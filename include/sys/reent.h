...
/* Cyclone:  have to name these structs */
struct _reent_u1
{
  unsigned int _unused_rand;
  /* FIX:  had to change char * to int */
  int _strtok_last;
...
{
#define _N_LISTS 30
  /* FIX had to change _nextf from unsigned char * int */
  unsigned int _nextf[_N_LISTS];
  unsigned int _nmalloc[_N_LISTS];
};

union _reent_union 
{
  struct _reent_u1 _reent; 
  struct _reent_u2 _unused;
};
