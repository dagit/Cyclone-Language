...
extern doc_t textptr(stringptr s);
...
extern doc_t group(string start, string stop, string sep, list_t<doc_t> ss);
extern doc_t groupl(string start, string stop, string sep, list_t<doc_t> ss);
