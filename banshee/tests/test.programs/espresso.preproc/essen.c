...
extern int essen_cube(pset_family F, pset_family D, pset c);
extern pset_family cb_consensus(register pset_family T, register pset c);
extern pset_family cb_consensus_dist0(pset_family R, register pset p, register pset c);
extern pset_family essential(pset_family *Fp, pset_family *Dp);
...
*Fp = sf_inactive(F); *Dp = sf_join(D, E);	sf_free(D);
return E;
}

...
((H1[0]) ? (free((char *) (H1[0])), (H1[0]) = 0) : 0); ((H1) ? (free((char *) (H1)), (H1) = 0) : 0);;
sf_free(H);
return essen;
}
pset_family cb_consensus(register pset_family T, register pset c)
{
...
pset_family cb_consensus_dist0(pset_family R, register pset p, register pset c)
{
int var;
int got_one;
