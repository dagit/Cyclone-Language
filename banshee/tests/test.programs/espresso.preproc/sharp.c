...
extern pset_family cb1_dsharp(pset_family T, pset c);
extern pset_family cb_dsharp(pset c, pset_family T);
extern pset_family cb_recur_dsharp();
extern pset_family cb_recur_sharp(pset c, pset_family T, int first, int last, int level);
extern pset_family cb_sharp(pset c, pset_family T);
extern pset_family cv_dsharp(pset_family A, pset_family B);
extern pset_family cv_intersect(pset_family A, pset_family B);
extern pset_family cv_sharp(pset_family A, pset_family B);
extern pset_family dsharp(pset a, pset b);
extern pset_family make_disjoint(pset_family A);
extern pset_family sharp(pset a, pset b);
...
pset_family cb_recur_sharp(pset c, pset_family T, int first, int last, int level)
{
...
((diff) ? (free((char *) (diff)), (diff) = 0) : 0);
((and) ? (free((char *) (and)), (and) = 0) : 0);
