...
extern void restore_cube_struct(void);
extern void save_cube_struct(void);
extern void setdown_cube(void);
extern PLA_labels();
...
{
register int i, var;
((cube.first_part) ? (free((char *) (cube.first_part)), (cube.first_part) = 0) : 0);
((cube.last_part) ? (free((char *) (cube.last_part)), (cube.last_part) = 0) : 0);
((cube.first_word) ? (free((char *) (cube.first_word)), (cube.first_word) = 0) : 0);
((cube.last_word) ? (free((char *) (cube.last_word)), (cube.last_word) = 0) : 0);
((cube.sparse) ? (free((char *) (cube.sparse)), (cube.sparse) = 0) : 0);
((cube.binary_mask) ? (free((char *) (cube.binary_mask)), (cube.binary_mask) = 0) : 0);
((cube.mv_mask) ? (free((char *) (cube.mv_mask)), (cube.mv_mask) = 0) : 0);
((cube.fullset) ? (free((char *) (cube.fullset)), (cube.fullset) = 0) : 0);
((cube.emptyset) ? (free((char *) (cube.emptyset)), (cube.emptyset) = 0) : 0);
for(var = 0; var < cube.num_vars; var++)
((cube.var_mask[var]) ? (free((char *) (cube.var_mask[var])), (cube.var_mask[var]) = 0) : 0);
((cube.var_mask) ? (free((char *) (cube.var_mask)), (cube.var_mask) = 0) : 0);
for(i = 0; i < 10; i++)
((cube.temp[i]) ? (free((char *) (cube.temp[i])), (cube.temp[i]) = 0) : 0);
((cube.temp) ? (free((char *) (cube.temp)), (cube.temp) = 0) : 0);
((cdata.part_zeros) ? (free((char *) (cdata.part_zeros)), (cdata.part_zeros) = 0) : 0);
((cdata.var_zeros) ? (free((char *) (cdata.var_zeros)), (cdata.var_zeros) = 0) : 0);
((cdata.parts_active) ? (free((char *) (cdata.parts_active)), (cdata.parts_active) = 0) : 0);
((cdata.is_unate) ? (free((char *) (cdata.is_unate)), (cdata.is_unate) = 0) : 0);
cube.first_part = cube.last_part = (int *) 0;
cube.first_word = cube.last_word = (int *) 0;
cube.sparse = (int *) 0;
cube.binary_mask = cube.mv_mask = (pset) 0;
cube.fullset = cube.emptyset = (pset) 0;
cube.var_mask = cube.temp = (pset *) 0;
cdata.part_zeros = cdata.var_zeros = cdata.parts_active = (int *) 0;
cdata.is_unate = (int *) 0;
}
void save_cube_struct(void)
{
temp_cube_save = cube; temp_cdata_save = cdata; cube.first_part = cube.last_part = (int *) 0;
cube.first_word = cube.last_word = (int *) 0;
cube.part_size = (int *) 0;
cube.binary_mask = cube.mv_mask = (pset) 0;
cube.fullset = cube.emptyset = (pset) 0;
cube.var_mask = cube.temp = (pset *) 0;
cdata.part_zeros = cdata.var_zeros = cdata.parts_active = (int *) 0;
...
{
cube = temp_cube_save; cdata = temp_cdata_save; }
