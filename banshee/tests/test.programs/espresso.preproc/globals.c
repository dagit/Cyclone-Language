...
extern int verify();
unsigned int debug; int verbose_debug; char *total_name[16]; long total_time[16]; int total_calls[16]; int echo_comments;	int echo_unknown_commands;	int force_irredundant; int skip_make_sparse;
int kiss; int pos; int print_solution; int recompute_onset; int remove_essential; int single_expand; int summary; int trace; int unwrap_onset; int use_random_order;	int use_super_gasp;	char *filename;	struct pla_types_struct pla_types[] = {
"-f", 1,
"-r", 4,
"-d", 2,
"-fd", (1 | 2),
