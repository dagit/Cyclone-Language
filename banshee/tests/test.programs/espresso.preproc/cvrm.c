...
extern foreach_output_function(pPLA PLA, int (*func) (), int (*func1) ());
extern int cubelist_partition(pset *T, pset **A, pset **B, unsigned int comp_debug);
...
extern pset_family cof_output(pset_family T, register int i);
extern pset_family lex_sort(pset_family T);
extern pset_family mini_sort(pset_family F, int (*compare) ());
extern pset_family random_order(register pset_family F);
extern pset_family size_sort(pset_family T);
extern pset_family sort_reduce(pset_family T);
extern pset_family uncof_output(pset_family T, int i);
extern pset_family unravel(pset_family B, int start);
extern pset_family unravel_range(pset_family B, int start, int end);
...
pset_family mini_sort(pset_family F, int (*compare) ())
{
...
{
register pset p, last, largest = 0;
...
pset_family random_order(register pset_family F)
{
pset temp;
register int i, k;
...

pset_family cof_output(pset_family T, register int i)
{
pset_family T1;
...
{
Fmin = sf_append(Fmin, PLA->F);	PLA->F = 0;
return 1;
}
