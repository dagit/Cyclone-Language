...
static effecttype global_effect = ((void *)0);
static effecttype global_env = ((void *)0);
static hash_table globals = ((void *)0);
static function_decl current_function_decl = ((void *)0);
static aloctype current_function_ret = ((void *)0);
...
static char *alloc_names[] = {
  ...
  "kmalloc", ((void *)0)};
static char *free_names[] = {"free", ((void *)0)};
...
static bool is_alloc_fun(const char *name)
{
  ...
  for (i = 0; alloc_names[i]; i++)
    {
      if (! __extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (name) && __builtin_constant_p (alloc_names[i]) && (__s1_len = strlen (name), __s2_len = strlen (alloc_names[i]), (!((size_t)(const void *)((name) + 1) - (size_t)(const void *)(name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((alloc_names[i]) + 1) - (size_t)(const void *)(alloc_names[i]) == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (name), (__const char *) (alloc_names[i]), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (name) && ((size_t)(const void *)((name) + 1) - (size_t)(const void *)(name) == 1) && (__s1_len = strlen (name), __s1_len < 4) ? (__builtin_constant_p (alloc_names[i]) && ((size_t)(const void *)((alloc_names[i]) + 1) - (size_t)(const void *)(alloc_names[i]) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (name))[0] - ((__const unsigned char *) (__const char *)(alloc_names[i]))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[1] - ((__const unsigned char *) (__const char *) (alloc_names[i]))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[2] - ((__const unsigned char *) (__const char *) (alloc_names[i]))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (name))[3] - ((__const unsigned char *) (__const char *) (alloc_names[i]))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (alloc_names[i]); register int __result = (((__const unsigned char *) (__const char *) (name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (alloc_names[i]) && ((size_t)(const void *)((alloc_names[i]) + 1) - (size_t)(const void *)(alloc_names[i]) == 1) && (__s2_len = strlen (alloc_names[i]), __s2_len < 4) ? (__builtin_constant_p (name) && ((size_t)(const void *)((name) + 1) - (size_t)(const void *)(name) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (name))[0] - ((__const unsigned char *) (__const char *)(alloc_names[i]))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[1] - ((__const unsigned char *) (__const char *) (alloc_names[i]))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[2] - ((__const unsigned char *) (__const char *) (alloc_names[i]))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (name))[3] - ((__const unsigned char *) (__const char *) (alloc_names[i]))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (alloc_names[i]))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (alloc_names[i]))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (alloc_names[i]))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (alloc_names[i]))[3]); } } __result; }))) : strcmp (name, alloc_names[i])))); }))
        return 1;
    }
  return 0;
}
static bool is_free_fun(const char *name)
{
  ...
  for (i = 0; free_names[i]; i++)
    {
      if (! __extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (name) && __builtin_constant_p (free_names[i]) && (__s1_len = strlen (name), __s2_len = strlen (free_names[i]), (!((size_t)(const void *)((name) + 1) - (size_t)(const void *)(name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((free_names[i]) + 1) - (size_t)(const void *)(free_names[i]) == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (name), (__const char *) (free_names[i]), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (name) && ((size_t)(const void *)((name) + 1) - (size_t)(const void *)(name) == 1) && (__s1_len = strlen (name), __s1_len < 4) ? (__builtin_constant_p (free_names[i]) && ((size_t)(const void *)((free_names[i]) + 1) - (size_t)(const void *)(free_names[i]) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (name))[0] - ((__const unsigned char *) (__const char *)(free_names[i]))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[1] - ((__const unsigned char *) (__const char *) (free_names[i]))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[2] - ((__const unsigned char *) (__const char *) (free_names[i]))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (name))[3] - ((__const unsigned char *) (__const char *) (free_names[i]))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (free_names[i]); register int __result = (((__const unsigned char *) (__const char *) (name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (free_names[i]) && ((size_t)(const void *)((free_names[i]) + 1) - (size_t)(const void *)(free_names[i]) == 1) && (__s2_len = strlen (free_names[i]), __s2_len < 4) ? (__builtin_constant_p (name) && ((size_t)(const void *)((name) + 1) - (size_t)(const void *)(name) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (name))[0] - ((__const unsigned char *) (__const char *)(free_names[i]))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[1] - ((__const unsigned char *) (__const char *) (free_names[i]))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[2] - ((__const unsigned char *) (__const char *) (free_names[i]))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (name))[3] - ((__const unsigned char *) (__const char *) (free_names[i]))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (free_names[i]))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (free_names[i]))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (free_names[i]))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (free_names[i]))[3]); } } __result; }))) : strcmp (name, free_names[i])))); }))
        return 1;
    }
  return 0;
}
static bool is_memcpy_fun(const char *name)
{
  ...
  for (i = 0; memcpy_names[i]; i++)
    {
      if (! __extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (name) && __builtin_constant_p (memcpy_names[i]) && (__s1_len = strlen (name), __s2_len = strlen (memcpy_names[i]), (!((size_t)(const void *)((name) + 1) - (size_t)(const void *)(name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((memcpy_names[i]) + 1) - (size_t)(const void *)(memcpy_names[i]) == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (name), (__const char *) (memcpy_names[i]), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (name) && ((size_t)(const void *)((name) + 1) - (size_t)(const void *)(name) == 1) && (__s1_len = strlen (name), __s1_len < 4) ? (__builtin_constant_p (memcpy_names[i]) && ((size_t)(const void *)((memcpy_names[i]) + 1) - (size_t)(const void *)(memcpy_names[i]) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (name))[0] - ((__const unsigned char *) (__const char *)(memcpy_names[i]))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[1] - ((__const unsigned char *) (__const char *) (memcpy_names[i]))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[2] - ((__const unsigned char *) (__const char *) (memcpy_names[i]))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (name))[3] - ((__const unsigned char *) (__const char *) (memcpy_names[i]))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (memcpy_names[i]); register int __result = (((__const unsigned char *) (__const char *) (name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (memcpy_names[i]) && ((size_t)(const void *)((memcpy_names[i]) + 1) - (size_t)(const void *)(memcpy_names[i]) == 1) && (__s2_len = strlen (memcpy_names[i]), __s2_len < 4) ? (__builtin_constant_p (name) && ((size_t)(const void *)((name) + 1) - (size_t)(const void *)(name) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (name))[0] - ((__const unsigned char *) (__const char *)(memcpy_names[i]))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[1] - ((__const unsigned char *) (__const char *) (memcpy_names[i]))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (name))[2] - ((__const unsigned char *) (__const char *) (memcpy_names[i]))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (name))[3] - ((__const unsigned char *) (__const char *) (memcpy_names[i]))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (memcpy_names[i]))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (memcpy_names[i]))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (memcpy_names[i]))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (memcpy_names[i]))[3]); } } __result; }))) : strcmp (name, memcpy_names[i])))); }))
        return 1;
    }
  return 0;
}
      ...
      if (hash_table_lookup(globals, (hash_key)ddecl->name,
      ...
      else
        {
          ...
          if (ddecl->in_prelude && !ddecl->defined)
            ddecl->defined = 1;
          ((void) ((hash_table_insert(globals, (hash_key) ddecl->name, ddecl)) ? 0 : (__assert_fail ("hash_table_insert(globals, (hash_key) ddecl->name, ddecl)", "rinf_analyze.c", 161, __PRETTY_FUNCTION__), 0)));
        }
    }
  else
    ddecl->alref = alocreftype_ref(make_aloctype_fresh());
...
void rinf_traverse_globals(void (*f)(data_declaration, void *), void *arg)
{
  ...
  while (hash_table_next(&hts, ((void *)0), (hash_data *) &ddecl))
    {
      ((void) ((!ddecl->shadowed) ? 0 : (__assert_fail ("!ddecl->shadowed", "rinf_analyze.c", 207, __PRETTY_FUNCTION__), 0)));
      f(ddecl, arg);
    }
}
                                  ...
                                  void *arg)
{
  ...
  while (hash_table_next_sorted(&htss, ((void *)0), (hash_data *) &ddecl))
    {
      ((void) ((!ddecl->shadowed) ? 0 : (__assert_fail ("!ddecl->shadowed", "rinf_analyze.c", 221, __PRETTY_FUNCTION__), 0)));
      f(ddecl, arg);
    }
}
void report_rinf(location loc, severity sev, const char *format, ...)
...
void rinf_analyze(declaration program)
{
  ...
  AST_set_parents(({ast_generic tEmPcast = (ast_generic)(program); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_node && (tEmPcast)->kind <= postkind_node)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_node && (tEmPcast)->kind <= postkind_node)", "rinf_analyze.c", 248, __PRETTY_FUNCTION__), 0))); (node)(tEmPcast); }));
  for (d = (program); d; d = ({ast_generic tEmPcast = (ast_generic)(d->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "rinf_analyze.c", 249, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
    {
...
static dinfo analyze_declaration(declaration d, effecttype env)
{
  switch (d->kind)
    ...
    case kind_data_decl:
      {
        data_decl dd = ({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)", "rinf_analyze.c", 277, __PRETTY_FUNCTION__), 0))); (data_decl)(tEmPcast); });
        declaration decl;
        effecttype eff, local_env, alocs;
        eff = effecttype_empty;
        local_env = env;
        alocs = effecttype_empty;
        for (decl = (dd->decls); decl; decl = ({ast_generic tEmPcast = (ast_generic)(decl->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "rinf_analyze.c", 285, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); })) {
          dinfo next;
    ...
    case kind_variable_decl:
      {
        variable_decl vd = ({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_variable_decl && (tEmPcast)->kind <= postkind_variable_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_variable_decl && (tEmPcast)->kind <= postkind_variable_decl)", "rinf_analyze.c", 299, __PRETTY_FUNCTION__), 0))); (variable_decl)(tEmPcast); });
        ...
        ((void) ((root->alref) ? 0 : (__assert_fail ("root->alref", "rinf_analyze.c", 323, __PRETTY_FUNCTION__), 0)));
        if (isglobal)
    ...
    case kind_function_decl:
      {
        ...
        add_ddecl(root);
        params = (((void)0), __rc_typed_rarrayalloc)((parse_region), (25), sizeof(aloctype), 0);
        for (i=0; i < 25; i++)
        ...
        bodyeffs = (((void)0), __rc_typed_rarrayalloc)((parse_region), (25 +1), sizeof(effecttype), 0);
        bodyeffs[0] = bodyeff;
        for (i=1; i < 25 +1; i++)
          bodyeffs[i] =
            effecttype_var(rstrcat(parse_region, rstrcat(parse_region, root->name, "_body_eff"), inttostr(parse_region, i)));
        {
          ...
          if (!is_void_parms(fd->fdeclarator->parms))
            for (arg = (fd->fdeclarator->parms); arg; arg = ({ast_generic tEmPcast = (ast_generic)(arg->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "rinf_analyze.c", 394, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
            {
              if (((arg)->kind >= kind_ellipsis_decl && (arg)->kind <= postkind_ellipsis_decl))
                break;
              ((void) ((i < 25) ? 0 : (__assert_fail ("i < 25", "rinf_analyze.c", 399, __PRETTY_FUNCTION__), 0)));
              if (arg->kind == kind_data_decl)
                {
                  data_decl argd = ({ast_generic tEmPcast = (ast_generic)(arg); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)", "rinf_analyze.c", 404, __PRETTY_FUNCTION__), 0))); (data_decl)(tEmPcast); });
                  argvd = ({ast_generic tEmPcast = (ast_generic)(argd->decls); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_variable_decl && (tEmPcast)->kind <= postkind_variable_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_variable_decl && (tEmPcast)->kind <= postkind_variable_decl)", "rinf_analyze.c", 406, __PRETTY_FUNCTION__), 0))); (variable_decl)(tEmPcast); });
                  ((void) ((!argvd->next) ? 0 : (__assert_fail ("!argvd->next", "rinf_analyze.c", 407, __PRETTY_FUNCTION__), 0)));
                  oid = ((void *)0);
                  root_vd = root_ddecl(argvd->ddecl);
                }
              else
                {
                  oid = ({ast_generic tEmPcast = (ast_generic)(arg); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_oldidentifier_decl && (tEmPcast)->kind <= postkind_oldidentifier_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_oldidentifier_decl && (tEmPcast)->kind <= postkind_oldidentifier_decl)", "rinf_analyze.c", 415, __PRETTY_FUNCTION__), 0))); (oldidentifier_decl)(tEmPcast); });
                  argvd = ((void *)0);
        ...
        {
          sinfo body;
          ((void) ((((fd->stmt)->kind >= kind_compound_stmt && (fd->stmt)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((fd->stmt)->kind >= kind_compound_stmt && (fd->stmt)->kind <= postkind_compound_stmt)", "rinf_analyze.c", 485, __PRETTY_FUNCTION__), 0)));
    ...
    case kind_extension_decl:
      {
        extension_decl ed = ({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_extension_decl && (tEmPcast)->kind <= postkind_extension_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_extension_decl && (tEmPcast)->kind <= postkind_extension_decl)", "rinf_analyze.c", 515, __PRETTY_FUNCTION__), 0))); (extension_decl)(tEmPcast); });
        return analyze_declaration(ed->decl, env);
      };
    default:
      __fail("rinf_analyze.c", 519, __FUNCTION__, "(at %s:%ld) " "Unexpected decl kind 0x%x\n", ((d->loc)->filename), ((d->loc)->lineno), d->kind);
    }
}
static einfo analyze_init(type t, expression rhs, effecttype env)
{
  if (rhs->kind == kind_init_list && type_array(t))
    {
      ...
      aloctype al;
      alocreftype result;
      init_list il = ({ast_generic tEmPcast = (ast_generic)(rhs); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_init_list && (tEmPcast)->kind <= postkind_init_list)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_init_list && (tEmPcast)->kind <= postkind_init_list)", "rinf_analyze.c", 531, __PRETTY_FUNCTION__), 0))); (init_list)(tEmPcast); });
      effecttype eff;
      eff = effecttype_empty;
      al = make_aloctype_fresh();
      for (e = (il->args); e; e = ({ast_generic tEmPcast = (ast_generic)(e->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "rinf_analyze.c", 537, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
        if (e->kind == kind_init_index)
          {
            init_index ii = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_init_index && (tEmPcast)->kind <= postkind_init_index)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_init_index && (tEmPcast)->kind <= postkind_init_index)", "rinf_analyze.c", 540, __PRETTY_FUNCTION__), 0))); (init_index)(tEmPcast); });
            einfo arg1, arg2;
    ...
    {
       init_list il = ({ast_generic tEmPcast = (ast_generic)(rhs); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_init_list && (tEmPcast)->kind <= postkind_init_list)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_init_list && (tEmPcast)->kind <= postkind_init_list)", "rinf_analyze.c", 572, __PRETTY_FUNCTION__), 0))); (init_list)(tEmPcast); });
       expression e;
       effecttype eff;
       aloctype al;
       ...
       al = make_aloctype_fresh();
       eff = effecttype_empty;
       for (e = (il->args); e; e = ({ast_generic tEmPcast = (ast_generic)(e->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "rinf_analyze.c", 581, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
         {
           expression init_expr;
           einfo init;
           if (!field)
           ...
           if (e->kind == kind_init_field)
             {
               init_field ifd = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_init_field && (tEmPcast)->kind <= postkind_init_field)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_init_field && (tEmPcast)->kind <= postkind_init_field)", "rinf_analyze.c", 591, __PRETTY_FUNCTION__), 0))); (init_field)(tEmPcast); });
...
static sinfo analyze_statement(statement s, effecttype env)
{
  switch (s->kind)
    ...
    case kind_compound_stmt:
      {
        compound_stmt cs = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)", "rinf_analyze.c", 621, __PRETTY_FUNCTION__), 0))); (compound_stmt)(tEmPcast); });
        declaration decl;
        statement stmt;
        effecttype eff, local_env;
        eff = effecttype_empty;
        local_env = env;
        for (decl = (cs->decls); decl; decl = ({ast_generic tEmPcast = (ast_generic)(decl->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "rinf_analyze.c", 630, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
          {
            dinfo next;
            ((void) ((decl->kind != kind_asm_decl) ? 0 : (__assert_fail ("decl->kind != kind_asm_decl", "rinf_analyze.c", 634, __PRETTY_FUNCTION__), 0)));
            next = analyze_declaration(decl, local_env);
            eff = effecttype_union(eff, next.eff);
            local_env = effecttype_union(local_env, next.alocs);
          }
        for (stmt = (cs->stmts); stmt; stmt = ({ast_generic tEmPcast = (ast_generic)(stmt->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)", "rinf_analyze.c", 641, __PRETTY_FUNCTION__), 0))); (statement)(tEmPcast); }))
          {
    ...
    case kind_if_stmt:
      {
        if_stmt is = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_if_stmt && (tEmPcast)->kind <= postkind_if_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_if_stmt && (tEmPcast)->kind <= postkind_if_stmt)", "rinf_analyze.c", 655, __PRETTY_FUNCTION__), 0))); (if_stmt)(tEmPcast); });
        einfo guard;
        sinfo then;
        effecttype eff;
    ...
    case kind_labeled_stmt:
      {
        labeled_stmt ls = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)", "rinf_analyze.c", 681, __PRETTY_FUNCTION__), 0))); (labeled_stmt)(tEmPcast); });
        return analyze_statement(ls->stmt, env);
      };
      break;
    case kind_expression_stmt:
      {
        expression_stmt es = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)", "rinf_analyze.c", 688, __PRETTY_FUNCTION__), 0))); (expression_stmt)(tEmPcast); });
        einfo ei;
    ...
    case kind_while_stmt:
      {
        while_stmt ws = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_while_stmt && (tEmPcast)->kind <= postkind_while_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_while_stmt && (tEmPcast)->kind <= postkind_while_stmt)", "rinf_analyze.c", 699, __PRETTY_FUNCTION__), 0))); (while_stmt)(tEmPcast); });
        einfo guard;
        sinfo body;
        effecttype eff;
    ...
    case kind_dowhile_stmt:
      {
        dowhile_stmt dws = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_dowhile_stmt && (tEmPcast)->kind <= postkind_dowhile_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_dowhile_stmt && (tEmPcast)->kind <= postkind_dowhile_stmt)", "rinf_analyze.c", 713, __PRETTY_FUNCTION__), 0))); (dowhile_stmt)(tEmPcast); });
        sinfo body;
        effecttype eff;
    ...
    case kind_switch_stmt:
      {
        switch_stmt ss = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_switch_stmt && (tEmPcast)->kind <= postkind_switch_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_switch_stmt && (tEmPcast)->kind <= postkind_switch_stmt)", "rinf_analyze.c", 734, __PRETTY_FUNCTION__), 0))); (switch_stmt)(tEmPcast); });
        einfo guard;
        sinfo body;
        effecttype eff;
    ...
    case kind_for_stmt:
      {
        for_stmt fs = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_for_stmt && (tEmPcast)->kind <= postkind_for_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_for_stmt && (tEmPcast)->kind <= postkind_for_stmt)", "rinf_analyze.c", 749, __PRETTY_FUNCTION__), 0))); (for_stmt)(tEmPcast); });
        sinfo body;
        effecttype eff;
        eff = effecttype_empty;
        if (fs->arg1)
    ...
    case kind_return_stmt:
      {
        return_stmt rs = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_return_stmt && (tEmPcast)->kind <= postkind_return_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_return_stmt && (tEmPcast)->kind <= postkind_return_stmt)", "rinf_analyze.c", 790, __PRETTY_FUNCTION__), 0))); (return_stmt)(tEmPcast); });
        effecttype eff;
        eff = effecttype_empty;
        if (rs->arg1)
          {
            ...
            eff = effecttype_union(eff, arg1.eff);
            eff = effecttype_union(eff, effecttype_read(arg1.tau));
            ((void) ((current_function_ret) ? 0 : (__assert_fail ("current_function_ret", "rinf_analyze.c", 802, __PRETTY_FUNCTION__), 0)));
    ...
    case kind_assert_type_stmt:
      ...
      break;
    default:
      __fail("rinf_analyze.c", 852, __FUNCTION__, "(at %s:%ld) " "Unexpected statement kind 0x%x\n", ((s->loc)->filename), ((s->loc)->lineno), s->kind);
      break;
    }
}
static einfo analyze_expression(expression e, effecttype env)
{
  ...
  case kind_comma:
    {
      comma c = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_comma && (tEmPcast)->kind <= postkind_comma)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_comma && (tEmPcast)->kind <= postkind_comma)", "rinf_analyze.c", 864, __PRETTY_FUNCTION__), 0))); (comma)(tEmPcast); });
      expression e2;
      effecttype eff;
      eff = effecttype_empty;
      for (e2 = (c->arg1); e2; e2 = ({ast_generic tEmPcast = (ast_generic)(e2->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "rinf_analyze.c", 869, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
        {
  ...
  case kind_cast:
    {
      cast c = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_cast && (tEmPcast)->kind <= postkind_cast)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_cast && (tEmPcast)->kind <= postkind_cast)", "rinf_analyze.c", 903, __PRETTY_FUNCTION__), 0))); (cast)(tEmPcast); });
      result = analyze_expression(c->arg1, env);
    };
    break;
  case kind_cast_list:
    {
      cast_list cl = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_cast_list && (tEmPcast)->kind <= postkind_cast_list)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_cast_list && (tEmPcast)->kind <= postkind_cast_list)", "rinf_analyze.c", 910, __PRETTY_FUNCTION__), 0))); (cast_list)(tEmPcast); });
      result = analyze_init(cl->type, cl->init_expr, env);
    };
    break;
  case kind_conditional:
    {
      conditional c = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)", "rinf_analyze.c", 917, __PRETTY_FUNCTION__), 0))); (conditional)(tEmPcast); });
  ...
  case kind_identifier:
    {
      identifier id = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "rinf_analyze.c", 944, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); });
      data_declaration root;
      if (is_alloc_fun(id->ddecl->name))
      ...
      else
        {
          ...
          if (!root->alref)
            {
              add_ddecl(root);
              ((void) ((root->alref) ? 0 : (__assert_fail ("root->alref", "rinf_analyze.c", 975, __PRETTY_FUNCTION__), 0)));
            }
  ...
  case kind_compound_expr:
    {
      compound_expr ce = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_expr && (tEmPcast)->kind <= postkind_compound_expr)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_expr && (tEmPcast)->kind <= postkind_compound_expr)", "rinf_analyze.c", 983, __PRETTY_FUNCTION__), 0))); (compound_expr)(tEmPcast); });
      compound_stmt cs = ({ast_generic tEmPcast = (ast_generic)(ce->stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)", "rinf_analyze.c", 984, __PRETTY_FUNCTION__), 0))); (compound_stmt)(tEmPcast); });
      statement cur_stmt;
      declaration d;
      effecttype eff, local_env;
      alocreftype tau;
      if (cs->id_labels)
        __fail("rinf_analyze.c", 991, __FUNCTION__, "(at %s:%ld) " "Unimplemented: id_labels\n", ((cs->loc)->filename), ((cs->loc)->lineno), 0);
      eff = effecttype_empty;
      local_env = env;
      for (d = (cs->decls); d; d = ({ast_generic tEmPcast = (ast_generic)(d->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "rinf_analyze.c", 997, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
        {
          dinfo next;
          ((void) ((d->kind != kind_asm_decl) ? 0 : (__assert_fail ("d->kind != kind_asm_decl", "rinf_analyze.c", 1001, __PRETTY_FUNCTION__), 0)));
      ...
      while (cur_stmt && cur_stmt->next)
        {
          ...
          eff = effecttype_union(eff, next.eff);
          cur_stmt = ({ast_generic tEmPcast = (ast_generic)(cur_stmt->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)", "rinf_analyze.c", 1014, __PRETTY_FUNCTION__), 0))); (statement)(tEmPcast); });
        }
      if (cur_stmt && ((cur_stmt)->kind >= kind_expression_stmt && (cur_stmt)->kind <= postkind_expression_stmt))
        {
          einfo next;
          next = analyze_expression(({ast_generic tEmPcast = (ast_generic)(cur_stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)", "rinf_analyze.c", 1023, __PRETTY_FUNCTION__), 0))); (expression_stmt)(tEmPcast); })->arg1,
                                    local_env);
          eff = effecttype_union(eff, next.eff);
          tau = next.tau;
        }
  ...
  case kind_function_call:
    {
      function_call fc = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_call && (tEmPcast)->kind <= postkind_function_call)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_call && (tEmPcast)->kind <= postkind_function_call)", "rinf_analyze.c", 1050, __PRETTY_FUNCTION__), 0))); (function_call)(tEmPcast); });
      einfo f_info;
      expression arg;
      int i;
      ...
      i = 0;
      for (arg = (fc->args); arg; arg = ({ast_generic tEmPcast = (ast_generic)(arg->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "rinf_analyze.c", 1077, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
        {
          einfo arg_info;
          ((void) ((i < 25) ? 0 : (__assert_fail ("i < 25", "rinf_analyze.c", 1081, __PRETTY_FUNCTION__), 0)));
  ...
  case kind_array_ref:
    {
      array_ref ar = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_array_ref && (tEmPcast)->kind <= postkind_array_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_array_ref && (tEmPcast)->kind <= postkind_array_ref)", "rinf_analyze.c", 1097, __PRETTY_FUNCTION__), 0))); (array_ref)(tEmPcast); });
  ...
  case kind_field_ref:
    {
      field_ref fr = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)", "rinf_analyze.c", 1120, __PRETTY_FUNCTION__), 0))); (field_ref)(tEmPcast); });
      result = analyze_expression(fr->arg1, env);
    };
    break;
  case kind_init_list:
    {
      __fail("rinf_analyze.c", 1128, __FUNCTION__, "(at %s:%ld) " "Unexpected init list\n", ((e->loc)->filename), ((e->loc)->lineno), 0);
    };
    break;
  case kind_init_index:
    {
      __fail("rinf_analyze.c", 1134, __FUNCTION__, "(at %s:%ld) " "Unexpected init index\n", ((e->loc)->filename), ((e->loc)->lineno), 0);
    };
    break;
  case kind_init_field:
    {
      __fail("rinf_analyze.c", 1139, __FUNCTION__, "(at %s:%ld) " "Unexpected init field\n", ((e->loc)->filename), ((e->loc)->lineno), 0);
    };
    break;
  ...
  default:
    if (((e)->kind >= kind_unary && (e)->kind <= postkind_unary))
      result = analyze_unary_expression(({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)", "rinf_analyze.c", 1161, __PRETTY_FUNCTION__), 0))); (unary)(tEmPcast); }), env);
    else if (((e)->kind >= kind_binary && (e)->kind <= postkind_binary))
      result = analyze_binary_expression(({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)", "rinf_analyze.c", 1163, __PRETTY_FUNCTION__), 0))); (binary)(tEmPcast); }), env);
    else
      __fail("rinf_analyze.c", 1165, __FUNCTION__, "(at %s:%ld) " "Unexpected expr kind 0x%x\n", ((e->loc)->filename), ((e->loc)->lineno), e->kind);
  }
  return result;
}
static einfo analyze_unary_expression(unary e, effecttype env)
{
  switch (e->kind)
    ...
    case kind_postdecrement:
      ...
      break;
    default:
      __fail("rinf_analyze.c", 1256, __FUNCTION__, "(at %s:%ld) " "Unexpected unary op kind 0x%x\n", ((e->loc)->filename), ((e->loc)->lineno), e->kind);
    }
}
static einfo analyze_binary_expression(binary e, effecttype env)
{
  ...
  switch (e->kind)
    ...
    default:
      __fail("rinf_analyze.c", 1330, __FUNCTION__, "(at %s:%ld) " "Unexpected binary op kind 0x%x\n", ((e->loc)->filename), ((e->loc)->lineno), e->kind);
    }
}
static einfo analyze_alloc_fun(void)
{
...
const char CANON_IDENT_6f13f211d1563728f77a12e523fbfe77[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/rinf_analyze.c";
