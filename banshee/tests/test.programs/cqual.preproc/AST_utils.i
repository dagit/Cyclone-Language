...
bool oldstyle_function(function_decl fn)
{
  return !fn->fdeclarator->parms || ((fn->fdeclarator->parms)->kind >= kind_oldidentifier_decl && (fn->fdeclarator->parms)->kind <= postkind_oldidentifier_decl);
}
function_declarator get_fdeclarator(declarator d)
{
  for (;;)
    switch (d->kind)
      ...
      case kind_function_declarator:
        return ({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_declarator && (tEmPcast)->kind <= postkind_function_declarator)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_declarator && (tEmPcast)->kind <= postkind_function_declarator)", "AST_utils.c", 34, __PRETTY_FUNCTION__), 0))); (function_declarator)(tEmPcast); });
      case kind_identifier_declarator:
        return ((void *)0);
      case kind_array_declarator:
        d = ({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_array_declarator && (tEmPcast)->kind <= postkind_array_declarator)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_array_declarator && (tEmPcast)->kind <= postkind_array_declarator)", "AST_utils.c", 38, __PRETTY_FUNCTION__), 0))); (array_declarator)(tEmPcast); })->declarator;
        break;
      case kind_pointer_declarator:
        d = ({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_pointer_declarator && (tEmPcast)->kind <= postkind_pointer_declarator)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_pointer_declarator && (tEmPcast)->kind <= postkind_pointer_declarator)", "AST_utils.c", 41, __PRETTY_FUNCTION__), 0))); (pointer_declarator)(tEmPcast); })->declarator;
        break;
      default:
        ((void) ((0) ? 0 : (__assert_fail ("0", "AST_utils.c", 44, __PRETTY_FUNCTION__), 0)));
      }
}
data_declaration get_parameter(declaration d)
{
  switch (d->kind)
    ...
    case kind_oldidentifier_decl:
      return ({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_oldidentifier_decl && (tEmPcast)->kind <= postkind_oldidentifier_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_oldidentifier_decl && (tEmPcast)->kind <= postkind_oldidentifier_decl)", "AST_utils.c", 55, __PRETTY_FUNCTION__), 0))); (oldidentifier_decl)(tEmPcast); })->ddecl;
    case kind_data_decl:
      return ({ast_generic tEmPcast = (ast_generic)(({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)", "AST_utils.c", 57, __PRETTY_FUNCTION__), 0))); (data_decl)(tEmPcast); })->decls); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_variable_decl && (tEmPcast)->kind <= postkind_variable_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_variable_decl && (tEmPcast)->kind <= postkind_variable_decl)", "AST_utils.c", 57, __PRETTY_FUNCTION__), 0))); (variable_decl)(tEmPcast); })->ddecl;
    default:
      ((void) ((0) ? 0 : (__assert_fail ("0", "AST_utils.c", 59, __PRETTY_FUNCTION__), 0)));
      return ((void *)0);
    }
}
data_declaration base_identifier(data_declaration d)
...
bool call_to(data_declaration fnd, function_call fce)
{
  return ((fce->arg1)->kind >= kind_identifier && (fce->arg1)->kind <= postkind_identifier) &&
    fnd && same_function(({ast_generic tEmPcast = (ast_generic)(fce->arg1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 82, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->ddecl, fnd);
}
bool is_localvar(expression e)
{
  data_declaration decl;
  if (!((e)->kind >= kind_identifier && (e)->kind <= postkind_identifier))
    return 0;
  decl = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 92, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->ddecl;
  return decl->kind == decl_variable && decl->islocal;
}
compound_stmt parent_block(node n)
{
  while (!((n)->kind >= kind_compound_stmt && (n)->kind <= postkind_compound_stmt) || ((n->parent)->kind >= kind_compound_expr && (n->parent)->kind <= postkind_compound_expr))
    n = n->parent;
  return ({ast_generic tEmPcast = (ast_generic)(n); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)", "AST_utils.c", 104, __PRETTY_FUNCTION__), 0))); (compound_stmt)(tEmPcast); });
}
function_decl parent_function(node n)
{
  while (!((n)->kind >= kind_function_decl && (n)->kind <= postkind_function_decl))
    n = n->parent;
  return ({ast_generic tEmPcast = (ast_generic)(n); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_decl && (tEmPcast)->kind <= postkind_function_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_decl && (tEmPcast)->kind <= postkind_function_decl)", "AST_utils.c", 112, __PRETTY_FUNCTION__), 0))); (function_decl)(tEmPcast); });
}
bool is_assignment(void *e)
{
...
expression ignore_fields(expression e)
{
  while (e->kind == kind_field_ref)
    e = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)", "AST_utils.c", 140, __PRETTY_FUNCTION__), 0))); (field_ref)(tEmPcast); })->arg1;
  return e;
}
expression expression_of_stmt(compound_expr ce)
{
  compound_stmt blk = ({ast_generic tEmPcast = (ast_generic)(ce->stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)", "AST_utils.c", 147, __PRETTY_FUNCTION__), 0))); (compound_stmt)(tEmPcast); });
  statement last_stmt = ({ast_generic tEmPcast = (ast_generic)(last_node(({ast_generic tEmPcast = (ast_generic)(blk->stmts); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_node && (tEmPcast)->kind <= postkind_node)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_node && (tEmPcast)->kind <= postkind_node)", "AST_utils.c", 148, __PRETTY_FUNCTION__), 0))); (node)(tEmPcast); }))); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)", "AST_utils.c", 148, __PRETTY_FUNCTION__), 0))); (statement)(tEmPcast); });
  if (last_stmt && ((last_stmt)->kind >= kind_expression_stmt && (last_stmt)->kind <= postkind_expression_stmt))
    {
      expression_stmt es = ({ast_generic tEmPcast = (ast_generic)(last_stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)", "AST_utils.c", 152, __PRETTY_FUNCTION__), 0))); (expression_stmt)(tEmPcast); });
      return es->arg1;
    }
  return ((void *)0);
}
bool expression_used(expression e)
{
  ...
  for (;;)
    {
      if (((p1)->kind >= kind_expression_stmt && (p1)->kind <= postkind_expression_stmt))
        return 0;
      if (!((p1)->kind >= kind_comma && (p1)->kind <= postkind_comma))
        return 1;
      if (n1)
        return 0;
      n1 = p1->next;
...
bool zero_expression(expression e)
{
  for (;;)
    {
      if (((e)->kind >= kind_assign && (e)->kind <= postkind_assign))
        {
          e = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_assign && (tEmPcast)->kind <= postkind_assign)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_assign && (tEmPcast)->kind <= postkind_assign)", "AST_utils.c", 189, __PRETTY_FUNCTION__), 0))); (assign)(tEmPcast); })->arg2;
          continue;
        }
      if (((e)->kind >= kind_cast && (e)->kind <= postkind_cast))
        {
          e = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_cast && (tEmPcast)->kind <= postkind_cast)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_cast && (tEmPcast)->kind <= postkind_cast)", "AST_utils.c", 194, __PRETTY_FUNCTION__), 0))); (cast)(tEmPcast); })->arg1;
          continue;
        }
      if (((e)->kind >= kind_comma && (e)->kind <= postkind_comma))
        {
          e = ({ast_generic tEmPcast = (ast_generic)(last_node(({ast_generic tEmPcast = (ast_generic)(({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_comma && (tEmPcast)->kind <= postkind_comma)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_comma && (tEmPcast)->kind <= postkind_comma)", "AST_utils.c", 199, __PRETTY_FUNCTION__), 0))); (comma)(tEmPcast); })->arg1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_node && (tEmPcast)->kind <= postkind_node)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_node && (tEmPcast)->kind <= postkind_node)", "AST_utils.c", 199, __PRETTY_FUNCTION__), 0))); (node)(tEmPcast); }))); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "AST_utils.c", 199, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); });
          continue;
        }
      break;
    }
...
expression build_int_constant(region r, location loc, type t, largest_int c)
{
  ...
  csts.data = (((void)0), __rc_rstrdup)(r, cstbuf);
  csts.length = strlen(cstbuf);
  cst = new_lexical_cst(r, loc, csts);
  cst->type = t;
  cst->cst = make_cst(make_cval_signed(c, t), t);
  return ({ast_generic tEmPcast = (ast_generic)(cst); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "AST_utils.c", 221, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); });
}
expression build_uint_constant(region r, location loc, type t, largest_uint c)
{
  char cstbuf[64];
  ...
  return ({ast_generic tEmPcast = (ast_generic)(cst); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "AST_utils.c", 237, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); });
}
cval value_of_enumerator(enumerator e)
{
...
expression build_identifier(region r, location loc, data_declaration id)
{
  ...
  ((void) ((id->kind == decl_variable || id->kind == decl_function) ? 0 : (__assert_fail ("id->kind == decl_variable || id->kind == decl_function", "AST_utils.c", 249, __PRETTY_FUNCTION__), 0)));
  e->type = id->type;
  e->cst = fold_identifier(({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "AST_utils.c", 251, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }), id);
  return ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "AST_utils.c", 253, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); });
}
char *string_to_charp(region r, string s)
{
  expression e;
  int len = 0;
  char *str;
  for (e = (s->strings); e; e = ({ast_generic tEmPcast = (ast_generic)(e->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "AST_utils.c", 263, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
    if (e->kind == kind_string_cst)
      len += ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)", "AST_utils.c", 265, __PRETTY_FUNCTION__), 0))); (string_cst)(tEmPcast); })->cstring.length - 2;
    else if (e->kind == kind_identifier)
      len += ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 267, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->cstring.length - 2;
    else
      __fail("AST_utils.c", 269, __FUNCTION__, "Unexpected string component kind %x\n", e->kind);
  str = (((void)0), __rc_typed_rarrayalloc)((r), (len + 1), sizeof(char), 0);
  str[0] = '\0';
  for (e = (s->strings); e; e = ({ast_generic tEmPcast = (ast_generic)(e->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "AST_utils.c", 272, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
    if (e->kind == kind_string_cst)
      (__extension__ (__builtin_constant_p (({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)", "AST_utils.c", 274, __PRETTY_FUNCTION__), 0))); (string_cst)(tEmPcast); })->cstring.data + 1) && __builtin_constant_p (({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)", "AST_utils.c", 274, __PRETTY_FUNCTION__), 0))); (string_cst)(tEmPcast); })->cstring.length - 2) ? (strlen (({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)", "AST_utils.c", 274, __PRETTY_FUNCTION__), 0))); (string_cst)(tEmPcast); })->cstring.data + 1) < ((size_t) (({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)", "AST_utils.c", 274, __PRETTY_FUNCTION__), 0))); (string_cst)(tEmPcast); })->cstring.length - 2)) ? strcat (str, ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)", "AST_utils.c", 274, __PRETTY_FUNCTION__), 0))); (string_cst)(tEmPcast); })->cstring.data + 1) : strncat (str, ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)", "AST_utils.c", 274, __PRETTY_FUNCTION__), 0))); (string_cst)(tEmPcast); })->cstring.data + 1, ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)", "AST_utils.c", 274, __PRETTY_FUNCTION__), 0))); (string_cst)(tEmPcast); })->cstring.length - 2)) : strncat (str, ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)", "AST_utils.c", 274, __PRETTY_FUNCTION__), 0))); (string_cst)(tEmPcast); })->cstring.data + 1, ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string_cst && (tEmPcast)->kind <= postkind_string_cst)", "AST_utils.c", 274, __PRETTY_FUNCTION__), 0))); (string_cst)(tEmPcast); })->cstring.length - 2)));
    else if (e->kind == kind_identifier)
      (__extension__ (__builtin_constant_p (({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 278, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->cstring.data + 1) && __builtin_constant_p (({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 278, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->cstring.length - 2) ? (strlen (({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 278, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->cstring.data + 1) < ((size_t) (({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 278, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->cstring.length - 2)) ? strcat (str, ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 278, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->cstring.data + 1) : strncat (str, ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 278, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->cstring.data + 1, ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 278, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->cstring.length - 2)) : strncat (str, ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 278, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->cstring.data + 1, ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "AST_utils.c", 278, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); })->cstring.length - 2)));
    else
      __fail("AST_utils.c", 282, __FUNCTION__, "Unexpected string component kind %x\n", e->kind);
  return str;
}
const char CANON_IDENT_409bb81ad6c6e747401cb704394dba0f[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/AST_utils.c";
