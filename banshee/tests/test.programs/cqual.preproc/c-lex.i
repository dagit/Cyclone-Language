...
typedef int __jmp_buf[6];typedef struct __jmp_buf_tag
  {
    __jmp_buf __jmpbuf;
...
static location make_location(struct Location l)
{
  ...
  last_allocated_location = (sizeof(struct Location) < (1 << (13 - 3)) ? (((void)0), __rc_ralloc_small0)((parse_region), sizeof(struct Location)) : (((void)0), __rc_typed_ralloc)((parse_region), sizeof(struct Location), 0));
...
init_lex(void)
{
  dummy_location = (sizeof(struct Location) < (1 << (13 - 3)) ? (((void)0), __rc_ralloc_small0)((parse_region), sizeof(struct Location)) : (((void)0), __rc_typed_ralloc)((parse_region), sizeof(struct Location), 0));
  dummy_location->filename = "<dummy>";
  dummy_location->lineno = 0;
  dummy_location->filepos = 0;
  dummy_location->in_system_header = 0;
  last_allocated_location = dummy_location;
  lineno = 0;
  filepos = -1;
  maxtoken = 40;
  ...
  if (flag_traditional)
    {
      do { struct resword *s = is_reserved_word ("const", sizeof ("const") - 1); if (s) s->name = ""; } while (0);
      do { struct resword *s = is_reserved_word ("volatile", sizeof ("volatile") - 1); if (s) s->name = ""; } while (0);
      do { struct resword *s = is_reserved_word ("typeof", sizeof ("typeof") - 1); if (s) s->name = ""; } while (0);
      do { struct resword *s = is_reserved_word ("signed", sizeof ("signed") - 1); if (s) s->name = ""; } while (0);
      do { struct resword *s = is_reserved_word ("inline", sizeof ("inline") - 1); if (s) s->name = ""; } while (0);
      do { struct resword *s = is_reserved_word ("iterator", sizeof ("iterator") - 1); if (s) s->name = ""; } while (0);
      do { struct resword *s = is_reserved_word ("complex", sizeof ("complex") - 1); if (s) s->name = ""; } while (0);
    }
  if (flag_no_asm)
    {
      do { struct resword *s = is_reserved_word ("asm", sizeof ("asm") - 1); if (s) s->name = ""; } while (0);
      do { struct resword *s = is_reserved_word ("typeof", sizeof ("typeof") - 1); if (s) s->name = ""; } while (0);
      do { struct resword *s = is_reserved_word ("inline", sizeof ("inline") - 1); if (s) s->name = ""; } while (0);
      do { struct resword *s = is_reserved_word ("iterator", sizeof ("iterator") - 1); if (s) s->name = ""; } while (0);
      do { struct resword *s = is_reserved_word ("complex", sizeof ("complex") - 1); if (s) s->name = ""; } while (0);
    }
  (filepos--, ungetc (check_newline(), finput));
}
void
...
{
  char *s;
  s = (((void)0), __rc_rstralloc)(parse_region, c->cstring.length - 1);
...
{
  return token == 265 && type_integral(yylval.u.constant->type);
}
static int token_intvalue(void)
{
  return cval_sint_value((yylval.u.constant->cst)->cval);
}
int
check_newline ()
{
  ...
  if ((c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z'))
    {
      if (c == 'p')
        {
          if ((filepos++, _IO_getc (finput)) == 'r'
              && (filepos++, _IO_getc (finput)) == 'a'
              && (filepos++, _IO_getc (finput)) == 'g'
              && (filepos++, _IO_getc (finput)) == 'm'
              && (filepos++, _IO_getc (finput)) == 'a'
              && ((c = (filepos++, _IO_getc (finput))) == ' ' || c == '\t' || c == '\n'))
            {
        ...
        {
          if ((filepos++, _IO_getc (finput)) == 'e'
              && (filepos++, _IO_getc (finput)) == 'f'
              && (filepos++, _IO_getc (finput)) == 'i'
              && (filepos++, _IO_getc (finput)) == 'n'
              && (filepos++, _IO_getc (finput)) == 'e'
              && ((c = (filepos++, _IO_getc (finput))) == ' ' || c == '\t' || c == '\n'))
            {
        ...
        {
          if ((filepos++, _IO_getc (finput)) == 'n'
              && (filepos++, _IO_getc (finput)) == 'd'
              && (filepos++, _IO_getc (finput)) == 'e'
              && (filepos++, _IO_getc (finput)) == 'f'
              && ((c = (filepos++, _IO_getc (finput))) == ' ' || c == '\t' || c == '\n'))
            {
        ...
        {
          if ((filepos++, _IO_getc (finput)) == 'i'
              && (filepos++, _IO_getc (finput)) == 'n'
              && (filepos++, _IO_getc (finput)) == 'e'
              && ((c = (filepos++, _IO_getc (finput))) == ' ' || c == '\t'))
            goto linenum;
        }
      else if (c == 'i')
        {
          if ((filepos++, _IO_getc (finput)) == 'd'
              && (filepos++, _IO_getc (finput)) == 'e'
              && (filepos++, _IO_getc (finput)) == 'n'
              && (filepos++, _IO_getc (finput)) == 't'
              && ((c = (filepos++, _IO_getc (finput))) == ' ' || c == '\t'))
            {
              while (c == ' ' || c == '\t')
                c = (filepos++, _IO_getc (finput));
  ...
  if (token_isint(token))
    {
      ...
      input_filename = parse_string_token(({ast_generic tEmPcast = (ast_generic)(yylval.u.constant); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_lexical_cst && (tEmPcast)->kind <= postkind_lexical_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_lexical_cst && (tEmPcast)->kind <= postkind_lexical_cst)", "c-lex.c", 718, __PRETTY_FUNCTION__), 0))); (lexical_cst)(tEmPcast); }));
      lineno = l;
      filepos = -1;
      in_system_header = 0;
      ...
      while (1)
        {
          ...
          if (!(c >= 'a' && c <= 'f')
              ...
              && !(c >= '0' && c <= '9'))
            {
              (token_ptr--, (filepos--, ungetc ((c), finput)));
              break;
            }
          code *= 16;
          if (c >= 'a' && c <= 'f')
...
static int read_char(char *context, char terminating_char,
                     char *cp, wchar_t *wcp)
{
  unsigned width = wcp ? type_size(wchar_type) * 8U
    : 8U;
  int c;
 tryagain:
  c = TGETC ();
...
{
  char buf[200];
  (__extension__ (__builtin_constant_p (string) ? (((size_t)(const void *)((string) + 1) - (size_t)(const void *)(string) == 1) && strlen (string) + 1 <= 8 ? __strcpy_small (buf, __extension__ (((__const unsigned char *) (__const char *) (string))[0 + 1] << 8 | ((__const unsigned char *) (__const char *) (string))[0]), __extension__ (((__const unsigned char *) (__const char *) (string))[4 + 1] << 8 | ((__const unsigned char *) (__const char *) (string))[4]), __extension__ (((((__const unsigned char *) (__const char *) (string))[0 + 3] << 8 | ((__const unsigned char *) (__const char *) (string))[0 + 2]) << 8 | ((__const unsigned char *) (__const char *) (string))[0 + 1]) << 8 | ((__const unsigned char *) (__const char *) (string))[0]), __extension__ (((((__const unsigned char *) (__const char *) (string))[4 + 3] << 8 | ((__const unsigned char *) (__const char *) (string))[4 + 2]) << 8 | ((__const unsigned char *) (__const char *) (string))[4 + 1]) << 8 | ((__const unsigned char *) (__const char *) (string))[4]), strlen (string) + 1) : (char *) memcpy (buf, string, strlen (string) + 1)) : strcpy (buf, string)));
  if (end_of_file)
...
yylex ()
{
  ...
  *token_ptr++ = c;
  ...
  last_location = make_location(loc);
  yylval.u.itoken.location = last_location;
  yylval.u.itoken.i = 0;
  switch (c)
    {
    case (-1):
    ...
    letter:
      ...
      *token_ptr = 0;
      ...
      if (value == 257)
        {
          yylval.idtoken.location = last_location;
          yylval.idtoken.id = make_token_cstring();
          yylval.idtoken.decl = lookup_id(yylval.idtoken.id.data, 0);
    ...
    case '.':
      {
        ...
        maxbase = (((largest_uint)1 << ((8 * 8U) - 1)) / base) << 1;
        maxbase += ((((largest_uint)1 << ((8 * 8U) - 1)) % base) << 1) / base;
        while (c == '.'
               || (((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISalnum) && c != 'l' && c != 'L'
                   && c != 'u' && c != 'U'
                   && c != 'i' && c != 'I' && c != 'j' && c != 'J'
            ...
            if (c == '.')
              {
                ...
                base = 10;
                c = TGETC();
                if (token_ptr == token_buffer + 2 && !((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISdigit))
                  {
                    if (c == '.')
                      {
                        c = TGETC();
        ...
        if (floatflag != NOT_FLOAT)
          {
            ...
            yylval.u.constant = fold_lexical_real(ftype, last_location, make_token_cstring());
          }
        else
          {
            int spec_unsigned = 0;
        ...
        if (((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISalnum) || c == '.' || c == '_' || c == '$'
    ...
    char_constant:
      {
        wchar_t wc;
        char *cbuf = __builtin_alloca (max_char_length);
        int chars_seen = 0, count, result = 0;
        unsigned width = wide_flag ? type_size(wchar_type) * 8U
          : 8U;
        for (;;)
          {
            count = read_char("character", '\'', cbuf, wide_flag ? &wc : ((void *)0));
            if (count <= 0)
              break;
            chars_seen += count;
            if (wide_flag)
              {
                ((void) ((count == 1) ? 0 : (__assert_fail ("count == 1", "c-lex.c", 1554, __PRETTY_FUNCTION__), 0)));
                if (chars_seen == 1)
                  result = wc;
              }
            else
        ...
        else if (chars_seen > int_type_size)
          error ("character constant too long");
        else if (chars_seen != 1 && ! flag_traditional && warn_multichar)
          warning ("multi-character character constant");
        yylval.u.constant = fold_lexical_char(last_location, make_token_cstring(),
                                              wide_flag, result);
        value = 265;
        break;
      }
    ...
    string_constant:
      {
        ...
        for (;;)
          {
            wchar_t *p;
            count = read_char("string", '"', cbuf, wide_flag ? &wc : ((void *)0));
            if (count <= 0)
              break;
            p = wchar_array_extend(string_array, count);
            if (wide_flag)
              {
                ((void) ((count == 1) ? 0 : (__assert_fail ("count == 1", "c-lex.c", 1610, __PRETTY_FUNCTION__), 0)));
                *p = wc;
              }
            else
              {
        ...
        yylval.u.string_cst = fold_lexical_string(last_location, make_token_cstring(),
    ...
    case '=':
      ...
      combine:
        ...
        if (c1 == '=')
          {
            ...
            switch (c)
              {
              case '<':
                value = 301; yylval.u.itoken.i = kind_leq; break;
              case '>':
                value = 301; yylval.u.itoken.i = kind_geq; break;
              case '!':
                value = 300; yylval.u.itoken.i = kind_ne; break;
              case '=':
                value = 300; yylval.u.itoken.i = kind_eq; break;
              case '+':
        ...
        (token_ptr--, (filepos--, ungetc ((c1), finput)));
        if (c == '<')
          {
            value = 301;
...
const char CANON_IDENT_a7ed3a3fa5f76052c28c71e3d2009ab4[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/c-lex.c";
