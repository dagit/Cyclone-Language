...
void cval_init(void)
{
  ((void) ((sizeof(largest_int) == sizeof(largest_uint)) ? 0 : (__assert_fail ("sizeof(largest_int) == sizeof(largest_uint)", "cval.c", 43, __PRETTY_FUNCTION__), 0)));
  cval_top.kind = cval_variable;
  cval_unknown.kind = cval_unk;
  cval_zero.kind = cval_sint;
  cval_zero.u.i.real.si = 0;
  cval_zero.u.i.isize = type_size(int_type);
}
cval make_cval_unsigned(largest_uint i, type t)
{
  cval c;
  ((void) ((type_integral(t) && type_unsigned(t)) ? 0 : (__assert_fail ("type_integral(t) && type_unsigned(t)", "cval.c", 57, __PRETTY_FUNCTION__), 0)));
  c.kind = cval_uint;
  c.u.i.real.ui = i;
  c.u.i.isize = type_size(t);
  return c;
}
cval make_cval_signed(largest_int i, type t)
{
  cval c;
  ((void) ((type_integral(t) && !type_unsigned(t)) ? 0 : (__assert_fail ("type_integral(t) && !type_unsigned(t)", "cval.c", 68, __PRETTY_FUNCTION__), 0)));
  c.kind = cval_sint;
  c.u.i.real.si = i;
  c.u.i.isize = type_size(t);
  return c;
...
cval make_cval_complex(cval r, cval i)
{
  ((void) ((r.kind == i.kind) ? 0 : (__assert_fail ("r.kind == i.kind", "cval.c", 85, __PRETTY_FUNCTION__), 0)));
  switch (r.kind)
    {
    case cval_float:
      r.u.fl.d_i = i.u.fl.d;
      ...
      return r;
    case cval_uint:
      ((void) ((r.u.i.isize == i.u.i.isize) ? 0 : (__assert_fail ("r.u.i.isize == i.u.i.isize", "cval.c", 94, __PRETTY_FUNCTION__), 0)));
      r.kind = cval_uint_complex;
      r.u.i.imag.ui_i = i.u.i.real.ui;
      return r;
    case cval_sint:
      ((void) ((r.u.i.isize == i.u.i.isize) ? 0 : (__assert_fail ("r.u.i.isize == i.u.i.isize", "cval.c", 99, __PRETTY_FUNCTION__), 0)));
      r.kind = cval_sint_complex;
      r.u.i.imag.si_i = i.u.i.real.si;
      return r;
                       ...
                       largest_int offset)
{
  ...
  ((void) ((!(ldecl && ddecl)) ? 0 : (__assert_fail ("!(ldecl && ddecl)", "cval.c", 113, __PRETTY_FUNCTION__), 0)));
  c.kind = cval_address;
  c.u.i.imag.addr.ddecl = ddecl;
  c.u.i.imag.addr.ldecl = ldecl;
  return c;
}
bool cval_isinteger(cval c)
{
...
{
  switch (c.kind) {
  default: case cval_variable: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 138, __PRETTY_FUNCTION__), 0)));
  case cval_unk: return 0;
  case cval_address: return c.u.i.real.si == 0;
...
{
  switch (c.kind) {
  default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 153, __PRETTY_FUNCTION__), 0)));
  case cval_address: ((void) ((c.u.i.real.si == 0) ? 0 : (__assert_fail ("c.u.i.real.si == 0", "cval.c", 154, __PRETTY_FUNCTION__), 0))); return 1;
  case cval_uint: return c.u.i.real.ui != 0;
  case cval_sint: return c.u.i.real.si != 0;
  case cval_float: return c.u.fl.d != 0;
  case cval_uint_complex: return c.u.i.real.ui && c.u.i.imag.ui_i;
  case cval_sint_complex: return c.u.i.real.si && c.u.i.imag.si_i;
  case cval_float_complex: return c.u.fl.d && c.u.fl.d_i;
  }
}
bool cval_knownvalue(cval c)
{
  switch (c.kind) {
  default: case cval_variable: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 171, __PRETTY_FUNCTION__), 0)));
  case cval_unk: case cval_address: return 0;
  case cval_uint: case cval_sint: case cval_float:
  case cval_uint_complex: case cval_sint_complex: case cval_float_complex:
    return 1;
  }
...
{
  switch (c.kind) {
  default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 185, __PRETTY_FUNCTION__), 0))); return 0;
  case cval_uint: return c.u.i.real.ui;
  case cval_sint: return c.u.i.real.si;
  case cval_float: return c.u.fl.d;
  }
}
largest_int cval_sint_value(cval c)
{
  switch (c.kind) {
  default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 198, __PRETTY_FUNCTION__), 0))); return 0;
  case cval_uint: return c.u.i.real.ui;
  case cval_sint: return c.u.i.real.si;
  case cval_float: return c.u.fl.d;
  }
...
{
  switch (c.kind) {
  default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 211, __PRETTY_FUNCTION__), 0))); return 0;
  case cval_uint: return c.u.i.real.ui;
  case cval_sint: return c.u.i.real.si;
  case cval_float: return c.u.fl.d;
  }
...
{
  switch (c.kind) {
  default: case cval_variable: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 224, __PRETTY_FUNCTION__), 0)));
  case cval_unk: case cval_address: return 0;
  case cval_uint: return c.u.i.real.ui == 1;
  case cval_sint: return c.u.i.real.si == 1;
  case cval_float: return c.u.fl.d == 1;
  case cval_uint_complex: return c.u.i.real.ui == 1 && c.u.i.imag.ui_i == 0;
  case cval_sint_complex: return c.u.i.real.si == 1 && c.u.i.imag.si_i == 0;
  case cval_float_complex: return c.u.fl.d == 1 && c.u.fl.d_i == 0;
  }
}
static largest_uint truncate_unsigned(largest_uint x, size_t tsize)
{
  ((void) ((tsize <= sizeof(largest_uint)) ? 0 : (__assert_fail ("tsize <= sizeof(largest_uint)", "cval.c", 239, __PRETTY_FUNCTION__), 0)));
  if (tsize == sizeof(largest_uint))
    return x;
  else
    return x & (((largest_uint)1 << 8U * tsize) - 1);
}
static largest_int truncate_signed(largest_int x, size_t tsize)
{
  largest_uint umask, uval;
  ((void) ((tsize <= sizeof(largest_int)) ? 0 : (__assert_fail ("tsize <= sizeof(largest_int)", "cval.c", 252, __PRETTY_FUNCTION__), 0)));
  if (tsize == sizeof(largest_int))
    return x;
  umask = (((largest_uint)1 << 8U * tsize) - 1);
  uval = x & umask;
  if (uval & ((largest_uint)1 << (8U * tsize - 1)))
  ...
  if (type_complex(to))
    {
      ...
      switch (c.kind)
        ...
        default:((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 295, __PRETTY_FUNCTION__), 0))); return c;
        }
    }
  if (cval_iscomplex(c))
  ...
  if (type_floating(to))
    {
      switch (c.kind)
        ...
        case cval_sint: case cval_uint:
          c.kind = cval_float;
          c.u.fl.d = c.kind == cval_sint ? (long double)c.u.i.real.si : (long double)c.u.i.real.ui;
          return c;
        case cval_float:
          if (type_float(to))
            c.u.fl.d = (float)c.u.fl.d;
          else if (type_double(to))
            c.u.fl.d = (double)c.u.fl.d;
          return c;
        default:((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 320, __PRETTY_FUNCTION__), 0))); return c;
        }
    }
  else
    {
      ...
      switch (c.kind)
        {
        case cval_float:
          ((void) ((!type_pointer(to)) ? 0 : (__assert_fail ("!type_pointer(to)", "cval.c", 332, __PRETTY_FUNCTION__), 0)));
          if (type_unsigned(to))
            {
              c.kind = cval_uint;
              c.u.i.real.ui = c.u.fl.d;
              c.u.i.isize = tosize;
            }
          else
            {
              c.kind = cval_sint;
              c.u.i.real.si = c.u.fl.d;
              c.u.i.isize = tosize;
            }
          return c;
        case cval_address:
        ...
        case cval_uint: case cval_sint:
          ...
          if (type_unsigned(to) || type_pointer(to))
            {
              if (c.kind == cval_sint)
                c.u.i.real.ui = c.u.i.real.si;
              c.u.i.real.ui = truncate_unsigned(c.u.i.real.ui, tosize);
              c.kind = cval_uint;
            }
          else
            {
              if (c.kind == cval_uint)
                c.u.i.real.si = c.u.i.real.ui;
              c.u.i.real.si = truncate_signed(c.u.i.real.si, tosize);
              c.kind = cval_sint;
            }
          return c;
        default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 373, __PRETTY_FUNCTION__), 0))); return c;
        }
    }
}
cval cval_not(cval c)
...
cval cval_negate(cval c)
{
  switch (c.kind)
    ...
    case cval_sint: c.u.i.real.si = -c.u.i.real.si; return c;
    case cval_uint: c.u.i.real.ui = truncate_unsigned(-c.u.i.real.ui, c.u.i.isize); return c;
    case cval_float: c.u.fl.d = -c.u.fl.d; return c;
    case cval_sint_complex:
      c.u.i.real.si = -c.u.i.real.si;
      c.u.i.imag.si_i = -c.u.i.imag.si_i;
      return c;
    case cval_uint_complex:
      c.u.i.real.ui = truncate_unsigned(-c.u.i.real.ui, c.u.i.isize);
      c.u.i.imag.ui_i = truncate_unsigned(-c.u.i.imag.ui_i, c.u.i.isize);
      return c;
    case cval_float_complex: c.u.fl.d = -c.u.fl.d; c.u.fl.d_i = -c.u.fl.d_i; return c;
...
cval cval_bitnot(cval c)
{
  switch (c.kind)
    ...
    case cval_variable: return cval_top;
    case cval_unk: case cval_address: return cval_unknown;
    case cval_sint: c.u.i.real.si = truncate_signed(~c.u.i.real.si, c.u.i.isize); return c;
    case cval_uint: c.u.i.real.ui = truncate_unsigned(~c.u.i.real.ui, c.u.i.isize); return c;
    default: abort(); return cval_top;
    }
}
cval cval_conjugate(cval c)
{
  switch (c.kind)
    ...
    case cval_uint_complex:
      c.u.i.imag.ui_i = truncate_unsigned(-c.u.i.imag.ui_i, c.u.i.isize);
      return c;
    case cval_float_complex: c.u.fl.d_i = -c.u.fl.d_i; return c;
    default: abort(); return cval_top;
    }
}
cval cval_realpart(cval c)
...
cval cval_imagpart(cval c)
{
  switch (c.kind)
    ...
    case cval_variable: return cval_top;
    case cval_unk: return cval_unknown;
    case cval_sint_complex: c.kind = cval_sint; c.u.i.real.si = c.u.i.imag.si_i; return c;
    case cval_uint_complex: c.kind = cval_uint; c.u.i.real.ui = c.u.i.imag.ui_i; return c;
    case cval_float_complex: c.kind = cval_float; c.u.fl.d = c.u.fl.d_i; return c;
    case cval_sint: c.u.i.real.si = 0; return c;
    case cval_uint: c.u.i.real.ui = 0; return c;
    case cval_float: c.u.fl.d = 0; return c;
    default: abort(); return cval_top;
    }
}
cval cval_add(cval c1, cval c2)
{
  if (((c1).kind == cval_variable) || ((c2).kind == cval_variable))
    return cval_top;
  if (((c1).kind == cval_unk) || ((c2).kind == cval_unk))
    return cval_unknown;
  ...
  switch (c1.kind)
    {
    case cval_float:
      ((void) ((c2.kind == cval_float) ? 0 : (__assert_fail ("c2.kind == cval_float", "cval.c", 485, __PRETTY_FUNCTION__), 0)));
      c1.u.fl.d += c2.u.fl.d;
      return c1;
    case cval_address:
      switch (c2.kind)
        ...
        case cval_sint: c1.u.i.real.si = truncate_signed(c1.u.i.real.si + c2.u.i.real.si, c1.u.i.isize); return c1;
        case cval_uint: c1.u.i.real.si = truncate_signed(c1.u.i.real.si + c2.u.i.real.ui, c1.u.i.isize); return c1;
        default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 495, __PRETTY_FUNCTION__), 0))); return c1;
        }
    case cval_sint:
      ((void) ((c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize", "cval.c", 499, __PRETTY_FUNCTION__), 0)));
      c1.u.i.real.si = truncate_signed(c1.u.i.real.si + c2.u.i.real.si, c1.u.i.isize);
      return c1;
    case cval_uint:
      ((void) ((c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize", "cval.c", 504, __PRETTY_FUNCTION__), 0)));
      c1.u.i.real.ui = truncate_unsigned(c1.u.i.real.ui + c2.u.i.real.ui, c1.u.i.isize);
      return c1;
    case cval_float_complex:
      ((void) ((c2.kind == cval_float_complex) ? 0 : (__assert_fail ("c2.kind == cval_float_complex", "cval.c", 509, __PRETTY_FUNCTION__), 0)));
      c1.u.fl.d += c2.u.fl.d;
      c1.u.fl.d_i += c2.u.fl.d_i;
      return c1;
    case cval_sint_complex:
      ((void) ((c2.kind == cval_sint_complex && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_sint_complex && c1.u.i.isize == c2.u.i.isize", "cval.c", 515, __PRETTY_FUNCTION__), 0)));
      c1.u.i.real.si = truncate_signed(c1.u.i.real.si + c2.u.i.real.si, c1.u.i.isize);
      c1.u.i.imag.si_i = truncate_signed(c1.u.i.imag.si_i + c2.u.i.imag.si_i, c1.u.i.isize);
      return c1;
    case cval_uint_complex:
      ((void) ((c2.kind == cval_uint_complex && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_uint_complex && c1.u.i.isize == c2.u.i.isize", "cval.c", 521, __PRETTY_FUNCTION__), 0)));
      c1.u.i.real.ui = truncate_unsigned(c1.u.i.real.ui + c2.u.i.real.ui, c1.u.i.isize);
      c1.u.i.imag.ui_i = truncate_unsigned(c1.u.i.imag.ui_i + c2.u.i.imag.ui_i, c1.u.i.isize);
      return c1;
    default:
      ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 527, __PRETTY_FUNCTION__), 0)));
      return c1;
    }
}
cval cval_sub(cval c1, cval c2)
{
  ...
  switch (c1.kind)
    {
    case cval_float:
      ((void) ((c2.kind == cval_float) ? 0 : (__assert_fail ("c2.kind == cval_float", "cval.c", 543, __PRETTY_FUNCTION__), 0)));
      c1.u.fl.d -= c2.u.fl.d;
      return c1;
    case cval_address:
      switch (c2.kind)
        {
        case cval_address:
          if (c1.u.i.imag.addr.ddecl != c2.u.i.imag.addr.ddecl ||
              c1.u.i.imag.addr.ldecl != c2.u.i.imag.addr.ldecl)
            return cval_unknown;
          c1.kind = cval_sint;
          c1.u.i.real.si = truncate_signed(c1.u.i.real.si - c2.u.i.real.si, c1.u.i.isize);
          return c1;
        case cval_sint: c1.u.i.real.si = truncate_signed(c1.u.i.real.si - c2.u.i.real.si, c1.u.i.isize); return c1;
        case cval_uint: c1.u.i.real.si = truncate_signed(c1.u.i.real.si - c2.u.i.real.ui, c1.u.i.isize); return c1;
        default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 560, __PRETTY_FUNCTION__), 0))); return c1;
        }
    case cval_sint:
      if (c2.kind == cval_address)
        return cval_unknown;
      ((void) ((c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize", "cval.c", 566, __PRETTY_FUNCTION__), 0)));
      c1.u.i.real.si = truncate_signed(c1.u.i.real.si - c2.u.i.real.si, c1.u.i.isize);
      return c1;
    case cval_uint:
      if (c2.kind == cval_address)
        return cval_unknown;
      ((void) ((c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize", "cval.c", 573, __PRETTY_FUNCTION__), 0)));
      c1.u.i.real.ui = truncate_unsigned(c1.u.i.real.ui - c2.u.i.real.ui, c1.u.i.isize);
      return c1;
    case cval_float_complex:
      ((void) ((c2.kind == cval_float_complex) ? 0 : (__assert_fail ("c2.kind == cval_float_complex", "cval.c", 578, __PRETTY_FUNCTION__), 0)));
      c1.u.fl.d -= c2.u.fl.d;
      c1.u.fl.d_i -= c2.u.fl.d_i;
      return c1;
    case cval_sint_complex:
      ((void) ((c2.kind == cval_sint_complex && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_sint_complex && c1.u.i.isize == c2.u.i.isize", "cval.c", 584, __PRETTY_FUNCTION__), 0)));
      c1.u.i.real.si = truncate_signed(c1.u.i.real.si - c2.u.i.real.si, c1.u.i.isize);
      c1.u.i.imag.si_i = truncate_signed(c1.u.i.imag.si_i - c2.u.i.imag.si_i, c1.u.i.isize);
      return c1;
    case cval_uint_complex:
      ((void) ((c2.kind == cval_uint_complex && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_uint_complex && c1.u.i.isize == c2.u.i.isize", "cval.c", 590, __PRETTY_FUNCTION__), 0)));
      c1.u.i.real.ui = truncate_unsigned(c1.u.i.real.ui - c2.u.i.real.ui, c1.u.i.isize);
      c1.u.i.imag.ui_i = truncate_unsigned(c1.u.i.imag.ui_i - c2.u.i.imag.ui_i, c1.u.i.isize);
      return c1;
    default:
      ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 596, __PRETTY_FUNCTION__), 0)));
      return c1;
    }
}
cval cval_times(cval c1, cval c2)
{
  ...
  if (cval_iscomplex(c1))
    {
      ...
      ((void) ((cval_iscomplex(c2)) ? 0 : (__assert_fail ("cval_iscomplex(c2)", "cval.c", 619, __PRETTY_FUNCTION__), 0)));
  ...
  switch (c1.kind)
    {
    case cval_float:
      ((void) ((c2.kind == cval_float) ? 0 : (__assert_fail ("c2.kind == cval_float", "cval.c", 632, __PRETTY_FUNCTION__), 0)));
      c1.u.fl.d *= c2.u.fl.d;
      return c1;
    case cval_address:
      return cval_isone(c2) ? c1 : cval_unknown;
    case cval_sint:
      ((void) ((c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize", "cval.c", 640, __PRETTY_FUNCTION__), 0)));
      c1.u.i.real.si = truncate_signed(c1.u.i.real.si * c2.u.i.real.si, c1.u.i.isize);
      return c1;
    case cval_uint:
      ((void) ((c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize", "cval.c", 645, __PRETTY_FUNCTION__), 0)));
      c1.u.i.real.ui = truncate_unsigned(c1.u.i.real.ui * c2.u.i.real.ui, c1.u.i.isize);
      return c1;
    default:
      ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 650, __PRETTY_FUNCTION__), 0)));
      return c1;
    }
}
cval cval_divide(cval c1, cval c2)
{
  ...
  if (cval_iscomplex(c1))
    {
      ...
      ((void) ((cval_iscomplex(c2)) ? 0 : (__assert_fail ("cval_iscomplex(c2)", "cval.c", 669, __PRETTY_FUNCTION__), 0)));
  ...
  switch (c1.kind)
    {
    case cval_float:
      ((void) ((c2.kind == cval_float) ? 0 : (__assert_fail ("c2.kind == cval_float", "cval.c", 684, __PRETTY_FUNCTION__), 0)));
      c1.u.fl.d /= c2.u.fl.d;
      return c1;
    case cval_address:
      return cval_isone(c2) ? c1 : cval_unknown;
    case cval_sint:
      if (c2.kind == cval_address)
        return cval_unknown;
      ((void) ((c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize", "cval.c", 694, __PRETTY_FUNCTION__), 0)));
      if (c2.u.i.real.si == 0)
        return cval_top;
      c1.u.i.real.si = truncate_signed(c1.u.i.real.si / c2.u.i.real.si, c1.u.i.isize);
      return c1;
    case cval_uint:
      if (c2.kind == cval_address)
        return cval_unknown;
      ((void) ((c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize", "cval.c", 704, __PRETTY_FUNCTION__), 0)));
      if (c2.u.i.real.ui == 0)
        return cval_top;
      c1.u.i.real.ui /= c2.u.i.real.ui;
      return c1;
    default:
      ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 711, __PRETTY_FUNCTION__), 0)));
      return c1;
    }
}
cval cval_modulo(cval c1, cval c2)
{
  ...
  if (((c1).kind == cval_unk) || ((c2).kind == cval_unk) ||
      ((c1).kind == cval_address) || ((c2).kind == cval_address))
    return cval_unknown;
  switch (c1.kind)
    {
    case cval_float:
      ((void) ((c2.kind == cval_float) ? 0 : (__assert_fail ("c2.kind == cval_float", "cval.c", 731, __PRETTY_FUNCTION__), 0)));
      c1.u.fl.d /= c2.u.fl.d;
      return c1;
    case cval_sint:
      ((void) ((c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize", "cval.c", 736, __PRETTY_FUNCTION__), 0)));
      if (c2.u.i.real.si == 0)
        return cval_top;
      c1.u.i.real.si = truncate_signed(c1.u.i.real.si % c2.u.i.real.si, c1.u.i.isize);
      return c1;
    case cval_uint:
      ((void) ((c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize", "cval.c", 743, __PRETTY_FUNCTION__), 0)));
      if (c2.u.i.real.ui == 0)
        return cval_top;
      c1.u.i.real.ui %= c2.u.i.real.ui;
      return c1;
    default:
      ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 750, __PRETTY_FUNCTION__), 0)));
      return c1;
    }
}
cval cval_lshift(cval c1, cval c2) { if (((c1).kind == cval_variable) || ((c2).kind == cval_variable)) return cval_top; if (((c1).kind == cval_unk) || ((c2).kind == cval_unk) || ((c1).kind == cval_address) || ((c2).kind == cval_address)) return cval_unknown; ((void) ((c1.kind == c2.kind && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c1.kind == c2.kind && c1.u.i.isize == c2.u.i.isize", "cval.c", 781, __PRETTY_FUNCTION__), 0))); switch (c1.kind) { case cval_sint: c1.u.i.real.si = truncate_signed(c1.u.i.real.si << c2.u.i.real.si, c1.u.i.isize); return c1; case cval_uint: c1.u.i.real.ui = truncate_signed(c1.u.i.real.ui << c2.u.i.real.ui, c1.u.i.isize); return c1; default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 781, __PRETTY_FUNCTION__), 0))); return c1; } }
cval cval_rshift(cval c1, cval c2) { if (((c1).kind == cval_variable) || ((c2).kind == cval_variable)) return cval_top; if (((c1).kind == cval_unk) || ((c2).kind == cval_unk) || ((c1).kind == cval_address) || ((c2).kind == cval_address)) return cval_unknown; ((void) ((c1.kind == c2.kind && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c1.kind == c2.kind && c1.u.i.isize == c2.u.i.isize", "cval.c", 782, __PRETTY_FUNCTION__), 0))); switch (c1.kind) { case cval_sint: c1.u.i.real.si = truncate_signed(c1.u.i.real.si >> c2.u.i.real.si, c1.u.i.isize); return c1; case cval_uint: c1.u.i.real.ui = truncate_signed(c1.u.i.real.ui >> c2.u.i.real.ui, c1.u.i.isize); return c1; default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 782, __PRETTY_FUNCTION__), 0))); return c1; } }
cval cval_bitand(cval c1, cval c2) { if (((c1).kind == cval_variable) || ((c2).kind == cval_variable)) return cval_top; if (((c1).kind == cval_unk) || ((c2).kind == cval_unk) || ((c1).kind == cval_address) || ((c2).kind == cval_address)) return cval_unknown; ((void) ((c1.kind == c2.kind && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c1.kind == c2.kind && c1.u.i.isize == c2.u.i.isize", "cval.c", 783, __PRETTY_FUNCTION__), 0))); switch (c1.kind) { case cval_sint: c1.u.i.real.si = truncate_signed(c1.u.i.real.si & c2.u.i.real.si, c1.u.i.isize); return c1; case cval_uint: c1.u.i.real.ui = truncate_signed(c1.u.i.real.ui & c2.u.i.real.ui, c1.u.i.isize); return c1; default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 783, __PRETTY_FUNCTION__), 0))); return c1; } }
cval cval_bitor(cval c1, cval c2) { if (((c1).kind == cval_variable) || ((c2).kind == cval_variable)) return cval_top; if (((c1).kind == cval_unk) || ((c2).kind == cval_unk) || ((c1).kind == cval_address) || ((c2).kind == cval_address)) return cval_unknown; ((void) ((c1.kind == c2.kind && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c1.kind == c2.kind && c1.u.i.isize == c2.u.i.isize", "cval.c", 784, __PRETTY_FUNCTION__), 0))); switch (c1.kind) { case cval_sint: c1.u.i.real.si = truncate_signed(c1.u.i.real.si | c2.u.i.real.si, c1.u.i.isize); return c1; case cval_uint: c1.u.i.real.ui = truncate_signed(c1.u.i.real.ui | c2.u.i.real.ui, c1.u.i.isize); return c1; default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 784, __PRETTY_FUNCTION__), 0))); return c1; } }
cval cval_bitxor(cval c1, cval c2) { if (((c1).kind == cval_variable) || ((c2).kind == cval_variable)) return cval_top; if (((c1).kind == cval_unk) || ((c2).kind == cval_unk) || ((c1).kind == cval_address) || ((c2).kind == cval_address)) return cval_unknown; ((void) ((c1.kind == c2.kind && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c1.kind == c2.kind && c1.u.i.isize == c2.u.i.isize", "cval.c", 785, __PRETTY_FUNCTION__), 0))); switch (c1.kind) { case cval_sint: c1.u.i.real.si = truncate_signed(c1.u.i.real.si ^ c2.u.i.real.si, c1.u.i.isize); return c1; case cval_uint: c1.u.i.real.ui = truncate_signed(c1.u.i.real.ui ^ c2.u.i.real.ui, c1.u.i.isize); return c1; default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 785, __PRETTY_FUNCTION__), 0))); return c1; } }
static cval cval_simpleeq(cval c1, cval c2) { bool res; if (((c1).kind == cval_variable) || ((c2).kind == cval_variable)) return cval_top; if (((c1).kind == cval_unk) || ((c2).kind == cval_unk) || ((c1).kind == cval_address) || ((c2).kind == cval_address)) return cval_unknown; switch (c1.kind) { case cval_float: ((void) ((c2.kind == cval_float) ? 0 : (__assert_fail ("c2.kind == cval_float", "cval.c", 824, __PRETTY_FUNCTION__), 0))); res = c1.u.fl.d == c2.u.fl.d; break; case cval_sint: ((void) ((c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize", "cval.c", 824, __PRETTY_FUNCTION__), 0))); res = c1.u.i.real.si == c2.u.i.real.si; break; case cval_uint: ((void) ((c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize", "cval.c", 824, __PRETTY_FUNCTION__), 0))); res = c1.u.i.real.ui == c2.u.i.real.ui; break; default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 824, __PRETTY_FUNCTION__), 0))); res = 0; break; } return make_cval_signed(res, int_type); }
cval cval_leq(cval c1, cval c2) { bool res; if (((c1).kind == cval_variable) || ((c2).kind == cval_variable)) return cval_top; if (((c1).kind == cval_unk) || ((c2).kind == cval_unk) || ((c1).kind == cval_address) || ((c2).kind == cval_address)) return cval_unknown; switch (c1.kind) { case cval_float: ((void) ((c2.kind == cval_float) ? 0 : (__assert_fail ("c2.kind == cval_float", "cval.c", 825, __PRETTY_FUNCTION__), 0))); res = c1.u.fl.d <= c2.u.fl.d; break; case cval_sint: ((void) ((c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_sint && c1.u.i.isize == c2.u.i.isize", "cval.c", 825, __PRETTY_FUNCTION__), 0))); res = c1.u.i.real.si <= c2.u.i.real.si; break; case cval_uint: ((void) ((c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize) ? 0 : (__assert_fail ("c2.kind == cval_uint && c1.u.i.isize == c2.u.i.isize", "cval.c", 825, __PRETTY_FUNCTION__), 0))); res = c1.u.i.real.ui <= c2.u.i.real.ui; break; default: ((void) ((0) ? 0 : (__assert_fail ("0", "cval.c", 825, __PRETTY_FUNCTION__), 0))); res = 0; break; } return make_cval_signed(res, int_type); }
cval cval_eq(cval c1, cval c2)
{
...
bool uint_inrange(largest_uint x, type t)
{
  ...
  largest_uint max;
  ((void) ((tsize <= sizeof(largest_uint)) ? 0 : (__assert_fail ("tsize <= sizeof(largest_uint)", "cval.c", 846, __PRETTY_FUNCTION__), 0)));
  if (tsize == sizeof(largest_uint) && type_unsigned(t))
    return 1;
  max = (largest_uint)1 << (8U * tsize - !type_unsigned(t));
  return x < max;
}
bool sint_inrange(largest_int x, type t)
{
  size_t tsize = type_size(t);
  largest_int max;
  ((void) ((tsize <= sizeof(largest_uint)) ? 0 : (__assert_fail ("tsize <= sizeof(largest_uint)", "cval.c", 861, __PRETTY_FUNCTION__), 0)));
  if (x < 0 && type_unsigned(t))
    return 0;
  if (tsize == sizeof(largest_uint))
    return 1;
  max = (largest_int)1 << (8U * tsize - !type_unsigned(t));
  return x >= -max && x < max;
}
bool cval_inrange(cval c, type t)
{
  switch (c.kind)
    {
    case cval_sint: return sint_inrange(c.u.i.real.si, t);
    case cval_uint: return uint_inrange(c.u.i.real.ui, t);
  ...
  switch (c1.kind)
    ...
    case cval_sint:
      switch (c2.kind)
        {
        case cval_sint:
          return c1.u.i.real.si - c2.u.i.real.si;
        case cval_uint:
          if (c1.u.i.real.si < 0 || c1.u.i.real.si < c2.u.i.real.ui)
            return -1;
          return c1.u.i.real.si - c2.u.i.real.ui;
        default: abort(); return 0;
        }
    case cval_uint:
      switch (c2.kind)
        {
        case cval_sint:
          if (c2.u.i.real.si < 0 || c1.u.i.real.ui < c2.u.i.real.si)
            return 1;
          return (c1.u.i.real.ui - c2.u.i.real.si) > 0;
        case cval_uint:
          if (c1.u.i.real.ui < c2.u.i.real.ui)
            return -1;
          if (c1.u.i.real.ui > c2.u.i.real.ui)
            return 1;
          return 0;
...
const char CANON_IDENT_171eefd1c2a068c35170efebb48dc25b[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/cval.c";
