...
void builtins_init(void);extern type builtin_va_list_type;
...
bool builtin_declaration(data_declaration dd)
{
  return (__extension__ (__builtin_constant_p (10) && ((__builtin_constant_p (dd->name) && strlen (dd->name) < ((size_t) (10))) || (__builtin_constant_p ("__builtin_") && strlen ("__builtin_") < ((size_t) (10)))) ? __extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (dd->name) && __builtin_constant_p ("__builtin_") && (__s1_len = strlen (dd->name), __s2_len = strlen ("__builtin_"), (!((size_t)(const void *)((dd->name) + 1) - (size_t)(const void *)(dd->name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("__builtin_") + 1) - (size_t)(const void *)("__builtin_") == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (dd->name), (__const char *) ("__builtin_"), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (dd->name) && ((size_t)(const void *)((dd->name) + 1) - (size_t)(const void *)(dd->name) == 1) && (__s1_len = strlen (dd->name), __s1_len < 4) ? (__builtin_constant_p ("__builtin_") && ((size_t)(const void *)(("__builtin_") + 1) - (size_t)(const void *)("__builtin_") == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (dd->name))[0] - ((__const unsigned char *) (__const char *)("__builtin_"))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (dd->name))[1] - ((__const unsigned char *) (__const char *) ("__builtin_"))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (dd->name))[2] - ((__const unsigned char *) (__const char *) ("__builtin_"))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (dd->name))[3] - ((__const unsigned char *) (__const char *) ("__builtin_"))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("__builtin_"); register int __result = (((__const unsigned char *) (__const char *) (dd->name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (dd->name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (dd->name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (dd->name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("__builtin_") && ((size_t)(const void *)(("__builtin_") + 1) - (size_t)(const void *)("__builtin_") == 1) && (__s2_len = strlen ("__builtin_"), __s2_len < 4) ? (__builtin_constant_p (dd->name) && ((size_t)(const void *)((dd->name) + 1) - (size_t)(const void *)(dd->name) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (dd->name))[0] - ((__const unsigned char *) (__const char *)("__builtin_"))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (dd->name))[1] - ((__const unsigned char *) (__const char *) ("__builtin_"))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (dd->name))[2] - ((__const unsigned char *) (__const char *) ("__builtin_"))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (dd->name))[3] - ((__const unsigned char *) (__const char *) ("__builtin_"))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (dd->name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("__builtin_"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("__builtin_"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("__builtin_"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("__builtin_"))[3]); } } __result; }))) : strcmp (dd->name, "__builtin_")))); }) : strncmp (dd->name, "__builtin_", 10))) == 0;
}
const char CANON_IDENT_d5b884669ccf35c6bf2ff947099c2789[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/builtins.c";
