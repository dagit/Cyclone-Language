...
char *string_to_charp(region r, string s);static FILE *of;
...
{
  int i;
  for (i = 0; i < indent_level; i++) _IO_putc (' ', of);
}
...
static void set_location(location l)
{
  ...
  if ((l->filename != output_loc.filename &&
       __extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (l->filename) && __builtin_constant_p (output_loc.filename) && (__s1_len = strlen (l->filename), __s2_len = strlen (output_loc.filename), (!((size_t)(const void *)((l->filename) + 1) - (size_t)(const void *)(l->filename) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((output_loc.filename) + 1) - (size_t)(const void *)(output_loc.filename) == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (l->filename), (__const char *) (output_loc.filename), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (l->filename) && ((size_t)(const void *)((l->filename) + 1) - (size_t)(const void *)(l->filename) == 1) && (__s1_len = strlen (l->filename), __s1_len < 4) ? (__builtin_constant_p (output_loc.filename) && ((size_t)(const void *)((output_loc.filename) + 1) - (size_t)(const void *)(output_loc.filename) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (l->filename))[0] - ((__const unsigned char *) (__const char *)(output_loc.filename))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->filename))[1] - ((__const unsigned char *) (__const char *) (output_loc.filename))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->filename))[2] - ((__const unsigned char *) (__const char *) (output_loc.filename))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (l->filename))[3] - ((__const unsigned char *) (__const char *) (output_loc.filename))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (output_loc.filename); register int __result = (((__const unsigned char *) (__const char *) (l->filename))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->filename))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->filename))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (l->filename))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (output_loc.filename) && ((size_t)(const void *)((output_loc.filename) + 1) - (size_t)(const void *)(output_loc.filename) == 1) && (__s2_len = strlen (output_loc.filename), __s2_len < 4) ? (__builtin_constant_p (l->filename) && ((size_t)(const void *)((l->filename) + 1) - (size_t)(const void *)(l->filename) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (l->filename))[0] - ((__const unsigned char *) (__const char *)(output_loc.filename))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->filename))[1] - ((__const unsigned char *) (__const char *) (output_loc.filename))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->filename))[2] - ((__const unsigned char *) (__const char *) (output_loc.filename))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (l->filename))[3] - ((__const unsigned char *) (__const char *) (output_loc.filename))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (l->filename); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (output_loc.filename))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (output_loc.filename))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (output_loc.filename))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (output_loc.filename))[3]); } } __result; }))) : strcmp (l->filename, output_loc.filename)))); })) ||
      l->in_system_header != output_loc.in_system_header)
    output_line_directive(l, 1);
...
void prt_simple_declarator(declarator d, bool);
...
{
  declaration d;
  for (d = (dlist); d; d = ({ast_generic tEmPcast = (ast_generic)(d->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "unparse.c", 302, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
...
void prt_toplevel_declaration(declaration d)
{
  ...
  switch (d->kind)
    {
      case kind_asm_decl: prt_asm_decl(({ast_generic tEmPcast = (ast_generic)((d)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_asm_decl && (tEmPcast)->kind <= postkind_asm_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_asm_decl && (tEmPcast)->kind <= postkind_asm_decl)", "unparse.c", 313, __PRETTY_FUNCTION__), 0))); (asm_decl)(tEmPcast); })); return;
      case kind_data_decl: prt_data_decl(({ast_generic tEmPcast = (ast_generic)((d)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)", "unparse.c", 314, __PRETTY_FUNCTION__), 0))); (data_decl)(tEmPcast); })); return;
      case kind_function_decl: prt_function_decl(({ast_generic tEmPcast = (ast_generic)((d)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_decl && (tEmPcast)->kind <= postkind_function_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_decl && (tEmPcast)->kind <= postkind_function_decl)", "unparse.c", 315, __PRETTY_FUNCTION__), 0))); (function_decl)(tEmPcast); })); return;
      case kind_extension_decl: prt_extension_decl(({ast_generic tEmPcast = (ast_generic)((d)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_extension_decl && (tEmPcast)->kind <= postkind_extension_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_extension_decl && (tEmPcast)->kind <= postkind_extension_decl)", "unparse.c", 316, __PRETTY_FUNCTION__), 0))); (extension_decl)(tEmPcast); })); return;
    default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 317, __PRETTY_FUNCTION__), 0))); break;
    }
}
void prt_asm_decl(asm_decl d)
{
...
void prt_data_decl(data_decl d)
{
  ...
  prt_type_elements(({ast_generic tEmPcast = (ast_generic)(d->attributes); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)", "unparse.c", 345, __PRETTY_FUNCTION__), 0))); (type_element)(tEmPcast); }));
  for (vd = (d->decls); vd; vd = ({ast_generic tEmPcast = (ast_generic)(vd->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "unparse.c", 347, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
    {
      prt_variable_decl(({ast_generic tEmPcast = (ast_generic)(vd); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_variable_decl && (tEmPcast)->kind <= postkind_variable_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_variable_decl && (tEmPcast)->kind <= postkind_variable_decl)", "unparse.c", 349, __PRETTY_FUNCTION__), 0))); (variable_decl)(tEmPcast); }));
      if (vd->next)
        output(", ");
    }
  outputln(";");
...
{
  declaration d;
  for (d = (dlist); d; d = ({ast_generic tEmPcast = (ast_generic)(d->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "unparse.c", 360, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
...
void prt_parameter_declaration(declaration d)
{
  ...
  switch (d->kind)
    {
      case kind_data_decl: prt_data_decl(({ast_generic tEmPcast = (ast_generic)((d)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)", "unparse.c", 369, __PRETTY_FUNCTION__), 0))); (data_decl)(tEmPcast); })); return;
      case kind_ellipsis_decl: prt_ellipsis_decl(({ast_generic tEmPcast = (ast_generic)((d)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_ellipsis_decl && (tEmPcast)->kind <= postkind_ellipsis_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_ellipsis_decl && (tEmPcast)->kind <= postkind_ellipsis_decl)", "unparse.c", 370, __PRETTY_FUNCTION__), 0))); (ellipsis_decl)(tEmPcast); })); return;
    default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 371, __PRETTY_FUNCTION__), 0))); break;
    }
}
void prt_function_decl(function_decl d)
{
  ...
  ((void) ((((d->stmt)->kind >= kind_compound_stmt && (d->stmt)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((d->stmt)->kind >= kind_compound_stmt && (d->stmt)->kind <= postkind_compound_stmt)", "unparse.c", 380, __PRETTY_FUNCTION__), 0)));
  prt_statement(d->stmt);
  newline();
}
void prt_variable_decl(variable_decl d)
{
  prt_declarator(d->declarator, ((void *)0), d->attributes);
  if (d->asm_stmt)
    prt_asm_stmt_plain(d->asm_stmt);
  if (d->arg1)
    {
      output(" = ");
      prt_expression(d->arg1, 1);
    }
}
void prt_declarator(declarator d, type_element elements, attribute attributes)
{
  prt_type_elements(elements);
  prt_type_elements(({ast_generic tEmPcast = (ast_generic)(attributes); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)", "unparse.c", 402, __PRETTY_FUNCTION__), 0))); (type_element)(tEmPcast); }));
  ...
  if (d)
    switch (d->kind)
      ...
      case kind_function_declarator:
        prt_simple_declarator(({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_declarator && (tEmPcast)->kind <= postkind_function_declarator)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_declarator && (tEmPcast)->kind <= postkind_function_declarator)", "unparse.c", 412, __PRETTY_FUNCTION__), 0))); (function_declarator)(tEmPcast); })->declarator, 1);
        prt_parameters(({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_declarator && (tEmPcast)->kind <= postkind_function_declarator)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_declarator && (tEmPcast)->kind <= postkind_function_declarator)", "unparse.c", 413, __PRETTY_FUNCTION__), 0))); (function_declarator)(tEmPcast); })->parms);
        break;
      case kind_array_declarator:
        {
          array_declarator ad = ({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_array_declarator && (tEmPcast)->kind <= postkind_array_declarator)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_array_declarator && (tEmPcast)->kind <= postkind_array_declarator)", "unparse.c", 417, __PRETTY_FUNCTION__), 0))); (array_declarator)(tEmPcast); });
          prt_simple_declarator(ad->declarator, 1);
          if (!ad->arg1)
            output("[]");
          else
            {
      ...
      case kind_pointer_declarator:
        {
          ...
          prt_simple_declarator(pd->declarator, 0);
          if (not_star)
            output(")");
          break;
        }
      case kind_identifier_declarator:
        set_location(d->loc);
        output_cstring(({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier_declarator && (tEmPcast)->kind <= postkind_identifier_declarator)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier_declarator && (tEmPcast)->kind <= postkind_identifier_declarator)", "unparse.c", 448, __PRETTY_FUNCTION__), 0))); (identifier_declarator)(tEmPcast); })->cstring);
        break;
      default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 451, __PRETTY_FUNCTION__), 0))); break;
      }
}
void prt_type_elements(type_element elements)
{
  type_element em;
  for (em = (elements); em; em = ({ast_generic tEmPcast = (ast_generic)(em->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)", "unparse.c", 459, __PRETTY_FUNCTION__), 0))); (type_element)(tEmPcast); }))
    {
      prt_type_element(em);
      output(" ");
    }
...
void prt_type_element(type_element em)
{
  switch (em->kind)
    {
      case kind_typename: prt_typename(({ast_generic tEmPcast = (ast_generic)((em)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_typename && (tEmPcast)->kind <= postkind_typename)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_typename && (tEmPcast)->kind <= postkind_typename)", "unparse.c", 470, __PRETTY_FUNCTION__), 0))); (typename)(tEmPcast); })); return;
      case kind_typeof_expr: prt_typeof_expr(({ast_generic tEmPcast = (ast_generic)((em)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_typeof_expr && (tEmPcast)->kind <= postkind_typeof_expr)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_typeof_expr && (tEmPcast)->kind <= postkind_typeof_expr)", "unparse.c", 471, __PRETTY_FUNCTION__), 0))); (typeof_expr)(tEmPcast); })); return;
      case kind_typeof_type: prt_typeof_type(({ast_generic tEmPcast = (ast_generic)((em)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_typeof_type && (tEmPcast)->kind <= postkind_typeof_type)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_typeof_type && (tEmPcast)->kind <= postkind_typeof_type)", "unparse.c", 472, __PRETTY_FUNCTION__), 0))); (typeof_type)(tEmPcast); })); return;
      case kind_attribute: prt_attribute(({ast_generic tEmPcast = (ast_generic)((em)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_attribute && (tEmPcast)->kind <= postkind_attribute)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_attribute && (tEmPcast)->kind <= postkind_attribute)", "unparse.c", 473, __PRETTY_FUNCTION__), 0))); (attribute)(tEmPcast); })); return;
      case kind_rid: prt_rid(({ast_generic tEmPcast = (ast_generic)((em)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_rid && (tEmPcast)->kind <= postkind_rid)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_rid && (tEmPcast)->kind <= postkind_rid)", "unparse.c", 474, __PRETTY_FUNCTION__), 0))); (rid)(tEmPcast); })); return;
      case kind_qualifier: prt_qualifier(({ast_generic tEmPcast = (ast_generic)((em)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_qualifier && (tEmPcast)->kind <= postkind_qualifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_qualifier && (tEmPcast)->kind <= postkind_qualifier)", "unparse.c", 475, __PRETTY_FUNCTION__), 0))); (qualifier)(tEmPcast); })); return;
      case kind_user_qual: prt_user_qual(({ast_generic tEmPcast = (ast_generic)((em)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_user_qual && (tEmPcast)->kind <= postkind_user_qual)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_user_qual && (tEmPcast)->kind <= postkind_user_qual)", "unparse.c", 476, __PRETTY_FUNCTION__), 0))); (user_qual)(tEmPcast); })); return;
    default:
      if (((em)->kind >= kind_tag_ref && (em)->kind <= postkind_tag_ref))
        prt_tag_ref(({ast_generic tEmPcast = (ast_generic)(em); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_tag_ref && (tEmPcast)->kind <= postkind_tag_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_tag_ref && (tEmPcast)->kind <= postkind_tag_ref)", "unparse.c", 479, __PRETTY_FUNCTION__), 0))); (tag_ref)(tEmPcast); }));
      else
        ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 481, __PRETTY_FUNCTION__), 0)));
      break;
    }
}
void prt_typename(typename tname)
  ...
  if (a->word2 || a->args)
    {
      ...
      if (a->word2)
        prt_word(a->word2);
      prt_expressions(a->args, a->word2 == ((void *)0));
      output(")");
    }
  output("))");
}
...
void prt_tag_ref(tag_ref tr)
{
  ...
  switch (tr->kind)
    ...
    default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 550, __PRETTY_FUNCTION__), 0)));
    }
  if (tr->word1)
    prt_word(tr->word1);
  if (tr->defined)
  ...
  if (tr->attributes)
    {
      output(" ");
      prt_type_elements(({ast_generic tEmPcast = (ast_generic)(tr->attributes); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)", "unparse.c", 565, __PRETTY_FUNCTION__), 0))); (type_element)(tEmPcast); }));
    }
}
void prt_enumerators(declaration elist)
{
  ...
  indent();
  startline();
  for (d = (elist); d; d = ({ast_generic tEmPcast = (ast_generic)(d->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "unparse.c", 576, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
    {
      prt_enumerator(({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_enumerator && (tEmPcast)->kind <= postkind_enumerator)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_enumerator && (tEmPcast)->kind <= postkind_enumerator)", "unparse.c", 578, __PRETTY_FUNCTION__), 0))); (enumerator)(tEmPcast); }));
      if (d->next)
        output(", ");
    }
  unindent();
...
void prt_fields(declaration flist)
{
  ...
  indent();
  startline();
  for (d = (flist); d; d = ({ast_generic tEmPcast = (ast_generic)(d->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "unparse.c", 594, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
...
void prt_field_declaration(declaration d)
{
  if (((d)->kind >= kind_extension_decl && (d)->kind <= postkind_extension_decl))
    prt_field_extension_decl(({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_extension_decl && (tEmPcast)->kind <= postkind_extension_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_extension_decl && (tEmPcast)->kind <= postkind_extension_decl)", "unparse.c", 604, __PRETTY_FUNCTION__), 0))); (extension_decl)(tEmPcast); }));
  else
    prt_field_data_decl(({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)", "unparse.c", 606, __PRETTY_FUNCTION__), 0))); (data_decl)(tEmPcast); }));
}
void prt_field_extension_decl(extension_decl d)
{
  set_location(d->loc);
...
void prt_field_data_decl(data_decl d)
{
  declaration fd;
  prt_type_elements(d->modifiers);
  prt_type_elements(({ast_generic tEmPcast = (ast_generic)(d->attributes); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)", "unparse.c", 621, __PRETTY_FUNCTION__), 0))); (type_element)(tEmPcast); }));
  for (fd = (d->decls); fd; fd = ({ast_generic tEmPcast = (ast_generic)(fd->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "unparse.c", 623, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
    {
      prt_field_decl(({ast_generic tEmPcast = (ast_generic)(fd); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_field_decl && (tEmPcast)->kind <= postkind_field_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_field_decl && (tEmPcast)->kind <= postkind_field_decl)", "unparse.c", 625, __PRETTY_FUNCTION__), 0))); (field_decl)(tEmPcast); }));
      if (fd->next)
        output(", ");
    }
  outputln(";");
...
void prt_field_decl(field_decl fd)
{
  prt_declarator(fd->declarator, ((void *)0), fd->attributes);
  if (fd->arg1)
    {
      output(" : ");
      prt_expression(fd->arg1, -1);
    }
}
void prt_enumerator(enumerator ed)
{
...
void prt_parameters(declaration parms)
{
  ...
  bool forward = 0;
  output("(");
  for (d = (parms); d; d = ({ast_generic tEmPcast = (ast_generic)(d->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "unparse.c", 659, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
    {
      forward = prt_parameter(d, d == parms, forward);
    }
  output(")");
}
bool prt_parameter(declaration parm, bool first, bool lastforward)
{
  switch (parm->kind)
    ...
    case kind_oldidentifier_decl:
      ...
      output_cstring(({ast_generic tEmPcast = (ast_generic)(parm); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_oldidentifier_decl && (tEmPcast)->kind <= postkind_oldidentifier_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_oldidentifier_decl && (tEmPcast)->kind <= postkind_oldidentifier_decl)", "unparse.c", 674, __PRETTY_FUNCTION__), 0))); (oldidentifier_decl)(tEmPcast); })->cstring);
      return 0;
    ...
    case kind_data_decl:
      {
        data_decl dd = ({ast_generic tEmPcast = (ast_generic)(parm); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)", "unparse.c", 684, __PRETTY_FUNCTION__), 0))); (data_decl)(tEmPcast); });
        variable_decl vd = ({ast_generic tEmPcast = (ast_generic)(dd->decls); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_variable_decl && (tEmPcast)->kind <= postkind_variable_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_variable_decl && (tEmPcast)->kind <= postkind_variable_decl)", "unparse.c", 685, __PRETTY_FUNCTION__), 0))); (variable_decl)(tEmPcast); });
        if (lastforward && !vd->forward)
          output("; ");
        else if (!first)
          output(", ");
        prt_type_elements(({ast_generic tEmPcast = (ast_generic)(dd->attributes); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_type_element && (tEmPcast)->kind <= postkind_type_element)", "unparse.c", 691, __PRETTY_FUNCTION__), 0))); (type_element)(tEmPcast); }));
        prt_declarator(vd->declarator, dd->modifiers, vd->attributes);
        return vd->forward;
      }
    default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 696, __PRETTY_FUNCTION__), 0))); return 0;
    }
}
void prt_asttype(asttype t)
{
  prt_declarator(t->declarator, t->qualifiers, ((void *)0));
}
void prt_word(word w)
{
  set_location(w->loc);
...
{
  expression e;
  for (e = (elist); e; e = ({ast_generic tEmPcast = (ast_generic)(e->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "unparse.c", 715, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
    {
      if (!isfirst) output(", ");
      isfirst = 0;
      prt_expression(e, 1);
...
void prt_expression(expression e, int context_priority)
{
  switch (e->kind)
    {
      case kind_comma: prt_comma(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_comma && (tEmPcast)->kind <= postkind_comma)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_comma && (tEmPcast)->kind <= postkind_comma)", "unparse.c", 732, __PRETTY_FUNCTION__), 0))); (comma)(tEmPcast); }), context_priority); return;
      case kind_sizeof_type: prt_sizeof_type(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_sizeof_type && (tEmPcast)->kind <= postkind_sizeof_type)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_sizeof_type && (tEmPcast)->kind <= postkind_sizeof_type)", "unparse.c", 733, __PRETTY_FUNCTION__), 0))); (sizeof_type)(tEmPcast); }), context_priority); return;
      case kind_alignof_type: prt_alignof_type(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_alignof_type && (tEmPcast)->kind <= postkind_alignof_type)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_alignof_type && (tEmPcast)->kind <= postkind_alignof_type)", "unparse.c", 734, __PRETTY_FUNCTION__), 0))); (alignof_type)(tEmPcast); }), context_priority); return;
      case kind_label_address: prt_label_address(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_label_address && (tEmPcast)->kind <= postkind_label_address)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_label_address && (tEmPcast)->kind <= postkind_label_address)", "unparse.c", 735, __PRETTY_FUNCTION__), 0))); (label_address)(tEmPcast); }), context_priority); return;
      case kind_cast: prt_cast(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_cast && (tEmPcast)->kind <= postkind_cast)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_cast && (tEmPcast)->kind <= postkind_cast)", "unparse.c", 736, __PRETTY_FUNCTION__), 0))); (cast)(tEmPcast); }), context_priority); return;
      case kind_cast_list: prt_cast_list(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_cast_list && (tEmPcast)->kind <= postkind_cast_list)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_cast_list && (tEmPcast)->kind <= postkind_cast_list)", "unparse.c", 737, __PRETTY_FUNCTION__), 0))); (cast_list)(tEmPcast); }), context_priority); return;
      case kind_conditional: prt_conditional(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)", "unparse.c", 738, __PRETTY_FUNCTION__), 0))); (conditional)(tEmPcast); }), context_priority); return;
      case kind_identifier: prt_identifier(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "unparse.c", 739, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); }), context_priority); return;
      case kind_compound_expr: prt_compound_expr(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_expr && (tEmPcast)->kind <= postkind_compound_expr)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_expr && (tEmPcast)->kind <= postkind_compound_expr)", "unparse.c", 740, __PRETTY_FUNCTION__), 0))); (compound_expr)(tEmPcast); }), context_priority); return;
      case kind_function_call: prt_function_call(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_call && (tEmPcast)->kind <= postkind_function_call)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_call && (tEmPcast)->kind <= postkind_function_call)", "unparse.c", 741, __PRETTY_FUNCTION__), 0))); (function_call)(tEmPcast); }), context_priority); return;
      case kind_array_ref: prt_array_ref(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_array_ref && (tEmPcast)->kind <= postkind_array_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_array_ref && (tEmPcast)->kind <= postkind_array_ref)", "unparse.c", 742, __PRETTY_FUNCTION__), 0))); (array_ref)(tEmPcast); }), context_priority); return;
      case kind_field_ref: prt_field_ref(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)", "unparse.c", 743, __PRETTY_FUNCTION__), 0))); (field_ref)(tEmPcast); }), context_priority); return;
      case kind_init_list: prt_init_list(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_init_list && (tEmPcast)->kind <= postkind_init_list)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_init_list && (tEmPcast)->kind <= postkind_init_list)", "unparse.c", 744, __PRETTY_FUNCTION__), 0))); (init_list)(tEmPcast); }), context_priority); return;
      case kind_init_index: prt_init_index(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_init_index && (tEmPcast)->kind <= postkind_init_index)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_init_index && (tEmPcast)->kind <= postkind_init_index)", "unparse.c", 745, __PRETTY_FUNCTION__), 0))); (init_index)(tEmPcast); }), context_priority); return;
      case kind_init_field: prt_init_field(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_init_field && (tEmPcast)->kind <= postkind_init_field)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_init_field && (tEmPcast)->kind <= postkind_init_field)", "unparse.c", 746, __PRETTY_FUNCTION__), 0))); (init_field)(tEmPcast); }), context_priority); return;
    case kind_string_cst:
      case kind_lexical_cst: prt_lexical_cst(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_lexical_cst && (tEmPcast)->kind <= postkind_lexical_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_lexical_cst && (tEmPcast)->kind <= postkind_lexical_cst)", "unparse.c", 748, __PRETTY_FUNCTION__), 0))); (lexical_cst)(tEmPcast); }), context_priority); return;
      case kind_string: prt_string(({ast_generic tEmPcast = (ast_generic)((e)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_string && (tEmPcast)->kind <= postkind_string)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_string && (tEmPcast)->kind <= postkind_string)", "unparse.c", 749, __PRETTY_FUNCTION__), 0))); (string)(tEmPcast); }), context_priority); return;
    default:
      if (((e)->kind >= kind_unary && (e)->kind <= postkind_unary))
        {
          prt_unary(({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)", "unparse.c", 753, __PRETTY_FUNCTION__), 0))); (unary)(tEmPcast); }), context_priority);
          return;
        }
      ((void) ((((e)->kind >= kind_binary && (e)->kind <= postkind_binary)) ? 0 : (__assert_fail ("((e)->kind >= kind_binary && (e)->kind <= postkind_binary)", "unparse.c", 756, __PRETTY_FUNCTION__), 0)));
      prt_binary(({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)", "unparse.c", 757, __PRETTY_FUNCTION__), 0))); (binary)(tEmPcast); }), context_priority);
      return;
    }
}
void prt_comma(comma e, int context_priority)
{
  if (0 < context_priority) output("(");
  prt_expressions(e->arg1, 1);
  if (0 < context_priority) output(")");
}
void prt_sizeof_type(sizeof_type e, int context_priority)
{
...
void prt_cast(cast e, int context_priority)
{
  if (13 < context_priority) output("(");
  set_location(e->loc);
  output("(");
  prt_asttype(e->asttype);
  output(")");
  prt_expression(e->arg1, 13);
  if (13 < context_priority) output(")");
}
void prt_cast_list(cast_list e, int context_priority)
{
  ...
  prt_asttype(e->asttype);
  output(")");
  prt_init_list(({ast_generic tEmPcast = (ast_generic)(e->init_expr); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_init_list && (tEmPcast)->kind <= postkind_init_list)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_init_list && (tEmPcast)->kind <= postkind_init_list)", "unparse.c", 818, __PRETTY_FUNCTION__), 0))); (init_list)(tEmPcast); }), 1);
  if (13 < context_priority) output(")");
}
void prt_conditional(conditional e, int context_priority)
{
  if (2 < context_priority) output("(");
  prt_expression(e->condition, 2);
  output(" ? ");
  if (e->arg1)
    prt_expression(e->arg1, 2);
  output(" : ");
  prt_expression(e->arg2, 2);
  if (2 < context_priority) output(")");
}
void prt_identifier(identifier e, int context_priority)
{
...
void prt_compound_expr(compound_expr e, int context_priority)
{
  set_location(e->loc);
  output("(");
  prt_compound_stmt(({ast_generic tEmPcast = (ast_generic)(e->stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)", "unparse.c", 844, __PRETTY_FUNCTION__), 0))); (compound_stmt)(tEmPcast); }));
  output(")");
}
void prt_function_call(function_call e, int context_priority)
{
  if (e->va_arg_call)
    ...
    {
      prt_expression(e->arg1, 14);
      output("(");
      prt_expressions(e->args, 1);
      output(")");
    }
}
void prt_array_ref(array_ref e, int context_priority)
...
void prt_field_ref(field_ref e, int context_priority)
{
  if (((e->arg1)->kind >= kind_dereference && (e->arg1)->kind <= postkind_dereference))
    {
      prt_expression(({ast_generic tEmPcast = (ast_generic)(e->arg1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_dereference && (tEmPcast)->kind <= postkind_dereference)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_dereference && (tEmPcast)->kind <= postkind_dereference)", "unparse.c", 890, __PRETTY_FUNCTION__), 0))); (dereference)(tEmPcast); })->arg1, 14);
      output("->");
    }
  else
    {
...
void prt_unary(unary e, int context_priority)
{
  char *op = ((void *)0), *postop = ((void *)0);
  int pri = 0;
  if (((e)->kind >= kind_dereference && (e)->kind <= postkind_dereference) && ((e->arg1)->kind >= kind_plus && (e->arg1)->kind <= postkind_plus))
    {
      plus derefed = ({ast_generic tEmPcast = (ast_generic)(e->arg1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_plus && (tEmPcast)->kind <= postkind_plus)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_plus && (tEmPcast)->kind <= postkind_plus)", "unparse.c", 912, __PRETTY_FUNCTION__), 0))); (plus)(tEmPcast); });
  ...
  switch (e->kind)
    ...
    default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 940, __PRETTY_FUNCTION__), 0))); return;
    }
  if (13 < context_priority) output("(");
  set_location(e->loc);
  if (op)
    {
      output(op);
      if (((e->arg1)->kind >= kind_unary && (e->arg1)->kind <= postkind_unary))
        output(" ");
      if (!pri)
        pri = 13;
    }
  prt_expression(e->arg1, pri ? pri : 14);
  if (postop)
    output(postop);
  if (13 < context_priority) output(")");
}
const char *binary_op_name(ast_kind kind)
{
  switch (kind)
    ...
    default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 991, __PRETTY_FUNCTION__), 0))); return "<bad>";
    }
}
void prt_binary(binary e, int context_priority)
{
  ...
  switch (e->kind)
    ...
    default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 1062, __PRETTY_FUNCTION__), 0))); return;
    }
  if (pri < context_priority) output("(");
...
{
  expression s;
  for (s = (e->strings); s; s = ({ast_generic tEmPcast = (ast_generic)(s->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "unparse.c", 1082, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
    prt_expression(s, -1);
}
void prt_init_list(init_list e, int context_priority)
{
...
void prt_statement(statement s)
{
  switch (s->kind)
    {
      case kind_asm_stmt: prt_asm_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_asm_stmt && (tEmPcast)->kind <= postkind_asm_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_asm_stmt && (tEmPcast)->kind <= postkind_asm_stmt)", "unparse.c", 1119, __PRETTY_FUNCTION__), 0))); (asm_stmt)(tEmPcast); })); return;
      case kind_compound_stmt: prt_compound_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)", "unparse.c", 1120, __PRETTY_FUNCTION__), 0))); (compound_stmt)(tEmPcast); })); return;
      case kind_if_stmt: prt_if_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_if_stmt && (tEmPcast)->kind <= postkind_if_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_if_stmt && (tEmPcast)->kind <= postkind_if_stmt)", "unparse.c", 1121, __PRETTY_FUNCTION__), 0))); (if_stmt)(tEmPcast); })); return;
      case kind_labeled_stmt: prt_labeled_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)", "unparse.c", 1122, __PRETTY_FUNCTION__), 0))); (labeled_stmt)(tEmPcast); })); return;
      case kind_expression_stmt: prt_expression_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)", "unparse.c", 1123, __PRETTY_FUNCTION__), 0))); (expression_stmt)(tEmPcast); })); return;
      case kind_while_stmt: prt_while_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_while_stmt && (tEmPcast)->kind <= postkind_while_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_while_stmt && (tEmPcast)->kind <= postkind_while_stmt)", "unparse.c", 1124, __PRETTY_FUNCTION__), 0))); (while_stmt)(tEmPcast); })); return;
      case kind_dowhile_stmt: prt_dowhile_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_dowhile_stmt && (tEmPcast)->kind <= postkind_dowhile_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_dowhile_stmt && (tEmPcast)->kind <= postkind_dowhile_stmt)", "unparse.c", 1125, __PRETTY_FUNCTION__), 0))); (dowhile_stmt)(tEmPcast); })); return;
      case kind_switch_stmt: prt_switch_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_switch_stmt && (tEmPcast)->kind <= postkind_switch_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_switch_stmt && (tEmPcast)->kind <= postkind_switch_stmt)", "unparse.c", 1126, __PRETTY_FUNCTION__), 0))); (switch_stmt)(tEmPcast); })); return;
      case kind_for_stmt: prt_for_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_for_stmt && (tEmPcast)->kind <= postkind_for_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_for_stmt && (tEmPcast)->kind <= postkind_for_stmt)", "unparse.c", 1127, __PRETTY_FUNCTION__), 0))); (for_stmt)(tEmPcast); })); return;
      case kind_break_stmt: prt_break_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_break_stmt && (tEmPcast)->kind <= postkind_break_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_break_stmt && (tEmPcast)->kind <= postkind_break_stmt)", "unparse.c", 1128, __PRETTY_FUNCTION__), 0))); (break_stmt)(tEmPcast); })); return;
      case kind_continue_stmt: prt_continue_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_continue_stmt && (tEmPcast)->kind <= postkind_continue_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_continue_stmt && (tEmPcast)->kind <= postkind_continue_stmt)", "unparse.c", 1129, __PRETTY_FUNCTION__), 0))); (continue_stmt)(tEmPcast); })); return;
      case kind_return_stmt: prt_return_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_return_stmt && (tEmPcast)->kind <= postkind_return_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_return_stmt && (tEmPcast)->kind <= postkind_return_stmt)", "unparse.c", 1130, __PRETTY_FUNCTION__), 0))); (return_stmt)(tEmPcast); })); return;
      case kind_goto_stmt: prt_goto_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_goto_stmt && (tEmPcast)->kind <= postkind_goto_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_goto_stmt && (tEmPcast)->kind <= postkind_goto_stmt)", "unparse.c", 1131, __PRETTY_FUNCTION__), 0))); (goto_stmt)(tEmPcast); })); return;
      case kind_computed_goto_stmt: prt_computed_goto_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_computed_goto_stmt && (tEmPcast)->kind <= postkind_computed_goto_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_computed_goto_stmt && (tEmPcast)->kind <= postkind_computed_goto_stmt)", "unparse.c", 1132, __PRETTY_FUNCTION__), 0))); (computed_goto_stmt)(tEmPcast); })); return;
      case kind_empty_stmt: prt_empty_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_empty_stmt && (tEmPcast)->kind <= postkind_empty_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_empty_stmt && (tEmPcast)->kind <= postkind_empty_stmt)", "unparse.c", 1133, __PRETTY_FUNCTION__), 0))); (empty_stmt)(tEmPcast); })); return;
      case kind_assert_type_stmt: prt_assert_type_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_assert_type_stmt && (tEmPcast)->kind <= postkind_assert_type_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_assert_type_stmt && (tEmPcast)->kind <= postkind_assert_type_stmt)", "unparse.c", 1134, __PRETTY_FUNCTION__), 0))); (assert_type_stmt)(tEmPcast); })); return;
      case kind_change_type_stmt: prt_change_type_stmt(({ast_generic tEmPcast = (ast_generic)((s)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_change_type_stmt && (tEmPcast)->kind <= postkind_change_type_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_change_type_stmt && (tEmPcast)->kind <= postkind_change_type_stmt)", "unparse.c", 1135, __PRETTY_FUNCTION__), 0))); (change_type_stmt)(tEmPcast); })); return;
    default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 1136, __PRETTY_FUNCTION__), 0))); return;
    }
}
static void prt_as_compound(statement s)
{
  if (!((s)->kind >= kind_compound_stmt && (s)->kind <= postkind_compound_stmt))
    outputln("{");
  prt_statement(s);
  if (!((s)->kind >= kind_compound_stmt && (s)->kind <= postkind_compound_stmt))
    {
...
void prt_compound_stmt(compound_stmt s)
{
  ...
  if (s->id_labels)
    {
      id_label l;
      output("__label__ ");
      for (l = (s->id_labels); l; l = ({ast_generic tEmPcast = (ast_generic)(l->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_id_label && (tEmPcast)->kind <= postkind_id_label)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_id_label && (tEmPcast)->kind <= postkind_id_label)", "unparse.c", 1164, __PRETTY_FUNCTION__), 0))); (id_label)(tEmPcast); }))
        {
          prt_id_label(l);
          if (l->next)
            output(", ");
  ...
  for (s1 = (s->stmts); s1; s1 = ({ast_generic tEmPcast = (ast_generic)(s1->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)", "unparse.c", 1178, __PRETTY_FUNCTION__), 0))); (statement)(tEmPcast); }))
    prt_statement(s1);
  unindent();
  outputln("}");
}
...
{
  declaration d;
  for (d = (dlist); d; d = ({ast_generic tEmPcast = (ast_generic)(d->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "unparse.c", 1189, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
...
void prt_compound_declaration(declaration d)
{
  ...
  switch (d->kind)
    {
      case kind_data_decl: prt_data_decl(({ast_generic tEmPcast = (ast_generic)((d)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_data_decl && (tEmPcast)->kind <= postkind_data_decl)", "unparse.c", 1198, __PRETTY_FUNCTION__), 0))); (data_decl)(tEmPcast); })); return;
      case kind_extension_decl: prt_extension_decl(({ast_generic tEmPcast = (ast_generic)((d)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_extension_decl && (tEmPcast)->kind <= postkind_extension_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_extension_decl && (tEmPcast)->kind <= postkind_extension_decl)", "unparse.c", 1199, __PRETTY_FUNCTION__), 0))); (extension_decl)(tEmPcast); })); return;
      case kind_function_decl: prt_function_decl(({ast_generic tEmPcast = (ast_generic)((d)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_decl && (tEmPcast)->kind <= postkind_function_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_decl && (tEmPcast)->kind <= postkind_function_decl)", "unparse.c", 1200, __PRETTY_FUNCTION__), 0))); (function_decl)(tEmPcast); })); return;
    default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 1201, __PRETTY_FUNCTION__), 0))); break;
    }
}
void prt_asm_stmt(asm_stmt s)
{
      ...
      if (s->asm_operands2 || s->asm_clobbers)
        {
          ...
          if (s->asm_clobbers)
            {
              output(" : ");
              prt_expressions(({ast_generic tEmPcast = (ast_generic)(s->asm_clobbers); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "unparse.c", 1232, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }), 1);
            }
        }
    }
  output(")");
...
{
  asm_operand o;
  for (o = (olist); o; o = ({ast_generic tEmPcast = (ast_generic)(o->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_asm_operand && (tEmPcast)->kind <= postkind_asm_operand)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_asm_operand && (tEmPcast)->kind <= postkind_asm_operand)", "unparse.c", 1243, __PRETTY_FUNCTION__), 0))); (asm_operand)(tEmPcast); }))
    {
      prt_asm_operand(o);
      if (o->next)
        output(", ");
...
void prt_asm_operand(asm_operand o)
{
  prt_string(o->string, -1);
  output("(");
  prt_expression(o->arg1, -1);
  output(")");
}
void prt_if_stmt(if_stmt s)
{
  set_location(s->loc);
  output("if (");
  prt_expression(s->condition, 1 ? 2 : -1);
  output(") ");
  indent();
...
void prt_for_stmt(for_stmt s)
{
  ...
  output("; ");
  if (s->arg2)
    prt_expression(s->arg2, -1);
  output("; ");
  if (s->arg3)
    prt_expression(s->arg3, -1);
  output(") ");
  indent();
  prt_statement(s->stmt);
  unindent();
...
void prt_label(label l)
{
  switch (l->kind)
    {
      case kind_id_label: prt_id_label(({ast_generic tEmPcast = (ast_generic)((l)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_id_label && (tEmPcast)->kind <= postkind_id_label)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_id_label && (tEmPcast)->kind <= postkind_id_label)", "unparse.c", 1419, __PRETTY_FUNCTION__), 0))); (id_label)(tEmPcast); })); return;
      case kind_case_label: prt_case_label(({ast_generic tEmPcast = (ast_generic)((l)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_case_label && (tEmPcast)->kind <= postkind_case_label)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_case_label && (tEmPcast)->kind <= postkind_case_label)", "unparse.c", 1420, __PRETTY_FUNCTION__), 0))); (case_label)(tEmPcast); })); return;
      case kind_default_label: prt_default_label(({ast_generic tEmPcast = (ast_generic)((l)); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_default_label && (tEmPcast)->kind <= postkind_default_label)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_default_label && (tEmPcast)->kind <= postkind_default_label)", "unparse.c", 1421, __PRETTY_FUNCTION__), 0))); (default_label)(tEmPcast); })); return;
    default: ((void) ((0) ? 0 : (__assert_fail ("0", "unparse.c", 1422, __PRETTY_FUNCTION__), 0))); return;
    }
}
void prt_id_label(id_label l)
{
...
void prt_case_label(case_label l)
{
  set_location(l->loc);
  output("case ");
  prt_expression(l->arg1, 1);
  if (l->arg2)
    {
      output(" ... ");
      prt_expression(l->arg2, 1);
    }
}
void prt_default_label(default_label l)
{
...
const char CANON_IDENT_18d2a14d9b647d95feb6e34c76f3c557[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/unparse.c";
