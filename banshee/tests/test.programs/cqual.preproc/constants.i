...
{
  known_cst kc = (sizeof(struct known_cst) < (1 << (13 - 3)) ? (((void)0), __rc_ralloc_small0)((parse_region), sizeof(struct known_cst)) : (((void)0), __rc_typed_ralloc)((parse_region), sizeof(struct known_cst), 0));
  kc->type = t;
  kc->cval = c;
  return kc;
}
...
known_cst fold_label_address(expression e)
{
  return make_address_cst(((void *)0), ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_label_address && (tEmPcast)->kind <= postkind_label_address)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_label_address && (tEmPcast)->kind <= postkind_label_address)", "constants.c", 92, __PRETTY_FUNCTION__), 0))); (label_address)(tEmPcast); })->id_label->ldecl, 0, e->type);
}
known_cst fold_sizeof(expression e, type stype)
{
...
known_cst fold_cast(expression e)
{
  cast cc = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_cast && (tEmPcast)->kind <= postkind_cast)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_cast && (tEmPcast)->kind <= postkind_cast)", "constants.c", 114, __PRETTY_FUNCTION__), 0))); (cast)(tEmPcast); });
...
known_cst fold_unary(expression e)
{
  unary u = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)", "constants.c", 125, __PRETTY_FUNCTION__), 0))); (unary)(tEmPcast); });
  ...
  if (arg)
    {
      switch (u->kind)
        ...
        default:
          ((void) ((0) ? 0 : (__assert_fail ("0", "constants.c", 163, __PRETTY_FUNCTION__), 0)));
          break;
        }
    }
  return ((void *)0);
...
static known_cst fold_sub(type restype, known_cst c1, known_cst c2)
{
  ...
  basetype = type_pointer(t1) ? t1 : type_pointer(t2) ? t2 : ((void *)0);
  if (basetype)
    {
...
{
  binary b = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)", "constants.c", 236, __PRETTY_FUNCTION__), 0))); (binary)(tEmPcast); });
  ...
  if (b->kind == kind_andand || b->kind == kind_oror)
    {
      bool c1val;
      if (c1 && cval_knownbool((c1)->cval) &&
          (c1val = cval_boolvalue((c1)->cval), b->kind == kind_andand ? !c1val : c1val))
        return make_signed_cst(0, t);
      if (c1 && c2)
        {
          if (cval_knownbool((c2)->cval))
            return make_signed_cst(cval_boolvalue((c2)->cval), t);
          else
  ...
  else if (c1 && c2)
    {
      ...
      switch (b->kind)
        ...
        case kind_leq: case kind_geq: case kind_lt: case kind_gt: {
          ...
          case kind_ne: res = (cval_not(cval_eq((cv1), (cv2)))); break;
          case kind_leq: res = cval_leq(cv1, cv2); break;
          case kind_geq: res = (cval_leq((cv2), (cv1))); break;
          case kind_lt: res = ((cval_not(cval_leq(((cv2)), ((cv1)))))); break;
          case kind_gt: res = (cval_not(cval_leq((cv1), (cv2)))); break;
          default: abort(); return ((void *)0);
          }
          return make_cst(res, t);
        }
        default:
          ((void) ((0) ? 0 : (__assert_fail ("0", "constants.c", 315, __PRETTY_FUNCTION__), 0))); return ((void *)0);
        }
      }
  return ((void *)0);
}
known_cst fold_conditional(expression e)
{
  conditional c = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)", "constants.c", 324, __PRETTY_FUNCTION__), 0))); (conditional)(tEmPcast); });
  known_cst cond = c->condition->cst;
  if (cond && cval_knownbool((cond)->cval))
    {
      expression value =
        cval_boolvalue((cond)->cval) ? (c->arg1 ? c->arg1 : c->condition) : c->arg2;
...
known_cst foldaddress_identifier(expression e, data_declaration decl)
{
  if ((decl->kind == decl_function && decl->ftype != function_nested) ||
    ...
    return make_address_cst(decl, ((void *)0), 0, make_pointer_type(e->type));
  else
    return ((void *)0);
}
known_cst foldaddress_string(string s)
{
  return make_address_cst(s->ddecl, ((void *)0), 0, s->type);
}
known_cst foldaddress_field_ref(known_cst object, field_declaration fdecl)
{
  if (!object || !fdecl->offset_cc || fdecl->bitwidth >= 0)
    return ((void *)0);
  if ((((object)->cval).kind == cval_unk))
    return make_unknown_cst(object->type);
  return fold_add(object->type, object,
                  make_unsigned_cst(fdecl->offset / 8U, size_t_type));
}
lexical_cst fold_lexical_real(type realtype, location loc, cstring tok)
{
  lexical_cst c = new_lexical_cst(parse_region, loc, tok);
  cval realvalue = make_cval_float(strtold(tok.data, ((void *)0)));
                               ...
                               bool wide_flag, wchar_array stringvalue)
{
  ...
  wchar_t *chars = (((void)0), __rc_typed_rarrayalloc)((parse_region), (length), sizeof(wchar_t), 0);
...
bool is_one_constant(known_cst c)
{
  return cval_knownbool(c->cval) && cval_boolvalue((c)->cval);
}
bool is_zero_constant(known_cst c)
{
  return cval_knownbool(c->cval) && !cval_boolvalue((c)->cval);
...
const char CANON_IDENT_30cbfa78eb31740bb45190ecd87e276b[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/constants.c";
