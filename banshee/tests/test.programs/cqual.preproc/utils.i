...
{
  cstring cs;
  cs.data = (((void)0), __rc_rstralloc)(r, l + 1);
  memcpy(cs.data, s, l);
  cs.data[l] = '\0';
  cs.length = l;
  return cs;
...
{
  char *result = (((void)0), __rc_typed_rarrayalloc)((r), (strlen(s1)+strlen(s2)+1), sizeof(char), 0);
  result[0] = '\0';
  strcat(result, s1);
  strcat(result, s2);
  return result;
...
char *rstrscat(region r, ...)
{
  ...
  while ((s = __builtin_va_arg(args, const char *)))
    len += strlen(s);
  result = (((void)0), __rc_typed_rarrayalloc)((r), (len+1), sizeof(char), 0);
  result[0] = '\0';
  __builtin_stdarg_start((args),r);
  while ((s = __builtin_va_arg(args, const char *)))
    strcat(result, s);
...
const char *inttostr(region r, int i)
{
  ...
  for (count = 10; i >= count; count *= 10)
    width++;
  result = (((void)0), __rc_typed_rarrayalloc)((r), (width + 1), sizeof(char), 0);
  if (snprintf(result, width + 1, "%d", i) == -1) {
    printf("i=%d, width=%d\n", i, width);
    __fail("utils.c", 241, __FUNCTION__, "inttostr width wrong\n");
  }
  return result;
}
char *rsprintf(region r, const char *fmt, ...)
...
char *ptr_to_ascii(void *ptr) {
  static char addr[((int) (3 + sizeof(void *)*2))];
  int nchars;
  nchars = snprintf(addr, ((int) (3 + sizeof(void *)*2)), "%p", ptr);
  if (nchars == -1 || nchars >= ((int) (3 + sizeof(void *)*2)))
    __fail("utils.c", 275, __FUNCTION__, "Unable to convert ptr to ascii (need %d bytes, have %d)\n", nchars, ((int) (3 + sizeof(void *)*2)));
  return addr;
}
unsigned long ptr_hash(void *ptr)
{
...
bool string_eq(const char *s1, const char *s2)
{
  if (!s1 || !s2)
    return 0;
  return !__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (s1) && __builtin_constant_p (s2) && (__s1_len = strlen (s1), __s2_len = strlen (s2), (!((size_t)(const void *)((s1) + 1) - (size_t)(const void *)(s1) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((s2) + 1) - (size_t)(const void *)(s2) == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (s1), (__const char *) (s2), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (s1) && ((size_t)(const void *)((s1) + 1) - (size_t)(const void *)(s1) == 1) && (__s1_len = strlen (s1), __s1_len < 4) ? (__builtin_constant_p (s2) && ((size_t)(const void *)((s2) + 1) - (size_t)(const void *)(s2) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (s1))[0] - ((__const unsigned char *) (__const char *)(s2))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (s1))[1] - ((__const unsigned char *) (__const char *) (s2))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (s1))[2] - ((__const unsigned char *) (__const char *) (s2))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (s1))[3] - ((__const unsigned char *) (__const char *) (s2))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (s2); register int __result = (((__const unsigned char *) (__const char *) (s1))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (s1))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (s1))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (s1))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (s2) && ((size_t)(const void *)((s2) + 1) - (size_t)(const void *)(s2) == 1) && (__s2_len = strlen (s2), __s2_len < 4) ? (__builtin_constant_p (s1) && ((size_t)(const void *)((s1) + 1) - (size_t)(const void *)(s1) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (s1))[0] - ((__const unsigned char *) (__const char *)(s2))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (s1))[1] - ((__const unsigned char *) (__const char *) (s2))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (s1))[2] - ((__const unsigned char *) (__const char *) (s2))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (s1))[3] - ((__const unsigned char *) (__const char *) (s2))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (s1); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (s2))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (s2))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (s2))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (s2))[3]); } } __result; }))) : strcmp (s1, s2)))); });
}
int ptr_cmp(void *ptr1, void *ptr2)
{
...
const char *name_with_loc(region r, const char *name, location loc) {
  ...
  int base_len;
  char *base_name;
  if ((index = (__extension__ (__builtin_constant_p ("@") && ((size_t)(const void *)(("@") + 1) - (size_t)(const void *)("@") == 1) ? (((__const char *) ("@"))[0] == '\0' ? (char *) (size_t) (name) : (((__const char *) ("@"))[1] == '\0' ? (__extension__ (__builtin_constant_p (((__const char *) ("@"))[0]) && (((__const char *) ("@"))[0]) == '\0' ? (char *) __rawmemchr (name, ((__const char *) ("@"))[0]) : strchr (name, ((__const char *) ("@"))[0]))) : strstr (name, "@"))) : strstr (name, "@")))))
    base_len = index - name;
  else
    base_len = strlen(name);
  base_name = __builtin_alloca ((base_len + 2) * sizeof(char));
  (__extension__ (__builtin_constant_p (name) && __builtin_constant_p (base_len) ? (strlen (name) + 1 >= ((size_t) (base_len)) ? (char *) memcpy (base_name, name, base_len) : strncpy (base_name, name, base_len)) : strncpy (base_name, name, base_len)));
  base_name[base_len] = '@';
  base_name[base_len+1] = '\0';
  return rstrcat(r, base_name, inttostr(r, loc->lineno));
}
const char CANON_IDENT_7f6f35979e54566263d1994e3ce8d93f[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/utils.c";
