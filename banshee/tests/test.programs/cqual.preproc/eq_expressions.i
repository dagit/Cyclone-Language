...
bool equal_expressions(expression e1, expression e2)
{
  ...
  case kind_conditional:
    {
      conditional c1 = ({ast_generic tEmPcast = (ast_generic)(e1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)", "eq_expressions.c", 54, __PRETTY_FUNCTION__), 0))); (conditional)(tEmPcast); });
      conditional c2 = ({ast_generic tEmPcast = (ast_generic)(e2); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)", "eq_expressions.c", 55, __PRETTY_FUNCTION__), 0))); (conditional)(tEmPcast); });
      ...
      if (c1->arg1)
        {
          ((void) ((c2->arg1) ? 0 : (__assert_fail ("c2->arg1", "eq_expressions.c", 63, __PRETTY_FUNCTION__), 0)));
  ...
  case kind_identifier:
    {
      identifier id1 = ({ast_generic tEmPcast = (ast_generic)(e1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "eq_expressions.c", 72, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); });
      identifier id2 = ({ast_generic tEmPcast = (ast_generic)(e2); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_identifier && (tEmPcast)->kind <= postkind_identifier)", "eq_expressions.c", 73, __PRETTY_FUNCTION__), 0))); (identifier)(tEmPcast); });
      return root_ddecl(id1->ddecl) == root_ddecl(id2->ddecl);
    }
    break;
  case kind_function_call:
    {
      function_call fc1 = ({ast_generic tEmPcast = (ast_generic)(e1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_call && (tEmPcast)->kind <= postkind_function_call)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_call && (tEmPcast)->kind <= postkind_function_call)", "eq_expressions.c", 79, __PRETTY_FUNCTION__), 0))); (function_call)(tEmPcast); });
      function_call fc2 = ({ast_generic tEmPcast = (ast_generic)(e2); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_call && (tEmPcast)->kind <= postkind_function_call)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_call && (tEmPcast)->kind <= postkind_function_call)", "eq_expressions.c", 80, __PRETTY_FUNCTION__), 0))); (function_call)(tEmPcast); });
      expression arg1, arg2;
      if (!equal_expressions(fc1->arg1, fc2->arg1))
        return 0;
      arg2 = fc2->args;
      for (arg1 = (fc1->args); arg1; arg1 = ({ast_generic tEmPcast = (ast_generic)(arg1->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "eq_expressions.c", 87, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
        {
          if (!arg2 || !equal_expressions(arg1, arg2))
            return 0;
          arg2 = ({ast_generic tEmPcast = (ast_generic)(arg2->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "eq_expressions.c", 92, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); });
        }
      return arg2 ? 0 : 1;
    }
  case kind_field_ref:
    {
      field_ref fr1 = ({ast_generic tEmPcast = (ast_generic)(e1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)", "eq_expressions.c", 98, __PRETTY_FUNCTION__), 0))); (field_ref)(tEmPcast); });
      field_ref fr2 = ({ast_generic tEmPcast = (ast_generic)(e2); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)", "eq_expressions.c", 99, __PRETTY_FUNCTION__), 0))); (field_ref)(tEmPcast); });
      return equal_expressions(fr1->arg1, fr2->arg1) &&
        !__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (fr1->cstring.data) && __builtin_constant_p (fr2->cstring.data) && (__s1_len = strlen (fr1->cstring.data), __s2_len = strlen (fr2->cstring.data), (!((size_t)(const void *)((fr1->cstring.data) + 1) - (size_t)(const void *)(fr1->cstring.data) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((fr2->cstring.data) + 1) - (size_t)(const void *)(fr2->cstring.data) == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (fr1->cstring.data), (__const char *) (fr2->cstring.data), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (fr1->cstring.data) && ((size_t)(const void *)((fr1->cstring.data) + 1) - (size_t)(const void *)(fr1->cstring.data) == 1) && (__s1_len = strlen (fr1->cstring.data), __s1_len < 4) ? (__builtin_constant_p (fr2->cstring.data) && ((size_t)(const void *)((fr2->cstring.data) + 1) - (size_t)(const void *)(fr2->cstring.data) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[0] - ((__const unsigned char *) (__const char *)(fr2->cstring.data))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[1] - ((__const unsigned char *) (__const char *) (fr2->cstring.data))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[2] - ((__const unsigned char *) (__const char *) (fr2->cstring.data))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[3] - ((__const unsigned char *) (__const char *) (fr2->cstring.data))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (fr2->cstring.data); register int __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (fr2->cstring.data) && ((size_t)(const void *)((fr2->cstring.data) + 1) - (size_t)(const void *)(fr2->cstring.data) == 1) && (__s2_len = strlen (fr2->cstring.data), __s2_len < 4) ? (__builtin_constant_p (fr1->cstring.data) && ((size_t)(const void *)((fr1->cstring.data) + 1) - (size_t)(const void *)(fr1->cstring.data) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[0] - ((__const unsigned char *) (__const char *)(fr2->cstring.data))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[1] - ((__const unsigned char *) (__const char *) (fr2->cstring.data))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[2] - ((__const unsigned char *) (__const char *) (fr2->cstring.data))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (fr1->cstring.data))[3] - ((__const unsigned char *) (__const char *) (fr2->cstring.data))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (fr1->cstring.data); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (fr2->cstring.data))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (fr2->cstring.data))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (fr2->cstring.data))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (fr2->cstring.data))[3]); } } __result; }))) : strcmp (fr1->cstring.data, fr2->cstring.data)))); });
    }
  case kind_array_ref:
    {
      array_ref ar1 = ({ast_generic tEmPcast = (ast_generic)(e1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_array_ref && (tEmPcast)->kind <= postkind_array_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_array_ref && (tEmPcast)->kind <= postkind_array_ref)", "eq_expressions.c", 106, __PRETTY_FUNCTION__), 0))); (array_ref)(tEmPcast); });
      array_ref ar2 = ({ast_generic tEmPcast = (ast_generic)(e2); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_array_ref && (tEmPcast)->kind <= postkind_array_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_array_ref && (tEmPcast)->kind <= postkind_array_ref)", "eq_expressions.c", 107, __PRETTY_FUNCTION__), 0))); (array_ref)(tEmPcast); });
      return equal_expressions(ar1->arg1, ar2->arg1) &&
        equal_expressions(ar1->arg2, ar2->arg2);
    }
  case kind_lexical_cst:
    {
      lexical_cst lc1 = ({ast_generic tEmPcast = (ast_generic)(e1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_lexical_cst && (tEmPcast)->kind <= postkind_lexical_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_lexical_cst && (tEmPcast)->kind <= postkind_lexical_cst)", "eq_expressions.c", 114, __PRETTY_FUNCTION__), 0))); (lexical_cst)(tEmPcast); });
      lexical_cst lc2 = ({ast_generic tEmPcast = (ast_generic)(e2); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_lexical_cst && (tEmPcast)->kind <= postkind_lexical_cst)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_lexical_cst && (tEmPcast)->kind <= postkind_lexical_cst)", "eq_expressions.c", 115, __PRETTY_FUNCTION__), 0))); (lexical_cst)(tEmPcast); });
      return !__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (lc1->cstring.data) && __builtin_constant_p (lc2->cstring.data) && (__s1_len = strlen (lc1->cstring.data), __s2_len = strlen (lc2->cstring.data), (!((size_t)(const void *)((lc1->cstring.data) + 1) - (size_t)(const void *)(lc1->cstring.data) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((lc2->cstring.data) + 1) - (size_t)(const void *)(lc2->cstring.data) == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (lc1->cstring.data), (__const char *) (lc2->cstring.data), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (lc1->cstring.data) && ((size_t)(const void *)((lc1->cstring.data) + 1) - (size_t)(const void *)(lc1->cstring.data) == 1) && (__s1_len = strlen (lc1->cstring.data), __s1_len < 4) ? (__builtin_constant_p (lc2->cstring.data) && ((size_t)(const void *)((lc2->cstring.data) + 1) - (size_t)(const void *)(lc2->cstring.data) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[0] - ((__const unsigned char *) (__const char *)(lc2->cstring.data))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[1] - ((__const unsigned char *) (__const char *) (lc2->cstring.data))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[2] - ((__const unsigned char *) (__const char *) (lc2->cstring.data))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[3] - ((__const unsigned char *) (__const char *) (lc2->cstring.data))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (lc2->cstring.data); register int __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (lc2->cstring.data) && ((size_t)(const void *)((lc2->cstring.data) + 1) - (size_t)(const void *)(lc2->cstring.data) == 1) && (__s2_len = strlen (lc2->cstring.data), __s2_len < 4) ? (__builtin_constant_p (lc1->cstring.data) && ((size_t)(const void *)((lc1->cstring.data) + 1) - (size_t)(const void *)(lc1->cstring.data) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[0] - ((__const unsigned char *) (__const char *)(lc2->cstring.data))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[1] - ((__const unsigned char *) (__const char *) (lc2->cstring.data))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[2] - ((__const unsigned char *) (__const char *) (lc2->cstring.data))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (lc1->cstring.data))[3] - ((__const unsigned char *) (__const char *) (lc2->cstring.data))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (lc1->cstring.data); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (lc2->cstring.data))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (lc2->cstring.data))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (lc2->cstring.data))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (lc2->cstring.data))[3]); } } __result; }))) : strcmp (lc1->cstring.data, lc2->cstring.data)))); });
    }
  default:
    if (((e1)->kind >= kind_unary && (e1)->kind <= postkind_unary) && ((e2)->kind >= kind_unary && (e2)->kind <= postkind_unary))
      return equal_unary_expressions(({ast_generic tEmPcast = (ast_generic)(e1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)", "eq_expressions.c", 121, __PRETTY_FUNCTION__), 0))); (unary)(tEmPcast); }), ({ast_generic tEmPcast = (ast_generic)(e2); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)", "eq_expressions.c", 121, __PRETTY_FUNCTION__), 0))); (unary)(tEmPcast); }));
    else if (((e1)->kind >= kind_binary && (e1)->kind <= postkind_binary) && ((e2)->kind >= kind_binary && (e2)->kind <= postkind_binary))
      return equal_binary_expressions(({ast_generic tEmPcast = (ast_generic)(e1); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)", "eq_expressions.c", 123, __PRETTY_FUNCTION__), 0))); (binary)(tEmPcast); }), ({ast_generic tEmPcast = (ast_generic)(e2); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)", "eq_expressions.c", 123, __PRETTY_FUNCTION__), 0))); (binary)(tEmPcast); }));
    else
      return 0;
  }
}
...
const char CANON_IDENT_69b1fde7c3932d1b8d924373d9d1d31d[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/eq_expressions.c";
