...
void set_input(FILE *f, char *filename)
{
  ...
  input_file_stack->next = ((void *)0);
  finput = f;
}
const char CANON_IDENT_6782acdcb37cb525a707652872b48fb0[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/input.c";
