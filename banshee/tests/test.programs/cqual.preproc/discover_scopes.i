...
void discover_scopes(declaration program)
{
  ...
  AST_set_parents(({ast_generic tEmPcast = (ast_generic)(program); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_node && (tEmPcast)->kind <= postkind_node)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_node && (tEmPcast)->kind <= postkind_node)", "discover_scopes.c", 48, __PRETTY_FUNCTION__), 0))); (node)(tEmPcast); }));
  pending_region = newregion();
  for (d = (program); d; d = ({ast_generic tEmPcast = (ast_generic)(d->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "discover_scopes.c", 52, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
    {
...
static void discover_scopes_declaration(declaration d)
{
  switch (d->kind)
    ...
    case kind_function_decl:
      {
        function_decl fd = ({ast_generic tEmPcast = (ast_generic)(d); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_decl && (tEmPcast)->kind <= postkind_function_decl)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_decl && (tEmPcast)->kind <= postkind_function_decl)", "discover_scopes.c", 66, __PRETTY_FUNCTION__), 0))); (function_decl)(tEmPcast); });
        ((void) ((((fd->stmt)->kind >= kind_compound_stmt && (fd->stmt)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((fd->stmt)->kind >= kind_compound_stmt && (fd->stmt)->kind <= postkind_compound_stmt)", "discover_scopes.c", 68, __PRETTY_FUNCTION__), 0)));
...
{
  int pos = 0;
  statement stmt = ((void *)0), new_block_end = ((void *)0), new_block_snd = ((void *)0);
  statement succ = ((void *)0),prev = ((void *)0),pred = ((void *)0), new_compound = ((void *)0);
  labeled_stmt ls = ({ast_generic tEmPcast = (ast_generic)(last_case); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)", "discover_scopes.c", 88, __PRETTY_FUNCTION__), 0))); (labeled_stmt)(tEmPcast); });
  ((void) ((pos1 != 0) ? 0 : (__assert_fail ("pos1 != 0", "discover_scopes.c", 90, __PRETTY_FUNCTION__), 0)));
  ((void) ((((last_case)->kind >= kind_labeled_stmt && (last_case)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((last_case)->kind >= kind_labeled_stmt && (last_case)->kind <= postkind_labeled_stmt)", "discover_scopes.c", 91, __PRETTY_FUNCTION__), 0)));
  if (pos1 > pos2)
    return 0;
  for (stmt = (stmts); stmt; stmt = ({ast_generic tEmPcast = (ast_generic)(stmt->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)", "discover_scopes.c", 97, __PRETTY_FUNCTION__), 0))); (statement)(tEmPcast); })) {
    if (pos == pos1)
      {
        ((void) ((prev) ? 0 : (__assert_fail ("prev", "discover_scopes.c", 101, __PRETTY_FUNCTION__), 0)));
        ((void) ((((prev)->kind >= kind_labeled_stmt && (prev)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((prev)->kind >= kind_labeled_stmt && (prev)->kind <= postkind_labeled_stmt)", "discover_scopes.c", 102, __PRETTY_FUNCTION__), 0)));
        ((void) ((prev == last_case) ? 0 : (__assert_fail ("prev == last_case", "discover_scopes.c", 103, __PRETTY_FUNCTION__), 0)));
        pred = prev;
        pred->next = ((void *)0);
        new_block_snd = stmt;
      }
...
{
  int pos = 0;
  statement stmt, prev = ((void *)0), pred = ((void *)0), succ = ((void *)0);
  statement new_block = ((void *)0), new_block_end = ((void *)0), new_compound;
  ((void) ((pos1 < pos2) ? 0 : (__assert_fail ("pos1 < pos2", "discover_scopes.c", 139, __PRETTY_FUNCTION__), 0)));
  for (stmt = (stmts); stmt; stmt = ({ast_generic tEmPcast = (ast_generic)(stmt->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)", "discover_scopes.c", 143, __PRETTY_FUNCTION__), 0))); (statement)(tEmPcast); })) {
    if (pos == pos1) {
      if (prev)
        {
          pred = prev;
...
{
  compound_stmt cs = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)", "discover_scopes.c", 185, __PRETTY_FUNCTION__), 0))); (compound_stmt)(tEmPcast); });
  statement stmt, last_case = ((void *)0);
  int pos = 0,last_case_pos = -1;
  bool changed = 0;
  expression result = ((void *)0);
  do {
    changed = 0;
    last_case_pos = -1;
    pos = 0;
    last_case = ((void *)0);
    for (stmt = (cs->stmts); stmt; stmt = ({ast_generic tEmPcast = (ast_generic)(stmt->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)", "discover_scopes.c", 196, __PRETTY_FUNCTION__), 0))); (statement)(tEmPcast); })) {
      if (((stmt)->kind >= kind_labeled_stmt && (stmt)->kind <= postkind_labeled_stmt) &&
          ( ((({ast_generic tEmPcast = (ast_generic)(stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)", "discover_scopes.c", 198, __PRETTY_FUNCTION__), 0))); (labeled_stmt)(tEmPcast); })->label)->kind >= kind_case_label && (({ast_generic tEmPcast = (ast_generic)(stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)", "discover_scopes.c", 198, __PRETTY_FUNCTION__), 0))); (labeled_stmt)(tEmPcast); })->label)->kind <= postkind_case_label)
            || ((({ast_generic tEmPcast = (ast_generic)(stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)", "discover_scopes.c", 199, __PRETTY_FUNCTION__), 0))); (labeled_stmt)(tEmPcast); })->label)->kind >= kind_default_label && (({ast_generic tEmPcast = (ast_generic)(stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)", "discover_scopes.c", 199, __PRETTY_FUNCTION__), 0))); (labeled_stmt)(tEmPcast); })->label)->kind <= postkind_default_label)) )
        {
          if (last_case_pos >= 0)
            {
    ...
    if (!changed && last_case_pos > 0)
      changed = insert_new_scope_labeled_stmt(cs->stmts,last_case,
                                              last_case_pos+1,
                                              pos-1,cs->env);
  }
  while (changed);
  for (stmt = (cs->stmts); stmt; stmt = ({ast_generic tEmPcast = (ast_generic)(stmt->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)", "discover_scopes.c", 225, __PRETTY_FUNCTION__), 0))); (statement)(tEmPcast); })) {
    if (((stmt)->kind >= kind_labeled_stmt && (stmt)->kind <= postkind_labeled_stmt))
      {
        labeled_stmt ls = ({ast_generic tEmPcast = (ast_generic)(stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)", "discover_scopes.c", 229, __PRETTY_FUNCTION__), 0))); (labeled_stmt)(tEmPcast); });
        result = discover_scopes_statement(ls->stmt);
      }
  }
  return result;
}
static expr_and_pos find_in_pending(dd_list pending, expression e)
{
  expr_and_pos ep;
  dd_list_pos p;
  for (p = dd_first((pending)); !(!(p)->next); p = ((p)->next)) {
    ep = ((expr_and_pos)((p)->data));
...
static expression discover_scopes_statement(statement s)
{
  switch (s->kind)
    ...
    case kind_compound_stmt:
      {
        bool found_pair = 0;
        compound_stmt cs = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)", "discover_scopes.c", 270, __PRETTY_FUNCTION__), 0))); (compound_stmt)(tEmPcast); });
        statement stmt;
        int pos = 0,pos1 = -1, pos2 = -1;
        int num_stmts = chain_length((node) cs->stmts);
        dd_list pending = dd_new_list(pending_region);
        for (stmt = (cs->stmts); stmt; stmt = ({ast_generic tEmPcast = (ast_generic)(stmt->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)", "discover_scopes.c", 277, __PRETTY_FUNCTION__), 0))); (statement)(tEmPcast); }))
          {
            ...
            if (e)
              {
                ...
                if (pos1 >= 0)
                  {
                    ((void) ((ep) ? 0 : (__assert_fail ("ep", "discover_scopes.c", 290, __PRETTY_FUNCTION__), 0)));
                  ...
                  {
                    ((void) ((ep == ((void *)0)) ? 0 : (__assert_fail ("ep == ((void *)0)", "discover_scopes.c", 303, __PRETTY_FUNCTION__), 0)));
                    ep = (sizeof(struct Expr_and_pos) < (1 << (13 - 3)) ? (((void)0), __rc_ralloc_small0)((pending_region), sizeof(struct Expr_and_pos)) : (((void)0), __rc_typed_ralloc)((pending_region), sizeof(struct Expr_and_pos), 0));
                    ep->pos = pos;
                    ep->e = e;
        ...
        if (found_pair)
          {
            ((void) ((pos1 >= 0 && pos2 >= 0) ? 0 : (__assert_fail ("pos1 >= 0 && pos2 >= 0", "discover_scopes.c", 320, __PRETTY_FUNCTION__), 0)));
        ...
        END:
        {
          if (((!(dd_first((pending)))->next)))
            return ((void *)0);
          else
            return ((expr_and_pos)((dd_last(pending))->data))->e;
        }
      }
    case kind_if_stmt:
      {
        expression result = ((void *)0);
        expression tmp = ((void *)0);
        if_stmt is = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_if_stmt && (tEmPcast)->kind <= postkind_if_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_if_stmt && (tEmPcast)->kind <= postkind_if_stmt)", "discover_scopes.c", 346, __PRETTY_FUNCTION__), 0))); (if_stmt)(tEmPcast); });
    ...
    case kind_labeled_stmt:
      {
        labeled_stmt ls = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_labeled_stmt && (tEmPcast)->kind <= postkind_labeled_stmt)", "discover_scopes.c", 381, __PRETTY_FUNCTION__), 0))); (labeled_stmt)(tEmPcast); });
        return discover_scopes_statement(ls->stmt);
      }
    case kind_expression_stmt:
      {
        expression_stmt es = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)", "discover_scopes.c", 387, __PRETTY_FUNCTION__), 0))); (expression_stmt)(tEmPcast); });
    ...
    case kind_while_stmt:
      {
        expression tmp = ((void *)0);
        expression result = ((void *)0);
        while_stmt ws = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_while_stmt && (tEmPcast)->kind <= postkind_while_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_while_stmt && (tEmPcast)->kind <= postkind_while_stmt)", "discover_scopes.c", 395, __PRETTY_FUNCTION__), 0))); (while_stmt)(tEmPcast); });
    ...
    case kind_dowhile_stmt:
      {
        expression tmp = ((void *)0);
        expression result = ((void *)0);
        dowhile_stmt dws = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_dowhile_stmt && (tEmPcast)->kind <= postkind_dowhile_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_dowhile_stmt && (tEmPcast)->kind <= postkind_dowhile_stmt)", "discover_scopes.c", 414, __PRETTY_FUNCTION__), 0))); (dowhile_stmt)(tEmPcast); });
    ...
    case kind_switch_stmt:
      {
        expression tmp = 0;
        expression result = 0;
        switch_stmt ss = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_switch_stmt && (tEmPcast)->kind <= postkind_switch_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_switch_stmt && (tEmPcast)->kind <= postkind_switch_stmt)", "discover_scopes.c", 434, __PRETTY_FUNCTION__), 0))); (switch_stmt)(tEmPcast); });
        result = discover_scopes_expression(ss->condition);
        ((void) ((((ss->stmt)->kind >= kind_compound_stmt && (ss->stmt)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((ss->stmt)->kind >= kind_compound_stmt && (ss->stmt)->kind <= postkind_compound_stmt)", "discover_scopes.c", 438, __PRETTY_FUNCTION__), 0)));
    ...
    case kind_for_stmt:
      {
        expression tmp = ((void *)0);
        expression result = ((void *)0);
        for_stmt fs = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_for_stmt && (tEmPcast)->kind <= postkind_for_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_for_stmt && (tEmPcast)->kind <= postkind_for_stmt)", "discover_scopes.c", 456, __PRETTY_FUNCTION__), 0))); (for_stmt)(tEmPcast); });
    ...
    case kind_return_stmt:
      {
        return_stmt rs = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_return_stmt && (tEmPcast)->kind <= postkind_return_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_return_stmt && (tEmPcast)->kind <= postkind_return_stmt)", "discover_scopes.c", 502, __PRETTY_FUNCTION__), 0))); (return_stmt)(tEmPcast); });
        if (rs->arg1)
    ...
    case kind_change_type_stmt:
      {
        change_type_stmt cts = ({ast_generic tEmPcast = (ast_generic)(s); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_change_type_stmt && (tEmPcast)->kind <= postkind_change_type_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_change_type_stmt && (tEmPcast)->kind <= postkind_change_type_stmt)", "discover_scopes.c", 533, __PRETTY_FUNCTION__), 0))); (change_type_stmt)(tEmPcast); });
        return cts->arg1;
      }
    ...
    default:
      __fail("discover_scopes.c", 546, __FUNCTION__, "(at %s:%ld) " "Unexpected statement kind 0x%x\n", ((s->loc)->filename), ((s->loc)->lineno), s->kind);
      return ((void *)0);
    }
}
static expression discover_scopes_expression(expression e)
{
  switch(e->kind)
    ...
    case kind_comma:
      {
        expression tmp = ((void *)0);
        expression result = ((void *)0);
        comma c = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_comma && (tEmPcast)->kind <= postkind_comma)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_comma && (tEmPcast)->kind <= postkind_comma)", "discover_scopes.c", 559, __PRETTY_FUNCTION__), 0))); (comma)(tEmPcast); });
        expression e2;
        for (e2 = (c->arg1); e2; e2 = ({ast_generic tEmPcast = (ast_generic)(e2->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "discover_scopes.c", 562, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
          {
    ...
    case kind_cast:
      {
        cast c = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_cast && (tEmPcast)->kind <= postkind_cast)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_cast && (tEmPcast)->kind <= postkind_cast)", "discover_scopes.c", 590, __PRETTY_FUNCTION__), 0))); (cast)(tEmPcast); });
    ...
    case kind_conditional:
      {
        expression tmp = ((void *)0);
        expression result = ((void *)0);
        conditional c = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_conditional && (tEmPcast)->kind <= postkind_conditional)", "discover_scopes.c", 602, __PRETTY_FUNCTION__), 0))); (conditional)(tEmPcast); });
    ...
    case kind_compound_expr:
      {
        expression result = ((void *)0),tmp = ((void *)0);
        compound_expr ce = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_expr && (tEmPcast)->kind <= postkind_compound_expr)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_expr && (tEmPcast)->kind <= postkind_compound_expr)", "discover_scopes.c", 639, __PRETTY_FUNCTION__), 0))); (compound_expr)(tEmPcast); });
        compound_stmt cs = ({ast_generic tEmPcast = (ast_generic)(ce->stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_compound_stmt && (tEmPcast)->kind <= postkind_compound_stmt)", "discover_scopes.c", 640, __PRETTY_FUNCTION__), 0))); (compound_stmt)(tEmPcast); });
        statement cur_stmt;
        declaration d;
        if (cs->id_labels)
          __fail("discover_scopes.c", 645, __FUNCTION__, "(at %s:%ld) " "Unimplemented: id_labels\n", ((cs->loc)->filename), ((cs->loc)->lineno), 0);
        for (d = (cs->decls); d; d = ({ast_generic tEmPcast = (ast_generic)(d->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_declaration && (tEmPcast)->kind <= postkind_declaration)", "discover_scopes.c", 648, __PRETTY_FUNCTION__), 0))); (declaration)(tEmPcast); }))
          {
          ((void) ((d->kind != kind_asm_decl) ? 0 : (__assert_fail ("d->kind != kind_asm_decl", "discover_scopes.c", 650, __PRETTY_FUNCTION__), 0)));
          discover_scopes_declaration(d);
          }
        cur_stmt = cs->stmts;
        while (cur_stmt && cur_stmt->next)
          {
            ...
            if (tmp && result)
              ...
              result = tmp;
            cur_stmt = ({ast_generic tEmPcast = (ast_generic)(cur_stmt->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_statement && (tEmPcast)->kind <= postkind_statement)", "discover_scopes.c", 664, __PRETTY_FUNCTION__), 0))); (statement)(tEmPcast); });
          }
        if (cur_stmt && ((cur_stmt)->kind >= kind_expression_stmt && (cur_stmt)->kind <= postkind_expression_stmt))
          {
            tmp =
              discover_scopes_expression(({ast_generic tEmPcast = (ast_generic)(cur_stmt); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression_stmt && (tEmPcast)->kind <= postkind_expression_stmt)", "discover_scopes.c", 672, __PRETTY_FUNCTION__), 0))); (expression_stmt)(tEmPcast); })->arg1);
            if (tmp && result)
              fprintf(stderr,"Warning: discarding change_type in compound expression\n");
            else if (tmp)
              result = tmp;
    ...
    case kind_function_call:
      {
        expression result;
        function_call fc = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_function_call && (tEmPcast)->kind <= postkind_function_call)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_function_call && (tEmPcast)->kind <= postkind_function_call)", "discover_scopes.c", 696, __PRETTY_FUNCTION__), 0))); (function_call)(tEmPcast); });
        expression arg;
        if (fc->va_arg_call)
          {
            return ((void *)0);
        ...
        for (arg = (fc->args); arg; arg = ({ast_generic tEmPcast = (ast_generic)(arg->next); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_expression && (tEmPcast)->kind <= postkind_expression)", "discover_scopes.c", 706, __PRETTY_FUNCTION__), 0))); (expression)(tEmPcast); }))
          {
    ...
    case kind_array_ref:
      {
        expression result = ((void *)0), result2 = ((void *)0);
        array_ref ar = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_array_ref && (tEmPcast)->kind <= postkind_array_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_array_ref && (tEmPcast)->kind <= postkind_array_ref)", "discover_scopes.c", 716, __PRETTY_FUNCTION__), 0))); (array_ref)(tEmPcast); });
    ...
    case kind_field_ref:
      {
        field_ref fr = ({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_field_ref && (tEmPcast)->kind <= postkind_field_ref)", "discover_scopes.c", 729, __PRETTY_FUNCTION__), 0))); (field_ref)(tEmPcast); });
        return discover_scopes_expression(fr->arg1);
      }
    case kind_init_list:
      {
        __fail("discover_scopes.c", 735, __FUNCTION__, "(at %s:%ld) " "Unexpected init list\n", ((e->loc)->filename), ((e->loc)->lineno), 0);
        return ((void *)0);
      }
    case kind_init_index:
      {
        __fail("discover_scopes.c", 741, __FUNCTION__, "(at %s:%ld) " "Unexpected init index\n", ((e->loc)->filename), ((e->loc)->lineno), 0);
        return ((void *)0);
      }
    case kind_init_field:
      {
        __fail("discover_scopes.c", 746, __FUNCTION__, "(at %s:%ld) " "Unexpected init field\n", ((e->loc)->filename), ((e->loc)->lineno), 0);
        return ((void *)0);
      }
    ...
    default:
      if (((e)->kind >= kind_unary && (e)->kind <= postkind_unary))
        return discover_scopes_unary_expression(({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_unary && (tEmPcast)->kind <= postkind_unary)", "discover_scopes.c", 759, __PRETTY_FUNCTION__), 0))); (unary)(tEmPcast); }));
      else if (((e)->kind >= kind_binary && (e)->kind <= postkind_binary))
        return discover_scopes_binary_expression(({ast_generic tEmPcast = (ast_generic)(e); if (tEmPcast) ((void) ((((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)) ? 0 : (__assert_fail ("((tEmPcast)->kind >= kind_binary && (tEmPcast)->kind <= postkind_binary)", "discover_scopes.c", 761, __PRETTY_FUNCTION__), 0))); (binary)(tEmPcast); }));
    }
  return ((void *)0);
}
static expression discover_scopes_unary_expression(unary e)
{
  switch (e->kind)
    ...
    default:
      __fail("discover_scopes.c", 816, __FUNCTION__, "(at %s:%ld) " "Unexpected unary op kind 0x%x\n", ((e->loc)->filename), ((e->loc)->lineno), e->kind);
      return ((void *)0);
    }
  return ((void *)0);
}
...
const char CANON_IDENT_be8576c63e3b16c457c6d855a7af57ca[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/discover_scopes.c";
