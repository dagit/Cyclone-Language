  ...
  if (!pam_buffer_map_lookup(buffer_clicks, bname, &clicks))
    {
      ...
      ((void) ((pam_buffer_map_insert(buffer_clicks, bname, clicks)) ? 0 : (__assert_fail ("pam_buffer_map_insert(buffer_clicks, bname, clicks)", "pam.c", 192, __PRETTY_FUNCTION__), 0)));
    }
...
{
  pam_click_map clicks;
  ((void) ((pam_buffer_map_lookup(buffer_clicks, bname, &clicks)) ? 0 : (__assert_fail ("pam_buffer_map_lookup(buffer_clicks, bname, &clicks)", "pam.c", 208, __PRETTY_FUNCTION__), 0)));
  ((void) ((pam_click_map_remove(clicks, cname)) ? 0 : (__assert_fail ("pam_click_map_remove(clicks, cname)", "pam.c", 209, __PRETTY_FUNCTION__), 0)));
}
...
int pam_add_qual_link(qual q, const char *link_name)
{
  ...
  if (variable_qual(q))
    ...
    {
      ((void) ((constant_qual(q)) ? 0 : (__assert_fail ("constant_qual(q)", "pam.c", 393, __PRETTY_FUNCTION__), 0)));
...
{
  ((void) ((pf == pam_add_text) ? 0 : (__assert_fail ("pf == pam_add_text", "pam.c", 404, __PRETTY_FUNCTION__), 0)));
      ...
      if (overlay->kind & overlay_qtype)
        {
          ...
          overlay->qtype->dt->print_gqtype_qf(overlay->qtype,pam_add_text,
                                              pam_quals_printf,((void *)0),0);
          pam_add_text("\n");
        }
      if (overlay->kind & overlay_fs_qtype)
        {
          pam_add_text("(flow-sensitive) %s: ", overlay->name);
          overlay->qtype->dt->print_gqtype_qf(overlay->fs_qtype,pam_add_text,
                                              pam_quals_printf,overlay->store,
                                              0);
        }
      if (overlay->kind & overlay_confined_exp)
        {
          pam_add_text("(flow-sensitive confined) ");
          pam_add_text(": ");
          overlay->qtype->dt->print_gqtype_qf(overlay->fs_qtype,pam_add_text,
                                             pam_quals_printf,overlay->store,
                                             0);
...
{
  ((void) ((constant_qual(q)) ? 0 : (__assert_fail ("constant_qual(q)", "pam.c", 490, __PRETTY_FUNCTION__), 0)));
  pam_add_text(" ");
  pam_add_qual_link(q, "");
  switch (sign_qual(q))
    {
    ...
    default: __fail("pam.c", 498, __FUNCTION__, "Unexpected qualifier sign %x\n", sign_qual(q));
    }
}
void pam_print_edge(qual left, qual right, location loc, polarity p,
                    bool first, bool bidi, void *arg)
{
  const char *s,*arrow = ((void *)0);
  static int left_size;
  static qual last_right = ((void *)0);
  qual to_print;
  switch (p)
    {
    case p_non:
    ...
    case p_pos:
      ...
      break;
    default:
      __fail("pam.c", 597, __FUNCTION__, "unknown polarity in pam_print_edge\n");
    }
  if (first)
    {
      qual init_qual = left;
...
void pam_qual_mouse_2_click_func(const char *file, const char *name, void *arg)
{
  void *addr;
  qual q;
  ((void) ((!arg) ? 0 : (__assert_fail ("!arg", "pam.c", 662, __PRETTY_FUNCTION__), 0)));
  if (sscanf(name, "%p", &addr) == 0)
    {
  ...
  pam_add_text("\n\n");
  traverse_error_path_edges(q,pam_print_edge,((void *)0));
  pam_blobs_end();
}
                         ...
                         const char *name, void *arg)
{
  if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (click) && __builtin_constant_p ("click") && (__s1_len = strlen (click), __s2_len = strlen ("click"), (!((size_t)(const void *)((click) + 1) - (size_t)(const void *)(click) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("click") + 1) - (size_t)(const void *)("click") == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (click), (__const char *) ("click"), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (click) && ((size_t)(const void *)((click) + 1) - (size_t)(const void *)(click) == 1) && (__s1_len = strlen (click), __s1_len < 4) ? (__builtin_constant_p ("click") && ((size_t)(const void *)(("click") + 1) - (size_t)(const void *)("click") == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (click))[0] - ((__const unsigned char *) (__const char *)("click"))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (click))[1] - ((__const unsigned char *) (__const char *) ("click"))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (click))[2] - ((__const unsigned char *) (__const char *) ("click"))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (click))[3] - ((__const unsigned char *) (__const char *) ("click"))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("click"); register int __result = (((__const unsigned char *) (__const char *) (click))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (click))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (click))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (click))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("click") && ((size_t)(const void *)(("click") + 1) - (size_t)(const void *)("click") == 1) && (__s2_len = strlen ("click"), __s2_len < 4) ? (__builtin_constant_p (click) && ((size_t)(const void *)((click) + 1) - (size_t)(const void *)(click) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (click))[0] - ((__const unsigned char *) (__const char *)("click"))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (click))[1] - ((__const unsigned char *) (__const char *) ("click"))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (click))[2] - ((__const unsigned char *) (__const char *) ("click"))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (click))[3] - ((__const unsigned char *) (__const char *) ("click"))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (click); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("click"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("click"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("click"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("click"))[3]); } } __result; }))) : strcmp (click, "click")))); }))
    ...
    __fail("pam.c", 746, __FUNCTION__, "Unexpected click ``%s''\n", click);
}
         ...
         pam_overlay_map_next(&oms, &loc, &overlay))
    {
      ...
      if (overlay->kind & overlay_qtype)
        color = combine_colors_pam(color,
                                   overlay->qtype->dt->color_gqtype(overlay->qtype,
                                                                    ((void *)0)));
      if (overlay->kind & (overlay_fs_qtype | overlay_confined_exp))
        color = combine_colors_pam(color,
                                   overlay->qtype->dt->color_gqtype(overlay->fs_qtype,overlay->store));
      if (!color && (overlay->kind & (overlay_qtype | overlay_fs_qtype |
                                      overlay_confined_exp)))
        color = "pam-color-1";
      if (overlay->kind & overlay_lin)
        {
                   ...
                   const char *name, location loc)
{
  ...
  if (flag_pam_html)
    {
      ((void) ((pam_file_map_lookup(pam_files, loc->filename, &f)) ? 0 : (__assert_fail ("pam_file_map_lookup(pam_files, loc->filename, &f)", "pam.c", 870, __PRETTY_FUNCTION__), 0)));
      ((void) ((pam_overlay_map_lookup(f->overlays, loc, &overlay)) ? 0 : (__assert_fail ("pam_overlay_map_lookup(f->overlays, loc, &overlay)", "pam.c", 871, __PRETTY_FUNCTION__), 0)));
...
void pam_add_file(const char *name)
{
  ...
  ((void) ((pam_file_map_insert(pam_files, local_name, f)) ? 0 : (__assert_fail ("pam_file_map_insert(pam_files, local_name, f)", "pam.c", 898, __PRETTY_FUNCTION__), 0)));
  pam_add_buffer_click("*Qualifier Results*", f->link,
                       (click_func) pam_load_file, (void *) local_name);
}
void pam_ensure_file(const char *name, pam_file *f)
{
  if (!pam_file_map_lookup(pam_files, name, f))
    {
      pam_add_file(name);
      ((void) ((pam_file_map_lookup(pam_files, name, f)) ? 0 : (__assert_fail ("pam_file_map_lookup(pam_files, name, f)", "pam.c", 911, __PRETTY_FUNCTION__), 0)));
    }
}
...
void pam_add_overlay_file(location loc, const char *idname, gqtype qt)
{
  pam_file f;
  pam_overlay overlay;
  pam_ensure_file(loc->filename, &f);
  if (pam_overlay_map_lookup(f->overlays, loc, &overlay))
  ...
  else
    {
      ...
      overlay->aloc = ((void *)0);
      ((void) ((pam_overlay_map_insert(f->overlays, loc, overlay)) ? 0 : (__assert_fail ("pam_overlay_map_insert(f->overlays, loc, overlay)", "pam.c", 980, __PRETTY_FUNCTION__), 0)));
    }
}
void pam_add_overlay_anchor(location loc)
{
  ...
  if (pam_overlay_map_lookup(f->overlays, loc, &overlay))
  ...
  else
    {
      ...
      overlay->store = ((void *)0);
      overlay->aloc = ((void *)0);
      ((void) ((pam_overlay_map_insert(f->overlays, loc, overlay)) ? 0 : (__assert_fail ("pam_overlay_map_insert(f->overlays, loc, overlay)", "pam.c", 1011, __PRETTY_FUNCTION__), 0)));
    }
}
void pam_add_overlay_lin(location loc, store store, aloc al)
{
  ...
  if (pam_overlay_map_lookup(f->overlays, loc, &overlay))
    {
      ...
      if (!overlay->store)
        ...
        ((void) ((eq_store(overlay->store, store)) ? 0 : (__assert_fail ("eq_store(overlay->store, store)", "pam.c", 1030, __PRETTY_FUNCTION__), 0)));
      ((void) ((!overlay->aloc) ? 0 : (__assert_fail ("!overlay->aloc", "pam.c", 1031, __PRETTY_FUNCTION__), 0)));
      overlay->aloc = al;
    }
  else
    {
      ...
      overlay->store = store;
      overlay->aloc = al;
      ((void) ((pam_overlay_map_insert(f->overlays, loc, overlay)) ? 0 : (__assert_fail ("pam_overlay_map_insert(f->overlays, loc, overlay)", "pam.c", 1044, __PRETTY_FUNCTION__), 0)));
    }
}
void pam_add_overlay_confined_exp(location loc, expression e, gqtype qt, store s)
{
  pam_file f;
  pam_overlay overlay;
  pam_ensure_file(loc->filename, &f);
  if (pam_overlay_map_lookup(f->overlays, loc, &overlay))
    {
    overlay->kind |= overlay_confined_exp;
    overlay->fs_qtype = qt;
    overlay->store = s;
    overlay->e = e;
    }
  else
    {
      ...
      overlay->qtype = ((void *)0);
      overlay->aloc = ((void *)0);
      ((void) ((pam_overlay_map_insert(f->overlays, loc, overlay)) ? 0 : (__assert_fail ("pam_overlay_map_insert(f->overlays, loc, overlay)", "pam.c", 1074, __PRETTY_FUNCTION__), 0)));
    }
}
void pam_add_overlay_flow_sensitive(location loc, const char *idname,
                                    gqtype qt, store s)
{
  ...
  if (pam_overlay_map_lookup(f->overlays, loc, &overlay))
  ...
  else
    {
      ...
      overlay->qtype = ((void *)0);
      overlay->aloc = ((void *)0);
      ((void) ((pam_overlay_map_insert(f->overlays, loc, overlay)) ? 0 : (__assert_fail ("pam_overlay_map_insert(f->overlays, loc, overlay)", "pam.c", 1111, __PRETTY_FUNCTION__), 0)));
    }
}
  ...
  for (p = dd_first((pam_errors)); !(!(p)->next); p = ((p)->next))
    {
      ...
      switch (e->sev)
        ...
        case sev_info:
          ...
          break;
        default:
          __fail("pam.c", 1172, __FUNCTION__, "Unexpected severity %d\n", e->sev);
        }
      if (e->loc)
        {
...
void pam_create_initial_window(void)
{
  ...
  pam_add_text("                                 ");
  if (exist_undefineds())
    pam_add_link("undef", "pam-color-6", "Undefined Globals");
  else
    pam_add_text("Undefined Globals (none)");
  pam_add_text("\n");
  if (exist_hotspots())
    {
      pam_add_link("hotspots", "pam-color-6",
                   "Hotspots");
      pam_add_text("                              ");
    }
  else
  ...
  if (exist_varargs())
    pam_add_link("varargs", "pam-color-6",
...
{
  int n = 0;
  ((void) ((size >= 1) ? 0 : (__assert_fail ("size >= 1", "pam.c", 1301, __PRETTY_FUNCTION__), 0)));
  while (n < size - 1)
    {
  ...
  while (1)
    {
      ...
      if ((bufSize += get_line(cmd, 1024 -bufSize)) == 1024)
        __fail("pam.c", 1350, __FUNCTION__, "PAM sent a command that was too big\n");
      if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (buf) && __builtin_constant_p ("click") && (__s1_len = strlen (buf), __s2_len = strlen ("click"), (!((size_t)(const void *)((buf) + 1) - (size_t)(const void *)(buf) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("click") + 1) - (size_t)(const void *)("click") == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (buf), (__const char *) ("click"), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (buf) && ((size_t)(const void *)((buf) + 1) - (size_t)(const void *)(buf) == 1) && (__s1_len = strlen (buf), __s1_len < 4) ? (__builtin_constant_p ("click") && ((size_t)(const void *)(("click") + 1) - (size_t)(const void *)("click") == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (buf))[0] - ((__const unsigned char *) (__const char *)("click"))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[1] - ((__const unsigned char *) (__const char *) ("click"))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[2] - ((__const unsigned char *) (__const char *) ("click"))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (buf))[3] - ((__const unsigned char *) (__const char *) ("click"))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("click"); register int __result = (((__const unsigned char *) (__const char *) (buf))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (buf))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("click") && ((size_t)(const void *)(("click") + 1) - (size_t)(const void *)("click") == 1) && (__s2_len = strlen ("click"), __s2_len < 4) ? (__builtin_constant_p (buf) && ((size_t)(const void *)((buf) + 1) - (size_t)(const void *)(buf) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (buf))[0] - ((__const unsigned char *) (__const char *)("click"))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[1] - ((__const unsigned char *) (__const char *) ("click"))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[2] - ((__const unsigned char *) (__const char *) ("click"))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (buf))[3] - ((__const unsigned char *) (__const char *) ("click"))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (buf); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("click"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("click"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("click"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("click"))[3]); } } __result; }))) : strcmp (buf, "click")))); }) || !__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (buf) && __builtin_constant_p ("shift-click") && (__s1_len = strlen (buf), __s2_len = strlen ("shift-click"), (!((size_t)(const void *)((buf) + 1) - (size_t)(const void *)(buf) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("shift-click") + 1) - (size_t)(const void *)("shift-click") == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (buf), (__const char *) ("shift-click"), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (buf) && ((size_t)(const void *)((buf) + 1) - (size_t)(const void *)(buf) == 1) && (__s1_len = strlen (buf), __s1_len < 4) ? (__builtin_constant_p ("shift-click") && ((size_t)(const void *)(("shift-click") + 1) - (size_t)(const void *)("shift-click") == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (buf))[0] - ((__const unsigned char *) (__const char *)("shift-click"))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[1] - ((__const unsigned char *) (__const char *) ("shift-click"))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[2] - ((__const unsigned char *) (__const char *) ("shift-click"))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (buf))[3] - ((__const unsigned char *) (__const char *) ("shift-click"))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("shift-click"); register int __result = (((__const unsigned char *) (__const char *) (buf))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (buf))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("shift-click") && ((size_t)(const void *)(("shift-click") + 1) - (size_t)(const void *)("shift-click") == 1) && (__s2_len = strlen ("shift-click"), __s2_len < 4) ? (__builtin_constant_p (buf) && ((size_t)(const void *)((buf) + 1) - (size_t)(const void *)(buf) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (buf))[0] - ((__const unsigned char *) (__const char *)("shift-click"))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[1] - ((__const unsigned char *) (__const char *) ("shift-click"))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (buf))[2] - ((__const unsigned char *) (__const char *) ("shift-click"))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (buf))[3] - ((__const unsigned char *) (__const char *) ("shift-click"))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (buf); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("shift-click"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("shift-click"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("shift-click"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("shift-click"))[3]); } } __result; }))) : strcmp (buf, "shift-click")))); }))
        {
          ...
          if ((bufSize += get_line(name, 1024 -bufSize)) == 1024)
            __fail("pam.c", 1358, __FUNCTION__, "PAM sent a command that was too big\n");
          file = buf + bufSize;
          if ((bufSize += get_line(file, 1024 -bufSize)) == 1024)
            __fail("pam.c", 1363, __FUNCTION__, "PAM sent a command that was too big\n");
          type = buf + bufSize;
          if ((bufSize += get_line(type, 1024 -bufSize)) == 1024)
            __fail("pam.c", 1368, __FUNCTION__, "PAM sent a command that was too big\n");
        ...
        __fail("pam.c", 1380, __FUNCTION__, "Unimplemented: PAM file\n");
      else
          ...
          if (overlay->kind & overlay_qtype)
            {
              ...
              overlay->qtype->dt->print_gqtype_qf(overlay->qtype,printf,
                                                  print_qual,
                                                  ((void *)0),0);
            }
          if (overlay->kind & overlay_fs_qtype)
            {
              ...
              overlay->fs_qtype->dt->print_gqtype_qf(overlay->fs_qtype,printf,
                                                  print_qual,overlay->store,
                                                  0);
            }
...
const char CANON_IDENT_472c2906272c1795a39a9fd01af21172[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/pam.c";
