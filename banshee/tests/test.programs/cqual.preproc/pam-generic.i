...
static region pam_generic_region = ((void *)0);
void pam_clear_buffer(const char *);
void pam_change_buffer(const char *);
void pam_set_lower_buffer(const char *);
void pam_set_upper_buffer(const char *);
  ...
  while (*s)
  {
    ...
    default:
      if (((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _ISprint))
        ...
        __fail("pam-generic.c", 126, __FUNCTION__, "Error: 0x%x not printable\n", *s);
    }
    s++;
    count++;
  }
...
void pam_window_op(pam_op_kind op, const char *wname, const char *kind)
{
  ...
  switch (op)
    ...
    default:
      __fail("pam-generic.c", 165, __FUNCTION__, "Unexpected window op %d\n", op);
    }
  printf(" (");
...
const char CANON_IDENT_858283a12737cbbaa32762fa56861afe[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/pam-generic.c";
