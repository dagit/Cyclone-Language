...
void pam_create_globals_buffer(kind_globals k)
{
  ...
  switch (k)
    ...
    case varargs_globals:
      ...
      break;
    default:
      __fail("pam-ast.c", 56, __FUNCTION__, "Unexpected kind_globals %x\n", k);
    }
...
const char CANON_IDENT_49b0e7383679df1812be149a5b70f6d2[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/pam-ast.c";
