...
user_qual_list new_user_qual_list(user_qual qual,
                                  user_qual_list next)
{
  user_qual_list nql = (sizeof(struct user_qual_list) < (1 << (13 - 3)) ? (((void)0), __rc_ralloc_small0)((parse_region), sizeof(struct user_qual_list)) : (((void)0), __rc_typed_ralloc)((parse_region), sizeof(struct user_qual_list), 0));
  nql->qual = qual;
  nql->next = next;
  return nql;
}
...
{
  for (; l; l = l->next)
    if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (l->qual->cstring.data) && __builtin_constant_p (q) && (__s1_len = strlen (l->qual->cstring.data), __s2_len = strlen (q), (!((size_t)(const void *)((l->qual->cstring.data) + 1) - (size_t)(const void *)(l->qual->cstring.data) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((q) + 1) - (size_t)(const void *)(q) == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (l->qual->cstring.data), (__const char *) (q), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (l->qual->cstring.data) && ((size_t)(const void *)((l->qual->cstring.data) + 1) - (size_t)(const void *)(l->qual->cstring.data) == 1) && (__s1_len = strlen (l->qual->cstring.data), __s1_len < 4) ? (__builtin_constant_p (q) && ((size_t)(const void *)((q) + 1) - (size_t)(const void *)(q) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[0] - ((__const unsigned char *) (__const char *)(q))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[1] - ((__const unsigned char *) (__const char *) (q))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[2] - ((__const unsigned char *) (__const char *) (q))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[3] - ((__const unsigned char *) (__const char *) (q))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (q); register int __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (q) && ((size_t)(const void *)((q) + 1) - (size_t)(const void *)(q) == 1) && (__s2_len = strlen (q), __s2_len < 4) ? (__builtin_constant_p (l->qual->cstring.data) && ((size_t)(const void *)((l->qual->cstring.data) + 1) - (size_t)(const void *)(l->qual->cstring.data) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[0] - ((__const unsigned char *) (__const char *)(q))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[1] - ((__const unsigned char *) (__const char *) (q))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[2] - ((__const unsigned char *) (__const char *) (q))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (l->qual->cstring.data))[3] - ((__const unsigned char *) (__const char *) (q))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (l->qual->cstring.data); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (q))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (q))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (q))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (q))[3]); } } __result; }))) : strcmp (l->qual->cstring.data, q)))); }))
      return 1;
  return 0;
}
user_qual_list union_user_qual_list(user_qual_list left,
...
const char CANON_IDENT_9a6e1f707ecf2f343e594c3af7a0946a[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/user-qual.c";
