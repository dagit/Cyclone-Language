...
env new_env(region r, env parent)
{
  env e = (sizeof(struct env) < (1 << (13 - 3)) ? (((void)0), __rc_ralloc_small0)((r), sizeof(struct env)) : (((void)0), __rc_typed_ralloc)((r), sizeof(struct env), 0));
  e->parent = parent;
  e->r = r;
  e->entries = ((void *)0);
  return e;
...
{
  if (e->entries == ((void *)0))
    e->entries = make_string_hash_table(e->r, 16);
...
const char CANON_IDENT_a235872dadfd88a8e26c7a0d00159b41[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/env.c";
