...
struct type_qualifier {
  ...
  union {
    struct {
      ...
      bool ptrflow_down:1;
      bool ptrflow_up:1;
      bool fieldflow_down:1;
      bool fieldflow_up:1;
      bool fieldptrflow_down:1;
      bool fieldptrflow_up:1;
      qual_set lbc, ubc;
      po_info po;
    } elt;
    struct {
...
cond mkcond(cond_dir dir, qual_gate *qgate, qual c, qual left, qual right,
            location loc);
...
int get_dsw_debug() {
  static int dsw_debug = 2;
  if (dsw_debug==2) dsw_debug = (getenv("DSW_DEBUG") ? 1 : 0);
  return dsw_debug;
}
void print_location(location loc) {
  char *filename = "<no filename>";
  long lineno = 0;
  if (loc) {
    if (loc->filename) filename = loc->filename;
    lineno = loc->lineno;
    printf("%ld", lineno);
  } else {
    printf("(no location)");
...
void print_pair_name(qual q) {
  if (q->kind == qk_link) {
    printf("(LINK)");
    q = ecr_qual(q);
  }
  switch(q->kind) {
  default: ((void) ((0) ? 0 : (__assert_fail ("0", "quals.c", 232, __PRETTY_FUNCTION__), 0))); break;
  case qk_constant: printf("(%p)%s", q, q->u.elt.name); break;
  case qk_variable: printf("(%p)%s", q, q->u.var.name); break;
  }
}
void print_pair(location loc, qual left, qual right, char *op) {
  print_location(loc);
  print_pair_name(left);
  printf(" %s ", op);
  print_pair_name(right);
  printf("\n");
}
enum { state_start = 0, state_init = 1,
       state_pos_defined = 2, state_finish = 3 } state = state_start;
...
static region quals_region = ((void *)0);
static int next_qual = 0;
static int max_index = 0;
static FILE *graph_file = ((void *)0);
...
void init_quals(void)
{
  ((void) ((!quals_region) ? 0 : (__assert_fail ("!quals_region", "quals.c", 339, __PRETTY_FUNCTION__), 0)));
  ...
  current_po = ((void *)0);
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&open_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&open_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&open_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&open_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&fi_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&fi_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&fi_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&fi_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&fs_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&fs_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&fs_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&fs_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&effect_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&effect_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&effect_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&effect_qgate, 0, sizeof (qual_gate)))));
  open_qgate.backward = 1;
  fi_qgate.backward = 1;
  fs_qgate.backward = 1;
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&ptrflow_down_pos_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&ptrflow_down_pos_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&ptrflow_down_pos_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&ptrflow_down_pos_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&ptrflow_down_neg_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&ptrflow_down_neg_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&ptrflow_down_neg_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&ptrflow_down_neg_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&ptrflow_up_pos_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&ptrflow_up_pos_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&ptrflow_up_pos_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&ptrflow_up_pos_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&ptrflow_up_neg_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&ptrflow_up_neg_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&ptrflow_up_neg_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&ptrflow_up_neg_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&fieldflow_down_pos_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&fieldflow_down_pos_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&fieldflow_down_pos_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&fieldflow_down_pos_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&fieldflow_down_neg_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&fieldflow_down_neg_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&fieldflow_down_neg_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&fieldflow_down_neg_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&fieldflow_up_pos_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&fieldflow_up_pos_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&fieldflow_up_pos_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&fieldflow_up_pos_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&fieldflow_up_neg_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&fieldflow_up_neg_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&fieldflow_up_neg_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&fieldflow_up_neg_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&fieldptrflow_down_pos_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&fieldptrflow_down_pos_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&fieldptrflow_down_pos_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&fieldptrflow_down_pos_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&fieldptrflow_down_neg_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&fieldptrflow_down_neg_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&fieldptrflow_down_neg_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&fieldptrflow_down_neg_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&fieldptrflow_up_pos_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&fieldptrflow_up_pos_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&fieldptrflow_up_pos_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&fieldptrflow_up_pos_qgate, 0, sizeof (qual_gate)))));
  (__extension__ (__builtin_constant_p (sizeof (qual_gate)) && (sizeof (qual_gate)) <= 16 ? ((sizeof (qual_gate)) == 1 ? ({ void *__s = (&fieldptrflow_up_neg_qgate); *((__uint8_t *) __s) = (__uint8_t) 0; __s; }) : ({ void *__s = (&fieldptrflow_up_neg_qgate); union { unsigned int __ui; unsigned short int __usi; unsigned char __uc; } *__u = __s; __uint8_t __c = (__uint8_t) (0); switch ((unsigned int) (sizeof (qual_gate))) { case 15: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 11: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 7: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 3: __u->__usi = (unsigned short int) __c * 0x0101; __u = __extension__ ((void *) __u + 2); __u->__uc = (unsigned char) __c; break; case 14: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 10: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 6: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 2: __u->__usi = (unsigned short int) __c * 0x0101; break; case 13: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 9: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 5: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 1: __u->__uc = (unsigned char) __c; break; case 16: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 12: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 8: __u->__ui = __c * 0x01010101; __u = __extension__ ((void *) __u + 4); case 4: __u->__ui = __c * 0x01010101; case 0: break; } __s; })) : (__builtin_constant_p (0) && (0) == '\0' ? ({ void *__s = (&fieldptrflow_up_neg_qgate); __builtin_memset (__s, '\0', sizeof (qual_gate)); __s; }) : memset (&fieldptrflow_up_neg_qgate, 0, sizeof (qual_gate)))));
  ((void) ((num_hotspots >= 0) ? 0 : (__assert_fail ("num_hotspots >= 0", "quals.c", 369, __PRETTY_FUNCTION__), 0)));
  if (num_hotspots != 0)
    {
      int i;
...
void end_define_pos(void)
{
  ((void) ((state == state_init) ? 0 : (__assert_fail ("state == state_init", "quals.c", 395, __PRETTY_FUNCTION__), 0)));
...
void dispose_quals(void)
{
  ((void) ((quals_region) ? 0 : (__assert_fail ("quals_region", "quals.c", 433, __PRETTY_FUNCTION__), 0)));
...
{
  if (current_po)
    __fail("quals.c", 582, __FUNCTION__, "begin_po_qual called without previous end_po_qual\n");
...
{
  if (!current_po)
    __fail("quals.c", 593, __FUNCTION__, "end_po_qual called without previous begin_po_qual\n");
...
{
  qual new_qual;
  ((void) ((state == state_init) ? 0 : (__assert_fail ("state == state_init", "quals.c", 629, __PRETTY_FUNCTION__), 0)));
  if (!current_po)
    __fail("quals.c", 631, __FUNCTION__, "add_qual called without previous begin_po_qual\n");
  if ((new_qual = find_qual(name)))
    {
      if (new_qual->u.elt.po != current_po)
        __fail("quals.c", 635, __FUNCTION__, "Qualifier %s in two different partial orders\n", new_qual->u.elt.name);
      return new_qual;
    }
  ...
  new_qual->u.elt.ptrflow_down = 0;
  new_qual->u.elt.ptrflow_up = 0;
  new_qual->u.elt.fieldflow_down = 0;
  new_qual->u.elt.fieldflow_up = 0;
  new_qual->u.elt.fieldptrflow_down = 0;
  new_qual->u.elt.fieldptrflow_up = 0;
...
void add_qual_lt(qual left, qual right)
{
  ((void) ((left->kind == qk_constant) ? 0 : (__assert_fail ("left->kind == qk_constant", "quals.c", 688, __PRETTY_FUNCTION__), 0)));
  ((void) ((right->kind == qk_constant) ? 0 : (__assert_fail ("right->kind == qk_constant", "quals.c", 689, __PRETTY_FUNCTION__), 0)));
...
void add_color_qual(qual q, const char *color)
{
  ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 718, __PRETTY_FUNCTION__), 0)));
  q->u.elt.color = (((void)0), __rc_rstrdup)(quals_region, color);
}
void add_level_qual(qual q, level_qual_t lev)
{
  ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 725, __PRETTY_FUNCTION__), 0)));
  ((void) ((lev == level_value || lev == level_ref) ? 0 : (__assert_fail ("lev == level_value || lev == level_ref", "quals.c", 726, __PRETTY_FUNCTION__), 0)));
  q->u.elt.level = lev;
}
void add_sign_qual(qual q, sign_qual_t sign)
{
  ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 734, __PRETTY_FUNCTION__), 0)));
  ((void) ((sign == sign_pos || sign == sign_neg || sign == sign_eq) ? 0 : (__assert_fail ("sign == sign_pos || sign == sign_neg || sign == sign_eq", "quals.c", 735, __PRETTY_FUNCTION__), 0)));
  q->u.elt.sign = sign;
}
void add_ptrflow_qual(qual q, flow_qual_t f)
{
  switch (f) {
  case flow_up:
    q->u.elt.ptrflow_up = 1;
    break;
  case flow_down:
    q->u.elt.ptrflow_down = 1;
    break;
  default:
    __fail("quals.c", 750, __FUNCTION__, "unknown flow direction!\n");
  }
...
void add_fieldflow_qual(qual q, flow_qual_t f)
{
  switch (f) {
  case flow_up:
    q->u.elt.fieldflow_up = 1;
    break;
  case flow_down:
    q->u.elt.fieldflow_down = 1;
    break;
  default:
    __fail("quals.c", 766, __FUNCTION__, "unknown flow direction!\n");
  }
...
void add_fieldptrflow_qual(qual q, flow_qual_t f)
{
  switch (f) {
  case flow_up:
    q->u.elt.fieldptrflow_up = 1;
    break;
  case flow_down:
    q->u.elt.fieldptrflow_down = 1;
    break;
  default:
    __fail("quals.c", 782, __FUNCTION__, "unknown flow direction!\n");
  }
...
qual find_qual(const char *name)
{
  ...
  for (qual_set_scan(all_quals, &qs), q = qual_set_next(&qs); q; q = qual_set_next(&qs))
    {
      ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 800, __PRETTY_FUNCTION__), 0)));
...
{
  qual fresh;
  ((void) ((state >= state_pos_defined) ? 0 : (__assert_fail ("state >= state_pos_defined", "quals.c", 833, __PRETTY_FUNCTION__), 0)));
  ...
  fresh->u.var.no_qual_loc_set = empty_loc_set(quals_region);
  fresh->u.var.aloc = ((void *)0);
  fresh->u.var.lb = empty_qual_edge_set(quals_region);
  fresh->u.var.ub = empty_qual_edge_set(quals_region);
  fresh->u.var.lbc = empty_qual_set(quals_region);
  fresh->u.var.ubc = empty_qual_set(quals_region);
  fresh->u.var.cond_set = empty_cond_set(quals_region);
...
void set_global_qual (qual q, bool global)
{
  ((void) ((state < state_finish) ? 0 : (__assert_fail ("state < state_finish", "quals.c", 880, __PRETTY_FUNCTION__), 0)));
}
void mk_no_qual_qual(location loc, qual q)
{
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 887, __PRETTY_FUNCTION__), 0)));
  if (!qual_set_empty(q->u.var.lbc) || !qual_set_empty(q->u.var.ubc))
...
{
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 897, __PRETTY_FUNCTION__), 0)));
  ((void) ((!q->u.var.store && !q->u.var.aloc) ? 0 : (__assert_fail ("!q->u.var.store && !q->u.var.aloc", "quals.c", 898, __PRETTY_FUNCTION__), 0)));
  q->u.var.store = s;
  q->u.var.aloc = al;
  if (!qual_set_empty(q->u.var.lbc))
    propagate_store_cell_forward(s, al);
  if (!qual_set_empty(q->u.var.ubc))
...
static qual ecr_qual(qual q)
{
  switch (q->kind)
    ...
    case qk_link:
      ...
      break;
    default:
      __fail("quals.c", 940, __FUNCTION__, "Unexpected qual kind %x\n", q->kind);
    }
}
static inline qual_edge mkqual_edge(region r, location loc, qual q)
{
  qual_edge result = (sizeof(struct Qual_edge) < (1 << (13 - 3)) ? (((void)0), __rc_ralloc_small0)((r), sizeof(struct Qual_edge)) : (((void)0), __rc_typed_ralloc)((r), sizeof(struct Qual_edge), 0));
  result->loc = loc;
  result->qual = q;
  if (loc)
...
static inline traverse_edge mktraverse_edge(region r, qual q, location loc,
                                            dir d)
{
  traverse_edge result = (sizeof(struct Traverse_edge) < (1 << (13 - 3)) ? (((void)0), __rc_ralloc_small0)((r), sizeof(struct Traverse_edge)) : (((void)0), __rc_typed_ralloc)((r), sizeof(struct Traverse_edge), 0));
  result->loc = loc;
  result->qual = q;
  result->dir = d;
  return result;
}
int cmp_qual_edge_semantic (qual_edge qe1, qual_edge qe2)
{
  return 0;
}
level_qual_t level_qual(qual q)
{
  ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 984, __PRETTY_FUNCTION__), 0)));
  return q->u.elt.level;
}
sign_qual_t sign_qual(qual q)
{
  ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 991, __PRETTY_FUNCTION__), 0)));
  return q->u.elt.sign;
}
bool flow_sensitive_qual(qual q)
{
  ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 998, __PRETTY_FUNCTION__), 0)));
  return q->u.elt.po->flow_sensitive;
}
bool nonprop_qual(qual q)
{
  ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 1005, __PRETTY_FUNCTION__), 0)));
...
{
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 1035, __PRETTY_FUNCTION__), 0)));
  return q->u.var.preferred;
}
location location_qual(qual q)
{
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 1043, __PRETTY_FUNCTION__), 0)));
  return q->u.var.loc;
}
qual_edge_set lb_qual(region r, qual q)
{
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 1051, __PRETTY_FUNCTION__), 0)));
  return q->u.var.lb;
}
qual_edge_set cs_lb_qual(region r, qual q)
{
...
{
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 1066, __PRETTY_FUNCTION__), 0)));
  return q->u.var.ub;
}
qual_edge_set cs_ub_qual(region r, qual q)
{
...
{
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 1081, __PRETTY_FUNCTION__), 0)));
...
bool _mkleq_qual(location loc, qual left, qual right, bool orig)
{
  ...
  if (left->kind == qk_constant && right->kind == qk_constant)
    {
      bool result = !may_leq_qual(left, right);
      ...
      if (!nonprop_qual(left) && !qual_set_member(right->u.var.lbc, left))
        {
          ...
          qual_set_insert(quals_region, &right->u.var.lbc, left);
          {
            loc_set_scanner ls;
            location loc;
            for (loc_set_scan(right->u.var.no_qual_loc_set, &ls), loc = loc_set_next(&ls); loc; loc = loc_set_next(&ls))
              report_qerror(loc, sev_err,
                            "Qualifier constraint reached a no-qual zone");
          }
          for (qual_set_scan(right->u.var.ubc, &qs), q = qual_set_next(&qs); q; q = qual_set_next(&qs))
            result = _mkleq_qual(loc, left, q, 0) || result;
          for (qual_edge_set_scan(right->u.var.ub, &qess), qe = qual_edge_set_next(&qess); qe; qe = qual_edge_set_next(&qess))
            result = _mkleq_qual(loc, left, qe->qual, 0) || result;
      ...
      if (!nonprop_qual(right) && !qual_set_member(left->u.var.ubc, right))
        {
          ...
          qual_set_insert(quals_region, &left->u.var.ubc, right);
          {
            loc_set_scanner ls;
            location loc;
            for (loc_set_scan(left->u.var.no_qual_loc_set, &ls), loc = loc_set_next(&ls); loc; loc = loc_set_next(&ls))
              report_qerror(loc, sev_err,
                            "Qualifier constraint reached a no-qual zone");
          }
          for (qual_set_scan(left->u.var.lbc, &qs), q = qual_set_next(&qs); q; q = qual_set_next(&qs))
            result = _mkleq_qual(loc, q, right, 0) || result;
          for (qual_edge_set_scan(left->u.var.lb, &qess), qe = qual_edge_set_next(&qess); qe; qe = qual_edge_set_next(&qess))
            result = _mkleq_qual(loc, qe->qual, right, 0) || result;
          if (qual_set_empty(right->u.elt.lbc))
            result = _mkleq_qual(loc, right, left, orig) || result;
  ...
  else
    {
      ...
      for (qual_set_scan(left->u.var.lbc, &qs), q1 = qual_set_next(&qs); q1; q1 = qual_set_next(&qs))
        result = _mkleq_qual(loc, q1, right, 0) || result;
      for (qual_set_scan(right->u.var.ubc, &qs), q2 = qual_set_next(&qs); q2; q2 = qual_set_next(&qs))
        result = _mkleq_qual(loc, left, q2, 0) || result;
      if (orig && result)
        increment_error_counts(left, right);
      return result;
    }
...
{
  if (qgate->backward)
    return _mkleq_qual(loc, left, right, 1);
  else
    return 0;
}
bool mkeq_qual(location loc, qual_gate *qgate, qual left, qual right)
...
bool leq_qual(qual left, qual right)
{
  left = ecr_qual(left);
  right = ecr_qual(right);
  ((void) ((constant_qual(left) || constant_qual(right)) ? 0 : (__assert_fail ("constant_qual(left) || constant_qual(right)", "quals.c", 1647, __PRETTY_FUNCTION__), 0)));
  if (left == right)
    return 1;
  if (left->kind == qk_constant && right->kind == qk_constant)
  ...
  else if (left->kind == qk_variable)
    {
      ...
      qual q;
      for (qual_set_scan(left->u.var.ubc, &qss), q = qual_set_next(&qss); q; q = qual_set_next(&qss))
        if (leq_qual(q, right))
          return 1;
      return 0;
    }
  else
    {
      qual_set_scanner qss;
      qual q;
      ((void) ((right->kind == qk_variable) ? 0 : (__assert_fail ("right->kind == qk_variable", "quals.c", 1669, __PRETTY_FUNCTION__), 0)));
      for (qual_set_scan(right->u.var.lbc, &qss), q = qual_set_next(&qss); q; q = qual_set_next(&qss))
        if (leq_qual(left, q))
          return 1;
      return 0;
    }
...
bool unify_qual(location loc, qual left, qual right)
{
  ...
  if (left == right)
    return 0;
  result = mkeq_qual(loc, &fi_qgate, left, right);
...
bool copy_constraint (qual_edge e, qual q1, qual q2)
{
  return mkleq_qual (e->loc, &fi_qgate, q1, q2);
}
bool eq_qual(qual left, qual right)
{
...
bool has_lb_qual(qual q, qual bound)
{
  ...
  qual_edge qe;
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 1788, __PRETTY_FUNCTION__), 0)));
  for (qual_edge_set_scan(q->u.var.lb, &qess), qe = qual_edge_set_next(&qess); qe; qe = qual_edge_set_next(&qess))
...
bool has_ub_qual(qual q, qual bound)
{
  ...
  qual_edge qe;
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 1808, __PRETTY_FUNCTION__), 0)));
  for (qual_edge_set_scan(q->u.var.lb, &qess), qe = qual_edge_set_next(&qess); qe; qe = qual_edge_set_next(&qess))
    if (eq_qual(bound, qe->qual))
      return 1;
  return 0;
...
bool has_fs_qual(qual q)
{
  ...
  qual_edge qe;
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 1840, __PRETTY_FUNCTION__), 0)));
  for (qual_edge_set_scan(q->u.var.ub, &qess), qe = qual_edge_set_next(&qess); qe; qe = qual_edge_set_next(&qess))
  ...
  if (constant_qual(q1) && constant_qual(q2))
    {
      return qual_set_member (q1->u.elt.ubc, q2) ||
        !qual_set_member(q1->u.elt.po->qualifiers, q2);
    }
  else if (constant_qual(q1) && variable_qual(q2))
    {
      qual_set_scanner qss;
      qual ubc;
      for (qual_set_scan(q2->u.var.ubc, &qss), ubc = qual_set_next(&qss); ubc; ubc = qual_set_next(&qss))
        if (! may_leq_qual (q1, ubc))
          return 0;
      return 1;
    }
  else if (variable_qual(q1) && constant_qual(q2))
    {
      qual_set_scanner qss;
      qual lbc;
      for (qual_set_scan(q1->u.var.lbc, &qss), lbc = qual_set_next(&qss); lbc; lbc = qual_set_next(&qss))
        if (! may_leq_qual (lbc, q2))
          return 0;
      return 1;
    }
  else
    {
      qual_set_scanner lqss;
      qual_set_scanner uqss;
      qual lbc;
      qual ubc;
      for (qual_set_scan(q1->u.var.lbc, &lqss), lbc = qual_set_next(&lqss); lbc; lbc = qual_set_next(&lqss))
        {
          for (qual_set_scan(q2->u.var.ubc, &uqss), ubc = qual_set_next(&uqss); ubc; ubc = qual_set_next(&uqss))
            {
...
bool cs_may_leq_qual (qual q1, qual q2)
{
  return may_leq_qual (q1, q2);
}
cond mkcond(cond_dir dir, qual_gate *qgate,
            qual c, qual left, qual right, location loc)
{
  cond cond;
...
bool cond_mkleq_qual(location loc, qual_gate *qgate1, qual l1, qual r1,
                     qual_gate *qgate2, qual l2, qual r2)
{
  ((void) ((constant_qual(l1) || constant_qual(r1)) ? 0 : (__assert_fail ("constant_qual(l1) || constant_qual(r1)", "quals.c", 1950, __PRETTY_FUNCTION__), 0)));
  l1 = ecr_qual(l1);
  r1 = ecr_qual(r1);
  l2 = ecr_qual(l2);
  r2 = ecr_qual(r2);
  if (leq_qual(l1, r1))
  ...
  else
    {
      ...
      ((void) ((constant_qual(c) && variable_qual(v)) ? 0 : (__assert_fail ("constant_qual(c) && variable_qual(v)", "quals.c", 1982, __PRETTY_FUNCTION__), 0)));
...
static bool cond_set_trigger(qual q)
{
  ...
  result = 0;
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 1999, __PRETTY_FUNCTION__), 0)));
  for (cond_set_scan(q->u.var.cond_set, &css), cond = cond_set_next(&css); cond; cond = cond_set_next(&css))
    if (!cond->triggered)
      {
        switch (cond->dir)
          {
          ...
          case v_leq_c:
            ...
            break;
          default:
            __fail("quals.c", 2012, __FUNCTION__, "Unexpected condition dir %x\n", cond->dir);
          }
        if (cond->triggered)
          result = mkleq_qual(cond->loc, &cond->qgate, cond->left, cond->right)
            || result;
      }
  return result;
}
void scan_qual_bounds(qual q, qual_traverse_fn f, void *arg)
{
  ...
  qual_edge qe;
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 2076, __PRETTY_FUNCTION__), 0)));
  for (qual_set_scan(q->u.var.lbc, &qs), p = qual_set_next(&qs); p; p = qual_set_next(&qs))
    if ((sign_qual(p) == sign_pos) || (sign_qual(p) == sign_eq))
      f(p, arg);
  for (qual_set_scan(q->u.var.ubc, &qs), p = qual_set_next(&qs); p; p = qual_set_next(&qs))
  ...
  for (qual_edge_set_scan(q->u.var.ub, &qess), qe = qual_edge_set_next(&qess); qe; qe = qual_edge_set_next(&qess))
    if (constant_qual(qe->qual) &&
        nonprop_qual(qe->qual) &&
        sign_qual(qe->qual) == sign_neg)
      f(qe->qual, arg);
}
int cmp_qual_byname(qual left, qual right)
{
  ((void) ((left->kind == qk_constant && right->kind == qk_constant) ? 0 : (__assert_fail ("left->kind == qk_constant && right->kind == qk_constant", "quals.c", 2104, __PRETTY_FUNCTION__), 0)));
  return __extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (left->u.elt.name) && __builtin_constant_p (right->u.elt.name) && (__s1_len = strlen (left->u.elt.name), __s2_len = strlen (right->u.elt.name), (!((size_t)(const void *)((left->u.elt.name) + 1) - (size_t)(const void *)(left->u.elt.name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((right->u.elt.name) + 1) - (size_t)(const void *)(right->u.elt.name) == 1) || __s2_len >= 4)) ? memcmp ((__const char *) (left->u.elt.name), (__const char *) (right->u.elt.name), (__s1_len < __s2_len ? __s1_len : __s2_len) + 1) : (__builtin_constant_p (left->u.elt.name) && ((size_t)(const void *)((left->u.elt.name) + 1) - (size_t)(const void *)(left->u.elt.name) == 1) && (__s1_len = strlen (left->u.elt.name), __s1_len < 4) ? (__builtin_constant_p (right->u.elt.name) && ((size_t)(const void *)((right->u.elt.name) + 1) - (size_t)(const void *)(right->u.elt.name) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[0] - ((__const unsigned char *) (__const char *)(right->u.elt.name))[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[1] - ((__const unsigned char *) (__const char *) (right->u.elt.name))[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[2] - ((__const unsigned char *) (__const char *) (right->u.elt.name))[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[3] - ((__const unsigned char *) (__const char *) (right->u.elt.name))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (right->u.elt.name); register int __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (right->u.elt.name) && ((size_t)(const void *)((right->u.elt.name) + 1) - (size_t)(const void *)(right->u.elt.name) == 1) && (__s2_len = strlen (right->u.elt.name), __s2_len < 4) ? (__builtin_constant_p (left->u.elt.name) && ((size_t)(const void *)((left->u.elt.name) + 1) - (size_t)(const void *)(left->u.elt.name) == 1) ? (__extension__ ({ register int __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[0] - ((__const unsigned char *) (__const char *)(right->u.elt.name))[0]); if (__s2_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[1] - ((__const unsigned char *) (__const char *) (right->u.elt.name))[1]); if (__s2_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[2] - ((__const unsigned char *) (__const char *) (right->u.elt.name))[2]); if (__s2_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (left->u.elt.name))[3] - ((__const unsigned char *) (__const char *) (right->u.elt.name))[3]); } } __result; })) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (left->u.elt.name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (right->u.elt.name))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (right->u.elt.name))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (right->u.elt.name))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (right->u.elt.name))[3]); } } __result; }))) : strcmp (left->u.elt.name, right->u.elt.name)))); });
}
struct add_info
{
  region r;
...
void scan_qual_bounds_sorted(qual q, qual_traverse_fn f, void *arg)
{
  ...
  for (qual_set_byname_scan(bounds, &qsbn), p = qual_set_byname_next(&qsbn); p; p = qual_set_byname_next(&qsbn))
    f(p, arg);
...
void print_qual_fn(qual q, void *arg)
{
  ...
  ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 2150, __PRETTY_FUNCTION__), 0)));
  if (!pi->first)
    pi->size += pi->pf(" ");
...
int print_qual(printf_func pf, qual q)
{
  ...
  switch(q->kind)
    ...
    case qk_variable:
      ...
      break;
    default:
      __fail("quals.c", 2177, __FUNCTION__, "Unexpected kind %d for qualifiers\n", q->kind);
    }
}
int cs_print_qual(printf_func pf, qual q)
{
  return print_qual (pf, q);
}
int print_qual_raw(printf_func pf, qual q)
{
  if (!q)
    __fail("quals.c", 2190, __FUNCTION__, "Null qualifier in print_qual_raw\n");
  switch(q->kind)
    {
    ...
    default: __fail("quals.c", 2196, __FUNCTION__, "Unexpected kind %d for qualifier\n", q->kind);
    }
}
const char *combine_colors_pam(const char *color1, const char *color2)
{
...
const char *color_qual(qual q)
{
  ...
  switch (q->kind)
    ...
    case qk_variable:
      ...
      break;
    default:
      __fail("quals.c", 2234, __FUNCTION__, "Unexpected kind %d for qualifier\n", q->kind);
    }
}
const char *name_qual(qual q)
{
  ...
  switch (q->kind)
    ...
    default:
      __fail("quals.c", 2247, __FUNCTION__, "Unexpected kind %d for qualifier\n", q->kind);
    }
}
bool set_qual_name(qual q, const char *name)
{
  ...
  switch (q->kind)
    ...
    default:
      __fail("quals.c", 2259, __FUNCTION__, "Unexpected kind %d for qualifier\n", q->kind);
    }
  return 0;
}
const char *unique_name_qual(qual q)
...
static dir interesting_constant_dir(qual q)
{
  dir d = dir_none;
  ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 2282, __PRETTY_FUNCTION__), 0)));
  switch (sign_qual(q))
    {
    case sign_pos:
      d |= dir_backward;
    ...
    case sign_eq:
      ...
      break;
    default:
      __fail("quals.c", 2295, __FUNCTION__, "Unexpected sign %x\n", sign_qual(q));
    }
  return d;
}
      ...
      if (!nonprop_qual(c))
        {
          switch (sign_qual(c))
            ...
            case sign_eq:
              ...
              break;
            default:
              __fail("quals.c", 2339, __FUNCTION__, "Unexpected sign %x\n", sign_qual(c));
            }
        }
      else
        {
          ...
          switch (sign_qual(c))
            ...
            case sign_eq:
              ...
              break;
            default:
              __fail("quals.c", 2366, __FUNCTION__, "Unexpected sign %x\n", sign_qual(c));
            }
        }
    }
  return result;
...
static void traverse_clear_marks(qual q)
{
  ...
  if (q->kind == qk_variable)
    ...
    ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 2394, __PRETTY_FUNCTION__), 0)));
}
qual find_shortest_path(region r, qual q, qual c, dir d)
{
  ...
  qual path_end;
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable && (!c || constant_qual(c))) ? 0 : (__assert_fail ("q->kind == qk_variable && (!c || constant_qual(c))", "quals.c", 2408, __PRETTY_FUNCTION__), 0)));
  queue = dd_new_list(r);
  dd_add_last(r, queue, q);
  q->parent = ((void *)0);
  path_end = ((void *)0);
  while (!((!(dd_first((queue)))->next)))
    {
      qual q;
      q = ((qual)((dd_first(queue))->data));
      ...
      if (constant_qual(q))
        {
          if (q == c || (!c && (interesting_constant_dir(q) & d)))
            {
              path_end = q;
              break;
            }
      ...
      else
        {
          ...
          qual_edge qe;
          dir dir_to_look;
          ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 2445, __PRETTY_FUNCTION__), 0)));
                                          ...
                                          void *arg)
{
  ...
  bool first = 1;
  q = ecr_qual(q);
  for (b = q; b->parent != ((void *)0); b = ecr_qual(b->parent->qual))
    {
      if (b->parent->dir == dir_forward)
        f(b, b->parent->qual, b->parent->loc, p_non, first, 0, arg);
      else
        {
          ((void) ((b->parent->dir == dir_backward) ? 0 : (__assert_fail ("b->parent->dir == dir_backward", "quals.c", 2503, __PRETTY_FUNCTION__), 0)));
          f(b->parent->qual, b, b->parent->loc, p_non, first, 0, arg);
        }
      first = 0;
    }
}
static bool traverse_parent_edges_reverse(qual q, edge_traverse_fn f,
                                          void *arg)
{
  bool first = 1;
  if (q->parent != ((void *)0))
    {
      first = traverse_parent_edges_reverse(q->parent->qual, f, arg);
      if (q->parent->dir == dir_backward)
        f(q->parent->qual, q, q->parent->loc, p_non, first, 0, arg);
      else
        {
          ((void) ((q->parent->dir == dir_forward) ? 0 : (__assert_fail ("q->parent->dir == dir_forward", "quals.c", 2523, __PRETTY_FUNCTION__), 0)));
          f(q, q->parent->qual, q->parent->loc, p_non, first, 0, arg);
        }
      return 0;
    }
  return first;
  ...
  if (!c)
    {
      ...
      left_end = find_shortest_path(scratch_region, q, ((void *)0),
                                    dir_backward);
      if (left_end)
        traverse_parent_edges_forward(left_end, f, arg);
      right_end = find_shortest_path(scratch_region, q, ((void *)0),
                                     dir_forward);
      if (right_end &&
  ...
  else
    {
      ...
      ((void) ((d != dir_none) ? 0 : (__assert_fail ("d != dir_none", "quals.c", 2564, __PRETTY_FUNCTION__), 0)));
      if (d & (dir_forward | dir_backward))
        {
          if ((end = find_shortest_path(scratch_region, q, c, dir_backward)))
            traverse_parent_edges_forward(end, f, arg);
                                             ...
                                             dir_forward)))
            traverse_parent_edges_reverse(end, f, arg);
          else if ((end = find_shortest_path(scratch_region, q, c, d)))
            traverse_parent_edges_forward(end, f, arg);
        }
      else
        {
...
edge_traverse_fn tepe_current_fn = ((void *)0);
static void tepe_print_path_to_qual(qual c, qual q)
{
  traverse_shortest_path_edges(q, c, tepe_current_fn, ((void *)0));
}
void traverse_error_path_edges(qual q,edge_traverse_fn f,void* arg)
{
  tepe_current_fn = f;
  scan_qual_bounds(q, (qual_traverse_fn) tepe_print_path_to_qual, q);
}
void cs_traverse_error_path_edges(qual q,edge_traverse_fn f,void* arg)
{
  return traverse_error_path_edges (q, f, arg);
}
void __traverse_qual_graph_nodes(qual q, qual c, qual_traverse_fn f,
                               void *arg)
{
  q = ecr_qual(q);
  ((void) ((constant_qual(c)) ? 0 : (__assert_fail ("constant_qual(c)", "quals.c", 2614, __PRETTY_FUNCTION__), 0)));
  if (q->mark)
    return;
  q->mark = 1;
  if (q->kind == qk_variable)
    ...
    {
      ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 2642, __PRETTY_FUNCTION__), 0)));
      f(q, arg);
    }
}
                                       ...
                                       void *arg)
{
  ...
  if (q->kind == qk_variable)
    ...
    ((void) ((q->kind == qk_constant) ? 0 : (__assert_fail ("q->kind == qk_constant", "quals.c", 2672, __PRETTY_FUNCTION__), 0)));
}
...
void traverse_qual_graph_nodes_lower(qual q, void *arg)
{
  ...
  if (q->kind == qk_constant ||
      !data->po_bounds_only ||
      (interesting_scan_dir(q, ((void *)0)) & dir_backward))
    data->f(q, data->arg);
}
void traverse_qual_graph_nodes_upper(qual q, void *arg)
{
  ...
  if (q->kind == qk_constant ||
      !data->po_bounds_only ||
      (interesting_scan_dir(q, ((void *)0)) & dir_forward))
    data->f(q, data->arg);
}
void traverse_qual_graph_nodes_both(qual q, void *arg)
{
  ...
  if (q->kind == qk_constant ||
      !data->po_bounds_only ||
      (interesting_scan_dir(q, ((void *)0)) & (dir_forward | dir_backward)))
    data->f(q, data->arg);
}
                               ...
                               qual_traverse_fn f, void *arg)
{
  ...
  data.arg = arg;
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 2720, __PRETTY_FUNCTION__), 0)));
  if (po_bounds_only &&
      (interesting_scan_dir(q, ((void *)0)) == (dir_forward | dir_backward)))
      {
  ...
  if (d & dir_backward)
    {
      for (qual_edge_set_scan(q->u.var.lb, &qess), qe = qual_edge_set_next(&qess); qe; qe = qual_edge_set_next(&qess))
        {
          qtf(qe->qual, q, qe->loc, p_non, 0, 0, arg);
  ...
  if (d & dir_forward)
    {
      for (qual_edge_set_scan(q->u.var.ub, &qess), qe = qual_edge_set_next(&qess); qe; qe = qual_edge_set_next(&qess))
        {
          qtf(q, qe->qual, qe->loc, p_non, 0, 0, arg);
          _traverse_qual_graph_edges(qe->qual, d, qtf, arg);
        }
    }
}
                                     ...
                                     bool first, bool bidi, void *arg)
{
  ...
  if (left->kind == qk_constant || !data->po_bounds_only ||
      (interesting_scan_dir(left, ((void *)0)) & dir_backward))
    data->f(left, right, loc, p, first, bidi, data->arg);
}
                                     ...
                                     bool first, bool bidi, void *arg)
{
  ...
  if (right->kind == qk_constant || !data->po_bounds_only ||
      (interesting_scan_dir(right, ((void *)0)) & dir_forward))
    data->f(left, right, loc, p, first, bidi, data->arg);
}
                                     ...
                                     bool first, bool bidi, void *arg)
{
  ...
  if (left->kind == qk_constant || right->kind == qk_constant ||
      !data->po_bounds_only ||
      interesting_scan_dir(left, ((void *)0)) ||
      interesting_scan_dir(right, ((void *)0)))
    data->f(left, right, loc, p, first, bidi, data->arg);
}
                               ...
                               edge_traverse_fn f, void *arg)
{
  ...
  data.arg = arg;
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 2833, __PRETTY_FUNCTION__), 0)));
  if (po_bounds_only &&
      (interesting_scan_dir(q, ((void *)0)) == (dir_forward | dir_backward)))
      {
...
void print_qual_graph_edge(qual left, qual right, location loc, polarity p,
                                     bool first, bool bidi, void *arg)
{
...
static void update_error_count(qual q)
{
  int i;
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 2897, __PRETTY_FUNCTION__), 0)));
  ...
  if (i == num_hotspots)
    {
      ...
      if (j < num_hotspots)
        {
          memmove (hotspots + j + 1, hotspots + j,
                   (num_hotspots - j - 1) * sizeof (qual));
          hotspots[j] = q;
        }
    }
  else if (hotspots[i] != ((void *)0) && i != 0)
    {
      int j;
      for (j = i; j > 0; j--)
...
static void increment_error_count(qual q)
{
  if (!hotspots)
    return;
  q = ecr_qual(q);
  ((void) ((q->kind == qk_variable) ? 0 : (__assert_fail ("q->kind == qk_variable", "quals.c", 2952, __PRETTY_FUNCTION__), 0)));
  q->u.var.num_errors++;
...
static void increment_error_counts(qual left, qual right)
{
  ...
  if (left->kind == qk_constant && right->kind == qk_constant)
    ...
    traverse_qual_graph_nodes(left, 1, increment_error_count_func, ((void *)0));
  else
    {
      ((void) ((right->kind == qk_variable) ? 0 : (__assert_fail ("right->kind == qk_variable", "quals.c", 2981, __PRETTY_FUNCTION__), 0)));
      traverse_qual_graph_nodes(right, 1, increment_error_count_func, ((void *)0));
    }
}
void print_qual_edges(qual q)
{
  ...
  qual_edge qe;
  for (qual_edge_set_scan(q->u.var.lb, &qes), qe = qual_edge_set_next(&qes); qe; qe = qual_edge_set_next(&qes))
    printf("%s %p <= %s %p\n", name_qual(qe->qual), ecr_qual(qe->qual),
           name_qual(q), ecr_qual(q));
  for (qual_edge_set_scan(q->u.var.ub, &qes), qe = qual_edge_set_next(&qes); qe; qe = qual_edge_set_next(&qes))
    printf("%s %p <= %s %p\n", name_qual(q), ecr_qual(q),
           name_qual(qe->qual), ecr_qual(qe->qual));
}
const char CANON_IDENT_7351b5898863dbd3b2229c5e6896996d[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/quals.c";
