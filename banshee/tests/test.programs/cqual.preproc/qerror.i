...
static region qerror_region = ((void *)0);
bool qerrors = 0;
growbuf qual_error_detail = ((void *)0);
growbuf qtype_error_detail = ((void *)0);
void init_qerror(void)
{
  ((void) ((!qerror_region) ? 0 : (__assert_fail ("!qerror_region", "qerror.c", 35, __PRETTY_FUNCTION__), 0)));
  qerror_region = newregion();
  qual_error_detail = growbuf_new(qerror_region, 256);
  qtype_error_detail = growbuf_new(qerror_region, 256);
  ((void) ((!qerrors) ? 0 : (__assert_fail ("!qerrors", "qerror.c", 39, __PRETTY_FUNCTION__), 0)));
}
int qual_ed_printf(const char *fmt, ...)
{
  va_list args;
...
const char CANON_IDENT_e461976b2a7f071380e9c56039b7bb86[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/qerror.c";
