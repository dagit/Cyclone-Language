...
{
  dd_list_pos new = (sizeof(struct dd_list_pos) < (1 << (13 - 3)) ? (((void)0), __rc_ralloc_small0)((r), sizeof(struct dd_list_pos)) : (((void)0), __rc_typed_ralloc)((r), sizeof(struct dd_list_pos), 0));
  new->data = data;
...
dd_list dd_new_list(region r)
{
  dd_list new = (sizeof(struct dd_list) < (1 << (13 - 3)) ? (((void)0), __rc_ralloc_small0)((r), sizeof(struct dd_list)) : (((void)0), __rc_typed_ralloc)((r), sizeof(struct dd_list), 0));
...
void dd_remove(dd_list_pos what)
{
  ...
  what->next = what->previous = ((void *)0);
  what->data = ((void *)0);
}
dd_list_pos dd_first(dd_list l)
{
...
unsigned long dd_length(dd_list l)
{
  dd_list_pos scan;
  unsigned long len = 0;
  for (scan = dd_first((l)); !(!(scan)->next); scan = ((scan)->next)) len++;
  return len;
}
void dd_append(dd_list l1, dd_list l2)
{
  ...
  l1->last = l2->last;
  l2->first = l2->last = ((void *)0);
}
dd_list dd_copy(region r, dd_list l)
{
  dd_list new = dd_new_list(r);
  dd_list_pos scan;
  for (scan = dd_first((l)); !(!(scan)->next); scan = ((scan)->next)) dd_add_last(r, new, scan->data);
  return new;
}
void dd_free_list(dd_list l, void (*delete)(dd_list_pos p))
{
  ...
  while (!(!(scan)->next))
    {
      ...
      scan->next = scan->previous = ((void *)0);
      scan->data = ((void *)0);
      scan = next;
    }
  l->first = l->last = ((void *)0);
}
dd_list_pos dd_find(dd_list l, void *find)
{
  dd_list_pos scan;
  for (scan = dd_first((l)); !(!(scan)->next); scan = ((scan)->next))
    if (((void *)((scan)->data)) == find) return scan;
  return ((void *)0);
}
dd_list_pos dd_search(dd_list l, dd_cmp_fn f, void *find)
{
  dd_list_pos scan;
  for (scan = dd_first((l)); !(!(scan)->next); scan = ((scan)->next))
    if (f(((void *)((scan)->data)), find) == 0) return scan;
  return ((void *)0);
}
...
void dd_sort (dd_list l, dd_cmp_fn f)
{
  ...
  count = dd_length(l);
  scratch = newregion();
  buf = (((void)0), __rc_typed_rarrayalloc)((scratch), (count), sizeof(void *), 0);
  i = 0;
  for (scan = dd_first((l)); !(!(scan)->next); scan = ((scan)->next))
    {
      buf[i] = ((void *)((scan)->data));
      i++;
    }
  cur_sort_fn = f;
...
void dd_remove_all_matches_from (dd_list_pos begin,
                                 dd_cmp_fn f, void* find)
{
  dd_list_pos scan;
  dd_list_pos next;
  for (scan = begin; !(!(scan)->next); scan = next)
    {
      next = ((scan)->next);
      if (f(((void *)((scan)->data)), find) == 0)
        dd_remove(scan);
    }
}
void dd_remove_dups(dd_list l, dd_cmp_fn f)
{
  dd_list_pos scan;
  for (scan = dd_first((l)); !(!(scan)->next); scan = ((scan)->next))
    dd_remove_all_matches_from (((scan)->next), f, ((void *)((scan)->data)));
}
const char CANON_IDENT_07a6691ba7d3fcab4112b2bd17b9b2ca[] = "CANON_IDENT_/moa/sc1/jkodumal/work/banshee/experiments/cqual/src/dd_list.c";
