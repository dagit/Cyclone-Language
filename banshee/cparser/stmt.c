...
{
  statement sw = current_function_decl->current_loop;
...
void check_break(statement break_statement)
{
  ...
  break_statement->parent_loop = current_function_decl->current_loop;
}

void check_continue(statement continue_statement)
{
  statement loop = current_function_decl->current_loop;
