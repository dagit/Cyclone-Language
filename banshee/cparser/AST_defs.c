...
{
  assign obj = ralloc(r, struct AST_assign);
...
{
  adjust_rc obj = ralloc(r, struct AST_adjust_rc);

  obj->kind = kind_adjust_rc;
  obj->location = location;
  obj->lregion = PERROR;
  obj->rregion = PERROR;
  obj->arg1 = arg1;
  obj->incrementrc = incrementrc;
...
{
  generic_rc obj = ralloc(r, struct AST_generic_rc);

  obj->kind = kind_generic_rc;
  obj->location = location;
  obj->lregion = PERROR;
  obj->rregion = PERROR;
  obj->arg1 = arg1;
...
{
  update_rc obj = ralloc(r, struct AST_update_rc);

  obj->kind = kind_update_rc;
  obj->location = location;
  obj->lregion = PERROR;
  obj->rregion = PERROR;
  obj->arg1 = arg1;
...
{
  adjust_function_decl obj = ralloc(r, struct AST_adjust_function_decl);

  obj->kind = kind_adjust_function_decl;
  obj->location = location;
...
{
  adjustarray_function_decl obj = ralloc(r, struct AST_adjustarray_function_decl);

  obj->kind = kind_adjustarray_function_decl;
  obj->location = location;
...
{
  update_function_decl obj = ralloc(r, struct AST_update_function_decl);

  obj->kind = kind_update_function_decl;
  obj->location = location;
...
{
  global_rc obj = ralloc(r, struct AST_generic_rc);

  obj->kind = kind_global_rc;
  obj->location = location;
  obj->lregion = PERROR;
  obj->rregion = PERROR;
  obj->arg1 = arg1;
...
{ return CAST(global_rc, ast_chain(CAST(node, l1), CAST(node, l2))); }
