...
case kind_adjust_rc: {
  adjust_rc x = CAST(adjust_rc, n);

  AST_set_parent_list(&x->arg1, n);
  break;
}
case kind_generic_rc: case kind_global_rc: {
  generic_rc x = CAST(generic_rc, n);
...
case kind_update_rc: {
  update_rc x = CAST(update_rc, n);

  AST_set_parent_list(&x->arg1, n);
  AST_set_parent_list(&x->arg2, n);
  break;
}
case kind_adjust_function_decl: break;
case kind_adjustarray_function_decl: break;
case kind_update_function_decl: break;
