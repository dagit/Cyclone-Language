...
case kind_adjust_function_decl: puts("adjust_function_decl"); break;
case kind_adjustarray_function_decl: puts("adjustarray_function_decl"); break;
case kind_update_function_decl: puts("update_function_decl"); break;
