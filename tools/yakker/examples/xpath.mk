...
$(GrammarName)-flat-dfa.txt: examples/$(GrammarName).bnf yakker
	./yakker -flatten-full -earley-gen-fsm start examples/$(GrammarName).bnf > $@
...
$(GrammarName)-tg-dfa.cyc: gen/$(GrammarName)-tg.bnf yakker
	./yakker -flatten-full -no-minus-elim -cyc-namespace $(GrammarNSPrefix)TGCycDFA -earley-gen-cyc start $< > $@
