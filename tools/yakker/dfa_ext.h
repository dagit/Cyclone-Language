...
extern st_t construct_repeat_dfa(DFA::edfa_t ed, act_t next,st_t target_s, st_t final);
}
...
#define DFA_R_EXTEND(dfa,nt,nt_start,repeat_follow)  \
  EXT_DFA_NAMESPACE::construct_repeat_dfa(dfa,nt,nt_start,repeat_follow)
