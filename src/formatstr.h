...
extern List::list_t<Absyn::type_t,`r> get_format_typs(region_t<`r>, Tcenv::tenv_t, string_t, Position::seg_t);

// Same as above, but the rules and types are different for scanf
extern List::list_t<Absyn::type_t,`r> get_scanf_typs(region_t<`r>, Tcenv::tenv_t, string_t, Position::seg_t);
