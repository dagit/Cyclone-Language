...
extern List::list_t<Absyn::type_t> get_format_typs(Tcenv::tenv_t, string, Position::seg_t);

// Same as above, but the rules and types are different for scanf
extern List::list_t<Absyn::type_t> get_scanf_typs(Tcenv::tenv_t,string, Position::seg_t);
