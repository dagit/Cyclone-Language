...
_tmp6A)),((_tmp6A->hd=(void*)(((struct _tuple2*)x->hd)[
_check_known_subscript_notnull(1,0)]).f1,((_tmp6A->tl=0,_tmp6A)))))));}{struct
Cyc_List_List*_tmp6B;prev2=(result2=((_tmp6B=_region_malloc(r4,sizeof(*_tmp6B)),((
_tmp6B->hd=(void*)(((struct _tuple2*)x->hd)[_check_known_subscript_notnull(1,0)]).f2,((
_tmp6B->tl=0,_tmp6B)))))));}for(x=x->tl;x != 0;x=x->tl){{struct Cyc_List_List*
_tmp6C;temp1=((_tmp6C=_region_malloc(r3,sizeof(*_tmp6C)),((_tmp6C->hd=(void*)(((
struct _tuple2*)x->hd)[_check_known_subscript_notnull(1,0)]).f1,((_tmp6C->tl=0,
_tmp6C))))));}{struct Cyc_List_List*_tmp6D;temp2=((_tmp6D=_region_malloc(r4,
sizeof(*_tmp6D)),((_tmp6D->hd=(void*)(((struct _tuple2*)x->hd)[
_check_known_subscript_notnull(1,0)]).f2,((_tmp6D->tl=0,_tmp6D))))));}prev1->tl=(
struct Cyc_List_List*)temp1;prev2->tl=(struct Cyc_List_List*)temp2;prev1=temp1;
prev2=temp2;}{struct _tuple0 _tmp6E;return(_tmp6E.f1=(struct Cyc_List_List*)result1,((
_tmp6E.f2=(struct Cyc_List_List*)result2,_tmp6E)));}}struct _tuple0 Cyc_List_split(
...
Cyc_List_List*prev3;struct Cyc_List_List*temp3;if(x == 0){struct _tuple1 _tmp6F;
return(_tmp6F.f1=0,((_tmp6F.f2=0,((_tmp6F.f3=0,_tmp6F)))));}{struct Cyc_List_List*
_tmp70;prev1=(result1=((_tmp70=_region_malloc(r3,sizeof(*_tmp70)),((_tmp70->hd=(
void*)(((struct _tuple3*)x->hd)[_check_known_subscript_notnull(1,0)]).f1,((_tmp70->tl=
0,_tmp70)))))));}{struct Cyc_List_List*_tmp71;prev2=(result2=((_tmp71=
_region_malloc(r4,sizeof(*_tmp71)),((_tmp71->hd=(void*)(((struct _tuple3*)x->hd)[
_check_known_subscript_notnull(1,0)]).f2,((_tmp71->tl=0,_tmp71)))))));}{struct
Cyc_List_List*_tmp72;prev3=(result3=((_tmp72=_region_malloc(r5,sizeof(*_tmp72)),((
_tmp72->hd=(void*)(((struct _tuple3*)x->hd)[_check_known_subscript_notnull(1,0)]).f3,((
_tmp72->tl=0,_tmp72)))))));}for(x=x->tl;x != 0;x=x->tl){{struct Cyc_List_List*
_tmp73;temp1=((_tmp73=_region_malloc(r3,sizeof(*_tmp73)),((_tmp73->hd=(void*)(((
struct _tuple3*)x->hd)[_check_known_subscript_notnull(1,0)]).f1,((_tmp73->tl=0,
_tmp73))))));}{struct Cyc_List_List*_tmp74;temp2=((_tmp74=_region_malloc(r4,
sizeof(*_tmp74)),((_tmp74->hd=(void*)(((struct _tuple3*)x->hd)[
_check_known_subscript_notnull(1,0)]).f2,((_tmp74->tl=0,_tmp74))))));}{struct Cyc_List_List*
_tmp75;temp3=((_tmp75=_region_malloc(r5,sizeof(*_tmp75)),((_tmp75->hd=(void*)(((
struct _tuple3*)x->hd)[_check_known_subscript_notnull(1,0)]).f3,((_tmp75->tl=0,
_tmp75))))));}prev1->tl=(struct Cyc_List_List*)temp1;prev2->tl=(struct Cyc_List_List*)
...
int)_throw((void*)& Cyc_Core_Not_found_val);}void*Cyc_List_assoc_cmp(int(*cmp)(
void*,void*),struct Cyc_List_List*l,void*x);void*Cyc_List_assoc_cmp(int(*cmp)(
void*,void*),struct Cyc_List_List*l,void*x){while(l != 0){if(cmp((*((struct _tuple2*)
l->hd)).f1,x)== 0)return(*((struct _tuple2*)l->hd)).f2;l=l->tl;}(int)_throw((void*)&
Cyc_Core_Not_found_val);}struct Cyc_List_List*Cyc_List_delete_cmp(int(*cmp)(void*,
void*),struct Cyc_List_List*l,void*x);struct Cyc_List_List*Cyc_List_delete_cmp(int(*
...
Cyc_List_List*x);struct Cyc_Core_Opt*Cyc_List_check_unique(int(*cmp)(void*,void*),
struct Cyc_List_List*x){while(x != 0){struct Cyc_List_List*_tmp30=x->tl;if(_tmp30 != 
0){if(cmp((void*)x->hd,(void*)_tmp30->hd)== 0){struct Cyc_Core_Opt*_tmp77;return(
