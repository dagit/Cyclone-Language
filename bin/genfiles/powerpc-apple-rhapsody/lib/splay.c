...
_tag_dynforward(_tmp46,sizeof(char),_get_zero_arr_size_char(_tmp46,19)))),_tmp47)))),
_tmp45)))));}_LL0:;}static void Cyc_Splay_rotate_right(struct _RegionHandle*r,
struct Cyc_Splay_noderef*nr);static void Cyc_Splay_rotate_right(struct _RegionHandle*
r,struct Cyc_Splay_noderef*nr){struct Cyc_Splay_node*_tmpD=nr->v;void*_tmpE=(void*)
_tmpD->right;struct Cyc_Splay_noderef*_tmpF;_LL6: if(_tmpE <= (void*)1)goto _LL8;if(*((
int*)_tmpE)!= 0)goto _LL8;_tmpF=((struct Cyc_Splay_Node_struct*)_tmpE)->f1;_LL7: {
struct Cyc_Splay_node*_tmp10=_tmpF->v;struct Cyc_Splay_Node_struct _tmp51;struct Cyc_Splay_node*
_tmp50;struct Cyc_Splay_noderef*_tmp4F;struct Cyc_Splay_Node_struct*_tmp4E;struct
Cyc_Splay_Node_struct*_tmp11=(_tmp4E=_region_malloc(r,sizeof(*_tmp4E)),((_tmp4E[
0]=((_tmp51.tag=0,((_tmp51.f1=((_tmp4F=_region_malloc(r,sizeof(*_tmp4F)),((
_tmp4F->v=((_tmp50=_region_malloc(r,sizeof(*_tmp50)),((_tmp50->key=(void*)((void*)
_tmpD->key),((_tmp50->data=(void*)((void*)_tmpD->data),((_tmp50->left=(void*)((
void*)_tmpD->left),((_tmp50->right=(void*)((void*)_tmp10->left),_tmp50)))))))))),
_tmp4F)))),_tmp51)))),_tmp4E)));{struct Cyc_Splay_node*_tmp52;nr->v=((_tmp52=
_region_malloc(r,sizeof(*_tmp52)),((_tmp52->key=(void*)((void*)_tmp10->key),((
_tmp52->data=(void*)((void*)_tmp10->data),((_tmp52->left=(void*)((void*)_tmp11),((
_tmp52->right=(void*)((void*)_tmp10->right),_tmp52))))))))));}goto _LL5;}_LL8:;
_LL9: {struct Cyc_Core_Invalid_argument_struct _tmp58;const char*_tmp57;struct Cyc_Core_Invalid_argument_struct*
_tmp56;(int)_throw((void*)((_tmp56=_cycalloc(sizeof(*_tmp56)),((_tmp56[0]=((
_tmp58.tag=Cyc_Core_Invalid_argument,((_tmp58.f1=((_tmp57="Splay::rotate_right",
_tag_dynforward(_tmp57,sizeof(char),_get_zero_arr_size_char(_tmp57,20)))),_tmp58)))),
_tmp56)))));}_LL5:;}struct _tuple0{void*f1;struct Cyc_Splay_noderef*f2;};static
void Cyc_Splay_lift(struct _RegionHandle*r,struct Cyc_List_List*dnl);static void Cyc_Splay_lift(
...
_RegionHandle _tmp2C=_new_region("temp");struct _RegionHandle*temp=& _tmp2C;
_push_region(temp);{struct Cyc_List_List*path=0;while(1){void*_tmp2D=tree;struct
Cyc_Splay_noderef*_tmp2E;_LL1F: if(_tmp2D <= (void*)1)goto _LL21;if(*((int*)_tmp2D)
!= 0)goto _LL21;_tmp2E=((struct Cyc_Splay_Node_struct*)_tmp2D)->f1;_LL20: {struct
Cyc_Splay_node*_tmp2F=_tmp2E->v;int _tmp30=reln(reln_first_arg,(void*)_tmp2F->key);
if(_tmp30 == 0){Cyc_Splay_lift(r,path);{int _tmp31=1;_npop_handler(0);return _tmp31;}}
else{if(_tmp30 < 0){{struct _tuple0*_tmp5B;struct Cyc_List_List*_tmp5A;path=((
_tmp5A=_region_malloc(temp,sizeof(*_tmp5A)),((_tmp5A->hd=((_tmp5B=_region_malloc(
temp,sizeof(*_tmp5B)),((_tmp5B->f1=(void*)((void*)0),((_tmp5B->f2=_tmp2E,_tmp5B)))))),((
_tmp5A->tl=path,_tmp5A))))));}tree=(void*)_tmp2F->left;}else{{struct _tuple0*
_tmp5E;struct Cyc_List_List*_tmp5D;path=((_tmp5D=_region_malloc(temp,sizeof(*
_tmp5D)),((_tmp5D->hd=((_tmp5E=_region_malloc(temp,sizeof(*_tmp5E)),((_tmp5E->f1=(
void*)((void*)1),((_tmp5E->f2=_tmp2E,_tmp5E)))))),((_tmp5D->tl=path,_tmp5D))))));}
tree=(void*)_tmp2F->right;}}goto _LL1E;}_LL21: if((int)_tmp2D != 0)goto _LL1E;_LL22:
if(path != 0)Cyc_Splay_lift(r,path->tl);{int _tmp36=0;_npop_handler(0);return
_tmp36;}_LL1E:;}};_pop_region(temp);}int Cyc_Splay_splay(int(*reln)(void*,void*),
