...
_dynforward_ptr*f1;unsigned int f2;struct _dynforward_ptr f3;};struct _tuple1{
unsigned int f1;void*f2;};struct Cyc_Typerep_Tuple_struct{int tag;unsigned int f1;
struct _dynforward_ptr f2;};struct _tuple2{unsigned int f1;struct _dynforward_ptr f2;}
...
int tag;struct _dynforward_ptr*f1;int f2;struct _dynforward_ptr f3;};struct _tuple4{
int f1;void*f2;};struct _tuple4 Cyc_Typerep_get_unionbranch(unsigned int tag,struct
...
char*tag;struct _dynforward_ptr f1;};int Cyc_strcmp(struct _dynforward_ptr s1,struct
_dynforward_ptr s2);int isprint(int);struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(
...
int f2;};struct _tuple7{struct _dynforward_ptr f1;int f2;};struct _tuple6 Cyc_Marshal_empty_addr_index();
...
_tmp2AA;return(_tmp2AA.f1=_tag_dynforward(((_tmp2AE=(unsigned int)1,((_tmp2AD=(
...
unsigned int**_tmp2B0,int*_tmp14,struct _dynforward_ptr*_tmp13){for(*_tmp2B3=0;*
_tmp2B3 < *_tmp2B2;(*_tmp2B3)++){(*_tmp2B0)[*_tmp2B3]=*_tmp2B3 < *_tmp14?*((
unsigned int*)_check_dynforward_subscript(*_tmp13,sizeof(unsigned int),(int)*
_tmp2B3)): 0;}}static struct _tuple7 Cyc_Marshal_table_insert(struct _tuple7 tbl,
unsigned int i){struct _dynforward_ptr _tmp13;int _tmp14;struct _tuple7 _tmp12=tbl;
_tmp13=_tmp12.f1;_tmp14=_tmp12.f2;if(_get_dynforward_size(_tmp13,sizeof(
unsigned int))== _tmp14){unsigned int _tmp2B3;unsigned int _tmp2B2;struct
_dynforward_ptr _tmp2B1;unsigned int*_tmp2B0;unsigned int _tmp2AF;_tmp13=((_tmp2AF=(
unsigned int)(2 * _tmp14),((_tmp2B0=(unsigned int*)_cycalloc_atomic(_check_times(
sizeof(unsigned int),_tmp2AF)),((_tmp2B1=_tag_dynforward(_tmp2B0,sizeof(
unsigned int),_tmp2AF),((((_tmp2B2=_tmp2AF,_tmp2B4(& _tmp2B3,& _tmp2B2,& _tmp2B0,&
_tmp14,& _tmp13))),_tmp2B1))))))));}*((unsigned int*)_check_dynforward_subscript(
...
tbl,int i){return*((unsigned int*)_check_dynforward_subscript(tbl.f1,sizeof(
...
fp,((_tmp2B8="NULL",_tag_dynforward(_tmp2B8,sizeof(char),_get_zero_arr_size_char(
_tmp2B8,5)))),_tag_dynforward(_tmp2B7,sizeof(void*),0)));}else{const char*_tmp2BC;
void*_tmp2BB[1];struct Cyc_Int_pa_struct _tmp2BA;(_tmp2BA.tag=1,((_tmp2BA.f1=ref,((
_tmp2BB[0]=& _tmp2BA,Cyc_fprintf(fp,((_tmp2BC="(#%x)",_tag_dynforward(_tmp2BC,
sizeof(char),_get_zero_arr_size_char(_tmp2BC,6)))),_tag_dynforward(_tmp2BB,
...
_dynforward_ptr*_tmp25;struct _dynforward_ptr _tmp26;struct _dynforward_ptr _tmp27;
struct _dynforward_ptr _tmp28;struct _dynforward_ptr _tmp29;struct _dynforward_ptr
_tmp2A;struct _dynforward_ptr _tmp2B;struct _dynforward_ptr _tmp2C;struct
_dynforward_ptr _tmp2D;struct _dynforward_ptr _tmp2E;struct _dynforward_ptr _tmp2F;
struct _dynforward_ptr*_tmp30;struct _dynforward_ptr _tmp31;int _tmp32;struct
_dynforward_ptr _tmp33;_LL1: if(_tmp1F <= (void*)2)goto _LL3;if(*((int*)_tmp1F)!= 0)
goto _LL3;_tmp20=((struct Cyc_Typerep_Int_struct*)_tmp1F)->f1;_tmp21=((struct Cyc_Typerep_Int_struct*)
_tmp1F)->f2;_LL2: switch(_tmp21){case 8: _LL19: {char*x=((char*(*)(void*x))
unsafe_cast)(val);if(isprint((int)*x)){const char*_tmp2C0;void*_tmp2BF[1];struct
Cyc_Int_pa_struct _tmp2BE;(_tmp2BE.tag=1,((_tmp2BE.f1=(unsigned long)((int)*x),((
_tmp2BF[0]=& _tmp2BE,Cyc_fprintf(fp,((_tmp2C0="'%c'",_tag_dynforward(_tmp2C0,
sizeof(char),_get_zero_arr_size_char(_tmp2C0,5)))),_tag_dynforward(_tmp2BF,
sizeof(void*),1)))))));}else{const char*_tmp2C4;void*_tmp2C3[1];struct Cyc_Int_pa_struct
_tmp2C2;(_tmp2C2.tag=1,((_tmp2C2.f1=(unsigned long)((int)*x),((_tmp2C3[0]=&
_tmp2C2,Cyc_fprintf(fp,((_tmp2C4="'\\%d'",_tag_dynforward(_tmp2C4,sizeof(char),
_get_zero_arr_size_char(_tmp2C4,6)))),_tag_dynforward(_tmp2C3,sizeof(void*),1)))))));}
break;}case 16: _LL1A: {short*x=((short*(*)(void*x))unsafe_cast)(val);{const char*
_tmp2CA;const char*_tmp2C9;void*_tmp2C8[1];struct Cyc_Int_pa_struct _tmp2C7;(
_tmp2C7.tag=1,((_tmp2C7.f1=(unsigned long)((int)*x),((_tmp2C8[0]=& _tmp2C7,Cyc_fprintf(
fp,_tmp20?(_tmp2C9="%d",_tag_dynforward(_tmp2C9,sizeof(char),
_get_zero_arr_size_char(_tmp2C9,3))):((_tmp2CA="%u",_tag_dynforward(_tmp2CA,
sizeof(char),_get_zero_arr_size_char(_tmp2CA,3)))),_tag_dynforward(_tmp2C8,
sizeof(void*),1)))))));}break;}case 32: _LL1B: {int*x=((int*(*)(void*x))
unsafe_cast)(val);{const char*_tmp2D0;const char*_tmp2CF;void*_tmp2CE[1];struct Cyc_Int_pa_struct
_tmp2CD;(_tmp2CD.tag=1,((_tmp2CD.f1=(unsigned long)*x,((_tmp2CE[0]=& _tmp2CD,Cyc_fprintf(
fp,_tmp20?(_tmp2CF="%d",_tag_dynforward(_tmp2CF,sizeof(char),
_get_zero_arr_size_char(_tmp2CF,3))):((_tmp2D0="%u",_tag_dynforward(_tmp2D0,
sizeof(char),_get_zero_arr_size_char(_tmp2D0,3)))),_tag_dynforward(_tmp2CE,
sizeof(void*),1)))))));}break;}default: _LL1C:{const char*_tmp2D4;void*_tmp2D3[1];
struct Cyc_Int_pa_struct _tmp2D2;(_tmp2D2.tag=1,((_tmp2D2.f1=(unsigned long)((int)
_tmp21),((_tmp2D3[0]=& _tmp2D2,Cyc_fprintf(Cyc_stderr,((_tmp2D4="fprint_type_base: illegal int size %d bits\n",
_tag_dynforward(_tmp2D4,sizeof(char),_get_zero_arr_size_char(_tmp2D4,44)))),
_tag_dynforward(_tmp2D3,sizeof(void*),1)))))));}exit(1);}goto _LL0;_LL3: if((int)
_tmp1F != 0)goto _LL5;_LL4: {float*x=((float*(*)(void*x))unsafe_cast)(val);{const
char*_tmp2D8;void*_tmp2D7[1];struct Cyc_Double_pa_struct _tmp2D6;(_tmp2D6.tag=2,((
_tmp2D6.f1=(double)*x,((_tmp2D7[0]=& _tmp2D6,Cyc_fprintf(fp,((_tmp2D8="%f",
_tag_dynforward(_tmp2D8,sizeof(char),_get_zero_arr_size_char(_tmp2D8,3)))),
_tag_dynforward(_tmp2D7,sizeof(void*),1)))))));}goto _LL0;}_LL5: if((int)_tmp1F != 
1)goto _LL7;_LL6: {double*x=((double*(*)(void*x))unsafe_cast)(val);{const char*
_tmp2DC;void*_tmp2DB[1];struct Cyc_Double_pa_struct _tmp2DA;(_tmp2DA.tag=2,((
_tmp2DA.f1=*x,((_tmp2DB[0]=& _tmp2DA,Cyc_fprintf(fp,((_tmp2DC="%f",
_tag_dynforward(_tmp2DC,sizeof(char),_get_zero_arr_size_char(_tmp2DC,3)))),
_tag_dynforward(_tmp2DB,sizeof(void*),1)))))));}goto _LL0;}_LL7: if(_tmp1F <= (void*)
...
_tmp2E0="{(@%x) ",_tag_dynforward(_tmp2E0,sizeof(char),_get_zero_arr_size_char(
_tmp2E0,8)))),_tag_dynforward(_tmp2DF,sizeof(void*),1)))))));}if(y != 0){int
typ_szb=(int)Cyc_Typerep_size_type(_tmp23);int i=0;for(0;i < _tmp22;++ i){env=Cyc_Marshal_fprint_type_base(
_tmp23,env,fp,((void*(*)(int x))unsafe_cast)(y));if(i != _tmp22 - 1){const char*
_tmp2E3;void*_tmp2E2;(_tmp2E2=0,Cyc_fprintf(fp,((_tmp2E3=", ",_tag_dynforward(
_tmp2E3,sizeof(char),_get_zero_arr_size_char(_tmp2E3,3)))),_tag_dynforward(
_tmp2E2,sizeof(void*),0)));}y +=typ_szb;}}else{const char*_tmp2E6;void*_tmp2E5;(
_tmp2E5=0,Cyc_fprintf(fp,((_tmp2E6="NULL",_tag_dynforward(_tmp2E6,sizeof(char),
_get_zero_arr_size_char(_tmp2E6,5)))),_tag_dynforward(_tmp2E5,sizeof(void*),0)));}{
const char*_tmp2E9;void*_tmp2E8;(_tmp2E8=0,Cyc_fprintf(fp,((_tmp2E9=" }",
_tag_dynforward(_tmp2E9,sizeof(char),_get_zero_arr_size_char(_tmp2E9,3)))),
_tag_dynforward(_tmp2E8,sizeof(void*),0)));}}else{Cyc_Marshal_fprint_ref(fp,(
unsigned int)y);}goto _LL0;}_LL9: if(_tmp1F <= (void*)2)goto _LLB;if(*((int*)_tmp1F)
!= 2)goto _LLB;_tmp24=(void*)((struct Cyc_Typerep_FatPtr_struct*)_tmp1F)->f1;_LLA: {
...
_tmp5A=_tmp59.f1;_tmp5B=_tmp59.f2;env=_tmp5B;if(!_tmp5A){{const char*_tmp2ED;void*
_tmp2EC[1];struct Cyc_Int_pa_struct _tmp2EB;(_tmp2EB.tag=1,((_tmp2EB.f1=base,((
_tmp2EC[0]=& _tmp2EB,Cyc_fprintf(fp,((_tmp2ED="[(@%x) ",_tag_dynforward(_tmp2ED,
sizeof(char),_get_zero_arr_size_char(_tmp2ED,8)))),_tag_dynforward(_tmp2EC,
sizeof(void*),1)))))));}{unsigned int i=base;for(0;i < last_plus_one;i +=typ_szb){
env=Cyc_Marshal_fprint_type_base(_tmp24,env,fp,((void*(*)(unsigned int x))
unsafe_cast)(i));if(i + typ_szb < last_plus_one){const char*_tmp2F0;void*_tmp2EF;(
_tmp2EF=0,Cyc_fprintf(fp,((_tmp2F0=", ",_tag_dynforward(_tmp2F0,sizeof(char),
_get_zero_arr_size_char(_tmp2F0,3)))),_tag_dynforward(_tmp2EF,sizeof(void*),0)));}}}{
const char*_tmp2F3;void*_tmp2F2;(_tmp2F2=0,Cyc_fprintf(fp,((_tmp2F3=" ]",
_tag_dynforward(_tmp2F3,sizeof(char),_get_zero_arr_size_char(_tmp2F3,3)))),
_tag_dynforward(_tmp2F2,sizeof(void*),0)));}}else{Cyc_Marshal_fprint_ref(fp,base);}
goto _LL0;}_LLB: if(_tmp1F <= (void*)2)goto _LLD;if(*((int*)_tmp1F)!= 3)goto _LLD;
_tmp25=((struct Cyc_Typerep_Struct_struct*)_tmp1F)->f1;_tmp26=((struct Cyc_Typerep_Struct_struct*)
_tmp1F)->f3;_LLC: if(_tmp25 == 0){const char*_tmp2F6;void*_tmp2F5;(_tmp2F5=0,Cyc_fprintf(
fp,((_tmp2F6="{ ",_tag_dynforward(_tmp2F6,sizeof(char),_get_zero_arr_size_char(
_tmp2F6,3)))),_tag_dynforward(_tmp2F5,sizeof(void*),0)));}else{const char*_tmp2FA;
void*_tmp2F9[1];struct Cyc_String_pa_struct _tmp2F8;(_tmp2F8.tag=0,((_tmp2F8.f1=(
struct _dynforward_ptr)((struct _dynforward_ptr)*_tmp25),((_tmp2F9[0]=& _tmp2F8,Cyc_fprintf(
fp,((_tmp2FA="%s{ ",_tag_dynforward(_tmp2FA,sizeof(char),_get_zero_arr_size_char(
_tmp2FA,5)))),_tag_dynforward(_tmp2F9,sizeof(void*),1)))))));}{int x=((int(*)(
void*x))unsafe_cast)(val);{int i=0;for(0;i < _get_dynforward_size(_tmp26,sizeof(
struct _tuple0*));++ i){unsigned int _tmp69;struct _dynforward_ptr _tmp6A;void*_tmp6B;
struct _tuple0 _tmp68=*(*((struct _tuple0**)_check_dynforward_subscript(_tmp26,
...
0,((_tmp2FC.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)_tmp6A),((_tmp2FD[
0]=& _tmp2FC,Cyc_fprintf(fp,((_tmp2FE="%s=",_tag_dynforward(_tmp2FE,sizeof(char),
_get_zero_arr_size_char(_tmp2FE,4)))),_tag_dynforward(_tmp2FD,sizeof(void*),1)))))));}{
int x_ofs=(int)(x + _tmp69);env=Cyc_Marshal_fprint_type_base(_tmp6B,env,fp,((void*(*)(
int x))unsafe_cast)(x_ofs));if(i != _get_dynforward_size(_tmp26,sizeof(struct
_tuple0*))- 1){const char*_tmp301;void*_tmp300;(_tmp300=0,Cyc_fprintf(fp,((
_tmp301=", ",_tag_dynforward(_tmp301,sizeof(char),_get_zero_arr_size_char(
_tmp301,3)))),_tag_dynforward(_tmp300,sizeof(void*),0)));}}}}{const char*_tmp304;
void*_tmp303;(_tmp303=0,Cyc_fprintf(fp,((_tmp304=" }",_tag_dynforward(_tmp304,
sizeof(char),_get_zero_arr_size_char(_tmp304,3)))),_tag_dynforward(_tmp303,
sizeof(void*),0)));}goto _LL0;}_LLD: if(_tmp1F <= (void*)2)goto _LLF;if(*((int*)
_tmp1F)!= 4)goto _LLF;_tmp27=((struct Cyc_Typerep_Tuple_struct*)_tmp1F)->f2;_LLE:{
const char*_tmp307;void*_tmp306;(_tmp306=0,Cyc_fprintf(fp,((_tmp307="$( ",
_tag_dynforward(_tmp307,sizeof(char),_get_zero_arr_size_char(_tmp307,4)))),
_tag_dynforward(_tmp306,sizeof(void*),0)));}{int x=((int(*)(void*x))unsafe_cast)(
val);{int i=0;for(0;i < _get_dynforward_size(_tmp27,sizeof(struct _tuple1*));++ i){
unsigned int _tmp76;void*_tmp77;struct _tuple1 _tmp75=*(*((struct _tuple1**)
_check_dynforward_subscript(_tmp27,sizeof(struct _tuple1*),i)));_tmp76=_tmp75.f1;
_tmp77=_tmp75.f2;{int x_ofs=(int)(x + _tmp76);env=Cyc_Marshal_fprint_type_base(
_tmp77,env,fp,((void*(*)(int x))unsafe_cast)(x_ofs));if(i != _get_dynforward_size(
_tmp27,sizeof(struct _tuple1*))- 1){const char*_tmp30A;void*_tmp309;(_tmp309=0,Cyc_fprintf(
fp,((_tmp30A=", ",_tag_dynforward(_tmp30A,sizeof(char),_get_zero_arr_size_char(
_tmp30A,3)))),_tag_dynforward(_tmp309,sizeof(void*),0)));}}}}{const char*_tmp30D;
void*_tmp30C;(_tmp30C=0,Cyc_fprintf(fp,((_tmp30D=" )",_tag_dynforward(_tmp30D,
sizeof(char),_get_zero_arr_size_char(_tmp30D,3)))),_tag_dynforward(_tmp30C,
sizeof(void*),0)));}goto _LL0;}_LLF: if(_tmp1F <= (void*)2)goto _LL11;if(*((int*)
_tmp1F)!= 6)goto _LL11;_tmp28=((struct Cyc_Typerep_TUnionField_struct*)_tmp1F)->f1;
...
_dynforward_ptr)((struct _dynforward_ptr)_tmp29),((_tmp310.tag=0,((_tmp310.f1=(
struct _dynforward_ptr)((struct _dynforward_ptr)_tmp28),((_tmp311[0]=& _tmp310,((
_tmp311[1]=& _tmp30F,Cyc_fprintf(fp,((_tmp312="%s.%s(",_tag_dynforward(_tmp312,
sizeof(char),_get_zero_arr_size_char(_tmp312,7)))),_tag_dynforward(_tmp311,
sizeof(void*),2)))))))))))));}{int x=((int(*)(void*x))unsafe_cast)(val);{int i=1;
for(0;i < _get_dynforward_size(_tmp2A,sizeof(struct _tuple1*));++ i){unsigned int
_tmp81;void*_tmp82;struct _tuple1 _tmp80=*(*((struct _tuple1**)
_check_dynforward_subscript(_tmp2A,sizeof(struct _tuple1*),i)));_tmp81=_tmp80.f1;
_tmp82=_tmp80.f2;{int x_ofs=(int)(x + _tmp81);env=Cyc_Marshal_fprint_type_base(
_tmp82,env,fp,((void*(*)(int x))unsafe_cast)(x_ofs));if(i != _get_dynforward_size(
_tmp2A,sizeof(struct _tuple1*))- 1){const char*_tmp315;void*_tmp314;(_tmp314=0,Cyc_fprintf(
fp,((_tmp315=", ",_tag_dynforward(_tmp315,sizeof(char),_get_zero_arr_size_char(
_tmp315,3)))),_tag_dynforward(_tmp314,sizeof(void*),0)));}}}}{const char*_tmp318;
void*_tmp317;(_tmp317=0,Cyc_fprintf(fp,((_tmp318=" )",_tag_dynforward(_tmp318,
sizeof(char),_get_zero_arr_size_char(_tmp318,3)))),_tag_dynforward(_tmp317,
sizeof(void*),0)));}goto _LL0;}_LL11: if(_tmp1F <= (void*)2)goto _LL13;if(*((int*)
_tmp1F)!= 5)goto _LL13;_tmp2B=((struct Cyc_Typerep_TUnion_struct*)_tmp1F)->f1;
...
_tmp31A;(_tmp31A.tag=0,((_tmp31A.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)Cyc_Typerep_get_tagname(*tagp,_tmp2C)),((_tmp31B[0]=& _tmp31A,Cyc_fprintf(
fp,((_tmp31C="%s",_tag_dynforward(_tmp31C,sizeof(char),_get_zero_arr_size_char(
_tmp31C,3)))),_tag_dynforward(_tmp31B,sizeof(void*),1)))))));}else{struct _tuple8
_tmp8B;int _tmp8C;struct Cyc_Set_Set*_tmp8D;struct _tuple8*_tmp8A=Cyc_Marshal_member_insert(
env,*tagp);_tmp8B=*_tmp8A;_tmp8C=_tmp8B.f1;_tmp8D=_tmp8B.f2;env=_tmp8D;if(!
_tmp8C){{const char*_tmp320;void*_tmp31F[1];struct Cyc_Int_pa_struct _tmp31E;(
_tmp31E.tag=1,((_tmp31E.f1=*tagp,((_tmp31F[0]=& _tmp31E,Cyc_fprintf(fp,((_tmp320="(@%x)",
_tag_dynforward(_tmp320,sizeof(char),_get_zero_arr_size_char(_tmp320,6)))),
_tag_dynforward(_tmp31F,sizeof(void*),1)))))));}{unsigned int*x=((unsigned int*(*)(
unsigned int x))unsafe_cast)(*tagp);unsigned int tag=*x;int _tmp92;void*_tmp93;
struct _tuple4 _tmp91=Cyc_Typerep_get_unionbranch(tag,_tmp2D);_tmp92=_tmp91.f1;
_tmp93=_tmp91.f2;{void*xoff=((void*(*)(unsigned int x))unsafe_cast)(*tagp + _tmp92);{
const char*_tmp324;void*_tmp323[1];struct Cyc_String_pa_struct _tmp322;(_tmp322.tag=
0,((_tmp322.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Typerep_get_tagname2(
tag,_tmp2D)),((_tmp323[0]=& _tmp322,Cyc_fprintf(fp,((_tmp324="&%s[",
_tag_dynforward(_tmp324,sizeof(char),_get_zero_arr_size_char(_tmp324,5)))),
_tag_dynforward(_tmp323,sizeof(void*),1)))))));}env=Cyc_Marshal_fprint_type_base(
_tmp93,env,fp,xoff);{const char*_tmp327;void*_tmp326;(_tmp326=0,Cyc_fprintf(fp,((
_tmp327="]",_tag_dynforward(_tmp327,sizeof(char),_get_zero_arr_size_char(_tmp327,
2)))),_tag_dynforward(_tmp326,sizeof(void*),0)));}}}}else{Cyc_Marshal_fprint_ref(
fp,*tagp);}}goto _LL0;}_LL13: if(_tmp1F <= (void*)2)goto _LL15;if(*((int*)_tmp1F)!= 
7)goto _LL15;_tmp2E=((struct Cyc_Typerep_XTUnion_struct*)_tmp1F)->f1;_tmp2F=((
struct Cyc_Typerep_XTUnion_struct*)_tmp1F)->f2;_LL14: {unsigned int*xtunionp=((
unsigned int*(*)(void*x))unsafe_cast)(val);struct _tuple8 _tmp9A;int _tmp9B;struct
Cyc_Set_Set*_tmp9C;struct _tuple8*_tmp99=Cyc_Marshal_member_insert(env,*xtunionp);
_tmp9A=*_tmp99;_tmp9B=_tmp9A.f1;_tmp9C=_tmp9A.f2;env=_tmp9C;if(!_tmp9B){{const
char*_tmp32B;void*_tmp32A[1];struct Cyc_Int_pa_struct _tmp329;(_tmp329.tag=1,((
_tmp329.f1=*xtunionp,((_tmp32A[0]=& _tmp329,Cyc_fprintf(fp,((_tmp32B="(@%x)",
_tag_dynforward(_tmp32B,sizeof(char),_get_zero_arr_size_char(_tmp32B,6)))),
_tag_dynforward(_tmp32A,sizeof(void*),1)))))));}{unsigned int*xtstructp=((
unsigned int*(*)(unsigned int x))unsafe_cast)(*xtunionp);if(*xtstructp != 0){char*
xtnamec=((char*(*)(unsigned int x))unsafe_cast)(*xtstructp + 4);struct
_dynforward_ptr xtname=(struct _dynforward_ptr)Cstring_to_string(xtnamec);{const
char*_tmp32F;void*_tmp32E[1];struct Cyc_String_pa_struct _tmp32D;(_tmp32D.tag=0,((
_tmp32D.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)xtname),((_tmp32E[0]=&
_tmp32D,Cyc_fprintf(fp,((_tmp32F="&%s[( ",_tag_dynforward(_tmp32F,sizeof(char),
_get_zero_arr_size_char(_tmp32F,7)))),_tag_dynforward(_tmp32E,sizeof(void*),1)))))));}{
int _tmpA4;void*_tmpA5;struct _tuple4 _tmpA3=Cyc_Typerep_get_xtunionbranch(xtname,
...
_tag_dynforward(_tmp332,sizeof(char),_get_zero_arr_size_char(_tmp332,4)))),
_tag_dynforward(_tmp331,sizeof(void*),0)));}}}}else{char*xtnamec=((char*(*)(
unsigned int x))unsafe_cast)(*xtunionp + 4);struct _dynforward_ptr xtname=(struct
_dynforward_ptr)Cstring_to_string(xtnamec);const char*_tmp336;void*_tmp335[1];
struct Cyc_String_pa_struct _tmp334;(_tmp334.tag=0,((_tmp334.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)xtname),((_tmp335[0]=& _tmp334,Cyc_fprintf(
fp,((_tmp336="%s",_tag_dynforward(_tmp336,sizeof(char),_get_zero_arr_size_char(
_tmp336,3)))),_tag_dynforward(_tmp335,sizeof(void*),1)))))));}}}else{Cyc_Marshal_fprint_ref(
fp,*xtunionp);}goto _LL0;}_LL15: if(_tmp1F <= (void*)2)goto _LL17;if(*((int*)_tmp1F)
!= 8)goto _LL17;_tmp30=((struct Cyc_Typerep_Union_struct*)_tmp1F)->f1;_tmp31=((
struct Cyc_Typerep_Union_struct*)_tmp1F)->f3;_LL16: if(_tmp30 == 0){const char*
_tmp339;void*_tmp338;(_tmp338=0,Cyc_fprintf(fp,((_tmp339="{",_tag_dynforward(
_tmp339,sizeof(char),_get_zero_arr_size_char(_tmp339,2)))),_tag_dynforward(
_tmp338,sizeof(void*),0)));}else{const char*_tmp33D;void*_tmp33C[1];struct Cyc_String_pa_struct
_tmp33B;(_tmp33B.tag=0,((_tmp33B.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)*_tmp30),((_tmp33C[0]=& _tmp33B,Cyc_fprintf(fp,((_tmp33D="%s{",
_tag_dynforward(_tmp33D,sizeof(char),_get_zero_arr_size_char(_tmp33D,4)))),
_tag_dynforward(_tmp33C,sizeof(void*),1)))))));}{int i=0;for(0;i < 
_get_dynforward_size(_tmp31,sizeof(struct _tuple3*));++ i){struct _dynforward_ptr
_tmpB1;void*_tmpB2;struct _tuple3 _tmpB0=*(*((struct _tuple3**)
_check_dynforward_subscript(_tmp31,sizeof(struct _tuple3*),i)));_tmpB1=_tmpB0.f1;
_tmpB2=_tmpB0.f2;{const char*_tmp341;void*_tmp340[1];struct Cyc_String_pa_struct
_tmp33F;(_tmp33F.tag=0,((_tmp33F.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)_tmpB1),((_tmp340[0]=& _tmp33F,Cyc_fprintf(fp,((_tmp341="%s=",
_tag_dynforward(_tmp341,sizeof(char),_get_zero_arr_size_char(_tmp341,4)))),
_tag_dynforward(_tmp340,sizeof(void*),1)))))));}Cyc_Marshal_fprint_type_base(
_tmpB2,env,fp,val);if(i < _get_dynforward_size(_tmp31,sizeof(struct _tuple3*))- 1){
const char*_tmp344;void*_tmp343;(_tmp343=0,Cyc_fprintf(fp,((_tmp344=" | ",
_tag_dynforward(_tmp344,sizeof(char),_get_zero_arr_size_char(_tmp344,4)))),
_tag_dynforward(_tmp343,sizeof(void*),0)));}}}{const char*_tmp347;void*_tmp346;(
_tmp346=0,Cyc_fprintf(fp,((_tmp347="}",_tag_dynforward(_tmp347,sizeof(char),
_get_zero_arr_size_char(_tmp347,2)))),_tag_dynforward(_tmp346,sizeof(void*),0)));}
...
_tmp349.tag=0,((_tmp349.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Typerep_get_tagname(*
tagp,_tmp33)),((_tmp34A[0]=& _tmp349,Cyc_fprintf(fp,((_tmp34B="%s",
_tag_dynforward(_tmp34B,sizeof(char),_get_zero_arr_size_char(_tmp34B,3)))),
_tag_dynforward(_tmp34A,sizeof(void*),1)))))));}goto _LL0;}_LL0:;}return env;}void
Cyc_Marshal_fprint_type(void*ts,struct Cyc___cycFILE*fp,void*val);void Cyc_Marshal_fprint_type(
...
_exn_thrown;void*_tmpC1=_tmpBE;struct _dynforward_ptr _tmpC2;_LL1F: if(*((void**)
_tmpC1)!= Cyc_Core_Failure)goto _LL21;_tmpC2=((struct Cyc_Core_Failure_struct*)
_tmpC1)->f1;_LL20:{const char*_tmp34F;void*_tmp34E[1];struct Cyc_String_pa_struct
_tmp34D;(_tmp34D.tag=0,((_tmp34D.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)_tmpC2),((_tmp34E[0]=& _tmp34D,Cyc_fprintf(Cyc_stderr,((_tmp34F="Core::Failure(%s)\n",
_tag_dynforward(_tmp34F,sizeof(char),_get_zero_arr_size_char(_tmp34F,19)))),
_tag_dynforward(_tmp34E,sizeof(void*),1)))))));}{struct Cyc_Core_Failure_struct
_tmp352;struct Cyc_Core_Failure_struct*_tmp351;(int)_throw((void*)((_tmp351=
_cycalloc(sizeof(*_tmp351)),((_tmp351[0]=((_tmp352.tag=Cyc_Core_Failure,((
_tmp352.f1=_tmpC2,_tmp352)))),_tmp351)))));}_LL21:;_LL22:(void)_throw(_tmpC1);
...
fp){struct Cyc_Core_Failure_struct _tmp358;const char*_tmp357;struct Cyc_Core_Failure_struct*
_tmp356;(int)_throw((void*)((_tmp356=_cycalloc(sizeof(*_tmp356)),((_tmp356[0]=((
_tmp358.tag=Cyc_Core_Failure,((_tmp358.f1=((_tmp357="Write failure",
_tag_dynforward(_tmp357,sizeof(char),_get_zero_arr_size_char(_tmp357,14)))),
...
_tmp35E.f1=((_tmp35D="Write failure",_tag_dynforward(_tmp35D,sizeof(char),
_get_zero_arr_size_char(_tmp35D,14)))),_tmp35E)))),_tmp35C)))));}void Cyc_Marshal_cycputint(
int x,struct Cyc___cycFILE*fp);void Cyc_Marshal_cycputint(int x,struct Cyc___cycFILE*
fp){struct Cyc_Core_Failure_struct _tmp364;const char*_tmp363;struct Cyc_Core_Failure_struct*
_tmp362;(int)_throw((void*)((_tmp362=_cycalloc(sizeof(*_tmp362)),((_tmp362[0]=((
_tmp364.tag=Cyc_Core_Failure,((_tmp364.f1=((_tmp363="Write failure",
_tag_dynforward(_tmp363,sizeof(char),_get_zero_arr_size_char(_tmp363,14)))),
...
_tmp36A.f1=((_tmp369="Write failure",_tag_dynforward(_tmp369,sizeof(char),
_get_zero_arr_size_char(_tmp369,14)))),_tmp36A)))),_tmp368)))));}void Cyc_Marshal_cycputdouble(
double x,struct Cyc___cycFILE*fp);void Cyc_Marshal_cycputdouble(double x,struct Cyc___cycFILE*
fp){struct Cyc_Core_Failure_struct _tmp370;const char*_tmp36F;struct Cyc_Core_Failure_struct*
_tmp36E;(int)_throw((void*)((_tmp36E=_cycalloc(sizeof(*_tmp36E)),((_tmp36E[0]=((
_tmp370.tag=Cyc_Core_Failure,((_tmp370.f1=((_tmp36F="Write failure",
_tag_dynforward(_tmp36F,sizeof(char),_get_zero_arr_size_char(_tmp36F,14)))),
...
char*_tmp372;unsigned int _tmp371;struct _dynforward_ptr x=_tag_dynforward(((
_tmp371=sizeof(char),((_tmp372=(char*)_region_malloc(r,_check_times(sizeof(char),
_tmp371)),((((_tmp373=_tmp371,_tmp375(& _tmp374,& _tmp373,& _tmp372))),_tmp372)))))),
sizeof(char),sizeof(char));if(Cyc_fread(x,sizeof(char),1,fp)< 1){struct Cyc_Core_Failure_struct
...
_tmp37B.f1=((_tmp37A="Read failure",_tag_dynforward(_tmp37A,sizeof(char),
_get_zero_arr_size_char(_tmp37A,13)))),_tmp37B)))),_tmp379)))));}{char*xx=((char*(*)(
char*x))unsafe_cast)((char*)_check_null(_untag_dynforward_ptr(x,sizeof(char),1)));
char _tmpDB=*xx;_npop_handler(0);return _tmpDB;}};_pop_region(r);}short Cyc_Marshal_cycgetshort(
...
struct _dynforward_ptr x=_tag_dynforward(((_tmp37C=sizeof(short),((_tmp37D=(char*)
...
_tmp385="Read failure",_tag_dynforward(_tmp385,sizeof(char),
_get_zero_arr_size_char(_tmp385,13)))),_tmp386)))),_tmp384)))));}{short*xx=((
short*(*)(char*x))unsafe_cast)((char*)_check_null(_untag_dynforward_ptr(x,
sizeof(char),1)));short _tmpE3=*xx;_npop_handler(0);return _tmpE3;}};_pop_region(r);}
int Cyc_Marshal_cycgetint(struct Cyc___cycFILE*fp);static void _tmp38B(unsigned int*
_tmp38A,unsigned int*_tmp389,char**_tmp388){for(*_tmp38A=0;*_tmp38A < *_tmp389;(*
_tmp38A)++){(*_tmp388)[*_tmp38A]='\000';}}int Cyc_Marshal_cycgetint(struct Cyc___cycFILE*
fp){struct _RegionHandle _tmpE7=_new_region("r");struct _RegionHandle*r=& _tmpE7;
_push_region(r);{unsigned int _tmp38A;unsigned int _tmp389;char*_tmp388;
unsigned int _tmp387;struct _dynforward_ptr x=_tag_dynforward(((_tmp387=sizeof(int),((
_tmp388=(char*)_region_malloc(r,_check_times(sizeof(char),_tmp387)),((((_tmp389=
_tmp387,_tmp38B(& _tmp38A,& _tmp389,& _tmp388))),_tmp388)))))),sizeof(char),sizeof(
int));if(Cyc_fread(x,sizeof(int),1,fp)< 1){struct Cyc_Core_Failure_struct _tmp391;
const char*_tmp390;struct Cyc_Core_Failure_struct*_tmp38F;(int)_throw((void*)((
_tmp38F=_cycalloc(sizeof(*_tmp38F)),((_tmp38F[0]=((_tmp391.tag=Cyc_Core_Failure,((
_tmp391.f1=((_tmp390="Read failure",_tag_dynforward(_tmp390,sizeof(char),
...
struct Cyc___cycFILE*fp);static void _tmp396(char**_tmp393,unsigned int*_tmp395,
unsigned int*_tmp394){for(*_tmp395=0;*_tmp395 < *_tmp394;(*_tmp395)++){(*_tmp393)[*
...
_tmp393,& _tmp395,& _tmp394))),_tmp393)))))),sizeof(char),sizeof(float));if(Cyc_fread(
...
_tmp39B="Read failure",_tag_dynforward(_tmp39B,sizeof(char),
_get_zero_arr_size_char(_tmp39B,13)))),_tmp39C)))),_tmp39A)))));}{float*xx=((
float*(*)(char*x))unsafe_cast)((char*)_check_null(_untag_dynforward_ptr(x,
sizeof(char),1)));float _tmpF3=*xx;_npop_handler(0);return _tmpF3;}};_pop_region(r);}
double Cyc_Marshal_cycgetdouble(struct Cyc___cycFILE*fp);static void _tmp3A1(
unsigned int*_tmp3A0,unsigned int*_tmp39F,char**_tmp39E){for(*_tmp3A0=0;*_tmp3A0
< *_tmp39F;(*_tmp3A0)++){(*_tmp39E)[*_tmp3A0]='\000';}}double Cyc_Marshal_cycgetdouble(
struct Cyc___cycFILE*fp){struct _RegionHandle _tmpF7=_new_region("r");struct
_RegionHandle*r=& _tmpF7;_push_region(r);{unsigned int _tmp3A0;unsigned int _tmp39F;
char*_tmp39E;unsigned int _tmp39D;struct _dynforward_ptr x=_tag_dynforward(((
_tmp39D=sizeof(double),((_tmp39E=(char*)_region_malloc(r,_check_times(sizeof(
char),_tmp39D)),((((_tmp39F=_tmp39D,_tmp3A1(& _tmp3A0,& _tmp39F,& _tmp39E))),
_tmp39E)))))),sizeof(char),sizeof(double));if(Cyc_fread(x,sizeof(double),1,fp)< 
1){struct Cyc_Core_Failure_struct _tmp3A7;const char*_tmp3A6;struct Cyc_Core_Failure_struct*
_tmp3A5;(int)_throw((void*)((_tmp3A5=_cycalloc(sizeof(*_tmp3A5)),((_tmp3A5[0]=((
_tmp3A7.tag=Cyc_Core_Failure,((_tmp3A7.f1=((_tmp3A6="Read failure",
_tag_dynforward(_tmp3A6,sizeof(char),_get_zero_arr_size_char(_tmp3A6,13)))),
_tmp3A7)))),_tmp3A5)))));}{double*xx=((double*(*)(char*x))unsafe_cast)((char*)
_check_null(_untag_dynforward_ptr(x,sizeof(char),1)));double _tmpFB=*xx;
...
_tmp102;void*_tmp103;struct _dynforward_ptr _tmp104;struct _dynforward_ptr _tmp105;
struct _dynforward_ptr _tmp106;struct _dynforward_ptr _tmp107;struct _dynforward_ptr
_tmp108;struct _dynforward_ptr _tmp109;int _tmp10A;int _tmp10B;_LL24: if(_tmpFF <= (
...
_tag_dynforward(_tmp3AB,sizeof(char),_get_zero_arr_size_char(_tmp3AB,43)))),
_tag_dynforward(_tmp3AA,sizeof(void*),1)))))));}exit(1);}goto _LL23;_LL26: if((int)
_tmpFF != 0)goto _LL28;_LL27: {float*x=((float*(*)(void*x))unsafe_cast)(val);Cyc_Marshal_cycputfloat(*
...
_tmpFF <= (void*)2)goto _LL2C;if(*((int*)_tmpFF)!= 1)goto _LL2C;_tmp101=((struct Cyc_Typerep_ThinPtr_struct*)
...
_get_dynforward_size(_tmp104,sizeof(struct _tuple0*));++ i){unsigned int _tmp112;
void*_tmp113;struct _tuple0 _tmp111=*(*((struct _tuple0**)
_check_dynforward_subscript(_tmp104,sizeof(struct _tuple0*),i)));_tmp112=_tmp111.f1;
...
_get_dynforward_size(_tmp105,sizeof(struct _tuple1*));++ i){unsigned int _tmp115;
void*_tmp116;struct _tuple1 _tmp114=*(*((struct _tuple1**)
_check_dynforward_subscript(_tmp105,sizeof(struct _tuple1*),i)));_tmp115=_tmp114.f1;
...
_get_dynforward_size(_tmp106,sizeof(struct _tuple1*));++ i){unsigned int _tmp118;
void*_tmp119;struct _tuple1 _tmp117=*(*((struct _tuple1**)
_check_dynforward_subscript(_tmp106,sizeof(struct _tuple1*),i)));_tmp118=_tmp117.f1;
...
_dynforward_ptr xtname=(struct _dynforward_ptr)Cstring_to_string(xtnamec);{const
char*_tmp3AF;void*_tmp3AE[1];struct Cyc_String_pa_struct _tmp3AD;(_tmp3AD.tag=0,((
_tmp3AD.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)xtname),((_tmp3AE[0]=&
_tmp3AD,Cyc_fprintf(fp,((_tmp3AF="%s",_tag_dynforward(_tmp3AF,sizeof(char),
_get_zero_arr_size_char(_tmp3AF,3)))),_tag_dynforward(_tmp3AE,sizeof(void*),1)))))));}
...
char*(*)(unsigned int x))unsafe_cast)(*xtunionp + 4);struct _dynforward_ptr xtname=(
struct _dynforward_ptr)Cstring_to_string(xtnamec);{const char*_tmp3B3;void*_tmp3B2[
1];struct Cyc_String_pa_struct _tmp3B1;(_tmp3B1.tag=0,((_tmp3B1.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)xtname),((_tmp3B2[0]=& _tmp3B1,Cyc_fprintf(
fp,((_tmp3B3="%s",_tag_dynforward(_tmp3B3,sizeof(char),_get_zero_arr_size_char(
_tmp3B3,3)))),_tag_dynforward(_tmp3B2,sizeof(void*),1)))))));}Cyc_Marshal_cycputchar('\000',
fp);}}}}goto _LL23;}_LL38: if(_tmpFF <= (void*)2)goto _LL3A;if(*((int*)_tmpFF)!= 8)
goto _LL3A;_tmp10A=((struct Cyc_Typerep_Union_struct*)_tmpFF)->f2;_LL39:{struct Cyc_Typerep_Tuple_struct
_tmp3CC;unsigned int _tmp3CB;unsigned int _tmp3CA;struct _dynforward_ptr _tmp3C9;
...
_check_times(sizeof(struct _tuple1*),_tmp3C7)),((_tmp3C9=_tag_dynforward(_tmp3C8,
...
_tmp134;struct _dynforward_ptr _tmp138;_LL42: if(*((void**)_tmp137)!= Cyc_Core_Failure)
...
_tmp3D1.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)_tmp138),((_tmp3D2[0]=&
_tmp3D1,Cyc_fprintf(Cyc_stderr,((_tmp3D3="Core::Failure(%s)\n",_tag_dynforward(
_tmp3D3,sizeof(char),_get_zero_arr_size_char(_tmp3D3,19)))),_tag_dynforward(
_tmp3D2,sizeof(void*),1)))))));}{struct Cyc_Core_Failure_struct _tmp3D6;struct Cyc_Core_Failure_struct*
_tmp3D5;(int)_throw((void*)((_tmp3D5=_cycalloc(sizeof(*_tmp3D5)),((_tmp3D5[0]=((
_tmp3D6.tag=Cyc_Core_Failure,((_tmp3D6.f1=_tmp138,_tmp3D6)))),_tmp3D5)))));}
_LL44:;_LL45:(void)_throw(_tmp137);_LL41:;}}}void Cyc_Marshal_fscanntstring(
struct Cyc___cycFILE*fp,struct _dynforward_ptr s);void Cyc_Marshal_fscanntstring(
struct Cyc___cycFILE*fp,struct _dynforward_ptr s){int c;int i=0;while((c=Cyc_fgetc(fp))
!= '\000'){if(c == - 1){struct Cyc_Core_Failure_struct _tmp3DC;const char*_tmp3DB;
struct Cyc_Core_Failure_struct*_tmp3DA;(int)_throw((void*)((_tmp3DA=_cycalloc(
sizeof(*_tmp3DA)),((_tmp3DA[0]=((_tmp3DC.tag=Cyc_Core_Failure,((_tmp3DC.f1=((
_tmp3DB="Read error",_tag_dynforward(_tmp3DB,sizeof(char),
_get_zero_arr_size_char(_tmp3DB,11)))),_tmp3DC)))),_tmp3DA)))));}{char _tmp3DF;
char _tmp3DE;struct _dynforward_ptr _tmp3DD;(_tmp3DD=_dynforward_ptr_plus(s,sizeof(
char),i),((_tmp3DE=*((char*)_check_dynforward_subscript(_tmp3DD,sizeof(char),0)),((
_tmp3DF=(char)c,((_get_dynforward_size(_tmp3DD,sizeof(char))== 1  && (_tmp3DE == '\000'
 && _tmp3DF != '\000')?_throw_arraybounds(): 1,*((char*)_tmp3DD.curr)=_tmp3DF)))))));}
++ i;}{char _tmp3E2;char _tmp3E1;struct _dynforward_ptr _tmp3E0;(_tmp3E0=
_dynforward_ptr_plus(s,sizeof(char),i),((_tmp3E1=*((char*)
_check_dynforward_subscript(_tmp3E0,sizeof(char),0)),((_tmp3E2='\000',((
_get_dynforward_size(_tmp3E0,sizeof(char))== 1  && (_tmp3E1 == '\000'  && _tmp3E2 != '\000')?
...
unsigned int _tmp149;void*_tmp14A;void*_tmp14B;struct _dynforward_ptr _tmp14C;
struct _dynforward_ptr _tmp14D;struct _dynforward_ptr _tmp14E;struct _dynforward_ptr
_tmp14F;struct _dynforward_ptr _tmp150;struct _dynforward_ptr _tmp151;int _tmp152;int
_tmp153;_LL47: if(_tmp147 <= (void*)2)goto _LL49;if(*((int*)_tmp147)!= 0)goto _LL49;
_tmp148=((struct Cyc_Typerep_Int_struct*)_tmp147)->f2;_LL48: switch(_tmp148){case 8:
_LL5F: {char*x=((char*(*)(void*x))unsafe_cast)(result);{char _tmp3E7;char _tmp3E6;
struct _dyneither_ptr _tmp3E5;char*_tmp3E4;(_tmp3E5=((_tmp3E4=x,_tag_dyneither(
_tmp3E4,sizeof(char),_get_zero_arr_size_char(_tmp3E4,1)))),((_tmp3E6=*((char*)
...
_tmp3ED.f1=((_tmp3EC="read_type_base: illegal int size bits",_tag_dynforward(
_tmp3EC,sizeof(char),_get_zero_arr_size_char(_tmp3EC,38)))),_tmp3ED)))),_tmp3EB)))));}}
goto _LL46;_LL49: if((int)_tmp147 != 0)goto _LL4B;_LL4A: {float*y=((float*(*)(void*x))
unsafe_cast)(result);*y=Cyc_Marshal_cycgetfloat(fp);goto _LL46;}_LL4B: if((int)
_tmp147 != 1)goto _LL4D;_LL4C: {double*y=((double*(*)(void*x))unsafe_cast)(result);*
y=Cyc_Marshal_cycgetdouble(fp);goto _LL46;}_LL4D: if(_tmp147 <= (void*)2)goto _LL4F;
if(*((int*)_tmp147)!= 1)goto _LL4F;_tmp149=((struct Cyc_Typerep_ThinPtr_struct*)
...
env,(unsigned int)mem)){int typ_szb=(int)Cyc_Typerep_size_type(_tmp14A);
unsigned int _tmp3F2;unsigned int _tmp3F1;struct _dynforward_ptr _tmp3F0;char*
_tmp3EF;unsigned int _tmp3EE;struct _dynforward_ptr buf=(_tmp3EE=_tmp149 * typ_szb,((
_tmp3EF=(char*)_cycalloc_atomic(_check_times(sizeof(char),_tmp3EE + 1)),((_tmp3F0=
_tag_dynforward(_tmp3EF,sizeof(char),_tmp3EE + 1),((((_tmp3F1=_tmp3EE,((_tmp3F3(&
_tmp3F2,& _tmp3F1,& _tmp3EF),_tmp3EF[_tmp3F1]=(char)0)))),_tmp3F0)))))));
unsigned int bufptr=(unsigned int)((char*)_check_null(_untag_dynforward_ptr(buf,
...
_get_dynforward_size(_tmp14C,sizeof(struct _tuple0*));++ i){unsigned int _tmp164;
void*_tmp165;struct _tuple0 _tmp163=*(*((struct _tuple0**)
_check_dynforward_subscript(_tmp14C,sizeof(struct _tuple0*),i)));_tmp164=_tmp163.f1;
...
void*x))unsafe_cast)(result);{int i=0;for(0;i < _get_dynforward_size(_tmp14D,
sizeof(struct _tuple1*));++ i){unsigned int _tmp167;void*_tmp168;struct _tuple1
_tmp166=*(*((struct _tuple1**)_check_dynforward_subscript(_tmp14D,sizeof(struct
...
for(0;i < _get_dynforward_size(_tmp14E,sizeof(struct _tuple1*));++ i){unsigned int
_tmp16A;void*_tmp16B;struct _tuple1 _tmp169=*(*((struct _tuple1**)
_check_dynforward_subscript(_tmp14E,sizeof(struct _tuple1*),i)));_tmp16A=_tmp169.f1;
...
_tmp3FD;struct _dynforward_ptr _tmp3FC;char*_tmp3FB;unsigned int _tmp3FA;struct
_dynforward_ptr buf=(_tmp3FA=_tmp16D + Cyc_Typerep_size_type(_tmp16E),((_tmp3FB=(
char*)_cycalloc_atomic(_check_times(sizeof(char),_tmp3FA + 1)),((_tmp3FC=
_tag_dynforward(_tmp3FB,sizeof(char),_tmp3FA + 1),((((_tmp3FD=_tmp3FA,((_tmp3FF(&
...
unsigned int _tmp405;struct _dynforward_ptr s=(_tmp409=((_tmp408=(unsigned int)100,((
...
_tmp407)))))),_tag_dynforward(_tmp409,sizeof(char),_get_zero_arr_size_char(
_tmp409,(unsigned int)100 + 1)));struct _dynforward_ptr xtname=_dynforward_ptr_plus(
s,sizeof(char),4);Cyc_Marshal_fscanntstring(fp,xtname);if((int)nonnull){int
_tmp174;void*_tmp175;struct _tuple4 _tmp173=Cyc_Typerep_get_xtunionbranch((struct
_dynforward_ptr)xtname,_tmp151);_tmp174=_tmp173.f1;_tmp175=_tmp173.f2;{
unsigned int _tmp40E;unsigned int _tmp40D;struct _dynforward_ptr _tmp40C;char*
_tmp40B;unsigned int _tmp40A;struct _dynforward_ptr buf=(_tmp40A=_tmp174 + Cyc_Typerep_size_type(
_tmp175),((_tmp40B=(char*)_cycalloc_atomic(_check_times(sizeof(char),_tmp40A + 1)),((
_tmp40C=_tag_dynforward(_tmp40B,sizeof(char),_tmp40A + 1),((((_tmp40D=_tmp40A,((
...
char*)_check_null(_untag_dynforward_ptr(s,sizeof(char),1 + 1)));env=Cyc_Marshal_rread_type_base(
...
unsigned int)((char*)_check_null(_untag_dynforward_ptr(s,sizeof(char),1 + 1)));
env=Cyc_Marshal_table_insert(env,*x);}}else{unsigned int*x=((unsigned int*(*)(
void*x))unsafe_cast)(result);*x=Cyc_Marshal_table_lookup(env,mem);}goto _LL46;}
_LL5B: if(_tmp147 <= (void*)2)goto _LL5D;if(*((int*)_tmp147)!= 8)goto _LL5D;_tmp152=((
struct Cyc_Typerep_Union_struct*)_tmp147)->f2;_LL5C:{struct Cyc_Typerep_Tuple_struct
_tmp428;unsigned int _tmp427;unsigned int _tmp426;struct _dynforward_ptr _tmp425;
...
_check_times(sizeof(struct _tuple1*),_tmp423)),((_tmp425=_tag_dynforward(_tmp424,
...
_tmp18B){{unsigned int _tmp430;unsigned int _tmp42F;struct _dynforward_ptr _tmp42E;
char*_tmp42D;unsigned int _tmp42C;struct _dynforward_ptr buf=(_tmp42C=Cyc_Typerep_size_type(
ts),((_tmp42D=(char*)_region_malloc(r,_check_times(sizeof(char),_tmp42C + 1)),((
_tmp42E=_tag_dynforward(_tmp42D,sizeof(char),_tmp42C + 1),((((_tmp42F=_tmp42C,((
_tmp431(& _tmp430,& _tmp42F,& _tmp42D),_tmp42D[_tmp42F]=(char)0)))),_tmp42E)))))));
void*result=((void*(*)(char*x))unsafe_cast)((char*)_check_null(
_untag_dynforward_ptr(buf,sizeof(char),1 + 1)));Cyc_Marshal_rread_type_base(r,ts,
...
_tmp192=_tmp18A;struct _dynforward_ptr _tmp193;_LL65: if(*((void**)_tmp192)!= Cyc_Core_Failure)
...
_tmp433.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)_tmp193),((_tmp434[0]=&
_tmp433,Cyc_fprintf(Cyc_stderr,((_tmp435="Core::Failure(%s)\n",_tag_dynforward(
_tmp435,sizeof(char),_get_zero_arr_size_char(_tmp435,19)))),_tag_dynforward(
_tmp434,sizeof(void*),1)))))));}{struct Cyc_Core_Failure_struct _tmp438;struct Cyc_Core_Failure_struct*
_tmp437;(int)_throw((void*)((_tmp437=_cycalloc(sizeof(*_tmp437)),((_tmp437[0]=((
_tmp438.tag=Cyc_Core_Failure,((_tmp438.f1=_tmp193,_tmp438)))),_tmp437)))));}
_LL67:;_LL68:(void)_throw(_tmp192);_LL64:;}}}void*Cyc_Marshal_read_type(void*ts,
struct Cyc___cycFILE*fp);void*Cyc_Marshal_read_type(void*ts,struct Cyc___cycFILE*
fp){return Cyc_Marshal_rread_type(Cyc_Core_heap_region,ts,fp);}static struct Cyc_Dict_Dict
Cyc_Marshal_empty_addr_map();static struct Cyc_Dict_Dict Cyc_Marshal_empty_addr_map(){
return((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,unsigned int k,unsigned int v))
Cyc_Dict_insert)(((struct Cyc_Dict_Dict(*)(int(*cmp)(unsigned int,unsigned int)))
Cyc_Dict_empty)(Cyc_Marshal_uint_cmp),0,0);}struct Cyc_Dict_Dict Cyc_Marshal_rcopy_type_base(
struct _RegionHandle*r,void*rep,struct Cyc_Dict_Dict env,void*val,void*result);
static void _tmp443(unsigned int*_tmp442,unsigned int*_tmp441,char**_tmp43F){for(*
_tmp442=0;*_tmp442 < *_tmp441;(*_tmp442)++){(*_tmp43F)[*_tmp442]='\000';}}static
void _tmp44A(unsigned int*_tmp449,unsigned int*_tmp448,char**_tmp446){for(*
_tmp449=0;*_tmp449 < *_tmp448;(*_tmp449)++){(*_tmp446)[*_tmp449]='\000';}}static
void _tmp451(unsigned int*_tmp450,unsigned int*_tmp44F,char**_tmp44D){for(*
_tmp450=0;*_tmp450 < *_tmp44F;(*_tmp450)++){(*_tmp44D)[*_tmp450]='\000';}}static
void _tmp457(unsigned int*_tmp456,unsigned int*_tmp455,char**_tmp453){for(*
_tmp456=0;*_tmp456 < *_tmp455;(*_tmp456)++){(*_tmp453)[*_tmp456]='\000';}}static
void _tmp463(unsigned int*_tmp462,unsigned int*_tmp461,struct _tuple1***_tmp45F){
for(*_tmp462=0;*_tmp462 < *_tmp461;(*_tmp462)++){struct Cyc_Typerep_Int_struct*
_tmp45D;struct Cyc_Typerep_Int_struct _tmp45C;struct _tuple1*_tmp45B;(*_tmp45F)[*
_tmp462]=((_tmp45B=_cycalloc(sizeof(*_tmp45B)),((_tmp45B->f1=*_tmp462,((_tmp45B->f2=(
void*)((_tmp45D=_cycalloc_atomic(sizeof(*_tmp45D)),((_tmp45D[0]=((_tmp45C.tag=0,((
_tmp45C.f1=0,((_tmp45C.f2=8,_tmp45C)))))),_tmp45D)))),_tmp45B))))));}}struct Cyc_Dict_Dict
...
void*_tmp1A0;struct _dynforward_ptr _tmp1A1;struct _dynforward_ptr _tmp1A2;struct
_dynforward_ptr _tmp1A3;struct _dynforward_ptr _tmp1A4;struct _dynforward_ptr _tmp1A5;
struct _dynforward_ptr _tmp1A6;int _tmp1A7;int _tmp1A8;_LL6A: if(_tmp199 <= (void*)2)
goto _LL72;if(*((int*)_tmp199)!= 0)goto _LL6C;_tmp19A=((struct Cyc_Typerep_Int_struct*)
_tmp199)->f2;if(_tmp19A != 8)goto _LL6C;_LL6B: {char*val0=((char*(*)(void*x))
unsafe_cast)(val);char*result0=((char*(*)(void*x))unsafe_cast)(result);{char
_tmp43D;char _tmp43C;struct _dyneither_ptr _tmp43B;char*_tmp43A;(_tmp43B=((_tmp43A=
result0,_tag_dyneither(_tmp43A,sizeof(char),_get_zero_arr_size_char(_tmp43A,1)))),((
...
_tmp19F);unsigned int _tmp442;unsigned int _tmp441;struct _dynforward_ptr _tmp440;
char*_tmp43F;unsigned int _tmp43E;struct _dynforward_ptr buf=(_tmp43E=_tmp19E * 
typ_szb,((_tmp43F=(char*)_region_malloc(r,_check_times(sizeof(char),_tmp43E + 1)),((
_tmp440=_tag_dynforward(_tmp43F,sizeof(char),_tmp43E + 1),((((_tmp441=_tmp43E,((
...
_dynforward_ptr _tmp447;char*_tmp446;unsigned int _tmp445;struct _dynforward_ptr buf=(
_tmp445=_tmp1B4 - _tmp1B2,((_tmp446=(char*)_region_malloc(r,_check_times(sizeof(
char),_tmp445 + 1)),((_tmp447=_tag_dynforward(_tmp446,sizeof(char),_tmp445 + 1),((((
...
_untag_dynforward_ptr(buf,sizeof(char),1 + 1)));{struct _tuple9 _tmp44B;*result0=((
...
for(0;i < _get_dynforward_size(_tmp1A1,sizeof(struct _tuple0*));++ i){unsigned int
_tmp1BD;void*_tmp1BE;struct _tuple0 _tmp1BC=*(*((struct _tuple0**)
_check_dynforward_subscript(_tmp1A1,sizeof(struct _tuple0*),i)));_tmp1BD=_tmp1BC.f1;
...
i=0;for(0;i < _get_dynforward_size(_tmp1A2,sizeof(struct _tuple1*));++ i){
unsigned int _tmp1C0;void*_tmp1C1;struct _tuple1 _tmp1BF=*(*((struct _tuple1**)
_check_dynforward_subscript(_tmp1A2,sizeof(struct _tuple1*),i)));_tmp1C0=_tmp1BF.f1;
...
result);{int i=0;for(0;i < _get_dynforward_size(_tmp1A3,sizeof(struct _tuple1*));++
i){unsigned int _tmp1C3;void*_tmp1C4;struct _tuple1 _tmp1C2=*(*((struct _tuple1**)
_check_dynforward_subscript(_tmp1A3,sizeof(struct _tuple1*),i)));_tmp1C3=_tmp1C2.f1;
...
unsigned int _tmp44F;struct _dynforward_ptr _tmp44E;char*_tmp44D;unsigned int
_tmp44C;struct _dynforward_ptr buf=(_tmp44C=_tmp1C6 + Cyc_Typerep_size_type(_tmp1C7),((
_tmp44D=(char*)_region_malloc(r,_check_times(sizeof(char),_tmp44C + 1)),((_tmp44E=
_tag_dynforward(_tmp44D,sizeof(char),_tmp44C + 1),((((_tmp44F=_tmp44C,((_tmp451(&
...
unsafe_cast)(xtnamep + 4);struct _dynforward_ptr xtname=(struct _dynforward_ptr)
...
unsigned int _tmp455;struct _dynforward_ptr _tmp454;char*_tmp453;unsigned int
_tmp452;struct _dynforward_ptr buf=(_tmp452=_tmp1CD + Cyc_Typerep_size_type(_tmp1CE),((
_tmp453=(char*)_region_malloc(r,_check_times(sizeof(char),_tmp452 + 1)),((_tmp454=
_tag_dynforward(_tmp453,sizeof(char),_tmp452 + 1),((((_tmp455=_tmp452,((_tmp457(&
...
struct _dynforward_ptr _tmp46D;struct _tuple1**_tmp46C;unsigned int _tmp46B;struct
Cyc_Typerep_Tuple_struct*_tmp46A;env=Cyc_Marshal_rcopy_type_base(r,(void*)((
_tmp46A=_cycalloc(sizeof(*_tmp46A)),((_tmp46A[0]=((_tmp470.tag=4,((_tmp470.f1=(
unsigned int)_tmp1A7,((_tmp470.f2=((_tmp46B=(unsigned int)_tmp1A7,((_tmp46C=(
struct _tuple1**)_cycalloc(_check_times(sizeof(struct _tuple1*),_tmp46B)),((
_tmp46D=_tag_dynforward(_tmp46C,sizeof(struct _tuple1*),_tmp46B),((((_tmp46E=
_tmp46B,_tmp463(& _tmp46F,& _tmp46E,& _tmp46C))),_tmp46D)))))))),_tmp470)))))),
_tmp46A)))),env,val,result);}goto _LL69;_LL86: if(*((int*)_tmp199)!= 9)goto _LL88;
_tmp1A8=((struct Cyc_Typerep_Enum_struct*)_tmp199)->f2;_LL87:{struct Cyc_Typerep_Int_struct
_tmp473;struct Cyc_Typerep_Int_struct*_tmp472;env=Cyc_Marshal_rcopy_type_base(r,(
void*)((_tmp472=_cycalloc_atomic(sizeof(*_tmp472)),((_tmp472[0]=((_tmp473.tag=0,((
_tmp473.f1=0,((_tmp473.f2=(unsigned int)(_tmp1A8 << 3),_tmp473)))))),_tmp472)))),
env,val,result);}goto _LL69;_LL88:;_LL89: {struct Cyc_Core_Failure_struct _tmp479;
const char*_tmp478;struct Cyc_Core_Failure_struct*_tmp477;(int)_throw((void*)((
_tmp477=_cycalloc(sizeof(*_tmp477)),((_tmp477[0]=((_tmp479.tag=Cyc_Core_Failure,((
_tmp479.f1=((_tmp478="Unhandled case in copy_type_base",_tag_dynforward(_tmp478,
sizeof(char),_get_zero_arr_size_char(_tmp478,33)))),_tmp479)))),_tmp477)))));}
_LL69:;}return env;}void*Cyc_Marshal_rcopy_type(struct _RegionHandle*r,void*ts,
void*val);static void _tmp47F(unsigned int*_tmp47E,unsigned int*_tmp47D,char**
_tmp47B){for(*_tmp47E=0;*_tmp47E < *_tmp47D;(*_tmp47E)++){(*_tmp47B)[*_tmp47E]='\000';}}
void*Cyc_Marshal_rcopy_type(struct _RegionHandle*r,void*ts,void*val){struct
...
_dynforward_ptr _tmp47C;char*_tmp47B;unsigned int _tmp47A;struct _dynforward_ptr buf=(
_tmp47A=Cyc_Typerep_size_type(ts),((_tmp47B=(char*)_region_malloc(r,_check_times(
sizeof(char),_tmp47A + 1)),((_tmp47C=_tag_dynforward(_tmp47B,sizeof(char),_tmp47A
+ 1),((((_tmp47D=_tmp47A,((_tmp47F(& _tmp47E,& _tmp47D,& _tmp47B),_tmp47B[_tmp47D]=(
char)0)))),_tmp47C)))))));void*result=((void*(*)(char*x))unsafe_cast)((char*)
_check_null(_untag_dynforward_ptr(buf,sizeof(char),1 + 1)));Cyc_Marshal_rcopy_type_base(
...
_tmp1EA=_tmp1E2;struct _dynforward_ptr _tmp1EB;_LL8B: if(*((void**)_tmp1EA)!= Cyc_Core_Failure)
...
_tmp481.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)_tmp1EB),((_tmp482[0]=&
_tmp481,Cyc_fprintf(Cyc_stderr,((_tmp483="Core::Failure(%s)\n",_tag_dynforward(
_tmp483,sizeof(char),_get_zero_arr_size_char(_tmp483,19)))),_tag_dynforward(
_tmp482,sizeof(void*),1)))))));}{struct Cyc_Core_Failure_struct _tmp486;struct Cyc_Core_Failure_struct*
_tmp485;(int)_throw((void*)((_tmp485=_cycalloc(sizeof(*_tmp485)),((_tmp485[0]=((
_tmp486.tag=Cyc_Core_Failure,((_tmp486.f1=_tmp1EB,_tmp486)))),_tmp485)))));}
_LL8D:;_LL8E:(void)_throw(_tmp1EA);_LL8A:;}}}void*Cyc_Marshal_copy_type(void*ts,
void*val);void*Cyc_Marshal_copy_type(void*ts,void*val){return Cyc_Marshal_rcopy_type(
Cyc_Core_heap_region,ts,val);}void*Cyc_Marshal_order_lex(void*ord1,void*ord2);
void*Cyc_Marshal_order_lex(void*ord1,void*ord2){if(ord1 != (void*)1)return ord1;
else{return ord2;}}struct _tuple10{unsigned int f1;unsigned int f2;};static int Cyc_Marshal_addrp_cmp(
struct _tuple10*addrp1,struct _tuple10*addrp2);static int Cyc_Marshal_addrp_cmp(
struct _tuple10*addrp1,struct _tuple10*addrp2){if((*addrp1).f1 < (*addrp2).f1)
return 1;else{if((*addrp1).f1 == (*addrp2).f1)return Cyc_Marshal_uint_cmp((*addrp1).f2,(*
...
unsigned int _tmp208;void*_tmp209;void*_tmp20A;struct _dynforward_ptr _tmp20B;
struct _dynforward_ptr _tmp20C;struct _dynforward_ptr _tmp20D;struct _dynforward_ptr
_tmp20E;struct _dynforward_ptr _tmp20F;struct _dynforward_ptr _tmp210;int _tmp211;
struct _dynforward_ptr _tmp212;int _tmp213;_LL90: if(_tmp1F7 <= (void*)2)goto _LLA0;
if(*((int*)_tmp1F7)!= 0)goto _LL92;_tmp1F8=((struct Cyc_Typerep_Int_struct*)
...
y);struct _tuple11 _tmp48A;return(_tmp48A.f1=*x0 == *y0?(void*)1:(*x0 <= *y0?(void*)
2:(void*)0),((_tmp48A.f2=env,_tmp48A)));}_LL92: if(*((int*)_tmp1F7)!= 0)goto _LL94;
...
int i=0;for(0;i < _get_dynforward_size(_tmp20B,sizeof(struct _tuple1*));++ i){
unsigned int _tmp23B;void*_tmp23C;struct _tuple1 _tmp23A=*(*((struct _tuple1**)
_check_dynforward_subscript(_tmp20B,sizeof(struct _tuple1*),i)));_tmp23B=_tmp23A.f1;
...
x))unsafe_cast)(y);void*ord=(void*)1;{int i=0;for(0;i < _get_dynforward_size(
_tmp20C,sizeof(struct _tuple0*));++ i){unsigned int _tmp242;void*_tmp243;struct
_tuple0 _tmp241=*(*((struct _tuple0**)_check_dynforward_subscript(_tmp20C,sizeof(
...
x))unsafe_cast)(y);void*ord=(void*)1;{int i=1;for(0;i < _get_dynforward_size(
_tmp20D,sizeof(struct _tuple1*));++ i){unsigned int _tmp249;void*_tmp24A;struct
_tuple1 _tmp248=*(*((struct _tuple1**)_check_dynforward_subscript(_tmp20D,sizeof(
...
unsigned int x))unsafe_cast)(*y0 + 4);struct _dynforward_ptr xname=(struct
_dynforward_ptr)Cstring_to_string(xnamec);struct _dynforward_ptr yname=(struct
_dynforward_ptr)Cstring_to_string(ynamec);int cmp=Cyc_strcmp((struct
_dynforward_ptr)xname,(struct _dynforward_ptr)yname);if(cmp < 0){struct _tuple11
_tmp4AC;return Cyc_Marshal_return_update(_tmp259,((_tmp4AC.f1=(void*)0,((_tmp4AC.f2=
env,_tmp4AC)))));}else{if(cmp == 0){struct _tuple11 _tmp4AD;return Cyc_Marshal_return_update(
_tmp259,((_tmp4AD.f1=(void*)1,((_tmp4AD.f2=env,_tmp4AD)))));}else{struct _tuple11
_tmp4AE;return Cyc_Marshal_return_update(_tmp259,((_tmp4AE.f1=(void*)2,((_tmp4AE.f2=
env,_tmp4AE)))));}}}else{if(*xp == 0){struct _tuple11 _tmp4AF;return Cyc_Marshal_return_update(
_tmp259,((_tmp4AF.f1=(void*)2,((_tmp4AF.f2=env,_tmp4AF)))));}else{if(*yp == 0){
struct _tuple11 _tmp4B0;return Cyc_Marshal_return_update(_tmp259,((_tmp4B0.f1=(void*)
0,((_tmp4B0.f2=env,_tmp4B0)))));}else{char*xnamec=((char*(*)(unsigned int x))
unsafe_cast)(*xp + 4);char*ynamec=((char*(*)(unsigned int x))unsafe_cast)(*yp + 4);
struct _dynforward_ptr xname=(struct _dynforward_ptr)Cstring_to_string(xnamec);
struct _dynforward_ptr yname=(struct _dynforward_ptr)Cstring_to_string(ynamec);int
cmp=Cyc_strcmp((struct _dynforward_ptr)xname,(struct _dynforward_ptr)yname);if(cmp
< 0){struct _tuple11 _tmp4B1;return Cyc_Marshal_return_update(_tmp259,((_tmp4B1.f1=(
void*)0,((_tmp4B1.f2=env,_tmp4B1)))));}else{if(cmp == 0){int _tmp263;void*_tmp264;
struct _tuple4 _tmp262=Cyc_Typerep_get_xtunionbranch(xname,_tmp210);_tmp263=
_tmp262.f1;_tmp264=_tmp262.f2;{void*xoff=((void*(*)(unsigned int x))unsafe_cast)(*
x0 + _tmp263);void*yoff=((void*(*)(unsigned int x))unsafe_cast)(*y0 + _tmp263);
return Cyc_Marshal_return_update(_tmp259,Cyc_Marshal_leq_eq_type(_tmp264,env,xoff,
yoff));}}else{struct _tuple11 _tmp4B2;return Cyc_Marshal_return_update(_tmp259,((
_tmp4B2.f1=(void*)2,((_tmp4B2.f2=env,_tmp4B2)))));}}}}}}}}_LLB2: if(*((int*)
...
_tmp4CB;unsigned int _tmp4CA;unsigned int _tmp4C9;struct _dynforward_ptr _tmp4C8;
...
sizeof(struct _tuple1*),_tmp4C6)),((_tmp4C8=_tag_dynforward(_tmp4C7,sizeof(struct
...
_tmp4D3="leq_eq_type case unmatched",_tag_dynforward(_tmp4D3,sizeof(char),
_get_zero_arr_size_char(_tmp4D3,27)))),_tmp4D4)))),_tmp4D2)))));}_LL8F:;}}int Cyc_Marshal_eq_type(
void*ts,void*x,void*y);int Cyc_Marshal_eq_type(void*ts,void*x,void*y){struct
...
void*)_exn_thrown;void*_tmp27C=_tmp276;struct _dynforward_ptr _tmp27D;_LLB9: if(*((
void**)_tmp27C)!= Cyc_Core_Failure)goto _LLBB;_tmp27D=((struct Cyc_Core_Failure_struct*)
_tmp27C)->f1;_LLBA:{const char*_tmp4D8;void*_tmp4D7[1];struct Cyc_String_pa_struct
_tmp4D6;(_tmp4D6.tag=0,((_tmp4D6.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)_tmp27D),((_tmp4D7[0]=& _tmp4D6,Cyc_fprintf(Cyc_stderr,((_tmp4D8="Core::Failure(%s)\n",
_tag_dynforward(_tmp4D8,sizeof(char),_get_zero_arr_size_char(_tmp4D8,19)))),
_tag_dynforward(_tmp4D7,sizeof(void*),1)))))));}{struct Cyc_Core_Failure_struct
_tmp4DB;struct Cyc_Core_Failure_struct*_tmp4DA;(int)_throw((void*)((_tmp4DA=
_cycalloc(sizeof(*_tmp4DA)),((_tmp4DA[0]=((_tmp4DB.tag=Cyc_Core_Failure,((
_tmp4DB.f1=_tmp27D,_tmp4DB)))),_tmp4DA)))));}_LLBB:;_LLBC:(void)_throw(_tmp27C);
_LLB8:;}}}int Cyc_Marshal_leq_type(void*ts,void*x,void*y);int Cyc_Marshal_leq_type(
void*ts,void*x,void*y){struct _handler_cons _tmp283;_push_handler(& _tmp283);{int
_tmp285=0;if(setjmp(_tmp283.handler))_tmp285=1;if(!_tmp285){{void*_tmp287;struct
_tuple11 _tmp286=Cyc_Marshal_leq_eq_type(ts,Cyc_Marshal_empty_eq_dict(),x,y);
_tmp287=_tmp286.f1;{int _tmp288=_tmp287 != (void*)0;_npop_handler(0);return _tmp288;}};
_pop_handler();}else{void*_tmp284=(void*)_exn_thrown;void*_tmp28A=_tmp284;struct
_dynforward_ptr _tmp28B;_LLBE: if(*((void**)_tmp28A)!= Cyc_Core_Failure)goto _LLC0;
_tmp28B=((struct Cyc_Core_Failure_struct*)_tmp28A)->f1;_LLBF:{const char*_tmp4DF;
void*_tmp4DE[1];struct Cyc_String_pa_struct _tmp4DD;(_tmp4DD.tag=0,((_tmp4DD.f1=(
struct _dynforward_ptr)((struct _dynforward_ptr)_tmp28B),((_tmp4DE[0]=& _tmp4DD,Cyc_fprintf(
Cyc_stderr,((_tmp4DF="Core::Failure(%s)\n",_tag_dynforward(_tmp4DF,sizeof(char),
_get_zero_arr_size_char(_tmp4DF,19)))),_tag_dynforward(_tmp4DE,sizeof(void*),1)))))));}{
...
_tmp29B=_tmp292;struct _dynforward_ptr _tmp29C;_LLCA: if(*((void**)_tmp29B)!= Cyc_Core_Failure)
...
_tmp4E4.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)_tmp29C),((_tmp4E5[0]=&
_tmp4E4,Cyc_fprintf(Cyc_stderr,((_tmp4E6="Core::Failure(%s)\n",_tag_dynforward(
_tmp4E6,sizeof(char),_get_zero_arr_size_char(_tmp4E6,19)))),_tag_dynforward(
_tmp4E5,sizeof(void*),1)))))));}{struct Cyc_Core_Failure_struct _tmp4E9;struct Cyc_Core_Failure_struct*
_tmp4E8;(int)_throw((void*)((_tmp4E8=_cycalloc(sizeof(*_tmp4E8)),((_tmp4E8[0]=((
_tmp4E9.tag=Cyc_Core_Failure,((_tmp4E9.f1=_tmp29C,_tmp4E9)))),_tmp4E8)))));}
_LLCC:;_LLCD:(void)_throw(_tmp29B);_LLC9:;}}}
