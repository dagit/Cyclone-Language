...
_get_zero_arr_size_char(_tmpE1,349))));}{char _tmpE4;char _tmpE3;struct
...
_get_zero_arr_size_char(_tmpE5,349))));}{char _tmpE8;char _tmpE7;struct
...
sizeof(char),_get_zero_arr_size_char(_tmpE9,349)))),sizeof(char),(int)(sizeof(
...
_tmpEA,sizeof(char),_get_zero_arr_size_char(_tmpEA,349)))),sizeof(char),(308 + 39)
+ 1);}if(_ulong != 0  || prec != 0){struct _dyneither_ptr xdigs;switch(base){case Cyc_OCT:
_LL5E: do{{char _tmpED;char _tmpEC;struct _dyneither_ptr _tmpEB;(_tmpEB=
...
_tag_dyneither(_tmpFC,sizeof(char),_get_zero_arr_size_char(_tmpFC,349)))),
sizeof(char),(308 + 39)+ 1)).curr - cp.curr)/ sizeof(char);}skipsize: break;
default: _LL5D: if(ch == '\000')goto done;{char*_tmpFD;cp=((_tmpFD=buf,
_tag_dyneither(_tmpFD,sizeof(char),_get_zero_arr_size_char(_tmpFD,349))));}{char
_tmp100;char _tmpFF;struct _dyneither_ptr _tmpFE;(_tmpFE=cp,((_tmpFF=*((char*)
...
char),_get_zero_arr_size_char(_tmp102,2)))),sizeof(char),0),((_tmp104=*((char*)
_check_dyneither_subscript(_tmp103,sizeof(char),0)),((_tmp105=sign,((
...
_tag_dyneither(_tmp106,sizeof(char),_get_zero_arr_size_char(_tmp106,2)))),1)!= 1)
...
expbuffer[_tmp72]=(char)0;}{char*_tmp107;struct _dyneither_ptr expbuf=(_tmp107=(
char*)expbuffer,_tag_dyneither(_tmp107,sizeof(char),_get_zero_arr_size_char(
_tmp107,309)));{char _tmp10A;char _tmp109;struct _dyneither_ptr _tmp108;(_tmp108=
_dyneither_ptr_inplace_plus_post(& p,sizeof(char),1),((_tmp109=*((char*)
_check_dyneither_subscript(_tmp108,sizeof(char),0)),((_tmp10A=(char)fmtch,((
_get_dyneither_size(_tmp108,sizeof(char))== 1  && (_tmp109 == '\000'  && _tmp10A != '\000')?
_throw_arraybounds(): 1,*((char*)_tmp108.curr)=_tmp10A)))))));}if(exp < 0){exp=-
exp;{char _tmp10D;char _tmp10C;struct _dyneither_ptr _tmp10B;(_tmp10B=
_dyneither_ptr_inplace_plus_post(& p,sizeof(char),1),((_tmp10C=*((char*)
_check_dyneither_subscript(_tmp10B,sizeof(char),0)),((_tmp10D='-',((
_get_dyneither_size(_tmp10B,sizeof(char))== 1  && (_tmp10C == '\000'  && _tmp10D != '\000')?
_throw_arraybounds(): 1,*((char*)_tmp10B.curr)=_tmp10D)))))));}}else{char _tmp110;
char _tmp10F;struct _dyneither_ptr _tmp10E;(_tmp10E=
...
_tmp116)))))));}{char _tmp119;char _tmp118;struct _dyneither_ptr _tmp117;for(0;t.curr
< (_dyneither_ptr_plus(expbuf,sizeof(char),308)).curr;(_tmp117=
...
_throw_arraybounds(): 1,*((char*)_tmp123.curr)=_tmp125)))))));}if(end.curr == 
start.curr){if((unsigned int)exp){{char _tmp128;char _tmp127;struct _dyneither_ptr
_tmp126;(_tmp126=end,((_tmp127=*((char*)_check_dyneither_subscript(_tmp126,
sizeof(char),0)),((_tmp128='1',((_get_dyneither_size(_tmp126,sizeof(char))== 1
 && (_tmp127 == '\000'  && _tmp128 != '\000')?_throw_arraybounds(): 1,*((char*)
...
sizeof(char),1);for(p=_dyneither_ptr_plus(endp,sizeof(char),- 1);p.curr >= startp.curr
 && integer != 0.0;++ expcnt){tmp=modf(integer / 10,& integer);{char _tmp12E;char
_tmp12D;struct _dyneither_ptr _tmp12C;(_tmp12C=_dyneither_ptr_inplace_plus_post(& p,
sizeof(char),-1),((_tmp12D=*((char*)_check_dyneither_subscript(_tmp12C,sizeof(
char),0)),((_tmp12E=(char)((int)((tmp + .01)* 10)+ '0'),((_get_dyneither_size(
_tmp12C,sizeof(char))== 1  && (_tmp12D == '\000'  && _tmp12E != '\000')?
_throw_arraybounds(): 1,*((char*)_tmp12C.curr)=_tmp12E)))))));}}switch(fmtch){
case 'f': _LL63: goto _LL64;case 'F': _LL64: if(expcnt){char _tmp131;char _tmp130;struct
_dyneither_ptr _tmp12F;for(0;(_dyneither_ptr_inplace_plus(& p,sizeof(char),1)).curr
< endp.curr;(_tmp12F=_dyneither_ptr_inplace_plus_post(& t,sizeof(char),1),((
_tmp130=*((char*)_check_dyneither_subscript(_tmp12F,sizeof(char),0)),((_tmp131=*((
char*)_check_dyneither_subscript(p,sizeof(char),0)),((_get_dyneither_size(
_tmp12F,sizeof(char))== 1  && (_tmp130 == '\000'  && _tmp131 != '\000')?
_throw_arraybounds(): 1,*((char*)_tmp12F.curr)=_tmp131)))))))){;}}else{char
_tmp134;char _tmp133;struct _dyneither_ptr _tmp132;(_tmp132=
_dyneither_ptr_inplace_plus_post(& t,sizeof(char),1),((_tmp133=*((char*)
_check_dyneither_subscript(_tmp132,sizeof(char),0)),((_tmp134='0',((
_get_dyneither_size(_tmp132,sizeof(char))== 1  && (_tmp133 == '\000'  && _tmp134 != '\000')?
_throw_arraybounds(): 1,*((char*)_tmp132.curr)=_tmp134)))))));}if(prec  || flags & 
8){char _tmp137;char _tmp136;struct _dyneither_ptr _tmp135;(_tmp135=
...
-- prec){char _tmp146;char _tmp145;struct _dyneither_ptr _tmp144;(_tmp144=
_dyneither_ptr_inplace_plus_post(& t,sizeof(char),1),((_tmp145=*((char*)
...
1,*((char*)_tmp144.curr)=_tmp146)))))));}if(!prec  && (
...
if(tmp != 0.0)break;}{char _tmp149;char _tmp148;struct _dyneither_ptr _tmp147;(
...
fract < .0001){-- prec;fmtch -=2;gformat=1;goto eformat;}if(expcnt){char _tmp15B;char
_tmp15A;struct _dyneither_ptr _tmp159;for(0;(_dyneither_ptr_inplace_plus(& p,
sizeof(char),1)).curr < endp.curr;(((_tmp159=_dyneither_ptr_inplace_plus_post(& t,
sizeof(char),1),((_tmp15A=*((char*)_check_dyneither_subscript(_tmp159,sizeof(
char),0)),((_tmp15B=*((char*)_check_dyneither_subscript(p,sizeof(char),0)),((
_get_dyneither_size(_tmp159,sizeof(char))== 1  && (_tmp15A == '\000'  && _tmp15B != '\000')?
_throw_arraybounds(): 1,*((char*)_tmp159.curr)=_tmp15B)))))))),-- prec)){;}}else{
char _tmp15E;char _tmp15D;struct _dyneither_ptr _tmp15C;(_tmp15C=
_dyneither_ptr_inplace_plus_post(& t,sizeof(char),1),((_tmp15D=*((char*)
_check_dyneither_subscript(_tmp15C,sizeof(char),0)),((_tmp15E='0',((
_get_dyneither_size(_tmp15C,sizeof(char))== 1  && (_tmp15D == '\000'  && _tmp15E != '\000')?
_throw_arraybounds(): 1,*((char*)_tmp15C.curr)=_tmp15E)))))));}if(prec  || flags & 
8){dotrim=1;{char _tmp161;char _tmp160;struct _dyneither_ptr _tmp15F;(_tmp15F=
_dyneither_ptr_inplace_plus_post(& t,sizeof(char),1),((_tmp160=*((char*)
_check_dyneither_subscript(_tmp15F,sizeof(char),0)),((_tmp161='.',((
_get_dyneither_size(_tmp15F,sizeof(char))== 1  && (_tmp160 == '\000'  && _tmp161 != '\000')?
_throw_arraybounds(): 1,*((char*)_tmp15F.curr)=_tmp161)))))));}}else{dotrim=0;}
if(fract != 0.0){if(prec){do{fract=modf(fract * 10,& tmp);{char _tmp164;char _tmp163;
struct _dyneither_ptr _tmp162;(_tmp162=_dyneither_ptr_inplace_plus_post(& t,sizeof(
char),1),((_tmp163=*((char*)_check_dyneither_subscript(_tmp162,sizeof(char),0)),((
_tmp164=(char)((int)tmp + '0'),((_get_dyneither_size(_tmp162,sizeof(char))== 1
 && (_tmp163 == '\000'  && _tmp164 != '\000')?_throw_arraybounds(): 1,*((char*)
_tmp162.curr)=_tmp164)))))));}}while(tmp == 0.0  && !expcnt);while(-- prec  && fract
!= 0.0){fract=modf(fract * 10,& tmp);{char _tmp167;char _tmp166;struct _dyneither_ptr
_tmp165;(_tmp165=_dyneither_ptr_inplace_plus_post(& t,sizeof(char),1),((_tmp166=*((
char*)_check_dyneither_subscript(_tmp165,sizeof(char),0)),((_tmp167=(char)((int)
tmp + '0'),((_get_dyneither_size(_tmp165,sizeof(char))== 1  && (_tmp166 == '\000'
 && _tmp167 != '\000')?_throw_arraybounds(): 1,*((char*)_tmp165.curr)=_tmp167)))))));}}}
if(fract != 0.0)startp=Cyc_sround(fract,0,startp,_dyneither_ptr_plus(t,sizeof(
char),- 1),(char)'\000',signp);}if(flags & 8){char _tmp16A;char _tmp169;struct
_dyneither_ptr _tmp168;for(0;prec --;(_tmp168=_dyneither_ptr_inplace_plus_post(& t,
sizeof(char),1),((_tmp169=*((char*)_check_dyneither_subscript(_tmp168,sizeof(
char),0)),((_tmp16A='0',((_get_dyneither_size(_tmp168,sizeof(char))== 1  && (
_tmp169 == '\000'  && _tmp16A != '\000')?_throw_arraybounds(): 1,*((char*)_tmp168.curr)=
_tmp16A)))))))){;}}else{if(dotrim){while(t.curr > startp.curr  && *((char*)
...
struct Cyc_Core_Impossible_struct _tmp170;const char*_tmp16F;struct Cyc_Core_Impossible_struct*
_tmp16E;(int)_throw((void*)((_tmp16E=_cycalloc(sizeof(*_tmp16E)),((_tmp16E[0]=((
_tmp170.tag=Cyc_Core_Impossible,((_tmp170.f1=((_tmp16F="__cvt_double",
_tag_dyneither(_tmp16F,sizeof(char),13))),_tmp170)))),_tmp16E)))));}}return(t.curr
...
_tuple0 _tmpC2;struct _dyneither_ptr*_tmpC3;unsigned long*_tmpC4;struct _tuple0*
_tmpC1=sptr_n;_tmpC2=*_tmpC1;_tmpC3=_tmpC2.f1;_tmpC4=_tmpC2.f2;{struct
_dyneither_ptr s=*_tmpC3;unsigned long n=*_tmpC4;if(n == 0)return - 1;*((char*)
_check_dyneither_subscript(s,sizeof(char),0))=(char)c;
_dyneither_ptr_inplace_plus(_tmpC3,sizeof(char),1);*_tmpC4=n - 1;return 1;}}int Cyc_vsnprintf(
...
_dyneither_ptr fmt,struct _dyneither_ptr ap){int ans;struct _dyneither_ptr _tmpC5=s;
unsigned long _tmpC6=n;struct _tuple0 _tmp171;struct _tuple0 _tmpC7=(_tmp171.f1=&
