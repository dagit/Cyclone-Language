...
void*x);static struct _dyneither_ptr Cyc_parg2string(void*x){void*_tmp0=x;_LL1: if(*((
int*)_tmp0)!= 0)goto _LL3;_LL2: {const char*_tmpBE;return(_tmpBE="string",
_tag_dyneither(_tmpBE,sizeof(char),7));}_LL3: if(*((int*)_tmp0)!= 1)goto _LL5;_LL4: {
const char*_tmpBF;return(_tmpBF="int",_tag_dyneither(_tmpBF,sizeof(char),4));}
_LL5: if(*((int*)_tmp0)!= 2)goto _LL7;_LL6: {const char*_tmpC0;return(_tmpC0="double",
_tag_dyneither(_tmpC0,sizeof(char),7));}_LL7: if(*((int*)_tmp0)!= 3)goto _LL9;_LL8: {
const char*_tmpC1;return(_tmpC1="long double",_tag_dyneither(_tmpC1,sizeof(char),
12));}_LL9: if(*((int*)_tmp0)!= 4)goto _LLB;_LLA: {const char*_tmpC2;return(_tmpC2="short *",
_tag_dyneither(_tmpC2,sizeof(char),8));}_LLB: if(*((int*)_tmp0)!= 5)goto _LL0;_LLC: {
const char*_tmpC3;return(_tmpC3="unsigned long *",_tag_dyneither(_tmpC3,sizeof(
char),16));}_LL0:;}static void*Cyc_badarg(struct _dyneither_ptr s);static void*Cyc_badarg(
struct _dyneither_ptr s){struct Cyc_Core_Invalid_argument_struct _tmpC6;struct Cyc_Core_Invalid_argument_struct*
...
static int Cyc_va_arg_int(struct _dyneither_ptr ap);static int Cyc_va_arg_int(struct
_dyneither_ptr ap){void*_tmp9=*((void**)_check_dyneither_subscript(ap,sizeof(void*),
0));unsigned long _tmpA;_LLE: if(*((int*)_tmp9)!= 1)goto _LL10;_tmpA=((struct Cyc_Int_pa_struct*)
_tmp9)->f1;_LLF: return(int)_tmpA;_LL10:;_LL11: {const char*_tmpC7;return((int(*)(
struct _dyneither_ptr s))Cyc_badarg)(((_tmpC7="printf expected int",_tag_dyneither(
_tmpC7,sizeof(char),20))));}_LLD:;}static long Cyc_va_arg_long(struct
_dyneither_ptr ap);static long Cyc_va_arg_long(struct _dyneither_ptr ap){void*_tmpC=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));unsigned long _tmpD;_LL13:
if(*((int*)_tmpC)!= 1)goto _LL15;_tmpD=((struct Cyc_Int_pa_struct*)_tmpC)->f1;
_LL14: return(long)_tmpD;_LL15:;_LL16: {const char*_tmpC8;return((long(*)(struct
_dyneither_ptr s))Cyc_badarg)(((_tmpC8="printf expected int",_tag_dyneither(
_tmpC8,sizeof(char),20))));}_LL12:;}static unsigned long Cyc_va_arg_ulong(struct
_dyneither_ptr ap);static unsigned long Cyc_va_arg_ulong(struct _dyneither_ptr ap){
void*_tmpF=*((void**)_check_dyneither_subscript(ap,sizeof(void*),0));
unsigned long _tmp10;_LL18: if(*((int*)_tmpF)!= 1)goto _LL1A;_tmp10=((struct Cyc_Int_pa_struct*)
_tmpF)->f1;_LL19: return(unsigned long)_tmp10;_LL1A:;_LL1B: {const char*_tmpC9;
return((unsigned long(*)(struct _dyneither_ptr s))Cyc_badarg)(((_tmpC9="printf expected int",
_tag_dyneither(_tmpC9,sizeof(char),20))));}_LL17:;}static unsigned long Cyc_va_arg_uint(
struct _dyneither_ptr ap);static unsigned long Cyc_va_arg_uint(struct _dyneither_ptr
ap){void*_tmp12=*((void**)_check_dyneither_subscript(ap,sizeof(void*),0));
unsigned long _tmp13;_LL1D: if(*((int*)_tmp12)!= 1)goto _LL1F;_tmp13=((struct Cyc_Int_pa_struct*)
_tmp12)->f1;_LL1E: return(unsigned int)_tmp13;_LL1F:;_LL20: {const char*_tmpCA;
return((unsigned long(*)(struct _dyneither_ptr s))Cyc_badarg)(((_tmpCA="printf expected int",
_tag_dyneither(_tmpCA,sizeof(char),20))));}_LL1C:;}static double Cyc_va_arg_double(
struct _dyneither_ptr ap);static double Cyc_va_arg_double(struct _dyneither_ptr ap){
void*_tmp15=*((void**)_check_dyneither_subscript(ap,sizeof(void*),0));double
_tmp16;long double _tmp17;_LL22: if(*((int*)_tmp15)!= 2)goto _LL24;_tmp16=((struct
Cyc_Double_pa_struct*)_tmp15)->f1;_LL23: return _tmp16;_LL24: if(*((int*)_tmp15)!= 
3)goto _LL26;_tmp17=((struct Cyc_LongDouble_pa_struct*)_tmp15)->f1;_LL25: return(
double)_tmp17;_LL26:;_LL27: {const char*_tmpCE;void*_tmpCD[1];struct Cyc_String_pa_struct
_tmpCC;(int)_throw(Cyc_badarg((struct _dyneither_ptr)((_tmpCC.tag=0,((_tmpCC.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_parg2string(*((void**)
_check_dyneither_subscript(ap,sizeof(void*),0)))),((_tmpCD[0]=& _tmpCC,Cyc_aprintf(((
_tmpCE="printf expected double but found %s",_tag_dyneither(_tmpCE,sizeof(char),
36))),_tag_dyneither(_tmpCD,sizeof(void*),1))))))))));}_LL21:;}static short*Cyc_va_arg_short_ptr(
struct _dyneither_ptr ap);static short*Cyc_va_arg_short_ptr(struct _dyneither_ptr ap){
void*_tmp1B=*((void**)_check_dyneither_subscript(ap,sizeof(void*),0));short*
...
_tmpCF="printf expected short pointer",_tag_dyneither(_tmpCF,sizeof(char),30)))));}
_LL28:;}static unsigned long*Cyc_va_arg_int_ptr(struct _dyneither_ptr ap);static
unsigned long*Cyc_va_arg_int_ptr(struct _dyneither_ptr ap){void*_tmp1E=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),0));unsigned long*_tmp1F;_LL2E: if(*((
int*)_tmp1E)!= 5)goto _LL30;_tmp1F=((struct Cyc_IntPtr_pa_struct*)_tmp1E)->f1;
_LL2F: return _tmp1F;_LL30:;_LL31: {const char*_tmpD0;(int)_throw(Cyc_badarg(((
_tmpD0="printf expected int pointer",_tag_dyneither(_tmpD0,sizeof(char),28)))));}
_LL2D:;}static struct _dyneither_ptr Cyc_va_arg_string(struct _dyneither_ptr ap);
static struct _dyneither_ptr Cyc_va_arg_string(struct _dyneither_ptr ap){void*_tmp21=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));struct _dyneither_ptr
_tmp22;_LL33: if(*((int*)_tmp21)!= 0)goto _LL35;_tmp22=((struct Cyc_String_pa_struct*)
_tmp21)->f1;_LL34: return _tmp22;_LL35:;_LL36: {const char*_tmpD1;(int)_throw(Cyc_badarg(((
_tmpD1="printf expected string",_tag_dyneither(_tmpD1,sizeof(char),23)))));}
...
ioputc_env,struct _dyneither_ptr s,int howmany);static int Cyc__IO_sputn(int(*ioputc)(
int,void*),void*ioputc_env,struct _dyneither_ptr s,int howmany){int i=0;while(i < 
howmany){if(_get_dyneither_size(s,sizeof(char))== 0  || ioputc((int)*((const char*)
_check_dyneither_subscript(s,sizeof(char),0)),ioputc_env)== - 1)return i;
_dyneither_ptr_inplace_plus(& s,sizeof(char),1);++ i;}return i;}static int Cyc__IO_nzsputn(
...
int howmany){int i=0;while(i < howmany){char c;if((_get_dyneither_size(s,sizeof(char))
== 0  || (c=*((const char*)_check_dyneither_subscript(s,sizeof(char),0)))== 0) || 
ioputc((int)c,ioputc_env)== - 1)return i;_dyneither_ptr_inplace_plus(& s,sizeof(
char),1);++ i;}return i;}static int Cyc__IO_padn(int(*ioputc)(int,void*),void*
ioputc_env,char c,int howmany);static int Cyc__IO_padn(int(*ioputc)(int,void*),void*
ioputc_env,char c,int howmany){int i=0;while(i < howmany){if(ioputc((int)c,
ioputc_env)== - 1)return i;++ i;}return i;}static struct _dyneither_ptr Cyc_my_memchr(
struct _dyneither_ptr s,char c,int n);static struct _dyneither_ptr Cyc_my_memchr(struct
_dyneither_ptr s,char c,int n){int sz=(int)_get_dyneither_size(s,sizeof(char));n=n < 
sz?n: sz;for(0;n != 0;(n --,_dyneither_ptr_inplace_plus_post(& s,sizeof(char),1))){
if(*((const char*)_check_dyneither_subscript(s,sizeof(char),0))== c)return s;}
return(struct _dyneither_ptr)_tag_dyneither(0,0,0);}static struct _dyneither_ptr Cyc_my_nzmemchr(
...
struct _dyneither_ptr s);static unsigned long Cyc_my_strlen(struct _dyneither_ptr s){
...
ap);int Cyc__IO_vfprintf(int(*ioputc)(int,void*),void*ioputc_env,struct
_dyneither_ptr fmt0,struct _dyneither_ptr ap){struct _dyneither_ptr fmt;register int ch;
register int n;struct _dyneither_ptr cp=_tag_dyneither(0,0,0);struct _dyneither_ptr
cp2=(struct _dyneither_ptr)_tag_dyneither(0,0,0);struct _dyneither_ptr cp3=(struct
...
_get_dyneither_size(fmt,sizeof(char));for(n=0;(n < fmt_sz  && (ch=(int)*((const
char*)_check_dyneither_subscript(fmt,sizeof(char),n)))!= '\000') && ch != '%';++ n){;}
fmt=_dyneither_ptr_plus(fmt,sizeof(char),n);if((n=(fmt.curr - fmark.curr)/ 
...
_LL4A:{char*_tmpD2;cp=((_tmpD2=buf,_tag_dyneither(_tmpD2,sizeof(char),
_get_zero_arr_size_char(_tmpD2,349))));}{char _tmpD5;char _tmpD4;struct
_dyneither_ptr _tmpD3;(_tmpD3=cp,((_tmpD4=*((char*)_check_dyneither_subscript(
_tmpD3,sizeof(char),0)),((_tmpD5=(char)Cyc_va_arg_int(ap),((_get_dyneither_size(
_tmpD3,sizeof(char))== 1  && (_tmpD4 == '\000'  && _tmpD5 != '\000')?
_throw_arraybounds(): 1,*((char*)_tmpD3.curr)=_tmpD5)))))));}
...
_tmpE8;xdigs=((_tmpE8="0123456789ABCDEF",_tag_dyneither(_tmpE8,sizeof(char),17)));}
else{const char*_tmpE9;xdigs=((_tmpE9="0123456789abcdef",_tag_dyneither(_tmpE9,
sizeof(char),17)));}do{{char _tmpEC;char _tmpEB;struct _dyneither_ptr _tmpEA;(_tmpEA=
...
Cyc__IO_sputn(ioputc,ioputc_env,(struct _dyneither_ptr)((_tmpF7=sign_string,
_tag_dyneither(_tmpF7,sizeof(char),_get_zero_arr_size_char(_tmpF7,2)))),1)!= 1)
goto error;}while(0);}else{if(flags & 64){ox[0]='0';ox[1]=(char)ch;do{if(Cyc__IO_nzsputn(
ioputc,ioputc_env,_tag_dyneither(ox,sizeof(char),2),2)!= 2)goto error;}while(0);}}
...
goto error;if(which_cp == 0)do{if(Cyc__IO_sputn(ioputc,ioputc_env,(struct
_dyneither_ptr)cp,size)!= size)goto error;}while(0);else{if(which_cp == 2)do{if(
Cyc__IO_sputn(ioputc,ioputc_env,(struct _dyneither_ptr)cp2,size)!= size)goto error;}while(
0);else{if(which_cp == 3)do{if(Cyc__IO_nzsputn(ioputc,ioputc_env,(struct
_dyneither_ptr)cp3,size)!= size)goto error;}while(0);}}if(Cyc__IO_padn(ioputc,
...
width: fieldsz;}}done: return ret;error: return - 1;}}static struct _dyneither_ptr Cyc_exponent(
struct _dyneither_ptr p,int exp,int fmtch);static struct _dyneither_ptr Cyc_exponent(
struct _dyneither_ptr p,int exp,int fmtch){struct _dyneither_ptr t;char expbuffer[309];{
unsigned int _tmp63=308;unsigned int i;for(i=0;i < _tmp63;i ++){expbuffer[i]='0';}
expbuffer[_tmp63]=(char)0;}{char*_tmpF8;struct _dyneither_ptr expbuf=(_tmpF8=(char*)
expbuffer,_tag_dyneither(_tmpF8,sizeof(char),_get_zero_arr_size_char(_tmpF8,309)));{
char _tmpFB;char _tmpFA;struct _dyneither_ptr _tmpF9;(_tmpF9=
_dyneither_ptr_inplace_plus_post(& p,sizeof(char),1),((_tmpFA=*((char*)
_check_dyneither_subscript(_tmpF9,sizeof(char),0)),((_tmpFB=(char)fmtch,((
_get_dyneither_size(_tmpF9,sizeof(char))== 1  && (_tmpFA == '\000'  && _tmpFB != '\000')?
_throw_arraybounds(): 1,*((char*)_tmpF9.curr)=_tmpFB)))))));}if(exp < 0){exp=- exp;{
char _tmpFE;char _tmpFD;struct _dyneither_ptr _tmpFC;(_tmpFC=
...
_tmp101)))))));}t=_dyneither_ptr_plus(expbuf,sizeof(char),308);if(exp > 9){do{
char _tmp104;char _tmp103;struct _dyneither_ptr _tmp102;(_tmp102=
_dyneither_ptr_inplace_plus(& t,sizeof(char),-1),((_tmp103=*((char*)
...
_tmp109;struct _dyneither_ptr _tmp108;for(0;t.curr < (_dyneither_ptr_plus(expbuf,
sizeof(char),308)).curr;(_tmp108=_dyneither_ptr_inplace_plus_post(& p,sizeof(char),
1),((_tmp109=*((char*)_check_dyneither_subscript(_tmp108,sizeof(char),0)),((
_tmp10A=*((char*)_check_dyneither_subscript(_dyneither_ptr_inplace_plus_post(& t,
sizeof(char),1),sizeof(char),0)),((_get_dyneither_size(_tmp108,sizeof(char))== 1
 && (_tmp109 == '\000'  && _tmp10A != '\000')?_throw_arraybounds(): 1,*((char*)
_tmp108.curr)=_tmp10A)))))))){;}}}else{{char _tmp10D;char _tmp10C;struct
...
_tmp10D='0',((_get_dyneither_size(_tmp10B,sizeof(char))== 1  && (_tmp10C == '\000'
 && _tmp10D != '\000')?_throw_arraybounds(): 1,*((char*)_tmp10B.curr)=_tmp10D)))))));}{
char _tmp110;char _tmp10F;struct _dyneither_ptr _tmp10E;(_tmp10E=
_dyneither_ptr_inplace_plus_post(& p,sizeof(char),1),((_tmp10F=*((char*)
_check_dyneither_subscript(_tmp10E,sizeof(char),0)),((_tmp110=(char)(exp + '0'),((
_get_dyneither_size(_tmp10E,sizeof(char))== 1  && (_tmp10F == '\000'  && _tmp110 != '\000')?
_throw_arraybounds(): 1,*((char*)_tmp10E.curr)=_tmp110)))))));}}return p;}}static
struct _dyneither_ptr Cyc_sround(double fract,int*exp,struct _dyneither_ptr start,
struct _dyneither_ptr end,char ch,int*signp);static struct _dyneither_ptr Cyc_sround(
...
_tag_dyneither(_tmp160,sizeof(char),13))),_tmp161)))),_tmp15F)))));}}return(t.curr
- startp.curr)/ sizeof(char);}int Cyc_vfprintf(struct Cyc___cycFILE*f,struct
_dyneither_ptr fmt,struct _dyneither_ptr ap);int Cyc_vfprintf(struct Cyc___cycFILE*f,
struct _dyneither_ptr fmt,struct _dyneither_ptr ap){int ans;ans=((int(*)(int(*ioputc)(
int,struct Cyc___cycFILE*),struct Cyc___cycFILE*ioputc_env,struct _dyneither_ptr
fmt0,struct _dyneither_ptr ap))Cyc__IO_vfprintf)(Cyc_putc,f,fmt,ap);return ans;}int
Cyc_fprintf(struct Cyc___cycFILE*f,struct _dyneither_ptr fmt,struct _dyneither_ptr ap);
int Cyc_fprintf(struct Cyc___cycFILE*f,struct _dyneither_ptr fmt,struct
_dyneither_ptr ap){return Cyc_vfprintf(f,fmt,ap);}int Cyc_vprintf(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap);int Cyc_vprintf(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap){int ans;ans=((int(*)(int(*ioputc)(int,struct Cyc___cycFILE*),
struct Cyc___cycFILE*ioputc_env,struct _dyneither_ptr fmt0,struct _dyneither_ptr ap))
Cyc__IO_vfprintf)(Cyc_putc,Cyc_stdout,fmt,ap);return ans;}int Cyc_printf(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap);int Cyc_printf(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap){int ans;ans=Cyc_vprintf(fmt,ap);return ans;}struct _tuple0{
struct _dyneither_ptr*f1;unsigned long*f2;};static int Cyc_putc_string(int c,struct
_tuple0*sptr_n);static int Cyc_putc_string(int c,struct _tuple0*sptr_n){struct
_tuple0 _tmpB3;struct _dyneither_ptr*_tmpB4;unsigned long*_tmpB5;struct _tuple0*
_tmpB2=sptr_n;_tmpB3=*_tmpB2;_tmpB4=_tmpB3.f1;_tmpB5=_tmpB3.f2;{struct
_dyneither_ptr s=*_tmpB4;unsigned long n=*_tmpB5;if(_get_dyneither_size(s,sizeof(
char))== 0  || n == 0)return - 1;*((char*)_check_dyneither_subscript(s,sizeof(char),
0))=(char)c;*_tmpB4=_dyneither_ptr_plus(s,sizeof(char),1);*_tmpB5=n - 1;return 1;}}
...
_dyneither_ptr fmt,struct _dyneither_ptr ap);static void _tmp168(unsigned int*_tmp167,
unsigned int*_tmp166,char**_tmp164){for(*_tmp167=0;*_tmp167 < *_tmp166;(*_tmp167)
++){(*_tmp164)[*_tmp167]='\000';}}struct _dyneither_ptr Cyc_vrprintf(struct
...
_tmp167;unsigned int _tmp166;struct _dyneither_ptr _tmp165;char*_tmp164;
unsigned int _tmp163;struct _dyneither_ptr s=(_tmp163=(unsigned int)size,((_tmp164=(
char*)_region_malloc(r1,_check_times(sizeof(char),_tmp163 + 1)),((_tmp165=
_tag_dyneither(_tmp164,sizeof(char),_tmp163 + 1),((((_tmp166=_tmp163,((_tmp168(&
_tmp167,& _tmp166,& _tmp164),_tmp164[_tmp166]=(char)0)))),_tmp165)))))));Cyc_vsprintf(
