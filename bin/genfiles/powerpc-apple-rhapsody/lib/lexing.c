...
struct Cyc_Lexing_lexbuf*lexbuf){if(_get_dynforward_size(Cyc_Lexing_aux_buffer,
...
Cyc_Lexing_aux_buffer,(int)(_get_dynforward_size(Cyc_Lexing_aux_buffer,sizeof(
...
int oldlen=lexbuf->lex_buffer_len;int newlen=oldlen * 2;struct _dynforward_ptr newbuf=
Cyc_Core_new_string((unsigned int)(newlen + 1));Cyc_zstrncpy(_dynforward_ptr_plus(
_dynforward_ptr_decrease_size(newbuf,sizeof(char),1),sizeof(char),oldlen),(
struct _dynforward_ptr)lexbuf->lex_buffer,(unsigned long)oldlen);lexbuf->lex_buffer=
...
Cyc_zstrncpy(_dynforward_ptr_decrease_size(lexbuf->lex_buffer,sizeof(char),1),(
struct _dynforward_ptr)_dynforward_ptr_plus(lexbuf->lex_buffer,sizeof(char),n),(
...
read_fun)(struct _dynforward_ptr,int,void*),void*read_fun_state);struct Cyc_Lexing_lexbuf*
Cyc_Lexing_from_function(int(*read_fun)(struct _dynforward_ptr,int,void*),void*
...
int Cyc_Lexing_read_from_file(struct _dynforward_ptr aux,int n,struct Cyc___cycFILE*f);
int Cyc_Lexing_read_from_file(struct _dynforward_ptr aux,int n,struct Cyc___cycFILE*f){
...
f){return((struct Cyc_Lexing_lexbuf*(*)(int(*read_fun)(struct _dynforward_ptr,int,
...
1;}struct Cyc_Lexing_lexbuf*Cyc_Lexing_from_string(struct _dynforward_ptr s);struct
Cyc_Lexing_lexbuf*Cyc_Lexing_from_string(struct _dynforward_ptr s){struct Cyc_Lexing_lexbuf*
...
_dynforward_ptr)s),((_tmp9->lex_buffer_len=(int)_get_dynforward_size(s,sizeof(
char)),((_tmp9->lex_abs_pos=0,((_tmp9->lex_start_pos=0,((_tmp9->lex_curr_pos=0,((
_tmp9->lex_last_pos=0,((_tmp9->lex_last_action=0,((_tmp9->lex_eof_reached=1,
_tmp9)))))))))))))))))))));}struct _dynforward_ptr Cyc_Lexing_lexeme(struct Cyc_Lexing_lexbuf*
lbuf);struct _dynforward_ptr Cyc_Lexing_lexeme(struct Cyc_Lexing_lexbuf*lbuf){int
len=lbuf->lex_curr_pos - lbuf->lex_start_pos;struct _dynforward_ptr s=Cyc_Core_new_string((
unsigned int)(len + 1));Cyc_zstrncpy(_dynforward_ptr_decrease_size(s,sizeof(char),
1),(struct _dynforward_ptr)_dynforward_ptr_plus(lbuf->lex_buffer,sizeof(char),
lbuf->lex_start_pos),(unsigned long)len);{char _tmpC;char _tmpB;struct
_dynforward_ptr _tmpA;(_tmpA=_dynforward_ptr_plus(s,sizeof(char),len),((_tmpB=*((
char*)_check_dynforward_subscript(_tmpA,sizeof(char),0)),((_tmpC='\000',((
...
lbuf,int i){return*((char*)_check_dynforward_subscript(lbuf->lex_buffer,sizeof(
