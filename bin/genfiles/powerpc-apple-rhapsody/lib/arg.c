...
18];extern char Cyc_List_Nth[8];unsigned long Cyc_strlen(struct _dynforward_ptr s);
int Cyc_strcmp(struct _dynforward_ptr s1,struct _dynforward_ptr s2);int Cyc_strncmp(
struct _dynforward_ptr s1,struct _dynforward_ptr s2,unsigned long len);struct
...
_dynforward_ptr x);static void*Cyc_Arg_lookup(struct Cyc_List_List*l,struct
...
struct Cyc_Buffer_t*b,int howmuch,struct _dynforward_ptr s);static struct
_dynforward_ptr Cyc_Arg_Justify_break_line(struct Cyc_Buffer_t*b,int howmuch,struct
_dynforward_ptr s){if(s.curr == ((struct _dynforward_ptr)_tag_dynforward(0,0,0)).curr)
return(struct _dynforward_ptr)_tag_dynforward(0,0,0);if(howmuch < 0)howmuch=0;{
unsigned long _tmp2=Cyc_strlen((struct _dynforward_ptr)s);{const char*_tmp62;const
char*_tmp61;_tmp2 <= _get_dynforward_size(s,sizeof(char))?0:((int(*)(struct
_dynforward_ptr assertion,struct _dynforward_ptr file,unsigned int line))Cyc___assert_fail)(((
_tmp61="len <= s.size",_tag_dynforward(_tmp61,sizeof(char),
_get_zero_arr_size_char(_tmp61,14)))),((_tmp62="arg.cyc",_tag_dynforward(_tmp62,
...
unsigned int _tmp67;unsigned int _tmp66;struct _dynforward_ptr _tmp65;char*_tmp64;
unsigned int _tmp63;struct _dynforward_ptr indentstr=(_tmp63=(unsigned int)(indent + 
...
Cyc_strlen((struct _dynforward_ptr)item);struct _dynforward_ptr itemsep;if(Cyc_strlen((
struct _dynforward_ptr)desc)> 0){if(_tmp8 + 1 > indent)itemsep=indentstr;else{
unsigned int _tmp70;unsigned int _tmp6F;struct _dynforward_ptr _tmp6E;char*_tmp6D;
unsigned int _tmp6C;struct _dynforward_ptr temp=(_tmp6C=(indent - _tmp8)+ 1,((_tmp6D=(
...
else{return;}Cyc_Buffer_add_string(b,(struct _dynforward_ptr)itemsep);while(desc.curr
...
0,0)).curr)Cyc_Buffer_add_string(b,(struct _dynforward_ptr)indentstr);else{const
char*_tmp75;Cyc_Buffer_add_string(b,((_tmp75="\n",_tag_dynforward(_tmp75,sizeof(
char),_get_zero_arr_size_char(_tmp75,2)))));}}return;}}}void Cyc_Arg_usage(struct
Cyc_List_List*speclist,struct _dynforward_ptr errmsg);void Cyc_Arg_usage(struct Cyc_List_List*
speclist,struct _dynforward_ptr errmsg){{const char*_tmp79;void*_tmp78[1];struct Cyc_String_pa_struct
...
_tag_dynforward(_tmp79,sizeof(char),_get_zero_arr_size_char(_tmp79,4)))),
_tag_dynforward(_tmp78,sizeof(void*),1)))))));}{struct Cyc_Buffer_t*_tmp18=Cyc_Buffer_create(
1024);while(speclist != 0){Cyc_Arg_Justify_justify_b(_tmp18,12,72,(struct
_dynforward_ptr)Cyc_strconcat((struct _dynforward_ptr)(*((struct _tuple0*)speclist->hd)).f1,(
struct _dynforward_ptr)(*((struct _tuple0*)speclist->hd)).f3),(*((struct _tuple0*)
speclist->hd)).f5);speclist=speclist->tl;}{const char*_tmp7D;void*_tmp7C[1];
struct Cyc_String_pa_struct _tmp7B;(_tmp7B.tag=0,((_tmp7B.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)Cyc_Buffer_contents(_tmp18)),((_tmp7C[0]=&
_tmp7B,Cyc_fprintf(Cyc_stderr,((_tmp7D="%s",_tag_dynforward(_tmp7D,sizeof(char),
_get_zero_arr_size_char(_tmp7D,3)))),_tag_dynforward(_tmp7C,sizeof(void*),1)))))));}}}
...
struct _dynforward_ptr errmsg);static void Cyc_Arg_stop(int prog_pos,void*e,struct Cyc_List_List*
speclist,struct _dynforward_ptr errmsg){const char*_tmp7E;struct _dynforward_ptr
progname=prog_pos < _get_dynforward_size(Cyc_Arg_args,sizeof(struct
_dynforward_ptr))?*((struct _dynforward_ptr*)_check_dynforward_subscript(Cyc_Arg_args,
sizeof(struct _dynforward_ptr),prog_pos)):((_tmp7E="(?)",_tag_dynforward(_tmp7E,
sizeof(char),_get_zero_arr_size_char(_tmp7E,4))));{void*_tmp1C=e;struct
...
_tmp1C)->f1;_LL2:{const char*_tmp7F;if(Cyc_strcmp((struct _dynforward_ptr)_tmp1D,((
_tmp7F="-help",_tag_dynforward(_tmp7F,sizeof(char),_get_zero_arr_size_char(
_tmp7F,6)))))!= 0){const char*_tmp84;void*_tmp83[2];struct Cyc_String_pa_struct
_tmp82;struct Cyc_String_pa_struct _tmp81;(_tmp81.tag=0,((_tmp81.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)_tmp1D),((_tmp82.tag=0,((_tmp82.f1=(
struct _dynforward_ptr)((struct _dynforward_ptr)progname),((_tmp83[0]=& _tmp82,((
_tmp83[1]=& _tmp81,Cyc_fprintf(Cyc_stderr,((_tmp84="%s: unknown option `%s'.\n",
_tag_dynforward(_tmp84,sizeof(char),_get_zero_arr_size_char(_tmp84,26)))),
_tag_dynforward(_tmp83,sizeof(void*),2)))))))))))));}}goto _LL0;_LL3: if(*((int*)
...
_tmp86;(_tmp86.tag=0,((_tmp86.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)
_tmp1E),((_tmp87.tag=0,((_tmp87.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)progname),((_tmp88[0]=& _tmp87,((_tmp88[1]=& _tmp86,Cyc_fprintf(
Cyc_stderr,((_tmp89="%s: option `%s' needs an argument.\n",_tag_dynforward(
_tmp89,sizeof(char),_get_zero_arr_size_char(_tmp89,36)))),_tag_dynforward(_tmp88,
sizeof(void*),2)))))))))))));}goto _LL0;_LL5: if(*((int*)_tmp1C)!= 3)goto _LL7;
_tmp1F=((struct Cyc_Arg_Wrong_struct*)_tmp1C)->f1;_tmp20=((struct Cyc_Arg_Wrong_struct*)
_tmp1C)->f2;_tmp21=((struct Cyc_Arg_Wrong_struct*)_tmp1C)->f3;_LL6:{const char*
_tmp90;void*_tmp8F[4];struct Cyc_String_pa_struct _tmp8E;struct Cyc_String_pa_struct
_tmp8D;struct Cyc_String_pa_struct _tmp8C;struct Cyc_String_pa_struct _tmp8B;(_tmp8B.tag=
0,((_tmp8B.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)_tmp21),((_tmp8C.tag=
0,((_tmp8C.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)_tmp1F),((_tmp8D.tag=
0,((_tmp8D.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)_tmp20),((_tmp8E.tag=
0,((_tmp8E.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)progname),((_tmp8F[
0]=& _tmp8E,((_tmp8F[1]=& _tmp8D,((_tmp8F[2]=& _tmp8C,((_tmp8F[3]=& _tmp8B,Cyc_fprintf(
Cyc_stderr,((_tmp90="%s: wrong argument `%s'; option `%s' expects %s.\n",
_tag_dynforward(_tmp90,sizeof(char),_get_zero_arr_size_char(_tmp90,50)))),
_tag_dynforward(_tmp8F,sizeof(void*),4)))))))))))))))))))))))));}goto _LL0;_LL7:
if(*((int*)_tmp1C)!= 2)goto _LL0;_tmp22=((struct Cyc_Arg_Message_struct*)_tmp1C)->f1;
_LL8:{const char*_tmp95;void*_tmp94[2];struct Cyc_String_pa_struct _tmp93;struct Cyc_String_pa_struct
_tmp92;(_tmp92.tag=0,((_tmp92.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)
_tmp22),((_tmp93.tag=0,((_tmp93.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)progname),((_tmp94[0]=& _tmp93,((_tmp94[1]=& _tmp92,Cyc_fprintf(
Cyc_stderr,((_tmp95="%s: %s.\n",_tag_dynforward(_tmp95,sizeof(char),
_get_zero_arr_size_char(_tmp95,9)))),_tag_dynforward(_tmp94,sizeof(void*),2)))))))))))));}
goto _LL0;_LL0:;}Cyc_Arg_usage(speclist,errmsg);Cyc_Arg_current=(int)
_get_dynforward_size(Cyc_Arg_args,sizeof(struct _dynforward_ptr));}void Cyc_Arg_parse(
struct Cyc_List_List*speclist,void(*anonfun)(struct _dynforward_ptr),struct
_dynforward_ptr errmsg,struct _dynforward_ptr orig_args);void Cyc_Arg_parse(struct
Cyc_List_List*speclist,void(*anonfun)(struct _dynforward_ptr),struct
_dynforward_ptr errmsg,struct _dynforward_ptr orig_args){Cyc_Arg_args=orig_args;{
int initpos=Cyc_Arg_current;unsigned int l=_get_dynforward_size(Cyc_Arg_args,
sizeof(struct _dynforward_ptr));if((*((struct _dynforward_ptr*)
_check_dynforward_subscript(Cyc_Arg_args,sizeof(struct _dynforward_ptr),(int)(l - 
1)))).curr == ((struct _dynforward_ptr)_tag_dynforward(0,0,0)).curr)l=l - 1;++ Cyc_Arg_current;
while(Cyc_Arg_current < l){struct _dynforward_ptr s=*((struct _dynforward_ptr*)
_check_dynforward_subscript(Cyc_Arg_args,sizeof(struct _dynforward_ptr),Cyc_Arg_current));
if((s.curr != ((struct _dynforward_ptr)_tag_dynforward(0,0,0)).curr  && 
_get_dynforward_size(s,sizeof(char))>= 1) && *((const char*)
_check_dynforward_subscript(s,sizeof(char),0))== '-'){void*action;{struct
...
_tmp40){{void*_tmp41=action;void(*_tmp42)();void(*_tmp43)(struct _dynforward_ptr);
int*_tmp44;int*_tmp45;void(*_tmp46)(struct _dynforward_ptr,struct _dynforward_ptr);
void(*_tmp47)(struct _dynforward_ptr);void(*_tmp48)(int);void(*_tmp49)(struct
_dynforward_ptr);_LLF: if(*((int*)_tmp41)!= 0)goto _LL11;_tmp42=((struct Cyc_Arg_Unit_spec_struct*)
...
_tmp41)->f1;_LL1C: {struct _dynforward_ptr arg=*((struct _dynforward_ptr*)
_check_dynforward_subscript(Cyc_Arg_args,sizeof(struct _dynforward_ptr),Cyc_Arg_current
...
_tag_dynforward(_tmpA1,sizeof(void*),1))))))))!= 1){{struct Cyc_Arg_Wrong_struct
_tmpA8;const char*_tmpA7;struct Cyc_Arg_Wrong_struct*_tmpA6;Cyc_Arg_stop(initpos,(
void*)((_tmpA6=_cycalloc(sizeof(*_tmpA6)),((_tmpA6[0]=((_tmpA8.tag=3,((_tmpA8.f1=
s,((_tmpA8.f2=arg,((_tmpA8.f3=((_tmpA7="an integer",_tag_dynforward(_tmpA7,
sizeof(char),_get_zero_arr_size_char(_tmpA7,11)))),_tmpA8)))))))),_tmpA6)))),
...
_exn_thrown;void*_tmp5D=_tmp5A;struct _dynforward_ptr _tmp5E;_LL25: if(*((void**)
