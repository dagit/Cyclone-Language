...
struct Cyc_Dict_Dict d,void*k);struct _dyneither_ptr Cyc_Bitvec_new_empty(int);
struct _dyneither_ptr Cyc_Bitvec_new_full(int);struct _dyneither_ptr Cyc_Bitvec_new_copy(
