...
void*f1;void*f2;};void*Cyc_PP_append(void*a1,void*a2);void*Cyc_PP_append(void*a1,
void*a2){if(a1 == (void*)((void*)0))return a2;else{if(a2 == (void*)((void*)0))
return a1;else{struct Cyc_PP_Append_struct _tmpA3;struct Cyc_PP_Append_struct*_tmpA2;
return(void*)((_tmpA2=_cycalloc(sizeof(*_tmpA2)),((_tmpA2[0]=((_tmpA3.tag=1,((
_tmpA3.f1=(void*)a1,((_tmpA3.f2=(void*)a2,_tmpA3)))))),_tmpA2))));}}}struct Cyc_List_List*
Cyc_PP_list_of_alist_f(void*y,struct Cyc_List_List*l);struct Cyc_List_List*Cyc_PP_list_of_alist_f(
...
_LL4: {struct Cyc_List_List*_tmpA4;return(_tmpA4=_cycalloc(sizeof(*_tmpA4)),((
_tmpA4->hd=(void*)_tmp3,((_tmpA4->tl=l,_tmpA4)))));}_LL5: if(_tmp2 <= (void*)1)
goto _LL0;if(*((int*)_tmp2)!= 1)goto _LL0;_tmp4=(void*)((struct Cyc_PP_Append_struct*)
_tmp2)->f1;_tmp5=(void*)((struct Cyc_PP_Append_struct*)_tmp2)->f2;_LL6: return Cyc_PP_list_of_alist_f(
...
_tmpA6;(_tmpA6.tag=0,((_tmpA6.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)*
_tmp9),((_tmpA7[0]=& _tmpA6,Cyc_fprintf(f,((_tmpA8="%s",_tag_dynforward(_tmpA8,
sizeof(char),_get_zero_arr_size_char(_tmpA8,3)))),_tag_dynforward(_tmpA7,sizeof(
void*),1)))))));}goto _LL7;_LLC: if(_tmp8 <= (void*)1)goto _LL7;if(*((int*)_tmp8)!= 
1)goto _LL7;_tmpA=(void*)((struct Cyc_PP_Append_struct*)_tmp8)->f1;_tmpB=(void*)((
struct Cyc_PP_Append_struct*)_tmp8)->f2;_LLD: Cyc_Xarray_set(_tmp7,last,_tmpB);if(
last == Cyc_Xarray_length(_tmp7)- 1)Cyc_Xarray_add(_tmp7,_tmpA);else{Cyc_Xarray_set(
_tmp7,last + 1,_tmpA);}++ last;goto _LL7;_LL7:;}}}void Cyc_PP_file_of_doc(struct Cyc_PP_Doc*
d,int w,struct Cyc___cycFILE*f);void Cyc_PP_file_of_doc(struct Cyc_PP_Doc*d,int w,
struct Cyc___cycFILE*f){struct Cyc_PP_Ppstate*_tmpA9;struct Cyc_PP_Out*o=((struct
Cyc_PP_Out*(*)(struct Cyc_Fn_Function*f,struct Cyc_PP_Ppstate*x))Cyc_Fn_apply)(d->f,((
_tmpA9=_cycalloc_atomic(sizeof(*_tmpA9)),((_tmpA9->ci=0,((_tmpA9->cc=0,((_tmpA9->cl=
1,((_tmpA9->pw=w,((_tmpA9->epw=w,_tmpA9)))))))))))));Cyc_PP_dump_out(f,(void*)o->ppout);}
struct _dynforward_ptr Cyc_PP_string_of_doc(struct Cyc_PP_Doc*d,int w);struct
_dynforward_ptr Cyc_PP_string_of_doc(struct Cyc_PP_Doc*d,int w){struct Cyc_PP_Ppstate*
...
const char*_tmpAB;return(struct _dynforward_ptr)Cyc_str_sepstr(((struct Cyc_List_List*(*)(
void*x))Cyc_PP_list_of_alist)((void*)o->ppout),((_tmpAB="",_tag_dynforward(
_tmpAB,sizeof(char),_get_zero_arr_size_char(_tmpAB,1)))));}struct _tuple0*Cyc_PP_string_and_links(
struct Cyc_PP_Doc*d,int w);struct _tuple0*Cyc_PP_string_and_links(struct Cyc_PP_Doc*
d,int w){struct Cyc_PP_Ppstate*_tmpAC;struct Cyc_PP_Out*o=((struct Cyc_PP_Out*(*)(
struct Cyc_Fn_Function*f,struct Cyc_PP_Ppstate*x))Cyc_Fn_apply)(d->f,((_tmpAC=
_cycalloc_atomic(sizeof(*_tmpAC)),((_tmpAC->ci=0,((_tmpAC->cc=0,((_tmpAC->cl=1,((
_tmpAC->pw=w,((_tmpAC->epw=w,_tmpAC)))))))))))));const char*_tmpAF;struct _tuple0*
_tmpAE;return(_tmpAE=_cycalloc(sizeof(*_tmpAE)),((_tmpAE->f1=(struct
_dynforward_ptr)Cyc_str_sepstr(((struct Cyc_List_List*(*)(void*x))Cyc_PP_list_of_alist)((
void*)o->ppout),((_tmpAF="",_tag_dynforward(_tmpAF,sizeof(char),
_get_zero_arr_size_char(_tmpAF,1))))),((_tmpAE->f2=((struct Cyc_List_List*(*)(
void*x))Cyc_PP_list_of_alist)((void*)o->links),_tmpAE)))));}static struct Cyc_Core_Opt*
Cyc_PP_bhashtbl=0;int Cyc_PP_tex_output=0;struct _dynforward_ptr Cyc_PP_nlblanks(
int i);struct _dynforward_ptr Cyc_PP_nlblanks(int i){if(Cyc_PP_bhashtbl == 0){struct
Cyc_Core_Opt*_tmpB0;Cyc_PP_bhashtbl=((_tmpB0=_cycalloc(sizeof(*_tmpB0)),((_tmpB0->v=((
struct Cyc_Hashtable_Table*(*)(int sz,int(*cmp)(int,int),int(*hash)(int)))Cyc_Hashtable_create)(
61,Cyc_Core_intcmp,(int(*)(int))Cyc_Core_identity),_tmpB0))));}if(i < 0){struct
Cyc_Core_Failure_struct _tmpB6;const char*_tmpB5;struct Cyc_Core_Failure_struct*
_tmpB4;(int)_throw((void*)((_tmpB4=_cycalloc(sizeof(*_tmpB4)),((_tmpB4[0]=((
_tmpB6.tag=Cyc_Core_Failure,((_tmpB6.f1=((_tmpB5="nlblanks",_tag_dynforward(
_tmpB5,sizeof(char),_get_zero_arr_size_char(_tmpB5,9)))),_tmpB6)))),_tmpB4)))));}{
struct _handler_cons _tmp19;_push_handler(& _tmp19);{int _tmp1B=0;if(setjmp(_tmp19.handler))
_tmp1B=1;if(!_tmp1B){{struct _dynforward_ptr _tmp1C=*((struct _dynforward_ptr*(*)(
...
_tmp1F=i / 8;int _tmp20=i % 8;int _tmp21=(2 + _tmp1F)+ _tmp20;struct _dynforward_ptr
nlb=Cyc_Core_new_string((unsigned int)_tmp21);{char _tmpB9;char _tmpB8;struct
_dynforward_ptr _tmpB7;(_tmpB7=_dynforward_ptr_plus(nlb,sizeof(char),0),((_tmpB8=*((
char*)_check_dynforward_subscript(_tmpB7,sizeof(char),0)),((_tmpB9='\n',((
_get_dynforward_size(_tmpB7,sizeof(char))== 1  && (_tmpB8 == '\000'  && _tmpB9 != '\000')?
_throw_arraybounds(): 1,*((char*)_tmpB7.curr)=_tmpB9)))))));}{int j=0;for(0;j < 
_tmp1F;++ j){char _tmpBC;char _tmpBB;struct _dynforward_ptr _tmpBA;(_tmpBA=
_dynforward_ptr_plus(nlb,sizeof(char),j + 1),((_tmpBB=*((char*)
_check_dynforward_subscript(_tmpBA,sizeof(char),0)),((_tmpBC='\t',((
_get_dynforward_size(_tmpBA,sizeof(char))== 1  && (_tmpBB == '\000'  && _tmpBC != '\000')?
_throw_arraybounds(): 1,*((char*)_tmpBA.curr)=_tmpBC)))))));}}{int j=0;for(0;j < 
_tmp20;++ j){char _tmpBF;char _tmpBE;struct _dynforward_ptr _tmpBD;(_tmpBD=
_dynforward_ptr_plus(nlb,sizeof(char),(j + 1)+ _tmp1F),((_tmpBE=*((char*)
_check_dynforward_subscript(_tmpBD,sizeof(char),0)),((_tmpBF=' ',((
_get_dynforward_size(_tmpBD,sizeof(char))== 1  && (_tmpBE == '\000'  && _tmpBF != '\000')?
_throw_arraybounds(): 1,*((char*)_tmpBD.curr)=_tmpBF)))))));}}{struct
_dynforward_ptr*_tmpC0;((void(*)(struct Cyc_Hashtable_Table*t,int key,struct
_dynforward_ptr*val))Cyc_Hashtable_insert)((struct Cyc_Hashtable_Table*)((struct
Cyc_Core_Opt*)_check_null(Cyc_PP_bhashtbl))->v,i,((_tmpC0=_cycalloc(sizeof(
struct _dynforward_ptr)* 1),((_tmpC0[0]=(struct _dynforward_ptr)nlb,_tmpC0)))));}
return(struct _dynforward_ptr)nlb;}else{int _tmp2C=3 + i;struct _dynforward_ptr nlb=
Cyc_Core_new_string((unsigned int)(_tmp2C + 1));{char _tmpC3;char _tmpC2;struct
_dynforward_ptr _tmpC1;(_tmpC1=_dynforward_ptr_plus(nlb,sizeof(char),0),((_tmpC2=*((
char*)_check_dynforward_subscript(_tmpC1,sizeof(char),0)),((_tmpC3='\\',((
_get_dynforward_size(_tmpC1,sizeof(char))== 1  && (_tmpC2 == '\000'  && _tmpC3 != '\000')?
_throw_arraybounds(): 1,*((char*)_tmpC1.curr)=_tmpC3)))))));}{char _tmpC6;char
_tmpC5;struct _dynforward_ptr _tmpC4;(_tmpC4=_dynforward_ptr_plus(nlb,sizeof(char),
1),((_tmpC5=*((char*)_check_dynforward_subscript(_tmpC4,sizeof(char),0)),((
_tmpC6='\\',((_get_dynforward_size(_tmpC4,sizeof(char))== 1  && (_tmpC5 == '\000'
 && _tmpC6 != '\000')?_throw_arraybounds(): 1,*((char*)_tmpC4.curr)=_tmpC6)))))));}{
char _tmpC9;char _tmpC8;struct _dynforward_ptr _tmpC7;(_tmpC7=_dynforward_ptr_plus(
nlb,sizeof(char),2),((_tmpC8=*((char*)_check_dynforward_subscript(_tmpC7,sizeof(
char),0)),((_tmpC9='\n',((_get_dynforward_size(_tmpC7,sizeof(char))== 1  && (
_tmpC8 == '\000'  && _tmpC9 != '\000')?_throw_arraybounds(): 1,*((char*)_tmpC7.curr)=
_tmpC9)))))));}{int j=3;for(0;j < _tmp2C;++ j){char _tmpCC;char _tmpCB;struct
_dynforward_ptr _tmpCA;(_tmpCA=_dynforward_ptr_plus(nlb,sizeof(char),j),((_tmpCB=*((
char*)_check_dynforward_subscript(_tmpCA,sizeof(char),0)),((_tmpCC='~',((
_get_dynforward_size(_tmpCA,sizeof(char))== 1  && (_tmpCB == '\000'  && _tmpCC != '\000')?
_throw_arraybounds(): 1,*((char*)_tmpCA.curr)=_tmpCC)))))));}}{struct
_dynforward_ptr*_tmpCD;((void(*)(struct Cyc_Hashtable_Table*t,int key,struct
_dynforward_ptr*val))Cyc_Hashtable_insert)((struct Cyc_Hashtable_Table*)((struct
Cyc_Core_Opt*)_check_null(Cyc_PP_bhashtbl))->v,i,((_tmpCD=_cycalloc(sizeof(
struct _dynforward_ptr)* 1),((_tmpCD[0]=(struct _dynforward_ptr)nlb,_tmpCD)))));}
return(struct _dynforward_ptr)nlb;}_LL11:;_LL12:(void)_throw(_tmp1E);_LLE:;}}}}
static struct Cyc_Core_Opt*Cyc_PP_str_hashtbl=0;int Cyc_PP_infinity=9999999;struct
_tuple1{int f1;struct _dynforward_ptr f2;};static struct Cyc_PP_Out*Cyc_PP_text_doc_f(
...
_dynforward_ptr _tmp3D;struct _tuple1*_tmp3A=clo;_tmp3B=*_tmp3A;_tmp3C=_tmp3B.f1;
_tmp3D=_tmp3B.f2;{struct Cyc_PP_Single_struct*_tmpD7;struct _dynforward_ptr*_tmpD6;
...
_tmpD5.f1=(void*)((_tmpD6=_cycalloc(sizeof(struct _dynforward_ptr)* 1),((_tmpD6[0]=
_tmp3D,_tmpD6)))),_tmpD5)))),_tmpD7))))),((_tmpD4->links=(void*)((void*)0),
_tmpD4)))))))));}}static struct Cyc_PP_Doc*Cyc_PP_text_doc(struct _dynforward_ptr s);
static struct Cyc_PP_Doc*Cyc_PP_text_doc(struct _dynforward_ptr s){int slen=(int)Cyc_strlen((
struct _dynforward_ptr)s);struct _tuple1*_tmpDA;struct Cyc_PP_Doc*_tmpD9;return(
...
_tmpD9)))))));}struct Cyc_PP_Doc*Cyc_PP_text(struct _dynforward_ptr s);struct Cyc_PP_Doc*
Cyc_PP_text(struct _dynforward_ptr s){struct Cyc_Hashtable_Table*t;if(Cyc_PP_str_hashtbl
...
if(!_tmp47){{struct _dynforward_ptr*_tmpDC;struct Cyc_PP_Doc*_tmp49=((struct Cyc_PP_Doc*(*)(
struct Cyc_Hashtable_Table*t,struct _dynforward_ptr*key))Cyc_Hashtable_lookup)(t,((
...
Cyc_PP_text_doc(s);{struct _dynforward_ptr*_tmpDD;((void(*)(struct Cyc_Hashtable_Table*
...
_dynforward_ptr*s);struct Cyc_PP_Doc*Cyc_PP_textptr(struct _dynforward_ptr*s){
return Cyc_PP_text(*s);}static struct Cyc_PP_Doc*Cyc_PP_text_width_doc(struct
_dynforward_ptr s,int slen);static struct Cyc_PP_Doc*Cyc_PP_text_width_doc(struct
_dynforward_ptr s,int slen){struct _tuple1*_tmpE0;struct Cyc_PP_Doc*_tmpDF;return(
...
Cyc_PP_text_width(struct _dynforward_ptr s,int slen);struct Cyc_PP_Doc*Cyc_PP_text_width(
...
if(!_tmp52){{struct _dynforward_ptr*_tmpE2;struct Cyc_PP_Doc*_tmp54=((struct Cyc_PP_Doc*(*)(
struct Cyc_Hashtable_Table*t,struct _dynforward_ptr*key))Cyc_Hashtable_lookup)(t,((
...
Cyc_PP_text_width_doc(s,slen);{struct _dynforward_ptr*_tmpE3;((void(*)(struct Cyc_Hashtable_Table*
t,struct _dynforward_ptr*key,struct Cyc_PP_Doc*val))Cyc_Hashtable_insert)(t,((
...
_cycalloc(sizeof(*_tmpE5)),((_tmpE5->v=Cyc_PP_text(((_tmpE6="",_tag_dynforward(
_tmpE6,sizeof(char),_get_zero_arr_size_char(_tmpE6,1))))),_tmpE5))));}return(
struct Cyc_PP_Doc*)((struct Cyc_Core_Opt*)_check_null(Cyc_PP_nil_doc_opt))->v;}
struct Cyc_PP_Doc*Cyc_PP_blank_doc();struct Cyc_PP_Doc*Cyc_PP_blank_doc(){if(Cyc_PP_blank_doc_opt
== 0){const char*_tmpE9;struct Cyc_Core_Opt*_tmpE8;Cyc_PP_blank_doc_opt=((_tmpE8=
_cycalloc(sizeof(*_tmpE8)),((_tmpE8->v=Cyc_PP_text(((_tmpE9="",_tag_dynforward(
_tmpE9,sizeof(char),_get_zero_arr_size_char(_tmpE9,1))))),_tmpE8))));}return(
struct Cyc_PP_Doc*)((struct Cyc_Core_Opt*)_check_null(Cyc_PP_blank_doc_opt))->v;}
struct _tuple2{int f1;struct _dynforward_ptr f2;struct _dynforward_ptr f3;};struct
_tuple3{int f1;int f2;int f3;struct _dynforward_ptr f4;};static struct Cyc_PP_Out*Cyc_PP_hyperlink_f(
...
struct Cyc_PP_Single_struct*_tmp109;struct _dynforward_ptr*_tmp108;struct Cyc_PP_Single_struct
...
void*)((_tmp108=_cycalloc(sizeof(struct _dynforward_ptr)* 1),((_tmp108[0]=Cyc_PP_nlblanks(
...
_tmp115)))))));}struct Cyc_PP_Doc*Cyc_PP_cat(struct _dynforward_ptr l);struct Cyc_PP_Doc*
Cyc_PP_cat(struct _dynforward_ptr l){struct Cyc_PP_Doc*_tmp80=Cyc_PP_nil_doc();{int
i=(int)(_get_dynforward_size(l,sizeof(struct Cyc_PP_Doc*))- 1);for(0;i >= 0;-- i){
...
doclist->tl));}}}}static struct Cyc_PP_Out*Cyc_PP_cats_arr_f(struct _dynforward_ptr*
...
links,_tmp11D)))))))));}}}struct Cyc_PP_Doc*Cyc_PP_cats_arr(struct _dynforward_ptr
docs);struct Cyc_PP_Doc*Cyc_PP_cats_arr(struct _dynforward_ptr docs){int sz=(int)
_get_dynforward_size(docs,sizeof(struct Cyc_PP_Doc*));if(sz == 0){struct Cyc_Core_Failure_struct
...
_tmp123.f1=((_tmp122="cats_arr -- size zero array",_tag_dynforward(_tmp122,
sizeof(char),_get_zero_arr_size_char(_tmp122,28)))),_tmp123)))),_tmp121)))));}{
...
mw=mw2;mwo=mwo2;}}{struct _dynforward_ptr*_tmp126;struct Cyc_PP_Doc*_tmp125;return(
_tmp125=_cycalloc(sizeof(*_tmp125)),((_tmp125->mwo=mw,((_tmp125->mw=mwo,((
_tmp125->f=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct
_dynforward_ptr*,struct Cyc_PP_Ppstate*),struct _dynforward_ptr*x))Cyc_Fn_make_fn)(
Cyc_PP_cats_arr_f,((_tmp126=_cycalloc(sizeof(struct _dynforward_ptr)* 1),((
_tmp126[0]=docs,_tmp126))))),_tmp125)))))));}}}static struct Cyc_PP_Out*Cyc_PP_doc_union_f(
...
_dynforward_ptr sep,struct Cyc_List_List*l){if(l == 0)return Cyc_PP_nil_doc();else{
...
_tag_dynforward(_tmp12C,sizeof(struct Cyc_PP_Doc*),4)))))))));}}}struct Cyc_PP_Doc*
Cyc_PP_ppseq(struct Cyc_PP_Doc*(*pp)(void*),struct _dynforward_ptr sep,struct Cyc_List_List*
l);struct Cyc_PP_Doc*Cyc_PP_ppseq(struct Cyc_PP_Doc*(*pp)(void*),struct
_dynforward_ptr sep,struct Cyc_List_List*l){return Cyc_PP_tab(Cyc_PP_ppseq_f(pp,sep,
l));}struct Cyc_PP_Doc*Cyc_PP_seq_f(struct _dynforward_ptr sep,struct Cyc_List_List*
l);struct Cyc_PP_Doc*Cyc_PP_seq_f(struct _dynforward_ptr sep,struct Cyc_List_List*l){
if(l == 0)return Cyc_PP_nil_doc();else{if(l->tl == 0)return(struct Cyc_PP_Doc*)l->hd;
...
struct _dynforward_ptr sep,struct Cyc_List_List*l);struct Cyc_PP_Doc*Cyc_PP_seq(
struct _dynforward_ptr sep,struct Cyc_List_List*l){return Cyc_PP_tab(Cyc_PP_seq_f(
sep,l));}struct Cyc_PP_Doc*Cyc_PP_ppseql_f(struct Cyc_PP_Doc*(*pp)(void*),struct
_dynforward_ptr sep,struct Cyc_List_List*l);struct Cyc_PP_Doc*Cyc_PP_ppseql_f(
struct Cyc_PP_Doc*(*pp)(void*),struct _dynforward_ptr sep,struct Cyc_List_List*l){
if(l == 0)return Cyc_PP_nil_doc();else{if(l->tl == 0)return pp((void*)l->hd);else{
struct Cyc_PP_Doc*_tmp130[4];return(_tmp130[3]=Cyc_PP_ppseql_f(pp,sep,l->tl),((
_tmp130[2]=Cyc_PP_line_doc(),((_tmp130[1]=Cyc_PP_text(sep),((_tmp130[0]=pp((void*)
l->hd),Cyc_PP_cat(_tag_dynforward(_tmp130,sizeof(struct Cyc_PP_Doc*),4)))))))));}}}
struct Cyc_PP_Doc*Cyc_PP_ppseql(struct Cyc_PP_Doc*(*pp)(void*),struct
_dynforward_ptr sep,struct Cyc_List_List*l);struct Cyc_PP_Doc*Cyc_PP_ppseql(struct
...
struct _dynforward_ptr sep,struct Cyc_List_List*l);static struct Cyc_PP_Doc*Cyc_PP_seql_f(
struct _dynforward_ptr sep,struct Cyc_List_List*l){if(l == 0)return Cyc_PP_nil_doc();
else{if(l->tl == 0)return(struct Cyc_PP_Doc*)l->hd;else{struct Cyc_PP_Doc*_tmp131[4];
return(_tmp131[3]=Cyc_PP_seql_f(sep,l->tl),((_tmp131[2]=Cyc_PP_line_doc(),((
_tmp131[1]=Cyc_PP_text(sep),((_tmp131[0]=(struct Cyc_PP_Doc*)l->hd,Cyc_PP_cat(
_tag_dynforward(_tmp131,sizeof(struct Cyc_PP_Doc*),4)))))))));}}}struct Cyc_PP_Doc*
Cyc_PP_seql(struct _dynforward_ptr sep,struct Cyc_List_List*l0);struct Cyc_PP_Doc*
Cyc_PP_seql(struct _dynforward_ptr sep,struct Cyc_List_List*l0){return Cyc_PP_tab(
Cyc_PP_seql_f(sep,l0));}struct Cyc_PP_Doc*Cyc_PP_group(struct _dynforward_ptr start,
struct _dynforward_ptr stop,struct _dynforward_ptr sep,struct Cyc_List_List*ss);
struct Cyc_PP_Doc*Cyc_PP_group(struct _dynforward_ptr start,struct _dynforward_ptr
stop,struct _dynforward_ptr sep,struct Cyc_List_List*ss){struct Cyc_PP_Doc*_tmp132[3];
return(_tmp132[2]=Cyc_PP_text(stop),((_tmp132[1]=Cyc_PP_seq(sep,ss),((_tmp132[0]=
Cyc_PP_text(start),Cyc_PP_cat(_tag_dynforward(_tmp132,sizeof(struct Cyc_PP_Doc*),
3)))))));}struct Cyc_PP_Doc*Cyc_PP_egroup(struct _dynforward_ptr start,struct
_dynforward_ptr stop,struct _dynforward_ptr sep,struct Cyc_List_List*ss);struct Cyc_PP_Doc*
Cyc_PP_egroup(struct _dynforward_ptr start,struct _dynforward_ptr stop,struct
_dynforward_ptr sep,struct Cyc_List_List*ss){if(ss == 0)return Cyc_PP_nil_doc();
else{struct Cyc_PP_Doc*_tmp133[3];return(_tmp133[2]=Cyc_PP_text(stop),((_tmp133[1]=
Cyc_PP_seq(sep,ss),((_tmp133[0]=Cyc_PP_text(start),Cyc_PP_cat(_tag_dynforward(
_tmp133,sizeof(struct Cyc_PP_Doc*),3)))))));}}struct Cyc_PP_Doc*Cyc_PP_groupl(
struct _dynforward_ptr start,struct _dynforward_ptr stop,struct _dynforward_ptr sep,
struct Cyc_List_List*ss);struct Cyc_PP_Doc*Cyc_PP_groupl(struct _dynforward_ptr
start,struct _dynforward_ptr stop,struct _dynforward_ptr sep,struct Cyc_List_List*ss){
struct Cyc_PP_Doc*_tmp134[3];return(_tmp134[2]=Cyc_PP_text(stop),((_tmp134[1]=Cyc_PP_seql(
sep,ss),((_tmp134[0]=Cyc_PP_text(start),Cyc_PP_cat(_tag_dynforward(_tmp134,
