...
_tmp5)),((_tmp5->v=(void*)f((void*)o->v),_tmp5)));}}struct _dynforward_ptr Cyc_Core_new_string(
unsigned int i);struct _dynforward_ptr Cyc_Core_new_string(unsigned int i){char*
_tmp7;unsigned int _tmp6;return(_tmp6=i,((_tmp7=_cyccalloc_atomic(sizeof(char),
_tmp6),_tag_dynforward(_tmp7,sizeof(char),_tmp6))));}struct _dynforward_ptr Cyc_Core_rnew_string(
struct _RegionHandle*r,unsigned int i);struct _dynforward_ptr Cyc_Core_rnew_string(
struct _RegionHandle*r,unsigned int i){char*_tmp9;unsigned int _tmp8;return(_tmp8=i,((
_tmp9=_region_calloc(r,sizeof(char),_tmp8),_tag_dynforward(_tmp9,sizeof(char),
