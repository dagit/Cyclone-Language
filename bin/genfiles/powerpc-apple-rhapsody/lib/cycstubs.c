...
struct Cyc_flock{long long l_start;long long l_len;int l_pid;short l_type;short
l_whence;};struct Cyc_Flock_struct{int tag;struct Cyc_flock*f1;};struct Cyc_Long_struct{
...
open_without_mode(const char*,int);int open_with_mode(const char*,int,
unsigned short);static char _tmp5[21]="fcntl: too many args";static struct Cyc_Core_Failure_struct
...
if(_get_dyneither_size(ms,sizeof(unsigned short))>= 1)return open_with_mode(s,i,*((
unsigned short*)_check_dyneither_subscript(ms,sizeof(unsigned short),0)));else{
...
return(void*)({struct Cyc___SIG_BUILTIN_struct*_tmpB=_cycalloc_atomic(sizeof(*
_tmpB));_tmpB[0]=({struct Cyc___SIG_BUILTIN_struct _tmpC;_tmpC.tag=0;_tmpC.f1=Cyc_SIG_DFL;
_tmpC;});_tmpB;});}void*Cyc_Csignal_make_SIG_ERR(){return(void*)({struct Cyc___SIG_BUILTIN_struct*
_tmpD=_cycalloc_atomic(sizeof(*_tmpD));_tmpD[0]=({struct Cyc___SIG_BUILTIN_struct
_tmpE;_tmpE.tag=0;_tmpE.f1=Cyc_SIG_ERR;_tmpE;});_tmpD;});}void*Cyc_Csignal_make_SIG_IGN(){
...
Cyc_SIG_ERR;_tmp10;});_tmpF;});}void*Cyc_Csignal_make_SIG_HANDLER(void(*f)(int)){
return(void*)({struct Cyc___SIG_HANDLER_struct*_tmp11=_cycalloc(sizeof(*_tmp11));
_tmp11[0]=({struct Cyc___SIG_HANDLER_struct _tmp12;_tmp12.tag=1;_tmp12.f1=f;_tmp12;});
_tmp11;});}void*signal_SIG_DFL(int);void*signal_SIG_ERR(int);void*signal_SIG_IGN(
int);void*signal(int,void(*)(int));static char _tmp14[49]="signal called with the wrong number of arguments";
static struct Cyc_Core_Failure_struct Cyc___signal_failure={Cyc_Core_Failure,{
_tmp14,_tmp14,_tmp14 + 49}};void*Cyc_signal(int a,struct _dyneither_ptr b){if(
_get_dyneither_size(b,sizeof(void*))!= 1)(int)_throw((void*)& Cyc___signal_failure);{
void*_tmp15=*((void**)_check_dyneither_subscript(b,sizeof(void*),0));enum Cyc_SigBuiltin
_tmp17;enum Cyc_SigBuiltin _tmp19;enum Cyc_SigBuiltin _tmp1B;void(*_tmp1D)(int);
_LL6: {struct Cyc___SIG_BUILTIN_struct*_tmp16=(struct Cyc___SIG_BUILTIN_struct*)
_tmp15;if(_tmp16->tag != 0)goto _LL8;else{_tmp17=_tmp16->f1;if(_tmp17 != Cyc_SIG_DFL)
goto _LL8;}}_LL7: return signal_SIG_DFL(a);_LL8: {struct Cyc___SIG_BUILTIN_struct*
_tmp18=(struct Cyc___SIG_BUILTIN_struct*)_tmp15;if(_tmp18->tag != 0)goto _LLA;else{
_tmp19=_tmp18->f1;if(_tmp19 != Cyc_SIG_ERR)goto _LLA;}}_LL9: return signal_SIG_ERR(a);
_LLA: {struct Cyc___SIG_BUILTIN_struct*_tmp1A=(struct Cyc___SIG_BUILTIN_struct*)
_tmp15;if(_tmp1A->tag != 0)goto _LLC;else{_tmp1B=_tmp1A->f1;if(_tmp1B != Cyc_SIG_IGN)
goto _LLC;}}_LLB: return signal_SIG_IGN(a);_LLC: {struct Cyc___SIG_HANDLER_struct*
_tmp1C=(struct Cyc___SIG_HANDLER_struct*)_tmp15;if(_tmp1C->tag != 1)goto _LL5;else{
_tmp1D=_tmp1C->f1;}}_LLD: return signal(a,_tmp1D);_LL5:;};}struct Cyc___cycFILE;
...
struct Cyc___cycFILE*_tmp1E=_cycalloc(sizeof(*_tmp1E));_tmp1E->file=(struct Cyc_Cstdio___abstractFILE*)
cf;_tmp1E;}): 0;}void clearerr(struct Cyc_Cstdio___abstractFILE*);void Cyc_clearerr(
...
Cyc_Cstdio___abstractFILE*_tmp1F=fdopen(i,s);return(unsigned int)_tmp1F?({struct
Cyc___cycFILE*_tmp20=_cycalloc(sizeof(*_tmp20));_tmp20->file=(struct Cyc_Cstdio___abstractFILE*)
_tmp1F;_tmp20;}): 0;}int feof(struct Cyc_Cstdio___abstractFILE*);int Cyc_feof(struct
...
char*type){struct Cyc_Cstdio___abstractFILE*_tmp25=fopen(name,type);return(
unsigned int)_tmp25?({struct Cyc___cycFILE*_tmp26=_cycalloc(sizeof(*_tmp26));
_tmp26->file=(struct Cyc_Cstdio___abstractFILE*)_tmp25;_tmp26;}): 0;}int fputc(int,
...
static char _tmp28[27]="fread: buffer insufficient";static struct Cyc_Core_Failure_struct
Cyc___fread_failure={Cyc_Core_Failure,{_tmp28,_tmp28,_tmp28 + 27}};unsigned long
Cyc_fread(struct _dyneither_ptr ptr,unsigned long size,unsigned long nmemb,struct Cyc___cycFILE*
...
_tmp29=freopen(filename,modes,f->file);return(unsigned int)_tmp29?(struct Cyc___cycFILE*)({
struct Cyc___cycFILE*_tmp2A=_cycalloc(sizeof(*_tmp2A));_tmp2A->file=(struct Cyc_Cstdio___abstractFILE*)
_tmp29;_tmp2A;}): 0;}int fseek(struct Cyc_Cstdio___abstractFILE*,long,int);int Cyc_fseek(
...
static char _tmp2C[31]="fwrite called with NULL string";static struct Cyc_Core_Failure_struct
Cyc___fwrite_failure_1={Cyc_Core_Failure,{_tmp2C,_tmp2C,_tmp2C + 31}};static char
_tmp2E[28]="fwrite: buffer insufficient";static struct Cyc_Core_Failure_struct Cyc___fwrite_failure_2={
Cyc_Core_Failure,{_tmp2E,_tmp2E,_tmp2E + 28}};unsigned long Cyc_fwrite(struct
...
_tmp2F=popen(name,type);return(unsigned int)_tmp2F?({struct Cyc___cycFILE*_tmp30=
_cycalloc(sizeof(*_tmp30));_tmp30->file=(struct Cyc_Cstdio___abstractFILE*)_tmp2F;
_tmp30;}): 0;}int putc(int,struct Cyc_Cstdio___abstractFILE*);int Cyc_putc(int x,
...
Cyc_Cstdio___abstractFILE*,char*,int,unsigned long);static char _tmp32[24]="setvbuf: buffer is NULL";
static struct Cyc_Core_Failure_struct Cyc___setvbuf_failure_1={Cyc_Core_Failure,{
_tmp32,_tmp32,_tmp32 + 24}};static char _tmp34[29]="setvbuf: buffer insufficient";
...
_dyneither_ptr buf,int type,unsigned long size){if(!((unsigned int)buf.curr))(int)
...
sizeof(char),1));if(f == 0){struct _dyneither_ptr fn=({unsigned int _tmp37=
_get_dyneither_size(fname,sizeof(char));char*_tmp38=(char*)_cycalloc_atomic(
_check_times(sizeof(char),_tmp37 + 1));struct _dyneither_ptr _tmp3A=_tag_dyneither(
_tmp38,sizeof(char),_tmp37 + 1);{unsigned int _tmp39=_tmp37;unsigned int i;for(i=0;
i < _tmp39;i ++){_tmp38[i]=((const char*)fname.curr)[(int)i];}_tmp38[_tmp39]=(char)
0;}_tmp3A;});(int)_throw((void*)({struct Cyc_FileOpenError_struct*_tmp35=
_cycalloc(sizeof(*_tmp35));_tmp35[0]=({struct Cyc_FileOpenError_struct _tmp36;
_tmp36.tag=Cyc_FileOpenError;_tmp36.f1=fn;_tmp36;});_tmp35;}));}return(struct Cyc___cycFILE*)
...
_dyneither_ptr);void Cyc_qsort(struct _dyneither_ptr,unsigned long,unsigned int,
int(*)(const void*,const void*));void Cyc_free(struct _dyneither_ptr ptr){;}void qsort(
void*,unsigned long,unsigned long,int(*)(const void*,const void*));static char
_tmp3D[23]="qsort called with NULL";static struct Cyc_Core_Failure_struct Cyc___qsort_failure_1={
Cyc_Core_Failure,{_tmp3D,_tmp3D,_tmp3D + 23}};static char _tmp3F[42]="qsort called with insufficient array size";
...
_untag_dyneither_ptr(tab,sizeof(void),1),nmemb,(unsigned long)szmemb,compar);}
...
_dyneither_ptr Cyc_mmap(struct _dyneither_ptr,unsigned long length,int prot,int flags,
int fd,long long offset);int Cyc_munmap(struct _dyneither_ptr start,unsigned long
length);char*__stub_mmap(char*start,unsigned long length,int prot,int flags,int fd,
long long offset);int munmap(const char*start,unsigned long length);static char _tmp41[
42]="mmap called with illegal start/prot/flags";static struct Cyc_Core_Failure_struct
...
int flags,int fd,long long offset){if((ignored.curr == (_tag_dyneither(0,0,0)).curr
 && prot == 1) && (flags == 2  || flags == 1))return(struct _dyneither_ptr)
wrap_Cbuffer_as_buffer(__stub_mmap(0,length,prot,flags,fd,offset),length);else{(
int)_throw((void*)& Cyc___mmap_failure);}}int Cyc_munmap(struct _dyneither_ptr start,
unsigned long length){return munmap((const char*)_check_null(_untag_dyneither_ptr(
start,sizeof(char),1)),length);}struct Cyc_timeval{int tv_sec;int tv_usec;};struct
...
ru_nvcsw;long ru_nivcsw;};struct Cyc_rlimit{long long rlim_cur;long long rlim_max;};
struct Cyc_fd_set{int fds_bits[(1024 + (sizeof(int)* 8 - 1))/ (sizeof(int)* 8)];};
struct Cyc_timespec{long tv_sec;int tv_nsec;};int Cyc_select(int a,struct Cyc_fd_set*b,
struct Cyc_fd_set*c,struct Cyc_fd_set*d,struct Cyc_timeval*e);void Cyc_FD_CLR(int,
struct Cyc_fd_set*);int Cyc_FD_ISSET(int,struct Cyc_fd_set*);void Cyc_FD_SET(int,
struct Cyc_fd_set*);void Cyc_FD_ZERO(struct Cyc_fd_set*);int select(int,struct Cyc_fd_set*,
struct Cyc_fd_set*,struct Cyc_fd_set*,struct Cyc_timeval*);extern int Cyc_select(int a,
struct Cyc_fd_set*b,struct Cyc_fd_set*c,struct Cyc_fd_set*d,struct Cyc_timeval*e){
if(a < 0  || a > 1024){*((int*)_check_null(__CYCLONE_ERRNO()))=22;return - 1;}return
select(a,b,c,d,e);}void __stub_FD_CLR(int,struct Cyc_fd_set*);int __stub_FD_ISSET(
int,struct Cyc_fd_set*);void __stub_FD_SET(int,struct Cyc_fd_set*);void
__stub_FD_ZERO(struct Cyc_fd_set*);void Cyc_FD_CLR(int a,struct Cyc_fd_set*b){if(a < 
0  || a > 1024)return;return __stub_FD_CLR(a,b);}int Cyc_FD_ISSET(int a,struct Cyc_fd_set*
b){if(a < 0  || a > 1024)return 0;return __stub_FD_ISSET(a,b);}void Cyc_FD_SET(int a,
struct Cyc_fd_set*b){if(a < 0  || a > 1024)return;return __stub_FD_SET(a,b);}void Cyc_FD_ZERO(
struct Cyc_fd_set*a){return __stub_FD_ZERO(a);}struct Cyc_cmsghdr;struct Cyc_linger{
int l_onoff;int l_linger;};struct Cyc_SA_sockaddr_in_struct{int tag;struct Cyc_sockaddr_in*
...
_dyneither_ptr);extern char Cyc_SocketError[12];struct Cyc_SocketError_struct{char*
tag;};int Cyc_bind(int fd,struct _dyneither_ptr);int Cyc_connect(int fd,struct
...
_dyneither_ptr);int Cyc_recv(int fd,struct _dyneither_ptr buf,unsigned long n,int
flags);int Cyc_recvfrom(int fd,struct _dyneither_ptr buf,unsigned long n,int flags,
struct _dyneither_ptr);int Cyc_send(int fd,struct _dyneither_ptr buf,unsigned long n,
int flags);int Cyc_sendto(int fd,struct _dyneither_ptr buf,unsigned long n,int flags,
struct _dyneither_ptr);int Cyc_setsockopt(int fd,int level,int optname,struct
_dyneither_ptr);char Cyc_SocketError[12]="SocketError";struct Cyc_SocketError_struct
Cyc_SocketError_val={Cyc_SocketError};int accept_in(int,const struct Cyc_sockaddr_in*,
...
_check_dyneither_subscript(ap,sizeof(void*),0));_tmp43.f2=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),1));_tmp43;});void*_tmp45;struct Cyc_sockaddr_in*
...
Cyc_SocketError_val);{struct _tuple0 _tmp4C=({struct _tuple0 _tmp4B;_tmp4B.f1=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));_tmp4B.f2=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),1));_tmp4B;});void*_tmp4D;struct Cyc_sockaddr_in*
...
_check_dyneither_subscript(ap,sizeof(void*),0));_tmp53.f2=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),1));_tmp53;});void*_tmp55;struct Cyc_sockaddr_in*
_tmp57;void*_tmp58;int _tmp5A;_LL19: _tmp55=_tmp54.f1;{struct Cyc_SA_sockaddr_in_struct*
_tmp56=(struct Cyc_SA_sockaddr_in_struct*)_tmp55;if(_tmp56->tag != 0)goto _LL1B;
else{_tmp57=_tmp56->f1;}};_tmp58=_tmp54.f2;{struct Cyc_SA_socklen_struct*_tmp59=(
struct Cyc_SA_socklen_struct*)_tmp58;if(_tmp59->tag != 2)goto _LL1B;else{_tmp5A=
_tmp59->f1;}};_LL1A: return connect_in(fd,(const struct Cyc_sockaddr_in*)_tmp57,
_tmp5A);_LL1B:;_LL1C:(int)_throw((void*)& Cyc_SocketError_val);_LL18:;};}int
...
void*)& Cyc_SocketError_val);{struct _tuple0 _tmp5C=({struct _tuple0 _tmp5B;_tmp5B.f1=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));_tmp5B.f2=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),1));_tmp5B;});void*_tmp5D;struct Cyc_sockaddr_in*
...
struct _dyneither_ptr ap){if(_get_dyneither_size(ap,sizeof(void*))!= 2)(int)_throw((
void*)& Cyc_SocketError_val);{struct _tuple0 _tmp64=({struct _tuple0 _tmp63;_tmp63.f1=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));_tmp63.f2=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),1));_tmp63;});void*_tmp65;struct Cyc_sockaddr_in*
...
_dyneither_ptr ap){if(_get_dyneither_size(ap,sizeof(void*))!= 2)(int)_throw((void*)&
Cyc_SocketError_val);{struct _tuple0 _tmp6C=({struct _tuple0 _tmp6B;_tmp6B.f1=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));_tmp6B.f2=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),1));_tmp6B;});void*_tmp6D;int*_tmp6F;
...
int fd,struct _dyneither_ptr buf,unsigned long n,int flags){return recv_wrapped(fd,buf,
n,flags);}int recvfrom_in(int,struct _dyneither_ptr,unsigned long,int,const struct
Cyc_sockaddr_in*,int*);int Cyc_recvfrom(int fd,struct _dyneither_ptr buf,
unsigned long n,int flags,struct _dyneither_ptr ap){if(_get_dyneither_size(ap,
sizeof(void*))!= 2)(int)_throw((void*)& Cyc_SocketError_val);{struct _tuple0 _tmp86=({
struct _tuple0 _tmp85;_tmp85.f1=*((void**)_check_dyneither_subscript(ap,sizeof(
void*),0));_tmp85.f2=*((void**)_check_dyneither_subscript(ap,sizeof(void*),1));
_tmp85;});void*_tmp87;struct Cyc_sockaddr_in*_tmp89;void*_tmp8A;int*_tmp8C;_LL33:
...
unsigned long n,int flags){return send_wrapped(fd,buf,n,flags);}int sendto_in(int,
struct _dyneither_ptr,unsigned long,int,const struct Cyc_sockaddr_in*,int);int Cyc_sendto(
int fd,struct _dyneither_ptr buf,unsigned long n,int flags,struct _dyneither_ptr ap){
if(_get_dyneither_size(ap,sizeof(void*))!= 2)(int)_throw((void*)& Cyc_SocketError_val);{
struct _tuple0 _tmp8E=({struct _tuple0 _tmp8D;_tmp8D.f1=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),0));_tmp8D.f2=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),1));_tmp8D;});void*_tmp8F;struct Cyc_sockaddr_in*
...
_dyneither_ptr ap){if(_get_dyneither_size(ap,sizeof(void*))!= 2)(int)_throw((void*)&
Cyc_SocketError_val);{struct _tuple0 _tmp96=({struct _tuple0 _tmp95;_tmp95.f1=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));_tmp95.f2=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),1));_tmp95;});void*_tmp97;int*_tmp99;
...
struct _dyneither_ptr,unsigned long,struct _dyneither_ptr,const struct Cyc_tm*);
unsigned long strftime(char*,unsigned long,const char*,const struct Cyc_tm*);static
char _tmpA4[27]="fgets: buffer insufficient";static struct Cyc_Core_Failure_struct
Cyc___strftime_failure={Cyc_Core_Failure,{_tmpA4,_tmpA4,_tmpA4 + 27}};
unsigned long Cyc_strftime(struct _dyneither_ptr s,unsigned long maxsize,struct
...
_check_null(_untag_dyneither_ptr(fmt,sizeof(char),1)),t);}struct Cyc_option{
struct _dyneither_ptr name;int has_arg;int*flag;int val;};int Cyc_execlp(const char*,
const char*,struct _dyneither_ptr);int execvp(const char*file,const char**argv);
struct _dyneither_ptr Cyc_getcwd(struct _dyneither_ptr buf,unsigned long size);int Cyc_gethostname(
...
const char**newargs=(const char**)_untag_dyneither_ptr(({unsigned int _tmpAF=
_get_dyneither_size(argv,sizeof(const char*));const char**_tmpB0=(const char**)
_cycalloc(_check_times(sizeof(const char*),_tmpAF + 1));struct _dyneither_ptr _tmpB2=
_tag_dyneither(_tmpB0,sizeof(const char*),_tmpAF + 1);{unsigned int _tmpB1=_tmpAF;
unsigned int i;for(i=0;i < _tmpB1;i ++){_tmpB0[i]=(const char*)0;}_tmpB0[_tmpB1]=(
const char*)0;}_tmpB2;}),sizeof(const char*),1);({struct _dyneither_ptr _tmpA8=
_dyneither_ptr_plus(({const char**_tmpA7=newargs;_tag_dyneither(_tmpA7,sizeof(
const char*),_get_zero_arr_size_voidstar(_tmpA7,1));}),sizeof(const char*),0);
const char*_tmpA9=*((const char**)_check_dyneither_subscript(_tmpA8,sizeof(const
char*),0));const char*_tmpAA=(const char*)arg0;if(_get_dyneither_size(_tmpA8,
sizeof(const char*))== 1  && (_tmpA9 == 0  && _tmpAA != 0))_throw_arraybounds();*((
const char**)_tmpA8.curr)=_tmpAA;});{int i=0;for(0;i < _get_dyneither_size(argv,
sizeof(const char*))- 1;++ i){({struct _dyneither_ptr _tmpAC=_dyneither_ptr_plus(({
const char**_tmpAB=newargs;_tag_dyneither(_tmpAB,sizeof(const char*),
_get_zero_arr_size_voidstar(_tmpAB,1));}),sizeof(const char*),i + 1);const char*
_tmpAD=*((const char**)_check_dyneither_subscript(_tmpAC,sizeof(const char*),0));
const char*_tmpAE=*((const char**)_check_dyneither_subscript(argv,sizeof(const char*),
i));if(_get_dyneither_size(_tmpAC,sizeof(const char*))== 1  && (_tmpAD == 0  && 
_tmpAE != 0))_throw_arraybounds();*((const char**)_tmpAC.curr)=_tmpAE;});}}return
execvp(path,(const char**)newargs);};}char*getcwd(char*buf,unsigned long size);
static char _tmpB4[29]="getcwd: invalid buf argument";static struct Cyc_Core_Failure_struct
Cyc___getcwd_failure={Cyc_Core_Failure,{_tmpB4,_tmpB4,_tmpB4 + 29}};struct
_dyneither_ptr Cyc_getcwd(struct _dyneither_ptr buf,unsigned long size){if(
_get_dyneither_size(buf,sizeof(char))< size)(int)_throw((void*)& Cyc___getcwd_failure);{
char*_tmpB5=getcwd((char*)_check_null(_untag_dyneither_ptr(buf,sizeof(char),1)),
size);return(unsigned int)_tmpB5?buf: _tag_dyneither(0,0,0);};}int gethostname(
char*,unsigned long);static char _tmpB7[34]="gethostname: called with NULL buf";
static struct Cyc_Core_Failure_struct Cyc___gethostname_failure_1={Cyc_Core_Failure,{
_tmpB7,_tmpB7,_tmpB7 + 34}};static char _tmpB9[46]="gethostname: called with count > numelts(buf)";
static struct Cyc_Core_Failure_struct Cyc___gethostname_failure_2={Cyc_Core_Failure,{
_tmpB9,_tmpB9,_tmpB9 + 46}};int Cyc_gethostname(struct _dyneither_ptr buf,
unsigned long count){if(!((unsigned int)buf.curr))(int)_throw((void*)& Cyc___gethostname_failure_1);
...
read(int fd,char*buf,unsigned long count);static char _tmpBB[39]="read: called with count > numelts(buf)";
