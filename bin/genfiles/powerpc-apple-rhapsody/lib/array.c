...
_dynforward_ptr x);static void _tmp6F(unsigned int*_tmp6E,unsigned int*_tmp6D,void***
_tmp6B,struct _dynforward_ptr*x){for(*_tmp6E=0;*_tmp6E < *_tmp6D;(*_tmp6E)++){(*
...
_tmp7B=(unsigned int)sx,((_tmp7A=(void**)_cycalloc(_check_times(sizeof(void*),
_tmp7B)),((_tmp79=_tag_dynforward(_tmp7A,sizeof(void*),_tmp7B),((((_tmp78=_tmp7B,
_tmp6F(& _tmp77,& _tmp78,& _tmp7A,& x))),_tmp79)))))))),((_tmp76.f2=((_tmp80=(
unsigned int)sx,((_tmp7F=(void**)_cycalloc(_check_times(sizeof(void*),_tmp80)),((
_tmp7E=_tag_dynforward(_tmp7F,sizeof(void*),_tmp80),((((_tmp7D=_tmp80,_tmp75(&
_tmp7C,& _tmp7D,& _tmp7F,& x))),_tmp7E)))))))),_tmp76)));}int Cyc_Array_memq(struct
