...
18];struct Cyc_FileOpenError_struct{char*tag;struct _dyneither_ptr f1;};struct
...
struct _dyneither_ptr,struct Cyc_Position_Segment*);struct _tuple10{struct Cyc_List_List*
...
sizeof(*_tmp14D)),((_tmp14D->hd=(void*)Cyc_Absyn_sint_typ,((_tmp14D->tl=_tmp13,
_tmp14D))))));}goto _LL29;_LL2C:;_LL2D: goto _LL29;_LL29:;}{struct Cyc_List_List*
...
_tmp14E;_tmp13=((_tmp14E=_region_malloc(r,sizeof(*_tmp14E)),((_tmp14E->hd=(void*)
Cyc_Absyn_sint_typ,((_tmp14E->tl=_tmp13,_tmp14E))))));}goto _LL2E;_LL31:;_LL32:
...
char*_tmp152;void*_tmp151[1];struct Cyc_Int_pa_struct _tmp150;(_tmp150.tag=1,((
_tmp150.f1=(unsigned long)((int)_tmp1F),((_tmp151[0]=& _tmp150,Cyc_Tcutil_terr(
loc,((_tmp152="flag '#' is not valid with %%%c",_tag_dyneither(_tmp152,sizeof(
char),32))),_tag_dyneither(_tmp151,sizeof(void*),1)))))));}{struct Cyc_List_List*
...
const char*_tmp157;void*_tmp156[2];struct Cyc_String_pa_struct _tmp155;struct Cyc_Int_pa_struct
_tmp154;(_tmp154.tag=1,((_tmp154.f1=(unsigned long)((int)_tmp1F),((_tmp155.tag=0,((
_tmp155.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp1E)),((
_tmp156[0]=& _tmp155,((_tmp156[1]=& _tmp154,Cyc_Tcutil_terr(loc,((_tmp157="length modifier '%s' is not allowed with %%%c",
...
_tmp158;_tmp13=((_tmp158=_region_malloc(r,sizeof(*_tmp158)),((_tmp158->hd=(void*)
t,((_tmp158->tl=_tmp13,_tmp158))))));}break;case 'u': _LL35:{struct Cyc_List_List*f=
...
_tmp161;_tmp13=((_tmp161=_region_malloc(r,sizeof(*_tmp161)),((_tmp161->hd=(void*)
t,((_tmp161->tl=_tmp13,_tmp161))))));}break;case 'f': _LL44: goto _LL50;case 'F':
...
_tmp66;_LL59: if(_tmp63 != 0)goto _LL5B;_LL5A:{struct Cyc_List_List*_tmp162;_tmp13=((
_tmp162=_region_malloc(r,sizeof(*_tmp162)),((_tmp162->hd=(void*)Cyc_Absyn_double_typ(
0),((_tmp162->tl=_tmp13,_tmp162))))));}goto _LL58;_LL5B: if(_tmp63 == 0)goto _LL5D;
_tmp64=*_tmp63;_tmp65=(int)_tmp64.hd;_tmp66=_tmp64.tl;if(_tmp66 != 0)goto _LL5D;
if(!(_tmp65 == 'l'))goto _LL5D;_LL5C:{struct Cyc_List_List*_tmp163;_tmp13=((_tmp163=
_region_malloc(r,sizeof(*_tmp163)),((_tmp163->hd=(void*)Cyc_Absyn_double_typ(1),((
...
_tmp175;_tmp13=((_tmp175=_region_malloc(r,sizeof(*_tmp175)),((_tmp175->hd=(void*)
Cyc_Absyn_sint_typ,((_tmp175->tl=_tmp13,_tmp175))))));}break;case 's': _LL5F:{
struct Cyc_List_List*f=_tmp1B;for(0;f != 0;f=f->tl){if((int)f->hd != '-'){{const
char*_tmp178;void*_tmp177;(_tmp177=0,Cyc_Tcutil_terr(loc,((_tmp178="a flag not allowed with %%s",
...
_region_malloc(r,sizeof(*_tmp17D)),((_tmp17D->hd=(void*)ptr,((_tmp17D->tl=_tmp13,
_tmp17D))))));}break;}case 'p': _LL60:{struct Cyc_List_List*_tmp17E;_tmp13=((
_tmp17E=_region_malloc(r,sizeof(*_tmp17E)),((_tmp17E->hd=(void*)Cyc_Absyn_uint_typ,((
...
_region_malloc(r,sizeof(*_tmp18D)),((_tmp18D->hd=(void*)t,((_tmp18D->tl=_tmp13,
_tmp18D))))));}break;}case '%': _LL62: if(_tmp1B != 0){{const char*_tmp191;void*
_tmp190[1];struct Cyc_String_pa_struct _tmp18F;(_tmp18F.tag=0,((_tmp18F.f1=(struct
...
struct _tuple11{int f1;struct Cyc_List_List*f2;struct Cyc_List_List*f3;char f4;int f5;
};struct Cyc_Core_Opt*Cyc_Formatstr_parse_inputformat(struct _RegionHandle*r,
struct _dyneither_ptr s,int i);struct Cyc_Core_Opt*Cyc_Formatstr_parse_inputformat(
...
_region_malloc(r,sizeof(*_tmp1B4)),((_tmp1B4->hd=(void*)t,((_tmp1B4->tl=_tmpC1,
_tmp1B4))))));}break;}case 'u': _LL94: goto _LLA0;case 'o': _LLA0: goto _LLA1;case 'x':
_LLA1: goto _LLA2;case 'X': _LLA2: {struct Cyc_Core_Opt*_tmp1B5;struct Cyc_Core_Opt*
_tmpEB=(_tmp1B5=_cycalloc(sizeof(*_tmp1B5)),((_tmp1B5->v=Cyc_Tcenv_lookup_type_vars(
te),_tmp1B5)));{struct Cyc_List_List*_tmpEC=_tmpCB;struct Cyc_List_List _tmpED;int
...
goto _LLA4;_LLAD:;_LLAE:{const char*_tmp1BA;void*_tmp1B9[2];struct Cyc_String_pa_struct
...
_region_malloc(r,sizeof(*_tmp1BB)),((_tmp1BB->hd=(void*)t,((_tmp1BB->tl=_tmpC1,
_tmp1BB))))));}break;}case 'f': _LLA3: goto _LLAF;case 'F': _LLAF: goto _LLB0;case 'e':
_LLB0: goto _LLB1;case 'E': _LLB1: goto _LLB2;case 'g': _LLB2: goto _LLB3;case 'G': _LLB3:
goto _LLB4;case 'a': _LLB4: goto _LLB5;case 'A': _LLB5: {struct Cyc_Core_Opt*_tmp1BC;
struct Cyc_Core_Opt*_tmp100=(_tmp1BC=_cycalloc(sizeof(*_tmp1BC)),((_tmp1BC->v=Cyc_Tcenv_lookup_type_vars(
...
_region_malloc(r,sizeof(*_tmp1C2)),((_tmp1C2->hd=(void*)t,((_tmp1C2->tl=_tmpC1,
_tmp1C2))))));}break;}case 'c': _LLB6: {struct Cyc_Core_Opt*_tmp1C3;struct Cyc_Core_Opt*
_tmp10C=(_tmp1C3=_cycalloc(sizeof(*_tmp1C3)),((_tmp1C3->v=Cyc_Tcenv_lookup_type_vars(
te),_tmp1C3)));{struct Cyc_List_List*_tmp1C4;_tmpC1=((_tmp1C4=_region_malloc(r,
sizeof(*_tmp1C4)),((_tmp1C4->hd=(void*)Cyc_Absyn_dyneither_typ(Cyc_Absyn_char_typ,
Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,_tmp10C),Cyc_Absyn_empty_tqual(
0),Cyc_Absyn_false_conref),((_tmp1C4->tl=_tmpC1,_tmp1C4))))));}break;}case 's':
_LLBE: {struct Cyc_Core_Opt*_tmp1C5;struct Cyc_Core_Opt*_tmp10F=(_tmp1C5=_cycalloc(
sizeof(*_tmp1C5)),((_tmp1C5->v=Cyc_Tcenv_lookup_type_vars(te),_tmp1C5)));void*
...
Cyc_List_List*_tmp1C6;_tmpC1=((_tmp1C6=_region_malloc(r,sizeof(*_tmp1C6)),((
_tmp1C6->hd=(void*)ptr,((_tmp1C6->tl=_tmpC1,_tmp1C6))))));}break;}case '[': _LLBF:
goto _LLC0;case 'p': _LLC0:{const char*_tmp1CA;void*_tmp1C9[1];struct Cyc_Int_pa_struct
_tmp1C8;(_tmp1C8.tag=1,((_tmp1C8.f1=(unsigned long)((int)_tmpCC),((_tmp1C9[0]=&
_tmp1C8,Cyc_Tcutil_terr(loc,((_tmp1CA="%%%c is not supported",_tag_dyneither(
_tmp1CA,sizeof(char),22))),_tag_dyneither(_tmp1C9,sizeof(void*),1)))))));}{
struct Cyc_List_List*_tmp115=0;_npop_handler(0);return _tmp115;}case 'n': _LLC1: {
struct Cyc_Core_Opt*_tmp1CB;struct Cyc_Core_Opt*_tmp116=(_tmp1CB=_cycalloc(sizeof(*
_tmp1CB)),((_tmp1CB->v=Cyc_Tcenv_lookup_type_vars(te),_tmp1CB)));{struct Cyc_List_List*
...
goto _LLC3;_LLCC:;_LLCD:{const char*_tmp1D0;void*_tmp1CF[2];struct Cyc_String_pa_struct
...
_region_malloc(r,sizeof(*_tmp1D1)),((_tmp1D1->hd=(void*)t,((_tmp1D1->tl=_tmpC1,
_tmp1D1))))));}break;}case '%': _LLC2: if(_tmpC9){{const char*_tmp1D4;void*_tmp1D3;(
_tmp1D3=0,Cyc_Tcutil_terr(loc,((_tmp1D4="Assignment suppression (*) is not allowed with %%%%",
...
struct Cyc_List_List*_tmp137=Cyc_List_imp_rev(_tmpC1);_npop_handler(0);return
_tmp137;};_pop_region(temp);}
