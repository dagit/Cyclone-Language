...
8];int isdigit(int);unsigned long Cyc_strlen(struct _dynforward_ptr s);struct
...
_tag_dynforward(_tmp147,sizeof(char),_get_zero_arr_size_char(_tmp147,18)))),
_tag_dynforward(_tmp146,sizeof(void*),0)));}{struct Cyc_List_List*_tmp18=0;
...
const char*_tmp14B;void*_tmp14A[1];struct Cyc_Int_pa_struct _tmp149;(_tmp149.tag=1,((
_tmp149.f1=(unsigned long)_tmp23,((_tmp14A[0]=& _tmp149,Cyc_Tcutil_terr(loc,((
_tmp14B="length modifier '%c' is not supported",_tag_dynforward(_tmp14B,sizeof(
char),_get_zero_arr_size_char(_tmp14B,38)))),_tag_dynforward(_tmp14A,sizeof(void*),
1)))))));}{struct Cyc_List_List*_tmp28=0;_npop_handler(0);return _tmp28;}_LL27:;
_LL28: goto _LL24;_LL24:;}{struct Cyc_List_List*_tmp29=_tmp1C;struct Cyc_List_List
_tmp2A;int _tmp2B;struct Cyc_List_List*_tmp2C;_LL2A: if(_tmp29 == 0)goto _LL2C;_tmp2A=*
_tmp29;_tmp2B=(int)_tmp2A.hd;_tmp2C=_tmp2A.tl;if(_tmp2C != 0)goto _LL2C;if(!(
_tmp2B == '*'))goto _LL2C;_LL2B:{struct Cyc_List_List*_tmp14C;_tmp13=((_tmp14C=
_region_malloc(r,sizeof(*_tmp14C)),((_tmp14C->hd=(void*)Cyc_Absyn_sint_typ,((
_tmp14C->tl=_tmp13,_tmp14C))))));}goto _LL29;_LL2C:;_LL2D: goto _LL29;_LL29:;}{
struct Cyc_List_List*_tmp2E=_tmp1D;struct Cyc_List_List _tmp2F;int _tmp30;struct Cyc_List_List*
_tmp31;struct Cyc_List_List _tmp32;int _tmp33;struct Cyc_List_List*_tmp34;_LL2F: if(
_tmp2E == 0)goto _LL31;_tmp2F=*_tmp2E;_tmp30=(int)_tmp2F.hd;_tmp31=_tmp2F.tl;if(
_tmp31 == 0)goto _LL31;_tmp32=*_tmp31;_tmp33=(int)_tmp32.hd;_tmp34=_tmp32.tl;if(
_tmp34 != 0)goto _LL31;if(!(_tmp30 == '.'  && _tmp33 == '*'))goto _LL31;_LL30:{struct
Cyc_List_List*_tmp14D;_tmp13=((_tmp14D=_region_malloc(r,sizeof(*_tmp14D)),((
_tmp14D->hd=(void*)Cyc_Absyn_sint_typ,((_tmp14D->tl=_tmp13,_tmp14D))))));}goto
_LL2E;_LL31:;_LL32: goto _LL2E;_LL2E:;}{void*t;switch(_tmp1F){case 'd': _LL33: goto
_LL34;case 'i': _LL34:{struct Cyc_List_List*f=_tmp1B;for(0;f != 0;f=f->tl){if((int)f->hd
== '#'){{const char*_tmp151;void*_tmp150[1];struct Cyc_Int_pa_struct _tmp14F;(
_tmp14F.tag=1,((_tmp14F.f1=(unsigned long)((int)_tmp1F),((_tmp150[0]=& _tmp14F,
Cyc_Tcutil_terr(loc,((_tmp151="flag '#' is not valid with %%%c",_tag_dynforward(
_tmp151,sizeof(char),_get_zero_arr_size_char(_tmp151,32)))),_tag_dynforward(
_tmp150,sizeof(void*),1)))))));}{struct Cyc_List_List*_tmp39=0;_npop_handler(0);
return _tmp39;}}}}{struct Cyc_List_List*_tmp3A=_tmp1E;struct Cyc_List_List _tmp3B;
int _tmp3C;struct Cyc_List_List*_tmp3D;struct Cyc_List_List _tmp3E;int _tmp3F;struct
Cyc_List_List*_tmp40;struct Cyc_List_List _tmp41;int _tmp42;struct Cyc_List_List*
...
_LL3F;_LL3E: t=Cyc_Absyn_schar_typ;goto _LL36;_LL3F:;_LL40:{const char*_tmp156;void*
_tmp155[2];struct Cyc_String_pa_struct _tmp154;struct Cyc_Int_pa_struct _tmp153;(
_tmp153.tag=1,((_tmp153.f1=(unsigned long)((int)_tmp1F),((_tmp154.tag=0,((
_tmp154.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(_tmp1E)),((
_tmp155[0]=& _tmp154,((_tmp155[1]=& _tmp153,Cyc_Tcutil_terr(loc,((_tmp156="length modifier '%s' is not allowed with %%%c",
_tag_dynforward(_tmp156,sizeof(char),_get_zero_arr_size_char(_tmp156,46)))),
_tag_dynforward(_tmp155,sizeof(void*),2)))))))))))));}{struct Cyc_List_List*
_tmp4B=0;_npop_handler(0);return _tmp4B;}_LL36:;}{struct Cyc_List_List*_tmp157;
_tmp13=((_tmp157=_region_malloc(r,sizeof(*_tmp157)),((_tmp157->hd=(void*)t,((
_tmp157->tl=_tmp13,_tmp157))))));}break;case 'u': _LL35:{struct Cyc_List_List*f=
...
_tag_dynforward(_tmp15A,sizeof(char),_get_zero_arr_size_char(_tmp15A,28)))),
_tag_dynforward(_tmp159,sizeof(void*),0)));}{struct Cyc_List_List*_tmp4F=0;
...
_LL4E;_LL4D: t=Cyc_Absyn_uchar_typ;goto _LL45;_LL4E:;_LL4F:{const char*_tmp15F;void*
_tmp15E[2];struct Cyc_String_pa_struct _tmp15D;struct Cyc_Int_pa_struct _tmp15C;(
_tmp15C.tag=1,((_tmp15C.f1=(unsigned long)((int)_tmp1F),((_tmp15D.tag=0,((
_tmp15D.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(_tmp1E)),((
_tmp15E[0]=& _tmp15D,((_tmp15E[1]=& _tmp15C,Cyc_Tcutil_terr(loc,((_tmp15F="length modifier '%s' is not allowed with %%%c",
_tag_dynforward(_tmp15F,sizeof(char),_get_zero_arr_size_char(_tmp15F,46)))),
_tag_dynforward(_tmp15E,sizeof(void*),2)))))))))))));}{struct Cyc_List_List*
_tmp61=0;_npop_handler(0);return _tmp61;}_LL45:;}{struct Cyc_List_List*_tmp160;
_tmp13=((_tmp160=_region_malloc(r,sizeof(*_tmp160)),((_tmp160->hd=(void*)t,((
_tmp160->tl=_tmp13,_tmp160))))));}break;case 'f': _LL44: goto _LL50;case 'F': _LL50:
...
_LL59: if(_tmp63 != 0)goto _LL5B;_LL5A:{struct Cyc_List_List*_tmp161;_tmp13=((
...
_tmp165.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(_tmp1E)),((
_tmp166[0]=& _tmp165,((_tmp166[1]=& _tmp164,Cyc_Tcutil_terr(loc,((_tmp167="length modifier '%s' is not allowed with %%%c",
_tag_dynforward(_tmp167,sizeof(char),_get_zero_arr_size_char(_tmp167,46)))),
_tag_dynforward(_tmp166,sizeof(void*),2)))))))))))));}{struct Cyc_List_List*
_tmp6D=0;_npop_handler(0);return _tmp6D;}_LL58:;}break;case 'c': _LL57:{struct Cyc_List_List*
f=_tmp1B;for(0;f != 0;f=f->tl){if((int)f->hd == '#'  || (int)f->hd == '0'){{const
char*_tmp16B;void*_tmp16A[1];struct Cyc_Int_pa_struct _tmp169;(_tmp169.tag=1,((
_tmp169.f1=(unsigned long)((int)f->hd),((_tmp16A[0]=& _tmp169,Cyc_Tcutil_terr(loc,((
_tmp16B="flag '%c' not allowed with %%c",_tag_dynforward(_tmp16B,sizeof(char),
_get_zero_arr_size_char(_tmp16B,31)))),_tag_dynforward(_tmp16A,sizeof(void*),1)))))));}{
...
0,((_tmp16D.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(_tmp1E)),((
_tmp16E[0]=& _tmp16D,Cyc_Tcutil_terr(loc,((_tmp16F="length modifier '%s' not allowed with %%c",
_tag_dynforward(_tmp16F,sizeof(char),_get_zero_arr_size_char(_tmp16F,42)))),
_tag_dynforward(_tmp16E,sizeof(void*),1)))))));}{struct Cyc_List_List*_tmp75=0;
_npop_handler(0);return _tmp75;}}if(_tmp1D != 0){{const char*_tmp173;void*_tmp172[1];
struct Cyc_String_pa_struct _tmp171;(_tmp171.tag=0,((_tmp171.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(_tmp1D)),((_tmp172[0]=&
_tmp171,Cyc_Tcutil_terr(loc,((_tmp173="precision '%s' not allowed with %%c",
_tag_dynforward(_tmp173,sizeof(char),_get_zero_arr_size_char(_tmp173,36)))),
_tag_dynforward(_tmp172,sizeof(void*),1)))))));}{struct Cyc_List_List*_tmp79=0;
_npop_handler(0);return _tmp79;}}{struct Cyc_List_List*_tmp174;_tmp13=((_tmp174=
_region_malloc(r,sizeof(*_tmp174)),((_tmp174->hd=(void*)Cyc_Absyn_sint_typ,((
_tmp174->tl=_tmp13,_tmp174))))));}break;case 's': _LL5F:{struct Cyc_List_List*f=
_tmp1B;for(0;f != 0;f=f->tl){if((int)f->hd != '-'){{const char*_tmp177;void*_tmp176;(
_tmp176=0,Cyc_Tcutil_terr(loc,((_tmp177="a flag not allowed with %%s",
_tag_dynforward(_tmp177,sizeof(char),_get_zero_arr_size_char(_tmp177,28)))),
_tag_dynforward(_tmp176,sizeof(void*),0)));}{struct Cyc_List_List*_tmp7D=0;
_npop_handler(0);return _tmp7D;}}}}if(_tmp1E != 0){{const char*_tmp17A;void*_tmp179;(
_tmp179=0,Cyc_Tcutil_terr(loc,((_tmp17A="length modifiers not allowed with %%s",
_tag_dynforward(_tmp17A,sizeof(char),_get_zero_arr_size_char(_tmp17A,38)))),
_tag_dynforward(_tmp179,sizeof(void*),0)));}{struct Cyc_List_List*_tmp80=0;
_npop_handler(0);return _tmp80;}}{struct Cyc_Core_Opt*_tmp17B;void*ptr=Cyc_Absyn_dynforward_typ(
Cyc_Absyn_char_typ,Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,((
_tmp17B=_cycalloc(sizeof(*_tmp17B)),((_tmp17B->v=Cyc_Tcenv_lookup_type_vars(te),
_tmp17B))))),Cyc_Absyn_const_tqual(0),Cyc_Absyn_false_conref);{struct Cyc_List_List*
_tmp17C;_tmp13=((_tmp17C=_region_malloc(r,sizeof(*_tmp17C)),((_tmp17C->hd=(void*)
ptr,((_tmp17C->tl=_tmp13,_tmp17C))))));}break;}case 'p': _LL60:{struct Cyc_List_List*
_tmp17D;_tmp13=((_tmp17D=_region_malloc(r,sizeof(*_tmp17D)),((_tmp17D->hd=(void*)
Cyc_Absyn_uint_typ,((_tmp17D->tl=_tmp13,_tmp17D))))));}break;case 'n': _LL61:{
struct Cyc_List_List*f=_tmp1B;for(0;f != 0;f=f->tl){if((int)f->hd == '#'  || (int)f->hd
== '0'){{const char*_tmp181;void*_tmp180[1];struct Cyc_Int_pa_struct _tmp17F;(
_tmp17F.tag=1,((_tmp17F.f1=(unsigned long)((int)f->hd),((_tmp180[0]=& _tmp17F,Cyc_Tcutil_terr(
loc,((_tmp181="flag '%c' not allowed with %%n",_tag_dynforward(_tmp181,sizeof(
char),_get_zero_arr_size_char(_tmp181,31)))),_tag_dynforward(_tmp180,sizeof(void*),
1)))))));}{struct Cyc_List_List*_tmp87=0;_npop_handler(0);return _tmp87;}}}}if(
_tmp1D != 0){{const char*_tmp185;void*_tmp184[1];struct Cyc_String_pa_struct _tmp183;(
_tmp183.tag=0,((_tmp183.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(
_tmp1D)),((_tmp184[0]=& _tmp183,Cyc_Tcutil_terr(loc,((_tmp185="precision '%s' not allowed with %%n",
_tag_dynforward(_tmp185,sizeof(char),_get_zero_arr_size_char(_tmp185,36)))),
_tag_dynforward(_tmp184,sizeof(void*),1)))))));}{struct Cyc_List_List*_tmp8B=0;
_npop_handler(0);return _tmp8B;}}{struct Cyc_Core_Opt*_tmp186;struct Cyc_Core_Opt*
_tmp8C=(_tmp186=_cycalloc(sizeof(*_tmp186)),((_tmp186->v=Cyc_Tcenv_lookup_type_vars(
te),_tmp186)));{struct Cyc_List_List*_tmp8D=_tmp1E;struct Cyc_List_List _tmp8E;int
...
goto _LL63;_LL6C:;_LL6D:{const char*_tmp18B;void*_tmp18A[2];struct Cyc_String_pa_struct
_tmp189;struct Cyc_Int_pa_struct _tmp188;(_tmp188.tag=1,((_tmp188.f1=(
unsigned long)((int)_tmp1F),((_tmp189.tag=0,((_tmp189.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)Cyc_implode(_tmp1E)),((_tmp18A[0]=& _tmp189,((_tmp18A[1]=&
_tmp188,Cyc_Tcutil_terr(loc,((_tmp18B="length modifier '%s' is not allowed with %%%c",
_tag_dynforward(_tmp18B,sizeof(char),_get_zero_arr_size_char(_tmp18B,46)))),
_tag_dynforward(_tmp18A,sizeof(void*),2)))))))))))));}{struct Cyc_List_List*
_tmp9E=0;_npop_handler(0);return _tmp9E;}_LL63:;}t=Cyc_Absyn_at_typ(t,Cyc_Absyn_new_evar((
struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,_tmp8C),Cyc_Absyn_empty_tqual(0),Cyc_Absyn_false_conref);{
struct Cyc_List_List*_tmp18C;_tmp13=((_tmp18C=_region_malloc(r,sizeof(*_tmp18C)),((
_tmp18C->hd=(void*)t,((_tmp18C->tl=_tmp13,_tmp18C))))));}break;}case '%': _LL62:
if(_tmp1B != 0){{const char*_tmp190;void*_tmp18F[1];struct Cyc_String_pa_struct
_tmp18E;(_tmp18E.tag=0,((_tmp18E.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)Cyc_implode(_tmp1B)),((_tmp18F[0]=& _tmp18E,Cyc_Tcutil_terr(loc,((
_tmp190="flags '%s' not allowed with %%%%",_tag_dynforward(_tmp190,sizeof(char),
_get_zero_arr_size_char(_tmp190,33)))),_tag_dynforward(_tmp18F,sizeof(void*),1)))))));}{
...
0,((_tmp192.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(_tmp1C)),((
_tmp193[0]=& _tmp192,Cyc_Tcutil_terr(loc,((_tmp194="width '%s' not allowed with %%%%",
_tag_dynforward(_tmp194,sizeof(char),_get_zero_arr_size_char(_tmp194,33)))),
_tag_dynforward(_tmp193,sizeof(void*),1)))))));}{struct Cyc_List_List*_tmpA8=0;
_npop_handler(0);return _tmpA8;}}if(_tmp1D != 0){{const char*_tmp198;void*_tmp197[1];
struct Cyc_String_pa_struct _tmp196;(_tmp196.tag=0,((_tmp196.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(_tmp1D)),((_tmp197[0]=&
_tmp196,Cyc_Tcutil_terr(loc,((_tmp198="precision '%s' not allowed with %%%%",
_tag_dynforward(_tmp198,sizeof(char),_get_zero_arr_size_char(_tmp198,37)))),
_tag_dynforward(_tmp197,sizeof(void*),1)))))));}{struct Cyc_List_List*_tmpAC=0;
_npop_handler(0);return _tmpAC;}}if(_tmp1E != 0){{const char*_tmp19C;void*_tmp19B[1];
struct Cyc_String_pa_struct _tmp19A;(_tmp19A.tag=0,((_tmp19A.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(_tmp1E)),((_tmp19B[0]=&
_tmp19A,Cyc_Tcutil_terr(loc,((_tmp19C="length modifier '%s' not allowed with %%%%",
_tag_dynforward(_tmp19C,sizeof(char),_get_zero_arr_size_char(_tmp19C,43)))),
_tag_dynforward(_tmp19B,sizeof(void*),1)))))));}{struct Cyc_List_List*_tmpB0=0;
...
i);struct Cyc_Core_Opt*Cyc_Formatstr_parse_inputformat(struct _RegionHandle*r,
...
case 'u': _LL7B: goto _LL7C;case 'x': _LL7C: goto _LL7D;case 'X': _LL7D: goto _LL7E;case 'f':
_LL7E: goto _LL7F;case 'F': _LL7F: goto _LL80;case 'e': _LL80: goto _LL81;case 'E': _LL81:
goto _LL82;case 'g': _LL82: goto _LL83;case 'G': _LL83: goto _LL84;case 'a': _LL84: goto
_LL85;case 'A': _LL85: goto _LL86;case 'c': _LL86: goto _LL87;case 's': _LL87: goto _LL88;
case 'p': _LL88: goto _LL89;case 'n': _LL89: goto _LL8A;case '%': _LL8A: break;default:
_LL8B: return 0;}{struct _tuple5*_tmp1A5;struct Cyc_Core_Opt*_tmp1A4;return(_tmp1A4=
...
te,struct _dynforward_ptr s,struct Cyc_Position_Segment*loc);struct Cyc_List_List*
...
_get_zero_arr_size_char(_tmp1A8,18)))),_tag_dynforward(_tmp1A7,sizeof(void*),0)));}{
...
_tag_dynforward(_tmp1AC,sizeof(char),_get_zero_arr_size_char(_tmp1AC,38)))),
_tag_dynforward(_tmp1AB,sizeof(void*),1)))))));}{struct Cyc_List_List*_tmpD5=0;
...
Cyc_Core_Opt*_tmp1AD;struct Cyc_Core_Opt*_tmpD6=(_tmp1AD=_cycalloc(sizeof(*
_tmp1AD)),((_tmp1AD->v=Cyc_Tcenv_lookup_type_vars(te),_tmp1AD)));{struct Cyc_List_List*
_tmpD7=_tmpCB;struct Cyc_List_List _tmpD8;int _tmpD9;struct Cyc_List_List*_tmpDA;
struct Cyc_List_List _tmpDB;int _tmpDC;struct Cyc_List_List*_tmpDD;struct Cyc_List_List
...
unsigned long)((int)_tmpCC),((_tmp1B0.tag=0,((_tmp1B0.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)Cyc_implode(_tmpCB)),((_tmp1B1[0]=& _tmp1B0,((_tmp1B1[1]=&
_tmp1AF,Cyc_Tcutil_terr(loc,((_tmp1B2="length modifier '%s' is not allowed with %%%c",
_tag_dynforward(_tmp1B2,sizeof(char),_get_zero_arr_size_char(_tmp1B2,46)))),
_tag_dynforward(_tmp1B1,sizeof(void*),2)))))))))))));}{struct Cyc_List_List*
_tmpE8=0;_npop_handler(0);return _tmpE8;}_LL95:;}t=Cyc_Absyn_at_typ(t,Cyc_Absyn_new_evar((
struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,_tmpD6),Cyc_Absyn_empty_tqual(0),Cyc_Absyn_false_conref);{
struct Cyc_List_List*_tmp1B3;_tmpC1=((_tmp1B3=_region_malloc(r,sizeof(*_tmp1B3)),((
_tmp1B3->hd=(void*)t,((_tmp1B3->tl=_tmpC1,_tmp1B3))))));}break;}case 'u': _LL94:
goto _LLA0;case 'o': _LLA0: goto _LLA1;case 'x': _LLA1: goto _LLA2;case 'X': _LLA2: {struct
Cyc_Core_Opt*_tmp1B4;struct Cyc_Core_Opt*_tmpEB=(_tmp1B4=_cycalloc(sizeof(*
_tmp1B4)),((_tmp1B4->v=Cyc_Tcenv_lookup_type_vars(te),_tmp1B4)));{struct Cyc_List_List*
_tmpEC=_tmpCB;struct Cyc_List_List _tmpED;int _tmpEE;struct Cyc_List_List*_tmpEF;
struct Cyc_List_List _tmpF0;int _tmpF1;struct Cyc_List_List*_tmpF2;struct Cyc_List_List
...
_LLA4;_LLAD:;_LLAE:{const char*_tmp1B9;void*_tmp1B8[2];struct Cyc_String_pa_struct
_tmp1B7;struct Cyc_Int_pa_struct _tmp1B6;(_tmp1B6.tag=1,((_tmp1B6.f1=(
unsigned long)((int)_tmpCC),((_tmp1B7.tag=0,((_tmp1B7.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)Cyc_implode(_tmpCB)),((_tmp1B8[0]=& _tmp1B7,((_tmp1B8[1]=&
_tmp1B6,Cyc_Tcutil_terr(loc,((_tmp1B9="length modifier '%s' is not allowed with %%%c",
_tag_dynforward(_tmp1B9,sizeof(char),_get_zero_arr_size_char(_tmp1B9,46)))),
_tag_dynforward(_tmp1B8,sizeof(void*),2)))))))))))));}{struct Cyc_List_List*
_tmpFD=0;_npop_handler(0);return _tmpFD;}_LLA4:;}t=Cyc_Absyn_at_typ(t,Cyc_Absyn_new_evar((
struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,_tmpEB),Cyc_Absyn_empty_tqual(0),Cyc_Absyn_false_conref);{
struct Cyc_List_List*_tmp1BA;_tmpC1=((_tmp1BA=_region_malloc(r,sizeof(*_tmp1BA)),((
_tmp1BA->hd=(void*)t,((_tmp1BA->tl=_tmpC1,_tmp1BA))))));}break;}case 'f': _LLA3:
...
case 'A': _LLB5: {struct Cyc_Core_Opt*_tmp1BB;struct Cyc_Core_Opt*_tmp100=(_tmp1BB=
_cycalloc(sizeof(*_tmp1BB)),((_tmp1BB->v=Cyc_Tcenv_lookup_type_vars(te),_tmp1BB)));{
...
t=Cyc_Absyn_double_typ(0);goto _LLB7;_LLBC:;_LLBD:{const char*_tmp1C0;void*_tmp1BF[
2];struct Cyc_String_pa_struct _tmp1BE;struct Cyc_Int_pa_struct _tmp1BD;(_tmp1BD.tag=
1,((_tmp1BD.f1=(unsigned long)((int)_tmpCC),((_tmp1BE.tag=0,((_tmp1BE.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(_tmpCB)),((_tmp1BF[0]=&
_tmp1BE,((_tmp1BF[1]=& _tmp1BD,Cyc_Tcutil_terr(loc,((_tmp1C0="length modifier '%s' is not allowed with %%%c",
_tag_dynforward(_tmp1C0,sizeof(char),_get_zero_arr_size_char(_tmp1C0,46)))),
_tag_dynforward(_tmp1BF,sizeof(void*),2)))))))))))));}{struct Cyc_List_List*
_tmp109=0;_npop_handler(0);return _tmp109;}_LLB7:;}t=Cyc_Absyn_at_typ(t,Cyc_Absyn_new_evar((
struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,_tmp100),Cyc_Absyn_empty_tqual(0),Cyc_Absyn_false_conref);{
struct Cyc_List_List*_tmp1C1;_tmpC1=((_tmp1C1=_region_malloc(r,sizeof(*_tmp1C1)),((
_tmp1C1->hd=(void*)t,((_tmp1C1->tl=_tmpC1,_tmp1C1))))));}break;}case 'c': _LLB6: {
struct Cyc_Core_Opt*_tmp1C2;struct Cyc_Core_Opt*_tmp10C=(_tmp1C2=_cycalloc(sizeof(*
_tmp1C2)),((_tmp1C2->v=Cyc_Tcenv_lookup_type_vars(te),_tmp1C2)));{struct Cyc_List_List*
_tmp1C3;_tmpC1=((_tmp1C3=_region_malloc(r,sizeof(*_tmp1C3)),((_tmp1C3->hd=(void*)
Cyc_Absyn_dynforward_typ(Cyc_Absyn_char_typ,Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)&
Cyc_Tcutil_rk,_tmp10C),Cyc_Absyn_empty_tqual(0),Cyc_Absyn_false_conref),((
_tmp1C3->tl=_tmpC1,_tmp1C3))))));}break;}case 's': _LLBE: {struct Cyc_Core_Opt*
_tmp1C4;struct Cyc_Core_Opt*_tmp10F=(_tmp1C4=_cycalloc(sizeof(*_tmp1C4)),((
_tmp1C4->v=Cyc_Tcenv_lookup_type_vars(te),_tmp1C4)));void*ptr=Cyc_Absyn_dynforward_typ(
Cyc_Absyn_char_typ,Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,
_tmp10F),Cyc_Absyn_empty_tqual(0),Cyc_Absyn_false_conref);{struct Cyc_List_List*
_tmp1C5;_tmpC1=((_tmp1C5=_region_malloc(r,sizeof(*_tmp1C5)),((_tmp1C5->hd=(void*)
ptr,((_tmp1C5->tl=_tmpC1,_tmp1C5))))));}break;}case '[': _LLBF: goto _LLC0;case 'p':
_LLC0:{const char*_tmp1C9;void*_tmp1C8[1];struct Cyc_Int_pa_struct _tmp1C7;(_tmp1C7.tag=
1,((_tmp1C7.f1=(unsigned long)((int)_tmpCC),((_tmp1C8[0]=& _tmp1C7,Cyc_Tcutil_terr(
loc,((_tmp1C9="%%%c is not supported",_tag_dynforward(_tmp1C9,sizeof(char),
_get_zero_arr_size_char(_tmp1C9,22)))),_tag_dynforward(_tmp1C8,sizeof(void*),1)))))));}{
...
unsigned long)((int)_tmpCC),((_tmp1CD.tag=0,((_tmp1CD.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)Cyc_implode(_tmpCB)),((_tmp1CE[0]=& _tmp1CD,((_tmp1CE[1]=&
_tmp1CC,Cyc_Tcutil_terr(loc,((_tmp1CF="length modifier '%s' is not allowed with %%%c",
_tag_dynforward(_tmp1CF,sizeof(char),_get_zero_arr_size_char(_tmp1CF,46)))),
_tag_dynforward(_tmp1CE,sizeof(void*),2)))))))))))));}{struct Cyc_List_List*
_tmp128=0;_npop_handler(0);return _tmp128;}_LLC3:;}t=Cyc_Absyn_at_typ(t,Cyc_Absyn_new_evar((
struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,_tmp116),Cyc_Absyn_empty_tqual(0),Cyc_Absyn_false_conref);{
struct Cyc_List_List*_tmp1D0;_tmpC1=((_tmp1D0=_region_malloc(r,sizeof(*_tmp1D0)),((
_tmp1D0->hd=(void*)t,((_tmp1D0->tl=_tmpC1,_tmp1D0))))));}break;}case '%': _LLC2:
if(_tmpC9){{const char*_tmp1D3;void*_tmp1D2;(_tmp1D2=0,Cyc_Tcutil_terr(loc,((
_tmp1D3="Assignment suppression (*) is not allowed with %%%%",_tag_dynforward(
_tmp1D3,sizeof(char),_get_zero_arr_size_char(_tmp1D3,52)))),_tag_dynforward(
_tmp1D2,sizeof(void*),0)));}{struct Cyc_List_List*_tmp12D=0;_npop_handler(0);
return _tmp12D;}}if(_tmpCA != 0){{const char*_tmp1D7;void*_tmp1D6[1];struct Cyc_String_pa_struct
_tmp1D5;(_tmp1D5.tag=0,((_tmp1D5.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)Cyc_implode(_tmpCA)),((_tmp1D6[0]=& _tmp1D5,Cyc_Tcutil_terr(loc,((
_tmp1D7="width '%s' not allowed with %%%%",_tag_dynforward(_tmp1D7,sizeof(char),
_get_zero_arr_size_char(_tmp1D7,33)))),_tag_dynforward(_tmp1D6,sizeof(void*),1)))))));}{
...
0,((_tmp1D9.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_implode(_tmpCB)),((
_tmp1DA[0]=& _tmp1D9,Cyc_Tcutil_terr(loc,((_tmp1DB="length modifier '%s' not allowed with %%%%",
_tag_dynforward(_tmp1DB,sizeof(char),_get_zero_arr_size_char(_tmp1DB,43)))),
_tag_dynforward(_tmp1DA,sizeof(void*),1)))))));}{struct Cyc_List_List*_tmp135=0;
