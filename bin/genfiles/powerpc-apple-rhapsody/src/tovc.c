...
struct Cyc_Tovc_BoxingEnv env,struct Cyc_Absyn_Exp*e);static void Cyc_Tovc_box_free_vars_exp(
...
_tmpF7.f1=(struct _dynforward_ptr)((_tmpF4.tag=0,((_tmpF4.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)*_tmp4),((_tmpF5[0]=& _tmpF4,Cyc_aprintf(((
_tmpF6="unbound variable %s found in box_free_vars_exp",_tag_dynforward(_tmpF6,
sizeof(char),_get_zero_arr_size_char(_tmpF6,47)))),_tag_dynforward(_tmpF5,
sizeof(void*),1)))))))),_tmpF7)))),_tmpF3)))));}}return;_LL3: if(*((int*)_tmp0)!= 
1)goto _LL5;_LL4: return;_LL5: if(*((int*)_tmp0)!= 0)goto _LL7;_LL6: return;_LL7: if(*((
int*)_tmp0)!= 11)goto _LL9;_tmp5=((struct Cyc_Absyn_FnCall_e_struct*)_tmp0)->f1;
_tmp6=((struct Cyc_Absyn_FnCall_e_struct*)_tmp0)->f2;_LL8: Cyc_Tovc_box_free_vars_exp(
...
env,(*((struct _tuple4*)_tmp1E->hd)).f2);}return;_LL33:;_LL34: {struct Cyc_Core_Impossible_struct
_tmpFD;const char*_tmpFC;struct Cyc_Core_Impossible_struct*_tmpFB;(int)_throw((
void*)((_tmpFB=_cycalloc(sizeof(*_tmpFB)),((_tmpFB[0]=((_tmpFD.tag=Cyc_Core_Impossible,((
_tmpFD.f1=((_tmpFC="bad exp form in Tocv::box_free_vars_exp",_tag_dynforward(
_tmpFC,sizeof(char),_get_zero_arr_size_char(_tmpFC,40)))),_tmpFD)))),_tmpFB)))));}
_LL0:;}}static void Cyc_Tovc_box_free_vars_stmt(struct Cyc_Tovc_BoxingEnv env,struct
Cyc_Absyn_Stmt*s);static void Cyc_Tovc_box_free_vars_stmt(struct Cyc_Tovc_BoxingEnv
...
env.varmap=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _dynforward_ptr*))
...
_tag_dynforward(_tmp103,sizeof(char),_get_zero_arr_size_char(_tmp103,28)))),
_tmp104)))),_tmp102)))));}_LL3A:;}}static int Cyc_Tovc_stmt_to_fun_cmp(struct Cyc_Absyn_Vardecl*
x,struct Cyc_Absyn_Vardecl*y);static int Cyc_Tovc_stmt_to_fun_cmp(struct Cyc_Absyn_Vardecl*
...
s,void*rettype);static struct Cyc_Absyn_Exp*Cyc_Tovc_stmt_to_fun(struct Cyc_Tovc_ToExpEnv
...
_tmp105;struct Cyc_Tovc_BoxingEnv _tmp48=(_tmp105.rgn=env.rgn,((_tmp105.all_locals=
env.all_locals,((_tmp105.varmap=env.varmap,((_tmp105.boundvars=0,((_tmp105.freevars=&
freevars,_tmp105)))))))));Cyc_Tovc_box_free_vars_stmt(_tmp48,s);{struct Cyc_List_List*
params=0;struct Cyc_List_List*args=0;struct Cyc_Iter_Iter _tmp49=((struct Cyc_Iter_Iter(*)(
struct _RegionHandle*rgn,struct Cyc_Set_Set*s))Cyc_Set_make_iter)(Cyc_Core_heap_region,
freevars);struct Cyc_Absyn_Vardecl*_tmp106;struct Cyc_Absyn_Vardecl*_tmp4A=(
_tmp106=_cycalloc(sizeof(*_tmp106)),((_tmp106->sc=(void*)((void*)2),((_tmp106->name=
Cyc_Absyn_exn_name,((_tmp106->tq=Cyc_Absyn_empty_tqual(0),((_tmp106->type=(void*)((
void*)0),((_tmp106->initializer=0,((_tmp106->rgn=0,((_tmp106->attributes=0,((
_tmp106->escapes=0,_tmp106)))))))))))))))));while(((int(*)(struct Cyc_Iter_Iter,
struct Cyc_Absyn_Vardecl**))Cyc_Iter_next)(_tmp49,& _tmp4A)){void*_tmp4B=(void*)
_tmp4A->type;struct Cyc_Absyn_ArrayInfo _tmp4C;void*_tmp4D;_LL5F: if(_tmp4B <= (void*)
4)goto _LL61;if(*((int*)_tmp4B)!= 7)goto _LL61;_tmp4C=((struct Cyc_Absyn_ArrayType_struct*)
_tmp4B)->f1;_tmp4D=(void*)_tmp4C.elt_type;_LL60:{struct _tuple5*_tmp109;struct Cyc_List_List*
_tmp108;params=((_tmp108=_cycalloc(sizeof(*_tmp108)),((_tmp108->hd=((_tmp109=
_cycalloc(sizeof(*_tmp109)),((_tmp109->f1=(*_tmp4A->name).f2,((_tmp109->f2=
_tmp4A->tq,((_tmp109->f3=Cyc_Absyn_cstar_typ(_tmp4D,Cyc_Absyn_empty_tqual(0)),
_tmp109)))))))),((_tmp108->tl=params,_tmp108))))));}{struct Cyc_List_List*_tmp10A;
args=((_tmp10A=_cycalloc(sizeof(*_tmp10A)),((_tmp10A->hd=Cyc_Absyn_var_exp(
_tmp4A->name,0),((_tmp10A->tl=args,_tmp10A))))));}goto _LL5E;_LL61:;_LL62:{struct
_tuple5*_tmp10D;struct Cyc_List_List*_tmp10C;params=((_tmp10C=_cycalloc(sizeof(*
_tmp10C)),((_tmp10C->hd=((_tmp10D=_cycalloc(sizeof(*_tmp10D)),((_tmp10D->f1=(*
_tmp4A->name).f2,((_tmp10D->f2=_tmp4A->tq,((_tmp10D->f3=Cyc_Absyn_cstar_typ((
void*)_tmp4A->type,Cyc_Absyn_empty_tqual(0)),_tmp10D)))))))),((_tmp10C->tl=
params,_tmp10C))))));}{struct Cyc_List_List*_tmp10E;args=((_tmp10E=_cycalloc(
sizeof(*_tmp10E)),((_tmp10E->hd=Cyc_Absyn_address_exp(Cyc_Absyn_var_exp(_tmp4A->name,
0),0),((_tmp10E->tl=args,_tmp10E))))));}goto _LL5E;_LL5E:;}{struct _tuple1*funname=
Cyc_Toc_temp_var();{struct Cyc_Absyn_Fn_d_struct*_tmp118;struct Cyc_Absyn_Fndecl*
_tmp117;struct Cyc_Absyn_Fn_d_struct _tmp116;struct Cyc_List_List*_tmp115;*env.gen_ds=((
_tmp115=_cycalloc(sizeof(*_tmp115)),((_tmp115->hd=Cyc_Absyn_new_decl((void*)((
_tmp118=_cycalloc(sizeof(*_tmp118)),((_tmp118[0]=((_tmp116.tag=1,((_tmp116.f1=((
_tmp117=_cycalloc(sizeof(*_tmp117)),((_tmp117->sc=(void*)((void*)0),((_tmp117->is_inline=
0,((_tmp117->name=funname,((_tmp117->tvs=0,((_tmp117->effect=0,((_tmp117->ret_type=(
void*)rettype,((_tmp117->args=params,((_tmp117->c_varargs=0,((_tmp117->cyc_varargs=
0,((_tmp117->rgn_po=0,((_tmp117->body=s,((_tmp117->cached_typ=0,((_tmp117->param_vardecls=
0,((_tmp117->fn_vardecl=0,((_tmp117->attributes=0,_tmp117)))))))))))))))))))))))))))))))),
_tmp116)))),_tmp118)))),0),((_tmp115->tl=*env.gen_ds,_tmp115))))));}return Cyc_Absyn_fncall_exp(
...
_tmp11E.f1=((_tmp11D="bad exp form in Tocv::apply_varmap",_tag_dynforward(
_tmp11D,sizeof(char),_get_zero_arr_size_char(_tmp11D,35)))),_tmp11E)))),_tmp11C)))));}
_LL63:;}static struct Cyc_Absyn_Exp*Cyc_Tovc_stmt_to_exp(struct Cyc_Tovc_ToExpEnv
env,struct Cyc_Absyn_Stmt*s);static struct Cyc_Absyn_Exp*Cyc_Tovc_stmt_to_exp(
...
_tmp126.f1=((_tmp125="bad local decl in Tovc::stmt_to_exp",_tag_dynforward(
_tmp125,sizeof(char),_get_zero_arr_size_char(_tmp125,36)))),_tmp126)))),_tmp124)))));}
...
Cyc_Tovc_stmt_to_exp(env,_tmpAE))->r));return;_LLE2:;_LLE3: {struct Cyc_Core_Impossible_struct
_tmp12C;const char*_tmp12B;struct Cyc_Core_Impossible_struct*_tmp12A;(int)_throw((
void*)((_tmp12A=_cycalloc(sizeof(*_tmp12A)),((_tmp12A[0]=((_tmp12C.tag=Cyc_Core_Impossible,((
_tmp12C.f1=((_tmp12B="bad exp form after xlation to C",_tag_dynforward(_tmp12B,
sizeof(char),_get_zero_arr_size_char(_tmp12B,32)))),_tmp12C)))),_tmp12A)))));}
_LLAF:;}static void Cyc_Tovc_stmt_to_vc(struct Cyc_Tovc_ToExpEnv env,struct Cyc_Absyn_Stmt*
s);static void Cyc_Tovc_stmt_to_vc(struct Cyc_Tovc_ToExpEnv env,struct Cyc_Absyn_Stmt*
s){while(1){env.encloser=s;{void*_tmpB2=(void*)s->r;struct Cyc_Absyn_Stmt*_tmpB3;
...
_tag_dynforward(_tmp131,sizeof(char),_get_zero_arr_size_char(_tmp131,27)))),
_tmp132)))),_tmp130)))));}_LL10D:;}goto _LL108;_LL10B:;_LL10C: goto _LL108;_LL108:;}
if(_tmpCC->initializer != 0)Cyc_Tovc_exp_to_vc(env,(struct Cyc_Absyn_Exp*)
_check_null(_tmpCC->initializer));{struct Cyc_List_List*_tmp133;env.all_locals=((
_tmp133=_region_malloc(env.rgn,sizeof(*_tmp133)),((_tmp133->hd=_tmpCC,((_tmp133->tl=
env.all_locals,_tmp133))))));}s=_tmpCA;continue;_LL106:;_LL107: goto _LL103;_LL103:;}
goto _LL102;_LL101:;_LL102: {struct Cyc_Core_Impossible_struct _tmp139;const char*
_tmp138;struct Cyc_Core_Impossible_struct*_tmp137;(int)_throw((void*)((_tmp137=
_cycalloc(sizeof(*_tmp137)),((_tmp137[0]=((_tmp139.tag=Cyc_Core_Impossible,((
_tmp139.f1=((_tmp138="bad stmt after xlation to C",_tag_dynforward(_tmp138,
sizeof(char),_get_zero_arr_size_char(_tmp138,28)))),_tmp139)))),_tmp137)))));}
...
_LL114: _tmpDA->cached_typ=0;{struct Cyc_Absyn_Vardecl*_tmp13A;struct Cyc_Absyn_Vardecl*
vd=(_tmp13A=_cycalloc(sizeof(*_tmp13A)),((_tmp13A->sc=(void*)((void*)_tmpDA->sc),((
_tmp13A->name=_tmpDA->name,((_tmp13A->tq=Cyc_Absyn_const_tqual(0),((_tmp13A->type=(
void*)Cyc_Tcutil_fndecl2typ(_tmpDA),((_tmp13A->initializer=0,((_tmp13A->rgn=0,((
_tmp13A->attributes=_tmpDA->attributes,((_tmp13A->escapes=0,_tmp13A)))))))))))))))));{
struct Cyc_Absyn_Var_d_struct*_tmp140;struct Cyc_Absyn_Var_d_struct _tmp13F;struct
Cyc_List_List*_tmp13E;_tmpD7=((_tmp13E=_cycalloc(sizeof(*_tmp13E)),((_tmp13E->hd=
Cyc_Absyn_new_decl((void*)((_tmp140=_cycalloc(sizeof(*_tmp140)),((_tmp140[0]=((
_tmp13F.tag=0,((_tmp13F.f1=vd,_tmp13F)))),_tmp140)))),0),((_tmp13E->tl=_tmpD7,
_tmp13E))))));}{struct _RegionHandle _tmpE2=_new_region("rgn");struct _RegionHandle*
rgn=& _tmpE2;_push_region(rgn);{struct Cyc_List_List**_tmp141;struct Cyc_List_List**
_tmpE3=(_tmp141=_region_malloc(rgn,sizeof(*_tmp141)),((_tmp141[0]=0,_tmp141)));{
struct Cyc_Tovc_ToExpEnv _tmp142;Cyc_Tovc_stmt_to_vc(((_tmp142.rgn=rgn,((_tmp142.all_locals=((
...
_dynforward_ptr*,struct _dynforward_ptr*)))Cyc_Dict_rempty)(rgn,Cyc_strptrcmp),((
...
_tag_dynforward(_tmp148,sizeof(char),_get_zero_arr_size_char(_tmp148,47)))),
_tmp149)))),_tmp147)))));}_LL112:;}return((struct Cyc_List_List*(*)(struct Cyc_List_List*
