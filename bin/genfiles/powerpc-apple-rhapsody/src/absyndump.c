...
Cyc_Absyndump_dump_char((int)'_');else{const char*_tmp2D5;Cyc_Absyndump_dump_nospace(((
_tmp2D5="::",_tag_dyneither(_tmp2D5,sizeof(char),3))));}}if(_tmp1 != 0){Cyc_Absyndump_dump_nospace(*((
...
_tmp2D6;Cyc_Absyndump_dump_nospace(((_tmp2D6="::",_tag_dyneither(_tmp2D6,sizeof(
char),3))));}Cyc_Absyndump_dump_nospace(*((struct _dyneither_ptr*)_tmp1->hd));}
if(Cyc_Absyndump_qvar_to_Cids){const char*_tmp2D7;Cyc_Absyndump_dump_nospace(((
_tmp2D7="_",_tag_dyneither(_tmp2D7,sizeof(char),2))));}else{const char*_tmp2D8;
Cyc_Absyndump_dump_nospace(((_tmp2D8="::",_tag_dyneither(_tmp2D8,sizeof(char),3))));}
...
const char*_tmp2D9;Cyc_Absyndump_dump(((_tmp2D9="restrict",_tag_dyneither(_tmp2D9,
sizeof(char),9))));}if(tq.q_volatile){const char*_tmp2DA;Cyc_Absyndump_dump(((
_tmp2DA="volatile",_tag_dyneither(_tmp2DA,sizeof(char),9))));}if(tq.print_const){
const char*_tmp2DB;Cyc_Absyndump_dump(((_tmp2DB="const",_tag_dyneither(_tmp2DB,
...
_tmp2DC;Cyc_Absyndump_dump(((_tmp2DC="static",_tag_dyneither(_tmp2DC,sizeof(char),
7))));}return;_LL1A: if((int)_tmpD != 2)goto _LL1C;_LL1B: return;_LL1C: if((int)_tmpD
!= 3)goto _LL1E;_LL1D:{const char*_tmp2DD;Cyc_Absyndump_dump(((_tmp2DD="extern",
_tag_dyneither(_tmp2DD,sizeof(char),7))));}return;_LL1E: if((int)_tmpD != 4)goto
_LL20;_LL1F:{const char*_tmp2DE;Cyc_Absyndump_dump(((_tmp2DE="extern \"C\"",
_tag_dyneither(_tmp2DE,sizeof(char),11))));}return;_LL20: if((int)_tmpD != 1)goto
_LL22;_LL21:{const char*_tmp2DF;Cyc_Absyndump_dump(((_tmp2DF="abstract",
_tag_dyneither(_tmp2DF,sizeof(char),9))));}return;_LL22: if((int)_tmpD != 5)goto
_LL17;_LL23:{const char*_tmp2E0;Cyc_Absyndump_dump(((_tmp2E0="register",
_tag_dyneither(_tmp2E0,sizeof(char),9))));}return;_LL17:;}void Cyc_Absyndump_dumpkind(
void*k);void Cyc_Absyndump_dumpkind(void*k){void*_tmp13=k;_LL25: if((int)_tmp13 != 
0)goto _LL27;_LL26:{const char*_tmp2E1;Cyc_Absyndump_dump(((_tmp2E1="A",
_tag_dyneither(_tmp2E1,sizeof(char),2))));}return;_LL27: if((int)_tmp13 != 1)goto
_LL29;_LL28:{const char*_tmp2E2;Cyc_Absyndump_dump(((_tmp2E2="M",_tag_dyneither(
_tmp2E2,sizeof(char),2))));}return;_LL29: if((int)_tmp13 != 2)goto _LL2B;_LL2A:{
const char*_tmp2E3;Cyc_Absyndump_dump(((_tmp2E3="B",_tag_dyneither(_tmp2E3,
sizeof(char),2))));}return;_LL2B: if((int)_tmp13 != 3)goto _LL2D;_LL2C:{const char*
_tmp2E4;Cyc_Absyndump_dump(((_tmp2E4="R",_tag_dyneither(_tmp2E4,sizeof(char),2))));}
return;_LL2D: if((int)_tmp13 != 4)goto _LL2F;_LL2E:{const char*_tmp2E5;Cyc_Absyndump_dump(((
_tmp2E5="UR",_tag_dyneither(_tmp2E5,sizeof(char),3))));}return;_LL2F: if((int)
_tmp13 != 5)goto _LL31;_LL30:{const char*_tmp2E6;Cyc_Absyndump_dump(((_tmp2E6="TR",
_tag_dyneither(_tmp2E6,sizeof(char),3))));}return;_LL31: if((int)_tmp13 != 6)goto
_LL33;_LL32:{const char*_tmp2E7;Cyc_Absyndump_dump(((_tmp2E7="E",_tag_dyneither(
_tmp2E7,sizeof(char),2))));}return;_LL33: if((int)_tmp13 != 7)goto _LL24;_LL34:{
const char*_tmp2E8;Cyc_Absyndump_dump(((_tmp2E8="I",_tag_dyneither(_tmp2E8,
...
_LL38;_LL37:{const char*_tmp2E9;Cyc_Absyndump_dump(((_tmp2E9="struct",
_tag_dyneither(_tmp2E9,sizeof(char),7))));}return;_LL38: if((int)_tmp1C != 1)goto
_LL35;_LL39:{const char*_tmp2EA;Cyc_Absyndump_dump(((_tmp2EA="union",
_tag_dyneither(_tmp2EA,sizeof(char),6))));}return;_LL35:;}void Cyc_Absyndump_dumptps(
struct Cyc_List_List*ts);void Cyc_Absyndump_dumptps(struct Cyc_List_List*ts){const
char*_tmp2ED;const char*_tmp2EC;const char*_tmp2EB;Cyc_Absyndump_egroup(Cyc_Absyndump_dumptyp,
ts,((_tmp2EB="<",_tag_dyneither(_tmp2EB,sizeof(char),2))),((_tmp2EC=">",
_tag_dyneither(_tmp2EC,sizeof(char),2))),((_tmp2ED=",",_tag_dyneither(_tmp2ED,
...
_tmp22)!= 1)goto _LL41;_LL40:{const char*_tmp2EE;Cyc_Absyndump_dump(((_tmp2EE="::?",
_tag_dyneither(_tmp2EE,sizeof(char),4))));}goto _LL3A;_LL41: if(*((int*)_tmp22)!= 
0)goto _LL3A;_tmp24=(void*)((struct Cyc_Absyn_Eq_kb_struct*)_tmp22)->f1;_LL42:{
const char*_tmp2EF;Cyc_Absyndump_dump(((_tmp2EF="::",_tag_dyneither(_tmp2EF,
...
const char*_tmp2F2;const char*_tmp2F1;const char*_tmp2F0;((void(*)(void(*f)(struct
...
tvs,((_tmp2F0="<",_tag_dyneither(_tmp2F0,sizeof(char),2))),((_tmp2F1=">",
_tag_dyneither(_tmp2F1,sizeof(char),2))),((_tmp2F2=",",_tag_dyneither(_tmp2F2,
sizeof(char),2))));}void Cyc_Absyndump_dumpkindedtvars(struct Cyc_List_List*tvs);
void Cyc_Absyndump_dumpkindedtvars(struct Cyc_List_List*tvs){const char*_tmp2F5;
const char*_tmp2F4;const char*_tmp2F3;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),
struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct
_dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,tvs,((
_tmp2F3="<",_tag_dyneither(_tmp2F3,sizeof(char),2))),((_tmp2F4=">",
_tag_dyneither(_tmp2F4,sizeof(char),2))),((_tmp2F5=",",_tag_dyneither(_tmp2F5,
...
ts);void Cyc_Absyndump_dumpargs(struct Cyc_List_List*ts){const char*_tmp2F8;const
char*_tmp2F7;const char*_tmp2F6;((void(*)(void(*f)(struct _tuple14*),struct Cyc_List_List*
l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumparg,ts,((_tmp2F6="(",_tag_dyneither(_tmp2F6,sizeof(char),2))),((
_tmp2F7=")",_tag_dyneither(_tmp2F7,sizeof(char),2))),((_tmp2F8=",",
_tag_dyneither(_tmp2F8,sizeof(char),2))));}void Cyc_Absyndump_dump_callconv(
...
_tmp30 != 0)goto _LL46;_LL45:{const char*_tmp2F9;Cyc_Absyndump_dump(((_tmp2F9="_stdcall",
_tag_dyneither(_tmp2F9,sizeof(char),9))));}return;_LL46: if((int)_tmp30 != 1)goto
_LL48;_LL47:{const char*_tmp2FA;Cyc_Absyndump_dump(((_tmp2FA="_cdecl",
_tag_dyneither(_tmp2FA,sizeof(char),7))));}return;_LL48: if((int)_tmp30 != 2)goto
_LL4A;_LL49:{const char*_tmp2FB;Cyc_Absyndump_dump(((_tmp2FB="_fastcall",
_tag_dyneither(_tmp2FB,sizeof(char),10))));}return;_LL4A:;_LL4B: goto _LL43;_LL43:;}}
...
_tmp2FC;Cyc_Absyndump_dump(((_tmp2FC="__declspec(",_tag_dyneither(_tmp2FC,
...
const char*_tmp2FD;Cyc_Absyndump_dump(((_tmp2FD=" __attribute__((",_tag_dyneither(
_tmp2FD,sizeof(char),17))));}for(0;atts != 0;atts=atts->tl){Cyc_Absyndump_dump(
Cyc_Absyn_attribute2string((void*)atts->hd));if(atts->tl != 0){const char*_tmp2FE;
Cyc_Absyndump_dump(((_tmp2FE=",",_tag_dyneither(_tmp2FE,sizeof(char),2))));}}{
const char*_tmp2FF;Cyc_Absyndump_dump(((_tmp2FF=")) ",_tag_dyneither(_tmp2FF,
...
_tmp3C != 2)goto _LL6B;_LL6A:{const char*_tmp300;Cyc_Absyndump_dump(((_tmp300="`H",
_tag_dyneither(_tmp300,sizeof(char),3))));}goto _LL68;_LL6B:;_LL6C: Cyc_Absyndump_dumpntyp(
...
struct Cyc_List_List*_tmp301;rgions=((_tmp301=_cycalloc(sizeof(*_tmp301)),((
_tmp301->hd=(void*)_tmp3F,((_tmp301->tl=rgions,_tmp301))))));}goto _LL6D;_LL70:
...
_LL73:{struct Cyc_List_List*_tmp302;effects=((_tmp302=_cycalloc(sizeof(*_tmp302)),((
_tmp302->hd=(void*)t,((_tmp302->tl=effects,_tmp302))))));}goto _LL6D;_LL6D:;}{
struct _tuple15 _tmp303;return(_tmp303.f1=rgions,((_tmp303.f2=effects,_tmp303)));}}
...
_LL7A: return;_LL7B: if((int)_tmp4A != 0)goto _LL7D;_LL7C:{const char*_tmp304;Cyc_Absyndump_dump(((
_tmp304="void",_tag_dyneither(_tmp304,sizeof(char),5))));}return;_LL7D: if(_tmp4A
...
Cyc_Absyn_Evar_struct*)_tmp4A)->f3;_LL80:{const char*_tmp305;Cyc_Absyndump_dump(((
_tmp305="%",_tag_dyneither(_tmp305,sizeof(char),2))));}if(_tmp4C == 0){const char*
_tmp306;Cyc_Absyndump_dump(((_tmp306="?",_tag_dyneither(_tmp306,sizeof(char),2))));}
else{Cyc_Absyndump_dumpkind((void*)_tmp4C->v);}{const char*_tmp30A;void*_tmp309[1];
struct Cyc_Int_pa_struct _tmp308;Cyc_Absyndump_dump((struct _dyneither_ptr)((
_tmp308.tag=1,((_tmp308.f1=(unsigned long)_tmp4E,((_tmp309[0]=& _tmp308,Cyc_aprintf(((
_tmp30A="(%d)",_tag_dyneither(_tmp30A,sizeof(char),5))),_tag_dyneither(_tmp309,
...
_tmp97=_tmp95.is_extensible;_LLCB: if(_tmp97){const char*_tmp30B;Cyc_Absyndump_dump(((
_tmp30B="@extensible ",_tag_dyneither(_tmp30B,sizeof(char),13))));}{const char*
_tmp30C;Cyc_Absyndump_dump(((_tmp30C="datatype ",_tag_dyneither(_tmp30C,sizeof(
...
_LLCF:;_LLD0: Cyc_Absyndump_dumptyp(r);{const char*_tmp30D;Cyc_Absyndump_dump(((
_tmp30D=" ",_tag_dyneither(_tmp30D,sizeof(char),2))));}goto _LLCC;_LLCC:;}Cyc_Absyndump_dumpqvar(
...
_tmpA1.f2;_tmpA7=*_tmpA6;_tmpA8=_tmpA7.name;_LLD5: if(_tmpA5){const char*_tmp30E;
Cyc_Absyndump_dump(((_tmp30E="@extensible ",_tag_dyneither(_tmp30E,sizeof(char),
13))));}{const char*_tmp30F;Cyc_Absyndump_dump(((_tmp30F="datatype ",
_tag_dyneither(_tmp30F,sizeof(char),10))));}Cyc_Absyndump_dumpqvar(_tmpA4);{
const char*_tmp310;Cyc_Absyndump_dump(((_tmp310=".",_tag_dyneither(_tmp310,
...
_tmp4A)->f2;if((int)_tmp5E != 2)goto _LL8B;_LL8A:{const char*_tmp311;Cyc_Absyndump_dump(((
_tmp311="int",_tag_dyneither(_tmp311,sizeof(char),4))));}return;_LL8B: if(*((int*)
...
if((int)_tmp62 != 3)goto _LL8F;_LL8E:{const char*_tmp312;Cyc_Absyndump_dump(((
_tmp312="long",_tag_dyneither(_tmp312,sizeof(char),5))));}return;_LL8F: if(*((int*)
...
_tmp4A)->f2;if((int)_tmp64 != 0)goto _LL91;_LL90:{const char*_tmp313;Cyc_Absyndump_dump(((
_tmp313="char",_tag_dyneither(_tmp313,sizeof(char),5))));}return;_LL91: if(*((int*)
...
_tmp4A)->f2;if((int)_tmp66 != 0)goto _LL93;_LL92:{const char*_tmp314;Cyc_Absyndump_dump(((
_tmp314="signed char",_tag_dyneither(_tmp314,sizeof(char),12))));}return;_LL93:
...
_tmp4A)->f2;if((int)_tmp68 != 0)goto _LL95;_LL94:{const char*_tmp315;Cyc_Absyndump_dump(((
_tmp315="unsigned char",_tag_dyneither(_tmp315,sizeof(char),14))));}return;_LL95:
...
if((int)_tmp6C != 1)goto _LL99;_LL98:{const char*_tmp316;Cyc_Absyndump_dump(((
_tmp316="short",_tag_dyneither(_tmp316,sizeof(char),6))));}return;_LL99: if(*((
...
_tmp4A)->f2;if((int)_tmp6E != 1)goto _LL9B;_LL9A:{const char*_tmp317;Cyc_Absyndump_dump(((
_tmp317="unsigned short",_tag_dyneither(_tmp317,sizeof(char),15))));}return;
...
_tmp4A)->f2;if((int)_tmp70 != 2)goto _LL9D;_LL9C:{const char*_tmp318;Cyc_Absyndump_dump(((
_tmp318="unsigned int",_tag_dyneither(_tmp318,sizeof(char),13))));}return;_LL9D:
...
_tmp4A)->f2;if((int)_tmp72 != 3)goto _LL9F;_LL9E:{const char*_tmp319;Cyc_Absyndump_dump(((
_tmp319="unsigned long",_tag_dyneither(_tmp319,sizeof(char),14))));}return;_LL9F:
...
if((int)_tmpB5 != 0)goto _LLD9;_LLD8:{const char*_tmp31A;Cyc_Absyndump_dump(((
_tmp31A="long long",_tag_dyneither(_tmp31A,sizeof(char),10))));}return;_LLD9: if((
int)_tmpB5 != 1)goto _LLD6;_LLDA:{const char*_tmp31B;Cyc_Absyndump_dump(((_tmp31B="__int64",
_tag_dyneither(_tmp31B,sizeof(char),8))));}return;_LLD6:;}_LLA3: if(*((int*)
...
_LLDC: if((int)_tmpB8 != 1)goto _LLDE;_LLDD:{const char*_tmp31C;Cyc_Absyndump_dump(((
_tmp31C="unsigned __int64",_tag_dyneither(_tmp31C,sizeof(char),17))));}return;
_LLDE: if((int)_tmpB8 != 0)goto _LLDB;_LLDF:{const char*_tmp31D;Cyc_Absyndump_dump(((
_tmp31D="unsigned long long",_tag_dyneither(_tmp31D,sizeof(char),19))));}return;
_LLDB:;}_LLA5: if((int)_tmp4A != 1)goto _LLA7;_LLA6:{const char*_tmp31E;Cyc_Absyndump_dump(((
_tmp31E="float",_tag_dyneither(_tmp31E,sizeof(char),6))));}return;_LLA7: if(
_tmp4A <= (void*)4)goto _LLBD;if(*((int*)_tmp4A)!= 6)goto _LLA9;_tmp79=((struct Cyc_Absyn_DoubleType_struct*)
_tmp4A)->f1;_LLA8: if(_tmp79){const char*_tmp31F;Cyc_Absyndump_dump(((_tmp31F="long double",
_tag_dyneither(_tmp31F,sizeof(char),12))));}else{const char*_tmp320;Cyc_Absyndump_dump(((
_tmp320="double",_tag_dyneither(_tmp320,sizeof(char),7))));}return;_LLA9: if(*((
...
_tmp80=((struct Cyc_Absyn_EnumType_struct*)_tmp4A)->f1;_LLB0:{const char*_tmp321;
Cyc_Absyndump_dump(((_tmp321="enum ",_tag_dyneither(_tmp321,sizeof(char),6))));}
...
_tmp322;Cyc_Absyndump_dump(((_tmp322="enum {",_tag_dyneither(_tmp322,sizeof(char),
7))));}Cyc_Absyndump_dumpenumfields(_tmp81);{const char*_tmp323;Cyc_Absyndump_dump(((
_tmp323="}",_tag_dyneither(_tmp323,sizeof(char),2))));}return;_LLB3: if(*((int*)
...
_tmp324;Cyc_Absyndump_dump(((_tmp324="valueof_t(",_tag_dyneither(_tmp324,sizeof(
char),11))));}Cyc_Absyndump_dumpexp(_tmp84);{const char*_tmp325;Cyc_Absyndump_dump(((
_tmp325=")",_tag_dyneither(_tmp325,sizeof(char),2))));}return;_LLB7: if(*((int*)
_tmp4A)!= 14)goto _LLB9;_tmp85=(void*)((struct Cyc_Absyn_RgnHandleType_struct*)
_tmp4A)->f1;_LLB8:{const char*_tmp326;Cyc_Absyndump_dump(((_tmp326="region_t<",
_tag_dyneither(_tmp326,sizeof(char),10))));}Cyc_Absyndump_dumprgn(_tmp85);{const
char*_tmp327;Cyc_Absyndump_dump(((_tmp327=">",_tag_dyneither(_tmp327,sizeof(char),
...
const char*_tmp328;Cyc_Absyndump_dump(((_tmp328="dynregion_t<",_tag_dyneither(
_tmp328,sizeof(char),13))));}Cyc_Absyndump_dumprgn(_tmp86);{const char*_tmp329;
Cyc_Absyndump_dump(((_tmp329=",",_tag_dyneither(_tmp329,sizeof(char),2))));}Cyc_Absyndump_dumprgn(
_tmp87);{const char*_tmp32A;Cyc_Absyndump_dump(((_tmp32A=">",_tag_dyneither(
_tmp32A,sizeof(char),2))));}return;_LLBB: if(*((int*)_tmp4A)!= 18)goto _LLBD;
_tmp88=(void*)((struct Cyc_Absyn_TagType_struct*)_tmp4A)->f1;_LLBC:{const char*
_tmp32B;Cyc_Absyndump_dump(((_tmp32B="tag_t<",_tag_dyneither(_tmp32B,sizeof(char),
7))));}Cyc_Absyndump_dumpntyp(_tmp88);{const char*_tmp32C;Cyc_Absyndump_dump(((
_tmp32C=">",_tag_dyneither(_tmp32C,sizeof(char),2))));}return;_LLBD: if((int)
_tmp4A != 3)goto _LLBF;_LLBE:{const char*_tmp32D;Cyc_Absyndump_dump(((_tmp32D="`U",
_tag_dyneither(_tmp32D,sizeof(char),3))));}goto _LL74;_LLBF: if((int)_tmp4A != 2)
...
_tmp32E;((void(*)(void(*f)(struct _tuple13*),struct Cyc_List_List*l,struct
_dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dump_rgncmp,rgn_po,((
_tmp32E=",",_tag_dyneither(_tmp32E,sizeof(char),2))));}void Cyc_Absyndump_dumpfunargs(
struct Cyc_List_List*args,int c_varargs,struct Cyc_Absyn_VarargInfo*cyc_varargs,
...
int)',');}if(c_varargs){const char*_tmp32F;Cyc_Absyndump_dump(((_tmp32F="...",
_tag_dyneither(_tmp32F,sizeof(char),4))));}else{if(cyc_varargs != 0){struct
_tuple7*_tmp330;struct _tuple7*_tmpD4=(_tmp330=_cycalloc(sizeof(*_tmp330)),((
_tmp330->f1=cyc_varargs->name,((_tmp330->f2=cyc_varargs->tq,((_tmp330->f3=
cyc_varargs->type,_tmp330)))))));{const char*_tmp331;Cyc_Absyndump_dump(((_tmp331="...",
_tag_dyneither(_tmp331,sizeof(char),4))));}if(cyc_varargs->inject){const char*
_tmp332;Cyc_Absyndump_dump(((_tmp332=" inject ",_tag_dyneither(_tmp332,sizeof(
...
struct Cyc_Absyn_ArrayElement_struct*)_tmpD8)->f1;_LLE2:{const char*_tmp333;Cyc_Absyndump_dump(((
_tmp333=".[",_tag_dyneither(_tmp333,sizeof(char),3))));}Cyc_Absyndump_dumpexp(
...
_tuple16*de);void Cyc_Absyndump_dumpde(struct _tuple16*de){{const char*_tmp336;
const char*_tmp335;const char*_tmp334;Cyc_Absyndump_egroup(Cyc_Absyndump_dumpdesignator,(*
de).f1,((_tmp334="",_tag_dyneither(_tmp334,sizeof(char),1))),((_tmp335="=",
_tag_dyneither(_tmp335,sizeof(char),2))),((_tmp336="=",_tag_dyneither(_tmp336,
...
struct Cyc_List_List*es){const char*_tmp339;const char*_tmp338;const char*_tmp337;((
...
Cyc_Absyndump_dumpexp_prec,inprec,es,((_tmp337="",_tag_dyneither(_tmp337,sizeof(
char),1))),((_tmp338="",_tag_dyneither(_tmp338,sizeof(char),1))),((_tmp339=",",
_tag_dyneither(_tmp339,sizeof(char),2))));}void Cyc_Absyndump_dumpexp_prec(int
inprec,struct Cyc_Absyn_Exp*e);void Cyc_Absyndump_dumpexp_prec(int inprec,struct Cyc_Absyn_Exp*
e){int myprec=Cyc_Absynpp_exp_prec(e);if(inprec >= myprec){const char*_tmp33A;Cyc_Absyndump_dump_nospace(((
_tmp33A="(",_tag_dyneither(_tmp33A,sizeof(char),2))));}{void*_tmpE3=e->r;union
...
_tmpEA=_tmpE9.f1;_tmpEB=_tmpE9.f2;_LLE9:{const char*_tmp33E;void*_tmp33D[1];
struct Cyc_Int_pa_struct _tmp33C;Cyc_Absyndump_dump((struct _dyneither_ptr)((
_tmp33C.tag=1,((_tmp33C.f1=(unsigned long)((int)_tmpEB),((_tmp33D[0]=& _tmp33C,
Cyc_aprintf(((_tmp33E="%d",_tag_dyneither(_tmp33E,sizeof(char),3))),
_tag_dyneither(_tmp33D,sizeof(void*),1)))))))));}goto _LLE5;_LLEA: if(*((int*)
...
_tmp342;void*_tmp341[1];struct Cyc_Int_pa_struct _tmp340;Cyc_Absyndump_dump((
struct _dyneither_ptr)((_tmp340.tag=1,((_tmp340.f1=(unsigned long)_tmpF3,((
_tmp341[0]=& _tmp340,Cyc_aprintf(((_tmp342="%d",_tag_dyneither(_tmp342,sizeof(
char),3))),_tag_dyneither(_tmp341,sizeof(void*),1)))))))));}goto _LLE5;_LLEE: if(*((
...
_tmp346;void*_tmp345[1];struct Cyc_Int_pa_struct _tmp344;Cyc_Absyndump_dump((
struct _dyneither_ptr)((_tmp344.tag=1,((_tmp344.f1=(unsigned int)_tmpF7,((_tmp345[
0]=& _tmp344,Cyc_aprintf(((_tmp346="%u",_tag_dyneither(_tmp346,sizeof(char),3))),
_tag_dyneither(_tmp345,sizeof(void*),1)))))))));}goto _LLE5;_LLF0: if(*((int*)
...
_tmpFA=_tmpF9.f1;_tmpFB=_tmpF9.f2;_LLF1:{const char*_tmp347;Cyc_Absyndump_dump(((
_tmp347="<<FIX LONG LONG CONSTANT>>",_tag_dyneither(_tmp347,sizeof(char),27))));}
...
char*_tmp348;Cyc_Absyndump_dump(((_tmp348="NULL",_tag_dyneither(_tmp348,sizeof(
...
if(_tmp104 == (void*)((void*)19)){{const char*_tmp349;Cyc_Absyndump_dump(((_tmp349="numelts(",
_tag_dyneither(_tmp349,sizeof(char),9))));}Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)((
struct Cyc_List_List*)_check_null(_tmp105))->hd);{const char*_tmp34A;Cyc_Absyndump_dump(((
_tmp34A=")",_tag_dyneither(_tmp34A,sizeof(char),2))));}}else{Cyc_Absyndump_dump(
...
break;default: _LL152: {struct Cyc_Core_Failure_struct _tmp350;const char*_tmp34F;
struct Cyc_Core_Failure_struct*_tmp34E;(int)_throw((void*)((_tmp34E=_cycalloc(
sizeof(*_tmp34E)),((_tmp34E[0]=((_tmp350.tag=Cyc_Core_Failure,((_tmp350.f1=((
_tmp34F="Absyndump -- Bad number of arguments to primop",_tag_dyneither(_tmp34F,
sizeof(char),47))),_tmp350)))),_tmp34E)))));}}goto _LLE5;}_LLFE: if(*((int*)_tmpE3)
...
Cyc_Absynpp_prim2str((void*)_tmp107->v));{const char*_tmp351;Cyc_Absyndump_dump_nospace(((
_tmp351="=",_tag_dyneither(_tmp351,sizeof(char),2))));}Cyc_Absyndump_dumpexp_prec(
...
_tmpE3)->f2;if((int)_tmp10A != 0)goto _LL102;_LL101:{const char*_tmp352;Cyc_Absyndump_dump(((
...
_tmpE3)->f2;if((int)_tmp10C != 2)goto _LL104;_LL103:{const char*_tmp353;Cyc_Absyndump_dump(((
_tmp353="--",_tag_dyneither(_tmp353,sizeof(char),3))));}Cyc_Absyndump_dumpexp_prec(
...
myprec,_tmp10D);{const char*_tmp354;Cyc_Absyndump_dump(((_tmp354="++",
_tag_dyneither(_tmp354,sizeof(char),3))));}goto _LLE5;_LL106: if(*((int*)_tmpE3)!= 
...
_LL108;_LL107: Cyc_Absyndump_dumpexp_prec(myprec,_tmp10F);{const char*_tmp355;Cyc_Absyndump_dump(((
_tmp355="--",_tag_dyneither(_tmp355,sizeof(char),3))));}goto _LLE5;_LL108: if(*((
...
myprec,_tmp114);{const char*_tmp356;Cyc_Absyndump_dump(((_tmp356=" && ",
...
myprec,_tmp116);{const char*_tmp357;Cyc_Absyndump_dump(((_tmp357=" || ",
_tag_dyneither(_tmp357,sizeof(char),5))));}Cyc_Absyndump_dumpexp_prec(myprec,
...
_tmp11C);{const char*_tmp358;Cyc_Absyndump_dump_nospace(((_tmp358="(",
_tag_dyneither(_tmp358,sizeof(char),2))));}Cyc_Absyndump_dumpexps_prec(20,
_tmp11D);{const char*_tmp359;Cyc_Absyndump_dump_nospace(((_tmp359=")",
_tag_dyneither(_tmp359,sizeof(char),2))));}goto _LLE5;_LL114: if(*((int*)_tmpE3)!= 
12)goto _LL116;_tmp11E=((struct Cyc_Absyn_Throw_e_struct*)_tmpE3)->f1;_LL115:{
const char*_tmp35A;Cyc_Absyndump_dump(((_tmp35A="throw",_tag_dyneither(_tmp35A,
...
_tmp125=((struct Cyc_Absyn_New_e_struct*)_tmpE3)->f2;_LL11F:{const char*_tmp35B;
Cyc_Absyndump_dump(((_tmp35B="new ",_tag_dyneither(_tmp35B,sizeof(char),5))));}
...
_LL121:{const char*_tmp35C;Cyc_Absyndump_dump(((_tmp35C="sizeof(",_tag_dyneither(
_tmp35C,sizeof(char),8))));}Cyc_Absyndump_dumptyp(_tmp126);Cyc_Absyndump_dump_char((
int)')');goto _LLE5;_LL122: if(*((int*)_tmpE3)!= 19)goto _LL124;_tmp127=((struct Cyc_Absyn_Sizeofexp_e_struct*)
_tmpE3)->f1;_LL123:{const char*_tmp35D;Cyc_Absyndump_dump(((_tmp35D="sizeof(",
_tag_dyneither(_tmp35D,sizeof(char),8))));}Cyc_Absyndump_dumpexp(_tmp127);Cyc_Absyndump_dump_char((
int)')');goto _LLE5;_LL124: if(*((int*)_tmpE3)!= 40)goto _LL126;_tmp128=(void*)((
struct Cyc_Absyn_Valueof_e_struct*)_tmpE3)->f1;_LL125:{const char*_tmp35E;Cyc_Absyndump_dump(((
_tmp35E="valueof(",_tag_dyneither(_tmp35E,sizeof(char),9))));}Cyc_Absyndump_dumptyp(
...
struct Cyc_Absyn_Tagcheck_e_struct*)_tmpE3)->f2;_LL127:{const char*_tmp35F;Cyc_Absyndump_dump(((
_tmp35F="tagcheck(",_tag_dyneither(_tmp35F,sizeof(char),10))));}Cyc_Absyndump_dumpexp(
...
const char*_tmp360;Cyc_Absyndump_dump(((_tmp360="offsetof(",_tag_dyneither(
_tmp360,sizeof(char),10))));}Cyc_Absyndump_dumptyp(_tmp12B);Cyc_Absyndump_dump_char((
...
_tmp12F)->f1;_LL12B:{const char*_tmp361;Cyc_Absyndump_dump(((_tmp361="offsetof(",
_tag_dyneither(_tmp361,sizeof(char),10))));}Cyc_Absyndump_dumptyp(_tmp12E);Cyc_Absyndump_dump_char((
int)',');{const char*_tmp365;void*_tmp364[1];struct Cyc_Int_pa_struct _tmp363;Cyc_Absyndump_dump((
struct _dyneither_ptr)((_tmp363.tag=1,((_tmp363.f1=(unsigned long)((int)_tmp130),((
_tmp364[0]=& _tmp363,Cyc_aprintf(((_tmp365="%d",_tag_dyneither(_tmp365,sizeof(
char),3))),_tag_dyneither(_tmp364,sizeof(void*),1)))))))));}Cyc_Absyndump_dump_char((
...
const char*_tmp366;Cyc_Absyndump_dump(((_tmp366="__gen(",_tag_dyneither(_tmp366,
...
myprec,_tmp136);{const char*_tmp367;Cyc_Absyndump_dump_nospace(((_tmp367="->",
_tag_dyneither(_tmp367,sizeof(char),3))));}Cyc_Absyndump_dump_nospace(*_tmp137);
...
_tmp368;Cyc_Absyndump_dump(((_tmp368="$(",_tag_dyneither(_tmp368,sizeof(char),3))));}
...
int)')');{const char*_tmp36B;const char*_tmp36A;const char*_tmp369;((void(*)(void(*
...
_tmp13C,((_tmp369="{",_tag_dyneither(_tmp369,sizeof(char),2))),((_tmp36A="}",
_tag_dyneither(_tmp36A,sizeof(char),2))),((_tmp36B=",",_tag_dyneither(_tmp36B,
sizeof(char),2))));}goto _LLE5;_LL13A: if(*((int*)_tmpE3)!= 28)goto _LL13C;_tmp13D=((
struct Cyc_Absyn_Array_e_struct*)_tmpE3)->f1;_LL13B:{const char*_tmp36E;const char*
_tmp36D;const char*_tmp36C;((void(*)(void(*f)(struct _tuple16*),struct Cyc_List_List*
l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumpde,_tmp13D,((_tmp36C="{",_tag_dyneither(_tmp36C,sizeof(char),2))),((
_tmp36D="}",_tag_dyneither(_tmp36D,sizeof(char),2))),((_tmp36E=",",
_tag_dyneither(_tmp36E,sizeof(char),2))));}goto _LLE5;_LL13C: if(*((int*)_tmpE3)!= 
...
Cyc_Absyn_Comprehension_e_struct*)_tmpE3)->f3;_LL13D:{const char*_tmp36F;Cyc_Absyndump_dump(((
_tmp36F="new {for",_tag_dyneither(_tmp36F,sizeof(char),9))));}Cyc_Absyndump_dump_str((*
...
_tmp142);{const char*_tmp372;const char*_tmp371;const char*_tmp370;((void(*)(void(*
f)(struct _tuple16*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct
_dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,
_tmp143,((_tmp370="",_tag_dyneither(_tmp370,sizeof(char),1))),((_tmp371="}",
...
struct Cyc_Absyn_AnonStruct_e_struct*)_tmpE3)->f2;_LL141:{const char*_tmp375;const
char*_tmp374;const char*_tmp373;((void(*)(void(*f)(struct _tuple16*),struct Cyc_List_List*
l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumpde,_tmp144,((_tmp373="{",_tag_dyneither(_tmp373,sizeof(char),2))),((
_tmp374="}",_tag_dyneither(_tmp374,sizeof(char),2))),((_tmp375=",",
_tag_dyneither(_tmp375,sizeof(char),2))));}goto _LLE5;_LL142: if(*((int*)_tmpE3)!= 
...
_tmp146->name);if(_tmp145 != 0){const char*_tmp378;const char*_tmp377;const char*
_tmp376;((void(*)(void(*f)(struct Cyc_Absyn_Exp*),struct Cyc_List_List*l,struct
_dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumpexp,_tmp145,((_tmp376="(",_tag_dyneither(_tmp376,sizeof(char),
2))),((_tmp377=")",_tag_dyneither(_tmp377,sizeof(char),2))),((_tmp378=",",
_tag_dyneither(_tmp378,sizeof(char),2))));}goto _LLE5;_LL144: if(*((int*)_tmpE3)!= 
...
_tmp149.num_elts;_LL149: if(_tmp14A){if(_tmp14B != 0){{const char*_tmp379;Cyc_Absyndump_dump(((
_tmp379="rcalloc(",_tag_dyneither(_tmp379,sizeof(char),9))));}Cyc_Absyndump_dumpexp((
struct Cyc_Absyn_Exp*)_tmp14B);{const char*_tmp37A;Cyc_Absyndump_dump(((_tmp37A=",",
_tag_dyneither(_tmp37A,sizeof(char),2))));}}else{const char*_tmp37B;Cyc_Absyndump_dump(((
_tmp37B="calloc",_tag_dyneither(_tmp37B,sizeof(char),7))));}Cyc_Absyndump_dumpexp(
_tmp14D);{const char*_tmp37C;Cyc_Absyndump_dump(((_tmp37C=",",_tag_dyneither(
_tmp37C,sizeof(char),2))));}Cyc_Absyndump_dumpexp(Cyc_Absyn_sizeoftyp_exp(*((
void**)_check_null(_tmp14C)),0));{const char*_tmp37D;Cyc_Absyndump_dump(((_tmp37D=")",
_tag_dyneither(_tmp37D,sizeof(char),2))));}}else{if(_tmp14B != 0){{const char*
_tmp37E;Cyc_Absyndump_dump(((_tmp37E="rmalloc(",_tag_dyneither(_tmp37E,sizeof(
char),9))));}Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_tmp14B);{const char*
_tmp37F;Cyc_Absyndump_dump(((_tmp37F=",",_tag_dyneither(_tmp37F,sizeof(char),2))));}}
else{const char*_tmp380;Cyc_Absyndump_dump(((_tmp380="malloc(",_tag_dyneither(
_tmp380,sizeof(char),8))));}if(_tmp14C != 0)Cyc_Absyndump_dumpexp(Cyc_Absyn_times_exp(
Cyc_Absyn_sizeoftyp_exp(*_tmp14C,0),_tmp14D,0));else{Cyc_Absyndump_dumpexp(
_tmp14D);}{const char*_tmp381;Cyc_Absyndump_dump(((_tmp381=")",_tag_dyneither(
_tmp381,sizeof(char),2))));}}goto _LLE5;_LL14A: if(*((int*)_tmpE3)!= 36)goto _LL14C;
_tmp14E=((struct Cyc_Absyn_Swap_e_struct*)_tmpE3)->f1;_tmp14F=((struct Cyc_Absyn_Swap_e_struct*)
_tmpE3)->f2;_LL14B:{const char*_tmp382;Cyc_Absyndump_dump(((_tmp382="cycswap(",
_tag_dyneither(_tmp382,sizeof(char),9))));}Cyc_Absyndump_dumpexp_prec(myprec,
...
_tmp385;const char*_tmp384;const char*_tmp383;((void(*)(void(*f)(struct _tuple16*),
struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct
_dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp151,((_tmp383="{",
_tag_dyneither(_tmp383,sizeof(char),2))),((_tmp384="}",_tag_dyneither(_tmp384,
sizeof(char),2))),((_tmp385=",",_tag_dyneither(_tmp385,sizeof(char),2))));}goto
_LLE5;_LL14E: if(*((int*)_tmpE3)!= 38)goto _LLE5;_tmp152=((struct Cyc_Absyn_StmtExp_e_struct*)
_tmpE3)->f1;_LL14F:{const char*_tmp386;Cyc_Absyndump_dump_nospace(((_tmp386="({",
_tag_dyneither(_tmp386,sizeof(char),3))));}Cyc_Absyndump_dumpstmt(_tmp152);{
const char*_tmp387;Cyc_Absyndump_dump_nospace(((_tmp387="})",_tag_dyneither(
_tmp387,sizeof(char),3))));}goto _LLE5;_LLE5:;}if(inprec >= myprec)Cyc_Absyndump_dump_char((
...
const char*_tmp388;Cyc_Absyndump_dump(((_tmp388="default:",_tag_dyneither(_tmp388,
sizeof(char),9))));}else{{const char*_tmp389;Cyc_Absyndump_dump(((_tmp389="case",
_tag_dyneither(_tmp389,sizeof(char),5))));}Cyc_Absyndump_dumppat(_tmp19A->pattern);
if(_tmp19A->where_clause != 0){{const char*_tmp38A;Cyc_Absyndump_dump(((_tmp38A="&&",
_tag_dyneither(_tmp38A,sizeof(char),3))));}Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)
_check_null(_tmp19A->where_clause));}{const char*_tmp38B;Cyc_Absyndump_dump_nospace(((
_tmp38B=":",_tag_dyneither(_tmp38B,sizeof(char),2))));}}Cyc_Absyndump_dumpstmt(
...
const char*_tmp38C;Cyc_Absyndump_dump(((_tmp38C="return;",_tag_dyneither(_tmp38C,
...
_LL15E: Cyc_Absyndump_dumploc(s->loc);{const char*_tmp38D;Cyc_Absyndump_dump(((
_tmp38D="return",_tag_dyneither(_tmp38D,sizeof(char),7))));}Cyc_Absyndump_dumpexp((
...
Cyc_Absyndump_dumploc(s->loc);{const char*_tmp38E;Cyc_Absyndump_dump(((_tmp38E="if(",
_tag_dyneither(_tmp38E,sizeof(char),4))));}Cyc_Absyndump_dumpexp(_tmp1A5);{void*
...
if(*((int*)_tmp1C3)!= 12)goto _LL184;_LL183:{const char*_tmp38F;Cyc_Absyndump_dump_nospace(((
_tmp38F="){",_tag_dyneither(_tmp38F,sizeof(char),3))));}Cyc_Absyndump_dumpstmt(
...
char*_tmp390;Cyc_Absyndump_dump(((_tmp390="else{",_tag_dyneither(_tmp390,sizeof(
...
Cyc_Absyndump_dumploc(s->loc);{const char*_tmp391;Cyc_Absyndump_dump(((_tmp391="while(",
_tag_dyneither(_tmp391,sizeof(char),7))));}Cyc_Absyndump_dumpexp(_tmp1A9);{const
char*_tmp392;Cyc_Absyndump_dump_nospace(((_tmp392="){",_tag_dyneither(_tmp392,
...
_LL165;_LL164: Cyc_Absyndump_dumploc(s->loc);{const char*_tmp393;Cyc_Absyndump_dump(((
_tmp393="break;",_tag_dyneither(_tmp393,sizeof(char),7))));}goto _LL154;_LL165:
if(_tmp19F <= (void*)1)goto _LL167;if(*((int*)_tmp19F)!= 6)goto _LL167;_LL166: Cyc_Absyndump_dumploc(
s->loc);{const char*_tmp394;Cyc_Absyndump_dump(((_tmp394="continue;",
_tag_dyneither(_tmp394,sizeof(char),10))));}goto _LL154;_LL167: if(_tmp19F <= (void*)
1)goto _LL169;if(*((int*)_tmp19F)!= 7)goto _LL169;_tmp1AB=((struct Cyc_Absyn_Goto_s_struct*)
_tmp19F)->f1;_LL168: Cyc_Absyndump_dumploc(s->loc);{const char*_tmp395;Cyc_Absyndump_dump(((
_tmp395="goto",_tag_dyneither(_tmp395,sizeof(char),5))));}Cyc_Absyndump_dump_str(
...
s->loc);{const char*_tmp396;Cyc_Absyndump_dump(((_tmp396="for(",_tag_dyneither(
_tmp396,sizeof(char),5))));}Cyc_Absyndump_dumpexp(_tmp1AC);Cyc_Absyndump_dump_semi();
Cyc_Absyndump_dumpexp(_tmp1AE);Cyc_Absyndump_dump_semi();Cyc_Absyndump_dumpexp(
_tmp1B0);{const char*_tmp397;Cyc_Absyndump_dump_nospace(((_tmp397="){",
_tag_dyneither(_tmp397,sizeof(char),3))));}Cyc_Absyndump_dumpstmt(_tmp1B1);Cyc_Absyndump_dump_char((
...
const char*_tmp398;Cyc_Absyndump_dump(((_tmp398="switch(",_tag_dyneither(_tmp398,
sizeof(char),8))));}Cyc_Absyndump_dumpexp(_tmp1B2);{const char*_tmp399;Cyc_Absyndump_dump_nospace(((
_tmp399="){",_tag_dyneither(_tmp399,sizeof(char),3))));}Cyc_Absyndump_dumpswitchclauses(
...
_tmp39A;Cyc_Absyndump_dump_nospace(((_tmp39A=": {",_tag_dyneither(_tmp39A,
...
s->loc);{const char*_tmp39B;Cyc_Absyndump_dump(((_tmp39B="do{",_tag_dyneither(
_tmp39B,sizeof(char),4))));}Cyc_Absyndump_dumpstmt(_tmp1B8);{const char*_tmp39C;
Cyc_Absyndump_dump_nospace(((_tmp39C="}while(",_tag_dyneither(_tmp39C,sizeof(
char),8))));}Cyc_Absyndump_dumpexp(_tmp1BA);{const char*_tmp39D;Cyc_Absyndump_dump_nospace(((
_tmp39D=");",_tag_dyneither(_tmp39D,sizeof(char),3))));}goto _LL154;_LL173: if(
...
const char*_tmp39E;Cyc_Absyndump_dump(((_tmp39E="fallthru;",_tag_dyneither(
_tmp39E,sizeof(char),10))));}goto _LL154;_LL175: if(_tmp19F <= (void*)1)goto _LL177;
if(*((int*)_tmp19F)!= 10)goto _LL177;_tmp1BC=((struct Cyc_Absyn_Fallthru_s_struct*)
_tmp19F)->f1;_LL176:{const char*_tmp39F;Cyc_Absyndump_dump(((_tmp39F="fallthru(",
_tag_dyneither(_tmp39F,sizeof(char),10))));}Cyc_Absyndump_dumpexps_prec(20,
_tmp1BC);{const char*_tmp3A0;Cyc_Absyndump_dump_nospace(((_tmp3A0=");",
_tag_dyneither(_tmp3A0,sizeof(char),3))));}goto _LL154;_LL177: if(_tmp19F <= (void*)
...
Cyc_Absyndump_dumploc(s->loc);{const char*_tmp3A1;Cyc_Absyndump_dump(((_tmp3A1="try",
_tag_dyneither(_tmp3A1,sizeof(char),4))));}Cyc_Absyndump_dumpstmt(_tmp1BD);{
const char*_tmp3A2;Cyc_Absyndump_dump(((_tmp3A2="catch{",_tag_dyneither(_tmp3A2,
...
_LL17A: Cyc_Absyndump_dumploc(s->loc);{const char*_tmp3A3;Cyc_Absyndump_dump(((
_tmp3A3="reset_region(",_tag_dyneither(_tmp3A3,sizeof(char),14))));}Cyc_Absyndump_dumpexp(
_tmp1BF);{const char*_tmp3A4;Cyc_Absyndump_dump(((_tmp3A4=");",_tag_dyneither(
_tmp3A4,sizeof(char),3))));}goto _LL154;_LL154:;}struct _tuple17{struct Cyc_List_List*
f1;struct Cyc_Absyn_Pat*f2;};void Cyc_Absyndump_dumpdp(struct _tuple17*dp);void Cyc_Absyndump_dumpdp(
struct _tuple17*dp){{const char*_tmp3A7;const char*_tmp3A6;const char*_tmp3A5;Cyc_Absyndump_egroup(
Cyc_Absyndump_dumpdesignator,(*dp).f1,((_tmp3A5="",_tag_dyneither(_tmp3A5,
sizeof(char),1))),((_tmp3A6="=",_tag_dyneither(_tmp3A6,sizeof(char),2))),((
_tmp3A7="=",_tag_dyneither(_tmp3A7,sizeof(char),2))));}Cyc_Absyndump_dumppat((*
...
_LL18E: if((int)_tmp1DE != 1)goto _LL190;_LL18F:{const char*_tmp3A8;Cyc_Absyndump_dump(((
_tmp3A8="NULL",_tag_dyneither(_tmp3A8,sizeof(char),5))));}goto _LL18B;_LL190: if(
...
_LL193:{const char*_tmp3AC;void*_tmp3AB[1];struct Cyc_Int_pa_struct _tmp3AA;Cyc_Absyndump_dump((
struct _dyneither_ptr)((_tmp3AA.tag=1,((_tmp3AA.f1=(unsigned long)_tmp1E2,((
_tmp3AB[0]=& _tmp3AA,Cyc_aprintf(((_tmp3AC="%d",_tag_dyneither(_tmp3AC,sizeof(
char),3))),_tag_dyneither(_tmp3AB,sizeof(void*),1)))))))));}goto _LL18B;_LL194:
...
_tmp3B0;void*_tmp3AF[1];struct Cyc_Int_pa_struct _tmp3AE;Cyc_Absyndump_dump((
struct _dyneither_ptr)((_tmp3AE.tag=1,((_tmp3AE.f1=(unsigned int)_tmp1E4,((
_tmp3AF[0]=& _tmp3AE,Cyc_aprintf(((_tmp3B0="%u",_tag_dyneither(_tmp3B0,sizeof(
char),3))),_tag_dyneither(_tmp3AF,sizeof(void*),1)))))))));}goto _LL18B;_LL196:
if(_tmp1DE <= (void*)2)goto _LL198;if(*((int*)_tmp1DE)!= 8)goto _LL198;_tmp1E5=((
struct Cyc_Absyn_Char_p_struct*)_tmp1DE)->f1;_LL197:{const char*_tmp3B1;Cyc_Absyndump_dump(((
_tmp3B1="'",_tag_dyneither(_tmp3B1,sizeof(char),2))));}Cyc_Absyndump_dump_nospace(
Cyc_Absynpp_char_escape(_tmp1E5));{const char*_tmp3B2;Cyc_Absyndump_dump_nospace(((
_tmp3B2="'",_tag_dyneither(_tmp3B2,sizeof(char),2))));}goto _LL18B;_LL198: if(
...
_tmp1EB->name);{const char*_tmp3B3;Cyc_Absyndump_dump(((_tmp3B3=" as ",
_tag_dyneither(_tmp3B3,sizeof(char),5))));}Cyc_Absyndump_dumppat(_tmp1EC);goto
...
Cyc_Absyn_Tuple_p_struct*)_tmp1DE)->f2;_LL19F: {const char*_tmp3B5;const char*
_tmp3B4;struct _dyneither_ptr term=_tmp1EE?(_tmp3B5=", ...)",_tag_dyneither(
_tmp3B5,sizeof(char),7)):((_tmp3B4=")",_tag_dyneither(_tmp3B4,sizeof(char),2)));{
const char*_tmp3B7;const char*_tmp3B6;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),
struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct
_dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp1ED,((_tmp3B6="$(",
_tag_dyneither(_tmp3B6,sizeof(char),3))),term,((_tmp3B7=",",_tag_dyneither(
_tmp3B7,sizeof(char),2))));}goto _LL18B;}_LL1A0: if(_tmp1DE <= (void*)2)goto _LL1A2;
if(*((int*)_tmp1DE)!= 4)goto _LL1A2;_tmp1EF=((struct Cyc_Absyn_Pointer_p_struct*)
_tmp1DE)->f1;_LL1A1:{const char*_tmp3B8;Cyc_Absyndump_dump(((_tmp3B8="&",
_tag_dyneither(_tmp3B8,sizeof(char),2))));}Cyc_Absyndump_dumppat(_tmp1EF);goto
...
_tmp1F2.r;if((int)_tmp1F3 != 0)goto _LL1A4;_LL1A3:{const char*_tmp3B9;Cyc_Absyndump_dump(((
_tmp3B9="*",_tag_dyneither(_tmp3B9,sizeof(char),2))));}Cyc_Absyndump_dumpqvar(
...
_tmp3BA;Cyc_Absyndump_dump(((_tmp3BA="*",_tag_dyneither(_tmp3BA,sizeof(char),2))));}
Cyc_Absyndump_dumpqvar(_tmp1F4->name);{const char*_tmp3BB;Cyc_Absyndump_dump(((
_tmp3BB=" as ",_tag_dyneither(_tmp3BB,sizeof(char),5))));}Cyc_Absyndump_dumppat(
...
_tmp3BD;const char*_tmp3BC;struct _dyneither_ptr term=_tmp1FB?(_tmp3BD=", ...)",
_tag_dyneither(_tmp3BD,sizeof(char),7)):((_tmp3BC=")",_tag_dyneither(_tmp3BC,
sizeof(char),2)));Cyc_Absyndump_dumpqvar(_tmp1F9);{const char*_tmp3BF;const char*
_tmp3BE;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct
_dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumppat,_tmp1FA,((_tmp3BE="(",_tag_dyneither(_tmp3BE,sizeof(char),
2))),term,((_tmp3BF=",",_tag_dyneither(_tmp3BF,sizeof(char),2))));}goto _LL18B;}
...
const char*_tmp3C1;const char*_tmp3C0;struct _dyneither_ptr term=_tmp201?(_tmp3C1=", ...)",
_tag_dyneither(_tmp3C1,sizeof(char),7)):((_tmp3C0=")",_tag_dyneither(_tmp3C0,
sizeof(char),2)));Cyc_Absyndump_dumpqvar(_tmp223);Cyc_Absyndump_dump_char((int)'{');{
const char*_tmp3C4;const char*_tmp3C3;const char*_tmp3C2;((void(*)(void(*f)(struct
Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct
_dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,
_tmp1FF,((_tmp3C2="[",_tag_dyneither(_tmp3C2,sizeof(char),2))),((_tmp3C3="]",
_tag_dyneither(_tmp3C3,sizeof(char),2))),((_tmp3C4=",",_tag_dyneither(_tmp3C4,
sizeof(char),2))));}{const char*_tmp3C6;const char*_tmp3C5;((void(*)(void(*f)(
...
_tmp200,((_tmp3C5="",_tag_dyneither(_tmp3C5,sizeof(char),1))),term,((_tmp3C6=",",
_tag_dyneither(_tmp3C6,sizeof(char),2))));}goto _LL18B;}}_LL1AE: if(_tmp1DE <= (
...
struct Cyc_Absyn_Aggr_p_struct*)_tmp1DE)->f4;_LL1AF: {const char*_tmp3C8;const char*
_tmp3C7;struct _dyneither_ptr term=_tmp205?(_tmp3C8=", ...)",_tag_dyneither(
_tmp3C8,sizeof(char),7)):((_tmp3C7=")",_tag_dyneither(_tmp3C7,sizeof(char),2)));
Cyc_Absyndump_dump_char((int)'{');{const char*_tmp3CB;const char*_tmp3CA;const char*
_tmp3C9;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct
_dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(
Cyc_Absyndump_dumptvar,_tmp203,((_tmp3C9="[",_tag_dyneither(_tmp3C9,sizeof(char),
2))),((_tmp3CA="]",_tag_dyneither(_tmp3CA,sizeof(char),2))),((_tmp3CB=",",
_tag_dyneither(_tmp3CB,sizeof(char),2))));}{const char*_tmp3CD;const char*_tmp3CC;((
...
_tmp204,((_tmp3CC="",_tag_dyneither(_tmp3CC,sizeof(char),1))),term,((_tmp3CD=",",
_tag_dyneither(_tmp3CD,sizeof(char),2))));}goto _LL18B;}_LL1B0: if(_tmp1DE <= (void*)
...
struct Cyc_Absyn_Datatype_p_struct*)_tmp1DE)->f4;_LL1B1: {const char*_tmp3CF;const
char*_tmp3CE;struct _dyneither_ptr term=_tmp208?(_tmp3CF=", ...)",_tag_dyneither(
_tmp3CF,sizeof(char),7)):((_tmp3CE=")",_tag_dyneither(_tmp3CE,sizeof(char),2)));
Cyc_Absyndump_dumpqvar(_tmp206->name);if(_tmp207 != 0){const char*_tmp3D1;const
char*_tmp3D0;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,
struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumppat,_tmp207,((_tmp3D0="(",_tag_dyneither(_tmp3D0,sizeof(char),
2))),term,((_tmp3D1=",",_tag_dyneither(_tmp3D1,sizeof(char),2))));}goto _LL18B;}
...
struct Cyc_List_List*fields){const char*_tmp3D2;((void(*)(void(*f)(struct Cyc_Absyn_Datatypefield*),
struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpdatatypefield,
fields,((_tmp3D2=",",_tag_dyneither(_tmp3D2,sizeof(char),2))));}void Cyc_Absyndump_dumpenumfield(
struct Cyc_Absyn_Enumfield*ef);void Cyc_Absyndump_dumpenumfield(struct Cyc_Absyn_Enumfield*
ef){Cyc_Absyndump_dumpqvar(ef->name);if(ef->tag != 0){{const char*_tmp3D3;Cyc_Absyndump_dump(((
_tmp3D3=" = ",_tag_dyneither(_tmp3D3,sizeof(char),4))));}Cyc_Absyndump_dumpexp((
...
fields){const char*_tmp3D4;((void(*)(void(*f)(struct Cyc_Absyn_Enumfield*),struct
Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpenumfield,
fields,((_tmp3D4=",",_tag_dyneither(_tmp3D4,sizeof(char),2))));}void Cyc_Absyndump_dumpaggrfields(
...
_LL1C0: if((int)_tmp241 != 0)goto _LL1C2;_LL1C1:{const char*_tmp3D5;Cyc_Absyndump_dump(((
_tmp3D5="_stdcall",_tag_dyneither(_tmp3D5,sizeof(char),9))));}goto _LL1BD;_LL1C2:
if((int)_tmp241 != 1)goto _LL1C4;_LL1C3:{const char*_tmp3D6;Cyc_Absyndump_dump(((
_tmp3D6="_cdecl",_tag_dyneither(_tmp3D6,sizeof(char),7))));}goto _LL1BD;_LL1C4:
if((int)_tmp241 != 2)goto _LL1C6;_LL1C5:{const char*_tmp3D7;Cyc_Absyndump_dump(((
_tmp3D7="_fastcall",_tag_dyneither(_tmp3D7,sizeof(char),10))));}goto _LL1BD;
...
_tuple9 _tmp3D8;struct _tuple9 _tmp257=(_tmp3D8.f1=call_conv,((_tmp3D8.f2=_tmp248,
_tmp3D8)));((void(*)(struct Cyc_List_List*tms,void(*f)(struct _tuple9*),struct
...
_LL207: if((int)_tmp27C != 1)goto _LL209;_LL208:{const char*_tmp3D9;Cyc_Absyndump_dump(((
_tmp3D9="__inline",_tag_dyneither(_tmp3D9,sizeof(char),9))));}goto _LL206;_LL209:;
_LL20A:{const char*_tmp3DA;Cyc_Absyndump_dump(((_tmp3DA="inline",_tag_dyneither(
_tmp3DA,sizeof(char),7))));}goto _LL206;_LL206:;}Cyc_Absyndump_dumpscope(_tmp25B->sc);{
struct Cyc_Absyn_FnType_struct _tmp3E0;struct Cyc_Absyn_FnInfo _tmp3DF;struct Cyc_Absyn_FnType_struct*
_tmp3DE;void*t=(void*)((_tmp3DE=_cycalloc(sizeof(*_tmp3DE)),((_tmp3DE[0]=((
_tmp3E0.tag=8,((_tmp3E0.f1=((_tmp3DF.tvars=_tmp25B->tvs,((_tmp3DF.effect=_tmp25B->effect,((
_tmp3DF.ret_typ=_tmp25B->ret_type,((_tmp3DF.args=((struct Cyc_List_List*(*)(
struct _tuple7*(*f)(struct _tuple10*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Absynpp_arg_mk_opt,
_tmp25B->args),((_tmp3DF.c_varargs=_tmp25B->c_varargs,((_tmp3DF.cyc_varargs=
_tmp25B->cyc_varargs,((_tmp3DF.rgn_po=_tmp25B->rgn_po,((_tmp3DF.attributes=0,
_tmp3DF)))))))))))))))),_tmp3E0)))),_tmp3DE))));{void*_tmp27F=Cyc_Cyclone_c_compiler;
...
_check_null(_tmp25C->impl))->exist_vars != 0){const char*_tmp3E3;const char*_tmp3E2;
const char*_tmp3E1;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*
...
_check_null(_tmp25C->impl))->fields);{const char*_tmp3E4;Cyc_Absyndump_dump(((
_tmp3E4="}",_tag_dyneither(_tmp3E4,sizeof(char),2))));}Cyc_Absyndump_dumpatts(
_tmp25C->attributes);{const char*_tmp3E5;Cyc_Absyndump_dump(((_tmp3E5=";",
_tag_dyneither(_tmp3E5,sizeof(char),2))));}}goto _LL1E0;_LL1E7: if(*((int*)_tmp259)
...
_tmp25F);if(_tmp263){const char*_tmp3E6;Cyc_Absyndump_dump(((_tmp3E6="@extensible ",
_tag_dyneither(_tmp3E6,sizeof(char),13))));}{const char*_tmp3E7;Cyc_Absyndump_dump(((
_tmp3E7="datatype ",_tag_dyneither(_tmp3E7,sizeof(char),10))));}Cyc_Absyndump_dumpqvar(
...
Cyc_List_List*)_tmp262->v);{const char*_tmp3E8;Cyc_Absyndump_dump_nospace(((
_tmp3E8="};",_tag_dyneither(_tmp3E8,sizeof(char),3))));}}goto _LL1E0;_LL1E9: if(*((
...
_LL1EA: Cyc_Absyndump_dumpscope(_tmp266);{const char*_tmp3E9;Cyc_Absyndump_dump(((
_tmp3E9="enum ",_tag_dyneither(_tmp3E9,sizeof(char),6))));}Cyc_Absyndump_dumpqvar(
...
char*_tmp3EA;Cyc_Absyndump_dump_nospace(((_tmp3EA="};",_tag_dyneither(_tmp3EA,
...
_tmp259)->f3;_LL1EC:{const char*_tmp3EB;Cyc_Absyndump_dump(((_tmp3EB="let",
_tag_dyneither(_tmp3EB,sizeof(char),4))));}Cyc_Absyndump_dumppat(_tmp269);Cyc_Absyndump_dump_char((
...
_tmp259)->f1;_LL1EE:{const char*_tmp3EC;Cyc_Absyndump_dump(((_tmp3EC="let ",
_tag_dyneither(_tmp3EC,sizeof(char),5))));}Cyc_Absyndump_dumpids(_tmp26B);Cyc_Absyndump_dump_semi();
...
_tmp259)->f4;_LL1F0:{const char*_tmp3ED;Cyc_Absyndump_dump(((_tmp3ED="region",
_tag_dyneither(_tmp3ED,sizeof(char),7))));}{const char*_tmp3EE;Cyc_Absyndump_dump(((
_tmp3EE="<",_tag_dyneither(_tmp3EE,sizeof(char),2))));}Cyc_Absyndump_dumptvar(
_tmp26C);{const char*_tmp3EF;Cyc_Absyndump_dump(((_tmp3EF="> ",_tag_dyneither(
_tmp3EF,sizeof(char),3))));}Cyc_Absyndump_dumpqvar(_tmp26D->name);if(_tmp26E){
const char*_tmp3F0;Cyc_Absyndump_dump(((_tmp3F0="@resetable",_tag_dyneither(
_tmp3F0,sizeof(char),11))));}if(_tmp26F != 0){{const char*_tmp3F1;Cyc_Absyndump_dump(((
_tmp3F1=" = open(",_tag_dyneither(_tmp3F1,sizeof(char),9))));}Cyc_Absyndump_dumpexp((
struct Cyc_Absyn_Exp*)_tmp26F);{const char*_tmp3F2;Cyc_Absyndump_dump(((_tmp3F2=")",
_tag_dyneither(_tmp3F2,sizeof(char),2))));}}Cyc_Absyndump_dump_semi();goto _LL1E0;
...
struct Cyc_Absyn_Alias_d_struct*)_tmp259)->f3;_LL1F2:{const char*_tmp3F3;Cyc_Absyndump_dump(((
_tmp3F3="alias ",_tag_dyneither(_tmp3F3,sizeof(char),7))));}{const char*_tmp3F4;
Cyc_Absyndump_dump(((_tmp3F4="<",_tag_dyneither(_tmp3F4,sizeof(char),2))));}Cyc_Absyndump_dumptvar(
_tmp271);{const char*_tmp3F5;Cyc_Absyndump_dump(((_tmp3F5=">",_tag_dyneither(
_tmp3F5,sizeof(char),2))));}Cyc_Absyndump_dumpqvar(_tmp272->name);{const char*
_tmp3F6;Cyc_Absyndump_dump(((_tmp3F6=" = ",_tag_dyneither(_tmp3F6,sizeof(char),4))));}
...
void*)((struct Cyc_Core_Opt*)_check_null(_tmp273->defn))->v)){{const char*_tmp3F7;
Cyc_Absyndump_dump(((_tmp3F7="typedef",_tag_dyneither(_tmp3F7,sizeof(char),8))));}{
...
_tmp3F8;Cyc_Absyndump_dump(((_tmp3F8="namespace",_tag_dyneither(_tmp3F8,sizeof(
...
_tmp277=((struct Cyc_Absyn_Using_d_struct*)_tmp259)->f2;_LL1F8:{const char*_tmp3F9;
Cyc_Absyndump_dump(((_tmp3F9="using",_tag_dyneither(_tmp3F9,sizeof(char),6))));}
...
const char*_tmp3FA;Cyc_Absyndump_dump(((_tmp3FA="extern \"C\" {",_tag_dyneither(
_tmp3FA,sizeof(char),13))));}for(0;_tmp278 != 0;_tmp278=_tmp278->tl){Cyc_Absyndump_dumpdecl((
...
_LL1FC:{const char*_tmp3FB;Cyc_Absyndump_dump(((_tmp3FB="extern \"C include\" {",
_tag_dyneither(_tmp3FB,sizeof(char),21))));}for(0;_tmp279 != 0;_tmp279=_tmp279->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp279->hd);}Cyc_Absyndump_dump_char((
int)'}');if(_tmp27A != 0){{const char*_tmp3FC;Cyc_Absyndump_dump(((_tmp3FC=" export {",
_tag_dyneither(_tmp3FC,sizeof(char),10))));}for(0;_tmp27A != 0;_tmp27A=_tmp27A->tl){
...
int)',');}{const char*_tmp3FD;Cyc_Absyndump_dump(((_tmp3FD="}",_tag_dyneither(
_tmp3FD,sizeof(char),2))));}}goto _LL1E0;_LL1FD: if((int)_tmp259 != 0)goto _LL1FF;
_LL1FE:{const char*_tmp3FE;Cyc_Absyndump_dump(((_tmp3FE=" __cyclone_port_on__; ",
_tag_dyneither(_tmp3FE,sizeof(char),23))));}goto _LL1E0;_LL1FF: if((int)_tmp259 != 
1)goto _LL1E0;_LL200:{const char*_tmp3FF;Cyc_Absyndump_dump(((_tmp3FF=" __cyclone_port_off__; ",
_tag_dyneither(_tmp3FF,sizeof(char),24))));}goto _LL1E0;_LL1E0:;}static void Cyc_Absyndump_dump_upperbound(
...
union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp2A9)){const char*_tmp400;
Cyc_Absyndump_dump(((_tmp400="@zeroterm",_tag_dyneither(_tmp400,sizeof(char),10))));}{
...
_tmp2AE != 3)goto _LL21F;_LL21E:{const char*_tmp401;Cyc_Absyndump_dump(((_tmp401="`U",
_tag_dyneither(_tmp401,sizeof(char),3))));}goto _LL21A;_LL21F: if(_tmp2AE <= (void*)
...
_tmp2A6));goto _LL21A;_LL223:;_LL224: {const char*_tmp404;void*_tmp403;(_tmp403=0,
Cyc_Tcutil_impos(((_tmp404="dumptms: bad rgn type in Pointer_mod",_tag_dyneither(
_tmp404,sizeof(char),37))),_tag_dyneither(_tmp403,sizeof(void*),0)));}_LL21A:;}
Cyc_Absyndump_dumptq(_tmp2AA);Cyc_Absyndump_dumptms(tms->tl,f,a);return;_LL213:;
_LL214: {int next_is_pointer=0;if(tms->tl != 0){void*_tmp2B4=(void*)((struct Cyc_List_List*)
...
_tmp2B5)->f1;_LL22C:{const char*_tmp405;Cyc_Absyndump_dump(((_tmp405="[]",
_tag_dyneither(_tmp405,sizeof(char),3))));}if(((int(*)(int y,union Cyc_Absyn_Constraint*
x))Cyc_Absyn_conref_def)(0,_tmp2B6)){const char*_tmp406;Cyc_Absyndump_dump(((
_tmp406="@zeroterm",_tag_dyneither(_tmp406,sizeof(char),10))));}goto _LL22A;
_LL22D: if(*((int*)_tmp2B5)!= 1)goto _LL22F;_tmp2B7=((struct Cyc_Absyn_ConstArray_mod_struct*)
_tmp2B5)->f1;_tmp2B8=((struct Cyc_Absyn_ConstArray_mod_struct*)_tmp2B5)->f2;
_LL22E: Cyc_Absyndump_dump_char((int)'[');Cyc_Absyndump_dumpexp(_tmp2B7);Cyc_Absyndump_dump_char((
int)']');if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,
_tmp2B8)){const char*_tmp407;Cyc_Absyndump_dump(((_tmp407="@zeroterm",
_tag_dyneither(_tmp407,sizeof(char),10))));}goto _LL22A;_LL22F: if(*((int*)_tmp2B5)
!= 3)goto _LL231;_tmp2B9=(void*)((struct Cyc_Absyn_Function_mod_struct*)_tmp2B5)->f1;
if(*((int*)_tmp2B9)!= 1)goto _LL231;_tmp2BA=((struct Cyc_Absyn_WithTypes_struct*)
...
const char*_tmp40A;const char*_tmp409;const char*_tmp408;((void(*)(void(*f)(struct
...
_tmp2C0,((_tmp408="(",_tag_dyneither(_tmp408,sizeof(char),2))),((_tmp409=")",
_tag_dyneither(_tmp409,sizeof(char),2))),((_tmp40A=",",_tag_dyneither(_tmp40A,
sizeof(char),2))));}goto _LL22A;_LL233: if(*((int*)_tmp2B5)!= 4)goto _LL235;_tmp2C2=((
struct Cyc_Absyn_TypeParams_mod_struct*)_tmp2B5)->f1;_tmp2C3=((struct Cyc_Absyn_TypeParams_mod_struct*)
_tmp2B5)->f2;_tmp2C4=((struct Cyc_Absyn_TypeParams_mod_struct*)_tmp2B5)->f3;
_LL234: if(_tmp2C4)Cyc_Absyndump_dumpkindedtvars(_tmp2C2);else{Cyc_Absyndump_dumptvars(
_tmp2C2);}goto _LL22A;_LL235: if(*((int*)_tmp2B5)!= 5)goto _LL237;_tmp2C5=((struct
Cyc_Absyn_Attributes_mod_struct*)_tmp2B5)->f2;_LL236: Cyc_Absyndump_dumpatts(
_tmp2C5);goto _LL22A;_LL237: if(*((int*)_tmp2B5)!= 2)goto _LL22A;_LL238: {const char*
_tmp40D;void*_tmp40C;(_tmp40C=0,Cyc_Tcutil_impos(((_tmp40D="dumptms",
_tag_dyneither(_tmp40D,sizeof(char),8))),_tag_dyneither(_tmp40C,sizeof(void*),0)));}
_LL22A:;}return;}_LL210:;}}void Cyc_Absyndump_dumptqtd(struct Cyc_Absyn_Tqual tq,
void*t,void(*f)(void*),void*a);void Cyc_Absyndump_dumptqtd(struct Cyc_Absyn_Tqual
tq,void*t,void(*f)(void*),void*a){struct _RegionHandle _tmp2CE=_new_region("temp");
struct _RegionHandle*temp=& _tmp2CE;_push_region(temp);{struct Cyc_Absyn_Tqual
_tmp2D0;void*_tmp2D1;struct Cyc_List_List*_tmp2D2;struct _tuple11 _tmp2CF=Cyc_Absynpp_to_tms(
temp,tq,t);_tmp2D0=_tmp2CF.f1;_tmp2D1=_tmp2CF.f2;_tmp2D2=_tmp2CF.f3;Cyc_Absyndump_dumptq(
_tmp2D0);Cyc_Absyndump_dumpntyp(_tmp2D1);Cyc_Absyndump_dumptms(Cyc_List_imp_rev(
_tmp2D2),f,a);};_pop_region(temp);}void Cyc_Absyndump_dumpdecllist2file(struct Cyc_List_List*
...
const char*_tmp410;void*_tmp40F;(_tmp40F=0,Cyc_fprintf(f,((_tmp410="\n",
_tag_dyneither(_tmp410,sizeof(char),2))),_tag_dyneither(_tmp40F,sizeof(void*),0)));}}
