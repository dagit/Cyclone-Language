...
_tmp50;void*_tmp51;int _tmp52;struct Cyc_Absyn_DatatypeInfo _tmp53;union Cyc_Absyn_DatatypeInfoU_union
_tmp54;struct Cyc_List_List*_tmp55;struct Cyc_Core_Opt*_tmp56;struct Cyc_Absyn_DatatypeFieldInfo
...
!= 2)goto _LL85;_tmp53=((struct Cyc_Absyn_DatatypeType_struct*)_tmp49)->f1;_tmp54=
_tmp53.datatype_info;_tmp55=_tmp53.targs;_tmp56=_tmp53.rgn;_LL84:{union Cyc_Absyn_DatatypeInfoU_union
_tmp8E=_tmp54;struct Cyc_Absyn_UnknownDatatypeInfo _tmp8F;struct _tuple0*_tmp90;int
_tmp91;struct Cyc_Absyn_Datatypedecl**_tmp92;struct Cyc_Absyn_Datatypedecl*_tmp93;
struct Cyc_Absyn_Datatypedecl _tmp94;struct _tuple0*_tmp95;int _tmp96;_LLC8: if((
_tmp8E.UnknownDatatype).tag != 0)goto _LLCA;_tmp8F=(_tmp8E.UnknownDatatype).f1;
_tmp90=_tmp8F.name;_tmp91=_tmp8F.is_extensible;_LLC9: _tmp95=_tmp90;_tmp96=_tmp91;
goto _LLCB;_LLCA: if((_tmp8E.KnownDatatype).tag != 1)goto _LLC7;_tmp92=(_tmp8E.KnownDatatype).f1;
_tmp93=*_tmp92;_tmp94=*_tmp93;_tmp95=_tmp94.name;_tmp96=_tmp94.is_extensible;
_LLCB: if(_tmp96){const char*_tmp2F4;Cyc_Absyndump_dump(((_tmp2F4="@extensible ",
_tag_dyneither(_tmp2F4,sizeof(char),13))));}{const char*_tmp2F5;Cyc_Absyndump_dump(((
_tmp2F5="datatype ",_tag_dyneither(_tmp2F5,sizeof(char),10))));}{void*r=(
...
r);{const char*_tmp2F6;Cyc_Absyndump_dump(((_tmp2F6=" ",_tag_dyneither(_tmp2F6,
sizeof(char),2))));}goto _LLCC;_LLCC:;}Cyc_Absyndump_dumpqvar(_tmp95);Cyc_Absyndump_dumptps(
...
_tmp2F7="@extensible ",_tag_dyneither(_tmp2F7,sizeof(char),13))));}{const char*
_tmp2F8;Cyc_Absyndump_dump(((_tmp2F8="datatype ",_tag_dyneither(_tmp2F8,sizeof(
char),10))));}Cyc_Absyndump_dumpqvar(_tmpA2);{const char*_tmp2F9;Cyc_Absyndump_dump(((
...
_tmp13A;struct Cyc_Absyn_Datatypefield*_tmp13B;struct _tuple0*_tmp13C;struct
_tuple0*_tmp13D;struct Cyc_Absyn_MallocInfo _tmp13E;int _tmp13F;struct Cyc_Absyn_Exp*
_tmp140;void**_tmp141;struct Cyc_Absyn_Exp*_tmp142;struct Cyc_Absyn_Exp*_tmp143;
struct Cyc_Absyn_Exp*_tmp144;struct Cyc_Core_Opt*_tmp145;struct Cyc_List_List*
_tmp146;struct Cyc_Absyn_Stmt*_tmp147;_LLE6: if(*((int*)_tmpE1)!= 0)goto _LLE8;
_tmpE2=((struct Cyc_Absyn_Const_e_struct*)_tmpE1)->f1;if(((((struct Cyc_Absyn_Const_e_struct*)
_tmpE1)->f1).Char_c).tag != 0)goto _LLE8;_tmpE3=(_tmpE2.Char_c).f1;_tmpE4=(_tmpE2.Char_c).f2;
_LLE7: Cyc_Absyndump_dump_char((int)'\'');Cyc_Absyndump_dump_nospace(Cyc_Absynpp_char_escape(
_tmpE4));Cyc_Absyndump_dump_char((int)'\'');goto _LLE5;_LLE8: if(*((int*)_tmpE1)!= 
0)goto _LLEA;_tmpE5=((struct Cyc_Absyn_Const_e_struct*)_tmpE1)->f1;if(((((struct
Cyc_Absyn_Const_e_struct*)_tmpE1)->f1).Short_c).tag != 1)goto _LLEA;_tmpE6=(_tmpE5.Short_c).f1;
_tmpE7=(_tmpE5.Short_c).f2;_LLE9:{const char*_tmp327;void*_tmp326[1];struct Cyc_Int_pa_struct
_tmp325;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp325.tag=1,((_tmp325.f1=(
unsigned long)((int)_tmpE7),((_tmp326[0]=& _tmp325,Cyc_aprintf(((_tmp327="%d",
_tag_dyneither(_tmp327,sizeof(char),3))),_tag_dyneither(_tmp326,sizeof(void*),1)))))))));}
goto _LLE5;_LLEA: if(*((int*)_tmpE1)!= 0)goto _LLEC;_tmpE8=((struct Cyc_Absyn_Const_e_struct*)
_tmpE1)->f1;if(((((struct Cyc_Absyn_Const_e_struct*)_tmpE1)->f1).Int_c).tag != 2)
goto _LLEC;_tmpE9=(_tmpE8.Int_c).f1;if((int)_tmpE9 != 2)goto _LLEC;_tmpEA=(_tmpE8.Int_c).f2;
...
32)goto _LL142;_tmp13A=((struct Cyc_Absyn_Datatype_e_struct*)_tmpE1)->f1;_tmp13B=((
struct Cyc_Absyn_Datatype_e_struct*)_tmpE1)->f3;_LL141: Cyc_Absyndump_dumpqvar(
...
_tmp1F3;int _tmp1F4;struct Cyc_Absyn_Datatypefield*_tmp1F5;struct Cyc_List_List*
...
void*)2)goto _LL1AE;if(*((int*)_tmp1D2)!= 6)goto _LL1AE;_tmp1F5=((struct Cyc_Absyn_Datatype_p_struct*)
_tmp1D2)->f2;_tmp1F6=((struct Cyc_Absyn_Datatype_p_struct*)_tmp1D2)->f3;_tmp1F7=((
struct Cyc_Absyn_Datatype_p_struct*)_tmp1D2)->f4;_LL1AD: {const char*_tmp3B0;const
...
struct Cyc_List_List*fields){const char*_tmp3B3;((void(*)(void(*f)(struct Cyc_Absyn_Datatypefield*),
...
!= 7)goto _LL1E5;_tmp245=((struct Cyc_Absyn_Datatype_d_struct*)_tmp241)->f1;
_tmp246=*_tmp245;_tmp247=(void*)_tmp246.sc;_tmp248=_tmp246.name;_tmp249=_tmp246.tvs;
_tmp24A=_tmp246.fields;_tmp24B=_tmp246.is_extensible;_tmp24C=_tmp246.is_flat;
_LL1E4: Cyc_Absyndump_dumpscope(_tmp247);{const char*_tmp3C7;Cyc_Absyndump_dump(((
_tmp3C7="datatype",_tag_dyneither(_tmp3C7,sizeof(char),9))));}if(_tmp24C){const
char*_tmp3C8;Cyc_Absyndump_dump_nospace(((_tmp3C8=" __attribute__((flat))",
_tag_dyneither(_tmp3C8,sizeof(char),23))));}Cyc_Absyndump_dumpqvar(_tmp248);Cyc_Absyndump_dumptvars(
_tmp249);if(_tmp24B){const char*_tmp3C9;Cyc_Absyndump_dump(((_tmp3C9="@extensible",
_tag_dyneither(_tmp3C9,sizeof(char),12))));}if(_tmp24A == 0)Cyc_Absyndump_dump_semi();
else{Cyc_Absyndump_dump_char((int)'{');Cyc_Absyndump_dumpdatatypefields((struct
Cyc_List_List*)_tmp24A->v);{const char*_tmp3CA;Cyc_Absyndump_dump_nospace(((
_tmp3CA="};",_tag_dyneither(_tmp3CA,sizeof(char),3))));}}goto _LL1DC;_LL1E5: if(*((
int*)_tmp241)!= 8)goto _LL1E7;_tmp24D=((struct Cyc_Absyn_Enum_d_struct*)_tmp241)->f1;
...
_tag_dyneither(_tmp3CF,sizeof(char),7))));}{const char*_tmp3D0;Cyc_Absyndump_dump(((
_tmp3D0="<",_tag_dyneither(_tmp3D0,sizeof(char),2))));}Cyc_Absyndump_dumptvar(
_tmp255);{const char*_tmp3D1;Cyc_Absyndump_dump(((_tmp3D1="> ",_tag_dyneither(
_tmp3D1,sizeof(char),3))));}Cyc_Absyndump_dumpqvar(_tmp256->name);if(_tmp257){
const char*_tmp3D2;Cyc_Absyndump_dump(((_tmp3D2="@resetable",_tag_dyneither(
_tmp3D2,sizeof(char),11))));}if(_tmp258 != 0){{const char*_tmp3D3;Cyc_Absyndump_dump(((
_tmp3D3=" = open(",_tag_dyneither(_tmp3D3,sizeof(char),9))));}Cyc_Absyndump_dumpexp((
struct Cyc_Absyn_Exp*)_tmp258);{const char*_tmp3D4;Cyc_Absyndump_dump(((_tmp3D4=")",
_tag_dyneither(_tmp3D4,sizeof(char),2))));}}Cyc_Absyndump_dump_semi();goto _LL1DC;
...
struct Cyc_Absyn_Alias_d_struct*)_tmp241)->f3;_LL1EE:{const char*_tmp3D5;Cyc_Absyndump_dump(((
_tmp3D5="alias ",_tag_dyneither(_tmp3D5,sizeof(char),7))));}{const char*_tmp3D6;
Cyc_Absyndump_dump(((_tmp3D6="<",_tag_dyneither(_tmp3D6,sizeof(char),2))));}Cyc_Absyndump_dumptvar(
...
const char*_tmp3E2;Cyc_Absyndump_dump(((_tmp3E2="@zeroterm",_tag_dyneither(
_tmp3E2,sizeof(char),10))));}{void*_tmp298=Cyc_Tcutil_compress(_tmp290);struct
Cyc_Absyn_Tvar*_tmp299;struct Cyc_Core_Opt*_tmp29A;_LL217: if((int)_tmp298 != 2)
goto _LL219;_LL218: goto _LL216;_LL219: if(_tmp298 <= (void*)4)goto _LL21D;if(*((int*)
_tmp298)!= 1)goto _LL21B;_tmp299=((struct Cyc_Absyn_VarType_struct*)_tmp298)->f1;
_LL21A: Cyc_Absyndump_dump_str(_tmp299->name);goto _LL216;_LL21B: if(*((int*)
_tmp298)!= 0)goto _LL21D;_tmp29A=((struct Cyc_Absyn_Evar_struct*)_tmp298)->f2;if(
_tmp29A != 0)goto _LL21D;_LL21C: Cyc_Absyndump_dumpntyp(Cyc_Tcutil_compress(_tmp290));
goto _LL216;_LL21D:;_LL21E: {const char*_tmp3E5;void*_tmp3E4;(_tmp3E4=0,Cyc_Tcutil_impos(((
_tmp3E5="dumptms: bad rgn type in Pointer_mod",_tag_dyneither(_tmp3E5,sizeof(
char),37))),_tag_dyneither(_tmp3E4,sizeof(void*),0)));}_LL216:;}Cyc_Absyndump_dumptq(
...
_tmp3E7="@zeroterm",_tag_dyneither(_tmp3E7,sizeof(char),10))));}goto _LL224;
_LL227: if(*((int*)_tmp29E)!= 1)goto _LL229;_tmp2A0=((struct Cyc_Absyn_ConstArray_mod_struct*)
...
_tag_dyneither(_tmp3E8,sizeof(char),10))));}goto _LL224;_LL229: if(*((int*)_tmp29E)
