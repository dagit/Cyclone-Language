...
_tmp383;(_tmp383=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp384="error locations not for VarRoots",_tag_dyneither(_tmp384,sizeof(char),
33))),_tag_dyneither(_tmp383,sizeof(void*),0)));}_LL0:;}}static void Cyc_CfFlowInfo_unique_err(
struct Cyc_CfFlowInfo_Place*place,struct _dyneither_ptr err_msg1,struct
_dyneither_ptr err_msg2,struct Cyc_Position_Segment*consumed_loc,struct Cyc_Position_Segment*
loc);static void Cyc_CfFlowInfo_unique_err(struct Cyc_CfFlowInfo_Place*place,struct
...
_dyneither_ptr)_tmp19,((_tmp386.tag=0,((_tmp386.f1=(struct _dyneither_ptr)_tmp18,((
_tmp387[0]=& _tmp386,((_tmp387[1]=& _tmp385,Cyc_Tcutil_terr(loc,err_msg1,
_tag_dyneither(_tmp387,sizeof(void*),2)))))))))))));}else{void*_tmp389[1];struct
Cyc_String_pa_struct _tmp388;(_tmp388.tag=0,((_tmp388.f1=(struct _dyneither_ptr)
_tmp18,((_tmp389[0]=& _tmp388,Cyc_Tcutil_terr(loc,err_msg2,_tag_dyneither(_tmp389,
sizeof(void*),1)))))));}}static struct Cyc_Position_Segment*Cyc_CfFlowInfo_combine_consume_f(
int isErr,struct Cyc_CfFlowInfo_Place*place,struct Cyc_Position_Segment*loc1,struct
Cyc_Position_Segment*loc2);static struct Cyc_Position_Segment*Cyc_CfFlowInfo_combine_consume_f(
int isErr,struct Cyc_CfFlowInfo_Place*place,struct Cyc_Position_Segment*loc1,struct
Cyc_Position_Segment*loc2){if(isErr){const char*_tmp38B;const char*_tmp38A;Cyc_CfFlowInfo_unique_err(
place,((_tmp38A="May consume non-aliased pointer %s more than once (cf. %s)",
_tag_dyneither(_tmp38A,sizeof(char),59))),((_tmp38B="May consume non-aliased pointer %s more than once",
_tag_dyneither(_tmp38B,sizeof(char),50))),loc1,loc2);}return loc1;}struct Cyc_Dict_Dict
Cyc_CfFlowInfo_union_place_set(struct Cyc_Dict_Dict s1,struct Cyc_Dict_Dict s2,int
...
_tmp48)->f1;_LL1B:{struct _dyneither_ptr*_tmp399;const char*_tmp398;void*_tmp397[1];
struct Cyc_String_pa_struct _tmp396;struct Cyc_List_List*_tmp395;sl=((_tmp395=
_cycalloc(sizeof(*_tmp395)),((_tmp395->hd=((_tmp399=_cycalloc(sizeof(*_tmp399)),((
_tmp399[0]=((_tmp396.tag=0,((_tmp396.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*(*_tmp49->name).f2),((_tmp397[0]=& _tmp396,Cyc_aprintf(((_tmp398="%s",
_tag_dyneither(_tmp398,sizeof(char),3))),_tag_dyneither(_tmp397,sizeof(void*),1)))))))),
_tmp399)))),((_tmp395->tl=sl,_tmp395))))));}goto _LL19;_LL1C: if(*((int*)_tmp48)!= 
1)goto _LL1E;_tmp4A=((struct Cyc_CfFlowInfo_MallocPt_struct*)_tmp48)->f1;_LL1D:{
struct _dyneither_ptr*_tmp3A6;const char*_tmp3A5;void*_tmp3A4[1];struct Cyc_Int_pa_struct
_tmp3A3;struct Cyc_List_List*_tmp3A2;sl=((_tmp3A2=_cycalloc(sizeof(*_tmp3A2)),((
_tmp3A2->hd=((_tmp3A6=_cycalloc(sizeof(*_tmp3A6)),((_tmp3A6[0]=((_tmp3A3.tag=1,((
_tmp3A3.f1=(unsigned long)((int)_tmp4A),((_tmp3A4[0]=& _tmp3A3,Cyc_aprintf(((
_tmp3A5="mpt%d",_tag_dyneither(_tmp3A5,sizeof(char),6))),_tag_dyneither(_tmp3A4,
sizeof(void*),1)))))))),_tmp3A6)))),((_tmp3A2->tl=sl,_tmp3A2))))));}goto _LL19;
_LL1E: if(*((int*)_tmp48)!= 2)goto _LL19;_tmp4B=((struct Cyc_CfFlowInfo_InitParam_struct*)
_tmp48)->f1;_LL1F:{struct _dyneither_ptr*_tmp3B3;const char*_tmp3B2;void*_tmp3B1[1];
struct Cyc_Int_pa_struct _tmp3B0;struct Cyc_List_List*_tmp3AF;sl=((_tmp3AF=
_cycalloc(sizeof(*_tmp3AF)),((_tmp3AF->hd=((_tmp3B3=_cycalloc(sizeof(*_tmp3B3)),((
_tmp3B3[0]=((_tmp3B0.tag=1,((_tmp3B0.f1=(unsigned long)_tmp4B,((_tmp3B1[0]=&
_tmp3B0,Cyc_aprintf(((_tmp3B2="param%d",_tag_dyneither(_tmp3B2,sizeof(char),8))),
_tag_dyneither(_tmp3B1,sizeof(void*),1)))))))),_tmp3B3)))),((_tmp3AF->tl=sl,
_tmp3AF))))));}goto _LL19;_LL19:;}for(0;_tmp47 != 0;_tmp47=_tmp47->tl){struct
_dyneither_ptr*_tmp3C0;const char*_tmp3BF;void*_tmp3BE[1];struct Cyc_Int_pa_struct
...
_tmp3BF="%d",_tag_dyneither(_tmp3BF,sizeof(char),3))),_tag_dyneither(_tmp3BE,
sizeof(void*),1)))))))),_tmp3C0)))),((_tmp3BC->tl=sl,_tmp3BC))))));}{struct Cyc_String_pa_struct
_tmp3CB;void*_tmp3CA[1];const char*_tmp3C9;const char*_tmp3C8;struct _dyneither_ptr*
_tmp3C7;struct _dyneither_ptr*_tmp60=(_tmp3C7=_cycalloc(sizeof(*_tmp3C7)),((
_tmp3C7[0]=((_tmp3CB.tag=0,((_tmp3CB.f1=(struct _dyneither_ptr)((_tmp3C8="",
_tag_dyneither(_tmp3C8,sizeof(char),1))),((_tmp3CA[0]=& _tmp3CB,Cyc_aprintf(((
_tmp3C9="%s",_tag_dyneither(_tmp3C9,sizeof(char),3))),_tag_dyneither(_tmp3CA,
sizeof(void*),1)))))))),_tmp3C7)));for(0;sl != 0;sl=sl->tl){const char*_tmp3D0;
void*_tmp3CF[2];struct Cyc_String_pa_struct _tmp3CE;struct Cyc_String_pa_struct
_tmp3CD;*_tmp60=((_tmp3CD.tag=0,((_tmp3CD.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*_tmp60),((_tmp3CE.tag=0,((_tmp3CE.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)*((struct _dyneither_ptr*)sl->hd)),((_tmp3CF[0]=& _tmp3CE,((
_tmp3CF[1]=& _tmp3CD,Cyc_aprintf(((_tmp3D0="%s.%s",_tag_dyneither(_tmp3D0,sizeof(
char),6))),_tag_dyneither(_tmp3CF,sizeof(void*),2))))))))))))));}return _tmp60;}}
...
_tmp3D2)[*_tmp3D5]=(void*)(*fenv)->unknown_all;}}struct _dyneither_ptr Cyc_CfFlowInfo_aggrfields_to_aggrdict(
...
unsigned int _tmp3D5;unsigned int _tmp3D4;struct _dyneither_ptr _tmp3D3;void**
_tmp3D2;unsigned int _tmp3D1;struct _dyneither_ptr d=(_tmp3D1=sz,((_tmp3D2=(void**)
_region_malloc(fenv->r,_check_times(sizeof(void*),_tmp3D1)),((_tmp3D3=
_tag_dyneither(_tmp3D2,sizeof(void*),_tmp3D1),((((_tmp3D4=_tmp3D1,_tmp3D6(& fenv,&
_tmp3D5,& _tmp3D4,& _tmp3D2))),_tmp3D3)))))));{int i=0;for(0;i < sz;(i ++,fs=fs->tl)){
struct Cyc_Absyn_Aggrfield _tmp6B;struct _dyneither_ptr*_tmp6C;void*_tmp6D;struct
...
if(_get_dyneither_size(*_tmp6C,sizeof(char))!= 1)*((void**)
...
_tmp76);unsigned int _tmp3DB;unsigned int _tmp3DA;struct _dyneither_ptr _tmp3D9;void**
_tmp3D8;unsigned int _tmp3D7;struct _dyneither_ptr d=(_tmp3D7=sz,((_tmp3D8=(void**)
_region_malloc(fenv->r,_check_times(sizeof(void*),_tmp3D7)),((_tmp3D9=
_tag_dyneither(_tmp3D8,sizeof(void*),_tmp3D7),((((_tmp3DA=_tmp3D7,_tmp3DC(& fenv,&
...
_tag_dyneither(_tmp3EA,sizeof(struct Cyc_CfFlowInfo_TagCmp*),1)))),_tmp3EC)))),
...
static void Cyc_CfFlowInfo_add_places(struct Cyc_CfFlowInfo_EscPile*pile,void*r){
void*_tmpA3=r;struct Cyc_CfFlowInfo_Place*_tmpA4;struct _dyneither_ptr _tmpA5;_LL44:
if(_tmpA3 <= (void*)3)goto _LL48;if(*((int*)_tmpA3)!= 2)goto _LL46;_tmpA4=((struct
Cyc_CfFlowInfo_AddressOf_struct*)_tmpA3)->f1;_LL45: Cyc_CfFlowInfo_add_place(pile,
_tmpA4);return;_LL46: if(*((int*)_tmpA3)!= 4)goto _LL48;_tmpA5=((struct Cyc_CfFlowInfo_Aggregate_struct*)
...
r,void*new_val,void*old_val);static void _tmp3F4(struct _RegionHandle**r,void**
new_val,struct _dyneither_ptr*_tmpA7,unsigned int*_tmp3F3,unsigned int*_tmp3F2,
void***_tmp3F0){for(*_tmp3F3=0;*_tmp3F3 < *_tmp3F2;(*_tmp3F3)++){(*_tmp3F0)[*
_tmp3F3]=Cyc_CfFlowInfo_insert_place_inner(*r,*new_val,((void**)(*_tmpA7).curr)[(
int)*_tmp3F3]);}}static void*Cyc_CfFlowInfo_insert_place_inner(struct
...
unsigned int _tmp3F3;unsigned int _tmp3F2;struct _dyneither_ptr _tmp3F1;void**
_tmp3F0;unsigned int _tmp3EF;struct _dyneither_ptr d2=(_tmp3EF=_get_dyneither_size(
_tmpA7,sizeof(void*)),((_tmp3F0=(void**)_region_malloc(r,_check_times(sizeof(
void*),_tmp3EF)),((_tmp3F1=_tag_dyneither(_tmp3F0,sizeof(void*),_tmp3EF),((((
_tmp3F2=_tmp3EF,_tmp3F4(& r,& new_val,& _tmpA7,& _tmp3F3,& _tmp3F2,& _tmp3F0))),
_tmp3F1)))))));struct Cyc_CfFlowInfo_Aggregate_struct _tmp3F7;struct Cyc_CfFlowInfo_Aggregate_struct*
_tmp3F6;return(void*)((_tmp3F6=_region_malloc(r,sizeof(*_tmp3F6)),((_tmp3F6[0]=((
_tmp3F7.tag=4,((_tmp3F7.f1=d2,_tmp3F7)))),_tmp3F6))));}_LL4D:;_LL4E: return
new_val;_LL4A:;}static struct _dyneither_ptr Cyc_CfFlowInfo_aggr_dict_insert(struct
_RegionHandle*r,struct _dyneither_ptr d,int n,void*rval);static void _tmp3FD(struct
_dyneither_ptr*d,unsigned int*_tmp3FC,unsigned int*_tmp3FB,void***_tmp3F9){for(*
_tmp3FC=0;*_tmp3FC < *_tmp3FB;(*_tmp3FC)++){(*_tmp3F9)[*_tmp3FC]=((void**)(*d).curr)[(
int)*_tmp3FC];}}static struct _dyneither_ptr Cyc_CfFlowInfo_aggr_dict_insert(struct
_RegionHandle*r,struct _dyneither_ptr d,int n,void*rval){void*_tmpAE=*((void**)
_check_dyneither_subscript(d,sizeof(void*),n));if(_tmpAE == rval)return d;{
unsigned int _tmp3FC;unsigned int _tmp3FB;struct _dyneither_ptr _tmp3FA;void**
_tmp3F9;unsigned int _tmp3F8;struct _dyneither_ptr res=(_tmp3F8=_get_dyneither_size(
d,sizeof(void*)),((_tmp3F9=(void**)_region_malloc(r,_check_times(sizeof(void*),
_tmp3F8)),((_tmp3FA=_tag_dyneither(_tmp3F9,sizeof(void*),_tmp3F8),((((_tmp3FB=
_tmp3F8,_tmp3FD(& d,& _tmp3FC,& _tmp3FB,& _tmp3F9))),_tmp3FA)))))));*((void**)
...
_tmpB6;int _tmpB7;struct Cyc_List_List*_tmpB8;void*_tmpB9;struct _dyneither_ptr
...
_tmpBC.curr == _tmpBA.curr)return old_val;else{struct Cyc_CfFlowInfo_Aggregate_struct
...
_tmp407.f1=((_tmp406="bad insert place",_tag_dyneither(_tmp406,sizeof(char),17))),
_tmp407)))),_tmp405)))));}_LL4F:;}}static struct Cyc_Dict_Dict Cyc_CfFlowInfo_escape_these(
...
void*r);static void*Cyc_CfFlowInfo_initlevel_approx(void*r){void*_tmpCC=r;void*
_tmpCD;void*_tmpCE;_LL61: if(_tmpCC <= (void*)3)goto _LL65;if(*((int*)_tmpCC)!= 0)
goto _LL63;_tmpCD=(void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)_tmpCC)->f1;
_LL62: return _tmpCD;_LL63: if(*((int*)_tmpCC)!= 1)goto _LL65;_tmpCE=(void*)((struct
Cyc_CfFlowInfo_Esc_struct*)_tmpCC)->f1;_LL64: return _tmpCE;_LL65: if((int)_tmpCC != 
0)goto _LL67;_LL66: goto _LL68;_LL67: if((int)_tmpCC != 1)goto _LL69;_LL68: return(void*)
2;_LL69: if((int)_tmpCC != 2)goto _LL6B;_LL6A: return(void*)1;_LL6B: if(_tmpCC <= (
void*)3)goto _LL6D;if(*((int*)_tmpCC)!= 3)goto _LL6D;_LL6C: return(void*)2;_LL6D:;
_LL6E: {struct Cyc_Core_Impossible_struct _tmp40D;const char*_tmp40C;struct Cyc_Core_Impossible_struct*
_tmp40B;(int)_throw((void*)((_tmp40B=_cycalloc(sizeof(*_tmp40B)),((_tmp40B[0]=((
_tmp40D.tag=Cyc_Core_Impossible,((_tmp40D.f1=((_tmp40C="initlevel_approx",
_tag_dyneither(_tmp40C,sizeof(char),17))),_tmp40D)))),_tmp40B)))));}_LL60:;}
...
r;struct _dyneither_ptr _tmpD3;struct Cyc_CfFlowInfo_Place*_tmpD4;_LL70: if(_tmpD2 <= (
...
_tmp410)));void*_tmpE1;struct _dyneither_ptr _tmpE2;int _tmpE3;_LL77: _tmpE1=_tmpE0.f1;
...
void**)_check_dyneither_subscript(_tmpE2,sizeof(void*),_tmpE3));goto _LL76;_LL79:;
...
_tag_dyneither(_tmp415,sizeof(char),17))),_tmp416)))),_tmp414)))));}_LL76:;}
return _tmpDE;}}static int Cyc_CfFlowInfo_is_rval_unescaped(void*rval);static int Cyc_CfFlowInfo_is_rval_unescaped(
...
struct Cyc_CfFlowInfo_AssignEnv**env,struct _dyneither_ptr*_tmpF5,struct
_dyneither_ptr*_tmpF3,unsigned int*_tmp420,unsigned int*_tmp41F,void***_tmp41D){
for(*_tmp420=0;*_tmp420 < *_tmp41F;(*_tmp420)++){(*_tmp41D)[*_tmp420]=Cyc_CfFlowInfo_assign_place_inner(*
env,((void**)(*_tmpF3).curr)[(int)*_tmp420],*((void**)_check_dyneither_subscript(*
_tmpF5,sizeof(void*),(int)*_tmp420)));}}static void*Cyc_CfFlowInfo_assign_place_inner(
struct Cyc_CfFlowInfo_AssignEnv*env,void*oldval,void*newval){struct _tuple0 _tmp418;
struct _tuple0 _tmpED=(_tmp418.f1=oldval,((_tmp418.f2=newval,_tmp418)));void*
_tmpEE;void*_tmpEF;struct Cyc_CfFlowInfo_Place*_tmpF0;void*_tmpF1;void*_tmpF2;
struct _dyneither_ptr _tmpF3;void*_tmpF4;struct _dyneither_ptr _tmpF5;void*_tmpF6;
void*_tmpF7;_LL83: _tmpEE=_tmpED.f1;if(_tmpEE <= (void*)3)goto _LL85;if(*((int*)
_tmpEE)!= 1)goto _LL85;_tmpEF=_tmpED.f2;if(_tmpEF <= (void*)3)goto _LL85;if(*((int*)
_tmpEF)!= 2)goto _LL85;_tmpF0=((struct Cyc_CfFlowInfo_AddressOf_struct*)_tmpEF)->f1;
_LL84: Cyc_CfFlowInfo_add_place(env->pile,_tmpF0);goto _LL86;_LL85: _tmpF1=_tmpED.f1;
if(_tmpF1 <= (void*)3)goto _LL87;if(*((int*)_tmpF1)!= 1)goto _LL87;_LL86: if(Cyc_CfFlowInfo_initlevel(
env->d,newval)!= (void*)2){const char*_tmp41B;void*_tmp41A;(_tmp41A=0,Cyc_Tcutil_terr(
env->loc,((_tmp41B="assignment puts possibly-uninitialized data in an escaped location",
_tag_dyneither(_tmp41B,sizeof(char),67))),_tag_dyneither(_tmp41A,sizeof(void*),0)));}
...
unsigned int _tmp420;unsigned int _tmp41F;struct _dyneither_ptr _tmp41E;void**
_tmp41D;unsigned int _tmp41C;struct _dyneither_ptr new_d=(_tmp41C=
_get_dyneither_size(_tmpF3,sizeof(void*)),((_tmp41D=(void**)_region_malloc((env->fenv)->r,
_check_times(sizeof(void*),_tmp41C)),((_tmp41E=_tag_dyneither(_tmp41D,sizeof(
void*),_tmp41C),((((_tmp41F=_tmp41C,_tmp421(& env,& _tmpF5,& _tmpF3,& _tmp420,&
_tmp41F,& _tmp41D))),_tmp41E)))))));int change=0;{int i=0;for(0;i < 
_get_dyneither_size(_tmpF3,sizeof(void*));++ i){if(*((void**)
_check_dyneither_subscript(new_d,sizeof(void*),i))!= ((void**)_tmpF3.curr)[i]){
...
change)return newval;{struct Cyc_CfFlowInfo_Aggregate_struct _tmp424;struct Cyc_CfFlowInfo_Aggregate_struct*
_tmp423;return(void*)((_tmp423=_region_malloc((env->fenv)->r,sizeof(*_tmp423)),((
_tmp423[0]=((_tmp424.tag=4,((_tmp424.f1=new_d,_tmp424)))),_tmp423))));}}_LL89:
_tmpF6=_tmpED.f2;if(_tmpF6 <= (void*)3)goto _LL8B;if(*((int*)_tmpF6)!= 1)goto _LL8B;
_tmpF7=(void*)((struct Cyc_CfFlowInfo_Esc_struct*)_tmpF6)->f1;_LL8A: {void*
_tmp100=_tmpF7;_LL8E: if((int)_tmp100 != 0)goto _LL90;_LL8F: return(void*)(env->fenv)->unknown_none;
_LL90: if((int)_tmp100 != 1)goto _LL92;_LL91: return(void*)(env->fenv)->unknown_this;
_LL92: if((int)_tmp100 != 2)goto _LL8D;_LL93: return(void*)(env->fenv)->unknown_all;
_LL8D:;}_LL8B:;_LL8C: return newval;_LL82:;}static void*Cyc_CfFlowInfo_assign_place_outer(
...
env,oldval,newval);{struct _tuple8 _tmp425;struct _tuple8 _tmp102=(_tmp425.f1=fs,((
_tmp425.f2=oldval,_tmp425)));struct Cyc_List_List*_tmp103;struct Cyc_List_List
_tmp104;int _tmp105;struct Cyc_List_List*_tmp106;void*_tmp107;struct _dyneither_ptr
_tmp108;_LL95: _tmp103=_tmp102.f1;if(_tmp103 == 0)goto _LL97;_tmp104=*_tmp103;
_tmp105=(int)_tmp104.hd;_tmp106=_tmp104.tl;_tmp107=_tmp102.f2;if(_tmp107 <= (void*)
3)goto _LL97;if(*((int*)_tmp107)!= 4)goto _LL97;_tmp108=((struct Cyc_CfFlowInfo_Aggregate_struct*)
...
_tmp105,_tmp109);if(_tmp10A.curr == _tmp108.curr)return oldval;else{struct Cyc_CfFlowInfo_Aggregate_struct
_tmp428;struct Cyc_CfFlowInfo_Aggregate_struct*_tmp427;return(void*)((_tmp427=
_region_malloc((env->fenv)->r,sizeof(*_tmp427)),((_tmp427[0]=((_tmp428.tag=4,((
_tmp428.f1=_tmp10A,_tmp428)))),_tmp427))));}}_LL97:;_LL98: {struct Cyc_Core_Impossible_struct
_tmp42E;const char*_tmp42D;struct Cyc_Core_Impossible_struct*_tmp42C;(int)_throw((
void*)((_tmp42C=_cycalloc(sizeof(*_tmp42C)),((_tmp42C[0]=((_tmp42E.tag=Cyc_Core_Impossible,((
_tmp42E.f1=((_tmp42D="bad assign place",_tag_dyneither(_tmp42D,sizeof(char),17))),
...
unsigned int*_tmp43A,unsigned int*_tmp439,void***_tmp437,struct _dyneither_ptr*
_tmp136,struct _dyneither_ptr*_tmp134){for(*_tmp43A=0;*_tmp43A < *_tmp439;(*
_tmp43A)++){(*_tmp437)[*_tmp43A]=((void*(*)(struct Cyc_CfFlowInfo_JoinEnv*env,int
a,void*r1,void*r2))Cyc_CfFlowInfo_join_absRval)(*env,0,((void**)(*_tmp134).curr)[(
int)*_tmp43A],*((void**)_check_dyneither_subscript(*_tmp136,sizeof(void*),(int)*
_tmp43A)));}}static void*Cyc_CfFlowInfo_join_absRval(struct Cyc_CfFlowInfo_JoinEnv*
env,void*a,void*r1,void*r2){if(r1 == r2)return r1;{struct _RegionHandle*_tmp124=(
env->fenv)->r;{struct _tuple0 _tmp435;struct _tuple0 _tmp126=(_tmp435.f1=r1,((
_tmp435.f2=r2,_tmp435)));void*_tmp127;struct Cyc_CfFlowInfo_Place*_tmp128;void*
_tmp129;struct Cyc_CfFlowInfo_Place*_tmp12A;void*_tmp12B;struct Cyc_CfFlowInfo_Place*
...
_LLA5: {unsigned int _tmp43A;unsigned int _tmp439;struct _dyneither_ptr _tmp438;void**
_tmp437;unsigned int _tmp436;struct _dyneither_ptr new_d=(_tmp436=
_get_dyneither_size(_tmp134,sizeof(void*)),((_tmp437=(void**)_region_malloc(
_tmp124,_check_times(sizeof(void*),_tmp436)),((_tmp438=_tag_dyneither(_tmp437,
...
_check_dyneither_subscript(new_d,sizeof(void*),i))!= ((void**)_tmp134.curr)[i]){
...
change)return r2;{struct Cyc_CfFlowInfo_Aggregate_struct _tmp43E;struct Cyc_CfFlowInfo_Aggregate_struct*
...
r2s)return r1s;{struct Cyc_List_List*res=0;int diff=0;{struct Cyc_List_List*_tmp16C=
r1s;for(0;_tmp16C != 0;_tmp16C=_tmp16C->tl){struct Cyc_CfFlowInfo_Reln*_tmp16D=(
struct Cyc_CfFlowInfo_Reln*)_tmp16C->hd;int found=0;{struct Cyc_List_List*_tmp16E=
r2s;for(0;_tmp16E != 0;_tmp16E=_tmp16E->tl){struct Cyc_CfFlowInfo_Reln*_tmp16F=(
struct Cyc_CfFlowInfo_Reln*)_tmp16E->hd;if(_tmp16D == _tmp16F  || _tmp16D->vd == 
_tmp16F->vd  && Cyc_CfFlowInfo_same_relop(_tmp16D->rop,_tmp16F->rop)){{struct Cyc_List_List*
_tmp446;res=((_tmp446=_region_malloc(r,sizeof(*_tmp446)),((_tmp446->hd=_tmp16D,((
_tmp446->tl=res,_tmp446))))));}found=1;break;}}}if(!found)diff=1;}}if(!diff)res=
...
Cyc_fprintf(Cyc_stderr,((_tmp449=", ",_tag_dyneither(_tmp449,sizeof(char),3))),
_tag_dyneither(_tmp448,sizeof(void*),0)));}_tmp176=0;}Cyc_CfFlowInfo_print_place((
struct Cyc_CfFlowInfo_Place*)x->hd);x=x->tl;}{const char*_tmp44C;void*_tmp44B;(
_tmp44B=0,Cyc_fprintf(Cyc_stderr,((_tmp44C="\n",_tag_dyneither(_tmp44C,sizeof(
char),2))),_tag_dyneither(_tmp44B,sizeof(void*),0)));}}static struct Cyc_CfFlowInfo_ConsumeInfo
...
_tmp465.f1=((_tmp464="join_flow_and_rval: BottomFL outflow",_tag_dyneither(
_tmp464,sizeof(char),37))),_tmp465)))),_tmp463)))));}_LLE4:;}}}static void*Cyc_CfFlowInfo_after_absRval_d(
struct Cyc_CfFlowInfo_AfterEnv*,int,void*,void*);static void*Cyc_CfFlowInfo_after_absRval(
struct Cyc_CfFlowInfo_AfterEnv*env,void*r1,void*r2);static void _tmp46C(struct Cyc_CfFlowInfo_AfterEnv**
env,unsigned int*_tmp46B,unsigned int*_tmp46A,void***_tmp468,struct
_dyneither_ptr*_tmp1BC,struct _dyneither_ptr*_tmp1BA){for(*_tmp46B=0;*_tmp46B < *
_tmp46A;(*_tmp46B)++){(*_tmp468)[*_tmp46B]=Cyc_CfFlowInfo_after_absRval_d(*env,(
int)*_tmp46B,((void**)(*_tmp1BA).curr)[(int)*_tmp46B],*((void**)
_check_dyneither_subscript(*_tmp1BC,sizeof(void*),(int)*_tmp46B)));}}static void*
...
struct _dyneither_ptr _tmp1BA;void*_tmp1BB;struct _dyneither_ptr _tmp1BC;_LLEE:
...
unsigned int _tmp46B;unsigned int _tmp46A;struct _dyneither_ptr _tmp469;void**
_tmp468;unsigned int _tmp467;struct _dyneither_ptr new_d=(_tmp467=
_get_dyneither_size(_tmp1BA,sizeof(void*)),((_tmp468=(void**)_region_malloc(((
env->joinenv).fenv)->r,_check_times(sizeof(void*),_tmp467)),((_tmp469=
_tag_dyneither(_tmp468,sizeof(void*),_tmp467),((((_tmp46A=_tmp467,_tmp46C(& env,&
_tmp46B,& _tmp46A,& _tmp468,& _tmp1BC,& _tmp1BA))),_tmp469)))))));int change=0;{int i=
0;for(0;i < _get_dyneither_size(_tmp1BA,sizeof(void*));++ i){if(*((void**)
_check_dyneither_subscript(new_d,sizeof(void*),i))!= ((void**)_tmp1BA.curr)[i]){
change=1;break;}}}if(!change)return r1;change=0;{int i=0;for(0;i < 
_get_dyneither_size(_tmp1BA,sizeof(void*));++ i){if(*((void**)
_check_dyneither_subscript(new_d,sizeof(void*),i))!= *((void**)
_check_dyneither_subscript(_tmp1BC,sizeof(void*),i))){change=1;break;}}}if(!
change)return r2;{struct Cyc_CfFlowInfo_Aggregate_struct _tmp46F;struct Cyc_CfFlowInfo_Aggregate_struct*
...
_tmp474="after_absRval -- non-aggregates!",_tag_dyneither(_tmp474,sizeof(char),
33))),_tmp475)))),_tmp473)))));}_LLED:;}}static void*Cyc_CfFlowInfo_after_absRval_d(
...
_tmp1C7=env->changed;{struct Cyc_List_List*_tmp476;*env->last_field_cell=((
_tmp476=_region_malloc(((env->joinenv).fenv)->r,sizeof(*_tmp476)),((_tmp476->hd=(
void*)key,((_tmp476->tl=0,_tmp476))))));}env->last_field_cell=(struct Cyc_List_List**)&((
struct Cyc_List_List*)_check_null(*env->last_field_cell))->tl;{void*_tmp1C9=Cyc_CfFlowInfo_after_absRval(
...
struct Cyc_CfFlowInfo_Place _tmp477;*env->curr_place=((_tmp477.root=(void*)root,((
_tmp477.fields=0,_tmp477))));}env->last_field_cell=(struct Cyc_List_List**)&(env->curr_place)->fields;
...
fenv,struct Cyc_Dict_Dict*all_changed,union Cyc_CfFlowInfo_FlowInfo_union f1,union
Cyc_CfFlowInfo_FlowInfo_union f2,struct Cyc_Dict_Dict chg1,struct Cyc_Dict_Dict chg2){
struct _tuple11 _tmp478;struct _tuple11 _tmp1CC=(_tmp478.f1=f1,((_tmp478.f2=f2,
_tmp478)));union Cyc_CfFlowInfo_FlowInfo_union _tmp1CD;union Cyc_CfFlowInfo_FlowInfo_union
...
_LLF7;_LLF6: {union Cyc_CfFlowInfo_FlowInfo_union _tmp479;return(union Cyc_CfFlowInfo_FlowInfo_union)(((
...
_tmp21E.LessNumelts).tag != 2)goto _LL129;_tmp220=(_tmp21E.LessNumelts).f1;_LL128:
_tmp221=_tmp220;goto _LL12A;_LL129: if((_tmp21E.LessEqNumelts).tag != 4)goto _LL12B;
_tmp221=(_tmp21E.LessEqNumelts).f1;_LL12A: if(v == _tmp221)found=1;goto _LL124;
_LL12B:;_LL12C: goto _LL124;_LL124:;}}if(!found)return rs;{struct Cyc_List_List*
_tmp222=0;for(p=rs;p != 0;p=p->tl){struct Cyc_CfFlowInfo_Reln*_tmp223=(struct Cyc_CfFlowInfo_Reln*)
...
_LL12F: _tmp226=_tmp225;goto _LL131;_LL130: if((_tmp224.LessNumelts).tag != 2)goto
_LL132;_tmp226=(_tmp224.LessNumelts).f1;_LL131: _tmp227=_tmp226;goto _LL133;_LL132:
if((_tmp224.LessEqNumelts).tag != 4)goto _LL134;_tmp227=(_tmp224.LessEqNumelts).f1;
...
_tmp243,((_tmp48C->rop=(union Cyc_CfFlowInfo_RelnOp_union)(((_tmp48B.LessEqNumelts).tag=
4,(((_tmp48B.LessEqNumelts).f1=v,_tmp48B)))),_tmp48C)))))),((_tmp48A->tl=r,
_tmp48A)))));}_LL151:;_LL152: return r;_LL146:;}_LL144:;_LL145: goto _LL141;_LL141:;}{
void*_tmp247=Cyc_Tcutil_compress((void*)v->type);_LL154: if(_tmp247 <= (void*)4)
goto _LL156;if(*((int*)_tmp247)!= 5)goto _LL156;_LL155: goto _LL153;_LL156:;_LL157:
return r;_LL153:;}loop: {void*_tmp248=(void*)e->r;struct Cyc_Absyn_Exp*_tmp249;
union Cyc_Absyn_Cnst_union _tmp24A;int _tmp24B;void*_tmp24C;struct Cyc_List_List*
_tmp24D;struct Cyc_List_List _tmp24E;struct Cyc_List_List*_tmp24F;struct Cyc_List_List
_tmp250;struct Cyc_Absyn_Exp*_tmp251;void*_tmp252;struct Cyc_List_List*_tmp253;
struct Cyc_List_List _tmp254;struct Cyc_Absyn_Exp*_tmp255;_LL159: if(*((int*)_tmp248)
!= 15)goto _LL15B;_tmp249=((struct Cyc_Absyn_Cast_e_struct*)_tmp248)->f2;_LL15A: e=
_tmp249;goto loop;_LL15B: if(*((int*)_tmp248)!= 0)goto _LL15D;_tmp24A=((struct Cyc_Absyn_Const_e_struct*)
_tmp248)->f1;if(((((struct Cyc_Absyn_Const_e_struct*)_tmp248)->f1).Int_c).tag != 2)
goto _LL15D;_tmp24B=(_tmp24A.Int_c).f2;_LL15C: {struct Cyc_CfFlowInfo_Reln*_tmp492;
union Cyc_CfFlowInfo_RelnOp_union _tmp491;struct Cyc_List_List*_tmp490;return(
_tmp490=_region_malloc(rgn,sizeof(*_tmp490)),((_tmp490->hd=((_tmp492=
_region_malloc(rgn,sizeof(*_tmp492)),((_tmp492->vd=v,((_tmp492->rop=(union Cyc_CfFlowInfo_RelnOp_union)(((
_tmp491.EqualConst).tag=0,(((_tmp491.EqualConst).f1=(unsigned int)_tmp24B,
_tmp491)))),_tmp492)))))),((_tmp490->tl=r,_tmp490)))));}_LL15D: if(*((int*)
_tmp248)!= 3)goto _LL15F;_tmp24C=(void*)((struct Cyc_Absyn_Primop_e_struct*)
_tmp248)->f1;if((int)_tmp24C != 4)goto _LL15F;_tmp24D=((struct Cyc_Absyn_Primop_e_struct*)
_tmp248)->f2;if(_tmp24D == 0)goto _LL15F;_tmp24E=*_tmp24D;_tmp24F=_tmp24E.tl;if(
_tmp24F == 0)goto _LL15F;_tmp250=*_tmp24F;_tmp251=(struct Cyc_Absyn_Exp*)_tmp250.hd;
_LL15E:{void*_tmp259=(void*)_tmp251->r;void*_tmp25A;struct Cyc_List_List*_tmp25B;
struct Cyc_List_List _tmp25C;struct Cyc_Absyn_Exp*_tmp25D;_LL164: if(*((int*)_tmp259)
!= 3)goto _LL166;_tmp25A=(void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp259)->f1;
...
v,((_tmp498->rop=(union Cyc_CfFlowInfo_RelnOp_union)(((_tmp497.LessNumelts).tag=2,(((
_tmp497.LessNumelts).f1=_tmp266,_tmp497)))),_tmp498)))))),((_tmp496->tl=r,
_tmp496)))));}_LL171:;_LL172: goto _LL168;_LL168:;}goto _LL163;_LL166:;_LL167: goto
_LL163;_LL163:;}goto _LL158;_LL15F: if(*((int*)_tmp248)!= 3)goto _LL161;_tmp252=(
void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp248)->f1;_tmp253=((struct Cyc_Absyn_Primop_e_struct*)
...
v,((_tmp49E->rop=(union Cyc_CfFlowInfo_RelnOp_union)(((_tmp49D.LessEqNumelts).tag=
4,(((_tmp49D.LessEqNumelts).f1=_tmp272,_tmp49D)))),_tmp49E)))))),((_tmp49C->tl=r,
_tmp49C)))));}_LL17C:;_LL17D: goto _LL173;_LL173:;}goto _LL158;_LL161:;_LL162: goto
_LL158;_LL158:;}return r;}struct Cyc_List_List*Cyc_CfFlowInfo_reln_assign_exp(
...
_tmp276=(void*)e1->r;void*_tmp277;struct Cyc_Absyn_Vardecl*_tmp278;void*_tmp279;
struct Cyc_Absyn_Vardecl*_tmp27A;void*_tmp27B;struct Cyc_Absyn_Vardecl*_tmp27C;
void*_tmp27D;struct Cyc_Absyn_Vardecl*_tmp27E;_LL17F: if(*((int*)_tmp276)!= 1)goto
_LL181;_tmp277=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp276)->f2;if(_tmp277 <= (
void*)1)goto _LL181;if(*((int*)_tmp277)!= 0)goto _LL181;_tmp278=((struct Cyc_Absyn_Global_b_struct*)
_tmp277)->f1;_LL180: _tmp27A=_tmp278;goto _LL182;_LL181: if(*((int*)_tmp276)!= 1)
goto _LL183;_tmp279=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp276)->f2;if(
_tmp279 <= (void*)1)goto _LL183;if(*((int*)_tmp279)!= 2)goto _LL183;_tmp27A=((
struct Cyc_Absyn_Param_b_struct*)_tmp279)->f1;_LL182: _tmp27C=_tmp27A;goto _LL184;
_LL183: if(*((int*)_tmp276)!= 1)goto _LL185;_tmp27B=(void*)((struct Cyc_Absyn_Var_e_struct*)
...
_tmp4A0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string((
r->vd)->name)),((_tmp4A1[0]=& _tmp4A0,Cyc_fprintf(Cyc_stderr,((_tmp4A2="%s",
_tag_dyneither(_tmp4A2,sizeof(char),3))),_tag_dyneither(_tmp4A1,sizeof(void*),1)))))));}{
...
_LL18B:{const char*_tmp4A6;void*_tmp4A5[1];struct Cyc_Int_pa_struct _tmp4A4;(
_tmp4A4.tag=1,((_tmp4A4.f1=(unsigned long)((int)_tmp283),((_tmp4A5[0]=& _tmp4A4,
Cyc_fprintf(Cyc_stderr,((_tmp4A6="==%d",_tag_dyneither(_tmp4A6,sizeof(char),5))),
_tag_dyneither(_tmp4A5,sizeof(void*),1)))))));}goto _LL189;_LL18C: if((_tmp282.LessVar).tag
!= 1)goto _LL18E;_tmp284=(_tmp282.LessVar).f1;_LL18D:{const char*_tmp4AA;void*
_tmp4A9[1];struct Cyc_String_pa_struct _tmp4A8;(_tmp4A8.tag=0,((_tmp4A8.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp284->name)),((
_tmp4A9[0]=& _tmp4A8,Cyc_fprintf(Cyc_stderr,((_tmp4AA="<%s",_tag_dyneither(
_tmp4AA,sizeof(char),4))),_tag_dyneither(_tmp4A9,sizeof(void*),1)))))));}goto
_LL189;_LL18E: if((_tmp282.LessNumelts).tag != 2)goto _LL190;_tmp285=(_tmp282.LessNumelts).f1;
_LL18F:{const char*_tmp4AE;void*_tmp4AD[1];struct Cyc_String_pa_struct _tmp4AC;(
_tmp4AC.tag=0,((_tmp4AC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp285->name)),((_tmp4AD[0]=& _tmp4AC,Cyc_fprintf(Cyc_stderr,((_tmp4AE="<numelts(%s)",
_tag_dyneither(_tmp4AE,sizeof(char),13))),_tag_dyneither(_tmp4AD,sizeof(void*),1)))))));}
goto _LL189;_LL190: if((_tmp282.LessConst).tag != 3)goto _LL192;_tmp286=(_tmp282.LessConst).f1;
_LL191:{const char*_tmp4B2;void*_tmp4B1[1];struct Cyc_Int_pa_struct _tmp4B0;(
_tmp4B0.tag=1,((_tmp4B0.f1=(unsigned long)((int)_tmp286),((_tmp4B1[0]=& _tmp4B0,
Cyc_fprintf(Cyc_stderr,((_tmp4B2="<%d",_tag_dyneither(_tmp4B2,sizeof(char),4))),
_tag_dyneither(_tmp4B1,sizeof(void*),1)))))));}goto _LL189;_LL192: if((_tmp282.LessEqNumelts).tag
!= 4)goto _LL189;_tmp287=(_tmp282.LessEqNumelts).f1;_LL193:{const char*_tmp4B6;
void*_tmp4B5[1];struct Cyc_String_pa_struct _tmp4B4;(_tmp4B4.tag=0,((_tmp4B4.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp287->name)),((
_tmp4B5[0]=& _tmp4B4,Cyc_fprintf(Cyc_stderr,((_tmp4B6="<=numelts(%s)",
_tag_dyneither(_tmp4B6,sizeof(char),14))),_tag_dyneither(_tmp4B5,sizeof(void*),1)))))));}
goto _LL189;_LL189:;}}void Cyc_CfFlowInfo_print_relns(struct Cyc_List_List*r);void
Cyc_CfFlowInfo_print_relns(struct Cyc_List_List*r){for(0;r != 0;r=r->tl){Cyc_CfFlowInfo_print_reln((
struct Cyc_CfFlowInfo_Reln*)r->hd);if(r->tl != 0){const char*_tmp4B9;void*_tmp4B8;(
_tmp4B8=0,Cyc_fprintf(Cyc_stderr,((_tmp4B9=",",_tag_dyneither(_tmp4B9,sizeof(
char),2))),_tag_dyneither(_tmp4B8,sizeof(void*),0)));}}}void Cyc_CfFlowInfo_print_initlevel(
...
Cyc_stderr,((_tmp4BC="uninitialized",_tag_dyneither(_tmp4BC,sizeof(char),14))),
_tag_dyneither(_tmp4BB,sizeof(void*),0)));}goto _LL194;_LL197: if((int)_tmp299 != 1)
goto _LL199;_LL198:{const char*_tmp4BF;void*_tmp4BE;(_tmp4BE=0,Cyc_fprintf(Cyc_stderr,((
_tmp4BF="this-initialized",_tag_dyneither(_tmp4BF,sizeof(char),17))),
_tag_dyneither(_tmp4BE,sizeof(void*),0)));}goto _LL194;_LL199: if((int)_tmp299 != 2)
goto _LL194;_LL19A:{const char*_tmp4C2;void*_tmp4C1;(_tmp4C1=0,Cyc_fprintf(Cyc_stderr,((
_tmp4C2="all-initialized",_tag_dyneither(_tmp4C2,sizeof(char),16))),
_tag_dyneither(_tmp4C1,sizeof(void*),0)));}goto _LL194;_LL194:;}void Cyc_CfFlowInfo_print_root(
void*root);void Cyc_CfFlowInfo_print_root(void*root){void*_tmp2A0=root;struct Cyc_Absyn_Vardecl*
_tmp2A1;struct Cyc_Absyn_Exp*_tmp2A2;void*_tmp2A3;_LL19C: if(*((int*)_tmp2A0)!= 0)
goto _LL19E;_tmp2A1=((struct Cyc_CfFlowInfo_VarRoot_struct*)_tmp2A0)->f1;_LL19D:{
const char*_tmp4C6;void*_tmp4C5[1];struct Cyc_String_pa_struct _tmp4C4;(_tmp4C4.tag=
0,((_tmp4C4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp2A1->name)),((_tmp4C5[0]=& _tmp4C4,Cyc_fprintf(Cyc_stderr,((_tmp4C6="Root(%s)",
_tag_dyneither(_tmp4C6,sizeof(char),9))),_tag_dyneither(_tmp4C5,sizeof(void*),1)))))));}
...
_LL19F:{const char*_tmp4CB;void*_tmp4CA[2];struct Cyc_String_pa_struct _tmp4C9;
struct Cyc_String_pa_struct _tmp4C8;(_tmp4C8.tag=0,((_tmp4C8.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp2A3)),((_tmp4C9.tag=
0,((_tmp4C9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(
_tmp2A2)),((_tmp4CA[0]=& _tmp4C9,((_tmp4CA[1]=& _tmp4C8,Cyc_fprintf(Cyc_stderr,((
_tmp4CB="MallocPt(%s,%s)",_tag_dyneither(_tmp4CB,sizeof(char),16))),
_tag_dyneither(_tmp4CA,sizeof(void*),2)))))))))))));}goto _LL19B;_LL1A0: if(*((int*)
_tmp2A0)!= 2)goto _LL19B;_LL1A1:{const char*_tmp4CE;void*_tmp4CD;(_tmp4CD=0,Cyc_fprintf(
Cyc_stderr,((_tmp4CE="InitParam(_,_)",_tag_dyneither(_tmp4CE,sizeof(char),15))),
_tag_dyneither(_tmp4CD,sizeof(void*),0)));}goto _LL19B;_LL19B:;}void Cyc_CfFlowInfo_print_place(
...
while(_tmp2AD != 0){{const char*_tmp4D2;void*_tmp4D1[1];struct Cyc_Int_pa_struct
_tmp4D0;(_tmp4D0.tag=1,((_tmp4D0.f1=(unsigned long)((int)_tmp2AD->hd),((_tmp4D1[
0]=& _tmp4D0,Cyc_fprintf(Cyc_stderr,((_tmp4D2=".%d",_tag_dyneither(_tmp4D2,
sizeof(char),4))),_tag_dyneither(_tmp4D1,sizeof(void*),1)))))));}_tmp2AD=_tmp2AD->tl;}{
const char*_tmp4D5;void*_tmp4D4;(_tmp4D4=0,Cyc_fprintf(Cyc_stderr,((_tmp4D5=" ",
_tag_dyneither(_tmp4D5,sizeof(char),2))),_tag_dyneither(_tmp4D4,sizeof(void*),0)));}}}
void Cyc_CfFlowInfo_print_place_set(struct Cyc_Dict_Dict p);void Cyc_CfFlowInfo_print_place_set(
...
r,p);int first=1;{const char*_tmp4D8;void*_tmp4D7;(_tmp4D7=0,Cyc_fprintf(Cyc_stderr,((
_tmp4D8="{ ",_tag_dyneither(_tmp4D8,sizeof(char),3))),_tag_dyneither(_tmp4D7,
sizeof(void*),0)));}while(((int(*)(struct Cyc_Iter_Iter,struct _tuple6*))Cyc_Iter_next)(
_tmp2B7,& _tmp2B8)){struct Cyc_CfFlowInfo_Place*_tmp2BB=_tmp2B8.f1;if(!first){{
const char*_tmp4DB;void*_tmp4DA;(_tmp4DA=0,Cyc_fprintf(Cyc_stderr,((_tmp4DB=", ",
_tag_dyneither(_tmp4DB,sizeof(char),3))),_tag_dyneither(_tmp4DA,sizeof(void*),0)));}
first=0;}Cyc_CfFlowInfo_print_place(_tmp2BB);}{const char*_tmp4DE;void*_tmp4DD;(
_tmp4DD=0,Cyc_fprintf(Cyc_stderr,((_tmp4DE="}\n",_tag_dyneither(_tmp4DE,sizeof(
char),3))),_tag_dyneither(_tmp4DD,sizeof(void*),0)));}};_pop_handler();}else{
void*_tmp2B5=(void*)_exn_thrown;void*_tmp2C1=_tmp2B5;_LL1A3:;_LL1A4:{const char*
_tmp4E1;void*_tmp4E0;(_tmp4E0=0,Cyc_fprintf(Cyc_stderr,((_tmp4E1="{ }\n",
_tag_dyneither(_tmp4E1,sizeof(char),5))),_tag_dyneither(_tmp4E0,sizeof(void*),0)));}
_npop_handler(0);return;_LL1A5:;_LL1A6:(void)_throw(_tmp2C1);_LL1A2:;}}};
_pop_region(r);}void Cyc_CfFlowInfo_print_absrval(void*rval);void Cyc_CfFlowInfo_print_absrval(
void*rval){void*_tmp2C4=rval;void*_tmp2C5;void*_tmp2C6;struct Cyc_CfFlowInfo_Place*
_tmp2C7;struct _dyneither_ptr _tmp2C8;_LL1A8: if((int)_tmp2C4 != 0)goto _LL1AA;_LL1A9:{
const char*_tmp4E4;void*_tmp4E3;(_tmp4E3=0,Cyc_fprintf(Cyc_stderr,((_tmp4E4="Zero",
_tag_dyneither(_tmp4E4,sizeof(char),5))),_tag_dyneither(_tmp4E3,sizeof(void*),0)));}
goto _LL1A7;_LL1AA: if((int)_tmp2C4 != 1)goto _LL1AC;_LL1AB:{const char*_tmp4E7;void*
_tmp4E6;(_tmp4E6=0,Cyc_fprintf(Cyc_stderr,((_tmp4E7="NotZeroAll",_tag_dyneither(
_tmp4E7,sizeof(char),11))),_tag_dyneither(_tmp4E6,sizeof(void*),0)));}goto _LL1A7;
_LL1AC: if((int)_tmp2C4 != 2)goto _LL1AE;_LL1AD:{const char*_tmp4EA;void*_tmp4E9;(
_tmp4E9=0,Cyc_fprintf(Cyc_stderr,((_tmp4EA="NotZeroThis",_tag_dyneither(_tmp4EA,
sizeof(char),12))),_tag_dyneither(_tmp4E9,sizeof(void*),0)));}goto _LL1A7;_LL1AE:
if(_tmp2C4 <= (void*)3)goto _LL1B0;if(*((int*)_tmp2C4)!= 0)goto _LL1B0;_tmp2C5=(
void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)_tmp2C4)->f1;_LL1AF:{const char*
_tmp4ED;void*_tmp4EC;(_tmp4EC=0,Cyc_fprintf(Cyc_stderr,((_tmp4ED="Unknown(",
_tag_dyneither(_tmp4ED,sizeof(char),9))),_tag_dyneither(_tmp4EC,sizeof(void*),0)));}
Cyc_CfFlowInfo_print_initlevel(_tmp2C5);{const char*_tmp4F0;void*_tmp4EF;(_tmp4EF=
0,Cyc_fprintf(Cyc_stderr,((_tmp4F0=")",_tag_dyneither(_tmp4F0,sizeof(char),2))),
_tag_dyneither(_tmp4EF,sizeof(void*),0)));}goto _LL1A7;_LL1B0: if(_tmp2C4 <= (void*)
3)goto _LL1B2;if(*((int*)_tmp2C4)!= 1)goto _LL1B2;_tmp2C6=(void*)((struct Cyc_CfFlowInfo_Esc_struct*)
_tmp2C4)->f1;_LL1B1:{const char*_tmp4F3;void*_tmp4F2;(_tmp4F2=0,Cyc_fprintf(Cyc_stderr,((
_tmp4F3="Esc(",_tag_dyneither(_tmp4F3,sizeof(char),5))),_tag_dyneither(_tmp4F2,
sizeof(void*),0)));}Cyc_CfFlowInfo_print_initlevel(_tmp2C6);{const char*_tmp4F6;
void*_tmp4F5;(_tmp4F5=0,Cyc_fprintf(Cyc_stderr,((_tmp4F6=")",_tag_dyneither(
_tmp4F6,sizeof(char),2))),_tag_dyneither(_tmp4F5,sizeof(void*),0)));}goto _LL1A7;
_LL1B2: if(_tmp2C4 <= (void*)3)goto _LL1B4;if(*((int*)_tmp2C4)!= 2)goto _LL1B4;
_tmp2C7=((struct Cyc_CfFlowInfo_AddressOf_struct*)_tmp2C4)->f1;_LL1B3:{const char*
_tmp4F9;void*_tmp4F8;(_tmp4F8=0,Cyc_fprintf(Cyc_stderr,((_tmp4F9="AddrOf(",
_tag_dyneither(_tmp4F9,sizeof(char),8))),_tag_dyneither(_tmp4F8,sizeof(void*),0)));}
Cyc_CfFlowInfo_print_place(_tmp2C7);{const char*_tmp4FC;void*_tmp4FB;(_tmp4FB=0,
Cyc_fprintf(Cyc_stderr,((_tmp4FC=")",_tag_dyneither(_tmp4FC,sizeof(char),2))),
_tag_dyneither(_tmp4FB,sizeof(void*),0)));}goto _LL1A7;_LL1B4: if(_tmp2C4 <= (void*)
3)goto _LL1B6;if(*((int*)_tmp2C4)!= 3)goto _LL1B6;_LL1B5:{const char*_tmp4FF;void*
_tmp4FE;(_tmp4FE=0,Cyc_fprintf(Cyc_stderr,((_tmp4FF="TagCmps(?)",_tag_dyneither(
_tmp4FF,sizeof(char),11))),_tag_dyneither(_tmp4FE,sizeof(void*),0)));}goto _LL1A7;
_LL1B6: if(_tmp2C4 <= (void*)3)goto _LL1A7;if(*((int*)_tmp2C4)!= 4)goto _LL1A7;
_tmp2C8=((struct Cyc_CfFlowInfo_Aggregate_struct*)_tmp2C4)->f1;_LL1B7:{const char*
_tmp502;void*_tmp501;(_tmp501=0,Cyc_fprintf(Cyc_stderr,((_tmp502="Aggregate{",
_tag_dyneither(_tmp502,sizeof(char),11))),_tag_dyneither(_tmp501,sizeof(void*),0)));}{
int i=0;for(0;i < _get_dyneither_size(_tmp2C8,sizeof(void*));++ i){Cyc_CfFlowInfo_print_absrval(((
...
_tag_dyneither(_tmp505,sizeof(char),2))),_tag_dyneither(_tmp504,sizeof(void*),0)));}}}{
const char*_tmp508;void*_tmp507;(_tmp507=0,Cyc_fprintf(Cyc_stderr,((_tmp508="}",
_tag_dyneither(_tmp508,sizeof(char),2))),_tag_dyneither(_tmp507,sizeof(void*),0)));}
...
char*_tmp50B;void*_tmp50A;(_tmp50A=0,Cyc_fprintf(Cyc_stderr,((_tmp50B="    ",
_tag_dyneither(_tmp50B,sizeof(char),5))),_tag_dyneither(_tmp50A,sizeof(void*),0)));}
Cyc_CfFlowInfo_print_root(root);{const char*_tmp50E;void*_tmp50D;(_tmp50D=0,Cyc_fprintf(
Cyc_stderr,((_tmp50E=" --> ",_tag_dyneither(_tmp50E,sizeof(char),6))),
_tag_dyneither(_tmp50D,sizeof(void*),0)));}Cyc_CfFlowInfo_print_absrval(rval);{
const char*_tmp511;void*_tmp510;(_tmp510=0,Cyc_fprintf(Cyc_stderr,((_tmp511="\n",
_tag_dyneither(_tmp511,sizeof(char),2))),_tag_dyneither(_tmp510,sizeof(void*),0)));}}
...
_tmp2E9.BottomFL).tag != 0)goto _LL1BB;_LL1BA:{const char*_tmp514;void*_tmp513;(
_tmp513=0,Cyc_fprintf(Cyc_stderr,((_tmp514="  BottomFL\n",_tag_dyneither(_tmp514,
sizeof(char),12))),_tag_dyneither(_tmp513,sizeof(void*),0)));}goto _LL1B8;_LL1BB:
if((_tmp2E9.ReachableFL).tag != 1)goto _LL1B8;_tmp2EA=(_tmp2E9.ReachableFL).f1;
...
sizeof(char),16))),_tag_dyneither(_tmp516,sizeof(void*),0)));}Cyc_Dict_iter(Cyc_CfFlowInfo_print_flow_mapping,
_tmp2EA);{const char*_tmp51A;void*_tmp519;(_tmp519=0,Cyc_fprintf(Cyc_stderr,((
_tmp51A="\n    consumed: ",_tag_dyneither(_tmp51A,sizeof(char),16))),
_tag_dyneither(_tmp519,sizeof(void*),0)));}Cyc_CfFlowInfo_print_place_set(
_tmp2EB.consumed);{const char*_tmp51D;void*_tmp51C;(_tmp51C=0,Cyc_fprintf(Cyc_stderr,((
_tmp51D="\n    may_consume: ",_tag_dyneither(_tmp51D,sizeof(char),19))),
_tag_dyneither(_tmp51C,sizeof(void*),0)));}Cyc_CfFlowInfo_print_place_list(
_tmp2EB.may_consume);{const char*_tmp520;void*_tmp51F;(_tmp51F=0,Cyc_fprintf(Cyc_stderr,((
_tmp520="\n",_tag_dyneither(_tmp520,sizeof(char),2))),_tag_dyneither(_tmp51F,
...
_tmp2F6 != 1)goto _LL1C4;_LL1C3: goto _LL1C5;_LL1C4: if(_tmp2F6 <= (void*)4)goto _LL1CC;
...
_LL1C9: goto _LL1CB;_LL1CA: if(*((int*)_tmp2F6)!= 18)goto _LL1CC;_LL1CB: goto _LL1CD;
_LL1CC: if((int)_tmp2F6 != 2)goto _LL1CE;_LL1CD: goto _LL1CF;_LL1CE: if(_tmp2F6 <= (
void*)4)goto _LL1D0;if(*((int*)_tmp2F6)!= 0)goto _LL1D0;_LL1CF: return 0;_LL1D0: if((
int)_tmp2F6 != 3)goto _LL1D2;_LL1D1: {void*_tmp30E=rgn;_LL1F3: if((int)_tmp30E != 0)
goto _LL1F5;_LL1F4: return 1;_LL1F5:;_LL1F6: return 0;_LL1F2:;}_LL1D2: if(_tmp2F6 <= (
void*)4)goto _LL1D4;if(*((int*)_tmp2F6)!= 1)goto _LL1D4;_tmp2F7=((struct Cyc_Absyn_VarType_struct*)
_tmp2F6)->f1;_LL1D3: {void*_tmp30F=rgn;struct Cyc_Absyn_Tvar*_tmp310;_LL1F8: if((
int)_tmp30F != 0)goto _LL1FA;_LL1F9: return 0;_LL1FA: if(_tmp30F <= (void*)1)goto
_LL1F7;if(*((int*)_tmp30F)!= 0)goto _LL1F7;_tmp310=((struct Cyc_CfFlowInfo_Region_k_struct*)
_tmp30F)->f1;_LL1FB: return Cyc_Absyn_tvar_cmp(_tmp2F7,_tmp310)== 0;_LL1F7:;}
_LL1D4: if(_tmp2F6 <= (void*)4)goto _LL1D6;if(*((int*)_tmp2F6)!= 2)goto _LL1D6;
_tmp2F8=((struct Cyc_Absyn_TunionType_struct*)_tmp2F6)->f1;_tmp2F9=_tmp2F8.targs;
_tmp2FA=_tmp2F8.rgn;_LL1D5: if((unsigned int)_tmp2FA  && Cyc_CfFlowInfo_contains_region(
rgn,(void*)_tmp2FA->v))return 1;_tmp2FB=_tmp2F9;goto _LL1D7;_LL1D6: if(_tmp2F6 <= (
void*)4)goto _LL1D8;if(*((int*)_tmp2F6)!= 16)goto _LL1D8;_tmp2FB=((struct Cyc_Absyn_TypedefType_struct*)
_tmp2F6)->f2;_LL1D7: _tmp2FD=_tmp2FB;goto _LL1D9;_LL1D8: if(_tmp2F6 <= (void*)4)goto
_LL1DA;if(*((int*)_tmp2F6)!= 10)goto _LL1DA;_tmp2FC=((struct Cyc_Absyn_AggrType_struct*)
_tmp2F6)->f1;_tmp2FD=_tmp2FC.targs;_LL1D9: _tmp2FF=_tmp2FD;goto _LL1DB;_LL1DA: if(
_tmp2F6 <= (void*)4)goto _LL1DC;if(*((int*)_tmp2F6)!= 3)goto _LL1DC;_tmp2FE=((
struct Cyc_Absyn_TunionFieldType_struct*)_tmp2F6)->f1;_tmp2FF=_tmp2FE.targs;
_LL1DB: _tmp300=_tmp2FF;goto _LL1DD;_LL1DC: if(_tmp2F6 <= (void*)4)goto _LL1DE;if(*((
int*)_tmp2F6)!= 20)goto _LL1DE;_tmp300=((struct Cyc_Absyn_JoinEff_struct*)_tmp2F6)->f1;
_LL1DD: return Cyc_List_exists_c(Cyc_CfFlowInfo_contains_region,rgn,_tmp300);
_LL1DE: if(_tmp2F6 <= (void*)4)goto _LL1E0;if(*((int*)_tmp2F6)!= 4)goto _LL1E0;
_tmp301=((struct Cyc_Absyn_PointerType_struct*)_tmp2F6)->f1;_tmp302=(void*)
_tmp301.elt_typ;_tmp303=_tmp301.ptr_atts;_tmp304=(void*)_tmp303.rgn;_LL1DF:
...
_tuple13*env,void*root,void*rval);static void Cyc_CfFlowInfo_kill_root(struct
...
rgn);struct Cyc_Absyn_Tvar*_tmp31B;_LL204: if(_tmp31A <= (void*)4)goto _LL206;if(*((
int*)_tmp31A)!= 1)goto _LL206;_tmp31B=((struct Cyc_Absyn_VarType_struct*)_tmp31A)->f1;
_LL205: {struct Cyc_CfFlowInfo_Region_k_struct _tmp521;struct Cyc_CfFlowInfo_Region_k_struct
...
env,fd);return env.f2;}_LL206: if((int)_tmp31A != 3)goto _LL208;_LL207: {struct
...
struct _tuple13*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_CfFlowInfo_kill_root,&
env,fd);return env.f2;}_LL208:;_LL209: {struct Cyc_Core_Impossible_struct _tmp529;
...
_tmp529.f1=((_tmp528="kill_flowdict_region",_tag_dyneither(_tmp528,sizeof(char),
21))),_tmp529)))),_tmp527)))));}_LL203:;}static struct Cyc_List_List*Cyc_CfFlowInfo_kill_relns_region(
...
_tmp324;struct Cyc_CfFlowInfo_ConsumeInfo _tmp325;_LL20B: if((_tmp322.BottomFL).tag
!= 0)goto _LL20D;_LL20C: return f;_LL20D: if((_tmp322.ReachableFL).tag != 1)goto
_LL20A;_tmp323=(_tmp322.ReachableFL).f1;_tmp324=(_tmp322.ReachableFL).f2;_tmp325=(
_tmp322.ReachableFL).f3;_LL20E: {struct Cyc_Dict_Dict _tmp326=Cyc_CfFlowInfo_kill_flowdict_region(
fenv,_tmp323,rgn);struct Cyc_List_List*_tmp327=Cyc_CfFlowInfo_kill_relns_region(
_tmp324,rgn);union Cyc_CfFlowInfo_FlowInfo_union _tmp52A;return(union Cyc_CfFlowInfo_FlowInfo_union)(((
_tmp52A.ReachableFL).tag=1,(((_tmp52A.ReachableFL).f1=_tmp326,(((_tmp52A.ReachableFL).f2=
_tmp327,(((_tmp52A.ReachableFL).f3=_tmp325,_tmp52A))))))));}_LL20A:;}struct
...
_tag_dyneither(_tmp52B,sizeof(char),59))),((_tmp52C="May consume non-aliased pointer %s more than once",
_tag_dyneither(_tmp52C,sizeof(char),50))),_tmp32E,_tmp32D);}}}union Cyc_CfFlowInfo_FlowInfo_union
...
_tmp334;_LL210: if((_tmp331.BottomFL).tag != 0)goto _LL212;_LL211: return f;_LL212:
if((_tmp331.ReachableFL).tag != 1)goto _LL20F;_tmp332=(_tmp331.ReachableFL).f1;
_tmp333=(_tmp331.ReachableFL).f2;_tmp334=(_tmp331.ReachableFL).f3;_LL213: if(
...
0,_tmp530)))),_tmp52F))))))));}}_LL20F:;}void Cyc_CfFlowInfo_check_unique_rvals(
struct Cyc_Position_Segment*loc,union Cyc_CfFlowInfo_FlowInfo_union f);void Cyc_CfFlowInfo_check_unique_rvals(
struct Cyc_Position_Segment*loc,union Cyc_CfFlowInfo_FlowInfo_union f){union Cyc_CfFlowInfo_FlowInfo_union
_tmp33A=f;struct Cyc_Dict_Dict _tmp33B;struct Cyc_List_List*_tmp33C;struct Cyc_CfFlowInfo_ConsumeInfo
_tmp33D;_LL215: if((_tmp33A.BottomFL).tag != 0)goto _LL217;_LL216: return;_LL217: if((
_tmp33A.ReachableFL).tag != 1)goto _LL214;_tmp33B=(_tmp33A.ReachableFL).f1;_tmp33C=(
_tmp33A.ReachableFL).f2;_tmp33D=(_tmp33A.ReachableFL).f3;_LL218: {struct Cyc_List_List*
...
_tag_dyneither(_tmp531,sizeof(char),58))),((_tmp532="Read through possibly consumed unique pointer %s",
_tag_dyneither(_tmp532,sizeof(char),49))),_tmp33F,loc);}break;}_tmp33E=_tmp33E->tl;}
...
Cyc_List_List*_tmp344;struct Cyc_CfFlowInfo_ConsumeInfo _tmp345;_LL21A: if((_tmp342.BottomFL).tag
!= 0)goto _LL21C;_LL21B: return f;_LL21C: if((_tmp342.ReachableFL).tag != 1)goto
_LL219;_tmp343=(_tmp342.ReachableFL).f1;_tmp344=(_tmp342.ReachableFL).f2;_tmp345=(
_tmp342.ReachableFL).f3;_LL21D: _tmp345.may_consume=0;{union Cyc_CfFlowInfo_FlowInfo_union
...
_tmp345,_tmp533))))))));}_LL219:;}union Cyc_CfFlowInfo_FlowInfo_union Cyc_CfFlowInfo_readthrough_unique_rvals(
struct Cyc_Position_Segment*loc,union Cyc_CfFlowInfo_FlowInfo_union f);union Cyc_CfFlowInfo_FlowInfo_union
Cyc_CfFlowInfo_readthrough_unique_rvals(struct Cyc_Position_Segment*loc,union Cyc_CfFlowInfo_FlowInfo_union
...
_tmp349,(((_tmp534.ReachableFL).f3=_tmp34A,_tmp534))))))));}_LL21E:;}}struct
...
!= 0)goto _LL226;_LL225: {struct Cyc_CfFlowInfo_ConsumeInfo _tmp537;struct _tuple5
_tmp536;return(_tmp536.f1=((_tmp537.consumed=fenv->mt_place_set,((_tmp537.may_consume=
0,_tmp537)))),((_tmp536.f2=f,_tmp536)));}_LL226: if((_tmp34C.ReachableFL).tag != 1)
goto _LL223;_tmp34D=(_tmp34C.ReachableFL).f1;_tmp34E=(_tmp34C.ReachableFL).f2;
_tmp34F=(_tmp34C.ReachableFL).f3;_LL227: if(clear){union Cyc_CfFlowInfo_FlowInfo_union
...
_tmp53E.f1=_tmp34F,((_tmp53E.f2=f,_tmp53E)));}_LL223:;}union Cyc_CfFlowInfo_FlowInfo_union
...
_LL22C: {union Cyc_CfFlowInfo_FlowInfo_union _tmp53F;return(union Cyc_CfFlowInfo_FlowInfo_union)(((
_tmp53F.ReachableFL).tag=1,(((_tmp53F.ReachableFL).f1=_tmp357,(((_tmp53F.ReachableFL).f2=
_tmp358,(((_tmp53F.ReachableFL).f3=c,_tmp53F))))))));}_LL228:;}
