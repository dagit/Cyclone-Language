...
_tmp1=(*q2).f1;{struct _tuple12 _tmp4A4;struct _tuple12 _tmp3=(_tmp4A4.f1=_tmp0,((
_tmp4A4.f2=_tmp1,_tmp4A4)));union Cyc_Absyn_Nmspace_union _tmp4;union Cyc_Absyn_Nmspace_union
...
k,struct Cyc_Core_Opt*env){struct Cyc_Absyn_Evar_struct _tmp4A7;struct Cyc_Absyn_Evar_struct*
_tmp4A6;return(void*)((_tmp4A6=_cycalloc(sizeof(*_tmp4A6)),((_tmp4A6[0]=((
_tmp4A7.tag=0,((_tmp4A7.f1=k,((_tmp4A7.f2=0,((_tmp4A7.f3=Cyc_Absyn_new_type_counter
++,((_tmp4A7.f4=env,_tmp4A7)))))))))),_tmp4A6))));}static struct Cyc_Core_Opt Cyc_Absyn_mk={(
...
x,struct Cyc_Absyn_Tqual y){struct Cyc_Absyn_Tqual _tmp4A8;return(_tmp4A8.print_const=
x.print_const  || y.print_const,((_tmp4A8.q_volatile=x.q_volatile  || y.q_volatile,((
_tmp4A8.q_restrict=x.q_restrict  || y.q_restrict,((_tmp4A8.real_const=x.real_const
 || y.real_const,((_tmp4A8.loc=Cyc_Position_segment_join(x.loc,y.loc),_tmp4A8)))))))));}
struct Cyc_Absyn_Tqual Cyc_Absyn_empty_tqual(struct Cyc_Position_Segment*loc);
struct Cyc_Absyn_Tqual Cyc_Absyn_empty_tqual(struct Cyc_Position_Segment*loc){
struct Cyc_Absyn_Tqual _tmp4A9;return(_tmp4A9.print_const=0,((_tmp4A9.q_volatile=0,((
_tmp4A9.q_restrict=0,((_tmp4A9.real_const=0,((_tmp4A9.loc=loc,_tmp4A9)))))))));}
struct Cyc_Absyn_Tqual Cyc_Absyn_const_tqual(struct Cyc_Position_Segment*loc);
struct Cyc_Absyn_Tqual Cyc_Absyn_const_tqual(struct Cyc_Position_Segment*loc){
struct Cyc_Absyn_Tqual _tmp4AA;return(_tmp4AA.print_const=1,((_tmp4AA.q_volatile=0,((
_tmp4AA.q_restrict=0,((_tmp4AA.real_const=1,((_tmp4AA.loc=loc,_tmp4AA)))))))));}
...
_tmp4AD;struct Cyc_Absyn_Conref*_tmp4AC;return(_tmp4AC=_cycalloc(sizeof(*_tmp4AC)),((
_tmp4AC->v=(union Cyc_Absyn_Constraint_union)(((_tmp4AD.Eq_constr).tag=0,(((
_tmp4AD.Eq_constr).f1=(void*)x,_tmp4AD)))),_tmp4AC)));}struct Cyc_Absyn_Conref*
Cyc_Absyn_empty_conref();struct Cyc_Absyn_Conref*Cyc_Absyn_empty_conref(){union
Cyc_Absyn_Constraint_union _tmp4B0;struct Cyc_Absyn_Conref*_tmp4AF;return(_tmp4AF=
_cycalloc(sizeof(*_tmp4AF)),((_tmp4AF->v=(union Cyc_Absyn_Constraint_union)(((
_tmp4B0.No_constr).tag=2,_tmp4B0)),_tmp4AF)));}static struct Cyc_Absyn_Conref Cyc_Absyn_true_conref_v={(
...
_tmp27);{union Cyc_Absyn_Constraint_union _tmp4B1;x->v=(union Cyc_Absyn_Constraint_union)(((
_tmp4B1.Forward_constr).tag=1,(((_tmp4B1.Forward_constr).f1=_tmp28,_tmp4B1))));}
...
const char*_tmp4B4;void*_tmp4B3;(_tmp4B3=0,Cyc_Tcutil_impos(((_tmp4B4="conref_val",
_tag_dyneither(_tmp4B4,sizeof(char),11))),_tag_dyneither(_tmp4B3,sizeof(void*),0)));}
...
struct Cyc_Core_Opt*_tmp4B5;*_tmp40=((_tmp4B5=_cycalloc(sizeof(*_tmp4B5)),((
_tmp4B5->v=(void*)Cyc_Tcutil_kind_to_bound(_tmp41),_tmp4B5))));}return _tmp41;
...
void*)2,Cyc_Absyn_empty_tqual(0),(void*)0,Cyc_Absyn_true_conref);void**_tmp4B6;
Cyc_Absyn_string_t_opt=((_tmp4B6=_cycalloc(sizeof(*_tmp4B6)),((_tmp4B6[0]=t,
_tmp4B6))));}return*((void**)_check_null(Cyc_Absyn_string_t_opt));}static void**
...
void*)2,Cyc_Absyn_const_tqual(0),(void*)0,Cyc_Absyn_true_conref);void**_tmp4B7;
Cyc_Absyn_const_string_t_opt=((_tmp4B7=_cycalloc(sizeof(*_tmp4B7)),((_tmp4B7[0]=
t,_tmp4B7))));}return*((void**)_check_null(Cyc_Absyn_const_string_t_opt));}void*
...
struct Cyc_Absyn_Conref*zeroterm){struct Cyc_Absyn_PointerType_struct _tmp4C1;
struct Cyc_Absyn_PtrAtts _tmp4C0;struct Cyc_Absyn_PtrInfo _tmp4BF;struct Cyc_Absyn_PointerType_struct*
_tmp4BE;return(void*)((_tmp4BE=_cycalloc(sizeof(*_tmp4BE)),((_tmp4BE[0]=((
_tmp4C1.tag=4,((_tmp4C1.f1=((_tmp4BF.elt_typ=(void*)t,((_tmp4BF.elt_tq=tq,((
_tmp4BF.ptr_atts=((_tmp4C0.rgn=(void*)r,((_tmp4C0.nullable=Cyc_Absyn_true_conref,((
_tmp4C0.bounds=Cyc_Absyn_new_conref(b),((_tmp4C0.zero_term=zeroterm,((_tmp4C0.ptrloc=
0,_tmp4C0)))))))))),_tmp4BF)))))),_tmp4C1)))),_tmp4BE))));}void*Cyc_Absyn_atb_typ(
...
zeroterm){struct Cyc_Absyn_PointerType_struct _tmp4CB;struct Cyc_Absyn_PtrAtts
_tmp4CA;struct Cyc_Absyn_PtrInfo _tmp4C9;struct Cyc_Absyn_PointerType_struct*
_tmp4C8;return(void*)((_tmp4C8=_cycalloc(sizeof(*_tmp4C8)),((_tmp4C8[0]=((
_tmp4CB.tag=4,((_tmp4CB.f1=((_tmp4C9.elt_typ=(void*)t,((_tmp4C9.elt_tq=tq,((
_tmp4C9.ptr_atts=((_tmp4CA.rgn=(void*)r,((_tmp4CA.nullable=Cyc_Absyn_false_conref,((
_tmp4CA.bounds=Cyc_Absyn_new_conref(b),((_tmp4CA.zero_term=zeroterm,((_tmp4CA.ptrloc=
0,_tmp4CA)))))))))),_tmp4C9)))))),_tmp4CB)))),_tmp4C8))));}void*Cyc_Absyn_star_typ(
...
_tmp4D5;struct Cyc_Absyn_PtrAtts _tmp4D4;struct Cyc_Absyn_PtrInfo _tmp4D3;struct Cyc_Absyn_PointerType_struct*
_tmp4D2;return(void*)((_tmp4D2=_cycalloc(sizeof(*_tmp4D2)),((_tmp4D2[0]=((
_tmp4D5.tag=4,((_tmp4D5.f1=((_tmp4D3.elt_typ=(void*)t,((_tmp4D3.elt_tq=tq,((
_tmp4D3.ptr_atts=((_tmp4D4.rgn=(void*)r,((_tmp4D4.nullable=Cyc_Absyn_true_conref,((
_tmp4D4.bounds=Cyc_Absyn_bounds_one_conref,((_tmp4D4.zero_term=zeroterm,((
_tmp4D4.ptrloc=0,_tmp4D4)))))))))),_tmp4D3)))))),_tmp4D5)))),_tmp4D2))));}void*
Cyc_Absyn_cstar_typ(void*t,struct Cyc_Absyn_Tqual tq);void*Cyc_Absyn_cstar_typ(
void*t,struct Cyc_Absyn_Tqual tq){struct Cyc_Absyn_PointerType_struct _tmp4DF;struct
Cyc_Absyn_PtrAtts _tmp4DE;struct Cyc_Absyn_PtrInfo _tmp4DD;struct Cyc_Absyn_PointerType_struct*
_tmp4DC;return(void*)((_tmp4DC=_cycalloc(sizeof(*_tmp4DC)),((_tmp4DC[0]=((
_tmp4DF.tag=4,((_tmp4DF.f1=((_tmp4DD.elt_typ=(void*)t,((_tmp4DD.elt_tq=tq,((
_tmp4DD.ptr_atts=((_tmp4DE.rgn=(void*)((void*)2),((_tmp4DE.nullable=Cyc_Absyn_true_conref,((
_tmp4DE.bounds=Cyc_Absyn_bounds_one_conref,((_tmp4DE.zero_term=Cyc_Absyn_false_conref,((
_tmp4DE.ptrloc=0,_tmp4DE)))))))))),_tmp4DD)))))),_tmp4DF)))),_tmp4DC))));}void*
...
zeroterm){struct Cyc_Absyn_PointerType_struct _tmp4E9;struct Cyc_Absyn_PtrAtts
_tmp4E8;struct Cyc_Absyn_PtrInfo _tmp4E7;struct Cyc_Absyn_PointerType_struct*
_tmp4E6;return(void*)((_tmp4E6=_cycalloc(sizeof(*_tmp4E6)),((_tmp4E6[0]=((
_tmp4E9.tag=4,((_tmp4E9.f1=((_tmp4E7.elt_typ=(void*)t,((_tmp4E7.elt_tq=tq,((
_tmp4E7.ptr_atts=((_tmp4E8.rgn=(void*)r,((_tmp4E8.nullable=Cyc_Absyn_false_conref,((
_tmp4E8.bounds=Cyc_Absyn_bounds_one_conref,((_tmp4E8.zero_term=zeroterm,((
_tmp4E8.ptrloc=0,_tmp4E8)))))))))),_tmp4E7)))))),_tmp4E9)))),_tmp4E6))));}void*
...
struct Cyc_Absyn_Conref*zeroterm){struct Cyc_Absyn_PointerType_struct _tmp4F3;
struct Cyc_Absyn_PtrAtts _tmp4F2;struct Cyc_Absyn_PtrInfo _tmp4F1;struct Cyc_Absyn_PointerType_struct*
_tmp4F0;return(void*)((_tmp4F0=_cycalloc(sizeof(*_tmp4F0)),((_tmp4F0[0]=((
_tmp4F3.tag=4,((_tmp4F3.f1=((_tmp4F1.elt_typ=(void*)t,((_tmp4F1.elt_tq=tq,((
_tmp4F1.ptr_atts=((_tmp4F2.rgn=(void*)r,((_tmp4F2.nullable=Cyc_Absyn_true_conref,((
_tmp4F2.bounds=Cyc_Absyn_bounds_dyneither_conref,((_tmp4F2.zero_term=zeroterm,((
_tmp4F2.ptrloc=0,_tmp4F2)))))))))),_tmp4F1)))))),_tmp4F3)))),_tmp4F0))));}void*
...
struct Cyc_Absyn_ArrayType_struct _tmp4F9;struct Cyc_Absyn_ArrayInfo _tmp4F8;struct
Cyc_Absyn_ArrayType_struct*_tmp4F7;return(void*)((_tmp4F7=_cycalloc(sizeof(*
_tmp4F7)),((_tmp4F7[0]=((_tmp4F9.tag=7,((_tmp4F9.f1=((_tmp4F8.elt_type=(void*)
elt_type,((_tmp4F8.tq=tq,((_tmp4F8.num_elts=num_elts,((_tmp4F8.zero_term=
zero_term,((_tmp4F8.zt_loc=ztloc,_tmp4F8)))))))))),_tmp4F9)))),_tmp4F7))));}
...
_tmp4FC;struct _tuple0*_tmp4FB;struct _tuple0*file_t_name=(_tmp4FB=_cycalloc(
sizeof(*_tmp4FB)),((_tmp4FB->f1=(union Cyc_Absyn_Nmspace_union)(((_tmp4FC.Abs_n).tag=
2,(((_tmp4FC.Abs_n).f1=0,_tmp4FC)))),((_tmp4FB->f2=sf,_tmp4FB)))));struct Cyc_Absyn_Aggrdecl*
_tmp4FD;struct Cyc_Absyn_Aggrdecl*sd=(_tmp4FD=_cycalloc(sizeof(*_tmp4FD)),((
_tmp4FD->kind=(void*)((void*)0),((_tmp4FD->sc=(void*)((void*)1),((_tmp4FD->name=
file_t_name,((_tmp4FD->tvs=0,((_tmp4FD->impl=0,((_tmp4FD->attributes=0,_tmp4FD)))))))))))));
struct Cyc_Absyn_AggrType_struct _tmp50C;union Cyc_Absyn_AggrInfoU_union _tmp50B;
struct Cyc_Absyn_Aggrdecl**_tmp50A;struct Cyc_Absyn_AggrInfo _tmp509;struct Cyc_Absyn_AggrType_struct*
_tmp508;void*file_struct_typ=(void*)((_tmp508=_cycalloc(sizeof(*_tmp508)),((
_tmp508[0]=((_tmp50C.tag=10,((_tmp50C.f1=((_tmp509.aggr_info=(union Cyc_Absyn_AggrInfoU_union)(((
_tmp50B.KnownAggr).tag=1,(((_tmp50B.KnownAggr).f1=((_tmp50A=_cycalloc(sizeof(*
_tmp50A)),((_tmp50A[0]=sd,_tmp50A)))),_tmp50B)))),((_tmp509.targs=0,_tmp509)))),
_tmp50C)))),_tmp508))));void**_tmp50D;file_t_opt=((_tmp50D=_cycalloc(sizeof(*
_tmp50D)),((_tmp50D[0]=Cyc_Absyn_at_typ(file_struct_typ,(void*)2,Cyc_Absyn_empty_tqual(
0),Cyc_Absyn_false_conref),_tmp50D))));}return*file_t_opt;}void*Cyc_Absyn_void_star_typ();
void*Cyc_Absyn_void_star_typ(){static void**void_star_t_opt=0;if(void_star_t_opt
== 0){void**_tmp50E;void_star_t_opt=((_tmp50E=_cycalloc(sizeof(*_tmp50E)),((
_tmp50E[0]=Cyc_Absyn_star_typ((void*)0,(void*)2,Cyc_Absyn_empty_tqual(0),Cyc_Absyn_false_conref),
_tmp50E))));}return*void_star_t_opt;}static struct Cyc_Absyn_JoinEff_struct Cyc_Absyn_empty_eff={
...
_dyneither_ptr*name){struct Cyc_Absyn_AggrType_struct _tmp51D;union Cyc_Absyn_AggrInfoU_union
_tmp51C;struct _tuple0*_tmp51B;struct Cyc_Absyn_AggrInfo _tmp51A;struct Cyc_Absyn_AggrType_struct*
_tmp519;return(void*)((_tmp519=_cycalloc(sizeof(*_tmp519)),((_tmp519[0]=((
_tmp51D.tag=10,((_tmp51D.f1=((_tmp51A.aggr_info=(union Cyc_Absyn_AggrInfoU_union)(((
_tmp51C.UnknownAggr).tag=0,(((_tmp51C.UnknownAggr).f1=(void*)k,(((_tmp51C.UnknownAggr).f2=((
_tmp51B=_cycalloc(sizeof(*_tmp51B)),((_tmp51B->f1=Cyc_Absyn_rel_ns_null,((
_tmp51B->f2=name,_tmp51B)))))),_tmp51C)))))),((_tmp51A.targs=0,_tmp51A)))),
_tmp51D)))),_tmp519))));}void*Cyc_Absyn_strct(struct _dyneither_ptr*name);void*
...
_tmp527;union Cyc_Absyn_AggrInfoU_union _tmp526;struct Cyc_Absyn_AggrInfo _tmp525;
struct Cyc_Absyn_AggrType_struct*_tmp524;return(void*)((_tmp524=_cycalloc(sizeof(*
_tmp524)),((_tmp524[0]=((_tmp527.tag=10,((_tmp527.f1=((_tmp525.aggr_info=(union
Cyc_Absyn_AggrInfoU_union)(((_tmp526.UnknownAggr).tag=0,(((_tmp526.UnknownAggr).f1=(
void*)((void*)0),(((_tmp526.UnknownAggr).f2=name,_tmp526)))))),((_tmp525.targs=0,
_tmp525)))),_tmp527)))),_tmp524))));}void*Cyc_Absyn_unionq_typ(struct _tuple0*
name);void*Cyc_Absyn_unionq_typ(struct _tuple0*name){struct Cyc_Absyn_AggrType_struct
_tmp531;union Cyc_Absyn_AggrInfoU_union _tmp530;struct Cyc_Absyn_AggrInfo _tmp52F;
struct Cyc_Absyn_AggrType_struct*_tmp52E;return(void*)((_tmp52E=_cycalloc(sizeof(*
_tmp52E)),((_tmp52E[0]=((_tmp531.tag=10,((_tmp531.f1=((_tmp52F.aggr_info=(union
Cyc_Absyn_AggrInfoU_union)(((_tmp530.UnknownAggr).tag=0,(((_tmp530.UnknownAggr).f1=(
void*)((void*)1),(((_tmp530.UnknownAggr).f2=name,_tmp530)))))),((_tmp52F.targs=0,
_tmp52F)))),_tmp531)))),_tmp52E))));}struct Cyc_Absyn_Exp*Cyc_Absyn_new_exp(void*
r,struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Exp*Cyc_Absyn_new_exp(void*r,
struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Exp*_tmp532;return(_tmp532=
_cycalloc(sizeof(*_tmp532)),((_tmp532->topt=0,((_tmp532->r=(void*)r,((_tmp532->loc=
loc,((_tmp532->annot=(void*)((void*)Cyc_Absyn_EmptyAnnot),_tmp532)))))))));}
...
struct Cyc_Absyn_New_e_struct _tmp535;struct Cyc_Absyn_New_e_struct*_tmp534;return
Cyc_Absyn_new_exp((void*)((_tmp534=_cycalloc(sizeof(*_tmp534)),((_tmp534[0]=((
_tmp535.tag=17,((_tmp535.f1=rgn_handle,((_tmp535.f2=e,_tmp535)))))),_tmp534)))),
loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_copy_exp(struct Cyc_Absyn_Exp*e);struct Cyc_Absyn_Exp*
Cyc_Absyn_copy_exp(struct Cyc_Absyn_Exp*e){struct Cyc_Absyn_Exp*_tmp536;return(
_tmp536=_cycalloc(sizeof(*_tmp536)),((_tmp536[0]=*e,_tmp536)));}struct Cyc_Absyn_Exp*
...
loc){struct Cyc_Absyn_Const_e_struct _tmp539;struct Cyc_Absyn_Const_e_struct*
_tmp538;return Cyc_Absyn_new_exp((void*)((_tmp538=_cycalloc(sizeof(*_tmp538)),((
_tmp538[0]=((_tmp539.tag=0,((_tmp539.f1=c,_tmp539)))),_tmp538)))),loc);}struct
...
_tmp53F;union Cyc_Absyn_Cnst_union _tmp53E;struct Cyc_Absyn_Const_e_struct*_tmp53D;
return Cyc_Absyn_new_exp((void*)((_tmp53D=_cycalloc(sizeof(*_tmp53D)),((_tmp53D[0]=((
_tmp53F.tag=0,((_tmp53F.f1=(union Cyc_Absyn_Cnst_union)(((_tmp53E.Null_c).tag=6,
_tmp53E)),_tmp53F)))),_tmp53D)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_int_exp(
void*s,int i,struct Cyc_Position_Segment*seg);struct Cyc_Absyn_Exp*Cyc_Absyn_int_exp(
void*s,int i,struct Cyc_Position_Segment*seg){union Cyc_Absyn_Cnst_union _tmp540;
return Cyc_Absyn_const_exp((union Cyc_Absyn_Cnst_union)(((_tmp540.Int_c).tag=2,(((
_tmp540.Int_c).f1=(void*)s,(((_tmp540.Int_c).f2=i,_tmp540)))))),seg);}struct Cyc_Absyn_Exp*
...
loc){union Cyc_Absyn_Cnst_union _tmp541;return Cyc_Absyn_const_exp((union Cyc_Absyn_Cnst_union)(((
_tmp541.Char_c).tag=0,(((_tmp541.Char_c).f1=(void*)((void*)2),(((_tmp541.Char_c).f2=
c,_tmp541)))))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_float_exp(struct
...
_tmp542;return Cyc_Absyn_const_exp((union Cyc_Absyn_Cnst_union)(((_tmp542.Float_c).tag=
4,(((_tmp542.Float_c).f1=f,_tmp542)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_string_exp(
...
_tmp543;return Cyc_Absyn_const_exp((union Cyc_Absyn_Cnst_union)(((_tmp543.String_c).tag=
5,(((_tmp543.String_c).f1=s,_tmp543)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_var_exp(
...
_tmp546;struct Cyc_Absyn_Var_e_struct*_tmp545;return Cyc_Absyn_new_exp((void*)((
_tmp545=_cycalloc(sizeof(*_tmp545)),((_tmp545[0]=((_tmp546.tag=1,((_tmp546.f1=q,((
_tmp546.f2=(void*)((void*)0),_tmp546)))))),_tmp545)))),loc);}struct Cyc_Absyn_Exp*
...
loc){struct Cyc_Absyn_Var_e_struct _tmp549;struct Cyc_Absyn_Var_e_struct*_tmp548;
return Cyc_Absyn_new_exp((void*)((_tmp548=_cycalloc(sizeof(*_tmp548)),((_tmp548[0]=((
_tmp549.tag=1,((_tmp549.f1=q,((_tmp549.f2=(void*)b,_tmp549)))))),_tmp548)))),loc);}
...
loc){struct Cyc_Absyn_UnknownId_e_struct _tmp54C;struct Cyc_Absyn_UnknownId_e_struct*
_tmp54B;return Cyc_Absyn_new_exp((void*)((_tmp54B=_cycalloc(sizeof(*_tmp54B)),((
_tmp54B[0]=((_tmp54C.tag=2,((_tmp54C.f1=q,_tmp54C)))),_tmp54B)))),loc);}struct
...
struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Primop_e_struct _tmp54F;struct Cyc_Absyn_Primop_e_struct*
_tmp54E;return Cyc_Absyn_new_exp((void*)((_tmp54E=_cycalloc(sizeof(*_tmp54E)),((
_tmp54E[0]=((_tmp54F.tag=3,((_tmp54F.f1=(void*)p,((_tmp54F.f2=es,_tmp54F)))))),
_tmp54E)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_prim1_exp(void*p,struct Cyc_Absyn_Exp*
...
_tmp550;return Cyc_Absyn_primop_exp(p,((_tmp550=_cycalloc(sizeof(*_tmp550)),((
_tmp550->hd=e,((_tmp550->tl=0,_tmp550)))))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_prim2_exp(
...
_tmp553;struct Cyc_List_List*_tmp552;return Cyc_Absyn_primop_exp(p,((_tmp552=
_cycalloc(sizeof(*_tmp552)),((_tmp552->hd=e1,((_tmp552->tl=((_tmp553=_cycalloc(
sizeof(*_tmp553)),((_tmp553->hd=e2,((_tmp553->tl=0,_tmp553)))))),_tmp552)))))),
...
_tmp556;struct Cyc_Absyn_AssignOp_e_struct*_tmp555;return Cyc_Absyn_new_exp((void*)((
_tmp555=_cycalloc(sizeof(*_tmp555)),((_tmp555[0]=((_tmp556.tag=4,((_tmp556.f1=e1,((
_tmp556.f2=popt,((_tmp556.f3=e2,_tmp556)))))))),_tmp555)))),loc);}struct Cyc_Absyn_Exp*
...
_tmp559;struct Cyc_Absyn_Increment_e_struct*_tmp558;return Cyc_Absyn_new_exp((void*)((
_tmp558=_cycalloc(sizeof(*_tmp558)),((_tmp558[0]=((_tmp559.tag=5,((_tmp559.f1=e,((
_tmp559.f2=(void*)i,_tmp559)))))),_tmp558)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_post_inc_exp(
...
_tmp55C;struct Cyc_Absyn_Conditional_e_struct*_tmp55B;return Cyc_Absyn_new_exp((
void*)((_tmp55B=_cycalloc(sizeof(*_tmp55B)),((_tmp55B[0]=((_tmp55C.tag=6,((
_tmp55C.f1=e1,((_tmp55C.f2=e2,((_tmp55C.f3=e3,_tmp55C)))))))),_tmp55B)))),loc);}
...
Cyc_Absyn_And_e_struct _tmp55F;struct Cyc_Absyn_And_e_struct*_tmp55E;return Cyc_Absyn_new_exp((
void*)((_tmp55E=_cycalloc(sizeof(*_tmp55E)),((_tmp55E[0]=((_tmp55F.tag=7,((
_tmp55F.f1=e1,((_tmp55F.f2=e2,_tmp55F)))))),_tmp55E)))),loc);}struct Cyc_Absyn_Exp*
...
e2,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Or_e_struct _tmp562;struct Cyc_Absyn_Or_e_struct*
_tmp561;return Cyc_Absyn_new_exp((void*)((_tmp561=_cycalloc(sizeof(*_tmp561)),((
_tmp561[0]=((_tmp562.tag=8,((_tmp562.f1=e1,((_tmp562.f2=e2,_tmp562)))))),_tmp561)))),
...
Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,struct Cyc_Position_Segment*loc){struct
Cyc_Absyn_SeqExp_e_struct _tmp565;struct Cyc_Absyn_SeqExp_e_struct*_tmp564;return
Cyc_Absyn_new_exp((void*)((_tmp564=_cycalloc(sizeof(*_tmp564)),((_tmp564[0]=((
_tmp565.tag=9,((_tmp565.f1=e1,((_tmp565.f2=e2,_tmp565)))))),_tmp564)))),loc);}
...
struct Cyc_Absyn_UnknownCall_e_struct _tmp568;struct Cyc_Absyn_UnknownCall_e_struct*
_tmp567;return Cyc_Absyn_new_exp((void*)((_tmp567=_cycalloc(sizeof(*_tmp567)),((
_tmp567[0]=((_tmp568.tag=10,((_tmp568.f1=e,((_tmp568.f2=es,_tmp568)))))),_tmp567)))),
...
struct Cyc_Absyn_Exp*e,struct Cyc_List_List*es,struct Cyc_Position_Segment*loc){
struct Cyc_Absyn_FnCall_e_struct _tmp56B;struct Cyc_Absyn_FnCall_e_struct*_tmp56A;
return Cyc_Absyn_new_exp((void*)((_tmp56A=_cycalloc(sizeof(*_tmp56A)),((_tmp56A[0]=((
_tmp56B.tag=11,((_tmp56B.f1=e,((_tmp56B.f2=es,((_tmp56B.f3=0,_tmp56B)))))))),
_tmp56A)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_noinstantiate_exp(struct Cyc_Absyn_Exp*
...
_tmp56E;struct Cyc_Absyn_NoInstantiate_e_struct*_tmp56D;return Cyc_Absyn_new_exp((
void*)((_tmp56D=_cycalloc(sizeof(*_tmp56D)),((_tmp56D[0]=((_tmp56E.tag=13,((
_tmp56E.f1=e,_tmp56E)))),_tmp56D)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_instantiate_exp(
...
ts,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Instantiate_e_struct _tmp571;
struct Cyc_Absyn_Instantiate_e_struct*_tmp570;return Cyc_Absyn_new_exp((void*)((
_tmp570=_cycalloc(sizeof(*_tmp570)),((_tmp570[0]=((_tmp571.tag=14,((_tmp571.f1=e,((
_tmp571.f2=ts,_tmp571)))))),_tmp570)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_cast_exp(
...
void*c,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Cast_e_struct _tmp574;
struct Cyc_Absyn_Cast_e_struct*_tmp573;return Cyc_Absyn_new_exp((void*)((_tmp573=
_cycalloc(sizeof(*_tmp573)),((_tmp573[0]=((_tmp574.tag=15,((_tmp574.f1=(void*)t,((
_tmp574.f2=e,((_tmp574.f3=user_cast,((_tmp574.f4=(void*)c,_tmp574)))))))))),
_tmp573)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_throw_exp(struct Cyc_Absyn_Exp*e,
...
_tmp577;struct Cyc_Absyn_Throw_e_struct*_tmp576;return Cyc_Absyn_new_exp((void*)((
_tmp576=_cycalloc(sizeof(*_tmp576)),((_tmp576[0]=((_tmp577.tag=12,((_tmp577.f1=e,
_tmp577)))),_tmp576)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_address_exp(struct
...
_tmp57A;struct Cyc_Absyn_Address_e_struct*_tmp579;return Cyc_Absyn_new_exp((void*)((
_tmp579=_cycalloc(sizeof(*_tmp579)),((_tmp579[0]=((_tmp57A.tag=16,((_tmp57A.f1=e,
_tmp57A)))),_tmp579)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_sizeoftyp_exp(void*t,
struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Exp*Cyc_Absyn_sizeoftyp_exp(void*
t,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Sizeoftyp_e_struct _tmp57D;
struct Cyc_Absyn_Sizeoftyp_e_struct*_tmp57C;return Cyc_Absyn_new_exp((void*)((
_tmp57C=_cycalloc(sizeof(*_tmp57C)),((_tmp57C[0]=((_tmp57D.tag=18,((_tmp57D.f1=(
void*)t,_tmp57D)))),_tmp57C)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_sizeofexp_exp(
...
_tmp580;struct Cyc_Absyn_Sizeofexp_e_struct*_tmp57F;return Cyc_Absyn_new_exp((void*)((
_tmp57F=_cycalloc(sizeof(*_tmp57F)),((_tmp57F[0]=((_tmp580.tag=19,((_tmp580.f1=e,
_tmp580)))),_tmp57F)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_offsetof_exp(void*t,
...
_tmp583;struct Cyc_Absyn_Offsetof_e_struct*_tmp582;return Cyc_Absyn_new_exp((void*)((
_tmp582=_cycalloc(sizeof(*_tmp582)),((_tmp582[0]=((_tmp583.tag=20,((_tmp583.f1=(
void*)t,((_tmp583.f2=(void*)of,_tmp583)))))),_tmp582)))),loc);}struct Cyc_Absyn_Exp*
...
struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Gentyp_e_struct _tmp586;struct Cyc_Absyn_Gentyp_e_struct*
_tmp585;return Cyc_Absyn_new_exp((void*)((_tmp585=_cycalloc(sizeof(*_tmp585)),((
_tmp585[0]=((_tmp586.tag=21,((_tmp586.f1=tvs,((_tmp586.f2=(void*)t,_tmp586)))))),
_tmp585)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_deref_exp(struct Cyc_Absyn_Exp*e,
...
_tmp589;struct Cyc_Absyn_Deref_e_struct*_tmp588;return Cyc_Absyn_new_exp((void*)((
_tmp588=_cycalloc(sizeof(*_tmp588)),((_tmp588[0]=((_tmp589.tag=22,((_tmp589.f1=e,
_tmp589)))),_tmp588)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_aggrmember_exp(
...
_tmp58C;struct Cyc_Absyn_AggrMember_e_struct*_tmp58B;return Cyc_Absyn_new_exp((
void*)((_tmp58B=_cycalloc(sizeof(*_tmp58B)),((_tmp58B[0]=((_tmp58C.tag=23,((
_tmp58C.f1=e,((_tmp58C.f2=n,_tmp58C)))))),_tmp58B)))),loc);}struct Cyc_Absyn_Exp*
...
_tmp58F;struct Cyc_Absyn_AggrArrow_e_struct*_tmp58E;return Cyc_Absyn_new_exp((void*)((
_tmp58E=_cycalloc(sizeof(*_tmp58E)),((_tmp58E[0]=((_tmp58F.tag=24,((_tmp58F.f1=e,((
_tmp58F.f2=n,_tmp58F)))))),_tmp58E)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_subscript_exp(
struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,struct Cyc_Position_Segment*loc);
struct Cyc_Absyn_Exp*Cyc_Absyn_subscript_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*
e2,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Subscript_e_struct _tmp592;
struct Cyc_Absyn_Subscript_e_struct*_tmp591;return Cyc_Absyn_new_exp((void*)((
_tmp591=_cycalloc(sizeof(*_tmp591)),((_tmp591[0]=((_tmp592.tag=25,((_tmp592.f1=
e1,((_tmp592.f2=e2,_tmp592)))))),_tmp591)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_tuple_exp(
...
_tmp595;struct Cyc_Absyn_Tuple_e_struct*_tmp594;return Cyc_Absyn_new_exp((void*)((
_tmp594=_cycalloc(sizeof(*_tmp594)),((_tmp594[0]=((_tmp595.tag=26,((_tmp595.f1=
es,_tmp595)))),_tmp594)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_stmt_exp(struct
...
_tmp598;struct Cyc_Absyn_StmtExp_e_struct*_tmp597;return Cyc_Absyn_new_exp((void*)((
_tmp597=_cycalloc(sizeof(*_tmp597)),((_tmp597[0]=((_tmp598.tag=38,((_tmp598.f1=s,
_tmp598)))),_tmp597)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_match_exn_exp(struct
...
_tmp59B;struct Cyc_Absyn_Valueof_e_struct*_tmp59A;return Cyc_Absyn_new_exp((void*)((
_tmp59A=_cycalloc(sizeof(*_tmp59A)),((_tmp59A[0]=((_tmp59B.tag=39,((_tmp59B.f1=(
void*)t,_tmp59B)))),_tmp59A)))),loc);}struct _tuple13{struct Cyc_List_List*f1;
...
0;for(0;es != 0;es=es->tl){struct _tuple13*_tmp59E;struct Cyc_List_List*_tmp59D;
dles=((_tmp59D=_cycalloc(sizeof(*_tmp59D)),((_tmp59D->hd=((_tmp59E=_cycalloc(
sizeof(*_tmp59E)),((_tmp59E->f1=0,((_tmp59E->f2=(struct Cyc_Absyn_Exp*)es->hd,
_tmp59E)))))),((_tmp59D->tl=dles,_tmp59D))))));}dles=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);{struct Cyc_Absyn_Array_e_struct
_tmp5A1;struct Cyc_Absyn_Array_e_struct*_tmp5A0;return Cyc_Absyn_new_exp((void*)((
_tmp5A0=_cycalloc(sizeof(*_tmp5A0)),((_tmp5A0[0]=((_tmp5A1.tag=28,((_tmp5A1.f1=
dles,_tmp5A1)))),_tmp5A0)))),loc);}}struct Cyc_Absyn_Exp*Cyc_Absyn_unresolvedmem_exp(
...
_tmp5A4;struct Cyc_Absyn_UnresolvedMem_e_struct*_tmp5A3;return Cyc_Absyn_new_exp((
void*)((_tmp5A3=_cycalloc(sizeof(*_tmp5A3)),((_tmp5A3[0]=((_tmp5A4.tag=37,((
_tmp5A4.f1=n,((_tmp5A4.f2=dles,_tmp5A4)))))),_tmp5A3)))),loc);}struct Cyc_Absyn_Stmt*
Cyc_Absyn_new_stmt(void*s,struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Stmt*
Cyc_Absyn_new_stmt(void*s,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Stmt*
_tmp5A5;return(_tmp5A5=_cycalloc(sizeof(*_tmp5A5)),((_tmp5A5->r=(void*)s,((
_tmp5A5->loc=loc,((_tmp5A5->non_local_preds=0,((_tmp5A5->try_depth=0,((_tmp5A5->annot=(
void*)((void*)Cyc_Absyn_EmptyAnnot),_tmp5A5)))))))))));}struct Cyc_Absyn_Stmt*Cyc_Absyn_skip_stmt(
...
loc){struct Cyc_Absyn_Exp_s_struct _tmp5A8;struct Cyc_Absyn_Exp_s_struct*_tmp5A7;
return Cyc_Absyn_new_stmt((void*)((_tmp5A7=_cycalloc(sizeof(*_tmp5A7)),((_tmp5A7[
0]=((_tmp5A8.tag=0,((_tmp5A8.f1=e,_tmp5A8)))),_tmp5A7)))),loc);}struct Cyc_Absyn_Stmt*
...
_tmp5AB;struct Cyc_Absyn_Return_s_struct*_tmp5AA;return Cyc_Absyn_new_stmt((void*)((
_tmp5AA=_cycalloc(sizeof(*_tmp5AA)),((_tmp5AA[0]=((_tmp5AB.tag=2,((_tmp5AB.f1=e,
_tmp5AB)))),_tmp5AA)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_ifthenelse_stmt(
struct Cyc_Absyn_Exp*e,struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2,struct Cyc_Position_Segment*
loc);struct Cyc_Absyn_Stmt*Cyc_Absyn_ifthenelse_stmt(struct Cyc_Absyn_Exp*e,struct
Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2,struct Cyc_Position_Segment*loc){struct
Cyc_Absyn_IfThenElse_s_struct _tmp5AE;struct Cyc_Absyn_IfThenElse_s_struct*_tmp5AD;
return Cyc_Absyn_new_stmt((void*)((_tmp5AD=_cycalloc(sizeof(*_tmp5AD)),((_tmp5AD[
0]=((_tmp5AE.tag=3,((_tmp5AE.f1=e,((_tmp5AE.f2=s1,((_tmp5AE.f3=s2,_tmp5AE)))))))),
_tmp5AD)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_while_stmt(struct Cyc_Absyn_Exp*
...
loc){struct Cyc_Absyn_While_s_struct _tmp5B4;struct _tuple2 _tmp5B3;struct Cyc_Absyn_While_s_struct*
_tmp5B2;return Cyc_Absyn_new_stmt((void*)((_tmp5B2=_cycalloc(sizeof(*_tmp5B2)),((
_tmp5B2[0]=((_tmp5B4.tag=4,((_tmp5B4.f1=((_tmp5B3.f1=e,((_tmp5B3.f2=Cyc_Absyn_skip_stmt(
e->loc),_tmp5B3)))),((_tmp5B4.f2=s,_tmp5B4)))))),_tmp5B2)))),loc);}struct Cyc_Absyn_Stmt*
Cyc_Absyn_break_stmt(struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Stmt*Cyc_Absyn_break_stmt(
struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Break_s_struct _tmp5B7;struct Cyc_Absyn_Break_s_struct*
_tmp5B6;return Cyc_Absyn_new_stmt((void*)((_tmp5B6=_cycalloc(sizeof(*_tmp5B6)),((
_tmp5B6[0]=((_tmp5B7.tag=5,((_tmp5B7.f1=0,_tmp5B7)))),_tmp5B6)))),loc);}struct
...
_tmp5BA;struct Cyc_Absyn_Continue_s_struct*_tmp5B9;return Cyc_Absyn_new_stmt((void*)((
_tmp5B9=_cycalloc(sizeof(*_tmp5B9)),((_tmp5B9[0]=((_tmp5BA.tag=6,((_tmp5BA.f1=0,
_tmp5BA)))),_tmp5B9)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_for_stmt(struct Cyc_Absyn_Exp*
...
e1,struct Cyc_Absyn_Exp*e2,struct Cyc_Absyn_Exp*e3,struct Cyc_Absyn_Stmt*s,struct
Cyc_Position_Segment*loc){struct Cyc_Absyn_For_s_struct _tmp5C3;struct _tuple2
_tmp5C2;struct _tuple2 _tmp5C1;struct Cyc_Absyn_For_s_struct*_tmp5C0;return Cyc_Absyn_new_stmt((
void*)((_tmp5C0=_cycalloc(sizeof(*_tmp5C0)),((_tmp5C0[0]=((_tmp5C3.tag=8,((
_tmp5C3.f1=e1,((_tmp5C3.f2=((_tmp5C1.f1=e2,((_tmp5C1.f2=Cyc_Absyn_skip_stmt(e3->loc),
_tmp5C1)))),((_tmp5C3.f3=((_tmp5C2.f1=e3,((_tmp5C2.f2=Cyc_Absyn_skip_stmt(e3->loc),
_tmp5C2)))),((_tmp5C3.f4=s,_tmp5C3)))))))))),_tmp5C0)))),loc);}struct Cyc_Absyn_Stmt*
...
scs,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Switch_s_struct _tmp5C6;
struct Cyc_Absyn_Switch_s_struct*_tmp5C5;return Cyc_Absyn_new_stmt((void*)((
_tmp5C5=_cycalloc(sizeof(*_tmp5C5)),((_tmp5C5[0]=((_tmp5C6.tag=9,((_tmp5C6.f1=e,((
_tmp5C6.f2=scs,_tmp5C6)))))),_tmp5C5)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_seq_stmt(
struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2,struct Cyc_Position_Segment*loc);
struct Cyc_Absyn_Stmt*Cyc_Absyn_seq_stmt(struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*
s2,struct Cyc_Position_Segment*loc){struct _tuple9 _tmp5C7;struct _tuple9 _tmp101=(
_tmp5C7.f1=(void*)s1->r,((_tmp5C7.f2=(void*)s2->r,_tmp5C7)));void*_tmp102;void*
...
_LL69: {struct Cyc_Absyn_Seq_s_struct _tmp5CA;struct Cyc_Absyn_Seq_s_struct*_tmp5C9;
return Cyc_Absyn_new_stmt((void*)((_tmp5C9=_cycalloc(sizeof(*_tmp5C9)),((_tmp5C9[
0]=((_tmp5CA.tag=1,((_tmp5CA.f1=s1,((_tmp5CA.f2=s2,_tmp5CA)))))),_tmp5C9)))),loc);}
...
_tmp5CD;struct Cyc_Absyn_Fallthru_s_struct*_tmp5CC;return Cyc_Absyn_new_stmt((void*)((
_tmp5CC=_cycalloc(sizeof(*_tmp5CC)),((_tmp5CC[0]=((_tmp5CD.tag=10,((_tmp5CD.f1=
el,((_tmp5CD.f2=0,_tmp5CD)))))),_tmp5CC)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_decl_stmt(
struct Cyc_Absyn_Decl*d,struct Cyc_Absyn_Stmt*s,struct Cyc_Position_Segment*loc);
struct Cyc_Absyn_Stmt*Cyc_Absyn_decl_stmt(struct Cyc_Absyn_Decl*d,struct Cyc_Absyn_Stmt*
s,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Decl_s_struct _tmp5D0;struct Cyc_Absyn_Decl_s_struct*
_tmp5CF;return Cyc_Absyn_new_stmt((void*)((_tmp5CF=_cycalloc(sizeof(*_tmp5CF)),((
_tmp5CF[0]=((_tmp5D0.tag=11,((_tmp5D0.f1=d,((_tmp5D0.f2=s,_tmp5D0)))))),_tmp5CF)))),
...
_tmp5D3;struct Cyc_Absyn_Var_d_struct*_tmp5D2;struct Cyc_Absyn_Decl*d=Cyc_Absyn_new_decl((
void*)((_tmp5D2=_cycalloc(sizeof(*_tmp5D2)),((_tmp5D2[0]=((_tmp5D3.tag=0,((
_tmp5D3.f1=Cyc_Absyn_new_vardecl(x,t,init),_tmp5D3)))),_tmp5D2)))),loc);struct
Cyc_Absyn_Decl_s_struct _tmp5D6;struct Cyc_Absyn_Decl_s_struct*_tmp5D5;return Cyc_Absyn_new_stmt((
void*)((_tmp5D5=_cycalloc(sizeof(*_tmp5D5)),((_tmp5D5[0]=((_tmp5D6.tag=11,((
_tmp5D6.f1=d,((_tmp5D6.f2=s,_tmp5D6)))))),_tmp5D5)))),loc);}struct Cyc_Absyn_Stmt*
Cyc_Absyn_label_stmt(struct _dyneither_ptr*v,struct Cyc_Absyn_Stmt*s,struct Cyc_Position_Segment*
loc);struct Cyc_Absyn_Stmt*Cyc_Absyn_label_stmt(struct _dyneither_ptr*v,struct Cyc_Absyn_Stmt*
s,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Label_s_struct _tmp5D9;struct
Cyc_Absyn_Label_s_struct*_tmp5D8;return Cyc_Absyn_new_stmt((void*)((_tmp5D8=
_cycalloc(sizeof(*_tmp5D8)),((_tmp5D8[0]=((_tmp5D9.tag=12,((_tmp5D9.f1=v,((
_tmp5D9.f2=s,_tmp5D9)))))),_tmp5D8)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_do_stmt(
...
e,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Do_s_struct _tmp5DF;struct
_tuple2 _tmp5DE;struct Cyc_Absyn_Do_s_struct*_tmp5DD;return Cyc_Absyn_new_stmt((
void*)((_tmp5DD=_cycalloc(sizeof(*_tmp5DD)),((_tmp5DD[0]=((_tmp5DF.tag=13,((
_tmp5DF.f1=s,((_tmp5DF.f2=((_tmp5DE.f1=e,((_tmp5DE.f2=Cyc_Absyn_skip_stmt(e->loc),
_tmp5DE)))),_tmp5DF)))))),_tmp5DD)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_trycatch_stmt(
...
scs,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_TryCatch_s_struct _tmp5E2;
struct Cyc_Absyn_TryCatch_s_struct*_tmp5E1;return Cyc_Absyn_new_stmt((void*)((
_tmp5E1=_cycalloc(sizeof(*_tmp5E1)),((_tmp5E1[0]=((_tmp5E2.tag=14,((_tmp5E2.f1=s,((
_tmp5E2.f2=scs,_tmp5E2)))))),_tmp5E1)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_goto_stmt(
struct _dyneither_ptr*lab,struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Stmt*
Cyc_Absyn_goto_stmt(struct _dyneither_ptr*lab,struct Cyc_Position_Segment*loc){
struct Cyc_Absyn_Goto_s_struct _tmp5E5;struct Cyc_Absyn_Goto_s_struct*_tmp5E4;
return Cyc_Absyn_new_stmt((void*)((_tmp5E4=_cycalloc(sizeof(*_tmp5E4)),((_tmp5E4[
0]=((_tmp5E5.tag=7,((_tmp5E5.f1=lab,((_tmp5E5.f2=0,_tmp5E5)))))),_tmp5E4)))),loc);}
...
void*p,struct Cyc_Position_Segment*s){struct Cyc_Absyn_Pat*_tmp5E6;return(_tmp5E6=
_cycalloc(sizeof(*_tmp5E6)),((_tmp5E6->r=(void*)p,((_tmp5E6->topt=0,((_tmp5E6->loc=
s,_tmp5E6)))))));}struct Cyc_Absyn_Pat*Cyc_Absyn_exp_pat(struct Cyc_Absyn_Exp*e);
struct Cyc_Absyn_Pat*Cyc_Absyn_exp_pat(struct Cyc_Absyn_Exp*e){struct Cyc_Absyn_Exp_p_struct
_tmp5E9;struct Cyc_Absyn_Exp_p_struct*_tmp5E8;return Cyc_Absyn_new_pat((void*)((
_tmp5E8=_cycalloc(sizeof(*_tmp5E8)),((_tmp5E8[0]=((_tmp5E9.tag=14,((_tmp5E9.f1=e,
_tmp5E9)))),_tmp5E8)))),e->loc);}struct Cyc_Absyn_Decl*Cyc_Absyn_new_decl(void*r,
struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Decl*Cyc_Absyn_new_decl(void*r,
struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Decl*_tmp5EA;return(_tmp5EA=
_cycalloc(sizeof(*_tmp5EA)),((_tmp5EA->r=(void*)r,((_tmp5EA->loc=loc,_tmp5EA)))));}
...
_tmp5ED;struct Cyc_Absyn_Let_d_struct*_tmp5EC;return Cyc_Absyn_new_decl((void*)((
_tmp5EC=_cycalloc(sizeof(*_tmp5EC)),((_tmp5EC[0]=((_tmp5ED.tag=2,((_tmp5ED.f1=p,((
_tmp5ED.f2=0,((_tmp5ED.f3=e,_tmp5ED)))))))),_tmp5EC)))),loc);}struct Cyc_Absyn_Decl*
...
loc){struct Cyc_Absyn_Letv_d_struct _tmp5F0;struct Cyc_Absyn_Letv_d_struct*_tmp5EF;
return Cyc_Absyn_new_decl((void*)((_tmp5EF=_cycalloc(sizeof(*_tmp5EF)),((_tmp5EF[
0]=((_tmp5F0.tag=3,((_tmp5F0.f1=vds,_tmp5F0)))),_tmp5EF)))),loc);}struct Cyc_Absyn_Vardecl*
Cyc_Absyn_new_vardecl(struct _tuple0*x,void*t,struct Cyc_Absyn_Exp*init);struct Cyc_Absyn_Vardecl*
Cyc_Absyn_new_vardecl(struct _tuple0*x,void*t,struct Cyc_Absyn_Exp*init){struct Cyc_Absyn_Vardecl*
_tmp5F1;return(_tmp5F1=_cycalloc(sizeof(*_tmp5F1)),((_tmp5F1->sc=(void*)((void*)
2),((_tmp5F1->name=x,((_tmp5F1->tq=Cyc_Absyn_empty_tqual(0),((_tmp5F1->type=(
void*)t,((_tmp5F1->initializer=init,((_tmp5F1->rgn=0,((_tmp5F1->attributes=0,((
_tmp5F1->escapes=0,_tmp5F1)))))))))))))))));}struct Cyc_Absyn_Vardecl*Cyc_Absyn_static_vardecl(
struct _tuple0*x,void*t,struct Cyc_Absyn_Exp*init);struct Cyc_Absyn_Vardecl*Cyc_Absyn_static_vardecl(
struct _tuple0*x,void*t,struct Cyc_Absyn_Exp*init){struct Cyc_Absyn_Vardecl*_tmp5F2;
return(_tmp5F2=_cycalloc(sizeof(*_tmp5F2)),((_tmp5F2->sc=(void*)((void*)0),((
_tmp5F2->name=x,((_tmp5F2->tq=Cyc_Absyn_empty_tqual(0),((_tmp5F2->type=(void*)t,((
_tmp5F2->initializer=init,((_tmp5F2->rgn=0,((_tmp5F2->attributes=0,((_tmp5F2->escapes=
0,_tmp5F2)))))))))))))))));}struct Cyc_Absyn_AggrdeclImpl*Cyc_Absyn_aggrdecl_impl(
...
Cyc_List_List*po,struct Cyc_List_List*fs){struct Cyc_Absyn_AggrdeclImpl*_tmp5F3;
return(_tmp5F3=_cycalloc(sizeof(*_tmp5F3)),((_tmp5F3->exist_vars=exists,((
_tmp5F3->rgn_po=po,((_tmp5F3->fields=fs,_tmp5F3)))))));}struct Cyc_Absyn_Decl*Cyc_Absyn_aggr_decl(
...
struct Cyc_Absyn_Aggr_d_struct _tmp5F9;struct Cyc_Absyn_Aggrdecl*_tmp5F8;struct Cyc_Absyn_Aggr_d_struct*
_tmp5F7;return Cyc_Absyn_new_decl((void*)((_tmp5F7=_cycalloc(sizeof(*_tmp5F7)),((
_tmp5F7[0]=((_tmp5F9.tag=4,((_tmp5F9.f1=((_tmp5F8=_cycalloc(sizeof(*_tmp5F8)),((
_tmp5F8->kind=(void*)k,((_tmp5F8->sc=(void*)s,((_tmp5F8->name=n,((_tmp5F8->tvs=
ts,((_tmp5F8->impl=i,((_tmp5F8->attributes=atts,_tmp5F8)))))))))))))),_tmp5F9)))),
_tmp5F7)))),loc);}struct Cyc_Absyn_Decl*Cyc_Absyn_struct_decl(void*s,struct
_tuple0*n,struct Cyc_List_List*ts,struct Cyc_Absyn_AggrdeclImpl*i,struct Cyc_List_List*
atts,struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Decl*Cyc_Absyn_struct_decl(
void*s,struct _tuple0*n,struct Cyc_List_List*ts,struct Cyc_Absyn_AggrdeclImpl*i,
...
_tmp5FF;struct Cyc_Absyn_Tuniondecl*_tmp5FE;struct Cyc_Absyn_Tunion_d_struct*
_tmp5FD;return Cyc_Absyn_new_decl((void*)((_tmp5FD=_cycalloc(sizeof(*_tmp5FD)),((
_tmp5FD[0]=((_tmp5FF.tag=5,((_tmp5FF.f1=((_tmp5FE=_cycalloc(sizeof(*_tmp5FE)),((
_tmp5FE->sc=(void*)s,((_tmp5FE->name=n,((_tmp5FE->tvs=ts,((_tmp5FE->fields=fs,((
_tmp5FE->is_xtunion=is_xtunion,((_tmp5FE->is_flat=is_flat,_tmp5FE)))))))))))))),
_tmp5FF)))),_tmp5FD)))),loc);}static struct _tuple1*Cyc_Absyn_expand_arg(struct
_tuple1*a);static struct _tuple1*Cyc_Absyn_expand_arg(struct _tuple1*a){struct
_tuple1*_tmp600;return(_tmp600=_cycalloc(sizeof(*_tmp600)),((_tmp600->f1=(*a).f1,((
_tmp600->f2=(*a).f2,((_tmp600->f3=Cyc_Absyn_pointer_expand((*a).f3,1),_tmp600)))))));}
...
struct Cyc_List_List*tvs,struct Cyc_Core_Opt*eff_typ,void*ret_typ,struct Cyc_List_List*
args,int c_varargs,struct Cyc_Absyn_VarargInfo*cyc_varargs,struct Cyc_List_List*
rgn_po,struct Cyc_List_List*atts){struct Cyc_Absyn_FnType_struct _tmp606;struct Cyc_Absyn_FnInfo
_tmp605;struct Cyc_Absyn_FnType_struct*_tmp604;return(void*)((_tmp604=_cycalloc(
sizeof(*_tmp604)),((_tmp604[0]=((_tmp606.tag=8,((_tmp606.f1=((_tmp605.tvars=tvs,((
_tmp605.ret_typ=(void*)Cyc_Absyn_pointer_expand(ret_typ,0),((_tmp605.effect=
eff_typ,((_tmp605.args=((struct Cyc_List_List*(*)(struct _tuple1*(*f)(struct
_tuple1*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Absyn_expand_arg,args),((
_tmp605.c_varargs=c_varargs,((_tmp605.cyc_varargs=cyc_varargs,((_tmp605.rgn_po=
rgn_po,((_tmp605.attributes=atts,_tmp605)))))))))))))))),_tmp606)))),_tmp604))));}
...
void*)4)goto _LL6D;if(*((int*)_tmp12C)!= 8)goto _LL6D;_LL6C: {struct Cyc_Core_Opt*
_tmp607;return Cyc_Absyn_at_typ(t,fresh_evar?Cyc_Absyn_new_evar(((_tmp607=
_cycalloc(sizeof(*_tmp607)),((_tmp607->v=(void*)((void*)3),_tmp607)))),0):(void*)
...
e){void*_tmp12E=(void*)e->r;void*_tmp12F;void*_tmp130;struct Cyc_Absyn_Vardecl*
_tmp131;void*_tmp132;struct Cyc_Absyn_Vardecl*_tmp133;struct Cyc_Absyn_Exp*_tmp134;
struct Cyc_Absyn_Exp*_tmp135;struct Cyc_Absyn_Exp*_tmp136;_LL70: if(*((int*)_tmp12E)
!= 1)goto _LL72;_tmp12F=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp12E)->f2;if(
_tmp12F <= (void*)1)goto _LL72;if(*((int*)_tmp12F)!= 1)goto _LL72;_LL71: return 0;
...
Cyc_List_List*fields,struct _dyneither_ptr*v){{struct Cyc_List_List*_tmp138=fields;
for(0;_tmp138 != 0;_tmp138=_tmp138->tl){if(Cyc_strptrcmp(((struct Cyc_Absyn_Aggrfield*)
_tmp138->hd)->name,v)== 0)return(struct Cyc_Absyn_Aggrfield*)((struct Cyc_Absyn_Aggrfield*)
_tmp138->hd);}}return 0;}struct Cyc_Absyn_Aggrfield*Cyc_Absyn_lookup_decl_field(
...
void*a);struct _dyneither_ptr Cyc_Absyn_attribute2string(void*a){void*_tmp139=a;
int _tmp13A;int _tmp13B;struct _dyneither_ptr _tmp13C;void*_tmp13D;int _tmp13E;int
_tmp13F;void*_tmp140;int _tmp141;int _tmp142;int _tmp143;struct _dyneither_ptr
_tmp144;_LL8C: if(_tmp139 <= (void*)17)goto _LL8E;if(*((int*)_tmp139)!= 0)goto _LL8E;
_tmp13A=((struct Cyc_Absyn_Regparm_att_struct*)_tmp139)->f1;_LL8D: {const char*
_tmp60B;void*_tmp60A[1];struct Cyc_Int_pa_struct _tmp609;return(struct
_dyneither_ptr)((_tmp609.tag=1,((_tmp609.f1=(unsigned long)_tmp13A,((_tmp60A[0]=&
_tmp609,Cyc_aprintf(((_tmp60B="regparm(%d)",_tag_dyneither(_tmp60B,sizeof(char),
12))),_tag_dyneither(_tmp60A,sizeof(void*),1))))))));}_LL8E: if((int)_tmp139 != 0)
goto _LL90;_LL8F: {const char*_tmp60C;return(_tmp60C="stdcall",_tag_dyneither(
_tmp60C,sizeof(char),8));}_LL90: if((int)_tmp139 != 1)goto _LL92;_LL91: {const char*
_tmp60D;return(_tmp60D="cdecl",_tag_dyneither(_tmp60D,sizeof(char),6));}_LL92:
if((int)_tmp139 != 2)goto _LL94;_LL93: {const char*_tmp60E;return(_tmp60E="fastcall",
_tag_dyneither(_tmp60E,sizeof(char),9));}_LL94: if((int)_tmp139 != 3)goto _LL96;
_LL95: {const char*_tmp60F;return(_tmp60F="noreturn",_tag_dyneither(_tmp60F,
sizeof(char),9));}_LL96: if((int)_tmp139 != 4)goto _LL98;_LL97: {const char*_tmp610;
return(_tmp610="const",_tag_dyneither(_tmp610,sizeof(char),6));}_LL98: if(_tmp139
<= (void*)17)goto _LL9A;if(*((int*)_tmp139)!= 1)goto _LL9A;_tmp13B=((struct Cyc_Absyn_Aligned_att_struct*)
_tmp139)->f1;_LL99: if(_tmp13B == - 1){const char*_tmp611;return(_tmp611="aligned",
_tag_dyneither(_tmp611,sizeof(char),8));}else{void*_tmp14E=Cyc_Cyclone_c_compiler;
_LLBD: if((int)_tmp14E != 0)goto _LLBF;_LLBE: {const char*_tmp615;void*_tmp614[1];
struct Cyc_Int_pa_struct _tmp613;return(struct _dyneither_ptr)((_tmp613.tag=1,((
_tmp613.f1=(unsigned long)_tmp13B,((_tmp614[0]=& _tmp613,Cyc_aprintf(((_tmp615="aligned(%d)",
_tag_dyneither(_tmp615,sizeof(char),12))),_tag_dyneither(_tmp614,sizeof(void*),1))))))));}
_LLBF: if((int)_tmp14E != 1)goto _LLBC;_LLC0: {const char*_tmp619;void*_tmp618[1];
struct Cyc_Int_pa_struct _tmp617;return(struct _dyneither_ptr)((_tmp617.tag=1,((
_tmp617.f1=(unsigned long)_tmp13B,((_tmp618[0]=& _tmp617,Cyc_aprintf(((_tmp619="align(%d)",
_tag_dyneither(_tmp619,sizeof(char),10))),_tag_dyneither(_tmp618,sizeof(void*),1))))))));}
_LLBC:;}_LL9A: if((int)_tmp139 != 5)goto _LL9C;_LL9B: {const char*_tmp61A;return(
_tmp61A="packed",_tag_dyneither(_tmp61A,sizeof(char),7));}_LL9C: if(_tmp139 <= (
void*)17)goto _LL9E;if(*((int*)_tmp139)!= 2)goto _LL9E;_tmp13C=((struct Cyc_Absyn_Section_att_struct*)
_tmp139)->f1;_LL9D: {const char*_tmp61E;void*_tmp61D[1];struct Cyc_String_pa_struct
_tmp61C;return(struct _dyneither_ptr)((_tmp61C.tag=0,((_tmp61C.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)_tmp13C),((_tmp61D[0]=& _tmp61C,Cyc_aprintf(((
_tmp61E="section(\"%s\")",_tag_dyneither(_tmp61E,sizeof(char),14))),
_tag_dyneither(_tmp61D,sizeof(void*),1))))))));}_LL9E: if((int)_tmp139 != 6)goto
_LLA0;_LL9F: {const char*_tmp61F;return(_tmp61F="nocommon",_tag_dyneither(_tmp61F,
sizeof(char),9));}_LLA0: if((int)_tmp139 != 7)goto _LLA2;_LLA1: {const char*_tmp620;
return(_tmp620="shared",_tag_dyneither(_tmp620,sizeof(char),7));}_LLA2: if((int)
_tmp139 != 8)goto _LLA4;_LLA3: {const char*_tmp621;return(_tmp621="unused",
_tag_dyneither(_tmp621,sizeof(char),7));}_LLA4: if((int)_tmp139 != 9)goto _LLA6;
_LLA5: {const char*_tmp622;return(_tmp622="weak",_tag_dyneither(_tmp622,sizeof(
char),5));}_LLA6: if((int)_tmp139 != 10)goto _LLA8;_LLA7: {const char*_tmp623;return(
_tmp623="dllimport",_tag_dyneither(_tmp623,sizeof(char),10));}_LLA8: if((int)
_tmp139 != 11)goto _LLAA;_LLA9: {const char*_tmp624;return(_tmp624="dllexport",
_tag_dyneither(_tmp624,sizeof(char),10));}_LLAA: if((int)_tmp139 != 12)goto _LLAC;
_LLAB: {const char*_tmp625;return(_tmp625="no_instrument_function",_tag_dyneither(
_tmp625,sizeof(char),23));}_LLAC: if((int)_tmp139 != 13)goto _LLAE;_LLAD: {const
char*_tmp626;return(_tmp626="constructor",_tag_dyneither(_tmp626,sizeof(char),12));}
_LLAE: if((int)_tmp139 != 14)goto _LLB0;_LLAF: {const char*_tmp627;return(_tmp627="destructor",
_tag_dyneither(_tmp627,sizeof(char),11));}_LLB0: if((int)_tmp139 != 15)goto _LLB2;
_LLB1: {const char*_tmp628;return(_tmp628="no_check_memory_usage",_tag_dyneither(
_tmp628,sizeof(char),22));}_LLB2: if(_tmp139 <= (void*)17)goto _LLB8;if(*((int*)
_tmp139)!= 3)goto _LLB4;_tmp13D=(void*)((struct Cyc_Absyn_Format_att_struct*)
_tmp139)->f1;if((int)_tmp13D != 0)goto _LLB4;_tmp13E=((struct Cyc_Absyn_Format_att_struct*)
_tmp139)->f2;_tmp13F=((struct Cyc_Absyn_Format_att_struct*)_tmp139)->f3;_LLB3: {
const char*_tmp62D;void*_tmp62C[2];struct Cyc_Int_pa_struct _tmp62B;struct Cyc_Int_pa_struct
_tmp62A;return(struct _dyneither_ptr)((_tmp62A.tag=1,((_tmp62A.f1=(unsigned int)
_tmp13F,((_tmp62B.tag=1,((_tmp62B.f1=(unsigned int)_tmp13E,((_tmp62C[0]=& _tmp62B,((
_tmp62C[1]=& _tmp62A,Cyc_aprintf(((_tmp62D="format(printf,%u,%u)",_tag_dyneither(
_tmp62D,sizeof(char),21))),_tag_dyneither(_tmp62C,sizeof(void*),2))))))))))))));}
_LLB4: if(*((int*)_tmp139)!= 3)goto _LLB6;_tmp140=(void*)((struct Cyc_Absyn_Format_att_struct*)
_tmp139)->f1;if((int)_tmp140 != 1)goto _LLB6;_tmp141=((struct Cyc_Absyn_Format_att_struct*)
_tmp139)->f2;_tmp142=((struct Cyc_Absyn_Format_att_struct*)_tmp139)->f3;_LLB5: {
const char*_tmp632;void*_tmp631[2];struct Cyc_Int_pa_struct _tmp630;struct Cyc_Int_pa_struct
_tmp62F;return(struct _dyneither_ptr)((_tmp62F.tag=1,((_tmp62F.f1=(unsigned int)
_tmp142,((_tmp630.tag=1,((_tmp630.f1=(unsigned int)_tmp141,((_tmp631[0]=& _tmp630,((
_tmp631[1]=& _tmp62F,Cyc_aprintf(((_tmp632="format(scanf,%u,%u)",_tag_dyneither(
_tmp632,sizeof(char),20))),_tag_dyneither(_tmp631,sizeof(void*),2))))))))))))));}
_LLB6: if(*((int*)_tmp139)!= 4)goto _LLB8;_tmp143=((struct Cyc_Absyn_Initializes_att_struct*)
_tmp139)->f1;_LLB7: {const char*_tmp636;void*_tmp635[1];struct Cyc_Int_pa_struct
_tmp634;return(struct _dyneither_ptr)((_tmp634.tag=1,((_tmp634.f1=(unsigned long)
_tmp143,((_tmp635[0]=& _tmp634,Cyc_aprintf(((_tmp636="initializes(%d)",
_tag_dyneither(_tmp636,sizeof(char),16))),_tag_dyneither(_tmp635,sizeof(void*),1))))))));}
_LLB8: if((int)_tmp139 != 16)goto _LLBA;_LLB9: {const char*_tmp637;return(_tmp637="pure",
_tag_dyneither(_tmp637,sizeof(char),5));}_LLBA: if(_tmp139 <= (void*)17)goto _LL8B;
if(*((int*)_tmp139)!= 5)goto _LL8B;_tmp144=((struct Cyc_Absyn_Mode_att_struct*)
_tmp139)->f1;_LLBB: {const char*_tmp63B;void*_tmp63A[1];struct Cyc_String_pa_struct
_tmp639;return(struct _dyneither_ptr)((_tmp639.tag=0,((_tmp639.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)_tmp144),((_tmp63A[0]=& _tmp639,Cyc_aprintf(((
_tmp63B="__mode__(\"%s\")",_tag_dyneither(_tmp63B,sizeof(char),15))),
_tag_dyneither(_tmp63A,sizeof(void*),1))))))));}_LL8B:;}int Cyc_Absyn_fntype_att(
void*a);int Cyc_Absyn_fntype_att(void*a){void*_tmp172=a;_LLC2: if(_tmp172 <= (void*)
17)goto _LLC4;if(*((int*)_tmp172)!= 0)goto _LLC4;_LLC3: goto _LLC5;_LLC4: if((int)
_tmp172 != 2)goto _LLC6;_LLC5: goto _LLC7;_LLC6: if((int)_tmp172 != 0)goto _LLC8;_LLC7:
goto _LLC9;_LLC8: if((int)_tmp172 != 1)goto _LLCA;_LLC9: goto _LLCB;_LLCA: if((int)
_tmp172 != 3)goto _LLCC;_LLCB: goto _LLCD;_LLCC: if((int)_tmp172 != 16)goto _LLCE;_LLCD:
goto _LLCF;_LLCE: if(_tmp172 <= (void*)17)goto _LLD0;if(*((int*)_tmp172)!= 3)goto
_LLD0;_LLCF: goto _LLD1;_LLD0: if((int)_tmp172 != 4)goto _LLD2;_LLD1: return 1;_LLD2:
if(_tmp172 <= (void*)17)goto _LLD4;if(*((int*)_tmp172)!= 4)goto _LLD4;_LLD3: return 1;
_LLD4:;_LLD5: return 0;_LLC1:;}static char _tmp173[3]="f0";static struct
_dyneither_ptr Cyc_Absyn_f0={_tmp173,_tmp173,_tmp173 + 3};static struct
...
int i);static void _tmp649(unsigned int*fsz,unsigned int*_tmp648,unsigned int*
_tmp647,struct _dyneither_ptr***_tmp645){for(*_tmp648=0;*_tmp648 < *_tmp647;(*
_tmp648)++){struct Cyc_Int_pa_struct _tmp643;void*_tmp642[1];const char*_tmp641;
struct _dyneither_ptr*_tmp640;(*_tmp645)[*_tmp648]=*_tmp648 < *fsz?*((struct
_dyneither_ptr**)_check_dyneither_subscript(Cyc_Absyn_field_names,sizeof(struct
_dyneither_ptr*),(int)*_tmp648)):((_tmp640=_cycalloc(sizeof(*_tmp640)),((_tmp640[
0]=(struct _dyneither_ptr)((_tmp643.tag=1,((_tmp643.f1=(unsigned long)((int)*
_tmp648),((_tmp642[0]=& _tmp643,Cyc_aprintf(((_tmp641="f%d",_tag_dyneither(
_tmp641,sizeof(char),4))),_tag_dyneither(_tmp642,sizeof(void*),1)))))))),_tmp640))));}}
...
fsz){unsigned int _tmp648;unsigned int _tmp647;struct _dyneither_ptr _tmp646;struct
_dyneither_ptr**_tmp645;unsigned int _tmp644;Cyc_Absyn_field_names=((_tmp644=(
unsigned int)(i + 1),((_tmp645=(struct _dyneither_ptr**)_cycalloc(_check_times(
sizeof(struct _dyneither_ptr*),_tmp644)),((_tmp646=_tag_dyneither(_tmp645,sizeof(
struct _dyneither_ptr*),_tmp644),((((_tmp647=_tmp644,_tmp649(& fsz,& _tmp648,&
_tmp647,& _tmp645))),_tmp646))))))));}return*((struct _dyneither_ptr**)
...
struct _tuple4 Cyc_Absyn_aggr_kinded_name(union Cyc_Absyn_AggrInfoU_union info){
union Cyc_Absyn_AggrInfoU_union _tmp17C=info;void*_tmp17D;struct _tuple0*_tmp17E;
struct Cyc_Absyn_Aggrdecl**_tmp17F;struct Cyc_Absyn_Aggrdecl*_tmp180;struct Cyc_Absyn_Aggrdecl
_tmp181;void*_tmp182;struct _tuple0*_tmp183;_LLD7: if((_tmp17C.UnknownAggr).tag != 
0)goto _LLD9;_tmp17D=(_tmp17C.UnknownAggr).f1;_tmp17E=(_tmp17C.UnknownAggr).f2;
_LLD8: {struct _tuple4 _tmp64A;return(_tmp64A.f1=_tmp17D,((_tmp64A.f2=_tmp17E,
_tmp64A)));}_LLD9: if((_tmp17C.KnownAggr).tag != 1)goto _LLD6;_tmp17F=(_tmp17C.KnownAggr).f1;
_tmp180=*_tmp17F;_tmp181=*_tmp180;_tmp182=(void*)_tmp181.kind;_tmp183=_tmp181.name;
_LLDA: {struct _tuple4 _tmp64B;return(_tmp64B.f1=_tmp182,((_tmp64B.f2=_tmp183,
_tmp64B)));}_LLD6:;}struct Cyc_Absyn_Aggrdecl*Cyc_Absyn_get_known_aggrdecl(union
Cyc_Absyn_AggrInfoU_union info);struct Cyc_Absyn_Aggrdecl*Cyc_Absyn_get_known_aggrdecl(
union Cyc_Absyn_AggrInfoU_union info){union Cyc_Absyn_AggrInfoU_union _tmp186=info;
void*_tmp187;struct _tuple0*_tmp188;struct Cyc_Absyn_Aggrdecl**_tmp189;struct Cyc_Absyn_Aggrdecl*
_tmp18A;_LLDC: if((_tmp186.UnknownAggr).tag != 0)goto _LLDE;_tmp187=(_tmp186.UnknownAggr).f1;
_tmp188=(_tmp186.UnknownAggr).f2;_LLDD: {const char*_tmp64E;void*_tmp64D;(_tmp64D=
0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp64E="unchecked aggrdecl",_tag_dyneither(_tmp64E,sizeof(char),19))),
_tag_dyneither(_tmp64D,sizeof(void*),0)));}_LLDE: if((_tmp186.KnownAggr).tag != 1)
goto _LLDB;_tmp189=(_tmp186.KnownAggr).f1;_tmp18A=*_tmp189;_LLDF: return _tmp18A;
_LLDB:;}int Cyc_Absyn_is_union_type(void*t);int Cyc_Absyn_is_union_type(void*t){
void*_tmp18D=Cyc_Tcutil_compress(t);void*_tmp18E;struct Cyc_Absyn_AggrInfo _tmp18F;
...
void*t){void*_tmp191=Cyc_Tcutil_compress(t);_LLE8: if(_tmp191 <= (void*)4)goto
_LLF2;if(*((int*)_tmp191)!= 2)goto _LLEA;_LLE9: goto _LLEB;_LLEA: if(*((int*)_tmp191)
!= 3)goto _LLEC;_LLEB: goto _LLED;_LLEC: if(*((int*)_tmp191)!= 9)goto _LLEE;_LLED:
goto _LLEF;_LLEE: if(*((int*)_tmp191)!= 10)goto _LLF0;_LLEF: goto _LLF1;_LLF0: if(*((
int*)_tmp191)!= 11)goto _LLF2;_LLF1: return 1;_LLF2:;_LLF3: return 0;_LLE7:;}void Cyc_Absyn_print_decls(
...
decls);{const char*_tmp651;void*_tmp650;(_tmp650=0,Cyc_printf(((_tmp651="\n",
_tag_dyneither(_tmp651,sizeof(char),2))),_tag_dyneither(_tmp650,sizeof(void*),0)));}}
