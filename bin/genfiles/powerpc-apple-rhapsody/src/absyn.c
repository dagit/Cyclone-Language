...
union Cyc_Absyn_Nmspace_union _tmp1=(*q2).f1;{struct _tuple12 _tmp4A7;struct _tuple12
_tmp3=(_tmp4A7.f1=_tmp0,((_tmp4A7.f2=_tmp1,_tmp4A7)));union Cyc_Absyn_Nmspace_union
...
k,struct Cyc_Core_Opt*env){struct Cyc_Absyn_Evar_struct _tmp4AA;struct Cyc_Absyn_Evar_struct*
_tmp4A9;return(void*)((_tmp4A9=_cycalloc(sizeof(*_tmp4A9)),((_tmp4A9[0]=((
_tmp4AA.tag=0,((_tmp4AA.f1=k,((_tmp4AA.f2=0,((_tmp4AA.f3=Cyc_Absyn_new_type_counter
++,((_tmp4AA.f4=env,_tmp4AA)))))))))),_tmp4A9))));}static struct Cyc_Core_Opt Cyc_Absyn_mk={(
...
x,struct Cyc_Absyn_Tqual y){struct Cyc_Absyn_Tqual _tmp4AB;return(_tmp4AB.print_const=
x.print_const  || y.print_const,((_tmp4AB.q_volatile=x.q_volatile  || y.q_volatile,((
_tmp4AB.q_restrict=x.q_restrict  || y.q_restrict,((_tmp4AB.real_const=x.real_const
 || y.real_const,((_tmp4AB.loc=Cyc_Position_segment_join(x.loc,y.loc),_tmp4AB)))))))));}
struct Cyc_Absyn_Tqual Cyc_Absyn_empty_tqual(struct Cyc_Position_Segment*loc);
struct Cyc_Absyn_Tqual Cyc_Absyn_empty_tqual(struct Cyc_Position_Segment*loc){
struct Cyc_Absyn_Tqual _tmp4AC;return(_tmp4AC.print_const=0,((_tmp4AC.q_volatile=0,((
_tmp4AC.q_restrict=0,((_tmp4AC.real_const=0,((_tmp4AC.loc=loc,_tmp4AC)))))))));}
struct Cyc_Absyn_Tqual Cyc_Absyn_const_tqual(struct Cyc_Position_Segment*loc);
struct Cyc_Absyn_Tqual Cyc_Absyn_const_tqual(struct Cyc_Position_Segment*loc){
struct Cyc_Absyn_Tqual _tmp4AD;return(_tmp4AD.print_const=1,((_tmp4AD.q_volatile=0,((
_tmp4AD.q_restrict=0,((_tmp4AD.real_const=1,((_tmp4AD.loc=loc,_tmp4AD)))))))));}
...
_tmp4B0;struct Cyc_Absyn_Conref*_tmp4AF;return(_tmp4AF=_cycalloc(sizeof(*_tmp4AF)),((
_tmp4AF->v=(union Cyc_Absyn_Constraint_union)(((_tmp4B0.Eq_constr).tag=0,(((
_tmp4B0.Eq_constr).f1=(void*)x,_tmp4B0)))),_tmp4AF)));}struct Cyc_Absyn_Conref*
Cyc_Absyn_empty_conref();struct Cyc_Absyn_Conref*Cyc_Absyn_empty_conref(){union
Cyc_Absyn_Constraint_union _tmp4B3;struct Cyc_Absyn_Conref*_tmp4B2;return(_tmp4B2=
_cycalloc(sizeof(*_tmp4B2)),((_tmp4B2->v=(union Cyc_Absyn_Constraint_union)(((
_tmp4B3.No_constr).tag=2,_tmp4B3)),_tmp4B2)));}static struct Cyc_Absyn_Conref Cyc_Absyn_true_conref_v={(
...
Cyc_Absyn_compress_conref(struct Cyc_Absyn_Conref*x);struct Cyc_Absyn_Conref*Cyc_Absyn_compress_conref(
struct Cyc_Absyn_Conref*x){union Cyc_Absyn_Constraint_union _tmp27=x->v;struct Cyc_Absyn_Conref*
_tmp28;_LL19: if((_tmp27.No_constr).tag != 2)goto _LL1B;_LL1A: goto _LL1C;_LL1B: if((
_tmp27.Eq_constr).tag != 0)goto _LL1D;_LL1C: return x;_LL1D: if((_tmp27.Forward_constr).tag
!= 1)goto _LL18;_tmp28=(_tmp27.Forward_constr).f1;_LL1E: {struct Cyc_Absyn_Conref*
_tmp29=Cyc_Absyn_compress_conref(_tmp28);{union Cyc_Absyn_Constraint_union _tmp4B4;
x->v=(union Cyc_Absyn_Constraint_union)(((_tmp4B4.Forward_constr).tag=1,(((
_tmp4B4.Forward_constr).f1=_tmp29,_tmp4B4))));}return _tmp29;}_LL18:;}void*Cyc_Absyn_conref_val(
struct Cyc_Absyn_Conref*x);void*Cyc_Absyn_conref_val(struct Cyc_Absyn_Conref*x){
union Cyc_Absyn_Constraint_union _tmp2B=(Cyc_Absyn_compress_conref(x))->v;void*
_tmp2C;_LL20: if((_tmp2B.Eq_constr).tag != 0)goto _LL22;_tmp2C=(_tmp2B.Eq_constr).f1;
_LL21: return _tmp2C;_LL22:;_LL23: {const char*_tmp4B7;void*_tmp4B6;(_tmp4B6=0,Cyc_Tcutil_impos(((
_tmp4B7="conref_val",_tag_dynforward(_tmp4B7,sizeof(char),
_get_zero_arr_size_char(_tmp4B7,11)))),_tag_dynforward(_tmp4B6,sizeof(void*),0)));}
...
k);void*Cyc_Absyn_compress_kb(void*k){void*_tmp31=k;struct Cyc_Core_Opt*_tmp32;
struct Cyc_Core_Opt*_tmp33;struct Cyc_Core_Opt*_tmp34;struct Cyc_Core_Opt _tmp35;
void*_tmp36;void**_tmp37;struct Cyc_Core_Opt*_tmp38;struct Cyc_Core_Opt _tmp39;void*
_tmp3A;void**_tmp3B;_LL2A: if(*((int*)_tmp31)!= 0)goto _LL2C;_LL2B: goto _LL2D;_LL2C:
if(*((int*)_tmp31)!= 1)goto _LL2E;_tmp32=((struct Cyc_Absyn_Unknown_kb_struct*)
_tmp31)->f1;if(_tmp32 != 0)goto _LL2E;_LL2D: goto _LL2F;_LL2E: if(*((int*)_tmp31)!= 2)
goto _LL30;_tmp33=((struct Cyc_Absyn_Less_kb_struct*)_tmp31)->f1;if(_tmp33 != 0)
goto _LL30;_LL2F: return k;_LL30: if(*((int*)_tmp31)!= 1)goto _LL32;_tmp34=((struct
Cyc_Absyn_Unknown_kb_struct*)_tmp31)->f1;if(_tmp34 == 0)goto _LL32;_tmp35=*_tmp34;
_tmp36=(void*)_tmp35.v;_tmp37=(void**)&(*((struct Cyc_Absyn_Unknown_kb_struct*)
...
void*Cyc_Absyn_force_kb(void*kb);void*Cyc_Absyn_force_kb(void*kb){void*_tmp3C=
Cyc_Absyn_compress_kb(kb);void*_tmp3D;struct Cyc_Core_Opt*_tmp3E;struct Cyc_Core_Opt**
_tmp3F;struct Cyc_Core_Opt*_tmp40;struct Cyc_Core_Opt**_tmp41;void*_tmp42;_LL35:
if(*((int*)_tmp3C)!= 0)goto _LL37;_tmp3D=(void*)((struct Cyc_Absyn_Eq_kb_struct*)
_tmp3C)->f1;_LL36: return _tmp3D;_LL37: if(*((int*)_tmp3C)!= 1)goto _LL39;_tmp3E=((
struct Cyc_Absyn_Unknown_kb_struct*)_tmp3C)->f1;_tmp3F=(struct Cyc_Core_Opt**)&((
struct Cyc_Absyn_Unknown_kb_struct*)_tmp3C)->f1;_LL38: _tmp41=_tmp3F;_tmp42=(void*)
2;goto _LL3A;_LL39: if(*((int*)_tmp3C)!= 2)goto _LL34;_tmp40=((struct Cyc_Absyn_Less_kb_struct*)
_tmp3C)->f1;_tmp41=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_struct*)
_tmp3C)->f1;_tmp42=(void*)((struct Cyc_Absyn_Less_kb_struct*)_tmp3C)->f2;_LL3A:{
struct Cyc_Core_Opt*_tmp4B8;*_tmp41=((_tmp4B8=_cycalloc(sizeof(*_tmp4B8)),((
_tmp4B8->v=(void*)Cyc_Tcutil_kind_to_bound(_tmp42),_tmp4B8))));}return _tmp42;
...
void*sn,void*sz){void*_tmp53=sn;_LL3C: if((int)_tmp53 != 0)goto _LL3E;_LL3D: {void*
_tmp54=sz;_LL43: if((int)_tmp54 != 0)goto _LL45;_LL44: return Cyc_Absyn_schar_typ;
_LL45: if((int)_tmp54 != 1)goto _LL47;_LL46: return Cyc_Absyn_sshort_typ;_LL47: if((
int)_tmp54 != 2)goto _LL49;_LL48: return Cyc_Absyn_sint_typ;_LL49: if((int)_tmp54 != 3)
goto _LL4B;_LL4A: return Cyc_Absyn_slong_typ;_LL4B: if((int)_tmp54 != 4)goto _LL42;
_LL4C: return Cyc_Absyn_slonglong_typ;_LL42:;}_LL3E: if((int)_tmp53 != 1)goto _LL40;
_LL3F: {void*_tmp55=sz;_LL4E: if((int)_tmp55 != 0)goto _LL50;_LL4F: return Cyc_Absyn_uchar_typ;
_LL50: if((int)_tmp55 != 1)goto _LL52;_LL51: return Cyc_Absyn_ushort_typ;_LL52: if((
int)_tmp55 != 2)goto _LL54;_LL53: return Cyc_Absyn_uint_typ;_LL54: if((int)_tmp55 != 3)
goto _LL56;_LL55: return Cyc_Absyn_ulong_typ;_LL56: if((int)_tmp55 != 4)goto _LL4D;
_LL57: return Cyc_Absyn_ulonglong_typ;_LL4D:;}_LL40: if((int)_tmp53 != 2)goto _LL3B;
_LL41: {void*_tmp56=sz;_LL59: if((int)_tmp56 != 0)goto _LL5B;_LL5A: return Cyc_Absyn_char_typ;
_LL5B: if((int)_tmp56 != 1)goto _LL5D;_LL5C: return Cyc_Absyn_nshort_typ;_LL5D: if((
int)_tmp56 != 2)goto _LL5F;_LL5E: return Cyc_Absyn_nint_typ;_LL5F: if((int)_tmp56 != 3)
goto _LL61;_LL60: return Cyc_Absyn_nlong_typ;_LL61: if((int)_tmp56 != 4)goto _LL58;
...
void*)2,Cyc_Absyn_empty_tqual(0),(void*)0,Cyc_Absyn_true_conref);void**_tmp4B9;
Cyc_Absyn_string_t_opt=((_tmp4B9=_cycalloc(sizeof(*_tmp4B9)),((_tmp4B9[0]=t,
_tmp4B9))));}return*((void**)_check_null(Cyc_Absyn_string_t_opt));}static void**
...
void*)2,Cyc_Absyn_const_tqual(0),(void*)0,Cyc_Absyn_true_conref);void**_tmp4BA;
Cyc_Absyn_const_string_t_opt=((_tmp4BA=_cycalloc(sizeof(*_tmp4BA)),((_tmp4BA[0]=
t,_tmp4BA))));}return*((void**)_check_null(Cyc_Absyn_const_string_t_opt));}void*
...
struct Cyc_Absyn_Conref*zeroterm){struct Cyc_Absyn_PointerType_struct _tmp4C4;
struct Cyc_Absyn_PtrAtts _tmp4C3;struct Cyc_Absyn_PtrInfo _tmp4C2;struct Cyc_Absyn_PointerType_struct*
_tmp4C1;return(void*)((_tmp4C1=_cycalloc(sizeof(*_tmp4C1)),((_tmp4C1[0]=((
_tmp4C4.tag=4,((_tmp4C4.f1=((_tmp4C2.elt_typ=(void*)t,((_tmp4C2.elt_tq=tq,((
_tmp4C2.ptr_atts=((_tmp4C3.rgn=(void*)r,((_tmp4C3.nullable=Cyc_Absyn_true_conref,((
_tmp4C3.bounds=Cyc_Absyn_new_conref(b),((_tmp4C3.zero_term=zeroterm,((_tmp4C3.ptrloc=
0,_tmp4C3)))))))))),_tmp4C2)))))),_tmp4C4)))),_tmp4C1))));}void*Cyc_Absyn_atb_typ(
...
zeroterm){struct Cyc_Absyn_PointerType_struct _tmp4CE;struct Cyc_Absyn_PtrAtts
_tmp4CD;struct Cyc_Absyn_PtrInfo _tmp4CC;struct Cyc_Absyn_PointerType_struct*
...
_tmp4CC.ptr_atts=((_tmp4CD.rgn=(void*)r,((_tmp4CD.nullable=Cyc_Absyn_false_conref,((
_tmp4CD.bounds=Cyc_Absyn_new_conref(b),((_tmp4CD.zero_term=zeroterm,((_tmp4CD.ptrloc=
0,_tmp4CD)))))))))),_tmp4CC)))))),_tmp4CE)))),_tmp4CB))));}void*Cyc_Absyn_star_typ(
...
_tmp4D8;struct Cyc_Absyn_PtrAtts _tmp4D7;struct Cyc_Absyn_PtrInfo _tmp4D6;struct Cyc_Absyn_PointerType_struct*
...
_tmp4D6.ptr_atts=((_tmp4D7.rgn=(void*)r,((_tmp4D7.nullable=Cyc_Absyn_true_conref,((
_tmp4D7.bounds=Cyc_Absyn_bounds_one_conref,((_tmp4D7.zero_term=zeroterm,((
_tmp4D7.ptrloc=0,_tmp4D7)))))))))),_tmp4D6)))))),_tmp4D8)))),_tmp4D5))));}void*
Cyc_Absyn_cstar_typ(void*t,struct Cyc_Absyn_Tqual tq);void*Cyc_Absyn_cstar_typ(
void*t,struct Cyc_Absyn_Tqual tq){struct Cyc_Absyn_PointerType_struct _tmp4E2;struct
Cyc_Absyn_PtrAtts _tmp4E1;struct Cyc_Absyn_PtrInfo _tmp4E0;struct Cyc_Absyn_PointerType_struct*
...
_tmp4E0.ptr_atts=((_tmp4E1.rgn=(void*)((void*)2),((_tmp4E1.nullable=Cyc_Absyn_true_conref,((
_tmp4E1.bounds=Cyc_Absyn_bounds_one_conref,((_tmp4E1.zero_term=Cyc_Absyn_false_conref,((
...
zeroterm){struct Cyc_Absyn_PointerType_struct _tmp4EC;struct Cyc_Absyn_PtrAtts
_tmp4EB;struct Cyc_Absyn_PtrInfo _tmp4EA;struct Cyc_Absyn_PointerType_struct*
...
_tmp4EA.ptr_atts=((_tmp4EB.rgn=(void*)r,((_tmp4EB.nullable=Cyc_Absyn_false_conref,((
_tmp4EB.bounds=Cyc_Absyn_bounds_one_conref,((_tmp4EB.zero_term=zeroterm,((
_tmp4EB.ptrloc=0,_tmp4EB)))))))))),_tmp4EA)))))),_tmp4EC)))),_tmp4E9))));}void*
Cyc_Absyn_dynforward_typ(void*t,void*r,struct Cyc_Absyn_Tqual tq,struct Cyc_Absyn_Conref*
zeroterm);void*Cyc_Absyn_dynforward_typ(void*t,void*r,struct Cyc_Absyn_Tqual tq,
struct Cyc_Absyn_Conref*zeroterm){struct Cyc_Absyn_PointerType_struct _tmp4F6;
struct Cyc_Absyn_PtrAtts _tmp4F5;struct Cyc_Absyn_PtrInfo _tmp4F4;struct Cyc_Absyn_PointerType_struct*
...
_tmp4F4.ptr_atts=((_tmp4F5.rgn=(void*)r,((_tmp4F5.nullable=Cyc_Absyn_true_conref,((
_tmp4F5.bounds=Cyc_Absyn_bounds_dynforward_conref,((_tmp4F5.zero_term=zeroterm,((
...
static char _tmp93[8]="__sFILE";void*Cyc_Absyn_file_typ();void*Cyc_Absyn_file_typ(){
static void**file_t_opt=0;static struct _dynforward_ptr sf_str={_tmp93,_tmp93 + 8};
static struct _dynforward_ptr*sf=& sf_str;if(file_t_opt == 0){union Cyc_Absyn_Nmspace_union
...
void*k,struct _dynforward_ptr*name);void*Cyc_Absyn_aggr_typ(void*k,struct
_dynforward_ptr*name){struct Cyc_Absyn_AggrType_struct _tmp52A;union Cyc_Absyn_AggrInfoU_union
...
_tmp52A)))),_tmp526))));}void*Cyc_Absyn_strct(struct _dynforward_ptr*name);void*
Cyc_Absyn_strct(struct _dynforward_ptr*name){return Cyc_Absyn_aggr_typ((void*)0,
name);}void*Cyc_Absyn_union_typ(struct _dynforward_ptr*name);void*Cyc_Absyn_union_typ(
...
_dynforward_ptr f,struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Exp*Cyc_Absyn_float_exp(
struct _dynforward_ptr f,struct Cyc_Position_Segment*loc){union Cyc_Absyn_Cnst_union
...
struct _dynforward_ptr s,struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Exp*Cyc_Absyn_string_exp(
struct _dynforward_ptr s,struct Cyc_Position_Segment*loc){union Cyc_Absyn_Cnst_union
...
struct Cyc_Absyn_Exp*e,struct _dynforward_ptr*n,struct Cyc_Position_Segment*loc);
struct Cyc_Absyn_Exp*Cyc_Absyn_aggrmember_exp(struct Cyc_Absyn_Exp*e,struct
_dynforward_ptr*n,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_AggrMember_e_struct
...
_tmp599.f1=e,((_tmp599.f2=n,_tmp599)))))),_tmp598)))),loc);}struct Cyc_Absyn_Exp*
Cyc_Absyn_aggrarrow_exp(struct Cyc_Absyn_Exp*e,struct _dynforward_ptr*n,struct Cyc_Position_Segment*
loc);struct Cyc_Absyn_Exp*Cyc_Absyn_aggrarrow_exp(struct Cyc_Absyn_Exp*e,struct
_dynforward_ptr*n,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_AggrArrow_e_struct
_tmp59C;struct Cyc_Absyn_AggrArrow_e_struct*_tmp59B;return Cyc_Absyn_new_exp((void*)((
_tmp59B=_cycalloc(sizeof(*_tmp59B)),((_tmp59B[0]=((_tmp59C.tag=24,((_tmp59C.f1=e,((
_tmp59C.f2=n,_tmp59C)))))),_tmp59B)))),loc);}struct Cyc_Absyn_Exp*Cyc_Absyn_subscript_exp(
struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,struct Cyc_Position_Segment*loc);
...
struct Cyc_List_List*es,struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Exp*Cyc_Absyn_array_exp(
struct Cyc_List_List*es,struct Cyc_Position_Segment*loc){struct Cyc_List_List*dles=
0;for(0;es != 0;es=es->tl){struct _tuple13*_tmp5A8;struct Cyc_List_List*_tmp5A7;
dles=((_tmp5A7=_cycalloc(sizeof(*_tmp5A7)),((_tmp5A7->hd=((_tmp5A8=_cycalloc(
sizeof(*_tmp5A8)),((_tmp5A8->f1=0,((_tmp5A8->f2=(struct Cyc_Absyn_Exp*)es->hd,
_tmp5A8)))))),((_tmp5A7->tl=dles,_tmp5A7))))));}dles=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);{struct Cyc_Absyn_Array_e_struct
_tmp5AB;struct Cyc_Absyn_Array_e_struct*_tmp5AA;return Cyc_Absyn_new_exp((void*)((
_tmp5AA=_cycalloc(sizeof(*_tmp5AA)),((_tmp5AA[0]=((_tmp5AB.tag=28,((_tmp5AB.f1=
dles,_tmp5AB)))),_tmp5AA)))),loc);}}struct Cyc_Absyn_Exp*Cyc_Absyn_unresolvedmem_exp(
...
_tmp5AE;struct Cyc_Absyn_UnresolvedMem_e_struct*_tmp5AD;return Cyc_Absyn_new_exp((
void*)((_tmp5AD=_cycalloc(sizeof(*_tmp5AD)),((_tmp5AD[0]=((_tmp5AE.tag=37,((
_tmp5AE.f1=n,((_tmp5AE.f2=dles,_tmp5AE)))))),_tmp5AD)))),loc);}struct Cyc_Absyn_Stmt*
Cyc_Absyn_new_stmt(void*s,struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Stmt*
Cyc_Absyn_new_stmt(void*s,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Stmt*
_tmp5AF;return(_tmp5AF=_cycalloc(sizeof(*_tmp5AF)),((_tmp5AF->r=(void*)s,((
_tmp5AF->loc=loc,((_tmp5AF->non_local_preds=0,((_tmp5AF->try_depth=0,((_tmp5AF->annot=(
void*)((void*)Cyc_Absyn_EmptyAnnot),_tmp5AF)))))))))));}struct Cyc_Absyn_Stmt*Cyc_Absyn_skip_stmt(
...
loc){struct Cyc_Absyn_Exp_s_struct _tmp5B2;struct Cyc_Absyn_Exp_s_struct*_tmp5B1;
return Cyc_Absyn_new_stmt((void*)((_tmp5B1=_cycalloc(sizeof(*_tmp5B1)),((_tmp5B1[
0]=((_tmp5B2.tag=0,((_tmp5B2.f1=e,_tmp5B2)))),_tmp5B1)))),loc);}struct Cyc_Absyn_Stmt*
...
_tmp5B5;struct Cyc_Absyn_Return_s_struct*_tmp5B4;return Cyc_Absyn_new_stmt((void*)((
_tmp5B4=_cycalloc(sizeof(*_tmp5B4)),((_tmp5B4[0]=((_tmp5B5.tag=2,((_tmp5B5.f1=e,
_tmp5B5)))),_tmp5B4)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_ifthenelse_stmt(
struct Cyc_Absyn_Exp*e,struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2,struct Cyc_Position_Segment*
loc);struct Cyc_Absyn_Stmt*Cyc_Absyn_ifthenelse_stmt(struct Cyc_Absyn_Exp*e,struct
Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2,struct Cyc_Position_Segment*loc){struct
Cyc_Absyn_IfThenElse_s_struct _tmp5B8;struct Cyc_Absyn_IfThenElse_s_struct*_tmp5B7;
return Cyc_Absyn_new_stmt((void*)((_tmp5B7=_cycalloc(sizeof(*_tmp5B7)),((_tmp5B7[
0]=((_tmp5B8.tag=3,((_tmp5B8.f1=e,((_tmp5B8.f2=s1,((_tmp5B8.f3=s2,_tmp5B8)))))))),
_tmp5B7)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_while_stmt(struct Cyc_Absyn_Exp*
...
loc){struct Cyc_Absyn_While_s_struct _tmp5BE;struct _tuple2 _tmp5BD;struct Cyc_Absyn_While_s_struct*
_tmp5BC;return Cyc_Absyn_new_stmt((void*)((_tmp5BC=_cycalloc(sizeof(*_tmp5BC)),((
_tmp5BC[0]=((_tmp5BE.tag=4,((_tmp5BE.f1=((_tmp5BD.f1=e,((_tmp5BD.f2=Cyc_Absyn_skip_stmt(
e->loc),_tmp5BD)))),((_tmp5BE.f2=s,_tmp5BE)))))),_tmp5BC)))),loc);}struct Cyc_Absyn_Stmt*
Cyc_Absyn_break_stmt(struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Stmt*Cyc_Absyn_break_stmt(
struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Break_s_struct _tmp5C1;struct Cyc_Absyn_Break_s_struct*
_tmp5C0;return Cyc_Absyn_new_stmt((void*)((_tmp5C0=_cycalloc(sizeof(*_tmp5C0)),((
_tmp5C0[0]=((_tmp5C1.tag=5,((_tmp5C1.f1=0,_tmp5C1)))),_tmp5C0)))),loc);}struct
...
_tmp5C4;struct Cyc_Absyn_Continue_s_struct*_tmp5C3;return Cyc_Absyn_new_stmt((void*)((
_tmp5C3=_cycalloc(sizeof(*_tmp5C3)),((_tmp5C3[0]=((_tmp5C4.tag=6,((_tmp5C4.f1=0,
_tmp5C4)))),_tmp5C3)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_for_stmt(struct Cyc_Absyn_Exp*
...
struct Cyc_Absyn_Switch_s_struct*_tmp5CF;return Cyc_Absyn_new_stmt((void*)((
_tmp5CF=_cycalloc(sizeof(*_tmp5CF)),((_tmp5CF[0]=((_tmp5D0.tag=9,((_tmp5D0.f1=e,((
_tmp5D0.f2=scs,_tmp5D0)))))),_tmp5CF)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_seq_stmt(
struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2,struct Cyc_Position_Segment*loc);
struct Cyc_Absyn_Stmt*Cyc_Absyn_seq_stmt(struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*
s2,struct Cyc_Position_Segment*loc){struct _tuple9 _tmp5D1;struct _tuple9 _tmp104=(
_tmp5D1.f1=(void*)s1->r,((_tmp5D1.f2=(void*)s2->r,_tmp5D1)));void*_tmp105;void*
_tmp106;_LL64: _tmp105=_tmp104.f1;if((int)_tmp105 != 0)goto _LL66;_LL65: return s2;
_LL66: _tmp106=_tmp104.f2;if((int)_tmp106 != 0)goto _LL68;_LL67: return s1;_LL68:;
_LL69: {struct Cyc_Absyn_Seq_s_struct _tmp5D4;struct Cyc_Absyn_Seq_s_struct*_tmp5D3;
return Cyc_Absyn_new_stmt((void*)((_tmp5D3=_cycalloc(sizeof(*_tmp5D3)),((_tmp5D3[
0]=((_tmp5D4.tag=1,((_tmp5D4.f1=s1,((_tmp5D4.f2=s2,_tmp5D4)))))),_tmp5D3)))),loc);}
...
_tmp5D7;struct Cyc_Absyn_Fallthru_s_struct*_tmp5D6;return Cyc_Absyn_new_stmt((void*)((
_tmp5D6=_cycalloc(sizeof(*_tmp5D6)),((_tmp5D6[0]=((_tmp5D7.tag=10,((_tmp5D7.f1=
el,((_tmp5D7.f2=0,_tmp5D7)))))),_tmp5D6)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_decl_stmt(
struct Cyc_Absyn_Decl*d,struct Cyc_Absyn_Stmt*s,struct Cyc_Position_Segment*loc);
struct Cyc_Absyn_Stmt*Cyc_Absyn_decl_stmt(struct Cyc_Absyn_Decl*d,struct Cyc_Absyn_Stmt*
s,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Decl_s_struct _tmp5DA;struct Cyc_Absyn_Decl_s_struct*
_tmp5D9;return Cyc_Absyn_new_stmt((void*)((_tmp5D9=_cycalloc(sizeof(*_tmp5D9)),((
_tmp5D9[0]=((_tmp5DA.tag=11,((_tmp5DA.f1=d,((_tmp5DA.f2=s,_tmp5DA)))))),_tmp5D9)))),
...
_tmp5DD;struct Cyc_Absyn_Var_d_struct*_tmp5DC;struct Cyc_Absyn_Decl*d=Cyc_Absyn_new_decl((
void*)((_tmp5DC=_cycalloc(sizeof(*_tmp5DC)),((_tmp5DC[0]=((_tmp5DD.tag=0,((
_tmp5DD.f1=Cyc_Absyn_new_vardecl(x,t,init),_tmp5DD)))),_tmp5DC)))),loc);struct
Cyc_Absyn_Decl_s_struct _tmp5E0;struct Cyc_Absyn_Decl_s_struct*_tmp5DF;return Cyc_Absyn_new_stmt((
void*)((_tmp5DF=_cycalloc(sizeof(*_tmp5DF)),((_tmp5DF[0]=((_tmp5E0.tag=11,((
_tmp5E0.f1=d,((_tmp5E0.f2=s,_tmp5E0)))))),_tmp5DF)))),loc);}struct Cyc_Absyn_Stmt*
Cyc_Absyn_label_stmt(struct _dynforward_ptr*v,struct Cyc_Absyn_Stmt*s,struct Cyc_Position_Segment*
loc);struct Cyc_Absyn_Stmt*Cyc_Absyn_label_stmt(struct _dynforward_ptr*v,struct Cyc_Absyn_Stmt*
s,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Label_s_struct _tmp5E3;struct
Cyc_Absyn_Label_s_struct*_tmp5E2;return Cyc_Absyn_new_stmt((void*)((_tmp5E2=
_cycalloc(sizeof(*_tmp5E2)),((_tmp5E2[0]=((_tmp5E3.tag=12,((_tmp5E3.f1=v,((
_tmp5E3.f2=s,_tmp5E3)))))),_tmp5E2)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_do_stmt(
...
e,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Do_s_struct _tmp5E9;struct
_tuple2 _tmp5E8;struct Cyc_Absyn_Do_s_struct*_tmp5E7;return Cyc_Absyn_new_stmt((
void*)((_tmp5E7=_cycalloc(sizeof(*_tmp5E7)),((_tmp5E7[0]=((_tmp5E9.tag=13,((
_tmp5E9.f1=s,((_tmp5E9.f2=((_tmp5E8.f1=e,((_tmp5E8.f2=Cyc_Absyn_skip_stmt(e->loc),
_tmp5E8)))),_tmp5E9)))))),_tmp5E7)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_trycatch_stmt(
...
scs,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_TryCatch_s_struct _tmp5EC;
struct Cyc_Absyn_TryCatch_s_struct*_tmp5EB;return Cyc_Absyn_new_stmt((void*)((
_tmp5EB=_cycalloc(sizeof(*_tmp5EB)),((_tmp5EB[0]=((_tmp5EC.tag=14,((_tmp5EC.f1=s,((
_tmp5EC.f2=scs,_tmp5EC)))))),_tmp5EB)))),loc);}struct Cyc_Absyn_Stmt*Cyc_Absyn_goto_stmt(
struct _dynforward_ptr*lab,struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Stmt*
Cyc_Absyn_goto_stmt(struct _dynforward_ptr*lab,struct Cyc_Position_Segment*loc){
struct Cyc_Absyn_Goto_s_struct _tmp5EF;struct Cyc_Absyn_Goto_s_struct*_tmp5EE;
return Cyc_Absyn_new_stmt((void*)((_tmp5EE=_cycalloc(sizeof(*_tmp5EE)),((_tmp5EE[
0]=((_tmp5EF.tag=7,((_tmp5EF.f1=lab,((_tmp5EF.f2=0,_tmp5EF)))))),_tmp5EE)))),loc);}
...
void*p,struct Cyc_Position_Segment*s){struct Cyc_Absyn_Pat*_tmp5F0;return(_tmp5F0=
_cycalloc(sizeof(*_tmp5F0)),((_tmp5F0->r=(void*)p,((_tmp5F0->topt=0,((_tmp5F0->loc=
s,_tmp5F0)))))));}struct Cyc_Absyn_Pat*Cyc_Absyn_exp_pat(struct Cyc_Absyn_Exp*e);
struct Cyc_Absyn_Pat*Cyc_Absyn_exp_pat(struct Cyc_Absyn_Exp*e){struct Cyc_Absyn_Exp_p_struct
_tmp5F3;struct Cyc_Absyn_Exp_p_struct*_tmp5F2;return Cyc_Absyn_new_pat((void*)((
_tmp5F2=_cycalloc(sizeof(*_tmp5F2)),((_tmp5F2[0]=((_tmp5F3.tag=14,((_tmp5F3.f1=e,
_tmp5F3)))),_tmp5F2)))),e->loc);}struct Cyc_Absyn_Decl*Cyc_Absyn_new_decl(void*r,
struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Decl*Cyc_Absyn_new_decl(void*r,
struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Decl*_tmp5F4;return(_tmp5F4=
_cycalloc(sizeof(*_tmp5F4)),((_tmp5F4->r=(void*)r,((_tmp5F4->loc=loc,_tmp5F4)))));}
...
_tmp5F7;struct Cyc_Absyn_Let_d_struct*_tmp5F6;return Cyc_Absyn_new_decl((void*)((
_tmp5F6=_cycalloc(sizeof(*_tmp5F6)),((_tmp5F6[0]=((_tmp5F7.tag=2,((_tmp5F7.f1=p,((
_tmp5F7.f2=0,((_tmp5F7.f3=e,_tmp5F7)))))))),_tmp5F6)))),loc);}struct Cyc_Absyn_Decl*
...
loc){struct Cyc_Absyn_Letv_d_struct _tmp5FA;struct Cyc_Absyn_Letv_d_struct*_tmp5F9;
return Cyc_Absyn_new_decl((void*)((_tmp5F9=_cycalloc(sizeof(*_tmp5F9)),((_tmp5F9[
0]=((_tmp5FA.tag=3,((_tmp5FA.f1=vds,_tmp5FA)))),_tmp5F9)))),loc);}struct Cyc_Absyn_Vardecl*
...
_tmp601[0]=((_tmp603.tag=4,((_tmp603.f1=((_tmp602=_cycalloc(sizeof(*_tmp602)),((
...
_tmp607[0]=((_tmp609.tag=5,((_tmp609.f1=((_tmp608=_cycalloc(sizeof(*_tmp608)),((
...
void*)4)goto _LL6D;if(*((int*)_tmp12F)!= 8)goto _LL6D;_LL6C: {struct Cyc_Core_Opt*
...
e){void*_tmp131=(void*)e->r;void*_tmp132;void*_tmp133;struct Cyc_Absyn_Vardecl*
_tmp134;void*_tmp135;struct Cyc_Absyn_Vardecl*_tmp136;struct Cyc_Absyn_Exp*_tmp137;
struct Cyc_Absyn_Exp*_tmp138;struct Cyc_Absyn_Exp*_tmp139;_LL70: if(*((int*)_tmp131)
!= 1)goto _LL72;_tmp132=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp131)->f2;if(
_tmp132 <= (void*)1)goto _LL72;if(*((int*)_tmp132)!= 1)goto _LL72;_LL71: return 0;
...
struct _dynforward_ptr*v);struct Cyc_Absyn_Aggrfield*Cyc_Absyn_lookup_field(struct
Cyc_List_List*fields,struct _dynforward_ptr*v){{struct Cyc_List_List*_tmp13B=
fields;for(0;_tmp13B != 0;_tmp13B=_tmp13B->tl){if(Cyc_strptrcmp(((struct Cyc_Absyn_Aggrfield*)
_tmp13B->hd)->name,v)== 0)return(struct Cyc_Absyn_Aggrfield*)((struct Cyc_Absyn_Aggrfield*)
_tmp13B->hd);}}return 0;}struct Cyc_Absyn_Aggrfield*Cyc_Absyn_lookup_decl_field(
struct Cyc_Absyn_Aggrdecl*ad,struct _dynforward_ptr*v);struct Cyc_Absyn_Aggrfield*
Cyc_Absyn_lookup_decl_field(struct Cyc_Absyn_Aggrdecl*ad,struct _dynforward_ptr*v){
...
return 0;return(struct _tuple3*)((struct _tuple3*)ts->hd);}struct _dynforward_ptr Cyc_Absyn_attribute2string(
void*a);struct _dynforward_ptr Cyc_Absyn_attribute2string(void*a){void*_tmp13C=a;
int _tmp13D;int _tmp13E;struct _dynforward_ptr _tmp13F;void*_tmp140;int _tmp141;int
_tmp142;void*_tmp143;int _tmp144;int _tmp145;int _tmp146;struct _dynforward_ptr
_tmp147;_LL8C: if(_tmp13C <= (void*)17)goto _LL8E;if(*((int*)_tmp13C)!= 0)goto _LL8E;
_tmp13D=((struct Cyc_Absyn_Regparm_att_struct*)_tmp13C)->f1;_LL8D: {const char*
_tmp615;void*_tmp614[1];struct Cyc_Int_pa_struct _tmp613;return(struct
_dynforward_ptr)((_tmp613.tag=1,((_tmp613.f1=(unsigned long)_tmp13D,((_tmp614[0]=&
_tmp613,Cyc_aprintf(((_tmp615="regparm(%d)",_tag_dynforward(_tmp615,sizeof(char),
_get_zero_arr_size_char(_tmp615,12)))),_tag_dynforward(_tmp614,sizeof(void*),1))))))));}
_LL8E: if((int)_tmp13C != 0)goto _LL90;_LL8F: {const char*_tmp616;return(_tmp616="stdcall",
_tag_dynforward(_tmp616,sizeof(char),_get_zero_arr_size_char(_tmp616,8)));}_LL90:
if((int)_tmp13C != 1)goto _LL92;_LL91: {const char*_tmp617;return(_tmp617="cdecl",
_tag_dynforward(_tmp617,sizeof(char),_get_zero_arr_size_char(_tmp617,6)));}_LL92:
if((int)_tmp13C != 2)goto _LL94;_LL93: {const char*_tmp618;return(_tmp618="fastcall",
_tag_dynforward(_tmp618,sizeof(char),_get_zero_arr_size_char(_tmp618,9)));}_LL94:
if((int)_tmp13C != 3)goto _LL96;_LL95: {const char*_tmp619;return(_tmp619="noreturn",
_tag_dynforward(_tmp619,sizeof(char),_get_zero_arr_size_char(_tmp619,9)));}_LL96:
if((int)_tmp13C != 4)goto _LL98;_LL97: {const char*_tmp61A;return(_tmp61A="const",
_tag_dynforward(_tmp61A,sizeof(char),_get_zero_arr_size_char(_tmp61A,6)));}_LL98:
if(_tmp13C <= (void*)17)goto _LL9A;if(*((int*)_tmp13C)!= 1)goto _LL9A;_tmp13E=((
struct Cyc_Absyn_Aligned_att_struct*)_tmp13C)->f1;_LL99: if(_tmp13E == - 1){const
char*_tmp61B;return(_tmp61B="aligned",_tag_dynforward(_tmp61B,sizeof(char),
_get_zero_arr_size_char(_tmp61B,8)));}else{void*_tmp151=Cyc_Cyclone_c_compiler;
_LLBD: if((int)_tmp151 != 0)goto _LLBF;_LLBE: {const char*_tmp61F;void*_tmp61E[1];
struct Cyc_Int_pa_struct _tmp61D;return(struct _dynforward_ptr)((_tmp61D.tag=1,((
_tmp61D.f1=(unsigned long)_tmp13E,((_tmp61E[0]=& _tmp61D,Cyc_aprintf(((_tmp61F="aligned(%d)",
_tag_dynforward(_tmp61F,sizeof(char),_get_zero_arr_size_char(_tmp61F,12)))),
_tag_dynforward(_tmp61E,sizeof(void*),1))))))));}_LLBF: if((int)_tmp151 != 1)goto
_LLBC;_LLC0: {const char*_tmp623;void*_tmp622[1];struct Cyc_Int_pa_struct _tmp621;
return(struct _dynforward_ptr)((_tmp621.tag=1,((_tmp621.f1=(unsigned long)_tmp13E,((
_tmp622[0]=& _tmp621,Cyc_aprintf(((_tmp623="align(%d)",_tag_dynforward(_tmp623,
sizeof(char),_get_zero_arr_size_char(_tmp623,10)))),_tag_dynforward(_tmp622,
sizeof(void*),1))))))));}_LLBC:;}_LL9A: if((int)_tmp13C != 5)goto _LL9C;_LL9B: {
const char*_tmp624;return(_tmp624="packed",_tag_dynforward(_tmp624,sizeof(char),
_get_zero_arr_size_char(_tmp624,7)));}_LL9C: if(_tmp13C <= (void*)17)goto _LL9E;if(*((
int*)_tmp13C)!= 2)goto _LL9E;_tmp13F=((struct Cyc_Absyn_Section_att_struct*)
_tmp13C)->f1;_LL9D: {const char*_tmp628;void*_tmp627[1];struct Cyc_String_pa_struct
_tmp626;return(struct _dynforward_ptr)((_tmp626.tag=0,((_tmp626.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)_tmp13F),((_tmp627[0]=& _tmp626,Cyc_aprintf(((
_tmp628="section(\"%s\")",_tag_dynforward(_tmp628,sizeof(char),
_get_zero_arr_size_char(_tmp628,14)))),_tag_dynforward(_tmp627,sizeof(void*),1))))))));}
_LL9E: if((int)_tmp13C != 6)goto _LLA0;_LL9F: {const char*_tmp629;return(_tmp629="nocommon",
_tag_dynforward(_tmp629,sizeof(char),_get_zero_arr_size_char(_tmp629,9)));}_LLA0:
if((int)_tmp13C != 7)goto _LLA2;_LLA1: {const char*_tmp62A;return(_tmp62A="shared",
_tag_dynforward(_tmp62A,sizeof(char),_get_zero_arr_size_char(_tmp62A,7)));}_LLA2:
if((int)_tmp13C != 8)goto _LLA4;_LLA3: {const char*_tmp62B;return(_tmp62B="unused",
_tag_dynforward(_tmp62B,sizeof(char),_get_zero_arr_size_char(_tmp62B,7)));}_LLA4:
if((int)_tmp13C != 9)goto _LLA6;_LLA5: {const char*_tmp62C;return(_tmp62C="weak",
_tag_dynforward(_tmp62C,sizeof(char),_get_zero_arr_size_char(_tmp62C,5)));}_LLA6:
if((int)_tmp13C != 10)goto _LLA8;_LLA7: {const char*_tmp62D;return(_tmp62D="dllimport",
_tag_dynforward(_tmp62D,sizeof(char),_get_zero_arr_size_char(_tmp62D,10)));}
_LLA8: if((int)_tmp13C != 11)goto _LLAA;_LLA9: {const char*_tmp62E;return(_tmp62E="dllexport",
_tag_dynforward(_tmp62E,sizeof(char),_get_zero_arr_size_char(_tmp62E,10)));}
_LLAA: if((int)_tmp13C != 12)goto _LLAC;_LLAB: {const char*_tmp62F;return(_tmp62F="no_instrument_function",
_tag_dynforward(_tmp62F,sizeof(char),_get_zero_arr_size_char(_tmp62F,23)));}
_LLAC: if((int)_tmp13C != 13)goto _LLAE;_LLAD: {const char*_tmp630;return(_tmp630="constructor",
_tag_dynforward(_tmp630,sizeof(char),_get_zero_arr_size_char(_tmp630,12)));}
_LLAE: if((int)_tmp13C != 14)goto _LLB0;_LLAF: {const char*_tmp631;return(_tmp631="destructor",
_tag_dynforward(_tmp631,sizeof(char),_get_zero_arr_size_char(_tmp631,11)));}
_LLB0: if((int)_tmp13C != 15)goto _LLB2;_LLB1: {const char*_tmp632;return(_tmp632="no_check_memory_usage",
_tag_dynforward(_tmp632,sizeof(char),_get_zero_arr_size_char(_tmp632,22)));}
...
Cyc_Absyn_Format_att_struct*)_tmp13C)->f3;_LLB3: {const char*_tmp637;void*_tmp636[
2];struct Cyc_Int_pa_struct _tmp635;struct Cyc_Int_pa_struct _tmp634;return(struct
_dynforward_ptr)((_tmp634.tag=1,((_tmp634.f1=(unsigned int)_tmp142,((_tmp635.tag=
1,((_tmp635.f1=(unsigned int)_tmp141,((_tmp636[0]=& _tmp635,((_tmp636[1]=& _tmp634,
Cyc_aprintf(((_tmp637="format(printf,%u,%u)",_tag_dynforward(_tmp637,sizeof(char),
_get_zero_arr_size_char(_tmp637,21)))),_tag_dynforward(_tmp636,sizeof(void*),2))))))))))))));}
_LLB4: if(*((int*)_tmp13C)!= 3)goto _LLB6;_tmp143=(void*)((struct Cyc_Absyn_Format_att_struct*)
_tmp13C)->f1;if((int)_tmp143 != 1)goto _LLB6;_tmp144=((struct Cyc_Absyn_Format_att_struct*)
_tmp13C)->f2;_tmp145=((struct Cyc_Absyn_Format_att_struct*)_tmp13C)->f3;_LLB5: {
const char*_tmp63C;void*_tmp63B[2];struct Cyc_Int_pa_struct _tmp63A;struct Cyc_Int_pa_struct
_tmp639;return(struct _dynforward_ptr)((_tmp639.tag=1,((_tmp639.f1=(unsigned int)
_tmp145,((_tmp63A.tag=1,((_tmp63A.f1=(unsigned int)_tmp144,((_tmp63B[0]=& _tmp63A,((
_tmp63B[1]=& _tmp639,Cyc_aprintf(((_tmp63C="format(scanf,%u,%u)",_tag_dynforward(
_tmp63C,sizeof(char),_get_zero_arr_size_char(_tmp63C,20)))),_tag_dynforward(
_tmp63B,sizeof(void*),2))))))))))))));}_LLB6: if(*((int*)_tmp13C)!= 4)goto _LLB8;
_tmp146=((struct Cyc_Absyn_Initializes_att_struct*)_tmp13C)->f1;_LLB7: {const char*
_tmp640;void*_tmp63F[1];struct Cyc_Int_pa_struct _tmp63E;return(struct
_dynforward_ptr)((_tmp63E.tag=1,((_tmp63E.f1=(unsigned long)_tmp146,((_tmp63F[0]=&
_tmp63E,Cyc_aprintf(((_tmp640="initializes(%d)",_tag_dynforward(_tmp640,sizeof(
char),_get_zero_arr_size_char(_tmp640,16)))),_tag_dynforward(_tmp63F,sizeof(void*),
1))))))));}_LLB8: if((int)_tmp13C != 16)goto _LLBA;_LLB9: {const char*_tmp641;return(
_tmp641="pure",_tag_dynforward(_tmp641,sizeof(char),_get_zero_arr_size_char(
_tmp641,5)));}_LLBA: if(_tmp13C <= (void*)17)goto _LL8B;if(*((int*)_tmp13C)!= 5)
goto _LL8B;_tmp147=((struct Cyc_Absyn_Mode_att_struct*)_tmp13C)->f1;_LLBB: {const
char*_tmp645;void*_tmp644[1];struct Cyc_String_pa_struct _tmp643;return(struct
_dynforward_ptr)((_tmp643.tag=0,((_tmp643.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)_tmp147),((_tmp644[0]=& _tmp643,Cyc_aprintf(((_tmp645="__mode__(\"%s\")",
_tag_dynforward(_tmp645,sizeof(char),_get_zero_arr_size_char(_tmp645,15)))),
_tag_dynforward(_tmp644,sizeof(void*),1))))))));}_LL8B:;}int Cyc_Absyn_fntype_att(
void*a);int Cyc_Absyn_fntype_att(void*a){void*_tmp175=a;_LLC2: if(_tmp175 <= (void*)
...
static void _tmp653(unsigned int*_tmp652,unsigned int*_tmp651,struct
_dynforward_ptr***_tmp64F,unsigned int*fsz){for(*_tmp652=0;*_tmp652 < *_tmp651;(*
_tmp652)++){struct Cyc_Int_pa_struct _tmp64D;void*_tmp64C[1];const char*_tmp64B;
struct _dynforward_ptr*_tmp64A;(*_tmp64F)[*_tmp652]=*_tmp652 < *fsz?*((struct
_dynforward_ptr**)_check_dynforward_subscript(Cyc_Absyn_field_names,sizeof(
struct _dynforward_ptr*),(int)*_tmp652)):((_tmp64A=_cycalloc(sizeof(*_tmp64A)),((
_tmp64A[0]=(struct _dynforward_ptr)((_tmp64D.tag=1,((_tmp64D.f1=(unsigned long)((
int)*_tmp652),((_tmp64C[0]=& _tmp64D,Cyc_aprintf(((_tmp64B="f%d",_tag_dynforward(
_tmp64B,sizeof(char),_get_zero_arr_size_char(_tmp64B,4)))),_tag_dynforward(
_tmp64C,sizeof(void*),1)))))))),_tmp64A))));}}struct _dynforward_ptr*Cyc_Absyn_fieldname(
int i){unsigned int fsz=_get_dynforward_size(Cyc_Absyn_field_names,sizeof(struct
_dynforward_ptr*));if(i >= fsz){unsigned int _tmp652;unsigned int _tmp651;struct
_dynforward_ptr _tmp650;struct _dynforward_ptr**_tmp64F;unsigned int _tmp64E;Cyc_Absyn_field_names=((
_tmp64E=(unsigned int)(i + 1),((_tmp64F=(struct _dynforward_ptr**)_cycalloc(
_check_times(sizeof(struct _dynforward_ptr*),_tmp64E)),((_tmp650=_tag_dynforward(
_tmp64F,sizeof(struct _dynforward_ptr*),_tmp64E),((((_tmp651=_tmp64E,_tmp653(&
_tmp652,& _tmp651,& _tmp64F,& fsz))),_tmp650))))))));}return*((struct
_dynforward_ptr**)_check_dynforward_subscript(Cyc_Absyn_field_names,sizeof(
struct _dynforward_ptr*),i));}struct _tuple4 Cyc_Absyn_aggr_kinded_name(union Cyc_Absyn_AggrInfoU_union
info);struct _tuple4 Cyc_Absyn_aggr_kinded_name(union Cyc_Absyn_AggrInfoU_union info){
...
_LLD8: {struct _tuple4 _tmp654;return(_tmp654.f1=_tmp180,((_tmp654.f2=_tmp181,
_tmp654)));}_LLD9: if((_tmp17F.KnownAggr).tag != 1)goto _LLD6;_tmp182=(_tmp17F.KnownAggr).f1;
_tmp183=*_tmp182;_tmp184=*_tmp183;_tmp185=(void*)_tmp184.kind;_tmp186=_tmp184.name;
_LLDA: {struct _tuple4 _tmp655;return(_tmp655.f1=_tmp185,((_tmp655.f2=_tmp186,
...
union Cyc_Absyn_AggrInfoU_union info){union Cyc_Absyn_AggrInfoU_union _tmp189=info;
void*_tmp18A;struct _tuple0*_tmp18B;struct Cyc_Absyn_Aggrdecl**_tmp18C;struct Cyc_Absyn_Aggrdecl*
_tmp18D;_LLDC: if((_tmp189.UnknownAggr).tag != 0)goto _LLDE;_tmp18A=(_tmp189.UnknownAggr).f1;
_tmp18B=(_tmp189.UnknownAggr).f2;_LLDD: {const char*_tmp658;void*_tmp657;(_tmp657=
0,((int(*)(struct _dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((
_tmp658="unchecked aggrdecl",_tag_dynforward(_tmp658,sizeof(char),
_get_zero_arr_size_char(_tmp658,19)))),_tag_dynforward(_tmp657,sizeof(void*),0)));}
...
int Cyc_Absyn_is_union_type(void*t){void*_tmp190=Cyc_Tcutil_compress(t);void*
_tmp191;struct Cyc_Absyn_AggrInfo _tmp192;union Cyc_Absyn_AggrInfoU_union _tmp193;
_LLE1: if(_tmp190 <= (void*)4)goto _LLE5;if(*((int*)_tmp190)!= 11)goto _LLE3;_tmp191=(
void*)((struct Cyc_Absyn_AnonAggrType_struct*)_tmp190)->f1;if((int)_tmp191 != 1)
goto _LLE3;_LLE2: return 1;_LLE3: if(*((int*)_tmp190)!= 10)goto _LLE5;_tmp192=((
struct Cyc_Absyn_AggrType_struct*)_tmp190)->f1;_tmp193=_tmp192.aggr_info;_LLE4:
return(Cyc_Absyn_aggr_kinded_name(_tmp193)).f1 == (void*)1;_LLE5:;_LLE6: return 0;
_LLE0:;}int Cyc_Absyn_is_aggr_type(void*t);int Cyc_Absyn_is_aggr_type(void*t){void*
...
_tag_dynforward(_tmp65B,sizeof(char),_get_zero_arr_size_char(_tmp65B,2)))),
_tag_dynforward(_tmp65A,sizeof(void*),0)));}}int Cyc_Absyn_porting_c_code=0;int
