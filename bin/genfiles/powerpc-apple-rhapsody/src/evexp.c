...
_tmp2=(_tmp0.Char_c).f2;_LL2: {union Cyc_Absyn_Cnst_union _tmp17F;return(union Cyc_Absyn_Cnst_union)(((
_tmp17F.Int_c).tag=2,(((_tmp17F.Int_c).f1=(void*)_tmp1,(((_tmp17F.Int_c).f2=(int)
_tmp2,_tmp17F))))));}_LL3: if((_tmp0.Short_c).tag != 1)goto _LL5;_tmp3=(_tmp0.Short_c).f1;
_tmp4=(_tmp0.Short_c).f2;_LL4: {union Cyc_Absyn_Cnst_union _tmp180;return(union Cyc_Absyn_Cnst_union)(((
_tmp180.Int_c).tag=2,(((_tmp180.Int_c).f1=(void*)_tmp3,(((_tmp180.Int_c).f2=(int)
_tmp4,_tmp180))))));}_LL5:;_LL6: return cn;_LL0:;}struct _tuple4 Cyc_Evexp_eval_const_uint_exp(
...
e);_tmp8=_tmp7.f1;_tmp9=_tmp7.f2;if(!_tmp9){struct _tuple4 _tmp181;return(_tmp181.f1=
0,((_tmp181.f2=0,_tmp181)));}{union Cyc_Absyn_Cnst_union _tmpB=Cyc_Evexp_promote_const(
_tmp8);int _tmpC;_LL8: if((_tmpB.Int_c).tag != 2)goto _LLA;_tmpC=(_tmpB.Int_c).f2;
_LL9: {struct _tuple4 _tmp182;return(_tmp182.f1=(unsigned int)_tmpC,((_tmp182.f2=1,
_tmp182)));}_LLA:;_LLB:{const char*_tmp185;void*_tmp184;(_tmp184=0,Cyc_Tcutil_terr(
e->loc,((_tmp185="expecting unsigned int",_tag_dyneither(_tmp185,sizeof(char),23))),
_tag_dyneither(_tmp184,sizeof(void*),0)));}{struct _tuple4 _tmp186;return(_tmp186.f1=
0,((_tmp186.f2=1,_tmp186)));}_LL7:;}}struct _tuple6{int f1;int f2;};static struct
...
_tmp13=_tmp11.f2;if(!_tmp13){struct _tuple6 _tmp187;return(_tmp187.f1=0,((_tmp187.f2=
0,_tmp187)));}{union Cyc_Absyn_Cnst_union _tmp15=Cyc_Evexp_promote_const(_tmp12);
int _tmp16;long long _tmp17;_LLD: if((_tmp15.Int_c).tag != 2)goto _LLF;_tmp16=(_tmp15.Int_c).f2;
_LLE: {struct _tuple6 _tmp188;return(_tmp188.f1=_tmp16 != 0,((_tmp188.f2=1,_tmp188)));}
_LLF: if((_tmp15.LongLong_c).tag != 3)goto _LL11;_tmp17=(_tmp15.LongLong_c).f2;
_LL10: {struct _tuple6 _tmp189;return(_tmp189.f1=_tmp17 != 0,((_tmp189.f2=1,_tmp189)));}
_LL11: if((_tmp15.Null_c).tag != 6)goto _LL13;_LL12: {struct _tuple6 _tmp18A;return(
_tmp18A.f1=0,((_tmp18A.f2=0,_tmp18A)));}_LL13:;_LL14:{const char*_tmp18D;void*
_tmp18C;(_tmp18C=0,Cyc_Tcutil_terr(e->loc,((_tmp18D="expecting bool",
_tag_dyneither(_tmp18D,sizeof(char),15))),_tag_dyneither(_tmp18C,sizeof(void*),0)));}{
struct _tuple6 _tmp18E;return(_tmp18E.f1=0,((_tmp18E.f2=0,_tmp18E)));}_LLC:;}}
...
_tmp20){struct _tuple5 _tmp18F;return(_tmp18F.f1=_tmp1F,((_tmp18F.f2=0,_tmp18F)));}{
struct _tuple7 _tmp190;struct _tuple7 _tmp23=(_tmp190.f1=p,((_tmp190.f2=_tmp1F,
_tmp190)));void*_tmp24;void*_tmp25;union Cyc_Absyn_Cnst_union _tmp26;void*_tmp27;
...
_tmp191;_tmp1F=(union Cyc_Absyn_Cnst_union)(((_tmp191.Int_c).tag=2,(((_tmp191.Int_c).f1=(
void*)((void*)0),(((_tmp191.Int_c).f2=- _tmp28,_tmp191))))));}goto _LL15;_LL1A:
...
_tmp192;_tmp1F=(union Cyc_Absyn_Cnst_union)(((_tmp192.Int_c).tag=2,(((_tmp192.Int_c).f1=(
void*)((void*)1),(((_tmp192.Int_c).f2=~ _tmp2C,_tmp192))))));}goto _LL15;_LL1C:
_tmp2D=_tmp23.f1;if((int)_tmp2D != 11)goto _LL1E;_tmp2E=_tmp23.f2;if(((_tmp23.f2).Int_c).tag
!= 2)goto _LL1E;_tmp2F=(_tmp2E.Int_c).f2;_LL1D:{union Cyc_Absyn_Cnst_union _tmp193;
_tmp1F=(union Cyc_Absyn_Cnst_union)(((_tmp193.Int_c).tag=2,(((_tmp193.Int_c).f1=(
void*)((void*)0),(((_tmp193.Int_c).f2=_tmp2F == 0?1: 0,_tmp193))))));}goto _LL15;
_LL1E: _tmp30=_tmp23.f1;if((int)_tmp30 != 11)goto _LL20;_tmp31=_tmp23.f2;if(((
_tmp23.f2).Null_c).tag != 6)goto _LL20;_LL1F:{union Cyc_Absyn_Cnst_union _tmp194;
_tmp1F=(union Cyc_Absyn_Cnst_union)(((_tmp194.Int_c).tag=2,(((_tmp194.Int_c).f1=(
void*)((void*)0),(((_tmp194.Int_c).f2=1,_tmp194))))));}goto _LL15;_LL20:;_LL21:{
const char*_tmp197;void*_tmp196;(_tmp196=0,Cyc_Tcutil_terr(e->loc,((_tmp197="bad constant expression",
_tag_dyneither(_tmp197,sizeof(char),24))),_tag_dyneither(_tmp196,sizeof(void*),0)));}
goto _LL15;_LL15:;}{struct _tuple5 _tmp198;return(_tmp198.f1=_tmp1F,((_tmp198.f2=1,
_tmp198)));}}struct _tuple8{void*f1;int f2;};static struct _tuple5 Cyc_Evexp_eval_const_binprimop(
...
_tmp3E){struct _tuple5 _tmp199;return(_tmp199.f1=_tmp3A,((_tmp199.f2=0,_tmp199)));}
...
char*_tmp19C;void*_tmp19B;(_tmp19B=0,Cyc_Tcutil_terr(e1->loc,((_tmp19C="bad constant expression",
_tag_dyneither(_tmp19C,sizeof(char),24))),_tag_dyneither(_tmp19B,sizeof(void*),0)));}{
struct _tuple5 _tmp19D;return(_tmp19D.f1=_tmp3A,((_tmp19D.f2=1,_tmp19D)));}_LL22:;}{
...
i2=_tmp48;goto _LL27;_LL2A:;_LL2B:{const char*_tmp1A0;void*_tmp19F;(_tmp19F=0,Cyc_Tcutil_terr(
e2->loc,((_tmp1A0="bad constant expression",_tag_dyneither(_tmp1A0,sizeof(char),
24))),_tag_dyneither(_tmp19F,sizeof(void*),0)));}{struct _tuple5 _tmp1A1;return(
_tmp1A1.f1=_tmp3A,((_tmp1A1.f2=1,_tmp1A1)));}_LL27:;}{void*_tmp4C=p;_LL2D: if((
int)_tmp4C != 3)goto _LL2F;_LL2E: goto _LL30;_LL2F: if((int)_tmp4C != 4)goto _LL31;
_LL30: if(i2 == 0){{const char*_tmp1A4;void*_tmp1A3;(_tmp1A3=0,Cyc_Tcutil_terr(e2->loc,((
_tmp1A4="division by zero in constant expression",_tag_dyneither(_tmp1A4,sizeof(
char),40))),_tag_dyneither(_tmp1A3,sizeof(void*),0)));}{struct _tuple5 _tmp1A5;
return(_tmp1A5.f1=_tmp3A,((_tmp1A5.f2=1,_tmp1A5)));}}goto _LL2C;_LL31:;_LL32: goto
...
int use_i3=0;int use_u3=0;int use_b3=0;{struct _tuple8 _tmp1A6;struct _tuple8 _tmp51=(
_tmp1A6.f1=p,((_tmp1A6.f2=has_u_arg,_tmp1A6)));void*_tmp52;int _tmp53;void*_tmp54;
...
const char*_tmp1A9;void*_tmp1A8;(_tmp1A8=0,Cyc_Tcutil_terr(e1->loc,((_tmp1A9=">>> NOT IMPLEMENTED",
_tag_dyneither(_tmp1A9,sizeof(char),20))),_tag_dyneither(_tmp1A8,sizeof(void*),0)));}
goto _LL69;_LL68:;_LL69:{const char*_tmp1AC;void*_tmp1AB;(_tmp1AB=0,Cyc_Tcutil_terr(
e1->loc,((_tmp1AC="bad constant expression",_tag_dyneither(_tmp1AC,sizeof(char),
24))),_tag_dyneither(_tmp1AB,sizeof(void*),0)));}{struct _tuple5 _tmp1AD;return(
_tmp1AD.f1=_tmp3A,((_tmp1AD.f2=1,_tmp1AD)));}_LL33:;}if(use_i3){union Cyc_Absyn_Cnst_union
_tmp1B0;struct _tuple5 _tmp1AF;return(_tmp1AF.f1=(union Cyc_Absyn_Cnst_union)(((
_tmp1B0.Int_c).tag=2,(((_tmp1B0.Int_c).f1=(void*)((void*)0),(((_tmp1B0.Int_c).f2=
i3,_tmp1B0)))))),((_tmp1AF.f2=1,_tmp1AF)));}if(use_u3){union Cyc_Absyn_Cnst_union
_tmp1B3;struct _tuple5 _tmp1B2;return(_tmp1B2.f1=(union Cyc_Absyn_Cnst_union)(((
_tmp1B3.Int_c).tag=2,(((_tmp1B3.Int_c).f1=(void*)((void*)1),(((_tmp1B3.Int_c).f2=(
int)u3,_tmp1B3)))))),((_tmp1B2.f2=1,_tmp1B2)));}if(use_b3){union Cyc_Absyn_Cnst_union
_tmp1B6;struct _tuple5 _tmp1B5;return(_tmp1B5.f1=(union Cyc_Absyn_Cnst_union)(((
_tmp1B6.Int_c).tag=2,(((_tmp1B6.Int_c).f1=(void*)((void*)0),(((_tmp1B6.Int_c).f2=
b3?1: 0,_tmp1B6)))))),((_tmp1B5.f2=1,_tmp1B5)));}{const char*_tmp1B9;void*_tmp1B8;(
_tmp1B8=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp1B9="Evexp::eval_const_binop",_tag_dyneither(_tmp1B9,sizeof(char),24))),
_tag_dyneither(_tmp1B8,sizeof(void*),0)));}}}}}static struct _tuple5 Cyc_Evexp_eval_const_exp(
...
void*_tmp97;struct Cyc_Absyn_Exp*_tmp98;struct Cyc_Absyn_Enumfield*_tmp99;struct
Cyc_Absyn_Enumfield*_tmp9A;_LL6B: if(*((int*)_tmp8B)!= 0)goto _LL6D;_tmp8C=((
struct Cyc_Absyn_Const_e_struct*)_tmp8B)->f1;_LL6C: {struct _tuple5 _tmp1BA;return(
_tmp1BA.f1=_tmp8C,((_tmp1BA.f2=1,_tmp1BA)));}_LL6D: if(*((int*)_tmp8B)!= 6)goto
_LL6F;_tmp8D=((struct Cyc_Absyn_Conditional_e_struct*)_tmp8B)->f1;_tmp8E=((struct
Cyc_Absyn_Conditional_e_struct*)_tmp8B)->f2;_tmp8F=((struct Cyc_Absyn_Conditional_e_struct*)
_tmp8B)->f3;_LL6E: {int _tmp9D;int _tmp9E;struct _tuple6 _tmp9C=Cyc_Evexp_eval_const_bool_exp(
_tmp8D);_tmp9D=_tmp9C.f1;_tmp9E=_tmp9C.f2;if(!_tmp9E){Cyc_Evexp_eval_const_exp(
_tmp8E);Cyc_Evexp_eval_const_exp(_tmp8F);{union Cyc_Absyn_Cnst_union _tmp1BD;
struct _tuple5 _tmp1BC;return(_tmp1BC.f1=(union Cyc_Absyn_Cnst_union)(((_tmp1BD.Int_c).tag=
2,(((_tmp1BD.Int_c).f1=(void*)((void*)0),(((_tmp1BD.Int_c).f2=0,_tmp1BD)))))),((
_tmp1BC.f2=0,_tmp1BC)));}}ans=_tmp9D?Cyc_Evexp_eval_const_exp(_tmp8E): Cyc_Evexp_eval_const_exp(
_tmp8F);goto _LL6A;}_LL6F: if(*((int*)_tmp8B)!= 7)goto _LL71;_tmp90=((struct Cyc_Absyn_And_e_struct*)
_tmp8B)->f1;_tmp91=((struct Cyc_Absyn_And_e_struct*)_tmp8B)->f2;_LL70: {int _tmpA2;
int _tmpA3;struct _tuple6 _tmpA1=Cyc_Evexp_eval_const_bool_exp(_tmp90);_tmpA2=
_tmpA1.f1;_tmpA3=_tmpA1.f2;if(!_tmpA3){Cyc_Evexp_eval_const_exp(_tmp91);{union
Cyc_Absyn_Cnst_union _tmp1C0;struct _tuple5 _tmp1BF;return(_tmp1BF.f1=(union Cyc_Absyn_Cnst_union)(((
_tmp1C0.Int_c).tag=2,(((_tmp1C0.Int_c).f1=(void*)((void*)0),(((_tmp1C0.Int_c).f2=
0,_tmp1C0)))))),((_tmp1BF.f2=0,_tmp1BF)));}}if(_tmpA2)ans=Cyc_Evexp_eval_const_exp(
_tmp91);else{union Cyc_Absyn_Cnst_union _tmp1C3;struct _tuple5 _tmp1C2;ans=((_tmp1C2.f1=(
union Cyc_Absyn_Cnst_union)(((_tmp1C3.Int_c).tag=2,(((_tmp1C3.Int_c).f1=(void*)((
void*)0),(((_tmp1C3.Int_c).f2=0,_tmp1C3)))))),((_tmp1C2.f2=1,_tmp1C2))));}goto
_LL6A;}_LL71: if(*((int*)_tmp8B)!= 8)goto _LL73;_tmp92=((struct Cyc_Absyn_Or_e_struct*)
_tmp8B)->f1;_tmp93=((struct Cyc_Absyn_Or_e_struct*)_tmp8B)->f2;_LL72: {int _tmpA9;
int _tmpAA;struct _tuple6 _tmpA8=Cyc_Evexp_eval_const_bool_exp(_tmp92);_tmpA9=
_tmpA8.f1;_tmpAA=_tmpA8.f2;if(!_tmpAA){Cyc_Evexp_eval_const_exp(_tmp93);{union
Cyc_Absyn_Cnst_union _tmp1C6;struct _tuple5 _tmp1C5;return(_tmp1C5.f1=(union Cyc_Absyn_Cnst_union)(((
_tmp1C6.Int_c).tag=2,(((_tmp1C6.Int_c).f1=(void*)((void*)0),(((_tmp1C6.Int_c).f2=
0,_tmp1C6)))))),((_tmp1C5.f2=0,_tmp1C5)));}}if(!_tmpA9)ans=Cyc_Evexp_eval_const_exp(
_tmp93);else{union Cyc_Absyn_Cnst_union _tmp1C9;struct _tuple5 _tmp1C8;ans=((_tmp1C8.f1=(
union Cyc_Absyn_Cnst_union)(((_tmp1C9.Int_c).tag=2,(((_tmp1C9.Int_c).f1=(void*)((
void*)0),(((_tmp1C9.Int_c).f2=1,_tmp1C9)))))),((_tmp1C8.f2=1,_tmp1C8))));}goto
...
_tmp95 == 0){{const char*_tmp1CC;void*_tmp1CB;(_tmp1CB=0,Cyc_Tcutil_terr(e->loc,((
_tmp1CC="bad static expression (no args to primop)",_tag_dyneither(_tmp1CC,
sizeof(char),42))),_tag_dyneither(_tmp1CB,sizeof(void*),0)));}{union Cyc_Absyn_Cnst_union
_tmp1CF;struct _tuple5 _tmp1CE;return(_tmp1CE.f1=(union Cyc_Absyn_Cnst_union)(((
_tmp1CF.Int_c).tag=2,(((_tmp1CF.Int_c).f1=(void*)((void*)0),(((_tmp1CF.Int_c).f2=
0,_tmp1CF)))))),((_tmp1CE.f2=1,_tmp1CE)));}}if(_tmp95->tl == 0){ans=Cyc_Evexp_eval_const_unprimop(
...
_check_null(_tmp95->tl))->hd);goto _LL6A;}{const char*_tmp1D2;void*_tmp1D1;(
_tmp1D1=0,Cyc_Tcutil_terr(e->loc,((_tmp1D2="bad static expression (too many args to primop)",
_tag_dyneither(_tmp1D2,sizeof(char),48))),_tag_dyneither(_tmp1D1,sizeof(void*),0)));}{
union Cyc_Absyn_Cnst_union _tmp1D5;struct _tuple5 _tmp1D4;return(_tmp1D4.f1=(union
Cyc_Absyn_Cnst_union)(((_tmp1D5.Int_c).tag=2,(((_tmp1D5.Int_c).f1=(void*)((void*)
0),(((_tmp1D5.Int_c).f2=0,_tmp1D5)))))),((_tmp1D4.f2=1,_tmp1D4)));}_LL75: if(*((
int*)_tmp8B)!= 39)goto _LL77;_tmp96=(void*)((struct Cyc_Absyn_Valueof_e_struct*)
_tmp8B)->f1;_LL76:{void*_tmpB7=Cyc_Tcutil_compress(_tmp96);struct Cyc_Absyn_Exp*
_tmpB8;_LL86: if(_tmpB7 <= (void*)4)goto _LL88;if(*((int*)_tmpB7)!= 17)goto _LL88;
_tmpB8=((struct Cyc_Absyn_ValueofType_struct*)_tmpB7)->f1;_LL87: return Cyc_Evexp_eval_const_exp(
_tmpB8);_LL88:;_LL89: goto _LL85;_LL85:;}goto _LL78;_LL77: if(*((int*)_tmp8B)!= 18)
goto _LL79;_LL78: goto _LL7A;_LL79: if(*((int*)_tmp8B)!= 19)goto _LL7B;_LL7A: goto
_LL7C;_LL7B: if(*((int*)_tmp8B)!= 20)goto _LL7D;_LL7C:{union Cyc_Absyn_Cnst_union
_tmp1D8;struct _tuple5 _tmp1D7;ans=((_tmp1D7.f1=(union Cyc_Absyn_Cnst_union)(((
_tmp1D8.Int_c).tag=2,(((_tmp1D8.Int_c).f1=(void*)((void*)0),(((_tmp1D8.Int_c).f2=
0,_tmp1D8)))))),((_tmp1D7.f2=0,_tmp1D7))));}goto _LL6A;_LL7D: if(*((int*)_tmp8B)!= 
15)goto _LL7F;_tmp97=(void*)((struct Cyc_Absyn_Cast_e_struct*)_tmp8B)->f1;_tmp98=((
struct Cyc_Absyn_Cast_e_struct*)_tmp8B)->f2;_LL7E: ans=Cyc_Evexp_eval_const_exp(
_tmp98);if(ans.f2){struct _tuple7 _tmp1D9;struct _tuple7 _tmpBC=(_tmp1D9.f1=Cyc_Tcutil_compress(
_tmp97),((_tmp1D9.f2=ans.f1,_tmp1D9)));void*_tmpBD;void*_tmpBE;void*_tmpBF;union
Cyc_Absyn_Cnst_union _tmpC0;void*_tmpC1;char _tmpC2;void*_tmpC3;void*_tmpC4;void*
_tmpC5;union Cyc_Absyn_Cnst_union _tmpC6;void*_tmpC7;short _tmpC8;void*_tmpC9;void*
_tmpCA;void*_tmpCB;union Cyc_Absyn_Cnst_union _tmpCC;void*_tmpCD;int _tmpCE;void*
_tmpCF;void*_tmpD0;union Cyc_Absyn_Cnst_union _tmpD1;void*_tmpD2;char _tmpD3;void*
_tmpD4;void*_tmpD5;union Cyc_Absyn_Cnst_union _tmpD6;void*_tmpD7;short _tmpD8;void*
_tmpD9;void*_tmpDA;union Cyc_Absyn_Cnst_union _tmpDB;void*_tmpDC;int _tmpDD;_LL8B:
_tmpBD=_tmpBC.f1;if(_tmpBD <= (void*)4)goto _LL8D;if(*((int*)_tmpBD)!= 5)goto _LL8D;
_tmpBE=(void*)((struct Cyc_Absyn_IntType_struct*)_tmpBD)->f1;_tmpBF=(void*)((
struct Cyc_Absyn_IntType_struct*)_tmpBD)->f2;_tmpC0=_tmpBC.f2;if(((_tmpBC.f2).Char_c).tag
!= 0)goto _LL8D;_tmpC1=(_tmpC0.Char_c).f1;_tmpC2=(_tmpC0.Char_c).f2;_LL8C: _tmpC4=
_tmpBE;_tmpC5=_tmpBF;_tmpC7=_tmpC1;_tmpC8=(short)_tmpC2;goto _LL8E;_LL8D: _tmpC3=
_tmpBC.f1;if(_tmpC3 <= (void*)4)goto _LL8F;if(*((int*)_tmpC3)!= 5)goto _LL8F;_tmpC4=(
void*)((struct Cyc_Absyn_IntType_struct*)_tmpC3)->f1;_tmpC5=(void*)((struct Cyc_Absyn_IntType_struct*)
_tmpC3)->f2;_tmpC6=_tmpBC.f2;if(((_tmpBC.f2).Short_c).tag != 1)goto _LL8F;_tmpC7=(
_tmpC6.Short_c).f1;_tmpC8=(_tmpC6.Short_c).f2;_LL8E: _tmpCA=_tmpC4;_tmpCB=_tmpC5;
_tmpCD=_tmpC7;_tmpCE=(int)_tmpC8;goto _LL90;_LL8F: _tmpC9=_tmpBC.f1;if(_tmpC9 <= (
void*)4)goto _LL91;if(*((int*)_tmpC9)!= 5)goto _LL91;_tmpCA=(void*)((struct Cyc_Absyn_IntType_struct*)
...
_tmpCE=(_tmpCC.Int_c).f2;_LL90: if(_tmpCA != _tmpCD){union Cyc_Absyn_Cnst_union
_tmp1DA;ans.f1=(union Cyc_Absyn_Cnst_union)(((_tmp1DA.Int_c).tag=2,(((_tmp1DA.Int_c).f1=(
void*)_tmpCA,(((_tmp1DA.Int_c).f2=_tmpCE,_tmp1DA))))));}goto _LL8A;_LL91: _tmpCF=
_tmpBC.f1;if(_tmpCF <= (void*)4)goto _LL93;if(*((int*)_tmpCF)!= 18)goto _LL93;
_tmpD0=(void*)((struct Cyc_Absyn_TagType_struct*)_tmpCF)->f1;_tmpD1=_tmpBC.f2;if(((
_tmpBC.f2).Char_c).tag != 0)goto _LL93;_tmpD2=(_tmpD1.Char_c).f1;_tmpD3=(_tmpD1.Char_c).f2;
_LL92: _tmpD5=_tmpD0;_tmpD7=_tmpD2;_tmpD8=(short)_tmpD3;goto _LL94;_LL93: _tmpD4=
_tmpBC.f1;if(_tmpD4 <= (void*)4)goto _LL95;if(*((int*)_tmpD4)!= 18)goto _LL95;
_tmpD5=(void*)((struct Cyc_Absyn_TagType_struct*)_tmpD4)->f1;_tmpD6=_tmpBC.f2;if(((
_tmpBC.f2).Short_c).tag != 1)goto _LL95;_tmpD7=(_tmpD6.Short_c).f1;_tmpD8=(_tmpD6.Short_c).f2;
_LL94: _tmpDA=_tmpD5;_tmpDC=_tmpD7;_tmpDD=(int)_tmpD8;goto _LL96;_LL95: _tmpD9=
_tmpBC.f1;if(_tmpD9 <= (void*)4)goto _LL97;if(*((int*)_tmpD9)!= 18)goto _LL97;
_tmpDA=(void*)((struct Cyc_Absyn_TagType_struct*)_tmpD9)->f1;_tmpDB=_tmpBC.f2;if(((
_tmpBC.f2).Int_c).tag != 2)goto _LL97;_tmpDC=(_tmpDB.Int_c).f1;_tmpDD=(_tmpDB.Int_c).f2;
_LL96: if(_tmpDD < 0){const char*_tmp1DD;void*_tmp1DC;(_tmp1DC=0,Cyc_Tcutil_terr(e->loc,((
_tmp1DD="cannot cast negative number to a tag type",_tag_dyneither(_tmp1DD,
sizeof(char),42))),_tag_dyneither(_tmp1DC,sizeof(void*),0)));}{struct Cyc_Absyn_ValueofType_struct
_tmp1E0;struct Cyc_Absyn_ValueofType_struct*_tmp1DF;Cyc_Tcutil_unify(_tmpDA,(void*)((
_tmp1DF=_cycalloc(sizeof(*_tmp1DF)),((_tmp1DF[0]=((_tmp1E0.tag=17,((_tmp1E0.f1=
Cyc_Absyn_const_exp(ans.f1,0),_tmp1E0)))),_tmp1DF)))));}{union Cyc_Absyn_Cnst_union
_tmp1E1;ans.f1=(union Cyc_Absyn_Cnst_union)(((_tmp1E1.Int_c).tag=2,(((_tmp1E1.Int_c).f1=(
void*)((void*)1),(((_tmp1E1.Int_c).f2=_tmpDD,_tmp1E1))))));}goto _LL8A;_LL97:;
_LL98:{const char*_tmp1E5;void*_tmp1E4[1];struct Cyc_String_pa_struct _tmp1E3;(
_tmp1E3.tag=0,((_tmp1E3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
_tmp97)),((_tmp1E4[0]=& _tmp1E3,Cyc_Tcutil_terr(e->loc,((_tmp1E5="cannot cast to %s",
_tag_dyneither(_tmp1E5,sizeof(char),18))),_tag_dyneither(_tmp1E4,sizeof(void*),1)))))));}
...
const char*_tmp1E9;void*_tmp1E8[1];struct Cyc_String_pa_struct _tmp1E7;(_tmp1E7.tag=
0,((_tmp1E7.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(
e)),((_tmp1E8[0]=& _tmp1E7,Cyc_Tcutil_terr(e->loc,((_tmp1E9="bad static expression %s",
_tag_dyneither(_tmp1E9,sizeof(char),25))),_tag_dyneither(_tmp1E8,sizeof(void*),1)))))));}{
union Cyc_Absyn_Cnst_union _tmp1EC;struct _tuple5 _tmp1EB;return(_tmp1EB.f1=(union
Cyc_Absyn_Cnst_union)(((_tmp1EC.Int_c).tag=2,(((_tmp1EC.Int_c).f1=(void*)((void*)
0),(((_tmp1EC.Int_c).f2=0,_tmp1EC)))))),((_tmp1EB.f2=1,_tmp1EB)));}_LL6A:;}if(
ans.f2){struct Cyc_Absyn_Const_e_struct _tmp1EF;struct Cyc_Absyn_Const_e_struct*
_tmp1EE;(void*)(e->r=(void*)((void*)((_tmp1EE=_cycalloc(sizeof(*_tmp1EE)),((
_tmp1EE[0]=((_tmp1EF.tag=0,((_tmp1EF.f1=ans.f1,_tmp1EF)))),_tmp1EE))))));}return
ans;}int Cyc_Evexp_c_can_eval(struct Cyc_Absyn_Exp*e);int Cyc_Evexp_c_can_eval(
struct Cyc_Absyn_Exp*e){void*_tmpEE=(void*)e->r;struct Cyc_Absyn_Exp*_tmpEF;struct
Cyc_Absyn_Exp*_tmpF0;struct Cyc_Absyn_Exp*_tmpF1;struct Cyc_Absyn_Exp*_tmpF2;
struct Cyc_Absyn_Exp*_tmpF3;struct Cyc_Absyn_Exp*_tmpF4;struct Cyc_Absyn_Exp*_tmpF5;
void*_tmpF6;struct Cyc_List_List*_tmpF7;struct Cyc_Absyn_Exp*_tmpF8;_LL9A: if(*((
int*)_tmpEE)!= 34)goto _LL9C;_LL9B: goto _LL9D;_LL9C: if(*((int*)_tmpEE)!= 33)goto
_LL9E;_LL9D: goto _LL9F;_LL9E: if(*((int*)_tmpEE)!= 18)goto _LLA0;_LL9F: goto _LLA1;
_LLA0: if(*((int*)_tmpEE)!= 19)goto _LLA2;_LLA1: goto _LLA3;_LLA2: if(*((int*)_tmpEE)
!= 20)goto _LLA4;_LLA3: goto _LLA5;_LLA4: if(*((int*)_tmpEE)!= 0)goto _LLA6;_LLA5:
return 1;_LLA6: if(*((int*)_tmpEE)!= 6)goto _LLA8;_tmpEF=((struct Cyc_Absyn_Conditional_e_struct*)
_tmpEE)->f1;_tmpF0=((struct Cyc_Absyn_Conditional_e_struct*)_tmpEE)->f2;_tmpF1=((
struct Cyc_Absyn_Conditional_e_struct*)_tmpEE)->f3;_LLA7: return(Cyc_Evexp_c_can_eval(
_tmpEF) && Cyc_Evexp_c_can_eval(_tmpF0)) && Cyc_Evexp_c_can_eval(_tmpF1);_LLA8:
if(*((int*)_tmpEE)!= 7)goto _LLAA;_tmpF2=((struct Cyc_Absyn_And_e_struct*)_tmpEE)->f1;
_tmpF3=((struct Cyc_Absyn_And_e_struct*)_tmpEE)->f2;_LLA9: _tmpF4=_tmpF2;_tmpF5=
_tmpF3;goto _LLAB;_LLAA: if(*((int*)_tmpEE)!= 8)goto _LLAC;_tmpF4=((struct Cyc_Absyn_Or_e_struct*)
_tmpEE)->f1;_tmpF5=((struct Cyc_Absyn_Or_e_struct*)_tmpEE)->f2;_LLAB: return Cyc_Evexp_c_can_eval(
_tmpF4) && Cyc_Evexp_c_can_eval(_tmpF5);_LLAC: if(*((int*)_tmpEE)!= 3)goto _LLAE;
_tmpF6=(void*)((struct Cyc_Absyn_Primop_e_struct*)_tmpEE)->f1;_tmpF7=((struct Cyc_Absyn_Primop_e_struct*)
...
e);static int Cyc_Evexp_const_exp_case_number(struct Cyc_Absyn_Exp*e){void*_tmpF9=(
void*)e->r;_LLB5: if(*((int*)_tmpF9)!= 0)goto _LLB7;_LLB6: return 1;_LLB7: if(*((int*)
_tmpF9)!= 6)goto _LLB9;_LLB8: return 2;_LLB9: if(*((int*)_tmpF9)!= 3)goto _LLBB;_LLBA:
return 3;_LLBB: if(*((int*)_tmpF9)!= 18)goto _LLBD;_LLBC: goto _LLBE;_LLBD: if(*((int*)
_tmpF9)!= 19)goto _LLBF;_LLBE: return 4;_LLBF: if(*((int*)_tmpF9)!= 20)goto _LLC1;
_LLC0: return 5;_LLC1: if(*((int*)_tmpF9)!= 15)goto _LLC3;_LLC2: return 6;_LLC3: if(*((
int*)_tmpF9)!= 7)goto _LLC5;_LLC4: return 7;_LLC5: if(*((int*)_tmpF9)!= 8)goto _LLC7;
_LLC6: return 8;_LLC7: if(*((int*)_tmpF9)!= 39)goto _LLC9;_LLC8: return 9;_LLC9:;_LLCA:{
const char*_tmp1F3;void*_tmp1F2[1];struct Cyc_String_pa_struct _tmp1F1;(_tmp1F1.tag=
0,((_tmp1F1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(
e)),((_tmp1F2[0]=& _tmp1F1,Cyc_Tcutil_terr(e->loc,((_tmp1F3="bad static expression %s",
_tag_dyneither(_tmp1F3,sizeof(char),25))),_tag_dyneither(_tmp1F2,sizeof(void*),1)))))));}
...
unsigned int _tmpFE;int _tmpFF;struct _tuple4 _tmpFD=Cyc_Evexp_eval_const_uint_exp(
...
_tmp103 - _tmp104;{struct _tuple3 _tmp1F4;struct _tuple3 _tmp106=(_tmp1F4.f1=(void*)
e1->r,((_tmp1F4.f2=(void*)e2->r,_tmp1F4)));void*_tmp107;struct Cyc_Absyn_Exp*
...
const char*_tmp1F7;void*_tmp1F6;(_tmp1F6=0,Cyc_Tcutil_terr(e2->loc,((_tmp1F7="cannot handle sizeof(exp) here -- use sizeof(type)",
_tag_dyneither(_tmp1F7,sizeof(char),51))),_tag_dyneither(_tmp1F6,sizeof(void*),0)));}
return Cyc_Tcutil_typecmp(_tmp126,(void*)((struct Cyc_Core_Opt*)_check_null(
...
_tmp12B)->f1;_LLD9: if(_tmp12A->topt == 0){const char*_tmp1FA;void*_tmp1F9;(_tmp1F9=
0,Cyc_Tcutil_terr(e1->loc,((_tmp1FA="cannot handle sizeof(exp) here -- use sizeof(type)",
_tag_dyneither(_tmp1FA,sizeof(char),51))),_tag_dyneither(_tmp1F9,sizeof(void*),0)));}
return Cyc_Tcutil_typecmp((void*)((struct Cyc_Core_Opt*)_check_null(_tmp12A->topt))->v,
...
_LLDB: if(_tmp12E->topt == 0){const char*_tmp1FD;void*_tmp1FC;(_tmp1FC=0,Cyc_Tcutil_terr(
e1->loc,((_tmp1FD="cannot handle sizeof(exp) here -- use sizeof(type)",
_tag_dyneither(_tmp1FD,sizeof(char),51))),_tag_dyneither(_tmp1FC,sizeof(void*),0)));}
if(_tmp130->topt == 0){const char*_tmp200;void*_tmp1FF;(_tmp1FF=0,Cyc_Tcutil_terr(
e2->loc,((_tmp200="cannot handle sizeof(exp) here -- use sizeof(type)",
_tag_dyneither(_tmp200,sizeof(char),51))),_tag_dyneither(_tmp1FF,sizeof(void*),0)));}
return Cyc_Tcutil_typecmp((void*)((struct Cyc_Core_Opt*)_check_null(_tmp12E->topt))->v,(
...
_tmp14D;{struct _tuple3 _tmp201;struct _tuple3 _tmp14F=(_tmp201.f1=_tmp133,((_tmp201.f2=
_tmp136,_tmp201)));void*_tmp150;void*_tmp151;void*_tmp152;void*_tmp153;void*
...
_tmp140))return 0;return Cyc_Tcutil_typecmp(_tmp13E,_tmp140);_LLE2:;_LLE3: {const
char*_tmp204;void*_tmp203;(_tmp203=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp204="Evexp::const_exp_cmp, unexpected case",
_tag_dyneither(_tmp204,sizeof(char),38))),_tag_dyneither(_tmp203,sizeof(void*),0)));}
...
struct Cyc_Absyn_Exp*e2){unsigned int _tmp160;int _tmp161;struct _tuple4 _tmp15F=Cyc_Evexp_eval_const_uint_exp(
e1);_tmp160=_tmp15F.f1;_tmp161=_tmp15F.f2;{unsigned int _tmp163;int _tmp164;struct
_tuple4 _tmp162=Cyc_Evexp_eval_const_uint_exp(e2);_tmp163=_tmp162.f1;_tmp164=
_tmp162.f2;if(_tmp161  && _tmp164)return _tmp160 <= _tmp163;return Cyc_Evexp_same_const_exp(
e1,e2);}}struct _tuple9{struct Cyc_Absyn_Tqual f1;void*f2;};int Cyc_Evexp_okay_szofarg(
void*t);int Cyc_Evexp_okay_szofarg(void*t){void*_tmp165=Cyc_Tcutil_compress(t);
struct Cyc_Absyn_Tvar*_tmp166;struct Cyc_Core_Opt*_tmp167;struct Cyc_Core_Opt
...
_LL12C: if((_tmp176.UnknownAggr).tag != 0)goto _LL12E;_LL12D: {const char*_tmp207;
void*_tmp206;(_tmp206=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))
Cyc_Tcutil_impos)(((_tmp207="szof on unchecked StructType",_tag_dyneither(
_tmp207,sizeof(char),29))),_tag_dyneither(_tmp206,sizeof(void*),0)));}_LL12E: if((
_tmp176.KnownAggr).tag != 1)goto _LL12B;_tmp177=(_tmp176.KnownAggr).f1;_tmp178=*
_tmp177;_LL12F: ad=_tmp178;_LL12B:;}if(ad->impl == 0)return 0;_tmp173=((struct Cyc_Absyn_AggrdeclImpl*)
...
_tmp174 == 0  || _tmp174->kind == 0){struct Cyc_String_pa_struct _tmp20F;void*_tmp20E[
1];const char*_tmp20D;void*_tmp20C;(_tmp20C=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)((struct _dyneither_ptr)((_tmp20F.tag=0,((
_tmp20F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((
_tmp20E[0]=& _tmp20F,Cyc_aprintf(((_tmp20D="szof typedeftype %s",_tag_dyneither(
_tmp20D,sizeof(char),20))),_tag_dyneither(_tmp20E,sizeof(void*),1)))))))),
_tag_dyneither(_tmp20C,sizeof(void*),0)));}return(void*)((struct Cyc_Core_Opt*)
_check_null(_tmp174->kind))->v == (void*)2;_LLED:;}
