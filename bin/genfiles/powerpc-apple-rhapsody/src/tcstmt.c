...
_tmp193="expected datatype exn but found %s",_tag_dyneither(_tmp193,sizeof(char),
35))),_tag_dyneither(_tmp192,sizeof(void*),1)))))));}else{Cyc_Tcpat_check_pat_regions(
...
unimp_msg_part=((_tmp202="datatype",_tag_dyneither(_tmp202,sizeof(char),9)));}
