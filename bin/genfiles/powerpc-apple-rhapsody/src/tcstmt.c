...
r);{struct Cyc_Tcenv_Stmt_j_struct _tmp155;struct Cyc_Tcenv_Stmt_j_struct*_tmp154;
struct Cyc_Tcenv_Tenv*_tmp49=Cyc_Tcenv_set_next(r,te,(void*)((_tmp154=_cycalloc(
sizeof(*_tmp154)),((_tmp154[0]=((_tmp155.tag=0,((_tmp155.f1=_tmp17,_tmp155)))),
_tmp154)))));Cyc_Tcstmt_tcStmt(_tmp49,_tmp16,1);};_pop_region(r);}Cyc_Tcstmt_tcStmt(
...
if((int)_tmp4C != 0)goto _LL31;_LL30: goto _LL2E;_LL31:;_LL32:{const char*_tmp159;
void*_tmp158[1];struct Cyc_String_pa_struct _tmp157;(_tmp157.tag=0,((_tmp157.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp158[
0]=& _tmp157,Cyc_Tcutil_terr(s0->loc,((_tmp159="must return a value of type %s",
...
Cyc_Tcutil_is_noalias_path(e)){const char*_tmp161;void*_tmp160;(_tmp160=0,Cyc_Tcutil_terr(
e->loc,((_tmp161="Cannot consume non-unique paths; do swap instead",
_tag_dyneither(_tmp161,sizeof(char),49))),_tag_dyneither(_tmp160,sizeof(void*),0)));}}
...
const char*_tmp162;Cyc_Tcexp_tcTest(te,_tmp19,((_tmp162="if statement",
_tag_dyneither(_tmp162,sizeof(char),13))));}Cyc_Tcstmt_tcStmt(te,_tmp1A,1);Cyc_Tcstmt_tcStmt(
...
_tag_dyneither(_tmp163,sizeof(char),11))));}{struct _RegionHandle _tmp58=
...
Cyc_Tcexp_tcExp(te,0,_tmp20);{const char*_tmp164;Cyc_Tcexp_tcTest(te,_tmp22,((
_tmp164="for loop",_tag_dyneither(_tmp164,sizeof(char),9))));}{struct
...
_tmp2A,((_tmp165="do loop",_tag_dyneither(_tmp165,sizeof(char),8))));}return;
...
== 0){{const char*_tmp168;void*_tmp167;(_tmp167=0,Cyc_Tcutil_terr(s0->loc,((
_tmp168="fallthru not in a non-last case",_tag_dyneither(_tmp168,sizeof(char),32))),
_tag_dyneither(_tmp167,sizeof(void*),0)));}return;}{struct Cyc_List_List*_tmp61=(*
...
_tmp63->hd)){{const char*_tmp16D;void*_tmp16C[2];struct Cyc_String_pa_struct
...
const char*_tmp170;void*_tmp16F;(_tmp16F=0,Cyc_Tcutil_terr(((struct Cyc_Absyn_Exp*)
_tmp33->hd)->loc,((_tmp170="Cannot consume non-unique paths; do swap instead",
_tag_dyneither(_tmp170,sizeof(char),49))),_tag_dyneither(_tmp16F,sizeof(void*),0)));}}
if(_tmp33 != 0){const char*_tmp173;void*_tmp172;(_tmp172=0,Cyc_Tcutil_terr(s0->loc,((
_tmp173="too many arguments to explicit fallthru",_tag_dyneither(_tmp173,sizeof(
char),40))),_tag_dyneither(_tmp172,sizeof(void*),0)));}if(_tmp63 != 0){const char*
...
_RegionHandle*r=& _tmp6E;_push_region(r);{struct _dyneither_ptr*_tmp183;const char*
_tmp182;void*_tmp181[1];struct Cyc_String_pa_struct _tmp180;struct Cyc_Absyn_Tvar*
_tmp17F;Cyc_Tcstmt_tcStmt(Cyc_Tcenv_new_named_block(r,s0->loc,Cyc_Tcenv_add_label(
te,_tmp36,_tmp37),((_tmp17F=_cycalloc(sizeof(*_tmp17F)),((_tmp17F->name=((
_tmp183=_cycalloc(sizeof(*_tmp183)),((_tmp183[0]=(struct _dyneither_ptr)((_tmp180.tag=
0,((_tmp180.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp36),((_tmp181[0]=&
_tmp180,Cyc_aprintf(((_tmp182="`%s",_tag_dyneither(_tmp182,sizeof(char),4))),
_tag_dyneither(_tmp181,sizeof(void*),1)))))))),_tmp183)))),((_tmp17F->identity=
...
_tmp186="Cannot consume non-unique paths; do swap instead",_tag_dyneither(
_tmp186,sizeof(char),49))),_tag_dyneither(_tmp185,sizeof(void*),0)));}{struct
...
_check_null(_tmp79->topt))->v,_tmp74)){{const char*_tmp18B;void*_tmp18A[2];struct
...
void*)((struct Cyc_Core_Opt*)_check_null(_tmp79->topt))->v)),((_tmp189.tag=0,((
_tmp189.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
_tmp74)),((_tmp18A[0]=& _tmp189,((_tmp18A[1]=& _tmp188,Cyc_Tcutil_terr(((struct Cyc_Absyn_Switch_clause*)
...
_tmp18C=_cycalloc(sizeof(*_tmp18C)),((_tmp18C->v=_tmp7A.patvars,_tmp18C))));}Cyc_Tcstmt_pattern_synth(((
...
_tmp85,_tmp87);}{struct Cyc_Core_Opt*_tmp194;((struct Cyc_Absyn_Switch_clause*)
_tmp86->hd)->pat_vars=((_tmp194=_cycalloc(sizeof(*_tmp194)),((_tmp194->v=_tmp88.patvars,
_tmp194))));}Cyc_Tcstmt_pattern_synth(((struct Cyc_Absyn_Switch_clause*)_tmp86->hd)->loc,
...
_tmp199;struct Cyc_Core_Opt*_tmp198;*_tmpA7=is_local?(_tmp199=_cycalloc(sizeof(*
_tmp199)),((_tmp199->v=(void*)_tmpA9,_tmp199))):((_tmp198=_cycalloc(sizeof(*
...
_tmp19A;(*_tmp91->name).f1=(union Cyc_Absyn_Nmspace_union)(((_tmp19A.Loc_n).tag=0,
_tmp19A));}goto _LL5D;_LL62: if((_tmpAF.Abs_n).tag != 2)goto _LL64;_tmpB1=(_tmpAF.Abs_n).f1;
_LL63: {const char*_tmp19D;void*_tmp19C;(int)_throw(((_tmp19C=0,Cyc_Tcutil_impos(((
_tmp19D="tcstmt: Abs_n declaration",_tag_dyneither(_tmp19D,sizeof(char),26))),
_tag_dyneither(_tmp19C,sizeof(void*),0)))));}_LL64:;_LL65:{const char*_tmp1A0;
...
_tmpA5)){const char*_tmp1A6;void*_tmp1A5;(_tmp1A5=0,Cyc_Tcutil_terr(_tmp3C->loc,((
...
_dyneither_ptr)((struct _dyneither_ptr)_tmpCD),((_tmp1A9.tag=0,((_tmp1A9.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)_tmpCC),((_tmp1AA.tag=0,((_tmp1AA.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)_tmpCB),((_tmp1AB[0]=& _tmp1AA,((
...
_dyneither_ptr)((struct _dyneither_ptr)_tmpCD),((_tmp1AF.tag=0,((_tmp1AF.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)_tmpCC),((_tmp1B0.tag=0,((_tmp1B0.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)_tmpCB),((_tmp1B1[0]=& _tmp1B0,((
...
_tmp1B4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpCD),((_tmp1B5.tag=0,((
_tmp1B5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpCC),((_tmp1B6.tag=0,((
_tmp1B6.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpCB),((_tmp1B7[0]=&
_tmp1B6,((_tmp1B7[1]=& _tmp1B5,((_tmp1B7[2]=& _tmp1B4,Cyc_Tcutil_terr(_tmp3C->loc,((
...
_check_null(_tmp95->topt))->v)),((_tmp1BC.tag=0,((_tmp1BC.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)((struct Cyc_Core_Opt*)
_check_null(_tmp92->topt))->v)),((_tmp1BD[0]=& _tmp1BC,((_tmp1BD[1]=& _tmp1BB,Cyc_Tcutil_terr(
_tmp3C->loc,((_tmp1BE="pattern type %s does not match definition type %s",
...
_tmpE6).rgn;{struct Cyc_Core_Opt*_tmp1BF;*_tmpED=((_tmp1BF=_cycalloc(sizeof(*
_tmp1BF)),((_tmp1BF->v=(void*)_tmpE3,_tmp1BF))));}{union Cyc_Absyn_Nmspace_union
...
_tmp1C0;(*_tmpE5->name).f1=(union Cyc_Absyn_Nmspace_union)(((_tmp1C0.Loc_n).tag=0,
_tmp1C0));}goto _LL76;_LL7B: if((_tmpEF.Abs_n).tag != 2)goto _LL7D;_tmpF1=(_tmpEF.Abs_n).f1;
_LL7C: {const char*_tmp1C3;void*_tmp1C2;(int)_throw(((_tmp1C2=0,Cyc_Tcutil_impos(((
_tmp1C3="tcstmt: Abs_n declaration",_tag_dyneither(_tmp1C3,sizeof(char),26))),
_tag_dyneither(_tmp1C2,sizeof(void*),0)))));}_LL7D:;_LL7E:{const char*_tmp1C6;
...
_tmp8F);if((void*)_tmp97->sc != (void*)2){const char*_tmp1C9;void*_tmp1C8;(_tmp1C8=
0,Cyc_Tcutil_terr(_tmp3C->loc,((_tmp1C9="bad storage class for inner function",
_tag_dyneither(_tmp1C9,sizeof(char),37))),_tag_dyneither(_tmp1C8,sizeof(void*),0)));}{
...
!= 2)goto _LL84;_tmpFC=(_tmpFA.Abs_n).f1;_LL83: {const char*_tmp1CC;void*_tmp1CB;(
_tmp1CB=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp1CC="tc: Abs_n in tcStmt var decl",_tag_dyneither(_tmp1CC,sizeof(char),29))),
_tag_dyneither(_tmp1CB,sizeof(void*),0)));}_LL84:;_LL85: {const char*_tmp1CF;void*
_tmp1CE;(_tmp1CE=0,Cyc_Tcutil_terr(_tmp3C->loc,((_tmp1CF="explicit namespace not allowed on inner function declaration",
_tag_dyneither(_tmp1CF,sizeof(char),61))),_tag_dyneither(_tmp1CE,sizeof(void*),0)));}
_LL7F:;}{union Cyc_Absyn_Nmspace_union _tmp1D0;(*_tmp97->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp1D0.Loc_n).tag=0,_tmp1D0));}Cyc_Tcutil_check_fndecl_valid_type(_tmp3C->loc,
...
_tmp1D2;(_tmp1D2.tag=0,((_tmp1D2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absyn_attribute2string((void*)atts->hd)),((_tmp1D3[0]=& _tmp1D2,Cyc_Tcutil_terr(
_tmp3C->loc,((_tmp1D4="bad attribute %s for function",_tag_dyneither(_tmp1D4,
sizeof(char),30))),_tag_dyneither(_tmp1D3,sizeof(void*),1)))))));}goto _LL86;
_LL8B:;_LL8C: goto _LL86;_LL86:;}}{struct Cyc_Core_Opt*_tmp1D7;struct Cyc_Absyn_Vardecl*
_tmp1D6;struct Cyc_Absyn_Vardecl*vd=(_tmp1D6=_cycalloc(sizeof(*_tmp1D6)),((
_tmp1D6->sc=(void*)((void*)_tmp97->sc),((_tmp1D6->name=_tmp97->name,((_tmp1D6->tq=
Cyc_Absyn_const_tqual(0),((_tmp1D6->type=(void*)Cyc_Absyn_at_typ(t,_tmpF7,Cyc_Absyn_empty_tqual(
0),Cyc_Absyn_false_conref),((_tmp1D6->initializer=0,((_tmp1D6->rgn=((_tmp1D7=
_cycalloc(sizeof(*_tmp1D7)),((_tmp1D7->v=(void*)_tmpF7,_tmp1D7)))),((_tmp1D6->attributes=
0,((_tmp1D6->escapes=0,_tmp1D6)))))))))))))))));_tmp97->fn_vardecl=(struct Cyc_Absyn_Vardecl*)
...
_tag_dyneither(_tmp1DA,sizeof(char),49))),_tag_dyneither(_tmp1D9,sizeof(void*),0)));}
...
_tmp1DB;unimp_msg_part=((_tmp1DB="namespace",_tag_dyneither(_tmp1DB,sizeof(char),
...
char*_tmp1DC;unimp_msg_part=((_tmp1DC="using",_tag_dyneither(_tmp1DC,sizeof(char),
6)));}goto _LL33;_LL40: if(*((int*)_tmp90)!= 4)goto _LL42;_LL41:{const char*_tmp1DD;
unimp_msg_part=((_tmp1DD="type",_tag_dyneither(_tmp1DD,sizeof(char),5)));}goto
_LL33;_LL42: if(*((int*)_tmp90)!= 5)goto _LL44;_LL43:{const char*_tmp1DE;
unimp_msg_part=((_tmp1DE="[x]tunion",_tag_dyneither(_tmp1DE,sizeof(char),10)));}
goto _LL33;_LL44: if(*((int*)_tmp90)!= 6)goto _LL46;_LL45:{const char*_tmp1DF;
unimp_msg_part=((_tmp1DF="enum",_tag_dyneither(_tmp1DF,sizeof(char),5)));}goto
_LL33;_LL46: if(*((int*)_tmp90)!= 7)goto _LL48;_LL47:{const char*_tmp1E0;
unimp_msg_part=((_tmp1E0="typedef",_tag_dyneither(_tmp1E0,sizeof(char),8)));}
goto _LL33;_LL48: if(*((int*)_tmp90)!= 10)goto _LL4A;_LL49:{const char*_tmp1E1;
unimp_msg_part=((_tmp1E1="extern \"C\"",_tag_dyneither(_tmp1E1,sizeof(char),11)));}
goto _LL33;_LL4A: if(*((int*)_tmp90)!= 11)goto _LL4C;_LL4B:{const char*_tmp1E2;
unimp_msg_part=((_tmp1E2="extern \"C include\"",_tag_dyneither(_tmp1E2,sizeof(
char),19)));}goto _LL33;_LL4C: if((int)_tmp90 != 0)goto _LL4E;_LL4D:{const char*
_tmp1E3;unimp_msg_part=((_tmp1E3="__cyclone_port_on__",_tag_dyneither(_tmp1E3,
sizeof(char),20)));}goto _LL33;_LL4E: if((int)_tmp90 != 1)goto _LL33;_LL4F:{const
char*_tmp1E4;unimp_msg_part=((_tmp1E4="__cyclone_port_off__",_tag_dyneither(
_tmp1E4,sizeof(char),21)));}goto _LL33;_LL33:;}};_pop_region(decl_rgn);}{const
char*_tmp1E8;void*_tmp1E7[1];struct Cyc_String_pa_struct _tmp1E6;(int)_throw(((
_tmp1E6.tag=0,((_tmp1E6.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
unimp_msg_part),((_tmp1E7[0]=& _tmp1E6,Cyc_Tcutil_impos(((_tmp1E8="tcStmt: nested %s declarations unimplemented",
_tag_dyneither(_tmp1E8,sizeof(char),45))),_tag_dyneither(_tmp1E7,sizeof(void*),1)))))))));}}
...
_tmp14)->f5;_LL29:{struct Cyc_Absyn_Seq_s_struct _tmp1EB;struct Cyc_Absyn_Seq_s_struct*
_tmp1EA;(void*)(_tmp42->r=(void*)((void*)(Cyc_Absyn_new_stmt((void*)((_tmp1EA=
_cycalloc(sizeof(*_tmp1EA)),((_tmp1EA[0]=((_tmp1EB.tag=1,((_tmp1EB.f1=Cyc_Absyn_new_stmt((
void*)_tmp42->r,_tmp42->loc),((_tmp1EB.f2=Cyc_Absyn_skip_stmt(_tmp42->loc),
_tmp1EB)))))),_tmp1EA)))),_tmp42->loc))->r));}{struct _RegionHandle _tmp119=
...
sizeof(*_tmp1F0)),((_tmp1F0[0]=((_tmp1F1.tag=15,((_tmp1F1.f1=(void*)rgn_typ,((
...
_cycalloc(sizeof(*_tmp1F3)),((_tmp1F3[0]=((_tmp1F4.tag=14,((_tmp1F4.f1=(void*)
...
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)((struct Cyc_Core_Opt*)
_check_null(open_exp->topt))->v)),((_tmp1F7.tag=0,((_tmp1F7.f1=(struct
...
_tmp1F9="expecting %s but found %s",_tag_dyneither(_tmp1F9,sizeof(char),26))),
_tag_dyneither(_tmp1F8,sizeof(void*),2)))))))))))));}Cyc_Tcenv_check_rgn_accessible(
te,open_exp->loc,rgn2_typ);te2=Cyc_Tcenv_add_region(r,te2,rgn_typ,0,1);}}else{{
struct Cyc_Absyn_VarType_struct _tmp1FC;struct Cyc_Absyn_VarType_struct*_tmp1FB;
rgn_typ=(void*)((_tmp1FB=_cycalloc(sizeof(*_tmp1FB)),((_tmp1FB[0]=((_tmp1FC.tag=
1,((_tmp1FC.f1=_tmp3E,_tmp1FC)))),_tmp1FB))));}{struct Cyc_List_List*_tmp1FD;te2=
Cyc_Tcenv_add_type_vars(r,s0->loc,te2,((_tmp1FD=_cycalloc(sizeof(*_tmp1FD)),((
_tmp1FD->hd=_tmp3E,((_tmp1FD->tl=0,_tmp1FD)))))));}te2=Cyc_Tcenv_add_region(r,
...
_tmp1FF[0]=((_tmp200.tag=14,((_tmp200.f1=(void*)rgn_typ,_tmp200)))),_tmp1FF)))))){
const char*_tmp203;void*_tmp202;(_tmp202=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp203="region stmt: type of region handle is wrong!",
_tag_dyneither(_tmp203,sizeof(char),45))),_tag_dyneither(_tmp202,sizeof(void*),0)));}}
...
te));struct Cyc_Absyn_RgnHandleType_struct _tmp206;struct Cyc_Absyn_RgnHandleType_struct*
_tmp205;void*etype=(void*)((_tmp205=_cycalloc(sizeof(*_tmp205)),((_tmp205[0]=((
_tmp206.tag=14,((_tmp206.f1=(void*)rgn_type,_tmp206)))),_tmp205))));if(!Cyc_Tcutil_unify(
Cyc_Tcexp_tcExp(te,(void**)& etype,_tmp43),etype)){const char*_tmp20A;void*_tmp209[
1];struct Cyc_String_pa_struct _tmp208;(_tmp208.tag=0,((_tmp208.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)((struct Cyc_Core_Opt*)
_check_null(_tmp43->topt))->v)),((_tmp209[0]=& _tmp208,Cyc_Tcutil_terr(_tmp43->loc,((
_tmp20A="expecting region_t but found %s",_tag_dyneither(_tmp20A,sizeof(char),32))),
_tag_dyneither(_tmp209,sizeof(void*),1)))))));}Cyc_Tcenv_check_rgn_resetable(te,
...
_tmp20D[0]=& _tmp20C,Cyc_Tcutil_terr(_tmp44->loc,((_tmp20E="%s is not a pointer type",
_tag_dyneither(_tmp20E,sizeof(char),25))),_tag_dyneither(_tmp20D,sizeof(void*),1)))))));}(
void*)(_tmp46->type=(void*)Cyc_Tcutil_copy_type((void*)((struct Cyc_Core_Opt*)
...
_tmp13C)->f1).ptr_atts).rgn;_LL8F:{struct Cyc_Absyn_VarType_struct _tmp211;struct
Cyc_Absyn_VarType_struct*_tmp210;*_tmp140=(void*)((_tmp210=_cycalloc(sizeof(*
_tmp210)),((_tmp210[0]=((_tmp211.tag=1,((_tmp211.f1=_tmp45,_tmp211)))),_tmp210))));}
goto _LL8D;_LL90:;_LL91: {const char*_tmp214;void*_tmp213;(_tmp213=0,((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp214="Not a pointer type in tcstmt:Alias_s",
_tag_dyneither(_tmp214,sizeof(char),37))),_tag_dyneither(_tmp213,sizeof(void*),0)));}
_LL8D:;}{struct Cyc_Core_Opt*_tmp215;_tmp46->rgn=((_tmp215=_cycalloc(sizeof(*
_tmp215)),((_tmp215->v=(void*)Cyc_Tcenv_curr_rgn(te),_tmp215))));}{struct
...
struct _dyneither_ptr))Cyc_List_rlist)(r,_tag_dyneither(_tmp216,sizeof(struct Cyc_Absyn_Tvar*),
1)))));{struct Cyc_Absyn_VarType_struct _tmp219;struct Cyc_Absyn_VarType_struct*
