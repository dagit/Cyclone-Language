...
return 1;}struct _tuple12{struct Cyc_Absyn_Tvar*f1;void*f2;};static struct Cyc_List_List*
...
_dyneither_ptr)((struct _dyneither_ptr)*_tmp60);({struct Cyc_String_pa_struct
