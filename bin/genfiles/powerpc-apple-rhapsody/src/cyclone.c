...
_tag_dyneither(_tmp38A,sizeof(char),12))));}}static int Cyc_produce_dependencies=0;
...
_tmp38);}}else{Cyc_add_ccarg(s);}}static void Cyc_remove_file(struct _dyneither_ptr
s);static void Cyc_remove_file(struct _dyneither_ptr s){if(Cyc_save_temps_r)return;
...
struct _dyneither_ptr file);struct Cyc_List_List*Cyc_read_specs(struct
...
struct _tuple19*_tmp3BE;const char*_tmp3BD;struct _dyneither_ptr*_tmp3BC;struct
...
_tmp3BB=_cycalloc(sizeof(*_tmp3BB)),((_tmp3BB[0]=(struct _dyneither_ptr)Cyc_strdup(
_tag_dyneither(strname,sizeof(char),256)),_tmp3BB)))),((_tmp3BE->f2=((_tmp3BC=
_cycalloc(sizeof(*_tmp3BC)),((_tmp3BC[0]=(struct _dyneither_ptr)Cyc_strdup(((
_tmp3BD="",_tag_dyneither(_tmp3BD,sizeof(char),1)))),_tmp3BC)))),_tmp3BE)))))),((
...
_tmp3C9->hd=((_tmp3CC=_cycalloc(sizeof(*_tmp3CC)),((_tmp3CC->f1=((_tmp3CA=
_cycalloc(sizeof(*_tmp3CA)),((_tmp3CA[0]=(struct _dyneither_ptr)Cyc_strdup(
_tag_dyneither(strname,sizeof(char),256)),_tmp3CA)))),((_tmp3CC->f2=((_tmp3CB=
_cycalloc(sizeof(*_tmp3CB)),((_tmp3CB[0]=(struct _dyneither_ptr)Cyc_strdup(
_tag_dyneither(strvalue,sizeof(char),4096)),_tmp3CB)))),_tmp3CC)))))),((_tmp3C9->tl=
...
sizeof(char),4096)),_tmp3CF)))),((_tmp3CE->tl=_tmp56,_tmp3CE))))));}}DONE: _tmp56=((
struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp56);{struct
Cyc_List_List*_tmp3D0;_tmp56=((_tmp3D0=_cycalloc(sizeof(*_tmp3D0)),((_tmp3D0->hd=
_init_dyneither_ptr(_cycalloc(sizeof(struct _dyneither_ptr)),"",sizeof(char),1),((
_tmp3D0->tl=_tmp56,_tmp3D0))))));}{struct _dyneither_ptr _tmp5B=((struct
_dyneither_ptr(*)(struct Cyc_List_List*x))Cyc_List_to_array)(_tmp56);unsigned int
_tmp3D5;unsigned int _tmp3D4;struct _dyneither_ptr _tmp3D3;struct _dyneither_ptr*
_tmp3D2;unsigned int _tmp3D1;struct _dyneither_ptr _tmp5C=(_tmp3D1=
...
_tmp97,_tmp96,((_tmp3F9=_cycalloc(sizeof(*_tmp3F9)),((_tmp3F9->f1=((_tmp3FB="written interface",
_tag_dyneither(_tmp3FB,sizeof(char),18))),((_tmp3F9->f2=((_tmp3FA="maximal interface",
_tag_dyneither(_tmp3FA,sizeof(char),18))),_tmp3F9))))))))Cyc_compile_failure=1;
...
_throw(_tmp124);_LL2B:;}}}Cyc_file_close((struct Cyc___cycFILE*)out_file);{struct
_dyneither_ptr*_tmp496;struct Cyc_List_List*_tmp495;Cyc_cfiles=((_tmp495=
...
_dyneither_ptr),i));}}{struct _tuple22*_tmp92E;const char*_tmp92D;struct Cyc_Arg_Set_spec_struct
_tmp92C;struct Cyc_Arg_Set_spec_struct*_tmp92B;const char*_tmp92A;const char*
_tmp929;struct _tuple22*_tmp928;const char*_tmp927;struct Cyc_Arg_Unit_spec_struct
_tmp926;struct Cyc_Arg_Unit_spec_struct*_tmp925;const char*_tmp924;const char*
_tmp923;struct _tuple22*_tmp922;const char*_tmp921;struct Cyc_Arg_Clear_spec_struct
_tmp920;struct Cyc_Arg_Clear_spec_struct*_tmp91F;const char*_tmp91E;const char*
_tmp91D;struct _tuple22*_tmp91C;const char*_tmp91B;struct Cyc_Arg_Set_spec_struct
_tmp91A;struct Cyc_Arg_Set_spec_struct*_tmp919;const char*_tmp918;const char*
_tmp917;struct _tuple22*_tmp916;const char*_tmp915;struct Cyc_Arg_Set_spec_struct
_tmp914;struct Cyc_Arg_Set_spec_struct*_tmp913;const char*_tmp912;const char*
_tmp911;struct _tuple22*_tmp910;const char*_tmp90F;struct Cyc_Arg_Set_spec_struct
_tmp90E;struct Cyc_Arg_Set_spec_struct*_tmp90D;const char*_tmp90C;const char*
_tmp90B;struct _tuple22*_tmp90A;const char*_tmp909;struct Cyc_Arg_String_spec_struct
_tmp908;struct Cyc_Arg_String_spec_struct*_tmp907;const char*_tmp906;const char*
_tmp905;struct _tuple22*_tmp904;const char*_tmp903;struct Cyc_Arg_Set_spec_struct
_tmp902;struct Cyc_Arg_Set_spec_struct*_tmp901;const char*_tmp900;const char*
_tmp8FF;struct _tuple22*_tmp8FE;const char*_tmp8FD;struct Cyc_Arg_Set_spec_struct
_tmp8FC;struct Cyc_Arg_Set_spec_struct*_tmp8FB;const char*_tmp8FA;const char*
_tmp8F9;struct _tuple22*_tmp8F8;const char*_tmp8F7;struct Cyc_Arg_Set_spec_struct
_tmp8F6;struct Cyc_Arg_Set_spec_struct*_tmp8F5;const char*_tmp8F4;const char*
_tmp8F3;struct _tuple22*_tmp8F2;const char*_tmp8F1;struct Cyc_Arg_Set_spec_struct
_tmp8F0;struct Cyc_Arg_Set_spec_struct*_tmp8EF;const char*_tmp8EE;const char*
_tmp8ED;struct _tuple22*_tmp8EC;const char*_tmp8EB;struct Cyc_Arg_Set_spec_struct
_tmp8EA;struct Cyc_Arg_Set_spec_struct*_tmp8E9;const char*_tmp8E8;const char*
_tmp8E7;struct _tuple22*_tmp8E6;const char*_tmp8E5;struct Cyc_Arg_Set_spec_struct
_tmp8E4;struct Cyc_Arg_Set_spec_struct*_tmp8E3;const char*_tmp8E2;const char*
_tmp8E1;struct _tuple22*_tmp8E0;const char*_tmp8DF;struct Cyc_Arg_Set_spec_struct
_tmp8DE;struct Cyc_Arg_Set_spec_struct*_tmp8DD;const char*_tmp8DC;const char*
_tmp8DB;struct _tuple22*_tmp8DA;const char*_tmp8D9;struct Cyc_Arg_Set_spec_struct
_tmp8D8;struct Cyc_Arg_Set_spec_struct*_tmp8D7;const char*_tmp8D6;const char*
_tmp8D5;struct _tuple22*_tmp8D4;const char*_tmp8D3;struct Cyc_Arg_Unit_spec_struct
_tmp8D2;struct Cyc_Arg_Unit_spec_struct*_tmp8D1;const char*_tmp8D0;const char*
_tmp8CF;struct _tuple22*_tmp8CE;const char*_tmp8CD;struct Cyc_Arg_Unit_spec_struct
_tmp8CC;struct Cyc_Arg_Unit_spec_struct*_tmp8CB;const char*_tmp8CA;const char*
_tmp8C9;struct _tuple22*_tmp8C8;const char*_tmp8C7;struct Cyc_Arg_String_spec_struct
_tmp8C6;struct Cyc_Arg_String_spec_struct*_tmp8C5;const char*_tmp8C4;const char*
_tmp8C3;struct _tuple22*_tmp8C2;const char*_tmp8C1;struct Cyc_Arg_Unit_spec_struct
_tmp8C0;struct Cyc_Arg_Unit_spec_struct*_tmp8BF;const char*_tmp8BE;const char*
_tmp8BD;struct _tuple22*_tmp8BC;const char*_tmp8BB;struct Cyc_Arg_Unit_spec_struct
_tmp8BA;struct Cyc_Arg_Unit_spec_struct*_tmp8B9;const char*_tmp8B8;const char*
_tmp8B7;struct _tuple22*_tmp8B6;const char*_tmp8B5;struct Cyc_Arg_Unit_spec_struct
_tmp8B4;struct Cyc_Arg_Unit_spec_struct*_tmp8B3;const char*_tmp8B2;const char*
_tmp8B1;struct _tuple22*_tmp8B0;const char*_tmp8AF;struct Cyc_Arg_Unit_spec_struct
_tmp8AE;struct Cyc_Arg_Unit_spec_struct*_tmp8AD;const char*_tmp8AC;const char*
_tmp8AB;struct _tuple22*_tmp8AA;const char*_tmp8A9;struct Cyc_Arg_Unit_spec_struct
_tmp8A8;struct Cyc_Arg_Unit_spec_struct*_tmp8A7;const char*_tmp8A6;const char*
_tmp8A5;struct _tuple22*_tmp8A4;const char*_tmp8A3;struct Cyc_Arg_Set_spec_struct
_tmp8A2;struct Cyc_Arg_Set_spec_struct*_tmp8A1;const char*_tmp8A0;const char*
_tmp89F;struct _tuple22*_tmp89E;const char*_tmp89D;struct Cyc_Arg_Unit_spec_struct
_tmp89C;struct Cyc_Arg_Unit_spec_struct*_tmp89B;const char*_tmp89A;const char*
_tmp899;struct _tuple22*_tmp898;const char*_tmp897;struct Cyc_Arg_String_spec_struct
_tmp896;struct Cyc_Arg_String_spec_struct*_tmp895;const char*_tmp894;const char*
_tmp893;struct _tuple22*_tmp892;const char*_tmp891;struct Cyc_Arg_Unit_spec_struct
_tmp890;struct Cyc_Arg_Unit_spec_struct*_tmp88F;const char*_tmp88E;const char*
_tmp88D;struct _tuple22*_tmp88C;const char*_tmp88B;struct Cyc_Arg_Set_spec_struct
_tmp88A;struct Cyc_Arg_Set_spec_struct*_tmp889;const char*_tmp888;const char*
_tmp887;struct _tuple22*_tmp886;const char*_tmp885;struct Cyc_Arg_Clear_spec_struct
_tmp884;struct Cyc_Arg_Clear_spec_struct*_tmp883;const char*_tmp882;const char*
_tmp881;struct _tuple22*_tmp880;const char*_tmp87F;struct Cyc_Arg_Set_spec_struct
_tmp87E;struct Cyc_Arg_Set_spec_struct*_tmp87D;const char*_tmp87C;const char*
_tmp87B;struct _tuple22*_tmp87A;const char*_tmp879;struct Cyc_Arg_Set_spec_struct
_tmp878;struct Cyc_Arg_Set_spec_struct*_tmp877;const char*_tmp876;const char*
_tmp875;struct _tuple22*_tmp874;const char*_tmp873;struct Cyc_Arg_Set_spec_struct
_tmp872;struct Cyc_Arg_Set_spec_struct*_tmp871;const char*_tmp870;const char*
_tmp86F;struct _tuple22*_tmp86E;const char*_tmp86D;struct Cyc_Arg_Set_spec_struct
_tmp86C;struct Cyc_Arg_Set_spec_struct*_tmp86B;const char*_tmp86A;const char*
_tmp869;struct _tuple22*_tmp868;const char*_tmp867;struct Cyc_Arg_Set_spec_struct
_tmp866;struct Cyc_Arg_Set_spec_struct*_tmp865;const char*_tmp864;const char*
_tmp863;struct _tuple22*_tmp862;const char*_tmp861;struct Cyc_Arg_Set_spec_struct
_tmp860;struct Cyc_Arg_Set_spec_struct*_tmp85F;const char*_tmp85E;const char*
_tmp85D;struct _tuple22*_tmp85C;const char*_tmp85B;struct Cyc_Arg_Set_spec_struct
_tmp85A;struct Cyc_Arg_Set_spec_struct*_tmp859;const char*_tmp858;const char*
_tmp857;struct _tuple22*_tmp856;const char*_tmp855;struct Cyc_Arg_Set_spec_struct
_tmp854;struct Cyc_Arg_Set_spec_struct*_tmp853;const char*_tmp852;const char*
_tmp851;struct _tuple22*_tmp850;const char*_tmp84F;struct Cyc_Arg_Unit_spec_struct
_tmp84E;struct Cyc_Arg_Unit_spec_struct*_tmp84D;const char*_tmp84C;const char*
_tmp84B;struct _tuple22*_tmp84A;const char*_tmp849;struct Cyc_Arg_String_spec_struct
_tmp848;struct Cyc_Arg_String_spec_struct*_tmp847;const char*_tmp846;const char*
_tmp845;struct _tuple22*_tmp844;const char*_tmp843;struct Cyc_Arg_String_spec_struct
_tmp842;struct Cyc_Arg_String_spec_struct*_tmp841;const char*_tmp840;const char*
_tmp83F;struct _tuple22*_tmp83E;const char*_tmp83D;struct Cyc_Arg_Flag_spec_struct
_tmp83C;struct Cyc_Arg_Flag_spec_struct*_tmp83B;const char*_tmp83A;const char*
_tmp839;struct _tuple22*_tmp838;const char*_tmp837;struct Cyc_Arg_Unit_spec_struct
_tmp836;struct Cyc_Arg_Unit_spec_struct*_tmp835;const char*_tmp834;const char*
_tmp833;struct _tuple22*_tmp832;const char*_tmp831;struct Cyc_Arg_Unit_spec_struct
_tmp830;struct Cyc_Arg_Unit_spec_struct*_tmp82F;const char*_tmp82E;const char*
_tmp82D;struct _tuple22*_tmp82C;const char*_tmp82B;struct Cyc_Arg_Unit_spec_struct
_tmp82A;struct Cyc_Arg_Unit_spec_struct*_tmp829;const char*_tmp828;const char*
_tmp827;struct _tuple22*_tmp826;const char*_tmp825;struct Cyc_Arg_Unit_spec_struct
_tmp824;struct Cyc_Arg_Unit_spec_struct*_tmp823;const char*_tmp822;const char*
_tmp821;struct _tuple22*_tmp820;const char*_tmp81F;struct Cyc_Arg_Flag_spec_struct
_tmp81E;struct Cyc_Arg_Flag_spec_struct*_tmp81D;const char*_tmp81C;const char*
_tmp81B;struct _tuple22*_tmp81A;const char*_tmp819;struct Cyc_Arg_Flag_spec_struct
_tmp818;struct Cyc_Arg_Flag_spec_struct*_tmp817;const char*_tmp816;const char*
_tmp815;struct _tuple22*_tmp814;const char*_tmp813;struct Cyc_Arg_Flag_spec_struct
_tmp812;struct Cyc_Arg_Flag_spec_struct*_tmp811;const char*_tmp810;const char*
_tmp80F;struct _tuple22*_tmp80E;const char*_tmp80D;struct Cyc_Arg_Flag_spec_struct
_tmp80C;struct Cyc_Arg_Flag_spec_struct*_tmp80B;const char*_tmp80A;const char*
_tmp809;struct _tuple22*_tmp808;const char*_tmp807;struct Cyc_Arg_Flag_spec_struct
_tmp806;struct Cyc_Arg_Flag_spec_struct*_tmp805;const char*_tmp804;const char*
_tmp803;struct _tuple22*_tmp802;const char*_tmp801;struct Cyc_Arg_Flag_spec_struct
_tmp800;struct Cyc_Arg_Flag_spec_struct*_tmp7FF;const char*_tmp7FE;const char*
_tmp7FD;struct _tuple22*_tmp7FC;const char*_tmp7FB;struct Cyc_Arg_Flag_spec_struct
_tmp7FA;struct Cyc_Arg_Flag_spec_struct*_tmp7F9;const char*_tmp7F8;const char*
_tmp7F7;struct _tuple22*_tmp7F6;const char*_tmp7F5;struct Cyc_Arg_Flag_spec_struct
_tmp7F4;struct Cyc_Arg_Flag_spec_struct*_tmp7F3;const char*_tmp7F2;const char*
_tmp7F1;struct _tuple22*_tmp7F0;const char*_tmp7EF;struct Cyc_Arg_String_spec_struct
_tmp7EE;struct Cyc_Arg_String_spec_struct*_tmp7ED;const char*_tmp7EC;const char*
_tmp7EB;struct _tuple22*_tmp7EA;const char*_tmp7E9;struct Cyc_Arg_Unit_spec_struct
_tmp7E8;struct Cyc_Arg_Unit_spec_struct*_tmp7E7;const char*_tmp7E6;const char*
_tmp7E5;struct _tuple22*_tmp7E4;const char*_tmp7E3;struct Cyc_Arg_Flag_spec_struct
_tmp7E2;struct Cyc_Arg_Flag_spec_struct*_tmp7E1;const char*_tmp7E0;const char*
_tmp7DF;struct _tuple22*_tmp7DE;const char*_tmp7DD;struct Cyc_Arg_Flag_spec_struct
_tmp7DC;struct Cyc_Arg_Flag_spec_struct*_tmp7DB;const char*_tmp7DA;const char*
_tmp7D9;struct _tuple22*_tmp7D8;const char*_tmp7D7;struct Cyc_Arg_Flag_spec_struct
_tmp7D6;struct Cyc_Arg_Flag_spec_struct*_tmp7D5;const char*_tmp7D4;const char*
_tmp7D3;struct _tuple22*_tmp7D2;const char*_tmp7D1;struct Cyc_Arg_Flag_spec_struct
_tmp7D0;struct Cyc_Arg_Flag_spec_struct*_tmp7CF;const char*_tmp7CE;const char*
_tmp7CD;struct _tuple22*_tmp7CC;const char*_tmp7CB;struct Cyc_Arg_Flag_spec_struct
_tmp7CA;struct Cyc_Arg_Flag_spec_struct*_tmp7C9;const char*_tmp7C8;const char*
_tmp7C7;struct _tuple22*_tmp7C6;const char*_tmp7C5;struct Cyc_Arg_Flag_spec_struct
_tmp7C4;struct Cyc_Arg_Flag_spec_struct*_tmp7C3;const char*_tmp7C2;const char*
_tmp7C1;struct _tuple22*_tmp7C0;const char*_tmp7BF;struct Cyc_Arg_String_spec_struct
_tmp7BE;struct Cyc_Arg_String_spec_struct*_tmp7BD;const char*_tmp7BC;const char*
_tmp7BB;struct _tuple22*_tmp7BA;const char*_tmp7B9;struct Cyc_Arg_Unit_spec_struct
_tmp7B8;struct Cyc_Arg_Unit_spec_struct*_tmp7B7;const char*_tmp7B6;const char*
_tmp7B5;struct _tuple22*_tmp7B4;const char*_tmp7B3;struct Cyc_Arg_Set_spec_struct
_tmp7B2;struct Cyc_Arg_Set_spec_struct*_tmp7B1;const char*_tmp7B0;const char*
_tmp7AF;struct _tuple22*_tmp7AE[64];struct Cyc_List_List*options=(_tmp7AE[63]=((
_tmp92E=_region_malloc(r,sizeof(*_tmp92E)),((_tmp92E->f1=((_tmp929="-noregions",
_tag_dyneither(_tmp929,sizeof(char),11))),((_tmp92E->f2=0,((_tmp92E->f3=((
_tmp92A="",_tag_dyneither(_tmp92A,sizeof(char),1))),((_tmp92E->f4=(void*)((
_tmp92B=_region_malloc(r,sizeof(*_tmp92B)),((_tmp92B[0]=((_tmp92C.tag=3,((
_tmp92C.f1=& Cyc_Absyn_no_regions,_tmp92C)))),_tmp92B)))),((_tmp92E->f5=((_tmp92D="Generate code that doesn't use regions",
_tag_dyneither(_tmp92D,sizeof(char),39))),_tmp92E)))))))))))),((_tmp7AE[62]=((
_tmp928=_region_malloc(r,sizeof(*_tmp928)),((_tmp928->f1=((_tmp923="-port",
_tag_dyneither(_tmp923,sizeof(char),6))),((_tmp928->f2=0,((_tmp928->f3=((_tmp924="",
_tag_dyneither(_tmp924,sizeof(char),1))),((_tmp928->f4=(void*)((_tmp925=
_region_malloc(r,sizeof(*_tmp925)),((_tmp925[0]=((_tmp926.tag=0,((_tmp926.f1=Cyc_set_port_c_code,
_tmp926)))),_tmp925)))),((_tmp928->f5=((_tmp927="Suggest how to port C code to Cyclone",
_tag_dyneither(_tmp927,sizeof(char),38))),_tmp928)))))))))))),((_tmp7AE[61]=((
_tmp922=_region_malloc(r,sizeof(*_tmp922)),((_tmp922->f1=((_tmp91D="-detailedlocation",
_tag_dyneither(_tmp91D,sizeof(char),18))),((_tmp922->f2=0,((_tmp922->f3=((
_tmp91E="",_tag_dyneither(_tmp91E,sizeof(char),1))),((_tmp922->f4=(void*)((
_tmp91F=_region_malloc(r,sizeof(*_tmp91F)),((_tmp91F[0]=((_tmp920.tag=4,((
_tmp920.f1=& Cyc_Position_use_gcc_style_location,_tmp920)))),_tmp91F)))),((
_tmp922->f5=((_tmp921="Try to give more detailed location information for errors",
_tag_dyneither(_tmp921,sizeof(char),58))),_tmp922)))))))))))),((_tmp7AE[60]=((
_tmp91C=_region_malloc(r,sizeof(*_tmp91C)),((_tmp91C->f1=((_tmp917="-noregister",
_tag_dyneither(_tmp917,sizeof(char),12))),((_tmp91C->f2=0,((_tmp91C->f3=((
_tmp918="",_tag_dyneither(_tmp918,sizeof(char),1))),((_tmp91C->f4=(void*)((
_tmp919=_region_malloc(r,sizeof(*_tmp919)),((_tmp919[0]=((_tmp91A.tag=3,((
_tmp91A.f1=& Cyc_Parse_no_register,_tmp91A)))),_tmp919)))),((_tmp91C->f5=((
_tmp91B="Treat register storage class as public",_tag_dyneither(_tmp91B,sizeof(
char),39))),_tmp91C)))))))))))),((_tmp7AE[59]=((_tmp916=_region_malloc(r,sizeof(*
_tmp916)),((_tmp916->f1=((_tmp911="-warnnullchecks",_tag_dyneither(_tmp911,
sizeof(char),16))),((_tmp916->f2=0,((_tmp916->f3=((_tmp912="",_tag_dyneither(
_tmp912,sizeof(char),1))),((_tmp916->f4=(void*)((_tmp913=_region_malloc(r,
sizeof(*_tmp913)),((_tmp913[0]=((_tmp914.tag=3,((_tmp914.f1=& Cyc_Toc_warn_all_null_deref,
_tmp914)))),_tmp913)))),((_tmp916->f5=((_tmp915="Warn when any null check can't be eliminated",
_tag_dyneither(_tmp915,sizeof(char),45))),_tmp916)))))))))))),((_tmp7AE[58]=((
_tmp910=_region_malloc(r,sizeof(*_tmp910)),((_tmp910->f1=((_tmp90B="-warnboundschecks",
_tag_dyneither(_tmp90B,sizeof(char),18))),((_tmp910->f2=0,((_tmp910->f3=((
_tmp90C="",_tag_dyneither(_tmp90C,sizeof(char),1))),((_tmp910->f4=(void*)((
_tmp90D=_region_malloc(r,sizeof(*_tmp90D)),((_tmp90D[0]=((_tmp90E.tag=3,((
_tmp90E.f1=& Cyc_Toc_warn_bounds_checks,_tmp90E)))),_tmp90D)))),((_tmp910->f5=((
_tmp90F="Warn when bounds checks can't be eliminated",_tag_dyneither(_tmp90F,
sizeof(char),44))),_tmp910)))))))))))),((_tmp7AE[57]=((_tmp90A=_region_malloc(r,
sizeof(*_tmp90A)),((_tmp90A->f1=((_tmp905="-CI",_tag_dyneither(_tmp905,sizeof(
char),4))),((_tmp90A->f2=0,((_tmp90A->f3=((_tmp906=" <file>",_tag_dyneither(
_tmp906,sizeof(char),8))),((_tmp90A->f4=(void*)((_tmp907=_region_malloc(r,
sizeof(*_tmp907)),((_tmp907[0]=((_tmp908.tag=5,((_tmp908.f1=Cyc_set_cyc_include,
_tmp908)))),_tmp907)))),((_tmp90A->f5=((_tmp909="Set cyc_include.h to be <file>",
_tag_dyneither(_tmp909,sizeof(char),31))),_tmp90A)))))))))))),((_tmp7AE[56]=((
_tmp904=_region_malloc(r,sizeof(*_tmp904)),((_tmp904->f1=((_tmp8FF="-nocyc_setjmp",
_tag_dyneither(_tmp8FF,sizeof(char),14))),((_tmp904->f2=0,((_tmp904->f3=((
_tmp900="",_tag_dyneither(_tmp900,sizeof(char),1))),((_tmp904->f4=(void*)((
_tmp901=_region_malloc(r,sizeof(*_tmp901)),((_tmp901[0]=((_tmp902.tag=3,((
_tmp902.f1=& Cyc_nocyc_setjmp_r,_tmp902)))),_tmp901)))),((_tmp904->f5=((_tmp903="Do not use compiler special file cyc_setjmp.h",
_tag_dyneither(_tmp903,sizeof(char),46))),_tmp904)))))))))))),((_tmp7AE[55]=((
_tmp8FE=_region_malloc(r,sizeof(*_tmp8FE)),((_tmp8FE->f1=((_tmp8F9="-printalleffects",
_tag_dyneither(_tmp8F9,sizeof(char),17))),((_tmp8FE->f2=0,((_tmp8FE->f3=((
_tmp8FA="",_tag_dyneither(_tmp8FA,sizeof(char),1))),((_tmp8FE->f4=(void*)((
_tmp8FB=_region_malloc(r,sizeof(*_tmp8FB)),((_tmp8FB[0]=((_tmp8FC.tag=3,((
_tmp8FC.f1=& Cyc_print_all_effects_r,_tmp8FC)))),_tmp8FB)))),((_tmp8FE->f5=((
_tmp8FD="Print effects for functions (type debugging)",_tag_dyneither(_tmp8FD,
sizeof(char),45))),_tmp8FE)))))))))))),((_tmp7AE[54]=((_tmp8F8=_region_malloc(r,
sizeof(*_tmp8F8)),((_tmp8F8->f1=((_tmp8F3="-printfullevars",_tag_dyneither(
_tmp8F3,sizeof(char),16))),((_tmp8F8->f2=0,((_tmp8F8->f3=((_tmp8F4="",
_tag_dyneither(_tmp8F4,sizeof(char),1))),((_tmp8F8->f4=(void*)((_tmp8F5=
_region_malloc(r,sizeof(*_tmp8F5)),((_tmp8F5[0]=((_tmp8F6.tag=3,((_tmp8F6.f1=&
Cyc_print_full_evars_r,_tmp8F6)))),_tmp8F5)))),((_tmp8F8->f5=((_tmp8F7="Print full information for evars (type debugging)",
_tag_dyneither(_tmp8F7,sizeof(char),50))),_tmp8F8)))))))))))),((_tmp7AE[53]=((
_tmp8F2=_region_malloc(r,sizeof(*_tmp8F2)),((_tmp8F2->f1=((_tmp8ED="-printallkinds",
_tag_dyneither(_tmp8ED,sizeof(char),15))),((_tmp8F2->f2=0,((_tmp8F2->f3=((
_tmp8EE="",_tag_dyneither(_tmp8EE,sizeof(char),1))),((_tmp8F2->f4=(void*)((
_tmp8EF=_region_malloc(r,sizeof(*_tmp8EF)),((_tmp8EF[0]=((_tmp8F0.tag=3,((
_tmp8F0.f1=& Cyc_print_all_kinds_r,_tmp8F0)))),_tmp8EF)))),((_tmp8F2->f5=((
_tmp8F1="Always print kinds of type variables",_tag_dyneither(_tmp8F1,sizeof(
char),37))),_tmp8F2)))))))))))),((_tmp7AE[52]=((_tmp8EC=_region_malloc(r,sizeof(*
_tmp8EC)),((_tmp8EC->f1=((_tmp8E7="-printalltvars",_tag_dyneither(_tmp8E7,
sizeof(char),15))),((_tmp8EC->f2=0,((_tmp8EC->f3=((_tmp8E8="",_tag_dyneither(
_tmp8E8,sizeof(char),1))),((_tmp8EC->f4=(void*)((_tmp8E9=_region_malloc(r,
sizeof(*_tmp8E9)),((_tmp8E9[0]=((_tmp8EA.tag=3,((_tmp8EA.f1=& Cyc_print_all_tvars_r,
_tmp8EA)))),_tmp8E9)))),((_tmp8EC->f5=((_tmp8EB="Print all type variables (even implicit default effects)",
_tag_dyneither(_tmp8EB,sizeof(char),57))),_tmp8EC)))))))))))),((_tmp7AE[51]=((
_tmp8E6=_region_malloc(r,sizeof(*_tmp8E6)),((_tmp8E6->f1=((_tmp8E1="-noexpandtypedefs",
_tag_dyneither(_tmp8E1,sizeof(char),18))),((_tmp8E6->f2=0,((_tmp8E6->f3=((
_tmp8E2="",_tag_dyneither(_tmp8E2,sizeof(char),1))),((_tmp8E6->f4=(void*)((
_tmp8E3=_region_malloc(r,sizeof(*_tmp8E3)),((_tmp8E3[0]=((_tmp8E4.tag=3,((
_tmp8E4.f1=& Cyc_noexpand_r,_tmp8E4)))),_tmp8E3)))),((_tmp8E6->f5=((_tmp8E5="Don't expand typedefs in pretty printing",
_tag_dyneither(_tmp8E5,sizeof(char),41))),_tmp8E6)))))))))))),((_tmp7AE[50]=((
_tmp8E0=_region_malloc(r,sizeof(*_tmp8E0)),((_tmp8E0->f1=((_tmp8DB="-noremoveunused",
_tag_dyneither(_tmp8DB,sizeof(char),16))),((_tmp8E0->f2=0,((_tmp8E0->f3=((
_tmp8DC="",_tag_dyneither(_tmp8DC,sizeof(char),1))),((_tmp8E0->f4=(void*)((
_tmp8DD=_region_malloc(r,sizeof(*_tmp8DD)),((_tmp8DD[0]=((_tmp8DE.tag=3,((
_tmp8DE.f1=& Cyc_noshake_r,_tmp8DE)))),_tmp8DD)))),((_tmp8E0->f5=((_tmp8DF="Don't remove externed variables that aren't used",
_tag_dyneither(_tmp8DF,sizeof(char),49))),_tmp8E0)))))))))))),((_tmp7AE[49]=((
_tmp8DA=_region_malloc(r,sizeof(*_tmp8DA)),((_tmp8DA->f1=((_tmp8D5="-nogc",
_tag_dyneither(_tmp8D5,sizeof(char),6))),((_tmp8DA->f2=0,((_tmp8DA->f3=((_tmp8D6="",
_tag_dyneither(_tmp8D6,sizeof(char),1))),((_tmp8DA->f4=(void*)((_tmp8D7=
_region_malloc(r,sizeof(*_tmp8D7)),((_tmp8D7[0]=((_tmp8D8.tag=3,((_tmp8D8.f1=&
Cyc_nogc_r,_tmp8D8)))),_tmp8D7)))),((_tmp8DA->f5=((_tmp8D9="Don't link in the garbage collector",
_tag_dyneither(_tmp8D9,sizeof(char),36))),_tmp8DA)))))))))))),((_tmp7AE[48]=((
_tmp8D4=_region_malloc(r,sizeof(*_tmp8D4)),((_tmp8D4->f1=((_tmp8CF="-nocyc",
_tag_dyneither(_tmp8CF,sizeof(char),7))),((_tmp8D4->f2=0,((_tmp8D4->f3=((_tmp8D0="",
_tag_dyneither(_tmp8D0,sizeof(char),1))),((_tmp8D4->f4=(void*)((_tmp8D1=
_region_malloc(r,sizeof(*_tmp8D1)),((_tmp8D1[0]=((_tmp8D2.tag=0,((_tmp8D2.f1=Cyc_set_nocyc,
_tmp8D2)))),_tmp8D1)))),((_tmp8D4->f5=((_tmp8D3="Don't add implicit namespace Cyc",
_tag_dyneither(_tmp8D3,sizeof(char),33))),_tmp8D4)))))))))))),((_tmp7AE[47]=((
_tmp8CE=_region_malloc(r,sizeof(*_tmp8CE)),((_tmp8CE->f1=((_tmp8C9="-no-cpp-precomp",
_tag_dyneither(_tmp8C9,sizeof(char),16))),((_tmp8CE->f2=0,((_tmp8CE->f3=((
_tmp8CA="",_tag_dyneither(_tmp8CA,sizeof(char),1))),((_tmp8CE->f4=(void*)((
_tmp8CB=_region_malloc(r,sizeof(*_tmp8CB)),((_tmp8CB[0]=((_tmp8CC.tag=0,((
_tmp8CC.f1=Cyc_set_nocppprecomp,_tmp8CC)))),_tmp8CB)))),((_tmp8CE->f5=((_tmp8CD="Don't do smart preprocessing (mac only)",
_tag_dyneither(_tmp8CD,sizeof(char),40))),_tmp8CE)))))))))))),((_tmp7AE[46]=((
_tmp8C8=_region_malloc(r,sizeof(*_tmp8C8)),((_tmp8C8->f1=((_tmp8C3="-use-cpp",
_tag_dyneither(_tmp8C3,sizeof(char),9))),((_tmp8C8->f2=0,((_tmp8C8->f3=((_tmp8C4="<path>",
_tag_dyneither(_tmp8C4,sizeof(char),7))),((_tmp8C8->f4=(void*)((_tmp8C5=
_region_malloc(r,sizeof(*_tmp8C5)),((_tmp8C5[0]=((_tmp8C6.tag=5,((_tmp8C6.f1=Cyc_set_cpp,
_tmp8C6)))),_tmp8C5)))),((_tmp8C8->f5=((_tmp8C7="Indicate which preprocessor to use",
_tag_dyneither(_tmp8C7,sizeof(char),35))),_tmp8C8)))))))))))),((_tmp7AE[45]=((
_tmp8C2=_region_malloc(r,sizeof(*_tmp8C2)),((_tmp8C2->f1=((_tmp8BD="--inline-checks",
_tag_dyneither(_tmp8BD,sizeof(char),16))),((_tmp8C2->f2=0,((_tmp8C2->f3=((
_tmp8BE="",_tag_dyneither(_tmp8BE,sizeof(char),1))),((_tmp8C2->f4=(void*)((
_tmp8BF=_region_malloc(r,sizeof(*_tmp8BF)),((_tmp8BF[0]=((_tmp8C0.tag=0,((
_tmp8C0.f1=Cyc_set_inline_functions,_tmp8C0)))),_tmp8BF)))),((_tmp8C2->f5=((
_tmp8C1="Inline bounds checks instead of #define",_tag_dyneither(_tmp8C1,sizeof(
char),40))),_tmp8C2)))))))))))),((_tmp7AE[44]=((_tmp8BC=_region_malloc(r,sizeof(*
_tmp8BC)),((_tmp8BC->f1=((_tmp8B7="--noboundschecks",_tag_dyneither(_tmp8B7,
sizeof(char),17))),((_tmp8BC->f2=0,((_tmp8BC->f3=((_tmp8B8="",_tag_dyneither(
_tmp8B8,sizeof(char),1))),((_tmp8BC->f4=(void*)((_tmp8B9=_region_malloc(r,
sizeof(*_tmp8B9)),((_tmp8B9[0]=((_tmp8BA.tag=0,((_tmp8BA.f1=Cyc_set_noboundschecks,
_tmp8BA)))),_tmp8B9)))),((_tmp8BC->f5=((_tmp8BB="Disable bounds checks",
_tag_dyneither(_tmp8BB,sizeof(char),22))),_tmp8BC)))))))))))),((_tmp7AE[43]=((
_tmp8B6=_region_malloc(r,sizeof(*_tmp8B6)),((_tmp8B6->f1=((_tmp8B1="--nonullchecks",
_tag_dyneither(_tmp8B1,sizeof(char),15))),((_tmp8B6->f2=0,((_tmp8B6->f3=((
_tmp8B2="",_tag_dyneither(_tmp8B2,sizeof(char),1))),((_tmp8B6->f4=(void*)((
_tmp8B3=_region_malloc(r,sizeof(*_tmp8B3)),((_tmp8B3[0]=((_tmp8B4.tag=0,((
_tmp8B4.f1=Cyc_set_nonullchecks,_tmp8B4)))),_tmp8B3)))),((_tmp8B6->f5=((_tmp8B5="Disable null checks",
_tag_dyneither(_tmp8B5,sizeof(char),20))),_tmp8B6)))))))))))),((_tmp7AE[42]=((
_tmp8B0=_region_malloc(r,sizeof(*_tmp8B0)),((_tmp8B0->f1=((_tmp8AB="--nochecks",
_tag_dyneither(_tmp8AB,sizeof(char),11))),((_tmp8B0->f2=0,((_tmp8B0->f3=((
_tmp8AC="",_tag_dyneither(_tmp8AC,sizeof(char),1))),((_tmp8B0->f4=(void*)((
_tmp8AD=_region_malloc(r,sizeof(*_tmp8AD)),((_tmp8AD[0]=((_tmp8AE.tag=0,((
_tmp8AE.f1=Cyc_set_nochecks,_tmp8AE)))),_tmp8AD)))),((_tmp8B0->f5=((_tmp8AF="Disable bounds/null checks",
_tag_dyneither(_tmp8AF,sizeof(char),27))),_tmp8B0)))))))))))),((_tmp7AE[41]=((
_tmp8AA=_region_malloc(r,sizeof(*_tmp8AA)),((_tmp8AA->f1=((_tmp8A5="--lineno",
_tag_dyneither(_tmp8A5,sizeof(char),9))),((_tmp8AA->f2=0,((_tmp8AA->f3=((_tmp8A6="",
_tag_dyneither(_tmp8A6,sizeof(char),1))),((_tmp8AA->f4=(void*)((_tmp8A7=
_region_malloc(r,sizeof(*_tmp8A7)),((_tmp8A7[0]=((_tmp8A8.tag=0,((_tmp8A8.f1=Cyc_set_lineno,
_tmp8A8)))),_tmp8A7)))),((_tmp8AA->f5=((_tmp8A9="Generate line numbers for debugging",
_tag_dyneither(_tmp8A9,sizeof(char),36))),_tmp8AA)))))))))))),((_tmp7AE[40]=((
_tmp8A4=_region_malloc(r,sizeof(*_tmp8A4)),((_tmp8A4->f1=((_tmp89F="-save-c",
_tag_dyneither(_tmp89F,sizeof(char),8))),((_tmp8A4->f2=0,((_tmp8A4->f3=((_tmp8A0="",
_tag_dyneither(_tmp8A0,sizeof(char),1))),((_tmp8A4->f4=(void*)((_tmp8A1=
_region_malloc(r,sizeof(*_tmp8A1)),((_tmp8A1[0]=((_tmp8A2.tag=3,((_tmp8A2.f1=&
Cyc_save_c_r,_tmp8A2)))),_tmp8A1)))),((_tmp8A4->f5=((_tmp8A3="Don't delete temporary C files",
_tag_dyneither(_tmp8A3,sizeof(char),31))),_tmp8A4)))))))))))),((_tmp7AE[39]=((
_tmp89E=_region_malloc(r,sizeof(*_tmp89E)),((_tmp89E->f1=((_tmp899="-save-temps",
_tag_dyneither(_tmp899,sizeof(char),12))),((_tmp89E->f2=0,((_tmp89E->f3=((
_tmp89A="",_tag_dyneither(_tmp89A,sizeof(char),1))),((_tmp89E->f4=(void*)((
_tmp89B=_region_malloc(r,sizeof(*_tmp89B)),((_tmp89B[0]=((_tmp89C.tag=0,((
_tmp89C.f1=Cyc_set_save_temps,_tmp89C)))),_tmp89B)))),((_tmp89E->f5=((_tmp89D="Don't delete temporary files",
_tag_dyneither(_tmp89D,sizeof(char),29))),_tmp89E)))))))))))),((_tmp7AE[38]=((
_tmp898=_region_malloc(r,sizeof(*_tmp898)),((_tmp898->f1=((_tmp893="-c-comp",
_tag_dyneither(_tmp893,sizeof(char),8))),((_tmp898->f2=0,((_tmp898->f3=((_tmp894=" <compiler>",
_tag_dyneither(_tmp894,sizeof(char),12))),((_tmp898->f4=(void*)((_tmp895=
_region_malloc(r,sizeof(*_tmp895)),((_tmp895[0]=((_tmp896.tag=5,((_tmp896.f1=Cyc_set_c_compiler,
_tmp896)))),_tmp895)))),((_tmp898->f5=((_tmp897="Produce C output for the given compiler",
_tag_dyneither(_tmp897,sizeof(char),40))),_tmp898)))))))))))),((_tmp7AE[37]=((
_tmp892=_region_malloc(r,sizeof(*_tmp892)),((_tmp892->f1=((_tmp88D="-un-gcc",
_tag_dyneither(_tmp88D,sizeof(char),8))),((_tmp892->f2=0,((_tmp892->f3=((_tmp88E="",
_tag_dyneither(_tmp88E,sizeof(char),1))),((_tmp892->f4=(void*)((_tmp88F=
_region_malloc(r,sizeof(*_tmp88F)),((_tmp88F[0]=((_tmp890.tag=0,((_tmp890.f1=Cyc_set_tovc,
_tmp890)))),_tmp88F)))),((_tmp892->f5=((_tmp891="Avoid gcc extensions in C output (except for attributes)",
_tag_dyneither(_tmp891,sizeof(char),57))),_tmp892)))))))))))),((_tmp7AE[36]=((
_tmp88C=_region_malloc(r,sizeof(*_tmp88C)),((_tmp88C->f1=((_tmp887="-elim-statement-expressions",
_tag_dyneither(_tmp887,sizeof(char),28))),((_tmp88C->f2=0,((_tmp88C->f3=((
_tmp888="",_tag_dyneither(_tmp888,sizeof(char),1))),((_tmp88C->f4=(void*)((
_tmp889=_region_malloc(r,sizeof(*_tmp889)),((_tmp889[0]=((_tmp88A.tag=3,((
_tmp88A.f1=& Cyc_elim_se_r,_tmp88A)))),_tmp889)))),((_tmp88C->f5=((_tmp88B="Avoid statement expressions in C output (implies --inline-checks)",
_tag_dyneither(_tmp88B,sizeof(char),66))),_tmp88C)))))))))))),((_tmp7AE[35]=((
_tmp886=_region_malloc(r,sizeof(*_tmp886)),((_tmp886->f1=((_tmp881="-up",
_tag_dyneither(_tmp881,sizeof(char),4))),((_tmp886->f2=0,((_tmp886->f3=((_tmp882="",
_tag_dyneither(_tmp882,sizeof(char),1))),((_tmp886->f4=(void*)((_tmp883=
_region_malloc(r,sizeof(*_tmp883)),((_tmp883[0]=((_tmp884.tag=4,((_tmp884.f1=&
Cyc_pp_r,_tmp884)))),_tmp883)))),((_tmp886->f5=((_tmp885="Ugly print the C code that Cyclone generates (default)",
_tag_dyneither(_tmp885,sizeof(char),55))),_tmp886)))))))))))),((_tmp7AE[34]=((
_tmp880=_region_malloc(r,sizeof(*_tmp880)),((_tmp880->f1=((_tmp87B="-pp",
_tag_dyneither(_tmp87B,sizeof(char),4))),((_tmp880->f2=0,((_tmp880->f3=((_tmp87C="",
_tag_dyneither(_tmp87C,sizeof(char),1))),((_tmp880->f4=(void*)((_tmp87D=
_region_malloc(r,sizeof(*_tmp87D)),((_tmp87D[0]=((_tmp87E.tag=3,((_tmp87E.f1=&
Cyc_pp_r,_tmp87E)))),_tmp87D)))),((_tmp880->f5=((_tmp87F="Pretty print the C code that Cyclone generates",
_tag_dyneither(_tmp87F,sizeof(char),47))),_tmp880)))))))))))),((_tmp7AE[33]=((
_tmp87A=_region_malloc(r,sizeof(*_tmp87A)),((_tmp87A->f1=((_tmp875="-ic",
_tag_dyneither(_tmp875,sizeof(char),4))),((_tmp87A->f2=0,((_tmp87A->f3=((_tmp876="",
_tag_dyneither(_tmp876,sizeof(char),1))),((_tmp87A->f4=(void*)((_tmp877=
_region_malloc(r,sizeof(*_tmp877)),((_tmp877[0]=((_tmp878.tag=3,((_tmp878.f1=&
Cyc_ic_r,_tmp878)))),_tmp877)))),((_tmp87A->f5=((_tmp879="Activate the link-checker",
_tag_dyneither(_tmp879,sizeof(char),26))),_tmp87A)))))))))))),((_tmp7AE[32]=((
_tmp874=_region_malloc(r,sizeof(*_tmp874)),((_tmp874->f1=((_tmp86F="-stopafter-toc",
_tag_dyneither(_tmp86F,sizeof(char),15))),((_tmp874->f2=0,((_tmp874->f3=((
_tmp870="",_tag_dyneither(_tmp870,sizeof(char),1))),((_tmp874->f4=(void*)((
_tmp871=_region_malloc(r,sizeof(*_tmp871)),((_tmp871[0]=((_tmp872.tag=3,((
_tmp872.f1=& Cyc_toc_r,_tmp872)))),_tmp871)))),((_tmp874->f5=((_tmp873="Stop after translation to C",
_tag_dyneither(_tmp873,sizeof(char),28))),_tmp874)))))))))))),((_tmp7AE[31]=((
_tmp86E=_region_malloc(r,sizeof(*_tmp86E)),((_tmp86E->f1=((_tmp869="-stopafter-cf",
_tag_dyneither(_tmp869,sizeof(char),14))),((_tmp86E->f2=0,((_tmp86E->f3=((
_tmp86A="",_tag_dyneither(_tmp86A,sizeof(char),1))),((_tmp86E->f4=(void*)((
_tmp86B=_region_malloc(r,sizeof(*_tmp86B)),((_tmp86B[0]=((_tmp86C.tag=3,((
_tmp86C.f1=& Cyc_cf_r,_tmp86C)))),_tmp86B)))),((_tmp86E->f5=((_tmp86D="Stop after control-flow checking",
_tag_dyneither(_tmp86D,sizeof(char),33))),_tmp86E)))))))))))),((_tmp7AE[30]=((
_tmp868=_region_malloc(r,sizeof(*_tmp868)),((_tmp868->f1=((_tmp863="-noprint",
_tag_dyneither(_tmp863,sizeof(char),9))),((_tmp868->f2=0,((_tmp868->f3=((_tmp864="",
_tag_dyneither(_tmp864,sizeof(char),1))),((_tmp868->f4=(void*)((_tmp865=
_region_malloc(r,sizeof(*_tmp865)),((_tmp865[0]=((_tmp866.tag=3,((_tmp866.f1=&
Cyc_noprint_r,_tmp866)))),_tmp865)))),((_tmp868->f5=((_tmp867="Do not print output (when stopping early)",
_tag_dyneither(_tmp867,sizeof(char),42))),_tmp868)))))))))))),((_tmp7AE[29]=((
_tmp862=_region_malloc(r,sizeof(*_tmp862)),((_tmp862->f1=((_tmp85D="-stopafter-tc",
_tag_dyneither(_tmp85D,sizeof(char),14))),((_tmp862->f2=0,((_tmp862->f3=((
_tmp85E="",_tag_dyneither(_tmp85E,sizeof(char),1))),((_tmp862->f4=(void*)((
_tmp85F=_region_malloc(r,sizeof(*_tmp85F)),((_tmp85F[0]=((_tmp860.tag=3,((
_tmp860.f1=& Cyc_tc_r,_tmp860)))),_tmp85F)))),((_tmp862->f5=((_tmp861="Stop after type checking",
_tag_dyneither(_tmp861,sizeof(char),25))),_tmp862)))))))))))),((_tmp7AE[28]=((
_tmp85C=_region_malloc(r,sizeof(*_tmp85C)),((_tmp85C->f1=((_tmp857="-stopafter-parse",
_tag_dyneither(_tmp857,sizeof(char),17))),((_tmp85C->f2=0,((_tmp85C->f3=((
_tmp858="",_tag_dyneither(_tmp858,sizeof(char),1))),((_tmp85C->f4=(void*)((
_tmp859=_region_malloc(r,sizeof(*_tmp859)),((_tmp859[0]=((_tmp85A.tag=3,((
_tmp85A.f1=& Cyc_parseonly_r,_tmp85A)))),_tmp859)))),((_tmp85C->f5=((_tmp85B="Stop after parsing",
_tag_dyneither(_tmp85B,sizeof(char),19))),_tmp85C)))))))))))),((_tmp7AE[27]=((
_tmp856=_region_malloc(r,sizeof(*_tmp856)),((_tmp856->f1=((_tmp851="-E",
_tag_dyneither(_tmp851,sizeof(char),3))),((_tmp856->f2=0,((_tmp856->f3=((_tmp852="",
_tag_dyneither(_tmp852,sizeof(char),1))),((_tmp856->f4=(void*)((_tmp853=
_region_malloc(r,sizeof(*_tmp853)),((_tmp853[0]=((_tmp854.tag=3,((_tmp854.f1=&
Cyc_stop_after_cpp_r,_tmp854)))),_tmp853)))),((_tmp856->f5=((_tmp855="Stop after preprocessing",
_tag_dyneither(_tmp855,sizeof(char),25))),_tmp856)))))))))))),((_tmp7AE[26]=((
_tmp850=_region_malloc(r,sizeof(*_tmp850)),((_tmp850->f1=((_tmp84B="-Wall",
_tag_dyneither(_tmp84B,sizeof(char),6))),((_tmp850->f2=0,((_tmp850->f3=((_tmp84C="",
_tag_dyneither(_tmp84C,sizeof(char),1))),((_tmp850->f4=(void*)((_tmp84D=
_region_malloc(r,sizeof(*_tmp84D)),((_tmp84D[0]=((_tmp84E.tag=0,((_tmp84E.f1=Cyc_set_all_warnings,
_tmp84E)))),_tmp84D)))),((_tmp850->f5=((_tmp84F="Turn on all warnings",
_tag_dyneither(_tmp84F,sizeof(char),21))),_tmp850)))))))))))),((_tmp7AE[25]=((
_tmp84A=_region_malloc(r,sizeof(*_tmp84A)),((_tmp84A->f1=((_tmp845="-b",
_tag_dyneither(_tmp845,sizeof(char),3))),((_tmp84A->f2=0,((_tmp84A->f3=((_tmp846="<arch>",
_tag_dyneither(_tmp846,sizeof(char),7))),((_tmp84A->f4=(void*)((_tmp847=
_region_malloc(r,sizeof(*_tmp847)),((_tmp847[0]=((_tmp848.tag=5,((_tmp848.f1=Cyc_set_target_arch,
_tmp848)))),_tmp847)))),((_tmp84A->f5=((_tmp849="Set target architecture; implies -stopafter-toc",
_tag_dyneither(_tmp849,sizeof(char),48))),_tmp84A)))))))))))),((_tmp7AE[24]=((
_tmp844=_region_malloc(r,sizeof(*_tmp844)),((_tmp844->f1=((_tmp83F="-MT",
_tag_dyneither(_tmp83F,sizeof(char),4))),((_tmp844->f2=0,((_tmp844->f3=((_tmp840=" <target>",
_tag_dyneither(_tmp840,sizeof(char),10))),((_tmp844->f4=(void*)((_tmp841=
_region_malloc(r,sizeof(*_tmp841)),((_tmp841[0]=((_tmp842.tag=5,((_tmp842.f1=Cyc_set_dependencies_target,
_tmp842)))),_tmp841)))),((_tmp844->f5=((_tmp843="Give target for dependencies",
_tag_dyneither(_tmp843,sizeof(char),29))),_tmp844)))))))))))),((_tmp7AE[23]=((
_tmp83E=_region_malloc(r,sizeof(*_tmp83E)),((_tmp83E->f1=((_tmp839="-MG",
_tag_dyneither(_tmp839,sizeof(char),4))),((_tmp83E->f2=0,((_tmp83E->f3=((_tmp83A="",
_tag_dyneither(_tmp83A,sizeof(char),1))),((_tmp83E->f4=(void*)((_tmp83B=
_region_malloc(r,sizeof(*_tmp83B)),((_tmp83B[0]=((_tmp83C.tag=1,((_tmp83C.f1=Cyc_add_cpparg,
_tmp83C)))),_tmp83B)))),((_tmp83E->f5=((_tmp83D="When producing dependencies assume that missing files are generated",
_tag_dyneither(_tmp83D,sizeof(char),68))),_tmp83E)))))))))))),((_tmp7AE[22]=((
_tmp838=_region_malloc(r,sizeof(*_tmp838)),((_tmp838->f1=((_tmp833="-M",
_tag_dyneither(_tmp833,sizeof(char),3))),((_tmp838->f2=0,((_tmp838->f3=((_tmp834="",
_tag_dyneither(_tmp834,sizeof(char),1))),((_tmp838->f4=(void*)((_tmp835=
_region_malloc(r,sizeof(*_tmp835)),((_tmp835[0]=((_tmp836.tag=0,((_tmp836.f1=Cyc_set_produce_dependencies,
_tmp836)))),_tmp835)))),((_tmp838->f5=((_tmp837="Produce dependencies",
_tag_dyneither(_tmp837,sizeof(char),21))),_tmp838)))))))))))),((_tmp7AE[21]=((
_tmp832=_region_malloc(r,sizeof(*_tmp832)),((_tmp832->f1=((_tmp82D="-S",
_tag_dyneither(_tmp82D,sizeof(char),3))),((_tmp832->f2=0,((_tmp832->f3=((_tmp82E="",
_tag_dyneither(_tmp82E,sizeof(char),1))),((_tmp832->f4=(void*)((_tmp82F=
_region_malloc(r,sizeof(*_tmp82F)),((_tmp82F[0]=((_tmp830.tag=0,((_tmp830.f1=Cyc_set_stop_after_asmfile,
_tmp830)))),_tmp82F)))),((_tmp832->f5=((_tmp831="Stop after producing assembly code",
_tag_dyneither(_tmp831,sizeof(char),35))),_tmp832)))))))))))),((_tmp7AE[20]=((
_tmp82C=_region_malloc(r,sizeof(*_tmp82C)),((_tmp82C->f1=((_tmp827="-pa",
_tag_dyneither(_tmp827,sizeof(char),4))),((_tmp82C->f2=0,((_tmp82C->f3=((_tmp828="",
_tag_dyneither(_tmp828,sizeof(char),1))),((_tmp82C->f4=(void*)((_tmp829=
_region_malloc(r,sizeof(*_tmp829)),((_tmp829[0]=((_tmp82A.tag=0,((_tmp82A.f1=Cyc_set_pa,
_tmp82A)))),_tmp829)))),((_tmp82C->f5=((_tmp82B="Compile for profiling with aprof",
_tag_dyneither(_tmp82B,sizeof(char),33))),_tmp82C)))))))))))),((_tmp7AE[19]=((
_tmp826=_region_malloc(r,sizeof(*_tmp826)),((_tmp826->f1=((_tmp821="-pg",
_tag_dyneither(_tmp821,sizeof(char),4))),((_tmp826->f2=0,((_tmp826->f3=((_tmp822="",
_tag_dyneither(_tmp822,sizeof(char),1))),((_tmp826->f4=(void*)((_tmp823=
_region_malloc(r,sizeof(*_tmp823)),((_tmp823[0]=((_tmp824.tag=0,((_tmp824.f1=Cyc_set_pg,
_tmp824)))),_tmp823)))),((_tmp826->f5=((_tmp825="Compile for profiling with gprof",
_tag_dyneither(_tmp825,sizeof(char),33))),_tmp826)))))))))))),((_tmp7AE[18]=((
_tmp820=_region_malloc(r,sizeof(*_tmp820)),((_tmp820->f1=((_tmp81B="-p",
_tag_dyneither(_tmp81B,sizeof(char),3))),((_tmp820->f2=0,((_tmp820->f3=((_tmp81C="",
_tag_dyneither(_tmp81C,sizeof(char),1))),((_tmp820->f4=(void*)((_tmp81D=
_region_malloc(r,sizeof(*_tmp81D)),((_tmp81D[0]=((_tmp81E.tag=1,((_tmp81E.f1=Cyc_add_ccarg,
_tmp81E)))),_tmp81D)))),((_tmp820->f5=((_tmp81F="Compile for profiling with prof",
_tag_dyneither(_tmp81F,sizeof(char),32))),_tmp820)))))))))))),((_tmp7AE[17]=((
_tmp81A=_region_malloc(r,sizeof(*_tmp81A)),((_tmp81A->f1=((_tmp815="-g",
_tag_dyneither(_tmp815,sizeof(char),3))),((_tmp81A->f2=0,((_tmp81A->f3=((_tmp816="",
_tag_dyneither(_tmp816,sizeof(char),1))),((_tmp81A->f4=(void*)((_tmp817=
_region_malloc(r,sizeof(*_tmp817)),((_tmp817[0]=((_tmp818.tag=1,((_tmp818.f1=Cyc_add_ccarg,
_tmp818)))),_tmp817)))),((_tmp81A->f5=((_tmp819="Compile for debugging",
_tag_dyneither(_tmp819,sizeof(char),22))),_tmp81A)))))))))))),((_tmp7AE[16]=((
_tmp814=_region_malloc(r,sizeof(*_tmp814)),((_tmp814->f1=((_tmp80F="-fomit-frame-pointer",
_tag_dyneither(_tmp80F,sizeof(char),21))),((_tmp814->f2=0,((_tmp814->f3=((
_tmp810="",_tag_dyneither(_tmp810,sizeof(char),1))),((_tmp814->f4=(void*)((
_tmp811=_region_malloc(r,sizeof(*_tmp811)),((_tmp811[0]=((_tmp812.tag=1,((
_tmp812.f1=Cyc_add_ccarg,_tmp812)))),_tmp811)))),((_tmp814->f5=((_tmp813="Omit frame pointer",
_tag_dyneither(_tmp813,sizeof(char),19))),_tmp814)))))))))))),((_tmp7AE[15]=((
_tmp80E=_region_malloc(r,sizeof(*_tmp80E)),((_tmp80E->f1=((_tmp809="-O3",
_tag_dyneither(_tmp809,sizeof(char),4))),((_tmp80E->f2=0,((_tmp80E->f3=((_tmp80A="",
_tag_dyneither(_tmp80A,sizeof(char),1))),((_tmp80E->f4=(void*)((_tmp80B=
_region_malloc(r,sizeof(*_tmp80B)),((_tmp80B[0]=((_tmp80C.tag=1,((_tmp80C.f1=Cyc_add_ccarg,
_tmp80C)))),_tmp80B)))),((_tmp80E->f5=((_tmp80D="Even more optimization",
_tag_dyneither(_tmp80D,sizeof(char),23))),_tmp80E)))))))))))),((_tmp7AE[14]=((
_tmp808=_region_malloc(r,sizeof(*_tmp808)),((_tmp808->f1=((_tmp803="-O2",
_tag_dyneither(_tmp803,sizeof(char),4))),((_tmp808->f2=0,((_tmp808->f3=((_tmp804="",
_tag_dyneither(_tmp804,sizeof(char),1))),((_tmp808->f4=(void*)((_tmp805=
_region_malloc(r,sizeof(*_tmp805)),((_tmp805[0]=((_tmp806.tag=1,((_tmp806.f1=Cyc_add_ccarg,
_tmp806)))),_tmp805)))),((_tmp808->f5=((_tmp807="A higher level of optimization",
_tag_dyneither(_tmp807,sizeof(char),31))),_tmp808)))))))))))),((_tmp7AE[13]=((
_tmp802=_region_malloc(r,sizeof(*_tmp802)),((_tmp802->f1=((_tmp7FD="-O",
_tag_dyneither(_tmp7FD,sizeof(char),3))),((_tmp802->f2=0,((_tmp802->f3=((_tmp7FE="",
_tag_dyneither(_tmp7FE,sizeof(char),1))),((_tmp802->f4=(void*)((_tmp7FF=
_region_malloc(r,sizeof(*_tmp7FF)),((_tmp7FF[0]=((_tmp800.tag=1,((_tmp800.f1=Cyc_add_ccarg,
_tmp800)))),_tmp7FF)))),((_tmp802->f5=((_tmp801="Optimize",_tag_dyneither(
_tmp801,sizeof(char),9))),_tmp802)))))))))))),((_tmp7AE[12]=((_tmp7FC=
_region_malloc(r,sizeof(*_tmp7FC)),((_tmp7FC->f1=((_tmp7F7="-O0",_tag_dyneither(
_tmp7F7,sizeof(char),4))),((_tmp7FC->f2=0,((_tmp7FC->f3=((_tmp7F8="",
_tag_dyneither(_tmp7F8,sizeof(char),1))),((_tmp7FC->f4=(void*)((_tmp7F9=
_region_malloc(r,sizeof(*_tmp7F9)),((_tmp7F9[0]=((_tmp7FA.tag=1,((_tmp7FA.f1=Cyc_add_ccarg,
_tmp7FA)))),_tmp7F9)))),((_tmp7FC->f5=((_tmp7FB="Don't optimize",_tag_dyneither(
_tmp7FB,sizeof(char),15))),_tmp7FC)))))))))))),((_tmp7AE[11]=((_tmp7F6=
_region_malloc(r,sizeof(*_tmp7F6)),((_tmp7F6->f1=((_tmp7F1="-s",_tag_dyneither(
_tmp7F1,sizeof(char),3))),((_tmp7F6->f2=0,((_tmp7F6->f3=((_tmp7F2="",
_tag_dyneither(_tmp7F2,sizeof(char),1))),((_tmp7F6->f4=(void*)((_tmp7F3=
_region_malloc(r,sizeof(*_tmp7F3)),((_tmp7F3[0]=((_tmp7F4.tag=1,((_tmp7F4.f1=Cyc_add_ccarg,
_tmp7F4)))),_tmp7F3)))),((_tmp7F6->f5=((_tmp7F5="Remove all symbol table and relocation info from executable",
_tag_dyneither(_tmp7F5,sizeof(char),60))),_tmp7F6)))))))))))),((_tmp7AE[10]=((
_tmp7F0=_region_malloc(r,sizeof(*_tmp7F0)),((_tmp7F0->f1=((_tmp7EB="-x",
_tag_dyneither(_tmp7EB,sizeof(char),3))),((_tmp7F0->f2=0,((_tmp7F0->f3=((_tmp7EC=" <language>",
_tag_dyneither(_tmp7EC,sizeof(char),12))),((_tmp7F0->f4=(void*)((_tmp7ED=
_region_malloc(r,sizeof(*_tmp7ED)),((_tmp7ED[0]=((_tmp7EE.tag=5,((_tmp7EE.f1=Cyc_set_inputtype,
_tmp7EE)))),_tmp7ED)))),((_tmp7F0->f5=((_tmp7EF="Specify <language> for the following input files",
_tag_dyneither(_tmp7EF,sizeof(char),49))),_tmp7F0)))))))))))),((_tmp7AE[9]=((
_tmp7EA=_region_malloc(r,sizeof(*_tmp7EA)),((_tmp7EA->f1=((_tmp7E5="-c",
_tag_dyneither(_tmp7E5,sizeof(char),3))),((_tmp7EA->f2=0,((_tmp7EA->f3=((_tmp7E6="",
_tag_dyneither(_tmp7E6,sizeof(char),1))),((_tmp7EA->f4=(void*)((_tmp7E7=
_region_malloc(r,sizeof(*_tmp7E7)),((_tmp7E7[0]=((_tmp7E8.tag=0,((_tmp7E8.f1=Cyc_set_stop_after_objectfile,
_tmp7E8)))),_tmp7E7)))),((_tmp7EA->f5=((_tmp7E9="Produce an object file instead of an executable; do not link",
_tag_dyneither(_tmp7E9,sizeof(char),61))),_tmp7EA)))))))))))),((_tmp7AE[8]=((
_tmp7E4=_region_malloc(r,sizeof(*_tmp7E4)),((_tmp7E4->f1=((_tmp7DF="-m",
_tag_dyneither(_tmp7DF,sizeof(char),3))),((_tmp7E4->f2=1,((_tmp7E4->f3=((_tmp7E0="<option>",
_tag_dyneither(_tmp7E0,sizeof(char),9))),((_tmp7E4->f4=(void*)((_tmp7E1=
_region_malloc(r,sizeof(*_tmp7E1)),((_tmp7E1[0]=((_tmp7E2.tag=1,((_tmp7E2.f1=Cyc_add_marg,
_tmp7E2)))),_tmp7E1)))),((_tmp7E4->f5=((_tmp7E3="GCC specific: pass machine-dependent flag on to gcc",
_tag_dyneither(_tmp7E3,sizeof(char),52))),_tmp7E4)))))))))))),((_tmp7AE[7]=((
_tmp7DE=_region_malloc(r,sizeof(*_tmp7DE)),((_tmp7DE->f1=((_tmp7D9="-l",
_tag_dyneither(_tmp7D9,sizeof(char),3))),((_tmp7DE->f2=1,((_tmp7DE->f3=((_tmp7DA="<libname>",
_tag_dyneither(_tmp7DA,sizeof(char),10))),((_tmp7DE->f4=(void*)((_tmp7DB=
_region_malloc(r,sizeof(*_tmp7DB)),((_tmp7DB[0]=((_tmp7DC.tag=1,((_tmp7DC.f1=Cyc_add_libarg,
_tmp7DC)))),_tmp7DB)))),((_tmp7DE->f5=((_tmp7DD="Library file",_tag_dyneither(
_tmp7DD,sizeof(char),13))),_tmp7DE)))))))))))),((_tmp7AE[6]=((_tmp7D8=
_region_malloc(r,sizeof(*_tmp7D8)),((_tmp7D8->f1=((_tmp7D3="-L",_tag_dyneither(
_tmp7D3,sizeof(char),3))),((_tmp7D8->f2=1,((_tmp7D8->f3=((_tmp7D4="<dir>",
_tag_dyneither(_tmp7D4,sizeof(char),6))),((_tmp7D8->f4=(void*)((_tmp7D5=
_region_malloc(r,sizeof(*_tmp7D5)),((_tmp7D5[0]=((_tmp7D6.tag=1,((_tmp7D6.f1=Cyc_add_ccarg,
_tmp7D6)))),_tmp7D5)))),((_tmp7D8->f5=((_tmp7D7="Add to the list of directories for -l",
_tag_dyneither(_tmp7D7,sizeof(char),38))),_tmp7D8)))))))))))),((_tmp7AE[5]=((
_tmp7D2=_region_malloc(r,sizeof(*_tmp7D2)),((_tmp7D2->f1=((_tmp7CD="-I",
_tag_dyneither(_tmp7CD,sizeof(char),3))),((_tmp7D2->f2=1,((_tmp7D2->f3=((_tmp7CE="<dir>",
_tag_dyneither(_tmp7CE,sizeof(char),6))),((_tmp7D2->f4=(void*)((_tmp7CF=
_region_malloc(r,sizeof(*_tmp7CF)),((_tmp7CF[0]=((_tmp7D0.tag=1,((_tmp7D0.f1=Cyc_add_cpparg,
_tmp7D0)))),_tmp7CF)))),((_tmp7D2->f5=((_tmp7D1="Add to the list of directories to search for include files",
_tag_dyneither(_tmp7D1,sizeof(char),59))),_tmp7D2)))))))))))),((_tmp7AE[4]=((
_tmp7CC=_region_malloc(r,sizeof(*_tmp7CC)),((_tmp7CC->f1=((_tmp7C7="-B",
_tag_dyneither(_tmp7C7,sizeof(char),3))),((_tmp7CC->f2=1,((_tmp7CC->f3=((_tmp7C8="<file>",
_tag_dyneither(_tmp7C8,sizeof(char),7))),((_tmp7CC->f4=(void*)((_tmp7C9=
_region_malloc(r,sizeof(*_tmp7C9)),((_tmp7C9[0]=((_tmp7CA.tag=1,((_tmp7CA.f1=Cyc_add_cyclone_exec_path,
_tmp7CA)))),_tmp7C9)))),((_tmp7CC->f5=((_tmp7CB="Add to the list of directories to search for compiler files",
_tag_dyneither(_tmp7CB,sizeof(char),60))),_tmp7CC)))))))))))),((_tmp7AE[3]=((
_tmp7C6=_region_malloc(r,sizeof(*_tmp7C6)),((_tmp7C6->f1=((_tmp7C1="-D",
_tag_dyneither(_tmp7C1,sizeof(char),3))),((_tmp7C6->f2=1,((_tmp7C6->f3=((_tmp7C2="<name>[=<value>]",
_tag_dyneither(_tmp7C2,sizeof(char),17))),((_tmp7C6->f4=(void*)((_tmp7C3=
_region_malloc(r,sizeof(*_tmp7C3)),((_tmp7C3[0]=((_tmp7C4.tag=1,((_tmp7C4.f1=Cyc_add_cpparg,
_tmp7C4)))),_tmp7C3)))),((_tmp7C6->f5=((_tmp7C5="Pass definition to preprocessor",
_tag_dyneither(_tmp7C5,sizeof(char),32))),_tmp7C6)))))))))))),((_tmp7AE[2]=((
_tmp7C0=_region_malloc(r,sizeof(*_tmp7C0)),((_tmp7C0->f1=((_tmp7BB="-o",
_tag_dyneither(_tmp7BB,sizeof(char),3))),((_tmp7C0->f2=0,((_tmp7C0->f3=((_tmp7BC=" <file>",
_tag_dyneither(_tmp7BC,sizeof(char),8))),((_tmp7C0->f4=(void*)((_tmp7BD=
_region_malloc(r,sizeof(*_tmp7BD)),((_tmp7BD[0]=((_tmp7BE.tag=5,((_tmp7BE.f1=Cyc_set_output_file,
_tmp7BE)))),_tmp7BD)))),((_tmp7C0->f5=((_tmp7BF="Set the output file name to <file>",
_tag_dyneither(_tmp7BF,sizeof(char),35))),_tmp7C0)))))))))))),((_tmp7AE[1]=((
_tmp7BA=_region_malloc(r,sizeof(*_tmp7BA)),((_tmp7BA->f1=((_tmp7B5="--version",
_tag_dyneither(_tmp7B5,sizeof(char),10))),((_tmp7BA->f2=0,((_tmp7BA->f3=((
_tmp7B6="",_tag_dyneither(_tmp7B6,sizeof(char),1))),((_tmp7BA->f4=(void*)((
_tmp7B7=_region_malloc(r,sizeof(*_tmp7B7)),((_tmp7B7[0]=((_tmp7B8.tag=0,((
_tmp7B8.f1=Cyc_print_version,_tmp7B8)))),_tmp7B7)))),((_tmp7BA->f5=((_tmp7B9="Print version information and exit",
_tag_dyneither(_tmp7B9,sizeof(char),35))),_tmp7BA)))))))))))),((_tmp7AE[0]=((
_tmp7B4=_region_malloc(r,sizeof(*_tmp7B4)),((_tmp7B4->f1=((_tmp7AF="-v",
_tag_dyneither(_tmp7AF,sizeof(char),3))),((_tmp7B4->f2=0,((_tmp7B4->f3=((_tmp7B0="",
_tag_dyneither(_tmp7B0,sizeof(char),1))),((_tmp7B4->f4=(void*)((_tmp7B1=
_region_malloc(r,sizeof(*_tmp7B1)),((_tmp7B1[0]=((_tmp7B2.tag=3,((_tmp7B2.f1=&
Cyc_v_r,_tmp7B2)))),_tmp7B1)))),((_tmp7B4->f5=((_tmp7B3="Print compilation stages verbosely",
_tag_dyneither(_tmp7B3,sizeof(char),35))),_tmp7B4)))))))))))),((struct Cyc_List_List*(*)(
...
_tmp972="empty interface",_tag_dyneither(_tmp972,sizeof(char),16))),((_tmp970->f2=((
_tmp971="global interface",_tag_dyneither(_tmp971,sizeof(char),17))),_tmp970)))))))){{
...
_tmp334;}}}}};_pop_handler();}else{void*_tmp31F=(void*)_exn_thrown;void*_tmp336=
_tmp31F;_LL3B:;_LL3C:{void*_tmp337=_tmp336;struct _dyneither_ptr _tmp339;struct
_dyneither_ptr _tmp33B;struct _dyneither_ptr _tmp33E;_LL40: {struct Cyc_Core_Failure_struct*
...
void)_throw(_tmp336);_LL3A:;}}}{const char*_tmp988;struct _dyneither_ptr
