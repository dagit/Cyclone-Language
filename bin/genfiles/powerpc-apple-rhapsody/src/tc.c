...
_LL4: goto _LL0;_LL5:;_LL6:{const char*_tmp22C;void*_tmp22B[1];struct Cyc_String_pa_struct
_tmp22A;(_tmp22A.tag=0,((_tmp22A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(vd->name)),((_tmp22B[0]=& _tmp22A,Cyc_Tcutil_terr(loc,((
_tmp22C="qualified variable declarations are not implemented (%s)",
_tag_dyneither(_tmp22C,sizeof(char),57))),_tag_dyneither(_tmp22B,sizeof(void*),1)))))));}
return;_LL0:;}{union Cyc_Absyn_Nmspace_union _tmp22D;(*vd->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp22D.Abs_n).tag=2,(((_tmp22D.Abs_n).f1=te->ns,_tmp22D))));}{void*_tmp13=Cyc_Tcutil_compress(
...
== (void*)4){if(_tmpA != 0){const char*_tmp230;void*_tmp22F;(_tmp22F=0,Cyc_Tcutil_terr(
loc,((_tmp230="extern declaration should not have initializer",_tag_dyneither(
_tmp230,sizeof(char),47))),_tag_dyneither(_tmp22F,sizeof(void*),0)));}}else{if(!
...
const char*_tmp235;void*_tmp234[2];struct Cyc_String_pa_struct _tmp233;struct Cyc_String_pa_struct
_tmp232;(_tmp232.tag=0,((_tmp232.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(vd->name)),((_tmp233.tag=0,((_tmp233.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)_tmpB->hd)),((
_tmp234[0]=& _tmp233,((_tmp234[1]=& _tmp232,Cyc_Tcutil_terr(loc,((_tmp235="bad attribute %s for variable %s",
_tag_dyneither(_tmp235,sizeof(char),33))),_tag_dyneither(_tmp234,sizeof(void*),2)))))))))))));}
goto _LL1C;_LL1C:;}if(_tmpA == 0  || ignore_init){if(check_var_init  && !Cyc_Tcutil_supports_default(
_tmp9)){const char*_tmp23A;void*_tmp239[2];struct Cyc_String_pa_struct _tmp238;
struct Cyc_String_pa_struct _tmp237;(_tmp237.tag=0,((_tmp237.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp9)),((_tmp238.tag=
0,((_tmp238.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
vd->name)),((_tmp239[0]=& _tmp238,((_tmp239[1]=& _tmp237,Cyc_Tcutil_terr(loc,((
_tmp23A="initializer required for variable %s of type %s",_tag_dyneither(_tmp23A,
sizeof(char),48))),_tag_dyneither(_tmp239,sizeof(void*),2)))))))))))));}}else{
...
char*_tmp240;void*_tmp23F[3];struct Cyc_String_pa_struct _tmp23E;struct Cyc_String_pa_struct
_tmp23D;struct Cyc_String_pa_struct _tmp23C;(_tmp23C.tag=0,((_tmp23C.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp2D)),((_tmp23D.tag=
0,((_tmp23D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
_tmp9)),((_tmp23E.tag=0,((_tmp23E.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name)),((_tmp23F[0]=& _tmp23E,((
_tmp23F[1]=& _tmp23D,((_tmp23F[2]=& _tmp23C,Cyc_Tcutil_terr(loc,((_tmp240="%s declared with type \n%s\n but initialized with type \n%s",
_tag_dyneither(_tmp240,sizeof(char),57))),_tag_dyneither(_tmp23F,sizeof(void*),3)))))))))))))))))));}
Cyc_Tcutil_explain_failure();}if(!Cyc_Tcutil_is_const_exp(te,_tmp2C)){const char*
_tmp243;void*_tmp242;(_tmp242=0,Cyc_Tcutil_terr(loc,((_tmp243="initializer is not a constant expression",
_tag_dyneither(_tmp243,sizeof(char),41))),_tag_dyneither(_tmp242,sizeof(void*),0)));}}}
...
_LL41;_LL40: if((int)_tmp35 != 4)goto _LL42;_LL41: {const char*_tmp246;void*_tmp245;(
_tmp245=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp246="tcVardecl: fn type atts in function var decl",_tag_dyneither(_tmp246,
sizeof(char),45))),_tag_dyneither(_tmp245,sizeof(void*),0)));}_LL42: if(_tmp35 <= (
void*)17)goto _LL44;if(*((int*)_tmp35)!= 1)goto _LL44;_LL43: goto _LL45;_LL44: if((
int)_tmp35 != 5)goto _LL46;_LL45:{const char*_tmp24A;void*_tmp249[1];struct Cyc_String_pa_struct
_tmp248;(_tmp248.tag=0,((_tmp248.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absyn_attribute2string((void*)_tmpB->hd)),((_tmp249[0]=& _tmp248,Cyc_Tcutil_terr(
loc,((_tmp24A="bad attribute %s in function declaration",_tag_dyneither(_tmp24A,
sizeof(char),41))),_tag_dyneither(_tmp249,sizeof(void*),1)))))));}goto _LL2F;
...
_LL4A: {struct Cyc_Absyn_Global_b_struct _tmp24D;struct Cyc_Absyn_Global_b_struct*
_tmp24C;struct Cyc_Absyn_Global_b_struct*_tmp41=(_tmp24C=_cycalloc(sizeof(*
_tmp24C)),((_tmp24C[0]=((_tmp24D.tag=0,((_tmp24D.f1=vd,_tmp24D)))),_tmp24C)));
...
exports)){struct Cyc_Tcenv_VarRes_struct*_tmp253;struct Cyc_Tcenv_VarRes_struct
_tmp252;struct _tuple7*_tmp251;ge->ordinaries=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct _dyneither_ptr*k,struct _tuple7*v))Cyc_Dict_insert)(ge->ordinaries,_tmp8,(
struct _tuple7*)((_tmp251=_cycalloc(sizeof(*_tmp251)),((_tmp251->f1=(void*)((
_tmp253=_cycalloc(sizeof(*_tmp253)),((_tmp253[0]=((_tmp252.tag=0,((_tmp252.f1=(
void*)_tmp42,_tmp252)))),_tmp253)))),((_tmp251->f2=1,_tmp251)))))));}
_npop_handler(0);return;}_LL4B: if(*((int*)_tmp3F)!= 1)goto _LL4D;_LL4C:{const char*
_tmp256;void*_tmp255;(_tmp255=0,Cyc_Tcutil_warn(loc,((_tmp256="variable declaration shadows previous struct declaration",
_tag_dyneither(_tmp256,sizeof(char),57))),_tag_dyneither(_tmp255,sizeof(void*),0)));}
goto _LL48;_LL4D: if(*((int*)_tmp3F)!= 2)goto _LL4F;_LL4E:{const char*_tmp259;void*
_tmp258;(_tmp258=0,Cyc_Tcutil_warn(loc,((_tmp259="variable declaration shadows previous datatype constructor",
_tag_dyneither(_tmp259,sizeof(char),59))),_tag_dyneither(_tmp258,sizeof(void*),0)));}
goto _LL48;_LL4F: if(*((int*)_tmp3F)!= 4)goto _LL51;_LL50: goto _LL52;_LL51: if(*((int*)
_tmp3F)!= 3)goto _LL48;_LL52:{const char*_tmp25C;void*_tmp25B;(_tmp25B=0,Cyc_Tcutil_warn(
loc,((_tmp25C="variable declaration shadows previous enum tag",_tag_dyneither(
_tmp25C,sizeof(char),47))),_tag_dyneither(_tmp25B,sizeof(void*),0)));}goto _LL48;
...
exports)){struct Cyc_Tcenv_VarRes_struct*_tmp26B;struct Cyc_Absyn_Global_b_struct*
_tmp26A;struct Cyc_Absyn_Global_b_struct _tmp269;struct Cyc_Tcenv_VarRes_struct
_tmp268;struct _tuple7*_tmp267;ge->ordinaries=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct _dyneither_ptr*k,struct _tuple7*v))Cyc_Dict_insert)(ge->ordinaries,_tmp8,(
struct _tuple7*)((_tmp267=_cycalloc(sizeof(*_tmp267)),((_tmp267->f1=(void*)((
_tmp26B=_cycalloc(sizeof(*_tmp26B)),((_tmp26B[0]=((_tmp268.tag=0,((_tmp268.f1=(
void*)((void*)((_tmp26A=_cycalloc(sizeof(*_tmp26A)),((_tmp26A[0]=((_tmp269.tag=0,((
_tmp269.f1=vd,_tmp269)))),_tmp26A))))),_tmp268)))),_tmp26B)))),((_tmp267->f2=0,
_tmp267)))))));}}static int Cyc_Tc_is_main(struct _tuple0*n);static int Cyc_Tc_is_main(
...
_tmp5A != 0)goto _LL5B;_LL5A: {const char*_tmp26C;return Cyc_strcmp((struct
_dyneither_ptr)*_tmp58,((_tmp26C="main",_tag_dyneither(_tmp26C,sizeof(char),5))))
...
if((void*)fd->sc == (void*)4  && !ignore_body){const char*_tmp26F;void*_tmp26E;(
_tmp26E=0,Cyc_Tcutil_terr(loc,((_tmp26F="extern \"C\" functions cannot be implemented in Cyclone",
_tag_dyneither(_tmp26F,sizeof(char),54))),_tag_dyneither(_tmp26E,sizeof(void*),0)));}{
...
!= 2)goto _LL62;_tmp60=(_tmp5E.Abs_n).f1;_LL61: {const char*_tmp272;void*_tmp271;(
_tmp271=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp272="tc: Abs_n in tcFndecl",_tag_dyneither(_tmp272,sizeof(char),22))),
_tag_dyneither(_tmp271,sizeof(void*),0)));}_LL62:;_LL63:{const char*_tmp276;void*
_tmp275[1];struct Cyc_String_pa_struct _tmp274;(_tmp274.tag=0,((_tmp274.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(fd->name)),((
_tmp275[0]=& _tmp274,Cyc_Tcutil_terr(loc,((_tmp276="qualified function declarations are not implemented (%s)",
_tag_dyneither(_tmp276,sizeof(char),57))),_tag_dyneither(_tmp275,sizeof(void*),1)))))));}
return;_LL5D:;}{union Cyc_Absyn_Nmspace_union _tmp277;(*fd->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp277.Abs_n).tag=2,(((_tmp277.Abs_n).f1=te->ns,_tmp277))));}Cyc_Tcutil_check_fndecl_valid_type(
...
_LL68:{const char*_tmp27B;void*_tmp27A[1];struct Cyc_String_pa_struct _tmp279;(
_tmp279.tag=0,((_tmp279.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((
void*)atts->hd)),((_tmp27A[0]=& _tmp279,Cyc_Tcutil_terr(loc,((_tmp27B="bad attribute %s for function",
_tag_dyneither(_tmp27B,sizeof(char),30))),_tag_dyneither(_tmp27A,sizeof(void*),1)))))));}
...
_tmp6F)->f1;_LL6D: {struct Cyc_Absyn_Funname_b_struct _tmp27E;struct Cyc_Absyn_Funname_b_struct*
_tmp27D;struct Cyc_Absyn_Funname_b_struct*_tmp71=(_tmp27D=_cycalloc(sizeof(*
_tmp27D)),((_tmp27D[0]=((_tmp27E.tag=1,((_tmp27E.f1=fd,_tmp27E)))),_tmp27D)));
...
_tmp284;struct Cyc_Tcenv_VarRes_struct _tmp283;struct _tuple7*_tmp282;ge->ordinaries=((
struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct _tuple7*
v))Cyc_Dict_insert)(ge->ordinaries,v,(struct _tuple7*)((_tmp282=_cycalloc(sizeof(*
_tmp282)),((_tmp282->f1=(void*)((_tmp284=_cycalloc(sizeof(*_tmp284)),((_tmp284[0]=((
_tmp283.tag=0,((_tmp283.f1=(void*)_tmp72,_tmp283)))),_tmp284)))),((_tmp282->f2=1,
_tmp282)))))));}goto _LL6B;}_LL6E: if(*((int*)_tmp6F)!= 1)goto _LL70;_LL6F:{const
char*_tmp287;void*_tmp286;(_tmp286=0,Cyc_Tcutil_warn(loc,((_tmp287="function declaration shadows previous type declaration",
_tag_dyneither(_tmp287,sizeof(char),55))),_tag_dyneither(_tmp286,sizeof(void*),0)));}
goto _LL6B;_LL70: if(*((int*)_tmp6F)!= 2)goto _LL72;_LL71:{const char*_tmp28A;void*
_tmp289;(_tmp289=0,Cyc_Tcutil_warn(loc,((_tmp28A="function declaration shadows previous datatype constructor",
_tag_dyneither(_tmp28A,sizeof(char),59))),_tag_dyneither(_tmp289,sizeof(void*),0)));}
goto _LL6B;_LL72: if(*((int*)_tmp6F)!= 4)goto _LL74;_LL73: goto _LL75;_LL74: if(*((int*)
_tmp6F)!= 3)goto _LL6B;_LL75:{const char*_tmp28D;void*_tmp28C;(_tmp28C=0,Cyc_Tcutil_warn(
loc,((_tmp28D="function declaration shadows previous enum tag",_tag_dyneither(
_tmp28D,sizeof(char),47))),_tag_dyneither(_tmp28C,sizeof(void*),0)));}goto _LL6B;
...
fd->name,*exports)){struct Cyc_Tcenv_VarRes_struct*_tmp29C;struct Cyc_Absyn_Funname_b_struct*
_tmp29B;struct Cyc_Absyn_Funname_b_struct _tmp29A;struct Cyc_Tcenv_VarRes_struct
_tmp299;struct _tuple7*_tmp298;ge->ordinaries=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct _dyneither_ptr*k,struct _tuple7*v))Cyc_Dict_insert)(ge->ordinaries,v,(
struct _tuple7*)((_tmp298=_cycalloc(sizeof(*_tmp298)),((_tmp298->f1=(void*)((
_tmp29C=_cycalloc(sizeof(*_tmp29C)),((_tmp29C[0]=((_tmp299.tag=0,((_tmp299.f1=(
void*)((void*)((_tmp29B=_cycalloc(sizeof(*_tmp29B)),((_tmp29B[0]=((_tmp29A.tag=1,((
_tmp29A.f1=fd,_tmp29A)))),_tmp29B))))),_tmp299)))),_tmp29C)))),((_tmp298->f2=0,
_tmp298)))))));}goto _LL76;_LL79:;_LL7A:(void)_throw(_tmp7F);_LL76:;}}}if(
...
fnrgn,loc,fd);struct Cyc_Tcenv_Tenv*_tmp29D;struct Cyc_Tcenv_Tenv*_tmp87=(_tmp29D=
_region_malloc(fnrgn,sizeof(*_tmp29D)),((_tmp29D->ns=te->ns,((_tmp29D->ae=te->ae,((
_tmp29D->le=(struct Cyc_Tcenv_Fenv*)_tmp86,((_tmp29D->allow_valueof=0,_tmp29D)))))))));
Cyc_Tcstmt_tcStmt(_tmp87,fd->body,0);Cyc_Tcenv_check_delayed_effects(_tmp87);Cyc_Tcenv_check_delayed_constraints(
_tmp87);if(!Cyc_Tcenv_all_labels_resolved(_tmp87)){const char*_tmp2A0;void*
_tmp29F;(_tmp29F=0,Cyc_Tcutil_terr(loc,((_tmp2A0="function has goto statements to undefined labels",
_tag_dyneither(_tmp2A0,sizeof(char),49))),_tag_dyneither(_tmp29F,sizeof(void*),0)));}}
if(Cyc_Tc_is_main(fd->name)){{void*_tmp8B=Cyc_Tcutil_compress((void*)fd->ret_type);
void*_tmp8C;_LL7C: if((int)_tmp8B != 0)goto _LL7E;_LL7D:{const char*_tmp2A3;void*
_tmp2A2;(_tmp2A2=0,Cyc_Tcutil_warn(loc,((_tmp2A3="main declared with return type void",
_tag_dyneither(_tmp2A3,sizeof(char),36))),_tag_dyneither(_tmp2A2,sizeof(void*),0)));}
...
_LL80:;_LL81:{const char*_tmp2A7;void*_tmp2A6[1];struct Cyc_String_pa_struct
_tmp2A5;(_tmp2A5.tag=0,((_tmp2A5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string((void*)fd->ret_type)),((_tmp2A6[0]=& _tmp2A5,Cyc_Tcutil_terr(
loc,((_tmp2A7="main declared with return type %s instead of int or void",
_tag_dyneither(_tmp2A7,sizeof(char),57))),_tag_dyneither(_tmp2A6,sizeof(void*),1)))))));}
goto _LL7B;_LL7B:;}if(fd->c_varargs  || fd->cyc_varargs != 0){const char*_tmp2AA;
void*_tmp2A9;(_tmp2A9=0,Cyc_Tcutil_terr(loc,((_tmp2AA="main declared with varargs",
_tag_dyneither(_tmp2AA,sizeof(char),27))),_tag_dyneither(_tmp2A9,sizeof(void*),0)));}{
...
_tmp98)->f2;_LL84: goto _LL82;_LL85:;_LL86:{const char*_tmp2AE;void*_tmp2AD[1];
struct Cyc_String_pa_struct _tmp2AC;(_tmp2AC.tag=0,((_tmp2AC.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp97)),((_tmp2AD[
0]=& _tmp2AC,Cyc_Tcutil_terr(loc,((_tmp2AE="main declared with first argument of type %s instead of int",
_tag_dyneither(_tmp2AE,sizeof(char),60))),_tag_dyneither(_tmp2AD,sizeof(void*),1)))))));}
...
_tmp9E.f3;_tmp94=_tmp94->tl;if(_tmp94 != 0){const char*_tmp2B1;void*_tmp2B0;(
_tmp2B0=0,Cyc_Tcutil_terr(loc,((_tmp2B1="main declared with too many arguments",
_tag_dyneither(_tmp2B1,sizeof(char),38))),_tag_dyneither(_tmp2B0,sizeof(void*),0)));}{
struct Cyc_Core_Opt*_tmp2B2;struct Cyc_Core_Opt*tvs=(_tmp2B2=_cycalloc(sizeof(*
_tmp2B2)),((_tmp2B2->v=fd->tvs,_tmp2B2)));struct Cyc_Core_Opt*_tmp2BA;struct Cyc_Core_Opt*
_tmp2B9;struct Cyc_Core_Opt*_tmp2B8;struct Cyc_Core_Opt*_tmp2B7;struct Cyc_Core_Opt*
_tmp2B6;struct Cyc_Core_Opt*_tmp2B5;struct Cyc_Core_Opt*_tmp2B4;struct Cyc_Core_Opt*
_tmp2B3;if(((!Cyc_Tcutil_unify(_tmp9F,Cyc_Absyn_dyneither_typ(Cyc_Absyn_string_typ(
Cyc_Absyn_new_evar(((_tmp2B9=_cycalloc(sizeof(*_tmp2B9)),((_tmp2B9->v=(void*)((
void*)3),_tmp2B9)))),tvs)),Cyc_Absyn_new_evar(((_tmp2BA=_cycalloc(sizeof(*
_tmp2BA)),((_tmp2BA->v=(void*)((void*)3),_tmp2BA)))),tvs),Cyc_Absyn_empty_tqual(
...
_tmp2B7=_cycalloc(sizeof(*_tmp2B7)),((_tmp2B7->v=(void*)((void*)3),_tmp2B7)))),
tvs)),Cyc_Absyn_new_evar(((_tmp2B8=_cycalloc(sizeof(*_tmp2B8)),((_tmp2B8->v=(
void*)((void*)3),_tmp2B8)))),tvs),Cyc_Absyn_empty_tqual(0),((struct Cyc_Absyn_Conref*(*)())
Cyc_Absyn_empty_conref)()))) && !Cyc_Tcutil_unify(_tmp9F,Cyc_Absyn_dyneither_typ(
Cyc_Absyn_string_typ(Cyc_Absyn_new_evar(((_tmp2B5=_cycalloc(sizeof(*_tmp2B5)),((
_tmp2B5->v=(void*)((void*)3),_tmp2B5)))),tvs)),Cyc_Absyn_new_evar(((_tmp2B6=
_cycalloc(sizeof(*_tmp2B6)),((_tmp2B6->v=(void*)((void*)3),_tmp2B6)))),tvs),Cyc_Absyn_const_tqual(
0),((struct Cyc_Absyn_Conref*(*)())Cyc_Absyn_empty_conref)()))) && !Cyc_Tcutil_unify(
_tmp9F,Cyc_Absyn_dyneither_typ(Cyc_Absyn_const_string_typ(Cyc_Absyn_new_evar(((
_tmp2B3=_cycalloc(sizeof(*_tmp2B3)),((_tmp2B3->v=(void*)((void*)3),_tmp2B3)))),
tvs)),Cyc_Absyn_new_evar(((_tmp2B4=_cycalloc(sizeof(*_tmp2B4)),((_tmp2B4->v=(
void*)((void*)3),_tmp2B4)))),tvs),Cyc_Absyn_const_tqual(0),((struct Cyc_Absyn_Conref*(*)())
Cyc_Absyn_empty_conref)()))){const char*_tmp2BE;void*_tmp2BD[1];struct Cyc_String_pa_struct
_tmp2BC;(_tmp2BC.tag=0,((_tmp2BC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(_tmp9F)),((_tmp2BD[0]=& _tmp2BC,Cyc_Tcutil_terr(loc,((
_tmp2BE="second argument of main has type %s instead of char??",_tag_dyneither(
_tmp2BE,sizeof(char),54))),_tag_dyneither(_tmp2BD,sizeof(void*),1)))))));}}}}}};
...
goto _LL8C;_LL8B: goto _LL87;_LL8C:;_LL8D:{const char*_tmp2C2;void*_tmp2C1[1];struct
Cyc_String_pa_struct _tmp2C0;(_tmp2C0.tag=0,((_tmp2C0.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_qvar2string(td->name)),((_tmp2C1[0]=& _tmp2C0,
Cyc_Tcutil_terr(loc,((_tmp2C2="qualified typedef declarations are not implemented (%s)",
_tag_dyneither(_tmp2C2,sizeof(char),56))),_tag_dyneither(_tmp2C1,sizeof(void*),1)))))));}
return;_LL87:;}if(((int(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_member)(
ge->typedefs,v)){{const char*_tmp2C6;void*_tmp2C5[1];struct Cyc_String_pa_struct
_tmp2C4;(_tmp2C4.tag=0,((_tmp2C4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
v),((_tmp2C5[0]=& _tmp2C4,Cyc_Tcutil_terr(loc,((_tmp2C6="redeclaration of typedef %s",
_tag_dyneither(_tmp2C6,sizeof(char),28))),_tag_dyneither(_tmp2C5,sizeof(void*),1)))))));}
return;}{union Cyc_Absyn_Nmspace_union _tmp2C7;(*td->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp2C7.Abs_n).tag=2,(((_tmp2C7.Abs_n).f1=te->ns,_tmp2C7))));}Cyc_Tcutil_check_unique_tvars(
...
_tmpB8)->f1;_LL90: if(td->defn != 0){const char*_tmp2CB;void*_tmp2CA[1];struct Cyc_String_pa_struct
_tmp2C9;(_tmp2C9.tag=0,((_tmp2C9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((
struct Cyc_Absyn_Tvar*)tvs->hd)->name),((_tmp2CA[0]=& _tmp2C9,Cyc_Tcutil_warn(loc,((
_tmp2CB="type variable %s is not used in typedef definition",_tag_dyneither(
_tmp2CB,sizeof(char),51))),_tag_dyneither(_tmp2CA,sizeof(void*),1)))))));}{
struct Cyc_Core_Opt*_tmp2CC;*_tmpBA=((_tmp2CC=_cycalloc(sizeof(*_tmp2CC)),((
_tmp2CC->v=(void*)Cyc_Tcutil_kind_to_bound((void*)2),_tmp2CC))));}goto _LL8E;
...
struct Cyc_Core_Opt*_tmp2CD;*_tmpBC=((_tmp2CD=_cycalloc(sizeof(*_tmp2CD)),((
_tmp2CD->v=(void*)Cyc_Tcutil_kind_to_bound(_tmpBD),_tmp2CD))));}goto _LL8E;_LL93:;
...
prev_fields,_tmpCB)){const char*_tmp2D1;void*_tmp2D0[1];struct Cyc_String_pa_struct
_tmp2CF;(_tmp2CF.tag=0,((_tmp2CF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
_tmpCB),((_tmp2D0[0]=& _tmp2CF,Cyc_Tcutil_terr(loc,((_tmp2D1="duplicate field %s",
_tag_dyneither(_tmp2D1,sizeof(char),19))),_tag_dyneither(_tmp2D0,sizeof(void*),1)))))));}{
const char*_tmp2D2;if(Cyc_strcmp((struct _dyneither_ptr)*_tmpCB,((_tmp2D2="",
_tag_dyneither(_tmp2D2,sizeof(char),1))))!= 0){struct Cyc_List_List*_tmp2D3;
prev_fields=((_tmp2D3=_region_malloc(uprev_rgn,sizeof(*_tmp2D3)),((_tmp2D3->hd=
_tmpCB,((_tmp2D3->tl=prev_fields,_tmp2D3))))));}}Cyc_Tcutil_check_type(loc,te,
...
_LL9A:;_LL9B:{const char*_tmp2D8;void*_tmp2D7[2];struct Cyc_String_pa_struct
_tmp2D6;struct Cyc_String_pa_struct _tmp2D5;(_tmp2D5.tag=0,((_tmp2D5.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*_tmpD5),((_tmp2D6.tag=0,((_tmp2D6.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)
atts->hd)),((_tmp2D7[0]=& _tmp2D6,((_tmp2D7[1]=& _tmp2D5,Cyc_Tcutil_terr(loc,((
_tmp2D8="bad attribute %s in  %s definition",_tag_dyneither(_tmp2D8,sizeof(char),
35))),_tag_dyneither(_tmp2D7,sizeof(void*),2)))))))))))));}goto _LL95;_LL95:;}}{
...
_tmpDC)->f2;if((int)_tmpE4 != 0)goto _LLA3;_LLA2:{struct Cyc_Core_Opt*_tmp2D9;*
_tmpE3=((_tmp2D9=_cycalloc(sizeof(*_tmp2D9)),((_tmp2D9->v=(void*)Cyc_Tcutil_kind_to_bound((
void*)2),_tmp2D9))));}continue;_LLA3: if(*((int*)_tmpDC)!= 0)goto _LLA5;_tmpE5=(
void*)((struct Cyc_Absyn_Eq_kb_struct*)_tmpDC)->f1;if((int)_tmpE5 != 1)goto _LLA5;
_LLA4:{const char*_tmp2DE;void*_tmp2DD[2];struct Cyc_String_pa_struct _tmp2DC;
struct Cyc_String_pa_struct _tmp2DB;(_tmp2DB.tag=0,((_tmp2DB.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)tvs2->hd)->name),((
_tmp2DC.tag=0,((_tmp2DC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmpD5),((
_tmp2DD[0]=& _tmp2DC,((_tmp2DD[1]=& _tmp2DB,Cyc_Tcutil_terr(loc,((_tmp2DE="type %s attempts to abstract type variable %s of kind M",
_tag_dyneither(_tmp2DE,sizeof(char),56))),_tag_dyneither(_tmp2DD,sizeof(void*),2)))))))))))));}
...
goto _LLAC;_LLAB: goto _LLA7;_LLAC:;_LLAD:{const char*_tmp2E2;void*_tmp2E1[1];struct
Cyc_String_pa_struct _tmp2E0;(_tmp2E0.tag=0,((_tmp2E0.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_qvar2string(ad->name)),((_tmp2E1[0]=& _tmp2E0,
Cyc_Tcutil_terr(loc,((_tmp2E2="qualified struct declarations are not implemented (%s)",
_tag_dyneither(_tmp2E2,sizeof(char),55))),_tag_dyneither(_tmp2E1,sizeof(void*),1)))))));}
return;_LLA7:;}{union Cyc_Absyn_Nmspace_union _tmp2E3;(*ad->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp2E3.Abs_n).tag=2,(((_tmp2E3.Abs_n).f1=te->ns,_tmp2E3))));}Cyc_Tcutil_check_unique_tvars(
loc,ad->tvs);Cyc_Tcutil_add_tvar_identities(ad->tvs);{struct _tuple9 _tmp2E4;
struct _tuple9 _tmpF3=(_tmp2E4.f1=ad->impl,((_tmp2E4.f2=((struct Cyc_Absyn_Aggrdecl***(*)(
struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup_opt)(ge->aggrdecls,
_tmpD5),_tmp2E4)));struct Cyc_Absyn_AggrdeclImpl*_tmpF4;struct Cyc_Absyn_Aggrdecl***
...
_LLB1;_LLB0:{struct Cyc_Absyn_Aggrdecl**_tmp2E5;ge->aggrdecls=((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Aggrdecl**v))Cyc_Dict_insert)(
ge->aggrdecls,_tmpD5,((_tmp2E5=_cycalloc(sizeof(*_tmp2E5)),((_tmp2E5[0]=ad,
_tmp2E5)))));}goto _LLAE;_LLB1: _tmpF6=_tmpF3.f1;if(_tmpF6 == 0)goto _LLB3;_tmpF7=*
...
_tmp2E8;struct Cyc_Absyn_Aggrdecl**_tmp2E7;struct Cyc_Absyn_Aggrdecl**_tmp109=(
_tmp2E7=_cycalloc(sizeof(*_tmp2E7)),((_tmp2E7[0]=((_tmp2E8=_cycalloc(sizeof(*
_tmp2E8)),((_tmp2E8->kind=(void*)((void*)ad->kind),((_tmp2E8->sc=(void*)((void*)
3),((_tmp2E8->name=ad->name,((_tmp2E8->tvs=_tmpDB,((_tmp2E8->impl=0,((_tmp2E8->attributes=
ad->attributes,_tmp2E8)))))))))))))),_tmp2E7)));ge->aggrdecls=((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Aggrdecl**v))Cyc_Dict_insert)(
ge->aggrdecls,_tmpD5,_tmp109);Cyc_Tcutil_check_unique_tvars(loc,_tmpF8);Cyc_Tcutil_add_tvar_identities(
...
int)_tmp112 != 0)goto _LLBE;_LLBD:{struct Cyc_Core_Opt*_tmp2E9;*_tmp111=((_tmp2E9=
_cycalloc(sizeof(*_tmp2E9)),((_tmp2E9->v=(void*)Cyc_Tcutil_kind_to_bound((void*)
2),_tmp2E9))));}continue;_LLBE: if(*((int*)_tmp10A)!= 0)goto _LLC0;_tmp113=(void*)((
struct Cyc_Absyn_Eq_kb_struct*)_tmp10A)->f1;if((int)_tmp113 != 1)goto _LLC0;_LLBF:{
const char*_tmp2EE;void*_tmp2ED[2];struct Cyc_String_pa_struct _tmp2EC;struct Cyc_String_pa_struct
_tmp2EB;(_tmp2EB.tag=0,((_tmp2EB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((
struct Cyc_Absyn_Tvar*)tvs2->hd)->name),((_tmp2EC.tag=0,((_tmp2EC.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*_tmpD5),((_tmp2ED[0]=& _tmp2EC,((_tmp2ED[1]=&
_tmp2EB,Cyc_Tcutil_terr(loc,((_tmp2EE="type %s attempts to abstract type variable %s of kind M",
_tag_dyneither(_tmp2EE,sizeof(char),56))),_tag_dyneither(_tmp2ED,sizeof(void*),2)))))))))))));}
continue;_LLC0:;_LLC1: continue;_LLB7:;}}if(_tmpFB  && (void*)ad->kind == (void*)0){
const char*_tmp2F1;void*_tmp2F0;(_tmp2F0=0,Cyc_Tcutil_terr(loc,((_tmp2F1="@tagged qualifier is only allowed on union declarations",
_tag_dyneither(_tmp2F1,sizeof(char),56))),_tag_dyneither(_tmp2F0,sizeof(void*),0)));}
Cyc_Tc_tcAggrImpl(te,ge,loc,((struct Cyc_List_List*(*)(struct Cyc_List_List*x,
struct Cyc_List_List*y))Cyc_List_append)(_tmpDB,_tmpF8),_tmpF9,_tmpFA);if((void*)
...
const char*_tmp2F7;void*_tmp2F6[3];struct Cyc_String_pa_struct _tmp2F5;struct Cyc_String_pa_struct
_tmp2F4;struct Cyc_String_pa_struct _tmp2F3;(_tmp2F3.tag=0,((_tmp2F3.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)((struct Cyc_Absyn_Aggrfield*)
f->hd)->type)),((_tmp2F4.tag=0,((_tmp2F4.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*_tmpD5),((_tmp2F5.tag=0,((_tmp2F5.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)f->hd)->name),((_tmp2F6[0]=&
_tmp2F5,((_tmp2F6[1]=& _tmp2F4,((_tmp2F6[2]=& _tmp2F3,Cyc_Tcutil_warn(loc,((
_tmp2F7="member %s of union %s has type %s which is not `bits-only' so it can only be written and not read",
_tag_dyneither(_tmp2F7,sizeof(char),98))),_tag_dyneither(_tmp2F6,sizeof(void*),3)))))))))))))))))));}}}*
_tmp109=ad;goto _LLAE;}_LLB3: _tmpFD=_tmpF3.f1;if(_tmpFD == 0)goto _LLB5;_tmpFE=*
_tmpFD;_tmpFF=_tmpFE.exist_vars;_tmp100=_tmpFE.rgn_po;_tmp101=_tmpFE.fields;
_tmp102=_tmpFE.tagged;_tmp103=_tmpF3.f2;if(_tmp103 == 0)goto _LLB5;_tmp104=*
_tmp103;_LLB4: if((void*)ad->kind != (void*)(*_tmp104)->kind){const char*_tmp2FA;
void*_tmp2F9;(_tmp2F9=0,Cyc_Tcutil_terr(loc,((_tmp2FA="cannot reuse struct names for unions and vice-versa",
_tag_dyneither(_tmp2FA,sizeof(char),52))),_tag_dyneither(_tmp2F9,sizeof(void*),0)));}{
struct Cyc_Absyn_Aggrdecl*_tmp124=*_tmp104;{struct Cyc_Absyn_Aggrdecl*_tmp2FB;*
_tmp104=((_tmp2FB=_cycalloc(sizeof(*_tmp2FB)),((_tmp2FB->kind=(void*)((void*)ad->kind),((
_tmp2FB->sc=(void*)((void*)3),((_tmp2FB->name=ad->name,((_tmp2FB->tvs=_tmpDB,((
_tmp2FB->impl=0,((_tmp2FB->attributes=ad->attributes,_tmp2FB))))))))))))));}Cyc_Tcutil_check_unique_tvars(
loc,_tmpFF);Cyc_Tcutil_add_tvar_identities(_tmpFF);if(_tmp102  && (void*)ad->kind
== (void*)0){const char*_tmp2FE;void*_tmp2FD;(_tmp2FD=0,Cyc_Tcutil_terr(loc,((
_tmp2FE="@tagged qualifier is only allowed on union declarations",_tag_dyneither(
_tmp2FE,sizeof(char),56))),_tag_dyneither(_tmp2FD,sizeof(void*),0)));}Cyc_Tc_tcAggrImpl(
te,ge,loc,((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))
Cyc_List_append)(_tmpDB,_tmpFF),_tmp100,_tmp101);*_tmp104=_tmp124;_tmp107=
_tmp104;goto _LLB6;}_LLB5: _tmp105=_tmpF3.f1;if(_tmp105 != 0)goto _LLAE;_tmp106=
_tmpF3.f2;if(_tmp106 == 0)goto _LLAE;_tmp107=*_tmp106;_LLB6: {struct Cyc_Absyn_Aggrdecl*
_tmp128=Cyc_Tcdecl_merge_aggrdecl(*_tmp107,ad,loc,Cyc_Tc_tc_msg);if(_tmp128 == 0)
return;else{*_tmp107=(struct Cyc_Absyn_Aggrdecl*)_tmp128;ad=(struct Cyc_Absyn_Aggrdecl*)
_tmp128;goto _LLAE;}}_LLAE:;}{struct Cyc_Tcenv_AggrRes_struct*_tmp304;struct Cyc_Tcenv_AggrRes_struct
_tmp303;struct _tuple7*_tmp302;ge->ordinaries=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct _dyneither_ptr*k,struct _tuple7*v))Cyc_Dict_insert)(ge->ordinaries,_tmpD5,(
struct _tuple7*)((_tmp302=_cycalloc(sizeof(*_tmp302)),((_tmp302->f1=(void*)((
_tmp304=_cycalloc(sizeof(*_tmp304)),((_tmp304[0]=((_tmp303.tag=1,((_tmp303.f1=ad,
_tmp303)))),_tmp304)))),((_tmp302->f2=1,_tmp302)))))));}}}struct _tuple10{struct
Cyc_Absyn_Tqual f1;void*f2;};static struct Cyc_List_List*Cyc_Tc_tcDatatypeFields(
struct Cyc_Tcenv_Tenv*te,struct Cyc_Tcenv_Genv*ge,struct Cyc_Position_Segment*loc,
struct _dyneither_ptr obj,int is_extensible,struct _tuple0*name,struct Cyc_List_List*
fields,struct Cyc_List_List*tvs,struct Cyc_Absyn_Datatypedecl*tudres);static struct
Cyc_List_List*Cyc_Tc_tcDatatypeFields(struct Cyc_Tcenv_Tenv*te,struct Cyc_Tcenv_Genv*
...
tudres){{struct Cyc_List_List*_tmp12C=fields;for(0;_tmp12C != 0;_tmp12C=_tmp12C->tl){
struct Cyc_Absyn_Datatypefield*_tmp12D=(struct Cyc_Absyn_Datatypefield*)_tmp12C->hd;{
struct Cyc_List_List*typs=_tmp12D->typs;for(0;typs != 0;typs=typs->tl){Cyc_Tcutil_check_type(
_tmp12D->loc,te,tvs,(void*)1,0,(*((struct _tuple10*)typs->hd)).f2);{struct
_RegionHandle*_tmp12E=Cyc_Tcenv_get_fnrgn(te);if(!tudres->is_flat  && Cyc_Tcutil_is_noalias_pointer_or_aggr(
_tmp12E,(*((struct _tuple10*)typs->hd)).f2)){const char*_tmp308;void*_tmp307[1];
struct Cyc_String_pa_struct _tmp306;(_tmp306.tag=0,((_tmp306.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp12D->name)),((
_tmp307[0]=& _tmp306,Cyc_Tcutil_terr(_tmp12D->loc,((_tmp308="noalias pointers in non-flat datatypes are not allowed (%s)",
_tag_dyneither(_tmp308,sizeof(char),60))),_tag_dyneither(_tmp307,sizeof(void*),1)))))));}((*((
...
_tmp132.Rel_n).f1;if(_tmp133 != 0)goto _LLC5;_LLC4: if(is_extensible){union Cyc_Absyn_Nmspace_union
_tmp309;(*_tmp12D->name).f1=(union Cyc_Absyn_Nmspace_union)(((_tmp309.Abs_n).tag=
2,(((_tmp309.Abs_n).f1=te->ns,_tmp309))));}else{(*_tmp12D->name).f1=(*name).f1;}
goto _LLC2;_LLC5: if((_tmp132.Rel_n).tag != 1)goto _LLC7;_LLC6:{const char*_tmp30D;
void*_tmp30C[1];struct Cyc_String_pa_struct _tmp30B;(_tmp30B.tag=0,((_tmp30B.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp12D->name)),((
_tmp30C[0]=& _tmp30B,Cyc_Tcutil_terr(_tmp12D->loc,((_tmp30D="qualified datatypefield declarations are not allowed (%s)",
_tag_dyneither(_tmp30D,sizeof(char),58))),_tag_dyneither(_tmp30C,sizeof(void*),1)))))));}
goto _LLC2;_LLC7: if((_tmp132.Abs_n).tag != 2)goto _LLC9;_LLC8: goto _LLC2;_LLC9: if((
_tmp132.Loc_n).tag != 0)goto _LLC2;_LLCA: {const char*_tmp310;void*_tmp30F;(_tmp30F=
0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp310="tcDatatypeFields: Loc_n",_tag_dyneither(_tmp310,sizeof(char),24))),
_tag_dyneither(_tmp30F,sizeof(void*),0)));}_LLC2:;}}}{struct Cyc_List_List*
...
const char*_tmp315;void*_tmp314[2];struct Cyc_String_pa_struct _tmp313;struct Cyc_String_pa_struct
_tmp312;(_tmp312.tag=0,((_tmp312.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
obj),((_tmp313.tag=0,((_tmp313.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*
_tmp13D->name).f2),((_tmp314[0]=& _tmp313,((_tmp314[1]=& _tmp312,Cyc_Tcutil_terr(
_tmp13D->loc,((_tmp315="duplicate field name %s in %s",_tag_dyneither(_tmp315,
sizeof(char),30))),_tag_dyneither(_tmp314,sizeof(void*),2)))))))))))));}else{
struct Cyc_List_List*_tmp316;prev_fields=((_tmp316=_region_malloc(uprev_rgn,
sizeof(*_tmp316)),((_tmp316->hd=(*_tmp13D->name).f2,((_tmp316->tl=prev_fields,
_tmp316))))));}if((void*)_tmp13D->sc != (void*)2){{const char*_tmp31A;void*_tmp319[
1];struct Cyc_String_pa_struct _tmp318;(_tmp318.tag=0,((_tmp318.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*(*_tmp13D->name).f2),((_tmp319[0]=&
_tmp318,Cyc_Tcutil_warn(loc,((_tmp31A="ignoring scope of field %s",
_tag_dyneither(_tmp31A,sizeof(char),27))),_tag_dyneither(_tmp319,sizeof(void*),1)))))));}(
void*)(_tmp13D->sc=(void*)((void*)2));}}}fields2=fields;};_pop_region(uprev_rgn);}{
struct Cyc_List_List*_tmp146=fields;for(0;_tmp146 != 0;_tmp146=_tmp146->tl){struct
Cyc_Absyn_Datatypefield*_tmp147=(struct Cyc_Absyn_Datatypefield*)_tmp146->hd;
struct Cyc_Tcenv_DatatypeRes_struct*_tmp320;struct Cyc_Tcenv_DatatypeRes_struct
_tmp31F;struct _tuple7*_tmp31E;ge->ordinaries=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct _dyneither_ptr*k,struct _tuple7*v))Cyc_Dict_insert)(ge->ordinaries,(*
_tmp147->name).f2,(struct _tuple7*)((_tmp31E=_cycalloc(sizeof(*_tmp31E)),((
_tmp31E->f1=(void*)((_tmp320=_cycalloc(sizeof(*_tmp320)),((_tmp320[0]=((_tmp31F.tag=
2,((_tmp31F.f1=tudres,((_tmp31F.f2=_tmp147,_tmp31F)))))),_tmp320)))),((_tmp31E->f2=
1,_tmp31E)))))));}}return fields2;}}struct _tuple11{struct Cyc_Core_Opt*f1;struct
Cyc_Absyn_Datatypedecl***f2;};void Cyc_Tc_tcDatatypedecl(struct Cyc_Tcenv_Tenv*te,
struct Cyc_Tcenv_Genv*ge,struct Cyc_Position_Segment*loc,struct Cyc_Absyn_Datatypedecl*
tud);void Cyc_Tc_tcDatatypedecl(struct Cyc_Tcenv_Tenv*te,struct Cyc_Tcenv_Genv*ge,
struct Cyc_Position_Segment*loc,struct Cyc_Absyn_Datatypedecl*tud){struct
_dyneither_ptr*v=(*tud->name).f2;const char*_tmp322;const char*_tmp321;struct
_dyneither_ptr obj=tud->is_extensible?(_tmp322="@extensible datatype",
_tag_dyneither(_tmp322,sizeof(char),21)):((_tmp321="datatype",_tag_dyneither(
_tmp321,sizeof(char),9)));struct Cyc_List_List*tvs=tud->tvs;{struct Cyc_List_List*
tvs2=tvs;for(0;tvs2 != 0;tvs2=tvs2->tl){void*_tmp14B=Cyc_Absyn_compress_kb((void*)((
struct Cyc_Absyn_Tvar*)tvs2->hd)->kind);struct Cyc_Core_Opt*_tmp14C;struct Cyc_Core_Opt**
_tmp14D;struct Cyc_Core_Opt*_tmp14E;struct Cyc_Core_Opt**_tmp14F;void*_tmp150;
struct Cyc_Core_Opt*_tmp151;struct Cyc_Core_Opt**_tmp152;void*_tmp153;struct Cyc_Core_Opt*
_tmp154;struct Cyc_Core_Opt**_tmp155;void*_tmp156;void*_tmp157;struct Cyc_Core_Opt*
_tmp158;struct Cyc_Core_Opt**_tmp159;void*_tmp15A;void*_tmp15B;void*_tmp15C;_LLCC:
if(*((int*)_tmp14B)!= 1)goto _LLCE;_tmp14C=((struct Cyc_Absyn_Unknown_kb_struct*)
_tmp14B)->f1;_tmp14D=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_struct*)
_tmp14B)->f1;_LLCD: _tmp14F=_tmp14D;goto _LLCF;_LLCE: if(*((int*)_tmp14B)!= 2)goto
_LLD0;_tmp14E=((struct Cyc_Absyn_Less_kb_struct*)_tmp14B)->f1;_tmp14F=(struct Cyc_Core_Opt**)&((
...
int)_tmp153 != 0)goto _LLD2;_LLD1:{struct Cyc_Core_Opt*_tmp323;*_tmp152=((_tmp323=
_cycalloc(sizeof(*_tmp323)),((_tmp323->v=(void*)Cyc_Tcutil_kind_to_bound((void*)
2),_tmp323))));}goto _LLCB;_LLD2: if(*((int*)_tmp14B)!= 2)goto _LLD4;_tmp154=((
struct Cyc_Absyn_Less_kb_struct*)_tmp14B)->f1;_tmp155=(struct Cyc_Core_Opt**)&((
struct Cyc_Absyn_Less_kb_struct*)_tmp14B)->f1;_tmp156=(void*)((struct Cyc_Absyn_Less_kb_struct*)
_tmp14B)->f2;if((int)_tmp156 != 5)goto _LLD4;_LLD3:{struct Cyc_Core_Opt*_tmp324;*
_tmp155=((_tmp324=_cycalloc(sizeof(*_tmp324)),((_tmp324->v=(void*)Cyc_Tcutil_kind_to_bound((
void*)3),_tmp324))));}goto _LLCB;_LLD4: if(*((int*)_tmp14B)!= 0)goto _LLD6;_tmp157=(
void*)((struct Cyc_Absyn_Eq_kb_struct*)_tmp14B)->f1;if((int)_tmp157 != 5)goto _LLD6;
_LLD5: if(!tud->is_flat){const char*_tmp32A;void*_tmp329[3];struct Cyc_String_pa_struct
_tmp328;struct Cyc_String_pa_struct _tmp327;struct Cyc_String_pa_struct _tmp326;(
_tmp326.tag=0,((_tmp326.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((
struct Cyc_Absyn_Tvar*)tvs2->hd)->name),((_tmp327.tag=0,((_tmp327.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*v),((_tmp328.tag=0,((_tmp328.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)obj),((_tmp329[0]=& _tmp328,((_tmp329[1]=&
_tmp327,((_tmp329[2]=& _tmp326,Cyc_Tcutil_terr(loc,((_tmp32A="%s %s attempts to abstract type variable %s of kind TR",
_tag_dyneither(_tmp32A,sizeof(char),55))),_tag_dyneither(_tmp329,sizeof(void*),3)))))))))))))))))));}
goto _LLCB;_LLD6: if(*((int*)_tmp14B)!= 2)goto _LLD8;_tmp158=((struct Cyc_Absyn_Less_kb_struct*)
...
_tmp14B)->f1;if((int)_tmp15B != 4)goto _LLDA;_LLD9: if(!tud->is_flat){const char*
_tmp330;void*_tmp32F[3];struct Cyc_String_pa_struct _tmp32E;struct Cyc_String_pa_struct
_tmp32D;struct Cyc_String_pa_struct _tmp32C;(_tmp32C.tag=0,((_tmp32C.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)tvs2->hd)->name),((
_tmp32D.tag=0,((_tmp32D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*v),((
_tmp32E.tag=0,((_tmp32E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)obj),((
_tmp32F[0]=& _tmp32E,((_tmp32F[1]=& _tmp32D,((_tmp32F[2]=& _tmp32C,Cyc_Tcutil_terr(
loc,((_tmp330="%s %s attempts to abstract type variable %s of kind UR",
_tag_dyneither(_tmp330,sizeof(char),55))),_tag_dyneither(_tmp32F,sizeof(void*),3)))))))))))))))))));}
goto _LLCB;_LLDA: if(*((int*)_tmp14B)!= 0)goto _LLDC;_tmp15C=(void*)((struct Cyc_Absyn_Eq_kb_struct*)
_tmp14B)->f1;if((int)_tmp15C != 1)goto _LLDC;_LLDB:{const char*_tmp336;void*_tmp335[
3];struct Cyc_String_pa_struct _tmp334;struct Cyc_String_pa_struct _tmp333;struct Cyc_String_pa_struct
_tmp332;(_tmp332.tag=0,((_tmp332.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((
struct Cyc_Absyn_Tvar*)tvs2->hd)->name),((_tmp333.tag=0,((_tmp333.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*v),((_tmp334.tag=0,((_tmp334.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)obj),((_tmp335[0]=& _tmp334,((_tmp335[1]=&
_tmp333,((_tmp335[2]=& _tmp332,Cyc_Tcutil_terr(loc,((_tmp336="%s %s attempts to abstract type variable %s of kind M",
_tag_dyneither(_tmp336,sizeof(char),54))),_tag_dyneither(_tmp335,sizeof(void*),3)))))))))))))))))));}
goto _LLCB;_LLDC:;_LLDD: goto _LLCB;_LLCB:;}}Cyc_Tcutil_check_unique_tvars(loc,tvs);
Cyc_Tcutil_add_tvar_identities(tvs);{struct _RegionHandle _tmp16E=_new_region("temp");
struct _RegionHandle*temp=& _tmp16E;_push_region(temp);{struct Cyc_Absyn_Datatypedecl***
tud_opt;{struct _handler_cons _tmp16F;_push_handler(& _tmp16F);{int _tmp171=0;if(
setjmp(_tmp16F.handler))_tmp171=1;if(!_tmp171){tud_opt=Cyc_Tcenv_lookup_xdatatypedecl(
temp,te,loc,tud->name);if(tud_opt == 0  && !tud->is_extensible)(int)_throw((void*)
Cyc_Dict_Absent);if(tud_opt != 0)tud->name=(*(*tud_opt))->name;else{union Cyc_Absyn_Nmspace_union
_tmp337;(*tud->name).f1=(union Cyc_Absyn_Nmspace_union)(((_tmp337.Abs_n).tag=2,(((
_tmp337.Abs_n).f1=te->ns,_tmp337))));};_pop_handler();}else{void*_tmp170=(void*)
_exn_thrown;void*_tmp174=_tmp170;_LLDF: if(_tmp174 != Cyc_Dict_Absent)goto _LLE1;
_LLE0:{union Cyc_Absyn_Nmspace_union _tmp175=(*tud->name).f1;struct Cyc_List_List*
_tmp176;_LLE4: if((_tmp175.Rel_n).tag != 1)goto _LLE6;_tmp176=(_tmp175.Rel_n).f1;
if(_tmp176 != 0)goto _LLE6;_LLE5:{union Cyc_Absyn_Nmspace_union _tmp338;(*tud->name).f1=(
union Cyc_Absyn_Nmspace_union)(((_tmp338.Abs_n).tag=2,(((_tmp338.Abs_n).f1=te->ns,
_tmp338))));}goto _LLE3;_LLE6: if((_tmp175.Abs_n).tag != 2)goto _LLE8;_LLE7: goto
_LLE9;_LLE8:;_LLE9:{const char*_tmp33C;void*_tmp33B[1];struct Cyc_String_pa_struct
_tmp33A;(_tmp33A.tag=0,((_tmp33A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(tud->name)),((_tmp33B[0]=& _tmp33A,Cyc_Tcutil_terr(loc,((
_tmp33C="qualified (non-extensible) datatype declarations are not implemented (%s)",
_tag_dyneither(_tmp33C,sizeof(char),74))),_tag_dyneither(_tmp33B,sizeof(void*),1)))))));}
_npop_handler(0);return;_LLE3:;}{struct Cyc_Absyn_Datatypedecl***_tmp17B=((struct
Cyc_Absyn_Datatypedecl***(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup_opt)(
ge->datatypedecls,v);{struct Cyc_Absyn_Datatypedecl***_tmp33D;tud_opt=(
unsigned int)_tmp17B?(_tmp33D=_region_malloc(temp,sizeof(*_tmp33D)),((_tmp33D[0]=*
_tmp17B,_tmp33D))): 0;}goto _LLDE;}_LLE1:;_LLE2:(void)_throw(_tmp174);_LLDE:;}}}{
struct _tuple11 _tmp33E;struct _tuple11 _tmp17E=(_tmp33E.f1=tud->fields,((_tmp33E.f2=
tud_opt,_tmp33E)));struct Cyc_Core_Opt*_tmp17F;struct Cyc_Absyn_Datatypedecl***
...
_LLED;_tmp180=_tmp17E.f2;if(_tmp180 != 0)goto _LLED;_LLEC:{struct Cyc_Absyn_Datatypedecl**
_tmp33F;ge->datatypedecls=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct
_dyneither_ptr*k,struct Cyc_Absyn_Datatypedecl**v))Cyc_Dict_insert)(ge->datatypedecls,
v,((_tmp33F=_cycalloc(sizeof(*_tmp33F)),((_tmp33F[0]=tud,_tmp33F)))));}goto _LLEA;
_LLED: _tmp181=_tmp17E.f1;if(_tmp181 == 0)goto _LLEF;_tmp182=*_tmp181;_tmp183=(
struct Cyc_List_List*)_tmp182.v;_tmp184=(struct Cyc_List_List**)&(*_tmp17E.f1).v;
_tmp185=_tmp17E.f2;if(_tmp185 != 0)goto _LLEF;_LLEE: {struct Cyc_Absyn_Datatypedecl*
_tmp342;struct Cyc_Absyn_Datatypedecl**_tmp341;struct Cyc_Absyn_Datatypedecl**
_tmp190=(_tmp341=_cycalloc(sizeof(*_tmp341)),((_tmp341[0]=((_tmp342=_cycalloc(
sizeof(*_tmp342)),((_tmp342->sc=(void*)((void*)3),((_tmp342->name=tud->name,((
_tmp342->tvs=tvs,((_tmp342->fields=0,((_tmp342->is_extensible=tud->is_extensible,((
_tmp342->is_flat=tud->is_flat,_tmp342)))))))))))))),_tmp341)));ge->datatypedecls=((
...
unsigned int)_tmp193) && _tmp193->is_extensible)tud->is_extensible=1;{struct Cyc_Absyn_Datatypedecl*
_tmp343;*_tmp18B=((_tmp343=_cycalloc(sizeof(*_tmp343)),((_tmp343->sc=(void*)((
void*)3),((_tmp343->name=tud->name,((_tmp343->tvs=tvs,((_tmp343->fields=0,((
_tmp343->is_extensible=tud->is_extensible,((_tmp343->is_flat=tud->is_flat,
_tmp343))))))))))))));}*_tmp189=Cyc_Tc_tcDatatypeFields(te,ge,loc,obj,tud->is_extensible,
tud->name,*_tmp189,tvs,tud);*_tmp18B=_tmp193;_tmp18E=_tmp18B;goto _LLF2;}_LLF1:
_tmp18C=_tmp17E.f1;if(_tmp18C != 0)goto _LLEA;_tmp18D=_tmp17E.f2;if(_tmp18D == 0)
goto _LLEA;_tmp18E=*_tmp18D;_LLF2: {struct Cyc_Absyn_Datatypedecl*_tmp195=Cyc_Tcdecl_merge_datatypedecl(*
...
_tmp198=(*ed->name).f1;struct Cyc_List_List*_tmp199;struct Cyc_List_List*_tmp19A;
_LLF4: if((_tmp198.Rel_n).tag != 1)goto _LLF6;_tmp199=(_tmp198.Rel_n).f1;if(_tmp199
!= 0)goto _LLF6;_LLF5: goto _LLF7;_LLF6: if((_tmp198.Abs_n).tag != 2)goto _LLF8;
_tmp19A=(_tmp198.Abs_n).f1;if(_tmp19A != 0)goto _LLF8;_LLF7: goto _LLF3;_LLF8:;_LLF9:{
const char*_tmp347;void*_tmp346[1];struct Cyc_String_pa_struct _tmp345;(_tmp345.tag=
0,((_tmp345.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
ed->name)),((_tmp346[0]=& _tmp345,Cyc_Tcutil_terr(loc,((_tmp347="qualified enum declarations are not implemented (%s)",
_tag_dyneither(_tmp347,sizeof(char),53))),_tag_dyneither(_tmp346,sizeof(void*),1)))))));}
return;_LLF3:;}{union Cyc_Absyn_Nmspace_union _tmp348;(*ed->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp348.Abs_n).tag=2,(((_tmp348.Abs_n).f1=te->ns,_tmp348))));}if(ed->fields != 0){
struct _RegionHandle _tmp19F=_new_region("uprev_rgn");struct _RegionHandle*
...
const char*_tmp34C;void*_tmp34B[1];struct Cyc_String_pa_struct _tmp34A;(_tmp34A.tag=
0,((_tmp34A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp1A0->name).f2),((
_tmp34B[0]=& _tmp34A,Cyc_Tcutil_terr(_tmp1A0->loc,((_tmp34C="duplicate field name %s",
_tag_dyneither(_tmp34C,sizeof(char),24))),_tag_dyneither(_tmp34B,sizeof(void*),1)))))));}
else{struct Cyc_List_List*_tmp34D;prev_fields=((_tmp34D=_region_malloc(uprev_rgn,
sizeof(*_tmp34D)),((_tmp34D->hd=(*_tmp1A0->name).f2,((_tmp34D->tl=prev_fields,
_tmp34D))))));}if(_tmp1A0->tag == 0)_tmp1A0->tag=(struct Cyc_Absyn_Exp*)Cyc_Absyn_uint_exp(
tag_count,_tmp1A0->loc);else{if(!Cyc_Tcutil_is_const_exp(te,(struct Cyc_Absyn_Exp*)
_check_null(_tmp1A0->tag))){const char*_tmp352;void*_tmp351[2];struct Cyc_String_pa_struct
_tmp350;struct Cyc_String_pa_struct _tmp34F;(_tmp34F.tag=0,((_tmp34F.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*(*_tmp1A0->name).f2),((_tmp350.tag=0,((
_tmp350.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*v),((_tmp351[0]=&
_tmp350,((_tmp351[1]=& _tmp34F,Cyc_Tcutil_terr(loc,((_tmp352="enum %s, field %s: expression is not constant",
_tag_dyneither(_tmp352,sizeof(char),46))),_tag_dyneither(_tmp351,sizeof(void*),2)))))))))))));}}{
unsigned int _tmp1AA;int _tmp1AB;struct _tuple4 _tmp1A9=Cyc_Evexp_eval_const_uint_exp((
struct Cyc_Absyn_Exp*)_check_null(_tmp1A0->tag));_tmp1AA=_tmp1A9.f1;_tmp1AB=
_tmp1A9.f2;if(!_tmp1AB){const char*_tmp355;void*_tmp354;(_tmp354=0,Cyc_Tcutil_terr(
loc,((_tmp355="Cyclone enum tags cannot use sizeof or offsetof",_tag_dyneither(
_tmp355,sizeof(char),48))),_tag_dyneither(_tmp354,sizeof(void*),0)));}tag_count=
_tmp1AA + 1;{union Cyc_Absyn_Nmspace_union _tmp356;(*_tmp1A0->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp356.Abs_n).tag=2,(((_tmp356.Abs_n).f1=te->ns,_tmp356))));}}}};_pop_region(
uprev_rgn);}{struct _handler_cons _tmp1AF;_push_handler(& _tmp1AF);{int _tmp1B1=0;
if(setjmp(_tmp1AF.handler))_tmp1B1=1;if(!_tmp1B1){{struct Cyc_Absyn_Enumdecl**
_tmp1B2=((struct Cyc_Absyn_Enumdecl**(*)(struct Cyc_Dict_Dict d,struct
...
if(_tmp1B5 != Cyc_Dict_Absent)goto _LLFD;_LLFC: {struct Cyc_Absyn_Enumdecl**_tmp357;
struct Cyc_Absyn_Enumdecl**_tmp1B6=(_tmp357=_cycalloc(sizeof(*_tmp357)),((_tmp357[
0]=ed,_tmp357)));ge->enumdecls=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,
struct _dyneither_ptr*k,struct Cyc_Absyn_Enumdecl**v))Cyc_Dict_insert)(ge->enumdecls,
v,_tmp1B6);goto _LLFA;}_LLFD:;_LLFE:(void)_throw(_tmp1B5);_LLFA:;}}}if(ed->fields
!= 0){struct Cyc_List_List*fs=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)
_check_null(ed->fields))->v;for(0;fs != 0;fs=fs->tl){struct Cyc_Absyn_Enumfield*
_tmp1B8=(struct Cyc_Absyn_Enumfield*)fs->hd;struct Cyc_Tcenv_EnumRes_struct*
_tmp35D;struct Cyc_Tcenv_EnumRes_struct _tmp35C;struct _tuple7*_tmp35B;ge->ordinaries=((
struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct _tuple7*
v))Cyc_Dict_insert)(ge->ordinaries,(*_tmp1B8->name).f2,(struct _tuple7*)((_tmp35B=
_cycalloc(sizeof(*_tmp35B)),((_tmp35B->f1=(void*)((_tmp35D=_cycalloc(sizeof(*
_tmp35D)),((_tmp35D[0]=((_tmp35C.tag=3,((_tmp35C.f1=ed,((_tmp35C.f2=_tmp1B8,
_tmp35C)))))),_tmp35D)))),((_tmp35B->f2=1,_tmp35B)))))));}}}static int Cyc_Tc_okay_externC(
struct Cyc_Position_Segment*loc,void*sc);static int Cyc_Tc_okay_externC(struct Cyc_Position_Segment*
loc,void*sc){void*_tmp1BC=sc;_LL100: if((int)_tmp1BC != 0)goto _LL102;_LL101:{const
char*_tmp360;void*_tmp35F;(_tmp35F=0,Cyc_Tcutil_warn(loc,((_tmp360="static declaration nested within extern \"C\"",
_tag_dyneither(_tmp360,sizeof(char),44))),_tag_dyneither(_tmp35F,sizeof(void*),0)));}
return 0;_LL102: if((int)_tmp1BC != 1)goto _LL104;_LL103:{const char*_tmp363;void*
_tmp362;(_tmp362=0,Cyc_Tcutil_warn(loc,((_tmp363="abstract declaration nested within extern \"C\"",
_tag_dyneither(_tmp363,sizeof(char),46))),_tag_dyneither(_tmp362,sizeof(void*),0)));}
return 0;_LL104: if((int)_tmp1BC != 2)goto _LL106;_LL105: goto _LL107;_LL106: if((int)
_tmp1BC != 5)goto _LL108;_LL107: goto _LL109;_LL108: if((int)_tmp1BC != 3)goto _LL10A;
_LL109: return 1;_LL10A: if((int)_tmp1BC != 4)goto _LLFF;_LL10B:{const char*_tmp366;
void*_tmp365;(_tmp365=0,Cyc_Tcutil_warn(loc,((_tmp366="nested extern \"C\" declaration",
_tag_dyneither(_tmp366,sizeof(char),30))),_tag_dyneither(_tmp365,sizeof(void*),0)));}
...
_LL10C;_LL111:;_LL112:{const char*_tmp36A;void*_tmp369[1];struct Cyc_String_pa_struct
_tmp368;(_tmp368.tag=0,((_tmp368.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp1C5)),((_tmp369[0]=& _tmp368,Cyc_Tcutil_terr(_tmp1C4,((
_tmp36A="qualified export variables are not implemented (%s)",_tag_dyneither(
_tmp36A,sizeof(char),52))),_tag_dyneither(_tmp369,sizeof(void*),1)))))));}
return;_LL10C:;}{union Cyc_Absyn_Nmspace_union _tmp36B;(*_tmp1C5).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp36B.Abs_n).tag=2,(((_tmp36B.Abs_n).f1=te->ns,_tmp36B))));}}}static void Cyc_Tc_tc_decls(
...
struct Cyc_List_List*_tmp1D1=ds0;for(0;_tmp1D1 != 0;(last=_tmp1D1,_tmp1D1=_tmp1D1->tl)){
struct Cyc_Absyn_Decl*d=(struct Cyc_Absyn_Decl*)_tmp1D1->hd;struct Cyc_Position_Segment*
loc=d->loc;void*_tmp1D2=(void*)d->r;struct Cyc_Absyn_Vardecl*_tmp1D3;struct Cyc_Absyn_Fndecl*
...
goto _LL118;_LL117:{const char*_tmp36E;void*_tmp36D;(_tmp36D=0,Cyc_Tcutil_terr(loc,((
_tmp36E="top level let-declarations are not implemented",_tag_dyneither(_tmp36E,
sizeof(char),47))),_tag_dyneither(_tmp36D,sizeof(void*),0)));}goto _LL113;_LL118:
if(*((int*)_tmp1D2)!= 4)goto _LL11A;_LL119:{const char*_tmp371;void*_tmp370;(
_tmp370=0,Cyc_Tcutil_terr(loc,((_tmp371="top level region declarations are not implemented",
_tag_dyneither(_tmp371,sizeof(char),50))),_tag_dyneither(_tmp370,sizeof(void*),0)));}
goto _LL113;_LL11A: if(*((int*)_tmp1D2)!= 5)goto _LL11C;_LL11B:{const char*_tmp374;
void*_tmp373;(_tmp373=0,Cyc_Tcutil_terr(loc,((_tmp374="top level alias declarations are not implemented",
_tag_dyneither(_tmp374,sizeof(char),49))),_tag_dyneither(_tmp373,sizeof(void*),0)));}
goto _LL113;_LL11C: if(*((int*)_tmp1D2)!= 0)goto _LL11E;_tmp1D3=((struct Cyc_Absyn_Var_d_struct*)
...
_tmp375;struct Cyc_List_List tmp=(_tmp375.hd=(struct Cyc_Absyn_Decl*)_tmp1D1->hd,((
_tmp375.tl=_tmp1D1->tl,_tmp375)));(struct Cyc_Absyn_Decl*)(_tmp1D1->hd=(void*)((
...
const char*_tmp378;void*_tmp377;(_tmp377=0,Cyc_Tcutil_warn(d->loc,((_tmp378="spurious __cyclone_port_on__",
_tag_dyneither(_tmp378,sizeof(char),29))),_tag_dyneither(_tmp377,sizeof(void*),0)));}
goto _LL113;_LL12A: if((int)_tmp1D2 != 1)goto _LL12C;_LL12B: goto _LL113;_LL12C: if(
_tmp1D2 <= (void*)2)goto _LL12E;if(*((int*)_tmp1D2)!= 10)goto _LL12E;_tmp1D9=((
...
_tmp379;struct Cyc_List_List*_tmp1F3=((struct Cyc_List_List*(*)(struct Cyc_List_List*
x,struct Cyc_List_List*y))Cyc_List_append)(_tmp1F2,((_tmp379=_cycalloc(sizeof(*
_tmp379)),((_tmp379->hd=_tmp1D9,((_tmp379->tl=0,_tmp379)))))));if(!((int(*)(
struct Cyc_Set_Set*s,struct _dyneither_ptr*elt))Cyc_Set_member)(ge->namespaces,
_tmp1D9)){ge->namespaces=((struct Cyc_Set_Set*(*)(struct _RegionHandle*r,struct Cyc_Set_Set*
s,struct _dyneither_ptr*elt))Cyc_Set_rinsert)(grgn,ge->namespaces,_tmp1D9);te->ae=((
...
_tmp1FF=_tmp1FD.tl;_LL143: first=_tmp1FE;{struct Cyc_List_List*_tmp37A;rest=((
struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(
_tmp1FF,((_tmp37A=_cycalloc(sizeof(*_tmp37A)),((_tmp37A->hd=_tmp1DE,((_tmp37A->tl=
0,_tmp37A)))))));}goto _LL139;_LL139:;}{struct Cyc_List_List*_tmp201=Cyc_Tcenv_resolve_namespace(
te,loc,first,rest);{struct Cyc_List_List*_tmp37B;ge->availables=(struct Cyc_List_List*)((
_tmp37B=_cycalloc(sizeof(*_tmp37B)),((_tmp37B->hd=_tmp201,((_tmp37B->tl=ge->availables,
_tmp37B))))));}Cyc_Tc_tc_decls(te,_tmp1DF,in_externC,in_externCinclude,
...
_tuple6*)_tmp1E2->hd;if(!(*_tmp203).f3){const char*_tmp37F;void*_tmp37E[1];struct
Cyc_String_pa_struct _tmp37D;(_tmp37D.tag=0,((_tmp37D.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_qvar2string((*_tmp203).f2)),((_tmp37E[0]=&
_tmp37D,Cyc_Tcutil_warn((*_tmp203).f1,((_tmp37F="%s is exported but not defined",
_tag_dyneither(_tmp37F,sizeof(char),31))),_tag_dyneither(_tmp37E,sizeof(void*),1)))))));}}
...
d){void*_tmp207=(void*)d->r;struct Cyc_Absyn_Vardecl*_tmp208;struct Cyc_List_List*
...
_tmp20F;struct Cyc_List_List**_tmp210;_LL145: if(_tmp207 <= (void*)2)goto _LL14F;if(*((
int*)_tmp207)!= 0)goto _LL147;_tmp208=((struct Cyc_Absyn_Var_d_struct*)_tmp207)->f1;
_LL146: if(env->in_cinclude  || (void*)_tmp208->sc != (void*)3  && (void*)_tmp208->sc
!= (void*)4)return 1;{struct _tuple0 _tmp212;union Cyc_Absyn_Nmspace_union _tmp213;
struct _dyneither_ptr*_tmp214;struct _tuple0*_tmp211=_tmp208->name;_tmp212=*
_tmp211;_tmp213=_tmp212.f1;_tmp214=_tmp212.f2;{struct Cyc_List_List*ns;{union Cyc_Absyn_Nmspace_union
_tmp215=_tmp213;struct Cyc_List_List*_tmp216;struct Cyc_List_List*_tmp217;_LL152:
if((_tmp215.Loc_n).tag != 0)goto _LL154;_LL153: ns=0;goto _LL151;_LL154: if((_tmp215.Rel_n).tag
...
_RegionHandle*rgn,struct Cyc_Tcenv_Genv*ge){struct _tuple12*_tmp380;return(_tmp380=
_region_malloc(rgn,sizeof(*_tmp380)),((_tmp380->f1=ge,((_tmp380->f2=((struct Cyc_Set_Set*(*)(
struct _RegionHandle*r,int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))
Cyc_Set_rempty)(rgn,Cyc_strptrcmp),_tmp380)))));}struct _tuple13{struct Cyc_List_List*
...
te,struct Cyc_List_List*ds){struct _RegionHandle _tmp21C=_new_region("rgn");struct
_RegionHandle*rgn=& _tmp21C;_push_region(rgn);{struct Cyc_Tc_TreeshakeEnv _tmp381;
struct Cyc_Tc_TreeshakeEnv _tmp21D=(_tmp381.rgn=rgn,((_tmp381.in_cinclude=0,((
_tmp381.nsdict=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,struct _tuple12*(*f)(
struct _RegionHandle*,struct Cyc_Tcenv_Genv*),struct _RegionHandle*env,struct Cyc_Dict_Dict
d))Cyc_Dict_rmap_c)(rgn,Cyc_Tc_treeshake_make_env_f,rgn,te->ae),_tmp381)))));
