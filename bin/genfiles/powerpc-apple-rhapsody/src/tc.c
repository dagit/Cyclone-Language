...
struct Cyc_Tc_TreeshakeEnv _tmp266;_tmp266.rgn=rgn;_tmp266.in_cinclude=0;_tmp266.nsdict=((
...
d))Cyc_Dict_rmap_c)(rgn,Cyc_Tc_treeshake_make_env_f,rgn,te->ae);_tmp266;});
