...
if(_tmpE != 0)goto _LL5;_LL4: goto _LL0;_LL5:;_LL6:{const char*_tmp26A;void*_tmp269[1];
struct Cyc_String_pa_struct _tmp268;(_tmp268.tag=0,((_tmp268.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name)),((
_tmp269[0]=& _tmp268,Cyc_Tcutil_terr(loc,((_tmp26A="qualified variable declarations are not implemented (%s)",
_tag_dyneither(_tmp26A,sizeof(char),57))),_tag_dyneither(_tmp269,sizeof(void*),1)))))));}
...
const char*_tmp26D;void*_tmp26C;(_tmp26C=0,Cyc_Tcutil_terr(loc,((_tmp26D="extern declaration should not have initializer",
_tag_dyneither(_tmp26D,sizeof(char),47))),_tag_dyneither(_tmp26C,sizeof(void*),0)));}}
...
_LL2C: continue;_LL2D:;_LL2E:{const char*_tmp272;void*_tmp271[2];struct Cyc_String_pa_struct
_tmp270;struct Cyc_String_pa_struct _tmp26F;(_tmp26F.tag=0,((_tmp26F.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name)),((
_tmp270.tag=0,((_tmp270.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((
void*)_tmpB->hd)),((_tmp271[0]=& _tmp270,((_tmp271[1]=& _tmp26F,Cyc_Tcutil_terr(
loc,((_tmp272="bad attribute %s for variable %s",_tag_dyneither(_tmp272,sizeof(
char),33))),_tag_dyneither(_tmp271,sizeof(void*),2)))))))))))));}goto _LL1C;_LL1C:;}
if(_tmpA == 0  || ignore_init){if(check_var_init  && !Cyc_Tcutil_supports_default(
_tmp9)){const char*_tmp277;void*_tmp276[2];struct Cyc_String_pa_struct _tmp275;
struct Cyc_String_pa_struct _tmp274;(_tmp274.tag=0,((_tmp274.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp9)),((_tmp275.tag=
0,((_tmp275.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
vd->name)),((_tmp276[0]=& _tmp275,((_tmp276[1]=& _tmp274,Cyc_Tcutil_terr(loc,((
_tmp277="initializer required for variable %s of type %s",_tag_dyneither(_tmp277,
sizeof(char),48))),_tag_dyneither(_tmp276,sizeof(void*),2)))))))))))));}}else{
...
char*_tmp27D;void*_tmp27C[3];struct Cyc_String_pa_struct _tmp27B;struct Cyc_String_pa_struct
_tmp27A;struct Cyc_String_pa_struct _tmp279;(_tmp279.tag=0,((_tmp279.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp3A)),((_tmp27A.tag=
0,((_tmp27A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
_tmp9)),((_tmp27B.tag=0,((_tmp27B.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name)),((_tmp27C[0]=& _tmp27B,((
_tmp27C[1]=& _tmp27A,((_tmp27C[2]=& _tmp279,Cyc_Tcutil_terr(loc,((_tmp27D="%s declared with type \n%s\n but initialized with type \n%s",
_tag_dyneither(_tmp27D,sizeof(char),57))),_tag_dyneither(_tmp27C,sizeof(void*),3)))))))))))))))))));}
Cyc_Tcutil_explain_failure();}if(!Cyc_Tcutil_is_const_exp(te,_tmp39)){const char*
_tmp280;void*_tmp27F;(_tmp27F=0,Cyc_Tcutil_terr(loc,((_tmp280="initializer is not a constant expression",
_tag_dyneither(_tmp280,sizeof(char),41))),_tag_dyneither(_tmp27F,sizeof(void*),0)));}}}
...
_tmp42;if(_tmp4B->tag != 5)goto _LL42;}_LL41: {const char*_tmp283;void*_tmp282;(
_tmp282=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp283="tcVardecl: fn type atts in function var decl",_tag_dyneither(_tmp283,
sizeof(char),45))),_tag_dyneither(_tmp282,sizeof(void*),0)));}_LL42: {struct Cyc_Absyn_Aligned_att_struct*
...
_tmp42;if(_tmp4D->tag != 7)goto _LL46;}_LL45:{const char*_tmp287;void*_tmp286[1];
...
_tmp286[0]=& _tmp285,Cyc_Tcutil_terr(loc,((_tmp287="bad attribute %s in function declaration",
_tag_dyneither(_tmp287,sizeof(char),41))),_tag_dyneither(_tmp286,sizeof(void*),1)))))));}
...
struct Cyc_Absyn_Global_b_struct _tmp28A;struct Cyc_Absyn_Global_b_struct*_tmp289;
struct Cyc_Absyn_Global_b_struct*_tmp5E=(_tmp289=_cycalloc(sizeof(*_tmp289)),((
_tmp289[0]=((_tmp28A.tag=1,((_tmp28A.f1=vd,_tmp28A)))),_tmp289)));void*_tmp5F=
...
vd->name,*exports)){struct Cyc_Tcenv_VarRes_struct*_tmp290;struct Cyc_Tcenv_VarRes_struct
_tmp28F;struct _tuple13*_tmp28E;ge->ordinaries=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct _dyneither_ptr*k,struct _tuple13*v))Cyc_Dict_insert)(ge->ordinaries,_tmp8,(
struct _tuple13*)((_tmp28E=_cycalloc(sizeof(*_tmp28E)),((_tmp28E->f1=(void*)((
_tmp290=_cycalloc(sizeof(*_tmp290)),((_tmp290[0]=((_tmp28F.tag=0,((_tmp28F.f1=(
void*)_tmp5F,_tmp28F)))),_tmp290)))),((_tmp28E->f2=1,_tmp28E)))))));}
...
_tmp293;void*_tmp292;(_tmp292=0,Cyc_Tcutil_warn(loc,((_tmp293="variable declaration shadows previous struct declaration",
_tag_dyneither(_tmp293,sizeof(char),57))),_tag_dyneither(_tmp292,sizeof(void*),0)));}
goto _LL48;_LL4D: {struct Cyc_Tcenv_DatatypeRes_struct*_tmp5B=(struct Cyc_Tcenv_DatatypeRes_struct*)
_tmp57;if(_tmp5B->tag != 2)goto _LL4F;}_LL4E:{const char*_tmp296;void*_tmp295;(
_tmp295=0,Cyc_Tcutil_warn(loc,((_tmp296="variable declaration shadows previous datatype constructor",
_tag_dyneither(_tmp296,sizeof(char),59))),_tag_dyneither(_tmp295,sizeof(void*),0)));}
...
_LL52:{const char*_tmp299;void*_tmp298;(_tmp298=0,Cyc_Tcutil_warn(loc,((_tmp299="variable declaration shadows previous enum tag",
_tag_dyneither(_tmp299,sizeof(char),47))),_tag_dyneither(_tmp298,sizeof(void*),0)));}
...
exports)){struct Cyc_Tcenv_VarRes_struct*_tmp2A8;struct Cyc_Absyn_Global_b_struct*
_tmp2A7;struct Cyc_Absyn_Global_b_struct _tmp2A6;struct Cyc_Tcenv_VarRes_struct
_tmp2A5;struct _tuple13*_tmp2A4;ge->ordinaries=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct _dyneither_ptr*k,struct _tuple13*v))Cyc_Dict_insert)(ge->ordinaries,_tmp8,(
struct _tuple13*)((_tmp2A4=_cycalloc(sizeof(*_tmp2A4)),((_tmp2A4->f1=(void*)((
_tmp2A8=_cycalloc(sizeof(*_tmp2A8)),((_tmp2A8[0]=((_tmp2A5.tag=0,((_tmp2A5.f1=(
void*)((void*)((_tmp2A7=_cycalloc(sizeof(*_tmp2A7)),((_tmp2A7[0]=((_tmp2A6.tag=1,((
_tmp2A6.f1=vd,_tmp2A6)))),_tmp2A7))))),_tmp2A5)))),_tmp2A8)))),((_tmp2A4->f2=0,
_tmp2A4)))))));}}static int Cyc_Tc_is_main(struct _tuple0*n);static int Cyc_Tc_is_main(
...
if(_tmp78 != 0)goto _LL5B;_LL5A: {const char*_tmp2A9;return Cyc_strcmp((struct
_dyneither_ptr)*_tmp76,((_tmp2A9="main",_tag_dyneither(_tmp2A9,sizeof(char),5))))
...
const char*_tmp2AC;void*_tmp2AB;(_tmp2AB=0,Cyc_Tcutil_terr(loc,((_tmp2AC="extern \"C\" functions cannot be implemented in Cyclone",
_tag_dyneither(_tmp2AC,sizeof(char),54))),_tag_dyneither(_tmp2AB,sizeof(void*),0)));}{
...
_tmp2AF;void*_tmp2AE;(_tmp2AE=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp2AF="tc: Abs_n in tcFndecl",
_tag_dyneither(_tmp2AF,sizeof(char),22))),_tag_dyneither(_tmp2AE,sizeof(void*),0)));}
_LL62:;_LL63:{const char*_tmp2B3;void*_tmp2B2[1];struct Cyc_String_pa_struct
_tmp2B1;(_tmp2B1.tag=0,((_tmp2B1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(fd->name)),((_tmp2B2[0]=& _tmp2B1,Cyc_Tcutil_terr(loc,((
_tmp2B3="qualified function declarations are not implemented (%s)",
_tag_dyneither(_tmp2B3,sizeof(char),57))),_tag_dyneither(_tmp2B2,sizeof(void*),1)))))));}
...
_tmp84;if(_tmp86->tag != 6)goto _LL69;}_LL68:{const char*_tmp2B7;void*_tmp2B6[1];
struct Cyc_String_pa_struct _tmp2B5;(_tmp2B5.tag=0,((_tmp2B5.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)atts->hd)),((
_tmp2B6[0]=& _tmp2B5,Cyc_Tcutil_terr(loc,((_tmp2B7="bad attribute %s for function",
_tag_dyneither(_tmp2B7,sizeof(char),30))),_tag_dyneither(_tmp2B6,sizeof(void*),1)))))));}
...
struct Cyc_Absyn_Funname_b_struct _tmp2BA;struct Cyc_Absyn_Funname_b_struct*_tmp2B9;
struct Cyc_Absyn_Funname_b_struct*_tmp95=(_tmp2B9=_cycalloc(sizeof(*_tmp2B9)),((
_tmp2B9[0]=((_tmp2BA.tag=2,((_tmp2BA.f1=fd,_tmp2BA)))),_tmp2B9)));void*_tmp96=
...
_tmp2C0;struct Cyc_Tcenv_VarRes_struct _tmp2BF;struct _tuple13*_tmp2BE;ge->ordinaries=((
struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct
_tuple13*v))Cyc_Dict_insert)(ge->ordinaries,v,(struct _tuple13*)((_tmp2BE=
_cycalloc(sizeof(*_tmp2BE)),((_tmp2BE->f1=(void*)((_tmp2C0=_cycalloc(sizeof(*
_tmp2C0)),((_tmp2C0[0]=((_tmp2BF.tag=0,((_tmp2BF.f1=(void*)_tmp96,_tmp2BF)))),
_tmp2C0)))),((_tmp2BE->f2=1,_tmp2BE)))))));}goto _LL6B;}_LL6E: {struct Cyc_Tcenv_AggrRes_struct*
_tmp91=(struct Cyc_Tcenv_AggrRes_struct*)_tmp8E;if(_tmp91->tag != 1)goto _LL70;}
_LL6F:{const char*_tmp2C3;void*_tmp2C2;(_tmp2C2=0,Cyc_Tcutil_warn(loc,((_tmp2C3="function declaration shadows previous type declaration",
_tag_dyneither(_tmp2C3,sizeof(char),55))),_tag_dyneither(_tmp2C2,sizeof(void*),0)));}
goto _LL6B;_LL70: {struct Cyc_Tcenv_DatatypeRes_struct*_tmp92=(struct Cyc_Tcenv_DatatypeRes_struct*)
_tmp8E;if(_tmp92->tag != 2)goto _LL72;}_LL71:{const char*_tmp2C6;void*_tmp2C5;(
_tmp2C5=0,Cyc_Tcutil_warn(loc,((_tmp2C6="function declaration shadows previous datatype constructor",
_tag_dyneither(_tmp2C6,sizeof(char),59))),_tag_dyneither(_tmp2C5,sizeof(void*),0)));}
...
_LL75:{const char*_tmp2C9;void*_tmp2C8;(_tmp2C8=0,Cyc_Tcutil_warn(loc,((_tmp2C9="function declaration shadows previous enum tag",
_tag_dyneither(_tmp2C9,sizeof(char),47))),_tag_dyneither(_tmp2C8,sizeof(void*),0)));}
...
fd->name,*exports)){struct Cyc_Tcenv_VarRes_struct*_tmp2D8;struct Cyc_Absyn_Funname_b_struct*
_tmp2D7;struct Cyc_Absyn_Funname_b_struct _tmp2D6;struct Cyc_Tcenv_VarRes_struct
_tmp2D5;struct _tuple13*_tmp2D4;ge->ordinaries=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct _dyneither_ptr*k,struct _tuple13*v))Cyc_Dict_insert)(ge->ordinaries,v,(
struct _tuple13*)((_tmp2D4=_cycalloc(sizeof(*_tmp2D4)),((_tmp2D4->f1=(void*)((
_tmp2D8=_cycalloc(sizeof(*_tmp2D8)),((_tmp2D8[0]=((_tmp2D5.tag=0,((_tmp2D5.f1=(
void*)((void*)((_tmp2D7=_cycalloc(sizeof(*_tmp2D7)),((_tmp2D7[0]=((_tmp2D6.tag=2,((
_tmp2D6.f1=fd,_tmp2D6)))),_tmp2D7))))),_tmp2D5)))),_tmp2D8)))),((_tmp2D4->f2=0,
_tmp2D4)))))));}goto _LL76;_LL79:;_LL7A:(void)_throw(_tmpA3);_LL76:;}};}if(
...
fnrgn,loc,fd);struct Cyc_Tcenv_Tenv*_tmp2D9;struct Cyc_Tcenv_Tenv*_tmpAC=(_tmp2D9=
_region_malloc(fnrgn,sizeof(*_tmp2D9)),((_tmp2D9->ns=te->ns,((_tmp2D9->ae=te->ae,((
_tmp2D9->le=(struct Cyc_Tcenv_Fenv*)_tmpAB,((_tmp2D9->allow_valueof=0,_tmp2D9)))))))));
Cyc_Tcstmt_tcStmt(_tmpAC,fd->body,0);Cyc_Tcenv_check_delayed_effects(_tmpAC);Cyc_Tcenv_check_delayed_constraints(
_tmpAC);if(!Cyc_Tcenv_all_labels_resolved(_tmpAC)){const char*_tmp2DC;void*
_tmp2DB;(_tmp2DB=0,Cyc_Tcutil_terr(loc,((_tmp2DC="function has goto statements to undefined labels",
_tag_dyneither(_tmp2DC,sizeof(char),49))),_tag_dyneither(_tmp2DB,sizeof(void*),0)));}}
...
const char*_tmp2DF;void*_tmp2DE;(_tmp2DE=0,Cyc_Tcutil_warn(loc,((_tmp2DF="main declared with return type void",
_tag_dyneither(_tmp2DF,sizeof(char),36))),_tag_dyneither(_tmp2DE,sizeof(void*),0)));}
...
_LL80:;_LL81:{const char*_tmp2E3;void*_tmp2E2[1];struct Cyc_String_pa_struct
_tmp2E1;(_tmp2E1.tag=0,((_tmp2E1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(fd->ret_type)),((_tmp2E2[0]=& _tmp2E1,Cyc_Tcutil_terr(loc,((
_tmp2E3="main declared with return type %s instead of int or void",
_tag_dyneither(_tmp2E3,sizeof(char),57))),_tag_dyneither(_tmp2E2,sizeof(void*),1)))))));}
goto _LL7B;_LL7B:;}if(fd->c_varargs  || fd->cyc_varargs != 0){const char*_tmp2E6;
void*_tmp2E5;(_tmp2E5=0,Cyc_Tcutil_terr(loc,((_tmp2E6="main declared with varargs",
_tag_dyneither(_tmp2E6,sizeof(char),27))),_tag_dyneither(_tmp2E5,sizeof(void*),0)));}{
...
_LL85:;_LL86:{const char*_tmp2EA;void*_tmp2E9[1];struct Cyc_String_pa_struct
_tmp2E8;(_tmp2E8.tag=0,((_tmp2E8.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(_tmpBE)),((_tmp2E9[0]=& _tmp2E8,Cyc_Tcutil_terr(loc,((
_tmp2EA="main declared with first argument of type %s instead of int",
_tag_dyneither(_tmp2EA,sizeof(char),60))),_tag_dyneither(_tmp2E9,sizeof(void*),1)))))));}
...
_tmpC6.f3;_tmpBB=_tmpBB->tl;if(_tmpBB != 0){const char*_tmp2ED;void*_tmp2EC;(
_tmp2EC=0,Cyc_Tcutil_terr(loc,((_tmp2ED="main declared with too many arguments",
_tag_dyneither(_tmp2ED,sizeof(char),38))),_tag_dyneither(_tmp2EC,sizeof(void*),0)));}{
struct Cyc_Core_Opt*_tmp2EE;struct Cyc_Core_Opt*tvs=(_tmp2EE=_cycalloc(sizeof(*
_tmp2EE)),((_tmp2EE->v=fd->tvs,_tmp2EE)));struct Cyc_Core_Opt*_tmp2F6;struct Cyc_Core_Opt*
_tmp2F5;struct Cyc_Core_Opt*_tmp2F4;struct Cyc_Core_Opt*_tmp2F3;struct Cyc_Core_Opt*
_tmp2F2;struct Cyc_Core_Opt*_tmp2F1;struct Cyc_Core_Opt*_tmp2F0;struct Cyc_Core_Opt*
_tmp2EF;if(((!Cyc_Tcutil_unify(_tmpC7,Cyc_Absyn_dyneither_typ(Cyc_Absyn_string_typ(
Cyc_Absyn_new_evar(((_tmp2F5=_cycalloc_atomic(sizeof(*_tmp2F5)),((_tmp2F5->v=(
void*)Cyc_Absyn_RgnKind,_tmp2F5)))),tvs)),Cyc_Absyn_new_evar(((_tmp2F6=
_cycalloc_atomic(sizeof(*_tmp2F6)),((_tmp2F6->v=(void*)Cyc_Absyn_RgnKind,_tmp2F6)))),
...
Cyc_Absyn_new_evar(((_tmp2F3=_cycalloc_atomic(sizeof(*_tmp2F3)),((_tmp2F3->v=(
void*)Cyc_Absyn_RgnKind,_tmp2F3)))),tvs)),Cyc_Absyn_new_evar(((_tmp2F4=
_cycalloc_atomic(sizeof(*_tmp2F4)),((_tmp2F4->v=(void*)Cyc_Absyn_RgnKind,_tmp2F4)))),
tvs),Cyc_Absyn_empty_tqual(0),((union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)())))
 && !Cyc_Tcutil_unify(_tmpC7,Cyc_Absyn_dyneither_typ(Cyc_Absyn_string_typ(Cyc_Absyn_new_evar(((
_tmp2F1=_cycalloc_atomic(sizeof(*_tmp2F1)),((_tmp2F1->v=(void*)Cyc_Absyn_RgnKind,
_tmp2F1)))),tvs)),Cyc_Absyn_new_evar(((_tmp2F2=_cycalloc_atomic(sizeof(*_tmp2F2)),((
_tmp2F2->v=(void*)Cyc_Absyn_RgnKind,_tmp2F2)))),tvs),Cyc_Absyn_const_tqual(0),((
...
_tmp2EF=_cycalloc_atomic(sizeof(*_tmp2EF)),((_tmp2EF->v=(void*)Cyc_Absyn_RgnKind,
_tmp2EF)))),tvs)),Cyc_Absyn_new_evar(((_tmp2F0=_cycalloc_atomic(sizeof(*_tmp2F0)),((
_tmp2F0->v=(void*)Cyc_Absyn_RgnKind,_tmp2F0)))),tvs),Cyc_Absyn_const_tqual(0),((
union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)()))){const char*_tmp2FA;
...
_tmp2F9[0]=& _tmp2F8,Cyc_Tcutil_terr(loc,((_tmp2FA="second argument of main has type %s instead of char??",
_tag_dyneither(_tmp2FA,sizeof(char),54))),_tag_dyneither(_tmp2F9,sizeof(void*),1)))))));}};}}};};
...
_LL8C:;_LL8D:{const char*_tmp2FE;void*_tmp2FD[1];struct Cyc_String_pa_struct
_tmp2FC;(_tmp2FC.tag=0,((_tmp2FC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(td->name)),((_tmp2FD[0]=& _tmp2FC,Cyc_Tcutil_terr(loc,((
_tmp2FE="qualified typedef declarations are not implemented (%s)",_tag_dyneither(
_tmp2FE,sizeof(char),56))),_tag_dyneither(_tmp2FD,sizeof(void*),1)))))));}
return;_LL87:;}if(((int(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_member)(
ge->typedefs,v)){{const char*_tmp302;void*_tmp301[1];struct Cyc_String_pa_struct
_tmp300;(_tmp300.tag=0,((_tmp300.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
v),((_tmp301[0]=& _tmp300,Cyc_Tcutil_terr(loc,((_tmp302="redeclaration of typedef %s",
_tag_dyneither(_tmp302,sizeof(char),28))),_tag_dyneither(_tmp301,sizeof(void*),1)))))));}
...
!= 0){const char*_tmp306;void*_tmp305[1];struct Cyc_String_pa_struct _tmp304;(
_tmp304.tag=0,((_tmp304.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((
struct Cyc_Absyn_Tvar*)tvs->hd)->name),((_tmp305[0]=& _tmp304,Cyc_Tcutil_warn(loc,((
_tmp306="type variable %s is not used in typedef definition",_tag_dyneither(
_tmp306,sizeof(char),51))),_tag_dyneither(_tmp305,sizeof(void*),1)))))));}{
struct Cyc_Core_Opt*_tmp307;*_tmpE2=((_tmp307=_cycalloc(sizeof(*_tmp307)),((
_tmp307->v=Cyc_Tcutil_kind_to_bound(Cyc_Absyn_BoxKind),_tmp307))));}goto _LL8E;
...
_tmpE3->f1;_tmpE6=_tmpE3->f2;}}_LL92:{struct Cyc_Core_Opt*_tmp308;*_tmpE5=((
_tmp308=_cycalloc(sizeof(*_tmp308)),((_tmp308->v=Cyc_Tcutil_kind_to_bound(_tmpE6),
_tmp308))));}goto _LL8E;_LL93:;_LL94: continue;_LL8E:;}}ge->typedefs=((struct Cyc_Dict_Dict(*)(
...
_tmp30C;void*_tmp30B[1];struct Cyc_String_pa_struct _tmp30A;(_tmp30A.tag=0,((
_tmp30A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmpF4),((_tmp30B[0]=&
_tmp30A,Cyc_Tcutil_terr(loc,((_tmp30C="duplicate field %s",_tag_dyneither(
_tmp30C,sizeof(char),19))),_tag_dyneither(_tmp30B,sizeof(void*),1)))))));}{const
char*_tmp30D;if(Cyc_strcmp((struct _dyneither_ptr)*_tmpF4,((_tmp30D="",
_tag_dyneither(_tmp30D,sizeof(char),1))))!= 0){struct Cyc_List_List*_tmp30E;
prev_fields=((_tmp30E=_region_malloc(uprev_rgn,sizeof(*_tmp30E)),((_tmp30E->hd=
_tmpF4,((_tmp30E->tl=prev_fields,_tmp30E))))));}}Cyc_Tcutil_check_type(loc,te,
...
_tmp105 != Cyc_Absyn_MemKind)goto _LL9A;}}_LL99:{struct Cyc_Core_Opt*_tmp30F;*
_tmp104=((_tmp30F=_cycalloc(sizeof(*_tmp30F)),((_tmp30F->v=Cyc_Tcutil_kind_to_bound(
Cyc_Absyn_BoxKind),_tmp30F))));}continue;_LL9A: {struct Cyc_Absyn_Less_kb_struct*
...
_tmp106->f2;}}_LL9B:{struct Cyc_Core_Opt*_tmp310;*_tmp108=((_tmp310=_cycalloc(
sizeof(*_tmp310)),((_tmp310->v=Cyc_Tcutil_kind_to_bound(_tmp109),_tmp310))));}
...
goto _LL9E;}}_LL9D:{const char*_tmp315;void*_tmp314[2];struct Cyc_String_pa_struct
_tmp313;struct Cyc_String_pa_struct _tmp312;(_tmp312.tag=0,((_tmp312.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)tvs2->hd)->name),((
_tmp313.tag=0,((_tmp313.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*n),((
_tmp314[0]=& _tmp313,((_tmp314[1]=& _tmp312,Cyc_Tcutil_terr(loc,((_tmp315="type %s attempts to abstract type variable %s of kind M",
_tag_dyneither(_tmp315,sizeof(char),56))),_tag_dyneither(_tmp314,sizeof(void*),2)))))))))))));}
...
continue;_LLA5:;_LLA6:{const char*_tmp31A;void*_tmp319[2];struct Cyc_String_pa_struct
_tmp318;struct Cyc_String_pa_struct _tmp317;(_tmp317.tag=0,((_tmp317.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*_tmp112),((_tmp318.tag=0,((_tmp318.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)
atts->hd)),((_tmp319[0]=& _tmp318,((_tmp319[1]=& _tmp317,Cyc_Tcutil_terr(loc,((
_tmp31A="bad attribute %s in  %s definition",_tag_dyneither(_tmp31A,sizeof(char),
35))),_tag_dyneither(_tmp319,sizeof(void*),2)))))))))))));}goto _LLA0;_LLA0:;}}{
...
_LLA7;_LLAC:;_LLAD:{const char*_tmp31E;void*_tmp31D[1];struct Cyc_String_pa_struct
_tmp31C;(_tmp31C.tag=0,((_tmp31C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(ad->name)),((_tmp31D[0]=& _tmp31C,Cyc_Tcutil_terr(loc,((
_tmp31E="qualified struct declarations are not implemented (%s)",_tag_dyneither(
_tmp31E,sizeof(char),55))),_tag_dyneither(_tmp31D,sizeof(void*),1)))))));}
return;_LLA7:;}(*ad->name).f1=Cyc_Absyn_Abs_n(te->ns);Cyc_Tcutil_check_unique_tvars(
loc,ad->tvs);Cyc_Tcutil_add_tvar_identities(ad->tvs);{struct _tuple15 _tmp31F;
struct _tuple15 _tmp122=(_tmp31F.f1=ad->impl,((_tmp31F.f2=((struct Cyc_Absyn_Aggrdecl***(*)(
struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup_opt)(ge->aggrdecls,
_tmp112),_tmp31F)));struct Cyc_Absyn_AggrdeclImpl*_tmp123;struct Cyc_Absyn_Aggrdecl***
...
_tmp320;ge->aggrdecls=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct
_dyneither_ptr*k,struct Cyc_Absyn_Aggrdecl**v))Cyc_Dict_insert)(ge->aggrdecls,
_tmp112,((_tmp320=_cycalloc(sizeof(*_tmp320)),((_tmp320[0]=ad,_tmp320)))));}goto
...
_tmp323;struct Cyc_Absyn_Aggrdecl**_tmp322;struct Cyc_Absyn_Aggrdecl**_tmp138=(
_tmp322=_cycalloc(sizeof(*_tmp322)),((_tmp322[0]=((_tmp323=_cycalloc(sizeof(*
_tmp323)),((_tmp323->kind=ad->kind,((_tmp323->sc=Cyc_Absyn_Extern,((_tmp323->name=
ad->name,((_tmp323->tvs=_tmp11A,((_tmp323->impl=0,((_tmp323->attributes=ad->attributes,
_tmp323)))))))))))))),_tmp322)));ge->aggrdecls=((struct Cyc_Dict_Dict(*)(struct
...
_tmp127);if(_tmp12A  && ad->kind == Cyc_Absyn_StructA){const char*_tmp326;void*
_tmp325;(_tmp325=0,Cyc_Tcutil_terr(loc,((_tmp326="@tagged qualifier is only allowed on union declarations",
_tag_dyneither(_tmp326,sizeof(char),56))),_tag_dyneither(_tmp325,sizeof(void*),0)));}
...
_tmp32C;void*_tmp32B[3];struct Cyc_String_pa_struct _tmp32A;struct Cyc_String_pa_struct
_tmp329;struct Cyc_String_pa_struct _tmp328;(_tmp328.tag=0,((_tmp328.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(((struct Cyc_Absyn_Aggrfield*)
f->hd)->type)),((_tmp329.tag=0,((_tmp329.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*_tmp112),((_tmp32A.tag=0,((_tmp32A.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)f->hd)->name),((_tmp32B[0]=&
_tmp32A,((_tmp32B[1]=& _tmp329,((_tmp32B[2]=& _tmp328,Cyc_Tcutil_warn(loc,((
_tmp32C="member %s of union %s has type %s which is not `bits-only' so it can only be written and not read",
_tag_dyneither(_tmp32C,sizeof(char),98))),_tag_dyneither(_tmp32B,sizeof(void*),3)))))))))))))))))));}}}*
...
_tmp132;_LLB4: if(ad->kind != (*_tmp133)->kind){const char*_tmp32F;void*_tmp32E;(
_tmp32E=0,Cyc_Tcutil_terr(loc,((_tmp32F="cannot reuse struct names for unions and vice-versa",
_tag_dyneither(_tmp32F,sizeof(char),52))),_tag_dyneither(_tmp32E,sizeof(void*),0)));}{
struct Cyc_Absyn_Aggrdecl*_tmp144=*_tmp133;{struct Cyc_Absyn_Aggrdecl*_tmp330;*
_tmp133=((_tmp330=_cycalloc(sizeof(*_tmp330)),((_tmp330->kind=ad->kind,((_tmp330->sc=
Cyc_Absyn_Extern,((_tmp330->name=ad->name,((_tmp330->tvs=_tmp11A,((_tmp330->impl=
0,((_tmp330->attributes=ad->attributes,_tmp330))))))))))))));}Cyc_Tcutil_check_unique_tvars(
loc,_tmp12E);Cyc_Tcutil_add_tvar_identities(_tmp12E);if(_tmp131  && ad->kind == 
Cyc_Absyn_StructA){const char*_tmp333;void*_tmp332;(_tmp332=0,Cyc_Tcutil_terr(loc,((
_tmp333="@tagged qualifier is only allowed on union declarations",_tag_dyneither(
_tmp333,sizeof(char),56))),_tag_dyneither(_tmp332,sizeof(void*),0)));}Cyc_Tc_tcAggrImpl(
...
_tmp148;goto _LLAE;}}_LLAE:;}{struct Cyc_Tcenv_AggrRes_struct*_tmp339;struct Cyc_Tcenv_AggrRes_struct
_tmp338;struct _tuple13*_tmp337;ge->ordinaries=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct _dyneither_ptr*k,struct _tuple13*v))Cyc_Dict_insert)(ge->ordinaries,
_tmp112,(struct _tuple13*)((_tmp337=_cycalloc(sizeof(*_tmp337)),((_tmp337->f1=(
void*)((_tmp339=_cycalloc(sizeof(*_tmp339)),((_tmp339[0]=((_tmp338.tag=1,((
_tmp338.f1=ad,_tmp338)))),_tmp339)))),((_tmp337->f2=1,_tmp337)))))));};};}static
...
_tmp33A;*_tmp152=((_tmp33A=_cycalloc(sizeof(*_tmp33A)),((_tmp33A->v=Cyc_Tcutil_kind_to_bound(
Cyc_Absyn_BoxKind),_tmp33A))));}goto _LLB7;_LLBC: {struct Cyc_Absyn_Less_kb_struct*
...
_tmp33B;*_tmp156=((_tmp33B=_cycalloc(sizeof(*_tmp33B)),((_tmp33B->v=Cyc_Tcutil_kind_to_bound(
Cyc_Absyn_AnyKind),_tmp33B))));}goto _LLB7;_LLBE: {struct Cyc_Absyn_Less_kb_struct*
...
_tmp33C;*_tmp15A=((_tmp33C=_cycalloc(sizeof(*_tmp33C)),((_tmp33C->v=Cyc_Tcutil_kind_to_bound(
Cyc_Absyn_RgnKind),_tmp33C))));}goto _LLB7;_LLC0: {struct Cyc_Absyn_Eq_kb_struct*
...
const char*_tmp341;void*_tmp340[2];struct Cyc_String_pa_struct _tmp33F;struct Cyc_String_pa_struct
_tmp33E;(_tmp33E.tag=0,((_tmp33E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((
struct Cyc_Absyn_Tvar*)tvs2->hd)->name),((_tmp33F.tag=0,((_tmp33F.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*v),((_tmp340[0]=& _tmp33F,((_tmp340[1]=&
_tmp33E,Cyc_Tcutil_terr(loc,((_tmp341="type %s attempts to abstract type variable %s of kind TR",
_tag_dyneither(_tmp341,sizeof(char),57))),_tag_dyneither(_tmp340,sizeof(void*),2)))))))))))));}
...
_tmp346;void*_tmp345[2];struct Cyc_String_pa_struct _tmp344;struct Cyc_String_pa_struct
_tmp343;(_tmp343.tag=0,((_tmp343.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((
struct Cyc_Absyn_Tvar*)tvs2->hd)->name),((_tmp344.tag=0,((_tmp344.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*v),((_tmp345[0]=& _tmp344,((_tmp345[1]=&
_tmp343,Cyc_Tcutil_terr(loc,((_tmp346="type %s attempts to abstract type variable %s of kind UR",
_tag_dyneither(_tmp346,sizeof(char),57))),_tag_dyneither(_tmp345,sizeof(void*),2)))))))))))));}
...
goto _LLC8;}}_LLC7:{const char*_tmp34B;void*_tmp34A[2];struct Cyc_String_pa_struct
_tmp349;struct Cyc_String_pa_struct _tmp348;(_tmp348.tag=0,((_tmp348.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)tvs2->hd)->name),((
_tmp349.tag=0,((_tmp349.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*v),((
_tmp34A[0]=& _tmp349,((_tmp34A[1]=& _tmp348,Cyc_Tcutil_terr(loc,((_tmp34B="type %s attempts to abstract type variable %s of kind M",
_tag_dyneither(_tmp34B,sizeof(char),56))),_tag_dyneither(_tmp34A,sizeof(void*),2)))))))))))));}
...
_tmp177,(*((struct _tuple16*)typs->hd)).f2)){const char*_tmp34F;void*_tmp34E[1];
...
_tmp34E[0]=& _tmp34D,Cyc_Tcutil_terr(_tmp176->loc,((_tmp34F="noalias pointers in datatypes are not allowed (%s)",
_tag_dyneither(_tmp34F,sizeof(char),51))),_tag_dyneither(_tmp34E,sizeof(void*),1)))))));}((*((
...
char*_tmp353;void*_tmp352[1];struct Cyc_String_pa_struct _tmp351;(_tmp351.tag=0,((
_tmp351.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp176->name)),((_tmp352[0]=& _tmp351,Cyc_Tcutil_terr(_tmp176->loc,((_tmp353="qualified datatypefield declarations are not allowed (%s)",
_tag_dyneither(_tmp353,sizeof(char),58))),_tag_dyneither(_tmp352,sizeof(void*),1)))))));}
...
_tmp17F=(int)(_tmp17B.Loc_n).val;_LLD2: {const char*_tmp356;void*_tmp355;(_tmp355=
0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp356="tcDatatypeFields: Loc_n",_tag_dyneither(_tmp356,sizeof(char),24))),
_tag_dyneither(_tmp355,sizeof(void*),0)));}_LLCA:;};}}{struct Cyc_List_List*
...
const char*_tmp35B;void*_tmp35A[2];struct Cyc_String_pa_struct _tmp359;struct Cyc_String_pa_struct
_tmp358;(_tmp358.tag=0,((_tmp358.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
obj),((_tmp359.tag=0,((_tmp359.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*
_tmp188->name).f2),((_tmp35A[0]=& _tmp359,((_tmp35A[1]=& _tmp358,Cyc_Tcutil_terr(
_tmp188->loc,((_tmp35B="duplicate field name %s in %s",_tag_dyneither(_tmp35B,
sizeof(char),30))),_tag_dyneither(_tmp35A,sizeof(void*),2)))))))))))));}else{
struct Cyc_List_List*_tmp35C;prev_fields=((_tmp35C=_region_malloc(uprev_rgn,
sizeof(*_tmp35C)),((_tmp35C->hd=(*_tmp188->name).f2,((_tmp35C->tl=prev_fields,
_tmp35C))))));}if(_tmp188->sc != Cyc_Absyn_Public){{const char*_tmp360;void*
_tmp35F[1];struct Cyc_String_pa_struct _tmp35E;(_tmp35E.tag=0,((_tmp35E.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*(*_tmp188->name).f2),((_tmp35F[0]=&
_tmp35E,Cyc_Tcutil_warn(loc,((_tmp360="ignoring scope of field %s",
_tag_dyneither(_tmp360,sizeof(char),27))),_tag_dyneither(_tmp35F,sizeof(void*),1)))))));}
...
_tmp366;struct Cyc_Tcenv_DatatypeRes_struct _tmp365;struct _tuple13*_tmp364;ge->ordinaries=((
struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct
_tuple13*v))Cyc_Dict_insert)(ge->ordinaries,(*_tmp192->name).f2,(struct _tuple13*)((
_tmp364=_cycalloc(sizeof(*_tmp364)),((_tmp364->f1=(void*)((_tmp366=_cycalloc(
sizeof(*_tmp366)),((_tmp366[0]=((_tmp365.tag=2,((_tmp365.f1=tudres,((_tmp365.f2=
_tmp192,_tmp365)))))),_tmp366)))),((_tmp364->f2=1,_tmp364)))))));}}return fields2;};}
...
tud){struct _dyneither_ptr*v=(*tud->name).f2;const char*_tmp368;const char*_tmp367;
struct _dyneither_ptr obj=tud->is_extensible?(_tmp368="@extensible datatype",
_tag_dyneither(_tmp368,sizeof(char),21)):((_tmp367="datatype",_tag_dyneither(
_tmp367,sizeof(char),9)));struct Cyc_List_List*tvs=tud->tvs;Cyc_Tcutil_check_unique_tvars(
...
struct Cyc_Dict_Absent_struct _tmp36B;struct Cyc_Dict_Absent_struct*_tmp36A;(int)
_throw((void*)((_tmp36A=_cycalloc_atomic(sizeof(*_tmp36A)),((_tmp36A[0]=((
_tmp36B.tag=Cyc_Dict_Absent,_tmp36B)),_tmp36A)))));}if(tud_opt != 0)tud->name=(*(*
...
_LLDD:;_LLDE:{const char*_tmp36F;void*_tmp36E[1];struct Cyc_String_pa_struct
_tmp36D;(_tmp36D.tag=0,((_tmp36D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(tud->name)),((_tmp36E[0]=& _tmp36D,Cyc_Tcutil_terr(loc,((
_tmp36F="qualified (non-extensible) datatype declarations are not implemented (%s)",
_tag_dyneither(_tmp36F,sizeof(char),74))),_tag_dyneither(_tmp36E,sizeof(void*),1)))))));}
...
ge->datatypedecls,v);{struct Cyc_Absyn_Datatypedecl***_tmp370;tud_opt=(
unsigned int)_tmp1A5?(_tmp370=_region_malloc(temp,sizeof(*_tmp370)),((_tmp370[0]=*
_tmp1A5,_tmp370))): 0;}goto _LLD3;};_LLD6:;_LLD7:(void)_throw(_tmp19D);_LLD3:;}};}{
struct _tuple17 _tmp371;struct _tuple17 _tmp1A8=(_tmp371.f1=tud->fields,((_tmp371.f2=
tud_opt,_tmp371)));struct Cyc_Core_Opt*_tmp1A9;struct Cyc_Absyn_Datatypedecl***
...
loc,v,tvs);{struct Cyc_Absyn_Datatypedecl**_tmp372;ge->datatypedecls=((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Datatypedecl**v))Cyc_Dict_insert)(
ge->datatypedecls,v,((_tmp372=_cycalloc(sizeof(*_tmp372)),((_tmp372[0]=tud,
_tmp372)))));}goto _LLDF;_LLE2: _tmp1AB=_tmp1A8.f1;if(_tmp1AB == 0)goto _LLE4;
...
_tmp375;struct Cyc_Absyn_Datatypedecl**_tmp374;struct Cyc_Absyn_Datatypedecl**
_tmp1BA=(_tmp374=_cycalloc(sizeof(*_tmp374)),((_tmp374[0]=((_tmp375=_cycalloc(
sizeof(*_tmp375)),((_tmp375->sc=Cyc_Absyn_Extern,((_tmp375->name=tud->name,((
_tmp375->tvs=tvs,((_tmp375->fields=0,((_tmp375->is_extensible=tud->is_extensible,
_tmp375)))))))))))),_tmp374)));ge->datatypedecls=((struct Cyc_Dict_Dict(*)(struct
...
_tmp376;*_tmp1B5=((_tmp376=_cycalloc(sizeof(*_tmp376)),((_tmp376->sc=Cyc_Absyn_Extern,((
_tmp376->name=tud->name,((_tmp376->tvs=tvs,((_tmp376->fields=0,((_tmp376->is_extensible=
tud->is_extensible,_tmp376))))))))))));}*_tmp1B3=Cyc_Tc_tcDatatypeFields(te,ge,
...
_LLE8;_LLED:;_LLEE:{const char*_tmp37A;void*_tmp379[1];struct Cyc_String_pa_struct
_tmp378;(_tmp378.tag=0,((_tmp378.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(ed->name)),((_tmp379[0]=& _tmp378,Cyc_Tcutil_terr(loc,((
_tmp37A="qualified enum declarations are not implemented (%s)",_tag_dyneither(
_tmp37A,sizeof(char),53))),_tag_dyneither(_tmp379,sizeof(void*),1)))))));}
...
const char*_tmp37E;void*_tmp37D[1];struct Cyc_String_pa_struct _tmp37C;(_tmp37C.tag=
0,((_tmp37C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp1C9->name).f2),((
_tmp37D[0]=& _tmp37C,Cyc_Tcutil_terr(_tmp1C9->loc,((_tmp37E="duplicate field name %s",
_tag_dyneither(_tmp37E,sizeof(char),24))),_tag_dyneither(_tmp37D,sizeof(void*),1)))))));}
else{struct Cyc_List_List*_tmp37F;prev_fields=((_tmp37F=_region_malloc(uprev_rgn,
sizeof(*_tmp37F)),((_tmp37F->hd=(*_tmp1C9->name).f2,((_tmp37F->tl=prev_fields,
_tmp37F))))));}if(_tmp1C9->tag == 0)_tmp1C9->tag=(struct Cyc_Absyn_Exp*)Cyc_Absyn_uint_exp(
tag_count,_tmp1C9->loc);else{if(!Cyc_Tcutil_is_const_exp(te,(struct Cyc_Absyn_Exp*)
_check_null(_tmp1C9->tag))){const char*_tmp384;void*_tmp383[2];struct Cyc_String_pa_struct
_tmp382;struct Cyc_String_pa_struct _tmp381;(_tmp381.tag=0,((_tmp381.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*(*_tmp1C9->name).f2),((_tmp382.tag=0,((
_tmp382.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*v),((_tmp383[0]=&
_tmp382,((_tmp383[1]=& _tmp381,Cyc_Tcutil_terr(loc,((_tmp384="enum %s, field %s: expression is not constant",
_tag_dyneither(_tmp384,sizeof(char),46))),_tag_dyneither(_tmp383,sizeof(void*),2)))))))))))));}}{
...
_tmp1D2.f2;if(!_tmp1D4){const char*_tmp387;void*_tmp386;(_tmp386=0,Cyc_Tcutil_terr(
loc,((_tmp387="Cyclone enum tags cannot use sizeof or offsetof",_tag_dyneither(
_tmp387,sizeof(char),48))),_tag_dyneither(_tmp386,sizeof(void*),0)));}tag_count=
...
_tmp388;struct Cyc_Absyn_Enumdecl**_tmp1DF=(_tmp388=_cycalloc(sizeof(*_tmp388)),((
_tmp388[0]=ed,_tmp388)));ge->enumdecls=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
...
_tmp38E;struct Cyc_Tcenv_EnumRes_struct _tmp38D;struct _tuple13*_tmp38C;ge->ordinaries=((
struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct
_tuple13*v))Cyc_Dict_insert)(ge->ordinaries,(*_tmp1E1->name).f2,(struct _tuple13*)((
_tmp38C=_cycalloc(sizeof(*_tmp38C)),((_tmp38C->f1=(void*)((_tmp38E=_cycalloc(
sizeof(*_tmp38E)),((_tmp38E[0]=((_tmp38D.tag=3,((_tmp38D.f1=ed,((_tmp38D.f2=
_tmp1E1,_tmp38D)))))),_tmp38E)))),((_tmp38C->f2=1,_tmp38C)))))));}}}static int Cyc_Tc_okay_externC(
...
_LLF4:{const char*_tmp391;void*_tmp390;(_tmp390=0,Cyc_Tcutil_warn(loc,((_tmp391="static declaration nested within extern \"C\"",
_tag_dyneither(_tmp391,sizeof(char),44))),_tag_dyneither(_tmp390,sizeof(void*),0)));}
return 0;case Cyc_Absyn_Abstract: _LLF5:{const char*_tmp394;void*_tmp393;(_tmp393=0,
Cyc_Tcutil_warn(loc,((_tmp394="abstract declaration nested within extern \"C\"",
_tag_dyneither(_tmp394,sizeof(char),46))),_tag_dyneither(_tmp393,sizeof(void*),0)));}
...
_tmp397;void*_tmp396;(_tmp396=0,Cyc_Tcutil_warn(loc,((_tmp397="nested extern \"C\" declaration",
_tag_dyneither(_tmp397,sizeof(char),30))),_tag_dyneither(_tmp396,sizeof(void*),0)));}
...
_LL100;_LLFF: goto _LLFB;_LL100:;_LL101:{const char*_tmp39B;void*_tmp39A[1];struct
Cyc_String_pa_struct _tmp399;(_tmp399.tag=0,((_tmp399.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp1ED)),((_tmp39A[0]=& _tmp399,Cyc_Tcutil_terr(
_tmp1EC,((_tmp39B="qualified export variables are not implemented (%s)",
_tag_dyneither(_tmp39B,sizeof(char),52))),_tag_dyneither(_tmp39A,sizeof(void*),1)))))));}
...
_tmp1F9;if(_tmp1FB->tag != 3)goto _LL107;}_LL106:{const char*_tmp39E;void*_tmp39D;(
_tmp39D=0,Cyc_Tcutil_terr(loc,((_tmp39E="top level let-declarations are not implemented",
_tag_dyneither(_tmp39E,sizeof(char),47))),_tag_dyneither(_tmp39D,sizeof(void*),0)));}
goto _LL102;_LL107: {struct Cyc_Absyn_Region_d_struct*_tmp1FC=(struct Cyc_Absyn_Region_d_struct*)
_tmp1F9;if(_tmp1FC->tag != 4)goto _LL109;}_LL108:{const char*_tmp3A1;void*_tmp3A0;(
_tmp3A0=0,Cyc_Tcutil_terr(loc,((_tmp3A1="top level region declarations are not implemented",
_tag_dyneither(_tmp3A1,sizeof(char),50))),_tag_dyneither(_tmp3A0,sizeof(void*),0)));}
goto _LL102;_LL109: {struct Cyc_Absyn_Alias_d_struct*_tmp1FD=(struct Cyc_Absyn_Alias_d_struct*)
_tmp1F9;if(_tmp1FD->tag != 5)goto _LL10B;}_LL10A:{const char*_tmp3A4;void*_tmp3A3;(
_tmp3A3=0,Cyc_Tcutil_terr(loc,((_tmp3A4="top level alias declarations are not implemented",
_tag_dyneither(_tmp3A4,sizeof(char),49))),_tag_dyneither(_tmp3A3,sizeof(void*),0)));}
...
else{struct Cyc_List_List _tmp3A5;struct Cyc_List_List tmp=(_tmp3A5.hd=(struct Cyc_Absyn_Decl*)
_tmp1F8->hd,((_tmp3A5.tl=_tmp1F8->tl,_tmp3A5)));_tmp1F8->hd=(void*)((struct Cyc_Absyn_Decl*)
...
_LL119;}_LL118:{const char*_tmp3A8;void*_tmp3A7;(_tmp3A7=0,Cyc_Tcutil_warn(d->loc,((
_tmp3A8="spurious __cyclone_port_on__",_tag_dyneither(_tmp3A8,sizeof(char),29))),
_tag_dyneither(_tmp3A7,sizeof(void*),0)));}goto _LL102;_LL119: {struct Cyc_Absyn_Portoff_d_struct*
...
_tmp22A=te->ns;struct Cyc_List_List*_tmp3A9;struct Cyc_List_List*_tmp22B=((struct
Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(
_tmp22A,((_tmp3A9=_cycalloc(sizeof(*_tmp3A9)),((_tmp3A9->hd=_tmp20D,((_tmp3A9->tl=
0,_tmp3A9)))))));if(!((int(*)(struct Cyc_Set_Set*s,struct _dyneither_ptr*elt))Cyc_Set_member)(
...
_tmp237;{struct Cyc_List_List*_tmp3AA;rest=((struct Cyc_List_List*(*)(struct Cyc_List_List*
x,struct Cyc_List_List*y))Cyc_List_append)(_tmp238,((_tmp3AA=_cycalloc(sizeof(*
_tmp3AA)),((_tmp3AA->hd=_tmp213,((_tmp3AA->tl=0,_tmp3AA)))))));}goto _LL128;
_LL128:;}{struct Cyc_List_List*_tmp23A=Cyc_Tcenv_resolve_namespace(te,loc,first,
rest);{struct Cyc_List_List*_tmp3AB;ge->availables=(struct Cyc_List_List*)((
_tmp3AB=_cycalloc(sizeof(*_tmp3AB)),((_tmp3AB->hd=_tmp23A,((_tmp3AB->tl=ge->availables,
_tmp3AB))))));}Cyc_Tc_tc_decls(te,_tmp214,in_externC,in_externCinclude,
...
_tmp23C).f3){const char*_tmp3AF;void*_tmp3AE[1];struct Cyc_String_pa_struct _tmp3AD;(
_tmp3AD.tag=0,((_tmp3AD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string((*
_tmp23C).f2)),((_tmp3AE[0]=& _tmp3AD,Cyc_Tcutil_warn((*_tmp23C).f1,((_tmp3AF="%s is exported but not defined",
_tag_dyneither(_tmp3AF,sizeof(char),31))),_tag_dyneither(_tmp3AE,sizeof(void*),1)))))));}}
...
struct _RegionHandle*rgn,struct Cyc_Tcenv_Genv*ge){struct _tuple18*_tmp3B0;return(
_tmp3B0=_region_malloc(rgn,sizeof(*_tmp3B0)),((_tmp3B0->f1=ge,((_tmp3B0->f2=((
struct Cyc_Set_Set*(*)(struct _RegionHandle*r,int(*cmp)(struct _dyneither_ptr*,
struct _dyneither_ptr*)))Cyc_Set_rempty)(rgn,Cyc_strptrcmp),_tmp3B0)))));}struct
...
_tmp3B1;struct Cyc_Tc_TreeshakeEnv _tmp25C=(_tmp3B1.rgn=rgn,((_tmp3B1.in_cinclude=
0,((_tmp3B1.nsdict=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,struct _tuple18*(*
f)(struct _RegionHandle*,struct Cyc_Tcenv_Genv*),struct _RegionHandle*env,struct Cyc_Dict_Dict
d))Cyc_Dict_rmap_c)(rgn,Cyc_Tc_treeshake_make_env_f,rgn,te->ae),_tmp3B1)))));
...
_tmp263=_tmp262.f1;_tmp264=_tmp262.f2;_tmp263->ordinaries=((struct Cyc_Dict_Dict(*)(
...
_tmp263->grgn,(int(*)(struct Cyc_Set_Set*set,struct _dyneither_ptr*x,struct
_tuple13*y))Cyc_Tc_treeshake_remove_f,_tmp264,_tmp263->ordinaries);}{struct Cyc_List_List*
_tmp265=_tmp25D;_npop_handler(0);return _tmp265;};};};_pop_region(rgn);}
