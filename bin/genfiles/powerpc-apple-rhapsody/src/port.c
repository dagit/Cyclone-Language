...
ts);static struct _dynforward_ptr Cyc_Port_ctype2string(int deep,void*t);static
struct _dynforward_ptr Cyc_Port_ctype2string(int deep,void*t){void*_tmp0=t;struct
_dynforward_ptr*_tmp1;void*_tmp2;void*_tmp3;void*_tmp4;void*_tmp5;void*_tmp6;
...
_tmp13;struct Cyc_Port_Cvar*_tmp14;_LL1: if((int)_tmp0 != 0)goto _LL3;_LL2: {const
char*_tmp3F1;return(_tmp3F1="const",_tag_dynforward(_tmp3F1,sizeof(char),
_get_zero_arr_size_char(_tmp3F1,6)));}_LL3: if((int)_tmp0 != 1)goto _LL5;_LL4: {
const char*_tmp3F2;return(_tmp3F2="notconst",_tag_dynforward(_tmp3F2,sizeof(char),
_get_zero_arr_size_char(_tmp3F2,9)));}_LL5: if((int)_tmp0 != 2)goto _LL7;_LL6: {
const char*_tmp3F3;return(_tmp3F3="thin",_tag_dynforward(_tmp3F3,sizeof(char),
_get_zero_arr_size_char(_tmp3F3,5)));}_LL7: if((int)_tmp0 != 3)goto _LL9;_LL8: {
const char*_tmp3F4;return(_tmp3F4="fat",_tag_dynforward(_tmp3F4,sizeof(char),
_get_zero_arr_size_char(_tmp3F4,4)));}_LL9: if((int)_tmp0 != 4)goto _LLB;_LLA: {
const char*_tmp3F5;return(_tmp3F5="void",_tag_dynforward(_tmp3F5,sizeof(char),
_get_zero_arr_size_char(_tmp3F5,5)));}_LLB: if((int)_tmp0 != 5)goto _LLD;_LLC: {
const char*_tmp3F6;return(_tmp3F6="zero",_tag_dynforward(_tmp3F6,sizeof(char),
_get_zero_arr_size_char(_tmp3F6,5)));}_LLD: if((int)_tmp0 != 6)goto _LLF;_LLE: {
const char*_tmp3F7;return(_tmp3F7="arith",_tag_dynforward(_tmp3F7,sizeof(char),
_get_zero_arr_size_char(_tmp3F7,6)));}_LLF: if((int)_tmp0 != 7)goto _LL11;_LL10: {
const char*_tmp3F8;return(_tmp3F8="heap",_tag_dynforward(_tmp3F8,sizeof(char),
_get_zero_arr_size_char(_tmp3F8,5)));}_LL11: if((int)_tmp0 != 8)goto _LL13;_LL12: {
const char*_tmp3F9;return(_tmp3F9="ZT",_tag_dynforward(_tmp3F9,sizeof(char),
_get_zero_arr_size_char(_tmp3F9,3)));}_LL13: if((int)_tmp0 != 9)goto _LL15;_LL14: {
const char*_tmp3FA;return(_tmp3FA="NZT",_tag_dynforward(_tmp3FA,sizeof(char),
_get_zero_arr_size_char(_tmp3FA,4)));}_LL15: if(_tmp0 <= (void*)10)goto _LL17;if(*((
int*)_tmp0)!= 0)goto _LL17;_tmp1=((struct Cyc_Port_RgnVar_ct_struct*)_tmp0)->f1;
_LL16: {const char*_tmp3FE;void*_tmp3FD[1];struct Cyc_String_pa_struct _tmp3FC;
return(struct _dynforward_ptr)((_tmp3FC.tag=0,((_tmp3FC.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)*_tmp1),((_tmp3FD[0]=& _tmp3FC,Cyc_aprintf(((_tmp3FE="%s",
_tag_dynforward(_tmp3FE,sizeof(char),_get_zero_arr_size_char(_tmp3FE,3)))),
_tag_dynforward(_tmp3FD,sizeof(void*),1))))))));}_LL17: if(_tmp0 <= (void*)10)goto
_LL19;if(*((int*)_tmp0)!= 1)goto _LL19;_tmp2=(void*)((struct Cyc_Port_Ptr_ct_struct*)
...
_tmp0)->f4;_tmp6=(void*)((struct Cyc_Port_Ptr_ct_struct*)_tmp0)->f5;_LL18: {const
char*_tmp406;void*_tmp405[5];struct Cyc_String_pa_struct _tmp404;struct Cyc_String_pa_struct
_tmp403;struct Cyc_String_pa_struct _tmp402;struct Cyc_String_pa_struct _tmp401;
struct Cyc_String_pa_struct _tmp400;return(struct _dynforward_ptr)((_tmp400.tag=0,((
_tmp400.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Port_ctype2string(
deep,_tmp6)),((_tmp401.tag=0,((_tmp401.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)Cyc_Port_ctype2string(deep,_tmp5)),((_tmp402.tag=0,((_tmp402.f1=(
struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Port_ctype2string(deep,_tmp4)),((
_tmp403.tag=0,((_tmp403.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Port_ctype2string(
deep,_tmp3)),((_tmp404.tag=0,((_tmp404.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)Cyc_Port_ctype2string(deep,_tmp2)),((_tmp405[0]=& _tmp404,((
_tmp405[1]=& _tmp403,((_tmp405[2]=& _tmp402,((_tmp405[3]=& _tmp401,((_tmp405[4]=&
_tmp400,Cyc_aprintf(((_tmp406="ptr(%s,%s,%s,%s,%s)",_tag_dynforward(_tmp406,
sizeof(char),_get_zero_arr_size_char(_tmp406,20)))),_tag_dynforward(_tmp405,
sizeof(void*),5))))))))))))))))))))))))))))))));}_LL19: if(_tmp0 <= (void*)10)goto
...
struct Cyc_Port_Array_ct_struct*)_tmp0)->f3;_LL1A: {const char*_tmp40C;void*
_tmp40B[3];struct Cyc_String_pa_struct _tmp40A;struct Cyc_String_pa_struct _tmp409;
struct Cyc_String_pa_struct _tmp408;return(struct _dynforward_ptr)((_tmp408.tag=0,((
_tmp408.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Port_ctype2string(
deep,_tmp9)),((_tmp409.tag=0,((_tmp409.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)Cyc_Port_ctype2string(deep,_tmp8)),((_tmp40A.tag=0,((_tmp40A.f1=(
struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Port_ctype2string(deep,_tmp7)),((
_tmp40B[0]=& _tmp40A,((_tmp40B[1]=& _tmp409,((_tmp40B[2]=& _tmp408,Cyc_aprintf(((
_tmp40C="array(%s,%s,%s)",_tag_dynforward(_tmp40C,sizeof(char),
_get_zero_arr_size_char(_tmp40C,16)))),_tag_dynforward(_tmp40B,sizeof(void*),3))))))))))))))))))));}
...
_tmpB.f2;_LL1C: {const char*_tmp40E;const char*_tmp40D;struct _dynforward_ptr s=(
void*)_tmpC->kind == (void*)0?(_tmp40E="struct",_tag_dynforward(_tmp40E,sizeof(
char),_get_zero_arr_size_char(_tmp40E,7))):((_tmp40D="union",_tag_dynforward(
_tmp40D,sizeof(char),_get_zero_arr_size_char(_tmp40D,6))));if(!deep){const char*
_tmp413;void*_tmp412[2];struct Cyc_String_pa_struct _tmp411;struct Cyc_String_pa_struct
_tmp410;return(struct _dynforward_ptr)((_tmp410.tag=0,((_tmp410.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)Cyc_Absynpp_qvar2string(_tmpC->name)),((
_tmp411.tag=0,((_tmp411.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)s),((
_tmp412[0]=& _tmp411,((_tmp412[1]=& _tmp410,Cyc_aprintf(((_tmp413="%s %s",
_tag_dynforward(_tmp413,sizeof(char),_get_zero_arr_size_char(_tmp413,6)))),
_tag_dynforward(_tmp412,sizeof(void*),2))))))))))))));}else{const char*_tmp419;
void*_tmp418[3];struct Cyc_String_pa_struct _tmp417;struct Cyc_String_pa_struct
_tmp416;struct Cyc_String_pa_struct _tmp415;return(struct _dynforward_ptr)((_tmp415.tag=
0,((_tmp415.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Port_cfields2string(
0,_tmpD)),((_tmp416.tag=0,((_tmp416.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)Cyc_Absynpp_qvar2string(_tmpC->name)),((_tmp417.tag=0,((_tmp417.f1=(
struct _dynforward_ptr)((struct _dynforward_ptr)s),((_tmp418[0]=& _tmp417,((_tmp418[
1]=& _tmp416,((_tmp418[2]=& _tmp415,Cyc_aprintf(((_tmp419="%s %s {%s}",
_tag_dynforward(_tmp419,sizeof(char),_get_zero_arr_size_char(_tmp419,11)))),
_tag_dynforward(_tmp418,sizeof(void*),3))))))))))))))))))));}}_LL1D: if(_tmp0 <= (
void*)10)goto _LL1F;if(*((int*)_tmp0)!= 4)goto _LL1F;_tmpE=((struct Cyc_Port_UnknownAggr_ct_struct*)
...
_tmp0)->f1;_LL20: {const char*_tmp41D;void*_tmp41C[1];struct Cyc_String_pa_struct
_tmp41B;return(struct _dynforward_ptr)((_tmp41B.tag=0,((_tmp41B.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)Cyc_Port_cfields2string(deep,_tmp11)),((
_tmp41C[0]=& _tmp41B,Cyc_aprintf(((_tmp41D="aggr {%s}",_tag_dynforward(_tmp41D,
sizeof(char),_get_zero_arr_size_char(_tmp41D,10)))),_tag_dynforward(_tmp41C,
sizeof(void*),1))))))));}_LL21: if(_tmp0 <= (void*)10)goto _LL23;if(*((int*)_tmp0)
!= 5)goto _LL23;_tmp12=(void*)((struct Cyc_Port_Fn_ct_struct*)_tmp0)->f1;_tmp13=((
struct Cyc_Port_Fn_ct_struct*)_tmp0)->f2;_LL22: {const char*_tmp422;void*_tmp421[2];
struct Cyc_String_pa_struct _tmp420;struct Cyc_String_pa_struct _tmp41F;return(
struct _dynforward_ptr)((_tmp41F.tag=0,((_tmp41F.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)Cyc_Port_ctype2string(deep,_tmp12)),((_tmp420.tag=0,((
_tmp420.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Port_ctypes2string(
deep,_tmp13)),((_tmp421[0]=& _tmp420,((_tmp421[1]=& _tmp41F,Cyc_aprintf(((_tmp422="fn(%s)->%s",
_tag_dynforward(_tmp422,sizeof(char),_get_zero_arr_size_char(_tmp422,11)))),
_tag_dynforward(_tmp421,sizeof(void*),2))))))))))))));}_LL23: if(_tmp0 <= (void*)
10)goto _LL0;if(*((int*)_tmp0)!= 6)goto _LL0;_tmp14=((struct Cyc_Port_Var_ct_struct*)
...
== 0){const char*_tmp426;void*_tmp425[1];struct Cyc_Int_pa_struct _tmp424;return(
struct _dynforward_ptr)((_tmp424.tag=1,((_tmp424.f1=(unsigned long)_tmp14->id,((
_tmp425[0]=& _tmp424,Cyc_aprintf(((_tmp426="var(%d)",_tag_dynforward(_tmp426,
sizeof(char),_get_zero_arr_size_char(_tmp426,8)))),_tag_dynforward(_tmp425,
sizeof(void*),1))))))));}else{const char*_tmp42C;void*_tmp42B[3];struct Cyc_String_pa_struct
_tmp42A;struct Cyc_Int_pa_struct _tmp429;struct Cyc_String_pa_struct _tmp428;return(
struct _dynforward_ptr)((_tmp428.tag=0,((_tmp428.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)Cyc_Port_ctypes2string(0,_tmp14->uppers)),((_tmp429.tag=1,((
_tmp429.f1=(unsigned long)_tmp14->id,((_tmp42A.tag=0,((_tmp42A.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)Cyc_Port_ctypes2string(0,_tmp14->lowers)),((
_tmp42B[0]=& _tmp42A,((_tmp42B[1]=& _tmp429,((_tmp42B[2]=& _tmp428,Cyc_aprintf(((
_tmp42C="var([%s]<=%d<=[%s])",_tag_dynforward(_tmp42C,sizeof(char),
_get_zero_arr_size_char(_tmp42C,20)))),_tag_dynforward(_tmp42B,sizeof(void*),3))))))))))))))))))));}}
_LL0:;}static struct _dynforward_ptr*Cyc_Port_ctype2stringptr(int deep,void*t);
static struct _dynforward_ptr*Cyc_Port_ctype2stringptr(int deep,void*t){struct
_dynforward_ptr*_tmp42D;return(_tmp42D=_cycalloc(sizeof(*_tmp42D)),((_tmp42D[0]=
Cyc_Port_ctype2string(deep,t),_tmp42D)));}struct Cyc_List_List*Cyc_Port_sep(
struct _dynforward_ptr s,struct Cyc_List_List*xs);struct Cyc_List_List*Cyc_Port_sep(
struct _dynforward_ptr s,struct Cyc_List_List*xs){struct _dynforward_ptr*_tmp42E;
struct _dynforward_ptr*_tmp49=(_tmp42E=_cycalloc(sizeof(*_tmp42E)),((_tmp42E[0]=s,
_tmp42E)));if(xs == 0)return xs;{struct Cyc_List_List*_tmp4A=xs;struct Cyc_List_List*
_tmp4B=xs->tl;for(0;_tmp4B != 0;(_tmp4A=_tmp4B,_tmp4B=_tmp4B->tl)){struct Cyc_List_List*
_tmp42F;((struct Cyc_List_List*)_check_null(_tmp4A))->tl=((_tmp42F=_cycalloc(
sizeof(*_tmp42F)),((_tmp42F->hd=_tmp49,((_tmp42F->tl=_tmp4B,_tmp42F))))));}
return xs;}}static struct _dynforward_ptr*Cyc_Port_cfield2stringptr(int deep,struct
Cyc_Port_Cfield*f);static struct _dynforward_ptr*Cyc_Port_cfield2stringptr(int deep,
struct Cyc_Port_Cfield*f){const char*_tmp435;void*_tmp434[3];struct Cyc_String_pa_struct
_tmp433;struct Cyc_String_pa_struct _tmp432;struct Cyc_String_pa_struct _tmp431;
struct _dynforward_ptr s=(struct _dynforward_ptr)((_tmp431.tag=0,((_tmp431.f1=(
struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Port_ctype2string(deep,(void*)
f->type)),((_tmp432.tag=0,((_tmp432.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)*f->f),((_tmp433.tag=0,((_tmp433.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)Cyc_Port_ctype2string(deep,(void*)f->qual)),((_tmp434[0]=&
_tmp433,((_tmp434[1]=& _tmp432,((_tmp434[2]=& _tmp431,Cyc_aprintf(((_tmp435="%s %s: %s",
_tag_dynforward(_tmp435,sizeof(char),_get_zero_arr_size_char(_tmp435,10)))),
_tag_dynforward(_tmp434,sizeof(void*),3))))))))))))))))))));struct
_dynforward_ptr*_tmp436;return(_tmp436=_cycalloc(sizeof(*_tmp436)),((_tmp436[0]=
s,_tmp436)));}static struct _dynforward_ptr Cyc_Port_ctypes2string(int deep,struct
Cyc_List_List*ts);static struct _dynforward_ptr Cyc_Port_ctypes2string(int deep,
struct Cyc_List_List*ts){const char*_tmp437;return(struct _dynforward_ptr)Cyc_strconcat_l(
Cyc_Port_sep(((_tmp437=",",_tag_dynforward(_tmp437,sizeof(char),
_get_zero_arr_size_char(_tmp437,2)))),((struct Cyc_List_List*(*)(struct
_dynforward_ptr*(*f)(int,void*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(
Cyc_Port_ctype2stringptr,deep,ts)));}static struct _dynforward_ptr Cyc_Port_cfields2string(
int deep,struct Cyc_List_List*fs);static struct _dynforward_ptr Cyc_Port_cfields2string(
int deep,struct Cyc_List_List*fs){const char*_tmp438;return(struct _dynforward_ptr)
Cyc_strconcat_l(Cyc_Port_sep(((_tmp438=";",_tag_dynforward(_tmp438,sizeof(char),
_get_zero_arr_size_char(_tmp438,2)))),((struct Cyc_List_List*(*)(struct
_dynforward_ptr*(*f)(int,struct Cyc_Port_Cfield*),int env,struct Cyc_List_List*x))
...
static void*Cyc_Port_const_ct(){return(void*)0;}static void*Cyc_Port_thin_ct();
static void*Cyc_Port_thin_ct(){return(void*)2;}static void*Cyc_Port_fat_ct();
static void*Cyc_Port_fat_ct(){return(void*)3;}static void*Cyc_Port_void_ct();
static void*Cyc_Port_void_ct(){return(void*)4;}static void*Cyc_Port_zero_ct();
static void*Cyc_Port_zero_ct(){return(void*)5;}static void*Cyc_Port_arith_ct();
...
struct _dynforward_ptr*n);static void*Cyc_Port_rgnvar_ct(struct _dynforward_ptr*n){
struct Cyc_Port_RgnVar_ct_struct _tmp43B;struct Cyc_Port_RgnVar_ct_struct*_tmp43A;
return(void*)((_tmp43A=_cycalloc(sizeof(*_tmp43A)),((_tmp43A[0]=((_tmp43B.tag=0,((
_tmp43B.f1=n,_tmp43B)))),_tmp43A))));}static void*Cyc_Port_unknown_aggr_ct(struct
Cyc_List_List*fs);static void*Cyc_Port_unknown_aggr_ct(struct Cyc_List_List*fs){
struct Cyc_Port_UnknownAggr_ct_struct _tmp43E;struct Cyc_Port_UnknownAggr_ct_struct*
_tmp43D;return(void*)((_tmp43D=_cycalloc(sizeof(*_tmp43D)),((_tmp43D[0]=((
_tmp43E.tag=4,((_tmp43E.f1=fs,((_tmp43E.f2=0,_tmp43E)))))),_tmp43D))));}static
void*Cyc_Port_known_aggr_ct(struct _tuple4*p);static void*Cyc_Port_known_aggr_ct(
struct _tuple4*p){struct Cyc_Port_KnownAggr_ct_struct _tmp441;struct Cyc_Port_KnownAggr_ct_struct*
_tmp440;return(void*)((_tmp440=_cycalloc(sizeof(*_tmp440)),((_tmp440[0]=((
_tmp441.tag=3,((_tmp441.f1=p,_tmp441)))),_tmp440))));}static void*Cyc_Port_ptr_ct(
void*elt,void*qual,void*ptr_kind,void*r,void*zt);static void*Cyc_Port_ptr_ct(void*
elt,void*qual,void*ptr_kind,void*r,void*zt){struct Cyc_Port_Ptr_ct_struct _tmp444;
struct Cyc_Port_Ptr_ct_struct*_tmp443;return(void*)((_tmp443=_cycalloc(sizeof(*
_tmp443)),((_tmp443[0]=((_tmp444.tag=1,((_tmp444.f1=(void*)elt,((_tmp444.f2=(
void*)qual,((_tmp444.f3=(void*)ptr_kind,((_tmp444.f4=(void*)r,((_tmp444.f5=(void*)
zt,_tmp444)))))))))))),_tmp443))));}static void*Cyc_Port_array_ct(void*elt,void*
qual,void*zt);static void*Cyc_Port_array_ct(void*elt,void*qual,void*zt){struct Cyc_Port_Array_ct_struct
_tmp447;struct Cyc_Port_Array_ct_struct*_tmp446;return(void*)((_tmp446=_cycalloc(
sizeof(*_tmp446)),((_tmp446[0]=((_tmp447.tag=2,((_tmp447.f1=(void*)elt,((_tmp447.f2=(
void*)qual,((_tmp447.f3=(void*)zt,_tmp447)))))))),_tmp446))));}static void*Cyc_Port_fn_ct(
void*return_type,struct Cyc_List_List*args);static void*Cyc_Port_fn_ct(void*
return_type,struct Cyc_List_List*args){struct Cyc_Port_Fn_ct_struct _tmp44A;struct
Cyc_Port_Fn_ct_struct*_tmp449;return(void*)((_tmp449=_cycalloc(sizeof(*_tmp449)),((
_tmp449[0]=((_tmp44A.tag=5,((_tmp44A.f1=(void*)return_type,((_tmp44A.f2=args,
_tmp44A)))))),_tmp449))));}static void*Cyc_Port_var();static void*Cyc_Port_var(){
static int counter=0;struct Cyc_Port_Var_ct_struct _tmp450;struct Cyc_Port_Cvar*
_tmp44F;struct Cyc_Port_Var_ct_struct*_tmp44E;return(void*)((_tmp44E=_cycalloc(
sizeof(*_tmp44E)),((_tmp44E[0]=((_tmp450.tag=6,((_tmp450.f1=((_tmp44F=_cycalloc(
sizeof(*_tmp44F)),((_tmp44F->id=counter ++,((_tmp44F->eq=0,((_tmp44F->uppers=0,((
_tmp44F->lowers=0,_tmp44F)))))))))),_tmp450)))),_tmp44E))));}static void*Cyc_Port_new_var(
void*x);static void*Cyc_Port_new_var(void*x){return Cyc_Port_var();}static struct
_dynforward_ptr*Cyc_Port_new_region_var();static struct _dynforward_ptr*Cyc_Port_new_region_var(){
static int counter=0;const char*_tmp454;void*_tmp453[1];struct Cyc_Int_pa_struct
_tmp452;struct _dynforward_ptr s=(struct _dynforward_ptr)((_tmp452.tag=1,((_tmp452.f1=(
unsigned long)counter ++,((_tmp453[0]=& _tmp452,Cyc_aprintf(((_tmp454="`R%d",
_tag_dynforward(_tmp454,sizeof(char),_get_zero_arr_size_char(_tmp454,5)))),
_tag_dynforward(_tmp453,sizeof(void*),1))))))));struct _dynforward_ptr*_tmp455;
return(_tmp455=_cycalloc(sizeof(*_tmp455)),((_tmp455[0]=s,_tmp455)));}static int
Cyc_Port_unifies(void*t1,void*t2);static void*Cyc_Port_compress_ct(void*t);static
void*Cyc_Port_compress_ct(void*t){void*_tmp69=t;struct Cyc_Port_Cvar*_tmp6A;
struct Cyc_Port_Cvar _tmp6B;void**_tmp6C;void***_tmp6D;struct Cyc_List_List*_tmp6E;
struct Cyc_List_List*_tmp6F;void**_tmp70;_LL26: if(_tmp69 <= (void*)10)goto _LL2A;
if(*((int*)_tmp69)!= 6)goto _LL28;_tmp6A=((struct Cyc_Port_Var_ct_struct*)_tmp69)->f1;
_tmp6B=*_tmp6A;_tmp6C=_tmp6B.eq;_tmp6D=(void***)&(*((struct Cyc_Port_Var_ct_struct*)
...
!= r){void**_tmp456;*_tmp6D=((_tmp456=_cycalloc(sizeof(*_tmp456)),((_tmp456[0]=r,
_tmp456))));}return r;}for(0;_tmp6F != 0;_tmp6F=_tmp6F->tl){void*_tmp73=(void*)
_tmp6F->hd;_LL2D: if((int)_tmp73 != 0)goto _LL2F;_LL2E: goto _LL30;_LL2F: if((int)
_tmp73 != 9)goto _LL31;_LL30: goto _LL32;_LL31: if((int)_tmp73 != 4)goto _LL33;_LL32:
goto _LL34;_LL33: if(_tmp73 <= (void*)10)goto _LL37;if(*((int*)_tmp73)!= 3)goto _LL35;
_LL34: goto _LL36;_LL35: if(*((int*)_tmp73)!= 5)goto _LL37;_LL36:{void**_tmp457;*
_tmp6D=((_tmp457=_cycalloc(sizeof(*_tmp457)),((_tmp457[0]=(void*)_tmp6F->hd,
_tmp457))));}return(void*)_tmp6F->hd;_LL37:;_LL38: goto _LL2C;_LL2C:;}for(0;_tmp6E
...
_tmp75)!= 5)goto _LL44;_LL43:{void**_tmp458;*_tmp6D=((_tmp458=_cycalloc(sizeof(*
_tmp458)),((_tmp458[0]=(void*)_tmp6E->hd,_tmp458))));}return(void*)_tmp6E->hd;
...
t);struct _dynforward_ptr*_tmp78;void*_tmp79;void*_tmp7A;void*_tmp7B;void*_tmp7C;
...
d,struct _dynforward_ptr*k))Cyc_Dict_member)(*instenv,_tmp78))*instenv=((struct
Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dynforward_ptr*k,void*v))Cyc_Dict_insert)(*
instenv,_tmp78,Cyc_Port_var());return((void*(*)(struct Cyc_Dict_Dict d,struct
_dynforward_ptr*k))Cyc_Dict_lookup)(*instenv,_tmp78);_LL63: if(_tmp77 <= (void*)10)
...
void*_tmp85;void*_tmp86;struct _tuple3 _tmp459;struct _tuple3 _tmp84=(_tmp459.f1=Cyc_Port_inst(
instenv,_tmp79),((_tmp459.f2=Cyc_Port_inst(instenv,_tmp7C),_tmp459)));_tmp85=
_tmp84.f1;_tmp86=_tmp84.f2;if(_tmp85 == _tmp79  && _tmp86 == _tmp7C)return t;{struct
Cyc_Port_Ptr_ct_struct _tmp45C;struct Cyc_Port_Ptr_ct_struct*_tmp45B;return(void*)((
_tmp45B=_cycalloc(sizeof(*_tmp45B)),((_tmp45B[0]=((_tmp45C.tag=1,((_tmp45C.f1=(
void*)_tmp85,((_tmp45C.f2=(void*)_tmp7A,((_tmp45C.f3=(void*)_tmp7B,((_tmp45C.f4=(
void*)_tmp86,((_tmp45C.f5=(void*)_tmp7D,_tmp45C)))))))))))),_tmp45B))));}}_LL65:
...
_tmp45F;struct Cyc_Port_Array_ct_struct*_tmp45E;return(void*)((_tmp45E=_cycalloc(
sizeof(*_tmp45E)),((_tmp45E[0]=((_tmp45F.tag=2,((_tmp45F.f1=(void*)_tmp89,((
_tmp45F.f2=(void*)_tmp7F,((_tmp45F.f3=(void*)_tmp80,_tmp45F)))))))),_tmp45E))));}}
...
_tmp77)->f2;_LL68: {struct Cyc_Port_Fn_ct_struct _tmp462;struct Cyc_Port_Fn_ct_struct*
_tmp461;return(void*)((_tmp461=_cycalloc(sizeof(*_tmp461)),((_tmp461[0]=((
_tmp462.tag=5,((_tmp462.f1=(void*)Cyc_Port_inst(instenv,_tmp81),((_tmp462.f2=((
struct Cyc_List_List*(*)(void*(*f)(struct Cyc_Dict_Dict*,void*),struct Cyc_Dict_Dict*
env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Port_inst,instenv,_tmp82),_tmp462)))))),
_tmp461))));}_LL46:;}void*Cyc_Port_instantiate(void*t);void*Cyc_Port_instantiate(
void*t){struct Cyc_Dict_Dict*_tmp463;return Cyc_Port_inst(((_tmp463=_cycalloc(
sizeof(*_tmp463)),((_tmp463[0]=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct
_dynforward_ptr*,struct _dynforward_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp),_tmp463)))),
...
void*)ts->hd))continue;{struct Cyc_List_List*_tmp464;res=((_tmp464=_cycalloc(
sizeof(*_tmp464)),((_tmp464->hd=(void*)((void*)ts->hd),((_tmp464->tl=res,_tmp464))))));}}
...
t1);t2=Cyc_Port_compress_ct(t2);if(t1 == t2)return;{struct _tuple3 _tmp465;struct
_tuple3 _tmpAE=(_tmp465.f1=t1,((_tmp465.f2=t2,_tmp465)));void*_tmpAF;struct Cyc_Port_Cvar*
...
void*_tmpBC;void*_tmpBD;void*_tmpBE;void*_tmpBF;struct _dynforward_ptr*_tmpC0;
struct _dynforward_ptr _tmpC1;void*_tmpC2;struct _dynforward_ptr*_tmpC3;struct
_dynforward_ptr _tmpC4;void*_tmpC5;void*_tmpC6;void*_tmpC7;void*_tmpC8;void*
_tmpC9;void*_tmpCA;void*_tmpCB;void*_tmpCC;void*_tmpCD;void*_tmpCE;struct Cyc_List_List*
...
void**_tmp466;_tmpB0->eq=((_tmp466=_cycalloc(sizeof(*_tmp466)),((_tmp466[0]=t2,
_tmp466))));}return;}else{(int)_throw((void*)Cyc_Port_Unify_ct);}_LL9C: _tmpB1=
...
if(Cyc_strcmp((struct _dynforward_ptr)_tmpC1,(struct _dynforward_ptr)_tmpC4)!= 0)(
...
_tmpD8,_tmpDC,1));{void**_tmp467;*_tmpDA=(*_tmpDE=((_tmp467=_cycalloc(sizeof(*
_tmp467)),((_tmp467[0]=_tmpF4,_tmp467)))));}return;}_LLAA: _tmpDF=_tmpAE.f1;if(
...
_tmpE5.f2;_LLAB: Cyc_Port_merge_fields(_tmpE7,_tmpE0,0);{void**_tmp468;*_tmpE2=((
_tmp468=_cycalloc(sizeof(*_tmp468)),((_tmp468[0]=t2,_tmp468))));}return;_LLAC:
...
_tmpEC,_tmpEE,0);{void**_tmp469;*_tmpF0=((_tmp469=_cycalloc(sizeof(*_tmp469)),((
_tmp469[0]=t1,_tmp469))));}return;_LLAE:;_LLAF:(int)_throw((void*)Cyc_Port_Unify_ct);
...
_tmpFB->f,_tmpF9->f)== 0){{struct Cyc_List_List*_tmp46A;common=((_tmp46A=
_cycalloc(sizeof(*_tmp46A)),((_tmp46A->hd=_tmpFB,((_tmp46A->tl=common,_tmp46A))))));}
...
allow_f1_subset_f2){struct Cyc_List_List*_tmp46B;common=((_tmp46B=_cycalloc(
sizeof(*_tmp46B)),((_tmp46B->hd=_tmpF9,((_tmp46B->tl=common,_tmp46B))))));}else{(
...
Cyc_List_List*_tmp46C;common=((_tmp46C=_cycalloc(sizeof(*_tmp46C)),((_tmp46C->hd=
_tmpFF,((_tmp46C->tl=common,_tmp46C))))));}}}return common;}static int Cyc_Port_unifies(
...
void*)_tmp109->hd);if(t == _tmp10A)return*uppers;{struct _tuple3 _tmp46D;struct
_tuple3 _tmp10C=(_tmp46D.f1=t,((_tmp46D.f2=_tmp10A,_tmp46D)));void*_tmp10D;void*
...
_tmp122;void*_tmp123;void*_tmp124;void*_tmp125;struct _tuple5 _tmp46E;struct
_tuple5 _tmp120=(_tmp46E.f1=Cyc_Port_var(),((_tmp46E.f2=Cyc_Port_var(),((_tmp46E.f3=
Cyc_Port_var(),((_tmp46E.f4=Cyc_Port_var(),((_tmp46E.f5=Cyc_Port_var(),_tmp46E)))))))));
_tmp121=_tmp120.f1;_tmp122=_tmp120.f2;_tmp123=_tmp120.f3;_tmp124=_tmp120.f4;
_tmp125=_tmp120.f5;{struct Cyc_Port_Ptr_ct_struct _tmp471;struct Cyc_Port_Ptr_ct_struct*
_tmp470;struct Cyc_Port_Ptr_ct_struct*_tmp126=(_tmp470=_cycalloc(sizeof(*_tmp470)),((
_tmp470[0]=((_tmp471.tag=1,((_tmp471.f1=(void*)_tmp121,((_tmp471.f2=(void*)
_tmp122,((_tmp471.f3=(void*)_tmp123,((_tmp471.f4=(void*)_tmp124,((_tmp471.f5=(
void*)_tmp125,_tmp471)))))))))))),_tmp470)));Cyc_Port_leq(_tmp121,_tmp114);Cyc_Port_leq(
...
_LLD0;_LLD0:;}}}{struct Cyc_List_List*_tmp472;return(_tmp472=_cycalloc(sizeof(*
_tmp472)),((_tmp472->hd=(void*)t,((_tmp472->tl=*uppers,_tmp472)))));}}static
...
void*)_tmp12B->hd);if(t == _tmp12C)return*lowers;{struct _tuple3 _tmp473;struct
_tuple3 _tmp12E=(_tmp473.f1=t,((_tmp473.f2=_tmp12C,_tmp473)));void*_tmp12F;void*
...
_tmp14A;struct _tuple5 _tmp474;struct _tuple5 _tmp145=(_tmp474.f1=Cyc_Port_var(),((
_tmp474.f2=Cyc_Port_var(),((_tmp474.f3=Cyc_Port_var(),((_tmp474.f4=Cyc_Port_var(),((
_tmp474.f5=Cyc_Port_var(),_tmp474)))))))));_tmp146=_tmp145.f1;_tmp147=_tmp145.f2;
_tmp148=_tmp145.f3;_tmp149=_tmp145.f4;_tmp14A=_tmp145.f5;{struct Cyc_Port_Ptr_ct_struct
_tmp477;struct Cyc_Port_Ptr_ct_struct*_tmp476;struct Cyc_Port_Ptr_ct_struct*
_tmp14B=(_tmp476=_cycalloc(sizeof(*_tmp476)),((_tmp476[0]=((_tmp477.tag=1,((
_tmp477.f1=(void*)_tmp146,((_tmp477.f2=(void*)_tmp147,((_tmp477.f3=(void*)
_tmp148,((_tmp477.f4=(void*)_tmp149,((_tmp477.f5=(void*)_tmp14A,_tmp477)))))))))))),
_tmp476)));Cyc_Port_leq(_tmp139,_tmp146);Cyc_Port_leq(_tmp13F,_tmp146);Cyc_Port_leq(
...
_tmp478;return(_tmp478=_cycalloc(sizeof(*_tmp478)),((_tmp478->hd=(void*)t,((
_tmp478->tl=*lowers,_tmp478)))));}}static int Cyc_Port_leq(void*t1,void*t2);static
int Cyc_Port_leq(void*t1,void*t2){if(t1 == t2)return 1;t1=Cyc_Port_compress_ct(t1);
t2=Cyc_Port_compress_ct(t2);{struct _tuple3 _tmp479;struct _tuple3 _tmp150=(_tmp479.f1=
t1,((_tmp479.f2=t2,_tmp479)));void*_tmp151;void*_tmp152;struct _dynforward_ptr*
...
struct Cyc_Port_Cenv*Cyc_Port_empty_cenv(){struct Cyc_Port_GlobalCenv*_tmp47A;
struct Cyc_Port_GlobalCenv*g=(_tmp47A=_cycalloc(sizeof(*_tmp47A)),((_tmp47A->typedef_dict=((
struct Cyc_Dict_Dict(*)(int(*cmp)(struct _tuple0*,struct _tuple0*)))Cyc_Dict_empty)(
Cyc_Absyn_qvar_cmp),((_tmp47A->struct_dict=((struct Cyc_Dict_Dict(*)(int(*cmp)(
struct _tuple0*,struct _tuple0*)))Cyc_Dict_empty)(Cyc_Absyn_qvar_cmp),((_tmp47A->union_dict=((
struct Cyc_Dict_Dict(*)(int(*cmp)(struct _tuple0*,struct _tuple0*)))Cyc_Dict_empty)(
Cyc_Absyn_qvar_cmp),((_tmp47A->qualifier_edits=0,((_tmp47A->pointer_edits=0,((
_tmp47A->zeroterm_edits=0,((_tmp47A->edits=0,((_tmp47A->porting=0,((_tmp47A->return_type=(
void*)Cyc_Port_void_ct(),_tmp47A)))))))))))))))))));struct Cyc_Port_Cenv*_tmp47B;
return(_tmp47B=_cycalloc(sizeof(*_tmp47B)),((_tmp47B->gcenv=g,((_tmp47B->cpos=(
void*)((void*)3),((_tmp47B->var_dict=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct
_tuple0*,struct _tuple0*)))Cyc_Dict_empty)(Cyc_Absyn_qvar_cmp),_tmp47B)))))));}
...
n);if((unsigned int)_tmp1AE)return*_tmp1AE;else{struct Cyc_Absyn_Aggrdecl*_tmp47C;
struct Cyc_Absyn_Aggrdecl*_tmp1AF=(_tmp47C=_cycalloc(sizeof(*_tmp47C)),((_tmp47C->kind=(
void*)((void*)0),((_tmp47C->sc=(void*)((void*)2),((_tmp47C->name=n,((_tmp47C->tvs=
0,((_tmp47C->impl=0,((_tmp47C->attributes=0,_tmp47C)))))))))))));struct _tuple4*
_tmp47D;struct _tuple4*p=(_tmp47D=_cycalloc(sizeof(*_tmp47D)),((_tmp47D->f1=
_tmp1AF,((_tmp47D->f2=0,_tmp47D)))));(env->gcenv)->struct_dict=((struct Cyc_Dict_Dict(*)(
...
unsigned int)_tmp1B2)return*_tmp1B2;else{struct Cyc_Absyn_Aggrdecl*_tmp47E;struct
Cyc_Absyn_Aggrdecl*_tmp1B3=(_tmp47E=_cycalloc(sizeof(*_tmp47E)),((_tmp47E->kind=(
void*)((void*)1),((_tmp47E->sc=(void*)((void*)2),((_tmp47E->name=n,((_tmp47E->tvs=
...
_tmp1B3,((_tmp47F->f2=0,_tmp47F)))));(env->gcenv)->union_dict=((struct Cyc_Dict_Dict(*)(
...
if(_tmp1BD != Cyc_Dict_Absent)goto _LL141;_LL140: {struct _tuple3 _tmp480;return(
_tmp480.f1=Cyc_Port_var(),((_tmp480.f2=Cyc_Port_var(),_tmp480)));}_LL141:;_LL142:(
...
_tmp1C5;_LL144: if(_tmp1C4 <= (void*)4)goto _LL148;if(*((int*)_tmp1C4)!= 17)goto
...
_LL154;if(*((int*)_tmp1CF)!= 17)goto _LL152;_tmp1D0=((struct Cyc_Absyn_TypedefType_struct*)
...
env,void*cpos){struct Cyc_Port_Cenv*_tmp481;return(_tmp481=_cycalloc(sizeof(*
_tmp481)),((_tmp481->gcenv=env->gcenv,((_tmp481->var_dict=env->var_dict,((
_tmp481->cpos=(void*)cpos,_tmp481)))))));}static void Cyc_Port_add_return_type(
...
_tuple0*x,void*t,void*qual,void*ctype){struct _tuple6*_tmp487;struct _tuple3*
_tmp486;struct Cyc_Port_Cenv*_tmp485;return(_tmp485=_cycalloc(sizeof(*_tmp485)),((
_tmp485->gcenv=env->gcenv,((_tmp485->var_dict=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct _tuple0*k,struct _tuple6*v))Cyc_Dict_insert)(env->var_dict,x,((_tmp487=
_cycalloc(sizeof(*_tmp487)),((_tmp487->f1=t,((_tmp487->f2=((_tmp486=_cycalloc(
sizeof(*_tmp486)),((_tmp486->f1=qual,((_tmp486->f2=ctype,_tmp486)))))),_tmp487))))))),((
_tmp485->cpos=(void*)((void*)env->cpos),_tmp485)))))));}static void Cyc_Port_add_typedef(
struct Cyc_Port_Cenv*env,struct _tuple0*n,void*t,void*ct);static void Cyc_Port_add_typedef(
struct Cyc_Port_Cenv*env,struct _tuple0*n,void*t,void*ct){struct _tuple3*_tmp488;(
...
_tmp488=_cycalloc(sizeof(*_tmp488)),((_tmp488->f1=t,((_tmp488->f2=ct,_tmp488)))))));}
...
new_qual,void*orig_qual,struct Cyc_Position_Segment*loc){struct _tuple7*_tmp48B;
struct Cyc_List_List*_tmp48A;(env->gcenv)->qualifier_edits=((_tmp48A=_cycalloc(
sizeof(*_tmp48A)),((_tmp48A->hd=((_tmp48B=_cycalloc(sizeof(*_tmp48B)),((_tmp48B->f1=
new_qual,((_tmp48B->f2=orig_qual,((_tmp48B->f3=loc,_tmp48B)))))))),((_tmp48A->tl=(
env->gcenv)->qualifier_edits,_tmp48A))))));}static void Cyc_Port_register_ptr_cvars(
...
void*orig_ptr,struct Cyc_Position_Segment*loc){struct _tuple7*_tmp48E;struct Cyc_List_List*
_tmp48D;(env->gcenv)->pointer_edits=((_tmp48D=_cycalloc(sizeof(*_tmp48D)),((
_tmp48D->hd=((_tmp48E=_cycalloc(sizeof(*_tmp48E)),((_tmp48E->f1=new_ptr,((
_tmp48E->f2=orig_ptr,((_tmp48E->f3=loc,_tmp48E)))))))),((_tmp48D->tl=(env->gcenv)->pointer_edits,
_tmp48D))))));}static void Cyc_Port_register_zeroterm_cvars(struct Cyc_Port_Cenv*
...
struct _tuple7*_tmp491;struct Cyc_List_List*_tmp490;(env->gcenv)->zeroterm_edits=((
_tmp490=_cycalloc(sizeof(*_tmp490)),((_tmp490->hd=((_tmp491=_cycalloc(sizeof(*
_tmp491)),((_tmp491->f1=new_zt,((_tmp491->f2=orig_zt,((_tmp491->f3=loc,_tmp491)))))))),((
_tmp490->tl=(env->gcenv)->zeroterm_edits,_tmp490))))));}static void*Cyc_Port_main_type();
static void*Cyc_Port_main_type(){struct _tuple1*_tmp492;struct _tuple1*arg1=(
_tmp492=_cycalloc(sizeof(*_tmp492)),((_tmp492->f1=0,((_tmp492->f2=Cyc_Absyn_empty_tqual(
0),((_tmp492->f3=Cyc_Absyn_sint_typ,_tmp492)))))));struct _tuple1*_tmp493;struct
_tuple1*arg2=(_tmp493=_cycalloc(sizeof(*_tmp493)),((_tmp493->f1=0,((_tmp493->f2=
Cyc_Absyn_empty_tqual(0),((_tmp493->f3=Cyc_Absyn_dynforward_typ(Cyc_Absyn_string_typ(
Cyc_Absyn_wildtyp(0)),Cyc_Absyn_wildtyp(0),Cyc_Absyn_empty_tqual(0),((struct Cyc_Absyn_Conref*(*)())
Cyc_Absyn_empty_conref)()),_tmp493)))))));struct Cyc_Absyn_FnType_struct _tmp49D;
struct _tuple1*_tmp49C[2];struct Cyc_Absyn_FnInfo _tmp49B;struct Cyc_Absyn_FnType_struct*
_tmp49A;return(void*)((_tmp49A=_cycalloc(sizeof(*_tmp49A)),((_tmp49A[0]=((
_tmp49D.tag=8,((_tmp49D.f1=((_tmp49B.tvars=0,((_tmp49B.effect=0,((_tmp49B.ret_typ=(
void*)Cyc_Absyn_sint_typ,((_tmp49B.args=((_tmp49C[1]=arg2,((_tmp49C[0]=arg1,((
struct Cyc_List_List*(*)(struct _dynforward_ptr))Cyc_List_list)(_tag_dynforward(
_tmp49C,sizeof(struct _tuple1*),2)))))),((_tmp49B.c_varargs=0,((_tmp49B.cyc_varargs=
0,((_tmp49B.rgn_po=0,((_tmp49B.attributes=0,_tmp49B)))))))))))))))),_tmp49D)))),
_tmp49A))));}static void*Cyc_Port_type_to_ctype(struct Cyc_Port_Cenv*env,void*t);
...
_tmp4A0;struct _tuple0*_tmp49F;_tmp1E6=Cyc_Port_add_var(_tmp1E6,((_tmp49F=
_cycalloc(sizeof(*_tmp49F)),((_tmp49F->f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp4A0.Loc_n).tag=0,_tmp4A0)),((_tmp49F->f2=_init_dynforward_ptr(_cycalloc(
sizeof(struct _dynforward_ptr)),"main",sizeof(char),5),_tmp49F)))))),Cyc_Port_main_type(),
...
Cyc_Port_compress_ct(t);struct _dynforward_ptr*_tmp1EB;void*_tmp1EC;void*_tmp1ED;
...
if(!((int(*)(struct Cyc_Dict_Dict d,struct _dynforward_ptr*k))Cyc_Dict_member)(*cts,
_tmp1EB)){int*_tmp4A1;*cts=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct
_dynforward_ptr*k,int*v))Cyc_Dict_insert)(*cts,_tmp1EB,(int*)((_tmp4A1=
_cycalloc_atomic(sizeof(*_tmp4A1)),((_tmp4A1[0]=0,_tmp4A1)))));}{int*_tmp1F7=((
int*(*)(struct Cyc_Dict_Dict d,struct _dynforward_ptr*k))Cyc_Dict_lookup)(*cts,
...
c);{struct _tuple3 _tmp4A2;struct _tuple3 _tmp1F9=(_tmp4A2.f1=t,((_tmp4A2.f2=c,
_tmp4A2)));void*_tmp1FA;struct Cyc_Absyn_PtrInfo _tmp1FB;void*_tmp1FC;struct Cyc_Absyn_PtrAtts
...
_tmp202);{struct _tuple3 _tmp4A3;struct _tuple3 _tmp211=(_tmp4A3.f1=_tmp1FE,((
_tmp4A3.f2=_tmp202,_tmp4A3)));void*_tmp212;void*_tmp213;void*_tmp214;void*
_tmp215;struct _dynforward_ptr*_tmp216;_LL188: _tmp212=_tmp211.f1;if(_tmp212 <= (
...
_tmp4AC;const char*_tmp4AB;const char*_tmp4AA;struct Cyc_List_List*_tmp4A9;(env->gcenv)->edits=((
_tmp4A9=_cycalloc(sizeof(*_tmp4A9)),((_tmp4A9->hd=((_tmp4AC=_cycalloc(sizeof(*
_tmp4AC)),((_tmp4AC->loc=_tmp20F,((_tmp4AC->old_string=((_tmp4AB="`H ",
_tag_dynforward(_tmp4AB,sizeof(char),_get_zero_arr_size_char(_tmp4AB,4)))),((
_tmp4AC->new_string=((_tmp4AA="",_tag_dynforward(_tmp4AA,sizeof(char),
_get_zero_arr_size_char(_tmp4AA,1)))),_tmp4AC)))))))),((_tmp4A9->tl=(env->gcenv)->edits,
_tmp4A9))))));}goto _LL187;_LL18A: _tmp214=_tmp211.f1;if(_tmp214 <= (void*)4)goto
...
_dynforward_ptr*k))Cyc_Dict_lookup)(counts,_tmp216);if(_tmp21B > 1){struct Cyc_Port_Edit*
_tmp4BC;const char*_tmp4BB;void*_tmp4BA[1];struct Cyc_String_pa_struct _tmp4B9;
const char*_tmp4B8;struct Cyc_List_List*_tmp4B7;(env->gcenv)->edits=((_tmp4B7=
_cycalloc(sizeof(*_tmp4B7)),((_tmp4B7->hd=((_tmp4BC=_cycalloc(sizeof(*_tmp4BC)),((
_tmp4BC->loc=_tmp20F,((_tmp4BC->old_string=(struct _dynforward_ptr)((_tmp4B9.tag=
0,((_tmp4B9.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)*_tmp216),((
_tmp4BA[0]=& _tmp4B9,Cyc_aprintf(((_tmp4BB="%s ",_tag_dynforward(_tmp4BB,sizeof(
char),_get_zero_arr_size_char(_tmp4BB,4)))),_tag_dynforward(_tmp4BA,sizeof(void*),
1)))))))),((_tmp4BC->new_string=((_tmp4B8="",_tag_dynforward(_tmp4B8,sizeof(char),
_get_zero_arr_size_char(_tmp4B8,1)))),_tmp4BC)))))))),((_tmp4B7->tl=(env->gcenv)->edits,
_tmp4B7))))));}goto _LL187;}_LL18C:;_LL18D: goto _LL187;_LL187:;}goto _LL17E;}_LL181:
...
_tmp225)!= 17)goto _LL191;_tmp226=((struct Cyc_Absyn_TypedefType_struct*)_tmp225)->f1;
_LL190:{union Cyc_Absyn_Nmspace_union _tmp4BD;(*_tmp226).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp4BD.Loc_n).tag=0,_tmp4BD));}return Cyc_Port_is_char(env,Cyc_Port_lookup_typedef(
...
if(_tmp229 <= (void*)4)goto _LL198;if(*((int*)_tmp229)!= 17)goto _LL198;_tmp22A=((
struct Cyc_Absyn_TypedefType_struct*)_tmp229)->f1;_LL197:{union Cyc_Absyn_Nmspace_union
_tmp4BE;(*_tmp22A).f1=(union Cyc_Absyn_Nmspace_union)(((_tmp4BE.Loc_n).tag=0,
_tmp4BE));}return Cyc_Port_lookup_typedef_ctype(env,_tmp22A);_LL198: if((int)
...
struct Cyc_Absyn_Tvar _tmp246;struct _dynforward_ptr*_tmp247;_LL1AF: if((int)_tmp244
...
_tmp257=_tmp255.f3;{struct Cyc_List_List*_tmp4BF;cargs=((_tmp4BF=_cycalloc(
sizeof(*_tmp4BF)),((_tmp4BF->hd=(void*)Cyc_Port_type_to_ctype(_tmp254,_tmp257),((
_tmp4BF->tl=cargs,_tmp4BF))))));}}return Cyc_Port_fn_ct(_tmp253,Cyc_List_imp_rev(
...
_tmp25B=(_tmp259.UnknownAggr).f2;_LL1CD:{union Cyc_Absyn_Nmspace_union _tmp4C0;(*
_tmp25B).f1=(union Cyc_Absyn_Nmspace_union)(((_tmp4C0.Loc_n).tag=0,_tmp4C0));}{
struct _tuple4*_tmp260=Cyc_Port_lookup_struct_decl(env,_tmp25B);return Cyc_Port_known_aggr_ct(
_tmp260);}_LL1CE: if((_tmp259.UnknownAggr).tag != 0)goto _LL1D0;_tmp25C=(_tmp259.UnknownAggr).f1;
if((int)_tmp25C != 1)goto _LL1D0;_tmp25D=(_tmp259.UnknownAggr).f2;_LL1CF:{union Cyc_Absyn_Nmspace_union
_tmp4C1;(*_tmp25D).f1=(union Cyc_Absyn_Nmspace_union)(((_tmp4C1.Loc_n).tag=0,
_tmp4C1));}{struct _tuple4*_tmp262=Cyc_Port_lookup_union_decl(env,_tmp25D);return
Cyc_Port_known_aggr_ct(_tmp262);}_LL1D0: if((_tmp259.KnownAggr).tag != 1)goto
_LL1CB;_tmp25E=(_tmp259.KnownAggr).f1;_LL1D1: {struct Cyc_Absyn_Aggrdecl*_tmp263=*
_tmp25E;void*_tmp264=(void*)_tmp263->kind;_LL1D3: if((int)_tmp264 != 0)goto _LL1D5;
_LL1D4: {struct _tuple4*_tmp265=Cyc_Port_lookup_struct_decl(env,_tmp263->name);
return Cyc_Port_known_aggr_ct(_tmp265);}_LL1D5: if((int)_tmp264 != 1)goto _LL1D2;
_LL1D6: {struct _tuple4*_tmp266=Cyc_Port_lookup_union_decl(env,_tmp263->name);
...
_LL1AB: for(0;(unsigned int)_tmp23E;_tmp23E=_tmp23E->tl){{union Cyc_Absyn_Nmspace_union
_tmp4C2;(*((struct Cyc_Absyn_Enumfield*)_tmp23E->hd)->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp4C2.Loc_n).tag=0,_tmp4C2));}env=Cyc_Port_add_var(env,((struct Cyc_Absyn_Enumfield*)
...
return Cyc_Port_arith_ct();_LL1FE: if((int)_tmp26A != 19)goto _LL1D7;_LL1FF: {const
char*_tmp4C5;void*_tmp4C4;(_tmp4C4=0,((int(*)(struct _dynforward_ptr fmt,struct
_dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4C5=".size primop",_tag_dynforward(
_tmp4C5,sizeof(char),_get_zero_arr_size_char(_tmp4C5,13)))),_tag_dynforward(
_tmp4C4,sizeof(void*),0)));}_LL1D7:;}static struct _tuple3 Cyc_Port_gen_lhs(struct
...
_dynforward_ptr*_tmp276;struct Cyc_Absyn_Exp*_tmp277;struct _dynforward_ptr*
_tmp278;_LL201: if(*((int*)_tmp26F)!= 1)goto _LL203;_tmp270=((struct Cyc_Absyn_Var_e_struct*)
...
union Cyc_Absyn_Nmspace_union _tmp4C6;(*_tmp271).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp4C6.Loc_n).tag=0,_tmp4C6));}return Cyc_Port_lookup_var(env,_tmp271);_LL205:
...
Cyc_Port_var());Cyc_Port_leq(_tmp27C,_tmp27D);{struct _tuple3 _tmp4C7;return(
_tmp4C7.f1=_tmp27B,((_tmp4C7.f2=_tmp27A,_tmp4C7)));}}}_LL207: if(*((int*)_tmp26F)
...
env,_tmp274),_tmp281);{struct _tuple3 _tmp4C8;return(_tmp4C8.f1=_tmp280,((_tmp4C8.f2=
_tmp27F,_tmp4C8)));}}_LL209: if(*((int*)_tmp26F)!= 23)goto _LL20B;_tmp275=((struct
...
void*_tmp285=Cyc_Port_gen_exp(env,_tmp275);{struct Cyc_Port_Cfield*_tmp4CB;struct
Cyc_Port_Cfield*_tmp4CA[1];Cyc_Port_leq(Cyc_Port_gen_exp(env,_tmp275),Cyc_Port_unknown_aggr_ct(((
_tmp4CA[0]=((_tmp4CB=_cycalloc(sizeof(*_tmp4CB)),((_tmp4CB->qual=(void*)_tmp284,((
_tmp4CB->f=_tmp276,((_tmp4CB->type=(void*)_tmp283,_tmp4CB)))))))),((struct Cyc_List_List*(*)(
struct _dynforward_ptr))Cyc_List_list)(_tag_dynforward(_tmp4CA,sizeof(struct Cyc_Port_Cfield*),
1))))));}{struct _tuple3 _tmp4CC;return(_tmp4CC.f1=_tmp284,((_tmp4CC.f2=_tmp283,
_tmp4CC)));}}_LL20B: if(*((int*)_tmp26F)!= 24)goto _LL20D;_tmp277=((struct Cyc_Absyn_AggrArrow_e_struct*)
...
env,_tmp277);{struct Cyc_Port_Cfield*_tmp4CF;struct Cyc_Port_Cfield*_tmp4CE[1];Cyc_Port_leq(
Cyc_Port_gen_exp(env,_tmp277),Cyc_Port_ptr_ct(Cyc_Port_unknown_aggr_ct(((_tmp4CE[
0]=((_tmp4CF=_cycalloc(sizeof(*_tmp4CF)),((_tmp4CF->qual=(void*)_tmp28A,((
_tmp4CF->f=_tmp278,((_tmp4CF->type=(void*)_tmp289,_tmp4CF)))))))),((struct Cyc_List_List*(*)(
struct _dynforward_ptr))Cyc_List_list)(_tag_dynforward(_tmp4CE,sizeof(struct Cyc_Port_Cfield*),
1))))),Cyc_Port_var(),Cyc_Port_var(),Cyc_Port_var(),Cyc_Port_var()));}{struct
_tuple3 _tmp4D0;return(_tmp4D0.f1=_tmp28A,((_tmp4D0.f2=_tmp289,_tmp4D0)));}}
_LL20D:;_LL20E: {struct Cyc_String_pa_struct _tmp4D8;void*_tmp4D7[1];const char*
_tmp4D6;void*_tmp4D5;(_tmp4D5=0,((int(*)(struct _dynforward_ptr fmt,struct
_dynforward_ptr ap))Cyc_Tcutil_impos)((struct _dynforward_ptr)((_tmp4D8.tag=0,((
_tmp4D8.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Absynpp_exp2string(
e)),((_tmp4D7[0]=& _tmp4D8,Cyc_aprintf(((_tmp4D6="gen_lhs: %s",_tag_dynforward(
_tmp4D6,sizeof(char),_get_zero_arr_size_char(_tmp4D6,12)))),_tag_dynforward(
_tmp4D7,sizeof(void*),1)))))))),_tag_dynforward(_tmp4D5,sizeof(void*),0)));}
_LL200:;}static void*Cyc_Port_gen_exp(struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Exp*
e);static void*Cyc_Port_gen_exp(struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Exp*e){
void*_tmp293=(void*)e->r;union Cyc_Absyn_Cnst_union _tmp294;union Cyc_Absyn_Cnst_union
_tmp295;union Cyc_Absyn_Cnst_union _tmp296;union Cyc_Absyn_Cnst_union _tmp297;union
Cyc_Absyn_Cnst_union _tmp298;int _tmp299;union Cyc_Absyn_Cnst_union _tmp29A;union Cyc_Absyn_Cnst_union
_tmp29B;union Cyc_Absyn_Cnst_union _tmp29C;struct _tuple0*_tmp29D;struct _tuple0*
_tmp29E;void*_tmp29F;struct Cyc_List_List*_tmp2A0;struct Cyc_Absyn_Exp*_tmp2A1;
struct Cyc_Core_Opt*_tmp2A2;struct Cyc_Absyn_Exp*_tmp2A3;struct Cyc_Absyn_Exp*
_tmp2A4;void*_tmp2A5;struct Cyc_Absyn_Exp*_tmp2A6;struct Cyc_Absyn_Exp*_tmp2A7;
struct Cyc_Absyn_Exp*_tmp2A8;struct Cyc_Absyn_Exp*_tmp2A9;struct Cyc_Absyn_Exp*
_tmp2AA;struct Cyc_Absyn_Exp*_tmp2AB;struct Cyc_Absyn_Exp*_tmp2AC;struct Cyc_Absyn_Exp*
_tmp2AD;struct Cyc_Absyn_Exp*_tmp2AE;struct Cyc_Absyn_Exp*_tmp2AF;struct Cyc_List_List*
_tmp2B0;struct Cyc_Absyn_Exp*_tmp2B1;struct Cyc_List_List*_tmp2B2;struct Cyc_Absyn_Exp*
_tmp2B3;void*_tmp2B4;struct Cyc_Absyn_Exp*_tmp2B5;struct Cyc_Absyn_Exp*_tmp2B6;
struct Cyc_Absyn_Exp*_tmp2B7;struct Cyc_Absyn_Exp*_tmp2B8;struct Cyc_Absyn_Exp*
_tmp2B9;struct Cyc_Absyn_Exp*_tmp2BA;struct _dynforward_ptr*_tmp2BB;struct Cyc_Absyn_Exp*
_tmp2BC;struct _dynforward_ptr*_tmp2BD;struct Cyc_Absyn_MallocInfo _tmp2BE;void**
_tmp2BF;struct Cyc_Absyn_Exp*_tmp2C0;struct Cyc_Absyn_Exp*_tmp2C1;struct Cyc_Absyn_Exp*
_tmp2C2;struct Cyc_Absyn_Stmt*_tmp2C3;_LL210: if(*((int*)_tmp293)!= 0)goto _LL212;
...
_tmp293)->f1;_LL22D:{union Cyc_Absyn_Nmspace_union _tmp4D9;(*_tmp29E).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp4D9.Loc_n).tag=0,_tmp4D9));}{void*_tmp2C6;struct _tuple3 _tmp2C5=Cyc_Port_lookup_var(
...
_tmp4DA;struct Cyc_List_List x2=(_tmp4DA.hd=(void*)_tmp2CF,((_tmp4DA.tl=0,_tmp4DA)));
struct Cyc_List_List _tmp4DB;struct Cyc_List_List x1=(_tmp4DB.hd=(void*)_tmp2CE,((
_tmp4DB.tl=(struct Cyc_List_List*)& x2,_tmp4DB)));void*_tmp2D0=Cyc_Port_gen_primop(
...
_LL242;_LL241: {const char*_tmp4DE;void*_tmp4DD;(_tmp4DD=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4DE="throw",
_tag_dynforward(_tmp4DE,sizeof(char),_get_zero_arr_size_char(_tmp4DE,6)))),
_tag_dynforward(_tmp4DD,sizeof(void*),0)));}_LL242: if(*((int*)_tmp293)!= 13)goto
_LL244;_tmp2B3=((struct Cyc_Absyn_NoInstantiate_e_struct*)_tmp293)->f1;_LL243:
return Cyc_Port_gen_exp(env,_tmp2B3);_LL244: if(*((int*)_tmp293)!= 14)goto _LL246;
_LL245: {const char*_tmp4E1;void*_tmp4E0;(_tmp4E0=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4E1="instantiate",
_tag_dynforward(_tmp4E1,sizeof(char),_get_zero_arr_size_char(_tmp4E1,12)))),
_tag_dynforward(_tmp4E0,sizeof(void*),0)));}_LL246: if(*((int*)_tmp293)!= 15)goto
_LL248;_tmp2B4=(void*)((struct Cyc_Absyn_Cast_e_struct*)_tmp293)->f1;_tmp2B5=((
struct Cyc_Absyn_Cast_e_struct*)_tmp293)->f2;_LL247: {void*_tmp2DF=Cyc_Port_type_to_ctype(
env,_tmp2B4);void*_tmp2E0=Cyc_Port_gen_exp(env,_tmp2B5);Cyc_Port_leq(_tmp2DF,
_tmp2E0);return _tmp2E0;}_LL248: if(*((int*)_tmp293)!= 16)goto _LL24A;_tmp2B6=((
struct Cyc_Absyn_Address_e_struct*)_tmp293)->f1;_LL249: {void*_tmp2E2;void*
_tmp2E3;struct _tuple3 _tmp2E1=Cyc_Port_gen_lhs(env,_tmp2B6);_tmp2E2=_tmp2E1.f1;
_tmp2E3=_tmp2E1.f2;return Cyc_Port_ptr_ct(_tmp2E3,_tmp2E2,Cyc_Port_var(),Cyc_Port_var(),
Cyc_Port_var());}_LL24A: if(*((int*)_tmp293)!= 25)goto _LL24C;_tmp2B7=((struct Cyc_Absyn_Subscript_e_struct*)
_tmp293)->f1;_tmp2B8=((struct Cyc_Absyn_Subscript_e_struct*)_tmp293)->f2;_LL24B: {
void*_tmp2E4=Cyc_Port_var();Cyc_Port_leq(Cyc_Port_gen_exp(env,_tmp2B8),Cyc_Port_arith_ct());{
...
env,_tmp2BA);{struct Cyc_Port_Cfield*_tmp4E4;struct Cyc_Port_Cfield*_tmp4E3[1];Cyc_Port_leq(
Cyc_Port_gen_exp(env,_tmp2BA),Cyc_Port_unknown_aggr_ct(((_tmp4E3[0]=((_tmp4E4=
_cycalloc(sizeof(*_tmp4E4)),((_tmp4E4->qual=(void*)Cyc_Port_var(),((_tmp4E4->f=
_tmp2BB,((_tmp4E4->type=(void*)_tmp2E7,_tmp4E4)))))))),((struct Cyc_List_List*(*)(
struct _dynforward_ptr))Cyc_List_list)(_tag_dynforward(_tmp4E3,sizeof(struct Cyc_Port_Cfield*),
...
env,_tmp2BC);{struct Cyc_Port_Cfield*_tmp4E7;struct Cyc_Port_Cfield*_tmp4E6[1];Cyc_Port_leq(
Cyc_Port_gen_exp(env,_tmp2BC),Cyc_Port_ptr_ct(Cyc_Port_unknown_aggr_ct(((_tmp4E6[
0]=((_tmp4E7=_cycalloc(sizeof(*_tmp4E7)),((_tmp4E7->qual=(void*)Cyc_Port_var(),((
_tmp4E7->f=_tmp2BD,((_tmp4E7->type=(void*)_tmp2EB,_tmp4E7)))))))),((struct Cyc_List_List*(*)(
struct _dynforward_ptr))Cyc_List_list)(_tag_dynforward(_tmp4E6,sizeof(struct Cyc_Port_Cfield*),
...
const char*_tmp4EA;void*_tmp4E9;(_tmp4E9=0,((int(*)(struct _dynforward_ptr fmt,
struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4EA="Swap_e",_tag_dynforward(
_tmp4EA,sizeof(char),_get_zero_arr_size_char(_tmp4EA,7)))),_tag_dynforward(
_tmp4E9,sizeof(void*),0)));}_LL256: if(*((int*)_tmp293)!= 21)goto _LL258;_LL257: {
const char*_tmp4ED;void*_tmp4EC;(_tmp4EC=0,((int(*)(struct _dynforward_ptr fmt,
struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4ED="Gen",_tag_dynforward(
_tmp4ED,sizeof(char),_get_zero_arr_size_char(_tmp4ED,4)))),_tag_dynforward(
_tmp4EC,sizeof(void*),0)));}_LL258: if(*((int*)_tmp293)!= 17)goto _LL25A;_LL259: {
const char*_tmp4F0;void*_tmp4EF;(_tmp4EF=0,((int(*)(struct _dynforward_ptr fmt,
struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4F0="New_e",_tag_dynforward(
_tmp4F0,sizeof(char),_get_zero_arr_size_char(_tmp4F0,6)))),_tag_dynforward(
_tmp4EF,sizeof(void*),0)));}_LL25A: if(*((int*)_tmp293)!= 26)goto _LL25C;_LL25B: {
const char*_tmp4F3;void*_tmp4F2;(_tmp4F2=0,((int(*)(struct _dynforward_ptr fmt,
struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4F3="Tuple_e",_tag_dynforward(
_tmp4F3,sizeof(char),_get_zero_arr_size_char(_tmp4F3,8)))),_tag_dynforward(
_tmp4F2,sizeof(void*),0)));}_LL25C: if(*((int*)_tmp293)!= 27)goto _LL25E;_LL25D: {
const char*_tmp4F6;void*_tmp4F5;(_tmp4F5=0,((int(*)(struct _dynforward_ptr fmt,
struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4F6="CompoundLit_e",
_tag_dynforward(_tmp4F6,sizeof(char),_get_zero_arr_size_char(_tmp4F6,14)))),
_tag_dynforward(_tmp4F5,sizeof(void*),0)));}_LL25E: if(*((int*)_tmp293)!= 28)goto
_LL260;_LL25F: {const char*_tmp4F9;void*_tmp4F8;(_tmp4F8=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4F9="Array_e",
_tag_dynforward(_tmp4F9,sizeof(char),_get_zero_arr_size_char(_tmp4F9,8)))),
_tag_dynforward(_tmp4F8,sizeof(void*),0)));}_LL260: if(*((int*)_tmp293)!= 29)goto
_LL262;_LL261: {const char*_tmp4FC;void*_tmp4FB;(_tmp4FB=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4FC="Comprehension_e",
_tag_dynforward(_tmp4FC,sizeof(char),_get_zero_arr_size_char(_tmp4FC,16)))),
_tag_dynforward(_tmp4FB,sizeof(void*),0)));}_LL262: if(*((int*)_tmp293)!= 30)goto
_LL264;_LL263: {const char*_tmp4FF;void*_tmp4FE;(_tmp4FE=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp4FF="Struct_e",
_tag_dynforward(_tmp4FF,sizeof(char),_get_zero_arr_size_char(_tmp4FF,9)))),
_tag_dynforward(_tmp4FE,sizeof(void*),0)));}_LL264: if(*((int*)_tmp293)!= 31)goto
_LL266;_LL265: {const char*_tmp502;void*_tmp501;(_tmp501=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp502="AnonStruct_e",
_tag_dynforward(_tmp502,sizeof(char),_get_zero_arr_size_char(_tmp502,13)))),
_tag_dynforward(_tmp501,sizeof(void*),0)));}_LL266: if(*((int*)_tmp293)!= 32)goto
_LL268;_LL267: {const char*_tmp505;void*_tmp504;(_tmp504=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp505="Tunion_e",
_tag_dynforward(_tmp505,sizeof(char),_get_zero_arr_size_char(_tmp505,9)))),
_tag_dynforward(_tmp504,sizeof(void*),0)));}_LL268: if(*((int*)_tmp293)!= 37)goto
_LL26A;_LL269: {const char*_tmp508;void*_tmp507;(_tmp507=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp508="UnresolvedMem_e",
_tag_dynforward(_tmp508,sizeof(char),_get_zero_arr_size_char(_tmp508,16)))),
_tag_dynforward(_tmp507,sizeof(void*),0)));}_LL26A: if(*((int*)_tmp293)!= 38)goto
_LL20F;_tmp2C3=((struct Cyc_Absyn_StmtExp_e_struct*)_tmp293)->f1;_LL26B: {const
char*_tmp50B;void*_tmp50A;(_tmp50A=0,((int(*)(struct _dynforward_ptr fmt,struct
_dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp50B="StmtExp_e",_tag_dynforward(
_tmp50B,sizeof(char),_get_zero_arr_size_char(_tmp50B,10)))),_tag_dynforward(
_tmp50A,sizeof(void*),0)));}_LL20F:;}static void Cyc_Port_gen_stmt(struct Cyc_Port_Cenv*
env,struct Cyc_Absyn_Stmt*s);static void Cyc_Port_gen_stmt(struct Cyc_Port_Cenv*env,
struct Cyc_Absyn_Stmt*s){void*_tmp308=(void*)s->r;struct Cyc_Absyn_Exp*_tmp309;
struct Cyc_Absyn_Stmt*_tmp30A;struct Cyc_Absyn_Stmt*_tmp30B;struct Cyc_Absyn_Exp*
...
_tmp312;struct Cyc_Absyn_Exp*_tmp313;struct _tuple2 _tmp314;struct Cyc_Absyn_Exp*
_tmp315;struct _tuple2 _tmp316;struct Cyc_Absyn_Exp*_tmp317;struct Cyc_Absyn_Stmt*
_tmp318;struct Cyc_Absyn_Exp*_tmp319;struct Cyc_List_List*_tmp31A;struct Cyc_Absyn_Decl*
_tmp31B;struct Cyc_Absyn_Stmt*_tmp31C;struct Cyc_Absyn_Stmt*_tmp31D;struct Cyc_Absyn_Stmt*
_tmp31E;struct _tuple2 _tmp31F;struct Cyc_Absyn_Exp*_tmp320;_LL26D: if((int)_tmp308
!= 0)goto _LL26F;_LL26E: return;_LL26F: if(_tmp308 <= (void*)1)goto _LL271;if(*((int*)
_tmp308)!= 0)goto _LL271;_tmp309=((struct Cyc_Absyn_Exp_s_struct*)_tmp308)->f1;
_LL270: Cyc_Port_gen_exp(env,_tmp309);return;_LL271: if(_tmp308 <= (void*)1)goto
_LL273;if(*((int*)_tmp308)!= 1)goto _LL273;_tmp30A=((struct Cyc_Absyn_Seq_s_struct*)
...
_tmp308)!= 10)goto _LL285;_LL284: {const char*_tmp50E;void*_tmp50D;(_tmp50D=0,((
int(*)(struct _dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((
_tmp50E="fallthru",_tag_dynforward(_tmp50E,sizeof(char),_get_zero_arr_size_char(
_tmp50E,9)))),_tag_dynforward(_tmp50D,sizeof(void*),0)));}_LL285: if(_tmp308 <= (
...
_LL28D;_LL28C: {const char*_tmp511;void*_tmp510;(_tmp510=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp511="try/catch",
_tag_dynforward(_tmp511,sizeof(char),_get_zero_arr_size_char(_tmp511,10)))),
_tag_dynforward(_tmp510,sizeof(void*),0)));}_LL28D: if(_tmp308 <= (void*)1)goto
_LL28F;if(*((int*)_tmp308)!= 15)goto _LL28F;_LL28E: {const char*_tmp514;void*
_tmp513;(_tmp513=0,((int(*)(struct _dynforward_ptr fmt,struct _dynforward_ptr ap))
Cyc_Tcutil_impos)(((_tmp514="region",_tag_dynforward(_tmp514,sizeof(char),
_get_zero_arr_size_char(_tmp514,7)))),_tag_dynforward(_tmp513,sizeof(void*),0)));}
_LL28F: if(_tmp308 <= (void*)1)goto _LL291;if(*((int*)_tmp308)!= 16)goto _LL291;
_LL290: {const char*_tmp517;void*_tmp516;(_tmp516=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp517="reset region",
_tag_dynforward(_tmp517,sizeof(char),_get_zero_arr_size_char(_tmp517,13)))),
_tag_dynforward(_tmp516,sizeof(void*),0)));}_LL291: if(_tmp308 <= (void*)1)goto
_LL26C;if(*((int*)_tmp308)!= 17)goto _LL26C;_LL292: {const char*_tmp51A;void*
_tmp519;(_tmp519=0,((int(*)(struct _dynforward_ptr fmt,struct _dynforward_ptr ap))
Cyc_Tcutil_impos)(((_tmp51A="alias",_tag_dynforward(_tmp51A,sizeof(char),
_get_zero_arr_size_char(_tmp51A,6)))),_tag_dynforward(_tmp519,sizeof(void*),0)));}
...
e);static void*Cyc_Port_gen_initializer(struct Cyc_Port_Cenv*env,void*t,struct Cyc_Absyn_Exp*
...
_tmp334=((struct Cyc_Absyn_TypedefType_struct*)_tmp333)->f1;_LL2A0:{union Cyc_Absyn_Nmspace_union
_tmp51B;(*_tmp334).f1=(union Cyc_Absyn_Nmspace_union)(((_tmp51B.Loc_n).tag=0,
_tmp51B));}t=Cyc_Port_lookup_typedef(env,_tmp334);goto LOOP;_LL2A1: if(*((int*)
...
_tmp346.f2;if((unsigned int)_tmp347){const char*_tmp51E;void*_tmp51D;(_tmp51D=0,((
int(*)(struct _dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((
_tmp51E="designators in initializers",_tag_dynforward(_tmp51E,sizeof(char),
_get_zero_arr_size_char(_tmp51E,28)))),_tag_dynforward(_tmp51D,sizeof(void*),0)));}{
...
_tmp33C=(_tmp33A.UnknownAggr).f2;_LL2A4:{union Cyc_Absyn_Nmspace_union _tmp51F;(*
_tmp33C).f1=(union Cyc_Absyn_Nmspace_union)(((_tmp51F.Loc_n).tag=0,_tmp51F));}{
struct Cyc_Absyn_Aggrdecl*_tmp34E;struct _tuple4 _tmp34D=*Cyc_Port_lookup_struct_decl(
env,_tmp33C);_tmp34E=_tmp34D.f1;if((struct Cyc_Absyn_Aggrdecl*)_tmp34E == 0){const
char*_tmp522;void*_tmp521;(_tmp521=0,((int(*)(struct _dynforward_ptr fmt,struct
_dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp522="struct is not yet defined",
_tag_dynforward(_tmp522,sizeof(char),_get_zero_arr_size_char(_tmp522,26)))),
_tag_dynforward(_tmp521,sizeof(void*),0)));}_tmp340=_tmp34E;goto _LL2A6;}_LL2A5:
if(*((int*)_tmp333)!= 10)goto _LL2A7;_tmp33D=((struct Cyc_Absyn_AggrType_struct*)
_tmp333)->f1;_tmp33E=_tmp33D.aggr_info;if((((((struct Cyc_Absyn_AggrType_struct*)
_tmp333)->f1).aggr_info).KnownAggr).tag != 1)goto _LL2A7;_tmp33F=(_tmp33E.KnownAggr).f1;
_tmp340=*_tmp33F;_LL2A6: {struct Cyc_List_List*_tmp351=((struct Cyc_Absyn_AggrdeclImpl*)
_check_null(_tmp340->impl))->fields;for(0;_tmp330 != 0;_tmp330=_tmp330->tl){
struct Cyc_List_List*_tmp353;struct Cyc_Absyn_Exp*_tmp354;struct _tuple8 _tmp352=*((
struct _tuple8*)_tmp330->hd);_tmp353=_tmp352.f1;_tmp354=_tmp352.f2;if((
unsigned int)_tmp353){const char*_tmp525;void*_tmp524;(_tmp524=0,((int(*)(struct
_dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp525="designators in initializers",
_tag_dynforward(_tmp525,sizeof(char),_get_zero_arr_size_char(_tmp525,28)))),
_tag_dynforward(_tmp524,sizeof(void*),0)));}{struct Cyc_Absyn_Aggrfield*_tmp357=(
struct Cyc_Absyn_Aggrfield*)((struct Cyc_List_List*)_check_null(_tmp351))->hd;
_tmp351=_tmp351->tl;{void*_tmp358=Cyc_Port_gen_initializer(env,(void*)_tmp357->type,
_tmp354);;}}}return Cyc_Port_type_to_ctype(env,t);}_LL2A7:;_LL2A8: {const char*
_tmp528;void*_tmp527;(_tmp527=0,((int(*)(struct _dynforward_ptr fmt,struct
_dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp528="bad type for aggregate initializer",
_tag_dynforward(_tmp528,sizeof(char),_get_zero_arr_size_char(_tmp528,35)))),
_tag_dynforward(_tmp527,sizeof(void*),0)));}_LL29E:;}_LL29A: if(*((int*)_tmp32D)
...
_LL2AC;_tmp35C=((struct Cyc_Absyn_TypedefType_struct*)_tmp35B)->f1;_LL2AB:{union
Cyc_Absyn_Nmspace_union _tmp529;(*_tmp35C).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp529.Loc_n).tag=0,_tmp529));}t=Cyc_Port_lookup_typedef(env,_tmp35C);goto LOOP2;
...
struct Cyc_Absyn_Decl*d){void*_tmp35E=(void*)d->r;struct Cyc_Absyn_Vardecl*_tmp35F;
_LL2B1: if(_tmp35E <= (void*)2)goto _LL2B3;if(*((int*)_tmp35E)!= 0)goto _LL2B3;
_tmp35F=((struct Cyc_Absyn_Var_d_struct*)_tmp35E)->f1;_LL2B2: {void*_tmp360=Cyc_Port_var();
void*q;if((env->gcenv)->porting){q=Cyc_Port_var();Cyc_Port_register_const_cvar(
env,q,(_tmp35F->tq).print_const?Cyc_Port_const_ct(): Cyc_Port_notconst_ct(),(
_tmp35F->tq).loc);}else{q=(_tmp35F->tq).print_const?Cyc_Port_const_ct(): Cyc_Port_notconst_ct();}{
union Cyc_Absyn_Nmspace_union _tmp52A;(*_tmp35F->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp52A.Loc_n).tag=0,_tmp52A));}env=Cyc_Port_add_var(env,_tmp35F->name,(void*)
_tmp35F->type,q,_tmp360);Cyc_Port_unifies(_tmp360,Cyc_Port_type_to_ctype(env,(
void*)_tmp35F->type));if((unsigned int)_tmp35F->initializer){struct Cyc_Absyn_Exp*
...
const char*_tmp52D;void*_tmp52C;(_tmp52C=0,((int(*)(struct _dynforward_ptr fmt,
struct _dynforward_ptr ap))Cyc_Tcutil_impos)(((_tmp52D="non-local decl that isn't a variable",
_tag_dynforward(_tmp52D,sizeof(char),_get_zero_arr_size_char(_tmp52D,37)))),
_tag_dynforward(_tmp52C,sizeof(void*),0)));}_LL2B0:;}struct _tuple9{struct
_dynforward_ptr*f1;struct Cyc_Absyn_Tqual f2;void*f3;};static struct _tuple1*Cyc_Port_make_targ(
struct _tuple9*arg);static struct _tuple1*Cyc_Port_make_targ(struct _tuple9*arg){
struct _dynforward_ptr*_tmp365;struct Cyc_Absyn_Tqual _tmp366;void*_tmp367;struct
_tuple9 _tmp364=*arg;_tmp365=_tmp364.f1;_tmp366=_tmp364.f2;_tmp367=_tmp364.f3;{
struct _tuple1*_tmp52E;return(_tmp52E=_cycalloc(sizeof(*_tmp52E)),((_tmp52E->f1=0,((
_tmp52E->f2=_tmp366,((_tmp52E->f3=_tmp367,_tmp52E)))))));}}static struct Cyc_Port_Cenv*
Cyc_Port_gen_topdecls(struct Cyc_Port_Cenv*env,struct Cyc_List_List*ds);struct
_tuple10{struct _dynforward_ptr*f1;void*f2;void*f3;void*f4;};static struct Cyc_Port_Cenv*
Cyc_Port_gen_topdecl(struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Decl*d);static
...
_LL2BB:{union Cyc_Absyn_Nmspace_union _tmp52F;(*_tmp36A->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp52F.Loc_n).tag=0,_tmp52F));}if(Cyc_Port_declared_var(env,_tmp36A->name)){
...
_tmp369)->f1;_LL2BD:{union Cyc_Absyn_Nmspace_union _tmp530;(*_tmp36B->name).f1=(
union Cyc_Absyn_Nmspace_union)(((_tmp530.Loc_n).tag=0,_tmp530));}{struct _tuple6*
predeclared=0;if(Cyc_Port_declared_var(env,_tmp36B->name))predeclared=(struct
_tuple6*)Cyc_Port_lookup_full_var(env,_tmp36B->name);{void*_tmp374=(void*)
_tmp36B->ret_type;struct Cyc_List_List*_tmp375=_tmp36B->args;struct Cyc_List_List*
_tmp376=((struct Cyc_List_List*(*)(struct _tuple1*(*f)(struct _tuple9*),struct Cyc_List_List*
x))Cyc_List_map)(Cyc_Port_make_targ,_tmp375);struct Cyc_Absyn_FnType_struct
_tmp536;struct Cyc_Absyn_FnInfo _tmp535;struct Cyc_Absyn_FnType_struct*_tmp534;
struct Cyc_Absyn_FnType_struct*_tmp377=(_tmp534=_cycalloc(sizeof(*_tmp534)),((
_tmp534[0]=((_tmp536.tag=8,((_tmp536.f1=((_tmp535.tvars=0,((_tmp535.effect=0,((
_tmp535.ret_typ=(void*)_tmp374,((_tmp535.args=_tmp376,((_tmp535.c_varargs=0,((
_tmp535.cyc_varargs=0,((_tmp535.rgn_po=0,((_tmp535.attributes=0,_tmp535)))))))))))))))),
_tmp536)))),_tmp534)));struct Cyc_Port_Cenv*_tmp378=Cyc_Port_set_cpos(env,(void*)
2);void*_tmp379=Cyc_Port_type_to_ctype(_tmp378,_tmp374);struct Cyc_List_List*
c_args=0;struct Cyc_List_List*c_arg_types=0;{struct Cyc_List_List*_tmp37A=_tmp375;
for(0;(unsigned int)_tmp37A;_tmp37A=_tmp37A->tl){struct _dynforward_ptr*_tmp37C;
struct Cyc_Absyn_Tqual _tmp37D;void*_tmp37E;struct _tuple9 _tmp37B=*((struct _tuple9*)
...
Cyc_Port_notconst_ct();}{struct _tuple10*_tmp539;struct Cyc_List_List*_tmp538;
c_args=((_tmp538=_cycalloc(sizeof(*_tmp538)),((_tmp538->hd=((_tmp539=_cycalloc(
sizeof(*_tmp539)),((_tmp539->f1=_tmp37C,((_tmp539->f2=_tmp37E,((_tmp539->f3=tqv,((
_tmp539->f4=_tmp37F,_tmp539)))))))))),((_tmp538->tl=c_args,_tmp538))))));}{
struct Cyc_List_List*_tmp53A;c_arg_types=((_tmp53A=_cycalloc(sizeof(*_tmp53A)),((
_tmp53A->hd=(void*)_tmp37F,((_tmp53A->tl=c_arg_types,_tmp53A))))));}}}}c_args=((
struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(c_args);
c_arg_types=Cyc_List_imp_rev(c_arg_types);{void*_tmp383=Cyc_Port_fn_ct(_tmp379,
c_arg_types);{union Cyc_Absyn_Nmspace_union _tmp53B;(*_tmp36B->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp53B.Loc_n).tag=0,_tmp53B));}_tmp378=Cyc_Port_add_var(_tmp378,_tmp36B->name,(
void*)_tmp377,Cyc_Port_const_ct(),_tmp383);Cyc_Port_add_return_type(_tmp378,
_tmp379);{struct Cyc_List_List*_tmp385=c_args;for(0;(unsigned int)_tmp385;_tmp385=
_tmp385->tl){struct _dynforward_ptr*_tmp387;void*_tmp388;void*_tmp389;void*
_tmp38A;struct _tuple10 _tmp386=*((struct _tuple10*)_tmp385->hd);_tmp387=_tmp386.f1;
_tmp388=_tmp386.f2;_tmp389=_tmp386.f3;_tmp38A=_tmp386.f4;{union Cyc_Absyn_Nmspace_union
_tmp53E;struct _tuple0*_tmp53D;_tmp378=Cyc_Port_add_var(_tmp378,((_tmp53D=
_cycalloc(sizeof(*_tmp53D)),((_tmp53D->f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp53E.Loc_n).tag=0,_tmp53E)),((_tmp53D->f2=_tmp387,_tmp53D)))))),_tmp388,
_tmp389,_tmp38A);}}}Cyc_Port_gen_stmt(_tmp378,_tmp36B->body);Cyc_Port_generalize(
0,_tmp383);{struct Cyc_Dict_Dict counts=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct
_dynforward_ptr*,struct _dynforward_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);Cyc_Port_region_counts(&
counts,_tmp383);Cyc_Port_register_rgns(env,counts,1,(void*)_tmp377,_tmp383);env=
Cyc_Port_add_var(_tmp378,_tmp36B->name,(void*)_tmp377,Cyc_Port_const_ct(),
_tmp383);if((unsigned int)predeclared){void*_tmp38E;struct _tuple3*_tmp38F;struct
_tuple3 _tmp390;void*_tmp391;void*_tmp392;struct _tuple6 _tmp38D=*predeclared;
_tmp38E=_tmp38D.f1;_tmp38F=_tmp38D.f2;_tmp390=*_tmp38F;_tmp391=_tmp390.f1;
_tmp392=_tmp390.f2;Cyc_Port_unifies(_tmp391,Cyc_Port_const_ct());Cyc_Port_unifies(
_tmp392,Cyc_Port_instantiate(_tmp383));Cyc_Port_register_rgns(env,counts,1,
_tmp38E,_tmp383);}return env;}}}}_LL2BE: if(*((int*)_tmp369)!= 7)goto _LL2C0;
_tmp36C=((struct Cyc_Absyn_Typedef_d_struct*)_tmp369)->f1;_LL2BF: {void*_tmp396=(
void*)((struct Cyc_Core_Opt*)_check_null(_tmp36C->defn))->v;void*_tmp397=Cyc_Port_type_to_ctype(
env,_tmp396);{union Cyc_Absyn_Nmspace_union _tmp53F;(*_tmp36C->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp53F.Loc_n).tag=0,_tmp53F));}Cyc_Port_add_typedef(env,_tmp36C->name,_tmp396,
_tmp397);return env;}_LL2C0: if(*((int*)_tmp369)!= 4)goto _LL2C2;_tmp36D=((struct
Cyc_Absyn_Aggr_d_struct*)_tmp369)->f1;_LL2C1: {struct _tuple0*_tmp399=_tmp36D->name;{
union Cyc_Absyn_Nmspace_union _tmp540;(*_tmp36D->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp540.Loc_n).tag=0,_tmp540));}{struct _tuple4*previous;struct Cyc_List_List*curr=
0;{void*_tmp39B=(void*)_tmp36D->kind;_LL2C7: if((int)_tmp39B != 0)goto _LL2C9;
_LL2C8: previous=Cyc_Port_lookup_struct_decl(env,_tmp399);goto _LL2C6;_LL2C9: if((
int)_tmp39B != 1)goto _LL2C6;_LL2CA: previous=Cyc_Port_lookup_union_decl(env,
_tmp399);goto _LL2C6;_LL2C6:;}if((unsigned int)_tmp36D->impl){struct Cyc_List_List*
cf=(*previous).f2;{struct Cyc_List_List*_tmp39C=((struct Cyc_Absyn_AggrdeclImpl*)
_check_null(_tmp36D->impl))->fields;for(0;(unsigned int)_tmp39C;_tmp39C=_tmp39C->tl){
struct Cyc_Absyn_Aggrfield*_tmp39D=(struct Cyc_Absyn_Aggrfield*)_tmp39C->hd;void*
qv;if((env->gcenv)->porting){qv=Cyc_Port_var();Cyc_Port_register_const_cvar(env,
qv,(_tmp39D->tq).print_const?Cyc_Port_const_ct(): Cyc_Port_notconst_ct(),(_tmp39D->tq).loc);}
else{qv=(_tmp39D->tq).print_const?Cyc_Port_const_ct(): Cyc_Port_notconst_ct();}{
void*_tmp39E=Cyc_Port_type_to_ctype(env,(void*)_tmp39D->type);if(cf != 0){void*
_tmp3A0;void*_tmp3A1;struct Cyc_Port_Cfield _tmp39F=*((struct Cyc_Port_Cfield*)cf->hd);
_tmp3A0=(void*)_tmp39F.qual;_tmp3A1=(void*)_tmp39F.type;cf=cf->tl;Cyc_Port_unifies(
qv,_tmp3A0);Cyc_Port_unifies(_tmp39E,_tmp3A1);}{struct Cyc_Port_Cfield*_tmp543;
struct Cyc_List_List*_tmp542;curr=((_tmp542=_cycalloc(sizeof(*_tmp542)),((_tmp542->hd=((
_tmp543=_cycalloc(sizeof(*_tmp543)),((_tmp543->qual=(void*)qv,((_tmp543->f=
_tmp39D->name,((_tmp543->type=(void*)_tmp39E,_tmp543)))))))),((_tmp542->tl=curr,
_tmp542))))));}}}}curr=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(
curr);if((*previous).f2 == 0)(*previous).f2=curr;}return env;}}_LL2C2: if(*((int*)
_tmp369)!= 6)goto _LL2C4;_tmp36E=((struct Cyc_Absyn_Enum_d_struct*)_tmp369)->f1;
_LL2C3:{union Cyc_Absyn_Nmspace_union _tmp544;(*_tmp36E->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp544.Loc_n).tag=0,_tmp544));}if((unsigned int)_tmp36E->fields){struct Cyc_List_List*
_tmp3A5=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp36E->fields))->v;
for(0;(unsigned int)_tmp3A5;_tmp3A5=_tmp3A5->tl){{union Cyc_Absyn_Nmspace_union
_tmp545;(*((struct Cyc_Absyn_Enumfield*)_tmp3A5->hd)->name).f1=(union Cyc_Absyn_Nmspace_union)(((
_tmp545.Loc_n).tag=0,_tmp545));}{struct Cyc_Absyn_EnumType_struct _tmp548;struct
Cyc_Absyn_EnumType_struct*_tmp547;env=Cyc_Port_add_var(env,((struct Cyc_Absyn_Enumfield*)
_tmp3A5->hd)->name,(void*)((_tmp547=_cycalloc(sizeof(*_tmp547)),((_tmp547[0]=((
_tmp548.tag=12,((_tmp548.f1=_tmp36E->name,((_tmp548.f2=(struct Cyc_Absyn_Enumdecl*)
_tmp36E,_tmp548)))))),_tmp547)))),Cyc_Port_const_ct(),Cyc_Port_arith_ct());}}}
return env;_LL2C4:;_LL2C5: if((env->gcenv)->porting){const char*_tmp54B;void*
_tmp54A;(_tmp54A=0,Cyc_fprintf(Cyc_stderr,((_tmp54B="Warning: Cyclone declaration found in code to be ported -- skipping.",
_tag_dynforward(_tmp54B,sizeof(char),_get_zero_arr_size_char(_tmp54B,69)))),
_tag_dynforward(_tmp54A,sizeof(void*),0)));}return env;_LL2B5:;}static struct Cyc_Port_Cenv*
Cyc_Port_gen_topdecls(struct Cyc_Port_Cenv*env,struct Cyc_List_List*ds);static
struct Cyc_Port_Cenv*Cyc_Port_gen_topdecls(struct Cyc_Port_Cenv*env,struct Cyc_List_List*
ds){for(0;(unsigned int)ds;ds=ds->tl){env=Cyc_Port_gen_topdecl(env,(struct Cyc_Absyn_Decl*)
ds->hd);}return env;}static struct Cyc_List_List*Cyc_Port_gen_edits(struct Cyc_List_List*
ds);static struct Cyc_List_List*Cyc_Port_gen_edits(struct Cyc_List_List*ds){struct
Cyc_Port_Cenv*env=Cyc_Port_gen_topdecls(Cyc_Port_initial_cenv(),ds);struct Cyc_List_List*
_tmp3AB=(env->gcenv)->pointer_edits;struct Cyc_List_List*_tmp3AC=(env->gcenv)->qualifier_edits;
struct Cyc_List_List*_tmp3AD=(env->gcenv)->zeroterm_edits;struct Cyc_List_List*
_tmp3AE=(env->gcenv)->edits;{struct Cyc_List_List*_tmp3AF=_tmp3AB;for(0;(
unsigned int)_tmp3AF;_tmp3AF=_tmp3AF->tl){void*_tmp3B1;void*_tmp3B2;struct Cyc_Position_Segment*
_tmp3B3;struct _tuple7 _tmp3B0=*((struct _tuple7*)_tmp3AF->hd);_tmp3B1=_tmp3B0.f1;
_tmp3B2=_tmp3B0.f2;_tmp3B3=_tmp3B0.f3;Cyc_Port_unifies(_tmp3B1,_tmp3B2);}}{
struct Cyc_List_List*_tmp3B4=_tmp3AC;for(0;(unsigned int)_tmp3B4;_tmp3B4=_tmp3B4->tl){
void*_tmp3B6;void*_tmp3B7;struct Cyc_Position_Segment*_tmp3B8;struct _tuple7
_tmp3B5=*((struct _tuple7*)_tmp3B4->hd);_tmp3B6=_tmp3B5.f1;_tmp3B7=_tmp3B5.f2;
_tmp3B8=_tmp3B5.f3;Cyc_Port_unifies(_tmp3B6,_tmp3B7);}}{struct Cyc_List_List*
_tmp3B9=_tmp3AD;for(0;(unsigned int)_tmp3B9;_tmp3B9=_tmp3B9->tl){void*_tmp3BB;
void*_tmp3BC;struct Cyc_Position_Segment*_tmp3BD;struct _tuple7 _tmp3BA=*((struct
_tuple7*)_tmp3B9->hd);_tmp3BB=_tmp3BA.f1;_tmp3BC=_tmp3BA.f2;_tmp3BD=_tmp3BA.f3;
Cyc_Port_unifies(_tmp3BB,_tmp3BC);}}for(0;(unsigned int)_tmp3AB;_tmp3AB=_tmp3AB->tl){
void*_tmp3BF;void*_tmp3C0;struct Cyc_Position_Segment*_tmp3C1;struct _tuple7
_tmp3BE=*((struct _tuple7*)_tmp3AB->hd);_tmp3BF=_tmp3BE.f1;_tmp3C0=_tmp3BE.f2;
_tmp3C1=_tmp3BE.f3;if(!Cyc_Port_unifies(_tmp3BF,_tmp3C0) && (unsigned int)
_tmp3C1){void*_tmp3C2=Cyc_Port_compress_ct(_tmp3C0);_LL2CC: if((int)_tmp3C2 != 2)
goto _LL2CE;_LL2CD:{struct Cyc_Port_Edit*_tmp554;const char*_tmp553;const char*
_tmp552;struct Cyc_List_List*_tmp551;_tmp3AE=((_tmp551=_cycalloc(sizeof(*_tmp551)),((
_tmp551->hd=((_tmp554=_cycalloc(sizeof(*_tmp554)),((_tmp554->loc=_tmp3C1,((
_tmp554->old_string=((_tmp553="?",_tag_dynforward(_tmp553,sizeof(char),
_get_zero_arr_size_char(_tmp553,2)))),((_tmp554->new_string=((_tmp552="*",
_tag_dynforward(_tmp552,sizeof(char),_get_zero_arr_size_char(_tmp552,2)))),
_tmp554)))))))),((_tmp551->tl=_tmp3AE,_tmp551))))));}goto _LL2CB;_LL2CE: if((int)
_tmp3C2 != 3)goto _LL2D0;_LL2CF:{struct Cyc_Port_Edit*_tmp55D;const char*_tmp55C;
const char*_tmp55B;struct Cyc_List_List*_tmp55A;_tmp3AE=((_tmp55A=_cycalloc(
sizeof(*_tmp55A)),((_tmp55A->hd=((_tmp55D=_cycalloc(sizeof(*_tmp55D)),((_tmp55D->loc=
_tmp3C1,((_tmp55D->old_string=((_tmp55C="*",_tag_dynforward(_tmp55C,sizeof(char),
_get_zero_arr_size_char(_tmp55C,2)))),((_tmp55D->new_string=((_tmp55B="?",
_tag_dynforward(_tmp55B,sizeof(char),_get_zero_arr_size_char(_tmp55B,2)))),
_tmp55D)))))))),((_tmp55A->tl=_tmp3AE,_tmp55A))))));}goto _LL2CB;_LL2D0:;_LL2D1:
goto _LL2CB;_LL2CB:;}}for(0;(unsigned int)_tmp3AC;_tmp3AC=_tmp3AC->tl){void*
_tmp3CC;void*_tmp3CD;struct Cyc_Position_Segment*_tmp3CE;struct _tuple7 _tmp3CB=*((
struct _tuple7*)_tmp3AC->hd);_tmp3CC=_tmp3CB.f1;_tmp3CD=_tmp3CB.f2;_tmp3CE=
_tmp3CB.f3;if(!Cyc_Port_unifies(_tmp3CC,_tmp3CD) && (unsigned int)_tmp3CE){void*
_tmp3CF=Cyc_Port_compress_ct(_tmp3CD);_LL2D3: if((int)_tmp3CF != 1)goto _LL2D5;
_LL2D4:{struct Cyc_Port_Edit*_tmp566;const char*_tmp565;const char*_tmp564;struct
Cyc_List_List*_tmp563;_tmp3AE=((_tmp563=_cycalloc(sizeof(*_tmp563)),((_tmp563->hd=((
_tmp566=_cycalloc(sizeof(*_tmp566)),((_tmp566->loc=_tmp3CE,((_tmp566->old_string=((
_tmp565="const ",_tag_dynforward(_tmp565,sizeof(char),_get_zero_arr_size_char(
_tmp565,7)))),((_tmp566->new_string=((_tmp564="",_tag_dynforward(_tmp564,sizeof(
char),_get_zero_arr_size_char(_tmp564,1)))),_tmp566)))))))),((_tmp563->tl=
_tmp3AE,_tmp563))))));}goto _LL2D2;_LL2D5: if((int)_tmp3CF != 0)goto _LL2D7;_LL2D6:{
struct Cyc_Port_Edit*_tmp56F;const char*_tmp56E;const char*_tmp56D;struct Cyc_List_List*
_tmp56C;_tmp3AE=((_tmp56C=_cycalloc(sizeof(*_tmp56C)),((_tmp56C->hd=((_tmp56F=
_cycalloc(sizeof(*_tmp56F)),((_tmp56F->loc=_tmp3CE,((_tmp56F->old_string=((
_tmp56E="",_tag_dynforward(_tmp56E,sizeof(char),_get_zero_arr_size_char(_tmp56E,
1)))),((_tmp56F->new_string=((_tmp56D="const ",_tag_dynforward(_tmp56D,sizeof(
char),_get_zero_arr_size_char(_tmp56D,7)))),_tmp56F)))))))),((_tmp56C->tl=
_tmp3AE,_tmp56C))))));}goto _LL2D2;_LL2D7:;_LL2D8: goto _LL2D2;_LL2D2:;}}for(0;(
...
_tmp3DC != 8)goto _LL2DC;_LL2DB:{struct Cyc_Port_Edit*_tmp578;const char*_tmp577;
const char*_tmp576;struct Cyc_List_List*_tmp575;_tmp3AE=((_tmp575=_cycalloc(
sizeof(*_tmp575)),((_tmp575->hd=((_tmp578=_cycalloc(sizeof(*_tmp578)),((_tmp578->loc=
_tmp3DB,((_tmp578->old_string=((_tmp577="NOZEROTERM ",_tag_dynforward(_tmp577,
sizeof(char),_get_zero_arr_size_char(_tmp577,12)))),((_tmp578->new_string=((
_tmp576="",_tag_dynforward(_tmp576,sizeof(char),_get_zero_arr_size_char(_tmp576,
1)))),_tmp578)))))))),((_tmp575->tl=_tmp3AE,_tmp575))))));}goto _LL2D9;_LL2DC: if((
int)_tmp3DC != 9)goto _LL2DE;_LL2DD:{struct Cyc_Port_Edit*_tmp581;const char*_tmp580;
const char*_tmp57F;struct Cyc_List_List*_tmp57E;_tmp3AE=((_tmp57E=_cycalloc(
sizeof(*_tmp57E)),((_tmp57E->hd=((_tmp581=_cycalloc(sizeof(*_tmp581)),((_tmp581->loc=
_tmp3DB,((_tmp581->old_string=((_tmp580="ZEROTERM ",_tag_dynforward(_tmp580,
sizeof(char),_get_zero_arr_size_char(_tmp580,10)))),((_tmp581->new_string=((
_tmp57F="",_tag_dynforward(_tmp57F,sizeof(char),_get_zero_arr_size_char(_tmp57F,
1)))),_tmp581)))))))),((_tmp57E->tl=_tmp3AE,_tmp57E))))));}goto _LL2D9;_LL2DE:;
...
struct Cyc_Port_Edit*e);static struct Cyc_Position_Segment*Cyc_Port_get_seg(struct
Cyc_Port_Edit*e){return e->loc;}void Cyc_Port_port(struct Cyc_List_List*ds);void Cyc_Port_port(
struct Cyc_List_List*ds){struct Cyc_List_List*_tmp3E5=Cyc_Port_gen_edits(ds);
struct Cyc_List_List*_tmp3E6=((struct Cyc_List_List*(*)(struct Cyc_Position_Segment*(*
...
struct Cyc_List_List*)_check_null(_tmp3E7))->hd);const char*_tmp587;void*_tmp586[3];
struct Cyc_String_pa_struct _tmp585;struct Cyc_String_pa_struct _tmp584;struct Cyc_String_pa_struct
_tmp583;(_tmp583.tag=0,((_tmp583.f1=(struct _dynforward_ptr)((struct
_dynforward_ptr)_tmp3EB),((_tmp584.tag=0,((_tmp584.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)_tmp3EA),((_tmp585.tag=0,((_tmp585.f1=(struct
_dynforward_ptr)((struct _dynforward_ptr)sloc),((_tmp586[0]=& _tmp585,((_tmp586[1]=&
_tmp584,((_tmp586[2]=& _tmp583,Cyc_printf(((_tmp587="%s: insert `%s' for `%s'\n",
_tag_dynforward(_tmp587,sizeof(char),_get_zero_arr_size_char(_tmp587,26)))),
_tag_dynforward(_tmp586,sizeof(void*),3)))))))))))))))))));}}}}
