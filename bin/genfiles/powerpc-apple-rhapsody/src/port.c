...
_dyneither_ptr Cyc_Port_ctype2string(int deep,void*t){void*_tmpA=t;struct
...
const char*_tmp578;void*_tmp577[3];struct Cyc_String_pa_struct _tmp576;struct Cyc_String_pa_struct
...
_tmp5AA=_cycalloc(sizeof(*_tmp5AA)),((_tmp5AA[0]=_tmp156,_tmp5AA)))));}return;}
