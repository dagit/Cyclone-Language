...
_tmp65,((_tmp572->tl=_tmp67,_tmp572))))));}return xs;}}static struct _dyneither_ptr*
Cyc_Port_cfield2stringptr(int deep,struct Cyc_Port_Cfield*f);static struct
...
char*_tmp57A;return(struct _dyneither_ptr)Cyc_strconcat_l(Cyc_Port_sep(((_tmp57A=",",
...
_tmp57E;struct Cyc_Port_RgnVar_ct_struct*_tmp57D;return(void*)((_tmp57D=_cycalloc(
sizeof(*_tmp57D)),((_tmp57D[0]=((_tmp57E.tag=10,((_tmp57E.f1=n,_tmp57E)))),
_tmp57D))));}static void*Cyc_Port_unknown_aggr_ct(struct Cyc_List_List*fs);static
...
_cycalloc(sizeof(*_tmp580)),((_tmp580[0]=((_tmp581.tag=14,((_tmp581.f1=fs,((
_tmp581.f2=0,_tmp581)))))),_tmp580))));}static void*Cyc_Port_known_aggr_ct(struct
...
zt){struct Cyc_Port_Ptr_ct_struct _tmp587;struct Cyc_Port_Ptr_ct_struct*_tmp586;
return(void*)((_tmp586=_cycalloc(sizeof(*_tmp586)),((_tmp586[0]=((_tmp587.tag=11,((
_tmp587.f1=(void*)elt,((_tmp587.f2=(void*)qual,((_tmp587.f3=(void*)ptr_kind,((
_tmp587.f4=(void*)r,((_tmp587.f5=(void*)zt,_tmp587)))))))))))),_tmp586))));}
static void*Cyc_Port_array_ct(void*elt,void*qual,void*zt);static void*Cyc_Port_array_ct(
void*elt,void*qual,void*zt){struct Cyc_Port_Array_ct_struct _tmp58A;struct Cyc_Port_Array_ct_struct*
_tmp589;return(void*)((_tmp589=_cycalloc(sizeof(*_tmp589)),((_tmp589[0]=((
_tmp58A.tag=12,((_tmp58A.f1=(void*)elt,((_tmp58A.f2=(void*)qual,((_tmp58A.f3=(
void*)zt,_tmp58A)))))))),_tmp589))));}static void*Cyc_Port_fn_ct(void*return_type,
struct Cyc_List_List*args);static void*Cyc_Port_fn_ct(void*return_type,struct Cyc_List_List*
args){struct Cyc_Port_Fn_ct_struct _tmp58D;struct Cyc_Port_Fn_ct_struct*_tmp58C;
return(void*)((_tmp58C=_cycalloc(sizeof(*_tmp58C)),((_tmp58C[0]=((_tmp58D.tag=15,((
_tmp58D.f1=(void*)return_type,((_tmp58D.f2=args,_tmp58D)))))),_tmp58C))));}
static void*Cyc_Port_var();static void*Cyc_Port_var(){static int counter=0;struct Cyc_Port_Var_ct_struct
_tmp593;struct Cyc_Port_Cvar*_tmp592;struct Cyc_Port_Var_ct_struct*_tmp591;return(
void*)((_tmp591=_cycalloc(sizeof(*_tmp591)),((_tmp591[0]=((_tmp593.tag=16,((
_tmp593.f1=((_tmp592=_cycalloc(sizeof(*_tmp592)),((_tmp592->id=counter ++,((
_tmp592->eq=0,((_tmp592->uppers=0,((_tmp592->lowers=0,_tmp592)))))))))),_tmp593)))),
_tmp591))));}static void*Cyc_Port_new_var(void*x);static void*Cyc_Port_new_var(
...
char*_tmp597;void*_tmp596[1];struct Cyc_Int_pa_struct _tmp595;struct _dyneither_ptr
s=(struct _dyneither_ptr)((_tmp595.tag=1,((_tmp595.f1=(unsigned long)counter ++,((
_tmp596[0]=& _tmp595,Cyc_aprintf(((_tmp597="`R%d",_tag_dyneither(_tmp597,sizeof(
char),5))),_tag_dyneither(_tmp596,sizeof(void*),1))))))));struct _dyneither_ptr*
_tmp598;return(_tmp598=_cycalloc(sizeof(*_tmp598)),((_tmp598[0]=s,_tmp598)));}
...
struct Cyc_Dict_Dict*_tmp5A6;return Cyc_Port_inst(((_tmp5A6=_cycalloc(sizeof(*
_tmp5A6)),((_tmp5A6[0]=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,
struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp),_tmp5A6)))),t);}struct Cyc_List_List*
...
struct Cyc_List_List*_tmp5A7;res=((_tmp5A7=_cycalloc(sizeof(*_tmp5A7)),((_tmp5A7->hd=(
void*)ts->hd,((_tmp5A7->tl=res,_tmp5A7))))));}}return res;}}void Cyc_Port_generalize(
...
t1);t2=Cyc_Port_compress_ct(t2);if(t1 == t2)return;{struct _tuple9 _tmp5A8;struct
_tuple9 _tmpFE=(_tmp5A8.f1=t1,((_tmp5A8.f2=t2,_tmp5A8)));void*_tmpFF;struct Cyc_Port_Cvar*
...
Cyc_Port_Unify_ct_val);}}{void**_tmp5A9;_tmp101->eq=((_tmp5A9=_cycalloc(sizeof(*
_tmp5A9)),((_tmp5A9[0]=t2,_tmp5A9))));}return;}else{(int)_throw((void*)& Cyc_Port_Unify_ct_val);}
...
if(Cyc_strptrcmp(_tmp15D->f,_tmp15B->f)== 0){{struct Cyc_List_List*_tmp5AD;common=((
_tmp5AD=_cycalloc(sizeof(*_tmp5AD)),((_tmp5AD->hd=_tmp15D,((_tmp5AD->tl=common,
_tmp5AD))))));}Cyc_Port_unify_ct(_tmp15D->qual,_tmp15B->qual);Cyc_Port_unify_ct(
...
Cyc_List_List*_tmp5AF;common=((_tmp5AF=_cycalloc(sizeof(*_tmp5AF)),((_tmp5AF->hd=
_tmp161,((_tmp5AF->tl=common,_tmp5AF))))));}}}return common;}static int Cyc_Port_unifies(
...
struct Cyc_List_List*_tmp5B5;return(_tmp5B5=_cycalloc(sizeof(*_tmp5B5)),((_tmp5B5->hd=
t,((_tmp5B5->tl=*uppers,_tmp5B5)))));}}static struct Cyc_List_List*Cyc_Port_insert_lower(
...
void*_tmp1D7;struct _tuple11 _tmp5B7;struct _tuple11 _tmp1D2=(_tmp5B7.f1=Cyc_Port_var(),((
...
lowers,_tmp5BB)))));}}static int Cyc_Port_leq(void*t1,void*t2);static int Cyc_Port_leq(
...
_tmp5BD;struct Cyc_Port_GlobalCenv*g=(_tmp5BD=_cycalloc(sizeof(*_tmp5BD)),((
_tmp5BD->typedef_dict=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _tuple0*,struct
_tuple0*)))Cyc_Dict_empty)(Cyc_Absyn_qvar_cmp),((_tmp5BD->struct_dict=((struct
Cyc_Dict_Dict(*)(int(*cmp)(struct _tuple0*,struct _tuple0*)))Cyc_Dict_empty)(Cyc_Absyn_qvar_cmp),((
_tmp5BD->union_dict=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _tuple0*,struct
_tuple0*)))Cyc_Dict_empty)(Cyc_Absyn_qvar_cmp),((_tmp5BD->qualifier_edits=0,((
_tmp5BD->pointer_edits=0,((_tmp5BD->zeroterm_edits=0,((_tmp5BD->edits=0,((
_tmp5BD->porting=0,((_tmp5BD->return_type=Cyc_Port_void_ct(),_tmp5BD)))))))))))))))))));
struct Cyc_Port_Cenv*_tmp5BE;return(_tmp5BE=_cycalloc(sizeof(*_tmp5BE)),((_tmp5BE->gcenv=
...
_tmp5BE)))))));}static int Cyc_Port_in_fn_arg(struct Cyc_Port_Cenv*env);static int
...
struct Cyc_Port_Cenv*env,enum Cyc_Port_CPos cpos){struct Cyc_Port_Cenv*_tmp5C4;
return(_tmp5C4=_cycalloc(sizeof(*_tmp5C4)),((_tmp5C4->gcenv=env->gcenv,((_tmp5C4->var_dict=
env->var_dict,((_tmp5C4->cpos=cpos,_tmp5C4)))))));}static void Cyc_Port_add_return_type(
...
void*t,void*qual,void*ctype){struct _tuple12*_tmp5CA;struct _tuple9*_tmp5C9;struct
Cyc_Port_Cenv*_tmp5C8;return(_tmp5C8=_cycalloc(sizeof(*_tmp5C8)),((_tmp5C8->gcenv=
...
_cycalloc(sizeof(*_tmp5CA)),((_tmp5CA->f1=t,((_tmp5CA->f2=((_tmp5C9=_cycalloc(
sizeof(*_tmp5C9)),((_tmp5C9->f1=qual,((_tmp5C9->f2=ctype,_tmp5C9)))))),_tmp5CA))))))),((
_tmp5C8->cpos=env->cpos,_tmp5C8)))))));}static void Cyc_Port_add_typedef(struct Cyc_Port_Cenv*
...
t,((_tmp5CB->f2=ct,_tmp5CB)))))));}struct _tuple13{void*f1;void*f2;struct Cyc_Position_Segment*
...
_tmp5D0->tl=(env->gcenv)->pointer_edits,_tmp5D0))))));}static void Cyc_Port_register_zeroterm_cvars(
...
void*orig_zt,struct Cyc_Position_Segment*loc){struct _tuple13*_tmp5D4;struct Cyc_List_List*
_tmp5D3;(env->gcenv)->zeroterm_edits=((_tmp5D3=_cycalloc(sizeof(*_tmp5D3)),((
_tmp5D3->hd=((_tmp5D4=_cycalloc(sizeof(*_tmp5D4)),((_tmp5D4->f1=new_zt,((_tmp5D4->f2=
orig_zt,((_tmp5D4->f3=loc,_tmp5D4)))))))),((_tmp5D3->tl=(env->gcenv)->zeroterm_edits,
_tmp5D3))))));}static void*Cyc_Port_main_type();static void*Cyc_Port_main_type(){
...
struct Cyc_Port_Cenv*_tmp2A6=Cyc_Port_empty_cenv();{struct _tuple0*_tmp5E1;_tmp2A6=
Cyc_Port_add_var(_tmp2A6,((_tmp5E1=_cycalloc(sizeof(*_tmp5E1)),((_tmp5E1->f1=Cyc_Absyn_Loc_n,((
...
counts,int fn_res,void*t,void*c){c=Cyc_Port_compress_ct(c);{struct _tuple9 _tmp5E3;
struct _tuple9 _tmp2C9=(_tmp5E3.f1=t,((_tmp5E3.f2=c,_tmp5E3)));void*_tmp2CA;struct
...
0;_tmp2D4=Cyc_Port_compress_ct(_tmp2D4);{struct _tuple9 _tmp5E4;struct _tuple9
_tmp2E7=(_tmp5E4.f1=_tmp2CF,((_tmp5E4.f2=_tmp2D4,_tmp5E4)));void*_tmp2E8;void*
...
_LL18C:;_LL18D: goto _LL187;_LL187:;}goto _LL17E;}_LL181: _tmp2D5=_tmp2C9.f1;{struct
Cyc_Absyn_ArrayType_struct*_tmp2D6=(struct Cyc_Absyn_ArrayType_struct*)_tmp2D5;
if(_tmp2D6->tag != 9)goto _LL183;else{_tmp2D7=_tmp2D6->f1;_tmp2D8=_tmp2D7.elt_type;}}
...
_tmp359;if(_tmp366->tag != 24)goto _LL20B;else{_tmp367=_tmp366->f1;_tmp368=_tmp366->f2;}}
...
_tmp382;if(_tmp3D6->tag != 35)goto _LL252;else{_tmp3D7=_tmp3D6->f1;_tmp3D8=_tmp3D7.elt_type;
...
struct Cyc_Absyn_Gentyp_e_struct*_tmp3DD=(struct Cyc_Absyn_Gentyp_e_struct*)
_tmp382;if(_tmp3DD->tag != 21)goto _LL256;}_LL255: {const char*_tmp627;void*_tmp626;(
_tmp626=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp627="Gen",_tag_dyneither(_tmp627,sizeof(char),4))),_tag_dyneither(_tmp626,
sizeof(void*),0)));}_LL256: {struct Cyc_Absyn_New_e_struct*_tmp3DE=(struct Cyc_Absyn_New_e_struct*)
_tmp382;if(_tmp3DE->tag != 17)goto _LL258;}_LL257: {const char*_tmp62A;void*_tmp629;(
_tmp629=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp62A="New_e",_tag_dyneither(_tmp62A,sizeof(char),6))),_tag_dyneither(_tmp629,
sizeof(void*),0)));}_LL258: {struct Cyc_Absyn_Tuple_e_struct*_tmp3DF=(struct Cyc_Absyn_Tuple_e_struct*)
_tmp382;if(_tmp3DF->tag != 26)goto _LL25A;}_LL259: {const char*_tmp62D;void*_tmp62C;(
_tmp62C=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp62D="Tuple_e",_tag_dyneither(_tmp62D,sizeof(char),8))),_tag_dyneither(
_tmp62C,sizeof(void*),0)));}_LL25A: {struct Cyc_Absyn_CompoundLit_e_struct*
_tmp3E0=(struct Cyc_Absyn_CompoundLit_e_struct*)_tmp382;if(_tmp3E0->tag != 27)goto
_LL25C;}_LL25B: {const char*_tmp630;void*_tmp62F;(_tmp62F=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp630="CompoundLit_e",
_tag_dyneither(_tmp630,sizeof(char),14))),_tag_dyneither(_tmp62F,sizeof(void*),0)));}
_LL25C: {struct Cyc_Absyn_Array_e_struct*_tmp3E1=(struct Cyc_Absyn_Array_e_struct*)
_tmp382;if(_tmp3E1->tag != 28)goto _LL25E;}_LL25D: {const char*_tmp633;void*_tmp632;(
_tmp632=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp633="Array_e",_tag_dyneither(_tmp633,sizeof(char),8))),_tag_dyneither(
_tmp632,sizeof(void*),0)));}_LL25E: {struct Cyc_Absyn_Comprehension_e_struct*
_tmp3E2=(struct Cyc_Absyn_Comprehension_e_struct*)_tmp382;if(_tmp3E2->tag != 29)
goto _LL260;}_LL25F: {const char*_tmp636;void*_tmp635;(_tmp635=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp636="Comprehension_e",
_tag_dyneither(_tmp636,sizeof(char),16))),_tag_dyneither(_tmp635,sizeof(void*),0)));}
_LL260: {struct Cyc_Absyn_Aggregate_e_struct*_tmp3E3=(struct Cyc_Absyn_Aggregate_e_struct*)
_tmp382;if(_tmp3E3->tag != 30)goto _LL262;}_LL261: {const char*_tmp639;void*_tmp638;(
_tmp638=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp639="Aggregate_e",_tag_dyneither(_tmp639,sizeof(char),12))),_tag_dyneither(
_tmp638,sizeof(void*),0)));}_LL262: {struct Cyc_Absyn_AnonStruct_e_struct*_tmp3E4=(
struct Cyc_Absyn_AnonStruct_e_struct*)_tmp382;if(_tmp3E4->tag != 31)goto _LL264;}
_LL263: {const char*_tmp63C;void*_tmp63B;(_tmp63B=0,((int(*)(struct _dyneither_ptr
fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp63C="AnonStruct_e",
_tag_dyneither(_tmp63C,sizeof(char),13))),_tag_dyneither(_tmp63B,sizeof(void*),0)));}
_LL264: {struct Cyc_Absyn_Datatype_e_struct*_tmp3E5=(struct Cyc_Absyn_Datatype_e_struct*)
_tmp382;if(_tmp3E5->tag != 32)goto _LL266;}_LL265: {const char*_tmp63F;void*_tmp63E;(
_tmp63E=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp63F="Datatype_e",_tag_dyneither(_tmp63F,sizeof(char),11))),_tag_dyneither(
_tmp63E,sizeof(void*),0)));}_LL266: {struct Cyc_Absyn_UnresolvedMem_e_struct*
_tmp3E6=(struct Cyc_Absyn_UnresolvedMem_e_struct*)_tmp382;if(_tmp3E6->tag != 37)
goto _LL268;}_LL267: {const char*_tmp642;void*_tmp641;(_tmp641=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp642="UnresolvedMem_e",
_tag_dyneither(_tmp642,sizeof(char),16))),_tag_dyneither(_tmp641,sizeof(void*),0)));}
_LL268: {struct Cyc_Absyn_StmtExp_e_struct*_tmp3E7=(struct Cyc_Absyn_StmtExp_e_struct*)
_tmp382;if(_tmp3E7->tag != 38)goto _LL26A;else{_tmp3E8=_tmp3E7->f1;}}_LL269: {
const char*_tmp645;void*_tmp644;(_tmp644=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp645="StmtExp_e",_tag_dyneither(
_tmp645,sizeof(char),10))),_tag_dyneither(_tmp644,sizeof(void*),0)));}_LL26A: {
struct Cyc_Absyn_Valueof_e_struct*_tmp3E9=(struct Cyc_Absyn_Valueof_e_struct*)
_tmp382;if(_tmp3E9->tag != 40)goto _LL26C;}_LL26B: {const char*_tmp648;void*_tmp647;(
_tmp647=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp648="Valueof_e",_tag_dyneither(_tmp648,sizeof(char),10))),_tag_dyneither(
_tmp647,sizeof(void*),0)));}_LL26C: {struct Cyc_Absyn_Tagcheck_e_struct*_tmp3EA=(
struct Cyc_Absyn_Tagcheck_e_struct*)_tmp382;if(_tmp3EA->tag != 39)goto _LL20D;}
_LL26D: {const char*_tmp64B;void*_tmp64A;(_tmp64A=0,((int(*)(struct _dyneither_ptr
fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp64B="Tagcheck_e",
_tag_dyneither(_tmp64B,sizeof(char),11))),_tag_dyneither(_tmp64A,sizeof(void*),0)));}
...
void*_tmp432=s->r;struct Cyc_Absyn_Exp*_tmp435;struct Cyc_Absyn_Stmt*_tmp437;
...
_tmp465=(struct Cyc_Absyn_UnresolvedMem_e_struct*)_tmp464;if(_tmp465->tag != 37)
...
if(_tmp467->tag != 28)goto _LL296;else{_tmp468=_tmp467->f1;}}_LL295: _tmp46A=
_tmp468;goto _LL297;_LL296: {struct Cyc_Absyn_CompoundLit_e_struct*_tmp469=(struct
Cyc_Absyn_CompoundLit_e_struct*)_tmp464;if(_tmp469->tag != 27)goto _LL298;else{
...
struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Decl*d){void*_tmp49D=d->r;struct Cyc_Absyn_Vardecl*
_tmp49F;_LL2AF: {struct Cyc_Absyn_Var_d_struct*_tmp49E=(struct Cyc_Absyn_Var_d_struct*)
...
struct _tuple15*arg){struct _dyneither_ptr*_tmp4A4;struct Cyc_Absyn_Tqual _tmp4A5;
void*_tmp4A6;struct _tuple15 _tmp4A3=*arg;_tmp4A4=_tmp4A3.f1;_tmp4A5=_tmp4A3.f2;
_tmp4A6=_tmp4A3.f3;{struct _tuple7*_tmp664;return(_tmp664=_cycalloc(sizeof(*
_tmp664)),((_tmp664->f1=0,((_tmp664->f2=_tmp4A5,((_tmp664->f3=_tmp4A6,_tmp664)))))));}}
...
_tmp672->type=_tmp4DD,_tmp672)))))))),((_tmp671->tl=curr,_tmp671))))));}}}}curr=((
struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(curr);if((*
previous).f2 == 0)(*previous).f2=curr;}return env;}}_LL2C0: {struct Cyc_Absyn_Enum_d_struct*
...
_tmp674)))),Cyc_Port_const_ct(),Cyc_Port_arith_ct());}}}return env;_LL2C2:;_LL2C3:
if((env->gcenv)->porting){const char*_tmp678;void*_tmp677;(_tmp677=0,Cyc_fprintf(
...
Cyc_Port_initial_cenv(),ds);struct Cyc_List_List*_tmp4E8=(env->gcenv)->pointer_edits;
struct Cyc_List_List*_tmp4E9=(env->gcenv)->qualifier_edits;struct Cyc_List_List*
_tmp4EA=(env->gcenv)->zeroterm_edits;struct Cyc_List_List*_tmp4EB=(env->gcenv)->edits;{
struct Cyc_List_List*_tmp4EC=_tmp4E8;for(0;(unsigned int)_tmp4EC;_tmp4EC=_tmp4EC->tl){
void*_tmp4EE;void*_tmp4EF;struct Cyc_Position_Segment*_tmp4F0;struct _tuple13
_tmp4ED=*((struct _tuple13*)_tmp4EC->hd);_tmp4EE=_tmp4ED.f1;_tmp4EF=_tmp4ED.f2;
_tmp4F0=_tmp4ED.f3;Cyc_Port_unifies(_tmp4EE,_tmp4EF);}}{struct Cyc_List_List*
_tmp4F1=_tmp4E9;for(0;(unsigned int)_tmp4F1;_tmp4F1=_tmp4F1->tl){void*_tmp4F3;
void*_tmp4F4;struct Cyc_Position_Segment*_tmp4F5;struct _tuple13 _tmp4F2=*((struct
_tuple13*)_tmp4F1->hd);_tmp4F3=_tmp4F2.f1;_tmp4F4=_tmp4F2.f2;_tmp4F5=_tmp4F2.f3;
Cyc_Port_unifies(_tmp4F3,_tmp4F4);}}{struct Cyc_List_List*_tmp4F6=_tmp4EA;for(0;(
unsigned int)_tmp4F6;_tmp4F6=_tmp4F6->tl){void*_tmp4F8;void*_tmp4F9;struct Cyc_Position_Segment*
_tmp4FA;struct _tuple13 _tmp4F7=*((struct _tuple13*)_tmp4F6->hd);_tmp4F8=_tmp4F7.f1;
_tmp4F9=_tmp4F7.f2;_tmp4FA=_tmp4F7.f3;Cyc_Port_unifies(_tmp4F8,_tmp4F9);}}for(0;(
unsigned int)_tmp4E8;_tmp4E8=_tmp4E8->tl){void*_tmp4FC;void*_tmp4FD;struct Cyc_Position_Segment*
...
_tmp528=Cyc_Port_gen_edits(ds);struct Cyc_List_List*_tmp529=((struct Cyc_List_List*(*)(
struct Cyc_Position_Segment*(*f)(struct Cyc_Port_Edit*),struct Cyc_List_List*x))Cyc_List_map)(
Cyc_Port_get_seg,_tmp528);Cyc_Position_use_gcc_style_location=0;{struct Cyc_List_List*
_tmp52A=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(Cyc_Position_strings_of_segments(
