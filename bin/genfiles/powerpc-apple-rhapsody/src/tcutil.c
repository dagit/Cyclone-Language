...
Cyc___cycFILE*)Cyc_stderr);{const char*_tmpB59;const char*_tmpB58;const char*
_tmpB57;void*_tmpB56[2];struct Cyc_String_pa_struct _tmpB55;struct Cyc_String_pa_struct
_tmpB54;struct _dyneither_ptr s1=(struct _dyneither_ptr)((_tmpB54.tag=0,((_tmpB54.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(Cyc_Tcutil_t1_failure)),((
_tmpB55.tag=0,((_tmpB55.f1=(struct _dyneither_ptr)(Cyc_Tcutil_tq1_const?(_tmpB58="const ",
_tag_dyneither(_tmpB58,sizeof(char),7)):((_tmpB59="",_tag_dyneither(_tmpB59,
sizeof(char),1)))),((_tmpB56[0]=& _tmpB55,((_tmpB56[1]=& _tmpB54,Cyc_aprintf(((
_tmpB57="%s%s",_tag_dyneither(_tmpB57,sizeof(char),5))),_tag_dyneither(_tmpB56,
sizeof(void*),2))))))))))))));const char*_tmpB62;const char*_tmpB61;const char*
_tmpB60;void*_tmpB5F[2];struct Cyc_String_pa_struct _tmpB5E;struct Cyc_String_pa_struct
_tmpB5D;struct _dyneither_ptr s2=(struct _dyneither_ptr)((_tmpB5D.tag=0,((_tmpB5D.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(Cyc_Tcutil_t2_failure)),((
_tmpB5E.tag=0,((_tmpB5E.f1=(struct _dyneither_ptr)(Cyc_Tcutil_tq2_const?(_tmpB61="const ",
...
sizeof(void*),2))))))))))))));int pos=2;{const char*_tmpB66;void*_tmpB65[1];struct
Cyc_String_pa_struct _tmpB64;(_tmpB64.tag=0,((_tmpB64.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)s1),((_tmpB65[0]=& _tmpB64,Cyc_fprintf(Cyc_stderr,((_tmpB66="  %s",
_tag_dyneither(_tmpB66,sizeof(char),5))),_tag_dyneither(_tmpB65,sizeof(void*),1)))))));}
pos +=_get_dyneither_size(s1,sizeof(char));if(pos + 5 >= 80){{const char*_tmpB69;
void*_tmpB68;(_tmpB68=0,Cyc_fprintf(Cyc_stderr,((_tmpB69="\n\t",_tag_dyneither(
_tmpB69,sizeof(char),3))),_tag_dyneither(_tmpB68,sizeof(void*),0)));}pos=8;}
else{{const char*_tmpB6C;void*_tmpB6B;(_tmpB6B=0,Cyc_fprintf(Cyc_stderr,((_tmpB6C=" ",
_tag_dyneither(_tmpB6C,sizeof(char),2))),_tag_dyneither(_tmpB6B,sizeof(void*),0)));}
++ pos;}{const char*_tmpB6F;void*_tmpB6E;(_tmpB6E=0,Cyc_fprintf(Cyc_stderr,((
_tmpB6F="and ",_tag_dyneither(_tmpB6F,sizeof(char),5))),_tag_dyneither(_tmpB6E,
sizeof(void*),0)));}pos +=4;if(pos + _get_dyneither_size(s2,sizeof(char))>= 80){{
const char*_tmpB72;void*_tmpB71;(_tmpB71=0,Cyc_fprintf(Cyc_stderr,((_tmpB72="\n\t",
_tag_dyneither(_tmpB72,sizeof(char),3))),_tag_dyneither(_tmpB71,sizeof(void*),0)));}
pos=8;}{const char*_tmpB76;void*_tmpB75[1];struct Cyc_String_pa_struct _tmpB74;(
_tmpB74.tag=0,((_tmpB74.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s2),((
_tmpB75[0]=& _tmpB74,Cyc_fprintf(Cyc_stderr,((_tmpB76="%s ",_tag_dyneither(
_tmpB76,sizeof(char),4))),_tag_dyneither(_tmpB75,sizeof(void*),1)))))));}pos +=
_get_dyneither_size(s2,sizeof(char))+ 1;if(pos + 17 >= 80){{const char*_tmpB79;void*
_tmpB78;(_tmpB78=0,Cyc_fprintf(Cyc_stderr,((_tmpB79="\n\t",_tag_dyneither(
_tmpB79,sizeof(char),3))),_tag_dyneither(_tmpB78,sizeof(void*),0)));}pos=8;}{
const char*_tmpB7C;void*_tmpB7B;(_tmpB7B=0,Cyc_fprintf(Cyc_stderr,((_tmpB7C="are not compatible. ",
_tag_dyneither(_tmpB7C,sizeof(char),21))),_tag_dyneither(_tmpB7B,sizeof(void*),0)));}
...
_tmpB7F;void*_tmpB7E;(_tmpB7E=0,Cyc_fprintf(Cyc_stderr,((_tmpB7F="\n\t",
_tag_dyneither(_tmpB7F,sizeof(char),3))),_tag_dyneither(_tmpB7E,sizeof(void*),0)));}{
const char*_tmpB83;void*_tmpB82[1];struct Cyc_String_pa_struct _tmpB81;(_tmpB81.tag=
0,((_tmpB81.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcutil_failure_reason),((
_tmpB82[0]=& _tmpB81,Cyc_fprintf(Cyc_stderr,((_tmpB83="%s",_tag_dyneither(_tmpB83,
sizeof(char),3))),_tag_dyneither(_tmpB82,sizeof(void*),1)))))));}}{const char*
_tmpB86;void*_tmpB85;(_tmpB85=0,Cyc_fprintf(Cyc_stderr,((_tmpB86="\n",
_tag_dyneither(_tmpB86,sizeof(char),2))),_tag_dyneither(_tmpB85,sizeof(void*),0)));}
...
const char*_tmpB8A;void*_tmpB89[1];struct Cyc_String_pa_struct _tmpB88;(_tmpB88.tag=
0,((_tmpB88.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)msg),((_tmpB89[0]=&
_tmpB88,Cyc_fprintf(Cyc_stderr,((_tmpB8A="Compiler Error (Tcutil::impos): %s\n",
_tag_dyneither(_tmpB8A,sizeof(char),36))),_tag_dyneither(_tmpB89,sizeof(void*),1)))))));}
Cyc_fflush((struct Cyc___cycFILE*)Cyc_stderr);{struct Cyc_Core_Impossible_struct
_tmpB8D;struct Cyc_Core_Impossible_struct*_tmpB8C;(int)_throw((void*)((_tmpB8C=
_cycalloc(sizeof(*_tmpB8C)),((_tmpB8C[0]=((_tmpB8D.tag=Cyc_Core_Impossible,((
_tmpB8D.f1=msg,_tmpB8D)))),_tmpB8C)))));}}static struct _dyneither_ptr Cyc_Tcutil_tvar2string(
...
const char*_tmpB92;void*_tmpB91[2];struct Cyc_String_pa_struct _tmpB90;struct Cyc_String_pa_struct
_tmpB8F;(_tmpB8F.tag=0,((_tmpB8F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_kindbound2string((void*)((struct Cyc_Absyn_Tvar*)tvs->hd)->kind)),((
_tmpB90.tag=0,((_tmpB90.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcutil_tvar2string((
struct Cyc_Absyn_Tvar*)tvs->hd)),((_tmpB91[0]=& _tmpB90,((_tmpB91[1]=& _tmpB8F,Cyc_fprintf(
Cyc_stderr,((_tmpB92="%s::%s ",_tag_dyneither(_tmpB92,sizeof(char),8))),
_tag_dyneither(_tmpB91,sizeof(void*),2)))))))))))));}{const char*_tmpB95;void*
_tmpB94;(_tmpB94=0,Cyc_fprintf(Cyc_stderr,((_tmpB95="\n",_tag_dyneither(_tmpB95,
sizeof(char),2))),_tag_dyneither(_tmpB94,sizeof(void*),0)));}Cyc_fflush((struct
...
fmt,ap);{struct Cyc_List_List*_tmpB96;Cyc_Tcutil_warning_segs=((_tmpB96=_cycalloc(
sizeof(*_tmpB96)),((_tmpB96->hd=sg,((_tmpB96->tl=Cyc_Tcutil_warning_segs,_tmpB96))))));}{
struct _dyneither_ptr*_tmpB99;struct Cyc_List_List*_tmpB98;Cyc_Tcutil_warning_msgs=((
_tmpB98=_cycalloc(sizeof(*_tmpB98)),((_tmpB98->hd=((_tmpB99=_cycalloc(sizeof(*
_tmpB99)),((_tmpB99[0]=msg,_tmpB99)))),((_tmpB98->tl=Cyc_Tcutil_warning_msgs,
_tmpB98))))));}}void Cyc_Tcutil_flush_warnings();void Cyc_Tcutil_flush_warnings(){
if(Cyc_Tcutil_warning_segs == 0)return;{const char*_tmpB9C;void*_tmpB9B;(_tmpB9B=0,
Cyc_fprintf(Cyc_stderr,((_tmpB9C="***Warnings***\n",_tag_dyneither(_tmpB9C,
sizeof(char),16))),_tag_dyneither(_tmpB9B,sizeof(void*),0)));}{struct Cyc_List_List*
...
Cyc_Tcutil_warning_msgs);while(Cyc_Tcutil_warning_msgs != 0){{const char*_tmpBA1;
void*_tmpBA0[2];struct Cyc_String_pa_struct _tmpB9F;struct Cyc_String_pa_struct
...
_tmpB9F.tag=0,((_tmpB9F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((
struct _dyneither_ptr*)((struct Cyc_List_List*)_check_null(_tmp35))->hd)),((
_tmpBA0[0]=& _tmpB9F,((_tmpBA0[1]=& _tmpB9E,Cyc_fprintf(Cyc_stderr,((_tmpBA1="%s: %s\n",
_tag_dyneither(_tmpBA1,sizeof(char),8))),_tag_dyneither(_tmpBA0,sizeof(void*),2)))))))))))));}
_tmp35=_tmp35->tl;Cyc_Tcutil_warning_msgs=((struct Cyc_List_List*)_check_null(Cyc_Tcutil_warning_msgs))->tl;}{
const char*_tmpBA4;void*_tmpBA3;(_tmpBA3=0,Cyc_fprintf(Cyc_stderr,((_tmpBA4="**************\n",
_tag_dyneither(_tmpBA4,sizeof(char),16))),_tag_dyneither(_tmpBA3,sizeof(void*),0)));}
...
_tmpBA5;*_tmp40=((_tmpBA5=_cycalloc(sizeof(*_tmpBA5)),((_tmpBA5[0]=t2,_tmpBA5))));}
...
struct Cyc_Core_Opt*_tmpBA6;*_tmp42=((_tmpBA6=_cycalloc(sizeof(*_tmpBA6)),((
_tmpBA6->v=(void*)t2,_tmpBA6))));}return t2;}_LL9:;_LLA: return t;_LL0:;}void*Cyc_Tcutil_copy_type(
...
_tmpBA9;struct Cyc_Absyn_Unknown_kb_struct*_tmpBA8;return(void*)((_tmpBA8=
_cycalloc(sizeof(*_tmpBA8)),((_tmpBA8[0]=((_tmpBA9.tag=1,((_tmpBA9.f1=0,_tmpBA9)))),
_tmpBA8))));}_LL15: if(*((int*)_tmp48)!= 2)goto _LL17;_tmp49=(void*)((struct Cyc_Absyn_Less_kb_struct*)
_tmp48)->f2;_LL16: {struct Cyc_Absyn_Less_kb_struct _tmpBAC;struct Cyc_Absyn_Less_kb_struct*
_tmpBAB;return(void*)((_tmpBAB=_cycalloc(sizeof(*_tmpBAB)),((_tmpBAB[0]=((
_tmpBAC.tag=2,((_tmpBAC.f1=0,((_tmpBAC.f2=(void*)_tmp49,_tmpBAC)))))),_tmpBAB))));}
...
Cyc_Absyn_Tvar*tv){struct Cyc_Absyn_Tvar*_tmpBAD;return(_tmpBAD=_cycalloc(sizeof(*
_tmpBAD)),((_tmpBAD->name=tv->name,((_tmpBAD->identity=- 1,((_tmpBAD->kind=(void*)
Cyc_Tcutil_copy_kindbound((void*)tv->kind),_tmpBAD)))))));}static struct _tuple3*
...
_tmp52=_tmp50.f2;_tmp53=_tmp50.f3;{struct _tuple3*_tmpBAE;return(_tmpBAE=
_cycalloc(sizeof(*_tmpBAE)),((_tmpBAE->f1=_tmp51,((_tmpBAE->f2=_tmp52,((_tmpBAE->f3=
Cyc_Tcutil_copy_type(_tmp53),_tmpBAE)))))));}}static struct _tuple5*Cyc_Tcutil_copy_tqt(
...
arg;_tmp56=*_tmp55;_tmp57=_tmp56.f1;_tmp58=_tmp56.f2;{struct _tuple5*_tmpBAF;
return(_tmpBAF=_cycalloc(sizeof(*_tmpBAF)),((_tmpBAF->f1=_tmp57,((_tmpBAF->f2=
Cyc_Tcutil_copy_type(_tmp58),_tmpBAF)))));}}static struct Cyc_Absyn_Aggrfield*Cyc_Tcutil_copy_field(
struct Cyc_Absyn_Aggrfield*f);static struct Cyc_Absyn_Aggrfield*Cyc_Tcutil_copy_field(
struct Cyc_Absyn_Aggrfield*f){struct Cyc_Absyn_Aggrfield*_tmpBB0;return(_tmpBB0=
_cycalloc(sizeof(*_tmpBB0)),((_tmpBB0->name=f->name,((_tmpBB0->tq=f->tq,((
_tmpBB0->type=(void*)Cyc_Tcutil_copy_type((void*)f->type),((_tmpBB0->width=f->width,((
_tmpBB0->attributes=f->attributes,_tmpBB0)))))))))));}static struct _tuple0*Cyc_Tcutil_copy_rgncmp(
...
_tmp5B;_tmp5D=_tmp5C.f1;_tmp5E=_tmp5C.f2;{struct _tuple0*_tmpBB1;return(_tmpBB1=
_cycalloc(sizeof(*_tmpBB1)),((_tmpBB1->f1=Cyc_Tcutil_copy_type(_tmp5D),((_tmpBB1->f2=
Cyc_Tcutil_copy_type(_tmp5E),_tmpBB1)))));}}static struct Cyc_Absyn_Enumfield*Cyc_Tcutil_copy_enumfield(
struct Cyc_Absyn_Enumfield*f);static struct Cyc_Absyn_Enumfield*Cyc_Tcutil_copy_enumfield(
struct Cyc_Absyn_Enumfield*f){struct Cyc_Absyn_Enumfield*_tmpBB2;return(_tmpBB2=
_cycalloc(sizeof(*_tmpBB2)),((_tmpBB2->name=f->name,((_tmpBB2->tag=f->tag,((
_tmpBB2->loc=f->loc,_tmpBB2)))))));}void*Cyc_Tcutil_copy_type(void*t);void*Cyc_Tcutil_copy_type(
...
_tmp61)->f1;_LL1F: {struct Cyc_Absyn_VarType_struct _tmpBB5;struct Cyc_Absyn_VarType_struct*
_tmpBB4;return(void*)((_tmpBB4=_cycalloc(sizeof(*_tmpBB4)),((_tmpBB4[0]=((
_tmpBB5.tag=1,((_tmpBB5.f1=Cyc_Tcutil_copy_tvar(_tmp62),_tmpBB5)))),_tmpBB4))));}
...
_LL21: {struct Cyc_Core_Opt*_tmpBB6;struct Cyc_Core_Opt*_tmp9E=(unsigned int)
_tmp66?(_tmpBB6=_cycalloc(sizeof(*_tmpBB6)),((_tmpBB6->v=(void*)Cyc_Tcutil_copy_type((
void*)_tmp66->v),_tmpBB6))): 0;struct Cyc_Absyn_TunionType_struct _tmpBBC;struct Cyc_Absyn_TunionInfo
_tmpBBB;struct Cyc_Absyn_TunionType_struct*_tmpBBA;return(void*)((_tmpBBA=
_cycalloc(sizeof(*_tmpBBA)),((_tmpBBA[0]=((_tmpBBC.tag=2,((_tmpBBC.f1=((_tmpBBB.tunion_info=
_tmp64,((_tmpBBB.targs=Cyc_Tcutil_copy_types(_tmp65),((_tmpBBB.rgn=_tmp9E,
_tmpBBB)))))),_tmpBBC)))),_tmpBBA))));}_LL22: if(*((int*)_tmp61)!= 3)goto _LL24;
_tmp67=((struct Cyc_Absyn_TunionFieldType_struct*)_tmp61)->f1;_tmp68=_tmp67.field_info;
_tmp69=_tmp67.targs;_LL23: {struct Cyc_Absyn_TunionFieldType_struct _tmpBC2;struct
Cyc_Absyn_TunionFieldInfo _tmpBC1;struct Cyc_Absyn_TunionFieldType_struct*_tmpBC0;
return(void*)((_tmpBC0=_cycalloc(sizeof(*_tmpBC0)),((_tmpBC0[0]=((_tmpBC2.tag=3,((
_tmpBC2.f1=((_tmpBC1.field_info=_tmp68,((_tmpBC1.targs=Cyc_Tcutil_copy_types(
_tmp69),_tmpBC1)))),_tmpBC2)))),_tmpBC0))));}_LL24: if(*((int*)_tmp61)!= 4)goto
...
_tmpBCC;struct Cyc_Absyn_PtrAtts _tmpBCB;struct Cyc_Absyn_PtrInfo _tmpBCA;struct Cyc_Absyn_PointerType_struct*
_tmpBC9;return(void*)((_tmpBC9=_cycalloc(sizeof(*_tmpBC9)),((_tmpBC9[0]=((
_tmpBCC.tag=4,((_tmpBCC.f1=((_tmpBCA.elt_typ=(void*)_tmpA6,((_tmpBCA.elt_tq=
_tmpA9,((_tmpBCA.ptr_atts=((_tmpBCB.rgn=(void*)_tmpA7,((_tmpBCB.nullable=_tmpA8,((
_tmpBCB.bounds=_tmpAA,((_tmpBCB.zero_term=_tmpAB,((_tmpBCB.ptrloc=_tmp72,_tmpBCB)))))))))),
_tmpBCA)))))),_tmpBCC)))),_tmpBC9))));}_LL26: if(*((int*)_tmp61)!= 5)goto _LL28;
...
_tmpBD2;struct Cyc_Absyn_ArrayInfo _tmpBD1;struct Cyc_Absyn_ArrayType_struct*
_tmpBD0;return(void*)((_tmpBD0=_cycalloc(sizeof(*_tmpBD0)),((_tmpBD0[0]=((
_tmpBD2.tag=7,((_tmpBD2.f1=((_tmpBD1.elt_type=(void*)Cyc_Tcutil_copy_type(_tmp74),((
_tmpBD1.tq=_tmp75,((_tmpBD1.num_elts=_tmp76,((_tmpBD1.zero_term=((struct Cyc_Absyn_Conref*(*)(
struct Cyc_Absyn_Conref*c))Cyc_Tcutil_copy_conref)(_tmp77),((_tmpBD1.zt_loc=
_tmp78,_tmpBD1)))))))))),_tmpBD2)))),_tmpBD0))));}_LL2E: if(*((int*)_tmp61)!= 8)
...
_tmp7A);struct Cyc_Core_Opt*_tmpBD3;struct Cyc_Core_Opt*_tmpB4=_tmp7B == 0?0:((
_tmpBD3=_cycalloc(sizeof(*_tmpBD3)),((_tmpBD3->v=(void*)Cyc_Tcutil_copy_type((
void*)_tmp7B->v),_tmpBD3))));void*_tmpB5=Cyc_Tcutil_copy_type(_tmp7C);struct Cyc_List_List*
...
_tmp7F;struct Cyc_Absyn_VarargInfo*_tmpBD4;cyc_varargs2=((_tmpBD4=_cycalloc(
sizeof(*_tmpBD4)),((_tmpBD4->name=cv->name,((_tmpBD4->tq=cv->tq,((_tmpBD4->type=(
void*)Cyc_Tcutil_copy_type((void*)cv->type),((_tmpBD4->inject=cv->inject,_tmpBD4))))))))));}{
...
struct Cyc_List_List*_tmpBA=_tmp81;struct Cyc_Absyn_FnType_struct _tmpBDA;struct Cyc_Absyn_FnInfo
_tmpBD9;struct Cyc_Absyn_FnType_struct*_tmpBD8;return(void*)((_tmpBD8=_cycalloc(
sizeof(*_tmpBD8)),((_tmpBD8[0]=((_tmpBDA.tag=8,((_tmpBDA.f1=((_tmpBD9.tvars=
_tmpB3,((_tmpBD9.effect=_tmpB4,((_tmpBD9.ret_typ=(void*)_tmpB5,((_tmpBD9.args=
_tmpB6,((_tmpBD9.c_varargs=_tmpB7,((_tmpBD9.cyc_varargs=cyc_varargs2,((_tmpBD9.rgn_po=
_tmpB9,((_tmpBD9.attributes=_tmpBA,_tmpBD9)))))))))))))))),_tmpBDA)))),_tmpBD8))));}}
_LL30: if(*((int*)_tmp61)!= 9)goto _LL32;_tmp82=((struct Cyc_Absyn_TupleType_struct*)
_tmp61)->f1;_LL31: {struct Cyc_Absyn_TupleType_struct _tmpBDD;struct Cyc_Absyn_TupleType_struct*
_tmpBDC;return(void*)((_tmpBDC=_cycalloc(sizeof(*_tmpBDC)),((_tmpBDC[0]=((
_tmpBDD.tag=9,((_tmpBDD.f1=((struct Cyc_List_List*(*)(struct _tuple5*(*f)(struct
_tuple5*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_copy_tqt,_tmp82),
_tmpBDD)))),_tmpBDC))));}_LL32: if(*((int*)_tmp61)!= 10)goto _LL34;_tmp83=((struct
...
_tmpBE7;union Cyc_Absyn_AggrInfoU_union _tmpBE6;struct Cyc_Absyn_AggrInfo _tmpBE5;
struct Cyc_Absyn_AggrType_struct*_tmpBE4;return(void*)((_tmpBE4=_cycalloc(sizeof(*
_tmpBE4)),((_tmpBE4[0]=((_tmpBE7.tag=10,((_tmpBE7.f1=((_tmpBE5.aggr_info=(union
Cyc_Absyn_AggrInfoU_union)(((_tmpBE6.UnknownAggr).tag=0,(((_tmpBE6.UnknownAggr).f1=(
void*)_tmp85,(((_tmpBE6.UnknownAggr).f2=_tmp86,_tmpBE6)))))),((_tmpBE5.targs=Cyc_Tcutil_copy_types(
_tmp87),_tmpBE5)))),_tmpBE7)))),_tmpBE4))));}_LL34: if(*((int*)_tmp61)!= 10)goto
...
Cyc_Absyn_AggrType_struct _tmpBF1;union Cyc_Absyn_AggrInfoU_union _tmpBF0;struct Cyc_Absyn_AggrInfo
_tmpBEF;struct Cyc_Absyn_AggrType_struct*_tmpBEE;return(void*)((_tmpBEE=_cycalloc(
sizeof(*_tmpBEE)),((_tmpBEE[0]=((_tmpBF1.tag=10,((_tmpBF1.f1=((_tmpBEF.aggr_info=(
union Cyc_Absyn_AggrInfoU_union)(((_tmpBF0.KnownAggr).tag=1,(((_tmpBF0.KnownAggr).f1=
_tmp8A,_tmpBF0)))),((_tmpBEF.targs=Cyc_Tcutil_copy_types(_tmp8B),_tmpBEF)))),
_tmpBF1)))),_tmpBEE))));}_LL36: if(*((int*)_tmp61)!= 11)goto _LL38;_tmp8C=(void*)((
struct Cyc_Absyn_AnonAggrType_struct*)_tmp61)->f1;_tmp8D=((struct Cyc_Absyn_AnonAggrType_struct*)
_tmp61)->f2;_LL37: {struct Cyc_Absyn_AnonAggrType_struct _tmpBF4;struct Cyc_Absyn_AnonAggrType_struct*
_tmpBF3;return(void*)((_tmpBF3=_cycalloc(sizeof(*_tmpBF3)),((_tmpBF3[0]=((
_tmpBF4.tag=11,((_tmpBF4.f1=(void*)_tmp8C,((_tmpBF4.f2=((struct Cyc_List_List*(*)(
struct Cyc_Absyn_Aggrfield*(*f)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*x))
Cyc_List_map)(Cyc_Tcutil_copy_field,_tmp8D),_tmpBF4)))))),_tmpBF3))));}_LL38: if(*((
...
_tmpBF7;struct Cyc_Absyn_EnumType_struct*_tmpBF6;return(void*)((_tmpBF6=_cycalloc(
sizeof(*_tmpBF6)),((_tmpBF6[0]=((_tmpBF7.tag=12,((_tmpBF7.f1=_tmp8E,((_tmpBF7.f2=
_tmp8F,_tmpBF7)))))),_tmpBF6))));}_LL3A: if(*((int*)_tmp61)!= 13)goto _LL3C;_tmp90=((
struct Cyc_Absyn_AnonEnumType_struct*)_tmp61)->f1;_LL3B: {struct Cyc_Absyn_AnonEnumType_struct
_tmpBFA;struct Cyc_Absyn_AnonEnumType_struct*_tmpBF9;return(void*)((_tmpBF9=
_cycalloc(sizeof(*_tmpBF9)),((_tmpBF9[0]=((_tmpBFA.tag=13,((_tmpBFA.f1=((struct
Cyc_List_List*(*)(struct Cyc_Absyn_Enumfield*(*f)(struct Cyc_Absyn_Enumfield*),
struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_copy_enumfield,_tmp90),_tmpBFA)))),
_tmpBF9))));}_LL3C: if(*((int*)_tmp61)!= 18)goto _LL3E;_tmp91=(void*)((struct Cyc_Absyn_TagType_struct*)
_tmp61)->f1;_LL3D: {struct Cyc_Absyn_TagType_struct _tmpBFD;struct Cyc_Absyn_TagType_struct*
_tmpBFC;return(void*)((_tmpBFC=_cycalloc(sizeof(*_tmpBFC)),((_tmpBFC[0]=((
_tmpBFD.tag=18,((_tmpBFD.f1=(void*)Cyc_Tcutil_copy_type(_tmp91),_tmpBFD)))),
_tmpBFC))));}_LL3E: if(*((int*)_tmp61)!= 17)goto _LL40;_tmp92=((struct Cyc_Absyn_ValueofType_struct*)
_tmp61)->f1;_LL3F: {struct Cyc_Absyn_ValueofType_struct _tmpC00;struct Cyc_Absyn_ValueofType_struct*
_tmpBFF;return(void*)((_tmpBFF=_cycalloc(sizeof(*_tmpBFF)),((_tmpBFF[0]=((
_tmpC00.tag=17,((_tmpC00.f1=_tmp92,_tmpC00)))),_tmpBFF))));}_LL40: if(*((int*)
_tmp61)!= 14)goto _LL42;_tmp93=(void*)((struct Cyc_Absyn_RgnHandleType_struct*)
_tmp61)->f1;_LL41: {struct Cyc_Absyn_RgnHandleType_struct _tmpC03;struct Cyc_Absyn_RgnHandleType_struct*
_tmpC02;return(void*)((_tmpC02=_cycalloc(sizeof(*_tmpC02)),((_tmpC02[0]=((
_tmpC03.tag=14,((_tmpC03.f1=(void*)Cyc_Tcutil_copy_type(_tmp93),_tmpC03)))),
_tmpC02))));}_LL42: if(*((int*)_tmp61)!= 15)goto _LL44;_tmp94=(void*)((struct Cyc_Absyn_DynRgnType_struct*)
_tmp61)->f1;_tmp95=(void*)((struct Cyc_Absyn_DynRgnType_struct*)_tmp61)->f2;_LL43: {
struct Cyc_Absyn_DynRgnType_struct _tmpC06;struct Cyc_Absyn_DynRgnType_struct*
_tmpC05;return(void*)((_tmpC05=_cycalloc(sizeof(*_tmpC05)),((_tmpC05[0]=((
_tmpC06.tag=15,((_tmpC06.f1=(void*)Cyc_Tcutil_copy_type(_tmp94),((_tmpC06.f2=(
void*)Cyc_Tcutil_copy_type(_tmp95),_tmpC06)))))),_tmpC05))));}_LL44: if(*((int*)
...
_tmp61)->f3;_LL45: {struct Cyc_Absyn_TypedefType_struct _tmpC09;struct Cyc_Absyn_TypedefType_struct*
_tmpC08;return(void*)((_tmpC08=_cycalloc(sizeof(*_tmpC08)),((_tmpC08[0]=((
_tmpC09.tag=16,((_tmpC09.f1=_tmp96,((_tmpC09.f2=Cyc_Tcutil_copy_types(_tmp97),((
_tmpC09.f3=_tmp98,((_tmpC09.f4=0,_tmpC09)))))))))),_tmpC08))));}_LL46: if((int)
...
_tmpC0C;struct Cyc_Absyn_AccessEff_struct*_tmpC0B;return(void*)((_tmpC0B=
_cycalloc(sizeof(*_tmpC0B)),((_tmpC0B[0]=((_tmpC0C.tag=19,((_tmpC0C.f1=(void*)
Cyc_Tcutil_copy_type(_tmp99),_tmpC0C)))),_tmpC0B))));}_LL4C: if(_tmp61 <= (void*)4)
goto _LL4E;if(*((int*)_tmp61)!= 20)goto _LL4E;_tmp9A=((struct Cyc_Absyn_JoinEff_struct*)
_tmp61)->f1;_LL4D: {struct Cyc_Absyn_JoinEff_struct _tmpC0F;struct Cyc_Absyn_JoinEff_struct*
_tmpC0E;return(void*)((_tmpC0E=_cycalloc(sizeof(*_tmpC0E)),((_tmpC0E[0]=((
_tmpC0F.tag=20,((_tmpC0F.f1=Cyc_Tcutil_copy_types(_tmp9A),_tmpC0F)))),_tmpC0E))));}
...
_tmpC12;struct Cyc_Absyn_RgnsEff_struct*_tmpC11;return(void*)((_tmpC11=_cycalloc(
sizeof(*_tmpC11)),((_tmpC11[0]=((_tmpC12.tag=21,((_tmpC12.f1=(void*)Cyc_Tcutil_copy_type(
_tmp9B),_tmpC12)))),_tmpC11))));}_LL19:;}int Cyc_Tcutil_kind_leq(void*k1,void*k2);
int Cyc_Tcutil_kind_leq(void*k1,void*k2){if(k1 == k2)return 1;{struct _tuple0 _tmpC13;
struct _tuple0 _tmpE0=(_tmpC13.f1=k1,((_tmpC13.f2=k2,_tmpC13)));void*_tmpE1;void*
...
_tmpEC)->f2;_LL6A: return _tmpEE;_LL6B:;_LL6C: {const char*_tmpC16;void*_tmpC15;(
_tmpC15=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpC16="kind not suitably constrained!",_tag_dyneither(_tmpC16,sizeof(char),31))),
_tag_dyneither(_tmpC15,sizeof(void*),0)));}_LL66:;}void*Cyc_Tcutil_typ_kind(void*
...
_tmpC19;void*_tmpC18;(_tmpC18=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpC19="typ_kind: Unresolved TunionFieldType",
_tag_dyneither(_tmpC19,sizeof(char),37))),_tag_dyneither(_tmpC18,sizeof(void*),0)));}
...
_tmpC1C;void*_tmpC1B;(_tmpC1B=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpC1C="typ_kind: forward constr in ptr bounds",
_tag_dyneither(_tmpC1C,sizeof(char),39))),_tag_dyneither(_tmpC1B,sizeof(void*),0)));}
...
_tmpF1)->f3;_LLA3: if(_tmp10D == 0  || _tmp10D->kind == 0){const char*_tmpC20;void*
_tmpC1F[1];struct Cyc_String_pa_struct _tmpC1E;(_tmpC1E.tag=0,((_tmpC1E.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmpC1F[0]=&
_tmpC1E,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpC20="typ_kind: typedef found: %s",_tag_dyneither(_tmpC20,sizeof(char),28))),
_tag_dyneither(_tmpC1F,sizeof(void*),1)))))));}return(void*)((struct Cyc_Core_Opt*)
...
env,_tmp11F)){{const char*_tmpC21;Cyc_Tcutil_failure_reason=((_tmpC21="(type variable would escape scope)",
_tag_dyneither(_tmpC21,sizeof(char),35)));}(int)_throw((void*)Cyc_Tcutil_Unify);}
...
const char*_tmpC22;Cyc_Tcutil_failure_reason=((_tmpC22="(occurs check)",
_tag_dyneither(_tmpC22,sizeof(char),15)));}(int)_throw((void*)Cyc_Tcutil_Unify);}
...
struct Cyc_List_List*l,struct Cyc_Absyn_Tvar*x))Cyc_List_mem)(Cyc_Tcutil_fast_tvar_cmp,
env,(struct Cyc_Absyn_Tvar*)s->hd)){struct Cyc_List_List*_tmpC23;_tmp140=((_tmpC23=
_cycalloc(sizeof(*_tmpC23)),((_tmpC23->hd=(struct Cyc_Absyn_Tvar*)s->hd,((_tmpC23->tl=
_tmp140,_tmpC23))))));}}}{struct Cyc_Core_Opt*_tmpC24;*_tmp122=((_tmpC24=
_cycalloc(sizeof(*_tmpC24)),((_tmpC24->v=_tmp140,_tmpC24))));}}}}goto _LLB8;_LLBD:
...
struct Cyc_Absyn_Tqual tq1,void*t1,struct Cyc_Absyn_Tqual tq2,void*t2){if(tq1.print_const
 && !tq1.real_const){const char*_tmpC27;void*_tmpC26;(_tmpC26=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpC27="tq1 real_const not set.",
_tag_dyneither(_tmpC27,sizeof(char),24))),_tag_dyneither(_tmpC26,sizeof(void*),0)));}
if(tq2.print_const  && !tq2.real_const){const char*_tmpC2A;void*_tmpC29;(_tmpC29=0,((
int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpC2A="tq2 real_const not set.",_tag_dyneither(_tmpC2A,sizeof(char),24))),
_tag_dyneither(_tmpC29,sizeof(void*),0)));}if((tq1.real_const != tq2.real_const
...
tq2.real_const;{const char*_tmpC2B;Cyc_Tcutil_failure_reason=((_tmpC2B="(qualifiers don't match)",
_tag_dyneither(_tmpC2B,sizeof(char),25)));}(int)_throw((void*)Cyc_Tcutil_Unify);}
...
!= 2)goto _LLDE;_LLDD:{union Cyc_Absyn_Constraint_union _tmpC2C;x->v=(union Cyc_Absyn_Constraint_union)(((
_tmpC2C.Forward_constr).tag=1,(((_tmpC2C.Forward_constr).f1=y,_tmpC2C))));}
...
_LLE7: if((_tmp14F.Forward_constr).tag != 1)goto _LLE2;_LLE8: {const char*_tmpC2F;
void*_tmpC2E;(_tmpC2E=0,Cyc_Tcutil_impos(((_tmpC2F="unify_conref: forward after compress(2)",
_tag_dyneither(_tmpC2F,sizeof(char),40))),_tag_dyneither(_tmpC2E,sizeof(void*),0)));}
_LLE2:;}_LLE0: if((_tmp14C.Forward_constr).tag != 1)goto _LLDB;_LLE1: {const char*
_tmpC32;void*_tmpC31;(_tmpC31=0,Cyc_Tcutil_impos(((_tmpC32="unify_conref: forward after compress",
_tag_dyneither(_tmpC32,sizeof(char),37))),_tag_dyneither(_tmpC31,sizeof(void*),0)));}
...
void*b1,void*b2){struct _tuple0 _tmpC33;struct _tuple0 _tmp15C=(_tmpC33.f1=b1,((
_tmpC33.f2=b2,_tmpC33)));void*_tmp15D;void*_tmp15E;void*_tmp15F;void*_tmp160;
...
_tuple0 _tmpC34;struct _tuple0 _tmp166=(_tmpC34.f1=b1,((_tmpC34.f2=b2,_tmpC34)));
...
_tuple0 _tmpC35;struct _tuple0 _tmp171=(_tmpC35.f1=att1,((_tmpC35.f2=att2,_tmpC35)));
...
_LL142:{struct Cyc_Absyn_ValueofType_struct _tmpC38;struct Cyc_Absyn_ValueofType_struct*
_tmpC37;t=(void*)((_tmpC37=_cycalloc(sizeof(*_tmpC37)),((_tmpC37[0]=((_tmpC38.tag=
17,((_tmpC38.f1=Cyc_Absyn_uint_exp(0,0),_tmpC38)))),_tmpC37))));}goto _LL13A;
_LL143:;_LL144: t=Cyc_Absyn_sint_typ;goto _LL13A;_LL13A:;}{struct _tuple8*_tmpC39;
return(_tmpC39=_cycalloc(sizeof(*_tmpC39)),((_tmpC39->f1=tv,((_tmpC39->f2=t,
_tmpC39)))));}}static void*Cyc_Tcutil_rgns_of(void*t);static void*Cyc_Tcutil_rgns_of(
...
_tmpC3C;struct Cyc_Absyn_AccessEff_struct*_tmpC3B;return(void*)((_tmpC3B=
_cycalloc(sizeof(*_tmpC3B)),((_tmpC3B[0]=((_tmpC3C.tag=19,((_tmpC3C.f1=(void*)t,
_tmpC3C)))),_tmpC3B))));}_LL181: if((int)_tmp1AC != 6)goto _LL183;_LL182: return t;
_LL183: if((int)_tmp1AC != 7)goto _LL185;_LL184: return Cyc_Absyn_empty_effect;_LL185:;
_LL186: {struct Cyc_Absyn_RgnsEff_struct _tmpC3F;struct Cyc_Absyn_RgnsEff_struct*
_tmpC3E;return(void*)((_tmpC3E=_cycalloc(sizeof(*_tmpC3E)),((_tmpC3E[0]=((
_tmpC3F.tag=21,((_tmpC3F.f1=(void*)t,_tmpC3F)))),_tmpC3E))));}_LL17A:;}_LL158:
if(*((int*)_tmp190)!= 14)goto _LL15A;_tmp191=(void*)((struct Cyc_Absyn_RgnHandleType_struct*)
_tmp190)->f1;_LL159: {struct Cyc_Absyn_AccessEff_struct _tmpC42;struct Cyc_Absyn_AccessEff_struct*
_tmpC41;return(void*)((_tmpC41=_cycalloc(sizeof(*_tmpC41)),((_tmpC41[0]=((
_tmpC42.tag=19,((_tmpC42.f1=(void*)_tmp191,_tmpC42)))),_tmpC41))));}_LL15A: if(*((
...
_LL15B: {struct Cyc_Absyn_AccessEff_struct _tmpC45;struct Cyc_Absyn_AccessEff_struct*
_tmpC44;return(void*)((_tmpC44=_cycalloc(sizeof(*_tmpC44)),((_tmpC44[0]=((
_tmpC45.tag=19,((_tmpC45.f1=(void*)_tmp193,_tmpC45)))),_tmpC44))));}_LL15C: if(*((
...
_tmpC4B;struct Cyc_Absyn_AccessEff_struct _tmpC4A;struct Cyc_List_List*_tmpC49;ts=((
_tmpC49=_cycalloc(sizeof(*_tmpC49)),((_tmpC49->hd=(void*)((void*)((_tmpC4B=
_cycalloc(sizeof(*_tmpC4B)),((_tmpC4B[0]=((_tmpC4A.tag=19,((_tmpC4A.f1=(void*)((
void*)_tmp196->v),_tmpC4A)))),_tmpC4B))))),((_tmpC49->tl=ts,_tmpC49))))));}{
struct Cyc_Absyn_JoinEff_struct _tmpC4E;struct Cyc_Absyn_JoinEff_struct*_tmpC4D;
return Cyc_Tcutil_normalize_effect((void*)((_tmpC4D=_cycalloc(sizeof(*_tmpC4D)),((
_tmpC4D[0]=((_tmpC4E.tag=20,((_tmpC4E.f1=ts,_tmpC4E)))),_tmpC4D)))));}}_LL15E:
...
void*)_tmp199.rgn;_LL15F: {struct Cyc_Absyn_JoinEff_struct _tmpC5D;struct Cyc_Absyn_AccessEff_struct*
_tmpC5C;struct Cyc_Absyn_AccessEff_struct _tmpC5B;void*_tmpC5A[2];struct Cyc_Absyn_JoinEff_struct*
_tmpC59;return Cyc_Tcutil_normalize_effect((void*)((_tmpC59=_cycalloc(sizeof(*
_tmpC59)),((_tmpC59[0]=((_tmpC5D.tag=20,((_tmpC5D.f1=((_tmpC5A[1]=Cyc_Tcutil_rgns_of(
_tmp198),((_tmpC5A[0]=(void*)((_tmpC5C=_cycalloc(sizeof(*_tmpC5C)),((_tmpC5C[0]=((
_tmpC5B.tag=19,((_tmpC5B.f1=(void*)_tmp19A,_tmpC5B)))),_tmpC5C)))),Cyc_List_list(
_tag_dyneither(_tmpC5A,sizeof(void*),2)))))),_tmpC5D)))),_tmpC59)))));}_LL160:
...
_tmp1BF=0;for(0;_tmp19D != 0;_tmp19D=_tmp19D->tl){struct Cyc_List_List*_tmpC5E;
_tmp1BF=((_tmpC5E=_cycalloc(sizeof(*_tmpC5E)),((_tmpC5E->hd=(void*)(*((struct
_tuple5*)_tmp19D->hd)).f2,((_tmpC5E->tl=_tmp1BF,_tmpC5E))))));}_tmp19F=_tmp1BF;
...
_tmp1A1=_tmp1A0.targs;_LL167: {struct Cyc_Absyn_JoinEff_struct _tmpC61;struct Cyc_Absyn_JoinEff_struct*
_tmpC60;return Cyc_Tcutil_normalize_effect((void*)((_tmpC60=_cycalloc(sizeof(*
_tmpC60)),((_tmpC60[0]=((_tmpC61.tag=20,((_tmpC61.f1=Cyc_List_map(Cyc_Tcutil_rgns_of,
_tmp1A1),_tmpC61)))),_tmpC60)))));}_LL168: if(*((int*)_tmp190)!= 11)goto _LL16A;
_tmp1A2=((struct Cyc_Absyn_AnonAggrType_struct*)_tmp190)->f2;_LL169: {struct Cyc_Absyn_JoinEff_struct
_tmpC64;struct Cyc_Absyn_JoinEff_struct*_tmpC63;return Cyc_Tcutil_normalize_effect((
void*)((_tmpC63=_cycalloc(sizeof(*_tmpC63)),((_tmpC63[0]=((_tmpC64.tag=20,((
_tmpC64.f1=((struct Cyc_List_List*(*)(void*(*f)(struct Cyc_Absyn_Aggrfield*),
struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_rgns_of_field,_tmp1A2),_tmpC64)))),
_tmpC63)))));}_LL16A: if(*((int*)_tmp190)!= 18)goto _LL16C;_LL16B: return Cyc_Absyn_empty_effect;
...
_tmp190)->f2;_LL179: {struct Cyc_Absyn_JoinEff_struct _tmpC67;struct Cyc_Absyn_JoinEff_struct*
...
_tmp1AB),_tmpC67)))),_tmpC66)))));}_LL145:;}void*Cyc_Tcutil_normalize_effect(
...
struct Cyc_List_List*_tmpC68;effects=((_tmpC68=_cycalloc(sizeof(*_tmpC68)),((
_tmpC68->hd=(void*)_tmp1CF,((_tmpC68->tl=effects,_tmpC68))))));}goto _LL195;
...
_tmpC72;struct Cyc_Core_Opt*_tmpC71;struct Cyc_Absyn_FnInfo _tmpC70;struct Cyc_Absyn_FnType_struct*
_tmpC6F;struct Cyc_Absyn_FnType_struct*_tmp1D4=(_tmpC6F=_cycalloc(sizeof(*_tmpC6F)),((
_tmpC6F[0]=((_tmpC72.tag=8,((_tmpC72.f1=((_tmpC70.tvars=0,((_tmpC70.effect=((
_tmpC71=_cycalloc(sizeof(*_tmpC71)),((_tmpC71->v=(void*)eff,_tmpC71)))),((
_tmpC70.ret_typ=(void*)((void*)0),((_tmpC70.args=0,((_tmpC70.c_varargs=0,((
_tmpC70.cyc_varargs=0,((_tmpC70.rgn_po=0,((_tmpC70.attributes=0,_tmpC70)))))))))))))))),
_tmpC72)))),_tmpC6F)));return Cyc_Absyn_atb_typ((void*)_tmp1D4,(void*)2,Cyc_Absyn_empty_tqual(
...
_tmp1DA);if(r == _tmp1DA)return 1;{struct _tuple0 _tmpC73;struct _tuple0 _tmp1E2=(
_tmpC73.f1=r,((_tmpC73.f2=_tmp1DA,_tmpC73)));void*_tmp1E3;struct Cyc_Absyn_Tvar*
...
_tmpC82;struct Cyc_Absyn_AccessEff_struct*_tmpC81;struct Cyc_Absyn_AccessEff_struct
_tmpC80;void*_tmpC7F[2];struct Cyc_Absyn_JoinEff_struct*_tmpC7E;void*_tmp1EF=Cyc_Tcutil_dummy_fntype((
void*)((_tmpC7E=_cycalloc(sizeof(*_tmpC7E)),((_tmpC7E[0]=((_tmpC82.tag=20,((
_tmpC82.f1=((_tmpC7F[1]=(void*)((_tmpC81=_cycalloc(sizeof(*_tmpC81)),((_tmpC81[0]=((
_tmpC80.tag=19,((_tmpC80.f1=(void*)r,_tmpC80)))),_tmpC81)))),((_tmpC7F[0]=
_tmp1EE,Cyc_List_list(_tag_dyneither(_tmpC7F,sizeof(void*),2)))))),_tmpC82)))),
_tmpC7E)))));{struct Cyc_Core_Opt*_tmpC83;*_tmp1EC=((_tmpC83=_cycalloc(sizeof(*
_tmpC83)),((_tmpC83->v=(void*)_tmp1EF,_tmpC83))));}return 1;}}_LL1BB:;_LL1BC:
...
_tmpC86;void*_tmpC85;(_tmpC85=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpC86="effect evar has wrong kind",
_tag_dyneither(_tmpC86,sizeof(char),27))),_tag_dyneither(_tmpC85,sizeof(void*),0)));}
...
_tmpC9B;struct Cyc_List_List*_tmpC9A;struct Cyc_Absyn_AccessEff_struct _tmpC99;
struct Cyc_Absyn_AccessEff_struct*_tmpC98;struct Cyc_List_List*_tmpC97;struct Cyc_Absyn_JoinEff_struct*
_tmpC96;struct Cyc_Absyn_JoinEff_struct*_tmp1F9=(_tmpC96=_cycalloc(sizeof(*
_tmpC96)),((_tmpC96[0]=((_tmpC9B.tag=20,((_tmpC9B.f1=((_tmpC97=_cycalloc(sizeof(*
_tmpC97)),((_tmpC97->hd=(void*)_tmp1F8,((_tmpC97->tl=((_tmpC9A=_cycalloc(sizeof(*
_tmpC9A)),((_tmpC9A->hd=(void*)((void*)((_tmpC98=_cycalloc(sizeof(*_tmpC98)),((
_tmpC98[0]=((_tmpC99.tag=19,((_tmpC99.f1=(void*)r,_tmpC99)))),_tmpC98))))),((
_tmpC9A->tl=0,_tmpC9A)))))),_tmpC97)))))),_tmpC9B)))),_tmpC96)));{struct Cyc_Core_Opt*
_tmpC9C;*_tmp1DF=((_tmpC9C=_cycalloc(sizeof(*_tmpC9C)),((_tmpC9C->v=(void*)((
void*)_tmp1F9),_tmpC9C))));}return 1;}}_LL1AC:;_LL1AD: return 0;_LL1A3:;}}static int
...
Cyc_Absyn_RgnsEff_struct*)_tmp208)->f1;_LL1CA: {struct _tuple0 _tmpC9D;struct
_tuple0 _tmp20B=(_tmpC9D.f1=Cyc_Tcutil_compress(_tmp209),((_tmpC9D.f2=_tmp203,
_tmpC9D)));void*_tmp20C;struct Cyc_Absyn_Tvar*_tmp20D;void*_tmp20E;struct Cyc_Absyn_Tvar*
...
_tmpCA0;void*_tmpC9F;(_tmpC9F=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpCA0="effect evar has wrong kind",
_tag_dyneither(_tmpCA0,sizeof(char),27))),_tag_dyneither(_tmpC9F,sizeof(void*),0)));}
...
_tmpCB5;struct Cyc_List_List*_tmpCB4;struct Cyc_Absyn_RgnsEff_struct _tmpCB3;struct
Cyc_Absyn_RgnsEff_struct*_tmpCB2;struct Cyc_List_List*_tmpCB1;struct Cyc_Absyn_JoinEff_struct*
_tmpCB0;struct Cyc_Absyn_JoinEff_struct*_tmp213=(_tmpCB0=_cycalloc(sizeof(*
_tmpCB0)),((_tmpCB0[0]=((_tmpCB5.tag=20,((_tmpCB5.f1=((_tmpCB1=_cycalloc(sizeof(*
_tmpCB1)),((_tmpCB1->hd=(void*)_tmp212,((_tmpCB1->tl=((_tmpCB4=_cycalloc(sizeof(*
_tmpCB4)),((_tmpCB4->hd=(void*)((void*)((_tmpCB2=_cycalloc(sizeof(*_tmpCB2)),((
_tmpCB2[0]=((_tmpCB3.tag=21,((_tmpCB3.f1=(void*)t,_tmpCB3)))),_tmpCB2))))),((
_tmpCB4->tl=0,_tmpCB4)))))),_tmpCB1)))))),_tmpCB5)))),_tmpCB0)));{struct Cyc_Core_Opt*
_tmpCB6;*_tmp206=((_tmpCB6=_cycalloc(sizeof(*_tmpCB6)),((_tmpCB6->v=(void*)((
void*)_tmp213),_tmpCB6))));}return 1;}}_LL1C6:;_LL1C7: return 0;_LL1BD:;}}static int
...
_tmpCC5;struct Cyc_Absyn_VarType_struct*_tmpCC4;struct Cyc_Absyn_VarType_struct
_tmpCC3;void*_tmpCC2[2];struct Cyc_Absyn_JoinEff_struct*_tmpCC1;void*_tmp22B=Cyc_Tcutil_dummy_fntype((
void*)((_tmpCC1=_cycalloc(sizeof(*_tmpCC1)),((_tmpCC1[0]=((_tmpCC5.tag=20,((
_tmpCC5.f1=((_tmpCC2[1]=(void*)((_tmpCC4=_cycalloc(sizeof(*_tmpCC4)),((_tmpCC4[0]=((
_tmpCC3.tag=1,((_tmpCC3.f1=v,_tmpCC3)))),_tmpCC4)))),((_tmpCC2[0]=_tmp22A,Cyc_List_list(
_tag_dyneither(_tmpCC2,sizeof(void*),2)))))),_tmpCC5)))),_tmpCC1)))));{struct Cyc_Core_Opt*
_tmpCC6;*_tmp228=((_tmpCC6=_cycalloc(sizeof(*_tmpCC6)),((_tmpCC6->v=(void*)
_tmp22B,_tmpCC6))));}return 1;}}_LL1E5:;_LL1E6: return 0;_LL1E2:;}_LL1E0:;_LL1E1:
...
_tmpCC9;void*_tmpCC8;(_tmpCC8=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpCC9="effect evar has wrong kind",
_tag_dyneither(_tmpCC9,sizeof(char),27))),_tag_dyneither(_tmpCC8,sizeof(void*),0)));}{
...
_tmpCDE;struct Cyc_List_List*_tmpCDD;struct Cyc_Absyn_VarType_struct _tmpCDC;struct
Cyc_Absyn_VarType_struct*_tmpCDB;struct Cyc_List_List*_tmpCDA;struct Cyc_Absyn_JoinEff_struct*
_tmpCD9;struct Cyc_Absyn_JoinEff_struct*_tmp235=(_tmpCD9=_cycalloc(sizeof(*
_tmpCD9)),((_tmpCD9[0]=((_tmpCDE.tag=20,((_tmpCDE.f1=((_tmpCDA=_cycalloc(sizeof(*
_tmpCDA)),((_tmpCDA->hd=(void*)_tmp234,((_tmpCDA->tl=((_tmpCDD=_cycalloc(sizeof(*
_tmpCDD)),((_tmpCDD->hd=(void*)((void*)((_tmpCDB=_cycalloc(sizeof(*_tmpCDB)),((
_tmpCDB[0]=((_tmpCDC.tag=1,((_tmpCDC.f1=v,_tmpCDC)))),_tmpCDB))))),((_tmpCDD->tl=
0,_tmpCDD)))))),_tmpCDA)))))),_tmpCDE)))),_tmpCD9)));{struct Cyc_Core_Opt*_tmpCDF;*
_tmp221=((_tmpCDF=_cycalloc(sizeof(*_tmpCDF)),((_tmpCDF->v=(void*)((void*)
_tmp235),_tmpCDF))));}return 1;}}_LL1DB:;_LL1DC: return 0;_LL1D2:;}}static int Cyc_Tcutil_evar_in_effect(
...
_tmpCE0;*_tmp248=((_tmpCE0=_cycalloc(sizeof(*_tmpCE0)),((_tmpCE0->v=(void*)Cyc_Absyn_empty_effect,
_tmpCE0))));}return 1;_LL200:;_LL201: {const char*_tmpCE4;void*_tmpCE3[1];struct
Cyc_String_pa_struct _tmpCE2;(_tmpCE2.tag=0,((_tmpCE2.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string(e1)),((_tmpCE3[0]=& _tmpCE2,((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpCE4="subset_effect: bad effect: %s",
...
_tmp259))->v)){{struct Cyc_Core_Opt*_tmpCE5;*_tmp25B=((_tmpCE5=_cycalloc(sizeof(*
_tmpCE5)),((_tmpCE5->v=(void*)t2,_tmpCE5))));}return;}else{{void*_tmp25F=t2;
...
struct Cyc_List_List*l,struct Cyc_Absyn_Tvar*x))Cyc_List_mem)(Cyc_Tcutil_fast_tvar_cmp,
_tmp264,(struct Cyc_Absyn_Tvar*)s2->hd)){{const char*_tmpCE6;Cyc_Tcutil_failure_reason=((
_tmpCE6="(type variable would escape scope)",_tag_dyneither(_tmpCE6,sizeof(char),
35)));}(int)_throw((void*)Cyc_Tcutil_Unify);}}}if(Cyc_Tcutil_kind_leq((void*)
_tmp259->v,_tmp25D)){{struct Cyc_Core_Opt*_tmpCE7;*_tmp261=((_tmpCE7=_cycalloc(
sizeof(*_tmpCE7)),((_tmpCE7->v=(void*)t1,_tmpCE7))));}return;}{const char*_tmpCE8;
Cyc_Tcutil_failure_reason=((_tmpCE8="(kinds are incompatible)",_tag_dyneither(
_tmpCE8,sizeof(char),25)));}goto _LL20C;}_LL20F: if(*((int*)_tmp25F)!= 4)goto
...
_tmpCE9;_tmp268->v=(union Cyc_Absyn_Constraint_union)(((_tmpCE9.Eq_constr).tag=0,(((
_tmpCE9.Eq_constr).f1=(void*)Cyc_Absyn_bounds_one,_tmpCE9))));}{struct Cyc_Core_Opt*
_tmpCEA;*_tmp25B=((_tmpCEA=_cycalloc(sizeof(*_tmpCEA)),((_tmpCEA->v=(void*)t2,
_tmpCEA))));}return;_LL216:;_LL217: goto _LL213;_LL213:;}goto _LL20C;}_LL211:;
_LL212: goto _LL20C;_LL20C:;}{const char*_tmpCEB;Cyc_Tcutil_failure_reason=((
_tmpCEB="(kinds are incompatible)",_tag_dyneither(_tmpCEB,sizeof(char),25)));}(
int)_throw((void*)Cyc_Tcutil_Unify);}}_LL20A:;_LL20B: goto _LL207;_LL207:;}{struct
_tuple0 _tmpCEC;struct _tuple0 _tmp26E=(_tmpCEC.f1=t2,((_tmpCEC.f2=t1,_tmpCEC)));
...
_tmp304,_tmp305)== 0){if(_tmp308 != _tmp309){const char*_tmpCF2;void*_tmpCF1[3];
struct Cyc_String_pa_struct _tmpCF0;struct Cyc_String_pa_struct _tmpCEF;struct Cyc_String_pa_struct
_tmpCEE;(_tmpCEE.tag=0,((_tmpCEE.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_kind2string(_tmp309)),((_tmpCEF.tag=0,((_tmpCEF.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(_tmp308)),((
_tmpCF0.tag=0,((_tmpCF0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp304),((
_tmpCF1[0]=& _tmpCF0,((_tmpCF1[1]=& _tmpCEF,((_tmpCF1[2]=& _tmpCEE,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpCF2="same type variable %s has kinds %s and %s",
_tag_dyneither(_tmpCF2,sizeof(char),42))),_tag_dyneither(_tmpCF1,sizeof(void*),3)))))))))))))))))));}
return;}{const char*_tmpCF3;Cyc_Tcutil_failure_reason=((_tmpCF3="(variable types are not the same)",
_tag_dyneither(_tmpCF3,sizeof(char),34)));}goto _LL218;}_LL21F: _tmp276=_tmp26E.f1;
...
if(_tmp311 != _tmp314){{const char*_tmpCF4;Cyc_Tcutil_failure_reason=((_tmpCF4="(struct and union type)",
_tag_dyneither(_tmpCF4,sizeof(char),24)));}goto _LL218;}if(Cyc_Absyn_qvar_cmp(
_tmp312,_tmp315)!= 0){{const char*_tmpCF5;Cyc_Tcutil_failure_reason=((_tmpCF5="(different type name)",
_tag_dyneither(_tmpCF5,sizeof(char),22)));}goto _LL218;}Cyc_Tcutil_unify_list(
...
_LL222: if(Cyc_Absyn_qvar_cmp(_tmp27F,_tmp281)== 0)return;{const char*_tmpCF6;Cyc_Tcutil_failure_reason=((
_tmpCF6="(different enum types)",_tag_dyneither(_tmpCF6,sizeof(char),23)));}goto
...
_tmp319->name,_tmp31A->name)!= 0){{const char*_tmpCF7;Cyc_Tcutil_failure_reason=((
_tmpCF7="(different names for enum fields)",_tag_dyneither(_tmpCF7,sizeof(char),
34)));}bad=1;break;}if(_tmp319->tag == _tmp31A->tag)continue;if(_tmp319->tag == 0
 || _tmp31A->tag == 0){{const char*_tmpCF8;Cyc_Tcutil_failure_reason=((_tmpCF8="(different tag values for enum fields)",
_tag_dyneither(_tmpCF8,sizeof(char),39)));}bad=1;break;}if(!Cyc_Evexp_same_const_exp((
struct Cyc_Absyn_Exp*)_check_null(_tmp319->tag),(struct Cyc_Absyn_Exp*)_check_null(
_tmp31A->tag))){{const char*_tmpCF9;Cyc_Tcutil_failure_reason=((_tmpCF9="(different tag values for enum fields)",
_tag_dyneither(_tmpCF9,sizeof(char),39)));}bad=1;break;}}if(bad)goto _LL218;if(
_tmp283 == 0  && _tmp285 == 0)return;{const char*_tmpCFA;Cyc_Tcutil_failure_reason=((
_tmpCFA="(different number of fields for enums)",_tag_dyneither(_tmpCFA,sizeof(
...
Cyc_Tcutil_unify_list(_tmp292,_tmp28B);return;}Tunion_fail: {const char*_tmpCFB;
Cyc_Tcutil_failure_reason=((_tmpCFB="(different tunion types)",_tag_dyneither(
_tmpCFB,sizeof(char),25)));}goto _LL218;_LL227: _tmp294=_tmp26E.f1;if(_tmp294 <= (
...
_tmpCFC;Cyc_Tcutil_failure_reason=((_tmpCFC="(different tunion field types)",
_tag_dyneither(_tmpCFC,sizeof(char),31)));}goto _LL218;_LL229: _tmp2A0=_tmp26E.f1;
...
Cyc_Tcutil_t1_failure=t1;Cyc_Tcutil_t2_failure=t2;{const char*_tmpCFD;((void(*)(
...
_tmp2A8,((_tmpCFD="(not both zero terminated)",_tag_dyneither(_tmpCFD,sizeof(
char),27))));}Cyc_Tcutil_unify_tqual(_tmp2AC,_tmp2AB,_tmp2A3,_tmp2A2);{const char*
_tmpCFE;Cyc_Tcutil_unify_it_conrefs(Cyc_Tcutil_unify_it_bounds,_tmp2B0,_tmp2A7,((
_tmpCFE="(different pointer bounds)",_tag_dyneither(_tmpCFE,sizeof(char),27))));}{
...
const char*_tmpCFF;((void(*)(int(*cmp)(int,int),struct Cyc_Absyn_Conref*x,struct
Cyc_Absyn_Conref*y,struct _dyneither_ptr reason))Cyc_Tcutil_unify_it_conrefs)(Cyc_Core_intcmp,
_tmp2AF,_tmp2A6,((_tmpCFF="(incompatible pointer types)",_tag_dyneither(_tmpCFF,
...
== (void*)3  && _tmp2B4 == (void*)2))return;{const char*_tmpD00;Cyc_Tcutil_failure_reason=((
_tmpD00="(different integral types)",_tag_dyneither(_tmpD00,sizeof(char),27)));}
...
_LL234: if(!Cyc_Evexp_same_const_exp(_tmp2C3,_tmp2C5)){{const char*_tmpD01;Cyc_Tcutil_failure_reason=((
_tmpD01="(cannot prove expressions are the same)",_tag_dyneither(_tmpD01,sizeof(
...
t2;{const char*_tmpD02;((void(*)(int(*cmp)(int,int),struct Cyc_Absyn_Conref*x,
struct Cyc_Absyn_Conref*y,struct _dyneither_ptr reason))Cyc_Tcutil_unify_it_conrefs)(
Cyc_Core_intcmp,_tmp2CB,_tmp2D1,((_tmpD02="(not both zero terminated)",
_tag_dyneither(_tmpD02,sizeof(char),27))));}if(_tmp2CA == _tmp2D0)return;if(
_tmp2CA == 0  || _tmp2D0 == 0)goto _LL218;if(Cyc_Evexp_same_const_exp((struct Cyc_Absyn_Exp*)
_tmp2CA,(struct Cyc_Absyn_Exp*)_tmp2D0))return;{const char*_tmpD03;Cyc_Tcutil_failure_reason=((
_tmpD03="(different array sizes)",_tag_dyneither(_tmpD03,sizeof(char),24)));}
...
const char*_tmpD04;Cyc_Tcutil_failure_reason=((_tmpD04="(second function type has too few type variables)",
_tag_dyneither(_tmpD04,sizeof(char),50)));}(int)_throw((void*)Cyc_Tcutil_Unify);}{
...
_tmp32D){{const char*_tmpD0A;void*_tmpD09[3];struct Cyc_String_pa_struct _tmpD08;
struct Cyc_String_pa_struct _tmpD07;struct Cyc_String_pa_struct _tmpD06;Cyc_Tcutil_failure_reason=(
struct _dyneither_ptr)((_tmpD06.tag=0,((_tmpD06.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_kind2string(_tmp32D)),((_tmpD07.tag=0,((_tmpD07.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(_tmp32C)),((
_tmpD08.tag=0,((_tmpD08.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcutil_tvar2string((
struct Cyc_Absyn_Tvar*)_tmp2DE->hd)),((_tmpD09[0]=& _tmpD08,((_tmpD09[1]=& _tmpD07,((
_tmpD09[2]=& _tmpD06,Cyc_aprintf(((_tmpD0A="(type var %s has different kinds %s and %s)",
_tag_dyneither(_tmpD0A,sizeof(char),44))),_tag_dyneither(_tmpD09,sizeof(void*),3))))))))))))))))))));}(
int)_throw((void*)Cyc_Tcutil_Unify);}{struct _tuple8*_tmpD14;struct Cyc_Absyn_VarType_struct
_tmpD13;struct Cyc_Absyn_VarType_struct*_tmpD12;struct Cyc_List_List*_tmpD11;inst=((
_tmpD11=_region_malloc(rgn,sizeof(*_tmpD11)),((_tmpD11->hd=((_tmpD14=
_region_malloc(rgn,sizeof(*_tmpD14)),((_tmpD14->f1=(struct Cyc_Absyn_Tvar*)
_tmp2D4->hd,((_tmpD14->f2=(void*)((_tmpD12=_cycalloc(sizeof(*_tmpD12)),((_tmpD12[
0]=((_tmpD13.tag=1,((_tmpD13.f1=(struct Cyc_Absyn_Tvar*)_tmp2DE->hd,_tmpD13)))),
_tmpD12)))),_tmpD14)))))),((_tmpD11->tl=inst,_tmpD11))))));}_tmp2DE=_tmp2DE->tl;
_tmp2D4=_tmp2D4->tl;}}if(_tmp2D4 != 0){{const char*_tmpD15;Cyc_Tcutil_failure_reason=((
_tmpD15="(second function type has too many type variables)",_tag_dyneither(
_tmpD15,sizeof(char),51)));}_npop_handler(0);goto _LL218;}if(inst != 0){{struct Cyc_Absyn_FnType_struct
_tmpD21;struct Cyc_Absyn_FnInfo _tmpD20;struct Cyc_Absyn_FnType_struct*_tmpD1F;
struct Cyc_Absyn_FnType_struct _tmpD1B;struct Cyc_Absyn_FnInfo _tmpD1A;struct Cyc_Absyn_FnType_struct*
_tmpD19;Cyc_Tcutil_unify_it((void*)((_tmpD19=_cycalloc(sizeof(*_tmpD19)),((
_tmpD19[0]=((_tmpD1B.tag=8,((_tmpD1B.f1=((_tmpD1A.tvars=0,((_tmpD1A.effect=
_tmp2DF,((_tmpD1A.ret_typ=(void*)_tmp2E0,((_tmpD1A.args=_tmp2E1,((_tmpD1A.c_varargs=
_tmp2E2,((_tmpD1A.cyc_varargs=_tmp2E3,((_tmpD1A.rgn_po=_tmp2E4,((_tmpD1A.attributes=
_tmp2E5,_tmpD1A)))))))))))))))),_tmpD1B)))),_tmpD19)))),Cyc_Tcutil_rsubstitute(
rgn,inst,(void*)((_tmpD1F=_cycalloc(sizeof(*_tmpD1F)),((_tmpD1F[0]=((_tmpD21.tag=
8,((_tmpD21.f1=((_tmpD20.tvars=0,((_tmpD20.effect=_tmp2D5,((_tmpD20.ret_typ=(
void*)_tmp2D6,((_tmpD20.args=_tmp2D7,((_tmpD20.c_varargs=_tmp2D8,((_tmpD20.cyc_varargs=
_tmp2D9,((_tmpD20.rgn_po=_tmp2DA,((_tmpD20.attributes=_tmp2DB,_tmpD20)))))))))))))))),
_tmpD21)))),_tmpD1F))))));}done=1;}}if(done){_npop_handler(0);return;}Cyc_Tcutil_unify_it(
...
t2;if(_tmp2E1 != 0  || _tmp2D7 != 0){{const char*_tmpD22;Cyc_Tcutil_failure_reason=((
_tmpD22="(function types have different number of arguments)",_tag_dyneither(
_tmpD22,sizeof(char),52)));}_npop_handler(0);goto _LL218;}if(_tmp2E2 != _tmp2D8){{
const char*_tmpD23;Cyc_Tcutil_failure_reason=((_tmpD23="(only one function type takes C varargs)",
_tag_dyneither(_tmpD23,sizeof(char),41)));}_npop_handler(0);goto _LL218;}{int
bad_cyc_vararg=0;{struct _tuple11 _tmpD24;struct _tuple11 _tmp347=(_tmpD24.f1=
_tmp2E3,((_tmpD24.f2=_tmp2D9,_tmpD24)));struct Cyc_Absyn_VarargInfo*_tmp348;
...
bad_cyc_vararg=1;{const char*_tmpD25;Cyc_Tcutil_failure_reason=((_tmpD25="(only one function type takes varargs)",
_tag_dyneither(_tmpD25,sizeof(char),39)));}goto _LL258;_LL25F: _tmp34C=_tmp347.f1;
...
_tmp357){bad_cyc_vararg=1;{const char*_tmpD26;Cyc_Tcutil_failure_reason=((_tmpD26="(only one function type injects varargs)",
_tag_dyneither(_tmpD26,sizeof(char),41)));}}goto _LL258;_LL258:;}if(
bad_cyc_vararg){_npop_handler(0);goto _LL218;}{int bad_effect=0;{struct _tuple12
_tmpD27;struct _tuple12 _tmp35B=(_tmpD27.f1=_tmp2DF,((_tmpD27.f2=_tmp2D5,_tmpD27)));
...
char*_tmpD28;Cyc_Tcutil_failure_reason=((_tmpD28="(function type effects do not unify)",
_tag_dyneither(_tmpD28,sizeof(char),37)));}_npop_handler(0);goto _LL218;}if(!Cyc_Tcutil_same_atts(
_tmp2DB,_tmp2E5)){{const char*_tmpD29;Cyc_Tcutil_failure_reason=((_tmpD29="(function types have different attributes)",
_tag_dyneither(_tmpD29,sizeof(char),43)));}_npop_handler(0);goto _LL218;}if(!Cyc_Tcutil_same_rgn_po(
_tmp2DA,_tmp2E4)){{const char*_tmpD2A;Cyc_Tcutil_failure_reason=((_tmpD2A="(function types have different region lifetime orderings)",
_tag_dyneither(_tmpD2A,sizeof(char),58)));}_npop_handler(0);goto _LL218;}
...
char*_tmpD2B;Cyc_Tcutil_failure_reason=((_tmpD2B="(tuple types have different numbers of components)",
_tag_dyneither(_tmpD2B,sizeof(char),51)));}goto _LL218;_LL23B: _tmp2EA=_tmp26E.f1;
...
if(_tmp2EE != _tmp2EB){{const char*_tmpD2C;Cyc_Tcutil_failure_reason=((_tmpD2C="(struct and union type)",
_tag_dyneither(_tmpD2C,sizeof(char),24)));}goto _LL218;}for(0;_tmp2EF != 0  && 
...
_tmp36C->name)!= 0){{const char*_tmpD2D;Cyc_Tcutil_failure_reason=((_tmpD2D="(different member names)",
_tag_dyneither(_tmpD2D,sizeof(char),25)));}(int)_throw((void*)Cyc_Tcutil_Unify);}
...
t2;{const char*_tmpD2E;Cyc_Tcutil_failure_reason=((_tmpD2E="(different attributes on member)",
_tag_dyneither(_tmpD2E,sizeof(char),33)));}(int)_throw((void*)Cyc_Tcutil_Unify);}
...
const char*_tmpD2F;Cyc_Tcutil_failure_reason=((_tmpD2F="(different bitfield widths on member)",
_tag_dyneither(_tmpD2F,sizeof(char),38)));}(int)_throw((void*)Cyc_Tcutil_Unify);}}
if(_tmp2EF == 0  && _tmp2EC == 0)return;Cyc_Tcutil_t1_failure=t1;Cyc_Tcutil_t2_failure=
t2;{const char*_tmpD30;Cyc_Tcutil_failure_reason=((_tmpD30="(different number of members)",
_tag_dyneither(_tmpD30,sizeof(char),30)));}goto _LL218;_LL23D: _tmp2F0=_tmp26E.f1;
...
19)goto _LL251;_LL250: if(Cyc_Tcutil_unify_effect(t1,t2))return;{const char*_tmpD31;
Cyc_Tcutil_failure_reason=((_tmpD31="(effects don't unify)",_tag_dyneither(
_tmpD31,sizeof(char),22)));}goto _LL218;_LL251:;_LL252: goto _LL218;_LL218:;}(int)
...
_tmp376.Forward_constr).tag != 1)goto _LL271;_LL277: {const char*_tmpD34;void*
_tmpD33;(_tmpD33=0,Cyc_Tcutil_impos(((_tmpD34="unify_conref: forward after compress(2)",
_tag_dyneither(_tmpD34,sizeof(char),40))),_tag_dyneither(_tmpD33,sizeof(void*),0)));}
_LL271:;}_LL26F: if((_tmp374.Forward_constr).tag != 1)goto _LL26A;_LL270: {const
char*_tmpD37;void*_tmpD36;(_tmpD36=0,Cyc_Tcutil_impos(((_tmpD37="unify_conref: forward after compress",
_tag_dyneither(_tmpD37,sizeof(char),37))),_tag_dyneither(_tmpD36,sizeof(void*),0)));}
...
return _tmp38B;{struct _tuple0 _tmpD38;struct _tuple0 _tmp38D=(_tmpD38.f1=t2,((
_tmpD38.f2=t1,_tmpD38)));void*_tmp38E;void*_tmp38F;void*_tmp390;struct Cyc_Absyn_Tvar*
...
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpD3B="typecmp: can only compare closed types",
_tag_dyneither(_tmpD3B,sizeof(char),39))),_tag_dyneither(_tmpD3A,sizeof(void*),0)));}
...
char*_tmpD3E;void*_tmpD3D;(_tmpD3D=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpD3E="missing expression in array index",
_tag_dyneither(_tmpD3E,sizeof(char),34))),_tag_dyneither(_tmpD3D,sizeof(void*),0)));}
...
_tmp3FA=_tmp3F3.rgn_po;_tmp3FB=_tmp3F3.attributes;_LL2C7: {const char*_tmpD41;
void*_tmpD40;(_tmpD40=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))
Cyc_Tcutil_impos)(((_tmpD41="typecmp: function types not handled",_tag_dyneither(
_tmpD41,sizeof(char),36))),_tag_dyneither(_tmpD40,sizeof(void*),0)));}_LL2C8:
...
_LL2DF: {const char*_tmpD44;void*_tmpD43;(_tmpD43=0,((int(*)(struct _dyneither_ptr
fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpD44="typecmp: effects not handled",
_tag_dyneither(_tmpD44,sizeof(char),29))),_tag_dyneither(_tmpD43,sizeof(void*),0)));}
_LL2E0:;_LL2E1: {const char*_tmpD47;void*_tmpD46;(_tmpD46=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpD47="Unmatched case in typecmp",
_tag_dyneither(_tmpD47,sizeof(char),26))),_tag_dyneither(_tmpD46,sizeof(void*),0)));}
...
t1);t2=Cyc_Tcutil_compress(t2);{struct _tuple0 _tmpD48;struct _tuple0 _tmp43E=(
_tmpD48.f1=t1,((_tmpD48.f2=t2,_tmpD48)));void*_tmp43F;int _tmp440;void*_tmp441;
...
max_arith_type->v)){struct Cyc_Core_Opt*_tmpD49;max_arith_type=((_tmpD49=
_region_malloc(_tmp47B,sizeof(*_tmpD49)),((_tmpD49->v=(void*)t1,_tmpD49))));}}}}
...
te,(struct Cyc_Absyn_Exp*)el->hd,t)){{const char*_tmpD4E;void*_tmpD4D[2];struct Cyc_String_pa_struct
_tmpD4C;struct Cyc_String_pa_struct _tmpD4B;(_tmpD4B.tag=0,((_tmpD4B.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)((struct Cyc_Core_Opt*)
_check_null(((struct Cyc_Absyn_Exp*)el->hd)->topt))->v)),((_tmpD4C.tag=0,((
_tmpD4C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((
_tmpD4D[0]=& _tmpD4C,((_tmpD4D[1]=& _tmpD4B,Cyc_Tcutil_terr(((struct Cyc_Absyn_Exp*)
el->hd)->loc,((_tmpD4E="type mismatch: expecting %s but found %s",_tag_dyneither(
_tmpD4E,sizeof(char),41))),_tag_dyneither(_tmpD4D,sizeof(void*),2)))))))))))));}
...
char*_tmpD51;void*_tmpD50;(_tmpD50=0,Cyc_Tcutil_warn(e->loc,((_tmpD51="integral size mismatch; conversion supplied",
_tag_dyneither(_tmpD51,sizeof(char),44))),_tag_dyneither(_tmpD50,sizeof(void*),0)));}
...
Cyc_Absyn_sint_typ)){const char*_tmpD54;void*_tmpD53;(_tmpD53=0,Cyc_Tcutil_warn(e->loc,((
_tmpD54="integral size mismatch; conversion supplied",_tag_dyneither(_tmpD54,
sizeof(char),44))),_tag_dyneither(_tmpD53,sizeof(void*),0)));}Cyc_Tcutil_unchecked_cast(
...
t1);t2=Cyc_Tcutil_compress(t2);{struct _tuple0 _tmpD55;struct _tuple0 _tmp488=(
_tmpD55.f1=t1,((_tmpD55.f2=t2,_tmpD55)));void*_tmp489;struct Cyc_Absyn_PtrInfo
...
_LL33E: okay=!_tmp4CA;goto _LL33C;_LL33F:;_LL340: {const char*_tmpD58;void*_tmpD57;(
_tmpD57=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpD58="silent_castable conref not eq",_tag_dyneither(_tmpD58,sizeof(char),30))),
_tag_dyneither(_tmpD57,sizeof(void*),0)));}_LL33C:;}if(!Cyc_Tcutil_unify_conrefs(
Cyc_Tcutil_unify_it_bounds,(_tmp48A.ptr_atts).bounds,(_tmp48C.ptr_atts).bounds)){
struct _tuple13 _tmpD59;struct _tuple13 _tmp4CE=(_tmpD59.f1=(Cyc_Absyn_compress_conref((
_tmp48A.ptr_atts).bounds))->v,((_tmpD59.f2=(Cyc_Absyn_compress_conref((_tmp48C.ptr_atts).bounds))->v,
_tmpD59)));union Cyc_Absyn_Constraint_union _tmp4CF;void*_tmp4D0;union Cyc_Absyn_Constraint_union
...
_tmp4D1.Eq_constr).f1;_LL343:{struct _tuple0 _tmpD5A;struct _tuple0 _tmp4D5=(_tmpD5A.f1=
_tmp4D0,((_tmpD5A.f2=_tmp4D2,_tmpD5A)));void*_tmp4D6;void*_tmp4D7;void*_tmp4D8;
...
const char*_tmpD5D;void*_tmpD5C;(_tmpD5C=0,Cyc_Tcutil_warn(loc,((_tmpD5D="implicit cast to shorter array",
_tag_dyneither(_tmpD5D,sizeof(char),31))),_tag_dyneither(_tmpD5C,sizeof(void*),0)));}
...
!= 2)goto _LL346;_LL345: okay=0;goto _LL341;_LL346:;_LL347: {const char*_tmpD60;void*
_tmpD5F;(_tmpD5F=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpD60="silent_castable conrefs didn't unify",_tag_dyneither(_tmpD60,sizeof(
char),37))),_tag_dyneither(_tmpD5F,sizeof(void*),0)));}_LL341:;}okay=okay  && Cyc_Tcutil_unify((
...
is_dyneither_ptr){void*_tmp4EC=Cyc_Tcutil_compress(t);struct Cyc_Absyn_PtrInfo
_tmp4ED;struct Cyc_Absyn_PtrAtts _tmp4EE;struct Cyc_Absyn_Conref*_tmp4EF;_LL35C: if(
_tmp4EC <= (void*)4)goto _LL35E;if(*((int*)_tmp4EC)!= 4)goto _LL35E;_tmp4ED=((
struct Cyc_Absyn_PointerType_struct*)_tmp4EC)->f1;_tmp4EE=_tmp4ED.ptr_atts;
_tmp4EF=_tmp4EE.bounds;_LL35D:*is_dyneither_ptr=Cyc_Absyn_conref_def(Cyc_Absyn_bounds_one,
_tmp4EF)== (void*)0;return 1;_LL35E:;_LL35F: return Cyc_Tcutil_typ_kind(t)== (void*)
...
k);struct Cyc_Core_Opt*Cyc_Tcutil_kind_to_opt(void*k){void*_tmp4FB=k;_LL36E: if((
int)_tmp4FB != 0)goto _LL370;_LL36F: return(struct Cyc_Core_Opt*)& Cyc_Tcutil_ak;
_LL370: if((int)_tmp4FB != 1)goto _LL372;_LL371: return(struct Cyc_Core_Opt*)& Cyc_Tcutil_mk;
_LL372: if((int)_tmp4FB != 2)goto _LL374;_LL373: return(struct Cyc_Core_Opt*)& Cyc_Tcutil_bk;
_LL374: if((int)_tmp4FB != 3)goto _LL376;_LL375: return(struct Cyc_Core_Opt*)& Cyc_Tcutil_rk;
_LL376: if((int)_tmp4FB != 4)goto _LL378;_LL377: return(struct Cyc_Core_Opt*)& Cyc_Tcutil_urk;
_LL378: if((int)_tmp4FB != 5)goto _LL37A;_LL379: return(struct Cyc_Core_Opt*)& Cyc_Tcutil_trk;
_LL37A: if((int)_tmp4FB != 6)goto _LL37C;_LL37B: return(struct Cyc_Core_Opt*)& Cyc_Tcutil_ek;
_LL37C: if((int)_tmp4FB != 7)goto _LL36D;_LL37D: return(struct Cyc_Core_Opt*)& Cyc_Tcutil_ik;
...
void*)& tb_v;static void*eb=(void*)& eb_v;static void*ib=(void*)& ib_v;void*_tmp4FC=k;
_LL37F: if((int)_tmp4FC != 0)goto _LL381;_LL380: return& ab;_LL381: if((int)_tmp4FC != 
1)goto _LL383;_LL382: return& mb;_LL383: if((int)_tmp4FC != 2)goto _LL385;_LL384:
return& bb;_LL385: if((int)_tmp4FC != 3)goto _LL387;_LL386: return& rb;_LL387: if((int)
_tmp4FC != 4)goto _LL389;_LL388: return& ub;_LL389: if((int)_tmp4FC != 5)goto _LL38B;
_LL38A: return& tb;_LL38B: if((int)_tmp4FC != 6)goto _LL38D;_LL38C: return& eb;_LL38D:
if((int)_tmp4FC != 7)goto _LL37E;_LL38E: return& ib;_LL37E:;}void*Cyc_Tcutil_kind_to_bound(
...
t2) && Cyc_Tcutil_is_zero(e1)){{struct Cyc_Absyn_Const_e_struct _tmpD66;union Cyc_Absyn_Cnst_union
_tmpD65;struct Cyc_Absyn_Const_e_struct*_tmpD64;(void*)(e1->r=(void*)((void*)((
_tmpD64=_cycalloc(sizeof(*_tmpD64)),((_tmpD64[0]=((_tmpD66.tag=0,((_tmpD66.f1=(
union Cyc_Absyn_Cnst_union)(((_tmpD65.Null_c).tag=6,_tmpD65)),_tmpD66)))),_tmpD64))))));}{
struct Cyc_Core_Opt*_tmp508=Cyc_Tcenv_lookup_opt_type_vars(te);struct Cyc_Absyn_PointerType_struct
_tmpD70;struct Cyc_Absyn_PtrAtts _tmpD6F;struct Cyc_Absyn_PtrInfo _tmpD6E;struct Cyc_Absyn_PointerType_struct*
_tmpD6D;struct Cyc_Absyn_PointerType_struct*_tmp509=(_tmpD6D=_cycalloc(sizeof(*
_tmpD6D)),((_tmpD6D[0]=((_tmpD70.tag=4,((_tmpD70.f1=((_tmpD6E.elt_typ=(void*)Cyc_Absyn_new_evar((
struct Cyc_Core_Opt*)& Cyc_Tcutil_ak,_tmp508),((_tmpD6E.elt_tq=Cyc_Absyn_empty_tqual(
0),((_tmpD6E.ptr_atts=((_tmpD6F.rgn=(void*)Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)&
Cyc_Tcutil_trk,_tmp508),((_tmpD6F.nullable=Cyc_Absyn_true_conref,((_tmpD6F.bounds=
Cyc_Absyn_empty_conref(),((_tmpD6F.zero_term=((struct Cyc_Absyn_Conref*(*)())Cyc_Absyn_empty_conref)(),((
_tmpD6F.ptrloc=0,_tmpD6F)))))))))),_tmpD6E)))))),_tmpD70)))),_tmpD6D)));(void*)(((
struct Cyc_Core_Opt*)_check_null(e1->topt))->v=(void*)((void*)_tmp509));return Cyc_Tcutil_coerce_arg(
te,e1,t2);}}return 0;}struct _dyneither_ptr Cyc_Tcutil_coercion2string(void*c);
struct _dyneither_ptr Cyc_Tcutil_coercion2string(void*c){void*_tmp50E=c;_LL390: if((
int)_tmp50E != 0)goto _LL392;_LL391: {const char*_tmpD71;return(_tmpD71="unknown",
_tag_dyneither(_tmpD71,sizeof(char),8));}_LL392: if((int)_tmp50E != 1)goto _LL394;
_LL393: {const char*_tmpD72;return(_tmpD72="no coercion",_tag_dyneither(_tmpD72,
sizeof(char),12));}_LL394: if((int)_tmp50E != 2)goto _LL396;_LL395: {const char*
_tmpD73;return(_tmpD73="null check",_tag_dyneither(_tmpD73,sizeof(char),11));}
_LL396: if((int)_tmp50E != 3)goto _LL38F;_LL397: {const char*_tmpD74;return(_tmpD74="other coercion",
_tag_dyneither(_tmpD74,sizeof(char),15));}_LL38F:;}int Cyc_Tcutil_coerce_arg(
...
t1)){if(Cyc_Tcutil_will_lose_precision(t1,t2)){const char*_tmpD79;void*_tmpD78[2];
struct Cyc_String_pa_struct _tmpD77;struct Cyc_String_pa_struct _tmpD76;(_tmpD76.tag=
0,((_tmpD76.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t2)),((_tmpD77.tag=0,((_tmpD77.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(t1)),((_tmpD78[0]=& _tmpD77,((_tmpD78[1]=& _tmpD76,Cyc_Tcutil_warn(
e->loc,((_tmpD79="integral size mismatch; %s -> %s conversion supplied",
_tag_dyneither(_tmpD79,sizeof(char),53))),_tag_dyneither(_tmpD78,sizeof(void*),2)))))))))))));}
...
char*_tmpD7E;void*_tmpD7D[2];struct Cyc_String_pa_struct _tmpD7C;struct Cyc_String_pa_struct
_tmpD7B;(_tmpD7B.tag=0,((_tmpD7B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(t2)),((_tmpD7C.tag=0,((_tmpD7C.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string(t1)),((_tmpD7D[0]=& _tmpD7C,((_tmpD7D[
1]=& _tmpD7B,Cyc_Tcutil_warn(e->loc,((_tmpD7E="implicit cast from %s to %s",
_tag_dyneither(_tmpD7E,sizeof(char),28))),_tag_dyneither(_tmpD7D,sizeof(void*),2)))))))))))));}
...
void*t);int Cyc_Tcutil_coerceable(void*t){void*_tmp51B=Cyc_Tcutil_compress(t);
_LL399: if(_tmp51B <= (void*)4)goto _LL39B;if(*((int*)_tmp51B)!= 5)goto _LL39B;
_LL39A: goto _LL39C;_LL39B: if((int)_tmp51B != 1)goto _LL39D;_LL39C: goto _LL39E;_LL39D:
if(_tmp51B <= (void*)4)goto _LL39F;if(*((int*)_tmp51B)!= 6)goto _LL39F;_LL39E:
...
struct _tuple9*env,struct Cyc_Absyn_Aggrfield*x){struct Cyc_List_List*_tmp51D;
struct _RegionHandle*_tmp51E;struct _tuple9 _tmp51C=*env;_tmp51D=_tmp51C.f1;_tmp51E=
_tmp51C.f2;{struct _tuple5*_tmpD7F;return(_tmpD7F=_region_malloc(_tmp51E,sizeof(*
_tmpD7F)),((_tmpD7F->f1=x->tq,((_tmpD7F->f2=Cyc_Tcutil_rsubstitute(_tmp51E,
_tmp51D,(void*)x->type),_tmpD7F)))));}}static struct _tuple5*Cyc_Tcutil_rcopy_tqt(
...
struct _tuple5 _tmp520=*x;_tmp521=_tmp520.f1;_tmp522=_tmp520.f2;{struct _tuple5*
_tmpD80;return(_tmpD80=_region_malloc(r,sizeof(*_tmpD80)),((_tmpD80->f1=_tmp521,((
_tmpD80->f2=_tmp522,_tmpD80)))));}}static struct Cyc_List_List*Cyc_Tcutil_flatten_typ(
...
Cyc_Tcutil_compress(t1);{void*_tmp524=t1;struct Cyc_List_List*_tmp525;struct Cyc_Absyn_AggrInfo
_tmp526;union Cyc_Absyn_AggrInfoU_union _tmp527;struct Cyc_Absyn_Aggrdecl**_tmp528;
struct Cyc_Absyn_Aggrdecl*_tmp529;struct Cyc_List_List*_tmp52A;void*_tmp52B;struct
Cyc_List_List*_tmp52C;struct Cyc_Absyn_FnInfo _tmp52D;_LL3A2: if((int)_tmp524 != 0)
goto _LL3A4;_LL3A3: return 0;_LL3A4: if(_tmp524 <= (void*)4)goto _LL3AC;if(*((int*)
_tmp524)!= 9)goto _LL3A6;_tmp525=((struct Cyc_Absyn_TupleType_struct*)_tmp524)->f1;
...
x))Cyc_List_rmap_c)(r,Cyc_Tcutil_rcopy_tqt,r,_tmp525);_LL3A6: if(*((int*)_tmp524)
...
_check_null(_tmp529->impl))->rgn_po != 0){struct _tuple5*_tmpD83;struct Cyc_List_List*
_tmpD82;return(_tmpD82=_region_malloc(r,sizeof(*_tmpD82)),((_tmpD82->hd=((
_tmpD83=_region_malloc(r,sizeof(*_tmpD83)),((_tmpD83->f1=Cyc_Absyn_empty_tqual(0),((
_tmpD83->f2=t1,_tmpD83)))))),((_tmpD82->tl=0,_tmpD82)))));}{struct Cyc_List_List*
_tmp530=((struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,
struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rzip)(r,r,_tmp529->tvs,
_tmp52A);struct _tuple9 _tmpD84;struct _tuple9 env=(_tmpD84.f1=_tmp530,((_tmpD84.f2=
r,_tmpD84)));return((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple5*(*
...
_check_null(_tmp529->impl))->fields);}_LL3A8: if(*((int*)_tmp524)!= 11)goto _LL3AA;
_tmp52B=(void*)((struct Cyc_Absyn_AnonAggrType_struct*)_tmp524)->f1;if((int)
_tmp52B != 0)goto _LL3AA;_tmp52C=((struct Cyc_Absyn_AnonAggrType_struct*)_tmp524)->f2;
_LL3A9: {struct _tuple9 _tmpD85;struct _tuple9 env=(_tmpD85.f1=0,((_tmpD85.f2=r,
_tmpD85)));return((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple5*(*
f)(struct _tuple9*,struct Cyc_Absyn_Aggrfield*),struct _tuple9*env,struct Cyc_List_List*
x))Cyc_List_rmap_c)(r,Cyc_Tcutil_flatten_typ_f,& env,_tmp52C);}_LL3AA: if(*((int*)
_tmp524)!= 8)goto _LL3AC;_tmp52D=((struct Cyc_Absyn_FnType_struct*)_tmp524)->f1;
_LL3AB: {struct _tuple5*_tmpD88;struct Cyc_List_List*_tmpD87;return(_tmpD87=
_region_malloc(r,sizeof(*_tmpD87)),((_tmpD87->hd=((_tmpD88=_region_malloc(r,
sizeof(*_tmpD88)),((_tmpD88->f1=Cyc_Absyn_const_tqual(0),((_tmpD88->f2=t1,
_tmpD88)))))),((_tmpD87->tl=0,_tmpD87)))));}_LL3AC:;_LL3AD: {struct _tuple5*
_tmpD8B;struct Cyc_List_List*_tmpD8A;return(_tmpD8A=_region_malloc(r,sizeof(*
_tmpD8A)),((_tmpD8A->hd=((_tmpD8B=_region_malloc(r,sizeof(*_tmpD8B)),((_tmpD8B->f1=
Cyc_Absyn_empty_tqual(0),((_tmpD8B->f2=t1,_tmpD8B)))))),((_tmpD8A->tl=0,_tmpD8A)))));}
...
a2){{struct Cyc_List_List*t=a1;for(0;t != 0;t=t->tl){void*_tmp537=(void*)t->hd;
_LL3AF: if((int)_tmp537 != 16)goto _LL3B1;_LL3B0: goto _LL3B2;_LL3B1: if((int)_tmp537
!= 3)goto _LL3B3;_LL3B2: goto _LL3B4;_LL3B3: if(_tmp537 <= (void*)17)goto _LL3B5;if(*((
int*)_tmp537)!= 4)goto _LL3B5;_LL3B4: continue;_LL3B5:;_LL3B6: if(!Cyc_List_exists_c(
...
_tmpD8C;struct _tuple0 _tmp539=(_tmpD8C.f1=t1,((_tmpD8C.f2=t2,_tmpD8C)));void*
...
_tmp541,_tmp54A)){struct _tuple0 _tmpD8D;struct _tuple0 _tmp563=(_tmpD8D.f1=Cyc_Absyn_conref_val(
_tmp541),((_tmpD8D.f2=Cyc_Absyn_conref_val(_tmp54A),_tmpD8D)));void*_tmp564;void*
...
_tmp569,_tmp567))return 0;goto _LL3C0;_LL3C5:;_LL3C6: return 0;_LL3C0:;}{struct
_tuple0*_tmpD90;struct Cyc_List_List*_tmpD8F;return Cyc_Tcutil_ptrsubtype(te,((
_tmpD8F=_cycalloc(sizeof(*_tmpD8F)),((_tmpD8F->hd=((_tmpD90=_cycalloc(sizeof(*
_tmpD90)),((_tmpD90->f1=t1,((_tmpD90->f2=t2,_tmpD90)))))),((_tmpD8F->tl=assume,
_tmpD8F)))))),_tmp53C,_tmp545);}_LL3BA: _tmp54C=_tmp539.f1;if(_tmp54C <= (void*)4)
goto _LL3BC;if(*((int*)_tmp54C)!= 2)goto _LL3BC;_tmp54D=((struct Cyc_Absyn_TunionType_struct*)
_tmp54C)->f1;_tmp54E=_tmp54D.tunion_info;if((((((struct Cyc_Absyn_TunionType_struct*)
_tmp54C)->f1).tunion_info).KnownTunion).tag != 1)goto _LL3BC;_tmp54F=(_tmp54E.KnownTunion).f1;
_tmp550=*_tmp54F;_tmp551=_tmp54D.targs;_tmp552=_tmp54D.rgn;if(_tmp552 == 0)goto
_LL3BC;_tmp553=*_tmp552;_tmp554=(void*)_tmp553.v;_tmp555=_tmp539.f2;if(_tmp555 <= (
void*)4)goto _LL3BC;if(*((int*)_tmp555)!= 2)goto _LL3BC;_tmp556=((struct Cyc_Absyn_TunionType_struct*)
_tmp555)->f1;_tmp557=_tmp556.tunion_info;if((((((struct Cyc_Absyn_TunionType_struct*)
_tmp555)->f1).tunion_info).KnownTunion).tag != 1)goto _LL3BC;_tmp558=(_tmp557.KnownTunion).f1;
_tmp559=*_tmp558;_tmp55A=_tmp556.targs;_tmp55B=_tmp556.rgn;if(_tmp55B == 0)goto
_LL3BC;_tmp55C=*_tmp55B;_tmp55D=(void*)_tmp55C.v;_LL3BB: if(_tmp550 != _tmp559  || 
!Cyc_Tcenv_region_outlives(te,_tmp554,_tmp55D))return 0;for(0;_tmp551 != 0  && 
_tmp55A != 0;(_tmp551=_tmp551->tl,_tmp55A=_tmp55A->tl)){if(!Cyc_Tcutil_unify((
void*)_tmp551->hd,(void*)_tmp55A->hd))return 0;}if(_tmp551 != 0  || _tmp55A != 0)
return 0;return 1;_LL3BC: _tmp55E=_tmp539.f1;if(_tmp55E <= (void*)4)goto _LL3BE;if(*((
int*)_tmp55E)!= 8)goto _LL3BE;_tmp55F=((struct Cyc_Absyn_FnType_struct*)_tmp55E)->f1;
_tmp560=_tmp539.f2;if(_tmp560 <= (void*)4)goto _LL3BE;if(*((int*)_tmp560)!= 8)goto
_LL3BE;_tmp561=((struct Cyc_Absyn_FnType_struct*)_tmp560)->f1;_LL3BD: if(_tmp55F.tvars
!= 0  || _tmp561.tvars != 0){struct Cyc_List_List*_tmp56C=_tmp55F.tvars;struct Cyc_List_List*
_tmp56D=_tmp561.tvars;if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmp56C)!= ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp56D))return 0;{
struct _RegionHandle*_tmp56E=Cyc_Tcenv_get_fnrgn(te);struct Cyc_List_List*inst=0;
while(_tmp56C != 0){if(Cyc_Tcutil_tvar_kind((struct Cyc_Absyn_Tvar*)_tmp56C->hd)!= 
Cyc_Tcutil_tvar_kind((struct Cyc_Absyn_Tvar*)((struct Cyc_List_List*)_check_null(
_tmp56D))->hd))return 0;{struct _tuple8*_tmpD9A;struct Cyc_Absyn_VarType_struct
_tmpD99;struct Cyc_Absyn_VarType_struct*_tmpD98;struct Cyc_List_List*_tmpD97;inst=((
_tmpD97=_region_malloc(_tmp56E,sizeof(*_tmpD97)),((_tmpD97->hd=((_tmpD9A=
_region_malloc(_tmp56E,sizeof(*_tmpD9A)),((_tmpD9A->f1=(struct Cyc_Absyn_Tvar*)
_tmp56D->hd,((_tmpD9A->f2=(void*)((_tmpD98=_cycalloc(sizeof(*_tmpD98)),((_tmpD98[
0]=((_tmpD99.tag=1,((_tmpD99.f1=(struct Cyc_Absyn_Tvar*)_tmp56C->hd,_tmpD99)))),
_tmpD98)))),_tmpD9A)))))),((_tmpD97->tl=inst,_tmpD97))))));}_tmp56C=_tmp56C->tl;
_tmp56D=_tmp56D->tl;}if(inst != 0){_tmp55F.tvars=0;_tmp561.tvars=0;{struct Cyc_Absyn_FnType_struct
_tmpDA0;struct Cyc_Absyn_FnType_struct*_tmpD9F;struct Cyc_Absyn_FnType_struct
_tmpD9D;struct Cyc_Absyn_FnType_struct*_tmpD9C;return Cyc_Tcutil_subtype(te,assume,(
void*)((_tmpD9C=_cycalloc(sizeof(*_tmpD9C)),((_tmpD9C[0]=((_tmpD9D.tag=8,((
_tmpD9D.f1=_tmp55F,_tmpD9D)))),_tmpD9C)))),(void*)((_tmpD9F=_cycalloc(sizeof(*
_tmpD9F)),((_tmpD9F[0]=((_tmpDA0.tag=8,((_tmpDA0.f1=_tmp561,_tmpDA0)))),_tmpD9F)))));}}}}
if(!Cyc_Tcutil_subtype(te,assume,(void*)_tmp55F.ret_typ,(void*)_tmp561.ret_typ))
return 0;{struct Cyc_List_List*_tmp577=_tmp55F.args;struct Cyc_List_List*_tmp578=
_tmp561.args;if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp577)!= ((
int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp578))return 0;for(0;_tmp577 != 
0;(_tmp577=_tmp577->tl,_tmp578=_tmp578->tl)){struct Cyc_Absyn_Tqual _tmp57A;void*
_tmp57B;struct _tuple3 _tmp579=*((struct _tuple3*)_tmp577->hd);_tmp57A=_tmp579.f2;
_tmp57B=_tmp579.f3;{struct Cyc_Absyn_Tqual _tmp57D;void*_tmp57E;struct _tuple3
_tmp57C=*((struct _tuple3*)((struct Cyc_List_List*)_check_null(_tmp578))->hd);
_tmp57D=_tmp57C.f2;_tmp57E=_tmp57C.f3;if(_tmp57D.real_const  && !_tmp57A.real_const
 || !Cyc_Tcutil_subtype(te,assume,_tmp57E,_tmp57B))return 0;}}if(_tmp55F.c_varargs
!= _tmp561.c_varargs)return 0;if(_tmp55F.cyc_varargs != 0  && _tmp561.cyc_varargs != 
0){struct Cyc_Absyn_VarargInfo _tmp57F=*_tmp55F.cyc_varargs;struct Cyc_Absyn_VarargInfo
_tmp580=*_tmp561.cyc_varargs;if((_tmp580.tq).real_const  && !(_tmp57F.tq).real_const
 || !Cyc_Tcutil_subtype(te,assume,(void*)_tmp580.type,(void*)_tmp57F.type))
return 0;}else{if(_tmp55F.cyc_varargs != 0  || _tmp561.cyc_varargs != 0)return 0;}if(
!Cyc_Tcutil_subset_effect(1,(void*)((struct Cyc_Core_Opt*)_check_null(_tmp55F.effect))->v,(
void*)((struct Cyc_Core_Opt*)_check_null(_tmp561.effect))->v))return 0;if(!Cyc_Tcutil_sub_rgnpo(
_tmp55F.rgn_po,_tmp561.rgn_po))return 0;if(!Cyc_Tcutil_sub_attributes(_tmp55F.attributes,
_tmp561.attributes))return 0;return 1;}_LL3BE:;_LL3BF: return 0;_LL3B7:;}}static int
Cyc_Tcutil_isomorphic(void*t1,void*t2);static int Cyc_Tcutil_isomorphic(void*t1,
void*t2){struct _tuple0 _tmpDA1;struct _tuple0 _tmp582=(_tmpDA1.f1=Cyc_Tcutil_compress(
t1),((_tmpDA1.f2=Cyc_Tcutil_compress(t2),_tmpDA1)));void*_tmp583;void*_tmp584;
void*_tmp585;void*_tmp586;_LL3C8: _tmp583=_tmp582.f1;if(_tmp583 <= (void*)4)goto
_LL3CA;if(*((int*)_tmp583)!= 5)goto _LL3CA;_tmp584=(void*)((struct Cyc_Absyn_IntType_struct*)
_tmp583)->f2;_tmp585=_tmp582.f2;if(_tmp585 <= (void*)4)goto _LL3CA;if(*((int*)
_tmp585)!= 5)goto _LL3CA;_tmp586=(void*)((struct Cyc_Absyn_IntType_struct*)_tmp585)->f2;
_LL3C9: return(_tmp584 == _tmp586  || _tmp584 == (void*)2  && _tmp586 == (void*)3) || 
_tmp584 == (void*)3  && _tmp586 == (void*)2;_LL3CA:;_LL3CB: return 0;_LL3C7:;}static
...
assume,void*t1,void*t2){struct _RegionHandle*_tmp587=Cyc_Tcenv_get_fnrgn(te);
struct Cyc_List_List*tqs1=Cyc_Tcutil_flatten_typ(_tmp587,te,t1);struct Cyc_List_List*
tqs2=Cyc_Tcutil_flatten_typ(_tmp587,te,t2);for(0;tqs2 != 0;(tqs2=tqs2->tl,tqs1=
tqs1->tl)){if(tqs1 == 0)return 0;{struct _tuple5 _tmp589;struct Cyc_Absyn_Tqual
_tmp58A;void*_tmp58B;struct _tuple5*_tmp588=(struct _tuple5*)tqs1->hd;_tmp589=*
_tmp588;_tmp58A=_tmp589.f1;_tmp58B=_tmp589.f2;{struct _tuple5 _tmp58D;struct Cyc_Absyn_Tqual
_tmp58E;void*_tmp58F;struct _tuple5*_tmp58C=(struct _tuple5*)tqs2->hd;_tmp58D=*
_tmp58C;_tmp58E=_tmp58D.f1;_tmp58F=_tmp58D.f2;if(_tmp58E.real_const  && Cyc_Tcutil_subtype(
te,assume,_tmp58B,_tmp58F))continue;else{if(Cyc_Tcutil_unify(_tmp58B,_tmp58F))
continue;else{if(Cyc_Tcutil_isomorphic(_tmp58B,_tmp58F))continue;else{return 0;}}}}}}
...
_tmp5AD=_tmp5A9.zero_term;_LL3EB: {void*coercion=(void*)3;struct _tuple0*_tmpDA4;
struct Cyc_List_List*_tmpDA3;struct Cyc_List_List*_tmp5AE=(_tmpDA3=_cycalloc(
sizeof(*_tmpDA3)),((_tmpDA3->hd=((_tmpDA4=_cycalloc(sizeof(*_tmpDA4)),((_tmpDA4->f1=
t1,((_tmpDA4->f2=t2,_tmpDA4)))))),((_tmpDA3->tl=0,_tmpDA3)))));int _tmp5AF=Cyc_Tcutil_ptrsubtype(
te,_tmp5AE,_tmp597,_tmp5A7) && (!_tmp598.real_const  || _tmp5A8.real_const);Cyc_Tcutil_t1_failure=
...
_tuple0 _tmpDA5;struct _tuple0 _tmp5B2=(_tmpDA5.f1=Cyc_Absyn_conref_val(_tmp59C),((
_tmpDA5.f2=Cyc_Absyn_conref_val(_tmp5AC),_tmpDA5)));void*_tmp5B3;struct Cyc_Absyn_Exp*
...
struct Cyc_Absyn_Cast_e_struct _tmpDA8;struct Cyc_Absyn_Cast_e_struct*_tmpDA7;(void*)(
e->r=(void*)((void*)((_tmpDA7=_cycalloc(sizeof(*_tmpDA7)),((_tmpDA7[0]=((_tmpDA8.tag=
15,((_tmpDA8.f1=(void*)t,((_tmpDA8.f2=_tmp5C3,((_tmpDA8.f3=0,((_tmpDA8.f4=(void*)
c,_tmpDA8)))))))))),_tmpDA7))))));}{struct Cyc_Core_Opt*_tmpDA9;e->topt=((_tmpDA9=
_cycalloc(sizeof(*_tmpDA9)),((_tmpDA9->v=(void*)t,_tmpDA9))));}}}int Cyc_Tcutil_is_integral(
struct Cyc_Absyn_Exp*e);int Cyc_Tcutil_is_integral(struct Cyc_Absyn_Exp*e){void*
_tmp5C7=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v);
...
e))return 1;{void*_tmp5C8=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
_check_null(e->topt))->v);_LL410: if((int)_tmp5C8 != 1)goto _LL412;_LL411: goto
_LL413;_LL412: if(_tmp5C8 <= (void*)4)goto _LL414;if(*((int*)_tmp5C8)!= 6)goto
_LL414;_LL413: return 1;_LL414:;_LL415: return 0;_LL40F:;}}int Cyc_Tcutil_is_function_type(
void*t);int Cyc_Tcutil_is_function_type(void*t){void*_tmp5C9=Cyc_Tcutil_compress(
t);_LL417: if(_tmp5C9 <= (void*)4)goto _LL419;if(*((int*)_tmp5C9)!= 8)goto _LL419;
_LL418: return 1;_LL419:;_LL41A: return 0;_LL416:;}void*Cyc_Tcutil_max_arithmetic_type(
void*t1,void*t2);void*Cyc_Tcutil_max_arithmetic_type(void*t1,void*t2){struct
_tuple0 _tmpDAA;struct _tuple0 _tmp5CB=(_tmpDAA.f1=t1,((_tmpDAA.f2=t2,_tmpDAA)));
void*_tmp5CC;int _tmp5CD;void*_tmp5CE;int _tmp5CF;void*_tmp5D0;void*_tmp5D1;void*
...
e){void*_tmp5EE=(void*)e->r;struct Cyc_Core_Opt*_tmp5EF;_LL43D: if(*((int*)_tmp5EE)
!= 4)goto _LL43F;_tmp5EF=((struct Cyc_Absyn_AssignOp_e_struct*)_tmp5EE)->f2;if(
_tmp5EF != 0)goto _LL43F;_LL43E:{const char*_tmpDAD;void*_tmpDAC;(_tmpDAC=0,Cyc_Tcutil_warn(
e->loc,((_tmpDAD="assignment in test",_tag_dyneither(_tmpDAD,sizeof(char),19))),
_tag_dyneither(_tmpDAC,sizeof(void*),0)));}goto _LL43C;_LL43F:;_LL440: goto _LL43C;
_LL43C:;}static int Cyc_Tcutil_constrain_kinds(void*c1,void*c2);static int Cyc_Tcutil_constrain_kinds(
void*c1,void*c2){c1=Cyc_Absyn_compress_kb(c1);c2=Cyc_Absyn_compress_kb(c2);{
struct _tuple0 _tmpDAE;struct _tuple0 _tmp5F3=(_tmpDAE.f1=c1,((_tmpDAE.f2=c2,_tmpDAE)));
void*_tmp5F4;void*_tmp5F5;void*_tmp5F6;void*_tmp5F7;void*_tmp5F8;struct Cyc_Core_Opt*
_tmp5F9;struct Cyc_Core_Opt**_tmp5FA;void*_tmp5FB;struct Cyc_Core_Opt*_tmp5FC;
struct Cyc_Core_Opt**_tmp5FD;void*_tmp5FE;struct Cyc_Core_Opt*_tmp5FF;struct Cyc_Core_Opt**
_tmp600;void*_tmp601;void*_tmp602;void*_tmp603;void*_tmp604;void*_tmp605;void*
_tmp606;struct Cyc_Core_Opt*_tmp607;struct Cyc_Core_Opt**_tmp608;void*_tmp609;void*
_tmp60A;struct Cyc_Core_Opt*_tmp60B;struct Cyc_Core_Opt**_tmp60C;void*_tmp60D;void*
_tmp60E;struct Cyc_Core_Opt*_tmp60F;struct Cyc_Core_Opt**_tmp610;void*_tmp611;
_LL442: _tmp5F4=_tmp5F3.f1;if(*((int*)_tmp5F4)!= 0)goto _LL444;_tmp5F5=(void*)((
struct Cyc_Absyn_Eq_kb_struct*)_tmp5F4)->f1;_tmp5F6=_tmp5F3.f2;if(*((int*)_tmp5F6)
!= 0)goto _LL444;_tmp5F7=(void*)((struct Cyc_Absyn_Eq_kb_struct*)_tmp5F6)->f1;
_LL443: return _tmp5F5 == _tmp5F7;_LL444: _tmp5F8=_tmp5F3.f2;if(*((int*)_tmp5F8)!= 1)
goto _LL446;_tmp5F9=((struct Cyc_Absyn_Unknown_kb_struct*)_tmp5F8)->f1;_tmp5FA=(
struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_struct*)_tmp5F8)->f1;_LL445:{
struct Cyc_Core_Opt*_tmpDAF;*_tmp5FA=((_tmpDAF=_cycalloc(sizeof(*_tmpDAF)),((
_tmpDAF->v=(void*)c1,_tmpDAF))));}return 1;_LL446: _tmp5FB=_tmp5F3.f1;if(*((int*)
_tmp5FB)!= 1)goto _LL448;_tmp5FC=((struct Cyc_Absyn_Unknown_kb_struct*)_tmp5FB)->f1;
_tmp5FD=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_struct*)_tmp5FB)->f1;
_LL447:{struct Cyc_Core_Opt*_tmpDB0;*_tmp5FD=((_tmpDB0=_cycalloc(sizeof(*_tmpDB0)),((
_tmpDB0->v=(void*)c2,_tmpDB0))));}return 1;_LL448: _tmp5FE=_tmp5F3.f1;if(*((int*)
_tmp5FE)!= 2)goto _LL44A;_tmp5FF=((struct Cyc_Absyn_Less_kb_struct*)_tmp5FE)->f1;
_tmp600=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_struct*)_tmp5FE)->f1;
_tmp601=(void*)((struct Cyc_Absyn_Less_kb_struct*)_tmp5FE)->f2;_tmp602=_tmp5F3.f2;
if(*((int*)_tmp602)!= 0)goto _LL44A;_tmp603=(void*)((struct Cyc_Absyn_Eq_kb_struct*)
_tmp602)->f1;_LL449: if(Cyc_Tcutil_kind_leq(_tmp603,_tmp601)){{struct Cyc_Core_Opt*
_tmpDB1;*_tmp600=((_tmpDB1=_cycalloc(sizeof(*_tmpDB1)),((_tmpDB1->v=(void*)c2,
_tmpDB1))));}return 1;}else{return 0;}_LL44A: _tmp604=_tmp5F3.f1;if(*((int*)_tmp604)
!= 0)goto _LL44C;_tmp605=(void*)((struct Cyc_Absyn_Eq_kb_struct*)_tmp604)->f1;
_tmp606=_tmp5F3.f2;if(*((int*)_tmp606)!= 2)goto _LL44C;_tmp607=((struct Cyc_Absyn_Less_kb_struct*)
...
_LL44B: if(Cyc_Tcutil_kind_leq(_tmp605,_tmp609)){{struct Cyc_Core_Opt*_tmpDB2;*
_tmp608=((_tmpDB2=_cycalloc(sizeof(*_tmpDB2)),((_tmpDB2->v=(void*)c1,_tmpDB2))));}
return 1;}else{return 0;}_LL44C: _tmp60A=_tmp5F3.f1;if(*((int*)_tmp60A)!= 2)goto
_LL441;_tmp60B=((struct Cyc_Absyn_Less_kb_struct*)_tmp60A)->f1;_tmp60C=(struct Cyc_Core_Opt**)&((
...
_tmp60E)->f2;_LL44D: if(Cyc_Tcutil_kind_leq(_tmp60D,_tmp611)){{struct Cyc_Core_Opt*
_tmpDB3;*_tmp610=((_tmpDB3=_cycalloc(sizeof(*_tmpDB3)),((_tmpDB3->v=(void*)c1,
_tmpDB3))));}return 1;}else{if(Cyc_Tcutil_kind_leq(_tmp611,_tmp60D)){{struct Cyc_Core_Opt*
_tmpDB4;*_tmp60C=((_tmpDB4=_cycalloc(sizeof(*_tmpDB4)),((_tmpDB4->v=(void*)c2,
_tmpDB4))));}return 1;}else{return 0;}}_LL441:;}}static int Cyc_Tcutil_tvar_id_counter=
...
++;const char*_tmpDB8;void*_tmpDB7[1];struct Cyc_Int_pa_struct _tmpDB6;struct
_dyneither_ptr s=(struct _dyneither_ptr)((_tmpDB6.tag=1,((_tmpDB6.f1=(
unsigned long)i,((_tmpDB7[0]=& _tmpDB6,Cyc_aprintf(((_tmpDB8="#%d",_tag_dyneither(
_tmpDB8,sizeof(char),4))),_tag_dyneither(_tmpDB7,sizeof(void*),1))))))));struct
_dyneither_ptr*_tmpDBB;struct Cyc_Absyn_Tvar*_tmpDBA;return(_tmpDBA=_cycalloc(
sizeof(*_tmpDBA)),((_tmpDBA->name=((_tmpDBB=_cycalloc(sizeof(struct
_dyneither_ptr)* 1),((_tmpDBB[0]=s,_tmpDBB)))),((_tmpDBA->identity=- 1,((_tmpDBA->kind=(
void*)k,_tmpDBA)))))));}int Cyc_Tcutil_is_temp_tvar(struct Cyc_Absyn_Tvar*t);int
Cyc_Tcutil_is_temp_tvar(struct Cyc_Absyn_Tvar*t){struct _dyneither_ptr _tmp61D=*t->name;
return*((const char*)_check_dyneither_subscript(_tmp61D,sizeof(char),0))== '#';}
void Cyc_Tcutil_rewrite_temp_tvar(struct Cyc_Absyn_Tvar*t);void Cyc_Tcutil_rewrite_temp_tvar(
struct Cyc_Absyn_Tvar*t){{const char*_tmpDBF;void*_tmpDBE[1];struct Cyc_String_pa_struct
_tmpDBD;(_tmpDBD.tag=0,((_tmpDBD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
t->name),((_tmpDBE[0]=& _tmpDBD,Cyc_printf(((_tmpDBF="%s",_tag_dyneither(_tmpDBF,
sizeof(char),3))),_tag_dyneither(_tmpDBE,sizeof(void*),1)))))));}if(!Cyc_Tcutil_is_temp_tvar(
t))return;{const char*_tmpDC0;struct _dyneither_ptr _tmp621=Cyc_strconcat(((_tmpDC0="`",
_tag_dyneither(_tmpDC0,sizeof(char),2))),(struct _dyneither_ptr)*t->name);{char
_tmpDC3;char _tmpDC2;struct _dyneither_ptr _tmpDC1;(_tmpDC1=_dyneither_ptr_plus(
_tmp621,sizeof(char),1),((_tmpDC2=*((char*)_check_dyneither_subscript(_tmpDC1,
sizeof(char),0)),((_tmpDC3='t',((_get_dyneither_size(_tmpDC1,sizeof(char))== 1
 && (_tmpDC2 == '\000'  && _tmpDC3 != '\000')?_throw_arraybounds(): 1,*((char*)
_tmpDC1.curr)=_tmpDC3)))))));}{struct _dyneither_ptr*_tmpDC4;t->name=((_tmpDC4=
_cycalloc(sizeof(struct _dyneither_ptr)* 1),((_tmpDC4[0]=(struct _dyneither_ptr)
_tmp621,_tmpDC4))));}}}struct _tuple14{struct _dyneither_ptr*f1;struct Cyc_Absyn_Tqual
...
_tmpDC7;struct _tuple3*_tmpDC6;return(_tmpDC6=_cycalloc(sizeof(*_tmpDC6)),((
_tmpDC6->f1=(struct Cyc_Core_Opt*)((_tmpDC7=_cycalloc(sizeof(*_tmpDC7)),((_tmpDC7->v=(*
x).f1,_tmpDC7)))),((_tmpDC6->f2=(*x).f2,((_tmpDC6->f3=(*x).f3,_tmpDC6)))))));}
void*Cyc_Tcutil_fndecl2typ(struct Cyc_Absyn_Fndecl*fd);void*Cyc_Tcutil_fndecl2typ(
struct Cyc_Absyn_Fndecl*fd){if(fd->cached_typ == 0){struct Cyc_List_List*_tmp629=0;{
struct Cyc_List_List*atts=fd->attributes;for(0;atts != 0;atts=atts->tl){if(Cyc_Absyn_fntype_att((
void*)atts->hd)){struct Cyc_List_List*_tmpDC8;_tmp629=((_tmpDC8=_cycalloc(sizeof(*
_tmpDC8)),((_tmpDC8->hd=(void*)((void*)atts->hd),((_tmpDC8->tl=_tmp629,_tmpDC8))))));}}}{
struct Cyc_Absyn_FnType_struct _tmpDCE;struct Cyc_Absyn_FnInfo _tmpDCD;struct Cyc_Absyn_FnType_struct*
_tmpDCC;return(void*)((_tmpDCC=_cycalloc(sizeof(*_tmpDCC)),((_tmpDCC[0]=((
_tmpDCE.tag=8,((_tmpDCE.f1=((_tmpDCD.tvars=fd->tvs,((_tmpDCD.effect=fd->effect,((
_tmpDCD.ret_typ=(void*)((void*)fd->ret_type),((_tmpDCD.args=((struct Cyc_List_List*(*)(
struct _tuple3*(*f)(struct _tuple14*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_fndecl2typ_f,
fd->args),((_tmpDCD.c_varargs=fd->c_varargs,((_tmpDCD.cyc_varargs=fd->cyc_varargs,((
_tmpDCD.rgn_po=fd->rgn_po,((_tmpDCD.attributes=_tmp629,_tmpDCD)))))))))))))))),
_tmpDCE)))),_tmpDCC))));}}return(void*)((struct Cyc_Core_Opt*)_check_null(fd->cached_typ))->v;}
...
_tmpDCF;return(_tmpDCF=_cycalloc(sizeof(*_tmpDCF)),((_tmpDCF->f1=(*pr).f1,((
_tmpDCF->f2=t,_tmpDCF)))));}struct _tuple16{struct Cyc_Core_Opt*f1;struct Cyc_Absyn_Tqual
...
struct _RegionHandle*rgn,struct _tuple3*y){struct _tuple16*_tmpDD2;struct _tuple17*
_tmpDD1;return(_tmpDD1=_region_malloc(rgn,sizeof(*_tmpDD1)),((_tmpDD1->f1=((
_tmpDD2=_region_malloc(rgn,sizeof(*_tmpDD2)),((_tmpDD2->f1=(*y).f1,((_tmpDD2->f2=(*
y).f2,_tmpDD2)))))),((_tmpDD1->f2=(*y).f3,_tmpDD1)))));}static struct _tuple3*Cyc_Tcutil_substitute_f2(
...
struct _tuple16 _tmp634=*_tmp632;_tmp635=_tmp634.f1;_tmp636=_tmp634.f2;{struct
_tuple3*_tmpDD3;return(_tmpDD3=_cycalloc(sizeof(*_tmpDD3)),((_tmpDD3->f1=_tmp635,((
_tmpDD3->f2=_tmp636,((_tmpDD3->f3=_tmp633,_tmpDD3)))))));}}}static void*Cyc_Tcutil_field_type(
...
struct Cyc_Absyn_Aggrfield*f,void*t){struct Cyc_Absyn_Aggrfield*_tmpDD4;return(
_tmpDD4=_cycalloc(sizeof(*_tmpDD4)),((_tmpDD4->name=f->name,((_tmpDD4->tq=f->tq,((
_tmpDD4->type=(void*)t,((_tmpDD4->width=f->width,((_tmpDD4->attributes=f->attributes,
_tmpDD4)))))))))));}static struct Cyc_List_List*Cyc_Tcutil_substs(struct
...
Cyc_Tcutil_copye(struct Cyc_Absyn_Exp*old,void*r){struct Cyc_Absyn_Exp*_tmpDD5;
return(_tmpDD5=_cycalloc(sizeof(*_tmpDD5)),((_tmpDD5->topt=old->topt,((_tmpDD5->r=(
void*)r,((_tmpDD5->loc=old->loc,((_tmpDD5->annot=(void*)((void*)old->annot),
_tmpDD5)))))))));}static struct Cyc_Absyn_Exp*Cyc_Tcutil_rsubsexp(struct
...
_tmp64F)return e;{struct Cyc_Absyn_Primop_e_struct _tmpDDB;struct Cyc_Absyn_Exp*
_tmpDDA[1];struct Cyc_Absyn_Primop_e_struct*_tmpDD9;return Cyc_Tcutil_copye(e,(
void*)((_tmpDD9=_cycalloc(sizeof(*_tmpDD9)),((_tmpDD9[0]=((_tmpDDB.tag=3,((
_tmpDDB.f1=(void*)_tmp63B,((_tmpDDB.f2=((_tmpDDA[0]=_tmp650,((struct Cyc_List_List*(*)(
struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpDDA,sizeof(struct Cyc_Absyn_Exp*),
1)))),_tmpDDB)))))),_tmpDD9)))));}}else{if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
...
r,inst,_tmp655);if(_tmp656 == _tmp654  && _tmp657 == _tmp655)return e;{struct Cyc_Absyn_Primop_e_struct
_tmpDE1;struct Cyc_Absyn_Exp*_tmpDE0[2];struct Cyc_Absyn_Primop_e_struct*_tmpDDF;
return Cyc_Tcutil_copye(e,(void*)((_tmpDDF=_cycalloc(sizeof(*_tmpDDF)),((_tmpDDF[
0]=((_tmpDE1.tag=3,((_tmpDE1.f1=(void*)_tmp63B,((_tmpDE1.f2=((_tmpDE0[1]=_tmp657,((
_tmpDE0[0]=_tmp656,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(
_tag_dyneither(_tmpDE0,sizeof(struct Cyc_Absyn_Exp*),2)))))),_tmpDE1)))))),
_tmpDDF)))));}}else{const char*_tmpDE4;void*_tmpDE3;return(_tmpDE3=0,((struct Cyc_Absyn_Exp*(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpDE4="primop does not have 1 or 2 args!",
_tag_dyneither(_tmpDE4,sizeof(char),34))),_tag_dyneither(_tmpDE3,sizeof(void*),0)));}}
_LL459: if(*((int*)_tmp63A)!= 6)goto _LL45B;_tmp63D=((struct Cyc_Absyn_Conditional_e_struct*)
...
if((_tmp65D == _tmp63D  && _tmp65E == _tmp63E) && _tmp65F == _tmp63F)return e;{struct
Cyc_Absyn_Conditional_e_struct _tmpDE7;struct Cyc_Absyn_Conditional_e_struct*
_tmpDE6;return Cyc_Tcutil_copye(e,(void*)((_tmpDE6=_cycalloc(sizeof(*_tmpDE6)),((
_tmpDE6[0]=((_tmpDE7.tag=6,((_tmpDE7.f1=_tmp65D,((_tmpDE7.f2=_tmp65E,((_tmpDE7.f3=
_tmp65F,_tmpDE7)))))))),_tmpDE6)))));}}_LL45B: if(*((int*)_tmp63A)!= 7)goto _LL45D;
_tmp640=((struct Cyc_Absyn_And_e_struct*)_tmp63A)->f1;_tmp641=((struct Cyc_Absyn_And_e_struct*)
...
_tmp662 == _tmp640  && _tmp663 == _tmp641)return e;{struct Cyc_Absyn_And_e_struct
_tmpDEA;struct Cyc_Absyn_And_e_struct*_tmpDE9;return Cyc_Tcutil_copye(e,(void*)((
_tmpDE9=_cycalloc(sizeof(*_tmpDE9)),((_tmpDE9[0]=((_tmpDEA.tag=7,((_tmpDEA.f1=
_tmp662,((_tmpDEA.f2=_tmp663,_tmpDEA)))))),_tmpDE9)))));}}_LL45D: if(*((int*)
_tmp63A)!= 8)goto _LL45F;_tmp642=((struct Cyc_Absyn_Or_e_struct*)_tmp63A)->f1;
_tmp643=((struct Cyc_Absyn_Or_e_struct*)_tmp63A)->f2;_LL45E: {struct Cyc_Absyn_Exp*
_tmp666=Cyc_Tcutil_rsubsexp(r,inst,_tmp642);struct Cyc_Absyn_Exp*_tmp667=Cyc_Tcutil_rsubsexp(
r,inst,_tmp643);if(_tmp666 == _tmp642  && _tmp667 == _tmp643)return e;{struct Cyc_Absyn_Or_e_struct
_tmpDED;struct Cyc_Absyn_Or_e_struct*_tmpDEC;return Cyc_Tcutil_copye(e,(void*)((
_tmpDEC=_cycalloc(sizeof(*_tmpDEC)),((_tmpDEC[0]=((_tmpDED.tag=8,((_tmpDED.f1=
_tmp666,((_tmpDED.f2=_tmp667,_tmpDED)))))),_tmpDEC)))));}}_LL45F: if(*((int*)
_tmp63A)!= 9)goto _LL461;_tmp644=((struct Cyc_Absyn_SeqExp_e_struct*)_tmp63A)->f1;
_tmp645=((struct Cyc_Absyn_SeqExp_e_struct*)_tmp63A)->f2;_LL460: {struct Cyc_Absyn_Exp*
_tmp66A=Cyc_Tcutil_rsubsexp(r,inst,_tmp644);struct Cyc_Absyn_Exp*_tmp66B=Cyc_Tcutil_rsubsexp(
r,inst,_tmp645);if(_tmp66A == _tmp644  && _tmp66B == _tmp645)return e;{struct Cyc_Absyn_SeqExp_e_struct
_tmpDF0;struct Cyc_Absyn_SeqExp_e_struct*_tmpDEF;return Cyc_Tcutil_copye(e,(void*)((
_tmpDEF=_cycalloc(sizeof(*_tmpDEF)),((_tmpDEF[0]=((_tmpDF0.tag=9,((_tmpDF0.f1=
_tmp66A,((_tmpDF0.f2=_tmp66B,_tmpDF0)))))),_tmpDEF)))));}}_LL461: if(*((int*)
_tmp63A)!= 15)goto _LL463;_tmp646=(void*)((struct Cyc_Absyn_Cast_e_struct*)_tmp63A)->f1;
_tmp647=((struct Cyc_Absyn_Cast_e_struct*)_tmp63A)->f2;_tmp648=((struct Cyc_Absyn_Cast_e_struct*)
_tmp63A)->f3;_tmp649=(void*)((struct Cyc_Absyn_Cast_e_struct*)_tmp63A)->f4;_LL462: {
struct Cyc_Absyn_Exp*_tmp66E=Cyc_Tcutil_rsubsexp(r,inst,_tmp647);void*_tmp66F=Cyc_Tcutil_rsubstitute(
r,inst,_tmp646);if(_tmp66E == _tmp647  && _tmp66F == _tmp646)return e;{struct Cyc_Absyn_Cast_e_struct
_tmpDF3;struct Cyc_Absyn_Cast_e_struct*_tmpDF2;return Cyc_Tcutil_copye(e,(void*)((
_tmpDF2=_cycalloc(sizeof(*_tmpDF2)),((_tmpDF2[0]=((_tmpDF3.tag=15,((_tmpDF3.f1=(
void*)_tmp66F,((_tmpDF3.f2=_tmp66E,((_tmpDF3.f3=_tmp648,((_tmpDF3.f4=(void*)
_tmp649,_tmpDF3)))))))))),_tmpDF2)))));}}_LL463: if(*((int*)_tmp63A)!= 18)goto
_LL465;_tmp64A=(void*)((struct Cyc_Absyn_Sizeoftyp_e_struct*)_tmp63A)->f1;_LL464: {
void*_tmp672=Cyc_Tcutil_rsubstitute(r,inst,_tmp64A);if(_tmp672 == _tmp64A)return e;{
struct Cyc_Absyn_Sizeoftyp_e_struct _tmpDF6;struct Cyc_Absyn_Sizeoftyp_e_struct*
_tmpDF5;return Cyc_Tcutil_copye(e,(void*)((_tmpDF5=_cycalloc(sizeof(*_tmpDF5)),((
_tmpDF5[0]=((_tmpDF6.tag=18,((_tmpDF6.f1=(void*)_tmp672,_tmpDF6)))),_tmpDF5)))));}}
_LL465: if(*((int*)_tmp63A)!= 19)goto _LL467;_tmp64B=((struct Cyc_Absyn_Sizeofexp_e_struct*)
_tmp63A)->f1;_LL466: {struct Cyc_Absyn_Exp*_tmp675=Cyc_Tcutil_rsubsexp(r,inst,
_tmp64B);if(_tmp675 == _tmp64B)return e;{struct Cyc_Absyn_Sizeofexp_e_struct _tmpDF9;
struct Cyc_Absyn_Sizeofexp_e_struct*_tmpDF8;return Cyc_Tcutil_copye(e,(void*)((
_tmpDF8=_cycalloc(sizeof(*_tmpDF8)),((_tmpDF8[0]=((_tmpDF9.tag=19,((_tmpDF9.f1=
_tmp675,_tmpDF9)))),_tmpDF8)))));}}_LL467: if(*((int*)_tmp63A)!= 20)goto _LL469;
_tmp64C=(void*)((struct Cyc_Absyn_Offsetof_e_struct*)_tmp63A)->f1;_tmp64D=(void*)((
struct Cyc_Absyn_Offsetof_e_struct*)_tmp63A)->f2;_LL468: {void*_tmp678=Cyc_Tcutil_rsubstitute(
r,inst,_tmp64C);if(_tmp678 == _tmp64C)return e;{struct Cyc_Absyn_Offsetof_e_struct
_tmpDFC;struct Cyc_Absyn_Offsetof_e_struct*_tmpDFB;return Cyc_Tcutil_copye(e,(void*)((
_tmpDFB=_cycalloc(sizeof(*_tmpDFB)),((_tmpDFB[0]=((_tmpDFC.tag=20,((_tmpDFC.f1=(
void*)_tmp678,((_tmpDFC.f2=(void*)_tmp64D,_tmpDFC)))))),_tmpDFB)))));}}_LL469:
if(*((int*)_tmp63A)!= 39)goto _LL46B;_tmp64E=(void*)((struct Cyc_Absyn_Valueof_e_struct*)
_tmp63A)->f1;_LL46A: {void*_tmp67B=Cyc_Tcutil_rsubstitute(r,inst,_tmp64E);if(
_tmp67B == _tmp64E)return e;{struct Cyc_Absyn_Valueof_e_struct _tmpDFF;struct Cyc_Absyn_Valueof_e_struct*
_tmpDFE;return Cyc_Tcutil_copye(e,(void*)((_tmpDFE=_cycalloc(sizeof(*_tmpDFE)),((
_tmpDFE[0]=((_tmpDFF.tag=39,((_tmpDFF.f1=(void*)_tmp67B,_tmpDFF)))),_tmpDFE)))));}}
_LL46B:;_LL46C: {const char*_tmpE02;void*_tmpE01;return(_tmpE01=0,((struct Cyc_Absyn_Exp*(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpE02="non-type-level-expression in Tcutil::rsubsexp",
_tag_dyneither(_tmpE02,sizeof(char),46))),_tag_dyneither(_tmpE01,sizeof(void*),0)));}
_LL44E:;}void*Cyc_Tcutil_rsubstitute(struct _RegionHandle*rgn,struct Cyc_List_List*
inst,void*t);void*Cyc_Tcutil_rsubstitute(struct _RegionHandle*rgn,struct Cyc_List_List*
inst,void*t){void*_tmp680=Cyc_Tcutil_compress(t);struct Cyc_Absyn_Tvar*_tmp681;
struct Cyc_Absyn_AggrInfo _tmp682;union Cyc_Absyn_AggrInfoU_union _tmp683;struct Cyc_List_List*
_tmp684;struct Cyc_Absyn_TunionInfo _tmp685;union Cyc_Absyn_TunionInfoU_union
_tmp686;struct Cyc_List_List*_tmp687;struct Cyc_Core_Opt*_tmp688;struct Cyc_Absyn_TunionFieldInfo
_tmp689;union Cyc_Absyn_TunionFieldInfoU_union _tmp68A;struct Cyc_List_List*_tmp68B;
struct _tuple2*_tmp68C;struct Cyc_List_List*_tmp68D;struct Cyc_Absyn_Typedefdecl*
_tmp68E;void**_tmp68F;struct Cyc_Absyn_ArrayInfo _tmp690;void*_tmp691;struct Cyc_Absyn_Tqual
...
_tmp6B9=Cyc_Tcutil_substs(rgn,inst,_tmp684);struct Cyc_Absyn_AggrType_struct
_tmpE08;struct Cyc_Absyn_AggrInfo _tmpE07;struct Cyc_Absyn_AggrType_struct*_tmpE06;
return _tmp6B9 == _tmp684?t:(void*)((_tmpE06=_cycalloc(sizeof(*_tmpE06)),((_tmpE06[
0]=((_tmpE08.tag=10,((_tmpE08.f1=((_tmpE07.aggr_info=_tmp683,((_tmpE07.targs=
_tmp6B9,_tmpE07)))),_tmpE08)))),_tmpE06))));}_LL472: if(*((int*)_tmp680)!= 2)goto
_LL474;_tmp685=((struct Cyc_Absyn_TunionType_struct*)_tmp680)->f1;_tmp686=_tmp685.tunion_info;
_tmp687=_tmp685.targs;_tmp688=_tmp685.rgn;_LL473: {struct Cyc_List_List*_tmp6BD=
Cyc_Tcutil_substs(rgn,inst,_tmp687);struct Cyc_Core_Opt*new_r;if((unsigned int)
_tmp688){void*_tmp6BE=Cyc_Tcutil_rsubstitute(rgn,inst,(void*)_tmp688->v);if(
_tmp6BE == (void*)_tmp688->v)new_r=_tmp688;else{struct Cyc_Core_Opt*_tmpE09;new_r=((
_tmpE09=_cycalloc(sizeof(*_tmpE09)),((_tmpE09->v=(void*)_tmp6BE,_tmpE09))));}}
else{new_r=_tmp688;}{struct Cyc_Absyn_TunionType_struct _tmpE0F;struct Cyc_Absyn_TunionInfo
_tmpE0E;struct Cyc_Absyn_TunionType_struct*_tmpE0D;return _tmp6BD == _tmp687  && 
new_r == _tmp688?t:(void*)((_tmpE0D=_cycalloc(sizeof(*_tmpE0D)),((_tmpE0D[0]=((
_tmpE0F.tag=2,((_tmpE0F.f1=((_tmpE0E.tunion_info=_tmp686,((_tmpE0E.targs=_tmp6BD,((
_tmpE0E.rgn=new_r,_tmpE0E)))))),_tmpE0F)))),_tmpE0D))));}}_LL474: if(*((int*)
_tmp680)!= 3)goto _LL476;_tmp689=((struct Cyc_Absyn_TunionFieldType_struct*)
_tmp680)->f1;_tmp68A=_tmp689.field_info;_tmp68B=_tmp689.targs;_LL475: {struct Cyc_List_List*
_tmp6C3=Cyc_Tcutil_substs(rgn,inst,_tmp68B);struct Cyc_Absyn_TunionFieldType_struct
_tmpE15;struct Cyc_Absyn_TunionFieldInfo _tmpE14;struct Cyc_Absyn_TunionFieldType_struct*
_tmpE13;return _tmp6C3 == _tmp68B?t:(void*)((_tmpE13=_cycalloc(sizeof(*_tmpE13)),((
_tmpE13[0]=((_tmpE15.tag=3,((_tmpE15.f1=((_tmpE14.field_info=_tmp68A,((_tmpE14.targs=
_tmp6C3,_tmpE14)))),_tmpE15)))),_tmpE13))));}_LL476: if(*((int*)_tmp680)!= 16)
goto _LL478;_tmp68C=((struct Cyc_Absyn_TypedefType_struct*)_tmp680)->f1;_tmp68D=((
...
struct Cyc_List_List*_tmp6C7=Cyc_Tcutil_substs(rgn,inst,_tmp68D);struct Cyc_Absyn_TypedefType_struct
_tmpE18;struct Cyc_Absyn_TypedefType_struct*_tmpE17;return _tmp6C7 == _tmp68D?t:(
void*)((_tmpE17=_cycalloc(sizeof(*_tmpE17)),((_tmpE17[0]=((_tmpE18.tag=16,((
_tmpE18.f1=_tmp68C,((_tmpE18.f2=_tmp6C7,((_tmpE18.f3=_tmp68E,((_tmpE18.f4=
_tmp68F,_tmpE18)))))))))),_tmpE17))));}_LL478: if(*((int*)_tmp680)!= 7)goto _LL47A;
_tmp690=((struct Cyc_Absyn_ArrayType_struct*)_tmp680)->f1;_tmp691=(void*)_tmp690.elt_type;
...
struct Cyc_Absyn_ArrayType_struct _tmpE1E;struct Cyc_Absyn_ArrayInfo _tmpE1D;struct
Cyc_Absyn_ArrayType_struct*_tmpE1C;return _tmp6CA == _tmp691?t:(void*)((_tmpE1C=
_cycalloc(sizeof(*_tmpE1C)),((_tmpE1C[0]=((_tmpE1E.tag=7,((_tmpE1E.f1=((_tmpE1D.elt_type=(
void*)_tmp6CA,((_tmpE1D.tq=_tmp692,((_tmpE1D.num_elts=_tmp693,((_tmpE1D.zero_term=
_tmp694,((_tmpE1D.zt_loc=_tmp695,_tmpE1D)))))))))),_tmpE1E)))),_tmpE1C))));}
_LL47A: if(*((int*)_tmp680)!= 4)goto _LL47C;_tmp696=((struct Cyc_Absyn_PointerType_struct*)
...
_tmp6D3);if(_tmp6D4 != _tmp6D3){struct Cyc_Absyn_Upper_b_struct _tmpE21;struct Cyc_Absyn_Upper_b_struct*
_tmpE20;_tmp6D0=Cyc_Absyn_new_conref((void*)((_tmpE20=_cycalloc(sizeof(*_tmpE20)),((
_tmpE20[0]=((_tmpE21.tag=0,((_tmpE21.f1=_tmp6D4,_tmpE21)))),_tmpE20)))));}goto
_LL4A7;}_LL4AA:;_LL4AB: goto _LL4A7;_LL4A7:;}if((_tmp6CE == _tmp697  && _tmp6CF == 
_tmp69A) && _tmp6D0 == _tmp69C)return t;{struct Cyc_Absyn_PointerType_struct _tmpE2B;
struct Cyc_Absyn_PtrAtts _tmpE2A;struct Cyc_Absyn_PtrInfo _tmpE29;struct Cyc_Absyn_PointerType_struct*
_tmpE28;return(void*)((_tmpE28=_cycalloc(sizeof(*_tmpE28)),((_tmpE28[0]=((
_tmpE2B.tag=4,((_tmpE2B.f1=((_tmpE29.elt_typ=(void*)_tmp6CE,((_tmpE29.elt_tq=
_tmp698,((_tmpE29.ptr_atts=((_tmpE2A.rgn=(void*)_tmp6CF,((_tmpE2A.nullable=
_tmp69B,((_tmpE2A.bounds=_tmp6D0,((_tmpE2A.zero_term=_tmp69D,((_tmpE2A.ptrloc=0,
_tmpE2A)))))))))),_tmpE29)))))),_tmpE2B)))),_tmpE28))));}}_LL47C: if(*((int*)
_tmp680)!= 8)goto _LL47E;_tmp69E=((struct Cyc_Absyn_FnType_struct*)_tmp680)->f1;
_tmp69F=_tmp69E.tvars;_tmp6A0=_tmp69E.effect;_tmp6A1=(void*)_tmp69E.ret_typ;
...
_tmp6DB=_tmp69F;for(0;_tmp6DB != 0;_tmp6DB=_tmp6DB->tl){struct _tuple8*_tmpE35;
struct Cyc_Absyn_VarType_struct _tmpE34;struct Cyc_Absyn_VarType_struct*_tmpE33;
struct Cyc_List_List*_tmpE32;inst=((_tmpE32=_region_malloc(rgn,sizeof(*_tmpE32)),((
_tmpE32->hd=((_tmpE35=_region_malloc(rgn,sizeof(*_tmpE35)),((_tmpE35->f1=(struct
Cyc_Absyn_Tvar*)_tmp6DB->hd,((_tmpE35->f2=(void*)((_tmpE33=_cycalloc(sizeof(*
_tmpE33)),((_tmpE33[0]=((_tmpE34.tag=1,((_tmpE34.f1=(struct Cyc_Absyn_Tvar*)
_tmp6DB->hd,_tmpE34)))),_tmpE33)))),_tmpE35)))))),((_tmpE32->tl=inst,_tmpE32))))));}}{
struct Cyc_List_List*_tmp6E1;struct Cyc_List_List*_tmp6E2;struct _tuple1 _tmp6E0=((
...
struct Cyc_List_List*x))Cyc_List_rmap_c)(rgn,Cyc_Tcutil_substitute_f1,rgn,_tmp6A2));
_tmp6E1=_tmp6E0.f1;_tmp6E2=_tmp6E0.f2;{struct Cyc_List_List*_tmp6E3=Cyc_Tcutil_substs(
rgn,inst,_tmp6E2);struct Cyc_List_List*_tmp6E4=((struct Cyc_List_List*(*)(struct
...
void*)_tmp6A0->v);if(_tmp6E5 == (void*)_tmp6A0->v)eff2=_tmp6A0;else{struct Cyc_Core_Opt*
_tmpE36;eff2=((_tmpE36=_cycalloc(sizeof(*_tmpE36)),((_tmpE36->v=(void*)_tmp6E5,
_tmpE36))));}}{struct Cyc_Absyn_VarargInfo*cyc_varargs2;if(_tmp6A4 == 0)
...
cyc_varargs2=_tmp6A4;else{struct Cyc_Absyn_VarargInfo*_tmpE37;cyc_varargs2=((
_tmpE37=_cycalloc(sizeof(*_tmpE37)),((_tmpE37->name=_tmp6E8,((_tmpE37->tq=
_tmp6E9,((_tmpE37->type=(void*)_tmp6EC,((_tmpE37->inject=_tmp6EB,_tmpE37))))))))));}}}{
struct Cyc_List_List*rgn_po2;struct Cyc_List_List*_tmp6EF;struct Cyc_List_List*
_tmp6F0;struct _tuple1 _tmp6EE=Cyc_List_rsplit(rgn,rgn,_tmp6A5);_tmp6EF=_tmp6EE.f1;
_tmp6F0=_tmp6EE.f2;{struct Cyc_List_List*_tmp6F1=Cyc_Tcutil_substs(rgn,inst,
_tmp6EF);struct Cyc_List_List*_tmp6F2=Cyc_Tcutil_substs(rgn,inst,_tmp6F0);if(
_tmp6F1 == _tmp6EF  && _tmp6F2 == _tmp6F0)rgn_po2=_tmp6A5;else{rgn_po2=Cyc_List_zip(
_tmp6F1,_tmp6F2);}{struct Cyc_Absyn_FnType_struct _tmpE3D;struct Cyc_Absyn_FnInfo
_tmpE3C;struct Cyc_Absyn_FnType_struct*_tmpE3B;return(void*)((_tmpE3B=_cycalloc(
sizeof(*_tmpE3B)),((_tmpE3B[0]=((_tmpE3D.tag=8,((_tmpE3D.f1=((_tmpE3C.tvars=
_tmp69F,((_tmpE3C.effect=eff2,((_tmpE3C.ret_typ=(void*)Cyc_Tcutil_rsubstitute(
rgn,inst,_tmp6A1),((_tmpE3C.args=_tmp6E4,((_tmpE3C.c_varargs=_tmp6A3,((_tmpE3C.cyc_varargs=
cyc_varargs2,((_tmpE3C.rgn_po=rgn_po2,((_tmpE3C.attributes=_tmp6A6,_tmpE3C)))))))))))))))),
_tmpE3D)))),_tmpE3B))));}}}}}}_LL47E: if(*((int*)_tmp680)!= 9)goto _LL480;_tmp6A7=((
...
_tmp6A7,_tmp6F7);struct Cyc_Absyn_TupleType_struct _tmpE40;struct Cyc_Absyn_TupleType_struct*
_tmpE3F;return(void*)((_tmpE3F=_cycalloc(sizeof(*_tmpE3F)),((_tmpE3F[0]=((
_tmpE40.tag=9,((_tmpE40.f1=_tmp6F8,_tmpE40)))),_tmpE3F))));}}_LL480: if(*((int*)
...
_tmp6FC);struct Cyc_Absyn_AnonAggrType_struct _tmpE43;struct Cyc_Absyn_AnonAggrType_struct*
_tmpE42;return(void*)((_tmpE42=_cycalloc(sizeof(*_tmpE42)),((_tmpE42[0]=((
_tmpE43.tag=11,((_tmpE43.f1=(void*)_tmp6A8,((_tmpE43.f2=_tmp6FD,_tmpE43)))))),
_tmpE42))));}}_LL482: if(*((int*)_tmp680)!= 0)goto _LL484;_tmp6AA=((struct Cyc_Absyn_Evar_struct*)
...
Cyc_Tcutil_rsubstitute(rgn,inst,_tmp6AB);struct Cyc_Absyn_RgnHandleType_struct
_tmpE46;struct Cyc_Absyn_RgnHandleType_struct*_tmpE45;return _tmp700 == _tmp6AB?t:(
void*)((_tmpE45=_cycalloc(sizeof(*_tmpE45)),((_tmpE45[0]=((_tmpE46.tag=14,((
_tmpE46.f1=(void*)_tmp700,_tmpE46)))),_tmpE45))));}_LL486: if(*((int*)_tmp680)!= 
15)goto _LL488;_tmp6AC=(void*)((struct Cyc_Absyn_DynRgnType_struct*)_tmp680)->f1;
_tmp6AD=(void*)((struct Cyc_Absyn_DynRgnType_struct*)_tmp680)->f2;_LL487: {void*
_tmp703=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp6AC);void*_tmp704=Cyc_Tcutil_rsubstitute(
rgn,inst,_tmp6AD);struct Cyc_Absyn_DynRgnType_struct _tmpE49;struct Cyc_Absyn_DynRgnType_struct*
_tmpE48;return _tmp703 == _tmp6AC  && _tmp704 == _tmp6AD?t:(void*)((_tmpE48=
_cycalloc(sizeof(*_tmpE48)),((_tmpE48[0]=((_tmpE49.tag=15,((_tmpE49.f1=(void*)
_tmp703,((_tmpE49.f2=(void*)_tmp704,_tmpE49)))))),_tmpE48))));}_LL488: if(*((int*)
_tmp680)!= 18)goto _LL48A;_tmp6AE=(void*)((struct Cyc_Absyn_TagType_struct*)
_tmp680)->f1;_LL489: {void*_tmp707=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp6AE);
struct Cyc_Absyn_TagType_struct _tmpE4C;struct Cyc_Absyn_TagType_struct*_tmpE4B;
return _tmp707 == _tmp6AE?t:(void*)((_tmpE4B=_cycalloc(sizeof(*_tmpE4B)),((_tmpE4B[
0]=((_tmpE4C.tag=18,((_tmpE4C.f1=(void*)_tmp707,_tmpE4C)))),_tmpE4B))));}_LL48A:
...
_tmp6AF);struct Cyc_Absyn_ValueofType_struct _tmpE4F;struct Cyc_Absyn_ValueofType_struct*
_tmpE4E;return _tmp70A == _tmp6AF?t:(void*)((_tmpE4E=_cycalloc(sizeof(*_tmpE4E)),((
_tmpE4E[0]=((_tmpE4F.tag=17,((_tmpE4F.f1=_tmp70A,_tmpE4F)))),_tmpE4E))));}_LL48C:
if(*((int*)_tmp680)!= 12)goto _LL48E;_LL48D: goto _LL48F;_LL48E: if(*((int*)_tmp680)
!= 13)goto _LL490;_LL48F: goto _LL491;_LL490: if((int)_tmp680 != 0)goto _LL492;_LL491:
goto _LL493;_LL492: if(_tmp680 <= (void*)4)goto _LL494;if(*((int*)_tmp680)!= 5)goto
...
struct Cyc_Absyn_RgnsEff_struct _tmpE52;struct Cyc_Absyn_RgnsEff_struct*_tmpE51;
return _tmp70D == _tmp6B0?t:(void*)((_tmpE51=_cycalloc(sizeof(*_tmpE51)),((_tmpE51[
0]=((_tmpE52.tag=21,((_tmpE52.f1=(void*)_tmp70D,_tmpE52)))),_tmpE51))));}_LL49E:
if(_tmp680 <= (void*)4)goto _LL4A0;if(*((int*)_tmp680)!= 19)goto _LL4A0;_tmp6B1=(
void*)((struct Cyc_Absyn_AccessEff_struct*)_tmp680)->f1;_LL49F: {void*_tmp710=Cyc_Tcutil_rsubstitute(
rgn,inst,_tmp6B1);struct Cyc_Absyn_AccessEff_struct _tmpE55;struct Cyc_Absyn_AccessEff_struct*
_tmpE54;return _tmp710 == _tmp6B1?t:(void*)((_tmpE54=_cycalloc(sizeof(*_tmpE54)),((
_tmpE54[0]=((_tmpE55.tag=19,((_tmpE55.f1=(void*)_tmp710,_tmpE55)))),_tmpE54))));}
_LL4A0: if(_tmp680 <= (void*)4)goto _LL46D;if(*((int*)_tmp680)!= 20)goto _LL46D;
_tmp6B2=((struct Cyc_Absyn_JoinEff_struct*)_tmp680)->f1;_LL4A1: {struct Cyc_List_List*
_tmp713=Cyc_Tcutil_substs(rgn,inst,_tmp6B2);struct Cyc_Absyn_JoinEff_struct
_tmpE58;struct Cyc_Absyn_JoinEff_struct*_tmpE57;return _tmp713 == _tmp6B2?t:(void*)((
_tmpE57=_cycalloc(sizeof(*_tmpE57)),((_tmpE57[0]=((_tmpE58.tag=20,((_tmpE58.f1=
_tmp713,_tmpE58)))),_tmpE57))));}_LL46D:;}static struct Cyc_List_List*Cyc_Tcutil_substs(
...
inst,struct Cyc_List_List*ts){if(ts == 0)return 0;{void*_tmp716=(void*)ts->hd;
struct Cyc_List_List*_tmp717=ts->tl;void*_tmp718=Cyc_Tcutil_rsubstitute(rgn,inst,
_tmp716);struct Cyc_List_List*_tmp719=Cyc_Tcutil_substs(rgn,inst,_tmp717);if(
_tmp716 == _tmp718  && _tmp717 == _tmp719)return ts;{struct Cyc_List_List*_tmpE59;
return(struct Cyc_List_List*)((struct Cyc_List_List*)((_tmpE59=_cycalloc(sizeof(*
_tmpE59)),((_tmpE59->hd=(void*)_tmp718,((_tmpE59->tl=_tmp719,_tmpE59)))))));}}}
...
tv){struct Cyc_Core_Opt*_tmp71B=Cyc_Tcutil_kind_to_opt(Cyc_Tcutil_tvar_kind(tv));
struct Cyc_Core_Opt*_tmpE5C;struct _tuple8*_tmpE5B;return(_tmpE5B=_cycalloc(
sizeof(*_tmpE5B)),((_tmpE5B->f1=tv,((_tmpE5B->f2=Cyc_Absyn_new_evar(_tmp71B,((
_tmpE5C=_cycalloc(sizeof(*_tmpE5C)),((_tmpE5C->v=s,_tmpE5C))))),_tmpE5B)))));}
...
tv){struct _tuple9 _tmp71F;struct Cyc_List_List*_tmp720;struct _RegionHandle*_tmp721;
...
struct Cyc_Core_Opt*_tmpE5F;struct _tuple8*_tmpE5E;return(_tmpE5E=_region_malloc(
_tmp721,sizeof(*_tmpE5E)),((_tmpE5E->f1=tv,((_tmpE5E->f2=Cyc_Absyn_new_evar(
_tmp722,((_tmpE5F=_cycalloc(sizeof(*_tmpE5F)),((_tmpE5F->v=_tmp720,_tmpE5F))))),
_tmpE5E)))));}}static struct Cyc_List_List*Cyc_Tcutil_add_free_tvar(struct Cyc_Position_Segment*
...
k1,k2)){const char*_tmpE65;void*_tmpE64[3];struct Cyc_String_pa_struct _tmpE63;
struct Cyc_String_pa_struct _tmpE62;struct Cyc_String_pa_struct _tmpE61;(_tmpE61.tag=
0,((_tmpE61.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kindbound2string(
k2)),((_tmpE62.tag=0,((_tmpE62.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_kindbound2string(k1)),((_tmpE63.tag=0,((_tmpE63.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*tv->name),((_tmpE64[0]=& _tmpE63,((_tmpE64[
1]=& _tmpE62,((_tmpE64[2]=& _tmpE61,Cyc_Tcutil_terr(loc,((_tmpE65="type variable %s is used with inconsistent kinds %s and %s",
_tag_dyneither(_tmpE65,sizeof(char),59))),_tag_dyneither(_tmpE64,sizeof(void*),3)))))))))))))))))));}
...
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpE68="same type variable has different identity!",
_tag_dyneither(_tmpE68,sizeof(char),43))),_tag_dyneither(_tmpE67,sizeof(void*),0)));}}
return tvs;}}}tv->identity=Cyc_Tcutil_new_tvar_id();{struct Cyc_List_List*_tmpE69;
return(_tmpE69=_cycalloc(sizeof(*_tmpE69)),((_tmpE69->hd=tv,((_tmpE69->tl=tvs,
_tmpE69)))));}}static struct Cyc_List_List*Cyc_Tcutil_fast_add_free_tvar(struct Cyc_List_List*
...
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpE6C="fast_add_free_tvar: bad identity in tv",
_tag_dyneither(_tmpE6C,sizeof(char),39))),_tag_dyneither(_tmpE6B,sizeof(void*),0)));}{
struct Cyc_List_List*tvs2=tvs;for(0;tvs2 != 0;tvs2=tvs2->tl){struct Cyc_Absyn_Tvar*
_tmp72F=(struct Cyc_Absyn_Tvar*)tvs2->hd;if(_tmp72F->identity == - 1){const char*
_tmpE6F;void*_tmpE6E;(_tmpE6E=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpE6F="fast_add_free_tvar: bad identity in tvs2",
_tag_dyneither(_tmpE6F,sizeof(char),41))),_tag_dyneither(_tmpE6E,sizeof(void*),0)));}
if(_tmp72F->identity == tv->identity)return tvs;}}{struct Cyc_List_List*_tmpE70;
return(_tmpE70=_cycalloc(sizeof(*_tmpE70)),((_tmpE70->hd=tv,((_tmpE70->tl=tvs,
_tmpE70)))));}}struct _tuple18{struct Cyc_Absyn_Tvar*f1;int f2;};static struct Cyc_List_List*
...
tv->identity == - 1){const char*_tmpE73;void*_tmpE72;(_tmpE72=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpE73="fast_add_free_tvar_bool: bad identity in tv",
_tag_dyneither(_tmpE73,sizeof(char),44))),_tag_dyneither(_tmpE72,sizeof(void*),0)));}{
struct Cyc_List_List*tvs2=tvs;for(0;tvs2 != 0;tvs2=tvs2->tl){struct _tuple18 _tmp736;
struct Cyc_Absyn_Tvar*_tmp737;int _tmp738;int*_tmp739;struct _tuple18*_tmp735=(
struct _tuple18*)tvs2->hd;_tmp736=*_tmp735;_tmp737=_tmp736.f1;_tmp738=_tmp736.f2;
_tmp739=(int*)&(*_tmp735).f2;if(_tmp737->identity == - 1){const char*_tmpE76;void*
_tmpE75;(_tmpE75=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpE76="fast_add_free_tvar_bool: bad identity in tvs2",_tag_dyneither(_tmpE76,
sizeof(char),46))),_tag_dyneither(_tmpE75,sizeof(void*),0)));}if(_tmp737->identity
== tv->identity){*_tmp739=*_tmp739  || b;return tvs;}}}{struct _tuple18*_tmpE79;
struct Cyc_List_List*_tmpE78;return(_tmpE78=_region_malloc(r,sizeof(*_tmpE78)),((
_tmpE78->hd=((_tmpE79=_region_malloc(r,sizeof(*_tmpE79)),((_tmpE79->f1=tv,((
_tmpE79->f2=b,_tmpE79)))))),((_tmpE78->tl=tvs,_tmpE78)))));}}static struct Cyc_List_List*
...
struct Cyc_Absyn_Tvar*tv){if(tv->identity == - 1){const char*_tmpE7D;void*_tmpE7C[1];
struct Cyc_String_pa_struct _tmpE7B;(_tmpE7B.tag=0,((_tmpE7B.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcutil_tvar2string(tv)),((_tmpE7C[0]=&
_tmpE7B,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpE7D="bound tvar id for %s is NULL",_tag_dyneither(_tmpE7D,sizeof(char),29))),
_tag_dyneither(_tmpE7C,sizeof(void*),1)))))));}{struct Cyc_List_List*_tmpE7E;
return(_tmpE7E=_cycalloc(sizeof(*_tmpE7E)),((_tmpE7E->hd=tv,((_tmpE7E->tl=tvs,
_tmpE7E)))));}}struct _tuple19{void*f1;int f2;};static struct Cyc_List_List*Cyc_Tcutil_add_free_evar(
...
b){void*_tmp742=Cyc_Tcutil_compress(e);int _tmp743;_LL4AD: if(_tmp742 <= (void*)4)
goto _LL4AF;if(*((int*)_tmp742)!= 0)goto _LL4AF;_tmp743=((struct Cyc_Absyn_Evar_struct*)
_tmp742)->f3;_LL4AE:{struct Cyc_List_List*es2=es;for(0;es2 != 0;es2=es2->tl){
struct _tuple19 _tmp745;void*_tmp746;int _tmp747;int*_tmp748;struct _tuple19*_tmp744=(
struct _tuple19*)es2->hd;_tmp745=*_tmp744;_tmp746=_tmp745.f1;_tmp747=_tmp745.f2;
_tmp748=(int*)&(*_tmp744).f2;{void*_tmp749=Cyc_Tcutil_compress(_tmp746);int
_tmp74A;_LL4B2: if(_tmp749 <= (void*)4)goto _LL4B4;if(*((int*)_tmp749)!= 0)goto
_LL4B4;_tmp74A=((struct Cyc_Absyn_Evar_struct*)_tmp749)->f3;_LL4B3: if(_tmp743 == 
_tmp74A){if(b != *_tmp748)*_tmp748=1;return es;}goto _LL4B1;_LL4B4:;_LL4B5: goto
_LL4B1;_LL4B1:;}}}{struct _tuple19*_tmpE81;struct Cyc_List_List*_tmpE80;return(
_tmpE80=_region_malloc(r,sizeof(*_tmpE80)),((_tmpE80->hd=((_tmpE81=
_region_malloc(r,sizeof(*_tmpE81)),((_tmpE81->f1=e,((_tmpE81->f2=b,_tmpE81)))))),((
_tmpE80->tl=es,_tmpE80)))));}_LL4AF:;_LL4B0: return es;_LL4AC:;}static struct Cyc_List_List*
...
Cyc_List_List*_tmpE82;r=((_tmpE82=_region_malloc(rgn,sizeof(*_tmpE82)),((_tmpE82->hd=(
struct Cyc_Absyn_Tvar*)tvs->hd,((_tmpE82->tl=r,_tmpE82))))));}}r=((struct Cyc_List_List*(*)(
...
Cyc_List_List*res=0;for(0;tvs != 0;tvs=tvs->tl){struct Cyc_Absyn_Tvar*_tmp74F;int
_tmp750;struct _tuple18 _tmp74E=*((struct _tuple18*)tvs->hd);_tmp74F=_tmp74E.f1;
_tmp750=_tmp74E.f2;{int present=0;{struct Cyc_List_List*b=btvs;for(0;b != 0;b=b->tl){
if(_tmp74F->identity == ((struct Cyc_Absyn_Tvar*)b->hd)->identity){present=1;
break;}}}if(!present){struct Cyc_List_List*_tmpE83;res=((_tmpE83=_region_malloc(r,
sizeof(*_tmpE83)),((_tmpE83->hd=(struct _tuple18*)tvs->hd,((_tmpE83->tl=res,
_tmpE83))))));}}}res=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(
...
struct Cyc_Absyn_Exp*)width)){const char*_tmpE87;void*_tmpE86[1];struct Cyc_String_pa_struct
_tmpE85;(_tmpE85.tag=0,((_tmpE85.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
fn),((_tmpE86[0]=& _tmpE85,Cyc_Tcutil_terr(loc,((_tmpE87="bitfield %s does not have constant width",
_tag_dyneither(_tmpE87,sizeof(char),41))),_tag_dyneither(_tmpE86,sizeof(void*),1)))))));}
else{unsigned int _tmp756;int _tmp757;struct _tuple7 _tmp755=Cyc_Evexp_eval_const_uint_exp((
struct Cyc_Absyn_Exp*)width);_tmp756=_tmp755.f1;_tmp757=_tmp755.f2;if(!_tmp757){
const char*_tmpE8A;void*_tmpE89;(_tmpE89=0,Cyc_Tcutil_terr(loc,((_tmpE8A="bitfield width cannot use sizeof or offsetof",
_tag_dyneither(_tmpE8A,sizeof(char),45))),_tag_dyneither(_tmpE89,sizeof(void*),0)));}
w=_tmp756;}{void*_tmp75A=Cyc_Tcutil_compress(field_typ);void*_tmp75B;_LL4B7: if(
_tmp75A <= (void*)4)goto _LL4B9;if(*((int*)_tmp75A)!= 5)goto _LL4B9;_tmp75B=(void*)((
struct Cyc_Absyn_IntType_struct*)_tmp75A)->f2;_LL4B8:{void*_tmp75C=_tmp75B;_LL4BC:
if((int)_tmp75C != 0)goto _LL4BE;_LL4BD: if(w > 8){const char*_tmpE8D;void*_tmpE8C;(
_tmpE8C=0,Cyc_Tcutil_terr(loc,((_tmpE8D="bitfield larger than type",
_tag_dyneither(_tmpE8D,sizeof(char),26))),_tag_dyneither(_tmpE8C,sizeof(void*),0)));}
goto _LL4BB;_LL4BE: if((int)_tmp75C != 1)goto _LL4C0;_LL4BF: if(w > 16){const char*
_tmpE90;void*_tmpE8F;(_tmpE8F=0,Cyc_Tcutil_terr(loc,((_tmpE90="bitfield larger than type",
_tag_dyneither(_tmpE90,sizeof(char),26))),_tag_dyneither(_tmpE8F,sizeof(void*),0)));}
goto _LL4BB;_LL4C0: if((int)_tmp75C != 3)goto _LL4C2;_LL4C1: goto _LL4C3;_LL4C2: if((
int)_tmp75C != 2)goto _LL4C4;_LL4C3: if(w > 32){const char*_tmpE93;void*_tmpE92;(
_tmpE92=0,Cyc_Tcutil_terr(loc,((_tmpE93="bitfield larger than type",
_tag_dyneither(_tmpE93,sizeof(char),26))),_tag_dyneither(_tmpE92,sizeof(void*),0)));}
goto _LL4BB;_LL4C4: if((int)_tmp75C != 4)goto _LL4BB;_LL4C5: if(w > 64){const char*
_tmpE96;void*_tmpE95;(_tmpE95=0,Cyc_Tcutil_terr(loc,((_tmpE96="bitfield larger than type",
_tag_dyneither(_tmpE96,sizeof(char),26))),_tag_dyneither(_tmpE95,sizeof(void*),0)));}
goto _LL4BB;_LL4BB:;}goto _LL4B6;_LL4B9:;_LL4BA:{const char*_tmpE9B;void*_tmpE9A[2];
struct Cyc_String_pa_struct _tmpE99;struct Cyc_String_pa_struct _tmpE98;(_tmpE98.tag=
0,((_tmpE98.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
field_typ)),((_tmpE99.tag=0,((_tmpE99.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*fn),((_tmpE9A[0]=& _tmpE99,((_tmpE9A[1]=& _tmpE98,Cyc_Tcutil_terr(
loc,((_tmpE9B="bitfield %s must have integral type but has type %s",
_tag_dyneither(_tmpE9B,sizeof(char),52))),_tag_dyneither(_tmpE9A,sizeof(void*),2)))))))))))));}
goto _LL4B6;_LL4B6:;}}}static void Cyc_Tcutil_check_field_atts(struct Cyc_Position_Segment*
...
for(0;atts != 0;atts=atts->tl){void*_tmp769=(void*)atts->hd;_LL4C7: if((int)
_tmp769 != 5)goto _LL4C9;_LL4C8: continue;_LL4C9: if(_tmp769 <= (void*)17)goto _LL4CB;
if(*((int*)_tmp769)!= 1)goto _LL4CB;_LL4CA: continue;_LL4CB:;_LL4CC: {const char*
_tmpEA0;void*_tmpE9F[2];struct Cyc_String_pa_struct _tmpE9E;struct Cyc_String_pa_struct
_tmpE9D;(_tmpE9D.tag=0,((_tmpE9D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
fn),((_tmpE9E.tag=0,((_tmpE9E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absyn_attribute2string((void*)atts->hd)),((_tmpE9F[0]=& _tmpE9E,((_tmpE9F[1]=&
_tmpE9D,Cyc_Tcutil_terr(loc,((_tmpEA0="bad attribute %s on member %s",
_tag_dyneither(_tmpEA0,sizeof(char),30))),_tag_dyneither(_tmpE9F,sizeof(void*),2)))))))))))));}
_LL4C6:;}}struct Cyc_Tcutil_CVTEnv{struct _RegionHandle*r;struct Cyc_List_List*
...
struct Cyc_Position_Segment*loc,int declared_const,void*t){void*_tmp76E=t;struct
Cyc_Absyn_Typedefdecl*_tmp76F;void**_tmp770;_LL4CE: if(_tmp76E <= (void*)4)goto
_LL4D0;if(*((int*)_tmp76E)!= 16)goto _LL4D0;_tmp76F=((struct Cyc_Absyn_TypedefType_struct*)
_tmp76E)->f3;_tmp770=((struct Cyc_Absyn_TypedefType_struct*)_tmp76E)->f4;_LL4CF:
if((((struct Cyc_Absyn_Typedefdecl*)_check_null(_tmp76F))->tq).real_const  || (
_tmp76F->tq).print_const){if(declared_const){const char*_tmpEA3;void*_tmpEA2;(
_tmpEA2=0,Cyc_Tcutil_warn(loc,((_tmpEA3="extra const",_tag_dyneither(_tmpEA3,
sizeof(char),12))),_tag_dyneither(_tmpEA2,sizeof(void*),0)));}return 1;}if((
unsigned int)_tmp770)return Cyc_Tcutil_extract_const_from_typedef(loc,
declared_const,*_tmp770);else{return declared_const;}_LL4D0:;_LL4D1: return
...
void*)((void*)3)};static struct Cyc_Core_Opt hrgn={(void*)((void*)2)};{void*_tmp773=
Cyc_Tcutil_compress(t);struct Cyc_Core_Opt*_tmp774;struct Cyc_Core_Opt**_tmp775;
struct Cyc_Core_Opt*_tmp776;struct Cyc_Core_Opt**_tmp777;struct Cyc_Absyn_Tvar*
_tmp778;struct Cyc_List_List*_tmp779;struct _tuple2*_tmp77A;struct Cyc_Absyn_Enumdecl*
_tmp77B;struct Cyc_Absyn_Enumdecl**_tmp77C;struct Cyc_Absyn_TunionInfo _tmp77D;
union Cyc_Absyn_TunionInfoU_union _tmp77E;union Cyc_Absyn_TunionInfoU_union*_tmp77F;
struct Cyc_List_List*_tmp780;struct Cyc_List_List**_tmp781;struct Cyc_Core_Opt*
_tmp782;struct Cyc_Core_Opt**_tmp783;struct Cyc_Absyn_TunionFieldInfo _tmp784;union
Cyc_Absyn_TunionFieldInfoU_union _tmp785;union Cyc_Absyn_TunionFieldInfoU_union*
_tmp786;struct Cyc_List_List*_tmp787;struct Cyc_Absyn_PtrInfo _tmp788;void*_tmp789;
struct Cyc_Absyn_Tqual _tmp78A;struct Cyc_Absyn_Tqual*_tmp78B;struct Cyc_Absyn_PtrAtts
_tmp78C;void*_tmp78D;struct Cyc_Absyn_Conref*_tmp78E;struct Cyc_Absyn_Conref*
_tmp78F;struct Cyc_Absyn_Conref*_tmp790;void*_tmp791;struct Cyc_Absyn_Exp*_tmp792;
struct Cyc_Absyn_ArrayInfo _tmp793;void*_tmp794;struct Cyc_Absyn_Tqual _tmp795;
struct Cyc_Absyn_Tqual*_tmp796;struct Cyc_Absyn_Exp*_tmp797;struct Cyc_Absyn_Exp**
_tmp798;struct Cyc_Absyn_Conref*_tmp799;struct Cyc_Position_Segment*_tmp79A;struct
Cyc_Absyn_FnInfo _tmp79B;struct Cyc_List_List*_tmp79C;struct Cyc_List_List**_tmp79D;
struct Cyc_Core_Opt*_tmp79E;struct Cyc_Core_Opt**_tmp79F;void*_tmp7A0;struct Cyc_List_List*
_tmp7A1;int _tmp7A2;struct Cyc_Absyn_VarargInfo*_tmp7A3;struct Cyc_List_List*
_tmp7A4;struct Cyc_List_List*_tmp7A5;struct Cyc_List_List*_tmp7A6;void*_tmp7A7;
struct Cyc_List_List*_tmp7A8;struct Cyc_Absyn_AggrInfo _tmp7A9;union Cyc_Absyn_AggrInfoU_union
_tmp7AA;union Cyc_Absyn_AggrInfoU_union*_tmp7AB;struct Cyc_List_List*_tmp7AC;
struct Cyc_List_List**_tmp7AD;struct _tuple2*_tmp7AE;struct Cyc_List_List*_tmp7AF;
struct Cyc_List_List**_tmp7B0;struct Cyc_Absyn_Typedefdecl*_tmp7B1;struct Cyc_Absyn_Typedefdecl**
_tmp7B2;void**_tmp7B3;void***_tmp7B4;void*_tmp7B5;void*_tmp7B6;void*_tmp7B7;void*
_tmp7B8;void*_tmp7B9;struct Cyc_List_List*_tmp7BA;_LL4D3: if((int)_tmp773 != 0)goto
_LL4D5;_LL4D4: goto _LL4D2;_LL4D5: if(_tmp773 <= (void*)4)goto _LL4E9;if(*((int*)
_tmp773)!= 0)goto _LL4D7;_tmp774=((struct Cyc_Absyn_Evar_struct*)_tmp773)->f1;
_tmp775=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Evar_struct*)_tmp773)->f1;
_tmp776=((struct Cyc_Absyn_Evar_struct*)_tmp773)->f2;_tmp777=(struct Cyc_Core_Opt**)&((
struct Cyc_Absyn_Evar_struct*)_tmp773)->f2;_LL4D6: if(*_tmp775 == 0)*_tmp775=Cyc_Tcutil_kind_to_opt(
...
struct Cyc_Absyn_Less_kb_struct _tmpEA6;struct Cyc_Absyn_Less_kb_struct*_tmpEA5;
struct Cyc_Absyn_Tvar*_tmp7BB=Cyc_Tcutil_new_tvar((void*)((_tmpEA5=_cycalloc(
sizeof(*_tmpEA5)),((_tmpEA5[0]=((_tmpEA6.tag=2,((_tmpEA6.f1=0,((_tmpEA6.f2=(void*)
expected_kind,_tmpEA6)))))),_tmpEA5)))));{struct Cyc_Absyn_VarType_struct*_tmpEAC;
struct Cyc_Absyn_VarType_struct _tmpEAB;struct Cyc_Core_Opt*_tmpEAA;*_tmp777=((
_tmpEAA=_cycalloc(sizeof(*_tmpEAA)),((_tmpEAA->v=(void*)((void*)((_tmpEAC=
_cycalloc(sizeof(*_tmpEAC)),((_tmpEAC[0]=((_tmpEAB.tag=1,((_tmpEAB.f1=_tmp7BB,
_tmpEAB)))),_tmpEAC))))),_tmpEAA))));}_tmp778=_tmp7BB;goto _LL4D8;}else{cvtenv.free_evars=
Cyc_Tcutil_add_free_evar(cvtenv.r,cvtenv.free_evars,t,put_in_effect);}}goto
_LL4D2;_LL4D7: if(*((int*)_tmp773)!= 1)goto _LL4D9;_tmp778=((struct Cyc_Absyn_VarType_struct*)
_tmp773)->f1;_LL4D8:{void*_tmp7C1=Cyc_Absyn_compress_kb((void*)_tmp778->kind);
struct Cyc_Core_Opt*_tmp7C2;struct Cyc_Core_Opt**_tmp7C3;_LL508: if(*((int*)_tmp7C1)
!= 1)goto _LL50A;_tmp7C2=((struct Cyc_Absyn_Unknown_kb_struct*)_tmp7C1)->f1;
_tmp7C3=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_struct*)_tmp7C1)->f1;
_LL509:{struct Cyc_Absyn_Less_kb_struct*_tmpEB2;struct Cyc_Absyn_Less_kb_struct
_tmpEB1;struct Cyc_Core_Opt*_tmpEB0;*_tmp7C3=((_tmpEB0=_cycalloc(sizeof(*_tmpEB0)),((
_tmpEB0->v=(void*)((void*)((_tmpEB2=_cycalloc(sizeof(*_tmpEB2)),((_tmpEB2[0]=((
_tmpEB1.tag=2,((_tmpEB1.f1=0,((_tmpEB1.f2=(void*)expected_kind,_tmpEB1)))))),
_tmpEB2))))),_tmpEB0))));}goto _LL507;_LL50A:;_LL50B: goto _LL507;_LL507:;}cvtenv.kind_env=
Cyc_Tcutil_add_free_tvar(loc,cvtenv.kind_env,_tmp778);cvtenv.free_vars=Cyc_Tcutil_fast_add_free_tvar_bool(
...
_LL50E: if(Cyc_Tcutil_kind_leq(expected_kind,_tmp7CA)){struct Cyc_Absyn_Less_kb_struct*
_tmpEB8;struct Cyc_Absyn_Less_kb_struct _tmpEB7;struct Cyc_Core_Opt*_tmpEB6;*
_tmp7C9=((_tmpEB6=_cycalloc(sizeof(*_tmpEB6)),((_tmpEB6->v=(void*)((void*)((
_tmpEB8=_cycalloc(sizeof(*_tmpEB8)),((_tmpEB8[0]=((_tmpEB7.tag=2,((_tmpEB7.f1=0,((
_tmpEB7.f2=(void*)expected_kind,_tmpEB7)))))),_tmpEB8))))),_tmpEB6))));}goto
_LL50C;_LL50F:;_LL510: goto _LL50C;_LL50C:;}goto _LL4D2;_LL4D9: if(*((int*)_tmp773)
!= 13)goto _LL4DB;_tmp779=((struct Cyc_Absyn_AnonEnumType_struct*)_tmp773)->f1;
_LL4DA: {struct Cyc_Tcenv_Genv*ge=((struct Cyc_Tcenv_Genv*(*)(struct Cyc_Dict_Dict d,
struct Cyc_List_List*k))Cyc_Dict_lookup)(te->ae,te->ns);struct _RegionHandle*
_tmp7CE=Cyc_Tcenv_get_fnrgn(te);{struct Cyc_List_List*prev_fields=0;unsigned int
tag_count=0;for(0;_tmp779 != 0;_tmp779=_tmp779->tl){struct Cyc_Absyn_Enumfield*
...
const char*_tmpEBC;void*_tmpEBB[1];struct Cyc_String_pa_struct _tmpEBA;(_tmpEBA.tag=
0,((_tmpEBA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp7CF->name).f2),((
_tmpEBB[0]=& _tmpEBA,Cyc_Tcutil_terr(_tmp7CF->loc,((_tmpEBC="duplicate enum field name %s",
_tag_dyneither(_tmpEBC,sizeof(char),29))),_tag_dyneither(_tmpEBB,sizeof(void*),1)))))));}
else{struct Cyc_List_List*_tmpEBD;prev_fields=((_tmpEBD=_region_malloc(_tmp7CE,
sizeof(*_tmpEBD)),((_tmpEBD->hd=(*_tmp7CF->name).f2,((_tmpEBD->tl=prev_fields,
_tmpEBD))))));}if(_tmp7CF->tag == 0)_tmp7CF->tag=(struct Cyc_Absyn_Exp*)Cyc_Absyn_uint_exp(
tag_count,_tmp7CF->loc);else{if(!Cyc_Tcutil_is_const_exp(te,(struct Cyc_Absyn_Exp*)
_check_null(_tmp7CF->tag))){const char*_tmpEC1;void*_tmpEC0[1];struct Cyc_String_pa_struct
_tmpEBF;(_tmpEBF.tag=0,((_tmpEBF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*
_tmp7CF->name).f2),((_tmpEC0[0]=& _tmpEBF,Cyc_Tcutil_terr(loc,((_tmpEC1="enum field %s: expression is not constant",
_tag_dyneither(_tmpEC1,sizeof(char),42))),_tag_dyneither(_tmpEC0,sizeof(void*),1)))))));}}{
unsigned int t1=(Cyc_Evexp_eval_const_uint_exp((struct Cyc_Absyn_Exp*)_check_null(
_tmp7CF->tag))).f1;tag_count=t1 + 1;{union Cyc_Absyn_Nmspace_union _tmpEC2;(*
_tmp7CF->name).f1=(union Cyc_Absyn_Nmspace_union)(((_tmpEC2.Abs_n).tag=2,(((
_tmpEC2.Abs_n).f1=te->ns,_tmpEC2))));}{struct Cyc_Tcenv_AnonEnumRes_struct*
_tmpEC8;struct Cyc_Tcenv_AnonEnumRes_struct _tmpEC7;struct _tuple19*_tmpEC6;ge->ordinaries=((
struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct
_tuple19*v))Cyc_Dict_insert)(ge->ordinaries,(*_tmp7CF->name).f2,(struct _tuple19*)((
_tmpEC6=_cycalloc(sizeof(*_tmpEC6)),((_tmpEC6->f1=(void*)((_tmpEC8=_cycalloc(
sizeof(*_tmpEC8)),((_tmpEC8[0]=((_tmpEC7.tag=4,((_tmpEC7.f1=(void*)t,((_tmpEC7.f2=
_tmp7CF,_tmpEC7)))))),_tmpEC8)))),((_tmpEC6->f2=1,_tmpEC6)))))));}}}}goto _LL4D2;}
_LL4DB: if(*((int*)_tmp773)!= 12)goto _LL4DD;_tmp77A=((struct Cyc_Absyn_EnumType_struct*)
...
struct Cyc_Absyn_Enumdecl*_tmpEC9;struct Cyc_Absyn_Enumdecl*_tmp7E1=(_tmpEC9=
_cycalloc(sizeof(*_tmpEC9)),((_tmpEC9->sc=(void*)((void*)3),((_tmpEC9->name=
_tmp77A,((_tmpEC9->fields=0,_tmpEC9)))))));Cyc_Tc_tcEnumdecl(te,_tmp7E0,loc,
_tmp7E1);{struct Cyc_Absyn_Enumdecl**ed=Cyc_Tcenv_lookup_enumdecl(te,loc,_tmp77A);*
_tmp77C=(struct Cyc_Absyn_Enumdecl*)*ed;goto _LL511;}}_LL514:;_LL515:(void)_throw(
_tmp7DF);_LL511:;}}}{struct Cyc_Absyn_Enumdecl*ed=(struct Cyc_Absyn_Enumdecl*)
_check_null(*_tmp77C);*_tmp77A=(ed->name)[_check_known_subscript_notnull(1,0)];
goto _LL4D2;}_LL4DD: if(*((int*)_tmp773)!= 2)goto _LL4DF;_tmp77D=((struct Cyc_Absyn_TunionType_struct*)
_tmp773)->f1;_tmp77E=_tmp77D.tunion_info;_tmp77F=(union Cyc_Absyn_TunionInfoU_union*)&(((
struct Cyc_Absyn_TunionType_struct*)_tmp773)->f1).tunion_info;_tmp780=_tmp77D.targs;
_tmp781=(struct Cyc_List_List**)&(((struct Cyc_Absyn_TunionType_struct*)_tmp773)->f1).targs;
_tmp782=_tmp77D.rgn;_tmp783=(struct Cyc_Core_Opt**)&(((struct Cyc_Absyn_TunionType_struct*)
_tmp773)->f1).rgn;_LL4DE: {struct Cyc_List_List*_tmp7E3=*_tmp781;{union Cyc_Absyn_TunionInfoU_union
...
_tmpECA;struct Cyc_Absyn_Tuniondecl*_tmp7F1=(_tmpECA=_cycalloc(sizeof(*_tmpECA)),((
_tmpECA->sc=(void*)((void*)3),((_tmpECA->name=_tmp7E6,((_tmpECA->tvs=0,((_tmpECA->fields=
0,((_tmpECA->is_xtunion=_tmp7E7,((_tmpECA->is_flat=_tmp7E8,_tmpECA)))))))))))));
Cyc_Tc_tcTuniondecl(te,_tmp7F0,loc,_tmp7F1);tudp=Cyc_Tcenv_lookup_tuniondecl(te,
loc,_tmp7E6);if(_tmp7E3 != 0){{const char*_tmpED3;const char*_tmpED2;const char*
_tmpED1;void*_tmpED0[2];struct Cyc_String_pa_struct _tmpECF;struct Cyc_String_pa_struct
_tmpECE;(_tmpECE.tag=0,((_tmpECE.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp7E6)),((_tmpECF.tag=0,((_tmpECF.f1=(struct
_dyneither_ptr)(_tmp7E7?(struct _dyneither_ptr)((struct _dyneither_ptr)((_tmpED2="xtunion",
_tag_dyneither(_tmpED2,sizeof(char),8)))):(struct _dyneither_ptr)((_tmpED3="tunion",
_tag_dyneither(_tmpED3,sizeof(char),7)))),((_tmpED0[0]=& _tmpECF,((_tmpED0[1]=&
_tmpECE,Cyc_Tcutil_terr(loc,((_tmpED1="declare parameterized %s %s before using",
_tag_dyneither(_tmpED1,sizeof(char),41))),_tag_dyneither(_tmpED0,sizeof(void*),2)))))))))))));}
return cvtenv;}goto _LL51B;}_LL51E:;_LL51F:(void)_throw(_tmp7EF);_LL51B:;}}}if((*
tudp)->is_xtunion != _tmp7E7){const char*_tmpED7;void*_tmpED6[1];struct Cyc_String_pa_struct
_tmpED5;(_tmpED5.tag=0,((_tmpED5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp7E6)),((_tmpED6[0]=& _tmpED5,Cyc_Tcutil_terr(loc,((
_tmpED7="[x]tunion is different from type declaration %s",_tag_dyneither(_tmpED7,
sizeof(char),48))),_tag_dyneither(_tmpED6,sizeof(void*),1)))))));}{union Cyc_Absyn_TunionInfoU_union
_tmpED8;*_tmp77F=(union Cyc_Absyn_TunionInfoU_union)(((_tmpED8.KnownTunion).tag=1,(((
_tmpED8.KnownTunion).f1=tudp,_tmpED8))));}_tmp7EA=*tudp;goto _LL51A;}_LL519: if((
_tmp7E4.KnownTunion).tag != 1)goto _LL516;_tmp7E9=(_tmp7E4.KnownTunion).f1;_tmp7EA=*
_tmp7E9;_LL51A: if(_tmp7EA->is_flat  && (unsigned int)*_tmp783){const char*_tmpEDC;
void*_tmpEDB[1];struct Cyc_String_pa_struct _tmpEDA;(_tmpEDA.tag=0,((_tmpEDA.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)((
struct Cyc_Core_Opt*)_check_null(*_tmp783))->v)),((_tmpEDB[0]=& _tmpEDA,Cyc_Tcutil_terr(
loc,((_tmpEDC="flat tunion has region %s",_tag_dyneither(_tmpEDC,sizeof(char),26))),
_tag_dyneither(_tmpEDB,sizeof(void*),1)))))));}if(!_tmp7EA->is_flat  && !((
unsigned int)*_tmp783)){struct Cyc_Core_Opt*_tmpEDD;*_tmp783=((_tmpEDD=_cycalloc(
sizeof(*_tmpEDD)),((_tmpEDD->v=(void*)Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)&
Cyc_Tcutil_rk,0),_tmpEDD))));}if((unsigned int)*_tmp783){void*_tmp801=(void*)((
struct Cyc_Core_Opt*)_check_null(*_tmp783))->v;cvtenv=Cyc_Tcutil_i_check_valid_type(
loc,te,cvtenv,(void*)3,_tmp801,1);}{struct Cyc_List_List*tvs=_tmp7EA->tvs;for(0;
_tmp7E3 != 0  && tvs != 0;(_tmp7E3=_tmp7E3->tl,tvs=tvs->tl)){void*t1=(void*)_tmp7E3->hd;
void*k1=Cyc_Tcutil_tvar_kind((struct Cyc_Absyn_Tvar*)tvs->hd);cvtenv=Cyc_Tcutil_i_check_valid_type(
loc,te,cvtenv,k1,t1,1);}if(_tmp7E3 != 0){const char*_tmpEE1;void*_tmpEE0[1];struct
Cyc_String_pa_struct _tmpEDF;(_tmpEDF.tag=0,((_tmpEDF.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp7EA->name)),((_tmpEE0[0]=&
_tmpEDF,Cyc_Tcutil_terr(loc,((_tmpEE1="too many type arguments for tunion %s",
_tag_dyneither(_tmpEE1,sizeof(char),38))),_tag_dyneither(_tmpEE0,sizeof(void*),1)))))));}
...
0);{struct Cyc_List_List*_tmpEE2;hidden_ts=((_tmpEE2=_cycalloc(sizeof(*_tmpEE2)),((
_tmpEE2->hd=(void*)e,((_tmpEE2->tl=hidden_ts,_tmpEE2))))));}cvtenv=Cyc_Tcutil_i_check_valid_type(
loc,te,cvtenv,k1,e,1);}*_tmp781=Cyc_List_imp_append(*_tmp781,Cyc_List_imp_rev(
hidden_ts));}goto _LL516;}_LL516:;}goto _LL4D2;}_LL4DF: if(*((int*)_tmp773)!= 3)
goto _LL4E1;_tmp784=((struct Cyc_Absyn_TunionFieldType_struct*)_tmp773)->f1;
_tmp785=_tmp784.field_info;_tmp786=(union Cyc_Absyn_TunionFieldInfoU_union*)&(((
...
_tmp811=_tmp80E;_LL526: if(_tmp811 != Cyc_Dict_Absent)goto _LL528;_LL527:{const char*
_tmpEE6;void*_tmpEE5[1];struct Cyc_String_pa_struct _tmpEE4;(_tmpEE4.tag=0,((
_tmpEE4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp808)),((_tmpEE5[0]=& _tmpEE4,Cyc_Tcutil_terr(loc,((_tmpEE6="unbound type tunion %s",
_tag_dyneither(_tmpEE6,sizeof(char),23))),_tag_dyneither(_tmpEE5,sizeof(void*),1)))))));}
return cvtenv;_LL528:;_LL529:(void)_throw(_tmp811);_LL525:;}}}{struct
...
!= _tmp80A){const char*_tmpEEA;void*_tmpEE9[1];struct Cyc_String_pa_struct _tmpEE8;(
_tmpEE8.tag=0,((_tmpEE8.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp808)),((_tmpEE9[0]=& _tmpEE8,Cyc_Tcutil_terr(loc,((_tmpEEA="[x]tunion is different from type declaration %s",
_tag_dyneither(_tmpEEA,sizeof(char),48))),_tag_dyneither(_tmpEE9,sizeof(void*),1)))))));}
goto _LL52A;_LL52D:;_LL52E:{const char*_tmpEEF;void*_tmpEEE[2];struct Cyc_String_pa_struct
_tmpEED;struct Cyc_String_pa_struct _tmpEEC;(_tmpEEC.tag=0,((_tmpEEC.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp808)),((
_tmpEED.tag=0,((_tmpEED.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp809)),((_tmpEEE[0]=& _tmpEED,((_tmpEEE[1]=& _tmpEEC,Cyc_Tcutil_terr(loc,((
_tmpEEF="unbound field %s in type tunion %s",_tag_dyneither(_tmpEEF,sizeof(char),
35))),_tag_dyneither(_tmpEEE,sizeof(void*),2)))))))))))));}{struct Cyc_Tcutil_CVTEnv
_tmp823=cvtenv;_npop_handler(0);return _tmp823;}_LL52A:;};_pop_handler();}else{
void*_tmp816=(void*)_exn_thrown;void*_tmp825=_tmp816;_LL530: if(_tmp825 != Cyc_Dict_Absent)
goto _LL532;_LL531:{const char*_tmpEF4;void*_tmpEF3[2];struct Cyc_String_pa_struct
...
_tmp809)),((_tmpEF3[0]=& _tmpEF2,((_tmpEF3[1]=& _tmpEF1,Cyc_Tcutil_terr(loc,((
_tmpEF4="unbound field %s in type tunion %s",_tag_dyneither(_tmpEF4,sizeof(char),
35))),_tag_dyneither(_tmpEF3,sizeof(void*),2)))))))))))));}return cvtenv;_LL532:;
_LL533:(void)_throw(_tmp825);_LL52F:;}}}{union Cyc_Absyn_TunionFieldInfoU_union
_tmpEF5;*_tmp786=(union Cyc_Absyn_TunionFieldInfoU_union)(((_tmpEF5.KnownTunionfield).tag=
1,(((_tmpEF5.KnownTunionfield).f1=tud,(((_tmpEF5.KnownTunionfield).f2=tuf,
_tmpEF5))))));}_tmp80B=tud;_tmp80C=tuf;goto _LL524;}_LL523: if((_tmp806.KnownTunionfield).tag
!= 1)goto _LL520;_tmp80B=(_tmp806.KnownTunionfield).f1;_tmp80C=(_tmp806.KnownTunionfield).f2;
...
cvtenv,k1,t1,1);}if(_tmp787 != 0){const char*_tmpEFA;void*_tmpEF9[2];struct Cyc_String_pa_struct
_tmpEF8;struct Cyc_String_pa_struct _tmpEF7;(_tmpEF7.tag=0,((_tmpEF7.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp80C->name)),((
_tmpEF8.tag=0,((_tmpEF8.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp80B->name)),((_tmpEF9[0]=& _tmpEF8,((_tmpEF9[1]=& _tmpEF7,Cyc_Tcutil_terr(loc,((
_tmpEFA="too many type arguments for tunion %s.%s",_tag_dyneither(_tmpEFA,
sizeof(char),41))),_tag_dyneither(_tmpEF9,sizeof(void*),2)))))))))))));}if(tvs != 
0){const char*_tmpEFF;void*_tmpEFE[2];struct Cyc_String_pa_struct _tmpEFD;struct Cyc_String_pa_struct
_tmpEFC;(_tmpEFC.tag=0,((_tmpEFC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp80C->name)),((_tmpEFD.tag=0,((_tmpEFD.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp80B->name)),((
_tmpEFE[0]=& _tmpEFD,((_tmpEFE[1]=& _tmpEFC,Cyc_Tcutil_terr(loc,((_tmpEFF="too few type arguments for tunion %s.%s",
_tag_dyneither(_tmpEFF,sizeof(char),40))),_tag_dyneither(_tmpEFE,sizeof(void*),2)))))))))))));}
goto _LL520;}_LL520:;}goto _LL4D2;_LL4E1: if(*((int*)_tmp773)!= 4)goto _LL4E3;
_tmp788=((struct Cyc_Absyn_PointerType_struct*)_tmp773)->f1;_tmp789=(void*)
...
_tmp789)){const char*_tmpF03;void*_tmpF02[1];struct Cyc_String_pa_struct _tmpF01;(
_tmpF01.tag=0,((_tmpF01.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
_tmp789)),((_tmpF02[0]=& _tmpF01,Cyc_Tcutil_terr(loc,((_tmpF03="cannot have a pointer to zero-terminated %s elements",
_tag_dyneither(_tmpF03,sizeof(char),53))),_tag_dyneither(_tmpF02,sizeof(void*),1)))))));}
is_zero_terminated=1;goto _LL534;_LL539:;_LL53A: is_zero_terminated=0;goto _LL534;
_LL534:;}{union Cyc_Absyn_Constraint_union _tmp83A=(Cyc_Absyn_compress_conref(
...
te,_tmp83D)){const char*_tmpF06;void*_tmpF05;(_tmpF05=0,Cyc_Tcutil_terr(loc,((
_tmpF06="pointer bounds expression is not an unsigned int",_tag_dyneither(
_tmpF06,sizeof(char),49))),_tag_dyneither(_tmpF05,sizeof(void*),0)));}{
unsigned int _tmp843;int _tmp844;struct _tuple7 _tmp842=Cyc_Evexp_eval_const_uint_exp(
_tmp83D);_tmp843=_tmp842.f1;_tmp844=_tmp842.f2;if(is_zero_terminated  && (!
_tmp844  || _tmp843 < 1)){const char*_tmpF09;void*_tmpF08;(_tmpF08=0,Cyc_Tcutil_terr(
loc,((_tmpF09="zero-terminated pointer cannot point to empty sequence",
_tag_dyneither(_tmpF09,sizeof(char),55))),_tag_dyneither(_tmpF08,sizeof(void*),0)));}
goto _LL540;}}_LL547: if((_tmp83A.Forward_constr).tag != 1)goto _LL540;_LL548: {
const char*_tmpF0C;void*_tmpF0B;(_tmpF0B=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpF0C="forward constraint",
_tag_dyneither(_tmpF0C,sizeof(char),19))),_tag_dyneither(_tmpF0B,sizeof(void*),0)));}
_LL540:;}goto _LL4D2;}_LL4E3: if(*((int*)_tmp773)!= 18)goto _LL4E5;_tmp791=(void*)((
struct Cyc_Absyn_TagType_struct*)_tmp773)->f1;_LL4E4: cvtenv=Cyc_Tcutil_i_check_valid_type(
loc,te,cvtenv,(void*)7,_tmp791,1);goto _LL4D2;_LL4E5: if(*((int*)_tmp773)!= 17)
goto _LL4E7;_tmp792=((struct Cyc_Absyn_ValueofType_struct*)_tmp773)->f1;_LL4E6: {
struct _RegionHandle*_tmp849=Cyc_Tcenv_get_fnrgn(te);{struct Cyc_Tcenv_Tenv*
_tmp84A=Cyc_Tcenv_allow_valueof(_tmp849,te);Cyc_Tcexp_tcExp(_tmp84A,0,_tmp792);}
if(!Cyc_Tcutil_coerce_uint_typ(te,_tmp792)){const char*_tmpF0F;void*_tmpF0E;(
_tmpF0E=0,Cyc_Tcutil_terr(loc,((_tmpF0F="valueof_t requires an int expression",
_tag_dyneither(_tmpF0F,sizeof(char),37))),_tag_dyneither(_tmpF0E,sizeof(void*),0)));}
cvtenv=Cyc_Tcutil_i_check_valid_type_level_exp(_tmp792,te,cvtenv);goto _LL4D2;}
_LL4E7: if(*((int*)_tmp773)!= 5)goto _LL4E9;_LL4E8: goto _LL4EA;_LL4E9: if((int)
_tmp773 != 1)goto _LL4EB;_LL4EA: goto _LL4EC;_LL4EB: if(_tmp773 <= (void*)4)goto _LL4F9;
if(*((int*)_tmp773)!= 6)goto _LL4ED;_LL4EC: goto _LL4D2;_LL4ED: if(*((int*)_tmp773)
!= 7)goto _LL4EF;_tmp793=((struct Cyc_Absyn_ArrayType_struct*)_tmp773)->f1;_tmp794=(
void*)_tmp793.elt_type;_tmp795=_tmp793.tq;_tmp796=(struct Cyc_Absyn_Tqual*)&(((
...
if(_tmp84F != 1)goto _LL54E;_LL54D: if(!Cyc_Tcutil_admits_zero(_tmp794)){const char*
_tmpF13;void*_tmpF12[1];struct Cyc_String_pa_struct _tmpF11;(_tmpF11.tag=0,((
_tmpF11.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
_tmp794)),((_tmpF12[0]=& _tmpF11,Cyc_Tcutil_terr(loc,((_tmpF13="cannot have a zero-terminated array of %s elements",
_tag_dyneither(_tmpF13,sizeof(char),51))),_tag_dyneither(_tmpF12,sizeof(void*),1)))))));}
is_zero_terminated=1;goto _LL549;_LL54E:;_LL54F: is_zero_terminated=0;goto _LL549;
_LL549:;}if(_tmp84D == 0){if(is_zero_terminated)*_tmp798=(_tmp84D=(struct Cyc_Absyn_Exp*)
Cyc_Absyn_uint_exp(1,0));else{{const char*_tmpF16;void*_tmpF15;(_tmpF15=0,Cyc_Tcutil_warn(
loc,((_tmpF16="array bound defaults to 1 here",_tag_dyneither(_tmpF16,sizeof(
char),31))),_tag_dyneither(_tmpF15,sizeof(void*),0)));}*_tmp798=(_tmp84D=(struct
Cyc_Absyn_Exp*)Cyc_Absyn_uint_exp(1,0));}}Cyc_Tcexp_tcExp(te,0,(struct Cyc_Absyn_Exp*)
_tmp84D);if(!Cyc_Tcutil_is_const_exp(te,(struct Cyc_Absyn_Exp*)_tmp84D)){const
char*_tmpF19;void*_tmpF18;(_tmpF18=0,Cyc_Tcutil_terr(loc,((_tmpF19="array bounds expression is not constant",
_tag_dyneither(_tmpF19,sizeof(char),40))),_tag_dyneither(_tmpF18,sizeof(void*),0)));}
if(!Cyc_Tcutil_coerce_uint_typ(te,(struct Cyc_Absyn_Exp*)_tmp84D)){const char*
_tmpF1C;void*_tmpF1B;(_tmpF1B=0,Cyc_Tcutil_terr(loc,((_tmpF1C="array bounds expression is not an unsigned int",
_tag_dyneither(_tmpF1C,sizeof(char),47))),_tag_dyneither(_tmpF1B,sizeof(void*),0)));}{
unsigned int _tmp85A;int _tmp85B;struct _tuple7 _tmp859=Cyc_Evexp_eval_const_uint_exp((
struct Cyc_Absyn_Exp*)_tmp84D);_tmp85A=_tmp859.f1;_tmp85B=_tmp859.f2;if((
is_zero_terminated  && _tmp85B) && _tmp85A < 1){const char*_tmpF1F;void*_tmpF1E;(
_tmpF1E=0,Cyc_Tcutil_warn(loc,((_tmpF1F="zero terminated array cannot have zero elements",
_tag_dyneither(_tmpF1F,sizeof(char),48))),_tag_dyneither(_tmpF1E,sizeof(void*),0)));}
if((_tmp85B  && _tmp85A < 1) && Cyc_Cyclone_tovc_r){{const char*_tmpF22;void*
_tmpF21;(_tmpF21=0,Cyc_Tcutil_warn(loc,((_tmpF22="arrays with 0 elements are not supported except with gcc -- changing to 1.",
_tag_dyneither(_tmpF22,sizeof(char),75))),_tag_dyneither(_tmpF21,sizeof(void*),0)));}*
_tmp798=(struct Cyc_Absyn_Exp*)Cyc_Absyn_uint_exp(1,0);}goto _LL4D2;}}}_LL4EF: if(*((
int*)_tmp773)!= 8)goto _LL4F1;_tmp79B=((struct Cyc_Absyn_FnType_struct*)_tmp773)->f1;
_tmp79C=_tmp79B.tvars;_tmp79D=(struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_struct*)
...
if(!Cyc_Absyn_fntype_att((void*)_tmp7A5->hd)){const char*_tmpF26;void*_tmpF25[1];
struct Cyc_String_pa_struct _tmpF24;(_tmpF24.tag=0,((_tmpF24.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)_tmp7A5->hd)),((
_tmpF25[0]=& _tmpF24,Cyc_Tcutil_terr(loc,((_tmpF26="bad function type attribute %s",
_tag_dyneither(_tmpF26,sizeof(char),31))),_tag_dyneither(_tmpF25,sizeof(void*),1)))))));}{
void*_tmp863=(void*)_tmp7A5->hd;void*_tmp864;int _tmp865;int _tmp866;_LL551: if((
int)_tmp863 != 0)goto _LL553;_LL552: if(!seen_stdcall){seen_stdcall=1;++ num_convs;}
goto _LL550;_LL553: if((int)_tmp863 != 1)goto _LL555;_LL554: if(!seen_cdecl){
seen_cdecl=1;++ num_convs;}goto _LL550;_LL555: if((int)_tmp863 != 2)goto _LL557;
_LL556: if(!seen_fastcall){seen_fastcall=1;++ num_convs;}goto _LL550;_LL557: if(
_tmp863 <= (void*)17)goto _LL559;if(*((int*)_tmp863)!= 3)goto _LL559;_tmp864=(void*)((
struct Cyc_Absyn_Format_att_struct*)_tmp863)->f1;_tmp865=((struct Cyc_Absyn_Format_att_struct*)
_tmp863)->f2;_tmp866=((struct Cyc_Absyn_Format_att_struct*)_tmp863)->f3;_LL558:
if(!seen_format){seen_format=1;ft=_tmp864;fmt_desc_arg=_tmp865;fmt_arg_start=
_tmp866;}else{const char*_tmpF29;void*_tmpF28;(_tmpF28=0,Cyc_Tcutil_terr(loc,((
_tmpF29="function can't have multiple format attributes",_tag_dyneither(_tmpF29,
sizeof(char),47))),_tag_dyneither(_tmpF28,sizeof(void*),0)));}goto _LL550;_LL559:;
_LL55A: goto _LL550;_LL550:;}}if(num_convs > 1){const char*_tmpF2C;void*_tmpF2B;(
_tmpF2B=0,Cyc_Tcutil_terr(loc,((_tmpF2C="function can't have multiple calling conventions",
_tag_dyneither(_tmpF2C,sizeof(char),49))),_tag_dyneither(_tmpF2B,sizeof(void*),0)));}
Cyc_Tcutil_check_unique_tvars(loc,*_tmp79D);{struct Cyc_List_List*b=*_tmp79D;for(
...
const char*_tmpF30;void*_tmpF2F[1];struct Cyc_String_pa_struct _tmpF2E;(_tmpF2E.tag=
0,((_tmpF2E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)
b->hd)->name),((_tmpF2F[0]=& _tmpF2E,Cyc_Tcutil_terr(loc,((_tmpF30="function attempts to abstract Mem type variable %s",
_tag_dyneither(_tmpF30,sizeof(char),51))),_tag_dyneither(_tmpF2F,sizeof(void*),1)))))));}
goto _LL55B;_LL55E:;_LL55F: goto _LL55B;_LL55B:;}}}{struct _RegionHandle*_tmp870=Cyc_Tcenv_get_fnrgn(
te);{struct Cyc_Tcutil_CVTEnv _tmpF31;struct Cyc_Tcutil_CVTEnv _tmp871=(_tmpF31.r=
_tmp870,((_tmpF31.kind_env=cvtenv.kind_env,((_tmpF31.free_vars=0,((_tmpF31.free_evars=
0,((_tmpF31.generalize_evars=cvtenv.generalize_evars,((_tmpF31.fn_result=1,
_tmpF31)))))))))));_tmp871=Cyc_Tcutil_i_check_valid_type(loc,te,_tmp871,(void*)1,
...
if(_tmp7A3 != 0){if(_tmp7A2){const char*_tmpF34;void*_tmpF33;(_tmpF33=0,((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpF34="both c_vararg and cyc_vararg",
_tag_dyneither(_tmpF34,sizeof(char),29))),_tag_dyneither(_tmpF33,sizeof(void*),0)));}{
void*_tmp877;int _tmp878;struct Cyc_Absyn_VarargInfo _tmp876=*_tmp7A3;_tmp877=(void*)
_tmp876.type;_tmp878=_tmp876.inject;_tmp871=Cyc_Tcutil_i_check_valid_type(loc,te,
_tmp871,(void*)1,_tmp877,1);(_tmp7A3->tq).real_const=Cyc_Tcutil_extract_const_from_typedef(
...
_LL562: if((*_tmp87C)->is_flat){const char*_tmpF37;void*_tmpF36;(_tmpF36=0,Cyc_Tcutil_terr(
loc,((_tmpF37="cant inject into a flat tunion",_tag_dyneither(_tmpF37,sizeof(
char),31))),_tag_dyneither(_tmpF36,sizeof(void*),0)));}goto _LL560;_LL563:;_LL564:{
const char*_tmpF3A;void*_tmpF39;(_tmpF39=0,Cyc_Tcutil_terr(loc,((_tmpF3A="can't inject a non-[x]tunion type",
_tag_dyneither(_tmpF3A,sizeof(char),34))),_tag_dyneither(_tmpF39,sizeof(void*),0)));}
goto _LL560;_LL560:;}}}if(seen_format){int _tmp881=((int(*)(struct Cyc_List_List*x))
Cyc_List_length)(_tmp7A1);if((((fmt_desc_arg < 0  || fmt_desc_arg > _tmp881) || 
fmt_arg_start < 0) || _tmp7A3 == 0  && fmt_arg_start != 0) || _tmp7A3 != 0  && 
fmt_arg_start != _tmp881 + 1){const char*_tmpF3D;void*_tmpF3C;(_tmpF3C=0,Cyc_Tcutil_terr(
loc,((_tmpF3D="bad format descriptor",_tag_dyneither(_tmpF3D,sizeof(char),22))),
_tag_dyneither(_tmpF3C,sizeof(void*),0)));}else{void*_tmp885;struct _tuple3
...
_tmp889.bounds;_tmp88B=_tmp889.zero_term;_LL567:{struct _tuple0 _tmpF3E;struct
_tuple0 _tmp88D=(_tmpF3E.f1=Cyc_Tcutil_compress(_tmp888),((_tmpF3E.f2=Cyc_Absyn_conref_def((
void*)((void*)0),_tmp88A),_tmpF3E)));void*_tmp88E;void*_tmp88F;void*_tmp890;void*
...
0)goto _LL56D;_LL56C: goto _LL56A;_LL56D:;_LL56E:{const char*_tmpF41;void*_tmpF40;(
_tmpF40=0,Cyc_Tcutil_terr(loc,((_tmpF41="format descriptor is not a char ? type",
_tag_dyneither(_tmpF41,sizeof(char),39))),_tag_dyneither(_tmpF40,sizeof(void*),0)));}
goto _LL56A;_LL56A:;}goto _LL565;_LL568:;_LL569:{const char*_tmpF44;void*_tmpF43;(
_tmpF43=0,Cyc_Tcutil_terr(loc,((_tmpF44="format descriptor is not a char ? type",
_tag_dyneither(_tmpF44,sizeof(char),39))),_tag_dyneither(_tmpF43,sizeof(void*),0)));}
goto _LL565;_LL565:;}if(fmt_arg_start != 0){int problem;{struct _tuple0 _tmpF45;
struct _tuple0 _tmp897=(_tmpF45.f1=ft,((_tmpF45.f2=Cyc_Tcutil_compress((void*)((
struct Cyc_Absyn_VarargInfo*)_check_null(_tmp7A3))->type),_tmpF45)));void*_tmp898;
void*_tmp899;struct Cyc_Absyn_TunionInfo _tmp89A;union Cyc_Absyn_TunionInfoU_union
_tmp89B;struct Cyc_Absyn_Tuniondecl**_tmp89C;struct Cyc_Absyn_Tuniondecl*_tmp89D;
void*_tmp89E;void*_tmp89F;struct Cyc_Absyn_TunionInfo _tmp8A0;union Cyc_Absyn_TunionInfoU_union
_tmp8A1;struct Cyc_Absyn_Tuniondecl**_tmp8A2;struct Cyc_Absyn_Tuniondecl*_tmp8A3;
_LL570: _tmp898=_tmp897.f1;if((int)_tmp898 != 0)goto _LL572;_tmp899=_tmp897.f2;if(
_tmp899 <= (void*)4)goto _LL572;if(*((int*)_tmp899)!= 2)goto _LL572;_tmp89A=((
struct Cyc_Absyn_TunionType_struct*)_tmp899)->f1;_tmp89B=_tmp89A.tunion_info;if((((((
struct Cyc_Absyn_TunionType_struct*)_tmp899)->f1).tunion_info).KnownTunion).tag != 
1)goto _LL572;_tmp89C=(_tmp89B.KnownTunion).f1;_tmp89D=*_tmp89C;_LL571: problem=
Cyc_Absyn_qvar_cmp(_tmp89D->name,Cyc_Absyn_tunion_print_arg_qvar)!= 0;goto _LL56F;
_LL572: _tmp89E=_tmp897.f1;if((int)_tmp89E != 1)goto _LL574;_tmp89F=_tmp897.f2;if(
_tmp89F <= (void*)4)goto _LL574;if(*((int*)_tmp89F)!= 2)goto _LL574;_tmp8A0=((
struct Cyc_Absyn_TunionType_struct*)_tmp89F)->f1;_tmp8A1=_tmp8A0.tunion_info;if((((((
struct Cyc_Absyn_TunionType_struct*)_tmp89F)->f1).tunion_info).KnownTunion).tag != 
...
_LL574:;_LL575: problem=1;goto _LL56F;_LL56F:;}if(problem){const char*_tmpF48;void*
_tmpF47;(_tmpF47=0,Cyc_Tcutil_terr(loc,((_tmpF48="format attribute and vararg types don't match",
_tag_dyneither(_tmpF48,sizeof(char),46))),_tag_dyneither(_tmpF47,sizeof(void*),0)));}}}}{
struct Cyc_List_List*rpo=_tmp7A4;for(0;rpo != 0;rpo=rpo->tl){struct _tuple0 _tmp8A7;
void*_tmp8A8;void*_tmp8A9;struct _tuple0*_tmp8A6=(struct _tuple0*)rpo->hd;_tmp8A7=*
_tmp8A6;_tmp8A8=_tmp8A7.f1;_tmp8A9=_tmp8A7.f2;_tmp871=Cyc_Tcutil_i_check_valid_type(
...
void*)3  || _tmp8B4 == (void*)4) || _tmp8B4 == (void*)5))goto _LL57D;_LL57C:{struct
Cyc_Absyn_AccessEff_struct*_tmpF57;struct Cyc_Absyn_VarType_struct*_tmpF56;struct
Cyc_Absyn_VarType_struct _tmpF55;struct Cyc_Absyn_AccessEff_struct _tmpF54;struct
Cyc_List_List*_tmpF53;effect=((_tmpF53=_cycalloc(sizeof(*_tmpF53)),((_tmpF53->hd=(
void*)((void*)((_tmpF57=_cycalloc(sizeof(*_tmpF57)),((_tmpF57[0]=((_tmpF54.tag=
19,((_tmpF54.f1=(void*)((void*)((_tmpF56=_cycalloc(sizeof(*_tmpF56)),((_tmpF56[0]=((
_tmpF55.tag=1,((_tmpF55.f1=_tmp8AB,_tmpF55)))),_tmpF56))))),_tmpF54)))),_tmpF57))))),((
_tmpF53->tl=effect,_tmpF53))))));}goto _LL576;_LL57D: if(*((int*)_tmp8AD)!= 2)goto
_LL57F;_tmp8B5=(void*)((struct Cyc_Absyn_Less_kb_struct*)_tmp8AD)->f2;if((int)
_tmp8B5 != 7)goto _LL57F;_LL57E: goto _LL580;_LL57F: if(*((int*)_tmp8AD)!= 0)goto
_LL581;_tmp8B6=(void*)((struct Cyc_Absyn_Eq_kb_struct*)_tmp8AD)->f1;if((int)
_tmp8B6 != 7)goto _LL581;_LL580: goto _LL576;_LL581: if(*((int*)_tmp8AD)!= 2)goto
_LL583;_tmp8B7=((struct Cyc_Absyn_Less_kb_struct*)_tmp8AD)->f1;_tmp8B8=(struct Cyc_Core_Opt**)&((
struct Cyc_Absyn_Less_kb_struct*)_tmp8AD)->f1;_tmp8B9=(void*)((struct Cyc_Absyn_Less_kb_struct*)
_tmp8AD)->f2;if((int)_tmp8B9 != 6)goto _LL583;_LL582:*_tmp8B8=Cyc_Tcutil_kind_to_bound_opt((
void*)6);goto _LL584;_LL583: if(*((int*)_tmp8AD)!= 0)goto _LL585;_tmp8BA=(void*)((
struct Cyc_Absyn_Eq_kb_struct*)_tmp8AD)->f1;if((int)_tmp8BA != 6)goto _LL585;_LL584:{
struct Cyc_Absyn_VarType_struct*_tmpF5D;struct Cyc_Absyn_VarType_struct _tmpF5C;
struct Cyc_List_List*_tmpF5B;effect=((_tmpF5B=_cycalloc(sizeof(*_tmpF5B)),((
_tmpF5B->hd=(void*)((void*)((_tmpF5D=_cycalloc(sizeof(*_tmpF5D)),((_tmpF5D[0]=((
_tmpF5C.tag=1,((_tmpF5C.f1=_tmp8AB,_tmpF5C)))),_tmpF5D))))),((_tmpF5B->tl=effect,
_tmpF5B))))));}goto _LL576;_LL585: if(*((int*)_tmp8AD)!= 1)goto _LL587;_tmp8BB=((
struct Cyc_Absyn_Unknown_kb_struct*)_tmp8AD)->f1;_tmp8BC=(struct Cyc_Core_Opt**)&((
struct Cyc_Absyn_Unknown_kb_struct*)_tmp8AD)->f1;_LL586:{struct Cyc_Absyn_Less_kb_struct*
_tmpF63;struct Cyc_Absyn_Less_kb_struct _tmpF62;struct Cyc_Core_Opt*_tmpF61;*
_tmp8BC=((_tmpF61=_cycalloc(sizeof(*_tmpF61)),((_tmpF61->v=(void*)((void*)((
_tmpF63=_cycalloc(sizeof(*_tmpF63)),((_tmpF63[0]=((_tmpF62.tag=2,((_tmpF62.f1=0,((
_tmpF62.f2=(void*)((void*)0),_tmpF62)))))),_tmpF63))))),_tmpF61))));}goto _LL588;
_LL587:;_LL588:{struct Cyc_Absyn_RgnsEff_struct*_tmpF72;struct Cyc_Absyn_VarType_struct*
_tmpF71;struct Cyc_Absyn_VarType_struct _tmpF70;struct Cyc_Absyn_RgnsEff_struct
_tmpF6F;struct Cyc_List_List*_tmpF6E;effect=((_tmpF6E=_cycalloc(sizeof(*_tmpF6E)),((
_tmpF6E->hd=(void*)((void*)((_tmpF72=_cycalloc(sizeof(*_tmpF72)),((_tmpF72[0]=((
_tmpF6F.tag=21,((_tmpF6F.f1=(void*)((void*)((_tmpF71=_cycalloc(sizeof(*_tmpF71)),((
_tmpF71[0]=((_tmpF70.tag=1,((_tmpF70.f1=_tmp8AB,_tmpF70)))),_tmpF71))))),_tmpF6F)))),
_tmpF72))))),((_tmpF6E->tl=effect,_tmpF6E))))));}goto _LL576;_LL576:;}}}{struct
Cyc_List_List*ts=_tmp871.free_evars;for(0;ts != 0;ts=ts->tl){void*_tmp8CE;int
_tmp8CF;struct _tuple19 _tmp8CD=*((struct _tuple19*)ts->hd);_tmp8CE=_tmp8CD.f1;
_tmp8CF=_tmp8CD.f2;if(!_tmp8CF)continue;{void*_tmp8D0=Cyc_Tcutil_typ_kind(
_tmp8CE);_LL58A: if((int)_tmp8D0 != 5)goto _LL58C;_LL58B: goto _LL58D;_LL58C: if((int)
_tmp8D0 != 4)goto _LL58E;_LL58D: goto _LL58F;_LL58E: if((int)_tmp8D0 != 3)goto _LL590;
_LL58F:{struct Cyc_Absyn_AccessEff_struct*_tmpF78;struct Cyc_Absyn_AccessEff_struct
_tmpF77;struct Cyc_List_List*_tmpF76;effect=((_tmpF76=_cycalloc(sizeof(*_tmpF76)),((
_tmpF76->hd=(void*)((void*)((_tmpF78=_cycalloc(sizeof(*_tmpF78)),((_tmpF78[0]=((
_tmpF77.tag=19,((_tmpF77.f1=(void*)_tmp8CE,_tmpF77)))),_tmpF78))))),((_tmpF76->tl=
effect,_tmpF76))))));}goto _LL589;_LL590: if((int)_tmp8D0 != 6)goto _LL592;_LL591:{
struct Cyc_List_List*_tmpF79;effect=((_tmpF79=_cycalloc(sizeof(*_tmpF79)),((
_tmpF79->hd=(void*)_tmp8CE,((_tmpF79->tl=effect,_tmpF79))))));}goto _LL589;_LL592:
if((int)_tmp8D0 != 7)goto _LL594;_LL593: goto _LL589;_LL594:;_LL595:{struct Cyc_Absyn_RgnsEff_struct*
_tmpF7F;struct Cyc_Absyn_RgnsEff_struct _tmpF7E;struct Cyc_List_List*_tmpF7D;effect=((
_tmpF7D=_cycalloc(sizeof(*_tmpF7D)),((_tmpF7D->hd=(void*)((void*)((_tmpF7F=
_cycalloc(sizeof(*_tmpF7F)),((_tmpF7F[0]=((_tmpF7E.tag=21,((_tmpF7E.f1=(void*)
_tmp8CE,_tmpF7E)))),_tmpF7F))))),((_tmpF7D->tl=effect,_tmpF7D))))));}goto _LL589;
_LL589:;}}}{struct Cyc_Absyn_JoinEff_struct*_tmpF85;struct Cyc_Absyn_JoinEff_struct
_tmpF84;struct Cyc_Core_Opt*_tmpF83;*_tmp79F=((_tmpF83=_cycalloc(sizeof(*_tmpF83)),((
_tmpF83->v=(void*)((void*)((_tmpF85=_cycalloc(sizeof(*_tmpF85)),((_tmpF85[0]=((
_tmpF84.tag=20,((_tmpF84.f1=effect,_tmpF84)))),_tmpF85))))),_tmpF83))));}}if(*
_tmp79D != 0){struct Cyc_List_List*bs=*_tmp79D;for(0;bs != 0;bs=bs->tl){void*
_tmp8DB=Cyc_Absyn_compress_kb((void*)((struct Cyc_Absyn_Tvar*)bs->hd)->kind);
struct Cyc_Core_Opt*_tmp8DC;struct Cyc_Core_Opt**_tmp8DD;struct Cyc_Core_Opt*
_tmp8DE;struct Cyc_Core_Opt**_tmp8DF;void*_tmp8E0;struct Cyc_Core_Opt*_tmp8E1;
struct Cyc_Core_Opt**_tmp8E2;void*_tmp8E3;struct Cyc_Core_Opt*_tmp8E4;struct Cyc_Core_Opt**
_tmp8E5;void*_tmp8E6;struct Cyc_Core_Opt*_tmp8E7;struct Cyc_Core_Opt**_tmp8E8;void*
_tmp8E9;void*_tmp8EA;_LL597: if(*((int*)_tmp8DB)!= 1)goto _LL599;_tmp8DC=((struct
Cyc_Absyn_Unknown_kb_struct*)_tmp8DB)->f1;_tmp8DD=(struct Cyc_Core_Opt**)&((
struct Cyc_Absyn_Unknown_kb_struct*)_tmp8DB)->f1;_LL598:{const char*_tmpF89;void*
_tmpF88[1];struct Cyc_String_pa_struct _tmpF87;(_tmpF87.tag=0,((_tmpF87.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)bs->hd)->name),((
_tmpF88[0]=& _tmpF87,Cyc_Tcutil_warn(loc,((_tmpF89="Type variable %s unconstrained, assuming boxed",
_tag_dyneither(_tmpF89,sizeof(char),47))),_tag_dyneither(_tmpF88,sizeof(void*),1)))))));}
_tmp8DF=_tmp8DD;goto _LL59A;_LL599: if(*((int*)_tmp8DB)!= 2)goto _LL59B;_tmp8DE=((
struct Cyc_Absyn_Less_kb_struct*)_tmp8DB)->f1;_tmp8DF=(struct Cyc_Core_Opt**)&((
...
_tmp8DB)->f1;if((int)_tmp8EA != 1)goto _LL5A3;_LL5A2:{const char*_tmpF8C;void*
_tmpF8B;(_tmpF8B=0,Cyc_Tcutil_terr(loc,((_tmpF8C="functions can't abstract M types",
_tag_dyneither(_tmpF8C,sizeof(char),33))),_tag_dyneither(_tmpF8B,sizeof(void*),0)));}
goto _LL596;_LL5A3:;_LL5A4: goto _LL596;_LL596:;}}cvtenv.kind_env=Cyc_Tcutil_remove_bound_tvars(
...
const char*_tmpF90;void*_tmpF8F[1];struct Cyc_String_pa_struct _tmpF8E;(_tmpF8E.tag=
0,((_tmpF8E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp8FB),((_tmpF8F[
0]=& _tmpF8E,Cyc_Tcutil_terr(loc,((_tmpF90="duplicate field %s",_tag_dyneither(
_tmpF90,sizeof(char),19))),_tag_dyneither(_tmpF8F,sizeof(void*),1)))))));}{const
char*_tmpF91;if(Cyc_strcmp((struct _dyneither_ptr)*_tmp8FB,((_tmpF91="",
_tag_dyneither(_tmpF91,sizeof(char),1))))!= 0){struct Cyc_List_List*_tmpF92;
prev_fields=((_tmpF92=_region_malloc(_tmp8F8,sizeof(*_tmpF92)),((_tmpF92->hd=
_tmp8FB,((_tmpF92->tl=prev_fields,_tmpF92))))));}}cvtenv=Cyc_Tcutil_i_check_valid_type(
...
_tmp8FE)){const char*_tmpF96;void*_tmpF95[1];struct Cyc_String_pa_struct _tmpF94;(
_tmpF94.tag=0,((_tmpF94.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp8FB),((
_tmpF95[0]=& _tmpF94,Cyc_Tcutil_warn(loc,((_tmpF96="union member %s is not `bits-only' so it can only be written and not read",
_tag_dyneither(_tmpF96,sizeof(char),74))),_tag_dyneither(_tmpF95,sizeof(void*),1)))))));}
Cyc_Tcutil_check_bitfield(loc,te,_tmp8FE,_tmp8FF,_tmp8FB);Cyc_Tcutil_check_field_atts(
...
te,loc,_tmp90B);{union Cyc_Absyn_AggrInfoU_union _tmpF97;*_tmp7AB=(union Cyc_Absyn_AggrInfoU_union)(((
_tmpF97.KnownAggr).tag=1,(((_tmpF97.KnownAggr).f1=adp,_tmpF97))));};_pop_handler();}
else{void*_tmp90F=(void*)_exn_thrown;void*_tmp913=_tmp90F;_LL5AB: if(_tmp913 != 
Cyc_Dict_Absent)goto _LL5AD;_LL5AC: {struct Cyc_Tcenv_Genv*_tmp914=((struct Cyc_Tcenv_Genv*(*)(
struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(te->ae,te->ns);
struct Cyc_Absyn_Aggrdecl*_tmpF98;struct Cyc_Absyn_Aggrdecl*_tmp915=(_tmpF98=
_cycalloc(sizeof(*_tmpF98)),((_tmpF98->kind=(void*)_tmp90A,((_tmpF98->sc=(void*)((
void*)3),((_tmpF98->name=_tmp90B,((_tmpF98->tvs=0,((_tmpF98->impl=0,((_tmpF98->attributes=
0,_tmpF98)))))))))))));Cyc_Tc_tcAggrdecl(te,_tmp914,loc,_tmp915);adp=Cyc_Tcenv_lookup_aggrdecl(
te,loc,_tmp90B);{union Cyc_Absyn_AggrInfoU_union _tmpF99;*_tmp7AB=(union Cyc_Absyn_AggrInfoU_union)(((
_tmpF99.KnownAggr).tag=1,(((_tmpF99.KnownAggr).f1=adp,_tmpF99))));}if(*_tmp7AD != 
0){{const char*_tmpF9D;void*_tmpF9C[1];struct Cyc_String_pa_struct _tmpF9B;(_tmpF9B.tag=
0,((_tmpF9B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp90B)),((_tmpF9C[0]=& _tmpF9B,Cyc_Tcutil_terr(loc,((_tmpF9D="declare parameterized type %s before using",
_tag_dyneither(_tmpF9D,sizeof(char),43))),_tag_dyneither(_tmpF9C,sizeof(void*),1)))))));}
return cvtenv;}goto _LL5AA;}_LL5AD:;_LL5AE:(void)_throw(_tmp913);_LL5AA:;}}}
...
char*_tmpFA1;void*_tmpFA0[1];struct Cyc_String_pa_struct _tmpF9F;(_tmpF9F.tag=0,((
_tmpF9F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp90D->name)),((_tmpFA0[0]=& _tmpF9F,Cyc_Tcutil_terr(loc,((_tmpFA1="too many parameters for type %s",
_tag_dyneither(_tmpFA1,sizeof(char),32))),_tag_dyneither(_tmpFA0,sizeof(void*),1)))))));}
if(tvs != 0){struct Cyc_List_List*hidden_ts=0;for(0;tvs != 0;tvs=tvs->tl){void*k=
Cyc_Tcutil_tvar_kind((struct Cyc_Absyn_Tvar*)tvs->hd);void*e=Cyc_Absyn_new_evar(0,
0);{struct Cyc_List_List*_tmpFA2;hidden_ts=((_tmpFA2=_cycalloc(sizeof(*_tmpFA2)),((
_tmpFA2->hd=(void*)e,((_tmpFA2->tl=hidden_ts,_tmpFA2))))));}cvtenv=Cyc_Tcutil_i_check_valid_type(
...
goto _LL5B2;_LL5B1:{const char*_tmpFA6;void*_tmpFA5[1];struct Cyc_String_pa_struct
_tmpFA4;(_tmpFA4.tag=0,((_tmpFA4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp7AE)),((_tmpFA5[0]=& _tmpFA4,Cyc_Tcutil_terr(loc,((
_tmpFA6="unbound typedef name %s",_tag_dyneither(_tmpFA6,sizeof(char),24))),
_tag_dyneither(_tmpFA5,sizeof(void*),1)))))));}return cvtenv;_LL5B2:;_LL5B3:(void)
_throw(_tmp923);_LL5AF:;}}}*_tmp7B2=(struct Cyc_Absyn_Typedefdecl*)td;_tmp7AE[0]=(
td->name)[_check_known_subscript_notnull(1,0)];{struct Cyc_List_List*tvs=td->tvs;
struct Cyc_List_List*ts=targs;struct _RegionHandle*_tmp927=Cyc_Tcenv_get_fnrgn(te);{
...
loc,te,cvtenv,k,(void*)ts->hd,1);{struct _tuple8*_tmpFA9;struct Cyc_List_List*
_tmpFA8;inst=((_tmpFA8=_region_malloc(_tmp927,sizeof(*_tmpFA8)),((_tmpFA8->hd=((
_tmpFA9=_region_malloc(_tmp927,sizeof(*_tmpFA9)),((_tmpFA9->f1=(struct Cyc_Absyn_Tvar*)
tvs->hd,((_tmpFA9->f2=(void*)ts->hd,_tmpFA9)))))),((_tmpFA8->tl=inst,_tmpFA8))))));}}
if(ts != 0){const char*_tmpFAD;void*_tmpFAC[1];struct Cyc_String_pa_struct _tmpFAB;(
_tmpFAB.tag=0,((_tmpFAB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp7AE)),((_tmpFAC[0]=& _tmpFAB,Cyc_Tcutil_terr(loc,((_tmpFAD="too many parameters for typedef %s",
_tag_dyneither(_tmpFAD,sizeof(char),35))),_tag_dyneither(_tmpFAC,sizeof(void*),1)))))));}
if(tvs != 0){struct Cyc_List_List*hidden_ts=0;for(0;tvs != 0;tvs=tvs->tl){void*k=
Cyc_Tcutil_tvar_kind((struct Cyc_Absyn_Tvar*)tvs->hd);void*e=Cyc_Absyn_new_evar(0,
0);{struct Cyc_List_List*_tmpFAE;hidden_ts=((_tmpFAE=_cycalloc(sizeof(*_tmpFAE)),((
_tmpFAE->hd=(void*)e,((_tmpFAE->tl=hidden_ts,_tmpFAE))))));}cvtenv=Cyc_Tcutil_i_check_valid_type(
loc,te,cvtenv,k,e,1);{struct _tuple8*_tmpFB1;struct Cyc_List_List*_tmpFB0;inst=(
struct Cyc_List_List*)((_tmpFB0=_cycalloc(sizeof(*_tmpFB0)),((_tmpFB0->hd=(struct
_tuple8*)((_tmpFB1=_cycalloc(sizeof(*_tmpFB1)),((_tmpFB1->f1=(struct Cyc_Absyn_Tvar*)
tvs->hd,((_tmpFB1->f2=e,_tmpFB1)))))),((_tmpFB0->tl=inst,_tmpFB0))))));}}*
_tmp7B0=Cyc_List_imp_append(targs,Cyc_List_imp_rev(hidden_ts));}if(td->defn != 0){
void*new_typ=Cyc_Tcutil_rsubstitute(_tmp927,inst,(void*)((struct Cyc_Core_Opt*)
_check_null(td->defn))->v);void**_tmpFB2;*_tmp7B4=((_tmpFB2=_cycalloc(sizeof(*
_tmpFB2)),((_tmpFB2[0]=new_typ,_tmpFB2))));}}goto _LL4D2;}}_LL4F9: if((int)_tmp773
!= 3)goto _LL4FB;_LL4FA: goto _LL4FC;_LL4FB: if((int)_tmp773 != 2)goto _LL4FD;_LL4FC:
goto _LL4D2;_LL4FD: if(_tmp773 <= (void*)4)goto _LL4FF;if(*((int*)_tmp773)!= 14)goto
_LL4FF;_tmp7B5=(void*)((struct Cyc_Absyn_RgnHandleType_struct*)_tmp773)->f1;
_LL4FE: cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,(void*)5,_tmp7B5,1);
goto _LL4D2;_LL4FF: if(_tmp773 <= (void*)4)goto _LL501;if(*((int*)_tmp773)!= 15)goto
_LL501;_tmp7B6=(void*)((struct Cyc_Absyn_DynRgnType_struct*)_tmp773)->f1;_tmp7B7=(
void*)((struct Cyc_Absyn_DynRgnType_struct*)_tmp773)->f2;_LL500: cvtenv=Cyc_Tcutil_i_check_valid_type(
loc,te,cvtenv,(void*)3,_tmp7B6,0);cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,
cvtenv,(void*)3,_tmp7B7,1);goto _LL4D2;_LL501: if(_tmp773 <= (void*)4)goto _LL503;
if(*((int*)_tmp773)!= 19)goto _LL503;_tmp7B8=(void*)((struct Cyc_Absyn_AccessEff_struct*)
...
void*_tmp936;_LL5BA: if(_tmp934 != 0)goto _LL5BC;_LL5BB:{const char*_tmpFB3;s=((
_tmpFB3="kind=NULL ",_tag_dyneither(_tmpFB3,sizeof(char),11)));}goto _LL5B9;
_LL5BC: if(_tmp934 == 0)goto _LL5B9;_tmp935=*_tmp934;_tmp936=(void*)_tmp935.v;
_LL5BD:{const char*_tmpFB7;void*_tmpFB6[1];struct Cyc_String_pa_struct _tmpFB5;s=(
struct _dyneither_ptr)((_tmpFB5.tag=0,((_tmpFB5.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_kind2string(_tmp936)),((_tmpFB6[0]=& _tmpFB5,Cyc_aprintf(((
_tmpFB7="kind=%s ",_tag_dyneither(_tmpFB7,sizeof(char),9))),_tag_dyneither(
_tmpFB6,sizeof(void*),1))))))));}goto _LL5B9;_LL5B9:;}{struct Cyc_Core_Opt*_tmp93B=
_tmp933;struct Cyc_Core_Opt _tmp93C;void*_tmp93D;_LL5BF: if(_tmp93B != 0)goto _LL5C1;
_LL5C0:{const char*_tmpFBB;void*_tmpFBA[1];struct Cyc_String_pa_struct _tmpFB9;s=(
struct _dyneither_ptr)((_tmpFB9.tag=0,((_tmpFB9.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)s),((_tmpFBA[0]=& _tmpFB9,Cyc_aprintf(((_tmpFBB="%s ref=NULL",
_tag_dyneither(_tmpFBB,sizeof(char),12))),_tag_dyneither(_tmpFBA,sizeof(void*),1))))))));}
goto _LL5BE;_LL5C1: if(_tmp93B == 0)goto _LL5BE;_tmp93C=*_tmp93B;_tmp93D=(void*)
_tmp93C.v;_LL5C2:{const char*_tmpFC0;void*_tmpFBF[2];struct Cyc_String_pa_struct
_tmpFBE;struct Cyc_String_pa_struct _tmpFBD;s=(struct _dyneither_ptr)((_tmpFBD.tag=
0,((_tmpFBD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
_tmp93D)),((_tmpFBE.tag=0,((_tmpFBE.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)s),((_tmpFBF[0]=& _tmpFBE,((_tmpFBF[1]=& _tmpFBD,Cyc_aprintf(((
_tmpFC0="%s ref=%s",_tag_dyneither(_tmpFC0,sizeof(char),10))),_tag_dyneither(
_tmpFBF,sizeof(void*),2))))))))))))));}goto _LL5BE;_LL5BE:;}{const char*_tmpFC4;
void*_tmpFC3[1];struct Cyc_String_pa_struct _tmpFC2;(_tmpFC2.tag=0,((_tmpFC2.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)s),((_tmpFC3[0]=& _tmpFC2,Cyc_fprintf(
Cyc_stderr,((_tmpFC4="evar info: %s\n",_tag_dyneither(_tmpFC4,sizeof(char),15))),
_tag_dyneither(_tmpFC3,sizeof(void*),1)))))));}goto _LL5B4;}_LL5B7:;_LL5B8: goto
_LL5B4;_LL5B4:;}{const char*_tmpFCA;void*_tmpFC9[3];struct Cyc_String_pa_struct
_tmpFC8;struct Cyc_String_pa_struct _tmpFC7;struct Cyc_String_pa_struct _tmpFC6;(
_tmpFC6.tag=0,((_tmpFC6.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(
expected_kind)),((_tmpFC7.tag=0,((_tmpFC7.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_kind2string(Cyc_Tcutil_typ_kind(t))),((_tmpFC8.tag=0,((
_tmpFC8.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((
_tmpFC9[0]=& _tmpFC8,((_tmpFC9[1]=& _tmpFC7,((_tmpFC9[2]=& _tmpFC6,Cyc_Tcutil_terr(
loc,((_tmpFCA="type %s has kind %s but as used here needs kind %s",
_tag_dyneither(_tmpFCA,sizeof(char),51))),_tag_dyneither(_tmpFC9,sizeof(void*),3)))))))))))))))))));}}
...
e,struct Cyc_Tcenv_Tenv*te,struct Cyc_Tcutil_CVTEnv cvtenv){{void*_tmp94D=(void*)e->r;
struct Cyc_List_List*_tmp94E;struct Cyc_Absyn_Exp*_tmp94F;struct Cyc_Absyn_Exp*
_tmp950;struct Cyc_Absyn_Exp*_tmp951;struct Cyc_Absyn_Exp*_tmp952;struct Cyc_Absyn_Exp*
_tmp953;struct Cyc_Absyn_Exp*_tmp954;struct Cyc_Absyn_Exp*_tmp955;struct Cyc_Absyn_Exp*
_tmp956;struct Cyc_Absyn_Exp*_tmp957;void*_tmp958;struct Cyc_Absyn_Exp*_tmp959;
void*_tmp95A;void*_tmp95B;void*_tmp95C;struct Cyc_Absyn_Exp*_tmp95D;_LL5C4: if(*((
int*)_tmp94D)!= 0)goto _LL5C6;_LL5C5: goto _LL5C7;_LL5C6: if(*((int*)_tmp94D)!= 33)
goto _LL5C8;_LL5C7: goto _LL5C9;_LL5C8: if(*((int*)_tmp94D)!= 34)goto _LL5CA;_LL5C9:
goto _LL5CB;_LL5CA: if(*((int*)_tmp94D)!= 1)goto _LL5CC;_LL5CB: goto _LL5C3;_LL5CC:
if(*((int*)_tmp94D)!= 3)goto _LL5CE;_tmp94E=((struct Cyc_Absyn_Primop_e_struct*)
...
_tmp95D,te,cvtenv);goto _LL5C3;_LL5E0:;_LL5E1: {const char*_tmpFCD;void*_tmpFCC;(
_tmpFCC=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpFCD="non-type-level-expression in Tcutil::i_check_valid_type_level_exp",
_tag_dyneither(_tmpFCD,sizeof(char),66))),_tag_dyneither(_tmpFCC,sizeof(void*),0)));}
_LL5C3:;}return cvtenv;}static struct Cyc_Tcutil_CVTEnv Cyc_Tcutil_check_valid_type(
struct Cyc_Position_Segment*loc,struct Cyc_Tcenv_Tenv*te,struct Cyc_Tcutil_CVTEnv
...
struct Cyc_Absyn_Evar_struct*)_tmp965)->f4;_LL5E4: if(*_tmp967 == 0){struct Cyc_Core_Opt*
_tmpFCE;*_tmp967=((_tmpFCE=_cycalloc(sizeof(*_tmpFCE)),((_tmpFCE->v=_tmp960,
_tmpFCE))));}else{struct Cyc_List_List*_tmp969=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)
...
struct Cyc_List_List*l,struct Cyc_Absyn_Tvar*x))Cyc_List_mem)(Cyc_Tcutil_fast_tvar_cmp,
_tmp960,(struct Cyc_Absyn_Tvar*)_tmp969->hd)){struct Cyc_List_List*_tmpFCF;_tmp96A=((
_tmpFCF=_cycalloc(sizeof(*_tmpFCF)),((_tmpFCF->hd=(struct Cyc_Absyn_Tvar*)_tmp969->hd,((
_tmpFCF->tl=_tmp96A,_tmpFCF))))));}}{struct Cyc_Core_Opt*_tmpFD0;*_tmp967=((
_tmpFD0=_cycalloc(sizeof(*_tmpFD0)),((_tmpFD0->v=_tmp96A,_tmpFD0))));}}goto
_LL5E2;_LL5E5:;_LL5E6: goto _LL5E2;_LL5E2:;}}}return cvt;}void Cyc_Tcutil_check_valid_toplevel_type(
...
generalize_evars=Cyc_Tcutil_is_function_type(t);struct Cyc_List_List*_tmp96D=Cyc_Tcenv_lookup_type_vars(
te);struct _RegionHandle*_tmp96E=Cyc_Tcenv_get_fnrgn(te);struct Cyc_Tcutil_CVTEnv
_tmpFD1;struct Cyc_Tcutil_CVTEnv _tmp96F=Cyc_Tcutil_check_valid_type(loc,te,((
_tmpFD1.r=_tmp96E,((_tmpFD1.kind_env=_tmp96D,((_tmpFD1.free_vars=0,((_tmpFD1.free_evars=
0,((_tmpFD1.generalize_evars=generalize_evars,((_tmpFD1.fn_result=0,_tmpFD1)))))))))))),(
void*)1,t);struct Cyc_List_List*_tmp970=((struct Cyc_List_List*(*)(struct
_RegionHandle*,struct Cyc_Absyn_Tvar*(*f)(struct _tuple18*),struct Cyc_List_List*x))
Cyc_List_rmap)(_tmp96E,(struct Cyc_Absyn_Tvar*(*)(struct _tuple18*))Cyc_Core_fst,
_tmp96F.free_vars);struct Cyc_List_List*_tmp971=((struct Cyc_List_List*(*)(struct
_RegionHandle*,void*(*f)(struct _tuple19*),struct Cyc_List_List*x))Cyc_List_rmap)(
_tmp96E,(void*(*)(struct _tuple19*))Cyc_Core_fst,_tmp96F.free_evars);if(_tmp96D != 
0){struct Cyc_List_List*_tmp972=0;{struct Cyc_List_List*_tmp973=_tmp970;for(0;(
unsigned int)_tmp973;_tmp973=_tmp973->tl){struct Cyc_Absyn_Tvar*_tmp974=(struct
Cyc_Absyn_Tvar*)_tmp973->hd;int found=0;{struct Cyc_List_List*_tmp975=_tmp96D;for(
0;(unsigned int)_tmp975;_tmp975=_tmp975->tl){if(Cyc_Absyn_tvar_cmp(_tmp974,(
struct Cyc_Absyn_Tvar*)_tmp975->hd)== 0){found=1;break;}}}if(!found){struct Cyc_List_List*
_tmpFD2;_tmp972=((_tmpFD2=_region_malloc(_tmp96E,sizeof(*_tmpFD2)),((_tmpFD2->hd=(
struct Cyc_Absyn_Tvar*)_tmp973->hd,((_tmpFD2->tl=_tmp972,_tmpFD2))))));}}}_tmp970=((
struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp972);}{
struct Cyc_List_List*x=_tmp970;for(0;x != 0;x=x->tl){void*_tmp977=Cyc_Absyn_compress_kb((
...
_tmp977)->f1;if((int)_tmp983 != 1)goto _LL5F2;_LL5F1:{const char*_tmpFD6;void*
_tmpFD5[1];struct Cyc_String_pa_struct _tmpFD4;(_tmpFD4.tag=0,((_tmpFD4.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcutil_tvar2string((struct Cyc_Absyn_Tvar*)
x->hd)),((_tmpFD5[0]=& _tmpFD4,Cyc_Tcutil_terr(loc,((_tmpFD6="type variable %s cannot have kind M",
_tag_dyneither(_tmpFD6,sizeof(char),36))),_tag_dyneither(_tmpFD5,sizeof(void*),1)))))));}
goto _LL5E7;_LL5F2:;_LL5F3: goto _LL5E7;_LL5E7:;}}if(_tmp970 != 0  || _tmp971 != 0){{
void*_tmp987=Cyc_Tcutil_compress(t);struct Cyc_Absyn_FnInfo _tmp988;struct Cyc_List_List*
_tmp989;struct Cyc_List_List**_tmp98A;struct Cyc_Core_Opt*_tmp98B;void*_tmp98C;
struct Cyc_List_List*_tmp98D;int _tmp98E;struct Cyc_Absyn_VarargInfo*_tmp98F;struct
Cyc_List_List*_tmp990;struct Cyc_List_List*_tmp991;_LL5F5: if(_tmp987 <= (void*)4)
goto _LL5F7;if(*((int*)_tmp987)!= 8)goto _LL5F7;_tmp988=((struct Cyc_Absyn_FnType_struct*)
_tmp987)->f1;_tmp989=_tmp988.tvars;_tmp98A=(struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_struct*)
_tmp987)->f1).tvars;_tmp98B=_tmp988.effect;_tmp98C=(void*)_tmp988.ret_typ;
_tmp98D=_tmp988.args;_tmp98E=_tmp988.c_varargs;_tmp98F=_tmp988.cyc_varargs;
_tmp990=_tmp988.rgn_po;_tmp991=_tmp988.attributes;_LL5F6: if(*_tmp98A == 0){*
_tmp98A=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_copy)(_tmp970);
_tmp970=0;}goto _LL5F4;_LL5F7:;_LL5F8: goto _LL5F4;_LL5F4:;}if(_tmp970 != 0){const
char*_tmpFDA;void*_tmpFD9[1];struct Cyc_String_pa_struct _tmpFD8;(_tmpFD8.tag=0,((
_tmpFD8.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)
_tmp970->hd)->name),((_tmpFD9[0]=& _tmpFD8,Cyc_Tcutil_terr(loc,((_tmpFDA="unbound type variable %s",
_tag_dyneither(_tmpFDA,sizeof(char),25))),_tag_dyneither(_tmpFD9,sizeof(void*),1)))))));}
if(_tmp971 != 0)for(0;_tmp971 != 0;_tmp971=_tmp971->tl){void*e=(void*)_tmp971->hd;
void*_tmp995=Cyc_Tcutil_typ_kind(e);_LL5FA: if((int)_tmp995 != 4)goto _LL5FC;_LL5FB:
if(!Cyc_Tcutil_unify(e,(void*)3)){const char*_tmpFDD;void*_tmpFDC;(_tmpFDC=0,((
int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpFDD="can't unify evar with unique region!",_tag_dyneither(_tmpFDD,sizeof(
char),37))),_tag_dyneither(_tmpFDC,sizeof(void*),0)));}goto _LL5F9;_LL5FC: if((int)
_tmp995 != 5)goto _LL5FE;_LL5FD: goto _LL5FF;_LL5FE: if((int)_tmp995 != 3)goto _LL600;
_LL5FF: if(!Cyc_Tcutil_unify(e,(void*)2)){const char*_tmpFE0;void*_tmpFDF;(_tmpFDF=
0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpFE0="can't unify evar with heap!",_tag_dyneither(_tmpFE0,sizeof(char),28))),
_tag_dyneither(_tmpFDF,sizeof(void*),0)));}goto _LL5F9;_LL600: if((int)_tmp995 != 6)
goto _LL602;_LL601: if(!Cyc_Tcutil_unify(e,Cyc_Absyn_empty_effect)){const char*
_tmpFE3;void*_tmpFE2;(_tmpFE2=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpFE3="can't unify evar with {}!",
_tag_dyneither(_tmpFE3,sizeof(char),26))),_tag_dyneither(_tmpFE2,sizeof(void*),0)));}
goto _LL5F9;_LL602:;_LL603:{const char*_tmpFE8;void*_tmpFE7[2];struct Cyc_String_pa_struct
_tmpFE6;struct Cyc_String_pa_struct _tmpFE5;(_tmpFE5.tag=0,((_tmpFE5.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmpFE6.tag=0,((
_tmpFE6.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(e)),((
_tmpFE7[0]=& _tmpFE6,((_tmpFE7[1]=& _tmpFE5,Cyc_Tcutil_terr(loc,((_tmpFE8="hidden type variable %s isn't abstracted in type %s",
_tag_dyneither(_tmpFE8,sizeof(char),52))),_tag_dyneither(_tmpFE7,sizeof(void*),2)))))))))))));}
goto _LL5F9;_LL5F9:;}}}void Cyc_Tcutil_check_fndecl_valid_type(struct Cyc_Position_Segment*
...
void*_tmp9A1=Cyc_Tcutil_compress(t);struct Cyc_Absyn_FnInfo _tmp9A2;struct Cyc_List_List*
_tmp9A3;struct Cyc_Core_Opt*_tmp9A4;void*_tmp9A5;_LL605: if(_tmp9A1 <= (void*)4)
goto _LL607;if(*((int*)_tmp9A1)!= 8)goto _LL607;_tmp9A2=((struct Cyc_Absyn_FnType_struct*)
_tmp9A1)->f1;_tmp9A3=_tmp9A2.tvars;_tmp9A4=_tmp9A2.effect;_tmp9A5=(void*)_tmp9A2.ret_typ;
_LL606: fd->tvs=_tmp9A3;fd->effect=_tmp9A4;goto _LL604;_LL607:;_LL608: {const char*
_tmpFEB;void*_tmpFEA;(_tmpFEA=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpFEB="check_fndecl_valid_type: not a FnType",
_tag_dyneither(_tmpFEB,sizeof(char),38))),_tag_dyneither(_tmpFEA,sizeof(void*),0)));}
_LL604:;}{struct _RegionHandle*_tmp9A8=Cyc_Tcenv_get_fnrgn(te);{const char*_tmpFEC;
...
_tmp9A8,(struct _dyneither_ptr*(*)(struct _tuple14*t))Cyc_Tcutil_fst_fdarg,fd->args),
loc,((_tmpFEC="function declaration has repeated parameter",_tag_dyneither(
_tmpFEC,sizeof(char),44))));}{struct Cyc_Core_Opt*_tmpFED;fd->cached_typ=((
_tmpFED=_cycalloc(sizeof(*_tmpFED)),((_tmpFED->v=(void*)t,_tmpFED))));}}}void Cyc_Tcutil_check_type(
...
_tmp9AB=Cyc_Tcenv_get_fnrgn(te);struct Cyc_Tcutil_CVTEnv _tmpFEE;struct Cyc_Tcutil_CVTEnv
_tmp9AC=Cyc_Tcutil_check_valid_type(loc,te,((_tmpFEE.r=_tmp9AB,((_tmpFEE.kind_env=
bound_tvars,((_tmpFEE.free_vars=0,((_tmpFEE.free_evars=0,((_tmpFEE.generalize_evars=
0,((_tmpFEE.fn_result=0,_tmpFEE)))))))))))),expected_kind,t);struct Cyc_List_List*
_tmp9AD=Cyc_Tcutil_remove_bound_tvars(_tmp9AB,((struct Cyc_List_List*(*)(struct
_RegionHandle*,struct Cyc_Absyn_Tvar*(*f)(struct _tuple18*),struct Cyc_List_List*x))
Cyc_List_rmap)(_tmp9AB,(struct Cyc_Absyn_Tvar*(*)(struct _tuple18*))Cyc_Core_fst,
_tmp9AC.free_vars),bound_tvars);struct Cyc_List_List*_tmp9AE=((struct Cyc_List_List*(*)(
struct _RegionHandle*,void*(*f)(struct _tuple19*),struct Cyc_List_List*x))Cyc_List_rmap)(
_tmp9AB,(void*(*)(struct _tuple19*))Cyc_Core_fst,_tmp9AC.free_evars);{struct Cyc_List_List*
fs=_tmp9AD;for(0;fs != 0;fs=fs->tl){struct _dyneither_ptr*_tmp9AF=((struct Cyc_Absyn_Tvar*)
fs->hd)->name;const char*_tmpFF3;void*_tmpFF2[2];struct Cyc_String_pa_struct
_tmpFF1;struct Cyc_String_pa_struct _tmpFF0;(_tmpFF0.tag=0,((_tmpFF0.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmpFF1.tag=0,((
_tmpFF1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp9AF),((_tmpFF2[0]=&
_tmpFF1,((_tmpFF2[1]=& _tmpFF0,Cyc_Tcutil_terr(loc,((_tmpFF3="unbound type variable %s in type %s",
_tag_dyneither(_tmpFF3,sizeof(char),36))),_tag_dyneither(_tmpFF2,sizeof(void*),2)))))))))))));}}
if(!allow_evars  && _tmp9AE != 0)for(0;_tmp9AE != 0;_tmp9AE=_tmp9AE->tl){void*e=(
void*)_tmp9AE->hd;void*_tmp9B4=Cyc_Tcutil_typ_kind(e);_LL60A: if((int)_tmp9B4 != 4)
goto _LL60C;_LL60B: if(!Cyc_Tcutil_unify(e,(void*)3)){const char*_tmpFF6;void*
_tmpFF5;(_tmpFF5=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpFF6="can't unify evar with unique region!",_tag_dyneither(_tmpFF6,sizeof(
char),37))),_tag_dyneither(_tmpFF5,sizeof(void*),0)));}goto _LL609;_LL60C: if((int)
_tmp9B4 != 5)goto _LL60E;_LL60D: goto _LL60F;_LL60E: if((int)_tmp9B4 != 3)goto _LL610;
_LL60F: if(!Cyc_Tcutil_unify(e,(void*)2)){const char*_tmpFF9;void*_tmpFF8;(_tmpFF8=
0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpFF9="can't unify evar with heap!",_tag_dyneither(_tmpFF9,sizeof(char),28))),
_tag_dyneither(_tmpFF8,sizeof(void*),0)));}goto _LL609;_LL610: if((int)_tmp9B4 != 6)
goto _LL612;_LL611: if(!Cyc_Tcutil_unify(e,Cyc_Absyn_empty_effect)){const char*
_tmpFFC;void*_tmpFFB;(_tmpFFB=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpFFC="can't unify evar with {}!",
_tag_dyneither(_tmpFFC,sizeof(char),26))),_tag_dyneither(_tmpFFB,sizeof(void*),0)));}
goto _LL609;_LL612:;_LL613:{const char*_tmp1001;void*_tmp1000[2];struct Cyc_String_pa_struct
_tmpFFF;struct Cyc_String_pa_struct _tmpFFE;(_tmpFFE.tag=0,((_tmpFFE.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmpFFF.tag=0,((
_tmpFFF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(e)),((
_tmp1000[0]=& _tmpFFF,((_tmp1000[1]=& _tmpFFE,Cyc_Tcutil_terr(loc,((_tmp1001="hidden type variable %s isn't abstracted in type %s",
_tag_dyneither(_tmp1001,sizeof(char),52))),_tag_dyneither(_tmp1000,sizeof(void*),
...
vs->hd,(void*)vs2->hd)== 0){const char*_tmp1006;void*_tmp1005[2];struct Cyc_String_pa_struct
_tmp1004;struct Cyc_String_pa_struct _tmp1003;(_tmp1003.tag=0,((_tmp1003.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)a2string((void*)vs->hd)),((_tmp1004.tag=
0,((_tmp1004.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)msg),((_tmp1005[0]=&
_tmp1004,((_tmp1005[1]=& _tmp1003,Cyc_Tcutil_terr(loc,((_tmp1006="%s: %s",
_tag_dyneither(_tmp1006,sizeof(char),7))),_tag_dyneither(_tmp1005,sizeof(void*),
...
struct Cyc_Position_Segment*loc,struct Cyc_List_List*tvs){const char*_tmp1007;((
...
tvs,loc,Cyc_Tcutil_tvar2string,((_tmp1007="duplicate type variable",
_tag_dyneither(_tmp1007,sizeof(char),24))));}struct _tuple20{struct Cyc_Absyn_Aggrfield*
...
_tmp1008;if(Cyc_strcmp((struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)
sd_fields->hd)->name,((_tmp1008="",_tag_dyneither(_tmp1008,sizeof(char),1))))!= 
0){struct _tuple20*_tmp100B;struct Cyc_List_List*_tmp100A;fields=((_tmp100A=
_cycalloc(sizeof(*_tmp100A)),((_tmp100A->hd=((_tmp100B=_cycalloc(sizeof(*
_tmp100B)),((_tmp100B->f1=(struct Cyc_Absyn_Aggrfield*)sd_fields->hd,((_tmp100B->f2=
0,_tmp100B)))))),((_tmp100A->tl=fields,_tmp100A))))));}}}fields=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x))Cyc_List_imp_rev)(fields);{struct Cyc_List_List*ans=0;for(
0;des != 0;des=des->tl){struct _tuple21 _tmp9C9;struct Cyc_List_List*_tmp9CA;void*
_tmp9CB;struct _tuple21*_tmp9C8=(struct _tuple21*)des->hd;_tmp9C9=*_tmp9C8;_tmp9CA=
_tmp9C9.f1;_tmp9CB=_tmp9C9.f2;if(_tmp9CA == 0){struct Cyc_List_List*_tmp9CC=fields;
for(0;_tmp9CC != 0;_tmp9CC=_tmp9CC->tl){if(!(*((struct _tuple20*)_tmp9CC->hd)).f2){(*((
struct _tuple20*)_tmp9CC->hd)).f2=1;{struct Cyc_Absyn_FieldName_struct*_tmp1011;
struct Cyc_Absyn_FieldName_struct _tmp1010;struct Cyc_List_List*_tmp100F;(*((struct
_tuple21*)des->hd)).f1=(struct Cyc_List_List*)((_tmp100F=_cycalloc(sizeof(*
_tmp100F)),((_tmp100F->hd=(void*)((void*)((_tmp1011=_cycalloc(sizeof(*_tmp1011)),((
_tmp1011[0]=((_tmp1010.tag=1,((_tmp1010.f1=((*((struct _tuple20*)_tmp9CC->hd)).f1)->name,
_tmp1010)))),_tmp1011))))),((_tmp100F->tl=0,_tmp100F))))));}{struct _tuple22*
_tmp1014;struct Cyc_List_List*_tmp1013;ans=((_tmp1013=_region_malloc(rgn,sizeof(*
_tmp1013)),((_tmp1013->hd=((_tmp1014=_region_malloc(rgn,sizeof(*_tmp1014)),((
_tmp1014->f1=(*((struct _tuple20*)_tmp9CC->hd)).f1,((_tmp1014->f2=_tmp9CB,
_tmp1014)))))),((_tmp1013->tl=ans,_tmp1013))))));}break;}}if(_tmp9CC == 0){const
char*_tmp1017;void*_tmp1016;(_tmp1016=0,Cyc_Tcutil_terr(loc,((_tmp1017="too many arguments to struct",
_tag_dyneither(_tmp1017,sizeof(char),29))),_tag_dyneither(_tmp1016,sizeof(void*),
0)));}}else{if(_tmp9CA->tl != 0){const char*_tmp101A;void*_tmp1019;(_tmp1019=0,Cyc_Tcutil_terr(
loc,((_tmp101A="multiple designators are not supported",_tag_dyneither(_tmp101A,
sizeof(char),39))),_tag_dyneither(_tmp1019,sizeof(void*),0)));}else{void*_tmp9D6=(
void*)_tmp9CA->hd;struct _dyneither_ptr*_tmp9D7;_LL615: if(*((int*)_tmp9D6)!= 0)
goto _LL617;_LL616:{const char*_tmp101D;void*_tmp101C;(_tmp101C=0,Cyc_Tcutil_terr(
loc,((_tmp101D="array designator used in argument to struct",_tag_dyneither(
_tmp101D,sizeof(char),44))),_tag_dyneither(_tmp101C,sizeof(void*),0)));}goto
_LL614;_LL617: if(*((int*)_tmp9D6)!= 1)goto _LL614;_tmp9D7=((struct Cyc_Absyn_FieldName_struct*)
...
== 0){if((*((struct _tuple20*)_tmp9DA->hd)).f2){const char*_tmp1021;void*_tmp1020[
1];struct Cyc_String_pa_struct _tmp101F;(_tmp101F.tag=0,((_tmp101F.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*_tmp9D7),((_tmp1020[0]=& _tmp101F,Cyc_Tcutil_terr(
loc,((_tmp1021="field %s has already been used as an argument",_tag_dyneither(
_tmp1021,sizeof(char),46))),_tag_dyneither(_tmp1020,sizeof(void*),1)))))));}(*((
struct _tuple20*)_tmp9DA->hd)).f2=1;{struct _tuple22*_tmp1024;struct Cyc_List_List*
_tmp1023;ans=((_tmp1023=_region_malloc(rgn,sizeof(*_tmp1023)),((_tmp1023->hd=((
_tmp1024=_region_malloc(rgn,sizeof(*_tmp1024)),((_tmp1024->f1=(*((struct _tuple20*)
_tmp9DA->hd)).f1,((_tmp1024->f2=_tmp9CB,_tmp1024)))))),((_tmp1023->tl=ans,
_tmp1023))))));}break;}}if(_tmp9DA == 0){const char*_tmp1028;void*_tmp1027[1];
struct Cyc_String_pa_struct _tmp1026;(_tmp1026.tag=0,((_tmp1026.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*_tmp9D7),((_tmp1027[0]=& _tmp1026,Cyc_Tcutil_terr(
loc,((_tmp1028="bad field designator %s",_tag_dyneither(_tmp1028,sizeof(char),24))),
_tag_dyneither(_tmp1027,sizeof(void*),1)))))));}goto _LL614;}_LL614:;}}}for(0;
fields != 0;fields=fields->tl){if(!(*((struct _tuple20*)fields->hd)).f2){{const
char*_tmp102B;void*_tmp102A;(_tmp102A=0,Cyc_Tcutil_terr(loc,((_tmp102B="too few arguments to struct",
_tag_dyneither(_tmp102B,sizeof(char),28))),_tag_dyneither(_tmp102A,sizeof(void*),
...
_tmp9E9;_LL61A: if(_tmp9E5 <= (void*)4)goto _LL61C;if(*((int*)_tmp9E5)!= 4)goto
_LL61C;_tmp9E6=((struct Cyc_Absyn_PointerType_struct*)_tmp9E5)->f1;_tmp9E7=(void*)
_tmp9E6.elt_typ;_tmp9E8=_tmp9E6.ptr_atts;_tmp9E9=_tmp9E8.bounds;_LL61B: {struct
Cyc_Absyn_Conref*_tmp9EA=Cyc_Absyn_compress_conref(_tmp9E9);union Cyc_Absyn_Constraint_union
_tmp9EB=(Cyc_Absyn_compress_conref(_tmp9EA))->v;void*_tmp9EC;_LL61F: if((_tmp9EB.Eq_constr).tag
!= 0)goto _LL621;_tmp9EC=(_tmp9EB.Eq_constr).f1;if((int)_tmp9EC != 0)goto _LL621;
_LL620:*elt_typ_dest=_tmp9E7;return 1;_LL621: if((_tmp9EB.No_constr).tag != 2)goto
_LL623;_LL622:{union Cyc_Absyn_Constraint_union _tmp102C;_tmp9EA->v=(union Cyc_Absyn_Constraint_union)(((
_tmp102C.Eq_constr).tag=0,(((_tmp102C.Eq_constr).f1=(void*)((void*)0),_tmp102C))));}*
elt_typ_dest=_tmp9E7;return 1;_LL623:;_LL624: return 0;_LL61E:;}_LL61C:;_LL61D:
return 0;_LL619:;}int Cyc_Tcutil_is_zero_pointer_typ_elt(void*t,void**elt_typ_dest);
int Cyc_Tcutil_is_zero_pointer_typ_elt(void*t,void**elt_typ_dest){void*_tmp9EE=
Cyc_Tcutil_compress(t);struct Cyc_Absyn_PtrInfo _tmp9EF;void*_tmp9F0;struct Cyc_Absyn_PtrAtts
_tmp9F1;struct Cyc_Absyn_Conref*_tmp9F2;_LL626: if(_tmp9EE <= (void*)4)goto _LL628;
if(*((int*)_tmp9EE)!= 4)goto _LL628;_tmp9EF=((struct Cyc_Absyn_PointerType_struct*)
_tmp9EE)->f1;_tmp9F0=(void*)_tmp9EF.elt_typ;_tmp9F1=_tmp9EF.ptr_atts;_tmp9F2=
_tmp9F1.zero_term;_LL627:*elt_typ_dest=_tmp9F0;return((int(*)(int,struct Cyc_Absyn_Conref*
x))Cyc_Absyn_conref_def)(0,_tmp9F2);_LL628:;_LL629: return 0;_LL625:;}int Cyc_Tcutil_is_zero_ptr_type(
void*t,void**ptr_type,int*is_dyneither,void**elt_type);int Cyc_Tcutil_is_zero_ptr_type(
void*t,void**ptr_type,int*is_dyneither,void**elt_type){void*_tmp9F3=Cyc_Tcutil_compress(
...
0,_tmp9FD)){*elt_type=_tmp9FA;*is_dyneither=0;{struct Cyc_Absyn_PointerType_struct
_tmp1041;struct Cyc_Absyn_PtrAtts _tmp1040;struct Cyc_Absyn_Upper_b_struct _tmp103F;
struct Cyc_Absyn_Upper_b_struct*_tmp103E;struct Cyc_Absyn_PtrInfo _tmp103D;struct
Cyc_Absyn_PointerType_struct*_tmp103C;*ptr_type=(void*)((_tmp103C=_cycalloc(
sizeof(*_tmp103C)),((_tmp103C[0]=((_tmp1041.tag=4,((_tmp1041.f1=((_tmp103D.elt_typ=(
void*)_tmp9FA,((_tmp103D.elt_tq=_tmp9FB,((_tmp103D.ptr_atts=((_tmp1040.rgn=(void*)((
void*)2),((_tmp1040.nullable=Cyc_Absyn_false_conref,((_tmp1040.bounds=Cyc_Absyn_new_conref((
void*)((_tmp103E=_cycalloc(sizeof(*_tmp103E)),((_tmp103E[0]=((_tmp103F.tag=0,((
_tmp103F.f1=(struct Cyc_Absyn_Exp*)_check_null(_tmp9FC),_tmp103F)))),_tmp103E))))),((
_tmp1040.zero_term=_tmp9FD,((_tmp1040.ptrloc=0,_tmp1040)))))))))),_tmp103D)))))),
_tmp1041)))),_tmp103C))));}return 1;}else{return 0;}_LL62F:;_LL630: return 0;_LL62A:;}
int Cyc_Tcutil_is_zero_ptr_deref(struct Cyc_Absyn_Exp*e1,void**ptr_type,int*
is_dyneither,void**elt_type);int Cyc_Tcutil_is_zero_ptr_deref(struct Cyc_Absyn_Exp*
e1,void**ptr_type,int*is_dyneither,void**elt_type){void*_tmpA05=(void*)e1->r;
struct Cyc_Absyn_Exp*_tmpA06;struct Cyc_Absyn_Exp*_tmpA07;struct Cyc_Absyn_Exp*
_tmpA08;struct Cyc_Absyn_Exp*_tmpA09;struct Cyc_Absyn_Exp*_tmpA0A;struct Cyc_Absyn_Exp*
_tmpA0B;_LL637: if(*((int*)_tmpA05)!= 15)goto _LL639;_LL638: {const char*_tmp1045;
void*_tmp1044[1];struct Cyc_String_pa_struct _tmp1043;(_tmp1043.tag=0,((_tmp1043.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e1)),((
_tmp1044[0]=& _tmp1043,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))
Cyc_Tcutil_impos)(((_tmp1045="we have a cast in a lhs:  %s",_tag_dyneither(
_tmp1045,sizeof(char),29))),_tag_dyneither(_tmp1044,sizeof(void*),1)))))));}
_LL639: if(*((int*)_tmpA05)!= 22)goto _LL63B;_tmpA06=((struct Cyc_Absyn_Deref_e_struct*)
...
elt_type)){const char*_tmp1049;void*_tmp1048[1];struct Cyc_String_pa_struct
_tmp1047;(_tmp1047.tag=0,((_tmp1047.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_exp2string(e1)),((_tmp1048[0]=& _tmp1047,((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1049="found zero pointer aggregate member assignment: %s",
_tag_dyneither(_tmp1049,sizeof(char),51))),_tag_dyneither(_tmp1048,sizeof(void*),
...
ptr_type,is_dyneither,elt_type)){const char*_tmp104D;void*_tmp104C[1];struct Cyc_String_pa_struct
...
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp104D="found zero pointer instantiate/noinstantiate: %s",
_tag_dyneither(_tmp104D,sizeof(char),49))),_tag_dyneither(_tmp104C,sizeof(void*),
1)))))));}return 0;_LL645: if(*((int*)_tmpA05)!= 1)goto _LL647;_LL646: return 0;
_LL647:;_LL648: {const char*_tmp1051;void*_tmp1050[1];struct Cyc_String_pa_struct
...
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1051="found bad lhs in is_zero_ptr_deref: %s",
_tag_dyneither(_tmp1051,sizeof(char),39))),_tag_dyneither(_tmp1050,sizeof(void*),
1)))))));}_LL636:;}int Cyc_Tcutil_is_tagged_pointer_typ(void*t);int Cyc_Tcutil_is_tagged_pointer_typ(
...
void*r){void*_tmpA18=Cyc_Tcutil_compress(r);struct Cyc_Absyn_Tvar*_tmpA19;_LL64A:
if((int)_tmpA18 != 3)goto _LL64C;_LL64B: return 1;_LL64C: if(_tmpA18 <= (void*)4)goto
_LL64E;if(*((int*)_tmpA18)!= 1)goto _LL64E;_tmpA19=((struct Cyc_Absyn_VarType_struct*)
_tmpA18)->f1;_LL64D: return Cyc_Tcutil_tvar_kind(_tmpA19)== (void*)4  || Cyc_Tcutil_tvar_kind(
_tmpA19)== (void*)5;_LL64E:;_LL64F: return 0;_LL649:;}int Cyc_Tcutil_is_noalias_pointer(
void*t);int Cyc_Tcutil_is_noalias_pointer(void*t){void*_tmpA1A=Cyc_Tcutil_compress(
...
!= 0)goto _LL65E;_LL65D: {const char*_tmp1054;void*_tmp1053;(_tmp1053=0,((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1054="got unknown aggr in is_noalias_aggr",
_tag_dyneither(_tmp1054,sizeof(char),36))),_tag_dyneither(_tmp1053,sizeof(void*),
...
const char*_tmp1057;void*_tmp1056;(_tmp1056=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1057="got unknown tunion in is_noalias_aggr",
_tag_dyneither(_tmp1057,sizeof(char),38))),_tag_dyneither(_tmp1056,sizeof(void*),
0)));}_LL667: if((_tmpA33.KnownTunion).tag != 1)goto _LL664;_tmpA38=(_tmpA33.KnownTunion).f1;
_tmpA39=*_tmpA38;_tmpA3A=*_tmpA39;_tmpA3B=_tmpA3A.tvs;_tmpA3C=_tmpA3A.fields;
_tmpA3D=_tmpA3A.is_flat;_LL668: if(!_tmpA3D){if(_tmpA2B == 0)return 0;return Cyc_Tcutil_is_noalias_region((
void*)_tmpA2B->v);}else{if(_tmpA3C == 0){const char*_tmp105A;void*_tmp1059;(
_tmp1059=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp105A="got tunion with no fields",_tag_dyneither(_tmp105A,sizeof(char),26))),
_tag_dyneither(_tmp1059,sizeof(void*),0)));}else{struct Cyc_List_List*_tmpA42=((
struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*
x,struct Cyc_List_List*y))Cyc_List_rzip)(rgn,rgn,_tmpA3B,_tmpA2A);struct Cyc_List_List*
_tmpA43=(struct Cyc_List_List*)_tmpA3C->v;while(_tmpA43 != 0){struct Cyc_List_List*
_tmpA44=((struct Cyc_Absyn_Tunionfield*)_tmpA43->hd)->typs;while(_tmpA44 != 0){
_tmpA1E=Cyc_Tcutil_rsubstitute(rgn,_tmpA42,(*((struct _tuple5*)_tmpA44->hd)).f2);
if(Cyc_Tcutil_is_noalias_pointer_or_aggr(rgn,_tmpA1E))return 1;_tmpA44=_tmpA44->tl;}
_tmpA43=_tmpA43->tl;}return 0;}}_LL664:;}_LL660: if(*((int*)_tmpA1F)!= 3)goto
_LL662;_tmpA2C=((struct Cyc_Absyn_TunionFieldType_struct*)_tmpA1F)->f1;_tmpA2D=
_tmpA2C.field_info;_tmpA2E=_tmpA2C.targs;_LL661: {union Cyc_Absyn_TunionFieldInfoU_union
_tmpA45=_tmpA2D;struct Cyc_Absyn_Tuniondecl*_tmpA46;struct Cyc_Absyn_Tunionfield*
_tmpA47;_LL66A: if((_tmpA45.UnknownTunionfield).tag != 0)goto _LL66C;_LL66B: {const
char*_tmp105D;void*_tmp105C;(_tmp105C=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp105D="got unknown tunion field in is_noalias_aggr",
_tag_dyneither(_tmp105D,sizeof(char),44))),_tag_dyneither(_tmp105C,sizeof(void*),
0)));}_LL66C: if((_tmpA45.KnownTunionfield).tag != 1)goto _LL669;_tmpA46=(_tmpA45.KnownTunionfield).f1;
...
_RegionHandle*r,void*t,struct _dyneither_ptr*f){void*_tmpA4C=Cyc_Tcutil_compress(
t);struct Cyc_Absyn_AggrInfo _tmpA4D;union Cyc_Absyn_AggrInfoU_union _tmpA4E;struct
Cyc_Absyn_Aggrdecl**_tmpA4F;struct Cyc_Absyn_Aggrdecl*_tmpA50;struct Cyc_List_List*
_tmpA51;struct Cyc_List_List*_tmpA52;_LL66F: if(_tmpA4C <= (void*)4)goto _LL673;if(*((
int*)_tmpA4C)!= 10)goto _LL671;_tmpA4D=((struct Cyc_Absyn_AggrType_struct*)_tmpA4C)->f1;
_tmpA4E=_tmpA4D.aggr_info;if((((((struct Cyc_Absyn_AggrType_struct*)_tmpA4C)->f1).aggr_info).KnownAggr).tag
...
_LL678;_LL677: {const char*_tmp1060;void*_tmp105F;(_tmp105F=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1060="is_noalias_field: missing field",
_tag_dyneither(_tmp1060,sizeof(char),32))),_tag_dyneither(_tmp105F,sizeof(void*),
...
_LL673:;_LL674: {const char*_tmp1064;void*_tmp1063[1];struct Cyc_String_pa_struct
_tmp1062;(_tmp1062.tag=0,((_tmp1062.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp1063[0]=& _tmp1062,((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1064="is_noalias_field: invalid type |%s|",
_tag_dyneither(_tmp1064,sizeof(char),36))),_tag_dyneither(_tmp1063,sizeof(void*),
...
struct _RegionHandle*r,struct Cyc_Absyn_Exp*e,int ignore_leaf){void*_tmpA5C=(void*)
e->r;void*_tmpA5D;struct Cyc_Absyn_Exp*_tmpA5E;struct _dyneither_ptr*_tmpA5F;
struct Cyc_Absyn_Exp*_tmpA60;struct Cyc_Absyn_Exp*_tmpA61;void*_tmpA62;void*
_tmpA63;void*_tmpA64;struct Cyc_Absyn_Exp*_tmpA65;struct Cyc_Absyn_Exp*_tmpA66;
struct Cyc_Absyn_Exp*_tmpA67;struct Cyc_Absyn_Exp*_tmpA68;void*_tmpA69;struct Cyc_Absyn_Exp*
_tmpA6A;struct Cyc_Absyn_Stmt*_tmpA6B;_LL67B: if(*((int*)_tmpA5C)!= 5)goto _LL67D;
_LL67C: goto _LL67E;_LL67D: if(*((int*)_tmpA5C)!= 7)goto _LL67F;_LL67E: goto _LL680;
_LL67F: if(*((int*)_tmpA5C)!= 8)goto _LL681;_LL680: goto _LL682;_LL681: if(*((int*)
_tmpA5C)!= 12)goto _LL683;_LL682: goto _LL684;_LL683: if(*((int*)_tmpA5C)!= 16)goto
_LL685;_LL684: goto _LL686;_LL685: if(*((int*)_tmpA5C)!= 18)goto _LL687;_LL686: goto
_LL688;_LL687: if(*((int*)_tmpA5C)!= 19)goto _LL689;_LL688: goto _LL68A;_LL689: if(*((
int*)_tmpA5C)!= 20)goto _LL68B;_LL68A: goto _LL68C;_LL68B: if(*((int*)_tmpA5C)!= 21)
goto _LL68D;_LL68C: goto _LL68E;_LL68D: if(*((int*)_tmpA5C)!= 27)goto _LL68F;_LL68E:
goto _LL690;_LL68F: if(*((int*)_tmpA5C)!= 29)goto _LL691;_LL690: goto _LL692;_LL691:
if(*((int*)_tmpA5C)!= 28)goto _LL693;_LL692: goto _LL694;_LL693: if(*((int*)_tmpA5C)
!= 33)goto _LL695;_LL694: goto _LL696;_LL695: if(*((int*)_tmpA5C)!= 34)goto _LL697;
_LL696: goto _LL698;_LL697: if(*((int*)_tmpA5C)!= 36)goto _LL699;_LL698: goto _LL69A;
_LL699: if(*((int*)_tmpA5C)!= 1)goto _LL69B;_tmpA5D=(void*)((struct Cyc_Absyn_Var_e_struct*)
...
_tmpA61);_tmpA71=_tmpA70.f1;_tmpA72=_tmpA70.f2;if(!_tmpA72){const char*_tmp1067;
void*_tmp1066;(_tmp1066=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr
ap))Cyc_Tcutil_impos)(((_tmp1067="is_noalias_path_aux: non-constant subscript",
_tag_dyneither(_tmp1067,sizeof(char),44))),_tag_dyneither(_tmp1066,sizeof(void*),
0)));}{struct _handler_cons _tmpA75;_push_handler(& _tmpA75);{int _tmpA77=0;if(
setjmp(_tmpA75.handler))_tmpA77=1;if(!_tmpA77){{void*_tmpA78=(*((struct _tuple5*(*)(
struct Cyc_List_List*x,int n))Cyc_List_nth)(_tmpA6F,(int)_tmpA71)).f2;int _tmpA79=(
ignore_leaf  || Cyc_Tcutil_is_noalias_pointer_or_aggr(r,_tmpA78)) && Cyc_Tcutil_is_noalias_path_aux(
r,_tmpA60,0);_npop_handler(0);return _tmpA79;};_pop_handler();}else{void*_tmpA76=(
void*)_exn_thrown;void*_tmpA7B=_tmpA76;_LL6CF: if(_tmpA7B != Cyc_List_Nth)goto
_LL6D1;_LL6D0: {const char*_tmp106A;void*_tmp1069;return(_tmp1069=0,((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp106A="is_noalias_path_aux: out-of-bounds subscript",
_tag_dyneither(_tmp106A,sizeof(char),45))),_tag_dyneither(_tmp1069,sizeof(void*),
0)));}_LL6D1:;_LL6D2:(void)_throw(_tmpA7B);_LL6CE:;}}}}_LL6CC:;_LL6CD: {const
char*_tmp106D;void*_tmp106C;(_tmp106C=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp106D="is_noalias_path_aux: subscript on non-pointer/tuple",
_tag_dyneither(_tmp106D,sizeof(char),52))),_tag_dyneither(_tmp106C,sizeof(void*),
0)));}_LL6C7:;}_LL6A5: if(*((int*)_tmpA5C)!= 32)goto _LL6A7;_LL6A6: goto _LL6A8;
_LL6A7: if(*((int*)_tmpA5C)!= 26)goto _LL6A9;_LL6A8: goto _LL6AA;_LL6A9: if(*((int*)
_tmpA5C)!= 30)goto _LL6AB;_LL6AA: goto _LL6AC;_LL6AB: if(*((int*)_tmpA5C)!= 31)goto
_LL6AD;_LL6AC: goto _LL6AE;_LL6AD: if(*((int*)_tmpA5C)!= 0)goto _LL6AF;_LL6AE: goto
_LL6B0;_LL6AF: if(*((int*)_tmpA5C)!= 35)goto _LL6B1;_LL6B0: goto _LL6B2;_LL6B1: if(*((
int*)_tmpA5C)!= 17)goto _LL6B3;_LL6B2: goto _LL6B4;_LL6B3: if(*((int*)_tmpA5C)!= 1)
goto _LL6B5;_tmpA62=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmpA5C)->f2;if(
_tmpA62 <= (void*)1)goto _LL6B5;if(*((int*)_tmpA62)!= 3)goto _LL6B5;_LL6B4: goto
_LL6B6;_LL6B5: if(*((int*)_tmpA5C)!= 1)goto _LL6B7;_tmpA63=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmpA5C)->f2;if(_tmpA63 <= (void*)1)goto _LL6B7;if(*((int*)_tmpA63)!= 4)goto _LL6B7;
_LL6B6: goto _LL6B8;_LL6B7: if(*((int*)_tmpA5C)!= 1)goto _LL6B9;_tmpA64=(void*)((
struct Cyc_Absyn_Var_e_struct*)_tmpA5C)->f2;if(_tmpA64 <= (void*)1)goto _LL6B9;if(*((
int*)_tmpA64)!= 2)goto _LL6B9;_LL6B8: {int _tmpA80=ignore_leaf  || Cyc_Tcutil_is_noalias_pointer_or_aggr(
r,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v);return _tmpA80;}_LL6B9:
if(*((int*)_tmpA5C)!= 6)goto _LL6BB;_tmpA65=((struct Cyc_Absyn_Conditional_e_struct*)
_tmpA5C)->f2;_LL6BA: _tmpA66=_tmpA65;goto _LL6BC;_LL6BB: if(*((int*)_tmpA5C)!= 9)
goto _LL6BD;_tmpA66=((struct Cyc_Absyn_SeqExp_e_struct*)_tmpA5C)->f2;_LL6BC:
_tmpA67=_tmpA66;goto _LL6BE;_LL6BD: if(*((int*)_tmpA5C)!= 4)goto _LL6BF;_tmpA67=((
struct Cyc_Absyn_AssignOp_e_struct*)_tmpA5C)->f1;_LL6BE: return Cyc_Tcutil_is_noalias_path_aux(
r,_tmpA67,ignore_leaf);_LL6BF: if(*((int*)_tmpA5C)!= 11)goto _LL6C1;_tmpA68=((
struct Cyc_Absyn_FnCall_e_struct*)_tmpA5C)->f1;_LL6C0: {void*_tmpA81=Cyc_Tcutil_compress((
void*)((struct Cyc_Core_Opt*)_check_null(_tmpA68->topt))->v);struct Cyc_Absyn_FnInfo
_tmpA82;void*_tmpA83;struct Cyc_Absyn_PtrInfo _tmpA84;void*_tmpA85;_LL6D4: if(
_tmpA81 <= (void*)4)goto _LL6D8;if(*((int*)_tmpA81)!= 8)goto _LL6D6;_tmpA82=((
struct Cyc_Absyn_FnType_struct*)_tmpA81)->f1;_tmpA83=(void*)_tmpA82.ret_typ;
_LL6D5: return ignore_leaf  || Cyc_Tcutil_is_noalias_pointer_or_aggr(r,_tmpA83);
_LL6D6: if(*((int*)_tmpA81)!= 4)goto _LL6D8;_tmpA84=((struct Cyc_Absyn_PointerType_struct*)
...
r,_tmpA88);_LL6DD:;_LL6DE: goto _LL6DA;_LL6DA:;}goto _LL6D9;_LL6D8:;_LL6D9: {const
char*_tmp1071;void*_tmp1070[1];struct Cyc_String_pa_struct _tmp106F;(_tmp106F.tag=
0,((_tmp106F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((
void*)((struct Cyc_Core_Opt*)_check_null(_tmpA68->topt))->v)),((_tmp1070[0]=&
_tmp106F,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp1071="Fncall has non function type %s",_tag_dyneither(_tmp1071,sizeof(char),
32))),_tag_dyneither(_tmp1070,sizeof(void*),1)))))));}_LL6D3:;}_LL6C1: if(*((int*)
_tmpA5C)!= 15)goto _LL6C3;_tmpA69=(void*)((struct Cyc_Absyn_Cast_e_struct*)_tmpA5C)->f1;
_tmpA6A=((struct Cyc_Absyn_Cast_e_struct*)_tmpA5C)->f2;_LL6C2: return Cyc_Tcutil_is_noalias_pointer_or_aggr(
r,_tmpA69) && Cyc_Tcutil_is_noalias_path_aux(r,_tmpA6A,1);_LL6C3: if(*((int*)
_tmpA5C)!= 38)goto _LL6C5;_tmpA6B=((struct Cyc_Absyn_StmtExp_e_struct*)_tmpA5C)->f1;
_LL6C4: while(1){void*_tmpA8C=(void*)_tmpA6B->r;struct Cyc_Absyn_Stmt*_tmpA8D;
struct Cyc_Absyn_Stmt*_tmpA8E;struct Cyc_Absyn_Decl*_tmpA8F;struct Cyc_Absyn_Stmt*
_tmpA90;struct Cyc_Absyn_Exp*_tmpA91;_LL6E0: if(_tmpA8C <= (void*)1)goto _LL6E6;if(*((
int*)_tmpA8C)!= 1)goto _LL6E2;_tmpA8D=((struct Cyc_Absyn_Seq_s_struct*)_tmpA8C)->f1;
_tmpA8E=((struct Cyc_Absyn_Seq_s_struct*)_tmpA8C)->f2;_LL6E1: _tmpA6B=_tmpA8E;goto
_LL6DF;_LL6E2: if(*((int*)_tmpA8C)!= 11)goto _LL6E4;_tmpA8F=((struct Cyc_Absyn_Decl_s_struct*)
_tmpA8C)->f1;_tmpA90=((struct Cyc_Absyn_Decl_s_struct*)_tmpA8C)->f2;_LL6E3:
_tmpA6B=_tmpA90;goto _LL6DF;_LL6E4: if(*((int*)_tmpA8C)!= 0)goto _LL6E6;_tmpA91=((
struct Cyc_Absyn_Exp_s_struct*)_tmpA8C)->f1;_LL6E5: return Cyc_Tcutil_is_noalias_path_aux(
r,_tmpA91,ignore_leaf);_LL6E6:;_LL6E7: {const char*_tmp1074;void*_tmp1073;(
_tmp1073=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp1074="is_noalias_stmt_exp: ill-formed StmtExp",_tag_dyneither(_tmp1074,
sizeof(char),40))),_tag_dyneither(_tmp1073,sizeof(void*),0)));}_LL6DF:;}_LL6C5:;
_LL6C6: {const char*_tmp1078;void*_tmp1077[1];struct Cyc_String_pa_struct _tmp1076;(
_tmp1076.tag=0,((_tmp1076.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(
e)),((_tmp1077[0]=& _tmp1076,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1078="Called is_noalias_path_aux with bogus exp |%s|\n",
_tag_dyneither(_tmp1078,sizeof(char),48))),_tag_dyneither(_tmp1077,sizeof(void*),
...
struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Exp*e){struct _tuple10 _tmp1079;struct
_tuple10 bogus_ans=(_tmp1079.f1=0,((_tmp1079.f2=(void*)2,_tmp1079)));void*_tmpA97=(
void*)e->r;struct _tuple2*_tmpA98;void*_tmpA99;struct Cyc_Absyn_Exp*_tmpA9A;struct
...
4)goto _LL705;if(*((int*)_tmpAA6)!= 7)goto _LL705;_LL704: {struct _tuple10 _tmp107A;
return(_tmp107A.f1=1,((_tmp107A.f2=(void*)2,_tmp107A)));}_LL705:;_LL706: {struct
_tuple10 _tmp107B;return(_tmp107B.f1=(_tmpAA2->tq).real_const,((_tmp107B.f2=(void*)
2,_tmp107B)));}_LL702:;}_LL6FC: if(_tmpAA1 <= (void*)1)goto _LL6FE;if(*((int*)
_tmpAA1)!= 3)goto _LL6FE;_tmpAA3=((struct Cyc_Absyn_Local_b_struct*)_tmpAA1)->f1;
_LL6FD: {void*_tmpAA9=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
_check_null(e->topt))->v);_LL708: if(_tmpAA9 <= (void*)4)goto _LL70A;if(*((int*)
_tmpAA9)!= 7)goto _LL70A;_LL709: {struct _tuple10 _tmp107C;return(_tmp107C.f1=1,((
_tmp107C.f2=(void*)((struct Cyc_Core_Opt*)_check_null(_tmpAA3->rgn))->v,_tmp107C)));}
_LL70A:;_LL70B: _tmpAA3->escapes=1;{struct _tuple10 _tmp107D;return(_tmp107D.f1=(
_tmpAA3->tq).real_const,((_tmp107D.f2=(void*)((struct Cyc_Core_Opt*)_check_null(
_tmpAA3->rgn))->v,_tmp107D)));}_LL707:;}_LL6FE: if(_tmpAA1 <= (void*)1)goto _LL700;
if(*((int*)_tmpAA1)!= 4)goto _LL700;_tmpAA4=((struct Cyc_Absyn_Pat_b_struct*)
_tmpAA1)->f1;_LL6FF: _tmpAA5=_tmpAA4;goto _LL701;_LL700: if(_tmpAA1 <= (void*)1)goto
_LL6F5;if(*((int*)_tmpAA1)!= 2)goto _LL6F5;_tmpAA5=((struct Cyc_Absyn_Param_b_struct*)
_tmpAA1)->f1;_LL701: _tmpAA5->escapes=1;{struct _tuple10 _tmp107E;return(_tmp107E.f1=(
_tmpAA5->tq).real_const,((_tmp107E.f2=(void*)((struct Cyc_Core_Opt*)_check_null(
_tmpAA5->rgn))->v,_tmp107E)));}_LL6F5:;}_LL6EB: if(*((int*)_tmpA97)!= 23)goto
_LL6ED;_tmpA9A=((struct Cyc_Absyn_AggrMember_e_struct*)_tmpA97)->f1;_tmpA9B=((
struct Cyc_Absyn_AggrMember_e_struct*)_tmpA97)->f2;_LL6EC: {void*_tmpAAD=Cyc_Tcutil_compress((
void*)((struct Cyc_Core_Opt*)_check_null(_tmpA9A->topt))->v);struct Cyc_List_List*
_tmpAAE;struct Cyc_Absyn_AggrInfo _tmpAAF;union Cyc_Absyn_AggrInfoU_union _tmpAB0;
struct Cyc_Absyn_Aggrdecl**_tmpAB1;struct Cyc_Absyn_Aggrdecl*_tmpAB2;_LL70D: if(
_tmpAAD <= (void*)4)goto _LL711;if(*((int*)_tmpAAD)!= 11)goto _LL70F;_tmpAAE=((
struct Cyc_Absyn_AnonAggrType_struct*)_tmpAAD)->f2;_LL70E: {struct Cyc_Absyn_Aggrfield*
_tmpAB3=Cyc_Absyn_lookup_field(_tmpAAE,_tmpA9B);if(_tmpAB3 != 0  && _tmpAB3->width
!= 0){struct _tuple10 _tmp107F;return(_tmp107F.f1=(_tmpAB3->tq).real_const,((
_tmp107F.f2=(Cyc_Tcutil_addressof_props(te,_tmpA9A)).f2,_tmp107F)));}return
bogus_ans;}_LL70F: if(*((int*)_tmpAAD)!= 10)goto _LL711;_tmpAAF=((struct Cyc_Absyn_AggrType_struct*)
_tmpAAD)->f1;_tmpAB0=_tmpAAF.aggr_info;if((((((struct Cyc_Absyn_AggrType_struct*)
_tmpAAD)->f1).aggr_info).KnownAggr).tag != 1)goto _LL711;_tmpAB1=(_tmpAB0.KnownAggr).f1;
_tmpAB2=*_tmpAB1;_LL710: {struct Cyc_Absyn_Aggrfield*_tmpAB5=Cyc_Absyn_lookup_decl_field(
_tmpAB2,_tmpA9B);if(_tmpAB5 != 0  && _tmpAB5->width != 0){struct _tuple10 _tmp1080;
return(_tmp1080.f1=(_tmpAB5->tq).real_const,((_tmp1080.f2=(Cyc_Tcutil_addressof_props(
te,_tmpA9A)).f2,_tmp1080)));}return bogus_ans;}_LL711:;_LL712: return bogus_ans;
_LL70C:;}_LL6ED: if(*((int*)_tmpA97)!= 24)goto _LL6EF;_tmpA9C=((struct Cyc_Absyn_AggrArrow_e_struct*)
...
_tmpAC1,_tmpA9D);goto _LL718;_LL71D:;_LL71E: return bogus_ans;_LL718:;}if(finfo != 0
 && finfo->width != 0){struct _tuple10 _tmp1081;return(_tmp1081.f1=(finfo->tq).real_const,((
_tmp1081.f2=_tmpABB,_tmp1081)));}return bogus_ans;}_LL716:;_LL717: return bogus_ans;
...
_tmpAC6.rgn;_LL721: {struct _tuple10 _tmp1082;return(_tmp1082.f1=_tmpAC5.real_const,((
_tmp1082.f2=_tmpAC7,_tmp1082)));}_LL722:;_LL723: return bogus_ans;_LL71F:;}_LL6F1:
if(*((int*)_tmpA97)!= 25)goto _LL6F3;_tmpA9F=((struct Cyc_Absyn_Subscript_e_struct*)
...
_tmpAD4 != 0){struct _tuple10 _tmp1083;return(_tmp1083.f1=((*_tmpAD4).f1).real_const,((
_tmp1083.f2=(Cyc_Tcutil_addressof_props(te,_tmpA9F)).f2,_tmp1083)));}return
...
_tmpACD.rgn;_LL728: {struct _tuple10 _tmp1084;return(_tmp1084.f1=_tmpACC.real_const,((
_tmp1084.f2=_tmpACE,_tmp1084)));}_LL729: if(*((int*)_tmpAC9)!= 7)goto _LL72B;
_tmpACF=((struct Cyc_Absyn_ArrayType_struct*)_tmpAC9)->f1;_tmpAD0=_tmpACF.tq;
_LL72A: {struct _tuple10 _tmp1085;return(_tmp1085.f1=_tmpAD0.real_const,((_tmp1085.f2=(
Cyc_Tcutil_addressof_props(te,_tmpA9F)).f2,_tmp1085)));}_LL72B:;_LL72C: return
bogus_ans;_LL724:;}_LL6F3:;_LL6F4:{const char*_tmp1088;void*_tmp1087;(_tmp1087=0,
Cyc_Tcutil_terr(e->loc,((_tmp1088="unary & applied to non-lvalue",_tag_dyneither(
_tmp1088,sizeof(char),30))),_tag_dyneither(_tmp1087,sizeof(void*),0)));}return
bogus_ans;_LL6E8:;}void*Cyc_Tcutil_array_to_ptr(struct Cyc_Tcenv_Tenv*te,void*
...
_tmpAE1=_tmpAE0.f2;{struct Cyc_Absyn_Upper_b_struct _tmp108B;struct Cyc_Absyn_Upper_b_struct*
_tmp108A;return Cyc_Absyn_atb_typ(_tmpADD,_tmpAE1,_tmpADE,(void*)((_tmp108A=
_cycalloc(sizeof(*_tmp108A)),((_tmp108A[0]=((_tmp108B.tag=0,((_tmp108B.f1=e,
_tmp108B)))),_tmp108A)))),_tmpADF);}}_LL730:;_LL731: return e_typ;_LL72D:;}void Cyc_Tcutil_check_bound(
...
_tmpAE7);_tmpAE9=_tmpAE8.f1;_tmpAEA=_tmpAE8.f2;if(_tmpAEA  && _tmpAE9 <= i){const
char*_tmp1090;void*_tmp108F[2];struct Cyc_Int_pa_struct _tmp108E;struct Cyc_Int_pa_struct
_tmp108D;(_tmp108D.tag=1,((_tmp108D.f1=(unsigned long)((int)i),((_tmp108E.tag=1,((
_tmp108E.f1=(unsigned long)((int)_tmpAE9),((_tmp108F[0]=& _tmp108E,((_tmp108F[1]=&
_tmp108D,Cyc_Tcutil_terr(loc,((_tmp1090="dereference is out of bounds: %d <= %d",
_tag_dyneither(_tmp1090,sizeof(char),39))),_tag_dyneither(_tmp108F,sizeof(void*),
2)))))))))))));}return;}_LL737: if((_tmpAE4.No_constr).tag != 2)goto _LL739;_LL738:{
struct Cyc_Absyn_Upper_b_struct*_tmp1096;struct Cyc_Absyn_Upper_b_struct _tmp1095;
union Cyc_Absyn_Constraint_union _tmp1094;b->v=(union Cyc_Absyn_Constraint_union)(((
_tmp1094.Eq_constr).tag=0,(((_tmp1094.Eq_constr).f1=(void*)((void*)((void*)((
_tmp1096=_cycalloc(sizeof(*_tmp1096)),((_tmp1096[0]=((_tmp1095.tag=0,((_tmp1095.f1=
Cyc_Absyn_uint_exp(i + 1,0),_tmp1095)))),_tmp1096)))))),_tmp1094))));}return;
_LL739:;_LL73A: {const char*_tmp1099;void*_tmp1098;(_tmp1098=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1099="check_bound -- bad compressed conref",
_tag_dyneither(_tmp1099,sizeof(char),37))),_tag_dyneither(_tmp1098,sizeof(void*),
...
union Cyc_Absyn_Constraint_union _tmpAF4=(Cyc_Absyn_compress_conref(b))->v;void*
_tmpAF5;struct Cyc_Absyn_Exp*_tmpAF6;_LL73C: if((_tmpAF4.Eq_constr).tag != 0)goto
_LL73E;_tmpAF5=(_tmpAF4.Eq_constr).f1;if(_tmpAF5 <= (void*)1)goto _LL73E;if(*((int*)
_tmpAF5)!= 0)goto _LL73E;_tmpAF6=((struct Cyc_Absyn_Upper_b_struct*)_tmpAF5)->f1;
_LL73D: {unsigned int _tmpAF8;int _tmpAF9;struct _tuple7 _tmpAF7=Cyc_Evexp_eval_const_uint_exp(
_tmpAF6);_tmpAF8=_tmpAF7.f1;_tmpAF9=_tmpAF7.f2;return _tmpAF9  && _tmpAF8 == 1;}
_LL73E:;_LL73F: return 0;_LL73B:;}int Cyc_Tcutil_bits_only(void*t);int Cyc_Tcutil_bits_only(
void*t){void*_tmpAFA=Cyc_Tcutil_compress(t);struct Cyc_Absyn_ArrayInfo _tmpAFB;
void*_tmpAFC;struct Cyc_Absyn_Conref*_tmpAFD;struct Cyc_List_List*_tmpAFE;struct
Cyc_Absyn_AggrInfo _tmpAFF;union Cyc_Absyn_AggrInfoU_union _tmpB00;struct Cyc_Absyn_AggrInfo
_tmpB01;union Cyc_Absyn_AggrInfoU_union _tmpB02;struct Cyc_Absyn_Aggrdecl**_tmpB03;
struct Cyc_Absyn_Aggrdecl*_tmpB04;struct Cyc_List_List*_tmpB05;struct Cyc_List_List*
_tmpB06;_LL741: if((int)_tmpAFA != 0)goto _LL743;_LL742: goto _LL744;_LL743: if(
_tmpAFA <= (void*)4)goto _LL745;if(*((int*)_tmpAFA)!= 5)goto _LL745;_LL744: goto
_LL746;_LL745: if((int)_tmpAFA != 1)goto _LL747;_LL746: goto _LL748;_LL747: if(_tmpAFA
<= (void*)4)goto _LL757;if(*((int*)_tmpAFA)!= 6)goto _LL749;_LL748: return 1;_LL749:
if(*((int*)_tmpAFA)!= 12)goto _LL74B;_LL74A: goto _LL74C;_LL74B: if(*((int*)_tmpAFA)
!= 13)goto _LL74D;_LL74C: return 0;_LL74D: if(*((int*)_tmpAFA)!= 7)goto _LL74F;
_tmpAFB=((struct Cyc_Absyn_ArrayType_struct*)_tmpAFA)->f1;_tmpAFC=(void*)_tmpAFB.elt_type;
_tmpAFD=_tmpAFB.zero_term;_LL74E: return !((int(*)(int,struct Cyc_Absyn_Conref*x))
Cyc_Absyn_conref_def)(0,_tmpAFD) && Cyc_Tcutil_bits_only(_tmpAFC);_LL74F: if(*((
int*)_tmpAFA)!= 9)goto _LL751;_tmpAFE=((struct Cyc_Absyn_TupleType_struct*)_tmpAFA)->f1;
_LL750: for(0;_tmpAFE != 0;_tmpAFE=_tmpAFE->tl){if(!Cyc_Tcutil_bits_only((*((
...
void*t);int Cyc_Tcutil_supports_default(void*t){void*_tmpB27=Cyc_Tcutil_compress(
t);struct Cyc_Absyn_PtrInfo _tmpB28;struct Cyc_Absyn_PtrAtts _tmpB29;struct Cyc_Absyn_Conref*
_tmpB2A;struct Cyc_Absyn_Conref*_tmpB2B;struct Cyc_Absyn_ArrayInfo _tmpB2C;void*
_tmpB2D;struct Cyc_List_List*_tmpB2E;struct Cyc_Absyn_AggrInfo _tmpB2F;union Cyc_Absyn_AggrInfoU_union
_tmpB30;struct Cyc_List_List*_tmpB31;struct Cyc_List_List*_tmpB32;_LL799: if((int)
_tmpB27 != 0)goto _LL79B;_LL79A: goto _LL79C;_LL79B: if(_tmpB27 <= (void*)4)goto _LL79D;
if(*((int*)_tmpB27)!= 5)goto _LL79D;_LL79C: goto _LL79E;_LL79D: if((int)_tmpB27 != 1)
goto _LL79F;_LL79E: goto _LL7A0;_LL79F: if(_tmpB27 <= (void*)4)goto _LL7AF;if(*((int*)
_tmpB27)!= 6)goto _LL7A1;_LL7A0: return 1;_LL7A1: if(*((int*)_tmpB27)!= 4)goto _LL7A3;
_tmpB28=((struct Cyc_Absyn_PointerType_struct*)_tmpB27)->f1;_tmpB29=_tmpB28.ptr_atts;
...
struct Cyc_List_List*fs){struct _RegionHandle _tmpB35=_new_region("rgn");struct
_RegionHandle*rgn=& _tmpB35;_push_region(rgn);{struct Cyc_List_List*_tmpB36=((
struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*
x,struct Cyc_List_List*y))Cyc_List_rzip)(rgn,rgn,tvs,ts);for(0;fs != 0;fs=fs->tl){
void*t=Cyc_Tcutil_rsubstitute(rgn,_tmpB36,(void*)((struct Cyc_Absyn_Aggrfield*)fs->hd)->type);
if(!Cyc_Tcutil_supports_default(t)){int _tmpB37=0;_npop_handler(0);return _tmpB37;}}}{
int _tmpB38=1;_npop_handler(0);return _tmpB38;};_pop_region(rgn);}int Cyc_Tcutil_admits_zero(
void*t);int Cyc_Tcutil_admits_zero(void*t){void*_tmpB39=Cyc_Tcutil_compress(t);
struct Cyc_Absyn_PtrInfo _tmpB3A;struct Cyc_Absyn_PtrAtts _tmpB3B;struct Cyc_Absyn_Conref*
_tmpB3C;struct Cyc_Absyn_Conref*_tmpB3D;_LL7B7: if(_tmpB39 <= (void*)4)goto _LL7B9;
if(*((int*)_tmpB39)!= 5)goto _LL7B9;_LL7B8: goto _LL7BA;_LL7B9: if((int)_tmpB39 != 1)
goto _LL7BB;_LL7BA: goto _LL7BC;_LL7BB: if(_tmpB39 <= (void*)4)goto _LL7BF;if(*((int*)
_tmpB39)!= 6)goto _LL7BD;_LL7BC: return 1;_LL7BD: if(*((int*)_tmpB39)!= 4)goto _LL7BF;
_tmpB3A=((struct Cyc_Absyn_PointerType_struct*)_tmpB39)->f1;_tmpB3B=_tmpB3A.ptr_atts;
_tmpB3C=_tmpB3B.nullable;_tmpB3D=_tmpB3B.bounds;_LL7BE: {union Cyc_Absyn_Constraint_union
_tmpB3E=(Cyc_Absyn_compress_conref(_tmpB3D))->v;void*_tmpB3F;_LL7C2: if((_tmpB3E.Eq_constr).tag
!= 0)goto _LL7C4;_tmpB3F=(_tmpB3E.Eq_constr).f1;if((int)_tmpB3F != 0)goto _LL7C4;
_LL7C3: return 0;_LL7C4: if((_tmpB3E.Eq_constr).tag != 0)goto _LL7C6;_LL7C5: {union
Cyc_Absyn_Constraint_union _tmpB40=(((struct Cyc_Absyn_Conref*(*)(struct Cyc_Absyn_Conref*
x))Cyc_Absyn_compress_conref)(_tmpB3C))->v;int _tmpB41;_LL7C9: if((_tmpB40.Eq_constr).tag
!= 0)goto _LL7CB;_tmpB41=(_tmpB40.Eq_constr).f1;_LL7CA: return _tmpB41;_LL7CB:;
_LL7CC: return 0;_LL7C8:;}_LL7C6:;_LL7C7: return 0;_LL7C1:;}_LL7BF:;_LL7C0: return 0;
_LL7B6:;}int Cyc_Tcutil_is_noreturn(void*t);int Cyc_Tcutil_is_noreturn(void*t){{
void*_tmpB42=Cyc_Tcutil_compress(t);struct Cyc_Absyn_PtrInfo _tmpB43;void*_tmpB44;
struct Cyc_Absyn_FnInfo _tmpB45;struct Cyc_List_List*_tmpB46;_LL7CE: if(_tmpB42 <= (
void*)4)goto _LL7D2;if(*((int*)_tmpB42)!= 4)goto _LL7D0;_tmpB43=((struct Cyc_Absyn_PointerType_struct*)
_tmpB42)->f1;_tmpB44=(void*)_tmpB43.elt_typ;_LL7CF: return Cyc_Tcutil_is_noreturn(
_tmpB44);_LL7D0: if(*((int*)_tmpB42)!= 8)goto _LL7D2;_tmpB45=((struct Cyc_Absyn_FnType_struct*)
_tmpB42)->f1;_tmpB46=_tmpB45.attributes;_LL7D1: for(0;_tmpB46 != 0;_tmpB46=_tmpB46->tl){
void*_tmpB47=(void*)_tmpB46->hd;_LL7D5: if((int)_tmpB47 != 3)goto _LL7D7;_LL7D6:
return 1;_LL7D7:;_LL7D8: continue;_LL7D4:;}goto _LL7CD;_LL7D2:;_LL7D3: goto _LL7CD;
_LL7CD:;}return 0;}struct Cyc_List_List*Cyc_Tcutil_transfer_fn_type_atts(void*t,
struct Cyc_List_List*atts);struct Cyc_List_List*Cyc_Tcutil_transfer_fn_type_atts(
void*t,struct Cyc_List_List*atts){void*_tmpB48=Cyc_Tcutil_compress(t);struct Cyc_Absyn_FnInfo
_tmpB49;struct Cyc_List_List*_tmpB4A;struct Cyc_List_List**_tmpB4B;_LL7DA: if(
_tmpB48 <= (void*)4)goto _LL7DC;if(*((int*)_tmpB48)!= 8)goto _LL7DC;_tmpB49=((
struct Cyc_Absyn_FnType_struct*)_tmpB48)->f1;_tmpB4A=_tmpB49.attributes;_tmpB4B=(
struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_struct*)_tmpB48)->f1).attributes;
_LL7DB: {struct Cyc_List_List*_tmpB4C=0;for(0;atts != 0;atts=atts->tl){if(Cyc_Absyn_fntype_att((
void*)atts->hd)){struct Cyc_List_List*_tmp109A;*_tmpB4B=((_tmp109A=_cycalloc(
sizeof(*_tmp109A)),((_tmp109A->hd=(void*)((void*)atts->hd),((_tmp109A->tl=*
_tmpB4B,_tmp109A))))));}else{struct Cyc_List_List*_tmp109B;_tmpB4C=((_tmp109B=
_cycalloc(sizeof(*_tmp109B)),((_tmp109B->hd=(void*)((void*)atts->hd),((_tmp109B->tl=
_tmpB4C,_tmp109B))))));}}return _tmpB4C;}_LL7DC:;_LL7DD: {const char*_tmp109E;void*
_tmp109D;(_tmp109D=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))
Cyc_Tcutil_impos)(((_tmp109E="transfer_fn_type_atts",_tag_dyneither(_tmp109E,
sizeof(char),22))),_tag_dyneither(_tmp109D,sizeof(void*),0)));}_LL7D9:;}
