...
int Cyc_Tcutil_is_noreturn(void*);void Cyc_Tcutil_check_no_qual(struct Cyc_Position_Segment*
loc,void*t);struct _tuple11{unsigned int f1;int f2;};struct _tuple11 Cyc_Evexp_eval_const_uint_exp(
...
encloser);void Cyc_NewControlFlow_cf_check(struct Cyc_List_List*ds);extern int Cyc_NewControlFlow_warn_lose_unique;
...
struct _dyneither_ptr Cyc_Absynpp_qvar2string(struct _tuple1*);int Cyc_NewControlFlow_warn_lose_unique=
...
_tmp75A;struct Cyc_NewControlFlow_CFStmtAnnot _tmp759;struct Cyc_NewControlFlow_CFAnnot_struct*
_tmp758;enclosee->annot=(void*)((_tmp758=_cycalloc(sizeof(*_tmp758)),((_tmp758[0]=((
_tmp75A.tag=Cyc_NewControlFlow_CFAnnot,((_tmp75A.f1=((_tmp759.encloser=encloser,((
_tmp759.visited=0,_tmp759)))),_tmp75A)))),_tmp758))));}struct Cyc_NewControlFlow_AnalEnv{
