...
_dyneither_ptr ap);void*Cyc_Tcutil_compress(void*t);void*Cyc_Tcutil_pointer_elt_type(
...
struct _tuple11 Cyc_Evexp_eval_const_uint_exp(struct Cyc_Absyn_Exp*e);struct Cyc_CfFlowInfo_VarRoot_struct{
...
loc);typedef struct Cyc_Dict_Dict Cyc_CfFlowInfo_place_set_t;struct Cyc_Dict_Dict Cyc_CfFlowInfo_union_place_set(
...
Cyc_NewControlFlow_dict_t;typedef struct Cyc_Position_Segment*Cyc_NewControlFlow_seg_t;
int Cyc_NewControlFlow_warn_lose_unique=0;struct Cyc_NewControlFlow_CFStmtAnnot{
struct Cyc_Absyn_Stmt*encloser;int visited;};typedef struct Cyc_NewControlFlow_CFStmtAnnot
Cyc_NewControlFlow_cf_stmt_annot_t;static char Cyc_NewControlFlow_CFAnnot[8]="CFAnnot";
...
encloser){struct Cyc_NewControlFlow_CFAnnot_struct _tmp75A;struct Cyc_NewControlFlow_CFStmtAnnot
_tmp759;struct Cyc_NewControlFlow_CFAnnot_struct*_tmp758;enclosee->annot=(void*)((
_tmp758=_cycalloc(sizeof(*_tmp758)),((_tmp758[0]=((_tmp75A.tag=Cyc_NewControlFlow_CFAnnot,((
_tmp75A.f1=((_tmp759.encloser=encloser,((_tmp759.visited=0,_tmp759)))),_tmp75A)))),
_tmp758))));}struct Cyc_NewControlFlow_AnalEnv{struct _RegionHandle*r;struct Cyc_CfFlowInfo_FlowEnv*
...
param_roots;struct Cyc_Hashtable_Table*flow_table;};typedef struct Cyc_NewControlFlow_AnalEnv*
Cyc_NewControlFlow_analenv_t;static union Cyc_CfFlowInfo_FlowInfo Cyc_NewControlFlow_anal_stmt(
...
struct Cyc_Absyn_Exp*);static struct _tuple14 Cyc_NewControlFlow_anal_Rexp(struct Cyc_NewControlFlow_AnalEnv*,
...
_LL4: {struct Cyc_Core_Impossible_struct _tmp760;const char*_tmp75F;struct Cyc_Core_Impossible_struct*
_tmp75E;(int)_throw((void*)((_tmp75E=_cycalloc(sizeof(*_tmp75E)),((_tmp75E[0]=((
_tmp760.tag=Cyc_Core_Impossible,((_tmp760.f1=((_tmp75F="ControlFlow -- wrong stmt annotation",
_tag_dyneither(_tmp75F,sizeof(char),37))),_tmp760)))),_tmp75E)))));}_LL0:;}
...
env->flow_table,s);if(sflow == 0){union Cyc_CfFlowInfo_FlowInfo*_tmp761;union Cyc_CfFlowInfo_FlowInfo*
res=(_tmp761=_region_malloc(env->r,sizeof(*_tmp761)),((_tmp761[0]=Cyc_CfFlowInfo_BottomFL(),
_tmp761)));((void(*)(struct Cyc_Hashtable_Table*t,struct Cyc_Absyn_Stmt*key,union
...
env->iteration_num;{struct _tuple17 _tmp762;return(_tmp762.f1=_tmpB,((_tmp762.f2=
_tmpC,_tmp762)));};}static void Cyc_NewControlFlow_update_tryflow(struct Cyc_NewControlFlow_AnalEnv*
...
_tuple18*_tmpE=ckenv;_tmpF=*_tmpE;_tmp10=_tmpF.f1;_tmp11=_tmpF.f2;_tmp12=_tmpF.f3;{
...
_tmp766;void*_tmp765[1];struct Cyc_String_pa_struct _tmp764;(_tmp764.tag=0,((
_tmp764.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp15->name)),((_tmp765[0]=& _tmp764,Cyc_Tcutil_warn(_tmp11,((_tmp766="unique pointer(s) reachable from %s may become unreachable.",
_tag_dyneither(_tmp766,sizeof(char),60))),_tag_dyneither(_tmp765,sizeof(void*),1)))))));}
...
flow,*_tmp1F);if(Cyc_NewControlFlow_warn_lose_unique){struct _tuple16 _tmp767;
struct _tuple16 _tmp22=(_tmp767.f1=flow,((_tmp767.f2=_tmp20,_tmp767)));union Cyc_CfFlowInfo_FlowInfo
...
_tuple18 _tmp768;struct _tuple18 _tmp29=(_tmp768.f1=env,((_tmp768.f2=s->loc,((
_tmp768.f3=_tmp28,_tmp768)))));((void(*)(void(*f)(struct _tuple18*,void*,void*),
...
_tmp2C;struct _tuple13 _tmp2D;struct Cyc_Dict_Dict _tmp2E;struct Cyc_List_List*_tmp2F;
...
_LL18;_tmp2D=(struct _tuple13)(_tmp2B.ReachableFL).val;_tmp2E=_tmp2D.f1;_tmp2F=
_tmp2D.f2;_LL1C: for(0;vds != 0;vds=vds->tl){struct Cyc_CfFlowInfo_VarRoot_struct
_tmp76B;struct Cyc_CfFlowInfo_VarRoot_struct*_tmp76A;struct Cyc_CfFlowInfo_VarRoot_struct*
_tmp30=(_tmp76A=_region_malloc(fenv->r,sizeof(*_tmp76A)),((_tmp76A[0]=((_tmp76B.tag=
0,((_tmp76B.f1=(struct Cyc_Absyn_Vardecl*)vds->hd,_tmp76B)))),_tmp76A)));_tmp2E=((
...
_LL20: if((_tmp33.ReachableFL).tag != 2)goto _LL1D;_tmp35=(struct _tuple13)(_tmp33.ReachableFL).val;
_tmp36=_tmp35.f1;_tmp37=_tmp35.f2;_LL21: if(Cyc_CfFlowInfo_initlevel(env->fenv,
_tmp36,r)!= Cyc_CfFlowInfo_AllIL){const char*_tmp76E;void*_tmp76D;(_tmp76D=0,Cyc_Tcutil_terr(
loc,((_tmp76E="expression may not be fully initialized",_tag_dyneither(_tmp76E,
sizeof(char),40))),_tag_dyneither(_tmp76D,sizeof(void*),0)));}{struct Cyc_Dict_Dict
...
r){struct _tuple0 _tmp76F;struct _tuple0 _tmp3D=(_tmp76F.f1=Cyc_Tcutil_compress(t),((
_tmp76F.f2=r,_tmp76F)));void*_tmp3E;enum Cyc_CfFlowInfo_InitLevel _tmp40;void*
...
if(!Cyc_Tcutil_is_noalias_pointer(t))goto _LL33;_LL32:{const char*_tmp772;void*
_tmp771;(_tmp771=0,Cyc_Tcutil_warn(loc,((_tmp772="argument may still contain unique pointers",
_tag_dyneither(_tmp772,sizeof(char),43))),_tag_dyneither(_tmp771,sizeof(void*),0)));}
...
int _tmp6C;struct _tuple13 _tmp6D;struct Cyc_Dict_Dict _tmp6E;struct Cyc_List_List*
...
_LL35;_tmp6D=(struct _tuple13)(_tmp6B.ReachableFL).val;_tmp6E=_tmp6D.f1;_tmp6F=
_tmp6D.f2;_LL39: if(!Cyc_Tcutil_is_noalias_pointer(t)){{const char*_tmp775;void*
_tmp774;(_tmp774=0,Cyc_Tcutil_terr(loc,((_tmp775="noliveunique attribute requires unique pointer",
_tag_dyneither(_tmp775,sizeof(char),47))),_tag_dyneither(_tmp774,sizeof(void*),0)));}
...
env->fenv)->r,_tmp72)){const char*_tmp778;void*_tmp777;(_tmp777=0,Cyc_Tcutil_warn(
loc,((_tmp778="argument may contain live unique pointers",_tag_dyneither(_tmp778,
sizeof(char),42))),_tag_dyneither(_tmp777,sizeof(void*),0)));}return Cyc_NewControlFlow_use_Rval(
...
struct _tuple20 _tmp779;return(_tmp779.f1=inflow,((_tmp779.f2=0,_tmp779)));}if(es->tl
...
_tmp7B.f2;{struct Cyc_List_List*_tmp77C;struct _tuple20 _tmp77B;return(_tmp77B.f1=
_tmp7C,((_tmp77B.f2=((_tmp77C=_region_malloc(rgn,sizeof(*_tmp77C)),((_tmp77C->hd=
_tmp7D,((_tmp77C->tl=0,_tmp77C)))))),_tmp77B)));};}{struct Cyc_Dict_Dict*
...
this_all_changed=(env->fenv)->mt_place_set;{struct Cyc_Dict_Dict*_tmp77D;env->all_changed=((
_tmp77D=_region_malloc(env->r,sizeof(*_tmp77D)),((_tmp77D[0]=(env->fenv)->mt_place_set,
_tmp77D))));}{union Cyc_CfFlowInfo_FlowInfo _tmp82;void*_tmp83;struct _tuple14
...
_tmp77E;rvals=((_tmp77E=_region_malloc(rgn,sizeof(*_tmp77E)),((_tmp77E->hd=
_tmp83,((_tmp77E->tl=0,_tmp77E))))));}this_all_changed=Cyc_CfFlowInfo_union_place_set(
...
_tmp77F;env->all_changed=((_tmp77F=_region_malloc(env->r,sizeof(*_tmp77F)),((
_tmp77F[0]=(env->fenv)->mt_place_set,_tmp77F))));}{union Cyc_CfFlowInfo_FlowInfo
...
_tmp86.f2;{struct Cyc_List_List*_tmp780;rvals=((_tmp780=_region_malloc(rgn,
sizeof(*_tmp780)),((_tmp780->hd=_tmp88,((_tmp780->tl=rvals,_tmp780))))));}
...
if(outer_all_changed == 0)env->all_changed=0;else{struct Cyc_Dict_Dict*_tmp781;env->all_changed=((
_tmp781=_region_malloc(env->r,sizeof(*_tmp781)),((_tmp781[0]=Cyc_CfFlowInfo_union_place_set(*
outer_all_changed,this_all_changed,0),_tmp781))));}Cyc_NewControlFlow_update_tryflow(
env,outflow);{struct _tuple20 _tmp782;return(_tmp782.f1=outflow,((_tmp782.f2=((
struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(rvals),_tmp782)));};};}
...
_tmp8F;struct _tuple20 _tmp8D=Cyc_NewControlFlow_anal_unordered_Rexps(_tmp8C,env,
inflow,es,0,0);_tmp8E=_tmp8D.f1;_tmp8F=_tmp8D.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp90=_tmp8E;struct _tuple13 _tmp91;struct Cyc_Dict_Dict _tmp92;int _tmp93;_LL40: if((
_tmp90.ReachableFL).tag != 2)goto _LL42;_tmp91=(struct _tuple13)(_tmp90.ReachableFL).val;
...
_tmp8F->hd)== Cyc_CfFlowInfo_NoneIL){const char*_tmp785;void*_tmp784;(_tmp784=0,
Cyc_Tcutil_terr(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd)->loc,((
_tmp785="expression may not be initialized",_tag_dyneither(_tmp785,sizeof(char),
34))),_tag_dyneither(_tmp784,sizeof(void*),0)));}}goto _LL3F;_LL42: if((_tmp90.BottomFL).tag
!= 1)goto _LL3F;_tmp93=(int)(_tmp90.BottomFL).val;_LL43: goto _LL3F;_LL3F:;}{struct
_tuple14 _tmp786;return(_tmp786.f1=_tmp8E,((_tmp786.f2=(env->fenv)->unknown_all,
_tmp786)));};}static union Cyc_CfFlowInfo_FlowInfo Cyc_NewControlFlow_notzero(
...
_tmp97=outflow;int _tmp98;struct _tuple13 _tmp99;struct Cyc_Dict_Dict _tmp9A;struct
...
goto _LL44;_tmp99=(struct _tuple13)(_tmp97.ReachableFL).val;_tmp9A=_tmp99.f1;
...
_tmpA0=outflow;int _tmpA1;struct _tuple13 _tmpA2;struct Cyc_Dict_Dict _tmpA3;struct
Cyc_List_List*_tmpA4;_LL4F: if((_tmpA0.BottomFL).tag != 1)goto _LL51;_tmpA1=(int)(
_tmpA0.BottomFL).val;_LL50: {struct _tuple16 _tmp787;return(_tmp787.f1=outflow,((
_tmp787.f2=outflow,_tmp787)));}_LL51: if((_tmpA0.ReachableFL).tag != 2)goto _LL4E;
_tmpA2=(struct _tuple13)(_tmpA0.ReachableFL).val;_tmpA3=_tmpA2.f1;_tmpA4=_tmpA2.f2;
...
!= 2)goto _LL56;_tmpA7=(int)(_tmpA6.UnknownL).val;_LL55: {struct _tuple16 _tmp788;
return(_tmp788.f1=outflow,((_tmp788.f2=outflow,_tmp788)));}_LL56: if((_tmpA6.PlaceL).tag
...
struct _tuple16 _tmp789;return(_tmp789.f1=Cyc_CfFlowInfo_ReachableFL(Cyc_CfFlowInfo_assign_place(
env->fenv,e->loc,_tmpA3,env->all_changed,_tmpA8,nzval),_tmpA4),((_tmp789.f2=Cyc_CfFlowInfo_ReachableFL(
Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmpA3,env->all_changed,_tmpA8,(env->fenv)->zero),
_tmpA4),_tmp789)));}_LL53:;}_LL4E:;}static struct Cyc_CfFlowInfo_NotZero_struct Cyc_NewControlFlow_mt_notzero_v={
...
union Cyc_CfFlowInfo_FlowInfo _tmpB4=f;int _tmpB5;struct _tuple13 _tmpB6;struct Cyc_Dict_Dict
_tmpB7;struct Cyc_List_List*_tmpB8;_LL5E: if((_tmpB4.BottomFL).tag != 1)goto _LL60;
_tmpB5=(int)(_tmpB4.BottomFL).val;_LL5F: {struct _tuple14 _tmp78A;return(_tmp78A.f1=
f,((_tmp78A.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpB0,0,(env->fenv)->unknown_all),
_tmp78A)));}_LL60: if((_tmpB4.ReachableFL).tag != 2)goto _LL5D;_tmpB6=(struct
_tuple13)(_tmpB4.ReachableFL).val;_tmpB7=_tmpB6.f1;_tmpB8=_tmpB6.f2;_LL61: if(Cyc_Tcutil_is_bound_one(
...
_LL76:{struct Cyc_CfFlowInfo_NotZero_struct _tmp78D;struct Cyc_CfFlowInfo_NotZero_struct*
_tmp78C;e->annot=(void*)((_tmp78C=_cycalloc(sizeof(*_tmp78C)),((_tmp78C[0]=((
_tmp78D.tag=Cyc_CfFlowInfo_NotZero,((_tmp78D.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmpB8),_tmp78D)))),_tmp78C))));}goto _LL74;_LL77:;_LL78: e->annot=(void*)& Cyc_NewControlFlow_mt_notzero_v;
...
struct Cyc_CfFlowInfo_NotZero_struct _tmp790;struct Cyc_CfFlowInfo_NotZero_struct*
_tmp78F;e->annot=(void*)((_tmp78F=_cycalloc(sizeof(*_tmp78F)),((_tmp78F[0]=((
_tmp790.tag=Cyc_CfFlowInfo_NotZero,((_tmp790.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmpB8),_tmp790)))),_tmp78F))));}goto _LL7E;_LL81:;_LL82: e->annot=(void*)& Cyc_NewControlFlow_mt_notzero_v;
goto _LL7E;_LL7E:;}goto _LL79;_LL79:;}{struct _tuple14 _tmp791;return(_tmp791.f1=f,((
_tmp791.f2=Cyc_CfFlowInfo_lookup_place(_tmpB7,_tmpBE),_tmp791)));};_LL69: {
...
struct _tuple14 _tmp792;return(_tmp792.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp792.f2=
Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpB0,0,(env->fenv)->unknown_all),
_tmp792)));};_LL6B: {struct Cyc_CfFlowInfo_UnknownR_struct*_tmpC0=(struct Cyc_CfFlowInfo_UnknownR_struct*)
...
_tmp795;struct Cyc_CfFlowInfo_UnknownZ_struct*_tmp794;e->annot=(void*)((_tmp794=
_cycalloc(sizeof(*_tmp794)),((_tmp794[0]=((_tmp795.tag=Cyc_CfFlowInfo_UnknownZ,((
_tmp795.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,_tmpB8),_tmp795)))),
_tmp794))));}goto _LL83;_LL86:;_LL87: e->annot=(void*)& Cyc_NewControlFlow_mt_unknownz_v;
...
_LL8C:{struct Cyc_CfFlowInfo_UnknownZ_struct _tmp798;struct Cyc_CfFlowInfo_UnknownZ_struct*
_tmp797;e->annot=(void*)((_tmp797=_cycalloc(sizeof(*_tmp797)),((_tmp797[0]=((
_tmp798.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp798.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmpB8),_tmp798)))),_tmp797))));}goto _LL88;_LL88:;}switch(Cyc_CfFlowInfo_initlevel(
...
_tmpDB;if(_tmpDC->tag != 7)goto _LL92;}_LL91:{const char*_tmp79B;void*_tmp79A;(
_tmp79A=0,Cyc_Tcutil_terr(e->loc,((_tmp79B="attempt to use a unique pointer that has already been copied",
_tag_dyneither(_tmp79B,sizeof(char),61))),_tag_dyneither(_tmp79A,sizeof(void*),0)));}
goto _LL8F;_LL92:;_LL93: {const char*_tmp79E;void*_tmp79D;(_tmp79D=0,Cyc_Tcutil_terr(
e->loc,((_tmp79E="dereference of possibly uninitialized pointer",_tag_dyneither(
_tmp79E,sizeof(char),46))),_tag_dyneither(_tmp79D,sizeof(void*),0)));}_LL8F:;}
goto _LL8E;case Cyc_CfFlowInfo_AllIL: _LL8E: {struct _tuple14 _tmp79F;return(_tmp79F.f1=
f,((_tmp79F.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpB0,0,(env->fenv)->unknown_all),
_tmp79F)));}case Cyc_CfFlowInfo_ThisIL: _LL94: {struct _tuple14 _tmp7A0;return(
_tmp7A0.f1=f,((_tmp7A0.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpB0,0,(env->fenv)->unknown_none),
_tmp7A0)));}}_LL5D:;}_LL5B:;_LL5C: {struct Cyc_Core_Impossible_struct _tmp7A6;
const char*_tmp7A5;struct Cyc_Core_Impossible_struct*_tmp7A4;(int)_throw((void*)((
_tmp7A4=_cycalloc(sizeof(*_tmp7A4)),((_tmp7A4[0]=((_tmp7A6.tag=Cyc_Core_Impossible,((
_tmp7A6.f1=((_tmp7A5="right deref of non-pointer-type",_tag_dyneither(_tmp7A5,
sizeof(char),32))),_tmp7A6)))),_tmp7A4)))));}_LL58:;}static struct Cyc_List_List*
...
_LLAF:;_LLB0: continue;_LLAC:;}}}if(!found){struct Cyc_CfFlowInfo_Reln*_tmp7A9;
struct Cyc_List_List*_tmp7A8;return(_tmp7A8=_region_malloc(rgn,sizeof(*_tmp7A8)),((
_tmp7A8->hd=((_tmp7A9=_region_malloc(rgn,sizeof(*_tmp7A9)),((_tmp7A9->vd=_tmp107,((
_tmp7A9->rop=Cyc_CfFlowInfo_LessNumelts(_tmpF6),_tmp7A9)))))),((_tmp7A8->tl=
relns,_tmp7A8)))));}}return relns;_LLAA:;_LLAB: return relns;_LLA1:;}else{return
...
_tmp10E=outflow;int _tmp10F;struct _tuple13 _tmp110;struct Cyc_Dict_Dict _tmp111;
struct Cyc_List_List*_tmp112;_LLB2: if((_tmp10E.BottomFL).tag != 1)goto _LLB4;
_tmp10F=(int)(_tmp10E.BottomFL).val;_LLB3: {struct _tuple14 _tmp7AA;return(_tmp7AA.f1=
Cyc_CfFlowInfo_BottomFL(),((_tmp7AA.f2=rval,_tmp7AA)));}_LLB4: if((_tmp10E.ReachableFL).tag
!= 2)goto _LLB1;_tmp110=(struct _tuple13)(_tmp10E.ReachableFL).val;_tmp111=_tmp110.f1;
...
_tmp7AD;void*_tmp7AC;(_tmp7AC=0,Cyc_Tcutil_warn(lexp->loc,((_tmp7AD="assignment may overwrite unique pointer(s)",
_tag_dyneither(_tmp7AD,sizeof(char),43))),_tag_dyneither(_tmp7AC,sizeof(void*),0)));}
goto _LLBB;_LLBB:;}Cyc_NewControlFlow_update_tryflow(env,outflow);{struct _tuple14
_tmp7AE;return(_tmp7AE.f1=outflow,((_tmp7AE.f2=rval,_tmp7AE)));};}_LLB9: if((
_tmp114.UnknownL).tag != 2)goto _LLB6;_tmp116=(int)(_tmp114.UnknownL).val;_LLBA: {
struct _tuple14 _tmp7AF;return(_tmp7AF.f1=Cyc_NewControlFlow_use_Rval(env,rexp->loc,
outflow,rval),((_tmp7AF.f2=rval,_tmp7AF)));}_LLB6:;}_LLB1:;}static int Cyc_NewControlFlow_is_local_var_rooted_path(
...
_tmp136=(struct Cyc_Absyn_TupleType_struct*)_tmp135;if(_tmp136->tag != 10)goto
...
_tmp139;struct _tuple17 _tmp138=Cyc_NewControlFlow_pre_stmt_check(env,inflow,s);
...
_tmp14E;struct _tuple15 _tmp14C=Cyc_NewControlFlow_anal_Lexp(env,inflow,1,_tmp143);
_tmp14D=_tmp14C.f1;_tmp14E=_tmp14C.f2;{struct _tuple15 _tmp7B0;struct _tuple15
_tmp150=(_tmp7B0.f1=_tmp14D,((_tmp7B0.f2=_tmp14E,_tmp7B0)));union Cyc_CfFlowInfo_FlowInfo
_tmp151;struct _tuple13 _tmp152;struct Cyc_Dict_Dict _tmp153;struct Cyc_List_List*
...
_tmp151.ReachableFL).tag != 2)goto _LLEA;_tmp152=(struct _tuple13)(_tmp151.ReachableFL).val;
...
struct Cyc_List_List _tmp7B1;struct Cyc_List_List _tmp15F=(_tmp7B1.hd=_tmp145,((
_tmp7B1.tl=0,_tmp7B1)));_tmp14D=Cyc_NewControlFlow_add_vars(_tmp137,_tmp14D,(
struct Cyc_List_List*)& _tmp15F,_tmp137->unknown_all,s->loc);{union Cyc_CfFlowInfo_FlowInfo
_tmp161;void*_tmp162;struct _tuple14 _tmp160=Cyc_NewControlFlow_anal_stmt_exp(env,
copy_ctxt,_tmp14D,_tmp146);_tmp161=_tmp160.f1;_tmp162=_tmp160.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp163=_tmp161;struct _tuple13 _tmp164;struct Cyc_Dict_Dict _tmp165;struct Cyc_List_List*
_tmp166;_LLF8: if((_tmp163.ReachableFL).tag != 2)goto _LLFA;_tmp164=(struct _tuple13)(
...
_tmp167=Cyc_CfFlowInfo_ReachableFL(_tmp165,_tmp166);struct _tuple14 _tmp7B2;return(
_tmp7B2.f1=_tmp167,((_tmp7B2.f2=_tmp162,_tmp7B2)));};_LLFA:;_LLFB: {struct
_tuple14 _tmp7B3;return(_tmp7B3.f1=_tmp161,((_tmp7B3.f2=_tmp162,_tmp7B3)));}_LLF7:;};};};};};};}
_LLEA: _tmp157=_tmp150.f1;if((_tmp157.BottomFL).tag != 1)goto _LLEC;_tmp158=(int)(
_tmp157.BottomFL).val;_LLEB: {struct _tuple14 _tmp7B4;return(_tmp7B4.f1=_tmp14D,((
_tmp7B4.f2=_tmp137->unknown_all,_tmp7B4)));}_LLEC:;_LLED:{const char*_tmp7B7;void*
_tmp7B6;(_tmp7B6=0,Cyc_Tcutil_terr(_tmp143->loc,((_tmp7B7="bad alias expression--no unique path found",
_tag_dyneither(_tmp7B7,sizeof(char),43))),_tag_dyneither(_tmp7B6,sizeof(void*),0)));}{
struct _tuple14 _tmp7B8;return(_tmp7B8.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7B8.f2=
_tmp137->unknown_all,_tmp7B8)));};_LLE7:;};}_LLE1: {struct Cyc_Absyn_Decl_s_struct*
...
copy_ctxt,inflow,_tmp14B);_LLE5:;_LLE6: {struct Cyc_Core_Impossible_struct _tmp7BE;
const char*_tmp7BD;struct Cyc_Core_Impossible_struct*_tmp7BC;(int)_throw((void*)((
_tmp7BC=_cycalloc(sizeof(*_tmp7BC)),((_tmp7BC[0]=((_tmp7BE.tag=Cyc_Core_Impossible,((
_tmp7BE.f1=((_tmp7BD="analyze_Rexp: ill-formed StmtExp",_tag_dyneither(_tmp7BD,
sizeof(char),33))),_tmp7BE)))),_tmp7BC)))));}_LLDC:;};}}struct _tuple21{union Cyc_CfFlowInfo_AbsLVal
...
static void _tmp85F(unsigned int*_tmp85E,unsigned int*_tmp85D,void***_tmp85B,
struct Cyc_List_List**_tmp35C){for(*_tmp85E=0;*_tmp85E < *_tmp85D;(*_tmp85E)++){
void*_tmp859;(*_tmp85B)[*_tmp85E]=((_tmp859=(void*)((struct Cyc_List_List*)
_check_null(*_tmp35C))->hd,((*_tmp35C=(*_tmp35C)->tl,_tmp859))));}}static struct
...
_tmp173=inflow;int _tmp174;struct _tuple13 _tmp175;struct Cyc_Dict_Dict _tmp176;
struct Cyc_List_List*_tmp177;_LLFD: if((_tmp173.BottomFL).tag != 1)goto _LLFF;
_tmp174=(int)(_tmp173.BottomFL).val;_LLFE: {struct _tuple14 _tmp7BF;return(_tmp7BF.f1=
Cyc_CfFlowInfo_BottomFL(),((_tmp7BF.f2=_tmp172->unknown_all,_tmp7BF)));}_LLFF:
if((_tmp173.ReachableFL).tag != 2)goto _LLFC;_tmp175=(struct _tuple13)(_tmp173.ReachableFL).val;
...
_tmp17A;union Cyc_CfFlowInfo_AbsLVal _tmp17B;struct _tuple15 _tmp179=Cyc_NewControlFlow_anal_Lexp(
env,inflow,1,e);_tmp17A=_tmp179.f1;_tmp17B=_tmp179.f2;{struct _tuple15 _tmp7C0;
struct _tuple15 _tmp17D=(_tmp7C0.f1=_tmp17A,((_tmp7C0.f2=_tmp17B,_tmp7C0)));union
Cyc_CfFlowInfo_FlowInfo _tmp17E;struct _tuple13 _tmp17F;struct Cyc_Dict_Dict _tmp180;
...
_tmp17F=(struct _tuple13)(_tmp17E.ReachableFL).val;_tmp180=_tmp17F.f1;_tmp181=
...
_tmp184,& needs_unconsume)){{const char*_tmp7C3;void*_tmp7C2;(_tmp7C2=0,Cyc_Tcutil_terr(
e->loc,((_tmp7C3="expression attempts to copy unique value that may be copied elsewhere.",
_tag_dyneither(_tmp7C3,sizeof(char),71))),_tag_dyneither(_tmp7C2,sizeof(void*),0)));}{
struct _tuple14 _tmp7C4;return(_tmp7C4.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7C4.f2=
_tmp172->unknown_all,_tmp7C4)));};}else{if(needs_unconsume){struct _tuple14
_tmp7C5;return(_tmp7C5.f1=_tmp17A,((_tmp7C5.f2=Cyc_CfFlowInfo_make_unique_unconsumed(
_tmp172,_tmp184),_tmp7C5)));}else{void*_tmp189=Cyc_CfFlowInfo_make_unique_consumed(
...
_tmp180,env->all_changed,_tmp183,_tmp189);struct _tuple14 _tmp7C6;return(_tmp7C6.f1=
Cyc_CfFlowInfo_ReachableFL(_tmp18A,_tmp181),((_tmp7C6.f2=_tmp184,_tmp7C6)));}}}
...
_tmp21A;void*_tmp21B;struct _tuple14 _tmp219=Cyc_NewControlFlow_anal_Rexp(env,
copy_ctxt,inflow,_tmp18E);_tmp21A=_tmp219.f1;_tmp21B=_tmp219.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp21D;void*_tmp21E;struct _tuple14 _tmp21C=Cyc_NewControlFlow_anal_derefR(env,
inflow,_tmp21A,_tmp18E,_tmp21B);_tmp21D=_tmp21C.f1;_tmp21E=_tmp21C.f2;{struct
_tuple14 _tmp7C7;return(_tmp7C7.f1=_tmp21D,((_tmp7C7.f2=_tmp21B,_tmp7C7)));};};}
...
else{_tmp19A=_tmp199->f1;if((_tmp19A.Int_c).tag != 5)goto _LL113;_tmp19B=(struct
_tuple6)(_tmp19A.Int_c).val;_tmp19C=_tmp19B.f2;if(_tmp19C != 0)goto _LL113;}}
_LL112: {struct _tuple14 _tmp7C8;return(_tmp7C8.f1=inflow,((_tmp7C8.f2=_tmp172->zero,
_tmp7C8)));}_LL113: {struct Cyc_Absyn_Const_e_struct*_tmp19D=(struct Cyc_Absyn_Const_e_struct*)
_tmp18C;if(_tmp19D->tag != 0)goto _LL115;else{_tmp19E=_tmp19D->f1;if((_tmp19E.Int_c).tag
!= 5)goto _LL115;_tmp19F=(struct _tuple6)(_tmp19E.Int_c).val;}}_LL114: goto _LL116;
...
if(_tmp1A2->tag != 2)goto _LL117;};}}_LL116: {struct _tuple14 _tmp7C9;return(_tmp7C9.f1=
inflow,((_tmp7C9.f2=_tmp172->notzeroall,_tmp7C9)));}_LL117: {struct Cyc_Absyn_Datatype_e_struct*
...
struct _tuple14 _tmp7CA;return(_tmp7CA.f1=inflow,((_tmp7CA.f2=_tmp172->unknown_all,
_tmp7CA)));}_LL125: {struct Cyc_Absyn_Var_e_struct*_tmp1AB=(struct Cyc_Absyn_Var_e_struct*)
...
_tmp1AD->tag != 1)goto _LL127;};}}_LL126: {struct _tuple14 _tmp7CB;return(_tmp7CB.f1=
inflow,((_tmp7CB.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp172,(void*)((struct Cyc_Core_Opt*)
_check_null(e->topt))->v,0,_tmp172->unknown_all),_tmp7CB)));}_LL127: {struct Cyc_Absyn_Var_e_struct*
...
struct Cyc_CfFlowInfo_VarRoot_struct*_tmp7D1;struct Cyc_CfFlowInfo_VarRoot_struct
_tmp7D0;struct _tuple14 _tmp7CF;return(_tmp7CF.f1=inflow,((_tmp7CF.f2=((void*(*)(
struct Cyc_Dict_Dict d,void*k))Cyc_Dict_lookup)(d,(void*)((_tmp7D1=_region_malloc(
env->r,sizeof(*_tmp7D1)),((_tmp7D1[0]=((_tmp7D0.tag=0,((_tmp7D0.f1=_tmp1B9,
_tmp7D0)))),_tmp7D1))))),_tmp7CF)));}_LL12D: {struct Cyc_Absyn_Primop_e_struct*
...
_tmp228;void*_tmp229;struct _tuple14 _tmp227=Cyc_NewControlFlow_anal_use_ints(env,
inflow,_tmp1BC);_tmp228=_tmp227.f1;_tmp229=_tmp227.f2;{struct _tuple14 _tmp7D2;
return(_tmp7D2.f1=_tmp228,((_tmp7D2.f2=_tmp229,_tmp7D2)));};}_LL12F: {struct Cyc_Absyn_Increment_e_struct*
_tmp1BD=(struct Cyc_Absyn_Increment_e_struct*)_tmp18C;if(_tmp1BD->tag != 5)goto
_LL131;else{_tmp1BE=_tmp1BD->f1;}}_LL130: {struct Cyc_List_List _tmp7D3;struct Cyc_List_List
_tmp22B=(_tmp7D3.hd=_tmp1BE,((_tmp7D3.tl=0,_tmp7D3)));union Cyc_CfFlowInfo_FlowInfo
_tmp22D;struct _tuple14 _tmp22C=Cyc_NewControlFlow_anal_use_ints(env,inflow,(
struct Cyc_List_List*)& _tmp22B);_tmp22D=_tmp22C.f1;{union Cyc_CfFlowInfo_AbsLVal
_tmp22F;struct _tuple15 _tmp22E=Cyc_NewControlFlow_anal_Lexp(env,_tmp22D,0,_tmp1BE);
_tmp22F=_tmp22E.f2;{struct _tuple21 _tmp7D4;struct _tuple21 _tmp231=(_tmp7D4.f1=
_tmp22F,((_tmp7D4.f2=_tmp22D,_tmp7D4)));union Cyc_CfFlowInfo_AbsLVal _tmp232;
struct Cyc_CfFlowInfo_Place*_tmp233;union Cyc_CfFlowInfo_FlowInfo _tmp234;struct
_tuple13 _tmp235;struct Cyc_Dict_Dict _tmp236;struct Cyc_List_List*_tmp237;_LL172:
...
_LL174;_tmp235=(struct _tuple13)(_tmp234.ReachableFL).val;_tmp236=_tmp235.f1;
...
_tmp237);goto _LL171;_LL174:;_LL175: goto _LL171;_LL171:;}{struct _tuple14 _tmp7D5;
return(_tmp7D5.f1=_tmp22D,((_tmp7D5.f2=_tmp172->unknown_all,_tmp7D5)));};};}
...
_check_null(e->topt))->v)){{const char*_tmp7D8;void*_tmp7D7;(_tmp7D7=0,Cyc_Tcutil_terr(
e->loc,((_tmp7D8="cannot track unique pointers through multiple assignments",
_tag_dyneither(_tmp7D8,sizeof(char),58))),_tag_dyneither(_tmp7D7,sizeof(void*),0)));}{
struct _tuple14 _tmp7D9;return(_tmp7D9.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7D9.f2=
_tmp172->unknown_all,_tmp7D9)));};}{struct Cyc_List_List _tmp7DA;struct Cyc_List_List
_tmp23D=(_tmp7DA.hd=_tmp1C3,((_tmp7DA.tl=0,_tmp7DA)));struct Cyc_List_List _tmp7DB;
struct Cyc_List_List _tmp23E=(_tmp7DB.hd=_tmp1C0,((_tmp7DB.tl=(struct Cyc_List_List*)&
_tmp23D,_tmp7DB)));union Cyc_CfFlowInfo_FlowInfo _tmp240;struct _tuple14 _tmp23F=Cyc_NewControlFlow_anal_use_ints(
env,inflow,(struct Cyc_List_List*)& _tmp23E);_tmp240=_tmp23F.f1;{union Cyc_CfFlowInfo_AbsLVal
_tmp242;struct _tuple15 _tmp241=Cyc_NewControlFlow_anal_Lexp(env,_tmp240,0,_tmp1C0);
_tmp242=_tmp241.f2;{union Cyc_CfFlowInfo_FlowInfo _tmp243=_tmp240;struct _tuple13
_tmp244;struct Cyc_Dict_Dict _tmp245;struct Cyc_List_List*_tmp246;_LL177: if((
_tmp243.ReachableFL).tag != 2)goto _LL179;_tmp244=(struct _tuple13)(_tmp243.ReachableFL).val;
...
_tuple14 _tmp7DC;return(_tmp7DC.f1=_tmp240,((_tmp7DC.f2=_tmp172->unknown_all,
_tmp7DC)));};};};_LL133: {struct Cyc_Absyn_AssignOp_e_struct*_tmp1C4=(struct Cyc_Absyn_AssignOp_e_struct*)
...
_tmp7DF;void*_tmp7DE;(_tmp7DE=0,Cyc_Tcutil_terr(e->loc,((_tmp7DF="cannot track unique pointers through multiple assignments",
_tag_dyneither(_tmp7DF,sizeof(char),58))),_tag_dyneither(_tmp7DE,sizeof(void*),0)));}{
struct _tuple14 _tmp7E0;return(_tmp7E0.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7E0.f2=
_tmp172->unknown_all,_tmp7E0)));};}{struct Cyc_Dict_Dict*_tmp250=env->all_changed;
while(1){{struct Cyc_Dict_Dict*_tmp7E1;env->all_changed=((_tmp7E1=_region_malloc(
env->r,sizeof(*_tmp7E1)),((_tmp7E1[0]=_tmp172->mt_place_set,_tmp7E1))));}{union
Cyc_CfFlowInfo_FlowInfo _tmp253;union Cyc_CfFlowInfo_AbsLVal _tmp254;struct _tuple15
...
_check_null(env->all_changed));{struct Cyc_Dict_Dict*_tmp7E2;env->all_changed=((
_tmp7E2=_region_malloc(env->r,sizeof(*_tmp7E2)),((_tmp7E2[0]=_tmp172->mt_place_set,
_tmp7E2))));}{union Cyc_CfFlowInfo_FlowInfo _tmp258;void*_tmp259;struct _tuple14
...
_LL136: {union Cyc_CfFlowInfo_FlowInfo _tmp25E;void*_tmp25F;struct _tuple14 _tmp25D=
...
union Cyc_CfFlowInfo_FlowInfo _tmp261;void*_tmp262;struct _tuple14 _tmp260=Cyc_NewControlFlow_anal_Rexp(
env,1,inflow,_tmp1CC);_tmp261=_tmp260.f1;_tmp262=_tmp260.f2;Cyc_NewControlFlow_use_Rval(
env,_tmp1CC->loc,_tmp261,_tmp262);{struct _tuple14 _tmp7E3;return(_tmp7E3.f1=Cyc_CfFlowInfo_BottomFL(),((
_tmp7E3.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp172,(void*)((struct Cyc_Core_Opt*)
_check_null(e->topt))->v,0,_tmp172->unknown_all),_tmp7E3)));};}_LL139: {struct
...
struct Cyc_List_List*_tmp268;struct Cyc_List_List*_tmp7E4;struct _tuple20 _tmp266=
Cyc_NewControlFlow_anal_unordered_Rexps(_tmp264,env,inflow,((_tmp7E4=
_region_malloc(_tmp264,sizeof(*_tmp7E4)),((_tmp7E4->hd=_tmp1CE,((_tmp7E4->tl=((
struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x))Cyc_List_rcopy)(
_tmp264,_tmp1CF),_tmp7E4)))))),0,1);_tmp267=_tmp266.f1;_tmp268=_tmp266.f2;{union
...
struct Cyc_Absyn_FnType_struct*)_tmp26E;if(_tmp26F->tag != 9)goto _LL188;else{
...
struct Cyc_List_List*_tmp7E5;init_params=((_tmp7E5=_region_malloc(_tmp264,sizeof(*
_tmp7E5)),((_tmp7E5->hd=(void*)_tmp274,((_tmp7E5->tl=init_params,_tmp7E5))))));}
...
struct Cyc_List_List*_tmp7E6;nolive_unique_params=((_tmp7E6=_region_malloc(
_tmp264,sizeof(*_tmp7E6)),((_tmp7E6->hd=(void*)_tmp276,((_tmp7E6->tl=
nolive_unique_params,_tmp7E6))))));}goto _LL18A;_LL18F:;_LL190: goto _LL18A;_LL18A:;}
goto _LL185;_LL188:;_LL189: {const char*_tmp7E9;void*_tmp7E8;(_tmp7E8=0,((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp7E9="anal_Rexp: bad function type",
_tag_dyneither(_tmp7E9,sizeof(char),29))),_tag_dyneither(_tmp7E8,sizeof(void*),0)));}
_LL185:;}goto _LL180;_LL183:;_LL184: {const char*_tmp7EC;void*_tmp7EB;(_tmp7EB=0,((
int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp7EC="anal_Rexp: bad function type",_tag_dyneither(_tmp7EC,sizeof(char),29))),
_tag_dyneither(_tmp7EB,sizeof(void*),0)));}_LL180:;}{int i=1;for(0;_tmp268 != 0;(((
...
union Cyc_CfFlowInfo_FlowInfo _tmp27D=_tmp267;int _tmp27E;struct _tuple13 _tmp27F;
...
!= 2)goto _LL191;_tmp27F=(struct _tuple13)(_tmp27D.ReachableFL).val;_tmp280=
_tmp27F.f1;_LL195: if(Cyc_CfFlowInfo_initlevel(env->fenv,_tmp280,(void*)_tmp268->hd)
== Cyc_CfFlowInfo_NoneIL){const char*_tmp7EF;void*_tmp7EE;(_tmp7EE=0,Cyc_Tcutil_terr(((
struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp1CF))->hd)->loc,((
_tmp7EF="expression may not be initialized",_tag_dyneither(_tmp7EF,sizeof(char),
34))),_tag_dyneither(_tmp7EE,sizeof(void*),0)));}{union Cyc_CfFlowInfo_FlowInfo
_tmp283=_tmp269;int _tmp284;struct _tuple13 _tmp285;struct Cyc_Dict_Dict _tmp286;
...
!= 2)goto _LL196;_tmp285=(struct _tuple13)(_tmp283.ReachableFL).val;_tmp286=
...
_tmp7F2;void*_tmp7F1;(_tmp7F1=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp7F2="anal_Rexp:bad type for initialized arg",
_tag_dyneither(_tmp7F2,sizeof(char),39))),_tag_dyneither(_tmp7F1,sizeof(void*),0)));}
...
void*)((struct Cyc_Core_Opt*)_check_null(_tmp1CE->topt))->v)){struct _tuple14
_tmp7F3;return(_tmp7F3.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7F3.f2=Cyc_CfFlowInfo_typ_to_absrval(
_tmp172,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v,0,_tmp172->unknown_all),
_tmp7F3)));}else{struct _tuple14 _tmp7F4;return(_tmp7F4.f1=_tmp269,((_tmp7F4.f2=
Cyc_CfFlowInfo_typ_to_absrval(_tmp172,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v,
0,_tmp172->unknown_all),_tmp7F4)));}};};}_LL13B: {struct Cyc_Absyn_Malloc_e_struct*
...
_LL13C: {struct Cyc_CfFlowInfo_MallocPt_struct _tmp7F7;struct Cyc_CfFlowInfo_MallocPt_struct*
_tmp7F6;void*root=(void*)((_tmp7F6=_region_malloc(_tmp172->r,sizeof(*_tmp7F6)),((
_tmp7F6[0]=((_tmp7F7.tag=1,((_tmp7F7.f1=_tmp1D5,((_tmp7F7.f2=(void*)((void*)((
struct Cyc_Core_Opt*)_check_null(e->topt))->v),_tmp7F7)))))),_tmp7F6))));struct
Cyc_CfFlowInfo_Place*_tmp7F8;struct Cyc_CfFlowInfo_Place*place=(_tmp7F8=
_region_malloc(_tmp172->r,sizeof(*_tmp7F8)),((_tmp7F8->root=root,((_tmp7F8->fields=
0,_tmp7F8)))));struct Cyc_CfFlowInfo_AddressOf_struct _tmp7FB;struct Cyc_CfFlowInfo_AddressOf_struct*
_tmp7FA;void*rval=(void*)((_tmp7FA=_region_malloc(_tmp172->r,sizeof(*_tmp7FA)),((
_tmp7FA[0]=((_tmp7FB.tag=5,((_tmp7FB.f1=place,_tmp7FB)))),_tmp7FA))));void*
...
_tmp297;struct Cyc_List_List*_tmp298;struct Cyc_Absyn_Exp*_tmp7FC[2];struct
_tuple20 _tmp296=Cyc_NewControlFlow_anal_unordered_Rexps(_tmp294,env,inflow,((
_tmp7FC[1]=_tmp1D5,((_tmp7FC[0]=(struct Cyc_Absyn_Exp*)_tmp1D3,((struct Cyc_List_List*(*)(
struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmp294,
_tag_dyneither(_tmp7FC,sizeof(struct Cyc_Absyn_Exp*),2)))))),1,1);_tmp297=_tmp296.f1;
_tmp298=_tmp296.f2;outflow=_tmp297;}else{union Cyc_CfFlowInfo_FlowInfo _tmp29A;
struct _tuple14 _tmp299=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp1D5);_tmp29A=
_tmp299.f1;outflow=_tmp29A;}{union Cyc_CfFlowInfo_FlowInfo _tmp29B=outflow;int
_tmp29C;struct _tuple13 _tmp29D;struct Cyc_Dict_Dict _tmp29E;struct Cyc_List_List*
_tmp29F;_LL1A6: if((_tmp29B.BottomFL).tag != 1)goto _LL1A8;_tmp29C=(int)(_tmp29B.BottomFL).val;
_LL1A7: {struct _tuple14 _tmp7FD;return(_tmp7FD.f1=outflow,((_tmp7FD.f2=rval,
_tmp7FD)));}_LL1A8: if((_tmp29B.ReachableFL).tag != 2)goto _LL1A5;_tmp29D=(struct
_tuple13)(_tmp29B.ReachableFL).val;_tmp29E=_tmp29D.f1;_tmp29F=_tmp29D.f2;_LL1A9: {
struct _tuple14 _tmp7FE;return(_tmp7FE.f1=Cyc_CfFlowInfo_ReachableFL(((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp29E,root,place_val),
_tmp29F),((_tmp7FE.f2=rval,_tmp7FE)));}_LL1A5:;};};}_LL13D: {struct Cyc_Absyn_Swap_e_struct*
...
_tmp7FF[2];struct _tuple20 _tmp2A9=Cyc_NewControlFlow_anal_unordered_Rexps(_tmp2A7,
env,inflow,((_tmp7FF[1]=_tmp1D9,((_tmp7FF[0]=_tmp1D8,((struct Cyc_List_List*(*)(
struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmp2A7,
_tag_dyneither(_tmp7FF,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,0);_tmp2AA=_tmp2A9.f1;
...
struct _tuple15 _tmp2AE=Cyc_NewControlFlow_anal_Lexp(env,outflow,0,_tmp1D9);
...
_tmp2B0.ReachableFL).tag != 2)goto _LL1AD;_tmp2B1=(struct _tuple13)(_tmp2B0.ReachableFL).val;
...
_LL1AD:;_LL1AE: goto _LL1AA;_LL1AA:;}{struct _tuple14 _tmp800;return(_tmp800.f1=
outflow,((_tmp800.f2=_tmp172->unknown_all,_tmp800)));};};};}_LL13F: {struct Cyc_Absyn_New_e_struct*
...
_tmp803;struct Cyc_CfFlowInfo_MallocPt_struct*_tmp802;void*root=(void*)((_tmp802=
_region_malloc(_tmp172->r,sizeof(*_tmp802)),((_tmp802[0]=((_tmp803.tag=1,((
_tmp803.f1=_tmp1DC,((_tmp803.f2=(void*)((void*)((struct Cyc_Core_Opt*)_check_null(
e->topt))->v),_tmp803)))))),_tmp802))));struct Cyc_CfFlowInfo_Place*_tmp804;
struct Cyc_CfFlowInfo_Place*place=(_tmp804=_region_malloc(_tmp172->r,sizeof(*
_tmp804)),((_tmp804->root=root,((_tmp804->fields=0,_tmp804)))));struct Cyc_CfFlowInfo_AddressOf_struct
_tmp807;struct Cyc_CfFlowInfo_AddressOf_struct*_tmp806;void*rval=(void*)((_tmp806=
_region_malloc(_tmp172->r,sizeof(*_tmp806)),((_tmp806[0]=((_tmp807.tag=5,((
_tmp807.f1=place,_tmp807)))),_tmp806))));((int(*)(struct Cyc_Dict_Dict*set,struct
...
_tmp2BE;struct Cyc_List_List*_tmp2BF;struct Cyc_Absyn_Exp*_tmp808[2];struct
_tuple20 _tmp2BD=Cyc_NewControlFlow_anal_unordered_Rexps(_tmp2BB,env,inflow,((
_tmp808[1]=_tmp1DC,((_tmp808[0]=(struct Cyc_Absyn_Exp*)_tmp1DB,((struct Cyc_List_List*(*)(
struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmp2BB,
_tag_dyneither(_tmp808,sizeof(struct Cyc_Absyn_Exp*),2)))))),1,1);_tmp2BE=_tmp2BD.f1;
...
Cyc_CfFlowInfo_FlowInfo _tmp2C1;void*_tmp2C2;struct _tuple14 _tmp2C0=Cyc_NewControlFlow_anal_Rexp(
...
struct _tuple13 _tmp2C5;struct Cyc_Dict_Dict _tmp2C6;struct Cyc_List_List*_tmp2C7;
_LL1BA: if((_tmp2C3.BottomFL).tag != 1)goto _LL1BC;_tmp2C4=(int)(_tmp2C3.BottomFL).val;
_LL1BB: {struct _tuple14 _tmp809;return(_tmp809.f1=outflow,((_tmp809.f2=rval,
_tmp809)));}_LL1BC: if((_tmp2C3.ReachableFL).tag != 2)goto _LL1B9;_tmp2C5=(struct
_tuple13)(_tmp2C3.ReachableFL).val;_tmp2C6=_tmp2C5.f1;_tmp2C7=_tmp2C5.f2;_LL1BD: {
struct _tuple14 _tmp80A;return(_tmp80A.f1=Cyc_CfFlowInfo_ReachableFL(((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp2C6,root,place_val),
_tmp2C7),((_tmp80A.f2=rval,_tmp80A)));}_LL1B9:;};};}_LL141: {struct Cyc_Absyn_Address_e_struct*
...
union Cyc_CfFlowInfo_AbsLVal _tmp2D1;struct _tuple15 _tmp2CF=Cyc_NewControlFlow_anal_Lexp(
...
!= 2)goto _LL1C1;_tmp2D3=(int)(_tmp2D2.UnknownL).val;_LL1C0: {struct _tuple14
_tmp80B;return(_tmp80B.f1=_tmp2D0,((_tmp80B.f2=_tmp172->notzeroall,_tmp80B)));}
_LL1C1: if((_tmp2D2.PlaceL).tag != 1)goto _LL1BE;_tmp2D4=(struct Cyc_CfFlowInfo_Place*)(
_tmp2D2.PlaceL).val;_LL1C2: {struct Cyc_CfFlowInfo_AddressOf_struct*_tmp811;
struct Cyc_CfFlowInfo_AddressOf_struct _tmp810;struct _tuple14 _tmp80F;return(
_tmp80F.f1=_tmp2D0,((_tmp80F.f2=(void*)((_tmp811=_region_malloc(env->r,sizeof(*
_tmp811)),((_tmp811[0]=((_tmp810.tag=5,((_tmp810.f1=_tmp2D4,_tmp810)))),_tmp811)))),
_tmp80F)));}_LL1BE:;};}_LL143: {struct Cyc_Absyn_Deref_e_struct*_tmp1DF=(struct
...
_tuple14 _tmp2D9=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,_tmp1E0);_tmp2DA=
...
_tmp2DD;void*_tmp2DE;struct _tuple14 _tmp2DC=Cyc_NewControlFlow_anal_Rexp(env,0,
inflow,_tmp1E2);_tmp2DD=_tmp2DC.f1;_tmp2DE=_tmp2DC.f2;if(Cyc_Absyn_is_nontagged_union_type((
void*)((struct Cyc_Core_Opt*)_check_null(_tmp1E2->topt))->v)){struct _tuple14
_tmp812;return(_tmp812.f1=_tmp2DD,((_tmp812.f2=Cyc_CfFlowInfo_typ_to_absrval(
_tmp172,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v,0,_tmp172->unknown_all),
_tmp812)));}{void*_tmp2E0=_tmp2DE;struct Cyc_CfFlowInfo_UnionRInfo _tmp2E2;int
...
_tmp2E4 != - 1) && _tmp2E4 != _tmp2E6){struct _tuple14 _tmp813;return(_tmp813.f1=
_tmp2DD,((_tmp813.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp172,(void*)((struct Cyc_Core_Opt*)
_check_null(e->topt))->v,1,_tmp172->unknown_none),_tmp813)));}{struct _tuple14
_tmp814;return(_tmp814.f1=_tmp2DD,((_tmp814.f2=*((void**)
_check_dyneither_subscript(_tmp2E5,sizeof(void*),_tmp2E6)),_tmp814)));};}_LL1C6:;
_LL1C7: {struct Cyc_Core_Impossible_struct _tmp821;const char*_tmp820;void*_tmp81F[
1];struct Cyc_String_pa_struct _tmp81E;struct Cyc_Core_Impossible_struct*_tmp81D;(
int)_throw((void*)((_tmp81D=_cycalloc(sizeof(*_tmp81D)),((_tmp81D[0]=((_tmp821.tag=
Cyc_Core_Impossible,((_tmp821.f1=(struct _dyneither_ptr)((_tmp81E.tag=0,((_tmp81E.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp81F[
0]=& _tmp81E,Cyc_aprintf(((_tmp820="anal_Rexp: AggrMember: %s",_tag_dyneither(
_tmp820,sizeof(char),26))),_tag_dyneither(_tmp81F,sizeof(void*),1)))))))),
_tmp821)))),_tmp81D)))));}_LL1C3:;};}_LL147: {struct Cyc_Absyn_Tagcheck_e_struct*
...
_tmp2EF;void*_tmp2F0;struct _tuple14 _tmp2EE=Cyc_NewControlFlow_anal_Rexp(env,0,
inflow,_tmp1E5);_tmp2EF=_tmp2EE.f1;_tmp2F0=_tmp2EE.f2;if(Cyc_Absyn_is_nontagged_union_type((
void*)((struct Cyc_Core_Opt*)_check_null(_tmp1E5->topt))->v)){struct _tuple14
_tmp822;return(_tmp822.f1=_tmp2EF,((_tmp822.f2=_tmp172->unknown_all,_tmp822)));}{
...
_tmp2F6 != - 1){if(_tmp2F6 != _tmp2F8){struct _tuple14 _tmp823;return(_tmp823.f1=
_tmp2EF,((_tmp823.f2=_tmp172->zero,_tmp823)));}else{struct _tuple14 _tmp824;return(
_tmp824.f1=_tmp2EF,((_tmp824.f2=_tmp172->notzeroall,_tmp824)));}}else{struct
_tuple14 _tmp825;return(_tmp825.f1=_tmp2EF,((_tmp825.f2=_tmp172->unknown_all,
_tmp825)));}}_LL1CB:;_LL1CC: {struct Cyc_Core_Impossible_struct _tmp832;const char*
_tmp831;void*_tmp830[1];struct Cyc_String_pa_struct _tmp82F;struct Cyc_Core_Impossible_struct*
_tmp82E;(int)_throw((void*)((_tmp82E=_cycalloc(sizeof(*_tmp82E)),((_tmp82E[0]=((
_tmp832.tag=Cyc_Core_Impossible,((_tmp832.f1=(struct _dyneither_ptr)((_tmp82F.tag=
0,((_tmp82F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(
e)),((_tmp830[0]=& _tmp82F,Cyc_aprintf(((_tmp831="anal_Rexp: TagCheck_e: %s",
_tag_dyneither(_tmp831,sizeof(char),26))),_tag_dyneither(_tmp830,sizeof(void*),1)))))))),
_tmp832)))),_tmp82E)))));}_LL1C8:;};}_LL149: {struct Cyc_Absyn_AggrArrow_e_struct*
...
_tmp302;void*_tmp303;struct _tuple14 _tmp301=Cyc_NewControlFlow_anal_Rexp(env,0,
inflow,_tmp1E8);_tmp302=_tmp301.f1;_tmp303=_tmp301.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp305;void*_tmp306;struct _tuple14 _tmp304=Cyc_NewControlFlow_anal_derefR(env,
...
_tmp30A)){struct _tuple14 _tmp833;return(_tmp833.f1=_tmp305,((_tmp833.f2=Cyc_CfFlowInfo_typ_to_absrval(
_tmp172,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v,0,_tmp172->unknown_all),
_tmp833)));}{void*_tmp30C=_tmp306;struct Cyc_CfFlowInfo_UnionRInfo _tmp30E;int
...
_tmp1E9);if((_tmp30F  && _tmp310 != - 1) && _tmp310 != _tmp312){struct _tuple14
_tmp834;return(_tmp834.f1=_tmp305,((_tmp834.f2=Cyc_CfFlowInfo_typ_to_absrval(
_tmp172,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v,1,_tmp172->unknown_none),
_tmp834)));}{struct _tuple14 _tmp835;return(_tmp835.f1=_tmp305,((_tmp835.f2=*((
void**)_check_dyneither_subscript(_tmp311,sizeof(void*),_tmp312)),_tmp835)));};}
_LL1D5:;_LL1D6: {struct Cyc_Core_Impossible_struct _tmp83B;const char*_tmp83A;
struct Cyc_Core_Impossible_struct*_tmp839;(int)_throw((void*)((_tmp839=_cycalloc(
sizeof(*_tmp839)),((_tmp839[0]=((_tmp83B.tag=Cyc_Core_Impossible,((_tmp83B.f1=((
_tmp83A="anal_Rexp: AggrArrow",_tag_dyneither(_tmp83A,sizeof(char),21))),_tmp83B)))),
_tmp839)))));}_LL1D2:;};_LL1D0:;_LL1D1: {struct Cyc_Core_Impossible_struct _tmp841;
const char*_tmp840;struct Cyc_Core_Impossible_struct*_tmp83F;(int)_throw((void*)((
_tmp83F=_cycalloc(sizeof(*_tmp83F)),((_tmp83F[0]=((_tmp841.tag=Cyc_Core_Impossible,((
_tmp841.f1=((_tmp840="anal_Rexp: AggrArrow ptr",_tag_dyneither(_tmp840,sizeof(
char),25))),_tmp841)))),_tmp83F)))));}_LL1CD:;};};}_LL14B: {struct Cyc_Absyn_Conditional_e_struct*
...
_tuple16 _tmp31B=Cyc_NewControlFlow_anal_test(env,inflow,_tmp1EB);_tmp31C=_tmp31B.f1;
_tmp31D=_tmp31B.f2;{struct _tuple14 _tmp31E=Cyc_NewControlFlow_anal_Rexp(env,
copy_ctxt,_tmp31C,_tmp1EC);struct _tuple14 _tmp31F=Cyc_NewControlFlow_anal_Rexp(
...
_tmp321;union Cyc_CfFlowInfo_FlowInfo _tmp322;struct _tuple16 _tmp320=Cyc_NewControlFlow_anal_test(
env,inflow,_tmp1EF);_tmp321=_tmp320.f1;_tmp322=_tmp320.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp324;void*_tmp325;struct _tuple14 _tmp323=Cyc_NewControlFlow_anal_Rexp(env,
copy_ctxt,_tmp321,_tmp1F0);_tmp324=_tmp323.f1;_tmp325=_tmp323.f2;{struct _tuple14
_tmp842;struct _tuple14 _tmp326=(_tmp842.f1=_tmp324,((_tmp842.f2=_tmp325,_tmp842)));
struct _tuple14 _tmp843;struct _tuple14 _tmp327=(_tmp843.f1=_tmp322,((_tmp843.f2=
_tmp172->zero,_tmp843)));return Cyc_CfFlowInfo_join_flow_and_rval(_tmp172,env->all_changed,
...
struct _tuple16 _tmp32A=Cyc_NewControlFlow_anal_test(env,inflow,_tmp1F2);_tmp32B=
_tmp32A.f1;_tmp32C=_tmp32A.f2;{union Cyc_CfFlowInfo_FlowInfo _tmp32E;void*_tmp32F;
struct _tuple14 _tmp32D=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,_tmp32C,_tmp1F3);
_tmp32E=_tmp32D.f1;_tmp32F=_tmp32D.f2;{struct _tuple14 _tmp844;struct _tuple14
_tmp330=(_tmp844.f1=_tmp32E,((_tmp844.f2=_tmp32F,_tmp844)));struct _tuple14
_tmp845;struct _tuple14 _tmp331=(_tmp845.f1=_tmp32B,((_tmp845.f2=_tmp172->notzeroall,
_tmp845)));return Cyc_CfFlowInfo_join_flow_and_rval(_tmp172,env->all_changed,
...
struct Cyc_Absyn_Exp*_tmp846[2];struct _tuple20 _tmp336=Cyc_NewControlFlow_anal_unordered_Rexps(
_tmp334,env,inflow,((_tmp846[1]=_tmp1F6,((_tmp846[0]=_tmp1F5,((struct Cyc_List_List*(*)(
struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmp334,
_tag_dyneither(_tmp846,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,1);_tmp337=_tmp336.f1;
_tmp338=_tmp336.f2;{union Cyc_CfFlowInfo_FlowInfo _tmp339=_tmp337;{union Cyc_CfFlowInfo_FlowInfo
_tmp33A=_tmp337;struct _tuple13 _tmp33B;struct Cyc_Dict_Dict _tmp33C;struct Cyc_List_List*
_tmp33D;_LL1D8: if((_tmp33A.ReachableFL).tag != 2)goto _LL1DA;_tmp33B=(struct
_tuple13)(_tmp33A.ReachableFL).val;_tmp33C=_tmp33B.f1;_tmp33D=_tmp33B.f2;_LL1D9:
...
const char*_tmp849;void*_tmp848;(_tmp848=0,Cyc_Tcutil_terr(_tmp1F6->loc,((_tmp849="expression may not be initialized",
_tag_dyneither(_tmp849,sizeof(char),34))),_tag_dyneither(_tmp848,sizeof(void*),0)));}{
...
_tmp342=(struct Cyc_Absyn_TupleType_struct*)_tmp341;if(_tmp342->tag != 10)goto
...
_tmp1F6)).f1;struct _tuple14 _tmp84A;return(_tmp84A.f1=_tmp339,((_tmp84A.f2=*((
void**)_check_dyneither_subscript(_tmp34A,sizeof(void*),(int)i)),_tmp84A)));}
_LL1E6:;_LL1E7: {struct Cyc_Core_Impossible_struct _tmp850;const char*_tmp84F;
...
_tmp84F="anal_Rexp: Subscript",_tag_dyneither(_tmp84F,sizeof(char),21))),_tmp850)))),
_tmp84E)))));}_LL1E3:;}_LL1DF: {struct Cyc_Absyn_PointerType_struct*_tmp344=(
...
union Cyc_CfFlowInfo_FlowInfo _tmp350;void*_tmp351;struct _tuple14 _tmp34F=Cyc_NewControlFlow_anal_derefR(
...
_tmp352.BottomFL).val;_LL1EA: {struct _tuple14 _tmp851;return(_tmp851.f1=_tmp350,((
_tmp851.f2=_tmp351,_tmp851)));}_LL1EB:;_LL1EC: {struct _tuple14 _tmp852;return(
_tmp852.f1=_tmp339,((_tmp852.f2=_tmp351,_tmp852)));}_LL1E8:;};}_LL1E1:;_LL1E2: {
...
_tmp858.tag=Cyc_Core_Impossible,((_tmp858.f1=((_tmp857="anal_Rexp: Subscript -- bad type",
_tag_dyneither(_tmp857,sizeof(char),33))),_tmp858)))),_tmp856)))));}_LL1DC:;};};}
...
_tmp35B;struct Cyc_List_List*_tmp35C;struct _tuple20 _tmp35A=Cyc_NewControlFlow_anal_unordered_Rexps(
_tmp359,env,inflow,_tmp1FB,1,1);_tmp35B=_tmp35A.f1;_tmp35C=_tmp35A.f2;{
unsigned int _tmp85E;unsigned int _tmp85D;struct _dyneither_ptr _tmp85C;void**
_tmp85B;unsigned int _tmp85A;struct _dyneither_ptr aggrdict=(_tmp85A=(unsigned int)((
int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp1FB),((_tmp85B=(void**)
_region_malloc(env->r,_check_times(sizeof(void*),_tmp85A)),((_tmp85C=
_tag_dyneither(_tmp85B,sizeof(void*),_tmp85A),((((_tmp85D=_tmp85A,_tmp85F(&
_tmp85E,& _tmp85D,& _tmp85B,& _tmp35C))),_tmp85C)))))));struct Cyc_CfFlowInfo_Aggregate_struct*
_tmp869;struct Cyc_CfFlowInfo_UnionRInfo _tmp868;struct Cyc_CfFlowInfo_Aggregate_struct
_tmp867;struct _tuple14 _tmp866;return(_tmp866.f1=_tmp35B,((_tmp866.f2=(void*)((
_tmp869=_region_malloc(env->r,sizeof(*_tmp869)),((_tmp869[0]=((_tmp867.tag=6,((
_tmp867.f1=((_tmp868.is_union=0,((_tmp868.fieldnum=- 1,_tmp868)))),((_tmp867.f2=
aggrdict,_tmp867)))))),_tmp869)))),_tmp866)));};}_LL157: {struct Cyc_Absyn_AnonStruct_e_struct*
...
struct Cyc_Absyn_AnonAggrType_struct*)_tmp366;if(_tmp367->tag != 12)goto _LL1F0;
else{_tmp368=_tmp367->f2;}}_LL1EF: fs=_tmp368;goto _LL1ED;_LL1F0:;_LL1F1: {struct
Cyc_Core_Impossible_struct _tmp86F;const char*_tmp86E;struct Cyc_Core_Impossible_struct*
_tmp86D;(int)_throw((void*)((_tmp86D=_cycalloc(sizeof(*_tmp86D)),((_tmp86D[0]=((
_tmp86F.tag=Cyc_Core_Impossible,((_tmp86F.f1=((_tmp86E="anal_Rexp:anon struct has bad type",
_tag_dyneither(_tmp86E,sizeof(char),35))),_tmp86F)))),_tmp86D)))));}_LL1ED:;}
...
_tmp36F;struct _tuple20 _tmp36D=Cyc_NewControlFlow_anal_unordered_Rexps(_tmp36C,
env,inflow,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_Absyn_Exp*(*
f)(struct _tuple22*),struct Cyc_List_List*x))Cyc_List_rmap)(_tmp36C,(struct Cyc_Absyn_Exp*(*)(
struct _tuple22*))Cyc_Core_snd,_tmp1FF),1,1);_tmp36E=_tmp36D.f1;_tmp36F=_tmp36D.f2;{
...
_tuple22*)((struct Cyc_List_List*)_check_null(_tmp1FF))->hd)).f1;for(0;ds != 0;ds=
...
_tmp875;const char*_tmp874;struct Cyc_Core_Impossible_struct*_tmp873;(int)_throw((
void*)((_tmp873=_cycalloc(sizeof(*_tmp873)),((_tmp873[0]=((_tmp875.tag=Cyc_Core_Impossible,((
_tmp875.f1=((_tmp874="anal_Rexp:Aggregate_e",_tag_dyneither(_tmp874,sizeof(char),
22))),_tmp875)))),_tmp873)))));}_LL1F5: {struct Cyc_Absyn_FieldName_struct*
...
_tmp377=(*((struct _tuple22*)_tmp1FF->hd)).f2;_tmp36E=Cyc_NewControlFlow_use_Rval(
env,_tmp377->loc,_tmp36E,(void*)_tmp36F->hd);}_LL1F2:;}}}{struct Cyc_CfFlowInfo_Aggregate_struct*
_tmp87F;struct Cyc_CfFlowInfo_UnionRInfo _tmp87E;struct Cyc_CfFlowInfo_Aggregate_struct
_tmp87D;struct _tuple14 _tmp87C;return(_tmp87C.f1=_tmp36E,((_tmp87C.f2=(void*)((
_tmp87F=_region_malloc(env->r,sizeof(*_tmp87F)),((_tmp87F[0]=((_tmp87D.tag=6,((
_tmp87D.f1=((_tmp87E.is_union=_tmp202 == Cyc_Absyn_UnionA,((_tmp87E.fieldnum=
field_no,_tmp87E)))),((_tmp87D.f2=aggrdict,_tmp87D)))))),_tmp87F)))),_tmp87C)));};};}
...
_tmp885;const char*_tmp884;struct Cyc_Core_Impossible_struct*_tmp883;(int)_throw((
void*)((_tmp883=_cycalloc(sizeof(*_tmp883)),((_tmp883[0]=((_tmp885.tag=Cyc_Core_Impossible,((
_tmp885.f1=((_tmp884="anal_Rexp:missing aggrdeclimpl",_tag_dyneither(_tmp884,
sizeof(char),31))),_tmp885)))),_tmp883)))));}_LL15D: {struct Cyc_Absyn_Array_e_struct*
...
struct _tuple22*),struct Cyc_List_List*x))Cyc_List_rmap)(_tmp37F,(struct Cyc_Absyn_Exp*(*)(
struct _tuple22*))Cyc_Core_snd,_tmp208);union Cyc_CfFlowInfo_FlowInfo _tmp382;
struct Cyc_List_List*_tmp383;struct _tuple20 _tmp381=Cyc_NewControlFlow_anal_unordered_Rexps(
...
_tmp382,(void*)_tmp383->hd);}{struct _tuple14 _tmp886;return(_tmp886.f1=_tmp382,((
_tmp886.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp172,(void*)((struct Cyc_Core_Opt*)
_check_null(e->topt))->v,0,_tmp172->unknown_all),_tmp886)));};}_LL15F: {struct
...
_tmp386;void*_tmp387;struct _tuple14 _tmp385=Cyc_NewControlFlow_anal_Rexp(env,1,
inflow,_tmp20B);_tmp386=_tmp385.f1;_tmp387=_tmp385.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp388=_tmp386;int _tmp389;struct _tuple13 _tmp38A;struct Cyc_Dict_Dict _tmp38B;
struct Cyc_List_List*_tmp38C;_LL1F8: if((_tmp388.BottomFL).tag != 1)goto _LL1FA;
_tmp389=(int)(_tmp388.BottomFL).val;_LL1F9: {struct _tuple14 _tmp887;return(
_tmp887.f1=_tmp386,((_tmp887.f2=_tmp172->unknown_all,_tmp887)));}_LL1FA: if((
_tmp388.ReachableFL).tag != 2)goto _LL1F7;_tmp38A=(struct _tuple13)(_tmp388.ReachableFL).val;
_tmp38B=_tmp38A.f1;_tmp38C=_tmp38A.f2;_LL1FB: if(Cyc_CfFlowInfo_initlevel(env->fenv,
_tmp38B,_tmp387)== Cyc_CfFlowInfo_NoneIL){const char*_tmp88A;void*_tmp889;(
_tmp889=0,Cyc_Tcutil_terr(_tmp20B->loc,((_tmp88A="expression may not be initialized",
...
_tmp3A2->escapes))goto _LL207;_LL206:{struct Cyc_CfFlowInfo_Reln*_tmp88D;struct Cyc_List_List*
_tmp88C;new_relns=((_tmp88C=_region_malloc(env->r,sizeof(*_tmp88C)),((_tmp88C->hd=((
_tmp88D=_region_malloc(env->r,sizeof(*_tmp88D)),((_tmp88D->vd=_tmp20A,((_tmp88D->rop=
Cyc_CfFlowInfo_LessVar(_tmp3A2,_tmp3A2->type),_tmp88D)))))),((_tmp88C->tl=
_tmp38C,_tmp88C))))));}goto _LL1FC;_LL207: {struct Cyc_Absyn_Const_e_struct*
_tmp3A3=(struct Cyc_Absyn_Const_e_struct*)_tmp390;if(_tmp3A3->tag != 0)goto _LL209;
else{_tmp3A4=_tmp3A3->f1;if((_tmp3A4.Int_c).tag != 5)goto _LL209;_tmp3A5=(struct
_tuple6)(_tmp3A4.Int_c).val;_tmp3A6=_tmp3A5.f2;}}_LL208:{struct Cyc_CfFlowInfo_Reln*
_tmp890;struct Cyc_List_List*_tmp88F;new_relns=((_tmp88F=_region_malloc(env->r,
sizeof(*_tmp88F)),((_tmp88F->hd=((_tmp890=_region_malloc(env->r,sizeof(*_tmp890)),((
_tmp890->vd=_tmp20A,((_tmp890->rop=Cyc_CfFlowInfo_LessConst((unsigned int)
_tmp3A6),_tmp890)))))),((_tmp88F->tl=_tmp38C,_tmp88F))))));}goto _LL1FC;_LL209: {
...
_tmp893;struct Cyc_List_List*_tmp892;new_relns=((_tmp892=_region_malloc(env->r,
sizeof(*_tmp892)),((_tmp892->hd=((_tmp893=_region_malloc(env->r,sizeof(*_tmp893)),((
_tmp893->vd=_tmp20A,((_tmp893->rop=Cyc_CfFlowInfo_LessNumelts(_tmp3C0),_tmp893)))))),((
_tmp892->tl=_tmp38C,_tmp892))))));}goto _LL20D;_LL216:;_LL217: goto _LL20D;_LL20D:;}
...
_LL21B;}_LL21A: {struct _tuple14 _tmp894;return(_tmp894.f1=_tmp386,((_tmp894.f2=
_tmp172->unknown_all,_tmp894)));}_LL21B: {struct Cyc_CfFlowInfo_NotZeroThis_struct*
...
_LL221;}_LL220: {struct Cyc_List_List _tmp895;struct Cyc_List_List _tmp3C9=(_tmp895.hd=
_tmp20A,((_tmp895.tl=0,_tmp895)));_tmp386=Cyc_NewControlFlow_add_vars(_tmp172,
_tmp386,(struct Cyc_List_List*)& _tmp3C9,_tmp172->unknown_all,e->loc);{union Cyc_CfFlowInfo_FlowInfo
_tmp3CB;void*_tmp3CC;struct _tuple14 _tmp3CA=Cyc_NewControlFlow_anal_Rexp(env,1,
_tmp386,_tmp20C);_tmp3CB=_tmp3CA.f1;_tmp3CC=_tmp3CA.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp3CD=_tmp3CB;int _tmp3CE;struct _tuple13 _tmp3CF;struct Cyc_Dict_Dict _tmp3D0;
_LL224: if((_tmp3CD.BottomFL).tag != 1)goto _LL226;_tmp3CE=(int)(_tmp3CD.BottomFL).val;
_LL225: {struct _tuple14 _tmp896;return(_tmp896.f1=_tmp3CB,((_tmp896.f2=_tmp172->unknown_all,
_tmp896)));}_LL226: if((_tmp3CD.ReachableFL).tag != 2)goto _LL223;_tmp3CF=(struct
_tuple13)(_tmp3CD.ReachableFL).val;_tmp3D0=_tmp3CF.f1;_LL227: if(Cyc_CfFlowInfo_initlevel(
_tmp172,_tmp3D0,_tmp3CC)!= Cyc_CfFlowInfo_AllIL){{const char*_tmp899;void*_tmp898;(
_tmp898=0,Cyc_Tcutil_terr(_tmp20B->loc,((_tmp899="expression may not be initialized",
_tag_dyneither(_tmp899,sizeof(char),34))),_tag_dyneither(_tmp898,sizeof(void*),0)));}{
struct _tuple14 _tmp89A;return(_tmp89A.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp89A.f2=
_tmp172->unknown_all,_tmp89A)));};}_LL223:;}_tmp386=_tmp3CB;goto _LL222;};}_LL221:;
_LL222: while(1){struct Cyc_List_List _tmp89B;struct Cyc_List_List _tmp3D6=(_tmp89B.hd=
_tmp20A,((_tmp89B.tl=0,_tmp89B)));_tmp386=Cyc_NewControlFlow_add_vars(_tmp172,
_tmp386,(struct Cyc_List_List*)& _tmp3D6,_tmp172->unknown_all,e->loc);{union Cyc_CfFlowInfo_FlowInfo
_tmp3D8;void*_tmp3D9;struct _tuple14 _tmp3D7=Cyc_NewControlFlow_anal_Rexp(env,1,
_tmp386,_tmp20C);_tmp3D8=_tmp3D7.f1;_tmp3D9=_tmp3D7.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp3DA=_tmp3D8;int _tmp3DB;struct _tuple13 _tmp3DC;struct Cyc_Dict_Dict _tmp3DD;
...
struct _tuple13)(_tmp3DA.ReachableFL).val;_tmp3DD=_tmp3DC.f1;_LL22C: if(Cyc_CfFlowInfo_initlevel(
_tmp172,_tmp3DD,_tmp3D9)!= Cyc_CfFlowInfo_AllIL){{const char*_tmp89E;void*_tmp89D;(
_tmp89D=0,Cyc_Tcutil_terr(_tmp20B->loc,((_tmp89E="expression may not be initialized",
_tag_dyneither(_tmp89E,sizeof(char),34))),_tag_dyneither(_tmp89D,sizeof(void*),0)));}{
struct _tuple14 _tmp89F;return(_tmp89F.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp89F.f2=
_tmp172->unknown_all,_tmp89F)));};}_LL228:;}{union Cyc_CfFlowInfo_FlowInfo _tmp3E1=
Cyc_CfFlowInfo_join_flow(_tmp172,env->all_changed,_tmp386,_tmp3D8);if(Cyc_CfFlowInfo_flow_lessthan_approx(
_tmp3E1,_tmp386))break;_tmp386=_tmp3E1;};};}{struct _tuple14 _tmp8A0;return(
_tmp8A0.f1=_tmp386,((_tmp8A0.f2=_tmp172->unknown_all,_tmp8A0)));};_LL218:;};};
...
_tmp8A6.f1=((_tmp8A5="anal_Rexp, unexpected exp form",_tag_dyneither(_tmp8A5,
sizeof(char),31))),_tmp8A6)))),_tmp8A4)))));}_LL106:;};}static struct _tuple15 Cyc_NewControlFlow_anal_derefL(
struct Cyc_NewControlFlow_AnalEnv*env,union Cyc_CfFlowInfo_FlowInfo inflow,struct
...
_tmp3EF=f;int _tmp3F0;struct _tuple13 _tmp3F1;struct Cyc_Dict_Dict _tmp3F2;struct Cyc_List_List*
_tmp3F3;_LL233: if((_tmp3EF.BottomFL).tag != 1)goto _LL235;_tmp3F0=(int)(_tmp3EF.BottomFL).val;
_LL234: {struct _tuple15 _tmp8A7;return(_tmp8A7.f1=f,((_tmp8A7.f2=Cyc_CfFlowInfo_UnknownL(),
_tmp8A7)));}_LL235: if((_tmp3EF.ReachableFL).tag != 2)goto _LL232;_tmp3F1=(struct
_tuple13)(_tmp3EF.ReachableFL).val;_tmp3F2=_tmp3F1.f1;_tmp3F3=_tmp3F1.f2;_LL236:
...
goto _LL23C;}_LL23B:{struct Cyc_CfFlowInfo_NotZero_struct _tmp8AA;struct Cyc_CfFlowInfo_NotZero_struct*
_tmp8A9;e->annot=(void*)((_tmp8A9=_cycalloc(sizeof(*_tmp8A9)),((_tmp8A9[0]=((
_tmp8AA.tag=Cyc_CfFlowInfo_NotZero,((_tmp8AA.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmp3F3),_tmp8AA)))),_tmp8A9))));}goto _LL237;_LL23C: {struct Cyc_CfFlowInfo_AddressOf_struct*
...
_tmp3FA.fields;}}_LL23D:{struct Cyc_CfFlowInfo_NotZero_struct _tmp8AD;struct Cyc_CfFlowInfo_NotZero_struct*
_tmp8AC;e->annot=(void*)((_tmp8AC=_cycalloc(sizeof(*_tmp8AC)),((_tmp8AC[0]=((
_tmp8AD.tag=Cyc_CfFlowInfo_NotZero,((_tmp8AD.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmp3F3),_tmp8AD)))),_tmp8AC))));}{struct Cyc_CfFlowInfo_Place*_tmp8B0;struct
_tuple15 _tmp8AF;return(_tmp8AF.f1=f,((_tmp8AF.f2=Cyc_CfFlowInfo_PlaceL(((_tmp8B0=
_region_malloc(_tmp3E7->r,sizeof(*_tmp8B0)),((_tmp8B0->root=_tmp3FB,((_tmp8B0->fields=((
struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x,struct Cyc_List_List*
y))Cyc_List_rappend)(_tmp3E7->r,_tmp3FC,flds),_tmp8B0))))))),_tmp8AF)));};_LL23E: {
...
struct _tuple15 _tmp8B1;return(_tmp8B1.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp8B1.f2=
Cyc_CfFlowInfo_UnknownL(),_tmp8B1)));};_LL240: {struct Cyc_CfFlowInfo_UnknownR_struct*
...
_tmp8B4;struct Cyc_CfFlowInfo_UnknownZ_struct*_tmp8B3;e->annot=(void*)((_tmp8B3=
_cycalloc(sizeof(*_tmp8B3)),((_tmp8B3[0]=((_tmp8B4.tag=Cyc_CfFlowInfo_UnknownZ,((
_tmp8B4.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,_tmp3F3),_tmp8B4)))),
_tmp8B3))));}_LL237:;}else{struct Cyc_CfFlowInfo_UnknownZ_struct _tmp8B7;struct Cyc_CfFlowInfo_UnknownZ_struct*
_tmp8B6;e->annot=(void*)((_tmp8B6=_cycalloc(sizeof(*_tmp8B6)),((_tmp8B6[0]=((
_tmp8B7.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp8B7.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmp3F3),_tmp8B7)))),_tmp8B6))));}if(Cyc_CfFlowInfo_initlevel(_tmp3E7,_tmp3F2,r)
== Cyc_CfFlowInfo_NoneIL){const char*_tmp8BA;void*_tmp8B9;(_tmp8B9=0,Cyc_Tcutil_terr(
e->loc,((_tmp8BA="dereference of possibly uninitialized pointer",_tag_dyneither(
_tmp8BA,sizeof(char),46))),_tag_dyneither(_tmp8B9,sizeof(void*),0)));}{struct
_tuple15 _tmp8BB;return(_tmp8BB.f1=f,((_tmp8BB.f2=Cyc_CfFlowInfo_UnknownL(),
_tmp8BB)));};_LL232:;}_LL230:;_LL231: {struct Cyc_Core_Impossible_struct _tmp8C1;
const char*_tmp8C0;struct Cyc_Core_Impossible_struct*_tmp8BF;(int)_throw((void*)((
_tmp8BF=_cycalloc(sizeof(*_tmp8BF)),((_tmp8BF[0]=((_tmp8C1.tag=Cyc_Core_Impossible,((
_tmp8C1.f1=((_tmp8C0="left deref of non-pointer-type",_tag_dyneither(_tmp8C0,
sizeof(char),31))),_tmp8C1)))),_tmp8BF)))));}_LL22D:;}static struct _tuple15 Cyc_NewControlFlow_anal_Lexp_rec(
...
_tmp412=inflow;int _tmp413;struct _tuple13 _tmp414;struct Cyc_Dict_Dict _tmp415;
struct Cyc_List_List*_tmp416;_LL245: if((_tmp412.BottomFL).tag != 1)goto _LL247;
_tmp413=(int)(_tmp412.BottomFL).val;_LL246: {struct _tuple15 _tmp8C2;return(
_tmp8C2.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp8C2.f2=Cyc_CfFlowInfo_UnknownL(),
_tmp8C2)));}_LL247: if((_tmp412.ReachableFL).tag != 2)goto _LL244;_tmp414=(struct
_tuple13)(_tmp412.ReachableFL).val;_tmp415=_tmp414.f1;_tmp416=_tmp414.f2;_LL248:
...
else{_tmp42A=_tmp429->f1;}};}}_LL255: {struct Cyc_CfFlowInfo_Place*_tmp8CC;struct
Cyc_CfFlowInfo_VarRoot_struct _tmp8CB;struct Cyc_CfFlowInfo_VarRoot_struct*_tmp8CA;
struct _tuple15 _tmp8C9;return(_tmp8C9.f1=inflow,((_tmp8C9.f2=Cyc_CfFlowInfo_PlaceL(((
_tmp8CC=_region_malloc(env->r,sizeof(*_tmp8CC)),((_tmp8CC->root=(void*)((_tmp8CA=
_region_malloc(env->r,sizeof(*_tmp8CA)),((_tmp8CA[0]=((_tmp8CB.tag=0,((_tmp8CB.f1=
_tmp42A,_tmp8CB)))),_tmp8CA)))),((_tmp8CC->fields=flds,_tmp8CC))))))),_tmp8C9)));}
...
_tuple15 _tmp8CD;return(_tmp8CD.f1=inflow,((_tmp8CD.f2=Cyc_CfFlowInfo_UnknownL(),
_tmp8CD)));}_LL258: {struct Cyc_Absyn_AggrArrow_e_struct*_tmp42F=(struct Cyc_Absyn_AggrArrow_e_struct*)
...
_tmp8CE;flds=((_tmp8CE=_region_malloc(env->r,sizeof(*_tmp8CE)),((_tmp8CE->hd=(
void*)Cyc_CfFlowInfo_get_field_index(_tmp442,_tmp431),((_tmp8CE->tl=flds,_tmp8CE))))));}
goto _LL262;_LL265:;_LL266: {struct Cyc_Core_Impossible_struct _tmp8D4;const char*
_tmp8D3;struct Cyc_Core_Impossible_struct*_tmp8D2;(int)_throw((void*)((_tmp8D2=
_cycalloc(sizeof(*_tmp8D2)),((_tmp8D2[0]=((_tmp8D4.tag=Cyc_Core_Impossible,((
_tmp8D4.f1=((_tmp8D3="anal_Rexp: AggrArrow ptr",_tag_dyneither(_tmp8D3,sizeof(
char),25))),_tmp8D4)))),_tmp8D2)))));}_LL262:;}_tmp433=_tmp430;goto _LL25B;_LL25A: {
...
_tmp449;struct _tuple15 _tmp447=Cyc_NewControlFlow_anal_Lexp(env,inflow,1,_tmp433);
_tmp448=_tmp447.f1;_tmp449=_tmp447.f2;{struct _tuple15 _tmp8D5;struct _tuple15
_tmp44B=(_tmp8D5.f1=_tmp448,((_tmp8D5.f2=_tmp449,_tmp8D5)));union Cyc_CfFlowInfo_FlowInfo
_tmp44C;struct _tuple13 _tmp44D;struct Cyc_Dict_Dict _tmp44E;struct Cyc_List_List*
...
struct _tuple13)(_tmp44C.ReachableFL).val;_tmp44E=_tmp44D.f1;_tmp44F=_tmp44D.f2;
...
_tmp8D8;struct Cyc_CfFlowInfo_MallocPt_struct*_tmp8D7;void*new_root=(void*)((
_tmp8D7=_region_malloc(_tmp411->r,sizeof(*_tmp8D7)),((_tmp8D7[0]=((_tmp8D8.tag=1,((
_tmp8D8.f1=e,((_tmp8D8.f2=(void*)((void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v),
_tmp8D8)))))),_tmp8D7))));struct Cyc_CfFlowInfo_Place*_tmp8D9;struct Cyc_CfFlowInfo_Place*
place=(_tmp8D9=_region_malloc(_tmp411->r,sizeof(*_tmp8D9)),((_tmp8D9->root=
new_root,((_tmp8D9->fields=0,_tmp8D9)))));struct Cyc_CfFlowInfo_AddressOf_struct
_tmp8DC;struct Cyc_CfFlowInfo_AddressOf_struct*_tmp8DB;void*res=(void*)((_tmp8DB=
_region_malloc(_tmp411->r,sizeof(*_tmp8DB)),((_tmp8DB[0]=((_tmp8DC.tag=5,((
_tmp8DC.f1=place,_tmp8DC)))),_tmp8DB))));((int(*)(struct Cyc_Dict_Dict*set,struct
Cyc_CfFlowInfo_Place*place,struct Cyc_Position_Segment*loc))Cyc_CfFlowInfo_update_place_set)(
...
_LL267:;};}{union Cyc_CfFlowInfo_FlowInfo _tmp45C;void*_tmp45D;struct _tuple14
...
_tmp45E;if(_tmp45F->tag != 10)goto _LL274;}_LL273: {unsigned int _tmp464=(Cyc_Evexp_eval_const_uint_exp(
_tmp436)).f1;struct Cyc_List_List*_tmp8DD;return Cyc_NewControlFlow_anal_Lexp_rec(
env,inflow,expand_unique,_tmp435,((_tmp8DD=_region_malloc(env->r,sizeof(*_tmp8DD)),((
_tmp8DD->hd=(void*)((int)_tmp464),((_tmp8DD->tl=flds,_tmp8DD)))))));}_LL274: {
...
_tmp469;struct Cyc_List_List*_tmp46A;struct Cyc_Absyn_Exp*_tmp8DE[2];struct
_tuple20 _tmp468=Cyc_NewControlFlow_anal_unordered_Rexps(_tmp466,env,inflow,((
_tmp8DE[1]=_tmp436,((_tmp8DE[0]=_tmp435,((struct Cyc_List_List*(*)(struct
_RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmp466,_tag_dyneither(
_tmp8DE,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,1);_tmp469=_tmp468.f1;_tmp46A=
_tmp468.f2;{union Cyc_CfFlowInfo_FlowInfo _tmp46B=_tmp469;{union Cyc_CfFlowInfo_FlowInfo
_tmp46C=_tmp469;struct _tuple13 _tmp46D;struct Cyc_Dict_Dict _tmp46E;struct Cyc_List_List*
_tmp46F;_LL279: if((_tmp46C.ReachableFL).tag != 2)goto _LL27B;_tmp46D=(struct
_tuple13)(_tmp46C.ReachableFL).val;_tmp46E=_tmp46D.f1;_tmp46F=_tmp46D.f2;_LL27A:
...
const char*_tmp8E1;void*_tmp8E0;(_tmp8E0=0,Cyc_Tcutil_terr(_tmp436->loc,((_tmp8E1="expression may not be initialized",
_tag_dyneither(_tmp8E1,sizeof(char),34))),_tag_dyneither(_tmp8E0,sizeof(void*),0)));}{
...
_tmp474;union Cyc_CfFlowInfo_AbsLVal _tmp475;struct _tuple15 _tmp473=Cyc_NewControlFlow_anal_derefL(
...
_tmp476.BottomFL).val;_LL27F: {struct _tuple15 _tmp8E2;return(_tmp8E2.f1=_tmp474,((
_tmp8E2.f2=_tmp475,_tmp8E2)));}_LL280:;_LL281: {struct _tuple15 _tmp8E3;return(
_tmp8E3.f1=_tmp46B,((_tmp8E3.f2=_tmp475,_tmp8E3)));}_LL27D:;};};};}_LL276:;
_LL277: {struct Cyc_Core_Impossible_struct _tmp8E9;const char*_tmp8E8;struct Cyc_Core_Impossible_struct*
_tmp8E7;(int)_throw((void*)((_tmp8E7=_cycalloc(sizeof(*_tmp8E7)),((_tmp8E7[0]=((
_tmp8E9.tag=Cyc_Core_Impossible,((_tmp8E9.f1=((_tmp8E8="anal_Lexp: Subscript -- bad type",
_tag_dyneither(_tmp8E8,sizeof(char),33))),_tmp8E9)))),_tmp8E7)))));}_LL271:;}
...
_check_null(_tmp438->topt))->v)){struct _tuple15 _tmp8EA;return(_tmp8EA.f1=inflow,((
_tmp8EA.f2=Cyc_CfFlowInfo_UnknownL(),_tmp8EA)));}{struct Cyc_List_List*_tmp8EB;
return Cyc_NewControlFlow_anal_Lexp_rec(env,inflow,expand_unique,_tmp438,((
_tmp8EB=_region_malloc(env->r,sizeof(*_tmp8EB)),((_tmp8EB->hd=(void*)Cyc_CfFlowInfo_get_field_index((
void*)((struct Cyc_Core_Opt*)_check_null(_tmp438->topt))->v,_tmp439),((_tmp8EB->tl=
flds,_tmp8EB)))))));};_LL260:;_LL261: {struct _tuple15 _tmp8EC;return(_tmp8EC.f1=
Cyc_CfFlowInfo_BottomFL(),((_tmp8EC.f2=Cyc_CfFlowInfo_UnknownL(),_tmp8EC)));}
_LL249:;};}static struct _tuple15 Cyc_NewControlFlow_anal_Lexp(struct Cyc_NewControlFlow_AnalEnv*
...
_tuple15 _tmp480=Cyc_NewControlFlow_anal_Lexp_rec(env,inflow,expand_unique,e,0);
_tmp481=_tmp480.f1;_tmp482=_tmp480.f2;{struct _tuple15 _tmp8ED;return(_tmp8ED.f1=
_tmp481,((_tmp8ED.f2=_tmp482,_tmp8ED)));};}static struct _tuple16 Cyc_NewControlFlow_anal_test(
struct Cyc_NewControlFlow_AnalEnv*env,union Cyc_CfFlowInfo_FlowInfo inflow,struct
...
_tuple16 _tmp49C=Cyc_NewControlFlow_anal_test(env,inflow,_tmp487);_tmp49D=_tmp49C.f1;
_tmp49E=_tmp49C.f2;{union Cyc_CfFlowInfo_FlowInfo _tmp4A0;union Cyc_CfFlowInfo_FlowInfo
_tmp4A1;struct _tuple16 _tmp49F=Cyc_NewControlFlow_anal_test(env,_tmp49D,_tmp488);
_tmp4A0=_tmp49F.f1;_tmp4A1=_tmp49F.f2;{union Cyc_CfFlowInfo_FlowInfo _tmp4A3;union
Cyc_CfFlowInfo_FlowInfo _tmp4A4;struct _tuple16 _tmp4A2=Cyc_NewControlFlow_anal_test(
env,_tmp49E,_tmp489);_tmp4A3=_tmp4A2.f1;_tmp4A4=_tmp4A2.f2;{struct _tuple16
_tmp8EE;return(_tmp8EE.f1=Cyc_CfFlowInfo_join_flow(_tmp484,env->all_changed,
_tmp4A0,_tmp4A3),((_tmp8EE.f2=Cyc_CfFlowInfo_join_flow(_tmp484,env->all_changed,
_tmp4A1,_tmp4A4),_tmp8EE)));};};};}_LL285: {struct Cyc_Absyn_And_e_struct*_tmp48A=(
...
_tmp4A7;union Cyc_CfFlowInfo_FlowInfo _tmp4A8;struct _tuple16 _tmp4A6=Cyc_NewControlFlow_anal_test(
env,inflow,_tmp48B);_tmp4A7=_tmp4A6.f1;_tmp4A8=_tmp4A6.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp4AA;union Cyc_CfFlowInfo_FlowInfo _tmp4AB;struct _tuple16 _tmp4A9=Cyc_NewControlFlow_anal_test(
env,_tmp4A7,_tmp48C);_tmp4AA=_tmp4A9.f1;_tmp4AB=_tmp4A9.f2;{struct _tuple16
_tmp8EF;return(_tmp8EF.f1=_tmp4AA,((_tmp8EF.f2=Cyc_CfFlowInfo_join_flow(_tmp484,
env->all_changed,_tmp4A8,_tmp4AB),_tmp8EF)));};};}_LL287: {struct Cyc_Absyn_Or_e_struct*
...
_tmp4AE;union Cyc_CfFlowInfo_FlowInfo _tmp4AF;struct _tuple16 _tmp4AD=Cyc_NewControlFlow_anal_test(
...
env,_tmp4AF,_tmp48F);_tmp4B1=_tmp4B0.f1;_tmp4B2=_tmp4B0.f2;{struct _tuple16
_tmp8F0;return(_tmp8F0.f1=Cyc_CfFlowInfo_join_flow(_tmp484,env->all_changed,
_tmp4AE,_tmp4B1),((_tmp8F0.f2=_tmp4B2,_tmp8F0)));};};}_LL289: {struct Cyc_Absyn_SeqExp_e_struct*
...
_tmp4B5;void*_tmp4B6;struct _tuple14 _tmp4B4=Cyc_NewControlFlow_anal_Rexp(env,0,
...
env,inflow,_tmp497);_tmp4B8=_tmp4B7.f1;_tmp4B9=_tmp4B7.f2;{struct _tuple16 _tmp8F1;
return(_tmp8F1.f1=_tmp4B9,((_tmp8F1.f2=_tmp4B8,_tmp8F1)));};}_LL28D: {struct Cyc_Absyn_Primop_e_struct*
...
Cyc_List_List*_tmp4BE;struct _tuple20 _tmp4BC=Cyc_NewControlFlow_anal_unordered_Rexps(
...
int _tmp4C0;struct _tuple13 _tmp4C1;struct Cyc_Dict_Dict _tmp4C2;struct Cyc_List_List*
_tmp4C3;_LL292: if((_tmp4BF.BottomFL).tag != 1)goto _LL294;_tmp4C0=(int)(_tmp4BF.BottomFL).val;
_LL293: {struct _tuple16 _tmp8F2;return(_tmp8F2.f1=f,((_tmp8F2.f2=f,_tmp8F2)));}
_LL294: if((_tmp4BF.ReachableFL).tag != 2)goto _LL291;_tmp4C1=(struct _tuple13)(
...
== Cyc_CfFlowInfo_NoneIL){const char*_tmp8F5;void*_tmp8F4;(_tmp8F4=0,Cyc_Tcutil_terr(((
struct Cyc_Absyn_Exp*)_tmp49B->hd)->loc,((_tmp8F5="expression may not be initialized",
_tag_dyneither(_tmp8F5,sizeof(char),34))),_tag_dyneither(_tmp8F4,sizeof(void*),0)));}
if(Cyc_CfFlowInfo_initlevel(env->fenv,_tmp4C2,r2)== Cyc_CfFlowInfo_NoneIL){const
char*_tmp8F8;void*_tmp8F7;(_tmp8F7=0,Cyc_Tcutil_terr(((struct Cyc_Absyn_Exp*)((
struct Cyc_List_List*)_check_null(_tmp49B->tl))->hd)->loc,((_tmp8F8="expression may not be initialized",
_tag_dyneither(_tmp8F8,sizeof(char),34))),_tag_dyneither(_tmp8F7,sizeof(void*),0)));}
if(_tmp49A == Cyc_Absyn_Eq  || _tmp49A == Cyc_Absyn_Neq){struct _tuple0 _tmp8F9;
struct _tuple0 _tmp4CC=(_tmp8F9.f1=r1,((_tmp8F9.f2=r2,_tmp8F9)));void*_tmp4CD;
...
_tmp4F4;union Cyc_CfFlowInfo_FlowInfo _tmp4F5;struct _tuple16 _tmp4F3=Cyc_NewControlFlow_splitzero(
env,f,f,_tmp4C5,_tmp4CF);_tmp4F4=_tmp4F3.f1;_tmp4F5=_tmp4F3.f2;switch(_tmp49A){
case Cyc_Absyn_Eq: _LL2AB: {struct _tuple16 _tmp8FA;return(_tmp8FA.f1=_tmp4F5,((
_tmp8FA.f2=_tmp4F4,_tmp8FA)));}case Cyc_Absyn_Neq: _LL2AC: {struct _tuple16 _tmp8FB;
return(_tmp8FB.f1=_tmp4F4,((_tmp8FB.f2=_tmp4F5,_tmp8FB)));}default: _LL2AD: {
struct Cyc_Core_Impossible_struct _tmp901;const char*_tmp900;struct Cyc_Core_Impossible_struct*
_tmp8FF;(int)_throw((void*)((_tmp8FF=_cycalloc(sizeof(*_tmp8FF)),((_tmp8FF[0]=((
_tmp901.tag=Cyc_Core_Impossible,((_tmp901.f1=((_tmp900="anal_test, zero-split",
_tag_dyneither(_tmp900,sizeof(char),22))),_tmp901)))),_tmp8FF)))));}}}_LL299:
...
union Cyc_CfFlowInfo_FlowInfo _tmp4FD;struct _tuple16 _tmp4FB=Cyc_NewControlFlow_splitzero(
env,f,f,_tmp4C6,_tmp4D6);_tmp4FC=_tmp4FB.f1;_tmp4FD=_tmp4FB.f2;switch(_tmp49A){
case Cyc_Absyn_Eq: _LL2AF: {struct _tuple16 _tmp902;return(_tmp902.f1=_tmp4FD,((
_tmp902.f2=_tmp4FC,_tmp902)));}case Cyc_Absyn_Neq: _LL2B0: {struct _tuple16 _tmp903;
return(_tmp903.f1=_tmp4FC,((_tmp903.f2=_tmp4FD,_tmp903)));}default: _LL2B1: {
struct Cyc_Core_Impossible_struct _tmp909;const char*_tmp908;struct Cyc_Core_Impossible_struct*
_tmp907;(int)_throw((void*)((_tmp907=_cycalloc(sizeof(*_tmp907)),((_tmp907[0]=((
_tmp909.tag=Cyc_Core_Impossible,((_tmp909.f1=((_tmp908="anal_test, zero-split",
_tag_dyneither(_tmp908,sizeof(char),22))),_tmp909)))),_tmp907)))));}}}_LL29B:
...
_LL29D;};_LL29C: if(_tmp49A == Cyc_Absyn_Eq){struct _tuple16 _tmp90A;return(_tmp90A.f1=
f,((_tmp90A.f2=Cyc_CfFlowInfo_BottomFL(),_tmp90A)));}else{struct _tuple16 _tmp90B;
return(_tmp90B.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp90B.f2=f,_tmp90B)));}_LL29D:
...
struct _tuple16 _tmp90C;return(_tmp90C.f1=f,((_tmp90C.f2=Cyc_CfFlowInfo_BottomFL(),
_tmp90C)));}else{struct _tuple16 _tmp90D;return(_tmp90D.f1=Cyc_CfFlowInfo_BottomFL(),((
_tmp90D.f2=f,_tmp90D)));}_LL2A9:;_LL2AA: goto _LL296;_LL296:;}{struct _tuple0
_tmp90E;struct _tuple0 _tmp508=(_tmp90E.f1=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
_check_null(_tmp4C5->topt))->v),((_tmp90E.f2=Cyc_Tcutil_compress((void*)((struct
Cyc_Core_Opt*)_check_null(_tmp4C6->topt))->v),_tmp90E)));void*_tmp509;enum Cyc_Absyn_Sign
...
struct Cyc_Absyn_TagType_struct*)_tmp50F;if(_tmp510->tag != 19)goto _LL2BA;};_LL2B9:
goto _LL2BB;_LL2BA: _tmp511=_tmp508.f2;{struct Cyc_Absyn_TagType_struct*_tmp512=(
struct Cyc_Absyn_TagType_struct*)_tmp511;if(_tmp512->tag != 19)goto _LL2BC;};_LL2BB:
goto _LL2B3;_LL2BC:;_LL2BD: {struct _tuple16 _tmp90F;return(_tmp90F.f1=f,((_tmp90F.f2=
f,_tmp90F)));}_LL2B3:;}switch(_tmp49A){case Cyc_Absyn_Eq: _LL2BE: goto _LL2BF;case
Cyc_Absyn_Neq: _LL2BF: goto _LL2C0;case Cyc_Absyn_Gt: _LL2C0: goto _LL2C1;case Cyc_Absyn_Gte:
_LL2C1: {struct _tuple16 _tmp910;return(_tmp910.f1=f,((_tmp910.f2=f,_tmp910)));}
case Cyc_Absyn_Lt: _LL2C2: {union Cyc_CfFlowInfo_FlowInfo _tmp515=f;union Cyc_CfFlowInfo_FlowInfo
_tmp516=f;{union Cyc_CfFlowInfo_FlowInfo _tmp517=_tmp515;int _tmp518;struct _tuple13
...
_tmp916;const char*_tmp915;struct Cyc_Core_Impossible_struct*_tmp914;(int)_throw((
void*)((_tmp914=_cycalloc(sizeof(*_tmp914)),((_tmp914[0]=((_tmp916.tag=Cyc_Core_Impossible,((
_tmp916.f1=((_tmp915="anal_test, Lt",_tag_dyneither(_tmp915,sizeof(char),14))),
_tmp916)))),_tmp914)))));}_LL2C7: if((_tmp517.ReachableFL).tag != 2)goto _LL2C4;
_tmp519=(struct _tuple13)(_tmp517.ReachableFL).val;_tmp51A=_tmp519.f1;_LL2C8:
...
_tmp551=(env->fenv)->r;struct Cyc_CfFlowInfo_Reln*_tmp919;struct Cyc_List_List*
_tmp918;struct Cyc_List_List*_tmp552=(_tmp918=_region_malloc(_tmp551,sizeof(*
_tmp918)),((_tmp918->hd=((_tmp919=_region_malloc(_tmp551,sizeof(*_tmp919)),((
_tmp919->vd=_tmp52E,((_tmp919->rop=Cyc_CfFlowInfo_LessVar(_tmp53F,_tmp53F->type),
_tmp919)))))),((_tmp918->tl=_tmp4C3,_tmp918)))));struct _tuple16 _tmp91A;return(
_tmp91A.f1=Cyc_CfFlowInfo_ReachableFL(_tmp4C2,_tmp552),((_tmp91A.f2=_tmp516,
_tmp91A)));}_LL2DD: {struct Cyc_Absyn_Const_e_struct*_tmp540=(struct Cyc_Absyn_Const_e_struct*)
_tmp52F;if(_tmp540->tag != 0)goto _LL2DF;else{_tmp541=_tmp540->f1;if((_tmp541.Int_c).tag
!= 5)goto _LL2DF;_tmp542=(struct _tuple6)(_tmp541.Int_c).val;_tmp543=_tmp542.f2;}}
...
else{_tmp549=_tmp548->f1;if((_tmp549.Int_c).tag != 5)goto _LL2E1;_tmp54A=(struct
_tuple6)(_tmp549.Int_c).val;_tmp54B=_tmp54A.f2;}};}}_LL2E0: {struct _RegionHandle*
_tmp556=(env->fenv)->r;struct Cyc_CfFlowInfo_Reln*_tmp91D;struct Cyc_List_List*
_tmp91C;struct Cyc_List_List*_tmp557=(_tmp91C=_region_malloc(_tmp556,sizeof(*
_tmp91C)),((_tmp91C->hd=((_tmp91D=_region_malloc(_tmp556,sizeof(*_tmp91D)),((
_tmp91D->vd=_tmp52E,((_tmp91D->rop=Cyc_CfFlowInfo_LessConst((unsigned int)
_tmp54B),_tmp91D)))))),((_tmp91C->tl=_tmp4C3,_tmp91C)))));struct _tuple16 _tmp91E;
return(_tmp91E.f1=Cyc_CfFlowInfo_ReachableFL(_tmp4C2,_tmp557),((_tmp91E.f2=
_tmp516,_tmp91E)));}_LL2E1: {struct Cyc_Absyn_Primop_e_struct*_tmp54C=(struct Cyc_Absyn_Primop_e_struct*)
...
_tmp56C=(env->fenv)->r;struct Cyc_CfFlowInfo_Reln*_tmp921;struct Cyc_List_List*
_tmp920;struct Cyc_List_List*_tmp56D=(_tmp920=_region_malloc(_tmp56C,sizeof(*
_tmp920)),((_tmp920->hd=((_tmp921=_region_malloc(_tmp56C,sizeof(*_tmp921)),((
_tmp921->vd=_tmp52E,((_tmp921->rop=Cyc_CfFlowInfo_LessNumelts(_tmp56B),_tmp921)))))),((
_tmp920->tl=_tmp4C3,_tmp920)))));struct _tuple16 _tmp922;return(_tmp922.f1=Cyc_CfFlowInfo_ReachableFL(
_tmp4C2,_tmp56D),((_tmp922.f2=_tmp516,_tmp922)));}_LL2EE:;_LL2EF: {struct
_tuple16 _tmp923;return(_tmp923.f1=_tmp515,((_tmp923.f2=_tmp516,_tmp923)));}
_LL2E5:;}_LL2E3:;_LL2E4: {struct _tuple16 _tmp924;return(_tmp924.f1=_tmp515,((
_tmp924.f2=_tmp516,_tmp924)));}_LL2D4:;}_LL2D2:;_LL2D3: {struct _tuple16 _tmp925;
return(_tmp925.f1=_tmp515,((_tmp925.f2=_tmp516,_tmp925)));}_LL2C9:;};}case Cyc_Absyn_Lte:
_LL2C3: {union Cyc_CfFlowInfo_FlowInfo _tmp574=f;union Cyc_CfFlowInfo_FlowInfo
_tmp575=f;{union Cyc_CfFlowInfo_FlowInfo _tmp576=_tmp574;int _tmp577;struct _tuple13
...
_tmp92B;const char*_tmp92A;struct Cyc_Core_Impossible_struct*_tmp929;(int)_throw((
void*)((_tmp929=_cycalloc(sizeof(*_tmp929)),((_tmp929[0]=((_tmp92B.tag=Cyc_Core_Impossible,((
_tmp92B.f1=((_tmp92A="anal_test, Lte",_tag_dyneither(_tmp92A,sizeof(char),15))),
_tmp92B)))),_tmp929)))));}_LL2F4: if((_tmp576.ReachableFL).tag != 2)goto _LL2F1;
_tmp578=(struct _tuple13)(_tmp576.ReachableFL).val;_tmp579=_tmp578.f1;_LL2F5:
...
_tmp58F->tag != 0)goto _LL304;else{_tmp590=_tmp58F->f1;if((_tmp590.Int_c).tag != 5)
...
else{_tmp598=_tmp597->f1;if((_tmp598.Int_c).tag != 5)goto _LL306;_tmp599=(struct
_tuple6)(_tmp598.Int_c).val;_tmp59A=_tmp599.f2;}};}}_LL305: {struct _RegionHandle*
_tmp5A0=(env->fenv)->r;struct Cyc_CfFlowInfo_Reln*_tmp92E;struct Cyc_List_List*
_tmp92D;struct Cyc_List_List*_tmp5A1=(_tmp92D=_region_malloc(_tmp5A0,sizeof(*
_tmp92D)),((_tmp92D->hd=((_tmp92E=_region_malloc(_tmp5A0,sizeof(*_tmp92E)),((
_tmp92E->vd=_tmp58D,((_tmp92E->rop=Cyc_CfFlowInfo_LessEqConst((unsigned int)
_tmp59A),_tmp92E)))))),((_tmp92D->tl=_tmp4C3,_tmp92D)))));struct _tuple16 _tmp92F;
return(_tmp92F.f1=Cyc_CfFlowInfo_ReachableFL(_tmp4C2,_tmp5A1),((_tmp92F.f2=
_tmp575,_tmp92F)));}_LL306: {struct Cyc_Absyn_Primop_e_struct*_tmp59B=(struct Cyc_Absyn_Primop_e_struct*)
...
_tmp5B6=env->fenv;struct Cyc_CfFlowInfo_Reln*_tmp932;struct Cyc_List_List*_tmp931;
struct Cyc_List_List*_tmp5B7=(_tmp931=_region_malloc(_tmp5B6->r,sizeof(*_tmp931)),((
_tmp931->hd=((_tmp932=_region_malloc(_tmp5B6->r,sizeof(*_tmp932)),((_tmp932->vd=
_tmp58D,((_tmp932->rop=Cyc_CfFlowInfo_LessEqNumelts(_tmp5B5),_tmp932)))))),((
_tmp931->tl=_tmp4C3,_tmp931)))));struct _tuple16 _tmp933;return(_tmp933.f1=Cyc_CfFlowInfo_ReachableFL(
_tmp4C2,_tmp5B7),((_tmp933.f2=_tmp575,_tmp933)));}_LL313:;_LL314: {struct
_tuple16 _tmp934;return(_tmp934.f1=_tmp574,((_tmp934.f2=_tmp575,_tmp934)));}
_LL30A:;}_LL308:;_LL309: {struct _tuple16 _tmp935;return(_tmp935.f1=_tmp574,((
_tmp935.f2=_tmp575,_tmp935)));}_LL301:;}_LL2FF:;_LL300: {struct _tuple16 _tmp936;
return(_tmp936.f1=_tmp574,((_tmp936.f2=_tmp575,_tmp936)));}_LL2F6:;};}default:
_LL2F0: {struct _tuple16 _tmp937;return(_tmp937.f1=f,((_tmp937.f2=f,_tmp937)));}}}
_LL291:;};}_LL28F:;_LL290: goto _LL282;_LL282:;}{union Cyc_CfFlowInfo_FlowInfo
_tmp5C0;void*_tmp5C1;struct _tuple14 _tmp5BF=Cyc_NewControlFlow_anal_Rexp(env,0,
inflow,e);_tmp5C0=_tmp5BF.f1;_tmp5C1=_tmp5BF.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp5C2=_tmp5C0;int _tmp5C3;struct _tuple13 _tmp5C4;struct Cyc_Dict_Dict _tmp5C5;
_LL317: if((_tmp5C2.BottomFL).tag != 1)goto _LL319;_tmp5C3=(int)(_tmp5C2.BottomFL).val;
_LL318: {struct _tuple16 _tmp938;return(_tmp938.f1=_tmp5C0,((_tmp938.f2=_tmp5C0,
_tmp938)));}_LL319: if((_tmp5C2.ReachableFL).tag != 2)goto _LL316;_tmp5C4=(struct
_tuple13)(_tmp5C2.ReachableFL).val;_tmp5C5=_tmp5C4.f1;_LL31A: {void*_tmp5C7=
...
_LL31E;}_LL31D: {struct _tuple16 _tmp939;return(_tmp939.f1=Cyc_CfFlowInfo_BottomFL(),((
_tmp939.f2=_tmp5C0,_tmp939)));}_LL31E: {struct Cyc_CfFlowInfo_NotZeroThis_struct*
...
_LL324;}_LL323: {struct _tuple16 _tmp93A;return(_tmp93A.f1=_tmp5C0,((_tmp93A.f2=
Cyc_CfFlowInfo_BottomFL(),_tmp93A)));}_LL324: {struct Cyc_CfFlowInfo_UnknownR_struct*
...
_LL32A;}_LL329:{const char*_tmp93D;void*_tmp93C;(_tmp93C=0,Cyc_Tcutil_terr(e->loc,((
_tmp93D="expression may not be initialized",_tag_dyneither(_tmp93D,sizeof(char),
34))),_tag_dyneither(_tmp93C,sizeof(void*),0)));}{struct _tuple16 _tmp93E;return(
_tmp93E.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp93E.f2=Cyc_CfFlowInfo_BottomFL(),
_tmp93E)));};_LL32A: {struct Cyc_CfFlowInfo_UnknownR_struct*_tmp5D1=(struct Cyc_CfFlowInfo_UnknownR_struct*)
...
_LL32D: {struct _tuple16 _tmp93F;return(_tmp93F.f1=_tmp5C0,((_tmp93F.f2=_tmp5C0,
_tmp93F)));}_LL32E: {struct Cyc_CfFlowInfo_Aggregate_struct*_tmp5D4=(struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmp5C7;if(_tmp5D4->tag != 6)goto _LL31B;}_LL32F: {struct Cyc_Core_Impossible_struct
_tmp945;const char*_tmp944;struct Cyc_Core_Impossible_struct*_tmp943;(int)_throw((
void*)((_tmp943=_cycalloc(sizeof(*_tmp943)),((_tmp943[0]=((_tmp945.tag=Cyc_Core_Impossible,((
_tmp945.f1=((_tmp944="anal_test",_tag_dyneither(_tmp944,sizeof(char),10))),
_tmp945)))),_tmp943)))));}_LL31B:;}_LL316:;};};}struct _tuple23{struct Cyc_Position_Segment*
f1;struct Cyc_NewControlFlow_AnalEnv*f2;struct Cyc_Dict_Dict f3;};static void Cyc_NewControlFlow_check_for_unused_unique(
struct _tuple23*ckenv,void*root,void*rval){struct _tuple23 _tmp5DF;struct Cyc_Position_Segment*
_tmp5E0;struct Cyc_NewControlFlow_AnalEnv*_tmp5E1;struct Cyc_Dict_Dict _tmp5E2;
struct _tuple23*_tmp5DE=ckenv;_tmp5DF=*_tmp5DE;_tmp5E0=_tmp5DF.f1;_tmp5E1=_tmp5DF.f2;
...
goto _LL335;_LL33C:;_LL33D:{const char*_tmp949;void*_tmp948[1];struct Cyc_String_pa_struct
_tmp947;(_tmp947.tag=0,((_tmp947.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp5E5->name)),((_tmp948[0]=& _tmp947,Cyc_Tcutil_warn(
_tmp5E0,((_tmp949="unique pointers reachable from %s may become unreachable",
_tag_dyneither(_tmp949,sizeof(char),57))),_tag_dyneither(_tmp948,sizeof(void*),1)))))));}
...
int _tmp5EF;struct _tuple13 _tmp5F0;struct Cyc_Dict_Dict _tmp5F1;_LL33F: if((_tmp5EE.BottomFL).tag
!= 1)goto _LL341;_tmp5EF=(int)(_tmp5EE.BottomFL).val;_LL340: return;_LL341: if((
_tmp5EE.ReachableFL).tag != 2)goto _LL33E;_tmp5F0=(struct _tuple13)(_tmp5EE.ReachableFL).val;
...
Cyc_CfFlowInfo_AllIL){const char*_tmp94C;void*_tmp94B;(_tmp94B=0,Cyc_Tcutil_terr(
loc,((_tmp94C="function may not initialize all the parameters with attribute 'initializes'",
_tag_dyneither(_tmp94C,sizeof(char),76))),_tag_dyneither(_tmp94B,sizeof(void*),0)));}}}
if(Cyc_NewControlFlow_warn_lose_unique){struct _tuple23 _tmp94D;struct _tuple23
_tmp5F5=(_tmp94D.f1=loc,((_tmp94D.f2=env,((_tmp94D.f3=_tmp5F1,_tmp94D)))));((
...
_tmp600;struct _tuple16 _tmp5FE=Cyc_NewControlFlow_anal_test(env,clause_inflow,
...
_tmp950;void*_tmp94F;(_tmp94F=0,Cyc_Tcutil_terr(_tmp5FC->loc,((_tmp950="switch clause may implicitly fallthru",
_tag_dyneither(_tmp950,sizeof(char),38))),_tag_dyneither(_tmp94F,sizeof(void*),0)));}
else{const char*_tmp953;void*_tmp952;(_tmp952=0,Cyc_Tcutil_warn(_tmp5FC->loc,((
_tmp953="switch clause may implicitly fallthru",_tag_dyneither(_tmp953,sizeof(
char),38))),_tag_dyneither(_tmp952,sizeof(void*),0)));}Cyc_NewControlFlow_update_flow(
...
_tuple24{struct Cyc_NewControlFlow_AnalEnv*f1;struct Cyc_Dict_Dict f2;struct Cyc_Position_Segment*
f3;};static void Cyc_NewControlFlow_check_dropped_unique_vd(struct _tuple24*vdenv,
struct Cyc_Absyn_Vardecl*vd){struct _tuple24 _tmp608;struct Cyc_NewControlFlow_AnalEnv*
_tmp609;struct Cyc_Dict_Dict _tmp60A;struct Cyc_Position_Segment*_tmp60B;struct
_tuple24*_tmp607=vdenv;_tmp608=*_tmp607;_tmp609=_tmp608.f1;_tmp60A=_tmp608.f2;
_tmp60B=_tmp608.f3;if(Cyc_Tcutil_is_noalias_pointer_or_aggr((_tmp609->fenv)->r,
vd->type)){struct Cyc_CfFlowInfo_VarRoot_struct _tmp956;struct Cyc_CfFlowInfo_VarRoot_struct*
_tmp955;struct Cyc_CfFlowInfo_VarRoot_struct*_tmp60C=(_tmp955=_region_malloc((
_tmp609->fenv)->r,sizeof(*_tmp955)),((_tmp955[0]=((_tmp956.tag=0,((_tmp956.f1=vd,
_tmp956)))),_tmp955)));void*_tmp60D=((void*(*)(struct Cyc_Dict_Dict d,void*k))Cyc_Dict_lookup)(
...
goto _LL348;_LL34F:;_LL350:{const char*_tmp95A;void*_tmp959[1];struct Cyc_String_pa_struct
_tmp958;(_tmp958.tag=0,((_tmp958.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(vd->name)),((_tmp959[0]=& _tmp958,Cyc_Tcutil_warn(_tmp60B,((
_tmp95A="unique pointers may still exist after variable %s goes out of scope",
_tag_dyneither(_tmp95A,sizeof(char),68))),_tag_dyneither(_tmp959,sizeof(void*),1)))))));}
...
_tmp618=inflow;struct _tuple13 _tmp619;struct Cyc_Dict_Dict _tmp61A;_LL352: if((
_tmp618.ReachableFL).tag != 2)goto _LL354;_tmp619=(struct _tuple13)(_tmp618.ReachableFL).val;
_tmp61A=_tmp619.f1;_LL353: {struct _tuple24 _tmp95B;struct _tuple24 _tmp61B=(_tmp95B.f1=
env,((_tmp95B.f2=_tmp61A,((_tmp95B.f3=decl->loc,_tmp95B)))));struct Cyc_CfFlowInfo_FlowEnv*
...
_tmp625=_tmp624->f1;}}_LL35C:((void(*)(void(*f)(struct _tuple24*,struct Cyc_Absyn_Vardecl*),
...
_tmp628;union Cyc_CfFlowInfo_FlowInfo*_tmp629;struct _tuple17 _tmp627=Cyc_NewControlFlow_pre_stmt_check(
...
_tmp639;struct _tuple10 _tmp63B;struct Cyc_Absyn_Exp*_tmp63C;struct Cyc_Absyn_Stmt*
_tmp63D;struct Cyc_Absyn_Stmt*_tmp63E;struct Cyc_Absyn_Stmt*_tmp640;struct _tuple10
_tmp641;struct Cyc_Absyn_Exp*_tmp642;struct Cyc_Absyn_Stmt*_tmp643;struct Cyc_Absyn_Exp*
_tmp645;struct _tuple10 _tmp646;struct Cyc_Absyn_Exp*_tmp647;struct Cyc_Absyn_Stmt*
_tmp648;struct _tuple10 _tmp649;struct Cyc_Absyn_Exp*_tmp64A;struct Cyc_Absyn_Stmt*
...
const char*_tmp95E;void*_tmp95D;(_tmp95D=0,Cyc_Tcutil_terr(s->loc,((_tmp95E="`noreturn' function might return",
_tag_dyneither(_tmp95E,sizeof(char),33))),_tag_dyneither(_tmp95D,sizeof(void*),0)));}
...
const char*_tmp961;void*_tmp960;(_tmp960=0,Cyc_Tcutil_terr(s->loc,((_tmp961="`noreturn' function might return",
_tag_dyneither(_tmp961,sizeof(char),33))),_tag_dyneither(_tmp960,sizeof(void*),0)));}{
union Cyc_CfFlowInfo_FlowInfo _tmp674;void*_tmp675;struct _tuple14 _tmp673=Cyc_NewControlFlow_anal_Rexp(
...
_tuple16 _tmp676=Cyc_NewControlFlow_anal_test(env,inflow,_tmp637);_tmp677=_tmp676.f1;
...
_tmp67C;struct _tuple17 _tmp67B=Cyc_NewControlFlow_pre_stmt_check(env,inflow,
...
_tuple16 _tmp67E=Cyc_NewControlFlow_anal_test(env,_tmp67D,_tmp63C);_tmp67F=
...
_tmp684;struct _tuple17 _tmp683=Cyc_NewControlFlow_pre_stmt_check(env,_tmp682,
...
_tuple16 _tmp686=Cyc_NewControlFlow_anal_test(env,_tmp685,_tmp642);_tmp687=
...
_tmp68B;struct _tuple17 _tmp68A=Cyc_NewControlFlow_pre_stmt_check(env,_tmp689,
...
_tuple16 _tmp68D=Cyc_NewControlFlow_anal_test(env,_tmp68C,_tmp647);_tmp68E=
_tmp68D.f1;_tmp68F=_tmp68D.f2;{union Cyc_CfFlowInfo_FlowInfo _tmp690=Cyc_NewControlFlow_anal_stmt(
env,_tmp68E,_tmp64C);union Cyc_CfFlowInfo_FlowInfo*_tmp692;struct _tuple17 _tmp691=
...
_tmp697;struct Cyc_List_List*_tmp698;struct _tuple20 _tmp696=Cyc_NewControlFlow_anal_unordered_Rexps(
...
_tmp699))->encloser;if(_tmp69B == _tmp699){{const char*_tmp964;void*_tmp963;(
_tmp963=0,Cyc_Tcutil_terr(s->loc,((_tmp964="goto enters local scope or exception handler",
_tag_dyneither(_tmp964,sizeof(char),45))),_tag_dyneither(_tmp963,sizeof(void*),0)));}
...
_tmp69F;void*_tmp6A0;struct _tuple14 _tmp69E=Cyc_NewControlFlow_anal_Rexp(env,1,
...
_LL38C: goto _LL38A;_LL38D:;_LL38E: {const char*_tmp967;void*_tmp966;(_tmp966=0,Cyc_Tcutil_terr(
s->loc,((_tmp967="last catch clause may implicitly fallthru",_tag_dyneither(
_tmp967,sizeof(char),42))),_tag_dyneither(_tmp966,sizeof(void*),0)));}_LL38A:;}
...
_tmp6A7;struct _tuple15 _tmp6A5=Cyc_NewControlFlow_anal_Lexp(env,inflow,1,_tmp664);
_tmp6A6=_tmp6A5.f1;_tmp6A7=_tmp6A5.f2;{struct _tuple15 _tmp968;struct _tuple15
_tmp6A9=(_tmp968.f1=_tmp6A6,((_tmp968.f2=_tmp6A7,_tmp968)));union Cyc_CfFlowInfo_FlowInfo
_tmp6AA;struct _tuple13 _tmp6AB;struct Cyc_Dict_Dict _tmp6AC;struct Cyc_List_List*
...
_tmp6AA.ReachableFL).tag != 2)goto _LL392;_tmp6AB=(struct _tuple13)(_tmp6AA.ReachableFL).val;
...
_tmp6B2);{struct Cyc_List_List _tmp969;struct Cyc_List_List _tmp6B8=(_tmp969.hd=
_tmp666,((_tmp969.tl=0,_tmp969)));_tmp6A6=Cyc_NewControlFlow_add_vars(_tmp62A,
_tmp6A6,(struct Cyc_List_List*)& _tmp6B8,_tmp62A->unknown_all,s->loc);_tmp6A6=Cyc_NewControlFlow_anal_stmt(
env,_tmp6A6,_tmp667);{union Cyc_CfFlowInfo_FlowInfo _tmp6B9=_tmp6A6;struct _tuple13
_tmp6BA;struct Cyc_Dict_Dict _tmp6BB;struct Cyc_List_List*_tmp6BC;_LL3A0: if((
_tmp6B9.ReachableFL).tag != 2)goto _LL3A2;_tmp6BA=(struct _tuple13)(_tmp6B9.ReachableFL).val;
...
_tmp6B0.BottomFL).val;_LL393: return _tmp6A6;_LL394:;_LL395:{const char*_tmp96C;
void*_tmp96B;(_tmp96B=0,Cyc_Tcutil_terr(_tmp664->loc,((_tmp96C="bad alias expression--no unique path found",
_tag_dyneither(_tmp96C,sizeof(char),43))),_tag_dyneither(_tmp96B,sizeof(void*),0)));}
...
void*_tmp6C2;struct _tuple14 _tmp6C0=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,
...
_tmp6C4;if(_tmp6C5->tag != 15)goto _LL3A7;else{_tmp6C6=(void*)_tmp6C5->f1;}}_LL3A6:
return Cyc_CfFlowInfo_kill_flow_region(_tmp62A,_tmp6C1,_tmp6C6);_LL3A7:;_LL3A8: {
struct Cyc_Core_Impossible_struct _tmp972;const char*_tmp971;struct Cyc_Core_Impossible_struct*
_tmp970;(int)_throw((void*)((_tmp970=_cycalloc(sizeof(*_tmp970)),((_tmp970[0]=((
_tmp972.tag=Cyc_Core_Impossible,((_tmp972.f1=((_tmp971="anal_stmt -- reset_region",
_tag_dyneither(_tmp971,sizeof(char),26))),_tmp972)))),_tmp970)))));}_LL3A4:;};}
_LL388:;_LL389: {struct Cyc_Core_Impossible_struct _tmp978;const char*_tmp977;
struct Cyc_Core_Impossible_struct*_tmp976;(int)_throw((void*)((_tmp976=_cycalloc(
sizeof(*_tmp976)),((_tmp976[0]=((_tmp978.tag=Cyc_Core_Impossible,((_tmp978.f1=((
_tmp977="anal_stmt -- bad stmt syntax or unimplemented stmt form",_tag_dyneither(
_tmp977,sizeof(char),56))),_tmp978)))),_tmp976)))));}_LL35F:;};}static void Cyc_NewControlFlow_check_nested_fun(
...
struct Cyc_List_List _tmp979;struct Cyc_List_List _tmp6DF=(_tmp979.hd=_tmp6D0,((
_tmp979.tl=0,_tmp979)));inflow=Cyc_NewControlFlow_add_vars(_tmp6CD,inflow,(
...
_tmp6E2;void*_tmp6E3;struct _tuple14 _tmp6E1=Cyc_NewControlFlow_anal_Rexp(env,1,
inflow,(struct Cyc_Absyn_Exp*)_tmp6E0);_tmp6E2=_tmp6E1.f1;_tmp6E3=_tmp6E1.f2;{
union Cyc_CfFlowInfo_FlowInfo _tmp6E4=_tmp6E2;int _tmp6E5;struct _tuple13 _tmp6E6;
...
_LL3B9: if((_tmp6E4.ReachableFL).tag != 2)goto _LL3B6;_tmp6E6=(struct _tuple13)(
_tmp6E4.ReachableFL).val;_tmp6E7=_tmp6E6.f1;_tmp6E8=_tmp6E6.f2;_LL3BA:{struct Cyc_CfFlowInfo_VarRoot_struct*
_tmp97F;struct Cyc_CfFlowInfo_VarRoot_struct _tmp97E;struct Cyc_CfFlowInfo_Place*
_tmp97D;_tmp6E7=Cyc_CfFlowInfo_assign_place(_tmp6CD,decl->loc,_tmp6E7,env->all_changed,((
_tmp97D=_region_malloc(env->r,sizeof(*_tmp97D)),((_tmp97D->root=(void*)((_tmp97F=
_region_malloc(env->r,sizeof(*_tmp97F)),((_tmp97F[0]=((_tmp97E.tag=0,((_tmp97E.f1=
_tmp6D0,_tmp97E)))),_tmp97F)))),((_tmp97D->fields=0,_tmp97D)))))),_tmp6E3);}
...
_tuple14 _tmp6EE=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp6D5);_tmp6EF=
...
struct Cyc_List_List*_tmp980;return Cyc_NewControlFlow_add_vars(_tmp6CD,inflow,((
_tmp980=_region_malloc(env->r,sizeof(*_tmp980)),((_tmp980->hd=_tmp6F2,((_tmp980->tl=
0,_tmp980)))))),_tmp6CD->unknown_all,decl->loc);};_LL3B2: {struct Cyc_Absyn_Region_d_struct*
...
union Cyc_CfFlowInfo_FlowInfo _tmp6F6;void*_tmp6F7;struct _tuple14 _tmp6F5=Cyc_NewControlFlow_anal_Rexp(
env,1,inflow,_tmp6F4);_tmp6F6=_tmp6F5.f1;_tmp6F7=_tmp6F5.f2;inflow=Cyc_NewControlFlow_use_Rval(
env,_tmp6F4->loc,_tmp6F6,_tmp6F7);}{struct Cyc_List_List _tmp981;struct Cyc_List_List
_tmp6F8=(_tmp981.hd=_tmp6DC,((_tmp981.tl=0,_tmp981)));return Cyc_NewControlFlow_add_vars(
_tmp6CD,inflow,(struct Cyc_List_List*)& _tmp6F8,_tmp6CD->unknown_all,decl->loc);};
_LL3B4:;_LL3B5: {struct Cyc_Core_Impossible_struct _tmp987;const char*_tmp986;
struct Cyc_Core_Impossible_struct*_tmp985;(int)_throw((void*)((_tmp985=_cycalloc(
sizeof(*_tmp985)),((_tmp985[0]=((_tmp987.tag=Cyc_Core_Impossible,((_tmp987.f1=((
_tmp986="anal_decl: unexpected decl variant",_tag_dyneither(_tmp986,sizeof(char),
35))),_tmp987)))),_tmp985)))));}_LL3A9:;}static void Cyc_NewControlFlow_check_fun(
...
_tuple13 _tmp702;struct Cyc_Dict_Dict _tmp703;struct Cyc_List_List*_tmp704;_LL3BC:
if((_tmp700.BottomFL).tag != 1)goto _LL3BE;_tmp701=(int)(_tmp700.BottomFL).val;
_LL3BD: {const char*_tmp98A;void*_tmp989;(_tmp989=0,((int(*)(struct _dyneither_ptr
fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp98A="check_fun",
_tag_dyneither(_tmp98A,sizeof(char),10))),_tag_dyneither(_tmp989,sizeof(void*),0)));}
_LL3BE: if((_tmp700.ReachableFL).tag != 2)goto _LL3BB;_tmp702=(struct _tuple13)(
...
_tmp707;if(_tmp708->tag != 9)goto _LL3C3;else{_tmp709=_tmp708->f1;_tmp70A=_tmp709.attributes;}}
_LL3C2: atts=_tmp70A;goto _LL3C0;_LL3C3:;_LL3C4: {const char*_tmp98D;void*_tmp98C;(
_tmp98C=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp98D="check_fun: non-function type cached with fndecl_t",_tag_dyneither(
_tmp98D,sizeof(char),50))),_tag_dyneither(_tmp98C,sizeof(void*),0)));}_LL3C0:;}
...
struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v)){{const char*_tmp990;
void*_tmp98F;(_tmp98F=0,Cyc_Tcutil_terr(_tmp6FF,((_tmp990="noliveunique attribute exceeds number of parameters",
_tag_dyneither(_tmp990,sizeof(char),52))),_tag_dyneither(_tmp98F,sizeof(void*),0)));}
...
_tmp714->type);if(!Cyc_Tcutil_is_noalias_pointer(t)){{const char*_tmp993;void*
_tmp992;(_tmp992=0,Cyc_Tcutil_terr(_tmp6FF,((_tmp993="noliveunique attribute requires unique pointer type",
_tag_dyneither(_tmp993,sizeof(char),52))),_tag_dyneither(_tmp992,sizeof(void*),0)));}
...
struct Cyc_CfFlowInfo_InitParam_struct _tmp996;struct Cyc_CfFlowInfo_InitParam_struct*
_tmp995;struct Cyc_CfFlowInfo_InitParam_struct*_tmp718=(_tmp995=_region_malloc(
_tmp6FE,sizeof(*_tmp995)),((_tmp995[0]=((_tmp996.tag=2,((_tmp996.f1=(int)j,((
_tmp996.f2=(void*)t,_tmp996)))))),_tmp995)));struct Cyc_CfFlowInfo_Place*_tmp997;
struct Cyc_CfFlowInfo_Place*_tmp719=(_tmp997=_region_malloc(_tmp6FE,sizeof(*
_tmp997)),((_tmp997->root=(void*)_tmp718,((_tmp997->fields=0,_tmp997)))));
_tmp703=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(
_tmp703,(void*)_tmp718,_tmp717);{struct Cyc_CfFlowInfo_AddressOf_struct _tmp99D;
struct Cyc_CfFlowInfo_AddressOf_struct*_tmp99C;struct Cyc_CfFlowInfo_VarRoot_struct
_tmp99A;struct Cyc_CfFlowInfo_VarRoot_struct*_tmp999;_tmp703=((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp703,(void*)((_tmp999=
_region_malloc(_tmp6FE,sizeof(*_tmp999)),((_tmp999[0]=((_tmp99A.tag=0,((_tmp99A.f1=
_tmp714,_tmp99A)))),_tmp999)))),(void*)((_tmp99C=_region_malloc(_tmp6FE,sizeof(*
_tmp99C)),((_tmp99C[0]=((_tmp99D.tag=5,((_tmp99D.f1=_tmp719,_tmp99D)))),_tmp99C)))));}
...
_check_null(fd->param_vardecls))->v)){{const char*_tmp9A0;void*_tmp99F;(_tmp99F=0,
Cyc_Tcutil_terr(_tmp6FF,((_tmp9A0="initializes attribute exceeds number of parameters",
_tag_dyneither(_tmp9A0,sizeof(char),51))),_tag_dyneither(_tmp99F,sizeof(void*),0)));}
...
const char*_tmp9A3;void*_tmp9A2;(_tmp9A2=0,Cyc_Tcutil_terr(_tmp6FF,((_tmp9A3="initializes attribute not allowed on nullable pointers",
_tag_dyneither(_tmp9A3,sizeof(char),55))),_tag_dyneither(_tmp9A2,sizeof(void*),0)));}
if(!Cyc_Tcutil_is_bound_one(_tmp72A)){const char*_tmp9A6;void*_tmp9A5;(_tmp9A5=0,
Cyc_Tcutil_terr(_tmp6FF,((_tmp9A6="initializes attribute allowed only on pointers of size 1",
_tag_dyneither(_tmp9A6,sizeof(char),57))),_tag_dyneither(_tmp9A5,sizeof(void*),0)));}
if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp72B)){
const char*_tmp9A9;void*_tmp9A8;(_tmp9A8=0,Cyc_Tcutil_terr(_tmp6FF,((_tmp9A9="initializes attribute allowed only on pointers to non-zero-terminated arrays",
_tag_dyneither(_tmp9A9,sizeof(char),77))),_tag_dyneither(_tmp9A8,sizeof(void*),0)));}{
struct Cyc_CfFlowInfo_InitParam_struct _tmp9AC;struct Cyc_CfFlowInfo_InitParam_struct*
_tmp9AB;struct Cyc_CfFlowInfo_InitParam_struct*_tmp732=(_tmp9AB=_region_malloc(
_tmp6FE,sizeof(*_tmp9AB)),((_tmp9AB[0]=((_tmp9AC.tag=2,((_tmp9AC.f1=(int)j,((
_tmp9AC.f2=(void*)_tmp727,_tmp9AC)))))),_tmp9AB)));struct Cyc_CfFlowInfo_Place*
_tmp9AD;struct Cyc_CfFlowInfo_Place*_tmp733=(_tmp9AD=_region_malloc(_tmp6FE,
sizeof(*_tmp9AD)),((_tmp9AD->root=(void*)_tmp732,((_tmp9AD->fields=0,_tmp9AD)))));
_tmp703=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(
_tmp703,(void*)_tmp732,Cyc_CfFlowInfo_typ_to_absrval(fenv,_tmp727,0,fenv->esc_none));{
struct Cyc_CfFlowInfo_AddressOf_struct _tmp9B3;struct Cyc_CfFlowInfo_AddressOf_struct*
_tmp9B2;struct Cyc_CfFlowInfo_VarRoot_struct _tmp9B0;struct Cyc_CfFlowInfo_VarRoot_struct*
_tmp9AF;_tmp703=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(
_tmp703,(void*)((_tmp9AF=_region_malloc(_tmp6FE,sizeof(*_tmp9AF)),((_tmp9AF[0]=((
_tmp9B0.tag=0,((_tmp9B0.f1=_tmp723,_tmp9B0)))),_tmp9AF)))),(void*)((_tmp9B2=
_region_malloc(_tmp6FE,sizeof(*_tmp9B2)),((_tmp9B2[0]=((_tmp9B3.tag=5,((_tmp9B3.f1=
_tmp733,_tmp9B3)))),_tmp9B2)))));}{struct Cyc_List_List*_tmp9B4;param_roots=((
_tmp9B4=_region_malloc(_tmp6FE,sizeof(*_tmp9B4)),((_tmp9B4->hd=_tmp733,((_tmp9B4->tl=
param_roots,_tmp9B4))))));}goto _LL3CC;};_LL3CF:;_LL3D0: {const char*_tmp9B7;void*
_tmp9B6;(_tmp9B6=0,Cyc_Tcutil_terr(_tmp6FF,((_tmp9B7="initializes attribute on non-pointer",
_tag_dyneither(_tmp9B7,sizeof(char),37))),_tag_dyneither(_tmp9B6,sizeof(void*),0)));}
...
s))Cyc_NewControlFlow_hash_ptr);struct Cyc_NewControlFlow_AnalEnv*_tmp9B8;struct
Cyc_NewControlFlow_AnalEnv*env=(_tmp9B8=_region_malloc(_tmp6FE,sizeof(*_tmp9B8)),((
_tmp9B8->r=_tmp6FE,((_tmp9B8->fenv=fenv,((_tmp9B8->iterate_again=1,((_tmp9B8->iteration_num=
0,((_tmp9B8->in_try=0,((_tmp9B8->tryflow=inflow,((_tmp9B8->all_changed=0,((
_tmp9B8->noreturn=noreturn,((_tmp9B8->param_roots=param_roots,((_tmp9B8->flow_table=
flow_table,_tmp9B8)))))))))))))))))))));union Cyc_CfFlowInfo_FlowInfo outflow=
...
const char*_tmp9BB;void*_tmp9BA;(_tmp9BA=0,Cyc_Tcutil_terr(_tmp6FF,((_tmp9BB="`noreturn' function might (implicitly) return",
_tag_dyneither(_tmp9BB,sizeof(char),46))),_tag_dyneither(_tmp9BA,sizeof(void*),0)));}
...
_LL3D8: goto _LL3D6;_LL3D9: {struct Cyc_Absyn_FloatType_struct*_tmp744=(struct Cyc_Absyn_FloatType_struct*)
_tmp742;if(_tmp744->tag != 7)goto _LL3DB;}_LL3DA: goto _LL3DC;_LL3DB: {struct Cyc_Absyn_IntType_struct*
_tmp745=(struct Cyc_Absyn_IntType_struct*)_tmp742;if(_tmp745->tag != 6)goto _LL3DD;}
_LL3DC:{const char*_tmp9BE;void*_tmp9BD;(_tmp9BD=0,Cyc_Tcutil_warn(_tmp6FF,((
_tmp9BE="function may not return a value",_tag_dyneither(_tmp9BE,sizeof(char),32))),
_tag_dyneither(_tmp9BD,sizeof(void*),0)));}goto _LL3D6;_LL3DD:;_LL3DE:{const char*
_tmp9C1;void*_tmp9C0;(_tmp9C0=0,Cyc_Tcutil_terr(_tmp6FF,((_tmp9C1="function may not return a value",
_tag_dyneither(_tmp9C1,sizeof(char),32))),_tag_dyneither(_tmp9C0,sizeof(void*),0)));}
goto _LL3D6;_LL3D6:;}goto _LL3D1;_LL3D1:;};};};}void Cyc_NewControlFlow_cf_check(
struct Cyc_List_List*ds){for(0;ds != 0;ds=ds->tl){void*_tmp74B=((struct Cyc_Absyn_Decl*)
ds->hd)->r;struct Cyc_Absyn_Fndecl*_tmp74D;struct Cyc_List_List*_tmp74F;struct Cyc_List_List*
_tmp751;struct Cyc_List_List*_tmp753;_LL3E0: {struct Cyc_Absyn_Fn_d_struct*_tmp74C=(
struct Cyc_Absyn_Fn_d_struct*)_tmp74B;if(_tmp74C->tag != 1)goto _LL3E2;else{_tmp74D=
_tmp74C->f1;}}_LL3E1: Cyc_NewControlFlow_check_fun(_tmp74D);goto _LL3DF;_LL3E2: {
struct Cyc_Absyn_ExternC_d_struct*_tmp74E=(struct Cyc_Absyn_ExternC_d_struct*)
_tmp74B;if(_tmp74E->tag != 12)goto _LL3E4;else{_tmp74F=_tmp74E->f1;}}_LL3E3:
_tmp751=_tmp74F;goto _LL3E5;_LL3E4: {struct Cyc_Absyn_Using_d_struct*_tmp750=(
struct Cyc_Absyn_Using_d_struct*)_tmp74B;if(_tmp750->tag != 11)goto _LL3E6;else{
_tmp751=_tmp750->f2;}}_LL3E5: _tmp753=_tmp751;goto _LL3E7;_LL3E6: {struct Cyc_Absyn_Namespace_d_struct*
_tmp752=(struct Cyc_Absyn_Namespace_d_struct*)_tmp74B;if(_tmp752->tag != 10)goto
_LL3E8;else{_tmp753=_tmp752->f2;}}_LL3E7: Cyc_NewControlFlow_cf_check(_tmp753);
goto _LL3DF;_LL3E8: {struct Cyc_Absyn_ExternCinclude_d_struct*_tmp754=(struct Cyc_Absyn_ExternCinclude_d_struct*)
_tmp74B;if(_tmp754->tag != 13)goto _LL3EA;}_LL3E9: goto _LL3DF;_LL3EA:;_LL3EB: goto
_LL3DF;_LL3DF:;}}
