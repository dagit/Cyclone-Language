...
# 100
extern struct Cyc_List_List*Cyc_Relations_reln_assign_var(struct _RegionHandle*,struct Cyc_List_List*,struct Cyc_Absyn_Vardecl*,struct Cyc_Absyn_Exp*);
# 103
extern struct Cyc_List_List*Cyc_Relations_reln_assign_exp(struct _RegionHandle*,struct Cyc_List_List*,struct Cyc_Absyn_Exp*,struct Cyc_Absyn_Exp*);
# 108
extern struct Cyc_List_List*Cyc_Relations_reln_kill_exp(struct _RegionHandle*,struct Cyc_List_List*,struct Cyc_Absyn_Exp*);
# 112
extern int Cyc_Relations_same_relns(struct Cyc_List_List*,struct Cyc_List_List*);
# 118
extern void Cyc_Relations_print_relns(struct Cyc___cycFILE*,struct Cyc_List_List*);
# 121
extern struct _fat_ptr Cyc_Relations_rop2string(union Cyc_Relations_RelnOp r);
extern struct _fat_ptr Cyc_Relations_relation2string(enum Cyc_Relations_Relation r);
extern struct _fat_ptr Cyc_Relations_relns2string(struct Cyc_List_List*r);
# 129
...
# 115 "tcpat.h"
extern int Cyc_Tcpat_has_vars(struct Cyc_Core_Opt*pat_vars);
# 29 "warn.h"
...
{void*_tmp1C5=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*_stmttmp2D=_tmp1C5;void*_tmp1C6=_stmttmp2D;void*_tmp1C7;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1C6)->tag == 3U){_LLBD: _tmp1C7=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1C6)->f1).elt_type;_LLBE: {void*t=_tmp1C7;
# 1184
...
# 1463
void*_tmp25E=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*_stmttmp42=_tmp25E;void*_tmp25F=_stmttmp42;void*_tmp260;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp25F)->tag == 3U){_LL148: _tmp260=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp25F)->f1).elt_type;_LL149: {void*t2=_tmp260;
# 1465
...
goto _LL166;}}}else{_LL169: _LL16A:
 goto _LL166;}_LL166:;}{
# 1522
void*_tmp292=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*_stmttmp4A=_tmp292;void*_tmp293=_stmttmp4A;struct Cyc_List_List*_tmp294;switch(*((int*)_tmp293)){case 6U: _LL16C: _tmp294=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp293)->f1;_LL16D: {struct Cyc_List_List*tqts=_tmp294;
# 1524
...
{void*_tmp2AC=Cyc_Tcutil_compress((void*)_check_null(e->topt));void*_stmttmp4E=_tmp2AC;void*_tmp2AD=_stmttmp4E;struct Cyc_List_List*_tmp2AE;if(((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp2AD)->tag == 7U){_LL186: _tmp2AE=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp2AD)->f2;_LL187: {struct Cyc_List_List*f=_tmp2AE;
