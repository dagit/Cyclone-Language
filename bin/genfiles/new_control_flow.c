...
goto _LL0;}_LL0:;}{
# 652
void*bnd=Cyc_Tcutil_get_pointer_bounds(_check_null(e1->topt));
...
{void*_Tmp3=Cyc_Absyn_compress(_check_null(fd->cached_type));void*_Tmp4;if(*((int*)_Tmp3)==6){_Tmp4=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp3)->f1.attributes;{struct Cyc_List_List*as=_Tmp4;
