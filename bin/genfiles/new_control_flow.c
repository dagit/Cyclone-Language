...
({void*_tmp645=(void*)({struct Cyc_NewControlFlow_CFAnnot_Absyn_AbsynAnnot_struct*_tmp2=_cycalloc(sizeof(*_tmp2));_tmp2->tag=Cyc_NewControlFlow_CFAnnot,(_tmp2->f1).visited=0;_tmp2;});s->annot=_tmp645;});return Cyc_NewControlFlow_get_stmt_annot(s);}_LL0:;}
# 142
...
if(sflow == 0){
union Cyc_CfFlowInfo_FlowInfo*res=({union Cyc_CfFlowInfo_FlowInfo*_tmp4=_cycalloc(sizeof(*_tmp4));({union Cyc_CfFlowInfo_FlowInfo _tmp646=Cyc_CfFlowInfo_BottomFL();*_tmp4=_tmp646;});_tmp4;});
...
# 163
({union Cyc_CfFlowInfo_FlowInfo _tmp647=Cyc_CfFlowInfo_join_flow(env->fenv,inflow,*_tmp8);*_tmp8=_tmp647;});
# 169
...
if(env->in_try)
# 187
({union Cyc_CfFlowInfo_FlowInfo _tmp648=Cyc_CfFlowInfo_join_flow(env->fenv,new_flow,env->tryflow);env->tryflow=_tmp648;});}struct _tuple21{struct Cyc_NewControlFlow_AnalEnv*f1;unsigned int f2;struct Cyc_Dict_Dict f3;};
# 194
...
# 208
({struct Cyc_String_pa_PrintArg_struct _tmpE=({struct Cyc_String_pa_PrintArg_struct _tmp5A4;_tmp5A4.tag=0U,({struct _dyneither_ptr _tmp649=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp10->name));_tmp5A4.f1=_tmp649;});_tmp5A4;});void*_tmpC[1U];_tmpC[0]=& _tmpE;({unsigned int _tmp64B=_tmp12;struct _dyneither_ptr _tmp64A=({const char*_tmpD="alias-free pointer(s) reachable from %s may become unreachable.";_tag_dyneither(_tmpD,sizeof(char),64U);});Cyc_Warn_warn(_tmp64B,_tmp64A,_tag_dyneither(_tmpC,sizeof(void*),1U));});});
goto _LL8;}_LL8:;}}
# 212
...
{struct Cyc_Absyn_Exp*_tmp2F=({struct _RegionHandle*_tmp64D=temp;struct Cyc_List_List*_tmp64C=((struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rzip)(temp,temp,_tmp2B->tvs,_tmp43);Cyc_Tcutil_rsubsexp(_tmp64D,_tmp64C,_tmp2D);});
# 309
if(!({struct Cyc_List_List*_tmp64E=_tmp46;Cyc_NewControlFlow_relns_ok(_tmp64E,Cyc_Relations_exp2relns(temp,_tmp2F));})){
({struct Cyc_String_pa_PrintArg_struct _tmp32=({struct Cyc_String_pa_PrintArg_struct _tmp5A8;_tmp5A8.tag=0U,({struct _dyneither_ptr _tmp64F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(Cyc_NewControlFlow_strip_cast(_tmp2F)));_tmp5A8.f1=_tmp64F;});_tmp5A8;});struct Cyc_String_pa_PrintArg_struct _tmp33=({struct Cyc_String_pa_PrintArg_struct _tmp5A7;_tmp5A7.tag=0U,_tmp5A7.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp5A7;});void*_tmp30[2U];_tmp30[0]=& _tmp32,_tmp30[1]=& _tmp33;({unsigned int _tmp651=loc;struct _dyneither_ptr _tmp650=({const char*_tmp31="unable to prove %s, required to access %s";_tag_dyneither(_tmp31,sizeof(char),42U);});Cyc_CfFlowInfo_aerr(_tmp651,_tmp650,_tag_dyneither(_tmp30,sizeof(void*),2U));});});
({void*_tmp34=0U;({struct Cyc___cycFILE*_tmp653=Cyc_stderr;struct _dyneither_ptr _tmp652=({const char*_tmp35="  [recorded facts on path: ";_tag_dyneither(_tmp35,sizeof(char),28U);});Cyc_fprintf(_tmp653,_tmp652,_tag_dyneither(_tmp34,sizeof(void*),0U));});});
Cyc_Relations_print_relns(Cyc_stderr,_tmp46);
({void*_tmp36=0U;({struct Cyc___cycFILE*_tmp655=Cyc_stderr;struct _dyneither_ptr _tmp654=({const char*_tmp37="]\n";_tag_dyneither(_tmp37,sizeof(char),3U);});Cyc_fprintf(_tmp655,_tmp654,_tag_dyneither(_tmp36,sizeof(void*),0U));});});}}
# 307
;_pop_region(temp);}
# 316
...
if(!({struct Cyc_List_List*_tmp656=_tmp46;Cyc_NewControlFlow_relns_ok(_tmp656,Cyc_Relations_exp2relns(temp,_tmp39));})){
({struct Cyc_String_pa_PrintArg_struct _tmp3D=({struct Cyc_String_pa_PrintArg_struct _tmp5AA;_tmp5AA.tag=0U,({struct _dyneither_ptr _tmp657=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(Cyc_NewControlFlow_strip_cast(_tmp39)));_tmp5AA.f1=_tmp657;});_tmp5AA;});struct Cyc_String_pa_PrintArg_struct _tmp3E=({struct Cyc_String_pa_PrintArg_struct _tmp5A9;_tmp5A9.tag=0U,_tmp5A9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp5A9;});void*_tmp3B[2U];_tmp3B[0]=& _tmp3D,_tmp3B[1]=& _tmp3E;({unsigned int _tmp659=loc;struct _dyneither_ptr _tmp658=({const char*_tmp3C="unable to prove %s, required to access %s";_tag_dyneither(_tmp3C,sizeof(char),42U);});Cyc_CfFlowInfo_aerr(_tmp659,_tmp658,_tag_dyneither(_tmp3B,sizeof(void*),2U));});});
({void*_tmp3F=0U;({struct Cyc___cycFILE*_tmp65B=Cyc_stderr;struct _dyneither_ptr _tmp65A=({const char*_tmp40="  [recorded facts on path: ";_tag_dyneither(_tmp40,sizeof(char),28U);});Cyc_fprintf(_tmp65B,_tmp65A,_tag_dyneither(_tmp3F,sizeof(void*),0U));});});
Cyc_Relations_print_relns(Cyc_stderr,_tmp46);
({void*_tmp41=0U;({struct Cyc___cycFILE*_tmp65D=Cyc_stderr;struct _dyneither_ptr _tmp65C=({const char*_tmp42="]\n";_tag_dyneither(_tmp42,sizeof(char),3U);});Cyc_fprintf(_tmp65D,_tmp65C,_tag_dyneither(_tmp41,sizeof(void*),0U));});});}
# 322
;_pop_region(temp);}
# 329
...
({void*_tmp48=0U;({unsigned int _tmp65F=loc;struct _dyneither_ptr _tmp65E=({const char*_tmp49="expression may not be fully initialized";_tag_dyneither(_tmp49,sizeof(char),40U);});Cyc_CfFlowInfo_aerr(_tmp65F,_tmp65E,_tag_dyneither(_tmp48,sizeof(void*),0U));});});{
...
struct _tuple0 _tmp4E=({struct _tuple0 _tmp5AB;({void*_tmp660=Cyc_Tcutil_compress(t);_tmp5AB.f1=_tmp660;}),_tmp5AB.f2=r;_tmp5AB;});struct _tuple0 _tmp4F=_tmp4E;enum Cyc_Absyn_AggrKind _tmp60;struct Cyc_List_List*_tmp5F;struct _dyneither_ptr _tmp5E;struct Cyc_List_List*_tmp5D;struct _dyneither_ptr _tmp5C;union Cyc_Absyn_AggrInfo _tmp5B;struct Cyc_List_List*_tmp5A;struct _dyneither_ptr _tmp59;struct Cyc_Absyn_Datatypefield*_tmp58;struct _dyneither_ptr _tmp57;void*_tmp56;switch(*((int*)_tmp4F.f2)){case 2U: if(((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp4F.f2)->f1 == Cyc_CfFlowInfo_NoneIL){_LL1: _LL2:
...
({struct Cyc_NewControlFlow_AnalEnv*_tmp663=env;unsigned int _tmp662=loc;void*_tmp661=(*((struct _tuple22*)((struct Cyc_List_List*)_check_null(_tmp5D))->hd)).f2;Cyc_NewControlFlow_check_nounique(_tmp663,_tmp662,_tmp661,*((void**)_check_dyneither_subscript(_tmp5C,sizeof(void*),i)));});}}
# 365
...
({struct Cyc_NewControlFlow_AnalEnv*_tmp666=env;unsigned int _tmp665=loc;void*_tmp664=((struct Cyc_Absyn_Aggrfield*)((struct Cyc_List_List*)_check_null(_tmp5F))->hd)->type;Cyc_NewControlFlow_check_nounique(_tmp666,_tmp665,_tmp664,*((void**)_check_dyneither_subscript(_tmp5E,sizeof(void*),i)));});}}
return;}else{goto _LL13;}case 3U: _LL11: _LL12:
# 385
 if(Cyc_Tcutil_is_noalias_pointer(t,0))
({void*_tmp54=0U;({unsigned int _tmp668=loc;struct _dyneither_ptr _tmp667=({const char*_tmp55="argument may still contain alias-free pointers";_tag_dyneither(_tmp55,sizeof(char),47U);});Cyc_Warn_warn(_tmp668,_tmp667,_tag_dyneither(_tmp54,sizeof(void*),0U));});});
...
# 396
 if(!Cyc_Tcutil_is_noalias_pointer(t,0))
({void*_tmp62=0U;({struct _dyneither_ptr _tmp669=({const char*_tmp63="noliveunique attribute requires alias-free pointer";_tag_dyneither(_tmp63,sizeof(char),51U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp669,_tag_dyneither(_tmp62,sizeof(void*),0U));});});{
...
({void*_tmp66=0U;({unsigned int _tmp66B=loc;struct _dyneither_ptr _tmp66A=({const char*_tmp67="argument may contain live alias-free pointers";_tag_dyneither(_tmp67,sizeof(char),46U);});Cyc_Warn_warn(_tmp66B,_tmp66A,_tag_dyneither(_tmp66,sizeof(void*),0U));});});
...
return({struct _tuple23 _tmp5AD;_tmp5AD.f1=inflow,({struct Cyc_List_List*_tmp66C=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(rvals);_tmp5AD.f2=_tmp66C;});_tmp5AD;});}
# 440
...
({void*_tmp77=0U;({unsigned int _tmp66E=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd)->loc;struct _dyneither_ptr _tmp66D=({const char*_tmp78="expression may not be initialized";_tag_dyneither(_tmp78,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp66E,_tmp66D,_tag_dyneither(_tmp77,sizeof(void*),0U));});});}
goto _LL3;}else{_LL6: _LL7:
 goto _LL3;}_LL3:;}
# 452
...
({void*_tmp7D=0U;({struct _dyneither_ptr _tmp66F=({const char*_tmp7E="consume_zero_rval";_tag_dyneither(_tmp7E,sizeof(char),18U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp66F,_tag_dyneither(_tmp7D,sizeof(void*),0U));});});else{
# 471
if(needs_unconsume)
...
union Cyc_CfFlowInfo_FlowInfo _tmp83=({struct Cyc_Dict_Dict _tmp670=Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmp86,_tmp84,nzval);Cyc_CfFlowInfo_ReachableFL(_tmp670,_tmp85);});
# 513
...
union Cyc_CfFlowInfo_FlowInfo _tmp674=({struct Cyc_Dict_Dict _tmp673=Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmp8E,_tmp8C,nzval);Cyc_CfFlowInfo_ReachableFL(_tmp673,_tmp8D);});_tmp5B1.f1=_tmp674;}),({
union Cyc_CfFlowInfo_FlowInfo _tmp672=({struct Cyc_Dict_Dict _tmp671=Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmp8E,_tmp8C,zval);Cyc_CfFlowInfo_ReachableFL(_tmp671,_tmp8D);});_tmp5B1.f2=_tmp672;});_tmp5B1;});}}_LL5:;}}_LL0:;}
# 545
...
# 562
if(possibly_null)
({void*_tmp675=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp95=_cycalloc(sizeof(*_tmp95));_tmp95->tag=Cyc_CfFlowInfo_UnknownZ,_tmp95->f1=relns;_tmp95;});e->annot=_tmp675;});else{
# 566
({void*_tmp676=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp96=_cycalloc(sizeof(*_tmp96));_tmp96->tag=Cyc_CfFlowInfo_NotZero,_tmp96->f1=relns;_tmp96;});e->annot=_tmp676;});}
# 568
...
# 597
 return({struct _tuple16 _tmp5B2;_tmp5B2.f1=f,({void*_tmp677=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpBF,0,(env->fenv)->unknown_all);_tmp5B2.f2=_tmp677;});_tmp5B2;});}else{_LL8: _tmpBB=((_tmp9C.ReachableFL).val).f1;_tmpBA=((_tmp9C.ReachableFL).val).f2;_LL9:
# 600
...
# 604
({void*_tmpA0=0U;({struct _dyneither_ptr _tmp678=({const char*_tmpA1="named location in anal_derefR";_tag_dyneither(_tmpA1,sizeof(char),30U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp678,_tag_dyneither(_tmpA0,sizeof(void*),0U));});});case 1U: _LL10: _LL11:
# 606
...
# 609
 Cyc_NewControlFlow_update_relns(e,0,_tmpBA);
return({struct _tuple16 _tmp5B3;_tmp5B3.f1=f,({void*_tmp679=Cyc_CfFlowInfo_lookup_place(_tmpBB,_tmpA7);_tmp5B3.f2=_tmp679;});_tmp5B3;});case 5U: _LL14: _tmpA8=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp9F)->f1;_LL15:
# 612
...
return({struct _tuple16 _tmp5B5;({union Cyc_CfFlowInfo_FlowInfo _tmp67B=Cyc_CfFlowInfo_BottomFL();_tmp5B5.f1=_tmp67B;}),({void*_tmp67A=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpBF,0,(env->fenv)->unknown_all);_tmp5B5.f2=_tmp67A;});_tmp5B5;});case 2U: _LL18: _tmpA9=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp9F)->f1;_LL19:
# 619
...
# 624
({void*_tmp67C=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmpA4=_cycalloc(sizeof(*_tmpA4));_tmpA4->tag=Cyc_CfFlowInfo_UnknownZ,_tmpA4->f1=_tmpBA;_tmpA4;});e->annot=_tmp67C;});
...
# 638
({void*_tmp67D=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmpAE=_cycalloc(sizeof(*_tmpAE));_tmpAE->tag=Cyc_CfFlowInfo_UnknownZ,_tmpAE->f1=_tmpBA;_tmpAE;});e->annot=_tmp67D;});
goto _LL21;}_LL21:;}{
# 642
...
# 647
({void*_tmpB5=0U;({unsigned int _tmp67F=e->loc;struct _dyneither_ptr _tmp67E=({const char*_tmpB6="attempt to dereference a consumed alias-free pointer";_tag_dyneither(_tmpB6,sizeof(char),53U);});Cyc_CfFlowInfo_aerr(_tmp67F,_tmp67E,_tag_dyneither(_tmpB5,sizeof(void*),0U));});});
goto _LL2E;}else{_LL31: _LL32:
# 650
({void*_tmpB7=0U;({unsigned int _tmp681=e->loc;struct _dyneither_ptr _tmp680=({const char*_tmpB8="dereference of possibly uninitialized pointer";_tag_dyneither(_tmpB8,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp681,_tmp680,_tag_dyneither(_tmpB7,sizeof(void*),0U));});});}_LL2E:;}
# 652
goto _LL2A;}}else{_LL29: _LL2A:
# 654
 return({struct _tuple16 _tmp5B6;_tmp5B6.f1=f,({void*_tmp682=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpBF,0,(env->fenv)->unknown_all);_tmp5B6.f2=_tmp682;});_tmp5B6;});}_LL26:;};}_LL5:;}}else{_LL3: _LL4:
# 657
({void*_tmpBC=0U;({struct _dyneither_ptr _tmp683=({const char*_tmpBD="right deref of non-pointer-type";_tag_dyneither(_tmpBD,sizeof(char),32U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp683,_tag_dyneither(_tmpBC,sizeof(void*),0U));});});}_LL0:;}
# 664
...
# 719
({struct Cyc_String_pa_PrintArg_struct _tmpD0=({struct Cyc_String_pa_PrintArg_struct _tmp5B7;_tmp5B7.tag=0U,({struct _dyneither_ptr _tmp684=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(exp));_tmp5B7.f1=_tmp684;});_tmp5B7;});void*_tmpCE[1U];_tmpCE[0]=& _tmpD0;({struct _dyneither_ptr _tmp685=({const char*_tmpCF="noconsume parameter %s must be l-values";_tag_dyneither(_tmpCF,sizeof(char),40U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp685,_tag_dyneither(_tmpCE,sizeof(void*),1U));});});
goto _LL3;}}else{_LL6: _LL7:
# 717
 goto _LL3;}_LL3:;}
# 722
...
# 736
 return({struct _tuple16 _tmp5B9;({union Cyc_CfFlowInfo_FlowInfo _tmp686=Cyc_CfFlowInfo_BottomFL();_tmp5B9.f1=_tmp686;}),_tmp5B9.f2=rval;_tmp5B9;});}else{_LL3: _tmpE0=((_tmpD5.ReachableFL).val).f1;_tmpDF=((_tmpD5.ReachableFL).val).f2;_LL4: {
# 738
...
# 769
 return({struct _tuple16 _tmp5BB;({union Cyc_CfFlowInfo_FlowInfo _tmp689=Cyc_NewControlFlow_use_Rval(env,rexp->loc,outflow,rval);_tmp5BB.f1=_tmp689;}),_tmp5BB.f2=rval;_tmp5BB;});}_LL5:;}}_LL0:;}
# 776
...
# 787
 _tmpE6=({struct Cyc_CfFlowInfo_FlowEnv*_tmp68E=fenv;unsigned int _tmp68D=loc;struct Cyc_Dict_Dict _tmp68C=_tmpE6;struct Cyc_CfFlowInfo_Place*_tmp68B=({struct Cyc_CfFlowInfo_Place*_tmpE3=_cycalloc(sizeof(*_tmpE3));
...
# 787
Cyc_CfFlowInfo_assign_place(_tmp68E,_tmp68D,_tmp68C,_tmp68B,rval);});
# 790
...
struct _dyneither_ptr _tmp68F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmp106));_tmp5BC.f1=_tmp68F;});_tmp5BC;});void*_tmpF0[1U];_tmpF0[0]=& _tmpF2;({struct _dyneither_ptr _tmp690=({const char*_tmpF1="oops! pattern init expr %s has no type!\n";_tag_dyneither(_tmpF1,sizeof(char),41U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp690,_tag_dyneither(_tmpF0,sizeof(void*),1U));});});{
# 843
...
struct _dyneither_ptr _tmp691=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmp106));_tmp5BD.f1=_tmp691;});_tmp5BD;});void*_tmpFD[1U];_tmpFD[0]=& _tmpFF;({unsigned int _tmp693=exp_loc;struct _dyneither_ptr _tmp692=({const char*_tmpFE="aliased pattern expression not an l-value: %s";_tag_dyneither(_tmpFE,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp693,_tmp692,_tag_dyneither(_tmpFD,sizeof(void*),1U));});});}_LL11:;}
# 872
...
return({struct Cyc_Absyn_Exp*_tmp694=Cyc_Absyn_prim1_exp(Cyc_Absyn_Numelts,_tmp114,0U);Cyc_Relations_exp2relnop(_tmp694,rop);});}default: _LL5: _LL6:
 return 1;}_LL0:;}
# 917
...
struct _dyneither_ptr _tmp695=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Relations_relns2string(_tmp123));_tmp5BF.f1=_tmp695;});_tmp5BF;});void*_tmp11D[4U];_tmp11D[0]=& _tmp11F,_tmp11D[1]=& _tmp120,_tmp11D[2]=& _tmp121,_tmp11D[3]=& _tmp122;({unsigned int _tmp697=loc;struct _dyneither_ptr _tmp696=({const char*_tmp11E="cannot prove that @requires clause %s %s %s is satisfied\n (all I know is %s)";_tag_dyneither(_tmp11E,sizeof(char),77U);});Cyc_CfFlowInfo_aerr(_tmp697,_tmp696,_tag_dyneither(_tmp11D,sizeof(void*),4U));});});
break;}}
# 948
...
{union Cyc_CfFlowInfo_FlowInfo _tmp126=inflow;struct Cyc_Dict_Dict _tmp128;struct Cyc_List_List*_tmp127;if((_tmp126.BottomFL).tag == 1){_LL1: _LL2:
 return({struct _tuple16 _tmp5C3;({union Cyc_CfFlowInfo_FlowInfo _tmp698=Cyc_CfFlowInfo_BottomFL();_tmp5C3.f1=_tmp698;}),_tmp5C3.f2=_tmp125->unknown_all;_tmp5C3;});}else{_LL3: _tmp128=((_tmp126.ReachableFL).val).f1;_tmp127=((_tmp126.ReachableFL).val).f2;_LL4:
...
({void*_tmp12E=0U;({unsigned int _tmp69A=e->loc;struct _dyneither_ptr _tmp699=({const char*_tmp12F="expression attempts to copy a consumed alias-free value";_tag_dyneither(_tmp12F,sizeof(char),56U);});Cyc_CfFlowInfo_aerr(_tmp69A,_tmp699,_tag_dyneither(_tmp12E,sizeof(void*),0U));});});
return({struct _tuple16 _tmp5C4;({union Cyc_CfFlowInfo_FlowInfo _tmp69B=Cyc_CfFlowInfo_BottomFL();_tmp5C4.f1=_tmp69B;}),_tmp5C4.f2=_tmp125->unknown_all;_tmp5C4;});}else{
# 1015
if(needs_unconsume)
# 1017
return({struct _tuple16 _tmp5C5;_tmp5C5.f1=_tmp136,({void*_tmp69C=Cyc_CfFlowInfo_make_unique_unconsumed(_tmp125,_tmp12D);_tmp5C5.f2=_tmp69C;});_tmp5C5;});else{
# 1020
...
# 1032
return({struct _tuple16 _tmp5C6;({union Cyc_CfFlowInfo_FlowInfo _tmp69D=Cyc_CfFlowInfo_ReachableFL(_tmp131,_tmp133);_tmp5C6.f1=_tmp69D;}),_tmp5C6.f2=_tmp12D;_tmp5C6;});}}}}else{goto _LLB;}}else{_LLB: _LLC:
# 1036
 goto _LL8;}_LL8:;};}{
# 1039
...
# 1055
 if(!({struct _dyneither_ptr _tmp69E=(struct _dyneither_ptr)_tmp2C1;Cyc_NewControlFlow_strcmp(_tmp69E,({const char*_tmp141="print_flow";_tag_dyneither(_tmp141,sizeof(char),11U);}));})){
struct _dyneither_ptr _tmp142=Cyc_Position_string_of_segment(e->loc);
({struct Cyc_String_pa_PrintArg_struct _tmp145=({struct Cyc_String_pa_PrintArg_struct _tmp5C9;_tmp5C9.tag=0U,_tmp5C9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp142);_tmp5C9;});void*_tmp143[1U];_tmp143[0]=& _tmp145;({struct Cyc___cycFILE*_tmp6A0=Cyc_stderr;struct _dyneither_ptr _tmp69F=({const char*_tmp144="%s: current flow is\n";_tag_dyneither(_tmp144,sizeof(char),21U);});Cyc_fprintf(_tmp6A0,_tmp69F,_tag_dyneither(_tmp143,sizeof(void*),1U));});});
Cyc_CfFlowInfo_print_flow(inflow);
({void*_tmp146=0U;({struct Cyc___cycFILE*_tmp6A2=Cyc_stderr;struct _dyneither_ptr _tmp6A1=({const char*_tmp147="\n";_tag_dyneither(_tmp147,sizeof(char),2U);});Cyc_fprintf(_tmp6A2,_tmp6A1,_tag_dyneither(_tmp146,sizeof(void*),0U));});});}else{
# 1061
if(!({struct _dyneither_ptr _tmp6A3=(struct _dyneither_ptr)_tmp2C1;Cyc_NewControlFlow_strcmp(_tmp6A3,({const char*_tmp148="debug_on";_tag_dyneither(_tmp148,sizeof(char),9U);}));}));else{
# 1066
if(!({struct _dyneither_ptr _tmp6A4=(struct _dyneither_ptr)_tmp2C1;Cyc_NewControlFlow_strcmp(_tmp6A4,({const char*_tmp149="debug_off";_tag_dyneither(_tmp149,sizeof(char),10U);}));}));else{
# 1072
({struct Cyc_String_pa_PrintArg_struct _tmp14C=({struct Cyc_String_pa_PrintArg_struct _tmp5CA;_tmp5CA.tag=0U,_tmp5CA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp2C1);_tmp5CA;});void*_tmp14A[1U];_tmp14A[0]=& _tmp14C;({unsigned int _tmp6A6=e->loc;struct _dyneither_ptr _tmp6A5=({const char*_tmp14B="unknown pragma %s";_tag_dyneither(_tmp14B,sizeof(char),18U);});Cyc_Warn_warn(_tmp6A6,_tmp6A5,_tag_dyneither(_tmp14A,sizeof(void*),1U));});});}}}
...
# 1091
 return({struct _tuple16 _tmp5CE;_tmp5CE.f1=inflow,({void*_tmp6A7=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5CE.f2=_tmp6A7;});_tmp5CE;});case 4U: _LL36: _tmp2C2=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp138)->f1)->f1;_LL37:
# 1096
 if((int)_tmp2C2->sc == (int)Cyc_Absyn_Static)
return({struct _tuple16 _tmp5CF;_tmp5CF.f1=inflow,({void*_tmp6A8=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5CF.f2=_tmp6A8;});_tmp5CF;});
# 1099
_tmp2C3=_tmp2C2;goto _LL39;case 3U: _LL38: _tmp2C3=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp138)->f1)->f1;_LL39:
...
# 1103
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct vdroot=({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp5D1;_tmp5D1.tag=0U,_tmp5D1.f1=_tmp2C4;_tmp5D1;});
return({struct _tuple16 _tmp5D0;_tmp5D0.f1=inflow,({void*_tmp6AA=({struct Cyc_Dict_Dict _tmp6A9=d;((void*(*)(struct Cyc_Dict_Dict d,int(*cmp)(void*,void*),void*k))Cyc_Dict_lookup_other)(_tmp6A9,Cyc_CfFlowInfo_root_cmp,(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp14D=_cycalloc(sizeof(*_tmp14D));*_tmp14D=vdroot;_tmp14D;}));});_tmp5D0.f2=_tmp6AA;});_tmp5D0;});}default: _LL74: _LL75:
# 1708
...
# 1084
 ...
 return({struct _tuple16 _tmp5D2;_tmp5D2.f1=inflow,_tmp5D2.f2=_tmp125->unknown_all;_tmp5D2;});case 3U: _LL3C: _tmp2C8=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2C7=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL3D: {
# 1110
...
return({struct _tuple16 _tmp5D3;_tmp5D3.f1=_tmp151,_tmp5D3.f2=_tmp150;_tmp5D3;});}case 5U: _LL3E: _tmp2C9=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL3F: {
# 1114
struct Cyc_List_List _tmp152=({struct Cyc_List_List _tmp5D7;_tmp5D7.hd=_tmp2C9,_tmp5D7.tl=0;_tmp5D7;});
...
# 1124
{struct _tuple25 _tmp15B=({struct _tuple25 _tmp5D4;_tmp5D4.f1=_tmp160,_tmp5D4.f2=_tmp161;_tmp5D4;});struct _tuple25 _tmp15C=_tmp15B;struct Cyc_CfFlowInfo_Place*_tmp15F;struct Cyc_Dict_Dict _tmp15E;struct Cyc_List_List*_tmp15D;if(((_tmp15C.f1).PlaceL).tag == 1){if(((_tmp15C.f2).ReachableFL).tag == 2){_LL91: _tmp15F=((_tmp15C.f1).PlaceL).val;_tmp15E=(((_tmp15C.f2).ReachableFL).val).f1;_tmp15D=(((_tmp15C.f2).ReachableFL).val).f2;_LL92:
# 1126
 _tmp15D=Cyc_Relations_reln_kill_exp(Cyc_Core_heap_region,_tmp15D,_tmp2C9);
_tmp161=({struct Cyc_Dict_Dict _tmp6AB=Cyc_CfFlowInfo_assign_place(_tmp125,_tmp2C9->loc,_tmp15E,_tmp15F,_tmp125->unknown_all);Cyc_CfFlowInfo_ReachableFL(_tmp6AB,_tmp15D);});
# 1131
goto _LL90;}else{goto _LL93;}}else{_LL93: _LL94:
 goto _LL90;}_LL90:;}
# 1135
if(iszt)
return({struct _tuple16 _tmp5D5;_tmp5D5.f1=_tmp161,_tmp5D5.f2=_tmp125->notzeroall;_tmp5D5;});else{
return({struct _tuple16 _tmp5D6;_tmp5D6.f1=_tmp161,_tmp5D6.f2=_tmp125->unknown_all;_tmp5D6;});}};};}case 4U: if(((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp138)->f2 != 0){_LL40: _tmp2CB=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2CA=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp138)->f3;_LL41:
# 1140
 if(copy_ctxt  && Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_check_null(e->topt))){
({void*_tmp162=0U;({unsigned int _tmp6AD=e->loc;struct _dyneither_ptr _tmp6AC=({const char*_tmp163="cannot track alias-free pointers through multiple assignments";_tag_dyneither(_tmp163,sizeof(char),62U);});Cyc_CfFlowInfo_aerr(_tmp6AD,_tmp6AC,_tag_dyneither(_tmp162,sizeof(void*),0U));});});
return({struct _tuple16 _tmp5D8;({union Cyc_CfFlowInfo_FlowInfo _tmp6AE=Cyc_CfFlowInfo_BottomFL();_tmp5D8.f1=_tmp6AE;}),_tmp5D8.f2=_tmp125->unknown_all;_tmp5D8;});}{
# 1144
...
goto _LL9B;}else{_LL9E: _LL9F:
 goto _LL9B;}_LL9B:;}
# 1167
return({struct _tuple16 _tmp5D9;_tmp5D9.f1=_tmp16E,_tmp5D9.f2=_tmp125->unknown_all;_tmp5D9;});};};}else{_LL42: _tmp2CD=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2CC=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp138)->f3;_LL43:
# 1170
 if(copy_ctxt  && Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_check_null(e->topt))){
({void*_tmp171=0U;({unsigned int _tmp6B0=e->loc;struct _dyneither_ptr _tmp6AF=({const char*_tmp172="cannot track alias-free pointers through multiple assignments";_tag_dyneither(_tmp172,sizeof(char),62U);});Cyc_CfFlowInfo_aerr(_tmp6B0,_tmp6AF,_tag_dyneither(_tmp171,sizeof(void*),0U));});});
return({struct _tuple16 _tmp5DA;({union Cyc_CfFlowInfo_FlowInfo _tmp6B1=Cyc_CfFlowInfo_BottomFL();_tmp5DA.f1=_tmp6B1;}),_tmp5DA.f2=_tmp125->unknown_all;_tmp5DA;});}
# 1176
inflow=({struct Cyc_NewControlFlow_AnalEnv*_tmp6B3=env;union Cyc_CfFlowInfo_FlowInfo _tmp6B2=inflow;Cyc_NewControlFlow_expand_unique_places(_tmp6B3,_tmp6B2,({struct Cyc_Absyn_Exp*_tmp173[2U];_tmp173[0]=_tmp2CD,_tmp173[1]=_tmp2CC;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp173,sizeof(struct Cyc_Absyn_Exp*),2U));}));});{
# 1178
...
# 1184
return({struct _tuple16 _tmp5DB;_tmp5DB.f1=_tmp17B,_tmp5DB.f2=_tmp17A;_tmp5DB;});};};};}case 9U: _LL44: _tmp2CF=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2CE=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL45: {
# 1187
...
return({struct _tuple16 _tmp5DC;({union Cyc_CfFlowInfo_FlowInfo _tmp6B5=Cyc_CfFlowInfo_BottomFL();_tmp5DC.f1=_tmp6B5;}),({void*_tmp6B4=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5DC.f2=_tmp6B4;});_tmp5DC;});}case 10U: _LL48: _tmp2D2=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2D1=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL49: {
# 1196
...
# 1202
struct _tuple23 _tmp18B=({struct Cyc_NewControlFlow_AnalEnv*_tmp6B7=env;union Cyc_CfFlowInfo_FlowInfo _tmp6B6=_tmp1BB;Cyc_NewControlFlow_anal_Rexps(_tmp6B7,_tmp6B6,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_copy)(_tmp2D1),1,1);});struct _tuple23 _tmp18C=_tmp18B;union Cyc_CfFlowInfo_FlowInfo _tmp1B9;struct Cyc_List_List*_tmp1B8;_LLB8: _tmp1B9=_tmp18C.f1;_tmp1B8=_tmp18C.f2;_LLB9:;{
# 1204
...
({void*_tmp19B=0U;({struct _dyneither_ptr _tmp6B8=({const char*_tmp19C="anal_Rexp: bad function type";_tag_dyneither(_tmp19C,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6B8,_tag_dyneither(_tmp19B,sizeof(void*),0U));});});}_LLBF:;}
# 1235
goto _LLBA;}else{_LLBD: _LLBE:
({void*_tmp1A0=0U;({struct _dyneither_ptr _tmp6B9=({const char*_tmp1A1="anal_Rexp: bad function type";_tag_dyneither(_tmp1A1,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6B9,_tag_dyneither(_tmp1A0,sizeof(void*),0U));});});}_LLBA:;}
# 1238
...
({void*_tmp1A6=0U;({unsigned int _tmp6BB=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp2D1))->hd)->loc;struct _dyneither_ptr _tmp6BA=({const char*_tmp1A7="expression may not be initialized";_tag_dyneither(_tmp1A7,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6BB,_tmp6BA,_tag_dyneither(_tmp1A6,sizeof(void*),0U));});});
...
# 1256
 _tmp1A9=({struct Cyc_CfFlowInfo_FlowEnv*_tmp6BF=_tmp125;unsigned int _tmp6BE=((struct Cyc_Absyn_Exp*)_tmp2D1->hd)->loc;struct Cyc_Dict_Dict _tmp6BD=_tmp1A9;struct Cyc_CfFlowInfo_Place*_tmp6BC=_tmp1B3;Cyc_CfFlowInfo_assign_place(_tmp6BF,_tmp6BE,_tmp6BD,_tmp6BC,
Cyc_CfFlowInfo_typ_to_absrval(_tmp125,_tmp1B0,0,_tmp125->esc_all));});
# 1260
goto _LLE1;}else{_LLE4: _LLE5:
({void*_tmp1AE=0U;({struct _dyneither_ptr _tmp6C0=({const char*_tmp1AF="anal_Rexp:bad type for initialized arg";_tag_dyneither(_tmp1AF,sizeof(char),39U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6C0,_tag_dyneither(_tmp1AE,sizeof(void*),0U));});});}_LLE1:;}
# 1263
goto _LLDA;case 5U: _LLDD: _LLDE:
# 1265
({void*_tmp1B1=0U;({struct _dyneither_ptr _tmp6C1=({const char*_tmp1B2="anal_Rexp:initialize attribute on unique pointers not yet supported";_tag_dyneither(_tmp1B2,sizeof(char),68U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6C1,_tag_dyneither(_tmp1B1,sizeof(void*),0U));});});default: _LLDF: _LLE0:
# 1267
 goto _LLDA;}_LLDA:;}
# 1269
...
# 1280
_tmp18D=({struct Cyc_NewControlFlow_AnalEnv*_tmp6C5=env;unsigned int _tmp6C4=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp2D1))->hd)->loc;void*_tmp6C3=(void*)_check_null(((struct Cyc_Absyn_Exp*)_tmp2D1->hd)->topt);union Cyc_CfFlowInfo_FlowInfo _tmp6C2=_tmp18D;Cyc_NewControlFlow_use_nounique_Rval(_tmp6C5,_tmp6C4,_tmp6C3,_tmp6C2,(void*)_tmp1B8->hd);});else{
# 1290
...
return({struct _tuple16 _tmp5DD;({union Cyc_CfFlowInfo_FlowInfo _tmp6C7=Cyc_CfFlowInfo_BottomFL();_tmp5DD.f1=_tmp6C7;}),({void*_tmp6C6=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5DD.f2=_tmp6C6;});_tmp5DD;});else{
# 1303
return({struct _tuple16 _tmp5DE;_tmp5DE.f1=_tmp18D,({void*_tmp6C8=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5DE.f2=_tmp6C8;});_tmp5DE;});}};};}case 34U: _LL4A: _tmp2D7=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp138)->f1).is_calloc;_tmp2D6=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp138)->f1).rgn;_tmp2D5=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp138)->f1).elt_type;_tmp2D4=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp138)->f1).num_elts;_tmp2D3=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp138)->f1).fat_result;_LL4B: {
# 1306
void*place_val;
...
return({struct _tuple16 _tmp5DF;_tmp5DF.f1=outflow,({void*_tmp6CB=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp1C4=_cycalloc(sizeof(*_tmp1C4));_tmp1C4->tag=5U,_tmp1C4->f1=place_val;_tmp1C4;});_tmp5DF.f2=_tmp6CB;});_tmp5DF;});else{
# 1324
...
union Cyc_CfFlowInfo_FlowInfo _tmp1C5=outflow;struct Cyc_Dict_Dict _tmp1C7;struct Cyc_List_List*_tmp1C6;if((_tmp1C5.BottomFL).tag == 1){_LLED: _LLEE:
 return({struct _tuple16 _tmp5E0;_tmp5E0.f1=outflow,_tmp5E0.f2=rval;_tmp5E0;});}else{_LLEF: _tmp1C7=((_tmp1C5.ReachableFL).val).f1;_tmp1C6=((_tmp1C5.ReachableFL).val).f2;_LLF0:
# 1330
 return({struct _tuple16 _tmp5E1;({union Cyc_CfFlowInfo_FlowInfo _tmp6CD=({struct Cyc_Dict_Dict _tmp6CC=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp1C7,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp6CC,_tmp1C6);});_tmp5E1.f1=_tmp6CD;}),_tmp5E1.f2=rval;_tmp5E1;});}_LLEC:;}};}case 35U: _LL4C: _tmp2D9=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2D8=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL4D: {
# 1335
void*left_rval;
void*right_rval;
union Cyc_CfFlowInfo_FlowInfo outflow;
# 1341
struct _tuple23 _tmp1CB=({struct Cyc_NewControlFlow_AnalEnv*_tmp6CF=env;union Cyc_CfFlowInfo_FlowInfo _tmp6CE=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6CF,_tmp6CE,({struct Cyc_Absyn_Exp*_tmp1E6[2U];_tmp1E6[0]=_tmp2D9,_tmp1E6[1]=_tmp2D8;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1E6,sizeof(struct Cyc_Absyn_Exp*),2U));}),0,0);});struct _tuple23 _tmp1CC=_tmp1CB;union Cyc_CfFlowInfo_FlowInfo _tmp1E5;struct Cyc_List_List*_tmp1E4;_LLF2: _tmp1E5=_tmp1CC.f1;_tmp1E4=_tmp1CC.f2;_LLF3:;
...
({void*_tmp1CE=0U;({unsigned int _tmp6D1=_tmp2D9->loc;struct _dyneither_ptr _tmp6D0=({const char*_tmp1CF="cannot swap value into zeroterm array not known to be 0";_tag_dyneither(_tmp1CF,sizeof(char),56U);});Cyc_CfFlowInfo_aerr(_tmp6D1,_tmp6D0,_tag_dyneither(_tmp1CE,sizeof(void*),0U));});});}_LLF4:;}else{
# 1358
...
({void*_tmp1D1=0U;({unsigned int _tmp6D3=_tmp2D8->loc;struct _dyneither_ptr _tmp6D2=({const char*_tmp1D2="cannot swap value into zeroterm array not known to be 0";_tag_dyneither(_tmp1D2,sizeof(char),56U);});Cyc_CfFlowInfo_aerr(_tmp6D3,_tmp6D2,_tag_dyneither(_tmp1D1,sizeof(void*),0U));});});}_LLF9:;}}{
# 1366
...
({void*_tmp1D9=0U;({unsigned int _tmp6D5=_tmp2D8->loc;struct _dyneither_ptr _tmp6D4=({const char*_tmp1DA="expression may not be fully initialized";_tag_dyneither(_tmp1DA,sizeof(char),40U);});Cyc_CfFlowInfo_aerr(_tmp6D5,_tmp6D4,_tag_dyneither(_tmp1D9,sizeof(void*),0U));});});
goto _LL109;}_LL109:;}
# 1382
...
({void*_tmp1DD=0U;({unsigned int _tmp6D7=_tmp2D9->loc;struct _dyneither_ptr _tmp6D6=({const char*_tmp1DE="expression may not be fully initialized";_tag_dyneither(_tmp1DE,sizeof(char),40U);});Cyc_CfFlowInfo_aerr(_tmp6D7,_tmp6D6,_tag_dyneither(_tmp1DD,sizeof(void*),0U));});});
goto _LL10E;}_LL10E:;}
# 1392
...
goto _LL104;}else{_LL107: _LL108:
 goto _LL104;}_LL104:;}
# 1402
return({struct _tuple16 _tmp5E2;_tmp5E2.f1=outflow,_tmp5E2.f2=_tmp125->unknown_all;_tmp5E2;});};};};}case 16U: _LL4E: _tmp2DB=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2DA=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL4F: {
# 1405
union Cyc_CfFlowInfo_FlowInfo outflow;
void*place_val;
if(_tmp2DB != 0){
struct _tuple23 _tmp1E7=({struct Cyc_NewControlFlow_AnalEnv*_tmp6D9=env;union Cyc_CfFlowInfo_FlowInfo _tmp6D8=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6D9,_tmp6D8,({struct Cyc_Absyn_Exp*_tmp1EB[2U];_tmp1EB[0]=_tmp2DB,_tmp1EB[1]=_tmp2DA;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1EB,sizeof(struct Cyc_Absyn_Exp*),2U));}),1,1);});struct _tuple23 _tmp1E8=_tmp1E7;union Cyc_CfFlowInfo_FlowInfo _tmp1EA;struct Cyc_List_List*_tmp1E9;_LL114: _tmp1EA=_tmp1E8.f1;_tmp1E9=_tmp1E8.f2;_LL115:;
outflow=_tmp1EA;
...
# 1417
if(Cyc_Tcutil_is_noalias_pointer((void*)_check_null(e->topt),1))
return({struct _tuple16 _tmp5E3;_tmp5E3.f1=outflow,({void*_tmp6DA=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp1F0=_cycalloc(sizeof(*_tmp1F0));_tmp1F0->tag=5U,_tmp1F0->f1=place_val;_tmp1F0;});_tmp5E3.f2=_tmp6DA;});_tmp5E3;});else{
# 1421
...
union Cyc_CfFlowInfo_FlowInfo _tmp1F1=outflow;struct Cyc_Dict_Dict _tmp1F3;struct Cyc_List_List*_tmp1F2;if((_tmp1F1.BottomFL).tag == 1){_LL11A: _LL11B:
 return({struct _tuple16 _tmp5E4;_tmp5E4.f1=outflow,_tmp5E4.f2=rval;_tmp5E4;});}else{_LL11C: _tmp1F3=((_tmp1F1.ReachableFL).val).f1;_tmp1F2=((_tmp1F1.ReachableFL).val).f2;_LL11D:
# 1427
 return({struct _tuple16 _tmp5E5;({union Cyc_CfFlowInfo_FlowInfo _tmp6DC=({struct Cyc_Dict_Dict _tmp6DB=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp1F3,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp6DB,_tmp1F2);});_tmp5E5.f1=_tmp6DC;}),_tmp5E5.f2=rval;_tmp5E5;});}_LL119:;}}case 15U: _LL50: _tmp2DC=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL51: {
# 1432
...
union Cyc_CfFlowInfo_AbsLVal _tmp1F9=_tmp1FC;struct Cyc_CfFlowInfo_Place*_tmp1FB;if((_tmp1F9.UnknownL).tag == 2){_LL122: _LL123:
 return({struct _tuple16 _tmp5E6;_tmp5E6.f1=_tmp1FD,_tmp5E6.f2=_tmp125->notzeroall;_tmp5E6;});}else{_LL124: _tmp1FB=(_tmp1F9.PlaceL).val;_LL125:
 return({struct _tuple16 _tmp5E7;_tmp5E7.f1=_tmp1FD,({void*_tmp6DD=(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp1FA=_cycalloc(sizeof(*_tmp1FA));_tmp1FA->tag=4U,_tmp1FA->f1=_tmp1FB;_tmp1FA;});_tmp5E7.f2=_tmp6DD;});_tmp5E7;});}_LL121:;};}case 20U: _LL52: _tmp2DD=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL53: {
# 1439
...
return({struct _tuple16 _tmp5E8;_tmp5E8.f1=_tmp213,({void*_tmp6DE=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5E8.f2=_tmp6DE;});_tmp5E8;});
...
return({struct _tuple16 _tmp5E9;_tmp5E9.f1=_tmp213,({void*_tmp6DF=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),1,_tmp125->unknown_none);_tmp5E9.f2=_tmp6DF;});_tmp5E9;});
return({struct _tuple16 _tmp5EA;_tmp5EA.f1=_tmp213,_tmp5EA.f2=*((void**)_check_dyneither_subscript(_tmp20E,sizeof(void*),_tmp208));_tmp5EA;});}}else{_LL132: _LL133:
# 1458
({void*_tmp209=0U;({struct Cyc___cycFILE*_tmp6E1=Cyc_stderr;struct _dyneither_ptr _tmp6E0=({const char*_tmp20A="the bad rexp is :";_tag_dyneither(_tmp20A,sizeof(char),18U);});Cyc_fprintf(_tmp6E1,_tmp6E0,_tag_dyneither(_tmp209,sizeof(void*),0U));});});
Cyc_CfFlowInfo_print_absrval(_tmp211);
({struct Cyc_String_pa_PrintArg_struct _tmp20D=({struct Cyc_String_pa_PrintArg_struct _tmp5EB;_tmp5EB.tag=0U,({struct _dyneither_ptr _tmp6E2=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp5EB.f1=_tmp6E2;});_tmp5EB;});void*_tmp20B[1U];_tmp20B[0]=& _tmp20D;({struct _dyneither_ptr _tmp6E3=({const char*_tmp20C="\nanal_Rexp: AggrMember: %s";_tag_dyneither(_tmp20C,sizeof(char),27U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6E3,_tag_dyneither(_tmp20B,sizeof(void*),1U));});});}_LL12F:;};};};}case 38U: _LL56: _tmp2E1=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2E0=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL57: {
# 1466
...
return({struct _tuple16 _tmp5EC;_tmp5EC.f1=_tmp222,_tmp5EC.f2=_tmp125->unknown_all;_tmp5EC;});{
...
if(_tmp21E != _tmp219)
return({struct _tuple16 _tmp5ED;_tmp5ED.f1=_tmp222,_tmp5ED.f2=_tmp125->zero;_tmp5ED;});else{
# 1478
return({struct _tuple16 _tmp5EE;_tmp5EE.f1=_tmp222,_tmp5EE.f2=_tmp125->notzeroall;_tmp5EE;});}}else{
# 1480
return({struct _tuple16 _tmp5EF;_tmp5EF.f1=_tmp222,_tmp5EF.f2=_tmp125->unknown_all;_tmp5EF;});}}}else{_LL13D: _LL13E:
# 1482
({struct Cyc_String_pa_PrintArg_struct _tmp21C=({struct Cyc_String_pa_PrintArg_struct _tmp5F0;_tmp5F0.tag=0U,({struct _dyneither_ptr _tmp6E4=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp5F0.f1=_tmp6E4;});_tmp5F0;});void*_tmp21A[1U];_tmp21A[0]=& _tmp21C;({struct _dyneither_ptr _tmp6E5=({const char*_tmp21B="anal_Rexp: TagCheck_e: %s";_tag_dyneither(_tmp21B,sizeof(char),26U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6E5,_tag_dyneither(_tmp21A,sizeof(void*),1U));});});}_LL13A:;};};}case 22U: _LL58: _tmp2E3=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2E2=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL59: {
# 1486
...
# 1496
return({struct _tuple16 _tmp5F1;_tmp5F1.f1=_tmp237,({void*_tmp6E6=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5F1.f2=_tmp6E6;});_tmp5F1;});
# 1498
...
return({struct _tuple16 _tmp5F2;_tmp5F2.f1=_tmp237,({void*_tmp6E7=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),1,_tmp125->unknown_none);_tmp5F2.f2=_tmp6E7;});_tmp5F2;});
return({struct _tuple16 _tmp5F3;_tmp5F3.f1=_tmp237,_tmp5F3.f2=*((void**)_check_dyneither_subscript(_tmp22F,sizeof(void*),_tmp22C));_tmp5F3;});}}else{_LL150: _LL151:
({void*_tmp22D=0U;({struct _dyneither_ptr _tmp6E8=({const char*_tmp22E="anal_Rexp: AggrArrow";_tag_dyneither(_tmp22E,sizeof(char),21U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6E8,_tag_dyneither(_tmp22D,sizeof(void*),0U));});});}_LL14D:;};};}else{_LL148: _LL149:
# 1510
({void*_tmp233=0U;({struct _dyneither_ptr _tmp6E9=({const char*_tmp234="anal_Rexp: AggrArrow ptr";_tag_dyneither(_tmp234,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6E9,_tag_dyneither(_tmp233,sizeof(void*),0U));});});}_LL145:;};};}case 6U: _LL5A: _tmp2E6=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2E5=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_tmp2E4=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp138)->f3;_LL5B: {
# 1514
...
struct _tuple16 _tmp244=({struct _tuple16 _tmp5F5;_tmp5F5.f1=_tmp247,_tmp5F5.f2=_tmp246;_tmp5F5;});
struct _tuple16 _tmp245=({struct _tuple16 _tmp5F4;_tmp5F4.f1=_tmp248,_tmp5F4.f2=_tmp125->zero;_tmp5F4;});
...
struct _tuple16 _tmp24E=({struct _tuple16 _tmp5F7;_tmp5F7.f1=_tmp251,_tmp5F7.f2=_tmp250;_tmp5F7;});
struct _tuple16 _tmp24F=({struct _tuple16 _tmp5F6;_tmp5F6.f1=_tmp253,_tmp5F6.f2=_tmp125->notzeroall;_tmp5F6;});
...
({void*_tmp258=0U;({unsigned int _tmp6ED=_tmp2EB->loc;struct _dyneither_ptr _tmp6EC=({const char*_tmp259="expression may not be initialized";_tag_dyneither(_tmp259,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6ED,_tmp6EC,_tag_dyneither(_tmp258,sizeof(void*),0U));});});{
...
return({struct _tuple16 _tmp5F8;_tmp5F8.f1=_tmp256,_tmp5F8.f2=*((void**)_check_dyneither_subscript(_tmp264,sizeof(void*),(int)i));_tmp5F8;});}}else{_LL176: _LL177:
({void*_tmp262=0U;({struct _dyneither_ptr _tmp6EE=({const char*_tmp263="anal_Rexp: Subscript";_tag_dyneither(_tmp263,sizeof(char),21U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6EE,_tag_dyneither(_tmp262,sizeof(void*),0U));});});}_LL173:;};}case 3U: _LL16C: _LL16D: {
# 1561
...
union Cyc_CfFlowInfo_FlowInfo _tmp268=_tmp26A;if((_tmp268.BottomFL).tag == 1){_LL17C: _LL17D:
 return({struct _tuple16 _tmp5F9;_tmp5F9.f1=_tmp26A,_tmp5F9.f2=_tmp269;_tmp5F9;});}else{_LL17E: _LL17F:
 return({struct _tuple16 _tmp5FA;_tmp5FA.f1=_tmp256,_tmp5FA.f2=_tmp269;_tmp5FA;});}_LL17B:;};}default: _LL16E: _LL16F:
# 1566
({void*_tmp26B=0U;({struct _dyneither_ptr _tmp6EF=({const char*_tmp26C="anal_Rexp: Subscript -- bad type";_tag_dyneither(_tmp26C,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6EF,_tag_dyneither(_tmp26B,sizeof(void*),0U));});});}_LL169:;};};}case 24U: _LL64: _tmp2ED=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL65: {
# 1572
...
((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp2ED);void**_tmp275=_cycalloc(_check_times(_tmp276,sizeof(void*)));({{unsigned int _tmp5FC=(unsigned int)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp2ED);unsigned int i;for(i=0;i < _tmp5FC;++ i){({
void*_tmp6F0=({void*_tmp274=(void*)((struct Cyc_List_List*)_check_null(_tmp277))->hd;
_tmp277=_tmp277->tl;
_tmp274;});
# 1575
_tmp275[i]=_tmp6F0;});}}0;});_tag_dyneither(_tmp275,sizeof(void*),_tmp276);});
# 1579
return({struct _tuple16 _tmp5FB;_tmp5FB.f1=_tmp278,({void*_tmp6F1=(void*)({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp273=_cycalloc(sizeof(*_tmp273));_tmp273->tag=6U,(_tmp273->f1).is_union=0,(_tmp273->f1).fieldnum=- 1,_tmp273->f2=aggrdict;_tmp273;});_tmp5FB.f2=_tmp6F1;});_tmp5FB;});};}case 30U: _LL66: _tmp2EE=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL67: {
# 1582
...
({void*_tmp27B=0U;({struct _dyneither_ptr _tmp6F2=({const char*_tmp27C="anal_Rexp:anon struct has bad type";_tag_dyneither(_tmp27C,sizeof(char),35U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6F2,_tag_dyneither(_tmp27B,sizeof(void*),0U));});});}_LL183:;}
# 1587
...
({void*_tmp282=0U;({struct _dyneither_ptr _tmp6F5=({const char*_tmp283="anal_Rexp:Aggregate_e";_tag_dyneither(_tmp283,sizeof(char),22U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6F5,_tag_dyneither(_tmp282,sizeof(void*),0U));});});}else{_LL18E: _tmp285=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp281)->f1;_LL18F:
# 1601
...
return({struct _tuple16 _tmp5FD;_tmp5FD.f1=_tmp289,_tmp5FD.f2=(void*)_tmp286;_tmp5FD;});};};}}else{goto _LL6A;}}else{_LL6A: _LL6B:
# 1615
({struct Cyc_String_pa_PrintArg_struct _tmp28C=({struct Cyc_String_pa_PrintArg_struct _tmp5FE;_tmp5FE.tag=0U,({struct _dyneither_ptr _tmp6F6=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp5FE.f1=_tmp6F6;});_tmp5FE;});void*_tmp28A[1U];_tmp28A[0]=& _tmp28C;({struct _dyneither_ptr _tmp6F7=({const char*_tmp28B="anal_Rexp:missing aggrdeclimpl in %s";_tag_dyneither(_tmp28B,sizeof(char),37U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6F7,_tag_dyneither(_tmp28A,sizeof(void*),1U));});});}case 26U: _LL6C: _tmp2F2=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL6D: {
# 1617
...
# 1622
return({struct _tuple16 _tmp5FF;_tmp5FF.f1=_tmp291,({void*_tmp6F8=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->notzeroall);_tmp5FF.f2=_tmp6F8;});_tmp5FF;});}case 27U: _LL6E: _tmp2F6=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2F5=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_tmp2F4=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp138)->f3;_tmp2F3=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp138)->f4;_LL6F: {
# 1626
...
union Cyc_CfFlowInfo_FlowInfo _tmp294=_tmp2AE;struct Cyc_Dict_Dict _tmp2AC;struct Cyc_List_List*_tmp2AB;if((_tmp294.BottomFL).tag == 1){_LL197: _LL198:
 return({struct _tuple16 _tmp600;_tmp600.f1=_tmp2AE,_tmp600.f2=_tmp125->unknown_all;_tmp600;});}else{_LL199: _tmp2AC=((_tmp294.ReachableFL).val).f1;_tmp2AB=((_tmp294.ReachableFL).val).f2;_LL19A:
# 1630
 if((int)Cyc_CfFlowInfo_initlevel(env->fenv,_tmp2AC,_tmp2AD)== (int)Cyc_CfFlowInfo_NoneIL)
({void*_tmp295=0U;({unsigned int _tmp6FA=_tmp2F5->loc;struct _dyneither_ptr _tmp6F9=({const char*_tmp296="expression may not be initialized";_tag_dyneither(_tmp296,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6FA,_tmp6F9,_tag_dyneither(_tmp295,sizeof(void*),0U));});});{
# 1634
...
void*_tmp297=_tmp2AD;switch(*((int*)_tmp297)){case 0U: _LL19C: _LL19D:
 return({struct _tuple16 _tmp601;_tmp601.f1=_tmp2AE,_tmp601.f2=_tmp125->unknown_all;_tmp601;});case 1U: _LL19E: _LL19F:
 goto _LL1A1;case 4U: _LL1A0: _LL1A1: {
# 1647
struct Cyc_List_List _tmp298=({struct Cyc_List_List _tmp604;_tmp604.hd=_tmp2F6,_tmp604.tl=0;_tmp604;});
...
{union Cyc_CfFlowInfo_FlowInfo _tmp29B=_tmp2A0;struct Cyc_Dict_Dict _tmp29E;if((_tmp29B.BottomFL).tag == 1){_LL1A8: _LL1A9:
 return({struct _tuple16 _tmp602;_tmp602.f1=_tmp2A0,_tmp602.f2=_tmp125->unknown_all;_tmp602;});}else{_LL1AA: _tmp29E=((_tmp29B.ReachableFL).val).f1;_LL1AB:
# 1654
 if((int)Cyc_CfFlowInfo_initlevel(_tmp125,_tmp29E,_tmp29F)!= (int)Cyc_CfFlowInfo_AllIL){
({void*_tmp29C=0U;({unsigned int _tmp6FC=_tmp2F5->loc;struct _dyneither_ptr _tmp6FB=({const char*_tmp29D="expression may not be initialized";_tag_dyneither(_tmp29D,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6FC,_tmp6FB,_tag_dyneither(_tmp29C,sizeof(void*),0U));});});
return({struct _tuple16 _tmp603;({union Cyc_CfFlowInfo_FlowInfo _tmp6FD=Cyc_CfFlowInfo_BottomFL();_tmp603.f1=_tmp6FD;}),_tmp603.f2=_tmp125->unknown_all;_tmp603;});}}_LL1A7:;}
# 1659
_tmp2AE=_tmp2A0;
goto _LL1A3;};}default: _LL1A2: _LL1A3:
# 1662
 while(1){
struct Cyc_List_List _tmp2A1=({struct Cyc_List_List _tmp606;_tmp606.hd=_tmp2F6,_tmp606.tl=0;_tmp606;});
...
({void*_tmp2A5=0U;({unsigned int _tmp6FF=_tmp2F5->loc;struct _dyneither_ptr _tmp6FE=({const char*_tmp2A6="expression may not be initialized";_tag_dyneither(_tmp2A6,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6FF,_tmp6FE,_tag_dyneither(_tmp2A5,sizeof(void*),0U));});});
return({struct _tuple16 _tmp605;({union Cyc_CfFlowInfo_FlowInfo _tmp700=Cyc_CfFlowInfo_BottomFL();_tmp605.f1=_tmp700;}),_tmp605.f2=_tmp125->unknown_all;_tmp605;});}}_LL1AF:;}{
# 1674
...
_tmp2AE=_tmp2A8;};};}
# 1679
return({struct _tuple16 _tmp607;_tmp607.f1=_tmp2AE,_tmp607.f2=_tmp125->notzeroall;_tmp607;});}_LL19B:;};};}_LL196:;};}case 28U: _LL70: _tmp2F9=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2F8=(void*)((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_tmp2F7=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp138)->f3;_LL71: {
# 1685
...
union Cyc_CfFlowInfo_FlowInfo _tmp2B1=outflow;struct Cyc_Dict_Dict _tmp2B3;struct Cyc_List_List*_tmp2B2;if((_tmp2B1.BottomFL).tag == 1){_LL1B8: _LL1B9:
 return({struct _tuple16 _tmp608;_tmp608.f1=outflow,_tmp608.f2=rval;_tmp608;});}else{_LL1BA: _tmp2B3=((_tmp2B1.ReachableFL).val).f1;_tmp2B2=((_tmp2B1.ReachableFL).val).f2;_LL1BB:
# 1700
 return({struct _tuple16 _tmp609;({union Cyc_CfFlowInfo_FlowInfo _tmp702=({struct Cyc_Dict_Dict _tmp701=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp2B3,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp701,_tmp2B2);});_tmp609.f1=_tmp702;}),_tmp609.f2=rval;_tmp609;});}_LL1B7:;};};}case 37U: _LL72: _tmp2FA=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL73: {
# 1704
struct _tuple17 _tmp2B8=({struct _tuple17 _tmp60B;_tmp60B.f1=(env->fenv)->unknown_all,_tmp60B.f2=copy_ctxt;_tmp60B;});
union Cyc_CfFlowInfo_FlowInfo _tmp2B9=Cyc_NewControlFlow_anal_stmt(env,inflow,_tmp2FA,& _tmp2B8);
return({struct _tuple16 _tmp60A;_tmp60A.f1=_tmp2B9,_tmp60A.f2=_tmp2B8.f1;_tmp60A;});}case 36U: _LL76: _LL77:
# 1709
 goto _LL79;case 25U: _LL78: _LL79:
 goto _LL7B;case 39U: _LL7A: _LL7B:
 goto _LL7D;default: _LL7C: _LL7D:
({void*_tmp2BA=0U;({struct _dyneither_ptr _tmp703=({const char*_tmp2BB="anal_Rexp, unexpected exp form";_tag_dyneither(_tmp2BB,sizeof(char),31U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp703,_tag_dyneither(_tmp2BA,sizeof(void*),0U));});});}_LLD:;};}
# 1724 "new_control_flow.cyc"
...
union Cyc_CfFlowInfo_FlowInfo _tmp2FE=f;struct Cyc_Dict_Dict _tmp31E;struct Cyc_List_List*_tmp31D;if((_tmp2FE.BottomFL).tag == 1){_LL6: _LL7:
 return({struct _tuple18 _tmp60C;_tmp60C.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp704=Cyc_CfFlowInfo_UnknownL();_tmp60C.f2=_tmp704;});_tmp60C;});}else{_LL8: _tmp31E=((_tmp2FE.ReachableFL).val).f1;_tmp31D=((_tmp2FE.ReachableFL).val).f2;_LL9: {
# 1740
...
# 1743
({void*_tmp302=0U;({struct _dyneither_ptr _tmp705=({const char*_tmp303="named location in anal_derefL";_tag_dyneither(_tmp303,sizeof(char),30U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp705,_tag_dyneither(_tmp302,sizeof(void*),0U));});});case 1U: _LL10: _LL11:
# 1745
({void*_tmp706=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp304=_cycalloc(sizeof(*_tmp304));_tmp304->tag=Cyc_CfFlowInfo_NotZero,_tmp304->f1=_tmp31D;_tmp304;});e->annot=_tmp706;});goto _LLD;case 5U: _LL12: _tmp30E=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp301)->f1;_LL13:
# 1748
 if(expanded_place_possibly_null)
# 1751
({void*_tmp707=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp305=_cycalloc(sizeof(*_tmp305));_tmp305->tag=Cyc_CfFlowInfo_UnknownZ,_tmp305->f1=_tmp31D;_tmp305;});e->annot=_tmp707;});else{
# 1754
...
# 1758
({void*_tmp708=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp308=_cycalloc(sizeof(*_tmp308));_tmp308->tag=Cyc_CfFlowInfo_UnknownZ,_tmp308->f1=_tmp31D;_tmp308;});e->annot=_tmp708;});
goto _LL1E;}else{_LL21: _LL22:
# 1761
({void*_tmp709=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp309=_cycalloc(sizeof(*_tmp309));_tmp309->tag=Cyc_CfFlowInfo_NotZero,_tmp309->f1=_tmp31D;_tmp309;});e->annot=_tmp709;});
goto _LL1E;}_LL1E:;}
# 1766
if(Cyc_Tcutil_is_bound_one(_tmp321))return({struct _tuple18 _tmp60D;_tmp60D.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp70A=Cyc_CfFlowInfo_UnknownL();_tmp60D.f2=_tmp70A;});_tmp60D;});
...
# 1770
({void*_tmp70B=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp30A=_cycalloc(sizeof(*_tmp30A));_tmp30A->tag=Cyc_CfFlowInfo_NotZero,_tmp30A->f1=_tmp31D;_tmp30A;});e->annot=_tmp70B;});
if(Cyc_Tcutil_is_bound_one(_tmp321))
return({struct _tuple18 _tmp60E;_tmp60E.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp70D=Cyc_CfFlowInfo_PlaceL(({struct Cyc_CfFlowInfo_Place*_tmp30B=_cycalloc(sizeof(*_tmp30B));_tmp30B->root=_tmp310,({struct Cyc_List_List*_tmp70C=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp30F,path);_tmp30B->path=_tmp70C;});_tmp30B;}));_tmp60E.f2=_tmp70D;});_tmp60E;});
goto _LLD;case 0U: _LL16: _LL17:
# 1775
 e->annot=(void*)& Cyc_CfFlowInfo_IsZero_val;
return({struct _tuple18 _tmp60F;({union Cyc_CfFlowInfo_FlowInfo _tmp70F=Cyc_CfFlowInfo_BottomFL();_tmp60F.f1=_tmp70F;}),({union Cyc_CfFlowInfo_AbsLVal _tmp70E=Cyc_CfFlowInfo_UnknownL();_tmp60F.f2=_tmp70E;});_tmp60F;});case 2U: _LL18: _tmp311=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp301)->f1;_LL19:
# 1780
 if(Cyc_Tcutil_is_bound_one(_tmp321))
f=Cyc_NewControlFlow_notzero(env,inflow,f,e,_tmp311,_tmp31B);
({void*_tmp710=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp30C=_cycalloc(sizeof(*_tmp30C));_tmp30C->tag=Cyc_CfFlowInfo_UnknownZ,_tmp30C->f1=_tmp31D;_tmp30C;});e->annot=_tmp710;});
...
# 1790
({void*_tmp711=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp30D=_cycalloc(sizeof(*_tmp30D));_tmp30D->tag=Cyc_CfFlowInfo_UnknownZ,_tmp30D->f1=_tmp31D;_tmp30D;});e->annot=_tmp711;});
goto _LLD;}_LLD:;}
# 1793
...
# 1797
({void*_tmp316=0U;({unsigned int _tmp713=e->loc;struct _dyneither_ptr _tmp712=({const char*_tmp317="attempt to dereference an alias-free that has already been copied";_tag_dyneither(_tmp317,sizeof(char),66U);});Cyc_CfFlowInfo_aerr(_tmp713,_tmp712,_tag_dyneither(_tmp316,sizeof(void*),0U));});});
goto _LL26;}else{_LL29: _LL2A:
# 1800
({void*_tmp318=0U;({unsigned int _tmp715=e->loc;struct _dyneither_ptr _tmp714=({const char*_tmp319="dereference of possibly uninitialized pointer";_tag_dyneither(_tmp319,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp715,_tmp714,_tag_dyneither(_tmp318,sizeof(void*),0U));});});
goto _LL26;}_LL26:;};}
# 1804
return({struct _tuple18 _tmp610;_tmp610.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp716=Cyc_CfFlowInfo_UnknownL();_tmp610.f2=_tmp716;});_tmp610;});}}_LL5:;}}else{_LL3: _LL4:
# 1806
({void*_tmp31F=0U;({struct _dyneither_ptr _tmp717=({const char*_tmp320="left deref of non-pointer-type";_tag_dyneither(_tmp320,sizeof(char),31U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp717,_tag_dyneither(_tmp31F,sizeof(void*),0U));});});}_LL0:;}
# 1812
...
path=({struct Cyc_List_List*_tmp324=_cycalloc(sizeof(*_tmp324));({void*_tmp718=(void*)({struct Cyc_CfFlowInfo_Star_CfFlowInfo_PathCon_struct*_tmp323=_cycalloc(sizeof(*_tmp323));_tmp323->tag=1U;_tmp323;});_tmp324->hd=_tmp718;}),_tmp324->tl=path;_tmp324;});
return({struct Cyc_CfFlowInfo_Place*_tmp325=_cycalloc(sizeof(*_tmp325));_tmp325->root=_tmp327,({struct Cyc_List_List*_tmp719=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp326,path);_tmp325->path=_tmp719;});_tmp325;});}
# 1822
...
{union Cyc_CfFlowInfo_FlowInfo _tmp329=inflow;struct Cyc_Dict_Dict _tmp32B;struct Cyc_List_List*_tmp32A;if((_tmp329.BottomFL).tag == 1){_LL1: _LL2:
 return({struct _tuple18 _tmp611;({union Cyc_CfFlowInfo_FlowInfo _tmp71B=Cyc_CfFlowInfo_BottomFL();_tmp611.f1=_tmp71B;}),({union Cyc_CfFlowInfo_AbsLVal _tmp71A=Cyc_CfFlowInfo_UnknownL();_tmp611.f2=_tmp71A;});_tmp611;});}else{_LL3: _tmp32B=((_tmp329.ReachableFL).val).f1;_tmp32A=((_tmp329.ReachableFL).val).f2;_LL4:
# 1831
 d=_tmp32B;}_LL0:;}{
# 1835
void*_tmp32C=e->r;void*_tmp32D=_tmp32C;struct Cyc_Absyn_Exp*_tmp384;struct _dyneither_ptr*_tmp383;struct Cyc_Absyn_Exp*_tmp382;struct Cyc_Absyn_Exp*_tmp381;struct Cyc_Absyn_Exp*_tmp380;struct Cyc_Absyn_Exp*_tmp37F;struct _dyneither_ptr*_tmp37E;struct Cyc_Absyn_Vardecl*_tmp37D;struct Cyc_Absyn_Vardecl*_tmp37C;struct Cyc_Absyn_Vardecl*_tmp37B;struct Cyc_Absyn_Vardecl*_tmp37A;struct Cyc_Absyn_Exp*_tmp379;struct Cyc_Absyn_Exp*_tmp378;struct Cyc_Absyn_Exp*_tmp377;switch(*((int*)_tmp32D)){case 14U: _LL6: _tmp377=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp32D)->f2;_LL7:
 ...
 return Cyc_NewControlFlow_anal_Lexp_rec(env,inflow,expand_unique,passthrough_consumes,_tmp379,path);case 1U: switch(*((int*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp32D)->f1)){case 4U: _LLC: _tmp37A=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp32D)->f1)->f1;_LLD:
# 1841
 if((int)_tmp37A->sc == (int)Cyc_Absyn_Static)
return({struct _tuple18 _tmp612;_tmp612.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp71C=Cyc_CfFlowInfo_UnknownL();_tmp612.f2=_tmp71C;});_tmp612;});
_tmp37B=_tmp37A;goto _LLF;case 3U: _LLE: _tmp37B=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp32D)->f1)->f1;_LLF:
...
# 1846
 return({struct _tuple18 _tmp613;_tmp613.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp71E=Cyc_CfFlowInfo_PlaceL(({struct Cyc_CfFlowInfo_Place*_tmp32F=_cycalloc(sizeof(*_tmp32F));({void*_tmp71D=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp32E=_cycalloc(sizeof(*_tmp32E));_tmp32E->tag=0U,_tmp32E->f1=_tmp37C;_tmp32E;});_tmp32F->root=_tmp71D;}),_tmp32F->path=path;_tmp32F;}));_tmp613.f2=_tmp71E;});_tmp613;});case 1U: _LL12: _tmp37D=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp32D)->f1)->f1;_LL13:
# 1848
 return({struct _tuple18 _tmp614;_tmp614.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp71F=Cyc_CfFlowInfo_UnknownL();_tmp614.f2=_tmp71F;});_tmp614;});default: goto _LL1C;}case 22U: _LL14: _tmp37F=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp32D)->f1;_tmp37E=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp32D)->f2;_LL15:
# 1851
...
path=({struct Cyc_List_List*_tmp333=_cycalloc(sizeof(*_tmp333));({void*_tmp721=(void*)({struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*_tmp332=_cycalloc(sizeof(*_tmp332));_tmp332->tag=0U,({int _tmp720=Cyc_CfFlowInfo_get_field_index(_tmp336,_tmp37E);_tmp332->f1=_tmp720;});_tmp332;});_tmp333->hd=_tmp721;}),_tmp333->tl=path;_tmp333;});}
# 1857
goto _LL1E;}else{_LL21: _LL22:
({void*_tmp334=0U;({struct _dyneither_ptr _tmp722=({const char*_tmp335="anal_Lexp: AggrArrow ptr";_tag_dyneither(_tmp335,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp722,_tag_dyneither(_tmp334,sizeof(void*),0U));});});}_LL1E:;}
# 1860
...
# 1875
({void*_tmp340=0U;({struct _dyneither_ptr _tmp723=({const char*_tmp341="bad named location in anal_Lexp:deref";_tag_dyneither(_tmp341,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp723,_tag_dyneither(_tmp340,sizeof(void*),0U));});});case 7U: switch(*((int*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp33F)->f3)){case 4U: _LL31: _LL32:
...
return({struct _tuple18 _tmp615;_tmp615.f1=_tmp344,({union Cyc_CfFlowInfo_AbsLVal _tmp724=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(_tmp353,path));_tmp615.f2=_tmp724;});_tmp615;});}case 1U: _LL39: _LL3A:
# 1886
...
void*res=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp34A=_cycalloc(sizeof(*_tmp34A));_tmp34A->tag=5U,({void*_tmp727=({struct Cyc_CfFlowInfo_FlowEnv*_tmp726=_tmp328;void*_tmp725=Cyc_Tcutil_pointer_elt_type((void*)_check_null(_tmp380->topt));Cyc_CfFlowInfo_typ_to_absrval(_tmp726,_tmp725,0,leaf);});_tmp34A->f1=_tmp727;});_tmp34A;});
...
# 1908
return({struct _tuple18 _tmp616;_tmp616.f1=_tmp349,({union Cyc_CfFlowInfo_AbsLVal _tmp728=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(_tmp353,path));_tmp616.f2=_tmp728;});_tmp616;});};}}_LL2E:;}else{
# 1912
...
return({struct _tuple18 _tmp617;_tmp617.f1=_tmp350,({union Cyc_CfFlowInfo_AbsLVal _tmp729=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(_tmp353,path));_tmp617.f2=_tmp729;});_tmp617;});}default: _LL48: _LL49:
# 1921
 goto _LL43;}_LL43:;}
# 1924
...
return({struct Cyc_NewControlFlow_AnalEnv*_tmp72F=env;union Cyc_CfFlowInfo_FlowInfo _tmp72E=inflow;int _tmp72D=expand_unique;int _tmp72C=passthrough_consumes;struct Cyc_Absyn_Exp*_tmp72B=_tmp382;Cyc_NewControlFlow_anal_Lexp_rec(_tmp72F,_tmp72E,_tmp72D,_tmp72C,_tmp72B,({struct Cyc_List_List*_tmp360=_cycalloc(sizeof(*_tmp360));
({void*_tmp72A=(void*)({struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*_tmp35F=_cycalloc(sizeof(*_tmp35F));_tmp35F->tag=0U,_tmp35F->f1=(int)_tmp35E;_tmp35F;});_tmp360->hd=_tmp72A;}),_tmp360->tl=path;_tmp360;}));});}case 3U: _LL53: _LL54: {
# 1940
struct _tuple23 _tmp361=({struct Cyc_NewControlFlow_AnalEnv*_tmp731=env;union Cyc_CfFlowInfo_FlowInfo _tmp730=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp731,_tmp730,({struct Cyc_Absyn_Exp*_tmp371[2U];_tmp371[0]=_tmp382,_tmp371[1]=_tmp381;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp371,sizeof(struct Cyc_Absyn_Exp*),2U));}),0,1);});struct _tuple23 _tmp362=_tmp361;union Cyc_CfFlowInfo_FlowInfo _tmp370;struct Cyc_List_List*_tmp36F;_LL58: _tmp370=_tmp362.f1;_tmp36F=_tmp362.f2;_LL59:;{
...
({void*_tmp365=0U;({unsigned int _tmp733=_tmp381->loc;struct _dyneither_ptr _tmp732=({const char*_tmp366="expression may not be initialized";_tag_dyneither(_tmp366,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp733,_tmp732,_tag_dyneither(_tmp365,sizeof(void*),0U));});});{
...
union Cyc_CfFlowInfo_FlowInfo _tmp36C=_tmp36E;if((_tmp36C.BottomFL).tag == 1){_LL63: _LL64:
 return({struct _tuple18 _tmp619;_tmp619.f1=_tmp36E,_tmp619.f2=_tmp36D;_tmp619;});}else{_LL65: _LL66:
 return({struct _tuple18 _tmp61A;_tmp61A.f1=_tmp363,_tmp61A.f2=_tmp36D;_tmp61A;});}_LL62:;};};};}default: _LL55: _LL56:
# 1958
({void*_tmp372=0U;({struct _dyneither_ptr _tmp734=({const char*_tmp373="anal_Lexp: Subscript -- bad type";_tag_dyneither(_tmp373,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp734,_tag_dyneither(_tmp372,sizeof(void*),0U));});});}_LL50:;}case 21U: _LL1A: _tmp384=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp32D)->f1;_tmp383=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp32D)->f2;_LL1B: {
# 1962
...
return({struct _tuple18 _tmp61B;_tmp61B.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp735=Cyc_CfFlowInfo_UnknownL();_tmp61B.f2=_tmp735;});_tmp61B;});
# 1969
return({struct Cyc_NewControlFlow_AnalEnv*_tmp73C=env;union Cyc_CfFlowInfo_FlowInfo _tmp73B=inflow;int _tmp73A=expand_unique;int _tmp739=passthrough_consumes;struct Cyc_Absyn_Exp*_tmp738=_tmp384;Cyc_NewControlFlow_anal_Lexp_rec(_tmp73C,_tmp73B,_tmp73A,_tmp739,_tmp738,({struct Cyc_List_List*_tmp376=_cycalloc(sizeof(*_tmp376));
({void*_tmp737=(void*)({struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*_tmp375=_cycalloc(sizeof(*_tmp375));_tmp375->tag=0U,({int _tmp736=Cyc_CfFlowInfo_get_field_index(_tmp374,_tmp383);_tmp375->f1=_tmp736;});_tmp375;});_tmp376->hd=_tmp737;}),_tmp376->tl=path;_tmp376;}));});}default: _LL1C: _LL1D:
# 1973
 return({struct _tuple18 _tmp61C;({union Cyc_CfFlowInfo_FlowInfo _tmp73E=Cyc_CfFlowInfo_BottomFL();_tmp61C.f1=_tmp73E;}),({union Cyc_CfFlowInfo_AbsLVal _tmp73D=Cyc_CfFlowInfo_UnknownL();_tmp61C.f2=_tmp73D;});_tmp61C;});}_LL5:;};}
# 1977
...
return({struct _tuple18 _tmp61D;_tmp61D.f1=_tmp388,_tmp61D.f2=_tmp387;_tmp61D;});}
# 1988
...
union Cyc_CfFlowInfo_FlowInfo _tmp392=_tmp391;struct Cyc_Dict_Dict _tmp3C7;struct Cyc_List_List*_tmp3C6;if((_tmp392.BottomFL).tag == 1){_LL7: _LL8:
 return({struct _tuple19 _tmp61E;_tmp61E.f1=_tmp391,_tmp61E.f2=_tmp391;_tmp61E;});}else{_LL9: _tmp3C7=((_tmp392.ReachableFL).val).f1;_tmp3C6=((_tmp392.ReachableFL).val).f2;_LLA: {
# 2022
...
({void*_tmp395=0U;({unsigned int _tmp740=((struct Cyc_Absyn_Exp*)es->hd)->loc;struct _dyneither_ptr _tmp73F=({const char*_tmp396="expression may not be initialized";_tag_dyneither(_tmp396,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp740,_tmp73F,_tag_dyneither(_tmp395,sizeof(void*),0U));});});
...
({void*_tmp397=0U;({unsigned int _tmp742=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es->tl))->hd)->loc;struct _dyneither_ptr _tmp741=({const char*_tmp398="expression may not be initialized";_tag_dyneither(_tmp398,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp742,_tmp741,_tag_dyneither(_tmp397,sizeof(void*),0U));});});{
# 2029
...
struct _tuple0 _tmp39F=({struct _tuple0 _tmp61F;_tmp61F.f1=_tmp3B4,_tmp61F.f2=_tmp3B2;_tmp61F;});struct _tuple0 _tmp3A0=_tmp39F;enum Cyc_CfFlowInfo_InitLevel _tmp3B0;enum Cyc_CfFlowInfo_InitLevel _tmp3AF;switch(*((int*)_tmp3A0.f1)){case 2U: if(((struct Cyc_CfFlowInfo_Zero_CfFlowInfo_AbsRVal_struct*)_tmp3A0.f2)->tag == 0U){_LL12: _tmp3AF=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp3A0.f1)->f1;_LL13: {
# 2039
...
({void*_tmp3A4=0U;({struct _dyneither_ptr _tmp743=({const char*_tmp3A5="anal_test, zero-split";_tag_dyneither(_tmp3A5,sizeof(char),22U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp743,_tag_dyneither(_tmp3A4,sizeof(void*),0U));});});}_LL25:;}
# 2045
...
({void*_tmp3AB=0U;({struct _dyneither_ptr _tmp744=({const char*_tmp3AC="anal_test, zero-split";_tag_dyneither(_tmp3AC,sizeof(char),22U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp744,_tag_dyneither(_tmp3AB,sizeof(void*),0U));});});}_LL2F:;}
# 2053
...
goto _LL11;}else{goto _LL20;}default: _LL20: _LL21:
 goto _LL11;}_LL11:;};};}
# 2074
{struct _tuple27 _tmp3B5=({struct _tuple27 _tmp621;_tmp621.f1=p,({
void*_tmp746=Cyc_Tcutil_compress((void*)_check_null(_tmp393->topt));_tmp621.f2=_tmp746;}),({
void*_tmp745=Cyc_Tcutil_compress((void*)_check_null(_tmp394->topt));_tmp621.f3=_tmp745;});_tmp621;});
# 2074
...
# 2082
 ...
 return({struct _tuple19 _tmp620;_tmp620.f1=_tmp399,_tmp620.f2=_tmp39A;_tmp620;});}}}_LL36:;}
# 2087
{enum Cyc_Absyn_Primop _tmp3B7=p;switch(_tmp3B7){case Cyc_Absyn_Eq: _LL46: _LL47:
 ...
 return({struct _tuple19 _tmp622;_tmp622.f1=_tmp399,_tmp622.f2=_tmp39A;_tmp622;});}_LL45:;}{
# 2092
...
# 2103
struct Cyc_List_List*_tmp3BC=({struct _RegionHandle*_tmp74A=_tmp3B8;union Cyc_Relations_RelnOp _tmp749=n2;enum Cyc_Relations_Relation _tmp748=Cyc_Relations_flip_relation(_tmp3C4);union Cyc_Relations_RelnOp _tmp747=n1;Cyc_Relations_add_relation(_tmp74A,_tmp749,_tmp748,_tmp747,_tmp3C6);});
struct _tuple19 _tmp3BD=({struct _tuple19 _tmp627;_tmp627.f1=_tmp399,_tmp627.f2=_tmp39A;_tmp627;});struct _tuple19 _tmp3BE=_tmp3BD;struct Cyc_Dict_Dict _tmp3C2;struct Cyc_Dict_Dict _tmp3C1;struct Cyc_Dict_Dict _tmp3C0;struct Cyc_Dict_Dict _tmp3BF;if(((_tmp3BE.f1).ReachableFL).tag == 2){if(((_tmp3BE.f2).ReachableFL).tag == 2){_LL58: _tmp3C0=(((_tmp3BE.f1).ReachableFL).val).f1;_tmp3BF=(((_tmp3BE.f2).ReachableFL).val).f1;_LL59:
# 2106
 return({struct _tuple19 _tmp623;({union Cyc_CfFlowInfo_FlowInfo _tmp74C=Cyc_CfFlowInfo_ReachableFL(_tmp3C0,_tmp3BB);_tmp623.f1=_tmp74C;}),({union Cyc_CfFlowInfo_FlowInfo _tmp74B=Cyc_CfFlowInfo_ReachableFL(_tmp3BF,_tmp3BC);_tmp623.f2=_tmp74B;});_tmp623;});}else{_LL5C: _tmp3C1=(((_tmp3BE.f1).ReachableFL).val).f1;_LL5D:
# 2110
 return({struct _tuple19 _tmp624;({union Cyc_CfFlowInfo_FlowInfo _tmp74D=Cyc_CfFlowInfo_ReachableFL(_tmp3C1,_tmp3BB);_tmp624.f1=_tmp74D;}),_tmp624.f2=_tmp39A;_tmp624;});}}else{if(((_tmp3BE.f2).ReachableFL).tag == 2){_LL5A: _tmp3C2=(((_tmp3BE.f2).ReachableFL).val).f1;_LL5B:
# 2108
 return({struct _tuple19 _tmp625;_tmp625.f1=_tmp399,({union Cyc_CfFlowInfo_FlowInfo _tmp74E=Cyc_CfFlowInfo_ReachableFL(_tmp3C2,_tmp3BC);_tmp625.f2=_tmp74E;});_tmp625;});}else{_LL5E: _LL5F:
# 2112
 return({struct _tuple19 _tmp626;_tmp626.f1=_tmp399,_tmp626.f2=_tmp39A;_tmp626;});}}_LL57:;}else{
# 2115
return({struct _tuple19 _tmp628;_tmp628.f1=_tmp399,_tmp628.f2=_tmp39A;_tmp628;});}};};};}}_LL6:;};};}
# 2121
...
return({struct _tuple19 _tmp629;({union Cyc_CfFlowInfo_FlowInfo _tmp750=Cyc_CfFlowInfo_join_flow(_tmp3CC,_tmp3D8,_tmp3D6);_tmp629.f1=_tmp750;}),({
union Cyc_CfFlowInfo_FlowInfo _tmp74F=Cyc_CfFlowInfo_join_flow(_tmp3CC,_tmp3D7,_tmp3D5);_tmp629.f2=_tmp74F;});_tmp629;});};};}case 7U: _LL3: _tmp40B=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp3CE)->f1;_tmp40A=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp3CE)->f2;_LL4: {
# 2131
...
return({struct _tuple19 _tmp62A;_tmp62A.f1=_tmp3E0,({union Cyc_CfFlowInfo_FlowInfo _tmp751=Cyc_CfFlowInfo_join_flow(_tmp3CC,_tmp3E1,_tmp3DF);_tmp62A.f2=_tmp751;});_tmp62A;});};}case 8U: _LL5: _tmp40D=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp3CE)->f1;_tmp40C=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp3CE)->f2;_LL6: {
# 2135
...
return({struct _tuple19 _tmp62B;({union Cyc_CfFlowInfo_FlowInfo _tmp752=Cyc_CfFlowInfo_join_flow(_tmp3CC,_tmp3EA,_tmp3E8);_tmp62B.f1=_tmp752;}),_tmp62B.f2=_tmp3E7;_tmp62B;});};}case 9U: _LL7: _tmp40F=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp3CE)->f1;_tmp40E=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp3CE)->f2;_LL8: {
# 2139
...
return({struct _tuple19 _tmp62C;_tmp62C.f1=_tmp3F1,_tmp62C.f2=_tmp3F2;_tmp62C;});}}else{goto _LLB;}}else{goto _LLB;}}else{_LLB: _tmp412=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp3CE)->f1;_tmp411=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp3CE)->f2;_LLC:
# 2145
...
union Cyc_CfFlowInfo_FlowInfo _tmp3F5=_tmp406;struct Cyc_Dict_Dict _tmp404;if((_tmp3F5.BottomFL).tag == 1){_LL2E: _LL2F:
 return({struct _tuple19 _tmp62D;_tmp62D.f1=_tmp406,_tmp62D.f2=_tmp406;_tmp62D;});}else{_LL30: _tmp404=((_tmp3F5.ReachableFL).val).f1;_LL31: {
# 2153
...
# 2156
({void*_tmp3F9=0U;({struct _dyneither_ptr _tmp753=({const char*_tmp3FA="anal_test: bad namedlocation";_tag_dyneither(_tmp3FA,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp753,_tag_dyneither(_tmp3F9,sizeof(void*),0U));});});case 0U: _LL38: _LL39:
 return({struct _tuple19 _tmp62E;({union Cyc_CfFlowInfo_FlowInfo _tmp754=Cyc_CfFlowInfo_BottomFL();_tmp62E.f1=_tmp754;}),_tmp62E.f2=_tmp406;_tmp62E;});case 1U: _LL3A: _LL3B:
 goto _LL3D;case 5U: _LL3C: _LL3D:
 goto _LL3F;case 4U: _LL3E: _LL3F:
 return({struct _tuple19 _tmp62F;_tmp62F.f1=_tmp406,({union Cyc_CfFlowInfo_FlowInfo _tmp755=Cyc_CfFlowInfo_BottomFL();_tmp62F.f2=_tmp755;});_tmp62F;});case 2U: if(((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp3F8)->f1 == Cyc_CfFlowInfo_NoneIL){_LL40: _LL41:
...
# 2167
 return({struct _tuple19 _tmp630;_tmp630.f1=_tmp406,_tmp630.f2=_tmp406;_tmp630;});}case 7U: _LL44: _LL45:
# 2164
({void*_tmp3FB=0U;({unsigned int _tmp757=e->loc;struct _dyneither_ptr _tmp756=({const char*_tmp3FC="expression may not be initialized";_tag_dyneither(_tmp3FC,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp757,_tmp756,_tag_dyneither(_tmp3FB,sizeof(void*),0U));});});
return({struct _tuple19 _tmp631;({union Cyc_CfFlowInfo_FlowInfo _tmp759=Cyc_CfFlowInfo_BottomFL();_tmp631.f1=_tmp759;}),({union Cyc_CfFlowInfo_FlowInfo _tmp758=Cyc_CfFlowInfo_BottomFL();_tmp631.f2=_tmp758;});_tmp631;});default: _LL4A: _LL4B:
# 2168
({void*_tmp3FD=0U;({struct _dyneither_ptr _tmp75A=({const char*_tmp3FE="anal_test";_tag_dyneither(_tmp3FE,sizeof(char),10U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp75A,_tag_dyneither(_tmp3FD,sizeof(void*),0U));});});}_LL35:;};}}_LL2D:;};}}_LL0:;}struct _tuple28{unsigned int f1;struct Cyc_NewControlFlow_AnalEnv*f2;struct Cyc_Dict_Dict f3;};
# 2174
...
# 2186
({struct Cyc_String_pa_PrintArg_struct _tmp41A=({struct Cyc_String_pa_PrintArg_struct _tmp632;_tmp632.tag=0U,({struct _dyneither_ptr _tmp75B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp41C->name));_tmp632.f1=_tmp75B;});_tmp632;});void*_tmp418[1U];_tmp418[0]=& _tmp41A;({unsigned int _tmp75D=_tmp41F;struct _dyneither_ptr _tmp75C=({const char*_tmp419="unique pointers reachable from %s may become unreachable";_tag_dyneither(_tmp419,sizeof(char),57U);});Cyc_Warn_warn(_tmp75D,_tmp75C,_tag_dyneither(_tmp418,sizeof(void*),1U));});});
goto _LLB;}_LLB:;};}
# 2190
goto _LL3;}else{_LL6: _LL7:
 goto _LL3;}_LL3:;};}
...
if((int)({struct Cyc_CfFlowInfo_FlowEnv*_tmp75F=env->fenv;struct Cyc_Dict_Dict _tmp75E=_tmp425;Cyc_CfFlowInfo_initlevel(_tmp75F,_tmp75E,Cyc_CfFlowInfo_lookup_place(_tmp425,(struct Cyc_CfFlowInfo_Place*)_tmp421->hd));})!= (int)Cyc_CfFlowInfo_AllIL)
({void*_tmp422=0U;({unsigned int _tmp761=loc;struct _dyneither_ptr _tmp760=({const char*_tmp423="function may not initialize all the parameters with attribute 'initializes'";_tag_dyneither(_tmp423,sizeof(char),76U);});Cyc_CfFlowInfo_aerr(_tmp761,_tmp760,_tag_dyneither(_tmp422,sizeof(void*),0U));});});}}
# 2203
if(Cyc_NewControlFlow_warn_lose_unique){
struct _tuple28 _tmp424=({struct _tuple28 _tmp633;_tmp633.f1=loc,_tmp633.f2=env,_tmp633.f3=_tmp425;_tmp633;});
...
# 2230
return({struct _tuple1 _tmp634;_tmp634.f1=_tmp426,_tmp634.f2=_tmp427;_tmp634;});}struct _tuple29{int f1;void*f2;};
# 2236
...
({void*_tmp433=0U;({struct _dyneither_ptr _tmp762=({const char*_tmp434="noconsume_place_ok: flow became Bottom!";_tag_dyneither(_tmp434,sizeof(char),40U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp762,_tag_dyneither(_tmp433,sizeof(void*),0U));});});}else{_LL3: _tmp446=((_tmp432.ReachableFL).val).f1;_LL4: {
# 2251
...
if(!do_unconsume)
({struct Cyc_String_pa_PrintArg_struct _tmp43D=({struct Cyc_String_pa_PrintArg_struct _tmp635;_tmp635.tag=0U,({
# 2275
struct _dyneither_ptr _tmp763=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp635.f1=_tmp763;});_tmp635;});void*_tmp43B[1U];_tmp43B[0]=& _tmp43D;({unsigned int _tmp765=loc;struct _dyneither_ptr _tmp764=({const char*_tmp43C="function consumes parameter %s which is does not have the 'consume' attribute";_tag_dyneither(_tmp43C,sizeof(char),78U);});Cyc_CfFlowInfo_aerr(_tmp765,_tmp764,_tag_dyneither(_tmp43B,sizeof(void*),1U));});});}else{
# 2278
if((int)Cyc_CfFlowInfo_initlevel(env->fenv,_tmp446,_tmp439)!= (int)Cyc_CfFlowInfo_AllIL  && !do_unconsume)
({struct Cyc_String_pa_PrintArg_struct _tmp440=({struct Cyc_String_pa_PrintArg_struct _tmp636;_tmp636.tag=0U,({
# 2281
struct _dyneither_ptr _tmp766=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp636.f1=_tmp766;});_tmp636;});void*_tmp43E[1U];_tmp43E[0]=& _tmp440;({unsigned int _tmp768=loc;struct _dyneither_ptr _tmp767=({const char*_tmp43F="function consumes value pointed to by parameter %s, which does not have the 'consume' attribute";_tag_dyneither(_tmp43F,sizeof(char),96U);});Cyc_CfFlowInfo_aerr(_tmp768,_tmp767,_tag_dyneither(_tmp43E,sizeof(void*),1U));});});else{
# 2283
varok=1;}}}else{
# 2286
varok=1;}}else{
...
varok=1;else{
if(!do_unconsume)
({struct Cyc_String_pa_PrintArg_struct _tmp443=({struct Cyc_String_pa_PrintArg_struct _tmp637;_tmp637.tag=0U,({
# 2298
struct _dyneither_ptr _tmp769=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp637.f1=_tmp769;});_tmp637;});void*_tmp441[1U];_tmp441[0]=& _tmp443;({unsigned int _tmp76B=loc;struct _dyneither_ptr _tmp76A=({const char*_tmp442="function parameter %s without 'consume' attribute no longer set to its original value";_tag_dyneither(_tmp442,sizeof(char),86U);});Cyc_CfFlowInfo_aerr(_tmp76B,_tmp76A,_tag_dyneither(_tmp441,sizeof(void*),1U));});});}
goto _LL5;}_LL5:;}
# 2305
return({struct _tuple29 _tmp638;_tmp638.f1=varok,_tmp638.f2=_tmp439;_tmp638;});}}_LL0:;}
# 2311
...
if(_tmp44E != 0)
({void*_tmp448=0U;({struct _dyneither_ptr _tmp76C=({const char*_tmp449="unconsume_params: param to unconsume is non-variable";_tag_dyneither(_tmp449,sizeof(char),53U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp76C,_tag_dyneither(_tmp448,sizeof(void*),0U));});});{
...
({void*_tmp44B=0U;({struct _dyneither_ptr _tmp76D=({const char*_tmp44C="unconsume_params: root is not a varroot";_tag_dyneither(_tmp44C,sizeof(char),40U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp76D,_tag_dyneither(_tmp44B,sizeof(void*),0U));});});}_LL3:;};}
# 2330 "new_control_flow.cyc"
...
struct Cyc_CfFlowInfo_FlowEnv*_tmp76F=env->fenv;struct _tuple16 _tmp76E=({struct _tuple16 _tmp639;_tmp639.f1=_tmp466,_tmp639.f2=_tmp454;_tmp639;});Cyc_CfFlowInfo_join_flow_and_rval(_tmp76F,_tmp76E,({struct _tuple16 _tmp63A;_tmp63A.f1=_tmp466,_tmp63A.f2=ropt;_tmp63A;}));});
# 2375
...
# 2391
 flow=({struct Cyc_Dict_Dict _tmp770=Cyc_CfFlowInfo_assign_place(env->fenv,loc,_tmp45E,_tmp464,new_rval);Cyc_CfFlowInfo_ReachableFL(_tmp770,_tmp45D);});
# 2395
goto _LL15;}else{_LL18: _LL19:
# 2397
({void*_tmp45B=0U;({struct _dyneither_ptr _tmp771=({const char*_tmp45C="unconsume_params: joined flow became bot!";_tag_dyneither(_tmp45C,sizeof(char),42U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp771,_tag_dyneither(_tmp45B,sizeof(void*),0U));});});}_LL15:;}
# 2399
goto _LLD;}else{
# 2401
goto _LL11;}
...
({struct Cyc_String_pa_PrintArg_struct _tmp461=({struct Cyc_String_pa_PrintArg_struct _tmp63B;_tmp63B.tag=0U,({
struct _dyneither_ptr _tmp772=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(unconsume_exp));_tmp63B.f1=_tmp772;});_tmp63B;});void*_tmp45F[1U];_tmp45F[0]=& _tmp461;({unsigned int _tmp774=loc;struct _dyneither_ptr _tmp773=({const char*_tmp460="aliased expression %s was overwritten";_tag_dyneither(_tmp460,sizeof(char),38U);});Cyc_CfFlowInfo_aerr(_tmp774,_tmp773,_tag_dyneither(_tmp45F,sizeof(void*),1U));});});
# 2425 "new_control_flow.cyc"
goto _LLD;}_LLD:;}
# 2427
...
is_region_open?({struct _tuple29 _tmp63C;_tmp63C.f1=1,_tmp63C.f2=0;_tmp63C;}):
...
({struct Cyc_List_List*_tmp776=({struct Cyc_List_List*_tmp479=_cycalloc(sizeof(*_tmp479));
({struct _tuple30*_tmp775=({struct _tuple30*_tmp478=_cycalloc(sizeof(*_tmp478));_tmp478->f1=0,_tmp478->f2=_tmp486,_tmp478->f3=_tmp484,_tmp478->f4=_tmp483;_tmp478;});_tmp479->hd=_tmp775;}),_tmp479->tl=_tmp477;_tmp479;});
# 2497
env->unique_pat_vars=_tmp776;});
# 2500
if(_tmp487 != 0){
...
({void*_tmp47F=0U;({unsigned int _tmp778=_tmp486->loc;struct _dyneither_ptr _tmp777=({const char*_tmp480="switch clause may implicitly fallthru";_tag_dyneither(_tmp480,sizeof(char),38U);});Cyc_CfFlowInfo_aerr(_tmp778,_tmp777,_tag_dyneither(_tmp47F,sizeof(void*),0U));});});else{
# 2523
({void*_tmp481=0U;({unsigned int _tmp77A=_tmp486->loc;struct _dyneither_ptr _tmp779=({const char*_tmp482="switch clause may implicitly fallthru";_tag_dyneither(_tmp482,sizeof(char),38U);});Cyc_Warn_warn(_tmp77A,_tmp779,_tag_dyneither(_tmp481,sizeof(void*),0U));});});}
# 2525
...
if(Cyc_Tcutil_is_noalias_pointer_or_aggr(vd->type)){
# 2540
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct vdroot=({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp63E;_tmp63E.tag=0U,_tmp63E.f1=vd;_tmp63E;});
struct _tuple15 _tmp48A=Cyc_CfFlowInfo_unname_rval(({struct Cyc_Dict_Dict _tmp77B=_tmp493;((void*(*)(struct Cyc_Dict_Dict d,int(*cmp)(void*,void*),void*k))Cyc_Dict_lookup_other)(_tmp77B,Cyc_CfFlowInfo_root_cmp,(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp491=_cycalloc(sizeof(*_tmp491));*_tmp491=vdroot;_tmp491;}));}));struct _tuple15 _tmp48B=_tmp48A;void*_tmp490;_LL4: _tmp490=_tmp48B.f1;_LL5:;{
...
# 2547
({struct Cyc_String_pa_PrintArg_struct _tmp48F=({struct Cyc_String_pa_PrintArg_struct _tmp63D;_tmp63D.tag=0U,({struct _dyneither_ptr _tmp77C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp63D.f1=_tmp77C;});_tmp63D;});void*_tmp48D[1U];_tmp48D[0]=& _tmp48F;({unsigned int _tmp77E=_tmp492;struct _dyneither_ptr _tmp77D=({const char*_tmp48E="unique pointers may still exist after variable %s goes out of scope";_tag_dyneither(_tmp48E,sizeof(char),68U);});Cyc_Warn_warn(_tmp77E,_tmp77D,_tag_dyneither(_tmp48D,sizeof(void*),1U));});});
# 2549
goto _LL6;}_LL6:;};}}
# 2554
...
# 2557
struct _tuple31 _tmp496=({struct _tuple31 _tmp63F;_tmp63F.f1=env,_tmp63F.f2=_tmp4A1,_tmp63F.f3=decl->loc;_tmp63F;});
...
# 2609
 if(env->noreturn)
({void*_tmp4AD=0U;({unsigned int _tmp780=s->loc;struct _dyneither_ptr _tmp77F=({const char*_tmp4AE="`noreturn' function might return";_tag_dyneither(_tmp4AE,sizeof(char),33U);});Cyc_CfFlowInfo_aerr(_tmp780,_tmp77F,_tag_dyneither(_tmp4AD,sizeof(void*),0U));});});
...
# 2615
 if(env->noreturn)
({void*_tmp4AF=0U;({unsigned int _tmp782=s->loc;struct _dyneither_ptr _tmp781=({const char*_tmp4B0="`noreturn' function might return";_tag_dyneither(_tmp4B0,sizeof(char),33U);});Cyc_CfFlowInfo_aerr(_tmp782,_tmp781,_tag_dyneither(_tmp4AF,sizeof(void*),0U));});});{
...
# 2634
 return({struct Cyc_NewControlFlow_AnalEnv*_tmp785=env;union Cyc_CfFlowInfo_FlowInfo _tmp784=Cyc_NewControlFlow_anal_stmt(env,inflow,_tmp51F,0);struct Cyc_Absyn_Stmt*_tmp783=_tmp51E;Cyc_NewControlFlow_anal_stmt(_tmp785,_tmp784,_tmp783,rval_opt);});case 4U: _LLE: _tmp522=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp4AC)->f1;_tmp521=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp4AC)->f2;_tmp520=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp4AC)->f3;_LLF: {
# 2637
...
if(_tmp4E9 != 0){
_tmp4EB=({struct Cyc_CfFlowInfo_FlowEnv*_tmp78B=_tmp4AA;struct Cyc_NewControlFlow_AnalEnv*_tmp78A=env;union Cyc_CfFlowInfo_FlowInfo _tmp789=_tmp4EB;struct Cyc_Absyn_Vardecl*_tmp788=*_tmp4E9;struct Cyc_Absyn_Exp*_tmp787=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp530))->hd;void*_tmp786=(void*)((struct Cyc_List_List*)_check_null(_tmp4EA))->hd;Cyc_NewControlFlow_do_initialize_var(_tmp78B,_tmp78A,_tmp789,_tmp788,_tmp787,_tmp786,s->loc);});
_tmp4EA=_tmp4EA->tl;
_tmp530=_tmp530->tl;}}}
# 2698
...
# 2862
({void*_tmp51A=0U;({struct _dyneither_ptr _tmp78C=({const char*_tmp51B="anal_stmt: bad stmt syntax or unimplemented stmt form";_tag_dyneither(_tmp51B,sizeof(char),54U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp78C,_tag_dyneither(_tmp51A,sizeof(void*),0U));});});}case 6U: _LL18: _LL19:
# 2704
...
({void*_tmp4ED=0U;({unsigned int _tmp78E=s->loc;struct _dyneither_ptr _tmp78D=({const char*_tmp4EE="break may cause function not to return a value";_tag_dyneither(_tmp4EE,sizeof(char),47U);});Cyc_Warn_warn(_tmp78E,_tmp78D,_tag_dyneither(_tmp4ED,sizeof(void*),0U));});});else{
# 2712
({void*_tmp4EF=0U;({unsigned int _tmp790=s->loc;struct _dyneither_ptr _tmp78F=({const char*_tmp4F0="break may cause function not to return a value";_tag_dyneither(_tmp4F0,sizeof(char),47U);});Cyc_CfFlowInfo_aerr(_tmp790,_tmp78F,_tag_dyneither(_tmp4EF,sizeof(void*),0U));});});}}
# 2714
goto _LL55;}else{_LL58: _LL59:
 goto _LL55;}_LL55:;}
# 2717
if(env->noreturn)
({void*_tmp4F1=0U;({unsigned int _tmp792=s->loc;struct _dyneither_ptr _tmp791=({const char*_tmp4F2="`noreturn' function might return";_tag_dyneither(_tmp4F2,sizeof(char),33U);});Cyc_CfFlowInfo_aerr(_tmp792,_tmp791,_tag_dyneither(_tmp4F1,sizeof(void*),0U));});});
Cyc_NewControlFlow_check_init_params(s->loc,env,inflow);
Cyc_NewControlFlow_unconsume_params(env,env->noconsume_params,0,0,inflow,s->loc);
...
if(_tmp4F3 == 0)
({void*_tmp4F4=0U;({unsigned int _tmp794=s->loc;struct _dyneither_ptr _tmp793=({const char*_tmp4F5="jump has no target (should be impossible)";_tag_dyneither(_tmp4F5,sizeof(char),42U);});Cyc_CfFlowInfo_aerr(_tmp794,_tmp793,_tag_dyneither(_tmp4F4,sizeof(void*),0U));});});
...
{union Cyc_CfFlowInfo_FlowInfo _tmp4F6=scs_outflow;if((_tmp4F6.BottomFL).tag == 1){_LL5B: _LL5C:
 goto _LL5A;}else{_LL5D: _LL5E:
({void*_tmp4F7=0U;({unsigned int _tmp796=s->loc;struct _dyneither_ptr _tmp795=({const char*_tmp4F8="last catch clause may implicitly fallthru";_tag_dyneither(_tmp4F8,sizeof(char),42U);});Cyc_CfFlowInfo_aerr(_tmp796,_tmp795,_tag_dyneither(_tmp4F7,sizeof(void*),0U));});});}_LL5A:;}
# 2760
outflow=s1_outflow;
# 2762
...
# 2776
({struct Cyc_List_List*_tmp798=({struct Cyc_List_List*_tmp4FD=_cycalloc(sizeof(*_tmp4FD));
({struct _tuple30*_tmp797=({struct _tuple30*_tmp4FC=_cycalloc(sizeof(*_tmp4FC));_tmp4FC->f1=0,_tmp4FC->f2=s,_tmp4FC->f3=_tmp4FF,_tmp4FC->f4=_tmp4FE;_tmp4FC;});_tmp4FD->hd=_tmp797;}),_tmp4FD->tl=_tmp4FB;_tmp4FD;});
# 2776
env->unique_pat_vars=_tmp798;});
# 2781
...
# 2801
struct Cyc_List_List l=({struct Cyc_List_List _tmp641;_tmp641.hd=_tmp53D,_tmp641.tl=0;_tmp641;});
...
# 2832
 goto _LL68;}_LL68:;}{
# 2835
struct Cyc_List_List _tmp514=({struct Cyc_List_List _tmp640;_tmp640.hd=_tmp53E,_tmp640.tl=0;_tmp640;});
...
({struct Cyc_List_List*_tmp79A=({struct Cyc_List_List*_tmp517=_cycalloc(sizeof(*_tmp517));({struct _tuple30*_tmp799=({struct _tuple30*_tmp516=_cycalloc(sizeof(*_tmp516));_tmp516->f1=1,_tmp516->f2=s,_tmp516->f3=_tmp505,_tmp516->f4=_tmp506;_tmp516;});_tmp517->hd=_tmp799;}),_tmp517->tl=_tmp515;_tmp517;});env->unique_pat_vars=_tmp79A;});
# 2844
...
# 2855
 outflow=({struct Cyc_NewControlFlow_AnalEnv*_tmp79D=env;union Cyc_CfFlowInfo_FlowInfo _tmp79C=Cyc_NewControlFlow_anal_decl(env,inflow,_tmp540);struct Cyc_Absyn_Stmt*_tmp79B=_tmp53F;Cyc_NewControlFlow_anal_stmt(_tmp79D,_tmp79C,_tmp79B,rval_opt);});
if(Cyc_NewControlFlow_warn_lose_unique)
...
# 2878
 if((int)_tmp554->sc == (int)Cyc_Absyn_Static)
return inflow;{
# 2883
struct Cyc_List_List _tmp547=({struct Cyc_List_List _tmp642;_tmp642.hd=_tmp554,_tmp642.tl=0;_tmp642;});
...
# 2900
return({struct Cyc_CfFlowInfo_FlowEnv*_tmp7A1=_tmp544;union Cyc_CfFlowInfo_FlowInfo _tmp7A0=inflow;struct Cyc_List_List*_tmp79F=({struct Cyc_List_List*_tmp54E=_cycalloc(sizeof(*_tmp54E));_tmp54E->hd=_tmp54D,_tmp54E->tl=0;_tmp54E;});void*_tmp79E=_tmp544->unknown_all;Cyc_NewControlFlow_add_vars(_tmp7A1,_tmp7A0,_tmp79F,_tmp79E,decl->loc,0);});};case 4U: _LL7: _tmp559=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp546)->f1;_tmp558=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp546)->f2;_tmp557=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp546)->f3;_LL8:
# 2903
 if(_tmp557 != 0)
({void*_tmp54F=0U;({struct _dyneither_ptr _tmp7A2=({const char*_tmp550="found open expression in declaration!";_tag_dyneither(_tmp550,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp7A2,_tag_dyneither(_tmp54F,sizeof(void*),0U));});});{
struct Cyc_List_List _tmp551=({struct Cyc_List_List _tmp643;_tmp643.hd=_tmp558,_tmp643.tl=0;_tmp643;});
return Cyc_NewControlFlow_add_vars(_tmp544,inflow,& _tmp551,_tmp544->unknown_all,decl->loc,0);};default: _LL9: _LLA:
# 2909
({void*_tmp552=0U;({struct _dyneither_ptr _tmp7A3=({const char*_tmp553="anal_decl: unexpected decl variant";_tag_dyneither(_tmp553,sizeof(char),35U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp7A3,_tag_dyneither(_tmp552,sizeof(void*),0U));});});}_LL0:;}
# 2917
...
({struct Cyc_JumpAnalysis_Jump_Anal_Result*_tmp7A6=tables;struct Cyc_CfFlowInfo_FlowEnv*_tmp7A5=fenv;union Cyc_CfFlowInfo_FlowInfo _tmp7A4=Cyc_CfFlowInfo_ReachableFL(fenv->mt_flowdict,0);Cyc_NewControlFlow_check_nested_fun(_tmp7A6,_tmp7A5,_tmp7A4,fd);});}
# 2919
...
struct _dyneither_ptr _tmp565=({unsigned int _tmp572=(unsigned int)_tmp564;int*_tmp571=({struct _RegionHandle*_tmp7A7=r;_region_malloc(_tmp7A7,_check_times(_tmp572,sizeof(int)));});({{unsigned int _tmp644=(unsigned int)_tmp564;unsigned int i;for(i=0;i < _tmp644;++ i){_tmp571[i]=0;}}0;});_tag_dyneither(_tmp571,sizeof(int),_tmp572);});
...
_tmp59A=({struct _RegionHandle*_tmp7AB=Cyc_Core_heap_region;union Cyc_Relations_RelnOp _tmp7AA=Cyc_NewControlFlow_translate_rop(_tmp576,_tmp578->rop1);enum Cyc_Relations_Relation _tmp7A9=_tmp578->relation;union Cyc_Relations_RelnOp _tmp7A8=
Cyc_NewControlFlow_translate_rop(_tmp576,_tmp578->rop2);
# 2990
Cyc_Relations_add_relation(_tmp7AB,_tmp7AA,_tmp7A9,_tmp7A8,_tmp59A);});}}{
# 2996
...
({void*_tmp57B=0U;({struct _dyneither_ptr _tmp7AC=({const char*_tmp57C="check_fun: non-function type cached with fndecl_t";_tag_dyneither(_tmp57C,sizeof(char),50U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp7AC,_tag_dyneither(_tmp57B,sizeof(void*),0U));});});}_LL3:;}{
# 3001
...
void*_tmp581=({
struct Cyc_CfFlowInfo_FlowEnv*_tmp7AF=fenv;void*_tmp7AE=elttype;struct Cyc_Absyn_Exp*_tmp7AD=bogus_exp;Cyc_CfFlowInfo_make_unique_consumed(_tmp7AF,_tmp7AE,_tmp7AD,- 1,
...
_tmp59B=({struct Cyc_Dict_Dict _tmp7B1=_tmp59B;void*_tmp7B0=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp584=_cycalloc(sizeof(*_tmp584));_tmp584->tag=0U,_tmp584->f1=_tmp580;_tmp584;});((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp7B1,_tmp7B0,(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp585=_cycalloc(sizeof(*_tmp585));_tmp585->tag=4U,_tmp585->f1=_tmp583;_tmp585;}));});
...
_tmp59B=({struct Cyc_Dict_Dict _tmp7B3=_tmp59B;void*_tmp7B2=(void*)_tmp589;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp7B3,_tmp7B2,Cyc_CfFlowInfo_typ_to_absrval(fenv,elttype,0,fenv->esc_none));});
_tmp59B=({struct Cyc_Dict_Dict _tmp7B5=_tmp59B;void*_tmp7B4=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp58B=_cycalloc(sizeof(*_tmp58B));_tmp58B->tag=0U,_tmp58B->f1=_tmp588;_tmp58B;});((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp7B5,_tmp7B4,(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp58C=_cycalloc(sizeof(*_tmp58C));_tmp58C->tag=4U,_tmp58C->f1=_tmp58A;_tmp58C;}));});
...
# 3059
if(noreturn)
({void*_tmp593=0U;({unsigned int _tmp7B9=_tmp573;struct _dyneither_ptr _tmp7B8=({const char*_tmp594="`noreturn' function might (implicitly) return";_tag_dyneither(_tmp594,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp7B9,_tmp7B8,_tag_dyneither(_tmp593,sizeof(void*),0U));});});else{
...
({void*_tmp595=0U;({unsigned int _tmp7BB=_tmp573;struct _dyneither_ptr _tmp7BA=({const char*_tmp596="function may not return a value";_tag_dyneither(_tmp596,sizeof(char),32U);});Cyc_Warn_warn(_tmp7BB,_tmp7BA,_tag_dyneither(_tmp595,sizeof(void*),0U));});});else{
# 3066
({void*_tmp597=0U;({unsigned int _tmp7BD=_tmp573;struct _dyneither_ptr _tmp7BC=({const char*_tmp598="function may not return a value";_tag_dyneither(_tmp598,sizeof(char),32U);});Cyc_CfFlowInfo_aerr(_tmp7BD,_tmp7BC,_tag_dyneither(_tmp597,sizeof(void*),0U));});});}goto _LLF;}}
# 3068
goto _LLF;}_LLF:;};};};};};};}
# 3072
void Cyc_NewControlFlow_cf_check(struct Cyc_JumpAnalysis_Jump_Anal_Result*tables,struct Cyc_List_List*ds){
