...
struct _tuple16 _T3E9=Cyc_NewControlFlow_anal_Lexp(env,inflow,1,0,e);union Cyc_CfFlowInfo_AbsLVal _T3EA;union Cyc_CfFlowInfo_FlowInfo _T3EB;_T3EB=_T3E9.f0;_T3EA=_T3E9.f1;{union Cyc_CfFlowInfo_FlowInfo flval=_T3EB;union Cyc_CfFlowInfo_AbsLVal lval=_T3EA;{struct _tuple16 _T3EC;
_T3EC.f0=flval;_T3EC.f1=lval;_TF=_T3EC;}{struct _tuple16 _T3EC=_TF;struct Cyc_CfFlowInfo_Place*_T3ED;struct Cyc_Dict_Dict _T3EE;_T10=_T3EC.f0;_T11=_T10.ReachableFL;_T12=_T11.tag;if(_T12!=2)goto _TLDC;_T13=_T3EC.f1;_T14=_T13.PlaceL;_T15=_T14.tag;if(_T15!=1)goto _TLDE;_T16=_T3EC.f0;_T17=_T16.ReachableFL;_T3EE=_T17.val;_T18=_T3EC.f1;_T19=_T18.PlaceL;_T3ED=_T19.val;{struct Cyc_Dict_Dict fd=_T3EE;struct Cyc_CfFlowInfo_Place*p=_T3ED;
# 828
...
_tag_fat("expression attempts to copy a consumed alias-free value",sizeof(char),56U);_T23=_tag_fat(0U,sizeof(void*),0);Cyc_CfFlowInfo_aerr(_T21,_T22,_T23);{struct _tuple14 _T3EF;
_T3EF.f0=Cyc_CfFlowInfo_BottomFL();_T25=fenv;_T3EF.f1=_T25->unknown_all;_T24=_T3EF;}return _T24;
# 834
_TLE0: _T26=needs_unconsume;if(!_T26)goto _TLE2;{struct _tuple14 _T3EF;
# 836
_T3EF.f0=flval;_T3EF.f1=Cyc_CfFlowInfo_make_unique_unconsumed(fenv,old_rval);_T27=_T3EF;}return _T27;
# 839
...
struct Cyc_Dict_Dict outdict=Cyc_CfFlowInfo_assign_place(_T32,_T34,_T35,_T36,_T37);{struct _tuple14 _T3EF;
# 851
_T3EF.f0=Cyc_CfFlowInfo_ReachableFL(outdict);_T3EF.f1=old_rval;_T38=_T3EF;}return _T38;}}}_TLDE: goto _LLB;_TLDC: _LLB: goto _LL8;_LL8:;}}}goto _TLDB;_TLDA: _TLDB: _T39=e;{
# 858
void*_T3E9=_T39->r;struct Cyc_Absyn_Stmt*_T3EA;enum Cyc_Absyn_AggrKind _T3EB;struct _fat_ptr*_T3EC;struct Cyc_Absyn_Exp*_T3ED;void**_T3EE;enum Cyc_Absyn_MallocKind _T3EF;struct Cyc_List_List*_T3F0;struct Cyc_Absyn_Exp*_T3F1;enum Cyc_Absyn_Primop _T3F2;struct Cyc_Absyn_Datatypedecl*_T3F3;int _T3F4;struct _fat_ptr _T3F5;void*_T3F6;_T3A=(int*)_T3E9;_T3B=*_T3A;switch(_T3B){case 14: _T3C=(struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_T3E9;_T3D=_T3C->f4;if(_T3D!=Cyc_Absyn_Null_to_NonNull)goto _TLE5;{struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;
# 862
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,inflow,e1,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f1=_T3F9;void*r1=_T3F8;
struct _tuple14 _T3FA=Cyc_NewControlFlow_anal_derefR(env,inflow,f1,e1,r1,0);void*_T3FB;union Cyc_CfFlowInfo_FlowInfo _T3FC;_T3FC=_T3FA.f0;_T3FB=_T3FA.f1;{union Cyc_CfFlowInfo_FlowInfo f2=_T3FC;void*r2=_T3FB;{struct _tuple14 _T3FD;
_T3FD.f0=f2;_T3FD.f1=r1;_T3E=_T3FD;}return _T3E;}}}_TLE5:{struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;_T3F6=e1;goto _LL13;}case 12:{struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;}_LL13: {struct Cyc_Absyn_Exp*e1=_T3F6;_T3F6=e1;goto _LL15;}case 40:{struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;}_LL15: {struct Cyc_Absyn_Exp*e1=_T3F6;_T3F6=e1;goto _LL17;}case 13:{struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;}_LL17: {struct Cyc_Absyn_Exp*e1=_T3F6;_T3F=
# 871
Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,inflow,e1,local_alias);return _T3F;}case 2:{struct Cyc_Absyn_Pragma_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Pragma_e_Absyn_Raw_exp_struct*)_T3E9;_T3F5=_T3F7->f1;}{struct _fat_ptr p=_T3F5;_T40=p;_T41=
# 874
_tag_fat("print_flow",sizeof(char),11U);_T42=Cyc_NewControlFlow_strcmp(_T40,_T41);if(_T42)goto _TLE7;else{goto _TLE9;}
_TLE9: _T43=e;_T44=_T43->loc;{struct _fat_ptr seg_str=Cyc_Position_string_of_segment(_T44);{struct Cyc_String_pa_PrintArg_struct _T3F7;_T3F7.tag=0;
_T3F7.f1=seg_str;_T45=_T3F7;}{struct Cyc_String_pa_PrintArg_struct _T3F7=_T45;void*_T3F8[1];_T3F8[0]=& _T3F7;_T46=Cyc_stderr;_T47=_tag_fat("%s: current flow is\n",sizeof(char),21U);_T48=_tag_fat(_T3F8,sizeof(void*),1);Cyc_fprintf(_T46,_T47,_T48);}
...
# 885
_TLEA: _T4F=p;_T50=_tag_fat("debug_off",sizeof(char),10U);_T51=Cyc_NewControlFlow_strcmp(_T4F,_T50);if(_T51)goto _TLED;else{goto _TLEF;}_TLEF: goto _TLEE;_TLED: _TLEE: _TLEB: _TLE8:{struct _tuple14 _T3F7;
# 893
_T3F7.f0=inflow;_T53=fenv;_T3F7.f1=_T53->zero;_T52=_T3F7;}return _T52;}case 39: goto _LL1D;case 0: _T54=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_T3E9;_T55=_T54->f1;_T56=_T55.Wstring_c;_T57=_T56.tag;switch(_T57){case 1: _LL1D: goto _LL1F;case 5: _T58=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_T3E9;_T59=_T58->f1;_T5A=_T59.Int_c;_T5B=_T5A.val;_T5C=_T5B.f1;if(_T5C!=0)goto _TLF1;_LL1F:{struct _tuple14 _T3F7;
# 897
_T3F7.f0=inflow;_T5E=fenv;_T3F7.f1=_T5E->zero;_T5D=_T3F7;}return _T5D;_TLF1: goto _LL23;case 8: _LL23: goto _LL25;case 9: _LL25: goto _LL27;default: _LL2D: goto _LL2F;};case 1: _T5F=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_T3E9;_T60=_T5F->f1;_T61=(int*)_T60;_T62=*_T61;switch(_T62){case 2: _LL27:{struct _tuple14 _T3F7;
# 901
_T3F7.f0=inflow;_T64=fenv;_T3F7.f1=_T64->notzeroall;_T63=_T3F7;}return _T63;case 1:{struct _tuple14 _T3F7;
# 918
_T3F7.f0=inflow;_T66=fenv;_T67=e;_T68=_T67->topt;_T69=_check_null(_T68);_T6A=fenv;_T6B=_T6A->unknown_all;_T3F7.f1=Cyc_CfFlowInfo_typ_to_absrval(_T66,_T69,0,_T6B);_T65=_T3F7;}return _T65;case 4:{struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_T3E9;_T6C=_T3F7->f1;{struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_T3F8=(struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)_T6C;_T3F6=_T3F8->f1;}}{struct Cyc_Absyn_Vardecl*vd=_T3F6;_T6D=vd;_T6E=_T6D->sc;_T6F=(int)_T6E;
# 923
if(_T6F!=0)goto _TLF4;{struct _tuple14 _T3F7;
_T3F7.f0=inflow;_T71=fenv;_T72=e;_T73=_T72->topt;_T74=_check_null(_T73);_T75=fenv;_T76=_T75->unknown_all;_T3F7.f1=Cyc_CfFlowInfo_typ_to_absrval(_T71,_T74,0,_T76);_T70=_T3F7;}return _T70;_TLF4: _T3F6=vd;goto _LL3F;}case 3:{struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_T3E9;_T77=_T3F7->f1;{struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_T3F8=(struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)_T77;_T3F6=_T3F8->f1;}}_LL3F: {struct Cyc_Absyn_Vardecl*vd=_T3F6;_T3F6=vd;goto _LL41;}case 5:{struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_T3E9;_T78=_T3F7->f1;{struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*_T3F8=(struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*)_T78;_T3F6=_T3F8->f1;}}_LL41: {struct Cyc_Absyn_Vardecl*vd=_T3F6;{struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _T3F7;_T3F7.tag=0;
# 930
_T3F7.f1=vd;_T79=_T3F7;}{struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct vdroot=_T79;{struct _tuple14 _T3F7;
_T3F7.f0=inflow;_T7B=d;_T7C=Cyc_CfFlowInfo_root_cmp;{struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_T3F8=_cycalloc(sizeof(struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct));*_T3F8=vdroot;_T7D=(struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*)_T3F8;}_T7E=(void*)_T7D;_T3F7.f1=Cyc_Dict_lookup_other(_T7B,_T7C,_T7E);_T7A=_T3F7;}return _T7A;}}default: goto _LL7B;};case 41:{struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F4=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;int static_only=_T3F4;_T7F=static_only;
# 904
if(!_T7F)goto _TLF6;goto _LL2B;_TLF6: {
struct _tuple17 _T3F7=Cyc_NewControlFlow_anal_test(env,inflow,e1);union Cyc_CfFlowInfo_FlowInfo _T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f1t=_T3F9;union Cyc_CfFlowInfo_FlowInfo f1f=_T3F8;{struct _tuple14 _T3FA;
_T3FA.f0=f1t;_T81=fenv;_T3FA.f1=_T81->notzeroall;_T80=_T3FA;}return _T80;}}}case 30: _T82=(struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_T3E9;_T83=_T82->f1;if(_T83!=0)goto _TLF8;_LL2B: goto _LL2D;_TLF8:{struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F3=_T3F7->f2;}{struct Cyc_List_List*es=_T3F6;struct Cyc_Absyn_Datatypedecl*tud=_T3F3;
# 1399
struct _tuple21 _T3F7=Cyc_NewControlFlow_anal_Rexps(env,inflow,es,1,1);struct Cyc_List_List*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;struct Cyc_List_List*rvals=_T3F8;_T84=
Cyc_List_length(es);_T85=_T84 + 1;{unsigned sz=(unsigned)_T85;{unsigned _T3FA=sz;_T88=_check_times(_T3FA,sizeof(void*));{void**_T3FB=_cycalloc(_T88);{unsigned _T3FC=sz;unsigned i;i=0;_TLFD: if(i < _T3FC)goto _TLFB;else{goto _TLFC;}_TLFB: _T89=i;_T8A=fenv;
_T3FB[_T89]=_T8A->unknown_none;i=i + 1;goto _TLFD;_TLFC:;}_T87=(void**)_T3FB;}_T86=_tag_fat(_T87,sizeof(void*),_T3FA);}{struct _fat_ptr aggrdict=_T86;_T8B=aggrdict;_T8C=_check_fat_subscript(_T8B,sizeof(void*),0);_T8D=(void**)_T8C;_T8E=fenv;
...
# 1403
i=i + 1;_T95=rvals;rvals=_T95->tl;goto _TL101;_TL100:;}{struct _tuple14 _T3FA;
# 1405
_T3FA.f0=f;{struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_T3FB=_cycalloc(sizeof(struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct));_T3FB->tag=6;_T3FB->f1.is_union=0;_T3FB->f1.fieldnum=-1;_T3FB->f2=aggrdict;_T97=(struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_T3FB;}_T3FA.f1=(void*)_T97;_T96=_T3FA;}return _T96;}}}}case 42: _LL2F: goto _LL31;case 18: _LL31: goto _LL33;case 17: _LL33: goto _LL35;case 19: _LL35: goto _LL37;case 32: _LL37: goto _LL39;case 31: _LL39:{struct _tuple14 _T3F7;
# 915
_T3F7.f0=inflow;_T99=fenv;_T3F7.f1=_T99->unknown_all;_T98=_T3F7;}return _T98;case 3:{struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_T3E9;_T3F2=_T3F7->f1;_T3F6=_T3F7->f2;}{enum Cyc_Absyn_Primop p=_T3F2;struct Cyc_List_List*es=_T3F6;_T9A=p;_T9B=(int)_T9A;
# 937
if(_T9B!=19)goto _TL102;_T9C=env;_T9D=inflow;_T9E=
# 940
_check_null(es);_T9F=_T9E->hd;_TA0=(struct Cyc_Absyn_Exp*)_T9F;_TA1=local_alias;{struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(_T9C,0,_T9D,_TA0,_TA1);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;void*r=_T3F8;_TA2=env;_TA3=inflow;_TA4=f;_TA5=es;_TA6=_TA5->hd;_TA7=(struct Cyc_Absyn_Exp*)_TA6;_TA8=r;{
struct _tuple14 _T3FA=Cyc_NewControlFlow_anal_derefR(_TA2,_TA3,_TA4,_TA7,_TA8,0);void*_T3FB;union Cyc_CfFlowInfo_FlowInfo _T3FC;_T3FC=_T3FA.f0;_T3FB=_T3FA.f1;{union Cyc_CfFlowInfo_FlowInfo f2=_T3FC;void*r2=_T3FB;_TA9=env;_TAA=es;_TAB=_TAA->hd;_TAC=(struct Cyc_Absyn_Exp*)_TAB;_TAD=_TAC->loc;_TAE=f2;_TAF=r;
f2=Cyc_NewControlFlow_use_Rval(_TA9,_TAD,_TAE,_TAF);{struct _tuple14 _T3FD;
_T3FD.f0=f2;_TB1=env;_TB2=_TB1->fenv;_T3FD.f1=_TB2->unknown_all;_TB0=_T3FD;}return _TB0;}}}}
# 945
_TL102: {struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_use_ints(env,inflow,es);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;void*r=_T3F8;{struct _tuple14 _T3FA;
_T3FA.f0=f;_T3FA.f1=r;_TB3=_T3FA;}return _TB3;}}}case 5:{struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;}{struct Cyc_Absyn_Exp*e1=_T3F6;{struct Cyc_List_List _T3F7;
# 949
_T3F7.hd=e1;_T3F7.tl=0;_TB4=_T3F7;}{struct Cyc_List_List arg=_TB4;_TB5=env;_TB6=inflow;_TB7=& arg;_TB8=(struct Cyc_List_List*)_TB7;{
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_use_ints(_TB5,_TB6,_TB8);union Cyc_CfFlowInfo_FlowInfo _T3F8;_T3F8=_T3F7.f0;{union Cyc_CfFlowInfo_FlowInfo f=_T3F8;
struct _tuple16 _T3F9=Cyc_NewControlFlow_anal_Lexp(env,f,0,0,e1);union Cyc_CfFlowInfo_AbsLVal _T3FA;_T3FA=_T3F9.f1;{union Cyc_CfFlowInfo_AbsLVal lval=_T3FA;_TB9=e1;_TBA=_TB9->topt;_TBB=
_check_null(_TBA);{int iszt=Cyc_Tcutil_is_zeroterm_pointer_type(_TBB);_TBC=iszt;
if(!_TBC)goto _TL104;{
# 956
struct _tuple14 _T3FB=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_T3FC;union Cyc_CfFlowInfo_FlowInfo _T3FD;_T3FD=_T3FB.f0;_T3FC=_T3FB.f1;{union Cyc_CfFlowInfo_FlowInfo g=_T3FD;void*r=_T3FC;
Cyc_NewControlFlow_anal_derefR(env,inflow,g,e1,r,0);}}goto _TL105;_TL104: _TL105:{struct _tuple23 _T3FB;
# 959
_T3FB.f0=lval;_T3FB.f1=f;_TBD=_T3FB;}{struct _tuple23 _T3FB=_TBD;struct Cyc_Dict_Dict _T3FC;struct Cyc_CfFlowInfo_Place*_T3FD;_TBE=_T3FB.f0;_TBF=_TBE.PlaceL;_TC0=_TBF.tag;if(_TC0!=1)goto _TL106;_TC1=_T3FB.f1;_TC2=_TC1.ReachableFL;_TC3=_TC2.tag;if(_TC3!=2)goto _TL108;_TC4=_T3FB.f0;_TC5=_TC4.PlaceL;_T3FD=_TC5.val;_TC6=_T3FB.f1;_TC7=_TC6.ReachableFL;_T3FC=_TC7.val;{struct Cyc_CfFlowInfo_Place*p=_T3FD;struct Cyc_Dict_Dict outdict=_T3FC;_TC8=fenv;_TC9=e1;_TCA=_TC9->loc;_TCB=outdict;_TCC=p;_TCD=fenv;_TCE=_TCD->unknown_all;_TCF=
# 961
...
# 968
if(!_TD0)goto _TL10A;{struct _tuple14 _T3FB;
_T3FB.f0=f;_TD2=fenv;_T3FB.f1=_TD2->notzeroall;_TD1=_T3FB;}return _TD1;
_TL10A:{struct _tuple14 _T3FB;_T3FB.f0=f;_TD4=fenv;_T3FB.f1=_TD4->unknown_all;_TD3=_T3FB;}return _TD3;}}}}}}case 4: _TD5=(struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_T3E9;_TD6=_TD5->f2;if(_TD6==0)goto _TL10C;{struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F1=_T3F7->f3;}{struct Cyc_Absyn_Exp*l=_T3F6;struct Cyc_Absyn_Exp*r=_T3F1;_TD7=copy_ctxt;
# 973
...
_tag_fat("cannot track alias-free pointers through multiple assignments",sizeof(char),62U);_TE1=_tag_fat(0U,sizeof(void*),0);Cyc_CfFlowInfo_aerr(_TDF,_TE0,_TE1);{struct _tuple14 _T3F7;
_T3F7.f0=Cyc_CfFlowInfo_BottomFL();_TE3=fenv;_T3F7.f1=_TE3->unknown_all;_TE2=_T3F7;}return _TE2;_TL10E: {
# 977
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,r,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo right_out=_T3F9;void*rval=_T3F8;
struct _tuple16 _T3FA=Cyc_NewControlFlow_anal_Lexp(env,right_out,0,0,l);union Cyc_CfFlowInfo_AbsLVal _T3FB;union Cyc_CfFlowInfo_FlowInfo _T3FC;_T3FC=_T3FA.f0;_T3FB=_T3FA.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3FC;union Cyc_CfFlowInfo_AbsLVal lval=_T3FB;{struct Cyc_Dict_Dict _T3FD;_TE4=f;_TE5=_TE4.ReachableFL;_TE6=_TE5.tag;if(_TE6!=2)goto _TL110;_TE7=f;_TE8=_TE7.ReachableFL;_T3FD=_TE8.val;{struct Cyc_Dict_Dict outdict=_T3FD;{struct Cyc_CfFlowInfo_Place*_T3FE;_TE9=lval;_TEA=_TE9.PlaceL;_TEB=_TEA.tag;if(_TEB!=1)goto _TL112;_TEC=lval;_TED=_TEC.PlaceL;_T3FE=_TED.val;{struct Cyc_CfFlowInfo_Place*p=_T3FE;_TEE=fenv;_TEF=l;_TF0=_TEF->loc;_TF1=outdict;_TF2=p;_TF3=fenv;_TF4=_TF3->unknown_all;
# 985
outdict=Cyc_CfFlowInfo_assign_place(_TEE,_TF0,_TF1,_TF2,_TF4);
# 987
f=Cyc_CfFlowInfo_ReachableFL(outdict);goto _LLAB;}_TL112: goto _LLAB;_LLAB:;}goto _LLA6;}_TL110: goto _LLA6;_LLA6:;}{struct _tuple14 _T3FD;
# 999
_T3FD.f0=f;_TF6=fenv;_T3FD.f1=_TF6->unknown_all;_TF5=_T3FD;}return _TF5;}}}}_TL10C:{struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F1=_T3F7->f3;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct Cyc_Absyn_Exp*e2=_T3F1;_TF7=copy_ctxt;
# 1002
...
_tag_fat("cannot track alias-free pointers through multiple assignments",sizeof(char),62U);_T101=_tag_fat(0U,sizeof(void*),0);Cyc_CfFlowInfo_aerr(_TFF,_T100,_T101);{struct _tuple14 _T3F7;
_T3F7.f0=Cyc_CfFlowInfo_BottomFL();_T103=fenv;_T3F7.f1=_T103->unknown_all;_T102=_T3F7;}return _T102;_TL114: _T104=env;_T105=inflow;{struct Cyc_Absyn_Exp*_T3F7[2];
# 1008
_T3F7[0]=e1;_T3F7[1]=e2;_T107=_tag_fat(_T3F7,sizeof(struct Cyc_Absyn_Exp*),2);_T106=Cyc_List_list(_T107);}inflow=Cyc_NewControlFlow_expand_unique_places(_T104,_T105,_T106);{
# 1010
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,e2,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo right_out=_T3F9;void*rval=_T3F8;
struct _tuple16 _T3FA=Cyc_NewControlFlow_anal_Lexp(env,right_out,0,0,e1);union Cyc_CfFlowInfo_AbsLVal _T3FB;union Cyc_CfFlowInfo_FlowInfo _T3FC;_T3FC=_T3FA.f0;_T3FB=_T3FA.f1;{union Cyc_CfFlowInfo_FlowInfo outflow=_T3FC;union Cyc_CfFlowInfo_AbsLVal lval=_T3FB;_T108=fenv;_T109=env;_T10A=outflow;_T10B=e1;_T10C=lval;_T10D=e2;_T10E=rval;_T10F=e;_T110=_T10F->loc;{
struct _tuple14 _T3FD=Cyc_NewControlFlow_do_assign(_T108,_T109,_T10A,_T10B,_T10C,_T10D,_T10E,_T110);void*_T3FE;union Cyc_CfFlowInfo_FlowInfo _T3FF;_T3FF=_T3FD.f0;_T3FE=_T3FD.f1;{union Cyc_CfFlowInfo_FlowInfo outflow=_T3FF;void*rval=_T3FE;{struct _tuple14 _T400;
# 1016
_T400.f0=outflow;_T400.f1=rval;_T111=_T400;}return _T111;}}}}}}case 9:{struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F1=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct Cyc_Absyn_Exp*e2=_T3F1;
# 1019
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;void*r=_T3F8;_T112=
Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,f,e2,local_alias);return _T112;}}case 11:{struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;}{struct Cyc_Absyn_Exp*e1=_T3F6;
# 1023
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,e1,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;void*r=_T3F8;_T113=env;_T114=e1;_T115=_T114->loc;_T116=f;_T117=r;
Cyc_NewControlFlow_use_Rval(_T113,_T115,_T116,_T117);{struct _tuple14 _T3FA;
_T3FA.f0=Cyc_CfFlowInfo_BottomFL();_T119=fenv;_T11A=e;_T11B=_T11A->topt;_T11C=_check_null(_T11B);_T11D=fenv;_T11E=_T11D->unknown_all;_T3FA.f1=Cyc_CfFlowInfo_typ_to_absrval(_T119,_T11C,0,_T11E);_T118=_T3FA;}return _T118;}}case 10:{struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F0=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct Cyc_List_List*es=_T3F0;
# 1028
struct Cyc_List_List*orig_es=es;
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f1=_T3F9;void*r1=_T3F8;
# 1031
Cyc_NewControlFlow_anal_derefR(env,inflow,f1,e1,r1,0);_T11F=env;_T120=f1;_T121=
# 1034
Cyc_List_copy(es);{struct _tuple21 _T3FA=Cyc_NewControlFlow_anal_Rexps(_T11F,_T120,_T121,1,1);struct Cyc_List_List*_T3FB;union Cyc_CfFlowInfo_FlowInfo _T3FC;_T3FC=_T3FA.f0;_T3FB=_T3FA.f1;{union Cyc_CfFlowInfo_FlowInfo fst_outflow=_T3FC;struct Cyc_List_List*rvals=_T3FB;_T122=env;_T123=e1;_T124=_T123->loc;_T125=fst_outflow;_T126=r1;{
# 1036
...
_check_null(_T128);{void*_T3FD=Cyc_Absyn_compress(_T129);void*_T3FE;_T12A=(int*)_T3FD;_T12B=*_T12A;if(_T12B!=4)goto _TL116;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T3FF=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T3FD;_T12C=_T3FF->f1;_T3FE=_T12C.elt_type;}{void*t=_T3FE;{
# 1043
void*_T3FF=Cyc_Absyn_compress(t);struct Cyc_List_List*_T400;_T12D=(int*)_T3FF;_T12E=*_T12D;if(_T12E!=6)goto _TL118;{struct Cyc_Absyn_FnType_Absyn_Type_struct*_T401=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T3FF;_T12F=_T401->f1;_T400=_T12F.attributes;}{struct Cyc_List_List*atts=_T400;
# 1045
_TL11D: if(atts!=0)goto _TL11B;else{goto _TL11C;}
# 1047
_TL11B: _T130=atts;{void*_T401=_T130->hd;int _T402;_T131=(int*)_T401;_T132=*_T131;switch(_T132){case 20:{struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*_T403=(struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_T401;_T402=_T403->f1;}{int i=_T402;{struct Cyc_List_List*_T403=_cycalloc(sizeof(struct Cyc_List_List));_T134=i;
# 1049
_T403->hd=(void*)_T134;_T403->tl=init_params;_T133=(struct Cyc_List_List*)_T403;}init_params=_T133;goto _LLCF;}case 21:{struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*_T403=(struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*)_T401;_T402=_T403->f1;}{int i=_T402;{struct Cyc_List_List*_T403=_cycalloc(sizeof(struct Cyc_List_List));_T136=i;
# 1051
_T403->hd=(void*)_T136;_T403->tl=nolive_unique_params;_T135=(struct Cyc_List_List*)_T403;}nolive_unique_params=_T135;{struct Cyc_List_List*_T403=_cycalloc(sizeof(struct Cyc_List_List));_T138=i;
_T403->hd=(void*)_T138;_T403->tl=consume_params;_T137=(struct Cyc_List_List*)_T403;}consume_params=_T137;goto _LLCF;}case 22:{struct Cyc_Absyn_Consume_att_Absyn_Attribute_struct*_T403=(struct Cyc_Absyn_Consume_att_Absyn_Attribute_struct*)_T401;_T402=_T403->f1;}{int i=_T402;{struct Cyc_List_List*_T403=_cycalloc(sizeof(struct Cyc_List_List));_T13A=i;
# 1055
_T403->hd=(void*)_T13A;_T403->tl=consume_params;_T139=(struct Cyc_List_List*)_T403;}consume_params=_T139;goto _LLCF;}default: goto _LLCF;}_LLCF:;}_T13B=atts;
# 1045
atts=_T13B->tl;goto _TL11D;_TL11C: goto _LLCA;}_TL118: _T13D=Cyc_Warn_impos;{
# 1060
int(*_T401)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T13D;_T13C=_T401;}_T13E=_tag_fat("anal_Rexp: bad function type",sizeof(char),29U);_T13F=_tag_fat(0U,sizeof(void*),0);_T13C(_T13E,_T13F);_LLCA:;}goto _LLC5;}_TL116: _T141=Cyc_Warn_impos;{
# 1063
int(*_T3FF)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T141;_T140=_T3FF;}_T142=_tag_fat("anal_Rexp: bad function type",sizeof(char),29U);_T143=_tag_fat(0U,sizeof(void*),0);_T140(_T142,_T143);_LLC5:;}{
# 1065
int i=1;_TL122: if(rvals!=0)goto _TL120;else{goto _TL121;}
_TL120: _T145=Cyc_List_memq;{int(*_T3FD)(struct Cyc_List_List*,int)=(int(*)(struct Cyc_List_List*,int))_T145;_T144=_T3FD;}_T146=_T144(init_params,i);if(!_T146)goto _TL123;{struct Cyc_Dict_Dict _T3FD;_T147=fst_outflow;_T148=_T147.BottomFL;_T149=_T148.tag;if(_T149!=1)goto _TL125;goto _LLD8;_TL125: _T14A=fst_outflow;_T14B=_T14A.ReachableFL;_T3FD=_T14B.val;{struct Cyc_Dict_Dict fst_d=_T3FD;_T14C=rvals;_T14D=_T14C->hd;{
# 1070
struct _tuple13 _T3FE=Cyc_CfFlowInfo_unname_rval(_T14D);void*_T3FF;_T3FF=_T3FE.f0;{void*r=_T3FF;_T14E=env;_T14F=_T14E->fenv;_T150=fst_d;_T151=rvals;_T152=_T151->hd;_T153=
...
_TL129: _T158=es;_T159=_T158->hd;_T15A=(struct Cyc_Absyn_Exp*)_T159;_T15B=_T15A->loc;_T15C=_tag_fat("expression may not be initialized",sizeof(char),34U);_T15D=_tag_fat(0U,sizeof(void*),0);Cyc_CfFlowInfo_aerr(_T15B,_T15C,_T15D);goto _TL128;_TL127: _TL128:{struct Cyc_Dict_Dict _T400;_T15E=outflow;_T15F=_T15E.BottomFL;_T160=_T15F.tag;if(_T160!=1)goto _TL12A;goto _LLE0;_TL12A: _T161=outflow;_T162=_T161.ReachableFL;_T400=_T162.val;{struct Cyc_Dict_Dict d=_T400;_T163=fenv;_T164=d;_T165=rvals;_T166=_T165->hd;{
# 1078
struct Cyc_Dict_Dict ans_d=Cyc_CfFlowInfo_escape_deref(_T163,_T164,_T166);_T167=rvals;{
void*_T401=_T167->hd;struct Cyc_CfFlowInfo_Place*_T402;_T168=(int*)_T401;_T169=*_T168;switch(_T169){case 4:{struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_T403=(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_T401;_T402=_T403->f1;}{struct Cyc_CfFlowInfo_Place*p=_T402;_T16A=es;_T16B=_T16A->hd;_T16C=(struct Cyc_Absyn_Exp*)_T16B;_T16D=_T16C->topt;{
# 1081
void*_T403=Cyc_Absyn_compress(_T16D);void*_T404;_T16E=(int*)_T403;_T16F=*_T16E;if(_T16F!=4)goto _TL12D;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T405=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T403;_T170=_T405->f1;_T404=_T170.elt_type;}{void*t=_T404;_T171=fenv;_T172=es;_T173=_T172->hd;_T174=(struct Cyc_Absyn_Exp*)_T173;_T175=_T174->loc;_T176=ans_d;_T177=p;_T178=fenv;_T179=t;_T17A=fenv;_T17B=_T17A->esc_all;_T17C=
# 1084
...
# 1088
int(*_T405)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T17E;_T17D=_T405;}_T17F=_tag_fat("anal_Rexp:bad type for initialized arg",sizeof(char),39U);_T180=_tag_fat(0U,sizeof(void*),0);_T17D(_T17F,_T180);_LLEC:;}goto _LLE5;}case 5: _T182=Cyc_Warn_impos;{
# 1092
int(*_T403)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T182;_T181=_T403;}_T183=
...
# 1102
_TL123: _T186=Cyc_List_memq;{int(*_T3FD)(struct Cyc_List_List*,int)=(int(*)(struct Cyc_List_List*,int))_T186;_T185=_T3FD;}_T187=_T185(nolive_unique_params,i);if(!_T187)goto _TL12F;_T188=env;_T189=
# 1107
...
int(*_T3FD)(struct Cyc_List_List*,int)=(int(*)(struct Cyc_List_List*,int))_T19E;_T19D=_T3FD;}_T19F=_T19D(consume_params,i);if(_T19F)goto _TL131;else{goto _TL133;}_TL133: _T1A0=env;_T1A1=_T1A0->aquals_bounds;_T1A2=es;_T1A3=_T1A2->hd;_T1A4=(struct Cyc_Absyn_Exp*)_T1A3;_T1A5=_T1A4->topt;_T1A6=
...
# 1127
_check_null(_T1B6);_T1B8=Cyc_Atts_is_noreturn_fn_type(_T1B7);if(!_T1B8)goto _TL134;{struct _tuple14 _T3FD;
_T3FD.f0=Cyc_CfFlowInfo_BottomFL();_T1BA=fenv;_T1BB=e;_T1BC=_T1BB->topt;_T1BD=_check_null(_T1BC);_T1BE=fenv;_T1BF=_T1BE->unknown_all;_T3FD.f1=Cyc_CfFlowInfo_typ_to_absrval(_T1BA,_T1BD,0,_T1BF);_T1B9=_T3FD;}return _T1B9;
# 1130
_TL134:{struct _tuple14 _T3FD;_T3FD.f0=outflow;_T1C1=fenv;_T1C2=e;_T1C3=_T1C2->topt;_T1C4=_check_null(_T1C3);_T1C5=fenv;_T1C6=_T1C5->unknown_all;_T3FD.f1=Cyc_CfFlowInfo_typ_to_absrval(_T1C1,_T1C4,0,_T1C6);_T1C0=_T3FD;}return _T1C0;}}}}}case 33:{struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_T3E9;_T1C7=_T3F7->f1;_T3EF=_T1C7.mknd;_T1C8=_T3F7->f1;_T3F6=_T1C8.rgn;_T1C9=_T3F7->f1;_T3F1=_T1C9.aqual;_T1CA=_T3F7->f1;_T3EE=_T1CA.elt_type;_T1CB=_T3F7->f1;_T3ED=_T1CB.num_elts;_T1CC=_T3F7->f1;_T3F4=_T1CC.fat_result;}{enum Cyc_Absyn_MallocKind mknd=_T3EF;struct Cyc_Absyn_Exp*ropt=_T3F6;struct Cyc_Absyn_Exp*aqopt=_T3F1;void**topt=_T3EE;struct Cyc_Absyn_Exp*exp=_T3ED;int isfat=_T3F4;
# 1133
...
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,exp,local_alias);union Cyc_CfFlowInfo_FlowInfo _T3F8;_T3F8=_T3F7.f0;{union Cyc_CfFlowInfo_FlowInfo f=_T3F8;
...
if(!_T1DE)goto _TL13C;{struct Cyc_List_List*_T3F7=_cycalloc(sizeof(struct Cyc_List_List));
_T3F7->hd=aqopt;_T3F7->tl=expl;_T1DF=(struct Cyc_List_List*)_T3F7;}expl=_T1DF;goto _TL13D;_TL13C: _TL13D: _T1E0=ropt;_T1E1=(unsigned)_T1E0;
# 1147
if(!_T1E1)goto _TL13E;{struct Cyc_List_List*_T3F7=_cycalloc(sizeof(struct Cyc_List_List));
_T3F7->hd=ropt;_T3F7->tl=expl;_T1E2=(struct Cyc_List_List*)_T3F7;}expl=_T1E2;goto _TL13F;_TL13E: _TL13F: {
# 1150
struct _tuple21 _T3F7=Cyc_NewControlFlow_anal_Rexps(env,inflow,expl,1,1);struct Cyc_List_List*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;struct Cyc_List_List*rvals=_T3F8;
outflow=f;}}}_TL13B: _T1E3=env;_T1E4=_T1E3->aquals_bounds;_T1E5=e;_T1E6=_T1E5->topt;_T1E7=
# 1155
_check_null(_T1E6);_T1E8=Cyc_Tcutil_is_noalias_pointer(_T1E4,_T1E7,1);if(!_T1E8)goto _TL140;{struct _tuple14 _T3F7;
_T3F7.f0=outflow;{struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_T3F8=_cycalloc(sizeof(struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct));_T3F8->tag=5;_T3F8->f1=place_val;_T1EA=(struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_T3F8;}_T3F7.f1=(void*)_T1EA;_T1E9=_T3F7;}return _T1E9;
# 1159
_TL140:{struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_T3F7=_cycalloc(sizeof(struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct));_T3F7->tag=1;_T3F7->f1=exp;_T1EC=e;_T1ED=_T1EC->topt;_T3F7->f2=_check_null(_T1ED);_T1EB=(struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_T3F7;}{void*root=(void*)_T1EB;
struct Cyc_CfFlowInfo_Place*place;place=_cycalloc(sizeof(struct Cyc_CfFlowInfo_Place));_T1EE=place;_T1EE->root=root;_T1EF=place;_T1EF->path=0;{struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_T3F7=_cycalloc(sizeof(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct));_T3F7->tag=4;
_T3F7->f1=place;_T1F0=(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_T3F7;}{void*rval=(void*)_T1F0;struct Cyc_Dict_Dict _T3F7;_T1F1=outflow;_T1F2=_T1F1.BottomFL;_T1F3=_T1F2.tag;if(_T1F3!=1)goto _TL142;{struct _tuple14 _T3F8;
# 1163
_T3F8.f0=outflow;_T3F8.f1=rval;_T1F4=_T3F8;}return _T1F4;_TL142: _T1F5=outflow;_T1F6=_T1F5.ReachableFL;_T3F7=_T1F6.val;{struct Cyc_Dict_Dict d2=_T3F7;{struct _tuple14 _T3F8;_T1F8=
# 1165
Cyc_Dict_insert(d2,root,place_val);_T3F8.f0=Cyc_CfFlowInfo_ReachableFL(_T1F8);_T3F8.f1=rval;_T1F7=_T3F8;}return _T1F7;};}};}}case 34:{struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F1=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct Cyc_Absyn_Exp*e2=_T3F1;
# 1170
void*left_rval;
void*right_rval;
union Cyc_CfFlowInfo_FlowInfo outflow;_T1F9=env;_T1FA=inflow;{struct Cyc_Absyn_Exp*_T3F7[2];
# 1176
_T3F7[0]=e1;_T3F7[1]=e2;_T1FC=_tag_fat(_T3F7,sizeof(struct Cyc_Absyn_Exp*),2);_T1FB=Cyc_List_list(_T1FC);}{struct _tuple21 _T3F7=Cyc_NewControlFlow_anal_Rexps(_T1F9,_T1FA,_T1FB,0,0);struct Cyc_List_List*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;struct Cyc_List_List*rvals=_T3F8;_T1FD=
...
# 1201
struct _tuple16 _T3FA=Cyc_NewControlFlow_anal_Lexp(env,outflow,0,0,e1);union Cyc_CfFlowInfo_AbsLVal _T3FB;_T3FB=_T3FA.f1;{union Cyc_CfFlowInfo_AbsLVal left_lval=_T3FB;
struct _tuple16 _T3FC=Cyc_NewControlFlow_anal_Lexp(env,outflow,0,0,e2);union Cyc_CfFlowInfo_AbsLVal _T3FD;_T3FD=_T3FC.f1;{union Cyc_CfFlowInfo_AbsLVal right_lval=_T3FD;{struct Cyc_Dict_Dict _T3FE;_T219=outflow;_T21A=_T219.ReachableFL;_T21B=_T21A.tag;if(_T21B!=2)goto _TL14C;_T21C=outflow;_T21D=_T21C.ReachableFL;_T3FE=_T21D.val;{struct Cyc_Dict_Dict outdict=_T3FE;{struct Cyc_CfFlowInfo_Place*_T3FF;_T21E=left_lval;_T21F=_T21E.PlaceL;_T220=_T21F.tag;if(_T220!=1)goto _TL14E;_T221=left_lval;_T222=_T221.PlaceL;_T3FF=_T222.val;{struct Cyc_CfFlowInfo_Place*lp=_T3FF;_T223=fenv;_T224=e1;_T225=_T224->loc;_T226=outdict;_T227=lp;_T228=right_rval;
# 1207
...
_tag_fat("expression may not be fully initialized",sizeof(char),40U);_T22E=_tag_fat(0U,sizeof(void*),0);Cyc_CfFlowInfo_aerr(_T22C,_T22D,_T22E);goto _TL151;_TL150: _TL151: goto _LL114;_LL114:;}{struct Cyc_CfFlowInfo_Place*_T3FF;_T22F=right_lval;_T230=_T22F.PlaceL;_T231=_T230.tag;if(_T231!=1)goto _TL152;_T232=right_lval;_T233=_T232.PlaceL;_T3FF=_T233.val;{struct Cyc_CfFlowInfo_Place*rp=_T3FF;_T234=fenv;_T235=e2;_T236=_T235->loc;_T237=outdict;_T238=rp;_T239=left_rval;
# 1219
...
Cyc_NewControlFlow_update_tryflow(env,outflow);goto _LL10F;}_TL14C: goto _LL10F;_LL10F:;}{struct _tuple14 _T3FE;
# 1235
_T3FE.f0=outflow;_T241=fenv;_T3FE.f1=_T241->unknown_all;_T240=_T3FE;}return _T240;}}}}}}}case 16:{struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F1=_T3F7->f2;_T3ED=_T3F7->f3;}{struct Cyc_Absyn_Exp*eopt=_T3F6;struct Cyc_Absyn_Exp*e2=_T3F1;struct Cyc_Absyn_Exp*qopt=_T3ED;
# 1238
union Cyc_CfFlowInfo_FlowInfo outflow;
void*place_val;
if(eopt!=0)goto _TL156;if(qopt!=0)goto _TL156;{
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,e2,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;void*r=_T3F8;
outflow=f;
...
if(!_T245)goto _TL158;{struct Cyc_List_List*_T3F7=_cycalloc(sizeof(struct Cyc_List_List));
_T3F7->hd=qopt;_T3F7->tl=expl;_T246=(struct Cyc_List_List*)_T3F7;}expl=_T246;
depth=depth + 1;goto _TL159;_TL158: _TL159: _T247=eopt;_T248=(unsigned)_T247;
# 1252
if(!_T248)goto _TL15A;{struct Cyc_List_List*_T3F7=_cycalloc(sizeof(struct Cyc_List_List));
_T3F7->hd=eopt;_T3F7->tl=expl;_T249=(struct Cyc_List_List*)_T3F7;}expl=_T249;
...
# 1261
_check_null(_T256);_T258=Cyc_Tcutil_is_noalias_pointer(_T254,_T257,1);if(!_T258)goto _TL15E;{struct _tuple14 _T3F7;
_T3F7.f0=outflow;{struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_T3F8=_cycalloc(sizeof(struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct));_T3F8->tag=5;_T3F8->f1=place_val;_T25A=(struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_T3F8;}_T3F7.f1=(void*)_T25A;_T259=_T3F7;}return _T259;
# 1265
_TL15E:{struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_T3F7=_cycalloc(sizeof(struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct));_T3F7->tag=1;_T3F7->f1=e2;_T25C=e;_T25D=_T25C->topt;_T3F7->f2=_check_null(_T25D);_T25B=(struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_T3F7;}{void*root=(void*)_T25B;
struct Cyc_CfFlowInfo_Place*place;place=_cycalloc(sizeof(struct Cyc_CfFlowInfo_Place));_T25E=place;_T25E->root=root;_T25F=place;_T25F->path=0;{struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_T3F7=_cycalloc(sizeof(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct));_T3F7->tag=4;
_T3F7->f1=place;_T260=(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_T3F7;}{void*rval=(void*)_T260;struct Cyc_Dict_Dict _T3F7;_T261=outflow;_T262=_T261.BottomFL;_T263=_T262.tag;if(_T263!=1)goto _TL160;{struct _tuple14 _T3F8;
# 1269
_T3F8.f0=outflow;_T3F8.f1=rval;_T264=_T3F8;}return _T264;_TL160: _T265=outflow;_T266=_T265.ReachableFL;_T3F7=_T266.val;{struct Cyc_Dict_Dict d2=_T3F7;{struct _tuple14 _T3F8;_T268=
# 1271
Cyc_Dict_insert(d2,root,place_val);_T3F8.f0=Cyc_CfFlowInfo_ReachableFL(_T268);_T3F8.f1=rval;_T267=_T3F8;}return _T267;};}};}case 15:{struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;}{struct Cyc_Absyn_Exp*e1=_T3F6;
# 1276
struct _tuple16 _T3F7=Cyc_NewControlFlow_anal_Lexp(env,inflow,0,0,e1);union Cyc_CfFlowInfo_AbsLVal _T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;union Cyc_CfFlowInfo_AbsLVal l=_T3F8;struct Cyc_CfFlowInfo_Place*_T3FA;_T269=l;_T26A=_T269.UnknownL;_T26B=_T26A.tag;if(_T26B!=2)goto _TL162;{struct _tuple14 _T3FB;
# 1278
_T3FB.f0=f;_T26D=fenv;_T3FB.f1=_T26D->notzeroall;_T26C=_T3FB;}return _T26C;_TL162: _T26E=l;_T26F=_T26E.PlaceL;_T3FA=_T26F.val;{struct Cyc_CfFlowInfo_Place*p=_T3FA;{struct _tuple14 _T3FB;
_T3FB.f0=f;{struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_T3FC=_cycalloc(sizeof(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct));_T3FC->tag=4;_T3FC->f1=p;_T271=(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_T3FC;}_T3FB.f1=(void*)_T271;_T270=_T3FB;}return _T270;};}}case 20:{struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;}{struct Cyc_Absyn_Exp*e1=_T3F6;
# 1283
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;void*r=_T3F8;_T272=
Cyc_NewControlFlow_anal_derefR(env,inflow,f,e1,r,0);return _T272;}}case 21:{struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3EC=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct _fat_ptr*field=_T3EC;
# 1287
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;void*r=_T3F8;_T273=e1;_T274=_T273->topt;{
void*e1_type=_check_null(_T274);_T275=
# 1290
Cyc_Absyn_is_nontagged_nonrequire_union_type(e1_type);if(!_T275)goto _TL164;{struct _tuple14 _T3FA;
_T3FA.f0=f;_T277=fenv;_T278=e;_T279=_T278->topt;_T27A=_check_null(_T279);_T27B=fenv;_T27C=_T27B->unknown_all;_T3FA.f1=Cyc_CfFlowInfo_typ_to_absrval(_T277,_T27A,0,_T27C);_T276=_T3FA;}return _T276;_TL164: _T27D=
...
struct _tuple13 _T3FA=Cyc_CfFlowInfo_unname_rval(r);void*_T3FB;_T3FB=_T3FA.f0;{void*r=_T3FB;struct _fat_ptr _T3FC;int _T3FD;int _T3FE;_T283=r;_T284=(int*)_T283;_T285=*_T284;if(_T285!=6)goto _TL168;_T286=r;{struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_T3FF=(struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_T286;_T287=_T3FF->f1;_T3FE=_T287.is_union;_T288=_T3FF->f1;_T3FD=_T288.fieldnum;_T3FC=_T3FF->f2;}{int is_union=_T3FE;int fnum=_T3FD;struct _fat_ptr rdict=_T3FC;_T289=e1;_T28A=_T289->topt;_T28B=
# 1297
_check_null(_T28A);_T28C=field;{int field_no=Cyc_CfFlowInfo_get_field_index(_T28B,_T28C);_T28D=is_union;
if(!_T28D)goto _TL16A;if(fnum==-1)goto _TL16A;if(fnum==field_no)goto _TL16A;{struct _tuple14 _T3FF;
_T3FF.f0=f;_T28F=fenv;_T290=e;_T291=_T290->topt;_T292=_check_null(_T291);_T293=fenv;_T294=_T293->unknown_none;_T3FF.f1=Cyc_CfFlowInfo_typ_to_absrval(_T28F,_T292,1,_T294);_T28E=_T3FF;}return _T28E;_TL16A:{struct _tuple14 _T3FF;
_T3FF.f0=f;_T296=rdict;_T297=field_no;_T298=_check_fat_subscript(_T296,sizeof(void*),_T297);_T299=(void**)_T298;_T3FF.f1=*_T299;_T295=_T3FF;}return _T295;}}_TL168: _T29A=Cyc_stderr;_T29B=
# 1302
_tag_fat("the bad rexp is :",sizeof(char),18U);_T29C=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T29A,_T29B,_T29C);
Cyc_CfFlowInfo_print_absrval(r);{struct Cyc_String_pa_PrintArg_struct _T3FF;_T3FF.tag=0;
_T3FF.f1=Cyc_Absynpp_exp2string(e);_T29D=_T3FF;}{struct Cyc_String_pa_PrintArg_struct _T3FF=_T29D;void*_T400[1];_T400[0]=& _T3FF;_T29F=Cyc_Warn_impos;{int(*_T401)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T29F;_T29E=_T401;}_T2A0=_tag_fat("\nanal_Rexp: AggrMember: %s",sizeof(char),27U);_T2A1=_tag_fat(_T400,sizeof(void*),1);_T29E(_T2A0,_T2A1);};}}}}}case 37:{struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3EC=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct _fat_ptr*field=_T3EC;
# 1310
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;void*r=_T3F8;_T2A2=e1;_T2A3=_T2A2->topt;_T2A4=
# 1312
_check_null(_T2A3);_T2A5=Cyc_Absyn_is_nontagged_nonrequire_union_type(_T2A4);if(!_T2A5)goto _TL16C;{struct _tuple14 _T3FA;
_T3FA.f0=f;_T2A7=fenv;_T3FA.f1=_T2A7->unknown_all;_T2A6=_T3FA;}return _T2A6;_TL16C: {
struct _tuple13 _T3FA=Cyc_CfFlowInfo_unname_rval(r);void*_T3FB;_T3FB=_T3FA.f0;{void*r=_T3FB;struct _fat_ptr _T3FC;int _T3FD;int _T3FE;_T2A8=r;_T2A9=(int*)_T2A8;_T2AA=*_T2A9;if(_T2AA!=6)goto _TL16E;_T2AB=r;{struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_T3FF=(struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_T2AB;_T2AC=_T3FF->f1;_T3FE=_T2AC.is_union;_T2AD=_T3FF->f1;_T3FD=_T2AD.fieldnum;_T3FC=_T3FF->f2;}{int is_union=_T3FE;int fnum=_T3FD;struct _fat_ptr rdict=_T3FC;_T2AE=e1;_T2AF=_T2AE->topt;_T2B0=
# 1317
_check_null(_T2AF);_T2B1=field;{int field_no=Cyc_CfFlowInfo_get_field_index(_T2B0,_T2B1);_T2B2=is_union;
if(!_T2B2)goto _TL170;if(fnum==-1)goto _TL170;
if(fnum==field_no)goto _TL172;{struct _tuple14 _T3FF;
_T3FF.f0=f;_T2B4=fenv;_T3FF.f1=_T2B4->zero;_T2B3=_T3FF;}return _T2B3;
# 1322
_TL172:{struct _tuple14 _T3FF;_T3FF.f0=f;_T2B6=fenv;_T3FF.f1=_T2B6->notzeroall;_T2B5=_T3FF;}return _T2B5;
# 1324
_TL170:{struct _tuple14 _T3FF;_T3FF.f0=f;_T2B8=fenv;_T3FF.f1=_T2B8->unknown_all;_T2B7=_T3FF;}return _T2B7;}}_TL16E:{struct Cyc_String_pa_PrintArg_struct _T3FF;_T3FF.tag=0;
# 1326
_T3FF.f1=Cyc_Absynpp_exp2string(e);_T2B9=_T3FF;}{struct Cyc_String_pa_PrintArg_struct _T3FF=_T2B9;void*_T400[1];_T400[0]=& _T3FF;_T2BB=Cyc_Warn_impos;{int(*_T401)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T2BB;_T2BA=_T401;}_T2BC=_tag_fat("anal_Rexp: TagCheck_e: %s",sizeof(char),26U);_T2BD=_tag_fat(_T400,sizeof(void*),1);_T2BA(_T2BC,_T2BD);};}}}}case 22:{struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3EC=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct _fat_ptr*field=_T3EC;
# 1330
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f1=_T3F9;void*r1=_T3F8;
# 1333
struct _tuple14 _T3FA=Cyc_NewControlFlow_anal_derefR(env,inflow,f1,e1,r1,0);void*_T3FB;union Cyc_CfFlowInfo_FlowInfo _T3FC;_T3FC=_T3FA.f0;_T3FB=_T3FA.f1;{union Cyc_CfFlowInfo_FlowInfo f2=_T3FC;void*r2=_T3FB;_T2BE=e1;_T2BF=_T2BE->topt;_T2C0=
# 1336
_check_null(_T2BF);{void*_T3FD=Cyc_Absyn_compress(_T2C0);void*_T3FE;_T2C1=(int*)_T3FD;_T2C2=*_T2C1;if(_T2C2!=4)goto _TL174;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T3FF=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T3FD;_T2C3=_T3FF->f1;_T3FE=_T2C3.elt_type;}{void*t2=_T3FE;_T2C4=
# 1338
Cyc_Absyn_is_nontagged_nonrequire_union_type(t2);if(!_T2C4)goto _TL176;{struct _tuple14 _T3FF;
# 1340
_T3FF.f0=f2;_T2C6=fenv;_T2C7=e;_T2C8=_T2C7->topt;_T2C9=_check_null(_T2C8);_T2CA=fenv;_T2CB=_T2CA->unknown_all;_T3FF.f1=Cyc_CfFlowInfo_typ_to_absrval(_T2C6,_T2C9,0,_T2CB);_T2C5=_T3FF;}return _T2C5;_TL176: _T2CC=
# 1342
Cyc_Absyn_is_require_union_type(t2);if(!_T2CC)goto _TL178;_T2CD=e1;_T2CE=_T2CD->loc;_T2CF=t2;_T2D0=field;_T2D1=f1;
Cyc_NewControlFlow_check_union_requires(_T2CE,_T2CF,_T2D0,_T2D1);goto _TL179;_TL178: _TL179: {
# 1345
struct _tuple13 _T3FF=Cyc_CfFlowInfo_unname_rval(r2);void*_T400;_T400=_T3FF.f0;{void*r2=_T400;struct _fat_ptr _T401;int _T402;int _T403;_T2D2=r2;_T2D3=(int*)_T2D2;_T2D4=*_T2D3;if(_T2D4!=6)goto _TL17A;_T2D5=r2;{struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_T404=(struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_T2D5;_T2D6=_T404->f1;_T403=_T2D6.is_union;_T2D7=_T404->f1;_T402=_T2D7.fieldnum;_T401=_T404->f2;}{int is_union=_T403;int fnum=_T402;struct _fat_ptr rdict=_T401;
# 1348
int field_no=Cyc_CfFlowInfo_get_field_index(t2,field);_T2D8=is_union;
if(!_T2D8)goto _TL17C;if(fnum==-1)goto _TL17C;if(fnum==field_no)goto _TL17C;{struct _tuple14 _T404;
_T404.f0=f2;_T2DA=fenv;_T2DB=e;_T2DC=_T2DB->topt;_T2DD=_check_null(_T2DC);_T2DE=fenv;_T2DF=_T2DE->unknown_none;_T404.f1=Cyc_CfFlowInfo_typ_to_absrval(_T2DA,_T2DD,1,_T2DF);_T2D9=_T404;}return _T2D9;_TL17C:{struct _tuple14 _T404;
_T404.f0=f2;_T2E1=rdict;_T2E2=field_no;_T2E3=_check_fat_subscript(_T2E1,sizeof(void*),_T2E2);_T2E4=(void**)_T2E3;_T404.f1=*_T2E4;_T2E0=_T404;}return _T2E0;}_TL17A: _T2E6=Cyc_Warn_impos;{
int(*_T404)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T2E6;_T2E5=_T404;}_T2E7=_tag_fat("anal_Rexp: AggrArrow",sizeof(char),21U);_T2E8=_tag_fat(0U,sizeof(void*),0);_T2E5(_T2E7,_T2E8);;}}}goto _TL175;_TL174: _T2EA=Cyc_Warn_impos;{
# 1354
int(*_T3FF)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T2EA;_T2E9=_T3FF;}_T2EB=_tag_fat("anal_Rexp: AggrArrow ptr",sizeof(char),25U);_T2EC=_tag_fat(0U,sizeof(void*),0);_T2E9(_T2EB,_T2EC);_TL175:;}}}}case 6:{struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F1=_T3F7->f2;_T3ED=_T3F7->f3;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct Cyc_Absyn_Exp*e2=_T3F1;struct Cyc_Absyn_Exp*e3=_T3ED;
# 1358
struct _tuple17 _T3F7=Cyc_NewControlFlow_anal_test(env,inflow,e1);union Cyc_CfFlowInfo_FlowInfo _T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f1t=_T3F9;union Cyc_CfFlowInfo_FlowInfo f1f=_T3F8;
struct _tuple14 pr2=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,f1t,e2,local_alias);
struct _tuple14 pr3=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,f1f,e3,local_alias);_T2ED=
Cyc_CfFlowInfo_join_flow_and_rval(fenv,pr2,pr3);return _T2ED;}}case 7:{struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F1=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct Cyc_Absyn_Exp*e2=_T3F1;
# 1364
struct _tuple17 _T3F7=Cyc_NewControlFlow_anal_test(env,inflow,e1);union Cyc_CfFlowInfo_FlowInfo _T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f1t=_T3F9;union Cyc_CfFlowInfo_FlowInfo f1f=_T3F8;
struct _tuple14 _T3FA=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,f1t,e2,local_alias);void*_T3FB;union Cyc_CfFlowInfo_FlowInfo _T3FC;_T3FC=_T3FA.f0;_T3FB=_T3FA.f1;{union Cyc_CfFlowInfo_FlowInfo f2t=_T3FC;void*f2r=_T3FB;{struct _tuple14 _T3FD;
_T3FD.f0=f2t;_T3FD.f1=f2r;_T2EE=_T3FD;}{struct _tuple14 pr2=_T2EE;{struct _tuple14 _T3FD;
_T3FD.f0=f1f;_T2F0=fenv;_T3FD.f1=_T2F0->zero;_T2EF=_T3FD;}{struct _tuple14 pr3=_T2EF;_T2F1=
Cyc_CfFlowInfo_join_flow_and_rval(fenv,pr2,pr3);return _T2F1;}}}}}case 8:{struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F1=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct Cyc_Absyn_Exp*e2=_T3F1;
# 1371
struct _tuple17 _T3F7=Cyc_NewControlFlow_anal_test(env,inflow,e1);union Cyc_CfFlowInfo_FlowInfo _T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f1t=_T3F9;union Cyc_CfFlowInfo_FlowInfo f1f=_T3F8;
struct _tuple14 _T3FA=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,f1f,e2,local_alias);void*_T3FB;union Cyc_CfFlowInfo_FlowInfo _T3FC;_T3FC=_T3FA.f0;_T3FB=_T3FA.f1;{union Cyc_CfFlowInfo_FlowInfo f2t=_T3FC;void*f2r=_T3FB;{struct _tuple14 _T3FD;
_T3FD.f0=f2t;_T3FD.f1=f2r;_T2F2=_T3FD;}{struct _tuple14 pr2=_T2F2;{struct _tuple14 _T3FD;
_T3FD.f0=f1t;_T2F4=fenv;_T3FD.f1=_T2F4->notzeroall;_T2F3=_T3FD;}{struct _tuple14 pr3=_T2F3;_T2F5=
Cyc_CfFlowInfo_join_flow_and_rval(fenv,pr2,pr3);return _T2F5;}}}}}case 23:{struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F1=_T3F7->f2;}{struct Cyc_Absyn_Exp*e1=_T3F6;struct Cyc_Absyn_Exp*e2=_T3F1;_T2F6=env;_T2F7=inflow;{struct Cyc_Absyn_Exp*_T3F7[2];
# 1378
_T3F7[0]=e1;_T3F7[1]=e2;_T2F9=_tag_fat(_T3F7,sizeof(struct Cyc_Absyn_Exp*),2);_T2F8=Cyc_List_list(_T2F9);}{struct _tuple21 _T3F7=Cyc_NewControlFlow_anal_Rexps(_T2F6,_T2F7,_T2F8,0,1);struct Cyc_List_List*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;struct Cyc_List_List*rvals=_T3F8;
# 1382
union Cyc_CfFlowInfo_FlowInfo f2=f;{struct Cyc_Dict_Dict _T3FA;_T2FA=f;_T2FB=_T2FA.ReachableFL;_T2FC=_T2FB.tag;if(_T2FC!=2)goto _TL17E;_T2FD=f;_T2FE=_T2FD.ReachableFL;_T3FA=_T2FE.val;{struct Cyc_Dict_Dict d2=_T3FA;_T2FF=env;_T300=_T2FF->fenv;_T301=d2;_T302=
# 1386
_check_null(rvals);_T303=_T302->tl;_T304=_check_null(_T303);_T305=_T304->hd;_T306=Cyc_CfFlowInfo_initlevel(_T300,_T301,_T305);_T307=(int)_T306;if(_T307!=0)goto _TL180;_T308=e2;_T309=_T308->loc;_T30A=
_tag_fat("expression may not be initialized",sizeof(char),34U);_T30B=_tag_fat(0U,sizeof(void*),0);Cyc_CfFlowInfo_aerr(_T309,_T30A,_T30B);goto _TL181;_TL180: _TL181:
 f2=Cyc_CfFlowInfo_ReachableFL(d2);goto _LL16F;}_TL17E: goto _LL16F;_LL16F:;}_T30C=env;_T30D=inflow;_T30E=f;_T30F=e1;_T310=
# 1392
_check_null(rvals);_T311=_T310->hd;_T312=e2;{struct _tuple14 _T3FA=Cyc_NewControlFlow_anal_derefR(_T30C,_T30D,_T30E,_T30F,_T311,_T312);void*_T3FB;union Cyc_CfFlowInfo_FlowInfo _T3FC;_T3FC=_T3FA.f0;_T3FB=_T3FA.f1;{union Cyc_CfFlowInfo_FlowInfo f3=_T3FC;void*r=_T3FB;_T313=f3;_T314=_T313.BottomFL;_T315=_T314.tag;if(_T315!=1)goto _TL182;{struct _tuple14 _T3FD;
# 1394
_T3FD.f0=f3;_T3FD.f1=r;_T316=_T3FD;}return _T316;_TL182:{struct _tuple14 _T3FD;
_T3FD.f0=f2;_T3FD.f1=r;_T317=_T3FD;}return _T317;;}}}}}case 29:{struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f3;}{struct Cyc_List_List*des=_T3F6;
# 1408
struct Cyc_List_List*fs;_T318=e;_T319=_T318->topt;_T31A=
_check_null(_T319);{void*_T3F7=Cyc_Absyn_compress(_T31A);struct Cyc_List_List*_T3F8;_T31B=(int*)_T3F7;_T31C=*_T31B;if(_T31C!=7)goto _TL184;{struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_T3F9=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_T3F7;_T3F8=_T3F9->f3;}{struct Cyc_List_List*f=_T3F8;
fs=f;goto _LL17F;}_TL184: _T31E=Cyc_Warn_impos;{
int(*_T3F9)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T31E;_T31D=_T3F9;}_T31F=_tag_fat("anal_Rexp:anon struct has bad type",sizeof(char),35U);_T320=_tag_fat(0U,sizeof(void*),0);_T31D(_T31F,_T320);_LL17F:;}_T3F6=des;_T3EB=0U;_T3F0=fs;goto _LL6D;}case 28: _T321=(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_T3E9;_T322=_T321->f4;if(_T322==0)goto _TL186;_T323=(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_T3E9;_T324=_T323->f4;_T325=(struct Cyc_Absyn_Aggrdecl*)_T324;_T326=_T325->impl;if(_T326==0)goto _TL188;{struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f3;_T327=_T3F7->f4;{struct Cyc_Absyn_Aggrdecl _T3F8=*_T327;_T3EB=_T3F8.kind;_T328=_T3F8.impl;{struct Cyc_Absyn_AggrdeclImpl _T3F9=*_T328;_T3F0=_T3F9.fields;}}}_LL6D:{struct Cyc_List_List*des=_T3F6;enum Cyc_Absyn_AggrKind kind=_T3EB;struct Cyc_List_List*fs=_T3F0;_T329=e;_T32A=_T329->topt;{
# 1415
void*exp_type=_check_null(_T32A);_T32B=env;_T32C=inflow;_T32E=Cyc_List_map;{
struct Cyc_List_List*(*_T3F7)(struct Cyc_Absyn_Exp*(*)(struct _tuple24*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(struct _tuple24*),struct Cyc_List_List*))_T32E;_T32D=_T3F7;}_T330=Cyc_Core_snd;{struct Cyc_Absyn_Exp*(*_T3F7)(struct _tuple24*)=(struct Cyc_Absyn_Exp*(*)(struct _tuple24*))_T330;_T32F=_T3F7;}_T331=des;_T332=_T32D(_T32F,_T331);{struct _tuple21 _T3F7=Cyc_NewControlFlow_anal_Rexps(_T32B,_T32C,_T332,1,1);struct Cyc_List_List*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f=_T3F9;struct Cyc_List_List*rvals=_T3F8;_T333=fenv;_T334=fs;_T335=kind;_T336=(int)_T335;_T337=_T336==1;_T338=fenv;_T339=_T338->unknown_all;{
struct _fat_ptr aggrdict=
Cyc_CfFlowInfo_aggrfields_to_aggrdict(_T333,_T334,_T337,_T339);
# 1420
int field_no=-1;{
int i=0;_TL18D: if(rvals!=0)goto _TL18B;else{goto _TL18C;}
_TL18B: _T33A=_check_null(des);_T33B=_T33A->hd;_T33C=(struct _tuple24*)_T33B;_T33D=*_T33C;{struct Cyc_List_List*ds=_T33D.f0;_TL191: if(ds!=0)goto _TL18F;else{goto _TL190;}
_TL18F: _T33E=ds;{void*_T3FA=_T33E->hd;struct _fat_ptr*_T3FB;_T33F=(int*)_T3FA;_T340=*_T33F;if(_T340!=0)goto _TL192;_T342=Cyc_Warn_impos;{
int(*_T3FC)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T342;_T341=_T3FC;}_T343=_tag_fat("anal_Rexp:Aggregate_e",sizeof(char),22U);_T344=_tag_fat(0U,sizeof(void*),0);_T341(_T343,_T344);goto _TL193;_TL192:{struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_T3FC=(struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_T3FA;_T3FB=_T3FC->f1;}{struct _fat_ptr*fld=_T3FB;
# 1427
field_no=Cyc_CfFlowInfo_get_field_index_fs(fs,fld);_T345=aggrdict;_T346=field_no;_T347=_check_fat_subscript(_T345,sizeof(void*),_T346);_T348=(void**)_T347;_T349=rvals;
*_T348=_T349->hd;_T34A=kind;_T34B=(int)_T34A;
# 1430
if(_T34B!=1)goto _TL194;_T34C=des;_T34D=_T34C->hd;_T34E=(struct _tuple24*)_T34D;_T34F=*_T34E;{
struct Cyc_Absyn_Exp*e=_T34F.f1;_T350=env;_T351=e;_T352=_T351->loc;_T353=f;_T354=rvals;_T355=_T354->hd;
f=Cyc_NewControlFlow_use_Rval(_T350,_T352,_T353,_T355);_T356=
# 1434
Cyc_Absyn_is_require_union_type(exp_type);if(!_T356)goto _TL196;_T357=e;_T358=_T357->loc;_T359=exp_type;_T35A=fld;_T35B=f;
Cyc_NewControlFlow_check_union_requires(_T358,_T359,_T35A,_T35B);goto _TL197;_TL196: _TL197:;}goto _TL195;_TL194: _TL195:;}_TL193:;}_T35C=ds;
# 1422
ds=_T35C->tl;goto _TL191;_TL190:;}_T35D=rvals;
# 1421
rvals=_T35D->tl;_T35E=des;des=_T35E->tl;i=i + 1;goto _TL18D;_TL18C:;}{
# 1439
struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*res;res=_cycalloc(sizeof(struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct));_T35F=res;_T35F->tag=6;_T360=res;_T361=kind;_T362=(int)_T361;_T360->f1.is_union=_T362==1;_T363=res;_T363->f1.fieldnum=field_no;_T364=res;_T364->f2=aggrdict;{struct _tuple14 _T3FA;
_T3FA.f0=f;_T366=res;_T3FA.f1=(void*)_T366;_T365=_T3FA;}return _T365;}}}}}}_TL188: goto _LL6E;_TL186: _LL6E:{struct Cyc_String_pa_PrintArg_struct _T3F7;_T3F7.tag=0;
# 1443
_T3F7.f1=Cyc_Absynpp_exp2string(e);_T367=_T3F7;}{struct Cyc_String_pa_PrintArg_struct _T3F7=_T367;void*_T3F8[1];_T3F8[0]=& _T3F7;_T369=Cyc_Warn_impos;{int(*_T3F9)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T369;_T368=_T3F9;}_T36A=_tag_fat("anal_Rexp:missing aggrdeclimpl in %s",sizeof(char),37U);_T36B=_tag_fat(_T3F8,sizeof(void*),1);_T368(_T36A,_T36B);};case 25:{struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;}{struct Cyc_List_List*dles=_T3F6;_T36D=Cyc_List_map;{
# 1445
struct Cyc_List_List*(*_T3F7)(struct Cyc_Absyn_Exp*(*)(struct _tuple24*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(struct _tuple24*),struct Cyc_List_List*))_T36D;_T36C=_T3F7;}_T36F=Cyc_Core_snd;{struct Cyc_Absyn_Exp*(*_T3F7)(struct _tuple24*)=(struct Cyc_Absyn_Exp*(*)(struct _tuple24*))_T36F;_T36E=_T3F7;}_T370=dles;{struct Cyc_List_List*es=_T36C(_T36E,_T370);
struct _tuple21 _T3F7=Cyc_NewControlFlow_anal_Rexps(env,inflow,es,1,1);struct Cyc_List_List*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo outflow=_T3F9;struct Cyc_List_List*rvals=_T3F8;
_TL19B: if(rvals!=0)goto _TL199;else{goto _TL19A;}
_TL199: _T371=env;_T372=_check_null(es);_T373=_T372->hd;_T374=(struct Cyc_Absyn_Exp*)_T373;_T375=_T374->loc;_T376=outflow;_T377=rvals;_T378=_T377->hd;outflow=Cyc_NewControlFlow_use_Rval(_T371,_T375,_T376,_T378);_T379=rvals;
# 1447
rvals=_T379->tl;_T37A=es;es=_T37A->tl;goto _TL19B;_TL19A:{struct _tuple14 _T3FA;
# 1450
_T3FA.f0=outflow;_T37C=fenv;_T37D=e;_T37E=_T37D->topt;_T37F=_check_null(_T37E);_T380=fenv;_T381=_T380->notzeroall;_T3FA.f1=Cyc_CfFlowInfo_typ_to_absrval(_T37C,_T37F,0,_T381);_T37B=_T3FA;}return _T37B;}}}case 26:{struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_T3E9;_T3F6=_T3F7->f1;_T3F1=_T3F7->f2;_T3ED=_T3F7->f3;_T3F4=_T3F7->f4;}{struct Cyc_Absyn_Vardecl*vd=_T3F6;struct Cyc_Absyn_Exp*e1=_T3F1;struct Cyc_Absyn_Exp*e2=_T3ED;int zt=_T3F4;
# 1454
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,e1,local_alias);void*_T3F8;union Cyc_CfFlowInfo_FlowInfo _T3F9;_T3F9=_T3F7.f0;_T3F8=_T3F7.f1;{union Cyc_CfFlowInfo_FlowInfo f1=_T3F9;void*r1=_T3F8;struct Cyc_Dict_Dict _T3FA;_T382=f1;_T383=_T382.BottomFL;_T384=_T383.tag;if(_T384!=1)goto _TL19C;{struct _tuple14 _T3FB;
# 1456
_T3FB.f0=f1;_T386=fenv;_T3FB.f1=_T386->unknown_all;_T385=_T3FB;}return _T385;_TL19C: _T387=f1;_T388=_T387.ReachableFL;_T3FA=_T388.val;{struct Cyc_Dict_Dict d1=_T3FA;_T389=env;_T38A=_T389->fenv;_T38B=d1;_T38C=r1;_T38D=
# 1458
Cyc_CfFlowInfo_initlevel(_T38A,_T38B,_T38C);_T38E=(int)_T38D;if(_T38E!=0)goto _TL19E;_T38F=e1;_T390=_T38F->loc;_T391=
_tag_fat("expression may not be initialized",sizeof(char),34U);_T392=_tag_fat(0U,sizeof(void*),0);Cyc_CfFlowInfo_aerr(_T390,_T391,_T392);goto _TL19F;_TL19E: _TL19F:
# 1462
 f1=Cyc_CfFlowInfo_ReachableFL(d1);_T393=r1;_T394=(int*)_T393;_T395=*_T394;switch(_T395){case 0:{struct _tuple14 _T3FB;
# 1466
_T3FB.f0=f1;_T397=fenv;_T3FB.f1=_T397->unknown_all;_T396=_T3FB;}return _T396;case 1: goto _LL19D;case 4: _LL19D:{struct Cyc_List_List _T3FB;
# 1469
_T3FB.hd=vd;_T3FB.tl=0;_T398=_T3FB;}{struct Cyc_List_List l=_T398;_T399=fenv;_T39A=f1;_T39B=& l;_T39C=(struct Cyc_List_List*)_T39B;_T39D=fenv;_T39E=_T39D->unknown_all;_T39F=e;_T3A0=_T39F->loc;
f1=Cyc_NewControlFlow_add_vars(_T399,_T39A,_T39C,_T39E,_T3A0,0);{
# 1472
struct _tuple14 _T3FB=Cyc_NewControlFlow_anal_Rexp(env,1,f1,e2,local_alias);void*_T3FC;union Cyc_CfFlowInfo_FlowInfo _T3FD;_T3FD=_T3FB.f0;_T3FC=_T3FB.f1;{union Cyc_CfFlowInfo_FlowInfo f2=_T3FD;void*r2=_T3FC;{struct Cyc_Dict_Dict _T3FE;_T3A1=f2;_T3A2=_T3A1.BottomFL;_T3A3=_T3A2.tag;if(_T3A3!=1)goto _TL1A1;{struct _tuple14 _T3FF;
# 1474
_T3FF.f0=f2;_T3A5=fenv;_T3FF.f1=_T3A5->unknown_all;_T3A4=_T3FF;}return _T3A4;_TL1A1: _T3A6=f2;_T3A7=_T3A6.ReachableFL;_T3FE=_T3A7.val;{struct Cyc_Dict_Dict d2=_T3FE;_T3A8=
# 1476
Cyc_CfFlowInfo_initlevel(fenv,d2,r2);_T3A9=(int)_T3A8;if(_T3A9==1)goto _TL1A3;_T3AA=e1;_T3AB=_T3AA->loc;_T3AC=
_tag_fat("expression may not be initialized",sizeof(char),34U);_T3AD=_tag_fat(0U,sizeof(void*),0);Cyc_CfFlowInfo_aerr(_T3AB,_T3AC,_T3AD);{struct _tuple14 _T3FF;
_T3FF.f0=Cyc_CfFlowInfo_BottomFL();_T3AF=fenv;_T3FF.f1=_T3AF->unknown_all;_T3AE=_T3FF;}return _T3AE;_TL1A3:;};}
# 1481
f1=f2;goto _LL19F;}}}default: _LL19F:
# 1484
 _TL1A5: if(1)goto _TL1A6;else{goto _TL1A7;}
_TL1A6:{struct Cyc_List_List _T3FB;_T3FB.hd=vd;_T3FB.tl=0;_T3B0=_T3FB;}{struct Cyc_List_List l=_T3B0;_T3B1=fenv;_T3B2=f1;_T3B3=& l;_T3B4=(struct Cyc_List_List*)_T3B3;_T3B5=fenv;_T3B6=_T3B5->unknown_all;_T3B7=e;_T3B8=_T3B7->loc;
f1=Cyc_NewControlFlow_add_vars(_T3B1,_T3B2,_T3B4,_T3B6,_T3B8,0);{
struct _tuple14 _T3FB=Cyc_NewControlFlow_anal_Rexp(env,1,f1,e2,local_alias);void*_T3FC;union Cyc_CfFlowInfo_FlowInfo _T3FD;_T3FD=_T3FB.f0;_T3FC=_T3FB.f1;{union Cyc_CfFlowInfo_FlowInfo f2=_T3FD;void*r2=_T3FC;{struct Cyc_Dict_Dict _T3FE;_T3B9=f2;_T3BA=_T3B9.BottomFL;_T3BB=_T3BA.tag;if(_T3BB!=1)goto _TL1A8;goto _LL1AB;_TL1A8: _T3BC=f2;_T3BD=_T3BC.ReachableFL;_T3FE=_T3BD.val;{struct Cyc_Dict_Dict d2=_T3FE;_T3BE=
# 1491
Cyc_CfFlowInfo_initlevel(fenv,d2,r2);_T3BF=(int)_T3BE;if(_T3BF==1)goto _TL1AA;_T3C0=e1;_T3C1=_T3C0->loc;_T3C2=
_tag_fat("expression may not be initialized",sizeof(char),34U);_T3C3=_tag_fat(0U,sizeof(void*),0);Cyc_CfFlowInfo_aerr(_T3C1,_T3C2,_T3C3);{struct _tuple14 _T3FF;
_T3FF.f0=Cyc_CfFlowInfo_BottomFL();_T3C5=fenv;_T3FF.f1=_T3C5->unknown_all;_T3C4=_T3FF;}return _T3C4;_TL1AA:;}_LL1AB:;}{
# 1496
union Cyc_CfFlowInfo_FlowInfo newflow=Cyc_CfFlowInfo_join_flow(fenv,f1,f2);_T3C6=
Cyc_CfFlowInfo_flow_lessthan_approx(newflow,f1);if(!_T3C6)goto _TL1AC;goto _TL1A7;_TL1AC:
# 1499
 f1=newflow;}}}}goto _TL1A5;_TL1A7:{struct _tuple14 _T3FB;
# 1501
_T3FB.f0=f1;_T3C8=fenv;_T3FB.f1=_T3C8->notzeroall;_T3C7=_T3FB;}return _T3C7;};};}}case 27:{struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_T3E9;_T3F1=_T3F7->f1;_T3C9=_T3F7->f2;_T3F6=(void*)_T3C9;_T3F4=_T3F7->f3;}{struct Cyc_Absyn_Exp*exp=_T3F1;void*typ=_T3F6;int iszeroterm=_T3F4;{struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_T3F7=_cycalloc(sizeof(struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct));_T3F7->tag=1;
# 1507
_T3F7->f1=exp;_T3CB=e;_T3CC=_T3CB->topt;_T3F7->f2=_check_null(_T3CC);_T3CA=(struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_T3F7;}{void*root=(void*)_T3CA;
struct Cyc_CfFlowInfo_Place*place;place=_cycalloc(sizeof(struct Cyc_CfFlowInfo_Place));_T3CD=place;_T3CD->root=root;_T3CE=place;_T3CE->path=0;{struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_T3F7=_cycalloc(sizeof(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct));_T3F7->tag=4;
_T3F7->f1=place;_T3CF=(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_T3F7;}{void*rval=(void*)_T3CF;
void*place_val;_T3D0=fenv;_T3D1=typ;_T3D2=fenv;_T3D3=_T3D2->unknown_none;
# 1515
place_val=Cyc_CfFlowInfo_typ_to_absrval(_T3D0,_T3D1,0,_T3D3);{
union Cyc_CfFlowInfo_FlowInfo outflow;
struct _tuple14 _T3F7=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,exp,local_alias);union Cyc_CfFlowInfo_FlowInfo _T3F8;_T3F8=_T3F7.f0;{union Cyc_CfFlowInfo_FlowInfo f=_T3F8;
outflow=f;{struct Cyc_Dict_Dict _T3F9;_T3D4=outflow;_T3D5=_T3D4.BottomFL;_T3D6=_T3D5.tag;if(_T3D6!=1)goto _TL1AE;{struct _tuple14 _T3FA;
# 1520
_T3FA.f0=outflow;_T3FA.f1=rval;_T3D7=_T3FA;}return _T3D7;_TL1AE: _T3D8=outflow;_T3D9=_T3D8.ReachableFL;_T3F9=_T3D9.val;{struct Cyc_Dict_Dict d2=_T3F9;{struct _tuple14 _T3FA;_T3DB=
# 1522
Cyc_Dict_insert(d2,root,place_val);_T3FA.f0=Cyc_CfFlowInfo_ReachableFL(_T3DB);_T3FA.f1=rval;_T3DA=_T3FA;}return _T3DA;};}}}}}}case 36:{struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_T3F7=(struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_T3E9;_T3EA=_T3F7->f1;}{struct Cyc_Absyn_Stmt*s=_T3EA;{struct _tuple15 _T3F7;_T3DD=env;_T3DE=_T3DD->fenv;
# 1526
_T3F7.f0=_T3DE->unknown_all;_T3F7.f1=copy_ctxt;_T3DC=_T3F7;}{struct _tuple15 rval_opt=_T3DC;_T3DF=env;_T3E0=inflow;_T3E1=s;_T3E2=& rval_opt;{
union Cyc_CfFlowInfo_FlowInfo f=Cyc_NewControlFlow_anal_stmt(_T3DF,_T3E0,_T3E1,_T3E2);{struct _tuple14 _T3F7;
_T3F7.f0=f;_T3E4=rval_opt;_T3F7.f1=_T3E4.f0;_T3E3=_T3F7;}return _T3E3;}}}case 35: _LL7B: goto _LL7D;case 24: _LL7D: goto _LL7F;default: _LL7F: _T3E6=Cyc_Warn_impos;{
# 1534
int(*_T3F7)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T3E6;_T3E5=_T3F7;}_T3E7=_tag_fat("anal_Rexp, unexpected exp form",sizeof(char),31U);_T3E8=_tag_fat(0U,sizeof(void*),0);_T3E5(_T3E7,_T3E8);};}}}
