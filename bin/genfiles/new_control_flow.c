...
({struct Cyc_NewControlFlow_AnalEnv*_tmp65C=env;unsigned int _tmp65B=loc;void*_tmp65A=((struct Cyc_Absyn_Aggrfield*)((struct Cyc_List_List*)_check_null(_tmp5F))->hd)->type;Cyc_NewControlFlow_check_nounique(_tmp65C,_tmp65B,_tmp65A,*((void**)_check_dyneither_subscript(_tmp5E,sizeof(void*),i)));});}}
return;}else{goto _LL13;}case 3U: _LL11: _LL12:
# 385
 if(Cyc_Tcutil_is_noalias_pointer(t,0))
({void*_tmp54=0U;({unsigned int _tmp65E=loc;struct _dyneither_ptr _tmp65D=({const char*_tmp55="argument may still contain alias-free pointers";_tag_dyneither(_tmp55,sizeof(char),47U);});Cyc_Warn_warn(_tmp65E,_tmp65D,_tag_dyneither(_tmp54,sizeof(void*),0U));});});
...
# 396
 if(!Cyc_Tcutil_is_noalias_pointer(t,0))
({void*_tmp62=0U;({struct _dyneither_ptr _tmp65F=({const char*_tmp63="noliveunique attribute requires alias-free pointer";_tag_dyneither(_tmp63,sizeof(char),51U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp65F,_tag_dyneither(_tmp62,sizeof(void*),0U));});});{
...
({void*_tmp660=Cyc_CfFlowInfo_lookup_place(_tmp6E,_tmp69);_tmp6A=_tmp660;});goto _LLB;case 5U: _LLA: _tmp6A=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp65)->f1;_LLB:
...
({void*_tmp66=0U;({unsigned int _tmp662=loc;struct _dyneither_ptr _tmp661=({const char*_tmp67="argument may contain live alias-free pointers";_tag_dyneither(_tmp67,sizeof(char),46U);});Cyc_Warn_warn(_tmp662,_tmp661,_tag_dyneither(_tmp66,sizeof(void*),0U));});});
...
inflow=_tmp73;
({struct Cyc_List_List*_tmp663=({struct Cyc_List_List*_tmp71=_cycalloc(sizeof(*_tmp71));_tmp71->hd=_tmp72,_tmp71->tl=rvals;_tmp71;});rvals=_tmp663;});
es=es->tl;
first_is_copy=others_are_copy;}while(es != 0);
# 434
Cyc_NewControlFlow_update_tryflow(env,inflow);
return({struct _tuple23 _tmp5A3;_tmp5A3.f1=inflow,({struct Cyc_List_List*_tmp664=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(rvals);_tmp5A3.f2=_tmp664;});_tmp5A3;});}
# 440
...
({void*_tmp77=0U;({unsigned int _tmp666=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd)->loc;struct _dyneither_ptr _tmp665=({const char*_tmp78="expression may not be initialized";_tag_dyneither(_tmp78,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp666,_tmp665,_tag_dyneither(_tmp77,sizeof(void*),0U));});});}
goto _LL3;}else{_LL6: _LL7:
 goto _LL3;}_LL3:;}
# 452
...
({void*_tmp7D=0U;({struct _dyneither_ptr _tmp667=({const char*_tmp7E="consume_zero_rval";_tag_dyneither(_tmp7E,sizeof(char),18U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp667,_tag_dyneither(_tmp7D,sizeof(void*),0U));});});else{
# 471
if(needs_unconsume)
...
({void*_tmp668=(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp82=_cycalloc(sizeof(*_tmp82));_tmp82->tag=8U,_tmp82->f1=(struct Cyc_Absyn_Vardecl*)names->hd,_tmp82->f2=nzval;_tmp82;});nzval=_tmp668;});}
# 508
({void*_tmp669=Cyc_NewControlFlow_consume_zero_rval(env,_tmp86,_tmp84,e,nzval);nzval=_tmp669;});{
union Cyc_CfFlowInfo_FlowInfo _tmp83=({struct Cyc_Dict_Dict _tmp66A=Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmp86,_tmp84,nzval);Cyc_CfFlowInfo_ReachableFL(_tmp66A,_tmp85);});
# 513
...
for(0;names != 0;names=names->tl){
({void*_tmp66B=(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp8A=_cycalloc(sizeof(*_tmp8A));_tmp8A->tag=8U,_tmp8A->f1=(struct Cyc_Absyn_Vardecl*)names->hd,_tmp8A->f2=nzval;_tmp8A;});nzval=_tmp66B;});
({void*_tmp66C=(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp8B=_cycalloc(sizeof(*_tmp8B));_tmp8B->tag=8U,_tmp8B->f1=(struct Cyc_Absyn_Vardecl*)names->hd,_tmp8B->f2=zval;_tmp8B;});zval=_tmp66C;});}
# 536
({void*_tmp66D=Cyc_NewControlFlow_consume_zero_rval(env,_tmp8E,_tmp8C,e,nzval);nzval=_tmp66D;});
({void*_tmp66E=Cyc_NewControlFlow_consume_zero_rval(env,_tmp8E,_tmp8C,e,zval);zval=_tmp66E;});
return({struct _tuple19 _tmp5A7;({
union Cyc_CfFlowInfo_FlowInfo _tmp672=({struct Cyc_Dict_Dict _tmp671=Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmp8E,_tmp8C,nzval);Cyc_CfFlowInfo_ReachableFL(_tmp671,_tmp8D);});_tmp5A7.f1=_tmp672;}),({
union Cyc_CfFlowInfo_FlowInfo _tmp670=({struct Cyc_Dict_Dict _tmp66F=Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmp8E,_tmp8C,zval);Cyc_CfFlowInfo_ReachableFL(_tmp66F,_tmp8D);});_tmp5A7.f2=_tmp670;});_tmp5A7;});}}_LL5:;}}_LL0:;}
# 545
...
# 597
 return({struct _tuple16 _tmp5A8;_tmp5A8.f1=f,({void*_tmp675=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpBF,0,(env->fenv)->unknown_all);_tmp5A8.f2=_tmp675;});_tmp5A8;});}else{_LL8: _tmpBB=((_tmp9C.ReachableFL).val).f1;_tmpBA=((_tmp9C.ReachableFL).val).f2;_LL9:
# 600
...
# 609
 Cyc_NewControlFlow_update_relns(e,0,_tmpBA);
return({struct _tuple16 _tmp5A9;_tmp5A9.f1=f,({void*_tmp677=Cyc_CfFlowInfo_lookup_place(_tmpBB,_tmpA7);_tmp5A9.f2=_tmp677;});_tmp5A9;});case 5U: _LL14: _tmpA8=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp9F)->f1;_LL15:
# 612
...
return({struct _tuple16 _tmp5AB;({union Cyc_CfFlowInfo_FlowInfo _tmp679=Cyc_CfFlowInfo_BottomFL();_tmp5AB.f1=_tmp679;}),({void*_tmp678=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpBF,0,(env->fenv)->unknown_all);_tmp5AB.f2=_tmp678;});_tmp5AB;});case 2U: _LL18: _tmpA9=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp9F)->f1;_LL19:
# 619
({union Cyc_CfFlowInfo_FlowInfo _tmp67A=Cyc_NewControlFlow_notzero(env,inflow,f,e,_tmpA9,_tmpAA);f=_tmp67A;});
...
# 624
({void*_tmp67B=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmpA4=_cycalloc(sizeof(*_tmpA4));_tmpA4->tag=Cyc_CfFlowInfo_UnknownZ,_tmpA4->f1=_tmpBA;_tmpA4;});e->annot=_tmp67B;});
...
# 638
({void*_tmp67C=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmpAE=_cycalloc(sizeof(*_tmpAE));_tmpAE->tag=Cyc_CfFlowInfo_UnknownZ,_tmpAE->f1=_tmpBA;_tmpAE;});e->annot=_tmp67C;});
goto _LL21;}_LL21:;}{
# 642
...
# 647
({void*_tmpB5=0U;({unsigned int _tmp67E=e->loc;struct _dyneither_ptr _tmp67D=({const char*_tmpB6="attempt to dereference a consumed alias-free pointer";_tag_dyneither(_tmpB6,sizeof(char),53U);});Cyc_CfFlowInfo_aerr(_tmp67E,_tmp67D,_tag_dyneither(_tmpB5,sizeof(void*),0U));});});
goto _LL2E;}else{_LL31: _LL32:
# 650
({void*_tmpB7=0U;({unsigned int _tmp680=e->loc;struct _dyneither_ptr _tmp67F=({const char*_tmpB8="dereference of possibly uninitialized pointer";_tag_dyneither(_tmpB8,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp680,_tmp67F,_tag_dyneither(_tmpB7,sizeof(void*),0U));});});}_LL2E:;}
# 652
goto _LL2A;}}else{_LL29: _LL2A:
# 654
 return({struct _tuple16 _tmp5AC;_tmp5AC.f1=f,({void*_tmp681=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpBF,0,(env->fenv)->unknown_all);_tmp5AC.f2=_tmp681;});_tmp5AC;});}_LL26:;};}_LL5:;}}else{_LL3: _LL4:
# 657
({void*_tmpBC=0U;({struct _dyneither_ptr _tmp682=({const char*_tmpBD="right deref of non-pointer-type";_tag_dyneither(_tmpBD,sizeof(char),32U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp682,_tag_dyneither(_tmpBC,sizeof(void*),0U));});});}_LL0:;}
# 664
...
if(e2_valid_op)
({struct Cyc_List_List*_tmp683=Cyc_Relations_add_relation(Cyc_Core_heap_region,n2,Cyc_Relations_Rlt,n1,relns);relns=_tmp683;});}
# 677
goto _LL0;}}else{_LL3: _LL4:
 goto _LL0;}_LL0:;}{
# 681
...
({struct Cyc_List_List*_tmp684=Cyc_Relations_add_relation(Cyc_Core_heap_region,n2,Cyc_Relations_Rlt,rbound,relns);relns=_tmp684;});}
# 687
return relns;};}
# 695
...
({void*_tmp685=(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmpCB=_cycalloc(sizeof(*_tmpCB));_tmpCB->tag=8U,_tmpCB->f1=(struct Cyc_Absyn_Vardecl*)_tmpCC->hd,_tmpCB->f2=_tmpC8;_tmpCB;});_tmpC8=_tmp685;});}
# 710
({struct Cyc_Dict_Dict _tmp686=Cyc_CfFlowInfo_assign_place(env->fenv,loc,_tmpD3,_tmpD1,_tmpC8);_tmpD3=_tmp686;});
({union Cyc_CfFlowInfo_FlowInfo _tmp687=Cyc_CfFlowInfo_ReachableFL(_tmpD3,_tmpD2);inflow=_tmp687;});
Cyc_NewControlFlow_update_tryflow(env,inflow);
# 716
goto _LL3;}}else{_LL8: _LL9:
# 719
({struct Cyc_String_pa_PrintArg_struct _tmpD0=({struct Cyc_String_pa_PrintArg_struct _tmp5AD;_tmp5AD.tag=0U,({struct _dyneither_ptr _tmp688=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(exp));_tmp5AD.f1=_tmp688;});_tmp5AD;});void*_tmpCE[1U];_tmpCE[0]=& _tmpD0;({struct _dyneither_ptr _tmp689=({const char*_tmpCF="noconsume parameter %s must be l-values";_tag_dyneither(_tmpCF,sizeof(char),40U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp689,_tag_dyneither(_tmpCE,sizeof(void*),1U));});});
goto _LL3;}}else{_LL6: _LL7:
# 717
 goto _LL3;}_LL3:;}
# 722
...
# 736
 return({struct _tuple16 _tmp5AF;({union Cyc_CfFlowInfo_FlowInfo _tmp68A=Cyc_CfFlowInfo_BottomFL();_tmp5AF.f1=_tmp68A;}),_tmp5AF.f2=rval;_tmp5AF;});}else{_LL3: _tmpE0=((_tmpD5.ReachableFL).val).f1;_tmpDF=((_tmpD5.ReachableFL).val).f2;_LL4: {
# 738
...
({struct Cyc_List_List*_tmp68B=Cyc_Relations_reln_assign_exp(Cyc_Core_heap_region,_tmpDF,lexp,rexp);_tmpDF=_tmp68B;});
({union Cyc_CfFlowInfo_FlowInfo _tmp68C=Cyc_CfFlowInfo_ReachableFL(_tmpD7,_tmpDF);outflow=_tmp68C;});
if(Cyc_NewControlFlow_warn_lose_unique  && 
...
# 758
({void*_tmpDB=0U;({unsigned int _tmp68E=lexp->loc;struct _dyneither_ptr _tmp68D=({const char*_tmpDC="assignment may overwrite alias-free pointer(s)";_tag_dyneither(_tmpDC,sizeof(char),47U);});Cyc_Warn_warn(_tmp68E,_tmp68D,_tag_dyneither(_tmpDB,sizeof(void*),0U));});});
goto _LLD;}_LLD:;};}
# 763
...
# 769
 return({struct _tuple16 _tmp5B1;({union Cyc_CfFlowInfo_FlowInfo _tmp68F=Cyc_NewControlFlow_use_Rval(env,rexp->loc,outflow,rval);_tmp5B1.f1=_tmp68F;}),_tmp5B1.f2=rval;_tmp5B1;});}_LL5:;}}_LL0:;}
# 776
...
# 787
({struct Cyc_Dict_Dict _tmp695=({struct Cyc_CfFlowInfo_FlowEnv*_tmp694=fenv;unsigned int _tmp693=loc;struct Cyc_Dict_Dict _tmp692=_tmpE6;struct Cyc_CfFlowInfo_Place*_tmp691=({struct Cyc_CfFlowInfo_Place*_tmpE3=_cycalloc(sizeof(*_tmpE3));
({void*_tmp690=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmpE2=_cycalloc(sizeof(*_tmpE2));_tmpE2->tag=0U,_tmpE2->f1=vd;_tmpE2;});_tmpE3->root=_tmp690;}),_tmpE3->path=0;_tmpE3;});
# 787
Cyc_CfFlowInfo_assign_place(_tmp694,_tmp693,_tmp692,_tmp691,rval);});_tmpE6=_tmp695;});
# 790
({struct Cyc_List_List*_tmp696=Cyc_Relations_reln_assign_var(Cyc_Core_heap_region,_tmpE5,vd,rexp);_tmpE5=_tmp696;});{
...
if((*((struct _tuple24*)x->hd)).f1 == 0)({struct Cyc_List_List*_tmp697=({struct Cyc_List_List*_tmpE8=_cycalloc(sizeof(*_tmpE8));_tmpE8->hd=(struct Cyc_Absyn_Exp*)_check_null((*((struct _tuple24*)x->hd)).f2),_tmpE8->tl=es;_tmpE8;});es=_tmp697;});}}
# 815
({union Cyc_CfFlowInfo_FlowInfo _tmp698=Cyc_NewControlFlow_add_vars(fenv,inflow,_tmpE7,fenv->unknown_all,pat_loc,name_locs);inflow=_tmp698;});
# 817
({union Cyc_CfFlowInfo_FlowInfo _tmp699=Cyc_NewControlFlow_expand_unique_places(env,inflow,es);inflow=_tmp699;});
...
({union Cyc_CfFlowInfo_FlowInfo _tmp69A=Cyc_NewControlFlow_use_Rval(env,exp_loc,_tmpEC,_tmpEB);inflow=_tmp69A;});}}{
# 829
...
struct _dyneither_ptr _tmp69B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmp106));_tmp5B2.f1=_tmp69B;});_tmp5B2;});void*_tmpF0[1U];_tmpF0[0]=& _tmpF2;({struct _dyneither_ptr _tmp69C=({const char*_tmpF1="oops! pattern init expr %s has no type!\n";_tag_dyneither(_tmpF1,sizeof(char),41U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp69C,_tag_dyneither(_tmpF0,sizeof(void*),1U));});});{
# 843
...
# 852
({void*_tmp69D=(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmpFA=_cycalloc(sizeof(*_tmpFA));_tmpFA->tag=8U,_tmpFA->f1=*_tmp107,_tmpFA->f2=_tmp103;_tmpFA;});_tmp103=_tmp69D;});{
# 855
void*_tmpFB=Cyc_CfFlowInfo_lookup_place(_tmp102,_tmp100);
({void*_tmp69E=(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmpFC=_cycalloc(sizeof(*_tmpFC));_tmpFC->tag=8U,_tmpFC->f1=*_tmp107,_tmpFC->f2=_tmpFB;_tmpFC;});_tmpFB=_tmp69E;});
({struct Cyc_Dict_Dict _tmp69F=Cyc_CfFlowInfo_assign_place(fenv,exp_loc,_tmp102,_tmp100,_tmpFB);_tmp102=_tmp69F;});
({union Cyc_CfFlowInfo_FlowInfo _tmp6A0=Cyc_CfFlowInfo_ReachableFL(_tmp102,_tmp101);_tmp104=_tmp6A0;});
...
struct _dyneither_ptr _tmp6A1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmp106));_tmp5B3.f1=_tmp6A1;});_tmp5B3;});void*_tmpFD[1U];_tmpFD[0]=& _tmpFF;({unsigned int _tmp6A3=exp_loc;struct _dyneither_ptr _tmp6A2=({const char*_tmpFE="aliased pattern expression not an l-value: %s";_tag_dyneither(_tmpFE,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp6A3,_tmp6A2,_tag_dyneither(_tmpFD,sizeof(void*),1U));});});}_LL11:;}
# 872
({union Cyc_CfFlowInfo_FlowInfo _tmp6A4=Cyc_NewControlFlow_do_initialize_var(fenv,env,_tmp104,*_tmp107,_tmp106,_tmp103,pat_loc);inflow=_tmp6A4;});
...
return({struct Cyc_Absyn_Exp*_tmp6A5=Cyc_Absyn_prim1_exp(Cyc_Absyn_Numelts,_tmp114,0U);Cyc_Relations_exp2relnop(_tmp6A5,rop);});}default: _LL5: _LL6:
 return 1;}_LL0:;}
# 917
...
struct _dyneither_ptr _tmp6A6=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Relations_relns2string(_tmp123));_tmp5B5.f1=_tmp6A6;});_tmp5B5;});void*_tmp11D[4U];_tmp11D[0]=& _tmp11F,_tmp11D[1]=& _tmp120,_tmp11D[2]=& _tmp121,_tmp11D[3]=& _tmp122;({unsigned int _tmp6A8=loc;struct _dyneither_ptr _tmp6A7=({const char*_tmp11E="cannot prove that @requires clause %s %s %s is satisfied\n (all I know is %s)";_tag_dyneither(_tmp11E,sizeof(char),77U);});Cyc_CfFlowInfo_aerr(_tmp6A8,_tmp6A7,_tag_dyneither(_tmp11D,sizeof(void*),4U));});});
break;}}
# 948
...
{union Cyc_CfFlowInfo_FlowInfo _tmp126=inflow;struct Cyc_Dict_Dict _tmp128;struct Cyc_List_List*_tmp127;if((_tmp126.BottomFL).tag == 1){_LL1: _LL2:
 return({struct _tuple16 _tmp5B9;({union Cyc_CfFlowInfo_FlowInfo _tmp6A9=Cyc_CfFlowInfo_BottomFL();_tmp5B9.f1=_tmp6A9;}),_tmp5B9.f2=_tmp125->unknown_all;_tmp5B9;});}else{_LL3: _tmp128=((_tmp126.ReachableFL).val).f1;_tmp127=((_tmp126.ReachableFL).val).f2;_LL4:
...
({void*_tmp12E=0U;({unsigned int _tmp6AB=e->loc;struct _dyneither_ptr _tmp6AA=({const char*_tmp12F="expression attempts to copy a consumed alias-free value";_tag_dyneither(_tmp12F,sizeof(char),56U);});Cyc_CfFlowInfo_aerr(_tmp6AB,_tmp6AA,_tag_dyneither(_tmp12E,sizeof(void*),0U));});});
return({struct _tuple16 _tmp5BA;({union Cyc_CfFlowInfo_FlowInfo _tmp6AC=Cyc_CfFlowInfo_BottomFL();_tmp5BA.f1=_tmp6AC;}),_tmp5BA.f2=_tmp125->unknown_all;_tmp5BA;});}else{
# 1015
if(needs_unconsume)
# 1017
return({struct _tuple16 _tmp5BB;_tmp5BB.f1=_tmp136,({void*_tmp6AD=Cyc_CfFlowInfo_make_unique_unconsumed(_tmp125,_tmp12D);_tmp5BB.f2=_tmp6AD;});_tmp5BB;});else{
# 1020
...
# 1032
return({struct _tuple16 _tmp5BC;({union Cyc_CfFlowInfo_FlowInfo _tmp6AE=Cyc_CfFlowInfo_ReachableFL(_tmp131,_tmp133);_tmp5BC.f1=_tmp6AE;}),_tmp5BC.f2=_tmp12D;_tmp5BC;});}}}}else{goto _LLB;}}else{_LLB: _LLC:
# 1036
 goto _LL8;}_LL8:;};}{
# 1039
...
# 1055
 if(!({struct _dyneither_ptr _tmp6AF=(struct _dyneither_ptr)_tmp2C0;Cyc_NewControlFlow_strcmp(_tmp6AF,({const char*_tmp141="print_flow";_tag_dyneither(_tmp141,sizeof(char),11U);}));})){
struct _dyneither_ptr _tmp142=Cyc_Position_string_of_segment(e->loc);
({struct Cyc_String_pa_PrintArg_struct _tmp145=({struct Cyc_String_pa_PrintArg_struct _tmp5BF;_tmp5BF.tag=0U,_tmp5BF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp142);_tmp5BF;});void*_tmp143[1U];_tmp143[0]=& _tmp145;({struct Cyc___cycFILE*_tmp6B1=Cyc_stderr;struct _dyneither_ptr _tmp6B0=({const char*_tmp144="%s: current flow is\n";_tag_dyneither(_tmp144,sizeof(char),21U);});Cyc_fprintf(_tmp6B1,_tmp6B0,_tag_dyneither(_tmp143,sizeof(void*),1U));});});
Cyc_CfFlowInfo_print_flow(inflow);
({void*_tmp146=0U;({struct Cyc___cycFILE*_tmp6B3=Cyc_stderr;struct _dyneither_ptr _tmp6B2=({const char*_tmp147="\n";_tag_dyneither(_tmp147,sizeof(char),2U);});Cyc_fprintf(_tmp6B3,_tmp6B2,_tag_dyneither(_tmp146,sizeof(void*),0U));});});}else{
# 1061
if(!({struct _dyneither_ptr _tmp6B4=(struct _dyneither_ptr)_tmp2C0;Cyc_NewControlFlow_strcmp(_tmp6B4,({const char*_tmp148="debug_on";_tag_dyneither(_tmp148,sizeof(char),9U);}));}));else{
# 1066
if(!({struct _dyneither_ptr _tmp6B5=(struct _dyneither_ptr)_tmp2C0;Cyc_NewControlFlow_strcmp(_tmp6B5,({const char*_tmp149="debug_off";_tag_dyneither(_tmp149,sizeof(char),10U);}));}));else{
# 1072
({struct Cyc_String_pa_PrintArg_struct _tmp14C=({struct Cyc_String_pa_PrintArg_struct _tmp5C0;_tmp5C0.tag=0U,_tmp5C0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp2C0);_tmp5C0;});void*_tmp14A[1U];_tmp14A[0]=& _tmp14C;({unsigned int _tmp6B7=e->loc;struct _dyneither_ptr _tmp6B6=({const char*_tmp14B="unknown pragma %s";_tag_dyneither(_tmp14B,sizeof(char),18U);});Cyc_Warn_warn(_tmp6B7,_tmp6B6,_tag_dyneither(_tmp14A,sizeof(void*),1U));});});}}}
...
# 1091
 return({struct _tuple16 _tmp5C4;_tmp5C4.f1=inflow,({void*_tmp6B8=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5C4.f2=_tmp6B8;});_tmp5C4;});case 3U: _LL36: _tmp2C1=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp138)->f1)->f1;_LL37:
# 1094
...
return({struct _tuple16 _tmp5C5;_tmp5C5.f1=inflow,({void*_tmp6BA=({struct Cyc_Dict_Dict _tmp6B9=d;((void*(*)(struct Cyc_Dict_Dict d,int(*cmp)(void*,void*),void*k))Cyc_Dict_lookup_other)(_tmp6B9,Cyc_CfFlowInfo_root_cmp,(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp14D=_cycalloc(sizeof(*_tmp14D));*_tmp14D=vdroot;_tmp14D;}));});_tmp5C5.f2=_tmp6BA;});_tmp5C5;});}default: _LL74: _LL75:
# 1700
...
# 1121
({struct Cyc_List_List*_tmp6BB=Cyc_Relations_reln_kill_exp(Cyc_Core_heap_region,_tmp15D,_tmp2C8);_tmp15D=_tmp6BB;});
({union Cyc_CfFlowInfo_FlowInfo _tmp6BD=({struct Cyc_Dict_Dict _tmp6BC=Cyc_CfFlowInfo_assign_place(_tmp125,_tmp2C8->loc,_tmp15E,_tmp15F,_tmp125->unknown_all);Cyc_CfFlowInfo_ReachableFL(_tmp6BC,_tmp15D);});_tmp161=_tmp6BD;});
# 1126
...
({void*_tmp162=0U;({unsigned int _tmp6BF=e->loc;struct _dyneither_ptr _tmp6BE=({const char*_tmp163="cannot track alias-free pointers through multiple assignments";_tag_dyneither(_tmp163,sizeof(char),62U);});Cyc_CfFlowInfo_aerr(_tmp6BF,_tmp6BE,_tag_dyneither(_tmp162,sizeof(void*),0U));});});
return({struct _tuple16 _tmp5CD;({union Cyc_CfFlowInfo_FlowInfo _tmp6C0=Cyc_CfFlowInfo_BottomFL();_tmp5CD.f1=_tmp6C0;}),_tmp5CD.f2=_tmp125->unknown_all;_tmp5CD;});}{
# 1139
...
# 1147
({struct Cyc_List_List*_tmp6C1=Cyc_Relations_reln_kill_exp(Cyc_Core_heap_region,_tmp16B,_tmp2CA);_tmp16B=_tmp6C1;});
({struct Cyc_Dict_Dict _tmp6C2=Cyc_CfFlowInfo_assign_place(_tmp125,_tmp2CA->loc,_tmp16C,_tmp16A,_tmp125->unknown_all);_tmp16C=_tmp6C2;});
# 1150
({union Cyc_CfFlowInfo_FlowInfo _tmp6C3=Cyc_CfFlowInfo_ReachableFL(_tmp16C,_tmp16B);_tmp16E=_tmp6C3;});
# 1154
...
# 1165
 if(copy_ctxt  && Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_check_null(e->topt))){
({void*_tmp171=0U;({unsigned int _tmp6C5=e->loc;struct _dyneither_ptr _tmp6C4=({const char*_tmp172="cannot track alias-free pointers through multiple assignments";_tag_dyneither(_tmp172,sizeof(char),62U);});Cyc_CfFlowInfo_aerr(_tmp6C5,_tmp6C4,_tag_dyneither(_tmp171,sizeof(void*),0U));});});
return({struct _tuple16 _tmp5CF;({union Cyc_CfFlowInfo_FlowInfo _tmp6C6=Cyc_CfFlowInfo_BottomFL();_tmp5CF.f1=_tmp6C6;}),_tmp5CF.f2=_tmp125->unknown_all;_tmp5CF;});}
# 1171
({union Cyc_CfFlowInfo_FlowInfo _tmp6C9=({struct Cyc_NewControlFlow_AnalEnv*_tmp6C8=env;union Cyc_CfFlowInfo_FlowInfo _tmp6C7=inflow;Cyc_NewControlFlow_expand_unique_places(_tmp6C8,_tmp6C7,({struct Cyc_Absyn_Exp*_tmp173[2U];_tmp173[0]=_tmp2CC,_tmp173[1]=_tmp2CB;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp173,sizeof(struct Cyc_Absyn_Exp*),2U));}));});inflow=_tmp6C9;});{
# 1173
...
return({struct _tuple16 _tmp5D1;({union Cyc_CfFlowInfo_FlowInfo _tmp6CB=Cyc_CfFlowInfo_BottomFL();_tmp5D1.f1=_tmp6CB;}),({void*_tmp6CA=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5D1.f2=_tmp6CA;});_tmp5D1;});}case 10U: _LL48: _tmp2D1=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2D0=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL49: {
# 1191
...
struct Cyc_NewControlFlow_AnalEnv*_tmp6CD=env;union Cyc_CfFlowInfo_FlowInfo _tmp6CC=_tmp1BA;Cyc_NewControlFlow_anal_Rexps(_tmp6CD,_tmp6CC,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_copy)(_tmp2D0),0,1);});
# 1195
...
# 1215
({struct Cyc_List_List*_tmp6CE=({struct Cyc_List_List*_tmp194=_cycalloc(sizeof(*_tmp194));_tmp194->hd=(void*)_tmp197,_tmp194->tl=init_params;_tmp194;});init_params=_tmp6CE;});goto _LLC4;case 21U: _LLC7: _tmp198=((struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*)_tmp193)->f1;_LLC8:
# 1217
({struct Cyc_List_List*_tmp6CF=({struct Cyc_List_List*_tmp195=_cycalloc(sizeof(*_tmp195));_tmp195->hd=(void*)_tmp198,_tmp195->tl=nolive_unique_params;_tmp195;});nolive_unique_params=_tmp6CF;});
goto _LLC4;case 22U: _LLC9: _tmp199=((struct Cyc_Absyn_Noconsume_att_Absyn_Attribute_struct*)_tmp193)->f1;_LLCA:
# 1221
({struct Cyc_List_List*_tmp6D0=({struct Cyc_List_List*_tmp196=_cycalloc(sizeof(*_tmp196));_tmp196->hd=(void*)_tmp199,_tmp196->tl=noconsume_params;_tmp196;});noconsume_params=_tmp6D0;});
goto _LLC4;default: _LLCB: _LLCC:
 goto _LLC4;}_LLC4:;}
# 1225
goto _LLBF;}else{_LLC2: _LLC3:
({void*_tmp19A=0U;({struct _dyneither_ptr _tmp6D1=({const char*_tmp19B="anal_Rexp: bad function type";_tag_dyneither(_tmp19B,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6D1,_tag_dyneither(_tmp19A,sizeof(void*),0U));});});}_LLBF:;}
# 1228
goto _LLBA;}else{_LLBD: _LLBE:
({void*_tmp19F=0U;({struct _dyneither_ptr _tmp6D2=({const char*_tmp1A0="anal_Rexp: bad function type";_tag_dyneither(_tmp1A0,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6D2,_tag_dyneither(_tmp19F,sizeof(void*),0U));});});}_LLBA:;}
# 1231
...
({void*_tmp1A5=0U;({unsigned int _tmp6D4=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp2D0))->hd)->loc;struct _dyneither_ptr _tmp6D3=({const char*_tmp1A6="expression may not be initialized";_tag_dyneither(_tmp1A6,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6D4,_tmp6D3,_tag_dyneither(_tmp1A5,sizeof(void*),0U));});});
...
# 1249
({struct Cyc_Dict_Dict _tmp6D9=({struct Cyc_CfFlowInfo_FlowEnv*_tmp6D8=_tmp125;unsigned int _tmp6D7=((struct Cyc_Absyn_Exp*)_tmp2D0->hd)->loc;struct Cyc_Dict_Dict _tmp6D6=_tmp1A8;struct Cyc_CfFlowInfo_Place*_tmp6D5=_tmp1B2;Cyc_CfFlowInfo_assign_place(_tmp6D8,_tmp6D7,_tmp6D6,_tmp6D5,
Cyc_CfFlowInfo_typ_to_absrval(_tmp125,_tmp1AF,0,_tmp125->esc_all));});
# 1249
_tmp1A8=_tmp6D9;});
# 1253
goto _LLE1;}else{_LLE4: _LLE5:
({void*_tmp1AD=0U;({struct _dyneither_ptr _tmp6DA=({const char*_tmp1AE="anal_Rexp:bad type for initialized arg";_tag_dyneither(_tmp1AE,sizeof(char),39U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6DA,_tag_dyneither(_tmp1AD,sizeof(void*),0U));});});}_LLE1:;}
# 1256
goto _LLDA;case 5U: _LLDD: _LLDE:
# 1258
({void*_tmp1B0=0U;({struct _dyneither_ptr _tmp6DB=({const char*_tmp1B1="anal_Rexp:initialize attribute on unique pointers not yet supported";_tag_dyneither(_tmp1B1,sizeof(char),68U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp6DB,_tag_dyneither(_tmp1B0,sizeof(void*),0U));});});default: _LLDF: _LLE0:
# 1260
 goto _LLDA;}_LLDA:;}
# 1262
({union Cyc_CfFlowInfo_FlowInfo _tmp6DC=Cyc_CfFlowInfo_ReachableFL(_tmp1A8,_tmp1B3);_tmp18D=_tmp6DC;});
goto _LLD5;}}_LLD5:;}
# 1265
...
# 1273
({union Cyc_CfFlowInfo_FlowInfo _tmp6E1=({struct Cyc_NewControlFlow_AnalEnv*_tmp6E0=env;unsigned int _tmp6DF=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp2D0))->hd)->loc;void*_tmp6DE=(void*)_check_null(((struct Cyc_Absyn_Exp*)_tmp2D0->hd)->topt);union Cyc_CfFlowInfo_FlowInfo _tmp6DD=_tmp18D;Cyc_NewControlFlow_use_nounique_Rval(_tmp6E0,_tmp6DF,_tmp6DE,_tmp6DD,(void*)_tmp1B7->hd);});_tmp18D=_tmp6E1;});else{
# 1283
({union Cyc_CfFlowInfo_FlowInfo _tmp6E2=Cyc_NewControlFlow_use_Rval(env,((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp2D0))->hd)->loc,_tmp18D,(void*)_tmp1B7->hd);_tmp18D=_tmp6E2;});
...
({union Cyc_CfFlowInfo_FlowInfo _tmp6E3=Cyc_NewControlFlow_restore_noconsume_arg(env,_tmp18D,(struct Cyc_Absyn_Exp*)_tmp2D0->hd,((struct Cyc_Absyn_Exp*)_tmp2D0->hd)->loc,(void*)_tmp1B7->hd);_tmp18D=_tmp6E3;});}}}}
# 1290
...
return({struct _tuple16 _tmp5D2;({union Cyc_CfFlowInfo_FlowInfo _tmp6E5=Cyc_CfFlowInfo_BottomFL();_tmp5D2.f1=_tmp6E5;}),({void*_tmp6E4=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5D2.f2=_tmp6E4;});_tmp5D2;});else{
# 1296
return({struct _tuple16 _tmp5D3;_tmp5D3.f1=_tmp18D,({void*_tmp6E6=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5D3.f2=_tmp6E6;});_tmp5D3;});}};};}case 34U: _LL4A: _tmp2D6=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp138)->f1).is_calloc;_tmp2D5=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp138)->f1).rgn;_tmp2D4=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp138)->f1).elt_type;_tmp2D3=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp138)->f1).num_elts;_tmp2D2=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp138)->f1).fat_result;_LL4B: {
# 1299
void*place_val;
if(_tmp2D2)place_val=_tmp125->notzeroall;else{
if(_tmp2D6)({void*_tmp6E7=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,*((void**)_check_null(_tmp2D4)),0,_tmp125->zero);place_val=_tmp6E7;});else{
({void*_tmp6E8=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,*((void**)_check_null(_tmp2D4)),0,_tmp125->unknown_none);place_val=_tmp6E8;});}}{
union Cyc_CfFlowInfo_FlowInfo outflow;
if(_tmp2D5 != 0){
struct _tuple23 _tmp1BB=({struct Cyc_NewControlFlow_AnalEnv*_tmp6EA=env;union Cyc_CfFlowInfo_FlowInfo _tmp6E9=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6EA,_tmp6E9,({struct Cyc_Absyn_Exp*_tmp1BF[2U];_tmp1BF[0]=_tmp2D5,_tmp1BF[1]=_tmp2D3;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1BF,sizeof(struct Cyc_Absyn_Exp*),2U));}),1,1);});struct _tuple23 _tmp1BC=_tmp1BB;union Cyc_CfFlowInfo_FlowInfo _tmp1BE;struct Cyc_List_List*_tmp1BD;_LLE7: _tmp1BE=_tmp1BC.f1;_tmp1BD=_tmp1BC.f2;_LLE8:;
...
return({struct _tuple16 _tmp5D4;_tmp5D4.f1=outflow,({void*_tmp6EB=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp1C3=_cycalloc(sizeof(*_tmp1C3));_tmp1C3->tag=5U,_tmp1C3->f1=place_val;_tmp1C3;});_tmp5D4.f2=_tmp6EB;});_tmp5D4;});else{
# 1317
...
# 1323
 return({struct _tuple16 _tmp5D6;({union Cyc_CfFlowInfo_FlowInfo _tmp6ED=({struct Cyc_Dict_Dict _tmp6EC=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp1C6,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp6EC,_tmp1C5);});_tmp5D6.f1=_tmp6ED;}),_tmp5D6.f2=rval;_tmp5D6;});}_LLEC:;}};}case 35U: _LL4C: _tmp2D8=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2D7=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL4D: {
# 1328
void*left_rval;
void*right_rval;
union Cyc_CfFlowInfo_FlowInfo outflow;
# 1334
struct _tuple23 _tmp1CA=({struct Cyc_NewControlFlow_AnalEnv*_tmp6EF=env;union Cyc_CfFlowInfo_FlowInfo _tmp6EE=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6EF,_tmp6EE,({struct Cyc_Absyn_Exp*_tmp1E5[2U];_tmp1E5[0]=_tmp2D8,_tmp1E5[1]=_tmp2D7;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1E5,sizeof(struct Cyc_Absyn_Exp*),2U));}),0,0);});struct _tuple23 _tmp1CB=_tmp1CA;union Cyc_CfFlowInfo_FlowInfo _tmp1E4;struct Cyc_List_List*_tmp1E3;_LLF2: _tmp1E4=_tmp1CB.f1;_tmp1E3=_tmp1CB.f2;_LLF3:;
...
({void*_tmp1CD=0U;({unsigned int _tmp6F1=_tmp2D8->loc;struct _dyneither_ptr _tmp6F0=({const char*_tmp1CE="cannot swap value into zeroterm array not known to be 0";_tag_dyneither(_tmp1CE,sizeof(char),56U);});Cyc_CfFlowInfo_aerr(_tmp6F1,_tmp6F0,_tag_dyneither(_tmp1CD,sizeof(void*),0U));});});}_LLF4:;}else{
# 1351
...
({void*_tmp1D0=0U;({unsigned int _tmp6F3=_tmp2D7->loc;struct _dyneither_ptr _tmp6F2=({const char*_tmp1D1="cannot swap value into zeroterm array not known to be 0";_tag_dyneither(_tmp1D1,sizeof(char),56U);});Cyc_CfFlowInfo_aerr(_tmp6F3,_tmp6F2,_tag_dyneither(_tmp1D0,sizeof(void*),0U));});});}_LLF9:;}}{
# 1359
...
# 1365
({struct Cyc_Dict_Dict _tmp6F4=Cyc_CfFlowInfo_assign_place(_tmp125,_tmp2D8->loc,_tmp1E0,_tmp1DA,right_rval);_tmp1E0=_tmp6F4;});
goto _LL109;}else{_LL10C: _LL10D:
# 1371
 if(Cyc_CfFlowInfo_initlevel(_tmp125,_tmp1E0,right_rval)!= Cyc_CfFlowInfo_AllIL)
({void*_tmp1D8=0U;({unsigned int _tmp6F6=_tmp2D7->loc;struct _dyneither_ptr _tmp6F5=({const char*_tmp1D9="expression may not be fully initialized";_tag_dyneither(_tmp1D9,sizeof(char),40U);});Cyc_CfFlowInfo_aerr(_tmp6F6,_tmp6F5,_tag_dyneither(_tmp1D8,sizeof(void*),0U));});});
goto _LL109;}_LL109:;}
# 1375
...
# 1377
({struct Cyc_Dict_Dict _tmp6F7=Cyc_CfFlowInfo_assign_place(_tmp125,_tmp2D7->loc,_tmp1E0,_tmp1DE,left_rval);_tmp1E0=_tmp6F7;});
goto _LL10E;}else{_LL111: _LL112:
# 1380
 if(Cyc_CfFlowInfo_initlevel(_tmp125,_tmp1E0,left_rval)!= Cyc_CfFlowInfo_AllIL)
({void*_tmp1DC=0U;({unsigned int _tmp6F9=_tmp2D8->loc;struct _dyneither_ptr _tmp6F8=({const char*_tmp1DD="expression may not be fully initialized";_tag_dyneither(_tmp1DD,sizeof(char),40U);});Cyc_CfFlowInfo_aerr(_tmp6F9,_tmp6F8,_tag_dyneither(_tmp1DC,sizeof(void*),0U));});});
goto _LL10E;}_LL10E:;}
# 1385
({struct Cyc_List_List*_tmp6FA=Cyc_Relations_reln_kill_exp(Cyc_Core_heap_region,_tmp1DF,_tmp2D8);_tmp1DF=_tmp6FA;});
({struct Cyc_List_List*_tmp6FB=Cyc_Relations_reln_kill_exp(Cyc_Core_heap_region,_tmp1DF,_tmp2D7);_tmp1DF=_tmp6FB;});
# 1388
({union Cyc_CfFlowInfo_FlowInfo _tmp6FC=Cyc_CfFlowInfo_ReachableFL(_tmp1E0,_tmp1DF);outflow=_tmp6FC;});
Cyc_NewControlFlow_update_tryflow(env,outflow);
...
# 1410
if(Cyc_Tcutil_is_noalias_pointer((void*)_check_null(e->topt),1))
return({struct _tuple16 _tmp5D8;_tmp5D8.f1=outflow,({void*_tmp6FF=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp1EF=_cycalloc(sizeof(*_tmp1EF));_tmp1EF->tag=5U,_tmp1EF->f1=place_val;_tmp1EF;});_tmp5D8.f2=_tmp6FF;});_tmp5D8;});else{
# 1414
...
# 1420
 return({struct _tuple16 _tmp5DA;({union Cyc_CfFlowInfo_FlowInfo _tmp701=({struct Cyc_Dict_Dict _tmp700=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp1F2,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp700,_tmp1F1);});_tmp5DA.f1=_tmp701;}),_tmp5DA.f2=rval;_tmp5DA;});}_LL119:;}}case 15U: _LL50: _tmp2DB=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL51: {
# 1425
...
union Cyc_CfFlowInfo_AbsLVal _tmp1F8=_tmp1FB;struct Cyc_CfFlowInfo_Place*_tmp1FA;if((_tmp1F8.UnknownL).tag == 2){_LL122: _LL123:
 ...
 return({struct _tuple16 _tmp5DC;_tmp5DC.f1=_tmp1FC,({void*_tmp702=(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp1F9=_cycalloc(sizeof(*_tmp1F9));_tmp1F9->tag=4U,_tmp1F9->f1=_tmp1FA;_tmp1F9;});_tmp5DC.f2=_tmp702;});_tmp5DC;});}_LL121:;};}case 20U: _LL52: _tmp2DC=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL53: {
# 1432
...
return({struct _tuple16 _tmp5DD;_tmp5DD.f1=_tmp212,({void*_tmp703=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5DD.f2=_tmp703;});_tmp5DD;});
...
return({struct _tuple16 _tmp5DE;_tmp5DE.f1=_tmp212,({void*_tmp704=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),1,_tmp125->unknown_none);_tmp5DE.f2=_tmp704;});_tmp5DE;});
...
# 1451
({void*_tmp208=0U;({struct Cyc___cycFILE*_tmp706=Cyc_stderr;struct _dyneither_ptr _tmp705=({const char*_tmp209="the bad rexp is :";_tag_dyneither(_tmp209,sizeof(char),18U);});Cyc_fprintf(_tmp706,_tmp705,_tag_dyneither(_tmp208,sizeof(void*),0U));});});
Cyc_CfFlowInfo_print_absrval(_tmp210);
({struct Cyc_String_pa_PrintArg_struct _tmp20C=({struct Cyc_String_pa_PrintArg_struct _tmp5E0;_tmp5E0.tag=0U,({struct _dyneither_ptr _tmp707=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp5E0.f1=_tmp707;});_tmp5E0;});void*_tmp20A[1U];_tmp20A[0]=& _tmp20C;({struct _dyneither_ptr _tmp708=({const char*_tmp20B="\nanal_Rexp: AggrMember: %s";_tag_dyneither(_tmp20B,sizeof(char),27U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp708,_tag_dyneither(_tmp20A,sizeof(void*),1U));});});}_LL12F:;};};};}case 38U: _LL56: _tmp2E0=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2DF=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL57: {
# 1459
...
# 1475
({struct Cyc_String_pa_PrintArg_struct _tmp21B=({struct Cyc_String_pa_PrintArg_struct _tmp5E5;_tmp5E5.tag=0U,({struct _dyneither_ptr _tmp709=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp5E5.f1=_tmp709;});_tmp5E5;});void*_tmp219[1U];_tmp219[0]=& _tmp21B;({struct _dyneither_ptr _tmp70A=({const char*_tmp21A="anal_Rexp: TagCheck_e: %s";_tag_dyneither(_tmp21A,sizeof(char),26U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp70A,_tag_dyneither(_tmp219,sizeof(void*),1U));});});}_LL13A:;};};}case 22U: _LL58: _tmp2E2=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2E1=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL59: {
# 1479
...
# 1489
return({struct _tuple16 _tmp5E6;_tmp5E6.f1=_tmp236,({void*_tmp70B=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5E6.f2=_tmp70B;});_tmp5E6;});
# 1491
...
return({struct _tuple16 _tmp5E7;_tmp5E7.f1=_tmp236,({void*_tmp70C=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),1,_tmp125->unknown_none);_tmp5E7.f2=_tmp70C;});_tmp5E7;});
...
({void*_tmp22C=0U;({struct _dyneither_ptr _tmp70D=({const char*_tmp22D="anal_Rexp: AggrArrow";_tag_dyneither(_tmp22D,sizeof(char),21U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp70D,_tag_dyneither(_tmp22C,sizeof(void*),0U));});});}_LL14D:;};};}else{_LL148: _LL149:
# 1503
({void*_tmp232=0U;({struct _dyneither_ptr _tmp70E=({const char*_tmp233="anal_Rexp: AggrArrow ptr";_tag_dyneither(_tmp233,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp70E,_tag_dyneither(_tmp232,sizeof(void*),0U));});});}_LL145:;};};}case 6U: _LL5A: _tmp2E5=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2E4=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_tmp2E3=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp138)->f3;_LL5B: {
# 1507
...
({void*_tmp257=0U;({unsigned int _tmp712=_tmp2EA->loc;struct _dyneither_ptr _tmp711=({const char*_tmp258="expression may not be initialized";_tag_dyneither(_tmp258,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp712,_tmp711,_tag_dyneither(_tmp257,sizeof(void*),0U));});});{
struct Cyc_List_List*_tmp259=Cyc_NewControlFlow_add_subscript_reln(_tmp25A,_tmp2EB,_tmp2EA);
if(_tmp25A != _tmp259)
({union Cyc_CfFlowInfo_FlowInfo _tmp713=Cyc_CfFlowInfo_ReachableFL(_tmp25B,_tmp259);_tmp255=_tmp713;});
...
({void*_tmp261=0U;({struct _dyneither_ptr _tmp714=({const char*_tmp262="anal_Rexp: Subscript";_tag_dyneither(_tmp262,sizeof(char),21U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp714,_tag_dyneither(_tmp261,sizeof(void*),0U));});});}_LL173:;};}case 3U: _LL16C: _LL16D: {
# 1554
...
# 1559
({void*_tmp26A=0U;({struct _dyneither_ptr _tmp715=({const char*_tmp26B="anal_Rexp: Subscript -- bad type";_tag_dyneither(_tmp26B,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp715,_tag_dyneither(_tmp26A,sizeof(void*),0U));});});}_LL169:;};};}case 24U: _LL64: _tmp2EC=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL65: {
# 1565
...
void*_tmp716=({void*_tmp273=(void*)((struct Cyc_List_List*)_check_null(_tmp276))->hd;
_tmp276=_tmp276->tl;
_tmp273;});
# 1568
_tmp274[i]=_tmp716;});}}0;});_tag_dyneither(_tmp274,sizeof(void*),_tmp275);});
# 1572
return({struct _tuple16 _tmp5F0;_tmp5F0.f1=_tmp277,({void*_tmp717=(void*)({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp272=_cycalloc(sizeof(*_tmp272));_tmp272->tag=6U,(_tmp272->f1).is_union=0,(_tmp272->f1).fieldnum=- 1,_tmp272->f2=aggrdict;_tmp272;});_tmp5F0.f2=_tmp717;});_tmp5F0;});};}case 30U: _LL66: _tmp2ED=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_LL67: {
# 1575
...
({void*_tmp27A=0U;({struct _dyneither_ptr _tmp718=({const char*_tmp27B="anal_Rexp:anon struct has bad type";_tag_dyneither(_tmp27B,sizeof(char),35U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp718,_tag_dyneither(_tmp27A,sizeof(void*),0U));});});}_LL183:;}
# 1580
...
({void*_tmp281=0U;({struct _dyneither_ptr _tmp71B=({const char*_tmp282="anal_Rexp:Aggregate_e";_tag_dyneither(_tmp282,sizeof(char),22U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp71B,_tag_dyneither(_tmp281,sizeof(void*),0U));});});}else{_LL18E: _tmp284=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp280)->f1;_LL18F:
# 1594
({int _tmp71C=Cyc_CfFlowInfo_get_field_index_fs(_tmp2EE,_tmp284);field_no=_tmp71C;});
...
({union Cyc_CfFlowInfo_FlowInfo _tmp71D=Cyc_NewControlFlow_use_Rval(env,_tmp283->loc,_tmp288,(void*)_tmp287->hd);_tmp288=_tmp71D;});
# 1601
...
# 1608
({struct Cyc_String_pa_PrintArg_struct _tmp28B=({struct Cyc_String_pa_PrintArg_struct _tmp5F3;_tmp5F3.tag=0U,({struct _dyneither_ptr _tmp71E=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp5F3.f1=_tmp71E;});_tmp5F3;});void*_tmp289[1U];_tmp289[0]=& _tmp28B;({struct _dyneither_ptr _tmp71F=({const char*_tmp28A="anal_Rexp:missing aggrdeclimpl in %s";_tag_dyneither(_tmp28A,sizeof(char),37U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp71F,_tag_dyneither(_tmp289,sizeof(void*),1U));});});}case 26U: _LL6C: _tmp2F1=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL6D: {
# 1610
...
({union Cyc_CfFlowInfo_FlowInfo _tmp720=Cyc_NewControlFlow_use_Rval(env,((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp28C))->hd)->loc,_tmp290,(void*)_tmp28F->hd);_tmp290=_tmp720;});}
return({struct _tuple16 _tmp5F4;_tmp5F4.f1=_tmp290,({void*_tmp721=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,(void*)_check_null(e->topt),0,_tmp125->unknown_all);_tmp5F4.f2=_tmp721;});_tmp5F4;});}case 27U: _LL6E: _tmp2F5=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_tmp2F4=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp138)->f2;_tmp2F3=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp138)->f3;_tmp2F2=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp138)->f4;_LL6F: {
# 1618
...
({void*_tmp294=0U;({unsigned int _tmp723=_tmp2F4->loc;struct _dyneither_ptr _tmp722=({const char*_tmp295="expression may not be initialized";_tag_dyneither(_tmp295,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp723,_tmp722,_tag_dyneither(_tmp294,sizeof(void*),0U));});});{
# 1626
...
({struct Cyc_List_List*_tmp724=Cyc_Relations_add_relation(Cyc_Core_heap_region,n1,Cyc_Relations_Rlt,n2,_tmp2AA);new_relns=_tmp724;});
if(_tmp2AA != new_relns)
({union Cyc_CfFlowInfo_FlowInfo _tmp725=Cyc_CfFlowInfo_ReachableFL(_tmp2AB,new_relns);_tmp2AD=_tmp725;});{
# 1635
...
({union Cyc_CfFlowInfo_FlowInfo _tmp726=Cyc_NewControlFlow_add_vars(_tmp125,_tmp2AD,& _tmp297,_tmp125->unknown_all,e->loc,0);_tmp2AD=_tmp726;});{
# 1642
...
({void*_tmp29B=0U;({unsigned int _tmp728=_tmp2F4->loc;struct _dyneither_ptr _tmp727=({const char*_tmp29C="expression may not be initialized";_tag_dyneither(_tmp29C,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp728,_tmp727,_tag_dyneither(_tmp29B,sizeof(void*),0U));});});
return({struct _tuple16 _tmp5F8;({union Cyc_CfFlowInfo_FlowInfo _tmp729=Cyc_CfFlowInfo_BottomFL();_tmp5F8.f1=_tmp729;}),_tmp5F8.f2=_tmp125->unknown_all;_tmp5F8;});}}_LL1A7:;}
# 1651
_tmp2AD=_tmp29F;
...
({union Cyc_CfFlowInfo_FlowInfo _tmp72A=Cyc_NewControlFlow_add_vars(_tmp125,_tmp2AD,& _tmp2A0,_tmp125->unknown_all,e->loc,0);_tmp2AD=_tmp72A;});{
...
({void*_tmp2A4=0U;({unsigned int _tmp72C=_tmp2F4->loc;struct _dyneither_ptr _tmp72B=({const char*_tmp2A5="expression may not be initialized";_tag_dyneither(_tmp2A5,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp72C,_tmp72B,_tag_dyneither(_tmp2A4,sizeof(void*),0U));});});
return({struct _tuple16 _tmp5FA;({union Cyc_CfFlowInfo_FlowInfo _tmp72D=Cyc_CfFlowInfo_BottomFL();_tmp5FA.f1=_tmp72D;}),_tmp5FA.f2=_tmp125->unknown_all;_tmp5FA;});}}_LL1AF:;}{
# 1666
...
void*place_val;
# 1685
({void*_tmp72E=Cyc_CfFlowInfo_typ_to_absrval(_tmp125,_tmp2F7,0,_tmp125->unknown_none);place_val=_tmp72E;});{
union Cyc_CfFlowInfo_FlowInfo outflow;
...
# 1692
 return({struct _tuple16 _tmp5FE;({union Cyc_CfFlowInfo_FlowInfo _tmp730=({struct Cyc_Dict_Dict _tmp72F=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp2B2,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp72F,_tmp2B1);});_tmp5FE.f1=_tmp730;}),_tmp5FE.f2=rval;_tmp5FE;});}_LL1B7:;};};}case 37U: _LL72: _tmp2F9=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp138)->f1;_LL73: {
# 1696
...
({void*_tmp2B9=0U;({struct _dyneither_ptr _tmp731=({const char*_tmp2BA="anal_Rexp, unexpected exp form";_tag_dyneither(_tmp2BA,sizeof(char),31U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp731,_tag_dyneither(_tmp2B9,sizeof(void*),0U));});});}_LLD:;};}
...
union Cyc_CfFlowInfo_FlowInfo _tmp2FD=f;struct Cyc_Dict_Dict _tmp31D;struct Cyc_List_List*_tmp31C;if((_tmp2FD.BottomFL).tag == 1){_LL6: _LL7:
 return({struct _tuple18 _tmp601;_tmp601.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp732=Cyc_CfFlowInfo_UnknownL();_tmp601.f2=_tmp732;});_tmp601;});}else{_LL8: _tmp31D=((_tmp2FD.ReachableFL).val).f1;_tmp31C=((_tmp2FD.ReachableFL).val).f2;_LL9: {
# 1732
...
# 1735
({void*_tmp301=0U;({struct _dyneither_ptr _tmp733=({const char*_tmp302="named location in anal_derefL";_tag_dyneither(_tmp302,sizeof(char),30U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp733,_tag_dyneither(_tmp301,sizeof(void*),0U));});});case 1U: _LL10: _LL11:
# 1737
({void*_tmp734=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp303=_cycalloc(sizeof(*_tmp303));_tmp303->tag=Cyc_CfFlowInfo_NotZero,_tmp303->f1=_tmp31C;_tmp303;});e->annot=_tmp734;});goto _LLD;case 5U: _LL12: _tmp30D=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp300)->f1;_LL13:
# 1740
 if(expanded_place_possibly_null)
# 1743
({void*_tmp735=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp304=_cycalloc(sizeof(*_tmp304));_tmp304->tag=Cyc_CfFlowInfo_UnknownZ,_tmp304->f1=_tmp31C;_tmp304;});e->annot=_tmp735;});else{
# 1746
...
# 1750
({void*_tmp736=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp307=_cycalloc(sizeof(*_tmp307));_tmp307->tag=Cyc_CfFlowInfo_UnknownZ,_tmp307->f1=_tmp31C;_tmp307;});e->annot=_tmp736;});
goto _LL1E;}else{_LL21: _LL22:
# 1753
({void*_tmp737=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp308=_cycalloc(sizeof(*_tmp308));_tmp308->tag=Cyc_CfFlowInfo_NotZero,_tmp308->f1=_tmp31C;_tmp308;});e->annot=_tmp737;});
goto _LL1E;}_LL1E:;}
# 1758
if(Cyc_Tcutil_is_bound_one(_tmp320))return({struct _tuple18 _tmp602;_tmp602.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp738=Cyc_CfFlowInfo_UnknownL();_tmp602.f2=_tmp738;});_tmp602;});
...
# 1762
({void*_tmp739=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp309=_cycalloc(sizeof(*_tmp309));_tmp309->tag=Cyc_CfFlowInfo_NotZero,_tmp309->f1=_tmp31C;_tmp309;});e->annot=_tmp739;});
if(Cyc_Tcutil_is_bound_one(_tmp320))
return({struct _tuple18 _tmp603;_tmp603.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp73B=Cyc_CfFlowInfo_PlaceL(({struct Cyc_CfFlowInfo_Place*_tmp30A=_cycalloc(sizeof(*_tmp30A));_tmp30A->root=_tmp30F,({struct Cyc_List_List*_tmp73A=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp30E,path);_tmp30A->path=_tmp73A;});_tmp30A;}));_tmp603.f2=_tmp73B;});_tmp603;});
goto _LLD;case 0U: _LL16: _LL17:
# 1767
 e->annot=(void*)& Cyc_CfFlowInfo_IsZero_val;
return({struct _tuple18 _tmp604;({union Cyc_CfFlowInfo_FlowInfo _tmp73D=Cyc_CfFlowInfo_BottomFL();_tmp604.f1=_tmp73D;}),({union Cyc_CfFlowInfo_AbsLVal _tmp73C=Cyc_CfFlowInfo_UnknownL();_tmp604.f2=_tmp73C;});_tmp604;});case 2U: _LL18: _tmp310=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp300)->f1;_LL19:
# 1772
 if(Cyc_Tcutil_is_bound_one(_tmp320))
({union Cyc_CfFlowInfo_FlowInfo _tmp73E=Cyc_NewControlFlow_notzero(env,inflow,f,e,_tmp310,_tmp31A);f=_tmp73E;});
({void*_tmp73F=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp30B=_cycalloc(sizeof(*_tmp30B));_tmp30B->tag=Cyc_CfFlowInfo_UnknownZ,_tmp30B->f1=_tmp31C;_tmp30B;});e->annot=_tmp73F;});
...
# 1782
({void*_tmp740=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp30C=_cycalloc(sizeof(*_tmp30C));_tmp30C->tag=Cyc_CfFlowInfo_UnknownZ,_tmp30C->f1=_tmp31C;_tmp30C;});e->annot=_tmp740;});
goto _LLD;}_LLD:;}
# 1785
...
# 1789
({void*_tmp315=0U;({unsigned int _tmp742=e->loc;struct _dyneither_ptr _tmp741=({const char*_tmp316="attempt to dereference an alias-free that has already been copied";_tag_dyneither(_tmp316,sizeof(char),66U);});Cyc_CfFlowInfo_aerr(_tmp742,_tmp741,_tag_dyneither(_tmp315,sizeof(void*),0U));});});
goto _LL26;}else{_LL29: _LL2A:
# 1792
({void*_tmp317=0U;({unsigned int _tmp744=e->loc;struct _dyneither_ptr _tmp743=({const char*_tmp318="dereference of possibly uninitialized pointer";_tag_dyneither(_tmp318,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp744,_tmp743,_tag_dyneither(_tmp317,sizeof(void*),0U));});});
goto _LL26;}_LL26:;};}
# 1796
return({struct _tuple18 _tmp605;_tmp605.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp745=Cyc_CfFlowInfo_UnknownL();_tmp605.f2=_tmp745;});_tmp605;});}}_LL5:;}}else{_LL3: _LL4:
# 1798
({void*_tmp31E=0U;({struct _dyneither_ptr _tmp746=({const char*_tmp31F="left deref of non-pointer-type";_tag_dyneither(_tmp31F,sizeof(char),31U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp746,_tag_dyneither(_tmp31E,sizeof(void*),0U));});});}_LL0:;}
# 1804
...
({struct Cyc_List_List*_tmp748=({struct Cyc_List_List*_tmp323=_cycalloc(sizeof(*_tmp323));({void*_tmp747=(void*)({struct Cyc_CfFlowInfo_Star_CfFlowInfo_PathCon_struct*_tmp322=_cycalloc(sizeof(*_tmp322));_tmp322->tag=1U;_tmp322;});_tmp323->hd=_tmp747;}),_tmp323->tl=path;_tmp323;});path=_tmp748;});
return({struct Cyc_CfFlowInfo_Place*_tmp324=_cycalloc(sizeof(*_tmp324));_tmp324->root=_tmp326,({struct Cyc_List_List*_tmp749=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp325,path);_tmp324->path=_tmp749;});_tmp324;});}
# 1814
...
{union Cyc_CfFlowInfo_FlowInfo _tmp328=inflow;struct Cyc_Dict_Dict _tmp32A;struct Cyc_List_List*_tmp329;if((_tmp328.BottomFL).tag == 1){_LL1: _LL2:
 return({struct _tuple18 _tmp606;({union Cyc_CfFlowInfo_FlowInfo _tmp74B=Cyc_CfFlowInfo_BottomFL();_tmp606.f1=_tmp74B;}),({union Cyc_CfFlowInfo_AbsLVal _tmp74A=Cyc_CfFlowInfo_UnknownL();_tmp606.f2=_tmp74A;});_tmp606;});}else{_LL3: _tmp32A=((_tmp328.ReachableFL).val).f1;_tmp329=((_tmp328.ReachableFL).val).f2;_LL4:
# 1823
 d=_tmp32A;}_LL0:;}{
# 1827
...
# 1835
 return({struct _tuple18 _tmp607;_tmp607.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp74D=Cyc_CfFlowInfo_PlaceL(({struct Cyc_CfFlowInfo_Place*_tmp32E=_cycalloc(sizeof(*_tmp32E));({void*_tmp74C=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp32D=_cycalloc(sizeof(*_tmp32D));_tmp32D->tag=0U,_tmp32D->f1=_tmp37B;_tmp32D;});_tmp32E->root=_tmp74C;}),_tmp32E->path=path;_tmp32E;}));_tmp607.f2=_tmp74D;});_tmp607;});case 1U: _LL12: _tmp37C=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp32C)->f1)->f1;_LL13:
# 1837
 return({struct _tuple18 _tmp608;_tmp608.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp74E=Cyc_CfFlowInfo_UnknownL();_tmp608.f2=_tmp74E;});_tmp608;});default: goto _LL1C;}case 22U: _LL14: _tmp37E=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp32C)->f1;_tmp37D=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp32C)->f2;_LL15:
# 1840
...
({struct Cyc_List_List*_tmp751=({struct Cyc_List_List*_tmp332=_cycalloc(sizeof(*_tmp332));({void*_tmp750=(void*)({struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*_tmp331=_cycalloc(sizeof(*_tmp331));_tmp331->tag=0U,({int _tmp74F=Cyc_CfFlowInfo_get_field_index(_tmp335,_tmp37D);_tmp331->f1=_tmp74F;});_tmp331;});_tmp332->hd=_tmp750;}),_tmp332->tl=path;_tmp332;});path=_tmp751;});}
# 1846
goto _LL1E;}else{_LL21: _LL22:
({void*_tmp333=0U;({struct _dyneither_ptr _tmp752=({const char*_tmp334="anal_Lexp: AggrArrow ptr";_tag_dyneither(_tmp334,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp752,_tag_dyneither(_tmp333,sizeof(void*),0U));});});}_LL1E:;}
# 1849
...
# 1864
({void*_tmp33F=0U;({struct _dyneither_ptr _tmp753=({const char*_tmp340="bad named location in anal_Lexp:deref";_tag_dyneither(_tmp340,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp753,_tag_dyneither(_tmp33F,sizeof(void*),0U));});});case 7U: switch(*((int*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp33E)->f3)){case 4U: _LL31: _LL32:
...
return({struct _tuple18 _tmp609;_tmp609.f1=_tmp343,({union Cyc_CfFlowInfo_AbsLVal _tmp754=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(_tmp352,path));_tmp609.f2=_tmp754;});_tmp609;});}case 1U: _LL39: _LL3A:
# 1875
...
void*res=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp349=_cycalloc(sizeof(*_tmp349));_tmp349->tag=5U,({void*_tmp757=({struct Cyc_CfFlowInfo_FlowEnv*_tmp756=_tmp327;void*_tmp755=Cyc_Tcutil_pointer_elt_type((void*)_check_null(_tmp37F->topt));Cyc_CfFlowInfo_typ_to_absrval(_tmp756,_tmp755,0,leaf);});_tmp349->f1=_tmp757;});_tmp349;});
for(0;_tmp350 != 0;_tmp350=_tmp350->tl){
({void*_tmp758=(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp344=_cycalloc(sizeof(*_tmp344));_tmp344->tag=8U,_tmp344->f1=(struct Cyc_Absyn_Vardecl*)_tmp350->hd,_tmp344->f2=res;_tmp344;});res=_tmp758;});}
({struct Cyc_Dict_Dict _tmp759=Cyc_CfFlowInfo_assign_place(_tmp327,e->loc,_tmp354,_tmp352,res);_tmp354=_tmp759;});{
...
# 1897
return({struct _tuple18 _tmp60A;_tmp60A.f1=_tmp348,({union Cyc_CfFlowInfo_AbsLVal _tmp75A=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(_tmp352,path));_tmp60A.f2=_tmp75A;});_tmp60A;});};}}_LL2E:;}else{
# 1901
...
return({struct _tuple18 _tmp60B;_tmp60B.f1=_tmp34F,({union Cyc_CfFlowInfo_AbsLVal _tmp75B=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(_tmp352,path));_tmp60B.f2=_tmp75B;});_tmp60B;});}default: _LL48: _LL49:
# 1910
 goto _LL43;}_LL43:;}
# 1913
...
return({struct Cyc_NewControlFlow_AnalEnv*_tmp761=env;union Cyc_CfFlowInfo_FlowInfo _tmp760=inflow;int _tmp75F=expand_unique;int _tmp75E=passthrough_consumes;struct Cyc_Absyn_Exp*_tmp75D=_tmp381;Cyc_NewControlFlow_anal_Lexp_rec(_tmp761,_tmp760,_tmp75F,_tmp75E,_tmp75D,({struct Cyc_List_List*_tmp35F=_cycalloc(sizeof(*_tmp35F));
({void*_tmp75C=(void*)({struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*_tmp35E=_cycalloc(sizeof(*_tmp35E));_tmp35E->tag=0U,_tmp35E->f1=(int)_tmp35D;_tmp35E;});_tmp35F->hd=_tmp75C;}),_tmp35F->tl=path;_tmp35F;}));});}case 3U: _LL53: _LL54: {
# 1929
struct _tuple23 _tmp360=({struct Cyc_NewControlFlow_AnalEnv*_tmp763=env;union Cyc_CfFlowInfo_FlowInfo _tmp762=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp763,_tmp762,({struct Cyc_Absyn_Exp*_tmp370[2U];_tmp370[0]=_tmp381,_tmp370[1]=_tmp380;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp370,sizeof(struct Cyc_Absyn_Exp*),2U));}),0,1);});struct _tuple23 _tmp361=_tmp360;union Cyc_CfFlowInfo_FlowInfo _tmp36F;struct Cyc_List_List*_tmp36E;_LL58: _tmp36F=_tmp361.f1;_tmp36E=_tmp361.f2;_LL59:;{
...
({void*_tmp364=0U;({unsigned int _tmp765=_tmp380->loc;struct _dyneither_ptr _tmp764=({const char*_tmp365="expression may not be initialized";_tag_dyneither(_tmp365,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp765,_tmp764,_tag_dyneither(_tmp364,sizeof(void*),0U));});});{
struct Cyc_List_List*_tmp366=Cyc_NewControlFlow_add_subscript_reln(_tmp367,_tmp381,_tmp380);
if(_tmp367 != _tmp366)
({union Cyc_CfFlowInfo_FlowInfo _tmp766=Cyc_CfFlowInfo_ReachableFL(_tmp368,_tmp366);_tmp362=_tmp766;});
...
# 1947
({void*_tmp371=0U;({struct _dyneither_ptr _tmp767=({const char*_tmp372="anal_Lexp: Subscript -- bad type";_tag_dyneither(_tmp372,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp767,_tag_dyneither(_tmp371,sizeof(void*),0U));});});}_LL50:;}case 21U: _LL1A: _tmp383=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp32C)->f1;_tmp382=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp32C)->f2;_LL1B: {
# 1951
...
return({struct _tuple18 _tmp60F;_tmp60F.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp768=Cyc_CfFlowInfo_UnknownL();_tmp60F.f2=_tmp768;});_tmp60F;});
# 1958
return({struct Cyc_NewControlFlow_AnalEnv*_tmp76F=env;union Cyc_CfFlowInfo_FlowInfo _tmp76E=inflow;int _tmp76D=expand_unique;int _tmp76C=passthrough_consumes;struct Cyc_Absyn_Exp*_tmp76B=_tmp383;Cyc_NewControlFlow_anal_Lexp_rec(_tmp76F,_tmp76E,_tmp76D,_tmp76C,_tmp76B,({struct Cyc_List_List*_tmp375=_cycalloc(sizeof(*_tmp375));
({void*_tmp76A=(void*)({struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*_tmp374=_cycalloc(sizeof(*_tmp374));_tmp374->tag=0U,({int _tmp769=Cyc_CfFlowInfo_get_field_index(_tmp373,_tmp382);_tmp374->f1=_tmp769;});_tmp374;});_tmp375->hd=_tmp76A;}),_tmp375->tl=path;_tmp375;}));});}default: _LL1C: _LL1D:
# 1962
 return({struct _tuple18 _tmp610;({union Cyc_CfFlowInfo_FlowInfo _tmp771=Cyc_CfFlowInfo_BottomFL();_tmp610.f1=_tmp771;}),({union Cyc_CfFlowInfo_AbsLVal _tmp770=Cyc_CfFlowInfo_UnknownL();_tmp610.f2=_tmp770;});_tmp610;});}_LL5:;};}
# 1966
...
({void*_tmp394=0U;({unsigned int _tmp773=((struct Cyc_Absyn_Exp*)es->hd)->loc;struct _dyneither_ptr _tmp772=({const char*_tmp395="expression may not be initialized";_tag_dyneither(_tmp395,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp773,_tmp772,_tag_dyneither(_tmp394,sizeof(void*),0U));});});
if(Cyc_CfFlowInfo_initlevel(env->fenv,_tmp3C6,_tmp3C7)== Cyc_CfFlowInfo_NoneIL  && !Cyc_CfFlowInfo_is_init_pointer(_tmp3C9))
({void*_tmp396=0U;({unsigned int _tmp775=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es->tl))->hd)->loc;struct _dyneither_ptr _tmp774=({const char*_tmp397="expression may not be initialized";_tag_dyneither(_tmp397,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp775,_tmp774,_tag_dyneither(_tmp396,sizeof(void*),0U));});});{
# 2014
...
({void*_tmp3A3=0U;({struct _dyneither_ptr _tmp776=({const char*_tmp3A4="anal_test, zero-split";_tag_dyneither(_tmp3A4,sizeof(char),22U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp776,_tag_dyneither(_tmp3A3,sizeof(void*),0U));});});}_LL25:;}
# 2030
...
({void*_tmp3AA=0U;({struct _dyneither_ptr _tmp777=({const char*_tmp3AB="anal_test, zero-split";_tag_dyneither(_tmp3AB,sizeof(char),22U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp777,_tag_dyneither(_tmp3AA,sizeof(void*),0U));});});}_LL2F:;}
# 2038
goto _LL11;}case 0U: _LL16: _LL17:
# 2040
 if(p == Cyc_Absyn_Eq)({union Cyc_CfFlowInfo_FlowInfo _tmp778=Cyc_CfFlowInfo_BottomFL();_tmp399=_tmp778;});else{
({union Cyc_CfFlowInfo_FlowInfo _tmp779=Cyc_CfFlowInfo_BottomFL();_tmp398=_tmp779;});}
...
# 2047
 if(p == Cyc_Absyn_Neq)({union Cyc_CfFlowInfo_FlowInfo _tmp77A=Cyc_CfFlowInfo_BottomFL();_tmp399=_tmp77A;});else{
({union Cyc_CfFlowInfo_FlowInfo _tmp77B=Cyc_CfFlowInfo_BottomFL();_tmp398=_tmp77B;});}
goto _LL11;}else{goto _LL20;}default: _LL20: _LL21:
 goto _LL11;}_LL11:;};};}
# 2058
{struct _tuple0 _tmp3B4=({struct _tuple0 _tmp615;({void*_tmp77D=Cyc_Tcutil_compress((void*)_check_null(_tmp392->topt));_tmp615.f1=_tmp77D;}),({
void*_tmp77C=Cyc_Tcutil_compress((void*)_check_null(_tmp393->topt));_tmp615.f2=_tmp77C;});_tmp615;});
# 2058
...
# 2084
struct Cyc_List_List*_tmp3BB=({struct _RegionHandle*_tmp781=_tmp3B7;union Cyc_Relations_RelnOp _tmp780=n2;enum Cyc_Relations_Relation _tmp77F=Cyc_Relations_flip_relation(_tmp3C3);union Cyc_Relations_RelnOp _tmp77E=n1;Cyc_Relations_add_relation(_tmp781,_tmp780,_tmp77F,_tmp77E,_tmp3C5);});
...
# 2087
 return({struct _tuple19 _tmp617;({union Cyc_CfFlowInfo_FlowInfo _tmp783=Cyc_CfFlowInfo_ReachableFL(_tmp3BF,_tmp3BA);_tmp617.f1=_tmp783;}),({union Cyc_CfFlowInfo_FlowInfo _tmp782=Cyc_CfFlowInfo_ReachableFL(_tmp3BE,_tmp3BB);_tmp617.f2=_tmp782;});_tmp617;});}else{_LL58: _tmp3C0=(((_tmp3BD.f1).ReachableFL).val).f1;_LL59:
# 2091
 return({struct _tuple19 _tmp618;({union Cyc_CfFlowInfo_FlowInfo _tmp784=Cyc_CfFlowInfo_ReachableFL(_tmp3C0,_tmp3BA);_tmp618.f1=_tmp784;}),_tmp618.f2=_tmp399;_tmp618;});}}else{if(((_tmp3BD.f2).ReachableFL).tag == 2){_LL56: _tmp3C1=(((_tmp3BD.f2).ReachableFL).val).f1;_LL57:
# 2089
 return({struct _tuple19 _tmp619;_tmp619.f1=_tmp398,({union Cyc_CfFlowInfo_FlowInfo _tmp785=Cyc_CfFlowInfo_ReachableFL(_tmp3C1,_tmp3BB);_tmp619.f2=_tmp785;});_tmp619;});}else{_LL5A: _LL5B:
# 2093
...
return({struct _tuple19 _tmp61D;({union Cyc_CfFlowInfo_FlowInfo _tmp787=Cyc_CfFlowInfo_join_flow(_tmp3CB,_tmp3D7,_tmp3D5);_tmp61D.f1=_tmp787;}),({
union Cyc_CfFlowInfo_FlowInfo _tmp786=Cyc_CfFlowInfo_join_flow(_tmp3CB,_tmp3D6,_tmp3D4);_tmp61D.f2=_tmp786;});_tmp61D;});};};}case 7U: _LL3: _tmp40A=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp3CD)->f1;_tmp409=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp3CD)->f2;_LL4: {
# 2112
...
return({struct _tuple19 _tmp61E;_tmp61E.f1=_tmp3DF,({union Cyc_CfFlowInfo_FlowInfo _tmp788=Cyc_CfFlowInfo_join_flow(_tmp3CB,_tmp3E0,_tmp3DE);_tmp61E.f2=_tmp788;});_tmp61E;});};}case 8U: _LL5: _tmp40C=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp3CD)->f1;_tmp40B=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp3CD)->f2;_LL6: {
# 2116
...
# 2137
({void*_tmp3F8=0U;({struct _dyneither_ptr _tmp78A=({const char*_tmp3F9="anal_test: bad namedlocation";_tag_dyneither(_tmp3F9,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp78A,_tag_dyneither(_tmp3F8,sizeof(void*),0U));});});case 0U: _LL38: _LL39:
 return({struct _tuple19 _tmp622;({union Cyc_CfFlowInfo_FlowInfo _tmp78B=Cyc_CfFlowInfo_BottomFL();_tmp622.f1=_tmp78B;}),_tmp622.f2=_tmp405;_tmp622;});case 1U: _LL3A: _LL3B:
 goto _LL3D;case 5U: _LL3C: _LL3D:
 goto _LL3F;case 4U: _LL3E: _LL3F:
 return({struct _tuple19 _tmp623;_tmp623.f1=_tmp405,({union Cyc_CfFlowInfo_FlowInfo _tmp78C=Cyc_CfFlowInfo_BottomFL();_tmp623.f2=_tmp78C;});_tmp623;});case 2U: if(((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp3F7)->f1 == Cyc_CfFlowInfo_NoneIL){_LL40: _LL41:
...
# 2145
({void*_tmp3FA=0U;({unsigned int _tmp78E=e->loc;struct _dyneither_ptr _tmp78D=({const char*_tmp3FB="expression may not be initialized";_tag_dyneither(_tmp3FB,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp78E,_tmp78D,_tag_dyneither(_tmp3FA,sizeof(void*),0U));});});
return({struct _tuple19 _tmp625;({union Cyc_CfFlowInfo_FlowInfo _tmp790=Cyc_CfFlowInfo_BottomFL();_tmp625.f1=_tmp790;}),({union Cyc_CfFlowInfo_FlowInfo _tmp78F=Cyc_CfFlowInfo_BottomFL();_tmp625.f2=_tmp78F;});_tmp625;});default: _LL4A: _LL4B:
# 2149
({void*_tmp3FC=0U;({struct _dyneither_ptr _tmp791=({const char*_tmp3FD="anal_test";_tag_dyneither(_tmp3FD,sizeof(char),10U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp791,_tag_dyneither(_tmp3FC,sizeof(void*),0U));});});}_LL35:;};}}_LL2D:;};}}_LL0:;}struct _tuple27{unsigned int f1;struct Cyc_NewControlFlow_AnalEnv*f2;struct Cyc_Dict_Dict f3;};
# 2155
...
# 2167
({struct Cyc_String_pa_PrintArg_struct _tmp419=({struct Cyc_String_pa_PrintArg_struct _tmp626;_tmp626.tag=0U,({struct _dyneither_ptr _tmp792=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp41B->name));_tmp626.f1=_tmp792;});_tmp626;});void*_tmp417[1U];_tmp417[0]=& _tmp419;({unsigned int _tmp794=_tmp41E;struct _dyneither_ptr _tmp793=({const char*_tmp418="unique pointers reachable from %s may become unreachable";_tag_dyneither(_tmp418,sizeof(char),57U);});Cyc_Warn_warn(_tmp794,_tmp793,_tag_dyneither(_tmp417,sizeof(void*),1U));});});
goto _LLB;}_LLB:;};}
# 2171
goto _LL3;}else{_LL6: _LL7:
 goto _LL3;}_LL3:;};}
...
if(({struct Cyc_CfFlowInfo_FlowEnv*_tmp796=env->fenv;struct Cyc_Dict_Dict _tmp795=_tmp424;Cyc_CfFlowInfo_initlevel(_tmp796,_tmp795,Cyc_CfFlowInfo_lookup_place(_tmp424,(struct Cyc_CfFlowInfo_Place*)_tmp420->hd));})!= Cyc_CfFlowInfo_AllIL)
({void*_tmp421=0U;({unsigned int _tmp798=loc;struct _dyneither_ptr _tmp797=({const char*_tmp422="function may not initialize all the parameters with attribute 'initializes'";_tag_dyneither(_tmp422,sizeof(char),76U);});Cyc_CfFlowInfo_aerr(_tmp798,_tmp797,_tag_dyneither(_tmp421,sizeof(void*),0U));});});}}
# 2184
if(Cyc_NewControlFlow_warn_lose_unique){
...
({struct Cyc_List_List*_tmp799=({struct Cyc_List_List*_tmp42B=_cycalloc(sizeof(*_tmp42B));_tmp42B->hd=_tmp42A,_tmp42B->tl=_tmp425;_tmp42B;});_tmp425=_tmp799;});
({struct Cyc_List_List*_tmp79A=({struct Cyc_List_List*_tmp42C=_cycalloc(sizeof(*_tmp42C));_tmp42C->hd=_tmp42F,_tmp42C->tl=_tmp426;_tmp42C;});_tmp426=_tmp79A;});}}}
# 2211
...
({void*_tmp432=0U;({struct _dyneither_ptr _tmp79B=({const char*_tmp433="noconsume_place_ok: flow became Bottom!";_tag_dyneither(_tmp433,sizeof(char),40U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp79B,_tag_dyneither(_tmp432,sizeof(void*),0U));});});}else{_LL3: _tmp445=((_tmp431.ReachableFL).val).f1;_LL4: {
# 2232
...
# 2256
struct _dyneither_ptr _tmp79C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp629.f1=_tmp79C;});_tmp629;});void*_tmp43A[1U];_tmp43A[0]=& _tmp43C;({unsigned int _tmp79E=loc;struct _dyneither_ptr _tmp79D=({const char*_tmp43B="function consumes parameter %s with attribute 'noconsume'";_tag_dyneither(_tmp43B,sizeof(char),58U);});Cyc_CfFlowInfo_aerr(_tmp79E,_tmp79D,_tag_dyneither(_tmp43A,sizeof(void*),1U));});});}else{
# 2259
...
# 2262
struct _dyneither_ptr _tmp79F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp62A.f1=_tmp79F;});_tmp62A;});void*_tmp43D[1U];_tmp43D[0]=& _tmp43F;({unsigned int _tmp7A1=loc;struct _dyneither_ptr _tmp7A0=({const char*_tmp43E="function consumes value pointed to by parameter %s, which has attribute 'noconsume'";_tag_dyneither(_tmp43E,sizeof(char),84U);});Cyc_CfFlowInfo_aerr(_tmp7A1,_tmp7A0,_tag_dyneither(_tmp43D,sizeof(void*),1U));});});else{
# 2264
varok=1;}}}else{
# 2267
varok=1;}}else{
...
# 2279
struct _dyneither_ptr _tmp7A2=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp62B.f1=_tmp7A2;});_tmp62B;});void*_tmp440[1U];_tmp440[0]=& _tmp442;({unsigned int _tmp7A4=loc;struct _dyneither_ptr _tmp7A3=({const char*_tmp441="function parameter %s with attribute 'noconsume' no longer set to its original value";_tag_dyneither(_tmp441,sizeof(char),85U);});Cyc_CfFlowInfo_aerr(_tmp7A4,_tmp7A3,_tag_dyneither(_tmp440,sizeof(void*),1U));});});}
goto _LL5;}_LL5:;}
# 2286
...
if(_tmp44D != 0)
({void*_tmp447=0U;({struct _dyneither_ptr _tmp7A5=({const char*_tmp448="unconsume_params: param to unconsume is non-variable";_tag_dyneither(_tmp448,sizeof(char),53U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp7A5,_tag_dyneither(_tmp447,sizeof(void*),0U));});});{
...
({void*_tmp44A=0U;({struct _dyneither_ptr _tmp7A6=({const char*_tmp44B="unconsume_params: root is not a varroot";_tag_dyneither(_tmp44B,sizeof(char),40U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp7A6,_tag_dyneither(_tmp44A,sizeof(void*),0U));});});}_LL3:;};}
...
if(varok){
# 2345
({void*_tmp7A7=Cyc_CfFlowInfo_make_unique_unconsumed(env->fenv,_tmp461);_tmp453=_tmp7A7;});
# 2350
if(ropt != 0){
# 2356
struct _tuple16 _tmp455=({
struct Cyc_CfFlowInfo_FlowEnv*_tmp7A9=env->fenv;struct _tuple16 _tmp7A8=({struct _tuple16 _tmp62D;_tmp62D.f1=_tmp465,_tmp62D.f2=_tmp453;_tmp62D;});Cyc_CfFlowInfo_join_flow_and_rval(_tmp7A9,_tmp7A8,({struct _tuple16 _tmp62E;_tmp62E.f1=_tmp465,_tmp62E.f2=ropt;_tmp62E;}));});
# 2356
...
# 2372
({union Cyc_CfFlowInfo_FlowInfo _tmp7AB=({struct Cyc_Dict_Dict _tmp7AA=Cyc_CfFlowInfo_assign_place(env->fenv,loc,_tmp45D,_tmp463,new_rval);Cyc_CfFlowInfo_ReachableFL(_tmp7AA,_tmp45C);});flow=_tmp7AB;});
# 2376
goto _LL15;}else{_LL18: _LL19:
# 2378
({void*_tmp45A=0U;({struct _dyneither_ptr _tmp7AC=({const char*_tmp45B="unconsume_params: joined flow became bot!";_tag_dyneither(_tmp45B,sizeof(char),42U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp7AC,_tag_dyneither(_tmp45A,sizeof(void*),0U));});});}_LL15:;}
# 2380
goto _LLD;}else{
# 2382
goto _LL11;}
...
struct _dyneither_ptr _tmp7AD=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(unconsume_exp));_tmp62F.f1=_tmp7AD;});_tmp62F;});void*_tmp45E[1U];_tmp45E[0]=& _tmp460;({unsigned int _tmp7AF=loc;struct _dyneither_ptr _tmp7AE=({const char*_tmp45F="aliased expression %s was overwritten";_tag_dyneither(_tmp45F,sizeof(char),38U);});Cyc_CfFlowInfo_aerr(_tmp7AF,_tmp7AE,_tag_dyneither(_tmp45E,sizeof(void*),1U));});});
...
# 2457
if(_tmp468)
({union Cyc_CfFlowInfo_FlowInfo _tmp7B0=Cyc_NewControlFlow_unconsume_exp(env,(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp46A))->hd,_tmp46C,_tmp470,_tmp46F,flow,loc);flow=_tmp7B0;});}}
# 2460
...
({struct Cyc_List_List*_tmp7B2=({struct Cyc_List_List*_tmp478=_cycalloc(sizeof(*_tmp478));
({struct _tuple29*_tmp7B1=({struct _tuple29*_tmp477=_cycalloc(sizeof(*_tmp477));_tmp477->f1=0,_tmp477->f2=_tmp485,_tmp477->f3=_tmp483,_tmp477->f4=_tmp482;_tmp477;});_tmp478->hd=_tmp7B1;}),_tmp478->tl=_tmp476;_tmp478;});
# 2478
env->unique_pat_vars=_tmp7B2;});
# 2481
if(_tmp486 != 0){
...
inflow=_tmp47B;
({union Cyc_CfFlowInfo_FlowInfo _tmp7B3=Cyc_NewControlFlow_anal_stmt(env,_tmp47C,_tmp485,0);clause_outflow=_tmp7B3;});}else{
# 2487
({union Cyc_CfFlowInfo_FlowInfo _tmp7B4=Cyc_NewControlFlow_anal_stmt(env,clause_inflow,_tmp485,0);clause_outflow=_tmp7B4;});}
# 2489
...
# 2494
({union Cyc_CfFlowInfo_FlowInfo _tmp7B5=Cyc_NewControlFlow_unconsume_params(env,_tmp483,_tmp482,0,clause_outflow,_tmp484);clause_outflow=_tmp7B5;});
# 2496
if(scs->tl == 0)
...
({void*_tmp47E=0U;({unsigned int _tmp7B7=_tmp485->loc;struct _dyneither_ptr _tmp7B6=({const char*_tmp47F="switch clause may implicitly fallthru";_tag_dyneither(_tmp47F,sizeof(char),38U);});Cyc_CfFlowInfo_aerr(_tmp7B7,_tmp7B6,_tag_dyneither(_tmp47E,sizeof(void*),0U));});});else{
# 2504
({void*_tmp480=0U;({unsigned int _tmp7B9=_tmp485->loc;struct _dyneither_ptr _tmp7B8=({const char*_tmp481="switch clause may implicitly fallthru";_tag_dyneither(_tmp481,sizeof(char),38U);});Cyc_Warn_warn(_tmp7B9,_tmp7B8,_tag_dyneither(_tmp480,sizeof(void*),0U));});});}
# 2506
...
struct _tuple15 _tmp489=Cyc_CfFlowInfo_unname_rval(({struct Cyc_Dict_Dict _tmp7BA=_tmp492;((void*(*)(struct Cyc_Dict_Dict d,int(*cmp)(void*,void*),void*k))Cyc_Dict_lookup_other)(_tmp7BA,Cyc_CfFlowInfo_root_cmp,(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp490=_cycalloc(sizeof(*_tmp490));*_tmp490=vdroot;_tmp490;}));}));struct _tuple15 _tmp48A=_tmp489;void*_tmp48F;_LL4: _tmp48F=_tmp48A.f1;_LL5:;{
...
# 2528
({struct Cyc_String_pa_PrintArg_struct _tmp48E=({struct Cyc_String_pa_PrintArg_struct _tmp631;_tmp631.tag=0U,({struct _dyneither_ptr _tmp7BB=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp631.f1=_tmp7BB;});_tmp631;});void*_tmp48C[1U];_tmp48C[0]=& _tmp48E;({unsigned int _tmp7BD=_tmp491;struct _dyneither_ptr _tmp7BC=({const char*_tmp48D="unique pointers may still exist after variable %s goes out of scope";_tag_dyneither(_tmp48D,sizeof(char),68U);});Cyc_Warn_warn(_tmp7BD,_tmp7BC,_tag_dyneither(_tmp48C,sizeof(void*),1U));});});
# 2530
goto _LL6;}_LL6:;};}}
# 2535
...
({union Cyc_CfFlowInfo_FlowInfo _tmp7BE=Cyc_NewControlFlow_unconsume_params(env,_tmp4A4,_tmp4A3,_tmp4A6,inflow,dest->loc);inflow=_tmp7BE;});}}
# 2571
return inflow;}
# 2577
...
# 2590
 if(env->noreturn)
({void*_tmp4AC=0U;({unsigned int _tmp7C0=s->loc;struct _dyneither_ptr _tmp7BF=({const char*_tmp4AD="`noreturn' function might return";_tag_dyneither(_tmp4AD,sizeof(char),33U);});Cyc_CfFlowInfo_aerr(_tmp7C0,_tmp7BF,_tag_dyneither(_tmp4AC,sizeof(void*),0U));});});
...
# 2596
 if(env->noreturn)
({void*_tmp4AE=0U;({unsigned int _tmp7C2=s->loc;struct _dyneither_ptr _tmp7C1=({const char*_tmp4AF="`noreturn' function might return";_tag_dyneither(_tmp4AF,sizeof(char),33U);});Cyc_CfFlowInfo_aerr(_tmp7C2,_tmp7C1,_tag_dyneither(_tmp4AE,sizeof(void*),0U));});});{
...
({union Cyc_CfFlowInfo_FlowInfo _tmp7C3=Cyc_NewControlFlow_use_Rval(env,_tmp51B->loc,_tmp4B3,_tmp4B2);_tmp4B3=_tmp7C3;});
...
# 2615
 return({struct Cyc_NewControlFlow_AnalEnv*_tmp7C6=env;union Cyc_CfFlowInfo_FlowInfo _tmp7C5=Cyc_NewControlFlow_anal_stmt(env,inflow,_tmp51E,0);struct Cyc_Absyn_Stmt*_tmp7C4=_tmp51D;Cyc_NewControlFlow_anal_stmt(_tmp7C6,_tmp7C5,_tmp7C4,rval_opt);});case 4U: _LLE: _tmp521=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp4AB)->f1;_tmp520=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp4AB)->f2;_tmp51F=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp4AB)->f3;_LLF: {
# 2618
...
# 2666
({union Cyc_CfFlowInfo_FlowInfo _tmp7C7=Cyc_NewControlFlow_unconsume_pat_vars(env,s,inflow,_tmp52E->body);inflow=_tmp7C7;});{
# 2668
...
({union Cyc_CfFlowInfo_FlowInfo _tmp7C8=Cyc_NewControlFlow_add_vars(_tmp4A9,_tmp4EA,_tmp4E4,_tmp4A9->unknown_all,s->loc,0);_tmp4EA=_tmp7C8;});
# 2671
...
if(_tmp4E8 != 0){
({union Cyc_CfFlowInfo_FlowInfo _tmp7CF=({struct Cyc_CfFlowInfo_FlowEnv*_tmp7CE=_tmp4A9;struct Cyc_NewControlFlow_AnalEnv*_tmp7CD=env;union Cyc_CfFlowInfo_FlowInfo _tmp7CC=_tmp4EA;struct Cyc_Absyn_Vardecl*_tmp7CB=*_tmp4E8;struct Cyc_Absyn_Exp*_tmp7CA=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp52F))->hd;void*_tmp7C9=(void*)((struct Cyc_List_List*)_check_null(_tmp4E9))->hd;Cyc_NewControlFlow_do_initialize_var(_tmp7CE,_tmp7CD,_tmp7CC,_tmp7CB,_tmp7CA,_tmp7C9,s->loc);});_tmp4EA=_tmp7CF;});
_tmp4E9=_tmp4E9->tl;
_tmp52F=_tmp52F->tl;}}}
# 2679
...
# 2843
({void*_tmp519=0U;({struct _dyneither_ptr _tmp7D0=({const char*_tmp51A="anal_stmt: bad stmt syntax or unimplemented stmt form";_tag_dyneither(_tmp51A,sizeof(char),54U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp7D0,_tag_dyneither(_tmp519,sizeof(void*),0U));});});}case 6U: _LL18: _LL19:
# 2685
...
({void*_tmp4EC=0U;({unsigned int _tmp7D2=s->loc;struct _dyneither_ptr _tmp7D1=({const char*_tmp4ED="break may cause function not to return a value";_tag_dyneither(_tmp4ED,sizeof(char),47U);});Cyc_Warn_warn(_tmp7D2,_tmp7D1,_tag_dyneither(_tmp4EC,sizeof(void*),0U));});});else{
# 2693
({void*_tmp4EE=0U;({unsigned int _tmp7D4=s->loc;struct _dyneither_ptr _tmp7D3=({const char*_tmp4EF="break may cause function not to return a value";_tag_dyneither(_tmp4EF,sizeof(char),47U);});Cyc_CfFlowInfo_aerr(_tmp7D4,_tmp7D3,_tag_dyneither(_tmp4EE,sizeof(void*),0U));});});}}
# 2695
goto _LL55;}else{_LL58: _LL59:
 goto _LL55;}_LL55:;}
# 2698
if(env->noreturn)
({void*_tmp4F0=0U;({unsigned int _tmp7D6=s->loc;struct _dyneither_ptr _tmp7D5=({const char*_tmp4F1="`noreturn' function might return";_tag_dyneither(_tmp4F1,sizeof(char),33U);});Cyc_CfFlowInfo_aerr(_tmp7D6,_tmp7D5,_tag_dyneither(_tmp4F0,sizeof(void*),0U));});});
Cyc_NewControlFlow_check_init_params(s->loc,env,inflow);
Cyc_NewControlFlow_unconsume_params(env,env->noconsume_params,0,0,inflow,s->loc);
...
if(_tmp4F2 == 0)
({void*_tmp4F3=0U;({unsigned int _tmp7D8=s->loc;struct _dyneither_ptr _tmp7D7=({const char*_tmp4F4="jump has no target (should be impossible)";_tag_dyneither(_tmp4F4,sizeof(char),42U);});Cyc_CfFlowInfo_aerr(_tmp7D8,_tmp7D7,_tag_dyneither(_tmp4F3,sizeof(void*),0U));});});
({union Cyc_CfFlowInfo_FlowInfo _tmp7D9=Cyc_NewControlFlow_unconsume_pat_vars(env,s,inflow,(struct Cyc_Absyn_Stmt*)_check_null(_tmp4F2));inflow=_tmp7D9;});
# 2713
...
{union Cyc_CfFlowInfo_FlowInfo _tmp4F5=scs_outflow;if((_tmp4F5.BottomFL).tag == 1){_LL5B: _LL5C:
 goto _LL5A;}else{_LL5D: _LL5E:
({void*_tmp4F6=0U;({unsigned int _tmp7DB=s->loc;struct _dyneither_ptr _tmp7DA=({const char*_tmp4F7="last catch clause may implicitly fallthru";_tag_dyneither(_tmp4F7,sizeof(char),42U);});Cyc_CfFlowInfo_aerr(_tmp7DB,_tmp7DA,_tag_dyneither(_tmp4F6,sizeof(void*),0U));});});}_LL5A:;}
# 2741
outflow=s1_outflow;
# 2743
...
({union Cyc_CfFlowInfo_FlowInfo _tmp7DC=Cyc_NewControlFlow_initialize_pat_vars(_tmp4A9,env,inflow,_tmp539,_tmp4FE != 0,_tmp537,_tmp538->loc);inflow=_tmp7DC;});{
struct Cyc_List_List*_tmp4FA=env->unique_pat_vars;
# 2757
({struct Cyc_List_List*_tmp7DE=({struct Cyc_List_List*_tmp4FC=_cycalloc(sizeof(*_tmp4FC));
({struct _tuple29*_tmp7DD=({struct _tuple29*_tmp4FB=_cycalloc(sizeof(*_tmp4FB));_tmp4FB->f1=0,_tmp4FB->f2=s,_tmp4FB->f3=_tmp4FE,_tmp4FB->f4=_tmp4FD;_tmp4FB;});_tmp4FC->hd=_tmp7DD;}),_tmp4FC->tl=_tmp4FA;_tmp4FC;});
# 2757
env->unique_pat_vars=_tmp7DE;});
# 2762
({union Cyc_CfFlowInfo_FlowInfo _tmp7DF=Cyc_NewControlFlow_anal_stmt(env,inflow,_tmp536,rval_opt);inflow=_tmp7DF;});
env->unique_pat_vars=_tmp4FA;
# 2766
({union Cyc_CfFlowInfo_FlowInfo _tmp7E0=Cyc_NewControlFlow_unconsume_params(env,_tmp4FE,_tmp4FD,0,inflow,_tmp537);inflow=_tmp7E0;});
# 2770
...
({void*_tmp7E1=(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp509=_cycalloc(sizeof(*_tmp509));_tmp509->tag=8U,_tmp509->f1=_tmp53D,_tmp509->f2=_tmp508;_tmp509;});_tmp508=_tmp7E1;});
({struct Cyc_Dict_Dict _tmp7E2=Cyc_CfFlowInfo_assign_place(_tmp4A9,_tmp53C->loc,_tmp512,_tmp510,_tmp508);_tmp512=_tmp7E2;});
({union Cyc_CfFlowInfo_FlowInfo _tmp7E3=Cyc_CfFlowInfo_ReachableFL(_tmp512,_tmp511);_tmp517=_tmp7E3;});{
...
({struct Cyc_List_List*_tmp7E4=({struct Cyc_List_List*_tmp50C=_cycalloc(sizeof(*_tmp50C));_tmp50C->hd=_tmp50B,_tmp50C->tl=_tmp504;_tmp50C;});_tmp504=_tmp7E4;});
({struct Cyc_List_List*_tmp7E5=({struct Cyc_List_List*_tmp50D=_cycalloc(sizeof(*_tmp50D));_tmp50D->hd=_tmp53C,_tmp50D->tl=_tmp505;_tmp50D;});_tmp505=_tmp7E5;});
...
({union Cyc_CfFlowInfo_FlowInfo _tmp7E6=Cyc_NewControlFlow_add_vars(_tmp4A9,_tmp517,& _tmp513,_tmp4A9->unknown_all,_tmp53B,0);_tmp517=_tmp7E6;});{
# 2820
struct Cyc_List_List*_tmp514=env->unique_pat_vars;
({struct Cyc_List_List*_tmp7E8=({struct Cyc_List_List*_tmp516=_cycalloc(sizeof(*_tmp516));({struct _tuple29*_tmp7E7=({struct _tuple29*_tmp515=_cycalloc(sizeof(*_tmp515));_tmp515->f1=1,_tmp515->f2=s,_tmp515->f3=_tmp504,_tmp515->f4=_tmp505;_tmp515;});_tmp516->hd=_tmp7E7;}),_tmp516->tl=_tmp514;_tmp516;});env->unique_pat_vars=_tmp7E8;});
# 2825
({union Cyc_CfFlowInfo_FlowInfo _tmp7E9=Cyc_NewControlFlow_anal_stmt(env,_tmp517,_tmp53A,rval_opt);_tmp517=_tmp7E9;});
env->unique_pat_vars=_tmp514;
# 2829
({union Cyc_CfFlowInfo_FlowInfo _tmp7EA=Cyc_NewControlFlow_unconsume_params(env,_tmp504,_tmp505,1,_tmp517,_tmp53B);_tmp517=_tmp7EA;});
# 2833
...
# 2836
({union Cyc_CfFlowInfo_FlowInfo _tmp7EE=({struct Cyc_NewControlFlow_AnalEnv*_tmp7ED=env;union Cyc_CfFlowInfo_FlowInfo _tmp7EC=Cyc_NewControlFlow_anal_decl(env,inflow,_tmp53F);struct Cyc_Absyn_Stmt*_tmp7EB=_tmp53E;Cyc_NewControlFlow_anal_stmt(_tmp7ED,_tmp7EC,_tmp7EB,rval_opt);});outflow=_tmp7EE;});
if(Cyc_NewControlFlow_warn_lose_unique)
...
({union Cyc_CfFlowInfo_FlowInfo _tmp7EF=Cyc_NewControlFlow_add_vars(_tmp543,inflow,& _tmp546,_tmp543->unknown_none,decl->loc,0);inflow=_tmp7EF;});{
...
# 2879
return({struct Cyc_CfFlowInfo_FlowEnv*_tmp7F3=_tmp543;union Cyc_CfFlowInfo_FlowInfo _tmp7F2=inflow;struct Cyc_List_List*_tmp7F1=({struct Cyc_List_List*_tmp54D=_cycalloc(sizeof(*_tmp54D));_tmp54D->hd=_tmp54C,_tmp54D->tl=0;_tmp54D;});void*_tmp7F0=_tmp543->unknown_all;Cyc_NewControlFlow_add_vars(_tmp7F3,_tmp7F2,_tmp7F1,_tmp7F0,decl->loc,0);});};case 4U: _LL7: _tmp558=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp545)->f1;_tmp557=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp545)->f2;_tmp556=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp545)->f3;_LL8:
# 2882
 if(_tmp556 != 0)
({void*_tmp54E=0U;({struct _dyneither_ptr _tmp7F4=({const char*_tmp54F="found open expression in declaration!";_tag_dyneither(_tmp54F,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp7F4,_tag_dyneither(_tmp54E,sizeof(void*),0U));});});{
...
# 2888
({void*_tmp551=0U;({struct _dyneither_ptr _tmp7F5=({const char*_tmp552="anal_decl: unexpected decl variant";_tag_dyneither(_tmp552,sizeof(char),35U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp7F5,_tag_dyneither(_tmp551,sizeof(void*),0U));});});}_LL0:;}
# 2896
...
({struct Cyc_JumpAnalysis_Jump_Anal_Result*_tmp7F8=tables;struct Cyc_CfFlowInfo_FlowEnv*_tmp7F7=fenv;union Cyc_CfFlowInfo_FlowInfo _tmp7F6=Cyc_CfFlowInfo_ReachableFL(fenv->mt_flowdict,0);Cyc_NewControlFlow_check_nested_fun(_tmp7F8,_tmp7F7,_tmp7F6,fd);});}
# 2898
...
({union Cyc_CfFlowInfo_FlowInfo _tmp7F9=Cyc_NewControlFlow_add_vars(fenv,inflow,(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v,fenv->unknown_all,_tmp562,1);inflow=_tmp7F9;});{
# 2935
...
({struct Cyc_List_List*_tmp7FE=({struct _RegionHandle*_tmp7FD=Cyc_Core_heap_region;union Cyc_Relations_RelnOp _tmp7FC=Cyc_NewControlFlow_translate_rop(_tmp565,_tmp567->rop1);enum Cyc_Relations_Relation _tmp7FB=_tmp567->relation;union Cyc_Relations_RelnOp _tmp7FA=
Cyc_NewControlFlow_translate_rop(_tmp565,_tmp567->rop2);
# 2943
Cyc_Relations_add_relation(_tmp7FD,_tmp7FC,_tmp7FB,_tmp7FA,_tmp590);});_tmp590=_tmp7FE;});}}{
# 2949
...
({void*_tmp56A=0U;({struct _dyneither_ptr _tmp7FF=({const char*_tmp56B="check_fun: non-function type cached with fndecl_t";_tag_dyneither(_tmp56B,sizeof(char),50U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp7FF,_tag_dyneither(_tmp56A,sizeof(void*),0U));});});}_LL3:;}
# 2956
...
void*_tmp570=({
struct Cyc_CfFlowInfo_FlowEnv*_tmp802=fenv;void*_tmp801=elttype;struct Cyc_Absyn_Exp*_tmp800=bogus_exp;Cyc_CfFlowInfo_make_unique_consumed(_tmp802,_tmp801,_tmp800,- 1,
...
({struct Cyc_Dict_Dict _tmp803=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp591,(void*)_tmp571,_tmp570);_tmp591=_tmp803;});
({struct Cyc_Dict_Dict _tmp806=({struct Cyc_Dict_Dict _tmp805=_tmp591;void*_tmp804=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp573=_cycalloc(sizeof(*_tmp573));_tmp573->tag=0U,_tmp573->f1=_tmp56F;_tmp573;});((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp805,_tmp804,(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp574=_cycalloc(sizeof(*_tmp574));_tmp574->tag=4U,_tmp574->f1=_tmp572;_tmp574;}));});_tmp591=_tmp806;});
...
({struct Cyc_Dict_Dict _tmp809=({struct Cyc_Dict_Dict _tmp808=_tmp591;void*_tmp807=(void*)_tmp578;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp808,_tmp807,Cyc_CfFlowInfo_typ_to_absrval(fenv,elttype,0,fenv->esc_none));});_tmp591=_tmp809;});
({struct Cyc_Dict_Dict _tmp80C=({struct Cyc_Dict_Dict _tmp80B=_tmp591;void*_tmp80A=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp57A=_cycalloc(sizeof(*_tmp57A));_tmp57A->tag=0U,_tmp57A->f1=_tmp577;_tmp57A;});((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp80B,_tmp80A,(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp57B=_cycalloc(sizeof(*_tmp57B));_tmp57B->tag=4U,_tmp57B->f1=_tmp579;_tmp57B;}));});_tmp591=_tmp80C;});
({struct Cyc_List_List*_tmp80D=({struct Cyc_List_List*_tmp57C=_cycalloc(sizeof(*_tmp57C));_tmp57C->hd=_tmp579,_tmp57C->tl=param_roots;_tmp57C;});param_roots=_tmp80D;});
...
({struct Cyc_List_List*_tmp80E=({struct Cyc_List_List*_tmp582=_cycalloc(sizeof(*_tmp582));_tmp582->hd=_tmp581,_tmp582->tl=noconsume_roots;_tmp582;});noconsume_roots=_tmp80E;});}
# 2987
goto _LL8;}default: _LLF: _LL10:
 goto _LL8;}_LL8:;}
# 2990
({union Cyc_CfFlowInfo_FlowInfo _tmp80F=Cyc_CfFlowInfo_ReachableFL(_tmp591,_tmp590);inflow=_tmp80F;});{
# 2992
...
struct Cyc_Hashtable_Table*_tmp811=((struct Cyc_Hashtable_Table*(*)(struct Cyc_Hashtable_Table*t,struct Cyc_Absyn_Fndecl*key))Cyc_Hashtable_lookup)(tables->succ_tables,fd);_tmp58F->succ_table=_tmp811;}),({
struct Cyc_Hashtable_Table*_tmp810=((struct Cyc_Hashtable_Table*(*)(struct Cyc_Hashtable_Table*t,struct Cyc_Absyn_Fndecl*key))Cyc_Hashtable_lookup)(tables->pat_pop_tables,fd);_tmp58F->pat_pop_table=_tmp810;}),_tmp58F->fenv=fenv,_tmp58F->iterate_again=1,_tmp58F->iteration_num=0,_tmp58F->in_try=0,_tmp58F->tryflow=inflow,_tmp58F->noreturn=noreturn,_tmp58F->return_type=fd->ret_type,_tmp58F->unique_pat_vars=0,_tmp58F->param_roots=param_roots,_tmp58F->noconsume_params=noconsume_roots,_tmp58F->flow_table=flow_table,_tmp58F->return_relns=fd->ensures_relns;_tmp58F;});
# 3002
...
# 3008
env->iterate_again=0;
({union Cyc_CfFlowInfo_FlowInfo _tmp812=Cyc_NewControlFlow_anal_stmt(env,inflow,fd->body,0);outflow=_tmp812;});}{
# 3011
...
# 3018
if(noreturn)
({void*_tmp589=0U;({unsigned int _tmp814=_tmp562;struct _dyneither_ptr _tmp813=({const char*_tmp58A="`noreturn' function might (implicitly) return";_tag_dyneither(_tmp58A,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp814,_tmp813,_tag_dyneither(_tmp589,sizeof(void*),0U));});});else{
if(!Cyc_Tcutil_is_void_type(fd->ret_type)){
if(Cyc_Tcutil_is_any_float_type(fd->ret_type) || 
Cyc_Tcutil_is_any_int_type(fd->ret_type))
({void*_tmp58B=0U;({unsigned int _tmp816=_tmp562;struct _dyneither_ptr _tmp815=({const char*_tmp58C="function may not return a value";_tag_dyneither(_tmp58C,sizeof(char),32U);});Cyc_Warn_warn(_tmp816,_tmp815,_tag_dyneither(_tmp58B,sizeof(void*),0U));});});else{
# 3025
({void*_tmp58D=0U;({unsigned int _tmp818=_tmp562;struct _dyneither_ptr _tmp817=({const char*_tmp58E="function may not return a value";_tag_dyneither(_tmp58E,sizeof(char),32U);});Cyc_CfFlowInfo_aerr(_tmp818,_tmp817,_tag_dyneither(_tmp58D,sizeof(void*),0U));});});}goto _LL11;}}
# 3027
goto _LL11;}_LL11:;};};};};};}
# 3031
void Cyc_NewControlFlow_cf_check(struct Cyc_JumpAnalysis_Jump_Anal_Result*tables,struct Cyc_List_List*ds){
