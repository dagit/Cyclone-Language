...
struct Cyc_Core_Impossible_exn_struct _tmp68C;const char*_tmp68B;struct Cyc_Core_Impossible_exn_struct*_tmp68A;(int)_throw((void*)((_tmp68A=_cycalloc(sizeof(*_tmp68A)),((_tmp68A[0]=((_tmp68C.tag=Cyc_Core_Impossible,((_tmp68C.f1=((_tmp68B="ControlFlow -- wrong stmt annotation",_tag_dyneither(_tmp68B,sizeof(char),37))),_tmp68C)))),_tmp68A)))));}}_LL0:;}
# 144
...
if(sflow == 0){
union Cyc_CfFlowInfo_FlowInfo*_tmp68D;union Cyc_CfFlowInfo_FlowInfo*res=(_tmp68D=_region_malloc(env->r,sizeof(*_tmp68D)),((_tmp68D[0]=Cyc_CfFlowInfo_BottomFL(),_tmp68D)));
...
struct _tuple20 _tmp68E;return(_tmp68E.f1=_tmpA,((_tmp68E.f2=_tmpB,_tmp68E)));};}
# 178
...
# 207
{const char*_tmp692;void*_tmp691[1];struct Cyc_String_pa_PrintArg_struct _tmp690;(_tmp690.tag=0,((_tmp690.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp12->name)),((_tmp691[0]=& _tmp690,Cyc_Tcutil_warn(_tmpF,((_tmp692="alias-free pointer(s) reachable from %s may become unreachable.",_tag_dyneither(_tmp692,sizeof(char),64))),_tag_dyneither(_tmp691,sizeof(void*),1)))))));}
goto _LLD;}_LLD:;}}
# 211
...
struct _tuple19 _tmp693;struct _tuple19 _tmp1B=(_tmp693.f1=flow,((_tmp693.f2=_tmp1A,_tmp693)));struct _tuple19 _tmp1C=_tmp1B;struct Cyc_Dict_Dict _tmp1D;struct Cyc_Dict_Dict _tmp1E;if(((_tmp1C.f1).ReachableFL).tag == 2){if(((_tmp1C.f2).ReachableFL).tag == 2){_LL19: _tmp1D=(((_tmp1C.f1).ReachableFL).val).f1;_tmp1E=(((_tmp1C.f2).ReachableFL).val).f1;_LL1A: {
# 228
struct _tuple21 _tmp694;struct _tuple21 _tmp1F=(_tmp694.f1=env,((_tmp694.f2=s->loc,((_tmp694.f3=_tmp1E,_tmp694)))));
...
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp697;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp696;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp25=(_tmp696=_region_malloc(fenv->r,sizeof(*_tmp696)),((_tmp696[0]=((_tmp697.tag=0,((_tmp697.f1=(struct Cyc_Absyn_Vardecl*)vds->hd,_tmp697)))),_tmp696)));
void*_tmp26=Cyc_CfFlowInfo_typ_to_absrval(fenv,((struct Cyc_Absyn_Vardecl*)vds->hd)->type,0,leafval);
if(nameit){
struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp69A;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp699;_tmp26=(void*)((_tmp699=_region_malloc(fenv->r,sizeof(*_tmp699)),((_tmp699[0]=((_tmp69A.tag=8,((_tmp69A.f1=(struct Cyc_Absyn_Vardecl*)vds->hd,((_tmp69A.f2=_tmp26,_tmp69A)))))),_tmp699))));}
# 266
...
struct Cyc_List_List*_tmp69B;if(Cyc_Relations_consistent_relations(((_tmp69B=_region_malloc(r,sizeof(*_tmp69B)),((_tmp69B->hd=_tmp2B,((_tmp69B->tl=assume,_tmp69B))))))))
return 0;}
# 284
return 1;}
# 287
...
{const char*_tmp6A0;void*_tmp69F[2];struct Cyc_String_pa_PrintArg_struct _tmp69E;struct Cyc_String_pa_PrintArg_struct _tmp69D;(_tmp69D.tag=0,((_tmp69D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f),((_tmp69E.tag=0,((_tmp69E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(Cyc_NewControlFlow_strip_cast(_tmp3B))),((_tmp69F[0]=& _tmp69E,((_tmp69F[1]=& _tmp69D,Cyc_CfFlowInfo_aerr(loc,((_tmp6A0="unable to prove %s, required to access %s",_tag_dyneither(_tmp6A0,sizeof(char),42))),_tag_dyneither(_tmp69F,sizeof(void*),2)))))))))))));}
{const char*_tmp6A3;void*_tmp6A2;(_tmp6A2=0,Cyc_fprintf(Cyc_stderr,((_tmp6A3="  [recorded facts on path: ",_tag_dyneither(_tmp6A3,sizeof(char),28))),_tag_dyneither(_tmp6A2,sizeof(void*),0)));}
...
const char*_tmp6B4;void*_tmp6B3;(_tmp6B3=0,Cyc_CfFlowInfo_aerr(loc,((_tmp6B4="expression may not be fully initialized",_tag_dyneither(_tmp6B4,sizeof(char),40))),_tag_dyneither(_tmp6B3,sizeof(void*),0)));}{
...
struct _tuple0 _tmp6B5;struct _tuple0 _tmp56=(_tmp6B5.f1=Cyc_Tcutil_compress(t),((_tmp6B5.f2=r,_tmp6B5)));struct _tuple0 _tmp57=_tmp56;enum Cyc_Absyn_AggrKind _tmp58;struct Cyc_List_List*_tmp59;struct _dyneither_ptr _tmp5A;union Cyc_Absyn_AggrInfoU _tmp5B;struct Cyc_List_List*_tmp5C;struct _dyneither_ptr _tmp5D;struct Cyc_List_List*_tmp5E;struct _dyneither_ptr _tmp5F;struct Cyc_Absyn_Datatypefield*_tmp60;struct _dyneither_ptr _tmp61;void*_tmp62;switch(*((int*)_tmp57.f2)){case 3: if(((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp57.f2)->f1 == Cyc_CfFlowInfo_NoneIL){_LL39: _LL3A:
...
{const char*_tmp6B8;void*_tmp6B7;(_tmp6B7=0,Cyc_Tcutil_warn(loc,((_tmp6B8="argument may still contain alias-free pointers",_tag_dyneither(_tmp6B8,sizeof(char),47))),_tag_dyneither(_tmp6B7,sizeof(void*),0)));}
...
{const char*_tmp6BB;void*_tmp6BA;(_tmp6BA=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp6BB="noliveunique attribute requires alias-free pointer",_tag_dyneither(_tmp6BB,sizeof(char),51))),_tag_dyneither(_tmp6BA,sizeof(void*),0)));}
...
const char*_tmp6BE;void*_tmp6BD;(_tmp6BD=0,Cyc_Tcutil_warn(loc,((_tmp6BE="argument may contain live alias-free pointers",_tag_dyneither(_tmp6BE,sizeof(char),46))),_tag_dyneither(_tmp6BD,sizeof(void*),0)));}
...
# 425
if(es == 0){
struct _tuple23 _tmp6BF;return(_tmp6BF.f1=inflow,((_tmp6BF.f2=0,_tmp6BF)));}
if(es->tl == 0){
...
struct Cyc_List_List*_tmp6C2;struct _tuple23 _tmp6C1;return(_tmp6C1.f1=_tmp7A,((_tmp6C1.f2=((_tmp6C2=_region_malloc(rgn,sizeof(*_tmp6C2)),((_tmp6C2->hd=_tmp7B,((_tmp6C2->tl=0,_tmp6C2)))))),_tmp6C1)));};}{
# 431
...
outflow=_tmp81;
{struct Cyc_List_List*_tmp6C4;rvals=((_tmp6C4=_region_malloc(rgn,sizeof(*_tmp6C4)),((_tmp6C4->hd=_tmp82,((_tmp6C4->tl=0,_tmp6C4))))));}
...
{struct Cyc_List_List*_tmp6C6;rvals=((_tmp6C6=_region_malloc(rgn,sizeof(*_tmp6C6)),((_tmp6C6->hd=_tmp88,((_tmp6C6->tl=rvals,_tmp6C6))))));}
...
# 469
struct Cyc_Dict_Dict*_tmp6C7;env->all_changed=((_tmp6C7=_region_malloc(env->r,sizeof(*_tmp6C7)),((_tmp6C7[0]=Cyc_CfFlowInfo_union_place_set(*outer_all_changed,this_all_changed,0),_tmp6C7))));}
# 471
Cyc_NewControlFlow_update_tryflow(env,outflow);{
# 473
struct _tuple23 _tmp6C8;return(_tmp6C8.f1=outflow,((_tmp6C8.f2=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(rvals),_tmp6C8)));};};}
# 478
...
const char*_tmp6CB;void*_tmp6CA;(_tmp6CA=0,Cyc_CfFlowInfo_aerr(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd)->loc,((_tmp6CB="expression may not be initialized",_tag_dyneither(_tmp6CB,sizeof(char),34))),_tag_dyneither(_tmp6CA,sizeof(void*),0)));}}
goto _LL65;}else{_LL68: _LL69:
 goto _LL65;}_LL65:;}{
# 492
struct _tuple16 _tmp6CC;struct _tuple16 _tmp96=(_tmp6CC.f1=_tmp8F,((_tmp6CC.f2=(env->fenv)->unknown_all,_tmp6CC)));_npop_handler(0);return _tmp96;};}
# 482
;_pop_region(rgn);}
# 500
...
struct Cyc_Core_Impossible_exn_struct _tmp6D2;const char*_tmp6D1;struct Cyc_Core_Impossible_exn_struct*_tmp6D0;(int)_throw((void*)((_tmp6D0=_cycalloc(sizeof(*_tmp6D0)),((_tmp6D0[0]=((_tmp6D2.tag=Cyc_Core_Impossible,((_tmp6D2.f1=((_tmp6D1="consume_zero_ral",_tag_dyneither(_tmp6D1,sizeof(char),17))),_tmp6D2)))),_tmp6D0)))));}else{
# 512
if(needs_unconsume)
...
struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp6D5;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp6D4;nzval=(void*)((_tmp6D4=_region_malloc((env->fenv)->r,sizeof(*_tmp6D4)),((_tmp6D4[0]=((_tmp6D5.tag=8,((_tmp6D5.f1=(struct Cyc_Absyn_Vardecl*)names->hd,((_tmp6D5.f2=nzval,_tmp6D5)))))),_tmp6D4))));}
# 550
...
struct _tuple19 _tmp6D6;return(_tmp6D6.f1=outflow,((_tmp6D6.f2=outflow,_tmp6D6)));}}else{_LL77: _tmpA5=((_tmpA4.ReachableFL).val).f1;_tmpA6=((_tmpA4.ReachableFL).val).f2;_LL78: {
# 570
...
struct _tuple19 _tmp6D7;return(_tmp6D7.f1=outflow,((_tmp6D7.f2=outflow,_tmp6D7)));}}else{_LL7C: _tmpAA=(_tmpA9.PlaceL).val;_LL7D: {
# 573
void*nzval=il == Cyc_CfFlowInfo_AllIL?(env->fenv)->notzeroall:(env->fenv)->notzerothis;
void*zval=(env->fenv)->zero;
for(0;names != 0;names=names->tl){
{struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp6DA;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp6D9;nzval=(void*)((_tmp6D9=_region_malloc((env->fenv)->r,sizeof(*_tmp6D9)),((_tmp6D9[0]=((_tmp6DA.tag=8,((_tmp6DA.f1=(struct Cyc_Absyn_Vardecl*)names->hd,((_tmp6DA.f2=nzval,_tmp6DA)))))),_tmp6D9))));}{
struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp6DD;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp6DC;zval=(void*)((_tmp6DC=_region_malloc((env->fenv)->r,sizeof(*_tmp6DC)),((_tmp6DC[0]=((_tmp6DD.tag=8,((_tmp6DD.f1=(struct Cyc_Absyn_Vardecl*)names->hd,((_tmp6DD.f2=zval,_tmp6DD)))))),_tmp6DC))));};}
# 579
...
struct _tuple19 _tmp6DE;return
(_tmp6DE.f1=Cyc_CfFlowInfo_ReachableFL(Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmpA5,env->all_changed,_tmpAA,nzval),_tmpA6),((_tmp6DE.f2=
# 584
Cyc_CfFlowInfo_ReachableFL(Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmpA5,env->all_changed,_tmpAA,zval),_tmpA6),_tmp6DE)));};}}_LL79:;}}_LL74:;}
# 590
...
# 606
struct _tuple16 _tmp6DF;return(_tmp6DF.f1=f,((_tmp6DF.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpB5,0,(env->fenv)->unknown_all),_tmp6DF)));}}else{_LL86: _tmpB9=((_tmpB8.ReachableFL).val).f1;_tmpBA=((_tmpB8.ReachableFL).val).f2;_LL87:
# 609
...
# 613
struct Cyc_Core_Impossible_exn_struct _tmp6E5;const char*_tmp6E4;struct Cyc_Core_Impossible_exn_struct*_tmp6E3;(int)_throw((void*)((_tmp6E3=_cycalloc(sizeof(*_tmp6E3)),((_tmp6E3[0]=((_tmp6E5.tag=Cyc_Core_Impossible,((_tmp6E5.f1=((_tmp6E4="named location in anal_derefR",_tag_dyneither(_tmp6E4,sizeof(char),30))),_tmp6E5)))),_tmp6E3)))));}case 1: _LL8E: _LL8F:
...
# 624
{struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct _tmp6E8;struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp6E7;e->annot=(void*)((_tmp6E7=_cycalloc(sizeof(*_tmp6E7)),((_tmp6E7[0]=((_tmp6E8.tag=Cyc_CfFlowInfo_NotZero,((_tmp6E8.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmpBA),_tmp6E8)))),_tmp6E7))));}
...
# 648
 if(possibly_null){
struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp6EB;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp6EA;e->annot=(void*)((_tmp6EA=_cycalloc(sizeof(*_tmp6EA)),((_tmp6EA[0]=((_tmp6EB.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp6EB.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmpBA),_tmp6EB)))),_tmp6EA))));}else{
# 651
struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct _tmp6EE;struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp6ED;e->annot=(void*)((_tmp6ED=_cycalloc(sizeof(*_tmp6ED)),((_tmp6ED[0]=((_tmp6EE.tag=Cyc_CfFlowInfo_NotZero,((_tmp6EE.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmpBA),_tmp6EE)))),_tmp6ED))));}
...
goto _LLA4;}}_LLA4:;}{
# 662
struct _tuple16 _tmp6EF;return(_tmp6EF.f1=f,((_tmp6EF.f2=Cyc_CfFlowInfo_lookup_place(_tmpB9,_tmpC2),_tmp6EF)));};}case 0: _LL94: _LL95:
# 664
 e->annot=(void*)& Cyc_CfFlowInfo_IsZero_val;{
struct _tuple16 _tmp6F0;return(_tmp6F0.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp6F0.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpB5,0,(env->fenv)->unknown_all),_tmp6F0)));};case 3: _LL96: _tmpC1=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmpC0)->f1;_LL97:
# 667
...
# 671
{struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp6F3;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp6F2;e->annot=(void*)((_tmp6F2=_cycalloc(sizeof(*_tmp6F2)),((_tmp6F2[0]=((_tmp6F3.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp6F3.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmpBA),_tmp6F3)))),_tmp6F2))));}
...
# 685
{struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp6F6;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp6F5;e->annot=(void*)((_tmp6F5=_cycalloc(sizeof(*_tmp6F5)),((_tmp6F5[0]=((_tmp6F6.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp6F6.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmpBA),_tmp6F6)))),_tmp6F5))));}
goto _LLB5;}_LLB5:;}{
# 689
...
# 694
{const char*_tmp6F9;void*_tmp6F8;(_tmp6F8=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp6F9="attempt to dereference a consumed alias-free pointer",_tag_dyneither(_tmp6F9,sizeof(char),53))),_tag_dyneither(_tmp6F8,sizeof(void*),0)));}
goto _LLC4;}else{_LLC7: _LLC8: {
# 697
const char*_tmp6FC;void*_tmp6FB;(_tmp6FB=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp6FC="dereference of possibly uninitialized pointer",_tag_dyneither(_tmp6FC,sizeof(char),46))),_tag_dyneither(_tmp6FB,sizeof(void*),0)));}}_LLC4:;}
# 699
goto _LLBE;}case Cyc_CfFlowInfo_AllIL: _LLBD: _LLBE: {
# 701
struct _tuple16 _tmp6FD;return(_tmp6FD.f1=f,((_tmp6FD.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpB5,0,(env->fenv)->unknown_all),_tmp6FD)));}default: _LLBF: _LLC0: {
# 703
struct _tuple16 _tmp6FE;return(_tmp6FE.f1=f,((_tmp6FE.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpB5,0,(env->fenv)->unknown_none),_tmp6FE)));}}_LLBA:;};}_LL83:;}}else{_LL81: _LL82: {
# 706
struct Cyc_Core_Impossible_exn_struct _tmp704;const char*_tmp703;struct Cyc_Core_Impossible_exn_struct*_tmp702;(int)_throw((void*)((_tmp702=_cycalloc(sizeof(*_tmp702)),((_tmp702[0]=((_tmp704.tag=Cyc_Core_Impossible,((_tmp704.f1=((_tmp703="right deref of non-pointer-type",_tag_dyneither(_tmp703,sizeof(char),32))),_tmp704)))),_tmp702)))));}}_LL7E:;}
# 713
...
{struct _tuple18 _tmp705;struct _tuple18 _tmpFA=(_tmp705.f1=inflow,((_tmp705.f2=_tmpF9,_tmp705)));struct _tuple18 _tmpFB=_tmpFA;struct Cyc_Dict_Dict _tmpFC;struct Cyc_List_List*_tmpFD;struct Cyc_CfFlowInfo_Place*_tmpFE;if(((_tmpFB.f1).ReachableFL).tag == 2){if(((_tmpFB.f2).PlaceL).tag == 1){_LLD2: _tmpFC=(((_tmpFB.f1).ReachableFL).val).f1;_tmpFD=(((_tmpFB.f1).ReachableFL).val).f2;_tmpFE=((_tmpFB.f2).PlaceL).val;_LLD3: {
# 753
...
struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp708;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp707;_tmpFF=(void*)((_tmp707=_region_malloc((env->fenv)->r,sizeof(*_tmp707)),((_tmp707[0]=((_tmp708.tag=8,((_tmp708.f1=(struct Cyc_Absyn_Vardecl*)_tmp103->hd,((_tmp708.f2=_tmpFF,_tmp708)))))),_tmp707))));}
# 760
...
# 769
{const char*_tmp70B;void*_tmp70A;(_tmp70A=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp70B="noconsume() parameters must be l-values",_tag_dyneither(_tmp70B,sizeof(char),40))),_tag_dyneither(_tmp70A,sizeof(void*),0)));}
...
# 787
struct _tuple16 _tmp70C;return(_tmp70C.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp70C.f2=rval,_tmp70C)));}}else{_LLDE: _tmp10A=((_tmp109.ReachableFL).val).f1;_tmp10B=((_tmp109.ReachableFL).val).f2;_LLDF: {
# 789
...
# 803
{const char*_tmp70F;void*_tmp70E;(_tmp70E=0,Cyc_Tcutil_warn(lexp->loc,((_tmp70F="assignment may overwrite alias-free pointer(s)",_tag_dyneither(_tmp70F,sizeof(char),47))),_tag_dyneither(_tmp70E,sizeof(void*),0)));}
goto _LLE8;}_LLE8:;};}
# 808
Cyc_NewControlFlow_update_tryflow(env,outflow);{
struct _tuple16 _tmp710;return(_tmp710.f1=outflow,((_tmp710.f2=rval,_tmp710)));};}}else{_LLE3: _LLE4: {
# 811
struct _tuple16 _tmp711;return(_tmp711.f1=Cyc_NewControlFlow_use_Rval(env,rexp->loc,outflow,rval),((_tmp711.f2=rval,_tmp711)));}}_LLE0:;}}_LLDB:;}
# 818
...
# 829
{struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp717;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp716;struct Cyc_CfFlowInfo_Place*_tmp715;_tmp119=Cyc_CfFlowInfo_assign_place(fenv,loc,_tmp119,env->all_changed,(
(_tmp715=_region_malloc(env->r,sizeof(*_tmp715)),((_tmp715->root=(void*)((_tmp717=_region_malloc(env->r,sizeof(*_tmp717)),((_tmp717[0]=((_tmp716.tag=0,((_tmp716.f1=vd,_tmp716)))),_tmp717)))),((_tmp715->fields=0,_tmp715)))))),rval);}
# 832
...
if((*((struct _tuple24*)x->hd)).f1 == 0){struct Cyc_List_List*_tmp718;es=((_tmp718=_cycalloc(sizeof(*_tmp718)),((_tmp718->hd=(struct Cyc_Absyn_Exp*)_check_null((*((struct _tuple24*)x->hd)).f2),((_tmp718->tl=es,_tmp718))))));}}}
# 857
...
if(_tmp129->topt == 0){
const char*_tmp71C;void*_tmp71B[1];struct Cyc_String_pa_PrintArg_struct _tmp71A;(_tmp71A.tag=0,((_tmp71A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_exp2string(_tmp129)),((_tmp71B[0]=& _tmp71A,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp71C="oops! pattern init expr %s has no type!\n",_tag_dyneither(_tmp71C,sizeof(char),41))),_tag_dyneither(_tmp71B,sizeof(void*),1)))))));}{
# 885
struct Cyc_List_List _tmp71D;struct Cyc_List_List l=(_tmp71D.hd=_tmp129,((_tmp71D.tl=0,_tmp71D)));
...
# 894
{struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp720;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp71F;_tmp134=(void*)((_tmp71F=_region_malloc(fenv->r,sizeof(*_tmp71F)),((_tmp71F[0]=((_tmp720.tag=8,((_tmp720.f1=*_tmp128,((_tmp720.f2=_tmp134,_tmp720)))))),_tmp71F))));}{
# 897
void*_tmp13C=Cyc_CfFlowInfo_lookup_place(_tmp136,_tmp139);
{struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp723;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp722;_tmp13C=(void*)((_tmp722=_region_malloc(fenv->r,sizeof(*_tmp722)),((_tmp722[0]=((_tmp723.tag=8,((_tmp723.f1=*_tmp128,((_tmp723.f2=_tmp13C,_tmp723)))))),_tmp722))));}
...
# 908
const char*_tmp727;void*_tmp726[1];struct Cyc_String_pa_PrintArg_struct _tmp725;(_tmp725.tag=0,((_tmp725.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_exp2string(_tmp129)),((_tmp726[0]=& _tmp725,Cyc_CfFlowInfo_aerr(exp_loc,((_tmp727="aliased pattern expression not an l-value: %s",_tag_dyneither(_tmp727,sizeof(char),46))),_tag_dyneither(_tmp726,sizeof(void*),1)))))));}}_LL107:;}
# 916
...
{const char*_tmp72E;void*_tmp72D[4];struct Cyc_String_pa_PrintArg_struct _tmp72C;struct Cyc_String_pa_PrintArg_struct _tmp72B;struct Cyc_String_pa_PrintArg_struct _tmp72A;struct Cyc_String_pa_PrintArg_struct _tmp729;(_tmp729.tag=0,((_tmp729.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Relations_relns2string(_tmp157)),((_tmp72A.tag=0,((_tmp72A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s3),((_tmp72B.tag=0,((_tmp72B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s2),((_tmp72C.tag=0,((_tmp72C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s1),((_tmp72D[0]=& _tmp72C,((_tmp72D[1]=& _tmp72B,((_tmp72D[2]=& _tmp72A,((_tmp72D[3]=& _tmp729,Cyc_Tcutil_terr(loc,((_tmp72E="cannot prove that @requires clause %s %s %s is satisfied\n (all I know is %s)",_tag_dyneither(_tmp72E,sizeof(char),77))),_tag_dyneither(_tmp72D,sizeof(void*),4)))))))))))))))))))))))));}
break;}}
# 992
goto _LL132;}_LL132:;}struct _tuple25{union Cyc_CfFlowInfo_AbsLVal f1;union Cyc_CfFlowInfo_FlowInfo f2;};struct _tuple26{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};static struct _tuple16 Cyc_NewControlFlow_anal_Rexp(struct Cyc_NewControlFlow_AnalEnv*env,int copy_ctxt,union Cyc_CfFlowInfo_FlowInfo inflow,struct Cyc_Absyn_Exp*e);static void _tmp7E1(unsigned int*_tmp7E0,unsigned int*_tmp7DF,void***_tmp7DD,struct Cyc_List_List**_tmp31F){for(*_tmp7E0=0;*_tmp7E0 < *_tmp7DF;(*_tmp7E0)++){
# 1585 "new_control_flow.cyc"
void*_tmp7DB;(*_tmp7DD)[*_tmp7E0]=(void*)((_tmp7DB=(void*)((struct Cyc_List_List*)_check_null(*_tmp31F))->hd,((*_tmp31F=(*_tmp31F)->tl,_tmp7DB))));}}
...
struct _tuple16 _tmp72F;return(_tmp72F.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp72F.f2=_tmp160->unknown_all,_tmp72F)));}}else{_LL13A: _tmp162=((_tmp161.ReachableFL).val).f1;_tmp163=((_tmp161.ReachableFL).val).f2;_LL13B:
...
struct _tuple18 _tmp730;struct _tuple18 _tmp169=(_tmp730.f1=_tmp167,((_tmp730.f2=_tmp168,_tmp730)));struct _tuple18 _tmp16A=_tmp169;struct Cyc_Dict_Dict _tmp16B;struct Cyc_List_List*_tmp16C;struct Cyc_CfFlowInfo_Place*_tmp16D;if(((_tmp16A.f1).ReachableFL).tag == 2){if(((_tmp16A.f2).PlaceL).tag == 1){_LL140: _tmp16B=(((_tmp16A.f1).ReachableFL).val).f1;_tmp16C=(((_tmp16A.f1).ReachableFL).val).f2;_tmp16D=((_tmp16A.f2).PlaceL).val;_LL141: {
# 1053
...
{const char*_tmp733;void*_tmp732;(_tmp732=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp733="expression attempts to copy a consumed alias-free value",_tag_dyneither(_tmp733,sizeof(char),56))),_tag_dyneither(_tmp732,sizeof(void*),0)));}{
struct _tuple16 _tmp734;return(_tmp734.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp734.f2=_tmp160->unknown_all,_tmp734)));};}else{
# 1059
if(needs_unconsume){
# 1061
struct _tuple16 _tmp735;return(_tmp735.f1=_tmp167,((_tmp735.f2=Cyc_CfFlowInfo_make_unique_unconsumed(_tmp160,_tmp16E),_tmp735)));}else{
# 1064
...
# 1076
struct _tuple16 _tmp736;return(_tmp736.f1=Cyc_CfFlowInfo_ReachableFL(_tmp174,_tmp16C),((_tmp736.f2=_tmp16E,_tmp736)));}}}}else{goto _LL142;}}else{_LL142: _LL143:
# 1078
 goto _LL13F;}_LL13F:;};}{
# 1081
...
struct _tuple16 _tmp737;return(_tmp737.f1=_tmp1BC,((_tmp737.f2=_tmp1B9,_tmp737)));};};}}else{_LL147: _tmp1B4=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp178)->f2;_LL148:
# 1091
...
struct _tuple16 _tmp738;return(_tmp738.f1=inflow,((_tmp738.f2=_tmp160->zero,_tmp738)));}}else{_LL151: _LL152:
...
# 1098
struct _tuple16 _tmp739;return(_tmp739.f1=inflow,((_tmp739.f2=_tmp160->notzeroall,_tmp739)));}case 1: _LL163: _LL164: {
# 1109
struct _tuple16 _tmp73A;return(_tmp73A.f1=inflow,((_tmp73A.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp160,(void*)_check_null(e->topt),0,_tmp160->unknown_all),_tmp73A)));}case 3: _LL165: _tmp1B1=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp178)->f2)->f1;_LL166:
# 1112
...
# 1116
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp73B;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct vdroot=(_tmp73B.tag=0,((_tmp73B.f1=_tmp1AF,_tmp73B)));
struct _tuple16 _tmp73C;return(_tmp73C.f1=inflow,((_tmp73C.f2=((void*(*)(struct Cyc_Dict_Dict d,int(*cmp)(void*,void*),void*k))Cyc_Dict_lookup_other)(d,Cyc_CfFlowInfo_root_cmp,(void*)& vdroot),_tmp73C)));}default: _LL1A3: _LL1A4:
# 1723
...
struct _tuple16 _tmp73D;return(_tmp73D.f1=inflow,((_tmp73D.f2=_tmp160->unknown_all,_tmp73D)));}case 2: _LL16B: _tmp1AB=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_tmp1AC=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp178)->f2;_LL16C: {
# 1123
...
struct _tuple16 _tmp73E;return(_tmp73E.f1=_tmp1C7,((_tmp73E.f2=_tmp1C8,_tmp73E)));};}case 4: _LL16D: _tmp1AA=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_LL16E: {
# 1127
struct Cyc_List_List _tmp73F;struct Cyc_List_List _tmp1CA=(_tmp73F.hd=_tmp1AA,((_tmp73F.tl=0,_tmp73F)));
...
goto _LL1BC;}else{goto _LL1BF;}}else{_LL1BF: _LL1C0:
 goto _LL1BC;}_LL1BC:;}{
# 1140
struct _tuple16 _tmp741;return(_tmp741.f1=_tmp1CD,((_tmp741.f2=_tmp160->unknown_all,_tmp741)));};};}case 3: if(((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp178)->f2 != 0){_LL16F: _tmp1A8=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_tmp1A9=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp178)->f3;_LL170:
# 1143
...
# 1147
struct Cyc_List_List _tmp746;struct Cyc_List_List _tmp1DC=(_tmp746.hd=_tmp1A9,((_tmp746.tl=0,_tmp746)));
struct Cyc_List_List _tmp747;struct Cyc_List_List _tmp1DD=(_tmp747.hd=_tmp1A8,((_tmp747.tl=& _tmp1DC,_tmp747)));
...
goto _LL1C7;}else{_LL1CA: _LL1CB:
 goto _LL1C7;}_LL1C7:;}{
# 1172
struct _tuple16 _tmp748;return(_tmp748.f1=_tmp1E0,((_tmp748.f2=_tmp160->unknown_all,_tmp748)));};};};}else{_LL171: _tmp1A6=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_tmp1A7=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp178)->f3;_LL172:
# 1176
 if(copy_ctxt  && Cyc_Tcutil_is_noalias_pointer_or_aggr(env->r,(void*)_check_null(e->topt))){
{const char*_tmp74B;void*_tmp74A;(_tmp74A=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp74B="cannot track alias-free pointers through multiple assignments",_tag_dyneither(_tmp74B,sizeof(char),62))),_tag_dyneither(_tmp74A,sizeof(void*),0)));}{
struct _tuple16 _tmp74C;return(_tmp74C.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp74C.f2=_tmp160->unknown_all,_tmp74C)));};}{
# 1180
struct Cyc_Dict_Dict*_tmp1EF=env->all_changed;
# 1182
{struct Cyc_Absyn_Exp*_tmp74D[2];inflow=Cyc_NewControlFlow_expand_unique_places(env,inflow,((_tmp74D[1]=_tmp1A7,((_tmp74D[0]=_tmp1A6,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(env->r,_tag_dyneither(_tmp74D,sizeof(struct Cyc_Absyn_Exp*),2)))))));}
while(1){
{struct Cyc_Dict_Dict*_tmp74E;env->all_changed=((_tmp74E=_region_malloc(env->r,sizeof(*_tmp74E)),((_tmp74E[0]=_tmp160->mt_place_set,_tmp74E))));}{
...
{struct Cyc_Dict_Dict*_tmp74F;env->all_changed=((_tmp74F=_region_malloc(env->r,sizeof(*_tmp74F)),((_tmp74F[0]=_tmp160->mt_place_set,_tmp74F))));}{
...
struct _tuple16 _tmp750;return(_tmp750.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp750.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp160,(void*)_check_null(e->topt),0,_tmp160->unknown_all),_tmp750)));};}case 9: _LL177: _tmp1A1=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_tmp1A2=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp178)->f2;_LL178: {
# 1220
...
struct Cyc_List_List*_tmp751;struct _tuple23 _tmp20A=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,((_tmp751=_region_malloc(temp,sizeof(*_tmp751)),((_tmp751->hd=_tmp1A1,((_tmp751->tl=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x))Cyc_List_rcopy)(temp,_tmp1A2),_tmp751)))))),0,1);struct _tuple23 _tmp20B=_tmp20A;union Cyc_CfFlowInfo_FlowInfo _tmp20C;struct Cyc_List_List*_tmp20D;_LL1DE: _tmp20C=_tmp20B.f1;_tmp20D=_tmp20B.f2;_LL1DF:;{
# 1224
...
# 1242
{struct Cyc_List_List*_tmp752;init_params=((_tmp752=_region_malloc(temp,sizeof(*_tmp752)),((_tmp752->hd=(void*)_tmp21B,((_tmp752->tl=init_params,_tmp752))))));}goto _LL1EA;case 21: _LL1ED: _tmp21A=((struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*)_tmp218)->f1;_LL1EE:
# 1244
{struct Cyc_List_List*_tmp753;nolive_unique_params=((_tmp753=_region_malloc(temp,sizeof(*_tmp753)),((_tmp753->hd=(void*)_tmp21A,((_tmp753->tl=nolive_unique_params,_tmp753))))));}
goto _LL1EA;case 22: _LL1EF: _tmp219=((struct Cyc_Absyn_Noconsume_att_Absyn_Attribute_struct*)_tmp218)->f1;_LL1F0:
# 1248
{struct Cyc_List_List*_tmp754;noconsume_params=((_tmp754=_region_malloc(temp,sizeof(*_tmp754)),((_tmp754->hd=(void*)_tmp219,((_tmp754->tl=noconsume_params,_tmp754))))));}
goto _LL1EA;default: _LL1F1: _LL1F2:
 goto _LL1EA;}_LL1EA:;}
# 1252
goto _LL1E5;}else{_LL1E8: _LL1E9: {
const char*_tmp757;void*_tmp756;(_tmp756=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp757="anal_Rexp: bad function type",_tag_dyneither(_tmp757,sizeof(char),29))),_tag_dyneither(_tmp756,sizeof(void*),0)));}}_LL1E5:;}
# 1255
goto _LL1E0;}else{_LL1E3: _LL1E4: {
const char*_tmp75A;void*_tmp759;(_tmp759=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp75A="anal_Rexp: bad function type",_tag_dyneither(_tmp75A,sizeof(char),29))),_tag_dyneither(_tmp759,sizeof(void*),0)));}}_LL1E0:;}
# 1258
...
const char*_tmp75D;void*_tmp75C;(_tmp75C=0,Cyc_CfFlowInfo_aerr(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp1A2))->hd)->loc,((_tmp75D="expression may not be initialized",_tag_dyneither(_tmp75D,sizeof(char),34))),_tag_dyneither(_tmp75C,sizeof(void*),0)));}
...
const char*_tmp760;void*_tmp75F;(_tmp75F=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp760="anal_Rexp:bad type for initialized arg",_tag_dyneither(_tmp760,sizeof(char),39))),_tag_dyneither(_tmp75F,sizeof(void*),0)));}}_LL202:;}
# 1283
...
struct _tuple16 _tmp761;struct _tuple16 _tmp234=(_tmp761.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp761.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp160,(void*)_check_null(e->topt),0,_tmp160->unknown_all),_tmp761)));_npop_handler(0);return _tmp234;}else{
# 1320
struct _tuple16 _tmp762;struct _tuple16 _tmp236=(_tmp762.f1=_tmp20E,((_tmp762.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp160,(void*)_check_null(e->topt),0,_tmp160->unknown_all),_tmp762)));_npop_handler(0);return _tmp236;}};};}
# 1221
...
# 1323
struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct _tmp765;struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_tmp764;void*root=(void*)((_tmp764=_region_malloc(_tmp160->r,sizeof(*_tmp764)),((_tmp764[0]=((_tmp765.tag=1,((_tmp765.f1=_tmp19F,((_tmp765.f2=(void*)_check_null(e->topt),_tmp765)))))),_tmp764))));
struct Cyc_CfFlowInfo_Place*_tmp766;struct Cyc_CfFlowInfo_Place*place=(_tmp766=_region_malloc(_tmp160->r,sizeof(*_tmp766)),((_tmp766->root=root,((_tmp766->fields=0,_tmp766)))));
struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp769;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp768;void*rval=(void*)((_tmp768=_region_malloc(_tmp160->r,sizeof(*_tmp768)),((_tmp768[0]=((_tmp769.tag=5,((_tmp769.f1=place,_tmp769)))),_tmp768))));
void*place_val;
...
{struct Cyc_Absyn_Exp*_tmp76A[2];struct _tuple23 _tmp239=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,(
(_tmp76A[1]=_tmp19F,((_tmp76A[0]=_tmp19D,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(temp,_tag_dyneither(_tmp76A,sizeof(struct Cyc_Absyn_Exp*),2)))))),1,1);
# 1334
struct _tuple23 _tmp23A=_tmp239;union Cyc_CfFlowInfo_FlowInfo _tmp23B;struct Cyc_List_List*_tmp23C;_LL208: _tmp23B=_tmp23A.f1;_tmp23C=_tmp23A.f2;_LL209:;
# 1336
outflow=_tmp23B;}
# 1334
...
struct _tuple16 _tmp76B;return(_tmp76B.f1=outflow,((_tmp76B.f2=rval,_tmp76B)));}}else{_LL210: _tmp242=((_tmp241.ReachableFL).val).f1;_tmp243=((_tmp241.ReachableFL).val).f2;_LL211: {
# 1345
struct _tuple16 _tmp76C;return(_tmp76C.f1=Cyc_CfFlowInfo_ReachableFL(((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp242,root,place_val),_tmp243),((_tmp76C.f2=rval,_tmp76C)));}}_LL20D:;};};}case 34: _LL17B: _tmp19A=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_tmp19B=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp178)->f2;_LL17C: {
# 1349
void*left_rval;
void*right_rval;
union Cyc_CfFlowInfo_FlowInfo outflow;
...
struct Cyc_Absyn_Exp*_tmp76D[2];struct _tuple23 _tmp24C=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,(
(_tmp76D[1]=_tmp19B,((_tmp76D[0]=_tmp19A,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(temp,_tag_dyneither(_tmp76D,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,0);
# 1356
struct _tuple23 _tmp24D=_tmp24C;union Cyc_CfFlowInfo_FlowInfo _tmp24E;struct Cyc_List_List*_tmp24F;_LL213: _tmp24E=_tmp24D.f1;_tmp24F=_tmp24D.f2;_LL214:;
# 1358
...
const char*_tmp770;void*_tmp76F;(_tmp76F=0,Cyc_Tcutil_terr(_tmp19B->loc,((_tmp770="expression may not be fully initialized",_tag_dyneither(_tmp770,sizeof(char),40))),_tag_dyneither(_tmp76F,sizeof(void*),0)));}
goto _LL220;}_LL220:;}
# 1380
...
const char*_tmp773;void*_tmp772;(_tmp772=0,Cyc_Tcutil_terr(_tmp19A->loc,((_tmp773="expression may not be fully initialized",_tag_dyneither(_tmp773,sizeof(char),40))),_tag_dyneither(_tmp772,sizeof(void*),0)));}
goto _LL225;}_LL225:;}
# 1391
...
goto _LL21B;}else{_LL21E: _LL21F:
 goto _LL21B;}_LL21B:;}{
# 1401
struct _tuple16 _tmp774;struct _tuple16 _tmp263=(_tmp774.f1=outflow,((_tmp774.f2=_tmp160->unknown_all,_tmp774)));_npop_handler(0);return _tmp263;};};};
# 1355
...
# 1404
struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct _tmp777;struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_tmp776;void*root=(void*)((_tmp776=_region_malloc(_tmp160->r,sizeof(*_tmp776)),((_tmp776[0]=((_tmp777.tag=1,((_tmp777.f1=_tmp199,((_tmp777.f2=(void*)_check_null(e->topt),_tmp777)))))),_tmp776))));
struct Cyc_CfFlowInfo_Place*_tmp778;struct Cyc_CfFlowInfo_Place*place=(_tmp778=_region_malloc(_tmp160->r,sizeof(*_tmp778)),((_tmp778->root=root,((_tmp778->fields=0,_tmp778)))));
struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp77B;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp77A;void*rval=(void*)((_tmp77A=_region_malloc(_tmp160->r,sizeof(*_tmp77A)),((_tmp77A[0]=((_tmp77B.tag=5,((_tmp77B.f1=place,_tmp77B)))),_tmp77A))));
((int(*)(struct Cyc_Dict_Dict*set,struct Cyc_CfFlowInfo_Place*place,unsigned int loc))Cyc_CfFlowInfo_update_place_set)(env->all_changed,place,0);{
union Cyc_CfFlowInfo_FlowInfo outflow;
void*place_val;
if(_tmp198 != 0){
struct _RegionHandle _tmp264=_new_region("temp");struct _RegionHandle*temp=& _tmp264;_push_region(temp);
{struct Cyc_Absyn_Exp*_tmp77C[2];struct _tuple23 _tmp265=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,(
(_tmp77C[1]=_tmp199,((_tmp77C[0]=_tmp198,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(temp,_tag_dyneither(_tmp77C,sizeof(struct Cyc_Absyn_Exp*),2)))))),1,1);
# 1412
struct _tuple23 _tmp266=_tmp265;union Cyc_CfFlowInfo_FlowInfo _tmp267;struct Cyc_List_List*_tmp268;_LL22B: _tmp267=_tmp266.f1;_tmp268=_tmp266.f2;_LL22C:;
# 1414
outflow=_tmp267;
...
struct _tuple16 _tmp77D;return(_tmp77D.f1=outflow,((_tmp77D.f2=rval,_tmp77D)));}}else{_LL233: _tmp26F=((_tmp26E.ReachableFL).val).f1;_tmp270=((_tmp26E.ReachableFL).val).f2;_LL234: {
# 1425
struct _tuple16 _tmp77E;return(_tmp77E.f1=Cyc_CfFlowInfo_ReachableFL(((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp26F,root,place_val),_tmp270),((_tmp77E.f2=rval,_tmp77E)));}}_LL230:;};};}case 14: _LL17F: _tmp197=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_LL180: {
# 1429
...
struct _tuple16 _tmp77F;return(_tmp77F.f1=_tmp27A,((_tmp77F.f2=_tmp160->notzeroall,_tmp77F)));}}else{_LL23B: _tmp27D=(_tmp27C.PlaceL).val;_LL23C: {
struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp785;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp784;struct _tuple16 _tmp783;return(_tmp783.f1=_tmp27A,((_tmp783.f2=(void*)((_tmp785=_region_malloc(env->r,sizeof(*_tmp785)),((_tmp785[0]=((_tmp784.tag=5,((_tmp784.f1=_tmp27D,_tmp784)))),_tmp785)))),_tmp783)));}}_LL238:;};}case 19: _LL181: _tmp196=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_LL182: {
# 1436
...
if(_tmp194->topt == 0){
{const char*_tmp789;void*_tmp788[1];struct Cyc_String_pa_PrintArg_struct _tmp787;(_tmp787.tag=0,((_tmp787.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp788[0]=& _tmp787,Cyc_fprintf(Cyc_stderr,((_tmp789="aggrmember exp %s\n",_tag_dyneither(_tmp789,sizeof(char),19))),_tag_dyneither(_tmp788,sizeof(void*),1)))))));}{
const char*_tmp78D;void*_tmp78C[1];struct Cyc_String_pa_PrintArg_struct _tmp78B;(_tmp78B.tag=0,((_tmp78B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmp194)),((_tmp78C[0]=& _tmp78B,Cyc_fprintf(Cyc_stderr,((_tmp78D="oops! %s.topt = null!\n",_tag_dyneither(_tmp78D,sizeof(char),23))),_tag_dyneither(_tmp78C,sizeof(void*),1)))))));};}{
# 1445
void*_tmp290=(void*)_check_null(_tmp194->topt);
if(Cyc_Absyn_is_nontagged_nonrequire_union_type(_tmp290)){
# 1448
struct _tuple16 _tmp78E;return(_tmp78E.f1=_tmp288,((_tmp78E.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp160,(void*)_check_null(e->topt),0,_tmp160->unknown_all),_tmp78E)));}
# 1450
...
struct _tuple16 _tmp78F;return(_tmp78F.f1=_tmp288,((_tmp78F.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp160,(void*)_check_null(e->topt),1,_tmp160->unknown_none),_tmp78F)));}{
struct _tuple16 _tmp790;return(_tmp790.f1=_tmp288,((_tmp790.f2=*((void**)_check_dyneither_subscript(_tmp298,sizeof(void*),_tmp299)),_tmp790)));};}}else{_LL249: _LL24A:
# 1461
{const char*_tmp793;void*_tmp792;(_tmp792=0,Cyc_fprintf(Cyc_stderr,((_tmp793="the bad rexp is :",_tag_dyneither(_tmp793,sizeof(char),18))),_tag_dyneither(_tmp792,sizeof(void*),0)));}
Cyc_CfFlowInfo_print_absrval(_tmp294);
{const char*_tmp796;void*_tmp795;(_tmp795=0,Cyc_fprintf(Cyc_stderr,((_tmp796="\n",_tag_dyneither(_tmp796,sizeof(char),2))),_tag_dyneither(_tmp795,sizeof(void*),0)));}{
struct Cyc_Core_Impossible_exn_struct _tmp7A3;const char*_tmp7A2;void*_tmp7A1[1];struct Cyc_String_pa_PrintArg_struct _tmp7A0;struct Cyc_Core_Impossible_exn_struct*_tmp79F;(int)_throw((void*)((_tmp79F=_cycalloc(sizeof(*_tmp79F)),((_tmp79F[0]=((_tmp7A3.tag=Cyc_Core_Impossible,((_tmp7A3.f1=(struct _dyneither_ptr)((_tmp7A0.tag=0,((_tmp7A0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp7A1[0]=& _tmp7A0,Cyc_aprintf(((_tmp7A2="anal_Rexp: AggrMember: %s",_tag_dyneither(_tmp7A2,sizeof(char),26))),_tag_dyneither(_tmp7A1,sizeof(void*),1)))))))),_tmp7A3)))),_tmp79F)))));};}_LL246:;};};};}case 37: _LL185: _tmp192=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_tmp193=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp178)->f2;_LL186: {
# 1471
...
struct _tuple16 _tmp7A4;return(_tmp7A4.f1=_tmp2A7,((_tmp7A4.f2=_tmp160->unknown_all,_tmp7A4)));}{
...
if(_tmp2AF != _tmp2B1){
struct _tuple16 _tmp7A5;return(_tmp7A5.f1=_tmp2A7,((_tmp7A5.f2=_tmp160->zero,_tmp7A5)));}else{
# 1483
struct _tuple16 _tmp7A6;return(_tmp7A6.f1=_tmp2A7,((_tmp7A6.f2=_tmp160->notzeroall,_tmp7A6)));}}else{
# 1485
struct _tuple16 _tmp7A7;return(_tmp7A7.f1=_tmp2A7,((_tmp7A7.f2=_tmp160->unknown_all,_tmp7A7)));}}}else{_LL254: _LL255: {
# 1487
struct Cyc_Core_Impossible_exn_struct _tmp7B4;const char*_tmp7B3;void*_tmp7B2[1];struct Cyc_String_pa_PrintArg_struct _tmp7B1;struct Cyc_Core_Impossible_exn_struct*_tmp7B0;(int)_throw((void*)((_tmp7B0=_cycalloc(sizeof(*_tmp7B0)),((_tmp7B0[0]=((_tmp7B4.tag=Cyc_Core_Impossible,((_tmp7B4.f1=(struct _dyneither_ptr)((_tmp7B1.tag=0,((_tmp7B1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp7B2[0]=& _tmp7B1,Cyc_aprintf(((_tmp7B3="anal_Rexp: TagCheck_e: %s",_tag_dyneither(_tmp7B3,sizeof(char),26))),_tag_dyneither(_tmp7B2,sizeof(void*),1)))))))),_tmp7B4)))),_tmp7B0)))));}}_LL251:;};};}case 21: _LL187: _tmp190=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_tmp191=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp178)->f2;_LL188: {
# 1492
...
# 1502
struct _tuple16 _tmp7B5;return(_tmp7B5.f1=_tmp2C0,((_tmp7B5.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp160,(void*)_check_null(e->topt),0,_tmp160->unknown_all),_tmp7B5)));}
# 1504
...
struct _tuple16 _tmp7B6;return(_tmp7B6.f1=_tmp2C0,((_tmp7B6.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp160,(void*)_check_null(e->topt),1,_tmp160->unknown_none),_tmp7B6)));}{
struct _tuple16 _tmp7B7;return(_tmp7B7.f1=_tmp2C0,((_tmp7B7.f2=*((void**)_check_dyneither_subscript(_tmp2CC,sizeof(void*),_tmp2CD)),_tmp7B7)));};}}else{_LL267: _LL268: {
struct Cyc_Core_Impossible_exn_struct _tmp7BD;const char*_tmp7BC;struct Cyc_Core_Impossible_exn_struct*_tmp7BB;(int)_throw((void*)((_tmp7BB=_cycalloc(sizeof(*_tmp7BB)),((_tmp7BB[0]=((_tmp7BD.tag=Cyc_Core_Impossible,((_tmp7BD.f1=((_tmp7BC="anal_Rexp: AggrArrow",_tag_dyneither(_tmp7BC,sizeof(char),21))),_tmp7BD)))),_tmp7BB)))));}}_LL264:;};};}else{_LL25F: _LL260: {
# 1516
struct Cyc_Core_Impossible_exn_struct _tmp7C3;const char*_tmp7C2;struct Cyc_Core_Impossible_exn_struct*_tmp7C1;(int)_throw((void*)((_tmp7C1=_cycalloc(sizeof(*_tmp7C1)),((_tmp7C1[0]=((_tmp7C3.tag=Cyc_Core_Impossible,((_tmp7C3.f1=((_tmp7C2="anal_Rexp: AggrArrow ptr",_tag_dyneither(_tmp7C2,sizeof(char),25))),_tmp7C3)))),_tmp7C1)))));}}_LL25C:;};};}case 5: _LL189: _tmp18D=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_tmp18E=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp178)->f2;_tmp18F=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp178)->f3;_LL18A: {
# 1520
...
struct _tuple16 _tmp7C4;struct _tuple16 _tmp2E4=(_tmp7C4.f1=_tmp2E2,((_tmp7C4.f2=_tmp2E3,_tmp7C4)));
struct _tuple16 _tmp7C5;struct _tuple16 _tmp2E5=(_tmp7C5.f1=_tmp2DF,((_tmp7C5.f2=_tmp160->zero,_tmp7C5)));
...
struct _tuple16 _tmp7C6;struct _tuple16 _tmp2F0=(_tmp7C6.f1=_tmp2EE,((_tmp7C6.f2=_tmp2EF,_tmp7C6)));
struct _tuple16 _tmp7C7;struct _tuple16 _tmp2F1=(_tmp7C7.f1=_tmp2EA,((_tmp7C7.f2=_tmp160->notzeroall,_tmp7C7)));
...
{struct Cyc_Absyn_Exp*_tmp7C8[2];struct _tuple23 _tmp2F5=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,(
(_tmp7C8[1]=_tmp188,((_tmp7C8[0]=_tmp187,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(temp,_tag_dyneither(_tmp7C8,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,1);
# 1542
struct _tuple23 _tmp2F6=_tmp2F5;union Cyc_CfFlowInfo_FlowInfo _tmp2F7;struct Cyc_List_List*_tmp2F8;_LL279: _tmp2F7=_tmp2F6.f1;_tmp2F8=_tmp2F6.f2;_LL27A:;{
# 1546
...
const char*_tmp7CB;void*_tmp7CA;(_tmp7CA=0,Cyc_CfFlowInfo_aerr(_tmp188->loc,((_tmp7CB="expression may not be initialized",_tag_dyneither(_tmp7CB,sizeof(char),34))),_tag_dyneither(_tmp7CA,sizeof(void*),0)));}{
...
struct _tuple16 _tmp7CC;struct _tuple16 _tmp30A=(_tmp7CC.f1=_tmp2F9,((_tmp7CC.f2=*((void**)_check_dyneither_subscript(_tmp308,sizeof(void*),(int)i)),_tmp7CC)));_npop_handler(0);return _tmp30A;}}else{_LL28D: _LL28E: {
struct Cyc_Core_Impossible_exn_struct _tmp7D2;const char*_tmp7D1;struct Cyc_Core_Impossible_exn_struct*_tmp7D0;(int)_throw((void*)((_tmp7D0=_cycalloc(sizeof(*_tmp7D0)),((_tmp7D0[0]=((_tmp7D2.tag=Cyc_Core_Impossible,((_tmp7D2.f1=((_tmp7D1="anal_Rexp: Subscript",_tag_dyneither(_tmp7D1,sizeof(char),21))),_tmp7D2)))),_tmp7D0)))));}}_LL28A:;};}case 5: _LL283: _tmp302=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp301)->f1).ptr_atts).bounds;_LL284: {
# 1569
...
struct _tuple16 _tmp7D3;struct _tuple16 _tmp314=(_tmp7D3.f1=_tmp310,((_tmp7D3.f2=_tmp311,_tmp7D3)));_npop_handler(0);return _tmp314;}}else{_LL295: _LL296: {
struct _tuple16 _tmp7D4;struct _tuple16 _tmp316=(_tmp7D4.f1=_tmp2F9,((_tmp7D4.f2=_tmp311,_tmp7D4)));_npop_handler(0);return _tmp316;}}_LL292:;};}default: _LL285: _LL286: {
# 1574
struct Cyc_Core_Impossible_exn_struct _tmp7DA;const char*_tmp7D9;struct Cyc_Core_Impossible_exn_struct*_tmp7D8;(int)_throw((void*)((_tmp7D8=_cycalloc(sizeof(*_tmp7D8)),((_tmp7D8[0]=((_tmp7DA.tag=Cyc_Core_Impossible,((_tmp7DA.f1=((_tmp7D9="anal_Rexp: Subscript -- bad type",_tag_dyneither(_tmp7D9,sizeof(char),33))),_tmp7DA)))),_tmp7D8)))));}}_LL280:;};};}
# 1542
...
unsigned int _tmp7E0;unsigned int _tmp7DF;struct _dyneither_ptr _tmp7DE;void**_tmp7DD;unsigned int _tmp7DC;struct _dyneither_ptr aggrdict=
(_tmp7DC=(unsigned int)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp186),((_tmp7DD=(void**)_region_malloc(env->r,_check_times(sizeof(void*),_tmp7DC)),((_tmp7DE=_tag_dyneither(_tmp7DD,sizeof(void*),_tmp7DC),((((_tmp7DF=_tmp7DC,_tmp7E1(& _tmp7E0,& _tmp7DF,& _tmp7DD,& _tmp31F))),_tmp7DE)))))));
# 1589
struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp7EB;struct Cyc_CfFlowInfo_UnionRInfo _tmp7EA;struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct _tmp7E9;struct _tuple16 _tmp7E8;struct _tuple16 _tmp324=(_tmp7E8.f1=_tmp31E,((_tmp7E8.f2=(void*)((_tmp7EB=_region_malloc(env->r,sizeof(*_tmp7EB)),((_tmp7EB[0]=((_tmp7E9.tag=6,((_tmp7E9.f1=((_tmp7EA.is_union=0,((_tmp7EA.fieldnum=- 1,_tmp7EA)))),((_tmp7E9.f2=aggrdict,_tmp7E9)))))),_tmp7EB)))),_tmp7E8)));_npop_handler(0);return _tmp324;};}
# 1582
...
struct Cyc_Core_Impossible_exn_struct _tmp7F1;const char*_tmp7F0;struct Cyc_Core_Impossible_exn_struct*_tmp7EF;(int)_throw((void*)((_tmp7EF=_cycalloc(sizeof(*_tmp7EF)),((_tmp7EF[0]=((_tmp7F1.tag=Cyc_Core_Impossible,((_tmp7F1.f1=((_tmp7F0="anal_Rexp:anon struct has bad type",_tag_dyneither(_tmp7F0,sizeof(char),35))),_tmp7F1)))),_tmp7EF)))));}}_LL29A:;}
# 1597
...
struct Cyc_Core_Impossible_exn_struct _tmp7F7;const char*_tmp7F6;struct Cyc_Core_Impossible_exn_struct*_tmp7F5;(int)_throw((void*)((_tmp7F5=_cycalloc(sizeof(*_tmp7F5)),((_tmp7F5[0]=((_tmp7F7.tag=Cyc_Core_Impossible,((_tmp7F7.f1=((_tmp7F6="anal_Rexp:Aggregate_e",_tag_dyneither(_tmp7F6,sizeof(char),22))),_tmp7F7)))),_tmp7F5)))));}}else{_LL2A5: _tmp337=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp336)->f1;_LL2A6:
# 1613
...
# 1623
struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct _tmp7FD;struct Cyc_CfFlowInfo_UnionRInfo _tmp7FC;struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp7FB;struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp33C=(_tmp7FB=_region_malloc(env->r,sizeof(*_tmp7FB)),((_tmp7FB[0]=((_tmp7FD.tag=6,((_tmp7FD.f1=((_tmp7FC.is_union=_tmp183 == Cyc_Absyn_UnionA,((_tmp7FC.fieldnum=field_no,_tmp7FC)))),((_tmp7FD.f2=aggrdict,_tmp7FD)))))),_tmp7FB)));
struct _tuple16 _tmp7FE;struct _tuple16 _tmp33E=(_tmp7FE.f1=_tmp333,((_tmp7FE.f2=(void*)_tmp33C,_tmp7FE)));_npop_handler(0);return _tmp33E;};};}
# 1601
;_pop_region(temp);}}else{goto _LL199;}}else{_LL199: _LL19A: {
# 1627
const char*_tmp802;void*_tmp801[1];struct Cyc_String_pa_PrintArg_struct _tmp800;(_tmp800.tag=0,((_tmp800.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp801[0]=& _tmp800,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp802="anal_Rexp:missing aggrdeclimpl in %s",_tag_dyneither(_tmp802,sizeof(char),37))),_tag_dyneither(_tmp801,sizeof(void*),1)))))));}}case 25: _LL19B: _tmp181=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_LL19C: {
# 1629
...
struct _tuple16 _tmp803;struct _tuple16 _tmp34C=(_tmp803.f1=_tmp349,((_tmp803.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp160,(void*)_check_null(e->topt),0,_tmp160->unknown_all),_tmp803)));_npop_handler(0);return _tmp34C;};}
# 1630
...
struct _tuple16 _tmp804;return(_tmp804.f1=_tmp34F,((_tmp804.f2=_tmp160->unknown_all,_tmp804)));}}else{_LL2B0: _tmp352=((_tmp351.ReachableFL).val).f1;_tmp353=((_tmp351.ReachableFL).val).f2;_LL2B1:
# 1642
 if(Cyc_CfFlowInfo_initlevel(env->fenv,_tmp352,_tmp350)== Cyc_CfFlowInfo_NoneIL){
const char*_tmp807;void*_tmp806;(_tmp806=0,Cyc_CfFlowInfo_aerr(_tmp17E->loc,((_tmp807="expression may not be initialized",_tag_dyneither(_tmp807,sizeof(char),34))),_tag_dyneither(_tmp806,sizeof(void*),0)));}{
# 1646
...
struct _tuple16 _tmp808;return(_tmp808.f1=_tmp34F,((_tmp808.f2=_tmp160->unknown_all,_tmp808)));}case 2: _LL2B5: _LL2B6:
 goto _LL2B8;case 1: _LL2B7: _LL2B8:
 goto _LL2BA;case 5: _LL2B9: _LL2BA: {
# 1661
struct Cyc_List_List _tmp809;struct Cyc_List_List _tmp359=(_tmp809.hd=_tmp17D,((_tmp809.tl=0,_tmp809)));
...
struct _tuple16 _tmp80A;return(_tmp80A.f1=_tmp35C,((_tmp80A.f2=_tmp160->unknown_all,_tmp80A)));}}else{_LL2C3: _tmp35F=((_tmp35E.ReachableFL).val).f1;_LL2C4:
# 1668
 if(Cyc_CfFlowInfo_initlevel(_tmp160,_tmp35F,_tmp35D)!= Cyc_CfFlowInfo_AllIL){
{const char*_tmp80D;void*_tmp80C;(_tmp80C=0,Cyc_CfFlowInfo_aerr(_tmp17E->loc,((_tmp80D="expression may not be initialized",_tag_dyneither(_tmp80D,sizeof(char),34))),_tag_dyneither(_tmp80C,sizeof(void*),0)));}{
struct _tuple16 _tmp80E;return(_tmp80E.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp80E.f2=_tmp160->unknown_all,_tmp80E)));};}}_LL2C0:;}
# 1673
_tmp34F=_tmp35C;
goto _LL2BC;};}default: _LL2BB: _LL2BC:
# 1676
 while(1){
struct Cyc_List_List _tmp80F;struct Cyc_List_List _tmp365=(_tmp80F.hd=_tmp17D,((_tmp80F.tl=0,_tmp80F)));
...
{const char*_tmp812;void*_tmp811;(_tmp811=0,Cyc_CfFlowInfo_aerr(_tmp17E->loc,((_tmp812="expression may not be initialized",_tag_dyneither(_tmp812,sizeof(char),34))),_tag_dyneither(_tmp811,sizeof(void*),0)));}{
struct _tuple16 _tmp813;return(_tmp813.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp813.f2=_tmp160->unknown_all,_tmp813)));};}}_LL2C8:;}{
# 1688
...
_tmp34F=_tmp36F;};};}{
# 1693
struct _tuple16 _tmp814;return(_tmp814.f1=_tmp34F,((_tmp814.f2=_tmp160->unknown_all,_tmp814)));};}_LL2B2:;};};}_LL2AD:;};}case 27: _LL19F: _tmp17A=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_tmp17B=(void*)((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp178)->f2;_tmp17C=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp178)->f3;_LL1A0: {
# 1699
struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct _tmp817;struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_tmp816;void*root=(void*)((_tmp816=_region_malloc(_tmp160->r,sizeof(*_tmp816)),((_tmp816[0]=((_tmp817.tag=1,((_tmp817.f1=_tmp17A,((_tmp817.f2=(void*)_check_null(e->topt),_tmp817)))))),_tmp816))));
struct Cyc_CfFlowInfo_Place*_tmp818;struct Cyc_CfFlowInfo_Place*place=(_tmp818=_region_malloc(_tmp160->r,sizeof(*_tmp818)),((_tmp818->root=root,((_tmp818->fields=0,_tmp818)))));
struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp81B;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp81A;void*rval=(void*)((_tmp81A=_region_malloc(_tmp160->r,sizeof(*_tmp81A)),((_tmp81A[0]=((_tmp81B.tag=5,((_tmp81B.f1=place,_tmp81B)))),_tmp81A))));
void*place_val;
# 1707
...
struct _tuple16 _tmp81C;return(_tmp81C.f1=outflow,((_tmp81C.f2=rval,_tmp81C)));}}else{_LL2D3: _tmp376=((_tmp375.ReachableFL).val).f1;_tmp377=((_tmp375.ReachableFL).val).f2;_LL2D4: {
# 1715
struct _tuple16 _tmp81D;return(_tmp81D.f1=Cyc_CfFlowInfo_ReachableFL(((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp376,root,place_val),_tmp377),((_tmp81D.f2=rval,_tmp81D)));}}_LL2D0:;};};};}case 36: _LL1A1: _tmp179=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp178)->f1;_LL1A2: {
# 1719
struct _tuple17 _tmp81E;struct _tuple17 _tmp37F=(_tmp81E.f1=(env->fenv)->unknown_all,((_tmp81E.f2=copy_ctxt,_tmp81E)));
union Cyc_CfFlowInfo_FlowInfo _tmp380=Cyc_NewControlFlow_anal_stmt(env,inflow,_tmp179,& _tmp37F);
struct _tuple16 _tmp81F;return(_tmp81F.f1=_tmp380,((_tmp81F.f2=_tmp37F.f1,_tmp81F)));}case 35: _LL1A5: _LL1A6:
# 1724
 goto _LL1A8;case 24: _LL1A7: _LL1A8:
 goto _LL1AA;case 38: _LL1A9: _LL1AA:
 goto _LL1AC;default: _LL1AB: _LL1AC: {
# 1728
struct Cyc_Core_Impossible_exn_struct _tmp825;const char*_tmp824;struct Cyc_Core_Impossible_exn_struct*_tmp823;(int)_throw((void*)((_tmp823=_cycalloc(sizeof(*_tmp823)),((_tmp823[0]=((_tmp825.tag=Cyc_Core_Impossible,((_tmp825.f1=((_tmp824="anal_Rexp, unexpected exp form",_tag_dyneither(_tmp824,sizeof(char),31))),_tmp825)))),_tmp823)))));}}_LL144:;};}
# 1738
...
struct _tuple18 _tmp826;return(_tmp826.f1=f,((_tmp826.f2=Cyc_CfFlowInfo_UnknownL(),_tmp826)));}}else{_LL2DD: _tmp38D=((_tmp38C.ReachableFL).val).f1;_tmp38E=((_tmp38C.ReachableFL).val).f2;_LL2DE:
# 1754
...
# 1758
struct Cyc_Core_Impossible_exn_struct _tmp82C;const char*_tmp82B;struct Cyc_Core_Impossible_exn_struct*_tmp82A;(int)_throw((void*)((_tmp82A=_cycalloc(sizeof(*_tmp82A)),((_tmp82A[0]=((_tmp82C.tag=Cyc_Core_Impossible,((_tmp82C.f1=((_tmp82B="named location in anal_derefL",_tag_dyneither(_tmp82B,sizeof(char),30))),_tmp82C)))),_tmp82A)))));}case 1: _LL2E5: _LL2E6:
 goto _LL2E8;case 2: _LL2E7: _LL2E8:
# 1761
{struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct _tmp82F;struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp82E;e->annot=(void*)((_tmp82E=_cycalloc(sizeof(*_tmp82E)),((_tmp82E[0]=((_tmp82F.tag=Cyc_CfFlowInfo_NotZero,((_tmp82F.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmp38E),_tmp82F)))),_tmp82E))));}goto _LL2E2;case 5: _LL2E9: _tmp396=(((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp394)->f1)->root;_tmp397=(((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp394)->f1)->fields;_LL2EA:
# 1764
 if(expanded_place){
# 1767
struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp832;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp831;e->annot=(void*)((_tmp831=_cycalloc(sizeof(*_tmp831)),((_tmp831[0]=((_tmp832.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp832.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmp38E),_tmp832)))),_tmp831))));}else{
# 1770
...
# 1774
{struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp835;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp834;e->annot=(void*)((_tmp834=_cycalloc(sizeof(*_tmp834)),((_tmp834[0]=((_tmp835.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp835.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmp38E),_tmp835)))),_tmp834))));}
goto _LL2F1;}else{_LL2F4: _LL2F5:
# 1777
{struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct _tmp838;struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp837;e->annot=(void*)((_tmp837=_cycalloc(sizeof(*_tmp837)),((_tmp837[0]=((_tmp838.tag=Cyc_CfFlowInfo_NotZero,((_tmp838.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmp38E),_tmp838)))),_tmp837))));}
goto _LL2F1;}_LL2F1:;}{
# 1781
struct Cyc_CfFlowInfo_Place*_tmp83B;struct _tuple18 _tmp83A;return(_tmp83A.f1=f,((_tmp83A.f2=Cyc_CfFlowInfo_PlaceL(((_tmp83B=_region_malloc(_tmp386->r,sizeof(*_tmp83B)),((_tmp83B->root=_tmp396,((_tmp83B->fields=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rappend)(_tmp386->r,_tmp397,flds),_tmp83B))))))),_tmp83A)));};case 0: _LL2EB: _LL2EC:
# 1783
 e->annot=(void*)& Cyc_CfFlowInfo_IsZero_val;{
struct _tuple18 _tmp83C;return(_tmp83C.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp83C.f2=Cyc_CfFlowInfo_UnknownL(),_tmp83C)));};case 3: _LL2ED: _tmp395=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp394)->f1;_LL2EE:
...
void*_tmp3A8=_tmp392;void*_tmp3A9;if(((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp3A8)->tag == 7){_LL2F7: _tmp3A9=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp3A8)->f3;_LL2F8:
 ...
 goto _LL2F6;}_LL2F6:;}{
# 1794
struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp83F;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp83E;e->annot=(void*)((_tmp83E=_cycalloc(sizeof(*_tmp83E)),((_tmp83E[0]=((_tmp83F.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp83F.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmp38E),_tmp83F)))),_tmp83E))));};}_LL2E2:;}}else{
# 1798
struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp842;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp841;e->annot=(void*)((_tmp841=_cycalloc(sizeof(*_tmp841)),((_tmp841[0]=((_tmp842.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp842.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmp38E),_tmp842)))),_tmp841))));}
...
# 1803
{const char*_tmp845;void*_tmp844;(_tmp844=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp845="attempt to dereference an alias-free that has already been copied",_tag_dyneither(_tmp845,sizeof(char),66))),_tag_dyneither(_tmp844,sizeof(void*),0)));}
goto _LL2FE;}else{_LL301: _LL302:
# 1806
{const char*_tmp848;void*_tmp847;(_tmp847=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp848="dereference of possibly uninitialized pointer",_tag_dyneither(_tmp848,sizeof(char),46))),_tag_dyneither(_tmp847,sizeof(void*),0)));}
goto _LL2FE;}_LL2FE:;};}{
# 1810
struct _tuple18 _tmp849;return(_tmp849.f1=f,((_tmp849.f2=Cyc_CfFlowInfo_UnknownL(),_tmp849)));};}_LL2DA:;}}else{_LL2D8: _LL2D9: {
# 1812
struct Cyc_Core_Impossible_exn_struct _tmp84F;const char*_tmp84E;struct Cyc_Core_Impossible_exn_struct*_tmp84D;(int)_throw((void*)((_tmp84D=_cycalloc(sizeof(*_tmp84D)),((_tmp84D[0]=((_tmp84F.tag=Cyc_Core_Impossible,((_tmp84F.f1=((_tmp84E="left deref of non-pointer-type",_tag_dyneither(_tmp84E,sizeof(char),31))),_tmp84F)))),_tmp84D)))));}}_LL2D5:;}
# 1820
...
struct _tuple18 _tmp850;return(_tmp850.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp850.f2=Cyc_CfFlowInfo_UnknownL(),_tmp850)));}}else{_LL306: _tmp3BC=((_tmp3BB.ReachableFL).val).f1;_tmp3BD=((_tmp3BB.ReachableFL).val).f2;_LL307:
# 1828
 d=_tmp3BC;}_LL303:;}{
# 1832
...
# 1840
struct Cyc_CfFlowInfo_Place*_tmp85A;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp859;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp858;struct _tuple18 _tmp857;return(_tmp857.f1=inflow,((_tmp857.f2=Cyc_CfFlowInfo_PlaceL(((_tmp85A=_region_malloc(env->r,sizeof(*_tmp85A)),((_tmp85A->root=(void*)((_tmp858=_region_malloc(env->r,sizeof(*_tmp858)),((_tmp858[0]=((_tmp859.tag=0,((_tmp859.f1=_tmp3C9,_tmp859)))),_tmp858)))),((_tmp85A->fields=flds,_tmp85A))))))),_tmp857)));}case 1: _LL315: _tmp3C8=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp3C0)->f2)->f1;_LL316: {
# 1842
struct _tuple18 _tmp85B;return(_tmp85B.f1=inflow,((_tmp85B.f2=Cyc_CfFlowInfo_UnknownL(),_tmp85B)));}default: goto _LL31F;}case 21: _LL317: _tmp3C6=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp3C0)->f1;_tmp3C7=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp3C0)->f2;_LL318:
# 1845
...
# 1863
struct _tuple18 _tmp863;struct _tuple18 _tmp3DF=(_tmp863.f1=_tmp3DD,((_tmp863.f2=_tmp3DE,_tmp863)));struct _tuple18 _tmp3E0=_tmp3DF;struct Cyc_Dict_Dict _tmp3E1;struct Cyc_List_List*_tmp3E2;struct Cyc_CfFlowInfo_Place*_tmp3E3;if(((_tmp3E0.f1).ReachableFL).tag == 2){if(((_tmp3E0.f2).PlaceL).tag == 1){_LL32A: _tmp3E1=(((_tmp3E0.f1).ReachableFL).val).f1;_tmp3E2=(((_tmp3E0.f1).ReachableFL).val).f2;_tmp3E3=((_tmp3E0.f2).PlaceL).val;_LL32B: {
# 1865
...
# 1869
struct Cyc_Core_Impossible_exn_struct _tmp869;const char*_tmp868;struct Cyc_Core_Impossible_exn_struct*_tmp867;(int)_throw((void*)((_tmp867=_cycalloc(sizeof(*_tmp867)),((_tmp867[0]=((_tmp869.tag=Cyc_Core_Impossible,((_tmp869.f1=((_tmp868="bad named location in anal_Lexp:deref",_tag_dyneither(_tmp868,sizeof(char),38))),_tmp869)))),_tmp867)))));}case 7: if(((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp3E9)->f3)->tag == 5){_LL334: _LL335:
...
struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct _tmp86C;struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_tmp86B;void*new_root=(void*)((_tmp86B=_region_malloc(_tmp3BA->r,sizeof(*_tmp86B)),((_tmp86B[0]=((_tmp86C.tag=1,((_tmp86C.f1=e,((_tmp86C.f2=(void*)_check_null(e->topt),_tmp86C)))))),_tmp86B))));
struct Cyc_CfFlowInfo_Place*_tmp86D;struct Cyc_CfFlowInfo_Place*place=(_tmp86D=_region_malloc(_tmp3BA->r,sizeof(*_tmp86D)),((_tmp86D->root=new_root,((_tmp86D->fields=0,_tmp86D)))));
struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp870;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp86F;void*res=(void*)((_tmp86F=_region_malloc(_tmp3BA->r,sizeof(*_tmp86F)),((_tmp86F[0]=((_tmp870.tag=5,((_tmp870.f1=place,_tmp870)))),_tmp86F))));
for(0;_tmp3E8 != 0;_tmp3E8=_tmp3E8->tl){
struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp873;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp872;res=(void*)((_tmp872=_region_malloc(_tmp3BA->r,sizeof(*_tmp872)),((_tmp872[0]=((_tmp873.tag=8,((_tmp873.f1=(struct Cyc_Absyn_Vardecl*)_tmp3E8->hd,((_tmp873.f2=res,_tmp873)))))),_tmp872))));}
((int(*)(struct Cyc_Dict_Dict*set,struct Cyc_CfFlowInfo_Place*place,unsigned int loc))Cyc_CfFlowInfo_update_place_set)(env->all_changed,place,0);
...
struct Cyc_List_List*_tmp874;return Cyc_NewControlFlow_anal_Lexp_rec(env,inflow,expand_unique,passthrough_consumes,_tmp3C3,((_tmp874=_region_malloc(env->r,sizeof(*_tmp874)),((_tmp874->hd=(void*)_tmp3FF,((_tmp874->tl=flds,_tmp874)))))));}case 5: _LL340: _tmp3FE=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp3FD)->f1).ptr_atts).bounds;_LL341: {
# 1914
struct _RegionHandle _tmp401=_new_region("temp");struct _RegionHandle*temp=& _tmp401;_push_region(temp);
{struct Cyc_Absyn_Exp*_tmp875[2];struct _tuple23 _tmp402=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,(
(_tmp875[1]=_tmp3C4,((_tmp875[0]=_tmp3C3,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(temp,_tag_dyneither(_tmp875,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,1);
# 1915
struct _tuple23 _tmp403=_tmp402;union Cyc_CfFlowInfo_FlowInfo _tmp404;struct Cyc_List_List*_tmp405;_LL345: _tmp404=_tmp403.f1;_tmp405=_tmp403.f2;_LL346:;{
# 1917
...
const char*_tmp878;void*_tmp877;(_tmp877=0,Cyc_CfFlowInfo_aerr(_tmp3C4->loc,((_tmp878="expression may not be initialized",_tag_dyneither(_tmp878,sizeof(char),34))),_tag_dyneither(_tmp877,sizeof(void*),0)));}{
...
struct _tuple18 _tmp879;struct _tuple18 _tmp413=(_tmp879.f1=_tmp40F,((_tmp879.f2=_tmp410,_tmp879)));_npop_handler(0);return _tmp413;}}else{_LL352: _LL353: {
struct _tuple18 _tmp87A;struct _tuple18 _tmp415=(_tmp87A.f1=_tmp406,((_tmp87A.f2=_tmp410,_tmp87A)));_npop_handler(0);return _tmp415;}}_LL34F:;};};};}
# 1915
;_pop_region(temp);}default: _LL342: _LL343: {
# 1934
struct Cyc_Core_Impossible_exn_struct _tmp880;const char*_tmp87F;struct Cyc_Core_Impossible_exn_struct*_tmp87E;(int)_throw((void*)((_tmp87E=_cycalloc(sizeof(*_tmp87E)),((_tmp87E[0]=((_tmp880.tag=Cyc_Core_Impossible,((_tmp880.f1=((_tmp87F="anal_Lexp: Subscript -- bad type",_tag_dyneither(_tmp87F,sizeof(char),33))),_tmp880)))),_tmp87E)))));}}_LL33D:;}case 20: _LL31D: _tmp3C1=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp3C0)->f1;_tmp3C2=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp3C0)->f2;_LL31E: {
# 1938
...
struct _tuple18 _tmp881;return(_tmp881.f1=inflow,((_tmp881.f2=Cyc_CfFlowInfo_UnknownL(),_tmp881)));}{
# 1945
struct Cyc_List_List*_tmp882;return Cyc_NewControlFlow_anal_Lexp_rec(env,inflow,expand_unique,passthrough_consumes,_tmp3C1,(
(_tmp882=_region_malloc(env->r,sizeof(*_tmp882)),((_tmp882->hd=(void*)Cyc_CfFlowInfo_get_field_index(_tmp41A,_tmp3C2),((_tmp882->tl=flds,_tmp882)))))));};}default: _LL31F: _LL320: {
# 1948
struct _tuple18 _tmp883;return(_tmp883.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp883.f2=Cyc_CfFlowInfo_UnknownL(),_tmp883)));}}_LL308:;};}
# 1952
...
struct _tuple18 _tmp884;return(_tmp884.f1=_tmp420,((_tmp884.f2=_tmp421,_tmp884)));};}
# 1962
static union Cyc_CfFlowInfo_FlowInfo Cyc_NewControlFlow_expand_unique_places(struct Cyc_NewControlFlow_AnalEnv*env,union Cyc_CfFlowInfo_FlowInfo inflow,struct Cyc_List_List*es){
# 1965
{struct Cyc_List_List*x=es;for(0;x != 0;x=x->tl){
...
struct _tuple19 _tmp885;struct _tuple19 _tmp430=(_tmp885.f1=f,((_tmp885.f2=f,_tmp885)));_npop_handler(0);return _tmp430;}}else{_LL360: _tmp42D=((_tmp42C.ReachableFL).val).f1;_tmp42E=((_tmp42C.ReachableFL).val).f2;_LL361: {
# 1998
...
const char*_tmp888;void*_tmp887;(_tmp887=0,Cyc_CfFlowInfo_aerr(((struct Cyc_Absyn_Exp*)es->hd)->loc,((_tmp888="expression may not be initialized",_tag_dyneither(_tmp888,sizeof(char),34))),_tag_dyneither(_tmp887,sizeof(void*),0)));}
if(Cyc_CfFlowInfo_initlevel(env->fenv,_tmp42D,r2)== Cyc_CfFlowInfo_NoneIL){
const char*_tmp88B;void*_tmp88A;(_tmp88A=0,Cyc_CfFlowInfo_aerr(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es->tl))->hd)->loc,((_tmp88B="expression may not be initialized",_tag_dyneither(_tmp88B,sizeof(char),34))),_tag_dyneither(_tmp88A,sizeof(void*),0)));}{
# 2005
...
struct _tuple0 _tmp88C;struct _tuple0 _tmp441=(_tmp88C.f1=_tmp43B,((_tmp88C.f2=_tmp43F,_tmp88C)));struct _tuple0 _tmp442=_tmp441;enum Cyc_CfFlowInfo_InitLevel _tmp443;enum Cyc_CfFlowInfo_InitLevel _tmp444;switch(*((int*)_tmp442.f1)){case 3: if(((struct Cyc_CfFlowInfo_Zero_CfFlowInfo_AbsRVal_struct*)_tmp442.f2)->tag == 0){_LL369: _tmp444=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp442.f1)->f1;_LL36A: {
# 2017
...
goto _LL368;}else{goto _LL37B;}default: _LL37B: _LL37C:
 goto _LL368;}_LL368:;};};}
# 2053
{struct _tuple0 _tmp899;struct _tuple0 _tmp456=(_tmp899.f1=Cyc_Tcutil_compress((void*)_check_null(_tmp431->topt)),((_tmp899.f2=Cyc_Tcutil_compress((void*)_check_null(_tmp432->topt)),_tmp899)));struct _tuple0 _tmp457=_tmp456;if(((struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp457.f1)->tag == 6){if(((struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp457.f1)->f1 == Cyc_Absyn_Unsigned){_LL392: _LL393:
...
struct _tuple19 _tmp89A;struct _tuple19 _tmp459=(_tmp89A.f1=_tmp437,((_tmp89A.f2=_tmp438,_tmp89A)));_npop_handler(0);return _tmp459;}}}}}_LL391:;}
# 2062
...
struct _tuple19 _tmp89B;struct _tuple19 _tmp45D=(_tmp89B.f1=_tmp437,((_tmp89B.f2=_tmp438,_tmp89B)));_npop_handler(0);return _tmp45D;}}_LL39C:;}{
# 2067
...
struct _tuple19 _tmp89C;struct _tuple19 _tmp466=(_tmp89C.f1=_tmp437,((_tmp89C.f2=_tmp438,_tmp89C)));struct _tuple19 _tmp467=_tmp466;struct Cyc_Dict_Dict _tmp468;struct Cyc_Dict_Dict _tmp469;struct Cyc_Dict_Dict _tmp46A;struct Cyc_Dict_Dict _tmp46B;if(((_tmp467.f1).ReachableFL).tag == 2){if(((_tmp467.f2).ReachableFL).tag == 2){_LL3AF: _tmp46A=(((_tmp467.f1).ReachableFL).val).f1;_tmp46B=(((_tmp467.f2).ReachableFL).val).f1;_LL3B0: {
# 2081
struct _tuple19 _tmp89D;struct _tuple19 _tmp46D=(_tmp89D.f1=Cyc_CfFlowInfo_ReachableFL(_tmp46A,_tmp464),((_tmp89D.f2=Cyc_CfFlowInfo_ReachableFL(_tmp46B,_tmp465),_tmp89D)));_npop_handler(0);return _tmp46D;}}else{_LL3B3: _tmp469=(((_tmp467.f1).ReachableFL).val).f1;_LL3B4: {
# 2085
struct _tuple19 _tmp89E;struct _tuple19 _tmp471=(_tmp89E.f1=Cyc_CfFlowInfo_ReachableFL(_tmp469,_tmp464),((_tmp89E.f2=_tmp438,_tmp89E)));_npop_handler(0);return _tmp471;}}}else{if(((_tmp467.f2).ReachableFL).tag == 2){_LL3B1: _tmp468=(((_tmp467.f2).ReachableFL).val).f1;_LL3B2: {
# 2083
struct _tuple19 _tmp89F;struct _tuple19 _tmp46F=(_tmp89F.f1=_tmp437,((_tmp89F.f2=Cyc_CfFlowInfo_ReachableFL(_tmp468,_tmp465),_tmp89F)));_npop_handler(0);return _tmp46F;}}else{_LL3B5: _LL3B6: {
# 2087
struct _tuple19 _tmp8A0;struct _tuple19 _tmp473=(_tmp8A0.f1=_tmp437,((_tmp8A0.f2=_tmp438,_tmp8A0)));_npop_handler(0);return _tmp473;}}}_LL3AE:;}else{
# 2090
struct _tuple19 _tmp8A1;struct _tuple19 _tmp476=(_tmp8A1.f1=_tmp437,((_tmp8A1.f2=_tmp438,_tmp8A1)));_npop_handler(0);return _tmp476;}};};};}}_LL35D:;};
# 1987
;_pop_region(temp);}
# 2096
...
struct _tuple19 _tmp8A2;return(_tmp8A2.f1=Cyc_CfFlowInfo_join_flow(_tmp477,env->all_changed,_tmp48C,_tmp490),((_tmp8A2.f2=
Cyc_CfFlowInfo_join_flow(_tmp477,env->all_changed,_tmp48D,_tmp491),_tmp8A2)));};};};}case 6: _LL3BA: _tmp481=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp479)->f1;_tmp482=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp479)->f2;_LL3BB: {
# 2107
...
struct _tuple19 _tmp8A3;return(_tmp8A3.f1=_tmp499,((_tmp8A3.f2=Cyc_CfFlowInfo_join_flow(_tmp477,env->all_changed,_tmp496,_tmp49A),_tmp8A3)));};};}case 7: _LL3BC: _tmp47F=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp479)->f1;_tmp480=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp479)->f2;_LL3BD: {
# 2111
...
struct _tuple19 _tmp8A4;return(_tmp8A4.f1=Cyc_CfFlowInfo_join_flow(_tmp477,env->all_changed,_tmp49E,_tmp4A2),((_tmp8A4.f2=_tmp4A3,_tmp8A4)));};};}case 8: _LL3BE: _tmp47D=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp479)->f1;_tmp47E=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp479)->f2;_LL3BF: {
# 2115
...
struct _tuple19 _tmp8A5;return(_tmp8A5.f1=_tmp4AC,((_tmp8A5.f2=_tmp4AB,_tmp8A5)));};}}else{goto _LL3C2;}}else{goto _LL3C2;}}else{_LL3C2: _tmp47A=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp479)->f1;_tmp47B=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp479)->f2;_LL3C3:
# 2121
...
struct _tuple19 _tmp8A6;return(_tmp8A6.f1=_tmp4B0,((_tmp8A6.f2=_tmp4B0,_tmp8A6)));}}else{_LL3E7: _tmp4B3=((_tmp4B2.ReachableFL).val).f1;_LL3E8: {
# 2129
...
# 2132
struct Cyc_Core_Impossible_exn_struct _tmp8AC;const char*_tmp8AB;struct Cyc_Core_Impossible_exn_struct*_tmp8AA;(int)_throw((void*)((_tmp8AA=_cycalloc(sizeof(*_tmp8AA)),((_tmp8AA[0]=((_tmp8AC.tag=Cyc_Core_Impossible,((_tmp8AC.f1=((_tmp8AB="anal_test: bad namedlocation",_tag_dyneither(_tmp8AB,sizeof(char),29))),_tmp8AC)))),_tmp8AA)))));}case 0: _LL3EF: _LL3F0: {
struct _tuple19 _tmp8AD;return(_tmp8AD.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp8AD.f2=_tmp4B0,_tmp8AD)));}case 2: _LL3F1: _LL3F2:
 goto _LL3F4;case 1: _LL3F3: _LL3F4:
 goto _LL3F6;case 5: _LL3F5: _LL3F6: {
struct _tuple19 _tmp8AE;return(_tmp8AE.f1=_tmp4B0,((_tmp8AE.f2=Cyc_CfFlowInfo_BottomFL(),_tmp8AE)));}case 3: if(((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp4B9)->f1 == Cyc_CfFlowInfo_NoneIL){_LL3F7: _LL3F8:
...
# 2143
struct _tuple19 _tmp8AF;return(_tmp8AF.f1=_tmp4B0,((_tmp8AF.f2=_tmp4B0,_tmp8AF)));}}case 7: _LL3FB: _LL3FC:
# 2140
{const char*_tmp8B2;void*_tmp8B1;(_tmp8B1=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp8B2="expression may not be initialized",_tag_dyneither(_tmp8B2,sizeof(char),34))),_tag_dyneither(_tmp8B1,sizeof(void*),0)));}{
struct _tuple19 _tmp8B3;return(_tmp8B3.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp8B3.f2=Cyc_CfFlowInfo_BottomFL(),_tmp8B3)));};default: _LL401: _LL402: {
# 2144
struct Cyc_Core_Impossible_exn_struct _tmp8B9;const char*_tmp8B8;struct Cyc_Core_Impossible_exn_struct*_tmp8B7;(int)_throw((void*)((_tmp8B7=_cycalloc(sizeof(*_tmp8B7)),((_tmp8B7[0]=((_tmp8B9.tag=Cyc_Core_Impossible,((_tmp8B9.f1=((_tmp8B8="anal_test",_tag_dyneither(_tmp8B8,sizeof(char),10))),_tmp8B9)))),_tmp8B7)))));}}_LL3EC:;};}}_LL3E4:;};}}_LL3B7:;}struct _tuple27{unsigned int f1;struct Cyc_NewControlFlow_AnalEnv*f2;struct Cyc_Dict_Dict f3;};
# 2150
...
# 2162
{const char*_tmp8BD;void*_tmp8BC[1];struct Cyc_String_pa_PrintArg_struct _tmp8BB;(_tmp8BB.tag=0,((_tmp8BB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp4CE->name)),((_tmp8BC[0]=& _tmp8BB,Cyc_Tcutil_warn(_tmp4CA,((_tmp8BD="unique pointers reachable from %s may become unreachable",_tag_dyneither(_tmp8BD,sizeof(char),57))),_tag_dyneither(_tmp8BC,sizeof(void*),1)))))));}
goto _LL40E;}_LL40E:;};}
# 2166
...
const char*_tmp8C0;void*_tmp8BF;(_tmp8BF=0,Cyc_CfFlowInfo_aerr(loc,((_tmp8C0="function may not initialize all the parameters with attribute 'initializes'",_tag_dyneither(_tmp8C0,sizeof(char),76))),_tag_dyneither(_tmp8BF,sizeof(void*),0)));}}}
# 2179
if(Cyc_NewControlFlow_warn_lose_unique){
struct _tuple27 _tmp8C1;struct _tuple27 _tmp4DB=(_tmp8C1.f1=loc,((_tmp8C1.f2=env,((_tmp8C1.f3=_tmp4D7,_tmp8C1)))));
...
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp8C4;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp8C3;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp4E3=(_tmp8C3=_region_malloc(frgn,sizeof(*_tmp8C3)),((_tmp8C3[0]=((_tmp8C4.tag=0,((_tmp8C4.f1=*_tmp4E1,_tmp8C4)))),_tmp8C3)));
struct Cyc_CfFlowInfo_Place*_tmp8C5;struct Cyc_CfFlowInfo_Place*_tmp4E4=(_tmp8C5=_region_malloc(frgn,sizeof(*_tmp8C5)),((_tmp8C5->root=(void*)_tmp4E3,((_tmp8C5->fields=0,_tmp8C5)))));
{struct Cyc_List_List*_tmp8C6;_tmp4DD=((_tmp8C6=_region_malloc(frgn,sizeof(*_tmp8C6)),((_tmp8C6->hd=_tmp4E4,((_tmp8C6->tl=_tmp4DD,_tmp8C6))))));}{
struct Cyc_List_List*_tmp8C7;_tmp4DE=((_tmp8C7=_region_malloc(frgn,sizeof(*_tmp8C7)),((_tmp8C7->hd=_tmp4E2,((_tmp8C7->tl=_tmp4DE,_tmp8C7))))));};}}}{
# 2207
struct _tuple1 _tmp8C8;return(_tmp8C8.f1=_tmp4DD,((_tmp8C8.f2=_tmp4DE,_tmp8C8)));};}struct _tuple28{int f1;void*f2;};
# 2213
...
# 2222
const char*_tmp8CB;void*_tmp8CA;(_tmp8CA=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp8CB="noconsume_place_ok: flow became Bottom!",_tag_dyneither(_tmp8CB,sizeof(char),40))),_tag_dyneither(_tmp8CA,sizeof(void*),0)));}}else{_LL422: _tmp4EC=((_tmp4EB.ReachableFL).val).f1;_LL423: {
# 2229
...
if(!do_unconsume){
const char*_tmp8CF;void*_tmp8CE[1];struct Cyc_String_pa_PrintArg_struct _tmp8CD;(_tmp8CD.tag=0,((_tmp8CD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 2253
Cyc_Absynpp_qvar2string(vd->name)),((_tmp8CE[0]=& _tmp8CD,Cyc_CfFlowInfo_aerr(loc,((_tmp8CF="function consumes parameter %s with attribute 'noconsume'",_tag_dyneither(_tmp8CF,sizeof(char),58))),_tag_dyneither(_tmp8CE,sizeof(void*),1)))))));}}else{
# 2256
if(Cyc_CfFlowInfo_initlevel(env->fenv,_tmp4EC,_tmp4F3)!= Cyc_CfFlowInfo_AllIL  && !do_unconsume){
const char*_tmp8D3;void*_tmp8D2[1];struct Cyc_String_pa_PrintArg_struct _tmp8D1;(_tmp8D1.tag=0,((_tmp8D1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 2259
Cyc_Absynpp_qvar2string(vd->name)),((_tmp8D2[0]=& _tmp8D1,Cyc_CfFlowInfo_aerr(loc,((_tmp8D3="function consumes value pointed to by parameter %s, which has attribute 'noconsume'",_tag_dyneither(_tmp8D3,sizeof(char),84))),_tag_dyneither(_tmp8D2,sizeof(void*),1)))))));}else{
# 2261
varok=1;}}}else{
# 2264
varok=1;}}else{
...
varok=1;else{
if(!do_unconsume){
const char*_tmp8D7;void*_tmp8D6[1];struct Cyc_String_pa_PrintArg_struct _tmp8D5;(_tmp8D5.tag=0,((_tmp8D5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 2276
Cyc_Absynpp_qvar2string(vd->name)),((_tmp8D6[0]=& _tmp8D5,Cyc_CfFlowInfo_aerr(loc,((_tmp8D7="function parameter %s with attribute 'noconsume' no longer set to its original value",_tag_dyneither(_tmp8D7,sizeof(char),85))),_tag_dyneither(_tmp8D6,sizeof(void*),1)))))));}}
goto _LL424;}_LL424:;}{
# 2280
struct _tuple28 _tmp8D8;return(_tmp8D8.f1=varok,((_tmp8D8.f2=_tmp4F3,_tmp8D8)));};}}_LL41F:;}
# 2286
...
if(_tmp503 != 0){
const char*_tmp8DB;void*_tmp8DA;(_tmp8DA=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp8DB="unconsume_params: param to unconsume is non-variable",_tag_dyneither(_tmp8DB,sizeof(char),53))),_tag_dyneither(_tmp8DA,sizeof(void*),0)));}{
...
const char*_tmp8DE;void*_tmp8DD;(_tmp8DD=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp8DE="unconsume_params: root is not a varroot",_tag_dyneither(_tmp8DE,sizeof(char),40))),_tag_dyneither(_tmp8DD,sizeof(void*),0)));}}_LL42C:;};}
...
if(ropt != 0){
# 2350
struct _tuple16 _tmp8E0;struct _tuple16 _tmp8DF;struct _tuple16 _tmp516=
Cyc_CfFlowInfo_join_flow_and_rval(env->fenv,env->all_changed,(
# 2353
(_tmp8DF.f1=_tmp50E,((_tmp8DF.f2=_tmp512,_tmp8DF)))),(
(_tmp8E0.f1=_tmp50E,((_tmp8E0.f2=ropt,_tmp8E0)))));
# 2350
...
# 2373
const char*_tmp8E3;void*_tmp8E2;(_tmp8E2=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp8E3="unconsume_params: joined flow became bot!",_tag_dyneither(_tmp8E3,sizeof(char),42))),_tag_dyneither(_tmp8E2,sizeof(void*),0)));}}_LL446:;}
# 2375
goto _LL43E;}else{
# 2377
goto _LL442;}
...
const char*_tmp8E7;void*_tmp8E6[1];struct Cyc_String_pa_PrintArg_struct _tmp8E5;(_tmp8E5.tag=0,((_tmp8E5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_exp2string(unconsume_exp)),((_tmp8E6[0]=& _tmp8E5,Cyc_CfFlowInfo_aerr(loc,((_tmp8E7="aliased expression %s was overwritten",_tag_dyneither(_tmp8E7,sizeof(char),38))),_tag_dyneither(_tmp8E6,sizeof(void*),1)))))));}
...
struct _tuple28 _tmp8E8;struct _tuple28 _tmp528=
is_region_open?(_tmp8E8.f1=1,((_tmp8E8.f2=0,_tmp8E8))):
...
{struct _tuple29*_tmp8EB;struct Cyc_List_List*_tmp8EA;env->unique_pat_vars=(
(_tmp8EA=_region_malloc(env->r,sizeof(*_tmp8EA)),((_tmp8EA->hd=((_tmp8EB=_region_malloc(env->r,sizeof(*_tmp8EB)),((_tmp8EB->f1=0,((_tmp8EB->f2=_tmp532,((_tmp8EB->f3=_tmp536,((_tmp8EB->f4=_tmp537,_tmp8EB)))))))))),((_tmp8EA->tl=_tmp538,_tmp8EA))))));}
# 2473
if(_tmp531 != 0){
...
const char*_tmp8EE;void*_tmp8ED;(_tmp8ED=0,Cyc_CfFlowInfo_aerr(_tmp532->loc,((_tmp8EE="switch clause may implicitly fallthru",_tag_dyneither(_tmp8EE,sizeof(char),38))),_tag_dyneither(_tmp8ED,sizeof(void*),0)));}else{
# 2496
const char*_tmp8F1;void*_tmp8F0;(_tmp8F0=0,Cyc_Tcutil_warn(_tmp532->loc,((_tmp8F1="switch clause may implicitly fallthru",_tag_dyneither(_tmp8F1,sizeof(char),38))),_tag_dyneither(_tmp8F0,sizeof(void*),0)));}
# 2498
...
# 2513
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp8F2;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct vdroot=(_tmp8F2.tag=0,((_tmp8F2.f1=vd,_tmp8F2)));
# 2515
...
# 2522
{const char*_tmp8F6;void*_tmp8F5[1];struct Cyc_String_pa_PrintArg_struct _tmp8F4;(_tmp8F4.tag=0,((_tmp8F4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name)),((_tmp8F5[0]=& _tmp8F4,Cyc_Tcutil_warn(_tmp547,((_tmp8F6="unique pointers may still exist after variable %s goes out of scope",_tag_dyneither(_tmp8F6,sizeof(char),68))),_tag_dyneither(_tmp8F5,sizeof(void*),1)))))));}
# 2524
goto _LL467;}_LL467:;};}}
# 2529
...
# 2533
struct _tuple30 _tmp8F7;struct _tuple30 _tmp552=(_tmp8F7.f1=env,((_tmp8F7.f2=_tmp551,((_tmp8F7.f3=decl->loc,_tmp8F7)))));
...
# 2625
{const char*_tmp8FA;void*_tmp8F9;(_tmp8F9=0,Cyc_Tcutil_warn(s->loc,((_tmp8FA="break may cause function not to return a value",_tag_dyneither(_tmp8FA,sizeof(char),47))),_tag_dyneither(_tmp8F9,sizeof(void*),0)));}
goto _LL4B9;default: _LL4C0: _LL4C1:
# 2628
{const char*_tmp8FD;void*_tmp8FC;(_tmp8FC=0,Cyc_Tcutil_terr(s->loc,((_tmp8FD="break may cause function not to return a value",_tag_dyneither(_tmp8FD,sizeof(char),47))),_tag_dyneither(_tmp8FC,sizeof(void*),0)));}
goto _LL4B9;}_LL4B9:;}
# 2631
...
# 2636
 if(env->noreturn){
const char*_tmp900;void*_tmp8FF;(_tmp8FF=0,Cyc_CfFlowInfo_aerr(s->loc,((_tmp900="`noreturn' function might return",_tag_dyneither(_tmp900,sizeof(char),33))),_tag_dyneither(_tmp8FF,sizeof(void*),0)));}
...
# 2642
 if(env->noreturn){
const char*_tmp903;void*_tmp902;(_tmp902=0,Cyc_CfFlowInfo_aerr(s->loc,((_tmp903="`noreturn' function might return",_tag_dyneither(_tmp903,sizeof(char),33))),_tag_dyneither(_tmp902,sizeof(void*),0)));}{
...
# 2888
struct Cyc_Core_Impossible_exn_struct _tmp909;const char*_tmp908;struct Cyc_Core_Impossible_exn_struct*_tmp907;(int)_throw((void*)((_tmp907=_cycalloc(sizeof(*_tmp907)),((_tmp907[0]=((_tmp909.tag=Cyc_Core_Impossible,((_tmp909.f1=((_tmp908="anal_stmt -- bad stmt syntax or unimplemented stmt form",_tag_dyneither(_tmp908,sizeof(char),56))),_tmp909)))),_tmp907)))));}}case 7: _LL4A0: _tmp580=((struct Cyc_Absyn_Continue_s_Absyn_Raw_stmt_struct*)_tmp56C)->f1;_LL4A1:
# 2730
...
if(_tmp5E1 == _tmp5DF){
{const char*_tmp90C;void*_tmp90B;(_tmp90B=0,Cyc_CfFlowInfo_aerr(s->loc,((_tmp90C="goto enters local scope or exception handler",_tag_dyneither(_tmp90C,sizeof(char),45))),_tag_dyneither(_tmp90B,sizeof(void*),0)));}
break;}
# 2743
_tmp5DF=_tmp5E1;}}
# 2747
...
const char*_tmp90F;void*_tmp90E;(_tmp90E=0,Cyc_CfFlowInfo_aerr(s->loc,((_tmp90F="last catch clause may implicitly fallthru",_tag_dyneither(_tmp90F,sizeof(char),42))),_tag_dyneither(_tmp90E,sizeof(void*),0)));}}_LL4EB:;}
# 2777
outflow=s1_outflow;
# 2779
...
{struct _tuple29*_tmp912;struct Cyc_List_List*_tmp911;env->unique_pat_vars=(
(_tmp911=_region_malloc(env->r,sizeof(*_tmp911)),((_tmp911->hd=((_tmp912=_region_malloc(env->r,sizeof(*_tmp912)),((_tmp912->f1=0,((_tmp912->f2=s,((_tmp912->f3=_tmp5E9,((_tmp912->f4=_tmp5EA,_tmp912)))))))))),((_tmp911->tl=_tmp5EB,_tmp911))))));}
# 2797
...
# 2817
struct Cyc_List_List _tmp913;struct Cyc_List_List l=(_tmp913.hd=_tmp572,((_tmp913.tl=0,_tmp913)));
...
{struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp916;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp915;_tmp5FC=(void*)((_tmp915=_region_malloc(_tmp56A->r,sizeof(*_tmp915)),((_tmp915[0]=((_tmp916.tag=8,((_tmp916.f1=_tmp571,((_tmp916.f2=_tmp5FC,_tmp916)))))),_tmp915))));}
...
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp919;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp918;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp5FF=(_tmp918=_region_malloc(_tmp56A->r,sizeof(*_tmp918)),((_tmp918[0]=((_tmp919.tag=0,((_tmp919.f1=_tmp571,_tmp919)))),_tmp918)));
struct Cyc_CfFlowInfo_Place*_tmp91A;struct Cyc_CfFlowInfo_Place*_tmp600=(_tmp91A=_region_malloc(_tmp56A->r,sizeof(*_tmp91A)),((_tmp91A->root=(void*)_tmp5FF,((_tmp91A->fields=0,_tmp91A)))));
{struct Cyc_List_List*_tmp91B;_tmp5F5=((_tmp91B=_region_malloc(_tmp56A->r,sizeof(*_tmp91B)),((_tmp91B->hd=_tmp600,((_tmp91B->tl=_tmp5F5,_tmp91B))))));}
{struct Cyc_List_List*_tmp91C;_tmp5F6=((_tmp91C=_region_malloc(_tmp56A->r,sizeof(*_tmp91C)),((_tmp91C->hd=_tmp572,((_tmp91C->tl=_tmp5F6,_tmp91C))))));}
...
# 2849
 goto _LL4F9;}_LL4F9:;}{
# 2852
struct Cyc_List_List _tmp91D;struct Cyc_List_List _tmp606=(_tmp91D.hd=_tmp571,((_tmp91D.tl=0,_tmp91D)));
...
{struct _tuple29*_tmp920;struct Cyc_List_List*_tmp91F;env->unique_pat_vars=(
(_tmp91F=_region_malloc(env->r,sizeof(*_tmp91F)),((_tmp91F->hd=((_tmp920=_region_malloc(env->r,sizeof(*_tmp920)),((_tmp920->f1=1,((_tmp920->f2=s,((_tmp920->f3=_tmp5F5,((_tmp920->f4=_tmp5F6,_tmp920)))))))))),((_tmp91F->tl=_tmp607,_tmp91F))))));}
# 2861
...
struct Cyc_Core_Impossible_exn_struct _tmp926;const char*_tmp925;struct Cyc_Core_Impossible_exn_struct*_tmp924;(int)_throw((void*)((_tmp924=_cycalloc(sizeof(*_tmp924)),((_tmp924[0]=((_tmp926.tag=Cyc_Core_Impossible,((_tmp926.f1=((_tmp925="anal_stmt -- reset_region",_tag_dyneither(_tmp925,sizeof(char),26))),_tmp926)))),_tmp924)))));}}_LL506:;};}}_LL487:;};}
# 2893
...
# 2906
struct Cyc_List_List _tmp927;struct Cyc_List_List _tmp624=(_tmp927.hd=_tmp623,((_tmp927.tl=0,_tmp927)));
...
goto _LL519;else{
struct Cyc_Dict_Absent_exn_struct _tmp938;struct Cyc_Dict_Absent_exn_struct*_tmp937;Cyc_Core_rethrow((void*)((_tmp937=_cycalloc_atomic(sizeof(*_tmp937)),((_tmp937[0]=((_tmp938.tag=Cyc_Dict_Absent,_tmp938)),_tmp937)))));}}else{_LL51C: _tmp63A=_tmp639;_LL51D:(int)_rethrow(_tmp63A);}_LL519:;}};}
# 2957
...
union Cyc_CfFlowInfo_FlowInfo _tmp939;struct _tuple14 _tmp642=(_tmp939=inflow,(((_tmp939.ReachableFL).tag != 2?_throw_match(): 1,(_tmp939.ReachableFL).val)));struct _tuple14 _tmp643=_tmp642;struct Cyc_Dict_Dict _tmp644;struct Cyc_List_List*_tmp645;_LL524: _tmp644=_tmp643.f1;_tmp645=_tmp643.f2;_LL525:;{
# 2988
...
const char*_tmp93C;void*_tmp93B;(_tmp93B=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp93C="check_fun: non-function type cached with fndecl_t",_tag_dyneither(_tmp93C,sizeof(char),50))),_tag_dyneither(_tmp93B,sizeof(void*),0)));}}_LL526:;}
# 3004
...
struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct _tmp93F;struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp93E;struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp655=(_tmp93E=_region_malloc(_tmp640,sizeof(*_tmp93E)),((_tmp93E[0]=((_tmp93F.tag=2,((_tmp93F.f1=_tmp652,((_tmp93F.f2=t,_tmp93F)))))),_tmp93E)));
struct Cyc_CfFlowInfo_Place*_tmp940;struct Cyc_CfFlowInfo_Place*_tmp656=(_tmp940=_region_malloc(_tmp640,sizeof(*_tmp940)),((_tmp940->root=(void*)_tmp655,((_tmp940->fields=0,_tmp940)))));
_tmp644=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp644,(void*)_tmp655,_tmp654);
{struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp946;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp945;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp943;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp942;_tmp644=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp644,(void*)((_tmp942=_region_malloc(_tmp640,sizeof(*_tmp942)),((_tmp942[0]=((_tmp943.tag=0,((_tmp943.f1=_tmp653,_tmp943)))),_tmp942)))),(void*)((_tmp945=_region_malloc(_tmp640,sizeof(*_tmp945)),((_tmp945[0]=((_tmp946.tag=5,((_tmp946.f1=_tmp656,_tmp946)))),_tmp945)))));}
...
struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct _tmp949;struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp948;struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp65F=(_tmp948=_region_malloc(_tmp640,sizeof(*_tmp948)),((_tmp948[0]=((_tmp949.tag=2,((_tmp949.f1=_tmp651,((_tmp949.f2=elttype,_tmp949)))))),_tmp948)));
struct Cyc_CfFlowInfo_Place*_tmp94A;struct Cyc_CfFlowInfo_Place*_tmp660=(_tmp94A=_region_malloc(_tmp640,sizeof(*_tmp94A)),((_tmp94A->root=(void*)_tmp65F,((_tmp94A->fields=0,_tmp94A)))));
...
{struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp950;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp94F;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp94D;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp94C;_tmp644=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp644,(void*)((_tmp94C=_region_malloc(_tmp640,sizeof(*_tmp94C)),((_tmp94C[0]=((_tmp94D.tag=0,((_tmp94D.f1=_tmp65E,_tmp94D)))),_tmp94C)))),(void*)((_tmp94F=_region_malloc(_tmp640,sizeof(*_tmp94F)),((_tmp94F[0]=((_tmp950.tag=5,((_tmp950.f1=_tmp660,_tmp950)))),_tmp94F)))));}
{struct Cyc_List_List*_tmp951;param_roots=((_tmp951=_region_malloc(_tmp640,sizeof(*_tmp951)),((_tmp951->hd=_tmp660,((_tmp951->tl=param_roots,_tmp951))))));}
...
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp954;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp953;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp66A=(_tmp953=_region_malloc(_tmp640,sizeof(*_tmp953)),((_tmp953[0]=((_tmp954.tag=0,((_tmp954.f1=_tmp669,_tmp954)))),_tmp953)));
struct Cyc_CfFlowInfo_Place*_tmp955;struct Cyc_CfFlowInfo_Place*_tmp66B=(_tmp955=_region_malloc(_tmp640,sizeof(*_tmp955)),((_tmp955->root=(void*)_tmp66A,((_tmp955->fields=0,_tmp955)))));
struct Cyc_List_List*_tmp956;noconsume_roots=((_tmp956=_region_malloc(_tmp640,sizeof(*_tmp956)),((_tmp956->hd=_tmp66B,((_tmp956->tl=noconsume_roots,_tmp956))))));}
# 3035
...
struct Cyc_NewControlFlow_AnalEnv*_tmp957;struct Cyc_NewControlFlow_AnalEnv*env=(_tmp957=_region_malloc(_tmp640,sizeof(*_tmp957)),((_tmp957->r=_tmp640,((_tmp957->fenv=fenv,((_tmp957->iterate_again=1,((_tmp957->iteration_num=0,((_tmp957->in_try=0,((_tmp957->tryflow=inflow,((_tmp957->all_changed=0,((_tmp957->noreturn=noreturn,((_tmp957->return_type=fd->ret_type,((_tmp957->unique_pat_vars=0,((_tmp957->param_roots=param_roots,((_tmp957->noconsume_params=noconsume_roots,((_tmp957->flow_table=flow_table,((_tmp957->return_relns=fd->ensures_relns,_tmp957)))))))))))))))))))))))))))));
...
# 3060
if(noreturn){
const char*_tmp95A;void*_tmp959;(_tmp959=0,Cyc_CfFlowInfo_aerr(_tmp641,((_tmp95A="`noreturn' function might (implicitly) return",_tag_dyneither(_tmp95A,sizeof(char),46))),_tag_dyneither(_tmp959,sizeof(void*),0)));}else{
# 3063
...
# 3067
{const char*_tmp95D;void*_tmp95C;(_tmp95C=0,Cyc_Tcutil_warn(_tmp641,((_tmp95D="function may not return a value",_tag_dyneither(_tmp95D,sizeof(char),32))),_tag_dyneither(_tmp95C,sizeof(void*),0)));}goto _LL539;default: _LL540: _LL541:
# 3069
{const char*_tmp960;void*_tmp95F;(_tmp95F=0,Cyc_CfFlowInfo_aerr(_tmp641,((_tmp960="function may not return a value",_tag_dyneither(_tmp960,sizeof(char),32))),_tag_dyneither(_tmp95F,sizeof(void*),0)));}goto _LL539;}_LL539:;}
# 3071
goto _LL534;}_LL534:;};};};};};}
# 3075
void Cyc_NewControlFlow_cf_check(struct Cyc_List_List*ds){
