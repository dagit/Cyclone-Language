...
union Cyc_CfFlowInfo_FlowInfo _tmp5=f;struct Cyc_List_List*_tmp6;if((_tmp5.BottomFL).tag == 1){_LL1: _LL2:
 ...
 return _tmp6;}_LL0:;}struct _tuple21{struct Cyc_NewControlFlow_CFStmtAnnot*f1;union Cyc_CfFlowInfo_FlowInfo*f2;};
# 159
...
return({struct _tuple21 _tmp597;_tmp597.f1=_tmp7,_tmp597.f2=_tmp8;_tmp597;});}
# 179
...
# 196
struct _tuple22*_tmp9=ckenv;struct Cyc_NewControlFlow_AnalEnv*_tmp13;unsigned _tmp12;struct Cyc_Dict_Dict _tmp11;_LL1: _tmp13=_tmp9->f1;_tmp12=_tmp9->f2;_tmp11=_tmp9->f3;_LL2:;{
...
struct _tuple20 _tmp17=({struct _tuple20 _tmp59A;_tmp59A.f1=flow,_tmp59A.f2=_tmp16;_tmp59A;});struct _tuple20 _tmp18=_tmp17;struct Cyc_Dict_Dict _tmp1B;struct Cyc_Dict_Dict _tmp1A;if(((_tmp18.f1).ReachableFL).tag == 2){if(((_tmp18.f2).ReachableFL).tag == 2){_LL1: _tmp1B=(((_tmp18.f1).ReachableFL).val).f1;_tmp1A=(((_tmp18.f2).ReachableFL).val).f1;_LL2: {
# 229
struct _tuple22 _tmp19=({struct _tuple22 _tmp599;_tmp599.f1=env,_tmp599.f2=s->loc,_tmp599.f3=_tmp1A;_tmp599;});
((void(*)(void(*f)(struct _tuple22*,void*,void*),struct _tuple22*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_NewControlFlow_check_unique_root,& _tmp19,_tmp1B);
...
return _tmp4B;};};}_LL0:;}struct _tuple23{struct Cyc_Absyn_Tqual f1;void*f2;};
# 350
...
({struct Cyc_NewControlFlow_AnalEnv*_tmp657=env;unsigned _tmp656=loc;void*_tmp655=(*((struct _tuple23*)((struct Cyc_List_List*)_check_null(_tmp5D))->hd)).f2;Cyc_NewControlFlow_check_nounique(_tmp657,_tmp656,_tmp655,*((void**)_check_fat_subscript(_tmp5C,sizeof(void*),i)));});}}
# 365
...
return _tmp6C;};};};}_LL0:;}struct _tuple24{union Cyc_CfFlowInfo_FlowInfo f1;struct Cyc_List_List*f2;};
# 418
...
do{
struct _tuple17 _tmp6F=Cyc_NewControlFlow_anal_Rexp(env,first_is_copy,inflow,(struct Cyc_Absyn_Exp*)es->hd);struct _tuple17 _tmp70=_tmp6F;union Cyc_CfFlowInfo_FlowInfo _tmp73;void*_tmp72;_LL1: _tmp73=_tmp70.f1;_tmp72=_tmp70.f2;_LL2:;
inflow=_tmp73;
...
# 442
struct _tuple24 _tmp75=_tmp74;union Cyc_CfFlowInfo_FlowInfo _tmp7B;struct Cyc_List_List*_tmp7A;_LL1: _tmp7B=_tmp75.f1;_tmp7A=_tmp75.f2;_LL2:;
# 444
...
goto _LL3;}else{_LL6: _LL7:
 goto _LL3;}_LL3:;}
# 452
return({struct _tuple17 _tmp5A2;_tmp5A2.f1=_tmp7B,_tmp5A2.f2=(env->fenv)->unknown_all;_tmp5A2;});}
# 459
...
union Cyc_CfFlowInfo_FlowInfo _tmp87=outflow;struct Cyc_Dict_Dict _tmp8E;struct Cyc_List_List*_tmp8D;if((_tmp87.BottomFL).tag == 1){_LL1: _LL2:
 return({struct _tuple20 _tmp5A3;_tmp5A3.f1=outflow,_tmp5A3.f2=outflow;_tmp5A3;});}else{_LL3: _tmp8E=((_tmp87.ReachableFL).val).f1;_tmp8D=((_tmp87.ReachableFL).val).f2;_LL4: {
# 527
union Cyc_CfFlowInfo_AbsLVal _tmp88=(Cyc_NewControlFlow_anal_Lexp(env,inflow,0,0,e)).f2;union Cyc_CfFlowInfo_AbsLVal _tmp89=_tmp88;struct Cyc_CfFlowInfo_Place*_tmp8C;if((_tmp89.UnknownL).tag == 2){_LL6: _LL7:
 return({struct _tuple20 _tmp5A4;_tmp5A4.f1=outflow,_tmp5A4.f2=outflow;_tmp5A4;});}else{_LL8: _tmp8C=(_tmp89.PlaceL).val;_LL9: {
# 530
void*nzval=(int)il == (int)1U?(env->fenv)->notzeroall:(env->fenv)->unknown_none;
...
# 579
 return({struct _tuple17 _tmp5A6;_tmp5A6.f1=f,({void*_tmp668=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpB3,0,(env->fenv)->unknown_all);_tmp5A6.f2=_tmp668;});_tmp5A6;});}else{_LL8: _tmpAF=((_tmp97.ReachableFL).val).f1;_tmpAE=((_tmp97.ReachableFL).val).f2;_LL9: {
# 581
struct _tuple16 _tmp98=Cyc_CfFlowInfo_unname_rval(r);struct _tuple16 _tmp99=_tmp98;void*_tmpAD;struct Cyc_List_List*_tmpAC;_LLB: _tmpAD=_tmp99.f1;_tmpAC=_tmp99.f2;_LLC:;
...
return({struct _tuple17 _tmp5A7;_tmp5A7.f1=f,({void*_tmp66A=Cyc_CfFlowInfo_lookup_place(_tmpAF,_tmp9F);_tmp5A7.f2=_tmp66A;});_tmp5A7;});
...
if(index == 0 && Cyc_Tcutil_is_bound_one(_tmpB2))
return({struct _tuple17 _tmp5A8;_tmp5A8.f1=f,_tmp5A8.f2=_tmpA0;_tmp5A8;});
...
# 612
struct _tuple16 _tmpA4=Cyc_CfFlowInfo_unname_rval(_tmpAD);struct _tuple16 _tmpA5=_tmpA4;void*_tmpAB;_LL22: _tmpAB=_tmpA5.f1;_LL23:;
...
# 622
 return({struct _tuple17 _tmp5AA;_tmp5AA.f1=f,({void*_tmp671=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpB3,0,(env->fenv)->unknown_all);_tmp5AA.f2=_tmp671;});_tmp5AA;});}_LL1C:;};}}_LL5:;}}else{_LL3: _LL4:
# 625
...
# 668
struct _tuple19 _tmpB8=Cyc_NewControlFlow_anal_Lexp(env,inflow,1,1,exp);struct _tuple19 _tmpB9=_tmpB8;union Cyc_CfFlowInfo_AbsLVal _tmpC8;_LL1: _tmpC8=_tmpB9.f2;_LL2:;
{struct _tuple19 _tmpBA=({struct _tuple19 _tmp5AC;_tmp5AC.f1=inflow,_tmp5AC.f2=_tmpC8;_tmp5AC;});struct _tuple19 _tmpBB=_tmpBA;struct Cyc_Dict_Dict _tmpC7;struct Cyc_List_List*_tmpC6;struct Cyc_CfFlowInfo_Place*_tmpC5;if(((_tmpBB.f1).ReachableFL).tag == 2){if(((_tmpBB.f2).PlaceL).tag == 1){_LL4: _tmpC7=(((_tmpBB.f1).ReachableFL).val).f1;_tmpC6=(((_tmpBB.f1).ReachableFL).val).f2;_tmpC5=((_tmpBB.f2).PlaceL).val;_LL5: {
# 671
void*_tmpBC=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,(void*)_check_null(exp->topt),0,(env->fenv)->unknown_all);
# 673
struct _tuple16 _tmpBD=Cyc_CfFlowInfo_unname_rval(old_rval);struct _tuple16 _tmpBE=_tmpBD;void*_tmpC1;struct Cyc_List_List*_tmpC0;_LLB: _tmpC1=_tmpBE.f1;_tmpC0=_tmpBE.f2;_LLC:;
...
# 704
 return({struct _tuple17 _tmp5AD;({union Cyc_CfFlowInfo_FlowInfo _tmp675=Cyc_CfFlowInfo_BottomFL();_tmp5AD.f1=_tmp675;}),_tmp5AD.f2=rval;_tmp5AD;});}else{_LL3: _tmpD4=((_tmpC9.ReachableFL).val).f1;_tmpD3=((_tmpC9.ReachableFL).val).f2;_LL4: {
# 706
...
# 720
struct _tuple16 _tmpCC=Cyc_CfFlowInfo_unname_rval(Cyc_CfFlowInfo_lookup_place(_tmpD4,_tmpD2));struct _tuple16 _tmpCD=_tmpCC;void*_tmpD1;_LLB: _tmpD1=_tmpCD.f1;_LLC:;{
...
# 763
return _tmpD8;};}_LL0:;}struct _tuple25{struct Cyc_Absyn_Vardecl**f1;struct Cyc_Absyn_Exp*f2;};
# 767
...
# 789
struct _tuple17 _tmpDD=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,(struct Cyc_Absyn_Exp*)x->hd);struct _tuple17 _tmpDE=_tmpDD;union Cyc_CfFlowInfo_FlowInfo _tmpE0;void*_tmpDF;_LL1: _tmpE0=_tmpDE.f1;_tmpDF=_tmpDE.f2;_LL2:;
...
struct _tuple25*_tmpE2=(struct _tuple25*)_tmpE1->hd;struct _tuple25*_tmpE3=_tmpE2;struct Cyc_Absyn_Vardecl**_tmpFB;struct Cyc_Absyn_Exp*_tmpFA;_LL4: _tmpFB=_tmpE3->f1;_tmpFA=_tmpE3->f2;_LL5:;
...
struct _tuple19 _tmpE8=Cyc_NewControlFlow_anal_Lexp(env,_tmpE7,0,0,_tmpFA);struct _tuple19 _tmpE9=_tmpE8;union Cyc_CfFlowInfo_AbsLVal _tmpF9;_LL7: _tmpF9=_tmpE9.f2;_LL8:;{
struct _tuple17 _tmpEA=Cyc_NewControlFlow_anal_Rexp(env,1,_tmpE7,_tmpFA);struct _tuple17 _tmpEB=_tmpEA;union Cyc_CfFlowInfo_FlowInfo _tmpF8;void*_tmpF7;_LLA: _tmpF8=_tmpEB.f1;_tmpF7=_tmpEB.f2;_LLB:;{
...
{union Cyc_CfFlowInfo_FlowInfo _tmp11A=inflow;struct Cyc_Dict_Dict _tmp11C;struct Cyc_List_List*_tmp11B;if((_tmp11A.BottomFL).tag == 1){_LL1: _LL2:
 return({struct _tuple17 _tmp5B7;({union Cyc_CfFlowInfo_FlowInfo _tmp687=Cyc_CfFlowInfo_BottomFL();_tmp5B7.f1=_tmp687;}),_tmp5B7.f2=_tmp119->unknown_all;_tmp5B7;});}else{_LL3: _tmp11C=((_tmp11A.ReachableFL).val).f1;_tmp11B=((_tmp11A.ReachableFL).val).f2;_LL4:
...
struct _tuple19 _tmp11D=Cyc_NewControlFlow_anal_Lexp(env,inflow,1,0,e);struct _tuple19 _tmp11E=_tmp11D;union Cyc_CfFlowInfo_FlowInfo _tmp12A;union Cyc_CfFlowInfo_AbsLVal _tmp129;_LL6: _tmp12A=_tmp11E.f1;_tmp129=_tmp11E.f2;_LL7:;{
struct _tuple19 _tmp11F=({struct _tuple19 _tmp5BB;_tmp5BB.f1=_tmp12A,_tmp5BB.f2=_tmp129;_tmp5BB;});struct _tuple19 _tmp120=_tmp11F;struct Cyc_Dict_Dict _tmp128;struct Cyc_List_List*_tmp127;struct Cyc_CfFlowInfo_Place*_tmp126;if(((_tmp120.f1).ReachableFL).tag == 2){if(((_tmp120.f2).PlaceL).tag == 1){_LL9: _tmp128=(((_tmp120.f1).ReachableFL).val).f1;_tmp127=(((_tmp120.f1).ReachableFL).val).f2;_tmp126=((_tmp120.f2).PlaceL).val;_LLA: {
# 977
...
return({struct _tuple17 _tmp5B8;({union Cyc_CfFlowInfo_FlowInfo _tmp68A=Cyc_CfFlowInfo_BottomFL();_tmp5B8.f1=_tmp68A;}),_tmp5B8.f2=_tmp119->unknown_all;_tmp5B8;});}else{
# 983
if(needs_unconsume)
# 985
return({struct _tuple17 _tmp5B9;_tmp5B9.f1=_tmp12A,({void*_tmp68B=Cyc_CfFlowInfo_make_unique_unconsumed(_tmp119,_tmp121);_tmp5B9.f2=_tmp68B;});_tmp5B9;});else{
# 988
...
# 1000
return({struct _tuple17 _tmp5BA;({union Cyc_CfFlowInfo_FlowInfo _tmp68C=Cyc_CfFlowInfo_ReachableFL(_tmp125,_tmp127);_tmp5BA.f1=_tmp68C;}),_tmp5BA.f2=_tmp121;_tmp5BA;});}}}}else{goto _LLB;}}else{_LLB: _LLC:
# 1004
 goto _LL8;}_LL8:;};}{
# 1007
...
# 1011
struct _tuple17 _tmp12D=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,inflow,_tmp2B0);struct _tuple17 _tmp12E=_tmp12D;union Cyc_CfFlowInfo_FlowInfo _tmp134;void*_tmp133;_LL7F: _tmp134=_tmp12E.f1;_tmp133=_tmp12E.f2;_LL80:;{
struct _tuple17 _tmp12F=Cyc_NewControlFlow_anal_derefR(env,inflow,_tmp134,_tmp2B0,_tmp133,0);struct _tuple17 _tmp130=_tmp12F;union Cyc_CfFlowInfo_FlowInfo _tmp132;void*_tmp131;_LL82: _tmp132=_tmp130.f1;_tmp131=_tmp130.f2;_LL83:;
return({struct _tuple17 _tmp5BC;_tmp5BC.f1=_tmp132,_tmp5BC.f2=_tmp133;_tmp5BC;});};}}else{_LL10: _tmp2B1=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL11:
# 1017
...
return({struct _tuple17 _tmp5BF;_tmp5BF.f1=inflow,_tmp5BF.f2=_tmp119->zero;_tmp5BF;});case 40U: _LL1A: _LL1B:
# 1043
 ...
 return({struct _tuple17 _tmp5C0;_tmp5C0.f1=inflow,_tmp5C0.f2=_tmp119->zero;_tmp5C0;});}else{_LL20: _LL21:
...
# 1049
 return({struct _tuple17 _tmp5C1;_tmp5C1.f1=inflow,_tmp5C1.f2=_tmp119->notzeroall;_tmp5C1;});case 1U: _LL36: _LL37:
# 1060
 return({struct _tuple17 _tmp5C2;_tmp5C2.f1=inflow,({void*_tmp696=Cyc_CfFlowInfo_typ_to_absrval(_tmp119,(void*)_check_null(e->topt),0,_tmp119->unknown_all);_tmp5C2.f2=_tmp696;});_tmp5C2;});case 4U: _LL38: _tmp2B6=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp12C)->f1)->f1;_LL39:
# 1065
 if((int)_tmp2B6->sc == (int)Cyc_Absyn_Static)
return({struct _tuple17 _tmp5C3;_tmp5C3.f1=inflow,({void*_tmp697=Cyc_CfFlowInfo_typ_to_absrval(_tmp119,(void*)_check_null(e->topt),0,_tmp119->unknown_all);_tmp5C3.f2=_tmp697;});_tmp5C3;});
# 1068
_tmp2B7=_tmp2B6;goto _LL3B;case 3U: _LL3A: _tmp2B7=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp12C)->f1)->f1;_LL3B:
 _tmp2B8=_tmp2B7;goto _LL3D;case 5U: _LL3C: _tmp2B8=((struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp12C)->f1)->f1;_LL3D: {
# 1072
...
return({struct _tuple17 _tmp5C4;_tmp5C4.f1=inflow,({void*_tmp699=({struct Cyc_Dict_Dict _tmp698=d;((void*(*)(struct Cyc_Dict_Dict d,int(*cmp)(void*,void*),void*k))Cyc_Dict_lookup_other)(_tmp698,Cyc_CfFlowInfo_root_cmp,(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp141=_cycalloc(sizeof(*_tmp141));*_tmp141=vdroot;_tmp141;}));});_tmp5C4.f2=_tmp699;});_tmp5C4;});}default: _LL76: _LL77:
# 1677
 goto _LL79;}case 31U: if(((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp12C)->f1 == 0){_LL28: _LL29:
# 1051
 goto _LL2B;}else{_LL64: _tmp2BA=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2B9=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL65:
# 1539
 _tmp2E1=_tmp2BA;goto _LL67;}case 18U: _LL2C: _LL2D:
# 1053
 ...
 return({struct _tuple17 _tmp5C6;_tmp5C6.f1=inflow,_tmp5C6.f2=_tmp119->unknown_all;_tmp5C6;});case 3U: _LL3E: _tmp2BC=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2BB=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL3F: {
# 1079
struct _tuple17 _tmp142=Cyc_NewControlFlow_anal_use_ints(env,inflow,_tmp2BB);struct _tuple17 _tmp143=_tmp142;union Cyc_CfFlowInfo_FlowInfo _tmp145;void*_tmp144;_LL85: _tmp145=_tmp143.f1;_tmp144=_tmp143.f2;_LL86:;
return({struct _tuple17 _tmp5C7;_tmp5C7.f1=_tmp145,_tmp5C7.f2=_tmp144;_tmp5C7;});}case 5U: _LL40: _tmp2BD=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL41: {
# 1083
struct Cyc_List_List _tmp146=({struct Cyc_List_List _tmp5CB;_tmp5CB.hd=_tmp2BD,_tmp5CB.tl=0;_tmp5CB;});
struct _tuple17 _tmp147=Cyc_NewControlFlow_anal_use_ints(env,inflow,& _tmp146);struct _tuple17 _tmp148=_tmp147;union Cyc_CfFlowInfo_FlowInfo _tmp155;_LL88: _tmp155=_tmp148.f1;_LL89:;{
struct _tuple19 _tmp149=Cyc_NewControlFlow_anal_Lexp(env,_tmp155,0,0,_tmp2BD);struct _tuple19 _tmp14A=_tmp149;union Cyc_CfFlowInfo_AbsLVal _tmp154;_LL8B: _tmp154=_tmp14A.f2;_LL8C:;{
int iszt=Cyc_Tcutil_is_zeroterm_pointer_type((void*)_check_null(_tmp2BD->topt));
if(iszt){
# 1090
struct _tuple17 _tmp14B=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,_tmp2BD);struct _tuple17 _tmp14C=_tmp14B;union Cyc_CfFlowInfo_FlowInfo _tmp14E;void*_tmp14D;_LL8E: _tmp14E=_tmp14C.f1;_tmp14D=_tmp14C.f2;_LL8F:;
Cyc_NewControlFlow_anal_derefR(env,inflow,_tmp14E,_tmp2BD,_tmp14D,0);}
# 1093
{struct _tuple26 _tmp14F=({struct _tuple26 _tmp5C8;_tmp5C8.f1=_tmp154,_tmp5C8.f2=_tmp155;_tmp5C8;});struct _tuple26 _tmp150=_tmp14F;struct Cyc_CfFlowInfo_Place*_tmp153;struct Cyc_Dict_Dict _tmp152;struct Cyc_List_List*_tmp151;if(((_tmp150.f1).PlaceL).tag == 1){if(((_tmp150.f2).ReachableFL).tag == 2){_LL91: _tmp153=((_tmp150.f1).PlaceL).val;_tmp152=(((_tmp150.f2).ReachableFL).val).f1;_tmp151=(((_tmp150.f2).ReachableFL).val).f2;_LL92:
# 1095
...
# 1104
if(iszt)
return({struct _tuple17 _tmp5C9;_tmp5C9.f1=_tmp155,_tmp5C9.f2=_tmp119->notzeroall;_tmp5C9;});else{
return({struct _tuple17 _tmp5CA;_tmp5CA.f1=_tmp155,_tmp5CA.f2=_tmp119->unknown_all;_tmp5CA;});}};};}case 4U: if(((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12C)->f2 != 0){_LL42: _tmp2BF=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2BE=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12C)->f3;_LL43:
# 1109
...
return({struct _tuple17 _tmp5CC;({union Cyc_CfFlowInfo_FlowInfo _tmp69D=Cyc_CfFlowInfo_BottomFL();_tmp5CC.f1=_tmp69D;}),_tmp5CC.f2=_tmp119->unknown_all;_tmp5CC;});}{
# 1113
struct _tuple17 _tmp158=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp2BE);struct _tuple17 _tmp159=_tmp158;union Cyc_CfFlowInfo_FlowInfo _tmp164;void*_tmp163;_LL96: _tmp164=_tmp159.f1;_tmp163=_tmp159.f2;_LL97:;{
struct _tuple19 _tmp15A=Cyc_NewControlFlow_anal_Lexp(env,_tmp164,0,0,_tmp2BF);struct _tuple19 _tmp15B=_tmp15A;union Cyc_CfFlowInfo_FlowInfo _tmp162;union Cyc_CfFlowInfo_AbsLVal _tmp161;_LL99: _tmp162=_tmp15B.f1;_tmp161=_tmp15B.f2;_LL9A:;
...
goto _LL9B;}else{_LL9E: _LL9F:
 goto _LL9B;}_LL9B:;}
# 1136
return({struct _tuple17 _tmp5CD;_tmp5CD.f1=_tmp162,_tmp5CD.f2=_tmp119->unknown_all;_tmp5CD;});};};}else{_LL44: _tmp2C1=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2C0=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12C)->f3;_LL45:
# 1139
 if(copy_ctxt && Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_check_null(e->topt))){
...
return({struct _tuple17 _tmp5CE;({union Cyc_CfFlowInfo_FlowInfo _tmp6A0=Cyc_CfFlowInfo_BottomFL();_tmp5CE.f1=_tmp6A0;}),_tmp5CE.f2=_tmp119->unknown_all;_tmp5CE;});}
# 1145
...
# 1147
struct _tuple17 _tmp168=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp2C0);struct _tuple17 _tmp169=_tmp168;union Cyc_CfFlowInfo_FlowInfo _tmp173;void*_tmp172;_LLA6: _tmp173=_tmp169.f1;_tmp172=_tmp169.f2;_LLA7:;{
struct _tuple19 _tmp16A=Cyc_NewControlFlow_anal_Lexp(env,_tmp173,0,0,_tmp2C1);struct _tuple19 _tmp16B=_tmp16A;union Cyc_CfFlowInfo_FlowInfo _tmp171;union Cyc_CfFlowInfo_AbsLVal _tmp170;_LLA9: _tmp171=_tmp16B.f1;_tmp170=_tmp16B.f2;_LLAA:;{
struct _tuple17 _tmp16C=Cyc_NewControlFlow_do_assign(_tmp119,env,_tmp171,_tmp2C1,_tmp170,_tmp2C0,_tmp172,e->loc);struct _tuple17 _tmp16D=_tmp16C;union Cyc_CfFlowInfo_FlowInfo _tmp16F;void*_tmp16E;_LLAC: _tmp16F=_tmp16D.f1;_tmp16E=_tmp16D.f2;_LLAD:;
# 1153
return({struct _tuple17 _tmp5CF;_tmp5CF.f1=_tmp16F,_tmp5CF.f2=_tmp16E;_tmp5CF;});};};};}case 9U: _LL46: _tmp2C3=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2C2=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL47: {
# 1156
struct _tuple17 _tmp174=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,_tmp2C3);struct _tuple17 _tmp175=_tmp174;union Cyc_CfFlowInfo_FlowInfo _tmp177;void*_tmp176;_LLAF: _tmp177=_tmp175.f1;_tmp176=_tmp175.f2;_LLB0:;
return Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,_tmp177,_tmp2C2);}case 11U: _LL48: _tmp2C4=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL49: {
# 1160
struct _tuple17 _tmp178=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp2C4);struct _tuple17 _tmp179=_tmp178;union Cyc_CfFlowInfo_FlowInfo _tmp17B;void*_tmp17A;_LLB2: _tmp17B=_tmp179.f1;_tmp17A=_tmp179.f2;_LLB3:;
Cyc_NewControlFlow_use_Rval(env,_tmp2C4->loc,_tmp17B,_tmp17A);
return({struct _tuple17 _tmp5D0;({union Cyc_CfFlowInfo_FlowInfo _tmp6A4=Cyc_CfFlowInfo_BottomFL();_tmp5D0.f1=_tmp6A4;}),({void*_tmp6A3=Cyc_CfFlowInfo_typ_to_absrval(_tmp119,(void*)_check_null(e->topt),0,_tmp119->unknown_all);_tmp5D0.f2=_tmp6A3;});_tmp5D0;});}case 10U: _LL4A: _tmp2C6=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2C5=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL4B: {
# 1165
struct Cyc_List_List*_tmp17C=_tmp2C5;
struct _tuple17 _tmp17D=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,_tmp2C6);struct _tuple17 _tmp17E=_tmp17D;union Cyc_CfFlowInfo_FlowInfo _tmp1AF;void*_tmp1AE;_LLB5: _tmp1AF=_tmp17E.f1;_tmp1AE=_tmp17E.f2;_LLB6:;
# 1168
Cyc_NewControlFlow_anal_derefR(env,inflow,_tmp1AF,_tmp2C6,_tmp1AE,0);{
# 1171
struct _tuple24 _tmp17F=({struct Cyc_NewControlFlow_AnalEnv*_tmp6A6=env;union Cyc_CfFlowInfo_FlowInfo _tmp6A5=_tmp1AF;Cyc_NewControlFlow_anal_Rexps(_tmp6A6,_tmp6A5,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_copy)(_tmp2C5),1,1);});struct _tuple24 _tmp180=_tmp17F;union Cyc_CfFlowInfo_FlowInfo _tmp1AD;struct Cyc_List_List*_tmp1AC;_LLB8: _tmp1AD=_tmp180.f1;_tmp1AC=_tmp180.f2;_LLB9:;{
# 1173
...
# 1212
struct _tuple16 _tmp198=Cyc_CfFlowInfo_unname_rval((void*)_tmp1AC->hd);struct _tuple16 _tmp199=_tmp198;void*_tmp1AA;_LLD3: _tmp1AA=_tmp199.f1;_LLD4:;
...
return({struct _tuple17 _tmp5D1;({union Cyc_CfFlowInfo_FlowInfo _tmp6B6=Cyc_CfFlowInfo_BottomFL();_tmp5D1.f1=_tmp6B6;}),({void*_tmp6B5=Cyc_CfFlowInfo_typ_to_absrval(_tmp119,(void*)_check_null(e->topt),0,_tmp119->unknown_all);_tmp5D1.f2=_tmp6B5;});_tmp5D1;});else{
# 1272
return({struct _tuple17 _tmp5D2;_tmp5D2.f1=_tmp181,({void*_tmp6B7=Cyc_CfFlowInfo_typ_to_absrval(_tmp119,(void*)_check_null(e->topt),0,_tmp119->unknown_all);_tmp5D2.f2=_tmp6B7;});_tmp5D2;});}};};}case 34U: _LL4C: _tmp2CB=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12C)->f1).is_calloc;_tmp2CA=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12C)->f1).rgn;_tmp2C9=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12C)->f1).elt_type;_tmp2C8=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12C)->f1).num_elts;_tmp2C7=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12C)->f1).fat_result;_LL4D: {
# 1275
void*place_val;
...
if(_tmp2CA != 0){
struct _tuple24 _tmp1B0=({struct Cyc_NewControlFlow_AnalEnv*_tmp6B9=env;union Cyc_CfFlowInfo_FlowInfo _tmp6B8=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6B9,_tmp6B8,({struct Cyc_Absyn_Exp*_tmp1B4[2U];_tmp1B4[0]=_tmp2CA,_tmp1B4[1]=_tmp2C8;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1B4,sizeof(struct Cyc_Absyn_Exp*),2U));}),1,1);});struct _tuple24 _tmp1B1=_tmp1B0;union Cyc_CfFlowInfo_FlowInfo _tmp1B3;struct Cyc_List_List*_tmp1B2;_LLE7: _tmp1B3=_tmp1B1.f1;_tmp1B2=_tmp1B1.f2;_LLE8:;
outflow=_tmp1B3;}else{
# 1284
struct _tuple17 _tmp1B5=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp2C8);struct _tuple17 _tmp1B6=_tmp1B5;union Cyc_CfFlowInfo_FlowInfo _tmp1B7;_LLEA: _tmp1B7=_tmp1B6.f1;_LLEB:;
outflow=_tmp1B7;}
# 1289
if(Cyc_Tcutil_is_noalias_pointer((void*)_check_null(e->topt),1))
return({struct _tuple17 _tmp5D3;_tmp5D3.f1=outflow,({void*_tmp6BA=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp1B8=_cycalloc(sizeof(*_tmp1B8));_tmp1B8->tag=5U,_tmp1B8->f1=place_val;_tmp1B8;});_tmp5D3.f2=_tmp6BA;});_tmp5D3;});else{
# 1293
...
union Cyc_CfFlowInfo_FlowInfo _tmp1B9=outflow;struct Cyc_Dict_Dict _tmp1BB;struct Cyc_List_List*_tmp1BA;if((_tmp1B9.BottomFL).tag == 1){_LLED: _LLEE:
 return({struct _tuple17 _tmp5D4;_tmp5D4.f1=outflow,_tmp5D4.f2=rval;_tmp5D4;});}else{_LLEF: _tmp1BB=((_tmp1B9.ReachableFL).val).f1;_tmp1BA=((_tmp1B9.ReachableFL).val).f2;_LLF0:
# 1299
 return({struct _tuple17 _tmp5D5;({union Cyc_CfFlowInfo_FlowInfo _tmp6BC=({struct Cyc_Dict_Dict _tmp6BB=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp1BB,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp6BB,_tmp1BA);});_tmp5D5.f1=_tmp6BC;}),_tmp5D5.f2=rval;_tmp5D5;});}_LLEC:;}};}case 35U: _LL4E: _tmp2CD=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2CC=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL4F: {
# 1304
void*left_rval;
void*right_rval;
union Cyc_CfFlowInfo_FlowInfo outflow;
# 1310
struct _tuple24 _tmp1BF=({struct Cyc_NewControlFlow_AnalEnv*_tmp6BE=env;union Cyc_CfFlowInfo_FlowInfo _tmp6BD=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6BE,_tmp6BD,({struct Cyc_Absyn_Exp*_tmp1DA[2U];_tmp1DA[0]=_tmp2CD,_tmp1DA[1]=_tmp2CC;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1DA,sizeof(struct Cyc_Absyn_Exp*),2U));}),0,0);});struct _tuple24 _tmp1C0=_tmp1BF;union Cyc_CfFlowInfo_FlowInfo _tmp1D9;struct Cyc_List_List*_tmp1D8;_LLF2: _tmp1D9=_tmp1C0.f1;_tmp1D8=_tmp1C0.f2;_LLF3:;
...
# 1335
struct _tuple19 _tmp1C7=Cyc_NewControlFlow_anal_Lexp(env,outflow,0,0,_tmp2CD);struct _tuple19 _tmp1C8=_tmp1C7;union Cyc_CfFlowInfo_AbsLVal _tmp1D7;_LLFF: _tmp1D7=_tmp1C8.f2;_LL100:;{
struct _tuple19 _tmp1C9=Cyc_NewControlFlow_anal_Lexp(env,outflow,0,0,_tmp2CC);struct _tuple19 _tmp1CA=_tmp1C9;union Cyc_CfFlowInfo_AbsLVal _tmp1D6;_LL102: _tmp1D6=_tmp1CA.f2;_LL103:;
...
goto _LL104;}else{_LL107: _LL108:
 goto _LL104;}_LL104:;}
# 1371
return({struct _tuple17 _tmp5D6;_tmp5D6.f1=outflow,_tmp5D6.f2=_tmp119->unknown_all;_tmp5D6;});};};};}case 16U: _LL50: _tmp2CF=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2CE=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL51: {
# 1374
union Cyc_CfFlowInfo_FlowInfo outflow;
void*place_val;
if(_tmp2CF != 0){
struct _tuple24 _tmp1DB=({struct Cyc_NewControlFlow_AnalEnv*_tmp6C8=env;union Cyc_CfFlowInfo_FlowInfo _tmp6C7=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6C8,_tmp6C7,({struct Cyc_Absyn_Exp*_tmp1DF[2U];_tmp1DF[0]=_tmp2CF,_tmp1DF[1]=_tmp2CE;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1DF,sizeof(struct Cyc_Absyn_Exp*),2U));}),1,1);});struct _tuple24 _tmp1DC=_tmp1DB;union Cyc_CfFlowInfo_FlowInfo _tmp1DE;struct Cyc_List_List*_tmp1DD;_LL114: _tmp1DE=_tmp1DC.f1;_tmp1DD=_tmp1DC.f2;_LL115:;
outflow=_tmp1DE;
place_val=(void*)((struct Cyc_List_List*)_check_null(((struct Cyc_List_List*)_check_null(_tmp1DD))->tl))->hd;}else{
# 1381
struct _tuple17 _tmp1E0=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp2CE);struct _tuple17 _tmp1E1=_tmp1E0;union Cyc_CfFlowInfo_FlowInfo _tmp1E3;void*_tmp1E2;_LL117: _tmp1E3=_tmp1E1.f1;_tmp1E2=_tmp1E1.f2;_LL118:;
outflow=_tmp1E3;
place_val=_tmp1E2;}
# 1386
if(Cyc_Tcutil_is_noalias_pointer((void*)_check_null(e->topt),1))
return({struct _tuple17 _tmp5D7;_tmp5D7.f1=outflow,({void*_tmp6C9=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp1E4=_cycalloc(sizeof(*_tmp1E4));_tmp1E4->tag=5U,_tmp1E4->f1=place_val;_tmp1E4;});_tmp5D7.f2=_tmp6C9;});_tmp5D7;});else{
# 1390
...
union Cyc_CfFlowInfo_FlowInfo _tmp1E5=outflow;struct Cyc_Dict_Dict _tmp1E7;struct Cyc_List_List*_tmp1E6;if((_tmp1E5.BottomFL).tag == 1){_LL11A: _LL11B:
 return({struct _tuple17 _tmp5D8;_tmp5D8.f1=outflow,_tmp5D8.f2=rval;_tmp5D8;});}else{_LL11C: _tmp1E7=((_tmp1E5.ReachableFL).val).f1;_tmp1E6=((_tmp1E5.ReachableFL).val).f2;_LL11D:
# 1396
 return({struct _tuple17 _tmp5D9;({union Cyc_CfFlowInfo_FlowInfo _tmp6CB=({struct Cyc_Dict_Dict _tmp6CA=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp1E7,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp6CA,_tmp1E6);});_tmp5D9.f1=_tmp6CB;}),_tmp5D9.f2=rval;_tmp5D9;});}_LL119:;}}case 15U: _LL52: _tmp2D0=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL53: {
# 1401
struct _tuple19 _tmp1EB=Cyc_NewControlFlow_anal_Lexp(env,inflow,0,0,_tmp2D0);struct _tuple19 _tmp1EC=_tmp1EB;union Cyc_CfFlowInfo_FlowInfo _tmp1F1;union Cyc_CfFlowInfo_AbsLVal _tmp1F0;_LL11F: _tmp1F1=_tmp1EC.f1;_tmp1F0=_tmp1EC.f2;_LL120:;{
union Cyc_CfFlowInfo_AbsLVal _tmp1ED=_tmp1F0;struct Cyc_CfFlowInfo_Place*_tmp1EF;if((_tmp1ED.UnknownL).tag == 2){_LL122: _LL123:
 return({struct _tuple17 _tmp5DA;_tmp5DA.f1=_tmp1F1,_tmp5DA.f2=_tmp119->notzeroall;_tmp5DA;});}else{_LL124: _tmp1EF=(_tmp1ED.PlaceL).val;_LL125:
 return({struct _tuple17 _tmp5DB;_tmp5DB.f1=_tmp1F1,({void*_tmp6CC=(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp1EE=_cycalloc(sizeof(*_tmp1EE));_tmp1EE->tag=4U,_tmp1EE->f1=_tmp1EF;_tmp1EE;});_tmp5DB.f2=_tmp6CC;});_tmp5DB;});}_LL121:;};}case 20U: _LL54: _tmp2D1=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL55: {
# 1408
struct _tuple17 _tmp1F2=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,_tmp2D1);struct _tuple17 _tmp1F3=_tmp1F2;union Cyc_CfFlowInfo_FlowInfo _tmp1F5;void*_tmp1F4;_LL127: _tmp1F5=_tmp1F3.f1;_tmp1F4=_tmp1F3.f2;_LL128:;
return Cyc_NewControlFlow_anal_derefR(env,inflow,_tmp1F5,_tmp2D1,_tmp1F4,0);}case 21U: _LL56: _tmp2D3=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2D2=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL57: {
# 1412
struct _tuple17 _tmp1F6=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,_tmp2D3);struct _tuple17 _tmp1F7=_tmp1F6;union Cyc_CfFlowInfo_FlowInfo _tmp207;void*_tmp206;_LL12A: _tmp207=_tmp1F7.f1;_tmp206=_tmp1F7.f2;_LL12B:;{
void*_tmp1F8=(void*)_check_null(_tmp2D3->topt);
# 1415
if(Cyc_Absyn_is_nontagged_nonrequire_union_type(_tmp1F8))
return({struct _tuple17 _tmp5DC;_tmp5DC.f1=_tmp207,({void*_tmp6CD=Cyc_CfFlowInfo_typ_to_absrval(_tmp119,(void*)_check_null(e->topt),0,_tmp119->unknown_all);_tmp5DC.f2=_tmp6CD;});_tmp5DC;});
if(Cyc_Absyn_is_require_union_type(_tmp1F8))
Cyc_NewControlFlow_check_union_requires(_tmp2D3->loc,_tmp1F8,_tmp2D2,_tmp207);{
struct _tuple16 _tmp1F9=Cyc_CfFlowInfo_unname_rval(_tmp206);struct _tuple16 _tmp1FA=_tmp1F9;void*_tmp205;_LL12D: _tmp205=_tmp1FA.f1;_LL12E:;{
...
return({struct _tuple17 _tmp5DD;_tmp5DD.f1=_tmp207,({void*_tmp6CE=Cyc_CfFlowInfo_typ_to_absrval(_tmp119,(void*)_check_null(e->topt),1,_tmp119->unknown_none);_tmp5DD.f2=_tmp6CE;});_tmp5DD;});
return({struct _tuple17 _tmp5DE;_tmp5DE.f1=_tmp207,_tmp5DE.f2=*((void**)_check_fat_subscript(_tmp202,sizeof(void*),_tmp1FC));_tmp5DE;});}}else{_LL132: _LL133:
# 1427
...
({struct Cyc_String_pa_PrintArg_struct _tmp201=({struct Cyc_String_pa_PrintArg_struct _tmp5DF;_tmp5DF.tag=0U,({struct _fat_ptr _tmp6D1=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp5DF.f1=_tmp6D1;});_tmp5DF;});void*_tmp1FF[1U];_tmp1FF[0]=& _tmp201;({struct _fat_ptr _tmp6D2=({const char*_tmp200="\nanal_Rexp: AggrMember: %s";_tag_fat(_tmp200,sizeof(char),27U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp6D2,_tag_fat(_tmp1FF,sizeof(void*),1U));});});}_LL12F:;};};};}case 38U: _LL58: _tmp2D5=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2D4=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL59: {
# 1435
struct _tuple17 _tmp208=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,_tmp2D5);struct _tuple17 _tmp209=_tmp208;union Cyc_CfFlowInfo_FlowInfo _tmp216;void*_tmp215;_LL135: _tmp216=_tmp209.f1;_tmp215=_tmp209.f2;_LL136:;
# 1437
if(Cyc_Absyn_is_nontagged_nonrequire_union_type((void*)_check_null(_tmp2D5->topt)))
return({struct _tuple17 _tmp5E0;_tmp5E0.f1=_tmp216,_tmp5E0.f2=_tmp119->unknown_all;_tmp5E0;});{
struct _tuple16 _tmp20A=Cyc_CfFlowInfo_unname_rval(_tmp215);struct _tuple16 _tmp20B=_tmp20A;void*_tmp214;_LL138: _tmp214=_tmp20B.f1;_LL139:;{
...
if(_tmp212 != _tmp20D)
return({struct _tuple17 _tmp5E1;_tmp5E1.f1=_tmp216,_tmp5E1.f2=_tmp119->zero;_tmp5E1;});else{
# 1447
return({struct _tuple17 _tmp5E2;_tmp5E2.f1=_tmp216,_tmp5E2.f2=_tmp119->notzeroall;_tmp5E2;});}}else{
# 1449
return({struct _tuple17 _tmp5E3;_tmp5E3.f1=_tmp216,_tmp5E3.f2=_tmp119->unknown_all;_tmp5E3;});}}}else{_LL13D: _LL13E:
# 1451
({struct Cyc_String_pa_PrintArg_struct _tmp210=({struct Cyc_String_pa_PrintArg_struct _tmp5E4;_tmp5E4.tag=0U,({struct _fat_ptr _tmp6D3=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp5E4.f1=_tmp6D3;});_tmp5E4;});void*_tmp20E[1U];_tmp20E[0]=& _tmp210;({struct _fat_ptr _tmp6D4=({const char*_tmp20F="anal_Rexp: TagCheck_e: %s";_tag_fat(_tmp20F,sizeof(char),26U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp6D4,_tag_fat(_tmp20E,sizeof(void*),1U));});});}_LL13A:;};};}case 22U: _LL5A: _tmp2D7=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2D6=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL5B: {
# 1455
struct _tuple17 _tmp217=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,_tmp2D7);struct _tuple17 _tmp218=_tmp217;union Cyc_CfFlowInfo_FlowInfo _tmp22D;void*_tmp22C;_LL140: _tmp22D=_tmp218.f1;_tmp22C=_tmp218.f2;_LL141:;{
# 1458
struct _tuple17 _tmp219=Cyc_NewControlFlow_anal_derefR(env,inflow,_tmp22D,_tmp2D7,_tmp22C,0);struct _tuple17 _tmp21A=_tmp219;union Cyc_CfFlowInfo_FlowInfo _tmp22B;void*_tmp22A;_LL143: _tmp22B=_tmp21A.f1;_tmp22A=_tmp21A.f2;_LL144:;{
# 1461
...
# 1465
return({struct _tuple17 _tmp5E5;_tmp5E5.f1=_tmp22B,({void*_tmp6D5=Cyc_CfFlowInfo_typ_to_absrval(_tmp119,(void*)_check_null(e->topt),0,_tmp119->unknown_all);_tmp5E5.f2=_tmp6D5;});_tmp5E5;});
# 1467
if(Cyc_Absyn_is_require_union_type(_tmp229))
Cyc_NewControlFlow_check_union_requires(_tmp2D7->loc,_tmp229,_tmp2D6,_tmp22D);{
# 1470
struct _tuple16 _tmp21D=Cyc_CfFlowInfo_unname_rval(_tmp22A);struct _tuple16 _tmp21E=_tmp21D;void*_tmp226;_LL14B: _tmp226=_tmp21E.f1;_LL14C:;{
...
return({struct _tuple17 _tmp5E6;_tmp5E6.f1=_tmp22B,({void*_tmp6D6=Cyc_CfFlowInfo_typ_to_absrval(_tmp119,(void*)_check_null(e->topt),1,_tmp119->unknown_none);_tmp5E6.f2=_tmp6D6;});_tmp5E6;});
return({struct _tuple17 _tmp5E7;_tmp5E7.f1=_tmp22B,_tmp5E7.f2=*((void**)_check_fat_subscript(_tmp223,sizeof(void*),_tmp220));_tmp5E7;});}}else{_LL150: _LL151:
...
# 1479
({void*_tmp227=0U;({struct _fat_ptr _tmp6D8=({const char*_tmp228="anal_Rexp: AggrArrow ptr";_tag_fat(_tmp228,sizeof(char),25U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp6D8,_tag_fat(_tmp227,sizeof(void*),0U));});});}_LL145:;};};}case 6U: _LL5C: _tmp2DA=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2D9=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_tmp2D8=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp12C)->f3;_LL5D: {
# 1483
struct _tuple20 _tmp22E=Cyc_NewControlFlow_anal_test(env,inflow,_tmp2DA);struct _tuple20 _tmp22F=_tmp22E;union Cyc_CfFlowInfo_FlowInfo _tmp233;union Cyc_CfFlowInfo_FlowInfo _tmp232;_LL153: _tmp233=_tmp22F.f1;_tmp232=_tmp22F.f2;_LL154:;{
struct _tuple17 _tmp230=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,_tmp233,_tmp2D9);
struct _tuple17 _tmp231=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,_tmp232,_tmp2D8);
return Cyc_CfFlowInfo_join_flow_and_rval(_tmp119,_tmp230,_tmp231);};}case 7U: _LL5E: _tmp2DC=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2DB=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL5F: {
# 1489
struct _tuple20 _tmp234=Cyc_NewControlFlow_anal_test(env,inflow,_tmp2DC);struct _tuple20 _tmp235=_tmp234;union Cyc_CfFlowInfo_FlowInfo _tmp23D;union Cyc_CfFlowInfo_FlowInfo _tmp23C;_LL156: _tmp23D=_tmp235.f1;_tmp23C=_tmp235.f2;_LL157:;{
struct _tuple17 _tmp236=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,_tmp23D,_tmp2DB);struct _tuple17 _tmp237=_tmp236;union Cyc_CfFlowInfo_FlowInfo _tmp23B;void*_tmp23A;_LL159: _tmp23B=_tmp237.f1;_tmp23A=_tmp237.f2;_LL15A:;{
struct _tuple17 _tmp238=({struct _tuple17 _tmp5E9;_tmp5E9.f1=_tmp23B,_tmp5E9.f2=_tmp23A;_tmp5E9;});
struct _tuple17 _tmp239=({struct _tuple17 _tmp5E8;_tmp5E8.f1=_tmp23C,_tmp5E8.f2=_tmp119->zero;_tmp5E8;});
return Cyc_CfFlowInfo_join_flow_and_rval(_tmp119,_tmp238,_tmp239);};};}case 8U: _LL60: _tmp2DE=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2DD=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL61: {
# 1496
struct _tuple20 _tmp23E=Cyc_NewControlFlow_anal_test(env,inflow,_tmp2DE);struct _tuple20 _tmp23F=_tmp23E;union Cyc_CfFlowInfo_FlowInfo _tmp247;union Cyc_CfFlowInfo_FlowInfo _tmp246;_LL15C: _tmp247=_tmp23F.f1;_tmp246=_tmp23F.f2;_LL15D:;{
struct _tuple17 _tmp240=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,_tmp246,_tmp2DD);struct _tuple17 _tmp241=_tmp240;union Cyc_CfFlowInfo_FlowInfo _tmp245;void*_tmp244;_LL15F: _tmp245=_tmp241.f1;_tmp244=_tmp241.f2;_LL160:;{
struct _tuple17 _tmp242=({struct _tuple17 _tmp5EB;_tmp5EB.f1=_tmp245,_tmp5EB.f2=_tmp244;_tmp5EB;});
struct _tuple17 _tmp243=({struct _tuple17 _tmp5EA;_tmp5EA.f1=_tmp247,_tmp5EA.f2=_tmp119->notzeroall;_tmp5EA;});
return Cyc_CfFlowInfo_join_flow_and_rval(_tmp119,_tmp242,_tmp243);};};}case 23U: _LL62: _tmp2E0=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2DF=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL63: {
# 1503
struct _tuple24 _tmp248=({struct Cyc_NewControlFlow_AnalEnv*_tmp6DA=env;union Cyc_CfFlowInfo_FlowInfo _tmp6D9=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6DA,_tmp6D9,({struct Cyc_Absyn_Exp*_tmp264[2U];_tmp264[0]=_tmp2E0,_tmp264[1]=_tmp2DF;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp264,sizeof(struct Cyc_Absyn_Exp*),2U));}),0,1);});struct _tuple24 _tmp249=_tmp248;union Cyc_CfFlowInfo_FlowInfo _tmp263;struct Cyc_List_List*_tmp262;_LL162: _tmp263=_tmp249.f1;_tmp262=_tmp249.f2;_LL163:;{
# 1507
...
# 1522
struct _tuple16 _tmp253=Cyc_CfFlowInfo_unname_rval((void*)((struct Cyc_List_List*)_check_null(_tmp262))->hd);struct _tuple16 _tmp254=_tmp253;void*_tmp259;_LL171: _tmp259=_tmp254.f1;_LL172:;{
...
return({struct _tuple17 _tmp5EC;_tmp5EC.f1=_tmp24A,_tmp5EC.f2=*((void**)_check_fat_subscript(_tmp258,sizeof(void*),(int)i));_tmp5EC;});}}else{_LL176: _LL177:
...
# 1530
struct _tuple17 _tmp25A=Cyc_NewControlFlow_anal_derefR(env,inflow,_tmp263,_tmp2E0,(void*)((struct Cyc_List_List*)_check_null(_tmp262))->hd,_tmp2DF);struct _tuple17 _tmp25B=_tmp25A;union Cyc_CfFlowInfo_FlowInfo _tmp25E;void*_tmp25D;_LL179: _tmp25E=_tmp25B.f1;_tmp25D=_tmp25B.f2;_LL17A:;{
union Cyc_CfFlowInfo_FlowInfo _tmp25C=_tmp25E;if((_tmp25C.BottomFL).tag == 1){_LL17C: _LL17D:
 return({struct _tuple17 _tmp5ED;_tmp5ED.f1=_tmp25E,_tmp5ED.f2=_tmp25D;_tmp5ED;});}else{_LL17E: _LL17F:
 return({struct _tuple17 _tmp5EE;_tmp5EE.f1=_tmp24A,_tmp5EE.f2=_tmp25D;_tmp5EE;});}_LL17B:;};}default: _LL16E: _LL16F:
# 1535
({void*_tmp25F=0U;({struct _fat_ptr _tmp6DE=({const char*_tmp260="anal_Rexp: Subscript -- bad type";_tag_fat(_tmp260,sizeof(char),33U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp6DE,_tag_fat(_tmp25F,sizeof(void*),0U));});});}_LL169:;};};}case 24U: _LL66: _tmp2E1=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL67: {
# 1541
struct _tuple24 _tmp265=Cyc_NewControlFlow_anal_Rexps(env,inflow,_tmp2E1,1,1);struct _tuple24 _tmp266=_tmp265;union Cyc_CfFlowInfo_FlowInfo _tmp26C;struct Cyc_List_List*_tmp26B;_LL181: _tmp26C=_tmp266.f1;_tmp26B=_tmp266.f2;_LL182:;{
...
# 1548
return({struct _tuple17 _tmp5EF;_tmp5EF.f1=_tmp26C,({void*_tmp6E0=(void*)({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp267=_cycalloc(sizeof(*_tmp267));_tmp267->tag=6U,(_tmp267->f1).is_union=0,(_tmp267->f1).fieldnum=- 1,_tmp267->f2=aggrdict;_tmp267;});_tmp5EF.f2=_tmp6E0;});_tmp5EF;});};}case 30U: _LL68: _tmp2E2=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL69: {
# 1551
...
# 1556
_tmp2E5=_tmp2E2;_tmp2E4=0U;_tmp2E3=fs;goto _LL6B;}case 29U: if(((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp12C)->f4 != 0){if(((struct Cyc_Absyn_Aggrdecl*)((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp12C)->f4)->impl != 0){_LL6A: _tmp2E5=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp12C)->f3;_tmp2E4=(((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp12C)->f4)->kind;_tmp2E3=((((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp12C)->f4)->impl)->fields;_LL6B: {
# 1558
void*exp_type=(void*)_check_null(e->topt);
struct _tuple24 _tmp272=({struct Cyc_NewControlFlow_AnalEnv*_tmp6E3=env;union Cyc_CfFlowInfo_FlowInfo _tmp6E2=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6E3,_tmp6E2,((struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*f)(struct _tuple27*),struct Cyc_List_List*x))Cyc_List_map)((struct Cyc_Absyn_Exp*(*)(struct _tuple27*))Cyc_Core_snd,_tmp2E5),1,1);});struct _tuple24 _tmp273=_tmp272;union Cyc_CfFlowInfo_FlowInfo _tmp27D;struct Cyc_List_List*_tmp27C;_LL189: _tmp27D=_tmp273.f1;_tmp27C=_tmp273.f2;_LL18A:;{
...
struct Cyc_List_List*ds=(*((struct _tuple27*)((struct Cyc_List_List*)_check_null(_tmp2E5))->hd)).f1;for(0;ds != 0;ds=ds->tl){
...
struct Cyc_Absyn_Exp*_tmp278=(*((struct _tuple27*)_tmp2E5->hd)).f2;
...
return({struct _tuple17 _tmp5F1;_tmp5F1.f1=_tmp27D,_tmp5F1.f2=(void*)_tmp27A;_tmp5F1;});};};}}else{goto _LL6C;}}else{_LL6C: _LL6D:
# 1584
({struct Cyc_String_pa_PrintArg_struct _tmp280=({struct Cyc_String_pa_PrintArg_struct _tmp5F2;_tmp5F2.tag=0U,({struct _fat_ptr _tmp6E5=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp5F2.f1=_tmp6E5;});_tmp5F2;});void*_tmp27E[1U];_tmp27E[0]=& _tmp280;({struct _fat_ptr _tmp6E6=({const char*_tmp27F="anal_Rexp:missing aggrdeclimpl in %s";_tag_fat(_tmp27F,sizeof(char),37U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp6E6,_tag_fat(_tmp27E,sizeof(void*),1U));});});}case 26U: _LL6E: _tmp2E6=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL6F: {
# 1586
struct Cyc_List_List*_tmp281=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*f)(struct _tuple27*),struct Cyc_List_List*x))Cyc_List_map)((struct Cyc_Absyn_Exp*(*)(struct _tuple27*))Cyc_Core_snd,_tmp2E6);
struct _tuple24 _tmp282=Cyc_NewControlFlow_anal_Rexps(env,inflow,_tmp281,1,1);struct _tuple24 _tmp283=_tmp282;union Cyc_CfFlowInfo_FlowInfo _tmp285;struct Cyc_List_List*_tmp284;_LL191: _tmp285=_tmp283.f1;_tmp284=_tmp283.f2;_LL192:;
...
# 1591
return({struct _tuple17 _tmp5F3;_tmp5F3.f1=_tmp285,({void*_tmp6E7=Cyc_CfFlowInfo_typ_to_absrval(_tmp119,(void*)_check_null(e->topt),0,_tmp119->notzeroall);_tmp5F3.f2=_tmp6E7;});_tmp5F3;});}case 27U: _LL70: _tmp2EA=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp2E9=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_tmp2E8=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp12C)->f3;_tmp2E7=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp12C)->f4;_LL71: {
# 1595
struct _tuple17 _tmp286=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp2E9);struct _tuple17 _tmp287=_tmp286;union Cyc_CfFlowInfo_FlowInfo _tmp2A2;void*_tmp2A1;_LL194: _tmp2A2=_tmp287.f1;_tmp2A1=_tmp287.f2;_LL195:;{
union Cyc_CfFlowInfo_FlowInfo _tmp288=_tmp2A2;struct Cyc_Dict_Dict _tmp2A0;struct Cyc_List_List*_tmp29F;if((_tmp288.BottomFL).tag == 1){_LL197: _LL198:
 return({struct _tuple17 _tmp5F4;_tmp5F4.f1=_tmp2A2,_tmp5F4.f2=_tmp119->unknown_all;_tmp5F4;});}else{_LL199: _tmp2A0=((_tmp288.ReachableFL).val).f1;_tmp29F=((_tmp288.ReachableFL).val).f2;_LL19A:
# 1599
...
void*_tmp28B=_tmp2A1;switch(*((int*)_tmp28B)){case 0U: _LL19C: _LL19D:
 return({struct _tuple17 _tmp5F5;_tmp5F5.f1=_tmp2A2,_tmp5F5.f2=_tmp119->unknown_all;_tmp5F5;});case 1U: _LL19E: _LL19F:
...
# 1619
struct _tuple17 _tmp28D=Cyc_NewControlFlow_anal_Rexp(env,1,_tmp2A2,_tmp2E8);struct _tuple17 _tmp28E=_tmp28D;union Cyc_CfFlowInfo_FlowInfo _tmp294;void*_tmp293;_LL1A5: _tmp294=_tmp28E.f1;_tmp293=_tmp28E.f2;_LL1A6:;
{union Cyc_CfFlowInfo_FlowInfo _tmp28F=_tmp294;struct Cyc_Dict_Dict _tmp292;if((_tmp28F.BottomFL).tag == 1){_LL1A8: _LL1A9:
 return({struct _tuple17 _tmp5F6;_tmp5F6.f1=_tmp294,_tmp5F6.f2=_tmp119->unknown_all;_tmp5F6;});}else{_LL1AA: _tmp292=((_tmp28F.ReachableFL).val).f1;_LL1AB:
# 1623
...
return({struct _tuple17 _tmp5F7;({union Cyc_CfFlowInfo_FlowInfo _tmp6EC=Cyc_CfFlowInfo_BottomFL();_tmp5F7.f1=_tmp6EC;}),_tmp5F7.f2=_tmp119->unknown_all;_tmp5F7;});}}_LL1A7:;}
# 1628
_tmp2A2=_tmp294;
...
struct _tuple17 _tmp296=Cyc_NewControlFlow_anal_Rexp(env,1,_tmp2A2,_tmp2E8);struct _tuple17 _tmp297=_tmp296;union Cyc_CfFlowInfo_FlowInfo _tmp29E;void*_tmp29D;_LL1AD: _tmp29E=_tmp297.f1;_tmp29D=_tmp297.f2;_LL1AE:;
...
return({struct _tuple17 _tmp5F9;({union Cyc_CfFlowInfo_FlowInfo _tmp6EF=Cyc_CfFlowInfo_BottomFL();_tmp5F9.f1=_tmp6EF;}),_tmp5F9.f2=_tmp119->unknown_all;_tmp5F9;});}}_LL1AF:;}{
# 1643
...
union Cyc_CfFlowInfo_FlowInfo outflow;
struct _tuple17 _tmp2A3=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp2ED);struct _tuple17 _tmp2A4=_tmp2A3;union Cyc_CfFlowInfo_FlowInfo _tmp2A8;_LL1B5: _tmp2A8=_tmp2A4.f1;_LL1B6:;
outflow=_tmp2A8;{
union Cyc_CfFlowInfo_FlowInfo _tmp2A5=outflow;struct Cyc_Dict_Dict _tmp2A7;struct Cyc_List_List*_tmp2A6;if((_tmp2A5.BottomFL).tag == 1){_LL1B8: _LL1B9:
 return({struct _tuple17 _tmp5FC;_tmp5FC.f1=outflow,_tmp5FC.f2=rval;_tmp5FC;});}else{_LL1BA: _tmp2A7=((_tmp2A5.ReachableFL).val).f1;_tmp2A6=((_tmp2A5.ReachableFL).val).f2;_LL1BB:
# 1669
 return({struct _tuple17 _tmp5FD;({union Cyc_CfFlowInfo_FlowInfo _tmp6F1=({struct Cyc_Dict_Dict _tmp6F0=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp2A7,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp6F0,_tmp2A6);});_tmp5FD.f1=_tmp6F1;}),_tmp5FD.f2=rval;_tmp5FD;});}_LL1B7:;};};}case 37U: _LL74: _tmp2EE=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL75: {
# 1673
struct _tuple18 _tmp2AC=({struct _tuple18 _tmp5FF;_tmp5FF.f1=(env->fenv)->unknown_all,_tmp5FF.f2=copy_ctxt;_tmp5FF;});
union Cyc_CfFlowInfo_FlowInfo _tmp2AD=Cyc_NewControlFlow_anal_stmt(env,inflow,_tmp2EE,& _tmp2AC);
return({struct _tuple17 _tmp5FE;_tmp5FE.f1=_tmp2AD,_tmp5FE.f2=_tmp2AC.f1;_tmp5FE;});}case 36U: _LL78: _LL79:
# 1678
 goto _LL7B;case 25U: _LL7A: _LL7B:
...
union Cyc_CfFlowInfo_FlowInfo _tmp2F2=f;struct Cyc_Dict_Dict _tmp312;struct Cyc_List_List*_tmp311;if((_tmp2F2.BottomFL).tag == 1){_LL6: _LL7:
 return({struct _tuple19 _tmp600;_tmp600.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp6F3=Cyc_CfFlowInfo_UnknownL();_tmp600.f2=_tmp6F3;});_tmp600;});}else{_LL8: _tmp312=((_tmp2F2.ReachableFL).val).f1;_tmp311=((_tmp2F2.ReachableFL).val).f2;_LL9: {
# 1709
struct _tuple16 _tmp2F3=Cyc_CfFlowInfo_unname_rval(r);struct _tuple16 _tmp2F4=_tmp2F3;void*_tmp310;struct Cyc_List_List*_tmp30F;_LLB: _tmp310=_tmp2F4.f1;_tmp30F=_tmp2F4.f2;_LLC:;
...
goto _LL1E;}_LL1E:;}
# 1735
if(Cyc_Tcutil_is_bound_one(_tmp315))return({struct _tuple19 _tmp601;_tmp601.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp6F9=Cyc_CfFlowInfo_UnknownL();_tmp601.f2=_tmp6F9;});_tmp601;});
...
return({struct _tuple19 _tmp602;_tmp602.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp6FC=Cyc_CfFlowInfo_PlaceL(({struct Cyc_CfFlowInfo_Place*_tmp2FF=_cycalloc(sizeof(*_tmp2FF));_tmp2FF->root=_tmp304,({struct Cyc_List_List*_tmp6FB=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp303,path);_tmp2FF->path=_tmp6FB;});_tmp2FF;}));_tmp602.f2=_tmp6FC;});_tmp602;});
goto _LLD;case 0U: _LL16: _LL17:
# 1744
 e->annot=(void*)& Cyc_CfFlowInfo_IsZero_val;
return({struct _tuple19 _tmp603;({union Cyc_CfFlowInfo_FlowInfo _tmp6FE=Cyc_CfFlowInfo_BottomFL();_tmp603.f1=_tmp6FE;}),({union Cyc_CfFlowInfo_AbsLVal _tmp6FD=Cyc_CfFlowInfo_UnknownL();_tmp603.f2=_tmp6FD;});_tmp603;});case 2U: _LL18: _tmp305=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp2F5)->f1;_LL19:
# 1749
 if(Cyc_Tcutil_is_bound_one(_tmp315))
...
struct _tuple16 _tmp307=Cyc_CfFlowInfo_unname_rval(_tmp310);struct _tuple16 _tmp308=_tmp307;void*_tmp30E;_LL24: _tmp30E=_tmp308.f1;_LL25:;{
...
{union Cyc_CfFlowInfo_FlowInfo _tmp31D=inflow;struct Cyc_Dict_Dict _tmp31F;struct Cyc_List_List*_tmp31E;if((_tmp31D.BottomFL).tag == 1){_LL1: _LL2:
 return({struct _tuple19 _tmp605;({union Cyc_CfFlowInfo_FlowInfo _tmp70A=Cyc_CfFlowInfo_BottomFL();_tmp605.f1=_tmp70A;}),({union Cyc_CfFlowInfo_AbsLVal _tmp709=Cyc_CfFlowInfo_UnknownL();_tmp605.f2=_tmp709;});_tmp605;});}else{_LL3: _tmp31F=((_tmp31D.ReachableFL).val).f1;_tmp31E=((_tmp31D.ReachableFL).val).f2;_LL4:
# 1800
 d=_tmp31F;}_LL0:;}{
# 1804
...
# 1835
struct _tuple19 _tmp32B=Cyc_NewControlFlow_anal_Lexp(env,inflow,expand_unique,passthrough_consumes,_tmp374);struct _tuple19 _tmp32C=_tmp32B;union Cyc_CfFlowInfo_FlowInfo _tmp34B;union Cyc_CfFlowInfo_AbsLVal _tmp34A;_LL24: _tmp34B=_tmp32C.f1;_tmp34A=_tmp32C.f2;_LL25:;{
struct _tuple19 _tmp32D=({struct _tuple19 _tmp60C;_tmp60C.f1=_tmp34B,_tmp60C.f2=_tmp34A;_tmp60C;});struct _tuple19 _tmp32E=_tmp32D;struct Cyc_Dict_Dict _tmp349;struct Cyc_List_List*_tmp348;struct Cyc_CfFlowInfo_Place*_tmp347;if(((_tmp32E.f1).ReachableFL).tag == 2){if(((_tmp32E.f2).PlaceL).tag == 1){_LL27: _tmp349=(((_tmp32E.f1).ReachableFL).val).f1;_tmp348=(((_tmp32E.f1).ReachableFL).val).f2;_tmp347=((_tmp32E.f2).PlaceL).val;_LL28: {
# 1838
void*_tmp32F=Cyc_CfFlowInfo_lookup_place(_tmp349,_tmp347);
struct _tuple16 _tmp330=Cyc_CfFlowInfo_unname_rval(_tmp32F);struct _tuple16 _tmp331=_tmp330;void*_tmp346;struct Cyc_List_List*_tmp345;_LL2C: _tmp346=_tmp331.f1;_tmp345=_tmp331.f2;_LL2D:;
if(expand_unique){
int _tmp332=1;
...
# 1852
struct _tuple19 _tmp336=Cyc_NewControlFlow_anal_derefL(env,_tmp34B,_tmp374,_tmp34B,_tmp32F,passthrough_consumes,0,path);struct _tuple19 _tmp337=_tmp336;union Cyc_CfFlowInfo_FlowInfo _tmp338;_LL3E: _tmp338=_tmp337.f1;_LL3F:;
return({struct _tuple19 _tmp609;_tmp609.f1=_tmp338,({union Cyc_CfFlowInfo_AbsLVal _tmp713=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(_tmp347,path));_tmp609.f2=_tmp713;});_tmp609;});}case 1U: _LL39: _LL3A:
# 1855
...
# 1875
struct _tuple19 _tmp33B=Cyc_NewControlFlow_anal_derefL(env,_tmp33A,_tmp374,_tmp33A,res,passthrough_consumes,_tmp332,path);struct _tuple19 _tmp33C=_tmp33B;union Cyc_CfFlowInfo_FlowInfo _tmp33D;_LL41: _tmp33D=_tmp33C.f1;_LL42:;
# 1877
return({struct _tuple19 _tmp60A;_tmp60A.f1=_tmp33D,({union Cyc_CfFlowInfo_AbsLVal _tmp717=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(_tmp347,path));_tmp60A.f2=_tmp717;});_tmp60A;});};}}_LL2E:;}else{
# 1881
...
# 1886
struct _tuple19 _tmp342=Cyc_NewControlFlow_anal_derefL(env,_tmp34B,_tmp374,_tmp34B,_tmp32F,passthrough_consumes,0,path);struct _tuple19 _tmp343=_tmp342;union Cyc_CfFlowInfo_FlowInfo _tmp344;_LL4B: _tmp344=_tmp343.f1;_LL4C:;
return({struct _tuple19 _tmp60B;_tmp60B.f1=_tmp344,({union Cyc_CfFlowInfo_AbsLVal _tmp718=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(_tmp347,path));_tmp60B.f2=_tmp718;});_tmp60B;});}default: _LL48: _LL49:
# 1890
 goto _LL43;}_LL43:;}
# 1893
goto _LL26;}}else{goto _LL29;}}else{_LL29: _LL2A:
 goto _LL26;}_LL26:;};}{
# 1898
struct _tuple17 _tmp34C=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,_tmp374);struct _tuple17 _tmp34D=_tmp34C;union Cyc_CfFlowInfo_FlowInfo _tmp34F;void*_tmp34E;_LL4E: _tmp34F=_tmp34D.f1;_tmp34E=_tmp34D.f2;_LL4F:;
# 1900
...
goto _LL5A;};}else{_LL5D: _LL5E:
 goto _LL5A;}_LL5A:;}{
# 1922
struct _tuple19 _tmp35E=Cyc_NewControlFlow_anal_derefL(env,inflow,_tmp376,_tmp364,(void*)((struct Cyc_List_List*)_check_null(_tmp363))->hd,passthrough_consumes,0,path);struct _tuple19 _tmp35F=_tmp35E;union Cyc_CfFlowInfo_FlowInfo _tmp362;union Cyc_CfFlowInfo_AbsLVal _tmp361;_LL60: _tmp362=_tmp35F.f1;_tmp361=_tmp35F.f2;_LL61:;{
union Cyc_CfFlowInfo_FlowInfo _tmp360=_tmp362;if((_tmp360.BottomFL).tag == 1){_LL63: _LL64:
 return({struct _tuple19 _tmp60D;_tmp60D.f1=_tmp362,_tmp60D.f2=_tmp361;_tmp60D;});}else{_LL65: _LL66:
 return({struct _tuple19 _tmp60E;_tmp60E.f1=_tmp357,_tmp60E.f2=_tmp361;_tmp60E;});}_LL62:;};};};}default: _LL55: _LL56:
# 1927
...
# 1950
struct _tuple19 _tmp379=Cyc_NewControlFlow_anal_Lexp_rec(env,inflow,expand_unique,passthrough_consumes,e,0);struct _tuple19 _tmp37A=_tmp379;union Cyc_CfFlowInfo_FlowInfo _tmp37C;union Cyc_CfFlowInfo_AbsLVal _tmp37B;_LL1: _tmp37C=_tmp37A.f1;_tmp37B=_tmp37A.f2;_LL2:;
return({struct _tuple19 _tmp611;_tmp611.f1=_tmp37C,_tmp611.f2=_tmp37B;_tmp611;});}
# 1957
...
# 1967
struct _tuple19 _tmp37D=Cyc_NewControlFlow_anal_Lexp(env,inflow,1,0,(struct Cyc_Absyn_Exp*)x->hd);struct _tuple19 _tmp37E=_tmp37D;union Cyc_CfFlowInfo_FlowInfo _tmp37F;_LL1: _tmp37F=_tmp37E.f1;_LL2:;
inflow=_tmp37F;}}}
# 1972
...
# 1983
struct _tuple17 _tmp381=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd);struct _tuple17 _tmp382=_tmp381;union Cyc_CfFlowInfo_FlowInfo _tmp3BF;void*_tmp3BE;_LL1: _tmp3BF=_tmp382.f1;_tmp3BE=_tmp382.f2;_LL2:;{
struct _tuple17 _tmp383=Cyc_NewControlFlow_anal_Rexp(env,0,_tmp3BF,(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es->tl))->hd);struct _tuple17 _tmp384=_tmp383;union Cyc_CfFlowInfo_FlowInfo _tmp3BD;void*_tmp3BC;_LL4: _tmp3BD=_tmp384.f1;_tmp3BC=_tmp384.f2;_LL5:;{
...
union Cyc_CfFlowInfo_FlowInfo _tmp386=_tmp385;struct Cyc_Dict_Dict _tmp3BB;struct Cyc_List_List*_tmp3BA;if((_tmp386.BottomFL).tag == 1){_LL7: _LL8:
 return({struct _tuple20 _tmp612;_tmp612.f1=_tmp385,_tmp612.f2=_tmp385;_tmp612;});}else{_LL9: _tmp3BB=((_tmp386.ReachableFL).val).f1;_tmp3BA=((_tmp386.ReachableFL).val).f2;_LLA: {
# 1991
...
struct _tuple16 _tmp38F=Cyc_CfFlowInfo_unname_rval(_tmp3BE);struct _tuple16 _tmp390=_tmp38F;void*_tmp3A8;struct Cyc_List_List*_tmp3A7;_LLC: _tmp3A8=_tmp390.f1;_tmp3A7=_tmp390.f2;_LLD:;{
struct _tuple16 _tmp391=Cyc_CfFlowInfo_unname_rval(_tmp3BC);struct _tuple16 _tmp392=_tmp391;void*_tmp3A6;struct Cyc_List_List*_tmp3A5;_LLF: _tmp3A6=_tmp392.f1;_tmp3A5=_tmp392.f2;_LL10:;{
...
# 2008
struct _tuple20 _tmp395=Cyc_NewControlFlow_splitzero(env,inflow,_tmp385,_tmp387,_tmp3A3,_tmp3A7);struct _tuple20 _tmp396=_tmp395;union Cyc_CfFlowInfo_FlowInfo _tmp39B;union Cyc_CfFlowInfo_FlowInfo _tmp39A;_LL23: _tmp39B=_tmp396.f1;_tmp39A=_tmp396.f2;_LL24:;
...
# 2016
struct _tuple20 _tmp39C=Cyc_NewControlFlow_splitzero(env,_tmp3BD,_tmp385,_tmp388,_tmp3A4,_tmp3A5);struct _tuple20 _tmp39D=_tmp39C;union Cyc_CfFlowInfo_FlowInfo _tmp3A2;union Cyc_CfFlowInfo_FlowInfo _tmp3A1;_LL2D: _tmp3A2=_tmp39D.f1;_tmp3A1=_tmp39D.f2;_LL2E:;
...
goto _LL11;}else{goto _LL20;}default: _LL20: _LL21:
 goto _LL11;}_LL11:;};};}
# 2043
{struct _tuple28 _tmp3A9=({struct _tuple28 _tmp615;_tmp615.f1=p,({
...
# 2043
struct _tuple28 _tmp3AA=_tmp3A9;switch(_tmp3AA.f1){case Cyc_Absyn_Eq: _LL37: _LL38:
# 2046
...
# 2051
 ...
 return({struct _tuple20 _tmp614;_tmp614.f1=_tmp38D,_tmp614.f2=_tmp38E;_tmp614;});}}}_LL36:;}
# 2056
{enum Cyc_Absyn_Primop _tmp3AB=p;switch(_tmp3AB){case Cyc_Absyn_Eq: _LL46: _LL47:
 ...
 return({struct _tuple20 _tmp616;_tmp616.f1=_tmp38D,_tmp616.f2=_tmp38E;_tmp616;});}_LL45:;}{
# 2061
...
struct _tuple20 _tmp3B1=({struct _tuple20 _tmp61B;_tmp61B.f1=_tmp38D,_tmp61B.f2=_tmp38E;_tmp61B;});struct _tuple20 _tmp3B2=_tmp3B1;struct Cyc_Dict_Dict _tmp3B6;struct Cyc_Dict_Dict _tmp3B5;struct Cyc_Dict_Dict _tmp3B4;struct Cyc_Dict_Dict _tmp3B3;if(((_tmp3B2.f1).ReachableFL).tag == 2){if(((_tmp3B2.f2).ReachableFL).tag == 2){_LL58: _tmp3B4=(((_tmp3B2.f1).ReachableFL).val).f1;_tmp3B3=(((_tmp3B2.f2).ReachableFL).val).f1;_LL59:
# 2075
 return({struct _tuple20 _tmp617;({union Cyc_CfFlowInfo_FlowInfo _tmp73B=Cyc_CfFlowInfo_ReachableFL(_tmp3B4,_tmp3AF);_tmp617.f1=_tmp73B;}),({union Cyc_CfFlowInfo_FlowInfo _tmp73A=Cyc_CfFlowInfo_ReachableFL(_tmp3B3,_tmp3B0);_tmp617.f2=_tmp73A;});_tmp617;});}else{_LL5C: _tmp3B5=(((_tmp3B2.f1).ReachableFL).val).f1;_LL5D:
# 2079
 return({struct _tuple20 _tmp618;({union Cyc_CfFlowInfo_FlowInfo _tmp73C=Cyc_CfFlowInfo_ReachableFL(_tmp3B5,_tmp3AF);_tmp618.f1=_tmp73C;}),_tmp618.f2=_tmp38E;_tmp618;});}}else{if(((_tmp3B2.f2).ReachableFL).tag == 2){_LL5A: _tmp3B6=(((_tmp3B2.f2).ReachableFL).val).f1;_LL5B:
# 2077
 return({struct _tuple20 _tmp619;_tmp619.f1=_tmp38D,({union Cyc_CfFlowInfo_FlowInfo _tmp73D=Cyc_CfFlowInfo_ReachableFL(_tmp3B6,_tmp3B0);_tmp619.f2=_tmp73D;});_tmp619;});}else{_LL5E: _LL5F:
# 2081
 return({struct _tuple20 _tmp61A;_tmp61A.f1=_tmp38D,_tmp61A.f2=_tmp38E;_tmp61A;});}}_LL57:;}else{
# 2084
return({struct _tuple20 _tmp61C;_tmp61C.f1=_tmp38D,_tmp61C.f2=_tmp38E;_tmp61C;});}};};};}}_LL6:;};};}
# 2090
...
# 2094
struct _tuple20 _tmp3C3=Cyc_NewControlFlow_anal_test(env,inflow,_tmp3FD);struct _tuple20 _tmp3C4=_tmp3C3;union Cyc_CfFlowInfo_FlowInfo _tmp3CE;union Cyc_CfFlowInfo_FlowInfo _tmp3CD;_LL10: _tmp3CE=_tmp3C4.f1;_tmp3CD=_tmp3C4.f2;_LL11:;{
struct _tuple20 _tmp3C5=Cyc_NewControlFlow_anal_test(env,_tmp3CE,_tmp3FC);struct _tuple20 _tmp3C6=_tmp3C5;union Cyc_CfFlowInfo_FlowInfo _tmp3CC;union Cyc_CfFlowInfo_FlowInfo _tmp3CB;_LL13: _tmp3CC=_tmp3C6.f1;_tmp3CB=_tmp3C6.f2;_LL14:;{
struct _tuple20 _tmp3C7=Cyc_NewControlFlow_anal_test(env,_tmp3CD,_tmp3FB);struct _tuple20 _tmp3C8=_tmp3C7;union Cyc_CfFlowInfo_FlowInfo _tmp3CA;union Cyc_CfFlowInfo_FlowInfo _tmp3C9;_LL16: _tmp3CA=_tmp3C8.f1;_tmp3C9=_tmp3C8.f2;_LL17:;
return({struct _tuple20 _tmp61D;({union Cyc_CfFlowInfo_FlowInfo _tmp73F=Cyc_CfFlowInfo_join_flow(_tmp3C0,_tmp3CC,_tmp3CA);_tmp61D.f1=_tmp73F;}),({
...
# 2100
struct _tuple20 _tmp3CF=Cyc_NewControlFlow_anal_test(env,inflow,_tmp3FF);struct _tuple20 _tmp3D0=_tmp3CF;union Cyc_CfFlowInfo_FlowInfo _tmp3D6;union Cyc_CfFlowInfo_FlowInfo _tmp3D5;_LL19: _tmp3D6=_tmp3D0.f1;_tmp3D5=_tmp3D0.f2;_LL1A:;{
struct _tuple20 _tmp3D1=Cyc_NewControlFlow_anal_test(env,_tmp3D6,_tmp3FE);struct _tuple20 _tmp3D2=_tmp3D1;union Cyc_CfFlowInfo_FlowInfo _tmp3D4;union Cyc_CfFlowInfo_FlowInfo _tmp3D3;_LL1C: _tmp3D4=_tmp3D2.f1;_tmp3D3=_tmp3D2.f2;_LL1D:;
return({struct _tuple20 _tmp61E;_tmp61E.f1=_tmp3D4,({union Cyc_CfFlowInfo_FlowInfo _tmp740=Cyc_CfFlowInfo_join_flow(_tmp3C0,_tmp3D5,_tmp3D3);_tmp61E.f2=_tmp740;});_tmp61E;});};}case 8U: _LL5: _tmp401=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp3C2)->f1;_tmp400=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp3C2)->f2;_LL6: {
# 2104
struct _tuple20 _tmp3D7=Cyc_NewControlFlow_anal_test(env,inflow,_tmp401);struct _tuple20 _tmp3D8=_tmp3D7;union Cyc_CfFlowInfo_FlowInfo _tmp3DE;union Cyc_CfFlowInfo_FlowInfo _tmp3DD;_LL1F: _tmp3DE=_tmp3D8.f1;_tmp3DD=_tmp3D8.f2;_LL20:;{
struct _tuple20 _tmp3D9=Cyc_NewControlFlow_anal_test(env,_tmp3DD,_tmp400);struct _tuple20 _tmp3DA=_tmp3D9;union Cyc_CfFlowInfo_FlowInfo _tmp3DC;union Cyc_CfFlowInfo_FlowInfo _tmp3DB;_LL22: _tmp3DC=_tmp3DA.f1;_tmp3DB=_tmp3DA.f2;_LL23:;
return({struct _tuple20 _tmp61F;({union Cyc_CfFlowInfo_FlowInfo _tmp741=Cyc_CfFlowInfo_join_flow(_tmp3C0,_tmp3DE,_tmp3DC);_tmp61F.f1=_tmp741;}),_tmp61F.f2=_tmp3DB;_tmp61F;});};}case 9U: _LL7: _tmp403=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp3C2)->f1;_tmp402=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp3C2)->f2;_LL8: {
# 2108
struct _tuple17 _tmp3DF=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,_tmp403);struct _tuple17 _tmp3E0=_tmp3DF;union Cyc_CfFlowInfo_FlowInfo _tmp3E2;void*_tmp3E1;_LL25: _tmp3E2=_tmp3E0.f1;_tmp3E1=_tmp3E0.f2;_LL26:;
...
# 2111
struct _tuple20 _tmp3E3=Cyc_NewControlFlow_anal_test(env,inflow,_tmp404);struct _tuple20 _tmp3E4=_tmp3E3;union Cyc_CfFlowInfo_FlowInfo _tmp3E6;union Cyc_CfFlowInfo_FlowInfo _tmp3E5;_LL28: _tmp3E6=_tmp3E4.f1;_tmp3E5=_tmp3E4.f2;_LL29:;
return({struct _tuple20 _tmp620;_tmp620.f1=_tmp3E5,_tmp620.f2=_tmp3E6;_tmp620;});}}else{goto _LLB;}}else{goto _LLB;}}else{_LLB: _tmp406=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp3C2)->f1;_tmp405=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp3C2)->f2;_LLC:
# 2114
 return Cyc_NewControlFlow_anal_primop_test(env,inflow,_tmp406,_tmp405);}default: _LLD: _LLE: {
# 2118
struct _tuple17 _tmp3E7=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e);struct _tuple17 _tmp3E8=_tmp3E7;union Cyc_CfFlowInfo_FlowInfo _tmp3FA;void*_tmp3F9;_LL2B: _tmp3FA=_tmp3E8.f1;_tmp3F9=_tmp3E8.f2;_LL2C:;{
union Cyc_CfFlowInfo_FlowInfo _tmp3E9=_tmp3FA;struct Cyc_Dict_Dict _tmp3F8;if((_tmp3E9.BottomFL).tag == 1){_LL2E: _LL2F:
 return({struct _tuple20 _tmp621;_tmp621.f1=_tmp3FA,_tmp621.f2=_tmp3FA;_tmp621;});}else{_LL30: _tmp3F8=((_tmp3E9.ReachableFL).val).f1;_LL31: {
# 2122
struct _tuple16 _tmp3EA=Cyc_CfFlowInfo_unname_rval(_tmp3F9);struct _tuple16 _tmp3EB=_tmp3EA;void*_tmp3F7;struct Cyc_List_List*_tmp3F6;_LL33: _tmp3F7=_tmp3EB.f1;_tmp3F6=_tmp3EB.f2;_LL34:;{
...
({void*_tmp3ED=0U;({struct _fat_ptr _tmp742=({const char*_tmp3EE="anal_test: bad namedlocation";_tag_fat(_tmp3EE,sizeof(char),29U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp742,_tag_fat(_tmp3ED,sizeof(void*),0U));});});case 0U: _LL38: _LL39:
 return({struct _tuple20 _tmp622;({union Cyc_CfFlowInfo_FlowInfo _tmp743=Cyc_CfFlowInfo_BottomFL();_tmp622.f1=_tmp743;}),_tmp622.f2=_tmp3FA;_tmp622;});case 1U: _LL3A: _LL3B:
 goto _LL3D;case 5U: _LL3C: _LL3D:
 goto _LL3F;case 4U: _LL3E: _LL3F:
 return({struct _tuple20 _tmp623;_tmp623.f1=_tmp3FA,({union Cyc_CfFlowInfo_FlowInfo _tmp744=Cyc_CfFlowInfo_BottomFL();_tmp623.f2=_tmp744;});_tmp623;});case 2U: if(((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp3EC)->f1 == Cyc_CfFlowInfo_NoneIL){_LL40: _LL41:
...
# 2136
 return({struct _tuple20 _tmp624;_tmp624.f1=_tmp3FA,_tmp624.f2=_tmp3FA;_tmp624;});}case 7U: _LL44: _LL45:
# 2133
...
# 2137
({void*_tmp3F1=0U;({struct _fat_ptr _tmp749=({const char*_tmp3F2="anal_test";_tag_fat(_tmp3F2,sizeof(char),10U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp749,_tag_fat(_tmp3F1,sizeof(void*),0U));});});}_LL35:;};}}_LL2D:;};}}_LL0:;}struct _tuple29{unsigned f1;struct Cyc_NewControlFlow_AnalEnv*f2;struct Cyc_Dict_Dict f3;};
# 2143
static void Cyc_NewControlFlow_check_for_unused_unique(struct _tuple29*ckenv,void*root,void*rval){
# 2145
struct _tuple29*_tmp407=ckenv;unsigned _tmp413;struct Cyc_NewControlFlow_AnalEnv*_tmp412;struct Cyc_Dict_Dict _tmp411;_LL1: _tmp413=_tmp407->f1;_tmp412=_tmp407->f2;_tmp411=_tmp407->f3;_LL2:;{
...
struct _tuple16 _tmp409=Cyc_CfFlowInfo_unname_rval(rval);struct _tuple16 _tmp40A=_tmp409;void*_tmp40F;_LL9: _tmp40F=_tmp40A.f1;_LLA:;{
...
# 2172
if(Cyc_NewControlFlow_warn_lose_unique){
struct _tuple29 _tmp418=({struct _tuple29 _tmp627;_tmp627.f1=loc,_tmp627.f2=env,_tmp627.f3=_tmp419;_tmp627;});
((void(*)(void(*f)(struct _tuple29*,void*,void*),struct _tuple29*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_NewControlFlow_check_for_unused_unique,& _tmp418,_tmp419);}
# 2176
return;}_LL0:;}
# 2185
...
{struct Cyc_List_List*x=vds;for(0;x != 0;x=x->tl){
struct _tuple25*_tmp41C=(struct _tuple25*)x->hd;struct _tuple25*_tmp41D=_tmp41C;struct Cyc_Absyn_Vardecl**_tmp425;struct Cyc_Absyn_Exp*_tmp424;_LL1: _tmp425=_tmp41D->f1;_tmp424=_tmp41D->f2;_LL2:;
...
# 2199
return({struct _tuple1 _tmp628;_tmp628.f1=_tmp41A,_tmp628.f2=_tmp41B;_tmp628;});}struct _tuple30{int f1;void*f2;};
# 2205
...
goto _LL5;}_LL5:;}
# 2274
return({struct _tuple30 _tmp62C;_tmp62C.f1=varok,_tmp62C.f2=_tmp42D;_tmp62C;});}}_LL0:;}
# 2280
...
# 2314
struct _tuple19 _tmp445=Cyc_NewControlFlow_anal_Lexp(env,flow,0,1,unconsume_exp);struct _tuple19 _tmp446=_tmp445;union Cyc_CfFlowInfo_FlowInfo _tmp45A;union Cyc_CfFlowInfo_AbsLVal _tmp459;_LL6: _tmp45A=_tmp446.f1;_tmp459=_tmp446.f2;_LL7:;
# 2317
...
if(ropt != 0){
# 2344
struct _tuple17 _tmp44A=({
struct Cyc_CfFlowInfo_FlowEnv*_tmp75E=env->fenv;struct _tuple17 _tmp75D=({struct _tuple17 _tmp62D;_tmp62D.f1=_tmp45A,_tmp62D.f2=_tmp448;_tmp62D;});Cyc_CfFlowInfo_join_flow_and_rval(_tmp75E,_tmp75D,({struct _tuple17 _tmp62E;_tmp62E.f1=_tmp45A,_tmp62E.f2=ropt;_tmp62E;}));});
# 2344
struct _tuple17 _tmp44B=_tmp44A;union Cyc_CfFlowInfo_FlowInfo _tmp44D;void*_tmp44C;_LL13: _tmp44D=_tmp44B.f1;_tmp44C=_tmp44B.f2;_LL14:;
# 2348
...
# 2439
struct _tuple30 _tmp463=_tmp462;int _tmp465;void*_tmp464;_LL6: _tmp465=_tmp463.f1;_tmp464=_tmp463.f2;_LL7:;
# 2445
if(_tmp45D)
...
({struct _tuple31*_tmp764=({struct _tuple31*_tmp46C=_cycalloc(sizeof(*_tmp46C));_tmp46C->f1=0,_tmp46C->f2=_tmp47A,_tmp46C->f3=_tmp478,_tmp46C->f4=_tmp477;_tmp46C;});_tmp46D->hd=_tmp764;}),_tmp46D->tl=_tmp46B;_tmp46D;});
# 2466
env->unique_pat_vars=_tmp765;});
# 2469
if(_tmp47B != 0){
struct Cyc_Absyn_Exp*wexp=_tmp47B;
struct _tuple20 _tmp46E=Cyc_NewControlFlow_anal_test(env,clause_inflow,wexp);struct _tuple20 _tmp46F=_tmp46E;union Cyc_CfFlowInfo_FlowInfo _tmp471;union Cyc_CfFlowInfo_FlowInfo _tmp470;_LL7: _tmp471=_tmp46F.f1;_tmp470=_tmp46F.f2;_LL8:;
inflow=_tmp470;
...
# 2506
struct _tuple32*_tmp47D=vdenv;struct Cyc_NewControlFlow_AnalEnv*_tmp488;struct Cyc_Dict_Dict _tmp487;unsigned _tmp486;_LL1: _tmp488=_tmp47D->f1;_tmp487=_tmp47D->f2;_tmp486=_tmp47D->f3;_LL2:;
if(Cyc_Tcutil_is_noalias_pointer_or_aggr(vd->type)){
# 2509
...
struct _tuple16 _tmp47E=Cyc_CfFlowInfo_unname_rval(({struct Cyc_Dict_Dict _tmp76A=_tmp487;((void*(*)(struct Cyc_Dict_Dict d,int(*cmp)(void*,void*),void*k))Cyc_Dict_lookup_other)(_tmp76A,Cyc_CfFlowInfo_root_cmp,(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp485=_cycalloc(sizeof(*_tmp485));*_tmp485=vdroot;_tmp485;}));}));struct _tuple16 _tmp47F=_tmp47E;void*_tmp484;_LL4: _tmp484=_tmp47F.f1;_LL5:;{
...
# 2526
struct _tuple32 _tmp48A=({struct _tuple32 _tmp633;_tmp633.f1=env,_tmp633.f2=_tmp495,_tmp633.f3=decl->loc;_tmp633;});
...
# 2537
((void(*)(void(*f)(struct _tuple32*,struct Cyc_Absyn_Vardecl*),struct _tuple32*env,struct Cyc_List_List*x))Cyc_List_iter_c)(Cyc_NewControlFlow_check_dropped_unique_vd,& _tmp48A,_tmp494);
...
struct _tuple31*_tmp496=(struct _tuple31*)((struct Cyc_List_List*)_check_null(x))->hd;struct _tuple31*_tmp497=_tmp496;int _tmp49B;struct Cyc_Absyn_Stmt*_tmp49A;struct Cyc_List_List*_tmp499;struct Cyc_List_List*_tmp498;_LL1: _tmp49B=_tmp497->f1;_tmp49A=_tmp497->f2;_tmp499=_tmp497->f3;_tmp498=_tmp497->f4;_LL2:;
...
# 2567
union Cyc_CfFlowInfo_FlowInfo outflow;
struct _tuple21 _tmp49C=Cyc_NewControlFlow_pre_stmt_check(env,inflow,s);struct _tuple21 _tmp49D=_tmp49C;struct Cyc_NewControlFlow_CFStmtAnnot*_tmp537;union Cyc_CfFlowInfo_FlowInfo*_tmp536;_LL1: _tmp537=_tmp49D.f1;_tmp536=_tmp49D.f2;_LL2:;
inflow=*_tmp536;{
...
struct _tuple17 _tmp4A5=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,(struct Cyc_Absyn_Exp*)_check_null(_tmp510));struct _tuple17 _tmp4A6=_tmp4A5;union Cyc_CfFlowInfo_FlowInfo _tmp4A8;void*_tmp4A7;_LL2D: _tmp4A8=_tmp4A6.f1;_tmp4A7=_tmp4A6.f2;_LL2E:;
...
# 2593
struct _tuple18*_tmp4A9=rval_opt;void**_tmp4AF;int _tmp4AE;if(_tmp4A9 != 0){_LL30: _tmp4AF=(void**)& _tmp4A9->f1;_tmp4AE=_tmp4A9->f2;_LL31: {
# 2595
struct _tuple17 _tmp4AA=Cyc_NewControlFlow_anal_Rexp(env,_tmp4AE,inflow,_tmp511);struct _tuple17 _tmp4AB=_tmp4AA;union Cyc_CfFlowInfo_FlowInfo _tmp4AD;void*_tmp4AC;_LL35: _tmp4AD=_tmp4AB.f1;_tmp4AC=_tmp4AB.f2;_LL36:;
*_tmp4AF=_tmp4AC;
...
# 2606
struct _tuple20 _tmp4B0=Cyc_NewControlFlow_anal_test(env,inflow,_tmp516);struct _tuple20 _tmp4B1=_tmp4B0;union Cyc_CfFlowInfo_FlowInfo _tmp4B5;union Cyc_CfFlowInfo_FlowInfo _tmp4B4;_LL38: _tmp4B5=_tmp4B1.f1;_tmp4B4=_tmp4B1.f2;_LL39:;{
# 2613
...
# 2621
struct _tuple21 _tmp4B6=Cyc_NewControlFlow_pre_stmt_check(env,inflow,_tmp518);struct _tuple21 _tmp4B7=_tmp4B6;union Cyc_CfFlowInfo_FlowInfo*_tmp4BE;_LL3B: _tmp4BE=_tmp4B7.f2;_LL3C:;{
union Cyc_CfFlowInfo_FlowInfo _tmp4B8=*_tmp4BE;
struct _tuple20 _tmp4B9=Cyc_NewControlFlow_anal_test(env,_tmp4B8,_tmp519);struct _tuple20 _tmp4BA=_tmp4B9;union Cyc_CfFlowInfo_FlowInfo _tmp4BD;union Cyc_CfFlowInfo_FlowInfo _tmp4BC;_LL3E: _tmp4BD=_tmp4BA.f1;_tmp4BC=_tmp4BA.f2;_LL3F:;{
...
struct _tuple21 _tmp4C0=Cyc_NewControlFlow_pre_stmt_check(env,_tmp4BF,_tmp51A);struct _tuple21 _tmp4C1=_tmp4C0;union Cyc_CfFlowInfo_FlowInfo*_tmp4C7;_LL41: _tmp4C7=_tmp4C1.f2;_LL42:;{
union Cyc_CfFlowInfo_FlowInfo _tmp4C2=*_tmp4C7;
struct _tuple20 _tmp4C3=Cyc_NewControlFlow_anal_test(env,_tmp4C2,_tmp51B);struct _tuple20 _tmp4C4=_tmp4C3;union Cyc_CfFlowInfo_FlowInfo _tmp4C6;union Cyc_CfFlowInfo_FlowInfo _tmp4C5;_LL44: _tmp4C6=_tmp4C4.f1;_tmp4C5=_tmp4C4.f2;_LL45:;
...
struct _tuple21 _tmp4C9=Cyc_NewControlFlow_pre_stmt_check(env,_tmp4C8,_tmp520);struct _tuple21 _tmp4CA=_tmp4C9;union Cyc_CfFlowInfo_FlowInfo*_tmp4D6;_LL47: _tmp4D6=_tmp4CA.f2;_LL48:;{
union Cyc_CfFlowInfo_FlowInfo _tmp4CB=*_tmp4D6;
struct _tuple20 _tmp4CC=Cyc_NewControlFlow_anal_test(env,_tmp4CB,_tmp521);struct _tuple20 _tmp4CD=_tmp4CC;union Cyc_CfFlowInfo_FlowInfo _tmp4D5;union Cyc_CfFlowInfo_FlowInfo _tmp4D4;_LL4A: _tmp4D5=_tmp4CD.f1;_tmp4D4=_tmp4CD.f2;_LL4B:;{
union Cyc_CfFlowInfo_FlowInfo _tmp4CE=Cyc_NewControlFlow_anal_stmt(env,_tmp4D5,_tmp51D,0);
struct _tuple21 _tmp4CF=Cyc_NewControlFlow_pre_stmt_check(env,_tmp4CE,_tmp51E);struct _tuple21 _tmp4D0=_tmp4CF;union Cyc_CfFlowInfo_FlowInfo*_tmp4D3;_LL4D: _tmp4D3=_tmp4D0.f2;_LL4E:;{
...
# 2652
struct _tuple24 _tmp4D7=Cyc_NewControlFlow_anal_Rexps(env,inflow,_tmp524,1,1);struct _tuple24 _tmp4D8=_tmp4D7;union Cyc_CfFlowInfo_FlowInfo _tmp4DF;struct Cyc_List_List*_tmp4DE;_LL50: _tmp4DF=_tmp4D8.f1;_tmp4DE=_tmp4D8.f2;_LL51:;
# 2654
...
struct _tuple25*_tmp4DA=(struct _tuple25*)x->hd;struct _tuple25*_tmp4DB=_tmp4DA;struct Cyc_Absyn_Vardecl**_tmp4DD;struct Cyc_Absyn_Exp*_tmp4DC;_LL53: _tmp4DD=_tmp4DB->f1;_tmp4DC=_tmp4DB->f2;_LL54:;
if(_tmp4DD != 0){
...
({struct _tuple31*_tmp786=({struct _tuple31*_tmp4F0=_cycalloc(sizeof(*_tmp4F0));_tmp4F0->f1=0,_tmp4F0->f2=s,_tmp4F0->f3=_tmp4F3,_tmp4F0->f4=_tmp4F2;_tmp4F0;});_tmp4F1->hd=_tmp786;}),_tmp4F1->tl=_tmp4EF;_tmp4F1;});
# 2745
...
struct _tuple19 _tmp4F5=Cyc_NewControlFlow_anal_Lexp(env,_tmp4F4,0,0,_tmp531);struct _tuple19 _tmp4F6=_tmp4F5;union Cyc_CfFlowInfo_AbsLVal _tmp50D;_LL63: _tmp50D=_tmp4F6.f2;_LL64:;{
struct _tuple17 _tmp4F7=Cyc_NewControlFlow_anal_Rexp(env,1,_tmp4F4,_tmp531);struct _tuple17 _tmp4F8=_tmp4F7;union Cyc_CfFlowInfo_FlowInfo _tmp50C;_LL66: _tmp50C=_tmp4F8.f1;_LL67:;{
...
if(_tmp53C == 0)
return inflow;{
struct _tuple17 _tmp53D=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp53C);struct _tuple17 _tmp53E=_tmp53D;union Cyc_CfFlowInfo_FlowInfo _tmp540;void*_tmp53F;_LLC: _tmp540=_tmp53E.f1;_tmp53F=_tmp53E.f2;_LLD:;
...
struct _tuple15 _tmp568=({union Cyc_CfFlowInfo_FlowInfo _tmp590=inflow;if((_tmp590.ReachableFL).tag != 2)_throw_match();(_tmp590.ReachableFL).val;});struct _tuple15 _tmp569=_tmp568;struct Cyc_Dict_Dict _tmp58F;struct Cyc_List_List*_tmp58E;_LL1: _tmp58F=_tmp569.f1;_tmp58E=_tmp569.f2;_LL2:;{
# 2956
