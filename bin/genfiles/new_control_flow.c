...
void Cyc_NewControlFlow_cf_check(struct Cyc_JumpAnalysis_Jump_Anal_Result*tables,struct Cyc_List_List*);extern char Cyc_Tcenv_Env_error[10U];struct Cyc_Tcenv_Env_error_exn_struct{char*tag;};struct Cyc_Tcenv_Genv{struct Cyc_Dict_Dict aggrdecls;struct Cyc_Dict_Dict datatypedecls;struct Cyc_Dict_Dict enumdecls;struct Cyc_Dict_Dict typedefs;struct Cyc_Dict_Dict ordinaries;};struct Cyc_Tcenv_Fenv;struct Cyc_Tcenv_Tenv{struct Cyc_List_List*ns;struct Cyc_Tcenv_Genv*ae;struct Cyc_Tcenv_Fenv*le;int allow_valueof: 1;int in_extern_c_include: 1;int in_tempest: 1;int tempest_generalize: 1;int in_extern_c_inc_repeat: 1;};
# 89 "tcenv.h"
...
({void*_tmp63A=(void*)({struct Cyc_NewControlFlow_CFAnnot_Absyn_AbsynAnnot_struct*_tmp3=_cycalloc(sizeof(*_tmp3));_tmp3->tag=Cyc_NewControlFlow_CFAnnot,(_tmp3->f1).visited=0;_tmp3;});s->annot=_tmp63A;});return Cyc_NewControlFlow_get_stmt_annot(s);}_LL0:;}
# 142
...
if(sflow == 0){
union Cyc_CfFlowInfo_FlowInfo*res=({union Cyc_CfFlowInfo_FlowInfo*_tmp4=_cycalloc(sizeof(*_tmp4));({union Cyc_CfFlowInfo_FlowInfo _tmp63B=Cyc_CfFlowInfo_BottomFL();*_tmp4=_tmp63B;});_tmp4;});
...
# 163
({union Cyc_CfFlowInfo_FlowInfo _tmp63C=Cyc_CfFlowInfo_join_flow(env->fenv,inflow,*sflow);*sflow=_tmp63C;});
# 169
annot->visited=env->iteration_num;
return({struct _tuple21 _tmp598;_tmp598.f1=annot,_tmp598.f2=sflow;_tmp598;});}
# 179
...
if(env->in_try)
# 187
({union Cyc_CfFlowInfo_FlowInfo _tmp63D=Cyc_CfFlowInfo_join_flow(env->fenv,new_flow,env->tryflow);env->tryflow=_tmp63D;});}struct _tuple22{struct Cyc_NewControlFlow_AnalEnv*f1;unsigned f2;struct Cyc_Dict_Dict f3;};
# 194
...
# 208
({struct Cyc_String_pa_PrintArg_struct _tmp13=({struct Cyc_String_pa_PrintArg_struct _tmp599;_tmp599.tag=0U,({struct _fat_ptr _tmp63E=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp599.f1=_tmp63E;});_tmp599;});void*_tmp11[1U];_tmp11[0]=& _tmp13;({unsigned _tmp640=loc;struct _fat_ptr _tmp63F=({const char*_tmp12="alias-free pointer(s) reachable from %s may become unreachable.";_tag_fat(_tmp12,sizeof(char),64U);});Cyc_Warn_warn(_tmp640,_tmp63F,_tag_fat(_tmp11,sizeof(void*),1U));});});
goto _LL8;}_LL8:;}}
# 212
...
{struct Cyc_Absyn_Exp*_tmp33=({struct _RegionHandle*_tmp642=temp;struct Cyc_List_List*_tmp641=((struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rzip)(temp,temp,ad->tvs,ts);Cyc_Tcutil_rsubsexp(_tmp642,_tmp641,req);});struct Cyc_Absyn_Exp*ireq=_tmp33;
# 308
if(!({struct Cyc_List_List*_tmp643=relns;Cyc_NewControlFlow_relns_ok(_tmp643,Cyc_Relations_exp2relns(temp,ireq));})){
({struct Cyc_String_pa_PrintArg_struct _tmp36=({struct Cyc_String_pa_PrintArg_struct _tmp59D;_tmp59D.tag=0U,({struct _fat_ptr _tmp644=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(Cyc_NewControlFlow_strip_cast(ireq)));_tmp59D.f1=_tmp644;});_tmp59D;});struct Cyc_String_pa_PrintArg_struct _tmp37=({struct Cyc_String_pa_PrintArg_struct _tmp59C;_tmp59C.tag=0U,_tmp59C.f1=(struct _fat_ptr)((struct _fat_ptr)*f);_tmp59C;});void*_tmp34[2U];_tmp34[0]=& _tmp36,_tmp34[1]=& _tmp37;({unsigned _tmp646=loc;struct _fat_ptr _tmp645=({const char*_tmp35="unable to prove %s, required to access %s";_tag_fat(_tmp35,sizeof(char),42U);});Cyc_CfFlowInfo_aerr(_tmp646,_tmp645,_tag_fat(_tmp34,sizeof(void*),2U));});});
({void*_tmp38=0U;({struct Cyc___cycFILE*_tmp648=Cyc_stderr;struct _fat_ptr _tmp647=({const char*_tmp39="  [recorded facts on path: ";_tag_fat(_tmp39,sizeof(char),28U);});Cyc_fprintf(_tmp648,_tmp647,_tag_fat(_tmp38,sizeof(void*),0U));});});
Cyc_Relations_print_relns(Cyc_stderr,relns);
({void*_tmp3A=0U;({struct Cyc___cycFILE*_tmp64A=Cyc_stderr;struct _fat_ptr _tmp649=({const char*_tmp3B="]\n";_tag_fat(_tmp3B,sizeof(char),3U);});Cyc_fprintf(_tmp64A,_tmp649,_tag_fat(_tmp3A,sizeof(void*),0U));});});}}
# 306
;_pop_region();}
# 315
...
if(!({struct Cyc_List_List*_tmp64B=relns;Cyc_NewControlFlow_relns_ok(_tmp64B,Cyc_Relations_exp2relns(temp,req));})){
({struct Cyc_String_pa_PrintArg_struct _tmp41=({struct Cyc_String_pa_PrintArg_struct _tmp59F;_tmp59F.tag=0U,({struct _fat_ptr _tmp64C=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(Cyc_NewControlFlow_strip_cast(req)));_tmp59F.f1=_tmp64C;});_tmp59F;});struct Cyc_String_pa_PrintArg_struct _tmp42=({struct Cyc_String_pa_PrintArg_struct _tmp59E;_tmp59E.tag=0U,_tmp59E.f1=(struct _fat_ptr)((struct _fat_ptr)*f);_tmp59E;});void*_tmp3F[2U];_tmp3F[0]=& _tmp41,_tmp3F[1]=& _tmp42;({unsigned _tmp64E=loc;struct _fat_ptr _tmp64D=({const char*_tmp40="unable to prove %s, required to access %s";_tag_fat(_tmp40,sizeof(char),42U);});Cyc_CfFlowInfo_aerr(_tmp64E,_tmp64D,_tag_fat(_tmp3F,sizeof(void*),2U));});});
({void*_tmp43=0U;({struct Cyc___cycFILE*_tmp650=Cyc_stderr;struct _fat_ptr _tmp64F=({const char*_tmp44="  [recorded facts on path: ";_tag_fat(_tmp44,sizeof(char),28U);});Cyc_fprintf(_tmp650,_tmp64F,_tag_fat(_tmp43,sizeof(void*),0U));});});
Cyc_Relations_print_relns(Cyc_stderr,relns);
({void*_tmp45=0U;({struct Cyc___cycFILE*_tmp652=Cyc_stderr;struct _fat_ptr _tmp651=({const char*_tmp46="]\n";_tag_fat(_tmp46,sizeof(char),3U);});Cyc_fprintf(_tmp652,_tmp651,_tag_fat(_tmp45,sizeof(void*),0U));});});}
# 321
;_pop_region();}
# 328
...
({void*_tmp4A=0U;({unsigned _tmp654=loc;struct _fat_ptr _tmp653=({const char*_tmp4B="expression may not be fully initialized";_tag_fat(_tmp4B,sizeof(char),40U);});Cyc_CfFlowInfo_aerr(_tmp654,_tmp653,_tag_fat(_tmp4A,sizeof(void*),0U));});});{
...
({struct Cyc_NewControlFlow_AnalEnv*_tmp658=env;unsigned _tmp657=loc;void*_tmp656=(*((struct _tuple23*)((struct Cyc_List_List*)_check_null(tqts))->hd)).f2;Cyc_NewControlFlow_check_nounique(_tmp658,_tmp657,_tmp656,*((void**)_check_fat_subscript(ad,sizeof(void*),i)));});}}
# 364
...
({void*_tmp5F=0U;({unsigned _tmp65A=loc;struct _fat_ptr _tmp659=({const char*_tmp60="argument may still contain alias-free pointers";_tag_fat(_tmp60,sizeof(char),47U);});Cyc_Warn_warn(_tmp65A,_tmp659,_tag_fat(_tmp5F,sizeof(void*),0U));});});
...
# 395
if(!Cyc_Tcutil_is_noalias_pointer(t,0))
({void*_tmp64=0U;({struct _fat_ptr _tmp65B=({const char*_tmp65="noliveunique attribute requires alias-free pointer";_tag_fat(_tmp65,sizeof(char),51U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp65B,_tag_fat(_tmp64,sizeof(void*),0U));});});{
...
({void*_tmp6B=0U;({unsigned _tmp65D=loc;struct _fat_ptr _tmp65C=({const char*_tmp6C="argument may contain live alias-free pointers";_tag_fat(_tmp6C,sizeof(char),46U);});Cyc_Warn_warn(_tmp65D,_tmp65C,_tag_fat(_tmp6B,sizeof(void*),0U));});});
...
if(es == 0)
return({struct _tuple24 _tmp5A1;_tmp5A1.f1=inflow,_tmp5A1.f2=0;_tmp5A1;});
do{
...
return({struct _tuple24 _tmp5A2;_tmp5A2.f1=inflow,({struct Cyc_List_List*_tmp65E=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(rvals);_tmp5A2.f2=_tmp65E;});_tmp5A2;});}
# 439
...
({void*_tmp7A=0U;({unsigned _tmp660=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd)->loc;struct _fat_ptr _tmp65F=({const char*_tmp7B="expression may not be initialized";_tag_fat(_tmp7B,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp660,_tmp65F,_tag_fat(_tmp7A,sizeof(void*),0U));});});}
goto _LL3;}}else{_LL6: _LL7:
 goto _LL3;}_LL3:;}
# 451
return({struct _tuple17 _tmp5A3;_tmp5A3.f1=afterflow,_tmp5A3.f2=(env->fenv)->unknown_all;_tmp5A3;});}}
# 458
...
({void*_tmp7D=0U;({struct _fat_ptr _tmp661=({const char*_tmp7E="consume_zero_rval";_tag_fat(_tmp7E,sizeof(char),18U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp661,_tag_fat(_tmp7D,sizeof(void*),0U));});});else{
# 470
if(needs_unconsume)
...
union Cyc_CfFlowInfo_FlowInfo _tmp86=({struct Cyc_Dict_Dict _tmp662=Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,d,p,nzval);Cyc_CfFlowInfo_ReachableFL(_tmp662,relns);});union Cyc_CfFlowInfo_FlowInfo outflow=_tmp86;
# 512
...
union Cyc_CfFlowInfo_FlowInfo _tmp87=outflow;struct Cyc_List_List*_tmp89;struct Cyc_Dict_Dict _tmp88;if((_tmp87.BottomFL).tag == 1){_LL1: _LL2:
 return({struct _tuple20 _tmp5A4;_tmp5A4.f1=outflow,_tmp5A4.f2=outflow;_tmp5A4;});}else{_LL3: _tmp88=((_tmp87.ReachableFL).val).f1;_tmp89=((_tmp87.ReachableFL).val).f2;_LL4: {struct Cyc_Dict_Dict d=_tmp88;struct Cyc_List_List*relns=_tmp89;
# 526
union Cyc_CfFlowInfo_AbsLVal _tmp8A=(Cyc_NewControlFlow_anal_Lexp(env,inflow,0,0,e)).f2;union Cyc_CfFlowInfo_AbsLVal _stmttmp8=_tmp8A;union Cyc_CfFlowInfo_AbsLVal _tmp8B=_stmttmp8;struct Cyc_CfFlowInfo_Place*_tmp8C;if((_tmp8B.UnknownL).tag == 2){_LL6: _LL7:
 return({struct _tuple20 _tmp5A5;_tmp5A5.f1=outflow,_tmp5A5.f2=outflow;_tmp5A5;});}else{_LL8: _tmp8C=(_tmp8B.PlaceL).val;_LL9: {struct Cyc_CfFlowInfo_Place*p=_tmp8C;
# 529
void*nzval=(int)il == (int)1U?(env->fenv)->notzeroall:(env->fenv)->unknown_none;
...
return({struct _tuple20 _tmp5A6;({
union Cyc_CfFlowInfo_FlowInfo _tmp666=({struct Cyc_Dict_Dict _tmp665=Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,d,p,nzval);Cyc_CfFlowInfo_ReachableFL(_tmp665,relns);});_tmp5A6.f1=_tmp666;}),({
union Cyc_CfFlowInfo_FlowInfo _tmp664=({struct Cyc_Dict_Dict _tmp663=Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,d,p,zval);Cyc_CfFlowInfo_ReachableFL(_tmp663,relns);});_tmp5A6.f2=_tmp664;});_tmp5A6;});}}_LL5:;}}_LL0:;}
# 544
...
# 559
if(possibly_null)
({void*_tmp667=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp93=_cycalloc(sizeof(*_tmp93));_tmp93->tag=Cyc_CfFlowInfo_UnknownZ,_tmp93->f1=relns;_tmp93;});e->annot=_tmp667;});else{
# 562
({void*_tmp668=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp94=_cycalloc(sizeof(*_tmp94));_tmp94->tag=Cyc_CfFlowInfo_NotZero,_tmp94->f1=relns;_tmp94;});e->annot=_tmp668;});}}
# 570
...
# 578
 return({struct _tuple17 _tmp5A7;_tmp5A7.f1=f,({void*_tmp669=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,elttype,0,(env->fenv)->unknown_all);_tmp5A7.f2=_tmp669;});_tmp5A7;});}else{_LL8: _tmp9A=((_tmp99.ReachableFL).val).f1;_tmp9B=((_tmp99.ReachableFL).val).f2;_LL9: {struct Cyc_Dict_Dict outdict=_tmp9A;struct Cyc_List_List*relns=_tmp9B;
# 580
...
# 583
({void*_tmpA6=0U;({struct _fat_ptr _tmp66A=({const char*_tmpA7="named location in anal_derefR";_tag_fat(_tmpA7,sizeof(char),30U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp66A,_tag_fat(_tmpA6,sizeof(void*),0U));});});}case 1U: _LL10: _LL11:
# 585
...
return({struct _tuple17 _tmp5A8;_tmp5A8.f1=f,({void*_tmp66B=Cyc_CfFlowInfo_lookup_place(outdict,p);_tmp5A8.f2=_tmp66B;});_tmp5A8;});
...
if(index == 0 && Cyc_Tcutil_is_bound_one(bd))
return({struct _tuple17 _tmp5A9;_tmp5A9.f1=f,_tmp5A9.f2=r;_tmp5A9;});
goto _LLD;}case 0U: _LL16: _LL17:
# 599
 e->annot=(void*)& Cyc_CfFlowInfo_IsZero_val;
return({struct _tuple17 _tmp5AA;({union Cyc_CfFlowInfo_FlowInfo _tmp66D=Cyc_CfFlowInfo_BottomFL();_tmp5AA.f1=_tmp66D;}),({void*_tmp66C=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,elttype,0,(env->fenv)->unknown_all);_tmp5AA.f2=_tmp66C;});_tmp5AA;});case 2U: _LL18: _tmpA1=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmpA0)->f1;_LL19: {enum Cyc_CfFlowInfo_InitLevel il=_tmpA1;
# 603
...
# 614
({void*_tmpAE=0U;({unsigned _tmp66F=e->loc;struct _fat_ptr _tmp66E=({const char*_tmpAF="attempt to dereference a consumed alias-free pointer";_tag_fat(_tmpAF,sizeof(char),53U);});Cyc_CfFlowInfo_aerr(_tmp66F,_tmp66E,_tag_fat(_tmpAE,sizeof(void*),0U));});});
goto _LL24;}else{_LL27: _LL28:
# 617
({void*_tmpB0=0U;({unsigned _tmp671=e->loc;struct _fat_ptr _tmp670=({const char*_tmpB1="dereference of possibly uninitialized pointer";_tag_fat(_tmpB1,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp671,_tmp670,_tag_fat(_tmpB0,sizeof(void*),0U));});});}_LL24:;}
# 619
goto _LL20;}}}else{_LL1F: _LL20:
# 621
 return({struct _tuple17 _tmp5AB;_tmp5AB.f1=f,({void*_tmp672=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,elttype,0,(env->fenv)->unknown_all);_tmp5AB.f2=_tmp672;});_tmp5AB;});}_LL1C:;}}}}_LL5:;}}else{_LL3: _LL4:
# 624
({void*_tmpB2=0U;({struct _fat_ptr _tmp673=({const char*_tmpB3="right deref of non-pointer-type";_tag_fat(_tmpB3,sizeof(char),32U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp673,_tag_fat(_tmpB2,sizeof(void*),0U));});});}_LL0:;}
# 631
...
# 686
({struct Cyc_String_pa_PrintArg_struct _tmpC8=({struct Cyc_String_pa_PrintArg_struct _tmp5AC;_tmp5AC.tag=0U,({struct _fat_ptr _tmp674=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(exp));_tmp5AC.f1=_tmp674;});_tmp5AC;});void*_tmpC6[1U];_tmpC6[0]=& _tmpC8;({struct _fat_ptr _tmp675=({const char*_tmpC7="noconsume parameter %s must be l-values";_tag_fat(_tmpC7,sizeof(char),40U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp675,_tag_fat(_tmpC6,sizeof(void*),1U));});});
goto _LL3;}}else{_LL6: _LL7:
# 684
 goto _LL3;}_LL3:;}
# 689
...
# 703
 return({struct _tuple17 _tmp5AE;({union Cyc_CfFlowInfo_FlowInfo _tmp676=Cyc_CfFlowInfo_BottomFL();_tmp5AE.f1=_tmp676;}),_tmp5AE.f2=rval;_tmp5AE;});}else{_LL3: _tmpCA=((_tmpC9.ReachableFL).val).f1;_tmpCB=((_tmpC9.ReachableFL).val).f2;_LL4: {struct Cyc_Dict_Dict indict=_tmpCA;struct Cyc_List_List*relns=_tmpCB;
# 705
...
# 725
({void*_tmpD3=0U;({unsigned _tmp678=lexp->loc;struct _fat_ptr _tmp677=({const char*_tmpD4="assignment may overwrite alias-free pointer(s)";_tag_fat(_tmpD4,sizeof(char),47U);});Cyc_Warn_warn(_tmp678,_tmp677,_tag_fat(_tmpD3,sizeof(void*),0U));});});
goto _LLD;}_LLD:;}}
# 730
Cyc_NewControlFlow_update_tryflow(env,outflow);
return({struct _tuple17 _tmp5AF;_tmp5AF.f1=outflow,_tmp5AF.f2=rval;_tmp5AF;});}}else{_LL8: _LL9:
# 736
 return({struct _tuple17 _tmp5B0;({union Cyc_CfFlowInfo_FlowInfo _tmp679=Cyc_NewControlFlow_use_Rval(env,rexp->loc,outflow,rval);_tmp5B0.f1=_tmp679;}),_tmp5B0.f2=rval;_tmp5B0;});}_LL5:;}}_LL0:;}
# 743
...
# 754
outdict=({struct Cyc_CfFlowInfo_FlowEnv*_tmp67E=fenv;unsigned _tmp67D=loc;struct Cyc_Dict_Dict _tmp67C=outdict;struct Cyc_CfFlowInfo_Place*_tmp67B=({struct Cyc_CfFlowInfo_Place*_tmpD9=_cycalloc(sizeof(*_tmpD9));
({void*_tmp67A=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmpD8=_cycalloc(sizeof(*_tmpD8));_tmpD8->tag=0U,_tmpD8->f1=vd;_tmpD8;});_tmpD9->root=_tmp67A;}),_tmpD9->path=0;_tmpD9;});
# 754
Cyc_CfFlowInfo_assign_place(_tmp67E,_tmp67D,_tmp67C,_tmp67B,rval);});
# 757
...
if(vd != 0 && ve != 0){
if(ve->topt == 0)
({struct Cyc_String_pa_PrintArg_struct _tmpE8=({struct Cyc_String_pa_PrintArg_struct _tmp5B1;_tmp5B1.tag=0U,({
struct _fat_ptr _tmp67F=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(ve));_tmp5B1.f1=_tmp67F;});_tmp5B1;});void*_tmpE6[1U];_tmpE6[0]=& _tmpE8;({struct _fat_ptr _tmp680=({const char*_tmpE7="oops! pattern init expr %s has no type!\n";_tag_fat(_tmpE7,sizeof(char),41U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp680,_tag_fat(_tmpE6,sizeof(void*),1U));});});{
# 810
struct Cyc_List_List l=({struct Cyc_List_List _tmp5B3;_tmp5B3.hd=ve,_tmp5B3.tl=0;_tmp5B3;});
...
Cyc_Tcutil_is_noalias_pointer_or_aggr((*vd)->type))
({struct Cyc_String_pa_PrintArg_struct _tmpFB=({struct Cyc_String_pa_PrintArg_struct _tmp5B2;_tmp5B2.tag=0U,({
struct _fat_ptr _tmp681=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(ve));_tmp5B2.f1=_tmp681;});_tmp5B2;});void*_tmpF9[1U];_tmpF9[0]=& _tmpFB;({unsigned _tmp683=exp_loc;struct _fat_ptr _tmp682=({const char*_tmpFA="aliased pattern expression not an l-value: %s";_tag_fat(_tmpFA,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp683,_tmp682,_tag_fat(_tmpF9,sizeof(void*),1U));});});}_LL11:;}
# 839
...
return({struct Cyc_Absyn_Exp*_tmp684=Cyc_Absyn_prim1_exp(Cyc_Absyn_Numelts,e,0U);Cyc_Relations_exp2relnop(_tmp684,rop);});}default: _LL5: _LL6:
 return 1;}_LL0:;}
# 884
...
({struct Cyc_String_pa_PrintArg_struct _tmp115=({struct Cyc_String_pa_PrintArg_struct _tmp5B7;_tmp5B7.tag=0U,_tmp5B7.f1=(struct _fat_ptr)((struct _fat_ptr)s1);_tmp5B7;});struct Cyc_String_pa_PrintArg_struct _tmp116=({struct Cyc_String_pa_PrintArg_struct _tmp5B6;_tmp5B6.tag=0U,_tmp5B6.f1=(struct _fat_ptr)((struct _fat_ptr)s2);_tmp5B6;});struct Cyc_String_pa_PrintArg_struct _tmp117=({struct Cyc_String_pa_PrintArg_struct _tmp5B5;_tmp5B5.tag=0U,_tmp5B5.f1=(struct _fat_ptr)((struct _fat_ptr)s3);_tmp5B5;});struct Cyc_String_pa_PrintArg_struct _tmp118=({struct Cyc_String_pa_PrintArg_struct _tmp5B4;_tmp5B4.tag=0U,({
struct _fat_ptr _tmp685=(struct _fat_ptr)((struct _fat_ptr)Cyc_Relations_relns2string(relns));_tmp5B4.f1=_tmp685;});_tmp5B4;});void*_tmp113[4U];_tmp113[0]=& _tmp115,_tmp113[1]=& _tmp116,_tmp113[2]=& _tmp117,_tmp113[3]=& _tmp118;({unsigned _tmp687=loc;struct _fat_ptr _tmp686=({const char*_tmp114="cannot prove that @requires clause %s %s %s is satisfied\n (all I know is %s)";_tag_fat(_tmp114,sizeof(char),77U);});Cyc_CfFlowInfo_aerr(_tmp687,_tmp686,_tag_fat(_tmp113,sizeof(void*),4U));});});
break;}}
# 915
...
{union Cyc_CfFlowInfo_FlowInfo _tmp11A=inflow;struct Cyc_List_List*_tmp11C;struct Cyc_Dict_Dict _tmp11B;if((_tmp11A.BottomFL).tag == 1){_LL1: _LL2:
 return({struct _tuple17 _tmp5B8;({union Cyc_CfFlowInfo_FlowInfo _tmp688=Cyc_CfFlowInfo_BottomFL();_tmp5B8.f1=_tmp688;}),_tmp5B8.f2=fenv->unknown_all;_tmp5B8;});}else{_LL3: _tmp11B=((_tmp11A.ReachableFL).val).f1;_tmp11C=((_tmp11A.ReachableFL).val).f2;_LL4: {struct Cyc_Dict_Dict d2=_tmp11B;struct Cyc_List_List*relns2=_tmp11C;
...
struct _tuple19 _tmp121=({struct _tuple19 _tmp5BC;_tmp5BC.f1=flval,_tmp5BC.f2=lval;_tmp5BC;});struct _tuple19 _stmttmp1B=_tmp121;struct _tuple19 _tmp122=_stmttmp1B;struct Cyc_CfFlowInfo_Place*_tmp125;struct Cyc_List_List*_tmp124;struct Cyc_Dict_Dict _tmp123;if(((_tmp122.f1).ReachableFL).tag == 2){if(((_tmp122.f2).PlaceL).tag == 1){_LL9: _tmp123=(((_tmp122.f1).ReachableFL).val).f1;_tmp124=(((_tmp122.f1).ReachableFL).val).f2;_tmp125=((_tmp122.f2).PlaceL).val;_LLA: {struct Cyc_Dict_Dict fd=_tmp123;struct Cyc_List_List*r=_tmp124;struct Cyc_CfFlowInfo_Place*p=_tmp125;
# 976
void*_tmp126=Cyc_CfFlowInfo_lookup_place(fd,p);void*old_rval=_tmp126;
int needs_unconsume=0;
if(Cyc_CfFlowInfo_is_unique_consumed(e,env->iteration_num,old_rval,& needs_unconsume)){
({void*_tmp127=0U;({unsigned _tmp68A=e->loc;struct _fat_ptr _tmp689=({const char*_tmp128="expression attempts to copy a consumed alias-free value";_tag_fat(_tmp128,sizeof(char),56U);});Cyc_CfFlowInfo_aerr(_tmp68A,_tmp689,_tag_fat(_tmp127,sizeof(void*),0U));});});
return({struct _tuple17 _tmp5B9;({union Cyc_CfFlowInfo_FlowInfo _tmp68B=Cyc_CfFlowInfo_BottomFL();_tmp5B9.f1=_tmp68B;}),_tmp5B9.f2=fenv->unknown_all;_tmp5B9;});}else{
# 982
if(needs_unconsume)
# 984
return({struct _tuple17 _tmp5BA;_tmp5BA.f1=flval,({void*_tmp68C=Cyc_CfFlowInfo_make_unique_unconsumed(fenv,old_rval);_tmp5BA.f2=_tmp68C;});_tmp5BA;});else{
# 987
...
# 999
return({struct _tuple17 _tmp5BB;({union Cyc_CfFlowInfo_FlowInfo _tmp68D=Cyc_CfFlowInfo_ReachableFL(outdict,r);_tmp5BB.f1=_tmp68D;}),_tmp5BB.f2=old_rval;_tmp5BB;});}}}}else{goto _LLB;}}else{_LLB: _LLC:
# 1003
 goto _LL8;}_LL8:;}}{
# 1006
...
return({struct _tuple17 _tmp5BD;_tmp5BD.f1=f2,_tmp5BD.f2=r1;_tmp5BD;});}}}}else{_LL10: _tmp16A=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL11: {struct Cyc_Absyn_Exp*e1=_tmp16A;
# 1016
...
# 1022
if(!({struct _fat_ptr _tmp68E=(struct _fat_ptr)p;Cyc_NewControlFlow_strcmp(_tmp68E,({const char*_tmp174="print_flow";_tag_fat(_tmp174,sizeof(char),11U);}));})){
struct _fat_ptr _tmp175=Cyc_Position_string_of_segment(e->loc);struct _fat_ptr seg_str=_tmp175;
({struct Cyc_String_pa_PrintArg_struct _tmp178=({struct Cyc_String_pa_PrintArg_struct _tmp5BE;_tmp5BE.tag=0U,_tmp5BE.f1=(struct _fat_ptr)((struct _fat_ptr)seg_str);_tmp5BE;});void*_tmp176[1U];_tmp176[0]=& _tmp178;({struct Cyc___cycFILE*_tmp690=Cyc_stderr;struct _fat_ptr _tmp68F=({const char*_tmp177="%s: current flow is\n";_tag_fat(_tmp177,sizeof(char),21U);});Cyc_fprintf(_tmp690,_tmp68F,_tag_fat(_tmp176,sizeof(void*),1U));});});
Cyc_CfFlowInfo_print_flow(inflow);
({void*_tmp179=0U;({struct Cyc___cycFILE*_tmp692=Cyc_stderr;struct _fat_ptr _tmp691=({const char*_tmp17A="\n";_tag_fat(_tmp17A,sizeof(char),2U);});Cyc_fprintf(_tmp692,_tmp691,_tag_fat(_tmp179,sizeof(void*),0U));});});}else{
# 1028
if(!({struct _fat_ptr _tmp693=(struct _fat_ptr)p;Cyc_NewControlFlow_strcmp(_tmp693,({const char*_tmp17B="debug_on";_tag_fat(_tmp17B,sizeof(char),9U);}));}));else{
# 1033
if(!({struct _fat_ptr _tmp694=(struct _fat_ptr)p;Cyc_NewControlFlow_strcmp(_tmp694,({const char*_tmp17C="debug_off";_tag_fat(_tmp17C,sizeof(char),10U);}));}));else{
# 1039
({struct Cyc_String_pa_PrintArg_struct _tmp17F=({struct Cyc_String_pa_PrintArg_struct _tmp5BF;_tmp5BF.tag=0U,_tmp5BF.f1=(struct _fat_ptr)((struct _fat_ptr)p);_tmp5BF;});void*_tmp17D[1U];_tmp17D[0]=& _tmp17F;({unsigned _tmp696=e->loc;struct _fat_ptr _tmp695=({const char*_tmp17E="unknown pragma %s";_tag_fat(_tmp17E,sizeof(char),18U);});Cyc_Warn_warn(_tmp696,_tmp695,_tag_fat(_tmp17D,sizeof(void*),1U));});});}}}
return({struct _tuple17 _tmp5C0;_tmp5C0.f1=inflow,_tmp5C0.f2=fenv->zero;_tmp5C0;});}case 40U: _LL1A: _LL1B:
# 1042
 ...
 return({struct _tuple17 _tmp5C1;_tmp5C1.f1=inflow,_tmp5C1.f2=fenv->zero;_tmp5C1;});}else{_LL20: _LL21:
...
# 1048
 return({struct _tuple17 _tmp5C2;_tmp5C2.f1=inflow,_tmp5C2.f2=fenv->notzeroall;_tmp5C2;});case 1U: _LL38: _LL39:
# 1060
 return({struct _tuple17 _tmp5C3;_tmp5C3.f1=inflow,({void*_tmp697=Cyc_CfFlowInfo_typ_to_absrval(fenv,(void*)_check_null(e->topt),0,fenv->unknown_all);_tmp5C3.f2=_tmp697;});_tmp5C3;});case 4U: _LL3A: _tmp165=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp12C)->f1)->f1;_LL3B: {struct Cyc_Absyn_Vardecl*vd=_tmp165;
# 1065
if((int)vd->sc == (int)Cyc_Absyn_Static)
return({struct _tuple17 _tmp5C4;_tmp5C4.f1=inflow,({void*_tmp698=Cyc_CfFlowInfo_typ_to_absrval(fenv,(void*)_check_null(e->topt),0,fenv->unknown_all);_tmp5C4.f2=_tmp698;});_tmp5C4;});
# 1068
...
# 1072
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct vdroot=({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp5C6;_tmp5C6.tag=0U,_tmp5C6.f1=vd;_tmp5C6;});
return({struct _tuple17 _tmp5C5;_tmp5C5.f1=inflow,({void*_tmp69A=({struct Cyc_Dict_Dict _tmp699=d;((void*(*)(struct Cyc_Dict_Dict d,int(*cmp)(void*,void*),void*k))Cyc_Dict_lookup_other)(_tmp699,Cyc_CfFlowInfo_root_cmp,(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp180=_cycalloc(sizeof(*_tmp180));*_tmp180=vdroot;_tmp180;}));});_tmp5C5.f2=_tmp69A;});_tmp5C5;});}default: _LL78: _LL79:
# 1676
...
# 1052
 ...
 return({struct _tuple17 _tmp5C7;_tmp5C7.f1=inflow,_tmp5C7.f2=fenv->unknown_all;_tmp5C7;});case 3U: _LL40: _tmp15F=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp160=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL41: {enum Cyc_Absyn_Primop p=_tmp15F;struct Cyc_List_List*es=_tmp160;
# 1079
...
return({struct _tuple17 _tmp5C8;_tmp5C8.f1=f,_tmp5C8.f2=r;_tmp5C8;});}}case 5U: _LL42: _tmp15E=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL43: {struct Cyc_Absyn_Exp*e1=_tmp15E;
# 1083
struct Cyc_List_List _tmp185=({struct Cyc_List_List _tmp5CC;_tmp5CC.hd=e1,_tmp5CC.tl=0;_tmp5CC;});struct Cyc_List_List arg=_tmp185;
...
# 1093
{struct _tuple26 _tmp190=({struct _tuple26 _tmp5C9;_tmp5C9.f1=lval,_tmp5C9.f2=f;_tmp5C9;});struct _tuple26 _stmttmp23=_tmp190;struct _tuple26 _tmp191=_stmttmp23;struct Cyc_List_List*_tmp194;struct Cyc_Dict_Dict _tmp193;struct Cyc_CfFlowInfo_Place*_tmp192;if(((_tmp191.f1).PlaceL).tag == 1){if(((_tmp191.f2).ReachableFL).tag == 2){_LL93: _tmp192=((_tmp191.f1).PlaceL).val;_tmp193=(((_tmp191.f2).ReachableFL).val).f1;_tmp194=(((_tmp191.f2).ReachableFL).val).f2;_LL94: {struct Cyc_CfFlowInfo_Place*p=_tmp192;struct Cyc_Dict_Dict outdict=_tmp193;struct Cyc_List_List*relns=_tmp194;
# 1095
relns=Cyc_Relations_reln_kill_exp(Cyc_Core_heap_region,relns,e1);
f=({struct Cyc_Dict_Dict _tmp69B=Cyc_CfFlowInfo_assign_place(fenv,e1->loc,outdict,p,fenv->unknown_all);Cyc_CfFlowInfo_ReachableFL(_tmp69B,relns);});
# 1100
goto _LL92;}}else{goto _LL95;}}else{_LL95: _LL96:
 goto _LL92;}_LL92:;}
# 1104
if(iszt)
return({struct _tuple17 _tmp5CA;_tmp5CA.f1=f,_tmp5CA.f2=fenv->notzeroall;_tmp5CA;});else{
return({struct _tuple17 _tmp5CB;_tmp5CB.f1=f,_tmp5CB.f2=fenv->unknown_all;_tmp5CB;});}}}}case 4U: if(((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12C)->f2 != 0){_LL44: _tmp15C=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp15D=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12C)->f3;_LL45: {struct Cyc_Absyn_Exp*l=_tmp15C;struct Cyc_Absyn_Exp*r=_tmp15D;
# 1109
if(copy_ctxt && Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_check_null(e->topt))){
({void*_tmp195=0U;({unsigned _tmp69D=e->loc;struct _fat_ptr _tmp69C=({const char*_tmp196="cannot track alias-free pointers through multiple assignments";_tag_fat(_tmp196,sizeof(char),62U);});Cyc_CfFlowInfo_aerr(_tmp69D,_tmp69C,_tag_fat(_tmp195,sizeof(void*),0U));});});
return({struct _tuple17 _tmp5CD;({union Cyc_CfFlowInfo_FlowInfo _tmp69E=Cyc_CfFlowInfo_BottomFL();_tmp5CD.f1=_tmp69E;}),_tmp5CD.f2=fenv->unknown_all;_tmp5CD;});}{
# 1113
...
goto _LL9D;}}else{_LLA0: _LLA1:
 goto _LL9D;}_LL9D:;}
# 1136
return({struct _tuple17 _tmp5CE;_tmp5CE.f1=f,_tmp5CE.f2=fenv->unknown_all;_tmp5CE;});}}}}}else{_LL46: _tmp15A=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp15B=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12C)->f3;_LL47: {struct Cyc_Absyn_Exp*e1=_tmp15A;struct Cyc_Absyn_Exp*e2=_tmp15B;
# 1139
if(copy_ctxt && Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_check_null(e->topt))){
({void*_tmp1A4=0U;({unsigned _tmp6A0=e->loc;struct _fat_ptr _tmp69F=({const char*_tmp1A5="cannot track alias-free pointers through multiple assignments";_tag_fat(_tmp1A5,sizeof(char),62U);});Cyc_CfFlowInfo_aerr(_tmp6A0,_tmp69F,_tag_fat(_tmp1A4,sizeof(void*),0U));});});
return({struct _tuple17 _tmp5CF;({union Cyc_CfFlowInfo_FlowInfo _tmp6A1=Cyc_CfFlowInfo_BottomFL();_tmp5CF.f1=_tmp6A1;}),_tmp5CF.f2=fenv->unknown_all;_tmp5CF;});}
# 1145
inflow=({struct Cyc_NewControlFlow_AnalEnv*_tmp6A3=env;union Cyc_CfFlowInfo_FlowInfo _tmp6A2=inflow;Cyc_NewControlFlow_expand_unique_places(_tmp6A3,_tmp6A2,({struct Cyc_Absyn_Exp*_tmp1A6[2U];_tmp1A6[0]=e1,_tmp1A6[1]=e2;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1A6,sizeof(struct Cyc_Absyn_Exp*),2U));}));});{
# 1147
...
# 1153
return({struct _tuple17 _tmp5D0;_tmp5D0.f1=outflow,_tmp5D0.f2=rval;_tmp5D0;});}}}}}}case 9U: _LL48: _tmp158=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp159=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL49: {struct Cyc_Absyn_Exp*e1=_tmp158;struct Cyc_Absyn_Exp*e2=_tmp159;
# 1156
...
return({struct _tuple17 _tmp5D1;({union Cyc_CfFlowInfo_FlowInfo _tmp6A5=Cyc_CfFlowInfo_BottomFL();_tmp5D1.f1=_tmp6A5;}),({void*_tmp6A4=Cyc_CfFlowInfo_typ_to_absrval(fenv,(void*)_check_null(e->topt),0,fenv->unknown_all);_tmp5D1.f2=_tmp6A4;});_tmp5D1;});}}case 10U: _LL4C: _tmp155=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp156=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL4D: {struct Cyc_Absyn_Exp*e1=_tmp155;struct Cyc_List_List*es=_tmp156;
# 1165
...
# 1171
struct _tuple24 _tmp1C0=({struct Cyc_NewControlFlow_AnalEnv*_tmp6A7=env;union Cyc_CfFlowInfo_FlowInfo _tmp6A6=f1;Cyc_NewControlFlow_anal_Rexps(_tmp6A7,_tmp6A6,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_copy)(es),1,1);});struct _tuple24 _stmttmp2C=_tmp1C0;struct _tuple24 _tmp1C1=_stmttmp2C;struct Cyc_List_List*_tmp1C3;union Cyc_CfFlowInfo_FlowInfo _tmp1C2;_LLBA: _tmp1C2=_tmp1C1.f1;_tmp1C3=_tmp1C1.f2;_LLBB: {union Cyc_CfFlowInfo_FlowInfo fst_outflow=_tmp1C2;struct Cyc_List_List*rvals=_tmp1C3;
# 1173
...
({void*_tmp1D6=0U;({struct _fat_ptr _tmp6A8=({const char*_tmp1D7="anal_Rexp: bad function type";_tag_fat(_tmp1D7,sizeof(char),29U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6A8,_tag_fat(_tmp1D6,sizeof(void*),0U));});});}_LLC1:;}
# 1203
goto _LLBC;}}else{_LLBF: _LLC0:
({void*_tmp1D8=0U;({struct _fat_ptr _tmp6A9=({const char*_tmp1D9="anal_Rexp: bad function type";_tag_fat(_tmp1D9,sizeof(char),29U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6A9,_tag_fat(_tmp1D8,sizeof(void*),0U));});});}_LLBC:;}
# 1206
...
({void*_tmp1DF=0U;({unsigned _tmp6AB=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd)->loc;struct _fat_ptr _tmp6AA=({const char*_tmp1E0="expression may not be initialized";_tag_fat(_tmp1E0,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6AB,_tmp6AA,_tag_fat(_tmp1DF,sizeof(void*),0U));});});
...
# 1224
ans_d=({struct Cyc_CfFlowInfo_FlowEnv*_tmp6AF=fenv;unsigned _tmp6AE=((struct Cyc_Absyn_Exp*)es->hd)->loc;struct Cyc_Dict_Dict _tmp6AD=ans_d;struct Cyc_CfFlowInfo_Place*_tmp6AC=p;Cyc_CfFlowInfo_assign_place(_tmp6AF,_tmp6AE,_tmp6AD,_tmp6AC,
Cyc_CfFlowInfo_typ_to_absrval(fenv,t,0,fenv->esc_all));});
# 1228
goto _LLE3;}}else{_LLE6: _LLE7:
({void*_tmp1EB=0U;({struct _fat_ptr _tmp6B0=({const char*_tmp1EC="anal_Rexp:bad type for initialized arg";_tag_fat(_tmp1EC,sizeof(char),39U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6B0,_tag_fat(_tmp1EB,sizeof(void*),0U));});});}_LLE3:;}
# 1231
goto _LLDC;}case 5U: _LLDF: _LLE0:
# 1233
({void*_tmp1ED=0U;({struct _fat_ptr _tmp6B1=({const char*_tmp1EE="anal_Rexp:initialize attribute on unique pointers not yet supported";_tag_fat(_tmp1EE,sizeof(char),68U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6B1,_tag_fat(_tmp1ED,sizeof(void*),0U));});});default: _LLE1: _LLE2:
# 1235
 goto _LLDC;}_LLDC:;}
# 1237
...
# 1248
outflow=({struct Cyc_NewControlFlow_AnalEnv*_tmp6B5=env;unsigned _tmp6B4=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd)->loc;void*_tmp6B3=(void*)_check_null(((struct Cyc_Absyn_Exp*)es->hd)->topt);union Cyc_CfFlowInfo_FlowInfo _tmp6B2=outflow;Cyc_NewControlFlow_use_nounique_Rval(_tmp6B5,_tmp6B4,_tmp6B3,_tmp6B2,(void*)rvals->hd);});else{
# 1258
...
return({struct _tuple17 _tmp5D2;({union Cyc_CfFlowInfo_FlowInfo _tmp6B7=Cyc_CfFlowInfo_BottomFL();_tmp5D2.f1=_tmp6B7;}),({void*_tmp6B6=Cyc_CfFlowInfo_typ_to_absrval(fenv,(void*)_check_null(e->topt),0,fenv->unknown_all);_tmp5D2.f2=_tmp6B6;});_tmp5D2;});else{
# 1271
return({struct _tuple17 _tmp5D3;_tmp5D3.f1=outflow,({void*_tmp6B8=Cyc_CfFlowInfo_typ_to_absrval(fenv,(void*)_check_null(e->topt),0,fenv->unknown_all);_tmp5D3.f2=_tmp6B8;});_tmp5D3;});}}}}}case 34U: _LL4E: _tmp150=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12C)->f1).is_calloc;_tmp151=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12C)->f1).rgn;_tmp152=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12C)->f1).elt_type;_tmp153=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12C)->f1).num_elts;_tmp154=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12C)->f1).fat_result;_LL4F: {int iscalloc=_tmp150;struct Cyc_Absyn_Exp*eopt=_tmp151;void**topt=_tmp152;struct Cyc_Absyn_Exp*exp=_tmp153;int isfat=_tmp154;
# 1274
void*place_val;
...
return({struct _tuple17 _tmp5D4;_tmp5D4.f1=outflow,({void*_tmp6BB=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp1F7=_cycalloc(sizeof(*_tmp1F7));_tmp1F7->tag=5U,_tmp1F7->f1=place_val;_tmp1F7;});_tmp5D4.f2=_tmp6BB;});_tmp5D4;});else{
# 1292
...
union Cyc_CfFlowInfo_FlowInfo _tmp1F8=outflow;struct Cyc_List_List*_tmp1FA;struct Cyc_Dict_Dict _tmp1F9;if((_tmp1F8.BottomFL).tag == 1){_LLEF: _LLF0:
 return({struct _tuple17 _tmp5D5;_tmp5D5.f1=outflow,_tmp5D5.f2=rval;_tmp5D5;});}else{_LLF1: _tmp1F9=((_tmp1F8.ReachableFL).val).f1;_tmp1FA=((_tmp1F8.ReachableFL).val).f2;_LLF2: {struct Cyc_Dict_Dict d2=_tmp1F9;struct Cyc_List_List*relns=_tmp1FA;
# 1298
return({struct _tuple17 _tmp5D6;({union Cyc_CfFlowInfo_FlowInfo _tmp6BD=({struct Cyc_Dict_Dict _tmp6BC=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(d2,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp6BC,relns);});_tmp5D6.f1=_tmp6BD;}),_tmp5D6.f2=rval;_tmp5D6;});}}_LLEE:;}}}case 35U: _LL50: _tmp14E=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp14F=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL51: {struct Cyc_Absyn_Exp*e1=_tmp14E;struct Cyc_Absyn_Exp*e2=_tmp14F;
# 1303
void*left_rval;
void*right_rval;
union Cyc_CfFlowInfo_FlowInfo outflow;
# 1309
struct _tuple24 _tmp1FE=({struct Cyc_NewControlFlow_AnalEnv*_tmp6BF=env;union Cyc_CfFlowInfo_FlowInfo _tmp6BE=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6BF,_tmp6BE,({struct Cyc_Absyn_Exp*_tmp219[2U];_tmp219[0]=e1,_tmp219[1]=e2;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp219,sizeof(struct Cyc_Absyn_Exp*),2U));}),0,0);});struct _tuple24 _stmttmp35=_tmp1FE;struct _tuple24 _tmp1FF=_stmttmp35;struct Cyc_List_List*_tmp201;union Cyc_CfFlowInfo_FlowInfo _tmp200;_LLF4: _tmp200=_tmp1FF.f1;_tmp201=_tmp1FF.f2;_LLF5: {union Cyc_CfFlowInfo_FlowInfo f=_tmp200;struct Cyc_List_List*rvals=_tmp201;
...
({void*_tmp203=0U;({unsigned _tmp6C1=e1->loc;struct _fat_ptr _tmp6C0=({const char*_tmp204="cannot swap value into zeroterm array not known to be 0";_tag_fat(_tmp204,sizeof(char),56U);});Cyc_CfFlowInfo_aerr(_tmp6C1,_tmp6C0,_tag_fat(_tmp203,sizeof(void*),0U));});});}_LLF6:;}else{
# 1326
...
({void*_tmp206=0U;({unsigned _tmp6C3=e2->loc;struct _fat_ptr _tmp6C2=({const char*_tmp207="cannot swap value into zeroterm array not known to be 0";_tag_fat(_tmp207,sizeof(char),56U);});Cyc_CfFlowInfo_aerr(_tmp6C3,_tmp6C2,_tag_fat(_tmp206,sizeof(void*),0U));});});}_LLFB:;}}{
# 1334
...
({void*_tmp213=0U;({unsigned _tmp6C5=e2->loc;struct _fat_ptr _tmp6C4=({const char*_tmp214="expression may not be fully initialized";_tag_fat(_tmp214,sizeof(char),40U);});Cyc_CfFlowInfo_aerr(_tmp6C5,_tmp6C4,_tag_fat(_tmp213,sizeof(void*),0U));});});
goto _LL10B;}_LL10B:;}
# 1350
...
({void*_tmp217=0U;({unsigned _tmp6C7=e1->loc;struct _fat_ptr _tmp6C6=({const char*_tmp218="expression may not be fully initialized";_tag_fat(_tmp218,sizeof(char),40U);});Cyc_CfFlowInfo_aerr(_tmp6C7,_tmp6C6,_tag_fat(_tmp217,sizeof(void*),0U));});});
goto _LL110;}_LL110:;}
# 1360
relns=Cyc_Relations_reln_kill_exp(Cyc_Core_heap_region,relns,e1);
...
goto _LL106;}}else{_LL109: _LL10A:
 goto _LL106;}_LL106:;}
# 1370
return({struct _tuple17 _tmp5D7;_tmp5D7.f1=outflow,_tmp5D7.f2=fenv->unknown_all;_tmp5D7;});}}}}}}case 16U: _LL52: _tmp14C=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp14D=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL53: {struct Cyc_Absyn_Exp*eopt=_tmp14C;struct Cyc_Absyn_Exp*e2=_tmp14D;
# 1373
union Cyc_CfFlowInfo_FlowInfo outflow;
void*place_val;
if(eopt != 0){
struct _tuple24 _tmp21A=({struct Cyc_NewControlFlow_AnalEnv*_tmp6C9=env;union Cyc_CfFlowInfo_FlowInfo _tmp6C8=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp6C9,_tmp6C8,({struct Cyc_Absyn_Exp*_tmp21E[2U];_tmp21E[0]=eopt,_tmp21E[1]=e2;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp21E,sizeof(struct Cyc_Absyn_Exp*),2U));}),1,1);});struct _tuple24 _stmttmp38=_tmp21A;struct _tuple24 _tmp21B=_stmttmp38;struct Cyc_List_List*_tmp21D;union Cyc_CfFlowInfo_FlowInfo _tmp21C;_LL116: _tmp21C=_tmp21B.f1;_tmp21D=_tmp21B.f2;_LL117: {union Cyc_CfFlowInfo_FlowInfo f=_tmp21C;struct Cyc_List_List*rvals=_tmp21D;
outflow=f;
...
# 1385
if(Cyc_Tcutil_is_noalias_pointer((void*)_check_null(e->topt),1))
return({struct _tuple17 _tmp5D8;_tmp5D8.f1=outflow,({void*_tmp6CA=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp223=_cycalloc(sizeof(*_tmp223));_tmp223->tag=5U,_tmp223->f1=place_val;_tmp223;});_tmp5D8.f2=_tmp6CA;});_tmp5D8;});else{
# 1389
...
union Cyc_CfFlowInfo_FlowInfo _tmp224=outflow;struct Cyc_List_List*_tmp226;struct Cyc_Dict_Dict _tmp225;if((_tmp224.BottomFL).tag == 1){_LL11C: _LL11D:
 return({struct _tuple17 _tmp5D9;_tmp5D9.f1=outflow,_tmp5D9.f2=rval;_tmp5D9;});}else{_LL11E: _tmp225=((_tmp224.ReachableFL).val).f1;_tmp226=((_tmp224.ReachableFL).val).f2;_LL11F: {struct Cyc_Dict_Dict d2=_tmp225;struct Cyc_List_List*relns=_tmp226;
# 1395
return({struct _tuple17 _tmp5DA;({union Cyc_CfFlowInfo_FlowInfo _tmp6CC=({struct Cyc_Dict_Dict _tmp6CB=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(d2,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp6CB,relns);});_tmp5DA.f1=_tmp6CC;}),_tmp5DA.f2=rval;_tmp5DA;});}}_LL11B:;}}case 15U: _LL54: _tmp14B=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL55: {struct Cyc_Absyn_Exp*e1=_tmp14B;
# 1400
...
union Cyc_CfFlowInfo_AbsLVal _tmp22E=l;struct Cyc_CfFlowInfo_Place*_tmp22F;if((_tmp22E.UnknownL).tag == 2){_LL124: _LL125:
 return({struct _tuple17 _tmp5DB;_tmp5DB.f1=f,_tmp5DB.f2=fenv->notzeroall;_tmp5DB;});}else{_LL126: _tmp22F=(_tmp22E.PlaceL).val;_LL127: {struct Cyc_CfFlowInfo_Place*p=_tmp22F;
return({struct _tuple17 _tmp5DC;_tmp5DC.f1=f,({void*_tmp6CD=(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp230=_cycalloc(sizeof(*_tmp230));_tmp230->tag=4U,_tmp230->f1=p;_tmp230;});_tmp5DC.f2=_tmp6CD;});_tmp5DC;});}}_LL123:;}}case 20U: _LL56: _tmp14A=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL57: {struct Cyc_Absyn_Exp*e1=_tmp14A;
# 1407
...
return({struct _tuple17 _tmp5DD;_tmp5DD.f1=f,({void*_tmp6CE=Cyc_CfFlowInfo_typ_to_absrval(fenv,(void*)_check_null(e->topt),0,fenv->unknown_all);_tmp5DD.f2=_tmp6CE;});_tmp5DD;});
...
return({struct _tuple17 _tmp5DE;_tmp5DE.f1=f,({void*_tmp6CF=Cyc_CfFlowInfo_typ_to_absrval(fenv,(void*)_check_null(e->topt),1,fenv->unknown_none);_tmp5DE.f2=_tmp6CF;});_tmp5DE;});
return({struct _tuple17 _tmp5DF;_tmp5DF.f1=f,_tmp5DF.f2=*((void**)_check_fat_subscript(rdict,sizeof(void*),field_no));_tmp5DF;});}}else{_LL134: _LL135:
# 1426
({void*_tmp242=0U;({struct Cyc___cycFILE*_tmp6D1=Cyc_stderr;struct _fat_ptr _tmp6D0=({const char*_tmp243="the bad rexp is :";_tag_fat(_tmp243,sizeof(char),18U);});Cyc_fprintf(_tmp6D1,_tmp6D0,_tag_fat(_tmp242,sizeof(void*),0U));});});
Cyc_CfFlowInfo_print_absrval(r);
({struct Cyc_String_pa_PrintArg_struct _tmp246=({struct Cyc_String_pa_PrintArg_struct _tmp5E0;_tmp5E0.tag=0U,({struct _fat_ptr _tmp6D2=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp5E0.f1=_tmp6D2;});_tmp5E0;});void*_tmp244[1U];_tmp244[0]=& _tmp246;({struct _fat_ptr _tmp6D3=({const char*_tmp245="\nanal_Rexp: AggrMember: %s";_tag_fat(_tmp245,sizeof(char),27U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6D3,_tag_fat(_tmp244,sizeof(void*),1U));});});}_LL131:;}}}}case 38U: _LL5A: _tmp146=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp147=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL5B: {struct Cyc_Absyn_Exp*e1=_tmp146;struct _fat_ptr*field=_tmp147;
# 1434
...
return({struct _tuple17 _tmp5E1;_tmp5E1.f1=f,_tmp5E1.f2=fenv->unknown_all;_tmp5E1;});{
...
if(is_union && fnum != -1){
if(fnum != field_no)
return({struct _tuple17 _tmp5E2;_tmp5E2.f1=f,_tmp5E2.f2=fenv->zero;_tmp5E2;});else{
# 1446
return({struct _tuple17 _tmp5E3;_tmp5E3.f1=f,_tmp5E3.f2=fenv->notzeroall;_tmp5E3;});}}else{
# 1448
return({struct _tuple17 _tmp5E4;_tmp5E4.f1=f,_tmp5E4.f2=fenv->unknown_all;_tmp5E4;});}}}else{_LL13F: _LL140:
# 1450
({struct Cyc_String_pa_PrintArg_struct _tmp255=({struct Cyc_String_pa_PrintArg_struct _tmp5E5;_tmp5E5.tag=0U,({struct _fat_ptr _tmp6D4=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp5E5.f1=_tmp6D4;});_tmp5E5;});void*_tmp253[1U];_tmp253[0]=& _tmp255;({struct _fat_ptr _tmp6D5=({const char*_tmp254="anal_Rexp: TagCheck_e: %s";_tag_fat(_tmp254,sizeof(char),26U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6D5,_tag_fat(_tmp253,sizeof(void*),1U));});});}_LL13C:;}}}}case 22U: _LL5C: _tmp144=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp145=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL5D: {struct Cyc_Absyn_Exp*e1=_tmp144;struct _fat_ptr*field=_tmp145;
# 1454
...
# 1464
return({struct _tuple17 _tmp5E6;_tmp5E6.f1=f2,({void*_tmp6D6=Cyc_CfFlowInfo_typ_to_absrval(fenv,(void*)_check_null(e->topt),0,fenv->unknown_all);_tmp5E6.f2=_tmp6D6;});_tmp5E6;});
# 1466
...
if((is_union && fnum != -1)&& fnum != field_no)
return({struct _tuple17 _tmp5E7;_tmp5E7.f1=f2,({void*_tmp6D7=Cyc_CfFlowInfo_typ_to_absrval(fenv,(void*)_check_null(e->topt),1,fenv->unknown_none);_tmp5E7.f2=_tmp6D7;});_tmp5E7;});
return({struct _tuple17 _tmp5E8;_tmp5E8.f1=f2,_tmp5E8.f2=*((void**)_check_fat_subscript(rdict,sizeof(void*),field_no));_tmp5E8;});}}else{_LL152: _LL153:
({void*_tmp269=0U;({struct _fat_ptr _tmp6D8=({const char*_tmp26A="anal_Rexp: AggrArrow";_tag_fat(_tmp26A,sizeof(char),21U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6D8,_tag_fat(_tmp269,sizeof(void*),0U));});});}_LL14F:;}}}}else{_LL14A: _LL14B:
# 1478
({void*_tmp26B=0U;({struct _fat_ptr _tmp6D9=({const char*_tmp26C="anal_Rexp: AggrArrow ptr";_tag_fat(_tmp26C,sizeof(char),25U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6D9,_tag_fat(_tmp26B,sizeof(void*),0U));});});}_LL147:;}}}case 6U: _LL5E: _tmp141=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_tmp142=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_tmp143=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp12C)->f3;_LL5F: {struct Cyc_Absyn_Exp*e1=_tmp141;struct Cyc_Absyn_Exp*e2=_tmp142;struct Cyc_Absyn_Exp*e3=_tmp143;
# 1482
...
struct _tuple17 _tmp27B=({struct _tuple17 _tmp5EA;_tmp5EA.f1=f2t,_tmp5EA.f2=f2r;_tmp5EA;});struct _tuple17 pr2=_tmp27B;
struct _tuple17 _tmp27C=({struct _tuple17 _tmp5E9;_tmp5E9.f1=f1f,_tmp5E9.f2=fenv->zero;_tmp5E9;});struct _tuple17 pr3=_tmp27C;
...
struct _tuple17 _tmp285=({struct _tuple17 _tmp5EC;_tmp5EC.f1=f2t,_tmp5EC.f2=f2r;_tmp5EC;});struct _tuple17 pr2=_tmp285;
struct _tuple17 _tmp286=({struct _tuple17 _tmp5EB;_tmp5EB.f1=f1t,_tmp5EB.f2=fenv->notzeroall;_tmp5EB;});struct _tuple17 pr3=_tmp286;
...
({void*_tmp28F=0U;({unsigned _tmp6DD=e2->loc;struct _fat_ptr _tmp6DC=({const char*_tmp290="expression may not be initialized";_tag_fat(_tmp290,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6DD,_tmp6DC,_tag_fat(_tmp28F,sizeof(void*),0U));});});{
...
return({struct _tuple17 _tmp5ED;_tmp5ED.f1=f2,_tmp5ED.f2=*((void**)_check_fat_subscript(rdict,sizeof(void*),(int)i));_tmp5ED;});}}else{_LL178: _LL179:
({void*_tmp29A=0U;({struct _fat_ptr _tmp6DE=({const char*_tmp29B="anal_Rexp: Subscript";_tag_fat(_tmp29B,sizeof(char),21U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6DE,_tag_fat(_tmp29A,sizeof(void*),0U));});});}_LL175:;}}case 3U: _LL16E: _LL16F: {
# 1529
...
union Cyc_CfFlowInfo_FlowInfo _tmp2A0=f3;if((_tmp2A0.BottomFL).tag == 1){_LL17E: _LL17F:
 return({struct _tuple17 _tmp5EE;_tmp5EE.f1=f3,_tmp5EE.f2=r;_tmp5EE;});}else{_LL180: _LL181:
 return({struct _tuple17 _tmp5EF;_tmp5EF.f1=f2,_tmp5EF.f2=r;_tmp5EF;});}_LL17D:;}}default: _LL170: _LL171:
# 1534
({void*_tmp2A1=0U;({struct _fat_ptr _tmp6DF=({const char*_tmp2A2="anal_Rexp: Subscript -- bad type";_tag_fat(_tmp2A2,sizeof(char),33U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6DF,_tag_fat(_tmp2A1,sizeof(void*),0U));});});}_LL16B:;}}}case 24U: _LL68: _tmp13A=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL69: {struct Cyc_List_List*es=_tmp13A;
# 1540
...
((int(*)(struct Cyc_List_List*x))Cyc_List_length)(es);void**_tmp2AA=_cycalloc(_check_times(_tmp2AB,sizeof(void*)));({{unsigned _tmp5F1=(unsigned)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(es);unsigned i;for(i=0;i < _tmp5F1;++ i){({
void*_tmp6E0=({void*_tmp2A9=(void*)((struct Cyc_List_List*)_check_null(rvals))->hd;void*temp=_tmp2A9;
rvals=rvals->tl;
temp;});
# 1543
_tmp2AA[i]=_tmp6E0;});}}0;});_tag_fat(_tmp2AA,sizeof(void*),_tmp2AB);});
# 1547
return({struct _tuple17 _tmp5F0;_tmp5F0.f1=f,({void*_tmp6E1=(void*)({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp2A8=_cycalloc(sizeof(*_tmp2A8));_tmp2A8->tag=6U,(_tmp2A8->f1).is_union=0,(_tmp2A8->f1).fieldnum=- 1,_tmp2A8->f2=aggrdict;_tmp2A8;});_tmp5F0.f2=_tmp6E1;});_tmp5F0;});}}case 30U: _LL6A: _tmp139=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmp12C)->f2;_LL6B: {struct Cyc_List_List*des=_tmp139;
# 1550
...
({void*_tmp2AF=0U;({struct _fat_ptr _tmp6E2=({const char*_tmp2B0="anal_Rexp:anon struct has bad type";_tag_fat(_tmp2B0,sizeof(char),35U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6E2,_tag_fat(_tmp2AF,sizeof(void*),0U));});});}_LL185:;}
# 1555
...
({void*_tmp2B8=0U;({struct _fat_ptr _tmp6E5=({const char*_tmp2B9="anal_Rexp:Aggregate_e";_tag_fat(_tmp2B9,sizeof(char),22U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6E5,_tag_fat(_tmp2B8,sizeof(void*),0U));});});}else{_LL190: _tmp2B7=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp2B6)->f1;_LL191: {struct _fat_ptr*fld=_tmp2B7;
# 1569
...
return({struct _tuple17 _tmp5F2;_tmp5F2.f1=f,_tmp5F2.f2=(void*)res;_tmp5F2;});}}}}else{goto _LL6E;}}else{_LL6E: _LL6F:
# 1583
({struct Cyc_String_pa_PrintArg_struct _tmp2BF=({struct Cyc_String_pa_PrintArg_struct _tmp5F3;_tmp5F3.tag=0U,({struct _fat_ptr _tmp6E6=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp5F3.f1=_tmp6E6;});_tmp5F3;});void*_tmp2BD[1U];_tmp2BD[0]=& _tmp2BF;({struct _fat_ptr _tmp6E7=({const char*_tmp2BE="anal_Rexp:missing aggrdeclimpl in %s";_tag_fat(_tmp2BE,sizeof(char),37U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6E7,_tag_fat(_tmp2BD,sizeof(void*),1U));});});}case 26U: _LL70: _tmp135=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL71: {struct Cyc_List_List*dles=_tmp135;
# 1585
...
union Cyc_CfFlowInfo_FlowInfo _tmp2C9=f1;struct Cyc_List_List*_tmp2CB;struct Cyc_Dict_Dict _tmp2CA;if((_tmp2C9.BottomFL).tag == 1){_LL199: _LL19A:
 return({struct _tuple17 _tmp5F5;_tmp5F5.f1=f1,_tmp5F5.f2=fenv->unknown_all;_tmp5F5;});}else{_LL19B: _tmp2CA=((_tmp2C9.ReachableFL).val).f1;_tmp2CB=((_tmp2C9.ReachableFL).val).f2;_LL19C: {struct Cyc_Dict_Dict d1=_tmp2CA;struct Cyc_List_List*relns=_tmp2CB;
# 1598
if((int)Cyc_CfFlowInfo_initlevel(env->fenv,d1,r1)== (int)Cyc_CfFlowInfo_NoneIL)
({void*_tmp2CC=0U;({unsigned _tmp6EA=e1->loc;struct _fat_ptr _tmp6E9=({const char*_tmp2CD="expression may not be initialized";_tag_fat(_tmp2CD,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6EA,_tmp6E9,_tag_fat(_tmp2CC,sizeof(void*),0U));});});{
# 1602
...
void*_tmp2CE=r1;switch(*((int*)_tmp2CE)){case 0U: _LL19E: _LL19F:
 return({struct _tuple17 _tmp5F6;_tmp5F6.f1=f1,_tmp5F6.f2=fenv->unknown_all;_tmp5F6;});case 1U: _LL1A0: _LL1A1:
 goto _LL1A3;case 4U: _LL1A2: _LL1A3: {
# 1615
struct Cyc_List_List _tmp2CF=({struct Cyc_List_List _tmp5F9;_tmp5F9.hd=vd,_tmp5F9.tl=0;_tmp5F9;});struct Cyc_List_List l=_tmp2CF;
...
{union Cyc_CfFlowInfo_FlowInfo _tmp2D4=f2;struct Cyc_Dict_Dict _tmp2D5;if((_tmp2D4.BottomFL).tag == 1){_LL1AA: _LL1AB:
 return({struct _tuple17 _tmp5F7;_tmp5F7.f1=f2,_tmp5F7.f2=fenv->unknown_all;_tmp5F7;});}else{_LL1AC: _tmp2D5=((_tmp2D4.ReachableFL).val).f1;_LL1AD: {struct Cyc_Dict_Dict d2=_tmp2D5;
# 1622
if((int)Cyc_CfFlowInfo_initlevel(fenv,d2,r2)!= (int)Cyc_CfFlowInfo_AllIL){
({void*_tmp2D6=0U;({unsigned _tmp6EC=e1->loc;struct _fat_ptr _tmp6EB=({const char*_tmp2D7="expression may not be initialized";_tag_fat(_tmp2D7,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6EC,_tmp6EB,_tag_fat(_tmp2D6,sizeof(void*),0U));});});
return({struct _tuple17 _tmp5F8;({union Cyc_CfFlowInfo_FlowInfo _tmp6ED=Cyc_CfFlowInfo_BottomFL();_tmp5F8.f1=_tmp6ED;}),_tmp5F8.f2=fenv->unknown_all;_tmp5F8;});}}}_LL1A9:;}
# 1627
f1=f2;
goto _LL1A5;}}}default: _LL1A4: _LL1A5:
# 1630
 while(1){
struct Cyc_List_List _tmp2D8=({struct Cyc_List_List _tmp5FB;_tmp5FB.hd=vd,_tmp5FB.tl=0;_tmp5FB;});struct Cyc_List_List l=_tmp2D8;
f1=Cyc_NewControlFlow_add_vars(fenv,f1,& l,fenv->unknown_all,e->loc,0);{
...
# 1637
if((int)Cyc_CfFlowInfo_initlevel(fenv,d2,r2)!= (int)Cyc_CfFlowInfo_AllIL){
({void*_tmp2DF=0U;({unsigned _tmp6EF=e1->loc;struct _fat_ptr _tmp6EE=({const char*_tmp2E0="expression may not be initialized";_tag_fat(_tmp2E0,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp6EF,_tmp6EE,_tag_fat(_tmp2DF,sizeof(void*),0U));});});
return({struct _tuple17 _tmp5FA;({union Cyc_CfFlowInfo_FlowInfo _tmp6F0=Cyc_CfFlowInfo_BottomFL();_tmp5FA.f1=_tmp6F0;}),_tmp5FA.f2=fenv->unknown_all;_tmp5FA;});}}}_LL1B1:;}{
# 1642
...
union Cyc_CfFlowInfo_FlowInfo _tmp2E5=outflow;struct Cyc_List_List*_tmp2E7;struct Cyc_Dict_Dict _tmp2E6;if((_tmp2E5.BottomFL).tag == 1){_LL1BA: _LL1BB:
 return({struct _tuple17 _tmp5FD;_tmp5FD.f1=outflow,_tmp5FD.f2=rval;_tmp5FD;});}else{_LL1BC: _tmp2E6=((_tmp2E5.ReachableFL).val).f1;_tmp2E7=((_tmp2E5.ReachableFL).val).f2;_LL1BD: {struct Cyc_Dict_Dict d2=_tmp2E6;struct Cyc_List_List*relns=_tmp2E7;
# 1668
return({struct _tuple17 _tmp5FE;({union Cyc_CfFlowInfo_FlowInfo _tmp6F2=({struct Cyc_Dict_Dict _tmp6F1=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(d2,root,place_val);Cyc_CfFlowInfo_ReachableFL(_tmp6F1,relns);});_tmp5FE.f1=_tmp6F2;}),_tmp5FE.f2=rval;_tmp5FE;});}}_LL1B9:;}}}}case 37U: _LL76: _tmp12D=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp12C)->f1;_LL77: {struct Cyc_Absyn_Stmt*s=_tmp12D;
# 1672
struct _tuple18 _tmp2EB=({struct _tuple18 _tmp600;_tmp600.f1=(env->fenv)->unknown_all,_tmp600.f2=copy_ctxt;_tmp600;});struct _tuple18 rval_opt=_tmp2EB;
...
return({struct _tuple17 _tmp5FF;_tmp5FF.f1=f,_tmp5FF.f2=rval_opt.f1;_tmp5FF;});}case 36U: _LL7A: _LL7B:
# 1677
 goto _LL7D;case 25U: _LL7C: _LL7D:
 goto _LL7F;default: _LL7E: _LL7F:
# 1680
({void*_tmp2ED=0U;({struct _fat_ptr _tmp6F3=({const char*_tmp2EE="anal_Rexp, unexpected exp form";_tag_fat(_tmp2EE,sizeof(char),31U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6F3,_tag_fat(_tmp2ED,sizeof(void*),0U));});});}_LLD:;}}
...
union Cyc_CfFlowInfo_FlowInfo _tmp2F3=f;struct Cyc_List_List*_tmp2F5;struct Cyc_Dict_Dict _tmp2F4;if((_tmp2F3.BottomFL).tag == 1){_LL6: _LL7:
 return({struct _tuple19 _tmp601;_tmp601.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp6F4=Cyc_CfFlowInfo_UnknownL();_tmp601.f2=_tmp6F4;});_tmp601;});}else{_LL8: _tmp2F4=((_tmp2F3.ReachableFL).val).f1;_tmp2F5=((_tmp2F3.ReachableFL).val).f2;_LL9: {struct Cyc_Dict_Dict outdict=_tmp2F4;struct Cyc_List_List*relns=_tmp2F5;
# 1708
...
# 1711
({void*_tmp300=0U;({struct _fat_ptr _tmp6F5=({const char*_tmp301="named location in anal_derefL";_tag_fat(_tmp301,sizeof(char),30U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp6F5,_tag_fat(_tmp300,sizeof(void*),0U));});});case 1U: _LL10: _LL11:
# 1713
({void*_tmp6F6=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp302=_cycalloc(sizeof(*_tmp302));_tmp302->tag=Cyc_CfFlowInfo_NotZero,_tmp302->f1=relns;_tmp302;});e->annot=_tmp6F6;});goto _LLD;case 5U: _LL12: _tmp2FF=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp2FA)->f1;_LL13: {void*rv=_tmp2FF;
# 1716
if(expanded_place_possibly_null)
# 1719
({void*_tmp6F7=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp303=_cycalloc(sizeof(*_tmp303));_tmp303->tag=Cyc_CfFlowInfo_UnknownZ,_tmp303->f1=relns;_tmp303;});e->annot=_tmp6F7;});else{
# 1722
...
# 1726
({void*_tmp6F8=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp306=_cycalloc(sizeof(*_tmp306));_tmp306->tag=Cyc_CfFlowInfo_UnknownZ,_tmp306->f1=relns;_tmp306;});e->annot=_tmp6F8;});
goto _LL1E;}else{_LL21: _LL22:
# 1729
({void*_tmp6F9=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp307=_cycalloc(sizeof(*_tmp307));_tmp307->tag=Cyc_CfFlowInfo_NotZero,_tmp307->f1=relns;_tmp307;});e->annot=_tmp6F9;});
goto _LL1E;}_LL1E:;}
# 1734
if(Cyc_Tcutil_is_bound_one(bd))return({struct _tuple19 _tmp602;_tmp602.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp6FA=Cyc_CfFlowInfo_UnknownL();_tmp602.f2=_tmp6FA;});_tmp602;});
...
# 1738
({void*_tmp6FB=(void*)({struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp308=_cycalloc(sizeof(*_tmp308));_tmp308->tag=Cyc_CfFlowInfo_NotZero,_tmp308->f1=relns;_tmp308;});e->annot=_tmp6FB;});
if(Cyc_Tcutil_is_bound_one(bd))
return({struct _tuple19 _tmp603;_tmp603.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp6FD=Cyc_CfFlowInfo_PlaceL(({struct Cyc_CfFlowInfo_Place*_tmp309=_cycalloc(sizeof(*_tmp309));_tmp309->root=root,({struct Cyc_List_List*_tmp6FC=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(path2,path);_tmp309->path=_tmp6FC;});_tmp309;}));_tmp603.f2=_tmp6FD;});_tmp603;});
goto _LLD;}case 0U: _LL16: _LL17:
# 1743
 e->annot=(void*)& Cyc_CfFlowInfo_IsZero_val;
return({struct _tuple19 _tmp604;({union Cyc_CfFlowInfo_FlowInfo _tmp6FF=Cyc_CfFlowInfo_BottomFL();_tmp604.f1=_tmp6FF;}),({union Cyc_CfFlowInfo_AbsLVal _tmp6FE=Cyc_CfFlowInfo_UnknownL();_tmp604.f2=_tmp6FE;});_tmp604;});case 2U: _LL18: _tmp2FC=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp2FA)->f1;_LL19: {enum Cyc_CfFlowInfo_InitLevel il=_tmp2FC;
# 1748
if(Cyc_Tcutil_is_bound_one(bd))
f=Cyc_NewControlFlow_notzero(env,inflow,f,e,il,names);
({void*_tmp700=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp30A=_cycalloc(sizeof(*_tmp30A));_tmp30A->tag=Cyc_CfFlowInfo_UnknownZ,_tmp30A->f1=relns;_tmp30A;});e->annot=_tmp700;});
...
# 1758
({void*_tmp701=(void*)({struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp30B=_cycalloc(sizeof(*_tmp30B));_tmp30B->tag=Cyc_CfFlowInfo_UnknownZ,_tmp30B->f1=relns;_tmp30B;});e->annot=_tmp701;});
goto _LLD;}_LLD:;}
# 1761
...
# 1765
({void*_tmp310=0U;({unsigned _tmp703=e->loc;struct _fat_ptr _tmp702=({const char*_tmp311="attempt to dereference an alias-free that has already been copied";_tag_fat(_tmp311,sizeof(char),66U);});Cyc_CfFlowInfo_aerr(_tmp703,_tmp702,_tag_fat(_tmp310,sizeof(void*),0U));});});
goto _LL26;}else{_LL29: _LL2A:
# 1768
({void*_tmp312=0U;({unsigned _tmp705=e->loc;struct _fat_ptr _tmp704=({const char*_tmp313="dereference of possibly uninitialized pointer";_tag_fat(_tmp313,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp705,_tmp704,_tag_fat(_tmp312,sizeof(void*),0U));});});
goto _LL26;}_LL26:;}}
# 1772
return({struct _tuple19 _tmp605;_tmp605.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp706=Cyc_CfFlowInfo_UnknownL();_tmp605.f2=_tmp706;});_tmp605;});}}}_LL5:;}}else{_LL3: _LL4:
# 1774
({void*_tmp314=0U;({struct _fat_ptr _tmp707=({const char*_tmp315="left deref of non-pointer-type";_tag_fat(_tmp315,sizeof(char),31U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp707,_tag_fat(_tmp314,sizeof(void*),0U));});});}_LL0:;}
# 1780
...
path=({struct Cyc_List_List*_tmp31A=_cycalloc(sizeof(*_tmp31A));({void*_tmp708=(void*)({struct Cyc_CfFlowInfo_Star_CfFlowInfo_PathCon_struct*_tmp319=_cycalloc(sizeof(*_tmp319));_tmp319->tag=1U;_tmp319;});_tmp31A->hd=_tmp708;}),_tmp31A->tl=path;_tmp31A;});
return({struct Cyc_CfFlowInfo_Place*_tmp31B=_cycalloc(sizeof(*_tmp31B));_tmp31B->root=proot,({struct Cyc_List_List*_tmp709=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(ppath,path);_tmp31B->path=_tmp709;});_tmp31B;});}}
# 1790
...
{union Cyc_CfFlowInfo_FlowInfo _tmp31D=inflow;struct Cyc_List_List*_tmp31F;struct Cyc_Dict_Dict _tmp31E;if((_tmp31D.BottomFL).tag == 1){_LL1: _LL2:
 return({struct _tuple19 _tmp606;({union Cyc_CfFlowInfo_FlowInfo _tmp70B=Cyc_CfFlowInfo_BottomFL();_tmp606.f1=_tmp70B;}),({union Cyc_CfFlowInfo_AbsLVal _tmp70A=Cyc_CfFlowInfo_UnknownL();_tmp606.f2=_tmp70A;});_tmp606;});}else{_LL3: _tmp31E=((_tmp31D.ReachableFL).val).f1;_tmp31F=((_tmp31D.ReachableFL).val).f2;_LL4: {struct Cyc_Dict_Dict d2=_tmp31E;struct Cyc_List_List*relns=_tmp31F;
# 1799
d=d2;}}_LL0:;}{
# 1803
...
# 1809
if((int)vd->sc == (int)Cyc_Absyn_Static)
return({struct _tuple19 _tmp607;_tmp607.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp70C=Cyc_CfFlowInfo_UnknownL();_tmp607.f2=_tmp70C;});_tmp607;});
...
# 1814
return({struct _tuple19 _tmp608;_tmp608.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp70E=Cyc_CfFlowInfo_PlaceL(({struct Cyc_CfFlowInfo_Place*_tmp331=_cycalloc(sizeof(*_tmp331));({void*_tmp70D=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp330=_cycalloc(sizeof(*_tmp330));_tmp330->tag=0U,_tmp330->f1=vd;_tmp330;});_tmp331->root=_tmp70D;}),_tmp331->path=path;_tmp331;}));_tmp608.f2=_tmp70E;});_tmp608;});}case 1U: _LL12: _tmp329=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp321)->f1)->f1;_LL13: {struct Cyc_Absyn_Vardecl*vd=_tmp329;
# 1816
return({struct _tuple19 _tmp609;_tmp609.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp70F=Cyc_CfFlowInfo_UnknownL();_tmp609.f2=_tmp70F;});_tmp609;});}default: goto _LL1C;}case 22U: _LL14: _tmp327=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp321)->f1;_tmp328=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp321)->f2;_LL15: {struct Cyc_Absyn_Exp*e1=_tmp327;struct _fat_ptr*f=_tmp328;
# 1819
...
path=({struct Cyc_List_List*_tmp336=_cycalloc(sizeof(*_tmp336));({void*_tmp711=(void*)({struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*_tmp335=_cycalloc(sizeof(*_tmp335));_tmp335->tag=0U,({int _tmp710=Cyc_CfFlowInfo_get_field_index(t2,f);_tmp335->f1=_tmp710;});_tmp335;});_tmp336->hd=_tmp711;}),_tmp336->tl=path;_tmp336;});}
# 1825
goto _LL1E;}}else{_LL21: _LL22:
({void*_tmp337=0U;({struct _fat_ptr _tmp712=({const char*_tmp338="anal_Lexp: AggrArrow ptr";_tag_fat(_tmp338,sizeof(char),25U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp712,_tag_fat(_tmp337,sizeof(void*),0U));});});}_LL1E:;}
# 1828
...
# 1843
({void*_tmp34B=0U;({struct _fat_ptr _tmp713=({const char*_tmp34C="bad named location in anal_Lexp:deref";_tag_fat(_tmp34C,sizeof(char),38U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp713,_tag_fat(_tmp34B,sizeof(void*),0U));});});}case 7U: switch(*((int*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp348)->f3)){case 4U: _LL31: _LL32:
...
return({struct _tuple19 _tmp60A;_tmp60A.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp714=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(p,path));_tmp60A.f2=_tmp714;});_tmp60A;});}}case 1U: _LL39: _LL3A:
# 1854
...
void*res=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp355=_cycalloc(sizeof(*_tmp355));_tmp355->tag=5U,({void*_tmp717=({struct Cyc_CfFlowInfo_FlowEnv*_tmp716=fenv;void*_tmp715=Cyc_Tcutil_pointer_elt_type((void*)_check_null(e1->topt));Cyc_CfFlowInfo_typ_to_absrval(_tmp716,_tmp715,0,leaf);});_tmp355->f1=_tmp717;});_tmp355;});
for(0;names != 0;names=names->tl){
...
# 1876
return({struct _tuple19 _tmp60B;_tmp60B.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp718=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(p,path));_tmp60B.f2=_tmp718;});_tmp60B;});}}}}_LL2E:;}else{
# 1880
...
return({struct _tuple19 _tmp60C;_tmp60C.f1=f,({union Cyc_CfFlowInfo_AbsLVal _tmp719=Cyc_CfFlowInfo_PlaceL(Cyc_NewControlFlow_make_expanded_place(p,path));_tmp60C.f2=_tmp719;});_tmp60C;});}}default: _LL48: _LL49:
# 1889
 goto _LL43;}_LL43:;}
# 1892
...
return({struct Cyc_NewControlFlow_AnalEnv*_tmp71F=env;union Cyc_CfFlowInfo_FlowInfo _tmp71E=inflow;int _tmp71D=expand_unique;int _tmp71C=passthrough_consumes;struct Cyc_Absyn_Exp*_tmp71B=e1;Cyc_NewControlFlow_anal_Lexp_rec(_tmp71F,_tmp71E,_tmp71D,_tmp71C,_tmp71B,({struct Cyc_List_List*_tmp362=_cycalloc(sizeof(*_tmp362));
({void*_tmp71A=(void*)({struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*_tmp361=_cycalloc(sizeof(*_tmp361));_tmp361->tag=0U,_tmp361->f1=(int)fld;_tmp361;});_tmp362->hd=_tmp71A;}),_tmp362->tl=path;_tmp362;}));});}case 3U: _LL53: _LL54: {
# 1908
struct _tuple24 _tmp363=({struct Cyc_NewControlFlow_AnalEnv*_tmp721=env;union Cyc_CfFlowInfo_FlowInfo _tmp720=inflow;Cyc_NewControlFlow_anal_Rexps(_tmp721,_tmp720,({struct Cyc_Absyn_Exp*_tmp373[2U];_tmp373[0]=e1,_tmp373[1]=e2;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp373,sizeof(struct Cyc_Absyn_Exp*),2U));}),0,1);});struct _tuple24 _stmttmp64=_tmp363;struct _tuple24 _tmp364=_stmttmp64;struct Cyc_List_List*_tmp366;union Cyc_CfFlowInfo_FlowInfo _tmp365;_LL58: _tmp365=_tmp364.f1;_tmp366=_tmp364.f2;_LL59: {union Cyc_CfFlowInfo_FlowInfo f=_tmp365;struct Cyc_List_List*rvals=_tmp366;
...
({void*_tmp36B=0U;({unsigned _tmp723=e2->loc;struct _fat_ptr _tmp722=({const char*_tmp36C="expression may not be initialized";_tag_fat(_tmp36C,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp723,_tmp722,_tag_fat(_tmp36B,sizeof(void*),0U));});});{
...
union Cyc_CfFlowInfo_FlowInfo _tmp372=f3;if((_tmp372.BottomFL).tag == 1){_LL63: _LL64:
 return({struct _tuple19 _tmp60E;_tmp60E.f1=f3,_tmp60E.f2=r;_tmp60E;});}else{_LL65: _LL66:
 return({struct _tuple19 _tmp60F;_tmp60F.f1=f2,_tmp60F.f2=r;_tmp60F;});}_LL62:;}}}}default: _LL55: _LL56:
# 1926
({void*_tmp374=0U;({struct _fat_ptr _tmp724=({const char*_tmp375="anal_Lexp: Subscript -- bad type";_tag_fat(_tmp375,sizeof(char),33U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp724,_tag_fat(_tmp374,sizeof(void*),0U));});});}_LL50:;}case 21U: _LL1A: _tmp322=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp321)->f1;_tmp323=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp321)->f2;_LL1B: {struct Cyc_Absyn_Exp*e1=_tmp322;struct _fat_ptr*fld=_tmp323;
# 1930
...
# 1934
if(Cyc_Absyn_is_nontagged_nonrequire_union_type(e1_type))
return({struct _tuple19 _tmp610;_tmp610.f1=inflow,({union Cyc_CfFlowInfo_AbsLVal _tmp725=Cyc_CfFlowInfo_UnknownL();_tmp610.f2=_tmp725;});_tmp610;});
# 1937
return({struct Cyc_NewControlFlow_AnalEnv*_tmp72C=env;union Cyc_CfFlowInfo_FlowInfo _tmp72B=inflow;int _tmp72A=expand_unique;int _tmp729=passthrough_consumes;struct Cyc_Absyn_Exp*_tmp728=e1;Cyc_NewControlFlow_anal_Lexp_rec(_tmp72C,_tmp72B,_tmp72A,_tmp729,_tmp728,({struct Cyc_List_List*_tmp378=_cycalloc(sizeof(*_tmp378));
({void*_tmp727=(void*)({struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*_tmp377=_cycalloc(sizeof(*_tmp377));_tmp377->tag=0U,({int _tmp726=Cyc_CfFlowInfo_get_field_index(e1_type,fld);_tmp377->f1=_tmp726;});_tmp377;});_tmp378->hd=_tmp727;}),_tmp378->tl=path;_tmp378;}));});}default: _LL1C: _LL1D:
# 1941
 return({struct _tuple19 _tmp611;({union Cyc_CfFlowInfo_FlowInfo _tmp72E=Cyc_CfFlowInfo_BottomFL();_tmp611.f1=_tmp72E;}),({union Cyc_CfFlowInfo_AbsLVal _tmp72D=Cyc_CfFlowInfo_UnknownL();_tmp611.f2=_tmp72D;});_tmp611;});}_LL5:;}}
# 1945
...
return({struct _tuple19 _tmp612;_tmp612.f1=f,_tmp612.f2=r;_tmp612;});}}
# 1956
...
union Cyc_CfFlowInfo_FlowInfo _tmp38A=f;struct Cyc_List_List*_tmp38C;struct Cyc_Dict_Dict _tmp38B;if((_tmp38A.BottomFL).tag == 1){_LL7: _LL8:
 return({struct _tuple20 _tmp613;_tmp613.f1=f,_tmp613.f2=f;_tmp613;});}else{_LL9: _tmp38B=((_tmp38A.ReachableFL).val).f1;_tmp38C=((_tmp38A.ReachableFL).val).f2;_LLA: {struct Cyc_Dict_Dict d=_tmp38B;struct Cyc_List_List*relns=_tmp38C;
# 1990
...
({void*_tmp38F=0U;({unsigned _tmp730=((struct Cyc_Absyn_Exp*)es->hd)->loc;struct _fat_ptr _tmp72F=({const char*_tmp390="expression may not be initialized";_tag_fat(_tmp390,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp730,_tmp72F,_tag_fat(_tmp38F,sizeof(void*),0U));});});
if((int)Cyc_CfFlowInfo_initlevel(env->fenv,d,r2)== (int)Cyc_CfFlowInfo_NoneIL && !Cyc_CfFlowInfo_is_init_pointer(r1))
({void*_tmp391=0U;({unsigned _tmp732=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es->tl))->hd)->loc;struct _fat_ptr _tmp731=({const char*_tmp392="expression may not be initialized";_tag_fat(_tmp392,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp732,_tmp731,_tag_fat(_tmp391,sizeof(void*),0U));});});{
# 1997
...
struct _tuple0 _tmp39D=({struct _tuple0 _tmp614;_tmp614.f1=r1,_tmp614.f2=r2;_tmp614;});struct _tuple0 _stmttmp6C=_tmp39D;struct _tuple0 _tmp39E=_stmttmp6C;enum Cyc_CfFlowInfo_InitLevel _tmp39F;enum Cyc_CfFlowInfo_InitLevel _tmp3A0;switch(*((int*)_tmp39E.f1)){case 2U: if(((struct Cyc_CfFlowInfo_Zero_CfFlowInfo_AbsRVal_struct*)_tmp39E.f2)->tag == 0U){_LL12: _tmp3A0=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp39E.f1)->f1;_LL13: {enum Cyc_CfFlowInfo_InitLevel il=_tmp3A0;
# 2007
...
({void*_tmp3A6=0U;({struct _fat_ptr _tmp733=({const char*_tmp3A7="anal_test, zero-split";_tag_fat(_tmp3A7,sizeof(char),22U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp733,_tag_fat(_tmp3A6,sizeof(void*),0U));});});}_LL25:;}
# 2013
...
({void*_tmp3AD=0U;({struct _fat_ptr _tmp734=({const char*_tmp3AE="anal_test, zero-split";_tag_fat(_tmp3AE,sizeof(char),22U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp734,_tag_fat(_tmp3AD,sizeof(void*),0U));});});}_LL2F:;}
# 2021
...
goto _LL11;}else{goto _LL20;}default: _LL20: _LL21:
 goto _LL11;}_LL11:;}}}
# 2042
{struct _tuple28 _tmp3AF=({struct _tuple28 _tmp616;_tmp616.f1=p,({
void*_tmp736=Cyc_Absyn_compress((void*)_check_null(e1->topt));_tmp616.f2=_tmp736;}),({
void*_tmp735=Cyc_Absyn_compress((void*)_check_null(e2->topt));_tmp616.f3=_tmp735;});_tmp616;});
# 2042
...
# 2050
 ...
 return({struct _tuple20 _tmp615;_tmp615.f1=ft,_tmp615.f2=ff;_tmp615;});}}}_LL36:;}
# 2055
{enum Cyc_Absyn_Primop _tmp3B1=p;switch(_tmp3B1){case Cyc_Absyn_Eq: _LL46: _LL47:
 ...
 return({struct _tuple20 _tmp617;_tmp617.f1=ft,_tmp617.f2=ff;_tmp617;});}_LL45:;}{
# 2060
...
# 2071
struct Cyc_List_List*_tmp3B9=({struct _RegionHandle*_tmp73A=r;union Cyc_Relations_RelnOp _tmp739=n2;enum Cyc_Relations_Relation _tmp738=Cyc_Relations_flip_relation(relation);union Cyc_Relations_RelnOp _tmp737=n1;Cyc_Relations_add_relation(_tmp73A,_tmp739,_tmp738,_tmp737,relns);});struct Cyc_List_List*relns_false=_tmp3B9;
struct _tuple20 _tmp3BA=({struct _tuple20 _tmp61C;_tmp61C.f1=ft,_tmp61C.f2=ff;_tmp61C;});struct _tuple20 _stmttmp71=_tmp3BA;struct _tuple20 _tmp3BB=_stmttmp71;struct Cyc_Dict_Dict _tmp3BC;struct Cyc_Dict_Dict _tmp3BD;struct Cyc_Dict_Dict _tmp3BF;struct Cyc_Dict_Dict _tmp3BE;if(((_tmp3BB.f1).ReachableFL).tag == 2){if(((_tmp3BB.f2).ReachableFL).tag == 2){_LL58: _tmp3BE=(((_tmp3BB.f1).ReachableFL).val).f1;_tmp3BF=(((_tmp3BB.f2).ReachableFL).val).f1;_LL59: {struct Cyc_Dict_Dict dt=_tmp3BE;struct Cyc_Dict_Dict df=_tmp3BF;
# 2074
return({struct _tuple20 _tmp618;({union Cyc_CfFlowInfo_FlowInfo _tmp73C=Cyc_CfFlowInfo_ReachableFL(dt,relns_true);_tmp618.f1=_tmp73C;}),({union Cyc_CfFlowInfo_FlowInfo _tmp73B=Cyc_CfFlowInfo_ReachableFL(df,relns_false);_tmp618.f2=_tmp73B;});_tmp618;});}}else{_LL5C: _tmp3BD=(((_tmp3BB.f1).ReachableFL).val).f1;_LL5D: {struct Cyc_Dict_Dict dt=_tmp3BD;
# 2078
return({struct _tuple20 _tmp619;({union Cyc_CfFlowInfo_FlowInfo _tmp73D=Cyc_CfFlowInfo_ReachableFL(dt,relns_true);_tmp619.f1=_tmp73D;}),_tmp619.f2=ff;_tmp619;});}}}else{if(((_tmp3BB.f2).ReachableFL).tag == 2){_LL5A: _tmp3BC=(((_tmp3BB.f2).ReachableFL).val).f1;_LL5B: {struct Cyc_Dict_Dict df=_tmp3BC;
# 2076
return({struct _tuple20 _tmp61A;_tmp61A.f1=ft,({union Cyc_CfFlowInfo_FlowInfo _tmp73E=Cyc_CfFlowInfo_ReachableFL(df,relns_false);_tmp61A.f2=_tmp73E;});_tmp61A;});}}else{_LL5E: _LL5F:
# 2080
 return({struct _tuple20 _tmp61B;_tmp61B.f1=ft,_tmp61B.f2=ff;_tmp61B;});}}_LL57:;}else{
# 2083
return({struct _tuple20 _tmp61D;_tmp61D.f1=ft,_tmp61D.f2=ff;_tmp61D;});}}}}}}_LL6:;}}}
# 2089
...
return({struct _tuple20 _tmp61E;({union Cyc_CfFlowInfo_FlowInfo _tmp740=Cyc_CfFlowInfo_join_flow(fenv,f2t,f3t);_tmp61E.f1=_tmp740;}),({
union Cyc_CfFlowInfo_FlowInfo _tmp73F=Cyc_CfFlowInfo_join_flow(fenv,f2f,f3f);_tmp61E.f2=_tmp73F;});_tmp61E;});}}}}case 7U: _LL3: _tmp3CA=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp3C2)->f1;_tmp3CB=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp3C2)->f2;_LL4: {struct Cyc_Absyn_Exp*e1=_tmp3CA;struct Cyc_Absyn_Exp*e2=_tmp3CB;
# 2099
...
return({struct _tuple20 _tmp61F;_tmp61F.f1=f2t,({union Cyc_CfFlowInfo_FlowInfo _tmp741=Cyc_CfFlowInfo_join_flow(fenv,f1f,f2f);_tmp61F.f2=_tmp741;});_tmp61F;});}}}case 8U: _LL5: _tmp3C8=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp3C2)->f1;_tmp3C9=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp3C2)->f2;_LL6: {struct Cyc_Absyn_Exp*e1=_tmp3C8;struct Cyc_Absyn_Exp*e2=_tmp3C9;
# 2103
...
return({struct _tuple20 _tmp620;({union Cyc_CfFlowInfo_FlowInfo _tmp742=Cyc_CfFlowInfo_join_flow(fenv,f1t,f2t);_tmp620.f1=_tmp742;}),_tmp620.f2=f2f;_tmp620;});}}}case 9U: _LL7: _tmp3C6=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp3C2)->f1;_tmp3C7=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp3C2)->f2;_LL8: {struct Cyc_Absyn_Exp*e1=_tmp3C6;struct Cyc_Absyn_Exp*e2=_tmp3C7;
# 2107
...
return({struct _tuple20 _tmp621;_tmp621.f1=f2,_tmp621.f2=f1;_tmp621;});}}}else{goto _LLB;}}else{goto _LLB;}}else{_LLB: _tmp3C3=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp3C2)->f1;_tmp3C4=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp3C2)->f2;_LLC: {enum Cyc_Absyn_Primop p=_tmp3C3;struct Cyc_List_List*es=_tmp3C4;
# 2113
...
union Cyc_CfFlowInfo_FlowInfo _tmp3F7=f;struct Cyc_Dict_Dict _tmp3F8;if((_tmp3F7.BottomFL).tag == 1){_LL2E: _LL2F:
 return({struct _tuple20 _tmp622;_tmp622.f1=f,_tmp622.f2=f;_tmp622;});}else{_LL30: _tmp3F8=((_tmp3F7.ReachableFL).val).f1;_LL31: {struct Cyc_Dict_Dict d=_tmp3F8;
# 2121
...
# 2124
({void*_tmp401=0U;({struct _fat_ptr _tmp743=({const char*_tmp402="anal_test: bad namedlocation";_tag_fat(_tmp402,sizeof(char),29U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp743,_tag_fat(_tmp401,sizeof(void*),0U));});});}case 0U: _LL38: _LL39:
 return({struct _tuple20 _tmp623;({union Cyc_CfFlowInfo_FlowInfo _tmp744=Cyc_CfFlowInfo_BottomFL();_tmp623.f1=_tmp744;}),_tmp623.f2=f;_tmp623;});case 1U: _LL3A: _LL3B:
 goto _LL3D;case 5U: _LL3C: _LL3D:
 goto _LL3F;case 4U: _LL3E: _LL3F:
 return({struct _tuple20 _tmp624;_tmp624.f1=f,({union Cyc_CfFlowInfo_FlowInfo _tmp745=Cyc_CfFlowInfo_BottomFL();_tmp624.f2=_tmp745;});_tmp624;});case 2U: if(((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp3FD)->f1 == Cyc_CfFlowInfo_NoneIL){_LL40: _LL41:
...
# 2135
 return({struct _tuple20 _tmp625;_tmp625.f1=f,_tmp625.f2=f;_tmp625;});}case 7U: _LL44: _LL45:
# 2132
({void*_tmp403=0U;({unsigned _tmp747=e->loc;struct _fat_ptr _tmp746=({const char*_tmp404="expression may not be initialized";_tag_fat(_tmp404,sizeof(char),34U);});Cyc_CfFlowInfo_aerr(_tmp747,_tmp746,_tag_fat(_tmp403,sizeof(void*),0U));});});
return({struct _tuple20 _tmp626;({union Cyc_CfFlowInfo_FlowInfo _tmp749=Cyc_CfFlowInfo_BottomFL();_tmp626.f1=_tmp749;}),({union Cyc_CfFlowInfo_FlowInfo _tmp748=Cyc_CfFlowInfo_BottomFL();_tmp626.f2=_tmp748;});_tmp626;});default: _LL4A: _LL4B:
# 2136
({void*_tmp405=0U;({struct _fat_ptr _tmp74A=({const char*_tmp406="anal_test";_tag_fat(_tmp406,sizeof(char),10U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp74A,_tag_fat(_tmp405,sizeof(void*),0U));});});}_LL35:;}}}_LL2D:;}}}_LL0:;}struct _tuple29{unsigned f1;struct Cyc_NewControlFlow_AnalEnv*f2;struct Cyc_Dict_Dict f3;};
# 2142
...
# 2154
({struct Cyc_String_pa_PrintArg_struct _tmp413=({struct Cyc_String_pa_PrintArg_struct _tmp627;_tmp627.tag=0U,({struct _fat_ptr _tmp74B=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp627.f1=_tmp74B;});_tmp627;});void*_tmp411[1U];_tmp411[0]=& _tmp413;({unsigned _tmp74D=loc;struct _fat_ptr _tmp74C=({const char*_tmp412="unique pointers reachable from %s may become unreachable";_tag_fat(_tmp412,sizeof(char),57U);});Cyc_Warn_warn(_tmp74D,_tmp74C,_tag_fat(_tmp411,sizeof(void*),1U));});});
goto _LLB;}_LLB:;}}
# 2158
goto _LL3;}}else{_LL6: _LL7:
 goto _LL3;}_LL3:;}}
...
if((int)({struct Cyc_CfFlowInfo_FlowEnv*_tmp74F=env->fenv;struct Cyc_Dict_Dict _tmp74E=d;Cyc_CfFlowInfo_initlevel(_tmp74F,_tmp74E,Cyc_CfFlowInfo_lookup_place(d,(struct Cyc_CfFlowInfo_Place*)inits->hd));})!= (int)Cyc_CfFlowInfo_AllIL)
({void*_tmp417=0U;({unsigned _tmp751=loc;struct _fat_ptr _tmp750=({const char*_tmp418="function may not initialize all the parameters with attribute 'initializes'";_tag_fat(_tmp418,sizeof(char),76U);});Cyc_CfFlowInfo_aerr(_tmp751,_tmp750,_tag_fat(_tmp417,sizeof(void*),0U));});});}}
# 2171
if(Cyc_Flags_warn_lose_unique){
struct _tuple29 _tmp419=({struct _tuple29 _tmp628;_tmp628.f1=loc,_tmp628.f2=env,_tmp628.f3=d;_tmp628;});struct _tuple29 check_env=_tmp419;
...
# 2198
return({struct _tuple1 _tmp629;_tmp629.f1=roots,_tmp629.f2=es;_tmp629;});}struct _tuple30{int f1;void*f2;};
# 2204
...
({void*_tmp428=0U;({struct _fat_ptr _tmp752=({const char*_tmp429="noconsume_place_ok: flow became Bottom!";_tag_fat(_tmp429,sizeof(char),40U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp752,_tag_fat(_tmp428,sizeof(void*),0U));});});}else{_LL3: _tmp427=((_tmp426.ReachableFL).val).f1;_LL4: {struct Cyc_Dict_Dict d=_tmp427;
# 2219
...
# 2243
struct _fat_ptr _tmp753=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp62A.f1=_tmp753;});_tmp62A;});void*_tmp432[1U];_tmp432[0]=& _tmp434;({unsigned _tmp755=loc;struct _fat_ptr _tmp754=({const char*_tmp433="function consumes parameter %s which is does not have the 'consume' attribute";_tag_fat(_tmp433,sizeof(char),78U);});Cyc_CfFlowInfo_aerr(_tmp755,_tmp754,_tag_fat(_tmp432,sizeof(void*),1U));});});}else{
# 2246
...
# 2249
struct _fat_ptr _tmp756=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp62B.f1=_tmp756;});_tmp62B;});void*_tmp435[1U];_tmp435[0]=& _tmp437;({unsigned _tmp758=loc;struct _fat_ptr _tmp757=({const char*_tmp436="function consumes value pointed to by parameter %s, which does not have the 'consume' attribute";_tag_fat(_tmp436,sizeof(char),96U);});Cyc_CfFlowInfo_aerr(_tmp758,_tmp757,_tag_fat(_tmp435,sizeof(void*),1U));});});else{
# 2251
varok=1;}}}else{
# 2254
varok=1;}}else{
...
varok=1;else{
if(!do_unconsume)
({struct Cyc_String_pa_PrintArg_struct _tmp43A=({struct Cyc_String_pa_PrintArg_struct _tmp62C;_tmp62C.tag=0U,({
# 2266
struct _fat_ptr _tmp759=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp62C.f1=_tmp759;});_tmp62C;});void*_tmp438[1U];_tmp438[0]=& _tmp43A;({unsigned _tmp75B=loc;struct _fat_ptr _tmp75A=({const char*_tmp439="function parameter %s without 'consume' attribute no longer set to its original value";_tag_fat(_tmp439,sizeof(char),86U);});Cyc_CfFlowInfo_aerr(_tmp75B,_tmp75A,_tag_fat(_tmp438,sizeof(void*),1U));});});}
goto _LL5;}_LL5:;}
# 2273
return({struct _tuple30 _tmp62D;_tmp62D.f1=varok,_tmp62D.f2=rval;_tmp62D;});}}_LL0:;}
# 2279
...
if(fs != 0)
({void*_tmp43E=0U;({struct _fat_ptr _tmp75C=({const char*_tmp43F="unconsume_params: param to unconsume is non-variable";_tag_fat(_tmp43F,sizeof(char),53U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp75C,_tag_fat(_tmp43E,sizeof(void*),0U));});});{
...
({void*_tmp442=0U;({struct _fat_ptr _tmp75D=({const char*_tmp443="unconsume_params: root is not a varroot";_tag_fat(_tmp443,sizeof(char),40U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp75D,_tag_fat(_tmp442,sizeof(void*),0U));});});}_LL3:;}}}
...
struct Cyc_CfFlowInfo_FlowEnv*_tmp75F=env->fenv;struct _tuple17 _tmp75E=({struct _tuple17 _tmp62E;_tmp62E.f1=f,_tmp62E.f2=old_rval;_tmp62E;});Cyc_CfFlowInfo_join_flow_and_rval(_tmp75F,_tmp75E,({struct _tuple17 _tmp62F;_tmp62F.f1=f,_tmp62F.f2=ropt;_tmp62F;}));});
# 2343
...
# 2359
flow=({struct Cyc_Dict_Dict _tmp760=Cyc_CfFlowInfo_assign_place(env->fenv,loc,d2,p,new_rval);Cyc_CfFlowInfo_ReachableFL(_tmp760,relns);});
# 2363
goto _LL15;}}else{_LL18: _LL19:
# 2365
({void*_tmp457=0U;({struct _fat_ptr _tmp761=({const char*_tmp458="unconsume_params: joined flow became bot!";_tag_fat(_tmp458,sizeof(char),42U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp761,_tag_fat(_tmp457,sizeof(void*),0U));});});}_LL15:;}
# 2367
goto _LLD;}else{
# 2369
goto _LL11;}
...
# 2376
 if(ropt != 0 && !
Cyc_Tcutil_is_noalias_pointer_or_aggr(vd->type))
({struct Cyc_String_pa_PrintArg_struct _tmp45B=({struct Cyc_String_pa_PrintArg_struct _tmp630;_tmp630.tag=0U,({
struct _fat_ptr _tmp762=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(unconsume_exp));_tmp630.f1=_tmp762;});_tmp630;});void*_tmp459[1U];_tmp459[0]=& _tmp45B;({unsigned _tmp764=loc;struct _fat_ptr _tmp763=({const char*_tmp45A="aliased expression %s was overwritten";_tag_fat(_tmp45A,sizeof(char),38U);});Cyc_CfFlowInfo_aerr(_tmp764,_tmp763,_tag_fat(_tmp459,sizeof(void*),1U));});});
...
is_region_open?({struct _tuple30 _tmp631;_tmp631.f1=1,_tmp631.f2=0;_tmp631;}):
...
({struct Cyc_List_List*_tmp766=({struct Cyc_List_List*_tmp473=_cycalloc(sizeof(*_tmp473));
({struct _tuple31*_tmp765=({struct _tuple31*_tmp472=_cycalloc(sizeof(*_tmp472));_tmp472->f1=0,_tmp472->f2=body,_tmp472->f3=roots,_tmp472->f4=es;_tmp472;});_tmp473->hd=_tmp765;}),_tmp473->tl=old_unique_pat_vars;_tmp473;});
# 2465
env->unique_pat_vars=_tmp766;});
# 2468
if(where_opt != 0){
...
({void*_tmp479=0U;({unsigned _tmp768=body->loc;struct _fat_ptr _tmp767=({const char*_tmp47A="switch clause may implicitly fallthru";_tag_fat(_tmp47A,sizeof(char),38U);});Cyc_CfFlowInfo_aerr(_tmp768,_tmp767,_tag_fat(_tmp479,sizeof(void*),0U));});});else{
# 2491
({void*_tmp47B=0U;({unsigned _tmp76A=body->loc;struct _fat_ptr _tmp769=({const char*_tmp47C="switch clause may implicitly fallthru";_tag_fat(_tmp47C,sizeof(char),38U);});Cyc_Warn_warn(_tmp76A,_tmp769,_tag_fat(_tmp47B,sizeof(void*),0U));});});}
# 2493
...
struct _tuple16 _tmp481=Cyc_CfFlowInfo_unname_rval(({struct Cyc_Dict_Dict _tmp76B=fd;((void*(*)(struct Cyc_Dict_Dict d,int(*cmp)(void*,void*),void*k))Cyc_Dict_lookup_other)(_tmp76B,Cyc_CfFlowInfo_root_cmp,(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp488=_cycalloc(sizeof(*_tmp488));*_tmp488=vdroot;_tmp488;}));}));struct _tuple16 _stmttmp86=_tmp481;struct _tuple16 _tmp482=_stmttmp86;void*_tmp483;_LL4: _tmp483=_tmp482.f1;_LL5: {void*rval=_tmp483;
...
# 2515
({struct Cyc_String_pa_PrintArg_struct _tmp487=({struct Cyc_String_pa_PrintArg_struct _tmp632;_tmp632.tag=0U,({struct _fat_ptr _tmp76C=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp632.f1=_tmp76C;});_tmp632;});void*_tmp485[1U];_tmp485[0]=& _tmp487;({unsigned _tmp76E=loc;struct _fat_ptr _tmp76D=({const char*_tmp486="unique pointers may still exist after variable %s goes out of scope";_tag_fat(_tmp486,sizeof(char),68U);});Cyc_Warn_warn(_tmp76E,_tmp76D,_tag_fat(_tmp485,sizeof(void*),1U));});});
# 2517
goto _LL6;}_LL6:;}}}}
# 2522
...
# 2525
struct _tuple32 _tmp48B=({struct _tuple32 _tmp634;_tmp634.f1=env,_tmp634.f2=fd,_tmp634.f3=decl->loc;_tmp634;});struct _tuple32 vdenv=_tmp48B;
...
# 2577
 if(env->noreturn)
({void*_tmp4C9=0U;({unsigned _tmp770=s->loc;struct _fat_ptr _tmp76F=({const char*_tmp4CA="`noreturn' function might return";_tag_fat(_tmp4CA,sizeof(char),33U);});Cyc_CfFlowInfo_aerr(_tmp770,_tmp76F,_tag_fat(_tmp4C9,sizeof(void*),0U));});});
...
# 2583
if(env->noreturn)
({void*_tmp4CB=0U;({unsigned _tmp772=s->loc;struct _fat_ptr _tmp771=({const char*_tmp4CC="`noreturn' function might return";_tag_fat(_tmp4CC,sizeof(char),33U);});Cyc_CfFlowInfo_aerr(_tmp772,_tmp771,_tag_fat(_tmp4CB,sizeof(void*),0U));});});{
...
if(vd != 0){
f=({struct Cyc_CfFlowInfo_FlowEnv*_tmp77B=fenv;struct Cyc_NewControlFlow_AnalEnv*_tmp77A=env;union Cyc_CfFlowInfo_FlowInfo _tmp779=f;struct Cyc_Absyn_Vardecl*_tmp778=*vd;struct Cyc_Absyn_Exp*_tmp777=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd;void*_tmp776=(void*)((struct Cyc_List_List*)_check_null(rvals))->hd;Cyc_NewControlFlow_do_initialize_var(_tmp77B,_tmp77A,_tmp779,_tmp778,_tmp777,_tmp776,s->loc);});
rvals=rvals->tl;
es=es->tl;}}}}
# 2666
...
# 2830
({void*_tmp536=0U;({struct _fat_ptr _tmp77C=({const char*_tmp537="anal_stmt: bad stmt syntax or unimplemented stmt form";_tag_fat(_tmp537,sizeof(char),54U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp77C,_tag_fat(_tmp536,sizeof(void*),0U));});});}case 6U: _LL18: _LL19:
# 2672
...
({void*_tmp509=0U;({unsigned _tmp77E=s->loc;struct _fat_ptr _tmp77D=({const char*_tmp50A="break may cause function not to return a value";_tag_fat(_tmp50A,sizeof(char),47U);});Cyc_Warn_warn(_tmp77E,_tmp77D,_tag_fat(_tmp509,sizeof(void*),0U));});});else{
# 2680
({void*_tmp50B=0U;({unsigned _tmp780=s->loc;struct _fat_ptr _tmp77F=({const char*_tmp50C="break may cause function not to return a value";_tag_fat(_tmp50C,sizeof(char),47U);});Cyc_CfFlowInfo_aerr(_tmp780,_tmp77F,_tag_fat(_tmp50B,sizeof(void*),0U));});});}}
# 2682
goto _LL55;}else{_LL58: _LL59:
 goto _LL55;}_LL55:;}
# 2685
if(env->noreturn)
({void*_tmp50D=0U;({unsigned _tmp782=s->loc;struct _fat_ptr _tmp781=({const char*_tmp50E="`noreturn' function might return";_tag_fat(_tmp50E,sizeof(char),33U);});Cyc_CfFlowInfo_aerr(_tmp782,_tmp781,_tag_fat(_tmp50D,sizeof(void*),0U));});});
Cyc_NewControlFlow_check_init_params(s->loc,env,inflow);
Cyc_NewControlFlow_unconsume_params(env,env->noconsume_params,0,0,inflow,s->loc);
...
if(dest == 0)
({void*_tmp510=0U;({unsigned _tmp784=s->loc;struct _fat_ptr _tmp783=({const char*_tmp511="jump has no target (should be impossible)";_tag_fat(_tmp511,sizeof(char),42U);});Cyc_CfFlowInfo_aerr(_tmp784,_tmp783,_tag_fat(_tmp510,sizeof(void*),0U));});});
...
{union Cyc_CfFlowInfo_FlowInfo _tmp512=scs_outflow;if((_tmp512.BottomFL).tag == 1){_LL5B: _LL5C:
 goto _LL5A;}else{_LL5D: _LL5E:
({void*_tmp513=0U;({unsigned _tmp786=s->loc;struct _fat_ptr _tmp785=({const char*_tmp514="last catch clause may implicitly fallthru";_tag_fat(_tmp514,sizeof(char),42U);});Cyc_CfFlowInfo_aerr(_tmp786,_tmp785,_tag_fat(_tmp513,sizeof(void*),0U));});});}_LL5A:;}
# 2728
outflow=s1_outflow;
# 2730
...
# 2744
({struct Cyc_List_List*_tmp788=({struct Cyc_List_List*_tmp51B=_cycalloc(sizeof(*_tmp51B));
({struct _tuple31*_tmp787=({struct _tuple31*_tmp51A=_cycalloc(sizeof(*_tmp51A));_tmp51A->f1=0,_tmp51A->f2=s,_tmp51A->f3=roots,_tmp51A->f4=es;_tmp51A;});_tmp51B->hd=_tmp787;}),_tmp51B->tl=old_unique_pat_vars;_tmp51B;});
# 2744
env->unique_pat_vars=_tmp788;});
# 2749
...
# 2769
struct Cyc_List_List l=({struct Cyc_List_List _tmp636;_tmp636.hd=open_exp_opt,_tmp636.tl=0;_tmp636;});
...
# 2800
 goto _LL68;}_LL68:;}{
# 2803
struct Cyc_List_List _tmp532=({struct Cyc_List_List _tmp635;_tmp635.hd=vd,_tmp635.tl=0;_tmp635;});struct Cyc_List_List vds=_tmp532;
...
({struct Cyc_List_List*_tmp78A=({struct Cyc_List_List*_tmp535=_cycalloc(sizeof(*_tmp535));({struct _tuple31*_tmp789=({struct _tuple31*_tmp534=_cycalloc(sizeof(*_tmp534));_tmp534->f1=1,_tmp534->f2=s,_tmp534->f3=roots,_tmp534->f4=es;_tmp534;});_tmp535->hd=_tmp789;}),_tmp535->tl=old_unique_pat_vars;_tmp535;});env->unique_pat_vars=_tmp78A;});
# 2812
...
# 2823
outflow=({struct Cyc_NewControlFlow_AnalEnv*_tmp78D=env;union Cyc_CfFlowInfo_FlowInfo _tmp78C=Cyc_NewControlFlow_anal_decl(env,inflow,d);struct Cyc_Absyn_Stmt*_tmp78B=s;Cyc_NewControlFlow_anal_stmt(_tmp78D,_tmp78C,_tmp78B,rval_opt);});
if(Cyc_Flags_warn_lose_unique)
...
void*_tmp539=decl->r;void*_stmttmp9B=_tmp539;void*_tmp53A=_stmttmp9B;struct Cyc_Absyn_Tvar*_tmp53B;struct Cyc_Absyn_Exp*_tmp53E;struct Cyc_Absyn_Vardecl*_tmp53D;struct Cyc_Absyn_Tvar*_tmp53C;struct Cyc_Absyn_Fndecl*_tmp53F;struct Cyc_List_List*_tmp540;struct Cyc_Absyn_Vardecl*_tmp541;switch(*((int*)_tmp53A)){case 0U: _LL1: _tmp541=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp53A)->f1;_LL2: {struct Cyc_Absyn_Vardecl*vd=_tmp541;
# 2846
if((int)vd->sc == (int)Cyc_Absyn_Static)
return inflow;{
# 2851
struct Cyc_List_List _tmp542=({struct Cyc_List_List _tmp637;_tmp637.hd=vd,_tmp637.tl=0;_tmp637;});struct Cyc_List_List vds=_tmp542;
inflow=Cyc_NewControlFlow_add_vars(fenv,inflow,& vds,fenv->unknown_none,decl->loc,0);{
struct Cyc_Absyn_Exp*_tmp543=vd->initializer;struct Cyc_Absyn_Exp*e=_tmp543;
if(e == 0)
return inflow;{
struct _tuple17 _tmp544=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,e);struct _tuple17 _stmttmp9C=_tmp544;struct _tuple17 _tmp545=_stmttmp9C;void*_tmp547;union Cyc_CfFlowInfo_FlowInfo _tmp546;_LLE: _tmp546=_tmp545.f1;_tmp547=_tmp545.f2;_LLF: {union Cyc_CfFlowInfo_FlowInfo f=_tmp546;void*r=_tmp547;
return Cyc_NewControlFlow_do_initialize_var(fenv,env,f,vd,e,r,decl->loc);}}}}}case 3U: _LL3: _tmp540=((struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*)_tmp53A)->f1;_LL4: {struct Cyc_List_List*vds=_tmp540;
# 2860
return Cyc_NewControlFlow_add_vars(fenv,inflow,vds,fenv->unknown_none,decl->loc,0);}case 1U: _LL5: _tmp53F=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp53A)->f1;_LL6: {struct Cyc_Absyn_Fndecl*fd=_tmp53F;
# 2863
Cyc_NewControlFlow_check_nested_fun(env->all_tables,fenv,inflow,fd);{
struct Cyc_Absyn_Vardecl*_tmp548=(struct Cyc_Absyn_Vardecl*)_check_null(fd->fn_vardecl);struct Cyc_Absyn_Vardecl*vd=_tmp548;
# 2868
return({struct Cyc_CfFlowInfo_FlowEnv*_tmp791=fenv;union Cyc_CfFlowInfo_FlowInfo _tmp790=inflow;struct Cyc_List_List*_tmp78F=({struct Cyc_List_List*_tmp549=_cycalloc(sizeof(*_tmp549));_tmp549->hd=vd,_tmp549->tl=0;_tmp549;});void*_tmp78E=fenv->unknown_all;Cyc_NewControlFlow_add_vars(_tmp791,_tmp790,_tmp78F,_tmp78E,decl->loc,0);});}}case 4U: _LL7: _tmp53C=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp53A)->f1;_tmp53D=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp53A)->f2;_tmp53E=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp53A)->f3;_LL8: {struct Cyc_Absyn_Tvar*tv=_tmp53C;struct Cyc_Absyn_Vardecl*vd=_tmp53D;struct Cyc_Absyn_Exp*open_exp_opt=_tmp53E;
# 2871
if(open_exp_opt != 0)
({void*_tmp54A=0U;({struct _fat_ptr _tmp792=({const char*_tmp54B="found open expression in declaration!";_tag_fat(_tmp54B,sizeof(char),38U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp792,_tag_fat(_tmp54A,sizeof(void*),0U));});});{
struct Cyc_List_List _tmp54C=({struct Cyc_List_List _tmp638;_tmp638.hd=vd,_tmp638.tl=0;_tmp638;});struct Cyc_List_List vds=_tmp54C;
return Cyc_NewControlFlow_add_vars(fenv,inflow,& vds,fenv->unknown_all,decl->loc,0);}}case 5U: _LL9: _tmp53B=((struct Cyc_Absyn_Pool_d_Absyn_Raw_decl_struct*)_tmp53A)->f1;_LLA: {struct Cyc_Absyn_Tvar*tv=_tmp53B;
# 2877
return inflow;}default: _LLB: _LLC:
# 2880
({void*_tmp54D=0U;({struct _fat_ptr _tmp793=({const char*_tmp54E="anal_decl: unexpected decl variant";_tag_fat(_tmp54E,sizeof(char),35U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp793,_tag_fat(_tmp54D,sizeof(void*),0U));});});}_LL0:;}
# 2888
static void Cyc_NewControlFlow_check_fun(struct Cyc_JumpAnalysis_Jump_Anal_Result*tables,struct Cyc_Absyn_Fndecl*fd){
struct _handler_cons _tmp54F;_push_handler(& _tmp54F);{int _tmp551=0;if(setjmp(_tmp54F.handler))_tmp551=1;if(!_tmp551){
{struct Cyc_CfFlowInfo_FlowEnv*fenv=Cyc_CfFlowInfo_new_flow_env();
({struct Cyc_JumpAnalysis_Jump_Anal_Result*_tmp796=tables;struct Cyc_CfFlowInfo_FlowEnv*_tmp795=fenv;union Cyc_CfFlowInfo_FlowInfo _tmp794=Cyc_CfFlowInfo_ReachableFL(fenv->mt_flowdict,0);Cyc_NewControlFlow_check_nested_fun(_tmp796,_tmp795,_tmp794,fd);});}
# 2890
;_pop_handler();}else{void*_tmp550=(void*)Cyc_Core_get_exn_thrown();void*_tmp552=_tmp550;void*_tmp553;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp552)->tag == Cyc_Dict_Absent){_LL1: _LL2:
# 2896
 if(Cyc_Position_num_errors > 0)
goto _LL0;else{
Cyc_Core_rethrow((void*)({struct Cyc_Dict_Absent_exn_struct*_tmp554=_cycalloc(sizeof(*_tmp554));_tmp554->tag=Cyc_Dict_Absent;_tmp554;}));}}else{_LL3: _tmp553=_tmp552;_LL4: {void*exn=_tmp553;(int)_rethrow(exn);}}_LL0:;}}}
# 2902
...
union Cyc_Relations_RelnOp _tmp555=r;unsigned _tmp556;if((_tmp555.RParam).tag == 5){_LL1: _tmp556=(_tmp555.RParam).val;_LL2: {unsigned i=_tmp556;
# 2910
struct Cyc_Absyn_Vardecl*_tmp557=((struct Cyc_Absyn_Vardecl*(*)(struct Cyc_List_List*x,int n))Cyc_List_nth)(vds,(int)i);struct Cyc_Absyn_Vardecl*vd=_tmp557;
if(!vd->escapes)
...
{int _tmp559=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(param_vardecls);int len=_tmp559;
struct _fat_ptr _tmp55A=({unsigned _tmp567=(unsigned)len;int*_tmp566=({struct _RegionHandle*_tmp797=r;_region_malloc(_tmp797,_check_times(_tmp567,sizeof(int)));});({{unsigned _tmp639=(unsigned)len;unsigned i;for(i=0;i < _tmp639;++ i){_tmp566[i]=0;}}0;});_tag_fat(_tmp566,sizeof(int),_tmp567);});struct _fat_ptr cons=_tmp55A;
for(0;atts != 0;atts=atts->tl){
void*_tmp55B=(void*)atts->hd;void*_stmttmp9D=_tmp55B;void*_tmp55C=_stmttmp9D;int _tmp55D;int _tmp55E;switch(*((int*)_tmp55C)){case 22U: _LL1: _tmp55E=((struct Cyc_Absyn_Consume_att_Absyn_Attribute_struct*)_tmp55C)->f1;_LL2: {int i=_tmp55E;
_tmp55D=i;goto _LL4;}case 21U: _LL3: _tmp55D=((struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*)_tmp55C)->f1;_LL4: {int i=_tmp55D;
...
struct Cyc_Absyn_Vardecl*_tmp55F=(struct Cyc_Absyn_Vardecl*)param_vardecls->hd;struct Cyc_Absyn_Vardecl*vd=_tmp55F;
if(Cyc_Tcutil_is_noalias_pointer(vd->type,0)&& !(*((int*)_check_fat_subscript(cons,sizeof(int),i)))){
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp560=({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp564=_cycalloc(sizeof(*_tmp564));_tmp564->tag=0U,_tmp564->f1=vd;_tmp564;});struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*root=_tmp560;
struct Cyc_CfFlowInfo_Place*_tmp561=({struct Cyc_CfFlowInfo_Place*_tmp563=_cycalloc(sizeof(*_tmp563));_tmp563->root=(void*)root,_tmp563->path=0;_tmp563;});struct Cyc_CfFlowInfo_Place*rp=_tmp561;
noconsume_roots=({struct Cyc_List_List*_tmp562=_cycalloc(sizeof(*_tmp562));_tmp562->hd=rp,_tmp562->tl=noconsume_roots;_tmp562;});}}}{
# 2942
struct Cyc_List_List*_tmp565=noconsume_roots;_npop_handler(0U);return _tmp565;}}}
# 2924
;_pop_region();}
# 2945
...
# 2949
unsigned _tmp568=(fd->body)->loc;unsigned loc=_tmp568;
...
struct _tuple15 _tmp569=({union Cyc_CfFlowInfo_FlowInfo _tmp591=inflow;if((_tmp591.ReachableFL).tag != 2)_throw_match();(_tmp591.ReachableFL).val;});struct _tuple15 _stmttmp9E=_tmp569;struct _tuple15 _tmp56A=_stmttmp9E;struct Cyc_List_List*_tmp56C;struct Cyc_Dict_Dict _tmp56B;_LL1: _tmp56B=_tmp56A.f1;_tmp56C=_tmp56A.f2;_LL2: {struct Cyc_Dict_Dict d=_tmp56B;struct Cyc_List_List*relns=_tmp56C;
# 2958
struct Cyc_List_List*_tmp56D=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v;struct Cyc_List_List*vardecls=_tmp56D;
{struct Cyc_List_List*_tmp56E=(fd->i).requires_relns;struct Cyc_List_List*reqs=_tmp56E;for(0;reqs != 0;reqs=reqs->tl){
struct Cyc_Relations_Reln*_tmp56F=(struct Cyc_Relations_Reln*)reqs->hd;struct Cyc_Relations_Reln*req=_tmp56F;
relns=({struct _RegionHandle*_tmp79B=Cyc_Core_heap_region;union Cyc_Relations_RelnOp _tmp79A=Cyc_NewControlFlow_translate_rop(vardecls,req->rop1);enum Cyc_Relations_Relation _tmp799=req->relation;union Cyc_Relations_RelnOp _tmp798=
Cyc_NewControlFlow_translate_rop(vardecls,req->rop2);
# 2961
Cyc_Relations_add_relation(_tmp79B,_tmp79A,_tmp799,_tmp798,relns);});}}{
# 2967
struct Cyc_List_List*atts;
{void*_tmp570=Cyc_Absyn_compress((void*)_check_null(fd->cached_type));void*_stmttmp9F=_tmp570;void*_tmp571=_stmttmp9F;struct Cyc_List_List*_tmp572;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp571)->tag == 5U){_LL4: _tmp572=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp571)->f1).attributes;_LL5: {struct Cyc_List_List*as=_tmp572;
atts=as;goto _LL3;}}else{_LL6: _LL7:
({void*_tmp573=0U;({struct _fat_ptr _tmp79C=({const char*_tmp574="check_fun: non-function type cached with fndecl_t";_tag_fat(_tmp574,sizeof(char),50U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp79C,_tag_fat(_tmp573,sizeof(void*),0U));});});}_LL3:;}{
# 2972
...
# 2975
for(0;atts != 0;atts=atts->tl){
void*_tmp575=(void*)atts->hd;void*_stmttmpA0=_tmp575;void*_tmp576=_stmttmpA0;int _tmp577;int _tmp578;switch(*((int*)_tmp576)){case 21U: _LL9: _tmp578=((struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*)_tmp576)->f1;_LLA: {int i=_tmp578;
# 2978
struct Cyc_Absyn_Exp*bogus_exp=Cyc_Absyn_signed_int_exp(- 1,0U);
struct Cyc_Absyn_Vardecl*_tmp579=((struct Cyc_Absyn_Vardecl*(*)(struct Cyc_List_List*x,int n))Cyc_List_nth)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v,i - 1);struct Cyc_Absyn_Vardecl*vd=_tmp579;
...
void*rval=_tmp57A;
# 2985
struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp57B=({struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp580=_cycalloc(sizeof(*_tmp580));_tmp580->tag=2U,_tmp580->f1=i,_tmp580->f2=t;_tmp580;});struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*r=_tmp57B;
struct Cyc_CfFlowInfo_Place*_tmp57C=({struct Cyc_CfFlowInfo_Place*_tmp57F=_cycalloc(sizeof(*_tmp57F));_tmp57F->root=(void*)r,_tmp57F->path=0;_tmp57F;});struct Cyc_CfFlowInfo_Place*rp=_tmp57C;
d=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(d,(void*)r,rval);
d=({struct Cyc_Dict_Dict _tmp7A1=d;void*_tmp7A0=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp57D=_cycalloc(sizeof(*_tmp57D));_tmp57D->tag=0U,_tmp57D->f1=vd;_tmp57D;});((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp7A1,_tmp7A0,(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp57E=_cycalloc(sizeof(*_tmp57E));_tmp57E->tag=4U,_tmp57E->f1=rp;_tmp57E;}));});
goto _LL8;}case 20U: _LLB: _tmp577=((struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_tmp576)->f1;_LLC: {int i=_tmp577;
# 2991
struct Cyc_Absyn_Vardecl*_tmp581=((struct Cyc_Absyn_Vardecl*(*)(struct Cyc_List_List*x,int n))Cyc_List_nth)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v,i - 1);struct Cyc_Absyn_Vardecl*vd=_tmp581;
void*elttype=Cyc_Tcutil_pointer_elt_type(vd->type);
struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp582=({struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp588=_cycalloc(sizeof(*_tmp588));_tmp588->tag=2U,_tmp588->f1=i,_tmp588->f2=elttype;_tmp588;});struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*r=_tmp582;
struct Cyc_CfFlowInfo_Place*_tmp583=({struct Cyc_CfFlowInfo_Place*_tmp587=_cycalloc(sizeof(*_tmp587));_tmp587->root=(void*)r,_tmp587->path=0;_tmp587;});struct Cyc_CfFlowInfo_Place*rp=_tmp583;
d=({struct Cyc_Dict_Dict _tmp7A3=d;void*_tmp7A2=(void*)r;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp7A3,_tmp7A2,Cyc_CfFlowInfo_typ_to_absrval(fenv,elttype,0,fenv->esc_none));});
d=({struct Cyc_Dict_Dict _tmp7A5=d;void*_tmp7A4=(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp584=_cycalloc(sizeof(*_tmp584));_tmp584->tag=0U,_tmp584->f1=vd;_tmp584;});((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp7A5,_tmp7A4,(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp585=_cycalloc(sizeof(*_tmp585));_tmp585->tag=4U,_tmp585->f1=rp;_tmp585;}));});
param_roots=({struct Cyc_List_List*_tmp586=_cycalloc(sizeof(*_tmp586));_tmp586->hd=rp,_tmp586->tl=param_roots;_tmp586;});
...
struct Cyc_Hashtable_Table*_tmp7A7=((struct Cyc_Hashtable_Table*(*)(struct Cyc_Hashtable_Table*t,struct Cyc_Absyn_Fndecl*key))Cyc_Hashtable_lookup)(tables->succ_tables,fd);_tmp590->succ_table=_tmp7A7;}),({
struct Cyc_Hashtable_Table*_tmp7A6=((struct Cyc_Hashtable_Table*(*)(struct Cyc_Hashtable_Table*t,struct Cyc_Absyn_Fndecl*key))Cyc_Hashtable_lookup)(tables->pat_pop_tables,fd);_tmp590->pat_pop_table=_tmp7A6;}),_tmp590->fenv=fenv,_tmp590->iterate_again=1,_tmp590->iteration_num=0,_tmp590->in_try=0,_tmp590->tryflow=inflow,_tmp590->noreturn=noreturn,_tmp590->return_type=(fd->i).ret_type,_tmp590->unique_pat_vars=0,_tmp590->param_roots=param_roots,_tmp590->noconsume_params=noconsume_roots,_tmp590->flow_table=flow_table,_tmp590->return_relns=(fd->i).ensures_relns;_tmp590;});
# 3014
...
# 3023
union Cyc_CfFlowInfo_FlowInfo _tmp589=outflow;if((_tmp589.BottomFL).tag == 1){_LL10: _LL11:
...
# 3030
if(noreturn)
({void*_tmp58A=0U;({unsigned _tmp7A9=loc;struct _fat_ptr _tmp7A8=({const char*_tmp58B="`noreturn' function might (implicitly) return";_tag_fat(_tmp58B,sizeof(char),46U);});Cyc_CfFlowInfo_aerr(_tmp7A9,_tmp7A8,_tag_fat(_tmp58A,sizeof(void*),0U));});});else{
...
({void*_tmp58C=0U;({unsigned _tmp7AB=loc;struct _fat_ptr _tmp7AA=({const char*_tmp58D="function may not return a value";_tag_fat(_tmp58D,sizeof(char),32U);});Cyc_Warn_warn(_tmp7AB,_tmp7AA,_tag_fat(_tmp58C,sizeof(void*),0U));});});else{
# 3037
({void*_tmp58E=0U;({unsigned _tmp7AD=loc;struct _fat_ptr _tmp7AC=({const char*_tmp58F="function may not return a value";_tag_fat(_tmp58F,sizeof(char),32U);});Cyc_CfFlowInfo_aerr(_tmp7AD,_tmp7AC,_tag_fat(_tmp58E,sizeof(void*),0U));});});}goto _LLF;}}
# 3039
goto _LLF;}_LLF:;}}}}}}}
# 3043
...
void*_tmp592=((struct Cyc_Absyn_Decl*)ds->hd)->r;void*_stmttmpA1=_tmp592;void*_tmp593=_stmttmpA1;struct Cyc_List_List*_tmp594;struct Cyc_List_List*_tmp595;struct Cyc_List_List*_tmp596;struct Cyc_Absyn_Fndecl*_tmp597;switch(*((int*)_tmp593)){case 1U: _LL1: _tmp597=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp593)->f1;_LL2: {struct Cyc_Absyn_Fndecl*fd=_tmp597;
Cyc_NewControlFlow_check_fun(tables,fd);goto _LL0;}case 12U: _LL3: _tmp596=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp593)->f1;_LL4: {struct Cyc_List_List*ds2=_tmp596;
# 3049
_tmp595=ds2;goto _LL6;}case 11U: _LL5: _tmp595=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp593)->f2;_LL6: {struct Cyc_List_List*ds2=_tmp595;
_tmp594=ds2;goto _LL8;}case 10U: _LL7: _tmp594=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp593)->f2;_LL8: {struct Cyc_List_List*ds2=_tmp594;
Cyc_NewControlFlow_cf_check(tables,ds2);goto _LL0;}case 13U: _LL9: _LLA:
