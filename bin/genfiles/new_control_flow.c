...
_tmp6B3;struct Cyc_NewControlFlow_CFStmtAnnot _tmp6B2;struct Cyc_NewControlFlow_CFAnnot_struct*
_tmp6B1;enclosee->annot=(void*)((_tmp6B1=_cycalloc(sizeof(*_tmp6B1)),((_tmp6B1[0]=((
_tmp6B3.tag=Cyc_NewControlFlow_CFAnnot,((_tmp6B3.f1=((_tmp6B2.encloser=encloser,((
_tmp6B2.visited=0,_tmp6B2)))),_tmp6B3)))),_tmp6B1))));}struct Cyc_NewControlFlow_AnalEnv{
...
_tmp6B9;const char*_tmp6B8;struct Cyc_Core_Impossible_struct*_tmp6B7;(int)_throw((
void*)((_tmp6B7=_cycalloc(sizeof(*_tmp6B7)),((_tmp6B7[0]=((_tmp6B9.tag=Cyc_Core_Impossible,((
_tmp6B9.f1=((_tmp6B8="ControlFlow -- wrong stmt annotation",_tag_dyneither(
_tmp6B8,sizeof(char),37))),_tmp6B9)))),_tmp6B7)))));}_LL0:;}static union Cyc_CfFlowInfo_FlowInfo*
...
env->flow_table,s);if(sflow == 0){union Cyc_CfFlowInfo_FlowInfo*_tmp6BA;union Cyc_CfFlowInfo_FlowInfo*
res=(_tmp6BA=_region_malloc(env->r,sizeof(*_tmp6BA)),((_tmp6BA[0]=Cyc_CfFlowInfo_BottomFL(),
_tmp6BA)));((void(*)(struct Cyc_Hashtable_Table*t,struct Cyc_Absyn_Stmt*key,union
...
env->iteration_num;{struct _tuple16 _tmp6BB;return(_tmp6BB.f1=_tmpB,((_tmp6BB.f2=
_tmpC,_tmp6BB)));};}static void Cyc_NewControlFlow_update_tryflow(struct Cyc_NewControlFlow_AnalEnv*
...
_tmp6BE;struct Cyc_CfFlowInfo_VarRoot_struct*_tmp6BD;struct Cyc_CfFlowInfo_VarRoot_struct*
_tmp16=(_tmp6BD=_region_malloc(fenv->r,sizeof(*_tmp6BD)),((_tmp6BD[0]=((_tmp6BE.tag=
0,((_tmp6BE.f1=(struct Cyc_Absyn_Vardecl*)vds->hd,_tmp6BE)))),_tmp6BD)));_tmp14=((
...
_tmp1C,r)!= Cyc_CfFlowInfo_AllIL){const char*_tmp6C1;void*_tmp6C0;(_tmp6C0=0,Cyc_Tcutil_terr(
loc,((_tmp6C1="expression may not be fully initialized",_tag_dyneither(_tmp6C1,
sizeof(char),40))),_tag_dyneither(_tmp6C0,sizeof(void*),0)));}{struct Cyc_Dict_Dict
...
env,struct Cyc_Position_Segment*loc,void*t,void*r){struct _tuple0 _tmp6C2;struct
_tuple0 _tmp23=(_tmp6C2.f1=Cyc_Tcutil_compress(t),((_tmp6C2.f2=r,_tmp6C2)));void*
...
if(!Cyc_Tcutil_is_noalias_pointer(t))goto _LL20;_LL1F:{const char*_tmp6C5;void*
_tmp6C4;(_tmp6C4=0,Cyc_Tcutil_warn(loc,((_tmp6C5="argument may still contain unique pointers",
_tag_dyneither(_tmp6C5,sizeof(char),43))),_tag_dyneither(_tmp6C4,sizeof(void*),0)));}
...
_tmp53.f2;_LL26: if(!Cyc_Tcutil_is_noalias_pointer(t)){{const char*_tmp6C8;void*
_tmp6C7;(_tmp6C7=0,Cyc_Tcutil_terr(loc,((_tmp6C8="noliveunique attribute requires unique pointer",
_tag_dyneither(_tmp6C8,sizeof(char),47))),_tag_dyneither(_tmp6C7,sizeof(void*),0)));}
...
_tmp58,Cyc_CfFlowInfo_lookup_place(_tmp54,_tmp5B));goto _LL27;_LL2A:;_LL2B:{const
char*_tmp6CB;void*_tmp6CA;(_tmp6CA=0,Cyc_Tcutil_warn(loc,((_tmp6CB="argument may contain live unique pointers",
_tag_dyneither(_tmp6CB,sizeof(char),42))),_tag_dyneither(_tmp6CA,sizeof(void*),0)));}
return Cyc_NewControlFlow_use_Rval(env,loc,inflow,r);_LL27:;}{struct Cyc_Dict_Dict
_tmp5E=Cyc_CfFlowInfo_escape_deref(env->fenv,_tmp54,env->all_changed,r);if(
_tmp54.t == _tmp5E.t)return inflow;{union Cyc_CfFlowInfo_FlowInfo _tmp5F=Cyc_CfFlowInfo_ReachableFL(
_tmp5E,_tmp55);Cyc_NewControlFlow_update_tryflow(env,_tmp5F);return _tmp5F;};};};
_LL22:;}struct _tuple18{union Cyc_CfFlowInfo_FlowInfo f1;struct Cyc_List_List*f2;};
static struct _tuple18 Cyc_NewControlFlow_anal_unordered_Rexps(struct _RegionHandle*
rgn,struct Cyc_NewControlFlow_AnalEnv*env,union Cyc_CfFlowInfo_FlowInfo inflow,
struct Cyc_List_List*es,int first_is_copy,int others_are_copy);static struct _tuple18
Cyc_NewControlFlow_anal_unordered_Rexps(struct _RegionHandle*rgn,struct Cyc_NewControlFlow_AnalEnv*
env,union Cyc_CfFlowInfo_FlowInfo inflow,struct Cyc_List_List*es,int first_is_copy,
int others_are_copy){if(es == 0){struct _tuple18 _tmp6CC;return(_tmp6CC.f1=inflow,((
_tmp6CC.f2=0,_tmp6CC)));}if(es->tl == 0){union Cyc_CfFlowInfo_FlowInfo _tmp62;void*
_tmp63;struct _tuple13 _tmp61=Cyc_NewControlFlow_anal_Rexp(env,first_is_copy,
inflow,(struct Cyc_Absyn_Exp*)es->hd);_tmp62=_tmp61.f1;_tmp63=_tmp61.f2;{struct
Cyc_List_List*_tmp6CF;struct _tuple18 _tmp6CE;return(_tmp6CE.f1=_tmp62,((_tmp6CE.f2=((
_tmp6CF=_region_malloc(rgn,sizeof(*_tmp6CF)),((_tmp6CF->hd=_tmp63,((_tmp6CF->tl=
0,_tmp6CF)))))),_tmp6CE)));};}{struct Cyc_Dict_Dict*outer_all_changed=env->all_changed;
struct Cyc_Dict_Dict this_all_changed;union Cyc_CfFlowInfo_FlowInfo old_inflow;union
Cyc_CfFlowInfo_FlowInfo outflow;struct Cyc_List_List*rvals;do{this_all_changed=(
env->fenv)->mt_place_set;{struct Cyc_Dict_Dict*_tmp6D0;env->all_changed=((_tmp6D0=
_region_malloc(env->r,sizeof(*_tmp6D0)),((_tmp6D0[0]=(env->fenv)->mt_place_set,
_tmp6D0))));}{union Cyc_CfFlowInfo_FlowInfo _tmp68;void*_tmp69;struct _tuple13
...
_tmp6D1;rvals=((_tmp6D1=_region_malloc(rgn,sizeof(*_tmp6D1)),((_tmp6D1->hd=
_tmp69,((_tmp6D1->tl=0,_tmp6D1))))));}this_all_changed=Cyc_CfFlowInfo_union_place_set(
...
_tmp6D2;env->all_changed=((_tmp6D2=_region_malloc(env->r,sizeof(*_tmp6D2)),((
_tmp6D2[0]=(env->fenv)->mt_place_set,_tmp6D2))));}{union Cyc_CfFlowInfo_FlowInfo
...
_tmp6C.f2;{struct Cyc_List_List*_tmp6D3;rvals=((_tmp6D3=_region_malloc(rgn,
sizeof(*_tmp6D3)),((_tmp6D3->hd=_tmp6E,((_tmp6D3->tl=rvals,_tmp6D3))))));}
...
if(outer_all_changed == 0)env->all_changed=0;else{struct Cyc_Dict_Dict*_tmp6D4;env->all_changed=((
_tmp6D4=_region_malloc(env->r,sizeof(*_tmp6D4)),((_tmp6D4[0]=Cyc_CfFlowInfo_union_place_set(*
outer_all_changed,this_all_changed,0),_tmp6D4))));}Cyc_NewControlFlow_update_tryflow(
env,outflow);{struct _tuple18 _tmp6D5;return(_tmp6D5.f1=outflow,((_tmp6D5.f2=((
struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(rvals),_tmp6D5)));};};}
...
const char*_tmp6D8;void*_tmp6D7;(_tmp6D7=0,Cyc_Tcutil_terr(((struct Cyc_Absyn_Exp*)((
struct Cyc_List_List*)_check_null(es))->hd)->loc,((_tmp6D8="expression may not be initialized",
_tag_dyneither(_tmp6D8,sizeof(char),34))),_tag_dyneither(_tmp6D7,sizeof(void*),0)));}}
goto _LL2C;_LL2F: if((_tmp76.BottomFL).tag != 1)goto _LL2C;_tmp79=(int)(_tmp76.BottomFL).val;
_LL30: goto _LL2C;_LL2C:;}{struct _tuple13 _tmp6D9;return(_tmp6D9.f1=_tmp74,((
_tmp6D9.f2=(env->fenv)->unknown_all,_tmp6D9)));};}static union Cyc_CfFlowInfo_FlowInfo
...
_tmp86.BottomFL).val;_LL3D: {struct _tuple15 _tmp6DA;return(_tmp6DA.f1=outflow,((
_tmp6DA.f2=outflow,_tmp6DA)));}_LL3E: if((_tmp86.ReachableFL).tag != 2)goto _LL3B;
...
!= 2)goto _LL43;_tmp8D=(int)(_tmp8C.UnknownL).val;_LL42: {struct _tuple15 _tmp6DB;
return(_tmp6DB.f1=outflow,((_tmp6DB.f2=outflow,_tmp6DB)));}_LL43: if((_tmp8C.PlaceL).tag
...
struct _tuple15 _tmp6DC;return(_tmp6DC.f1=Cyc_CfFlowInfo_ReachableFL(Cyc_CfFlowInfo_assign_place(
env->fenv,e->loc,_tmp89,env->all_changed,_tmp8E,nzval),_tmp8A),((_tmp6DC.f2=Cyc_CfFlowInfo_ReachableFL(
Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmp89,env->all_changed,_tmp8E,(env->fenv)->zero),
_tmp8A),_tmp6DC)));}_LL40:;}_LL3B:;}static struct Cyc_CfFlowInfo_NotZero_struct Cyc_NewControlFlow_mt_notzero_v={
...
_tmp9B=(int)(_tmp9A.BottomFL).val;_LL4C: {struct _tuple13 _tmp6DD;return(_tmp6DD.f1=
f,((_tmp6DD.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmp96,(env->fenv)->unknown_all),
_tmp6DD)));}_LL4D: if((_tmp9A.ReachableFL).tag != 2)goto _LL4A;_tmp9C=(struct
...
_LL63:{struct Cyc_CfFlowInfo_NotZero_struct _tmp6E0;struct Cyc_CfFlowInfo_NotZero_struct*
_tmp6DF;e->annot=(void*)((_tmp6DF=_cycalloc(sizeof(*_tmp6DF)),((_tmp6DF[0]=((
_tmp6E0.tag=Cyc_CfFlowInfo_NotZero,((_tmp6E0.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmp9E),_tmp6E0)))),_tmp6DF))));}goto _LL61;_LL64:;_LL65: e->annot=(void*)& Cyc_NewControlFlow_mt_notzero_v;
...
struct Cyc_CfFlowInfo_NotZero_struct _tmp6E3;struct Cyc_CfFlowInfo_NotZero_struct*
_tmp6E2;e->annot=(void*)((_tmp6E2=_cycalloc(sizeof(*_tmp6E2)),((_tmp6E2[0]=((
_tmp6E3.tag=Cyc_CfFlowInfo_NotZero,((_tmp6E3.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmp9E),_tmp6E3)))),_tmp6E2))));}goto _LL6B;_LL6E:;_LL6F: e->annot=(void*)& Cyc_NewControlFlow_mt_notzero_v;
goto _LL6B;_LL6B:;}goto _LL66;_LL66:;}{struct _tuple13 _tmp6E4;return(_tmp6E4.f1=f,((
_tmp6E4.f2=Cyc_CfFlowInfo_lookup_place(_tmp9D,_tmpA4),_tmp6E4)));};_LL56: {
...
struct _tuple13 _tmp6E5;return(_tmp6E5.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp6E5.f2=
Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmp96,(env->fenv)->unknown_all),_tmp6E5)));};
...
_tmp6E8;struct Cyc_CfFlowInfo_UnknownZ_struct*_tmp6E7;e->annot=(void*)((_tmp6E7=
_cycalloc(sizeof(*_tmp6E7)),((_tmp6E7[0]=((_tmp6E8.tag=Cyc_CfFlowInfo_UnknownZ,((
_tmp6E8.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,_tmp9E),_tmp6E8)))),
_tmp6E7))));}goto _LL70;_LL73:;_LL74: e->annot=(void*)& Cyc_NewControlFlow_mt_unknownz_v;
...
_LL79:{struct Cyc_CfFlowInfo_UnknownZ_struct _tmp6EB;struct Cyc_CfFlowInfo_UnknownZ_struct*
_tmp6EA;e->annot=(void*)((_tmp6EA=_cycalloc(sizeof(*_tmp6EA)),((_tmp6EA[0]=((
_tmp6EB.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp6EB.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmp9E),_tmp6EB)))),_tmp6EA))));}goto _LL75;_LL75:;}switch(Cyc_CfFlowInfo_initlevel(
...
_tmpC1;if(_tmpC2->tag != 7)goto _LL7F;}_LL7E:{const char*_tmp6EE;void*_tmp6ED;(
_tmp6ED=0,Cyc_Tcutil_terr(e->loc,((_tmp6EE="attempt to use a unique pointer that has already been copied",
_tag_dyneither(_tmp6EE,sizeof(char),61))),_tag_dyneither(_tmp6ED,sizeof(void*),0)));}
goto _LL7C;_LL7F:;_LL80: {const char*_tmp6F1;void*_tmp6F0;(_tmp6F0=0,Cyc_Tcutil_terr(
e->loc,((_tmp6F1="dereference of possibly uninitialized pointer",_tag_dyneither(
_tmp6F1,sizeof(char),46))),_tag_dyneither(_tmp6F0,sizeof(void*),0)));}_LL7C:;}
goto _LL7B;case Cyc_CfFlowInfo_AllIL: _LL7B: {struct _tuple13 _tmp6F2;return(_tmp6F2.f1=
f,((_tmp6F2.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmp96,(env->fenv)->unknown_all),
_tmp6F2)));}case Cyc_CfFlowInfo_ThisIL: _LL81: {struct _tuple13 _tmp6F3;return(
_tmp6F3.f1=f,((_tmp6F3.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmp96,(env->fenv)->unknown_none),
_tmp6F3)));}}_LL4A:;}_LL48:;_LL49: {struct Cyc_Core_Impossible_struct _tmp6F9;
...
_tmp6F9.f1=((_tmp6F8="right deref of non-pointer-type",_tag_dyneither(_tmp6F8,
sizeof(char),32))),_tmp6F9)))),_tmp6F7)))));}_LL45:;}static struct Cyc_List_List*
...
!found){struct Cyc_CfFlowInfo_Reln*_tmp6FC;struct Cyc_List_List*_tmp6FB;return(
_tmp6FB=_region_malloc(rgn,sizeof(*_tmp6FB)),((_tmp6FB->hd=((_tmp6FC=
_region_malloc(rgn,sizeof(*_tmp6FC)),((_tmp6FC->vd=_tmpED,((_tmp6FC->rop=Cyc_CfFlowInfo_LessNumelts(
_tmpDC),_tmp6FC)))))),((_tmp6FB->tl=relns,_tmp6FB)))));}}return relns;_LL97:;
...
_tmpF4.BottomFL).val;_LLA0: {struct _tuple13 _tmp6FD;return(_tmp6FD.f1=Cyc_CfFlowInfo_BottomFL(),((
_tmp6FD.f2=rval,_tmp6FD)));}_LLA1: if((_tmpF4.ReachableFL).tag != 2)goto _LL9E;
...
env,outflow);{struct _tuple13 _tmp6FE;return(_tmp6FE.f1=outflow,((_tmp6FE.f2=rval,
_tmp6FE)));};_LLA6: if((_tmpFA.UnknownL).tag != 2)goto _LLA3;_tmpFC=(int)(_tmpFA.UnknownL).val;
_LLA7: {struct _tuple13 _tmp6FF;return(_tmp6FF.f1=Cyc_NewControlFlow_use_Rval(env,
rexp->loc,outflow,rval),((_tmp6FF.f2=rval,_tmp6FF)));}_LLA3:;}_LL9E:;}static int
...
static void _tmp78E(unsigned int*_tmp78D,unsigned int*_tmp78C,void***_tmp78A,
struct Cyc_List_List**_tmp2EF){for(*_tmp78D=0;*_tmp78D < *_tmp78C;(*_tmp78D)++){
void*_tmp788;(*_tmp78A)[*_tmp78D]=((_tmp788=(void*)((struct Cyc_List_List*)
_check_null(*_tmp2EF))->hd,((*_tmp2EF=(*_tmp2EF)->tl,_tmp788))));}}static struct
...
_tmp117=(int)(_tmp116.BottomFL).val;_LLC2: {struct _tuple13 _tmp700;return(_tmp700.f1=
Cyc_CfFlowInfo_BottomFL(),((_tmp700.f2=_tmp115->unknown_all,_tmp700)));}_LLC3:
...
env,inflow,1,e);_tmp11D=_tmp11C.f1;_tmp11E=_tmp11C.f2;{struct _tuple14 _tmp701;
struct _tuple14 _tmp120=(_tmp701.f1=_tmp11D,((_tmp701.f2=_tmp11E,_tmp701)));union
...
struct _tuple13 _tmp702;return(_tmp702.f1=_tmp11D,((_tmp702.f2=_tmp12C,_tmp702)));}{
const char*_tmp705;void*_tmp704;(_tmp704=0,Cyc_Tcutil_terr(e->loc,((_tmp705="expression attempts to copy unique value that may be copied elsewhere.",
_tag_dyneither(_tmp705,sizeof(char),71))),_tag_dyneither(_tmp704,sizeof(void*),0)));}{
struct _tuple13 _tmp706;return(_tmp706.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp706.f2=
_tmp115->unknown_all,_tmp706)));};_LLCD:;_LLCE: goto _LLCA;_LLCA:;}{void*_tmp131=
...
_tmp126,_tmp131);struct _tuple13 _tmp707;return(_tmp707.f1=Cyc_CfFlowInfo_ReachableFL(
_tmp132,_tmp124),((_tmp707.f2=_tmp127,_tmp707)));};}_LLC8:;_LLC9: goto _LLC5;_LLC5:;};}{
...
_tmp136,_tmp1C2);_tmp1C4=_tmp1C3.f1;_tmp1C5=_tmp1C3.f2;{struct _tuple13 _tmp708;
return(_tmp708.f1=_tmp1C4,((_tmp708.f2=_tmp1C2,_tmp708)));};};}_LLD2: {struct Cyc_Absyn_Cast_e_struct*
...
struct _tuple13 _tmp709;return(_tmp709.f1=inflow,((_tmp709.f2=_tmp115->zero,
_tmp709)));}_LLDC: {struct Cyc_Absyn_Const_e_struct*_tmp145=(struct Cyc_Absyn_Const_e_struct*)
...
_LLDF: {struct _tuple13 _tmp70A;return(_tmp70A.f1=inflow,((_tmp70A.f2=_tmp115->notzeroall,
_tmp70A)));}_LLE0: {struct Cyc_Absyn_Datatype_e_struct*_tmp14B=(struct Cyc_Absyn_Datatype_e_struct*)
...
_LLED: {struct _tuple13 _tmp70B;return(_tmp70B.f1=inflow,((_tmp70B.f2=_tmp115->unknown_all,
_tmp70B)));}_LLEE: {struct Cyc_Absyn_Var_e_struct*_tmp153=(struct Cyc_Absyn_Var_e_struct*)
...
_LLEF: {struct _tuple13 _tmp70C;return(_tmp70C.f1=inflow,((_tmp70C.f2=Cyc_CfFlowInfo_typ_to_absrval(
_tmp115,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v,_tmp115->unknown_all),
_tmp70C)));}_LLF0: {struct Cyc_Absyn_Var_e_struct*_tmp156=(struct Cyc_Absyn_Var_e_struct*)
...
struct Cyc_CfFlowInfo_VarRoot_struct*_tmp712;struct Cyc_CfFlowInfo_VarRoot_struct
_tmp711;struct _tuple13 _tmp710;return(_tmp710.f1=inflow,((_tmp710.f2=((void*(*)(
struct Cyc_Dict_Dict d,void*k))Cyc_Dict_lookup)(d,(void*)((_tmp712=_region_malloc(
env->r,sizeof(*_tmp712)),((_tmp712[0]=((_tmp711.tag=0,((_tmp711.f1=_tmp161,
_tmp711)))),_tmp712))))),_tmp710)));}_LLF6: {struct Cyc_Absyn_Primop_e_struct*
...
inflow,_tmp164);_tmp1CF=_tmp1CE.f1;_tmp1D0=_tmp1CE.f2;{struct _tuple13 _tmp713;
return(_tmp713.f1=_tmp1CF,((_tmp713.f2=_tmp1D0,_tmp713)));};}_LLF8: {struct Cyc_Absyn_Increment_e_struct*
_tmp165=(struct Cyc_Absyn_Increment_e_struct*)_tmp134;if(_tmp165->tag != 5)goto
_LLFA;else{_tmp166=_tmp165->f1;}}_LLF9: {struct Cyc_List_List _tmp714;struct Cyc_List_List
_tmp1D2=(_tmp714.hd=_tmp166,((_tmp714.tl=0,_tmp714)));union Cyc_CfFlowInfo_FlowInfo
...
_tmp1D6=_tmp1D5.f2;{struct _tuple19 _tmp715;struct _tuple19 _tmp1D8=(_tmp715.f1=
_tmp1D6,((_tmp715.f2=_tmp1D4,_tmp715)));union Cyc_CfFlowInfo_AbsLVal _tmp1D9;
...
_tmp1DE);goto _LL138;_LL13B:;_LL13C: goto _LL138;_LL138:;}{struct _tuple13 _tmp716;
return(_tmp716.f1=_tmp1D4,((_tmp716.f2=_tmp115->unknown_all,_tmp716)));};};}
...
_check_null(e->topt))->v)){{const char*_tmp719;void*_tmp718;(_tmp718=0,Cyc_Tcutil_terr(
e->loc,((_tmp719="cannot track unique pointers through multiple assignments",
_tag_dyneither(_tmp719,sizeof(char),58))),_tag_dyneither(_tmp718,sizeof(void*),0)));}{
struct _tuple13 _tmp71A;return(_tmp71A.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp71A.f2=
_tmp115->unknown_all,_tmp71A)));};}{struct Cyc_List_List _tmp71B;struct Cyc_List_List
_tmp1E4=(_tmp71B.hd=_tmp16B,((_tmp71B.tl=0,_tmp71B)));struct Cyc_List_List _tmp71C;
struct Cyc_List_List _tmp1E5=(_tmp71C.hd=_tmp168,((_tmp71C.tl=(struct Cyc_List_List*)&
_tmp1E4,_tmp71C)));union Cyc_CfFlowInfo_FlowInfo _tmp1E7;struct _tuple13 _tmp1E6=Cyc_NewControlFlow_anal_use_ints(
...
_tuple13 _tmp71D;return(_tmp71D.f1=_tmp1E7,((_tmp71D.f2=_tmp115->unknown_all,
_tmp71D)));};};};_LLFC: {struct Cyc_Absyn_AssignOp_e_struct*_tmp16C=(struct Cyc_Absyn_AssignOp_e_struct*)
...
_tmp720;void*_tmp71F;(_tmp71F=0,Cyc_Tcutil_terr(e->loc,((_tmp720="cannot track unique pointers through multiple assignments",
_tag_dyneither(_tmp720,sizeof(char),58))),_tag_dyneither(_tmp71F,sizeof(void*),0)));}{
struct _tuple13 _tmp721;return(_tmp721.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp721.f2=
_tmp115->unknown_all,_tmp721)));};}{struct Cyc_Dict_Dict*_tmp1F7=env->all_changed;
while(1){{struct Cyc_Dict_Dict*_tmp722;env->all_changed=((_tmp722=_region_malloc(
env->r,sizeof(*_tmp722)),((_tmp722[0]=_tmp115->mt_place_set,_tmp722))));}{union
...
_check_null(env->all_changed));{struct Cyc_Dict_Dict*_tmp723;env->all_changed=((
_tmp723=_region_malloc(env->r,sizeof(*_tmp723)),((_tmp723[0]=_tmp115->mt_place_set,
_tmp723))));}{union Cyc_CfFlowInfo_FlowInfo _tmp1FF;void*_tmp200;struct _tuple13
...
env,_tmp174->loc,_tmp208,_tmp209);{struct _tuple13 _tmp724;return(_tmp724.f1=Cyc_CfFlowInfo_BottomFL(),((
_tmp724.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp115,(void*)((struct Cyc_Core_Opt*)
_check_null(e->topt))->v,_tmp115->unknown_all),_tmp724)));};}_LL102: {struct Cyc_Absyn_FnCall_e_struct*
...
_tmp20F;struct Cyc_List_List*_tmp725;struct _tuple18 _tmp20D=Cyc_NewControlFlow_anal_unordered_Rexps(
_tmp20B,env,inflow,((_tmp725=_region_malloc(_tmp20B,sizeof(*_tmp725)),((_tmp725->hd=
_tmp176,((_tmp725->tl=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*
x))Cyc_List_rcopy)(_tmp20B,_tmp177),_tmp725)))))),0,1);_tmp20E=_tmp20D.f1;
...
struct Cyc_List_List*_tmp726;init_params=((_tmp726=_region_malloc(_tmp20B,sizeof(*
_tmp726)),((_tmp726->hd=(void*)_tmp21B,((_tmp726->tl=init_params,_tmp726))))));}
...
struct Cyc_List_List*_tmp727;nolive_unique_params=((_tmp727=_region_malloc(
_tmp20B,sizeof(*_tmp727)),((_tmp727->hd=(void*)_tmp21D,((_tmp727->tl=
nolive_unique_params,_tmp727))))));}goto _LL151;_LL156:;_LL157: goto _LL151;_LL151:;}
goto _LL14C;_LL14F:;_LL150: {const char*_tmp72A;void*_tmp729;(_tmp729=0,((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp72A="anal_Rexp: bad function type",
_tag_dyneither(_tmp72A,sizeof(char),29))),_tag_dyneither(_tmp729,sizeof(void*),0)));}
_LL14C:;}goto _LL147;_LL14A:;_LL14B: {const char*_tmp72D;void*_tmp72C;(_tmp72C=0,((
int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp72D="anal_Rexp: bad function type",_tag_dyneither(_tmp72D,sizeof(char),29))),
_tag_dyneither(_tmp72C,sizeof(void*),0)));}_LL147:;}{int i=1;for(0;_tmp20F != 0;(((
...
== Cyc_CfFlowInfo_NoneIL){const char*_tmp730;void*_tmp72F;(_tmp72F=0,Cyc_Tcutil_terr(((
struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp177))->hd)->loc,((
_tmp730="expression may not be initialized",_tag_dyneither(_tmp730,sizeof(char),
34))),_tag_dyneither(_tmp72F,sizeof(void*),0)));}{union Cyc_CfFlowInfo_FlowInfo
...
_tmp115,_tmp236,_tmp115->esc_all));goto _LL167;_LL16A:;_LL16B: {const char*_tmp733;
void*_tmp732;(_tmp732=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))
Cyc_Tcutil_impos)(((_tmp733="anal_Rexp:bad type for initialized arg",
_tag_dyneither(_tmp733,sizeof(char),39))),_tag_dyneither(_tmp732,sizeof(void*),0)));}
...
_tmp734;return(_tmp734.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp734.f2=Cyc_CfFlowInfo_typ_to_absrval(
_tmp115,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v,_tmp115->unknown_all),
_tmp734)));}else{struct _tuple13 _tmp735;return(_tmp735.f1=_tmp210,((_tmp735.f2=
Cyc_CfFlowInfo_typ_to_absrval(_tmp115,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v,
_tmp115->unknown_all),_tmp735)));}};};}_LL104: {struct Cyc_Absyn_Malloc_e_struct*
...
_LL105: {struct Cyc_CfFlowInfo_MallocPt_struct _tmp738;struct Cyc_CfFlowInfo_MallocPt_struct*
_tmp737;void*root=(void*)((_tmp737=_region_malloc(_tmp115->r,sizeof(*_tmp737)),((
_tmp737[0]=((_tmp738.tag=1,((_tmp738.f1=_tmp17D,((_tmp738.f2=(void*)((void*)((
struct Cyc_Core_Opt*)_check_null(e->topt))->v),_tmp738)))))),_tmp737))));struct
Cyc_CfFlowInfo_Place*_tmp739;struct Cyc_CfFlowInfo_Place*place=(_tmp739=
_region_malloc(_tmp115->r,sizeof(*_tmp739)),((_tmp739->root=root,((_tmp739->fields=
0,_tmp739)))));struct Cyc_CfFlowInfo_AddressOf_struct _tmp73C;struct Cyc_CfFlowInfo_AddressOf_struct*
_tmp73B;void*rval=(void*)((_tmp73B=_region_malloc(_tmp115->r,sizeof(*_tmp73B)),((
_tmp73B[0]=((_tmp73C.tag=5,((_tmp73C.f1=place,_tmp73C)))),_tmp73B))));void*
...
_tmp23E;struct Cyc_List_List*_tmp23F;struct Cyc_Absyn_Exp*_tmp73D[2];struct
_tuple18 _tmp23D=Cyc_NewControlFlow_anal_unordered_Rexps(_tmp23B,env,inflow,((
_tmp73D[1]=_tmp17D,((_tmp73D[0]=(struct Cyc_Absyn_Exp*)_tmp17B,((struct Cyc_List_List*(*)(
struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmp23B,
_tag_dyneither(_tmp73D,sizeof(struct Cyc_Absyn_Exp*),2)))))),1,1);_tmp23E=_tmp23D.f1;
...
_LL16E: {struct _tuple13 _tmp73E;return(_tmp73E.f1=outflow,((_tmp73E.f2=rval,
_tmp73E)));}_LL16F: if((_tmp242.ReachableFL).tag != 2)goto _LL16C;_tmp244=(struct
_tuple12)(_tmp242.ReachableFL).val;_tmp245=_tmp244.f1;_tmp246=_tmp244.f2;_LL170: {
struct _tuple13 _tmp73F;return(_tmp73F.f1=Cyc_CfFlowInfo_ReachableFL(((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp245,root,place_val),
_tmp246),((_tmp73F.f2=rval,_tmp73F)));}_LL16C:;};}_LL106: {struct Cyc_Absyn_Swap_e_struct*
...
_tmp740[2];struct _tuple18 _tmp250=Cyc_NewControlFlow_anal_unordered_Rexps(_tmp24E,
env,inflow,((_tmp740[1]=_tmp181,((_tmp740[0]=_tmp180,((struct Cyc_List_List*(*)(
struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmp24E,
_tag_dyneither(_tmp740,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,0);_tmp251=_tmp250.f1;
...
_LL174:;_LL175: goto _LL171;_LL171:;}{struct _tuple13 _tmp741;return(_tmp741.f1=
outflow,((_tmp741.f2=_tmp115->unknown_all,_tmp741)));};};};}_LL108: {struct Cyc_Absyn_New_e_struct*
...
_tmp744;struct Cyc_CfFlowInfo_MallocPt_struct*_tmp743;void*root=(void*)((_tmp743=
_region_malloc(_tmp115->r,sizeof(*_tmp743)),((_tmp743[0]=((_tmp744.tag=1,((
_tmp744.f1=_tmp184,((_tmp744.f2=(void*)((void*)((struct Cyc_Core_Opt*)_check_null(
e->topt))->v),_tmp744)))))),_tmp743))));struct Cyc_CfFlowInfo_Place*_tmp745;
struct Cyc_CfFlowInfo_Place*place=(_tmp745=_region_malloc(_tmp115->r,sizeof(*
_tmp745)),((_tmp745->root=root,((_tmp745->fields=0,_tmp745)))));struct Cyc_CfFlowInfo_AddressOf_struct
_tmp748;struct Cyc_CfFlowInfo_AddressOf_struct*_tmp747;void*rval=(void*)((_tmp747=
_region_malloc(_tmp115->r,sizeof(*_tmp747)),((_tmp747[0]=((_tmp748.tag=5,((
_tmp748.f1=place,_tmp748)))),_tmp747))));((int(*)(struct Cyc_Dict_Dict*set,struct
...
_tmp265;struct Cyc_List_List*_tmp266;struct Cyc_Absyn_Exp*_tmp749[2];struct
_tuple18 _tmp264=Cyc_NewControlFlow_anal_unordered_Rexps(_tmp262,env,inflow,((
_tmp749[1]=_tmp184,((_tmp749[0]=(struct Cyc_Absyn_Exp*)_tmp183,((struct Cyc_List_List*(*)(
struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmp262,
_tag_dyneither(_tmp749,sizeof(struct Cyc_Absyn_Exp*),2)))))),1,1);_tmp265=_tmp264.f1;
...
_LL182: {struct _tuple13 _tmp74A;return(_tmp74A.f1=outflow,((_tmp74A.f2=rval,
_tmp74A)));}_LL183: if((_tmp26A.ReachableFL).tag != 2)goto _LL180;_tmp26C=(struct
_tuple12)(_tmp26A.ReachableFL).val;_tmp26D=_tmp26C.f1;_tmp26E=_tmp26C.f2;_LL184: {
struct _tuple13 _tmp74B;return(_tmp74B.f1=Cyc_CfFlowInfo_ReachableFL(((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp26D,root,place_val),
_tmp26E),((_tmp74B.f2=rval,_tmp74B)));}_LL180:;};};}_LL10A: {struct Cyc_Absyn_Address_e_struct*
...
_tmp74C;return(_tmp74C.f1=_tmp277,((_tmp74C.f2=_tmp115->notzeroall,_tmp74C)));}
_LL188: if((_tmp279.PlaceL).tag != 1)goto _LL185;_tmp27B=(struct Cyc_CfFlowInfo_Place*)(
_tmp279.PlaceL).val;_LL189: {struct Cyc_CfFlowInfo_AddressOf_struct*_tmp752;
struct Cyc_CfFlowInfo_AddressOf_struct _tmp751;struct _tuple13 _tmp750;return(
_tmp750.f1=_tmp277,((_tmp750.f2=(void*)((_tmp752=_region_malloc(env->r,sizeof(*
_tmp752)),((_tmp752[0]=((_tmp751.tag=5,((_tmp751.f1=_tmp27B,_tmp751)))),_tmp752)))),
_tmp750)));}_LL185:;};}_LL10C: {struct Cyc_Absyn_Deref_e_struct*_tmp187=(struct
...
_tmp753;return(_tmp753.f1=_tmp284,((_tmp753.f2=Cyc_CfFlowInfo_typ_to_absrval(
_tmp115,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v,_tmp115->unknown_all),
_tmp753)));}{void*_tmp287=_tmp285;int _tmp289;struct _dyneither_ptr _tmp28A;_LL18B: {
...
_check_null(_tmp18A->topt))->v,_tmp18B);struct _tuple13 _tmp754;return(_tmp754.f1=
_tmp284,((_tmp754.f2=*((void**)_check_dyneither_subscript(_tmp28A,sizeof(void*),
_tmp28B)),_tmp754)));}_LL18D:;_LL18E: {struct Cyc_Core_Impossible_struct _tmp761;
const char*_tmp760;void*_tmp75F[1];struct Cyc_String_pa_struct _tmp75E;struct Cyc_Core_Impossible_struct*
_tmp75D;(int)_throw((void*)((_tmp75D=_cycalloc(sizeof(*_tmp75D)),((_tmp75D[0]=((
_tmp761.tag=Cyc_Core_Impossible,((_tmp761.f1=(struct _dyneither_ptr)((_tmp75E.tag=
0,((_tmp75E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(
e)),((_tmp75F[0]=& _tmp75E,Cyc_aprintf(((_tmp760="anal_Rexp: AggrMember: %s",
_tag_dyneither(_tmp760,sizeof(char),26))),_tag_dyneither(_tmp75F,sizeof(void*),1)))))))),
_tmp761)))),_tmp75D)))));}_LL18A:;};}_LL110: {struct Cyc_Absyn_Tagcheck_e_struct*
...
inflow,_tmp18D);_tmp293=_tmp292.f1;_tmp294=_tmp292.f2;{struct _tuple13 _tmp762;
return(_tmp762.f1=_tmp293,((_tmp762.f2=_tmp115->unknown_all,_tmp762)));};}_LL112: {
...
_tmp29F)){struct _tuple13 _tmp763;return(_tmp763.f1=_tmp29A,((_tmp763.f2=Cyc_CfFlowInfo_typ_to_absrval(
_tmp115,(void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v,_tmp115->unknown_all),
_tmp763)));}{void*_tmp2A1=_tmp29B;int _tmp2A3;struct _dyneither_ptr _tmp2A4;_LL195: {
...
_tuple13 _tmp764;return(_tmp764.f1=_tmp29A,((_tmp764.f2=*((void**)
_check_dyneither_subscript(_tmp2A4,sizeof(void*),_tmp2A5)),_tmp764)));}_LL197:;
_LL198: {struct Cyc_Core_Impossible_struct _tmp76A;const char*_tmp769;struct Cyc_Core_Impossible_struct*
_tmp768;(int)_throw((void*)((_tmp768=_cycalloc(sizeof(*_tmp768)),((_tmp768[0]=((
_tmp76A.tag=Cyc_Core_Impossible,((_tmp76A.f1=((_tmp769="anal_Rexp: AggrArrow",
_tag_dyneither(_tmp769,sizeof(char),21))),_tmp76A)))),_tmp768)))));}_LL194:;};
_LL192:;_LL193: {struct Cyc_Core_Impossible_struct _tmp770;const char*_tmp76F;
struct Cyc_Core_Impossible_struct*_tmp76E;(int)_throw((void*)((_tmp76E=_cycalloc(
sizeof(*_tmp76E)),((_tmp76E[0]=((_tmp770.tag=Cyc_Core_Impossible,((_tmp770.f1=((
_tmp76F="anal_Rexp: AggrArrow ptr",_tag_dyneither(_tmp76F,sizeof(char),25))),
_tmp770)))),_tmp76E)))));}_LL18F:;};};}_LL114: {struct Cyc_Absyn_Conditional_e_struct*
...
_tmp771;struct _tuple13 _tmp2B8=(_tmp771.f1=_tmp2B6,((_tmp771.f2=_tmp2B7,_tmp771)));
struct _tuple13 _tmp772;struct _tuple13 _tmp2B9=(_tmp772.f1=_tmp2B4,((_tmp772.f2=
_tmp115->zero,_tmp772)));return Cyc_CfFlowInfo_join_flow_and_rval(_tmp115,env->all_changed,
...
_tmp2C0=_tmp2BF.f1;_tmp2C1=_tmp2BF.f2;{struct _tuple13 _tmp773;struct _tuple13
_tmp2C2=(_tmp773.f1=_tmp2C0,((_tmp773.f2=_tmp2C1,_tmp773)));struct _tuple13
_tmp774;struct _tuple13 _tmp2C3=(_tmp774.f1=_tmp2BD,((_tmp774.f2=_tmp115->notzeroall,
_tmp774)));return Cyc_CfFlowInfo_join_flow_and_rval(_tmp115,env->all_changed,
...
struct Cyc_Absyn_Exp*_tmp775[2];struct _tuple18 _tmp2C8=Cyc_NewControlFlow_anal_unordered_Rexps(
_tmp2C6,env,inflow,((_tmp775[1]=_tmp19E,((_tmp775[0]=_tmp19D,((struct Cyc_List_List*(*)(
struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmp2C6,
_tag_dyneither(_tmp775,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,1);_tmp2C9=_tmp2C8.f1;
...
const char*_tmp778;void*_tmp777;(_tmp777=0,Cyc_Tcutil_terr(_tmp19E->loc,((_tmp778="expression may not be initialized",
...
_tuple13 _tmp779;return(_tmp779.f1=_tmp2CB,((_tmp779.f2=*((void**)
_check_dyneither_subscript(_tmp2DD,sizeof(void*),(int)i)),_tmp779)));}_LL1A8:;
_LL1A9: {struct Cyc_Core_Impossible_struct _tmp77F;const char*_tmp77E;struct Cyc_Core_Impossible_struct*
_tmp77D;(int)_throw((void*)((_tmp77D=_cycalloc(sizeof(*_tmp77D)),((_tmp77D[0]=((
_tmp77F.tag=Cyc_Core_Impossible,((_tmp77F.f1=((_tmp77E="anal_Rexp: Subscript",
_tag_dyneither(_tmp77E,sizeof(char),21))),_tmp77F)))),_tmp77D)))));}_LL1A5:;}
...
_LL1AC: {struct _tuple13 _tmp780;return(_tmp780.f1=_tmp2E3,((_tmp780.f2=_tmp2E4,
_tmp780)));}_LL1AD:;_LL1AE: {struct _tuple13 _tmp781;return(_tmp781.f1=_tmp2CB,((
_tmp781.f2=_tmp2E4,_tmp781)));}_LL1AA:;};}_LL1A3:;_LL1A4: {struct Cyc_Core_Impossible_struct
_tmp787;const char*_tmp786;struct Cyc_Core_Impossible_struct*_tmp785;(int)_throw((
void*)((_tmp785=_cycalloc(sizeof(*_tmp785)),((_tmp785[0]=((_tmp787.tag=Cyc_Core_Impossible,((
_tmp787.f1=((_tmp786="anal_Rexp: Subscript -- bad type",_tag_dyneither(_tmp786,
sizeof(char),33))),_tmp787)))),_tmp785)))));}_LL19E:;};};}_LL11C: {struct Cyc_Absyn_Datatype_e_struct*
...
_tmp78D;unsigned int _tmp78C;struct _dyneither_ptr _tmp78B;void**_tmp78A;
unsigned int _tmp789;struct _dyneither_ptr aggrdict=(_tmp789=(unsigned int)((int(*)(
struct Cyc_List_List*x))Cyc_List_length)(_tmp1A3),((_tmp78A=(void**)
_region_malloc(env->r,_check_times(sizeof(void*),_tmp789)),((_tmp78B=
_tag_dyneither(_tmp78A,sizeof(void*),_tmp789),((((_tmp78C=_tmp789,_tmp78E(&
_tmp78D,& _tmp78C,& _tmp78A,& _tmp2EF))),_tmp78B)))))));struct Cyc_CfFlowInfo_Aggregate_struct*
_tmp794;struct Cyc_CfFlowInfo_Aggregate_struct _tmp793;struct _tuple13 _tmp792;
return(_tmp792.f1=_tmp2EE,((_tmp792.f2=(void*)((_tmp794=_region_malloc(env->r,
sizeof(*_tmp794)),((_tmp794[0]=((_tmp793.tag=6,((_tmp793.f1=0,((_tmp793.f2=
aggrdict,_tmp793)))))),_tmp794)))),_tmp792)));};}_LL120: {struct Cyc_Absyn_AnonStruct_e_struct*
...
Cyc_Core_Impossible_struct _tmp79A;const char*_tmp799;struct Cyc_Core_Impossible_struct*
_tmp798;(int)_throw((void*)((_tmp798=_cycalloc(sizeof(*_tmp798)),((_tmp798[0]=((
_tmp79A.tag=Cyc_Core_Impossible,((_tmp79A.f1=((_tmp799="anal_Rexp:anon struct has bad type",
_tag_dyneither(_tmp799,sizeof(char),35))),_tmp79A)))),_tmp798)))));}_LL1AF:;}
...
_LL1B7;}_LL1B6: {struct Cyc_Core_Impossible_struct _tmp7A0;const char*_tmp79F;
struct Cyc_Core_Impossible_struct*_tmp79E;(int)_throw((void*)((_tmp79E=_cycalloc(
sizeof(*_tmp79E)),((_tmp79E[0]=((_tmp7A0.tag=Cyc_Core_Impossible,((_tmp7A0.f1=((
_tmp79F="anal_Rexp:Aggregate_e",_tag_dyneither(_tmp79F,sizeof(char),22))),
_tmp7A0)))),_tmp79E)))));}_LL1B7: {struct Cyc_Absyn_FieldName_struct*_tmp304=(
...
_tmp7A6;struct Cyc_CfFlowInfo_Aggregate_struct _tmp7A5;struct _tuple13 _tmp7A4;
return(_tmp7A4.f1=_tmp300,((_tmp7A4.f2=(void*)((_tmp7A6=_region_malloc(env->r,
sizeof(*_tmp7A6)),((_tmp7A6[0]=((_tmp7A5.tag=6,((_tmp7A5.f1=_tmp1AA == Cyc_Absyn_UnionA,((
_tmp7A5.f2=aggrdict,_tmp7A5)))))),_tmp7A6)))),_tmp7A4)));};};}_LL124: {struct Cyc_Absyn_Aggregate_e_struct*
_tmp1AE=(struct Cyc_Absyn_Aggregate_e_struct*)_tmp134;if(_tmp1AE->tag != 29)goto
_LL126;}_LL125: {struct Cyc_Core_Impossible_struct _tmp7AC;const char*_tmp7AB;
struct Cyc_Core_Impossible_struct*_tmp7AA;(int)_throw((void*)((_tmp7AA=_cycalloc(
sizeof(*_tmp7AA)),((_tmp7AA[0]=((_tmp7AC.tag=Cyc_Core_Impossible,((_tmp7AC.f1=((
_tmp7AB="anal_Rexp:missing aggrdeclimpl",_tag_dyneither(_tmp7AB,sizeof(char),31))),
_tmp7AC)))),_tmp7AA)))));}_LL126: {struct Cyc_Absyn_Array_e_struct*_tmp1AF=(
...
_tmp314,(void*)_tmp315->hd);}{struct _tuple13 _tmp7AD;return(_tmp7AD.f1=_tmp314,((
_tmp7AD.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp115,(void*)((struct Cyc_Core_Opt*)
_check_null(e->topt))->v,_tmp115->unknown_all),_tmp7AD)));};}_LL128: {struct Cyc_Absyn_Comprehension_e_struct*
...
_LL1BB: {struct _tuple13 _tmp7AE;return(_tmp7AE.f1=_tmp318,((_tmp7AE.f2=_tmp115->unknown_all,
_tmp7AE)));}_LL1BC: if((_tmp31A.ReachableFL).tag != 2)goto _LL1B9;_tmp31C=(struct
...
const char*_tmp7B1;void*_tmp7B0;(_tmp7B0=0,Cyc_Tcutil_terr(_tmp1B3->loc,((_tmp7B1="expression may not be initialized",
_tag_dyneither(_tmp7B1,sizeof(char),34))),_tag_dyneither(_tmp7B0,sizeof(void*),0)));}{
...
_tmp334->escapes))goto _LL1C9;_LL1C8:{struct Cyc_CfFlowInfo_Reln*_tmp7B4;struct Cyc_List_List*
_tmp7B3;new_relns=((_tmp7B3=_region_malloc(env->r,sizeof(*_tmp7B3)),((_tmp7B3->hd=((
_tmp7B4=_region_malloc(env->r,sizeof(*_tmp7B4)),((_tmp7B4->vd=_tmp1B2,((_tmp7B4->rop=
Cyc_CfFlowInfo_LessVar(_tmp334,_tmp334->type),_tmp7B4)))))),((_tmp7B3->tl=
_tmp31E,_tmp7B3))))));}goto _LL1BE;_LL1C9: {struct Cyc_Absyn_Const_e_struct*
...
_tmp7B7;struct Cyc_List_List*_tmp7B6;new_relns=((_tmp7B6=_region_malloc(env->r,
sizeof(*_tmp7B6)),((_tmp7B6->hd=((_tmp7B7=_region_malloc(env->r,sizeof(*_tmp7B7)),((
_tmp7B7->vd=_tmp1B2,((_tmp7B7->rop=Cyc_CfFlowInfo_LessConst((unsigned int)
_tmp338),_tmp7B7)))))),((_tmp7B6->tl=_tmp31E,_tmp7B6))))));}goto _LL1BE;_LL1CB: {
...
_tmp7BA;struct Cyc_List_List*_tmp7B9;new_relns=((_tmp7B9=_region_malloc(env->r,
sizeof(*_tmp7B9)),((_tmp7B9->hd=((_tmp7BA=_region_malloc(env->r,sizeof(*_tmp7BA)),((
_tmp7BA->vd=_tmp1B2,((_tmp7BA->rop=Cyc_CfFlowInfo_LessNumelts(_tmp352),_tmp7BA)))))),((
_tmp7B9->tl=_tmp31E,_tmp7B9))))));}goto _LL1CF;_LL1D8:;_LL1D9: goto _LL1CF;_LL1CF:;}
...
_LL1DD;}_LL1DC: {struct _tuple13 _tmp7BB;return(_tmp7BB.f1=_tmp318,((_tmp7BB.f2=
_tmp115->unknown_all,_tmp7BB)));}_LL1DD: {struct Cyc_CfFlowInfo_NotZeroThis_struct*
...
_LL1E3;}_LL1E2: {struct Cyc_List_List _tmp7BC;struct Cyc_List_List _tmp35B=(_tmp7BC.hd=
_tmp1B2,((_tmp7BC.tl=0,_tmp7BC)));_tmp318=Cyc_NewControlFlow_add_vars(_tmp115,
...
_LL1E7: {struct _tuple13 _tmp7BD;return(_tmp7BD.f1=_tmp35D,((_tmp7BD.f2=_tmp115->unknown_all,
_tmp7BD)));}_LL1E8: if((_tmp35F.ReachableFL).tag != 2)goto _LL1E5;_tmp361=(struct
_tuple12)(_tmp35F.ReachableFL).val;_tmp362=_tmp361.f1;_LL1E9: if(Cyc_CfFlowInfo_initlevel(
_tmp115,_tmp362,_tmp35E)!= Cyc_CfFlowInfo_AllIL){{const char*_tmp7C0;void*_tmp7BF;(
_tmp7BF=0,Cyc_Tcutil_terr(_tmp1B3->loc,((_tmp7C0="expression may not be initialized",
_tag_dyneither(_tmp7C0,sizeof(char),34))),_tag_dyneither(_tmp7BF,sizeof(void*),0)));}{
struct _tuple13 _tmp7C1;return(_tmp7C1.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7C1.f2=
_tmp115->unknown_all,_tmp7C1)));};}_LL1E5:;}_tmp318=_tmp35D;goto _LL1E4;};}_LL1E3:;
_LL1E4: while(1){struct Cyc_List_List _tmp7C2;struct Cyc_List_List _tmp368=(_tmp7C2.hd=
_tmp1B2,((_tmp7C2.tl=0,_tmp7C2)));_tmp318=Cyc_NewControlFlow_add_vars(_tmp115,
...
_tmp115,_tmp36F,_tmp36B)!= Cyc_CfFlowInfo_AllIL){{const char*_tmp7C5;void*_tmp7C4;(
_tmp7C4=0,Cyc_Tcutil_terr(_tmp1B3->loc,((_tmp7C5="expression may not be initialized",
_tag_dyneither(_tmp7C5,sizeof(char),34))),_tag_dyneither(_tmp7C4,sizeof(void*),0)));}{
struct _tuple13 _tmp7C6;return(_tmp7C6.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7C6.f2=
_tmp115->unknown_all,_tmp7C6)));};}_LL1EA:;}{union Cyc_CfFlowInfo_FlowInfo _tmp373=
Cyc_CfFlowInfo_join_flow(_tmp115,env->all_changed,_tmp318,_tmp36A);if(Cyc_CfFlowInfo_flow_lessthan_approx(
_tmp373,_tmp318))break;_tmp318=_tmp373;};};}{struct _tuple13 _tmp7C7;return(
_tmp7C7.f1=_tmp318,((_tmp7C7.f2=_tmp115->unknown_all,_tmp7C7)));};_LL1DA:;};};
...
_tmp7CD;const char*_tmp7CC;struct Cyc_Core_Impossible_struct*_tmp7CB;(int)_throw((
void*)((_tmp7CB=_cycalloc(sizeof(*_tmp7CB)),((_tmp7CB[0]=((_tmp7CD.tag=Cyc_Core_Impossible,((
_tmp7CD.f1=((_tmp7CC="analyze_Rexp: ill-formed StmtExp",_tag_dyneither(_tmp7CC,
sizeof(char),33))),_tmp7CD)))),_tmp7CB)))));}_LL1EF:;};}_LL12C: {struct Cyc_Absyn_Var_e_struct*
...
struct Cyc_Core_Impossible_struct _tmp7D3;const char*_tmp7D2;struct Cyc_Core_Impossible_struct*
_tmp7D1;(int)_throw((void*)((_tmp7D1=_cycalloc(sizeof(*_tmp7D1)),((_tmp7D1[0]=((
_tmp7D3.tag=Cyc_Core_Impossible,((_tmp7D3.f1=((_tmp7D2="anal_Rexp, unexpected exp form",
_tag_dyneither(_tmp7D2,sizeof(char),31))),_tmp7D3)))),_tmp7D1)))));}_LLCF:;};}
...
_LL1FF: {struct _tuple14 _tmp7D4;return(_tmp7D4.f1=f,((_tmp7D4.f2=Cyc_CfFlowInfo_UnknownL(),
_tmp7D4)));}_LL200: if((_tmp38F.ReachableFL).tag != 2)goto _LL1FD;_tmp391=(struct
...
goto _LL207;}_LL206:{struct Cyc_CfFlowInfo_NotZero_struct _tmp7D7;struct Cyc_CfFlowInfo_NotZero_struct*
_tmp7D6;e->annot=(void*)((_tmp7D6=_cycalloc(sizeof(*_tmp7D6)),((_tmp7D6[0]=((
_tmp7D7.tag=Cyc_CfFlowInfo_NotZero,((_tmp7D7.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmp393),_tmp7D7)))),_tmp7D6))));}goto _LL202;_LL207: {struct Cyc_CfFlowInfo_AddressOf_struct*
...
_tmp39A.fields;}}_LL208:{struct Cyc_CfFlowInfo_NotZero_struct _tmp7DA;struct Cyc_CfFlowInfo_NotZero_struct*
_tmp7D9;e->annot=(void*)((_tmp7D9=_cycalloc(sizeof(*_tmp7D9)),((_tmp7D9[0]=((
_tmp7DA.tag=Cyc_CfFlowInfo_NotZero,((_tmp7DA.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmp393),_tmp7DA)))),_tmp7D9))));}{struct Cyc_CfFlowInfo_Place*_tmp7DD;struct
_tuple14 _tmp7DC;return(_tmp7DC.f1=f,((_tmp7DC.f2=Cyc_CfFlowInfo_PlaceL(((_tmp7DD=
_region_malloc(_tmp387->r,sizeof(*_tmp7DD)),((_tmp7DD->root=_tmp39B,((_tmp7DD->fields=((
struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x,struct Cyc_List_List*
y))Cyc_List_rappend)(_tmp387->r,_tmp39C,flds),_tmp7DD))))))),_tmp7DC)));};_LL209: {
...
struct _tuple14 _tmp7DE;return(_tmp7DE.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7DE.f2=
Cyc_CfFlowInfo_UnknownL(),_tmp7DE)));};_LL20B: {struct Cyc_CfFlowInfo_UnknownR_struct*
...
_tmp7E1;struct Cyc_CfFlowInfo_UnknownZ_struct*_tmp7E0;e->annot=(void*)((_tmp7E0=
_cycalloc(sizeof(*_tmp7E0)),((_tmp7E0[0]=((_tmp7E1.tag=Cyc_CfFlowInfo_UnknownZ,((
_tmp7E1.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,_tmp393),_tmp7E1)))),
_tmp7E0))));}_LL202:;}else{struct Cyc_CfFlowInfo_UnknownZ_struct _tmp7E4;struct Cyc_CfFlowInfo_UnknownZ_struct*
_tmp7E3;e->annot=(void*)((_tmp7E3=_cycalloc(sizeof(*_tmp7E3)),((_tmp7E3[0]=((
_tmp7E4.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp7E4.f1=Cyc_CfFlowInfo_copy_relns(Cyc_Core_heap_region,
_tmp393),_tmp7E4)))),_tmp7E3))));}if(Cyc_CfFlowInfo_initlevel(_tmp387,_tmp392,r)
== Cyc_CfFlowInfo_NoneIL){const char*_tmp7E7;void*_tmp7E6;(_tmp7E6=0,Cyc_Tcutil_terr(
e->loc,((_tmp7E7="dereference of possibly uninitialized pointer",_tag_dyneither(
_tmp7E7,sizeof(char),46))),_tag_dyneither(_tmp7E6,sizeof(void*),0)));}{struct
_tuple14 _tmp7E8;return(_tmp7E8.f1=f,((_tmp7E8.f2=Cyc_CfFlowInfo_UnknownL(),
_tmp7E8)));};_LL1FD:;}_LL1FB:;_LL1FC: {struct Cyc_Core_Impossible_struct _tmp7EE;
...
_tmp7EE.f1=((_tmp7ED="left deref of non-pointer-type",_tag_dyneither(_tmp7ED,
sizeof(char),31))),_tmp7EE)))),_tmp7EC)))));}_LL1F8:;}static struct _tuple14 Cyc_NewControlFlow_anal_Lexp_rec(
...
struct _tuple14 _tmp7EF;return(_tmp7EF.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7EF.f2=
Cyc_CfFlowInfo_UnknownL(),_tmp7EF)));}_LL212: if((_tmp3B2.ReachableFL).tag != 2)
...
else{_tmp3CA=_tmp3C9->f1;}};}}_LL220: {struct Cyc_CfFlowInfo_Place*_tmp7F9;struct
Cyc_CfFlowInfo_VarRoot_struct _tmp7F8;struct Cyc_CfFlowInfo_VarRoot_struct*_tmp7F7;
struct _tuple14 _tmp7F6;return(_tmp7F6.f1=inflow,((_tmp7F6.f2=Cyc_CfFlowInfo_PlaceL(((
_tmp7F9=_region_malloc(env->r,sizeof(*_tmp7F9)),((_tmp7F9->root=(void*)((_tmp7F7=
_region_malloc(env->r,sizeof(*_tmp7F7)),((_tmp7F7[0]=((_tmp7F8.tag=0,((_tmp7F8.f1=
_tmp3CA,_tmp7F8)))),_tmp7F7)))),((_tmp7F9->fields=flds,_tmp7F9))))))),_tmp7F6)));}
...
_tuple14 _tmp7FA;return(_tmp7FA.f1=inflow,((_tmp7FA.f2=Cyc_CfFlowInfo_UnknownL(),
_tmp7FA)));}_LL223: {struct Cyc_Absyn_AggrArrow_e_struct*_tmp3CF=(struct Cyc_Absyn_AggrArrow_e_struct*)
...
_tmp7FB;flds=((_tmp7FB=_region_malloc(env->r,sizeof(*_tmp7FB)),((_tmp7FB->hd=(
void*)Cyc_CfFlowInfo_get_field_index(_tmp3E2,_tmp3D1),((_tmp7FB->tl=flds,_tmp7FB))))));}
goto _LL22D;_LL230:;_LL231: {struct Cyc_Core_Impossible_struct _tmp801;const char*
_tmp800;struct Cyc_Core_Impossible_struct*_tmp7FF;(int)_throw((void*)((_tmp7FF=
_cycalloc(sizeof(*_tmp7FF)),((_tmp7FF[0]=((_tmp801.tag=Cyc_Core_Impossible,((
_tmp801.f1=((_tmp800="anal_Rexp: AggrArrow ptr",_tag_dyneither(_tmp800,sizeof(
char),25))),_tmp801)))),_tmp7FF)))));}_LL22D:;}_tmp3D3=_tmp3D0;goto _LL226;_LL225: {
...
_tmp802;struct _tuple14 _tmp3EB=(_tmp802.f1=_tmp3E8,((_tmp802.f2=_tmp3E9,_tmp802)));
...
_tmp805;struct Cyc_CfFlowInfo_MallocPt_struct*_tmp804;void*new_root=(void*)((
_tmp804=_region_malloc(_tmp3B1->r,sizeof(*_tmp804)),((_tmp804[0]=((_tmp805.tag=1,((
_tmp805.f1=e,((_tmp805.f2=(void*)((void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v),
_tmp805)))))),_tmp804))));struct Cyc_CfFlowInfo_Place*_tmp806;struct Cyc_CfFlowInfo_Place*
place=(_tmp806=_region_malloc(_tmp3B1->r,sizeof(*_tmp806)),((_tmp806->root=
new_root,((_tmp806->fields=0,_tmp806)))));struct Cyc_CfFlowInfo_AddressOf_struct
_tmp809;struct Cyc_CfFlowInfo_AddressOf_struct*_tmp808;void*res=(void*)((_tmp808=
_region_malloc(_tmp3B1->r,sizeof(*_tmp808)),((_tmp808[0]=((_tmp809.tag=5,((
_tmp809.f1=place,_tmp809)))),_tmp808))));((int(*)(struct Cyc_Dict_Dict*set,struct
Cyc_CfFlowInfo_Place*place,struct Cyc_Position_Segment*loc))Cyc_CfFlowInfo_update_place_set)(
...
_tmp3D6)).f1;struct Cyc_List_List*_tmp80A;return Cyc_NewControlFlow_anal_Lexp_rec(
env,inflow,expand_unique,_tmp3D5,((_tmp80A=_region_malloc(env->r,sizeof(*_tmp80A)),((
_tmp80A->hd=(void*)((int)_tmp404),((_tmp80A->tl=flds,_tmp80A)))))));}_LL23F: {
...
_tmp409;struct Cyc_List_List*_tmp40A;struct Cyc_Absyn_Exp*_tmp80B[2];struct
_tuple18 _tmp408=Cyc_NewControlFlow_anal_unordered_Rexps(_tmp406,env,inflow,((
_tmp80B[1]=_tmp3D6,((_tmp80B[0]=_tmp3D5,((struct Cyc_List_List*(*)(struct
_RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmp406,_tag_dyneither(
_tmp80B,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,1);_tmp409=_tmp408.f1;_tmp40A=
...
const char*_tmp80E;void*_tmp80D;(_tmp80D=0,Cyc_Tcutil_terr(_tmp3D6->loc,((_tmp80E="expression may not be initialized",
_tag_dyneither(_tmp80E,sizeof(char),34))),_tag_dyneither(_tmp80D,sizeof(void*),0)));}{
...
_tmp416.BottomFL).val;_LL24A: {struct _tuple14 _tmp80F;return(_tmp80F.f1=_tmp414,((
_tmp80F.f2=_tmp415,_tmp80F)));}_LL24B:;_LL24C: {struct _tuple14 _tmp810;return(
_tmp810.f1=_tmp40B,((_tmp810.f2=_tmp415,_tmp810)));}_LL248:;};};};}_LL241:;
_LL242: {struct Cyc_Core_Impossible_struct _tmp816;const char*_tmp815;struct Cyc_Core_Impossible_struct*
_tmp814;(int)_throw((void*)((_tmp814=_cycalloc(sizeof(*_tmp814)),((_tmp814[0]=((
_tmp816.tag=Cyc_Core_Impossible,((_tmp816.f1=((_tmp815="anal_Lexp: Subscript -- bad type",
_tag_dyneither(_tmp815,sizeof(char),33))),_tmp816)))),_tmp814)))));}_LL23C:;}
...
_check_null(_tmp3D8->topt))->v)){struct _tuple14 _tmp817;return(_tmp817.f1=inflow,((
_tmp817.f2=Cyc_CfFlowInfo_UnknownL(),_tmp817)));}{struct Cyc_List_List*_tmp818;
return Cyc_NewControlFlow_anal_Lexp_rec(env,inflow,expand_unique,_tmp3D8,((
_tmp818=_region_malloc(env->r,sizeof(*_tmp818)),((_tmp818->hd=(void*)Cyc_CfFlowInfo_get_field_index((
void*)((struct Cyc_Core_Opt*)_check_null(_tmp3D8->topt))->v,_tmp3D9),((_tmp818->tl=
flds,_tmp818)))))));};_LL22B:;_LL22C: {struct _tuple14 _tmp819;return(_tmp819.f1=
Cyc_CfFlowInfo_BottomFL(),((_tmp819.f2=Cyc_CfFlowInfo_UnknownL(),_tmp819)));}
...
_tmp421=_tmp420.f1;_tmp422=_tmp420.f2;{struct _tuple14 _tmp81A;return(_tmp81A.f1=
_tmp421,((_tmp81A.f2=_tmp422,_tmp81A)));};}static struct _tuple15 Cyc_NewControlFlow_anal_test(
struct Cyc_NewControlFlow_AnalEnv*env,union Cyc_CfFlowInfo_FlowInfo inflow,struct
...
_tmp81B;return(_tmp81B.f1=Cyc_CfFlowInfo_join_flow(_tmp424,env->all_changed,
_tmp440,_tmp443),((_tmp81B.f2=Cyc_CfFlowInfo_join_flow(_tmp424,env->all_changed,
_tmp441,_tmp444),_tmp81B)));};};};}_LL250: {struct Cyc_Absyn_And_e_struct*_tmp42A=(
...
_tmp81C;return(_tmp81C.f1=_tmp44A,((_tmp81C.f2=Cyc_CfFlowInfo_join_flow(_tmp424,
env->all_changed,_tmp448,_tmp44B),_tmp81C)));};};}_LL252: {struct Cyc_Absyn_Or_e_struct*
...
_tmp81D;return(_tmp81D.f1=Cyc_CfFlowInfo_join_flow(_tmp424,env->all_changed,
_tmp44E,_tmp451),((_tmp81D.f2=_tmp452,_tmp81D)));};};}_LL254: {struct Cyc_Absyn_SeqExp_e_struct*
...
env,inflow,_tmp437);_tmp458=_tmp457.f1;_tmp459=_tmp457.f2;{struct _tuple15 _tmp81E;
return(_tmp81E.f1=_tmp459,((_tmp81E.f2=_tmp458,_tmp81E)));};}_LL258: {struct Cyc_Absyn_Primop_e_struct*
...
_LL25E: {struct _tuple15 _tmp81F;return(_tmp81F.f1=f,((_tmp81F.f2=f,_tmp81F)));}
...
== Cyc_CfFlowInfo_NoneIL){const char*_tmp822;void*_tmp821;(_tmp821=0,Cyc_Tcutil_terr(((
struct Cyc_Absyn_Exp*)_tmp43B->hd)->loc,((_tmp822="expression may not be initialized",
_tag_dyneither(_tmp822,sizeof(char),34))),_tag_dyneither(_tmp821,sizeof(void*),0)));}
if(Cyc_CfFlowInfo_initlevel(env->fenv,_tmp462,r2)== Cyc_CfFlowInfo_NoneIL){const
char*_tmp825;void*_tmp824;(_tmp824=0,Cyc_Tcutil_terr(((struct Cyc_Absyn_Exp*)((
struct Cyc_List_List*)_check_null(_tmp43B->tl))->hd)->loc,((_tmp825="expression may not be initialized",
_tag_dyneither(_tmp825,sizeof(char),34))),_tag_dyneither(_tmp824,sizeof(void*),0)));}
if(_tmp43A == Cyc_Absyn_Eq  || _tmp43A == Cyc_Absyn_Neq){struct _tuple0 _tmp826;
struct _tuple0 _tmp46C=(_tmp826.f1=r1,((_tmp826.f2=r2,_tmp826)));void*_tmp46D;
...
case Cyc_Absyn_Eq: _LL276: {struct _tuple15 _tmp827;return(_tmp827.f1=_tmp495,((
_tmp827.f2=_tmp494,_tmp827)));}case Cyc_Absyn_Neq: _LL277: {struct _tuple15 _tmp828;
return(_tmp828.f1=_tmp494,((_tmp828.f2=_tmp495,_tmp828)));}default: _LL278: {
struct Cyc_Core_Impossible_struct _tmp82E;const char*_tmp82D;struct Cyc_Core_Impossible_struct*
_tmp82C;(int)_throw((void*)((_tmp82C=_cycalloc(sizeof(*_tmp82C)),((_tmp82C[0]=((
_tmp82E.tag=Cyc_Core_Impossible,((_tmp82E.f1=((_tmp82D="anal_test, zero-split",
_tag_dyneither(_tmp82D,sizeof(char),22))),_tmp82E)))),_tmp82C)))));}}}_LL264:
...
case Cyc_Absyn_Eq: _LL27A: {struct _tuple15 _tmp82F;return(_tmp82F.f1=_tmp49D,((
_tmp82F.f2=_tmp49C,_tmp82F)));}case Cyc_Absyn_Neq: _LL27B: {struct _tuple15 _tmp830;
return(_tmp830.f1=_tmp49C,((_tmp830.f2=_tmp49D,_tmp830)));}default: _LL27C: {
struct Cyc_Core_Impossible_struct _tmp836;const char*_tmp835;struct Cyc_Core_Impossible_struct*
_tmp834;(int)_throw((void*)((_tmp834=_cycalloc(sizeof(*_tmp834)),((_tmp834[0]=((
_tmp836.tag=Cyc_Core_Impossible,((_tmp836.f1=((_tmp835="anal_test, zero-split",
_tag_dyneither(_tmp835,sizeof(char),22))),_tmp836)))),_tmp834)))));}}}_LL266:
...
_LL268;};_LL267: if(_tmp43A == Cyc_Absyn_Eq){struct _tuple15 _tmp837;return(_tmp837.f1=
f,((_tmp837.f2=Cyc_CfFlowInfo_BottomFL(),_tmp837)));}else{struct _tuple15 _tmp838;
return(_tmp838.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp838.f2=f,_tmp838)));}_LL268:
...
struct _tuple15 _tmp839;return(_tmp839.f1=f,((_tmp839.f2=Cyc_CfFlowInfo_BottomFL(),
_tmp839)));}else{struct _tuple15 _tmp83A;return(_tmp83A.f1=Cyc_CfFlowInfo_BottomFL(),((
_tmp83A.f2=f,_tmp83A)));}_LL274:;_LL275: goto _LL261;_LL261:;}{struct _tuple0
_tmp83B;struct _tuple0 _tmp4A8=(_tmp83B.f1=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
_check_null(_tmp465->topt))->v),((_tmp83B.f2=Cyc_Tcutil_compress((void*)((struct
Cyc_Core_Opt*)_check_null(_tmp466->topt))->v),_tmp83B)));void*_tmp4A9;enum Cyc_Absyn_Sign
...
goto _LL27E;_LL287:;_LL288: {struct _tuple15 _tmp83C;return(_tmp83C.f1=f,((_tmp83C.f2=
f,_tmp83C)));}_LL27E:;}switch(_tmp43A){case Cyc_Absyn_Eq: _LL289: goto _LL28A;case
Cyc_Absyn_Neq: _LL28A: goto _LL28B;case Cyc_Absyn_Gt: _LL28B: goto _LL28C;case Cyc_Absyn_Gte:
_LL28C: {struct _tuple15 _tmp83D;return(_tmp83D.f1=f,((_tmp83D.f2=f,_tmp83D)));}
...
_tmp843;const char*_tmp842;struct Cyc_Core_Impossible_struct*_tmp841;(int)_throw((
void*)((_tmp841=_cycalloc(sizeof(*_tmp841)),((_tmp841[0]=((_tmp843.tag=Cyc_Core_Impossible,((
_tmp843.f1=((_tmp842="anal_test, Lt",_tag_dyneither(_tmp842,sizeof(char),14))),
_tmp843)))),_tmp841)))));}_LL292: if((_tmp4B7.ReachableFL).tag != 2)goto _LL28F;
...
_tmp4F1=(env->fenv)->r;struct Cyc_CfFlowInfo_Reln*_tmp846;struct Cyc_List_List*
_tmp845;struct Cyc_List_List*_tmp4F2=(_tmp845=_region_malloc(_tmp4F1,sizeof(*
_tmp845)),((_tmp845->hd=((_tmp846=_region_malloc(_tmp4F1,sizeof(*_tmp846)),((
_tmp846->vd=_tmp4CE,((_tmp846->rop=Cyc_CfFlowInfo_LessVar(_tmp4DF,_tmp4DF->type),
_tmp846)))))),((_tmp845->tl=_tmp463,_tmp845)))));struct _tuple15 _tmp847;return(
_tmp847.f1=Cyc_CfFlowInfo_ReachableFL(_tmp462,_tmp4F2),((_tmp847.f2=_tmp4B6,
_tmp847)));}_LL2A8: {struct Cyc_Absyn_Const_e_struct*_tmp4E0=(struct Cyc_Absyn_Const_e_struct*)
...
_tmp4F6=(env->fenv)->r;struct Cyc_CfFlowInfo_Reln*_tmp84A;struct Cyc_List_List*
_tmp849;struct Cyc_List_List*_tmp4F7=(_tmp849=_region_malloc(_tmp4F6,sizeof(*
_tmp849)),((_tmp849->hd=((_tmp84A=_region_malloc(_tmp4F6,sizeof(*_tmp84A)),((
_tmp84A->vd=_tmp4CE,((_tmp84A->rop=Cyc_CfFlowInfo_LessConst((unsigned int)
_tmp4EB),_tmp84A)))))),((_tmp849->tl=_tmp463,_tmp849)))));struct _tuple15 _tmp84B;
return(_tmp84B.f1=Cyc_CfFlowInfo_ReachableFL(_tmp462,_tmp4F7),((_tmp84B.f2=
_tmp4B6,_tmp84B)));}_LL2AC: {struct Cyc_Absyn_Primop_e_struct*_tmp4EC=(struct Cyc_Absyn_Primop_e_struct*)
...
_tmp50C=(env->fenv)->r;struct Cyc_CfFlowInfo_Reln*_tmp84E;struct Cyc_List_List*
_tmp84D;struct Cyc_List_List*_tmp50D=(_tmp84D=_region_malloc(_tmp50C,sizeof(*
_tmp84D)),((_tmp84D->hd=((_tmp84E=_region_malloc(_tmp50C,sizeof(*_tmp84E)),((
_tmp84E->vd=_tmp4CE,((_tmp84E->rop=Cyc_CfFlowInfo_LessNumelts(_tmp50B),_tmp84E)))))),((
_tmp84D->tl=_tmp463,_tmp84D)))));struct _tuple15 _tmp84F;return(_tmp84F.f1=Cyc_CfFlowInfo_ReachableFL(
_tmp462,_tmp50D),((_tmp84F.f2=_tmp4B6,_tmp84F)));}_LL2B9:;_LL2BA: {struct
_tuple15 _tmp850;return(_tmp850.f1=_tmp4B5,((_tmp850.f2=_tmp4B6,_tmp850)));}
_LL2B0:;}_LL2AE:;_LL2AF: {struct _tuple15 _tmp851;return(_tmp851.f1=_tmp4B5,((
_tmp851.f2=_tmp4B6,_tmp851)));}_LL29F:;}_LL29D:;_LL29E: {struct _tuple15 _tmp852;
return(_tmp852.f1=_tmp4B5,((_tmp852.f2=_tmp4B6,_tmp852)));}_LL294:;};}case Cyc_Absyn_Lte:
...
_tmp858;const char*_tmp857;struct Cyc_Core_Impossible_struct*_tmp856;(int)_throw((
void*)((_tmp856=_cycalloc(sizeof(*_tmp856)),((_tmp856[0]=((_tmp858.tag=Cyc_Core_Impossible,((
_tmp858.f1=((_tmp857="anal_test, Lte",_tag_dyneither(_tmp857,sizeof(char),15))),
_tmp858)))),_tmp856)))));}_LL2BF: if((_tmp516.ReachableFL).tag != 2)goto _LL2BC;
...
_tmp540=(env->fenv)->r;struct Cyc_CfFlowInfo_Reln*_tmp85B;struct Cyc_List_List*
_tmp85A;struct Cyc_List_List*_tmp541=(_tmp85A=_region_malloc(_tmp540,sizeof(*
_tmp85A)),((_tmp85A->hd=((_tmp85B=_region_malloc(_tmp540,sizeof(*_tmp85B)),((
_tmp85B->vd=_tmp52D,((_tmp85B->rop=Cyc_CfFlowInfo_LessEqConst((unsigned int)
_tmp53A),_tmp85B)))))),((_tmp85A->tl=_tmp463,_tmp85A)))));struct _tuple15 _tmp85C;
return(_tmp85C.f1=Cyc_CfFlowInfo_ReachableFL(_tmp462,_tmp541),((_tmp85C.f2=
_tmp515,_tmp85C)));}_LL2D1: {struct Cyc_Absyn_Primop_e_struct*_tmp53B=(struct Cyc_Absyn_Primop_e_struct*)
...
_tmp556=env->fenv;struct Cyc_CfFlowInfo_Reln*_tmp85F;struct Cyc_List_List*_tmp85E;
struct Cyc_List_List*_tmp557=(_tmp85E=_region_malloc(_tmp556->r,sizeof(*_tmp85E)),((
_tmp85E->hd=((_tmp85F=_region_malloc(_tmp556->r,sizeof(*_tmp85F)),((_tmp85F->vd=
_tmp52D,((_tmp85F->rop=Cyc_CfFlowInfo_LessEqNumelts(_tmp555),_tmp85F)))))),((
_tmp85E->tl=_tmp463,_tmp85E)))));struct _tuple15 _tmp860;return(_tmp860.f1=Cyc_CfFlowInfo_ReachableFL(
_tmp462,_tmp557),((_tmp860.f2=_tmp515,_tmp860)));}_LL2DE:;_LL2DF: {struct
_tuple15 _tmp861;return(_tmp861.f1=_tmp514,((_tmp861.f2=_tmp515,_tmp861)));}
_LL2D5:;}_LL2D3:;_LL2D4: {struct _tuple15 _tmp862;return(_tmp862.f1=_tmp514,((
_tmp862.f2=_tmp515,_tmp862)));}_LL2CC:;}_LL2CA:;_LL2CB: {struct _tuple15 _tmp863;
return(_tmp863.f1=_tmp514,((_tmp863.f2=_tmp515,_tmp863)));}_LL2C1:;};}default:
_LL2BB: {struct _tuple15 _tmp864;return(_tmp864.f1=f,((_tmp864.f2=f,_tmp864)));}}}
...
_LL2E3: {struct _tuple15 _tmp865;return(_tmp865.f1=_tmp560,((_tmp865.f2=_tmp560,
_tmp865)));}_LL2E4: if((_tmp562.ReachableFL).tag != 2)goto _LL2E1;_tmp564=(struct
...
_LL2E9;}_LL2E8: {struct _tuple15 _tmp866;return(_tmp866.f1=Cyc_CfFlowInfo_BottomFL(),((
_tmp866.f2=_tmp560,_tmp866)));}_LL2E9: {struct Cyc_CfFlowInfo_NotZeroThis_struct*
...
_LL2EF;}_LL2EE: {struct _tuple15 _tmp867;return(_tmp867.f1=_tmp560,((_tmp867.f2=
Cyc_CfFlowInfo_BottomFL(),_tmp867)));}_LL2EF: {struct Cyc_CfFlowInfo_UnknownR_struct*
...
_LL2F5;}_LL2F4:{const char*_tmp86A;void*_tmp869;(_tmp869=0,Cyc_Tcutil_terr(e->loc,((
_tmp86A="expression may not be initialized",_tag_dyneither(_tmp86A,sizeof(char),
34))),_tag_dyneither(_tmp869,sizeof(void*),0)));}{struct _tuple15 _tmp86B;return(
_tmp86B.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp86B.f2=Cyc_CfFlowInfo_BottomFL(),
_tmp86B)));};_LL2F5: {struct Cyc_CfFlowInfo_UnknownR_struct*_tmp571=(struct Cyc_CfFlowInfo_UnknownR_struct*)
...
_LL2F8: {struct _tuple15 _tmp86C;return(_tmp86C.f1=_tmp560,((_tmp86C.f2=_tmp560,
_tmp86C)));}_LL2F9: {struct Cyc_CfFlowInfo_Aggregate_struct*_tmp574=(struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmp567;if(_tmp574->tag != 6)goto _LL2E6;}_LL2FA: {struct Cyc_Core_Impossible_struct
_tmp872;const char*_tmp871;struct Cyc_Core_Impossible_struct*_tmp870;(int)_throw((
void*)((_tmp870=_cycalloc(sizeof(*_tmp870)),((_tmp870[0]=((_tmp872.tag=Cyc_Core_Impossible,((
_tmp872.f1=((_tmp871="anal_test",_tag_dyneither(_tmp871,sizeof(char),10))),
_tmp872)))),_tmp870)))));}_LL2E6:;}_LL2E1:;};};}static void Cyc_NewControlFlow_check_init_params(
...
_tmp582->hd))!= Cyc_CfFlowInfo_AllIL){const char*_tmp875;void*_tmp874;(_tmp874=0,
Cyc_Tcutil_terr(loc,((_tmp875="function may not initialize all the parameters with attribute 'initializes'",
_tag_dyneither(_tmp875,sizeof(char),76))),_tag_dyneither(_tmp874,sizeof(void*),0)));}}}
...
_tmp878;void*_tmp877;(_tmp877=0,Cyc_Tcutil_terr(_tmp58A->loc,((_tmp878="switch clause may implicitly fallthru",
_tag_dyneither(_tmp878,sizeof(char),38))),_tag_dyneither(_tmp877,sizeof(void*),0)));}
else{const char*_tmp87B;void*_tmp87A;(_tmp87A=0,Cyc_Tcutil_warn(_tmp58A->loc,((
_tmp87B="switch clause may implicitly fallthru",_tag_dyneither(_tmp87B,sizeof(
char),38))),_tag_dyneither(_tmp87A,sizeof(void*),0)));}Cyc_NewControlFlow_update_flow(
...
const char*_tmp87E;void*_tmp87D;(_tmp87D=0,Cyc_Tcutil_terr(s->loc,((_tmp87E="`noreturn' function might return",
_tag_dyneither(_tmp87E,sizeof(char),33))),_tag_dyneither(_tmp87D,sizeof(void*),0)));}
...
const char*_tmp881;void*_tmp880;(_tmp880=0,Cyc_Tcutil_terr(s->loc,((_tmp881="`noreturn' function might return",
_tag_dyneither(_tmp881,sizeof(char),33))),_tag_dyneither(_tmp880,sizeof(void*),0)));}{
...
_tmp607))->encloser;if(_tmp609 == _tmp607){{const char*_tmp884;void*_tmp883;(
_tmp883=0,Cyc_Tcutil_terr(s->loc,((_tmp884="goto enters local scope or exception handler",
_tag_dyneither(_tmp884,sizeof(char),45))),_tag_dyneither(_tmp883,sizeof(void*),0)));}
...
_LL332: goto _LL330;_LL333:;_LL334: {const char*_tmp887;void*_tmp886;(_tmp886=0,Cyc_Tcutil_terr(
s->loc,((_tmp887="last catch clause may implicitly fallthru",_tag_dyneither(
_tmp887,sizeof(char),42))),_tag_dyneither(_tmp886,sizeof(void*),0)));}_LL330:;}
...
_tmp5CD->f2;}}_LL327: {union Cyc_CfFlowInfo_FlowInfo _tmp614;void*_tmp615;struct
_tuple13 _tmp613=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp5D2);_tmp614=
_tmp613.f1;_tmp615=_tmp613.f2;_tmp614=Cyc_NewControlFlow_use_Rval(env,_tmp5D2->loc,
_tmp614,_tmp615);{struct Cyc_List_List _tmp888;struct Cyc_List_List _tmp616=(_tmp888.hd=
_tmp5D4,((_tmp888.tl=0,_tmp888)));_tmp614=Cyc_NewControlFlow_add_vars(_tmp598,
_tmp614,(struct Cyc_List_List*)& _tmp616,_tmp598->unknown_all,s->loc);outflow=Cyc_NewControlFlow_anal_stmt(
env,_tmp614,_tmp5D5);goto _LL305;};}_LL328: {struct Cyc_Absyn_Decl_s_struct*
...
_LL32E;else{_tmp5DC=_tmp5DB->f1;}}_LL32D: {union Cyc_CfFlowInfo_FlowInfo _tmp619;
void*_tmp61A;struct _tuple13 _tmp618=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,
_tmp5DC);_tmp619=_tmp618.f1;_tmp61A=_tmp618.f2;{union Cyc_CfFlowInfo_FlowInfo
_tmp61B=Cyc_NewControlFlow_use_Rval(env,_tmp5DC->loc,_tmp619,_tmp61A);{void*
_tmp61C=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)_check_null(_tmp5DC->topt))->v);
void*_tmp61E;_LL336: {struct Cyc_Absyn_RgnHandleType_struct*_tmp61D=(struct Cyc_Absyn_RgnHandleType_struct*)
_tmp61C;if(_tmp61D->tag != 16)goto _LL338;else{_tmp61E=(void*)_tmp61D->f1;}}_LL337:
outflow=Cyc_CfFlowInfo_kill_flow_region(_tmp598,_tmp619,_tmp61E);goto _LL335;
_LL338:;_LL339: {struct Cyc_Core_Impossible_struct _tmp88E;const char*_tmp88D;
struct Cyc_Core_Impossible_struct*_tmp88C;(int)_throw((void*)((_tmp88C=_cycalloc(
sizeof(*_tmp88C)),((_tmp88C[0]=((_tmp88E.tag=Cyc_Core_Impossible,((_tmp88E.f1=((
_tmp88D="anal_stmt -- reset_region",_tag_dyneither(_tmp88D,sizeof(char),26))),
_tmp88E)))),_tmp88C)))));}_LL335:;}goto _LL305;};}_LL32E:;_LL32F: {struct Cyc_Core_Impossible_struct
_tmp894;const char*_tmp893;struct Cyc_Core_Impossible_struct*_tmp892;(int)_throw((
void*)((_tmp892=_cycalloc(sizeof(*_tmp892)),((_tmp892[0]=((_tmp894.tag=Cyc_Core_Impossible,((
_tmp894.f1=((_tmp893="anal_stmt -- bad stmt syntax or unimplemented stmt form",
_tag_dyneither(_tmp893,sizeof(char),56))),_tmp894)))),_tmp892)))));}_LL305:;}
...
struct Cyc_NewControlFlow_AnalEnv*env,union Cyc_CfFlowInfo_FlowInfo inflow,struct
Cyc_Absyn_Decl*decl){struct Cyc_CfFlowInfo_FlowEnv*_tmp625=env->fenv;void*_tmp626=
decl->r;struct Cyc_Absyn_Vardecl*_tmp628;struct Cyc_Core_Opt*_tmp62A;struct Cyc_Core_Opt
_tmp62B;struct Cyc_List_List*_tmp62C;struct Cyc_Absyn_Exp*_tmp62D;struct Cyc_List_List*
_tmp62F;struct Cyc_Absyn_Fndecl*_tmp631;struct Cyc_Absyn_Tvar*_tmp633;struct Cyc_Absyn_Vardecl*
_tmp634;int _tmp635;struct Cyc_Absyn_Exp*_tmp636;_LL33B: {struct Cyc_Absyn_Var_d_struct*
_tmp627=(struct Cyc_Absyn_Var_d_struct*)_tmp626;if(_tmp627->tag != 0)goto _LL33D;
else{_tmp628=_tmp627->f1;}}_LL33C: {struct Cyc_List_List _tmp895;struct Cyc_List_List
_tmp637=(_tmp895.hd=_tmp628,((_tmp895.tl=0,_tmp895)));inflow=Cyc_NewControlFlow_add_vars(
_tmp625,inflow,(struct Cyc_List_List*)& _tmp637,_tmp625->unknown_none,decl->loc);{
struct Cyc_Absyn_Exp*_tmp638=_tmp628->initializer;if(_tmp638 == 0)return inflow;{
union Cyc_CfFlowInfo_FlowInfo _tmp63A;void*_tmp63B;struct _tuple13 _tmp639=Cyc_NewControlFlow_anal_Rexp(
env,1,inflow,(struct Cyc_Absyn_Exp*)_tmp638);_tmp63A=_tmp639.f1;_tmp63B=_tmp639.f2;{
union Cyc_CfFlowInfo_FlowInfo _tmp63C=_tmp63A;int _tmp63D;struct _tuple12 _tmp63E;
struct Cyc_Dict_Dict _tmp63F;struct Cyc_List_List*_tmp640;_LL348: if((_tmp63C.BottomFL).tag
!= 1)goto _LL34A;_tmp63D=(int)(_tmp63C.BottomFL).val;_LL349: return Cyc_CfFlowInfo_BottomFL();
_LL34A: if((_tmp63C.ReachableFL).tag != 2)goto _LL347;_tmp63E=(struct _tuple12)(
_tmp63C.ReachableFL).val;_tmp63F=_tmp63E.f1;_tmp640=_tmp63E.f2;_LL34B:{struct Cyc_CfFlowInfo_VarRoot_struct*
_tmp89B;struct Cyc_CfFlowInfo_VarRoot_struct _tmp89A;struct Cyc_CfFlowInfo_Place*
_tmp899;_tmp63F=Cyc_CfFlowInfo_assign_place(_tmp625,decl->loc,_tmp63F,env->all_changed,((
_tmp899=_region_malloc(env->r,sizeof(*_tmp899)),((_tmp899->root=(void*)((_tmp89B=
_region_malloc(env->r,sizeof(*_tmp89B)),((_tmp89B[0]=((_tmp89A.tag=0,((_tmp89A.f1=
_tmp628,_tmp89A)))),_tmp89B)))),((_tmp899->fields=0,_tmp899)))))),_tmp63B);}
_tmp640=Cyc_CfFlowInfo_reln_assign_var(env->r,_tmp640,_tmp628,(struct Cyc_Absyn_Exp*)
_check_null(_tmp628->initializer));{union Cyc_CfFlowInfo_FlowInfo _tmp644=Cyc_CfFlowInfo_ReachableFL(
_tmp63F,_tmp640);Cyc_NewControlFlow_update_tryflow(env,_tmp644);return _tmp644;};
_LL347:;};};};}_LL33D: {struct Cyc_Absyn_Let_d_struct*_tmp629=(struct Cyc_Absyn_Let_d_struct*)
_tmp626;if(_tmp629->tag != 2)goto _LL33F;else{_tmp62A=_tmp629->f2;if(_tmp62A == 0)
goto _LL33F;_tmp62B=*_tmp62A;_tmp62C=(struct Cyc_List_List*)_tmp62B.v;_tmp62D=
_tmp629->f3;}}_LL33E: {union Cyc_CfFlowInfo_FlowInfo _tmp647;void*_tmp648;struct
_tuple13 _tmp646=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,_tmp62D);_tmp647=
_tmp646.f1;_tmp648=_tmp646.f2;_tmp647=Cyc_NewControlFlow_use_Rval(env,_tmp62D->loc,
_tmp647,_tmp648);return Cyc_NewControlFlow_add_vars(_tmp625,_tmp647,_tmp62C,
_tmp625->unknown_all,decl->loc);}_LL33F: {struct Cyc_Absyn_Letv_d_struct*_tmp62E=(
struct Cyc_Absyn_Letv_d_struct*)_tmp626;if(_tmp62E->tag != 3)goto _LL341;else{
_tmp62F=_tmp62E->f1;}}_LL340: return Cyc_NewControlFlow_add_vars(_tmp625,inflow,
_tmp62F,_tmp625->unknown_none,decl->loc);_LL341: {struct Cyc_Absyn_Fn_d_struct*
_tmp630=(struct Cyc_Absyn_Fn_d_struct*)_tmp626;if(_tmp630->tag != 1)goto _LL343;
else{_tmp631=_tmp630->f1;}}_LL342: Cyc_NewControlFlow_check_nested_fun(_tmp625,
inflow,_tmp631);{void*_tmp649=(void*)((struct Cyc_Core_Opt*)_check_null(_tmp631->cached_typ))->v;
struct Cyc_Absyn_Vardecl*_tmp64A=(struct Cyc_Absyn_Vardecl*)_check_null(_tmp631->fn_vardecl);
struct Cyc_List_List*_tmp89C;return Cyc_NewControlFlow_add_vars(_tmp625,inflow,((
_tmp89C=_region_malloc(env->r,sizeof(*_tmp89C)),((_tmp89C->hd=_tmp64A,((_tmp89C->tl=
0,_tmp89C)))))),_tmp625->unknown_all,decl->loc);};_LL343: {struct Cyc_Absyn_Region_d_struct*
_tmp632=(struct Cyc_Absyn_Region_d_struct*)_tmp626;if(_tmp632->tag != 4)goto _LL345;
else{_tmp633=_tmp632->f1;_tmp634=_tmp632->f2;_tmp635=_tmp632->f3;_tmp636=_tmp632->f4;}}
_LL344: if(_tmp636 != 0){struct Cyc_Absyn_Exp*_tmp64C=(struct Cyc_Absyn_Exp*)_tmp636;
union Cyc_CfFlowInfo_FlowInfo _tmp64E;void*_tmp64F;struct _tuple13 _tmp64D=Cyc_NewControlFlow_anal_Rexp(
env,1,inflow,_tmp64C);_tmp64E=_tmp64D.f1;_tmp64F=_tmp64D.f2;inflow=Cyc_NewControlFlow_use_Rval(
env,_tmp64C->loc,_tmp64E,_tmp64F);}{struct Cyc_List_List _tmp89D;struct Cyc_List_List
_tmp650=(_tmp89D.hd=_tmp634,((_tmp89D.tl=0,_tmp89D)));return Cyc_NewControlFlow_add_vars(
_tmp625,inflow,(struct Cyc_List_List*)& _tmp650,_tmp625->unknown_all,decl->loc);};
_LL345:;_LL346: {struct Cyc_Core_Impossible_struct _tmp8A3;const char*_tmp8A2;
struct Cyc_Core_Impossible_struct*_tmp8A1;(int)_throw((void*)((_tmp8A1=_cycalloc(
sizeof(*_tmp8A1)),((_tmp8A1[0]=((_tmp8A3.tag=Cyc_Core_Impossible,((_tmp8A3.f1=((
_tmp8A2="anal_decl: unexpected decl variant",_tag_dyneither(_tmp8A2,sizeof(char),
35))),_tmp8A3)))),_tmp8A1)))));}_LL33A:;}static void Cyc_NewControlFlow_check_fun(
struct Cyc_Absyn_Fndecl*fd);static void Cyc_NewControlFlow_check_fun(struct Cyc_Absyn_Fndecl*
fd){struct _RegionHandle _tmp655=_new_region("frgn");struct _RegionHandle*frgn=&
_tmp655;_push_region(frgn);{struct Cyc_CfFlowInfo_FlowEnv*fenv=Cyc_CfFlowInfo_new_flow_env(
...
_RegionHandle*_tmp656=fenv->r;struct Cyc_Position_Segment*_tmp657=(fd->body)->loc;
inflow=Cyc_NewControlFlow_add_vars(fenv,inflow,(struct Cyc_List_List*)((struct Cyc_Core_Opt*)
_check_null(fd->param_vardecls))->v,fenv->unknown_all,_tmp657);{struct Cyc_List_List*
param_roots=0;{union Cyc_CfFlowInfo_FlowInfo _tmp658=inflow;int _tmp659;struct
_tuple12 _tmp65A;struct Cyc_Dict_Dict _tmp65B;struct Cyc_List_List*_tmp65C;_LL34D:
if((_tmp658.BottomFL).tag != 1)goto _LL34F;_tmp659=(int)(_tmp658.BottomFL).val;
_LL34E: {const char*_tmp8A6;void*_tmp8A5;(_tmp8A5=0,((int(*)(struct _dyneither_ptr
fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp8A6="check_fun",
_tag_dyneither(_tmp8A6,sizeof(char),10))),_tag_dyneither(_tmp8A5,sizeof(void*),0)));}
_LL34F: if((_tmp658.ReachableFL).tag != 2)goto _LL34C;_tmp65A=(struct _tuple12)(
_tmp658.ReachableFL).val;_tmp65B=_tmp65A.f1;_tmp65C=_tmp65A.f2;_LL350: {struct
Cyc_List_List*atts;{void*_tmp65F=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
_check_null(fd->cached_typ))->v);struct Cyc_Absyn_FnInfo _tmp661;struct Cyc_List_List*
_tmp662;_LL352: {struct Cyc_Absyn_FnType_struct*_tmp660=(struct Cyc_Absyn_FnType_struct*)
_tmp65F;if(_tmp660->tag != 10)goto _LL354;else{_tmp661=_tmp660->f1;_tmp662=_tmp661.attributes;}}
_LL353: atts=_tmp662;goto _LL351;_LL354:;_LL355: {const char*_tmp8A9;void*_tmp8A8;(
_tmp8A8=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp8A9="check_fun: non-function type cached with fndecl_t",_tag_dyneither(
_tmp8A9,sizeof(char),50))),_tag_dyneither(_tmp8A8,sizeof(void*),0)));}_LL351:;}
for(0;atts != 0;atts=atts->tl){void*_tmp665=(void*)atts->hd;int _tmp667;int _tmp669;
_LL357: {struct Cyc_Absyn_Noliveunique_att_struct*_tmp666=(struct Cyc_Absyn_Noliveunique_att_struct*)
_tmp665;if(_tmp666->tag != 21)goto _LL359;else{_tmp667=_tmp666->f1;}}_LL358: {
unsigned int j=(unsigned int)_tmp667;struct Cyc_Absyn_Exp*bogus_exp=Cyc_Absyn_signed_int_exp(
- 1,0);if(j > ((int(*)(struct Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((
struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v)){{const char*_tmp8AC;
void*_tmp8AB;(_tmp8AB=0,Cyc_Tcutil_terr(_tmp657,((_tmp8AC="noliveunique attribute exceeds number of parameters",
_tag_dyneither(_tmp8AC,sizeof(char),52))),_tag_dyneither(_tmp8AB,sizeof(void*),0)));}
continue;}{struct Cyc_Absyn_Vardecl*_tmp66C=((struct Cyc_Absyn_Vardecl*(*)(struct
...
_tmp66C->type);if(!Cyc_Tcutil_is_noalias_pointer(t)){{const char*_tmp8AF;void*
_tmp8AE;(_tmp8AE=0,Cyc_Tcutil_terr(_tmp657,((_tmp8AF="noliveunique attribute requires unique pointer type",
_tag_dyneither(_tmp8AF,sizeof(char),52))),_tag_dyneither(_tmp8AE,sizeof(void*),0)));}
continue;}{void*elttype=Cyc_Tcutil_pointer_elt_type(t);void*_tmp66F=Cyc_CfFlowInfo_make_unique_consumed(
fenv,elttype,bogus_exp,- 1,Cyc_CfFlowInfo_typ_to_absrval(fenv,elttype,fenv->unknown_all));
struct Cyc_CfFlowInfo_InitParam_struct _tmp8B2;struct Cyc_CfFlowInfo_InitParam_struct*
_tmp8B1;struct Cyc_CfFlowInfo_InitParam_struct*_tmp670=(_tmp8B1=_region_malloc(
_tmp656,sizeof(*_tmp8B1)),((_tmp8B1[0]=((_tmp8B2.tag=2,((_tmp8B2.f1=(int)j,((
_tmp8B2.f2=(void*)t,_tmp8B2)))))),_tmp8B1)));struct Cyc_CfFlowInfo_Place*_tmp8B3;
struct Cyc_CfFlowInfo_Place*_tmp671=(_tmp8B3=_region_malloc(_tmp656,sizeof(*
_tmp8B3)),((_tmp8B3->root=(void*)_tmp670,((_tmp8B3->fields=0,_tmp8B3)))));
_tmp65B=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(
_tmp65B,(void*)_tmp670,_tmp66F);{struct Cyc_CfFlowInfo_AddressOf_struct _tmp8B9;
struct Cyc_CfFlowInfo_AddressOf_struct*_tmp8B8;struct Cyc_CfFlowInfo_VarRoot_struct
_tmp8B6;struct Cyc_CfFlowInfo_VarRoot_struct*_tmp8B5;_tmp65B=((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp65B,(void*)((_tmp8B5=
_region_malloc(_tmp656,sizeof(*_tmp8B5)),((_tmp8B5[0]=((_tmp8B6.tag=0,((_tmp8B6.f1=
_tmp66C,_tmp8B6)))),_tmp8B5)))),(void*)((_tmp8B8=_region_malloc(_tmp656,sizeof(*
_tmp8B8)),((_tmp8B8[0]=((_tmp8B9.tag=5,((_tmp8B9.f1=_tmp671,_tmp8B9)))),_tmp8B8)))));}
goto _LL356;};};}_LL359: {struct Cyc_Absyn_Initializes_att_struct*_tmp668=(struct
Cyc_Absyn_Initializes_att_struct*)_tmp665;if(_tmp668->tag != 20)goto _LL35B;else{
_tmp669=_tmp668->f1;}}_LL35A: {unsigned int j=(unsigned int)_tmp669;if(j > ((int(*)(
struct Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)
_check_null(fd->param_vardecls))->v)){{const char*_tmp8BC;void*_tmp8BB;(_tmp8BB=0,
Cyc_Tcutil_terr(_tmp657,((_tmp8BC="initializes attribute exceeds number of parameters",
_tag_dyneither(_tmp8BC,sizeof(char),51))),_tag_dyneither(_tmp8BB,sizeof(void*),0)));}
continue;}{struct Cyc_Absyn_Vardecl*_tmp67B=((struct Cyc_Absyn_Vardecl*(*)(struct
Cyc_List_List*x,int n))Cyc_List_nth)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)
_check_null(fd->param_vardecls))->v,(int)(j - 1));{void*_tmp67C=Cyc_Tcutil_compress(
_tmp67B->type);struct Cyc_Absyn_PtrInfo _tmp67E;void*_tmp67F;struct Cyc_Absyn_PtrAtts
_tmp680;union Cyc_Absyn_Constraint*_tmp681;union Cyc_Absyn_Constraint*_tmp682;
union Cyc_Absyn_Constraint*_tmp683;_LL35E: {struct Cyc_Absyn_PointerType_struct*
_tmp67D=(struct Cyc_Absyn_PointerType_struct*)_tmp67C;if(_tmp67D->tag != 5)goto
_LL360;else{_tmp67E=_tmp67D->f1;_tmp67F=_tmp67E.elt_typ;_tmp680=_tmp67E.ptr_atts;
_tmp681=_tmp680.nullable;_tmp682=_tmp680.bounds;_tmp683=_tmp680.zero_term;}}
_LL35F: if(((int(*)(union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_val)(_tmp681)){
const char*_tmp8BF;void*_tmp8BE;(_tmp8BE=0,Cyc_Tcutil_terr(_tmp657,((_tmp8BF="initializes attribute not allowed on nullable pointers",
_tag_dyneither(_tmp8BF,sizeof(char),55))),_tag_dyneither(_tmp8BE,sizeof(void*),0)));}
if(!Cyc_Tcutil_is_bound_one(_tmp682)){const char*_tmp8C2;void*_tmp8C1;(_tmp8C1=0,
Cyc_Tcutil_terr(_tmp657,((_tmp8C2="initializes attribute allowed only on pointers of size 1",
_tag_dyneither(_tmp8C2,sizeof(char),57))),_tag_dyneither(_tmp8C1,sizeof(void*),0)));}
if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp683)){
const char*_tmp8C5;void*_tmp8C4;(_tmp8C4=0,Cyc_Tcutil_terr(_tmp657,((_tmp8C5="initializes attribute allowed only on pointers to non-zero-terminated arrays",
_tag_dyneither(_tmp8C5,sizeof(char),77))),_tag_dyneither(_tmp8C4,sizeof(void*),0)));}{
struct Cyc_CfFlowInfo_InitParam_struct _tmp8C8;struct Cyc_CfFlowInfo_InitParam_struct*
_tmp8C7;struct Cyc_CfFlowInfo_InitParam_struct*_tmp68A=(_tmp8C7=_region_malloc(
_tmp656,sizeof(*_tmp8C7)),((_tmp8C7[0]=((_tmp8C8.tag=2,((_tmp8C8.f1=(int)j,((
_tmp8C8.f2=(void*)_tmp67F,_tmp8C8)))))),_tmp8C7)));struct Cyc_CfFlowInfo_Place*
_tmp8C9;struct Cyc_CfFlowInfo_Place*_tmp68B=(_tmp8C9=_region_malloc(_tmp656,
sizeof(*_tmp8C9)),((_tmp8C9->root=(void*)_tmp68A,((_tmp8C9->fields=0,_tmp8C9)))));
_tmp65B=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(
_tmp65B,(void*)_tmp68A,Cyc_CfFlowInfo_typ_to_absrval(fenv,_tmp67F,fenv->esc_none));{
struct Cyc_CfFlowInfo_AddressOf_struct _tmp8CF;struct Cyc_CfFlowInfo_AddressOf_struct*
_tmp8CE;struct Cyc_CfFlowInfo_VarRoot_struct _tmp8CC;struct Cyc_CfFlowInfo_VarRoot_struct*
_tmp8CB;_tmp65B=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(
_tmp65B,(void*)((_tmp8CB=_region_malloc(_tmp656,sizeof(*_tmp8CB)),((_tmp8CB[0]=((
_tmp8CC.tag=0,((_tmp8CC.f1=_tmp67B,_tmp8CC)))),_tmp8CB)))),(void*)((_tmp8CE=
_region_malloc(_tmp656,sizeof(*_tmp8CE)),((_tmp8CE[0]=((_tmp8CF.tag=5,((_tmp8CF.f1=
_tmp68B,_tmp8CF)))),_tmp8CE)))));}{struct Cyc_List_List*_tmp8D0;param_roots=((
_tmp8D0=_region_malloc(_tmp656,sizeof(*_tmp8D0)),((_tmp8D0->hd=_tmp68B,((_tmp8D0->tl=
param_roots,_tmp8D0))))));}goto _LL35D;};_LL360:;_LL361: {const char*_tmp8D3;void*
_tmp8D2;(_tmp8D2=0,Cyc_Tcutil_terr(_tmp657,((_tmp8D3="initializes attribute on non-pointer",
_tag_dyneither(_tmp8D3,sizeof(char),37))),_tag_dyneither(_tmp8D2,sizeof(void*),0)));}
_LL35D:;}goto _LL356;};}_LL35B:;_LL35C: goto _LL356;_LL356:;}inflow=Cyc_CfFlowInfo_ReachableFL(
_tmp65B,_tmp65C);}_LL34C:;}{int noreturn=Cyc_Tcutil_is_noreturn(Cyc_Tcutil_fndecl2typ(
...
hash)(struct Cyc_Absyn_Stmt*)))Cyc_Hashtable_rcreate)(_tmp656,33,(int(*)(struct
Cyc_Absyn_Stmt*,struct Cyc_Absyn_Stmt*))Cyc_Core_ptrcmp,(int(*)(struct Cyc_Absyn_Stmt*
s))Cyc_NewControlFlow_hash_ptr);struct Cyc_NewControlFlow_AnalEnv*_tmp8D4;struct
Cyc_NewControlFlow_AnalEnv*env=(_tmp8D4=_region_malloc(_tmp656,sizeof(*_tmp8D4)),((
_tmp8D4->r=_tmp656,((_tmp8D4->fenv=fenv,((_tmp8D4->iterate_again=1,((_tmp8D4->iteration_num=
0,((_tmp8D4->in_try=0,((_tmp8D4->tryflow=inflow,((_tmp8D4->all_changed=0,((
_tmp8D4->noreturn=noreturn,((_tmp8D4->param_roots=param_roots,((_tmp8D4->flow_table=
flow_table,_tmp8D4)))))))))))))))))))));union Cyc_CfFlowInfo_FlowInfo outflow=
...
union Cyc_CfFlowInfo_FlowInfo _tmp696=outflow;int _tmp697;_LL363: if((_tmp696.BottomFL).tag
!= 1)goto _LL365;_tmp697=(int)(_tmp696.BottomFL).val;_LL364: goto _LL362;_LL365:;
_LL366: Cyc_NewControlFlow_check_init_params(_tmp657,env,outflow);if(noreturn){
const char*_tmp8D7;void*_tmp8D6;(_tmp8D6=0,Cyc_Tcutil_terr(_tmp657,((_tmp8D7="`noreturn' function might (implicitly) return",
_tag_dyneither(_tmp8D7,sizeof(char),46))),_tag_dyneither(_tmp8D6,sizeof(void*),0)));}
else{void*_tmp69A=Cyc_Tcutil_compress(fd->ret_type);_LL368: {struct Cyc_Absyn_VoidType_struct*
_tmp69B=(struct Cyc_Absyn_VoidType_struct*)_tmp69A;if(_tmp69B->tag != 0)goto _LL36A;}
_LL369: goto _LL367;_LL36A: {struct Cyc_Absyn_DoubleType_struct*_tmp69C=(struct Cyc_Absyn_DoubleType_struct*)
_tmp69A;if(_tmp69C->tag != 8)goto _LL36C;}_LL36B: goto _LL36D;_LL36C: {struct Cyc_Absyn_FloatType_struct*
_tmp69D=(struct Cyc_Absyn_FloatType_struct*)_tmp69A;if(_tmp69D->tag != 7)goto
_LL36E;}_LL36D: goto _LL36F;_LL36E: {struct Cyc_Absyn_IntType_struct*_tmp69E=(
struct Cyc_Absyn_IntType_struct*)_tmp69A;if(_tmp69E->tag != 6)goto _LL370;}_LL36F:{
const char*_tmp8DA;void*_tmp8D9;(_tmp8D9=0,Cyc_Tcutil_warn(_tmp657,((_tmp8DA="function may not return a value",
_tag_dyneither(_tmp8DA,sizeof(char),32))),_tag_dyneither(_tmp8D9,sizeof(void*),0)));}
goto _LL367;_LL370:;_LL371:{const char*_tmp8DD;void*_tmp8DC;(_tmp8DC=0,Cyc_Tcutil_terr(
_tmp657,((_tmp8DD="function may not return a value",_tag_dyneither(_tmp8DD,
sizeof(char),32))),_tag_dyneither(_tmp8DC,sizeof(void*),0)));}goto _LL367;_LL367:;}
goto _LL362;_LL362:;};};};}void Cyc_NewControlFlow_cf_check(struct Cyc_List_List*ds);
void Cyc_NewControlFlow_cf_check(struct Cyc_List_List*ds){for(0;ds != 0;ds=ds->tl){
void*_tmp6A4=((struct Cyc_Absyn_Decl*)ds->hd)->r;struct Cyc_Absyn_Fndecl*_tmp6A6;
struct Cyc_List_List*_tmp6A8;struct Cyc_List_List*_tmp6AA;struct Cyc_List_List*
_tmp6AC;_LL373: {struct Cyc_Absyn_Fn_d_struct*_tmp6A5=(struct Cyc_Absyn_Fn_d_struct*)
_tmp6A4;if(_tmp6A5->tag != 1)goto _LL375;else{_tmp6A6=_tmp6A5->f1;}}_LL374: Cyc_NewControlFlow_check_fun(
_tmp6A6);goto _LL372;_LL375: {struct Cyc_Absyn_ExternC_d_struct*_tmp6A7=(struct Cyc_Absyn_ExternC_d_struct*)
_tmp6A4;if(_tmp6A7->tag != 12)goto _LL377;else{_tmp6A8=_tmp6A7->f1;}}_LL376:
_tmp6AA=_tmp6A8;goto _LL378;_LL377: {struct Cyc_Absyn_Using_d_struct*_tmp6A9=(
struct Cyc_Absyn_Using_d_struct*)_tmp6A4;if(_tmp6A9->tag != 11)goto _LL379;else{
_tmp6AA=_tmp6A9->f2;}}_LL378: _tmp6AC=_tmp6AA;goto _LL37A;_LL379: {struct Cyc_Absyn_Namespace_d_struct*
_tmp6AB=(struct Cyc_Absyn_Namespace_d_struct*)_tmp6A4;if(_tmp6AB->tag != 10)goto
_LL37B;else{_tmp6AC=_tmp6AB->f2;}}_LL37A: Cyc_NewControlFlow_cf_check(_tmp6AC);
goto _LL372;_LL37B: {struct Cyc_Absyn_ExternCinclude_d_struct*_tmp6AD=(struct Cyc_Absyn_ExternCinclude_d_struct*)
_tmp6A4;if(_tmp6AD->tag != 13)goto _LL37D;}_LL37C: goto _LL372;_LL37D:;_LL37E: goto
_LL372;_LL372:;}}
