...
struct Cyc_Core_Impossible_exn_struct _tmp68A;const char*_tmp689;struct Cyc_Core_Impossible_exn_struct*_tmp688;(int)_throw((void*)((_tmp688=_cycalloc(sizeof(*_tmp688)),((_tmp688[0]=((_tmp68A.tag=Cyc_Core_Impossible,((_tmp68A.f1=((_tmp689="ControlFlow -- wrong stmt annotation",_tag_dyneither(_tmp689,sizeof(char),37))),_tmp68A)))),_tmp688)))));}_LL0:;}
# 137
...
if(sflow == 0){
union Cyc_CfFlowInfo_FlowInfo*_tmp68B;union Cyc_CfFlowInfo_FlowInfo*res=(_tmp68B=_region_malloc(env->r,sizeof(*_tmp68B)),((_tmp68B[0]=Cyc_CfFlowInfo_BottomFL(),_tmp68B)));
...
struct _tuple19 _tmp68C;return(_tmp68C.f1=_tmpA,((_tmp68C.f2=_tmpB,_tmp68C)));};}
# 171
...
# 200
{const char*_tmp690;void*_tmp68F[1];struct Cyc_String_pa_PrintArg_struct _tmp68E;(_tmp68E.tag=0,((_tmp68E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp13->name)),((_tmp68F[0]=& _tmp68E,Cyc_Tcutil_warn(_tmpF,((_tmp690="unique pointer(s) reachable from %s may become unreachable.",_tag_dyneither(_tmp690,sizeof(char),60))),_tag_dyneither(_tmp68F,sizeof(void*),1)))))));}
goto _LLA;_LLA:;}}
# 204
goto _LL5;_LL8:;_LL9:
 goto _LL5;_LL5:;};}
...
struct _tuple18 _tmp691;struct _tuple18 _stmttmp1=(_tmp691.f1=flow,((_tmp691.f2=_tmp1F,_tmp691)));struct _tuple18 _tmp20=_stmttmp1;struct Cyc_Dict_Dict _tmp21;struct Cyc_Dict_Dict _tmp22;_LL16: if(((_tmp20.f1).ReachableFL).tag != 2)goto _LL18;_tmp21=((struct _tuple14)((_tmp20.f1).ReachableFL).val).f1;if(((_tmp20.f2).ReachableFL).tag != 2)goto _LL18;_tmp22=((struct _tuple14)((_tmp20.f2).ReachableFL).val).f1;_LL17: {
# 221
struct _tuple20 _tmp692;struct _tuple20 _tmp23=(_tmp692.f1=env,((_tmp692.f2=s->loc,((_tmp692.f3=_tmp22,_tmp692)))));
...
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp695;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp694;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp29=(_tmp694=_region_malloc(fenv->r,sizeof(*_tmp694)),((_tmp694[0]=((_tmp695.tag=0,((_tmp695.f1=(struct Cyc_Absyn_Vardecl*)vds->hd,_tmp695)))),_tmp694)));
void*_tmp2A=Cyc_CfFlowInfo_typ_to_absrval(fenv,((struct Cyc_Absyn_Vardecl*)vds->hd)->type,0,leafval);
if(nameit){
struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp698;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp697;_tmp2A=(void*)((_tmp697=_region_malloc(fenv->r,sizeof(*_tmp697)),((_tmp697[0]=((_tmp698.tag=8,((_tmp698.f1=(struct Cyc_Absyn_Vardecl*)vds->hd,((_tmp698.f2=_tmp2A,_tmp698)))))),_tmp697))));}
# 259
...
struct Cyc_List_List*_tmp699;if(Cyc_Relations_consistent_relations(((_tmp699=_region_malloc(r,sizeof(*_tmp699)),((_tmp699->hd=_tmp2F,((_tmp699->tl=assume,_tmp699))))))))
return 0;}
# 277
return 1;}
# 280
...
{const char*_tmp6A9;void*_tmp6A8[2];struct Cyc_String_pa_PrintArg_struct _tmp6A7;struct Cyc_String_pa_PrintArg_struct _tmp6A6;(_tmp6A6.tag=0,((_tmp6A6.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f),((_tmp6A7.tag=0,((_tmp6A7.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(Cyc_NewControlFlow_strip_cast(_tmp4A))),((_tmp6A8[0]=& _tmp6A7,((_tmp6A8[1]=& _tmp6A6,Cyc_CfFlowInfo_aerr(loc,((_tmp6A9="unable to prove %s, required to access %s",_tag_dyneither(_tmp6A9,sizeof(char),42))),_tag_dyneither(_tmp6A8,sizeof(void*),2)))))))))))));}
{const char*_tmp6AC;void*_tmp6AB;(_tmp6AB=0,Cyc_fprintf(Cyc_stderr,((_tmp6AC="  [recorded facts on path: ",_tag_dyneither(_tmp6AC,sizeof(char),28))),_tag_dyneither(_tmp6AB,sizeof(void*),0)));}
Cyc_Relations_print_relns(Cyc_stderr,_tmp35);{
...
const char*_tmp6B2;void*_tmp6B1;(_tmp6B1=0,Cyc_CfFlowInfo_aerr(loc,((_tmp6B2="expression may not be fully initialized",_tag_dyneither(_tmp6B2,sizeof(char),40))),_tag_dyneither(_tmp6B1,sizeof(void*),0)));}{
...
struct _tuple0 _tmp6B3;struct _tuple0 _stmttmp4=(_tmp6B3.f1=Cyc_Tcutil_compress(t),((_tmp6B3.f2=r,_tmp6B3)));struct _tuple0 _tmp5B=_stmttmp4;void*_tmp60;struct Cyc_Absyn_Datatypefield*_tmp62;struct _dyneither_ptr _tmp64;struct Cyc_List_List*_tmp66;struct _dyneither_ptr _tmp68;union Cyc_Absyn_AggrInfoU _tmp6A;struct Cyc_List_List*_tmp6B;struct _dyneither_ptr _tmp6D;enum Cyc_Absyn_AggrKind _tmp6F;struct Cyc_List_List*_tmp70;struct _dyneither_ptr _tmp72;_LL36: {struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*_tmp5C=(struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp5B.f2;if(_tmp5C->tag != 3)goto _LL38;else{if(_tmp5C->f1 != Cyc_CfFlowInfo_NoneIL)goto _LL38;}}_LL37:
...
{const char*_tmp6B9;void*_tmp6B8;(_tmp6B8=0,Cyc_CfFlowInfo_aerr(loc,((_tmp6B9="noliveunique attribute requires unique pointer",_tag_dyneither(_tmp6B9,sizeof(char),47))),_tag_dyneither(_tmp6B8,sizeof(void*),0)));}
...
# 418
if(es == 0){
struct _tuple22 _tmp6BD;return(_tmp6BD.f1=inflow,((_tmp6BD.f2=0,_tmp6BD)));}
if(es->tl == 0){
...
struct Cyc_List_List*_tmp6C0;struct _tuple22 _tmp6BF;return(_tmp6BF.f1=_tmp8C,((_tmp6BF.f2=((_tmp6C0=_region_malloc(rgn,sizeof(*_tmp6C0)),((_tmp6C0->hd=_tmp8D,((_tmp6C0->tl=0,_tmp6C0)))))),_tmp6BF)));};}{
# 424
...
outflow=_tmp92;
{struct Cyc_List_List*_tmp6C2;rvals=((_tmp6C2=_region_malloc(rgn,sizeof(*_tmp6C2)),((_tmp6C2->hd=_tmp93,((_tmp6C2->tl=0,_tmp6C2))))));}
...
{struct Cyc_List_List*_tmp6C4;rvals=((_tmp6C4=_region_malloc(rgn,sizeof(*_tmp6C4)),((_tmp6C4->hd=_tmp98,((_tmp6C4->tl=rvals,_tmp6C4))))));}
...
struct _tuple22 _tmp6C6;return(_tmp6C6.f1=outflow,((_tmp6C6.f2=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(rvals),_tmp6C6)));};};}
# 469
...
const char*_tmp6C9;void*_tmp6C8;(_tmp6C8=0,Cyc_CfFlowInfo_aerr(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd)->loc,((_tmp6C9="expression may not be initialized",_tag_dyneither(_tmp6C9,sizeof(char),34))),_tag_dyneither(_tmp6C8,sizeof(void*),0)));}}
goto _LL56;_LL59: if((_tmpA0.BottomFL).tag != 1)goto _LL56;_LL5A:
 goto _LL56;_LL56:;}{
# 483
struct _tuple15 _tmp6CA;struct _tuple15 _tmpA5=(_tmp6CA.f1=_tmp9E,((_tmp6CA.f2=(env->fenv)->unknown_all,_tmp6CA)));_npop_handler(0);return _tmpA5;};}
# 473
;_pop_region(rgn);}
...
if(locname != 0){
struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp6CD;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp6CC;nzval=(void*)((_tmp6CC=_region_malloc((env->fenv)->r,sizeof(*_tmp6CC)),((_tmp6CC[0]=((_tmp6CD.tag=8,((_tmp6CD.f1=locname,((_tmp6CD.f2=nzval,_tmp6CD)))))),_tmp6CC))));}{
...
struct _tuple18 _tmp6CE;return(_tmp6CE.f1=outflow,((_tmp6CE.f2=outflow,_tmp6CE)));}_LL68: if((_tmpAE.ReachableFL).tag != 2)goto _LL65;_tmpAF=((struct _tuple14)(_tmpAE.ReachableFL).val).f1;_tmpB0=((struct _tuple14)(_tmpAE.ReachableFL).val).f2;_LL69: {
# 536
...
struct _tuple18 _tmp6CF;return(_tmp6CF.f1=outflow,((_tmp6CF.f2=outflow,_tmp6CF)));}_LL6D: if((_tmpB2.PlaceL).tag != 1)goto _LL6A;_tmpB3=(struct Cyc_CfFlowInfo_Place*)(_tmpB2.PlaceL).val;_LL6E: {
# 539
void*nzval=il == Cyc_CfFlowInfo_AllIL?(env->fenv)->notzeroall:(env->fenv)->notzerothis;
void*zval=(env->fenv)->zero;
if(locname != 0){
{struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp6D2;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp6D1;nzval=(void*)((_tmp6D1=_region_malloc((env->fenv)->r,sizeof(*_tmp6D1)),((_tmp6D1[0]=((_tmp6D2.tag=8,((_tmp6D2.f1=locname,((_tmp6D2.f2=nzval,_tmp6D2)))))),_tmp6D1))));}{
struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp6D5;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp6D4;zval=(void*)((_tmp6D4=_region_malloc((env->fenv)->r,sizeof(*_tmp6D4)),((_tmp6D4[0]=((_tmp6D5.tag=8,((_tmp6D5.f1=locname,((_tmp6D5.f2=zval,_tmp6D5)))))),_tmp6D4))));};}{
# 545
struct _tuple18 _tmp6D6;return
...
# 548
Cyc_CfFlowInfo_ReachableFL(Cyc_CfFlowInfo_assign_place(env->fenv,e->loc,_tmpAF,env->all_changed,_tmpB3,zval),_tmpB0),_tmp6D6)));};}_LL6A:;}_LL65:;}
# 554
...
# 570
struct _tuple15 _tmp6D7;return(_tmp6D7.f1=f,((_tmp6D7.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpBE,0,(env->fenv)->unknown_all),_tmp6D7)));}_LL77: if((_tmpC1.ReachableFL).tag != 2)goto _LL74;_tmpC2=((struct _tuple14)(_tmpC1.ReachableFL).val).f1;_tmpC3=((struct _tuple14)(_tmpC1.ReachableFL).val).f2;_LL78:
# 573
...
# 588
{struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct _tmp6DA;struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp6D9;e->annot=(void*)((_tmp6D9=_cycalloc(sizeof(*_tmp6D9)),((_tmp6D9[0]=((_tmp6DA.tag=Cyc_CfFlowInfo_NotZero,((_tmp6DA.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmpC3),_tmp6DA)))),_tmp6D9))));}
...
# 606
{struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct _tmp6DD;struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp6DC;e->annot=(void*)((_tmp6DC=_cycalloc(sizeof(*_tmp6DC)),((_tmp6DC[0]=((_tmp6DD.tag=Cyc_CfFlowInfo_NotZero,((_tmp6DD.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmpC3),_tmp6DD)))),_tmp6DC))));}
...
goto _LL92;_LL92:;}{
# 614
struct _tuple15 _tmp6DE;return(_tmp6DE.f1=f,((_tmp6DE.f2=Cyc_CfFlowInfo_lookup_place(_tmpC2,_tmpCC),_tmp6DE)));};_LL82: {struct Cyc_CfFlowInfo_Zero_CfFlowInfo_AbsRVal_struct*_tmpCD=(struct Cyc_CfFlowInfo_Zero_CfFlowInfo_AbsRVal_struct*)_tmpC5;if(_tmpCD->tag != 0)goto _LL84;}_LL83:
# 616
 e->annot=(void*)& Cyc_CfFlowInfo_IsZero_val;{
struct _tuple15 _tmp6DF;return(_tmp6DF.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp6DF.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpBE,0,(env->fenv)->unknown_all),_tmp6DF)));};_LL84: {struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*_tmpCE=(struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmpC5;if(_tmpCE->tag != 3)goto _LL86;else{_tmpCF=_tmpCE->f1;}}_LL85:
# 619
...
# 623
{struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp6E2;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp6E1;e->annot=(void*)((_tmp6E1=_cycalloc(sizeof(*_tmp6E1)),((_tmp6E1[0]=((_tmp6E2.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp6E2.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmpC3),_tmp6E2)))),_tmp6E1))));}
...
# 637
{struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp6E5;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp6E4;e->annot=(void*)((_tmp6E4=_cycalloc(sizeof(*_tmp6E4)),((_tmp6E4[0]=((_tmp6E5.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp6E5.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmpC3),_tmp6E5)))),_tmp6E4))));}
goto _LLA1;_LLA1:;}{
# 641
...
# 645
{const char*_tmp6E8;void*_tmp6E7;(_tmp6E7=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp6E8="attempt to use a unique pointer that has already been copied",_tag_dyneither(_tmp6E8,sizeof(char),61))),_tag_dyneither(_tmp6E7,sizeof(void*),0)));}
goto _LLA8;_LLAB:;_LLAC: {
# 648
const char*_tmp6EB;void*_tmp6EA;(_tmp6EA=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp6EB="dereference of possibly uninitialized pointer",_tag_dyneither(_tmp6EB,sizeof(char),46))),_tag_dyneither(_tmp6EA,sizeof(void*),0)));}_LLA8:;}
# 650
goto _LLA7;case Cyc_CfFlowInfo_AllIL: _LLA7: {
# 652
struct _tuple15 _tmp6EC;return(_tmp6EC.f1=f,((_tmp6EC.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpBE,0,(env->fenv)->unknown_all),_tmp6EC)));}case Cyc_CfFlowInfo_ThisIL: _LLAD: {
# 654
struct _tuple15 _tmp6ED;return(_tmp6ED.f1=f,((_tmp6ED.f2=Cyc_CfFlowInfo_typ_to_absrval(env->fenv,_tmpBE,0,(env->fenv)->unknown_none),_tmp6ED)));}}};_LL74:;}_LL72:;_LL73: {
# 657
...
{struct _tuple17 _tmp6F4;struct _tuple17 _stmttmp15=(_tmp6F4.f1=inflow,((_tmp6F4.f2=_tmpF9,_tmp6F4)));struct _tuple17 _tmpFA=_stmttmp15;struct Cyc_Dict_Dict _tmpFB;struct Cyc_List_List*_tmpFC;struct Cyc_CfFlowInfo_Place*_tmpFD;_LLB5: if(((_tmpFA.f1).ReachableFL).tag != 2)goto _LLB7;_tmpFB=((struct _tuple14)((_tmpFA.f1).ReachableFL).val).f1;_tmpFC=((struct _tuple14)((_tmpFA.f1).ReachableFL).val).f2;if(((_tmpFA.f2).PlaceL).tag != 1)goto _LLB7;_tmpFD=(struct Cyc_CfFlowInfo_Place*)((_tmpFA.f2).PlaceL).val;_LLB6: {
# 703
...
# 715
{const char*_tmp6F7;void*_tmp6F6;(_tmp6F6=0,Cyc_CfFlowInfo_aerr(loc,((_tmp6F7="noconsume() parameters must be l-values",_tag_dyneither(_tmp6F7,sizeof(char),40))),_tag_dyneither(_tmp6F6,sizeof(void*),0)));}
goto _LLB4;_LLB4:;}
# 718
return inflow;}
# 723
...
# 734
struct _tuple15 _tmp6F8;return(_tmp6F8.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp6F8.f2=rval,_tmp6F8)));}_LLBE: if((_tmp102.ReachableFL).tag != 2)goto _LLBB;_tmp103=((struct _tuple14)(_tmp102.ReachableFL).val).f1;_tmp104=((struct _tuple14)(_tmp102.ReachableFL).val).f2;_LLBF: {
# 736
...
# 752
{const char*_tmp6FB;void*_tmp6FA;(_tmp6FA=0,Cyc_Tcutil_warn(lexp->loc,((_tmp6FB="assignment may overwrite unique pointer(s)",_tag_dyneither(_tmp6FB,sizeof(char),43))),_tag_dyneither(_tmp6FA,sizeof(void*),0)));}
goto _LLC5;_LLC5:;}
# 757
Cyc_NewControlFlow_update_tryflow(env,outflow);{
# 759
struct _tuple15 _tmp6FC;return(_tmp6FC.f1=outflow,((_tmp6FC.f2=rval,_tmp6FC)));};}_LLC3: if((_tmp106.UnknownL).tag != 2)goto _LLC0;_LLC4: {
# 762
struct _tuple15 _tmp6FD;return(_tmp6FD.f1=Cyc_NewControlFlow_use_Rval(env,rexp->loc,outflow,rval),((_tmp6FD.f2=rval,_tmp6FD)));}_LLC0:;}_LLBB:;}
# 769
...
# 778
{struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp703;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp702;struct Cyc_CfFlowInfo_Place*_tmp701;_tmp118=Cyc_CfFlowInfo_assign_place(fenv,loc,_tmp118,env->all_changed,(
(_tmp701=_region_malloc(env->r,sizeof(*_tmp701)),((_tmp701->root=(void*)((_tmp703=_region_malloc(env->r,sizeof(*_tmp703)),((_tmp703[0]=((_tmp702.tag=0,((_tmp702.f1=vd,_tmp702)))),_tmp703)))),((_tmp701->fields=0,_tmp701)))))),rval);}
# 781
...
if((*((struct _tuple23*)x->hd)).f1 == 0){struct Cyc_List_List*_tmp704;es=((_tmp704=_cycalloc(sizeof(*_tmp704)),((_tmp704->hd=(struct Cyc_Absyn_Exp*)_check_null((*((struct _tuple23*)x->hd)).f2),((_tmp704->tl=es,_tmp704))))));}}}
# 808
...
# 829
if(_tmp126->topt == 0){
const char*_tmp708;void*_tmp707[1];struct Cyc_String_pa_PrintArg_struct _tmp706;(_tmp706.tag=0,((_tmp706.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_exp2string(_tmp126)),((_tmp707[0]=& _tmp706,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp708="oops! pattern init expr %s has no type!\n",_tag_dyneither(_tmp708,sizeof(char),41))),_tag_dyneither(_tmp707,sizeof(void*),1)))))));}
# 834
Cyc_fflush(Cyc_stderr);{
# 836
struct Cyc_List_List _tmp709;struct Cyc_List_List l=(_tmp709.hd=_tmp126,((_tmp709.tl=0,_tmp709)));
...
if(name_locs){
struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp70C;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp70B;_tmp12D=(void*)((_tmp70B=_region_malloc(fenv->r,sizeof(*_tmp70B)),((_tmp70B[0]=((_tmp70C.tag=8,((_tmp70C.f1=*_tmp125,((_tmp70C.f2=_tmp12D,_tmp70C)))))),_tmp70B))));}
...
struct _tuple15 _tmp70D;return(_tmp70D.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp70D.f2=_tmp142->unknown_all,_tmp70D)));}_LLF2: if((_tmp143.ReachableFL).tag != 2)goto _LLEF;_tmp144=((struct _tuple14)(_tmp143.ReachableFL).val).f1;_tmp145=((struct _tuple14)(_tmp143.ReachableFL).val).f2;_LLF3:
...
struct _tuple17 _tmp70E;struct _tuple17 _stmttmp1D=(_tmp70E.f1=_tmp148,((_tmp70E.f2=_tmp149,_tmp70E)));struct _tuple17 _tmp14A=_stmttmp1D;struct Cyc_Dict_Dict _tmp14B;struct Cyc_List_List*_tmp14C;struct Cyc_CfFlowInfo_Place*_tmp14D;_LLF5: if(((_tmp14A.f1).ReachableFL).tag != 2)goto _LLF7;_tmp14B=((struct _tuple14)((_tmp14A.f1).ReachableFL).val).f1;_tmp14C=((struct _tuple14)((_tmp14A.f1).ReachableFL).val).f2;if(((_tmp14A.f2).PlaceL).tag != 1)goto _LLF7;_tmp14D=(struct Cyc_CfFlowInfo_Place*)((_tmp14A.f2).PlaceL).val;_LLF6: {
# 925
...
{const char*_tmp711;void*_tmp710;(_tmp710=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp711="expression attempts to copy unique value that may be copied elsewhere.",_tag_dyneither(_tmp711,sizeof(char),71))),_tag_dyneither(_tmp710,sizeof(void*),0)));}{
struct _tuple15 _tmp712;return(_tmp712.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp712.f2=_tmp142->unknown_all,_tmp712)));};}else{
# 931
if(needs_unconsume){
# 933
struct _tuple15 _tmp713;return(_tmp713.f1=_tmp148,((_tmp713.f2=Cyc_CfFlowInfo_make_unique_unconsumed(_tmp142,_tmp14E),_tmp713)));}else{
# 936
...
# 947
struct _tuple15 _tmp714;return(_tmp714.f1=Cyc_CfFlowInfo_ReachableFL(_tmp154,_tmp14C),((_tmp714.f2=_tmp14E,_tmp714)));}}}_LLF7:;_LLF8:
# 949
 goto _LLF4;_LLF4:;};}{
# 952
...
struct _tuple15 _tmp715;return(_tmp715.f1=_tmp1D3,((_tmp715.f2=_tmp1D1,_tmp715)));};};}_LLFC: {struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp15A=(struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp15A->tag != 13)goto _LLFE;else{_tmp15B=_tmp15A->f2;}}_LLFD:
# 962
...
struct _tuple15 _tmp716;return(_tmp716.f1=inflow,((_tmp716.f2=_tmp142->zero,_tmp716)));}_LL106: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp162=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp162->tag != 0)goto _LL108;else{if(((_tmp162->f1).Int_c).tag != 5)goto _LL108;}}_LL107:
...
struct _tuple15 _tmp717;return(_tmp717.f1=inflow,((_tmp717.f2=_tmp142->notzeroall,_tmp717)));}_LL10A: {struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmp165=(struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp165->tag != 30)goto _LL10C;else{if(_tmp165->f1 != 0)goto _LL10C;}}_LL10B:
# 971
...
struct _tuple15 _tmp718;return(_tmp718.f1=inflow,((_tmp718.f2=_tmp142->unknown_all,_tmp718)));}_LL118: {struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp16C=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp16C->tag != 1)goto _LL11A;else{struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp16D=(struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((void*)_tmp16C->f2);if(_tmp16D->tag != 1)goto _LL11A;}}_LL119: {
# 980
struct _tuple15 _tmp719;return(_tmp719.f1=inflow,((_tmp719.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp142,(void*)_check_null(e->topt),0,_tmp142->unknown_all),_tmp719)));}_LL11A: {struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp16E=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp16E->tag != 1)goto _LL11C;else{struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp16F=(struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)((void*)_tmp16E->f2);if(_tmp16F->tag != 3)goto _LL11C;else{_tmp170=_tmp16F->f1;}}}_LL11B:
# 983
...
# 987
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp71A;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct vdroot=(_tmp71A.tag=0,((_tmp71A.f1=_tmp176,_tmp71A)));
struct _tuple15 _tmp71B;return(_tmp71B.f1=inflow,((_tmp71B.f2=((void*(*)(struct Cyc_Dict_Dict d,int(*cmp)(void*,void*),void*k))Cyc_Dict_lookup_other)(d,Cyc_CfFlowInfo_root_cmp,(void*)& vdroot),_tmp71B)));}_LL120: {struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp177=(struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp177->tag != 2)goto _LL122;else{_tmp178=_tmp177->f1;_tmp179=_tmp177->f2;}}_LL121: {
# 994
...
struct _tuple15 _tmp71C;return(_tmp71C.f1=_tmp1DD,((_tmp71C.f2=_tmp1DE,_tmp71C)));};}_LL122: {struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp17A=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp17A->tag != 4)goto _LL124;else{_tmp17B=_tmp17A->f1;}}_LL123: {
# 998
struct Cyc_List_List _tmp71D;struct Cyc_List_List _tmp1E0=(_tmp71D.hd=_tmp17B,((_tmp71D.tl=0,_tmp71D)));
...
{struct _tuple24 _tmp71E;struct _tuple24 _stmttmp4D=(_tmp71E.f1=_tmp1E4,((_tmp71E.f2=_tmp1E2,_tmp71E)));struct _tuple24 _tmp1E5=_stmttmp4D;struct Cyc_CfFlowInfo_Place*_tmp1E6;struct Cyc_Dict_Dict _tmp1E7;struct Cyc_List_List*_tmp1E8;_LL163: if(((_tmp1E5.f1).PlaceL).tag != 1)goto _LL165;_tmp1E6=(struct Cyc_CfFlowInfo_Place*)((_tmp1E5.f1).PlaceL).val;if(((_tmp1E5.f2).ReachableFL).tag != 2)goto _LL165;_tmp1E7=((struct _tuple14)((_tmp1E5.f2).ReachableFL).val).f1;_tmp1E8=((struct _tuple14)((_tmp1E5.f2).ReachableFL).val).f2;_LL164:
# 1003
...
goto _LL162;_LL165:;_LL166:
 goto _LL162;_LL162:;}{
# 1010
struct _tuple15 _tmp71F;return(_tmp71F.f1=_tmp1E2,((_tmp71F.f2=_tmp142->unknown_all,_tmp71F)));};};}_LL124: {struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmp17C=(struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp17C->tag != 3)goto _LL126;else{_tmp17D=_tmp17C->f1;if(_tmp17C->f2 == 0)goto _LL126;_tmp17E=_tmp17C->f3;}}_LL125:
# 1013
 if(copy_ctxt  && Cyc_Tcutil_is_noalias_pointer_or_aggr(env->r,(void*)_check_null(e->topt))){
{const char*_tmp722;void*_tmp721;(_tmp721=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp722="cannot track unique pointers through multiple assignments",_tag_dyneither(_tmp722,sizeof(char),58))),_tag_dyneither(_tmp721,sizeof(void*),0)));}{
struct _tuple15 _tmp723;return(_tmp723.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp723.f2=_tmp142->unknown_all,_tmp723)));};}{
# 1017
struct Cyc_List_List _tmp724;struct Cyc_List_List _tmp1EF=(_tmp724.hd=_tmp17E,((_tmp724.tl=0,_tmp724)));
struct Cyc_List_List _tmp725;struct Cyc_List_List _tmp1F0=(_tmp725.hd=_tmp17D,((_tmp725.tl=& _tmp1EF,_tmp725)));
...
goto _LL167;_LL16A:;_LL16B:
 goto _LL167;_LL167:;}{
# 1041
struct _tuple15 _tmp726;return(_tmp726.f1=_tmp1F2,((_tmp726.f2=_tmp142->unknown_all,_tmp726)));};};};_LL126: {struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmp17F=(struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp17F->tag != 3)goto _LL128;else{_tmp180=_tmp17F->f1;if(_tmp17F->f2 != 0)goto _LL128;_tmp181=_tmp17F->f3;}}_LL127:
# 1045
 if(copy_ctxt  && Cyc_Tcutil_is_noalias_pointer_or_aggr(env->r,(void*)_check_null(e->topt))){
{const char*_tmp729;void*_tmp728;(_tmp728=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp729="cannot track unique pointers through multiple assignments",_tag_dyneither(_tmp729,sizeof(char),58))),_tag_dyneither(_tmp728,sizeof(void*),0)));}{
struct _tuple15 _tmp72A;return(_tmp72A.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp72A.f2=_tmp142->unknown_all,_tmp72A)));};}{
# 1049
struct Cyc_Dict_Dict*_tmp200=env->all_changed;
# 1051
{struct Cyc_Absyn_Exp*_tmp72B[2];inflow=Cyc_NewControlFlow_expand_unique_places(env,inflow,((_tmp72B[1]=_tmp181,((_tmp72B[0]=_tmp180,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(env->r,_tag_dyneither(_tmp72B,sizeof(struct Cyc_Absyn_Exp*),2)))))));}
while(1){
{struct Cyc_Dict_Dict*_tmp72C;env->all_changed=((_tmp72C=_region_malloc(env->r,sizeof(*_tmp72C)),((_tmp72C[0]=_tmp142->mt_place_set,_tmp72C))));}{
...
struct _tuple15 _tmp72E;return(_tmp72E.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp72E.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp142,(void*)_check_null(e->topt),0,_tmp142->unknown_all),_tmp72E)));};}_LL12C: {struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp187=(struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp187->tag != 9)goto _LL12E;else{_tmp188=_tmp187->f1;_tmp189=_tmp187->f2;}}_LL12D: {
# 1089
struct _RegionHandle _tmp215=_new_region("temp");struct _RegionHandle*temp=& _tmp215;_push_region(temp);
{struct Cyc_List_List*_tmp72F;struct _tuple22 _stmttmp3F=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,((_tmp72F=_region_malloc(temp,sizeof(*_tmp72F)),((_tmp72F->hd=_tmp188,((_tmp72F->tl=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x))Cyc_List_rcopy)(temp,_tmp189),_tmp72F)))))),0,1);union Cyc_CfFlowInfo_FlowInfo _tmp217;struct Cyc_List_List*_tmp218;struct _tuple22 _tmp216=_stmttmp3F;_tmp217=_tmp216.f1;_tmp218=_tmp216.f2;{
# 1092
...
# 1106
{struct Cyc_List_List*_tmp730;init_params=((_tmp730=_region_malloc(temp,sizeof(*_tmp730)),((_tmp730->hd=(void*)_tmp222,((_tmp730->tl=init_params,_tmp730))))));}goto _LL17B;_LL17E: {struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*_tmp223=(struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*)_tmp220;if(_tmp223->tag != 21)goto _LL180;else{_tmp224=_tmp223->f1;}}_LL17F:
# 1108
{struct Cyc_List_List*_tmp731;nolive_unique_params=((_tmp731=_region_malloc(temp,sizeof(*_tmp731)),((_tmp731->hd=(void*)_tmp224,((_tmp731->tl=nolive_unique_params,_tmp731))))));}
...
# 1112
{struct Cyc_List_List*_tmp732;noconsume_params=((_tmp732=_region_malloc(temp,sizeof(*_tmp732)),((_tmp732->hd=(void*)_tmp226,((_tmp732->tl=noconsume_params,_tmp732))))));}
goto _LL17B;_LL182:;_LL183:
 goto _LL17B;_LL17B:;}
# 1116
goto _LL176;_LL179:;_LL17A: {
const char*_tmp735;void*_tmp734;(_tmp734=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp735="anal_Rexp: bad function type",_tag_dyneither(_tmp735,sizeof(char),29))),_tag_dyneither(_tmp734,sizeof(void*),0)));}_LL176:;}
# 1119
goto _LL171;_LL174:;_LL175: {
const char*_tmp738;void*_tmp737;(_tmp737=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp738="anal_Rexp: bad function type",_tag_dyneither(_tmp738,sizeof(char),29))),_tag_dyneither(_tmp737,sizeof(void*),0)));}_LL171:;}
# 1122
...
const char*_tmp73B;void*_tmp73A;(_tmp73A=0,Cyc_CfFlowInfo_aerr(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp189))->hd)->loc,((_tmp73B="expression may not be initialized",_tag_dyneither(_tmp73B,sizeof(char),34))),_tag_dyneither(_tmp73A,sizeof(void*),0)));}
...
const char*_tmp73E;void*_tmp73D;(_tmp73D=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp73E="anal_Rexp:bad type for initialized arg",_tag_dyneither(_tmp73E,sizeof(char),39))),_tag_dyneither(_tmp73D,sizeof(void*),0)));}_LL193:;}
# 1148
...
struct _tuple15 _tmp73F;struct _tuple15 _tmp23F=(_tmp73F.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp73F.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp142,(void*)_check_null(e->topt),0,_tmp142->unknown_all),_tmp73F)));_npop_handler(0);return _tmp23F;}else{
# 1179
struct _tuple15 _tmp740;struct _tuple15 _tmp241=(_tmp740.f1=_tmp219,((_tmp740.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp142,(void*)_check_null(e->topt),0,_tmp142->unknown_all),_tmp740)));_npop_handler(0);return _tmp241;}};};}
# 1090
...
# 1182
struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct _tmp743;struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_tmp742;void*root=(void*)((_tmp742=_region_malloc(_tmp142->r,sizeof(*_tmp742)),((_tmp742[0]=((_tmp743.tag=1,((_tmp743.f1=_tmp18E,((_tmp743.f2=(void*)_check_null(e->topt),_tmp743)))))),_tmp742))));
struct Cyc_CfFlowInfo_Place*_tmp744;struct Cyc_CfFlowInfo_Place*place=(_tmp744=_region_malloc(_tmp142->r,sizeof(*_tmp744)),((_tmp744->root=root,((_tmp744->fields=0,_tmp744)))));
struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp747;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp746;void*rval=(void*)((_tmp746=_region_malloc(_tmp142->r,sizeof(*_tmp746)),((_tmp746[0]=((_tmp747.tag=5,((_tmp747.f1=place,_tmp747)))),_tmp746))));
void*place_val;
...
{struct Cyc_Absyn_Exp*_tmp748[2];struct _tuple22 _stmttmp3D=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,(
(_tmp748[1]=_tmp18E,((_tmp748[0]=_tmp18C,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(temp,_tag_dyneither(_tmp748,sizeof(struct Cyc_Absyn_Exp*),2)))))),1,1);
# 1193
...
struct _tuple15 _tmp749;return(_tmp749.f1=outflow,((_tmp749.f2=rval,_tmp749)));}_LL19B: if((_tmp24A.ReachableFL).tag != 2)goto _LL198;_tmp24B=((struct _tuple14)(_tmp24A.ReachableFL).val).f1;_tmp24C=((struct _tuple14)(_tmp24A.ReachableFL).val).f2;_LL19C: {
# 1204
struct _tuple15 _tmp74A;return(_tmp74A.f1=Cyc_CfFlowInfo_ReachableFL(((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp24B,root,place_val),_tmp24C),((_tmp74A.f2=rval,_tmp74A)));}_LL198:;};};}_LL130: {struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*_tmp190=(struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp190->tag != 34)goto _LL132;else{_tmp191=_tmp190->f1;_tmp192=_tmp190->f2;}}_LL131: {
# 1208
void*left_rval;
void*right_rval;
union Cyc_CfFlowInfo_FlowInfo outflow;
...
struct Cyc_Absyn_Exp*_tmp74B[2];struct _tuple22 _stmttmp3A=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,(
(_tmp74B[1]=_tmp192,((_tmp74B[0]=_tmp191,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(temp,_tag_dyneither(_tmp74B,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,0);
# 1215
...
goto _LL19D;_LL1A0:;_LL1A1:
 goto _LL19D;_LL19D:;}{
# 1250
struct _tuple15 _tmp74C;struct _tuple15 _tmp265=(_tmp74C.f1=outflow,((_tmp74C.f2=_tmp142->unknown_all,_tmp74C)));_npop_handler(0);return _tmp265;};};};
# 1214
...
# 1253
struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct _tmp74F;struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_tmp74E;void*root=(void*)((_tmp74E=_region_malloc(_tmp142->r,sizeof(*_tmp74E)),((_tmp74E[0]=((_tmp74F.tag=1,((_tmp74F.f1=_tmp195,((_tmp74F.f2=(void*)_check_null(e->topt),_tmp74F)))))),_tmp74E))));
struct Cyc_CfFlowInfo_Place*_tmp750;struct Cyc_CfFlowInfo_Place*place=(_tmp750=_region_malloc(_tmp142->r,sizeof(*_tmp750)),((_tmp750->root=root,((_tmp750->fields=0,_tmp750)))));
struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp753;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp752;void*rval=(void*)((_tmp752=_region_malloc(_tmp142->r,sizeof(*_tmp752)),((_tmp752[0]=((_tmp753.tag=5,((_tmp753.f1=place,_tmp753)))),_tmp752))));
((int(*)(struct Cyc_Dict_Dict*set,struct Cyc_CfFlowInfo_Place*place,unsigned int loc))Cyc_CfFlowInfo_update_place_set)(env->all_changed,place,0);{
union Cyc_CfFlowInfo_FlowInfo outflow;
void*place_val;
if(_tmp194 != 0){
struct _RegionHandle _tmp266=_new_region("temp");struct _RegionHandle*temp=& _tmp266;_push_region(temp);
{struct Cyc_Absyn_Exp*_tmp754[2];struct _tuple22 _stmttmp38=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,(
(_tmp754[1]=_tmp195,((_tmp754[0]=_tmp194,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(temp,_tag_dyneither(_tmp754,sizeof(struct Cyc_Absyn_Exp*),2)))))),1,1);
# 1261
...
struct _tuple15 _tmp755;return(_tmp755.f1=outflow,((_tmp755.f2=rval,_tmp755)));}_LL1AF: if((_tmp26E.ReachableFL).tag != 2)goto _LL1AC;_tmp26F=((struct _tuple14)(_tmp26E.ReachableFL).val).f1;_tmp270=((struct _tuple14)(_tmp26E.ReachableFL).val).f2;_LL1B0: {
# 1274
struct _tuple15 _tmp756;return(_tmp756.f1=Cyc_CfFlowInfo_ReachableFL(((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp26F,root,place_val),_tmp270),((_tmp756.f2=rval,_tmp756)));}_LL1AC:;};};}_LL134: {struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*_tmp196=(struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp196->tag != 14)goto _LL136;else{_tmp197=_tmp196->f1;}}_LL135: {
# 1278
...
struct _tuple15 _tmp757;return(_tmp757.f1=_tmp279,((_tmp757.f2=_tmp142->notzeroall,_tmp757)));}_LL1B4: if((_tmp27B.PlaceL).tag != 1)goto _LL1B1;_tmp27C=(struct Cyc_CfFlowInfo_Place*)(_tmp27B.PlaceL).val;_LL1B5: {
struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp75D;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp75C;struct _tuple15 _tmp75B;return(_tmp75B.f1=_tmp279,((_tmp75B.f2=(void*)((_tmp75D=_region_malloc(env->r,sizeof(*_tmp75D)),((_tmp75D[0]=((_tmp75C.tag=5,((_tmp75C.f1=_tmp27C,_tmp75C)))),_tmp75D)))),_tmp75B)));}_LL1B1:;};}_LL136: {struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_tmp198=(struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp198->tag != 19)goto _LL138;else{_tmp199=_tmp198->f1;}}_LL137: {
# 1285
...
if(_tmp19B->topt == 0){
{const char*_tmp761;void*_tmp760[1];struct Cyc_String_pa_PrintArg_struct _tmp75F;(_tmp75F.tag=0,((_tmp75F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp760[0]=& _tmp75F,Cyc_fprintf(Cyc_stderr,((_tmp761="aggrmember exp %s\n",_tag_dyneither(_tmp761,sizeof(char),19))),_tag_dyneither(_tmp760,sizeof(void*),1)))))));}{
const char*_tmp765;void*_tmp764[1];struct Cyc_String_pa_PrintArg_struct _tmp763;(_tmp763.tag=0,((_tmp763.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmp19B)),((_tmp764[0]=& _tmp763,Cyc_fprintf(Cyc_stderr,((_tmp765="oops! %s.topt = null!\n",_tag_dyneither(_tmp765,sizeof(char),23))),_tag_dyneither(_tmp764,sizeof(void*),1)))))));};}{
# 1294
void*_tmp28D=(void*)_check_null(_tmp19B->topt);
if(Cyc_Absyn_is_nontagged_nonrequire_union_type(_tmp28D)){
# 1297
struct _tuple15 _tmp766;return(_tmp766.f1=_tmp285,((_tmp766.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp142,(void*)_check_null(e->topt),0,_tmp142->unknown_all),_tmp766)));}
# 1299
...
struct _tuple15 _tmp767;return(_tmp767.f1=_tmp285,((_tmp767.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp142,(void*)_check_null(e->topt),1,_tmp142->unknown_none),_tmp767)));}{
struct _tuple15 _tmp768;return(_tmp768.f1=_tmp285,((_tmp768.f2=*((void**)_check_dyneither_subscript(_tmp298,sizeof(void*),_tmp299)),_tmp768)));};}_LL1BB:;_LL1BC:
# 1311
{const char*_tmp76B;void*_tmp76A;(_tmp76A=0,Cyc_fprintf(Cyc_stderr,((_tmp76B="the bad rexp is :",_tag_dyneither(_tmp76B,sizeof(char),18))),_tag_dyneither(_tmp76A,sizeof(void*),0)));}
Cyc_CfFlowInfo_print_absrval(_tmp286);
{const char*_tmp76E;void*_tmp76D;(_tmp76D=0,Cyc_fprintf(Cyc_stderr,((_tmp76E="\n",_tag_dyneither(_tmp76E,sizeof(char),2))),_tag_dyneither(_tmp76D,sizeof(void*),0)));}{
struct Cyc_Core_Impossible_exn_struct _tmp77B;const char*_tmp77A;void*_tmp779[1];struct Cyc_String_pa_PrintArg_struct _tmp778;struct Cyc_Core_Impossible_exn_struct*_tmp777;(int)_throw((void*)((_tmp777=_cycalloc(sizeof(*_tmp777)),((_tmp777[0]=((_tmp77B.tag=Cyc_Core_Impossible,((_tmp77B.f1=(struct _dyneither_ptr)((_tmp778.tag=0,((_tmp778.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp779[0]=& _tmp778,Cyc_aprintf(((_tmp77A="anal_Rexp: AggrMember: %s",_tag_dyneither(_tmp77A,sizeof(char),26))),_tag_dyneither(_tmp779,sizeof(void*),1)))))))),_tmp77B)))),_tmp777)))));};_LL1B6:;};};}_LL13A: {struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*_tmp19D=(struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp19D->tag != 37)goto _LL13C;else{_tmp19E=_tmp19D->f1;_tmp19F=_tmp19D->f2;}}_LL13B: {
# 1321
...
struct _tuple15 _tmp77C;return(_tmp77C.f1=_tmp2A6,((_tmp77C.f2=_tmp142->unknown_all,_tmp77C)));}{
...
if(_tmp2B1 != _tmp2B3){
struct _tuple15 _tmp77D;return(_tmp77D.f1=_tmp2A6,((_tmp77D.f2=_tmp142->zero,_tmp77D)));}else{
# 1334
struct _tuple15 _tmp77E;return(_tmp77E.f1=_tmp2A6,((_tmp77E.f2=_tmp142->notzeroall,_tmp77E)));}}else{
# 1336
struct _tuple15 _tmp77F;return(_tmp77F.f1=_tmp2A6,((_tmp77F.f2=_tmp142->unknown_all,_tmp77F)));}}_LL1C2:;_LL1C3: {
# 1338
struct Cyc_Core_Impossible_exn_struct _tmp78C;const char*_tmp78B;void*_tmp78A[1];struct Cyc_String_pa_PrintArg_struct _tmp789;struct Cyc_Core_Impossible_exn_struct*_tmp788;(int)_throw((void*)((_tmp788=_cycalloc(sizeof(*_tmp788)),((_tmp788[0]=((_tmp78C.tag=Cyc_Core_Impossible,((_tmp78C.f1=(struct _dyneither_ptr)((_tmp789.tag=0,((_tmp789.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp78A[0]=& _tmp789,Cyc_aprintf(((_tmp78B="anal_Rexp: TagCheck_e: %s",_tag_dyneither(_tmp78B,sizeof(char),26))),_tag_dyneither(_tmp78A,sizeof(void*),1)))))))),_tmp78C)))),_tmp788)))));}_LL1BD:;};}_LL13C: {struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp1A0=(struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp1A0->tag != 21)goto _LL13E;else{_tmp1A1=_tmp1A0->f1;_tmp1A2=_tmp1A0->f2;}}_LL13D: {
# 1343
...
# 1353
struct _tuple15 _tmp78D;return(_tmp78D.f1=_tmp2C0,((_tmp78D.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp142,(void*)_check_null(e->topt),0,_tmp142->unknown_all),_tmp78D)));}
# 1355
...
struct _tuple15 _tmp78E;return(_tmp78E.f1=_tmp2C0,((_tmp78E.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp142,(void*)_check_null(e->topt),1,_tmp142->unknown_none),_tmp78E)));}{
struct _tuple15 _tmp78F;return(_tmp78F.f1=_tmp2C0,((_tmp78F.f2=*((void**)_check_dyneither_subscript(_tmp2CF,sizeof(void*),_tmp2D0)),_tmp78F)));};}_LL1CE:;_LL1CF: {
struct Cyc_Core_Impossible_exn_struct _tmp795;const char*_tmp794;struct Cyc_Core_Impossible_exn_struct*_tmp793;(int)_throw((void*)((_tmp793=_cycalloc(sizeof(*_tmp793)),((_tmp793[0]=((_tmp795.tag=Cyc_Core_Impossible,((_tmp795.f1=((_tmp794="anal_Rexp: AggrArrow",_tag_dyneither(_tmp794,sizeof(char),21))),_tmp795)))),_tmp793)))));}_LL1C9:;};_LL1C7:;_LL1C8: {
# 1368
struct Cyc_Core_Impossible_exn_struct _tmp79B;const char*_tmp79A;struct Cyc_Core_Impossible_exn_struct*_tmp799;(int)_throw((void*)((_tmp799=_cycalloc(sizeof(*_tmp799)),((_tmp799[0]=((_tmp79B.tag=Cyc_Core_Impossible,((_tmp79B.f1=((_tmp79A="anal_Rexp: AggrArrow ptr",_tag_dyneither(_tmp79A,sizeof(char),25))),_tmp79B)))),_tmp799)))));}_LL1C4:;};};}_LL13E: {struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_tmp1A3=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp1A3->tag != 5)goto _LL140;else{_tmp1A4=_tmp1A3->f1;_tmp1A5=_tmp1A3->f2;_tmp1A6=_tmp1A3->f3;}}_LL13F: {
# 1372
...
struct _tuple15 _tmp79C;struct _tuple15 _tmp2E4=(_tmp79C.f1=_tmp2E2,((_tmp79C.f2=_tmp2E3,_tmp79C)));
struct _tuple15 _tmp79D;struct _tuple15 _tmp2E5=(_tmp79D.f1=_tmp2E0,((_tmp79D.f2=_tmp142->zero,_tmp79D)));
...
struct _tuple15 _tmp79E;struct _tuple15 _tmp2EE=(_tmp79E.f1=_tmp2EC,((_tmp79E.f2=_tmp2ED,_tmp79E)));
struct _tuple15 _tmp79F;struct _tuple15 _tmp2EF=(_tmp79F.f1=_tmp2E9,((_tmp79F.f2=_tmp142->notzeroall,_tmp79F)));
...
{struct Cyc_Absyn_Exp*_tmp7A0[2];struct _tuple22 _stmttmp28=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,(
(_tmp7A0[1]=_tmp1AF,((_tmp7A0[0]=_tmp1AE,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(temp,_tag_dyneither(_tmp7A0,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,1);
# 1394
...
const char*_tmp7A3;void*_tmp7A2;(_tmp7A2=0,Cyc_CfFlowInfo_aerr(_tmp1AF->loc,((_tmp7A3="expression may not be initialized",_tag_dyneither(_tmp7A3,sizeof(char),34))),_tag_dyneither(_tmp7A2,sizeof(void*),0)));}{
...
struct _tuple15 _tmp7A4;struct _tuple15 _tmp309=(_tmp7A4.f1=_tmp2F6,((_tmp7A4.f2=*((void**)_check_dyneither_subscript(_tmp307,sizeof(void*),(int)i)),_tmp7A4)));_npop_handler(0);return _tmp309;}_LL1E1:;_LL1E2: {
struct Cyc_Core_Impossible_exn_struct _tmp7AA;const char*_tmp7A9;struct Cyc_Core_Impossible_exn_struct*_tmp7A8;(int)_throw((void*)((_tmp7A8=_cycalloc(sizeof(*_tmp7A8)),((_tmp7A8[0]=((_tmp7AA.tag=Cyc_Core_Impossible,((_tmp7AA.f1=((_tmp7A9="anal_Rexp: Subscript",_tag_dyneither(_tmp7A9,sizeof(char),21))),_tmp7AA)))),_tmp7A8)))));}_LL1DC:;}_LL1D8: {struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp300=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp2FD;if(_tmp300->tag != 5)goto _LL1DA;else{_tmp301=((_tmp300->f1).ptr_atts).bounds;}}_LL1D9: {
# 1422
...
struct _tuple15 _tmp7AB;struct _tuple15 _tmp312=(_tmp7AB.f1=_tmp30E,((_tmp7AB.f2=_tmp30F,_tmp7AB)));_npop_handler(0);return _tmp312;}_LL1E6:;_LL1E7: {
struct _tuple15 _tmp7AC;struct _tuple15 _tmp314=(_tmp7AC.f1=_tmp2F6,((_tmp7AC.f2=_tmp30F,_tmp7AC)));_npop_handler(0);return _tmp314;}_LL1E3:;};}_LL1DA:;_LL1DB: {
# 1427
struct Cyc_Core_Impossible_exn_struct _tmp7B2;const char*_tmp7B1;struct Cyc_Core_Impossible_exn_struct*_tmp7B0;(int)_throw((void*)((_tmp7B0=_cycalloc(sizeof(*_tmp7B0)),((_tmp7B0[0]=((_tmp7B2.tag=Cyc_Core_Impossible,((_tmp7B2.f1=((_tmp7B1="anal_Rexp: Subscript -- bad type",_tag_dyneither(_tmp7B1,sizeof(char),33))),_tmp7B2)))),_tmp7B0)))));}_LL1D5:;};};}
# 1394
...
unsigned int _tmp7B8;unsigned int _tmp7B7;struct _dyneither_ptr _tmp7B6;void**_tmp7B5;unsigned int _tmp7B4;struct _dyneither_ptr aggrdict=
(_tmp7B4=(unsigned int)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp1B4),((_tmp7B5=(void**)_region_malloc(env->r,_check_times(sizeof(void*),_tmp7B4)),((_tmp7B6=_tag_dyneither(_tmp7B5,sizeof(void*),_tmp7B4),((((_tmp7B7=_tmp7B4,_tmp7B9(& _tmp7B8,& _tmp7B7,& _tmp7B5,& _tmp31C))),_tmp7B6)))))));
# 1442
struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp7C3;struct Cyc_CfFlowInfo_UnionRInfo _tmp7C2;struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct _tmp7C1;struct _tuple15 _tmp7C0;struct _tuple15 _tmp321=(_tmp7C0.f1=_tmp31B,((_tmp7C0.f2=(void*)((_tmp7C3=_region_malloc(env->r,sizeof(*_tmp7C3)),((_tmp7C3[0]=((_tmp7C1.tag=6,((_tmp7C1.f1=((_tmp7C2.is_union=0,((_tmp7C2.fieldnum=- 1,_tmp7C2)))),((_tmp7C1.f2=aggrdict,_tmp7C1)))))),_tmp7C3)))),_tmp7C0)));_npop_handler(0);return _tmp321;};}
# 1435
...
struct Cyc_Core_Impossible_exn_struct _tmp7C9;const char*_tmp7C8;struct Cyc_Core_Impossible_exn_struct*_tmp7C7;(int)_throw((void*)((_tmp7C7=_cycalloc(sizeof(*_tmp7C7)),((_tmp7C7[0]=((_tmp7C9.tag=Cyc_Core_Impossible,((_tmp7C9.f1=((_tmp7C8="anal_Rexp:anon struct has bad type",_tag_dyneither(_tmp7C8,sizeof(char),35))),_tmp7C9)))),_tmp7C7)))));}_LL1E8:;}
# 1450
...
struct Cyc_Core_Impossible_exn_struct _tmp7CF;const char*_tmp7CE;struct Cyc_Core_Impossible_exn_struct*_tmp7CD;(int)_throw((void*)((_tmp7CD=_cycalloc(sizeof(*_tmp7CD)),((_tmp7CD[0]=((_tmp7CF.tag=Cyc_Core_Impossible,((_tmp7CF.f1=((_tmp7CE="anal_Rexp:Aggregate_e",_tag_dyneither(_tmp7CE,sizeof(char),22))),_tmp7CF)))),_tmp7CD)))));}_LL1F0: {struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_tmp333=(struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp331;if(_tmp333->tag != 1)goto _LL1ED;else{_tmp334=_tmp333->f1;}}_LL1F1:
# 1466
...
# 1476
struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct _tmp7D5;struct Cyc_CfFlowInfo_UnionRInfo _tmp7D4;struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp7D3;struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp339=(_tmp7D3=_region_malloc(env->r,sizeof(*_tmp7D3)),((_tmp7D3[0]=((_tmp7D5.tag=6,((_tmp7D5.f1=((_tmp7D4.is_union=_tmp1B9 == Cyc_Absyn_UnionA,((_tmp7D4.fieldnum=field_no,_tmp7D4)))),((_tmp7D5.f2=aggrdict,_tmp7D5)))))),_tmp7D3)));
struct _tuple15 _tmp7D6;struct _tuple15 _tmp33B=(_tmp7D6.f1=_tmp32F,((_tmp7D6.f2=(void*)_tmp339,_tmp7D6)));_npop_handler(0);return _tmp33B;};};}
# 1454
...
# 1480
struct Cyc_Core_Impossible_exn_struct _tmp7DC;const char*_tmp7DB;struct Cyc_Core_Impossible_exn_struct*_tmp7DA;(int)_throw((void*)((_tmp7DA=_cycalloc(sizeof(*_tmp7DA)),((_tmp7DA[0]=((_tmp7DC.tag=Cyc_Core_Impossible,((_tmp7DC.f1=((_tmp7DB="anal_Rexp:missing aggrdeclimpl",_tag_dyneither(_tmp7DB,sizeof(char),31))),_tmp7DC)))),_tmp7DA)))));}_LL150: {struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_tmp1BC=(struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp1BC->tag != 25)goto _LL152;else{_tmp1BD=_tmp1BC->f1;}}_LL151: {
# 1482
...
struct _tuple15 _tmp7DD;struct _tuple15 _tmp348=(_tmp7DD.f1=_tmp345,((_tmp7DD.f2=Cyc_CfFlowInfo_typ_to_absrval(_tmp142,(void*)_check_null(e->topt),0,_tmp142->unknown_all),_tmp7DD)));_npop_handler(0);return _tmp348;};}
# 1483
...
struct _tuple15 _tmp7DE;return(_tmp7DE.f1=_tmp34A,((_tmp7DE.f2=_tmp142->unknown_all,_tmp7DE)));}_LL1F5: if((_tmp34C.ReachableFL).tag != 2)goto _LL1F2;_tmp34D=((struct _tuple14)(_tmp34C.ReachableFL).val).f1;_tmp34E=((struct _tuple14)(_tmp34C.ReachableFL).val).f2;_LL1F6:
# 1495
 if(Cyc_CfFlowInfo_initlevel(env->fenv,_tmp34D,_tmp34B)== Cyc_CfFlowInfo_NoneIL){
const char*_tmp7E1;void*_tmp7E0;(_tmp7E0=0,Cyc_CfFlowInfo_aerr(_tmp1C0->loc,((_tmp7E1="expression may not be initialized",_tag_dyneither(_tmp7E1,sizeof(char),34))),_tag_dyneither(_tmp7E0,sizeof(void*),0)));}{
# 1499
...
struct _tuple15 _tmp7E2;return(_tmp7E2.f1=_tmp34A,((_tmp7E2.f2=_tmp142->unknown_all,_tmp7E2)));}_LL1FA: {struct Cyc_CfFlowInfo_NotZeroThis_CfFlowInfo_AbsRVal_struct*_tmp354=(struct Cyc_CfFlowInfo_NotZeroThis_CfFlowInfo_AbsRVal_struct*)_tmp352;if(_tmp354->tag != 2)goto _LL1FC;}_LL1FB:
...
# 1514
struct Cyc_List_List _tmp7E3;struct Cyc_List_List _tmp358=(_tmp7E3.hd=_tmp1BF,((_tmp7E3.tl=0,_tmp7E3)));
...
struct _tuple15 _tmp7E4;return(_tmp7E4.f1=_tmp35A,((_tmp7E4.f2=_tmp142->unknown_all,_tmp7E4)));}_LL205: if((_tmp35C.ReachableFL).tag != 2)goto _LL202;_tmp35D=((struct _tuple14)(_tmp35C.ReachableFL).val).f1;_LL206:
# 1521
 if(Cyc_CfFlowInfo_initlevel(_tmp142,_tmp35D,_tmp35B)!= Cyc_CfFlowInfo_AllIL){
{const char*_tmp7E7;void*_tmp7E6;(_tmp7E6=0,Cyc_CfFlowInfo_aerr(_tmp1C0->loc,((_tmp7E7="expression may not be initialized",_tag_dyneither(_tmp7E7,sizeof(char),34))),_tag_dyneither(_tmp7E6,sizeof(void*),0)));}{
struct _tuple15 _tmp7E8;return(_tmp7E8.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7E8.f2=_tmp142->unknown_all,_tmp7E8)));};}_LL202:;}
# 1526
_tmp34A=_tmp35A;
goto _LL201;};}_LL200:;_LL201:
# 1529
 while(1){
struct Cyc_List_List _tmp7E9;struct Cyc_List_List _tmp363=(_tmp7E9.hd=_tmp1BF,((_tmp7E9.tl=0,_tmp7E9)));
...
{const char*_tmp7EC;void*_tmp7EB;(_tmp7EB=0,Cyc_CfFlowInfo_aerr(_tmp1C0->loc,((_tmp7EC="expression may not be initialized",_tag_dyneither(_tmp7EC,sizeof(char),34))),_tag_dyneither(_tmp7EB,sizeof(void*),0)));}{
struct _tuple15 _tmp7ED;return(_tmp7ED.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp7ED.f2=_tmp142->unknown_all,_tmp7ED)));};}_LL207:;}{
# 1541
...
_tmp34A=_tmp36C;};};}{
# 1546
struct _tuple15 _tmp7EE;return(_tmp7EE.f1=_tmp34A,((_tmp7EE.f2=_tmp142->unknown_all,_tmp7EE)));};_LL1F7:;};};_LL1F2:;};}_LL154: {struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*_tmp1C3=(struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp1C3->tag != 27)goto _LL156;else{_tmp1C4=_tmp1C3->f1;_tmp1C5=(void*)_tmp1C3->f2;_tmp1C6=_tmp1C3->f3;}}_LL155: {
# 1552
struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct _tmp7F1;struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_tmp7F0;void*root=(void*)((_tmp7F0=_region_malloc(_tmp142->r,sizeof(*_tmp7F0)),((_tmp7F0[0]=((_tmp7F1.tag=1,((_tmp7F1.f1=_tmp1C4,((_tmp7F1.f2=(void*)_check_null(e->topt),_tmp7F1)))))),_tmp7F0))));
struct Cyc_CfFlowInfo_Place*_tmp7F2;struct Cyc_CfFlowInfo_Place*place=(_tmp7F2=_region_malloc(_tmp142->r,sizeof(*_tmp7F2)),((_tmp7F2->root=root,((_tmp7F2->fields=0,_tmp7F2)))));
struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp7F5;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp7F4;void*rval=(void*)((_tmp7F4=_region_malloc(_tmp142->r,sizeof(*_tmp7F4)),((_tmp7F4[0]=((_tmp7F5.tag=5,((_tmp7F5.f1=place,_tmp7F5)))),_tmp7F4))));
void*place_val;
# 1560
...
struct _tuple15 _tmp7F6;return(_tmp7F6.f1=outflow,((_tmp7F6.f2=rval,_tmp7F6)));}_LL20F: if((_tmp371.ReachableFL).tag != 2)goto _LL20C;_tmp372=((struct _tuple14)(_tmp371.ReachableFL).val).f1;_tmp373=((struct _tuple14)(_tmp371.ReachableFL).val).f2;_LL210: {
# 1568
struct _tuple15 _tmp7F7;return(_tmp7F7.f1=Cyc_CfFlowInfo_ReachableFL(((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp372,root,place_val),_tmp373),((_tmp7F7.f2=rval,_tmp7F7)));}_LL20C:;};};};}_LL156: {struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_tmp1C7=(struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp1C7->tag != 36)goto _LL158;else{_tmp1C8=_tmp1C7->f1;}}_LL157: {
# 1572
struct _tuple16 _tmp7F8;struct _tuple16 _tmp37B=(_tmp7F8.f1=(env->fenv)->unknown_all,((_tmp7F8.f2=copy_ctxt,_tmp7F8)));
union Cyc_CfFlowInfo_FlowInfo _tmp37C=Cyc_NewControlFlow_anal_stmt(env,inflow,_tmp1C8,& _tmp37B);
struct _tuple15 _tmp7F9;return(_tmp7F9.f1=_tmp37C,((_tmp7F9.f2=_tmp37B.f1,_tmp7F9)));}_LL158: {struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp1C9=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp157;if(_tmp1C9->tag != 1)goto _LL15A;else{struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*_tmp1CA=(struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*)((void*)_tmp1C9->f2);if(_tmp1CA->tag != 0)goto _LL15A;}}_LL159:
# 1576
...
# 1581
struct Cyc_Core_Impossible_exn_struct _tmp7FF;const char*_tmp7FE;struct Cyc_Core_Impossible_exn_struct*_tmp7FD;(int)_throw((void*)((_tmp7FD=_cycalloc(sizeof(*_tmp7FD)),((_tmp7FD[0]=((_tmp7FF.tag=Cyc_Core_Impossible,((_tmp7FF.f1=((_tmp7FE="anal_Rexp, unexpected exp form",_tag_dyneither(_tmp7FE,sizeof(char),31))),_tmp7FF)))),_tmp7FD)))));}_LLF9:;};}
# 1591
...
struct _tuple17 _tmp800;return(_tmp800.f1=f,((_tmp800.f2=Cyc_CfFlowInfo_UnknownL(),_tmp800)));}_LL219: if((_tmp388.ReachableFL).tag != 2)goto _LL216;_tmp389=((struct _tuple14)(_tmp388.ReachableFL).val).f1;_tmp38A=((struct _tuple14)(_tmp388.ReachableFL).val).f2;_LL21A: {
# 1606
struct Cyc_Absyn_Vardecl*locname=0;
...
# 1612
{struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct _tmp803;struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp802;e->annot=(void*)((_tmp802=_cycalloc(sizeof(*_tmp802)),((_tmp802[0]=((_tmp803.tag=Cyc_CfFlowInfo_NotZero,((_tmp803.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmp38A),_tmp803)))),_tmp802))));}goto _LL21B;_LL222: {struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp392=(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp38C;if(_tmp392->tag != 5)goto _LL224;else{_tmp393=(_tmp392->f1)->root;_tmp394=(_tmp392->f1)->fields;}}_LL223:
# 1614
{struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct _tmp806;struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*_tmp805;e->annot=(void*)((_tmp805=_cycalloc(sizeof(*_tmp805)),((_tmp805[0]=((_tmp806.tag=Cyc_CfFlowInfo_NotZero,((_tmp806.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmp38A),_tmp806)))),_tmp805))));}{
struct Cyc_CfFlowInfo_Place*_tmp809;struct _tuple17 _tmp808;return(_tmp808.f1=f,((_tmp808.f2=Cyc_CfFlowInfo_PlaceL(((_tmp809=_region_malloc(_tmp382->r,sizeof(*_tmp809)),((_tmp809->root=_tmp393,((_tmp809->fields=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rappend)(_tmp382->r,_tmp394,flds),_tmp809))))))),_tmp808)));};_LL224: {struct Cyc_CfFlowInfo_Zero_CfFlowInfo_AbsRVal_struct*_tmp395=(struct Cyc_CfFlowInfo_Zero_CfFlowInfo_AbsRVal_struct*)_tmp38C;if(_tmp395->tag != 0)goto _LL226;}_LL225:
# 1617
 e->annot=(void*)& Cyc_CfFlowInfo_IsZero_val;{
struct _tuple17 _tmp80A;return(_tmp80A.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp80A.f2=Cyc_CfFlowInfo_UnknownL(),_tmp80A)));};_LL226: {struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*_tmp396=(struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp38C;if(_tmp396->tag != 3)goto _LL228;else{_tmp397=_tmp396->f1;}}_LL227:
...
void*_tmp39F=r;void*_tmp3A1;_LL22B: {struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*_tmp3A0=(struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp39F;if(_tmp3A0->tag != 7)goto _LL22D;else{_tmp3A1=(void*)_tmp3A0->f3;}}_LL22C:
 ...
 goto _LL22A;_LL22A:;}{
# 1628
struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp80D;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp80C;e->annot=(void*)((_tmp80C=_cycalloc(sizeof(*_tmp80C)),((_tmp80C[0]=((_tmp80D.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp80D.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmp38A),_tmp80D)))),_tmp80C))));};_LL21B:;}}else{
# 1631
struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct _tmp810;struct Cyc_CfFlowInfo_UnknownZ_Absyn_AbsynAnnot_struct*_tmp80F;e->annot=(void*)((_tmp80F=_cycalloc(sizeof(*_tmp80F)),((_tmp80F[0]=((_tmp810.tag=Cyc_CfFlowInfo_UnknownZ,((_tmp810.f1=Cyc_Relations_copy_relns(Cyc_Core_heap_region,_tmp38A),_tmp810)))),_tmp80F))));}
if(Cyc_CfFlowInfo_initlevel(_tmp382,_tmp389,r)== Cyc_CfFlowInfo_NoneIL){
const char*_tmp813;void*_tmp812;(_tmp812=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp813="dereference of possibly uninitialized pointer",_tag_dyneither(_tmp813,sizeof(char),46))),_tag_dyneither(_tmp812,sizeof(void*),0)));}{
struct _tuple17 _tmp814;return(_tmp814.f1=f,((_tmp814.f2=Cyc_CfFlowInfo_UnknownL(),_tmp814)));};}_LL216:;}_LL214:;_LL215: {
# 1636
struct Cyc_Core_Impossible_exn_struct _tmp81A;const char*_tmp819;struct Cyc_Core_Impossible_exn_struct*_tmp818;(int)_throw((void*)((_tmp818=_cycalloc(sizeof(*_tmp818)),((_tmp818[0]=((_tmp81A.tag=Cyc_Core_Impossible,((_tmp81A.f1=((_tmp819="left deref of non-pointer-type",_tag_dyneither(_tmp819,sizeof(char),31))),_tmp81A)))),_tmp818)))));}_LL211:;}
# 1644
...
struct _tuple17 _tmp81B;return(_tmp81B.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp81B.f2=Cyc_CfFlowInfo_UnknownL(),_tmp81B)));}_LL232: if((_tmp3AD.ReachableFL).tag != 2)goto _LL22F;_tmp3AE=((struct _tuple14)(_tmp3AD.ReachableFL).val).f1;_tmp3AF=((struct _tuple14)(_tmp3AD.ReachableFL).val).f2;_LL233:
# 1652
 d=_tmp3AE;_LL22F:;}{
# 1656
...
# 1664
struct Cyc_CfFlowInfo_Place*_tmp825;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp824;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp823;struct _tuple17 _tmp822;return(_tmp822.f1=inflow,((_tmp822.f2=Cyc_CfFlowInfo_PlaceL(((_tmp825=_region_malloc(env->r,sizeof(*_tmp825)),((_tmp825->root=(void*)((_tmp823=_region_malloc(env->r,sizeof(*_tmp823)),((_tmp823[0]=((_tmp824.tag=0,((_tmp824.f1=_tmp3C0,_tmp824)))),_tmp823)))),((_tmp825->fields=flds,_tmp825))))))),_tmp822)));}_LL241: {struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp3C1=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp3B1;if(_tmp3C1->tag != 1)goto _LL243;else{struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp3C2=(struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((void*)_tmp3C1->f2);if(_tmp3C2->tag != 1)goto _LL243;else{_tmp3C3=_tmp3C2->f1;}}}_LL242: {
# 1666
struct _tuple17 _tmp826;return(_tmp826.f1=inflow,((_tmp826.f2=Cyc_CfFlowInfo_UnknownL(),_tmp826)));}_LL243: {struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp3C4=(struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp3B1;if(_tmp3C4->tag != 21)goto _LL245;else{_tmp3C5=_tmp3C4->f1;_tmp3C6=_tmp3C4->f2;}}_LL244:
# 1669
...
struct Cyc_List_List*_tmp827;flds=((_tmp827=_region_malloc(env->r,sizeof(*_tmp827)),((_tmp827->hd=(void*)Cyc_CfFlowInfo_get_field_index(_tmp3D6,_tmp3C6),((_tmp827->tl=flds,_tmp827))))));};}
# 1675
goto _LL24D;_LL250:;_LL251: {
struct Cyc_Core_Impossible_exn_struct _tmp82D;const char*_tmp82C;struct Cyc_Core_Impossible_exn_struct*_tmp82B;(int)_throw((void*)((_tmp82B=_cycalloc(sizeof(*_tmp82B)),((_tmp82B[0]=((_tmp82D.tag=Cyc_Core_Impossible,((_tmp82D.f1=((_tmp82C="anal_Lexp: AggrArrow ptr",_tag_dyneither(_tmp82C,sizeof(char),25))),_tmp82D)))),_tmp82B)))));}_LL24D:;}
# 1678
...
# 1687
struct _tuple17 _tmp82E;struct _tuple17 _stmttmp57=(_tmp82E.f1=_tmp3DC,((_tmp82E.f2=_tmp3DD,_tmp82E)));struct _tuple17 _tmp3DE=_stmttmp57;struct Cyc_Dict_Dict _tmp3DF;struct Cyc_List_List*_tmp3E0;struct Cyc_CfFlowInfo_Place*_tmp3E1;_LL253: if(((_tmp3DE.f1).ReachableFL).tag != 2)goto _LL255;_tmp3DF=((struct _tuple14)((_tmp3DE.f1).ReachableFL).val).f1;_tmp3E0=((struct _tuple14)((_tmp3DE.f1).ReachableFL).val).f2;if(((_tmp3DE.f2).PlaceL).tag != 1)goto _LL255;_tmp3E1=(struct Cyc_CfFlowInfo_Place*)((_tmp3DE.f2).PlaceL).val;_LL254: {
# 1689
...
struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct _tmp831;struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*_tmp830;void*new_root=(void*)((_tmp830=_region_malloc(_tmp3AC->r,sizeof(*_tmp830)),((_tmp830[0]=((_tmp831.tag=1,((_tmp831.f1=e,((_tmp831.f2=(void*)_check_null(e->topt),_tmp831)))))),_tmp830))));
struct Cyc_CfFlowInfo_Place*_tmp832;struct Cyc_CfFlowInfo_Place*place=(_tmp832=_region_malloc(_tmp3AC->r,sizeof(*_tmp832)),((_tmp832->root=new_root,((_tmp832->fields=0,_tmp832)))));
struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp835;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp834;void*res=(void*)((_tmp834=_region_malloc(_tmp3AC->r,sizeof(*_tmp834)),((_tmp834[0]=((_tmp835.tag=5,((_tmp835.f1=place,_tmp835)))),_tmp834))));
if(locname != 0){
struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp838;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp837;res=(void*)((_tmp837=_region_malloc(_tmp3AC->r,sizeof(*_tmp837)),((_tmp837[0]=((_tmp838.tag=8,((_tmp838.f1=locname,((_tmp838.f2=res,_tmp838)))))),_tmp837))));}
((int(*)(struct Cyc_Dict_Dict*set,struct Cyc_CfFlowInfo_Place*place,unsigned int loc))Cyc_CfFlowInfo_update_place_set)(env->all_changed,place,0);
...
struct Cyc_List_List*_tmp839;return Cyc_NewControlFlow_anal_Lexp_rec(env,inflow,expand_unique,passthrough_consumes,_tmp3CA,((_tmp839=_region_malloc(env->r,sizeof(*_tmp839)),((_tmp839->hd=(void*)((int)_tmp3FA),((_tmp839->tl=flds,_tmp839)))))));}_LL263: {struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp3F8=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp3F6;if(_tmp3F8->tag != 5)goto _LL265;else{_tmp3F9=((_tmp3F8->f1).ptr_atts).bounds;}}_LL264: {
# 1730
struct _RegionHandle _tmp3FC=_new_region("temp");struct _RegionHandle*temp=& _tmp3FC;_push_region(temp);
{struct Cyc_Absyn_Exp*_tmp83A[2];struct _tuple22 _stmttmp54=Cyc_NewControlFlow_anal_unordered_Rexps(temp,env,inflow,(
(_tmp83A[1]=_tmp3CB,((_tmp83A[0]=_tmp3CA,((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(temp,_tag_dyneither(_tmp83A,sizeof(struct Cyc_Absyn_Exp*),2)))))),0,1);
# 1731
...
const char*_tmp83D;void*_tmp83C;(_tmp83C=0,Cyc_CfFlowInfo_aerr(_tmp3CB->loc,((_tmp83D="expression may not be initialized",_tag_dyneither(_tmp83D,sizeof(char),34))),_tag_dyneither(_tmp83C,sizeof(void*),0)));}{
...
struct _tuple17 _tmp846;return(_tmp846.f1=inflow,((_tmp846.f2=Cyc_CfFlowInfo_UnknownL(),_tmp846)));}{
# 1761
struct Cyc_List_List*_tmp847;return Cyc_NewControlFlow_anal_Lexp_rec(env,inflow,expand_unique,passthrough_consumes,_tmp3CD,(
(_tmp847=_region_malloc(env->r,sizeof(*_tmp847)),((_tmp847->hd=(void*)Cyc_CfFlowInfo_get_field_index(_tmp413,_tmp3CE),((_tmp847->tl=flds,_tmp847)))))));};}_LL24B:;_LL24C: {
# 1764
struct _tuple17 _tmp848;return(_tmp848.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp848.f2=Cyc_CfFlowInfo_UnknownL(),_tmp848)));}_LL234:;};}
# 1768
...
struct _tuple17 _tmp849;return(_tmp849.f1=_tmp418,((_tmp849.f2=_tmp419,_tmp849)));};}
# 1778
static union Cyc_CfFlowInfo_FlowInfo Cyc_NewControlFlow_expand_unique_places(struct Cyc_NewControlFlow_AnalEnv*env,union Cyc_CfFlowInfo_FlowInfo inflow,struct Cyc_List_List*es){
# 1780
{struct Cyc_List_List*x=es;for(0;x != 0;x=x->tl){
...
struct _tuple18 _tmp84A;struct _tuple18 _tmp426=(_tmp84A.f1=f,((_tmp84A.f2=f,_tmp84A)));_npop_handler(0);return _tmp426;}_LL274: if((_tmp422.ReachableFL).tag != 2)goto _LL271;_tmp423=((struct _tuple14)(_tmp422.ReachableFL).val).f1;_tmp424=((struct _tuple14)(_tmp422.ReachableFL).val).f2;_LL275: {
# 1812
...
const char*_tmp84D;void*_tmp84C;(_tmp84C=0,Cyc_CfFlowInfo_aerr(((struct Cyc_Absyn_Exp*)es->hd)->loc,((_tmp84D="expression may not be initialized",_tag_dyneither(_tmp84D,sizeof(char),34))),_tag_dyneither(_tmp84C,sizeof(void*),0)));}
if(Cyc_CfFlowInfo_initlevel(env->fenv,_tmp423,r2)== Cyc_CfFlowInfo_NoneIL){
const char*_tmp850;void*_tmp84F;(_tmp84F=0,Cyc_CfFlowInfo_aerr(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es->tl))->hd)->loc,((_tmp850="expression may not be initialized",_tag_dyneither(_tmp850,sizeof(char),34))),_tag_dyneither(_tmp84F,sizeof(void*),0)));}{
# 1819
...
goto _LL280;_LL293:;_LL294:
 goto _LL280;_LL280:;};}
# 1875
{struct _tuple0 _tmp85E;struct _tuple0 _stmttmp60=(_tmp85E.f1=Cyc_Tcutil_compress((void*)_check_null(_tmp427->topt)),((_tmp85E.f2=Cyc_Tcutil_compress((void*)_check_null(_tmp428->topt)),_tmp85E)));struct _tuple0 _tmp459=_stmttmp60;_LL29E: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp45A=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp459.f1;if(_tmp45A->tag != 6)goto _LL2A0;else{if(_tmp45A->f1 != Cyc_Absyn_Unsigned)goto _LL2A0;}}_LL29F:
...
struct _tuple18 _tmp85F;struct _tuple18 _tmp45F=(_tmp85F.f1=_tmp42D,((_tmp85F.f2=_tmp42E,_tmp85F)));_npop_handler(0);return _tmp45F;}_LL29D:;}
# 1884
...
struct _tuple18 _tmp860;struct _tuple18 _tmp462=(_tmp860.f1=_tmp42D,((_tmp860.f2=_tmp42E,_tmp860)));_npop_handler(0);return _tmp462;}}{
# 1889
...
struct _tuple18 _tmp861;struct _tuple18 _stmttmp62=(_tmp861.f1=_tmp42D,((_tmp861.f2=_tmp42E,_tmp861)));struct _tuple18 _tmp46A=_stmttmp62;struct Cyc_Dict_Dict _tmp46B;struct Cyc_Dict_Dict _tmp46C;struct Cyc_Dict_Dict _tmp46D;struct Cyc_Dict_Dict _tmp46E;_LL2B1: if(((_tmp46A.f1).ReachableFL).tag != 2)goto _LL2B3;_tmp46B=((struct _tuple14)((_tmp46A.f1).ReachableFL).val).f1;if(((_tmp46A.f2).ReachableFL).tag != 2)goto _LL2B3;_tmp46C=((struct _tuple14)((_tmp46A.f2).ReachableFL).val).f1;_LL2B2: {
# 1903
struct _tuple18 _tmp862;struct _tuple18 _tmp470=(_tmp862.f1=Cyc_CfFlowInfo_ReachableFL(_tmp46B,_tmp468),((_tmp862.f2=Cyc_CfFlowInfo_ReachableFL(_tmp46C,_tmp469),_tmp862)));_npop_handler(0);return _tmp470;}_LL2B3: if(((_tmp46A.f2).ReachableFL).tag != 2)goto _LL2B5;_tmp46D=((struct _tuple14)((_tmp46A.f2).ReachableFL).val).f1;_LL2B4: {
# 1905
struct _tuple18 _tmp863;struct _tuple18 _tmp472=(_tmp863.f1=_tmp42D,((_tmp863.f2=Cyc_CfFlowInfo_ReachableFL(_tmp46D,_tmp469),_tmp863)));_npop_handler(0);return _tmp472;}_LL2B5: if(((_tmp46A.f1).ReachableFL).tag != 2)goto _LL2B7;_tmp46E=((struct _tuple14)((_tmp46A.f1).ReachableFL).val).f1;_LL2B6: {
# 1907
struct _tuple18 _tmp864;struct _tuple18 _tmp474=(_tmp864.f1=Cyc_CfFlowInfo_ReachableFL(_tmp46E,_tmp468),((_tmp864.f2=_tmp42E,_tmp864)));_npop_handler(0);return _tmp474;}_LL2B7:;_LL2B8: {
# 1909
struct _tuple18 _tmp865;struct _tuple18 _tmp476=(_tmp865.f1=_tmp42D,((_tmp865.f2=_tmp42E,_tmp865)));_npop_handler(0);return _tmp476;}_LL2B0:;}else{
# 1912
struct _tuple18 _tmp866;struct _tuple18 _tmp479=(_tmp866.f1=_tmp42D,((_tmp866.f2=_tmp42E,_tmp866)));_npop_handler(0);return _tmp479;}};};};}_LL271:;};
# 1801
;_pop_region(temp);}
# 1918
...
struct _tuple18 _tmp867;return(_tmp867.f1=Cyc_CfFlowInfo_join_flow(_tmp47A,env->all_changed,_tmp492,_tmp495),((_tmp867.f2=
Cyc_CfFlowInfo_join_flow(_tmp47A,env->all_changed,_tmp493,_tmp496),_tmp867)));};};};}_LL2BC: {struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_tmp480=(struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp47B;if(_tmp480->tag != 6)goto _LL2BE;else{_tmp481=_tmp480->f1;_tmp482=_tmp480->f2;}}_LL2BD: {
# 1929
...
struct _tuple18 _tmp868;return(_tmp868.f1=_tmp49C,((_tmp868.f2=Cyc_CfFlowInfo_join_flow(_tmp47A,env->all_changed,_tmp49A,_tmp49D),_tmp868)));};};}_LL2BE: {struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_tmp483=(struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp47B;if(_tmp483->tag != 7)goto _LL2C0;else{_tmp484=_tmp483->f1;_tmp485=_tmp483->f2;}}_LL2BF: {
# 1933
...
struct _tuple18 _tmp869;return(_tmp869.f1=Cyc_CfFlowInfo_join_flow(_tmp47A,env->all_changed,_tmp4A0,_tmp4A3),((_tmp869.f2=_tmp4A4,_tmp869)));};};}_LL2C0: {struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_tmp486=(struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp47B;if(_tmp486->tag != 8)goto _LL2C2;else{_tmp487=_tmp486->f1;_tmp488=_tmp486->f2;}}_LL2C1: {
# 1937
...
struct _tuple18 _tmp86A;return(_tmp86A.f1=_tmp4AB,((_tmp86A.f2=_tmp4AA,_tmp86A)));};}_LL2C4: {struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp48B=(struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp47B;if(_tmp48B->tag != 2)goto _LL2C6;else{_tmp48C=_tmp48B->f1;_tmp48D=_tmp48B->f2;}}_LL2C5:
# 1943
...
struct _tuple18 _tmp86B;return(_tmp86B.f1=_tmp4AE,((_tmp86B.f2=_tmp4AE,_tmp86B)));}_LL2CB: if((_tmp4B0.ReachableFL).tag != 2)goto _LL2C8;_tmp4B1=((struct _tuple14)(_tmp4B0.ReachableFL).val).f1;_LL2CC: {
# 1951
struct Cyc_Absyn_Vardecl*locname=0;
...
struct _tuple18 _tmp86C;return(_tmp86C.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp86C.f2=_tmp4AE,_tmp86C)));}_LL2D2: {struct Cyc_CfFlowInfo_NotZeroThis_CfFlowInfo_AbsRVal_struct*_tmp4B8=(struct Cyc_CfFlowInfo_NotZeroThis_CfFlowInfo_AbsRVal_struct*)_tmp4B3;if(_tmp4B8->tag != 2)goto _LL2D4;}_LL2D3:
...
# 1961
{const char*_tmp870;void*_tmp86F;(_tmp86F=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp870="expression may not be initialized",_tag_dyneither(_tmp870,sizeof(char),34))),_tag_dyneither(_tmp86F,sizeof(void*),0)));}{
struct _tuple18 _tmp871;return(_tmp871.f1=Cyc_CfFlowInfo_BottomFL(),((_tmp871.f2=Cyc_CfFlowInfo_BottomFL(),_tmp871)));};_LL2DE: {struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*_tmp4BE=(struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp4B3;if(_tmp4BE->tag != 3)goto _LL2E0;else{_tmp4BF=_tmp4BE->f1;}}_LL2DF:
# 1964
...
struct _tuple18 _tmp872;return(_tmp872.f1=_tmp4AE,((_tmp872.f2=_tmp4AE,_tmp872)));}_LL2E2: {struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp4C1=(struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp4B3;if(_tmp4C1->tag != 6)goto _LL2CD;}_LL2E3: {
struct Cyc_Core_Impossible_exn_struct _tmp878;const char*_tmp877;struct Cyc_Core_Impossible_exn_struct*_tmp876;(int)_throw((void*)((_tmp876=_cycalloc(sizeof(*_tmp876)),((_tmp876[0]=((_tmp878.tag=Cyc_Core_Impossible,((_tmp878.f1=((_tmp877="anal_test",_tag_dyneither(_tmp877,sizeof(char),10))),_tmp878)))),_tmp876)))));}_LL2CD:;}}_LL2C8:;};}_LL2B9:;}struct _tuple26{unsigned int f1;struct Cyc_NewControlFlow_AnalEnv*f2;struct Cyc_Dict_Dict f3;};
# 1972
...
# 1986
{const char*_tmp87C;void*_tmp87B[1];struct Cyc_String_pa_PrintArg_struct _tmp87A;(_tmp87A.tag=0,((_tmp87A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp4D1->name)),((_tmp87B[0]=& _tmp87A,Cyc_Tcutil_warn(_tmp4CC,((_tmp87C="unique pointers reachable from %s may become unreachable",_tag_dyneither(_tmp87C,sizeof(char),57))),_tag_dyneither(_tmp87B,sizeof(void*),1)))))));}
goto _LL2E9;_LL2E9:;}
# 1989
...
const char*_tmp87F;void*_tmp87E;(_tmp87E=0,Cyc_CfFlowInfo_aerr(loc,((_tmp87F="function may not initialize all the parameters with attribute 'initializes'",_tag_dyneither(_tmp87F,sizeof(char),76))),_tag_dyneither(_tmp87E,sizeof(void*),0)));}}}
# 2002
if(Cyc_NewControlFlow_warn_lose_unique){
struct _tuple26 _tmp880;struct _tuple26 _tmp4E4=(_tmp880.f1=loc,((_tmp880.f2=env,((_tmp880.f3=_tmp4E0,_tmp880)))));
...
# 2022
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp883;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp882;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp4EB=(_tmp882=_region_malloc(frgn,sizeof(*_tmp882)),((_tmp882[0]=((_tmp883.tag=0,((_tmp883.f1=*_tmp4E9,_tmp883)))),_tmp882)));
struct Cyc_CfFlowInfo_Place*_tmp884;struct Cyc_CfFlowInfo_Place*_tmp4EC=(_tmp884=_region_malloc(frgn,sizeof(*_tmp884)),((_tmp884->root=(void*)_tmp4EB,((_tmp884->fields=0,_tmp884)))));
{struct Cyc_List_List*_tmp885;_tmp4E6=((_tmp885=_region_malloc(frgn,sizeof(*_tmp885)),((_tmp885->hd=_tmp4EC,((_tmp885->tl=_tmp4E6,_tmp885))))));}{
struct Cyc_List_List*_tmp886;_tmp4E7=((_tmp886=_region_malloc(frgn,sizeof(*_tmp886)),((_tmp886->hd=_tmp4EA,((_tmp886->tl=_tmp4E7,_tmp886))))));};}}}{
# 2028
struct _tuple1 _tmp887;return(_tmp887.f1=_tmp4E6,((_tmp887.f2=_tmp4E7,_tmp887)));};}
# 2037
...
{struct _tuple0 _tmp888;struct _tuple0 _stmttmp70=(_tmp888.f1=_tmp4FD,((_tmp888.f2=_tmp4FB,_tmp888)));struct _tuple0 _tmp4FE=_stmttmp70;struct Cyc_Absyn_Vardecl*_tmp500;struct Cyc_Absyn_Vardecl*_tmp502;void*_tmp503;struct Cyc_Absyn_Vardecl*_tmp505;_LL308:{struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp4FF=(struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*)_tmp4FE.f1;if(_tmp4FF->tag != 0)goto _LL30A;else{_tmp500=_tmp4FF->f1;}}{struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp501=(struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp4FE.f2;if(_tmp501->tag != 8)goto _LL30A;else{_tmp502=_tmp501->f1;_tmp503=(void*)_tmp501->f2;}};_LL309:
# 2067
 if(_tmp500 == _tmp502){
if(Cyc_CfFlowInfo_is_unique_consumed(_tmp4F5,_tmp4F7,_tmp503,& _tmp4F6)){
if(!_tmp4F4){
const char*_tmp88C;void*_tmp88B[1];struct Cyc_String_pa_PrintArg_struct _tmp88A;(_tmp88A.tag=0,((_tmp88A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 2072
Cyc_Absynpp_qvar2string(_tmp500->name)),((_tmp88B[0]=& _tmp88A,Cyc_CfFlowInfo_aerr(loc,((_tmp88C="function consumes parameter %s with attribute 'noconsume'",_tag_dyneither(_tmp88C,sizeof(char),58))),_tag_dyneither(_tmp88B,sizeof(void*),1)))))));}}else{
# 2074
if(Cyc_CfFlowInfo_initlevel(env->fenv,_tmp4FA,_tmp503)!= Cyc_CfFlowInfo_AllIL  && !_tmp4F4){
const char*_tmp890;void*_tmp88F[1];struct Cyc_String_pa_PrintArg_struct _tmp88E;(_tmp88E.tag=0,((_tmp88E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 2077
Cyc_Absynpp_qvar2string(_tmp500->name)),((_tmp88F[0]=& _tmp88E,Cyc_CfFlowInfo_aerr(loc,((_tmp890="function consumes value pointed to by parameter %s, which has attribute 'noconsume'",_tag_dyneither(_tmp890,sizeof(char),84))),_tag_dyneither(_tmp88F,sizeof(void*),1)))))));}else{
# 2079
if(_tmp4F4){
# 2085
...
# 2097
struct _tuple15 _tmp892;struct _tuple15 _tmp891;struct _tuple15 _stmttmp72=
Cyc_CfFlowInfo_join_flow_and_rval(env->fenv,env->all_changed,(
# 2100
(_tmp891.f1=_tmp50D,((_tmp891.f2=_tmp511,_tmp891)))),(
(_tmp892.f1=_tmp50D,((_tmp892.f2=_tmp503,_tmp892)))));
# 2097
...
# 2110
const char*_tmp895;void*_tmp894;(_tmp894=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp895="unconsume_params: joined flow became bot!",_tag_dyneither(_tmp895,sizeof(char),42))),_tag_dyneither(_tmp894,sizeof(void*),0)));}_LL313:;}
# 2112
...
# 2124
 if(!_tmp4F4){
const char*_tmp899;void*_tmp898[1];struct Cyc_String_pa_PrintArg_struct _tmp897;(_tmp897.tag=0,((_tmp897.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 2127
Cyc_Absynpp_qvar2string(_tmp505->name)),((_tmp898[0]=& _tmp897,Cyc_CfFlowInfo_aerr(loc,((_tmp899="function parameter %s with attribute 'noconsume' no longer set to its original value",_tag_dyneither(_tmp899,sizeof(char),85))),_tag_dyneither(_tmp898,sizeof(void*),1)))))));}
goto _LL307;_LL30C:;_LL30D: {
# 2130
const char*_tmp89C;void*_tmp89B;(_tmp89B=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp89C="unconsume_params: root is not a varroot",_tag_dyneither(_tmp89C,sizeof(char),40))),_tag_dyneither(_tmp89B,sizeof(void*),0)));}_LL307:;}
# 2132
goto _LL302;}_LL305: if((_tmp4F9.BottomFL).tag != 1)goto _LL302;_LL306: {
# 2134
const char*_tmp89F;void*_tmp89E;(_tmp89E=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp89F="unconsume_params: flow became Bottom!",_tag_dyneither(_tmp89F,sizeof(char),38))),_tag_dyneither(_tmp89E,sizeof(void*),0)));}_LL302:;}}
# 2137
...
{struct _tuple27*_tmp8A2;struct Cyc_List_List*_tmp8A1;env->unique_pat_vars=(
(_tmp8A1=_region_malloc(env->r,sizeof(*_tmp8A1)),((_tmp8A1->hd=((_tmp8A2=_region_malloc(env->r,sizeof(*_tmp8A2)),((_tmp8A2->f1=_tmp528,((_tmp8A2->f2=_tmp52B,((_tmp8A2->f3=_tmp52C,_tmp8A2)))))))),((_tmp8A1->tl=_tmp52D,_tmp8A1))))));}
# 2156
if(_tmp527 != 0){
...
const char*_tmp8A5;void*_tmp8A4;(_tmp8A4=0,Cyc_CfFlowInfo_aerr(_tmp528->loc,((_tmp8A5="switch clause may implicitly fallthru",_tag_dyneither(_tmp8A5,sizeof(char),38))),_tag_dyneither(_tmp8A4,sizeof(void*),0)));}else{
# 2179
const char*_tmp8A8;void*_tmp8A7;(_tmp8A7=0,Cyc_Tcutil_warn(_tmp528->loc,((_tmp8A8="switch clause may implicitly fallthru",_tag_dyneither(_tmp8A8,sizeof(char),38))),_tag_dyneither(_tmp8A7,sizeof(void*),0)));}
# 2181
...
# 2196
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp8A9;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct vdroot=(_tmp8A9.tag=0,((_tmp8A9.f1=vd,_tmp8A9)));
# 2198
...
# 2207
{const char*_tmp8AD;void*_tmp8AC[1];struct Cyc_String_pa_PrintArg_struct _tmp8AB;(_tmp8AB.tag=0,((_tmp8AB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name)),((_tmp8AC[0]=& _tmp8AB,Cyc_Tcutil_warn(_tmp53B,((_tmp8AD="unique pointers may still exist after variable %s goes out of scope",_tag_dyneither(_tmp8AD,sizeof(char),68))),_tag_dyneither(_tmp8AC,sizeof(void*),1)))))));}
# 2209
goto _LL31D;_LL31D:;}}
# 2214
...
# 2218
struct _tuple28 _tmp8AE;struct _tuple28 _tmp54D=(_tmp8AE.f1=env,((_tmp8AE.f2=_tmp54C,((_tmp8AE.f3=decl->loc,_tmp8AE)))));
...
# 2294
{const char*_tmp8B1;void*_tmp8B0;(_tmp8B0=0,Cyc_Tcutil_warn(s->loc,((_tmp8B1="break may cause function not to return a value",_tag_dyneither(_tmp8B1,sizeof(char),47))),_tag_dyneither(_tmp8B0,sizeof(void*),0)));}
goto _LL36C;_LL373:;_LL374:
# 2297
{const char*_tmp8B4;void*_tmp8B3;(_tmp8B3=0,Cyc_Tcutil_terr(s->loc,((_tmp8B4="break may cause function not to return a value",_tag_dyneither(_tmp8B4,sizeof(char),47))),_tag_dyneither(_tmp8B3,sizeof(void*),0)));}
goto _LL36C;_LL36C:;}
# 2300
...
# 2305
 if(env->noreturn){
const char*_tmp8B7;void*_tmp8B6;(_tmp8B6=0,Cyc_CfFlowInfo_aerr(s->loc,((_tmp8B7="`noreturn' function might return",_tag_dyneither(_tmp8B7,sizeof(char),33))),_tag_dyneither(_tmp8B6,sizeof(void*),0)));}
...
# 2311
 if(env->noreturn){
const char*_tmp8BA;void*_tmp8B9;(_tmp8B9=0,Cyc_CfFlowInfo_aerr(s->loc,((_tmp8BA="`noreturn' function might return",_tag_dyneither(_tmp8BA,sizeof(char),33))),_tag_dyneither(_tmp8B9,sizeof(void*),0)));}{
...
if(_tmp5E3 == _tmp5E1){
{const char*_tmp8BD;void*_tmp8BC;(_tmp8BC=0,Cyc_CfFlowInfo_aerr(s->loc,((_tmp8BD="goto enters local scope or exception handler",_tag_dyneither(_tmp8BD,sizeof(char),45))),_tag_dyneither(_tmp8BC,sizeof(void*),0)));}
break;}
# 2412
_tmp5E1=_tmp5E3;}}
# 2416
...
const char*_tmp8C0;void*_tmp8BF;(_tmp8BF=0,Cyc_CfFlowInfo_aerr(s->loc,((_tmp8C0="last catch clause may implicitly fallthru",_tag_dyneither(_tmp8C0,sizeof(char),42))),_tag_dyneither(_tmp8BF,sizeof(void*),0)));}_LL37A:;}
# 2446
outflow=s1_outflow;
# 2448
...
{struct _tuple27*_tmp8C3;struct Cyc_List_List*_tmp8C2;env->unique_pat_vars=(
(_tmp8C2=_region_malloc(env->r,sizeof(*_tmp8C2)),((_tmp8C2->hd=((_tmp8C3=_region_malloc(env->r,sizeof(*_tmp8C3)),((_tmp8C3->f1=_tmp596,((_tmp8C3->f2=_tmp5EA,((_tmp8C3->f3=_tmp5EB,_tmp8C3)))))))),((_tmp8C2->tl=_tmp5EC,_tmp8C2))))));}
# 2466
...
{struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp8C7;struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp8C6;_tmp5F7=(void*)((_tmp8C6=_region_malloc(_tmp563->r,sizeof(*_tmp8C6)),((_tmp8C6[0]=((_tmp8C7.tag=8,((_tmp8C7.f1=_tmp59A,((_tmp8C7.f2=_tmp5F7,_tmp8C7)))))),_tmp8C6))));}
...
struct Cyc_List_List _tmp8C8;struct Cyc_List_List _tmp5FB=(_tmp8C8.hd=_tmp59A,((_tmp8C8.tl=0,_tmp8C8)));
# 2508
...
# 2522
struct _tuple15 _tmp8CA;struct _tuple15 _tmp8C9;struct _tuple15 _stmttmp81=Cyc_CfFlowInfo_join_flow_and_rval(_tmp563,env->all_changed,(
(_tmp8C9.f1=_tmp5F0,((_tmp8C9.f2=_tmp5F6,_tmp8C9)))),((_tmp8CA.f1=_tmp5F0,((_tmp8CA.f2=_tmp602,_tmp8CA)))));
# 2522
...
# 2527
{const char*_tmp8CD;void*_tmp8CC;(_tmp8CC=0,Cyc_CfFlowInfo_aerr(s->loc,((_tmp8CD="aliased location was overwritten",_tag_dyneither(_tmp8CD,sizeof(char),33))),_tag_dyneither(_tmp8CC,sizeof(void*),0)));}
goto _LL38F;_LL38F:;}
# 2530
...
{const char*_tmp8D0;void*_tmp8CF;(_tmp8CF=0,Cyc_CfFlowInfo_aerr(e->loc,((_tmp8D0="bad alias expression--no unique path found",_tag_dyneither(_tmp8D0,sizeof(char),43))),_tag_dyneither(_tmp8CF,sizeof(void*),0)));}
...
# 2578
struct Cyc_List_List _tmp8DD;struct Cyc_List_List _tmp627=(_tmp8DD.hd=_tmp61D,((_tmp8DD.tl=0,_tmp8DD)));
...
# 2596
struct Cyc_List_List*_tmp8DE;return Cyc_NewControlFlow_add_vars(_tmp61A,inflow,((_tmp8DE=_region_malloc(env->r,sizeof(*_tmp8DE)),((_tmp8DE->hd=_tmp62D,((_tmp8DE->tl=0,_tmp8DE)))))),_tmp61A->unknown_all,decl->loc,0);};_LL3A0: {struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*_tmp622=(struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp61B;if(_tmp622->tag != 4)goto _LL3A2;else{_tmp623=_tmp622->f1;_tmp624=_tmp622->f2;_tmp625=_tmp622->f3;_tmp626=_tmp622->f4;}}_LL3A1:
# 2599
 if(_tmp626 != 0){
...
# 2604
struct Cyc_List_List _tmp8DF;struct Cyc_List_List _tmp633=(_tmp8DF.hd=_tmp624,((_tmp8DF.tl=0,_tmp8DF)));
return Cyc_NewControlFlow_add_vars(_tmp61A,inflow,& _tmp633,_tmp61A->unknown_all,decl->loc,0);};_LL3A2:;_LL3A3: {
# 2608
struct Cyc_Core_Impossible_exn_struct _tmp8E5;const char*_tmp8E4;struct Cyc_Core_Impossible_exn_struct*_tmp8E3;(int)_throw((void*)((_tmp8E3=_cycalloc(sizeof(*_tmp8E3)),((_tmp8E3[0]=((_tmp8E5.tag=Cyc_Core_Impossible,((_tmp8E5.f1=((_tmp8E4="anal_decl: unexpected decl variant",_tag_dyneither(_tmp8E4,sizeof(char),35))),_tmp8E5)))),_tmp8E3)))));}_LL399:;}
# 2616
...
const char*_tmp8E8;void*_tmp8E7;(_tmp8E7=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp8E8="check_fun",_tag_dyneither(_tmp8E8,sizeof(char),10))),_tag_dyneither(_tmp8E7,sizeof(void*),0)));}_LL3A7: if((_tmp63B.ReachableFL).tag != 2)goto _LL3A4;_tmp63C=((struct _tuple14)(_tmp63B.ReachableFL).val).f1;_tmp63D=((struct _tuple14)(_tmp63B.ReachableFL).val).f2;_LL3A8: {
# 2644
...
const char*_tmp8EB;void*_tmp8EA;(_tmp8EA=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp8EB="check_fun: non-function type cached with fndecl_t",_tag_dyneither(_tmp8EB,sizeof(char),50))),_tag_dyneither(_tmp8EA,sizeof(void*),0)));}_LL3A9:;}
# 2651
...
struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct _tmp8EE;struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp8ED;struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp64E=(_tmp8ED=_region_malloc(_tmp639,sizeof(*_tmp8ED)),((_tmp8ED[0]=((_tmp8EE.tag=2,((_tmp8EE.f1=_tmp647,((_tmp8EE.f2=t,_tmp8EE)))))),_tmp8ED)));
struct Cyc_CfFlowInfo_Place*_tmp8EF;struct Cyc_CfFlowInfo_Place*_tmp64F=(_tmp8EF=_region_malloc(_tmp639,sizeof(*_tmp8EF)),((_tmp8EF->root=(void*)_tmp64E,((_tmp8EF->fields=0,_tmp8EF)))));
_tmp63C=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp63C,(void*)_tmp64E,_tmp64D);
{struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp8F5;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp8F4;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp8F2;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp8F1;_tmp63C=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp63C,(void*)((_tmp8F1=_region_malloc(_tmp639,sizeof(*_tmp8F1)),((_tmp8F1[0]=((_tmp8F2.tag=0,((_tmp8F2.f1=_tmp64C,_tmp8F2)))),_tmp8F1)))),(void*)((_tmp8F4=_region_malloc(_tmp639,sizeof(*_tmp8F4)),((_tmp8F4[0]=((_tmp8F5.tag=5,((_tmp8F5.f1=_tmp64F,_tmp8F5)))),_tmp8F4)))));}
...
struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct _tmp8F8;struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp8F7;struct Cyc_CfFlowInfo_InitParam_CfFlowInfo_Root_struct*_tmp658=(_tmp8F7=_region_malloc(_tmp639,sizeof(*_tmp8F7)),((_tmp8F7[0]=((_tmp8F8.tag=2,((_tmp8F8.f1=_tmp649,((_tmp8F8.f2=elttype,_tmp8F8)))))),_tmp8F7)));
struct Cyc_CfFlowInfo_Place*_tmp8F9;struct Cyc_CfFlowInfo_Place*_tmp659=(_tmp8F9=_region_malloc(_tmp639,sizeof(*_tmp8F9)),((_tmp8F9->root=(void*)_tmp658,((_tmp8F9->fields=0,_tmp8F9)))));
...
{struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct _tmp8FF;struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_tmp8FE;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp8FC;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp8FB;_tmp63C=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,void*k,void*v))Cyc_Dict_insert)(_tmp63C,(void*)((_tmp8FB=_region_malloc(_tmp639,sizeof(*_tmp8FB)),((_tmp8FB[0]=((_tmp8FC.tag=0,((_tmp8FC.f1=_tmp657,_tmp8FC)))),_tmp8FB)))),(void*)((_tmp8FE=_region_malloc(_tmp639,sizeof(*_tmp8FE)),((_tmp8FE[0]=((_tmp8FF.tag=5,((_tmp8FF.f1=_tmp659,_tmp8FF)))),_tmp8FE)))));}
{struct Cyc_List_List*_tmp900;param_roots=((_tmp900=_region_malloc(_tmp639,sizeof(*_tmp900)),((_tmp900->hd=_tmp659,((_tmp900->tl=param_roots,_tmp900))))));}
...
struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct _tmp903;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp902;struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_tmp663=(_tmp902=_region_malloc(_tmp639,sizeof(*_tmp902)),((_tmp902[0]=((_tmp903.tag=0,((_tmp903.f1=_tmp662,_tmp903)))),_tmp902)));
struct Cyc_CfFlowInfo_Place*_tmp904;struct Cyc_CfFlowInfo_Place*_tmp664=(_tmp904=_region_malloc(_tmp639,sizeof(*_tmp904)),((_tmp904->root=(void*)_tmp663,((_tmp904->fields=0,_tmp904)))));
struct Cyc_List_List*_tmp905;noconsume_roots=((_tmp905=_region_malloc(_tmp639,sizeof(*_tmp905)),((_tmp905->hd=_tmp664,((_tmp905->tl=noconsume_roots,_tmp905))))));}
# 2682
...
struct Cyc_NewControlFlow_AnalEnv*_tmp906;struct Cyc_NewControlFlow_AnalEnv*env=(_tmp906=_region_malloc(_tmp639,sizeof(*_tmp906)),((_tmp906->r=_tmp639,((_tmp906->fenv=fenv,((_tmp906->iterate_again=1,((_tmp906->iteration_num=0,((_tmp906->in_try=0,((_tmp906->tryflow=inflow,((_tmp906->all_changed=0,((_tmp906->noreturn=noreturn,((_tmp906->return_type=fd->ret_type,((_tmp906->unique_pat_vars=0,((_tmp906->param_roots=param_roots,((_tmp906->noconsume_params=noconsume_roots,((_tmp906->flow_table=flow_table,_tmp906)))))))))))))))))))))))))));
...
# 2701
union Cyc_CfFlowInfo_FlowInfo _tmp669=outflow;_LL3B8: if((_tmp669.BottomFL).tag != 1)goto _LL3BA;_LL3B9:
...
# 2708
if(noreturn){
const char*_tmp909;void*_tmp908;(_tmp908=0,Cyc_CfFlowInfo_aerr(_tmp63A,((_tmp909="`noreturn' function might (implicitly) return",_tag_dyneither(_tmp909,sizeof(char),46))),_tag_dyneither(_tmp908,sizeof(void*),0)));}else{
# 2711
void*_stmttmp95=Cyc_Tcutil_compress(fd->ret_type);void*_tmp66C=_stmttmp95;_LL3BD: {struct Cyc_Absyn_VoidType_Absyn_Type_struct*_tmp66D=(struct Cyc_Absyn_VoidType_Absyn_Type_struct*)_tmp66C;if(_tmp66D->tag != 0)goto _LL3BF;}_LL3BE:
 goto _LL3BC;_LL3BF: {struct Cyc_Absyn_FloatType_Absyn_Type_struct*_tmp66E=(struct Cyc_Absyn_FloatType_Absyn_Type_struct*)_tmp66C;if(_tmp66E->tag != 7)goto _LL3C1;}_LL3C0:
 goto _LL3C2;_LL3C1: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp66F=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp66C;if(_tmp66F->tag != 6)goto _LL3C3;}_LL3C2:
# 2715
{const char*_tmp90C;void*_tmp90B;(_tmp90B=0,Cyc_Tcutil_warn(_tmp63A,((_tmp90C="function may not return a value",_tag_dyneither(_tmp90C,sizeof(char),32))),_tag_dyneither(_tmp90B,sizeof(void*),0)));}goto _LL3BC;_LL3C3:;_LL3C4:
# 2717
{const char*_tmp90F;void*_tmp90E;(_tmp90E=0,Cyc_CfFlowInfo_aerr(_tmp63A,((_tmp90F="function may not return a value",_tag_dyneither(_tmp90F,sizeof(char),32))),_tag_dyneither(_tmp90E,sizeof(void*),0)));}goto _LL3BC;_LL3BC:;}
# 2719
goto _LL3B7;_LL3B7:;};};};}
# 2723
void Cyc_NewControlFlow_cf_check(struct Cyc_List_List*ds){
...
void*_stmttmp96=((struct Cyc_Absyn_Decl*)ds->hd)->r;void*_tmp675=_stmttmp96;struct Cyc_Absyn_Fndecl*_tmp677;struct Cyc_List_List*_tmp679;struct Cyc_List_List*_tmp67B;struct Cyc_List_List*_tmp67D;_LL3C6: {struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*_tmp676=(struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp675;if(_tmp676->tag != 1)goto _LL3C8;else{_tmp677=_tmp676->f1;}}_LL3C7:
 Cyc_NewControlFlow_check_fun(_tmp677);goto _LL3C5;_LL3C8: {struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*_tmp678=(struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp675;if(_tmp678->tag != 12)goto _LL3CA;else{_tmp679=_tmp678->f1;}}_LL3C9:
 _tmp67B=_tmp679;goto _LL3CB;_LL3CA: {struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*_tmp67A=(struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp675;if(_tmp67A->tag != 11)goto _LL3CC;else{_tmp67B=_tmp67A->f2;}}_LL3CB:
 _tmp67D=_tmp67B;goto _LL3CD;_LL3CC: {struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*_tmp67C=(struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp675;if(_tmp67C->tag != 10)goto _LL3CE;else{_tmp67D=_tmp67C->f2;}}_LL3CD:
 Cyc_NewControlFlow_cf_check(_tmp67D);goto _LL3C5;_LL3CE: {struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*_tmp67E=(struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp675;if(_tmp67E->tag != 13)goto _LL3D0;}_LL3CF:
