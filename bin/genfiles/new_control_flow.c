...
# 1012
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,inflow,e1,local_alias);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f1=_TmpC;void*r1=_TmpB;
struct _tuple17 _TmpD=Cyc_NewControlFlow_anal_derefR(env,inflow,f1,e1,r1,0);void*_TmpE;union Cyc_CfFlowInfo_FlowInfo _TmpF;_TmpF=_TmpD.f1;_TmpE=_TmpD.f2;{union Cyc_CfFlowInfo_FlowInfo f2=_TmpF;void*r2=_TmpE;
return({struct _tuple17 _Tmp10;_Tmp10.f1=f2,_Tmp10.f2=r1;_Tmp10;});}}}}else{_Tmp9=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_Tmp9;
# 1018
...
_Tmp9=e1;goto _LL15;}case 41: _Tmp9=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_LL15: {struct Cyc_Absyn_Exp*e1=_Tmp9;
...
# 1043
return({struct _tuple17 _TmpA;_TmpA.f1=inflow,_TmpA.f2=fenv->zero;_TmpA;});}case 40:
# 1045
 ...
 return({struct _tuple17 _TmpA;_TmpA.f1=inflow,_TmpA.f2=fenv->zero;_TmpA;});}else{
...
# 1051
 return({struct _tuple17 _TmpA;_TmpA.f1=inflow,_TmpA.f2=fenv->notzeroall;_TmpA;});case 1:
# 1063
 return({struct _tuple17 _TmpA;_TmpA.f1=inflow,({void*_TmpB=Cyc_CfFlowInfo_typ_to_absrval(fenv,_check_null(e->topt),0,fenv->unknown_all);_TmpA.f2=_TmpB;});_TmpA;});case 4: _Tmp9=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp0)->f1)->f1;{struct Cyc_Absyn_Vardecl*vd=_Tmp9;
# 1068
if((int)vd->sc==0)
return({struct _tuple17 _TmpA;_TmpA.f1=inflow,({void*_TmpB=Cyc_CfFlowInfo_typ_to_absrval(fenv,_check_null(e->topt),0,fenv->unknown_all);_TmpA.f2=_TmpB;});_TmpA;});
# 1071
...
return({struct _tuple17 _TmpA;_TmpA.f1=inflow,({void*_TmpB=({struct Cyc_Dict_Dict _TmpC=d;Cyc_Dict_lookup_other(_TmpC,Cyc_CfFlowInfo_root_cmp,(void*)({struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*_TmpD=_cycalloc(sizeof(struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct));*_TmpD=vdroot;_TmpD;}));});_TmpA.f2=_TmpB;});_TmpA;});}default:
# 1698
...
# 1560
_Tmp9=es;goto _LL69;}}case 42: _LL2D:
# 1055
 ...
 return({struct _tuple17 _TmpA;_TmpA.f1=inflow,_TmpA.f2=fenv->unknown_all;_TmpA;});case 3: _Tmp6=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp9=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{enum Cyc_Absyn_Primop p=_Tmp6;struct Cyc_List_List*es=_Tmp9;
# 1082
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_use_ints(env,inflow,es);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;void*r=_TmpB;
return({struct _tuple17 _TmpD;_TmpD.f1=f,_TmpD.f2=r;_TmpD;});}}case 5: _Tmp9=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{struct Cyc_Absyn_Exp*e1=_Tmp9;
# 1086
struct Cyc_List_List arg=({struct Cyc_List_List _TmpA;_TmpA.hd=e1,_TmpA.tl=0;_TmpA;});
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_use_ints(env,inflow,& arg);union Cyc_CfFlowInfo_FlowInfo _TmpB;_TmpB=_TmpA.f1;{union Cyc_CfFlowInfo_FlowInfo f=_TmpB;
struct _tuple19 _TmpC=Cyc_NewControlFlow_anal_Lexp(env,f,0,0,e1);union Cyc_CfFlowInfo_AbsLVal _TmpD;_TmpD=_TmpC.f2;{union Cyc_CfFlowInfo_AbsLVal lval=_TmpD;
int iszt=Cyc_Tcutil_is_zeroterm_pointer_type(_check_null(e1->topt));
if(iszt){
# 1093
struct _tuple17 _TmpE=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_TmpF;union Cyc_CfFlowInfo_FlowInfo _Tmp10;_Tmp10=_TmpE.f1;_TmpF=_TmpE.f2;{union Cyc_CfFlowInfo_FlowInfo g=_Tmp10;void*r=_TmpF;
Cyc_NewControlFlow_anal_derefR(env,inflow,g,e1,r,0);}}
# 1096
{struct _tuple26 _TmpE=({struct _tuple26 _TmpF;_TmpF.f1=lval,_TmpF.f2=f;_TmpF;});void*_TmpF;struct Cyc_Dict_Dict _Tmp10;void*_Tmp11;if(_TmpE.f1.PlaceL.tag==1){if(_TmpE.f2.ReachableFL.tag==2){_Tmp11=_TmpE.f1.PlaceL.val;_Tmp10=_TmpE.f2.ReachableFL.val.f1;_TmpF=_TmpE.f2.ReachableFL.val.f2;{struct Cyc_CfFlowInfo_Place*p=_Tmp11;struct Cyc_Dict_Dict outdict=_Tmp10;struct Cyc_List_List*relns=_TmpF;
# 1098
...
# 1107
if(iszt)
return({struct _tuple17 _TmpE;_TmpE.f1=f,_TmpE.f2=fenv->notzeroall;_TmpE;});else{
return({struct _tuple17 _TmpE;_TmpE.f1=f,_TmpE.f2=fenv->unknown_all;_TmpE;});}}}}case 4: if(((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_Tmp0)->f2!=0){_Tmp9=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp7=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;{struct Cyc_Absyn_Exp*l=_Tmp9;struct Cyc_Absyn_Exp*r=_Tmp7;
# 1112
...
return({struct _tuple17 _TmpA;({union Cyc_CfFlowInfo_FlowInfo _TmpB=Cyc_CfFlowInfo_BottomFL();_TmpA.f1=_TmpB;}),_TmpA.f2=fenv->unknown_all;_TmpA;});}{
# 1116
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,r,local_alias);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo right_out=_TmpC;void*rval=_TmpB;
struct _tuple19 _TmpD=Cyc_NewControlFlow_anal_Lexp(env,right_out,0,0,l);union Cyc_CfFlowInfo_AbsLVal _TmpE;union Cyc_CfFlowInfo_FlowInfo _TmpF;_TmpF=_TmpD.f1;_TmpE=_TmpD.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpF;union Cyc_CfFlowInfo_AbsLVal lval=_TmpE;
{void*_Tmp10;struct Cyc_Dict_Dict _Tmp11;if(f.ReachableFL.tag==2){_Tmp11=f.ReachableFL.val.f1;_Tmp10=f.ReachableFL.val.f2;{struct Cyc_Dict_Dict outdict=_Tmp11;struct Cyc_List_List*relns=_Tmp10;
# 1120
...
goto _LL9D;}_LL9D:;}
# 1139
return({struct _tuple17 _Tmp10;_Tmp10.f1=f,_Tmp10.f2=fenv->unknown_all;_Tmp10;});}}}}}else{_Tmp9=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp7=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;{struct Cyc_Absyn_Exp*e1=_Tmp9;struct Cyc_Absyn_Exp*e2=_Tmp7;
# 1142
if(copy_ctxt && Cyc_Tcutil_is_noalias_pointer_or_aggr(env->aquals_bounds,_check_null(e->topt))){
Cyc_CfFlowInfo_aerr(e->loc,_tag_fat("cannot track alias-free pointers through multiple assignments",sizeof(char),62U),_tag_fat(0U,sizeof(void*),0));
return({struct _tuple17 _TmpA;({union Cyc_CfFlowInfo_FlowInfo _TmpB=Cyc_CfFlowInfo_BottomFL();_TmpA.f1=_TmpB;}),_TmpA.f2=fenv->unknown_all;_TmpA;});}
...
# 1150
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,e2,local_alias);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo right_out=_TmpC;void*rval=_TmpB;
struct _tuple19 _TmpD=Cyc_NewControlFlow_anal_Lexp(env,right_out,0,0,e1);union Cyc_CfFlowInfo_AbsLVal _TmpE;union Cyc_CfFlowInfo_FlowInfo _TmpF;_TmpF=_TmpD.f1;_TmpE=_TmpD.f2;{union Cyc_CfFlowInfo_FlowInfo outflow=_TmpF;union Cyc_CfFlowInfo_AbsLVal lval=_TmpE;
struct _tuple17 _Tmp10=Cyc_NewControlFlow_do_assign(fenv,env,outflow,e1,lval,e2,rval,e->loc);void*_Tmp11;union Cyc_CfFlowInfo_FlowInfo _Tmp12;_Tmp12=_Tmp10.f1;_Tmp11=_Tmp10.f2;{union Cyc_CfFlowInfo_FlowInfo outflow=_Tmp12;void*rval=_Tmp11;
# 1156
return({struct _tuple17 _Tmp13;_Tmp13.f1=outflow,_Tmp13.f2=rval;_Tmp13;});}}}}}}case 9: _Tmp9=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp7=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_Tmp9;struct Cyc_Absyn_Exp*e2=_Tmp7;
# 1159
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;void*r=_TmpB;
...
# 1163
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,e1,local_alias);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;void*r=_TmpB;
Cyc_NewControlFlow_use_Rval(env,e1->loc,f,r);
return({struct _tuple17 _TmpD;({union Cyc_CfFlowInfo_FlowInfo _TmpE=Cyc_CfFlowInfo_BottomFL();_TmpD.f1=_TmpE;}),({void*_TmpE=Cyc_CfFlowInfo_typ_to_absrval(fenv,_check_null(e->topt),0,fenv->unknown_all);_TmpD.f2=_TmpE;});_TmpD;});}}case 10: _Tmp9=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp7=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_Tmp9;struct Cyc_List_List*es=_Tmp7;
# 1168
struct Cyc_List_List*orig_es=es;
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f1=_TmpC;void*r1=_TmpB;
# 1171
Cyc_NewControlFlow_anal_derefR(env,inflow,f1,e1,r1,0);{
# 1174
struct _tuple24 _TmpD=({struct Cyc_NewControlFlow_AnalEnv*_TmpE=env;union Cyc_CfFlowInfo_FlowInfo _TmpF=f1;Cyc_NewControlFlow_anal_Rexps(_TmpE,_TmpF,Cyc_List_copy(es),1,1);});void*_TmpE;union Cyc_CfFlowInfo_FlowInfo _TmpF;_TmpF=_TmpD.f1;_TmpE=_TmpD.f2;{union Cyc_CfFlowInfo_FlowInfo fst_outflow=_TmpF;struct Cyc_List_List*rvals=_TmpE;
# 1176
...
# 1193
init_params=({struct Cyc_List_List*_Tmp18=_cycalloc(sizeof(struct Cyc_List_List));_Tmp18->hd=(void*)i,_Tmp18->tl=init_params;_Tmp18;});goto _LLC6;}case 21: _Tmp17=((struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*)_Tmp16)->f1;{int i=_Tmp17;
# 1195
...
goto _LLC6;}case 22: _Tmp17=((struct Cyc_Absyn_Consume_att_Absyn_Attribute_struct*)_Tmp16)->f1;{int i=_Tmp17;
# 1199
consume_params=({struct Cyc_List_List*_Tmp18=_cycalloc(sizeof(struct Cyc_List_List));_Tmp18->hd=(void*)i,_Tmp18->tl=consume_params;_Tmp18;});
goto _LLC6;}default:
 goto _LLC6;}_LLC6:;}
...
goto _LLCF;else{_Tmp10=fst_outflow.ReachableFL.val.f1;{struct Cyc_Dict_Dict fst_d=_Tmp10;
# 1214
struct _tuple16 _Tmp11=Cyc_CfFlowInfo_unname_rval((void*)rvals->hd);void*_Tmp12;_Tmp12=_Tmp11.f1;{void*r=_Tmp12;
...
goto _LLD7;else{_Tmp14=outflow.ReachableFL.val.f1;_Tmp13=outflow.ReachableFL.val.f2;{struct Cyc_Dict_Dict d=_Tmp14;struct Cyc_List_List*relns=_Tmp13;
# 1222
...
if(ropt==0 && aqopt==0){
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,exp,local_alias);union Cyc_CfFlowInfo_FlowInfo _TmpB;_TmpB=_TmpA.f1;{union Cyc_CfFlowInfo_FlowInfo f=_TmpB;
outflow=f;}}else{
# 1287
...
# 1294
struct _tuple24 _TmpA=Cyc_NewControlFlow_anal_Rexps(env,inflow,expl,1,1);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;struct Cyc_List_List*rvals=_TmpB;
outflow=f;}}}
# 1299
if(Cyc_Tcutil_is_noalias_pointer(env->aquals_bounds,_check_null(e->topt),1))
return({struct _tuple17 _TmpA;_TmpA.f1=outflow,({void*_TmpB=(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_TmpC=_cycalloc(sizeof(struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct));_TmpC->tag=5,_TmpC->f1=place_val;_TmpC;});_TmpA.f2=_TmpB;});_TmpA;});else{
# 1303
...
return({struct _tuple17 _TmpC;_TmpC.f1=outflow,_TmpC.f2=rval;_TmpC;});else{_TmpB=outflow.ReachableFL.val.f1;_TmpA=outflow.ReachableFL.val.f2;{struct Cyc_Dict_Dict d2=_TmpB;struct Cyc_List_List*relns=_TmpA;
# 1309
return({struct _tuple17 _TmpC;({union Cyc_CfFlowInfo_FlowInfo _TmpD=({struct Cyc_Dict_Dict _TmpE=Cyc_Dict_insert(d2,root,place_val);Cyc_CfFlowInfo_ReachableFL(_TmpE,relns);});_TmpC.f1=_TmpD;}),_TmpC.f2=rval;_TmpC;});}};}}}}case 35: _Tmp9=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp7=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_Tmp9;struct Cyc_Absyn_Exp*e2=_Tmp7;
# 1314
void*left_rval;
void*right_rval;
union Cyc_CfFlowInfo_FlowInfo outflow;
# 1320
struct _tuple24 _TmpA=({struct Cyc_NewControlFlow_AnalEnv*_TmpB=env;union Cyc_CfFlowInfo_FlowInfo _TmpC=inflow;Cyc_NewControlFlow_anal_Rexps(_TmpB,_TmpC,({struct Cyc_Absyn_Exp*_TmpD[2];_TmpD[0]=e1,_TmpD[1]=e2;Cyc_List_list(_tag_fat(_TmpD,sizeof(struct Cyc_Absyn_Exp*),2));}),0,0);});void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;struct Cyc_List_List*rvals=_TmpB;
...
# 1345
struct _tuple19 _TmpD=Cyc_NewControlFlow_anal_Lexp(env,outflow,0,0,e1);union Cyc_CfFlowInfo_AbsLVal _TmpE;_TmpE=_TmpD.f2;{union Cyc_CfFlowInfo_AbsLVal left_lval=_TmpE;
struct _tuple19 _TmpF=Cyc_NewControlFlow_anal_Lexp(env,outflow,0,0,e2);union Cyc_CfFlowInfo_AbsLVal _Tmp10;_Tmp10=_TmpF.f2;{union Cyc_CfFlowInfo_AbsLVal right_lval=_Tmp10;
{void*_Tmp11;struct Cyc_Dict_Dict _Tmp12;if(outflow.ReachableFL.tag==2){_Tmp12=outflow.ReachableFL.val.f1;_Tmp11=outflow.ReachableFL.val.f2;{struct Cyc_Dict_Dict outdict=_Tmp12;struct Cyc_List_List*relns=_Tmp11;
# 1349
...
goto _LL106;}_LL106:;}
# 1381
return({struct _tuple17 _Tmp11;_Tmp11.f1=outflow,_Tmp11.f2=fenv->unknown_all;_Tmp11;});}}}}}}case 16: _Tmp9=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp7=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp4=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;{struct Cyc_Absyn_Exp*eopt=_Tmp9;struct Cyc_Absyn_Exp*e2=_Tmp7;struct Cyc_Absyn_Exp*qopt=_Tmp4;
# 1384
union Cyc_CfFlowInfo_FlowInfo outflow;
void*place_val;
if(eopt==0 && qopt==0){
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,e2,local_alias);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;void*r=_TmpB;
outflow=f;
place_val=r;}}else{
# 1392
...
return({struct _tuple17 _TmpC;_TmpC.f1=outflow,_TmpC.f2=rval;_TmpC;});else{_TmpB=outflow.ReachableFL.val.f1;_TmpA=outflow.ReachableFL.val.f2;{struct Cyc_Dict_Dict d2=_TmpB;struct Cyc_List_List*relns=_TmpA;
# 1417
return({struct _tuple17 _TmpC;({union Cyc_CfFlowInfo_FlowInfo _TmpD=({struct Cyc_Dict_Dict _TmpE=Cyc_Dict_insert(d2,root,place_val);Cyc_CfFlowInfo_ReachableFL(_TmpE,relns);});_TmpC.f1=_TmpD;}),_TmpC.f2=rval;_TmpC;});}};}}}case 15: _Tmp9=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{struct Cyc_Absyn_Exp*e1=_Tmp9;
# 1422
struct _tuple19 _TmpA=Cyc_NewControlFlow_anal_Lexp(env,inflow,0,0,e1);union Cyc_CfFlowInfo_AbsLVal _TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;union Cyc_CfFlowInfo_AbsLVal l=_TmpB;
void*_TmpD;if(l.UnknownL.tag==2)
return({struct _tuple17 _TmpE;_TmpE.f1=f,_TmpE.f2=fenv->notzeroall;_TmpE;});else{_TmpD=l.PlaceL.val;{struct Cyc_CfFlowInfo_Place*p=_TmpD;
return({struct _tuple17 _TmpE;_TmpE.f1=f,({void*_TmpF=(void*)({struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*_Tmp10=_cycalloc(sizeof(struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct));_Tmp10->tag=4,_Tmp10->f1=p;_Tmp10;});_TmpE.f2=_TmpF;});_TmpE;});}};}}case 20: _Tmp9=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{struct Cyc_Absyn_Exp*e1=_Tmp9;
# 1429
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_Rexp(env,0,inflow,e1,local_alias);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;void*r=_TmpB;
...
return({struct _tuple17 _TmpD;_TmpD.f1=f,({void*_TmpE=Cyc_CfFlowInfo_typ_to_absrval(fenv,_check_null(e->topt),0,fenv->unknown_all);_TmpD.f2=_TmpE;});_TmpD;});
if(Cyc_Absyn_is_require_union_type(e1_type))
Cyc_NewControlFlow_check_union_requires(e1->loc,e1_type,field,f);{
struct _tuple16 _TmpD=Cyc_CfFlowInfo_unname_rval(r);void*_TmpE;_TmpE=_TmpD.f1;{void*r=_TmpE;
...
# 1486
return({struct _tuple17 _Tmp12;_Tmp12.f1=f2,({void*_Tmp13=Cyc_CfFlowInfo_typ_to_absrval(fenv,_check_null(e->topt),0,fenv->unknown_all);_Tmp12.f2=_Tmp13;});_Tmp12;});
# 1488
if(Cyc_Absyn_is_require_union_type(t2))
Cyc_NewControlFlow_check_union_requires(e1->loc,t2,field,f1);{
# 1491
struct _tuple16 _Tmp12=Cyc_CfFlowInfo_unname_rval(r2);void*_Tmp13;_Tmp13=_Tmp12.f1;{void*r2=_Tmp13;
...
# 1504
struct _tuple20 _TmpA=Cyc_NewControlFlow_anal_test(env,inflow,e1);union Cyc_CfFlowInfo_FlowInfo _TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f1t=_TmpC;union Cyc_CfFlowInfo_FlowInfo f1f=_TmpB;
...
# 1510
struct _tuple20 _TmpA=Cyc_NewControlFlow_anal_test(env,inflow,e1);union Cyc_CfFlowInfo_FlowInfo _TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f1t=_TmpC;union Cyc_CfFlowInfo_FlowInfo f1f=_TmpB;
struct _tuple17 _TmpD=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,f1t,e2,local_alias);void*_TmpE;union Cyc_CfFlowInfo_FlowInfo _TmpF;_TmpF=_TmpD.f1;_TmpE=_TmpD.f2;{union Cyc_CfFlowInfo_FlowInfo f2t=_TmpF;void*f2r=_TmpE;
struct _tuple17 pr2=({struct _tuple17 _Tmp10;_Tmp10.f1=f2t,_Tmp10.f2=f2r;_Tmp10;});
struct _tuple17 pr3=({struct _tuple17 _Tmp10;_Tmp10.f1=f1f,_Tmp10.f2=fenv->zero;_Tmp10;});
...
# 1517
struct _tuple20 _TmpA=Cyc_NewControlFlow_anal_test(env,inflow,e1);union Cyc_CfFlowInfo_FlowInfo _TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f1t=_TmpC;union Cyc_CfFlowInfo_FlowInfo f1f=_TmpB;
struct _tuple17 _TmpD=Cyc_NewControlFlow_anal_Rexp(env,copy_ctxt,f1f,e2,local_alias);void*_TmpE;union Cyc_CfFlowInfo_FlowInfo _TmpF;_TmpF=_TmpD.f1;_TmpE=_TmpD.f2;{union Cyc_CfFlowInfo_FlowInfo f2t=_TmpF;void*f2r=_TmpE;
struct _tuple17 pr2=({struct _tuple17 _Tmp10;_Tmp10.f1=f2t,_Tmp10.f2=f2r;_Tmp10;});
struct _tuple17 pr3=({struct _tuple17 _Tmp10;_Tmp10.f1=f1t,_Tmp10.f2=fenv->notzeroall;_Tmp10;});
...
# 1524
struct _tuple24 _TmpA=({struct Cyc_NewControlFlow_AnalEnv*_TmpB=env;union Cyc_CfFlowInfo_FlowInfo _TmpC=inflow;Cyc_NewControlFlow_anal_Rexps(_TmpB,_TmpC,({struct Cyc_Absyn_Exp*_TmpD[2];_TmpD[0]=e1,_TmpD[1]=e2;Cyc_List_list(_tag_fat(_TmpD,sizeof(struct Cyc_Absyn_Exp*),2));}),0,1);});void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;struct Cyc_List_List*rvals=_TmpB;
# 1528
union Cyc_CfFlowInfo_FlowInfo f2=f;
{void*_TmpD;struct Cyc_Dict_Dict _TmpE;if(f.ReachableFL.tag==2){_TmpE=f.ReachableFL.val.f1;_TmpD=f.ReachableFL.val.f2;{struct Cyc_Dict_Dict d2=_TmpE;struct Cyc_List_List*relns=_TmpD;
# 1533
...
goto _LL166;}_LL166:;}{
# 1541
void*_TmpD=Cyc_Absyn_compress(_check_null(e1->topt));void*_TmpE;switch(*((int*)_TmpD)){case 6: _TmpE=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_TmpD)->f1;{struct Cyc_List_List*tqts=_TmpE;
# 1543
struct _tuple16 _TmpF=Cyc_CfFlowInfo_unname_rval((void*)rvals->hd);void*_Tmp10;_Tmp10=_TmpF.f1;{void*r=_Tmp10;
struct _fat_ptr _Tmp11;if(*((int*)r)==6){_Tmp11=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)r)->f2;{struct _fat_ptr rdict=_Tmp11;
# 1546
...
# 1551
struct _tuple17 _TmpF=Cyc_NewControlFlow_anal_derefR(env,inflow,f,e1,(void*)rvals->hd,e2);void*_Tmp10;union Cyc_CfFlowInfo_FlowInfo _Tmp11;_Tmp11=_TmpF.f1;_Tmp10=_TmpF.f2;{union Cyc_CfFlowInfo_FlowInfo f3=_Tmp11;void*r=_Tmp10;
...
# 1556
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("anal_Rexp: Subscript -- bad type",sizeof(char),33U),_tag_fat(0U,sizeof(void*),0));};}}}case 24: _Tmp9=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_LL69: {struct Cyc_List_List*es=_Tmp9;
# 1562
struct _tuple24 _TmpA=Cyc_NewControlFlow_anal_Rexps(env,inflow,es,1,1);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;struct Cyc_List_List*rvals=_TmpB;
...
# 1569
return({struct _tuple17 _TmpD;_TmpD.f1=f,({void*_TmpE=(void*)({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_TmpF=_cycalloc(sizeof(struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct));_TmpF->tag=6,_TmpF->f1.is_union=0,_TmpF->f1.fieldnum=-1,_TmpF->f2=aggrdict;_TmpF;});_TmpD.f2=_TmpE;});_TmpD;});}}case 30: _Tmp9=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_List_List*des=_Tmp9;
# 1572
struct Cyc_List_List*fs;
{void*_TmpA=Cyc_Absyn_compress(_check_null(e->topt));void*_TmpB;if(*((int*)_TmpA)==7){_TmpB=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_TmpA)->f2;{struct Cyc_List_List*f=_TmpB;
fs=f;goto _LL185;}}else{
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("anal_Rexp:anon struct has bad type",sizeof(char),35U),_tag_fat(0U,sizeof(void*),0));}_LL185:;}
# 1577
_Tmp9=des;_Tmp1=0U;_Tmp7=fs;goto _LL6D;}case 29: if(((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_Tmp0)->f4!=0){if(((struct Cyc_Absyn_Aggrdecl*)((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_Tmp0)->f4)->impl!=0){_Tmp9=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;_Tmp1=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_Tmp0)->f4->kind;_Tmp7=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_Tmp0)->f4->impl->fields;_LL6D: {struct Cyc_List_List*des=_Tmp9;enum Cyc_Absyn_AggrKind kind=_Tmp1;struct Cyc_List_List*fs=_Tmp7;
# 1579
void*exp_type=_check_null(e->topt);
struct _tuple24 _TmpA=({struct Cyc_NewControlFlow_AnalEnv*_TmpB=env;union Cyc_CfFlowInfo_FlowInfo _TmpC=inflow;Cyc_NewControlFlow_anal_Rexps(_TmpB,_TmpC,({(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(struct _tuple27*),struct Cyc_List_List*))Cyc_List_map;})(({(struct Cyc_Absyn_Exp*(*)(struct _tuple27*))Cyc_Core_snd;}),des),1,1);});void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f=_TmpC;struct Cyc_List_List*rvals=_TmpB;
...
struct _tuple24 _TmpA=Cyc_NewControlFlow_anal_Rexps(env,inflow,es,1,1);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo outflow=_TmpC;struct Cyc_List_List*rvals=_TmpB;
for(1;rvals!=0;(rvals=rvals->tl,es=es->tl)){
outflow=Cyc_NewControlFlow_use_Rval(env,((struct Cyc_Absyn_Exp*)_check_null(es)->hd)->loc,outflow,(void*)rvals->hd);}
# 1612
return({struct _tuple17 _TmpD;_TmpD.f1=outflow,({void*_TmpE=Cyc_CfFlowInfo_typ_to_absrval(fenv,_check_null(e->topt),0,fenv->notzeroall);_TmpD.f2=_TmpE;});_TmpD;});}}case 27: _Tmp9=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp7=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp4=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;_Tmp2=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_Tmp0)->f4;{struct Cyc_Absyn_Vardecl*vd=_Tmp9;struct Cyc_Absyn_Exp*e1=_Tmp7;struct Cyc_Absyn_Exp*e2=_Tmp4;int zt=_Tmp2;
# 1616
struct _tuple17 _TmpA=Cyc_NewControlFlow_anal_Rexp(env,1,inflow,e1,local_alias);void*_TmpB;union Cyc_CfFlowInfo_FlowInfo _TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{union Cyc_CfFlowInfo_FlowInfo f1=_TmpC;void*r1=_TmpB;
void*_TmpD;struct Cyc_Dict_Dict _TmpE;if(f1.BottomFL.tag==1)
return({struct _tuple17 _TmpF;_TmpF.f1=f1,_TmpF.f2=fenv->unknown_all;_TmpF;});else{_TmpE=f1.ReachableFL.val.f1;_TmpD=f1.ReachableFL.val.f2;{struct Cyc_Dict_Dict d1=_TmpE;struct Cyc_List_List*relns=_TmpD;
# 1620
...
switch(*((int*)r1)){case 0:
 return({struct _tuple17 _TmpF;_TmpF.f1=f1,_TmpF.f2=fenv->unknown_all;_TmpF;});case 1:
...
# 1640
struct _tuple17 _TmpF=Cyc_NewControlFlow_anal_Rexp(env,1,f1,e2,local_alias);void*_Tmp10;union Cyc_CfFlowInfo_FlowInfo _Tmp11;_Tmp11=_TmpF.f1;_Tmp10=_TmpF.f2;{union Cyc_CfFlowInfo_FlowInfo f2=_Tmp11;void*r2=_Tmp10;
{struct Cyc_Dict_Dict _Tmp12;if(f2.BottomFL.tag==1)
return({struct _tuple17 _Tmp13;_Tmp13.f1=f2,_Tmp13.f2=fenv->unknown_all;_Tmp13;});else{_Tmp12=f2.ReachableFL.val.f1;{struct Cyc_Dict_Dict d2=_Tmp12;
# 1644
if((int)Cyc_CfFlowInfo_initlevel(fenv,d2,r2)!=1){
Cyc_CfFlowInfo_aerr(e1->loc,_tag_fat("expression may not be initialized",sizeof(char),34U),_tag_fat(0U,sizeof(void*),0));
return({struct _tuple17 _Tmp13;({union Cyc_CfFlowInfo_FlowInfo _Tmp14=Cyc_CfFlowInfo_BottomFL();_Tmp13.f1=_Tmp14;}),_Tmp13.f2=fenv->unknown_all;_Tmp13;});}}};}
# 1649
f1=f2;
...
struct _tuple17 _TmpF=Cyc_NewControlFlow_anal_Rexp(env,1,f1,e2,local_alias);void*_Tmp10;union Cyc_CfFlowInfo_FlowInfo _Tmp11;_Tmp11=_TmpF.f1;_Tmp10=_TmpF.f2;{union Cyc_CfFlowInfo_FlowInfo f2=_Tmp11;void*r2=_Tmp10;
{struct Cyc_Dict_Dict _Tmp12;if(f2.BottomFL.tag==1)
goto _LL1B1;else{_Tmp12=f2.ReachableFL.val.f1;{struct Cyc_Dict_Dict d2=_Tmp12;
# 1659
if((int)Cyc_CfFlowInfo_initlevel(fenv,d2,r2)!=1){
Cyc_CfFlowInfo_aerr(e1->loc,_tag_fat("expression may not be initialized",sizeof(char),34U),_tag_fat(0U,sizeof(void*),0));
return({struct _tuple17 _Tmp13;({union Cyc_CfFlowInfo_FlowInfo _Tmp14=Cyc_CfFlowInfo_BottomFL();_Tmp13.f1=_Tmp14;}),_Tmp13.f2=fenv->unknown_all;_Tmp13;});}}}_LL1B1:;}{
# 1664
...
return({struct _tuple17 _TmpE;_TmpE.f1=outflow,_TmpE.f2=rval;_TmpE;});else{_TmpD=outflow.ReachableFL.val.f1;_TmpC=outflow.ReachableFL.val.f2;{struct Cyc_Dict_Dict d2=_TmpD;struct Cyc_List_List*relns=_TmpC;
# 1690
return({struct _tuple17 _TmpE;({union Cyc_CfFlowInfo_FlowInfo _TmpF=({struct Cyc_Dict_Dict _Tmp10=Cyc_Dict_insert(d2,root,place_val);Cyc_CfFlowInfo_ReachableFL(_Tmp10,relns);});_TmpE.f1=_TmpF;}),_TmpE.f2=rval;_TmpE;});}};}}}}}case 37: _Tmp9=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{struct Cyc_Absyn_Stmt*s=_Tmp9;
# 1694
struct _tuple18 rval_opt=({struct _tuple18 _TmpA;_TmpA.f1=env->fenv->unknown_all,_TmpA.f2=copy_ctxt;_TmpA;});
union Cyc_CfFlowInfo_FlowInfo f=Cyc_NewControlFlow_anal_stmt(env,inflow,s,& rval_opt);
return({struct _tuple17 _TmpA;_TmpA.f1=f,_TmpA.f2=rval_opt.f1;_TmpA;});}case 36: _LL7B:
# 1699
...
goto _LL11;}else{goto _LL20;}default: _LL20:
 goto _LL11;}_LL11:;}}}
# 2064
{struct _tuple28 _Tmp8=({struct _tuple28 _Tmp9;_Tmp9.f1=p,({
...
# 2158
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("anal_test",sizeof(char),10U),_tag_fat(0U,sizeof(void*),0));};}}};}}};}struct _tuple29{unsigned f1;struct Cyc_NewControlFlow_AnalEnv*f2;struct Cyc_Dict_Dict f3;};
# 2164
...
if(Cyc_Flags_warn_lose_unique){
struct _tuple29 check_env=({struct _tuple29 _Tmp1;_Tmp1.f1=loc,_Tmp1.f2=env,_Tmp1.f3=d;_Tmp1;});
...
goto _LL5;}_LL5:;}
# 2295
return({struct _tuple30 _Tmp1;_Tmp1.f1=varok,_Tmp1.f2=rval;_Tmp1;});}};}
# 2301
...
struct _tuple30 _Tmp2=
is_region_open?({struct _tuple30 _Tmp3;_Tmp3.f1=1,_Tmp3.f2=0;_Tmp3;}):
...
struct _tuple1 _Tmp5=Cyc_NewControlFlow_get_unconsume_pat_vars(env,(struct Cyc_List_List*)vds_opt->v);void*_Tmp6;void*_Tmp7;_Tmp7=_Tmp5.f1;_Tmp6=_Tmp5.f2;{struct Cyc_List_List*roots=_Tmp7;struct Cyc_List_List*es=_Tmp6;
...
# 2547
struct _tuple32 vdenv=({struct _tuple32 _Tmp1;_Tmp1.f1=env,_Tmp1.f2=fd,_Tmp1.f3=decl->loc;_Tmp1;});
struct Cyc_CfFlowInfo_FlowEnv*fenv=env->fenv;
...
struct _tuple31*_Tmp0=(struct _tuple31*)x->hd;void*_Tmp1;void*_Tmp2;void*_Tmp3;int _Tmp4;_Tmp4=_Tmp0->f1;_Tmp3=_Tmp0->f2;_Tmp2=_Tmp0->f3;_Tmp1=_Tmp0->f4;{int is_open=_Tmp4;struct Cyc_Absyn_Stmt*pat_stmt=_Tmp3;struct Cyc_List_List*roots=_Tmp2;struct Cyc_List_List*es=_Tmp1;
...
goto _LL5F;}_LL5F:;}{
# 2769
struct _tuple1 _TmpB=Cyc_NewControlFlow_get_unconsume_pat_vars(env,vds);void*_TmpC;void*_TmpD;_TmpD=_TmpB.f1;_TmpC=_TmpB.f2;{struct Cyc_List_List*roots=_TmpD;struct Cyc_List_List*es=_TmpC;
