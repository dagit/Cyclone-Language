...
void*t=(void*)_check_null(_tmp556->cached_type);
...
{struct Cyc_List_List*_tmp577=fd->requires_relns;for(0;_tmp577 != 0;_tmp577=_tmp577->tl){
...
({void*_tmp57B=0U;({struct _dyneither_ptr _tmp7A8=({const char*_tmp57C="check_fun: non-function type cached with fndecl_t";_tag_dyneither(_tmp57C,sizeof(char),50U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp7A8,_tag_dyneither(_tmp57B,sizeof(void*),0U));});});}_LL3:;}{
# 2991
...
struct Cyc_Hashtable_Table*_tmp7B2=((struct Cyc_Hashtable_Table*(*)(struct Cyc_Hashtable_Table*t,struct Cyc_Absyn_Fndecl*key))Cyc_Hashtable_lookup)(tables->pat_pop_tables,fd);_tmp599->pat_pop_table=_tmp7B2;}),_tmp599->fenv=fenv,_tmp599->iterate_again=1,_tmp599->iteration_num=0,_tmp599->in_try=0,_tmp599->tryflow=inflow,_tmp599->noreturn=noreturn,_tmp599->return_type=fd->ret_type,_tmp599->unique_pat_vars=0,_tmp599->param_roots=param_roots,_tmp599->noconsume_params=noconsume_roots,_tmp599->flow_table=flow_table,_tmp599->return_relns=fd->ensures_relns;_tmp599;});
# 3033
