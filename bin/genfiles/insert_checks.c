...
struct Cyc_Vcgen_ExpChecks*ec=Cyc_Vcgen_exp2ctxt_checks(nv.assn_info,a);
# 313
int flag=!Cyc_PrattProver_constraint_prove(ec->ctxt.assn,ec->bounds_check);
# 332 "insert_checks.cyc"
