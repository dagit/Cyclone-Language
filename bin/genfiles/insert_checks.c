...
# 82
static struct Cyc_InsertChecks_Env Cyc_InsertChecks_toplevel_env (void){return({struct Cyc_InsertChecks_Env _tmpA6;_tmpA6.in_sizeof=0,_tmpA6.at_toplevel=1;_tmpA6;});}
static struct Cyc_InsertChecks_Env Cyc_InsertChecks_fn_body_env (void){return({struct Cyc_InsertChecks_Env _tmpA7;_tmpA7.in_sizeof=0,_tmpA7.at_toplevel=0;_tmpA7;});}
