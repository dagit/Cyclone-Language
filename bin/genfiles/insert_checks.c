...
# 273
es=_TD->tl;goto _TL3B;_TL3A: goto _LL0;}case 4:{struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_T144;_T14D=_T14E->f1;_T14C=_T14E->f3;}{struct Cyc_Absyn_Exp*e1=_T14D;struct Cyc_Absyn_Exp*e2=_T14C;_T14D=e1;_T14C=e2;goto _LL10;}case 9:{struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_T144;_T14D=_T14E->f1;_T14C=_T14E->f2;}_LL10: {struct Cyc_Absyn_Exp*e1=_T14D;struct Cyc_Absyn_Exp*e2=_T14C;_T14D=e1;_T14C=e2;goto _LL12;}case 7:{struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_T144;_T14D=_T14E->f1;_T14C=_T14E->f2;}_LL12: {struct Cyc_Absyn_Exp*e1=_T14D;struct Cyc_Absyn_Exp*e2=_T14C;_T14D=e1;_T14C=e2;goto _LL14;}case 8:{struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_T144;_T14D=_T14E->f1;_T14C=_T14E->f2;}_LL14: {struct Cyc_Absyn_Exp*e1=_T14D;struct Cyc_Absyn_Exp*e2=_T14C;_TE=e;_TF=& Cyc_InsertChecks_NoCheck_val;_T10=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_TF;
# 283
_TE->annot=(void*)_T10;
Cyc_InsertChecks_do_exp(nv,e1);
Cyc_InsertChecks_do_exp(nv,e2);goto _LL0;}case 6:{struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_T144;_T14D=_T14E->f1;_T14C=_T14E->f2;_T14B=_T14E->f3;}{struct Cyc_Absyn_Exp*e1=_T14D;struct Cyc_Absyn_Exp*e2=_T14C;struct Cyc_Absyn_Exp*e3=_T14B;_T11=e;_T12=& Cyc_InsertChecks_NoCheck_val;_T13=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T12;
# 288
_T11->annot=(void*)_T13;
Cyc_InsertChecks_do_exp(nv,e1);
Cyc_InsertChecks_do_exp(nv,e2);
Cyc_InsertChecks_do_exp(nv,e3);goto _LL0;}case 5:{struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_T144;_T14D=_T14E->f1;_T14A=_T14E->f2;}{struct Cyc_Absyn_Exp*e2=_T14D;enum Cyc_Absyn_Incrementor incr=_T14A;_T14=e;_T15=_T14->annot;_T16=& Cyc_InsertChecks_NoCheck_val;_T17=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T16;_T18=(void*)_T17;
# 299
...
_TL3C: _T2B=e;_T2C=& Cyc_InsertChecks_NoCheck_val;_T2D=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T2C;_T2B->annot=(void*)_T2D;_TL3D:
 Cyc_InsertChecks_do_exp(nv,e2);goto _LL0;}case 10:{struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_T144;_T14D=_T14E->f1;_T149=_T14E->f2;}{struct Cyc_Absyn_Exp*e1=_T14D;struct Cyc_List_List*es=_T149;_T2E=
# 313
...
# 318
es=_T3A->tl;goto _TL45;_TL44: goto _LL0;}case 14:{struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_T144;_T3B=_T14E->f1;_T14D=(void*)_T3B;_T14C=_T14E->f2;_T148=_T14E->f3;_T147=_T14E->f4;}{void*t=_T14D;struct Cyc_Absyn_Exp*e1=_T14C;int user_inserted=_T148;enum Cyc_Absyn_Coercion coercion=_T147;{struct _tuple13 _T14E;_T3D=e1;_T3E=_T3D->topt;_T3F=
# 325
_check_null(_T3E);_T14E.f0=Cyc_Absyn_compress(_T3F);_T14E.f1=Cyc_Absyn_compress(t);_T3C=_T14E;}{struct _tuple13 _T14E=_T3C;struct Cyc_Absyn_PtrInfo _T14F;struct Cyc_Absyn_PtrInfo _T150;_T40=_T14E.f0;_T41=(int*)_T40;_T42=*_T41;if(_T42!=4)goto _TL46;_T43=_T14E.f1;_T44=(int*)_T43;_T45=*_T44;if(_T45!=4)goto _TL48;_T46=_T14E.f0;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T151=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T46;_T150=_T151->f1;}_T47=_T14E.f1;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T151=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T47;_T14F=_T151->f1;}{struct Cyc_Absyn_PtrInfo p1=_T150;struct Cyc_Absyn_PtrInfo p2=_T14F;_T48=p1;_T49=_T48.ptr_atts;_T4A=_T49.nullable;{
# 327
...
_TL4D: _T5F=Cyc_Warn_impos_loc;{int(*_T151)(unsigned,struct _fat_ptr,struct _fat_ptr)=(int(*)(unsigned,struct _fat_ptr,struct _fat_ptr))_T5F;_T5E=_T151;}_T60=e;_T61=_T60->loc;_T62=_tag_fat("null-check conversion mis-classified",sizeof(char),37U);_T63=_tag_fat(0U,sizeof(void*),0);_T5E(_T61,_T62,_T63);goto _TL4B;
...
int(*_T151)(unsigned,struct _fat_ptr,struct _fat_ptr)=(int(*)(unsigned,struct _fat_ptr,struct _fat_ptr))_T6B;_T6A=_T151;}_T6C=e;_T6D=_T6C->loc;_T6E=_tag_fat("conversion mis-classified as null-check",sizeof(char),40U);_T6F=_tag_fat(0U,sizeof(void*),0);_T6A(_T6D,_T6E,_T6F);goto _TL50;_TL4F: _TL50: _TL4B:{struct _tuple14 _T151;
_T151.f0=b1;_T151.f1=b2;_T70=_T151;}{struct _tuple14 _T151=_T70;_T71=_T151.f0;if(_T71==0)goto _TL52;_T72=_T151.f1;if(_T72==0)goto _TL54;_T73=
# 338
Cyc_Evexp_lte_const_exp(b2,b1);if(_T73)goto _TL56;else{goto _TL58;}
_TL58: _T75=Cyc_Warn_impos_loc;{int(*_T152)(unsigned,struct _fat_ptr,struct _fat_ptr)=(int(*)(unsigned,struct _fat_ptr,struct _fat_ptr))_T75;_T74=_T152;}_T76=e;_T77=_T76->loc;_T78=_tag_fat("InsertChecks: cast to maybe-shorter pointer type",sizeof(char),49U);_T79=_tag_fat(0U,sizeof(void*),0);_T74(_T77,_T78,_T79);goto _TL57;_TL56: _TL57: _T7A=n1;
# 341
...
_T8F->annot=(void*)_T91;goto _LL5C;_TL52: _T92=_T151.f1;if(_T92==0)goto _TL62;_T93=nv;_T94=_T93.at_toplevel;
# 356
...
# 361
struct _tuple12 _T152=Cyc_InsertChecks_need_bound_null_check_annot(e);int _T153;int _T154;_T154=_T152.f0;_T153=_T152.f1;{int bds_ck=_T154;int null_ck=_T153;_T99=bds_ck;
if(!_T99)goto _TL66;
...
# 385
Cyc_InsertChecks_do_exp(nv,e1);goto _LL0;}case 22:{struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}{struct Cyc_Absyn_Exp*e1=_T14C;_T14C=e1;goto _LL20;}case 20:{struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}_LL20: {struct Cyc_Absyn_Exp*e1=_T14C;_T14C=e1;_T14B=
# 389
Cyc_InsertChecks_shared_zero_exp();goto _LL22;}case 23:{struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;_T14B=_T14E->f2;}_LL22: {struct Cyc_Absyn_Exp*e1=_T14C;struct Cyc_Absyn_Exp*e2=_T14B;_TBE=e1;_TBF=_TBE->topt;_TC0=
# 391
_check_null(_TBF);{void*_T14E=Cyc_Absyn_compress(_TC0);void*_T14F;void*_T150;void*_T151;void*_T152;struct Cyc_Absyn_Tqual _T153;void*_T154;_TC1=(int*)_T14E;_TC2=*_TC1;if(_TC2!=4)goto _TL77;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T155=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T14E;_TC3=_T155->f1;_T154=_TC3.elt_type;_TC4=_T155->f1;_T153=_TC4.elt_tq;_TC5=_T155->f1;_TC6=_TC5.ptr_atts;_T152=_TC6.eff;_TC7=_T155->f1;_TC8=_TC7.ptr_atts;_T151=_TC8.nullable;_TC9=_T155->f1;_TCA=_TC9.ptr_atts;_T150=_TCA.bounds;_TCB=_T155->f1;_TCC=_TCB.ptr_atts;_T14F=_TCC.zero_term;}{void*ta=_T154;struct Cyc_Absyn_Tqual tq=_T153;void*rgn=_T152;void*n=_T151;void*b=_T150;void*zt=_T14F;
# 393
struct _tuple12 _T155=Cyc_InsertChecks_need_bound_null_check_annot(e);int _T156;int _T157;_T157=_T155.f0;_T156=_T155.f1;{int bds_ck=_T157;int null_ck=_T156;_TCD=bds_ck;
# 396
if(!_TCD)goto _TL79;
...
if(!_TD1)goto _TL7D;_TD2=Cyc_Flags_warn_bounds_checks;if(!_TD2)goto _TL7D;{struct Cyc_String_pa_PrintArg_struct _T158;_T158.tag=0;
_T158.f1=Cyc_Absynpp_exp2string(e);_TD3=_T158;}{struct Cyc_String_pa_PrintArg_struct _T158=_TD3;void*_T159[1];_T159[0]=& _T158;_TD4=e1;_TD5=_TD4->loc;_TD6=_tag_fat("inserted bounds check at %s",sizeof(char),28U);_TD7=_tag_fat(_T159,sizeof(void*),1);Cyc_Warn_warn(_TD5,_TD6,_TD7);}goto _TL7E;_TL7D: _TL7E: _TD8=
...
# 423
_TL8E: _TE9=nv;_TEA=_TE9.assn_info;_TEB=e1;{struct Cyc_Vcgen_ExpChecks*ec=Cyc_Vcgen_exp2ctxt_checks(_TEA,_TEB);_TEC=e;_TED=_TEC->loc;{struct Cyc_String_pa_PrintArg_struct _T158;_T158.tag=0;_TF0=ec;_TF1=_TF0->bounds_check;
_T158.f1=Cyc_AssnDef_assn2string(_TF1);_TEF=_T158;}{struct Cyc_String_pa_PrintArg_struct _T158=_TEF;void*_T159[1];_T159[0]=& _T158;_TF2=_tag_fat("cannot determine subscript is in bounds (%s)",sizeof(char),45U);_TF3=_tag_fat(_T159,sizeof(void*),1);_TEE=Cyc_aprintf(_TF2,_TF3);}_TF4=_tag_fat(0U,sizeof(void*),0);Cyc_Warn_err(_TED,_TEE,_TF4);{struct Cyc_String_pa_PrintArg_struct _T158;_T158.tag=0;_TF6=ec;_TF7=_TF6->ctxt;
# 426
_T158.f1=Cyc_AssnDef_assnmap2string(_TF7);_TF5=_T158;}{struct Cyc_String_pa_PrintArg_struct _T158=_TF5;void*_T159[1];_T159[0]=& _T158;_TF8=Cyc_stderr;_TF9=
# 425
_tag_fat("[all that I can prove is %s",sizeof(char),28U);_TFA=_tag_fat(_T159,sizeof(void*),1);Cyc_fprintf(_TF8,_TF9,_TFA);}_TFB=Cyc_stderr;_TFC=
# 427
_tag_fat("]\n",sizeof(char),3U);_TFD=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_TFB,_TFC,_TFD);}goto _TL8D;_TL8C: _TL8D: _TFE=e;_T100=null_ck;
# 430
if(!_T100)goto _TL8F;{struct Cyc_InsertChecks_NullAndThinBound_Absyn_AbsynAnnot_struct*_T158=_cycalloc(sizeof(struct Cyc_InsertChecks_NullAndThinBound_Absyn_AbsynAnnot_struct));_T158->tag=Cyc_InsertChecks_NullAndThinBound;_T158->f1=bd;_T101=(struct Cyc_InsertChecks_NullAndThinBound_Absyn_AbsynAnnot_struct*)_T158;}_TFF=(void*)_T101;goto _TL90;_TL8F:{struct Cyc_InsertChecks_ThinBound_Absyn_AbsynAnnot_struct*_T158=_cycalloc(sizeof(struct Cyc_InsertChecks_ThinBound_Absyn_AbsynAnnot_struct));_T158->tag=Cyc_InsertChecks_ThinBound;_T158->f1=bd;_T102=(struct Cyc_InsertChecks_ThinBound_Absyn_AbsynAnnot_struct*)_T158;}_TFF=(void*)_T102;_TL90:
# 429
...
# 438
int(*_T155)(unsigned,struct _fat_ptr,struct _fat_ptr)=(int(*)(unsigned,struct _fat_ptr,struct _fat_ptr))_T112;_T111=_T155;}_T113=e;_T114=_T113->loc;_T115=_tag_fat("InsertChecks: non-pointer-type on dereference",sizeof(char),46U);_T116=_tag_fat(0U,sizeof(void*),0);_T111(_T114,_T115,_T116);_LL68:;}
# 440
Cyc_InsertChecks_do_exp(nv,e1);
Cyc_InsertChecks_do_exp(nv,e2);goto _LL0;}case 18:{struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}{struct Cyc_Absyn_Exp*e1=_T14C;_T117=e;_T118=& Cyc_InsertChecks_NoCheck_val;_T119=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T118;
# 445
_T117->annot=(void*)_T119;_T11A=
Cyc_InsertChecks_enter_sizeof(nv);_T11B=e1;Cyc_InsertChecks_do_exp(_T11A,_T11B);goto _LL0;}case 16:{struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;_T14B=_T14E->f2;_T146=_T14E->f3;}{struct Cyc_Absyn_Exp*rgnopt=_T14C;struct Cyc_Absyn_Exp*e1=_T14B;struct Cyc_Absyn_Exp*qualopt=_T146;_T11C=e;_T11D=& Cyc_InsertChecks_NoCheck_val;_T11E=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T11D;
# 450
_T11C->annot=(void*)_T11E;
Cyc_InsertChecks_do_exp_opt(nv,rgnopt);
Cyc_InsertChecks_do_exp_opt(nv,qualopt);
Cyc_InsertChecks_do_exp(nv,e1);goto _LL0;}case 33:{struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_T144;_T11F=_T14E->f1;_T14C=_T11F.rgn;_T120=_T14E->f1;_T14B=_T120.aqual;_T121=_T14E->f1;_T146=_T121.num_elts;}{struct Cyc_Absyn_Exp*rgnopt=_T14C;struct Cyc_Absyn_Exp*aqopt=_T14B;struct Cyc_Absyn_Exp*sizeexp=_T146;_T122=e;_T123=& Cyc_InsertChecks_NoCheck_val;_T124=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T123;
# 457
_T122->annot=(void*)_T124;
Cyc_InsertChecks_do_exp_opt(nv,rgnopt);
Cyc_InsertChecks_do_exp_opt(nv,aqopt);
Cyc_InsertChecks_do_exp(nv,sizeexp);goto _LL0;}case 41:{struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}{struct Cyc_Absyn_Exp*e1=_T14C;_T14C=e1;goto _LL2C;}case 40:{struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}_LL2C: {struct Cyc_Absyn_Exp*e1=_T14C;_T14C=e1;goto _LL2E;}case 11:{struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}_LL2E: {struct Cyc_Absyn_Exp*e1=_T14C;_T14C=e1;goto _LL30;}case 12:{struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}_LL30: {struct Cyc_Absyn_Exp*e1=_T14C;_T14C=e1;goto _LL32;}case 13:{struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}_LL32: {struct Cyc_Absyn_Exp*e1=_T14C;_T14C=e1;goto _LL34;}case 15:{struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}_LL34: {struct Cyc_Absyn_Exp*e1=_T14C;_T14C=e1;goto _LL36;}case 42:{struct Cyc_Absyn_Assert_false_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Assert_false_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}_LL36: {struct Cyc_Absyn_Exp*e1=_T14C;_T125=e;_T126=& Cyc_InsertChecks_NoCheck_val;_T127=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T126;
# 470
...
# 476
_T128->annot=(void*)_T12A;goto _LL0;case 21:{struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}{struct Cyc_Absyn_Exp*e1=_T14C;_T14C=e1;goto _LL42;}case 37:{struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}_LL42: {struct Cyc_Absyn_Exp*e1=_T14C;_T14C=e1;goto _LL44;}case 27:{struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;}_LL44: {struct Cyc_Absyn_Exp*e1=_T14C;_T12B=e;_T12C=& Cyc_InsertChecks_NoCheck_val;_T12D=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T12C;
# 480
_T12B->annot=(void*)_T12D;
Cyc_InsertChecks_do_exp(nv,e1);goto _LL0;}case 26:{struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f2;_T14B=_T14E->f3;}{struct Cyc_Absyn_Exp*e1=_T14C;struct Cyc_Absyn_Exp*e2=_T14B;_T14C=e1;_T14B=e2;goto _LL48;}case 34:{struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_T144;_T14C=_T14E->f1;_T14B=_T14E->f2;}_LL48: {struct Cyc_Absyn_Exp*e1=_T14C;struct Cyc_Absyn_Exp*e2=_T14B;_T12E=e;_T12F=& Cyc_InsertChecks_NoCheck_val;_T130=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T12F;
# 485
_T12E->annot=(void*)_T130;
Cyc_InsertChecks_do_exp(nv,e1);
Cyc_InsertChecks_do_exp(nv,e2);goto _LL0;}case 25:{struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_T144;_T149=_T14E->f1;}{struct Cyc_List_List*dles=_T149;_T149=dles;goto _LL4C;}case 28:{struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_T144;_T149=_T14E->f3;}_LL4C: {struct Cyc_List_List*dles=_T149;_T149=dles;goto _LL4E;}case 29:{struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_T144;_T149=_T14E->f3;}_LL4E: {struct Cyc_List_List*dles=_T149;_T131=e;_T132=& Cyc_InsertChecks_NoCheck_val;_T133=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T132;
# 492
...
# 493
dles=_T13A->tl;goto _TL98;_TL97: goto _LL0;}case 36:{struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_T14E=(struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_T144;_T145=_T14E->f1;}{struct Cyc_Absyn_Stmt*s=_T145;_T13B=e;_T13C=& Cyc_InsertChecks_NoCheck_val;_T13D=(struct Cyc_InsertChecks_NoCheck_Absyn_AbsynAnnot_struct*)_T13C;
# 496
_T13B->annot=(void*)_T13D;Cyc_InsertChecks_do_stmt(nv,s);goto _LL0;}case 35: goto _LL54;case 24: _LL54: goto _LL56;default: _LL56: _T13F=Cyc_Warn_impos_loc;{
# 500
int(*_T14E)(unsigned,struct _fat_ptr,struct _fat_ptr)=(int(*)(unsigned,struct _fat_ptr,struct _fat_ptr))_T13F;_T13E=_T14E;}_T140=e;_T141=_T140->loc;_T142=_tag_fat("InsertChecks, unexpected exp form",sizeof(char),34U);_T143=_tag_fat(0U,sizeof(void*),0);_T13E(_T141,_T142,_T143);}_LL0:;}}
# 504
