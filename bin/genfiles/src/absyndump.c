...
_temp1146); if( _temp1148 != 0){ Cyc_Absyndump_dump_char(( int)':'); Cyc_Absyndump_dumpexp((
struct Cyc_Absyn_Exp*) _temp1148->v);} Cyc_Absyndump_dump_semi();}} void Cyc_Absyndump_dumptypedefname(
