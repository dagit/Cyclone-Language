...
GC_malloc( sizeof( struct _tagged_arr*) * _temp59); struct _tagged_arr _temp65=
...
_tagged_arr)({ struct Cyc_Stdio_Int_pa_struct _temp64; _temp64.tag= Cyc_Stdio_Int_pa;
_temp64.f1=( int) j;{ void* _temp63[ 1u]={& _temp64}; Cyc_Stdio_aprintf(
_tag_arr("f%d", sizeof( unsigned char), 4u), _tag_arr( _temp63, sizeof( void*),
1u));}}); _temp62;});}}; _temp65;});} return*(( struct _tagged_arr**)
...
_temp66)->f1; if( _temp108 ==( void*) Cyc_Absyn_Null_c){ goto _LL77;} else{ goto
...
_LL71: return _temp98 == 0; _LL73: return _temp102 == 0; _LL75: return _temp106
== 0; _LL77: return 1; _LL79: return Cyc_Toc_is_zero( _temp110); _LL81: return((
int(*)( int(* pred)( struct Cyc_Absyn_Exp*), struct Cyc_List_List* x)) Cyc_List_forall)(
Cyc_Toc_is_zero, _temp112); _LL83: _temp116= _temp114; goto _LL85; _LL85:
_temp118= _temp116; goto _LL87; _LL87: _temp120= _temp118; goto _LL89; _LL89:
for( 0; _temp120 != 0; _temp120=(( struct Cyc_List_List*) _check_null( _temp120))->tl){
if( ! Cyc_Toc_is_zero((*(( struct _tuple4*)(( struct Cyc_List_List*) _check_null(
_temp120))->hd)).f2)){ return 0;}} return 1; _LL91: return 0; _LL67:;} static
int Cyc_Toc_is_nullable( void* t){ void* _temp122= Cyc_Tcutil_compress( t);
struct Cyc_Absyn_PtrInfo _temp128; struct Cyc_Absyn_Conref* _temp130; _LL124:
if(( unsigned int) _temp122 > 4u?*(( int*) _temp122) == Cyc_Absyn_PointerType: 0){
_LL129: _temp128=(( struct Cyc_Absyn_PointerType_struct*) _temp122)->f1; _LL131:
_temp130= _temp128.nullable; goto _LL125;} else{ goto _LL126;} _LL126: goto
_LL127; _LL125: return(( int(*)( int, struct Cyc_Absyn_Conref* x)) Cyc_Absyn_conref_def)(
...
GC_malloc( sizeof( struct _tuple0)); _temp133->f1=(* x).f1; _temp133->f2=({
struct _tagged_arr* _temp134=( struct _tagged_arr*) GC_malloc( sizeof( struct
_tagged_arr)); _temp134[ 0]=( struct _tagged_arr) Cyc_String_strconcat(*(* x).f2,
...
_temp143= tqs0; for( 0; _temp143 != 0? _temp139 != 0: 0;( _temp143=(( struct Cyc_List_List*)
_check_null( _temp143))->tl, _temp139=(( struct Cyc_List_List*) _check_null(
_temp139))->tl)){ if( ! Cyc_Tcutil_unify((*(( struct _tuple3*)(( struct Cyc_List_List*)
_check_null( _temp143))->hd)).f2,( void*)(( struct Cyc_List_List*) _check_null(
_temp139))->hd)){ break;}} if( _temp143 == 0? _temp139 == 0: 0){ return _temp141;}}}}{
struct _tagged_arr* x=({ struct _tagged_arr* _temp157=( struct _tagged_arr*)
GC_malloc( sizeof( struct _tagged_arr)); _temp157[ 0]=( struct _tagged_arr)({
struct Cyc_Stdio_Int_pa_struct _temp159; _temp159.tag= Cyc_Stdio_Int_pa;
_temp159.f1=( int)(( unsigned int) Cyc_Toc_tuple_type_counter ++);{ void*
_temp158[ 1u]={& _temp159}; Cyc_Stdio_aprintf( _tag_arr("_tuple%d", sizeof(
...
GC_malloc( sizeof( struct Cyc_Absyn_Structfield)); _temp146->name= Cyc_Toc_fieldname(
...
GC_malloc( sizeof( struct Cyc_Absyn_Structdecl)); _temp153->sc=( void*)(( void*)
Cyc_Absyn_Public); _temp153->name=({ struct Cyc_Core_Opt* _temp155=( struct Cyc_Core_Opt*)
GC_malloc( sizeof( struct Cyc_Core_Opt)); _temp155->v=( void*)({ struct _tuple0*
...
GC_malloc( sizeof( struct Cyc_Core_Opt)); _temp154->v=( void*) _temp144;
_temp154;}); _temp153->attributes= 0; _temp153;}); Cyc_Toc_result_decls=({
struct Cyc_List_List* _temp148=( struct Cyc_List_List*) GC_malloc( sizeof(
...
GC_malloc( sizeof( struct Cyc_Absyn_Struct_d_struct)); _temp149[ 0]=({ struct
...
GC_malloc( sizeof( struct Cyc_List_List)); _temp151->hd=( void*)({ struct
_tuple5* _temp152=( struct _tuple5*) GC_malloc( sizeof( struct _tuple5));
...
_tuple0* _temp160=( struct _tuple0*) GC_malloc( sizeof( struct _tuple0));
_temp160->f1=( void*) Cyc_Absyn_Loc_n; _temp160->f2=({ struct _tagged_arr*
_temp161=( struct _tagged_arr*) GC_malloc( sizeof( struct _tagged_arr));
_temp161[ 0]=( struct _tagged_arr)({ struct Cyc_Stdio_Int_pa_struct _temp163;
_temp163.tag= Cyc_Stdio_Int_pa; _temp163.f1=( int)(( unsigned int) Cyc_Toc_temp_var_counter
++);{ void* _temp162[ 1u]={& _temp163}; Cyc_Stdio_aprintf( _tag_arr("_temp%d",
sizeof( unsigned char), 8u), _tag_arr( _temp162, sizeof( void*), 1u));}});
_temp161;}); _temp160;});} static struct _tagged_arr* Cyc_Toc_fresh_label(){
return({ struct _tagged_arr* _temp164=( struct _tagged_arr*) GC_malloc( sizeof(
struct _tagged_arr)); _temp164[ 0]=( struct _tagged_arr)({ struct Cyc_Stdio_Int_pa_struct
_temp166; _temp166.tag= Cyc_Stdio_Int_pa; _temp166.f1=( int)(( unsigned int) Cyc_Toc_temp_var_counter
++);{ void* _temp165[ 1u]={& _temp166}; Cyc_Stdio_aprintf( _tag_arr("_LL%d",
...
_temp175=( struct _tuple1*) GC_malloc( sizeof( struct _tuple1)); _temp175->f1=
...
_LL177; _LL177: return({ struct _tuple3* _temp182=( struct _tuple3*) GC_malloc(
...
void* _temp322; _LL207: if( _temp205 ==( void*) Cyc_Absyn_VoidType){ goto _LL208;}
else{ goto _LL209;} _LL209: if(( unsigned int) _temp205 > 4u?*(( int*) _temp205)
== Cyc_Absyn_Evar: 0){ _LL258: _temp257=(( struct Cyc_Absyn_Evar_struct*)
_temp205)->f2; if( _temp257 == 0){ goto _LL210;} else{ goto _LL211;}} else{ goto
_LL211;} _LL211: if(( unsigned int) _temp205 > 4u?*(( int*) _temp205) == Cyc_Absyn_Evar:
0){ _LL260: _temp259=(( struct Cyc_Absyn_Evar_struct*) _temp205)->f2; if(
_temp259 == 0){ goto _LL213;} else{ _temp261=* _temp259; _LL263: _temp262=( void*)
_temp261.v; goto _LL212;}} else{ goto _LL213;} _LL213: if(( unsigned int)
_temp205 > 4u?*(( int*) _temp205) == Cyc_Absyn_VarType: 0){ goto _LL214;} else{
goto _LL215;} _LL215: if(( unsigned int) _temp205 > 4u?*(( int*) _temp205) ==
Cyc_Absyn_TunionType: 0){ _LL265: _temp264=(( struct Cyc_Absyn_TunionType_struct*)
_temp205)->f1; _LL267: _temp266=( void*) _temp264.tunion_info; if(*(( int*)
_temp266) == Cyc_Absyn_KnownTunion){ _LL269: _temp268=(( struct Cyc_Absyn_KnownTunion_struct*)
_temp266)->f1; goto _LL216;} else{ goto _LL217;}} else{ goto _LL217;} _LL217:
if(( unsigned int) _temp205 > 4u?*(( int*) _temp205) == Cyc_Absyn_TunionType: 0){
goto _LL218;} else{ goto _LL219;} _LL219: if(( unsigned int) _temp205 > 4u?*((
int*) _temp205) == Cyc_Absyn_TunionFieldType: 0){ _LL271: _temp270=(( struct Cyc_Absyn_TunionFieldType_struct*)
_temp205)->f1; _LL273: _temp272=( void*) _temp270.field_info; if(*(( int*)
...
_temp272)->f2; goto _LL220;} else{ goto _LL221;}} else{ goto _LL221;} _LL221:
...
int*) _temp205) == Cyc_Absyn_PointerType: 0){ _LL279: _temp278=(( struct Cyc_Absyn_PointerType_struct*)
_temp205)->f1; _LL285: _temp284=( void*) _temp278.elt_typ; goto _LL283; _LL283:
...
0){ _LL291: _temp290=( void*)(( struct Cyc_Absyn_ArrayType_struct*) _temp205)->f1;
goto _LL289; _LL289: _temp288=(( struct Cyc_Absyn_ArrayType_struct*) _temp205)->f2;
goto _LL287; _LL287: _temp286=(( struct Cyc_Absyn_ArrayType_struct*) _temp205)->f3;
goto _LL232;} else{ goto _LL233;} _LL233: if(( unsigned int) _temp205 > 4u?*((
int*) _temp205) == Cyc_Absyn_FnType: 0){ _LL293: _temp292=(( struct Cyc_Absyn_FnType_struct*)
_temp205)->f1; _LL303: _temp302=( void*) _temp292.ret_typ; goto _LL301; _LL301:
...
_temp292.attributes; goto _LL234;} else{ goto _LL235;} _LL235: if(( unsigned int)
_temp205 > 4u?*(( int*) _temp205) == Cyc_Absyn_TupleType: 0){ _LL305: _temp304=((
...
0){ _LL307: _temp306=(( struct Cyc_Absyn_AnonStructType_struct*) _temp205)->f1;
goto _LL238;} else{ goto _LL239;} _LL239: if(( unsigned int) _temp205 > 4u?*((
int*) _temp205) == Cyc_Absyn_AnonUnionType: 0){ _LL309: _temp308=(( struct Cyc_Absyn_AnonUnionType_struct*)
_temp205)->f1; goto _LL240;} else{ goto _LL241;} _LL241: if(( unsigned int)
_temp205 > 4u?*(( int*) _temp205) == Cyc_Absyn_UnionType: 0){ _LL311: _temp310=((
...
0){ _LL313: _temp312=(( struct Cyc_Absyn_StructType_struct*) _temp205)->f1; goto
_LL244;} else{ goto _LL245;} _LL245: if(( unsigned int) _temp205 > 4u?*(( int*)
_temp205) == Cyc_Absyn_EnumType: 0){ _LL315: _temp314=(( struct Cyc_Absyn_EnumType_struct*)
_temp205)->f1; goto _LL246;} else{ goto _LL247;} _LL247: if(( unsigned int)
_temp205 > 4u?*(( int*) _temp205) == Cyc_Absyn_TypedefType: 0){ _LL321: _temp320=((
struct Cyc_Absyn_TypedefType_struct*) _temp205)->f1; goto _LL319; _LL319:
_temp318=(( struct Cyc_Absyn_TypedefType_struct*) _temp205)->f2; goto _LL317;
_LL317: _temp316=(( struct Cyc_Absyn_TypedefType_struct*) _temp205)->f3; goto
_LL248;} else{ goto _LL249;} _LL249: if(( unsigned int) _temp205 > 4u?*(( int*)
_temp205) == Cyc_Absyn_RgnHandleType: 0){ _LL323: _temp322=( void*)(( struct Cyc_Absyn_RgnHandleType_struct*)
_temp205)->f1; goto _LL250;} else{ goto _LL251;} _LL251: if( _temp205 ==( void*)
Cyc_Absyn_HeapRgn){ goto _LL252;} else{ goto _LL253;} _LL253: if(( unsigned int)
_temp205 > 4u?*(( int*) _temp205) == Cyc_Absyn_AccessEff: 0){ goto _LL254;}
else{ goto _LL255;} _LL255: if(( unsigned int) _temp205 > 4u?*(( int*) _temp205)
== Cyc_Absyn_JoinEff: 0){ goto _LL256;} else{ goto _LL206;} _LL208: return t;
_LL210: return Cyc_Absyn_sint_t; _LL212: return Cyc_Toc_typ_to_c( _temp262);
_LL214: return Cyc_Absyn_void_star_typ(); _LL216: return Cyc_Absyn_void_star_typ();
_LL218:( int) _throw(({ void* _temp324[ 0u]={}; Cyc_Tcutil_impos( _tag_arr("unresolved TunionType",
sizeof( unsigned char), 22u), _tag_arr( _temp324, sizeof( void*), 0u));}));
_LL220: if( _temp274->typs == 0){ if( _temp276->is_xtunion){ return Cyc_Absyn_star_typ(
...
_LL224: _temp284= Cyc_Toc_typ_to_c_array( _temp284);{ void* _temp326=( void*)(
...
_LL327:;} _LL226: return t; _LL228: return t; _LL230: return t; _LL232: return(
...
_temp286; _temp335;}); _temp334;}); _LL234: { struct Cyc_List_List* _temp336= 0;
...
_LL236: _temp304=(( struct Cyc_List_List*(*)( struct _tuple3*(* f)( struct
...
_temp356);} _LL238: return( void*)({ struct Cyc_Absyn_AnonStructType_struct*
...
_LL240: return( void*)({ struct Cyc_Absyn_AnonUnionType_struct* _temp359=(
...
_temp308); _temp360;}); _temp359;}); _LL242: if( _temp310 == 0){({ void*
...
_check_null( _temp310)); _LL244: if( _temp312 == 0){({ void* _temp362[ 0u]={};((
...
return Cyc_Absyn_strctq(( struct _tuple0*) _check_null( _temp312)); _LL246:
return t; _LL248: if( _temp316 == 0){ return({ void* _temp363[ 0u]={}; Cyc_Toc_toc_impos(
...
_check_null( _temp316))->v); _temp366;}); _temp365;}); _temp364;}); _LL250:
return Cyc_Absyn_cstar_typ( Cyc_Absyn_strct( Cyc_Toc__RegionHandle_sp), Cyc_Toc_mt_tq);
_LL252: return({ void* _temp367[ 0u]={}; Cyc_Toc_toc_impos( _tag_arr("Toc::typ_to_c: type translation passed the heap region",
sizeof( unsigned char), 55u), _tag_arr( _temp367, sizeof( void*), 0u));});
_LL254: return({ void* _temp368[ 0u]={}; Cyc_Toc_toc_impos( _tag_arr("Toc::typ_to_c: type translation passed the access eff",
sizeof( unsigned char), 54u), _tag_arr( _temp368, sizeof( void*), 0u));});
_LL256: return({ void* _temp369[ 0u]={}; Cyc_Toc_toc_impos( _tag_arr("Toc::typ_to_c: type translation passed the join eff",
...
struct Cyc_Absyn_Exp* e, struct Cyc_Position_Segment* l){ void* _temp370= t;
struct Cyc_Absyn_Tqual _temp376; void* _temp378; _LL372: if(( unsigned int)
_temp370 > 4u?*(( int*) _temp370) == Cyc_Absyn_ArrayType: 0){ _LL379: _temp378=(
void*)(( struct Cyc_Absyn_ArrayType_struct*) _temp370)->f1; goto _LL377; _LL377:
_temp376=(( struct Cyc_Absyn_ArrayType_struct*) _temp370)->f2; goto _LL373;}
else{ goto _LL374;} _LL374: goto _LL375; _LL373: return Cyc_Absyn_cast_exp( Cyc_Absyn_star_typ(
_temp378,( void*) Cyc_Absyn_HeapRgn, _temp376), e, l); _LL375: return Cyc_Absyn_cast_exp(
t, e, l); _LL371:;} static int Cyc_Toc_atomic_typ( void* t){ void* _temp380= Cyc_Tcutil_compress(
...
_temp432; struct Cyc_List_List* _temp434; _LL382: if( _temp380 ==( void*) Cyc_Absyn_VoidType){
goto _LL383;} else{ goto _LL384;} _LL384: if(( unsigned int) _temp380 > 4u?*((
int*) _temp380) == Cyc_Absyn_VarType: 0){ goto _LL385;} else{ goto _LL386;}
_LL386: if(( unsigned int) _temp380 > 4u?*(( int*) _temp380) == Cyc_Absyn_IntType:
0){ goto _LL387;} else{ goto _LL388;} _LL388: if(( unsigned int) _temp380 > 4u?*((
int*) _temp380) == Cyc_Absyn_EnumType: 0){ goto _LL389;} else{ goto _LL390;}
_LL390: if( _temp380 ==( void*) Cyc_Absyn_FloatType){ goto _LL391;} else{ goto
_LL392;} _LL392: if( _temp380 ==( void*) Cyc_Absyn_DoubleType){ goto _LL393;}
else{ goto _LL394;} _LL394: if(( unsigned int) _temp380 > 4u?*(( int*) _temp380)
== Cyc_Absyn_FnType: 0){ goto _LL395;} else{ goto _LL396;} _LL396: if((
unsigned int) _temp380 > 4u?*(( int*) _temp380) == Cyc_Absyn_ArrayType: 0){
_LL419: _temp418=( void*)(( struct Cyc_Absyn_ArrayType_struct*) _temp380)->f1;
goto _LL397;} else{ goto _LL398;} _LL398: if(( unsigned int) _temp380 > 4u?*((
int*) _temp380) == Cyc_Absyn_StructType: 0){ _LL421: _temp420=(( struct Cyc_Absyn_StructType_struct*)
_temp380)->f3; goto _LL399;} else{ goto _LL400;} _LL400: if(( unsigned int)
_temp380 > 4u?*(( int*) _temp380) == Cyc_Absyn_AnonStructType: 0){ _LL423:
_temp422=(( struct Cyc_Absyn_AnonStructType_struct*) _temp380)->f1; goto _LL401;}
else{ goto _LL402;} _LL402: if(( unsigned int) _temp380 > 4u?*(( int*) _temp380)
== Cyc_Absyn_AnonUnionType: 0){ _LL425: _temp424=(( struct Cyc_Absyn_AnonUnionType_struct*)
_temp380)->f1; goto _LL403;} else{ goto _LL404;} _LL404: if(( unsigned int)
_temp380 > 4u?*(( int*) _temp380) == Cyc_Absyn_TunionFieldType: 0){ _LL427:
_temp426=(( struct Cyc_Absyn_TunionFieldType_struct*) _temp380)->f1; _LL429:
...
if(( unsigned int) _temp380 > 4u?*(( int*) _temp380) == Cyc_Absyn_TupleType: 0){
_LL435: _temp434=(( struct Cyc_Absyn_TupleType_struct*) _temp380)->f1; goto
_LL407;} else{ goto _LL408;} _LL408: if(( unsigned int) _temp380 > 4u?*(( int*)
_temp380) == Cyc_Absyn_TunionType: 0){ goto _LL409;} else{ goto _LL410;} _LL410:
if(( unsigned int) _temp380 > 4u?*(( int*) _temp380) == Cyc_Absyn_UnionType: 0){
goto _LL411;} else{ goto _LL412;} _LL412: if(( unsigned int) _temp380 > 4u?*((
int*) _temp380) == Cyc_Absyn_PointerType: 0){ goto _LL413;} else{ goto _LL414;}
_LL414: if(( unsigned int) _temp380 > 4u?*(( int*) _temp380) == Cyc_Absyn_RgnHandleType:
0){ goto _LL415;} else{ goto _LL416;} _LL416: goto _LL417; _LL383: return 1;
_LL385: return 0; _LL387: return 1; _LL389: return 1; _LL391: return 1; _LL393:
return 1; _LL395: return 1; _LL397: return Cyc_Toc_atomic_typ( _temp418); _LL399:
if( _temp420 == 0? 1:(*(( struct Cyc_Absyn_Structdecl**) _check_null( _temp420)))->fields
== 0){ return 0;}{ struct Cyc_List_List* _temp436=( struct Cyc_List_List*)((
struct Cyc_Core_Opt*) _check_null((*(( struct Cyc_Absyn_Structdecl**)
_check_null( _temp420)))->fields))->v; for( 0; _temp436 != 0; _temp436=(( struct
Cyc_List_List*) _check_null( _temp436))->tl){ if( ! Cyc_Toc_atomic_typ(( void*)((
struct Cyc_Absyn_Structfield*)(( struct Cyc_List_List*) _check_null( _temp436))->hd)->type)){
return 0;}}} return 1; _LL401: _temp424= _temp422; goto _LL403; _LL403: for( 0;
_temp424 != 0; _temp424=(( struct Cyc_List_List*) _check_null( _temp424))->tl){
if( ! Cyc_Toc_atomic_typ(( void*)(( struct Cyc_Absyn_Structfield*)(( struct Cyc_List_List*)
_check_null( _temp424))->hd)->type)){ return 0;}} return 1; _LL405: _temp434=
_temp430->typs; goto _LL407; _LL407: for( 0; _temp434 != 0; _temp434=(( struct
Cyc_List_List*) _check_null( _temp434))->tl){ if( ! Cyc_Toc_atomic_typ((*((
...
_LL415: return 0; _LL417:({ struct Cyc_Stdio_String_pa_struct _temp438; _temp438.tag=
Cyc_Stdio_String_pa; _temp438.f1=( struct _tagged_arr) Cyc_Absynpp_typ2string( t);{
...
return 0; _LL381:;} static int Cyc_Toc_is_void_star( void* t){ void* _temp439=
...
_temp470, f); if( _temp473 == 0){({ struct Cyc_Stdio_String_pa_struct _temp475;
_temp475.tag= Cyc_Stdio_String_pa; _temp475.f1=( struct _tagged_arr)*(( struct
Cyc_Absyn_Structfield*) _check_null( _temp473))->name;{ void* _temp474[ 1u]={&
_temp475};(( int(*)( struct _tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_toc_impos)(
_tag_arr("is_poly_field: bad field %s", sizeof( unsigned char), 28u), _tag_arr(
_temp474, sizeof( void*), 1u));}});} return Cyc_Toc_is_void_star(( void*)((
struct Cyc_Absyn_Structfield*) _check_null( _temp473))->type);} _LL462: return 0;
_LL464: return 0; _LL466:( int) _throw(({ struct Cyc_Stdio_String_pa_struct
_temp477; _temp477.tag= Cyc_Stdio_String_pa; _temp477.f1=( struct _tagged_arr)
Cyc_Absynpp_typ2string( t);{ void* _temp476[ 1u]={& _temp477}; Cyc_Toc_toc_impos(
_tag_arr("is_poly_field: bad type %s", sizeof( unsigned char), 27u), _tag_arr(
_temp476, sizeof( void*), 1u));}})); _LL456:;} static int Cyc_Toc_is_poly_project(
struct Cyc_Absyn_Exp* e){ void* _temp478=( void*) e->r; struct _tagged_arr*
_temp486; struct Cyc_Absyn_Exp* _temp488; struct _tagged_arr* _temp490; struct
Cyc_Absyn_Exp* _temp492; _LL480: if(*(( int*) _temp478) == Cyc_Absyn_StructMember_e){
_LL489: _temp488=(( struct Cyc_Absyn_StructMember_e_struct*) _temp478)->f1; goto
_LL487; _LL487: _temp486=(( struct Cyc_Absyn_StructMember_e_struct*) _temp478)->f2;
goto _LL481;} else{ goto _LL482;} _LL482: if(*(( int*) _temp478) == Cyc_Absyn_StructArrow_e){
_LL493: _temp492=(( struct Cyc_Absyn_StructArrow_e_struct*) _temp478)->f1; goto
_LL491; _LL491: _temp490=(( struct Cyc_Absyn_StructArrow_e_struct*) _temp478)->f2;
goto _LL483;} else{ goto _LL484;} _LL484: goto _LL485; _LL481: return Cyc_Toc_is_poly_field((
...
_temp502; _LL496: if(( unsigned int) _temp494 > 4u?*(( int*) _temp494) == Cyc_Absyn_PointerType:
...
_LL499:({ struct Cyc_Stdio_String_pa_struct _temp505; _temp505.tag= Cyc_Stdio_String_pa;
...
2u));}), 0);} static struct Cyc_Absyn_Exp* Cyc_Toc_fdconv( struct Cyc_Absyn_Exp*
e){ return Cyc_Absyn_fncall_exp( Cyc_Toc__sfile_to_file_e,({ struct Cyc_List_List*
...
struct Cyc_List_List* _temp510=( struct Cyc_List_List*) GC_malloc( sizeof(
struct Cyc_List_List)); _temp510->hd=( void*) e; _temp510->tl= 0; _temp510;}), 0);}
static struct Cyc_Absyn_Exp* Cyc_Toc_make_toplevel_tagged_arr( void* t, struct
Cyc_Absyn_Exp* sz, struct Cyc_Absyn_Exp* e){ int is_string= 0;{ void* _temp511=(
void*) e->r; void* _temp517; _LL513: if(*(( int*) _temp511) == Cyc_Absyn_Const_e){
_LL518: _temp517=( void*)(( struct Cyc_Absyn_Const_e_struct*) _temp511)->f1; if((
unsigned int) _temp517 > 1u?*(( int*) _temp517) == Cyc_Absyn_String_c: 0){ goto
_LL514;} else{ goto _LL515;}} else{ goto _LL515;} _LL515: goto _LL516; _LL514:
is_string= 1; goto _LL512; _LL516: goto _LL512; _LL512:;}{ struct Cyc_Absyn_Exp*
...
Cyc_Toc_lvalue_assign( e1,({ struct Cyc_List_List* _temp762=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp762->hd=( void*) _temp758;
_temp762->tl= fs; _temp762;}), f, f_env); goto _LL743; _LL751: if( ! Cyc_Absyn_is_lvalue(
e1)){({ struct Cyc_Stdio_String_pa_struct _temp764; _temp764.tag= Cyc_Stdio_String_pa;
_temp764.f1=( struct _tagged_arr) Cyc_Absynpp_exp2string( e1);{ void* _temp763[
1u]={& _temp764};(( int(*)( struct _tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_toc_impos)(
_tag_arr("lvalue_assign: could not find lvalue in `%s'", sizeof( unsigned char),
45u), _tag_arr( _temp763, sizeof( void*), 1u));}});}{ struct Cyc_Absyn_Exp*
...
void*)( e1->r=( void*)(( void*)( f( e1_copy, f_env))->r)); goto _LL743;} _LL743:;}
static void Cyc_Toc_lvalue_assign_stmt( struct Cyc_Absyn_Stmt* s, struct Cyc_List_List*
fs, struct Cyc_Absyn_Exp*(* f)( struct Cyc_Absyn_Exp*, void*), void* f_env){
void* _temp765=( void*) s->r; struct Cyc_Absyn_Exp* _temp775; struct Cyc_Absyn_Stmt*
_temp777; struct Cyc_Absyn_Decl* _temp779; struct Cyc_Absyn_Stmt* _temp781;
_LL767: if(( unsigned int) _temp765 > 1u?*(( int*) _temp765) == Cyc_Absyn_Exp_s:
0){ _LL776: _temp775=(( struct Cyc_Absyn_Exp_s_struct*) _temp765)->f1; goto
_LL768;} else{ goto _LL769;} _LL769: if(( unsigned int) _temp765 > 1u?*(( int*)
_temp765) == Cyc_Absyn_Decl_s: 0){ _LL780: _temp779=(( struct Cyc_Absyn_Decl_s_struct*)
_temp765)->f1; goto _LL778; _LL778: _temp777=(( struct Cyc_Absyn_Decl_s_struct*)
_temp765)->f2; goto _LL770;} else{ goto _LL771;} _LL771: if(( unsigned int)
_temp765 > 1u?*(( int*) _temp765) == Cyc_Absyn_Seq_s: 0){ _LL782: _temp781=((
struct Cyc_Absyn_Seq_s_struct*) _temp765)->f2; goto _LL772;} else{ goto _LL773;}
_LL773: goto _LL774; _LL768: Cyc_Toc_lvalue_assign( _temp775, fs, f, f_env);
goto _LL766; _LL770: Cyc_Toc_lvalue_assign_stmt( _temp777, fs, f, f_env); goto
_LL766; _LL772: Cyc_Toc_lvalue_assign_stmt( _temp781, fs, f, f_env); goto _LL766;
_LL774:({ struct Cyc_Stdio_String_pa_struct _temp784; _temp784.tag= Cyc_Stdio_String_pa;
_temp784.f1=( struct _tagged_arr) Cyc_Absynpp_stmt2string( s);{ void* _temp783[
1u]={& _temp784};(( int(*)( struct _tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_toc_impos)(
_tag_arr("lvalue_assign_stmt: %s", sizeof( unsigned char), 23u), _tag_arr(
_temp783, sizeof( void*), 1u));}}); goto _LL766; _LL766:;} static struct Cyc_List_List*
...
prev; if( x == 0){ return 0;} result=({ struct Cyc_List_List* _temp785=( struct
Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List)); _temp785->hd=(
void*) f(( void*)(( struct Cyc_List_List*) _check_null( x))->hd, env); _temp785->tl=
0; _temp785;}); prev= result; for( x=(( struct Cyc_List_List*) _check_null( x))->tl;
...
struct Cyc_List_List* x)) Cyc_List_map)( Cyc_Toc_get_cyc_typ, _temp888); struct
Cyc_List_List* _temp1034=(( struct Cyc_List_List*(*)( void*(* f)( struct Cyc_Absyn_Exp*),
struct Cyc_List_List* x)) Cyc_List_map)( Cyc_Toc_get_c_typ, _temp888);(( void(*)(
...
void* _temp1035= _temp890; _LL1037: if( _temp1035 ==( void*) Cyc_Absyn_Size){
goto _LL1038;} else{ goto _LL1039;} _LL1039: if( _temp1035 ==( void*) Cyc_Absyn_Plus){
goto _LL1040;} else{ goto _LL1041;} _LL1041: if( _temp1035 ==( void*) Cyc_Absyn_Minus){
goto _LL1042;} else{ goto _LL1043;} _LL1043: if( _temp1035 ==( void*) Cyc_Absyn_Eq){
goto _LL1044;} else{ goto _LL1045;} _LL1045: if( _temp1035 ==( void*) Cyc_Absyn_Neq){
goto _LL1046;} else{ goto _LL1047;} _LL1047: if( _temp1035 ==( void*) Cyc_Absyn_Gt){
goto _LL1048;} else{ goto _LL1049;} _LL1049: if( _temp1035 ==( void*) Cyc_Absyn_Gte){
goto _LL1050;} else{ goto _LL1051;} _LL1051: if( _temp1035 ==( void*) Cyc_Absyn_Lt){
goto _LL1052;} else{ goto _LL1053;} _LL1053: if( _temp1035 ==( void*) Cyc_Absyn_Lte){
goto _LL1054;} else{ goto _LL1055;} _LL1055: goto _LL1056; _LL1038: { struct Cyc_Absyn_Exp*
arg=( struct Cyc_Absyn_Exp*)(( struct Cyc_List_List*) _check_null( _temp888))->hd;{
void* _temp1057=( void*)(( struct Cyc_Core_Opt*) _check_null( arg->topt))->v;
struct Cyc_Absyn_Exp* _temp1065; struct Cyc_Absyn_PtrInfo _temp1067; struct Cyc_Absyn_Conref*
_temp1069; void* _temp1071; _LL1059: if(( unsigned int) _temp1057 > 4u?*(( int*)
_temp1057) == Cyc_Absyn_ArrayType: 0){ _LL1066: _temp1065=(( struct Cyc_Absyn_ArrayType_struct*)
_temp1057)->f3; goto _LL1060;} else{ goto _LL1061;} _LL1061: if(( unsigned int)
_temp1057 > 4u?*(( int*) _temp1057) == Cyc_Absyn_PointerType: 0){ _LL1068:
_temp1067=(( struct Cyc_Absyn_PointerType_struct*) _temp1057)->f1; _LL1072:
_temp1071=( void*) _temp1067.elt_typ; goto _LL1070; _LL1070: _temp1069=
_temp1067.bounds; goto _LL1062;} else{ goto _LL1063;} _LL1063: goto _LL1064;
_LL1060:( void*)( e->r=( void*)(( void*)(( struct Cyc_Absyn_Exp*) _check_null(
_temp1065))->r)); goto _LL1058; _LL1062:{ void* _temp1073= Cyc_Absyn_conref_def(
Cyc_Absyn_bounds_one, _temp1069); struct Cyc_Absyn_Exp* _temp1079; _LL1075: if(
_temp1073 ==( void*) Cyc_Absyn_Unknown_b){ goto _LL1076;} else{ goto _LL1077;}
_LL1077: if(( unsigned int) _temp1073 > 1u?*(( int*) _temp1073) == Cyc_Absyn_Upper_b:
0){ _LL1080: _temp1079=(( struct Cyc_Absyn_Upper_b_struct*) _temp1073)->f1; goto
_LL1078;} else{ goto _LL1074;} _LL1076:( void*)( e->r=( void*)(( void*)( Cyc_Absyn_fncall_exp(
Cyc_Toc__get_arr_size_e,({ struct Cyc_Absyn_Exp* _temp1081[ 2u]; _temp1081[ 1u]=
Cyc_Absyn_sizeoftyp_exp( Cyc_Toc_typ_to_c( _temp1071), 0); _temp1081[ 0u]=(
...
_temp1081, sizeof( struct Cyc_Absyn_Exp*), 2u));}), 0))->r)); goto _LL1074;
_LL1078:( void*)( e->r=( void*)(( void*) _temp1079->r)); goto _LL1074; _LL1074:;}
goto _LL1058; _LL1064:({ struct Cyc_Stdio_String_pa_struct _temp1084; _temp1084.tag=
Cyc_Stdio_String_pa; _temp1084.f1=( struct _tagged_arr) Cyc_Absynpp_typ2string((
void*)(( struct Cyc_Core_Opt*) _check_null( arg->topt))->v);{ struct Cyc_Stdio_String_pa_struct
_temp1083; _temp1083.tag= Cyc_Stdio_String_pa; _temp1083.f1=( struct _tagged_arr)
Cyc_Absynpp_typ2string(( void*)(( struct Cyc_List_List*) _check_null( _temp1034))->hd);{
void* _temp1082[ 2u]={& _temp1083,& _temp1084};(( int(*)( struct _tagged_arr fmt,
struct _tagged_arr ap)) Cyc_Toc_toc_impos)( _tag_arr("size primop applied to non-array %s (%s)",
sizeof( unsigned char), 41u), _tag_arr( _temp1082, sizeof( void*), 2u));}}});
return; _LL1058:;} goto _LL1036;} _LL1040: { void* elt_typ=( void*) Cyc_Absyn_VoidType;
...
Cyc_Toc__tagged_arr_plus_e,({ struct Cyc_Absyn_Exp* _temp1085[ 3u]; _temp1085[ 2u]=
e2; _temp1085[ 1u]= Cyc_Absyn_sizeoftyp_exp( Cyc_Toc_typ_to_c( elt_typ), 0);
_temp1085[ 0u]= e1;(( struct Cyc_List_List*(*)( struct _tagged_arr)) Cyc_List_list)(
_tag_arr( _temp1085, sizeof( struct Cyc_Absyn_Exp*), 3u));}), 0))->r));} goto
_LL1036;} _LL1042: { void* elt_typ=( void*) Cyc_Absyn_VoidType; if( Cyc_Tcutil_is_tagged_pointer_typ_elt((
...
Cyc_Absyn_prim1_exp(( void*) Cyc_Absyn_Minus, e2, 0); _temp1086[ 1u]= Cyc_Absyn_sizeoftyp_exp(
Cyc_Toc_typ_to_c( elt_typ), 0); _temp1086[ 0u]= e1;(( struct Cyc_List_List*(*)(
struct _tagged_arr)) Cyc_List_list)( _tag_arr( _temp1086, sizeof( struct Cyc_Absyn_Exp*),
3u));}), 0))->r));}} goto _LL1036;} _LL1044: goto _LL1046; _LL1046: goto _LL1048;
_LL1048: goto _LL1050; _LL1050: goto _LL1052; _LL1052: goto _LL1054; _LL1054: {
struct Cyc_Absyn_Exp* e1=( struct Cyc_Absyn_Exp*)(( struct Cyc_List_List*)
_check_null( _temp888))->hd; struct Cyc_Absyn_Exp* e2=( struct Cyc_Absyn_Exp*)((
struct Cyc_List_List*) _check_null((( struct Cyc_List_List*) _check_null(
_temp888))->tl))->hd; void* t1=( void*)(( struct Cyc_List_List*) _check_null(
_temp1033))->hd; void* t2=( void*)(( struct Cyc_List_List*) _check_null(((
struct Cyc_List_List*) _check_null( _temp1033))->tl))->hd; if( Cyc_Tcutil_is_tagged_pointer_typ(
...
void*) e2->r, 0), Cyc_Toc_curr_sp, 0))->r));} goto _LL1036;} _LL1056: goto
_LL1036; _LL1036:;} goto _LL801;} _LL813: { void* e2_cyc_typ=( void*)(( struct
...
old_typ,& elt_typ)){ struct Cyc_Absyn_Exp* _temp1087=( _temp892 ==( void*) Cyc_Absyn_PostInc?
1: _temp892 ==( void*) Cyc_Absyn_PostDec)? Cyc_Toc__tagged_arr_inplace_plus_post_e:
Cyc_Toc__tagged_arr_inplace_plus_e; int _temp1088=( _temp892 ==( void*) Cyc_Absyn_PreInc?
1: _temp892 ==( void*) Cyc_Absyn_PostInc)? 1: - 1;( void*)( e->r=( void*)(( void*)(
Cyc_Absyn_fncall_exp( _temp1087,({ struct Cyc_Absyn_Exp* _temp1089[ 3u];
_temp1089[ 2u]= Cyc_Absyn_signed_int_exp( _temp1088, 0); _temp1089[ 1u]= Cyc_Absyn_sizeoftyp_exp(
Cyc_Toc_typ_to_c( elt_typ), 0); _temp1089[ 0u]= Cyc_Absyn_address_exp( _temp894,
0);(( struct Cyc_List_List*(*)( struct _tagged_arr)) Cyc_List_list)( _tag_arr(
_temp1089, sizeof( struct Cyc_Absyn_Exp*), 3u));}), 0))->r));} if( elt_typ ==(
...
change;{ void* _temp1090=( void*)(( struct Cyc_Core_Opt*) _check_null( _temp898))->v;
_LL1092: if( _temp1090 ==( void*) Cyc_Absyn_Plus){ goto _LL1093;} else{ goto
_LL1094;} _LL1094: if( _temp1090 ==( void*) Cyc_Absyn_Minus){ goto _LL1095;}
else{ goto _LL1096;} _LL1096: goto _LL1097; _LL1093: change= _temp896; goto
_LL1091; _LL1095: change= Cyc_Absyn_prim1_exp(( void*) Cyc_Absyn_Minus, _temp896,
0); goto _LL1091; _LL1097:( int) _throw(({ void* _temp1098[ 0u]={}; Cyc_Tcutil_impos(
_tag_arr("bad t ? pointer arithmetic", sizeof( unsigned char), 27u), _tag_arr(
_temp1098, sizeof( void*), 0u));})); goto _LL1091; _LL1091:;} done= 1;( void*)(
e->r=( void*)(( void*)( Cyc_Absyn_fncall_exp( Cyc_Toc__tagged_arr_inplace_plus_e,({
struct Cyc_Absyn_Exp* _temp1099[ 3u]; _temp1099[ 2u]= change; _temp1099[ 1u]=
Cyc_Absyn_sizeoftyp_exp( Cyc_Toc_typ_to_c( elt_typ), 0); _temp1099[ 0u]= Cyc_Absyn_address_exp(
_temp900, 0);(( struct Cyc_List_List*(*)( struct _tagged_arr)) Cyc_List_list)(
_tag_arr( _temp1099, sizeof( struct Cyc_Absyn_Exp*), 3u));}), 0))->r));}} if( !
...
Cyc_Toc_assignop_lvalue,({ struct _tuple7* _temp1100=( struct _tuple7*)
GC_malloc( sizeof( struct _tuple7) * 1); _temp1100[ 0]=({ struct _tuple7
_temp1101; _temp1101.f1= _temp898; _temp1101.f2= _temp896; _temp1101;});
_temp1100;}));( void*)( e->r=( void*)(( void*) _temp900->r));}} goto _LL801;}}
...
struct _RegionHandle _temp1102= _new_region(); struct _RegionHandle* r=&
_temp1102; _push_region( r);{ struct _tuple0* argv= Cyc_Toc_temp_var(); struct
...
_temp1119=( struct Cyc_Absyn_ArrayType_struct*) GC_malloc( sizeof( struct Cyc_Absyn_ArrayType_struct));
_temp1119[ 0]=({ struct Cyc_Absyn_ArrayType_struct _temp1120; _temp1120.tag= Cyc_Absyn_ArrayType;
_temp1120.f1=( void*) cva_type; _temp1120.f2= Cyc_Toc_mt_tq; _temp1120.f3=(
struct Cyc_Absyn_Exp*) num_varargs_exp; _temp1120;}); _temp1119;}); int num_args=((
...
_check_null( _temp931))->hd); new_args=({ struct Cyc_List_List* _temp1103=(
...
_temp1103->tl= new_args; _temp1103;});}} new_args=({ struct Cyc_List_List*
_temp1104=( struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List));
_temp1104->hd=( void*) Cyc_Absyn_fncall_exp( Cyc_Toc__tag_arr_e,({ struct Cyc_Absyn_Exp*
_temp1105[ 3u]; _temp1105[ 2u]= num_varargs_exp; _temp1105[ 1u]= Cyc_Absyn_sizeoftyp_exp(
cva_type, 0); _temp1105[ 0u]= argvexp;(( struct Cyc_List_List*(*)( struct
_tagged_arr)) Cyc_List_list)( _tag_arr( _temp1105, sizeof( struct Cyc_Absyn_Exp*),
3u));}), 0); _temp1104->tl= new_args; _temp1104;}); new_args=(( struct Cyc_List_List*(*)(
...
unsigned int _temp1115=( unsigned int) _temp929; struct _tuple0** _temp1116=(
struct _tuple0**) _region_malloc( r, sizeof( struct _tuple0*) * _temp1115);
struct _tagged_arr _temp1118= _tag_arr( _temp1116, sizeof( struct _tuple0*),(
unsigned int) _temp929);{ unsigned int _temp1117= _temp1115; unsigned int i;
for( i= 0; i < _temp1117; i ++){ _temp1116[ i]= Cyc_Toc_temp_var();}}; _temp1118;});
struct Cyc_List_List* _temp1106= 0;{ int i= _temp929 - 1; for( 0; i >= 0; -- i){
_temp1106=({ struct Cyc_List_List* _temp1107=( struct Cyc_List_List*) GC_malloc(
sizeof( struct Cyc_List_List)); _temp1107->hd=( void*) Cyc_Toc_make_dle( Cyc_Absyn_address_exp(
Cyc_Absyn_var_exp(*(( struct _tuple0**) _check_unknown_subscript( vs, sizeof(
struct _tuple0*), i)), 0), 0)); _temp1107->tl= _temp1106; _temp1107;});}} s= Cyc_Absyn_declare_stmt(
argv, arr_type,( struct Cyc_Absyn_Exp*) Cyc_Absyn_unresolvedmem_exp( 0,
_temp1106, 0), s, 0);{ int i= 0; for( 0; _temp931 != 0;((( _temp931=(( struct
...
_temp1110; struct Cyc_List_List* _temp1111; struct _tuple0* _temp1113; struct
Cyc_Absyn_Tunionfield* _temp1108=( struct Cyc_Absyn_Tunionfield*)(( struct Cyc_List_List*)
_check_null( _temp927))->hd; _temp1110=* _temp1108; _LL1114: _temp1113=
_temp1110.name; goto _LL1112; _LL1112: _temp1111= _temp1110.typs; goto _LL1109;
_LL1109: { void* field_typ= Cyc_Toc_typ_to_c((*(( struct _tuple3*)(( struct Cyc_List_List*)
_check_null( _temp1111))->hd)).f2); Cyc_Toc_exp_to_c( nv, arg); if( Cyc_Toc_is_void_star(
...
varexp, Cyc_Toc_tag_sp, 0), Cyc_Absyn_var_exp( _temp1113, 0), 0), s, 0); s= Cyc_Absyn_declare_stmt(
var, Cyc_Absyn_strctq( Cyc_Toc_collapse_qvar_tag( _temp1113, _tag_arr("_struct",
...
0){{ void* _temp1121= Cyc_Tcutil_compress(( void*)(( struct Cyc_List_List*)
_check_null( _temp939))->hd); _LL1123: if(( unsigned int) _temp1121 > 4u?*(( int*)
_temp1121) == Cyc_Absyn_VarType: 0){ goto _LL1124;} else{ goto _LL1125;} _LL1125:
if(( unsigned int) _temp1121 > 4u?*(( int*) _temp1121) == Cyc_Absyn_TunionType:
0){ goto _LL1126;} else{ goto _LL1127;} _LL1127: goto _LL1128; _LL1124:
continue; _LL1126: continue; _LL1128:( void*)( e->r=( void*)(( void*)( Cyc_Toc_array_to_ptr_cast(
Cyc_Toc_typ_to_c(( void*)(( struct Cyc_Core_Opt*) _check_null( e->topt))->v),
_temp941, 0))->r)); goto _LL1122; _LL1122:;} break;}} goto _LL801; _LL833: {
...
nv, _temp943);{ struct _tuple8 _temp1130=({ struct _tuple8 _temp1129; _temp1129.f1=
Cyc_Tcutil_compress( old_t2); _temp1129.f2= Cyc_Tcutil_compress( new_typ);
_temp1129;}); void* _temp1138; struct Cyc_Absyn_PtrInfo _temp1140; void*
_temp1142; struct Cyc_Absyn_PtrInfo _temp1144; void* _temp1146; void* _temp1148;
struct Cyc_Absyn_PtrInfo _temp1150; _LL1132: _LL1143: _temp1142= _temp1130.f1;
if(( unsigned int) _temp1142 > 4u?*(( int*) _temp1142) == Cyc_Absyn_PointerType:
0){ _LL1145: _temp1144=(( struct Cyc_Absyn_PointerType_struct*) _temp1142)->f1;
goto _LL1139;} else{ goto _LL1134;} _LL1139: _temp1138= _temp1130.f2; if((
unsigned int) _temp1138 > 4u?*(( int*) _temp1138) == Cyc_Absyn_PointerType: 0){
_LL1141: _temp1140=(( struct Cyc_Absyn_PointerType_struct*) _temp1138)->f1; goto
_LL1133;} else{ goto _LL1134;} _LL1134: _LL1149: _temp1148= _temp1130.f1; if((
unsigned int) _temp1148 > 4u?*(( int*) _temp1148) == Cyc_Absyn_PointerType: 0){
_LL1151: _temp1150=(( struct Cyc_Absyn_PointerType_struct*) _temp1148)->f1; goto
_LL1147;} else{ goto _LL1136;} _LL1147: _temp1146= _temp1130.f2; if((
unsigned int) _temp1146 > 4u?*(( int*) _temp1146) == Cyc_Absyn_IntType: 0){ goto
_LL1135;} else{ goto _LL1136;} _LL1136: goto _LL1137; _LL1133: { int _temp1152=((
int(*)( int, struct Cyc_Absyn_Conref* x)) Cyc_Absyn_conref_def)( 0, _temp1144.nullable);
int _temp1153=(( int(*)( int, struct Cyc_Absyn_Conref* x)) Cyc_Absyn_conref_def)(
0, _temp1140.nullable); void* _temp1154= Cyc_Absyn_conref_def( Cyc_Absyn_bounds_one,
_temp1144.bounds); void* _temp1155= Cyc_Absyn_conref_def( Cyc_Absyn_bounds_one,
_temp1140.bounds);{ struct _tuple8 _temp1157=({ struct _tuple8 _temp1156;
_temp1156.f1= _temp1154; _temp1156.f2= _temp1155; _temp1156;}); void* _temp1167;
void* _temp1169; void* _temp1171; void* _temp1173; struct Cyc_Absyn_Exp*
_temp1175; void* _temp1177; struct Cyc_Absyn_Exp* _temp1179; void* _temp1181;
_LL1159: _LL1170: _temp1169= _temp1157.f1; if(( unsigned int) _temp1169 > 1u?*((
int*) _temp1169) == Cyc_Absyn_Upper_b: 0){ goto _LL1168;} else{ goto _LL1161;}
_LL1168: _temp1167= _temp1157.f2; if(( unsigned int) _temp1167 > 1u?*(( int*)
_temp1167) == Cyc_Absyn_Upper_b: 0){ goto _LL1160;} else{ goto _LL1161;} _LL1161:
_LL1174: _temp1173= _temp1157.f1; if(( unsigned int) _temp1173 > 1u?*(( int*)
_temp1173) == Cyc_Absyn_Upper_b: 0){ _LL1176: _temp1175=(( struct Cyc_Absyn_Upper_b_struct*)
_temp1173)->f1; goto _LL1172;} else{ goto _LL1163;} _LL1172: _temp1171=
_temp1157.f2; if( _temp1171 ==( void*) Cyc_Absyn_Unknown_b){ goto _LL1162;}
else{ goto _LL1163;} _LL1163: _LL1182: _temp1181= _temp1157.f1; if( _temp1181 ==(
void*) Cyc_Absyn_Unknown_b){ goto _LL1178;} else{ goto _LL1165;} _LL1178:
_temp1177= _temp1157.f2; if(( unsigned int) _temp1177 > 1u?*(( int*) _temp1177)
== Cyc_Absyn_Upper_b: 0){ _LL1180: _temp1179=(( struct Cyc_Absyn_Upper_b_struct*)
_temp1177)->f1; goto _LL1164;} else{ goto _LL1165;} _LL1165: goto _LL1166;
_LL1160: if( _temp1152? ! _temp1153: 0){ if( nv->toplevel){({ void* _temp1183[ 0u]={};((
int(*)( struct _tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_unimp)( _tag_arr("can't do null-check conversion at top-level",
sizeof( unsigned char), 44u), _tag_arr( _temp1183, sizeof( void*), 0u));});}(
void*)( e->r=( void*)(( void*)( Cyc_Absyn_cast_exp(* _temp947, Cyc_Absyn_fncall_exp(
Cyc_Toc__check_null_e,({ struct Cyc_List_List* _temp1184=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1184->hd=( void*) _temp943;
_temp1184->tl= 0; _temp1184;}), 0), 0))->r));} goto _LL1158; _LL1162: if( nv->toplevel){(
void*)( e->r=( void*)(( void*)( Cyc_Toc_make_toplevel_tagged_arr( old_t2,
_temp1175, _temp943))->r));} else{( void*)( e->r=( void*)(( void*)( Cyc_Absyn_fncall_exp(
Cyc_Toc__tag_arr_e,({ struct Cyc_Absyn_Exp* _temp1185[ 3u]; _temp1185[ 2u]=
_temp1175; _temp1185[ 1u]= Cyc_Absyn_sizeoftyp_exp( Cyc_Toc_typ_to_c(( void*)
_temp1140.elt_typ), 0); _temp1185[ 0u]= _temp943;(( struct Cyc_List_List*(*)(
struct _tagged_arr)) Cyc_List_list)( _tag_arr( _temp1185, sizeof( struct Cyc_Absyn_Exp*),
3u));}), 0))->r));} goto _LL1158; _LL1164: if( nv->toplevel){({ void* _temp1186[
...
45u), _tag_arr( _temp1186, sizeof( void*), 0u));});}{ struct Cyc_Absyn_Exp*
_temp1187= Cyc_Absyn_fncall_exp( Cyc_Toc__untag_arr_e,({ struct Cyc_Absyn_Exp*
_temp1189[ 3u]; _temp1189[ 2u]= _temp1179; _temp1189[ 1u]= Cyc_Absyn_sizeoftyp_exp(
Cyc_Toc_typ_to_c(( void*) _temp1144.elt_typ), 0); _temp1189[ 0u]= _temp943;((
struct Cyc_List_List*(*)( struct _tagged_arr)) Cyc_List_list)( _tag_arr(
_temp1189, sizeof( struct Cyc_Absyn_Exp*), 3u));}), 0); if( _temp1153){( void*)(
_temp1187->r=( void*)(( void*)( Cyc_Absyn_fncall_exp( Cyc_Toc__check_null_e,({
struct Cyc_List_List* _temp1188=( struct Cyc_List_List*) GC_malloc( sizeof(
struct Cyc_List_List)); _temp1188->hd=( void*) Cyc_Absyn_copy_exp( _temp1187);
_temp1188->tl= 0; _temp1188;}), 0))->r));}( void*)( e->r=( void*)(( void*)( Cyc_Absyn_cast_exp(*
_temp947, _temp1187, 0))->r)); goto _LL1158;} _LL1166: goto _LL1158; _LL1158:;}
goto _LL1131;} _LL1135:{ void* _temp1190= Cyc_Absyn_conref_def( Cyc_Absyn_bounds_one,
_temp1150.bounds); _LL1192: if( _temp1190 ==( void*) Cyc_Absyn_Unknown_b){ goto
_LL1193;} else{ goto _LL1194;} _LL1194: goto _LL1195; _LL1193:( void*)( _temp943->r=(
void*)(( void*)( Cyc_Absyn_structmember_exp( Cyc_Absyn_new_exp(( void*) _temp943->r,
_temp943->loc), Cyc_Toc_curr_sp, 0))->r)); goto _LL1191; _LL1195: goto _LL1191;
_LL1191:;} goto _LL1131; _LL1137: goto _LL1131; _LL1131:;} goto _LL801;} _LL835:{
void* _temp1196=( void*) _temp948->r; struct Cyc_List_List* _temp1204; struct
_tuple0* _temp1206; struct Cyc_List_List* _temp1208; _LL1198: if(*(( int*)
_temp1196) == Cyc_Absyn_Struct_e){ _LL1207: _temp1206=(( struct Cyc_Absyn_Struct_e_struct*)
_temp1196)->f1; goto _LL1205; _LL1205: _temp1204=(( struct Cyc_Absyn_Struct_e_struct*)
_temp1196)->f3; goto _LL1199;} else{ goto _LL1200;} _LL1200: if(*(( int*)
_temp1196) == Cyc_Absyn_Tuple_e){ _LL1209: _temp1208=(( struct Cyc_Absyn_Tuple_e_struct*)
_temp1196)->f1; goto _LL1201;} else{ goto _LL1202;} _LL1202: goto _LL1203;
_LL1199: if( nv->toplevel){({ struct Cyc_Stdio_String_pa_struct _temp1211;
_temp1211.tag= Cyc_Stdio_String_pa; _temp1211.f1=( struct _tagged_arr) Cyc_Position_string_of_segment(
_temp948->loc);{ void* _temp1210[ 1u]={& _temp1211};(( int(*)( struct
_tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_unimp)( _tag_arr("%s: & on non-identifiers at the top-level",
sizeof( unsigned char), 42u), _tag_arr( _temp1210, sizeof( void*), 1u));}});}(
void*)( e->r=( void*)(( void*)( Cyc_Toc_init_struct( nv,( void*)(( struct Cyc_Core_Opt*)
_check_null( _temp948->topt))->v, 1, 0, _temp1204, _temp1206))->r)); goto
_LL1197; _LL1201: if( nv->toplevel){({ struct Cyc_Stdio_String_pa_struct
_temp1213; _temp1213.tag= Cyc_Stdio_String_pa; _temp1213.f1=( struct _tagged_arr)
Cyc_Position_string_of_segment( _temp948->loc);{ void* _temp1212[ 1u]={&
_temp1213};(( int(*)( struct _tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_unimp)(
_tag_arr("%s: & on non-identifiers at the top-level", sizeof( unsigned char), 42u),
_tag_arr( _temp1212, sizeof( void*), 1u));}});}( void*)( e->r=( void*)(( void*)(
Cyc_Toc_init_tuple( nv, 1, 0, _temp1208))->r)); goto _LL1197; _LL1203: Cyc_Toc_exp_to_c(
...
_LL1197; _LL1197:;} goto _LL801; _LL837: if( nv->toplevel){({ struct Cyc_Stdio_String_pa_struct
_temp1215; _temp1215.tag= Cyc_Stdio_String_pa; _temp1215.f1=( struct _tagged_arr)
Cyc_Position_string_of_segment( _temp950->loc);{ void* _temp1214[ 1u]={&
_temp1215};(( int(*)( struct _tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_unimp)(
_tag_arr("%s: new at top-level", sizeof( unsigned char), 21u), _tag_arr(
_temp1214, sizeof( void*), 1u));}});}{ void* _temp1216=( void*) _temp950->r;
struct Cyc_List_List* _temp1228; struct Cyc_Absyn_Exp* _temp1230; struct Cyc_Absyn_Exp*
_temp1232; struct Cyc_Absyn_Vardecl* _temp1234; struct Cyc_List_List* _temp1236;
struct _tuple0* _temp1238; struct Cyc_List_List* _temp1240; _LL1218: if(*(( int*)
_temp1216) == Cyc_Absyn_Array_e){ _LL1229: _temp1228=(( struct Cyc_Absyn_Array_e_struct*)
_temp1216)->f1; goto _LL1219;} else{ goto _LL1220;} _LL1220: if(*(( int*)
_temp1216) == Cyc_Absyn_Comprehension_e){ _LL1235: _temp1234=(( struct Cyc_Absyn_Comprehension_e_struct*)
_temp1216)->f1; goto _LL1233; _LL1233: _temp1232=(( struct Cyc_Absyn_Comprehension_e_struct*)
_temp1216)->f2; goto _LL1231; _LL1231: _temp1230=(( struct Cyc_Absyn_Comprehension_e_struct*)
_temp1216)->f3; goto _LL1221;} else{ goto _LL1222;} _LL1222: if(*(( int*)
_temp1216) == Cyc_Absyn_Struct_e){ _LL1239: _temp1238=(( struct Cyc_Absyn_Struct_e_struct*)
_temp1216)->f1; goto _LL1237; _LL1237: _temp1236=(( struct Cyc_Absyn_Struct_e_struct*)
_temp1216)->f3; goto _LL1223;} else{ goto _LL1224;} _LL1224: if(*(( int*)
_temp1216) == Cyc_Absyn_Tuple_e){ _LL1241: _temp1240=(( struct Cyc_Absyn_Tuple_e_struct*)
_temp1216)->f1; goto _LL1225;} else{ goto _LL1226;} _LL1226: goto _LL1227;
_LL1219: { struct _tuple0* _temp1242= Cyc_Toc_temp_var(); struct Cyc_Absyn_Exp*
_temp1243= Cyc_Absyn_var_exp( _temp1242, 0); struct Cyc_Absyn_Stmt* _temp1244=
Cyc_Toc_init_array( nv, _temp1243, _temp1228, Cyc_Absyn_exp_stmt( _temp1243, 0));
void* old_elt_typ;{ void* _temp1245= Cyc_Tcutil_compress( old_typ); struct Cyc_Absyn_PtrInfo
_temp1251; struct Cyc_Absyn_Tqual _temp1253; void* _temp1255; _LL1247: if((
unsigned int) _temp1245 > 4u?*(( int*) _temp1245) == Cyc_Absyn_PointerType: 0){
_LL1252: _temp1251=(( struct Cyc_Absyn_PointerType_struct*) _temp1245)->f1;
_LL1256: _temp1255=( void*) _temp1251.elt_typ; goto _LL1254; _LL1254: _temp1253=
_temp1251.tq; goto _LL1248;} else{ goto _LL1249;} _LL1249: goto _LL1250; _LL1248:
old_elt_typ= _temp1255; goto _LL1246; _LL1250: old_elt_typ=({ void* _temp1257[ 0u]={};
Cyc_Toc_toc_impos( _tag_arr("exp_to_c:new array expression doesn't have ptr type",
sizeof( unsigned char), 52u), _tag_arr( _temp1257, sizeof( void*), 0u));}); goto
_LL1246; _LL1246:;}{ void* elt_typ= Cyc_Toc_typ_to_c( old_elt_typ); void*
_temp1258= Cyc_Absyn_cstar_typ( elt_typ, Cyc_Toc_mt_tq); struct Cyc_Absyn_Exp*
_temp1259= Cyc_Absyn_times_exp( Cyc_Absyn_sizeoftyp_exp( elt_typ, 0), Cyc_Absyn_signed_int_exp(((
int(*)( struct Cyc_List_List* x)) Cyc_List_length)( _temp1228), 0), 0); struct
Cyc_Absyn_Exp* e1; if( _temp952 == 0){ e1= Cyc_Toc_malloc_exp( old_elt_typ,
_temp1259);} else{ struct Cyc_Absyn_Exp* r=( struct Cyc_Absyn_Exp*) _check_null(
_temp952); Cyc_Toc_exp_to_c( nv, r); e1= Cyc_Toc_rmalloc_exp( r, _temp1259);}{
struct Cyc_Absyn_Exp* _temp1260= Cyc_Absyn_cast_exp( _temp1258, e1, 0);( void*)(
e->r=( void*)(( void*)( Cyc_Absyn_stmt_exp( Cyc_Absyn_declare_stmt( _temp1242,
_temp1258,( struct Cyc_Absyn_Exp*) _temp1260, _temp1244, 0), 0))->r)); goto
_LL1217;}}} _LL1221: { int is_tagged_ptr= 0;{ void* _temp1261= Cyc_Tcutil_compress(
old_typ); struct Cyc_Absyn_PtrInfo _temp1267; struct Cyc_Absyn_Conref* _temp1269;
struct Cyc_Absyn_Tqual _temp1271; void* _temp1273; _LL1263: if(( unsigned int)
_temp1261 > 4u?*(( int*) _temp1261) == Cyc_Absyn_PointerType: 0){ _LL1268:
_temp1267=(( struct Cyc_Absyn_PointerType_struct*) _temp1261)->f1; _LL1274:
_temp1273=( void*) _temp1267.elt_typ; goto _LL1272; _LL1272: _temp1271=
_temp1267.tq; goto _LL1270; _LL1270: _temp1269= _temp1267.bounds; goto _LL1264;}
else{ goto _LL1265;} _LL1265: goto _LL1266; _LL1264: is_tagged_ptr= Cyc_Absyn_conref_def(
Cyc_Absyn_bounds_one, _temp1269) ==( void*) Cyc_Absyn_Unknown_b; goto _LL1262;
_LL1266:({ void* _temp1275[ 0u]={};(( int(*)( struct _tagged_arr fmt, struct
_tagged_arr ap)) Cyc_Toc_toc_impos)( _tag_arr("exp_to_c: comprehension not an array type",
sizeof( unsigned char), 42u), _tag_arr( _temp1275, sizeof( void*), 0u));}); goto
_LL1262; _LL1262:;}{ struct _tuple0* max= Cyc_Toc_temp_var(); struct _tuple0* a=
Cyc_Toc_temp_var(); void* old_elt_typ=( void*)(( struct Cyc_Core_Opt*)
_check_null( _temp1230->topt))->v; void* elt_typ= Cyc_Toc_typ_to_c( old_elt_typ);
void* ptr_typ= Cyc_Absyn_cstar_typ( elt_typ, Cyc_Toc_mt_tq); Cyc_Toc_exp_to_c(
nv, _temp1232);{ struct Cyc_Absyn_Stmt* s= Cyc_Toc_init_comprehension( nv, Cyc_Absyn_var_exp(
a, 0), _temp1234, Cyc_Absyn_var_exp( max, 0), _temp1230, Cyc_Absyn_skip_stmt( 0),
1);{ struct _RegionHandle _temp1276= _new_region(); struct _RegionHandle* r=&
_temp1276; _push_region( r);{ struct Cyc_List_List* decls=({ struct Cyc_List_List*
_temp1294=( struct Cyc_List_List*) _region_malloc( r, sizeof( struct Cyc_List_List));
_temp1294->hd=( void*)({ struct _tuple9* _temp1295=( struct _tuple9*)
_region_malloc( r, sizeof( struct _tuple9)); _temp1295->f1= max; _temp1295->f2=
Cyc_Absyn_uint_t; _temp1295->f3=( struct Cyc_Absyn_Exp*) _temp1232; _temp1295;});
_temp1294->tl= 0; _temp1294;}); struct Cyc_Absyn_Exp* ai; if( _temp952 == 0){ ai=
...
decls=({ struct Cyc_List_List* _temp1277=( struct Cyc_List_List*) _region_malloc(
r, sizeof( struct Cyc_List_List)); _temp1277->hd=( void*)({ struct _tuple9*
_temp1278=( struct _tuple9*) _region_malloc( r, sizeof( struct _tuple9));
_temp1278->f1= a; _temp1278->f2= ptr_typ; _temp1278->f3=( struct Cyc_Absyn_Exp*)
ainit; _temp1278;}); _temp1277->tl= decls; _temp1277;}); if( is_tagged_ptr){
struct _tuple0* _temp1279= Cyc_Toc_temp_var(); void* _temp1280= Cyc_Toc_typ_to_c(
old_typ); struct Cyc_Absyn_Exp* _temp1281= Cyc_Absyn_fncall_exp( Cyc_Toc__tag_arr_e,({
struct Cyc_Absyn_Exp* _temp1284[ 3u]; _temp1284[ 2u]= _temp1232; _temp1284[ 1u]=
Cyc_Absyn_sizeoftyp_exp( elt_typ, 0); _temp1284[ 0u]= Cyc_Absyn_var_exp( a, 0);((
struct Cyc_List_List*(*)( struct _tagged_arr)) Cyc_List_list)( _tag_arr(
_temp1284, sizeof( struct Cyc_Absyn_Exp*), 3u));}), 0); decls=({ struct Cyc_List_List*
...
_region_malloc( r, sizeof( struct _tuple9)); _temp1283->f1= _temp1279; _temp1283->f2=
_temp1280; _temp1283->f3=( struct Cyc_Absyn_Exp*) _temp1281; _temp1283;});
_temp1282->tl= decls; _temp1282;}); s= Cyc_Absyn_seq_stmt( s, Cyc_Absyn_exp_stmt(
Cyc_Absyn_var_exp( _temp1279, 0), 0), 0);} else{ s= Cyc_Absyn_seq_stmt( s, Cyc_Absyn_exp_stmt(
Cyc_Absyn_var_exp( a, 0), 0), 0);}{ struct Cyc_List_List* _temp1285= decls; for(
0; _temp1285 != 0; _temp1285=(( struct Cyc_List_List*) _check_null( _temp1285))->tl){
struct Cyc_Absyn_Exp* _temp1288; void* _temp1290; struct _tuple0* _temp1292;
struct _tuple9 _temp1286=*(( struct _tuple9*)(( struct Cyc_List_List*)
_check_null( _temp1285))->hd); _LL1293: _temp1292= _temp1286.f1; goto _LL1291;
_LL1291: _temp1290= _temp1286.f2; goto _LL1289; _LL1289: _temp1288= _temp1286.f3;
goto _LL1287; _LL1287: s= Cyc_Absyn_declare_stmt( _temp1292, _temp1290,
_temp1288, s, 0);}}( void*)( e->r=( void*)(( void*)( Cyc_Absyn_stmt_exp( s, 0))->r));}};
_pop_region( r);} goto _LL1217;}}} _LL1223:( void*)( e->r=( void*)(( void*)( Cyc_Toc_init_struct(
nv,( void*)(( struct Cyc_Core_Opt*) _check_null( _temp950->topt))->v, 1,
_temp952, _temp1236, _temp1238))->r)); goto _LL1217; _LL1225:( void*)( e->r=(
void*)(( void*)( Cyc_Toc_init_tuple( nv, 1, _temp952, _temp1240))->r)); goto
_LL1217; _LL1227: { void* old_elt_typ=( void*)(( struct Cyc_Core_Opt*)
...
elt_typ, Cyc_Toc_mt_tq), mexp, 0);{ int done= 0;{ void* _temp1296=( void*)
_temp950->r; struct Cyc_Absyn_Exp* _temp1302; void* _temp1304; _LL1298: if(*((
int*) _temp1296) == Cyc_Absyn_Cast_e){ _LL1305: _temp1304=( void*)(( struct Cyc_Absyn_Cast_e_struct*)
_temp1296)->f1; goto _LL1303; _LL1303: _temp1302=(( struct Cyc_Absyn_Cast_e_struct*)
_temp1296)->f2; goto _LL1299;} else{ goto _LL1300;} _LL1300: goto _LL1301;
_LL1299:{ struct _tuple8 _temp1307=({ struct _tuple8 _temp1306; _temp1306.f1=
Cyc_Tcutil_compress( _temp1304); _temp1306.f2= Cyc_Tcutil_compress(( void*)((
struct Cyc_Core_Opt*) _check_null( _temp1302->topt))->v); _temp1306;}); void*
_temp1313; struct Cyc_Absyn_PtrInfo _temp1315; struct Cyc_Absyn_Conref*
_temp1317; void* _temp1319; struct Cyc_Absyn_PtrInfo _temp1321; struct Cyc_Absyn_Conref*
_temp1323; void* _temp1325; _LL1309: _LL1320: _temp1319= _temp1307.f1; if((
unsigned int) _temp1319 > 4u?*(( int*) _temp1319) == Cyc_Absyn_PointerType: 0){
_LL1322: _temp1321=(( struct Cyc_Absyn_PointerType_struct*) _temp1319)->f1;
_LL1326: _temp1325=( void*) _temp1321.elt_typ; goto _LL1324; _LL1324: _temp1323=
_temp1321.bounds; goto _LL1314;} else{ goto _LL1311;} _LL1314: _temp1313=
_temp1307.f2; if(( unsigned int) _temp1313 > 4u?*(( int*) _temp1313) == Cyc_Absyn_PointerType:
0){ _LL1316: _temp1315=(( struct Cyc_Absyn_PointerType_struct*) _temp1313)->f1;
_LL1318: _temp1317= _temp1315.bounds; goto _LL1310;} else{ goto _LL1311;}
_LL1311: goto _LL1312; _LL1310:{ struct _tuple8 _temp1328=({ struct _tuple8
_temp1327; _temp1327.f1= Cyc_Absyn_conref_def( Cyc_Absyn_bounds_one, _temp1323);
_temp1327.f2= Cyc_Absyn_conref_def( Cyc_Absyn_bounds_one, _temp1317); _temp1327;});
void* _temp1334; struct Cyc_Absyn_Exp* _temp1336; void* _temp1338; _LL1330:
_LL1339: _temp1338= _temp1328.f1; if( _temp1338 ==( void*) Cyc_Absyn_Unknown_b){
goto _LL1335;} else{ goto _LL1332;} _LL1335: _temp1334= _temp1328.f2; if((
unsigned int) _temp1334 > 1u?*(( int*) _temp1334) == Cyc_Absyn_Upper_b: 0){
_LL1337: _temp1336=(( struct Cyc_Absyn_Upper_b_struct*) _temp1334)->f1; goto
_LL1331;} else{ goto _LL1332;} _LL1332: goto _LL1333; _LL1331: done= 1;( void*)(
e->r=( void*)(( void*)( Cyc_Absyn_fncall_exp( Cyc_Toc__init_tag_arr_e,({ struct
Cyc_Absyn_Exp* _temp1340[ 4u]; _temp1340[ 3u]= _temp1336; _temp1340[ 2u]= Cyc_Absyn_sizeoftyp_exp(
_temp1325, 0); _temp1340[ 1u]= _temp1302; _temp1340[ 0u]= mexp;(( struct Cyc_List_List*(*)(
struct _tagged_arr)) Cyc_List_list)( _tag_arr( _temp1340, sizeof( struct Cyc_Absyn_Exp*),
4u));}), 0))->r)); goto _LL1329; _LL1333: goto _LL1329; _LL1329:;} goto _LL1308;
_LL1312: goto _LL1308; _LL1308:;} goto _LL1297; _LL1301: goto _LL1297; _LL1297:;}
if( ! done){ struct _tuple0* _temp1341= Cyc_Toc_temp_var(); struct Cyc_Absyn_Stmt*
_temp1342= Cyc_Absyn_exp_stmt( Cyc_Absyn_var_exp( _temp1341, 0), 0); struct Cyc_Absyn_Exp*
_temp1343= Cyc_Absyn_signed_int_exp( 0, 0); Cyc_Toc_exp_to_c( nv, _temp950);
_temp1342= Cyc_Absyn_seq_stmt( Cyc_Absyn_assign_stmt( Cyc_Absyn_subscript_exp(
Cyc_Absyn_var_exp( _temp1341, 0), _temp1343, 0), _temp950, 0), _temp1342, 0);{
void* _temp1344= Cyc_Absyn_cstar_typ( elt_typ, Cyc_Toc_mt_tq);( void*)( e->r=(
void*)(( void*)( Cyc_Absyn_stmt_exp( Cyc_Absyn_declare_stmt( _temp1341,
_temp1344,( struct Cyc_Absyn_Exp*) mexp, _temp1342, 0), 0))->r));}} goto _LL1217;}}
_LL1217:;} goto _LL801; _LL839: Cyc_Toc_exp_to_c( nv, _temp954); goto _LL801;
_LL841:( void*)( e->r=( void*)(( void*)({ struct Cyc_Absyn_Sizeoftyp_e_struct*
_temp1345=( struct Cyc_Absyn_Sizeoftyp_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Sizeoftyp_e_struct));
_temp1345[ 0]=({ struct Cyc_Absyn_Sizeoftyp_e_struct _temp1346; _temp1346.tag=
Cyc_Absyn_Sizeoftyp_e; _temp1346.f1=( void*) Cyc_Toc_typ_to_c_array( _temp956);
_temp1346;}); _temp1345;}))); goto _LL801; _LL843:( void*)( e->r=( void*)(( void*)({
struct Cyc_Absyn_Offsetof_e_struct* _temp1347=( struct Cyc_Absyn_Offsetof_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Offsetof_e_struct)); _temp1347[ 0]=({ struct
Cyc_Absyn_Offsetof_e_struct _temp1348; _temp1348.tag= Cyc_Absyn_Offsetof_e;
_temp1348.f1=( void*) Cyc_Toc_typ_to_c_array( _temp960); _temp1348.f2= _temp958;
_temp1348;}); _temp1347;}))); goto _LL801; _LL845: { void* _temp1349= Cyc_Tcutil_compress((
void*)(( struct Cyc_Core_Opt*) _check_null( _temp962->topt))->v);{ void*
_temp1350= _temp1349; struct Cyc_Absyn_PtrInfo _temp1356; struct Cyc_Absyn_Conref*
_temp1358; struct Cyc_Absyn_Tqual _temp1360; struct Cyc_Absyn_Conref* _temp1362;
void* _temp1364; void* _temp1366; _LL1352: if(( unsigned int) _temp1350 > 4u?*((
int*) _temp1350) == Cyc_Absyn_PointerType: 0){ _LL1357: _temp1356=(( struct Cyc_Absyn_PointerType_struct*)
_temp1350)->f1; _LL1367: _temp1366=( void*) _temp1356.elt_typ; goto _LL1365;
_LL1365: _temp1364=( void*) _temp1356.rgn_typ; goto _LL1363; _LL1363: _temp1362=
_temp1356.nullable; goto _LL1361; _LL1361: _temp1360= _temp1356.tq; goto _LL1359;
_LL1359: _temp1358= _temp1356.bounds; goto _LL1353;} else{ goto _LL1354;}
_LL1354: goto _LL1355; _LL1353:{ void* _temp1368= Cyc_Absyn_conref_def( Cyc_Absyn_bounds_one,
_temp1358); _LL1370: if(( unsigned int) _temp1368 > 1u?*(( int*) _temp1368) ==
Cyc_Absyn_Upper_b: 0){ goto _LL1371;} else{ goto _LL1372;} _LL1372: if(
_temp1368 ==( void*) Cyc_Absyn_Unknown_b){ goto _LL1373;} else{ goto _LL1369;}
_LL1371: Cyc_Toc_exp_to_c( nv, _temp962); if( Cyc_Toc_is_nullable( _temp1349)){(
...
Cyc_Toc__check_null_e,({ struct Cyc_List_List* _temp1374=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1374->hd=( void*) _temp962;
_temp1374->tl= 0; _temp1374;}), 0), 0), 0))->r));} goto _LL1369; _LL1373: {
struct Cyc_Absyn_Exp* _temp1375= Cyc_Absyn_uint_exp( 0, 0); _temp1375->topt=({
struct Cyc_Core_Opt* _temp1376=( struct Cyc_Core_Opt*) GC_malloc( sizeof( struct
Cyc_Core_Opt)); _temp1376->v=( void*) Cyc_Absyn_uint_t; _temp1376;});( void*)( e->r=(
void*)(( void*)( Cyc_Absyn_subscript_exp( _temp962, _temp1375, 0))->r)); Cyc_Toc_exp_to_c(
...
_temp1377, sizeof( void*), 0u));}); goto _LL1351; _LL1351:;} goto _LL801;}
...
struct Cyc_List_List)); _temp1399->hd=( void*) _temp970; _temp1399->tl= 0;
_temp1399;}), 0), 0), _temp968, 0))->r));} goto _LL1391;} _LL1395: { void* ta1=
Cyc_Toc_typ_to_c_array( _temp1388);( void*)( _temp970->r=( void*)(( void*)( Cyc_Absyn_cast_exp(
Cyc_Absyn_cstar_typ( ta1, _temp1382), Cyc_Absyn_fncall_exp( Cyc_Toc__check_unknown_subscript_e,({
struct Cyc_Absyn_Exp* _temp1400[ 3u]; _temp1400[ 2u]= Cyc_Absyn_uint_exp( 0, 0);
_temp1400[ 1u]= Cyc_Absyn_sizeoftyp_exp( ta1, 0); _temp1400[ 0u]= Cyc_Absyn_copy_exp(
_temp970);(( struct Cyc_List_List*(*)( struct _tagged_arr)) Cyc_List_list)(
_tag_arr( _temp1400, sizeof( struct Cyc_Absyn_Exp*), 3u));}), 0), 0))->r)); goto
_LL1391;} _LL1391:;} if( is_poly){( void*)( e->r=( void*)(( void*)( Cyc_Toc_array_to_ptr_cast(
Cyc_Toc_typ_to_c(( void*)(( struct Cyc_Core_Opt*) _check_null( e->topt))->v),
Cyc_Absyn_new_exp(( void*) e->r, 0), 0))->r));} goto _LL801;}} _LL851: { void*
_temp1401= Cyc_Tcutil_compress(( void*)(( struct Cyc_Core_Opt*) _check_null(
_temp974->topt))->v); Cyc_Toc_exp_to_c( nv, _temp974); Cyc_Toc_exp_to_c( nv,
_temp972);{ void* _temp1402= _temp1401; struct Cyc_List_List* _temp1410; struct
Cyc_Absyn_PtrInfo _temp1412; struct Cyc_Absyn_Conref* _temp1414; struct Cyc_Absyn_Tqual
_temp1416; struct Cyc_Absyn_Conref* _temp1418; void* _temp1420; void* _temp1422;
_LL1404: if(( unsigned int) _temp1402 > 4u?*(( int*) _temp1402) == Cyc_Absyn_TupleType:
0){ _LL1411: _temp1410=(( struct Cyc_Absyn_TupleType_struct*) _temp1402)->f1;
goto _LL1405;} else{ goto _LL1406;} _LL1406: if(( unsigned int) _temp1402 > 4u?*((
int*) _temp1402) == Cyc_Absyn_PointerType: 0){ _LL1413: _temp1412=(( struct Cyc_Absyn_PointerType_struct*)
_temp1402)->f1; _LL1423: _temp1422=( void*) _temp1412.elt_typ; goto _LL1421;
_LL1421: _temp1420=( void*) _temp1412.rgn_typ; goto _LL1419; _LL1419: _temp1418=
_temp1412.nullable; goto _LL1417; _LL1417: _temp1416= _temp1412.tq; goto _LL1415;
_LL1415: _temp1414= _temp1412.bounds; goto _LL1407;} else{ goto _LL1408;}
_LL1408: goto _LL1409; _LL1405: { unsigned int i= Cyc_Evexp_eval_const_uint_exp(
_temp972) + 1;( void*)( e->r=( void*)(( void*)( Cyc_Absyn_structmember_exp(
_temp974, Cyc_Toc_fieldname(( int) i), 0))->r)); goto _LL1403;} _LL1407:{ void*
_temp1424= Cyc_Absyn_conref_def( Cyc_Absyn_bounds_one, _temp1414); struct Cyc_Absyn_Exp*
_temp1430; _LL1426: if(( unsigned int) _temp1424 > 1u?*(( int*) _temp1424) ==
Cyc_Absyn_Upper_b: 0){ _LL1431: _temp1430=(( struct Cyc_Absyn_Upper_b_struct*)
_temp1424)->f1; goto _LL1427;} else{ goto _LL1428;} _LL1428: if( _temp1424 ==(
void*) Cyc_Absyn_Unknown_b){ goto _LL1429;} else{ goto _LL1425;} _LL1427:
_temp1430= Cyc_Absyn_uint_exp( Cyc_Evexp_eval_const_uint_exp( _temp1430), 0);{
int possibly_null=(( int(*)( int, struct Cyc_Absyn_Conref* x)) Cyc_Absyn_conref_def)(
0, _temp1418); void* ta1= Cyc_Toc_typ_to_c( _temp1422); void* ta2= Cyc_Absyn_cstar_typ(
ta1, _temp1416); if( possibly_null){( void*)( e->r=( void*)(( void*)( Cyc_Absyn_deref_exp(
Cyc_Absyn_cast_exp( ta2, Cyc_Absyn_fncall_exp( Cyc_Toc__check_known_subscript_null_e,({
struct Cyc_Absyn_Exp* _temp1432[ 4u]; _temp1432[ 3u]= _temp972; _temp1432[ 2u]=
Cyc_Absyn_sizeoftyp_exp( ta1, 0); _temp1432[ 1u]= _temp1430; _temp1432[ 0u]=
_temp974;(( struct Cyc_List_List*(*)( struct _tagged_arr)) Cyc_List_list)(
_tag_arr( _temp1432, sizeof( struct Cyc_Absyn_Exp*), 4u));}), 0), 0), 0))->r));}
else{( void*)( _temp972->r=( void*)(( void*)( Cyc_Absyn_fncall_exp( Cyc_Toc__check_known_subscript_notnull_e,({
struct Cyc_Absyn_Exp* _temp1433[ 2u]; _temp1433[ 1u]= Cyc_Absyn_copy_exp(
_temp972); _temp1433[ 0u]= _temp1430;(( struct Cyc_List_List*(*)( struct
_tagged_arr)) Cyc_List_list)( _tag_arr( _temp1433, sizeof( struct Cyc_Absyn_Exp*),
2u));}), 0))->r));} goto _LL1425;} _LL1429: { void* ta1= Cyc_Toc_typ_to_c_array(
_temp1422);( void*)( e->r=( void*)(( void*)( Cyc_Absyn_deref_exp( Cyc_Absyn_cast_exp(
Cyc_Absyn_cstar_typ( ta1, _temp1416), Cyc_Absyn_fncall_exp( Cyc_Toc__check_unknown_subscript_e,({
struct Cyc_Absyn_Exp* _temp1434[ 3u]; _temp1434[ 2u]= _temp972; _temp1434[ 1u]=
Cyc_Absyn_sizeoftyp_exp( ta1, 0); _temp1434[ 0u]= _temp974;(( struct Cyc_List_List*(*)(
struct _tagged_arr)) Cyc_List_list)( _tag_arr( _temp1434, sizeof( struct Cyc_Absyn_Exp*),
...
_LL1403; _LL1403:;} goto _LL801;} _LL853: if( ! nv->toplevel){( void*)( e->r=(
...
_temp976); struct _tagged_arr* _temp1437= Cyc_Toc_add_tuple_type( _temp1436);
...
dles=({ struct Cyc_List_List* _temp1438=( struct Cyc_List_List*) GC_malloc(
sizeof( struct Cyc_List_List)); _temp1438->hd=( void*)({ struct _tuple4*
_temp1439=( struct _tuple4*) GC_malloc( sizeof( struct _tuple4)); _temp1439->f1=
0; _temp1439->f2=( struct Cyc_Absyn_Exp*)(( struct Cyc_List_List*) _check_null(
_temp976))->hd; _temp1439;}); _temp1438->tl= dles; _temp1438;});}} dles=((
...
0, _temp978, 0))->r));{ struct Cyc_List_List* _temp1440= _temp978; for( 0;
...
Cyc_Toc_exp_to_c( nv, _temp1444);}} goto _LL801; _LL857: { unsigned int
_temp1446= Cyc_Evexp_eval_const_uint_exp( _temp982); Cyc_Toc_exp_to_c( nv,
...
_temp1447=( struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List));
_temp1447->hd=( void*)({ struct _tuple4* _temp1448=( struct _tuple4*) GC_malloc(
sizeof( struct _tuple4)); _temp1448->f1= 0; _temp1448->f2= _temp980; _temp1448;});
...
else{ if( _temp986 == 0){({ void* _temp1449[ 0u]={};(( int(*)( struct
...
_temp986); struct _RegionHandle _temp1450= _new_region(); struct _RegionHandle*
...
struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List)); _temp1463->hd=(
void*)({ struct _tuple4* _temp1464=( struct _tuple4*) GC_malloc( sizeof( struct
...
_temp1452), 0))->r));}; _pop_region( rgn);}} goto _LL801; _LL861: { struct Cyc_List_List*
fs;{ void* _temp1465= Cyc_Tcutil_compress( _temp996); struct Cyc_List_List*
...
_LL1468: fs= _temp1471; goto _LL1466; _LL1470: fs=({ struct Cyc_Stdio_String_pa_struct
_temp1474; _temp1474.tag= Cyc_Stdio_String_pa; _temp1474.f1=( struct _tagged_arr)
Cyc_Absynpp_typ2string( _temp996);{ void* _temp1473[ 1u]={& _temp1474};(( struct
...
e->loc, _temp994, fs); for( 0; _temp1476 != 0; _temp1476=(( struct Cyc_List_List*)
...
else{ int tag_count= 0; struct Cyc_List_List* _temp1485= _temp1000->fields == 0?
...
_LL801;} _LL865: { struct _tuple0* _temp1486= _temp1004->name; struct Cyc_List_List*
_temp1487= _temp1004->typs; struct _tuple0* _temp1488= Cyc_Toc_temp_var();
...
if( _temp1006->is_xtunion){ tag_exp= Cyc_Absyn_var_exp( _temp1486, 0);} else{
int tag_count= 0; struct Cyc_List_List* _temp1491= _temp1006->fields == 0? 0:(
...
unsigned int) tag_count, 0);}{ struct Cyc_List_List* _temp1492= 0; for( 0;
_temp1008 != 0;( _temp1008=(( struct Cyc_List_List*) _check_null( _temp1008))->tl,
...
field_typ)){ cur_e= Cyc_Absyn_cast_exp( field_typ, cur_e, 0);} _temp1492=({
struct Cyc_List_List* _temp1493=( struct Cyc_List_List*) GC_malloc( sizeof(
struct Cyc_List_List)); _temp1493->hd=( void*)({ struct _tuple4* _temp1494=(
struct _tuple4*) GC_malloc( sizeof( struct _tuple4)); _temp1494->f1= 0;
_temp1494->f2= cur_e; _temp1494;}); _temp1493->tl= _temp1492; _temp1493;});}
_temp1492=({ struct Cyc_List_List* _temp1495=( struct Cyc_List_List*) GC_malloc(
sizeof( struct Cyc_List_List)); _temp1495->hd=( void*)({ struct _tuple4*
_temp1496=( struct _tuple4*) GC_malloc( sizeof( struct _tuple4)); _temp1496->f1=
0; _temp1496->f2= tag_exp; _temp1496;}); _temp1495->tl=(( struct Cyc_List_List*(*)(
struct Cyc_List_List* x)) Cyc_List_imp_rev)( _temp1492); _temp1495;});( void*)(
e->r=( void*)(( void*)( Cyc_Absyn_unresolvedmem_exp(({ struct Cyc_Core_Opt*
_temp1497=( struct Cyc_Core_Opt*) GC_malloc( sizeof( struct Cyc_Core_Opt));
_temp1497->v=( void*) Cyc_Toc_collapse_qvar_tag( _temp1486, _tag_arr("_struct",
sizeof( unsigned char), 8u)); _temp1497;}), _temp1492, 0))->r));}} else{ struct
Cyc_List_List* _temp1498=({ struct Cyc_List_List* _temp1504=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1504->hd=( void*) Cyc_Absyn_assign_stmt(
Cyc_Absyn_structmember_exp( _temp1489, Cyc_Toc_tag_sp, 0), Cyc_Absyn_var_exp(
_temp1486, 0), 0); _temp1504->tl= 0; _temp1504;});{ int i= 1; for( 0; _temp1008
!= 0;((( _temp1008=(( struct Cyc_List_List*) _check_null( _temp1008))->tl, i ++)),
_temp1487=(( struct Cyc_List_List*) _check_null( _temp1487))->tl)){ struct Cyc_Absyn_Exp*
cur_e=( struct Cyc_Absyn_Exp*)(( struct Cyc_List_List*) _check_null( _temp1008))->hd;
void* field_typ= Cyc_Toc_typ_to_c((*(( struct _tuple3*)(( struct Cyc_List_List*)
_check_null( _temp1487))->hd)).f2); Cyc_Toc_exp_to_c( nv, cur_e); if( Cyc_Toc_is_void_star(
field_typ)){ cur_e= Cyc_Absyn_cast_exp( field_typ, cur_e, 0);}{ struct Cyc_Absyn_Stmt*
_temp1499= Cyc_Absyn_assign_stmt( Cyc_Absyn_structmember_exp( _temp1489, Cyc_Toc_fieldname(
i), 0), cur_e, 0); _temp1498=({ struct Cyc_List_List* _temp1500=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1500->hd=( void*) _temp1499;
_temp1500->tl= _temp1498; _temp1500;});}}}{ struct Cyc_Absyn_Stmt* _temp1501=
Cyc_Absyn_exp_stmt( _temp1489, 0); struct Cyc_Absyn_Stmt* _temp1502= Cyc_Absyn_seq_stmts(((
struct Cyc_List_List*(*)( struct Cyc_List_List* x)) Cyc_List_imp_rev)(({ struct
Cyc_List_List* _temp1503=( struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List));
_temp1503->hd=( void*) _temp1501; _temp1503->tl= _temp1498; _temp1503;})), 0);(
void*)( e->r=( void*)(( void*)( Cyc_Absyn_stmt_exp( Cyc_Absyn_declare_stmt(
_temp1488, _temp1490, 0, _temp1502, 0), 0))->r));}} goto _LL801;} _LL867: goto
...
nv, _temp1014); goto _LL801; _LL873:({ void* _temp1505[ 0u]={};(( int(*)( struct
_tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_toc_impos)( _tag_arr("UnresolvedMem",
sizeof( unsigned char), 14u), _tag_arr( _temp1505, sizeof( void*), 0u));}); goto
_LL801; _LL875:({ void* _temp1506[ 0u]={};(( int(*)( struct _tagged_arr fmt,
struct _tagged_arr ap)) Cyc_Toc_unimp)( _tag_arr("compoundlit", sizeof(
unsigned char), 12u), _tag_arr( _temp1506, sizeof( void*), 0u));}); goto _LL801;
_LL877:({ void* _temp1507[ 0u]={};(( int(*)( struct _tagged_arr fmt, struct
_tagged_arr ap)) Cyc_Toc_unimp)( _tag_arr("codegen", sizeof( unsigned char), 8u),
_tag_arr( _temp1507, sizeof( void*), 0u));}); goto _LL801; _LL879:({ void*
_temp1508[ 0u]={};(( int(*)( struct _tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_unimp)(
_tag_arr("fill", sizeof( unsigned char), 5u), _tag_arr( _temp1508, sizeof( void*),
...
_temp1545; struct Cyc_Absyn_Vardecl _temp1547; struct _tuple0* _temp1548; struct
Cyc_Absyn_Vardecl* _temp1550; int _temp1552; void* _temp1554; unsigned char
_temp1556; struct _tagged_arr _temp1558; struct Cyc_Absyn_Enumfield* _temp1560;
struct Cyc_Absyn_Enumdecl* _temp1562; struct Cyc_List_List* _temp1564; struct
Cyc_List_List* _temp1566; struct Cyc_Absyn_Tunionfield* _temp1568; struct Cyc_Absyn_Tuniondecl*
_temp1570; struct Cyc_Absyn_Pat* _temp1573; struct Cyc_Absyn_Pat _temp1575; void*
_temp1576; struct Cyc_List_List* _temp1578; struct Cyc_List_List* _temp1580;
struct Cyc_Absyn_Tunionfield* _temp1582; struct Cyc_Absyn_Tuniondecl* _temp1584;
struct Cyc_List_List* _temp1586; struct Cyc_List_List* _temp1588; struct Cyc_List_List*
_temp1590; struct Cyc_List_List* _temp1592; struct Cyc_Core_Opt* _temp1594;
struct Cyc_Absyn_Structdecl* _temp1596; struct Cyc_Absyn_Pat* _temp1598; _LL1511:
if(( unsigned int) _temp1509 > 2u?*(( int*) _temp1509) == Cyc_Absyn_Var_p: 0){
_LL1546: _temp1545=(( struct Cyc_Absyn_Var_p_struct*) _temp1509)->f1; _temp1547=*
_temp1545; _LL1549: _temp1548= _temp1547.name; goto _LL1512;} else{ goto _LL1513;}
_LL1513: if( _temp1509 ==( void*) Cyc_Absyn_Wild_p){ goto _LL1514;} else{ goto
_LL1515;} _LL1515: if(( unsigned int) _temp1509 > 2u?*(( int*) _temp1509) == Cyc_Absyn_Reference_p:
0){ _LL1551: _temp1550=(( struct Cyc_Absyn_Reference_p_struct*) _temp1509)->f1;
goto _LL1516;} else{ goto _LL1517;} _LL1517: if( _temp1509 ==( void*) Cyc_Absyn_Null_p){
goto _LL1518;} else{ goto _LL1519;} _LL1519: if(( unsigned int) _temp1509 > 2u?*((
int*) _temp1509) == Cyc_Absyn_Int_p: 0){ _LL1555: _temp1554=( void*)(( struct
Cyc_Absyn_Int_p_struct*) _temp1509)->f1; goto _LL1553; _LL1553: _temp1552=((
struct Cyc_Absyn_Int_p_struct*) _temp1509)->f2; goto _LL1520;} else{ goto
_LL1521;} _LL1521: if(( unsigned int) _temp1509 > 2u?*(( int*) _temp1509) == Cyc_Absyn_Char_p:
0){ _LL1557: _temp1556=(( struct Cyc_Absyn_Char_p_struct*) _temp1509)->f1; goto
_LL1522;} else{ goto _LL1523;} _LL1523: if(( unsigned int) _temp1509 > 2u?*((
int*) _temp1509) == Cyc_Absyn_Float_p: 0){ _LL1559: _temp1558=(( struct Cyc_Absyn_Float_p_struct*)
_temp1509)->f1; goto _LL1524;} else{ goto _LL1525;} _LL1525: if(( unsigned int)
_temp1509 > 2u?*(( int*) _temp1509) == Cyc_Absyn_Enum_p: 0){ _LL1563: _temp1562=((
struct Cyc_Absyn_Enum_p_struct*) _temp1509)->f1; goto _LL1561; _LL1561:
_temp1560=(( struct Cyc_Absyn_Enum_p_struct*) _temp1509)->f2; goto _LL1526;}
else{ goto _LL1527;} _LL1527: if(( unsigned int) _temp1509 > 2u?*(( int*)
_temp1509) == Cyc_Absyn_Tunion_p: 0){ _LL1571: _temp1570=(( struct Cyc_Absyn_Tunion_p_struct*)
_temp1509)->f1; goto _LL1569; _LL1569: _temp1568=(( struct Cyc_Absyn_Tunion_p_struct*)
_temp1509)->f2; goto _LL1567; _LL1567: _temp1566=(( struct Cyc_Absyn_Tunion_p_struct*)
_temp1509)->f3; goto _LL1565; _LL1565: _temp1564=(( struct Cyc_Absyn_Tunion_p_struct*)
_temp1509)->f4; if( _temp1564 == 0){ goto _LL1528;} else{ goto _LL1529;}} else{
goto _LL1529;} _LL1529: if(( unsigned int) _temp1509 > 2u?*(( int*) _temp1509)
== Cyc_Absyn_Pointer_p: 0){ _LL1574: _temp1573=(( struct Cyc_Absyn_Pointer_p_struct*)
_temp1509)->f1; _temp1575=* _temp1573; _LL1577: _temp1576=( void*) _temp1575.r;
if(( unsigned int) _temp1576 > 2u?*(( int*) _temp1576) == Cyc_Absyn_Tunion_p: 0){
_LL1585: _temp1584=(( struct Cyc_Absyn_Tunion_p_struct*) _temp1576)->f1; goto
_LL1583; _LL1583: _temp1582=(( struct Cyc_Absyn_Tunion_p_struct*) _temp1576)->f2;
goto _LL1581; _LL1581: _temp1580=(( struct Cyc_Absyn_Tunion_p_struct*) _temp1576)->f3;
goto _LL1579; _LL1579: _temp1578=(( struct Cyc_Absyn_Tunion_p_struct*) _temp1576)->f4;
goto _LL1572;} else{ goto _LL1531;}} else{ goto _LL1531;} _LL1572: if( _temp1578
!= 0){ goto _LL1530;} else{ goto _LL1531;} _LL1531: if(( unsigned int) _temp1509
> 2u?*(( int*) _temp1509) == Cyc_Absyn_Tunion_p: 0){ _LL1587: _temp1586=((
struct Cyc_Absyn_Tunion_p_struct*) _temp1509)->f4; goto _LL1532;} else{ goto
_LL1533;} _LL1533: if(( unsigned int) _temp1509 > 2u?*(( int*) _temp1509) == Cyc_Absyn_Tuple_p:
0){ _LL1589: _temp1588=(( struct Cyc_Absyn_Tuple_p_struct*) _temp1509)->f1; goto
_LL1534;} else{ goto _LL1535;} _LL1535: if(( unsigned int) _temp1509 > 2u?*((
int*) _temp1509) == Cyc_Absyn_Struct_p: 0){ _LL1597: _temp1596=(( struct Cyc_Absyn_Struct_p_struct*)
_temp1509)->f1; goto _LL1595; _LL1595: _temp1594=(( struct Cyc_Absyn_Struct_p_struct*)
_temp1509)->f2; goto _LL1593; _LL1593: _temp1592=(( struct Cyc_Absyn_Struct_p_struct*)
_temp1509)->f3; goto _LL1591; _LL1591: _temp1590=(( struct Cyc_Absyn_Struct_p_struct*)
_temp1509)->f4; goto _LL1536;} else{ goto _LL1537;} _LL1537: if(( unsigned int)
_temp1509 > 2u?*(( int*) _temp1509) == Cyc_Absyn_Pointer_p: 0){ _LL1599:
_temp1598=(( struct Cyc_Absyn_Pointer_p_struct*) _temp1509)->f1; goto _LL1538;}
else{ goto _LL1539;} _LL1539: if(( unsigned int) _temp1509 > 2u?*(( int*)
_temp1509) == Cyc_Absyn_UnknownId_p: 0){ goto _LL1540;} else{ goto _LL1541;}
_LL1541: if(( unsigned int) _temp1509 > 2u?*(( int*) _temp1509) == Cyc_Absyn_UnknownCall_p:
0){ goto _LL1542;} else{ goto _LL1543;} _LL1543: if(( unsigned int) _temp1509 >
2u?*(( int*) _temp1509) == Cyc_Absyn_UnknownFields_p: 0){ goto _LL1544;} else{
goto _LL1510;} _LL1512: nv= Cyc_Toc_add_varmap( nv, _temp1548, r); goto _LL1514;
_LL1514: s= Cyc_Absyn_goto_stmt( succ_lab, 0); goto _LL1510; _LL1516: { struct
_tuple0* _temp1600= Cyc_Toc_temp_var(); decls=({ struct Cyc_List_List* _temp1601=(
struct Cyc_List_List*) _region_malloc( rgn, sizeof( struct Cyc_List_List));
_temp1601->hd=( void*)({ struct _tuple12* _temp1602=( struct _tuple12*)
_region_malloc( rgn, sizeof( struct _tuple12)); _temp1602->f1= _temp1600;
_temp1602->f2= Cyc_Absyn_cstar_typ( Cyc_Toc_typ_to_c( t), Cyc_Toc_mt_tq);
_temp1602;}); _temp1601->tl= decls; _temp1601;}); nv= Cyc_Toc_add_varmap( nv,
_temp1550->name, Cyc_Absyn_var_exp( _temp1600, 0)); s= Cyc_Absyn_seq_stmt( Cyc_Absyn_assign_stmt(
Cyc_Absyn_var_exp( _temp1600, 0), Cyc_Absyn_address_exp( path, 0), 0), Cyc_Absyn_goto_stmt(
...
Cyc_Absyn_int_exp( _temp1554, _temp1552, 0), succ_lab, fail_lab); goto _LL1510;
_LL1522: s= Cyc_Toc_if_eq_goto_stmt( r, Cyc_Absyn_char_exp( _temp1556, 0),
succ_lab, fail_lab); goto _LL1510; _LL1524: s= Cyc_Toc_if_eq_goto_stmt( r, Cyc_Absyn_float_exp(
_temp1558, 0), succ_lab, fail_lab); goto _LL1510; _LL1526: s= Cyc_Toc_if_eq_goto_stmt(
r, Cyc_Absyn_new_exp(( void*)({ struct Cyc_Absyn_Enum_e_struct* _temp1603=(
struct Cyc_Absyn_Enum_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Enum_e_struct));
_temp1603[ 0]=({ struct Cyc_Absyn_Enum_e_struct _temp1604; _temp1604.tag= Cyc_Absyn_Enum_e;
_temp1604.f1= _temp1560->name; _temp1604.f2=( struct Cyc_Absyn_Enumdecl*)
_temp1562; _temp1604.f3=( struct Cyc_Absyn_Enumfield*) _temp1560; _temp1604;});
_temp1603;}), 0), succ_lab, fail_lab); goto _LL1510; _LL1528: { struct Cyc_Absyn_Exp*
cmp_exp= Cyc_Absyn_var_exp( _temp1568->name, 0); if( ! _temp1570->is_xtunion){
cmp_exp= Cyc_Absyn_cast_exp( Cyc_Absyn_void_star_typ(), cmp_exp, 0);} s= Cyc_Toc_if_eq_goto_stmt(
r, cmp_exp, succ_lab, fail_lab); goto _LL1510;} _LL1530: { struct Cyc_List_List*
ss= 0; int cnt=(( int(*)( struct Cyc_List_List* x)) Cyc_List_length)( _temp1578);
struct _tuple0* tufstrct= Cyc_Toc_collapse_qvar_tag( _temp1582->name, _tag_arr("_struct",
...
Cyc_List_List* _temp1605=(( struct Cyc_List_List*(*)( struct _RegionHandle*,
struct Cyc_List_List* x)) Cyc_List_rrev)( rgn, _temp1582->typs); struct Cyc_List_List*
_temp1606=(( struct Cyc_List_List*(*)( struct _RegionHandle*, struct Cyc_List_List*
x)) Cyc_List_rrev)( rgn, _temp1578); for( 0; _temp1606 != 0;((( _temp1606=((
struct Cyc_List_List*) _check_null( _temp1606))->tl, _temp1605=(( struct Cyc_List_List*)
_check_null( _temp1605))->tl)), cnt --)){ struct Cyc_Absyn_Pat* _temp1607=(
struct Cyc_Absyn_Pat*)(( struct Cyc_List_List*) _check_null( _temp1606))->hd;
if(( void*) _temp1607->r ==( void*) Cyc_Absyn_Wild_p){ continue;}{ void*
_temp1608=(*(( struct _tuple3*)(( struct Cyc_List_List*) _check_null( _temp1605))->hd)).f2;
struct _tuple0* _temp1609= Cyc_Toc_temp_var(); void* _temp1610=( void*)(( struct
Cyc_Core_Opt*) _check_null( _temp1607->topt))->v; void* _temp1611= Cyc_Toc_typ_to_c(
_temp1610); struct _tagged_arr* _temp1612= Cyc_Toc_fresh_label(); struct Cyc_Absyn_Exp*
_temp1613= Cyc_Absyn_structarrow_exp( rcast, Cyc_Toc_fieldname( cnt), 0); if(
Cyc_Toc_is_void_star( Cyc_Toc_typ_to_c( _temp1608))){ _temp1613= Cyc_Absyn_cast_exp(
_temp1611, _temp1613, 0);} decls=({ struct Cyc_List_List* _temp1614=( struct Cyc_List_List*)
_region_malloc( rgn, sizeof( struct Cyc_List_List)); _temp1614->hd=( void*)({
struct _tuple12* _temp1615=( struct _tuple12*) _region_malloc( rgn, sizeof(
struct _tuple12)); _temp1615->f1= _temp1609; _temp1615->f2= _temp1611; _temp1615;});
_temp1614->tl= decls; _temp1614;});{ struct _tuple11 _temp1616= Cyc_Toc_xlate_pat(
nv, rgn, _temp1610, Cyc_Absyn_var_exp( _temp1609, 0), _temp1613, _temp1607,
succ_lab, fail_lab, decls); nv= _temp1616.f1; decls= _temp1616.f2;{ struct Cyc_Absyn_Stmt*
_temp1617= _temp1616.f3; struct Cyc_Absyn_Stmt* _temp1618= Cyc_Absyn_assign_stmt(
Cyc_Absyn_var_exp( _temp1609, 0), _temp1613, 0); struct Cyc_Absyn_Stmt*
_temp1619= Cyc_Absyn_seq_stmt( _temp1618, _temp1617, 0); ss=({ struct Cyc_List_List*
_temp1620=( struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List));
_temp1620->hd=( void*) Cyc_Absyn_label_stmt( _temp1612, _temp1619, 0); _temp1620->tl=
ss; _temp1620;}); succ_lab= _temp1612;}}}} if( ss == 0){ ss=({ struct Cyc_List_List*
_temp1621=( struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List));
_temp1621->hd=( void*) Cyc_Absyn_goto_stmt( succ_lab, 0); _temp1621->tl= 0;
_temp1621;});}{ struct Cyc_Absyn_Exp* test_exp; if( _temp1584->is_xtunion){
...
struct Cyc_Absyn_Exp* e= Cyc_Absyn_var_exp( _temp1582->name, 0); test_exp= Cyc_Absyn_eq_exp(
...
struct Cyc_List_List* _temp1622=( struct Cyc_List_List*)(( struct Cyc_Core_Opt*)
_check_null( _temp1584->fields))->v; for( 0; _temp1622 != 0; _temp1622=(( struct
Cyc_List_List*) _check_null( _temp1622))->tl){ struct Cyc_Absyn_Tunionfield*
_temp1623=( struct Cyc_Absyn_Tunionfield*)(( struct Cyc_List_List*) _check_null(
_temp1622))->hd; if( _temp1623->typs == 0){ max_tag ++;}}}{ struct Cyc_Absyn_Exp*
...
_temp1582->name, 0); test_exp= max_tag > 0? Cyc_Absyn_and_exp( e5, Cyc_Absyn_eq_exp(
...
goto _LL1510;}} _LL1532: _temp1588= _temp1586; goto _LL1534; _LL1534: { struct
Cyc_List_List* ss= 0; int cnt=(( int(*)( struct Cyc_List_List* x)) Cyc_List_length)(
_temp1588);{ struct Cyc_List_List* _temp1624=(( struct Cyc_List_List*(*)( struct
_RegionHandle*, struct Cyc_List_List* x)) Cyc_List_rrev)( rgn, _temp1588); for(
0; _temp1624 != 0;( _temp1624=(( struct Cyc_List_List*) _check_null( _temp1624))->tl,
cnt --)){ struct Cyc_Absyn_Pat* _temp1625=( struct Cyc_Absyn_Pat*)(( struct Cyc_List_List*)
_check_null( _temp1624))->hd; if(( void*) _temp1625->r ==( void*) Cyc_Absyn_Wild_p){
continue;}{ struct _tuple0* _temp1626= Cyc_Toc_temp_var(); void* _temp1627=(
void*)(( struct Cyc_Core_Opt*) _check_null( _temp1625->topt))->v; struct
_tagged_arr* _temp1628= Cyc_Toc_fresh_label(); decls=({ struct Cyc_List_List*
_temp1629=( struct Cyc_List_List*) _region_malloc( rgn, sizeof( struct Cyc_List_List));
_temp1629->hd=( void*)({ struct _tuple12* _temp1630=( struct _tuple12*)
_region_malloc( rgn, sizeof( struct _tuple12)); _temp1630->f1= _temp1626;
_temp1630->f2= Cyc_Toc_typ_to_c( _temp1627); _temp1630;}); _temp1629->tl= decls;
_temp1629;});{ struct _tuple11 _temp1631= Cyc_Toc_xlate_pat( nv, rgn, _temp1627,
Cyc_Absyn_var_exp( _temp1626, 0), Cyc_Absyn_structmember_exp( path, Cyc_Toc_fieldname(
cnt), 0), _temp1625, succ_lab, fail_lab, decls); nv= _temp1631.f1; decls=
_temp1631.f2;{ struct Cyc_Absyn_Stmt* _temp1632= _temp1631.f3; struct Cyc_Absyn_Stmt*
_temp1633= Cyc_Absyn_seq_stmt( Cyc_Absyn_assign_stmt( Cyc_Absyn_var_exp(
_temp1626, 0), Cyc_Absyn_structmember_exp( r, Cyc_Toc_fieldname( cnt), 0), 0),
_temp1632, 0); ss=({ struct Cyc_List_List* _temp1634=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1634->hd=( void*) Cyc_Absyn_label_stmt(
_temp1628, _temp1633, 0); _temp1634->tl= ss; _temp1634;}); succ_lab= _temp1628;}}}}}
if( ss == 0){ ss=({ struct Cyc_List_List* _temp1635=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1635->hd=( void*) Cyc_Absyn_goto_stmt(
succ_lab, 0); _temp1635->tl= 0; _temp1635;});} s= Cyc_Absyn_seq_stmts( ss, 0);
goto _LL1510;} _LL1536: { struct Cyc_List_List* ss= 0;{ struct Cyc_List_List*
_temp1636=(( struct Cyc_List_List*(*)( struct _RegionHandle*, struct Cyc_List_List*
x)) Cyc_List_rrev)( rgn, _temp1590); for( 0; _temp1636 != 0; _temp1636=(( struct
Cyc_List_List*) _check_null( _temp1636))->tl){ struct _tuple13* _temp1637=(
struct _tuple13*)(( struct Cyc_List_List*) _check_null( _temp1636))->hd; struct
Cyc_Absyn_Pat* _temp1638=(* _temp1637).f2; if(( void*) _temp1638->r ==( void*)
Cyc_Absyn_Wild_p){ continue;}{ struct _tagged_arr* f;{ void* _temp1639=( void*)((
struct Cyc_List_List*) _check_null((* _temp1637).f1))->hd; struct _tagged_arr*
_temp1645; _LL1641: if(*(( int*) _temp1639) == Cyc_Absyn_FieldName){ _LL1646:
_temp1645=(( struct Cyc_Absyn_FieldName_struct*) _temp1639)->f1; goto _LL1642;}
else{ goto _LL1643;} _LL1643: goto _LL1644; _LL1642: f= _temp1645; goto _LL1640;
_LL1644:( int) _throw(( void*) Cyc_Toc_Match_error); _LL1640:;}{ struct _tuple0*
_temp1647= Cyc_Toc_temp_var(); void* _temp1648=( void*)(( struct Cyc_Core_Opt*)
_check_null( _temp1638->topt))->v; void* _temp1649= Cyc_Toc_typ_to_c( _temp1648);
struct _tagged_arr* _temp1650= Cyc_Toc_fresh_label(); decls=({ struct Cyc_List_List*
_temp1651=( struct Cyc_List_List*) _region_malloc( rgn, sizeof( struct Cyc_List_List));
_temp1651->hd=( void*)({ struct _tuple12* _temp1652=( struct _tuple12*)
_region_malloc( rgn, sizeof( struct _tuple12)); _temp1652->f1= _temp1647;
_temp1652->f2= _temp1649; _temp1652;}); _temp1651->tl= decls; _temp1651;});{
struct _tuple11 _temp1653= Cyc_Toc_xlate_pat( nv, rgn, _temp1648, Cyc_Absyn_var_exp(
_temp1647, 0), Cyc_Absyn_structmember_exp( path, f, 0), _temp1638, succ_lab,
fail_lab, decls); nv= _temp1653.f1; decls= _temp1653.f2;{ struct Cyc_Absyn_Exp*
_temp1654= Cyc_Absyn_structmember_exp( r, f, 0); if( Cyc_Toc_is_void_star(( void*)((
struct Cyc_Absyn_Structfield*) _check_null( Cyc_Absyn_lookup_field(( struct Cyc_List_List*)((
struct Cyc_Core_Opt*) _check_null( _temp1596->fields))->v, f)))->type)){
_temp1654= Cyc_Absyn_cast_exp( _temp1649, _temp1654, 0);}{ struct Cyc_Absyn_Stmt*
_temp1655= _temp1653.f3; struct Cyc_Absyn_Stmt* _temp1656= Cyc_Absyn_seq_stmt(
Cyc_Absyn_assign_stmt( Cyc_Absyn_var_exp( _temp1647, 0), _temp1654, 0),
_temp1655, 0); ss=({ struct Cyc_List_List* _temp1657=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1657->hd=( void*) Cyc_Absyn_label_stmt(
_temp1650, _temp1656, 0); _temp1657->tl= ss; _temp1657;}); succ_lab= _temp1650;}}}}}}}
if( ss == 0){ ss=({ struct Cyc_List_List* _temp1658=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1658->hd=( void*) Cyc_Absyn_goto_stmt(
succ_lab, 0); _temp1658->tl= 0; _temp1658;});} s= Cyc_Absyn_seq_stmts( ss, 0);
goto _LL1510;} _LL1538: { struct _tuple0* _temp1659= Cyc_Toc_temp_var(); void*
_temp1660=( void*)(( struct Cyc_Core_Opt*) _check_null( _temp1598->topt))->v;
decls=({ struct Cyc_List_List* _temp1661=( struct Cyc_List_List*) _region_malloc(
rgn, sizeof( struct Cyc_List_List)); _temp1661->hd=( void*)({ struct _tuple12*
_temp1662=( struct _tuple12*) _region_malloc( rgn, sizeof( struct _tuple12));
_temp1662->f1= _temp1659; _temp1662->f2= Cyc_Toc_typ_to_c( _temp1660); _temp1662;});
_temp1661->tl= decls; _temp1661;});{ struct _tuple11 _temp1663= Cyc_Toc_xlate_pat(
nv, rgn, _temp1660, Cyc_Absyn_var_exp( _temp1659, 0), Cyc_Absyn_deref_exp( path,
0), _temp1598, succ_lab, fail_lab, decls); nv= _temp1663.f1; decls= _temp1663.f2;{
struct Cyc_Absyn_Stmt* _temp1664= _temp1663.f3; struct Cyc_Absyn_Stmt* _temp1665=
Cyc_Absyn_seq_stmt( Cyc_Absyn_assign_stmt( Cyc_Absyn_var_exp( _temp1659, 0), Cyc_Absyn_deref_exp(
r, 0), 0), _temp1664, 0); if( Cyc_Toc_is_nullable( t)){ s= Cyc_Absyn_ifthenelse_stmt(
Cyc_Absyn_eq_exp( r, Cyc_Absyn_signed_int_exp( 0, 0), 0), Cyc_Absyn_goto_stmt(
fail_lab, 0), _temp1665, 0);} else{ s= _temp1665;} goto _LL1510;}}} _LL1540: s=({
void* _temp1666[ 0u]={};(( struct Cyc_Absyn_Stmt*(*)( struct _tagged_arr fmt,
struct _tagged_arr ap)) Cyc_Toc_toc_impos)( _tag_arr("unknownid", sizeof(
unsigned char), 10u), _tag_arr( _temp1666, sizeof( void*), 0u));}); goto _LL1510;
_LL1542: s=({ void* _temp1667[ 0u]={};(( struct Cyc_Absyn_Stmt*(*)( struct
_tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_toc_impos)( _tag_arr("unknowncall",
sizeof( unsigned char), 12u), _tag_arr( _temp1667, sizeof( void*), 0u));}); goto
_LL1510; _LL1544: s=({ void* _temp1668[ 0u]={};(( struct Cyc_Absyn_Stmt*(*)(
struct _tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_toc_impos)( _tag_arr("unknownfields",
sizeof( unsigned char), 14u), _tag_arr( _temp1668, sizeof( void*), 0u));}); goto
_LL1510; _LL1510:;} return({ struct _tuple11 _temp1669; _temp1669.f1= nv;
_temp1669.f2= decls; _temp1669.f3= s; _temp1669;});} struct _tuple14{ struct
...
sc){ return({ struct _tuple14* _temp1670=( struct _tuple14*) _region_malloc( r,
sizeof( struct _tuple14)); _temp1670->f1= Cyc_Toc_fresh_label(); _temp1670->f2=
Cyc_Toc_fresh_label(); _temp1670->f3= sc; _temp1670;});} static void Cyc_Toc_xlate_switch(
struct Cyc_Toc_Env* nv, struct Cyc_Absyn_Stmt* whole_s, struct Cyc_Absyn_Exp* e,
struct Cyc_List_List* scs){ Cyc_Toc_exp_to_c( nv, e);{ void* _temp1671=( void*)((
struct Cyc_Core_Opt*) _check_null( e->topt))->v; int leave_as_switch;{ void*
_temp1672= Cyc_Tcutil_compress( _temp1671); _LL1674: if(( unsigned int)
_temp1672 > 4u?*(( int*) _temp1672) == Cyc_Absyn_IntType: 0){ goto _LL1675;}
else{ goto _LL1676;} _LL1676: goto _LL1677; _LL1675: leave_as_switch= 1; goto
_LL1673; _LL1677: leave_as_switch= 0; goto _LL1673; _LL1673:;}{ struct Cyc_List_List*
...
_temp1683= Cyc_Toc_xlate_pat( nv, rgn, _temp1671, r, path, sc->pattern, succ_lab,
...
nv, rgn, _temp1671, r, path, sc->pattern, _temp1687, fail_lab, decls); Cyc_Toc_exp_to_c(
