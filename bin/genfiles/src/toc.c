...
_tagged_arr)({ struct Cyc_Stdio_Int_pa_struct _temp62; _temp62.tag= Cyc_Stdio_Int_pa;
_temp62.f1=( int) j;{ void* _temp61[ 1u]={& _temp62}; Cyc_Stdio_aprintf(
_tag_arr("f%d", sizeof( unsigned char), 4u), _tag_arr( _temp61, sizeof( void*),
1u));}}); _temp60;});}}; _temp63;});} return*(( struct _tagged_arr**)
...
struct _tagged_arr)({ struct Cyc_Stdio_Int_pa_struct _temp157; _temp157.tag= Cyc_Stdio_Int_pa;
...
Cyc_Absyn_Exp*) Cyc_Absyn_string_exp(( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct
...
_check_null( Cyc_Toc_xtunion_fields_so_far))->v, f->name,( void*) f->sc != (
void*) Cyc_Absyn_Extern)); if( f->typs !=  0){ struct Cyc_List_List* fields= 0;
int i= 1;{ struct Cyc_List_List* _temp1998= f->typs; for( 0; _temp1998 !=  0;(
_temp1998=(( struct Cyc_List_List*) _check_null( _temp1998))->tl, i ++)){ struct
_tagged_arr* _temp1999=({ struct _tagged_arr* _temp2003=( struct _tagged_arr*)
GC_malloc( sizeof( struct _tagged_arr)); _temp2003[ 0]=( struct _tagged_arr)({
struct Cyc_Stdio_Int_pa_struct _temp2005; _temp2005.tag= Cyc_Stdio_Int_pa;
_temp2005.f1=( int)(( unsigned int) i);{ void* _temp2004[ 1u]={& _temp2005}; Cyc_Stdio_aprintf(
_tag_arr("f%d", sizeof( unsigned char), 4u), _tag_arr( _temp2004, sizeof( void*),
1u));}}); _temp2003;}); struct Cyc_Absyn_Structfield* _temp2000=({ struct Cyc_Absyn_Structfield*
