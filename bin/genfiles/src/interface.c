...
unsigned char* tag; struct _tuple9* f1; } ; extern unsigned char Cyc_Rgnorder_tok[
...
struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp28; _temp28.tag=
Cyc_Stdio_String_pa; _temp28.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string( n);{
struct Cyc_Stdio_String_pa_struct _temp27; _temp27.tag= Cyc_Stdio_String_pa;
_temp27.f1=( struct _tagged_arr) t;{ struct Cyc_Stdio_String_pa_struct _temp26;
_temp26.tag= Cyc_Stdio_String_pa; _temp26.f1=( struct _tagged_arr) sc;{ void*
_temp25[ 3u]={& _temp26,& _temp27,& _temp28}; Cyc_Stdio_aprintf( _tag_arr("fields of %s %s %s have never been defined",
sizeof( unsigned char), 43u), _tag_arr( _temp25, sizeof( void*), 3u));}}}}));}
static void Cyc_Interface_body_err( struct _tagged_arr sc, struct _tuple0* n){
Cyc_Interface_err(( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct
_temp31; _temp31.tag= Cyc_Stdio_String_pa; _temp31.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
n);{ struct Cyc_Stdio_String_pa_struct _temp30; _temp30.tag= Cyc_Stdio_String_pa;
_temp30.f1=( struct _tagged_arr) sc;{ void* _temp29[ 2u]={& _temp30,& _temp31};
Cyc_Stdio_aprintf( _tag_arr("the body of %s function %s has never been defined",
...
_tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp36; _temp36.tag= Cyc_Stdio_String_pa;
_temp36.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string( name2);{ struct Cyc_Stdio_String_pa_struct
_temp35; _temp35.tag= Cyc_Stdio_String_pa; _temp35.f1=( struct _tagged_arr) obj2;{
struct Cyc_Stdio_String_pa_struct _temp34; _temp34.tag= Cyc_Stdio_String_pa;
_temp34.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string( name1);{ struct Cyc_Stdio_String_pa_struct
_temp33; _temp33.tag= Cyc_Stdio_String_pa; _temp33.f1=( struct _tagged_arr) obj1;{
void* _temp32[ 4u]={& _temp33,& _temp34,& _temp35,& _temp36}; Cyc_Stdio_aprintf(
...
Cyc_Interface_err(( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct
_temp41; _temp41.tag= Cyc_Stdio_String_pa; _temp41.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
name2);{ struct Cyc_Stdio_String_pa_struct _temp40; _temp40.tag= Cyc_Stdio_String_pa;
_temp40.f1=( struct _tagged_arr) obj2;{ struct Cyc_Stdio_String_pa_struct
_temp39; _temp39.tag= Cyc_Stdio_String_pa; _temp39.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
name1);{ struct Cyc_Stdio_String_pa_struct _temp38; _temp38.tag= Cyc_Stdio_String_pa;
_temp38.f1=( struct _tagged_arr) obj1;{ void* _temp37[ 4u]={& _temp38,& _temp39,&
_temp40,& _temp41}; Cyc_Stdio_aprintf( _tag_arr("declaration of %s %s relies on fields of abstract %s %s",
...
struct Cyc_Core_Opt*) _check_null( d->fields))->v; for( 0; _temp56 != 0; _temp56=((
struct Cyc_List_List*) _check_null( _temp56))->tl){ if( ! Cyc_Interface_check_public_type(
...
_temp123 == 0){ goto _LL101;} else{ _temp125=* _temp123; _LL127: _temp126=( void*)
_temp125.v; goto _LL100;}} else{ goto _LL101;} _LL101: if(( unsigned int)
...
struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp194; _temp194.tag=
Cyc_Stdio_String_pa; _temp194.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
_temp148);{ void* _temp193[ 1u]={& _temp194}; Cyc_Stdio_aprintf( _tag_arr("check_public_type (can't find enum %s)",
...
_temp215.f1=( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp217;
_temp217.tag= Cyc_Stdio_String_pa; _temp217.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
_temp156->name);{ void* _temp216[ 1u]={& _temp217}; Cyc_Stdio_aprintf( _tag_arr("check_public_type (can't find [x]tunion %s)",
...
_tag_arr("[x]tunion", sizeof( unsigned char), 10u), tud->name); return 0;}
...
struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp240; _temp240.tag=
Cyc_Stdio_String_pa; _temp240.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
_temp166->name);{ void* _temp239[ 1u]={& _temp240}; Cyc_Stdio_aprintf( _tag_arr("check_public_type (can't find [x]tunion %s and search its fields)",
...
_temp242.f1=( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp244;
_temp244.tag= Cyc_Stdio_String_pa; _temp244.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
tud->name);{ void* _temp243[ 1u]={& _temp244}; Cyc_Stdio_aprintf( _tag_arr("check_public_type ([x]tunion %s has no fields)",
...
if( Cyc_String_strptrcmp((* _temp164->name).f2,(*(( struct Cyc_Absyn_Tunionfield*)((
...
struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp249; _temp249.tag=
Cyc_Stdio_String_pa; _temp249.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
_temp164->name);{ void* _temp248[ 1u]={& _temp249}; Cyc_Stdio_aprintf( _tag_arr("check_public_type (can't find [x]tunionfield %s)",
...
obj, name,( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp251;
_temp251.tag= Cyc_Stdio_String_pa; _temp251.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
tuf->name);{ void* _temp250[ 1u]={& _temp251}; Cyc_Stdio_aprintf( _tag_arr("field %s of",
...
return 1; _LL94:;} struct _tuple11{ struct Cyc_Interface_Ienv* f1; struct Cyc_Interface_Ienv*
...
_temp263; struct _tuple11* _temp252= env; _temp254=* _temp252; _LL264: _temp263=
...
_LL267:;}} static void Cyc_Interface_extract_uniondecl( struct _tuple11* env,
...
_temp291; struct _tuple11* _temp280= env; _temp282=* _temp280; _LL292: _temp291=
...
_LL295:;}} static void Cyc_Interface_extract_enumdecl( struct _tuple11* env,
struct _tagged_arr* x, struct Cyc_Absyn_Enumdecl** dp){ struct _tuple11 _temp310;
...
_temp319; struct _tuple11* _temp308= env; _temp310=* _temp308; _LL320: _temp319=
...
if( _temp321->fields == 0){ Cyc_Interface_fields_err( _tag_arr("public", sizeof(
unsigned char), 7u), _tag_arr("enum", sizeof( unsigned char), 5u), _temp321->name);
_temp321=({ struct Cyc_Absyn_Enumdecl* _temp335=( struct Cyc_Absyn_Enumdecl*)
...
struct Cyc_List_List* _temp347; _LL339: if(( unsigned int) _temp337 > 1u?*(( int*)
_temp337) == Cyc_Absyn_Rel_n: 0){ _LL346: _temp345=(( struct Cyc_Absyn_Rel_n_struct*)
...
struct _tuple11 _temp374; struct Cyc_Interface_I* _temp375; struct Cyc_Interface_Seen*
_temp377; struct Cyc_Dict_Dict* _temp379; int _temp381; struct Cyc_Interface_Ienv*
_temp383; struct Cyc_Interface_Ienv* _temp385; struct _tuple11* _temp372= env;
...
Cyc_List_List* _temp408= _temp407; for( 0; _temp408 != 0; _temp408=(( struct Cyc_List_List*)
_check_null( _temp408))->tl){ Cyc_Interface_extract_xtunionfielddecl( _temp375,
_temp387,( struct Cyc_Absyn_Tunionfield*)(( struct Cyc_List_List*) _check_null(
_temp408))->hd);}}}} _temp385->tuniondecls=(( struct Cyc_Dict_Dict*(*)( struct
Cyc_Dict_Dict* d, struct _tagged_arr* key, struct Cyc_Absyn_Tuniondecl* data))
Cyc_Dict_insert)( _temp385->tuniondecls, x, _temp387);} goto _LL389; _LL389:;}}
static void Cyc_Interface_extract_typedef( struct _tuple11* env, struct
_tagged_arr* x, struct Cyc_Absyn_Typedefdecl* d){ struct _tuple11 _temp411;
struct Cyc_Interface_Seen* _temp412; struct Cyc_Dict_Dict* _temp414; struct Cyc_Interface_Ienv*
_temp416; struct _tuple11* _temp409= env; _temp411=* _temp409; _LL417: _temp416=
_temp411.f2; goto _LL415; _LL415: _temp414= _temp411.f4; goto _LL413; _LL413:
_temp412= _temp411.f5; goto _LL410; _LL410: if( Cyc_Interface_check_public_typedefdecl(
...
_temp429; struct _tuple11* _temp418= env; _temp420=* _temp418; _LL430: _temp429=
...
_LL464;} _LL464: if( _temp456 ==( void*) Cyc_Absyn_ExternC){ goto _LL465;} else{
goto _LL466;} _LL466: if( _temp456 ==( void*) Cyc_Absyn_Extern){ goto _LL467;}
else{ goto _LL457;} _LL459: if( _temp425? Cyc_Tcutil_is_function_type(( void*)
_temp450->type): 0){ Cyc_Interface_body_err( _tag_arr("static", sizeof(
...
int _temp477; struct Cyc_Interface_I* _temp479; struct _tuple12* _temp470= env_f;
...
_LL474: _temp473= _temp472.f4; goto _LL471; _LL471: { struct _tuple11 _temp481=({
struct _tuple11 _temp482; _temp482.f1=(( struct Cyc_Interface_Ienv*(*)( struct
...
_temp482;});(( void(*)( void(* f)( struct _tuple11*, struct _tagged_arr*, struct
...
_temp481, ge->uniondecls);(( void(*)( void(* f)( struct _tuple11*, struct
...
_temp481, ge->enumdecls);(( void(*)( void(* f)( struct _tuple11*, struct
...
struct Cyc_Dict_Dict* ae, int check_complete_defs){ struct _tuple12 _temp483=({
struct _tuple12 _temp484; _temp484.f1=(( struct Cyc_Interface_I*(*)( struct Cyc_Dict_Dict*
...
struct _tuple13* env, struct _tagged_arr* x, void* y1){ struct _tuple13 _temp487;
...
_temp498; struct _tuple13* _temp485= env; _temp487=* _temp485; _LL497: _temp496=
...
_tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp512; _temp512.tag= Cyc_Stdio_String_pa;
_temp512.f1=( struct _tagged_arr)* x;{ struct Cyc_Stdio_String_pa_struct
_temp511; _temp511.tag= Cyc_Stdio_String_pa; _temp511.f1=( struct _tagged_arr)
_temp490;{ void* _temp510[ 2u]={& _temp511,& _temp512}; Cyc_Stdio_aprintf(
...
_temp513=({ struct _tuple13 _temp514; _temp514.f1= 1; _temp514.f2= dic2;
...
msg,( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp517; _temp517.tag=
Cyc_Stdio_String_pa; _temp517.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string((
struct _tuple0*)(( struct Cyc_Core_Opt*) _check_null( d1->name))->v);{ void*
_temp516[ 1u]={& _temp517}; Cyc_Stdio_aprintf( _tag_arr("declaration of struct %s discloses too much information",
...
msg,( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp520; _temp520.tag=
Cyc_Stdio_String_pa; _temp520.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string((
struct _tuple0*)(( struct Cyc_Core_Opt*) _check_null( d1->name))->v);{ void*
_temp519[ 1u]={& _temp520}; Cyc_Stdio_aprintf( _tag_arr("declaration of union %s discloses too much information",
...
msg,( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp523; _temp523.tag=
Cyc_Stdio_String_pa; _temp523.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
d1->name);{ void* _temp522[ 1u]={& _temp523}; Cyc_Stdio_aprintf( _tag_arr("declaration of tunion %s discloses too much information",
...
_temp524= Cyc_Tcdecl_merge_enumdecl( d0, d1, 0, msg); if( _temp524 == 0){ return
0;} if(( struct Cyc_Absyn_Enumdecl*) d0 != _temp524){ Cyc_Interface_check_err(
msg,( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp526; _temp526.tag=
Cyc_Stdio_String_pa; _temp526.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
d1->name);{ void* _temp525[ 1u]={& _temp526}; Cyc_Stdio_aprintf( _tag_arr("declaration of enum %s discloses too much information",
...
msg,( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp529; _temp529.tag=
Cyc_Stdio_String_pa; _temp529.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
d1->name);{ void* _temp528[ 1u]={& _temp529}; Cyc_Stdio_aprintf( _tag_arr("declaration of variable %s discloses too much information",
...
msg,( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp532; _temp532.tag=
Cyc_Stdio_String_pa; _temp532.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
d1->name);{ void* _temp531[ 1u]={& _temp532}; Cyc_Stdio_aprintf( _tag_arr("declaration of typedef %s discloses too much information",
...
msg,( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp535; _temp535.tag=
Cyc_Stdio_String_pa; _temp535.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string((
d1->field)->name);{ void* _temp534[ 1u]={& _temp535}; Cyc_Stdio_aprintf(
...
_temp539: 0)? _temp540: 0)? _temp541: 0)? _temp542: 0;} struct _tuple14{ int f1;
...
struct _tuple14 _temp545; struct _tagged_arr* _temp546; struct Cyc_Dict_Dict*
_temp548; int _temp550; int* _temp552; struct _tuple14* _temp543= env; _temp545=*
...
struct Cyc_Dict_Dict* dic2, struct _tagged_arr* msg){ struct _tuple14 _temp563=({
struct _tuple14 _temp564; _temp564.f1= 1; _temp564.f2= dic2; _temp564.f3= msg;
_temp564;});(( void(*)( void(* f)( struct _tuple14*, struct Cyc_List_List*,
...
struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp572; _temp572.tag=
Cyc_Stdio_String_pa; _temp572.f1=( struct _tagged_arr)(*(( struct _tuple3*)
_check_null( info))).f2;{ struct Cyc_Stdio_String_pa_struct _temp571; _temp571.tag=
Cyc_Stdio_String_pa; _temp571.f1=( struct _tagged_arr)(*(( struct _tuple3*)
_check_null( info))).f1;{ void* _temp570[ 2u]={& _temp571,& _temp572}; Cyc_Stdio_aprintf(
...
info != 0){ msg=({ struct _tagged_arr* _temp573=( struct _tagged_arr*) GC_malloc(
sizeof( struct _tagged_arr)); _temp573[ 0]=( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct
_temp576; _temp576.tag= Cyc_Stdio_String_pa; _temp576.f1=( struct _tagged_arr)(*((
struct _tuple3*) _check_null( info))).f1;{ struct Cyc_Stdio_String_pa_struct
_temp575; _temp575.tag= Cyc_Stdio_String_pa; _temp575.f1=( struct _tagged_arr)(*((
struct _tuple3*) _check_null( info))).f2;{ void* _temp574[ 2u]={& _temp575,&
_temp576}; Cyc_Stdio_aprintf( _tag_arr("checking inclusion of %s imports into %s imports,",
...
_temp579); _LL580:;}}} struct _tuple15{ int f1; struct Cyc_Dict_Dict* f2; struct
...
_tuple15* env, struct _tagged_arr* x, void** y2){ struct _tuple15 _temp587;
...
Cyc_Dict_Dict** _temp600; int _temp601; int* _temp603; struct _tuple15* _temp585=
...
struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp623; _temp623.tag=
Cyc_Stdio_String_pa; _temp623.f1=( struct _tagged_arr)* x;{ struct Cyc_Stdio_String_pa_struct
_temp622; _temp622.tag= Cyc_Stdio_String_pa; _temp622.f1=( struct _tagged_arr)
_temp590;{ void* _temp621[ 2u]={& _temp622,& _temp623}; Cyc_Stdio_aprintf(
...
struct _tagged_arr* msg){ struct _tuple15 _temp631=({ struct _tuple15 _temp633;
...
struct _tuple16 _temp644; struct _tagged_arr* _temp645; struct Cyc_Dict_Dict*
_temp647; struct Cyc_Dict_Dict* _temp649; struct Cyc_Dict_Dict* _temp651; struct
Cyc_Dict_Dict** _temp653; int _temp654; int* _temp656; struct _tuple16* _temp642=
...
struct _tuple16 _temp679=({ struct _tuple16 _temp681; _temp681.f1= 1; _temp681.f2=((
struct Cyc_Dict_Dict*(*)( int(* comp)( struct Cyc_List_List*, struct Cyc_List_List*)))
Cyc_Dict_empty)( Cyc_Absyn_varlist_cmp); _temp681.f3= dic1; _temp681.f4= excl;
_temp681.f5= msg; _temp681;});(( void(*)( void(* f)( struct _tuple16*, struct
Cyc_List_List*, struct Cyc_Interface_Ienv*), struct _tuple16* env, struct Cyc_Dict_Dict*
d)) Cyc_Dict_iter_c)( Cyc_Interface_compat_merge_ns_f,& _temp679, dic2); if(
_temp679.f1){ return({ struct Cyc_Core_Opt* _temp680=( struct Cyc_Core_Opt*)
GC_malloc( sizeof( struct Cyc_Core_Opt)); _temp680->v=( void*) _temp679.f2;
_temp680;});} else{ return 0;}} struct _tuple17{ int f1; struct Cyc_Dict_Dict*
...
x, void* y){ struct _tuple17 _temp684; struct _tagged_arr* _temp685; struct
_tagged_arr _temp687; struct Cyc_Dict_Dict* _temp689; struct Cyc_Dict_Dict*
_temp691; struct Cyc_Dict_Dict** _temp693; int _temp694; int* _temp696; struct
_tuple17* _temp682= env; _temp684=* _temp682; _LL695: _temp694= _temp684.f1;
_temp696=&(* _temp682).f1; goto _LL692; _LL692: _temp691= _temp684.f2; _temp693=&(*
_temp682).f2; goto _LL690; _LL690: _temp689= _temp684.f3; goto _LL688; _LL688:
_temp687= _temp684.f4; goto _LL686; _LL686: _temp685= _temp684.f5; goto _LL683;
_LL683: if((( int(*)( struct Cyc_Dict_Dict* d, struct _tagged_arr* key)) Cyc_Dict_member)(
_temp689, x)){ Cyc_Interface_check_err( _temp685,( struct _tagged_arr)({ struct
Cyc_Stdio_String_pa_struct _temp699; _temp699.tag= Cyc_Stdio_String_pa; _temp699.f1=(
struct _tagged_arr)* x;{ struct Cyc_Stdio_String_pa_struct _temp698; _temp698.tag=
Cyc_Stdio_String_pa; _temp698.f1=( struct _tagged_arr) _temp687;{ void* _temp697[
2u]={& _temp698,& _temp699}; Cyc_Stdio_aprintf( _tag_arr("%s %s is exported more than once",
...
_tagged_arr* msg){ struct _tuple17 _temp700=({ struct _tuple17 _temp702;
_temp702.f1= 1; _temp702.f2= dic1; _temp702.f3= dic1; _temp702.f4= t; _temp702.f5=
msg; _temp702;});(( void(*)( void(* f)( struct _tuple17*, struct _tagged_arr*,
...
_temp723; struct _tuple18* _temp711= env; _temp713=* _temp711; _LL722: _temp721=
...
_temp735=({ struct _tuple18 _temp737; _temp737.f1= 1; _temp737.f2= dic1;
...
msg= 0; if( info != 0){ msg=({ struct _tagged_arr* _temp741=( struct _tagged_arr*)
GC_malloc( sizeof( struct _tagged_arr)); _temp741[ 0]=( struct _tagged_arr)({
struct Cyc_Stdio_String_pa_struct _temp744; _temp744.tag= Cyc_Stdio_String_pa;
_temp744.f1=( struct _tagged_arr)(*(( struct _tuple3*) _check_null( info))).f2;{
struct Cyc_Stdio_String_pa_struct _temp743; _temp743.tag= Cyc_Stdio_String_pa;
_temp743.f1=( struct _tagged_arr)(*(( struct _tuple3*) _check_null( info))).f1;{
void* _temp742[ 2u]={& _temp743,& _temp744}; Cyc_Stdio_aprintf( _tag_arr("merging exports of %s and %s,",
...
_temp747[ 0]=( struct _tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp750;
_temp750.tag= Cyc_Stdio_String_pa; _temp750.f1=( struct _tagged_arr)(*(( struct
_tuple3*) _check_null( info))).f2;{ struct Cyc_Stdio_String_pa_struct _temp749;
_temp749.tag= Cyc_Stdio_String_pa; _temp749.f1=( struct _tagged_arr)(*(( struct
_tuple3*) _check_null( info))).f1;{ void* _temp748[ 2u]={& _temp749,& _temp750};
Cyc_Stdio_aprintf( _tag_arr("merging imports of %s and %s,", sizeof(
unsigned char), 30u), _tag_arr( _temp748, sizeof( void*), 2u));}}}); _temp747;});}{
struct Cyc_Core_Opt* _temp751= Cyc_Interface_compat_merge_ns( i1->imports, i2->imports,(
struct Cyc_Dict_Dict*)(( struct Cyc_Core_Opt*) _check_null( _temp745))->v, msg);
if( _temp751 == 0){ struct Cyc_Interface_I* _temp752= 0; _npop_handler( 0u);
return _temp752;}{ struct Cyc_Interface_I* _temp754=({ struct Cyc_Interface_I*
_temp753=( struct Cyc_Interface_I*) GC_malloc( sizeof( struct Cyc_Interface_I));
_temp753->imports=( struct Cyc_Dict_Dict*)(( struct Cyc_Core_Opt*) _check_null(
_temp751))->v; _temp753->exports=( struct Cyc_Dict_Dict*)(( struct Cyc_Core_Opt*)
_check_null( _temp745))->v; _temp753;}); _npop_handler( 0u); return _temp754;}}}};
...
struct Cyc_Stdio_String_pa_struct _temp766; _temp766.tag= Cyc_Stdio_String_pa;
_temp766.f1=( struct _tagged_arr)*(( struct _tagged_arr*)(( struct Cyc_List_List*)
_check_null( linfo))->hd);{ struct Cyc_Stdio_String_pa_struct _temp765; _temp765.tag=
Cyc_Stdio_String_pa; _temp765.f1=( struct _tagged_arr)*(( struct _tagged_arr*)
_check_null( curr_info));{ void* _temp764[ 2u]={& _temp765,& _temp766}; Cyc_Stdio_aprintf(
...
struct Cyc_Stdio_String_pa_struct _temp772; _temp772.tag= Cyc_Stdio_String_pa;
_temp772.f1=( struct _tagged_arr)*(( struct _tagged_arr*)(( struct Cyc_List_List*)
_check_null( linfo))->hd);{ struct Cyc_Stdio_String_pa_struct _temp771; _temp771.tag=
Cyc_Stdio_String_pa; _temp771.f1=( struct _tagged_arr)*(( struct _tagged_arr*)
_check_null( curr_info));{ void* _temp770[ 2u]={& _temp771,& _temp772}; Cyc_Stdio_aprintf(
...
struct _tuple10* x){ return({ struct _tuple10* _temp795=( struct _tuple10*)
GC_malloc( sizeof( struct _tuple10)); _temp795->f1= Cyc_Absyn_empty_tqual();
...
Cyc_Absynpp_cyci_params_r);({ void* _temp848[ 0u]={}; Cyc_Stdio_fprintf( f,
_tag_arr("/****** needed (headers) ******/\n", sizeof( unsigned char), 34u),
_tag_arr( _temp848, sizeof( void*), 0u));});(( void(*)( void(* f)( struct Cyc_Stdio___sFILE*,
...
f, i->imports);({ void* _temp849[ 0u]={}; Cyc_Stdio_fprintf( f, _tag_arr("\n/****** provided (headers) ******/\n",
...
f, i->exports);({ void* _temp850[ 0u]={}; Cyc_Stdio_fprintf( f, _tag_arr("/****** needed (headers of xtunionfielddecls) ******/\n",
...
f, i->imports);({ void* _temp851[ 0u]={}; Cyc_Stdio_fprintf( f, _tag_arr("\n/****** provided (headers of xtunionfielddecls) ******/\n",
sizeof( unsigned char), 58u), _tag_arr( _temp851, sizeof( void*), 0u));});((
void(*)( void(* f)( struct Cyc_Stdio___sFILE*, struct Cyc_List_List*, struct Cyc_Interface_Ienv*),
struct Cyc_Stdio___sFILE* env, struct Cyc_Dict_Dict* d)) Cyc_Dict_iter_c)( Cyc_Interface_print_ns_xtunionfielddecl_headers,
f, i->exports);({ void* _temp852[ 0u]={}; Cyc_Stdio_fprintf( f, _tag_arr("\n/****** provided (typedefs) ******/\n",
...
f, i->exports);({ void* _temp853[ 0u]={}; Cyc_Stdio_fprintf( f, _tag_arr("\n/****** needed (declarations) ******/\n",
...
f, i->imports);({ void* _temp854[ 0u]={}; Cyc_Stdio_fprintf( f, _tag_arr("\n/****** provided (declarations) ******/\n",
