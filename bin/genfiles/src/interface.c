...
extern int Cyc_Interface_is_subinterface(struct Cyc_Interface_T *i1,struct Cyc_Interface_T *i2);
...
struct Cyc_Lexing_lex_tables {
  struct _tagged_ptr0 lex_base;
  struct _tagged_ptr0 lex_backtrk;
  struct _tagged_ptr0 lex_default;
  struct _tagged_ptr0 lex_trans;
  struct _tagged_ptr0 lex_check;
};
...
typedef struct Cyc_Interface_Ienv *Cyc_Interface_ienv_t;
struct Cyc_Interface_T {
  struct Cyc_Dict_Dict *imports;
  struct Cyc_Dict_Dict *exports;
};
struct Cyc_Interface_Ienv *Cyc_Interface_new_ienv() {
  return ({ struct Cyc_Interface_Ienv *_temp0 = (struct Cyc_Interface_Ienv *)GC_malloc(sizeof(struct Cyc_Interface_Ienv));
    _temp0->structdecls = ((struct Cyc_Dict_Dict *(*)(int (*comp)(struct _tagged_string *,
								  struct _tagged_string *)))Cyc_Dict_empty)(Cyc_String_zstrptrcmp);
    _temp0->uniondecls = ((struct Cyc_Dict_Dict *(*)(int (*comp)(struct _tagged_string *,
								 struct _tagged_string *)))Cyc_Dict_empty)(Cyc_String_zstrptrcmp);
    _temp0->tuniondecls = ((struct Cyc_Dict_Dict *(*)(int (*comp)(struct _tagged_string *,
								  struct _tagged_string *)))Cyc_Dict_empty)(Cyc_String_zstrptrcmp);
    _temp0->enumdecls = ((struct Cyc_Dict_Dict *(*)(int (*comp)(struct _tagged_string *,
								struct _tagged_string *)))Cyc_Dict_empty)(Cyc_String_zstrptrcmp);
    _temp0->typedefdecls = ((struct Cyc_Dict_Dict *(*)(int (*comp)(struct _tagged_string *,
								   struct _tagged_string *)))Cyc_Dict_empty)(Cyc_String_zstrptrcmp);
...
struct _tuple9 {
  ...
  struct Cyc_Interface_Ienv *f2;
};
static void Cyc_Interface_extract_structdecl(struct _tuple9 *env,struct _tagged_string *x,
					     struct Cyc_Absyn_Structdecl **dp) {
  struct Cyc_Interface_Ienv *ext = (*env).f1;
  struct Cyc_Interface_Ienv *pub = (*env).f2;
  struct Cyc_Absyn_Structdecl *d = *dp;
  void *_temp1 = (void *)d->sc;
  _LL3: if (_temp1 == (void *)Cyc_Absyn_Static) {
    goto _LL4;
  }
  else {
    goto _LL5;
  }
  _LL5: if (_temp1 == (void *)Cyc_Absyn_Abstract) {
    goto _LL6;
  }
  else {
    goto _LL7;
  }
  _LL7: if (_temp1 == (void *)Cyc_Absyn_Public) {
    goto _LL8;
  }
  else {
    goto _LL9;
  }
  _LL9: if (_temp1 == (void *)Cyc_Absyn_ExternC) {
    goto _LL10;
  }
  else {
    goto _LL11;
  }
  _LL11: if (_temp1 == (void *)Cyc_Absyn_Extern) {
    goto _LL12;
  }
  else {
    goto _LL2;
  ...
  _LL4: goto _LL2;
  _LL6: if (d->fields != 0) {
	  d = ({ struct Cyc_Absyn_Structdecl *_temp13 = (struct Cyc_Absyn_Structdecl *)GC_malloc(sizeof(struct Cyc_Absyn_Structdecl));
	    _temp13[0] = *d;
	    _temp13; });
	  d->fields = 0;
	}
	goto _LL8;
  _LL8: pub->structdecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
						       struct _tagged_string *key,
						       struct Cyc_Absyn_Structdecl *data))Cyc_Dict_insert)(pub->structdecls,
													   x,
													   d);
	goto _LL2;
  _LL10: goto _LL12;
  _LL12: ext->structdecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
							struct _tagged_string *key,
							struct Cyc_Absyn_Structdecl *data))Cyc_Dict_insert)(ext->structdecls,
													    x,
													    d);
	 goto _LL2;
  _LL2: ;
}
static void Cyc_Interface_extract_uniondecl(struct _tuple9 *env,struct _tagged_string *x,
					    struct Cyc_Absyn_Uniondecl **dp) {
  struct Cyc_Interface_Ienv *ext = (*env).f1;
  struct Cyc_Interface_Ienv *pub = (*env).f2;
  struct Cyc_Absyn_Uniondecl *d = *dp;
  void *_temp14 = (void *)d->sc;
  _LL16: if (_temp14 == (void *)Cyc_Absyn_Static) {
    goto _LL17;
  }
  else {
    goto _LL18;
  }
  _LL18: if (_temp14 == (void *)Cyc_Absyn_Abstract) {
    goto _LL19;
  }
  else {
    goto _LL20;
  }
  _LL20: if (_temp14 == (void *)Cyc_Absyn_Public) {
    goto _LL21;
  }
  else {
    goto _LL22;
  }
  _LL22: if (_temp14 == (void *)Cyc_Absyn_ExternC) {
    goto _LL23;
  }
  else {
    goto _LL24;
  }
  _LL24: if (_temp14 == (void *)Cyc_Absyn_Extern) {
    goto _LL25;
  }
  else {
    goto _LL15;
  ...
  _LL17: goto _LL15;
  _LL19: if (d->fields != 0) {
	   d = ({ struct Cyc_Absyn_Uniondecl *_temp26 = (struct Cyc_Absyn_Uniondecl *)GC_malloc(sizeof(struct Cyc_Absyn_Uniondecl));
	     _temp26[0] = *d;
	     _temp26; });
	   d->fields = 0;
	 }
	 goto _LL21;
  _LL21: pub->uniondecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
						       struct _tagged_string *key,
						       struct Cyc_Absyn_Uniondecl *data))Cyc_Dict_insert)(pub->uniondecls,
													  x,
													  d);
	 goto _LL15;
  _LL23: goto _LL25;
  _LL25: ext->uniondecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
						       struct _tagged_string *key,
						       struct Cyc_Absyn_Uniondecl *data))Cyc_Dict_insert)(ext->uniondecls,
													  x,
													  d);
	 goto _LL15;
  _LL15: ;
}
static void Cyc_Interface_extract_tuniondecl(struct _tuple9 *env,struct _tagged_string *x,
					     struct Cyc_Absyn_Tuniondecl **dp) {
  struct Cyc_Interface_Ienv *ext = (*env).f1;
  struct Cyc_Interface_Ienv *pub = (*env).f2;
  struct Cyc_Absyn_Tuniondecl *d = *dp;
  void *_temp27 = (void *)d->sc;
  _LL29: if (_temp27 == (void *)Cyc_Absyn_Static) {
    goto _LL30;
  }
  else {
    goto _LL31;
  }
  _LL31: if (_temp27 == (void *)Cyc_Absyn_Abstract) {
    goto _LL32;
  }
  else {
    goto _LL33;
  }
  _LL33: if (_temp27 == (void *)Cyc_Absyn_Public) {
    goto _LL34;
  }
  else {
    goto _LL35;
  }
  _LL35: if (_temp27 == (void *)Cyc_Absyn_ExternC) {
    goto _LL36;
  }
  else {
    goto _LL37;
  }
  _LL37: if (_temp27 == (void *)Cyc_Absyn_Extern) {
    goto _LL38;
  }
  else {
    goto _LL28;
  ...
  _LL30: goto _LL28;
  _LL32: if (d->fields != 0) {
	   d = ({ struct Cyc_Absyn_Tuniondecl *_temp39 = (struct Cyc_Absyn_Tuniondecl *)GC_malloc(sizeof(struct Cyc_Absyn_Tuniondecl));
	     _temp39[0] = *d;
	     _temp39; });
	   d->fields = 0;
	 }
	 goto _LL34;
  _LL34: pub->tuniondecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
							struct _tagged_string *key,
							struct Cyc_Absyn_Tuniondecl *data))Cyc_Dict_insert)(pub->tuniondecls,
													    x,
													    d);
	 goto _LL28;
  _LL36: goto _LL38;
  _LL38: ext->tuniondecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
							struct _tagged_string *key,
							struct Cyc_Absyn_Tuniondecl *data))Cyc_Dict_insert)(ext->tuniondecls,
													    x,
													    d);
	 goto _LL28;
  _LL28: ;
}
static void Cyc_Interface_extract_enumdecl(struct _tuple9 *env,struct _tagged_string *x,
					   struct Cyc_Absyn_Enumdecl **dp) {
  struct Cyc_Interface_Ienv *ext = (*env).f1;
  struct Cyc_Interface_Ienv *pub = (*env).f2;
  struct Cyc_Absyn_Enumdecl *d = *dp;
  void *_temp40 = (void *)d->sc;
  _LL42: if (_temp40 == (void *)Cyc_Absyn_Static) {
    goto _LL43;
  }
  else {
    goto _LL44;
  }
  _LL44: if (_temp40 == (void *)Cyc_Absyn_Abstract) {
    goto _LL45;
  }
  else {
    goto _LL46;
  }
  _LL46: if (_temp40 == (void *)Cyc_Absyn_Public) {
    goto _LL47;
  }
  else {
    goto _LL48;
  }
  _LL48: if (_temp40 == (void *)Cyc_Absyn_ExternC) {
    goto _LL49;
  }
  else {
    goto _LL50;
  }
  _LL50: if (_temp40 == (void *)Cyc_Absyn_Extern) {
    goto _LL51;
  }
  else {
    goto _LL41;
  ...
  _LL43: goto _LL41;
  _LL45: if (d->fields != 0) {
	   d = ({ struct Cyc_Absyn_Enumdecl *_temp52 = (struct Cyc_Absyn_Enumdecl *)GC_malloc(sizeof(struct Cyc_Absyn_Enumdecl));
	     _temp52[0] = *d;
	     _temp52; });
	   d->fields = 0;
	 }
	 goto _LL47;
  _LL47: pub->enumdecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
						      struct _tagged_string *key,
						      struct Cyc_Absyn_Enumdecl *data))Cyc_Dict_insert)(pub->enumdecls,
													x,
													d);
	 goto _LL41;
  _LL49: goto _LL51;
  _LL51: ext->enumdecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
						      struct _tagged_string *key,
						      struct Cyc_Absyn_Enumdecl *data))Cyc_Dict_insert)(ext->enumdecls,
													x,
													d);
	 goto _LL41;
  _LL41: ;
}
static void Cyc_Interface_extract_typedef(struct _tuple9 *env,struct _tagged_string *x,
					  struct Cyc_Absyn_Typedefdecl *d) {
  struct Cyc_Interface_Ienv *pub = (*env).f2;
  pub->typedefdecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
						  struct _tagged_string *key,
						  struct Cyc_Absyn_Typedefdecl *data))Cyc_Dict_insert)(pub->typedefdecls,
												       x,
												       d);
}
struct _tuple10 {
...
static void Cyc_Interface_extract_ordinarie(struct _tuple10 *env,struct _tagged_string *x,
					    struct _tuple3 *v) {
  struct Cyc_Interface_Ienv *ext = (*env).f1;
  struct Cyc_Interface_Ienv *pub = (*env).f2;
  int check_fun_definition = (*env).f3;
  void *r = (*v).f1;
  void *_temp53 = r;
  void *_temp59;
  _LL55: if (*((int *)_temp53) == Cyc_Tcenv_VarRes) {
    _LL60: _temp59 = (void *)((struct Cyc_Tcenv_VarRes_struct *)_temp53)->f1;
	   goto _LL56;
  }
  else {
    goto _LL57;
  ...
  _LL57: goto _LL58;
  _LL56: { void *_temp61 = _temp59;
    struct Cyc_Absyn_Fndecl *_temp69;
    struct Cyc_Absyn_Vardecl *_temp71;
    _LL63: if ((unsigned int)_temp61 > 1 ? *((int *)_temp61) == Cyc_Absyn_Funname_b : 0) {
      _LL70: _temp69 = (struct Cyc_Absyn_Fndecl *)((struct Cyc_Absyn_Funname_b_struct *)_temp61)->f1;
	     goto _LL64;
    }
    else {
      goto _LL65;
    }
    _LL65: if ((unsigned int)_temp61 > 1 ? *((int *)_temp61) == Cyc_Absyn_Global_b : 0) {
      _LL72: _temp71 = (struct Cyc_Absyn_Vardecl *)((struct Cyc_Absyn_Global_b_struct *)_temp61)->f1;
	     goto _LL66;
    }
    else {
      goto _LL67;
    ...
    _LL67: goto _LL68;
    _LL64: {
    struct Cyc_Absyn_Vardecl *vd = ({ struct Cyc_Absyn_Vardecl *_temp73 = (struct Cyc_Absyn_Vardecl *)GC_malloc(sizeof(struct Cyc_Absyn_Vardecl));
	_temp73->sc = (void *)((void *)_temp69->sc);
	_temp73->name = _temp69->name;
	_temp73->tq = ({ struct Cyc_Absyn_Tqual _temp75;
	  _temp75.q_const = 0;
	  _temp75.q_volatile = 0;
	  _temp75.q_restrict = 0;
	  _temp75; });
	_temp73->type = (void *)((void *)({ struct Cyc_Core_Opt *_temp74 = _temp69->cached_typ;
	  if (_temp74 == 0) {
	    _throw(Null_Exception);
	  }
	  _temp74->v; }));
	_temp73->initializer = 0;
	_temp73->rgn = 0;
	_temp73->attributes = 0;
	_temp73; });
      check_fun_definition = 0;
      _temp71 = vd;
      goto _LL66;
    }
    _LL66: _temp71 = ({ struct Cyc_Absyn_Vardecl *_temp76 = (struct Cyc_Absyn_Vardecl *)GC_malloc(sizeof(struct Cyc_Absyn_Vardecl));
	     _temp76[0] = *_temp71;
	     _temp76; });
	   _temp71->initializer = 0;
	   { void *_temp77 = (void *)_temp71->sc;
	     _LL79: if (_temp77 == (void *)Cyc_Absyn_Static) {
	       goto _LL80;
	     }
	     else {
	       goto _LL81;
	     }
	     _LL81: if (_temp77 == (void *)Cyc_Absyn_Abstract) {
	       goto _LL82;
	     }
	     else {
	       goto _LL83;
	     }
	     _LL83: if (_temp77 == (void *)Cyc_Absyn_Public) {
	       goto _LL84;
	     }
	     else {
	       goto _LL85;
	     }
	     _LL85: if (_temp77 == (void *)Cyc_Absyn_ExternC) {
	       goto _LL86;
	     }
	     else {
	       goto _LL87;
	     }
	     _LL87: if (_temp77 == (void *)Cyc_Absyn_Extern) {
	       goto _LL88;
	     }
	     else {
	       goto _LL78;
	     }
	     _LL80: if (check_fun_definition ? Cyc_Tcutil_is_function_type((void *)_temp71->type) : 0) {
		      Cyc_Tcutil_terr(Cyc_Position_segment_of_abs(0,0),({ struct _tagged_string _temp89 = Cyc_Absynpp_qvar2string(_temp71->name);
					xprintf("static function %.*s has never been defined",
						_temp89.last_plus_one - _temp89.curr,
						_temp89.curr); }));
		    }
		    goto _LL78;
	     _LL82: goto _LL78;
	     _LL84: if (check_fun_definition ? Cyc_Tcutil_is_function_type((void *)_temp71->type) : 0) {
		      Cyc_Tcutil_terr(Cyc_Position_segment_of_abs(0,0),({ struct _tagged_string _temp90 = Cyc_Absynpp_qvar2string(_temp71->name);
					xprintf("public function %.*s has never been defined",
						_temp90.last_plus_one - _temp90.curr,
						_temp90.curr); }));
		    }
		    pub->vardecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
								struct _tagged_string *key,
								struct Cyc_Absyn_Vardecl *data))Cyc_Dict_insert)(pub->vardecls,
														 x,
														 _temp71);
		    goto _LL78;
	     _LL86: goto _LL88;
	     _LL88: ext->vardecls = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Dict_Dict *d,
								struct _tagged_string *key,
								struct Cyc_Absyn_Vardecl *data))Cyc_Dict_insert)(ext->vardecls,
														 x,
														 _temp71);
		    goto _LL78;
	     _LL78: ;
...
struct _tuple11 {
  struct Cyc_Interface_T *f1;
  int f2;
};
static void Cyc_Interface_extract_f(struct _tuple11 *env_f,struct Cyc_List_List *ns,
				    struct Cyc_Tcenv_Genv *ge) {
  struct Cyc_Interface_T *i = (*env_f).f1;
  int check_fun_definition = (*env_f).f2;
  struct _tuple9 *env = ({ struct _tuple9 *_temp92 = (struct _tuple9 *)GC_malloc(sizeof(struct _tuple9));
    _temp92->f1 = ((struct Cyc_Interface_Ienv *(*)(struct Cyc_Dict_Dict *d,
						   struct Cyc_List_List *key))Cyc_Dict_lookup)(i->imports,
											       ns);
    _temp92->f2 = ((struct Cyc_Interface_Ienv *(*)(struct Cyc_Dict_Dict *d,
						   struct Cyc_List_List *key))Cyc_Dict_lookup)(i->exports,
											       ns);
    _temp92; });
  ((void (*)(void (*f)(struct _tuple9 *,struct _tagged_string *,struct Cyc_Absyn_Structdecl **),
  ...
  ((void (*)(void (*f)(struct _tuple9 *,struct _tagged_string *,struct Cyc_Absyn_Tuniondecl **),
	     struct _tuple9 *env,struct Cyc_Dict_Dict *d))Cyc_Dict_iter_c)(Cyc_Interface_extract_tuniondecl,
									   env,
									   ge->tuniondecls);
  ((void (*)(void (*f)(struct _tuple9 *,struct _tagged_string *,struct Cyc_Absyn_Enumdecl **),
	     struct _tuple9 *env,struct Cyc_Dict_Dict *d))Cyc_Dict_iter_c)(Cyc_Interface_extract_enumdecl,
									   env,
									   ge->enumdecls);
  ((void (*)(void (*f)(struct _tuple9 *,struct _tagged_string *,struct Cyc_Absyn_Typedefdecl *),
	     struct _tuple9 *env,struct Cyc_Dict_Dict *d))Cyc_Dict_iter_c)(Cyc_Interface_extract_typedef,
									   env,
									   ge->typedefs);
  ((void (*)(void (*f)(struct _tuple10 *,struct _tagged_string *,struct _tuple3 *),
	     struct _tuple10 *env,struct Cyc_Dict_Dict *d))Cyc_Dict_iter_c)(Cyc_Interface_extract_ordinarie,
									    ({ struct _tuple10 *_temp91 = (struct _tuple10 *)GC_malloc(sizeof(struct _tuple10));
									      _temp91->f1 = (*env).f1;
									      _temp91->f2 = (*env).f2;
									      _temp91->f3 = check_fun_definition;
									      _temp91; }),
									    ge->ordinaries);
}
...
static struct Cyc_Interface_T *Cyc_Interface_gen_extract(struct Cyc_Dict_Dict *ae,
							 int check_fun_definition) {
  struct Cyc_Interface_T *i = ({ struct Cyc_Interface_T *_temp94 = (struct Cyc_Interface_T *)GC_malloc(sizeof(struct Cyc_Interface_T));
    _temp94->imports = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Interface_Ienv *(*f)(struct Cyc_Tcenv_Genv *),
						   struct Cyc_Dict_Dict *d))Cyc_Dict_map)((struct Cyc_Interface_Ienv *(*)(struct Cyc_Tcenv_Genv *ignore))Cyc_Interface_extract_new_ienv,
											  ae);
    _temp94->exports = ((struct Cyc_Dict_Dict *(*)(struct Cyc_Interface_Ienv *(*f)(struct Cyc_Tcenv_Genv *),
						   struct Cyc_Dict_Dict *d))Cyc_Dict_map)((struct Cyc_Interface_Ienv *(*)(struct Cyc_Tcenv_Genv *ignore))Cyc_Interface_extract_new_ienv,
											  ae);
    _temp94; });
  ((void (*)(void (*f)(struct _tuple11 *,struct Cyc_List_List *,struct Cyc_Tcenv_Genv *),
	     struct _tuple11 *env,struct Cyc_Dict_Dict *d))Cyc_Dict_iter_c)(Cyc_Interface_extract_f,
									    ({ struct _tuple11 *_temp93 = (struct _tuple11 *)GC_malloc(sizeof(struct _tuple11));
									      _temp93->f1 = i;
									      _temp93->f2 = check_fun_definition;
									      _temp93; }),
									    ae);
  return i;
}
struct Cyc_Interface_T *Cyc_Interface_extract(struct Cyc_Dict_Dict *ae) {
  return Cyc_Interface_gen_extract(ae,1);
}
char Cyc_Interface_Check_False[10] = "\000\000\000\000False";
static void Cyc_Interface_Check_is_true(int b) {
  if (! b) {
    (void)_throw((void *)Cyc_Interface_Check_False);
  }
}
static void Cyc_Interface_Check_box(void *x,void *y) {
  Cyc_Interface_Check_is_true(x == y);
}
static void Cyc_Interface_Check_list(void (*f)(void *,void *),struct Cyc_List_List *l1,
				     struct Cyc_List_List *l2) {
  ((void (*)(void (*f)(void *,void *),struct Cyc_List_List *x,struct Cyc_List_List *y))Cyc_List_iter2)(f,
												       l1,
												       l2);
}
static void Cyc_Interface_Check_opt(void (*f)(void *,void *),struct Cyc_Core_Opt *o1,
				    struct Cyc_Core_Opt *o2) {
  if (o1 == 0) {
    Cyc_Interface_Check_is_true(o2 == 0);
  }
  else {
    Cyc_Interface_Check_is_true(o2 != 0);
    f((void *)({ struct Cyc_Core_Opt *_temp95 = o1;
	if (_temp95 == 0) {
	  _throw(Null_Exception);
	}
	_temp95->v; }),(void *)({ struct Cyc_Core_Opt *_temp96 = o2;
	if (_temp96 == 0) {
	  _throw(Null_Exception);
	}
	_temp96->v; }));
...
static void Cyc_Interface_Check_str(struct _tagged_string s1,struct _tagged_string s2) {
  Cyc_Interface_Check_is_true(Cyc_String_strcmp(s1,s2) == 0);
}
static void Cyc_Interface_Check_strptr(struct _tagged_string *n1,struct _tagged_string *n2) {
  Cyc_Interface_Check_str(*n1,*n2);
}
static void Cyc_Interface_Check_tvar(struct Cyc_Absyn_Tvar *t1,struct Cyc_Absyn_Tvar *t2) {
  ;
}
static void Cyc_Interface_Check_tvar_list(struct Cyc_List_List *l1,struct Cyc_List_List *l2) {
  ((void (*)(void (*f)(struct Cyc_Absyn_Tvar *,struct Cyc_Absyn_Tvar *),struct Cyc_List_List *l1,
	     struct Cyc_List_List *l2))Cyc_Interface_Check_list)(Cyc_Interface_Check_tvar,
								 l1,l2);
}
static void Cyc_Interface_Check_tqual(struct Cyc_Absyn_Tqual t1,struct Cyc_Absyn_Tqual t2) {
  ;
}
static void Cyc_Interface_Check_structfield(struct Cyc_Absyn_Structfield *s1,
					    struct Cyc_Absyn_Structfield *s2) {
  Cyc_Interface_Check_strptr(s1->name,s2->name);
  Cyc_Interface_Check_tqual(s1->tq,s2->tq);
}
static void Cyc_Interface_Check_structfield_list(struct Cyc_List_List *l1,
						 struct Cyc_List_List *l2) {
  ((void (*)(void (*f)(struct Cyc_Absyn_Structfield *,struct Cyc_Absyn_Structfield *),
	     struct Cyc_List_List *l1,struct Cyc_List_List *l2))Cyc_Interface_Check_list)(Cyc_Interface_Check_structfield,
											  l1,
											  l2);
}
static void Cyc_Interface_Check_structdecl(struct Cyc_Absyn_Structdecl *d1,
					   struct Cyc_Absyn_Structdecl *d2) {
  ((void (*)(void *x,void *y))Cyc_Interface_Check_box)((void *)d1->sc,(void *)d2->sc);
  Cyc_Interface_Check_tvar_list(d1->tvs,d2->tvs);
  ((void (*)(void (*f)(struct Cyc_List_List *,struct Cyc_List_List *),struct Cyc_Core_Opt *o1,
	     struct Cyc_Core_Opt *o2))Cyc_Interface_Check_opt)(Cyc_Interface_Check_structfield_list,
							       d1->fields,
							       d2->fields);
}
static void Cyc_Interface_Check_uniondecl(struct Cyc_Absyn_Uniondecl *d1,
					  struct Cyc_Absyn_Uniondecl *d2) {
  ;
}
static void Cyc_Interface_Check_tuniondecl(struct Cyc_Absyn_Tuniondecl *d1,
					   struct Cyc_Absyn_Tuniondecl *d2) {
  ;
}
static void Cyc_Interface_Check_enumdecl(struct Cyc_Absyn_Enumdecl *d1,struct Cyc_Absyn_Enumdecl *d2) {
  ;
}
static void Cyc_Interface_Check_typedefdecl(struct Cyc_Absyn_Typedefdecl *d1,
					    struct Cyc_Absyn_Typedefdecl *d2) {
  ;
}
static void Cyc_Interface_Check_vardecl(struct Cyc_Absyn_Vardecl *d1,struct Cyc_Absyn_Vardecl *d2) {
  ;
}
static void Cyc_Interface_Check_incl_ns(struct Cyc_Interface_Ienv *ie1,struct Cyc_Interface_Ienv *ie2) {
  ((void (*)(void (*f)(struct Cyc_Absyn_Structdecl *,struct Cyc_Absyn_Structdecl *),
	     struct Cyc_Dict_Dict *d1,struct Cyc_Dict_Dict *d2))Cyc_Dict_iter2)(Cyc_Interface_Check_structdecl,
										ie1->structdecls,
										ie2->structdecls);
  ...
  ((void (*)(void (*f)(struct Cyc_Absyn_Tuniondecl *,struct Cyc_Absyn_Tuniondecl *),
	     struct Cyc_Dict_Dict *d1,struct Cyc_Dict_Dict *d2))Cyc_Dict_iter2)(Cyc_Interface_Check_tuniondecl,
										ie1->tuniondecls,
										ie2->tuniondecls);
  ((void (*)(void (*f)(struct Cyc_Absyn_Enumdecl *,struct Cyc_Absyn_Enumdecl *),
	     struct Cyc_Dict_Dict *d1,struct Cyc_Dict_Dict *d2))Cyc_Dict_iter2)(Cyc_Interface_Check_enumdecl,
										ie1->enumdecls,
										ie2->enumdecls);
  ((void (*)(void (*f)(struct Cyc_Absyn_Typedefdecl *,struct Cyc_Absyn_Typedefdecl *),
	     struct Cyc_Dict_Dict *d1,struct Cyc_Dict_Dict *d2))Cyc_Dict_iter2)(Cyc_Interface_Check_typedefdecl,
										ie1->typedefdecls,
										ie2->typedefdecls);
  ((void (*)(void (*f)(struct Cyc_Absyn_Vardecl *,struct Cyc_Absyn_Vardecl *),
	     struct Cyc_Dict_Dict *d1,struct Cyc_Dict_Dict *d2))Cyc_Dict_iter2)(Cyc_Interface_Check_vardecl,
										ie1->vardecls,
										ie2->vardecls);
}
int Cyc_Interface_is_subinterface(struct Cyc_Interface_T *i1,struct Cyc_Interface_T *i2) {
  { struct _handler_cons _temp97;
    _push_handler(&_temp97);
    { void *_temp98 = (void *)setjmp(_temp97.handler);
      if (! _temp98) {
	((void (*)(void (*f)(struct Cyc_Interface_Ienv *,struct Cyc_Interface_Ienv *),
	...
	void *_temp100 = _temp98;
	_LL102: if (_temp100 == Cyc_Interface_Check_False) {
	  goto _LL103;
	}
	else {
	  goto _LL104;
	}
	_LL104: if (_temp100 == Cyc_Dict_Absent) {
	  goto _LL105;
	}
	else {
	  goto _LL106;
...
static struct Cyc_List_List *Cyc_Interface_add_namespace(struct Cyc_List_List *tds,
  ...
  return ({ struct Cyc_List_List *_temp108 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp108->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Namespace_d_struct *_temp109 = (struct Cyc_Absyn_Namespace_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Namespace_d_struct));
						_temp109[0] = ({ struct Cyc_Absyn_Namespace_d_struct _temp110;
						  _temp110.tag = Cyc_Absyn_Namespace_d;
						  _temp110.f1 = (struct _tagged_string *)({ struct Cyc_List_List *_temp111 = ns;
						    if (_temp111 == 0) {
						      _throw(Null_Exception);
						    }
						    _temp111->hd; });
						  _temp110.f2 = Cyc_Interface_add_namespace(tds,
											    ({ struct Cyc_List_List *_temp112 = ns;
											      if (_temp112 == 0) {
												_throw(Null_Exception);
											      }
											      _temp112->tl; }));
...
static struct Cyc_List_List *Cyc_Interface_add_structdecl(struct _tagged_string *x,
							  struct Cyc_Absyn_Structdecl *d,
							  struct Cyc_List_List *tds) {
  return ({ struct Cyc_List_List *_temp113 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp113->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Struct_d_struct *_temp114 = (struct Cyc_Absyn_Struct_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Struct_d_struct));
						_temp114[0] = ({ struct Cyc_Absyn_Struct_d_struct _temp115;
						  _temp115.tag = Cyc_Absyn_Struct_d;
						  _temp115.f1 = d;
						  _temp115; });
						_temp114; }),0);
    _temp113->tl = tds;
...
static struct Cyc_List_List *Cyc_Interface_add_structdecl_header(struct _tagged_string *x,
								 struct Cyc_Absyn_Structdecl *d,
								 struct Cyc_List_List *tds) {
  d = ({ struct Cyc_Absyn_Structdecl *_temp116 = (struct Cyc_Absyn_Structdecl *)GC_malloc(sizeof(struct Cyc_Absyn_Structdecl));
    _temp116[0] = *d;
    _temp116; });
  d->fields = 0;
  (void *)(d->sc = (void *)((void *)Cyc_Absyn_Extern));
  return ({ struct Cyc_List_List *_temp117 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp117->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Struct_d_struct *_temp118 = (struct Cyc_Absyn_Struct_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Struct_d_struct));
						_temp118[0] = ({ struct Cyc_Absyn_Struct_d_struct _temp119;
						  _temp119.tag = Cyc_Absyn_Struct_d;
						  _temp119.f1 = d;
						  _temp119; });
						_temp118; }),0);
    _temp117->tl = tds;
...
static struct Cyc_List_List *Cyc_Interface_add_uniondecl(struct _tagged_string *x,
							 struct Cyc_Absyn_Uniondecl *d,
							 struct Cyc_List_List *tds) {
  return ({ struct Cyc_List_List *_temp120 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp120->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Union_d_struct *_temp121 = (struct Cyc_Absyn_Union_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Union_d_struct));
						_temp121[0] = ({ struct Cyc_Absyn_Union_d_struct _temp122;
						  _temp122.tag = Cyc_Absyn_Union_d;
						  _temp122.f1 = d;
						  _temp122; });
						_temp121; }),0);
    _temp120->tl = tds;
...
static struct Cyc_List_List *Cyc_Interface_add_uniondecl_header(struct _tagged_string *x,
								struct Cyc_Absyn_Uniondecl *d,
								struct Cyc_List_List *tds) {
  d = ({ struct Cyc_Absyn_Uniondecl *_temp123 = (struct Cyc_Absyn_Uniondecl *)GC_malloc(sizeof(struct Cyc_Absyn_Uniondecl));
    _temp123[0] = *d;
    _temp123; });
  d->fields = 0;
  (void *)(d->sc = (void *)((void *)Cyc_Absyn_Extern));
  return ({ struct Cyc_List_List *_temp124 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp124->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Union_d_struct *_temp125 = (struct Cyc_Absyn_Union_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Union_d_struct));
						_temp125[0] = ({ struct Cyc_Absyn_Union_d_struct _temp126;
						  _temp126.tag = Cyc_Absyn_Union_d;
						  _temp126.f1 = d;
						  _temp126; });
						_temp125; }),0);
    _temp124->tl = tds;
...
static struct Cyc_List_List *Cyc_Interface_add_tuniondecl(struct _tagged_string *x,
							  struct Cyc_Absyn_Tuniondecl *d,
							  struct Cyc_List_List *tds) {
  return ({ struct Cyc_List_List *_temp127 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp127->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Tunion_d_struct *_temp128 = (struct Cyc_Absyn_Tunion_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Tunion_d_struct));
						_temp128[0] = ({ struct Cyc_Absyn_Tunion_d_struct _temp129;
						  _temp129.tag = Cyc_Absyn_Tunion_d;
						  _temp129.f1 = d;
						  _temp129; });
						_temp128; }),0);
    _temp127->tl = tds;
...
static struct Cyc_List_List *Cyc_Interface_add_tuniondecl_header(struct _tagged_string *x,
								 struct Cyc_Absyn_Tuniondecl *d,
								 struct Cyc_List_List *tds) {
  d = ({ struct Cyc_Absyn_Tuniondecl *_temp130 = (struct Cyc_Absyn_Tuniondecl *)GC_malloc(sizeof(struct Cyc_Absyn_Tuniondecl));
    _temp130[0] = *d;
    _temp130; });
  d->fields = 0;
  (void *)(d->sc = (void *)((void *)Cyc_Absyn_Extern));
  return ({ struct Cyc_List_List *_temp131 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp131->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Tunion_d_struct *_temp132 = (struct Cyc_Absyn_Tunion_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Tunion_d_struct));
						_temp132[0] = ({ struct Cyc_Absyn_Tunion_d_struct _temp133;
						  _temp133.tag = Cyc_Absyn_Tunion_d;
						  _temp133.f1 = d;
						  _temp133; });
						_temp132; }),0);
    _temp131->tl = tds;
...
static struct Cyc_List_List *Cyc_Interface_add_enumdecl(struct _tagged_string *x,
							struct Cyc_Absyn_Enumdecl *d,
							struct Cyc_List_List *tds) {
  return ({ struct Cyc_List_List *_temp134 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp134->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Enum_d_struct *_temp135 = (struct Cyc_Absyn_Enum_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Enum_d_struct));
						_temp135[0] = ({ struct Cyc_Absyn_Enum_d_struct _temp136;
						  _temp136.tag = Cyc_Absyn_Enum_d;
						  _temp136.f1 = d;
						  _temp136; });
						_temp135; }),0);
    _temp134->tl = tds;
...
static struct Cyc_List_List *Cyc_Interface_add_enumdecl_header(struct _tagged_string *x,
							       struct Cyc_Absyn_Enumdecl *d,
							       struct Cyc_List_List *tds) {
  d = ({ struct Cyc_Absyn_Enumdecl *_temp137 = (struct Cyc_Absyn_Enumdecl *)GC_malloc(sizeof(struct Cyc_Absyn_Enumdecl));
    _temp137[0] = *d;
    _temp137; });
  d->fields = 0;
  (void *)(d->sc = (void *)((void *)Cyc_Absyn_Extern));
  return ({ struct Cyc_List_List *_temp138 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp138->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Enum_d_struct *_temp139 = (struct Cyc_Absyn_Enum_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Enum_d_struct));
						_temp139[0] = ({ struct Cyc_Absyn_Enum_d_struct _temp140;
						  _temp140.tag = Cyc_Absyn_Enum_d;
						  _temp140.f1 = d;
						  _temp140; });
						_temp139; }),0);
    _temp138->tl = tds;
...
static struct Cyc_List_List *Cyc_Interface_add_typedef(struct _tagged_string *x,
						       struct Cyc_Absyn_Typedefdecl *d,
						       struct Cyc_List_List *tds) {
  return ({ struct Cyc_List_List *_temp141 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp141->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Typedef_d_struct *_temp142 = (struct Cyc_Absyn_Typedef_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Typedef_d_struct));
						_temp142[0] = ({ struct Cyc_Absyn_Typedef_d_struct _temp143;
						  _temp143.tag = Cyc_Absyn_Typedef_d;
						  _temp143.f1 = d;
						  _temp143; });
						_temp142; }),0);
    _temp141->tl = tds;
...
static struct Cyc_List_List *Cyc_Interface_add_var(struct _tagged_string *x,
						   ...
						   struct Cyc_List_List *tds) {
  return ({ struct Cyc_List_List *_temp144 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp144->hd = (void *)Cyc_Absyn_new_decl((void *)({ struct Cyc_Absyn_Var_d_struct *_temp145 = (struct Cyc_Absyn_Var_d_struct *)GC_malloc(sizeof(struct Cyc_Absyn_Var_d_struct));
						_temp145[0] = ({ struct Cyc_Absyn_Var_d_struct _temp146;
						  _temp146.tag = Cyc_Absyn_Var_d;
						  _temp146.f1 = d;
						  _temp146; });
						_temp145; }),0);
    _temp144->tl = tds;
...
static void Cyc_Interface_print_ns_headers(struct Cyc_Stdio___sFILE *f,struct Cyc_List_List *ns,
					   struct Cyc_Interface_Ienv *ie) {
  struct Cyc_List_List *tds = 0;
  tds = ((struct Cyc_List_List *(*)(struct Cyc_List_List *(*f)(struct _tagged_string *,
							       struct Cyc_Absyn_Structdecl *,
							       struct Cyc_List_List *),
  ...
  tds = Cyc_Interface_add_namespace(tds,ns);
  Cyc_Absynpp_decllist2file(tds,f);
}
static void Cyc_Interface_print_ns_typedefs(struct Cyc_Stdio___sFILE *f,struct Cyc_List_List *ns,
					    struct Cyc_Interface_Ienv *ie) {
  struct Cyc_List_List *tds = 0;
  tds = ((struct Cyc_List_List *(*)(struct Cyc_List_List *(*f)(struct _tagged_string *,
							       struct Cyc_Absyn_Typedefdecl *,
							       struct Cyc_List_List *),
				    struct Cyc_Dict_Dict *d,struct Cyc_List_List *accum))Cyc_Dict_fold)(Cyc_Interface_add_typedef,
													ie->typedefdecls,
													tds);
  tds = ((struct Cyc_List_List *(*)(struct Cyc_List_List *x))Cyc_List_imp_rev)(tds);
  tds = Cyc_Interface_add_namespace(tds,ns);
...
static void Cyc_Interface_print_ns_decls(struct Cyc_Stdio___sFILE *f,struct Cyc_List_List *ns,
					 struct Cyc_Interface_Ienv *ie) {
  struct Cyc_List_List *tds = 0;
  tds = ((struct Cyc_List_List *(*)(struct Cyc_List_List *(*f)(struct _tagged_string *,
							       struct Cyc_Absyn_Structdecl *,
...
void Cyc_Interface_print(struct Cyc_Interface_T *i,struct Cyc_Stdio___sFILE *f) {
  fprintf(f,"/****** needed (headers) ******/\n");
  ((void (*)(void (*f)(struct Cyc_Stdio___sFILE *,struct Cyc_List_List *,
		       struct Cyc_Interface_Ienv *),struct Cyc_Stdio___sFILE *env,
	     struct Cyc_Dict_Dict *d))Cyc_Dict_iter_c)(Cyc_Interface_print_ns_headers,
						       f,i->imports);
  fprintf(f,"\n/****** provided (headers) ******/\n");
  ((void (*)(void (*f)(struct Cyc_Stdio___sFILE *,struct Cyc_List_List *,
		       struct Cyc_Interface_Ienv *),struct Cyc_Stdio___sFILE *env,
  ...
  ((void (*)(void (*f)(struct Cyc_Stdio___sFILE *,struct Cyc_List_List *,
		       struct Cyc_Interface_Ienv *),struct Cyc_Stdio___sFILE *env,
	     struct Cyc_Dict_Dict *d))Cyc_Dict_iter_c)(Cyc_Interface_print_ns_typedefs,
						       f,i->exports);
  fprintf(f,"\n/****** needed (declarations) ******/\n");
  ((void (*)(void (*f)(struct Cyc_Stdio___sFILE *,struct Cyc_List_List *,
		       struct Cyc_Interface_Ienv *),struct Cyc_Stdio___sFILE *env,
	     struct Cyc_Dict_Dict *d))Cyc_Dict_iter_c)(Cyc_Interface_print_ns_decls,
						       f,i->imports);
...
struct Cyc_Interface_T *Cyc_Interface_parse(struct Cyc_Stdio___sFILE *f) {
  Cyc_Lex_lex_init();
  { struct Cyc_List_List *tds = Cyc_Parse_parse_file(f);
    Cyc_Absynpp_expand_typedefs = 0;
    { struct Cyc_Tcenv_Tenv *te = Cyc_Tcenv_tc_init();
      Cyc_Tc_tc(te,0,tds);
      tds = Cyc_Tc_treeshake(te,tds);
      return Cyc_Interface_gen_extract(te->ae,0);}
    }
