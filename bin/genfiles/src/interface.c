...
struct Cyc_Stdio_String_pa_struct _temp576; _temp576.tag= Cyc_Stdio_String_pa;
_temp576.f1=( struct _tagged_arr)(*(( struct _tuple3*) _check_null( info))).f1;{
struct Cyc_Stdio_String_pa_struct _temp575; _temp575.tag= Cyc_Stdio_String_pa;
_temp575.f1=( struct _tagged_arr)(*(( struct _tuple3*) _check_null( info))).f2;{
void* _temp574[ 2u]={& _temp575,& _temp576}; Cyc_Stdio_aprintf( _tag_arr("checking inclusion of %s imports into %s imports,",
...
_tagged_arr)({ struct Cyc_Stdio_String_pa_struct _temp744; _temp744.tag= Cyc_Stdio_String_pa;
