...
struct _tuple17* Cyc_yyget_QualSpecList_tok( void* yy1){ void* _temp1336= yy1;
struct _tuple17* _temp1342; _LL1338: if(*(( void**) _temp1336) == Cyc_QualSpecList_tok){
_LL1343: _temp1342=( struct _tuple17*)(( struct Cyc_QualSpecList_tok_struct*)
...
_throw( Null_Exception);}* _temp2951;})); struct _tuple15 _temp2898; int
_temp2899; void* _temp2901; struct _tuple15* _temp2896= Cyc_yyget_Int_tok(({
...
_temp3581; _temp3581.tag= Cyc_InitDecl_tok; _temp3581.f1=({ struct _tuple14*
_temp3582=( struct _tuple14*) GC_malloc( sizeof( struct _tuple14)); _temp3582->f1=
...
_temp3588.f1=({ struct _tuple14* _temp3589=( struct _tuple14*) GC_malloc(
sizeof( struct _tuple14)); _temp3589->f1= Cyc_yyget_Declarator_tok(({ struct
...
_temp3631.f1=({ struct _tuple17* _temp3632=( struct _tuple17*) GC_malloc(
sizeof( struct _tuple17)); _temp3632->f1= Cyc_Absyn_empty_tqual(); _temp3632->f2=(
...
_temp3642.f1=({ struct _tuple17* _temp3643=( struct _tuple17*) GC_malloc(
sizeof( struct _tuple17)); _temp3643->f1=(* Cyc_yyget_QualSpecList_tok(({ struct
...
Cyc_QualSpecList_tok; _temp3662.f1=({ struct _tuple17* _temp3663=( struct
_tuple17*) GC_malloc( sizeof( struct _tuple17)); _temp3663->f1= Cyc_yyget_TypeQual_tok(({
...
_temp3672.f1=({ struct _tuple17* _temp3673=( struct _tuple17*) GC_malloc(
sizeof( struct _tuple17)); _temp3673->f1= Cyc_Absyn_combine_tqual( Cyc_yyget_TypeQual_tok(({
...
_temp3714.f1=({ struct _tuple12* _temp3715=( struct _tuple12*) GC_malloc(
sizeof( struct _tuple12)); _temp3715->f1= Cyc_yyget_Declarator_tok(({ struct
...
_temp3721.f1=({ struct _tuple12* _temp3722=( struct _tuple12*) GC_malloc(
sizeof( struct _tuple12)); _temp3722->f1=({ struct Cyc_Parse_Declarator*
...
_tuple12* _temp3737=( struct _tuple12*) GC_malloc( sizeof( struct _tuple12));
...
Cyc_FieldPattern_tok; _temp6213.f1=({ struct _tuple13* _temp6214=( struct
_tuple13*) GC_malloc( sizeof( struct _tuple13)); _temp6214->f1= 0; _temp6214->f2=
...
Cyc_FieldPattern_tok; _temp6220.f1=({ struct _tuple13* _temp6221=( struct
_tuple13*) GC_malloc( sizeof( struct _tuple13)); _temp6221->f1= Cyc_yyget_DesignatorList_tok(({
...
int i, void* v){ void* _temp7490= v; struct _tuple15* _temp7510; struct _tuple15
...
_LL7511: _temp7510=( struct _tuple15*)(( struct Cyc_Int_tok_struct*) _temp7490)->f1;
