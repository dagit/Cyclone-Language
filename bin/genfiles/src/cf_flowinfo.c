...
struct Cyc_CfFlowInfo_StructPI_struct _temp197; _temp197.tag= Cyc_CfFlowInfo_StructPI;
...
void*)({ struct Cyc_Core_Impossible_struct* _temp232=( struct Cyc_Core_Impossible_struct*)
GC_malloc( sizeof( struct Cyc_Core_Impossible_struct)); _temp232[ 0]=({ struct
Cyc_Core_Impossible_struct _temp233; _temp233.tag= Cyc_Core_Impossible; _temp233.f1=(
struct _tagged_string)({ char* _temp234=( char*)"bad lookup_place"; struct
...
Cyc_CfFlowInfo_StructPI; _temp274.f1=(( struct Cyc_Dict_Dict*(*)( struct Cyc_Dict_Dict*
...
_temp273;});} _LL244:( void) _throw(( void*)({ struct Cyc_Core_Impossible_struct*
_temp275=( struct Cyc_Core_Impossible_struct*) GC_malloc( sizeof( struct Cyc_Core_Impossible_struct));
_temp275[ 0]=({ struct Cyc_Core_Impossible_struct _temp276; _temp276.tag= Cyc_Core_Impossible;
...
_temp360[ 0]=({ struct Cyc_CfFlowInfo_TuplePI_struct _temp361; _temp361.tag= Cyc_CfFlowInfo_TuplePI;
...
Cyc_CfFlowInfo_StructPI; _temp363.f1=(( struct Cyc_Dict_Dict*(*)( void*(* f)(
...
_temp386); return; _LL365:;} struct Cyc_Dict_Dict* Cyc_CfFlowInfo_escape_these(
...
_handler_cons _temp388; _push_handler(& _temp388);{ void* _temp389=( void*)
setjmp( _temp388.handler); if( ! _temp389){ place_old_pinfo= Cyc_CfFlowInfo_lookup_place(
d, place);; _pop_handler();} else{ void* _temp391= _temp389; _LL393: if(
_temp391 == Cyc_Dict_Absent){ goto _LL394;} else{ goto _LL395;} _LL395: goto
_LL396; _LL394: continue; _LL396:( void) _throw( _temp391); _LL392:;}}}{ struct
_tuple7 places_env=({ struct _tuple7 _temp397; _temp397.f1= d; _temp397.f2=&
places; _temp397;}); void* place_new_pinfo= Cyc_CfFlowInfo_pinfo_getplaces_esc(&
...
Cyc_CfFlowInfo_StructPI; _temp425.f1=(( struct Cyc_Dict_Dict*(*)( void*(* f)(
...
if( _temp437 ==( void*) Cyc_CfFlowInfo_Esc){ goto _LL436;} else{ goto _LL431;}
_LL436: _temp435= _temp427.f2; goto _LL430; _LL431: _LL442: _temp441= _temp427.f1;
goto _LL440; _LL440: _temp439= _temp427.f2; if( _temp439 ==( void*) Cyc_CfFlowInfo_Esc){
...
_temp458= _temp444.f1; if( _temp458 ==( void*) Cyc_CfFlowInfo_NoneIL){ goto
_LL457;} else{ goto _LL448;} _LL457: _temp456= _temp444.f2; goto _LL447; _LL448:
_LL463: _temp462= _temp444.f1; goto _LL461; _LL461: _temp460= _temp444.f2; if(
_temp460 ==( void*) Cyc_CfFlowInfo_NoneIL){ goto _LL449;} else{ goto _LL450;}
_LL450: _LL467: _temp466= _temp444.f1; if( _temp466 ==( void*) Cyc_CfFlowInfo_ThisIL){
...
if( _temp468 ==( void*) Cyc_CfFlowInfo_ThisIL){ goto _LL453;} else{ goto _LL454;}
...
_temp525[ 0]=({ struct Cyc_CfFlowInfo_LeafPI_struct _temp526; _temp526.tag= Cyc_CfFlowInfo_LeafPI;
...
Cyc_CfFlowInfo_StructPI; _temp567.f1=(( struct Cyc_Dict_Dict*(*)( void*(* f)(
...
_LL539:( void) _throw(( void*)({ struct Cyc_Core_Impossible_struct* _temp568=(
struct Cyc_Core_Impossible_struct*) GC_malloc( sizeof( struct Cyc_Core_Impossible_struct));
_temp568[ 0]=({ struct Cyc_Core_Impossible_struct _temp569; _temp569.tag= Cyc_Core_Impossible;
...
struct Cyc_Dict_Dict* _temp596; _LL576: _LL585: _temp584= _temp574.f1; if(
_temp584 ==( void*) Cyc_CfFlowInfo_BottomFL){ goto _LL583;} else{ goto _LL578;}
...
_temp598[ 0]=({ struct Cyc_CfFlowInfo_InitsFL_struct _temp599; _temp599.tag= Cyc_CfFlowInfo_InitsFL;
...
_LL641:( void) _throw(( void*)({ struct Cyc_Core_Impossible_struct* _temp666=(
struct Cyc_Core_Impossible_struct*) GC_malloc( sizeof( struct Cyc_Core_Impossible_struct));
...
struct Cyc_Dict_Dict* _temp693; _LL673: _LL682: _temp681= _temp671.f1; if(
_temp681 ==( void*) Cyc_CfFlowInfo_BottomFL){ goto _LL680;} else{ goto _LL675;}
