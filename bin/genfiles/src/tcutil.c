...
struct Cyc_Core_Opt* _temp3125= _temp3089->rgn; if( _temp3125 == 0){ _throw(
...
struct Cyc_Core_Opt* _temp3127= _temp3089->rgn; if( _temp3127 == 0){ _throw(
...
_temp3093->rgn; if( _temp3129 == 0){ _throw( Null_Exception);} _temp3129->v;});
