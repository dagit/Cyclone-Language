...
void* _temp684; void* _temp686; _LL672: if(( unsigned int) _temp670 >  4u?*((
int*) _temp670) ==  Cyc_Absyn_PointerType: 0){ _LL677: _temp676=(( struct Cyc_Absyn_PointerType_struct*)
...
_temp706,*(( void**) _check_null( topt)));} while( _temp669 !=  0? _temp704 != 
...
else{ if(( _temp669 !=  0? 1: _temp702)? 1: _temp700 !=  0){ if( _temp702){ for(
0; _temp669 !=  0; _temp669=(( struct Cyc_List_List*) _check_null( _temp669))->tl){
...
_check_null( _temp700); _temp757;});* vararg_call_info=( struct Cyc_Absyn_VarargCallInfo*)
_temp725; if( ! Cyc_Tcutil_unify( Cyc_Tcenv_curr_rgn( te), _temp721)){({ struct
Cyc_Stdio_String_pa_struct _temp728; _temp728.tag= Cyc_Stdio_String_pa; _temp728.f1=(
struct _tagged_arr) Cyc_Absynpp_typ2string( Cyc_Tcenv_curr_rgn( te));{ struct
Cyc_Stdio_String_pa_struct _temp727; _temp727.tag= Cyc_Stdio_String_pa; _temp727.f1=(
struct _tagged_arr) Cyc_Absynpp_typ2string( _temp721);{ void* _temp726[ 2u]={&
_temp727,& _temp728}; Cyc_Tcutil_terr( loc, _tag_arr("I have no idea how this could fail, but it did because the region for the varargs (%s) doesn't unify with the expected new_block region (%s).",
...
Cyc_Absyn_Tuniondecl* _temp746; _LL734: if(( unsigned int) _temp732 >  4u?*((
int*) _temp732) ==  Cyc_Absyn_TunionType: 0){ _LL739: _temp738=(( struct Cyc_Absyn_TunionType_struct*)
...
args, _temp766 -  1); struct Cyc_Core_Opt* fmt_args; if( _temp764 ==  0){
fmt_args= 0;} else{ fmt_args=({ struct Cyc_Core_Opt* _temp774=( struct Cyc_Core_Opt*)
...
_temp771; _LL784: if( _temp782 ==  Cyc_List_Nth){ goto _LL785;} else{ goto
_LL786;} _LL786: goto _LL787; _LL785:({ void* _temp788[ 0u]={}; Cyc_Tcutil_terr(
...
_tag_arr( _temp836, sizeof( void*), 0u));});} for( 0; ts !=  0;( ts=(( struct
Cyc_List_List*) _check_null( ts))->tl, _temp834=(( struct Cyc_List_List*)
_check_null( _temp834))->tl)){ void* k= Cyc_Absyn_conref_val((( struct Cyc_Absyn_Tvar*)((
struct Cyc_List_List*) _check_null( _temp834))->hd)->kind); Cyc_Tcutil_check_type(
loc, te, Cyc_Tcenv_lookup_type_vars( te), k, 1,( void*)(( struct Cyc_List_List*)
_check_null( ts))->hd); instantiation=({ struct Cyc_List_List* _temp837=( struct
Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List)); _temp837->hd=( void*)({
struct _tuple5* _temp838=( struct _tuple5*) GC_malloc( sizeof( struct _tuple5));
_temp838->f1=( struct Cyc_Absyn_Tvar*)(( struct Cyc_List_List*) _check_null(
_temp834))->hd; _temp838->f2=( void*)(( struct Cyc_List_List*) _check_null( ts))->hd;
_temp838;}); _temp837->tl= instantiation; _temp837;});}{ void* new_fn_typ= Cyc_Tcutil_substitute(
...
_temp922)->f3; if( _temp938 ==  0){ goto _LL926;} else{ _temp940=* _temp938;
goto _LL925;}} else{ goto _LL926;} _LL926: if(( unsigned int) _temp922 >  4u?*((
int*) _temp922) ==  Cyc_Absyn_AnonStructType: 0){ _LL946: _temp945=(( struct Cyc_Absyn_AnonStructType_struct*)
...
_temp922)->f3; if( _temp949 ==  0){ goto _LL932;} else{ _temp951=* _temp949;
goto _LL931;}} else{ goto _LL932;} _LL932: if(( unsigned int) _temp922 >  4u?*((
int*) _temp922) ==  Cyc_Absyn_ArrayType: 0){ goto _LL956;} else{ goto _LL934;}
_LL956: if( Cyc_String_zstrcmp(* f, _tag_arr("size", sizeof( unsigned char), 5u))
==  0){ goto _LL933;} else{ goto _LL934;} _LL934: if(( unsigned int) _temp922 > 
4u?*(( int*) _temp922) ==  Cyc_Absyn_PointerType: 0){ goto _LL957;} else{ goto
_LL936;} _LL957: if( Cyc_String_zstrcmp(* f, _tag_arr("size", sizeof(
unsigned char), 5u)) ==  0){ goto _LL935;} else{ goto _LL936;} _LL936: goto
_LL937; _LL925: if( _temp943 ==  0){ return({ void* _temp958[ 0u]={}; Cyc_Tcexp_expr_err(
te, loc, _tag_arr("unresolved struct type (COMPILER ERROR)", sizeof(
unsigned char), 40u), _tag_arr( _temp958, sizeof( void*), 0u));});}{ struct Cyc_Absyn_Structfield*
...
_temp972= Cyc_Absyn_lookup_union_field( _temp951, f); if( _temp972 ==  0){
return({ struct Cyc_Stdio_String_pa_struct _temp975; _temp975.tag= Cyc_Stdio_String_pa;
...
_LL1010;} _LL1010: if(( unsigned int) _temp1002 >  4u?*(( int*) _temp1002) == 
Cyc_Absyn_AnonUnionType: 0){ _LL1031: _temp1030=(( struct Cyc_Absyn_AnonUnionType_struct*)
_temp1002)->f1; goto _LL1011;} else{ goto _LL1012;} _LL1012: goto _LL1013;
_LL1005: { struct Cyc_Absyn_Structfield* _temp1032= Cyc_Absyn_lookup_struct_field(
_temp1016, f); if( _temp1032 ==  0){ return({ struct Cyc_Stdio_String_pa_struct
_temp1035; _temp1035.tag= Cyc_Stdio_String_pa; _temp1035.f1=( struct _tagged_arr)*
f;{ struct Cyc_Stdio_String_pa_struct _temp1034; _temp1034.tag= Cyc_Stdio_String_pa;
_temp1034.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(( struct _tuple1*)
_check_null( _temp1019));{ void* _temp1033[ 2u]={& _temp1034,& _temp1035}; Cyc_Tcexp_expr_err(
te, loc, _tag_arr("struct %s has no %s field", sizeof( unsigned char), 26u),
_tag_arr( _temp1033, sizeof( void*), 2u));}}});}{ void* t3;{ struct
_RegionHandle _temp1036= _new_region(); struct _RegionHandle* rgn=& _temp1036;
_push_region( rgn);{ struct Cyc_List_List* _temp1037=(( struct Cyc_List_List*(*)(
struct _RegionHandle* r3, struct _RegionHandle* r4, struct Cyc_List_List* x,
struct Cyc_List_List* y)) Cyc_List_rzip)( rgn, rgn, _temp1016->tvs, _temp1017);
t3= Cyc_Tcutil_rsubstitute( rgn, _temp1037,( void*)(( struct Cyc_Absyn_Structfield*)
...
_LL1117: goto _LL1113; _LL1113:;} if( ! done){ for( 0; es !=  0; es=(( struct
...
struct Cyc_List_List)); _temp1124->hd=( void*)({ struct _tuple8* _temp1125=(
struct _tuple8*) GC_malloc( sizeof( struct _tuple8)); _temp1125->f1= Cyc_Absyn_empty_tqual();
_temp1125->f2=( void*)(( struct Cyc_Core_Opt*) _check_null((( struct Cyc_Absyn_Exp*)((
struct Cyc_List_List*) _check_null( es))->hd)->topt))->v; _temp1125;});
_temp1124->tl= fields; _temp1124;});}} return( void*)({ struct Cyc_Absyn_TupleType_struct*
...
te),( void*) Cyc_Absyn_MemKind, 1, t);{ void* _temp1298= t; struct Cyc_Absyn_TunionFieldInfo
...
_LL1307: _temp1306=( void*) _temp1304.field_info; if(*(( int*) _temp1306) == 
Cyc_Absyn_KnownTunionfield){ _LL1309: _temp1308=(( struct Cyc_Absyn_KnownTunionfield_struct*)
_temp1306)->f2; goto _LL1301;} else{ goto _LL1302;}} else{ goto _LL1302;}
_LL1302: goto _LL1303; _LL1301: if( _temp1308->tvs !=  0){({ void* _temp1310[ 0u]={};
Cyc_Tcutil_terr( loc, _tag_arr("malloc with existential types not yet implemented",
sizeof( unsigned char), 50u), _tag_arr( _temp1310, sizeof( void*), 0u));});}
goto _LL1299; _LL1303: goto _LL1299; _LL1299:;}{ void*(* _temp1311)( void* t,
...
_LL1326;} _LL1326: if(( unsigned int) _temp1322 >  1u?*(( int*) _temp1322) == 
Cyc_Absyn_Seq_s: 0){ _LL1337: _temp1336=(( struct Cyc_Absyn_Seq_s_struct*)
_temp1322)->f1; goto _LL1335; _LL1335: _temp1334=(( struct Cyc_Absyn_Seq_s_struct*)
_temp1322)->f2; goto _LL1327;} else{ goto _LL1328;} _LL1328: if(( unsigned int)
_temp1322 >  1u?*(( int*) _temp1322) ==  Cyc_Absyn_Decl_s: 0){ _LL1341:
_temp1340=(( struct Cyc_Absyn_Decl_s_struct*) _temp1322)->f1; goto _LL1339;
_LL1339: _temp1338=(( struct Cyc_Absyn_Decl_s_struct*) _temp1322)->f2; goto
_LL1329;} else{ goto _LL1330;} _LL1330: goto _LL1331; _LL1325: return( void*)((
struct Cyc_Core_Opt*) _check_null( _temp1332->topt))->v; _LL1327: s= _temp1334;
continue; _LL1329: s= _temp1338; continue; _LL1331: return({ void* _temp1342[ 0u]={};
...
unsigned int) _temp1345 >  4u?*(( int*) _temp1345) ==  Cyc_Absyn_RgnHandleType:
0){ _LL1352: _temp1351=( void*)(( struct Cyc_Absyn_RgnHandleType_struct*)
_temp1345)->f1; goto _LL1348;} else{ goto _LL1349;} _LL1349: goto _LL1350;
_LL1348: rgn= _temp1351; Cyc_Tcenv_check_rgn_accessible( te, loc, rgn); goto
_LL1346; _LL1350:({ struct Cyc_Stdio_String_pa_struct _temp1354; _temp1354.tag=
Cyc_Stdio_String_pa; _temp1354.f1=( struct _tagged_arr) Cyc_Absynpp_typ2string(
handle_type);{ void* _temp1353[ 1u]={& _temp1354}; Cyc_Tcutil_terr((( struct Cyc_Absyn_Exp*)
...
if(*(( int*) _temp1484) ==  Cyc_Absyn_Comprehension_e){ goto _LL1489;} else{
goto _LL1490;} _LL1490: if(*(( int*) _temp1484) ==  Cyc_Absyn_Const_e){ _LL1495:
