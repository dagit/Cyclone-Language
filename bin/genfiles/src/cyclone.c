...
_temp183=( void*) _exn_thrown; void* _temp186= _temp183; struct _tagged_arr
_temp192; _LL188: if(*(( void**) _temp186) == Cyc_Core_InvalidArg){ _LL193:
_temp192=(( struct Cyc_Core_InvalidArg_struct*) _temp186)->f1; goto _LL189;}
else{ goto _LL190;} _LL190: goto _LL191; _LL189: basename=* n; goto _LL187;
_LL191:( void) _throw( _temp186); _LL187:;}}}{ struct _tagged_arr _temp194= Cyc_String_strconcat(
basename, _tag_arr(".cycio", sizeof( unsigned char), 7u)); struct Cyc_Stdio___sFILE*
_temp195= Cyc_try_file_open(( struct _tagged_arr) _temp194, _tag_arr("r",
sizeof( unsigned char), 2u), _tag_arr("interface object file", sizeof(
unsigned char), 22u)); if( _temp195 == 0){ Cyc_compile_failure= 1; Cyc_remove_cfiles();
exit( 1);} Cyc_Position_reset_position(( struct _tagged_arr) _temp194);{ struct
Cyc_Interface_I* _temp196= Cyc_Interface_load(( struct Cyc_Stdio___sFILE*)
_check_null( _temp195)); Cyc_Stdio_file_close(( struct Cyc_Stdio___sFILE*)
_check_null( _temp195)); return _temp196;}}}} static int Cyc_is_cfile( struct
...
struct Cyc_List_List* options=({ struct Cyc_List_List*(* _temp260)( struct
_tagged_arr)=( struct Cyc_List_List*(*)( struct _tagged_arr)) Cyc_List_list;
struct _tuple11* _temp263=({ struct _tuple11* _temp408=( struct _tuple11*)
GC_malloc( sizeof( struct _tuple11)); _temp408->f1= _tag_arr("-v", sizeof(
unsigned char), 3u); _temp408->f2=( void*)({ struct Cyc_Arg_Set_spec_struct*
_temp409=( struct Cyc_Arg_Set_spec_struct*) GC_malloc( sizeof( struct Cyc_Arg_Set_spec_struct));
_temp409[ 0]=({ struct Cyc_Arg_Set_spec_struct _temp410; _temp410.tag= Cyc_Arg_Set_spec;
_temp410.f1=& Cyc_v_r; _temp410;}); _temp409;}); _temp408->f3= _tag_arr("    Print compilation stages verbosely",
sizeof( unsigned char), 39u); _temp408;}); struct _tuple11* _temp264=({ struct
_tuple11* _temp405=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp405->f1= _tag_arr("-o", sizeof( unsigned char), 3u); _temp405->f2=( void*)({
struct Cyc_Arg_String_spec_struct* _temp406=( struct Cyc_Arg_String_spec_struct*)
GC_malloc( sizeof( struct Cyc_Arg_String_spec_struct)); _temp406[ 0]=({ struct
Cyc_Arg_String_spec_struct _temp407; _temp407.tag= Cyc_Arg_String_spec; _temp407.f1=
Cyc_set_output_file; _temp407;}); _temp406;}); _temp405->f3= _tag_arr("    Output file name",
sizeof( unsigned char), 21u); _temp405;}); struct _tuple11* _temp265=({ struct
_tuple11* _temp402=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp402->f1= _tag_arr("-D*", sizeof( unsigned char), 4u); _temp402->f2=( void*)({
struct Cyc_Arg_Flag_spec_struct* _temp403=( struct Cyc_Arg_Flag_spec_struct*)
GC_malloc( sizeof( struct Cyc_Arg_Flag_spec_struct)); _temp403[ 0]=({ struct Cyc_Arg_Flag_spec_struct
_temp404; _temp404.tag= Cyc_Arg_Flag_spec; _temp404.f1= Cyc_add_cpparg; _temp404;});
_temp403;}); _temp402->f3= _tag_arr("   Pass definition to preprocessor",
sizeof( unsigned char), 35u); _temp402;}); struct _tuple11* _temp266=({ struct
_tuple11* _temp399=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp399->f1= _tag_arr("-B*", sizeof( unsigned char), 4u); _temp399->f2=( void*)({
struct Cyc_Arg_Flag_spec_struct* _temp400=( struct Cyc_Arg_Flag_spec_struct*)
GC_malloc( sizeof( struct Cyc_Arg_Flag_spec_struct)); _temp400[ 0]=({ struct Cyc_Arg_Flag_spec_struct
_temp401; _temp401.tag= Cyc_Arg_Flag_spec; _temp401.f1= Cyc_add_cyclone_exec_prefix_path;
_temp401;}); _temp400;}); _temp399->f3= _tag_arr("   Add to the list of directories to search for compiler files",
sizeof( unsigned char), 63u); _temp399;}); struct _tuple11* _temp267=({ struct
_tuple11* _temp396=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp396->f1= _tag_arr("-I*", sizeof( unsigned char), 4u); _temp396->f2=( void*)({
...
_temp397;}); _temp396->f3= _tag_arr("   Add to the list of directories to search for include files",
sizeof( unsigned char), 62u); _temp396;}); struct _tuple11* _temp268=({ struct
_tuple11* _temp393=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp393->f1= _tag_arr("-L*", sizeof( unsigned char), 4u); _temp393->f2=( void*)({
...
_temp394;}); _temp393->f3= _tag_arr("   Add to the list of directories for -l",
sizeof( unsigned char), 41u); _temp393;}); struct _tuple11* _temp269=({ struct
_tuple11* _temp390=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp390->f1= _tag_arr("-l*", sizeof( unsigned char), 4u); _temp390->f2=( void*)({
...
_temp392; _temp392.tag= Cyc_Arg_Flag_spec; _temp392.f1= Cyc_add_libarg; _temp392;});
_temp391;}); _temp390->f3= _tag_arr("   Library file", sizeof( unsigned char),
16u); _temp390;}); struct _tuple11* _temp270=({ struct _tuple11* _temp387=(
struct _tuple11*) GC_malloc( sizeof( struct _tuple11)); _temp387->f1= _tag_arr("-c",
sizeof( unsigned char), 3u); _temp387->f2=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp388=( struct Cyc_Arg_Unit_spec_struct*) GC_malloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp388[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp389; _temp389.tag= Cyc_Arg_Unit_spec;
_temp389.f1= Cyc_set_stop_after_objectfile; _temp389;}); _temp388;}); _temp387->f3=
_tag_arr("    Produce object file", sizeof( unsigned char), 24u); _temp387;});
struct _tuple11* _temp271=({ struct _tuple11* _temp384=( struct _tuple11*)
GC_malloc( sizeof( struct _tuple11)); _temp384->f1= _tag_arr("-s", sizeof(
unsigned char), 3u); _temp384->f2=( void*)({ struct Cyc_Arg_Flag_spec_struct*
_temp385=( struct Cyc_Arg_Flag_spec_struct*) GC_malloc( sizeof( struct Cyc_Arg_Flag_spec_struct));
_temp385[ 0]=({ struct Cyc_Arg_Flag_spec_struct _temp386; _temp386.tag= Cyc_Arg_Flag_spec;
_temp386.f1= Cyc_add_ccarg; _temp386;}); _temp385;}); _temp384->f3= _tag_arr("    Remove all symbol table and relocation info from executable",
sizeof( unsigned char), 64u); _temp384;}); struct _tuple11* _temp272=({ struct
_tuple11* _temp381=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp381->f1= _tag_arr("-O", sizeof( unsigned char), 3u); _temp381->f2=( void*)({
...
_temp383; _temp383.tag= Cyc_Arg_Flag_spec; _temp383.f1= Cyc_add_ccarg; _temp383;});
_temp382;}); _temp381->f3= _tag_arr("    Optimize", sizeof( unsigned char), 13u);
_temp381;}); struct _tuple11* _temp273=({ struct _tuple11* _temp378=( struct
_tuple11*) GC_malloc( sizeof( struct _tuple11)); _temp378->f1= _tag_arr("-O2",
sizeof( unsigned char), 4u); _temp378->f2=( void*)({ struct Cyc_Arg_Flag_spec_struct*
_temp379=( struct Cyc_Arg_Flag_spec_struct*) GC_malloc( sizeof( struct Cyc_Arg_Flag_spec_struct));
_temp379[ 0]=({ struct Cyc_Arg_Flag_spec_struct _temp380; _temp380.tag= Cyc_Arg_Flag_spec;
_temp380.f1= Cyc_add_ccarg; _temp380;}); _temp379;}); _temp378->f3= _tag_arr("   Optimize",
sizeof( unsigned char), 12u); _temp378;}); struct _tuple11* _temp274=({ struct
_tuple11* _temp375=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp375->f1= _tag_arr("-O3", sizeof( unsigned char), 4u); _temp375->f2=( void*)({
struct Cyc_Arg_Flag_spec_struct* _temp376=( struct Cyc_Arg_Flag_spec_struct*)
GC_malloc( sizeof( struct Cyc_Arg_Flag_spec_struct)); _temp376[ 0]=({ struct Cyc_Arg_Flag_spec_struct
_temp377; _temp377.tag= Cyc_Arg_Flag_spec; _temp377.f1= Cyc_add_ccarg; _temp377;});
_temp376;}); _temp375->f3= _tag_arr("   Optimize", sizeof( unsigned char), 12u);
_temp375;}); struct _tuple11* _temp275=({ struct _tuple11* _temp372=( struct
_tuple11*) GC_malloc( sizeof( struct _tuple11)); _temp372->f1= _tag_arr("-g",
sizeof( unsigned char), 3u); _temp372->f2=( void*)({ struct Cyc_Arg_Flag_spec_struct*
_temp373=( struct Cyc_Arg_Flag_spec_struct*) GC_malloc( sizeof( struct Cyc_Arg_Flag_spec_struct));
_temp373[ 0]=({ struct Cyc_Arg_Flag_spec_struct _temp374; _temp374.tag= Cyc_Arg_Flag_spec;
_temp374.f1= Cyc_add_ccarg; _temp374;}); _temp373;}); _temp372->f3= _tag_arr("    Compile for debugging",
sizeof( unsigned char), 26u); _temp372;}); struct _tuple11* _temp276=({ struct
_tuple11* _temp369=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp369->f1= _tag_arr("-p", sizeof( unsigned char), 3u); _temp369->f2=( void*)({
...
_temp370;}); _temp369->f3= _tag_arr("    Compile for prof", sizeof(
unsigned char), 21u); _temp369;}); struct _tuple11* _temp277=({ struct _tuple11*
_temp366=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11)); _temp366->f1=
_tag_arr("-pg", sizeof( unsigned char), 4u); _temp366->f2=( void*)({ struct Cyc_Arg_Flag_spec_struct*
_temp367=( struct Cyc_Arg_Flag_spec_struct*) GC_malloc( sizeof( struct Cyc_Arg_Flag_spec_struct));
_temp367[ 0]=({ struct Cyc_Arg_Flag_spec_struct _temp368; _temp368.tag= Cyc_Arg_Flag_spec;
...
sizeof( unsigned char), 58u); _temp312;}); struct _tuple11* _temp296=({ struct
_tuple11* _temp309=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp309->f1= _tag_arr("-noexpandtypedefs", sizeof( unsigned char), 18u);
_temp309->f2=( void*)({ struct Cyc_Arg_Set_spec_struct* _temp310=( struct Cyc_Arg_Set_spec_struct*)
GC_malloc( sizeof( struct Cyc_Arg_Set_spec_struct)); _temp310[ 0]=({ struct Cyc_Arg_Set_spec_struct
_temp311; _temp311.tag= Cyc_Arg_Set_spec; _temp311.f1=& Cyc_noexpand_r; _temp311;});
_temp310;}); _temp309->f3= _tag_arr("\n        Don't expand typedefs in pretty printing",
sizeof( unsigned char), 50u); _temp309;}); struct _tuple11* _temp297=({ struct
_tuple11* _temp306=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp306->f1= _tag_arr("-printalltvars", sizeof( unsigned char), 15u); _temp306->f2=(
void*)({ struct Cyc_Arg_Set_spec_struct* _temp307=( struct Cyc_Arg_Set_spec_struct*)
GC_malloc( sizeof( struct Cyc_Arg_Set_spec_struct)); _temp307[ 0]=({ struct Cyc_Arg_Set_spec_struct
_temp308; _temp308.tag= Cyc_Arg_Set_spec; _temp308.f1=& Cyc_print_all_tvars_r;
_temp308;}); _temp307;}); _temp306->f3= _tag_arr("\n        Print all type variables (even implicit default effects)",
sizeof( unsigned char), 66u); _temp306;}); struct _tuple11* _temp298=({ struct
_tuple11* _temp303=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp303->f1= _tag_arr("-printallkinds", sizeof( unsigned char), 15u); _temp303->f2=(
...
_temp305; _temp305.tag= Cyc_Arg_Set_spec; _temp305.f1=& Cyc_print_all_kinds_r;
_temp305;}); _temp304;}); _temp303->f3= _tag_arr("\n        Always print kinds of type variables",
sizeof( unsigned char), 46u); _temp303;}); struct _tuple11* _temp299=({ struct
_tuple11* _temp300=( struct _tuple11*) GC_malloc( sizeof( struct _tuple11));
_temp300->f1= _tag_arr("-printfullevars", sizeof( unsigned char), 16u); _temp300->f2=(
...
_temp287, _temp288, _temp289, _temp290, _temp291, _temp292, _temp293, _temp294,
_temp295, _temp296, _temp297, _temp298, _temp299}; struct _tagged_arr _temp262={(
void*) _temp261,( void*) _temp261,( void*)( _temp261 + 37u)}; _temp260( _temp262);});
Cyc_Arg_parse( options, Cyc_add_other, _tag_arr("Options:", sizeof(
unsigned char), 9u), argv);{ struct Cyc_List_List* _temp197=(( struct Cyc_List_List*(*)(
struct Cyc_List_List* x)) Cyc_List_rev)( Cyc_cyclone_files); for( 0; _temp197 !=
0; _temp197=(( struct Cyc_List_List*) _check_null( _temp197))->tl){ Cyc_process_file(*((
struct _tagged_arr*)(( struct Cyc_List_List*) _check_null( _temp197))->hd)); if(
...
Cyc_cyclone_exec_prefix_path=({ struct Cyc_List_List* _temp198=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp198->hd=( void*)({ struct
_tagged_arr* _temp199=( struct _tagged_arr*) GC_malloc( sizeof( struct
_tagged_arr)); _temp199[ 0]= cyclone_exec_prefix; _temp199;}); _temp198->tl= Cyc_cyclone_exec_prefix_path;
_temp198;});} Cyc_cyclone_exec_prefix_path=({ struct Cyc_List_List* _temp200=(
...
_tagged_arr)),"c:/cyclone/bin/cyc-lib", sizeof( unsigned char), 23u); _temp200->tl=
Cyc_cyclone_exec_prefix_path; _temp200;}); Cyc_cyclone_exec_prefix_path=((
struct Cyc_List_List*(*)( struct Cyc_List_List* x)) Cyc_List_imp_rev)( Cyc_cyclone_exec_prefix_path);{
struct _tagged_arr _temp201= Cyc_do_find( Cyc_cyclone_exec_prefix_path, _tag_arr("include/cyc_include.h",
sizeof( unsigned char), 22u)); Cyc_ccargs=(( struct Cyc_List_List*(*)( struct
Cyc_List_List* x)) Cyc_List_rev)( Cyc_ccargs);{ struct _tagged_arr _temp202= Cyc_String_str_sepstr(((
...
Cyc_List_List* x)) Cyc_List_rev)( Cyc_libargs);{ struct _tagged_arr _temp203=
Cyc_String_str_sepstr(({ struct Cyc_List_List* _temp259=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp259->hd=( void*) _init_tag_arr((
struct _tagged_arr*) GC_malloc( sizeof( struct _tagged_arr)),"", sizeof(
unsigned char), 1u); _temp259->tl=(( struct Cyc_List_List*(*)( struct
_tagged_arr*(* f)( struct _tagged_arr*), struct Cyc_List_List* x)) Cyc_List_map)(
Cyc_sh_escape_stringptr, Cyc_libargs); _temp259;}), _tag_arr(" ", sizeof(
unsigned char), 2u)); struct Cyc_List_List* stdlib; struct _tagged_arr
stdlib_string; int _temp204=(( Cyc_stop_after_asmfile_r? 1: Cyc_stop_after_objectfile_r)?
...
_temp213.curr);});} if( Cyc_ic_r){ struct _handler_cons _temp214; _push_handler(&
_temp214);{ int _temp216= 0; if( setjmp( _temp214.handler)){ _temp216= 1;} if( !
_temp216){ Cyc_ccargs=(( struct Cyc_List_List*(*)( int(* f)( struct _tagged_arr*),
...
_temp217=(( struct Cyc_List_List*(*)( struct Cyc_List_List* x, struct Cyc_List_List*
...
_temp204){ _temp217=({ struct Cyc_List_List* _temp218=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp218->hd=( void*) Cyc_final_strptr;
_temp218->tl= _temp217; _temp218;});}{ struct Cyc_Interface_I* _temp219=((
...
Cyc_read_cycio, _temp217, _temp217); if( _temp219 == 0){ fprintf( _sfile_to_file(
Cyc_Stdio_stderr),"Error: interfaces incompatible\n"); Cyc_compile_failure= 1;
Cyc_remove_cfiles();{ int _temp220= 1; _npop_handler( 0u); return _temp220;}}
if( _temp204){ if( Cyc_output_file != 0){ struct _tagged_arr _temp221=({ struct
_tagged_arr _temp224=( struct _tagged_arr) Cyc_Filename_chop_extension(*((
struct _tagged_arr*) _check_null( Cyc_output_file))); xprintf("%.*s.cycio",
_get_arr_size( _temp224, 1u), _temp224.curr);}); struct Cyc_Stdio___sFILE*
_temp222= Cyc_try_file_open(( struct _tagged_arr) _temp221, _tag_arr("w",
sizeof( unsigned char), 2u), _tag_arr("interface object file", sizeof(
unsigned char), 22u)); if( _temp222 == 0){ Cyc_compile_failure= 1; Cyc_remove_cfiles();{
int _temp223= 1; _npop_handler( 0u); return _temp223;}} Cyc_Interface_save((
struct Cyc_Interface_I*) _check_null( _temp219),( struct Cyc_Stdio___sFILE*)
_check_null( _temp222)); Cyc_Stdio_file_close(( struct Cyc_Stdio___sFILE*)
_check_null( _temp222));}} else{ if( ! Cyc_Interface_is_subinterface( Cyc_Interface_empty(),(
struct Cyc_Interface_I*) _check_null( _temp219),({ struct _tuple9* _temp225=(
struct _tuple9*) GC_malloc( sizeof( struct _tuple9)); _temp225->f1= _tag_arr("empty interface",
sizeof( unsigned char), 16u); _temp225->f2= _tag_arr("global interface", sizeof(
unsigned char), 17u); _temp225;}))){ fprintf( _sfile_to_file( Cyc_Stdio_stderr),"Error: some objects are still undefined\n");
Cyc_compile_failure= 1; Cyc_remove_cfiles();{ int _temp226= 1; _npop_handler( 0u);
return _temp226;}}}}}; _pop_handler();} else{ void* _temp215=( void*)
_exn_thrown; void* _temp228= _temp215; struct _tagged_arr _temp242; struct
_tagged_arr _temp244; struct _tagged_arr _temp246; _LL230: if(*(( void**)
_temp228) == Cyc_Core_Failure){ _LL243: _temp242=(( struct Cyc_Core_Failure_struct*)
_temp228)->f1; goto _LL231;} else{ goto _LL232;} _LL232: if(*(( void**) _temp228)
== Cyc_Core_Impossible){ _LL245: _temp244=(( struct Cyc_Core_Impossible_struct*)
_temp228)->f1; goto _LL233;} else{ goto _LL234;} _LL234: if( _temp228 == Cyc_Dict_Absent){
goto _LL235;} else{ goto _LL236;} _LL236: if(*(( void**) _temp228) == Cyc_Core_InvalidArg){
_LL247: _temp246=(( struct Cyc_Core_InvalidArg_struct*) _temp228)->f1; goto
_LL237;} else{ goto _LL238;} _LL238: goto _LL239; _LL240: goto _LL241; _LL231:({
struct _tagged_arr _temp248= _temp242; printf("Exception Core::Failure %.*s\n",
_get_arr_size( _temp248, 1u), _temp248.curr);}); Cyc_compile_failure= 1; Cyc_remove_cfiles();
return 1; _LL233:({ struct _tagged_arr _temp249= _temp244; printf("Exception Core::Impossible %.*s\n",
_get_arr_size( _temp249, 1u), _temp249.curr);}); Cyc_compile_failure= 1; Cyc_remove_cfiles();
return 1; _LL235: printf("Exception Dict::Absent\n"); Cyc_compile_failure= 1;
Cyc_remove_cfiles(); return 1; _LL237:({ struct _tagged_arr _temp250= _temp246;
printf("Exception Core::InvalidArg %.*s\n", _get_arr_size( _temp250, 1u),
_temp250.curr);}); Cyc_compile_failure= 1; Cyc_remove_cfiles(); return 1; _LL239:
printf("Uncaught exception\n"); Cyc_compile_failure= 1; Cyc_remove_cfiles();
return 1; _LL241:( void) _throw( _temp228); _LL229:;}}}{ struct _tagged_arr
_temp251=({ struct _tagged_arr _temp254= _temp201; struct _tagged_arr _temp255=
Cyc_output_file == 0? _tag_arr("", sizeof( unsigned char), 1u):( struct
_tagged_arr)({ struct _tagged_arr _temp253= Cyc_sh_escape_string(*(( struct
_tagged_arr*) _check_null( Cyc_output_file))); xprintf(" -o %.*s", _get_arr_size(
_temp253, 1u), _temp253.curr);}); struct _tagged_arr _temp256=( struct
_tagged_arr) _temp202; struct _tagged_arr _temp257= stdlib_string; struct
_tagged_arr _temp258=( struct _tagged_arr) _temp203; xprintf("gcc -include %.*s%.*s %.*s%.*s%.*s",
_get_arr_size( _temp254, 1u), _temp254.curr, _get_arr_size( _temp255, 1u),
_temp255.curr, _get_arr_size( _temp256, 1u), _temp256.curr, _get_arr_size(
_temp257, 1u), _temp257.curr, _get_arr_size( _temp258, 1u), _temp258.curr);});
if( Cyc_v_r){({ struct _tagged_arr _temp252=( struct _tagged_arr) _temp251;
fprintf( _sfile_to_file( Cyc_Stdio_stderr),"%.*s\n", _get_arr_size( _temp252, 1u),
_temp252.curr);});} if( system( string_to_Cstring(( struct _tagged_arr) _temp251))
