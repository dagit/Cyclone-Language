...
_temp48 + 1; _temp49;}); int other_exn= 0; void* ex=( void*)({ struct Cyc_Core_Impossible_struct*
_temp44=( struct Cyc_Core_Impossible_struct*) GC_malloc( sizeof( struct Cyc_Core_Impossible_struct));
