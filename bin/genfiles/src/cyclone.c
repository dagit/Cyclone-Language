...
Cyc_Position_seg_t; typedef void* Cyc_Position_Error_kind; extern const
unsigned int Cyc_Position_Lex; extern const unsigned int Cyc_Position_Parse;
...
Cyc_Tcenv_tenv_t; extern struct Cyc_Tcenv_Tenv* Cyc_Tcenv_tc_init(); extern char
Cyc_Tcutil_TypeErr_tag[ 8u]; struct Cyc_Tcutil_TypeErr_struct{ char* tag; } ;
extern void Cyc_Tcutil_flush_warnings(); extern void Cyc_Tc_tc( struct Cyc_Tcenv_Tenv*
...
struct Cyc_List_List* Cyc_Toc_toc( struct Cyc_List_List* ds); extern int Cyc_Toc_check_for_null;
...
fields; } ; extern const unsigned int Cyc_CfFlowInfo_Esc; extern const
unsigned int Cyc_CfFlowInfo_Unesc; extern const unsigned int Cyc_CfFlowInfo_NoneIL;
...
Cyc_Stdio_remove( preprocfile); return;}}}}} int Cyc_main(){ struct _tuple9
specs[ 15]={({ struct _tuple9 _temp99; _temp99.f1=( struct _tagged_string)({
char* _temp104=( char*)"-nocyc"; struct _tagged_string _temp105; _temp105.curr=
_temp104; _temp105.base= _temp104; _temp105.last_plus_one= _temp104 + 7;
_temp105;}); _temp99.f2=( void*)({ struct Cyc_Arg_Clear_spec_struct* _temp102=(
struct Cyc_Arg_Clear_spec_struct*) GC_malloc( sizeof( struct Cyc_Arg_Clear_spec_struct));
_temp102[ 0]=({ struct Cyc_Arg_Clear_spec_struct _temp103; _temp103.tag= Cyc_Arg_Clear_spec_tag;
...
_temp250.last_plus_one= _temp249 + 9; _temp250;})); return Cyc_compile_failure?
1: 0;}