...
_check_null( _temp139)): 0)? 1:( _temp126 == 0? _temp139 != 0: 0))? 1:( _temp126
!= 0? _temp139 == 0: 0)){ Cyc_Tcdecl_merr( loc, msg,( struct _tagged_arr)({
struct Cyc_Stdio_String_pa_struct _temp163; _temp163.tag= Cyc_Stdio_String_pa;
