...
extern void* Cyc_Absyn_string_typ( void* rgn); extern void* Cyc_Absyn_file_typ_nocyc();
...
0; _temp64.q_volatile= 0; _temp64.q_restrict= 0; _temp64;});} int Cyc_Absyn_is_format_prim(
void* p){ void* _temp65= p; _LL67: if( _temp65 ==( void*) Cyc_Absyn_Printf){
goto _LL68;} else{ goto _LL69;} _LL69: if( _temp65 ==( void*) Cyc_Absyn_Fprintf){
goto _LL70;} else{ goto _LL71;} _LL71: if( _temp65 ==( void*) Cyc_Absyn_Xprintf){
goto _LL72;} else{ goto _LL73;} _LL73: if( _temp65 ==( void*) Cyc_Absyn_Scanf){
goto _LL74;} else{ goto _LL75;} _LL75: if( _temp65 ==( void*) Cyc_Absyn_Fscanf){
goto _LL76;} else{ goto _LL77;} _LL77: if( _temp65 ==( void*) Cyc_Absyn_Sscanf){
goto _LL78;} else{ goto _LL79;} _LL79: goto _LL80; _LL68: return 1; _LL70:
return 1; _LL72: return 1; _LL74: return 1; _LL76: return 1; _LL78: return 1;
_LL80: return 0; _LL66:;} struct Cyc_Absyn_Conref* Cyc_Absyn_new_conref( void* x){
return({ struct Cyc_Absyn_Conref* _temp81=( struct Cyc_Absyn_Conref*) GC_malloc(
sizeof( struct Cyc_Absyn_Conref)); _temp81->v=( void*)(( void*)({ struct Cyc_Absyn_Eq_constr_struct*
...
_LL107: return(( void*(*)( struct _tagged_string)) Cyc_Tcutil_impos)(({
unsigned char* _temp110="conref_val"; struct _tagged_string _temp111; _temp111.curr=
_temp110; _temp111.base= _temp110; _temp111.last_plus_one= _temp110 + 11;
_temp111;})); _LL103:;} static struct Cyc_Absyn_IntType_struct Cyc_Absyn_uchar_tt={
...
void*) 2u; static unsigned char _temp122[ 4u]="exn"; static struct
_tagged_string Cyc_Absyn_exn_string={ _temp122, _temp122, _temp122 + 4u}; static
...
void* Cyc_Absyn_string_typ( void* rgn){ if( Cyc_Absyn_string_t_opt == 0){ void*
t= Cyc_Absyn_starb_typ( Cyc_Absyn_uchar_t, rgn, Cyc_Absyn_empty_tqual(),( void*)
Cyc_Absyn_Unknown_b); Cyc_Absyn_string_t_opt=({ struct Cyc_Core_Opt* _temp126=(
struct Cyc_Core_Opt*) GC_malloc( sizeof( struct Cyc_Core_Opt)); _temp126->v=(
void*) t; _temp126;});} return( void*)(( struct Cyc_Core_Opt*) _check_null( Cyc_Absyn_string_t_opt))->v;}
static struct Cyc_Absyn_Int_c_struct Cyc_Absyn_one_intc={ 2u,( void*)(( void*) 0u),
1}; static struct Cyc_Absyn_Const_e_struct Cyc_Absyn_one_b_raw={ 0u,( void*)((
void*)& Cyc_Absyn_one_intc)}; static struct Cyc_Absyn_Exp Cyc_Absyn_one_be={ 0,(
void*)(( void*)& Cyc_Absyn_one_b_raw), 0}; static struct Cyc_Absyn_Upper_b_struct
Cyc_Absyn_one_bt={ 0u,& Cyc_Absyn_one_be}; void* Cyc_Absyn_bounds_one=( void*)&
Cyc_Absyn_one_bt; void* Cyc_Absyn_starb_typ( void* t, void* r, struct Cyc_Absyn_Tqual
tq, void* b){ return( void*)({ struct Cyc_Absyn_PointerType_struct* _temp130=(
...
struct Cyc_Core_Opt* Cyc_Absyn_file_t_opt= 0; static unsigned char _temp141[ 8u]="__sFILE";
...
unsigned char _temp144[ 4u]="Cyc"; static struct _tagged_string Cyc_Absyn_cyc_str={
_temp144, _temp144, _temp144 + 4u}; static struct _tagged_string* Cyc_Absyn_cyc=&
Cyc_Absyn_cyc_str; static unsigned char _temp147[ 6u]="Stdio"; static struct
_tagged_string Cyc_Absyn_st_str={ _temp147, _temp147, _temp147 + 6u}; static
...
void*)({ struct Cyc_Absyn_Abs_n_struct* _temp155=( struct Cyc_Absyn_Abs_n_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Abs_n_struct)); _temp155[ 0]=({ struct Cyc_Absyn_Abs_n_struct
_temp156; _temp156.tag= Cyc_Absyn_Abs_n; _temp156.f1= ns; _temp156;}); _temp155;});
_temp154->f2= Cyc_Absyn_sf; _temp154;}); struct Cyc_Absyn_Structdecl* sd=({
struct Cyc_Absyn_Structdecl* _temp152=( struct Cyc_Absyn_Structdecl*) GC_malloc(
sizeof( struct Cyc_Absyn_Structdecl)); _temp152->sc=( void*)(( void*) Cyc_Absyn_Abstract);
_temp152->name=({ struct Cyc_Core_Opt* _temp153=( struct Cyc_Core_Opt*)
GC_malloc( sizeof( struct Cyc_Core_Opt)); _temp153->v=( void*) file_t_name;
_temp153;}); _temp152->tvs= 0; _temp152->fields= 0; _temp152->attributes= 0;
_temp152;}); void* file_struct_typ=( void*)({ struct Cyc_Absyn_StructType_struct*
...
Cyc_Absyn_empty_tqual()); _temp148;});} struct _tagged_ptr1{ struct
...
Cyc_Absyn_file_typ_ns(({ struct Cyc_List_List*(* _temp157)( struct _tagged_ptr1)=(
struct Cyc_List_List*(*)( struct _tagged_ptr1)) Cyc_List_list; struct
_tagged_string* _temp160= Cyc_Absyn_cyc; struct _tagged_string* _temp161= Cyc_Absyn_st;
struct _tagged_string* _temp158[ 2u]={ _temp160, _temp161}; struct _tagged_ptr1
_temp159={ _temp158, _temp158, _temp158 + 2u}; _temp157( _temp159);}));} return(
...
struct Cyc_List_List*(* _temp162)( struct _tagged_ptr1)=( struct Cyc_List_List*(*)(
struct _tagged_ptr1)) Cyc_List_list; struct _tagged_string* _temp165= Cyc_Absyn_st;
struct _tagged_string* _temp163[ 1u]={ _temp165}; struct _tagged_ptr1 _temp164={
_temp163, _temp163, _temp163 + 1u}; _temp162( _temp164);}));} return( void*)((
...
== 0){ Cyc_Absyn_void_star_t_opt=({ struct Cyc_Core_Opt* _temp166=( struct Cyc_Core_Opt*)
GC_malloc( sizeof( struct Cyc_Core_Opt)); _temp166->v=( void*) Cyc_Absyn_star_typ((
void*) Cyc_Absyn_VoidType,( void*) Cyc_Absyn_HeapRgn, Cyc_Absyn_empty_tqual());
_temp166;});} return( void*)(( struct Cyc_Core_Opt*) _check_null( Cyc_Absyn_void_star_t_opt))->v;}
struct Cyc_Core_Opt* Cyc_Absyn_void_star_typ_opt(){ if( Cyc_Absyn_void_star_t_opt
== 0){ Cyc_Absyn_void_star_t_opt=({ struct Cyc_Core_Opt* _temp167=( struct Cyc_Core_Opt*)
GC_malloc( sizeof( struct Cyc_Core_Opt)); _temp167->v=( void*) Cyc_Absyn_star_typ((
void*) Cyc_Absyn_VoidType,( void*) Cyc_Absyn_HeapRgn, Cyc_Absyn_empty_tqual());
_temp167;});} return Cyc_Absyn_void_star_t_opt;} void* Cyc_Absyn_strct( struct
_tagged_string* name){ return( void*)({ struct Cyc_Absyn_StructType_struct*
_temp168=( struct Cyc_Absyn_StructType_struct*) GC_malloc( sizeof( struct Cyc_Absyn_StructType_struct));
_temp168[ 0]=({ struct Cyc_Absyn_StructType_struct _temp169; _temp169.tag= Cyc_Absyn_StructType;
_temp169.f1=({ struct _tuple0* _temp170=( struct _tuple0*) GC_malloc( sizeof(
struct _tuple0) * 1); _temp170[ 0]=({ struct _tuple0 _temp171; _temp171.f1=(
void*)({ struct Cyc_Absyn_Abs_n_struct* _temp172=( struct Cyc_Absyn_Abs_n_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Abs_n_struct)); _temp172[ 0]=({ struct Cyc_Absyn_Abs_n_struct
_temp173; _temp173.tag= Cyc_Absyn_Abs_n; _temp173.f1= 0; _temp173;}); _temp172;});
_temp171.f2= name; _temp171;}); _temp170;}); _temp169.f2= 0; _temp169.f3= 0;
_temp169;}); _temp168;});} void* Cyc_Absyn_union_typ( struct _tagged_string*
name){ return( void*)({ struct Cyc_Absyn_UnionType_struct* _temp174=( struct Cyc_Absyn_UnionType_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_UnionType_struct)); _temp174[ 0]=({ struct
Cyc_Absyn_UnionType_struct _temp175; _temp175.tag= Cyc_Absyn_UnionType; _temp175.f1=({
struct _tuple0* _temp176=( struct _tuple0*) GC_malloc( sizeof( struct _tuple0) *
1); _temp176[ 0]=({ struct _tuple0 _temp177; _temp177.f1=( void*)({ struct Cyc_Absyn_Abs_n_struct*
...
_temp179.f1= 0; _temp179;}); _temp178;}); _temp177.f2= name; _temp177;});
_temp176;}); _temp175.f2= 0; _temp175.f3= 0; _temp175;}); _temp174;});} void*
Cyc_Absyn_strctq( struct _tuple0* name){ return( void*)({ struct Cyc_Absyn_StructType_struct*
_temp180=( struct Cyc_Absyn_StructType_struct*) GC_malloc( sizeof( struct Cyc_Absyn_StructType_struct));
_temp180[ 0]=({ struct Cyc_Absyn_StructType_struct _temp181; _temp181.tag= Cyc_Absyn_StructType;
_temp181.f1=( struct _tuple0*) name; _temp181.f2= 0; _temp181.f3= 0; _temp181;});
_temp180;});} void* Cyc_Absyn_unionq_typ( struct _tuple0* name){ return( void*)({
struct Cyc_Absyn_UnionType_struct* _temp182=( struct Cyc_Absyn_UnionType_struct*)
...
struct _tuple0*) name; _temp183.f2= 0; _temp183.f3= 0; _temp183;}); _temp182;});}
struct Cyc_Absyn_Exp* Cyc_Absyn_new_exp( void* r, struct Cyc_Position_Segment*
loc){ return({ struct Cyc_Absyn_Exp* _temp184=( struct Cyc_Absyn_Exp*) GC_malloc(
sizeof( struct Cyc_Absyn_Exp)); _temp184->topt= 0; _temp184->r=( void*) r;
_temp184->loc= loc; _temp184;});} struct Cyc_Absyn_Exp* Cyc_Absyn_New_exp(
...
_temp185=( struct Cyc_Absyn_New_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_New_e_struct));
_temp185[ 0]=({ struct Cyc_Absyn_New_e_struct _temp186; _temp186.tag= Cyc_Absyn_New_e;
_temp186.f1= rgn_handle; _temp186.f2= e; _temp186;}); _temp185;}), loc);} struct
Cyc_Absyn_Exp* Cyc_Absyn_copy_exp( struct Cyc_Absyn_Exp* e){ return({ struct Cyc_Absyn_Exp*
_temp187=( struct Cyc_Absyn_Exp*) GC_malloc( sizeof( struct Cyc_Absyn_Exp));
_temp187->topt= e->topt; _temp187->r=( void*)(( void*) e->r); _temp187->loc= e->loc;
_temp187;});} struct Cyc_Absyn_Exp* Cyc_Absyn_const_exp( void* c, struct Cyc_Position_Segment*
loc){ return Cyc_Absyn_new_exp(( void*)({ struct Cyc_Absyn_Const_e_struct*
_temp188=( struct Cyc_Absyn_Const_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Const_e_struct));
_temp188[ 0]=({ struct Cyc_Absyn_Const_e_struct _temp189; _temp189.tag= Cyc_Absyn_Const_e;
_temp189.f1=( void*) c; _temp189;}); _temp188;}), loc);} struct Cyc_Absyn_Exp*
Cyc_Absyn_null_exp( struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp((
void*)({ struct Cyc_Absyn_Const_e_struct* _temp190=( struct Cyc_Absyn_Const_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Const_e_struct)); _temp190[ 0]=({ struct Cyc_Absyn_Const_e_struct
_temp191; _temp191.tag= Cyc_Absyn_Const_e; _temp191.f1=( void*)(( void*) Cyc_Absyn_Null_c);
_temp191;}); _temp190;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_int_exp( void*
...
_temp193; _temp193.tag= Cyc_Absyn_Int_c; _temp193.f1=( void*) s; _temp193.f2= i;
_temp193;}); _temp192;}), seg);} struct Cyc_Absyn_Exp* Cyc_Absyn_signed_int_exp(
...
void*)({ struct Cyc_Absyn_Char_c_struct* _temp194=( struct Cyc_Absyn_Char_c_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Char_c_struct)); _temp194[ 0]=({ struct Cyc_Absyn_Char_c_struct
_temp195; _temp195.tag= Cyc_Absyn_Char_c; _temp195.f1=( void*)(( void*) Cyc_Absyn_Unsigned);
_temp195.f2= c; _temp195;}); _temp194;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_float_exp(
struct _tagged_string f, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_const_exp((
void*)({ struct Cyc_Absyn_Float_c_struct* _temp196=( struct Cyc_Absyn_Float_c_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Float_c_struct)); _temp196[ 0]=({ struct Cyc_Absyn_Float_c_struct
_temp197; _temp197.tag= Cyc_Absyn_Float_c; _temp197.f1= f; _temp197;}); _temp196;}),
...
Cyc_Absyn_String_c_struct* _temp198=( struct Cyc_Absyn_String_c_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_String_c_struct)); _temp198[ 0]=({ struct
Cyc_Absyn_String_c_struct _temp199; _temp199.tag= Cyc_Absyn_String_c; _temp199.f1=
s; _temp199;}); _temp198;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_var_exp(
struct _tuple0* q, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp((
void*)({ struct Cyc_Absyn_Var_e_struct* _temp200=( struct Cyc_Absyn_Var_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Var_e_struct)); _temp200[ 0]=({ struct Cyc_Absyn_Var_e_struct
_temp201; _temp201.tag= Cyc_Absyn_Var_e; _temp201.f1= q; _temp201.f2=( void*)((
void*) Cyc_Absyn_Unresolved_b); _temp201;}); _temp200;}), loc);} struct Cyc_Absyn_Exp*
Cyc_Absyn_varb_exp( struct _tuple0* q, void* b, struct Cyc_Position_Segment* loc){
return Cyc_Absyn_new_exp(( void*)({ struct Cyc_Absyn_Var_e_struct* _temp202=(
struct Cyc_Absyn_Var_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Var_e_struct));
_temp202[ 0]=({ struct Cyc_Absyn_Var_e_struct _temp203; _temp203.tag= Cyc_Absyn_Var_e;
_temp203.f1= q; _temp203.f2=( void*) b; _temp203;}); _temp202;}), loc);} struct
...
_temp204=( struct Cyc_Absyn_UnknownId_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_UnknownId_e_struct));
_temp204[ 0]=({ struct Cyc_Absyn_UnknownId_e_struct _temp205; _temp205.tag= Cyc_Absyn_UnknownId_e;
_temp205.f1= q; _temp205;}); _temp204;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_primop_exp(
void* p, struct Cyc_List_List* es, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp((
void*)({ struct Cyc_Absyn_Primop_e_struct* _temp206=( struct Cyc_Absyn_Primop_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Primop_e_struct)); _temp206[ 0]=({ struct
Cyc_Absyn_Primop_e_struct _temp207; _temp207.tag= Cyc_Absyn_Primop_e; _temp207.f1=(
void*) p; _temp207.f2= es; _temp207;}); _temp206;}), loc);} struct Cyc_Absyn_Exp*
Cyc_Absyn_prim1_exp( void* p, struct Cyc_Absyn_Exp* e, struct Cyc_Position_Segment*
loc){ return Cyc_Absyn_primop_exp( p,({ struct Cyc_List_List* _temp208=( struct
Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List)); _temp208->hd=( void*)
e; _temp208->tl= 0; _temp208;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_prim2_exp(
void* p, struct Cyc_Absyn_Exp* e1, struct Cyc_Absyn_Exp* e2, struct Cyc_Position_Segment*
loc){ return Cyc_Absyn_primop_exp( p,({ struct Cyc_List_List* _temp209=( struct
Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List)); _temp209->hd=( void*)
e1; _temp209->tl=({ struct Cyc_List_List* _temp210=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp210->hd=( void*) e2; _temp210->tl=
0; _temp210;}); _temp209;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_add_exp(
...
void*)({ struct Cyc_Absyn_AssignOp_e_struct* _temp211=( struct Cyc_Absyn_AssignOp_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_AssignOp_e_struct)); _temp211[ 0]=({ struct
Cyc_Absyn_AssignOp_e_struct _temp212; _temp212.tag= Cyc_Absyn_AssignOp_e;
_temp212.f1= e1; _temp212.f2= popt; _temp212.f3= e2; _temp212;}); _temp211;}),
...
struct Cyc_Absyn_Increment_e_struct* _temp213=( struct Cyc_Absyn_Increment_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Increment_e_struct)); _temp213[ 0]=({ struct
Cyc_Absyn_Increment_e_struct _temp214; _temp214.tag= Cyc_Absyn_Increment_e;
_temp214.f1= e; _temp214.f2=( void*) i; _temp214;}); _temp213;}), loc);} struct
...
_temp215=( struct Cyc_Absyn_Conditional_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Conditional_e_struct));
_temp215[ 0]=({ struct Cyc_Absyn_Conditional_e_struct _temp216; _temp216.tag=
Cyc_Absyn_Conditional_e; _temp216.f1= e1; _temp216.f2= e2; _temp216.f3= e3;
_temp216;}); _temp215;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_and_exp( struct
...
void*)({ struct Cyc_Absyn_SeqExp_e_struct* _temp217=( struct Cyc_Absyn_SeqExp_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_SeqExp_e_struct)); _temp217[ 0]=({ struct
Cyc_Absyn_SeqExp_e_struct _temp218; _temp218.tag= Cyc_Absyn_SeqExp_e; _temp218.f1=
e1; _temp218.f2= e2; _temp218;}); _temp217;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_unknowncall_exp(
...
_temp219=( struct Cyc_Absyn_UnknownCall_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_UnknownCall_e_struct));
_temp219[ 0]=({ struct Cyc_Absyn_UnknownCall_e_struct _temp220; _temp220.tag=
Cyc_Absyn_UnknownCall_e; _temp220.f1= e; _temp220.f2= es; _temp220;}); _temp219;}),
...
void*)({ struct Cyc_Absyn_FnCall_e_struct* _temp221=( struct Cyc_Absyn_FnCall_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_FnCall_e_struct)); _temp221[ 0]=({ struct
Cyc_Absyn_FnCall_e_struct _temp222; _temp222.tag= Cyc_Absyn_FnCall_e; _temp222.f1=
e; _temp222.f2= es; _temp222.f3= 0; _temp222;}); _temp221;}), loc);} struct Cyc_Absyn_Exp*
...
_temp223=( struct Cyc_Absyn_NoInstantiate_e_struct*) GC_malloc( sizeof( struct
Cyc_Absyn_NoInstantiate_e_struct)); _temp223[ 0]=({ struct Cyc_Absyn_NoInstantiate_e_struct
_temp224; _temp224.tag= Cyc_Absyn_NoInstantiate_e; _temp224.f1= e; _temp224;});
_temp223;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_instantiate_exp( struct Cyc_Absyn_Exp*
e, struct Cyc_List_List* ts, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp((
void*)({ struct Cyc_Absyn_Instantiate_e_struct* _temp225=( struct Cyc_Absyn_Instantiate_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Instantiate_e_struct)); _temp225[ 0]=({
struct Cyc_Absyn_Instantiate_e_struct _temp226; _temp226.tag= Cyc_Absyn_Instantiate_e;
_temp226.f1= e; _temp226.f2= ts; _temp226;}); _temp225;}), loc);} struct Cyc_Absyn_Exp*
...
_temp227=( struct Cyc_Absyn_Cast_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Cast_e_struct));
_temp227[ 0]=({ struct Cyc_Absyn_Cast_e_struct _temp228; _temp228.tag= Cyc_Absyn_Cast_e;
_temp228.f1=( void*) t; _temp228.f2= e; _temp228;}); _temp227;}), loc);} struct
...
_temp229=( struct Cyc_Absyn_Throw_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Throw_e_struct));
_temp229[ 0]=({ struct Cyc_Absyn_Throw_e_struct _temp230; _temp230.tag= Cyc_Absyn_Throw_e;
_temp230.f1= e; _temp230;}); _temp229;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_address_exp(
struct Cyc_Absyn_Exp* e, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp((
void*)({ struct Cyc_Absyn_Address_e_struct* _temp231=( struct Cyc_Absyn_Address_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Address_e_struct)); _temp231[ 0]=({ struct
Cyc_Absyn_Address_e_struct _temp232; _temp232.tag= Cyc_Absyn_Address_e; _temp232.f1=
e; _temp232;}); _temp231;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_sizeoftyp_exp(
void* t, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp(( void*)({
struct Cyc_Absyn_Sizeoftyp_e_struct* _temp233=( struct Cyc_Absyn_Sizeoftyp_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Sizeoftyp_e_struct)); _temp233[ 0]=({ struct
Cyc_Absyn_Sizeoftyp_e_struct _temp234; _temp234.tag= Cyc_Absyn_Sizeoftyp_e;
_temp234.f1=( void*) t; _temp234;}); _temp233;}), loc);} struct Cyc_Absyn_Exp*
...
_temp235=( struct Cyc_Absyn_Sizeofexp_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Sizeofexp_e_struct));
_temp235[ 0]=({ struct Cyc_Absyn_Sizeofexp_e_struct _temp236; _temp236.tag= Cyc_Absyn_Sizeofexp_e;
_temp236.f1= e; _temp236;}); _temp235;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_deref_exp(
struct Cyc_Absyn_Exp* e, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp((
void*)({ struct Cyc_Absyn_Deref_e_struct* _temp237=( struct Cyc_Absyn_Deref_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Deref_e_struct)); _temp237[ 0]=({ struct Cyc_Absyn_Deref_e_struct
_temp238; _temp238.tag= Cyc_Absyn_Deref_e; _temp238.f1= e; _temp238;}); _temp237;}),
...
void*)({ struct Cyc_Absyn_StructMember_e_struct* _temp239=( struct Cyc_Absyn_StructMember_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_StructMember_e_struct)); _temp239[ 0]=({
struct Cyc_Absyn_StructMember_e_struct _temp240; _temp240.tag= Cyc_Absyn_StructMember_e;
_temp240.f1= e; _temp240.f2= n; _temp240;}); _temp239;}), loc);} struct Cyc_Absyn_Exp*
...
Cyc_Absyn_StructArrow_e_struct* _temp241=( struct Cyc_Absyn_StructArrow_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_StructArrow_e_struct)); _temp241[ 0]=({
struct Cyc_Absyn_StructArrow_e_struct _temp242; _temp242.tag= Cyc_Absyn_StructArrow_e;
...
e1, struct Cyc_Absyn_Exp* e2, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp((
void*)({ struct Cyc_Absyn_Subscript_e_struct* _temp243=( struct Cyc_Absyn_Subscript_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Subscript_e_struct)); _temp243[ 0]=({ struct
Cyc_Absyn_Subscript_e_struct _temp244; _temp244.tag= Cyc_Absyn_Subscript_e;
...
s; _temp248;}); _temp247;}), loc);} static unsigned char _temp251[ 15u]="Null_Exception";
static struct _tagged_string Cyc_Absyn_ne_str={ _temp251, _temp251, _temp251 +
...
_temp253= 0; goto _LL254; _LL254: for( 0; es != 0; es=(( struct Cyc_List_List*)
_check_null( es))->tl){ _temp253=({ struct Cyc_List_List* _temp255=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp255->hd=( void*)({ struct
_tuple5* _temp256=( struct _tuple5*) GC_malloc( sizeof( struct _tuple5));
_temp256->f1= 0; _temp256->f2=( struct Cyc_Absyn_Exp*)(( struct Cyc_List_List*)
_check_null( es))->hd; _temp256;}); _temp255->tl= _temp253; _temp255;});}
_temp253=(( struct Cyc_List_List*(*)( struct Cyc_List_List* x)) Cyc_List_imp_rev)(
_temp253); return Cyc_Absyn_new_exp(( void*)({ struct Cyc_Absyn_Array_e_struct*
_temp257=( struct Cyc_Absyn_Array_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Array_e_struct));
_temp257[ 0]=({ struct Cyc_Absyn_Array_e_struct _temp258; _temp258.tag= Cyc_Absyn_Array_e;
_temp258.f1= _temp253; _temp258;}); _temp257;}), loc);} struct Cyc_Absyn_Exp*
Cyc_Absyn_unresolvedmem_exp( struct Cyc_Core_Opt* n, struct Cyc_List_List* dles,
struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp(( void*)({ struct
Cyc_Absyn_UnresolvedMem_e_struct* _temp259=( struct Cyc_Absyn_UnresolvedMem_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_UnresolvedMem_e_struct)); _temp259[ 0]=({
struct Cyc_Absyn_UnresolvedMem_e_struct _temp260; _temp260.tag= Cyc_Absyn_UnresolvedMem_e;
_temp260.f1= n; _temp260.f2= dles; _temp260;}); _temp259;}), loc);} struct Cyc_Absyn_Stmt*
Cyc_Absyn_new_stmt( void* s, struct Cyc_Position_Segment* loc){ return({ struct
Cyc_Absyn_Stmt* _temp261=( struct Cyc_Absyn_Stmt*) GC_malloc( sizeof( struct Cyc_Absyn_Stmt));
_temp261->r=( void*) s; _temp261->loc= loc; _temp261->non_local_preds= 0;
_temp261->try_depth= 0; _temp261->annot=( void*)(( void*) Cyc_Absyn_EmptyAnnot);
_temp261;});} struct Cyc_Absyn_Stmt* Cyc_Absyn_skip_stmt( struct Cyc_Position_Segment*
...
return Cyc_Absyn_new_stmt(( void*)({ struct Cyc_Absyn_Exp_s_struct* _temp262=(
struct Cyc_Absyn_Exp_s_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Exp_s_struct));
_temp262[ 0]=({ struct Cyc_Absyn_Exp_s_struct _temp263; _temp263.tag= Cyc_Absyn_Exp_s;
_temp263.f1= e; _temp263;}); _temp262;}), loc);} struct Cyc_Absyn_Stmt* Cyc_Absyn_seq_stmts(
...
void*)({ struct Cyc_Absyn_Return_s_struct* _temp264=( struct Cyc_Absyn_Return_s_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Return_s_struct)); _temp264[ 0]=({ struct
Cyc_Absyn_Return_s_struct _temp265; _temp265.tag= Cyc_Absyn_Return_s; _temp265.f1=
e; _temp265;}); _temp264;}), loc);} struct Cyc_Absyn_Stmt* Cyc_Absyn_ifthenelse_stmt(
struct Cyc_Absyn_Exp* e, struct Cyc_Absyn_Stmt* s1, struct Cyc_Absyn_Stmt* s2,
struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_stmt(( void*)({ struct
Cyc_Absyn_IfThenElse_s_struct* _temp266=( struct Cyc_Absyn_IfThenElse_s_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_IfThenElse_s_struct)); _temp266[ 0]=({
struct Cyc_Absyn_IfThenElse_s_struct _temp267; _temp267.tag= Cyc_Absyn_IfThenElse_s;
_temp267.f1= e; _temp267.f2= s1; _temp267.f3= s2; _temp267;}); _temp266;}), loc);}
...
struct Cyc_Absyn_While_s_struct* _temp268=( struct Cyc_Absyn_While_s_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_While_s_struct)); _temp268[ 0]=({ struct Cyc_Absyn_While_s_struct
_temp269; _temp269.tag= Cyc_Absyn_While_s; _temp269.f1=({ struct _tuple2
_temp270; _temp270.f1= e; _temp270.f2= Cyc_Absyn_skip_stmt( e->loc); _temp270;});
_temp269.f2= s; _temp269;}); _temp268;}), loc);} struct Cyc_Absyn_Stmt* Cyc_Absyn_break_stmt(
struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_stmt(( void*)({ struct
Cyc_Absyn_Break_s_struct* _temp271=( struct Cyc_Absyn_Break_s_struct*) GC_malloc(
sizeof( struct Cyc_Absyn_Break_s_struct)); _temp271[ 0]=({ struct Cyc_Absyn_Break_s_struct
_temp272; _temp272.tag= Cyc_Absyn_Break_s; _temp272.f1= 0; _temp272;}); _temp271;}),
...
_temp273=( struct Cyc_Absyn_Continue_s_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Continue_s_struct));
_temp273[ 0]=({ struct Cyc_Absyn_Continue_s_struct _temp274; _temp274.tag= Cyc_Absyn_Continue_s;
_temp274.f1= 0; _temp274;}); _temp273;}), loc);} struct Cyc_Absyn_Stmt* Cyc_Absyn_for_stmt(
struct Cyc_Absyn_Exp* e1, struct Cyc_Absyn_Exp* e2, struct Cyc_Absyn_Exp* e3,
struct Cyc_Absyn_Stmt* s, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_stmt((
void*)({ struct Cyc_Absyn_For_s_struct* _temp275=( struct Cyc_Absyn_For_s_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_For_s_struct)); _temp275[ 0]=({ struct Cyc_Absyn_For_s_struct
_temp276; _temp276.tag= Cyc_Absyn_For_s; _temp276.f1= e1; _temp276.f2=({ struct
_tuple2 _temp277; _temp277.f1= e2; _temp277.f2= Cyc_Absyn_skip_stmt( e3->loc);
_temp277;}); _temp276.f3=({ struct _tuple2 _temp278; _temp278.f1= e3; _temp278.f2=
Cyc_Absyn_skip_stmt( e3->loc); _temp278;}); _temp276.f4= s; _temp276;});
_temp275;}), loc);} struct Cyc_Absyn_Stmt* Cyc_Absyn_switch_stmt( struct Cyc_Absyn_Exp*
e, struct Cyc_List_List* scs, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_stmt((
void*)({ struct Cyc_Absyn_Switch_s_struct* _temp279=( struct Cyc_Absyn_Switch_s_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Switch_s_struct)); _temp279[ 0]=({ struct
Cyc_Absyn_Switch_s_struct _temp280; _temp280.tag= Cyc_Absyn_Switch_s; _temp280.f1=
e; _temp280.f2= scs; _temp280;}); _temp279;}), loc);} struct Cyc_Absyn_Stmt* Cyc_Absyn_seq_stmt(
struct Cyc_Absyn_Stmt* s1, struct Cyc_Absyn_Stmt* s2, struct Cyc_Position_Segment*
loc){ void* _temp281=( void*) s1->r; _LL283: if( _temp281 ==( void*) Cyc_Absyn_Skip_s){
goto _LL284;} else{ goto _LL285;} _LL285: goto _LL286; _LL284: return s2; _LL286:
return Cyc_Absyn_new_stmt(( void*)({ struct Cyc_Absyn_Seq_s_struct* _temp287=(
struct Cyc_Absyn_Seq_s_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Seq_s_struct));
_temp287[ 0]=({ struct Cyc_Absyn_Seq_s_struct _temp288; _temp288.tag= Cyc_Absyn_Seq_s;
_temp288.f1= s1; _temp288.f2= s2; _temp288;}); _temp287;}), loc); _LL282:;}
...
_temp289=( struct Cyc_Absyn_Fallthru_s_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Fallthru_s_struct));
_temp289[ 0]=({ struct Cyc_Absyn_Fallthru_s_struct _temp290; _temp290.tag= Cyc_Absyn_Fallthru_s;
_temp290.f1= el; _temp290.f2= 0; _temp290;}); _temp289;}), loc);} struct Cyc_Absyn_Stmt*
...
_temp291=( struct Cyc_Absyn_Decl_s_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Decl_s_struct));
_temp291[ 0]=({ struct Cyc_Absyn_Decl_s_struct _temp292; _temp292.tag= Cyc_Absyn_Decl_s;
_temp292.f1= d; _temp292.f2= s; _temp292;}); _temp291;}), loc);} struct Cyc_Absyn_Stmt*
...
d= Cyc_Absyn_new_decl(( void*)({ struct Cyc_Absyn_Var_d_struct* _temp295=(
struct Cyc_Absyn_Var_d_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Var_d_struct));
_temp295[ 0]=({ struct Cyc_Absyn_Var_d_struct _temp296; _temp296.tag= Cyc_Absyn_Var_d;
_temp296.f1= Cyc_Absyn_new_vardecl( x, t, init); _temp296;}); _temp295;}), loc);
return Cyc_Absyn_new_stmt(( void*)({ struct Cyc_Absyn_Decl_s_struct* _temp293=(
...
return Cyc_Absyn_new_stmt(( void*)({ struct Cyc_Absyn_Cut_s_struct* _temp297=(
struct Cyc_Absyn_Cut_s_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Cut_s_struct));
_temp297[ 0]=({ struct Cyc_Absyn_Cut_s_struct _temp298; _temp298.tag= Cyc_Absyn_Cut_s;
_temp298.f1= s; _temp298;}); _temp297;}), loc);} struct Cyc_Absyn_Stmt* Cyc_Absyn_splice_stmt(
struct Cyc_Absyn_Stmt* s, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_stmt((
void*)({ struct Cyc_Absyn_Splice_s_struct* _temp299=( struct Cyc_Absyn_Splice_s_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Splice_s_struct)); _temp299[ 0]=({ struct
Cyc_Absyn_Splice_s_struct _temp300; _temp300.tag= Cyc_Absyn_Splice_s; _temp300.f1=
s; _temp300;}); _temp299;}), loc);} struct Cyc_Absyn_Stmt* Cyc_Absyn_label_stmt(
...
_temp301=( struct Cyc_Absyn_Label_s_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Label_s_struct));
_temp301[ 0]=({ struct Cyc_Absyn_Label_s_struct _temp302; _temp302.tag= Cyc_Absyn_Label_s;
_temp302.f1= v; _temp302.f2= s; _temp302;}); _temp301;}), loc);} struct Cyc_Absyn_Stmt*
...
_temp303=( struct Cyc_Absyn_Do_s_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Do_s_struct));
_temp303[ 0]=({ struct Cyc_Absyn_Do_s_struct _temp304; _temp304.tag= Cyc_Absyn_Do_s;
_temp304.f1= s; _temp304.f2=({ struct _tuple2 _temp305; _temp305.f1= e; _temp305.f2=
Cyc_Absyn_skip_stmt( e->loc); _temp305;}); _temp304;}); _temp303;}), loc);}
...
void*)({ struct Cyc_Absyn_TryCatch_s_struct* _temp306=( struct Cyc_Absyn_TryCatch_s_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_TryCatch_s_struct)); _temp306[ 0]=({ struct
Cyc_Absyn_TryCatch_s_struct _temp307; _temp307.tag= Cyc_Absyn_TryCatch_s;
_temp307.f1= s; _temp307.f2= scs; _temp307;}); _temp306;}), loc);} struct Cyc_Absyn_Stmt*
...
_temp308=( struct Cyc_Absyn_Goto_s_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Goto_s_struct));
_temp308[ 0]=({ struct Cyc_Absyn_Goto_s_struct _temp309; _temp309.tag= Cyc_Absyn_Goto_s;
_temp309.f1= lab; _temp309.f2= 0; _temp309;}); _temp308;}), loc);} struct Cyc_Absyn_Stmt*
...
Cyc_Position_Segment* s){ return({ struct Cyc_Absyn_Pat* _temp310=( struct Cyc_Absyn_Pat*)
GC_malloc( sizeof( struct Cyc_Absyn_Pat)); _temp310->r=( void*) p; _temp310->topt=
0; _temp310->loc= s; _temp310;});} struct Cyc_Absyn_Decl* Cyc_Absyn_new_decl(
void* r, struct Cyc_Position_Segment* loc){ return({ struct Cyc_Absyn_Decl*
_temp311=( struct Cyc_Absyn_Decl*) GC_malloc( sizeof( struct Cyc_Absyn_Decl));
_temp311->r=( void*) r; _temp311->loc= loc; _temp311;});} struct Cyc_Absyn_Decl*
...
void*)({ struct Cyc_Absyn_Let_d_struct* _temp312=( struct Cyc_Absyn_Let_d_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Let_d_struct)); _temp312[ 0]=({ struct Cyc_Absyn_Let_d_struct
_temp313; _temp313.tag= Cyc_Absyn_Let_d; _temp313.f1= p; _temp313.f2= 0;
_temp313.f3= t_opt; _temp313.f4= e; _temp313.f5= 0; _temp313;}); _temp312;}),
...
Cyc_Absyn_Letv_d_struct* _temp314=( struct Cyc_Absyn_Letv_d_struct*) GC_malloc(
sizeof( struct Cyc_Absyn_Letv_d_struct)); _temp314[ 0]=({ struct Cyc_Absyn_Letv_d_struct
_temp315; _temp315.tag= Cyc_Absyn_Letv_d; _temp315.f1= vds; _temp315;});
_temp314;}), loc);} struct Cyc_Absyn_Vardecl* Cyc_Absyn_new_vardecl( struct
_tuple0* x, void* t, struct Cyc_Absyn_Exp* init){ return({ struct Cyc_Absyn_Vardecl*
_temp316=( struct Cyc_Absyn_Vardecl*) GC_malloc( sizeof( struct Cyc_Absyn_Vardecl));
...
void*)({ struct Cyc_Absyn_FnType_struct* _temp328=( struct Cyc_Absyn_FnType_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_FnType_struct)); _temp328[ 0]=({ struct Cyc_Absyn_FnType_struct
_temp329; _temp329.tag= Cyc_Absyn_FnType; _temp329.f1=({ struct Cyc_Absyn_FnInfo
_temp330; _temp330.tvars= tvs; _temp330.ret_typ=( void*) Cyc_Absyn_pointer_expand(
ret_typ); _temp330.effect= eff_typ; _temp330.args=(( struct Cyc_List_List*(*)(
struct _tuple1*(* f)( struct _tuple1*), struct Cyc_List_List* x)) Cyc_List_map)(
Cyc_Absyn_expand_arg, args); _temp330.c_varargs= c_varargs; _temp330.cyc_varargs=
cyc_varargs; _temp330.attributes= atts; _temp330;}); _temp329;}); _temp328;});}
void* Cyc_Absyn_pointer_expand( void* t){ void* _temp331= t; struct Cyc_Absyn_FnInfo
_temp337; _LL333: if(( unsigned int) _temp331 > 4u?*(( int*) _temp331) == Cyc_Absyn_FnType:
0){ _LL338: _temp337=(( struct Cyc_Absyn_FnType_struct*) _temp331)->f1; goto
_LL334;} else{ goto _LL335;} _LL335: goto _LL336; _LL334: return Cyc_Absyn_at_typ(
...
void* _temp363; struct Cyc_Absyn_Fndecl* _temp365; struct _tuple0* _temp367;
void* _temp369; struct Cyc_Absyn_Vardecl* _temp371; struct _tuple0* _temp373;
void* _temp375; struct Cyc_Absyn_Vardecl* _temp377; struct _tuple0* _temp379;
void* _temp381; struct _tuple0* _temp383; struct Cyc_Absyn_Exp* _temp385; struct
Cyc_Absyn_Exp* _temp387; struct _tagged_string* _temp389; struct Cyc_Absyn_Exp*
_temp391; struct _tagged_string* _temp393; struct Cyc_Absyn_Exp* _temp395;
struct Cyc_Absyn_Exp* _temp397; struct Cyc_List_List* _temp399; struct Cyc_Absyn_Exp*
_temp401; struct Cyc_Absyn_Exp* _temp403; _LL341: if(*(( int*) _temp339) == Cyc_Absyn_Var_e){
_LL368: _temp367=(( struct Cyc_Absyn_Var_e_struct*) _temp339)->f1; goto _LL364;
_LL364: _temp363=( void*)(( struct Cyc_Absyn_Var_e_struct*) _temp339)->f2; if((
unsigned int) _temp363 > 1u?*(( int*) _temp363) == Cyc_Absyn_Funname_b: 0){
_LL366: _temp365=(( struct Cyc_Absyn_Funname_b_struct*) _temp363)->f1; goto
...
_temp339)->f1; goto _LL370; _LL370: _temp369=( void*)(( struct Cyc_Absyn_Var_e_struct*)
_temp339)->f2; if(( unsigned int) _temp369 > 1u?*(( int*) _temp369) == Cyc_Absyn_Global_b:
0){ _LL372: _temp371=(( struct Cyc_Absyn_Global_b_struct*) _temp369)->f1; goto
_LL344;} else{ goto _LL345;}} else{ goto _LL345;} _LL345: if(*(( int*) _temp339)
== Cyc_Absyn_Var_e){ _LL380: _temp379=(( struct Cyc_Absyn_Var_e_struct*)
_temp339)->f1; goto _LL376; _LL376: _temp375=( void*)(( struct Cyc_Absyn_Var_e_struct*)
_temp339)->f2; if(( unsigned int) _temp375 > 1u?*(( int*) _temp375) == Cyc_Absyn_Local_b:
0){ _LL378: _temp377=(( struct Cyc_Absyn_Local_b_struct*) _temp375)->f1; goto
_LL346;} else{ goto _LL347;}} else{ goto _LL347;} _LL347: if(*(( int*) _temp339)
== Cyc_Absyn_Var_e){ _LL384: _temp383=(( struct Cyc_Absyn_Var_e_struct*)
_temp339)->f1; goto _LL382; _LL382: _temp381=( void*)(( struct Cyc_Absyn_Var_e_struct*)
_temp339)->f2; goto _LL348;} else{ goto _LL349;} _LL349: if(*(( int*) _temp339)
== Cyc_Absyn_Subscript_e){ _LL388: _temp387=(( struct Cyc_Absyn_Subscript_e_struct*)
_temp339)->f1; goto _LL386; _LL386: _temp385=(( struct Cyc_Absyn_Subscript_e_struct*)
_temp339)->f2; goto _LL350;} else{ goto _LL351;} _LL351: if(*(( int*) _temp339)
== Cyc_Absyn_StructMember_e){ _LL392: _temp391=(( struct Cyc_Absyn_StructMember_e_struct*)
_temp339)->f1; goto _LL390; _LL390: _temp389=(( struct Cyc_Absyn_StructMember_e_struct*)
_temp339)->f2; goto _LL352;} else{ goto _LL353;} _LL353: if(*(( int*) _temp339)
== Cyc_Absyn_StructArrow_e){ _LL396: _temp395=(( struct Cyc_Absyn_StructArrow_e_struct*)
_temp339)->f1; goto _LL394; _LL394: _temp393=(( struct Cyc_Absyn_StructArrow_e_struct*)
_temp339)->f2; goto _LL354;} else{ goto _LL355;} _LL355: if(*(( int*) _temp339)
== Cyc_Absyn_Deref_e){ _LL398: _temp397=(( struct Cyc_Absyn_Deref_e_struct*)
_temp339)->f1; goto _LL356;} else{ goto _LL357;} _LL357: if(*(( int*) _temp339)
== Cyc_Absyn_Instantiate_e){ _LL402: _temp401=(( struct Cyc_Absyn_Instantiate_e_struct*)
_temp339)->f1; goto _LL400; _LL400: _temp399=(( struct Cyc_Absyn_Instantiate_e_struct*)
_temp339)->f2; goto _LL358;} else{ goto _LL359;} _LL359: if(*(( int*) _temp339)
== Cyc_Absyn_NoInstantiate_e){ _LL404: _temp403=(( struct Cyc_Absyn_NoInstantiate_e_struct*)
_temp339)->f1; goto _LL360;} else{ goto _LL361;} _LL361: goto _LL362; _LL342:
return 0; _LL344: _temp377= _temp371; goto _LL346; _LL346: { void* _temp405= Cyc_Tcutil_compress((
void*) _temp377->type); struct Cyc_Absyn_Exp* _temp411; struct Cyc_Absyn_Tqual
_temp413; void* _temp415; _LL407: if(( unsigned int) _temp405 > 4u?*(( int*)
_temp405) == Cyc_Absyn_ArrayType: 0){ _LL416: _temp415=( void*)(( struct Cyc_Absyn_ArrayType_struct*)
_temp405)->f1; goto _LL414; _LL414: _temp413=(( struct Cyc_Absyn_ArrayType_struct*)
_temp405)->f2; goto _LL412; _LL412: _temp411=(( struct Cyc_Absyn_ArrayType_struct*)
_temp405)->f3; goto _LL408;} else{ goto _LL409;} _LL409: goto _LL410; _LL408:
return 0; _LL410: return 1; _LL406:;} _LL348: return 1; _LL350: return 1; _LL352:
return Cyc_Absyn_is_lvalue( _temp391); _LL354: return 1; _LL356: return 1;
_LL358: return Cyc_Absyn_is_lvalue( _temp401); _LL360: return Cyc_Absyn_is_lvalue(
_temp403); _LL362: return 0; _LL340:;} struct Cyc_Absyn_Structfield* Cyc_Absyn_lookup_field(
...
struct Cyc_Absyn_Structfield* _temp417=( struct Cyc_Absyn_Structfield*)(( struct
Cyc_List_List*) _check_null( fs))->hd; goto _LL418; _LL418: if( Cyc_String_zstrptrcmp(
_temp417->name, v) == 0){ return( struct Cyc_Absyn_Structfield*) _temp417;}}}
...
_temp419= a; int _temp459; int _temp461; struct _tagged_string _temp463; _LL421:
if(( unsigned int) _temp419 > 16u?*(( int*) _temp419) == Cyc_Absyn_Regparm_att:
0){ _LL460: _temp459=(( struct Cyc_Absyn_Regparm_att_struct*) _temp419)->f1;
goto _LL422;} else{ goto _LL423;} _LL423: if( _temp419 ==( void*) Cyc_Absyn_Stdcall_att){
goto _LL424;} else{ goto _LL425;} _LL425: if( _temp419 ==( void*) Cyc_Absyn_Cdecl_att){
goto _LL426;} else{ goto _LL427;} _LL427: if( _temp419 ==( void*) Cyc_Absyn_Fastcall_att){
goto _LL428;} else{ goto _LL429;} _LL429: if( _temp419 ==( void*) Cyc_Absyn_Noreturn_att){
goto _LL430;} else{ goto _LL431;} _LL431: if( _temp419 ==( void*) Cyc_Absyn_Const_att){
goto _LL432;} else{ goto _LL433;} _LL433: if(( unsigned int) _temp419 > 16u?*((
int*) _temp419) == Cyc_Absyn_Aligned_att: 0){ _LL462: _temp461=(( struct Cyc_Absyn_Aligned_att_struct*)
_temp419)->f1; goto _LL434;} else{ goto _LL435;} _LL435: if( _temp419 ==( void*)
Cyc_Absyn_Packed_att){ goto _LL436;} else{ goto _LL437;} _LL437: if((
unsigned int) _temp419 > 16u?*(( int*) _temp419) == Cyc_Absyn_Section_att: 0){
_LL464: _temp463=(( struct Cyc_Absyn_Section_att_struct*) _temp419)->f1; goto
_LL438;} else{ goto _LL439;} _LL439: if( _temp419 ==( void*) Cyc_Absyn_Nocommon_att){
goto _LL440;} else{ goto _LL441;} _LL441: if( _temp419 ==( void*) Cyc_Absyn_Shared_att){
goto _LL442;} else{ goto _LL443;} _LL443: if( _temp419 ==( void*) Cyc_Absyn_Unused_att){
goto _LL444;} else{ goto _LL445;} _LL445: if( _temp419 ==( void*) Cyc_Absyn_Weak_att){
goto _LL446;} else{ goto _LL447;} _LL447: if( _temp419 ==( void*) Cyc_Absyn_Dllimport_att){
goto _LL448;} else{ goto _LL449;} _LL449: if( _temp419 ==( void*) Cyc_Absyn_Dllexport_att){
goto _LL450;} else{ goto _LL451;} _LL451: if( _temp419 ==( void*) Cyc_Absyn_No_instrument_function_att){
goto _LL452;} else{ goto _LL453;} _LL453: if( _temp419 ==( void*) Cyc_Absyn_Constructor_att){
goto _LL454;} else{ goto _LL455;} _LL455: if( _temp419 ==( void*) Cyc_Absyn_Destructor_att){
goto _LL456;} else{ goto _LL457;} _LL457: if( _temp419 ==( void*) Cyc_Absyn_No_check_memory_usage_att){
goto _LL458;} else{ goto _LL420;} _LL422: return xprintf("regparm(%d)", _temp459);
_LL424: return({ unsigned char* _temp465="stdcall"; struct _tagged_string
_temp466; _temp466.curr= _temp465; _temp466.base= _temp465; _temp466.last_plus_one=
_temp465 + 8; _temp466;}); _LL426: return({ unsigned char* _temp467="cdecl";
struct _tagged_string _temp468; _temp468.curr= _temp467; _temp468.base= _temp467;
_temp468.last_plus_one= _temp467 + 6; _temp468;}); _LL428: return({
unsigned char* _temp469="fastcall"; struct _tagged_string _temp470; _temp470.curr=
_temp469; _temp470.base= _temp469; _temp470.last_plus_one= _temp469 + 9;
_temp470;}); _LL430: return({ unsigned char* _temp471="noreturn"; struct
_tagged_string _temp472; _temp472.curr= _temp471; _temp472.base= _temp471;
_temp472.last_plus_one= _temp471 + 9; _temp472;}); _LL432: return({
unsigned char* _temp473="const"; struct _tagged_string _temp474; _temp474.curr=
_temp473; _temp474.base= _temp473; _temp474.last_plus_one= _temp473 + 6;
_temp474;}); _LL434: if( _temp461 == - 1){ return({ unsigned char* _temp475="aligned";
struct _tagged_string _temp476; _temp476.curr= _temp475; _temp476.base= _temp475;
_temp476.last_plus_one= _temp475 + 8; _temp476;});} else{ return xprintf("aligned(%d)",
_temp461);} _LL436: return({ unsigned char* _temp477="packed"; struct
_tagged_string _temp478; _temp478.curr= _temp477; _temp478.base= _temp477;
_temp478.last_plus_one= _temp477 + 7; _temp478;}); _LL438: return({ struct
_tagged_string _temp479= _temp463; xprintf("section(\"%.*s\")", _temp479.last_plus_one
- _temp479.curr, _temp479.curr);}); _LL440: return({ unsigned char* _temp480="nocommon";
struct _tagged_string _temp481; _temp481.curr= _temp480; _temp481.base= _temp480;
_temp481.last_plus_one= _temp480 + 9; _temp481;}); _LL442: return({
unsigned char* _temp482="shared"; struct _tagged_string _temp483; _temp483.curr=
_temp482; _temp483.base= _temp482; _temp483.last_plus_one= _temp482 + 7;
_temp483;}); _LL444: return({ unsigned char* _temp484="unused"; struct
_tagged_string _temp485; _temp485.curr= _temp484; _temp485.base= _temp484;
_temp485.last_plus_one= _temp484 + 7; _temp485;}); _LL446: return({
unsigned char* _temp486="weak"; struct _tagged_string _temp487; _temp487.curr=
_temp486; _temp487.base= _temp486; _temp487.last_plus_one= _temp486 + 5;
_temp487;}); _LL448: return({ unsigned char* _temp488="dllimport"; struct
_tagged_string _temp489; _temp489.curr= _temp488; _temp489.base= _temp488;
_temp489.last_plus_one= _temp488 + 10; _temp489;}); _LL450: return({
unsigned char* _temp490="dllexport"; struct _tagged_string _temp491; _temp491.curr=
_temp490; _temp491.base= _temp490; _temp491.last_plus_one= _temp490 + 10;
_temp491;}); _LL452: return({ unsigned char* _temp492="no_instrument_function";
struct _tagged_string _temp493; _temp493.curr= _temp492; _temp493.base= _temp492;
_temp493.last_plus_one= _temp492 + 23; _temp493;}); _LL454: return({
unsigned char* _temp494="constructor"; struct _tagged_string _temp495; _temp495.curr=
_temp494; _temp495.base= _temp494; _temp495.last_plus_one= _temp494 + 12;
_temp495;}); _LL456: return({ unsigned char* _temp496="destructor"; struct
_tagged_string _temp497; _temp497.curr= _temp496; _temp497.base= _temp496;
_temp497.last_plus_one= _temp496 + 11; _temp497;}); _LL458: return({
unsigned char* _temp498="no_check_memory_usage"; struct _tagged_string _temp499;
_temp499.curr= _temp498; _temp499.base= _temp498; _temp499.last_plus_one=
_temp498 + 22; _temp499;}); _LL420:;} int Cyc_Absyn_fntype_att( void* a){ void*
_temp500= a; int _temp514; _LL502: if(( unsigned int) _temp500 > 16u?*(( int*)
_temp500) == Cyc_Absyn_Regparm_att: 0){ _LL515: _temp514=(( struct Cyc_Absyn_Regparm_att_struct*)
_temp500)->f1; goto _LL503;} else{ goto _LL504;} _LL504: if( _temp500 ==( void*)
Cyc_Absyn_Stdcall_att){ goto _LL505;} else{ goto _LL506;} _LL506: if( _temp500
==( void*) Cyc_Absyn_Cdecl_att){ goto _LL507;} else{ goto _LL508;} _LL508: if(
_temp500 ==( void*) Cyc_Absyn_Noreturn_att){ goto _LL509;} else{ goto _LL510;}
_LL510: if( _temp500 ==( void*) Cyc_Absyn_Const_att){ goto _LL511;} else{ goto
_LL512;} _LL512: goto _LL513; _LL503: goto _LL505; _LL505: goto _LL507; _LL507:
goto _LL509; _LL509: goto _LL511; _LL511: return 1; _LL513: return 0; _LL501:;}