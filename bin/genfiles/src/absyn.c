...
struct _tagged_string* Cyc_Absyn_st=& Cyc_Absyn_st_str; void* Cyc_Absyn_file_typ(){
...
_temp156; _temp156.tag= Cyc_Absyn_Abs_n; _temp156.f1=( struct Cyc_List_List*)({
struct Cyc_List_List* _temp157=( struct Cyc_List_List*) GC_malloc( sizeof(
struct Cyc_List_List)); _temp157->hd=( void*) Cyc_Absyn_cyc; _temp157->tl=({
struct Cyc_List_List* _temp158=( struct Cyc_List_List*) GC_malloc( sizeof(
struct Cyc_List_List)); _temp158->hd=( void*) Cyc_Absyn_st; _temp158->tl= 0;
_temp158;}); _temp157;}); _temp156;}); _temp155;}); _temp154->f2= Cyc_Absyn_sf;
...
void*)({ struct Cyc_Absyn_Char_c_struct* _temp187=( struct Cyc_Absyn_Char_c_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Char_c_struct)); _temp187[ 0]=({ struct Cyc_Absyn_Char_c_struct
...
e; _temp215.f2= es; _temp215.f3= 0; _temp215;}); _temp214;}), loc);} struct Cyc_Absyn_Exp*
...
_temp216=( struct Cyc_Absyn_NoInstantiate_e_struct*) GC_malloc( sizeof( struct
Cyc_Absyn_NoInstantiate_e_struct)); _temp216[ 0]=({ struct Cyc_Absyn_NoInstantiate_e_struct
_temp217; _temp217.tag= Cyc_Absyn_NoInstantiate_e; _temp217.f1= e; _temp217;});
_temp216;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_instantiate_exp( struct Cyc_Absyn_Exp*
e, struct Cyc_List_List* ts, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp((
void*)({ struct Cyc_Absyn_Instantiate_e_struct* _temp218=( struct Cyc_Absyn_Instantiate_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Instantiate_e_struct)); _temp218[ 0]=({
struct Cyc_Absyn_Instantiate_e_struct _temp219; _temp219.tag= Cyc_Absyn_Instantiate_e;
_temp219.f1= e; _temp219.f2= ts; _temp219;}); _temp218;}), loc);} struct Cyc_Absyn_Exp*
...
_temp220=( struct Cyc_Absyn_Cast_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Cast_e_struct));
_temp220[ 0]=({ struct Cyc_Absyn_Cast_e_struct _temp221; _temp221.tag= Cyc_Absyn_Cast_e;
_temp221.f1=( void*) t; _temp221.f2= e; _temp221;}); _temp220;}), loc);} struct
...
_temp222=( struct Cyc_Absyn_Throw_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Throw_e_struct));
_temp222[ 0]=({ struct Cyc_Absyn_Throw_e_struct _temp223; _temp223.tag= Cyc_Absyn_Throw_e;
_temp223.f1= e; _temp223;}); _temp222;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_address_exp(
struct Cyc_Absyn_Exp* e, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp((
void*)({ struct Cyc_Absyn_Address_e_struct* _temp224=( struct Cyc_Absyn_Address_e_struct*)
...
s; _temp241;}); _temp240;}), loc);} static unsigned char _temp244[ 15u]="Null_Exception";
...
void*)({ struct Cyc_Absyn_FnType_struct* _temp321=( struct Cyc_Absyn_FnType_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_FnType_struct)); _temp321[ 0]=({ struct Cyc_Absyn_FnType_struct
_temp322; _temp322.tag= Cyc_Absyn_FnType; _temp322.f1=({ struct Cyc_Absyn_FnInfo
_temp323; _temp323.tvars= tvs; _temp323.ret_typ=( void*) Cyc_Absyn_pointer_expand(
ret_typ); _temp323.effect= eff_typ; _temp323.args=(( struct Cyc_List_List*(*)(
struct _tuple1*(* f)( struct _tuple1*), struct Cyc_List_List* x)) Cyc_List_map)(
Cyc_Absyn_expand_arg, args); _temp323.c_varargs= c_varargs; _temp323.cyc_varargs=
cyc_varargs; _temp323.attributes= atts; _temp323;}); _temp322;}); _temp321;});}
void* Cyc_Absyn_pointer_expand( void* t){ void* _temp324= t; struct Cyc_Absyn_FnInfo
_temp330; _LL326: if(( unsigned int) _temp324 > 4u?*(( int*) _temp324) == Cyc_Absyn_FnType:
0){ _LL331: _temp330=(( struct Cyc_Absyn_FnType_struct*) _temp324)->f1; goto
_LL327;} else{ goto _LL328;} _LL328: goto _LL329; _LL327: return Cyc_Absyn_at_typ(
t,( void*) Cyc_Absyn_HeapRgn, Cyc_Absyn_empty_tqual()); _LL329: return t; _LL325:;}
int Cyc_Absyn_is_lvalue( struct Cyc_Absyn_Exp* e){ void* _temp332=( void*) e->r;
void* _temp352; struct Cyc_Absyn_Fndecl* _temp354; struct _tuple0* _temp356;
void* _temp358; struct Cyc_Absyn_Vardecl* _temp360; struct _tuple0* _temp362;
void* _temp364; struct Cyc_Absyn_Vardecl* _temp366; struct _tuple0* _temp368;
void* _temp370; struct _tuple0* _temp372; struct Cyc_Absyn_Exp* _temp374; struct
Cyc_Absyn_Exp* _temp376; struct _tagged_string* _temp378; struct Cyc_Absyn_Exp*
_temp380; struct _tagged_string* _temp382; struct Cyc_Absyn_Exp* _temp384;
struct Cyc_Absyn_Exp* _temp386; _LL334: if(*(( int*) _temp332) == Cyc_Absyn_Var_e){
_LL357: _temp356=(( struct Cyc_Absyn_Var_e_struct*) _temp332)->f1; goto _LL353;
_LL353: _temp352=( void*)(( struct Cyc_Absyn_Var_e_struct*) _temp332)->f2; if((
unsigned int) _temp352 > 1u?*(( int*) _temp352) == Cyc_Absyn_Funname_b: 0){
_LL355: _temp354=(( struct Cyc_Absyn_Funname_b_struct*) _temp352)->f1; goto
...
_temp402= a; int _temp442; int _temp444; struct _tagged_string _temp446; _LL404:
if(( unsigned int) _temp402 > 16u?*(( int*) _temp402) == Cyc_Absyn_Regparm_att:
0){ _LL443: _temp442=(( struct Cyc_Absyn_Regparm_att_struct*) _temp402)->f1;
...
goto _LL409;} else{ goto _LL410;} _LL410: if( _temp402 ==( void*) Cyc_Absyn_Fastcall_att){
goto _LL411;} else{ goto _LL412;} _LL412: if( _temp402 ==( void*) Cyc_Absyn_Noreturn_att){
goto _LL413;} else{ goto _LL414;} _LL414: if( _temp402 ==( void*) Cyc_Absyn_Const_att){
goto _LL415;} else{ goto _LL416;} _LL416: if(( unsigned int) _temp402 > 16u?*((
int*) _temp402) == Cyc_Absyn_Aligned_att: 0){ _LL445: _temp444=(( struct Cyc_Absyn_Aligned_att_struct*)
_temp402)->f1; goto _LL417;} else{ goto _LL418;} _LL418: if( _temp402 ==( void*)
Cyc_Absyn_Packed_att){ goto _LL419;} else{ goto _LL420;} _LL420: if((
unsigned int) _temp402 > 16u?*(( int*) _temp402) == Cyc_Absyn_Section_att: 0){
_LL447: _temp446=(( struct Cyc_Absyn_Section_att_struct*) _temp402)->f1; goto
_LL421;} else{ goto _LL422;} _LL422: if( _temp402 ==( void*) Cyc_Absyn_Nocommon_att){
goto _LL423;} else{ goto _LL424;} _LL424: if( _temp402 ==( void*) Cyc_Absyn_Shared_att){
goto _LL425;} else{ goto _LL426;} _LL426: if( _temp402 ==( void*) Cyc_Absyn_Unused_att){
goto _LL427;} else{ goto _LL428;} _LL428: if( _temp402 ==( void*) Cyc_Absyn_Weak_att){
goto _LL429;} else{ goto _LL430;} _LL430: if( _temp402 ==( void*) Cyc_Absyn_Dllimport_att){
goto _LL431;} else{ goto _LL432;} _LL432: if( _temp402 ==( void*) Cyc_Absyn_Dllexport_att){
goto _LL433;} else{ goto _LL434;} _LL434: if( _temp402 ==( void*) Cyc_Absyn_No_instrument_function_att){
goto _LL435;} else{ goto _LL436;} _LL436: if( _temp402 ==( void*) Cyc_Absyn_Constructor_att){
goto _LL437;} else{ goto _LL438;} _LL438: if( _temp402 ==( void*) Cyc_Absyn_Destructor_att){
goto _LL439;} else{ goto _LL440;} _LL440: if( _temp402 ==( void*) Cyc_Absyn_No_check_memory_usage_att){
goto _LL441;} else{ goto _LL403;} _LL405: return xprintf("regparm(%d)", _temp442);
_LL407: return({ unsigned char* _temp448="stdcall"; struct _tagged_string
_temp449; _temp449.curr= _temp448; _temp449.base= _temp448; _temp449.last_plus_one=
_temp448 + 8; _temp449;}); _LL409: return({ unsigned char* _temp450="cdecl";
struct _tagged_string _temp451; _temp451.curr= _temp450; _temp451.base= _temp450;
_temp451.last_plus_one= _temp450 + 6; _temp451;}); _LL411: return({
unsigned char* _temp452="fastcall"; struct _tagged_string _temp453; _temp453.curr=
_temp452; _temp453.base= _temp452; _temp453.last_plus_one= _temp452 + 9;
_temp453;}); _LL413: return({ unsigned char* _temp454="noreturn"; struct
_tagged_string _temp455; _temp455.curr= _temp454; _temp455.base= _temp454;
_temp455.last_plus_one= _temp454 + 9; _temp455;}); _LL415: return({
unsigned char* _temp456="const"; struct _tagged_string _temp457; _temp457.curr=
_temp456; _temp457.base= _temp456; _temp457.last_plus_one= _temp456 + 6;
_temp457;}); _LL417: if( _temp444 == - 1){ return({ unsigned char* _temp458="aligned";
...
_temp444);} _LL419: return({ unsigned char* _temp460="packed"; struct
_tagged_string _temp461; _temp461.curr= _temp460; _temp461.base= _temp460;
_temp461.last_plus_one= _temp460 + 7; _temp461;}); _LL421: return({ struct
_tagged_string _temp462= _temp446; xprintf("section(\"%.*s\")", _temp462.last_plus_one
- _temp462.curr, _temp462.curr);}); _LL423: return({ unsigned char* _temp463="nocommon";
struct _tagged_string _temp464; _temp464.curr= _temp463; _temp464.base= _temp463;
_temp464.last_plus_one= _temp463 + 9; _temp464;}); _LL425: return({
unsigned char* _temp465="shared"; struct _tagged_string _temp466; _temp466.curr=
_temp465; _temp466.base= _temp465; _temp466.last_plus_one= _temp465 + 7;
_temp466;}); _LL427: return({ unsigned char* _temp467="unused"; struct
_tagged_string _temp468; _temp468.curr= _temp467; _temp468.base= _temp467;
_temp468.last_plus_one= _temp467 + 7; _temp468;}); _LL429: return({
unsigned char* _temp469="weak"; struct _tagged_string _temp470; _temp470.curr=
_temp469; _temp470.base= _temp469; _temp470.last_plus_one= _temp469 + 5;
_temp470;}); _LL431: return({ unsigned char* _temp471="dllimport"; struct
_tagged_string _temp472; _temp472.curr= _temp471; _temp472.base= _temp471;
_temp472.last_plus_one= _temp471 + 10; _temp472;}); _LL433: return({
unsigned char* _temp473="dllexport"; struct _tagged_string _temp474; _temp474.curr=
_temp473; _temp474.base= _temp473; _temp474.last_plus_one= _temp473 + 10;
_temp474;}); _LL435: return({ unsigned char* _temp475="no_instrument_function";
struct _tagged_string _temp476; _temp476.curr= _temp475; _temp476.base= _temp475;
_temp476.last_plus_one= _temp475 + 23; _temp476;}); _LL437: return({
unsigned char* _temp477="constructor"; struct _tagged_string _temp478; _temp478.curr=
_temp477; _temp478.base= _temp477; _temp478.last_plus_one= _temp477 + 12;
_temp478;}); _LL439: return({ unsigned char* _temp479="destructor"; struct
_tagged_string _temp480; _temp480.curr= _temp479; _temp480.base= _temp479;
_temp480.last_plus_one= _temp479 + 11; _temp480;}); _LL441: return({
unsigned char* _temp481="no_check_memory_usage"; struct _tagged_string _temp482;
_temp482.curr= _temp481; _temp482.base= _temp481; _temp482.last_plus_one=
_temp481 + 22; _temp482;}); _LL403:;} int Cyc_Absyn_fntype_att( void* a){ void*
_temp483= a; int _temp497; _LL485: if(( unsigned int) _temp483 > 16u?*(( int*)
_temp483) == Cyc_Absyn_Regparm_att: 0){ _LL498: _temp497=(( struct Cyc_Absyn_Regparm_att_struct*)
_temp483)->f1; goto _LL486;} else{ goto _LL487;} _LL487: if( _temp483 ==( void*)
Cyc_Absyn_Stdcall_att){ goto _LL488;} else{ goto _LL489;} _LL489: if( _temp483
==( void*) Cyc_Absyn_Cdecl_att){ goto _LL490;} else{ goto _LL491;} _LL491: if(
_temp483 ==( void*) Cyc_Absyn_Noreturn_att){ goto _LL492;} else{ goto _LL493;}
_LL493: if( _temp483 ==( void*) Cyc_Absyn_Const_att){ goto _LL494;} else{ goto
_LL495;} _LL495: goto _LL496; _LL486: goto _LL488; _LL488: goto _LL490; _LL490:
goto _LL492; _LL492: goto _LL494; _LL494: return 1; _LL496: return 0; _LL484:;}