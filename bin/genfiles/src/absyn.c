...
loc){ return Cyc_Absyn_new_exp(({ struct Cyc_Absyn_Sizeoftyp_e_struct* _temp178=(
struct Cyc_Absyn_Sizeoftyp_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Sizeoftyp_e_struct));
_temp178->tag= Cyc_Absyn_Sizeoftyp_e_tag; _temp178->f1=( void*) t;( void*)
_temp178;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_sizeofexp_exp( struct Cyc_Absyn_Exp*
e, struct Cyc_Position_Segment* loc){ return Cyc_Absyn_new_exp(({ struct Cyc_Absyn_Sizeofexp_e_struct*
_temp179=( struct Cyc_Absyn_Sizeofexp_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Sizeofexp_e_struct));
_temp179->tag= Cyc_Absyn_Sizeofexp_e_tag; _temp179->f1= e;( void*) _temp179;}),
...
_tuple5* _temp192=( struct _tuple5*) GC_malloc( sizeof( struct _tuple5));
...
Cyc_Absyn_EmptyAnnot_struct)); _temp196->tag= Cyc_Absyn_EmptyAnnot_tag;( struct
...
_temp229->region= 0; _temp229->attributes= 0; _temp229;});} struct Cyc_Absyn_Vardecl*
Cyc_Absyn_static_vardecl( struct _tuple0* x, void* t, struct Cyc_Absyn_Exp* init){
return({ struct Cyc_Absyn_Vardecl* _temp230=( struct Cyc_Absyn_Vardecl*)
GC_malloc( sizeof( struct Cyc_Absyn_Vardecl)); _temp230->sc=( void*) Cyc_Absyn_Static;
_temp230->name= x; _temp230->tq= Cyc_Absyn_empty_tqual(); _temp230->type=( void*)
t; _temp230->initializer= init; _temp230->shadow= 0; _temp230->region= 0;
_temp230->attributes= 0; _temp230;});} struct Cyc_Absyn_Decl* Cyc_Absyn_struct_decl(
...
struct Cyc_Absyn_Struct_d_struct* _temp231=( struct Cyc_Absyn_Struct_d_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Struct_d_struct)); _temp231->tag= Cyc_Absyn_Struct_d_tag;
_temp231->f1=({ struct Cyc_Absyn_Structdecl* _temp232=( struct Cyc_Absyn_Structdecl*)
GC_malloc( sizeof( struct Cyc_Absyn_Structdecl)); _temp232->sc=( void*) s;
_temp232->name= n; _temp232->tvs= ts; _temp232->fields= fs; _temp232->attributes=
atts; _temp232;});( void*) _temp231;}), loc);} struct Cyc_Absyn_Decl* Cyc_Absyn_enum_decl(
void* s, struct Cyc_Core_Opt* n, struct Cyc_List_List* ts, struct Cyc_Core_Opt*
...
Cyc_Absyn_FnType_struct* _temp238=( struct Cyc_Absyn_FnType_struct*) GC_malloc(
sizeof( struct Cyc_Absyn_FnType_struct)); _temp238->tag= Cyc_Absyn_FnType_tag;
_temp238->f1=({ struct Cyc_Absyn_FnInfo _temp239; _temp239.tvars= tvs; _temp239.ret_typ=(
void*) Cyc_Absyn_pointer_expand( ret_typ); _temp239.effect= eff_typ; _temp239.args=((
struct Cyc_List_List*(*)( struct _tuple1*(* f)( struct _tuple1*), struct Cyc_List_List*
x)) Cyc_List_map)( Cyc_Absyn_expand_arg, args); _temp239.varargs= varargs;
_temp239.attributes= atts; _temp239;});( void*) _temp238;});} void* Cyc_Absyn_pointer_expand(
void* t){ void* _temp240= t; struct Cyc_Absyn_FnInfo _temp246; _LL242: if((
unsigned int) _temp240 > 5u?(( struct _enum_struct*) _temp240)->tag == Cyc_Absyn_FnType_tag:
0){ _LL247: _temp246=( struct Cyc_Absyn_FnInfo)(( struct Cyc_Absyn_FnType_struct*)
_temp240)->f1; goto _LL243;} else{ goto _LL244;} _LL244: goto _LL245; _LL243:
return Cyc_Absyn_at_typ( t, Cyc_Absyn_HeapRgn, Cyc_Absyn_empty_tqual()); _LL245:
return t; _LL241:;} int Cyc_Absyn_is_lvalue( struct Cyc_Absyn_Exp* e){ void*
_temp248=( void*) e->r; void* _temp268; struct Cyc_Absyn_Fndecl* _temp270;
struct _tuple0* _temp272; void* _temp274; struct Cyc_Absyn_Vardecl* _temp276;
struct _tuple0* _temp278; void* _temp280; struct Cyc_Absyn_Vardecl* _temp282;
struct _tuple0* _temp284; void* _temp286; struct _tuple0* _temp288; struct Cyc_Absyn_Exp*
_temp290; struct Cyc_Absyn_Exp* _temp292; struct _tagged_string* _temp294;
struct Cyc_Absyn_Exp* _temp296; struct _tagged_string* _temp298; struct Cyc_Absyn_Exp*
_temp300; struct Cyc_Absyn_Exp* _temp302; _LL250: if((( struct _enum_struct*)
_temp248)->tag == Cyc_Absyn_Var_e_tag){ _LL273: _temp272=( struct _tuple0*)((
struct Cyc_Absyn_Var_e_struct*) _temp248)->f1; goto _LL269; _LL269: _temp268=(
void*)(( struct Cyc_Absyn_Var_e_struct*) _temp248)->f2; if(( unsigned int)
_temp268 > 1u?(( struct _enum_struct*) _temp268)->tag == Cyc_Absyn_Funname_b_tag:
0){ _LL271: _temp270=( struct Cyc_Absyn_Fndecl*)(( struct Cyc_Absyn_Funname_b_struct*)
_temp268)->f1; goto _LL251;} else{ goto _LL252;}} else{ goto _LL252;} _LL252:
if((( struct _enum_struct*) _temp248)->tag == Cyc_Absyn_Var_e_tag){ _LL279:
_temp278=( struct _tuple0*)(( struct Cyc_Absyn_Var_e_struct*) _temp248)->f1;
goto _LL275; _LL275: _temp274=( void*)(( struct Cyc_Absyn_Var_e_struct*)
...
_LL263: return 1; _LL265: return 1; _LL267: return 0; _LL249:;} struct Cyc_Absyn_Structfield*
...
void* a){ void* _temp316= a; int _temp354; int _temp356; struct _tagged_string
_temp358; _LL318: if(( unsigned int) _temp316 > 15u?(( struct _enum_struct*)
_temp316)->tag == Cyc_Absyn_Regparm_att_tag: 0){ _LL355: _temp354=( int)((
struct Cyc_Absyn_Regparm_att_struct*) _temp316)->f1; goto _LL319;} else{ goto
_LL320;} _LL320: if( _temp316 == Cyc_Absyn_Stdcall_att){ goto _LL321;} else{
goto _LL322;} _LL322: if( _temp316 == Cyc_Absyn_Cdecl_att){ goto _LL323;} else{
goto _LL324;} _LL324: if( _temp316 == Cyc_Absyn_Noreturn_att){ goto _LL325;}
else{ goto _LL326;} _LL326: if( _temp316 == Cyc_Absyn_Const_att){ goto _LL327;}
else{ goto _LL328;} _LL328: if(( unsigned int) _temp316 > 15u?(( struct
_enum_struct*) _temp316)->tag == Cyc_Absyn_Aligned_att_tag: 0){ _LL357: _temp356=(
int)(( struct Cyc_Absyn_Aligned_att_struct*) _temp316)->f1; goto _LL329;} else{
goto _LL330;} _LL330: if( _temp316 == Cyc_Absyn_Packed_att){ goto _LL331;} else{
goto _LL332;} _LL332: if(( unsigned int) _temp316 > 15u?(( struct _enum_struct*)
_temp316)->tag == Cyc_Absyn_Section_att_tag: 0){ _LL359: _temp358=( struct
_tagged_string)(( struct Cyc_Absyn_Section_att_struct*) _temp316)->f1; goto
_LL333;} else{ goto _LL334;} _LL334: if( _temp316 == Cyc_Absyn_Nocommon_att){
goto _LL335;} else{ goto _LL336;} _LL336: if( _temp316 == Cyc_Absyn_Shared_att){
goto _LL337;} else{ goto _LL338;} _LL338: if( _temp316 == Cyc_Absyn_Unused_att){
goto _LL339;} else{ goto _LL340;} _LL340: if( _temp316 == Cyc_Absyn_Weak_att){
goto _LL341;} else{ goto _LL342;} _LL342: if( _temp316 == Cyc_Absyn_Dllimport_att){
goto _LL343;} else{ goto _LL344;} _LL344: if( _temp316 == Cyc_Absyn_Dllexport_att){
goto _LL345;} else{ goto _LL346;} _LL346: if( _temp316 == Cyc_Absyn_No_instrument_function_att){
goto _LL347;} else{ goto _LL348;} _LL348: if( _temp316 == Cyc_Absyn_Constructor_att){
goto _LL349;} else{ goto _LL350;} _LL350: if( _temp316 == Cyc_Absyn_Destructor_att){
goto _LL351;} else{ goto _LL352;} _LL352: if( _temp316 == Cyc_Absyn_No_check_memory_usage_att){
goto _LL353;} else{ goto _LL317;} _LL319: return xprintf("regparm(%d)", _temp354);
_LL321: return( struct _tagged_string)({ char* _temp360=( char*)"stdcall";
struct _tagged_string _temp361; _temp361.curr= _temp360; _temp361.base= _temp360;
_temp361.last_plus_one= _temp360 + 8; _temp361;}); _LL323: return( struct
_tagged_string)({ char* _temp362=( char*)"cdecl"; struct _tagged_string _temp363;
_temp363.curr= _temp362; _temp363.base= _temp362; _temp363.last_plus_one=
_temp362 + 6; _temp363;}); _LL325: return( struct _tagged_string)({ char*
_temp364=( char*)"noreturn"; struct _tagged_string _temp365; _temp365.curr=
_temp364; _temp365.base= _temp364; _temp365.last_plus_one= _temp364 + 9;
_temp365;}); _LL327: return( struct _tagged_string)({ char* _temp366=( char*)"const";
struct _tagged_string _temp367; _temp367.curr= _temp366; _temp367.base= _temp366;
_temp367.last_plus_one= _temp366 + 6; _temp367;}); _LL329: if( _temp356 == - 1){
return( struct _tagged_string)({ char* _temp368=( char*)"aligned"; struct
_tagged_string _temp369; _temp369.curr= _temp368; _temp369.base= _temp368;
_temp369.last_plus_one= _temp368 + 8; _temp369;});} else{ return xprintf("aligned(%d)",
_temp356);} _LL331: return( struct _tagged_string)({ char* _temp370=( char*)"packed";
struct _tagged_string _temp371; _temp371.curr= _temp370; _temp371.base= _temp370;
_temp371.last_plus_one= _temp370 + 7; _temp371;}); _LL333: return({ struct
_tagged_string _temp372= _temp358; xprintf("section(\"%.*s\")", _temp372.last_plus_one
- _temp372.curr, _temp372.curr);}); _LL335: return( struct _tagged_string)({
char* _temp373=( char*)"nocommon"; struct _tagged_string _temp374; _temp374.curr=
_temp373; _temp374.base= _temp373; _temp374.last_plus_one= _temp373 + 9;
_temp374;}); _LL337: return( struct _tagged_string)({ char* _temp375=( char*)"shared";
struct _tagged_string _temp376; _temp376.curr= _temp375; _temp376.base= _temp375;
_temp376.last_plus_one= _temp375 + 7; _temp376;}); _LL339: return( struct
_tagged_string)({ char* _temp377=( char*)"unused"; struct _tagged_string
_temp378; _temp378.curr= _temp377; _temp378.base= _temp377; _temp378.last_plus_one=
_temp377 + 7; _temp378;}); _LL341: return( struct _tagged_string)({ char*
_temp379=( char*)"weak"; struct _tagged_string _temp380; _temp380.curr= _temp379;
_temp380.base= _temp379; _temp380.last_plus_one= _temp379 + 5; _temp380;});
_LL343: return( struct _tagged_string)({ char* _temp381=( char*)"dllimport";
struct _tagged_string _temp382; _temp382.curr= _temp381; _temp382.base= _temp381;
_temp382.last_plus_one= _temp381 + 10; _temp382;}); _LL345: return( struct
_tagged_string)({ char* _temp383=( char*)"dllexport"; struct _tagged_string
_temp384; _temp384.curr= _temp383; _temp384.base= _temp383; _temp384.last_plus_one=
_temp383 + 10; _temp384;}); _LL347: return( struct _tagged_string)({ char*
_temp385=( char*)"no_instrument_function"; struct _tagged_string _temp386;
_temp386.curr= _temp385; _temp386.base= _temp385; _temp386.last_plus_one=
_temp385 + 23; _temp386;}); _LL349: return( struct _tagged_string)({ char*
_temp387=( char*)"constructor"; struct _tagged_string _temp388; _temp388.curr=
_temp387; _temp388.base= _temp387; _temp388.last_plus_one= _temp387 + 12;
_temp388;}); _LL351: return( struct _tagged_string)({ char* _temp389=( char*)"destructor";
struct _tagged_string _temp390; _temp390.curr= _temp389; _temp390.base= _temp389;
_temp390.last_plus_one= _temp389 + 11; _temp390;}); _LL353: return( struct
_tagged_string)({ char* _temp391=( char*)"no_check_memory_usage"; struct
_tagged_string _temp392; _temp392.curr= _temp391; _temp392.base= _temp391;
_temp392.last_plus_one= _temp391 + 22; _temp392;}); _LL317:;}