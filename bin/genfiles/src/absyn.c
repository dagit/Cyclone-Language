...
Cyc_Absyn_Tqual{ int q_const: 1; int q_volatile: 1; int q_restrict: 1; } ; void*
Cyc_Absyn_B1=( void*) 0; void* Cyc_Absyn_B2=( void*) 1; void* Cyc_Absyn_B4=(
...
} ; const int Cyc_Absyn_Eq_constr_tag= 0; struct Cyc_Absyn_Eq_constr_struct{ int
tag; void* f1; } ; const int Cyc_Absyn_Forward_constr_tag= 1; struct Cyc_Absyn_Forward_constr_struct{
...
} ; const int Cyc_Absyn_UnionType_tag= 10; struct Cyc_Absyn_UnionType_struct{
int tag; struct _tuple0* f1; struct Cyc_List_List* f2; struct Cyc_Absyn_Uniondecl**
f3; } ; const int Cyc_Absyn_RgnHandleType_tag= 11; struct Cyc_Absyn_RgnHandleType_struct{
int tag; void* f1; } ; const int Cyc_Absyn_TypedefType_tag= 12; struct Cyc_Absyn_TypedefType_struct{
int tag; struct _tuple0* f1; struct Cyc_List_List* f2; struct Cyc_Core_Opt* f3;
} ; void* Cyc_Absyn_HeapRgn=( void*) 3; const int Cyc_Absyn_AccessEff_tag= 13;
struct Cyc_Absyn_AccessEff_struct{ int tag; void* f1; } ; const int Cyc_Absyn_JoinEff_tag=
14; struct Cyc_Absyn_JoinEff_struct{ int tag; struct Cyc_List_List* f1; } ;
...
int tag; struct Cyc_Absyn_Exp* f1; } ; void* Cyc_Absyn_TaggedArray_ps=( void*) 0;
const int Cyc_Absyn_Regparm_att_tag= 0; struct Cyc_Absyn_Regparm_att_struct{ int
tag; int f1; } ; void* Cyc_Absyn_Stdcall_att=( void*) 0; void* Cyc_Absyn_Cdecl_att=(
...
struct _tuple0)); _temp136->f1=({ struct Cyc_Absyn_Abs_n_struct* _temp137=(
struct Cyc_Absyn_Abs_n_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Abs_n_struct));
_temp137->tag= Cyc_Absyn_Abs_n_tag; _temp137->f1=( struct Cyc_List_List*)({
struct Cyc_List_List* _temp138=( struct Cyc_List_List*) GC_malloc( sizeof(
struct Cyc_List_List)); _temp138->hd=( void*) Cyc_Absyn_cyc; _temp138->tl=({
struct Cyc_List_List* _temp139=( struct Cyc_List_List*) GC_malloc( sizeof(
struct Cyc_List_List)); _temp139->hd=( void*) Cyc_Absyn_st; _temp139->tl= 0;
_temp139;}); _temp138;});( void*) _temp137;}); _temp136->f2= Cyc_Absyn_sf;
_temp136;}); struct Cyc_Absyn_Structdecl* sd=({ struct Cyc_Absyn_Structdecl*
_temp140=( struct Cyc_Absyn_Structdecl*) GC_malloc( sizeof( struct Cyc_Absyn_Structdecl));
_temp140->sc=( void*) Cyc_Absyn_Abstract; _temp140->name=({ struct Cyc_Core_Opt*
_temp141=( struct Cyc_Core_Opt*) GC_malloc( sizeof( struct Cyc_Core_Opt));
_temp141->v=( void*) file_t_name; _temp141;}); _temp140->tvs= 0; _temp140->fields=
0; _temp140->attributes= 0; _temp140;}); void* file_struct_typ=({ struct Cyc_Absyn_StructType_struct*
_temp142=( struct Cyc_Absyn_StructType_struct*) GC_malloc( sizeof( struct Cyc_Absyn_StructType_struct));
_temp142->tag= Cyc_Absyn_StructType_tag; _temp142->f1=( struct _tuple0*)
file_t_name; _temp142->f2= 0; _temp142->f3=({ struct Cyc_Absyn_Structdecl**
_temp143=( struct Cyc_Absyn_Structdecl**) GC_malloc( sizeof( struct Cyc_Absyn_Structdecl*)
* 1); _temp143[ 0]= sd; _temp143;});( void*) _temp142;}); Cyc_Absyn_file_t_opt=({
struct Cyc_Core_Opt* _temp144=( struct Cyc_Core_Opt*) GC_malloc( sizeof( struct
Cyc_Core_Opt)); _temp144->v=( void*) Cyc_Absyn_at_typ( file_struct_typ, Cyc_Absyn_HeapRgn,
Cyc_Absyn_empty_tqual()); _temp144;});} return( void*) Cyc_Absyn_file_t_opt->v;}
...
_temp145->v=( void*) Cyc_Absyn_star_typ( Cyc_Absyn_VoidType, Cyc_Absyn_HeapRgn,
Cyc_Absyn_empty_tqual()); _temp145;});} return( void*) Cyc_Absyn_void_star_t_opt->v;}
void* Cyc_Absyn_strct( struct _tagged_string* name){ return({ struct Cyc_Absyn_StructType_struct*
_temp146=( struct Cyc_Absyn_StructType_struct*) GC_malloc( sizeof( struct Cyc_Absyn_StructType_struct));
_temp146->tag= Cyc_Absyn_StructType_tag; _temp146->f1=({ struct _tuple0*
_temp147=( struct _tuple0*) GC_malloc( sizeof( struct _tuple0) * 1); _temp147[ 0]=({
struct _tuple0 _temp148; _temp148.f1=({ struct Cyc_Absyn_Abs_n_struct* _temp149=(
struct Cyc_Absyn_Abs_n_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Abs_n_struct));
_temp149->tag= Cyc_Absyn_Abs_n_tag; _temp149->f1= 0;( void*) _temp149;});
_temp148.f2= name; _temp148;}); _temp147;}); _temp146->f2= 0; _temp146->f3= 0;(
void*) _temp146;});} void* Cyc_Absyn_union_typ( struct _tagged_string* name){
return({ struct Cyc_Absyn_UnionType_struct* _temp150=( struct Cyc_Absyn_UnionType_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_UnionType_struct)); _temp150->tag= Cyc_Absyn_UnionType_tag;
_temp150->f1=({ struct _tuple0* _temp151=( struct _tuple0*) GC_malloc( sizeof(
struct _tuple0) * 1); _temp151[ 0]=({ struct _tuple0 _temp152; _temp152.f1=({
struct Cyc_Absyn_Abs_n_struct* _temp153=( struct Cyc_Absyn_Abs_n_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Abs_n_struct)); _temp153->tag= Cyc_Absyn_Abs_n_tag;
_temp153->f1= 0;( void*) _temp153;}); _temp152.f2= name; _temp152;}); _temp151;});
_temp150->f2= 0; _temp150->f3= 0;( void*) _temp150;});} void* Cyc_Absyn_strctq(
struct _tuple0* name){ return({ struct Cyc_Absyn_StructType_struct* _temp154=(
struct Cyc_Absyn_StructType_struct*) GC_malloc( sizeof( struct Cyc_Absyn_StructType_struct));
_temp154->tag= Cyc_Absyn_StructType_tag; _temp154->f1=( struct _tuple0*) name;
_temp154->f2= 0; _temp154->f3= 0;( void*) _temp154;});} void* Cyc_Absyn_unionq_typ(
struct _tuple0* name){ return({ struct Cyc_Absyn_UnionType_struct* _temp155=(
struct Cyc_Absyn_UnionType_struct*) GC_malloc( sizeof( struct Cyc_Absyn_UnionType_struct));
_temp155->tag= Cyc_Absyn_UnionType_tag; _temp155->f1=( struct _tuple0*) name;
_temp155->f2= 0; _temp155->f3= 0;( void*) _temp155;});} struct Cyc_Absyn_Exp*
Cyc_Absyn_new_exp( void* r, struct Cyc_Position_Segment* loc){ return({ struct
Cyc_Absyn_Exp* _temp156=( struct Cyc_Absyn_Exp*) GC_malloc( sizeof( struct Cyc_Absyn_Exp));
_temp156->topt= 0; _temp156->r=( void*) r; _temp156->loc= loc; _temp156;});}
struct Cyc_Absyn_Exp* Cyc_Absyn_New_exp( struct Cyc_Absyn_Exp* e, struct Cyc_Position_Segment*
loc){ return Cyc_Absyn_new_exp(({ struct Cyc_Absyn_New_e_struct* _temp157=(
struct Cyc_Absyn_New_e_struct*) GC_malloc( sizeof( struct Cyc_Absyn_New_e_struct));
_temp157->tag= Cyc_Absyn_New_e_tag; _temp157->f1= e;( void*) _temp157;}), loc);}
...
struct Cyc_Absyn_String_c_struct* _temp164=( struct Cyc_Absyn_String_c_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_String_c_struct)); _temp164->tag= Cyc_Absyn_String_c_tag;
_temp164->f1= s;( void*) _temp164;}), loc);} struct Cyc_Absyn_Exp* Cyc_Absyn_var_exp(
...
_temp198->tag= Cyc_Absyn_Array_e_tag; _temp198->f1= dles;( void*) _temp198;}),
...
struct Cyc_Absyn_UnresolvedMem_e_struct* _temp199=( struct Cyc_Absyn_UnresolvedMem_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_UnresolvedMem_e_struct)); _temp199->tag= Cyc_Absyn_UnresolvedMem_e_tag;
