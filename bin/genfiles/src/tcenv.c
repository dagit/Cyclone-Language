...
extern void* Cyc_Absyn_exn_typ; extern struct _tagged_string Cyc_Absynpp_typ2string(
...
Cyc_Tcenv_tenv_t; extern struct Cyc_Tcenv_Tenv* Cyc_Tcenv_tc_init(); extern
...
1; const int Cyc_Tcenv_TunionRes_tag= 2; const int Cyc_Tcenv_XTunionRes_tag= 3;
const int Cyc_Tcenv_EnumRes_tag= 4; const int Cyc_Tcenv_Outermost_tag= 0; const
int Cyc_Tcenv_Frame_tag= 1; const int Cyc_Tcenv_Hidden_tag= 2; const
unsigned int Cyc_Tcenv_NotLoop_j= 0; const unsigned int Cyc_Tcenv_CaseEnd_j= 1;
const unsigned int Cyc_Tcenv_FnEnd_j= 2; const int Cyc_Tcenv_Stmt_j_tag= 0;
...
Cyc_Tcutil_empty_var_set=({ struct Cyc_Core_Opt* _temp3=( struct Cyc_Core_Opt*)
GC_malloc( sizeof( struct Cyc_Core_Opt)); _temp3->v=( void*)(( struct Cyc_Set_Set*(*)(
int(* comp)( struct _tagged_string*, struct _tagged_string*))) Cyc_Set_empty)(
Cyc_String_zstrptrcmp); _temp3;});{ struct Cyc_Tcenv_Genv* ge= Cyc_Tcenv_empty_genv();
struct Cyc_List_List* top_ns= 0; Cyc_Absyn_exn_xed=({ struct Cyc_Absyn_XTuniondecl*
_temp4=( struct Cyc_Absyn_XTuniondecl*) GC_malloc( sizeof( struct Cyc_Absyn_XTuniondecl));
