...
0){ return 0;} if( Cyc_String_zstrptrcmp(( struct _tagged_arr*)(( struct Cyc_List_List*)
...
lookup( ge2, v);({ struct Cyc_Stdio_String_pa_struct _temp16; _temp16.tag= Cyc_Stdio_String_pa;
