...
({struct _dyneither_ptr _tmp4E=({unsigned _tmp0=size;_tag_dyneither(_cyccalloc_atomic(sizeof(unsigned char),_tmp0),sizeof(unsigned char),_tmp0);});z->digits=_tmp4E;});
size > 0?0:({struct _dyneither_ptr _tmp4F=({const char*_tmp1="size > 0";_tag_dyneither(_tmp1,sizeof(char),9U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp4F,({const char*_tmp2="ap.cyc";_tag_dyneither(_tmp2,sizeof(char),7U);}),37U);});
z->sign=1;
z->size=size;
z->ndigits=1;
return z;}
...
# 78
borrow == 0?0:({struct _dyneither_ptr _tmp5C=({const char*_tmp3="borrow == 0";_tag_dyneither(_tmp3,sizeof(char),12U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp5C,({const char*_tmp4="ap.cyc";_tag_dyneither(_tmp4,sizeof(char),7U);}),78U);});
return Cyc_normalize(z,z->size);}
# 81
...
struct Cyc_AP_T*Cyc_AP_neg(struct Cyc_AP_T*x){
struct Cyc_AP_T*z;
(unsigned)x?0:({struct _dyneither_ptr _tmp5F=({const char*_tmp5="x";_tag_dyneither(_tmp5,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp5F,({const char*_tmp6="ap.cyc";_tag_dyneither(_tmp6,sizeof(char),7U);}),97U);});
z=Cyc_mk(x->ndigits);
((struct _dyneither_ptr(*)(struct _dyneither_ptr d,struct _dyneither_ptr s,unsigned long,unsigned))Cyc__memcpy)(((struct Cyc_AP_T*)_check_null(z))->digits,(struct _dyneither_ptr)x->digits,(unsigned)x->ndigits / sizeof(*((unsigned char*)(x->digits).curr))+ (unsigned)((unsigned)x->ndigits % sizeof(*((unsigned char*)(x->digits).curr))== (unsigned)0?0: 1),sizeof(*((unsigned char*)(x->digits).curr)));
z->ndigits=x->ndigits;
...
struct Cyc_AP_T*Cyc_AP_abs(struct Cyc_AP_T*x){
struct Cyc_AP_T*z;
(unsigned)x?0:({struct _dyneither_ptr _tmp60=({const char*_tmp7="x";_tag_dyneither(_tmp7,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp60,({const char*_tmp8="ap.cyc";_tag_dyneither(_tmp8,sizeof(char),7U);}),106U);});
z=Cyc_mk(x->ndigits);
((struct _dyneither_ptr(*)(struct _dyneither_ptr d,struct _dyneither_ptr s,unsigned long,unsigned))Cyc__memcpy)(((struct Cyc_AP_T*)_check_null(z))->digits,(struct _dyneither_ptr)x->digits,(unsigned)x->ndigits / sizeof(*((unsigned char*)(x->digits).curr))+ (unsigned)((unsigned)x->ndigits % sizeof(*((unsigned char*)(x->digits).curr))== (unsigned)0?0: 1),sizeof(*((unsigned char*)(x->digits).curr)));
z->ndigits=x->ndigits;
z->sign=1;
...
struct Cyc_AP_T*Cyc_AP_mul(struct Cyc_AP_T*x,struct Cyc_AP_T*y){
struct Cyc_AP_T*z;
(unsigned)x?0:({struct _dyneither_ptr _tmp61=({const char*_tmp9="x";_tag_dyneither(_tmp9,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp61,({const char*_tmpA="ap.cyc";_tag_dyneither(_tmpA,sizeof(char),7U);}),115U);});
(unsigned)y?0:({struct _dyneither_ptr _tmp62=({const char*_tmpB="y";_tag_dyneither(_tmpB,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp62,({const char*_tmpC="ap.cyc";_tag_dyneither(_tmpC,sizeof(char),7U);}),116U);});
...
struct Cyc_AP_T*Cyc_AP_add(struct Cyc_AP_T*x,struct Cyc_AP_T*y){
struct Cyc_AP_T*z;
(unsigned)x?0:({struct _dyneither_ptr _tmp63=({const char*_tmpD="x";_tag_dyneither(_tmpD,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp63,({const char*_tmpE="ap.cyc";_tag_dyneither(_tmpE,sizeof(char),7U);}),127U);});
(unsigned)y?0:({struct _dyneither_ptr _tmp64=({const char*_tmpF="y";_tag_dyneither(_tmpF,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp64,({const char*_tmp10="ap.cyc";_tag_dyneither(_tmp10,sizeof(char),7U);}),128U);});
if((x->sign ^ y->sign)== 0){
...
struct Cyc_AP_T*Cyc_AP_sub(struct Cyc_AP_T*x,struct Cyc_AP_T*y){
struct Cyc_AP_T*z;
(unsigned)x?0:({struct _dyneither_ptr _tmp6E=({const char*_tmp11="x";_tag_dyneither(_tmp11,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp6E,({const char*_tmp12="ap.cyc";_tag_dyneither(_tmp12,sizeof(char),7U);}),145U);});
(unsigned)y?0:({struct _dyneither_ptr _tmp6F=({const char*_tmp13="y";_tag_dyneither(_tmp13,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp6F,({const char*_tmp14="ap.cyc";_tag_dyneither(_tmp14,sizeof(char),7U);}),146U);});
if(!((x->sign ^ y->sign)== 0)){
...
(unsigned)x?0:({struct _dyneither_ptr _tmp79=({const char*_tmp15="x";_tag_dyneither(_tmp15,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp79,({const char*_tmp16="ap.cyc";_tag_dyneither(_tmp16,sizeof(char),7U);}),162U);});
(unsigned)y?0:({struct _dyneither_ptr _tmp7A=({const char*_tmp17="y";_tag_dyneither(_tmp17,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp7A,({const char*_tmp18="ap.cyc";_tag_dyneither(_tmp18,sizeof(char),7U);}),163U);});
!(y->ndigits == 1 &&(int)*((unsigned char*)_check_dyneither_subscript(y->digits,sizeof(unsigned char),0))== 0)?0:({struct _dyneither_ptr _tmp7B=({const char*_tmp19="!((y)->ndigits==1 && (y)->digits[0]==0)";_tag_dyneither(_tmp19,sizeof(char),40U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp7B,({const char*_tmp1A="ap.cyc";_tag_dyneither(_tmp1A,sizeof(char),7U);}),164U);});
q=Cyc_mk(x->ndigits);
r=Cyc_mk(y->ndigits);
{
struct _dyneither_ptr tmp=({unsigned _tmp1B=(unsigned)((x->ndigits + y->ndigits)+ 2)* sizeof(unsigned char);_tag_dyneither(_cycalloc_atomic(_tmp1B),1U,_tmp1B);});
...
struct Cyc_AP_T*Cyc_AP_mod(struct Cyc_AP_T*x,struct Cyc_AP_T*y){
struct Cyc_AP_T*q;struct Cyc_AP_T*r;
(unsigned)x?0:({struct _dyneither_ptr _tmp82=({const char*_tmp1C="x";_tag_dyneither(_tmp1C,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp82,({const char*_tmp1D="ap.cyc";_tag_dyneither(_tmp1D,sizeof(char),7U);}),180U);});
(unsigned)y?0:({struct _dyneither_ptr _tmp83=({const char*_tmp1E="y";_tag_dyneither(_tmp1E,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp83,({const char*_tmp1F="ap.cyc";_tag_dyneither(_tmp1F,sizeof(char),7U);}),181U);});
!(y->ndigits == 1 &&(int)*((unsigned char*)_check_dyneither_subscript(y->digits,sizeof(unsigned char),0))== 0)?0:({struct _dyneither_ptr _tmp84=({const char*_tmp20="!((y)->ndigits==1 && (y)->digits[0]==0)";_tag_dyneither(_tmp20,sizeof(char),40U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp84,({const char*_tmp21="ap.cyc";_tag_dyneither(_tmp21,sizeof(char),7U);}),182U);});
q=Cyc_mk(x->ndigits);
r=Cyc_mk(y->ndigits);
{
struct _dyneither_ptr tmp=({unsigned _tmp22=(unsigned)((x->ndigits + y->ndigits)+ 2)* sizeof(unsigned char);_tag_dyneither(_cycalloc_atomic(_tmp22),1U,_tmp22);});
...
struct Cyc_AP_T*Cyc_AP_pow(struct Cyc_AP_T*x,struct Cyc_AP_T*y,struct Cyc_AP_T*p){
struct Cyc_AP_T*z;
(unsigned)x?0:({struct _dyneither_ptr _tmp8B=({const char*_tmp23="x";_tag_dyneither(_tmp23,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp8B,({const char*_tmp24="ap.cyc";_tag_dyneither(_tmp24,sizeof(char),7U);}),197U);});
(unsigned)y?0:({struct _dyneither_ptr _tmp8C=({const char*_tmp25="y";_tag_dyneither(_tmp25,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp8C,({const char*_tmp26="ap.cyc";_tag_dyneither(_tmp26,sizeof(char),7U);}),198U);});
y->sign == 1?0:({struct _dyneither_ptr _tmp8D=({const char*_tmp27="y->sign == 1";_tag_dyneither(_tmp27,sizeof(char),13U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp8D,({const char*_tmp28="ap.cyc";_tag_dyneither(_tmp28,sizeof(char),7U);}),199U);});
(!((unsigned)p)||(p->sign == 1 && !(p->ndigits == 1 &&(int)*((unsigned char*)_check_dyneither_subscript(p->digits,sizeof(unsigned char),0))== 0))&& !(p->ndigits == 1 &&(int)*((unsigned char*)_check_dyneither_subscript(p->digits,sizeof(unsigned char),0))== 1))?0:({struct _dyneither_ptr _tmp8E=({const char*_tmp29="!p || p->sign==1 && !((p)->ndigits==1 && (p)->digits[0]==0) && !((p)->ndigits==1 && (p)->digits[0]==1)";_tag_dyneither(_tmp29,sizeof(char),103U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp8E,({const char*_tmp2A="ap.cyc";_tag_dyneither(_tmp2A,sizeof(char),7U);}),200U);});
...
# 229
int Cyc_AP_cmp(struct Cyc_AP_T*x,struct Cyc_AP_T*y){
(unsigned)x?0:({struct _dyneither_ptr _tmp92=({const char*_tmp2B="x";_tag_dyneither(_tmp2B,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp92,({const char*_tmp2C="ap.cyc";_tag_dyneither(_tmp2C,sizeof(char),7U);}),230U);});
(unsigned)y?0:({struct _dyneither_ptr _tmp93=({const char*_tmp2D="y";_tag_dyneither(_tmp2D,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp93,({const char*_tmp2E="ap.cyc";_tag_dyneither(_tmp2E,sizeof(char),7U);}),231U);});
if(!((x->sign ^ y->sign)== 0))
return x->sign;else{
if(x->sign == 1)
...
struct Cyc_AP_T*Cyc_AP_lshift(struct Cyc_AP_T*x,int s){
struct Cyc_AP_T*z;
(unsigned)x?0:({struct _dyneither_ptr _tmp9A=({const char*_tmp2F="x";_tag_dyneither(_tmp2F,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp9A,({const char*_tmp30="ap.cyc";_tag_dyneither(_tmp30,sizeof(char),7U);}),269U);});
s >= 0?0:({struct _dyneither_ptr _tmp9B=({const char*_tmp31="s >= 0";_tag_dyneither(_tmp31,sizeof(char),7U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp9B,({const char*_tmp32="ap.cyc";_tag_dyneither(_tmp32,sizeof(char),7U);}),270U);});
...
# 277
struct Cyc_AP_T*Cyc_AP_rshift(struct Cyc_AP_T*x,int s){
(unsigned)x?0:({struct _dyneither_ptr _tmp9C=({const char*_tmp33="x";_tag_dyneither(_tmp33,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp9C,({const char*_tmp34="ap.cyc";_tag_dyneither(_tmp34,sizeof(char),7U);}),278U);});
s >= 0?0:({struct _dyneither_ptr _tmp9D=({const char*_tmp35="s >= 0";_tag_dyneither(_tmp35,sizeof(char),7U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmp9D,({const char*_tmp36="ap.cyc";_tag_dyneither(_tmp36,sizeof(char),7U);}),279U);});
if(s >= 8 * x->ndigits)
...
long Cyc_AP_toint(struct Cyc_AP_T*x){
unsigned long u;
(unsigned)x?0:({struct _dyneither_ptr _tmpA1=({const char*_tmp37="x";_tag_dyneither(_tmp37,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmpA1,({const char*_tmp38="ap.cyc";_tag_dyneither(_tmp38,sizeof(char),7U);}),332U);});
...
char sign='\000';
int carry;
(unsigned)p.curr?0:({struct _dyneither_ptr _tmpA3=({const char*_tmp39="p";_tag_dyneither(_tmp39,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmpA3,({const char*_tmp3A="ap.cyc";_tag_dyneither(_tmp3A,sizeof(char),7U);}),344U);});
base >= 2 && base <= 36?0:({struct _dyneither_ptr _tmpA4=({const char*_tmp3B="base >= 2 && base <= 36";_tag_dyneither(_tmp3B,sizeof(char),24U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmpA4,({const char*_tmp3C="ap.cyc";_tag_dyneither(_tmp3C,sizeof(char),7U);}),345U);});
...
# 367
carry == 0?0:({struct _dyneither_ptr _tmpA8=({const char*_tmp3E="carry == 0";_tag_dyneither(_tmp3E,sizeof(char),11U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmpA8,({const char*_tmp3F="ap.cyc";_tag_dyneither(_tmp3F,sizeof(char),7U);}),367U);});
Cyc_normalize(z,z->size);
...
int size;int k;
(unsigned)x?0:({struct _dyneither_ptr _tmpA9=({const char*_tmp41="x";_tag_dyneither(_tmp41,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmpA9,({const char*_tmp42="ap.cyc";_tag_dyneither(_tmp42,sizeof(char),7U);}),376U);});
base >= 2 && base <= 36?0:({struct _dyneither_ptr _tmpAA=({const char*_tmp43="base >= 2 && base <= 36";_tag_dyneither(_tmp43,sizeof(char),24U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmpAA,({const char*_tmp44="ap.cyc";_tag_dyneither(_tmp44,sizeof(char),7U);}),377U);});
for(k=5;1 << k > base;-- k){
;}
size=((8 * x->ndigits)/ k + 1)+ 1;
if(x->sign == - 1)
++ size;
str=({unsigned _tmp45=size;_tag_dyneither(_cyccalloc_atomic(sizeof(char),_tmp45),sizeof(char),_tmp45);});
q=({unsigned _tmp46=(unsigned)x->ndigits * sizeof(unsigned char);_tag_dyneither(_cycalloc_atomic(_tmp46),1U,_tmp46);});
((struct _dyneither_ptr(*)(struct _dyneither_ptr d,struct _dyneither_ptr s,unsigned long,unsigned))Cyc__memcpy)(q,(struct _dyneither_ptr)x->digits,(unsigned)x->ndigits / sizeof(*((unsigned char*)(x->digits).curr))+ (unsigned)((unsigned)x->ndigits % sizeof(*((unsigned char*)(x->digits).curr))== (unsigned)0?0: 1),sizeof(*((unsigned char*)(x->digits).curr)));
if(x->sign == - 1){
...
(unsigned)x?0:({struct _dyneither_ptr _tmpAF=({const char*_tmp4A="x";_tag_dyneither(_tmp4A,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmpAF,({const char*_tmp4B="ap.cyc";_tag_dyneither(_tmp4B,sizeof(char),7U);}),395U);});
(unsigned)y?0:({struct _dyneither_ptr _tmpB0=({const char*_tmp4C="y";_tag_dyneither(_tmp4C,sizeof(char),2U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned line))Cyc___assert_fail)(_tmpB0,({const char*_tmp4D="ap.cyc";_tag_dyneither(_tmp4D,sizeof(char),7U);}),396U);});
