...
struct _fat_ptr _tmp51B=({const char*_tmp17B="dereferences an alias-free-pointer from a non-unique path";_tag_fat(_tmp17B,sizeof(char),58U);});_tmp40C.f1=_tmp51B;});_tmp40C;});void*_tmp177[3U];_tmp177[0]=& _tmp178,_tmp177[1]=& _tmp179,_tmp177[2]=& _tmp17A;({unsigned _tmp51C=p->loc;Cyc_Warn_err2(_tmp51C,_tag_fat(_tmp177,sizeof(void*),3U));});});}}}}}}}
# 822 "tcpat.cyc"
