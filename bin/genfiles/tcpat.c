...
return;}
# 101
({void*_tmp3FF=(void*)({struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmp28=_cycalloc(sizeof(*_tmp28));_tmp28->tag=10,_tmp28->f1=2U,_tmp28->f2=(int)i;_tmp28;});p->r=_tmp3FF;});
return;}}}case 15:
# 104
