...
# 57
({struct Cyc_String_pa_PrintArg_struct _tmpA;_tmpA.tag=0;({struct _dyneither_ptr _tmp3E4=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(t));_tmpA.f1=_tmp3E4;});({void*_tmp8[1]={& _tmpA};({unsigned int _tmp3E6=p->loc;struct _dyneither_ptr _tmp3E5=({const char*_tmp9="pattern expects aggregate type instead of %s";_tag_dyneither(_tmp9,sizeof(char),45);});Cyc_Tcutil_terr(_tmp3E6,_tmp3E5,_tag_dyneither(_tmp8,sizeof(void*),1));});});});
goto _LLF;}_LLF:;}
# 61
...
{void*_tmp145=_tmp14C->r;void*_tmp146=_tmp145;struct Cyc_Absyn_Exp*_tmp14B;if(((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp146)->tag == 14){_LLB2: _tmp14B=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp146)->f1;_LLB3:
# 707
