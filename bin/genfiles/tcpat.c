...
_tmp14=({struct Cyc_List_List*_tmp16=_cycalloc(sizeof(*_tmp16));({struct Cyc_Absyn_Tvar*_tmp3E2=Cyc_Tcutil_new_tvar((void*)({struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*_tmp15=_cycalloc(sizeof(*_tmp15));_tmp15->tag=1U,_tmp15->f1=0;_tmp15;}));_tmp16->hd=_tmp3E2;}),_tmp16->tl=_tmp14;_tmp16;});}
({struct Cyc_List_List*_tmp3E3=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(*_tmp29,_tmp14);*_tmp29=_tmp3E3;});}}
# 84
return;};}}else{_LLB: _LLC:
# 97
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp23=_cycalloc(sizeof(*_tmp23));_tmp23->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp3E4=({const char*_tmp22="resolve_pat unknownAggr";_tag_dyneither(_tmp22,sizeof(char),24U);});_tmp23->f1=_tmp3E4;});_tmp23;}));}}case 17U: _LL5: _tmp2B=((struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp1)->f1;_LL6:
# 86
 Cyc_Tcexp_tcExp(te,0,_tmp2B);
if(!Cyc_Tcutil_is_const_exp(_tmp2B)){
({void*_tmp17=0U;({unsigned int _tmp3E6=p->loc;struct _dyneither_ptr _tmp3E5=({const char*_tmp18="non-constant expression in case pattern";_tag_dyneither(_tmp18,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp3E6,_tmp3E5,_tag_dyneither(_tmp17,sizeof(void*),0U));});});
p->r=(void*)& Cyc_Absyn_Wild_p_val;}{
# 91
...
({void*_tmp3E7=(void*)({struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmp1B=_cycalloc(sizeof(*_tmp1B));_tmp1B->tag=10U,_tmp1B->f1=Cyc_Absyn_None,_tmp1B->f2=(int)_tmp1D;_tmp1B;});p->r=_tmp3E7;});
return;};case 15U: _LL7: _LL8:
# 95
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp1F=_cycalloc(sizeof(*_tmp1F));_tmp1F->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp3E8=({const char*_tmp1E="resolve_pat UnknownId_p";_tag_dyneither(_tmp1E,sizeof(char),24U);});_tmp1F->f1=_tmp3E8;});_tmp1F;}));case 16U: _LL9: _LLA:
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp21=_cycalloc(sizeof(*_tmp21));_tmp21->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp3E9=({const char*_tmp20="resolve_pat UnknownCall_p";_tag_dyneither(_tmp20,sizeof(char),26U);});_tmp21->f1=_tmp3E9;});_tmp21;}));default: _LLD: _LLE:
# 99
 return;}_LL0:;}
# 103
...
if(vd != 0){
(*vd)->type=t;
({struct Cyc_Absyn_Tqual _tmp3EA=Cyc_Absyn_empty_tqual(0U);(*vd)->tq=_tmp3EA;});}
# 132
({struct Cyc_List_List*_tmp3EC=({struct Cyc_List_List*_tmp30=_cycalloc(sizeof(*_tmp30));({struct _tuple15*_tmp3EB=({struct _tuple15*_tmp2F=_cycalloc(sizeof(*_tmp2F));_tmp2F->f1=vd,_tmp2F->f2=e;_tmp2F;});_tmp30->hd=_tmp3EB;}),_tmp30->tl=*v_result_ptr;_tmp30;});*v_result_ptr=_tmp3EC;});}
# 134
...
return({struct Cyc_Tcpat_TcPatResult _tmp386;({struct _tuple1*_tmp3F0=({struct _tuple1*_tmp35=_cycalloc(sizeof(*_tmp35));({struct Cyc_List_List*_tmp3EF=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)((*_tmp39).f1,(*_tmp37).f1);_tmp35->f1=_tmp3EF;}),({
struct Cyc_List_List*_tmp3EE=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)((*_tmp39).f2,(*_tmp37).f2);_tmp35->f2=_tmp3EE;});_tmp35;});
# 143
_tmp386.tvars_and_bounds_opt=_tmp3F0;}),({
# 145
struct Cyc_List_List*_tmp3ED=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp38,_tmp36);_tmp386.patvars=_tmp3ED;});_tmp386;});}
# 147
return({struct Cyc_Tcpat_TcPatResult _tmp387;_tmp387.tvars_and_bounds_opt=0,({struct Cyc_List_List*_tmp3F1=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp38,_tmp36);_tmp387.patvars=_tmp3F1;});_tmp387;});};}
# 150
...
void*_tmp3F3=t;Cyc_Tcutil_promote_array(_tmp3F3,rgn_opt == 0?Cyc_Absyn_new_evar(& Cyc_Tcutil_rko,({struct Cyc_Core_Opt*_tmp3B=_cycalloc(sizeof(*_tmp3B));({struct Cyc_List_List*_tmp3F2=Cyc_Tcenv_lookup_type_vars(te);_tmp3B->v=_tmp3F2;});_tmp3B;})): rgn_opt,0);}): t;}struct _tuple16{struct Cyc_Absyn_Tvar*f1;int f2;};
# 162
...
t=*topt;else{
# 180
t=({struct Cyc_List_List*_tmp3F4=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tcpat_any_type(_tmp3F4,topt);});}
...
if(({struct _dyneither_ptr _tmp3F6=(struct _dyneither_ptr)_tmp4D;Cyc_strcmp(_tmp3F6,({const char*_tmp41="true";_tag_dyneither(_tmp41,sizeof(char),5U);}));})== 0  || ({struct _dyneither_ptr _tmp3F5=(struct _dyneither_ptr)_tmp4D;Cyc_strcmp(_tmp3F5,({const char*_tmp42="false";_tag_dyneither(_tmp42,sizeof(char),6U);}));})== 0)
({struct Cyc_String_pa_PrintArg_struct _tmp45=({struct Cyc_String_pa_PrintArg_struct _tmp388;_tmp388.tag=0U,_tmp388.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp4D);_tmp388;});void*_tmp43[1U];_tmp43[0]=& _tmp45;({unsigned int _tmp3F8=p->loc;struct _dyneither_ptr _tmp3F7=({const char*_tmp44="you probably do not want to use %s as a local variable";_tag_dyneither(_tmp44,sizeof(char),55U);});Cyc_Tcutil_warn(_tmp3F8,_tmp3F7,_tag_dyneither(_tmp43,sizeof(void*),1U));});});
...
({void*_tmp48=0U;({unsigned int _tmp3FA=p->loc;struct _dyneither_ptr _tmp3F9=({const char*_tmp49="array reference would point into unknown/unallowed region";_tag_dyneither(_tmp49,sizeof(char),58U);});Cyc_Tcutil_terr(_tmp3FA,_tmp3F9,_tag_dyneither(_tmp48,sizeof(void*),0U));});});
goto _LL30;}else{_LL33: _LL34:
# 197
 if(!Cyc_Tcutil_kind_leq(Cyc_Tcutil_type_kind(t),& Cyc_Tcutil_tmk))
({void*_tmp4A=0U;({unsigned int _tmp3FC=p->loc;struct _dyneither_ptr _tmp3FB=({const char*_tmp4B="pattern would point to an abstract member";_tag_dyneither(_tmp4B,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp3FC,_tmp3FB,_tag_dyneither(_tmp4A,sizeof(void*),0U));});});
goto _LL30;}_LL30:;}
# 201
({struct Cyc_Absyn_Vardecl**_tmp3FF=({struct Cyc_Absyn_Vardecl**_tmp4C=_cycalloc(sizeof(*_tmp4C));*_tmp4C=_tmpE0;_tmp4C;});struct Cyc_Absyn_Exp*_tmp3FE=access_exp;struct Cyc_List_List**_tmp3FD=& res.patvars;Cyc_Tcpat_set_vd(_tmp3FF,_tmp3FE,_tmp3FD,Cyc_Tcpat_pat_promote_array(te,t,rgn_pat));});
...
# 204
struct Cyc_Tcenv_Tenv*te2=({unsigned int _tmp401=p->loc;struct Cyc_Tcenv_Tenv*_tmp400=te;Cyc_Tcenv_add_type_vars(_tmp401,_tmp400,({struct Cyc_Absyn_Tvar*_tmp58[1U];_tmp58[0]=_tmpE2;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp58,sizeof(struct Cyc_Absyn_Tvar*),1U));}));});
if(res.tvars_and_bounds_opt == 0)
({struct _tuple1*_tmp402=({struct _tuple1*_tmp4E=_cycalloc(sizeof(*_tmp4E));_tmp4E->f1=0,_tmp4E->f2=0;_tmp4E;});res.tvars_and_bounds_opt=_tmp402;});
({struct Cyc_List_List*_tmp405=({
struct Cyc_List_List*_tmp404=(*res.tvars_and_bounds_opt).f1;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp404,({struct Cyc_List_List*_tmp50=_cycalloc(sizeof(*_tmp50));({struct _tuple16*_tmp403=({struct _tuple16*_tmp4F=_cycalloc(sizeof(*_tmp4F));_tmp4F->f1=_tmpE2,_tmp4F->f2=1;_tmp4F;});_tmp50->hd=_tmp403;}),_tmp50->tl=0;_tmp50;}));});
# 207
(*res.tvars_and_bounds_opt).f1=_tmp405;});
# 209
({unsigned int _tmp408=p->loc;struct Cyc_Tcenv_Tenv*_tmp407=te2;struct Cyc_List_List*_tmp406=Cyc_Tcenv_lookup_type_vars(te2);Cyc_Tcutil_check_type(_tmp408,_tmp407,_tmp406,& Cyc_Tcutil_tmk,1,0,_tmpE1->type);});
# 212
if(topt != 0)t=*topt;else{
t=({struct Cyc_List_List*_tmp409=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tcpat_any_type(_tmp409,topt);});}
...
# 216
 if(rgn_pat == 0  || !allow_ref_pat)
({void*_tmp53=0U;({unsigned int _tmp40B=p->loc;struct _dyneither_ptr _tmp40A=({const char*_tmp54="array reference would point into unknown/unallowed region";_tag_dyneither(_tmp54,sizeof(char),58U);});Cyc_Tcutil_terr(_tmp40B,_tmp40A,_tag_dyneither(_tmp53,sizeof(void*),0U));});});
goto _LL35;}else{_LL38: _LL39:
# 220
 if(!Cyc_Tcutil_kind_leq(Cyc_Tcutil_type_kind(t),& Cyc_Tcutil_tmk))
({void*_tmp55=0U;({unsigned int _tmp40D=p->loc;struct _dyneither_ptr _tmp40C=({const char*_tmp56="pattern would point to an abstract member";_tag_dyneither(_tmp56,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp40D,_tmp40C,_tag_dyneither(_tmp55,sizeof(void*),0U));});});
goto _LL35;}_LL35:;}
# 224
({struct Cyc_Absyn_Vardecl**_tmp410=({struct Cyc_Absyn_Vardecl**_tmp57=_cycalloc(sizeof(*_tmp57));*_tmp57=_tmpE1;_tmp57;});struct Cyc_Absyn_Exp*_tmp40F=access_exp;struct Cyc_List_List**_tmp40E=& res.patvars;Cyc_Tcpat_set_vd(_tmp410,_tmp40F,_tmp40E,_tmpE1->type);});
...
({void*_tmp59=0U;({unsigned int _tmp412=p->loc;struct _dyneither_ptr _tmp411=({const char*_tmp5A="* pattern would point into an unknown/unallowed region";_tag_dyneither(_tmp5A,sizeof(char),55U);});Cyc_Tcutil_terr(_tmp412,_tmp411,_tag_dyneither(_tmp59,sizeof(void*),0U));});});
goto _LL0;}else{
# 235
if(Cyc_Tcutil_is_noalias_pointer_or_aggr(t))
({void*_tmp5B=0U;({unsigned int _tmp414=p->loc;struct _dyneither_ptr _tmp413=({const char*_tmp5C="* pattern cannot take the address of an alias-free path";_tag_dyneither(_tmp5C,sizeof(char),56U);});Cyc_Tcutil_terr(_tmp414,_tmp413,_tag_dyneither(_tmp5B,sizeof(void*),0U));});});}{
# 238
struct Cyc_Absyn_Exp*new_access_exp=0;
void*t2=(void*)({struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp5E=_cycalloc(sizeof(*_tmp5E));_tmp5E->tag=3U,(_tmp5E->f1).elt_type=t,({struct Cyc_Absyn_Tqual _tmp417=Cyc_Absyn_empty_tqual(0U);(_tmp5E->f1).elt_tq=_tmp417;}),
((_tmp5E->f1).ptr_atts).rgn=rgn_pat,((_tmp5E->f1).ptr_atts).nullable=Cyc_Absyn_false_type,({
void*_tmp416=Cyc_Tcutil_any_bounds(& te);((_tmp5E->f1).ptr_atts).bounds=_tmp416;}),({void*_tmp415=Cyc_Tcutil_any_bool(& te);((_tmp5E->f1).ptr_atts).zero_term=_tmp415;}),((_tmp5E->f1).ptr_atts).ptrloc=0;_tmp5E;});
# 243
if((unsigned int)access_exp){
new_access_exp=Cyc_Absyn_address_exp(access_exp,0U);
new_access_exp->topt=t2;}
# 247
({struct Cyc_Absyn_Vardecl**_tmp41A=({struct Cyc_Absyn_Vardecl**_tmp5D=_cycalloc(sizeof(*_tmp5D));*_tmp5D=_tmpE4;_tmp5D;});struct Cyc_Absyn_Exp*_tmp419=new_access_exp;struct Cyc_List_List**_tmp418=& res.patvars;Cyc_Tcpat_set_vd(_tmp41A,_tmp419,_tmp418,t2);});
...
# 253
({struct Cyc_Absyn_Vardecl**_tmp41D=({struct Cyc_Absyn_Vardecl**_tmp5F=_cycalloc(sizeof(*_tmp5F));*_tmp5F=_tmpE5;_tmp5F;});struct Cyc_Absyn_Exp*_tmp41C=access_exp;struct Cyc_List_List**_tmp41B=& res.patvars;Cyc_Tcpat_set_vd(_tmp41D,_tmp41C,_tmp41B,_tmpE5->type);});
# 257
({unsigned int _tmp41F=p->loc;struct Cyc_Tcenv_Tenv*_tmp41E=te;Cyc_Tcenv_add_type_vars(_tmp41F,_tmp41E,({struct Cyc_Absyn_Tvar*_tmp60[1U];_tmp60[0]=_tmpE6;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp60,sizeof(struct Cyc_Absyn_Tvar*),1U));}));});
if(res.tvars_and_bounds_opt == 0)
({struct _tuple1*_tmp420=({struct _tuple1*_tmp61=_cycalloc(sizeof(*_tmp61));_tmp61->f1=0,_tmp61->f2=0;_tmp61;});res.tvars_and_bounds_opt=_tmp420;});
({struct Cyc_List_List*_tmp422=({struct Cyc_List_List*_tmp63=_cycalloc(sizeof(*_tmp63));
({struct _tuple16*_tmp421=({struct _tuple16*_tmp62=_cycalloc(sizeof(*_tmp62));_tmp62->f1=_tmpE6,_tmp62->f2=0;_tmp62;});_tmp63->hd=_tmp421;}),_tmp63->tl=(*res.tvars_and_bounds_opt).f1;_tmp63;});
# 260
(*res.tvars_and_bounds_opt).f1=_tmp422;});
# 262
...
# 265
 ...
 t=({void**_tmp423=topt;Cyc_Tcpat_num_type(_tmp423,Cyc_Absyn_gen_float_type((unsigned int)_tmpE7));});goto _LL0;case 13U: _LL15: _tmpE8=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp3E)->f1;_LL16:
# 271
 t=({void**_tmp424=topt;Cyc_Tcpat_num_type(_tmp424,Cyc_Absyn_enum_type(_tmpE8->name,_tmpE8));});
...
t=(void*)({struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp67=_cycalloc(sizeof(*_tmp67));_tmp67->tag=3U,({void*_tmp429=Cyc_Absyn_new_evar(& Cyc_Tcutil_ako,_tmp66);(_tmp67->f1).elt_type=_tmp429;}),({
struct Cyc_Absyn_Tqual _tmp428=Cyc_Absyn_empty_tqual(0U);(_tmp67->f1).elt_tq=_tmp428;}),
({void*_tmp427=Cyc_Absyn_new_evar(& Cyc_Tcutil_trko,_tmp66);((_tmp67->f1).ptr_atts).rgn=_tmp427;}),((_tmp67->f1).ptr_atts).nullable=Cyc_Absyn_true_type,({
# 285
void*_tmp426=Cyc_Tcutil_any_bounds(& te);((_tmp67->f1).ptr_atts).bounds=_tmp426;}),({void*_tmp425=Cyc_Tcutil_any_bool(& te);((_tmp67->f1).ptr_atts).zero_term=_tmp425;}),((_tmp67->f1).ptr_atts).ptrloc=0;_tmp67;});
...
struct Cyc_Absyn_Exp*new_access_exp=0;
if((unsigned int)access_exp)new_access_exp=Cyc_Absyn_deref_exp(access_exp,0U);
res=({struct Cyc_Tcpat_TcPatResult _tmp42A=res;Cyc_Tcpat_combine_results(_tmp42A,Cyc_Tcpat_tcPatRec(te,_tmpEA,_tmp68,ptr_rgn,1,new_access_exp));});
# 315
...
# 321
 ...
 goto _LL49;}_LL49:;}{
# 325
void*new_type=({union Cyc_Absyn_DatatypeInfo _tmp42B=Cyc_Absyn_KnownDatatype(({struct Cyc_Absyn_Datatypedecl**_tmp72=_cycalloc(sizeof(*_tmp72));*_tmp72=_tmp76;_tmp72;}));Cyc_Absyn_datatype_type(_tmp42B,_tmp74);});
# 327
...
elt_const?({struct Cyc_Absyn_Tqual _tmp42F=Cyc_Absyn_const_tqual(0U);(_tmp71->f1).elt_tq=_tmp42F;}):({
struct Cyc_Absyn_Tqual _tmp42E=Cyc_Absyn_empty_tqual(0U);(_tmp71->f1).elt_tq=_tmp42E;}),
((_tmp71->f1).ptr_atts).rgn=ptr_rgn,({void*_tmp42D=Cyc_Tcutil_any_bool(& te);((_tmp71->f1).ptr_atts).nullable=_tmp42D;}),({
void*_tmp42C=Cyc_Absyn_bounds_one();((_tmp71->f1).ptr_atts).bounds=_tmp42C;}),((_tmp71->f1).ptr_atts).zero_term=Cyc_Absyn_false_type,((_tmp71->f1).ptr_atts).ptrloc=0;_tmp71;});
# 334
...
elt_const?({struct Cyc_Absyn_Tqual _tmp434=Cyc_Absyn_const_tqual(0U);(_tmp73->f1).elt_tq=_tmp434;}):({
struct Cyc_Absyn_Tqual _tmp433=Cyc_Absyn_empty_tqual(0U);(_tmp73->f1).elt_tq=_tmp433;}),
((_tmp73->f1).ptr_atts).rgn=ptr_rgn,({void*_tmp432=Cyc_Tcutil_any_bool(& te);((_tmp73->f1).ptr_atts).nullable=_tmp432;}),({
void*_tmp431=Cyc_Tcutil_any_bounds(& te);((_tmp73->f1).ptr_atts).bounds=_tmp431;}),({void*_tmp430=Cyc_Tcutil_any_bool(& te);((_tmp73->f1).ptr_atts).zero_term=_tmp430;}),((_tmp73->f1).ptr_atts).ptrloc=0;_tmp73;});}_LL44:;}
# 343
...
wild_ps=({struct Cyc_List_List*_tmp7C=_cycalloc(sizeof(*_tmp7C));({struct Cyc_Absyn_Pat*_tmp435=Cyc_Tcpat_wild_pat(p->loc);_tmp7C->hd=_tmp435;}),_tmp7C->tl=wild_ps;_tmp7C;});}}
({struct Cyc_List_List*_tmp436=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp77,wild_ps);*_tmpEC=_tmp436;});
_tmp77=*_tmpEC;}else{
if(({int _tmp437=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp77);_tmp437 == ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp7F);}))
({void*_tmp7D=0U;({unsigned int _tmp439=p->loc;struct _dyneither_ptr _tmp438=({const char*_tmp7E="unnecessary ... in tuple pattern";_tag_dyneither(_tmp7E,sizeof(char),33U);});Cyc_Tcutil_warn(_tmp439,_tmp438,_tag_dyneither(_tmp7D,sizeof(void*),0U));});});}}
# 368
...
# 372
if(_tmpEB)
({void*_tmp80=0U;({unsigned int _tmp43B=p->loc;struct _dyneither_ptr _tmp43A=({const char*_tmp81="cannot determine missing fields for ... in tuple pattern";_tag_dyneither(_tmp81,sizeof(char),57U);});Cyc_Tcutil_terr(_tmp43B,_tmp43A,_tag_dyneither(_tmp80,sizeof(void*),0U));});});}
...
struct Cyc_Absyn_Exp*new_access_exp=0;
if((unsigned int)access_exp)
new_access_exp=({struct Cyc_Absyn_Exp*_tmp43C=access_exp;Cyc_Absyn_subscript_exp(_tmp43C,
...
# 385
res=({struct Cyc_Tcpat_TcPatResult _tmp43D=res;Cyc_Tcpat_combine_results(_tmp43D,Cyc_Tcpat_tcPatRec(te,(struct Cyc_Absyn_Pat*)_tmp77->hd,_tmp82,rgn_pat,allow_ref_pat,new_access_exp));});
# 388
if((unsigned int)new_access_exp)new_access_exp->topt=((struct Cyc_Absyn_Pat*)_tmp77->hd)->topt;
pat_ts=({struct Cyc_List_List*_tmp84=_cycalloc(sizeof(*_tmp84));({struct _tuple17*_tmp43F=({struct _tuple17*_tmp83=_cycalloc(sizeof(*_tmp83));({struct Cyc_Absyn_Tqual _tmp43E=Cyc_Absyn_empty_tqual(0U);_tmp83->f1=_tmp43E;}),_tmp83->f2=(void*)_check_null(((struct Cyc_Absyn_Pat*)_tmp77->hd)->topt);_tmp83;});_tmp84->hd=_tmp43F;}),_tmp84->tl=pat_ts;_tmp84;});};}}
# 391
t=(void*)({struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmp85=_cycalloc(sizeof(*_tmp85));_tmp85->tag=6U,({struct Cyc_List_List*_tmp440=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(pat_ts);_tmp85->f1=_tmp440;});_tmp85;});
...
struct _dyneither_ptr aggr_str=(int)_tmpF0->kind == (int)Cyc_Absyn_StructA?({const char*_tmpC5="struct";_tag_dyneither(_tmpC5,sizeof(char),7U);}):({const char*_tmpC6="union";_tag_dyneither(_tmpC6,sizeof(char),6U);});
if(_tmpF0->impl == 0){
({struct Cyc_String_pa_PrintArg_struct _tmp89=({struct Cyc_String_pa_PrintArg_struct _tmp38A;_tmp38A.tag=0U,_tmp38A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)aggr_str);_tmp38A;});void*_tmp87[1U];_tmp87[0]=& _tmp89;({unsigned int _tmp442=p->loc;struct _dyneither_ptr _tmp441=({const char*_tmp88="can't destructure an abstract %s";_tag_dyneither(_tmp88,sizeof(char),33U);});Cyc_Tcutil_terr(_tmp442,_tmp441,_tag_dyneither(_tmp87,sizeof(void*),1U));});});
...
({void*_tmp90=0U;({struct _dyneither_ptr _tmp443=({const char*_tmp91="unconstrained existential type variable in aggregate";_tag_dyneither(_tmp91,sizeof(char),53U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp443,_tag_dyneither(_tmp90,sizeof(void*),0U));});});}_LL53:;}
# 431
...
({struct Cyc_Core_Opt*_tmp444=({struct Cyc_Core_Opt*_tmp95=_cycalloc(sizeof(*_tmp95));_tmp95->v=_tmp8E;_tmp95;});*_tmp99=_tmp444;});goto _LL5A;}_LL5A:;}
# 440
if(error)
...
# 444
struct _dyneither_ptr _tmp445=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kindbound2string(_tmp8D));_tmp38C.f1=_tmp445;});_tmp38C;});struct Cyc_String_pa_PrintArg_struct _tmp9E=({struct Cyc_String_pa_PrintArg_struct _tmp38B;_tmp38B.tag=0U,({struct _dyneither_ptr _tmp446=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(k2));_tmp38B.f1=_tmp446;});_tmp38B;});void*_tmp9A[3U];_tmp9A[0]=& _tmp9C,_tmp9A[1]=& _tmp9D,_tmp9A[2]=& _tmp9E;({unsigned int _tmp448=p->loc;struct _dyneither_ptr _tmp447=({const char*_tmp9B="type variable %s has kind %s but must have at least kind %s";_tag_dyneither(_tmp9B,sizeof(char),60U);});Cyc_Tcutil_terr(_tmp448,_tmp447,_tag_dyneither(_tmp9A,sizeof(void*),3U));});});{
# 446
...
({struct _tuple0*_tmp449=({struct _tuple0*_tmpA0=_cycalloc(sizeof(*_tmpA0));_tmpA0->f1=Cyc_Absyn_empty_effect,_tmpA0->f2=vartype;_tmpA0;});_tmpA1->hd=_tmp449;}),_tmpA1->tl=outlives_constraints;_tmpA1;});else{
# 455
({void*_tmpA2=0U;({struct _dyneither_ptr _tmp44A=({const char*_tmpA3="opened existential had unique or top region kind";_tag_dyneither(_tmpA3,sizeof(char),49U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp44A,_tag_dyneither(_tmpA2,sizeof(void*),0U));});});}}};};}}
# 459
...
if(res.tvars_and_bounds_opt == 0)
({struct _tuple1*_tmp44B=({struct _tuple1*_tmpAC=_cycalloc(sizeof(*_tmpAC));_tmpAC->f1=0,_tmpAC->f2=0;_tmpAC;});res.tvars_and_bounds_opt=_tmp44B;});
({struct Cyc_List_List*_tmp44D=({
struct Cyc_List_List*_tmp44C=(*res.tvars_and_bounds_opt).f1;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp44C,((struct Cyc_List_List*(*)(struct _tuple16*(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_add_false,_tmpEF));});
# 474
(*res.tvars_and_bounds_opt).f1=_tmp44D;});
# 476
({struct Cyc_List_List*_tmp44E=
...
# 476
(*res.tvars_and_bounds_opt).f2=_tmp44E;});{
# 478
...
_tmpAD=({struct Cyc_List_List*_tmpB0=_cycalloc(sizeof(*_tmpB0));({struct _tuple0*_tmp451=({struct _tuple0*_tmpAF=_cycalloc(sizeof(*_tmpAF));({void*_tmp450=Cyc_Tcutil_rsubstitute(rgn,_tmpAB,(*((struct _tuple0*)_tmpAE->hd)).f1);_tmpAF->f1=_tmp450;}),({
void*_tmp44F=Cyc_Tcutil_rsubstitute(rgn,_tmpAB,(*((struct _tuple0*)_tmpAE->hd)).f2);_tmpAF->f2=_tmp44F;});_tmpAF;});
# 480
_tmpB0->hd=_tmp451;}),_tmpB0->tl=_tmpAD;_tmpB0;});}}
# 483
_tmpAD=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmpAD);
({struct Cyc_List_List*_tmp452=
((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)((*res.tvars_and_bounds_opt).f2,_tmpAD);
# 484
(*res.tvars_and_bounds_opt).f2=_tmp452;});};}
# 489
t=({union Cyc_Absyn_AggrInfo _tmp453=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmpB1=_cycalloc(sizeof(*_tmpB1));*_tmpB1=_tmpF0;_tmpB1;}));Cyc_Absyn_aggr_type(_tmp453,_tmpA9);});
if(_tmpED  && (int)_tmpF0->kind == (int)Cyc_Absyn_UnionA)
({void*_tmpB2=0U;({unsigned int _tmp455=p->loc;struct _dyneither_ptr _tmp454=({const char*_tmpB3="`...' pattern not allowed in union pattern";_tag_dyneither(_tmpB3,sizeof(char),43U);});Cyc_Tcutil_warn(_tmp455,_tmp454,_tag_dyneither(_tmpB2,sizeof(void*),0U));});});else{
if(_tmpED){
# 494
...
wild_dps=({struct Cyc_List_List*_tmpB7=_cycalloc(sizeof(*_tmpB7));({struct _tuple18*_tmp457=({struct _tuple18*_tmpB6=_cycalloc(sizeof(*_tmpB6));_tmpB6->f1=0,({struct Cyc_Absyn_Pat*_tmp456=Cyc_Tcpat_wild_pat(p->loc);_tmpB6->f2=_tmp456;});_tmpB6;});_tmpB7->hd=_tmp457;}),_tmpB7->tl=wild_dps;_tmpB7;});}}
({struct Cyc_List_List*_tmp458=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp86,wild_dps);*_tmpEE=_tmp458;});
_tmp86=*_tmpEE;}else{
if(_tmpB4 == _tmpB5)
({void*_tmpB8=0U;({unsigned int _tmp45A=p->loc;struct _dyneither_ptr _tmp459=({const char*_tmpB9="unnecessary ... in struct pattern";_tag_dyneither(_tmpB9,sizeof(char),34U);});Cyc_Tcutil_warn(_tmp45A,_tmp459,_tag_dyneither(_tmpB8,sizeof(void*),0U));});});}}}{
# 505
...
res=({struct Cyc_Tcpat_TcPatResult _tmp45B=res;Cyc_Tcpat_combine_results(_tmp45B,Cyc_Tcpat_tcPatRec(te2,_tmpC3,& _tmpBC,rgn_pat,allow_ref_pat,new_access_exp));});
# 519
...
struct _dyneither_ptr _tmp45C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmpBC));_tmp38F.f1=_tmp45C;});_tmp38F;});struct Cyc_String_pa_PrintArg_struct _tmpC2=({struct Cyc_String_pa_PrintArg_struct _tmp38E;_tmp38E.tag=0U,({
struct _dyneither_ptr _tmp45D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmpC3->topt)));_tmp38E.f1=_tmp45D;});_tmp38E;});void*_tmpBD[4U];_tmpBD[0]=& _tmpBF,_tmpBD[1]=& _tmpC0,_tmpBD[2]=& _tmpC1,_tmpBD[3]=& _tmpC2;({unsigned int _tmp45F=p->loc;struct _dyneither_ptr _tmp45E=({const char*_tmpBE="field %s of %s pattern expects type %s != %s";_tag_dyneither(_tmpBE,sizeof(char),45U);});Cyc_Tcutil_terr(_tmp45F,_tmp45E,_tag_dyneither(_tmpBD,sizeof(void*),4U));});});
...
t=({union Cyc_Absyn_DatatypeFieldInfo _tmp460=Cyc_Absyn_KnownDatatypefield(_tmpF4,_tmpF3);Cyc_Absyn_datatype_field_type(_tmp460,_tmpCB);});
if(_tmpF1){
# 539
...
wild_ps=({struct Cyc_List_List*_tmpCE=_cycalloc(sizeof(*_tmpCE));({struct Cyc_Absyn_Pat*_tmp461=Cyc_Tcpat_wild_pat(p->loc);_tmpCE->hd=_tmp461;}),_tmpCE->tl=wild_ps;_tmpCE;});}}
({struct Cyc_List_List*_tmp462=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmpC7,wild_ps);*_tmpF2=_tmp462;});
_tmpC7=*_tmpF2;}else{
if(_tmpCC == _tmpCD)
({struct Cyc_String_pa_PrintArg_struct _tmpD1=({struct Cyc_String_pa_PrintArg_struct _tmp393;_tmp393.tag=0U,({
struct _dyneither_ptr _tmp463=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpF4->name));_tmp393.f1=_tmp463;});_tmp393;});void*_tmpCF[1U];_tmpCF[0]=& _tmpD1;({unsigned int _tmp465=p->loc;struct _dyneither_ptr _tmp464=({const char*_tmpD0="unnecessary ... in datatype field %s";_tag_dyneither(_tmpD0,sizeof(char),37U);});Cyc_Tcutil_warn(_tmp465,_tmp464,_tag_dyneither(_tmpCF,sizeof(void*),1U));});});}}
# 551
...
res=({struct Cyc_Tcpat_TcPatResult _tmp466=res;Cyc_Tcpat_combine_results(_tmp466,Cyc_Tcpat_tcPatRec(te,_tmpD2,& _tmpD3,rgn_pat,allow_ref_pat,0));});
# 565
...
struct _dyneither_ptr _tmp467=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpF3->name));_tmp396.f1=_tmp467;});_tmp396;});struct Cyc_String_pa_PrintArg_struct _tmpD7=({struct Cyc_String_pa_PrintArg_struct _tmp395;_tmp395.tag=0U,({struct _dyneither_ptr _tmp468=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmpD3));_tmp395.f1=_tmp468;});_tmp395;});struct Cyc_String_pa_PrintArg_struct _tmpD8=({struct Cyc_String_pa_PrintArg_struct _tmp394;_tmp394.tag=0U,({
struct _dyneither_ptr _tmp469=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmpD2->topt)));_tmp394.f1=_tmp469;});_tmp394;});void*_tmpD4[3U];_tmpD4[0]=& _tmpD6,_tmpD4[1]=& _tmpD7,_tmpD4[2]=& _tmpD8;({unsigned int _tmp46B=_tmpD2->loc;struct _dyneither_ptr _tmp46A=({const char*_tmpD5="%s expects argument type %s, not %s";_tag_dyneither(_tmpD5,sizeof(char),36U);});Cyc_Tcutil_terr(_tmp46B,_tmp46A,_tag_dyneither(_tmpD4,sizeof(void*),3U));});});}
# 570
if(_tmpC7 != 0)
({struct Cyc_String_pa_PrintArg_struct _tmpDB=({struct Cyc_String_pa_PrintArg_struct _tmp397;_tmp397.tag=0U,({
struct _dyneither_ptr _tmp46C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpF3->name));_tmp397.f1=_tmp46C;});_tmp397;});void*_tmpD9[1U];_tmpD9[0]=& _tmpDB;({unsigned int _tmp46E=p->loc;struct _dyneither_ptr _tmp46D=({const char*_tmpDA="too many arguments for datatype constructor %s";_tag_dyneither(_tmpDA,sizeof(char),47U);});Cyc_Tcutil_terr(_tmp46E,_tmp46D,_tag_dyneither(_tmpD9,sizeof(void*),1U));});});
if(tqts != 0)
({struct Cyc_String_pa_PrintArg_struct _tmpDE=({struct Cyc_String_pa_PrintArg_struct _tmp398;_tmp398.tag=0U,({
struct _dyneither_ptr _tmp46F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpF3->name));_tmp398.f1=_tmp46F;});_tmp398;});void*_tmpDC[1U];_tmpDC[0]=& _tmpDE;({unsigned int _tmp471=p->loc;struct _dyneither_ptr _tmp470=({const char*_tmpDD="too few arguments for datatype constructor %s";_tag_dyneither(_tmpDD,sizeof(char),46U);});Cyc_Tcutil_terr(_tmp471,_tmp470,_tag_dyneither(_tmpDC,sizeof(void*),1U));});});
...
({struct Cyc_List_List*_tmp473=((struct Cyc_List_List*(*)(struct _dyneither_ptr*(*f)(struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_get_name,_tmpF8);unsigned int _tmp472=p->loc;Cyc_Tcutil_check_unique_vars(_tmp473,_tmp472,({const char*_tmpFA="pattern contains a repeated variable";_tag_dyneither(_tmpFA,sizeof(char),37U);}));});
# 603
...
({struct Cyc_Absyn_Exp*_tmp474=Cyc_Tcutil_deep_copy_exp(1,(struct Cyc_Absyn_Exp*)_check_null(*_tmpFD));*_tmpFD=_tmp474;});}}
# 608
return _tmpF5;};}
# 614
...
# 637
struct Cyc_List_List*assump=({struct Cyc_List_List*_tmp112=_cycalloc(sizeof(*_tmp112));({struct _tuple0*_tmp478=({struct _tuple0*_tmp111=_cycalloc(sizeof(*_tmp111));_tmp111->f1=Cyc_Absyn_unique_rgn_type,({void*_tmp477=(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp110=_cycalloc(sizeof(*_tmp110));_tmp110->tag=2U,_tmp110->f1=tv;_tmp110;});_tmp111->f2=_tmp477;});_tmp111;});_tmp112->hd=_tmp478;}),_tmp112->tl=0;_tmp112;});
if(Cyc_Tcutil_subtype(tenv,assump,old_type,new_type)){
# 655 "tcpat.cyc"
struct _tuple0 _tmp106=({struct _tuple0 _tmp39C;({void*_tmp47A=Cyc_Tcutil_compress(old_type);_tmp39C.f1=_tmp47A;}),({void*_tmp479=Cyc_Tcutil_compress(new_type);_tmp39C.f2=_tmp479;});_tmp39C;});struct _tuple0 _tmp107=_tmp106;struct Cyc_Absyn_PtrInfo _tmp10B;struct Cyc_Absyn_PtrInfo _tmp10A;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp107.f1)->tag == 3U){if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp107.f2)->tag == 3U){_LL1: _tmp10B=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp107.f1)->f1;_tmp10A=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp107.f2)->f1;_LL2:
 goto _LL0;}else{goto _LL3;}}else{_LL3: _LL4:
({void*_tmp108=0U;({unsigned int _tmp47C=loc;struct _dyneither_ptr _tmp47B=({const char*_tmp109="alias requires pointer type";_tag_dyneither(_tmp109,sizeof(char),28U);});Cyc_Tcutil_terr(_tmp47C,_tmp47B,_tag_dyneither(_tmp108,sizeof(void*),0U));});});goto _LL0;}_LL0:;}else{
# 660
({struct Cyc_String_pa_PrintArg_struct _tmp10E=({struct Cyc_String_pa_PrintArg_struct _tmp39E;_tmp39E.tag=0U,({
struct _dyneither_ptr _tmp47D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(old_type));_tmp39E.f1=_tmp47D;});_tmp39E;});struct Cyc_String_pa_PrintArg_struct _tmp10F=({struct Cyc_String_pa_PrintArg_struct _tmp39D;_tmp39D.tag=0U,({struct _dyneither_ptr _tmp47E=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(new_type));_tmp39D.f1=_tmp47E;});_tmp39D;});void*_tmp10C[2U];_tmp10C[0]=& _tmp10E,_tmp10C[1]=& _tmp10F;({unsigned int _tmp480=loc;struct _dyneither_ptr _tmp47F=({const char*_tmp10D="cannot alias value of type %s to type %s";_tag_dyneither(_tmp10D,sizeof(char),41U);});Cyc_Tcutil_terr(_tmp480,_tmp47F,_tag_dyneither(_tmp10C,sizeof(void*),2U));});});}}
# 667
...
({struct Cyc_Tcenv_Tenv*_tmp483=te;struct Cyc_Absyn_Pat*_tmp482=_tmp131;int _tmp481=Cyc_Tcutil_is_noalias_region(_tmp119,0);Cyc_Tcpat_check_pat_regions_rec(_tmp483,_tmp482,_tmp481,patvars);});
return;}else{_LL14: _LL15:
({void*_tmp117=0U;({struct _dyneither_ptr _tmp484=({const char*_tmp118="check_pat_regions: bad pointer type";_tag_dyneither(_tmp118,sizeof(char),36U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp484,_tag_dyneither(_tmp117,sizeof(void*),0U));});});}_LL11:;}case 7U: _LL3: _tmp134=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp114)->f1;_tmp133=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp114)->f2;_tmp132=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp114)->f3;_LL4:
# 681
...
({void*_tmp11E=0U;({unsigned int _tmp486=p->loc;struct _dyneither_ptr _tmp485=({const char*_tmp11F="reference pattern not allowed on alias-free pointers";_tag_dyneither(_tmp11F,sizeof(char),53U);});Cyc_Tcutil_terr(_tmp486,_tmp485,_tag_dyneither(_tmp11E,sizeof(void*),0U));});});
goto _LL19;}else{_LL1C: _LL1D:
# 704
({void*_tmp120=0U;({struct _dyneither_ptr _tmp487=({const char*_tmp121="check_pat_regions: bad reference access expression";_tag_dyneither(_tmp121,sizeof(char),51U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp487,_tag_dyneither(_tmp120,sizeof(void*),0U));});});}_LL19:;}
# 706
break;}}}
# 709
...
({void*_tmp127=0U;({unsigned int _tmp489=p->loc;struct _dyneither_ptr _tmp488=({const char*_tmp128="pattern to array would create alias of no-alias pointer";_tag_dyneither(_tmp128,sizeof(char),56U);});Cyc_Tcutil_terr(_tmp489,_tmp488,_tag_dyneither(_tmp127,sizeof(void*),0U));});});
return;}
# 718
...
if(_tmp12F == 0)
({void*_tmp12B=0U;({unsigned int _tmp48B=p->loc;struct _dyneither_ptr _tmp48A=({const char*_tmp12C="cannot alias pattern expression in datatype";_tag_dyneither(_tmp12C,sizeof(char),44U);});Cyc_Tcutil_terr(_tmp48B,_tmp48A,_tag_dyneither(_tmp12B,sizeof(void*),0U));});});else{
# 732
struct Cyc_Tcenv_Tenv*te2=({unsigned int _tmp48D=p->loc;struct Cyc_Tcenv_Tenv*_tmp48C=te;Cyc_Tcenv_add_type_vars(_tmp48D,_tmp48C,({struct Cyc_Absyn_Tvar*_tmp12E[1U];_tmp12E[0]=_tmp13C;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp12E,sizeof(struct Cyc_Absyn_Tvar*),1U));}));});
te2=({struct Cyc_Tcenv_Tenv*_tmp48E=te2;Cyc_Tcenv_add_region(_tmp48E,(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp12D=_cycalloc(sizeof(*_tmp12D));_tmp12D->tag=2U,_tmp12D->f1=_tmp13C;_tmp12D;}),0);});
# 735
...
# 770
struct _dyneither_ptr _tmp491=(struct _dyneither_ptr)(_tmp148 != 0?(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp145=({struct Cyc_String_pa_PrintArg_struct _tmp3A0;_tmp3A0.tag=0U,({
# 772
struct _dyneither_ptr _tmp48F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string((*_tmp148)->name));_tmp3A0.f1=_tmp48F;});_tmp3A0;});void*_tmp143[1U];_tmp143[0]=& _tmp145;({struct _dyneither_ptr _tmp490=({const char*_tmp144="for variable %s";_tag_dyneither(_tmp144,sizeof(char),16U);});Cyc_aprintf(_tmp490,_tag_dyneither(_tmp143,sizeof(void*),1U));});}):({const char*_tmp146="";_tag_dyneither(_tmp146,sizeof(char),1U);}));
# 770
_tmp39F.f1=_tmp491;});_tmp39F;});void*_tmp140[1U];_tmp140[0]=& _tmp142;({unsigned int _tmp493=p->loc;struct _dyneither_ptr _tmp492=({const char*_tmp141="pattern %s dereferences a alias-free pointer from a non-unique path";_tag_dyneither(_tmp141,sizeof(char),68U);});Cyc_Tcutil_terr(_tmp493,_tmp492,_tag_dyneither(_tmp140,sizeof(void*),1U));});});}}};}
# 826 "tcpat.cyc"
...
struct Cyc_Tcpat_Deref_Tcpat_Access_struct Cyc_Tcpat_Deref_val={1U};struct _union_Name_value_Name_v{int tag;struct _dyneither_ptr val;};struct _union_Name_value_Int_v{int tag;int val;};union Cyc_Tcpat_Name_value{struct _union_Name_value_Name_v Name_v;struct _union_Name_value_Int_v Int_v;};
# 850
...
++ i;}}
# 908
({void*_tmp156=0U;({struct _dyneither_ptr _tmp495=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp159=({struct Cyc_String_pa_PrintArg_struct _tmp3A3;_tmp3A3.tag=0U,_tmp3A3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp3A3;});void*_tmp157[1U];_tmp157[0]=& _tmp159;({struct _dyneither_ptr _tmp494=({const char*_tmp158="get_member_offset %s failed";_tag_dyneither(_tmp158,sizeof(char),28U);});Cyc_aprintf(_tmp494,_tag_dyneither(_tmp157,sizeof(void*),1U));});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp495,_tag_dyneither(_tmp156,sizeof(void*),0U));});});}
# 911
...
goto _LL1E;}else{_LL21: _LL22:
 goto _LL1E;}_LL1E:;}
# 932
({void*_tmp166=0U;({struct _dyneither_ptr _tmp496=({const char*_tmp167="non-null pointer type or non-pointer type in pointer pattern";_tag_dyneither(_tmp167,sizeof(char),61U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp496,_tag_dyneither(_tmp166,sizeof(void*),0U));});});case 8U: _LL18: _tmp185=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp15D)->f1;_tmp184=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp15D)->f2;_LL19:
# 934
...
# 937
return(void*)({struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*_tmp169=_cycalloc(sizeof(*_tmp169));_tmp169->tag=7U,({int _tmp497=(int)Cyc_Tcpat_datatype_tag_number(_tmp185,_tmp184->name);_tmp169->f1=_tmp497;}),_tmp169->f2=_tmp185,_tmp169->f3=_tmp184;_tmp169;});}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp15D)->f1 != 0){_LL1A: _tmp187=*((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp15D)->f1;_tmp186=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp15D)->f3;_LL1B: {
# 939
...
({void*_tmp16F=0U;({struct _dyneither_ptr _tmp498=({const char*_tmp170="no field name in tagged union pattern";_tag_dyneither(_tmp170,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp498,_tag_dyneither(_tmp16F,sizeof(void*),0U));});});}_LL26:;}
# 947
return(void*)({struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*_tmp172=_cycalloc(sizeof(*_tmp172));_tmp172->tag=8U,_tmp172->f1=f,({int _tmp499=Cyc_Tcpat_get_member_offset(_tmp16A,f);_tmp172->f2=_tmp499;});_tmp172;});};}else{
# 949
({void*_tmp175=0U;({struct _dyneither_ptr _tmp49A=({const char*_tmp176="non-tagged aggregate in pattern test";_tag_dyneither(_tmp176,sizeof(char),37U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp49A,_tag_dyneither(_tmp175,sizeof(void*),0U));});});}}}else{goto _LL1C;}default: _LL1C: _LL1D:
({void*_tmp177=0U;({struct _dyneither_ptr _tmp49B=({const char*_tmp178="non-test pattern in pattern test";_tag_dyneither(_tmp178,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp49B,_tag_dyneither(_tmp177,sizeof(void*),0U));});});}_LL5:;}}_LL0:;}
# 955
...
return({struct Cyc_Tcpat_Con_s*_tmp18B=_cycalloc(sizeof(*_tmp18B));({union Cyc_Tcpat_Name_value _tmp49D=Cyc_Tcpat_Name_v(({const char*_tmp18A="NULL";_tag_dyneither(_tmp18A,sizeof(char),5U);}));_tmp18B->name=_tmp49D;}),_tmp18B->arity=0,_tmp18B->span=& Cyc_Tcpat_two_opt,({union Cyc_Tcpat_PatOrWhere _tmp49C=Cyc_Tcpat_pw(p);_tmp18B->orig_pat=_tmp49C;});_tmp18B;});}
# 962
static struct Cyc_Tcpat_Con_s*Cyc_Tcpat_null_ptr_con(struct Cyc_Absyn_Pat*p){
return({struct Cyc_Tcpat_Con_s*_tmp18D=_cycalloc(sizeof(*_tmp18D));({union Cyc_Tcpat_Name_value _tmp49F=Cyc_Tcpat_Name_v(({const char*_tmp18C="&";_tag_dyneither(_tmp18C,sizeof(char),2U);}));_tmp18D->name=_tmp49F;}),_tmp18D->arity=1,_tmp18D->span=& Cyc_Tcpat_two_opt,({union Cyc_Tcpat_PatOrWhere _tmp49E=Cyc_Tcpat_pw(p);_tmp18D->orig_pat=_tmp49E;});_tmp18D;});}
# 965
static struct Cyc_Tcpat_Con_s*Cyc_Tcpat_ptr_con(struct Cyc_Absyn_Pat*p){
return({struct Cyc_Tcpat_Con_s*_tmp18F=_cycalloc(sizeof(*_tmp18F));({union Cyc_Tcpat_Name_value _tmp4A1=Cyc_Tcpat_Name_v(({const char*_tmp18E="&";_tag_dyneither(_tmp18E,sizeof(char),2U);}));_tmp18F->name=_tmp4A1;}),_tmp18F->arity=1,_tmp18F->span=& Cyc_Tcpat_one_opt,({union Cyc_Tcpat_PatOrWhere _tmp4A0=Cyc_Tcpat_pw(p);_tmp18F->orig_pat=_tmp4A0;});_tmp18F;});}
# 968
static struct Cyc_Tcpat_Con_s*Cyc_Tcpat_int_con(int i,union Cyc_Tcpat_PatOrWhere p){
return({struct Cyc_Tcpat_Con_s*_tmp190=_cycalloc(sizeof(*_tmp190));({union Cyc_Tcpat_Name_value _tmp4A2=Cyc_Tcpat_Int_v(i);_tmp190->name=_tmp4A2;}),_tmp190->arity=0,_tmp190->span=0,_tmp190->orig_pat=p;_tmp190;});}
# 971
static struct Cyc_Tcpat_Con_s*Cyc_Tcpat_float_con(struct _dyneither_ptr f,struct Cyc_Absyn_Pat*p){
return({struct Cyc_Tcpat_Con_s*_tmp191=_cycalloc(sizeof(*_tmp191));({union Cyc_Tcpat_Name_value _tmp4A4=Cyc_Tcpat_Name_v(f);_tmp191->name=_tmp4A4;}),_tmp191->arity=0,_tmp191->span=0,({union Cyc_Tcpat_PatOrWhere _tmp4A3=Cyc_Tcpat_pw(p);_tmp191->orig_pat=_tmp4A3;});_tmp191;});}
# 974
static struct Cyc_Tcpat_Con_s*Cyc_Tcpat_char_con(char c,struct Cyc_Absyn_Pat*p){
return({struct Cyc_Tcpat_Con_s*_tmp192=_cycalloc(sizeof(*_tmp192));({union Cyc_Tcpat_Name_value _tmp4A6=Cyc_Tcpat_Int_v((int)c);_tmp192->name=_tmp4A6;}),_tmp192->arity=0,_tmp192->span=& Cyc_Tcpat_twofiftysix_opt,({union Cyc_Tcpat_PatOrWhere _tmp4A5=Cyc_Tcpat_pw(p);_tmp192->orig_pat=_tmp4A5;});_tmp192;});}
# 977
static struct Cyc_Tcpat_Con_s*Cyc_Tcpat_tuple_con(int i,union Cyc_Tcpat_PatOrWhere p){
return({struct Cyc_Tcpat_Con_s*_tmp194=_cycalloc(sizeof(*_tmp194));({union Cyc_Tcpat_Name_value _tmp4A7=Cyc_Tcpat_Name_v(({const char*_tmp193="$";_tag_dyneither(_tmp193,sizeof(char),2U);}));_tmp194->name=_tmp4A7;}),_tmp194->arity=i,_tmp194->span=& Cyc_Tcpat_one_opt,_tmp194->orig_pat=p;_tmp194;});}
# 982
static void*Cyc_Tcpat_null_pat(struct Cyc_Absyn_Pat*p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp195=_cycalloc(sizeof(*_tmp195));_tmp195->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp4A8=Cyc_Tcpat_null_con(p);_tmp195->f1=_tmp4A8;}),_tmp195->f2=0;_tmp195;});}
# 985
static void*Cyc_Tcpat_int_pat(int i,union Cyc_Tcpat_PatOrWhere p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp196=_cycalloc(sizeof(*_tmp196));_tmp196->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp4A9=Cyc_Tcpat_int_con(i,p);_tmp196->f1=_tmp4A9;}),_tmp196->f2=0;_tmp196;});}
# 988
static void*Cyc_Tcpat_char_pat(char c,struct Cyc_Absyn_Pat*p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp197=_cycalloc(sizeof(*_tmp197));_tmp197->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp4AA=Cyc_Tcpat_char_con(c,p);_tmp197->f1=_tmp4AA;}),_tmp197->f2=0;_tmp197;});}
# 991
static void*Cyc_Tcpat_float_pat(struct _dyneither_ptr f,struct Cyc_Absyn_Pat*p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp198=_cycalloc(sizeof(*_tmp198));_tmp198->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp4AB=Cyc_Tcpat_float_con(f,p);_tmp198->f1=_tmp4AB;}),_tmp198->f2=0;_tmp198;});}
# 994
static void*Cyc_Tcpat_null_ptr_pat(void*p,struct Cyc_Absyn_Pat*p0){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp19A=_cycalloc(sizeof(*_tmp19A));_tmp19A->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp4AD=Cyc_Tcpat_null_ptr_con(p0);_tmp19A->f1=_tmp4AD;}),({struct Cyc_List_List*_tmp4AC=({struct Cyc_List_List*_tmp199=_cycalloc(sizeof(*_tmp199));_tmp199->hd=p,_tmp199->tl=0;_tmp199;});_tmp19A->f2=_tmp4AC;});_tmp19A;});}
# 997
static void*Cyc_Tcpat_ptr_pat(void*p,struct Cyc_Absyn_Pat*p0){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp19C=_cycalloc(sizeof(*_tmp19C));_tmp19C->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp4AF=Cyc_Tcpat_ptr_con(p0);_tmp19C->f1=_tmp4AF;}),({struct Cyc_List_List*_tmp4AE=({struct Cyc_List_List*_tmp19B=_cycalloc(sizeof(*_tmp19B));_tmp19B->hd=p,_tmp19B->tl=0;_tmp19B;});_tmp19C->f2=_tmp4AE;});_tmp19C;});}
# 1000
static void*Cyc_Tcpat_tuple_pat(struct Cyc_List_List*ss,union Cyc_Tcpat_PatOrWhere p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp19D=_cycalloc(sizeof(*_tmp19D));_tmp19D->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp4B1=({int _tmp4B0=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ss);Cyc_Tcpat_tuple_con(_tmp4B0,p);});_tmp19D->f1=_tmp4B1;}),_tmp19D->f2=ss;_tmp19D;});}
# 1003
static void*Cyc_Tcpat_con_pat(struct _dyneither_ptr con_name,int*span,struct Cyc_List_List*ps,struct Cyc_Absyn_Pat*p){
# 1005
struct Cyc_Tcpat_Con_s*c=({struct Cyc_Tcpat_Con_s*_tmp19F=_cycalloc(sizeof(*_tmp19F));({union Cyc_Tcpat_Name_value _tmp4B4=Cyc_Tcpat_Name_v(con_name);_tmp19F->name=_tmp4B4;}),({int _tmp4B3=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ps);_tmp19F->arity=_tmp4B3;}),_tmp19F->span=span,({union Cyc_Tcpat_PatOrWhere _tmp4B2=Cyc_Tcpat_pw(p);_tmp19F->orig_pat=_tmp4B2;});_tmp19F;});
...
{void*_tmp1A0=p->r;void*_tmp1A1=_tmp1A0;void*_tmp1DE;struct Cyc_Absyn_Enumfield*_tmp1DD;struct Cyc_Absyn_Enumdecl*_tmp1DC;struct Cyc_Absyn_Enumfield*_tmp1DB;struct Cyc_Absyn_Aggrdecl*_tmp1DA;struct Cyc_List_List*_tmp1D9;struct Cyc_List_List*_tmp1D8;struct Cyc_Absyn_Datatypedecl*_tmp1D7;struct Cyc_Absyn_Datatypefield*_tmp1D6;struct Cyc_List_List*_tmp1D5;struct Cyc_Absyn_Pat*_tmp1D4;struct Cyc_Absyn_Pat*_tmp1D3;struct Cyc_Absyn_Pat*_tmp1D2;struct _dyneither_ptr _tmp1D1;char _tmp1D0;enum Cyc_Absyn_Sign _tmp1CF;int _tmp1CE;switch(*((int*)_tmp1A1)){case 0U: _LL1: _LL2:
 ...
 s=Cyc_Tcpat_null_pat(p);goto _LL0;case 10U: _LL9: _tmp1CF=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1A1)->f1;_tmp1CE=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1A1)->f2;_LLA:
 s=({int _tmp4B5=_tmp1CE;Cyc_Tcpat_int_pat(_tmp4B5,Cyc_Tcpat_pw(p));});goto _LL0;case 11U: _LLB: _tmp1D0=((struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp1A1)->f1;_LLC:
 s=Cyc_Tcpat_char_pat(_tmp1D0,p);goto _LL0;case 12U: _LLD: _tmp1D1=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp1A1)->f1;_LLE:
 s=Cyc_Tcpat_float_pat(_tmp1D1,p);goto _LL0;case 1U: _LLF: _tmp1D2=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp1A1)->f2;_LL10:
 s=Cyc_Tcpat_compile_pat(_tmp1D2);goto _LL0;case 3U: _LL11: _tmp1D3=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1A1)->f2;_LL12:
 s=Cyc_Tcpat_compile_pat(_tmp1D3);goto _LL0;case 6U: _LL13: _tmp1D4=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp1A1)->f1;_LL14:
# 1023
...
({void*_tmp1A5=0U;({struct _dyneither_ptr _tmp4B6=({const char*_tmp1A6="expecting pointertype for pattern!";_tag_dyneither(_tmp1A6,sizeof(char),35U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4B6,_tag_dyneither(_tmp1A5,sizeof(void*),0U));});});}_LL27:;}
# 1034
...
span=0;else{
# 1042
span=({int*_tmp1AA=_cycalloc_atomic(sizeof(*_tmp1AA));({int _tmp4B7=((int(*)(struct Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp1D7->fields))->v);*_tmp1AA=_tmp4B7;});_tmp1AA;});}
goto _LL2C;case 19U: _LL2F: _LL30:
 span=& Cyc_Tcpat_one_opt;goto _LL2C;default: goto _LL31;}else{_LL31: _LL32:
 span=({void*_tmp1AB=0U;({struct _dyneither_ptr _tmp4B8=({const char*_tmp1AC="void datatype pattern has bad type";_tag_dyneither(_tmp1AC,sizeof(char),35U);});((int*(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4B8,_tag_dyneither(_tmp1AB,sizeof(void*),0U));});});goto _LL2C;}_LL2C:;}
# 1047
s=({struct _dyneither_ptr _tmp4BB=*(*_tmp1D6->name).f2;int*_tmp4BA=span;struct Cyc_List_List*_tmp4B9=((struct Cyc_List_List*(*)(void*(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_compile_pat,_tmp1D5);Cyc_Tcpat_con_pat(_tmp4BB,_tmp4BA,_tmp4B9,p);});
goto _LL0;}case 5U: _LL17: _tmp1D8=((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp1A1)->f1;_LL18:
# 1051
 s=({struct Cyc_List_List*_tmp4BC=((struct Cyc_List_List*(*)(void*(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_compile_pat,_tmp1D8);Cyc_Tcpat_tuple_pat(_tmp4BC,Cyc_Tcpat_pw(p));});goto _LL0;case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1A1)->f1 != 0){if((((union Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1A1)->f1)->KnownAggr).tag == 2){_LL19: _tmp1DA=*((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1A1)->f1)->KnownAggr).val;_tmp1D9=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1A1)->f3;_LL1A:
# 1056
 if((int)_tmp1DA->kind == (int)Cyc_Absyn_StructA){
...
# 1060
int found=({struct _dyneither_ptr _tmp4BD=(struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)fields->hd)->name;Cyc_strcmp(_tmp4BD,({const char*_tmp1B8="";_tag_dyneither(_tmp1B8,sizeof(char),1U);}));})== 0;
...
ps=({struct Cyc_List_List*_tmp1B0=_cycalloc(sizeof(*_tmp1B0));({void*_tmp4BE=Cyc_Tcpat_compile_pat(_tmp1B4);_tmp1B0->hd=_tmp4BE;}),_tmp1B0->tl=ps;_tmp1B0;});
found=1;}
# 1069
goto _LL36;}else{goto _LL39;}}else{goto _LL39;}}else{_LL39: _LL3A:
({void*_tmp1B1=0U;({struct _dyneither_ptr _tmp4BF=({const char*_tmp1B2="bad designator(s)";_tag_dyneither(_tmp1B2,sizeof(char),18U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4BF,_tag_dyneither(_tmp1B1,sizeof(void*),0U));});});}_LL36:;};}}
# 1073
if(!found)
({void*_tmp1B6=0U;({struct _dyneither_ptr _tmp4C0=({const char*_tmp1B7="bad designator";_tag_dyneither(_tmp1B7,sizeof(char),15U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4C0,_tag_dyneither(_tmp1B6,sizeof(void*),0U));});});}}
# 1076
s=({struct Cyc_List_List*_tmp4C1=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(ps);Cyc_Tcpat_tuple_pat(_tmp4C1,Cyc_Tcpat_pw(p));});}else{
# 1079
if(!((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp1DA->impl))->tagged)
({void*_tmp1B9=0U;({unsigned int _tmp4C3=p->loc;struct _dyneither_ptr _tmp4C2=({const char*_tmp1BA="patterns on untagged unions not yet supported.";_tag_dyneither(_tmp1BA,sizeof(char),47U);});Cyc_Tcutil_terr(_tmp4C3,_tmp4C2,_tag_dyneither(_tmp1B9,sizeof(void*),0U));});});{
int*span=({int*_tmp1C1=_cycalloc_atomic(sizeof(*_tmp1C1));({int _tmp4C4=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp1DA->impl))->fields);*_tmp1C1=_tmp4C4;});_tmp1C1;});
...
# 1084
 s=({struct _dyneither_ptr _tmp4C8=*_tmp1C0;int*_tmp4C7=span;struct Cyc_List_List*_tmp4C6=({struct Cyc_List_List*_tmp1BC=_cycalloc(sizeof(*_tmp1BC));({void*_tmp4C5=Cyc_Tcpat_compile_pat(_tmp1BF);_tmp1BC->hd=_tmp4C5;}),_tmp1BC->tl=0;_tmp1BC;});Cyc_Tcpat_con_pat(_tmp4C8,_tmp4C7,_tmp4C6,p);});
goto _LL3B;}else{goto _LL3E;}}else{goto _LL3E;}}else{goto _LL3E;}}else{goto _LL3E;}}else{_LL3E: _LL3F:
({void*_tmp1BD=0U;({struct _dyneither_ptr _tmp4C9=({const char*_tmp1BE="bad union pattern";_tag_dyneither(_tmp1BE,sizeof(char),18U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4C9,_tag_dyneither(_tmp1BD,sizeof(void*),0U));});});}_LL3B:;};}
# 1089
...
s=({struct _dyneither_ptr _tmp4CB=*(*_tmp1DB->name).f2;int*_tmp4CA=({int*_tmp1C4=_cycalloc_atomic(sizeof(*_tmp1C4));*_tmp1C4=span;_tmp1C4;});Cyc_Tcpat_con_pat(_tmp4CB,_tmp4CA,0,p);});
goto _LL40;}}_LL40:;}
# 1105
...
({void*_tmp1C7=0U;({struct _dyneither_ptr _tmp4CC=({const char*_tmp1C8="bad type in AnonEnum_p";_tag_dyneither(_tmp1C8,sizeof(char),23U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4CC,_tag_dyneither(_tmp1C7,sizeof(void*),0U));});});}_LL45:;}
# 1117
...
# 1121
 s=Cyc_Tcpat_con_pat(*(*_tmp1DD->name).f2,0,0,p);
goto _LL4A;}else{goto _LL4D;}}else{_LL4D: _LL4E: {
# 1124
int span=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(fields);
s=({struct _dyneither_ptr _tmp4CE=*(*_tmp1DD->name).f2;int*_tmp4CD=({int*_tmp1CC=_cycalloc_atomic(sizeof(*_tmp1CC));*_tmp1CC=span;_tmp1CC;});Cyc_Tcpat_con_pat(_tmp4CE,_tmp4CD,0,p);});
goto _LL4A;}}_LL4A:;}
# 1128
...
# 1132
 s=(void*)({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp1CD=_cycalloc(sizeof(*_tmp1CD));_tmp1CD->tag=0U;_tmp1CD;});}_LL0:;}
# 1134
...
struct Cyc_List_List*_tmp4D0=({struct Cyc_List_List*_tmp1EE=_cycalloc(sizeof(*_tmp1EE));({struct _tuple0*_tmp4CF=({struct _tuple0*_tmp1ED=_cycalloc(sizeof(*_tmp1ED));_tmp1ED->f1=_tmp1EB,_tmp1ED->f2=d1;_tmp1ED;});_tmp1EE->hd=_tmp4CF;}),_tmp1EE->tl=_tmp1F1;_tmp1EE;});_tmp1EF->f2=_tmp4D0;}),_tmp1EF->f3=_tmp1F0;_tmp1EF;});else{
# 1194
goto _LL0;}}else{_LL3: _LL4:
 goto _LL0;}_LL0:;}
# 1197
return(void*)({struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*_tmp1F5=_cycalloc(sizeof(*_tmp1F5));_tmp1F5->tag=2U,_tmp1F5->f1=access,({struct Cyc_List_List*_tmp4D2=({struct Cyc_List_List*_tmp1F4=_cycalloc(sizeof(*_tmp1F4));({struct _tuple0*_tmp4D1=({struct _tuple0*_tmp1F3=_cycalloc(sizeof(*_tmp1F3));_tmp1F3->f1=_tmp1EB,_tmp1F3->f2=d1;_tmp1F3;});_tmp1F4->hd=_tmp4D1;}),_tmp1F4->tl=0;_tmp1F4;});_tmp1F5->f2=_tmp4D2;}),_tmp1F5->f3=d2;_tmp1F5;});}struct _tuple20{struct Cyc_List_List*f1;struct Cyc_List_List*f2;struct Cyc_List_List*f3;};
# 1208
enum Cyc_Tcpat_Answer{Cyc_Tcpat_Yes  = 0U,Cyc_Tcpat_No  = 1U,Cyc_Tcpat_Maybe  = 2U};
# 1211
static void Cyc_Tcpat_print_tab(int i){
for(0;i != 0;-- i){
({void*_tmp1F6=0U;({struct Cyc___cycFILE*_tmp4D4=Cyc_stderr;struct _dyneither_ptr _tmp4D3=({const char*_tmp1F7=" ";_tag_dyneither(_tmp1F7,sizeof(char),2U);});Cyc_fprintf(_tmp4D4,_tmp4D3,_tag_dyneither(_tmp1F6,sizeof(void*),0U));});});}}
# 1217
...
({struct Cyc_String_pa_PrintArg_struct _tmp1FC=({struct Cyc_String_pa_PrintArg_struct _tmp3A7;_tmp3A7.tag=0U,_tmp3A7.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp200);_tmp3A7;});void*_tmp1FA[1U];_tmp1FA[0]=& _tmp1FC;({struct Cyc___cycFILE*_tmp4D6=Cyc_stderr;struct _dyneither_ptr _tmp4D5=({const char*_tmp1FB="%s";_tag_dyneither(_tmp1FB,sizeof(char),3U);});Cyc_fprintf(_tmp4D6,_tmp4D5,_tag_dyneither(_tmp1FA,sizeof(void*),1U));});});goto _LL0;}else{_LL3: _tmp201=(_tmp1F9.Int_v).val;_LL4:
({struct Cyc_Int_pa_PrintArg_struct _tmp1FF=({struct Cyc_Int_pa_PrintArg_struct _tmp3A8;_tmp3A8.tag=1U,_tmp3A8.f1=(unsigned long)_tmp201;_tmp3A8;});void*_tmp1FD[1U];_tmp1FD[0]=& _tmp1FF;({struct Cyc___cycFILE*_tmp4D8=Cyc_stderr;struct _dyneither_ptr _tmp4D7=({const char*_tmp1FE="%d";_tag_dyneither(_tmp1FE,sizeof(char),3U);});Cyc_fprintf(_tmp4D8,_tmp4D7,_tag_dyneither(_tmp1FD,sizeof(void*),1U));});});goto _LL0;}_LL0:;}
# 1225
...
({void*_tmp203=0U;({struct Cyc___cycFILE*_tmp4DA=Cyc_stderr;struct _dyneither_ptr _tmp4D9=({const char*_tmp204="DUMMY";_tag_dyneither(_tmp204,sizeof(char),6U);});Cyc_fprintf(_tmp4DA,_tmp4D9,_tag_dyneither(_tmp203,sizeof(void*),0U));});});goto _LL0;case 1U: _LL3: _LL4:
({void*_tmp205=0U;({struct Cyc___cycFILE*_tmp4DC=Cyc_stderr;struct _dyneither_ptr _tmp4DB=({const char*_tmp206="*";_tag_dyneither(_tmp206,sizeof(char),2U);});Cyc_fprintf(_tmp4DC,_tmp4DB,_tag_dyneither(_tmp205,sizeof(void*),0U));});});goto _LL0;case 2U: _LL5: _tmp214=((struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*)_tmp202)->f1;_LL6:
({struct Cyc_Int_pa_PrintArg_struct _tmp209=({struct Cyc_Int_pa_PrintArg_struct _tmp3A9;_tmp3A9.tag=1U,_tmp3A9.f1=(unsigned long)((int)_tmp214);_tmp3A9;});void*_tmp207[1U];_tmp207[0]=& _tmp209;({struct Cyc___cycFILE*_tmp4DE=Cyc_stderr;struct _dyneither_ptr _tmp4DD=({const char*_tmp208="[%d]";_tag_dyneither(_tmp208,sizeof(char),5U);});Cyc_fprintf(_tmp4DE,_tmp4DD,_tag_dyneither(_tmp207,sizeof(void*),1U));});});goto _LL0;case 3U: _LL7: _tmp216=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp202)->f2;_tmp215=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp202)->f3;_LL8:
# 1231
({struct Cyc_String_pa_PrintArg_struct _tmp20C=({struct Cyc_String_pa_PrintArg_struct _tmp3AB;_tmp3AB.tag=0U,({struct _dyneither_ptr _tmp4DF=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp216->name));_tmp3AB.f1=_tmp4DF;});_tmp3AB;});struct Cyc_Int_pa_PrintArg_struct _tmp20D=({struct Cyc_Int_pa_PrintArg_struct _tmp3AA;_tmp3AA.tag=1U,_tmp3AA.f1=(unsigned long)((int)_tmp215);_tmp3AA;});void*_tmp20A[2U];_tmp20A[0]=& _tmp20C,_tmp20A[1]=& _tmp20D;({struct Cyc___cycFILE*_tmp4E1=Cyc_stderr;struct _dyneither_ptr _tmp4E0=({const char*_tmp20B="%s[%d]";_tag_dyneither(_tmp20B,sizeof(char),7U);});Cyc_fprintf(_tmp4E1,_tmp4E0,_tag_dyneither(_tmp20A,sizeof(void*),2U));});});goto _LL0;default: _LL9: _tmp218=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp202)->f1;_tmp217=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp202)->f2;_LLA:
# 1233
 if(_tmp218)
({struct Cyc_String_pa_PrintArg_struct _tmp210=({struct Cyc_String_pa_PrintArg_struct _tmp3AC;_tmp3AC.tag=0U,_tmp3AC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp217);_tmp3AC;});void*_tmp20E[1U];_tmp20E[0]=& _tmp210;({struct Cyc___cycFILE*_tmp4E3=Cyc_stderr;struct _dyneither_ptr _tmp4E2=({const char*_tmp20F=".tagunion.%s";_tag_dyneither(_tmp20F,sizeof(char),13U);});Cyc_fprintf(_tmp4E3,_tmp4E2,_tag_dyneither(_tmp20E,sizeof(void*),1U));});});else{
# 1236
({struct Cyc_String_pa_PrintArg_struct _tmp213=({struct Cyc_String_pa_PrintArg_struct _tmp3AD;_tmp3AD.tag=0U,_tmp3AD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp217);_tmp3AD;});void*_tmp211[1U];_tmp211[0]=& _tmp213;({struct Cyc___cycFILE*_tmp4E5=Cyc_stderr;struct _dyneither_ptr _tmp4E4=({const char*_tmp212=".%s";_tag_dyneither(_tmp212,sizeof(char),4U);});Cyc_fprintf(_tmp4E5,_tmp4E4,_tag_dyneither(_tmp211,sizeof(void*),1U));});});}
goto _LL0;}_LL0:;}
# 1241
...
({void*_tmp21A=0U;({struct Cyc___cycFILE*_tmp4E7=Cyc_stderr;struct _dyneither_ptr _tmp4E6=({const char*_tmp21B="where(NULL)";_tag_dyneither(_tmp21B,sizeof(char),12U);});Cyc_fprintf(_tmp4E7,_tmp4E6,_tag_dyneither(_tmp21A,sizeof(void*),0U));});});goto _LL0;}else{_LL3: _tmp236=((struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct*)_tmp219)->f1;_LL4:
({struct Cyc_String_pa_PrintArg_struct _tmp21E=({struct Cyc_String_pa_PrintArg_struct _tmp3AE;_tmp3AE.tag=0U,({struct _dyneither_ptr _tmp4E8=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string((struct Cyc_Absyn_Exp*)_check_null(_tmp236)));_tmp3AE.f1=_tmp4E8;});_tmp3AE;});void*_tmp21C[1U];_tmp21C[0]=& _tmp21E;({struct Cyc___cycFILE*_tmp4EA=Cyc_stderr;struct _dyneither_ptr _tmp4E9=({const char*_tmp21D="where(%s)";_tag_dyneither(_tmp21D,sizeof(char),10U);});Cyc_fprintf(_tmp4EA,_tmp4E9,_tag_dyneither(_tmp21C,sizeof(void*),1U));});});goto _LL0;}case 1U: _LL5: _LL6:
({void*_tmp21F=0U;({struct Cyc___cycFILE*_tmp4EC=Cyc_stderr;struct _dyneither_ptr _tmp4EB=({const char*_tmp220="NULL";_tag_dyneither(_tmp220,sizeof(char),5U);});Cyc_fprintf(_tmp4EC,_tmp4EB,_tag_dyneither(_tmp21F,sizeof(void*),0U));});});goto _LL0;case 2U: _LL7: _LL8:
({void*_tmp221=0U;({struct Cyc___cycFILE*_tmp4EE=Cyc_stderr;struct _dyneither_ptr _tmp4ED=({const char*_tmp222="NOT-NULL:";_tag_dyneither(_tmp222,sizeof(char),10U);});Cyc_fprintf(_tmp4EE,_tmp4ED,_tag_dyneither(_tmp221,sizeof(void*),0U));});});goto _LL0;case 4U: _LL9: _tmp237=((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp219)->f2;_LLA:
 _tmp238=_tmp237;goto _LLC;case 3U: _LLB: _tmp238=((struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*)_tmp219)->f2;_LLC:
({struct Cyc_String_pa_PrintArg_struct _tmp225=({struct Cyc_String_pa_PrintArg_struct _tmp3AF;_tmp3AF.tag=0U,({struct _dyneither_ptr _tmp4EF=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp238->name));_tmp3AF.f1=_tmp4EF;});_tmp3AF;});void*_tmp223[1U];_tmp223[0]=& _tmp225;({struct Cyc___cycFILE*_tmp4F1=Cyc_stderr;struct _dyneither_ptr _tmp4F0=({const char*_tmp224="%s";_tag_dyneither(_tmp224,sizeof(char),3U);});Cyc_fprintf(_tmp4F1,_tmp4F0,_tag_dyneither(_tmp223,sizeof(void*),1U));});});goto _LL0;case 5U: _LLD: _tmp239=((struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*)_tmp219)->f1;_LLE:
({struct Cyc_String_pa_PrintArg_struct _tmp228=({struct Cyc_String_pa_PrintArg_struct _tmp3B0;_tmp3B0.tag=0U,_tmp3B0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp239);_tmp3B0;});void*_tmp226[1U];_tmp226[0]=& _tmp228;({struct Cyc___cycFILE*_tmp4F3=Cyc_stderr;struct _dyneither_ptr _tmp4F2=({const char*_tmp227="%s";_tag_dyneither(_tmp227,sizeof(char),3U);});Cyc_fprintf(_tmp4F3,_tmp4F2,_tag_dyneither(_tmp226,sizeof(void*),1U));});});goto _LL0;case 6U: _LLF: _tmp23A=((struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*)_tmp219)->f1;_LL10:
({struct Cyc_Int_pa_PrintArg_struct _tmp22B=({struct Cyc_Int_pa_PrintArg_struct _tmp3B1;_tmp3B1.tag=1U,_tmp3B1.f1=(unsigned long)((int)_tmp23A);_tmp3B1;});void*_tmp229[1U];_tmp229[0]=& _tmp22B;({struct Cyc___cycFILE*_tmp4F5=Cyc_stderr;struct _dyneither_ptr _tmp4F4=({const char*_tmp22A="%d";_tag_dyneither(_tmp22A,sizeof(char),3U);});Cyc_fprintf(_tmp4F5,_tmp4F4,_tag_dyneither(_tmp229,sizeof(void*),1U));});});goto _LL0;case 7U: _LL11: _tmp23B=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp219)->f1;_LL12:
({struct Cyc_Int_pa_PrintArg_struct _tmp22E=({struct Cyc_Int_pa_PrintArg_struct _tmp3B2;_tmp3B2.tag=1U,_tmp3B2.f1=(unsigned long)_tmp23B;_tmp3B2;});void*_tmp22C[1U];_tmp22C[0]=& _tmp22E;({struct Cyc___cycFILE*_tmp4F7=Cyc_stderr;struct _dyneither_ptr _tmp4F6=({const char*_tmp22D="datatypetag(%d)";_tag_dyneither(_tmp22D,sizeof(char),16U);});Cyc_fprintf(_tmp4F7,_tmp4F6,_tag_dyneither(_tmp22C,sizeof(void*),1U));});});goto _LL0;case 8U: _LL13: _tmp23D=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp219)->f1;_tmp23C=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp219)->f2;_LL14:
({struct Cyc_String_pa_PrintArg_struct _tmp231=({struct Cyc_String_pa_PrintArg_struct _tmp3B4;_tmp3B4.tag=0U,_tmp3B4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp23D);_tmp3B4;});struct Cyc_Int_pa_PrintArg_struct _tmp232=({struct Cyc_Int_pa_PrintArg_struct _tmp3B3;_tmp3B3.tag=1U,_tmp3B3.f1=(unsigned long)_tmp23C;_tmp3B3;});void*_tmp22F[2U];_tmp22F[0]=& _tmp231,_tmp22F[1]=& _tmp232;({struct Cyc___cycFILE*_tmp4F9=Cyc_stderr;struct _dyneither_ptr _tmp4F8=({const char*_tmp230="uniontag[%s](%d)";_tag_dyneither(_tmp230,sizeof(char),17U);});Cyc_fprintf(_tmp4F9,_tmp4F8,_tag_dyneither(_tmp22F,sizeof(void*),2U));});});goto _LL0;default: _LL15: _tmp23E=((struct Cyc_Tcpat_EqExtensibleDatatype_Tcpat_PatTest_struct*)_tmp219)->f2;_LL16:
# 1254
({struct Cyc_String_pa_PrintArg_struct _tmp235=({struct Cyc_String_pa_PrintArg_struct _tmp3B5;_tmp3B5.tag=0U,({struct _dyneither_ptr _tmp4FA=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp23E->name));_tmp3B5.f1=_tmp4FA;});_tmp3B5;});void*_tmp233[1U];_tmp233[0]=& _tmp235;({struct Cyc___cycFILE*_tmp4FC=Cyc_stderr;struct _dyneither_ptr _tmp4FB=({const char*_tmp234="datatypefield(%s)";_tag_dyneither(_tmp234,sizeof(char),18U);});Cyc_fprintf(_tmp4FC,_tmp4FB,_tag_dyneither(_tmp233,sizeof(void*),1U));});});}_LL0:;}
# 1258
static void Cyc_Tcpat_print_rhs(struct Cyc_Tcpat_Rhs*r){
({struct Cyc_String_pa_PrintArg_struct _tmp241=({struct Cyc_String_pa_PrintArg_struct _tmp3B6;_tmp3B6.tag=0U,({struct _dyneither_ptr _tmp4FD=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_stmt2string(r->rhs));_tmp3B6.f1=_tmp4FD;});_tmp3B6;});void*_tmp23F[1U];_tmp23F[0]=& _tmp241;({struct Cyc___cycFILE*_tmp4FF=Cyc_stderr;struct _dyneither_ptr _tmp4FE=({const char*_tmp240="%s";_tag_dyneither(_tmp240,sizeof(char),3U);});Cyc_fprintf(_tmp4FF,_tmp4FE,_tag_dyneither(_tmp23F,sizeof(void*),1U));});});}
# 1262
...
({void*_tmp243=0U;({struct Cyc___cycFILE*_tmp501=Cyc_stderr;struct _dyneither_ptr _tmp500=({const char*_tmp244="Success(";_tag_dyneither(_tmp244,sizeof(char),9U);});Cyc_fprintf(_tmp501,_tmp500,_tag_dyneither(_tmp243,sizeof(void*),0U));});});Cyc_Tcpat_print_rhs(_tmp25B);({void*_tmp245=0U;({struct Cyc___cycFILE*_tmp503=Cyc_stderr;struct _dyneither_ptr _tmp502=({const char*_tmp246=")\n";_tag_dyneither(_tmp246,sizeof(char),3U);});Cyc_fprintf(_tmp503,_tmp502,_tag_dyneither(_tmp245,sizeof(void*),0U));});});
goto _LL0;case 0U: _LL3: _LL4:
({void*_tmp247=0U;({struct Cyc___cycFILE*_tmp505=Cyc_stderr;struct _dyneither_ptr _tmp504=({const char*_tmp248="Failure\n";_tag_dyneither(_tmp248,sizeof(char),9U);});Cyc_fprintf(_tmp505,_tmp504,_tag_dyneither(_tmp247,sizeof(void*),0U));});});goto _LL0;default: _LL5: _tmp25E=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp242)->f1;_tmp25D=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp242)->f2;_tmp25C=(void*)((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp242)->f3;_LL6:
# 1270
 Cyc_Tcpat_print_tab(tab);
({void*_tmp249=0U;({struct Cyc___cycFILE*_tmp507=Cyc_stderr;struct _dyneither_ptr _tmp506=({const char*_tmp24A="Switch[";_tag_dyneither(_tmp24A,sizeof(char),8U);});Cyc_fprintf(_tmp507,_tmp506,_tag_dyneither(_tmp249,sizeof(void*),0U));});});
for(0;_tmp25E != 0;_tmp25E=_tmp25E->tl){
Cyc_Tcpat_print_access(((struct Cyc_Tcpat_PathNode*)_tmp25E->hd)->access);
if(_tmp25E->tl != 0)({void*_tmp24B=0U;({struct Cyc___cycFILE*_tmp509=Cyc_stderr;struct _dyneither_ptr _tmp508=({const char*_tmp24C=",";_tag_dyneither(_tmp24C,sizeof(char),2U);});Cyc_fprintf(_tmp509,_tmp508,_tag_dyneither(_tmp24B,sizeof(void*),0U));});});}
# 1276
({void*_tmp24D=0U;({struct Cyc___cycFILE*_tmp50B=Cyc_stderr;struct _dyneither_ptr _tmp50A=({const char*_tmp24E="] {\n";_tag_dyneither(_tmp24E,sizeof(char),5U);});Cyc_fprintf(_tmp50B,_tmp50A,_tag_dyneither(_tmp24D,sizeof(void*),0U));});});
...
Cyc_Tcpat_print_tab(tab);
({void*_tmp251=0U;({struct Cyc___cycFILE*_tmp50D=Cyc_stderr;struct _dyneither_ptr _tmp50C=({const char*_tmp252="case ";_tag_dyneither(_tmp252,sizeof(char),6U);});Cyc_fprintf(_tmp50D,_tmp50C,_tag_dyneither(_tmp251,sizeof(void*),0U));});});
Cyc_Tcpat_print_pat_test(_tmp256);
({void*_tmp253=0U;({struct Cyc___cycFILE*_tmp50F=Cyc_stderr;struct _dyneither_ptr _tmp50E=({const char*_tmp254=":\n";_tag_dyneither(_tmp254,sizeof(char),3U);});Cyc_fprintf(_tmp50F,_tmp50E,_tag_dyneither(_tmp253,sizeof(void*),0U));});});
Cyc_Tcpat_print_dec_tree(_tmp255,tab + 7);}
# 1285
Cyc_Tcpat_print_tab(tab);
({void*_tmp257=0U;({struct Cyc___cycFILE*_tmp511=Cyc_stderr;struct _dyneither_ptr _tmp510=({const char*_tmp258="default:\n";_tag_dyneither(_tmp258,sizeof(char),10U);});Cyc_fprintf(_tmp511,_tmp510,_tag_dyneither(_tmp257,sizeof(void*),0U));});});
Cyc_Tcpat_print_dec_tree(_tmp25C,tab + 7);
Cyc_Tcpat_print_tab(tab);
({void*_tmp259=0U;({struct Cyc___cycFILE*_tmp513=Cyc_stderr;struct _dyneither_ptr _tmp512=({const char*_tmp25A="}\n";_tag_dyneither(_tmp25A,sizeof(char),3U);});Cyc_fprintf(_tmp513,_tmp512,_tag_dyneither(_tmp259,sizeof(void*),0U));});});}_LL0:;}
# 1293
...
# 1311
 return(void*)({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp260=_cycalloc(sizeof(*_tmp260));_tmp260->tag=1U,({struct Cyc_Set_Set*_tmp514=((struct Cyc_Set_Set*(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_insert)(_tmp263,c);_tmp260->f1=_tmp514;});_tmp260;});}else{_LL3: _LL4:
({void*_tmp261=0U;({struct _dyneither_ptr _tmp515=({const char*_tmp262="add_neg called when td is Positive";_tag_dyneither(_tmp262,sizeof(char),35U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp515,_tag_dyneither(_tmp261,sizeof(void*),0U));});});}_LL0:;}
# 1318
...
# 1329
if(c->span != 0  && ({int _tmp516=*((int*)_check_null(c->span));_tmp516 == ((int(*)(struct Cyc_Set_Set*s))Cyc_Set_cardinality)(_tmp266)+ 1;}))
...
({struct _tuple21*_tmp518=({struct _tuple21*_tmp269=_cycalloc(sizeof(*_tmp269));_tmp269->f1=_tmp26D,({struct Cyc_List_List*_tmp517=({struct Cyc_List_List*_tmp268=_cycalloc(sizeof(*_tmp268));_tmp268->hd=dsc,_tmp268->tl=_tmp26C;_tmp268;});_tmp269->f2=_tmp517;});_tmp269;});_tmp26A->hd=_tmp518;}),_tmp26A->tl=_tmp26B;_tmp26A;});}_LL0:;}
# 1352
...
({void*_tmp26F=0U;({struct _dyneither_ptr _tmp519=({const char*_tmp270="norm_context: empty context";_tag_dyneither(_tmp270,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp519,_tag_dyneither(_tmp26F,sizeof(void*),0U));});});}else{_LL3: _tmp274=((struct _tuple21*)_tmp26E->hd)->f1;_tmp273=((struct _tuple21*)_tmp26E->hd)->f2;_tmp272=_tmp26E->tl;_LL4:
# 1356
 return({struct Cyc_List_List*_tmp51B=_tmp272;Cyc_Tcpat_augment(_tmp51B,(void*)({struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp271=_cycalloc(sizeof(*_tmp271));_tmp271->tag=0U,_tmp271->f1=_tmp274,({struct Cyc_List_List*_tmp51A=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(_tmp273);_tmp271->f2=_tmp51A;});_tmp271;}));});}_LL0:;}
# 1365
...
({void*_tmp277=0U;({struct _dyneither_ptr _tmp51C=({const char*_tmp278="build_desc: ctxt and work don't match";_tag_dyneither(_tmp278,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp51C,_tag_dyneither(_tmp277,sizeof(void*),0U));});});}else{_LL7: _tmp280=((struct _tuple21*)(_tmp276.f1)->hd)->f1;_tmp27F=((struct _tuple21*)(_tmp276.f1)->hd)->f2;_tmp27E=(_tmp276.f1)->tl;_tmp27D=((struct _tuple20*)(_tmp276.f2)->hd)->f3;_tmp27C=(_tmp276.f2)->tl;_LL8: {
# 1372
struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp279=({struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp27B=_cycalloc(sizeof(*_tmp27B));_tmp27B->tag=0U,_tmp27B->f1=_tmp280,({struct Cyc_List_List*_tmp51E=({struct Cyc_List_List*_tmp51D=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(_tmp27F);((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp51D,({struct Cyc_List_List*_tmp27A=_cycalloc(sizeof(*_tmp27A));_tmp27A->hd=dsc,_tmp27A->tl=_tmp27D;_tmp27A;}));});_tmp27B->f2=_tmp51E;});_tmp27B;});
...
return({void*_tmp520=(void*)({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp286=_cycalloc(sizeof(*_tmp286));_tmp286->tag=1U,({struct Cyc_Set_Set*_tmp51F=Cyc_Tcpat_empty_con_set();_tmp286->f1=_tmp51F;});_tmp286;});Cyc_Tcpat_or_match(_tmp520,allmrules);});}
# 1400
...
# 1406
 return({struct Cyc_List_List*_tmp523=Cyc_Tcpat_norm_context(ctx);struct Cyc_List_List*_tmp522=_tmp29A;struct Cyc_Tcpat_Rhs*_tmp521=right_hand_side;Cyc_Tcpat_and_match(_tmp523,_tmp522,_tmp521,rules);});}else{goto _LL5;}}else{goto _LL5;}}else{_LL5: _tmp29E=((struct _tuple20*)_tmp287->hd)->f1;_tmp29D=((struct _tuple20*)_tmp287->hd)->f2;_tmp29C=((struct _tuple20*)_tmp287->hd)->f3;_tmp29B=_tmp287->tl;_LL6:
# 1408
 if((_tmp29E == 0  || _tmp29D == 0) || _tmp29C == 0)
({void*_tmp289=0U;({struct _dyneither_ptr _tmp524=({const char*_tmp28A="tcpat:and_match: malformed work frame";_tag_dyneither(_tmp28A,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp524,_tag_dyneither(_tmp289,sizeof(void*),0U));});});{
...
return({void*_tmp52A=_tmp299;struct Cyc_List_List*_tmp529=_tmp297;void*_tmp528=_tmp295;struct Cyc_List_List*_tmp527=ctx;struct Cyc_List_List*_tmp526=({struct Cyc_List_List*_tmp292=_cycalloc(sizeof(*_tmp292));_tmp292->hd=_tmp291,_tmp292->tl=_tmp29B;_tmp292;});struct Cyc_Tcpat_Rhs*_tmp525=right_hand_side;Cyc_Tcpat_match(_tmp52A,_tmp529,_tmp528,_tmp527,_tmp526,_tmp525,rules);});};};};};}}_LL0:;}
# 1419
...
# 1425
void*any=(void*)({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp2A2=_cycalloc(sizeof(*_tmp2A2));_tmp2A2->tag=1U,({struct Cyc_Set_Set*_tmp52B=Cyc_Tcpat_empty_con_set();_tmp2A2->f1=_tmp52B;});_tmp2A2;});
struct Cyc_List_List*_tmp2A0=0;
{int i=0;for(0;i < pcon->arity;++ i){
_tmp2A0=({struct Cyc_List_List*_tmp2A1=_cycalloc(sizeof(*_tmp2A1));_tmp2A1->hd=any,_tmp2A1->tl=_tmp2A0;_tmp2A1;});}}
...
# 1440
 if(i != 0)
({void*_tmp2A8=0U;({struct _dyneither_ptr _tmp52D=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp2AB=({struct Cyc_Int_pa_PrintArg_struct _tmp3B8;_tmp3B8.tag=1U,_tmp3B8.f1=(unsigned long)i;_tmp3B8;});void*_tmp2A9[1U];_tmp2A9[0]=& _tmp2AB;({struct _dyneither_ptr _tmp52C=({const char*_tmp2AA="get_access on pointer pattern with offset %d\n";_tag_dyneither(_tmp2AA,sizeof(char),46U);});Cyc_aprintf(_tmp52C,_tag_dyneither(_tmp2A9,sizeof(void*),1U));});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp52D,_tag_dyneither(_tmp2A8,sizeof(void*),0U));});});
...
({void*_tmp2B2=0U;({struct _dyneither_ptr _tmp530=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2B5=({struct Cyc_String_pa_PrintArg_struct _tmp3B9;_tmp3B9.tag=0U,({struct _dyneither_ptr _tmp52E=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_pat2string(_tmp2C2));_tmp3B9.f1=_tmp52E;});_tmp3B9;});void*_tmp2B3[1U];_tmp2B3[0]=& _tmp2B5;({struct _dyneither_ptr _tmp52F=({const char*_tmp2B4="get_access on bad aggr pattern: %s";_tag_dyneither(_tmp2B4,sizeof(char),35U);});Cyc_aprintf(_tmp52F,_tag_dyneither(_tmp2B3,sizeof(void*),1U));});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp530,_tag_dyneither(_tmp2B2,sizeof(void*),0U));});});}_LL10:;}{
# 1454
...
({void*_tmp2BA=0U;({struct _dyneither_ptr _tmp533=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2BD=({struct Cyc_String_pa_PrintArg_struct _tmp3BA;_tmp3BA.tag=0U,({struct _dyneither_ptr _tmp531=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_pat2string(_tmp2C2));_tmp3BA.f1=_tmp531;});_tmp3BA;});void*_tmp2BB[1U];_tmp2BB[0]=& _tmp2BD;({struct _dyneither_ptr _tmp532=({const char*_tmp2BC="get_access on bad pattern: %s";_tag_dyneither(_tmp2BC,sizeof(char),30U);});Cyc_aprintf(_tmp532,_tag_dyneither(_tmp2BB,sizeof(void*),1U));});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp533,_tag_dyneither(_tmp2BA,sizeof(void*),0U));});});}_LL5:;}}_LL0:;}struct _tuple23{struct Cyc_List_List*f1;struct Cyc_Tcpat_Con_s*f2;};
# 1464
...
return({struct Cyc_List_List*_tmp2C5=_cycalloc(sizeof(*_tmp2C5));({struct Cyc_Tcpat_PathNode*_tmp534=({struct Cyc_Tcpat_PathNode*_tmp2C4=_cycalloc(sizeof(*_tmp2C4));_tmp2C4->orig_pat=_tmp2C6->orig_pat,_tmp2C4->access=acc;_tmp2C4;});_tmp2C5->hd=_tmp534;}),_tmp2C5->tl=_tmp2C7;_tmp2C5;});};}
# 1469
...
# 1483
 return({struct Cyc_List_List*_tmp537=Cyc_Tcpat_augment(ctx,dsc);struct Cyc_List_List*_tmp536=work;struct Cyc_Tcpat_Rhs*_tmp535=right_hand_side;Cyc_Tcpat_and_match(_tmp537,_tmp536,_tmp535,rules);});}else{_LL3: _tmp2D7=((struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*)_tmp2C9)->f1;_tmp2D6=((struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*)_tmp2C9)->f2;_LL4: {
# 1485
...
# 1487
struct Cyc_List_List*ctx2=({struct Cyc_List_List*_tmp2CF=_cycalloc(sizeof(*_tmp2CF));({struct _tuple21*_tmp538=({struct _tuple21*_tmp2CE=_cycalloc(sizeof(*_tmp2CE));_tmp2CE->f1=_tmp2D7,_tmp2CE->f2=0;_tmp2CE;});_tmp2CF->hd=_tmp538;}),_tmp2CF->tl=ctx;_tmp2CF;});
struct _tuple20*work_frame=({struct _tuple20*_tmp2CD=_cycalloc(sizeof(*_tmp2CD));_tmp2CD->f1=_tmp2D6,({struct Cyc_List_List*_tmp53A=Cyc_Tcpat_getoargs(_tmp2D7,obj);_tmp2CD->f2=_tmp53A;}),({
struct Cyc_List_List*_tmp539=Cyc_Tcpat_getdargs(_tmp2D7,dsc);_tmp2CD->f3=_tmp539;});_tmp2CD;});
...
# 1493
 return({void*_tmp53B=Cyc_Tcpat_build_desc(ctx,dsc,work);Cyc_Tcpat_or_match(_tmp53B,rules);});default: _LLA: _LLB: {
# 1495
struct Cyc_List_List*ctx2=({struct Cyc_List_List*_tmp2D5=_cycalloc(sizeof(*_tmp2D5));({struct _tuple21*_tmp53C=({struct _tuple21*_tmp2D4=_cycalloc(sizeof(*_tmp2D4));_tmp2D4->f1=_tmp2D7,_tmp2D4->f2=0;_tmp2D4;});_tmp2D5->hd=_tmp53C;}),_tmp2D5->tl=ctx;_tmp2D5;});
struct _tuple20*work_frame=({struct _tuple20*_tmp2D3=_cycalloc(sizeof(*_tmp2D3));_tmp2D3->f1=_tmp2D6,({struct Cyc_List_List*_tmp53E=Cyc_Tcpat_getoargs(_tmp2D7,obj);_tmp2D3->f2=_tmp53E;}),({
struct Cyc_List_List*_tmp53D=Cyc_Tcpat_getdargs(_tmp2D7,dsc);_tmp2D3->f3=_tmp53D;});_tmp2D3;});
...
void*_tmp2D1=({void*_tmp541=({struct Cyc_List_List*_tmp540=ctx;void*_tmp53F=Cyc_Tcpat_add_neg(dsc,_tmp2D7);Cyc_Tcpat_build_desc(_tmp540,_tmp53F,work);});Cyc_Tcpat_or_match(_tmp541,rules);});
# 1502
...
sp=({struct Cyc_List_List*_tmp543=({void*_tmp2E1[2U];_tmp2E1[0]=sp0,({void*_tmp542=Cyc_Tcpat_int_pat(*ctr,_tmp2E0);_tmp2E1[1]=_tmp542;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp2E1,sizeof(void*),2U));});Cyc_Tcpat_tuple_pat(_tmp543,_tmp2E0);});
*ctr=*ctr + 1;}else{
# 1548
sp=({struct Cyc_List_List*_tmp545=({void*_tmp2E2[2U];_tmp2E2[0]=sp0,({void*_tmp544=(void*)({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp2E3=_cycalloc(sizeof(*_tmp2E3));_tmp2E3->tag=0U;_tmp2E3;});_tmp2E2[1]=_tmp544;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp2E2,sizeof(void*),2U));});Cyc_Tcpat_tuple_pat(_tmp545,({union Cyc_Tcpat_PatOrWhere _tmp3BD;(_tmp3BD.where_clause).tag=2U,(_tmp3BD.where_clause).val=0;_tmp3BD;}));});}
...
void*_tmp2EB=p->r;void*_tmp2EC=_tmp2EB;struct Cyc_Absyn_Exp*_tmp321;struct Cyc_Absyn_Enumfield*_tmp320;struct Cyc_Absyn_Enumfield*_tmp31F;struct _dyneither_ptr _tmp31E;int _tmp31D;char _tmp31C;int _tmp31B;struct Cyc_Absyn_Datatypefield*_tmp31A;struct Cyc_Absyn_Aggrdecl*_tmp319;struct Cyc_List_List*_tmp318;struct Cyc_Absyn_Tvar*_tmp317;struct Cyc_Absyn_Vardecl*_tmp316;struct Cyc_Absyn_Vardecl*_tmp315;struct Cyc_Absyn_Vardecl*_tmp314;switch(*((int*)_tmp2EC)){case 0U: _LLB: _LLC:
 ...
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2F0=({struct Cyc_String_pa_PrintArg_struct _tmp3BE;_tmp3BE.tag=0U,({struct _dyneither_ptr _tmp546=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp315->name));_tmp3BE.f1=_tmp546;});_tmp3BE;});void*_tmp2EE[1U];_tmp2EE[0]=& _tmp2F0;({struct _dyneither_ptr _tmp547=({const char*_tmp2EF="*%s";_tag_dyneither(_tmp2EF,sizeof(char),4U);});Cyc_aprintf(_tmp547,_tag_dyneither(_tmp2EE,sizeof(void*),1U));});});case 4U: _LL11: _tmp317=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp2EC)->f1;_tmp316=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp2EC)->f2;_LL12:
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2F3=({struct Cyc_String_pa_PrintArg_struct _tmp3C0;_tmp3C0.tag=0U,({struct _dyneither_ptr _tmp548=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp316->name));_tmp3C0.f1=_tmp548;});_tmp3C0;});struct Cyc_String_pa_PrintArg_struct _tmp2F4=({struct Cyc_String_pa_PrintArg_struct _tmp3BF;_tmp3BF.tag=0U,_tmp3BF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp317->name);_tmp3BF;});void*_tmp2F1[2U];_tmp2F1[0]=& _tmp2F3,_tmp2F1[1]=& _tmp2F4;({struct _dyneither_ptr _tmp549=({const char*_tmp2F2="%s<`%s>";_tag_dyneither(_tmp2F2,sizeof(char),8U);});Cyc_aprintf(_tmp549,_tag_dyneither(_tmp2F1,sizeof(void*),2U));});});case 5U: _LL13: _LL14:
# 1572
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2F7=({struct Cyc_String_pa_PrintArg_struct _tmp3C1;_tmp3C1.tag=0U,({struct _dyneither_ptr _tmp54A=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(_tmp345));_tmp3C1.f1=_tmp54A;});_tmp3C1;});void*_tmp2F5[1U];_tmp2F5[0]=& _tmp2F7;({struct _dyneither_ptr _tmp54B=({const char*_tmp2F6="$(%s)";_tag_dyneither(_tmp2F6,sizeof(char),6U);});Cyc_aprintf(_tmp54B,_tag_dyneither(_tmp2F5,sizeof(void*),1U));});});case 6U: _LL15: _LL16:
# 1574
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2FA=({struct Cyc_String_pa_PrintArg_struct _tmp3C2;_tmp3C2.tag=0U,({struct _dyneither_ptr _tmp54C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(_tmp345));_tmp3C2.f1=_tmp54C;});_tmp3C2;});void*_tmp2F8[1U];_tmp2F8[0]=& _tmp2FA;({struct _dyneither_ptr _tmp54D=({const char*_tmp2F9="&%s";_tag_dyneither(_tmp2F9,sizeof(char),4U);});Cyc_aprintf(_tmp54D,_tag_dyneither(_tmp2F8,sizeof(void*),1U));});});case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp2EC)->f1 != 0){if((((union Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp2EC)->f1)->KnownAggr).tag == 2){_LL17: _tmp319=*((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp2EC)->f1)->KnownAggr).val;_tmp318=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp2EC)->f3;_LL18:
# 1576
 if((int)_tmp319->kind == (int)Cyc_Absyn_UnionA){
...
# 1579
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2FE=({struct Cyc_String_pa_PrintArg_struct _tmp3C5;_tmp3C5.tag=0U,({struct _dyneither_ptr _tmp54E=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp319->name));_tmp3C5.f1=_tmp54E;});_tmp3C5;});struct Cyc_String_pa_PrintArg_struct _tmp2FF=({struct Cyc_String_pa_PrintArg_struct _tmp3C4;_tmp3C4.tag=0U,_tmp3C4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp301);_tmp3C4;});struct Cyc_String_pa_PrintArg_struct _tmp300=({struct Cyc_String_pa_PrintArg_struct _tmp3C3;_tmp3C3.tag=0U,({
struct _dyneither_ptr _tmp54F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(_tmp345));_tmp3C3.f1=_tmp54F;});_tmp3C3;});void*_tmp2FC[3U];_tmp2FC[0]=& _tmp2FE,_tmp2FC[1]=& _tmp2FF,_tmp2FC[2]=& _tmp300;({struct _dyneither_ptr _tmp550=({const char*_tmp2FD="%s{.%s = %s}";_tag_dyneither(_tmp2FD,sizeof(char),13U);});Cyc_aprintf(_tmp550,_tag_dyneither(_tmp2FC,sizeof(void*),3U));});});}else{goto _LL2E;}}else{goto _LL2E;}}else{_LL2E: _LL2F:
 goto _LL2B;}_LL2B:;}
# 1584
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp304=({struct Cyc_String_pa_PrintArg_struct _tmp3C7;_tmp3C7.tag=0U,({struct _dyneither_ptr _tmp551=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp319->name));_tmp3C7.f1=_tmp551;});_tmp3C7;});struct Cyc_String_pa_PrintArg_struct _tmp305=({struct Cyc_String_pa_PrintArg_struct _tmp3C6;_tmp3C6.tag=0U,({struct _dyneither_ptr _tmp552=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(_tmp345));_tmp3C6.f1=_tmp552;});_tmp3C6;});void*_tmp302[2U];_tmp302[0]=& _tmp304,_tmp302[1]=& _tmp305;({struct _dyneither_ptr _tmp553=({const char*_tmp303="%s{%s}";_tag_dyneither(_tmp303,sizeof(char),7U);});Cyc_aprintf(_tmp553,_tag_dyneither(_tmp302,sizeof(void*),2U));});});}else{goto _LL29;}}else{goto _LL29;}case 8U: _LL19: _tmp31A=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp2EC)->f2;_LL1A:
# 1586
 if(_tmp345 == 0)
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp308=({struct Cyc_String_pa_PrintArg_struct _tmp3C8;_tmp3C8.tag=0U,({struct _dyneither_ptr _tmp554=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp31A->name));_tmp3C8.f1=_tmp554;});_tmp3C8;});void*_tmp306[1U];_tmp306[0]=& _tmp308;({struct _dyneither_ptr _tmp555=({const char*_tmp307="%s";_tag_dyneither(_tmp307,sizeof(char),3U);});Cyc_aprintf(_tmp555,_tag_dyneither(_tmp306,sizeof(void*),1U));});});else{
# 1589
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp30B=({struct Cyc_String_pa_PrintArg_struct _tmp3CA;_tmp3CA.tag=0U,({struct _dyneither_ptr _tmp556=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp31A->name));_tmp3CA.f1=_tmp556;});_tmp3CA;});struct Cyc_String_pa_PrintArg_struct _tmp30C=({struct Cyc_String_pa_PrintArg_struct _tmp3C9;_tmp3C9.tag=0U,({struct _dyneither_ptr _tmp557=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(_tmp345));_tmp3C9.f1=_tmp557;});_tmp3C9;});void*_tmp309[2U];_tmp309[0]=& _tmp30B,_tmp309[1]=& _tmp30C;({struct _dyneither_ptr _tmp558=({const char*_tmp30A="%s(%s)";_tag_dyneither(_tmp30A,sizeof(char),7U);});Cyc_aprintf(_tmp558,_tag_dyneither(_tmp309,sizeof(void*),2U));});});}case 9U: _LL1B: _LL1C:
 ...
 return(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp310=({struct Cyc_Int_pa_PrintArg_struct _tmp3CB;_tmp3CB.tag=1U,_tmp3CB.f1=(unsigned long)_tmp31B;_tmp3CB;});void*_tmp30E[1U];_tmp30E[0]=& _tmp310;({struct _dyneither_ptr _tmp559=({const char*_tmp30F="%d";_tag_dyneither(_tmp30F,sizeof(char),3U);});Cyc_aprintf(_tmp559,_tag_dyneither(_tmp30E,sizeof(void*),1U));});});case 11U: _LL1F: _tmp31C=((struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp2EC)->f1;_LL20:
 return(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp313=({struct Cyc_Int_pa_PrintArg_struct _tmp3CC;_tmp3CC.tag=1U,_tmp3CC.f1=(unsigned long)((int)_tmp31C);_tmp3CC;});void*_tmp311[1U];_tmp311[0]=& _tmp313;({struct _dyneither_ptr _tmp55A=({const char*_tmp312="%d";_tag_dyneither(_tmp312,sizeof(char),3U);});Cyc_aprintf(_tmp55A,_tag_dyneither(_tmp311,sizeof(void*),1U));});});case 12U: _LL21: _tmp31E=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp2EC)->f1;_tmp31D=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp2EC)->f2;_LL22:
...
return(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp32A=({struct Cyc_Int_pa_PrintArg_struct _tmp3CD;_tmp3CD.tag=1U,_tmp3CD.f1=(unsigned long)i;_tmp3CD;});void*_tmp328[1U];_tmp328[0]=& _tmp32A;({struct _dyneither_ptr _tmp55B=({const char*_tmp329="%d";_tag_dyneither(_tmp329,sizeof(char),3U);});Cyc_aprintf(_tmp55B,_tag_dyneither(_tmp328,sizeof(void*),1U));});});}}
# 1614
(int)_throw((void*)& Cyc_Tcpat_Desc2string_val);}else{_LL33: _LL34:
# 1617
{unsigned int i=0U;for(0;i < (unsigned int)-1;++ i){
...
if(!({struct Cyc_Set_Set*_tmp55E=_tmp347;((int(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp55E,({struct Cyc_Tcpat_Con_s*_tmp334=_cycalloc(sizeof(*_tmp334));({union Cyc_Tcpat_Name_value _tmp55D=Cyc_Tcpat_Name_v(n);_tmp334->name=_tmp55D;}),_tmp334->arity=0,_tmp334->span=0,_tmp334->orig_pat=_tmp323->orig_pat;_tmp334;}));})){
if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp333)== 0)
return n;else{
# 1642
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp337=({struct Cyc_String_pa_PrintArg_struct _tmp3CF;_tmp3CF.tag=0U,_tmp3CF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)n);_tmp3CF;});void*_tmp335[1U];_tmp335[0]=& _tmp337;({struct _dyneither_ptr _tmp55F=({const char*_tmp336="%s(...)";_tag_dyneither(_tmp336,sizeof(char),8U);});Cyc_aprintf(_tmp55F,_tag_dyneither(_tmp335,sizeof(void*),1U));});});}}}
# 1645
(int)_throw((void*)& Cyc_Tcpat_Desc2string_val);};}else{goto _LL3B;}case 20U: if(((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp326)->f1)->f1).KnownAggr).tag == 2){_LL39: _tmp342=*((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp326)->f1)->f1).KnownAggr).val;if((int)_tmp342->kind == (int)Cyc_Absyn_UnionA){_LL3A: {
# 1647
...
if(!({struct Cyc_Set_Set*_tmp561=_tmp347;((int(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp561,({struct Cyc_Tcpat_Con_s*_tmp33B=_cycalloc(sizeof(*_tmp33B));({union Cyc_Tcpat_Name_value _tmp560=Cyc_Tcpat_Name_v(n);_tmp33B->name=_tmp560;}),_tmp33B->arity=0,_tmp33B->span=0,_tmp33B->orig_pat=_tmp323->orig_pat;_tmp33B;}));}))
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp33E=({struct Cyc_String_pa_PrintArg_struct _tmp3D1;_tmp3D1.tag=0U,_tmp3D1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp340);_tmp3D1;});struct Cyc_String_pa_PrintArg_struct _tmp33F=({struct Cyc_String_pa_PrintArg_struct _tmp3D0;_tmp3D0.tag=0U,_tmp3D0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)n);_tmp3D0;});void*_tmp33C[2U];_tmp33C[0]=& _tmp33E,_tmp33C[1]=& _tmp33F;({struct _dyneither_ptr _tmp562=({const char*_tmp33D="%s{.%s = _}";_tag_dyneither(_tmp33D,sizeof(char),12U);});Cyc_aprintf(_tmp562,_tag_dyneither(_tmp33C,sizeof(void*),2U));});});}
# 1655
...
if(is_nullable){
if(!({struct Cyc_Set_Set*_tmp563=_tmp347;((int(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp563,Cyc_Tcpat_null_con(_tmp324));}))
...
return({struct _dyneither_ptr*_tmp348=_cycalloc(sizeof(*_tmp348));({struct _dyneither_ptr _tmp564=Cyc_Tcpat_desc2string(d);*_tmp348=_tmp564;});_tmp348;});}
# 1663
...
struct _dyneither_ptr*comma=({struct _dyneither_ptr*_tmp34D=_cycalloc(sizeof(*_tmp34D));({struct _dyneither_ptr _tmp565=({const char*_tmp34C=",";_tag_dyneither(_tmp34C,sizeof(char),2U);});*_tmp34D=_tmp565;});_tmp34D;});
{struct Cyc_List_List*_tmp34A=_tmp349;for(0;_tmp34A != 0;_tmp34A=((struct Cyc_List_List*)_check_null(_tmp34A))->tl){
if(_tmp34A->tl != 0){
({struct Cyc_List_List*_tmp566=({struct Cyc_List_List*_tmp34B=_cycalloc(sizeof(*_tmp34B));_tmp34B->hd=comma,_tmp34B->tl=_tmp34A->tl;_tmp34B;});_tmp34A->tl=_tmp566;});
_tmp34A=_tmp34A->tl;}}}
# 1672
...
({struct Cyc_String_pa_PrintArg_struct _tmp354=({struct Cyc_String_pa_PrintArg_struct _tmp3D2;_tmp3D2.tag=0U,_tmp3D2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp351);_tmp3D2;});void*_tmp352[1U];_tmp352[0]=& _tmp354;({unsigned int _tmp568=loc;struct _dyneither_ptr _tmp567=({const char*_tmp353="patterns may not be exhaustive.\n\tmissing case for %s";_tag_dyneither(_tmp353,sizeof(char),53U);});Cyc_Tcutil_terr(_tmp568,_tmp567,_tag_dyneither(_tmp352,sizeof(void*),1U));});});}
# 1677
...
# 1681
({void*_tmp356=0U;({unsigned int _tmp56A=loc;struct _dyneither_ptr _tmp569=({const char*_tmp357="patterns may not be exhaustive.";_tag_dyneither(_tmp357,sizeof(char),32U);});Cyc_Tcutil_terr(_tmp56A,_tmp569,_tag_dyneither(_tmp356,sizeof(void*),0U));});});
...
if(!_tmp363){
({void*_tmp360=0U;({unsigned int _tmp56C=_tmp362;struct _dyneither_ptr _tmp56B=({const char*_tmp361="redundant pattern (check for misspelled constructors in earlier patterns)";_tag_dyneither(_tmp361,sizeof(char),74U);});Cyc_Tcutil_terr(_tmp56C,_tmp56B,_tag_dyneither(_tmp360,sizeof(void*),0U));});});
# 1709
break;}}};}
# 1718
...
({struct Cyc_String_pa_PrintArg_struct _tmp36A=({struct Cyc_String_pa_PrintArg_struct _tmp3D3;_tmp3D3.tag=0U,_tmp3D3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp367);_tmp3D3;});void*_tmp368[1U];_tmp368[0]=& _tmp36A;({unsigned int _tmp56E=(*pr).f1;struct _dyneither_ptr _tmp56D=({const char*_tmp369="pattern not exhaustive.\n\tmissing case for %s";_tag_dyneither(_tmp369,sizeof(char),45U);});Cyc_Tcutil_warn(_tmp56E,_tmp56D,_tag_dyneither(_tmp368,sizeof(void*),1U));});});}
# 1721
...
# 1725
({void*_tmp36C=0U;({unsigned int _tmp570=(*pr).f1;struct _dyneither_ptr _tmp56F=({const char*_tmp36D="pattern not exhaustive.";_tag_dyneither(_tmp36D,sizeof(char),24U);});Cyc_Tcutil_warn(_tmp570,_tmp56F,_tag_dyneither(_tmp36C,sizeof(void*),0U));});});
...
struct Cyc_Tcpat_Rhs*rhs=({struct Cyc_Tcpat_Rhs*_tmp375=_cycalloc(sizeof(*_tmp375));_tmp375->used=0,_tmp375->pat_loc=p->loc,({struct Cyc_Absyn_Stmt*_tmp571=Cyc_Absyn_skip_stmt(0U);_tmp375->rhs=_tmp571;});_tmp375;});
struct Cyc_List_List*_tmp36F=({struct Cyc_List_List*_tmp374=_cycalloc(sizeof(*_tmp374));({struct _tuple22*_tmp573=({struct _tuple22*_tmp373=_cycalloc(sizeof(*_tmp373));({void*_tmp572=Cyc_Tcpat_compile_pat(p);_tmp373->f1=_tmp572;}),_tmp373->f2=rhs;_tmp373;});_tmp374->hd=_tmp573;}),_tmp374->tl=0;_tmp374;});
...
# 1753
if(swc->where_clause != 0)
({void*_tmp376=0U;({unsigned int _tmp575=((struct Cyc_Absyn_Exp*)_check_null(swc->where_clause))->loc;struct _dyneither_ptr _tmp574=({const char*_tmp377="&&-clauses not supported in exception handlers.";_tag_dyneither(_tmp377,sizeof(char),48U);});Cyc_Tcutil_terr(_tmp575,_tmp574,_tag_dyneither(_tmp376,sizeof(void*),0U));});});{
# 1756
...
if(!_tmp382){
({void*_tmp37F=0U;({unsigned int _tmp577=_tmp381;struct _dyneither_ptr _tmp576=({const char*_tmp380="redundant pattern (check for misspelled constructors in earlier patterns)";_tag_dyneither(_tmp380,sizeof(char),74U);});Cyc_Tcutil_terr(_tmp577,_tmp576,_tag_dyneither(_tmp37F,sizeof(void*),0U));});});
break;}};}};}
# 1783
