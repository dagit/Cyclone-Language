...
p->r=(void*)& Cyc_Absyn_Wild_p_val;}{
# 94
struct _tuple15 _tmp19=Cyc_Evexp_eval_const_uint_exp(_tmp2B);struct _tuple15 _tmp1A=_tmp19;unsigned _tmp1D;int _tmp1C;_LL15: _tmp1D=_tmp1A.f1;_tmp1C=_tmp1A.f2;_LL16:;
...
# 135
({struct Cyc_List_List*_tmp3EA=({struct Cyc_List_List*_tmp30=_cycalloc(sizeof(*_tmp30));({struct _tuple16*_tmp3E9=({struct _tuple16*_tmp2F=_cycalloc(sizeof(*_tmp2F));_tmp2F->f1=vd,_tmp2F->f2=e;_tmp2F;});_tmp30->hd=_tmp3E9;}),_tmp30->tl=*v_result_ptr;_tmp30;});*v_result_ptr=_tmp3EA;});}
# 137
...
void*_tmp3F1=t;Cyc_Tcutil_promote_array(_tmp3F1,rgn_opt == 0?Cyc_Absyn_new_evar(& Cyc_Tcutil_rko,({struct Cyc_Core_Opt*_tmp3B=_cycalloc(sizeof(*_tmp3B));({struct Cyc_List_List*_tmp3F0=Cyc_Tcenv_lookup_type_vars(te);_tmp3B->v=_tmp3F0;});_tmp3B;})): rgn_opt,0);}): t;}struct _tuple17{struct Cyc_Absyn_Tvar*f1;int f2;};
# 165
static struct _tuple17*Cyc_Tcpat_add_false(struct Cyc_Absyn_Tvar*tv){
return({struct _tuple17*_tmp3C=_cycalloc(sizeof(*_tmp3C));_tmp3C->f1=tv,_tmp3C->f2=0;_tmp3C;});}struct _tuple18{struct Cyc_Absyn_Tqual f1;void*f2;};struct _tuple19{struct Cyc_List_List*f1;struct Cyc_Absyn_Pat*f2;};struct _tuple20{struct Cyc_Absyn_Aggrfield*f1;struct Cyc_Absyn_Pat*f2;};
# 169
...
({struct _tuple17*_tmp41F=({struct _tuple17*_tmp63=_cycalloc(sizeof(*_tmp63));_tmp63->f1=_tmpEA,_tmp63->f2=0;_tmp63;});_tmp64->hd=_tmp41F;}),_tmp64->tl=(*res.tvars_and_bounds_opt).f1;_tmp64;});
# 264
...
void**_tmp86=0;
if(topt_ts != 0){
_tmp86=&(*((struct _tuple18*)topt_ts->hd)).f2;
topt_ts=topt_ts->tl;}{
# 385
struct Cyc_Absyn_Exp*new_access_exp=0;
if((unsigned)access_exp)
...
struct _tuple13 _tmpAA=({struct _tuple13 _tmp390;_tmp390.f1=_tmpA9,_tmp390.f2=rgn;_tmp390;});
struct Cyc_List_List*_tmpAB=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple14*(*f)(struct _tuple13*,struct Cyc_Absyn_Tvar*),struct _tuple13*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(rgn,Cyc_Tcutil_r_make_inst_var,& _tmpAA,_tmpF4->tvs);
...
struct Cyc_List_List*_tmpAD=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple14*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple14*))Cyc_Core_snd,_tmpAB);
struct Cyc_List_List*_tmpAE=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple14*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple14*))Cyc_Core_snd,_tmpAC);
...
struct Cyc_List_List*_tmp44A=(*res.tvars_and_bounds_opt).f1;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp44A,((struct Cyc_List_List*(*)(struct _tuple17*(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_add_false,_tmpF3));});
# 479
...
wild_dps=({struct Cyc_List_List*_tmpBB=_cycalloc(sizeof(*_tmpBB));({struct _tuple19*_tmp455=({struct _tuple19*_tmpBA=_cycalloc(sizeof(*_tmpBA));_tmpBA->f1=0,({struct Cyc_Absyn_Pat*_tmp454=Cyc_Tcpat_wild_pat(p->loc);_tmpBA->f2=_tmp454;});_tmpBA;});_tmpBB->hd=_tmp455;}),_tmpBB->tl=wild_dps;_tmpBB;});}}
...
struct _tuple20*_tmpBE=(struct _tuple20*)fields->hd;struct _tuple20*_tmpBF=_tmpBE;struct Cyc_Absyn_Aggrfield*_tmpC8;struct Cyc_Absyn_Pat*_tmpC7;_LL62: _tmpC8=_tmpBF->f1;_tmpC7=_tmpBF->f2;_LL63:;{
...
struct _tuple13 _tmpCD=({struct _tuple13 _tmp397;_tmp397.f1=_tmpCC,_tmp397.f2=Cyc_Core_heap_region;_tmp397;});
struct Cyc_List_List*_tmpCE=((struct Cyc_List_List*(*)(struct _tuple14*(*f)(struct _tuple13*,struct Cyc_Absyn_Tvar*),struct _tuple13*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcutil_r_make_inst_var,& _tmpCD,_tmpF8->tvs);
struct Cyc_List_List*_tmpCF=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple14*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple14*))Cyc_Core_snd,_tmpCE);
...
# 560
void*_tmpD7=Cyc_Tcutil_substitute(_tmpCE,(*((struct _tuple18*)tqts->hd)).f2);
# 563
if((unsigned)access_exp)
...
struct _tuple16*_tmpFF=(struct _tuple16*)x->hd;struct _tuple16*_tmp100=_tmpFF;struct Cyc_Absyn_Vardecl**_tmp102;struct Cyc_Absyn_Exp**_tmp101;_LL4: _tmp102=_tmp100->f1;_tmp101=(struct Cyc_Absyn_Exp**)& _tmp100->f2;_LL5:;
...
Cyc_Tcpat_check_pat_regions_rec(te,(*((struct _tuple19*)_tmp136->hd)).f2,did_noalias_deref,patvars);}
...
struct _tuple16*_tmp11E=(struct _tuple16*)x->hd;struct _tuple16*_tmp11F=_tmp11E;struct Cyc_Absyn_Vardecl**_tmp128;struct Cyc_Absyn_Exp*_tmp127;_LL17: _tmp128=_tmp11F->f1;_tmp127=_tmp11F->f2;_LL18:;
# 702
...
# 729
{struct Cyc_List_List*x=patvars;for(0;x != 0;x=x->tl){
struct _tuple16*_tmp12D=(struct _tuple16*)x->hd;struct _tuple16*_tmp12E=_tmp12D;struct Cyc_Absyn_Vardecl**_tmp134;struct Cyc_Absyn_Exp*_tmp133;_LL24: _tmp134=_tmp12E->f1;_tmp133=_tmp12E->f2;_LL25:;
# 733
...
struct Cyc_List_List*x=patvars;for(0;x != 0;x=x->tl){
struct _tuple16*_tmp141=(struct _tuple16*)x->hd;struct _tuple16*_tmp142=_tmp141;struct Cyc_Absyn_Vardecl**_tmp14C;struct Cyc_Absyn_Exp*_tmp14B;_LL1: _tmp14C=_tmp142->f1;_tmp14B=_tmp142->f2;_LL2:;
if(_tmp14B != 0){
...
struct _tuple19*_tmp16F=(struct _tuple19*)((struct Cyc_List_List*)_check_null(_tmp18A))->hd;struct _tuple19*_tmp170=_tmp16F;struct Cyc_List_List*_tmp178;struct Cyc_Absyn_Pat*_tmp177;_LL24: _tmp178=_tmp170->f1;_tmp177=_tmp170->f2;_LL25:;{
struct _fat_ptr*f;
...
struct _tuple19*_tmp1B1=(struct _tuple19*)dlps0->hd;struct _tuple19*_tmp1B2=_tmp1B1;struct Cyc_List_List*_tmp1B9;struct Cyc_Absyn_Pat*_tmp1B8;_LL34: _tmp1B9=_tmp1B2->f1;_tmp1B8=_tmp1B2->f2;_LL35:;{
...
struct Cyc_List_List*_tmp1BF=_tmp1D7;struct _fat_ptr*_tmp1C4;struct Cyc_Absyn_Pat*_tmp1C3;if(_tmp1BF != 0){if(((struct _tuple19*)((struct Cyc_List_List*)_tmp1BF)->hd)->f1 != 0){if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)((struct Cyc_List_List*)((struct _tuple19*)((struct Cyc_List_List*)_tmp1BF)->hd)->f1)->hd)->tag == 1U){if(((struct Cyc_List_List*)((struct _tuple19*)((struct Cyc_List_List*)_tmp1BF)->hd)->f1)->tl == 0){if(((struct Cyc_List_List*)_tmp1BF)->tl == 0){_LL3C: _tmp1C4=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)(((struct _tuple19*)_tmp1BF->hd)->f1)->hd)->f1;_tmp1C3=((struct _tuple19*)_tmp1BF->hd)->f2;_LL3D:
# 1089
...
struct Cyc_List_List*_tmp265=ctxt;struct Cyc_Tcpat_Con_s*_tmp26B;struct Cyc_List_List*_tmp26A;struct Cyc_List_List*_tmp269;if(_tmp265 == 0){_LL1: _LL2:
 return 0;}else{_LL3: _tmp26B=((struct _tuple22*)_tmp265->hd)->f1;_tmp26A=((struct _tuple22*)_tmp265->hd)->f2;_tmp269=_tmp265->tl;_LL4:
# 1335
 return({struct Cyc_List_List*_tmp268=_cycalloc(sizeof(*_tmp268));
({struct _tuple22*_tmp51A=({struct _tuple22*_tmp267=_cycalloc(sizeof(*_tmp267));_tmp267->f1=_tmp26B,({struct Cyc_List_List*_tmp519=({struct Cyc_List_List*_tmp266=_cycalloc(sizeof(*_tmp266));_tmp266->hd=dsc,_tmp266->tl=_tmp26A;_tmp266;});_tmp267->f2=_tmp519;});_tmp267;});_tmp268->hd=_tmp51A;}),_tmp268->tl=_tmp269;_tmp268;});}_LL0:;}
# 1343
...
({void*_tmp26D=0U;({struct _fat_ptr _tmp51B=({const char*_tmp26E="norm_context: empty context";_tag_fat(_tmp26E,sizeof(char),28U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp51B,_tag_fat(_tmp26D,sizeof(void*),0U));});});}else{_LL3: _tmp272=((struct _tuple22*)_tmp26C->hd)->f1;_tmp271=((struct _tuple22*)_tmp26C->hd)->f2;_tmp270=_tmp26C->tl;_LL4:
# 1347
...
struct Cyc_List_List*_tmp27F=allmrules;void*_tmp283;struct Cyc_Tcpat_Rhs*_tmp282;struct Cyc_List_List*_tmp281;if(_tmp27F == 0){_LL1: _LL2:
 return(void*)({struct Cyc_Tcpat_Failure_Tcpat_Decision_struct*_tmp280=_cycalloc(sizeof(*_tmp280));_tmp280->tag=0U,_tmp280->f1=dsc;_tmp280;});}else{_LL3: _tmp283=((struct _tuple23*)_tmp27F->hd)->f1;_tmp282=((struct _tuple23*)_tmp27F->hd)->f2;_tmp281=_tmp27F->tl;_LL4:
# 1379
...
struct Cyc_List_List*_tmp285=work;struct Cyc_List_List*_tmp29C;struct Cyc_List_List*_tmp29B;struct Cyc_List_List*_tmp29A;struct Cyc_List_List*_tmp299;struct Cyc_List_List*_tmp298;if(_tmp285 == 0){_LL1: _LL2:
 return(void*)({struct Cyc_Tcpat_Success_Tcpat_Decision_struct*_tmp286=_cycalloc(sizeof(*_tmp286));_tmp286->tag=1U,_tmp286->f1=right_hand_side;_tmp286;});}else{if(((struct _tuple21*)((struct Cyc_List_List*)_tmp285)->hd)->f1 == 0){if(((struct _tuple21*)((struct Cyc_List_List*)_tmp285)->hd)->f2 == 0){if(((struct _tuple21*)((struct Cyc_List_List*)_tmp285)->hd)->f3 == 0){_LL3: _tmp298=_tmp285->tl;_LL4:
# 1397
 return({struct Cyc_List_List*_tmp525=Cyc_Tcpat_norm_context(ctx);struct Cyc_List_List*_tmp524=_tmp298;struct Cyc_Tcpat_Rhs*_tmp523=right_hand_side;Cyc_Tcpat_and_match(_tmp525,_tmp524,_tmp523,rules);});}else{goto _LL5;}}else{goto _LL5;}}else{_LL5: _tmp29C=((struct _tuple21*)_tmp285->hd)->f1;_tmp29B=((struct _tuple21*)_tmp285->hd)->f2;_tmp29A=((struct _tuple21*)_tmp285->hd)->f3;_tmp299=_tmp285->tl;_LL6:
# 1399
...
struct _tuple21*_tmp28F=({struct _tuple21*_tmp291=_cycalloc(sizeof(*_tmp291));_tmp291->f1=_tmp296,_tmp291->f2=_tmp294,_tmp291->f3=_tmp292;_tmp291;});
...
struct _tuple24 _tmp2C6=({struct _tuple24 _tmp3B9;_tmp3B9.f1=obj,_tmp3B9.f2=pcon;_tmp3B9;});
return((struct Cyc_List_List*(*)(int n,struct Cyc_List_List*(*f)(struct _tuple24*,int),struct _tuple24*env))Cyc_List_tabulate_c)(pcon->arity,Cyc_Tcpat_getoarg,& _tmp2C6);}
# 1468
...
# 1478
struct Cyc_List_List*ctx2=({struct Cyc_List_List*_tmp2CD=_cycalloc(sizeof(*_tmp2CD));({struct _tuple22*_tmp53A=({struct _tuple22*_tmp2CC=_cycalloc(sizeof(*_tmp2CC));_tmp2CC->f1=_tmp2D5,_tmp2CC->f2=0;_tmp2CC;});_tmp2CD->hd=_tmp53A;}),_tmp2CD->tl=ctx;_tmp2CD;});
struct _tuple21*work_frame=({struct _tuple21*_tmp2CB=_cycalloc(sizeof(*_tmp2CB));_tmp2CB->f1=_tmp2D4,({struct Cyc_List_List*_tmp53C=Cyc_Tcpat_getoargs(_tmp2D5,obj);_tmp2CB->f2=_tmp53C;}),({
...
# 1486
struct Cyc_List_List*ctx2=({struct Cyc_List_List*_tmp2D3=_cycalloc(sizeof(*_tmp2D3));({struct _tuple22*_tmp53E=({struct _tuple22*_tmp2D2=_cycalloc(sizeof(*_tmp2D2));_tmp2D2->f1=_tmp2D5,_tmp2D2->f2=0;_tmp2D2;});_tmp2D3->hd=_tmp53E;}),_tmp2D3->tl=ctx;_tmp2D3;});
struct _tuple21*work_frame=({struct _tuple21*_tmp2D1=_cycalloc(sizeof(*_tmp2D1));_tmp2D1->f1=_tmp2D4,({struct Cyc_List_List*_tmp540=Cyc_Tcpat_getoargs(_tmp2D5,obj);_tmp2D1->f2=_tmp540;}),({
...
return({struct _tuple23*_tmp2E2=_cycalloc(sizeof(*_tmp2E2));_tmp2E2->f1=sp,_tmp2E2->f2=rhs;_tmp2E2;});}char Cyc_Tcpat_Desc2string[12U]="Desc2string";struct Cyc_Tcpat_Desc2string_exn_struct{char*tag;};
# 1545
...
struct Cyc_List_List*_tmp2F9=_tmp316;struct _fat_ptr*_tmp2FF;if(_tmp2F9 != 0){if(((struct _tuple19*)((struct Cyc_List_List*)_tmp2F9)->hd)->f1 != 0){if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)((struct Cyc_List_List*)((struct _tuple19*)((struct Cyc_List_List*)_tmp2F9)->hd)->f1)->hd)->tag == 1U){_LL2C: _tmp2FF=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)(((struct _tuple19*)_tmp2F9->hd)->f1)->hd)->f1;_LL2D:
# 1570
...
int _tmp357=0;
int*_tmp358=& _tmp357;
struct Cyc_List_List*_tmp359=((struct Cyc_List_List*(*)(struct _tuple23*(*f)(int*,struct Cyc_Absyn_Switch_clause*),int*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcpat_get_match,_tmp358,swcs);
...
struct _tuple23*_tmp35C=(struct _tuple23*)_tmp359->hd;struct _tuple23*_tmp35D=_tmp35C;int _tmp361;unsigned _tmp360;_LL1: _tmp361=(_tmp35D->f2)->used;_tmp360=(_tmp35D->f2)->pat_loc;_LL2:;
if(!_tmp361){
...
struct Cyc_List_List*_tmp36D=({struct Cyc_List_List*_tmp372=_cycalloc(sizeof(*_tmp372));({struct _tuple23*_tmp575=({struct _tuple23*_tmp371=_cycalloc(sizeof(*_tmp371));({void*_tmp574=Cyc_Tcpat_compile_pat(p);_tmp371->f1=_tmp574;}),_tmp371->f2=rhs;_tmp371;});_tmp372->hd=_tmp575;}),_tmp372->tl=0;_tmp372;});
void*_tmp36E=Cyc_Tcpat_match_compile(_tmp36D);
struct _tuple15 _tmp36F=({struct _tuple15 _tmp3D2;_tmp3D2.f1=loc,_tmp3D2.f2=1;_tmp3D2;});
int _tmp370=0;
((void(*)(void*d,void(*not_exhaust)(struct _tuple15*,void*),struct _tuple15*env1,void(*rhs_appears)(int,struct Cyc_Tcpat_Rhs*),int env2,int*exhaust_done))Cyc_Tcpat_check_exhaust_overlap)(_tmp36E,Cyc_Tcpat_not_exhaust_warn,& _tmp36F,Cyc_Tcpat_dummy_fn,0,& _tmp370);
# 1732
*dopt=_tmp36E;
return _tmp36F.f2;}
# 1740
...
return({struct _tuple23*_tmp376=_cycalloc(sizeof(*_tmp376));_tmp376->f1=sp0,_tmp376->f2=rhs;_tmp376;});};}
# 1750
...
# 1757
struct Cyc_List_List*_tmp378=((struct Cyc_List_List*(*)(struct _tuple23*(*f)(struct Cyc_Absyn_Switch_clause*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_get_match2,swcs);
...
struct _tuple23*_tmp37B=(struct _tuple23*)_tmp378->hd;struct _tuple23*_tmp37C=_tmp37B;int _tmp380;unsigned _tmp37F;_LL1: _tmp380=(_tmp37C->f2)->used;_tmp37F=(_tmp37C->f2)->pat_loc;_LL2:;
if(!_tmp380){
...
if((*((struct _tuple16*)_tmp381->hd)).f1 != 0)
return 1;}}
return 0;}
