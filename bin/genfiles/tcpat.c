...
# 53
({void*_tmp3E3=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp5=_cycalloc(sizeof(*_tmp5));({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct _tmp3E2=({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct _tmp6;_tmp6.tag=7U;({struct Cyc_Absyn_AggrInfo*_tmp3E1=({struct Cyc_Absyn_AggrInfo*_tmp7=_cycalloc(sizeof(*_tmp7));_tmp7[0]=_tmpB;_tmp7;});_tmp6.f1=_tmp3E1;});_tmp6.f2=_tmp2C;_tmp6.f3=_tmp2B;_tmp6.f4=_tmp2A;_tmp6;});_tmp5[0]=_tmp3E2;});_tmp5;});p->r=_tmp3E3;});
Cyc_Tcpat_resolve_pat(te,topt,p);
goto _LLF;}else{_LL12: _LL13:
# 57
({struct Cyc_String_pa_PrintArg_struct _tmpA;_tmpA.tag=0U;({struct _dyneither_ptr _tmp3E4=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmpA.f1=_tmp3E4;});({void*_tmp8[1U]={& _tmpA};({unsigned int _tmp3E6=p->loc;struct _dyneither_ptr _tmp3E5=({const char*_tmp9="pattern expects aggregate type instead of %s";_tag_dyneither(_tmp9,sizeof(char),45U);});Cyc_Tcutil_terr(_tmp3E6,_tmp3E5,_tag_dyneither(_tmp8,sizeof(void*),1U));});});});
goto _LLF;}_LLF:;}
# 60
return;};}else{if(((((struct Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1)->f1)->aggr_info).KnownAggr).tag == 2U){_LL3: _tmp31=(((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1)->f1)->aggr_info).KnownAggr).val;_tmp30=(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1)->f1)->targs;_tmp2F=(struct Cyc_List_List**)&((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1)->f2;_tmp2E=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1)->f3;_tmp2D=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1)->f4;_LL4: {
# 63
struct Cyc_Absyn_Aggrdecl*_tmpC=*_tmp31;
if(_tmpC->impl == 0){
({struct Cyc_String_pa_PrintArg_struct _tmpF;_tmpF.tag=0U;({struct _dyneither_ptr _tmp3E7=(struct _dyneither_ptr)(
_tmpC->kind == Cyc_Absyn_StructA?({const char*_tmp10="struct";_tag_dyneither(_tmp10,sizeof(char),7U);}):({const char*_tmp11="union";_tag_dyneither(_tmp11,sizeof(char),6U);}));_tmpF.f1=_tmp3E7;});({void*_tmpD[1U]={& _tmpF};({unsigned int _tmp3E9=p->loc;struct _dyneither_ptr _tmp3E8=({const char*_tmpE="can't destructure an abstract %s";_tag_dyneither(_tmpE,sizeof(char),33U);});Cyc_Tcutil_terr(_tmp3E9,_tmp3E8,_tag_dyneither(_tmpD,sizeof(void*),1U));});});});
...
if(more_exists < 0){
({void*_tmp12=0U;({unsigned int _tmp3EC=p->loc;struct _dyneither_ptr _tmp3EB=({const char*_tmp13="too many existentially bound type variables in pattern";_tag_dyneither(_tmp13,sizeof(char),55U);});Cyc_Tcutil_terr(_tmp3EC,_tmp3EB,_tag_dyneither(_tmp12,sizeof(void*),0U));});});{
...
# 97
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp27=_cycalloc(sizeof(*_tmp27));({struct Cyc_Core_Impossible_exn_struct _tmp3F2=({struct Cyc_Core_Impossible_exn_struct _tmp28;_tmp28.tag=Cyc_Core_Impossible;({struct _dyneither_ptr _tmp3F1=({const char*_tmp29="resolve_pat unknownAggr";_tag_dyneither(_tmp29,sizeof(char),24U);});_tmp28.f1=_tmp3F1;});_tmp28;});_tmp27[0]=_tmp3F2;});_tmp27;}));}}case 17U: _LL5: _tmp32=((struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp1)->f1;_LL6:
# 86
 Cyc_Tcexp_tcExp(te,0,_tmp32);
if(!Cyc_Tcutil_is_const_exp(_tmp32)){
({void*_tmp19=0U;({unsigned int _tmp3F4=p->loc;struct _dyneither_ptr _tmp3F3=({const char*_tmp1A="non-constant expression in case pattern";_tag_dyneither(_tmp1A,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp3F4,_tmp3F3,_tag_dyneither(_tmp19,sizeof(void*),0U));});});
p->r=(void*)& Cyc_Absyn_Wild_p_val;}{
# 91
...
({void*_tmp3F6=(void*)({struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmp1D=_cycalloc_atomic(sizeof(*_tmp1D));({struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct _tmp3F5=({struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct _tmp1E;_tmp1E.tag=10U;_tmp1E.f1=Cyc_Absyn_None;_tmp1E.f2=(int)_tmp20;_tmp1E;});_tmp1D[0]=_tmp3F5;});_tmp1D;});p->r=_tmp3F6;});
return;};case 15U: _LL7: _LL8:
# 95
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp21=_cycalloc(sizeof(*_tmp21));({struct Cyc_Core_Impossible_exn_struct _tmp3F8=({struct Cyc_Core_Impossible_exn_struct _tmp22;_tmp22.tag=Cyc_Core_Impossible;({struct _dyneither_ptr _tmp3F7=({const char*_tmp23="resolve_pat UnknownId_p";_tag_dyneither(_tmp23,sizeof(char),24U);});_tmp22.f1=_tmp3F7;});_tmp22;});_tmp21[0]=_tmp3F8;});_tmp21;}));case 16U: _LL9: _LLA:
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp24=_cycalloc(sizeof(*_tmp24));({struct Cyc_Core_Impossible_exn_struct _tmp3FA=({struct Cyc_Core_Impossible_exn_struct _tmp25;_tmp25.tag=Cyc_Core_Impossible;({struct _dyneither_ptr _tmp3F9=({const char*_tmp26="resolve_pat UnknownCall_p";_tag_dyneither(_tmp26,sizeof(char),26U);});_tmp25.f1=_tmp3F9;});_tmp25;});_tmp24[0]=_tmp3FA;});_tmp24;}));default: _LLD: _LLE:
# 99
 return;}_LL0:;}
# 103
...
return*topt;
# 118
{void*_tmp34=Cyc_Tcutil_compress(numt);void*_tmp35=_tmp34;switch(*((int*)_tmp35)){case 13U: _LL18: _LL19:
 goto _LL1B;case 14U: _LL1A: _LL1B:
...
if(vd != 0){
(*vd)->type=t;
({struct Cyc_Absyn_Tqual _tmp3FB=Cyc_Absyn_empty_tqual(0U);(*vd)->tq=_tmp3FB;});}
# 132
...
# 174
{void*_tmp46=p->r;void*_tmp47=_tmp46;struct Cyc_Absyn_Datatypedecl*_tmp117;struct Cyc_Absyn_Datatypefield*_tmp116;struct Cyc_List_List**_tmp115;int _tmp114;struct Cyc_Absyn_Aggrdecl*_tmp113;struct Cyc_List_List**_tmp112;struct Cyc_List_List*_tmp111;struct Cyc_List_List**_tmp110;int _tmp10F;struct Cyc_List_List**_tmp10E;int _tmp10D;struct Cyc_Absyn_Pat*_tmp10C;void*_tmp10B;struct Cyc_Absyn_Enumdecl*_tmp10A;int _tmp109;struct Cyc_Absyn_Tvar*_tmp108;struct Cyc_Absyn_Vardecl*_tmp107;struct Cyc_Absyn_Vardecl*_tmp106;struct Cyc_Absyn_Pat*_tmp105;struct Cyc_Absyn_Tvar*_tmp104;struct Cyc_Absyn_Vardecl*_tmp103;struct Cyc_Absyn_Vardecl*_tmp102;struct Cyc_Absyn_Pat*_tmp101;switch(*((int*)_tmp47)){case 0U: _LL25: _LL26:
# 177
 if(topt != 0)
t=*topt;else{
# 180
({void*_tmp408=({struct Cyc_List_List*_tmp407=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tcpat_any_type(_tmp407,topt);});t=_tmp408;});}
goto _LL24;case 1U: _LL27: _tmp102=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp47)->f1;_tmp101=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp47)->f2;_LL28: {
# 184
...
if(({struct _dyneither_ptr _tmp40A=(struct _dyneither_ptr)_tmp56;Cyc_strcmp(_tmp40A,({const char*_tmp4A="true";_tag_dyneither(_tmp4A,sizeof(char),5U);}));})== 0  || ({struct _dyneither_ptr _tmp409=(struct _dyneither_ptr)_tmp56;Cyc_strcmp(_tmp409,({const char*_tmp4B="false";_tag_dyneither(_tmp4B,sizeof(char),6U);}));})== 0)
({struct Cyc_String_pa_PrintArg_struct _tmp4E;_tmp4E.tag=0U;_tmp4E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp56);({void*_tmp4C[1U]={& _tmp4E};({unsigned int _tmp40C=p->loc;struct _dyneither_ptr _tmp40B=({const char*_tmp4D="you probably do not want to use %s as a local variable...";_tag_dyneither(_tmp4D,sizeof(char),58U);});Cyc_Tcutil_warn(_tmp40C,_tmp40B,_tag_dyneither(_tmp4C,sizeof(void*),1U));});});});
# 188
...
# 192
{void*_tmp4F=Cyc_Tcutil_compress(t);void*_tmp50=_tmp4F;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp50)->tag == 8U){_LL55: _LL56:
# 194
 if(rgn_pat == 0  || !allow_ref_pat)
({void*_tmp51=0U;({unsigned int _tmp40F=p->loc;struct _dyneither_ptr _tmp40E=({const char*_tmp52="array reference would point into unknown/unallowed region";_tag_dyneither(_tmp52,sizeof(char),58U);});Cyc_Tcutil_terr(_tmp40F,_tmp40E,_tag_dyneither(_tmp51,sizeof(void*),0U));});});
goto _LL54;}else{_LL57: _LL58:
# 198
 if(!Cyc_Tcutil_kind_leq(Cyc_Tcutil_typ_kind(t),& Cyc_Tcutil_tmk))
({void*_tmp53=0U;({unsigned int _tmp411=p->loc;struct _dyneither_ptr _tmp410=({const char*_tmp54="pattern would point to an abstract member";_tag_dyneither(_tmp54,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp411,_tmp410,_tag_dyneither(_tmp53,sizeof(void*),0U));});});
goto _LL54;}_LL54:;}
# 202
...
goto _LL24;}case 2U: _LL29: _tmp104=((struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp47)->f1;_tmp103=((struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp47)->f2;_LL2A: {
# 205
struct Cyc_Tcenv_Tenv*te2=({unsigned int _tmp416=p->loc;struct Cyc_Tcenv_Tenv*_tmp415=te;Cyc_Tcenv_add_type_vars(_tmp416,_tmp415,({struct Cyc_Absyn_Tvar*_tmp61[1U];_tmp61[0U]=_tmp104;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp61,sizeof(struct Cyc_Absyn_Tvar*),1U));}));});
...
{void*_tmp5A=Cyc_Tcutil_compress(t);void*_tmp5B=_tmp5A;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp5B)->tag == 8U){_LL5A: _LL5B:
# 217
 if(rgn_pat == 0  || !allow_ref_pat)
({void*_tmp5C=0U;({unsigned int _tmp421=p->loc;struct _dyneither_ptr _tmp420=({const char*_tmp5D="array reference would point into unknown/unallowed region";_tag_dyneither(_tmp5D,sizeof(char),58U);});Cyc_Tcutil_terr(_tmp421,_tmp420,_tag_dyneither(_tmp5C,sizeof(void*),0U));});});
goto _LL59;}else{_LL5C: _LL5D:
# 221
 if(!Cyc_Tcutil_kind_leq(Cyc_Tcutil_typ_kind(t),& Cyc_Tcutil_tmk))
({void*_tmp5E=0U;({unsigned int _tmp423=p->loc;struct _dyneither_ptr _tmp422=({const char*_tmp5F="pattern would point to an abstract member";_tag_dyneither(_tmp5F,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp423,_tmp422,_tag_dyneither(_tmp5E,sizeof(void*),0U));});});
goto _LL59;}_LL59:;}
# 225
...
goto _LL24;}case 3U: _LL2B: _tmp106=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp47)->f1;_tmp105=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp47)->f2;_LL2C:
# 229
...
({void*_tmp62=0U;({unsigned int _tmp429=p->loc;struct _dyneither_ptr _tmp428=({const char*_tmp63="* pattern would point into an unknown/unallowed region";_tag_dyneither(_tmp63,sizeof(char),55U);});Cyc_Tcutil_terr(_tmp429,_tmp428,_tag_dyneither(_tmp62,sizeof(void*),0U));});});
goto _LL24;}else{
# 236
if(Cyc_Tcutil_is_noalias_pointer_or_aggr(t))
({void*_tmp64=0U;({unsigned int _tmp42B=p->loc;struct _dyneither_ptr _tmp42A=({const char*_tmp65="* pattern cannot take the address of an alias-free path";_tag_dyneither(_tmp65,sizeof(char),56U);});Cyc_Tcutil_terr(_tmp42B,_tmp42A,_tag_dyneither(_tmp64,sizeof(void*),0U));});});}{
# 239
struct Cyc_Absyn_Exp*new_access_exp=0;
void*t2=(void*)({struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp67=_cycalloc(sizeof(*_tmp67));({struct Cyc_Absyn_PointerType_Absyn_Type_struct _tmp431=({struct Cyc_Absyn_PointerType_Absyn_Type_struct _tmp68;_tmp68.tag=5U;({struct Cyc_Absyn_PtrInfo _tmp430=({struct Cyc_Absyn_PtrInfo _tmp69;_tmp69.elt_typ=t;({struct Cyc_Absyn_Tqual _tmp42C=Cyc_Absyn_empty_tqual(0U);_tmp69.elt_tq=_tmp42C;});({struct Cyc_Absyn_PtrAtts _tmp42F=({(_tmp69.ptr_atts).rgn=rgn_pat;(_tmp69.ptr_atts).nullable=Cyc_Absyn_false_conref;({union Cyc_Absyn_Constraint*_tmp42D=
# 242
...
({struct Cyc_Absyn_Exp*_tmp432=Cyc_Absyn_address_exp(access_exp,0U);new_access_exp=_tmp432;});
...
goto _LL24;};case 4U: _LL2D: _tmp108=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp47)->f1;_tmp107=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp47)->f2;_LL2E:
# 254
...
# 258
({unsigned int _tmp43A=p->loc;struct Cyc_Tcenv_Tenv*_tmp439=te;Cyc_Tcenv_add_type_vars(_tmp43A,_tmp439,({struct Cyc_Absyn_Tvar*_tmp6B[1U];_tmp6B[0U]=_tmp108;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp6B,sizeof(struct Cyc_Absyn_Tvar*),1U));}));});
if(res.tvars_and_bounds_opt == 0)
...
goto _LL24;case 10U: switch(((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp47)->f1){case Cyc_Absyn_Unsigned: _LL2F: _LL30:
# 266
...
({void*_tmp43F=Cyc_Tcpat_num_type(topt,Cyc_Absyn_sint_typ);t=_tmp43F;});goto _LL24;}case 11U: _LL35: _LL36:
({void*_tmp440=Cyc_Tcpat_num_type(topt,Cyc_Absyn_char_typ);t=_tmp440;});goto _LL24;case 12U: _LL37: _tmp109=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp47)->f2;_LL38:
({void*_tmp442=({void**_tmp441=topt;Cyc_Tcpat_num_type(_tmp441,Cyc_Absyn_float_typ(_tmp109));});t=_tmp442;});goto _LL24;case 13U: _LL39: _tmp10A=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp47)->f1;_LL3A:
# 272
({void*_tmp445=({void**_tmp444=topt;Cyc_Tcpat_num_type(_tmp444,(void*)({struct Cyc_Absyn_EnumType_Absyn_Type_struct*_tmp6F=_cycalloc(sizeof(*_tmp6F));({struct Cyc_Absyn_EnumType_Absyn_Type_struct _tmp443=({struct Cyc_Absyn_EnumType_Absyn_Type_struct _tmp70;_tmp70.tag=13U;_tmp70.f1=_tmp10A->name;_tmp70.f2=_tmp10A;_tmp70;});_tmp6F[0]=_tmp443;});_tmp6F;}));});t=_tmp445;});
goto _LL24;case 14U: _LL3B: _tmp10B=(void*)((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp47)->f1;_LL3C:
({void*_tmp446=Cyc_Tcpat_num_type(topt,_tmp10B);t=_tmp446;});goto _LL24;case 9U: _LL3D: _LL3E:
# 276
 if(topt != 0){
void*_tmp71=Cyc_Tcutil_compress(*topt);void*_tmp72=_tmp71;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp72)->tag == 5U){_LL5F: _LL60:
 t=*topt;goto tcpat_end;}else{_LL61: _LL62:
 goto _LL5E;}_LL5E:;}{
# 281
struct Cyc_Core_Opt*_tmp73=Cyc_Tcenv_lookup_opt_type_vars(te);
({void*_tmp44F=(void*)({struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp74=_cycalloc(sizeof(*_tmp74));({struct Cyc_Absyn_PointerType_Absyn_Type_struct _tmp44E=({struct Cyc_Absyn_PointerType_Absyn_Type_struct _tmp75;_tmp75.tag=5U;({struct Cyc_Absyn_PtrInfo _tmp44D=({struct Cyc_Absyn_PtrInfo _tmp76;({void*_tmp447=Cyc_Absyn_new_evar(& Cyc_Tcutil_ako,_tmp73);_tmp76.elt_typ=_tmp447;});({struct Cyc_Absyn_Tqual _tmp448=
Cyc_Absyn_empty_tqual(0U);_tmp76.elt_tq=_tmp448;});({struct Cyc_Absyn_PtrAtts _tmp44C=({({void*_tmp449=
...
struct Cyc_Absyn_Exp*new_access_exp=0;
if((unsigned int)access_exp)({struct Cyc_Absyn_Exp*_tmp450=Cyc_Absyn_deref_exp(access_exp,0U);new_access_exp=_tmp450;});
...
# 338
 DONT_PROMOTE:
({void*_tmp463=(void*)({struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp87=_cycalloc(sizeof(*_tmp87));({struct Cyc_Absyn_PointerType_Absyn_Type_struct _tmp462=({struct Cyc_Absyn_PointerType_Absyn_Type_struct _tmp88;_tmp88.tag=5U;({struct Cyc_Absyn_PtrInfo _tmp461=({struct Cyc_Absyn_PtrInfo _tmp89;_tmp89.elt_typ=(void*)_check_null(_tmp10C->topt);({struct Cyc_Absyn_Tqual _tmp45C=
elt_const?Cyc_Absyn_const_tqual(0U):
 Cyc_Absyn_empty_tqual(0U);_tmp89.elt_tq=_tmp45C;});({struct Cyc_Absyn_PtrAtts _tmp460=({(_tmp89.ptr_atts).rgn=ptr_rgn;({union Cyc_Absyn_Constraint*_tmp45D=
...
goto _LL24;};}case 5U: _LL41: _tmp10E=(struct Cyc_List_List**)&((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp47)->f1;_tmp10D=((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp47)->f2;_LL42: {
# 350
struct Cyc_List_List*_tmp8D=*_tmp10E;
struct Cyc_List_List*pat_ts=0;
struct Cyc_List_List*topt_ts=0;
if(topt != 0){
void*_tmp8E=Cyc_Tcutil_compress(*topt);void*_tmp8F=_tmp8E;struct Cyc_List_List*_tmp95;if(((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp8F)->tag == 10U){_LL73: _tmp95=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp8F)->f1;_LL74:
# 356
 topt_ts=_tmp95;
if(_tmp10D){
# 359
...
({void*_tmp93=0U;({unsigned int _tmp469=p->loc;struct _dyneither_ptr _tmp468=({const char*_tmp94="unnecessary ... in tuple pattern";_tag_dyneither(_tmp94,sizeof(char),33U);});Cyc_Tcutil_warn(_tmp469,_tmp468,_tag_dyneither(_tmp93,sizeof(void*),0U));});});}}
# 371
...
# 375
if(_tmp10D)
({void*_tmp96=0U;({unsigned int _tmp46B=p->loc;struct _dyneither_ptr _tmp46A=({const char*_tmp97="cannot determine missing fields for ... in tuple pattern";_tag_dyneither(_tmp97,sizeof(char),57U);});Cyc_Tcutil_terr(_tmp46B,_tmp46A,_tag_dyneither(_tmp96,sizeof(void*),0U));});});}
...
Cyc_Absyn_const_exp(({union Cyc_Absyn_Cnst _tmp99;({struct _tuple7 _tmp46C=({struct _tuple7 _tmp9A;_tmp9A.f1=Cyc_Absyn_Unsigned;_tmp9A.f2=i;_tmp9A;});(_tmp99.Int_c).val=_tmp46C;});(_tmp99.Int_c).tag=5;_tmp99;}),0U),0U);});
# 385
...
if(_tmp113->impl == 0){
({struct Cyc_String_pa_PrintArg_struct _tmpA2;_tmpA2.tag=0U;_tmpA2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)aggr_str);({void*_tmpA0[1U]={& _tmpA2};({unsigned int _tmp478=p->loc;struct _dyneither_ptr _tmp477=({const char*_tmpA1="can't destructure an abstract %s";_tag_dyneither(_tmpA1,sizeof(char),33U);});Cyc_Tcutil_terr(_tmp478,_tmp477,_tag_dyneither(_tmpA0,sizeof(void*),1U));});});});
...
{void*_tmpA8=_tmpA7;struct Cyc_Absyn_Kind*_tmpAC;struct Cyc_Absyn_Kind*_tmpAB;switch(*((int*)_tmpA8)){case 2U: _LL78: _tmpAB=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmpA8)->f2;_LL79:
 _tmpAC=_tmpAB;goto _LL7B;case 0U: _LL7A: _tmpAC=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmpA8)->f1;_LL7B:
 k2=_tmpAC;goto _LL77;default: _LL7C: _LL7D:
({void*_tmpA9=0U;({struct _dyneither_ptr _tmp47A=({const char*_tmpAA="unconstrained existential type variable in aggregate";_tag_dyneither(_tmpAA,sizeof(char),53U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp47A,_tag_dyneither(_tmpA9,sizeof(void*),0U));});});}_LL77:;}
# 434
{void*_tmpAD=_tmpA6;struct Cyc_Core_Opt**_tmpB2;struct Cyc_Core_Opt**_tmpB1;struct Cyc_Absyn_Kind*_tmpB0;struct Cyc_Absyn_Kind*_tmpAF;switch(*((int*)_tmpAD)){case 0U: _LL7F: _tmpAF=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmpAD)->f1;_LL80:
# 437
 if(!Cyc_Tcutil_kind_leq(k2,_tmpAF))
error=1;
goto _LL7E;case 2U: _LL81: _tmpB1=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmpAD)->f1;_tmpB0=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmpAD)->f2;_LL82:
...
# 443
if(error)
({struct Cyc_String_pa_PrintArg_struct _tmpB7;_tmpB7.tag=0U;({struct _dyneither_ptr _tmp47C=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 447
Cyc_Absynpp_kind2string(k2));_tmpB7.f1=_tmp47C;});({struct Cyc_String_pa_PrintArg_struct _tmpB6;_tmpB6.tag=0U;({struct _dyneither_ptr _tmp47D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kindbound2string(_tmpA6));_tmpB6.f1=_tmp47D;});({struct Cyc_String_pa_PrintArg_struct _tmpB5;_tmpB5.tag=0U;_tmpB5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*tv->name);({void*_tmpB3[3U]={& _tmpB5,& _tmpB6,& _tmpB7};({unsigned int _tmp47F=p->loc;struct _dyneither_ptr _tmp47E=({const char*_tmpB4="type variable %s has kind %s but must have at least kind %s";_tag_dyneither(_tmpB4,sizeof(char),60U);});Cyc_Tcutil_terr(_tmp47F,_tmp47E,_tag_dyneither(_tmpB3,sizeof(void*),3U));});});});});});{
# 449
void*vartype=(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmpBD=_cycalloc(sizeof(*_tmpBD));({struct Cyc_Absyn_VarType_Absyn_Type_struct _tmp480=({struct Cyc_Absyn_VarType_Absyn_Type_struct _tmpBE;_tmpBE.tag=2U;_tmpBE.f1=tv;_tmpBE;});_tmpBD[0]=_tmp480;});_tmpBD;});
...
# 458
({void*_tmpBB=0U;({struct _dyneither_ptr _tmp484=({const char*_tmpBC="opened existential had unique or top region kind";_tag_dyneither(_tmpBC,sizeof(char),49U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp484,_tag_dyneither(_tmpBB,sizeof(void*),0U));});});}}};};}}
# 462
...
_tmp9F=*_tmp110;}else{
if(_tmpD1 == _tmpD2)
({void*_tmpD5=0U;({unsigned int _tmp49B=p->loc;struct _dyneither_ptr _tmp49A=({const char*_tmpD6="unnecessary ... in struct pattern";_tag_dyneither(_tmpD6,sizeof(char),34U);});Cyc_Tcutil_warn(_tmp49B,_tmp49A,_tag_dyneither(_tmpD5,sizeof(void*),0U));});});}}}{
# 508
...
struct Cyc_Absyn_Exp*new_access_exp=0;
if((unsigned int)access_exp)
({struct Cyc_Absyn_Exp*_tmp49C=Cyc_Absyn_aggrmember_exp(access_exp,_tmpE1->name,0U);new_access_exp=_tmp49C;});
...
({struct Cyc_String_pa_PrintArg_struct _tmpDF;_tmpDF.tag=0U;({struct _dyneither_ptr _tmp49F=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 525
Cyc_Absynpp_typ2string((void*)_check_null(_tmpE0->topt)));_tmpDF.f1=_tmp49F;});({struct Cyc_String_pa_PrintArg_struct _tmpDE;_tmpDE.tag=0U;({struct _dyneither_ptr _tmp4A0=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 524
Cyc_Absynpp_typ2string(_tmpD9));_tmpDE.f1=_tmp4A0;});({struct Cyc_String_pa_PrintArg_struct _tmpDD;_tmpDD.tag=0U;_tmpDD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)aggr_str);({struct Cyc_String_pa_PrintArg_struct _tmpDC;_tmpDC.tag=0U;_tmpDC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmpE1->name);({void*_tmpDA[4U]={& _tmpDC,& _tmpDD,& _tmpDE,& _tmpDF};({unsigned int _tmp4A2=p->loc;struct _dyneither_ptr _tmp4A1=({const char*_tmpDB="field %s of %s pattern expects type %s != %s";_tag_dyneither(_tmpDB,sizeof(char),45U);});Cyc_Tcutil_terr(_tmp4A2,_tmp4A1,_tag_dyneither(_tmpDA,sizeof(void*),4U));});});});});});});
# 526
...
({void*_tmp4A6=(void*)({struct Cyc_Absyn_DatatypeFieldType_Absyn_Type_struct*_tmpEA=_cycalloc(sizeof(*_tmpEA));({struct Cyc_Absyn_DatatypeFieldType_Absyn_Type_struct _tmp4A5=({struct Cyc_Absyn_DatatypeFieldType_Absyn_Type_struct _tmpEB;_tmpEB.tag=4U;({struct Cyc_Absyn_DatatypeFieldInfo _tmp4A4=({struct Cyc_Absyn_DatatypeFieldInfo _tmpEC;({union Cyc_Absyn_DatatypeFieldInfoU _tmp4A3=Cyc_Absyn_KnownDatatypefield(_tmp117,_tmp116);_tmpEC.field_info=_tmp4A3;});_tmpEC.targs=_tmpE9;_tmpEC;});_tmpEB.f1=_tmp4A4;});_tmpEB;});_tmpEA[0]=_tmp4A5;});_tmpEA;});t=_tmp4A6;});
# 541
if(_tmp114){
# 543
...
_tmpE5=*_tmp115;}else{
if(_tmpED == _tmpEE)
({struct Cyc_String_pa_PrintArg_struct _tmpF2;_tmpF2.tag=0U;({struct _dyneither_ptr _tmp4AA=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp117->name));_tmpF2.f1=_tmp4AA;});({void*_tmpF0[1U]={& _tmpF2};({unsigned int _tmp4AC=p->loc;struct _dyneither_ptr _tmp4AB=({const char*_tmpF1="unnecessary ... in datatype field %s";_tag_dyneither(_tmpF1,sizeof(char),37U);});Cyc_Tcutil_warn(_tmp4AC,_tmp4AB,_tag_dyneither(_tmpF0,sizeof(void*),1U));});});});}}
# 555
...
({struct Cyc_String_pa_PrintArg_struct _tmpF9;_tmpF9.tag=0U;({struct _dyneither_ptr _tmp4AF=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 572
Cyc_Absynpp_typ2string((void*)_check_null(_tmpF3->topt)));_tmpF9.f1=_tmp4AF;});({struct Cyc_String_pa_PrintArg_struct _tmpF8;_tmpF8.tag=0U;({struct _dyneither_ptr _tmp4B0=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 571
Cyc_Absynpp_typ2string(_tmpF4));_tmpF8.f1=_tmp4B0;});({struct Cyc_String_pa_PrintArg_struct _tmpF7;_tmpF7.tag=0U;({struct _dyneither_ptr _tmp4B1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp116->name));_tmpF7.f1=_tmp4B1;});({void*_tmpF5[3U]={& _tmpF7,& _tmpF8,& _tmpF9};({unsigned int _tmp4B3=_tmpF3->loc;struct _dyneither_ptr _tmp4B2=({const char*_tmpF6="%s expects argument type %s, not %s";_tag_dyneither(_tmpF6,sizeof(char),36U);});Cyc_Tcutil_terr(_tmp4B3,_tmp4B2,_tag_dyneither(_tmpF5,sizeof(void*),3U));});});});});});}
# 574
if(_tmpE5 != 0)
({struct Cyc_String_pa_PrintArg_struct _tmpFC;_tmpFC.tag=0U;({struct _dyneither_ptr _tmp4B4=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp116->name));_tmpFC.f1=_tmp4B4;});({void*_tmpFA[1U]={& _tmpFC};({unsigned int _tmp4B6=p->loc;struct _dyneither_ptr _tmp4B5=({const char*_tmpFB="too many arguments for datatype constructor %s";_tag_dyneither(_tmpFB,sizeof(char),47U);});Cyc_Tcutil_terr(_tmp4B6,_tmp4B5,_tag_dyneither(_tmpFA,sizeof(void*),1U));});});});
if(tqts != 0)
({struct Cyc_String_pa_PrintArg_struct _tmpFF;_tmpFF.tag=0U;({struct _dyneither_ptr _tmp4B7=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp116->name));_tmpFF.f1=_tmp4B7;});({void*_tmpFD[1U]={& _tmpFF};({unsigned int _tmp4B9=p->loc;struct _dyneither_ptr _tmp4B8=({const char*_tmpFE="too few arguments for datatype constructor %s";_tag_dyneither(_tmpFE,sizeof(char),46U);});Cyc_Tcutil_terr(_tmp4B9,_tmp4B8,_tag_dyneither(_tmpFD,sizeof(void*),1U));});});});
goto _LL24;}case 15U: _LL4B: _LL4C:
# 584
 goto _LL4E;case 17U: _LL4D: _LL4E:
...
# 641
struct Cyc_List_List*assump=({struct Cyc_List_List*_tmp138=_cycalloc(sizeof(*_tmp138));({struct _tuple0*_tmp4C6=({struct _tuple0*_tmp139=_cycalloc(sizeof(*_tmp139));_tmp139->f1=(void*)& Cyc_Absyn_UniqueRgn_val;({void*_tmp4C5=(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp13A=_cycalloc(sizeof(*_tmp13A));({struct Cyc_Absyn_VarType_Absyn_Type_struct _tmp4C4=({struct Cyc_Absyn_VarType_Absyn_Type_struct _tmp13B;_tmp13B.tag=2U;_tmp13B.f1=tv;_tmp13B;});_tmp13A[0]=_tmp4C4;});_tmp13A;});_tmp139->f2=_tmp4C5;});_tmp139;});_tmp138->hd=_tmp4C6;});_tmp138->tl=0;_tmp138;});
if(Cyc_Tcutil_subtype(tenv,assump,old_type,new_type)){
# 659 "tcpat.cyc"
struct _tuple0 _tmp12D=({struct _tuple0 _tmp133;({void*_tmp4C7=Cyc_Tcutil_compress(old_type);_tmp133.f1=_tmp4C7;});({void*_tmp4C8=Cyc_Tcutil_compress(new_type);_tmp133.f2=_tmp4C8;});_tmp133;});struct _tuple0 _tmp12E=_tmp12D;struct Cyc_Absyn_PtrInfo _tmp132;struct Cyc_Absyn_PtrInfo _tmp131;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp12E.f1)->tag == 5U){if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp12E.f2)->tag == 5U){_LL94: _tmp132=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp12E.f1)->f1;_tmp131=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp12E.f2)->f1;_LL95:
 goto _LL93;}else{goto _LL96;}}else{_LL96: _LL97:
({void*_tmp12F=0U;({unsigned int _tmp4CA=loc;struct _dyneither_ptr _tmp4C9=({const char*_tmp130="alias requires pointer type";_tag_dyneither(_tmp130,sizeof(char),28U);});Cyc_Tcutil_terr(_tmp4CA,_tmp4C9,_tag_dyneither(_tmp12F,sizeof(void*),0U));});});goto _LL93;}_LL93:;}else{
# 664
({struct Cyc_String_pa_PrintArg_struct _tmp137;_tmp137.tag=0U;({struct _dyneither_ptr _tmp4CB=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(new_type));_tmp137.f1=_tmp4CB;});({struct Cyc_String_pa_PrintArg_struct _tmp136;_tmp136.tag=0U;({struct _dyneither_ptr _tmp4CC=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(old_type));_tmp136.f1=_tmp4CC;});({void*_tmp134[2U]={& _tmp136,& _tmp137};({unsigned int _tmp4CE=loc;struct _dyneither_ptr _tmp4CD=({const char*_tmp135="cannot alias value of type %s to type %s";_tag_dyneither(_tmp135,sizeof(char),41U);});Cyc_Tcutil_terr(_tmp4CE,_tmp4CD,_tag_dyneither(_tmp134,sizeof(void*),2U));});});});});}}
# 671
...
# 675
void*_tmp13C=p->r;void*_tmp13D=_tmp13C;struct Cyc_Absyn_Tvar*_tmp166;struct Cyc_Absyn_Vardecl*_tmp165;struct Cyc_Absyn_Vardecl*_tmp164;struct Cyc_Absyn_Pat*_tmp163;struct Cyc_Absyn_Vardecl*_tmp162;struct Cyc_Absyn_Pat*_tmp161;struct Cyc_List_List*_tmp160;struct Cyc_List_List*_tmp15F;struct Cyc_Absyn_AggrInfo*_tmp15E;struct Cyc_List_List*_tmp15D;struct Cyc_List_List*_tmp15C;struct Cyc_Absyn_Pat*_tmp15B;switch(*((int*)_tmp13D)){case 6U: _LL99: _tmp15B=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp13D)->f1;_LL9A: {
# 677
void*_tmp13E=(void*)_check_null(p->topt);void*_tmp13F=_tmp13E;void*_tmp142;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp13F)->tag == 5U){_LLAA: _tmp142=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp13F)->f1).ptr_atts).rgn;_LLAB:
# 679
...
({void*_tmp140=0U;({struct _dyneither_ptr _tmp4D2=({const char*_tmp141="check_pat_regions: bad pointer type";_tag_dyneither(_tmp141,sizeof(char),36U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4D2,_tag_dyneither(_tmp140,sizeof(void*),0U));});});}_LLA9:;}case 7U: _LL9B: _tmp15E=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp13D)->f1;_tmp15D=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp13D)->f2;_tmp15C=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp13D)->f3;_LL9C:
# 685
...
return;case 8U: _LL9D: _tmp15F=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp13D)->f3;_LL9E:
# 689
 did_noalias_deref=0;_tmp160=_tmp15F;goto _LLA0;case 5U: _LL9F: _tmp160=((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp13D)->f1;_LLA0:
# 691
...
return;case 3U: _LLA1: _tmp162=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp13D)->f1;_tmp161=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp13D)->f2;_LLA2:
# 695
...
{void*_tmp145=_tmp14C->r;void*_tmp146=_tmp145;struct Cyc_Absyn_Exp*_tmp14B;if(((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp146)->tag == 15U){_LLB2: _tmp14B=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp146)->f1;_LLB3:
# 704
 if(Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_check_null(_tmp14B->topt)))
({void*_tmp147=0U;({unsigned int _tmp4D4=p->loc;struct _dyneither_ptr _tmp4D3=({const char*_tmp148="reference pattern not allowed on alias-free pointers";_tag_dyneither(_tmp148,sizeof(char),53U);});Cyc_Tcutil_terr(_tmp4D4,_tmp4D3,_tag_dyneither(_tmp147,sizeof(void*),0U));});});
goto _LLB1;}else{_LLB4: _LLB5:
# 708
({void*_tmp149=0U;({struct _dyneither_ptr _tmp4D5=({const char*_tmp14A="check_pat_regions: bad reference access expression";_tag_dyneither(_tmp14A,sizeof(char),51U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4D5,_tag_dyneither(_tmp149,sizeof(void*),0U));});});}_LLB1:;}
# 710
break;}}}
# 713
Cyc_Tcpat_check_pat_regions_rec(te,_tmp161,did_noalias_deref,patvars);
return;case 1U: _LLA3: _tmp164=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp13D)->f1;_tmp163=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp13D)->f2;_LLA4:
# 716
{void*_tmp14E=p->topt;void*_tmp14F=_tmp14E;if(_tmp14F != 0){if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp14F)->tag == 8U){_LLB7: _LLB8:
# 718
 if(did_noalias_deref){
({void*_tmp150=0U;({unsigned int _tmp4D7=p->loc;struct _dyneither_ptr _tmp4D6=({const char*_tmp151="pattern to array would create alias of no-alias pointer";_tag_dyneither(_tmp151,sizeof(char),56U);});Cyc_Tcutil_terr(_tmp4D7,_tmp4D6,_tag_dyneither(_tmp150,sizeof(void*),0U));});});
return;}
# 722
...
return;case 2U: _LLA5: _tmp166=((struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp13D)->f1;_tmp165=((struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp13D)->f2;_LLA6:
# 728
{struct Cyc_List_List*x=patvars;for(0;x != 0;x=x->tl){
...
if(_tmp159 == 0)
({void*_tmp154=0U;({unsigned int _tmp4D9=p->loc;struct _dyneither_ptr _tmp4D8=({const char*_tmp155="cannot alias pattern expression in datatype";_tag_dyneither(_tmp155,sizeof(char),44U);});Cyc_Tcutil_terr(_tmp4D9,_tmp4D8,_tag_dyneither(_tmp154,sizeof(void*),0U));});});else{
# 736
struct Cyc_Tcenv_Tenv*te2=({unsigned int _tmp4DB=p->loc;struct Cyc_Tcenv_Tenv*_tmp4DA=te;Cyc_Tcenv_add_type_vars(_tmp4DB,_tmp4DA,({struct Cyc_Absyn_Tvar*_tmp158[1U];_tmp158[0U]=_tmp166;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp158,sizeof(struct Cyc_Absyn_Tvar*),1U));}));});
({struct Cyc_Tcenv_Tenv*_tmp4DE=({struct Cyc_Tcenv_Tenv*_tmp4DD=te2;Cyc_Tcenv_add_region(_tmp4DD,(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp156=_cycalloc(sizeof(*_tmp156));({struct Cyc_Absyn_VarType_Absyn_Type_struct _tmp4DC=({struct Cyc_Absyn_VarType_Absyn_Type_struct _tmp157;_tmp157.tag=2U;_tmp157.f1=_tmp166;_tmp157;});_tmp156[0]=_tmp4DC;});_tmp156;}),1);});te2=_tmp4DE;});
# 739
...
# 772
({struct Cyc_String_pa_PrintArg_struct _tmp16C;_tmp16C.tag=0U;({struct _dyneither_ptr _tmp4E1=(struct _dyneither_ptr)(
# 774
_tmp172 != 0?(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp16F;_tmp16F.tag=0U;({struct _dyneither_ptr _tmp4DF=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 776
Cyc_Absynpp_qvar2string((*_tmp172)->name));_tmp16F.f1=_tmp4DF;});({void*_tmp16D[1U]={& _tmp16F};({struct _dyneither_ptr _tmp4E0=({const char*_tmp16E="for variable %s";_tag_dyneither(_tmp16E,sizeof(char),16U);});Cyc_aprintf(_tmp4E0,_tag_dyneither(_tmp16D,sizeof(void*),1U));});});}):({const char*_tmp170="";_tag_dyneither(_tmp170,sizeof(char),1U);}));_tmp16C.f1=_tmp4E1;});({void*_tmp16A[1U]={& _tmp16C};({unsigned int _tmp4E3=p->loc;struct _dyneither_ptr _tmp4E2=({const char*_tmp16B="pattern %s dereferences a alias-free pointer from a non-unique path";_tag_dyneither(_tmp16B,sizeof(char),68U);});Cyc_Tcutil_terr(_tmp4E3,_tmp4E2,_tag_dyneither(_tmp16A,sizeof(void*),1U));});});});}}};}
# 830 "tcpat.cyc"
...
union Cyc_Tcpat_Name_value _tmp179=c1->name;union Cyc_Tcpat_Name_value _tmp17A=_tmp179;int _tmp182;struct _dyneither_ptr _tmp181;if((_tmp17A.Name_v).tag == 1U){_LLC2: _tmp181=(_tmp17A.Name_v).val;_LLC3: {
# 874
union Cyc_Tcpat_Name_value _tmp17B=c2->name;union Cyc_Tcpat_Name_value _tmp17C=_tmp17B;struct _dyneither_ptr _tmp17D;if((_tmp17C.Name_v).tag == 1U){_LLC7: _tmp17D=(_tmp17C.Name_v).val;_LLC8:
...
# 879
union Cyc_Tcpat_Name_value _tmp17E=c2->name;union Cyc_Tcpat_Name_value _tmp17F=_tmp17E;int _tmp180;if((_tmp17F.Name_v).tag == 1U){_LLCC: _LLCD:
...
++ i;}}
# 912
({void*_tmp186=0U;({struct _dyneither_ptr _tmp4E5=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp189;_tmp189.tag=0U;_tmp189.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);({void*_tmp187[1U]={& _tmp189};({struct _dyneither_ptr _tmp4E4=({const char*_tmp188="get_member_offset %s failed";_tag_dyneither(_tmp188,sizeof(char),28U);});Cyc_aprintf(_tmp4E4,_tag_dyneither(_tmp187,sizeof(void*),1U));});});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4E5,_tag_dyneither(_tmp186,sizeof(void*),0U));});});}
# 915
static void*Cyc_Tcpat_get_pat_test(union Cyc_Tcpat_PatOrWhere pw){
union Cyc_Tcpat_PatOrWhere _tmp18A=pw;struct Cyc_Absyn_Pat*_tmp1C3;struct Cyc_Absyn_Exp*_tmp1C2;if((_tmp18A.where_clause).tag == 2U){_LLD1: _tmp1C2=(_tmp18A.where_clause).val;_LLD2:
 return(void*)({struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct*_tmp18B=_cycalloc(sizeof(*_tmp18B));({struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct _tmp4E6=({struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct _tmp18C;_tmp18C.tag=0U;_tmp18C.f1=_tmp1C2;_tmp18C;});_tmp18B[0]=_tmp4E6;});_tmp18B;});}else{_LLD3: _tmp1C3=(_tmp18A.pattern).val;_LLD4: {
# 919
void*_tmp18D=_tmp1C3->r;void*_tmp18E=_tmp18D;union Cyc_Absyn_AggrInfoU _tmp1C1;struct Cyc_List_List*_tmp1C0;struct Cyc_Absyn_Datatypedecl*_tmp1BF;struct Cyc_Absyn_Datatypefield*_tmp1BE;void*_tmp1BD;struct Cyc_Absyn_Enumfield*_tmp1BC;struct Cyc_Absyn_Enumdecl*_tmp1BB;struct Cyc_Absyn_Enumfield*_tmp1BA;struct _dyneither_ptr _tmp1B9;int _tmp1B8;char _tmp1B7;enum Cyc_Absyn_Sign _tmp1B6;int _tmp1B5;struct Cyc_Absyn_Pat*_tmp1B4;struct Cyc_Absyn_Pat*_tmp1B3;switch(*((int*)_tmp18E)){case 1U: _LLD6: _tmp1B3=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp18E)->f2;_LLD7:
 _tmp1B4=_tmp1B3;goto _LLD9;case 3U: _LLD8: _tmp1B4=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp18E)->f2;_LLD9:
 return Cyc_Tcpat_get_pat_test(({union Cyc_Tcpat_PatOrWhere _tmp18F;(_tmp18F.pattern).val=_tmp1B4;(_tmp18F.pattern).tag=1;_tmp18F;}));case 9U: _LLDA: _LLDB:
 return(void*)& Cyc_Tcpat_EqNull_val;case 10U: _LLDC: _tmp1B6=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp18E)->f1;_tmp1B5=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp18E)->f2;_LLDD:
 return(void*)({struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*_tmp190=_cycalloc_atomic(sizeof(*_tmp190));({struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct _tmp4E7=({struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct _tmp191;_tmp191.tag=6U;_tmp191.f1=(unsigned int)_tmp1B5;_tmp191;});_tmp190[0]=_tmp4E7;});_tmp190;});case 11U: _LLDE: _tmp1B7=((struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp18E)->f1;_LLDF:
 return(void*)({struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*_tmp192=_cycalloc_atomic(sizeof(*_tmp192));({struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct _tmp4E8=({struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct _tmp193;_tmp193.tag=6U;_tmp193.f1=(unsigned int)_tmp1B7;_tmp193;});_tmp192[0]=_tmp4E8;});_tmp192;});case 12U: _LLE0: _tmp1B9=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp18E)->f1;_tmp1B8=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp18E)->f2;_LLE1:
 return(void*)({struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*_tmp194=_cycalloc(sizeof(*_tmp194));({struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct _tmp4E9=({struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct _tmp195;_tmp195.tag=5U;_tmp195.f1=_tmp1B9;_tmp195.f2=_tmp1B8;_tmp195;});_tmp194[0]=_tmp4E9;});_tmp194;});case 13U: _LLE2: _tmp1BB=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp18E)->f1;_tmp1BA=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp18E)->f2;_LLE3:
 return(void*)({struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*_tmp196=_cycalloc(sizeof(*_tmp196));({struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct _tmp4EA=({struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct _tmp197;_tmp197.tag=3U;_tmp197.f1=_tmp1BB;_tmp197.f2=_tmp1BA;_tmp197;});_tmp196[0]=_tmp4EA;});_tmp196;});case 14U: _LLE4: _tmp1BD=(void*)((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp18E)->f1;_tmp1BC=((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp18E)->f2;_LLE5:
 return(void*)({struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*_tmp198=_cycalloc(sizeof(*_tmp198));({struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct _tmp4EB=({struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct _tmp199;_tmp199.tag=4U;_tmp199.f1=_tmp1BD;_tmp199.f2=_tmp1BC;_tmp199;});_tmp198[0]=_tmp4EB;});_tmp198;});case 6U: _LLE6: _LLE7:
# 929
{void*_tmp19A=Cyc_Tcutil_compress((void*)_check_null(_tmp1C3->topt));void*_tmp19B=_tmp19A;union Cyc_Absyn_Constraint*_tmp19C;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp19B)->tag == 5U){_LLEF: _tmp19C=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp19B)->f1).ptr_atts).nullable;_LLF0:
# 931
...
goto _LLEE;}else{_LLF1: _LLF2:
 goto _LLEE;}_LLEE:;}
# 936
({void*_tmp19D=0U;({struct _dyneither_ptr _tmp4EC=({const char*_tmp19E="non-null pointer type or non-pointer type in pointer pattern";_tag_dyneither(_tmp19E,sizeof(char),61U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4EC,_tag_dyneither(_tmp19D,sizeof(void*),0U));});});case 8U: _LLE8: _tmp1BF=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp18E)->f1;_tmp1BE=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp18E)->f2;_LLE9:
# 938
 if(_tmp1BF->is_extensible)
return(void*)({struct Cyc_Tcpat_EqExtensibleDatatype_Tcpat_PatTest_struct*_tmp19F=_cycalloc(sizeof(*_tmp19F));({struct Cyc_Tcpat_EqExtensibleDatatype_Tcpat_PatTest_struct _tmp4ED=({struct Cyc_Tcpat_EqExtensibleDatatype_Tcpat_PatTest_struct _tmp1A0;_tmp1A0.tag=9U;_tmp1A0.f1=_tmp1BF;_tmp1A0.f2=_tmp1BE;_tmp1A0;});_tmp19F[0]=_tmp4ED;});_tmp19F;});else{
# 941
return(void*)({struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*_tmp1A1=_cycalloc(sizeof(*_tmp1A1));({struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct _tmp4EF=({struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct _tmp1A2;_tmp1A2.tag=7U;({int _tmp4EE=(int)Cyc_Tcpat_datatype_tag_number(_tmp1BF,_tmp1BE->name);_tmp1A2.f1=_tmp4EE;});_tmp1A2.f2=_tmp1BF;_tmp1A2.f3=_tmp1BE;_tmp1A2;});_tmp1A1[0]=_tmp4EF;});_tmp1A1;});}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp18E)->f1 != 0){_LLEA: _tmp1C1=(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp18E)->f1)->aggr_info;_tmp1C0=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp18E)->f3;_LLEB: {
# 943
...
{void*_tmp1A6=(void*)((struct Cyc_List_List*)_check_null(_tmp1AE))->hd;void*_tmp1A7=_tmp1A6;struct _dyneither_ptr*_tmp1AA;if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp1A7)->tag == 1U){_LLF7: _tmp1AA=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp1A7)->f1;_LLF8:
 f=_tmp1AA;goto _LLF6;}else{_LLF9: _LLFA:
({void*_tmp1A8=0U;({struct _dyneither_ptr _tmp4F0=({const char*_tmp1A9="no field name in tagged union pattern";_tag_dyneither(_tmp1A9,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F0,_tag_dyneither(_tmp1A8,sizeof(void*),0U));});});}_LLF6:;}
# 951
return(void*)({struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*_tmp1AB=_cycalloc(sizeof(*_tmp1AB));({struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct _tmp4F2=({struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct _tmp1AC;_tmp1AC.tag=8U;_tmp1AC.f1=f;({int _tmp4F1=Cyc_Tcpat_get_member_offset(_tmp1A3,f);_tmp1AC.f2=_tmp4F1;});_tmp1AC;});_tmp1AB[0]=_tmp4F2;});_tmp1AB;});};}else{
# 953
({void*_tmp1AF=0U;({struct _dyneither_ptr _tmp4F3=({const char*_tmp1B0="non-tagged aggregate in pattern test";_tag_dyneither(_tmp1B0,sizeof(char),37U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F3,_tag_dyneither(_tmp1AF,sizeof(void*),0U));});});}}}else{goto _LLEC;}default: _LLEC: _LLED:
({void*_tmp1B1=0U;({struct _dyneither_ptr _tmp4F4=({const char*_tmp1B2="non-test pattern in pattern test";_tag_dyneither(_tmp1B2,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F4,_tag_dyneither(_tmp1B1,sizeof(void*),0U));});});}_LLD5:;}}_LLD0:;}
# 959
...
return({struct Cyc_Tcpat_Con_s*_tmp1CE=_cycalloc(sizeof(*_tmp1CE));({union Cyc_Tcpat_Name_value _tmp500=Cyc_Tcpat_Name_v(({const char*_tmp1CF="$";_tag_dyneither(_tmp1CF,sizeof(char),2U);}));_tmp1CE->name=_tmp500;});_tmp1CE->arity=i;_tmp1CE->span=& Cyc_Tcpat_one_opt;_tmp1CE->orig_pat=p;_tmp1CE;});}
# 986
static void*Cyc_Tcpat_null_pat(struct Cyc_Absyn_Pat*p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1D0=_cycalloc(sizeof(*_tmp1D0));({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp502=({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp1D1;_tmp1D1.tag=1U;({struct Cyc_Tcpat_Con_s*_tmp501=Cyc_Tcpat_null_con(p);_tmp1D1.f1=_tmp501;});_tmp1D1.f2=0;_tmp1D1;});_tmp1D0[0]=_tmp502;});_tmp1D0;});}
# 989
static void*Cyc_Tcpat_int_pat(int i,union Cyc_Tcpat_PatOrWhere p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1D2=_cycalloc(sizeof(*_tmp1D2));({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp504=({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp1D3;_tmp1D3.tag=1U;({struct Cyc_Tcpat_Con_s*_tmp503=Cyc_Tcpat_int_con(i,p);_tmp1D3.f1=_tmp503;});_tmp1D3.f2=0;_tmp1D3;});_tmp1D2[0]=_tmp504;});_tmp1D2;});}
# 992
static void*Cyc_Tcpat_char_pat(char c,struct Cyc_Absyn_Pat*p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1D4=_cycalloc(sizeof(*_tmp1D4));({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp506=({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp1D5;_tmp1D5.tag=1U;({struct Cyc_Tcpat_Con_s*_tmp505=Cyc_Tcpat_char_con(c,p);_tmp1D5.f1=_tmp505;});_tmp1D5.f2=0;_tmp1D5;});_tmp1D4[0]=_tmp506;});_tmp1D4;});}
# 995
static void*Cyc_Tcpat_float_pat(struct _dyneither_ptr f,struct Cyc_Absyn_Pat*p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1D6=_cycalloc(sizeof(*_tmp1D6));({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp508=({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp1D7;_tmp1D7.tag=1U;({struct Cyc_Tcpat_Con_s*_tmp507=Cyc_Tcpat_float_con(f,p);_tmp1D7.f1=_tmp507;});_tmp1D7.f2=0;_tmp1D7;});_tmp1D6[0]=_tmp508;});_tmp1D6;});}
# 998
static void*Cyc_Tcpat_null_ptr_pat(void*p,struct Cyc_Absyn_Pat*p0){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1D8=_cycalloc(sizeof(*_tmp1D8));({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp50B=({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp1D9;_tmp1D9.tag=1U;({struct Cyc_Tcpat_Con_s*_tmp509=Cyc_Tcpat_null_ptr_con(p0);_tmp1D9.f1=_tmp509;});({struct Cyc_List_List*_tmp50A=({struct Cyc_List_List*_tmp1DA=_cycalloc(sizeof(*_tmp1DA));_tmp1DA->hd=p;_tmp1DA->tl=0;_tmp1DA;});_tmp1D9.f2=_tmp50A;});_tmp1D9;});_tmp1D8[0]=_tmp50B;});_tmp1D8;});}
# 1001
static void*Cyc_Tcpat_ptr_pat(void*p,struct Cyc_Absyn_Pat*p0){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1DB=_cycalloc(sizeof(*_tmp1DB));({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp50E=({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp1DC;_tmp1DC.tag=1U;({struct Cyc_Tcpat_Con_s*_tmp50C=Cyc_Tcpat_ptr_con(p0);_tmp1DC.f1=_tmp50C;});({struct Cyc_List_List*_tmp50D=({struct Cyc_List_List*_tmp1DD=_cycalloc(sizeof(*_tmp1DD));_tmp1DD->hd=p;_tmp1DD->tl=0;_tmp1DD;});_tmp1DC.f2=_tmp50D;});_tmp1DC;});_tmp1DB[0]=_tmp50E;});_tmp1DB;});}
# 1004
static void*Cyc_Tcpat_tuple_pat(struct Cyc_List_List*ss,union Cyc_Tcpat_PatOrWhere p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1DE=_cycalloc(sizeof(*_tmp1DE));({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp511=({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp1DF;_tmp1DF.tag=1U;({struct Cyc_Tcpat_Con_s*_tmp510=({int _tmp50F=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ss);Cyc_Tcpat_tuple_con(_tmp50F,p);});_tmp1DF.f1=_tmp510;});_tmp1DF.f2=ss;_tmp1DF;});_tmp1DE[0]=_tmp511;});_tmp1DE;});}
# 1007
...
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1E0=_cycalloc(sizeof(*_tmp1E0));({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp515=({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp1E1;_tmp1E1.tag=1U;_tmp1E1.f1=c;_tmp1E1.f2=ps;_tmp1E1;});_tmp1E0[0]=_tmp515;});_tmp1E0;});}
# 1014
static void*Cyc_Tcpat_compile_pat(struct Cyc_Absyn_Pat*p){
void*s;
{void*_tmp1E3=p->r;void*_tmp1E4=_tmp1E3;void*_tmp227;struct Cyc_Absyn_Enumfield*_tmp226;struct Cyc_Absyn_Enumdecl*_tmp225;struct Cyc_Absyn_Enumfield*_tmp224;struct Cyc_Absyn_Aggrdecl*_tmp223;struct Cyc_List_List*_tmp222;struct Cyc_List_List*_tmp221;struct Cyc_Absyn_Datatypedecl*_tmp220;struct Cyc_Absyn_Datatypefield*_tmp21F;struct Cyc_List_List*_tmp21E;struct Cyc_Absyn_Pat*_tmp21D;struct Cyc_Absyn_Pat*_tmp21C;struct Cyc_Absyn_Pat*_tmp21B;struct _dyneither_ptr _tmp21A;char _tmp219;enum Cyc_Absyn_Sign _tmp218;int _tmp217;switch(*((int*)_tmp1E4)){case 0U: _LLFC: _LLFD:
 goto _LLFF;case 2U: _LLFE: _LLFF:
 goto _LL101;case 4U: _LL100: _LL101:
({void*_tmp517=(void*)({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp1E5=_cycalloc_atomic(sizeof(*_tmp1E5));({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct _tmp516=({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct _tmp1E6;_tmp1E6.tag=0U;_tmp1E6;});_tmp1E5[0]=_tmp516;});_tmp1E5;});s=_tmp517;});goto _LLFB;case 9U: _LL102: _LL103:
({void*_tmp518=Cyc_Tcpat_null_pat(p);s=_tmp518;});goto _LLFB;case 10U: _LL104: _tmp218=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1;_tmp217=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1E4)->f2;_LL105:
({void*_tmp51A=({int _tmp519=_tmp217;Cyc_Tcpat_int_pat(_tmp519,Cyc_Tcpat_pw(p));});s=_tmp51A;});goto _LLFB;case 11U: _LL106: _tmp219=((struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1;_LL107:
({void*_tmp51B=Cyc_Tcpat_char_pat(_tmp219,p);s=_tmp51B;});goto _LLFB;case 12U: _LL108: _tmp21A=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1;_LL109:
({void*_tmp51C=Cyc_Tcpat_float_pat(_tmp21A,p);s=_tmp51C;});goto _LLFB;case 1U: _LL10A: _tmp21B=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp1E4)->f2;_LL10B:
({void*_tmp51D=Cyc_Tcpat_compile_pat(_tmp21B);s=_tmp51D;});goto _LLFB;case 3U: _LL10C: _tmp21C=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1E4)->f2;_LL10D:
({void*_tmp51E=Cyc_Tcpat_compile_pat(_tmp21C);s=_tmp51E;});goto _LLFB;case 6U: _LL10E: _tmp21D=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1;_LL10F:
# 1027
{void*_tmp1E7=Cyc_Tcutil_compress((void*)_check_null(p->topt));void*_tmp1E8=_tmp1E7;union Cyc_Absyn_Constraint*_tmp1EF;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1E8)->tag == 5U){_LL123: _tmp1EF=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1E8)->f1).ptr_atts).nullable;_LL124: {
# 1029
int is_nullable=0;
int still_working=1;
while(still_working){
union Cyc_Absyn_Constraint*_tmp1E9=_tmp1EF;int _tmp1EC;union Cyc_Absyn_Constraint*_tmp1EB;switch((((union Cyc_Absyn_Constraint*)_tmp1E9)->No_constr).tag){case 2U: _LL128: _tmp1EB=(_tmp1E9->Forward_constr).val;_LL129:
# 1034
*_tmp1EF=*_tmp1EB;
continue;case 3U: _LL12A: _LL12B:
# 1037
...
({void*_tmp1ED=0U;({struct _dyneither_ptr _tmp521=({const char*_tmp1EE="expecting pointertype for pattern!";_tag_dyneither(_tmp1EE,sizeof(char),35U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp521,_tag_dyneither(_tmp1ED,sizeof(void*),0U));});});}_LL122:;}
# 1055
goto _LLFB;case 8U: _LL110: _tmp220=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1;_tmp21F=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp1E4)->f2;_tmp21E=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp1E4)->f3;_LL111: {
# 1057
int*span;
{void*_tmp1F0=Cyc_Tcutil_compress((void*)_check_null(p->topt));void*_tmp1F1=_tmp1F0;switch(*((int*)_tmp1F1)){case 3U: _LL12F: _LL130:
# 1060
...
goto _LL12E;case 4U: _LL131: _LL132:
 span=& Cyc_Tcpat_one_opt;goto _LL12E;default: _LL133: _LL134:
({int*_tmp525=({void*_tmp1F3=0U;({struct _dyneither_ptr _tmp524=({const char*_tmp1F4="void datatype pattern has bad type";_tag_dyneither(_tmp1F4,sizeof(char),35U);});((int*(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp524,_tag_dyneither(_tmp1F3,sizeof(void*),0U));});});span=_tmp525;});goto _LL12E;}_LL12E:;}
# 1068
...
goto _LLFB;}case 5U: _LL112: _tmp221=((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1;_LL113:
# 1072
({void*_tmp52B=({struct Cyc_List_List*_tmp52A=((struct Cyc_List_List*(*)(void*(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_compile_pat,_tmp221);Cyc_Tcpat_tuple_pat(_tmp52A,Cyc_Tcpat_pw(p));});s=_tmp52B;});goto _LLFB;case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1 != 0){if(((((struct Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1)->aggr_info).KnownAggr).tag == 2U){_LL114: _tmp223=*(((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1)->aggr_info).KnownAggr).val;_tmp222=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1E4)->f3;_LL115:
# 1077
...
# 1081
int found=({struct _dyneither_ptr _tmp52C=(struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)fields->hd)->name;Cyc_strcmp(_tmp52C,({const char*_tmp200="";_tag_dyneither(_tmp200,sizeof(char),1U);}));})== 0;
...
struct Cyc_List_List*_tmp1F7=_tmp1FD;struct _dyneither_ptr*_tmp1FB;if(_tmp1F7 != 0){if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)((struct Cyc_List_List*)_tmp1F7)->hd)->tag == 1U){if(((struct Cyc_List_List*)_tmp1F7)->tl == 0){_LL139: _tmp1FB=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp1F7->hd)->f1;_LL13A:
# 1086
...
({void*_tmp1F9=0U;({struct _dyneither_ptr _tmp52F=({const char*_tmp1FA="bad designator(s)";_tag_dyneither(_tmp1FA,sizeof(char),18U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp52F,_tag_dyneither(_tmp1F9,sizeof(void*),0U));});});}_LL138:;};}}
# 1094
if(!found)
({void*_tmp1FE=0U;({struct _dyneither_ptr _tmp530=({const char*_tmp1FF="bad designator";_tag_dyneither(_tmp1FF,sizeof(char),15U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp530,_tag_dyneither(_tmp1FE,sizeof(void*),0U));});});}}
# 1097
...
({void*_tmp201=0U;({unsigned int _tmp534=p->loc;struct _dyneither_ptr _tmp533=({const char*_tmp202="patterns on untagged unions not yet supported.";_tag_dyneither(_tmp202,sizeof(char),47U);});Cyc_Tcutil_terr(_tmp534,_tmp533,_tag_dyneither(_tmp201,sizeof(void*),0U));});});{
...
struct Cyc_List_List*_tmp203=_tmp222;struct _dyneither_ptr*_tmp208;struct Cyc_Absyn_Pat*_tmp207;if(_tmp203 != 0){if(((struct _tuple18*)((struct Cyc_List_List*)_tmp203)->hd)->f1 != 0){if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)((struct Cyc_List_List*)((struct _tuple18*)((struct Cyc_List_List*)_tmp203)->hd)->f1)->hd)->tag == 1U){if(((struct Cyc_List_List*)((struct _tuple18*)((struct Cyc_List_List*)_tmp203)->hd)->f1)->tl == 0){if(((struct Cyc_List_List*)_tmp203)->tl == 0){_LL13E: _tmp208=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)(((struct _tuple18*)_tmp203->hd)->f1)->hd)->f1;_tmp207=((struct _tuple18*)_tmp203->hd)->f2;_LL13F:
# 1105
...
({void*_tmp205=0U;({struct _dyneither_ptr _tmp53B=({const char*_tmp206="bad union pattern";_tag_dyneither(_tmp206,sizeof(char),18U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp53B,_tag_dyneither(_tmp205,sizeof(void*),0U));});});}_LL13D:;};}
# 1110
goto _LLFB;}else{goto _LL11E;}}else{_LL11E: _LL11F:
# 1152
 goto _LL121;}case 13U: _LL116: _tmp225=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1;_tmp224=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp1E4)->f2;_LL117:
# 1115
{void*_tmp20A=Cyc_Tcutil_compress((void*)_check_null(p->topt));void*_tmp20B=_tmp20A;if(((struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp20B)->tag == 6U){_LL143: _LL144:
# 1119
...
goto _LL142;}}_LL142:;}
# 1126
goto _LLFB;case 14U: _LL118: _tmp227=(void*)((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp1E4)->f1;_tmp226=((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp1E4)->f2;_LL119: {
# 1131
struct Cyc_List_List*fields;
{void*_tmp20D=Cyc_Tcutil_compress(_tmp227);void*_tmp20E=_tmp20D;struct Cyc_List_List*_tmp211;if(((struct Cyc_Absyn_AnonEnumType_Absyn_Type_struct*)_tmp20E)->tag == 14U){_LL148: _tmp211=((struct Cyc_Absyn_AnonEnumType_Absyn_Type_struct*)_tmp20E)->f1;_LL149:
 fields=_tmp211;goto _LL147;}else{_LL14A: _LL14B:
({void*_tmp20F=0U;({struct _dyneither_ptr _tmp540=({const char*_tmp210="bad type in AnonEnum_p";_tag_dyneither(_tmp210,sizeof(char),23U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp540,_tag_dyneither(_tmp20F,sizeof(void*),0U));});});}_LL147:;}
# 1138
{void*_tmp212=Cyc_Tcutil_compress((void*)_check_null(p->topt));void*_tmp213=_tmp212;if(((struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp213)->tag == 6U){_LL14D: _LL14E:
# 1142
...
goto _LL14C;}}_LL14C:;}
# 1149
goto _LLFB;}case 15U: _LL11A: _LL11B:
 goto _LL11D;case 16U: _LL11C: _LL11D:
 goto _LL11F;default: _LL120: _LL121:
# 1153
({void*_tmp546=(void*)({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp215=_cycalloc_atomic(sizeof(*_tmp215));({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct _tmp545=({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct _tmp216;_tmp216.tag=0U;_tmp216;});_tmp215[0]=_tmp545;});_tmp215;});s=_tmp546;});}_LLFB:;}
# 1155
return s;}
# 1163
...
struct _tuple0 _tmp228=({struct _tuple0 _tmp234;_tmp234.f1=a1;_tmp234.f2=a2;_tmp234;});struct _tuple0 _tmp229=_tmp228;int _tmp233;struct _dyneither_ptr*_tmp232;int _tmp231;struct _dyneither_ptr*_tmp230;struct Cyc_Absyn_Datatypefield*_tmp22F;unsigned int _tmp22E;struct Cyc_Absyn_Datatypefield*_tmp22D;unsigned int _tmp22C;unsigned int _tmp22B;unsigned int _tmp22A;switch(*((int*)_tmp229.f1)){case 0U: if(((struct Cyc_Tcpat_Dummy_Tcpat_Access_struct*)_tmp229.f2)->tag == 0U){_LL152: _LL153:
 return 1;}else{goto _LL15C;}case 1U: if(((struct Cyc_Tcpat_Deref_Tcpat_Access_struct*)_tmp229.f2)->tag == 1U){_LL154: _LL155:
 return 1;}else{goto _LL15C;}case 2U: if(((struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*)_tmp229.f2)->tag == 2U){_LL156: _tmp22B=((struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*)_tmp229.f1)->f1;_tmp22A=((struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*)_tmp229.f2)->f1;_LL157:
 return _tmp22B == _tmp22A;}else{goto _LL15C;}case 3U: if(((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp229.f2)->tag == 3U){_LL158: _tmp22F=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp229.f1)->f2;_tmp22E=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp229.f1)->f3;_tmp22D=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp229.f2)->f2;_tmp22C=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp229.f2)->f3;_LL159:
# 1190
 return _tmp22F == _tmp22D  && _tmp22E == _tmp22C;}else{goto _LL15C;}default: if(((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp229.f2)->tag == 4U){_LL15A: _tmp233=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp229.f1)->f1;_tmp232=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp229.f1)->f2;_tmp231=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp229.f2)->f1;_tmp230=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp229.f2)->f2;_LL15B:
# 1192
...
for(0;i != 0;-- i){
({void*_tmp242=0U;({struct Cyc___cycFILE*_tmp54E=Cyc_stderr;struct _dyneither_ptr _tmp54D=({const char*_tmp243=" ";_tag_dyneither(_tmp243,sizeof(char),2U);});Cyc_fprintf(_tmp54E,_tmp54D,_tag_dyneither(_tmp242,sizeof(void*),0U));});});}}
# 1238
static void Cyc_Tcpat_print_con(struct Cyc_Tcpat_Con_s*c){
union Cyc_Tcpat_Name_value _tmp244=c->name;
union Cyc_Tcpat_Name_value _tmp245=_tmp244;int _tmp24D;struct _dyneither_ptr _tmp24C;if((_tmp245.Name_v).tag == 1U){_LL164: _tmp24C=(_tmp245.Name_v).val;_LL165:
({struct Cyc_String_pa_PrintArg_struct _tmp248;_tmp248.tag=0U;_tmp248.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp24C);({void*_tmp246[1U]={& _tmp248};({struct Cyc___cycFILE*_tmp550=Cyc_stderr;struct _dyneither_ptr _tmp54F=({const char*_tmp247="%s";_tag_dyneither(_tmp247,sizeof(char),3U);});Cyc_fprintf(_tmp550,_tmp54F,_tag_dyneither(_tmp246,sizeof(void*),1U));});});});goto _LL163;}else{_LL166: _tmp24D=(_tmp245.Int_v).val;_LL167:
({struct Cyc_Int_pa_PrintArg_struct _tmp24B;_tmp24B.tag=1U;_tmp24B.f1=(unsigned long)_tmp24D;({void*_tmp249[1U]={& _tmp24B};({struct Cyc___cycFILE*_tmp552=Cyc_stderr;struct _dyneither_ptr _tmp551=({const char*_tmp24A="%d";_tag_dyneither(_tmp24A,sizeof(char),3U);});Cyc_fprintf(_tmp552,_tmp551,_tag_dyneither(_tmp249,sizeof(void*),1U));});});});goto _LL163;}_LL163:;}
# 1246
static void Cyc_Tcpat_print_access(void*a){
void*_tmp24E=a;int _tmp264;struct _dyneither_ptr*_tmp263;struct Cyc_Absyn_Datatypefield*_tmp262;unsigned int _tmp261;unsigned int _tmp260;switch(*((int*)_tmp24E)){case 0U: _LL169: _LL16A:
({void*_tmp24F=0U;({struct Cyc___cycFILE*_tmp554=Cyc_stderr;struct _dyneither_ptr _tmp553=({const char*_tmp250="DUMMY";_tag_dyneither(_tmp250,sizeof(char),6U);});Cyc_fprintf(_tmp554,_tmp553,_tag_dyneither(_tmp24F,sizeof(void*),0U));});});goto _LL168;case 1U: _LL16B: _LL16C:
({void*_tmp251=0U;({struct Cyc___cycFILE*_tmp556=Cyc_stderr;struct _dyneither_ptr _tmp555=({const char*_tmp252="*";_tag_dyneither(_tmp252,sizeof(char),2U);});Cyc_fprintf(_tmp556,_tmp555,_tag_dyneither(_tmp251,sizeof(void*),0U));});});goto _LL168;case 2U: _LL16D: _tmp260=((struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*)_tmp24E)->f1;_LL16E:
({struct Cyc_Int_pa_PrintArg_struct _tmp255;_tmp255.tag=1U;_tmp255.f1=(unsigned long)((int)_tmp260);({void*_tmp253[1U]={& _tmp255};({struct Cyc___cycFILE*_tmp558=Cyc_stderr;struct _dyneither_ptr _tmp557=({const char*_tmp254="[%d]";_tag_dyneither(_tmp254,sizeof(char),5U);});Cyc_fprintf(_tmp558,_tmp557,_tag_dyneither(_tmp253,sizeof(void*),1U));});});});goto _LL168;case 3U: _LL16F: _tmp262=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp24E)->f2;_tmp261=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp24E)->f3;_LL170:
# 1252
({struct Cyc_Int_pa_PrintArg_struct _tmp259;_tmp259.tag=1U;_tmp259.f1=(unsigned long)((int)_tmp261);({struct Cyc_String_pa_PrintArg_struct _tmp258;_tmp258.tag=0U;({struct _dyneither_ptr _tmp559=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp262->name));_tmp258.f1=_tmp559;});({void*_tmp256[2U]={& _tmp258,& _tmp259};({struct Cyc___cycFILE*_tmp55B=Cyc_stderr;struct _dyneither_ptr _tmp55A=({const char*_tmp257="%s[%d]";_tag_dyneither(_tmp257,sizeof(char),7U);});Cyc_fprintf(_tmp55B,_tmp55A,_tag_dyneither(_tmp256,sizeof(void*),2U));});});});});goto _LL168;default: _LL171: _tmp264=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp24E)->f1;_tmp263=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp24E)->f2;_LL172:
# 1254
 if(_tmp264)
({struct Cyc_String_pa_PrintArg_struct _tmp25C;_tmp25C.tag=0U;_tmp25C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp263);({void*_tmp25A[1U]={& _tmp25C};({struct Cyc___cycFILE*_tmp55D=Cyc_stderr;struct _dyneither_ptr _tmp55C=({const char*_tmp25B=".tagunion.%s";_tag_dyneither(_tmp25B,sizeof(char),13U);});Cyc_fprintf(_tmp55D,_tmp55C,_tag_dyneither(_tmp25A,sizeof(void*),1U));});});});else{
# 1257
({struct Cyc_String_pa_PrintArg_struct _tmp25F;_tmp25F.tag=0U;_tmp25F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp263);({void*_tmp25D[1U]={& _tmp25F};({struct Cyc___cycFILE*_tmp55F=Cyc_stderr;struct _dyneither_ptr _tmp55E=({const char*_tmp25E=".%s";_tag_dyneither(_tmp25E,sizeof(char),4U);});Cyc_fprintf(_tmp55F,_tmp55E,_tag_dyneither(_tmp25D,sizeof(void*),1U));});});});}
goto _LL168;}_LL168:;}
# 1262
static void Cyc_Tcpat_print_pat_test(void*p){
void*_tmp265=p;struct Cyc_Absyn_Datatypefield*_tmp28A;struct _dyneither_ptr*_tmp289;int _tmp288;int _tmp287;unsigned int _tmp286;struct _dyneither_ptr _tmp285;struct Cyc_Absyn_Enumfield*_tmp284;struct Cyc_Absyn_Enumfield*_tmp283;struct Cyc_Absyn_Exp*_tmp282;switch(*((int*)_tmp265)){case 0U: if(((struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct*)_tmp265)->f1 == 0){_LL174: _LL175:
({void*_tmp266=0U;({struct Cyc___cycFILE*_tmp561=Cyc_stderr;struct _dyneither_ptr _tmp560=({const char*_tmp267="where(NULL)";_tag_dyneither(_tmp267,sizeof(char),12U);});Cyc_fprintf(_tmp561,_tmp560,_tag_dyneither(_tmp266,sizeof(void*),0U));});});goto _LL173;}else{_LL176: _tmp282=((struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct*)_tmp265)->f1;_LL177:
({struct Cyc_String_pa_PrintArg_struct _tmp26A;_tmp26A.tag=0U;({struct _dyneither_ptr _tmp562=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string((struct Cyc_Absyn_Exp*)_check_null(_tmp282)));_tmp26A.f1=_tmp562;});({void*_tmp268[1U]={& _tmp26A};({struct Cyc___cycFILE*_tmp564=Cyc_stderr;struct _dyneither_ptr _tmp563=({const char*_tmp269="where(%s)";_tag_dyneither(_tmp269,sizeof(char),10U);});Cyc_fprintf(_tmp564,_tmp563,_tag_dyneither(_tmp268,sizeof(void*),1U));});});});goto _LL173;}case 1U: _LL178: _LL179:
({void*_tmp26B=0U;({struct Cyc___cycFILE*_tmp566=Cyc_stderr;struct _dyneither_ptr _tmp565=({const char*_tmp26C="NULL";_tag_dyneither(_tmp26C,sizeof(char),5U);});Cyc_fprintf(_tmp566,_tmp565,_tag_dyneither(_tmp26B,sizeof(void*),0U));});});goto _LL173;case 2U: _LL17A: _LL17B:
({void*_tmp26D=0U;({struct Cyc___cycFILE*_tmp568=Cyc_stderr;struct _dyneither_ptr _tmp567=({const char*_tmp26E="NOT-NULL:";_tag_dyneither(_tmp26E,sizeof(char),10U);});Cyc_fprintf(_tmp568,_tmp567,_tag_dyneither(_tmp26D,sizeof(void*),0U));});});goto _LL173;case 4U: _LL17C: _tmp283=((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp265)->f2;_LL17D:
 _tmp284=_tmp283;goto _LL17F;case 3U: _LL17E: _tmp284=((struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*)_tmp265)->f2;_LL17F:
({struct Cyc_String_pa_PrintArg_struct _tmp271;_tmp271.tag=0U;({struct _dyneither_ptr _tmp569=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp284->name));_tmp271.f1=_tmp569;});({void*_tmp26F[1U]={& _tmp271};({struct Cyc___cycFILE*_tmp56B=Cyc_stderr;struct _dyneither_ptr _tmp56A=({const char*_tmp270="%s";_tag_dyneither(_tmp270,sizeof(char),3U);});Cyc_fprintf(_tmp56B,_tmp56A,_tag_dyneither(_tmp26F,sizeof(void*),1U));});});});goto _LL173;case 5U: _LL180: _tmp285=((struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*)_tmp265)->f1;_LL181:
({struct Cyc_String_pa_PrintArg_struct _tmp274;_tmp274.tag=0U;_tmp274.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp285);({void*_tmp272[1U]={& _tmp274};({struct Cyc___cycFILE*_tmp56D=Cyc_stderr;struct _dyneither_ptr _tmp56C=({const char*_tmp273="%s";_tag_dyneither(_tmp273,sizeof(char),3U);});Cyc_fprintf(_tmp56D,_tmp56C,_tag_dyneither(_tmp272,sizeof(void*),1U));});});});goto _LL173;case 6U: _LL182: _tmp286=((struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*)_tmp265)->f1;_LL183:
({struct Cyc_Int_pa_PrintArg_struct _tmp277;_tmp277.tag=1U;_tmp277.f1=(unsigned long)((int)_tmp286);({void*_tmp275[1U]={& _tmp277};({struct Cyc___cycFILE*_tmp56F=Cyc_stderr;struct _dyneither_ptr _tmp56E=({const char*_tmp276="%d";_tag_dyneither(_tmp276,sizeof(char),3U);});Cyc_fprintf(_tmp56F,_tmp56E,_tag_dyneither(_tmp275,sizeof(void*),1U));});});});goto _LL173;case 7U: _LL184: _tmp287=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp265)->f1;_LL185:
({struct Cyc_Int_pa_PrintArg_struct _tmp27A;_tmp27A.tag=1U;_tmp27A.f1=(unsigned long)_tmp287;({void*_tmp278[1U]={& _tmp27A};({struct Cyc___cycFILE*_tmp571=Cyc_stderr;struct _dyneither_ptr _tmp570=({const char*_tmp279="datatypetag(%d)";_tag_dyneither(_tmp279,sizeof(char),16U);});Cyc_fprintf(_tmp571,_tmp570,_tag_dyneither(_tmp278,sizeof(void*),1U));});});});goto _LL173;case 8U: _LL186: _tmp289=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp265)->f1;_tmp288=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp265)->f2;_LL187:
({struct Cyc_Int_pa_PrintArg_struct _tmp27E;_tmp27E.tag=1U;_tmp27E.f1=(unsigned long)_tmp288;({struct Cyc_String_pa_PrintArg_struct _tmp27D;_tmp27D.tag=0U;_tmp27D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp289);({void*_tmp27B[2U]={& _tmp27D,& _tmp27E};({struct Cyc___cycFILE*_tmp573=Cyc_stderr;struct _dyneither_ptr _tmp572=({const char*_tmp27C="uniontag[%s](%d)";_tag_dyneither(_tmp27C,sizeof(char),17U);});Cyc_fprintf(_tmp573,_tmp572,_tag_dyneither(_tmp27B,sizeof(void*),2U));});});});});goto _LL173;default: _LL188: _tmp28A=((struct Cyc_Tcpat_EqExtensibleDatatype_Tcpat_PatTest_struct*)_tmp265)->f2;_LL189:
# 1275
({struct Cyc_String_pa_PrintArg_struct _tmp281;_tmp281.tag=0U;({struct _dyneither_ptr _tmp574=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp28A->name));_tmp281.f1=_tmp574;});({void*_tmp27F[1U]={& _tmp281};({struct Cyc___cycFILE*_tmp576=Cyc_stderr;struct _dyneither_ptr _tmp575=({const char*_tmp280="datatypefield(%s)";_tag_dyneither(_tmp280,sizeof(char),18U);});Cyc_fprintf(_tmp576,_tmp575,_tag_dyneither(_tmp27F,sizeof(void*),1U));});});});}_LL173:;}
# 1279
static void Cyc_Tcpat_print_rhs(struct Cyc_Tcpat_Rhs*r){
({struct Cyc_String_pa_PrintArg_struct _tmp28D;_tmp28D.tag=0U;({struct _dyneither_ptr _tmp577=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_stmt2string(r->rhs));_tmp28D.f1=_tmp577;});({void*_tmp28B[1U]={& _tmp28D};({struct Cyc___cycFILE*_tmp579=Cyc_stderr;struct _dyneither_ptr _tmp578=({const char*_tmp28C="%s";_tag_dyneither(_tmp28C,sizeof(char),3U);});Cyc_fprintf(_tmp579,_tmp578,_tag_dyneither(_tmp28B,sizeof(void*),1U));});});});}
# 1283
static void Cyc_Tcpat_print_dec_tree(void*d,int tab){
void*_tmp28E=d;struct Cyc_List_List*_tmp2AA;struct Cyc_List_List*_tmp2A9;void*_tmp2A8;struct Cyc_Tcpat_Rhs*_tmp2A7;switch(*((int*)_tmp28E)){case 1U: _LL18B: _tmp2A7=((struct Cyc_Tcpat_Success_Tcpat_Decision_struct*)_tmp28E)->f1;_LL18C:
# 1286
 Cyc_Tcpat_print_tab(tab);
({void*_tmp28F=0U;({struct Cyc___cycFILE*_tmp57B=Cyc_stderr;struct _dyneither_ptr _tmp57A=({const char*_tmp290="Success(";_tag_dyneither(_tmp290,sizeof(char),9U);});Cyc_fprintf(_tmp57B,_tmp57A,_tag_dyneither(_tmp28F,sizeof(void*),0U));});});Cyc_Tcpat_print_rhs(_tmp2A7);({void*_tmp291=0U;({struct Cyc___cycFILE*_tmp57D=Cyc_stderr;struct _dyneither_ptr _tmp57C=({const char*_tmp292=")\n";_tag_dyneither(_tmp292,sizeof(char),3U);});Cyc_fprintf(_tmp57D,_tmp57C,_tag_dyneither(_tmp291,sizeof(void*),0U));});});
goto _LL18A;case 0U: _LL18D: _LL18E:
({void*_tmp293=0U;({struct Cyc___cycFILE*_tmp57F=Cyc_stderr;struct _dyneither_ptr _tmp57E=({const char*_tmp294="Failure\n";_tag_dyneither(_tmp294,sizeof(char),9U);});Cyc_fprintf(_tmp57F,_tmp57E,_tag_dyneither(_tmp293,sizeof(void*),0U));});});goto _LL18A;default: _LL18F: _tmp2AA=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp28E)->f1;_tmp2A9=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp28E)->f2;_tmp2A8=(void*)((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp28E)->f3;_LL190:
# 1291
 Cyc_Tcpat_print_tab(tab);
({void*_tmp295=0U;({struct Cyc___cycFILE*_tmp581=Cyc_stderr;struct _dyneither_ptr _tmp580=({const char*_tmp296="Switch[";_tag_dyneither(_tmp296,sizeof(char),8U);});Cyc_fprintf(_tmp581,_tmp580,_tag_dyneither(_tmp295,sizeof(void*),0U));});});
for(0;_tmp2AA != 0;_tmp2AA=_tmp2AA->tl){
Cyc_Tcpat_print_access(((struct Cyc_Tcpat_PathNode*)_tmp2AA->hd)->access);
if(_tmp2AA->tl != 0)({void*_tmp297=0U;({struct Cyc___cycFILE*_tmp583=Cyc_stderr;struct _dyneither_ptr _tmp582=({const char*_tmp298=",";_tag_dyneither(_tmp298,sizeof(char),2U);});Cyc_fprintf(_tmp583,_tmp582,_tag_dyneither(_tmp297,sizeof(void*),0U));});});}
# 1297
({void*_tmp299=0U;({struct Cyc___cycFILE*_tmp585=Cyc_stderr;struct _dyneither_ptr _tmp584=({const char*_tmp29A="] {\n";_tag_dyneither(_tmp29A,sizeof(char),5U);});Cyc_fprintf(_tmp585,_tmp584,_tag_dyneither(_tmp299,sizeof(void*),0U));});});
...
Cyc_Tcpat_print_tab(tab);
({void*_tmp29D=0U;({struct Cyc___cycFILE*_tmp587=Cyc_stderr;struct _dyneither_ptr _tmp586=({const char*_tmp29E="case ";_tag_dyneither(_tmp29E,sizeof(char),6U);});Cyc_fprintf(_tmp587,_tmp586,_tag_dyneither(_tmp29D,sizeof(void*),0U));});});
Cyc_Tcpat_print_pat_test(_tmp2A2);
({void*_tmp29F=0U;({struct Cyc___cycFILE*_tmp589=Cyc_stderr;struct _dyneither_ptr _tmp588=({const char*_tmp2A0=":\n";_tag_dyneither(_tmp2A0,sizeof(char),3U);});Cyc_fprintf(_tmp589,_tmp588,_tag_dyneither(_tmp29F,sizeof(void*),0U));});});
Cyc_Tcpat_print_dec_tree(_tmp2A1,tab + 7);}
# 1306
Cyc_Tcpat_print_tab(tab);
({void*_tmp2A3=0U;({struct Cyc___cycFILE*_tmp58B=Cyc_stderr;struct _dyneither_ptr _tmp58A=({const char*_tmp2A4="default:\n";_tag_dyneither(_tmp2A4,sizeof(char),10U);});Cyc_fprintf(_tmp58B,_tmp58A,_tag_dyneither(_tmp2A3,sizeof(void*),0U));});});
Cyc_Tcpat_print_dec_tree(_tmp2A8,tab + 7);
Cyc_Tcpat_print_tab(tab);
({void*_tmp2A5=0U;({struct Cyc___cycFILE*_tmp58D=Cyc_stderr;struct _dyneither_ptr _tmp58C=({const char*_tmp2A6="}\n";_tag_dyneither(_tmp2A6,sizeof(char),3U);});Cyc_fprintf(_tmp58D,_tmp58C,_tag_dyneither(_tmp2A5,sizeof(void*),0U));});});}_LL18A:;}
# 1314
...
void*_tmp2AB=td;struct Cyc_Set_Set*_tmp2B0;if(((struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)_tmp2AB)->tag == 1U){_LL195: _tmp2B0=((struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)_tmp2AB)->f1;_LL196:
# 1332
 return(void*)({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp2AC=_cycalloc(sizeof(*_tmp2AC));({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct _tmp58F=({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct _tmp2AD;_tmp2AD.tag=1U;({struct Cyc_Set_Set*_tmp58E=((struct Cyc_Set_Set*(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_insert)(_tmp2B0,c);_tmp2AD.f1=_tmp58E;});_tmp2AD;});_tmp2AC[0]=_tmp58F;});_tmp2AC;});}else{_LL197: _LL198:
({void*_tmp2AE=0U;({struct _dyneither_ptr _tmp590=({const char*_tmp2AF="add_neg called when td is Positive";_tag_dyneither(_tmp2AF,sizeof(char),35U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp590,_tag_dyneither(_tmp2AE,sizeof(void*),0U));});});}_LL194:;}
# 1339
static enum Cyc_Tcpat_Answer Cyc_Tcpat_static_match(struct Cyc_Tcpat_Con_s*c,void*td){
void*_tmp2B1=td;struct Cyc_Set_Set*_tmp2B3;struct Cyc_Tcpat_Con_s*_tmp2B2;if(((struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp2B1)->tag == 0U){_LL19A: _tmp2B2=((struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp2B1)->f1;_LL19B:
# 1343
...
({void*_tmp2BC=0U;({struct _dyneither_ptr _tmp594=({const char*_tmp2BD="norm_context: empty context";_tag_dyneither(_tmp2BD,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp594,_tag_dyneither(_tmp2BC,sizeof(void*),0U));});});}else{_LL1A6: _tmp2C2=((struct _tuple21*)_tmp2BB->hd)->f1;_tmp2C1=((struct _tuple21*)_tmp2BB->hd)->f2;_tmp2C0=_tmp2BB->tl;_LL1A7:
# 1377
 return({struct Cyc_List_List*_tmp597=_tmp2C0;Cyc_Tcpat_augment(_tmp597,(void*)({struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp2BE=_cycalloc(sizeof(*_tmp2BE));({struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct _tmp596=({struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct _tmp2BF;_tmp2BF.tag=0U;_tmp2BF.f1=_tmp2C2;({struct Cyc_List_List*_tmp595=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(_tmp2C1);_tmp2BF.f2=_tmp595;});_tmp2BF;});_tmp2BE[0]=_tmp596;});_tmp2BE;}));});}_LL1A3:;}
# 1386
...
({void*_tmp2C5=0U;({struct _dyneither_ptr _tmp598=({const char*_tmp2C6="build_desc: ctxt and work don't match";_tag_dyneither(_tmp2C6,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp598,_tag_dyneither(_tmp2C5,sizeof(void*),0U));});});}else{_LL1AF: _tmp2CF=((struct _tuple21*)(_tmp2C4.f1)->hd)->f1;_tmp2CE=((struct _tuple21*)(_tmp2C4.f1)->hd)->f2;_tmp2CD=(_tmp2C4.f1)->tl;_tmp2CC=((struct _tuple20*)(_tmp2C4.f2)->hd)->f3;_tmp2CB=(_tmp2C4.f2)->tl;_LL1B0: {
# 1393
struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp2C7=({struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp2C8=_cycalloc(sizeof(*_tmp2C8));({struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct _tmp59B=({struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct _tmp2C9;_tmp2C9.tag=0U;_tmp2C9.f1=_tmp2CF;({struct Cyc_List_List*_tmp59A=({struct Cyc_List_List*_tmp599=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(_tmp2CE);((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp599,({struct Cyc_List_List*_tmp2CA=_cycalloc(sizeof(*_tmp2CA));_tmp2CA->hd=dsc;_tmp2CA->tl=_tmp2CC;_tmp2CA;}));});_tmp2C9.f2=_tmp59A;});_tmp2C9;});_tmp2C8[0]=_tmp59B;});_tmp2C8;});
...
return({void*_tmp59F=(void*)({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp2D7=_cycalloc(sizeof(*_tmp2D7));({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct _tmp59E=({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct _tmp2D8;_tmp2D8.tag=1U;({struct Cyc_Set_Set*_tmp59D=Cyc_Tcpat_empty_con_set();_tmp2D8.f1=_tmp59D;});_tmp2D8;});_tmp2D7[0]=_tmp59E;});_tmp2D7;});Cyc_Tcpat_or_match(_tmp59F,allmrules);});}
# 1421
...
({void*_tmp2DC=0U;({struct _dyneither_ptr _tmp5A4=({const char*_tmp2DD="tcpat:and_match: malformed work frame";_tag_dyneither(_tmp2DD,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp5A4,_tag_dyneither(_tmp2DC,sizeof(void*),0U));});});{
...
void*_tmp2F2=dsc;struct Cyc_List_List*_tmp2F8;struct Cyc_Set_Set*_tmp2F7;if(((struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)_tmp2F2)->tag == 1U){_LL1C7: _tmp2F7=((struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)_tmp2F2)->f1;_LL1C8: {
# 1446
void*any=(void*)({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp2F5=_cycalloc(sizeof(*_tmp2F5));({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct _tmp5AC=({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct _tmp2F6;_tmp2F6.tag=1U;({struct Cyc_Set_Set*_tmp5AB=Cyc_Tcpat_empty_con_set();_tmp2F6.f1=_tmp5AB;});_tmp2F6;});_tmp2F5[0]=_tmp5AC;});_tmp2F5;});
...
union Cyc_Tcpat_PatOrWhere _tmp2F9=pw;struct Cyc_Absyn_Pat*_tmp31A;if((_tmp2F9.where_clause).tag == 2U){_LL1CC: _LL1CD:
 return(void*)& Cyc_Tcpat_Dummy_val;}else{_LL1CE: _tmp31A=(_tmp2F9.pattern).val;_LL1CF: {
# 1459
void*_tmp2FA=_tmp31A->r;void*_tmp2FB=_tmp2FA;union Cyc_Absyn_AggrInfoU _tmp319;struct Cyc_List_List*_tmp318;struct Cyc_Absyn_Datatypedecl*_tmp317;struct Cyc_Absyn_Datatypefield*_tmp316;switch(*((int*)_tmp2FB)){case 6U: _LL1D1: _LL1D2:
# 1461
 if(i != 0)
({void*_tmp2FC=0U;({struct _dyneither_ptr _tmp5AF=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp2FF;_tmp2FF.tag=1U;_tmp2FF.f1=(unsigned long)i;({void*_tmp2FD[1U]={& _tmp2FF};({struct _dyneither_ptr _tmp5AE=({const char*_tmp2FE="get_access on pointer pattern with offset %d\n";_tag_dyneither(_tmp2FE,sizeof(char),46U);});Cyc_aprintf(_tmp5AE,_tag_dyneither(_tmp2FD,sizeof(void*),1U));});});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp5AF,_tag_dyneither(_tmp2FC,sizeof(void*),0U));});});
return(void*)& Cyc_Tcpat_Deref_val;case 5U: _LL1D3: _LL1D4:
 return(void*)({struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*_tmp300=_cycalloc_atomic(sizeof(*_tmp300));({struct Cyc_Tcpat_TupleField_Tcpat_Access_struct _tmp5B0=({struct Cyc_Tcpat_TupleField_Tcpat_Access_struct _tmp301;_tmp301.tag=2U;_tmp301.f1=(unsigned int)i;_tmp301;});_tmp300[0]=_tmp5B0;});_tmp300;});case 8U: _LL1D5: _tmp317=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp2FB)->f1;_tmp316=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp2FB)->f2;_LL1D6:
 return(void*)({struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*_tmp302=_cycalloc(sizeof(*_tmp302));({struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct _tmp5B1=({struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct _tmp303;_tmp303.tag=3U;_tmp303.f1=_tmp317;_tmp303.f2=_tmp316;_tmp303.f3=(unsigned int)i;_tmp303;});_tmp302[0]=_tmp5B1;});_tmp302;});case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp2FB)->f1 != 0){_LL1D7: _tmp319=(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp2FB)->f1)->aggr_info;_tmp318=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp2FB)->f3;_LL1D8: {
# 1467
...
struct Cyc_List_List*_tmp305=(*((struct _tuple18*)((struct Cyc_List_List*)_check_null(_tmp318))->hd)).f1;struct Cyc_List_List*_tmp306=_tmp305;struct _dyneither_ptr*_tmp30D;if(_tmp306 != 0){if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)((struct Cyc_List_List*)_tmp306)->hd)->tag == 1U){if(((struct Cyc_List_List*)_tmp306)->tl == 0){_LL1DC: _tmp30D=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp306->hd)->f1;_LL1DD:
# 1471
 return(void*)({struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*_tmp307=_cycalloc(sizeof(*_tmp307));({struct Cyc_Tcpat_AggrField_Tcpat_Access_struct _tmp5B2=({struct Cyc_Tcpat_AggrField_Tcpat_Access_struct _tmp308;_tmp308.tag=4U;_tmp308.f1=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp304->impl))->tagged;_tmp308.f2=_tmp30D;_tmp308;});_tmp307[0]=_tmp5B2;});_tmp307;});}else{goto _LL1DE;}}else{goto _LL1DE;}}else{_LL1DE: _LL1DF:
({void*_tmp309=0U;({struct _dyneither_ptr _tmp5B5=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp30C;_tmp30C.tag=0U;({struct _dyneither_ptr _tmp5B3=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_pat2string(_tmp31A));_tmp30C.f1=_tmp5B3;});({void*_tmp30A[1U]={& _tmp30C};({struct _dyneither_ptr _tmp5B4=({const char*_tmp30B="get_access on bad aggr pattern: %s";_tag_dyneither(_tmp30B,sizeof(char),35U);});Cyc_aprintf(_tmp5B4,_tag_dyneither(_tmp30A,sizeof(void*),1U));});});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp5B5,_tag_dyneither(_tmp309,sizeof(void*),0U));});});}_LL1DB:;}{
# 1475
...
return(void*)({struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*_tmp310=_cycalloc(sizeof(*_tmp310));({struct Cyc_Tcpat_AggrField_Tcpat_Access_struct _tmp5B6=({struct Cyc_Tcpat_AggrField_Tcpat_Access_struct _tmp311;_tmp311.tag=4U;_tmp311.f1=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp304->impl))->tagged;_tmp311.f2=((struct Cyc_Absyn_Aggrfield*)((struct Cyc_List_List*)_check_null(_tmp30E))->hd)->name;_tmp311;});_tmp310[0]=_tmp5B6;});_tmp310;});};}}else{goto _LL1D9;}default: _LL1D9: _LL1DA:
({void*_tmp312=0U;({struct _dyneither_ptr _tmp5B9=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp315;_tmp315.tag=0U;({struct _dyneither_ptr _tmp5B7=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_pat2string(_tmp31A));_tmp315.f1=_tmp5B7;});({void*_tmp313[1U]={& _tmp315};({struct _dyneither_ptr _tmp5B8=({const char*_tmp314="get_access on bad pattern: %s";_tag_dyneither(_tmp314,sizeof(char),30U);});Cyc_aprintf(_tmp5B8,_tag_dyneither(_tmp313,sizeof(void*),1U));});});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp5B9,_tag_dyneither(_tmp312,sizeof(void*),0U));});});}_LL1D0:;}}_LL1CB:;}struct _tuple23{struct Cyc_List_List*f1;struct Cyc_Tcpat_Con_s*f2;};
# 1485
...
# 1502
void*_tmp322=p;struct Cyc_Tcpat_Con_s*_tmp330;struct Cyc_List_List*_tmp32F;if(((struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*)_tmp322)->tag == 0U){_LL1E4: _LL1E5:
# 1504
...
# 1538
void*_tmp331=d;struct Cyc_List_List*_tmp338;void*_tmp337;struct Cyc_Tcpat_Rhs*_tmp336;void*_tmp335;switch(*((int*)_tmp331)){case 0U: _LL1F0: _tmp335=(void*)((struct Cyc_Tcpat_Failure_Tcpat_Decision_struct*)_tmp331)->f1;_LL1F1:
# 1540
 if(!(*exhaust_done)){not_exhaust(env1,_tmp335);*exhaust_done=1;}
goto _LL1EF;case 1U: _LL1F2: _tmp336=((struct Cyc_Tcpat_Success_Tcpat_Decision_struct*)_tmp331)->f1;_LL1F3:
...
({void*_tmp5CA=({struct Cyc_List_List*_tmp5C9=({void*_tmp33A[2U];({void*_tmp5C8=Cyc_Tcpat_int_pat(*ctr,_tmp339);_tmp33A[1U]=_tmp5C8;});_tmp33A[0U]=sp0;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp33A,sizeof(void*),2U));});Cyc_Tcpat_tuple_pat(_tmp5C9,_tmp339);});sp=_tmp5CA;});
*ctr=*ctr + 1;}else{
# 1569
({void*_tmp5CE=({struct Cyc_List_List*_tmp5CD=({void*_tmp33C[2U];({void*_tmp5CC=(void*)({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp33D=_cycalloc_atomic(sizeof(*_tmp33D));({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct _tmp5CB=({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct _tmp33E;_tmp33E.tag=0U;_tmp33E;});_tmp33D[0]=_tmp5CB;});_tmp33D;});_tmp33C[1U]=_tmp5CC;});_tmp33C[0U]=sp0;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp33C,sizeof(void*),2U));});Cyc_Tcpat_tuple_pat(_tmp5CD,({union Cyc_Tcpat_PatOrWhere _tmp33F;(_tmp33F.where_clause).val=0;(_tmp33F.where_clause).tag=2;_tmp33F;}));});sp=_tmp5CE;});}
...
void*_tmp343=d;struct Cyc_Set_Set*_tmp3A4;struct Cyc_Tcpat_Con_s*_tmp3A3;struct Cyc_List_List*_tmp3A2;if(((struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp343)->tag == 0U){_LL1FA: _tmp3A3=((struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp343)->f1;_tmp3A2=((struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp343)->f2;_LL1FB: {
# 1581
union Cyc_Tcpat_Name_value _tmp344=_tmp3A3->name;
struct Cyc_Absyn_Pat*p;
{union Cyc_Tcpat_PatOrWhere _tmp345=_tmp3A3->orig_pat;union Cyc_Tcpat_PatOrWhere _tmp346=_tmp345;struct Cyc_Absyn_Pat*_tmp347;if((_tmp346.where_clause).tag == 2U){_LL1FF: _LL200:
...
# 1587
void*_tmp348=p->r;void*_tmp349=_tmp348;struct Cyc_Absyn_Exp*_tmp37E;struct Cyc_Absyn_Enumfield*_tmp37D;struct Cyc_Absyn_Enumfield*_tmp37C;struct _dyneither_ptr _tmp37B;int _tmp37A;char _tmp379;int _tmp378;struct Cyc_Absyn_Datatypefield*_tmp377;struct Cyc_Absyn_Aggrdecl*_tmp376;struct Cyc_List_List*_tmp375;struct Cyc_Absyn_Tvar*_tmp374;struct Cyc_Absyn_Vardecl*_tmp373;struct Cyc_Absyn_Vardecl*_tmp372;struct Cyc_Absyn_Vardecl*_tmp371;switch(*((int*)_tmp349)){case 0U: _LL204: _LL205:
 return({const char*_tmp34A="_";_tag_dyneither(_tmp34A,sizeof(char),2U);});case 1U: _LL206: _tmp371=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp349)->f1;_LL207:
 return Cyc_Absynpp_qvar2string(_tmp371->name);case 3U: _LL208: _tmp372=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp349)->f1;_LL209:
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp34D;_tmp34D.tag=0U;({struct _dyneither_ptr _tmp5CF=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp372->name));_tmp34D.f1=_tmp5CF;});({void*_tmp34B[1U]={& _tmp34D};({struct _dyneither_ptr _tmp5D0=({const char*_tmp34C="*%s";_tag_dyneither(_tmp34C,sizeof(char),4U);});Cyc_aprintf(_tmp5D0,_tag_dyneither(_tmp34B,sizeof(void*),1U));});});});case 4U: _LL20A: _tmp374=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp349)->f1;_tmp373=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp349)->f2;_LL20B:
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp351;_tmp351.tag=0U;_tmp351.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp374->name);({struct Cyc_String_pa_PrintArg_struct _tmp350;_tmp350.tag=0U;({struct _dyneither_ptr _tmp5D1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp373->name));_tmp350.f1=_tmp5D1;});({void*_tmp34E[2U]={& _tmp350,& _tmp351};({struct _dyneither_ptr _tmp5D2=({const char*_tmp34F="%s<`%s>";_tag_dyneither(_tmp34F,sizeof(char),8U);});Cyc_aprintf(_tmp5D2,_tag_dyneither(_tmp34E,sizeof(void*),2U));});});});});case 5U: _LL20C: _LL20D:
# 1593
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp354;_tmp354.tag=0U;({struct _dyneither_ptr _tmp5D3=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(_tmp3A2));_tmp354.f1=_tmp5D3;});({void*_tmp352[1U]={& _tmp354};({struct _dyneither_ptr _tmp5D4=({const char*_tmp353="$(%s)";_tag_dyneither(_tmp353,sizeof(char),6U);});Cyc_aprintf(_tmp5D4,_tag_dyneither(_tmp352,sizeof(void*),1U));});});});case 6U: _LL20E: _LL20F:
# 1595
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp357;_tmp357.tag=0U;({struct _dyneither_ptr _tmp5D5=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(_tmp3A2));_tmp357.f1=_tmp5D5;});({void*_tmp355[1U]={& _tmp357};({struct _dyneither_ptr _tmp5D6=({const char*_tmp356="&%s";_tag_dyneither(_tmp356,sizeof(char),4U);});Cyc_aprintf(_tmp5D6,_tag_dyneither(_tmp355,sizeof(void*),1U));});});});case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp349)->f1 != 0){if(((((struct Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp349)->f1)->aggr_info).KnownAggr).tag == 2U){_LL210: _tmp376=*(((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp349)->f1)->aggr_info).KnownAggr).val;_tmp375=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp349)->f3;_LL211:
# 1597
 if(_tmp376->kind == Cyc_Absyn_UnionA){
struct Cyc_List_List*_tmp358=_tmp375;struct _dyneither_ptr*_tmp35E;if(_tmp358 != 0){if(((struct _tuple18*)((struct Cyc_List_List*)_tmp358)->hd)->f1 != 0){if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)((struct Cyc_List_List*)((struct _tuple18*)((struct Cyc_List_List*)_tmp358)->hd)->f1)->hd)->tag == 1U){_LL225: _tmp35E=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)(((struct _tuple18*)_tmp358->hd)->f1)->hd)->f1;_LL226:
# 1600
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp35D;_tmp35D.tag=0U;({struct _dyneither_ptr _tmp5D7=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Tcpat_descs2string(_tmp3A2));_tmp35D.f1=_tmp5D7;});({struct Cyc_String_pa_PrintArg_struct _tmp35C;_tmp35C.tag=0U;_tmp35C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp35E);({struct Cyc_String_pa_PrintArg_struct _tmp35B;_tmp35B.tag=0U;({struct _dyneither_ptr _tmp5D8=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 1600
Cyc_Absynpp_qvar2string(_tmp376->name));_tmp35B.f1=_tmp5D8;});({void*_tmp359[3U]={& _tmp35B,& _tmp35C,& _tmp35D};({struct _dyneither_ptr _tmp5D9=({const char*_tmp35A="%s{.%s = %s}";_tag_dyneither(_tmp35A,sizeof(char),13U);});Cyc_aprintf(_tmp5D9,_tag_dyneither(_tmp359,sizeof(void*),3U));});});});});});}else{goto _LL227;}}else{goto _LL227;}}else{_LL227: _LL228:
# 1602
 goto _LL224;}_LL224:;}
# 1605
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp362;_tmp362.tag=0U;({struct _dyneither_ptr _tmp5DA=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(_tmp3A2));_tmp362.f1=_tmp5DA;});({struct Cyc_String_pa_PrintArg_struct _tmp361;_tmp361.tag=0U;({struct _dyneither_ptr _tmp5DB=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp376->name));_tmp361.f1=_tmp5DB;});({void*_tmp35F[2U]={& _tmp361,& _tmp362};({struct _dyneither_ptr _tmp5DC=({const char*_tmp360="%s{%s}";_tag_dyneither(_tmp360,sizeof(char),7U);});Cyc_aprintf(_tmp5DC,_tag_dyneither(_tmp35F,sizeof(void*),2U));});});});});}else{goto _LL222;}}else{goto _LL222;}case 8U: _LL212: _tmp377=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp349)->f2;_LL213:
# 1607
 if(_tmp3A2 == 0)
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp365;_tmp365.tag=0U;({struct _dyneither_ptr _tmp5DD=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp377->name));_tmp365.f1=_tmp5DD;});({void*_tmp363[1U]={& _tmp365};({struct _dyneither_ptr _tmp5DE=({const char*_tmp364="%s";_tag_dyneither(_tmp364,sizeof(char),3U);});Cyc_aprintf(_tmp5DE,_tag_dyneither(_tmp363,sizeof(void*),1U));});});});else{
# 1610
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp369;_tmp369.tag=0U;({struct _dyneither_ptr _tmp5DF=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(_tmp3A2));_tmp369.f1=_tmp5DF;});({struct Cyc_String_pa_PrintArg_struct _tmp368;_tmp368.tag=0U;({struct _dyneither_ptr _tmp5E0=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp377->name));_tmp368.f1=_tmp5E0;});({void*_tmp366[2U]={& _tmp368,& _tmp369};({struct _dyneither_ptr _tmp5E1=({const char*_tmp367="%s(%s)";_tag_dyneither(_tmp367,sizeof(char),7U);});Cyc_aprintf(_tmp5E1,_tag_dyneither(_tmp366,sizeof(void*),2U));});});});});}case 9U: _LL214: _LL215:
 return({const char*_tmp36A="NULL";_tag_dyneither(_tmp36A,sizeof(char),5U);});case 10U: _LL216: _tmp378=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp349)->f2;_LL217:
 return(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp36D;_tmp36D.tag=1U;_tmp36D.f1=(unsigned long)_tmp378;({void*_tmp36B[1U]={& _tmp36D};({struct _dyneither_ptr _tmp5E2=({const char*_tmp36C="%d";_tag_dyneither(_tmp36C,sizeof(char),3U);});Cyc_aprintf(_tmp5E2,_tag_dyneither(_tmp36B,sizeof(void*),1U));});});});case 11U: _LL218: _tmp379=((struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp349)->f1;_LL219:
 return(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp370;_tmp370.tag=1U;_tmp370.f1=(unsigned long)((int)_tmp379);({void*_tmp36E[1U]={& _tmp370};({struct _dyneither_ptr _tmp5E3=({const char*_tmp36F="%d";_tag_dyneither(_tmp36F,sizeof(char),3U);});Cyc_aprintf(_tmp5E3,_tag_dyneither(_tmp36E,sizeof(void*),1U));});});});case 12U: _LL21A: _tmp37B=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp349)->f1;_tmp37A=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp349)->f2;_LL21B:
 return _tmp37B;case 13U: _LL21C: _tmp37C=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp349)->f2;_LL21D:
 _tmp37D=_tmp37C;goto _LL21F;case 14U: _LL21E: _tmp37D=((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp349)->f2;_LL21F:
 return Cyc_Absynpp_qvar2string(_tmp37D->name);case 17U: _LL220: _tmp37E=((struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp349)->f1;_LL221:
...
return(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp387;_tmp387.tag=1U;_tmp387.f1=(unsigned long)i;({void*_tmp385[1U]={& _tmp387};({struct _dyneither_ptr _tmp5E4=({const char*_tmp386="%d";_tag_dyneither(_tmp386,sizeof(char),3U);});Cyc_aprintf(_tmp5E4,_tag_dyneither(_tmp385,sizeof(void*),1U));});});});}}
# 1635
...
return(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp38B;_tmp38B.tag=1U;_tmp38B.f1=(unsigned long)((int)i);({void*_tmp389[1U]={& _tmp38B};({struct _dyneither_ptr _tmp5E5=({const char*_tmp38A="%d";_tag_dyneither(_tmp38A,sizeof(char),3U);});Cyc_aprintf(_tmp5E5,_tag_dyneither(_tmp389,sizeof(void*),1U));});});});}}
# 1643
(int)_throw((void*)& Cyc_Tcpat_Desc2string_val);}case 5U: _LL22E: _tmp39E=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp383)->f1).ptr_atts;_LL22F: {
# 1645
...
# 1651
return({const char*_tmp38E="&_";_tag_dyneither(_tmp38E,sizeof(char),3U);});}case 3U: if((((((struct Cyc_Absyn_DatatypeType_Absyn_Type_struct*)_tmp383)->f1).datatype_info).KnownDatatype).tag == 2U){_LL230: _tmp39F=*(((((struct Cyc_Absyn_DatatypeType_Absyn_Type_struct*)_tmp383)->f1).datatype_info).KnownDatatype).val;_LL231:
# 1653
...
return n;else{
# 1663
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp394;_tmp394.tag=0U;_tmp394.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)n);({void*_tmp392[1U]={& _tmp394};({struct _dyneither_ptr _tmp5E9=({const char*_tmp393="%s(...)";_tag_dyneither(_tmp393,sizeof(char),8U);});Cyc_aprintf(_tmp5E9,_tag_dyneither(_tmp392,sizeof(void*),1U));});});});}}}
# 1666
(int)_throw((void*)& Cyc_Tcpat_Desc2string_val);};}else{goto _LL234;}case 11U: if((((((struct Cyc_Absyn_AggrType_Absyn_Type_struct*)_tmp383)->f1).aggr_info).KnownAggr).tag == 2U){_LL232: _tmp3A0=*(((((struct Cyc_Absyn_AggrType_Absyn_Type_struct*)_tmp383)->f1).aggr_info).KnownAggr).val;if(_tmp3A0->kind == Cyc_Absyn_UnionA){_LL233: {
# 1668
...
({struct Cyc_String_pa_PrintArg_struct _tmp3B0;_tmp3B0.tag=0U;_tmp3B0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp3AD);({void*_tmp3AE[1U]={& _tmp3B0};({unsigned int _tmp5F0=loc;struct _dyneither_ptr _tmp5EF=({const char*_tmp3AF="patterns may not be exhaustive.\n\tmissing case for %s";_tag_dyneither(_tmp3AF,sizeof(char),53U);});Cyc_Tcutil_terr(_tmp5F0,_tmp5EF,_tag_dyneither(_tmp3AE,sizeof(void*),1U));});});});}
# 1698
...
# 1702
({void*_tmp3B2=0U;({unsigned int _tmp5F2=loc;struct _dyneither_ptr _tmp5F1=({const char*_tmp3B3="patterns may not be exhaustive.";_tag_dyneither(_tmp3B3,sizeof(char),32U);});Cyc_Tcutil_terr(_tmp5F2,_tmp5F1,_tag_dyneither(_tmp3B2,sizeof(void*),0U));});});
...
if(!_tmp3BF){
({void*_tmp3BC=0U;({unsigned int _tmp5F4=_tmp3BE;struct _dyneither_ptr _tmp5F3=({const char*_tmp3BD="redundant pattern (check for misspelled constructors in earlier patterns)";_tag_dyneither(_tmp3BD,sizeof(char),74U);});Cyc_Tcutil_terr(_tmp5F4,_tmp5F3,_tag_dyneither(_tmp3BC,sizeof(void*),0U));});});
# 1730
break;}}};}
# 1739
...
({struct Cyc_String_pa_PrintArg_struct _tmp3C6;_tmp3C6.tag=0U;_tmp3C6.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp3C3);({void*_tmp3C4[1U]={& _tmp3C6};({unsigned int _tmp5F6=(*pr).f1;struct _dyneither_ptr _tmp5F5=({const char*_tmp3C5="pattern not exhaustive.\n\tmissing case for %s";_tag_dyneither(_tmp3C5,sizeof(char),45U);});Cyc_Tcutil_warn(_tmp5F6,_tmp5F5,_tag_dyneither(_tmp3C4,sizeof(void*),1U));});});});}
# 1742
...
# 1746
({void*_tmp3C8=0U;({unsigned int _tmp5F8=(*pr).f1;struct _dyneither_ptr _tmp5F7=({const char*_tmp3C9="pattern not exhaustive.";_tag_dyneither(_tmp3C9,sizeof(char),24U);});Cyc_Tcutil_warn(_tmp5F8,_tmp5F7,_tag_dyneither(_tmp3C8,sizeof(void*),0U));});});
...
struct Cyc_Tcpat_Rhs*rhs=({struct Cyc_Tcpat_Rhs*_tmp3D2=_cycalloc(sizeof(*_tmp3D2));_tmp3D2->used=0;_tmp3D2->pat_loc=p->loc;({struct Cyc_Absyn_Stmt*_tmp5F9=Cyc_Absyn_skip_stmt(0U);_tmp3D2->rhs=_tmp5F9;});_tmp3D2;});
...
if(!_tmp3DD){
({void*_tmp3DA=0U;({unsigned int _tmp5FD=_tmp3DC;struct _dyneither_ptr _tmp5FC=({const char*_tmp3DB="redundant pattern (check for misspelled constructors in earlier patterns)";_tag_dyneither(_tmp3DB,sizeof(char),74U);});Cyc_Tcutil_terr(_tmp5FD,_tmp5FC,_tag_dyneither(_tmp3DA,sizeof(void*),0U));});});
break;}};}};}
# 1799
