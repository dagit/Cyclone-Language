...
Cyc_Iter_next(struct Cyc_Iter_Iter,void*);struct Cyc_Dict_T;typedef const struct Cyc_Dict_T*
...
Cyc_Dict_Present[8];struct Cyc_Dict_Present_exn_struct{char*tag;};extern char Cyc_Dict_Absent[
7];struct Cyc_Dict_Absent_exn_struct{char*tag;};struct Cyc_Set_Set;typedef struct
Cyc_Set_Set*Cyc_Set_set_t;struct Cyc_Set_Set*Cyc_Set_rempty(struct _RegionHandle*r,
...
Cyc_Set_Absent[7];struct Cyc_Set_Absent_exn_struct{char*tag;};void*Cyc_Set_choose(
...
void*Cyc_Absyn_uint_typ;extern void*Cyc_Absyn_sint_typ;void*Cyc_Absyn_float_typ(
int);extern void*Cyc_Absyn_empty_effect;struct Cyc_Absyn_Pat*Cyc_Absyn_new_pat(
void*p,unsigned int s);struct Cyc_Absyn_Vardecl*Cyc_Absyn_new_vardecl(struct
_tuple1*x,void*t,struct Cyc_Absyn_Exp*init);struct Cyc_PP_Ppstate;typedef struct Cyc_PP_Ppstate*
...
_RegionHandle*,struct Cyc_Tcenv_Tenv*,unsigned int,struct _tuple1*);struct Cyc_Absyn_Aggrdecl**
Cyc_Tcenv_lookup_aggrdecl(struct Cyc_Tcenv_Tenv*,unsigned int,struct _tuple1*);
...
struct Cyc_Absyn_Kind*k1,struct Cyc_Absyn_Kind*k2);struct Cyc_Absyn_Kind*Cyc_Tcutil_typ_kind(
void*t);void*Cyc_Tcutil_compress(void*t);int Cyc_Tcutil_coerceable(void*);extern
struct Cyc_Absyn_Kind Cyc_Tcutil_tmk;extern struct Cyc_Core_Opt Cyc_Tcutil_rko;extern
struct Cyc_Core_Opt Cyc_Tcutil_ako;extern struct Cyc_Core_Opt Cyc_Tcutil_mko;extern
struct Cyc_Core_Opt Cyc_Tcutil_trko;int Cyc_Tcutil_unify(void*,void*);void*Cyc_Tcutil_rsubstitute(
...
_tmp16;int _tmp17;struct Cyc_Absyn_Exp*_tmp19;_LL1: {struct Cyc_Absyn_UnknownId_p_Absyn_Raw_pat_struct*
_tmp1=(struct Cyc_Absyn_UnknownId_p_Absyn_Raw_pat_struct*)_tmp0;if(_tmp1->tag != 
14)goto _LL3;else{_tmp2=_tmp1->f1;}}_LL2:{struct _handler_cons _tmp1A;_push_handler(&
_tmp1A);{int _tmp1C=0;if(setjmp(_tmp1A.handler))_tmp1C=1;if(!_tmp1C){{struct
_RegionHandle _tmp1D=_new_region("r");struct _RegionHandle*r=& _tmp1D;_push_region(
r);{void*_tmp1E=Cyc_Tcenv_lookup_ordinary(r,te,p->loc,_tmp2);struct Cyc_Absyn_Datatypedecl*
...
!= 2)goto _LL12;else{_tmp21=_tmp20->f1;_tmp22=_tmp20->f2;}}_LL11:{struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct
_tmp3BE;struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp3BD;p->r=(void*)((
_tmp3BD=_cycalloc(sizeof(*_tmp3BD)),((_tmp3BD[0]=((_tmp3BE.tag=7,((_tmp3BE.f1=
_tmp21,((_tmp3BE.f2=_tmp22,((_tmp3BE.f3=0,((_tmp3BE.f4=0,_tmp3BE)))))))))),
...
goto _LL14;else{_tmp24=_tmp23->f1;_tmp25=_tmp23->f2;}}_LL13:{struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct
_tmp3C1;struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*_tmp3C0;p->r=(void*)((
_tmp3C0=_cycalloc(sizeof(*_tmp3C0)),((_tmp3C0[0]=((_tmp3C1.tag=12,((_tmp3C1.f1=
_tmp24,((_tmp3C1.f2=_tmp25,_tmp3C1)))))),_tmp3C0))));}_npop_handler(1);return;
_LL14: {struct Cyc_Tcenv_AnonEnumRes_Tcenv_Resolved_struct*_tmp26=(struct Cyc_Tcenv_AnonEnumRes_Tcenv_Resolved_struct*)
_tmp1E;if(_tmp26->tag != 4)goto _LL16;else{_tmp27=(void*)_tmp26->f1;_tmp28=_tmp26->f2;}}
_LL15:{struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct _tmp3C4;struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*
...
goto _LLD;}_LL17: goto _LLD;_LLD:;};_pop_region(r);};_pop_handler();}else{void*
_tmp1B=(void*)_exn_thrown;void*_tmp33=_tmp1B;_LL19: {struct Cyc_Dict_Absent_exn_struct*
_tmp34=(struct Cyc_Dict_Absent_exn_struct*)_tmp33;if(_tmp34->tag != Cyc_Dict_Absent)
...
struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*_tmp3=(struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*)
...
_tmp44;struct Cyc_Absyn_Datatypefield*_tmp45;_LL25: {struct Cyc_Tcenv_AggrRes_Tcenv_Resolved_struct*
_tmp41=(struct Cyc_Tcenv_AggrRes_Tcenv_Resolved_struct*)_tmp40;if(_tmp41->tag != 1)
goto _LL27;else{_tmp42=_tmp41->f1;}}_LL26: {struct Cyc_List_List*_tmp49=0;for(0;
_tmp5 != 0;_tmp5=_tmp5->tl){struct _tuple15*_tmp3CD;struct Cyc_List_List*_tmp3CC;
_tmp49=((_tmp3CC=_cycalloc(sizeof(*_tmp3CC)),((_tmp3CC->hd=((_tmp3CD=_cycalloc(
sizeof(*_tmp3CD)),((_tmp3CD->f1=0,((_tmp3CD->f2=(struct Cyc_Absyn_Pat*)_tmp5->hd,
_tmp3CD)))))),((_tmp3CC->tl=_tmp49,_tmp3CC))))));}{struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct
_tmp3D7;struct Cyc_Absyn_Aggrdecl**_tmp3D6;struct Cyc_Absyn_AggrInfo*_tmp3D5;
struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp3D4;p->r=(void*)((_tmp3D4=
_cycalloc(sizeof(*_tmp3D4)),((_tmp3D4[0]=((_tmp3D7.tag=6,((_tmp3D7.f1=((_tmp3D5=
_cycalloc(sizeof(*_tmp3D5)),((_tmp3D5->aggr_info=Cyc_Absyn_KnownAggr(((_tmp3D6=
_cycalloc(sizeof(*_tmp3D6)),((_tmp3D6[0]=_tmp42,_tmp3D6))))),((_tmp3D5->targs=0,
_tmp3D5)))))),((_tmp3D7.f2=0,((_tmp3D7.f3=((struct Cyc_List_List*(*)(struct Cyc_List_List*
x))Cyc_List_imp_rev)(_tmp49),((_tmp3D7.f4=_tmp6,_tmp3D7)))))))))),_tmp3D4))));}
...
!= 2)goto _LL29;else{_tmp44=_tmp43->f1;_tmp45=_tmp43->f2;}}_LL28:{struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct
_tmp3DA;struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp3D9;p->r=(void*)((
_tmp3D9=_cycalloc(sizeof(*_tmp3D9)),((_tmp3D9[0]=((_tmp3DA.tag=7,((_tmp3DA.f1=
_tmp44,((_tmp3DA.f2=_tmp45,((_tmp3DA.f3=_tmp5,((_tmp3DA.f4=_tmp6,_tmp3DA)))))))))),
_tmp3D9))));}_npop_handler(1);return;_LL29: {struct Cyc_Tcenv_EnumRes_Tcenv_Resolved_struct*
_tmp46=(struct Cyc_Tcenv_EnumRes_Tcenv_Resolved_struct*)_tmp40;if(_tmp46->tag != 3)
goto _LL2B;}_LL2A: goto _LL2C;_LL2B: {struct Cyc_Tcenv_AnonEnumRes_Tcenv_Resolved_struct*
_tmp47=(struct Cyc_Tcenv_AnonEnumRes_Tcenv_Resolved_struct*)_tmp40;if(_tmp47->tag
!= 4)goto _LL2D;}_LL2C:{const char*_tmp3DD;void*_tmp3DC;(_tmp3DC=0,Cyc_Tcutil_terr(
p->loc,((_tmp3DD="enum tag used with arguments in pattern",_tag_dyneither(
_tmp3DD,sizeof(char),40))),_tag_dyneither(_tmp3DC,sizeof(void*),0)));}p->r=(void*)&
Cyc_Absyn_Wild_p_val;_npop_handler(1);return;_LL2D: {struct Cyc_Tcenv_VarRes_Tcenv_Resolved_struct*
_tmp48=(struct Cyc_Tcenv_VarRes_Tcenv_Resolved_struct*)_tmp40;if(_tmp48->tag != 0)
goto _LL24;}_LL2E: goto _LL24;_LL24:;};_pop_region(r);};_pop_handler();}else{void*
_tmp3D=(void*)_exn_thrown;void*_tmp55=_tmp3D;_LL30: {struct Cyc_Dict_Absent_exn_struct*
_tmp56=(struct Cyc_Dict_Absent_exn_struct*)_tmp55;if(_tmp56->tag != Cyc_Dict_Absent)
goto _LL32;}_LL31: goto _LL2F;_LL32:;_LL33:(void)_throw(_tmp55);_LL2F:;}};}{const
char*_tmp3E1;void*_tmp3E0[1];struct Cyc_String_pa_PrintArg_struct _tmp3DF;(_tmp3DF.tag=
0,((_tmp3DF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
...
p->r=(void*)& Cyc_Absyn_Wild_p_val;return;_LL5: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*
_tmp7=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp0;if(_tmp7->tag != 6)goto
_LL7;else{_tmp8=_tmp7->f1;if(_tmp8 != 0)goto _LL7;_tmp9=_tmp7->f2;_tmpA=_tmp7->f3;
_tmpB=_tmp7->f4;}}_LL6: if(topt == 0){const char*_tmp3E4;void*_tmp3E3;(_tmp3E3=0,
Cyc_Tcutil_terr(p->loc,((_tmp3E4="cannot determine pattern type",_tag_dyneither(
_tmp3E4,sizeof(char),30))),_tag_dyneither(_tmp3E3,sizeof(void*),0)));}{void*t=
Cyc_Tcutil_compress(*((void**)_check_null(topt)));{void*_tmp5C=t;struct Cyc_Absyn_AggrInfo
_tmp5E;_LL35: {struct Cyc_Absyn_AggrType_Absyn_Type_struct*_tmp5D=(struct Cyc_Absyn_AggrType_Absyn_Type_struct*)
_tmp5C;if(_tmp5D->tag != 11)goto _LL37;else{_tmp5E=_tmp5D->f1;}}_LL36:{struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct
_tmp3EA;struct Cyc_Absyn_AggrInfo*_tmp3E9;struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*
_tmp3E8;p->r=(void*)((_tmp3E8=_cycalloc(sizeof(*_tmp3E8)),((_tmp3E8[0]=((_tmp3EA.tag=
6,((_tmp3EA.f1=((_tmp3E9=_cycalloc(sizeof(*_tmp3E9)),((_tmp3E9[0]=_tmp5E,_tmp3E9)))),((
_tmp3EA.f2=_tmp9,((_tmp3EA.f3=_tmpA,((_tmp3EA.f4=_tmpB,_tmp3EA)))))))))),_tmp3E8))));}
Cyc_Tcpat_resolve_pat(te,topt,p);goto _LL34;_LL37:;_LL38:{const char*_tmp3EE;void*
_tmp3ED[1];struct Cyc_String_pa_PrintArg_struct _tmp3EC;(_tmp3EC.tag=0,((_tmp3EC.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp3ED[
0]=& _tmp3EC,Cyc_Tcutil_terr(p->loc,((_tmp3EE="pattern expects aggregate type instead of %s",
_tag_dyneither(_tmp3EE,sizeof(char),45))),_tag_dyneither(_tmp3ED,sizeof(void*),1)))))));}
goto _LL34;_LL34:;}return;};_LL7: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*
_tmpC=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp0;if(_tmpC->tag != 6)goto
_LL9;else{_tmpD=_tmpC->f1;if(_tmpD == 0)goto _LL9;_tmpE=*_tmpD;_tmpF=_tmpE.aggr_info;
if((_tmpF.UnknownAggr).tag != 1)goto _LL9;_tmp10=(struct _tuple3)(_tmpF.UnknownAggr).val;
_tmp11=_tmp10.f1;_tmp12=_tmp10.f2;_tmp13=_tmpE.targs;_tmp14=_tmpC->f2;_tmp15=(
struct Cyc_List_List**)& _tmpC->f2;_tmp16=_tmpC->f3;_tmp17=_tmpC->f4;}}_LL8:{
struct _handler_cons _tmp65;_push_handler(& _tmp65);{int _tmp67=0;if(setjmp(_tmp65.handler))
_tmp67=1;if(!_tmp67){{struct Cyc_Absyn_Aggrdecl**_tmp68=Cyc_Tcenv_lookup_aggrdecl(
te,p->loc,_tmp12);struct Cyc_Absyn_Aggrdecl*_tmp69=*_tmp68;if(_tmp69->impl == 0){{
const char*_tmp3F6;void*_tmp3F5[1];const char*_tmp3F4;const char*_tmp3F3;struct Cyc_String_pa_PrintArg_struct
...
more_exists){struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*_tmp3FF;struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct
...
struct Cyc_List_List*y))Cyc_List_imp_append)(*_tmp15,_tmp72);}}{struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct
_tmp405;struct Cyc_Absyn_AggrInfo*_tmp404;struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*
_tmp403;p->r=(void*)((_tmp403=_cycalloc(sizeof(*_tmp403)),((_tmp403[0]=((_tmp405.tag=
6,((_tmp405.f1=((_tmp404=_cycalloc(sizeof(*_tmp404)),((_tmp404->aggr_info=Cyc_Absyn_KnownAggr(
_tmp68),((_tmp404->targs=_tmp13,_tmp404)))))),((_tmp405.f2=*_tmp15,((_tmp405.f3=
_tmp16,((_tmp405.f4=_tmp17,_tmp405)))))))))),_tmp403))));};};};_pop_handler();}
else{void*_tmp66=(void*)_exn_thrown;void*_tmp7A=_tmp66;_LL3A: {struct Cyc_Dict_Absent_exn_struct*
_tmp7B=(struct Cyc_Dict_Absent_exn_struct*)_tmp7A;if(_tmp7B->tag != Cyc_Dict_Absent)
...
goto _LL39;_LL3C:;_LL3D:(void)_throw(_tmp7A);_LL39:;}};}return;_LL9: {struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*
_tmp18=(struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp0;if(_tmp18->tag != 16)
goto _LLB;else{_tmp19=_tmp18->f1;}}_LLA: Cyc_Tcexp_tcExp(te,0,_tmp19);if(!Cyc_Tcutil_is_const_exp(
...
_tmp19);_tmp81=_tmp80.f1;_tmp82=_tmp80.f2;{struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct
_tmp40E;struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmp40D;p->r=(void*)((_tmp40D=
_cycalloc_atomic(sizeof(*_tmp40D)),((_tmp40D[0]=((_tmp40E.tag=9,((_tmp40E.f1=Cyc_Absyn_None,((
...
numt);_LL3F: {struct Cyc_Absyn_EnumType_Absyn_Type_struct*_tmp87=(struct Cyc_Absyn_EnumType_Absyn_Type_struct*)
...
_tmp416)));};};}static struct Cyc_Absyn_Pat*Cyc_Tcpat_wild_pat(unsigned int loc){
struct Cyc_Absyn_Pat*_tmp417;return(_tmp417=_cycalloc(sizeof(*_tmp417)),((_tmp417->loc=
loc,((_tmp417->topt=0,((_tmp417->r=(void*)& Cyc_Absyn_Wild_p_val,_tmp417)))))));}
...
te,topt,p);{void*t;struct Cyc_Tcpat_TcPatResult _tmp418;struct Cyc_Tcpat_TcPatResult
res=(_tmp418.tvars_and_bounds_opt=0,((_tmp418.patvars=0,_tmp418)));{void*_tmp95=
...
_tmpCC;_LL44: {struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*_tmp96=(struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*)
_tmp95;if(_tmp96->tag != 0)goto _LL46;}_LL45: t=Cyc_Tcpat_any_type(Cyc_Tcenv_lookup_type_vars(
te),topt);goto _LL43;_LL46: {struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp97=(
struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmp97->tag != 1)goto _LL48;
else{_tmp98=_tmp97->f1;_tmp99=_tmp97->f2;}}_LL47: res=Cyc_Tcpat_tcPatRec(te,
_tmp99,topt,rgn_opt);t=(void*)_check_null(_tmp99->topt);if(!Cyc_Tcutil_kind_leq(
Cyc_Tcutil_typ_kind(t),& Cyc_Tcutil_tmk)){const char*_tmp41B;void*_tmp41A;(_tmp41A=
0,Cyc_Tcutil_terr(p->loc,((_tmp41B="pattern would point to an abstract member",
_tag_dyneither(_tmp41B,sizeof(char),42))),_tag_dyneither(_tmp41A,sizeof(void*),0)));}
Cyc_Tcpat_set_vd(_tmp98,& res.patvars,t);goto _LL43;_LL48: {struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*
_tmp9A=(struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmp9A->tag
!= 2)goto _LL4A;else{_tmp9B=_tmp9A->f1;_tmp9C=_tmp9A->f2;}}_LL49: res=Cyc_Tcpat_tcPatRec(
te,_tmp9C,topt,rgn_opt);t=(void*)_check_null(_tmp9C->topt);if(rgn_opt == 0){{
...
goto _LL43;}else{if(Cyc_Tcutil_is_noalias_pointer(t)){const char*_tmp421;void*
_tmp420;(_tmp420=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
...
Cyc_Absyn_PointerType_Absyn_Type_struct _tmp42B;struct Cyc_Absyn_PtrAtts _tmp42A;
struct Cyc_Absyn_PtrInfo _tmp429;struct Cyc_Absyn_PointerType_Absyn_Type_struct*
_tmp428;Cyc_Tcpat_set_vd(_tmp9B,& res.patvars,(void*)((_tmp428=_cycalloc(sizeof(*
_tmp428)),((_tmp428[0]=((_tmp42B.tag=5,((_tmp42B.f1=((_tmp429.elt_typ=t,((
_tmp429.elt_tq=Cyc_Absyn_empty_tqual(0),((_tmp429.ptr_atts=((_tmp42A.rgn=*
rgn_opt,((_tmp42A.nullable=Cyc_Absyn_false_conref,((_tmp42A.bounds=((union Cyc_Absyn_Constraint*(*)())
Cyc_Absyn_empty_conref)(),((_tmp42A.zero_term=((union Cyc_Absyn_Constraint*(*)())
Cyc_Absyn_empty_conref)(),((_tmp42A.ptrloc=0,_tmp42A)))))))))),_tmp429)))))),
_tmp42B)))),_tmp428)))));}goto _LL43;_LL4A: {struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*
_tmp9D=(struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmp9D->tag != 3)
goto _LL4C;else{_tmp9E=_tmp9D->f1;_tmp9F=_tmp9D->f2;}}_LL4B: Cyc_Tcpat_set_vd(
_tmp9F,& res.patvars,_tmp9F->type);{struct _RegionHandle _tmpDA=_new_region("r2");
struct _RegionHandle*r2=& _tmpDA;_push_region(r2);{struct Cyc_Absyn_Tvar*_tmp42C[1];
Cyc_Tcenv_add_type_vars(r2,p->loc,te,((_tmp42C[0]=_tmp9E,((struct Cyc_List_List*(*)(
struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp42C,sizeof(struct Cyc_Absyn_Tvar*),
...
_tmp42E))))));}t=Cyc_Absyn_uint_typ;_npop_handler(0);goto _LL43;;_pop_region(r2);};
_LL4C: {struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmpA0=(struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)
_tmp95;if(_tmpA0->tag != 9)goto _LL4E;else{_tmpA1=_tmpA0->f1;if(_tmpA1 != Cyc_Absyn_Unsigned)
goto _LL4E;}}_LL4D: t=Cyc_Tcpat_num_type(topt,Cyc_Absyn_uint_typ);goto _LL43;_LL4E: {
struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmpA2=(struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)
_tmp95;if(_tmpA2->tag != 9)goto _LL50;else{_tmpA3=_tmpA2->f1;if(_tmpA3 != Cyc_Absyn_None)
goto _LL50;}}_LL4F: goto _LL51;_LL50: {struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*
_tmpA4=(struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmpA4->tag != 9)
goto _LL52;else{_tmpA5=_tmpA4->f1;if(_tmpA5 != Cyc_Absyn_Signed)goto _LL52;}}_LL51:
...
goto _LL54;}_LL53: t=Cyc_Tcpat_num_type(topt,Cyc_Absyn_char_typ);goto _LL43;_LL54: {
struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*_tmpA7=(struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)
_tmp95;if(_tmpA7->tag != 11)goto _LL56;else{_tmpA8=_tmpA7->f2;}}_LL55: t=Cyc_Tcpat_num_type(
topt,Cyc_Absyn_float_typ(_tmpA8));goto _LL43;_LL56: {struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*
_tmpA9=(struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmpA9->tag != 12)
goto _LL58;else{_tmpAA=_tmpA9->f1;}}_LL57:{struct Cyc_Absyn_EnumType_Absyn_Type_struct
_tmp431;struct Cyc_Absyn_EnumType_Absyn_Type_struct*_tmp430;t=Cyc_Tcpat_num_type(
topt,(void*)((_tmp430=_cycalloc(sizeof(*_tmp430)),((_tmp430[0]=((_tmp431.tag=13,((
_tmp431.f1=_tmpAA->name,((_tmp431.f2=(struct Cyc_Absyn_Enumdecl*)_tmpAA,_tmp431)))))),
_tmp430)))));}goto _LL43;_LL58: {struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*
_tmpAB=(struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmpAB->tag != 
13)goto _LL5A;else{_tmpAC=(void*)_tmpAB->f1;}}_LL59: t=Cyc_Tcpat_num_type(topt,
_tmpAC);goto _LL43;_LL5A: {struct Cyc_Absyn_Null_p_Absyn_Raw_pat_struct*_tmpAD=(
struct Cyc_Absyn_Null_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmpAD->tag != 8)goto _LL5C;}
_LL5B: if(topt != 0){void*_tmpE0=Cyc_Tcutil_compress(*topt);_LL6F: {struct Cyc_Absyn_PointerType_Absyn_Type_struct*
_tmpE1=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmpE0;if(_tmpE1->tag != 5)
goto _LL71;}_LL70: t=*topt;goto tcpat_end;_LL71:;_LL72: goto _LL6E;_LL6E:;}{struct Cyc_Core_Opt*
_tmpE2=Cyc_Tcenv_lookup_opt_type_vars(te);{struct Cyc_Absyn_PointerType_Absyn_Type_struct
_tmp43B;struct Cyc_Absyn_PtrAtts _tmp43A;struct Cyc_Absyn_PtrInfo _tmp439;struct Cyc_Absyn_PointerType_Absyn_Type_struct*
...
_tmpE2),((_tmp439.elt_tq=Cyc_Absyn_empty_tqual(0),((_tmp439.ptr_atts=((_tmp43A.rgn=
Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_rko,_tmpE2),((_tmp43A.nullable=
Cyc_Absyn_true_conref,((_tmp43A.bounds=((union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)(),((
_tmp43A.zero_term=((union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)(),((
_tmp43A.ptrloc=0,_tmp43A)))))))))),_tmp439)))))),_tmp43B)))),_tmp438))));}goto
_LL43;};_LL5C: {struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*_tmpAE=(struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)
...
_LL75: inner_typ=_tmpEB;_tmpE7=(void**)& inner_typ;elt_const=_tmpEC.real_const;
goto _LL73;_LL76:;_LL77: goto _LL73;_LL73:;}{void*ptr_rgn=Cyc_Absyn_new_evar((
struct Cyc_Core_Opt*)& Cyc_Tcutil_trko,Cyc_Tcenv_lookup_opt_type_vars(te));res=Cyc_Tcpat_combine_results(
res,Cyc_Tcpat_tcPatRec(te,_tmpAF,_tmpE7,(void**)& ptr_rgn));{void*_tmpED=Cyc_Tcutil_compress((
void*)_check_null(_tmpAF->topt));struct Cyc_Absyn_DatatypeFieldInfo _tmpEF;union
Cyc_Absyn_DatatypeFieldInfoU _tmpF0;struct _tuple2 _tmpF1;struct Cyc_Absyn_Datatypedecl*
...
inner_typ);_LL7E: {struct Cyc_Absyn_DatatypeFieldType_Absyn_Type_struct*_tmpF6=(
struct Cyc_Absyn_DatatypeFieldType_Absyn_Type_struct*)_tmpF5;if(_tmpF6->tag != 4)
goto _LL80;}_LL7F: goto DONT_PROMOTE;_LL80:;_LL81: goto _LL7D;_LL7D:;}{struct Cyc_Absyn_DatatypeType_Absyn_Type_struct
_tmp445;struct Cyc_Absyn_Datatypedecl**_tmp444;struct Cyc_Absyn_DatatypeInfo
_tmp443;struct Cyc_Absyn_DatatypeType_Absyn_Type_struct*_tmp442;void*new_type=(
void*)((_tmp442=_cycalloc(sizeof(*_tmp442)),((_tmp442[0]=((_tmp445.tag=3,((
_tmp445.f1=((_tmp443.datatype_info=Cyc_Absyn_KnownDatatype(((_tmp444=_cycalloc(
sizeof(*_tmp444)),((_tmp444[0]=_tmpF2,_tmp444))))),((_tmp443.targs=_tmpF4,
_tmp443)))),_tmp445)))),_tmp442))));_tmpAF->topt=(void*)new_type;{struct Cyc_Absyn_PointerType_Absyn_Type_struct
_tmp44F;struct Cyc_Absyn_PtrAtts _tmp44E;struct Cyc_Absyn_PtrInfo _tmp44D;struct Cyc_Absyn_PointerType_Absyn_Type_struct*
_tmp44C;t=(void*)((_tmp44C=_cycalloc(sizeof(*_tmp44C)),((_tmp44C[0]=((_tmp44F.tag=
5,((_tmp44F.f1=((_tmp44D.elt_typ=new_type,((_tmp44D.elt_tq=elt_const?Cyc_Absyn_const_tqual(
...
elt_const?Cyc_Absyn_const_tqual(0): Cyc_Absyn_empty_tqual(0),((_tmp457.ptr_atts=((
_tmp458.rgn=ptr_rgn,((_tmp458.nullable=((union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)(),((
_tmp458.bounds=((union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)(),((
...
goto _LL43;};}_LL5E: {struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*_tmpB0=(struct
Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmpB0->tag != 4)goto _LL60;
else{_tmpB1=_tmpB0->f1;_tmpB2=(struct Cyc_List_List**)& _tmpB0->f1;_tmpB3=_tmpB0->f2;}}
_LL5F: {struct Cyc_List_List*_tmp103=*_tmpB2;struct Cyc_List_List*pat_ts=0;struct
Cyc_List_List*topt_ts=0;if(topt != 0){void*_tmp104=Cyc_Tcutil_compress(*topt);
struct Cyc_List_List*_tmp106;_LL83: {struct Cyc_Absyn_TupleType_Absyn_Type_struct*
_tmp105=(struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp104;if(_tmp105->tag != 
10)goto _LL85;else{_tmp106=_tmp105->f1;}}_LL84: topt_ts=_tmp106;if(_tmpB3){int
_tmp107=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp103);int _tmp108=((
int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp106);if(_tmp107 < _tmp108){
struct Cyc_List_List*wild_ps=0;{int i=0;for(0;i < _tmp108 - _tmp107;++ i){struct Cyc_List_List*
_tmp45A;wild_ps=((_tmp45A=_cycalloc(sizeof(*_tmp45A)),((_tmp45A->hd=Cyc_Tcpat_wild_pat(
p->loc),((_tmp45A->tl=wild_ps,_tmp45A))))));}}*_tmpB2=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp103,
wild_ps);_tmp103=*_tmpB2;}else{if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmp103)== ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp106)){const char*
_tmp45D;void*_tmp45C;(_tmp45C=0,Cyc_Tcutil_warn(p->loc,((_tmp45D="unnecessary ... in tuple pattern",
...
_tmp103->hd)->topt),_tmp463)))))),((_tmp462->tl=pat_ts,_tmp462))))));};}{struct
Cyc_Absyn_TupleType_Absyn_Type_struct _tmp466;struct Cyc_Absyn_TupleType_Absyn_Type_struct*
...
pat_ts),_tmp466)))),_tmp465))));}goto _LL43;}_LL60: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*
_tmpB4=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmpB4->tag != 6)
goto _LL62;else{_tmpB5=_tmpB4->f1;if(_tmpB5 == 0)goto _LL62;_tmpB6=*_tmpB5;_tmpB7=
_tmpB6.aggr_info;if((_tmpB7.KnownAggr).tag != 2)goto _LL62;_tmpB8=(struct Cyc_Absyn_Aggrdecl**)(
...
_tmpB4->f3;_tmpBF=_tmpB4->f4;}}_LL61: {struct Cyc_List_List*_tmp113=*_tmpBE;const
...
void*_tmp46B[1];struct Cyc_String_pa_PrintArg_struct _tmp46A;(_tmp46A.tag=0,((
_tmp46A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)aggr_str),((_tmp46B[0]=&
_tmp46A,Cyc_Tcutil_terr(p->loc,((_tmp46C="can't destructure an abstract %s",
_tag_dyneither(_tmp46C,sizeof(char),33))),_tag_dyneither(_tmp46B,sizeof(void*),1)))))));}
t=Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te));goto _LL43;}if(_tmpBC != 0
 || _tmpB9->kind == Cyc_Absyn_UnionA  && ((struct Cyc_Absyn_AggrdeclImpl*)
_check_null(_tmpB9->impl))->tagged)rgn_opt=0;{struct _RegionHandle _tmp117=
_new_region("rgn");struct _RegionHandle*rgn=& _tmp117;_push_region(rgn);{struct Cyc_List_List*
_tmp118=0;struct Cyc_List_List*outlives_constraints=0;struct Cyc_List_List*_tmp119=((
struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmpB9->impl))->exist_vars;{struct Cyc_List_List*
t=_tmpBC;for(0;t != 0;t=t->tl){struct Cyc_Absyn_Tvar*tv=(struct Cyc_Absyn_Tvar*)t->hd;
struct Cyc_Absyn_Tvar*uv=(struct Cyc_Absyn_Tvar*)((struct Cyc_List_List*)
_check_null(_tmp119))->hd;_tmp119=_tmp119->tl;{void*_tmp11A=Cyc_Absyn_compress_kb(
tv->kind);void*_tmp11B=Cyc_Absyn_compress_kb(uv->kind);int error=0;struct Cyc_Absyn_Kind*
k2;{void*_tmp11C=_tmp11B;struct Cyc_Absyn_Kind*_tmp11E;struct Cyc_Absyn_Kind*
_tmp120;_LL88: {struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp11D=(struct
Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp11C;if(_tmp11D->tag != 2)goto _LL8A;
else{_tmp11E=_tmp11D->f2;}}_LL89: _tmp120=_tmp11E;goto _LL8B;_LL8A: {struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*
_tmp11F=(struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp11C;if(_tmp11F->tag != 
0)goto _LL8C;else{_tmp120=_tmp11F->f1;}}_LL8B: k2=_tmp120;goto _LL87;_LL8C:;_LL8D: {
...
0)goto _LL91;else{_tmp125=_tmp124->f1;}}_LL90: if(!Cyc_Tcutil_kind_leq(k2,_tmp125))
error=1;goto _LL8E;_LL91: {struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp126=(
...
_tmp129=_tmp126->f2;}}_LL92: _tmp12C=_tmp128;goto _LL94;_LL93: {struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*
...
_LL94:{struct Cyc_Core_Opt*_tmp470;*_tmp12C=((_tmp470=_cycalloc(sizeof(*_tmp470)),((
_tmp470->v=_tmp11B,_tmp470))));}goto _LL8E;_LL8E:;}if(error){const char*_tmp476;
void*_tmp475[3];struct Cyc_String_pa_PrintArg_struct _tmp474;struct Cyc_String_pa_PrintArg_struct
_tmp473;struct Cyc_String_pa_PrintArg_struct _tmp472;(_tmp472.tag=0,((_tmp472.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(k2)),((
_tmp473.tag=0,((_tmp473.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kindbound2string(
_tmp11A)),((_tmp474.tag=0,((_tmp474.f1=(struct _dyneither_ptr)((struct
...
_tmp479.tag=2,((_tmp479.f1=tv,_tmp479)))),_tmp478))));{struct Cyc_List_List*
_tmp47A;_tmp118=((_tmp47A=_region_malloc(rgn,sizeof(*_tmp47A)),((_tmp47A->hd=(
void*)vartype,((_tmp47A->tl=_tmp118,_tmp47A))))));}if(k2->kind == Cyc_Absyn_RgnKind){
if(k2->aliasqual == Cyc_Absyn_Aliasable){struct _tuple0*_tmp47D;struct Cyc_List_List*
_tmp47C;outlives_constraints=((_tmp47C=_cycalloc(sizeof(*_tmp47C)),((_tmp47C->hd=((
...
_tmp118);{struct _RegionHandle _tmp13A=_new_region("r2");struct _RegionHandle*r2=&
_tmp13A;_push_region(r2);{struct Cyc_Tcenv_Tenv*te2=Cyc_Tcenv_add_type_vars(r2,p->loc,
te,_tmpBC);struct Cyc_List_List*_tmp13B=Cyc_Tcenv_lookup_type_vars(te2);struct
_tuple11 _tmp481;struct _tuple11 _tmp13C=(_tmp481.f1=_tmp13B,((_tmp481.f2=rgn,
_tmp481)));struct Cyc_List_List*_tmp13D=((struct Cyc_List_List*(*)(struct
...
_tmp13C,_tmpB9->tvs);struct Cyc_List_List*_tmp13E=((struct Cyc_List_List*(*)(
struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x,struct Cyc_List_List*
y))Cyc_List_rzip)(rgn,rgn,((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmpB9->impl))->exist_vars,
_tmp118);struct Cyc_List_List*_tmp13F=((struct Cyc_List_List*(*)(void*(*f)(struct
_tuple12*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple12*))Cyc_Core_snd,
_tmp13D);struct Cyc_List_List*_tmp140=((struct Cyc_List_List*(*)(void*(*f)(struct
_tuple12*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple12*))Cyc_Core_snd,
_tmp13E);struct Cyc_List_List*_tmp141=((struct Cyc_List_List*(*)(struct
_RegionHandle*,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rappend)(
rgn,_tmp13D,_tmp13E);if(_tmpBC != 0  || ((struct Cyc_Absyn_AggrdeclImpl*)
...
_tmp144=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmpB9->impl))->rgn_po;for(0;
_tmp144 != 0;_tmp144=_tmp144->tl){struct _tuple0*_tmp485;struct Cyc_List_List*
_tmp484;_tmp143=((_tmp484=_cycalloc(sizeof(*_tmp484)),((_tmp484->hd=((_tmp485=
_cycalloc(sizeof(*_tmp485)),((_tmp485->f1=Cyc_Tcutil_rsubstitute(rgn,_tmp141,(*((
struct _tuple0*)_tmp144->hd)).f1),((_tmp485->f2=Cyc_Tcutil_rsubstitute(rgn,
_tmp141,(*((struct _tuple0*)_tmp144->hd)).f2),_tmp485)))))),((_tmp484->tl=_tmp143,
_tmp484))))));}}_tmp143=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(
...
_tmpBB=_tmp13F;{struct Cyc_Absyn_AggrType_Absyn_Type_struct _tmp48F;struct Cyc_Absyn_Aggrdecl**
...
_tmp48D)))),_tmp48F)))),_tmp48C))));}if(_tmpBF  && _tmpB9->kind == Cyc_Absyn_UnionA){
...
else{if(_tmpBF){int _tmp14D=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmp113);int _tmp14E=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(((struct Cyc_Absyn_AggrdeclImpl*)
_check_null(_tmpB9->impl))->fields);if(_tmp14D < _tmp14E){struct Cyc_List_List*
wild_dps=0;{int i=0;for(0;i < _tmp14E - _tmp14D;++ i){struct _tuple15*_tmp495;struct
...
wild_dps);_tmp113=*_tmpBE;}else{if(_tmp14D == _tmp14E){const char*_tmp498;void*
...
fields))Cyc_Tcutil_resolve_aggregate_designators)(rgn,p->loc,_tmp113,_tmpB9->kind,((
struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmpB9->impl))->fields);for(0;fields != 
0;fields=fields->tl){struct _tuple17 _tmp154;struct Cyc_Absyn_Aggrfield*_tmp155;
struct Cyc_Absyn_Pat*_tmp156;struct _tuple17*_tmp153=(struct _tuple17*)fields->hd;
_tmp154=*_tmp153;_tmp155=_tmp154.f1;_tmp156=_tmp154.f2;{void*_tmp157=Cyc_Tcutil_rsubstitute(
rgn,_tmp141,_tmp155->type);res=Cyc_Tcpat_combine_results(res,Cyc_Tcpat_tcPatRec(
te2,_tmp156,(void**)& _tmp157,rgn_opt));if(!Cyc_Tcutil_unify((void*)_check_null(
_tmp156->topt),_tmp157)){const char*_tmp49F;void*_tmp49E[4];struct Cyc_String_pa_PrintArg_struct
_tmp49D;struct Cyc_String_pa_PrintArg_struct _tmp49C;struct Cyc_String_pa_PrintArg_struct
...
_check_null(_tmp156->topt))),((_tmp49B.tag=0,((_tmp49B.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp157)),((_tmp49C.tag=0,((_tmp49C.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)aggr_str),((_tmp49D.tag=0,((_tmp49D.f1=(
...
struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmpC0=(struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)
...
_LL63: {struct Cyc_List_List*_tmp161=*_tmpC4;struct _RegionHandle _tmp162=
_new_region("rgn");struct _RegionHandle*rgn=& _tmp162;_push_region(rgn);{struct Cyc_List_List*
tqts=_tmpC2->typs;struct Cyc_List_List*_tmp163=Cyc_Tcenv_lookup_type_vars(te);
struct _tuple11 _tmp4A0;struct _tuple11 _tmp164=(_tmp4A0.f1=_tmp163,((_tmp4A0.f2=rgn,
_tmp4A0)));struct Cyc_List_List*_tmp165=((struct Cyc_List_List*(*)(struct
_RegionHandle*,struct _tuple12*(*f)(struct _tuple11*,struct Cyc_Absyn_Tvar*),struct
_tuple11*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(rgn,Cyc_Tcutil_r_make_inst_var,&
_tmp164,_tmpC1->tvs);struct Cyc_List_List*_tmp166=((struct Cyc_List_List*(*)(void*(*
f)(struct _tuple12*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct
_tuple12*))Cyc_Core_snd,_tmp165);{struct Cyc_Absyn_DatatypeFieldType_Absyn_Type_struct
...
_tmp4A5.targs=_tmp166,_tmp4A5)))),_tmp4A6)))),_tmp4A4))));}if(_tmpC5){int _tmp16A=((
...
wild_ps=0;{int i=0;for(0;i < _tmp16B - _tmp16A;++ i){struct Cyc_List_List*_tmp4A7;
...
x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp161,wild_ps);_tmp161=*_tmpC4;}
else{if(_tmp16A == _tmp16B){const char*_tmp4AB;void*_tmp4AA[1];struct Cyc_String_pa_PrintArg_struct
...
char),37))),_tag_dyneither(_tmp4AA,sizeof(void*),1)))))));}}}for(0;_tmp161 != 0
 && tqts != 0;(_tmp161=_tmp161->tl,tqts=tqts->tl)){struct Cyc_Absyn_Pat*_tmp170=(
struct Cyc_Absyn_Pat*)_tmp161->hd;void*_tmp171=Cyc_Tcutil_rsubstitute(rgn,_tmp165,(*((
struct _tuple16*)tqts->hd)).f2);res=Cyc_Tcpat_combine_results(res,Cyc_Tcpat_tcPatRec(
te,_tmp170,(void**)& _tmp171,rgn_opt));if(!Cyc_Tcutil_unify((void*)_check_null(
_tmp170->topt),_tmp171)){const char*_tmp4B1;void*_tmp4B0[3];struct Cyc_String_pa_PrintArg_struct
_tmp4AF;struct Cyc_String_pa_PrintArg_struct _tmp4AE;struct Cyc_String_pa_PrintArg_struct
...
_tmp4AE.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
_tmp171)),((_tmp4AF.tag=0,((_tmp4AF.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpC2->name)),((_tmp4B0[0]=& _tmp4AF,((
_tmp4B0[1]=& _tmp4AE,((_tmp4B0[2]=& _tmp4AD,Cyc_Tcutil_terr(_tmp170->loc,((_tmp4B1="%s expects argument type %s, not %s",
_tag_dyneither(_tmp4B1,sizeof(char),36))),_tag_dyneither(_tmp4B0,sizeof(void*),3)))))))))))))))))));}}
if(_tmp161 != 0){const char*_tmp4B5;void*_tmp4B4[1];struct Cyc_String_pa_PrintArg_struct
...
_tmp4B7.tag=0,((_tmp4B7.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
...
_npop_handler(0);goto _LL43;;_pop_region(rgn);}_LL64: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*
_tmpC6=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmpC6->tag != 6)
goto _LL66;else{_tmpC7=_tmpC6->f1;if(_tmpC7 != 0)goto _LL66;}}_LL65: goto _LL67;_LL66: {
struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmpC8=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)
...
struct Cyc_Absyn_UnknownId_p_Absyn_Raw_pat_struct*_tmpCD=(struct Cyc_Absyn_UnknownId_p_Absyn_Raw_pat_struct*)
_tmp95;if(_tmpCD->tag != 14)goto _LL6A;}_LL69: goto _LL6B;_LL6A: {struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*
_tmpCE=(struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmpCE->tag != 16)
goto _LL6C;}_LL6B: goto _LL6D;_LL6C: {struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*
_tmpCF=(struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*)_tmp95;if(_tmpCF->tag
!= 15)goto _LL43;}_LL6D: t=Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te));
goto _LL43;_LL43:;}tcpat_end: p->topt=(void*)t;return res;};}struct Cyc_Tcpat_TcPatResult
Cyc_Tcpat_tcPat(struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Pat*p,void**topt){struct
Cyc_Tcpat_TcPatResult _tmp17F=Cyc_Tcpat_tcPatRec(te,p,(void**)topt,0);struct
_RegionHandle _tmp180=_new_region("r");struct _RegionHandle*r=& _tmp180;
_push_region(r);{const char*_tmp4BA;Cyc_Tcutil_check_unique_vars(((struct Cyc_List_List*(*)(
struct _RegionHandle*,struct _dyneither_ptr*(*f)(struct Cyc_Absyn_Vardecl*),struct
Cyc_List_List*x))Cyc_List_rmap)(r,Cyc_Tcpat_get_name,_tmp17F.patvars),p->loc,((
_tmp4BA="pattern contains a repeated variable",_tag_dyneither(_tmp4BA,sizeof(
char),37))));}{struct Cyc_Tcpat_TcPatResult _tmp182=_tmp17F;_npop_handler(0);
return _tmp182;};;_pop_region(r);}void Cyc_Tcpat_check_pat_regions(struct Cyc_Tcenv_Tenv*
...
_LL96: {struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*_tmp184=(struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)
_tmp183;if(_tmp184->tag != 5)goto _LL98;else{_tmp185=_tmp184->f1;}}_LL97: Cyc_Tcpat_check_pat_regions(
te,_tmp185);{struct _RegionHandle _tmp18C=_new_region("temp");struct _RegionHandle*
temp=& _tmp18C;_push_region(temp);if(Cyc_Tcutil_is_noalias_pointer_or_aggr(temp,(
void*)_check_null(_tmp185->topt))){{const char*_tmp4BD;void*_tmp4BC;(_tmp4BC=0,
Cyc_Tcutil_terr(p->loc,((_tmp4BD="Pattern dereferences to a non-aliased pointer; use swap",
...
_check_null(p->topt))){{const char*_tmp4C0;void*_tmp4BF;(_tmp4BF=0,Cyc_Tcutil_terr(
p->loc,((_tmp4C0="Pattern dereferences a non-aliased pointer; use swap",
_tag_dyneither(_tmp4C0,sizeof(char),53))),_tag_dyneither(_tmp4BF,sizeof(void*),0)));}
_npop_handler(0);return;}{void*_tmp191=(void*)_check_null(p->topt);struct Cyc_Absyn_PtrInfo
_tmp193;struct Cyc_Absyn_PtrAtts _tmp194;void*_tmp195;_LLA1: {struct Cyc_Absyn_PointerType_Absyn_Type_struct*
...
_LLA2: Cyc_Tcenv_check_rgn_accessible(te,p->loc,_tmp195);_npop_handler(0);return;
_LLA3:;_LLA4: {const char*_tmp4C3;void*_tmp4C2;(_tmp4C2=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp4C3="check_pat_regions: bad pointer type",
_tag_dyneither(_tmp4C3,sizeof(char),36))),_tag_dyneither(_tmp4C2,sizeof(void*),0)));}
_LLA0:;};;_pop_region(temp);};_LL98: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*
_tmp186=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp183;if(_tmp186->tag != 
6)goto _LL9A;else{_tmp187=_tmp186->f3;}}_LL99: for(0;_tmp187 != 0;_tmp187=_tmp187->tl){
Cyc_Tcpat_check_pat_regions(te,(*((struct _tuple15*)_tmp187->hd)).f2);}return;
_LL9A: {struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp188=(struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)
_tmp183;if(_tmp188->tag != 7)goto _LL9C;else{_tmp189=_tmp188->f3;}}_LL9B: _tmp18B=
_tmp189;goto _LL9D;_LL9C: {struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*_tmp18A=(
struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp183;if(_tmp18A->tag != 4)goto
_LL9E;else{_tmp18B=_tmp18A->f1;}}_LL9D: for(0;_tmp18B != 0;_tmp18B=_tmp18B->tl){
Cyc_Tcpat_check_pat_regions(te,(struct Cyc_Absyn_Pat*)_tmp18B->hd);}return;_LL9E:;
_LL9F: return;_LL95:;}struct _union_Name_value_Name_v{int tag;struct _dyneither_ptr
val;};struct _union_Name_value_Int_v{int tag;int val;};union Cyc_Tcpat_Name_value{
struct _union_Name_value_Name_v Name_v;struct _union_Name_value_Int_v Int_v;};
typedef union Cyc_Tcpat_Name_value Cyc_Tcpat_name_value_t;union Cyc_Tcpat_Name_value
Cyc_Tcpat_Name_v(struct _dyneither_ptr s){union Cyc_Tcpat_Name_value _tmp4C4;return((
_tmp4C4.Name_v).val=s,(((_tmp4C4.Name_v).tag=1,_tmp4C4)));}union Cyc_Tcpat_Name_value
Cyc_Tcpat_Int_v(int i){union Cyc_Tcpat_Name_value _tmp4C5;return((_tmp4C5.Int_v).val=
i,(((_tmp4C5.Int_v).tag=2,_tmp4C5)));}struct Cyc_Tcpat_Con_s{union Cyc_Tcpat_Name_value
name;int arity;int*span;struct Cyc_Absyn_Pat*orig_pat;};typedef struct Cyc_Tcpat_Con_s*
Cyc_Tcpat_con_t;struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct{int tag;};struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct{
int tag;struct Cyc_Tcpat_Con_s*f1;struct Cyc_List_List*f2;};typedef void*Cyc_Tcpat_simple_pat_t;
...
r,sizeof(*_tmp4C7)),((_tmp4C7->name=Cyc_Tcpat_Name_v(((_tmp4C8="NULL",
...
_region_malloc(r,sizeof(*_tmp4CA)),((_tmp4CA->name=Cyc_Tcpat_Name_v(((_tmp4CB="&",
_tag_dyneither(_tmp4CB,sizeof(char),2)))),((_tmp4CA->arity=1,((_tmp4CA->span=(
...
p){const char*_tmp4CE;struct Cyc_Tcpat_Con_s*_tmp4CD;return(_tmp4CD=_region_malloc(
r,sizeof(*_tmp4CD)),((_tmp4CD->name=Cyc_Tcpat_Name_v(((_tmp4CE="&",
_tag_dyneither(_tmp4CE,sizeof(char),2)))),((_tmp4CD->arity=1,((_tmp4CD->span=(
int*)& Cyc_Tcpat_one_opt,((_tmp4CD->orig_pat=(struct Cyc_Absyn_Pat*)p,_tmp4CD)))))))));}
static struct Cyc_Tcpat_Con_s*Cyc_Tcpat_int_con(struct _RegionHandle*r,int i,struct
Cyc_Absyn_Pat*p){struct Cyc_Tcpat_Con_s*_tmp4CF;return(_tmp4CF=_region_malloc(r,
sizeof(*_tmp4CF)),((_tmp4CF->name=Cyc_Tcpat_Int_v(i),((_tmp4CF->arity=0,((
_tmp4CF->span=0,((_tmp4CF->orig_pat=p,_tmp4CF)))))))));}static struct Cyc_Tcpat_Con_s*
Cyc_Tcpat_float_con(struct _RegionHandle*r,struct _dyneither_ptr f,struct Cyc_Absyn_Pat*
p){struct Cyc_Tcpat_Con_s*_tmp4D0;return(_tmp4D0=_region_malloc(r,sizeof(*_tmp4D0)),((
_tmp4D0->name=Cyc_Tcpat_Name_v(f),((_tmp4D0->arity=0,((_tmp4D0->span=0,((_tmp4D0->orig_pat=(
struct Cyc_Absyn_Pat*)p,_tmp4D0)))))))));}static struct Cyc_Tcpat_Con_s*Cyc_Tcpat_char_con(
struct _RegionHandle*r,char c,struct Cyc_Absyn_Pat*p){struct Cyc_Tcpat_Con_s*_tmp4D1;
return(_tmp4D1=_region_malloc(r,sizeof(*_tmp4D1)),((_tmp4D1->name=Cyc_Tcpat_Int_v((
int)c),((_tmp4D1->arity=0,((_tmp4D1->span=(int*)& Cyc_Tcpat_twofiftysix_opt,((
_tmp4D1->orig_pat=(struct Cyc_Absyn_Pat*)p,_tmp4D1)))))))));}static struct Cyc_Tcpat_Con_s*
Cyc_Tcpat_tuple_con(struct _RegionHandle*r,int i,struct Cyc_Absyn_Pat*p){const char*
_tmp4D4;struct Cyc_Tcpat_Con_s*_tmp4D3;return(_tmp4D3=_region_malloc(r,sizeof(*
_tmp4D3)),((_tmp4D3->name=Cyc_Tcpat_Name_v(((_tmp4D4="$",_tag_dyneither(_tmp4D4,
sizeof(char),2)))),((_tmp4D3->arity=i,((_tmp4D3->span=(int*)& Cyc_Tcpat_one_opt,((
_tmp4D3->orig_pat=p,_tmp4D3)))))))));}static void*Cyc_Tcpat_null_pat(struct
_RegionHandle*r,struct Cyc_Absyn_Pat*p){struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct
_tmp4D7;struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp4D6;return(void*)((
_tmp4D6=_region_malloc(r,sizeof(*_tmp4D6)),((_tmp4D6[0]=((_tmp4D7.tag=1,((
_tmp4D7.f1=Cyc_Tcpat_null_con(r,p),((_tmp4D7.f2=0,_tmp4D7)))))),_tmp4D6))));}
...
_tmp4D9))));}static void*Cyc_Tcpat_char_pat(struct _RegionHandle*r,char c,struct Cyc_Absyn_Pat*
p){struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp4DD;struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*
...
_tmp4DC))));}static void*Cyc_Tcpat_float_pat(struct _RegionHandle*r,struct
_dyneither_ptr f,struct Cyc_Absyn_Pat*p){struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct
_tmp4E0;struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp4DF;return(void*)((
_tmp4DF=_region_malloc(r,sizeof(*_tmp4DF)),((_tmp4DF[0]=((_tmp4E0.tag=1,((
_tmp4E0.f1=Cyc_Tcpat_float_con(r,f,p),((_tmp4E0.f2=0,_tmp4E0)))))),_tmp4DF))));}
static void*Cyc_Tcpat_null_ptr_pat(struct _RegionHandle*r,void*p,struct Cyc_Absyn_Pat*
p0){struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp4E6;struct Cyc_List_List*
_tmp4E5;struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp4E4;return(void*)((
_tmp4E4=_region_malloc(r,sizeof(*_tmp4E4)),((_tmp4E4[0]=((_tmp4E6.tag=1,((
_tmp4E6.f1=Cyc_Tcpat_null_ptr_con(r,p0),((_tmp4E6.f2=((_tmp4E5=_region_malloc(r,
sizeof(*_tmp4E5)),((_tmp4E5->hd=p,((_tmp4E5->tl=0,_tmp4E5)))))),_tmp4E6)))))),
_tmp4E4))));}static void*Cyc_Tcpat_ptr_pat(struct _RegionHandle*r,void*p,struct Cyc_Absyn_Pat*
p0){struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp4EC;struct Cyc_List_List*
_tmp4EB;struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp4EA;return(void*)((
_tmp4EA=_region_malloc(r,sizeof(*_tmp4EA)),((_tmp4EA[0]=((_tmp4EC.tag=1,((
_tmp4EC.f1=Cyc_Tcpat_ptr_con(r,p0),((_tmp4EC.f2=((_tmp4EB=_region_malloc(r,
sizeof(*_tmp4EB)),((_tmp4EB->hd=p,((_tmp4EB->tl=0,_tmp4EB)))))),_tmp4EC)))))),
_tmp4EA))));}static void*Cyc_Tcpat_tuple_pat(struct _RegionHandle*r,struct Cyc_List_List*
ss,struct Cyc_Absyn_Pat*p){struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct _tmp4EF;
struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp4EE;return(void*)((_tmp4EE=
_region_malloc(r,sizeof(*_tmp4EE)),((_tmp4EE[0]=((_tmp4EF.tag=1,((_tmp4EF.f1=Cyc_Tcpat_tuple_con(
r,((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ss),p),((_tmp4EF.f2=ss,
_tmp4EF)))))),_tmp4EE))));}static void*Cyc_Tcpat_con_pat(struct _RegionHandle*r,
struct _dyneither_ptr con_name,int*span,struct Cyc_List_List*ps,struct Cyc_Absyn_Pat*
p){struct Cyc_Tcpat_Con_s*_tmp4F0;struct Cyc_Tcpat_Con_s*c=(_tmp4F0=_region_malloc(
r,sizeof(*_tmp4F0)),((_tmp4F0->name=Cyc_Tcpat_Name_v(con_name),((_tmp4F0->arity=((
int(*)(struct Cyc_List_List*x))Cyc_List_length)(ps),((_tmp4F0->span=span,((
_tmp4F0->orig_pat=(struct Cyc_Absyn_Pat*)p,_tmp4F0)))))))));struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct
_tmp4F3;struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp4F2;return(void*)((
_tmp4F2=_region_malloc(r,sizeof(*_tmp4F2)),((_tmp4F2[0]=((_tmp4F3.tag=1,((
_tmp4F3.f1=c,((_tmp4F3.f2=ps,_tmp4F3)))))),_tmp4F2))));}static void*Cyc_Tcpat_compile_pat(
struct _RegionHandle*r,struct Cyc_Absyn_Pat*p){void*s;{void*_tmp1C1=p->r;enum Cyc_Absyn_Sign
_tmp1C6;int _tmp1C7;char _tmp1C9;struct _dyneither_ptr _tmp1CB;struct Cyc_Absyn_Pat*
_tmp1CD;struct Cyc_Absyn_Pat*_tmp1CF;struct Cyc_Absyn_Pat*_tmp1D1;struct Cyc_Absyn_Datatypedecl*
...
_tmp1E4;_LLB5: {struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*_tmp1C2=(struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*)
_tmp1C1;if(_tmp1C2->tag != 0)goto _LLB7;}_LLB6: goto _LLB8;_LLB7: {struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*
_tmp1C3=(struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp1C1;if(_tmp1C3->tag
!= 3)goto _LLB9;}_LLB8:{struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct _tmp4F6;struct
Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp4F5;s=(void*)((_tmp4F5=_region_malloc(
r,sizeof(*_tmp4F5)),((_tmp4F5[0]=((_tmp4F6.tag=0,_tmp4F6)),_tmp4F5))));}goto
_LLB4;_LLB9: {struct Cyc_Absyn_Null_p_Absyn_Raw_pat_struct*_tmp1C4=(struct Cyc_Absyn_Null_p_Absyn_Raw_pat_struct*)
_tmp1C1;if(_tmp1C4->tag != 8)goto _LLBB;}_LLBA: s=Cyc_Tcpat_null_pat(r,p);goto _LLB4;
_LLBB: {struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmp1C5=(struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)
_tmp1C1;if(_tmp1C5->tag != 9)goto _LLBD;else{_tmp1C6=_tmp1C5->f1;_tmp1C7=_tmp1C5->f2;}}
_LLBC: s=Cyc_Tcpat_int_pat(r,_tmp1C7,(struct Cyc_Absyn_Pat*)p);goto _LLB4;_LLBD: {
struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*_tmp1C8=(struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)
_tmp1C1;if(_tmp1C8->tag != 10)goto _LLBF;else{_tmp1C9=_tmp1C8->f1;}}_LLBE: s=Cyc_Tcpat_char_pat(
r,_tmp1C9,p);goto _LLB4;_LLBF: {struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*
_tmp1CA=(struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp1C1;if(_tmp1CA->tag != 
11)goto _LLC1;else{_tmp1CB=_tmp1CA->f1;}}_LLC0: s=Cyc_Tcpat_float_pat(r,_tmp1CB,p);
goto _LLB4;_LLC1: {struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp1CC=(struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)
_tmp1C1;if(_tmp1CC->tag != 1)goto _LLC3;else{_tmp1CD=_tmp1CC->f2;}}_LLC2: s=Cyc_Tcpat_compile_pat(
r,_tmp1CD);goto _LLB4;_LLC3: {struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*
_tmp1CE=(struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1C1;if(_tmp1CE->tag
!= 2)goto _LLC5;else{_tmp1CF=_tmp1CE->f2;}}_LLC4: s=Cyc_Tcpat_compile_pat(r,
_tmp1CF);goto _LLB4;_LLC5: {struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*
_tmp1D0=(struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp1C1;if(_tmp1D0->tag
!= 5)goto _LLC7;else{_tmp1D1=_tmp1D0->f1;}}_LLC6:{void*_tmp1EB=Cyc_Tcutil_compress((
void*)_check_null(p->topt));struct Cyc_Absyn_PtrInfo _tmp1ED;struct Cyc_Absyn_PtrAtts
_tmp1EE;union Cyc_Absyn_Constraint*_tmp1EF;_LLDA: {struct Cyc_Absyn_PointerType_Absyn_Type_struct*
_tmp1EC=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1EB;if(_tmp1EC->tag
!= 5)goto _LLDC;else{_tmp1ED=_tmp1EC->f1;_tmp1EE=_tmp1ED.ptr_atts;_tmp1EF=_tmp1EE.nullable;}}
_LLDB: {int is_nullable=0;int still_working=1;while(still_working){union Cyc_Absyn_Constraint*
_tmp1F0=_tmp1EF;union Cyc_Absyn_Constraint _tmp1F1;union Cyc_Absyn_Constraint*
_tmp1F2;union Cyc_Absyn_Constraint _tmp1F3;int _tmp1F4;union Cyc_Absyn_Constraint
_tmp1F5;int _tmp1F6;_LLDF: _tmp1F1=*_tmp1F0;if((_tmp1F1.Forward_constr).tag != 2)
goto _LLE1;_tmp1F2=(union Cyc_Absyn_Constraint*)(_tmp1F1.Forward_constr).val;_LLE0:*
_tmp1EF=*_tmp1F2;continue;_LLE1: _tmp1F3=*_tmp1F0;if((_tmp1F3.No_constr).tag != 3)
goto _LLE3;_tmp1F4=(int)(_tmp1F3.No_constr).val;_LLE2:{struct
_union_Constraint_Eq_constr*_tmp4F7;(_tmp4F7=& _tmp1EF->Eq_constr,((_tmp4F7->tag=
1,_tmp4F7->val=0)));}is_nullable=0;still_working=0;goto _LLDE;_LLE3: _tmp1F5=*
_tmp1F0;if((_tmp1F5.Eq_constr).tag != 1)goto _LLDE;_tmp1F6=(int)(_tmp1F5.Eq_constr).val;
...
r,ss,p);}goto _LLD9;};}_LLDC:;_LLDD: {const char*_tmp4FA;void*_tmp4F9;(_tmp4F9=0,((
int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp4FA="expecting pointertype for pattern!",_tag_dyneither(_tmp4FA,sizeof(char),
35))),_tag_dyneither(_tmp4F9,sizeof(void*),0)));}_LLD9:;}goto _LLB4;_LLC7: {
struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp1D2=(struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)
...
_check_null(p->topt));_LLE6: {struct Cyc_Absyn_DatatypeType_Absyn_Type_struct*
_tmp1FB=(struct Cyc_Absyn_DatatypeType_Absyn_Type_struct*)_tmp1FA;if(_tmp1FB->tag
!= 3)goto _LLE8;}_LLE7: if(_tmp1D3->is_extensible)span=0;else{int*_tmp4FB;span=((
_tmp4FB=_region_malloc(r,sizeof(*_tmp4FB)),((_tmp4FB[0]=((int(*)(struct Cyc_List_List*
x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(
_tmp1D3->fields))->v),_tmp4FB))));}goto _LLE5;_LLE8: {struct Cyc_Absyn_DatatypeFieldType_Absyn_Type_struct*
_tmp1FC=(struct Cyc_Absyn_DatatypeFieldType_Absyn_Type_struct*)_tmp1FA;if(_tmp1FC->tag
!= 4)goto _LLEA;}_LLE9: span=(int*)& Cyc_Tcpat_one_opt;goto _LLE5;_LLEA:;_LLEB:{
...
r,_tmp1D5),p);goto _LLB4;}_LLC9: {struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*
_tmp1D6=(struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp1C1;if(_tmp1D6->tag != 
4)goto _LLCB;else{_tmp1D7=_tmp1D6->f1;}}_LLCA: s=Cyc_Tcpat_tuple_pat(r,((struct Cyc_List_List*(*)(
struct _RegionHandle*,void*(*f)(struct _RegionHandle*,struct Cyc_Absyn_Pat*),struct
_RegionHandle*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(r,Cyc_Tcpat_compile_pat,
r,_tmp1D7),(struct Cyc_Absyn_Pat*)p);goto _LLB4;_LLCB: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*
_tmp1D8=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C1;if(_tmp1D8->tag != 
6)goto _LLCD;else{_tmp1D9=_tmp1D8->f1;if(_tmp1D9 == 0)goto _LLCD;_tmp1DA=*_tmp1D9;
_tmp1DB=_tmp1DA.aggr_info;if((_tmp1DB.KnownAggr).tag != 2)goto _LLCD;_tmp1DC=(
struct Cyc_Absyn_Aggrdecl**)(_tmp1DB.KnownAggr).val;_tmp1DD=*_tmp1DC;_tmp1DE=
_tmp1D8->f3;}}_LLCC: if(_tmp1DD->kind == Cyc_Absyn_StructA){struct Cyc_List_List*ps=
0;{struct Cyc_List_List*fields=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(
_tmp1DD->impl))->fields;for(0;fields != 0;fields=fields->tl){const char*_tmp4FF;
int found=Cyc_strcmp((struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)fields->hd)->name,((
_tmp4FF="",_tag_dyneither(_tmp4FF,sizeof(char),1))))== 0;{struct Cyc_List_List*
dlps0=_tmp1DE;for(0;!found  && dlps0 != 0;dlps0=dlps0->tl){struct _tuple15 _tmp201;
struct Cyc_List_List*_tmp202;struct Cyc_Absyn_Pat*_tmp203;struct _tuple15*_tmp200=(
struct _tuple15*)dlps0->hd;_tmp201=*_tmp200;_tmp202=_tmp201.f1;_tmp203=_tmp201.f2;{
...
goto _LLEF;_LLEE: if(Cyc_strptrcmp(_tmp208,((struct Cyc_Absyn_Aggrfield*)fields->hd)->name)
== 0){{struct Cyc_List_List*_tmp500;ps=((_tmp500=_region_malloc(r,sizeof(*_tmp500)),((
_tmp500->hd=Cyc_Tcpat_compile_pat(r,_tmp203),((_tmp500->tl=ps,_tmp500))))));}
found=1;}goto _LLEC;_LLEF:;_LLF0: {const char*_tmp503;void*_tmp502;(_tmp502=0,((
int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp503="bad designator(s)",_tag_dyneither(_tmp503,sizeof(char),18))),
_tag_dyneither(_tmp502,sizeof(void*),0)));}_LLEC:;};}}if(!found){const char*
_tmp506;void*_tmp505;(_tmp505=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp506="bad designator",_tag_dyneither(
_tmp506,sizeof(char),15))),_tag_dyneither(_tmp505,sizeof(void*),0)));}}}s=Cyc_Tcpat_tuple_pat(
r,ps,(struct Cyc_Absyn_Pat*)p);}else{if(!((struct Cyc_Absyn_AggrdeclImpl*)
_check_null(_tmp1DD->impl))->tagged){const char*_tmp509;void*_tmp508;(_tmp508=0,
Cyc_Tcutil_terr(p->loc,((_tmp509="patterns on untagged unions not yet supported.",
...
_check_null(_tmp1DD->impl))->fields),_tmp50A)));struct Cyc_List_List*_tmp212=
_tmp1DE;struct Cyc_List_List _tmp213;struct _tuple15*_tmp214;struct _tuple15 _tmp215;
struct Cyc_List_List*_tmp216;struct Cyc_List_List _tmp217;void*_tmp218;struct
_dyneither_ptr*_tmp21A;struct Cyc_List_List*_tmp21B;struct Cyc_Absyn_Pat*_tmp21C;
struct Cyc_List_List*_tmp21D;_LLF2: if(_tmp212 == 0)goto _LLF4;_tmp213=*_tmp212;
_tmp214=(struct _tuple15*)_tmp213.hd;_tmp215=*_tmp214;_tmp216=_tmp215.f1;if(
_tmp216 == 0)goto _LLF4;_tmp217=*_tmp216;_tmp218=(void*)_tmp217.hd;{struct Cyc_Absyn_FieldName_Absyn_Designator_struct*
_tmp219=(struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp218;if(_tmp219->tag
!= 1)goto _LLF4;else{_tmp21A=_tmp219->f1;}};_tmp21B=_tmp217.tl;if(_tmp21B != 0)
goto _LLF4;_tmp21C=_tmp215.f2;_tmp21D=_tmp213.tl;if(_tmp21D != 0)goto _LLF4;_LLF3:{
...
_tmp50B->tl=0,_tmp50B)))))),p);}goto _LLF1;_LLF4:;_LLF5: {const char*_tmp50E;void*
_tmp50D;(_tmp50D=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp50E="bad union pattern",_tag_dyneither(_tmp50E,sizeof(char),18))),
_tag_dyneither(_tmp50D,sizeof(void*),0)));}_LLF1:;};}goto _LLB4;_LLCD: {struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*
_tmp1DF=(struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp1C1;if(_tmp1DF->tag != 
12)goto _LLCF;else{_tmp1E0=_tmp1DF->f1;_tmp1E1=_tmp1DF->f2;}}_LLCE: {int span=((
int(*)(struct Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)
_check_null(_tmp1E0->fields))->v);{int*_tmp50F;s=Cyc_Tcpat_con_pat(r,*(*_tmp1E1->name).f2,((
_tmp50F=_region_malloc(r,sizeof(*_tmp50F)),((_tmp50F[0]=span,_tmp50F)))),0,p);}
...
goto _LLD1;else{_tmp1E3=(void*)_tmp1E2->f1;_tmp1E4=_tmp1E2->f2;}}_LLD0: {struct
Cyc_List_List*fields;{void*_tmp223=Cyc_Tcutil_compress(_tmp1E3);struct Cyc_List_List*
_tmp225;_LLF7: {struct Cyc_Absyn_AnonEnumType_Absyn_Type_struct*_tmp224=(struct
Cyc_Absyn_AnonEnumType_Absyn_Type_struct*)_tmp223;if(_tmp224->tag != 14)goto _LLF9;
else{_tmp225=_tmp224->f1;}}_LLF8: fields=_tmp225;goto _LLF6;_LLF9:;_LLFA: {const
char*_tmp512;void*_tmp511;(_tmp511=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp512="bad type in AnonEnum_p",
...
_tmp513;s=Cyc_Tcpat_con_pat(r,*(*_tmp1E4->name).f2,((_tmp513=_region_malloc(r,
sizeof(*_tmp513)),((_tmp513[0]=span,_tmp513)))),0,p);}goto _LLB4;};}_LLD1: {
struct Cyc_Absyn_UnknownId_p_Absyn_Raw_pat_struct*_tmp1E5=(struct Cyc_Absyn_UnknownId_p_Absyn_Raw_pat_struct*)
_tmp1C1;if(_tmp1E5->tag != 14)goto _LLD3;}_LLD2: goto _LLD4;_LLD3: {struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*
_tmp1E6=(struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*)_tmp1C1;if(_tmp1E6->tag
!= 15)goto _LLD5;}_LLD4: goto _LLD6;_LLD5: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*
_tmp1E7=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C1;if(_tmp1E7->tag != 
6)goto _LLD7;}_LLD6: goto _LLD8;_LLD7: {struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*
_tmp1E8=(struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp1C1;if(_tmp1E8->tag != 
16)goto _LLB4;}_LLD8: {struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct _tmp516;struct
Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp515;s=(void*)((_tmp515=_region_malloc(
r,sizeof(*_tmp515)),((_tmp515[0]=((_tmp516.tag=0,_tmp516)),_tmp515))));}_LLB4:;}
return s;}typedef struct Cyc_List_List*Cyc_Tcpat_match_t;struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct{
int tag;struct Cyc_Tcpat_Con_s*f1;struct Cyc_List_List*f2;};struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct{
int tag;struct Cyc_Set_Set*f1;};typedef void*Cyc_Tcpat_term_desc_t;typedef struct Cyc_List_List*
Cyc_Tcpat_context_t;typedef struct Cyc_List_List*Cyc_Tcpat_access_t;struct Cyc_Tcpat_Failure_Tcpat_Decision_struct{
...
Cyc_Tcpat_Con_s*f2;void*f3;void*f4;};typedef void*Cyc_Tcpat_decision_t;struct
_tuple18{struct Cyc_List_List*f1;struct Cyc_List_List*f2;struct Cyc_List_List*f3;};
typedef struct _tuple18*Cyc_Tcpat_work_stack_frame_t;typedef struct Cyc_List_List*
...
Cyc_Tcpat_print_tab(int i){for(0;i != 0;-- i){const char*_tmp519;void*_tmp518;(
_tmp518=0,Cyc_fprintf(Cyc_stderr,((_tmp519=" ",_tag_dyneither(_tmp519,sizeof(
char),2))),_tag_dyneither(_tmp518,sizeof(void*),0)));}}static void Cyc_Tcpat_print_con(
struct Cyc_Tcpat_Con_s*c){union Cyc_Tcpat_Name_value _tmp22D=c->name;union Cyc_Tcpat_Name_value
_tmp22E=_tmp22D;struct _dyneither_ptr _tmp22F;int _tmp230;_LLFC: if((_tmp22E.Name_v).tag
!= 1)goto _LLFE;_tmp22F=(struct _dyneither_ptr)(_tmp22E.Name_v).val;_LLFD:{const
char*_tmp51D;void*_tmp51C[1];struct Cyc_String_pa_PrintArg_struct _tmp51B;(_tmp51B.tag=
0,((_tmp51B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp22F),((_tmp51C[0]=&
_tmp51B,Cyc_fprintf(Cyc_stderr,((_tmp51D="%s",_tag_dyneither(_tmp51D,sizeof(char),
3))),_tag_dyneither(_tmp51C,sizeof(void*),1)))))));}goto _LLFB;_LLFE: if((_tmp22E.Int_v).tag
!= 2)goto _LLFB;_tmp230=(int)(_tmp22E.Int_v).val;_LLFF:{const char*_tmp521;void*
_tmp520[1];struct Cyc_Int_pa_PrintArg_struct _tmp51F;(_tmp51F.tag=1,((_tmp51F.f1=(
unsigned long)_tmp230,((_tmp520[0]=& _tmp51F,Cyc_fprintf(Cyc_stderr,((_tmp521="%d",
_tag_dyneither(_tmp521,sizeof(char),3))),_tag_dyneither(_tmp520,sizeof(void*),1)))))));}
...
!= 1)goto _LL103;else{_tmp239=(void*)_tmp238->f1;}}_LL102: Cyc_Tcpat_print_tab(tab);{
...
sizeof(void*),0)));}goto _LL100;_LL103: {struct Cyc_Tcpat_Failure_Tcpat_Decision_struct*
_tmp23A=(struct Cyc_Tcpat_Failure_Tcpat_Decision_struct*)_tmp237;if(_tmp23A->tag
!= 0)goto _LL105;}_LL104:{const char*_tmp52A;void*_tmp529;(_tmp529=0,Cyc_fprintf(
Cyc_stderr,((_tmp52A="Failure\n",_tag_dyneither(_tmp52A,sizeof(char),9))),
_tag_dyneither(_tmp529,sizeof(void*),0)));}goto _LL100;_LL105: {struct Cyc_Tcpat_IfEq_Tcpat_Decision_struct*
_tmp23B=(struct Cyc_Tcpat_IfEq_Tcpat_Decision_struct*)_tmp237;if(_tmp23B->tag != 2)
goto _LL100;else{_tmp23C=_tmp23B->f1;_tmp23D=_tmp23B->f2;_tmp23E=(void*)_tmp23B->f3;
_tmp23F=(void*)_tmp23B->f4;}}_LL106: Cyc_Tcpat_print_tab(tab);{const char*_tmp52D;
void*_tmp52C;(_tmp52C=0,Cyc_fprintf(Cyc_stderr,((_tmp52D="Access[",
_tag_dyneither(_tmp52D,sizeof(char),8))),_tag_dyneither(_tmp52C,sizeof(void*),0)));}
for(0;_tmp23C != 0;_tmp23C=_tmp23C->tl){{const char*_tmp531;void*_tmp530[1];struct
Cyc_Int_pa_PrintArg_struct _tmp52F;(_tmp52F.tag=1,((_tmp52F.f1=(unsigned long)((
int)_tmp23C->hd),((_tmp530[0]=& _tmp52F,Cyc_fprintf(Cyc_stderr,((_tmp531="%d",
_tag_dyneither(_tmp531,sizeof(char),3))),_tag_dyneither(_tmp530,sizeof(void*),1)))))));}
...
sizeof(void*),0)));}}{const char*_tmp537;void*_tmp536;(_tmp536=0,Cyc_fprintf(Cyc_stderr,((
_tmp537="],",_tag_dyneither(_tmp537,sizeof(char),3))),_tag_dyneither(_tmp536,
sizeof(void*),0)));}Cyc_Tcpat_print_con(_tmp23D);{const char*_tmp53A;void*_tmp539;(
_tmp539=0,Cyc_fprintf(Cyc_stderr,((_tmp53A=",\n",_tag_dyneither(_tmp53A,sizeof(
char),3))),_tag_dyneither(_tmp539,sizeof(void*),0)));}Cyc_Tcpat_print_dec_tree(
...
_LL108: {struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp252=(struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)
_tmp251;if(_tmp252->tag != 1)goto _LL10A;else{_tmp253=_tmp252->f1;}}_LL109: {
...
_LL10B: {const char*_tmp540;void*_tmp53F;(_tmp53F=0,((int(*)(struct _dyneither_ptr
fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp540="add_neg called when td is Positive",
...
_tmp25D;_LL10D: {struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp25A=(struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)
_tmp259;if(_tmp25A->tag != 0)goto _LL10F;else{_tmp25B=_tmp25A->f1;}}_LL10E: if(Cyc_Tcpat_compare_con(
c,_tmp25B)== 0)return Cyc_Tcpat_Yes;else{return Cyc_Tcpat_No;}_LL10F: {struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*
_tmp25C=(struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)_tmp259;if(_tmp25C->tag != 1)
goto _LL10C;else{_tmp25D=_tmp25C->f1;}}_LL110: if(((int(*)(struct Cyc_Set_Set*s,
struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp25D,c))return Cyc_Tcpat_No;else{
if(c->span != 0  && *((int*)_check_null(c->span))== ((int(*)(struct Cyc_Set_Set*s))
Cyc_Set_cardinality)(_tmp25D)+ 1)return Cyc_Tcpat_Yes;else{return Cyc_Tcpat_Maybe;}}
_LL10C:;}struct _tuple20{struct Cyc_Tcpat_Con_s*f1;struct Cyc_List_List*f2;};static
struct Cyc_List_List*Cyc_Tcpat_augment(struct _RegionHandle*r,struct Cyc_List_List*
ctxt,void*dsc){struct Cyc_List_List*_tmp25E=ctxt;struct Cyc_List_List _tmp25F;
struct _tuple20*_tmp260;struct _tuple20 _tmp261;struct Cyc_Tcpat_Con_s*_tmp262;
struct Cyc_List_List*_tmp263;struct Cyc_List_List*_tmp264;_LL112: if(_tmp25E != 0)
goto _LL114;_LL113: return 0;_LL114: if(_tmp25E == 0)goto _LL111;_tmp25F=*_tmp25E;
_tmp260=(struct _tuple20*)_tmp25F.hd;_tmp261=*_tmp260;_tmp262=_tmp261.f1;_tmp263=
_tmp261.f2;_tmp264=_tmp25F.tl;_LL115: {struct _tuple20*_tmp546;struct Cyc_List_List*
_tmp545;struct Cyc_List_List*_tmp544;return(_tmp544=_region_malloc(r,sizeof(*
_tmp544)),((_tmp544->hd=((_tmp546=_region_malloc(r,sizeof(*_tmp546)),((_tmp546->f1=
_tmp262,((_tmp546->f2=(struct Cyc_List_List*)((_tmp545=_region_malloc(r,sizeof(*
_tmp545)),((_tmp545->hd=dsc,((_tmp545->tl=_tmp263,_tmp545)))))),_tmp546)))))),((
_tmp544->tl=_tmp264,_tmp544)))));}_LL111:;}static struct Cyc_List_List*Cyc_Tcpat_norm_context(
struct _RegionHandle*r,struct Cyc_List_List*ctxt){struct Cyc_List_List*_tmp268=ctxt;
struct Cyc_List_List _tmp269;struct _tuple20*_tmp26A;struct _tuple20 _tmp26B;struct
Cyc_Tcpat_Con_s*_tmp26C;struct Cyc_List_List*_tmp26D;struct Cyc_List_List*_tmp26E;
_LL117: if(_tmp268 != 0)goto _LL119;_LL118: {const char*_tmp549;void*_tmp548;(
_tmp548=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmp549="norm_context: empty context",_tag_dyneither(_tmp549,sizeof(char),28))),
_tag_dyneither(_tmp548,sizeof(void*),0)));}_LL119: if(_tmp268 == 0)goto _LL116;
_tmp269=*_tmp268;_tmp26A=(struct _tuple20*)_tmp269.hd;_tmp26B=*_tmp26A;_tmp26C=
_tmp26B.f1;_tmp26D=_tmp26B.f2;_tmp26E=_tmp269.tl;_LL11A: {struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct
_tmp54C;struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp54B;return Cyc_Tcpat_augment(
r,_tmp26E,(void*)((_tmp54B=_region_malloc(r,sizeof(*_tmp54B)),((_tmp54B[0]=((
_tmp54C.tag=0,((_tmp54C.f1=_tmp26C,((_tmp54C.f2=((struct Cyc_List_List*(*)(struct
_RegionHandle*,struct Cyc_List_List*x))Cyc_List_rrev)(r,_tmp26D),_tmp54C)))))),
_tmp54B)))));}_LL116:;}static void*Cyc_Tcpat_build_desc(struct _RegionHandle*r,
struct Cyc_List_List*ctxt,void*dsc,struct Cyc_List_List*work){struct _tuple13
_tmp54D;struct _tuple13 _tmp274=(_tmp54D.f1=ctxt,((_tmp54D.f2=work,_tmp54D)));
struct Cyc_List_List*_tmp275;struct Cyc_List_List*_tmp276;struct Cyc_List_List*
...
return dsc;_LL11E: _tmp277=_tmp274.f1;if(_tmp277 != 0)goto _LL120;_LL11F: goto _LL121;
_LL120: _tmp278=_tmp274.f2;if(_tmp278 != 0)goto _LL122;_LL121: {const char*_tmp550;
void*_tmp54F;(_tmp54F=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))
Cyc_Tcutil_impos)(((_tmp550="build_desc: ctxt and work don't match",
...
_tmp281.tl;_LL123: {struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct _tmp556;struct Cyc_List_List*
_tmp555;struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp554;struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*
...
struct _RegionHandle*,struct Cyc_List_List*x))Cyc_List_rrev)(r,_tmp27E),((_tmp555=
_region_malloc(r,sizeof(*_tmp555)),((_tmp555->hd=dsc,((_tmp555->tl=_tmp284,
_tmp555))))))),_tmp556)))))),_tmp554)));return Cyc_Tcpat_build_desc(r,_tmp27F,(
void*)_tmp288,_tmp285);}_LL11B:;}static void*Cyc_Tcpat_match(struct _RegionHandle*
...
_tmp28C=allmrules;struct Cyc_List_List _tmp28D;struct _tuple0*_tmp28E;struct _tuple0
_tmp28F;void*_tmp290;void*_tmp291;struct Cyc_List_List*_tmp292;_LL125: if(_tmp28C
!= 0)goto _LL127;_LL126: {struct Cyc_Tcpat_Failure_Tcpat_Decision_struct _tmp559;
struct Cyc_Tcpat_Failure_Tcpat_Decision_struct*_tmp558;return(void*)((_tmp558=
_cycalloc(sizeof(*_tmp558)),((_tmp558[0]=((_tmp559.tag=0,((_tmp559.f1=(void*)dsc,
_tmp559)))),_tmp558))));}_LL127: if(_tmp28C == 0)goto _LL124;_tmp28D=*_tmp28C;
_tmp28E=(struct _tuple0*)_tmp28D.hd;_tmp28F=*_tmp28E;_tmp290=_tmp28F.f1;_tmp291=
_tmp28F.f2;_tmp292=_tmp28D.tl;_LL128: return Cyc_Tcpat_match(r,_tmp290,0,dsc,0,0,
_tmp291,_tmp292);_LL124:;}static void*Cyc_Tcpat_match_compile(struct _RegionHandle*
r,struct Cyc_List_List*allmrules){struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct
_tmp55C;struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp55B;return Cyc_Tcpat_or_match(
r,(void*)((_tmp55B=_region_malloc(r,sizeof(*_tmp55B)),((_tmp55B[0]=((_tmp55C.tag=
1,((_tmp55C.f1=Cyc_Tcpat_empty_con_set(r),_tmp55C)))),_tmp55B)))),allmrules);}
...
Cyc_List_List*_tmp297=work;struct Cyc_List_List _tmp298;struct _tuple18*_tmp299;
struct _tuple18 _tmp29A;struct Cyc_List_List*_tmp29B;struct Cyc_List_List*_tmp29C;
...
_tmp2A5;_LL12A: if(_tmp297 != 0)goto _LL12C;_LL12B: {struct Cyc_Tcpat_Success_Tcpat_Decision_struct
_tmp55F;struct Cyc_Tcpat_Success_Tcpat_Decision_struct*_tmp55E;return(void*)((
_tmp55E=_region_malloc(r,sizeof(*_tmp55E)),((_tmp55E[0]=((_tmp55F.tag=1,((
_tmp55F.f1=(void*)right_hand_side,_tmp55F)))),_tmp55E))));}_LL12C: if(_tmp297 == 0)
goto _LL12E;_tmp298=*_tmp297;_tmp299=(struct _tuple18*)_tmp298.hd;_tmp29A=*_tmp299;
_tmp29B=_tmp29A.f1;if(_tmp29B != 0)goto _LL12E;_tmp29C=_tmp29A.f2;if(_tmp29C != 0)
goto _LL12E;_tmp29D=_tmp29A.f3;if(_tmp29D != 0)goto _LL12E;_tmp29E=_tmp298.tl;
_LL12D: return Cyc_Tcpat_and_match(r,Cyc_Tcpat_norm_context(r,ctx),_tmp29E,
...
_tmp2A4=_tmp2A1.f3;_tmp2A5=_tmp29F.tl;_LL12F: if((_tmp2A2 == 0  || _tmp2A3 == 0) || 
_tmp2A4 == 0){const char*_tmp562;void*_tmp561;(_tmp561=0,Cyc_Tcutil_impos(((
_tmp562="tcpat:and_match: malformed work frame",_tag_dyneither(_tmp562,sizeof(
char),38))),_tag_dyneither(_tmp561,sizeof(void*),0)));}{struct Cyc_List_List
...
_tmp2B3.tl;{struct _tuple18*_tmp563;struct _tuple18*_tmp2B6=(_tmp563=
_region_malloc(r,sizeof(*_tmp563)),((_tmp563->f1=_tmp2AD,((_tmp563->f2=_tmp2B1,((
_tmp563->f3=_tmp2B5,_tmp563)))))));struct Cyc_List_List*_tmp564;return Cyc_Tcpat_match(
r,_tmp2AC,_tmp2B0,_tmp2B4,ctx,((_tmp564=_region_malloc(r,sizeof(*_tmp564)),((
_tmp564->hd=_tmp2B6,((_tmp564->tl=_tmp2A5,_tmp564)))))),right_hand_side,rules);};};};};
...
struct Cyc_List_List*_tmp2BD;_LL131: {struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*
_tmp2BA=(struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)_tmp2B9;if(_tmp2BA->tag != 1)
goto _LL133;else{_tmp2BB=_tmp2BA->f1;}}_LL132: {struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct
_tmp567;struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp566;void*any=(void*)((
_tmp566=_region_malloc(r,sizeof(*_tmp566)),((_tmp566[0]=((_tmp567.tag=1,((
_tmp567.f1=Cyc_Tcpat_empty_con_set(r),_tmp567)))),_tmp566))));struct Cyc_List_List*
_tmp2BE=0;{int i=0;for(0;i < pcon->arity;++ i){struct Cyc_List_List*_tmp568;_tmp2BE=((
_tmp568=_region_malloc(r,sizeof(*_tmp568)),((_tmp568->hd=any,((_tmp568->tl=
_tmp2BE,_tmp568))))));}}return _tmp2BE;}_LL133: {struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*
_tmp2BC=(struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp2B9;if(_tmp2BC->tag != 0)
goto _LL130;else{_tmp2BD=_tmp2BC->f2;}}_LL134: return _tmp2BD;_LL130:;}struct
_tuple21{struct _RegionHandle*f1;struct Cyc_List_List*f2;};static struct Cyc_List_List*
Cyc_Tcpat_getoarg(struct _tuple21*env,int i){struct _tuple21 _tmp2C3;struct
_RegionHandle*_tmp2C4;struct Cyc_List_List*_tmp2C5;struct _tuple21*_tmp2C2=env;
_tmp2C3=*_tmp2C2;_tmp2C4=_tmp2C3.f1;_tmp2C5=_tmp2C3.f2;{struct Cyc_List_List*
_tmp569;return(_tmp569=_region_malloc(_tmp2C4,sizeof(*_tmp569)),((_tmp569->hd=(
void*)(i + 1),((_tmp569->tl=_tmp2C5,_tmp569)))));};}static struct Cyc_List_List*Cyc_Tcpat_getoargs(
struct _RegionHandle*r,struct Cyc_Tcpat_Con_s*pcon,struct Cyc_List_List*obj){struct
_tuple21 _tmp56A;struct _tuple21 _tmp2C7=(_tmp56A.f1=r,((_tmp56A.f2=obj,_tmp56A)));
...
_tmp2CC;struct Cyc_List_List*_tmp2CD;_LL136: {struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*
_tmp2CA=(struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*)_tmp2C9;if(_tmp2CA->tag != 
0)goto _LL138;}_LL137: return Cyc_Tcpat_and_match(r,Cyc_Tcpat_augment(r,ctx,dsc),
work,right_hand_side,rules);_LL138: {struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*
_tmp2CB=(struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*)_tmp2C9;if(_tmp2CB->tag != 
1)goto _LL135;else{_tmp2CC=_tmp2CB->f1;_tmp2CD=_tmp2CB->f2;}}_LL139: switch(Cyc_Tcpat_static_match(
_tmp2CC,dsc)){case Cyc_Tcpat_Yes: _LL13A: {struct _tuple20*_tmp56D;struct Cyc_List_List*
_tmp56C;struct Cyc_List_List*ctx2=(_tmp56C=_region_malloc(r,sizeof(*_tmp56C)),((
_tmp56C->hd=((_tmp56D=_region_malloc(r,sizeof(*_tmp56D)),((_tmp56D->f1=_tmp2CC,((
_tmp56D->f2=0,_tmp56D)))))),((_tmp56C->tl=ctx,_tmp56C)))));struct _tuple18*
_tmp56E;struct _tuple18*work_frame=(_tmp56E=_region_malloc(r,sizeof(*_tmp56E)),((
_tmp56E->f1=_tmp2CD,((_tmp56E->f2=Cyc_Tcpat_getoargs(r,_tmp2CC,obj),((_tmp56E->f3=
Cyc_Tcpat_getdargs(r,_tmp2CC,dsc),_tmp56E)))))));struct Cyc_List_List*_tmp56F;
struct Cyc_List_List*work2=(_tmp56F=_region_malloc(r,sizeof(*_tmp56F)),((_tmp56F->hd=
work_frame,((_tmp56F->tl=work,_tmp56F)))));return Cyc_Tcpat_and_match(r,ctx2,
work2,right_hand_side,rules);}case Cyc_Tcpat_No: _LL13B: return Cyc_Tcpat_or_match(r,
Cyc_Tcpat_build_desc(r,ctx,dsc,work),rules);case Cyc_Tcpat_Maybe: _LL13C: {struct
_tuple20*_tmp572;struct Cyc_List_List*_tmp571;struct Cyc_List_List*ctx2=(_tmp571=
_region_malloc(r,sizeof(*_tmp571)),((_tmp571->hd=((_tmp572=_region_malloc(r,
sizeof(*_tmp572)),((_tmp572->f1=_tmp2CC,((_tmp572->f2=0,_tmp572)))))),((_tmp571->tl=
ctx,_tmp571)))));struct _tuple18*_tmp573;struct _tuple18*work_frame=(_tmp573=
_region_malloc(r,sizeof(*_tmp573)),((_tmp573->f1=_tmp2CD,((_tmp573->f2=Cyc_Tcpat_getoargs(
r,_tmp2CC,obj),((_tmp573->f3=Cyc_Tcpat_getdargs(r,_tmp2CC,dsc),_tmp573)))))));
struct Cyc_List_List*_tmp574;struct Cyc_List_List*work2=(_tmp574=_region_malloc(r,
sizeof(*_tmp574)),((_tmp574->hd=work_frame,((_tmp574->tl=work,_tmp574)))));void*
_tmp2D2=Cyc_Tcpat_and_match(r,ctx2,work2,right_hand_side,rules);void*_tmp2D3=Cyc_Tcpat_or_match(
r,Cyc_Tcpat_build_desc(r,ctx,Cyc_Tcpat_add_neg(r,dsc,_tmp2CC),work),rules);
...
_tmp577.f4=(void*)_tmp2D3,_tmp577)))))))))),_tmp576))));}}_LL135:;}static void Cyc_Tcpat_check_exhaust_overlap(
...
_tmp2DA=d;void*_tmp2DC;void*_tmp2DE;void*_tmp2E0;void*_tmp2E1;_LL13F: {struct Cyc_Tcpat_Failure_Tcpat_Decision_struct*
_tmp2DB=(struct Cyc_Tcpat_Failure_Tcpat_Decision_struct*)_tmp2DA;if(_tmp2DB->tag
!= 0)goto _LL141;else{_tmp2DC=(void*)_tmp2DB->f1;}}_LL140: if(!(*exhaust_done)){
not_exhaust(r,env1,_tmp2DC);*exhaust_done=1;}goto _LL13E;_LL141: {struct Cyc_Tcpat_Success_Tcpat_Decision_struct*
_tmp2DD=(struct Cyc_Tcpat_Success_Tcpat_Decision_struct*)_tmp2DA;if(_tmp2DD->tag
!= 1)goto _LL143;else{_tmp2DE=(void*)_tmp2DD->f1;}}_LL142: rhs_appears(env2,
_tmp2DE);goto _LL13E;_LL143: {struct Cyc_Tcpat_IfEq_Tcpat_Decision_struct*_tmp2DF=(
struct Cyc_Tcpat_IfEq_Tcpat_Decision_struct*)_tmp2DA;if(_tmp2DF->tag != 2)goto
_LL13E;else{_tmp2E0=(void*)_tmp2DF->f3;_tmp2E1=(void*)_tmp2DF->f4;}}_LL144: Cyc_Tcpat_check_exhaust_overlap(
r,_tmp2E0,not_exhaust,env1,rhs_appears,env2,exhaust_done);Cyc_Tcpat_check_exhaust_overlap(
r,_tmp2E1,not_exhaust,env1,rhs_appears,env2,exhaust_done);goto _LL13E;_LL13E:;}
struct _tuple22{void*f1;struct _tuple19*f2;};struct _tuple23{struct _RegionHandle*f1;
int*f2;};static struct _tuple22*Cyc_Tcpat_get_match(struct _tuple23*env,struct Cyc_Absyn_Switch_clause*
swc){struct _tuple23 _tmp2E3;struct _RegionHandle*_tmp2E4;int*_tmp2E5;struct
_tuple23*_tmp2E2=env;_tmp2E3=*_tmp2E2;_tmp2E4=_tmp2E3.f1;_tmp2E5=_tmp2E3.f2;{
void*sp0=Cyc_Tcpat_compile_pat(_tmp2E4,swc->pattern);struct _tuple19*_tmp578;
struct _tuple19*rhs=(_tmp578=_region_malloc(_tmp2E4,sizeof(*_tmp578)),((_tmp578->f1=
0,((_tmp578->f2=(swc->pattern)->loc,_tmp578)))));void*sp;if(swc->where_clause != 
0){{struct Cyc_List_List*_tmp57B;struct Cyc_List_List*_tmp57A;sp=Cyc_Tcpat_tuple_pat(
_tmp2E4,((_tmp57A=_region_malloc(_tmp2E4,sizeof(*_tmp57A)),((_tmp57A->hd=sp0,((
_tmp57A->tl=((_tmp57B=_region_malloc(_tmp2E4,sizeof(*_tmp57B)),((_tmp57B->hd=Cyc_Tcpat_int_pat(
_tmp2E4,*_tmp2E5,0),((_tmp57B->tl=0,_tmp57B)))))),_tmp57A)))))),0);}*_tmp2E5=*
_tmp2E5 + 1;}else{struct Cyc_List_List*_tmp585;struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct
_tmp584;struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp583;struct Cyc_List_List*
_tmp582;sp=Cyc_Tcpat_tuple_pat(_tmp2E4,((_tmp582=_region_malloc(_tmp2E4,sizeof(*
_tmp582)),((_tmp582->hd=sp0,((_tmp582->tl=((_tmp585=_region_malloc(_tmp2E4,
sizeof(*_tmp585)),((_tmp585->hd=(void*)((_tmp583=_region_malloc(_tmp2E4,sizeof(*
_tmp583)),((_tmp583[0]=((_tmp584.tag=0,_tmp584)),_tmp583)))),((_tmp585->tl=0,
_tmp585)))))),_tmp582)))))),0);}{struct _tuple22*_tmp586;return(_tmp586=
_region_malloc(_tmp2E4,sizeof(*_tmp586)),((_tmp586->f1=sp,((_tmp586->f2=rhs,
_tmp586)))));};};}char Cyc_Tcpat_Desc2string[12]="Desc2string";struct Cyc_Tcpat_Desc2string_exn_struct{
char*tag;};struct Cyc_Tcpat_Desc2string_exn_struct Cyc_Tcpat_Desc2string_val={Cyc_Tcpat_Desc2string};
...
_LL148;else{_tmp2F1=_tmp2F0->f1;_tmp2F2=_tmp2F0->f2;}}_LL147: {union Cyc_Tcpat_Name_value
...
_tmp30D;char _tmp30F;struct _dyneither_ptr _tmp311;int _tmp312;struct Cyc_Absyn_Enumfield*
_tmp314;struct Cyc_Absyn_Enumfield*_tmp316;struct Cyc_Absyn_Exp*_tmp318;_LL14B: {
struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*_tmp2F8=(struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*)
_tmp2F7;if(_tmp2F8->tag != 0)goto _LL14D;}_LL14C: {const char*_tmp587;return(
_tmp587="_",_tag_dyneither(_tmp587,sizeof(char),2));}_LL14D: {struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*
_tmp2F9=(struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp2F7;if(_tmp2F9->tag != 1)
goto _LL14F;else{_tmp2FA=_tmp2F9->f1;}}_LL14E: return Cyc_Absynpp_qvar2string(
_tmp2FA->name);_LL14F: {struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*_tmp2FB=(
struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp2F7;if(_tmp2FB->tag != 2)
goto _LL151;else{_tmp2FC=_tmp2FB->f1;}}_LL150: {const char*_tmp58B;void*_tmp58A[1];
struct Cyc_String_pa_PrintArg_struct _tmp589;return(struct _dyneither_ptr)((_tmp589.tag=
0,((_tmp589.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp2FC->name)),((_tmp58A[0]=& _tmp589,Cyc_aprintf(((_tmp58B="*%s",_tag_dyneither(
_tmp58B,sizeof(char),4))),_tag_dyneither(_tmp58A,sizeof(void*),1))))))));}_LL151: {
struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*_tmp2FD=(struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)
_tmp2F7;if(_tmp2FD->tag != 3)goto _LL153;else{_tmp2FE=_tmp2FD->f1;_tmp2FF=_tmp2FD->f2;}}
_LL152: {const char*_tmp590;void*_tmp58F[2];struct Cyc_String_pa_PrintArg_struct
_tmp58E;struct Cyc_String_pa_PrintArg_struct _tmp58D;return(struct _dyneither_ptr)((
_tmp58D.tag=0,((_tmp58D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp2FE->name),((
...
4)goto _LL155;}_LL154: {const char*_tmp594;void*_tmp593[1];struct Cyc_String_pa_PrintArg_struct
_tmp592;return(struct _dyneither_ptr)((_tmp592.tag=0,((_tmp592.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(r,_tmp2F2)),((
_tmp593[0]=& _tmp592,Cyc_aprintf(((_tmp594="$(%s)",_tag_dyneither(_tmp594,sizeof(
char),6))),_tag_dyneither(_tmp593,sizeof(void*),1))))))));}_LL155: {struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*
_tmp301=(struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp2F7;if(_tmp301->tag
!= 5)goto _LL157;}_LL156: {const char*_tmp598;void*_tmp597[1];struct Cyc_String_pa_PrintArg_struct
_tmp596;return(struct _dyneither_ptr)((_tmp596.tag=0,((_tmp596.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(r,_tmp2F2)),((
_tmp597[0]=& _tmp596,Cyc_aprintf(((_tmp598="&%s",_tag_dyneither(_tmp598,sizeof(
char),4))),_tag_dyneither(_tmp597,sizeof(void*),1))))))));}_LL157: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*
...
_tmp302->f3;}}_LL158: if(_tmp307->kind == Cyc_Absyn_UnionA){struct Cyc_List_List*
_tmp327=_tmp308;struct Cyc_List_List _tmp328;struct _tuple15*_tmp329;struct _tuple15
_tmp32A;struct Cyc_List_List*_tmp32B;struct Cyc_List_List _tmp32C;void*_tmp32D;
struct _dyneither_ptr*_tmp32F;_LL16C: if(_tmp327 == 0)goto _LL16E;_tmp328=*_tmp327;
_tmp329=(struct _tuple15*)_tmp328.hd;_tmp32A=*_tmp329;_tmp32B=_tmp32A.f1;if(
_tmp32B == 0)goto _LL16E;_tmp32C=*_tmp32B;_tmp32D=(void*)_tmp32C.hd;{struct Cyc_Absyn_FieldName_Absyn_Designator_struct*
_tmp32E=(struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp32D;if(_tmp32E->tag
!= 1)goto _LL16E;else{_tmp32F=_tmp32E->f1;}};_LL16D: {const char*_tmp59E;void*
_tmp59D[3];struct Cyc_String_pa_PrintArg_struct _tmp59C;struct Cyc_String_pa_PrintArg_struct
_tmp59B;struct Cyc_String_pa_PrintArg_struct _tmp59A;return(struct _dyneither_ptr)((
_tmp59A.tag=0,((_tmp59A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(
r,_tmp2F2)),((_tmp59B.tag=0,((_tmp59B.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*_tmp32F),((_tmp59C.tag=0,((_tmp59C.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp307->name)),((_tmp59D[0]=&
_tmp59C,((_tmp59D[1]=& _tmp59B,((_tmp59D[2]=& _tmp59A,Cyc_aprintf(((_tmp59E="%s{.%s = %s}",
_tag_dyneither(_tmp59E,sizeof(char),13))),_tag_dyneither(_tmp59D,sizeof(void*),3))))))))))))))))))));}
_LL16E:;_LL16F: goto _LL16B;_LL16B:;}{const char*_tmp5A3;void*_tmp5A2[2];struct Cyc_String_pa_PrintArg_struct
_tmp5A1;struct Cyc_String_pa_PrintArg_struct _tmp5A0;return(struct _dyneither_ptr)((
_tmp5A0.tag=0,((_tmp5A0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(
...
_tmp2F2 == 0){const char*_tmp5A7;void*_tmp5A6[1];struct Cyc_String_pa_PrintArg_struct
_tmp5A5;return(struct _dyneither_ptr)((_tmp5A5.tag=0,((_tmp5A5.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp30A->name)),((
_tmp5A6[0]=& _tmp5A5,Cyc_aprintf(((_tmp5A7="%s",_tag_dyneither(_tmp5A7,sizeof(
char),3))),_tag_dyneither(_tmp5A6,sizeof(void*),1))))))));}else{const char*
_tmp5AC;void*_tmp5AB[2];struct Cyc_String_pa_PrintArg_struct _tmp5AA;struct Cyc_String_pa_PrintArg_struct
_tmp5A9;return(struct _dyneither_ptr)((_tmp5A9.tag=0,((_tmp5A9.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcpat_descs2string(r,_tmp2F2)),((
_tmp5AA.tag=0,((_tmp5AA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp30A->name)),((_tmp5AB[0]=& _tmp5AA,((_tmp5AB[1]=& _tmp5A9,Cyc_aprintf(((
_tmp5AC="%s(%s)",_tag_dyneither(_tmp5AC,sizeof(char),7))),_tag_dyneither(_tmp5AB,
sizeof(void*),2))))))))))))));}_LL15B: {struct Cyc_Absyn_Null_p_Absyn_Raw_pat_struct*
_tmp30B=(struct Cyc_Absyn_Null_p_Absyn_Raw_pat_struct*)_tmp2F7;if(_tmp30B->tag != 
8)goto _LL15D;}_LL15C: {const char*_tmp5AD;return(_tmp5AD="NULL",_tag_dyneither(
_tmp5AD,sizeof(char),5));}_LL15D: {struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*
_tmp30C=(struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp2F7;if(_tmp30C->tag != 9)
goto _LL15F;else{_tmp30D=_tmp30C->f2;}}_LL15E: {const char*_tmp5B1;void*_tmp5B0[1];
struct Cyc_Int_pa_PrintArg_struct _tmp5AF;return(struct _dyneither_ptr)((_tmp5AF.tag=
1,((_tmp5AF.f1=(unsigned long)_tmp30D,((_tmp5B0[0]=& _tmp5AF,Cyc_aprintf(((
_tmp5B1="%d",_tag_dyneither(_tmp5B1,sizeof(char),3))),_tag_dyneither(_tmp5B0,
sizeof(void*),1))))))));}_LL15F: {struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*
_tmp30E=(struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp2F7;if(_tmp30E->tag != 
10)goto _LL161;else{_tmp30F=_tmp30E->f1;}}_LL160: {const char*_tmp5B5;void*_tmp5B4[
1];struct Cyc_Int_pa_PrintArg_struct _tmp5B3;return(struct _dyneither_ptr)((_tmp5B3.tag=
1,((_tmp5B3.f1=(unsigned long)((int)_tmp30F),((_tmp5B4[0]=& _tmp5B3,Cyc_aprintf(((
_tmp5B5="%d",_tag_dyneither(_tmp5B5,sizeof(char),3))),_tag_dyneither(_tmp5B4,
sizeof(void*),1))))))));}_LL161: {struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*
_tmp310=(struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp2F7;if(_tmp310->tag != 
11)goto _LL163;else{_tmp311=_tmp310->f1;_tmp312=_tmp310->f2;}}_LL162: return
_tmp311;_LL163: {struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*_tmp313=(struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)
_tmp2F7;if(_tmp313->tag != 12)goto _LL165;else{_tmp314=_tmp313->f2;}}_LL164:
...
!= 13)goto _LL167;else{_tmp316=_tmp315->f2;}}_LL166: return Cyc_Absynpp_qvar2string(
_tmp316->name);_LL167: {struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*_tmp317=(
struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp2F7;if(_tmp317->tag != 16)goto
_LL169;else{_tmp318=_tmp317->f1;}}_LL168: return Cyc_Absynpp_exp2string(_tmp318);
_LL169:;_LL16A:(int)_throw((void*)& Cyc_Tcpat_Desc2string_val);_LL14A:;};}_LL148: {
struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp2F3=(struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)
_tmp2EF;if(_tmp2F3->tag != 1)goto _LL145;else{_tmp2F4=_tmp2F3->f1;}}_LL149: if(((
int(*)(struct Cyc_Set_Set*s))Cyc_Set_is_empty)(_tmp2F4)){const char*_tmp5B6;return(
_tmp5B6="_",_tag_dyneither(_tmp5B6,sizeof(char),2));}{struct Cyc_Tcpat_Con_s*
_tmp348=((struct Cyc_Tcpat_Con_s*(*)(struct Cyc_Set_Set*s))Cyc_Set_choose)(_tmp2F4);
struct Cyc_Absyn_Pat*_tmp349=_tmp348->orig_pat;if(_tmp349 == 0)(int)_throw((void*)&
Cyc_Tcpat_Desc2string_val);{void*_tmp34A=Cyc_Tcutil_compress((void*)_check_null(
_tmp349->topt));enum Cyc_Absyn_Size_of _tmp34C;struct Cyc_Absyn_PtrInfo _tmp34F;
struct Cyc_Absyn_PtrAtts _tmp350;struct Cyc_Absyn_DatatypeInfo _tmp352;union Cyc_Absyn_DatatypeInfoU
_tmp353;struct Cyc_Absyn_Datatypedecl**_tmp354;struct Cyc_Absyn_Datatypedecl*
_tmp355;struct Cyc_Absyn_AggrInfo _tmp357;union Cyc_Absyn_AggrInfoU _tmp358;struct
Cyc_Absyn_Aggrdecl**_tmp359;struct Cyc_Absyn_Aggrdecl*_tmp35A;_LL171: {struct Cyc_Absyn_IntType_Absyn_Type_struct*
_tmp34B=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp34A;if(_tmp34B->tag != 6)
goto _LL173;else{_tmp34C=_tmp34B->f2;if(_tmp34C != Cyc_Absyn_Char_sz)goto _LL173;}}
_LL172:{int i=0;for(0;i < 256;++ i){struct Cyc_Tcpat_Con_s*_tmp35B=Cyc_Tcpat_char_con(
r,(char)i,(struct Cyc_Absyn_Pat*)_tmp349);if(!((int(*)(struct Cyc_Set_Set*s,struct
Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp2F4,_tmp35B)){const char*_tmp5BA;void*
_tmp5B9[1];struct Cyc_Int_pa_PrintArg_struct _tmp5B8;return(struct _dyneither_ptr)((
_tmp5B8.tag=1,((_tmp5B8.f1=(unsigned long)i,((_tmp5B9[0]=& _tmp5B8,Cyc_aprintf(((
_tmp5BA="%d",_tag_dyneither(_tmp5BA,sizeof(char),3))),_tag_dyneither(_tmp5B9,
sizeof(void*),1))))))));}}}(int)_throw((void*)& Cyc_Tcpat_Desc2string_val);_LL173: {
struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp34D=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)
_tmp34A;if(_tmp34D->tag != 6)goto _LL175;}_LL174:{unsigned int i=0;for(0;i < 0 - 1;++
i){struct Cyc_Tcpat_Con_s*_tmp35F=Cyc_Tcpat_int_con(r,(int)i,_tmp349);if(!((int(*)(
struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp2F4,_tmp35F)){
const char*_tmp5BE;void*_tmp5BD[1];struct Cyc_Int_pa_PrintArg_struct _tmp5BC;return(
struct _dyneither_ptr)((_tmp5BC.tag=1,((_tmp5BC.f1=(unsigned long)((int)i),((
_tmp5BD[0]=& _tmp5BC,Cyc_aprintf(((_tmp5BE="%d",_tag_dyneither(_tmp5BE,sizeof(
char),3))),_tag_dyneither(_tmp5BD,sizeof(void*),1))))))));}}}(int)_throw((void*)&
Cyc_Tcpat_Desc2string_val);_LL175: {struct Cyc_Absyn_PointerType_Absyn_Type_struct*
...
union Cyc_Absyn_Constraint*_tmp363=_tmp350.nullable;int is_nullable=((int(*)(int y,
union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp363);if(is_nullable){
if(!((int(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(
_tmp2F4,Cyc_Tcpat_null_con(r,(struct Cyc_Absyn_Pat*)_tmp349))){const char*_tmp5BF;
return(_tmp5BF="NULL",_tag_dyneither(_tmp5BF,sizeof(char),5));}}{const char*
_tmp5C0;return(_tmp5C0="&_",_tag_dyneither(_tmp5C0,sizeof(char),3));};}_LL177: {
struct Cyc_Absyn_DatatypeType_Absyn_Type_struct*_tmp351=(struct Cyc_Absyn_DatatypeType_Absyn_Type_struct*)
...
_tmp353.KnownDatatype).val;_tmp355=*_tmp354;}}_LL178: if(_tmp355->is_extensible)(
int)_throw((void*)& Cyc_Tcpat_Desc2string_val);{struct Cyc_List_List*_tmp366=(
struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp355->fields))->v;int
span=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp366);for(0;(
unsigned int)_tmp366;_tmp366=_tmp366->tl){struct _dyneither_ptr n=*(*((struct Cyc_Absyn_Datatypefield*)
_tmp366->hd)->name).f2;struct Cyc_List_List*_tmp367=((struct Cyc_Absyn_Datatypefield*)
_tmp366->hd)->typs;struct Cyc_Tcpat_Con_s*_tmp5C1;if(!((int(*)(struct Cyc_Set_Set*
s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp2F4,(struct Cyc_Tcpat_Con_s*)((
_tmp5C1=_cycalloc(sizeof(*_tmp5C1)),((_tmp5C1->name=Cyc_Tcpat_Name_v(n),((
_tmp5C1->arity=0,((_tmp5C1->span=0,((_tmp5C1->orig_pat=_tmp349,_tmp5C1)))))))))))){
if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp367)== 0)return n;else{
...
int span=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp36C);struct _tuple1
_tmp36E;struct _dyneither_ptr*_tmp36F;struct _dyneither_ptr _tmp370;struct _tuple1*
_tmp36D=_tmp35A->name;_tmp36E=*_tmp36D;_tmp36F=_tmp36E.f2;_tmp370=*_tmp36F;for(0;(
unsigned int)_tmp36C;_tmp36C=_tmp36C->tl){struct _dyneither_ptr n=*((struct Cyc_Absyn_Aggrfield*)
_tmp36C->hd)->name;struct Cyc_Tcpat_Con_s*_tmp5C6;if(!((int(*)(struct Cyc_Set_Set*
s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp2F4,(struct Cyc_Tcpat_Con_s*)((
_tmp5C6=_cycalloc(sizeof(*_tmp5C6)),((_tmp5C6->name=Cyc_Tcpat_Name_v(n),((
_tmp5C6->arity=0,((_tmp5C6->span=0,((_tmp5C6->orig_pat=_tmp349,_tmp5C6)))))))))))){
...
struct _RegionHandle*r,void*d){struct _dyneither_ptr*_tmp5CC;return(_tmp5CC=
_cycalloc(sizeof(*_tmp5CC)),((_tmp5CC[0]=Cyc_Tcpat_desc2string(r,d),_tmp5CC)));}
static struct _dyneither_ptr Cyc_Tcpat_descs2string(struct _RegionHandle*r,struct Cyc_List_List*
ds){struct Cyc_List_List*_tmp377=((struct Cyc_List_List*(*)(struct _RegionHandle*,
...
sizeof(char),2);{struct Cyc_List_List*_tmp378=_tmp377;for(0;_tmp378 != 0;_tmp378=((
struct Cyc_List_List*)_check_null(_tmp378))->tl){if(_tmp378->tl != 0){{struct Cyc_List_List*
_tmp5CD;_tmp378->tl=(struct Cyc_List_List*)((_tmp5CD=_cycalloc(sizeof(*_tmp5CD)),((
_tmp5CD->hd=comma,((_tmp5CD->tl=_tmp378->tl,_tmp5CD))))));}_tmp378=_tmp378->tl;}}}
return(struct _dyneither_ptr)Cyc_strconcat_l(_tmp377);}static void Cyc_Tcpat_not_exhaust_err(
struct _RegionHandle*r,unsigned int loc,void*desc){struct _handler_cons _tmp37B;
_push_handler(& _tmp37B);{int _tmp37D=0;if(setjmp(_tmp37B.handler))_tmp37D=1;if(!
_tmp37D){{struct _dyneither_ptr _tmp37E=Cyc_Tcpat_desc2string(r,desc);const char*
_tmp5D1;void*_tmp5D0[1];struct Cyc_String_pa_PrintArg_struct _tmp5CF;(_tmp5CF.tag=
0,((_tmp5CF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp37E),((_tmp5D0[0]=&
_tmp5CF,Cyc_Tcutil_terr(loc,((_tmp5D1="patterns may not be exhaustive.\n\tmissing case for %s",
_tag_dyneither(_tmp5D1,sizeof(char),53))),_tag_dyneither(_tmp5D0,sizeof(void*),1)))))));};
_pop_handler();}else{void*_tmp37C=(void*)_exn_thrown;void*_tmp383=_tmp37C;_LL17E: {
struct Cyc_Tcpat_Desc2string_exn_struct*_tmp384=(struct Cyc_Tcpat_Desc2string_exn_struct*)
_tmp383;if(_tmp384->tag != Cyc_Tcpat_Desc2string)goto _LL180;}_LL17F:{const char*
_tmp5D4;void*_tmp5D3;(_tmp5D3=0,Cyc_Tcutil_terr(loc,((_tmp5D4="patterns may not be exhaustive.",
_tag_dyneither(_tmp5D4,sizeof(char),32))),_tag_dyneither(_tmp5D3,sizeof(void*),0)));}
goto _LL17D;_LL180:;_LL181:(void)_throw(_tmp383);_LL17D:;}};}static void Cyc_Tcpat_rule_occurs(
...
_RegionHandle _tmp387=_new_region("r");struct _RegionHandle*r=& _tmp387;
_push_region(r);{int _tmp388=0;struct _tuple23 _tmp5D5;struct _tuple23 _tmp389=(
_tmp5D5.f1=r,((_tmp5D5.f2=& _tmp388,_tmp5D5)));struct Cyc_List_List*_tmp38A=((
...
r,Cyc_Tcpat_get_match,& _tmp389,swcs);void*_tmp38B=((void*(*)(struct _RegionHandle*
r,struct Cyc_List_List*allmrules))Cyc_Tcpat_match_compile)(r,_tmp38A);int _tmp38C=
...
if(!_tmp391){{const char*_tmp5D8;void*_tmp5D7;(_tmp5D7=0,Cyc_Tcutil_terr(_tmp392,((
_tmp5D8="redundant pattern (check for misspelled constructors in earlier patterns)",
...
1;if(!_tmp398){{struct _dyneither_ptr _tmp399=Cyc_Tcpat_desc2string(r,desc);const
char*_tmp5DC;void*_tmp5DB[1];struct Cyc_String_pa_PrintArg_struct _tmp5DA;(_tmp5DA.tag=
0,((_tmp5DA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp399),((_tmp5DB[0]=&
_tmp5DA,Cyc_Tcutil_warn((*pr).f1,((_tmp5DC="pattern not exhaustive.\n\tmissing case for %s",
_tag_dyneither(_tmp5DC,sizeof(char),45))),_tag_dyneither(_tmp5DB,sizeof(void*),1)))))));};
_pop_handler();}else{void*_tmp397=(void*)_exn_thrown;void*_tmp39E=_tmp397;_LL183: {
struct Cyc_Tcpat_Desc2string_exn_struct*_tmp39F=(struct Cyc_Tcpat_Desc2string_exn_struct*)
_tmp39E;if(_tmp39F->tag != Cyc_Tcpat_Desc2string)goto _LL185;}_LL184:{const char*
_tmp5DF;void*_tmp5DE;(_tmp5DE=0,Cyc_Tcutil_warn((*pr).f1,((_tmp5DF="pattern not exhaustive.",
_tag_dyneither(_tmp5DF,sizeof(char),24))),_tag_dyneither(_tmp5DE,sizeof(void*),0)));}
goto _LL182;_LL185:;_LL186:(void)_throw(_tmp39E);_LL182:;}};};}static void Cyc_Tcpat_dummy_fn(
...
_RegionHandle _tmp3A2=_new_region("r");struct _RegionHandle*r=& _tmp3A2;
_push_region(r);{struct _tuple24*_tmp5E2;struct Cyc_List_List*_tmp5E1;struct Cyc_List_List*
_tmp3A3=(_tmp5E1=_region_malloc(r,sizeof(*_tmp5E1)),((_tmp5E1->hd=((_tmp5E2=
_region_malloc(r,sizeof(*_tmp5E2)),((_tmp5E2->f1=Cyc_Tcpat_compile_pat(r,p),((
_tmp5E2->f2=0,_tmp5E2)))))),((_tmp5E1->tl=0,_tmp5E1)))));void*_tmp3A4=((void*(*)(
struct _RegionHandle*r,struct Cyc_List_List*allmrules))Cyc_Tcpat_match_compile)(r,
_tmp3A3);struct _tuple14 _tmp5E3;struct _tuple14 _tmp3A5=(_tmp5E3.f1=loc,((_tmp5E3.f2=
1,_tmp5E3)));int _tmp3A6=0;((void(*)(struct _RegionHandle*r,void*d,void(*
...
r,_tmp3A4,Cyc_Tcpat_not_exhaust_warn,& _tmp3A5,Cyc_Tcpat_dummy_fn,0,& _tmp3A6);{
int _tmp3A7=_tmp3A5.f2;_npop_handler(0);return _tmp3A7;};};_pop_region(r);}static
struct _tuple22*Cyc_Tcpat_get_match2(struct _RegionHandle*r,struct Cyc_Absyn_Switch_clause*
swc){void*sp0=Cyc_Tcpat_compile_pat(r,swc->pattern);struct _tuple19*_tmp5E4;
struct _tuple19*rhs=(_tmp5E4=_region_malloc(r,sizeof(*_tmp5E4)),((_tmp5E4->f1=0,((
_tmp5E4->f2=(swc->pattern)->loc,_tmp5E4)))));struct _tuple22*_tmp5E5;return(
_tmp5E5=_region_malloc(r,sizeof(*_tmp5E5)),((_tmp5E5->f1=sp0,((_tmp5E5->f2=rhs,
_tmp5E5)))));}static void Cyc_Tcpat_not_exhaust_err2(struct _RegionHandle*r,
unsigned int loc,void*d){;}void Cyc_Tcpat_check_catch_overlap(unsigned int loc,
struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List*swcs){struct _RegionHandle _tmp3AD=
_new_region("r");struct _RegionHandle*r=& _tmp3AD;_push_region(r);{struct Cyc_List_List*
_tmp3AE=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple22*(*f)(
...
_tmp3AF=((void*(*)(struct _RegionHandle*r,struct Cyc_List_List*allmrules))Cyc_Tcpat_match_compile)(
r,_tmp3AE);int _tmp3B0=0;((void(*)(struct _RegionHandle*r,void*d,void(*not_exhaust)(
...
_tmp3AF,Cyc_Tcpat_not_exhaust_err2,loc,Cyc_Tcpat_rule_occurs,0,& _tmp3B0);for(0;
_tmp3AE != 0;_tmp3AE=_tmp3AE->tl){struct _tuple22 _tmp3B2;struct _tuple19*_tmp3B3;
struct _tuple19 _tmp3B4;int _tmp3B5;unsigned int _tmp3B6;struct _tuple22*_tmp3B1=(
struct _tuple22*)_tmp3AE->hd;_tmp3B2=*_tmp3B1;_tmp3B3=_tmp3B2.f2;_tmp3B4=*_tmp3B3;
_tmp3B5=_tmp3B4.f1;_tmp3B6=_tmp3B4.f2;if(!_tmp3B5){{const char*_tmp5E8;void*
_tmp5E7;(_tmp5E7=0,Cyc_Tcutil_terr(_tmp3B6,((_tmp5E8="redundant pattern (check for misspelled constructors in earlier patterns)",
