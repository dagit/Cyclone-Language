...
# 52
if(topt == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3A9;_tmp3A9.tag=0U,({struct _fat_ptr _tmp43D=({const char*_tmpC="cannot determine pattern type";_tag_fat(_tmpC,sizeof(char),30U);});_tmp3A9.f1=_tmp43D;});_tmp3A9;});void*_tmpA[1U];_tmpA[0]=& _tmpB;({unsigned _tmp43E=p->loc;Cyc_Warn_err2(_tmp43E,_tag_fat(_tmpA,sizeof(void*),1U));});});else{
# 55
...
# 57
({void*_tmp440=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp11=_cycalloc(sizeof(*_tmp11));_tmp11->tag=7U,({union Cyc_Absyn_AggrInfo*_tmp43F=({union Cyc_Absyn_AggrInfo*_tmp10=_cycalloc(sizeof(*_tmp10));*_tmp10=ainfo;_tmp10;});_tmp11->f1=_tmp43F;}),_tmp11->f2=exist_ts,_tmp11->f3=dps,_tmp11->f4=dots;_tmp11;});p->r=_tmp440;});
Cyc_Tcpat_resolve_pat(te,topt,p);
goto _LLF;}}else{goto _LL12;}}else{_LL12: _LL13:
# 61
({struct Cyc_Warn_String_Warn_Warg_struct _tmp13=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3AB;_tmp3AB.tag=0U,({struct _fat_ptr _tmp441=({const char*_tmp15="pattern expects aggregate type instead of ";_tag_fat(_tmp15,sizeof(char),43U);});_tmp3AB.f1=_tmp441;});_tmp3AB;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp14=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp3AA;_tmp3AA.tag=2U,_tmp3AA.f1=(void*)*topt;_tmp3AA;});void*_tmp12[2U];_tmp12[0]=& _tmp13,_tmp12[1]=& _tmp14;({unsigned _tmp442=p->loc;Cyc_Warn_err2(_tmp442,_tag_fat(_tmp12,sizeof(void*),2U));});});
goto _LLF;}_LLF:;}
# 64
...
if(ad->impl == 0){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3AD;_tmp3AD.tag=0U,({struct _fat_ptr _tmp443=({const char*_tmp1A="can't destructure an abstract";_tag_fat(_tmp1A,sizeof(char),30U);});_tmp3AD.f1=_tmp443;});_tmp3AD;});struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmp19=({struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmp3AC;_tmp3AC.tag=6U,_tmp3AC.f1=ad;_tmp3AC;});void*_tmp17[2U];_tmp17[0]=& _tmp18,_tmp17[1]=& _tmp19;({unsigned _tmp444=p->loc;Cyc_Warn_err2(_tmp444,_tag_fat(_tmp17,sizeof(void*),2U));});});
p->r=(void*)& Cyc_Absyn_Wild_p_val;
return;}{
# 73
int more_exists=({int _tmp445=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->exist_vars);_tmp445 - ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(*exist_ts);});
if(more_exists < 0){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3AE;_tmp3AE.tag=0U,({struct _fat_ptr _tmp446=({const char*_tmp1D="too many existential type variables in pattern";_tag_fat(_tmp1D,sizeof(char),47U);});_tmp3AE.f1=_tmp446;});_tmp3AE;});void*_tmp1B[1U];_tmp1B[0]=& _tmp1C;({unsigned _tmp447=p->loc;Cyc_Warn_err2(_tmp447,_tag_fat(_tmp1B,sizeof(void*),1U));});});{
...
new_ts=({struct Cyc_List_List*_tmp21=_cycalloc(sizeof(*_tmp21));({struct Cyc_Absyn_Tvar*_tmp448=Cyc_Tcutil_new_tvar((void*)({struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*_tmp20=_cycalloc(sizeof(*_tmp20));_tmp20->tag=1U,_tmp20->f1=0;_tmp20;}));_tmp21->hd=_tmp448;}),_tmp21->tl=new_ts;_tmp21;});}
({struct Cyc_List_List*_tmp449=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(*exist_ts,new_ts);*exist_ts=_tmp449;});}}
# 87
return;}}}else{_LLB: _LLC:
# 106
({struct Cyc_Warn_String_Warn_Warg_struct _tmp34=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3AF;_tmp3AF.tag=0U,({struct _fat_ptr _tmp44A=({const char*_tmp35="resolve_pat unknownAggr";_tag_fat(_tmp35,sizeof(char),24U);});_tmp3AF.f1=_tmp44A;});_tmp3AF;});void*_tmp33[1U];_tmp33[0]=& _tmp34;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp33,sizeof(void*),1U));});}}case 17U: _LL5: _tmp2=((struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp1)->f1;_LL6: {struct Cyc_Absyn_Exp*e=_tmp2;
# 89
Cyc_Tcexp_tcExp(te,0,e);
if(!Cyc_Tcutil_is_const_exp(e)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp23=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B0;_tmp3B0.tag=0U,({struct _fat_ptr _tmp44B=({const char*_tmp24="non-constant expression in case pattern";_tag_fat(_tmp24,sizeof(char),40U);});_tmp3B0.f1=_tmp44B;});_tmp3B0;});void*_tmp22[1U];_tmp22[0]=& _tmp23;({unsigned _tmp44C=p->loc;Cyc_Warn_err2(_tmp44C,_tag_fat(_tmp22,sizeof(void*),1U));});});
p->r=(void*)& Cyc_Absyn_Wild_p_val;
return;}{
# 95
...
if(!known){
({struct Cyc_String_pa_PrintArg_struct _tmp2B=({struct Cyc_String_pa_PrintArg_struct _tmp3B1;_tmp3B1.tag=0U,({struct _fat_ptr _tmp44D=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp3B1.f1=_tmp44D;});_tmp3B1;});void*_tmp29[1U];_tmp29[0]=& _tmp2B;({unsigned _tmp44F=p->loc;struct _fat_ptr _tmp44E=({const char*_tmp2A="cannot evaluate expression at compile time\nWe suggest using x && x == %s instead";_tag_fat(_tmp2A,sizeof(char),81U);});Cyc_Warn_err(_tmp44F,_tmp44E,_tag_fat(_tmp29,sizeof(void*),1U));});});
p->r=(void*)& Cyc_Absyn_Wild_p_val;
return;}
# 101
({void*_tmp450=(void*)({struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmp2C=_cycalloc(sizeof(*_tmp2C));_tmp2C->tag=10U,_tmp2C->f1=Cyc_Absyn_None,_tmp2C->f2=(int)i;_tmp2C;});p->r=_tmp450;});
return;}}}case 15U: _LL7: _LL8:
# 104
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B2;_tmp3B2.tag=0U,({struct _fat_ptr _tmp451=({const char*_tmp2F="resolve_pat UnknownId_p";_tag_fat(_tmp2F,sizeof(char),24U);});_tmp3B2.f1=_tmp451;});_tmp3B2;});void*_tmp2D[1U];_tmp2D[0]=& _tmp2E;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp2D,sizeof(void*),1U));});case 16U: _LL9: _LLA:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp31=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B3;_tmp3B3.tag=0U,({struct _fat_ptr _tmp452=({const char*_tmp32="resolve_pat UnknownCall_p";_tag_fat(_tmp32,sizeof(char),26U);});_tmp3B3.f1=_tmp452;});_tmp3B3;});void*_tmp30[1U];_tmp30[0]=& _tmp31;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp30,sizeof(void*),1U));});default: _LLD: _LLE:
# 108
 return;}_LL0:;}
# 112
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp39=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B6;_tmp3B6.tag=0U,({struct _fat_ptr _tmp454=({const char*_tmp3D="unnecessary ... in ";_tag_fat(_tmp3D,sizeof(char),20U);});_tmp3B6.f1=_tmp454;});_tmp3B6;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B5;_tmp3B5.tag=0U,_tmp3B5.f1=msg_str;_tmp3B5;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B4;_tmp3B4.tag=0U,({struct _fat_ptr _tmp455=({const char*_tmp3C=" pattern";_tag_fat(_tmp3C,sizeof(char),9U);});_tmp3B4.f1=_tmp455;});_tmp3B4;});void*_tmp38[3U];_tmp38[0]=& _tmp39,_tmp38[1]=& _tmp3A,_tmp38[2]=& _tmp3B;({unsigned _tmp456=loc;Cyc_Warn_warn2(_tmp456,_tag_fat(_tmp38,sizeof(void*),3U));});});{
...
return*topt;{
void*_tmp40=Cyc_Absyn_compress(numt);void*_stmttmp3=_tmp40;void*_tmp41=_stmttmp3;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp41)->tag == 0U)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp41)->f1)){case 15U: _LL1: _LL2:
...
if(p1 == 0 && p2 == 0)
return({struct Cyc_Tcpat_TcPatResult _tmp3B7;_tmp3B7.tvars_and_bounds_opt=0,({struct Cyc_List_List*_tmp45B=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(vs1,vs2);_tmp3B7.patvars=_tmp45B;});_tmp3B7;});
if(p1 == 0)
...
return({struct Cyc_Tcpat_TcPatResult _tmp3B8;({struct _tuple1*_tmp45F=({struct _tuple1*_tmp4C=_cycalloc(sizeof(*_tmp4C));({struct Cyc_List_List*_tmp45E=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)((*p1).f1,(*p2).f1);_tmp4C->f1=_tmp45E;}),({
struct Cyc_List_List*_tmp45D=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)((*p1).f2,(*p2).f2);_tmp4C->f2=_tmp45D;});_tmp4C;});
# 167
_tmp3B8.tvars_and_bounds_opt=_tmp45F;}),({
# 169
struct Cyc_List_List*_tmp45C=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(vs1,vs2);_tmp3B8.patvars=_tmp45C;});_tmp3B8;});}}}
# 173
...
# 194
 t=({struct Cyc_List_List*_tmp462=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tcpat_any_type(_tmp462,topt);});goto _LL0;case 1U: _LL3: _tmp65=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp50)->f1;_tmp66=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp50)->f2;_LL4: {struct Cyc_Absyn_Vardecl*vd=_tmp65;struct Cyc_Absyn_Pat*p2=_tmp66;
# 198
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp6D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3BB;_tmp3BB.tag=0U,({struct _fat_ptr _tmp465=({const char*_tmp71="you probably do not want to use ";_tag_fat(_tmp71,sizeof(char),33U);});_tmp3BB.f1=_tmp465;});_tmp3BB;});struct Cyc_Warn_String_Warn_Warg_struct _tmp6E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3BA;_tmp3BA.tag=0U,_tmp3BA.f1=v;_tmp3BA;});struct Cyc_Warn_String_Warn_Warg_struct _tmp6F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B9;_tmp3B9.tag=0U,({
struct _fat_ptr _tmp466=({const char*_tmp70=" as a local variable";_tag_fat(_tmp70,sizeof(char),21U);});_tmp3B9.f1=_tmp466;});_tmp3B9;});void*_tmp6C[3U];_tmp6C[0]=& _tmp6D,_tmp6C[1]=& _tmp6E,_tmp6C[2]=& _tmp6F;({unsigned _tmp467=p->loc;Cyc_Warn_warn2(_tmp467,_tag_fat(_tmp6C,sizeof(void*),3U));});});
res=Cyc_Tcpat_tcPatRec(te,p2,topt,rgn_pat,allow_ref_pat,access_exp);
t=(void*)_check_null(p2->topt);
# 206
{void*_tmp72=Cyc_Absyn_compress(t);void*_stmttmp6=_tmp72;void*_tmp73=_stmttmp6;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp73)->tag == 4U){_LL2F: _LL30:
# 208
 if(rgn_pat == 0 || !allow_ref_pat)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp75=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3BC;_tmp3BC.tag=0U,({struct _fat_ptr _tmp468=({const char*_tmp76="array reference would point into unknown/unallowed region";_tag_fat(_tmp76,sizeof(char),58U);});_tmp3BC.f1=_tmp468;});_tmp3BC;});void*_tmp74[1U];_tmp74[0]=& _tmp75;({unsigned _tmp469=p->loc;Cyc_Warn_err2(_tmp469,_tag_fat(_tmp74,sizeof(void*),1U));});});
goto _LL2E;}else{_LL31: _LL32:
# 212
 if(!Cyc_Kinds_kind_leq(Cyc_Tcutil_type_kind(t),& Cyc_Kinds_tmk))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp78=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3BD;_tmp3BD.tag=0U,({struct _fat_ptr _tmp46A=({const char*_tmp79="pattern would point to an abstract member";_tag_fat(_tmp79,sizeof(char),42U);});_tmp3BD.f1=_tmp46A;});_tmp3BD;});void*_tmp77[1U];_tmp77[0]=& _tmp78;({unsigned _tmp46B=p->loc;Cyc_Warn_err2(_tmp46B,_tag_fat(_tmp77,sizeof(void*),1U));});});
goto _LL2E;}_LL2E:;}
# 216
...
goto _LL0;}}case 2U: _LL5: _tmp63=((struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp50)->f1;_tmp64=((struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp50)->f2;_LL6: {struct Cyc_Absyn_Tvar*tv=_tmp63;struct Cyc_Absyn_Vardecl*vd=_tmp64;
# 219
struct Cyc_Tcenv_Tenv*te2=({unsigned _tmp470=p->loc;struct Cyc_Tcenv_Tenv*_tmp46F=te;Cyc_Tcenv_add_type_vars(_tmp470,_tmp46F,({struct Cyc_Absyn_Tvar*_tmp87[1U];_tmp87[0]=tv;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp87,sizeof(struct Cyc_Absyn_Tvar*),1U));}));});
...
struct Cyc_List_List*_tmp473=(*res.tvars_and_bounds_opt).f1;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp473,({struct Cyc_List_List*_tmp7D=_cycalloc(sizeof(*_tmp7D));({struct _tuple18*_tmp472=({struct _tuple18*_tmp7C=_cycalloc(sizeof(*_tmp7C));_tmp7C->f1=tv,_tmp7C->f2=1;_tmp7C;});_tmp7D->hd=_tmp472;}),_tmp7D->tl=0;_tmp7D;}));});
# 222
...
{void*_tmp7E=Cyc_Absyn_compress(t);void*_stmttmp7=_tmp7E;void*_tmp7F=_stmttmp7;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp7F)->tag == 4U){_LL34: _LL35:
# 230
 if(rgn_pat == 0 || !allow_ref_pat)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp81=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3BE;_tmp3BE.tag=0U,({struct _fat_ptr _tmp479=({const char*_tmp82="array reference would point into unknown/unallowed region";_tag_fat(_tmp82,sizeof(char),58U);});_tmp3BE.f1=_tmp479;});_tmp3BE;});void*_tmp80[1U];_tmp80[0]=& _tmp81;({unsigned _tmp47A=p->loc;Cyc_Warn_err2(_tmp47A,_tag_fat(_tmp80,sizeof(void*),1U));});});
goto _LL33;}else{_LL36: _LL37:
# 234
 if(!Cyc_Kinds_kind_leq(Cyc_Tcutil_type_kind(t),& Cyc_Kinds_tmk))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp84=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3BF;_tmp3BF.tag=0U,({struct _fat_ptr _tmp47B=({const char*_tmp85="pattern would point to an abstract member";_tag_fat(_tmp85,sizeof(char),42U);});_tmp3BF.f1=_tmp47B;});_tmp3BF;});void*_tmp83[1U];_tmp83[0]=& _tmp84;({unsigned _tmp47C=p->loc;Cyc_Warn_err2(_tmp47C,_tag_fat(_tmp83,sizeof(void*),1U));});});
goto _LL33;}_LL33:;}
# 238
...
goto _LL0;}case 3U: _LL7: _tmp61=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp50)->f1;_tmp62=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp50)->f2;_LL8: {struct Cyc_Absyn_Vardecl*vd=_tmp61;struct Cyc_Absyn_Pat*p2=_tmp62;
# 242
res=Cyc_Tcpat_tcPatRec(te,p2,topt,rgn_pat,allow_ref_pat,access_exp);
t=(void*)_check_null(p2->topt);
if(!allow_ref_pat || rgn_pat == 0){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp89=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C0;_tmp3C0.tag=0U,({struct _fat_ptr _tmp480=({const char*_tmp8A="* pattern would point into an unknown/unallowed region";_tag_fat(_tmp8A,sizeof(char),55U);});_tmp3C0.f1=_tmp480;});_tmp3C0;});void*_tmp88[1U];_tmp88[0]=& _tmp89;({unsigned _tmp481=p->loc;Cyc_Warn_err2(_tmp481,_tag_fat(_tmp88,sizeof(void*),1U));});});
goto _LL0;}else{
if(Cyc_Tcutil_is_noalias_pointer_or_aggr(t))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp8C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C1;_tmp3C1.tag=0U,({struct _fat_ptr _tmp482=({const char*_tmp8D="* pattern cannot take the address of an alias-free path";_tag_fat(_tmp8D,sizeof(char),56U);});_tmp3C1.f1=_tmp482;});_tmp3C1;});void*_tmp8B[1U];_tmp8B[0]=& _tmp8C;({unsigned _tmp483=p->loc;Cyc_Warn_err2(_tmp483,_tag_fat(_tmp8B,sizeof(void*),1U));});});}{
...
goto _LL0;}}}case 4U: _LL9: _tmp5F=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp50)->f1;_tmp60=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp50)->f2;_LLA: {struct Cyc_Absyn_Tvar*tv=_tmp5F;struct Cyc_Absyn_Vardecl*vd=_tmp60;
# 265
...
# 269
({unsigned _tmp48B=p->loc;struct Cyc_Tcenv_Tenv*_tmp48A=te;Cyc_Tcenv_add_type_vars(_tmp48B,_tmp48A,({struct Cyc_Absyn_Tvar*_tmp91[1U];_tmp91[0]=tv;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp91,sizeof(struct Cyc_Absyn_Tvar*),1U));}));});
if(res.tvars_and_bounds_opt == 0)
...
goto _LL0;}case 10U: if(((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp50)->f1 == Cyc_Absyn_Unsigned){_LLB: _LLC:
# 277
 ...
 t=Cyc_Tcpat_num_type(topt,Cyc_Absyn_char_type);goto _LL0;case 12U: _LL11: _tmp5E=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp50)->f2;_LL12: {int i=_tmp5E;
t=({void**_tmp48F=topt;Cyc_Tcpat_num_type(_tmp48F,Cyc_Absyn_gen_float_type((unsigned)i));});goto _LL0;}case 13U: _LL13: _tmp5D=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp50)->f1;_LL14: {struct Cyc_Absyn_Enumdecl*ed=_tmp5D;
t=({void**_tmp490=topt;Cyc_Tcpat_num_type(_tmp490,Cyc_Absyn_enum_type(ed->name,ed));});goto _LL0;}case 14U: _LL15: _tmp5C=(void*)((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp50)->f1;_LL16: {void*tenum=_tmp5C;
t=Cyc_Tcpat_num_type(topt,tenum);goto _LL0;}case 9U: _LL17: _LL18:
# 284
 if(topt != 0){
void*_tmp95=Cyc_Absyn_compress(*topt);void*_stmttmp8=_tmp95;void*_tmp96=_stmttmp8;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp96)->tag == 3U){_LL39: _LL3A:
...
# 333
p2->topt=new_type;
t=(void*)({struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmpA4=_cycalloc(sizeof(*_tmpA4));_tmpA4->tag=3U,(_tmpA4->f1).elt_type=new_type,
...
goto _LL0;}}case 5U: _LL1B: _tmp59=(struct Cyc_List_List**)&((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp50)->f1;_tmp5A=((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp50)->f2;_LL1C: {struct Cyc_List_List**ps_p=_tmp59;int dots=_tmp5A;
# 353
...
if(topt != 0){
void*_tmpA8=Cyc_Absyn_compress(*topt);void*_stmttmpC=_tmpA8;void*_tmpA9=_stmttmpC;struct Cyc_List_List*_tmpAA;if(((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmpA9)->tag == 6U){_LL4D: _tmpAA=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmpA9)->f1;_LL4E: {struct Cyc_List_List*tqts=_tmpAA;
# 359
topt_ts=tqts;
if(dots){
({struct Cyc_List_List*_tmp49D=({struct Cyc_List_List*_tmp49C=ps;int _tmp49B=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ps);int _tmp49A=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(tqts);unsigned _tmp499=p->loc;((struct Cyc_List_List*(*)(struct Cyc_List_List*earlier,int num_pats,int num_fields,struct Cyc_Absyn_Pat*(*f)(unsigned),unsigned loc,struct _fat_ptr msg_str))Cyc_Tcpat_remove_dots)(_tmp49C,_tmp49B,_tmp49A,Cyc_Tcpat_wild_pat,_tmp499,({const char*_tmpAB="tuple";_tag_fat(_tmpAB,sizeof(char),6U);}));});*ps_p=_tmp49D;});
# 363
ps=*ps_p;}
# 365
...
# 368
if(dots)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpAD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C2;_tmp3C2.tag=0U,({struct _fat_ptr _tmp49E=({const char*_tmpAE="cannot determine missing fields for ... in tuple pattern";_tag_fat(_tmpAE,sizeof(char),57U);});_tmp3C2.f1=_tmp49E;});_tmp3C2;});void*_tmpAC[1U];_tmpAC[0]=& _tmpAD;({unsigned _tmp49F=p->loc;Cyc_Warn_err2(_tmp49F,_tag_fat(_tmpAC,sizeof(void*),1U));});});}
...
# 387
t=(void*)({struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmpB2=_cycalloc(sizeof(*_tmpB2));_tmpB2->tag=6U,({struct Cyc_List_List*_tmp4A4=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(pat_ts);_tmpB2->f1=_tmp4A4;});_tmpB2;});
goto _LL0;}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp50)->f1 != 0){if((((union Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp50)->f1)->KnownAggr).tag == 2){_LL1D: _tmp55=*((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp50)->f1)->KnownAggr).val;_tmp56=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp50)->f2;_tmp57=(struct Cyc_List_List**)&((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp50)->f3;_tmp58=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp50)->f4;_LL1E: {struct Cyc_Absyn_Aggrdecl*ad=_tmp55;struct Cyc_List_List*exist_ts=_tmp56;struct Cyc_List_List**dps_p=_tmp57;int dots=_tmp58;
# 391
struct Cyc_List_List*_tmpB3=*dps_p;struct Cyc_List_List*dps=_tmpB3;
if(ad->impl == 0){
({struct Cyc_Warn_String_Warn_Warg_struct _tmpB5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C5;_tmp3C5.tag=0U,({struct _fat_ptr _tmp4A5=({const char*_tmpB7="can't destructure abstract ";_tag_fat(_tmpB7,sizeof(char),28U);});_tmp3C5.f1=_tmp4A5;});_tmp3C5;});struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmpB6=({struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmp3C4;_tmp3C4.tag=6U,_tmp3C4.f1=ad;_tmp3C4;});void*_tmpB4[2U];_tmpB4[0]=& _tmpB5,_tmpB4[1]=& _tmpB6;({unsigned _tmp4A6=p->loc;Cyc_Warn_err2(_tmp4A6,_tag_fat(_tmpB4,sizeof(void*),2U));});});
...
{void*_tmpBD=kb2;struct Cyc_Absyn_Kind*_tmpBE;struct Cyc_Absyn_Kind*_tmpBF;switch(*((int*)_tmpBD)){case 2U: _LL52: _tmpBF=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmpBD)->f2;_LL53: {struct Cyc_Absyn_Kind*k=_tmpBF;
_tmpBE=k;goto _LL55;}case 0U: _LL54: _tmpBE=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmpBD)->f1;_LL55: {struct Cyc_Absyn_Kind*k=_tmpBE;
k2=k;goto _LL51;}default: _LL56: _LL57:
({struct Cyc_Warn_String_Warn_Warg_struct _tmpC1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C6;_tmp3C6.tag=0U,({struct _fat_ptr _tmp4A7=({const char*_tmpC2="unconstrained existential tyvar in aggregate";_tag_fat(_tmpC2,sizeof(char),45U);});_tmp3C6.f1=_tmp4A7;});_tmp3C6;});void*_tmpC0[1U];_tmpC0[0]=& _tmpC1;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpC0,sizeof(void*),1U));});}_LL51:;}
# 425
{void*_tmpC3=kb1;struct Cyc_Core_Opt**_tmpC4;struct Cyc_Absyn_Kind*_tmpC6;struct Cyc_Core_Opt**_tmpC5;struct Cyc_Absyn_Kind*_tmpC7;switch(*((int*)_tmpC3)){case 0U: _LL59: _tmpC7=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmpC3)->f1;_LL5A: {struct Cyc_Absyn_Kind*k1=_tmpC7;
# 428
if(!Cyc_Kinds_kind_leq(k2,k1))
({struct Cyc_Warn_String_Warn_Warg_struct _tmpC9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3CC;_tmp3CC.tag=0U,({struct _fat_ptr _tmp4A8=({const char*_tmpD1="type variable ";_tag_fat(_tmpD1,sizeof(char),15U);});_tmp3CC.f1=_tmp4A8;});_tmp3CC;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmpCA=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp3CB;_tmp3CB.tag=7U,_tmp3CB.f1=tv;_tmp3CB;});struct Cyc_Warn_String_Warn_Warg_struct _tmpCB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3CA;_tmp3CA.tag=0U,({struct _fat_ptr _tmp4A9=({const char*_tmpD0=" has kind ";_tag_fat(_tmpD0,sizeof(char),11U);});_tmp3CA.f1=_tmp4A9;});_tmp3CA;});struct Cyc_Warn_KindBound_Warn_Warg_struct _tmpCC=({struct Cyc_Warn_KindBound_Warn_Warg_struct _tmp3C9;_tmp3C9.tag=8U,_tmp3C9.f1=(void*)kb1;_tmp3C9;});struct Cyc_Warn_String_Warn_Warg_struct _tmpCD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C8;_tmp3C8.tag=0U,({
struct _fat_ptr _tmp4AA=({const char*_tmpCF=" but must have at least kind ";_tag_fat(_tmpCF,sizeof(char),30U);});_tmp3C8.f1=_tmp4AA;});_tmp3C8;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmpCE=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp3C7;_tmp3C7.tag=9U,_tmp3C7.f1=k2;_tmp3C7;});void*_tmpC8[6U];_tmpC8[0]=& _tmpC9,_tmpC8[1]=& _tmpCA,_tmpC8[2]=& _tmpCB,_tmpC8[3]=& _tmpCC,_tmpC8[4]=& _tmpCD,_tmpC8[5]=& _tmpCE;({unsigned _tmp4AB=p->loc;Cyc_Warn_err2(_tmp4AB,_tag_fat(_tmpC8,sizeof(void*),6U));});});
goto _LL58;}case 2U: _LL5B: _tmpC5=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmpC3)->f1;_tmpC6=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmpC3)->f2;_LL5C: {struct Cyc_Core_Opt**f=_tmpC5;struct Cyc_Absyn_Kind*k=_tmpC6;
...
# 435
void*vartype=(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmpD9=_cycalloc(sizeof(*_tmpD9));_tmpD9->tag=2U,_tmpD9->f1=tv;_tmpD9;});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpD5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3CD;_tmp3CD.tag=0U,({struct _fat_ptr _tmp4AD=({const char*_tmpD6="opened existential had unique or top region kind";_tag_fat(_tmpD6,sizeof(char),49U);});_tmp3CD.f1=_tmp4AD;});_tmp3CD;});void*_tmpD4[1U];_tmpD4[0]=& _tmpD5;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpD4,sizeof(void*),1U));});
...
struct Cyc_List_List*_tmpDB=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple14*(*f)(struct _tuple13*,struct Cyc_Absyn_Tvar*),struct _tuple13*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(rgn,Cyc_Tcutil_r_make_inst_var,& env,ad->tvs);struct Cyc_List_List*all_inst=_tmpDB;
struct Cyc_List_List*_tmpDC=((struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rzip)(rgn,rgn,((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->exist_vars,var_tvs);struct Cyc_List_List*exist_inst=_tmpDC;
struct Cyc_List_List*_tmpDD=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple14*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple14*))Cyc_Core_snd,all_inst);struct Cyc_List_List*all_typs=_tmpDD;
struct Cyc_List_List*_tmpDE=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple14*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple14*))Cyc_Core_snd,exist_inst);struct Cyc_List_List*exist_typs=_tmpDE;
struct Cyc_List_List*_tmpDF=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rappend)(rgn,all_inst,exist_inst);struct Cyc_List_List*inst=_tmpDF;
# 458
...
struct Cyc_List_List*_tmp4B1=(*res.tvars_and_bounds_opt).f1;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp4B1,((struct Cyc_List_List*(*)(struct _tuple18*(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_add_false,exist_ts));});
# 461
...
({void*_tmpE6=0U;({unsigned _tmp4BA=p->loc;struct _fat_ptr _tmp4B9=({const char*_tmpE7="`...' pattern not allowed in union pattern";_tag_fat(_tmpE7,sizeof(char),43U);});Cyc_Warn_warn(_tmp4BA,_tmp4B9,_tag_fat(_tmpE6,sizeof(void*),0U));});});else{
if(dots){
({struct Cyc_List_List*_tmp4BF=({struct Cyc_List_List*_tmp4BE=dps;int _tmp4BD=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(dps);int _tmp4BC=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->fields);unsigned _tmp4BB=p->loc;((struct Cyc_List_List*(*)(struct Cyc_List_List*earlier,int num_pats,int num_fields,struct _tuple16*(*f)(unsigned),unsigned loc,struct _fat_ptr msg_str))Cyc_Tcpat_remove_dots)(_tmp4BE,_tmp4BD,_tmp4BC,Cyc_Tcpat_wild_dlp,_tmp4BB,({const char*_tmpE8="struct";_tag_fat(_tmpE8,sizeof(char),7U);}));});*dps_p=_tmp4BF;});
# 482
dps=*dps_p;}}{
# 484
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpEF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3D5;_tmp3D5.tag=0U,({struct _fat_ptr _tmp4C1=({const char*_tmpFA="field ";_tag_fat(_tmpFA,sizeof(char),7U);});_tmp3D5.f1=_tmp4C1;});_tmp3D5;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3D4;_tmp3D4.tag=0U,_tmp3D4.f1=*field->name;_tmp3D4;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3D3;_tmp3D3.tag=0U,({struct _fat_ptr _tmp4C2=({const char*_tmpF9=" of ";_tag_fat(_tmpF9,sizeof(char),5U);});_tmp3D3.f1=_tmp4C2;});_tmp3D3;});struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmpF2=({struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmp3D2;_tmp3D2.tag=6U,_tmp3D2.f1=ad;_tmp3D2;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3D1;_tmp3D1.tag=0U,({
struct _fat_ptr _tmp4C3=({const char*_tmpF8=" pattern expects type ";_tag_fat(_tmpF8,sizeof(char),23U);});_tmp3D1.f1=_tmp4C3;});_tmp3D1;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpF4=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp3D0;_tmp3D0.tag=2U,_tmp3D0.f1=(void*)inst_fieldtyp;_tmp3D0;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3CF;_tmp3CF.tag=0U,({struct _fat_ptr _tmp4C4=({const char*_tmpF7=" != ";_tag_fat(_tmpF7,sizeof(char),5U);});_tmp3CF.f1=_tmp4C4;});_tmp3CF;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpF6=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp3CE;_tmp3CE.tag=2U,_tmp3CE.f1=(void*)_check_null(pat->topt);_tmp3CE;});void*_tmpEE[8U];_tmpEE[0]=& _tmpEF,_tmpEE[1]=& _tmpF0,_tmpEE[2]=& _tmpF1,_tmpEE[3]=& _tmpF2,_tmpEE[4]=& _tmpF3,_tmpEE[5]=& _tmpF4,_tmpEE[6]=& _tmpF5,_tmpEE[7]=& _tmpF6;({unsigned _tmp4C5=p->loc;Cyc_Warn_err2(_tmp4C5,_tag_fat(_tmpEE,sizeof(void*),8U));});});
# 502
...
struct Cyc_List_List*_tmpFD=((struct Cyc_List_List*(*)(struct _tuple14*(*f)(struct _tuple13*,struct Cyc_Absyn_Tvar*),struct _tuple13*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcutil_r_make_inst_var,& env,tud->tvs);struct Cyc_List_List*inst=_tmpFD;
struct Cyc_List_List*_tmpFE=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple14*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple14*))Cyc_Core_snd,inst);struct Cyc_List_List*all_typs=_tmpFE;
...
if(dots){
({struct Cyc_List_List*_tmp4CC=({struct Cyc_List_List*_tmp4CB=ps;int _tmp4CA=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ps);int _tmp4C9=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(tqts);unsigned _tmp4C8=p->loc;((struct Cyc_List_List*(*)(struct Cyc_List_List*earlier,int num_pats,int num_fields,struct Cyc_Absyn_Pat*(*f)(unsigned),unsigned loc,struct _fat_ptr msg_str))Cyc_Tcpat_remove_dots)(_tmp4CB,_tmp4CA,_tmp4C9,Cyc_Tcpat_wild_pat,_tmp4C8,({const char*_tmpFF="datatype field";_tag_fat(_tmpFF,sizeof(char),15U);}));});*ps_p=_tmp4CC;});
# 518
ps=*ps_p;}
# 520
...
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp103=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp3DB;_tmp3DB.tag=1U,_tmp3DB.f1=tuf->name;_tmp3DB;});struct Cyc_Warn_String_Warn_Warg_struct _tmp104=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3DA;_tmp3DA.tag=0U,({struct _fat_ptr _tmp4CE=({const char*_tmp109=" expects argument type ";_tag_fat(_tmp109,sizeof(char),24U);});_tmp3DA.f1=_tmp4CE;});_tmp3DA;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp105=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp3D9;_tmp3D9.tag=2U,_tmp3D9.f1=(void*)field_typ;_tmp3D9;});struct Cyc_Warn_String_Warn_Warg_struct _tmp106=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3D8;_tmp3D8.tag=0U,({
struct _fat_ptr _tmp4CF=({const char*_tmp108=" not ";_tag_fat(_tmp108,sizeof(char),6U);});_tmp3D8.f1=_tmp4CF;});_tmp3D8;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp107=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp3D7;_tmp3D7.tag=2U,_tmp3D7.f1=(void*)_check_null(p2->topt);_tmp3D7;});void*_tmp102[5U];_tmp102[0]=& _tmp103,_tmp102[1]=& _tmp104,_tmp102[2]=& _tmp105,_tmp102[3]=& _tmp106,_tmp102[4]=& _tmp107;({unsigned _tmp4D0=p2->loc;Cyc_Warn_err2(_tmp4D0,_tag_fat(_tmp102,sizeof(void*),5U));});});}
# 538
if(ps != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp10B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3DD;_tmp3DD.tag=0U,({struct _fat_ptr _tmp4D1=({const char*_tmp10D="too many arguments for datatype constructor ";_tag_fat(_tmp10D,sizeof(char),45U);});_tmp3DD.f1=_tmp4D1;});_tmp3DD;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp10C=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp3DC;_tmp3DC.tag=1U,_tmp3DC.f1=tuf->name;_tmp3DC;});void*_tmp10A[2U];_tmp10A[0]=& _tmp10B,_tmp10A[1]=& _tmp10C;({unsigned _tmp4D2=p->loc;Cyc_Warn_err2(_tmp4D2,_tag_fat(_tmp10A,sizeof(void*),2U));});});
if(tqts != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp10F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3DF;_tmp3DF.tag=0U,({struct _fat_ptr _tmp4D3=({const char*_tmp111="too few arguments for datatype constructor ";_tag_fat(_tmp111,sizeof(char),44U);});_tmp3DF.f1=_tmp4D3;});_tmp3DF;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp110=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp3DE;_tmp3DE.tag=1U,_tmp3DE.f1=tuf->name;_tmp3DE;});void*_tmp10E[2U];_tmp10E[0]=& _tmp10F,_tmp10E[1]=& _tmp110;({unsigned _tmp4D4=p->loc;Cyc_Warn_err2(_tmp4D4,_tag_fat(_tmp10E,sizeof(void*),2U));});});
...
# 559
struct _tuple1 _tmp113=((struct _tuple1(*)(struct Cyc_List_List*x))Cyc_List_split)(ans.patvars);struct _tuple1 _stmttmpE=_tmp113;struct _tuple1 _tmp114=_stmttmpE;struct Cyc_List_List*_tmp115;_LL1: _tmp115=_tmp114.f1;_LL2: {struct Cyc_List_List*vs1=_tmp115;
...
({struct Cyc_List_List*_tmp4D6=((struct Cyc_List_List*(*)(struct _fat_ptr*(*f)(struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_get_name,vs);unsigned _tmp4D5=p->loc;Cyc_Tcutil_check_unique_vars(_tmp4D6,_tmp4D5,({const char*_tmp118="pattern contains a repeated variable";_tag_fat(_tmp118,sizeof(char),37U);}));});
# 568
...
# 582
struct _tuple0 _tmp11D=({struct _tuple0 _tmp3E2;({void*_tmp4D9=Cyc_Absyn_compress(old_type);_tmp3E2.f1=_tmp4D9;}),({void*_tmp4D8=Cyc_Absyn_compress(new_type);_tmp3E2.f2=_tmp4D8;});_tmp3E2;});struct _tuple0 _stmttmp10=_tmp11D;struct _tuple0 _tmp11E=_stmttmp10;struct Cyc_Absyn_PtrInfo _tmp120;struct Cyc_Absyn_PtrInfo _tmp11F;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp11E.f1)->tag == 3U){if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp11E.f2)->tag == 3U){_LL1: _tmp11F=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp11E.f1)->f1;_tmp120=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp11E.f2)->f1;_LL2: {struct Cyc_Absyn_PtrInfo pold=_tmp11F;struct Cyc_Absyn_PtrInfo pnew=_tmp120;
# 584
struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp121=({struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp122=_cycalloc(sizeof(*_tmp122));_tmp122->tag=3U,(_tmp122->f1).elt_type=pold.elt_type,(_tmp122->f1).elt_tq=pnew.elt_tq,
...
# 603
struct Cyc_List_List*assump=({struct Cyc_List_List*_tmp133=_cycalloc(sizeof(*_tmp133));({struct _tuple0*_tmp4E0=({struct _tuple0*_tmp132=_cycalloc(sizeof(*_tmp132));_tmp132->f1=Cyc_Absyn_unique_rgn_type,({void*_tmp4DF=(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp131=_cycalloc(sizeof(*_tmp131));_tmp131->tag=2U,_tmp131->f1=tv;_tmp131;});_tmp132->f2=_tmp4DF;});_tmp132;});_tmp133->hd=_tmp4E0;}),_tmp133->tl=0;_tmp133;});
...
# 621 "tcpat.cyc"
struct _tuple0 _tmp123=({struct _tuple0 _tmp3E4;({void*_tmp4E5=Cyc_Absyn_compress(old_type);_tmp3E4.f1=_tmp4E5;}),({void*_tmp4E4=Cyc_Absyn_compress(new_type);_tmp3E4.f2=_tmp4E4;});_tmp3E4;});struct _tuple0 _stmttmp11=_tmp123;struct _tuple0 _tmp124=_stmttmp11;struct Cyc_Absyn_PtrInfo _tmp126;struct Cyc_Absyn_PtrInfo _tmp125;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp124.f1)->tag == 3U){if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp124.f2)->tag == 3U){_LL1: _tmp125=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp124.f1)->f1;_tmp126=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp124.f2)->f1;_LL2: {struct Cyc_Absyn_PtrInfo pold=_tmp125;struct Cyc_Absyn_PtrInfo pnew=_tmp126;
goto _LL0;}}else{goto _LL3;}}else{_LL3: _LL4:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp128=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3E3;_tmp3E3.tag=0U,({struct _fat_ptr _tmp4E6=({const char*_tmp129="alias requires pointer type";_tag_fat(_tmp129,sizeof(char),28U);});_tmp3E3.f1=_tmp4E6;});_tmp3E3;});void*_tmp127[1U];_tmp127[0]=& _tmp128;({unsigned _tmp4E7=loc;Cyc_Warn_err2(_tmp4E7,_tag_fat(_tmp127,sizeof(void*),1U));});});goto _LL0;}_LL0:;}else{
# 626
({struct Cyc_Warn_String_Warn_Warg_struct _tmp12B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3E8;_tmp3E8.tag=0U,({struct _fat_ptr _tmp4E8=({const char*_tmp130="cannot alias value of type ";_tag_fat(_tmp130,sizeof(char),28U);});_tmp3E8.f1=_tmp4E8;});_tmp3E8;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp12C=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp3E7;_tmp3E7.tag=2U,_tmp3E7.f1=(void*)old_type;_tmp3E7;});struct Cyc_Warn_String_Warn_Warg_struct _tmp12D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3E6;_tmp3E6.tag=0U,({struct _fat_ptr _tmp4E9=({const char*_tmp12F=" to type ";_tag_fat(_tmp12F,sizeof(char),10U);});_tmp3E6.f1=_tmp4E9;});_tmp3E6;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp12E=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp3E5;_tmp3E5.tag=2U,_tmp3E5.f1=(void*)new_type;_tmp3E5;});void*_tmp12A[4U];_tmp12A[0]=& _tmp12B,_tmp12A[1]=& _tmp12C,_tmp12A[2]=& _tmp12D,_tmp12A[3]=& _tmp12E;({unsigned _tmp4EA=loc;Cyc_Warn_err2(_tmp4EA,_tag_fat(_tmp12A,sizeof(void*),4U));});});}}
# 632
...
# 634
void*_tmp134=p->r;void*_stmttmp12=_tmp134;void*_tmp135=_stmttmp12;struct Cyc_Absyn_Vardecl*_tmp137;struct Cyc_Absyn_Tvar*_tmp136;struct Cyc_Absyn_Pat*_tmp139;struct Cyc_Absyn_Vardecl*_tmp138;struct Cyc_Absyn_Pat*_tmp13B;struct Cyc_Absyn_Vardecl*_tmp13A;struct Cyc_List_List*_tmp13C;struct Cyc_List_List*_tmp13D;struct Cyc_List_List*_tmp140;struct Cyc_List_List*_tmp13F;union Cyc_Absyn_AggrInfo*_tmp13E;struct Cyc_Absyn_Pat*_tmp141;switch(*((int*)_tmp135)){case 6U: _LL1: _tmp141=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp135)->f1;_LL2: {struct Cyc_Absyn_Pat*p2=_tmp141;
# 636
void*_tmp142=(void*)_check_null(p->topt);void*_stmttmp13=_tmp142;void*_tmp143=_stmttmp13;void*_tmp144;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp143)->tag == 3U){_LL12: _tmp144=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp143)->f1).ptr_atts).rgn;_LL13: {void*rt=_tmp144;
# 638
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp146=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3E9;_tmp3E9.tag=0U,({struct _fat_ptr _tmp4EE=({const char*_tmp147="check_pat_regions: bad pointer type";_tag_fat(_tmp147,sizeof(char),36U);});_tmp3E9.f1=_tmp4EE;});_tmp3E9;});void*_tmp145[1U];_tmp145[0]=& _tmp146;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp145,sizeof(void*),1U));});}_LL11:;}case 7U: _LL3: _tmp13E=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp135)->f1;_tmp13F=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp135)->f2;_tmp140=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp135)->f3;_LL4: {union Cyc_Absyn_AggrInfo*ai=_tmp13E;struct Cyc_List_List*exist_ts=_tmp13F;struct Cyc_List_List*dps=_tmp140;
# 644
for(0;dps != 0;dps=dps->tl){
Cyc_Tcpat_check_pat_regions_rec(te,(*((struct _tuple16*)dps->hd)).f2,did_noalias_deref,patvars);}
return;}case 8U: _LL5: _tmp13D=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp135)->f3;_LL6: {struct Cyc_List_List*ps=_tmp13D;
# 648
did_noalias_deref=0;_tmp13C=ps;goto _LL8;}case 5U: _LL7: _tmp13C=((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp135)->f1;_LL8: {struct Cyc_List_List*ps=_tmp13C;
# 650
for(0;ps != 0;ps=ps->tl){
Cyc_Tcpat_check_pat_regions_rec(te,(struct Cyc_Absyn_Pat*)ps->hd,did_noalias_deref,patvars);}
return;}case 3U: _LL9: _tmp13A=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp135)->f1;_tmp13B=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp135)->f2;_LLA: {struct Cyc_Absyn_Vardecl*vd=_tmp13A;struct Cyc_Absyn_Pat*p2=_tmp13B;
# 654
...
{void*_tmp14C=eopt->r;void*_stmttmp15=_tmp14C;void*_tmp14D=_stmttmp15;struct Cyc_Absyn_Exp*_tmp14E;if(((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp14D)->tag == 15U){_LL1A: _tmp14E=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp14D)->f1;_LL1B: {struct Cyc_Absyn_Exp*e=_tmp14E;
# 663
if(Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_check_null(e->topt)))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp150=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3EA;_tmp3EA.tag=0U,({struct _fat_ptr _tmp4EF=({const char*_tmp151="reference pattern not allowed on alias-free pointers";_tag_fat(_tmp151,sizeof(char),53U);});_tmp3EA.f1=_tmp4EF;});_tmp3EA;});void*_tmp14F[1U];_tmp14F[0]=& _tmp150;({unsigned _tmp4F0=p->loc;Cyc_Warn_err2(_tmp4F0,_tag_fat(_tmp14F,sizeof(void*),1U));});});
goto _LL19;}}else{_LL1C: _LL1D:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp153=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3EB;_tmp3EB.tag=0U,({struct _fat_ptr _tmp4F1=({const char*_tmp154="check_pat_regions: bad reference access exp";_tag_fat(_tmp154,sizeof(char),44U);});_tmp3EB.f1=_tmp4F1;});_tmp3EB;});void*_tmp152[1U];_tmp152[0]=& _tmp153;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp152,sizeof(void*),1U));});}_LL19:;}
# 668
break;}}}}
# 671
Cyc_Tcpat_check_pat_regions_rec(te,p2,did_noalias_deref,patvars);
return;}case 1U: _LLB: _tmp138=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp135)->f1;_tmp139=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp135)->f2;_LLC: {struct Cyc_Absyn_Vardecl*vd=_tmp138;struct Cyc_Absyn_Pat*p2=_tmp139;
# 674
{void*_tmp155=p->topt;void*_stmttmp16=_tmp155;void*_tmp156=_stmttmp16;if(_tmp156 != 0){if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp156)->tag == 4U){_LL1F: _LL20:
# 676
 if(!did_noalias_deref)
goto _LL1E;
({struct Cyc_Warn_String_Warn_Warg_struct _tmp158=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3EC;_tmp3EC.tag=0U,({struct _fat_ptr _tmp4F2=({const char*_tmp159="pattern to array would create alias of no-alias pointer";_tag_fat(_tmp159,sizeof(char),56U);});_tmp3EC.f1=_tmp4F2;});_tmp3EC;});void*_tmp157[1U];_tmp157[0]=& _tmp158;({unsigned _tmp4F3=p->loc;Cyc_Warn_err2(_tmp4F3,_tag_fat(_tmp157,sizeof(void*),1U));});});
return;}else{goto _LL21;}}else{_LL21: _LL22:
 goto _LL1E;}_LL1E:;}
# 682
Cyc_Tcpat_check_pat_regions_rec(te,p2,did_noalias_deref,patvars);
return;}case 2U: _LLD: _tmp136=((struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp135)->f1;_tmp137=((struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp135)->f2;_LLE: {struct Cyc_Absyn_Tvar*tv=_tmp136;struct Cyc_Absyn_Vardecl*vd=_tmp137;
# 685
{struct Cyc_List_List*x=patvars;for(0;x != 0;x=x->tl){
...
if(vdopt != 0 &&*vdopt == vd){
if(eopt == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp15F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3ED;_tmp3ED.tag=0U,({struct _fat_ptr _tmp4F4=({const char*_tmp160="cannot alias pattern expression in datatype";_tag_fat(_tmp160,sizeof(char),44U);});_tmp3ED.f1=_tmp4F4;});_tmp3ED;});void*_tmp15E[1U];_tmp15E[0]=& _tmp15F;({unsigned _tmp4F5=p->loc;Cyc_Warn_err2(_tmp4F5,_tag_fat(_tmp15E,sizeof(void*),1U));});});else{
# 693
struct Cyc_Tcenv_Tenv*te2=({unsigned _tmp4F7=p->loc;struct Cyc_Tcenv_Tenv*_tmp4F6=te;Cyc_Tcenv_add_type_vars(_tmp4F7,_tmp4F6,({struct Cyc_Absyn_Tvar*_tmp162[1U];_tmp162[0]=tv;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp162,sizeof(struct Cyc_Absyn_Tvar*),1U));}));});
te2=({struct Cyc_Tcenv_Tenv*_tmp4F8=te2;Cyc_Tcenv_add_region(_tmp4F8,(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp161=_cycalloc(sizeof(*_tmp161));_tmp161->tag=2U,_tmp161->f1=tv;_tmp161;}),0,0);});
# 696
...
# 726
if(vdopt == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp169=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3EF;_tmp3EF.tag=0U,({struct _fat_ptr _tmp4F9=({const char*_tmp16C="pattern dereferences an alias-free-pointer ";_tag_fat(_tmp16C,sizeof(char),44U);});_tmp3EF.f1=_tmp4F9;});_tmp3EF;});struct Cyc_Warn_String_Warn_Warg_struct _tmp16A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3EE;_tmp3EE.tag=0U,({
struct _fat_ptr _tmp4FA=({const char*_tmp16B="from a non-unique path";_tag_fat(_tmp16B,sizeof(char),23U);});_tmp3EE.f1=_tmp4FA;});_tmp3EE;});void*_tmp168[2U];_tmp168[0]=& _tmp169,_tmp168[1]=& _tmp16A;({unsigned _tmp4FB=p->loc;Cyc_Warn_err2(_tmp4FB,_tag_fat(_tmp168,sizeof(void*),2U));});});else{
# 730
({struct Cyc_Warn_String_Warn_Warg_struct _tmp16E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3F2;_tmp3F2.tag=0U,({struct _fat_ptr _tmp4FC=({const char*_tmp172="pattern for variable ";_tag_fat(_tmp172,sizeof(char),22U);});_tmp3F2.f1=_tmp4FC;});_tmp3F2;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp16F=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp3F1;_tmp3F1.tag=1U,_tmp3F1.f1=(*vdopt)->name;_tmp3F1;});struct Cyc_Warn_String_Warn_Warg_struct _tmp170=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3F0;_tmp3F0.tag=0U,({
struct _fat_ptr _tmp4FD=({const char*_tmp171=" dereferences an alias-free-pointer from a non-unique path";_tag_fat(_tmp171,sizeof(char),59U);});_tmp3F0.f1=_tmp4FD;});_tmp3F0;});void*_tmp16D[3U];_tmp16D[0]=& _tmp16E,_tmp16D[1]=& _tmp16F,_tmp16D[2]=& _tmp170;({unsigned _tmp4FE=p->loc;Cyc_Warn_err2(_tmp4FE,_tag_fat(_tmp16D,sizeof(void*),3U));});});}}}}}}}
# 777 "tcpat.cyc"
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp180=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3F7;_tmp3F7.tag=0U,({struct _fat_ptr _tmp4FF=({const char*_tmp184="get_member_offset ";_tag_fat(_tmp184,sizeof(char),19U);});_tmp3F7.f1=_tmp4FF;});_tmp3F7;});struct Cyc_Warn_String_Warn_Warg_struct _tmp181=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3F6;_tmp3F6.tag=0U,_tmp3F6.f1=*f;_tmp3F6;});struct Cyc_Warn_String_Warn_Warg_struct _tmp182=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3F5;_tmp3F5.tag=0U,({struct _fat_ptr _tmp500=({const char*_tmp183=" failed";_tag_fat(_tmp183,sizeof(char),8U);});_tmp3F5.f1=_tmp500;});_tmp3F5;});void*_tmp17F[3U];_tmp17F[0]=& _tmp180,_tmp17F[1]=& _tmp181,_tmp17F[2]=& _tmp182;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp17F,sizeof(void*),3U));});}
# 859
...
return(void*)({struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct*_tmp188=_cycalloc(sizeof(*_tmp188));_tmp188->tag=0U,_tmp188->f1=e;_tmp188;});}}else{_LL3: _tmp186=(_tmp185.pattern).val;_LL4: {struct Cyc_Absyn_Pat*p=_tmp186;
# 863
void*_tmp189=p->r;void*_stmttmp1C=_tmp189;void*_tmp18A=_stmttmp1C;struct Cyc_List_List*_tmp18C;union Cyc_Absyn_AggrInfo _tmp18B;struct Cyc_Absyn_Datatypefield*_tmp18E;struct Cyc_Absyn_Datatypedecl*_tmp18D;struct Cyc_Absyn_Enumfield*_tmp190;void*_tmp18F;struct Cyc_Absyn_Enumfield*_tmp192;struct Cyc_Absyn_Enumdecl*_tmp191;int _tmp194;struct _fat_ptr _tmp193;char _tmp195;int _tmp197;enum Cyc_Absyn_Sign _tmp196;struct Cyc_Absyn_Pat*_tmp198;struct Cyc_Absyn_Pat*_tmp199;switch(*((int*)_tmp18A)){case 1U: _LL6: _tmp199=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp18A)->f2;_LL7: {struct Cyc_Absyn_Pat*p1=_tmp199;
_tmp198=p1;goto _LL9;}case 3U: _LL8: _tmp198=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp18A)->f2;_LL9: {struct Cyc_Absyn_Pat*p1=_tmp198;
return Cyc_Tcpat_get_pat_test(({union Cyc_Tcpat_PatOrWhere _tmp3F8;(_tmp3F8.pattern).tag=1U,(_tmp3F8.pattern).val=p1;_tmp3F8;}));}case 9U: _LLA: _LLB:
 return(void*)& Cyc_Tcpat_EqNull_val;case 10U: _LLC: _tmp196=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp18A)->f1;_tmp197=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp18A)->f2;_LLD: {enum Cyc_Absyn_Sign s=_tmp196;int i=_tmp197;
return(void*)({struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*_tmp19A=_cycalloc(sizeof(*_tmp19A));_tmp19A->tag=6U,_tmp19A->f1=(unsigned)i;_tmp19A;});}case 11U: _LLE: _tmp195=((struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp18A)->f1;_LLF: {char c=_tmp195;
return(void*)({struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*_tmp19B=_cycalloc(sizeof(*_tmp19B));_tmp19B->tag=6U,_tmp19B->f1=(unsigned)c;_tmp19B;});}case 12U: _LL10: _tmp193=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp18A)->f1;_tmp194=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp18A)->f2;_LL11: {struct _fat_ptr f=_tmp193;int i=_tmp194;
return(void*)({struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*_tmp19C=_cycalloc(sizeof(*_tmp19C));_tmp19C->tag=5U,_tmp19C->f1=f,_tmp19C->f2=i;_tmp19C;});}case 13U: _LL12: _tmp191=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp18A)->f1;_tmp192=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp18A)->f2;_LL13: {struct Cyc_Absyn_Enumdecl*ed=_tmp191;struct Cyc_Absyn_Enumfield*ef=_tmp192;
return(void*)({struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*_tmp19D=_cycalloc(sizeof(*_tmp19D));_tmp19D->tag=3U,_tmp19D->f1=ed,_tmp19D->f2=ef;_tmp19D;});}case 14U: _LL14: _tmp18F=(void*)((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp18A)->f1;_tmp190=((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp18A)->f2;_LL15: {void*t=_tmp18F;struct Cyc_Absyn_Enumfield*ef=_tmp190;
return(void*)({struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*_tmp19E=_cycalloc(sizeof(*_tmp19E));_tmp19E->tag=4U,_tmp19E->f1=t,_tmp19E->f2=ef;_tmp19E;});}case 6U: _LL16: _LL17:
# 873
 if(!Cyc_Tcutil_is_pointer_type((void*)_check_null(p->topt))|| !
Cyc_Tcutil_is_nullable_pointer_type((void*)_check_null(p->topt),0))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1A0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3F9;_tmp3F9.tag=0U,({struct _fat_ptr _tmp501=({const char*_tmp1A1="non-null pointer type or non-pointer type in pointer pattern";_tag_fat(_tmp1A1,sizeof(char),61U);});_tmp3F9.f1=_tmp501;});_tmp3F9;});void*_tmp19F[1U];_tmp19F[0]=& _tmp1A0;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp19F,sizeof(void*),1U));});
return(void*)& Cyc_Tcpat_NeqNull_val;case 8U: _LL18: _tmp18D=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp18A)->f1;_tmp18E=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp18A)->f2;_LL19: {struct Cyc_Absyn_Datatypedecl*ddecl=_tmp18D;struct Cyc_Absyn_Datatypefield*df=_tmp18E;
# 878
if(ddecl->is_extensible)
return(void*)({struct Cyc_Tcpat_EqExtensibleDatatype_Tcpat_PatTest_struct*_tmp1A2=_cycalloc(sizeof(*_tmp1A2));_tmp1A2->tag=9U,_tmp1A2->f1=ddecl,_tmp1A2->f2=df;_tmp1A2;});
return(void*)({struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*_tmp1A3=_cycalloc(sizeof(*_tmp1A3));_tmp1A3->tag=7U,({int _tmp502=(int)Cyc_Tcpat_datatype_tag_number(ddecl,df->name);_tmp1A3->f1=_tmp502;}),_tmp1A3->f2=ddecl,_tmp1A3->f3=df;_tmp1A3;});}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp18A)->f1 != 0){_LL1A: _tmp18B=*((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp18A)->f1;_tmp18C=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp18A)->f3;_LL1B: {union Cyc_Absyn_AggrInfo info=_tmp18B;struct Cyc_List_List*dlps=_tmp18C;
# 882
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1A6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FA;_tmp3FA.tag=0U,({struct _fat_ptr _tmp503=({const char*_tmp1A7="non-tagged aggregate in pattern test";_tag_fat(_tmp1A7,sizeof(char),37U);});_tmp3FA.f1=_tmp503;});_tmp3FA;});void*_tmp1A5[1U];_tmp1A5[0]=& _tmp1A6;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1A5,sizeof(void*),1U));});{
void*_tmp1A8=(void*)((struct Cyc_List_List*)_check_null((*((struct _tuple16*)((struct Cyc_List_List*)_check_null(dlps))->hd)).f1))->hd;void*_stmttmp1D=_tmp1A8;void*_tmp1A9=_stmttmp1D;struct _fat_ptr*_tmp1AA;if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp1A9)->tag == 1U){_LL1F: _tmp1AA=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp1A9)->f1;_LL20: {struct _fat_ptr*f=_tmp1AA;
return(void*)({struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*_tmp1AB=_cycalloc(sizeof(*_tmp1AB));_tmp1AB->tag=8U,_tmp1AB->f1=f,({int _tmp504=Cyc_Tcpat_get_member_offset(ad,f);_tmp1AB->f2=_tmp504;});_tmp1AB;});}}else{_LL21: _LL22:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1AD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FB;_tmp3FB.tag=0U,({struct _fat_ptr _tmp505=({const char*_tmp1AE="no field name in tagged union pattern";_tag_fat(_tmp1AE,sizeof(char),38U);});_tmp3FB.f1=_tmp505;});_tmp3FB;});void*_tmp1AC[1U];_tmp1AC[0]=& _tmp1AD;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1AC,sizeof(void*),1U));});}_LL1E:;}}}else{goto _LL1C;}default: _LL1C: _LL1D:
# 889
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1B0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FC;_tmp3FC.tag=0U,({struct _fat_ptr _tmp506=({const char*_tmp1B1="non-test pattern in pattern test";_tag_fat(_tmp1B1,sizeof(char),33U);});_tmp3FC.f1=_tmp506;});_tmp3FC;});void*_tmp1AF[1U];_tmp1AF[0]=& _tmp1B0;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1AF,sizeof(void*),1U));});}_LL5:;}}_LL0:;}
# 894
...
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1BD=_cycalloc(sizeof(*_tmp1BD));_tmp1BD->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp513=Cyc_Tcpat_null_con(p);_tmp1BD->f1=_tmp513;}),_tmp1BD->f2=0;_tmp1BD;});}
# 924
static void*Cyc_Tcpat_int_pat(int i,union Cyc_Tcpat_PatOrWhere p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1BE=_cycalloc(sizeof(*_tmp1BE));_tmp1BE->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp514=Cyc_Tcpat_int_con(i,p);_tmp1BE->f1=_tmp514;}),_tmp1BE->f2=0;_tmp1BE;});}
# 927
static void*Cyc_Tcpat_char_pat(char c,struct Cyc_Absyn_Pat*p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1BF=_cycalloc(sizeof(*_tmp1BF));_tmp1BF->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp515=Cyc_Tcpat_char_con(c,p);_tmp1BF->f1=_tmp515;}),_tmp1BF->f2=0;_tmp1BF;});}
# 930
static void*Cyc_Tcpat_float_pat(struct _fat_ptr f,struct Cyc_Absyn_Pat*p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1C0=_cycalloc(sizeof(*_tmp1C0));_tmp1C0->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp516=Cyc_Tcpat_float_con(f,p);_tmp1C0->f1=_tmp516;}),_tmp1C0->f2=0;_tmp1C0;});}
# 933
static void*Cyc_Tcpat_null_ptr_pat(void*p,struct Cyc_Absyn_Pat*p0){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1C2=_cycalloc(sizeof(*_tmp1C2));_tmp1C2->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp518=Cyc_Tcpat_null_ptr_con(p0);_tmp1C2->f1=_tmp518;}),({struct Cyc_List_List*_tmp517=({struct Cyc_List_List*_tmp1C1=_cycalloc(sizeof(*_tmp1C1));_tmp1C1->hd=p,_tmp1C1->tl=0;_tmp1C1;});_tmp1C2->f2=_tmp517;});_tmp1C2;});}
# 936
static void*Cyc_Tcpat_ptr_pat(void*p,struct Cyc_Absyn_Pat*p0){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1C4=_cycalloc(sizeof(*_tmp1C4));_tmp1C4->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp51A=Cyc_Tcpat_ptr_con(p0);_tmp1C4->f1=_tmp51A;}),({struct Cyc_List_List*_tmp519=({struct Cyc_List_List*_tmp1C3=_cycalloc(sizeof(*_tmp1C3));_tmp1C3->hd=p,_tmp1C3->tl=0;_tmp1C3;});_tmp1C4->f2=_tmp519;});_tmp1C4;});}
# 939
static void*Cyc_Tcpat_tuple_pat(struct Cyc_List_List*ss,union Cyc_Tcpat_PatOrWhere p){
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1C5=_cycalloc(sizeof(*_tmp1C5));_tmp1C5->tag=1U,({struct Cyc_Tcpat_Con_s*_tmp51C=({int _tmp51B=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ss);Cyc_Tcpat_tuple_con(_tmp51B,p);});_tmp1C5->f1=_tmp51C;}),_tmp1C5->f2=ss;_tmp1C5;});}
# 942
static void*Cyc_Tcpat_con_pat(struct _fat_ptr con_name,int*span,struct Cyc_List_List*ps,struct Cyc_Absyn_Pat*p){
# 944
struct Cyc_Tcpat_Con_s*c=({struct Cyc_Tcpat_Con_s*_tmp1C7=_cycalloc(sizeof(*_tmp1C7));({union Cyc_Tcpat_Name_value _tmp51F=Cyc_Tcpat_Name_v(con_name);_tmp1C7->name=_tmp51F;}),({int _tmp51E=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ps);_tmp1C7->arity=_tmp51E;}),_tmp1C7->span=span,({union Cyc_Tcpat_PatOrWhere _tmp51D=Cyc_Tcpat_pw(p);_tmp1C7->orig_pat=_tmp51D;});_tmp1C7;});
return(void*)({struct Cyc_Tcpat_Con_Tcpat_Simple_pat_struct*_tmp1C6=_cycalloc(sizeof(*_tmp1C6));_tmp1C6->tag=1U,_tmp1C6->f1=c,_tmp1C6->f2=ps;_tmp1C6;});}
# 949
static void*Cyc_Tcpat_compile_pat(struct Cyc_Absyn_Pat*p){
void*s;
{void*_tmp1C8=p->r;void*_stmttmp1E=_tmp1C8;void*_tmp1C9=_stmttmp1E;struct Cyc_Absyn_Enumfield*_tmp1CA;struct Cyc_Absyn_Enumfield*_tmp1CB;struct Cyc_List_List*_tmp1CD;struct Cyc_Absyn_Aggrdecl*_tmp1CC;struct Cyc_List_List*_tmp1CE;struct Cyc_List_List*_tmp1D1;struct Cyc_Absyn_Datatypefield*_tmp1D0;struct Cyc_Absyn_Datatypedecl*_tmp1CF;struct Cyc_Absyn_Pat*_tmp1D2;struct Cyc_Absyn_Pat*_tmp1D3;struct Cyc_Absyn_Pat*_tmp1D4;struct _fat_ptr _tmp1D5;char _tmp1D6;int _tmp1D8;enum Cyc_Absyn_Sign _tmp1D7;switch(*((int*)_tmp1C9)){case 0U: _LL1: _LL2:
 goto _LL4;case 2U: _LL3: _LL4:
 goto _LL6;case 4U: _LL5: _LL6:
 s=(void*)({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp1D9=_cycalloc(sizeof(*_tmp1D9));_tmp1D9->tag=0U;_tmp1D9;});goto _LL0;case 9U: _LL7: _LL8:
 s=Cyc_Tcpat_null_pat(p);goto _LL0;case 10U: _LL9: _tmp1D7=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1C9)->f1;_tmp1D8=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1C9)->f2;_LLA: {enum Cyc_Absyn_Sign sn=_tmp1D7;int i=_tmp1D8;
s=({int _tmp520=i;Cyc_Tcpat_int_pat(_tmp520,Cyc_Tcpat_pw(p));});goto _LL0;}case 11U: _LLB: _tmp1D6=((struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp1C9)->f1;_LLC: {char c=_tmp1D6;
s=Cyc_Tcpat_char_pat(c,p);goto _LL0;}case 12U: _LLD: _tmp1D5=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp1C9)->f1;_LLE: {struct _fat_ptr f=_tmp1D5;
s=Cyc_Tcpat_float_pat(f,p);goto _LL0;}case 1U: _LLF: _tmp1D4=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp1C9)->f2;_LL10: {struct Cyc_Absyn_Pat*p2=_tmp1D4;
s=Cyc_Tcpat_compile_pat(p2);goto _LL0;}case 3U: _LL11: _tmp1D3=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1C9)->f2;_LL12: {struct Cyc_Absyn_Pat*p2=_tmp1D3;
s=Cyc_Tcpat_compile_pat(p2);goto _LL0;}case 6U: _LL13: _tmp1D2=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp1C9)->f1;_LL14: {struct Cyc_Absyn_Pat*pp=_tmp1D2;
# 962
{void*_tmp1DA=Cyc_Absyn_compress((void*)_check_null(p->topt));void*_stmttmp1F=_tmp1DA;void*_tmp1DB=_stmttmp1F;void*_tmp1DC;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1DB)->tag == 3U){_LL28: _tmp1DC=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1DB)->f1).ptr_atts).nullable;_LL29: {void*n=_tmp1DC;
# 964
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1DE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FE;_tmp3FE.tag=0U,({struct _fat_ptr _tmp521=({const char*_tmp1DF="expecting pointertype for pattern!";_tag_fat(_tmp1DF,sizeof(char),35U);});_tmp3FE.f1=_tmp521;});_tmp3FE;});void*_tmp1DD[1U];_tmp1DD[0]=& _tmp1DE;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1DD,sizeof(void*),1U));});}_LL27:;}
# 970
goto _LL0;}case 8U: _LL15: _tmp1CF=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp1C9)->f1;_tmp1D0=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp1C9)->f2;_tmp1D1=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp1C9)->f3;_LL16: {struct Cyc_Absyn_Datatypedecl*tud=_tmp1CF;struct Cyc_Absyn_Datatypefield*tuf=_tmp1D0;struct Cyc_List_List*ps=_tmp1D1;
# 972
int*span;
{void*_tmp1E0=Cyc_Absyn_compress((void*)_check_null(p->topt));void*_stmttmp20=_tmp1E0;void*_tmp1E1=_stmttmp20;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1E1)->tag == 0U)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1E1)->f1)){case 18U: _LL2D: _LL2E:
# 975
 span=tud->is_extensible?0:({int*_tmp1E2=_cycalloc_atomic(sizeof(*_tmp1E2));({int _tmp522=((int(*)(struct Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(tud->fields))->v);*_tmp1E2=_tmp522;});_tmp1E2;});
goto _LL2C;case 19U: _LL2F: _LL30:
 span=& Cyc_Tcpat_one_opt;goto _LL2C;default: goto _LL31;}else{_LL31: _LL32:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1E4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FF;_tmp3FF.tag=0U,({struct _fat_ptr _tmp523=({const char*_tmp1E5="void datatype pattern has bad type";_tag_fat(_tmp1E5,sizeof(char),35U);});_tmp3FF.f1=_tmp523;});_tmp3FF;});void*_tmp1E3[1U];_tmp1E3[0]=& _tmp1E4;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1E3,sizeof(void*),1U));});}_LL2C:;}
# 980
s=({struct _fat_ptr _tmp526=*(*tuf->name).f2;int*_tmp525=span;struct Cyc_List_List*_tmp524=((struct Cyc_List_List*(*)(void*(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_compile_pat,ps);Cyc_Tcpat_con_pat(_tmp526,_tmp525,_tmp524,p);});
goto _LL0;}case 5U: _LL17: _tmp1CE=((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp1C9)->f1;_LL18: {struct Cyc_List_List*ps=_tmp1CE;
# 983
s=({struct Cyc_List_List*_tmp527=((struct Cyc_List_List*(*)(void*(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_compile_pat,ps);Cyc_Tcpat_tuple_pat(_tmp527,Cyc_Tcpat_pw(p));});goto _LL0;}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C9)->f1 != 0){if((((union Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C9)->f1)->KnownAggr).tag == 2){_LL19: _tmp1CC=*((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C9)->f1)->KnownAggr).val;_tmp1CD=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C9)->f3;_LL1A: {struct Cyc_Absyn_Aggrdecl*ad=_tmp1CC;struct Cyc_List_List*dlps=_tmp1CD;
# 988
...
struct Cyc_List_List*_tmp1EA=dl;struct _fat_ptr*_tmp1EB;if(_tmp1EA != 0){if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)((struct Cyc_List_List*)_tmp1EA)->hd)->tag == 1U){if(((struct Cyc_List_List*)_tmp1EA)->tl == 0){_LL37: _tmp1EB=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp1EA->hd)->f1;_LL38: {struct _fat_ptr*f=_tmp1EB;
# 997
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1EE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp400;_tmp400.tag=0U,({struct _fat_ptr _tmp52A=({const char*_tmp1EF="bad designator(s)";_tag_fat(_tmp1EF,sizeof(char),18U);});_tmp400.f1=_tmp52A;});_tmp400;});void*_tmp1ED[1U];_tmp1ED[0]=& _tmp1EE;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1ED,sizeof(void*),1U));});}_LL36:;}}}
# 1005
if(!found)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1F1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp401;_tmp401.tag=0U,({struct _fat_ptr _tmp52B=({const char*_tmp1F2="bad designator";_tag_fat(_tmp1F2,sizeof(char),15U);});_tmp401.f1=_tmp52B;});_tmp401;});void*_tmp1F0[1U];_tmp1F0[0]=& _tmp1F1;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1F0,sizeof(void*),1U));});}}
# 1008
s=({struct Cyc_List_List*_tmp52C=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(ps);Cyc_Tcpat_tuple_pat(_tmp52C,Cyc_Tcpat_pw(p));});}else{
# 1011
if(!((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->tagged)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1F5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp402;_tmp402.tag=0U,({struct _fat_ptr _tmp52D=({const char*_tmp1F6="patterns on untagged unions not yet supported.";_tag_fat(_tmp1F6,sizeof(char),47U);});_tmp402.f1=_tmp52D;});_tmp402;});void*_tmp1F4[1U];_tmp1F4[0]=& _tmp1F5;({unsigned _tmp52E=p->loc;Cyc_Warn_err2(_tmp52E,_tag_fat(_tmp1F4,sizeof(void*),1U));});});{
int*span=({int*_tmp1FE=_cycalloc_atomic(sizeof(*_tmp1FE));({int _tmp52F=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->fields);*_tmp1FE=_tmp52F;});_tmp1FE;});
struct Cyc_List_List*_tmp1F7=dlps;struct Cyc_Absyn_Pat*_tmp1F9;struct _fat_ptr*_tmp1F8;if(_tmp1F7 != 0){if(((struct _tuple16*)((struct Cyc_List_List*)_tmp1F7)->hd)->f1 != 0){if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)((struct Cyc_List_List*)((struct _tuple16*)((struct Cyc_List_List*)_tmp1F7)->hd)->f1)->hd)->tag == 1U){if(((struct Cyc_List_List*)((struct _tuple16*)((struct Cyc_List_List*)_tmp1F7)->hd)->f1)->tl == 0){if(((struct Cyc_List_List*)_tmp1F7)->tl == 0){_LL3C: _tmp1F8=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)(((struct _tuple16*)_tmp1F7->hd)->f1)->hd)->f1;_tmp1F9=((struct _tuple16*)_tmp1F7->hd)->f2;_LL3D: {struct _fat_ptr*f=_tmp1F8;struct Cyc_Absyn_Pat*p2=_tmp1F9;
# 1016
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1FC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp403;_tmp403.tag=0U,({struct _fat_ptr _tmp534=({const char*_tmp1FD="bad union pattern";_tag_fat(_tmp1FD,sizeof(char),18U);});_tmp403.f1=_tmp534;});_tmp403;});void*_tmp1FB[1U];_tmp1FB[0]=& _tmp1FC;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1FB,sizeof(void*),1U));});}_LL3B:;}}
# 1021
goto _LL0;}}else{goto _LL23;}}else{_LL23: _LL24:
# 1033
 goto _LL26;}case 13U: _LL1B: _tmp1CB=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp1C9)->f2;_LL1C: {struct Cyc_Absyn_Enumfield*ef=_tmp1CB;
# 1028
_tmp1CA=ef;goto _LL1E;}case 14U: _LL1D: _tmp1CA=((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp1C9)->f2;_LL1E: {struct Cyc_Absyn_Enumfield*ef=_tmp1CA;
...
# 1034
 s=(void*)({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp1FF=_cycalloc(sizeof(*_tmp1FF));_tmp1FF->tag=0U;_tmp1FF;});}_LL0:;}
# 1036
...
struct _tuple0 _tmp200=({struct _tuple0 _tmp404;_tmp404.f1=a1,_tmp404.f2=a2;_tmp404;});struct _tuple0 _stmttmp22=_tmp200;struct _tuple0 _tmp201=_stmttmp22;struct _fat_ptr*_tmp205;int _tmp204;struct _fat_ptr*_tmp203;int _tmp202;unsigned _tmp209;struct Cyc_Absyn_Datatypefield*_tmp208;unsigned _tmp207;struct Cyc_Absyn_Datatypefield*_tmp206;unsigned _tmp20B;unsigned _tmp20A;switch(*((int*)_tmp201.f1)){case 0U: if(((struct Cyc_Tcpat_Dummy_Tcpat_Access_struct*)_tmp201.f2)->tag == 0U){_LL1: _LL2:
 return 1;}else{goto _LLB;}case 1U: if(((struct Cyc_Tcpat_Deref_Tcpat_Access_struct*)_tmp201.f2)->tag == 1U){_LL3: _LL4:
 return 1;}else{goto _LLB;}case 2U: if(((struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*)_tmp201.f2)->tag == 2U){_LL5: _tmp20A=((struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*)_tmp201.f1)->f1;_tmp20B=((struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*)_tmp201.f2)->f1;_LL6: {unsigned i1=_tmp20A;unsigned i2=_tmp20B;
return i1 == i2;}}else{goto _LLB;}case 3U: if(((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp201.f2)->tag == 3U){_LL7: _tmp206=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp201.f1)->f2;_tmp207=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp201.f1)->f3;_tmp208=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp201.f2)->f2;_tmp209=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp201.f2)->f3;_LL8: {struct Cyc_Absyn_Datatypefield*df1=_tmp206;unsigned i1=_tmp207;struct Cyc_Absyn_Datatypefield*df2=_tmp208;unsigned i2=_tmp209;
# 1067
return df1 == df2 && i1 == i2;}}else{goto _LLB;}default: if(((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp201.f2)->tag == 4U){_LL9: _tmp202=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp201.f1)->f1;_tmp203=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp201.f1)->f2;_tmp204=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp201.f2)->f1;_tmp205=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp201.f2)->f2;_LLA: {int b1=_tmp202;struct _fat_ptr*f1=_tmp203;int b2=_tmp204;struct _fat_ptr*f2=_tmp205;
# 1069
...
void*_tmp20D=d2;void*_tmp210;struct Cyc_List_List*_tmp20F;struct Cyc_List_List*_tmp20E;if(((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp20D)->tag == 2U){_LL1: _tmp20E=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp20D)->f1;_tmp20F=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp20D)->f2;_tmp210=(void*)((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp20D)->f3;_LL2: {struct Cyc_List_List*access2=_tmp20E;struct Cyc_List_List*switch_clauses=_tmp20F;void*default_decision=_tmp210;
# 1085
if(Cyc_Tcpat_same_path(access,access2)&&(int)(((con->orig_pat).pattern).tag == 1))
return(void*)({struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*_tmp213=_cycalloc(sizeof(*_tmp213));_tmp213->tag=2U,_tmp213->f1=access2,({
...
goto _LL4;}}else{_LL3: _LL4:
 return(void*)({struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*_tmp216=_cycalloc(sizeof(*_tmp216));_tmp216->tag=2U,_tmp216->f1=access,({struct Cyc_List_List*_tmp538=({struct Cyc_List_List*_tmp215=_cycalloc(sizeof(*_tmp215));({struct _tuple0*_tmp537=({struct _tuple0*_tmp214=_cycalloc(sizeof(*_tmp214));_tmp214->f1=test,_tmp214->f2=d1;_tmp214;});_tmp215->hd=_tmp537;}),_tmp215->tl=0;_tmp215;});_tmp216->f2=_tmp538;}),_tmp216->f3=d2;_tmp216;});}_LL0:;}struct _tuple21{struct Cyc_List_List*f1;struct Cyc_List_List*f2;struct Cyc_List_List*f3;};
# 1102
enum Cyc_Tcpat_Answer{Cyc_Tcpat_Yes =0U,Cyc_Tcpat_No =1U,Cyc_Tcpat_Maybe =2U};
# 1105
static void Cyc_Tcpat_print_tab(int i){
for(0;i != 0;-- i){
({void*_tmp217=0U;({struct Cyc___cycFILE*_tmp53A=Cyc_stderr;struct _fat_ptr _tmp539=({const char*_tmp218=" ";_tag_fat(_tmp218,sizeof(char),2U);});Cyc_fprintf(_tmp53A,_tmp539,_tag_fat(_tmp217,sizeof(void*),0U));});});}}
# 1109
...
({struct Cyc_String_pa_PrintArg_struct _tmp21F=({struct Cyc_String_pa_PrintArg_struct _tmp405;_tmp405.tag=0U,_tmp405.f1=(struct _fat_ptr)((struct _fat_ptr)s);_tmp405;});void*_tmp21D[1U];_tmp21D[0]=& _tmp21F;({struct Cyc___cycFILE*_tmp53C=Cyc_stderr;struct _fat_ptr _tmp53B=({const char*_tmp21E="%s";_tag_fat(_tmp21E,sizeof(char),3U);});Cyc_fprintf(_tmp53C,_tmp53B,_tag_fat(_tmp21D,sizeof(void*),1U));});});goto _LL0;}}else{_LL3: _tmp21B=(_tmp21A.Int_v).val;_LL4: {int i=_tmp21B;
({struct Cyc_Int_pa_PrintArg_struct _tmp222=({struct Cyc_Int_pa_PrintArg_struct _tmp406;_tmp406.tag=1U,_tmp406.f1=(unsigned long)i;_tmp406;});void*_tmp220[1U];_tmp220[0]=& _tmp222;({struct Cyc___cycFILE*_tmp53E=Cyc_stderr;struct _fat_ptr _tmp53D=({const char*_tmp221="%d";_tag_fat(_tmp221,sizeof(char),3U);});Cyc_fprintf(_tmp53E,_tmp53D,_tag_fat(_tmp220,sizeof(void*),1U));});});goto _LL0;}}_LL0:;}
# 1116
static void Cyc_Tcpat_print_access(void*a){
void*_tmp223=a;struct _fat_ptr*_tmp225;int _tmp224;unsigned _tmp227;struct Cyc_Absyn_Datatypefield*_tmp226;unsigned _tmp228;switch(*((int*)_tmp223)){case 0U: _LL1: _LL2:
({void*_tmp229=0U;({struct Cyc___cycFILE*_tmp540=Cyc_stderr;struct _fat_ptr _tmp53F=({const char*_tmp22A="DUMMY";_tag_fat(_tmp22A,sizeof(char),6U);});Cyc_fprintf(_tmp540,_tmp53F,_tag_fat(_tmp229,sizeof(void*),0U));});});goto _LL0;case 1U: _LL3: _LL4:
({void*_tmp22B=0U;({struct Cyc___cycFILE*_tmp542=Cyc_stderr;struct _fat_ptr _tmp541=({const char*_tmp22C="*";_tag_fat(_tmp22C,sizeof(char),2U);});Cyc_fprintf(_tmp542,_tmp541,_tag_fat(_tmp22B,sizeof(void*),0U));});});goto _LL0;case 2U: _LL5: _tmp228=((struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*)_tmp223)->f1;_LL6: {unsigned i=_tmp228;
({struct Cyc_Int_pa_PrintArg_struct _tmp22F=({struct Cyc_Int_pa_PrintArg_struct _tmp407;_tmp407.tag=1U,_tmp407.f1=(unsigned long)((int)i);_tmp407;});void*_tmp22D[1U];_tmp22D[0]=& _tmp22F;({struct Cyc___cycFILE*_tmp544=Cyc_stderr;struct _fat_ptr _tmp543=({const char*_tmp22E="[%d]";_tag_fat(_tmp22E,sizeof(char),5U);});Cyc_fprintf(_tmp544,_tmp543,_tag_fat(_tmp22D,sizeof(void*),1U));});});goto _LL0;}case 3U: _LL7: _tmp226=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp223)->f2;_tmp227=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_tmp223)->f3;_LL8: {struct Cyc_Absyn_Datatypefield*f=_tmp226;unsigned i=_tmp227;
# 1122
({struct Cyc_String_pa_PrintArg_struct _tmp232=({struct Cyc_String_pa_PrintArg_struct _tmp409;_tmp409.tag=0U,({struct _fat_ptr _tmp545=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(f->name));_tmp409.f1=_tmp545;});_tmp409;});struct Cyc_Int_pa_PrintArg_struct _tmp233=({struct Cyc_Int_pa_PrintArg_struct _tmp408;_tmp408.tag=1U,_tmp408.f1=(unsigned long)((int)i);_tmp408;});void*_tmp230[2U];_tmp230[0]=& _tmp232,_tmp230[1]=& _tmp233;({struct Cyc___cycFILE*_tmp547=Cyc_stderr;struct _fat_ptr _tmp546=({const char*_tmp231="%s[%d]";_tag_fat(_tmp231,sizeof(char),7U);});Cyc_fprintf(_tmp547,_tmp546,_tag_fat(_tmp230,sizeof(void*),2U));});});goto _LL0;}default: _LL9: _tmp224=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp223)->f1;_tmp225=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp223)->f2;_LLA: {int tagged=_tmp224;struct _fat_ptr*f=_tmp225;
# 1124
if(tagged)
({void*_tmp234=0U;({struct Cyc___cycFILE*_tmp549=Cyc_stderr;struct _fat_ptr _tmp548=({const char*_tmp235=".tagunion";_tag_fat(_tmp235,sizeof(char),10U);});Cyc_fprintf(_tmp549,_tmp548,_tag_fat(_tmp234,sizeof(void*),0U));});});
({struct Cyc_String_pa_PrintArg_struct _tmp238=({struct Cyc_String_pa_PrintArg_struct _tmp40A;_tmp40A.tag=0U,_tmp40A.f1=(struct _fat_ptr)((struct _fat_ptr)*f);_tmp40A;});void*_tmp236[1U];_tmp236[0]=& _tmp238;({struct Cyc___cycFILE*_tmp54B=Cyc_stderr;struct _fat_ptr _tmp54A=({const char*_tmp237=".%s";_tag_fat(_tmp237,sizeof(char),4U);});Cyc_fprintf(_tmp54B,_tmp54A,_tag_fat(_tmp236,sizeof(void*),1U));});});
goto _LL0;}}_LL0:;}
# 1131
static void Cyc_Tcpat_print_pat_test(void*p){
void*_tmp239=p;struct Cyc_Absyn_Datatypefield*_tmp23A;int _tmp23C;struct _fat_ptr*_tmp23B;int _tmp23D;unsigned _tmp23E;struct _fat_ptr _tmp23F;struct Cyc_Absyn_Enumfield*_tmp240;struct Cyc_Absyn_Enumfield*_tmp241;struct Cyc_Absyn_Exp*_tmp242;switch(*((int*)_tmp239)){case 0U: if(((struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct*)_tmp239)->f1 == 0){_LL1: _LL2:
({void*_tmp243=0U;({struct Cyc___cycFILE*_tmp54D=Cyc_stderr;struct _fat_ptr _tmp54C=({const char*_tmp244="where(NULL)";_tag_fat(_tmp244,sizeof(char),12U);});Cyc_fprintf(_tmp54D,_tmp54C,_tag_fat(_tmp243,sizeof(void*),0U));});});goto _LL0;}else{_LL3: _tmp242=((struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct*)_tmp239)->f1;_LL4: {struct Cyc_Absyn_Exp*e=_tmp242;
({struct Cyc_String_pa_PrintArg_struct _tmp247=({struct Cyc_String_pa_PrintArg_struct _tmp40B;_tmp40B.tag=0U,({struct _fat_ptr _tmp54E=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string((struct Cyc_Absyn_Exp*)_check_null(e)));_tmp40B.f1=_tmp54E;});_tmp40B;});void*_tmp245[1U];_tmp245[0]=& _tmp247;({struct Cyc___cycFILE*_tmp550=Cyc_stderr;struct _fat_ptr _tmp54F=({const char*_tmp246="where(%s)";_tag_fat(_tmp246,sizeof(char),10U);});Cyc_fprintf(_tmp550,_tmp54F,_tag_fat(_tmp245,sizeof(void*),1U));});});goto _LL0;}}case 1U: _LL5: _LL6:
({void*_tmp248=0U;({struct Cyc___cycFILE*_tmp552=Cyc_stderr;struct _fat_ptr _tmp551=({const char*_tmp249="NULL";_tag_fat(_tmp249,sizeof(char),5U);});Cyc_fprintf(_tmp552,_tmp551,_tag_fat(_tmp248,sizeof(void*),0U));});});goto _LL0;case 2U: _LL7: _LL8:
({void*_tmp24A=0U;({struct Cyc___cycFILE*_tmp554=Cyc_stderr;struct _fat_ptr _tmp553=({const char*_tmp24B="NOT-NULL:";_tag_fat(_tmp24B,sizeof(char),10U);});Cyc_fprintf(_tmp554,_tmp553,_tag_fat(_tmp24A,sizeof(void*),0U));});});goto _LL0;case 4U: _LL9: _tmp241=((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp239)->f2;_LLA: {struct Cyc_Absyn_Enumfield*ef=_tmp241;
_tmp240=ef;goto _LLC;}case 3U: _LLB: _tmp240=((struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*)_tmp239)->f2;_LLC: {struct Cyc_Absyn_Enumfield*ef=_tmp240;
({struct Cyc_String_pa_PrintArg_struct _tmp24E=({struct Cyc_String_pa_PrintArg_struct _tmp40C;_tmp40C.tag=0U,({struct _fat_ptr _tmp555=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(ef->name));_tmp40C.f1=_tmp555;});_tmp40C;});void*_tmp24C[1U];_tmp24C[0]=& _tmp24E;({struct Cyc___cycFILE*_tmp557=Cyc_stderr;struct _fat_ptr _tmp556=({const char*_tmp24D="%s";_tag_fat(_tmp24D,sizeof(char),3U);});Cyc_fprintf(_tmp557,_tmp556,_tag_fat(_tmp24C,sizeof(void*),1U));});});goto _LL0;}case 5U: _LLD: _tmp23F=((struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*)_tmp239)->f1;_LLE: {struct _fat_ptr s=_tmp23F;
({struct Cyc_String_pa_PrintArg_struct _tmp251=({struct Cyc_String_pa_PrintArg_struct _tmp40D;_tmp40D.tag=0U,_tmp40D.f1=(struct _fat_ptr)((struct _fat_ptr)s);_tmp40D;});void*_tmp24F[1U];_tmp24F[0]=& _tmp251;({struct Cyc___cycFILE*_tmp559=Cyc_stderr;struct _fat_ptr _tmp558=({const char*_tmp250="%s";_tag_fat(_tmp250,sizeof(char),3U);});Cyc_fprintf(_tmp559,_tmp558,_tag_fat(_tmp24F,sizeof(void*),1U));});});goto _LL0;}case 6U: _LLF: _tmp23E=((struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*)_tmp239)->f1;_LL10: {unsigned i=_tmp23E;
({struct Cyc_Int_pa_PrintArg_struct _tmp254=({struct Cyc_Int_pa_PrintArg_struct _tmp40E;_tmp40E.tag=1U,_tmp40E.f1=(unsigned long)((int)i);_tmp40E;});void*_tmp252[1U];_tmp252[0]=& _tmp254;({struct Cyc___cycFILE*_tmp55B=Cyc_stderr;struct _fat_ptr _tmp55A=({const char*_tmp253="%d";_tag_fat(_tmp253,sizeof(char),3U);});Cyc_fprintf(_tmp55B,_tmp55A,_tag_fat(_tmp252,sizeof(void*),1U));});});goto _LL0;}case 7U: _LL11: _tmp23D=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp239)->f1;_LL12: {int i=_tmp23D;
({struct Cyc_Int_pa_PrintArg_struct _tmp257=({struct Cyc_Int_pa_PrintArg_struct _tmp40F;_tmp40F.tag=1U,_tmp40F.f1=(unsigned long)i;_tmp40F;});void*_tmp255[1U];_tmp255[0]=& _tmp257;({struct Cyc___cycFILE*_tmp55D=Cyc_stderr;struct _fat_ptr _tmp55C=({const char*_tmp256="datatypetag(%d)";_tag_fat(_tmp256,sizeof(char),16U);});Cyc_fprintf(_tmp55D,_tmp55C,_tag_fat(_tmp255,sizeof(void*),1U));});});goto _LL0;}case 8U: _LL13: _tmp23B=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp239)->f1;_tmp23C=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp239)->f2;_LL14: {struct _fat_ptr*f=_tmp23B;int i=_tmp23C;
({struct Cyc_String_pa_PrintArg_struct _tmp25A=({struct Cyc_String_pa_PrintArg_struct _tmp411;_tmp411.tag=0U,_tmp411.f1=(struct _fat_ptr)((struct _fat_ptr)*f);_tmp411;});struct Cyc_Int_pa_PrintArg_struct _tmp25B=({struct Cyc_Int_pa_PrintArg_struct _tmp410;_tmp410.tag=1U,_tmp410.f1=(unsigned long)i;_tmp410;});void*_tmp258[2U];_tmp258[0]=& _tmp25A,_tmp258[1]=& _tmp25B;({struct Cyc___cycFILE*_tmp55F=Cyc_stderr;struct _fat_ptr _tmp55E=({const char*_tmp259="uniontag[%s](%d)";_tag_fat(_tmp259,sizeof(char),17U);});Cyc_fprintf(_tmp55F,_tmp55E,_tag_fat(_tmp258,sizeof(void*),2U));});});goto _LL0;}default: _LL15: _tmp23A=((struct Cyc_Tcpat_EqExtensibleDatatype_Tcpat_PatTest_struct*)_tmp239)->f2;_LL16: {struct Cyc_Absyn_Datatypefield*f=_tmp23A;
# 1144
({struct Cyc_String_pa_PrintArg_struct _tmp25E=({struct Cyc_String_pa_PrintArg_struct _tmp412;_tmp412.tag=0U,({struct _fat_ptr _tmp560=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(f->name));_tmp412.f1=_tmp560;});_tmp412;});void*_tmp25C[1U];_tmp25C[0]=& _tmp25E;({struct Cyc___cycFILE*_tmp562=Cyc_stderr;struct _fat_ptr _tmp561=({const char*_tmp25D="datatypefield(%s)";_tag_fat(_tmp25D,sizeof(char),18U);});Cyc_fprintf(_tmp562,_tmp561,_tag_fat(_tmp25C,sizeof(void*),1U));});});}}_LL0:;}
# 1148
static void Cyc_Tcpat_print_rhs(struct Cyc_Tcpat_Rhs*r){
({struct Cyc_String_pa_PrintArg_struct _tmp261=({struct Cyc_String_pa_PrintArg_struct _tmp413;_tmp413.tag=0U,({struct _fat_ptr _tmp563=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_stmt2string(r->rhs));_tmp413.f1=_tmp563;});_tmp413;});void*_tmp25F[1U];_tmp25F[0]=& _tmp261;({struct Cyc___cycFILE*_tmp565=Cyc_stderr;struct _fat_ptr _tmp564=({const char*_tmp260="%s";_tag_fat(_tmp260,sizeof(char),3U);});Cyc_fprintf(_tmp565,_tmp564,_tag_fat(_tmp25F,sizeof(void*),1U));});});}
# 1152
static void Cyc_Tcpat_print_dec_tree(void*d,int tab){
void*_tmp262=d;void*_tmp265;struct Cyc_List_List*_tmp264;struct Cyc_List_List*_tmp263;struct Cyc_Tcpat_Rhs*_tmp266;switch(*((int*)_tmp262)){case 1U: _LL1: _tmp266=((struct Cyc_Tcpat_Success_Tcpat_Decision_struct*)_tmp262)->f1;_LL2: {struct Cyc_Tcpat_Rhs*rhs=_tmp266;
# 1155
Cyc_Tcpat_print_tab(tab);
({void*_tmp267=0U;({struct Cyc___cycFILE*_tmp567=Cyc_stderr;struct _fat_ptr _tmp566=({const char*_tmp268="Success(";_tag_fat(_tmp268,sizeof(char),9U);});Cyc_fprintf(_tmp567,_tmp566,_tag_fat(_tmp267,sizeof(void*),0U));});});Cyc_Tcpat_print_rhs(rhs);({void*_tmp269=0U;({struct Cyc___cycFILE*_tmp569=Cyc_stderr;struct _fat_ptr _tmp568=({const char*_tmp26A=")\n";_tag_fat(_tmp26A,sizeof(char),3U);});Cyc_fprintf(_tmp569,_tmp568,_tag_fat(_tmp269,sizeof(void*),0U));});});
goto _LL0;}case 0U: _LL3: _LL4:
({void*_tmp26B=0U;({struct Cyc___cycFILE*_tmp56B=Cyc_stderr;struct _fat_ptr _tmp56A=({const char*_tmp26C="Failure\n";_tag_fat(_tmp26C,sizeof(char),9U);});Cyc_fprintf(_tmp56B,_tmp56A,_tag_fat(_tmp26B,sizeof(void*),0U));});});goto _LL0;default: _LL5: _tmp263=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp262)->f1;_tmp264=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp262)->f2;_tmp265=(void*)((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp262)->f3;_LL6: {struct Cyc_List_List*a=_tmp263;struct Cyc_List_List*cases=_tmp264;void*def=_tmp265;
# 1160
Cyc_Tcpat_print_tab(tab);
({void*_tmp26D=0U;({struct Cyc___cycFILE*_tmp56D=Cyc_stderr;struct _fat_ptr _tmp56C=({const char*_tmp26E="Switch[";_tag_fat(_tmp26E,sizeof(char),8U);});Cyc_fprintf(_tmp56D,_tmp56C,_tag_fat(_tmp26D,sizeof(void*),0U));});});
for(0;a != 0;a=a->tl){
Cyc_Tcpat_print_access(((struct Cyc_Tcpat_PathNode*)a->hd)->access);
if(a->tl != 0)({void*_tmp26F=0U;({struct Cyc___cycFILE*_tmp56F=Cyc_stderr;struct _fat_ptr _tmp56E=({const char*_tmp270=",";_tag_fat(_tmp270,sizeof(char),2U);});Cyc_fprintf(_tmp56F,_tmp56E,_tag_fat(_tmp26F,sizeof(void*),0U));});});}
# 1166
({void*_tmp271=0U;({struct Cyc___cycFILE*_tmp571=Cyc_stderr;struct _fat_ptr _tmp570=({const char*_tmp272="] {\n";_tag_fat(_tmp272,sizeof(char),5U);});Cyc_fprintf(_tmp571,_tmp570,_tag_fat(_tmp271,sizeof(void*),0U));});});
...
Cyc_Tcpat_print_tab(tab);
({void*_tmp277=0U;({struct Cyc___cycFILE*_tmp573=Cyc_stderr;struct _fat_ptr _tmp572=({const char*_tmp278="case ";_tag_fat(_tmp278,sizeof(char),6U);});Cyc_fprintf(_tmp573,_tmp572,_tag_fat(_tmp277,sizeof(void*),0U));});});
Cyc_Tcpat_print_pat_test(pt);
({void*_tmp279=0U;({struct Cyc___cycFILE*_tmp575=Cyc_stderr;struct _fat_ptr _tmp574=({const char*_tmp27A=":\n";_tag_fat(_tmp27A,sizeof(char),3U);});Cyc_fprintf(_tmp575,_tmp574,_tag_fat(_tmp279,sizeof(void*),0U));});});
Cyc_Tcpat_print_dec_tree(d,tab + 7);}}
# 1175
Cyc_Tcpat_print_tab(tab);
({void*_tmp27B=0U;({struct Cyc___cycFILE*_tmp577=Cyc_stderr;struct _fat_ptr _tmp576=({const char*_tmp27C="default:\n";_tag_fat(_tmp27C,sizeof(char),10U);});Cyc_fprintf(_tmp577,_tmp576,_tag_fat(_tmp27B,sizeof(void*),0U));});});
Cyc_Tcpat_print_dec_tree(def,tab + 7);
Cyc_Tcpat_print_tab(tab);
({void*_tmp27D=0U;({struct Cyc___cycFILE*_tmp579=Cyc_stderr;struct _fat_ptr _tmp578=({const char*_tmp27E="}\n";_tag_fat(_tmp27E,sizeof(char),3U);});Cyc_fprintf(_tmp579,_tmp578,_tag_fat(_tmp27D,sizeof(void*),0U));});});}}_LL0:;}
# 1183
...
void*_tmp27F=td;struct Cyc_Set_Set*_tmp280;if(((struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)_tmp27F)->tag == 1U){_LL1: _tmp280=((struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)_tmp27F)->f1;_LL2: {struct Cyc_Set_Set*cs=_tmp280;
# 1201
return(void*)({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp281=_cycalloc(sizeof(*_tmp281));_tmp281->tag=1U,({struct Cyc_Set_Set*_tmp57A=((struct Cyc_Set_Set*(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_insert)(cs,c);_tmp281->f1=_tmp57A;});_tmp281;});}}else{_LL3: _LL4:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp283=({struct Cyc_Warn_String_Warn_Warg_struct _tmp414;_tmp414.tag=0U,({struct _fat_ptr _tmp57B=({const char*_tmp284="add_neg called when td is Positive";_tag_fat(_tmp284,sizeof(char),35U);});_tmp414.f1=_tmp57B;});_tmp414;});void*_tmp282[1U];_tmp282[0]=& _tmp283;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp282,sizeof(void*),1U));});}_LL0:;}
# 1208
static enum Cyc_Tcpat_Answer Cyc_Tcpat_static_match(struct Cyc_Tcpat_Con_s*c,void*td){
void*_tmp285=td;struct Cyc_Set_Set*_tmp286;struct Cyc_Tcpat_Con_s*_tmp287;if(((struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp285)->tag == 0U){_LL1: _tmp287=((struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp285)->f1;_LL2: {struct Cyc_Tcpat_Con_s*c2=_tmp287;
# 1212
...
# 1218
if(c->span != 0 &&({int _tmp57C=*((int*)_check_null(c->span));_tmp57C == ((int(*)(struct Cyc_Set_Set*s))Cyc_Set_cardinality)(cs)+ 1;}))
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp294=({struct Cyc_Warn_String_Warn_Warg_struct _tmp415;_tmp415.tag=0U,({struct _fat_ptr _tmp57F=({const char*_tmp295="norm_context: empty context";_tag_fat(_tmp295,sizeof(char),28U);});_tmp415.f1=_tmp57F;});_tmp415;});void*_tmp293[1U];_tmp293[0]=& _tmp294;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp293,sizeof(void*),1U));});}else{_LL3: _tmp290=((struct _tuple22*)_tmp28F->hd)->f1;_tmp291=((struct _tuple22*)_tmp28F->hd)->f2;_tmp292=_tmp28F->tl;_LL4: {struct Cyc_Tcpat_Con_s*c=_tmp290;struct Cyc_List_List*args=_tmp291;struct Cyc_List_List*tl=_tmp292;
return({struct Cyc_List_List*_tmp581=tl;Cyc_Tcpat_augment(_tmp581,(void*)({struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp296=_cycalloc(sizeof(*_tmp296));_tmp296->tag=0U,_tmp296->f1=c,({struct Cyc_List_List*_tmp580=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(args);_tmp296->f2=_tmp580;});_tmp296;}));});}}_LL0:;}
# 1251
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp29F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp416;_tmp416.tag=0U,({struct _fat_ptr _tmp582=({const char*_tmp2A0="build_desc: ctxt and work don't match";_tag_fat(_tmp2A0,sizeof(char),38U);});_tmp416.f1=_tmp582;});_tmp416;});void*_tmp29E[1U];_tmp29E[0]=& _tmp29F;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp29E,sizeof(void*),1U));});}else{_LL7: _tmp299=((struct _tuple22*)(_tmp298.f1)->hd)->f1;_tmp29A=((struct _tuple22*)(_tmp298.f1)->hd)->f2;_tmp29B=(_tmp298.f1)->tl;_tmp29C=((struct _tuple21*)(_tmp298.f2)->hd)->f3;_tmp29D=(_tmp298.f2)->tl;_LL8: {struct Cyc_Tcpat_Con_s*c=_tmp299;struct Cyc_List_List*args=_tmp29A;struct Cyc_List_List*rest=_tmp29B;struct Cyc_List_List*dargs=_tmp29C;struct Cyc_List_List*work2=_tmp29D;
# 1258
struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp2A1=({struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*_tmp2A3=_cycalloc(sizeof(*_tmp2A3));_tmp2A3->tag=0U,_tmp2A3->f1=c,({struct Cyc_List_List*_tmp584=({struct Cyc_List_List*_tmp583=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(args);((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp583,({struct Cyc_List_List*_tmp2A2=_cycalloc(sizeof(*_tmp2A2));_tmp2A2->hd=dsc,_tmp2A2->tl=dargs;_tmp2A2;}));});_tmp2A3->f2=_tmp584;});_tmp2A3;});struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*td=_tmp2A1;
...
struct Cyc_List_List*_tmp2A4=allmrules;struct Cyc_List_List*_tmp2A7;struct Cyc_Tcpat_Rhs*_tmp2A6;void*_tmp2A5;if(_tmp2A4 == 0){_LL1: _LL2:
 return(void*)({struct Cyc_Tcpat_Failure_Tcpat_Decision_struct*_tmp2A8=_cycalloc(sizeof(*_tmp2A8));_tmp2A8->tag=0U,_tmp2A8->f1=dsc;_tmp2A8;});}else{_LL3: _tmp2A5=((struct _tuple23*)_tmp2A4->hd)->f1;_tmp2A6=((struct _tuple23*)_tmp2A4->hd)->f2;_tmp2A7=_tmp2A4->tl;_LL4: {void*pat1=_tmp2A5;struct Cyc_Tcpat_Rhs*rhs1=_tmp2A6;struct Cyc_List_List*rulerest=_tmp2A7;
# 1272
...
return({void*_tmp586=(void*)({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp2A9=_cycalloc(sizeof(*_tmp2A9));_tmp2A9->tag=1U,({struct Cyc_Set_Set*_tmp585=Cyc_Tcpat_empty_con_set();_tmp2A9->f1=_tmp585;});_tmp2A9;});Cyc_Tcpat_or_match(_tmp586,allmrules);});}
# 1284
...
struct Cyc_List_List*_tmp2AA=work;struct Cyc_List_List*_tmp2AE;struct Cyc_List_List*_tmp2AD;struct Cyc_List_List*_tmp2AC;struct Cyc_List_List*_tmp2AB;struct Cyc_List_List*_tmp2AF;if(_tmp2AA == 0){_LL1: _LL2:
 return(void*)({struct Cyc_Tcpat_Success_Tcpat_Decision_struct*_tmp2B0=_cycalloc(sizeof(*_tmp2B0));_tmp2B0->tag=1U,_tmp2B0->f1=right_hand_side;_tmp2B0;});}else{if(((struct _tuple21*)((struct Cyc_List_List*)_tmp2AA)->hd)->f1 == 0){if(((struct _tuple21*)((struct Cyc_List_List*)_tmp2AA)->hd)->f2 == 0){if(((struct _tuple21*)((struct Cyc_List_List*)_tmp2AA)->hd)->f3 == 0){_LL3: _tmp2AF=_tmp2AA->tl;_LL4: {struct Cyc_List_List*workr=_tmp2AF;
# 1290
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2B2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp418;_tmp418.tag=0U,({struct _fat_ptr _tmp58A=({const char*_tmp2B3="tcpat:and_match: malformed work frame";_tag_fat(_tmp2B3,sizeof(char),38U);});_tmp418.f1=_tmp58A;});_tmp418;});void*_tmp2B1[1U];_tmp2B1[0]=& _tmp2B2;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp2B1,sizeof(void*),1U));});{
...
void*_tmp2C3=dsc;struct Cyc_List_List*_tmp2C4;struct Cyc_Set_Set*_tmp2C5;if(((struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)_tmp2C3)->tag == 1U){_LL1: _tmp2C5=((struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*)_tmp2C3)->f1;_LL2: {struct Cyc_Set_Set*ncs=_tmp2C5;
# 1309
void*any=(void*)({struct Cyc_Tcpat_Neg_Tcpat_Term_desc_struct*_tmp2C8=_cycalloc(sizeof(*_tmp2C8));_tmp2C8->tag=1U,({struct Cyc_Set_Set*_tmp591=Cyc_Tcpat_empty_con_set();_tmp2C8->f1=_tmp591;});_tmp2C8;});
...
# 1322
void*_tmp2CB=p->r;void*_stmttmp29=_tmp2CB;void*_tmp2CC=_stmttmp29;struct Cyc_List_List*_tmp2CE;union Cyc_Absyn_AggrInfo _tmp2CD;struct Cyc_Absyn_Datatypefield*_tmp2D0;struct Cyc_Absyn_Datatypedecl*_tmp2CF;switch(*((int*)_tmp2CC)){case 6U: _LL6: _LL7:
# 1324
 if(i != 0)
({struct Cyc_Int_pa_PrintArg_struct _tmp2D3=({struct Cyc_Int_pa_PrintArg_struct _tmp419;_tmp419.tag=1U,_tmp419.f1=(unsigned long)i;_tmp419;});void*_tmp2D1[1U];_tmp2D1[0]=& _tmp2D3;({struct _fat_ptr _tmp592=({const char*_tmp2D2="get_access on pointer pattern with offset %d\n";_tag_fat(_tmp2D2,sizeof(char),46U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp592,_tag_fat(_tmp2D1,sizeof(void*),1U));});});
return(void*)& Cyc_Tcpat_Deref_val;case 5U: _LL8: _LL9:
 return(void*)({struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*_tmp2D4=_cycalloc(sizeof(*_tmp2D4));_tmp2D4->tag=2U,_tmp2D4->f1=(unsigned)i;_tmp2D4;});case 8U: _LLA: _tmp2CF=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp2CC)->f1;_tmp2D0=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp2CC)->f2;_LLB: {struct Cyc_Absyn_Datatypedecl*tud=_tmp2CF;struct Cyc_Absyn_Datatypefield*tuf=_tmp2D0;
return(void*)({struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*_tmp2D5=_cycalloc(sizeof(*_tmp2D5));_tmp2D5->tag=3U,_tmp2D5->f1=tud,_tmp2D5->f2=tuf,_tmp2D5->f3=(unsigned)i;_tmp2D5;});}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp2CC)->f1 != 0){_LLC: _tmp2CD=*((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp2CC)->f1;_tmp2CE=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp2CC)->f3;_LLD: {union Cyc_Absyn_AggrInfo info=_tmp2CD;struct Cyc_List_List*dlps=_tmp2CE;
# 1330
struct Cyc_Absyn_Aggrdecl*_tmp2D6=Cyc_Absyn_get_known_aggrdecl(info);struct Cyc_Absyn_Aggrdecl*ad=_tmp2D6;
if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->tagged){
struct Cyc_List_List*_tmp2D7=(*((struct _tuple16*)((struct Cyc_List_List*)_check_null(dlps))->hd)).f1;struct Cyc_List_List*_stmttmp2A=_tmp2D7;struct Cyc_List_List*_tmp2D8=_stmttmp2A;struct _fat_ptr*_tmp2D9;if(_tmp2D8 != 0){if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)((struct Cyc_List_List*)_tmp2D8)->hd)->tag == 1U){if(((struct Cyc_List_List*)_tmp2D8)->tl == 0){_LL11: _tmp2D9=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp2D8->hd)->f1;_LL12: {struct _fat_ptr*f=_tmp2D9;
# 1334
return(void*)({struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*_tmp2DA=_cycalloc(sizeof(*_tmp2DA));_tmp2DA->tag=4U,_tmp2DA->f1=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->tagged,_tmp2DA->f2=f;_tmp2DA;});}}else{goto _LL13;}}else{goto _LL13;}}else{_LL13: _LL14:
# 1336
({struct Cyc_String_pa_PrintArg_struct _tmp2DD=({struct Cyc_String_pa_PrintArg_struct _tmp41A;_tmp41A.tag=0U,({struct _fat_ptr _tmp593=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_pat2string(p));_tmp41A.f1=_tmp593;});_tmp41A;});void*_tmp2DB[1U];_tmp2DB[0]=& _tmp2DD;({struct _fat_ptr _tmp594=({const char*_tmp2DC="get_access on bad aggr pattern: %s";_tag_fat(_tmp2DC,sizeof(char),35U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp594,_tag_fat(_tmp2DB,sizeof(void*),1U));});});}_LL10:;}{
# 1338
...
return(void*)({struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*_tmp2E0=_cycalloc(sizeof(*_tmp2E0));_tmp2E0->tag=4U,_tmp2E0->f1=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->tagged,_tmp2E0->f2=((struct Cyc_Absyn_Aggrfield*)((struct Cyc_List_List*)_check_null(fields))->hd)->name;_tmp2E0;});}}}else{goto _LLE;}default: _LLE: _LLF:
({struct Cyc_String_pa_PrintArg_struct _tmp2E3=({struct Cyc_String_pa_PrintArg_struct _tmp41B;_tmp41B.tag=0U,({struct _fat_ptr _tmp595=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_pat2string(p));_tmp41B.f1=_tmp595;});_tmp41B;});void*_tmp2E1[1U];_tmp2E1[0]=& _tmp2E3;({struct _fat_ptr _tmp596=({const char*_tmp2E2="get_access on bad pattern: %s";_tag_fat(_tmp2E2,sizeof(char),30U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp596,_tag_fat(_tmp2E1,sizeof(void*),1U));});});}_LL5:;}}_LL0:;}struct _tuple24{struct Cyc_List_List*f1;struct Cyc_Tcpat_Con_s*f2;};
# 1348
...
# 1364
void*_tmp2EA=p;struct Cyc_List_List*_tmp2EC;struct Cyc_Tcpat_Con_s*_tmp2EB;if(((struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*)_tmp2EA)->tag == 0U){_LL1: _LL2:
...
# 1398
void*_tmp2F9=d;void*_tmp2FB;struct Cyc_List_List*_tmp2FA;struct Cyc_Tcpat_Rhs*_tmp2FC;void*_tmp2FD;switch(*((int*)_tmp2F9)){case 0U: _LL1: _tmp2FD=(void*)((struct Cyc_Tcpat_Failure_Tcpat_Decision_struct*)_tmp2F9)->f1;_LL2: {void*td=_tmp2FD;
# 1400
if(!(*exhaust_done)){not_exhaust(env1,td);*exhaust_done=1;}
goto _LL0;}case 1U: _LL3: _tmp2FC=((struct Cyc_Tcpat_Success_Tcpat_Decision_struct*)_tmp2F9)->f1;_LL4: {struct Cyc_Tcpat_Rhs*r=_tmp2FC;
...
sp=({struct Cyc_List_List*_tmp5A6=({void*_tmp302[2U];_tmp302[0]=sp0,({void*_tmp5A5=Cyc_Tcpat_int_pat(*ctr,w);_tmp302[1]=_tmp5A5;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp302,sizeof(void*),2U));});Cyc_Tcpat_tuple_pat(_tmp5A6,w);});
*ctr=*ctr + 1;}else{
# 1428
sp=({struct Cyc_List_List*_tmp5A8=({void*_tmp303[2U];_tmp303[0]=sp0,({void*_tmp5A7=(void*)({struct Cyc_Tcpat_Any_Tcpat_Simple_pat_struct*_tmp304=_cycalloc(sizeof(*_tmp304));_tmp304->tag=0U;_tmp304;});_tmp303[1]=_tmp5A7;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp303,sizeof(void*),2U));});Cyc_Tcpat_tuple_pat(_tmp5A8,({union Cyc_Tcpat_PatOrWhere _tmp41E;(_tmp41E.where_clause).tag=2U,(_tmp41E.where_clause).val=0;_tmp41E;}));});}
...
void*_tmp307=d;struct Cyc_Set_Set*_tmp308;struct Cyc_List_List*_tmp30A;struct Cyc_Tcpat_Con_s*_tmp309;if(((struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp307)->tag == 0U){_LL1: _tmp309=((struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp307)->f1;_tmp30A=((struct Cyc_Tcpat_Pos_Tcpat_Term_desc_struct*)_tmp307)->f2;_LL2: {struct Cyc_Tcpat_Con_s*c=_tmp309;struct Cyc_List_List*ds=_tmp30A;
# 1440
...
p=p2;goto _LL5;}}_LL5:;}{
# 1446
void*_tmp30F=p->r;void*_stmttmp2E=_tmp30F;void*_tmp310=_stmttmp2E;struct Cyc_Absyn_Exp*_tmp311;struct Cyc_Absyn_Enumfield*_tmp312;struct Cyc_Absyn_Enumfield*_tmp313;int _tmp315;struct _fat_ptr _tmp314;char _tmp316;int _tmp317;struct Cyc_Absyn_Datatypefield*_tmp318;struct Cyc_List_List*_tmp31A;struct Cyc_Absyn_Aggrdecl*_tmp319;struct Cyc_Absyn_Vardecl*_tmp31C;struct Cyc_Absyn_Tvar*_tmp31B;struct Cyc_Absyn_Vardecl*_tmp31D;struct Cyc_Absyn_Vardecl*_tmp31E;switch(*((int*)_tmp310)){case 0U: _LLB: _LLC:
 return({const char*_tmp31F="_";_tag_fat(_tmp31F,sizeof(char),2U);});case 1U: _LLD: _tmp31E=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp310)->f1;_LLE: {struct Cyc_Absyn_Vardecl*vd=_tmp31E;
return Cyc_Absynpp_qvar2string(vd->name);}case 3U: _LLF: _tmp31D=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp310)->f1;_LL10: {struct Cyc_Absyn_Vardecl*vd=_tmp31D;
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp322=({struct Cyc_String_pa_PrintArg_struct _tmp41F;_tmp41F.tag=0U,({struct _fat_ptr _tmp5A9=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp41F.f1=_tmp5A9;});_tmp41F;});void*_tmp320[1U];_tmp320[0]=& _tmp322;({struct _fat_ptr _tmp5AA=({const char*_tmp321="*%s";_tag_fat(_tmp321,sizeof(char),4U);});Cyc_aprintf(_tmp5AA,_tag_fat(_tmp320,sizeof(void*),1U));});});}case 4U: _LL11: _tmp31B=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp310)->f1;_tmp31C=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp310)->f2;_LL12: {struct Cyc_Absyn_Tvar*tv=_tmp31B;struct Cyc_Absyn_Vardecl*vd=_tmp31C;
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp325=({struct Cyc_String_pa_PrintArg_struct _tmp421;_tmp421.tag=0U,({struct _fat_ptr _tmp5AB=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp421.f1=_tmp5AB;});_tmp421;});struct Cyc_String_pa_PrintArg_struct _tmp326=({struct Cyc_String_pa_PrintArg_struct _tmp420;_tmp420.tag=0U,_tmp420.f1=(struct _fat_ptr)((struct _fat_ptr)*tv->name);_tmp420;});void*_tmp323[2U];_tmp323[0]=& _tmp325,_tmp323[1]=& _tmp326;({struct _fat_ptr _tmp5AC=({const char*_tmp324="%s<`%s>";_tag_fat(_tmp324,sizeof(char),8U);});Cyc_aprintf(_tmp5AC,_tag_fat(_tmp323,sizeof(void*),2U));});});}case 5U: _LL13: _LL14:
# 1452
 return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp329=({struct Cyc_String_pa_PrintArg_struct _tmp422;_tmp422.tag=0U,({struct _fat_ptr _tmp5AD=(struct _fat_ptr)((struct _fat_ptr)Cyc_Tcpat_descs2string(ds));_tmp422.f1=_tmp5AD;});_tmp422;});void*_tmp327[1U];_tmp327[0]=& _tmp329;({struct _fat_ptr _tmp5AE=({const char*_tmp328="$(%s)";_tag_fat(_tmp328,sizeof(char),6U);});Cyc_aprintf(_tmp5AE,_tag_fat(_tmp327,sizeof(void*),1U));});});case 6U: _LL15: _LL16:
 return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp32C=({struct Cyc_String_pa_PrintArg_struct _tmp423;_tmp423.tag=0U,({struct _fat_ptr _tmp5AF=(struct _fat_ptr)((struct _fat_ptr)Cyc_Tcpat_descs2string(ds));_tmp423.f1=_tmp5AF;});_tmp423;});void*_tmp32A[1U];_tmp32A[0]=& _tmp32C;({struct _fat_ptr _tmp5B0=({const char*_tmp32B="&%s";_tag_fat(_tmp32B,sizeof(char),4U);});Cyc_aprintf(_tmp5B0,_tag_fat(_tmp32A,sizeof(void*),1U));});});case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp310)->f1 != 0){if((((union Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp310)->f1)->KnownAggr).tag == 2){_LL17: _tmp319=*((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp310)->f1)->KnownAggr).val;_tmp31A=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp310)->f3;_LL18: {struct Cyc_Absyn_Aggrdecl*ad=_tmp319;struct Cyc_List_List*dlps=_tmp31A;
# 1455
if((int)ad->kind == (int)Cyc_Absyn_UnionA){
struct Cyc_List_List*_tmp32D=dlps;struct _fat_ptr*_tmp32E;if(_tmp32D != 0){if(((struct _tuple16*)((struct Cyc_List_List*)_tmp32D)->hd)->f1 != 0){if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)((struct Cyc_List_List*)((struct _tuple16*)((struct Cyc_List_List*)_tmp32D)->hd)->f1)->hd)->tag == 1U){_LL2C: _tmp32E=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)(((struct _tuple16*)_tmp32D->hd)->f1)->hd)->f1;_LL2D: {struct _fat_ptr*f=_tmp32E;
# 1458
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp331=({struct Cyc_String_pa_PrintArg_struct _tmp426;_tmp426.tag=0U,({struct _fat_ptr _tmp5B1=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(ad->name));_tmp426.f1=_tmp5B1;});_tmp426;});struct Cyc_String_pa_PrintArg_struct _tmp332=({struct Cyc_String_pa_PrintArg_struct _tmp425;_tmp425.tag=0U,_tmp425.f1=(struct _fat_ptr)((struct _fat_ptr)*f);_tmp425;});struct Cyc_String_pa_PrintArg_struct _tmp333=({struct Cyc_String_pa_PrintArg_struct _tmp424;_tmp424.tag=0U,({
struct _fat_ptr _tmp5B2=(struct _fat_ptr)((struct _fat_ptr)Cyc_Tcpat_descs2string(ds));_tmp424.f1=_tmp5B2;});_tmp424;});void*_tmp32F[3U];_tmp32F[0]=& _tmp331,_tmp32F[1]=& _tmp332,_tmp32F[2]=& _tmp333;({struct _fat_ptr _tmp5B3=({const char*_tmp330="%s{.%s = %s}";_tag_fat(_tmp330,sizeof(char),13U);});Cyc_aprintf(_tmp5B3,_tag_fat(_tmp32F,sizeof(void*),3U));});});}}else{goto _LL2E;}}else{goto _LL2E;}}else{_LL2E: _LL2F:
 goto _LL2B;}_LL2B:;}
# 1462
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp336=({struct Cyc_String_pa_PrintArg_struct _tmp428;_tmp428.tag=0U,({struct _fat_ptr _tmp5B4=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(ad->name));_tmp428.f1=_tmp5B4;});_tmp428;});struct Cyc_String_pa_PrintArg_struct _tmp337=({struct Cyc_String_pa_PrintArg_struct _tmp427;_tmp427.tag=0U,({struct _fat_ptr _tmp5B5=(struct _fat_ptr)((struct _fat_ptr)Cyc_Tcpat_descs2string(ds));_tmp427.f1=_tmp5B5;});_tmp427;});void*_tmp334[2U];_tmp334[0]=& _tmp336,_tmp334[1]=& _tmp337;({struct _fat_ptr _tmp5B6=({const char*_tmp335="%s{%s}";_tag_fat(_tmp335,sizeof(char),7U);});Cyc_aprintf(_tmp5B6,_tag_fat(_tmp334,sizeof(void*),2U));});});}}else{goto _LL29;}}else{goto _LL29;}case 8U: _LL19: _tmp318=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp310)->f2;_LL1A: {struct Cyc_Absyn_Datatypefield*tuf=_tmp318;
# 1464
if(ds == 0)
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp33A=({struct Cyc_String_pa_PrintArg_struct _tmp429;_tmp429.tag=0U,({struct _fat_ptr _tmp5B7=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(tuf->name));_tmp429.f1=_tmp5B7;});_tmp429;});void*_tmp338[1U];_tmp338[0]=& _tmp33A;({struct _fat_ptr _tmp5B8=({const char*_tmp339="%s";_tag_fat(_tmp339,sizeof(char),3U);});Cyc_aprintf(_tmp5B8,_tag_fat(_tmp338,sizeof(void*),1U));});});else{
# 1467
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp33D=({struct Cyc_String_pa_PrintArg_struct _tmp42B;_tmp42B.tag=0U,({struct _fat_ptr _tmp5B9=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(tuf->name));_tmp42B.f1=_tmp5B9;});_tmp42B;});struct Cyc_String_pa_PrintArg_struct _tmp33E=({struct Cyc_String_pa_PrintArg_struct _tmp42A;_tmp42A.tag=0U,({struct _fat_ptr _tmp5BA=(struct _fat_ptr)((struct _fat_ptr)Cyc_Tcpat_descs2string(ds));_tmp42A.f1=_tmp5BA;});_tmp42A;});void*_tmp33B[2U];_tmp33B[0]=& _tmp33D,_tmp33B[1]=& _tmp33E;({struct _fat_ptr _tmp5BB=({const char*_tmp33C="%s(%s)";_tag_fat(_tmp33C,sizeof(char),7U);});Cyc_aprintf(_tmp5BB,_tag_fat(_tmp33B,sizeof(void*),2U));});});}}case 9U: _LL1B: _LL1C:
 return({const char*_tmp33F="NULL";_tag_fat(_tmp33F,sizeof(char),5U);});case 10U: _LL1D: _tmp317=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp310)->f2;_LL1E: {int i=_tmp317;
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp342=({struct Cyc_Int_pa_PrintArg_struct _tmp42C;_tmp42C.tag=1U,_tmp42C.f1=(unsigned long)i;_tmp42C;});void*_tmp340[1U];_tmp340[0]=& _tmp342;({struct _fat_ptr _tmp5BC=({const char*_tmp341="%d";_tag_fat(_tmp341,sizeof(char),3U);});Cyc_aprintf(_tmp5BC,_tag_fat(_tmp340,sizeof(void*),1U));});});}case 11U: _LL1F: _tmp316=((struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp310)->f1;_LL20: {char c=_tmp316;
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp345=({struct Cyc_Int_pa_PrintArg_struct _tmp42D;_tmp42D.tag=1U,_tmp42D.f1=(unsigned long)((int)c);_tmp42D;});void*_tmp343[1U];_tmp343[0]=& _tmp345;({struct _fat_ptr _tmp5BD=({const char*_tmp344="%d";_tag_fat(_tmp344,sizeof(char),3U);});Cyc_aprintf(_tmp5BD,_tag_fat(_tmp343,sizeof(void*),1U));});});}case 12U: _LL21: _tmp314=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp310)->f1;_tmp315=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp310)->f2;_LL22: {struct _fat_ptr f=_tmp314;int i=_tmp315;
return f;}case 13U: _LL23: _tmp313=((struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*)_tmp310)->f2;_LL24: {struct Cyc_Absyn_Enumfield*ef=_tmp313;
_tmp312=ef;goto _LL26;}case 14U: _LL25: _tmp312=((struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*)_tmp310)->f2;_LL26: {struct Cyc_Absyn_Enumfield*ef=_tmp312;
return Cyc_Absynpp_qvar2string(ef->name);}case 17U: _LL27: _tmp311=((struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp310)->f1;_LL28: {struct Cyc_Absyn_Exp*e=_tmp311;
...
# 1478
if(((int(*)(struct Cyc_Set_Set*s))Cyc_Set_is_empty)(s))return({const char*_tmp346="_";_tag_fat(_tmp346,sizeof(char),2U);});{
struct Cyc_Tcpat_Con_s*_tmp347=((struct Cyc_Tcpat_Con_s*(*)(struct Cyc_Set_Set*s))Cyc_Set_choose)(s);struct Cyc_Tcpat_Con_s*c=_tmp347;
# 1482
...
void*_tmp349=Cyc_Absyn_compress((void*)_check_null(orig_pat->topt));void*_stmttmp2F=_tmp349;void*_tmp34A=_stmttmp2F;void*_tmp34B;struct Cyc_Absyn_Aggrdecl*_tmp34C;struct Cyc_Absyn_Datatypedecl*_tmp34D;switch(*((int*)_tmp34A)){case 0U: switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp34A)->f1)){case 1U: if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp34A)->f1)->f2 == Cyc_Absyn_Char_sz){_LL31: _LL32:
# 1487
{int i=0;for(0;i < 256;++ i){
if(!({struct Cyc_Set_Set*_tmp5BE=s;((int(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp5BE,Cyc_Tcpat_char_con((char)i,orig_pat));}))
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp350=({struct Cyc_Int_pa_PrintArg_struct _tmp42E;_tmp42E.tag=1U,_tmp42E.f1=(unsigned long)i;_tmp42E;});void*_tmp34E[1U];_tmp34E[0]=& _tmp350;({struct _fat_ptr _tmp5BF=({const char*_tmp34F="%d";_tag_fat(_tmp34F,sizeof(char),3U);});Cyc_aprintf(_tmp5BF,_tag_fat(_tmp34E,sizeof(void*),1U));});});}}
(int)_throw((void*)& Cyc_Tcpat_Desc2string_val);}else{_LL33: _LL34:
# 1493
{unsigned i=0U;for(0;i < (unsigned)-1;++ i){
if(!({struct Cyc_Set_Set*_tmp5C0=s;((int(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp5C0,Cyc_Tcpat_int_con((int)i,c->orig_pat));}))
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp353=({struct Cyc_Int_pa_PrintArg_struct _tmp42F;_tmp42F.tag=1U,_tmp42F.f1=(unsigned long)((int)i);_tmp42F;});void*_tmp351[1U];_tmp351[0]=& _tmp353;({struct _fat_ptr _tmp5C1=({const char*_tmp352="%d";_tag_fat(_tmp352,sizeof(char),3U);});Cyc_aprintf(_tmp5C1,_tag_fat(_tmp351,sizeof(void*),1U));});});}}
...
if(!({struct Cyc_Set_Set*_tmp5C3=s;((int(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp5C3,({struct Cyc_Tcpat_Con_s*_tmp358=_cycalloc(sizeof(*_tmp358));({union Cyc_Tcpat_Name_value _tmp5C2=Cyc_Tcpat_Name_v(n);_tmp358->name=_tmp5C2;}),_tmp358->arity=0,_tmp358->span=0,_tmp358->orig_pat=c->orig_pat;_tmp358;}));}))
return((int(*)(struct Cyc_List_List*x))Cyc_List_length)(args)== 0?n:(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp35B=({struct Cyc_String_pa_PrintArg_struct _tmp430;_tmp430.tag=0U,_tmp430.f1=(struct _fat_ptr)((struct _fat_ptr)n);_tmp430;});void*_tmp359[1U];_tmp359[0]=& _tmp35B;({struct _fat_ptr _tmp5C4=({const char*_tmp35A="%s(...)";_tag_fat(_tmp35A,sizeof(char),8U);});Cyc_aprintf(_tmp5C4,_tag_fat(_tmp359,sizeof(void*),1U));});});}
# 1511
...
if(!({struct Cyc_Set_Set*_tmp5C6=s;((int(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp5C6,({struct Cyc_Tcpat_Con_s*_tmp360=_cycalloc(sizeof(*_tmp360));({union Cyc_Tcpat_Name_value _tmp5C5=Cyc_Tcpat_Name_v(n);_tmp360->name=_tmp5C5;}),_tmp360->arity=0,_tmp360->span=0,_tmp360->orig_pat=c->orig_pat;_tmp360;}));}))
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp363=({struct Cyc_String_pa_PrintArg_struct _tmp432;_tmp432.tag=0U,_tmp432.f1=(struct _fat_ptr)((struct _fat_ptr)union_name);_tmp432;});struct Cyc_String_pa_PrintArg_struct _tmp364=({struct Cyc_String_pa_PrintArg_struct _tmp431;_tmp431.tag=0U,_tmp431.f1=(struct _fat_ptr)((struct _fat_ptr)n);_tmp431;});void*_tmp361[2U];_tmp361[0]=& _tmp363,_tmp361[1]=& _tmp364;({struct _fat_ptr _tmp5C7=({const char*_tmp362="%s{.%s = _}";_tag_fat(_tmp362,sizeof(char),12U);});Cyc_aprintf(_tmp5C7,_tag_fat(_tmp361,sizeof(void*),2U));});});}
# 1521
(int)_throw((void*)& Cyc_Tcpat_Desc2string_val);}}}else{goto _LL3B;}}else{goto _LL3B;}default: goto _LL3B;}case 3U: _LL35: _tmp34B=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp34A)->f1).ptr_atts).nullable;_LL36: {void*n=_tmp34B;
# 1498
if(Cyc_Tcutil_force_type2bool(0,n)&& !({struct Cyc_Set_Set*_tmp5C8=s;((int(*)(struct Cyc_Set_Set*s,struct Cyc_Tcpat_Con_s*elt))Cyc_Set_member)(_tmp5C8,Cyc_Tcpat_null_con(orig_pat));}))
...
struct Cyc_List_List*_tmp367=((struct Cyc_List_List*(*)(struct _fat_ptr*(*f)(void*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_desc2stringptr,ds);struct Cyc_List_List*ss=_tmp367;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp371=({struct Cyc_Warn_String_Warn_Warg_struct _tmp434;_tmp434.tag=0U,({struct _fat_ptr _tmp5CC=({const char*_tmp373="patterns may not be exhaustive.\n\tmissing case for ";_tag_fat(_tmp373,sizeof(char),51U);});_tmp434.f1=_tmp5CC;});_tmp434;});struct Cyc_Warn_String_Warn_Warg_struct _tmp372=({struct Cyc_Warn_String_Warn_Warg_struct _tmp433;_tmp433.tag=0U,_tmp433.f1=s;_tmp433;});void*_tmp370[2U];_tmp370[0]=& _tmp371,_tmp370[1]=& _tmp372;({unsigned _tmp5CD=loc;Cyc_Warn_err2(_tmp5CD,_tag_fat(_tmp370,sizeof(void*),2U));});});}
# 1542
...
# 1545
({struct Cyc_Warn_String_Warn_Warg_struct _tmp377=({struct Cyc_Warn_String_Warn_Warg_struct _tmp435;_tmp435.tag=0U,({struct _fat_ptr _tmp5CE=({const char*_tmp378="patterns may not be exhaustive.";_tag_fat(_tmp378,sizeof(char),32U);});_tmp435.f1=_tmp5CE;});_tmp435;});void*_tmp376[1U];_tmp376[0]=& _tmp377;({unsigned _tmp5CF=loc;Cyc_Warn_err2(_tmp5CF,_tag_fat(_tmp376,sizeof(void*),1U));});});
...
struct Cyc_List_List*_tmp37B=((struct Cyc_List_List*(*)(struct _tuple23*(*f)(int*,struct Cyc_Absyn_Switch_clause*),int*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcpat_get_match,env,swcs);struct Cyc_List_List*match_rules=_tmp37B;
...
if(!b){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp383=({struct Cyc_Warn_String_Warn_Warg_struct _tmp436;_tmp436.tag=0U,({struct _fat_ptr _tmp5D0=({const char*_tmp384="redundant pattern (check for misspelled constructors in earlier patterns)";_tag_fat(_tmp384,sizeof(char),74U);});_tmp436.f1=_tmp5D0;});_tmp436;});void*_tmp382[1U];_tmp382[0]=& _tmp383;({unsigned _tmp5D1=loc2;Cyc_Warn_err2(_tmp5D1,_tag_fat(_tmp382,sizeof(void*),1U));});});
# 1573
break;}}}}}
# 1582
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp38A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp438;_tmp438.tag=0U,({struct _fat_ptr _tmp5D2=({const char*_tmp38C="pattern not exhaustive.\n\tmissing case for ";_tag_fat(_tmp38C,sizeof(char),43U);});_tmp438.f1=_tmp5D2;});_tmp438;});struct Cyc_Warn_String_Warn_Warg_struct _tmp38B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp437;_tmp437.tag=0U,_tmp437.f1=s;_tmp437;});void*_tmp389[2U];_tmp389[0]=& _tmp38A,_tmp389[1]=& _tmp38B;({unsigned _tmp5D3=(*pr).f1;Cyc_Warn_warn2(_tmp5D3,_tag_fat(_tmp389,sizeof(void*),2U));});});}
# 1585
...
# 1588
({struct Cyc_Warn_String_Warn_Warg_struct _tmp390=({struct Cyc_Warn_String_Warn_Warg_struct _tmp439;_tmp439.tag=0U,({struct _fat_ptr _tmp5D4=({const char*_tmp391="pattern not exhaustive.";_tag_fat(_tmp391,sizeof(char),24U);});_tmp439.f1=_tmp5D4;});_tmp439;});void*_tmp38F[1U];_tmp38F[0]=& _tmp390;({unsigned _tmp5D5=(*pr).f1;Cyc_Warn_warn2(_tmp5D5,_tag_fat(_tmp38F,sizeof(void*),1U));});});
...
# 1616
if(swc->where_clause != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp39A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp43B;_tmp43B.tag=0U,({struct _fat_ptr _tmp5D9=({const char*_tmp39B="&&-clauses not supported in exception handlers.";_tag_fat(_tmp39B,sizeof(char),48U);});_tmp43B.f1=_tmp5D9;});_tmp43B;});void*_tmp399[1U];_tmp399[0]=& _tmp39A;({unsigned _tmp5DA=((struct Cyc_Absyn_Exp*)_check_null(swc->where_clause))->loc;Cyc_Warn_err2(_tmp5DA,_tag_fat(_tmp399,sizeof(void*),1U));});});{
# 1619
...
# 1629
struct Cyc_List_List*_tmp39E=((struct Cyc_List_List*(*)(struct _tuple23*(*f)(struct Cyc_Absyn_Switch_clause*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcpat_get_match2,swcs);struct Cyc_List_List*match_rules=_tmp39E;
...
if(!b){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3A6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp43C;_tmp43C.tag=0U,({struct _fat_ptr _tmp5DB=({const char*_tmp3A7="redundant pattern (check for misspelled constructors in earlier patterns)";_tag_fat(_tmp3A7,sizeof(char),74U);});_tmp43C.f1=_tmp5DB;});_tmp43C;});void*_tmp3A5[1U];_tmp3A5[0]=& _tmp3A6;({unsigned _tmp5DC=loc2;Cyc_Warn_err2(_tmp5DC,_tag_fat(_tmp3A5,sizeof(void*),1U));});});
break;}}}}}}
# 1646
