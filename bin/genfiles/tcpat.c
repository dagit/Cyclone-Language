...
_TF.f1=_tag_fat("patterns may not be exhaustive.\n\tmissing case for ",sizeof(char),51U);_T2=_TF;}{struct Cyc_Warn_String_Warn_Warg_struct _TF=_T2;{struct Cyc_Warn_String_Warn_Warg_struct _T10;_T10.tag=0;_T10.f1=s;_T3=_T10;}{struct Cyc_Warn_String_Warn_Warg_struct _T10=_T3;void*_T11[2];_T11[0]=& _TF;_T11[1]=& _T10;_T4=loc;_T5=_tag_fat(_T11,sizeof(void*),2);Cyc_Warn_err2(_T4,_T5);}}}_pop_handler();goto _TL267;_TL266: _T6=Cyc_Core_get_exn_thrown();{void*_TF=(void*)_T6;void*_T10;_T7=(struct Cyc_Tcpat_Desc2string_exn_struct*)_TF;_T8=_T7->tag;_T9=Cyc_Tcpat_Desc2string;if(_T8!=_T9)goto _TL269;{struct Cyc_Warn_String_Warn_Warg_struct _T11;_T11.tag=0;
# 1670
_T11.f1=_tag_fat("patterns may not be exhaustive.",sizeof(char),32U);_TA=_T11;}{struct Cyc_Warn_String_Warn_Warg_struct _T11=_TA;void*_T12[1];_T12[0]=& _T11;_TB=loc;_TC=_tag_fat(_T12,sizeof(void*),1);Cyc_Warn_err2(_TB,_TC);}goto _LL0;_TL269: _T10=_TF;{void*exn=_T10;_rethrow(exn);}_LL0:;}_TL267:;}}
# 1674
...
# 1707
static void Cyc_Tcpat_not_exhaust_warn(struct _tuple15*pr,void*desc){struct _tuple15*_T0;struct _handler_cons*_T1;int _T2;struct Cyc_Warn_String_Warn_Warg_struct _T3;struct Cyc_Warn_String_Warn_Warg_struct _T4;struct _tuple15*_T5;struct _tuple15 _T6;unsigned _T7;struct _fat_ptr _T8;void*_T9;struct Cyc_Tcpat_Desc2string_exn_struct*_TA;char*_TB;char*_TC;struct Cyc_Warn_String_Warn_Warg_struct _TD;struct _tuple15*_TE;struct _tuple15 _TF;unsigned _T10;struct _fat_ptr _T11;_T0=pr;
