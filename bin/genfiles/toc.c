...
# 78
({struct _dyneither_ptr _tmp7B5=(struct _dyneither_ptr)({struct _dyneither_ptr _tmp7B4=({const char*_tmp0="Toc (unimplemented): ";_tag_dyneither(_tmp0,sizeof(char),22U);});Cyc_strconcat(_tmp7B4,(struct _dyneither_ptr)fmt);});Cyc_Warn_vimpos(_tmp7B5,ap);});}
# 80
static void*Cyc_Toc_toc_impos(struct _dyneither_ptr fmt,struct _dyneither_ptr ap){
# 82
({struct _dyneither_ptr _tmp7B7=(struct _dyneither_ptr)({struct _dyneither_ptr _tmp7B6=({const char*_tmp1="Toc: ";_tag_dyneither(_tmp1,sizeof(char),6U);});Cyc_strconcat(_tmp7B6,(struct _dyneither_ptr)fmt);});Cyc_Warn_vimpos(_tmp7B7,ap);});}
# 86
...
({struct Cyc_List_List**_tmp7C3=({struct Cyc_List_List**_tmpA=_region_malloc(d,sizeof(*_tmpA));*_tmpA=0;_tmpA;});_tmp11->tuple_types=_tmp7C3;}),({
struct Cyc_List_List**_tmp7C2=({struct Cyc_List_List**_tmpB=_region_malloc(d,sizeof(*_tmpB));*_tmpB=0;_tmpB;});_tmp11->anon_aggr_types=_tmp7C2;}),({
struct Cyc_Dict_Dict*_tmp7C1=({struct Cyc_Dict_Dict*_tmpC=_region_malloc(d,sizeof(*_tmpC));({struct Cyc_Dict_Dict _tmp7C0=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _tuple1*,struct _tuple1*)))Cyc_Dict_rempty)(d,Cyc_Absyn_qvar_cmp);*_tmpC=_tmp7C0;});_tmpC;});_tmp11->aggrs_so_far=_tmp7C1;}),({
struct Cyc_List_List**_tmp7BF=({struct Cyc_List_List**_tmpD=_region_malloc(d,sizeof(*_tmpD));*_tmpD=0;_tmpD;});_tmp11->abs_struct_types=_tmp7BF;}),({
struct Cyc_Set_Set**_tmp7BE=({struct Cyc_Set_Set**_tmpE=_region_malloc(d,sizeof(*_tmpE));({struct Cyc_Set_Set*_tmp7BD=((struct Cyc_Set_Set*(*)(struct _RegionHandle*r,int(*cmp)(struct _tuple1*,struct _tuple1*)))Cyc_Set_rempty)(d,Cyc_Absyn_qvar_cmp);*_tmpE=_tmp7BD;});_tmpE;});_tmp11->datatypes_so_far=_tmp7BE;}),({
struct Cyc_Dict_Dict*_tmp7BC=({struct Cyc_Dict_Dict*_tmpF=_region_malloc(d,sizeof(*_tmpF));({struct Cyc_Dict_Dict _tmp7BB=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _tuple1*,struct _tuple1*)))Cyc_Dict_rempty)(d,Cyc_Absyn_qvar_cmp);*_tmpF=_tmp7BB;});_tmpF;});_tmp11->xdatatypes_so_far=_tmp7BC;}),({
struct Cyc_Dict_Dict*_tmp7BA=({struct Cyc_Dict_Dict*_tmp10=_region_malloc(d,sizeof(*_tmp10));({struct Cyc_Dict_Dict _tmp7B9=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _tuple15*,struct _tuple15*)))Cyc_Dict_rempty)(d,Cyc_Toc_qvar_tag_cmp);*_tmp10=_tmp7B9;});_tmp10;});_tmp11->qvar_tags=_tmp7BA;}),({
struct Cyc_Xarray_Xarray*_tmp7B8=((struct Cyc_Xarray_Xarray*(*)(struct _RegionHandle*))Cyc_Xarray_rcreate_empty)(d);_tmp11->temp_labels=_tmp7B8;});_tmp11;});}struct Cyc_Toc_TocStateWrap{struct Cyc_Core_DynamicRegion*dyn;struct Cyc_Toc_TocState*state;};
# 160
...
({struct Cyc_Toc_TocStateWrap _tmp7C4=({struct Cyc_Toc_TocStateWrap _tmp77D;_tmp77D.dyn=_tmp1C,_tmp77D.state=_tmp1B;_tmp77D;});*ts=_tmp7C4;});
...
{struct _tuple16 _tmp1A=({struct _tuple16 _tmp77E;_tmp77E.f1=_tmp1B,_tmp77E.f2=arg;_tmp77E;});
({void*_tmp7C5=f(h,& _tmp1A);res=_tmp7C5;});}
# 177
;}
# 179
...
struct _tuple17 env=({struct _tuple17 _tmp77F;_tmp77F.f1=q,_tmp77F.f2=type_maker;_tmp77F;});
...
void*_tmp6D=dpt;
if(_tmp6D == 0){
({void*_tmp7C6=Cyc_Absyn_aggr_type(Cyc_Absyn_UnknownAggr(Cyc_Absyn_StructA,& Cyc_Toc__dyneither_ptr_pr,0),0);_tmp6D=_tmp7C6;});
dpt=_tmp6D;}
# 305
return _tmp6D;}
# 308
...
return({struct _tuple20*_tmp70=_cycalloc(sizeof(*_tmp70));({struct Cyc_List_List*_tmp7C8=({struct Cyc_List_List*_tmp6F=_cycalloc(sizeof(*_tmp6F));({void*_tmp7C7=(void*)({struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_tmp6E=_cycalloc(sizeof(*_tmp6E));_tmp6E->tag=1U,_tmp6E->f1=name;_tmp6E;});_tmp6F->hd=_tmp7C7;}),_tmp6F->tl=0;_tmp6F;});_tmp70->f1=_tmp7C8;}),_tmp70->f2=e;_tmp70;});}
# 320
...
({void*_tmp87=0U;({struct _dyneither_ptr _tmp7C9=({const char*_tmp88="impossible IntCon (not char, short or int)";_tag_dyneither(_tmp88,sizeof(char),43U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp7C9,_tag_dyneither(_tmp87,sizeof(void*),0U));});});}_LLD:;}
# 438
...
({struct Cyc_String_pa_PrintArg_struct _tmp8B=({struct Cyc_String_pa_PrintArg_struct _tmp780;_tmp780.tag=0U,({struct _dyneither_ptr _tmp7CA=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp780.f1=_tmp7CA;});_tmp780;});void*_tmp89[1U];_tmp89[0]=& _tmp8B;({struct _dyneither_ptr _tmp7CB=({const char*_tmp8A="impossible expression type %s (not int, float, double, or pointer)";_tag_dyneither(_tmp8A,sizeof(char),67U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp7CB,_tag_dyneither(_tmp89,sizeof(void*),1U));});});}_LL0:;}
# 445
return function;}
# 447
...
({void*_tmp8F=0U;({struct _dyneither_ptr _tmp7CC=({const char*_tmp90="impossible type (not pointer)";_tag_dyneither(_tmp90,sizeof(char),30U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp7CC,_tag_dyneither(_tmp8F,sizeof(void*),0U));});});}_LL0:;}
# 457
...
# 501
 if(_tmpB0 == 0)
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpA4=({struct Cyc_String_pa_PrintArg_struct _tmp782;_tmp782.tag=0U,_tmp782.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*s);_tmp782;});struct Cyc_String_pa_PrintArg_struct _tmpA5=({struct Cyc_String_pa_PrintArg_struct _tmp781;_tmp781.tag=0U,_tmp781.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmpB1);_tmp781;});void*_tmpA2[2U];_tmpA2[0]=& _tmpA4,_tmpA2[1]=& _tmpA5;({struct _dyneither_ptr _tmp7CD=({const char*_tmpA3="%s_%s_struct";_tag_dyneither(_tmpA3,sizeof(char),13U);});Cyc_aprintf(_tmp7CD,_tag_dyneither(_tmpA2,sizeof(void*),2U));});});{
struct _RegionHandle _tmpA6=_new_region("r");struct _RegionHandle*r=& _tmpA6;_push_region(r);
{struct _dyneither_ptr _tmpAD=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpA9=({struct Cyc_String_pa_PrintArg_struct _tmp785;_tmp785.tag=0U,_tmp785.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*s);_tmp785;});struct Cyc_String_pa_PrintArg_struct _tmpAA=({struct Cyc_String_pa_PrintArg_struct _tmp784;_tmp784.tag=0U,({struct _dyneither_ptr _tmp7D0=(struct _dyneither_ptr)((struct _dyneither_ptr)({struct _RegionHandle*_tmp7CF=r;struct Cyc_List_List*_tmp7CE=_tmpB0;Cyc_rstr_sepstr(_tmp7CF,_tmp7CE,({const char*_tmpAC="_";_tag_dyneither(_tmpAC,sizeof(char),2U);}));}));_tmp784.f1=_tmp7D0;});_tmp784;});struct Cyc_String_pa_PrintArg_struct _tmpAB=({struct Cyc_String_pa_PrintArg_struct _tmp783;_tmp783.tag=0U,_tmp783.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmpB1);_tmp783;});void*_tmpA7[3U];_tmpA7[0]=& _tmpA9,_tmpA7[1]=& _tmpAA,_tmpA7[2]=& _tmpAB;({struct _dyneither_ptr _tmp7D1=({const char*_tmpA8="%s_%s_%s_struct";_tag_dyneither(_tmpA8,sizeof(char),16U);});Cyc_aprintf(_tmp7D1,_tag_dyneither(_tmpA7,sizeof(void*),3U));});});_npop_handler(0U);return _tmpAD;};_pop_region(r);};}_LL3:;};}struct _tuple21{struct Cyc_Toc_TocState*f1;struct _tuple15*f2;};
# 514
...
struct _tuple1*res=({struct _tuple1*_tmpBF=_cycalloc(sizeof(*_tmpBF));_tmpBF->f1=_tmpC1,({struct _dyneither_ptr*_tmp7D2=({struct _dyneither_ptr*_tmpBE=_cycalloc(sizeof(*_tmpBE));*_tmpBE=newvar;_tmpBE;});_tmpBF->f2=_tmp7D2;});_tmpBF;});
({struct Cyc_Dict_Dict _tmp7D3=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple15*k,struct _tuple1*v))Cyc_Dict_insert)(*_tmpC7,_tmpBC,res);*_tmpC7=_tmp7D3;});
...
struct _tuple15 env=({struct _tuple15 _tmp786;_tmp786.f1=fieldname,_tmp786.f2=dtname;_tmp786;});
...
# 540
struct _tuple1*_tmp7D6=({struct _tuple1*_tmpC8=_cycalloc(sizeof(*_tmpC8));({union Cyc_Absyn_Nmspace _tmp7D5=Cyc_Absyn_Rel_n(0);_tmpC8->f1=_tmp7D5;}),_tmpC8->f2=name;_tmpC8;});_tmpCA->name=_tmp7D6;}),({
struct Cyc_Absyn_AggrdeclImpl*_tmp7D4=({struct Cyc_Absyn_AggrdeclImpl*_tmpC9=_cycalloc(sizeof(*_tmpC9));_tmpC9->exist_vars=0,_tmpC9->rgn_po=0,_tmpC9->tagged=0,_tmpC9->fields=fs;_tmpC9;});_tmpCA->impl=_tmp7D4;});_tmpCA;});}struct _tuple22{struct Cyc_Toc_TocState*f1;struct Cyc_List_List*f2;};struct _tuple23{void*f1;struct Cyc_List_List*f2;};
# 549
...
return _tmpD2;};}}{
# 565
struct _dyneither_ptr*xname=({struct _dyneither_ptr*_tmpE0=_cycalloc(sizeof(*_tmpE0));({struct _dyneither_ptr _tmp7D8=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpDF=({struct Cyc_Int_pa_PrintArg_struct _tmp787;_tmp787.tag=1U,_tmp787.f1=(unsigned long)Cyc_Toc_tuple_type_counter ++;_tmp787;});void*_tmpDD[1U];_tmpDD[0]=& _tmpDF;({struct _dyneither_ptr _tmp7D7=({const char*_tmpDE="_tuple%d";_tag_dyneither(_tmpDE,sizeof(char),9U);});Cyc_aprintf(_tmp7D7,_tag_dyneither(_tmpDD,sizeof(void*),1U));});});*_tmpE0=_tmp7D8;});_tmpE0;});
...
({struct Cyc_List_List*_tmp7DB=({struct Cyc_List_List*_tmpD5=_cycalloc(sizeof(*_tmpD5));({struct Cyc_Absyn_Aggrfield*_tmp7DA=({struct Cyc_Absyn_Aggrfield*_tmpD4=_cycalloc(sizeof(*_tmpD4));({struct _dyneither_ptr*_tmp7D9=Cyc_Absyn_fieldname(i);_tmpD4->name=_tmp7D9;}),_tmpD4->tq=Cyc_Toc_mt_tq,_tmpD4->type=(void*)ts2->hd,_tmpD4->width=0,_tmpD4->attributes=0,_tmpD4->requires_clause=0;_tmpD4;});_tmpD5->hd=_tmp7DA;}),_tmpD5->tl=_tmpD3;_tmpD5;});_tmpD3=_tmp7DB;});}}
({struct Cyc_List_List*_tmp7DC=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmpD3);_tmpD3=_tmp7DC;});{
...
({struct Cyc_List_List*_tmp7DE=({struct Cyc_List_List*_tmpD9=_cycalloc(sizeof(*_tmpD9));({struct Cyc_Absyn_Decl*_tmp7DD=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpD8=_cycalloc(sizeof(*_tmpD8));_tmpD8->tag=5U,_tmpD8->f1=_tmpD6;_tmpD8;}),0U);_tmpD9->hd=_tmp7DD;}),_tmpD9->tl=Cyc_Toc_result_decls;_tmpD9;});Cyc_Toc_result_decls=_tmp7DE;});
({struct Cyc_List_List*_tmp7E0=({struct Cyc_List_List*_tmpDB=_region_malloc(d,sizeof(*_tmpDB));({struct _tuple23*_tmp7DF=({struct _tuple23*_tmpDA=_region_malloc(d,sizeof(*_tmpDA));_tmpDA->f1=_tmpD7,_tmpDA->f2=ts;_tmpDA;});_tmpDB->hd=_tmp7DF;}),_tmpDB->tl=*_tmpE2;_tmpDB;});*_tmpE2=_tmp7E0;});
return _tmpD7;};};}
# 578
...
return _tmpE9;}}{
# 597
struct _dyneither_ptr*xname=({struct _dyneither_ptr*_tmpF4=_cycalloc(sizeof(*_tmpF4));({struct _dyneither_ptr _tmp7E2=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpF3=({struct Cyc_Int_pa_PrintArg_struct _tmp788;_tmp788.tag=1U,_tmp788.f1=(unsigned long)Cyc_Toc_tuple_type_counter ++;_tmp788;});void*_tmpF1[1U];_tmpF1[0]=& _tmpF3;({struct _dyneither_ptr _tmp7E1=({const char*_tmpF2="_tuple%d";_tag_dyneither(_tmpF2,sizeof(char),9U);});Cyc_aprintf(_tmp7E1,_tag_dyneither(_tmpF1,sizeof(void*),1U));});});*_tmpF4=_tmp7E2;});_tmpF4;});
...
({struct Cyc_List_List*_tmp7E4=({struct Cyc_List_List*_tmpED=_cycalloc(sizeof(*_tmpED));({struct Cyc_Absyn_Decl*_tmp7E3=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpEC=_cycalloc(sizeof(*_tmpEC));_tmpEC->tag=5U,_tmpEC->f1=_tmpEA;_tmpEC;}),0U);_tmpED->hd=_tmp7E3;}),_tmpED->tl=Cyc_Toc_result_decls;_tmpED;});Cyc_Toc_result_decls=_tmp7E4;});
({struct Cyc_List_List*_tmp7E6=({struct Cyc_List_List*_tmpEF=_region_malloc(d,sizeof(*_tmpEF));({struct _tuple26*_tmp7E5=({struct _tuple26*_tmpEE=_region_malloc(d,sizeof(*_tmpEE));_tmpEE->f1=_tmpEB,_tmpEE->f2=_tmpF6,_tmpEE->f3=_tmpF5;_tmpEE;});_tmpEF->hd=_tmp7E5;}),_tmpEF->tl=*_tmpF7;_tmpEF;});*_tmpF7=_tmp7E6;});
return _tmpEB;};};}
# 605
...
int _tmp7E7=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp11A);_tmp7E7 == ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp104);})){
int okay=1;
...
# 641
 if(Cyc_Tcutil_unify(_tmpFF,_tmp100) || ({void*_tmp7E8=Cyc_Toc_typ_to_c(_tmpFF);Cyc_Tcutil_unify(_tmp7E8,Cyc_Toc_typ_to_c(_tmp100));}))
continue;
okay=0;
goto _LL6;}_LL6:;}
# 646
...
return _tmp103;}}}{
# 655
struct _dyneither_ptr*xname=({struct _dyneither_ptr*_tmp118=_cycalloc(sizeof(*_tmp118));({struct _dyneither_ptr _tmp7EA=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp117=({struct Cyc_Int_pa_PrintArg_struct _tmp789;_tmp789.tag=1U,_tmp789.f1=(unsigned long)Cyc_Toc_tuple_type_counter ++;_tmp789;});void*_tmp115[1U];_tmp115[0]=& _tmp117;({struct _dyneither_ptr _tmp7E9=({const char*_tmp116="_tuple%d";_tag_dyneither(_tmp116,sizeof(char),9U);});Cyc_aprintf(_tmp7E9,_tag_dyneither(_tmp115,sizeof(void*),1U));});});*_tmp118=_tmp7EA;});_tmp118;});
void*x=Cyc_Absyn_strct(xname);
struct Cyc_List_List*_tmp106=0;
# 659
({struct Cyc_List_List*_tmp7EC=({struct Cyc_List_List*_tmp108=_region_malloc(d,sizeof(*_tmp108));({struct _tuple29*_tmp7EB=({struct _tuple29*_tmp107=_region_malloc(d,sizeof(*_tmp107));_tmp107->f1=_tmp11C,_tmp107->f2=_tmp11A,_tmp107->f3=x;_tmp107;});_tmp108->hd=_tmp7EB;}),_tmp108->tl=*_tmp11D;_tmp108;});*_tmp11D=_tmp7EC;});{
# 662
...
({struct Cyc_List_List*_tmp7EE=({struct Cyc_List_List*_tmp10D=_cycalloc(sizeof(*_tmp10D));({void*_tmp7ED=(void*)({struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_tmp10C=_cycalloc(sizeof(*_tmp10C));_tmp10C->tag=6U,_tmp10C->f1=0;_tmp10C;});_tmp10D->hd=_tmp7ED;}),_tmp10D->tl=atts;_tmp10D;});atts=_tmp7EE;});
({void*_tmp7EF=Cyc_Toc_typ_to_c(Cyc_Tcutil_rsubstitute(r,_tmp10A,t));t=_tmp7EF;});
# 679
if(Cyc_Tcutil_unify(t,Cyc_Absyn_void_type))
({void*_tmp7F3=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp10E=_cycalloc(sizeof(*_tmp10E));_tmp10E->tag=4U,({void*_tmp7F2=Cyc_Absyn_void_star_type();(_tmp10E->f1).elt_type=_tmp7F2;}),({struct Cyc_Absyn_Tqual _tmp7F1=Cyc_Absyn_empty_tqual(0U);(_tmp10E->f1).tq=_tmp7F1;}),({
struct Cyc_Absyn_Exp*_tmp7F0=Cyc_Absyn_uint_exp(0U,0U);(_tmp10E->f1).num_elts=_tmp7F0;}),(_tmp10E->f1).zero_term=Cyc_Absyn_false_type,(_tmp10E->f1).zt_loc=0U;_tmp10E;});
# 680
t=_tmp7F3;});
# 683
({struct Cyc_List_List*_tmp7F5=({struct Cyc_List_List*_tmp110=_cycalloc(sizeof(*_tmp110));({struct Cyc_Absyn_Aggrfield*_tmp7F4=({struct Cyc_Absyn_Aggrfield*_tmp10F=_cycalloc(sizeof(*_tmp10F));_tmp10F->name=_tmp10B->name,_tmp10F->tq=Cyc_Toc_mt_tq,_tmp10F->type=t,_tmp10F->width=_tmp10B->width,_tmp10F->attributes=atts,_tmp10F->requires_clause=0;_tmp10F;});_tmp110->hd=_tmp7F4;}),_tmp110->tl=_tmp106;_tmp110;});_tmp106=_tmp7F5;});}
# 685
({struct Cyc_List_List*_tmp7F6=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp106);_tmp106=_tmp7F6;});{
struct Cyc_Absyn_Aggrdecl*_tmp111=Cyc_Toc_make_c_struct_defn(xname,_tmp106);
({struct Cyc_List_List*_tmp7F8=({struct Cyc_List_List*_tmp113=_cycalloc(sizeof(*_tmp113));({struct Cyc_Absyn_Decl*_tmp7F7=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp112=_cycalloc(sizeof(*_tmp112));_tmp112->tag=5U,_tmp112->f1=_tmp111;_tmp112;}),0U);_tmp113->hd=_tmp7F7;}),_tmp113->tl=Cyc_Toc_result_decls;_tmp113;});Cyc_Toc_result_decls=_tmp7F8;});{
...
# 695
struct _tuple27 env=({struct _tuple27 _tmp78A;_tmp78A.f1=struct_name,_tmp78A.f2=type_vars,_tmp78A.f3=type_args,_tmp78A.f4=fields;_tmp78A;});
...
# 703
struct _tuple1*Cyc_Toc_temp_var(){
return({struct _tuple1*_tmp122=_cycalloc(sizeof(*_tmp122));_tmp122->f1=Cyc_Absyn_Loc_n,({struct _dyneither_ptr*_tmp7FB=({struct _dyneither_ptr*_tmp121=_cycalloc(sizeof(*_tmp121));({struct _dyneither_ptr _tmp7FA=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp120=({struct Cyc_Int_pa_PrintArg_struct _tmp78B;_tmp78B.tag=1U,_tmp78B.f1=(unsigned int)Cyc_Toc_temp_var_counter ++;_tmp78B;});void*_tmp11E[1U];_tmp11E[0]=& _tmp120;({struct _dyneither_ptr _tmp7F9=({const char*_tmp11F="_tmp%X";_tag_dyneither(_tmp11F,sizeof(char),7U);});Cyc_aprintf(_tmp7F9,_tag_dyneither(_tmp11E,sizeof(void*),1U));});});*_tmp121=_tmp7FA;});_tmp121;});_tmp122->f2=_tmp7FB;});_tmp122;});}struct _tuple30{struct Cyc_Toc_TocState*f1;int f2;};
# 709
...
if(({int _tmp7FC=_tmp125;_tmp7FC < ((int(*)(struct Cyc_Xarray_Xarray*))Cyc_Xarray_length)(_tmp12C);}))
return((struct _dyneither_ptr*(*)(struct Cyc_Xarray_Xarray*,int))Cyc_Xarray_get)(_tmp12C,_tmp125);{
struct _dyneither_ptr*res=({struct _dyneither_ptr*_tmp12B=_cycalloc(sizeof(*_tmp12B));({struct _dyneither_ptr _tmp7FE=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp12A=({struct Cyc_Int_pa_PrintArg_struct _tmp78C;_tmp78C.tag=1U,_tmp78C.f1=(unsigned int)_tmp125;_tmp78C;});void*_tmp128[1U];_tmp128[0]=& _tmp12A;({struct _dyneither_ptr _tmp7FD=({const char*_tmp129="_LL%X";_tag_dyneither(_tmp129,sizeof(char),6U);});Cyc_aprintf(_tmp7FD,_tag_dyneither(_tmp128,sizeof(void*),1U));});});*_tmp12B=_tmp7FE;});_tmp12B;});
if(({int _tmp7FF=((int(*)(struct Cyc_Xarray_Xarray*,struct _dyneither_ptr*))Cyc_Xarray_add_ind)(_tmp12C,res);_tmp7FF != _tmp125;}))
({void*_tmp126=0U;({struct _dyneither_ptr _tmp800=({const char*_tmp127="fresh_label: add_ind returned bad index...";_tag_dyneither(_tmp127,sizeof(char),43U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp800,_tag_dyneither(_tmp126,sizeof(void*),0U));});});
return res;};};}
# 720
...
return({struct _tuple9*_tmp130=_cycalloc(sizeof(*_tmp130));_tmp130->f1=_tmp133,_tmp130->f2=_tmp132,({void*_tmp801=Cyc_Toc_typ_to_c(_tmp131);_tmp130->f3=_tmp801;});_tmp130;});}
# 762 "toc.cyc"
...
# 765
 return({void*_tmp802=Cyc_Toc_typ_to_c_array(_tmp13A);Cyc_Absyn_cstar_type(_tmp802,_tmp139);});case 1U: _LL3: _tmp13B=(void*)((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp135)->f2;if(_tmp13B != 0){_LL4:
...
static void**cs=0;
if(cs == 0)
({void**_tmp804=({void**_tmp13E=_cycalloc(sizeof(*_tmp13E));({void*_tmp803=Cyc_Absyn_star_type(Cyc_Absyn_char_type,Cyc_Absyn_heap_rgn_type,Cyc_Toc_mt_tq,Cyc_Absyn_false_type);*_tmp13E=_tmp803;});_tmp13E;});cs=_tmp804;});
return*cs;}
# 791
static void*Cyc_Toc_rgn_type(){
static void**r=0;
if(r == 0)
({void**_tmp807=({void**_tmp13F=_cycalloc(sizeof(*_tmp13F));({void*_tmp806=({void*_tmp805=Cyc_Absyn_strct(Cyc_Toc__RegionHandle_sp);Cyc_Absyn_cstar_type(_tmp805,Cyc_Toc_mt_tq);});*_tmp13F=_tmp806;});_tmp13F;});r=_tmp807;});
return*r;}
# 797
static void*Cyc_Toc_dyn_rgn_type(){
static void**r=0;
if(r == 0)
({void**_tmp80A=({void**_tmp140=_cycalloc(sizeof(*_tmp140));({void*_tmp809=({void*_tmp808=Cyc_Absyn_strct(Cyc_Toc__DynRegionHandle_sp);Cyc_Absyn_cstar_type(_tmp808,Cyc_Toc_mt_tq);});*_tmp140=_tmp809;});_tmp140;});r=_tmp80A;});
return*r;}
# 803
...
# 835
({void*_tmp147=0U;({struct _dyneither_ptr _tmp80B=({const char*_tmp148="unresolved DatatypeFieldType";_tag_dyneither(_tmp148,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp80B,_tag_dyneither(_tmp147,sizeof(void*),0U));});});}case 1U: _LLF: _LL10:
# 844
...
# 898
if(_tmp159->impl == 0)
({struct Cyc_String_pa_PrintArg_struct _tmp15C=({struct Cyc_String_pa_PrintArg_struct _tmp78E;_tmp78E.tag=0U,({
struct _dyneither_ptr _tmp80C=(struct _dyneither_ptr)(_tmp159->kind == Cyc_Absyn_UnionA?({const char*_tmp15E="union";_tag_dyneither(_tmp15E,sizeof(char),6U);}):({const char*_tmp15F="struct";_tag_dyneither(_tmp15F,sizeof(char),7U);}));_tmp78E.f1=_tmp80C;});_tmp78E;});struct Cyc_String_pa_PrintArg_struct _tmp15D=({struct Cyc_String_pa_PrintArg_struct _tmp78D;_tmp78D.tag=0U,({
struct _dyneither_ptr _tmp80D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp159->name));_tmp78D.f1=_tmp80D;});_tmp78D;});void*_tmp15A[2U];_tmp15A[0]=& _tmp15C,_tmp15A[1]=& _tmp15D;({struct _dyneither_ptr _tmp80E=({const char*_tmp15B="%s %s was never defined.";_tag_dyneither(_tmp15B,sizeof(char),25U);});Cyc_Tcutil_warn(0U,_tmp80E,_tag_dyneither(_tmp15A,sizeof(void*),2U));});});}
# 906
...
if(_tmp159->expected_mem_kind)
({struct Cyc_String_pa_PrintArg_struct _tmp164=({struct Cyc_String_pa_PrintArg_struct _tmp78F;_tmp78F.tag=0U,({struct _dyneither_ptr _tmp80F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp159->name));_tmp78F.f1=_tmp80F;});_tmp78F;});void*_tmp162[1U];_tmp162[0]=& _tmp164;({struct _dyneither_ptr _tmp810=({const char*_tmp163="struct %s ended up being abstract.";_tag_dyneither(_tmp163,sizeof(char),35U);});Cyc_Tcutil_warn(0U,_tmp810,_tag_dyneither(_tmp162,sizeof(void*),1U));});});{
# 919
...
# 839
({void*_tmp811=Cyc_Toc_typ_to_c(_tmp176);_tmp176=_tmp811;});
...
# 847
 return({void*_tmp815=Cyc_Toc_typ_to_c(_tmp17A);struct Cyc_Absyn_Tqual _tmp814=_tmp179;struct Cyc_Absyn_Exp*_tmp813=_tmp178;void*_tmp812=Cyc_Absyn_false_type;Cyc_Absyn_array_type(_tmp815,_tmp814,_tmp813,_tmp812,_tmp177);});case 5U: _LL15: _tmp180=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp146)->f1).ret_tqual;_tmp17F=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp146)->f1).ret_type;_tmp17E=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp146)->f1).args;_tmp17D=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp146)->f1).c_varargs;_tmp17C=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp146)->f1).cyc_varargs;_tmp17B=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp146)->f1).attributes;_LL16: {
# 853
...
({struct Cyc_List_List*_tmp816=({struct Cyc_List_List*_tmp14C=_cycalloc(sizeof(*_tmp14C));_tmp14C->hd=(void*)_tmp17B->hd,_tmp14C->tl=_tmp149;_tmp14C;});_tmp149=_tmp816;});goto _LL35;}_LL35:;}{
# 864
...
({struct Cyc_List_List*_tmp818=({struct Cyc_List_List*_tmp817=_tmp14D;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp817,({struct Cyc_List_List*_tmp150=_cycalloc(sizeof(*_tmp150));_tmp150->hd=_tmp14F,_tmp150->tl=0;_tmp150;}));});_tmp14D=_tmp818;});}
# 871
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp152=_cycalloc(sizeof(*_tmp152));_tmp152->tag=5U,(_tmp152->f1).tvars=0,(_tmp152->f1).effect=0,(_tmp152->f1).ret_tqual=_tmp180,({void*_tmp819=Cyc_Toc_typ_to_c(_tmp17F);(_tmp152->f1).ret_type=_tmp819;}),(_tmp152->f1).args=_tmp14D,(_tmp152->f1).c_varargs=_tmp17D,(_tmp152->f1).cyc_varargs=0,(_tmp152->f1).rgn_po=0,(_tmp152->f1).attributes=_tmp149,(_tmp152->f1).requires_clause=0,(_tmp152->f1).requires_relns=0,(_tmp152->f1).ensures_clause=0,(_tmp152->f1).ensures_relns=0;_tmp152;});};}case 6U: _LL17: _tmp181=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp146)->f1;_LL18: {
# 876
struct Cyc_List_List*_tmp153=0;
for(0;_tmp181 != 0;_tmp181=_tmp181->tl){
({struct Cyc_List_List*_tmp81C=({struct Cyc_List_List*_tmp155=_cycalloc(sizeof(*_tmp155));({struct _tuple12*_tmp81B=({struct _tuple12*_tmp154=_cycalloc(sizeof(*_tmp154));_tmp154->f1=(*((struct _tuple12*)_tmp181->hd)).f1,({void*_tmp81A=Cyc_Toc_typ_to_c((*((struct _tuple12*)_tmp181->hd)).f2);_tmp154->f2=_tmp81A;});_tmp154;});_tmp155->hd=_tmp81B;}),_tmp155->tl=_tmp153;_tmp155;});_tmp153=_tmp81C;});}
...
({struct Cyc_List_List*_tmp81F=({struct Cyc_List_List*_tmp157=_cycalloc(sizeof(*_tmp157));({struct Cyc_Absyn_Aggrfield*_tmp81E=({struct Cyc_Absyn_Aggrfield*_tmp81D=(struct Cyc_Absyn_Aggrfield*)_tmp182->hd;Cyc_Toc_aggrfield_to_c(_tmp81D,Cyc_Toc_typ_to_c(((struct Cyc_Absyn_Aggrfield*)_tmp182->hd)->type));});_tmp157->hd=_tmp81E;}),_tmp157->tl=_tmp156;_tmp157;});_tmp156=_tmp81F;});}
return({enum Cyc_Absyn_AggrKind _tmp820=_tmp183;Cyc_Toc_add_anon_aggr_type(_tmp820,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp156));});}case 8U: _LL21: _tmp187=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp146)->f1;_tmp186=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp146)->f2;_tmp185=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp146)->f3;_tmp184=(void*)((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp146)->f4;_LL22:
# 931
 if(_tmp184 == 0){
if(_tmp186 != 0)
...
return t;}}else{
# 936
return(void*)({struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmp16B=_cycalloc(sizeof(*_tmp16B));_tmp16B->tag=8U,_tmp16B->f1=_tmp187,_tmp16B->f2=0,_tmp16B->f3=_tmp185,({void*_tmp821=Cyc_Toc_typ_to_c(_tmp184);_tmp16B->f4=_tmp821;});_tmp16B;});}case 9U: _LL2B: _tmp188=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp146)->f1;_LL2C:
# 947
...
# 971
 return({void*_tmp822=Cyc_Absyn_star_type(_tmp190,Cyc_Absyn_heap_rgn_type,_tmp18F,Cyc_Absyn_false_type);Cyc_Toc_cast_it(_tmp822,e);});}else{_LL3: _LL4:
...
({struct Cyc_String_pa_PrintArg_struct _tmp19A=({struct Cyc_String_pa_PrintArg_struct _tmp790;_tmp790.tag=0U,({struct _dyneither_ptr _tmp823=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp790.f1=_tmp823;});_tmp790;});void*_tmp198[1U];_tmp198[0]=& _tmp19A;({struct _dyneither_ptr _tmp824=({const char*_tmp199="atomic_typ:  bad type %s";_tag_dyneither(_tmp199,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp824,_tag_dyneither(_tmp198,sizeof(void*),1U));});});}_LL11:;}case 5U: _LL5: _LL6:
# 1006
...
({struct Cyc_String_pa_PrintArg_struct _tmp1A0=({struct Cyc_String_pa_PrintArg_struct _tmp791;_tmp791.tag=0U,({struct _dyneither_ptr _tmp825=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp791.f1=_tmp825;});_tmp791;});void*_tmp19E[1U];_tmp19E[0]=& _tmp1A0;({struct _dyneither_ptr _tmp826=({const char*_tmp19F="atomic_typ:  bad type %s";_tag_dyneither(_tmp19F,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp826,_tag_dyneither(_tmp19E,sizeof(void*),1U));});});}_LL0:;}
# 1028
...
if(_tmp1AB->impl == 0)
({void*_tmp1AC=0U;({struct _dyneither_ptr _tmp827=({const char*_tmp1AD="is_poly_field: type missing fields";_tag_dyneither(_tmp1AD,sizeof(char),35U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp827,_tag_dyneither(_tmp1AC,sizeof(void*),0U));});});
...
if(_tmp1AE == 0)
({struct Cyc_String_pa_PrintArg_struct _tmp1B1=({struct Cyc_String_pa_PrintArg_struct _tmp792;_tmp792.tag=0U,_tmp792.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp792;});void*_tmp1AF[1U];_tmp1AF[0]=& _tmp1B1;({struct _dyneither_ptr _tmp828=({const char*_tmp1B0="is_poly_field: bad field %s";_tag_dyneither(_tmp1B0,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp828,_tag_dyneither(_tmp1AF,sizeof(void*),1U));});});
return Cyc_Toc_is_void_star_or_boxed_tvar(_tmp1AE->type);}default: _LL5: _LL6:
({struct Cyc_String_pa_PrintArg_struct _tmp1B4=({struct Cyc_String_pa_PrintArg_struct _tmp793;_tmp793.tag=0U,({struct _dyneither_ptr _tmp829=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp793.f1=_tmp829;});_tmp793;});void*_tmp1B2[1U];_tmp1B2[0]=& _tmp1B4;({struct _dyneither_ptr _tmp82A=({const char*_tmp1B3="is_poly_field: bad type %s";_tag_dyneither(_tmp1B3,sizeof(char),27U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp82A,_tag_dyneither(_tmp1B2,sizeof(void*),1U));});});}_LL0:;}
# 1064
...
({struct Cyc_String_pa_PrintArg_struct _tmp1BD=({struct Cyc_String_pa_PrintArg_struct _tmp794;_tmp794.tag=0U,({struct _dyneither_ptr _tmp82B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmp1C2->topt)));_tmp794.f1=_tmp82B;});_tmp794;});void*_tmp1BB[1U];_tmp1BB[0]=& _tmp1BD;({struct _dyneither_ptr _tmp82C=({const char*_tmp1BC="is_poly_project: bad type %s";_tag_dyneither(_tmp1BC,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp82C,_tag_dyneither(_tmp1BB,sizeof(void*),1U));});});}_LL7:;}default: _LL5: _LL6:
# 1075
 return 0;}_LL0:;}
# 1080
static struct Cyc_Absyn_Exp*Cyc_Toc_malloc_ptr(struct Cyc_Absyn_Exp*s){
return({struct Cyc_Absyn_Exp*_tmp82D=Cyc_Toc__cycalloc_e;Cyc_Absyn_fncall_exp(_tmp82D,({struct Cyc_List_List*_tmp1C3=_cycalloc(sizeof(*_tmp1C3));_tmp1C3->hd=s,_tmp1C3->tl=0;_tmp1C3;}),0U);});}
# 1084
static struct Cyc_Absyn_Exp*Cyc_Toc_malloc_atomic(struct Cyc_Absyn_Exp*s){
return({struct Cyc_Absyn_Exp*_tmp82E=Cyc_Toc__cycalloc_atomic_e;Cyc_Absyn_fncall_exp(_tmp82E,({struct Cyc_List_List*_tmp1C4=_cycalloc(sizeof(*_tmp1C4));_tmp1C4->hd=s,_tmp1C4->tl=0;_tmp1C4;}),0U);});}
# 1088
...
return({struct Cyc_Absyn_Exp*_tmp82F=Cyc_Toc__region_malloc_e;Cyc_Absyn_fncall_exp(_tmp82F,({struct Cyc_Absyn_Exp*_tmp1C5[2U];_tmp1C5[0]=rgn,_tmp1C5[1]=s;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1C5,sizeof(struct Cyc_Absyn_Exp*),2U));}),0U);});}
# 1098
static struct Cyc_Absyn_Exp*Cyc_Toc_rmalloc_inline_exp(struct Cyc_Absyn_Exp*rgn,struct Cyc_Absyn_Exp*s){
return({struct Cyc_Absyn_Exp*_tmp830=Cyc_Toc__fast_region_malloc_e;Cyc_Absyn_fncall_exp(_tmp830,({struct Cyc_Absyn_Exp*_tmp1C6[2U];_tmp1C6[0]=rgn,_tmp1C6[1]=s;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1C6,sizeof(struct Cyc_Absyn_Exp*),2U));}),0U);});}
# 1102
static struct Cyc_Absyn_Exp*Cyc_Toc_calloc_exp(void*elt_type,struct Cyc_Absyn_Exp*s,struct Cyc_Absyn_Exp*n){
if(Cyc_Toc_atomic_type(elt_type))
return({struct Cyc_Absyn_Exp*_tmp831=Cyc_Toc__cyccalloc_atomic_e;Cyc_Absyn_fncall_exp(_tmp831,({struct Cyc_Absyn_Exp*_tmp1C7[2U];_tmp1C7[0]=s,_tmp1C7[1]=n;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1C7,sizeof(struct Cyc_Absyn_Exp*),2U));}),0U);});else{
# 1106
return({struct Cyc_Absyn_Exp*_tmp832=Cyc_Toc__cyccalloc_e;Cyc_Absyn_fncall_exp(_tmp832,({struct Cyc_Absyn_Exp*_tmp1C8[2U];_tmp1C8[0]=s,_tmp1C8[1]=n;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1C8,sizeof(struct Cyc_Absyn_Exp*),2U));}),0U);});}}
# 1109
static struct Cyc_Absyn_Exp*Cyc_Toc_rcalloc_exp(struct Cyc_Absyn_Exp*rgn,struct Cyc_Absyn_Exp*s,struct Cyc_Absyn_Exp*n){
return({struct Cyc_Absyn_Exp*_tmp833=Cyc_Toc__region_calloc_e;Cyc_Absyn_fncall_exp(_tmp833,({struct Cyc_Absyn_Exp*_tmp1C9[3U];_tmp1C9[0]=rgn,_tmp1C9[1]=s,_tmp1C9[2]=n;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1C9,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);});}
# 1113
static struct Cyc_Absyn_Exp*Cyc_Toc_newthrow_exp(struct Cyc_Absyn_Exp*e){
return({struct Cyc_Absyn_Exp*_tmp834=Cyc_Toc__throw_e;Cyc_Absyn_fncall_exp(_tmp834,({struct Cyc_List_List*_tmp1CA=_cycalloc(sizeof(*_tmp1CA));_tmp1CA->hd=e,_tmp1CA->tl=0;_tmp1CA;}),0U);});}
# 1116
static struct Cyc_Absyn_Exp*Cyc_Toc_newrethrow_exp(struct Cyc_Absyn_Exp*e){
return({struct Cyc_Absyn_Exp*_tmp835=Cyc_Toc__rethrow_e;Cyc_Absyn_fncall_exp(_tmp835,({struct Cyc_List_List*_tmp1CB=_cycalloc(sizeof(*_tmp1CB));_tmp1CB->hd=e,_tmp1CB->tl=0;_tmp1CB;}),0U);});}
# 1120
static struct Cyc_Absyn_Stmt*Cyc_Toc_throw_match_stmt(){
return Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmp836=Cyc_Toc__throw_match_e;Cyc_Absyn_fncall_exp(_tmp836,({void*_tmp1CC=0U;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1CC,sizeof(struct Cyc_Absyn_Exp*),0U));}),0U);}),0U);}
# 1125
...
({struct Cyc_List_List*_tmp838=({struct Cyc_List_List*_tmp1D0=_cycalloc(sizeof(*_tmp1D0));({struct Cyc_Absyn_Decl*_tmp837=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp1CF=_cycalloc(sizeof(*_tmp1CF));_tmp1CF->tag=0U,_tmp1CF->f1=vd;_tmp1CF;}),0U);_tmp1D0->hd=_tmp837;}),_tmp1D0->tl=Cyc_Toc_result_decls;_tmp1D0;});Cyc_Toc_result_decls=_tmp838;});
({struct Cyc_Absyn_Exp*_tmp839=Cyc_Absyn_var_exp(x,0U);xexp=_tmp839;});
({struct Cyc_Absyn_Exp*_tmp83A=Cyc_Absyn_add_exp(xexp,sz,0U);xplussz=_tmp83A;});}else{
# 1149
({struct Cyc_Absyn_Exp*_tmp83C=({void*_tmp83B=Cyc_Absyn_void_star_type();Cyc_Toc_cast_it(_tmp83B,e);});xexp=_tmp83C;});
# 1151
({struct Cyc_Absyn_Exp*_tmp83E=({void*_tmp83D=Cyc_Absyn_void_star_type();Cyc_Toc_cast_it(_tmp83D,Cyc_Absyn_add_exp(e,sz,0U));});xplussz=_tmp83E;});}
# 1153
return Cyc_Absyn_unresolvedmem_exp(0,({struct _tuple20*_tmp1D1[3U];({struct _tuple20*_tmp841=({struct _tuple20*_tmp1D2=_cycalloc(sizeof(*_tmp1D2));_tmp1D2->f1=0,_tmp1D2->f2=xexp;_tmp1D2;});_tmp1D1[0]=_tmp841;}),({
struct _tuple20*_tmp840=({struct _tuple20*_tmp1D3=_cycalloc(sizeof(*_tmp1D3));_tmp1D3->f1=0,_tmp1D3->f2=xexp;_tmp1D3;});_tmp1D1[1]=_tmp840;}),({
struct _tuple20*_tmp83F=({struct _tuple20*_tmp1D4=_cycalloc(sizeof(*_tmp1D4));_tmp1D4->f1=0,_tmp1D4->f2=xplussz;_tmp1D4;});_tmp1D1[2]=_tmp83F;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1D1,sizeof(struct _tuple20*),3U));}),0U);};}struct Cyc_Toc_FallthruInfo{struct _dyneither_ptr*label;struct Cyc_List_List*binders;};struct Cyc_Toc_Env{struct _dyneither_ptr**break_lab;struct _dyneither_ptr**continue_lab;struct Cyc_Toc_FallthruInfo*fallthru_info;int toplevel;int*in_lhs;int*in_sizeof;struct _RegionHandle*rgn;};
# 1190 "toc.cyc"
...
# 1205
int*_tmp843=({int*_tmp1D9=_region_malloc(r,sizeof(*_tmp1D9));*_tmp1D9=0;_tmp1D9;});_tmp1DB->in_lhs=_tmp843;}),({
int*_tmp842=({int*_tmp1DA=_region_malloc(r,sizeof(*_tmp1DA));*_tmp1DA=0;_tmp1DA;});_tmp1DB->in_sizeof=_tmp842;}),_tmp1DB->rgn=r;_tmp1DB;});}
# 1210
...
return({struct Cyc_Toc_Env*_tmp205=_region_malloc(r,sizeof(*_tmp205));({struct _dyneither_ptr**_tmp844=({struct _dyneither_ptr**_tmp204=_region_malloc(r,sizeof(*_tmp204));*_tmp204=break_l;_tmp204;});_tmp205->break_lab=_tmp844;}),_tmp205->continue_lab=_tmp20B,_tmp205->fallthru_info=fi,_tmp205->toplevel=_tmp209,_tmp205->in_lhs=_tmp208,_tmp205->in_sizeof=_tmp207,_tmp205->rgn=r;_tmp205;});};}
# 1256
...
return({struct Cyc_Toc_Env*_tmp20F=_region_malloc(r,sizeof(*_tmp20F));({struct _dyneither_ptr**_tmp845=({struct _dyneither_ptr**_tmp20E=_region_malloc(r,sizeof(*_tmp20E));*_tmp20E=break_l;_tmp20E;});_tmp20F->break_lab=_tmp845;}),_tmp20F->continue_lab=_tmp214,_tmp20F->fallthru_info=0,_tmp20F->toplevel=_tmp212,_tmp20F->in_lhs=_tmp211,_tmp20F->in_sizeof=_tmp210,_tmp20F->rgn=r;_tmp20F;});}
# 1265
...
return({struct Cyc_Toc_Env*_tmp218=_region_malloc(r,sizeof(*_tmp218));_tmp218->break_lab=0,_tmp218->continue_lab=_tmp21D,({struct Cyc_Toc_FallthruInfo*_tmp846=({struct Cyc_Toc_FallthruInfo*_tmp217=_region_malloc(r,sizeof(*_tmp217));_tmp217->label=next_l,_tmp217->binders=0;_tmp217;});_tmp218->fallthru_info=_tmp846;}),_tmp218->toplevel=_tmp21B,_tmp218->in_lhs=_tmp21A,_tmp218->in_sizeof=_tmp219,_tmp218->rgn=r;_tmp218;});}
# 1281 "toc.cyc"
...
({void*_tmp223=0U;({struct _dyneither_ptr _tmp847=({const char*_tmp224="Toc::is_nullable";_tag_dyneither(_tmp224,sizeof(char),17U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp847,_tag_dyneither(_tmp223,sizeof(void*),0U));});});}_LLB:;}}else{if(((struct Cyc_CfFlowInfo_NotZero_Absyn_AbsynAnnot_struct*)_tmp220)->tag == Cyc_CfFlowInfo_NotZero){_LL3: _LL4:
# 1297
 return 0;}else{if(((struct Cyc_CfFlowInfo_IsZero_Absyn_AbsynAnnot_struct*)_tmp220)->tag == Cyc_CfFlowInfo_IsZero){_LL5: _LL6:
# 1299
({void*_tmp226=0U;({unsigned int _tmp849=e->loc;struct _dyneither_ptr _tmp848=({const char*_tmp227="NULL pointer check will definitely fail";_tag_dyneither(_tmp227,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp849,_tmp848,_tag_dyneither(_tmp226,sizeof(void*),0U));});});
...
({void*_tmp228=0U;({struct _dyneither_ptr _tmp84A=({const char*_tmp229="need_null_check";_tag_dyneither(_tmp229,sizeof(char),16U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp84A,_tag_dyneither(_tmp228,sizeof(void*),0U));});});}}}}_LL0:;}
# 1310
...
# 1315
({void*_tmp22C=0U;({unsigned int _tmp84C=e->loc;struct _dyneither_ptr _tmp84B=({const char*_tmp22D="dereference of NULL pointer";_tag_dyneither(_tmp22D,sizeof(char),28U);});Cyc_Tcutil_terr(_tmp84C,_tmp84B,_tag_dyneither(_tmp22C,sizeof(void*),0U));});});
...
({void*_tmp22E=0U;({struct _dyneither_ptr _tmp84D=({const char*_tmp22F="get_relns";_tag_dyneither(_tmp22F,sizeof(char),10U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp84D,_tag_dyneither(_tmp22E,sizeof(void*),0U));});});}}}}_LL0:;}static char _tmp235[8U]="*bogus*";
# 1325
...
({struct Cyc_List_List*_tmp84E=Cyc_Relations_add_relation(Cyc_Core_heap_region,rop_bound,Cyc_Relations_Rlte,rop_a,relns);relns=_tmp84E;});}
# 1382
if(valid_rop_i){
...
if(e->topt == 0)({void*_tmp243=0U;({struct _dyneither_ptr _tmp84F=({const char*_tmp244="Missing type in primop ";_tag_dyneither(_tmp244,sizeof(char),24U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp84F,_tag_dyneither(_tmp243,sizeof(void*),0U));});});
return(void*)_check_null(e->topt);}
# 1421
static struct _tuple12*Cyc_Toc_tup_to_c(struct Cyc_Absyn_Exp*e){
return({struct _tuple12*_tmp245=_cycalloc(sizeof(*_tmp245));_tmp245->f1=Cyc_Toc_mt_tq,({void*_tmp850=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));_tmp245->f2=_tmp850;});_tmp245;});}
# 1426
...
({void*_tmp249=0U;({struct _dyneither_ptr _tmp851=({const char*_tmp24A="array designators for abstract-field initialization";_tag_dyneither(_tmp24A,sizeof(char),52U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(_tmp851,_tag_dyneither(_tmp249,sizeof(void*),0U));});});}}
({struct Cyc_Absyn_Exp*_tmp852=Cyc_Absyn_signed_int_exp(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp24B),0U);_tmp24D=_tmp852;});_tmp24C=0;goto _LL4;case 27U: _LL3: _tmp24D=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp247)->f2;_tmp24C=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp247)->f4;_LL4:
...
# 1435
({struct Cyc_Absyn_Exp*_tmp853=Cyc_Absyn_copy_exp(_tmp24F);_tmp24F=_tmp853;});
return _tmp24E?({struct Cyc_Absyn_Exp*_tmp854=_tmp24F;Cyc_Absyn_add_exp(_tmp854,Cyc_Absyn_uint_exp(1U,0U),0U);}): _tmp24F;default: _LL7: _LL8:
 return 0;}_LL0:;}
# 1444
...
return 0;
# 1491
return({struct Cyc_Absyn_Exp*_tmp857=({struct Cyc_Absyn_Exp*_tmp856=Cyc_Toc__check_times_e;Cyc_Absyn_fncall_exp(_tmp856,({struct Cyc_Absyn_Exp*_tmp25D[2U];_tmp25D[0]=(struct Cyc_Absyn_Exp*)_check_null(Cyc_Toc_array_length_exp(_tmp260)),({
# 1493
struct Cyc_Absyn_Exp*_tmp855=Cyc_Absyn_sizeoftype_exp(_tmp25F,0U);_tmp25D[1]=_tmp855;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp25D,sizeof(struct Cyc_Absyn_Exp*),2U));}),0U);});
# 1491
Cyc_Absyn_add_exp(_tmp857,
# 1494
Cyc_Absyn_signed_int_exp((int)sizeof(double),0U),0U);});}else{_LL10: _LL11:
 return 0;}_LLD:;};}};}
# 1499
({void*_tmp262=0U;({struct _dyneither_ptr _tmp858=({const char*_tmp263="get_varsizeexp: did not find last struct field";_tag_dyneither(_tmp263,sizeof(char),47U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp858,_tag_dyneither(_tmp262,sizeof(void*),0U));});});};}
# 1502
...
++ i;}}
# 1509
({void*_tmp266=0U;({struct _dyneither_ptr _tmp85A=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp269=({struct Cyc_String_pa_PrintArg_struct _tmp795;_tmp795.tag=0U,_tmp795.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp795;});void*_tmp267[1U];_tmp267[0]=& _tmp269;({struct _dyneither_ptr _tmp859=({const char*_tmp268="get_member_offset %s failed";_tag_dyneither(_tmp268,sizeof(char),28U);});Cyc_aprintf(_tmp859,_tag_dyneither(_tmp267,sizeof(void*),1U));});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp85A,_tag_dyneither(_tmp266,sizeof(void*),0U));});});}struct _tuple31{struct Cyc_Core_Opt*f1;struct Cyc_Absyn_Exp*f2;};
# 1513
...
# 1539
 e1->r=_tmp274->r;
({struct Cyc_Absyn_Exp*_tmp85D=e1;struct Cyc_List_List*_tmp85C=({struct Cyc_List_List*_tmp26D=_cycalloc(sizeof(*_tmp26D));_tmp26D->hd=_tmp273,_tmp26D->tl=fs;_tmp26D;});struct Cyc_Absyn_Exp*(*_tmp85B)(struct Cyc_Absyn_Exp*,void*)=f;Cyc_Toc_lvalue_assign(_tmp85D,_tmp85C,_tmp85B,f_env);});
goto _LL0;default: _LL7: _LL8: {
# 1547
struct Cyc_Absyn_Exp*e1_copy=Cyc_Absyn_copy_exp(e1);
# 1549
for(0;fs != 0;fs=fs->tl){
({struct Cyc_Absyn_Exp*_tmp85E=Cyc_Toc_member_exp(e1_copy,(struct _dyneither_ptr*)fs->hd,e1_copy->loc);e1_copy=_tmp85E;});}
({void*_tmp85F=(f(e1_copy,f_env))->r;e1->r=_tmp85F;});
goto _LL0;}}_LL0:;}
# 1555
static void Cyc_Toc_lvalue_assign_stmt(struct Cyc_Absyn_Stmt*s,struct Cyc_List_List*fs,struct Cyc_Absyn_Exp*(*f)(struct Cyc_Absyn_Exp*,void*),void*f_env){
# 1557
...
({struct Cyc_String_pa_PrintArg_struct _tmp279=({struct Cyc_String_pa_PrintArg_struct _tmp796;_tmp796.tag=0U,({struct _dyneither_ptr _tmp860=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_stmt2string(s));_tmp796.f1=_tmp860;});_tmp796;});void*_tmp277[1U];_tmp277[0]=& _tmp279;({struct _dyneither_ptr _tmp861=({const char*_tmp278="lvalue_assign_stmt: %s";_tag_dyneither(_tmp278,sizeof(char),23U);});Cyc_Toc_toc_impos(_tmp861,_tag_dyneither(_tmp277,sizeof(void*),1U));});});}_LL0:;}
# 1566
...
# 1573
({struct Cyc_Absyn_Exp*_tmp862=Cyc_Toc_push_address_exp(*_tmp283);*_tmp283=_tmp862;});
({void*_tmp863=Cyc_Absyn_cstar_type(*_tmp284,Cyc_Toc_mt_tq);*_tmp284=_tmp863;});
...
({struct Cyc_String_pa_PrintArg_struct _tmp282=({struct Cyc_String_pa_PrintArg_struct _tmp797;_tmp797.tag=0U,({struct _dyneither_ptr _tmp864=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp797.f1=_tmp864;});_tmp797;});void*_tmp280[1U];_tmp280[0]=& _tmp282;({struct _dyneither_ptr _tmp865=({const char*_tmp281="can't take & of exp %s";_tag_dyneither(_tmp281,sizeof(char),23U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp865,_tag_dyneither(_tmp280,sizeof(void*),1U));});});}_LL0:;}
# 1589
static void Cyc_Toc_push_address_stmt(struct Cyc_Absyn_Stmt*s){
...
({struct Cyc_Absyn_Exp*_tmp866=Cyc_Toc_push_address_exp(*_tmp28E);*_tmp28E=_tmp866;});goto _LL0;default: _LL7: _LL8:
({struct Cyc_String_pa_PrintArg_struct _tmp28B=({struct Cyc_String_pa_PrintArg_struct _tmp798;_tmp798.tag=0U,({struct _dyneither_ptr _tmp867=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_stmt2string(s));_tmp798.f1=_tmp867;});_tmp798;});void*_tmp289[1U];_tmp289[0]=& _tmp28B;({struct _dyneither_ptr _tmp868=({const char*_tmp28A="can't take & of stmt %s";_tag_dyneither(_tmp28A,sizeof(char),24U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp868,_tag_dyneither(_tmp289,sizeof(void*),1U));});});}_LL0:;}
# 1598
...
({void*_tmp291=0U;({struct _dyneither_ptr _tmp869=({const char*_tmp292="get_ptr_typ: not a pointer!";_tag_dyneither(_tmp292,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp869,_tag_dyneither(_tmp291,sizeof(void*),0U));});});}_LL0:;}
# 1608
...
({struct Cyc_Absyn_Exp*_tmp86A=Cyc_Absyn_null_exp(0U);res=_tmp86A;});goto _LL0;case 0U: _LL3: _tmp2A6=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp295)->f1;_LL4:
# 1613
...
# 1615
({struct Cyc_Absyn_Exp*_tmp86B=Cyc_Absyn_const_exp(Cyc_Absyn_Char_c(_tmp29D,'\000'),0U);res=_tmp86B;});goto _LL7;case Cyc_Absyn_Short_sz: _LLA: _tmp29E=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp296)->f1;_LLB:
# 1617
({struct Cyc_Absyn_Exp*_tmp86C=Cyc_Absyn_const_exp(Cyc_Absyn_Short_c(_tmp29E,0),0U);res=_tmp86C;});goto _LL7;case Cyc_Absyn_Int_sz: _LL10: _tmp29F=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp296)->f1;_LL11:
# 1620
...
# 1622
({struct Cyc_Absyn_Exp*_tmp86D=Cyc_Absyn_const_exp(Cyc_Absyn_Int_c(_tmp2A0,0),0U);res=_tmp86D;});goto _LL7;default: _LL14: _tmp2A1=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp296)->f1;_LL15:
# 1624
({struct Cyc_Absyn_Exp*_tmp86E=Cyc_Absyn_const_exp(Cyc_Absyn_LongLong_c(_tmp2A1,(long long)0),0U);res=_tmp86E;});goto _LL7;}case 15U: _LLC: _LLD:
# 1618
...
# 1625
({struct Cyc_Absyn_Exp*_tmp86F=Cyc_Absyn_const_exp(Cyc_Absyn_Float_c(({const char*_tmp297="0.0F";_tag_dyneither(_tmp297,sizeof(char),5U);}),0),0U);res=_tmp86F;});goto _LL7;case 1U: _LL18: _LL19:
({struct Cyc_Absyn_Exp*_tmp870=Cyc_Absyn_const_exp(Cyc_Absyn_Float_c(({const char*_tmp298="0.0";_tag_dyneither(_tmp298,sizeof(char),4U);}),1),0U);res=_tmp870;});goto _LL7;default: _LL1A: _tmp2A2=((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp296)->f1;_LL1B:
({struct Cyc_Absyn_Exp*_tmp872=Cyc_Absyn_const_exp(({struct _dyneither_ptr _tmp871=({const char*_tmp299="0.0L";_tag_dyneither(_tmp299,sizeof(char),5U);});Cyc_Absyn_Float_c(_tmp871,_tmp2A2);}),0U);res=_tmp872;});goto _LL7;}default: _LL1C: _LL1D:
# 1629
({struct Cyc_String_pa_PrintArg_struct _tmp29C=({struct Cyc_String_pa_PrintArg_struct _tmp799;_tmp799.tag=0U,({struct _dyneither_ptr _tmp873=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp799.f1=_tmp873;});_tmp799;});void*_tmp29A[1U];_tmp29A[0]=& _tmp29C;({struct _dyneither_ptr _tmp874=({const char*_tmp29B="found non-zero type %s in generate_zero";_tag_dyneither(_tmp29B,sizeof(char),40U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp874,_tag_dyneither(_tmp29A,sizeof(void*),1U));});});}_LL7:;}
# 1631
goto _LL0;default: _LL5: _LL6:
# 1633
({struct Cyc_String_pa_PrintArg_struct _tmp2A5=({struct Cyc_String_pa_PrintArg_struct _tmp79A;_tmp79A.tag=0U,({struct _dyneither_ptr _tmp875=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp79A.f1=_tmp875;});_tmp79A;});void*_tmp2A3[1U];_tmp2A3[0]=& _tmp2A5;({struct _dyneither_ptr _tmp876=({const char*_tmp2A4="found non-zero type %s in generate_zero";_tag_dyneither(_tmp2A4,sizeof(char),40U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp876,_tag_dyneither(_tmp2A3,sizeof(void*),1U));});});}_LL0:;}
# 1635
res->topt=t;
return res;}
# 1642
...
# 1663
 if(!is_dyneither){
({struct Cyc_Absyn_Exp*_tmp877=Cyc_Absyn_cast_exp(fat_ptr_type,_tmp2B0,0,Cyc_Absyn_Other_coercion,0U);_tmp2B0=_tmp877;});
...
# 1669
 if(!is_dyneither){
({struct Cyc_Absyn_Exp*_tmp878=Cyc_Absyn_cast_exp(fat_ptr_type,_tmp2B2,0,Cyc_Absyn_Other_coercion,0U);_tmp2B2=_tmp878;});
_tmp2B2->topt=fat_ptr_type;}
# 1673
Cyc_Toc_exp_to_c(nv,_tmp2B2);Cyc_Toc_exp_to_c(nv,_tmp2B1);
({struct Cyc_Absyn_Exp*_tmp87B=({struct Cyc_Absyn_Exp*_tmp87A=Cyc_Toc__dyneither_ptr_plus_e;Cyc_Absyn_fncall_exp(_tmp87A,({struct Cyc_Absyn_Exp*_tmp2AD[3U];_tmp2AD[0]=_tmp2B2,({
struct Cyc_Absyn_Exp*_tmp879=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp2AD[1]=_tmp879;}),_tmp2AD[2]=_tmp2B1;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp2AD,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);});
# 1674
xinit=_tmp87B;});
# 1676
goto _LL0;default: _LL5: _LL6:
({void*_tmp2AE=0U;({struct _dyneither_ptr _tmp87C=({const char*_tmp2AF="found bad lhs for zero-terminated pointer assignment";_tag_dyneither(_tmp2AF,sizeof(char),53U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp87C,_tag_dyneither(_tmp2AE,sizeof(void*),0U));});});}_LL0:;}{
# 1679
...
({struct Cyc_Absyn_Exp*_tmp87D=Cyc_Absyn_prim2_exp((enum Cyc_Absyn_Primop)popt->v,_tmp2BC,e2,0U);z_init=_tmp87D;});
...
# 1716
struct Cyc_List_List*_tmp2C6=({struct Cyc_Absyn_Exp*_tmp2D4[2U];({struct Cyc_Absyn_Exp*_tmp87F=Cyc_Absyn_varb_exp((void*)_tmp2B6,0U);_tmp2D4[0]=_tmp87F;}),({
struct Cyc_Absyn_Exp*_tmp87E=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp2D4[1]=_tmp87E;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp2D4,sizeof(struct Cyc_Absyn_Exp*),2U));});
struct Cyc_Absyn_Exp*_tmp2C7=Cyc_Absyn_uint_exp(1U,0U);
struct Cyc_Absyn_Exp*xsize;
({struct Cyc_Absyn_Exp*_tmp881=({struct Cyc_Absyn_Exp*_tmp880=Cyc_Absyn_fncall_exp(Cyc_Toc__get_dyneither_size_e,_tmp2C6,0U);Cyc_Absyn_prim2_exp(Cyc_Absyn_Eq,_tmp880,_tmp2C7,0U);});xsize=_tmp881;});{
# 1723
struct Cyc_Absyn_Exp*_tmp2C8=({struct Cyc_Absyn_Exp*_tmp882=xsize;Cyc_Absyn_and_exp(_tmp882,Cyc_Absyn_and_exp(_tmp2C2,_tmp2C5,0U),0U);});
struct Cyc_Absyn_Stmt*_tmp2C9=Cyc_Absyn_exp_stmt(Cyc_Absyn_fncall_exp(Cyc_Toc__throw_arraybounds_e,0,0U),0U);
struct Cyc_Absyn_Exp*_tmp2CA=({struct Cyc_Absyn_Exp*_tmp883=Cyc_Absyn_varb_exp((void*)_tmp2B6,0U);Cyc_Toc_member_exp(_tmp883,Cyc_Toc_curr_sp,0U);});
({struct Cyc_Absyn_Exp*_tmp884=Cyc_Toc_cast_it(_tmp2A9,_tmp2CA);_tmp2CA=_tmp884;});{
struct Cyc_Absyn_Exp*_tmp2CB=Cyc_Absyn_deref_exp(_tmp2CA,0U);
struct Cyc_Absyn_Exp*_tmp2CC=({struct Cyc_Absyn_Exp*_tmp885=_tmp2CB;Cyc_Absyn_assign_exp(_tmp885,Cyc_Absyn_var_exp(_tmp2BD,0U),0U);});
struct Cyc_Absyn_Stmt*_tmp2CD=Cyc_Absyn_exp_stmt(_tmp2CC,0U);
({struct Cyc_Absyn_Stmt*_tmp889=({struct Cyc_Absyn_Stmt*_tmp888=({struct Cyc_Absyn_Exp*_tmp887=_tmp2C8;struct Cyc_Absyn_Stmt*_tmp886=_tmp2C9;Cyc_Absyn_ifthenelse_stmt(_tmp887,_tmp886,Cyc_Absyn_skip_stmt(0U),0U);});Cyc_Absyn_seq_stmt(_tmp888,_tmp2CD,0U);});_tmp2CD=_tmp889;});
({struct Cyc_Absyn_Stmt*_tmp88C=({struct Cyc_Absyn_Decl*_tmp88B=({struct Cyc_Absyn_Decl*_tmp2CF=_cycalloc(sizeof(*_tmp2CF));({void*_tmp88A=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp2CE=_cycalloc(sizeof(*_tmp2CE));_tmp2CE->tag=0U,_tmp2CE->f1=_tmp2BE;_tmp2CE;});_tmp2CF->r=_tmp88A;}),_tmp2CF->loc=0U;_tmp2CF;});Cyc_Absyn_decl_stmt(_tmp88B,_tmp2CD,0U);});_tmp2CD=_tmp88C;});
({struct Cyc_Absyn_Stmt*_tmp88F=({struct Cyc_Absyn_Decl*_tmp88E=({struct Cyc_Absyn_Decl*_tmp2D1=_cycalloc(sizeof(*_tmp2D1));({void*_tmp88D=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp2D0=_cycalloc(sizeof(*_tmp2D0));_tmp2D0->tag=0U,_tmp2D0->f1=_tmp2BA;_tmp2D0;});_tmp2D1->r=_tmp88D;}),_tmp2D1->loc=0U;_tmp2D1;});Cyc_Absyn_decl_stmt(_tmp88E,_tmp2CD,0U);});_tmp2CD=_tmp88F;});
({struct Cyc_Absyn_Stmt*_tmp892=({struct Cyc_Absyn_Decl*_tmp891=({struct Cyc_Absyn_Decl*_tmp2D3=_cycalloc(sizeof(*_tmp2D3));({void*_tmp890=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp2D2=_cycalloc(sizeof(*_tmp2D2));_tmp2D2->tag=0U,_tmp2D2->f1=_tmp2B5;_tmp2D2;});_tmp2D3->r=_tmp890;}),_tmp2D3->loc=0U;_tmp2D3;});Cyc_Absyn_decl_stmt(_tmp891,_tmp2CD,0U);});_tmp2CD=_tmp892;});
({void*_tmp893=Cyc_Toc_stmt_exp_r(_tmp2CD);e->r=_tmp893;});};};};};};};};};};}
# 1681
;_pop_region(rgn2);};}
# 1749 "toc.cyc"
...
# 1756
({struct Cyc_Absyn_Aggrdecl*_tmp894=Cyc_Absyn_get_known_aggrdecl(_tmp2E2);ad=_tmp894;});goto _LL0;}else{goto _LL3;}}else{_LL3: _LL4:
({void*_tmp2DE=0U;({struct _dyneither_ptr _tmp897=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2E1=({struct Cyc_String_pa_PrintArg_struct _tmp79B;_tmp79B.tag=0U,({
struct _dyneither_ptr _tmp895=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(aggrtype));_tmp79B.f1=_tmp895;});_tmp79B;});void*_tmp2DF[1U];_tmp2DF[0]=& _tmp2E1;({struct _dyneither_ptr _tmp896=({const char*_tmp2E0="expecting union but found %s in check_tagged_union";_tag_dyneither(_tmp2E0,sizeof(char),51U);});Cyc_aprintf(_tmp896,_tag_dyneither(_tmp2DF,sizeof(void*),1U));});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp897,_tag_dyneither(_tmp2DE,sizeof(void*),0U));});});}_LL0:;}{
# 1760
...
struct Cyc_Absyn_Stmt*_tmp2EA=({struct Cyc_Absyn_Exp*_tmp899=_tmp2E7;struct Cyc_Absyn_Stmt*_tmp898=Cyc_Toc_throw_match_stmt();Cyc_Absyn_ifthenelse_stmt(_tmp899,_tmp898,Cyc_Toc_skip_stmt_dl(),0U);});
...
struct Cyc_Absyn_Stmt*_tmp2ED=({struct _tuple1*_tmp89C=_tmp2E3;void*_tmp89B=_tmp2EB;struct Cyc_Absyn_Exp*_tmp89A=_tmp2EC;Cyc_Absyn_declare_stmt(_tmp89C,_tmp89B,_tmp89A,Cyc_Absyn_seq_stmt(_tmp2EA,_tmp2E9,0U),0U);});
return Cyc_Toc_stmt_exp_r(_tmp2ED);}else{
# 1774
struct Cyc_Absyn_Exp*_tmp2EE=({struct Cyc_Absyn_Exp*_tmp89D=aggrproj(_tmp2E4,f,0U);Cyc_Toc_member_exp(_tmp89D,Cyc_Toc_tag_sp,0U);});
struct Cyc_Absyn_Exp*_tmp2EF=Cyc_Absyn_neq_exp(_tmp2EE,_tmp2E5,0U);
struct Cyc_Absyn_Exp*_tmp2F0=({struct Cyc_Absyn_Exp*_tmp89E=aggrproj(_tmp2E4,f,0U);Cyc_Toc_member_exp(_tmp89E,Cyc_Toc_val_sp,0U);});
struct Cyc_Absyn_Stmt*_tmp2F1=Cyc_Absyn_exp_stmt(_tmp2F0,0U);
struct Cyc_Absyn_Stmt*_tmp2F2=({struct Cyc_Absyn_Exp*_tmp8A0=_tmp2EF;struct Cyc_Absyn_Stmt*_tmp89F=Cyc_Toc_throw_match_stmt();Cyc_Absyn_ifthenelse_stmt(_tmp8A0,_tmp89F,Cyc_Toc_skip_stmt_dl(),0U);});
struct Cyc_Absyn_Stmt*_tmp2F3=({struct _tuple1*_tmp8A3=_tmp2E3;void*_tmp8A2=e1_c_type;struct Cyc_Absyn_Exp*_tmp8A1=e1;Cyc_Absyn_declare_stmt(_tmp8A3,_tmp8A2,_tmp8A1,Cyc_Absyn_seq_stmt(_tmp2F2,_tmp2F1,0U),0U);});
...
({int _tmp8A4=Cyc_Toc_get_member_offset(_tmp2F6,f);*f_tag=_tmp8A4;});{
# 1792
struct _dyneither_ptr str=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2FA=({struct Cyc_String_pa_PrintArg_struct _tmp79D;_tmp79D.tag=0U,_tmp79D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp2F6->name).f2);_tmp79D;});struct Cyc_String_pa_PrintArg_struct _tmp2FB=({struct Cyc_String_pa_PrintArg_struct _tmp79C;_tmp79C.tag=0U,_tmp79C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp79C;});void*_tmp2F8[2U];_tmp2F8[0]=& _tmp2FA,_tmp2F8[1]=& _tmp2FB;({struct _dyneither_ptr _tmp8A5=({const char*_tmp2F9="_union_%s_%s";_tag_dyneither(_tmp2F9,sizeof(char),13U);});Cyc_aprintf(_tmp8A5,_tag_dyneither(_tmp2F8,sizeof(void*),2U));});});
({void*_tmp8A6=Cyc_Absyn_strct(({struct _dyneither_ptr*_tmp2F7=_cycalloc(sizeof(*_tmp2F7));*_tmp2F7=str;_tmp2F7;}));*tagged_member_type=_tmp8A6;});
...
({void*_tmp2FF=0U;({struct _dyneither_ptr _tmp8A7=({const char*_tmp300="cast on lhs!";_tag_dyneither(_tmp300,sizeof(char),13U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp8A7,_tag_dyneither(_tmp2FF,sizeof(void*),0U));});});case 21U: _LL3: _tmp307=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp2FE)->f1;_tmp306=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp2FE)->f2;_tmp305=(int*)&((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp2FE)->f4;_LL4:
# 1809
...
if(popt == 0)
({struct Cyc_Absyn_Stmt*_tmp8A8=Cyc_Absyn_exp_stmt(Cyc_Absyn_assign_exp(temp_tag,f_tag,0U),0U);s2=_tmp8A8;});else{
# 1845
struct Cyc_Absyn_Exp*_tmp30C=Cyc_Absyn_neq_exp(temp_tag,f_tag,0U);
({struct Cyc_Absyn_Stmt*_tmp8AB=({struct Cyc_Absyn_Exp*_tmp8AA=_tmp30C;struct Cyc_Absyn_Stmt*_tmp8A9=Cyc_Toc_throw_match_stmt();Cyc_Absyn_ifthenelse_stmt(_tmp8AA,_tmp8A9,Cyc_Toc_skip_stmt_dl(),0U);});s2=_tmp8AB;});}{
# 1848
struct Cyc_Absyn_Stmt*s1=({struct _tuple1*_tmp8AE=_tmp30B;void*_tmp8AD=Cyc_Absyn_cstar_type(member_type,Cyc_Toc_mt_tq);struct Cyc_Absyn_Exp*_tmp8AC=
Cyc_Toc_push_address_exp(e1);
# 1848
Cyc_Absyn_declare_stmt(_tmp8AE,_tmp8AD,_tmp8AC,
# 1850
...
void*_tmp30D=e->r;
if(e->topt == 0)
({struct Cyc_String_pa_PrintArg_struct _tmp310=({struct Cyc_String_pa_PrintArg_struct _tmp79E;_tmp79E.tag=0U,({struct _dyneither_ptr _tmp8AF=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp79E.f1=_tmp8AF;});_tmp79E;});void*_tmp30E[1U];_tmp30E[0]=& _tmp310;({struct _dyneither_ptr _tmp8B0=({const char*_tmp30F="exp_to_c: no type for %s";_tag_dyneither(_tmp30F,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp8B0,_tag_dyneither(_tmp30E,sizeof(void*),1U));});});{
...
({void*_tmp8B1=(Cyc_Toc_make_toplevel_dyn_arr(old_typ,_tmp312,_tmp312))->r;e->r=_tmp8B1;});else{
# 1873
({void*_tmp8B3=({struct Cyc_Absyn_Exp*_tmp8B2=Cyc_Toc__tag_dyneither_e;Cyc_Toc_fncall_exp_r(_tmp8B2,({struct Cyc_Absyn_Exp*_tmp313[3U];_tmp313[0]=_tmp312,_tmp313[1]=_tmp312,_tmp313[2]=_tmp312;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp313,sizeof(struct Cyc_Absyn_Exp*),3U));}));});e->r=_tmp8B3;});}}else{
# 1875
e->r=(void*)& Cyc_Toc_zero_exp;}
# 1877
...
({void*_tmp318=0U;({unsigned int _tmp8B5=e->loc;struct _dyneither_ptr _tmp8B4=({const char*_tmp319="can't calculate numelts";_tag_dyneither(_tmp319,sizeof(char),24U);});Cyc_Tcutil_terr(_tmp8B5,_tmp8B4,_tag_dyneither(_tmp318,sizeof(void*),0U));});});
...
# 1896
struct Cyc_Absyn_Exp*_tmp31A=({void*_tmp8B6=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp8B6,_tmp326);});
if(_tmp31A == 0)
# 1899
({void*_tmp8B9=({struct Cyc_Absyn_Exp*_tmp8B8=Cyc_Toc__get_dyneither_size_e;Cyc_Toc_fncall_exp_r(_tmp8B8,({struct Cyc_Absyn_Exp*_tmp31B[2U];_tmp31B[0]=(struct Cyc_Absyn_Exp*)_tmp4E4->hd,({
# 1901
struct Cyc_Absyn_Exp*_tmp8B7=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(_tmp328),0U);_tmp31B[1]=_tmp8B7;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp31B,sizeof(struct Cyc_Absyn_Exp*),2U));}));});
# 1899
e->r=_tmp8B9;});else{
# 1903
...
# 1909
({void*_tmp8BB=({struct Cyc_Absyn_Exp*_tmp8BA=function_e;Cyc_Toc_fncall_exp_r(_tmp8BA,({struct Cyc_Absyn_Exp*_tmp31D[2U];_tmp31D[0]=(struct Cyc_Absyn_Exp*)_tmp4E4->hd,_tmp31D[1]=_tmp31C;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp31D,sizeof(struct Cyc_Absyn_Exp*),2U));}));});e->r=_tmp8BB;});}else{
if(Cyc_Tcutil_force_type2bool(0,_tmp327)){
if(!Cyc_Evexp_c_can_eval(_tmp31C))
({void*_tmp31E=0U;({unsigned int _tmp8BD=e->loc;struct _dyneither_ptr _tmp8BC=({const char*_tmp31F="can't calculate numelts";_tag_dyneither(_tmp31F,sizeof(char),24U);});Cyc_Tcutil_terr(_tmp8BD,_tmp8BC,_tag_dyneither(_tmp31E,sizeof(void*),0U));});});
# 1914
({void*_tmp8C0=({struct Cyc_Absyn_Exp*_tmp8BF=arg;struct Cyc_Absyn_Exp*_tmp8BE=_tmp31C;Cyc_Toc_conditional_exp_r(_tmp8BF,_tmp8BE,Cyc_Absyn_uint_exp(0U,0U));});e->r=_tmp8C0;});}else{
# 1916
e->r=_tmp31C->r;goto _LL6E;}}}
# 1919
goto _LL6E;}default: _LL73: _LL74:
# 1921
({struct Cyc_String_pa_PrintArg_struct _tmp322=({struct Cyc_String_pa_PrintArg_struct _tmp7A0;_tmp7A0.tag=0U,({
struct _dyneither_ptr _tmp8C1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(arg->topt)));_tmp7A0.f1=_tmp8C1;});_tmp7A0;});struct Cyc_String_pa_PrintArg_struct _tmp323=({struct Cyc_String_pa_PrintArg_struct _tmp79F;_tmp79F.tag=0U,({struct _dyneither_ptr _tmp8C2=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(arg->topt)));_tmp79F.f1=_tmp8C2;});_tmp79F;});void*_tmp320[2U];_tmp320[0]=& _tmp322,_tmp320[1]=& _tmp323;({struct _dyneither_ptr _tmp8C3=({const char*_tmp321="size primop applied to non-array %s (%s)";_tag_dyneither(_tmp321,sizeof(char),41U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp8C3,_tag_dyneither(_tmp320,sizeof(void*),2U));});});}_LL6E:;}
# 1924
goto _LL59;}case Cyc_Absyn_Plus: _LL5C: _LL5D:
# 1929
 if(Cyc_Toc_is_toplevel(nv))
({void*_tmp329=0U;({struct _dyneither_ptr _tmp8C4=({const char*_tmp32A="can't do pointer arithmetic at top-level";_tag_dyneither(_tmp32A,sizeof(char),41U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(_tmp8C4,_tag_dyneither(_tmp329,sizeof(void*),0U));});});
...
# 1933
struct Cyc_Absyn_Exp*_tmp32D=({void*_tmp8C5=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp8C5,_tmp332);});
if(_tmp32D == 0){
...
({void*_tmp8C8=({struct Cyc_Absyn_Exp*_tmp8C7=Cyc_Toc__dyneither_ptr_plus_e;Cyc_Toc_fncall_exp_r(_tmp8C7,({struct Cyc_Absyn_Exp*_tmp32E[3U];_tmp32E[0]=e1,({
struct Cyc_Absyn_Exp*_tmp8C6=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(_tmp333),0U);_tmp32E[1]=_tmp8C6;}),_tmp32E[2]=e2;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp32E,sizeof(struct Cyc_Absyn_Exp*),3U));}));});
# 1937
e->r=_tmp8C8;});}else{
# 1940
...
({void*_tmp8CC=({struct Cyc_Absyn_Exp*_tmp8CB=Cyc_Absyn_new_exp(e1->r,0U);Cyc_Toc_aggrmember_exp_r(_tmp8CB,Cyc_Toc_curr_sp);});e1->r=_tmp8CC;});
({void*_tmp8CE=({struct Cyc_Absyn_Exp*_tmp8CD=Cyc_Absyn_new_exp(e2->r,0U);Cyc_Toc_aggrmember_exp_r(_tmp8CD,Cyc_Toc_curr_sp);});e2->r=_tmp8CE;});
({void*_tmp8D0=({void*_tmp8CF=Cyc_Absyn_cstar_type(Cyc_Absyn_uchar_type,Cyc_Toc_mt_tq);e2->topt=_tmp8CF;});e1->topt=_tmp8D0;});
({void*_tmp8D2=({struct Cyc_Absyn_Exp*_tmp8D1=Cyc_Absyn_copy_exp(e);Cyc_Absyn_divide_exp(_tmp8D1,
Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U),0U);})->r;
# 1963
e->r=_tmp8D2;});}else{
# 1966
({void*_tmp8D6=({struct Cyc_Absyn_Exp*_tmp8D5=Cyc_Toc__dyneither_ptr_plus_e;Cyc_Toc_fncall_exp_r(_tmp8D5,({struct Cyc_Absyn_Exp*_tmp334[3U];_tmp334[0]=e1,({
struct Cyc_Absyn_Exp*_tmp8D4=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp334[1]=_tmp8D4;}),({
struct Cyc_Absyn_Exp*_tmp8D3=Cyc_Absyn_prim1_exp(Cyc_Absyn_Minus,e2,0U);_tmp334[2]=_tmp8D3;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp334,sizeof(struct Cyc_Absyn_Exp*),3U));}));});
# 1966
e->r=_tmp8D6;});}}
# 1971
...
void*_tmp335=({void*_tmp8D7=Cyc_Toc_typ_to_c(elt_type);Cyc_Absyn_cstar_type(_tmp8D7,Cyc_Toc_mt_tq);});
({void*_tmp8DA=({void*_tmp8D9=_tmp335;Cyc_Toc_cast_it_r(_tmp8D9,({struct Cyc_Absyn_Exp*_tmp8D8=Cyc_Absyn_new_exp(e1->r,0U);Cyc_Toc_member_exp(_tmp8D8,Cyc_Toc_curr_sp,0U);}));});e1->r=_tmp8DA;});
e1->topt=_tmp335;}
# 1989
if(Cyc_Tcutil_is_tagged_pointer_type(t2)){
void*_tmp336=({void*_tmp8DB=Cyc_Toc_typ_to_c(elt_type);Cyc_Absyn_cstar_type(_tmp8DB,Cyc_Toc_mt_tq);});
({void*_tmp8DE=({void*_tmp8DD=_tmp336;Cyc_Toc_cast_it_r(_tmp8DD,({struct Cyc_Absyn_Exp*_tmp8DC=Cyc_Absyn_new_exp(e2->r,0U);Cyc_Toc_member_exp(_tmp8DC,Cyc_Toc_curr_sp,0U);}));});e2->r=_tmp8DE;});
e2->topt=_tmp336;}
# 1994
...
if(_tmp4E6 == Cyc_Absyn_PreDec  || _tmp4E6 == Cyc_Absyn_PostDec)({struct _dyneither_ptr _tmp8DF=({const char*_tmp337="decrement";_tag_dyneither(_tmp337,sizeof(char),10U);});incr_str=_tmp8DF;});
if(Cyc_Tcutil_is_zero_ptr_deref(_tmp4E7,& ptr_type,& is_dyneither,& elt_type)){
({struct Cyc_String_pa_PrintArg_struct _tmp33A=({struct Cyc_String_pa_PrintArg_struct _tmp7A1;_tmp7A1.tag=0U,_tmp7A1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)incr_str);_tmp7A1;});void*_tmp338[1U];_tmp338[0]=& _tmp33A;({unsigned int _tmp8E1=e->loc;struct _dyneither_ptr _tmp8E0=({const char*_tmp339="in-place %s is not supported when dereferencing a zero-terminated pointer";_tag_dyneither(_tmp339,sizeof(char),74U);});Cyc_Tcutil_terr(_tmp8E1,_tmp8E0,_tag_dyneither(_tmp338,sizeof(void*),1U));});});
({void*_tmp33B=0U;({struct _dyneither_ptr _tmp8E2=({const char*_tmp33C="in-place inc/dec on zero-term";_tag_dyneither(_tmp33C,sizeof(char),30U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp8E2,_tag_dyneither(_tmp33B,sizeof(void*),0U));});});}{
# 2017
...
# 2024
({void*_tmp8E4=(void*)({struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmp340=_cycalloc(sizeof(*_tmp340));_tmp340->tag=4U,_tmp340->f1=_tmp4E7,({struct Cyc_Core_Opt*_tmp8E3=({struct Cyc_Core_Opt*_tmp33F=_cycalloc(sizeof(*_tmp33F));_tmp33F->v=(void*)Cyc_Absyn_Plus;_tmp33F;});_tmp340->f2=_tmp8E3;}),_tmp340->f3=_tmp33D;_tmp340;});e->r=_tmp8E4;});
Cyc_Toc_exp_to_c(nv,e);
return;case Cyc_Absyn_PreDec: _LL7D: _LL7E:
# 2028
({void*_tmp8E6=(void*)({struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmp342=_cycalloc(sizeof(*_tmp342));_tmp342->tag=4U,_tmp342->f1=_tmp4E7,({struct Cyc_Core_Opt*_tmp8E5=({struct Cyc_Core_Opt*_tmp341=_cycalloc(sizeof(*_tmp341));_tmp341->v=(void*)Cyc_Absyn_Minus;_tmp341;});_tmp342->f2=_tmp8E5;}),_tmp342->f3=_tmp33D;_tmp342;});e->r=_tmp8E6;});
Cyc_Toc_exp_to_c(nv,e);
return;default: _LL7F: _LL80:
# 2032
({struct Cyc_String_pa_PrintArg_struct _tmp345=({struct Cyc_String_pa_PrintArg_struct _tmp7A2;_tmp7A2.tag=0U,_tmp7A2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)incr_str);_tmp7A2;});void*_tmp343[1U];_tmp343[0]=& _tmp345;({unsigned int _tmp8E8=e->loc;struct _dyneither_ptr _tmp8E7=({const char*_tmp344="in-place post%s is not supported on @tagged union members";_tag_dyneither(_tmp344,sizeof(char),58U);});Cyc_Tcutil_terr(_tmp8E8,_tmp8E7,_tag_dyneither(_tmp343,sizeof(void*),1U));});});
# 2034
({void*_tmp346=0U;({struct _dyneither_ptr _tmp8E9=({const char*_tmp347="in-place inc/dec on @tagged union";_tag_dyneither(_tmp347,sizeof(char),34U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp8E9,_tag_dyneither(_tmp346,sizeof(void*),0U));});});}_LL7A:;};}{
# 2037
...
change=-1;
({void*_tmp8EE=({struct Cyc_Absyn_Exp*_tmp8ED=fn_e;Cyc_Toc_fncall_exp_r(_tmp8ED,({struct Cyc_Absyn_Exp*_tmp348[3U];({struct Cyc_Absyn_Exp*_tmp8EC=Cyc_Toc_push_address_exp(_tmp4E7);_tmp348[0]=_tmp8EC;}),({
struct Cyc_Absyn_Exp*_tmp8EB=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_typ),0U);_tmp348[1]=_tmp8EB;}),({
struct Cyc_Absyn_Exp*_tmp8EA=Cyc_Absyn_signed_int_exp(change,0U);_tmp348[2]=_tmp8EA;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp348,sizeof(struct Cyc_Absyn_Exp*),3U));}));});
# 2052
e->r=_tmp8EE;});}else{
# 2055
...
void*_tmp34A=({void*_tmp8EF=Cyc_Toc_typ_to_c(old_typ);Cyc_Absyn_cstar_type(_tmp8EF,Cyc_Toc_mt_tq);});
struct Cyc_Absyn_Exp*_tmp34B=Cyc_Toc_push_address_exp(_tmp4E7);
struct Cyc_Absyn_Exp*_tmp34C=({struct Cyc_Absyn_Exp*_tmp8F0=Cyc_Absyn_deref_exp(Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(_tmp349,0U),0U),0U);Cyc_Absyn_neq_exp(_tmp8F0,
Cyc_Absyn_int_exp(Cyc_Absyn_None,0,0U),0U);});
if(need_null_ck)
({struct Cyc_Absyn_Exp*_tmp8F3=({struct Cyc_Absyn_Exp*_tmp8F2=({struct Cyc_Absyn_Exp*_tmp8F1=Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(_tmp349,0U),0U);Cyc_Absyn_neq_exp(_tmp8F1,
Cyc_Absyn_int_exp(Cyc_Absyn_None,0,0U),0U);});
# 2068
Cyc_Absyn_and_exp(_tmp8F2,_tmp34C,0U);});_tmp34C=_tmp8F3;});{
# 2070
struct Cyc_Absyn_Stmt*_tmp34D=({struct Cyc_Absyn_Exp*_tmp8F5=_tmp34C;struct Cyc_Absyn_Stmt*_tmp8F4=
Cyc_Absyn_exp_stmt(Cyc_Absyn_pre_inc_exp(Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(_tmp349,0U),0U),0U),0U);
# 2070
Cyc_Absyn_ifthenelse_stmt(_tmp8F5,_tmp8F4,
# 2072
Cyc_Absyn_exp_stmt(Cyc_Absyn_fncall_exp(Cyc_Toc__throw_arraybounds_e,0,0U),0U),0U);});
({struct Cyc_Absyn_Stmt*_tmp8F7=({struct Cyc_Absyn_Stmt*_tmp8F6=_tmp34D;Cyc_Absyn_seq_stmt(_tmp8F6,Cyc_Absyn_exp_stmt(Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(_tmp349,0U),0U),0U),0U);});_tmp34D=_tmp8F7;});
({void*_tmp8F8=(Cyc_Absyn_stmt_exp(Cyc_Absyn_declare_stmt(_tmp349,_tmp34A,_tmp34B,_tmp34D,0U),0U))->r;e->r=_tmp8F8;});};}else{
# 2077
...
({void*_tmp8FC=({struct Cyc_Absyn_Exp*_tmp8FB=fn_e;Cyc_Toc_fncall_exp_r(_tmp8FB,({struct Cyc_Absyn_Exp*_tmp34F[2U];({struct Cyc_Absyn_Exp*_tmp8FA=Cyc_Toc_push_address_exp(_tmp4E7);_tmp34F[0]=_tmp8FA;}),({
struct Cyc_Absyn_Exp*_tmp8F9=Cyc_Absyn_signed_int_exp(1,0U);_tmp34F[1]=_tmp8F9;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp34F,sizeof(struct Cyc_Absyn_Exp*),2U));}));});
# 2079
e->r=_tmp8FC;});}}else{
# 2082
...
({void*_tmp8FD=Cyc_Toc_tagged_union_assignop(_tmp4EA,e1_old_typ,_tmp4E9,_tmp4E8,e2_old_typ,f_tag,tagged_member_struct_type);e->r=_tmp8FD;});
# 2116
return;}{
# 2118
void*ptr_type=Cyc_Absyn_void_type;
...
# 2142
({struct Cyc_Absyn_Exp*_tmp8FE=Cyc_Absyn_prim1_exp(Cyc_Absyn_Minus,_tmp4E8,0U);change=_tmp8FE;});goto _LL81;default: _LL86: _LL87:
({void*_tmp353=0U;({struct _dyneither_ptr _tmp8FF=({const char*_tmp354="bad t ? pointer arithmetic";_tag_dyneither(_tmp354,sizeof(char),27U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp8FF,_tag_dyneither(_tmp353,sizeof(void*),0U));});});}_LL81:;}
# 2145
done=1;{
# 2147
struct Cyc_Absyn_Exp*_tmp355=Cyc_Toc__dyneither_ptr_inplace_plus_e;
({void*_tmp903=({struct Cyc_Absyn_Exp*_tmp902=_tmp355;Cyc_Toc_fncall_exp_r(_tmp902,({struct Cyc_Absyn_Exp*_tmp356[3U];({struct Cyc_Absyn_Exp*_tmp901=Cyc_Toc_push_address_exp(_tmp4EA);_tmp356[0]=_tmp901;}),({
struct Cyc_Absyn_Exp*_tmp900=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_typ),0U);_tmp356[1]=_tmp900;}),_tmp356[2]=change;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp356,sizeof(struct Cyc_Absyn_Exp*),3U));}));});
# 2148
e->r=_tmp903;});};}else{
# 2151
if(Cyc_Tcutil_is_zero_pointer_type_elt(old_typ,& elt_typ)){
...
({void*_tmp905=({struct Cyc_Absyn_Exp*_tmp904=Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__zero_arr_inplace_plus_functionSet,_tmp4EA);Cyc_Toc_fncall_exp_r(_tmp904,({struct Cyc_Absyn_Exp*_tmp359[2U];_tmp359[0]=_tmp4EA,_tmp359[1]=_tmp4E8;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp359,sizeof(struct Cyc_Absyn_Exp*),2U));}));});e->r=_tmp905;});
goto _LL88;}else{_LL8B: _LL8C:
({void*_tmp35A=0U;({struct _dyneither_ptr _tmp906=({const char*_tmp35B="bad zero-terminated pointer arithmetic";_tag_dyneither(_tmp35B,sizeof(char),39U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp906,_tag_dyneither(_tmp35A,sizeof(void*),0U));});});}_LL88:;}}}
# 2163
if(!done){
# 2165
if(e1_poly)
({void*_tmp908=({void*_tmp907=Cyc_Absyn_void_star_type();Cyc_Toc_cast_it_r(_tmp907,Cyc_Absyn_new_exp(_tmp4E8->r,0U));});_tmp4E8->r=_tmp908;});
# 2171
if(!Cyc_Absyn_is_lvalue(_tmp4EA)){
({struct Cyc_Absyn_Exp*_tmp909=_tmp4EA;((void(*)(struct Cyc_Absyn_Exp*e1,struct Cyc_List_List*fs,struct Cyc_Absyn_Exp*(*f)(struct Cyc_Absyn_Exp*,struct _tuple31*),struct _tuple31*f_env))Cyc_Toc_lvalue_assign)(_tmp909,0,Cyc_Toc_assignop_lvalue,({unsigned int _tmp35D=1;struct _tuple31*_tmp35C=_cycalloc(_check_times(_tmp35D,sizeof(struct _tuple31)));(_tmp35C[0]).f1=_tmp4E9,(_tmp35C[0]).f2=_tmp4E8;_tmp35C;}));});
e->r=_tmp4EA->r;}}
# 2176
...
({struct Cyc_List_List*_tmp90A=({struct Cyc_List_List*_tmp35F=_cycalloc(sizeof(*_tmp35F));_tmp35F->hd=(struct Cyc_Absyn_Exp*)_tmp4F9->hd,_tmp35F->tl=new_args;_tmp35F;});new_args=_tmp90A;});}}
# 2218
({struct Cyc_List_List*_tmp90E=({struct Cyc_List_List*_tmp361=_cycalloc(sizeof(*_tmp361));({struct Cyc_Absyn_Exp*_tmp90D=({struct Cyc_Absyn_Exp*_tmp90C=Cyc_Toc__tag_dyneither_e;Cyc_Absyn_fncall_exp(_tmp90C,({struct Cyc_Absyn_Exp*_tmp360[3U];_tmp360[0]=argvexp,({
# 2220
struct Cyc_Absyn_Exp*_tmp90B=Cyc_Absyn_sizeoftype_exp(cva_type,0U);_tmp360[1]=_tmp90B;}),_tmp360[2]=num_varargs_exp;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp360,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);});
# 2218
_tmp361->hd=_tmp90D;}),_tmp361->tl=new_args;_tmp361;});new_args=_tmp90E;});
# 2223
({struct Cyc_List_List*_tmp90F=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(new_args);new_args=_tmp90F;});
# 2225
...
({void*_tmp364=0U;({struct _dyneither_ptr _tmp910=({const char*_tmp365="toc: unknown datatype in vararg with inject";_tag_dyneither(_tmp365,sizeof(char),44U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp910,_tag_dyneither(_tmp364,sizeof(void*),0U));});});}_LL8D:;}{
# 2235
struct _dyneither_ptr vs=({unsigned int _tmp377=(unsigned int)_tmp4F8;struct _tuple1**_tmp376=({struct _RegionHandle*_tmp911=r;_region_malloc(_tmp911,_check_times(_tmp377,sizeof(struct _tuple1*)));});({{unsigned int _tmp7A3=(unsigned int)_tmp4F8;unsigned int i;for(i=0;i < _tmp7A3;++ i){({struct _tuple1*_tmp912=Cyc_Toc_temp_var();_tmp376[i]=_tmp912;});}}0;});_tag_dyneither(_tmp376,sizeof(struct _tuple1*),_tmp377);});
# 2237
if(_tmp4F8 != 0){
# 2241
struct Cyc_List_List*_tmp367=0;
{int i=_tmp4F8 - 1;for(0;i >= 0;-- i){
({struct Cyc_List_List*_tmp914=({struct Cyc_List_List*_tmp368=_cycalloc(sizeof(*_tmp368));({struct Cyc_Absyn_Exp*_tmp913=Cyc_Absyn_address_exp(Cyc_Absyn_var_exp(*((struct _tuple1**)_check_dyneither_subscript(vs,sizeof(struct _tuple1*),i)),0U),0U);_tmp368->hd=_tmp913;}),_tmp368->tl=_tmp367;_tmp368;});_tmp367=_tmp914;});}}
({struct Cyc_Absyn_Stmt*_tmp918=({struct _tuple1*_tmp917=argv;void*_tmp916=arr_type;struct Cyc_Absyn_Exp*_tmp915=Cyc_Absyn_array_exp(_tmp367,0U);Cyc_Absyn_declare_stmt(_tmp917,_tmp916,_tmp915,s,0U);});s=_tmp918;});
# 2246
({struct Cyc_List_List*_tmp919=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp4F9);_tmp4F9=_tmp919;});
({struct Cyc_List_List*_tmp91A=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp4F7);_tmp4F7=_tmp91A;});{
...
({struct Cyc_Absyn_Exp*_tmp91B=Cyc_Toc_cast_it(field_typ,arg);arg=_tmp91B;});{
# 2260
struct _tuple1*_tmp36B=Cyc_Toc_collapse_qvars(_tmp370,tud->name);
struct Cyc_List_List*_tmp36C=({struct _tuple20*_tmp36E[2U];({struct _tuple20*_tmp91F=({struct _dyneither_ptr*_tmp91E=Cyc_Toc_tag_sp;Cyc_Toc_make_field(_tmp91E,Cyc_Toc_datatype_tag(tud,_tmp370));});_tmp36E[0]=_tmp91F;}),({
struct _tuple20*_tmp91D=({struct _dyneither_ptr*_tmp91C=Cyc_Absyn_fieldname(1);Cyc_Toc_make_field(_tmp91C,arg);});_tmp36E[1]=_tmp91D;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp36E,sizeof(struct _tuple20*),2U));});
({struct Cyc_Absyn_Stmt*_tmp923=({struct _tuple1*_tmp922=var;void*_tmp921=Cyc_Absyn_strctq(_tmp36B);struct Cyc_Absyn_Exp*_tmp920=
...
# 2263
Cyc_Absyn_declare_stmt(_tmp922,_tmp921,_tmp920,s,0U);});s=_tmp923;});};};}};}else{
# 2271
struct Cyc_List_List*_tmp371=({struct _tuple32*_tmp372[3U];({struct _tuple32*_tmp92C=({struct _tuple32*_tmp373=_cycalloc(sizeof(*_tmp373));({struct _dyneither_ptr _tmp92B=_tag_dyneither(0,0,0);_tmp373->f1=_tmp92B;}),({struct Cyc_Absyn_Exp*_tmp92A=Cyc_Absyn_uint_exp(0U,0U);_tmp373->f2=_tmp92A;});_tmp373;});_tmp372[0]=_tmp92C;}),({
struct _tuple32*_tmp929=({struct _tuple32*_tmp374=_cycalloc(sizeof(*_tmp374));({struct _dyneither_ptr _tmp928=_tag_dyneither(0,0,0);_tmp374->f1=_tmp928;}),({struct Cyc_Absyn_Exp*_tmp927=Cyc_Absyn_uint_exp(0U,0U);_tmp374->f2=_tmp927;});_tmp374;});_tmp372[1]=_tmp929;}),({
struct _tuple32*_tmp926=({struct _tuple32*_tmp375=_cycalloc(sizeof(*_tmp375));({struct _dyneither_ptr _tmp925=_tag_dyneither(0,0,0);_tmp375->f1=_tmp925;}),({struct Cyc_Absyn_Exp*_tmp924=Cyc_Absyn_uint_exp(0U,0U);_tmp375->f2=_tmp924;});_tmp375;});_tmp372[2]=_tmp926;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp372,sizeof(struct _tuple32*),3U));});
({struct Cyc_Absyn_Stmt*_tmp930=({struct _tuple1*_tmp92F=argv;void*_tmp92E=Cyc_Absyn_void_star_type();struct Cyc_Absyn_Exp*_tmp92D=Cyc_Absyn_uint_exp(0U,0U);Cyc_Absyn_declare_stmt(_tmp92F,_tmp92E,_tmp92D,s,0U);});s=_tmp930;});}};}else{
# 2279
if(_tmp4F8 != 0){
struct Cyc_List_List*array_args=0;
for(0;_tmp4F9 != 0;_tmp4F9=_tmp4F9->tl){
Cyc_Toc_exp_to_c(nv,(struct Cyc_Absyn_Exp*)_tmp4F9->hd);
({struct Cyc_List_List*_tmp931=({struct Cyc_List_List*_tmp378=_cycalloc(sizeof(*_tmp378));_tmp378->hd=(struct Cyc_Absyn_Exp*)_tmp4F9->hd,_tmp378->tl=array_args;_tmp378;});array_args=_tmp931;});}{
# 2285
...
({struct Cyc_Absyn_Stmt*_tmp932=Cyc_Absyn_declare_stmt(argv,arr_type,_tmp379,s,0U);s=_tmp932;});};}else{
# 2288
({struct Cyc_Absyn_Stmt*_tmp936=({struct _tuple1*_tmp935=argv;void*_tmp934=Cyc_Absyn_void_star_type();struct Cyc_Absyn_Exp*_tmp933=Cyc_Absyn_uint_exp(0U,0U);Cyc_Absyn_declare_stmt(_tmp935,_tmp934,_tmp933,s,0U);});s=_tmp936;});}}
# 2291
({void*_tmp937=Cyc_Toc_stmt_exp_r(s);e->r=_tmp937;});};}
# 2293
...
({void*_tmp939=({void*_tmp938=Cyc_Toc_typ_to_c(old_typ);Cyc_Toc_array_to_ptr_cast(_tmp938,_tmp37A,0U);})->r;e->r=_tmp939;});
...
# 2318
({void*_tmp93B=({void*_tmp93A=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_array_to_ptr_cast(_tmp93A,_tmp4FF,0U);})->r;e->r=_tmp93B;});
goto _LL95;}_LL95:;}
# 2321
break;}}
# 2324
...
# 2333
{struct _tuple33 _tmp37E=({struct _tuple33 _tmp7A7;({void*_tmp93D=Cyc_Tcutil_compress(old_t2);_tmp7A7.f1=_tmp93D;}),({void*_tmp93C=Cyc_Tcutil_compress(new_typ);_tmp7A7.f2=_tmp93C;});_tmp7A7;});struct _tuple33 _tmp37F=_tmp37E;struct Cyc_Absyn_PtrInfo _tmp3BD;struct Cyc_Absyn_PtrInfo _tmp3BC;struct Cyc_Absyn_PtrInfo _tmp3BB;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp37F.f1)->tag == 3U)switch(*((int*)_tmp37F.f2)){case 3U: _LL9D: _tmp3BC=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp37F.f1)->f1;_tmp3BB=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp37F.f2)->f1;_LL9E: {
# 2335
...
struct Cyc_Absyn_Exp*_tmp382=({void*_tmp93E=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp93E,(_tmp3BC.ptr_atts).bounds);});
struct Cyc_Absyn_Exp*_tmp383=({void*_tmp93F=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp93F,(_tmp3BB.ptr_atts).bounds);});
...
{struct _tuple34 _tmp386=({struct _tuple34 _tmp7A6;_tmp7A6.f1=_tmp382,_tmp7A6.f2=_tmp383;_tmp7A6;});struct _tuple34 _tmp387=_tmp386;if(_tmp387.f1 != 0){if(_tmp387.f2 != 0){_LLA4: _LLA5: {
# 2343
...
({void*_tmp38A=0U;({unsigned int _tmp941=e->loc;struct _dyneither_ptr _tmp940=({const char*_tmp38B="can't validate cast due to potential size differences";_tag_dyneither(_tmp38B,sizeof(char),54U);});Cyc_Tcutil_terr(_tmp941,_tmp940,_tag_dyneither(_tmp38A,sizeof(void*),0U));});});
if(_tmp380  && !_tmp381){
if(Cyc_Toc_is_toplevel(nv))
({void*_tmp38C=0U;({struct _dyneither_ptr _tmp942=({const char*_tmp38D="can't do NULL-check conversion at top-level";_tag_dyneither(_tmp38D,sizeof(char),44U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(_tmp942,_tag_dyneither(_tmp38C,sizeof(void*),0U));});});
# 2354
if(_tmp500 != Cyc_Absyn_Null_to_NonNull)
({struct Cyc_String_pa_PrintArg_struct _tmp390=({struct Cyc_String_pa_PrintArg_struct _tmp7A4;_tmp7A4.tag=0U,({struct _dyneither_ptr _tmp943=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp7A4.f1=_tmp943;});_tmp7A4;});void*_tmp38E[1U];_tmp38E[0]=& _tmp390;({struct _dyneither_ptr _tmp944=({const char*_tmp38F="null-check conversion mis-classified: %s";_tag_dyneither(_tmp38F,sizeof(char),41U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp944,_tag_dyneither(_tmp38E,sizeof(void*),1U));});});{
int do_null_check=Cyc_Toc_need_null_check(_tmp502);
if(do_null_check){
if(!_tmp501)
({void*_tmp391=0U;({unsigned int _tmp946=e->loc;struct _dyneither_ptr _tmp945=({const char*_tmp392="inserted null check due to implicit cast from * to @ type";_tag_dyneither(_tmp392,sizeof(char),58U);});Cyc_Tcutil_warn(_tmp946,_tmp945,_tag_dyneither(_tmp391,sizeof(void*),0U));});});
# 2361
({void*_tmp949=({void*_tmp948=*_tmp503;Cyc_Toc_cast_it_r(_tmp948,({struct Cyc_Absyn_Exp*_tmp947=Cyc_Toc__check_null_e;Cyc_Absyn_fncall_exp(_tmp947,({struct Cyc_List_List*_tmp393=_cycalloc(sizeof(*_tmp393));
...
({void*_tmp395=0U;({unsigned int _tmp94B=e->loc;struct _dyneither_ptr _tmp94A=({const char*_tmp396="cannot perform coercion since numelts cannot be determined statically.";_tag_dyneither(_tmp396,sizeof(char),71U);});Cyc_Tcutil_terr(_tmp94B,_tmp94A,_tag_dyneither(_tmp395,sizeof(void*),0U));});});{
...
# 2384
if(_tmp500 == Cyc_Absyn_Null_to_NonNull)
({struct Cyc_String_pa_PrintArg_struct _tmp39B=({struct Cyc_String_pa_PrintArg_struct _tmp7A5;_tmp7A5.tag=0U,({struct _dyneither_ptr _tmp94C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp7A5.f1=_tmp94C;});_tmp7A5;});void*_tmp399[1U];_tmp399[0]=& _tmp39B;({struct _dyneither_ptr _tmp94D=({const char*_tmp39A="conversion mis-classified as null-check: %s";_tag_dyneither(_tmp39A,sizeof(char),44U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp94D,_tag_dyneither(_tmp399,sizeof(void*),1U));});});
if(Cyc_Toc_is_toplevel(nv)){
# 2388
if((_tmp384  && !(_tmp3BB.elt_tq).real_const) && !_tmp385)
# 2391
({struct Cyc_Absyn_Exp*_tmp94F=({struct Cyc_Absyn_Exp*_tmp94E=_tmp394;Cyc_Absyn_prim2_exp(Cyc_Absyn_Minus,_tmp94E,Cyc_Absyn_uint_exp(1U,0U),0U);});_tmp394=_tmp94F;});
# 2393
({void*_tmp950=(Cyc_Toc_make_toplevel_dyn_arr(old_t2,_tmp394,_tmp502))->r;e->r=_tmp950;});}else{
# 2395
...
arg3=_tmp394;else{
# 2423
({struct Cyc_Absyn_Exp*_tmp954=({struct Cyc_Absyn_Exp*_tmp953=Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__get_zero_arr_size_functionSet,_tmp502);Cyc_Absyn_fncall_exp(_tmp953,({struct Cyc_Absyn_Exp*_tmp3A1[2U];({
# 2425
struct Cyc_Absyn_Exp*_tmp952=({void*_tmp951=Cyc_Absyn_void_star_type();Cyc_Toc_cast_it(_tmp951,_tmp39E);});_tmp3A1[0]=_tmp952;}),_tmp3A1[1]=_tmp394;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp3A1,sizeof(struct Cyc_Absyn_Exp*),2U));}),0U);});
# 2423
arg3=_tmp954;});}
# 2426
goto _LLAF;}_LLAF:;}
...
# 2431
({struct Cyc_Absyn_Exp*_tmp956=({struct Cyc_Absyn_Exp*_tmp955=arg3;Cyc_Absyn_prim2_exp(Cyc_Absyn_Minus,_tmp955,Cyc_Absyn_uint_exp(1U,0U),0U);});arg3=_tmp956;});{
# 2433
struct Cyc_Absyn_Exp*_tmp3A4=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(_tmp3BB.elt_type),0U);
struct Cyc_Absyn_Exp*_tmp3A5=({struct Cyc_Absyn_Exp*_tmp957=_tmp39C;Cyc_Absyn_fncall_exp(_tmp957,({struct Cyc_Absyn_Exp*_tmp3A7[3U];_tmp3A7[0]=_tmp39E,_tmp3A7[1]=_tmp3A4,_tmp3A7[2]=arg3;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp3A7,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);});
struct Cyc_Absyn_Stmt*_tmp3A6=Cyc_Absyn_exp_stmt(_tmp3A5,0U);
({struct Cyc_Absyn_Stmt*_tmp95B=({struct _tuple1*_tmp95A=_tmp39D;void*_tmp959=Cyc_Toc_typ_to_c(old_t2);struct Cyc_Absyn_Exp*_tmp958=_tmp502;Cyc_Absyn_declare_stmt(_tmp95A,_tmp959,_tmp958,_tmp3A6,0U);});_tmp3A6=_tmp95B;});
({void*_tmp95C=Cyc_Toc_stmt_exp_r(_tmp3A6);e->r=_tmp95C;});};}else{
# 2440
({void*_tmp95F=({struct Cyc_Absyn_Exp*_tmp95E=_tmp39C;Cyc_Toc_fncall_exp_r(_tmp95E,({struct Cyc_Absyn_Exp*_tmp3A8[3U];_tmp3A8[0]=_tmp502,({
# 2442
struct Cyc_Absyn_Exp*_tmp95D=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(_tmp3BB.elt_type),0U);_tmp3A8[1]=_tmp95D;}),_tmp3A8[2]=_tmp394;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp3A8,sizeof(struct Cyc_Absyn_Exp*),3U));}));});
# 2440
e->r=_tmp95F;});}}
# 2446
...
({void*_tmp3AC=0U;({unsigned int _tmp961=e->loc;struct _dyneither_ptr _tmp960=({const char*_tmp3AD="cannot perform coercion since numelts cannot be determined statically.";_tag_dyneither(_tmp3AD,sizeof(char),71U);});Cyc_Tcutil_terr(_tmp961,_tmp960,_tag_dyneither(_tmp3AC,sizeof(void*),0U));});});
if(Cyc_Toc_is_toplevel(nv))
({void*_tmp3AE=0U;({struct _dyneither_ptr _tmp962=({const char*_tmp3AF="can't coerce t? to t* or t@ at the top-level";_tag_dyneither(_tmp3AF,sizeof(char),45U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(_tmp962,_tag_dyneither(_tmp3AE,sizeof(void*),0U));});});{
# 2461 "toc.cyc"
struct Cyc_Absyn_Exp*_tmp3B0=_tmp3AB;
if(_tmp384  && !_tmp385)
({struct Cyc_Absyn_Exp*_tmp964=({struct Cyc_Absyn_Exp*_tmp963=_tmp3AB;Cyc_Absyn_add_exp(_tmp963,Cyc_Absyn_uint_exp(1U,0U),0U);});_tmp3B0=_tmp964;});{
# 2468
struct Cyc_Absyn_Exp*_tmp3B1=Cyc_Toc__untag_dyneither_ptr_e;
struct Cyc_Absyn_Exp*_tmp3B2=({struct Cyc_Absyn_Exp*_tmp966=_tmp3B1;Cyc_Absyn_fncall_exp(_tmp966,({struct Cyc_Absyn_Exp*_tmp3B4[3U];_tmp3B4[0]=_tmp502,({
# 2471
struct Cyc_Absyn_Exp*_tmp965=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(_tmp3BC.elt_type),0U);_tmp3B4[1]=_tmp965;}),_tmp3B4[2]=_tmp3B0;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp3B4,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);});
# 2473
if(!_tmp381)
({void*_tmp969=({struct Cyc_Absyn_Exp*_tmp968=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_r(_tmp968,({struct Cyc_List_List*_tmp3B3=_cycalloc(sizeof(*_tmp3B3));
({struct Cyc_Absyn_Exp*_tmp967=Cyc_Absyn_copy_exp(_tmp3B2);_tmp3B3->hd=_tmp967;}),_tmp3B3->tl=0;_tmp3B3;}));});
# 2474
_tmp3B2->r=_tmp969;});
# 2476
({void*_tmp96A=Cyc_Toc_cast_it_r(*_tmp503,_tmp3B2);e->r=_tmp96A;});
goto _LLA3;};};}}else{_LLAA: _LLAB:
# 2481
 DynCast:
 if((_tmp384  && !_tmp385) && !(_tmp3BB.elt_tq).real_const){
if(Cyc_Toc_is_toplevel(nv))
({void*_tmp3B5=0U;({struct _dyneither_ptr _tmp96B=({const char*_tmp3B6="can't coerce a ZEROTERM to a non-const NOZEROTERM pointer at toplevel";_tag_dyneither(_tmp3B6,sizeof(char),70U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(_tmp96B,_tag_dyneither(_tmp3B5,sizeof(void*),0U));});});{
struct Cyc_Absyn_Exp*_tmp3B7=Cyc_Toc__dyneither_ptr_decrease_size_e;
({void*_tmp96F=({struct Cyc_Absyn_Exp*_tmp96E=_tmp3B7;Cyc_Toc_fncall_exp_r(_tmp96E,({struct Cyc_Absyn_Exp*_tmp3B8[3U];_tmp3B8[0]=_tmp502,({
struct Cyc_Absyn_Exp*_tmp96D=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(_tmp3BC.elt_type),0U);_tmp3B8[1]=_tmp96D;}),({
struct Cyc_Absyn_Exp*_tmp96C=Cyc_Absyn_uint_exp(1U,0U);_tmp3B8[2]=_tmp96C;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp3B8,sizeof(struct Cyc_Absyn_Exp*),3U));}));});
# 2486
e->r=_tmp96F;});};}
# 2490
goto _LLA3;}}_LLA3:;}
...
# 2494
{struct Cyc_Absyn_Exp*_tmp3B9=({void*_tmp970=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp970,(_tmp3BD.ptr_atts).bounds);});struct Cyc_Absyn_Exp*_tmp3BA=_tmp3B9;if(_tmp3BA == 0){_LLBB: _LLBC:
# 2496
({void*_tmp972=({struct Cyc_Absyn_Exp*_tmp971=Cyc_Absyn_new_exp(_tmp502->r,_tmp502->loc);Cyc_Toc_aggrmember_exp_r(_tmp971,Cyc_Toc_curr_sp);});_tmp502->r=_tmp972;});
...
# 2516
({void*_tmp974=({void*_tmp973=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_cast_it_r(_tmp973,_tmp504);});e->r=_tmp974;});}else{
if(Cyc_Tcutil_kind_leq(& Cyc_Tcutil_ak,Cyc_Tcutil_type_kind((void*)_check_null(_tmp504->topt))))
# 2520
({void*_tmp976=({void*_tmp975=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_cast_it_r(_tmp975,_tmp504);});e->r=_tmp976;});}
# 2522
...
# 2537
({void*_tmp977=Cyc_Toc_typ_to_c(_tmp3C2);elt_typ=_tmp977;});
({struct Cyc_Absyn_Exp*_tmp978=Cyc_Absyn_copy_exp(_tmp3BF);lhs=_tmp978;});
goto _LLBF;}else{_LLC2: _LLC3:
# 2541
({struct Cyc_Absyn_Exp*_tmp979=Cyc_Absyn_deref_exp(Cyc_Absyn_copy_exp(_tmp3BF),0U);lhs=_tmp979;});
goto _LLBF;}_LLBF:;}{
# 2544
...
({struct Cyc_Absyn_Exp*_tmp97C=({struct Cyc_Absyn_Exp*_tmp97B=Cyc_Toc__check_times_e;Cyc_Absyn_fncall_exp(_tmp97B,({struct Cyc_Absyn_Exp*_tmp3C5[2U];_tmp3C5[0]=(struct Cyc_Absyn_Exp*)_check_null(_tmp3C4),({
struct Cyc_Absyn_Exp*_tmp97A=Cyc_Absyn_sizeoftype_exp(elt_typ,0U);_tmp3C5[1]=_tmp97A;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp3C5,sizeof(struct Cyc_Absyn_Exp*),2U));}),0U);});
# 2549
mexp=_tmp97C;});else{
# 2552
({struct Cyc_Absyn_Exp*_tmp97D=Cyc_Absyn_sizeofexp_exp(Cyc_Absyn_deref_exp(_tmp3BF,0U),0U);mexp=_tmp97D;});}{
# 2555
struct Cyc_Absyn_Exp*_tmp3C6=Cyc_Toc_get_varsizeexp(_tmp505);
if(_tmp3C6 != 0)
({struct Cyc_Absyn_Exp*_tmp97E=Cyc_Absyn_add_exp(mexp,_tmp3C6,0U);mexp=_tmp97E;});
# 2559
if(_tmp506 == 0  || Cyc_Absyn_no_regions)
({struct Cyc_Absyn_Exp*_tmp97F=Cyc_Toc_malloc_exp(elt_typ,mexp);mexp=_tmp97F;});else{
# 2562
struct Cyc_Absyn_Exp*r=_tmp506;
Cyc_Toc_exp_to_c(nv,r);
({struct Cyc_Absyn_Exp*_tmp980=Cyc_Toc_rmalloc_exp(r,mexp);mexp=_tmp980;});}{
# 2566
struct Cyc_Absyn_Exp*answer;
if(Cyc_Tcutil_is_dyneither_ptr(old_typ))
({struct Cyc_Absyn_Exp*_tmp985=({struct Cyc_Absyn_Exp*_tmp984=Cyc_Toc__tag_dyneither_e;Cyc_Absyn_fncall_exp(_tmp984,({struct Cyc_Absyn_Exp*_tmp3C7[3U];({
struct Cyc_Absyn_Exp*_tmp983=Cyc_Absyn_copy_exp(_tmp3BF);_tmp3C7[0]=_tmp983;}),({
struct Cyc_Absyn_Exp*_tmp982=Cyc_Absyn_sizeoftype_exp(elt_typ,0U);_tmp3C7[1]=_tmp982;}),
(unsigned int)_tmp3C4?_tmp3C7[2]=_tmp3C4:({struct Cyc_Absyn_Exp*_tmp981=Cyc_Absyn_uint_exp(1U,0U);_tmp3C7[2]=_tmp981;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp3C7,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);});
# 2568
answer=_tmp985;});else{
# 2573
({struct Cyc_Absyn_Exp*_tmp986=Cyc_Absyn_copy_exp(_tmp3BF);answer=_tmp986;});}
({void*_tmp987=(void*)({struct Cyc_Toc_Dest_Absyn_AbsynAnnot_struct*_tmp3C8=_cycalloc(sizeof(*_tmp3C8));_tmp3C8->tag=Cyc_Toc_Dest,_tmp3C8->f1=_tmp3BF;_tmp3C8;});e->annot=_tmp987;});{
struct Cyc_Absyn_Stmt*_tmp3C9=({struct _tuple1*_tmp98B=_tmp3BE;void*_tmp98A=Cyc_Absyn_cstar_type(elt_typ,Cyc_Toc_mt_tq);struct Cyc_Absyn_Exp*_tmp989=mexp;Cyc_Absyn_declare_stmt(_tmp98B,_tmp98A,_tmp989,({
struct Cyc_Absyn_Stmt*_tmp988=Cyc_Absyn_exp_stmt(Cyc_Absyn_copy_exp(e),0U);Cyc_Absyn_seq_stmt(_tmp988,
Cyc_Absyn_exp_stmt(answer,0U),0U);}),0U);});
# 2579
if((unsigned int)array_len)
({struct Cyc_Absyn_Stmt*_tmp98C=Cyc_Absyn_declare_stmt((struct _tuple1*)_check_null(_tmp3C3),Cyc_Absyn_uint_type,array_len,_tmp3C9,0U);_tmp3C9=_tmp98C;});
({void*_tmp98D=Cyc_Toc_stmt_exp_r(_tmp3C9);e->r=_tmp98D;});
if(_tmp3C6 != 0)
...
if(_tmp3D2->impl == 0)
({void*_tmp3D3=0U;({struct _dyneither_ptr _tmp992=({const char*_tmp3D4="struct fields must be known";_tag_dyneither(_tmp3D4,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp992,_tag_dyneither(_tmp3D3,sizeof(void*),0U));});});
...
# 2616
 if(_tmp3E1 == 0)
({void*_tmp993=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp3D8=_cycalloc(sizeof(*_tmp3D8));_tmp3D8->tag=0U,_tmp3D8->f1=Cyc_Toc_tag_sp;_tmp3D8;}));_tmp3CD->hd=_tmp993;});else{
# 2619
({void*_tmp994=(*((struct _tuple12*(*)(struct Cyc_List_List*x,int n))Cyc_List_nth)(_tmp3DD->typs,(int)(_tmp3E1 - 1))).f2;_tmp3CC=_tmp994;});
({void*_tmp996=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp3D9=_cycalloc(sizeof(*_tmp3D9));_tmp3D9->tag=0U,({struct _dyneither_ptr*_tmp995=Cyc_Absyn_fieldname((int)_tmp3E1);_tmp3D9->f1=_tmp995;});_tmp3D9;}));_tmp3CD->hd=_tmp996;});}
# 2622
...
({void*_tmp997=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp3D6=_cycalloc(sizeof(*_tmp3D6));_tmp3D6->tag=0U,_tmp3D6->f1=_tmp3D5->name;_tmp3D6;}));_tmp3CD->hd=_tmp997;});
_tmp3CC=_tmp3D5->type;
goto _LLC9;}case 6U: _LLCE: _tmp3DF=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp3D1)->f1;_LLCF:
# 2612
({void*_tmp999=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp3D7=_cycalloc(sizeof(*_tmp3D7));_tmp3D7->tag=0U,({struct _dyneither_ptr*_tmp998=Cyc_Absyn_fieldname((int)(_tmp3E1 + 1));_tmp3D7->f1=_tmp998;});_tmp3D7;}));_tmp3CD->hd=_tmp999;});
({void*_tmp99A=(*((struct _tuple12*(*)(struct Cyc_List_List*x,int n))Cyc_List_nth)(_tmp3DF,(int)_tmp3E1)).f2;_tmp3CC=_tmp99A;});
goto _LLC9;default: _LLD2: _LLD3:
# 2623
({void*_tmp3DA=0U;({struct _dyneither_ptr _tmp99B=({const char*_tmp3DB="impossible type for offsetof tuple index";_tag_dyneither(_tmp3DB,sizeof(char),41U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp99B,_tag_dyneither(_tmp3DA,sizeof(void*),0U));});});
goto _LLC9;}_LLC9:;}
# 2626
goto _LLC4;}_LLC4:;}
# 2629
({void*_tmp99D=(void*)({struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmp3E2=_cycalloc(sizeof(*_tmp3E2));_tmp3E2->tag=19U,({void*_tmp99C=Cyc_Toc_typ_to_c(_tmp50A);_tmp3E2->f1=_tmp99C;}),_tmp3E2->f2=_tmp509;_tmp3E2;});e->r=_tmp99D;});
...
# 2637
{struct Cyc_Absyn_Exp*_tmp3E6=({void*_tmp99E=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp99E,_tmp3F7);});struct Cyc_Absyn_Exp*_tmp3E7=_tmp3E6;struct Cyc_Absyn_Exp*_tmp3F3;if(_tmp3E7 != 0){_LLDA: _tmp3F3=_tmp3E7;_LLDB: {
# 2639
...
({void*_tmp3E9=0U;({unsigned int _tmp9A0=e->loc;struct _dyneither_ptr _tmp99F=({const char*_tmp3EA="inserted null check due to dereference";_tag_dyneither(_tmp3EA,sizeof(char),39U);});Cyc_Tcutil_warn(_tmp9A0,_tmp99F,_tag_dyneither(_tmp3E9,sizeof(void*),0U));});});
# 2646
({void*_tmp9A4=({void*_tmp9A3=Cyc_Toc_typ_to_c(_tmp3E4);Cyc_Toc_cast_it_r(_tmp9A3,({
struct Cyc_Absyn_Exp*_tmp9A2=Cyc_Toc__check_null_e;Cyc_Absyn_fncall_exp(_tmp9A2,({struct Cyc_List_List*_tmp3EB=_cycalloc(sizeof(*_tmp3EB));
({struct Cyc_Absyn_Exp*_tmp9A1=Cyc_Absyn_copy_exp(_tmp50B);_tmp3EB->hd=_tmp9A1;}),_tmp3EB->tl=0;_tmp3EB;}),0U);}));});
# 2646
_tmp50B->r=_tmp9A4;});}
# 2654
...
({void*_tmp3EE=0U;({unsigned int _tmp9A6=e->loc;struct _dyneither_ptr _tmp9A5=({const char*_tmp3EF="cannot determine dereference is in bounds";_tag_dyneither(_tmp3EF,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp9A6,_tmp9A5,_tag_dyneither(_tmp3EE,sizeof(void*),0U));});});}
# 2663
goto _LLD9;}}else{_LLDC: _LLDD: {
# 2666
struct Cyc_Absyn_Exp*_tmp3F2=Cyc_Absyn_uint_exp(0U,0U);
_tmp3F2->topt=Cyc_Absyn_uint_type;
({void*_tmp9A7=Cyc_Toc_subscript_exp_r(_tmp50B,_tmp3F2);e->r=_tmp9A7;});
Cyc_Toc_exp_to_c(nv,e);
goto _LLD9;}}_LLD9:;}
# 2672
goto _LLD4;}else{_LLD7: _LLD8:
({void*_tmp3F4=0U;({struct _dyneither_ptr _tmp9A8=({const char*_tmp3F5="exp_to_c: Deref: non-pointer";_tag_dyneither(_tmp3F5,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp9A8,_tag_dyneither(_tmp3F4,sizeof(void*),0U));});});}_LLD4:;}
# 2675
...
if(_tmp50D  && _tmp50C)
({void*_tmp9AD=({struct Cyc_Absyn_Exp*_tmp9AC=_tmp50F;void*_tmp9AB=Cyc_Toc_typ_to_c(e1_cyc_type);void*_tmp9AA=e1_cyc_type;struct _dyneither_ptr*_tmp9A9=_tmp50E;Cyc_Toc_check_tagged_union(_tmp9AC,_tmp9AB,_tmp9AA,_tmp9A9,
Cyc_Toc_in_lhs(nv),Cyc_Toc_member_exp);});
# 2682
e->r=_tmp9AD;});
# 2686
if(is_poly)
({void*_tmp9AF=({void*_tmp9AE=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_array_to_ptr_cast(_tmp9AE,Cyc_Absyn_new_exp(e->r,0U),0U);})->r;e->r=_tmp9AF;});
...
{struct Cyc_Absyn_Exp*_tmp3FF=({void*_tmp9B0=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp9B0,_tmp411);});struct Cyc_Absyn_Exp*_tmp400=_tmp3FF;struct Cyc_Absyn_Exp*_tmp40F;if(_tmp400 != 0){_LLE5: _tmp40F=_tmp400;_LLE6: {
# 2701
...
if(_tmp40C){
if(_tmp40D < 1)
({void*_tmp404=0U;({struct _dyneither_ptr _tmp9B1=({const char*_tmp405="exp_to_c:  AggrArrow_e on pointer of size 0";_tag_dyneither(_tmp405,sizeof(char),44U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp9B1,_tag_dyneither(_tmp404,sizeof(void*),0U));});});
if(do_null_check){
if(Cyc_Toc_warn_all_null_deref)
({void*_tmp406=0U;({unsigned int _tmp9B3=e->loc;struct _dyneither_ptr _tmp9B2=({const char*_tmp407="inserted null check due to dereference";_tag_dyneither(_tmp407,sizeof(char),39U);});Cyc_Tcutil_warn(_tmp9B3,_tmp9B2,_tag_dyneither(_tmp406,sizeof(void*),0U));});});
# 2710
({void*_tmp9B7=({void*_tmp9B6=Cyc_Toc_typ_to_c(e1typ);Cyc_Toc_cast_it_r(_tmp9B6,({
struct Cyc_Absyn_Exp*_tmp9B5=Cyc_Toc__check_null_e;Cyc_Absyn_fncall_exp(_tmp9B5,({struct Cyc_Absyn_Exp*_tmp408[1U];({struct Cyc_Absyn_Exp*_tmp9B4=
Cyc_Absyn_new_exp(_tmp513->r,0U);_tmp408[0]=_tmp9B4;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp408,sizeof(struct Cyc_Absyn_Exp*),1U));}),0U);}));});
# 2710
_tmp513->r=_tmp9B7;});}}else{
# 2715
if(!Cyc_Evexp_c_can_eval(_tmp401))
({void*_tmp409=0U;({unsigned int _tmp9B9=e->loc;struct _dyneither_ptr _tmp9B8=({const char*_tmp40A="cannot determine pointer dereference in bounds";_tag_dyneither(_tmp40A,sizeof(char),47U);});Cyc_Tcutil_terr(_tmp9B9,_tmp9B8,_tag_dyneither(_tmp409,sizeof(void*),0U));});});
# 2719
({void*_tmp9BF=({void*_tmp9BE=Cyc_Toc_typ_to_c(e1typ);Cyc_Toc_cast_it_r(_tmp9BE,({
struct Cyc_Absyn_Exp*_tmp9BD=Cyc_Toc__check_known_subscript_null_e;Cyc_Absyn_fncall_exp(_tmp9BD,({struct Cyc_Absyn_Exp*_tmp40B[4U];({
struct Cyc_Absyn_Exp*_tmp9BC=Cyc_Absyn_new_exp(_tmp513->r,0U);_tmp40B[0]=_tmp9BC;}),_tmp40B[1]=_tmp401,({
struct Cyc_Absyn_Exp*_tmp9BB=Cyc_Absyn_sizeoftype_exp(_tmp415,0U);_tmp40B[2]=_tmp9BB;}),({
struct Cyc_Absyn_Exp*_tmp9BA=Cyc_Absyn_uint_exp(0U,0U);_tmp40B[3]=_tmp9BA;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp40B,sizeof(struct Cyc_Absyn_Exp*),4U));}),0U);}));});
# 2719
_tmp513->r=_tmp9BF;});}
# 2725
...
({void*_tmp9C5=({void*_tmp9C4=Cyc_Absyn_cstar_type(ta1,_tmp414);Cyc_Toc_cast_it_r(_tmp9C4,({
struct Cyc_Absyn_Exp*_tmp9C3=Cyc_Toc__check_dyneither_subscript_e;Cyc_Absyn_fncall_exp(_tmp9C3,({struct Cyc_Absyn_Exp*_tmp40E[3U];({
struct Cyc_Absyn_Exp*_tmp9C2=Cyc_Absyn_new_exp(_tmp513->r,0U);_tmp40E[0]=_tmp9C2;}),({
struct Cyc_Absyn_Exp*_tmp9C1=Cyc_Absyn_sizeoftype_exp(ta1,0U);_tmp40E[1]=_tmp9C1;}),({
struct Cyc_Absyn_Exp*_tmp9C0=Cyc_Absyn_uint_exp(0U,0U);_tmp40E[2]=_tmp9C0;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp40E,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);}));});
# 2729
_tmp513->r=_tmp9C5;});
# 2736
goto _LLE4;}}_LLE4:;}
# 2738
if(_tmp511  && _tmp510)
({void*_tmp9CA=({struct Cyc_Absyn_Exp*_tmp9C9=_tmp513;void*_tmp9C8=Cyc_Toc_typ_to_c(e1typ);void*_tmp9C7=_tmp415;struct _dyneither_ptr*_tmp9C6=_tmp512;Cyc_Toc_check_tagged_union(_tmp9C9,_tmp9C8,_tmp9C7,_tmp9C6,Cyc_Toc_in_lhs(nv),Cyc_Absyn_aggrarrow_exp);});e->r=_tmp9CA;});
# 2741
if(is_poly  && _tmp510)
({void*_tmp9CC=({void*_tmp9CB=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_array_to_ptr_cast(_tmp9CB,Cyc_Absyn_new_exp(e->r,0U),0U);})->r;e->r=_tmp9CC;});
...
if(!_tmp41D)
({void*_tmp41B=0U;({struct _dyneither_ptr _tmp9CD=({const char*_tmp41C="unknown tuple subscript in translation to C";_tag_dyneither(_tmp41C,sizeof(char),44U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp9CD,_tag_dyneither(_tmp41B,sizeof(void*),0U));});});
({void*_tmp9CF=({struct Cyc_Absyn_Exp*_tmp9CE=_tmp515;Cyc_Toc_aggrmember_exp_r(_tmp9CE,Cyc_Absyn_fieldname((int)(_tmp41E + 1)));});e->r=_tmp9CF;});
...
# 2769
int in_bnds=_tmp421;
{struct Cyc_Absyn_Exp*_tmp422=({void*_tmp9D0=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp9D0,_tmp443);});struct Cyc_Absyn_Exp*_tmp423=_tmp422;_LLF7: _LLF8:
# 2772
({int _tmp9D1=in_bnds  || Cyc_Toc_check_bounds(_tmp417,_tmp41F,_tmp515,_tmp514);in_bnds=_tmp9D1;});
if(Cyc_Toc_warn_bounds_checks  && !in_bnds)
({struct Cyc_String_pa_PrintArg_struct _tmp426=({struct Cyc_String_pa_PrintArg_struct _tmp7A8;_tmp7A8.tag=0U,({struct _dyneither_ptr _tmp9D2=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp7A8.f1=_tmp9D2;});_tmp7A8;});void*_tmp424[1U];_tmp424[0]=& _tmp426;({unsigned int _tmp9D4=e->loc;struct _dyneither_ptr _tmp9D3=({const char*_tmp425="bounds check necessary for %s";_tag_dyneither(_tmp425,sizeof(char),30U);});Cyc_Tcutil_warn(_tmp9D4,_tmp9D3,_tag_dyneither(_tmp424,sizeof(void*),1U));});});_LLF6:;}
# 2779
Cyc_Toc_exp_to_c(nv,_tmp515);
Cyc_Toc_exp_to_c(nv,_tmp514);
++ Cyc_Toc_total_bounds_checks;
{struct Cyc_Absyn_Exp*_tmp427=({void*_tmp9D5=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp9D5,_tmp443);});struct Cyc_Absyn_Exp*_tmp428=_tmp427;struct Cyc_Absyn_Exp*_tmp43E;if(_tmp428 != 0){_LLFA: _tmp43E=_tmp428;_LLFB: {
# 2784
...
if(Cyc_Toc_warn_all_null_deref)
({void*_tmp42C=0U;({unsigned int _tmp9D7=e->loc;struct _dyneither_ptr _tmp9D6=({const char*_tmp42D="inserted null check due to dereference";_tag_dyneither(_tmp42D,sizeof(char),39U);});Cyc_Tcutil_warn(_tmp9D7,_tmp9D6,_tag_dyneither(_tmp42C,sizeof(void*),0U));});});
({void*_tmp9DB=({void*_tmp9DA=ta2;Cyc_Toc_cast_it_r(_tmp9DA,({struct Cyc_Absyn_Exp*_tmp9D9=Cyc_Toc__check_null_e;Cyc_Absyn_fncall_exp(_tmp9D9,({struct Cyc_Absyn_Exp*_tmp42E[1U];({struct Cyc_Absyn_Exp*_tmp9D8=
Cyc_Absyn_copy_exp(_tmp515);_tmp42E[0]=_tmp9D8;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp42E,sizeof(struct Cyc_Absyn_Exp*),1U));}),0U);}));});
# 2795
_tmp515->r=_tmp9DB;});}else{
# 2799
if((_tmp43A  && _tmp43B == 1) && Cyc_Tcutil_force_type2bool(0,_tmp442)){
# 2801
if(!Cyc_Evexp_c_can_eval(_tmp429))
({void*_tmp42F=0U;({unsigned int _tmp9DD=e->loc;struct _dyneither_ptr _tmp9DC=({const char*_tmp430="cannot determine subscript is in bounds";_tag_dyneither(_tmp430,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp9DD,_tmp9DC,_tag_dyneither(_tmp42F,sizeof(void*),0U));});});{
struct Cyc_Absyn_Exp*function_e=Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__zero_arr_plus_functionSet,_tmp515);
({void*_tmp9E0=Cyc_Toc_deref_exp_r(({void*_tmp9DF=ta2;Cyc_Toc_cast_it(_tmp9DF,({
struct Cyc_Absyn_Exp*_tmp9DE=function_e;Cyc_Absyn_fncall_exp(_tmp9DE,({struct Cyc_Absyn_Exp*_tmp431[3U];_tmp431[0]=_tmp515,_tmp431[1]=_tmp429,_tmp431[2]=_tmp514;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp431,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);}));}));
# 2804
e->r=_tmp9E0;});};}else{
# 2807
if(possibly_null){
if(!Cyc_Evexp_c_can_eval(_tmp429))
({void*_tmp432=0U;({unsigned int _tmp9E2=e->loc;struct _dyneither_ptr _tmp9E1=({const char*_tmp433="cannot determine subscript is in bounds";_tag_dyneither(_tmp433,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp9E2,_tmp9E1,_tag_dyneither(_tmp432,sizeof(void*),0U));});});
if(Cyc_Toc_warn_all_null_deref)
({void*_tmp434=0U;({unsigned int _tmp9E4=e->loc;struct _dyneither_ptr _tmp9E3=({const char*_tmp435="inserted null check due to dereference";_tag_dyneither(_tmp435,sizeof(char),39U);});Cyc_Tcutil_warn(_tmp9E4,_tmp9E3,_tag_dyneither(_tmp434,sizeof(void*),0U));});});
# 2813
({void*_tmp9E8=Cyc_Toc_deref_exp_r(({void*_tmp9E7=ta2;Cyc_Toc_cast_it(_tmp9E7,({
struct Cyc_Absyn_Exp*_tmp9E6=Cyc_Toc__check_known_subscript_null_e;Cyc_Absyn_fncall_exp(_tmp9E6,({struct Cyc_Absyn_Exp*_tmp436[4U];_tmp436[0]=_tmp515,_tmp436[1]=_tmp429,({
# 2816
struct Cyc_Absyn_Exp*_tmp9E5=Cyc_Absyn_sizeoftype_exp(ta1,0U);_tmp436[2]=_tmp9E5;}),_tmp436[3]=_tmp514;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp436,sizeof(struct Cyc_Absyn_Exp*),4U));}),0U);}));}));
# 2813
e->r=_tmp9E8;});}else{
# 2819
if(!Cyc_Evexp_c_can_eval(_tmp429))
({void*_tmp437=0U;({unsigned int _tmp9EA=e->loc;struct _dyneither_ptr _tmp9E9=({const char*_tmp438="cannot determine subscript is in bounds";_tag_dyneither(_tmp438,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp9EA,_tmp9E9,_tag_dyneither(_tmp437,sizeof(void*),0U));});});
# 2822
({void*_tmp9ED=({struct Cyc_Absyn_Exp*_tmp9EC=Cyc_Toc__check_known_subscript_notnull_e;Cyc_Toc_fncall_exp_r(_tmp9EC,({struct Cyc_Absyn_Exp*_tmp439[2U];_tmp439[0]=_tmp429,({
struct Cyc_Absyn_Exp*_tmp9EB=Cyc_Absyn_copy_exp(_tmp514);_tmp439[1]=_tmp9EB;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp439,sizeof(struct Cyc_Absyn_Exp*),2U));}));});
# 2822
_tmp514->r=_tmp9ED;});}}}}
# 2825
...
# 2831
++ Cyc_Toc_bounds_checks_eliminated;
({void*_tmp9F0=({struct Cyc_Absyn_Exp*_tmp9EF=({void*_tmp9EE=Cyc_Absyn_cstar_type(ta1,_tmp446);Cyc_Toc_cast_it(_tmp9EE,
Cyc_Toc_member_exp(_tmp515,Cyc_Toc_curr_sp,0U));});
# 2832
Cyc_Toc_subscript_exp_r(_tmp9EF,_tmp514);});e->r=_tmp9F0;});}else{
# 2836
struct Cyc_Absyn_Exp*_tmp43C=Cyc_Toc__check_dyneither_subscript_e;
({void*_tmp9F4=Cyc_Toc_deref_exp_r(({void*_tmp9F3=Cyc_Absyn_cstar_type(ta1,_tmp446);Cyc_Toc_cast_it(_tmp9F3,({
struct Cyc_Absyn_Exp*_tmp9F2=_tmp43C;Cyc_Absyn_fncall_exp(_tmp9F2,({struct Cyc_Absyn_Exp*_tmp43D[3U];_tmp43D[0]=_tmp515,({
struct Cyc_Absyn_Exp*_tmp9F1=Cyc_Absyn_sizeoftype_exp(ta1,0U);_tmp43D[1]=_tmp9F1;}),_tmp43D[2]=_tmp514;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp43D,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);}));}));
# 2837
e->r=_tmp9F4;});}
# 2842
goto _LLF9;}}_LLF9:;}
...
({void*_tmp43F=0U;({struct _dyneither_ptr _tmp9F5=({const char*_tmp440="exp_to_c: Subscript on non-tuple/array/tuple ptr";_tag_dyneither(_tmp440,sizeof(char),49U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp9F5,_tag_dyneither(_tmp43F,sizeof(void*),0U));});});}_LLEC:;}
# 2847
...
({struct Cyc_List_List*_tmp9F8=({struct Cyc_List_List*_tmp44A=_cycalloc(sizeof(*_tmp44A));({struct _tuple20*_tmp9F7=({struct _dyneither_ptr*_tmp9F6=Cyc_Absyn_fieldname(i);Cyc_Toc_make_field(_tmp9F6,(struct Cyc_Absyn_Exp*)_tmp516->hd);});_tmp44A->hd=_tmp9F7;}),_tmp44A->tl=dles;_tmp44A;});dles=_tmp9F8;});}}
# 2861
({void*_tmp9FA=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp44B=_cycalloc(sizeof(*_tmp44B));_tmp44B->tag=29U,_tmp44B->f1=sd->name,_tmp44B->f2=0,({struct Cyc_List_List*_tmp9F9=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);_tmp44B->f3=_tmp9F9;}),_tmp44B->f4=sd;_tmp44B;});e->r=_tmp9FA;});
e->topt=_tmp448;
goto _LL101;}}else{goto _LL104;}}else{goto _LL104;}}else{_LL104: _LL105:
({void*_tmp44C=0U;({struct _dyneither_ptr _tmp9FB=({const char*_tmp44D="tuple type not an aggregate";_tag_dyneither(_tmp44D,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmp9FB,_tag_dyneither(_tmp44C,sizeof(void*),0U));});});}_LL101:;}
# 2866
goto _LL0;}else{
# 2870
struct Cyc_List_List*dles=0;
...
Cyc_Toc_exp_to_c(nv,(struct Cyc_Absyn_Exp*)_tmp516->hd);
({struct Cyc_List_List*_tmp9FD=({struct Cyc_List_List*_tmp450=_cycalloc(sizeof(*_tmp450));({struct _tuple20*_tmp9FC=({struct _tuple20*_tmp44F=_cycalloc(sizeof(*_tmp44F));_tmp44F->f1=0,_tmp44F->f2=(struct Cyc_Absyn_Exp*)_tmp516->hd;_tmp44F;});_tmp450->hd=_tmp9FC;}),_tmp450->tl=dles;_tmp450;});dles=_tmp9FD;});}
# 2875
({void*_tmp9FE=Cyc_Toc_unresolvedmem_exp_r(0,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles));e->r=_tmp9FE;});}
# 2877
...
if(Cyc_Toc_is_toplevel(nv))
({void*_tmp9FF=Cyc_Toc_unresolvedmem_exp_r(0,_tmp517);e->r=_tmp9FF;});
...
if(!_tmp45C)
({void*_tmp455=0U;({unsigned int _tmpA01=_tmp51A->loc;struct _dyneither_ptr _tmpA00=({const char*_tmp456="cannot determine value of constant";_tag_dyneither(_tmp456,sizeof(char),35U);});Cyc_Tcutil_terr(_tmpA01,_tmpA00,_tag_dyneither(_tmp455,sizeof(void*),0U));});});
{unsigned int i=0U;for(0;i < _tmp45D;++ i){
({struct Cyc_List_List*_tmpA03=({struct Cyc_List_List*_tmp458=_cycalloc(sizeof(*_tmp458));({struct _tuple20*_tmpA02=({struct _tuple20*_tmp457=_cycalloc(sizeof(*_tmp457));_tmp457->f1=0,_tmp457->f2=_tmp519;_tmp457;});_tmp458->hd=_tmpA02;}),_tmp458->tl=es;_tmp458;});es=_tmpA03;});}}
# 2904
if(_tmp518){
struct Cyc_Absyn_Exp*_tmp459=({void*_tmpA04=_tmp454;Cyc_Toc_cast_it(_tmpA04,Cyc_Absyn_uint_exp(0U,0U));});
({struct Cyc_List_List*_tmpA07=({struct Cyc_List_List*_tmpA06=es;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmpA06,({struct Cyc_List_List*_tmp45B=_cycalloc(sizeof(*_tmp45B));({struct _tuple20*_tmpA05=({struct _tuple20*_tmp45A=_cycalloc(sizeof(*_tmp45A));_tmp45A->f1=0,_tmp45A->f2=_tmp459;_tmp45A;});_tmp45B->hd=_tmpA05;}),_tmp45B->tl=0;_tmp45B;}));});es=_tmpA07;});}}
# 2909
({void*_tmpA08=Cyc_Toc_unresolvedmem_exp_r(0,es);e->r=_tmpA08;});};}
# 2911
...
# 2918
 if(Cyc_Toc_is_toplevel(nv))
({void*_tmpA09=Cyc_Toc_unresolvedmem_exp_r(0,0);e->r=_tmpA09;});else{
# 2921
...
({void*_tmpA0A=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp462=_cycalloc(sizeof(*_tmp462));_tmp462->tag=29U,_tmp462->f1=sd->name,_tmp462->f2=0,_tmp462->f3=_tmp51F,_tmp462->f4=sd;_tmp462;});e->r=_tmpA0A;});
e->topt=_tmp45F;
goto _LL109;}}else{goto _LL10C;}}else{goto _LL10C;}}else{_LL10C: _LL10D:
({void*_tmp463=0U;({struct _dyneither_ptr _tmpA0B=({const char*_tmp464="anonStruct type not an aggregate";_tag_dyneither(_tmp464,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpA0B,_tag_dyneither(_tmp463,sizeof(void*),0U));});});}_LL109:;}else{
# 2939
({void*_tmpA0C=Cyc_Toc_unresolvedmem_exp_r(0,_tmp51F);e->r=_tmpA0C;});}
...
({void*_tmp466=0U;({struct _dyneither_ptr _tmpA0D=({const char*_tmp467="exp_to_c, Aggregate_e: missing aggrdecl pointer or fields";_tag_dyneither(_tmp467,sizeof(char),58U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpA0D,_tag_dyneither(_tmp466,sizeof(void*),0U));});});{
...
({struct _tuple1*_tmpA0E=(Cyc_Absyn_aggr_kinded_name(_tmp46D)).f2;*_tmp524=_tmpA0E;});goto _LL10E;}else{goto _LL111;}}else{_LL111: _LL112:
({void*_tmp46B=0U;({struct _dyneither_ptr _tmpA0F=({const char*_tmp46C="exp_to_c, Aggregate_e: bad type translation";_tag_dyneither(_tmp46C,sizeof(char),44U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpA0F,_tag_dyneither(_tmp46B,sizeof(void*),0U));});});}_LL10E:;}{
# 2956
...
({void*_tmpA11=({void*_tmpA10=Cyc_Toc_typ_to_c(_tmp49B->type);Cyc_Toc_cast_it(_tmpA10,
...
struct _tuple1*s=({struct _tuple1*_tmp485=_cycalloc(sizeof(*_tmp485));({union Cyc_Absyn_Nmspace _tmpA15=Cyc_Absyn_Abs_n(0,1);_tmp485->f1=_tmpA15;}),({
struct _dyneither_ptr*_tmpA14=({struct _dyneither_ptr*_tmp484=_cycalloc(sizeof(*_tmp484));({struct _dyneither_ptr _tmpA13=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp482=({struct Cyc_String_pa_PrintArg_struct _tmp7AA;_tmp7AA.tag=0U,_tmp7AA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp521->name).f2);_tmp7AA;});struct Cyc_String_pa_PrintArg_struct _tmp483=({struct Cyc_String_pa_PrintArg_struct _tmp7A9;_tmp7A9.tag=0U,_tmp7A9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp477);_tmp7A9;});void*_tmp480[2U];_tmp480[0]=& _tmp482,_tmp480[1]=& _tmp483;({struct _dyneither_ptr _tmpA12=({const char*_tmp481="_union_%s_%s";_tag_dyneither(_tmp481,sizeof(char),13U);});Cyc_aprintf(_tmpA12,_tag_dyneither(_tmp480,sizeof(void*),2U));});});*_tmp484=_tmpA13;});_tmp484;});_tmp485->f2=_tmpA14;});_tmp485;});
# 2985
struct _tuple20*_tmp47B=({
struct _dyneither_ptr*_tmpA17=_tmp477;Cyc_Toc_make_field(_tmpA17,Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp47F=_cycalloc(sizeof(*_tmp47F));_tmp47F->tag=29U,_tmp47F->f1=s,_tmp47F->f2=0,({struct Cyc_List_List*_tmpA16=({struct _tuple20*_tmp47E[2U];_tmp47E[0]=_tmp479,_tmp47E[1]=_tmp47A;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp47E,sizeof(struct _tuple20*),2U));});_tmp47F->f3=_tmpA16;}),_tmp47F->f4=0;_tmp47F;}),0U));});
# 2988
({void*_tmpA19=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp47D=_cycalloc(sizeof(*_tmp47D));_tmp47D->tag=29U,_tmp47D->f1=*_tmp524,_tmp47D->f2=0,({struct Cyc_List_List*_tmpA18=({struct _tuple20*_tmp47C[1U];_tmp47C[0]=_tmp47B;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp47C,sizeof(struct _tuple20*),1U));});_tmp47D->f3=_tmpA18;}),_tmp47D->f4=_tmp521;_tmp47D;});e->r=_tmpA19;});}
# 2994
if(Cyc_Toc_is_abstract_type(old_typ) && _tmp46F == _tmp49B){
struct Cyc_List_List*_tmp486=({struct Cyc_List_List*_tmpA1A=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_zip)(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp521->impl))->exist_vars,_tmp523);((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmpA1A,
...
struct Cyc_Absyn_Aggrfield*_tmp48A=({struct Cyc_Absyn_Aggrfield*_tmpA1B=_tmp488;Cyc_Toc_aggrfield_to_c(_tmpA1B,
Cyc_Toc_typ_to_c(Cyc_Tcutil_substitute(_tmp486,_tmp489)));});
({struct Cyc_List_List*_tmpA1C=({struct Cyc_List_List*_tmp48B=_cycalloc(sizeof(*_tmp48B));_tmp48B->hd=_tmp48A,_tmp48B->tl=new_fields;_tmp48B;});new_fields=_tmpA1C;});
# 3009
if(_tmp487->tl == 0){
...
({struct Cyc_Absyn_Exp*_tmpA1D=Cyc_Absyn_uint_exp(0U,0U);_tmp48E.num_elts=_tmpA1D;});
({void*_tmpA1E=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp48F=_cycalloc(sizeof(*_tmp48F));_tmp48F->tag=4U,_tmp48F->f1=_tmp48E;_tmp48F;});_tmp48A->type=_tmpA1E;});}
# 3017
...
({struct Cyc_List_List*_tmpA20=({struct Cyc_List_List*_tmp494=_cycalloc(sizeof(*_tmp494));({void*_tmpA1F=(void*)({struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_tmp493=_cycalloc(sizeof(*_tmp493));_tmp493->tag=6U,_tmp493->f1=0;_tmp493;});_tmp494->hd=_tmpA1F;}),_tmp494->tl=_tmp48A->attributes;_tmp494;});_tmp48A->attributes=_tmpA20;});}}}
# 3038
({struct Cyc_Absyn_Aggrdecl*_tmpA24=({struct _dyneither_ptr*_tmpA23=({struct _dyneither_ptr*_tmp498=_cycalloc(sizeof(*_tmp498));({struct _dyneither_ptr _tmpA22=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp497=({struct Cyc_Int_pa_PrintArg_struct _tmp7AB;_tmp7AB.tag=1U,_tmp7AB.f1=(unsigned long)Cyc_Toc_tuple_type_counter ++;_tmp7AB;});void*_tmp495[1U];_tmp495[0]=& _tmp497;({struct _dyneither_ptr _tmpA21=({const char*_tmp496="_genStruct%d";_tag_dyneither(_tmp496,sizeof(char),13U);});Cyc_aprintf(_tmpA21,_tag_dyneither(_tmp495,sizeof(void*),1U));});});*_tmp498=_tmpA22;});_tmp498;});Cyc_Toc_make_c_struct_defn(_tmpA23,
# 3040
...
# 3044
({void*_tmpA25=Cyc_Absyn_aggr_type(Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp499=_cycalloc(sizeof(*_tmp499));*_tmp499=_tmp521;_tmp499;})),0);e->topt=_tmpA25;});}};}}
# 3047
goto _LL113;}else{goto _LL116;}}else{_LL116: _LL117:
({void*_tmp49C=0U;({struct _dyneither_ptr _tmpA26=({const char*_tmp49D="exp_to_c, Aggregate_e: bad struct type";_tag_dyneither(_tmp49D,sizeof(char),39U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpA26,_tag_dyneither(_tmp49C,sizeof(void*),0U));});});}_LL113:;}else{
# 3056
if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp521->impl))->tagged){
# 3058
...
({void*_tmpA28=({
void*_tmpA27=Cyc_Absyn_void_star_type();Cyc_Toc_cast_it_r(_tmpA27,Cyc_Absyn_new_exp(_tmp4A8->r,0U));});
# 3064
_tmp4A8->r=_tmpA28;});{
# 3067
int i=Cyc_Toc_get_member_offset(_tmp521,_tmp4A9->name);
struct Cyc_Absyn_Exp*field_tag_exp=Cyc_Absyn_signed_int_exp(i,0U);
struct Cyc_List_List*_tmp4A3=({struct _tuple20*_tmp4A5[2U];({struct _tuple20*_tmpA2A=({struct _tuple20*_tmp4A6=_cycalloc(sizeof(*_tmp4A6));_tmp4A6->f1=0,_tmp4A6->f2=field_tag_exp;_tmp4A6;});_tmp4A5[0]=_tmpA2A;}),({struct _tuple20*_tmpA29=({struct _tuple20*_tmp4A7=_cycalloc(sizeof(*_tmp4A7));_tmp4A7->f1=0,_tmp4A7->f2=_tmp4A8;_tmp4A7;});_tmp4A5[1]=_tmpA29;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp4A5,sizeof(struct _tuple20*),2U));});
struct Cyc_Absyn_Exp*umem=Cyc_Absyn_unresolvedmem_exp(0,_tmp4A3,0U);
({void*_tmpA2C=Cyc_Toc_unresolvedmem_exp_r(0,({struct _tuple20*_tmp4A4[1U];({struct _tuple20*_tmpA2B=Cyc_Toc_make_field(_tmp4A9->name,umem);_tmp4A4[0]=_tmpA2B;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp4A4,sizeof(struct _tuple20*),1U));}));e->r=_tmpA2C;});};};}else{
# 3074
...
({struct Cyc_Absyn_Exp*_tmpA2E=({void*_tmpA2D=_tmp4AF;Cyc_Toc_cast_it(_tmpA2D,Cyc_Absyn_copy_exp(_tmp4B3));});_tmp4B3=_tmpA2E;});}
({struct Cyc_List_List*_tmpA30=({struct Cyc_List_List*_tmp4B2=_cycalloc(sizeof(*_tmp4B2));({struct _tuple20*_tmpA2F=({struct _tuple20*_tmp4B1=_cycalloc(sizeof(*_tmp4B1));_tmp4B1->f1=0,_tmp4B1->f2=_tmp4B3;_tmp4B1;});_tmp4B2->hd=_tmpA2F;}),_tmp4B2->tl=_tmp4AA;_tmp4B2;});_tmp4AA=_tmpA30;});
break;};}}}
# 3093
({void*_tmpA31=Cyc_Toc_unresolvedmem_exp_r(0,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp4AA));e->r=_tmpA31;});}}
# 3096
...
({void*_tmpA32=(Cyc_Toc_cast_it(field_typ,cur_e))->r;cur_e->r=_tmpA32;});}}{
# 3111
...
({struct Cyc_List_List*_tmpA35=({struct Cyc_List_List*_tmp4B9=_cycalloc(sizeof(*_tmp4B9));({struct _tuple20*_tmpA34=({struct _dyneither_ptr*_tmpA33=Cyc_Absyn_fieldname(i);Cyc_Toc_make_field(_tmpA33,(struct Cyc_Absyn_Exp*)_tmp527->hd);});_tmp4B9->hd=_tmpA34;}),_tmp4B9->tl=dles;_tmp4B9;});dles=_tmpA35;});}}{
# 3122
struct _tuple20*_tmp4BA=Cyc_Toc_make_field(Cyc_Toc_tag_sp,_tmp4B8);
({void*_tmpA39=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp4BC=_cycalloc(sizeof(*_tmp4BC));_tmp4BC->tag=29U,({struct _tuple1*_tmpA38=Cyc_Toc_collapse_qvars(_tmp525->name,_tmp526->name);_tmp4BC->f1=_tmpA38;}),_tmp4BC->f2=0,({
struct Cyc_List_List*_tmpA37=({struct Cyc_List_List*_tmp4BB=_cycalloc(sizeof(*_tmp4BB));_tmp4BB->hd=_tmp4BA,({struct Cyc_List_List*_tmpA36=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);_tmp4BB->tl=_tmpA36;});_tmp4BB;});_tmp4BC->f3=_tmpA37;}),_tmp4BC->f4=0;_tmp4BC;});
# 3123
e->r=_tmpA39;});};}else{
# 3128
struct Cyc_List_List*_tmp4BD=0;
for(0;_tmp527 != 0;_tmp527=_tmp527->tl){
({struct Cyc_List_List*_tmpA3B=({struct Cyc_List_List*_tmp4BF=_cycalloc(sizeof(*_tmp4BF));({struct _tuple20*_tmpA3A=({struct _tuple20*_tmp4BE=_cycalloc(sizeof(*_tmp4BE));_tmp4BE->f1=0,_tmp4BE->f2=(struct Cyc_Absyn_Exp*)_tmp527->hd;_tmp4BE;});_tmp4BF->hd=_tmpA3A;}),_tmp4BF->tl=_tmp4BD;_tmp4BF;});_tmp4BD=_tmpA3B;});}
({void*_tmpA3E=Cyc_Toc_unresolvedmem_exp_r(0,({struct Cyc_List_List*_tmp4C1=_cycalloc(sizeof(*_tmp4C1));({struct _tuple20*_tmpA3D=({struct _tuple20*_tmp4C0=_cycalloc(sizeof(*_tmp4C0));_tmp4C0->f1=0,_tmp4C0->f2=_tmp4B8;_tmp4C0;});_tmp4C1->hd=_tmpA3D;}),({
struct Cyc_List_List*_tmpA3C=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp4BD);_tmp4C1->tl=_tmpA3C;});_tmp4C1;}));
# 3131
e->r=_tmpA3E;});}
# 3134
...
({struct Cyc_Absyn_Exp*_tmpA41=({struct Cyc_Absyn_Exp*_tmpA40=rgn;struct Cyc_Absyn_Exp*_tmpA3F=Cyc_Absyn_sizeoftype_exp(t_c,0U);Cyc_Toc_rcalloc_exp(_tmpA40,_tmpA3F,Cyc_Absyn_var_exp(_tmp4C2,0U));});pexp=_tmpA41;});}else{
# 3155
({struct Cyc_Absyn_Exp*_tmpA44=({void*_tmpA43=*_tmp52B;struct Cyc_Absyn_Exp*_tmpA42=Cyc_Absyn_sizeoftype_exp(t_c,0U);Cyc_Toc_calloc_exp(_tmpA43,_tmpA42,Cyc_Absyn_var_exp(_tmp4C2,0U));});pexp=_tmpA44;});}
# 3157
({struct Cyc_Absyn_Exp*_tmpA49=({struct Cyc_Absyn_Exp*_tmpA48=Cyc_Toc__tag_dyneither_e;Cyc_Absyn_fncall_exp(_tmpA48,({struct Cyc_Absyn_Exp*_tmp4C4[3U];({
struct Cyc_Absyn_Exp*_tmpA47=Cyc_Absyn_var_exp(_tmp4C3,0U);_tmp4C4[0]=_tmpA47;}),({struct Cyc_Absyn_Exp*_tmpA46=Cyc_Absyn_sizeoftype_exp(t_c,0U);_tmp4C4[1]=_tmpA46;}),({
struct Cyc_Absyn_Exp*_tmpA45=Cyc_Absyn_var_exp(_tmp4C2,0U);_tmp4C4[2]=_tmpA45;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp4C4,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);});
# 3157
rexp=_tmpA49;});}else{
# 3161
if(_tmp52C != 0  && !Cyc_Absyn_no_regions){
...
Cyc_Toc_exp_to_c(nv,rgn);
if(_tmp528)
({struct Cyc_Absyn_Exp*_tmpA4B=({struct Cyc_Absyn_Exp*_tmpA4A=rgn;Cyc_Toc_rmalloc_inline_exp(_tmpA4A,Cyc_Absyn_var_exp(_tmp4C2,0U));});pexp=_tmpA4B;});else{
# 3167
({struct Cyc_Absyn_Exp*_tmpA4D=({struct Cyc_Absyn_Exp*_tmpA4C=rgn;Cyc_Toc_rmalloc_exp(_tmpA4C,Cyc_Absyn_var_exp(_tmp4C2,0U));});pexp=_tmpA4D;});}}else{
# 3169
({struct Cyc_Absyn_Exp*_tmpA4F=({void*_tmpA4E=*_tmp52B;Cyc_Toc_malloc_exp(_tmpA4E,Cyc_Absyn_var_exp(_tmp4C2,0U));});pexp=_tmpA4F;});}
# 3171
({struct Cyc_Absyn_Exp*_tmpA54=({struct Cyc_Absyn_Exp*_tmpA53=Cyc_Toc__tag_dyneither_e;Cyc_Absyn_fncall_exp(_tmpA53,({struct Cyc_Absyn_Exp*_tmp4C5[3U];({struct Cyc_Absyn_Exp*_tmpA52=Cyc_Absyn_var_exp(_tmp4C3,0U);_tmp4C5[0]=_tmpA52;}),({struct Cyc_Absyn_Exp*_tmpA51=Cyc_Absyn_uint_exp(1U,0U);_tmp4C5[1]=_tmpA51;}),({
struct Cyc_Absyn_Exp*_tmpA50=Cyc_Absyn_var_exp(_tmp4C2,0U);_tmp4C5[2]=_tmpA50;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp4C5,sizeof(struct Cyc_Absyn_Exp*),3U));}),0U);});
# 3171
rexp=_tmpA54;});}{
# 3174
struct Cyc_Absyn_Stmt*_tmp4C6=({struct _tuple1*_tmpA5A=_tmp4C2;void*_tmpA59=Cyc_Absyn_uint_type;struct Cyc_Absyn_Exp*_tmpA58=_tmp52A;Cyc_Absyn_declare_stmt(_tmpA5A,_tmpA59,_tmpA58,({
struct _tuple1*_tmpA57=_tmp4C3;void*_tmpA56=Cyc_Absyn_cstar_type(t_c,Cyc_Toc_mt_tq);struct Cyc_Absyn_Exp*_tmpA55=pexp;Cyc_Absyn_declare_stmt(_tmpA57,_tmpA56,_tmpA55,
Cyc_Absyn_exp_stmt(rexp,0U),0U);}),0U);});
({void*_tmpA5B=Cyc_Toc_stmt_exp_r(_tmp4C6);e->r=_tmpA5B;});};}else{
# 3179
if(_tmp52D){
if(_tmp52C != 0  && !Cyc_Absyn_no_regions){
struct Cyc_Absyn_Exp*rgn=_tmp52C;
Cyc_Toc_exp_to_c(nv,rgn);
({void*_tmpA5E=({struct Cyc_Absyn_Exp*_tmpA5D=rgn;struct Cyc_Absyn_Exp*_tmpA5C=Cyc_Absyn_sizeoftype_exp(t_c,0U);Cyc_Toc_rcalloc_exp(_tmpA5D,_tmpA5C,_tmp52A);})->r;e->r=_tmpA5E;});}else{
# 3185
({void*_tmpA61=({void*_tmpA60=*_tmp52B;struct Cyc_Absyn_Exp*_tmpA5F=Cyc_Absyn_sizeoftype_exp(t_c,0U);Cyc_Toc_calloc_exp(_tmpA60,_tmpA5F,_tmp52A);})->r;e->r=_tmpA61;});}}else{
# 3188
if(_tmp52C != 0  && !Cyc_Absyn_no_regions){
struct Cyc_Absyn_Exp*rgn=_tmp52C;
Cyc_Toc_exp_to_c(nv,rgn);
if(_tmp528)
({void*_tmpA62=(Cyc_Toc_rmalloc_inline_exp(rgn,_tmp52A))->r;e->r=_tmpA62;});else{
# 3194
({void*_tmpA63=(Cyc_Toc_rmalloc_exp(rgn,_tmp52A))->r;e->r=_tmpA63;});}}else{
# 3196
({void*_tmpA64=(Cyc_Toc_malloc_exp(*_tmp52B,_tmp52A))->r;e->r=_tmpA64;});}}}
# 3200
...
({void*_tmp4C7=0U;({struct _dyneither_ptr _tmpA65=({const char*_tmp4C8="Swap_e: is_pointer_or_boxed: not a pointer or boxed type";_tag_dyneither(_tmp4C8,sizeof(char),57U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpA65,_tag_dyneither(_tmp4C7,sizeof(void*),0U));});});{
# 3217
...
# 3223
struct Cyc_Absyn_Exp*_tmp4CE=({struct Cyc_Absyn_Exp*_tmpA67=Cyc_Tcutil_deep_copy_exp(1,_tmp52F);struct Cyc_Absyn_Exp*_tmpA66=_tmp4CD;Cyc_Absyn_assign_exp(_tmpA67,_tmpA66,_tmp4C9);});_tmp4CE->topt=e1_old_typ;{
struct Cyc_Absyn_Stmt*_tmp4CF=Cyc_Absyn_exp_stmt(_tmp4CE,_tmp4C9);
struct Cyc_Absyn_Exp*_tmp4D0=({struct Cyc_Absyn_Exp*_tmpA69=Cyc_Tcutil_deep_copy_exp(1,_tmp52E);struct Cyc_Absyn_Exp*_tmpA68=_tmp4CB;Cyc_Absyn_assign_exp(_tmpA69,_tmpA68,_tmp4C9);});_tmp4D0->topt=e2_old_typ;{
struct Cyc_Absyn_Stmt*_tmp4D1=Cyc_Absyn_exp_stmt(_tmp4D0,_tmp4C9);
# 3228
struct Cyc_Absyn_Stmt*_tmp4D2=({struct _tuple1*_tmpA71=_tmp4CA;void*_tmpA70=e1_old_typ;struct Cyc_Absyn_Exp*_tmpA6F=_tmp52F;struct Cyc_Absyn_Stmt*_tmpA6E=({
struct _tuple1*_tmpA6D=_tmp4CC;void*_tmpA6C=e2_old_typ;struct Cyc_Absyn_Exp*_tmpA6B=_tmp52E;struct Cyc_Absyn_Stmt*_tmpA6A=
Cyc_Absyn_seq_stmt(_tmp4CF,_tmp4D1,_tmp4C9);
# 3229
Cyc_Absyn_declare_stmt(_tmpA6D,_tmpA6C,_tmpA6B,_tmpA6A,_tmp4C9);});
# 3228
Cyc_Absyn_declare_stmt(_tmpA71,_tmpA70,_tmpA6F,_tmpA6E,_tmp4C9);});
# 3231
Cyc_Toc_stmt_to_c(nv,_tmp4D2);
({void*_tmpA72=Cyc_Toc_stmt_exp_r(_tmp4D2);e->r=_tmpA72;});
...
({void*_tmpA73=(Cyc_Absyn_eq_exp(_tmp4D7,_tmp4D5,0U))->r;e->r=_tmpA73;});
goto _LL12B;}}else{goto _LL12E;}}else{goto _LL12E;}}else{_LL12E: _LL12F:
({void*_tmp4D8=0U;({struct _dyneither_ptr _tmpA74=({const char*_tmp4D9="non-aggregate type in tagcheck";_tag_dyneither(_tmp4D9,sizeof(char),31U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpA74,_tag_dyneither(_tmp4D8,sizeof(void*),0U));});});}_LL12B:;}
# 3247
...
({void*_tmp4DB=0U;({struct _dyneither_ptr _tmpA75=({const char*_tmp4DC="UnresolvedMem";_tag_dyneither(_tmp4DC,sizeof(char),14U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpA75,_tag_dyneither(_tmp4DB,sizeof(void*),0U));});});case 25U: _LL53: _LL54:
({void*_tmp4DD=0U;({struct _dyneither_ptr _tmpA76=({const char*_tmp4DE="compoundlit";_tag_dyneither(_tmp4DE,sizeof(char),12U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(_tmpA76,_tag_dyneither(_tmp4DD,sizeof(void*),0U));});});case 39U: _LL55: _LL56:
({void*_tmp4DF=0U;({struct _dyneither_ptr _tmpA77=({const char*_tmp4E0="valueof(-)";_tag_dyneither(_tmp4E0,sizeof(char),11U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpA77,_tag_dyneither(_tmp4DF,sizeof(void*),0U));});});default: _LL57: _LL58:
({void*_tmp4E1=0U;({struct _dyneither_ptr _tmpA78=({const char*_tmp4E2="__asm__";_tag_dyneither(_tmp4E2,sizeof(char),8U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpA78,_tag_dyneither(_tmp4E1,sizeof(void*),0U));});});}_LL0:;};}struct _tuple36{int f1;struct _dyneither_ptr*f2;struct _dyneither_ptr*f3;struct Cyc_Absyn_Switch_clause*f4;};
# 3280 "toc.cyc"
static struct _tuple36*Cyc_Toc_gen_labels(struct _RegionHandle*r,struct Cyc_Absyn_Switch_clause*sc){
# 3282
return({struct _tuple36*_tmp533=_region_malloc(r,sizeof(*_tmp533));_tmp533->f1=0,({struct _dyneither_ptr*_tmpA7A=Cyc_Toc_fresh_label();_tmp533->f2=_tmpA7A;}),({struct _dyneither_ptr*_tmpA79=Cyc_Toc_fresh_label();_tmp533->f3=_tmpA79;}),_tmp533->f4=sc;_tmp533;});}
# 3287
...
# 3298
 ...
 goto _LL0;default: _LL7: _LL8:
({struct Cyc_Absyn_Exp*_tmpA7C=({void*_tmpA7B=Cyc_Toc_typ_to_c_array(t);Cyc_Toc_cast_it(_tmpA7B,v);});v=_tmpA7C;});goto _LL0;}_LL0:;}{
# 3304
...
# 3317
 ps=ps->tl;
({struct Cyc_Absyn_Exp*_tmpA7F=({void*_tmpA7E=({void*_tmpA7D=Cyc_Absyn_strctq(Cyc_Toc_collapse_qvars(_tmp53D->name,_tmp53E->name));Cyc_Absyn_cstar_type(_tmpA7D,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpA7E,v);});v=_tmpA7F;});
({struct Cyc_Absyn_Exp*_tmpA81=({struct Cyc_Absyn_Exp*_tmpA80=v;Cyc_Absyn_aggrarrow_exp(_tmpA80,Cyc_Absyn_fieldname((int)(_tmp53C + 1)),0U);});v=_tmpA81;});
continue;}else{_LL17: _LL18:
# 3322
 goto _LL14;}_LL14:;}
# 3325
({struct Cyc_Absyn_Exp*_tmpA82=Cyc_Absyn_deref_exp(v,0U);v=_tmpA82;});
goto _LL9;case 2U: _LLE: _tmp53F=((struct Cyc_Tcpat_TupleField_Tcpat_Access_struct*)_tmp539)->f1;_LLF:
({struct Cyc_Absyn_Exp*_tmpA84=({struct Cyc_Absyn_Exp*_tmpA83=v;Cyc_Toc_member_exp(_tmpA83,Cyc_Absyn_fieldname((int)(_tmp53F + 1)),0U);});v=_tmpA84;});goto _LL9;case 4U: _LL10: _tmp541=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp539)->f1;_tmp540=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp539)->f2;_LL11:
# 3329
({struct Cyc_Absyn_Exp*_tmpA85=Cyc_Toc_member_exp(v,_tmp540,0U);v=_tmpA85;});
if(_tmp541)
({struct Cyc_Absyn_Exp*_tmpA86=Cyc_Toc_member_exp(v,Cyc_Toc_val_sp,0U);v=_tmpA86;});
...
# 3334
({struct Cyc_Absyn_Exp*_tmpA88=({struct Cyc_Absyn_Exp*_tmpA87=v;Cyc_Toc_member_exp(_tmpA87,Cyc_Absyn_fieldname((int)(_tmp542 + 1)),0U);});v=_tmpA88;});
goto _LL9;}_LL9:;};}
# 3338
return v;}
# 3343
...
# 3347
 ...
 return({struct Cyc_Absyn_Exp*_tmpA89=v;Cyc_Absyn_eq_exp(_tmpA89,Cyc_Absyn_signed_int_exp(0,0U),0U);});case 2U: _LL5: _LL6:
 return({struct Cyc_Absyn_Exp*_tmpA8A=v;Cyc_Absyn_neq_exp(_tmpA8A,Cyc_Absyn_signed_int_exp(0,0U),0U);});case 3U: _LL7: _tmp552=((struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*)_tmp545)->f1;_tmp551=((struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*)_tmp545)->f2;_LL8:
# 3351
 return({struct Cyc_Absyn_Exp*_tmpA8B=v;Cyc_Absyn_eq_exp(_tmpA8B,Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmp546=_cycalloc(sizeof(*_tmp546));_tmp546->tag=32U,_tmp546->f1=_tmp552,_tmp546->f2=_tmp551;_tmp546;}),0U),0U);});case 4U: _LL9: _tmp554=(void*)((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp545)->f1;_tmp553=((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp545)->f2;_LLA:
# 3353
 return({struct Cyc_Absyn_Exp*_tmpA8C=v;Cyc_Absyn_eq_exp(_tmpA8C,Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmp547=_cycalloc(sizeof(*_tmp547));_tmp547->tag=33U,_tmp547->f1=_tmp554,_tmp547->f2=_tmp553;_tmp547;}),0U),0U);});case 5U: _LLB: _tmp556=((struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*)_tmp545)->f1;_tmp555=((struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*)_tmp545)->f2;_LLC:
 return({struct Cyc_Absyn_Exp*_tmpA8D=v;Cyc_Absyn_eq_exp(_tmpA8D,Cyc_Absyn_float_exp(_tmp556,_tmp555,0U),0U);});case 6U: _LLD: _tmp557=((struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*)_tmp545)->f1;_LLE:
 return({struct Cyc_Absyn_Exp*_tmpA8E=v;Cyc_Absyn_eq_exp(_tmpA8E,Cyc_Absyn_signed_int_exp((int)_tmp557,0U),0U);});case 7U: _LLF: _tmp55A=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp545)->f1;_tmp559=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp545)->f2;_tmp558=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp545)->f3;_LL10:
# 3359
 LOOP1: {
void*_tmp548=v->r;void*_tmp549=_tmp548;struct Cyc_Absyn_Exp*_tmp54B;struct Cyc_Absyn_Exp*_tmp54A;switch(*((int*)_tmp549)){case 14U: _LL16: _tmp54A=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp549)->f2;_LL17:
 ...
 goto _LL15;}_LL15:;}
# 3366
({struct Cyc_Absyn_Exp*_tmpA91=({void*_tmpA90=({void*_tmpA8F=Cyc_Absyn_strctq(Cyc_Toc_collapse_qvars(_tmp558->name,_tmp559->name));Cyc_Absyn_cstar_type(_tmpA8F,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpA90,v);});v=_tmpA91;});
return({struct Cyc_Absyn_Exp*_tmpA92=Cyc_Absyn_aggrarrow_exp(v,Cyc_Toc_tag_sp,0U);Cyc_Absyn_eq_exp(_tmpA92,Cyc_Absyn_uint_exp((unsigned int)_tmp55A,0U),0U);});case 8U: _LL11: _tmp55C=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp545)->f1;_tmp55B=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp545)->f2;_LL12:
# 3371
({struct Cyc_Absyn_Exp*_tmpA94=({struct Cyc_Absyn_Exp*_tmpA93=Cyc_Toc_member_exp(v,_tmp55C,0U);Cyc_Toc_member_exp(_tmpA93,Cyc_Toc_tag_sp,0U);});v=_tmpA94;});
return({struct Cyc_Absyn_Exp*_tmpA95=v;Cyc_Absyn_eq_exp(_tmpA95,Cyc_Absyn_signed_int_exp(_tmp55B,0U),0U);});default: _LL13: _tmp55E=((struct Cyc_Tcpat_EqExtensibleDatatype_Tcpat_PatTest_struct*)_tmp545)->f1;_tmp55D=((struct Cyc_Tcpat_EqExtensibleDatatype_Tcpat_PatTest_struct*)_tmp545)->f2;_LL14:
# 3375
 LOOP2: {
void*_tmp54C=v->r;void*_tmp54D=_tmp54C;struct Cyc_Absyn_Exp*_tmp54F;struct Cyc_Absyn_Exp*_tmp54E;switch(*((int*)_tmp54D)){case 14U: _LL1D: _tmp54E=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp54D)->f2;_LL1E:
 ...
 goto _LL1C;}_LL1C:;}
# 3382
({struct Cyc_Absyn_Exp*_tmpA98=({void*_tmpA97=({void*_tmpA96=Cyc_Absyn_strctq(Cyc_Toc_collapse_qvars(_tmp55D->name,_tmp55E->name));Cyc_Absyn_cstar_type(_tmpA96,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpA97,v);});v=_tmpA98;});
return({struct Cyc_Absyn_Exp*_tmpA99=Cyc_Absyn_aggrarrow_exp(v,Cyc_Toc_tag_sp,0U);Cyc_Absyn_eq_exp(_tmpA99,Cyc_Absyn_var_exp(_tmp55D->name,0U),0U);});}_LL0:;}struct Cyc_Toc_OtherTest_Toc_TestKind_struct{int tag;};struct Cyc_Toc_DatatypeTagTest_Toc_TestKind_struct{int tag;};struct Cyc_Toc_WhereTest_Toc_TestKind_struct{int tag;struct Cyc_Absyn_Exp*f1;};struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct{int tag;struct _dyneither_ptr*f1;};
# 3396
...
({void*_tmpA9A=(void*)({struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct*_tmp562=_cycalloc(sizeof(*_tmp562));_tmp562->tag=3U,_tmp562->f1=_tmp564;_tmp562;});k=_tmpA9A;});
...
# 3425
({void*_tmpA9B=(void*)({struct Cyc_Toc_WhereTest_Toc_TestKind_struct*_tmp563=_cycalloc(sizeof(*_tmp563));_tmp563->tag=2U,_tmp563->f1=_tmp565;_tmp563;});k=_tmpA9B;});
return({struct _tuple37 _tmp7AC;_tmp7AC.f1=0,_tmp7AC.f2=k;_tmp7AC;});}else{_LL10: _LL11:
 goto _LL13;}case 1U: _LL12: _LL13:
 goto _LL15;case 2U: _LL14: _LL15:
 goto _LL17;case 5U: _LL16: _LL17:
 goto _LL19;default: _LL18: _LL19:
 return({struct _tuple37 _tmp7AD;_tmp7AD.f1=0,_tmp7AD.f2=k;_tmp7AD;});}_LL3:;};}
# 3434
return({struct _tuple37 _tmp7AE;_tmp7AE.f1=c,_tmp7AE.f2=k;_tmp7AE;});}
# 3439
...
# 3443
({struct Cyc_Absyn_Exp*_tmpA9C=Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmp568=_cycalloc(sizeof(*_tmp568));_tmp568->tag=32U,_tmp568->f1=_tmp56D,_tmp568->f2=_tmp56C;_tmp568;}),0U);e=_tmpA9C;});goto _LL0;case 4U: _LL3: _tmp56F=(void*)((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp567)->f1;_tmp56E=((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp567)->f2;_LL4:
# 3445
({struct Cyc_Absyn_Exp*_tmpA9D=Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmp569=_cycalloc(sizeof(*_tmp569));_tmp569->tag=33U,_tmp569->f1=_tmp56F,_tmp569->f2=_tmp56E;_tmp569;}),0U);e=_tmpA9D;});goto _LL0;case 6U: _LL5: _tmp570=((struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*)_tmp567)->f1;_LL6:
...
# 3449
({struct Cyc_Absyn_Exp*_tmpA9E=Cyc_Absyn_uint_exp((unsigned int)_tmp572,0U);e=_tmpA9E;});
goto _LL0;default: _LLB: _LLC:
({void*_tmp56A=0U;({struct _dyneither_ptr _tmpA9F=({const char*_tmp56B="compile_pat_test_as_case!";_tag_dyneither(_tmp56B,sizeof(char),26U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpA9F,_tag_dyneither(_tmp56A,sizeof(void*),0U));});});}_LL0:;}
# 3453
...
# 3477
({struct Cyc_List_List*_tmpAA0=({struct Cyc_List_List*_tmp577=_region_malloc(rgn,sizeof(*_tmp577));_tmp577->hd=_tmp59B,_tmp577->tl=*decls;_tmp577;});*decls=_tmpAA0;});{
struct Cyc_Absyn_Stmt*_tmp578=({struct Cyc_Absyn_Exp*_tmpAA1=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp579=_cycalloc(sizeof(*_tmp579));_tmp579->tag=4U,_tmp579->f1=_tmp59B;_tmp579;}),0U);Cyc_Absyn_assign_stmt(_tmpAA1,Cyc_Absyn_copy_exp(path),0U);});
return({struct Cyc_Absyn_Stmt*_tmpAA2=_tmp578;Cyc_Toc_seq_stmt_opt(_tmpAA2,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,path,_tmp59A));});};case 4U: _LL5: _tmp59C=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp575)->f2;_LL6:
# 3482
({struct Cyc_List_List*_tmpAA3=({struct Cyc_List_List*_tmp57A=_region_malloc(rgn,sizeof(*_tmp57A));_tmp57A->hd=_tmp59C,_tmp57A->tl=*decls;_tmp57A;});*decls=_tmpAA3;});
return({struct Cyc_Absyn_Exp*_tmpAA4=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp57B=_cycalloc(sizeof(*_tmp57B));_tmp57B->tag=4U,_tmp57B->f1=_tmp59C;_tmp57B;}),0U);Cyc_Absyn_assign_stmt(_tmpAA4,Cyc_Absyn_copy_exp(path),0U);});case 0U: _LL7: _LL8:
...
# 3487
({struct Cyc_List_List*_tmpAA5=({struct Cyc_List_List*_tmp57C=_region_malloc(rgn,sizeof(*_tmp57C));_tmp57C->hd=_tmp59E,_tmp57C->tl=*decls;_tmp57C;});*decls=_tmpAA5;});
({void*_tmpAA6=Cyc_Absyn_cstar_type(t,Cyc_Toc_mt_tq);_tmp59E->type=_tmpAA6;});{
# 3490
struct Cyc_Absyn_Stmt*_tmp57D=({struct Cyc_Absyn_Exp*_tmpAA9=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp57E=_cycalloc(sizeof(*_tmp57E));_tmp57E->tag=4U,_tmp57E->f1=_tmp59E;_tmp57E;}),0U);Cyc_Absyn_assign_stmt(_tmpAA9,({
void*_tmpAA8=({void*_tmpAA7=Cyc_Toc_typ_to_c_array(t);Cyc_Absyn_cstar_type(_tmpAA7,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpAA8,
Cyc_Toc_push_address_exp(Cyc_Absyn_copy_exp(path)));}),0U);});
return({struct Cyc_Absyn_Stmt*_tmpAAA=_tmp57D;Cyc_Toc_seq_stmt_opt(_tmpAAA,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,path,_tmp59D));});};case 9U: _LLB: _LLC:
# 3495
...
void*_tmp57F=({void*_tmpAAB=Cyc_Absyn_strctq(tufstrct);Cyc_Absyn_cstar_type(_tmpAAB,Cyc_Toc_mt_tq);});
({struct Cyc_Absyn_Exp*_tmpAAC=Cyc_Toc_cast_it(_tmp57F,path);path=_tmpAAC;});{
int cnt=1;
...
struct Cyc_Absyn_Exp*_tmp585=({struct Cyc_Absyn_Exp*_tmpAAD=path;Cyc_Absyn_aggrarrow_exp(_tmpAAD,Cyc_Absyn_fieldname(cnt),0U);});
if(Cyc_Toc_is_void_star_or_boxed_tvar(Cyc_Toc_typ_to_c(_tmp582)))
({struct Cyc_Absyn_Exp*_tmpAAE=Cyc_Toc_cast_it(_tmp584,_tmp585);_tmp585=_tmpAAE;});
({struct Cyc_Absyn_Stmt*_tmpAB0=({struct Cyc_Absyn_Stmt*_tmpAAF=s;Cyc_Toc_seq_stmt_opt(_tmpAAF,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,_tmp585,_tmp581));});s=_tmpAB0;});};}
# 3522
return s;};};}else{_LL21: _tmp5A2=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp575)->f1;_LL22:
# 3567
 return({struct _RegionHandle*_tmpAB4=rgn;struct Cyc_Toc_Env**_tmpAB3=nv;struct Cyc_List_List**_tmpAB2=decls;struct Cyc_Absyn_Exp*_tmpAB1=Cyc_Absyn_deref_exp(path,0U);Cyc_Toc_extract_pattern_vars(_tmpAB4,_tmpAB3,_tmpAB2,_tmpAB1,_tmp5A2);});}case 8U: _LL19: _tmp5A3=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp575)->f3;_LL1A:
# 3524
...
({struct Cyc_Absyn_Stmt*_tmpABA=({struct Cyc_Absyn_Stmt*_tmpAB9=s;Cyc_Toc_seq_stmt_opt(_tmpAB9,({struct _RegionHandle*_tmpAB8=rgn;struct Cyc_Toc_Env**_tmpAB7=nv;struct Cyc_List_List**_tmpAB6=decls;struct Cyc_Absyn_Exp*_tmpAB5=Cyc_Toc_member_exp(path,_tmp588,0U);Cyc_Toc_extract_pattern_vars(_tmpAB8,_tmpAB7,_tmpAB6,_tmpAB5,_tmp586);}));});s=_tmpABA;});};}
# 3536
return s;}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp575)->f1 == 0){_LL1D: _LL1E:
({void*_tmp589=0U;({struct _dyneither_ptr _tmpABB=({const char*_tmp58A="unresolved aggregate pattern!";_tag_dyneither(_tmp58A,sizeof(char),30U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpABB,_tag_dyneither(_tmp589,sizeof(void*),0U));});});}else{_LL1F: _tmp5A6=*((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp575)->f1;_tmp5A5=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp575)->f3;_LL20: {
# 3540
...
# 3552
if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp58B->impl))->tagged)({struct Cyc_Absyn_Exp*_tmpABC=Cyc_Toc_member_exp(_tmp591,Cyc_Toc_val_sp,0U);_tmp591=_tmpABC;});{
...
({struct Cyc_Absyn_Exp*_tmpABD=Cyc_Toc_cast_it(_tmp590,_tmp591);_tmp591=_tmpABD;});else{
if(!Cyc_Tcutil_is_array_type(_tmp592) && Cyc_Tcutil_kind_leq(& Cyc_Tcutil_ak,Cyc_Tcutil_type_kind(_tmp592)))
# 3559
({struct Cyc_Absyn_Exp*_tmpABF=Cyc_Absyn_deref_exp(({void*_tmpABE=Cyc_Absyn_cstar_type(_tmp590,Cyc_Toc_mt_tq);Cyc_Toc_cast_it(_tmpABE,
Cyc_Absyn_address_exp(_tmp591,0U));}),0U);
# 3559
_tmp591=_tmpABF;});}
# 3562
({struct Cyc_Absyn_Stmt*_tmpAC1=({struct Cyc_Absyn_Stmt*_tmpAC0=s;Cyc_Toc_seq_stmt_opt(_tmpAC0,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,_tmp591,_tmp58D));});s=_tmpAC1;});};};}
# 3564
return s;}}case 15U: _LL23: _LL24:
# 3569
({void*_tmp593=0U;({struct _dyneither_ptr _tmpAC2=({const char*_tmp594="unknownid pat";_tag_dyneither(_tmp594,sizeof(char),14U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpAC2,_tag_dyneither(_tmp593,sizeof(void*),0U));});});case 16U: _LL25: _LL26:
({void*_tmp595=0U;({struct _dyneither_ptr _tmpAC3=({const char*_tmp596="unknowncall pat";_tag_dyneither(_tmp596,sizeof(char),16U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpAC3,_tag_dyneither(_tmp595,sizeof(void*),0U));});});default: _LL27: _LL28:
({void*_tmp597=0U;({struct _dyneither_ptr _tmpAC4=({const char*_tmp598="exp pat";_tag_dyneither(_tmp598,sizeof(char),8U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpAC4,_tag_dyneither(_tmp597,sizeof(void*),0U));});});}_LL0:;}struct _tuple39{struct Cyc_Toc_Env*f1;struct _dyneither_ptr*f2;struct Cyc_Absyn_Stmt*f3;};
# 3580
...
*_tmp5B0=1;{
# 3604
struct Cyc_Absyn_Stmt*init_opt=({struct _RegionHandle*_tmpAC7=rgn;struct Cyc_List_List**_tmpAC6=decls;struct Cyc_Absyn_Exp*_tmpAC5=Cyc_Absyn_var_exp(v,0U);Cyc_Toc_extract_pattern_vars(_tmpAC7,& nv,_tmpAC6,_tmpAC5,_tmp5AD->pattern);});
# 3607
struct Cyc_Absyn_Stmt*res=Cyc_Absyn_label_stmt(_tmp5AE,_tmp5AD->body,0U);
if(init_opt != 0)
({struct Cyc_Absyn_Stmt*_tmpAC8=Cyc_Absyn_seq_stmt(init_opt,res,0U);res=_tmpAC8;});
({struct Cyc_Absyn_Stmt*_tmpAC9=Cyc_Absyn_label_stmt(_tmp5AF,res,0U);res=_tmpAC9;});
({struct Cyc_List_List*_tmpACB=({struct Cyc_List_List*_tmp5AC=_region_malloc(rgn,sizeof(*_tmp5AC));({struct _tuple39*_tmpACA=({struct _tuple39*_tmp5AB=_region_malloc(rgn,sizeof(*_tmp5AB));_tmp5AB->f1=nv,_tmp5AB->f2=_tmp5AE,_tmp5AB->f3=_tmp5AA;_tmp5AB;});_tmp5AC->hd=_tmpACA;}),_tmp5AC->tl=*bodies;_tmp5AC;});*bodies=_tmpACB;});
return res;};}};}
# 3615
({void*_tmp5B1=0U;({struct _dyneither_ptr _tmpACC=({const char*_tmp5B2="couldn't find rhs!";_tag_dyneither(_tmp5B2,sizeof(char),19U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpACC,_tag_dyneither(_tmp5B1,sizeof(void*),0U));});});default: _LL7: _tmp5E5=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp5A7)->f1;_tmp5E4=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp5A7)->f2;_tmp5E3=(void*)((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp5A7)->f3;_LL8: {
# 3618
struct Cyc_Absyn_Stmt*res=Cyc_Toc_compile_decision_tree(rgn,nv,decls,bodies,_tmp5E3,lscs,v);
# 3620
struct Cyc_Absyn_Exp*_tmp5B3=({struct Cyc_List_List*_tmpACD=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(_tmp5E5);Cyc_Toc_compile_path(_tmpACD,Cyc_Absyn_var_exp(v,0U));});
...
({struct Cyc_Absyn_Switch_clause*_tmpACF=({struct Cyc_Absyn_Switch_clause*_tmp5C6=_cycalloc(sizeof(*_tmp5C6));({struct Cyc_Absyn_Pat*_tmpACE=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0U);_tmp5C6->pattern=_tmpACE;}),_tmp5C6->pat_vars=0,_tmp5C6->where_clause=0,_tmp5C6->body=res,_tmp5C6->loc=0U;_tmp5C6;});_tmp5C7->hd=_tmpACF;}),_tmp5C7->tl=0;_tmp5C7;});
# 3630
...
# 3637
({struct Cyc_List_List*_tmpAD1=({struct Cyc_List_List*_tmp5BC=_cycalloc(sizeof(*_tmp5BC));({struct Cyc_Absyn_Switch_clause*_tmpAD0=({struct Cyc_Absyn_Switch_clause*_tmp5BB=_cycalloc(sizeof(*_tmp5BB));_tmp5BB->pattern=_tmp5B9,_tmp5BB->pat_vars=0,_tmp5BB->where_clause=0,_tmp5BB->body=_tmp5BA,_tmp5BB->loc=0U;_tmp5BB;});_tmp5BC->hd=_tmpAD0;}),_tmp5BC->tl=new_lscs;_tmp5BC;});new_lscs=_tmpAD1;});};}
# 3639
...
void*_tmp5C0=_tmp5B3->r;void*_tmp5C1=_tmp5C0;struct Cyc_Absyn_Exp*_tmp5C3;struct Cyc_Absyn_Exp*_tmp5C2;switch(*((int*)_tmp5C1)){case 14U: _LL1C: _tmp5C2=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp5C1)->f2;_LL1D:
 ...
 goto _LL1B;}_LL1B:;}
# 3648
({struct Cyc_Absyn_Exp*_tmpAD3=Cyc_Absyn_deref_exp(({void*_tmpAD2=Cyc_Absyn_cstar_type(Cyc_Absyn_sint_type,Cyc_Toc_mt_tq);Cyc_Toc_cast_it(_tmpAD2,_tmp5B3);}),0U);_tmp5B3=_tmpAD3;});goto _LL12;case 3U: _LL15: _tmp5C4=((struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct*)_tmp5BF)->f1;_LL16:
# 3651
({struct Cyc_Absyn_Exp*_tmpAD5=({struct Cyc_Absyn_Exp*_tmpAD4=Cyc_Toc_member_exp(_tmp5B3,_tmp5C4,0U);Cyc_Toc_member_exp(_tmpAD4,Cyc_Toc_tag_sp,0U);});_tmp5B3=_tmpAD5;});goto _LL12;case 2U: _LL17: _LL18:
# 3653
 goto _LL12;default: _LL19: _LL1A:
 goto _LL12;}_LL12:;}
# 3656
({struct Cyc_Absyn_Stmt*_tmpAD6=Cyc_Absyn_new_stmt((void*)({struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*_tmp5C5=_cycalloc(sizeof(*_tmp5C5));_tmp5C5->tag=10U,_tmp5C5->f1=_tmp5B3,_tmp5C5->f2=new_lscs,_tmp5C5->f3=0;_tmp5C5;}),0U);res=_tmpAD6;});}else{
# 3660
...
*_tmp5D2=1;{
# 3677
struct Cyc_Absyn_Stmt*init_opt=({struct _RegionHandle*_tmpAD9=rgn;struct Cyc_List_List**_tmpAD8=decls;struct Cyc_Absyn_Exp*_tmpAD7=Cyc_Absyn_var_exp(v,0U);Cyc_Toc_extract_pattern_vars(_tmpAD9,& nv,_tmpAD8,_tmpAD7,_tmp5CF->pattern);});
# 3680
Cyc_Toc_exp_to_c(nv,_tmp5DF);{
# 3683
struct Cyc_Absyn_Stmt*r=Cyc_Absyn_label_stmt(_tmp5D0,_tmp5CF->body,0U);
({struct Cyc_Absyn_Stmt*_tmpADA=Cyc_Absyn_ifthenelse_stmt(_tmp5DF,r,res,0U);r=_tmpADA;});
if(init_opt != 0)
({struct Cyc_Absyn_Stmt*_tmpADB=Cyc_Absyn_seq_stmt(init_opt,r,0U);r=_tmpADB;});
({struct Cyc_Absyn_Stmt*_tmpADC=Cyc_Absyn_label_stmt(_tmp5D1,r,0U);r=_tmpADC;});
({struct Cyc_List_List*_tmpADE=({struct Cyc_List_List*_tmp5CE=_region_malloc(rgn,sizeof(*_tmp5CE));({struct _tuple39*_tmpADD=({struct _tuple39*_tmp5CD=_region_malloc(rgn,sizeof(*_tmp5CD));_tmp5CD->f1=nv,_tmp5CD->f2=_tmp5D0,_tmp5CD->f3=_tmp5CC;_tmp5CD;});_tmp5CE->hd=_tmpADD;}),_tmp5CE->tl=*bodies;_tmp5CE;});*bodies=_tmpADE;});
return r;};};}};}
# 3692
({void*_tmp5D3=0U;({struct _dyneither_ptr _tmpADF=({const char*_tmp5D4="couldn't find rhs!";_tag_dyneither(_tmp5D4,sizeof(char),19U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpADF,_tag_dyneither(_tmp5D3,sizeof(void*),0U));});});}else{goto _LL2A;}}else{goto _LL2A;}}else{_LL2A: _LL2B:
({void*_tmp5D5=0U;({struct _dyneither_ptr _tmpAE0=({const char*_tmp5D6="bad where clause in match compiler";_tag_dyneither(_tmp5D6,sizeof(char),35U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpAE0,_tag_dyneither(_tmp5D5,sizeof(void*),0U));});});}_LL27:;}}else{_LL25: _LL26:
# 3697
 for(0;_tmp5B4 != 0;_tmp5B4=_tmp5B4->tl){
...
({struct Cyc_Absyn_Stmt*_tmpAE1=Cyc_Absyn_ifthenelse_stmt(_tmp5DB,_tmp5DC,res,0U);res=_tmpAE1;});};}}_LL22:;}
# 3705
return res;}}}_LL0:;}
# 3715
...
# 3772
if(_tmp5F3 == 0)
({struct Cyc_Toc_Env*_tmpAE2=Cyc_Toc_last_switchclause_env(rgn,_tmp5F0,end_l);Cyc_Toc_stmt_to_c(_tmpAE2,s);});else{
# 3776
struct Cyc_List_List*vs=0;
if(_tmp5F4->pat_vars != 0){
({struct Cyc_List_List*_tmpAE3=((struct Cyc_List_List*(*)(struct Cyc_List_List*l))Cyc_Tcutil_filter_nulls)((((struct _tuple0(*)(struct Cyc_List_List*x))Cyc_List_split)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp5F4->pat_vars))->v)).f1);vs=_tmpAE3;});
({struct Cyc_List_List*_tmpAE4=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(vs);vs=_tmpAE4;});}
# 3781
({struct Cyc_Toc_Env*_tmpAE5=Cyc_Toc_non_last_switchclause_env(rgn,_tmp5F0,end_l,_tmp5F5,vs);Cyc_Toc_stmt_to_c(_tmpAE5,s);});}};}else{
# 3785
({struct Cyc_Toc_Env*_tmpAE6=Cyc_Toc_last_switchclause_env(rgn,_tmp5F0,end_l);Cyc_Toc_stmt_to_c(_tmpAE6,s);});}};};}}{
# 3789
struct Cyc_Absyn_Stmt*res=({struct Cyc_Absyn_Stmt*_tmpAE8=test_tree;Cyc_Absyn_seq_stmt(_tmpAE8,({struct _dyneither_ptr*_tmpAE7=end_l;Cyc_Absyn_label_stmt(_tmpAE7,Cyc_Toc_skip_stmt_dl(),0U);}),0U);});
# 3791
...
({struct _tuple1*_tmpAE9=Cyc_Toc_temp_var();_tmp5F8->name=_tmpAE9;});
({void*_tmpAEA=Cyc_Toc_typ_to_c_array(_tmp5F8->type);_tmp5F8->type=_tmpAEA;});
({struct Cyc_Absyn_Stmt*_tmpAEC=({struct Cyc_Absyn_Decl*_tmpAEB=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp5F9=_cycalloc(sizeof(*_tmp5F9));_tmp5F9->tag=0U,_tmp5F9->f1=_tmp5F8;_tmp5F9;}),0U);Cyc_Absyn_decl_stmt(_tmpAEB,res,0U);});res=_tmpAEC;});}
# 3798
({void*_tmpAF0=({struct _tuple1*_tmpAEF=v;void*_tmpAEE=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));struct Cyc_Absyn_Exp*_tmpAED=e;Cyc_Absyn_declare_stmt(_tmpAEF,_tmpAEE,_tmpAED,res,0U);})->r;whole_s->r=_tmpAF0;});
...
return Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmpAF2=Cyc_Toc__npop_handler_e;Cyc_Absyn_fncall_exp(_tmpAF2,({struct Cyc_List_List*_tmp5FA=_cycalloc(sizeof(*_tmp5FA));
({struct Cyc_Absyn_Exp*_tmpAF1=Cyc_Absyn_uint_exp((unsigned int)(n - 1),0U);_tmp5FA->hd=_tmpAF1;}),_tmp5FA->tl=0;_tmp5FA;}),0U);}),0U);}
# 3817
void Cyc_Toc_do_npop_before(int n,struct Cyc_Absyn_Stmt*s){
if(n > 0)
({void*_tmpAF4=({struct Cyc_Absyn_Stmt*_tmpAF3=Cyc_Toc_make_npop_handler(n);Cyc_Toc_seq_stmt_r(_tmpAF3,Cyc_Absyn_new_stmt(s->r,0U));});s->r=_tmpAF4;});}
# 3822
static void Cyc_Toc_stmt_to_c(struct Cyc_Toc_Env*nv,struct Cyc_Absyn_Stmt*s){
# 3824
while(1){
...
void*topt=0;
if(_tmp63C != 0){
({void*_tmpAF5=Cyc_Toc_typ_to_c((void*)_check_null(_tmp63C->topt));topt=_tmpAF5;});
...
({void*_tmpAFA=({struct _tuple1*_tmpAF9=_tmp5FE;void*_tmpAF8=topt;struct Cyc_Absyn_Exp*_tmpAF7=_tmp63C;Cyc_Absyn_declare_stmt(_tmpAF9,_tmpAF8,_tmpAF7,({
struct Cyc_Absyn_Stmt*_tmpAF6=Cyc_Toc_make_npop_handler(_tmp5FD);Cyc_Absyn_seq_stmt(_tmpAF6,_tmp5FF,0U);}),0U);})->r;
# 3847
s->r=_tmpAFA;});}else{
# 3851
...
({struct Cyc_Toc_Env*_tmpAFB=Cyc_Toc_loop_env(temp,nv);Cyc_Toc_stmt_to_c(_tmpAFB,_tmp640);});
# 3864
_npop_handler(0U);return;
# 3861
...
if(_tmp602 != 0)
({void*_tmpAFC=Cyc_Toc_goto_stmt_r(*_tmp602);s->r=_tmpAFC;});
# 3870
({int _tmpAFD=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpAFD,s);});
...
if(_tmp604 != 0)
({void*_tmpAFE=Cyc_Toc_goto_stmt_r(*_tmp604);s->r=_tmpAFE;});
goto _LL12;}case 8U: _LL11: _LL12:
# 3879
({int _tmpAFF=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpAFF,s);});
...
({struct Cyc_Toc_Env*_tmpB00=Cyc_Toc_loop_env(temp,nv);Cyc_Toc_stmt_to_c(_tmpB00,_tmp642);});
# 3887
_npop_handler(0U);return;
# 3884
...
if(_tmp610 == 0)
({void*_tmp607=0U;({struct _dyneither_ptr _tmpB01=({const char*_tmp608="fallthru in unexpected place";_tag_dyneither(_tmp608,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpB01,_tag_dyneither(_tmp607,sizeof(void*),0U));});});{
...
# 3898
({int _tmpB02=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpB02,s2);});{
...
({struct Cyc_Absyn_Stmt*_tmpB05=({struct Cyc_Absyn_Stmt*_tmpB04=({struct Cyc_Absyn_Exp*_tmpB03=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*_tmp60D=_cycalloc(sizeof(*_tmp60D));_tmp60D->tag=5U,_tmp60D->f1=(struct Cyc_Absyn_Vardecl*)_tmp60B->hd;_tmp60D;}),0U);Cyc_Absyn_assign_stmt(_tmpB03,(struct Cyc_Absyn_Exp*)_tmp60C->hd,0U);});Cyc_Absyn_seq_stmt(_tmpB04,s2,0U);});s2=_tmpB05;});}
# 3906
s->r=s2->r;
...
# 3922
({struct _tuple1*_tmpB06=Cyc_Toc_temp_var();_tmp616->name=_tmpB06;});
_tmp616->initializer=_tmp627;
({void*_tmpB07=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp615=_cycalloc(sizeof(*_tmp615));_tmp615->tag=0U,_tmp615->f1=_tmp616;_tmp615;});_tmp64C->r=_tmpB07;});
Cyc_Toc_local_decl_to_c(nv,_tmp616,_tmp64B);
goto _LL3A;}else{goto _LL3D;}}else{_LL3D: _LL3E:
# 3931
({void*_tmpB08=(Cyc_Toc_letdecl_to_c(nv,_tmp628,_tmp626,(void*)_check_null(_tmp627->topt),_tmp627,_tmp64B))->r;s->r=_tmpB08;});
goto _LL3A;}_LL3A:;}
# 3934
...
if(_tmp617 == 0)
({void*_tmp618=0U;({struct _dyneither_ptr _tmpB09=({const char*_tmp619="empty Letv_d";_tag_dyneither(_tmp619,sizeof(char),13U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB09,_tag_dyneither(_tmp618,sizeof(void*),0U));});});
({void*_tmpB0A=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp61A=_cycalloc(sizeof(*_tmp61A));_tmp61A->tag=0U,_tmp61A->f1=(struct Cyc_Absyn_Vardecl*)_tmp617->hd;_tmp61A;});_tmp64C->r=_tmpB0A;});
_tmp617=_tmp617->tl;
...
({void*_tmpB0C=({struct Cyc_Absyn_Decl*_tmpB0B=_tmp61B;Cyc_Absyn_decl_stmt(_tmpB0B,Cyc_Absyn_new_stmt(s->r,0U),0U);})->r;s->r=_tmpB0C;});}
# 3947
...
({void*_tmpB10=({struct _tuple1*_tmpB0F=x_var;void*_tmpB0E=rh_struct_ptr_typ;struct Cyc_Absyn_Exp*_tmpB0D=
Cyc_Absyn_uint_exp(0U,0U);
# 3965
Cyc_Absyn_declare_stmt(_tmpB0F,_tmpB0E,_tmpB0D,_tmp61D,0U);})->r;s->r=_tmpB10;});else{
# 3967
if((unsigned int)_tmp62B){
# 3969
Cyc_Toc_exp_to_c(nv,_tmp62B);{
struct Cyc_Absyn_Exp*arg=Cyc_Absyn_address_exp(({struct Cyc_Absyn_Exp*_tmpB12=_tmp62B;Cyc_Absyn_aggrarrow_exp(_tmpB12,({struct _dyneither_ptr*_tmp61F=_cycalloc(sizeof(*_tmp61F));({struct _dyneither_ptr _tmpB11=({const char*_tmp61E="h";_tag_dyneither(_tmp61E,sizeof(char),2U);});*_tmp61F=_tmpB11;});_tmp61F;}),0U);}),0U);
({void*_tmpB13=(Cyc_Absyn_declare_stmt(x_var,rh_struct_ptr_typ,arg,_tmp61D,0U))->r;s->r=_tmpB13;});};}else{
# 3979
({void*_tmpB20=({
struct _tuple1*_tmpB1F=rh_var;void*_tmpB1E=rh_struct_typ;struct Cyc_Absyn_Exp*_tmpB1D=({
struct Cyc_Absyn_Exp*_tmpB15=Cyc_Toc__new_region_e;Cyc_Absyn_fncall_exp(_tmpB15,({struct Cyc_List_List*_tmp620=_cycalloc(sizeof(*_tmp620));
({struct Cyc_Absyn_Exp*_tmpB14=Cyc_Absyn_string_exp(Cyc_Absynpp_qvar2string(x_var),0U);_tmp620->hd=_tmpB14;}),_tmp620->tl=0;_tmp620;}),0U);});
# 3980
Cyc_Absyn_declare_stmt(_tmpB1F,_tmpB1E,_tmpB1D,({
# 3984
struct _tuple1*_tmpB1C=x_var;void*_tmpB1B=rh_struct_ptr_typ;struct Cyc_Absyn_Exp*_tmpB1A=Cyc_Absyn_address_exp(rh_exp,0U);Cyc_Absyn_declare_stmt(_tmpB1C,_tmpB1B,_tmpB1A,({
struct Cyc_Absyn_Stmt*_tmpB19=Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmpB16=Cyc_Toc__push_region_e;Cyc_Absyn_fncall_exp(_tmpB16,({struct Cyc_Absyn_Exp*_tmp621[1U];_tmp621[0]=x_exp;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp621,sizeof(struct Cyc_Absyn_Exp*),1U));}),0U);}),0U);Cyc_Absyn_seq_stmt(_tmpB19,({
struct Cyc_Absyn_Stmt*_tmpB18=_tmp61D;Cyc_Absyn_seq_stmt(_tmpB18,
Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmpB17=Cyc_Toc__pop_region_e;Cyc_Absyn_fncall_exp(_tmpB17,({struct Cyc_Absyn_Exp*_tmp622[1U];_tmp622[0]=x_exp;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp622,sizeof(struct Cyc_Absyn_Exp*),1U));}),0U);}),0U),0U);}),0U);}),0U);}),0U);})->r;
# 3979
s->r=_tmpB20;});}}
# 3990
return;}default: _LL38: _LL39:
({void*_tmp623=0U;({struct _dyneither_ptr _tmpB21=({const char*_tmp624="bad nested declaration within function";_tag_dyneither(_tmp624,sizeof(char),39U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB21,_tag_dyneither(_tmp623,sizeof(void*),0U));});});}_LL2D:;}
# 3993
...
({struct Cyc_Toc_Env*_tmpB22=Cyc_Toc_loop_env(temp,nv);Cyc_Toc_stmt_to_c(_tmpB22,_tmp650);});
...
struct Cyc_Absyn_Stmt*_tmp630=({struct Cyc_Absyn_Stmt*_tmpB23=_tmp653;Cyc_Absyn_seq_stmt(_tmpB23,
...
struct Cyc_Absyn_Exp*_tmpB25=Cyc_Toc_setjmp_e;Cyc_Absyn_fncall_exp(_tmpB25,({struct Cyc_List_List*_tmp637=_cycalloc(sizeof(*_tmp637));
({struct Cyc_Absyn_Exp*_tmpB24=Cyc_Toc_member_exp(h_exp,Cyc_Toc_handler_sp,0U);_tmp637->hd=_tmpB24;}),_tmp637->tl=0;_tmp637;}),0U);});
# 4042
struct Cyc_Absyn_Stmt*_tmp633=
Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmpB27=Cyc_Toc__push_handler_e;Cyc_Absyn_fncall_exp(_tmpB27,({struct Cyc_List_List*_tmp636=_cycalloc(sizeof(*_tmp636));
({struct Cyc_Absyn_Exp*_tmpB26=Cyc_Absyn_address_exp(h_exp,0U);_tmp636->hd=_tmpB26;}),_tmp636->tl=0;_tmp636;}),0U);}),0U);
# 4046
...
({void*_tmpB36=({
struct _tuple1*_tmpB35=h_var;void*_tmpB34=h_typ;Cyc_Absyn_declare_stmt(_tmpB35,_tmpB34,0,({
struct Cyc_Absyn_Stmt*_tmpB33=_tmp633;Cyc_Absyn_seq_stmt(_tmpB33,({
struct _tuple1*_tmpB32=was_thrown_var;void*_tmpB31=was_thrown_typ;struct Cyc_Absyn_Exp*_tmpB30=_tmp634;Cyc_Absyn_declare_stmt(_tmpB32,_tmpB31,_tmpB30,({
struct Cyc_Absyn_Stmt*_tmpB2F=({struct Cyc_Absyn_Exp*_tmpB29=_tmp632;struct Cyc_Absyn_Stmt*_tmpB28=
Cyc_Absyn_assign_stmt(was_thrown_exp,_tmp635,0U);
# 4052
Cyc_Absyn_ifthenelse_stmt(_tmpB29,_tmpB28,
# 4054
Cyc_Toc_skip_stmt_dl(),0U);});
# 4052
Cyc_Absyn_seq_stmt(_tmpB2F,({
# 4055
struct Cyc_Absyn_Exp*_tmpB2E=Cyc_Absyn_prim1_exp(Cyc_Absyn_Not,was_thrown_exp,0U);struct Cyc_Absyn_Stmt*_tmpB2D=_tmp630;Cyc_Absyn_ifthenelse_stmt(_tmpB2E,_tmpB2D,({
# 4057
struct _tuple1*_tmpB2C=e_var;void*_tmpB2B=e_typ;struct Cyc_Absyn_Exp*_tmpB2A=
Cyc_Toc_cast_it(e_typ,Cyc_Toc__exn_thrown_e);
# 4057
Cyc_Absyn_declare_stmt(_tmpB2C,_tmpB2B,_tmpB2A,_tmp631,0U);}),0U);}),0U);}),0U);}),0U);}),0U);})->r;
# 4048
s->r=_tmpB36;});};};
# 4061
_npop_handler(0U);return;
...
f->requires_clause=0;
f->ensures_clause=0;
({void*_tmpB37=Cyc_Toc_typ_to_c(f->ret_type);f->ret_type=_tmpB37;});{
...
({void*_tmpB38=Cyc_Toc_typ_to_c((*((struct _tuple9*)_tmp656->hd)).f3);(*((struct _tuple9*)_tmp656->hd)).f3=_tmpB38;});}}
# 4086
if(cinclude){
Cyc_Toc_stmttypes_to_c(f->body);
_npop_handler(0U);return;}
# 4090
({struct Cyc_Hashtable_Table**_tmpB3A=({struct Cyc_Hashtable_Table**_tmp659=_cycalloc(sizeof(*_tmp659));({struct Cyc_Hashtable_Table*_tmpB39=((struct Cyc_Hashtable_Table*(*)(struct Cyc_Hashtable_Table*t,struct Cyc_Absyn_Fndecl*key))Cyc_Hashtable_lookup)(*((struct Cyc_Hashtable_Table**)_check_null(Cyc_Toc_gpop_tables)),f);*_tmp659=_tmpB39;});_tmp659;});Cyc_Toc_fn_pop_table=_tmpB3A;});
...
({struct Cyc_List_List*_tmpB3D=({struct Cyc_List_List*_tmpB3C=f->args;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmpB3C,({struct Cyc_List_List*_tmp65F=_cycalloc(sizeof(*_tmp65F));({struct _tuple9*_tmpB3B=({struct _tuple9*_tmp65E=_cycalloc(sizeof(*_tmp65E));_tmp65E->f1=_tmp664,_tmp65E->f2=_tmp663,_tmp65E->f3=_tmp65C;_tmp65E;});_tmp65F->hd=_tmpB3B;}),_tmp65F->tl=0;_tmp65F;}));});f->args=_tmpB3D;});
f->cyc_varargs=0;};}
# 4099
...
({void*_tmpB3E=Cyc_Toc_typ_to_c(((struct Cyc_Absyn_Vardecl*)_tmp665->hd)->type);((struct Cyc_Absyn_Vardecl*)_tmp665->hd)->type=_tmpB3E;});}}
# 4102
({struct Cyc_Toc_Env*_tmpB3F=Cyc_Toc_clear_toplevel(frgn,_tmp655);Cyc_Toc_stmt_to_c(_tmpB3F,f->body);});}
# 4079
;_pop_region(frgn);};}
# 4106
...
({struct _tuple19*_tmpB41=({struct _tuple19*_tmp66D=_region_malloc(d,sizeof(*_tmp66D));_tmp66D->f1=_tmp69C,({void*_tmpB40=Cyc_Absyn_strctq(_tmp669);_tmp66D->f2=_tmpB40;});_tmp66D;});v=_tmpB41;});else{
# 4137
({struct _tuple19*_tmpB43=({struct _tuple19*_tmp66E=_region_malloc(d,sizeof(*_tmp66E));_tmp66E->f1=_tmp69C,({void*_tmpB42=Cyc_Absyn_unionq_type(_tmp669);_tmp66E->f2=_tmpB42;});_tmp66E;});v=_tmpB43;});}
({struct Cyc_Dict_Dict _tmpB44=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple1*k,struct _tuple19*v))Cyc_Dict_insert)(*_tmp69A,_tmp669,v);*_tmp69A=_tmpB44;});};}else{
# 4140
...
if(_tmp673->impl == 0){
({struct Cyc_Dict_Dict _tmpB47=({struct Cyc_Dict_Dict _tmpB46=*_tmp69A;struct _tuple1*_tmpB45=_tmp669;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple1*k,struct _tuple19*v))Cyc_Dict_insert)(_tmpB46,_tmpB45,({struct _tuple19*_tmp671=_region_malloc(d,sizeof(*_tmp671));_tmp671->f1=_tmp69C,_tmp671->f2=_tmp672;_tmp671;}));});*_tmp69A=_tmpB47;});
...
({struct Cyc_Absyn_AggrdeclImpl*_tmpB48=({struct Cyc_Absyn_AggrdeclImpl*_tmp674=_cycalloc(sizeof(*_tmp674));_tmp674->exist_vars=0,_tmp674->rgn_po=0,_tmp674->fields=0,_tmp674->tagged=0;_tmp674;});new_ad->impl=_tmpB48;});{
# 4159
struct Cyc_List_List*new_fields=0;
...
# 4180
({void*_tmpB4A=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp67B=_cycalloc(sizeof(*_tmp67B));_tmp67B->tag=4U,(_tmp67B->f1).elt_type=_tmp682,(_tmp67B->f1).tq=_tmp681,({struct Cyc_Absyn_Exp*_tmpB49=Cyc_Absyn_uint_exp(0U,0U);(_tmp67B->f1).num_elts=_tmpB49;}),(_tmp67B->f1).zero_term=_tmp680,(_tmp67B->f1).zt_loc=_tmp67F;_tmp67B;});_tmp677=_tmpB4A;});
goto _LL9;}else{_LLC: _LLD:
# 4183
({struct Cyc_List_List*_tmpB4C=({struct Cyc_List_List*_tmp67D=_cycalloc(sizeof(*_tmp67D));({void*_tmpB4B=(void*)({struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_tmp67C=_cycalloc(sizeof(*_tmp67C));_tmp67C->tag=6U,_tmp67C->f1=0;_tmp67C;});_tmp67D->hd=_tmpB4B;}),_tmp67D->tl=_tmp678;_tmp67D;});_tmp678=_tmpB4C;});
({void*_tmpB50=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp67E=_cycalloc(sizeof(*_tmp67E));_tmp67E->tag=4U,({void*_tmpB4F=Cyc_Absyn_void_star_type();(_tmp67E->f1).elt_type=_tmpB4F;}),({
struct Cyc_Absyn_Tqual _tmpB4E=Cyc_Absyn_empty_tqual(0U);(_tmp67E->f1).tq=_tmpB4E;}),({
struct Cyc_Absyn_Exp*_tmpB4D=Cyc_Absyn_uint_exp(0U,0U);(_tmp67E->f1).num_elts=_tmpB4D;}),(_tmp67E->f1).zero_term=Cyc_Absyn_false_type,(_tmp67E->f1).zt_loc=0U;_tmp67E;});
# 4184
_tmp677=_tmpB50;});}_LL9:;}{
# 4190
...
# 4192
void*_tmpB51=Cyc_Toc_typ_to_c(_tmp677);_tmp695->type=_tmpB51;}),_tmp695->width=_tmp676->width,_tmp695->attributes=_tmp678,_tmp695->requires_clause=0;_tmp695;});
# 4200
...
struct _dyneither_ptr s=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp692=({struct Cyc_String_pa_PrintArg_struct _tmp7B0;_tmp7B0.tag=0U,_tmp7B0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp69C->name).f2);_tmp7B0;});struct Cyc_String_pa_PrintArg_struct _tmp693=({struct Cyc_String_pa_PrintArg_struct _tmp7AF;_tmp7AF.tag=0U,_tmp7AF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp685);_tmp7AF;});void*_tmp690[2U];_tmp690[0]=& _tmp692,_tmp690[1]=& _tmp693;({struct _dyneither_ptr _tmpB52=({const char*_tmp691="_union_%s_%s";_tag_dyneither(_tmp691,sizeof(char),13U);});Cyc_aprintf(_tmpB52,_tag_dyneither(_tmp690,sizeof(void*),2U));});});
...
({struct Cyc_List_List*_tmpB54=({struct Cyc_List_List*_tmp68B=_cycalloc(sizeof(*_tmp68B));({struct Cyc_Absyn_Decl*_tmpB53=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp68A=_cycalloc(sizeof(*_tmp68A));_tmp68A->tag=5U,_tmp68A->f1=_tmp689;_tmp68A;}),0U);_tmp68B->hd=_tmpB53;}),_tmp68B->tl=Cyc_Toc_result_decls;_tmp68B;});Cyc_Toc_result_decls=_tmpB54;});
({void*_tmpB55=Cyc_Absyn_strct(str);_tmp683->type=_tmpB55;});}
# 4212
({struct Cyc_List_List*_tmpB56=({struct Cyc_List_List*_tmp694=_cycalloc(sizeof(*_tmp694));_tmp694->hd=_tmp683,_tmp694->tl=new_fields;_tmp694;});new_fields=_tmpB56;});};}}
# 4214
({struct Cyc_List_List*_tmpB57=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(new_fields);(new_ad->impl)->fields=_tmpB57;});};}
# 4216
if(_tmp69B)
({struct Cyc_List_List*_tmpB5A=({struct Cyc_List_List*_tmp698=_cycalloc(sizeof(*_tmp698));({struct Cyc_Absyn_Decl*_tmpB59=({struct Cyc_Absyn_Decl*_tmp697=_cycalloc(sizeof(*_tmp697));({void*_tmpB58=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp696=_cycalloc(sizeof(*_tmp696));_tmp696->tag=5U,_tmp696->f1=new_ad;_tmp696;});_tmp697->r=_tmpB58;}),_tmp697->loc=0U;_tmp697;});_tmp698->hd=_tmpB59;}),_tmp698->tl=Cyc_Toc_result_decls;_tmp698;});Cyc_Toc_result_decls=_tmpB5A;});
return 0;};};};}
# 4221
static void Cyc_Toc_aggrdecl_to_c(struct Cyc_Absyn_Aggrdecl*ad,int add_to_decls){
struct _tuple40 p=({struct _tuple40 _tmp7B1;_tmp7B1.f1=ad,_tmp7B1.f2=add_to_decls;_tmp7B1;});
...
return 0;
({struct Cyc_Set_Set*_tmpB5B=((struct Cyc_Set_Set*(*)(struct _RegionHandle*r,struct Cyc_Set_Set*s,struct _tuple1*elt))Cyc_Set_rinsert)(d,*_tmp6B0,_tmp6A0);*_tmp6B0=_tmpB5B;});
...
void*_tmpB5C=Cyc_Toc_typ_to_c((*((struct _tuple12*)_tmp6A3->hd)).f2);_tmp6A7->type=_tmpB5C;}),_tmp6A7->width=0,_tmp6A7->attributes=0,_tmp6A7->requires_clause=0;_tmp6A7;});
({struct Cyc_List_List*_tmpB5D=({struct Cyc_List_List*_tmp6A6=_cycalloc(sizeof(*_tmp6A6));_tmp6A6->hd=_tmp6A5,_tmp6A6->tl=_tmp6A2;_tmp6A6;});_tmp6A2=_tmpB5D;});}}
# 4269
({struct Cyc_List_List*_tmpB60=({struct Cyc_List_List*_tmp6A9=_cycalloc(sizeof(*_tmp6A9));({struct Cyc_Absyn_Aggrfield*_tmpB5F=({struct Cyc_Absyn_Aggrfield*_tmp6A8=_cycalloc(sizeof(*_tmp6A8));_tmp6A8->name=Cyc_Toc_tag_sp,_tmp6A8->tq=Cyc_Toc_mt_tq,_tmp6A8->type=Cyc_Absyn_sint_type,_tmp6A8->width=0,_tmp6A8->attributes=0,_tmp6A8->requires_clause=0;_tmp6A8;});_tmp6A9->hd=_tmpB5F;}),({
struct Cyc_List_List*_tmpB5E=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp6A2);_tmp6A9->tl=_tmpB5E;});_tmp6A9;});
# 4269
_tmp6A2=_tmpB60;});{
# 4271
struct Cyc_Absyn_Aggrdecl*_tmp6AA=({struct _dyneither_ptr*_tmpB62=({struct _dyneither_ptr*_tmp6AE=_cycalloc(sizeof(*_tmp6AE));({struct _dyneither_ptr _tmpB61=({const char*_tmp6AD="";_tag_dyneither(_tmp6AD,sizeof(char),1U);});*_tmp6AE=_tmpB61;});_tmp6AE;});Cyc_Toc_make_c_struct_defn(_tmpB62,_tmp6A2);});
({struct _tuple1*_tmpB63=Cyc_Toc_collapse_qvars(f->name,_tmp6AF->name);_tmp6AA->name=_tmpB63;});
({struct Cyc_List_List*_tmpB65=({struct Cyc_List_List*_tmp6AC=_cycalloc(sizeof(*_tmp6AC));({struct Cyc_Absyn_Decl*_tmpB64=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp6AB=_cycalloc(sizeof(*_tmp6AB));_tmp6AB->tag=5U,_tmp6AB->f1=_tmp6AA;_tmp6AB;}),0U);_tmp6AC->hd=_tmpB64;}),_tmp6AC->tl=Cyc_Toc_result_decls;_tmp6AC;});Cyc_Toc_result_decls=_tmpB65;});};}}
# 4275
return 0;};}
# 4278
static void Cyc_Toc_datatypedecl_to_c(struct Cyc_Absyn_Datatypedecl*tud){
...
({struct Cyc_Absyn_Exp*_tmpB66=Cyc_Absyn_string_exp(*fn,0U);initopt=_tmpB66;});{
# 4317
struct Cyc_Absyn_Vardecl*_tmp6BB=Cyc_Absyn_new_vardecl(0U,f->name,_tmp6B8,initopt);
_tmp6BB->sc=f->sc;
({struct Cyc_List_List*_tmpB68=({struct Cyc_List_List*_tmp6BD=_cycalloc(sizeof(*_tmp6BD));({struct Cyc_Absyn_Decl*_tmpB67=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp6BC=_cycalloc(sizeof(*_tmp6BC));_tmp6BC->tag=0U,_tmp6BC->f1=_tmp6BB;_tmp6BC;}),0U);_tmp6BD->hd=_tmpB67;}),_tmp6BD->tl=Cyc_Toc_result_decls;_tmp6BD;});Cyc_Toc_result_decls=_tmpB68;});
({struct Cyc_Dict_Dict _tmpB69=
...
struct _dyneither_ptr*_tmp6BF=({struct _dyneither_ptr*_tmp6C6=_cycalloc(sizeof(*_tmp6C6));({struct _dyneither_ptr _tmpB6B=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp6C5=({struct Cyc_Int_pa_PrintArg_struct _tmp7B2;_tmp7B2.tag=1U,_tmp7B2.f1=(unsigned long)i;_tmp7B2;});void*_tmp6C3[1U];_tmp6C3[0]=& _tmp6C5;({struct _dyneither_ptr _tmpB6A=({const char*_tmp6C4="f%d";_tag_dyneither(_tmp6C4,sizeof(char),4U);});Cyc_aprintf(_tmpB6A,_tag_dyneither(_tmp6C3,sizeof(void*),1U));});});*_tmp6C6=_tmpB6B;});_tmp6C6;});
...
void*_tmpB6C=Cyc_Toc_typ_to_c((*((struct _tuple12*)_tmp6BE->hd)).f2);_tmp6C2->type=_tmpB6C;}),_tmp6C2->width=0,_tmp6C2->attributes=0,_tmp6C2->requires_clause=0;_tmp6C2;});
({struct Cyc_List_List*_tmpB6D=({struct Cyc_List_List*_tmp6C1=_cycalloc(sizeof(*_tmp6C1));_tmp6C1->hd=_tmp6C0,_tmp6C1->tl=fields;_tmp6C1;});fields=_tmpB6D;});}}
# 4330
({struct Cyc_List_List*_tmpB71=({struct Cyc_List_List*_tmp6C8=_cycalloc(sizeof(*_tmp6C8));({struct Cyc_Absyn_Aggrfield*_tmpB70=({struct Cyc_Absyn_Aggrfield*_tmp6C7=_cycalloc(sizeof(*_tmp6C7));_tmp6C7->name=Cyc_Toc_tag_sp,_tmp6C7->tq=Cyc_Toc_mt_tq,({
void*_tmpB6F=Cyc_Absyn_cstar_type(Cyc_Absyn_char_type,Cyc_Toc_mt_tq);_tmp6C7->type=_tmpB6F;}),_tmp6C7->width=0,_tmp6C7->attributes=0,_tmp6C7->requires_clause=0;_tmp6C7;});
# 4330
_tmp6C8->hd=_tmpB70;}),({
# 4332
struct Cyc_List_List*_tmpB6E=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(fields);_tmp6C8->tl=_tmpB6E;});_tmp6C8;});
# 4330
fields=_tmpB71;});{
# 4333
struct Cyc_Absyn_Aggrdecl*_tmp6C9=({struct _dyneither_ptr*_tmpB73=({struct _dyneither_ptr*_tmp6CD=_cycalloc(sizeof(*_tmp6CD));({struct _dyneither_ptr _tmpB72=({const char*_tmp6CC="";_tag_dyneither(_tmp6CC,sizeof(char),1U);});*_tmp6CD=_tmpB72;});_tmp6CD;});Cyc_Toc_make_c_struct_defn(_tmpB73,fields);});
({struct _tuple1*_tmpB74=Cyc_Toc_collapse_qvars(f->name,_tmp6D3->name);_tmp6C9->name=_tmpB74;});
({struct Cyc_List_List*_tmpB76=({struct Cyc_List_List*_tmp6CB=_cycalloc(sizeof(*_tmp6CB));({struct Cyc_Absyn_Decl*_tmpB75=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp6CA=_cycalloc(sizeof(*_tmp6CA));_tmp6CA->tag=5U,_tmp6CA->f1=_tmp6C9;_tmp6CA;}),0U);_tmp6CB->hd=_tmpB75;}),_tmp6CB->tl=Cyc_Toc_result_decls;_tmp6CB;});Cyc_Toc_result_decls=_tmpB76;});
...
_tmp6CF->sc=f->sc;
({struct Cyc_List_List*_tmpB78=({struct Cyc_List_List*_tmp6D1=_cycalloc(sizeof(*_tmp6D1));({struct Cyc_Absyn_Decl*_tmpB77=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp6D0=_cycalloc(sizeof(*_tmp6D0));_tmp6D0->tag=0U,_tmp6D0->f1=_tmp6CF;_tmp6D0;}),0U);_tmp6D1->hd=_tmpB77;}),_tmp6D1->tl=Cyc_Toc_result_decls;_tmp6D1;});Cyc_Toc_result_decls=_tmpB78;});
({struct Cyc_Dict_Dict _tmpB79=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple1*k,int v))Cyc_Dict_insert)(*_tmp6D2,f->name,1);*_tmp6D2=_tmpB79;});}
# 4345
...
({void*_tmpB7A=Cyc_Toc_typ_to_c(old_typ);vd->type=_tmpB7A;});
# 4366
...
if(_tmp6DE == 0)
({void*_tmp6D9=0U;({struct _dyneither_ptr _tmpB7B=({const char*_tmp6DA="can't initialize zero-terminated array -- size unknown";_tag_dyneither(_tmp6DA,sizeof(char),55U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpB7B,_tag_dyneither(_tmp6D9,sizeof(void*),0U));});});{
struct Cyc_Absyn_Exp*num_elts=_tmp6DE;
struct Cyc_Absyn_Exp*_tmp6DB=({struct Cyc_Absyn_Exp*_tmpB7D=Cyc_Absyn_var_exp(vd->name,0U);Cyc_Absyn_subscript_exp(_tmpB7D,({
struct Cyc_Absyn_Exp*_tmpB7C=num_elts;Cyc_Absyn_add_exp(_tmpB7C,Cyc_Absyn_signed_int_exp(- 1,0U),0U);}),0U);});
# 4392
struct Cyc_Absyn_Exp*_tmp6DC=Cyc_Absyn_signed_int_exp(0,0U);
({void*_tmpB7F=({struct Cyc_Absyn_Stmt*_tmpB7E=Cyc_Absyn_exp_stmt(Cyc_Absyn_assign_exp(_tmp6DB,_tmp6DC,0U),0U);Cyc_Toc_seq_stmt_r(_tmpB7E,
...
# 4409
({void*_tmpB80=Cyc_Toc_rewrite_decision(*_tmp6E5,success);*_tmp6E5=_tmpB80;});
...
({void*_tmpB81=Cyc_Toc_rewrite_decision(*_tmp6E3,success);*_tmp6E3=_tmpB81;});}
# 4414
return d;}_LL0:;}
# 4425 "toc.cyc"
...
if(dopt != 0)
# 4441
({void*_tmpB82=Cyc_Toc_rewrite_decision(dopt,_tmp6EB);dopt=_tmpB82;});{
# 4443
...
struct Cyc_List_List*_tmp6ED=({struct _RegionHandle*_tmpB85=rgn;struct _RegionHandle*_tmpB84=rgn;((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple36*(*f)(struct _RegionHandle*,struct Cyc_Absyn_Switch_clause*),struct _RegionHandle*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(_tmpB85,Cyc_Toc_gen_labels,_tmpB84,({struct Cyc_Absyn_Switch_clause*_tmp6F7[1U];_tmp6F7[0]=_tmp6EC;({struct _RegionHandle*_tmpB83=rgn;((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(_tmpB83,_tag_dyneither(_tmp6F7,sizeof(struct Cyc_Absyn_Switch_clause*),1U));});}));});
# 4446
struct Cyc_List_List*mydecls=0;
struct Cyc_List_List*mybodies=0;
# 4450
...
# 4458
({void*_tmp6F2=0U;({struct _dyneither_ptr _tmpB86=({const char*_tmp6F3="letdecl_to_c: couldn't find env!";_tag_dyneither(_tmp6F3,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpB86,_tag_dyneither(_tmp6F2,sizeof(void*),0U));});});
FOUND_ENV:
# 4462
...
({struct _tuple1*_tmpB87=Cyc_Toc_temp_var();_tmp6F4->name=_tmpB87;});
({void*_tmpB88=Cyc_Toc_typ_to_c_array(_tmp6F4->type);_tmp6F4->type=_tmpB88;});
({struct Cyc_Absyn_Stmt*_tmpB8A=({struct Cyc_Absyn_Decl*_tmpB89=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp6F5=_cycalloc(sizeof(*_tmp6F5));_tmp6F5->tag=0U,_tmp6F5->f1=_tmp6F4;_tmp6F5;}),0U);Cyc_Absyn_decl_stmt(_tmpB89,res,0U);});res=_tmpB8A;});}
# 4473
({struct Cyc_Absyn_Stmt*_tmpB8E=({struct _tuple1*_tmpB8D=v;void*_tmpB8C=Cyc_Toc_typ_to_c(_tmp6EA);struct Cyc_Absyn_Exp*_tmpB8B=e;Cyc_Absyn_declare_stmt(_tmpB8D,_tmpB8C,_tmpB8B,res,0U);});res=_tmpB8E;});{
...
({void*_tmpB8F=Cyc_Toc_typ_to_c(*_tmp71D);*_tmp71D=_tmpB8F;});Cyc_Toc_exptypes_to_c(_tmp71C);goto _LL0;case 25U: _LL27: _tmp71F=(void**)&(((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp6FA)->f1)->f3;_tmp71E=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp6FA)->f2;_LL28:
# 4505
({void*_tmpB90=Cyc_Toc_typ_to_c(*_tmp71F);*_tmp71F=_tmpB90;});
...
({void*_tmpB91=Cyc_Toc_typ_to_c(*_tmp723);*_tmp723=_tmpB91;});goto _LL0;case 37U: _LL31: _tmp724=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp6FA)->f1;_LL32:
...
({void**_tmpB93=({void**_tmp6FE=_cycalloc(sizeof(*_tmp6FE));({void*_tmpB92=Cyc_Toc_typ_to_c(*((void**)_check_null(_tmp725->elt_type)));*_tmp6FE=_tmpB92;});_tmp6FE;});_tmp725->elt_type=_tmpB93;});
...
({void*_tmp6FF=0U;({unsigned int _tmpB95=e->loc;struct _dyneither_ptr _tmpB94=({const char*_tmp700="Cyclone expression within C code";_tag_dyneither(_tmp700,sizeof(char),33U);});Cyc_Tcutil_terr(_tmpB95,_tmpB94,_tag_dyneither(_tmp6FF,sizeof(void*),0U));});});goto _LL0;}_LL0:;}
# 4542
...
# 4545
({void*_tmpB96=Cyc_Toc_typ_to_c(_tmp72D->type);_tmp72D->type=_tmpB96;});
...
# 4549
({void*_tmpB97=Cyc_Toc_typ_to_c(_tmp72E->ret_type);_tmp72E->ret_type=_tmpB97;});
{struct Cyc_List_List*_tmp728=_tmp72E->args;for(0;_tmp728 != 0;_tmp728=_tmp728->tl){
({void*_tmpB98=Cyc_Toc_typ_to_c((*((struct _tuple9*)_tmp728->hd)).f3);(*((struct _tuple9*)_tmp728->hd)).f3=_tmpB98;});}}
# 4553
...
({void*_tmpB99=Cyc_Toc_typ_to_c((void*)_check_null(_tmp731->defn));_tmp731->defn=_tmpB99;});goto _LL0;case 2U: _LLB: _LLC:
...
# 4571
({void*_tmp72B=0U;({unsigned int _tmpB9B=d->loc;struct _dyneither_ptr _tmpB9A=({const char*_tmp72C="Cyclone declaration within C code";_tag_dyneither(_tmp72C,sizeof(char),34U);});Cyc_Tcutil_terr(_tmpB9B,_tmpB9A,_tag_dyneither(_tmp72B,sizeof(void*),0U));});});
...
# 4605
({void*_tmpB9C=(void*)({struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*_tmp734=_cycalloc(sizeof(*_tmp734));_tmp734->tag=0U;_tmp734;});s->r=_tmpB9C;});
goto _LL0;default: _LL1F: _LL20:
# 4608
({void*_tmp735=0U;({unsigned int _tmpBA0=s->loc;struct _dyneither_ptr _tmpB9F=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp738=({struct Cyc_String_pa_PrintArg_struct _tmp7B3;_tmp7B3.tag=0U,({struct _dyneither_ptr _tmpB9D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_stmt2string(s));_tmp7B3.f1=_tmpB9D;});_tmp7B3;});void*_tmp736[1U];_tmp736[0]=& _tmp738;({struct _dyneither_ptr _tmpB9E=({const char*_tmp737="Cyclone statement in C code: %s";_tag_dyneither(_tmp737,sizeof(char),32U);});Cyc_aprintf(_tmpB9E,_tag_dyneither(_tmp736,sizeof(void*),1U));});});Cyc_Tcutil_terr(_tmpBA0,_tmpB9F,_tag_dyneither(_tmp735,sizeof(void*),0U));});});
goto _LL0;}_LL0:;}
# 4616
...
for(0;ds != 0;ds=ds->tl){
if(!Cyc_Toc_is_toplevel(nv))
({void*_tmp74E=0U;({struct _dyneither_ptr _tmpBA1=({const char*_tmp74F="decls_to_c: not at toplevel!";_tag_dyneither(_tmp74F,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpBA1,_tag_dyneither(_tmp74E,sizeof(void*),0U));});});
Cyc_Toc_fresh_label_counter=0;{
struct Cyc_Absyn_Decl*d=(struct Cyc_Absyn_Decl*)ds->hd;
void*_tmp750=d->r;void*_tmp751=_tmp750;struct Cyc_List_List*_tmp769;struct Cyc_List_List*_tmp768;struct Cyc_List_List*_tmp767;struct Cyc_List_List*_tmp766;struct Cyc_Absyn_Typedefdecl*_tmp765;struct Cyc_Absyn_Enumdecl*_tmp764;struct Cyc_Absyn_Datatypedecl*_tmp763;struct Cyc_Absyn_Aggrdecl*_tmp762;struct Cyc_Absyn_Fndecl*_tmp761;struct Cyc_Absyn_Vardecl*_tmp760;switch(*((int*)_tmp751)){case 0U: _LL1: _tmp760=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp751)->f1;_LL2: {
# 4624
struct _tuple1*_tmp752=_tmp760->name;
# 4626
if(_tmp760->sc == Cyc_Absyn_ExternC)
({struct _tuple1*_tmpBA3=({struct _tuple1*_tmp753=_cycalloc(sizeof(*_tmp753));({union Cyc_Absyn_Nmspace _tmpBA2=Cyc_Absyn_Abs_n(0,1);_tmp753->f1=_tmpBA2;}),_tmp753->f2=(*_tmp752).f2;_tmp753;});_tmp752=_tmpBA3;});
if(_tmp760->initializer != 0){
if(_tmp760->sc == Cyc_Absyn_ExternC)_tmp760->sc=Cyc_Absyn_Public;
if(cinclude)
Cyc_Toc_exptypes_to_c((struct Cyc_Absyn_Exp*)_check_null(_tmp760->initializer));else{
# 4633
Cyc_Toc_exp_to_c(nv,(struct Cyc_Absyn_Exp*)_check_null(_tmp760->initializer));}}
# 4635
_tmp760->name=_tmp752;
({enum Cyc_Absyn_Scope _tmpBA4=Cyc_Toc_scope_to_c(_tmp760->sc);_tmp760->sc=_tmpBA4;});
({void*_tmpBA5=Cyc_Toc_typ_to_c(_tmp760->type);_tmp760->type=_tmpBA5;});
({struct Cyc_List_List*_tmpBA6=({struct Cyc_List_List*_tmp754=_cycalloc(sizeof(*_tmp754));_tmp754->hd=d,_tmp754->tl=Cyc_Toc_result_decls;_tmp754;});Cyc_Toc_result_decls=_tmpBA6;});
goto _LL0;}case 1U: _LL3: _tmp761=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp751)->f1;_LL4: {
# 4641
struct _tuple1*_tmp755=_tmp761->name;
# 4643
if(_tmp761->sc == Cyc_Absyn_ExternC){
({struct _tuple1*_tmpBA8=({struct _tuple1*_tmp756=_cycalloc(sizeof(*_tmp756));({union Cyc_Absyn_Nmspace _tmpBA7=Cyc_Absyn_Abs_n(0,1);_tmp756->f1=_tmpBA7;}),_tmp756->f2=(*_tmp755).f2;_tmp756;});_tmp755=_tmpBA8;});
_tmp761->sc=Cyc_Absyn_Public;}
# 4647
_tmp761->name=_tmp755;
Cyc_Toc_fndecl_to_c(nv,_tmp761,cinclude);
({struct Cyc_List_List*_tmpBA9=({struct Cyc_List_List*_tmp757=_cycalloc(sizeof(*_tmp757));_tmp757->hd=d,_tmp757->tl=Cyc_Toc_result_decls;_tmp757;});Cyc_Toc_result_decls=_tmpBA9;});
goto _LL0;}case 2U: _LL5: _LL6:
 goto _LL8;case 3U: _LL7: _LL8:
({void*_tmp758=0U;({struct _dyneither_ptr _tmpBAA=({const char*_tmp759="letdecl at toplevel";_tag_dyneither(_tmp759,sizeof(char),20U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpBAA,_tag_dyneither(_tmp758,sizeof(void*),0U));});});case 4U: _LL9: _LLA:
({void*_tmp75A=0U;({struct _dyneither_ptr _tmpBAB=({const char*_tmp75B="region decl at toplevel";_tag_dyneither(_tmp75B,sizeof(char),24U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(_tmpBAB,_tag_dyneither(_tmp75A,sizeof(void*),0U));});});case 5U: _LLB: _tmp762=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp751)->f1;_LLC:
# 4655
 Cyc_Toc_aggrdecl_to_c(_tmp762,1);
goto _LL0;case 6U: _LLD: _tmp763=((struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp751)->f1;_LLE:
# 4658
 if(_tmp763->is_extensible)
Cyc_Toc_xdatatypedecl_to_c(_tmp763);else{
# 4661
Cyc_Toc_datatypedecl_to_c(_tmp763);}
goto _LL0;case 7U: _LLF: _tmp764=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp751)->f1;_LL10:
# 4664
 Cyc_Toc_enumdecl_to_c(_tmp764);
({struct Cyc_List_List*_tmpBAC=({struct Cyc_List_List*_tmp75C=_cycalloc(sizeof(*_tmp75C));_tmp75C->hd=d,_tmp75C->tl=Cyc_Toc_result_decls;_tmp75C;});Cyc_Toc_result_decls=_tmpBAC;});
goto _LL0;case 8U: _LL11: _tmp765=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp751)->f1;_LL12:
# 4668
 _tmp765->tvs=0;
if(_tmp765->defn != 0)
({void*_tmpBAD=Cyc_Toc_typ_to_c((void*)_check_null(_tmp765->defn));_tmp765->defn=_tmpBAD;});else{
# 4672
enum Cyc_Absyn_KindQual _tmp75D=((struct Cyc_Absyn_Kind*)((struct Cyc_Core_Opt*)_check_null(_tmp765->kind))->v)->kind;enum Cyc_Absyn_KindQual _tmp75E=_tmp75D;if(_tmp75E == Cyc_Absyn_BoxKind){_LL20: _LL21:
({void*_tmpBAE=Cyc_Absyn_void_star_type();_tmp765->defn=_tmpBAE;});goto _LL1F;}else{_LL22: _LL23:
 _tmp765->defn=Cyc_Absyn_void_type;goto _LL1F;}_LL1F:;}
# 4680
if(Cyc_noexpand_r)
({struct Cyc_List_List*_tmpBAF=({struct Cyc_List_List*_tmp75F=_cycalloc(sizeof(*_tmp75F));_tmp75F->hd=d,_tmp75F->tl=Cyc_Toc_result_decls;_tmp75F;});Cyc_Toc_result_decls=_tmpBAF;});
goto _LL0;case 13U: _LL13: _LL14:
 goto _LL16;case 14U: _LL15: _LL16:
 goto _LL0;case 9U: _LL17: _tmp766=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp751)->f2;_LL18:
 _tmp767=_tmp766;goto _LL1A;case 10U: _LL19: _tmp767=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp751)->f2;_LL1A:
 _tmp768=_tmp767;goto _LL1C;case 11U: _LL1B: _tmp768=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp751)->f1;_LL1C:
({struct Cyc_Toc_Env*_tmpBB0=Cyc_Toc_decls_to_c(r,nv,_tmp768,top,cinclude);nv=_tmpBB0;});goto _LL0;default: _LL1D: _tmp769=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp751)->f1;_LL1E:
({struct Cyc_Toc_Env*_tmpBB1=Cyc_Toc_decls_to_c(r,nv,_tmp769,top,1);nv=_tmpBB1;});goto _LL0;}_LL0:;};}
# 4691
return nv;}
# 4695
static void Cyc_Toc_init(){
struct Cyc_Core_NewDynamicRegion _tmp76A=Cyc_Core__new_rckey("internal-error","internal-error",0);struct Cyc_Core_NewDynamicRegion _tmp76B=_tmp76A;struct Cyc_Core_DynamicRegion*_tmp770;_LL1: _tmp770=_tmp76B.key;_LL2:;{
struct Cyc_Toc_TocState*ts;
{struct _RegionHandle*h=& _tmp770->h;
({struct Cyc_Toc_TocState*_tmpBB2=Cyc_Toc_empty_toc_state(h);ts=_tmpBB2;});;}
({struct Cyc_Toc_TocStateWrap*_tmpBB3=({struct Cyc_Toc_TocStateWrap*_tmp76D=_region_malloc(Cyc_Core_unique_region,sizeof(*_tmp76D));_tmp76D->dyn=_tmp770,_tmp76D->state=ts;_tmp76D;});Cyc_Toc_toc_state=_tmpBB3;});
...
({struct _dyneither_ptr _tmpBB4=_tag_dyneither(({unsigned int _tmp76F=35;struct _dyneither_ptr**_tmp76E=_cycalloc(_check_times(_tmp76F,sizeof(struct _dyneither_ptr*)));_tmp76E[0]=& Cyc_Toc__throw_str,_tmp76E[1]=& Cyc_Toc_setjmp_str,_tmp76E[2]=& Cyc_Toc__push_handler_str,_tmp76E[3]=& Cyc_Toc__pop_handler_str,_tmp76E[4]=& Cyc_Toc__exn_thrown_str,_tmp76E[5]=& Cyc_Toc__npop_handler_str,_tmp76E[6]=& Cyc_Toc__check_null_str,_tmp76E[7]=& Cyc_Toc__check_known_subscript_null_str,_tmp76E[8]=& Cyc_Toc__check_known_subscript_notnull_str,_tmp76E[9]=& Cyc_Toc__check_dyneither_subscript_str,_tmp76E[10]=& Cyc_Toc__dyneither_ptr_str,_tmp76E[11]=& Cyc_Toc__tag_dyneither_str,_tmp76E[12]=& Cyc_Toc__untag_dyneither_ptr_str,_tmp76E[13]=& Cyc_Toc__get_dyneither_size_str,_tmp76E[14]=& Cyc_Toc__get_zero_arr_size_str,_tmp76E[15]=& Cyc_Toc__dyneither_ptr_plus_str,_tmp76E[16]=& Cyc_Toc__zero_arr_plus_str,_tmp76E[17]=& Cyc_Toc__dyneither_ptr_inplace_plus_str,_tmp76E[18]=& Cyc_Toc__zero_arr_inplace_plus_str,_tmp76E[19]=& Cyc_Toc__dyneither_ptr_inplace_plus_post_str,_tmp76E[20]=& Cyc_Toc__zero_arr_inplace_plus_post_str,_tmp76E[21]=& Cyc_Toc__cycalloc_str,_tmp76E[22]=& Cyc_Toc__cyccalloc_str,_tmp76E[23]=& Cyc_Toc__cycalloc_atomic_str,_tmp76E[24]=& Cyc_Toc__cyccalloc_atomic_str,_tmp76E[25]=& Cyc_Toc__region_malloc_str,_tmp76E[26]=& Cyc_Toc__region_calloc_str,_tmp76E[27]=& Cyc_Toc__check_times_str,_tmp76E[28]=& Cyc_Toc__new_region_str,_tmp76E[29]=& Cyc_Toc__push_region_str,_tmp76E[30]=& Cyc_Toc__pop_region_str,_tmp76E[31]=& Cyc_Toc__throw_arraybounds_str,_tmp76E[32]=& Cyc_Toc__dyneither_ptr_decrease_size_str,_tmp76E[33]=& Cyc_Toc__throw_match_str,_tmp76E[34]=& Cyc_Toc__fast_region_malloc_str;_tmp76E;}),sizeof(struct _dyneither_ptr*),35U);Cyc_Toc_globals=_tmpBB4;});};}
# 4746
void Cyc_Toc_finish(){
struct Cyc_Toc_TocStateWrap*ts=0;
({struct Cyc_Toc_TocStateWrap*_tmp771=ts;struct Cyc_Toc_TocStateWrap*_tmp772=Cyc_Toc_toc_state;ts=_tmp772;Cyc_Toc_toc_state=_tmp771;});{
struct Cyc_Toc_TocStateWrap _tmp773=*((struct Cyc_Toc_TocStateWrap*)_check_null(ts));struct Cyc_Toc_TocStateWrap _tmp774=_tmp773;struct Cyc_Core_DynamicRegion*_tmp77A;struct Cyc_Toc_TocState*_tmp779;_LL1: _tmp77A=_tmp774.dyn;_tmp779=_tmp774.state;_LL2:;
# 4751
{struct _RegionHandle*h=& _tmp77A->h;
{struct Cyc_Toc_TocState _tmp776=*_tmp779;struct Cyc_Toc_TocState _tmp777=_tmp776;struct Cyc_Xarray_Xarray*_tmp778;_LL4: _tmp778=_tmp777.temp_labels;_LL5:;
((void(*)(struct Cyc_Xarray_Xarray*xarr))Cyc_Xarray_reuse)(_tmp778);}
# 4752
;}
# 4755
Cyc_Core_free_rckey(_tmp77A);
...
struct Cyc_List_List*Cyc_Toc_toc(struct Cyc_Hashtable_Table*pop_tables,struct Cyc_List_List*ds){
# 4766
({struct Cyc_Hashtable_Table**_tmpBB5=({struct Cyc_Hashtable_Table**_tmp77B=_cycalloc(sizeof(*_tmp77B));*_tmp77B=pop_tables;_tmp77B;});Cyc_Toc_gpop_tables=_tmpBB5;});
Cyc_Toc_init();
{struct _RegionHandle _tmp77C=_new_region("start");struct _RegionHandle*start=& _tmp77C;_push_region(start);
({struct _RegionHandle*_tmpBB7=start;struct Cyc_Toc_Env*_tmpBB6=Cyc_Toc_empty_env(start);Cyc_Toc_decls_to_c(_tmpBB7,_tmpBB6,ds,1,0);});;_pop_region(start);}
# 4775
