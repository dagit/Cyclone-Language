...
# 831
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp16D=_cycalloc(sizeof(*_tmp16D));_tmp16D->tag=5U,(_tmp16D->f1).tvars=0,(_tmp16D->f1).effect=0,(_tmp16D->f1).ret_tqual=tq2,({void*_tmp852=Cyc_Toc_typ_to_c(t2);(_tmp16D->f1).ret_type=_tmp852;}),(_tmp16D->f1).args=new_args,(_tmp16D->f1).c_varargs=c_vararg,(_tmp16D->f1).cyc_varargs=0,(_tmp16D->f1).rgn_po=0,(_tmp16D->f1).attributes=new_atts,(_tmp16D->f1).requires_clause=0,(_tmp16D->f1).requires_relns=0,(_tmp16D->f1).ensures_clause=0,(_tmp16D->f1).ensures_relns=0,(_tmp16D->f1).return_value=0;_tmp16D;});}}case 6U: _LL17: _tmp14A=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp13D)->f1;_LL18: {struct Cyc_List_List*tqs=_tmp14A;
# 836
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp274=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7B7;_tmp7B7.tag=0U,({struct _fat_ptr _tmp8A5=({const char*_tmp276="can't take & of exp ";_tag_fat(_tmp276,sizeof(char),21U);});_tmp7B7.f1=_tmp8A5;});_tmp7B7;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp275=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp7B6;_tmp7B6.tag=4U,_tmp7B6.f1=e;_tmp7B6;});void*_tmp273[2U];_tmp273[0]=& _tmp274,_tmp273[1]=& _tmp275;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp273,sizeof(void*),2U));});}_LL0:;}
# 1466
static void Cyc_Toc_push_address_stmt(struct Cyc_Absyn_Stmt*s){
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp27D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7B9;_tmp7B9.tag=0U,({struct _fat_ptr _tmp8A7=({const char*_tmp27F="can't take & of stmt ";_tag_fat(_tmp27F,sizeof(char),22U);});_tmp7B9.f1=_tmp8A7;});_tmp7B9;});struct Cyc_Warn_Stmt_Warn_Warg_struct _tmp27E=({struct Cyc_Warn_Stmt_Warn_Warg_struct _tmp7B8;_tmp7B8.tag=5U,_tmp7B8.f1=s;_tmp7B8;});void*_tmp27C[2U];_tmp27C[0]=& _tmp27D,_tmp27C[1]=& _tmp27E;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp27C,sizeof(void*),2U));});}_LL0:;}
# 1478
...
({void*_tmp8DA=(Cyc_Absyn_int_exp(Cyc_Absyn_Signed,1,0U))->r;e->r=_tmp8DA;});goto _LL7;case 41U: _LL12: _tmp347=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_LL13: {struct Cyc_Absyn_Exp*e1=_tmp347;
Cyc_Toc_exp_to_c(nv,e1);goto _LL7;}case 3U: _LL14: _tmp345=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp346=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL15: {enum Cyc_Absyn_Primop p=_tmp345;struct Cyc_List_List*es=_tmp346;
# 1728
...
{enum Cyc_Absyn_Primop _tmp34B=p;switch(_tmp34B){case Cyc_Absyn_Numelts: _LL63: _LL64: {
# 1733
struct Cyc_Absyn_Exp*arg=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd;
{void*_tmp34C=Cyc_Tcutil_compress((void*)_check_null(arg->topt));void*_stmttmp2E=_tmp34C;void*_tmp34D=_stmttmp2E;void*_tmp351;void*_tmp350;void*_tmp34F;void*_tmp34E;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp34D)->tag == 3U){_LL78: _tmp34E=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp34D)->f1).elt_type;_tmp34F=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp34D)->f1).ptr_atts).nullable;_tmp350=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp34D)->f1).ptr_atts).bounds;_tmp351=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp34D)->f1).ptr_atts).zero_term;_LL79: {void*elt_type=_tmp34E;void*nbl=_tmp34F;void*bound=_tmp350;void*zt=_tmp351;
# 1736
struct Cyc_Absyn_Exp*_tmp352=({void*_tmp8DB=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp8DB,bound);});struct Cyc_Absyn_Exp*eopt=_tmp352;
if(eopt == 0)
# 1739
({void*_tmp8DE=({struct Cyc_Absyn_Exp*_tmp353[2U];_tmp353[0]=(struct Cyc_Absyn_Exp*)es->hd,({
struct Cyc_Absyn_Exp*_tmp8DC=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp353[1]=_tmp8DC;});({struct Cyc_Absyn_Exp*_tmp8DD=Cyc_Toc__get_fat_size_e;Cyc_Toc_fncall_exp_r(_tmp8DD,_tag_fat(_tmp353,sizeof(struct Cyc_Absyn_Exp*),2U));});});
# 1739
e->r=_tmp8DE;});else{
# 1742
...
# 1748
({void*_tmp8E0=({struct Cyc_Absyn_Exp*_tmp355[2U];_tmp355[0]=(struct Cyc_Absyn_Exp*)es->hd,_tmp355[1]=e2;({struct Cyc_Absyn_Exp*_tmp8DF=function_e;Cyc_Toc_fncall_exp_r(_tmp8DF,_tag_fat(_tmp355,sizeof(struct Cyc_Absyn_Exp*),2U));});});e->r=_tmp8E0;});}else{
if(Cyc_Tcutil_force_type2bool(0,nbl)){
if(!Cyc_Evexp_c_can_eval(e2))
({void*_tmp356=0U;({unsigned _tmp8E2=e->loc;struct _fat_ptr _tmp8E1=({const char*_tmp357="can't calculate numelts";_tag_fat(_tmp357,sizeof(char),24U);});Cyc_Tcutil_terr(_tmp8E2,_tmp8E1,_tag_fat(_tmp356,sizeof(void*),0U));});});
# 1753
({void*_tmp8E5=({struct Cyc_Absyn_Exp*_tmp8E4=arg;struct Cyc_Absyn_Exp*_tmp8E3=e2;Cyc_Toc_conditional_exp_r(_tmp8E4,_tmp8E3,Cyc_Absyn_uint_exp(0U,0U));});e->r=_tmp8E5;});}else{
# 1755
e->r=e2->r;goto _LL77;}}}
# 1758
goto _LL77;}}else{_LL7A: _LL7B:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp359=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C4;_tmp7C4.tag=0U,({struct _fat_ptr _tmp8E6=({const char*_tmp35B="numelts primop applied to non-pointer ";_tag_fat(_tmp35B,sizeof(char),39U);});_tmp7C4.f1=_tmp8E6;});_tmp7C4;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp35A=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp7C3;_tmp7C3.tag=2U,_tmp7C3.f1=(void*)_check_null(arg->topt);_tmp7C3;});void*_tmp358[2U];_tmp358[0]=& _tmp359,_tmp358[1]=& _tmp35A;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp358,sizeof(void*),2U));});}_LL77:;}
# 1762
...
if(eopt == 0)
({void*_tmp8EA=({struct Cyc_Absyn_Exp*_tmp363[3U];_tmp363[0]=e1,({
struct Cyc_Absyn_Exp*_tmp8E8=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp363[1]=_tmp8E8;}),_tmp363[2]=e2;({struct Cyc_Absyn_Exp*_tmp8E9=Cyc_Toc__fat_ptr_plus_e;Cyc_Toc_fncall_exp_r(_tmp8E9,_tag_fat(_tmp363,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 1775
e->r=_tmp8EA;});else{
# 1777
if(Cyc_Tcutil_force_type2bool(0,zt))
({void*_tmp8EC=({struct Cyc_Absyn_Exp*_tmp364[3U];_tmp364[0]=e1,_tmp364[1]=eopt,_tmp364[2]=e2;({struct Cyc_Absyn_Exp*_tmp8EB=Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__zero_arr_plus_functionSet,e1);Cyc_Toc_fncall_exp_r(_tmp8EB,_tag_fat(_tmp364,sizeof(struct Cyc_Absyn_Exp*),3U));});});e->r=_tmp8EC;});}
...
({void*_tmp8EE=({struct Cyc_Absyn_Exp*_tmp8ED=Cyc_Absyn_new_exp(e1->r,0U);Cyc_Toc_aggrmember_exp_r(_tmp8ED,Cyc_Toc_curr_sp);});e1->r=_tmp8EE;});
({void*_tmp8F0=({struct Cyc_Absyn_Exp*_tmp8EF=Cyc_Absyn_new_exp(e2->r,0U);Cyc_Toc_aggrmember_exp_r(_tmp8EF,Cyc_Toc_curr_sp);});e2->r=_tmp8F0;});
({void*_tmp8F2=({void*_tmp8F1=Cyc_Absyn_cstar_type(Cyc_Absyn_uchar_type,Cyc_Toc_mt_tq);e2->topt=_tmp8F1;});e1->topt=_tmp8F2;});
({void*_tmp8F4=({struct Cyc_Absyn_Exp*_tmp8F3=Cyc_Absyn_copy_exp(e);Cyc_Absyn_divide_exp(_tmp8F3,
Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U),0U);})->r;
# 1795
e->r=_tmp8F4;});}else{
# 1798
({void*_tmp8F8=({struct Cyc_Absyn_Exp*_tmp365[3U];_tmp365[0]=e1,({
struct Cyc_Absyn_Exp*_tmp8F6=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp365[1]=_tmp8F6;}),({
struct Cyc_Absyn_Exp*_tmp8F5=Cyc_Absyn_prim1_exp(Cyc_Absyn_Minus,e2,0U);_tmp365[2]=_tmp8F5;});({struct Cyc_Absyn_Exp*_tmp8F7=Cyc_Toc__fat_ptr_plus_e;Cyc_Toc_fncall_exp_r(_tmp8F7,_tag_fat(_tmp365,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 1798
e->r=_tmp8F8;});}}
# 1802
...
void*_tmp366=({void*_tmp8F9=Cyc_Toc_typ_to_c(elt_type);Cyc_Absyn_cstar_type(_tmp8F9,Cyc_Toc_mt_tq);});void*t=_tmp366;
({void*_tmp8FC=({void*_tmp8FB=t;Cyc_Toc_cast_it_r(_tmp8FB,({struct Cyc_Absyn_Exp*_tmp8FA=Cyc_Absyn_new_exp(e1->r,0U);Cyc_Toc_member_exp(_tmp8FA,Cyc_Toc_curr_sp,0U);}));});e1->r=_tmp8FC;});
e1->topt=t;}
# 1815
if(Cyc_Tcutil_is_fat_pointer_type(t2)){
void*_tmp367=({void*_tmp8FD=Cyc_Toc_typ_to_c(elt_type);Cyc_Absyn_cstar_type(_tmp8FD,Cyc_Toc_mt_tq);});void*t=_tmp367;
({void*_tmp900=({void*_tmp8FF=t;Cyc_Toc_cast_it_r(_tmp8FF,({struct Cyc_Absyn_Exp*_tmp8FE=Cyc_Absyn_new_exp(e2->r,0U);Cyc_Toc_member_exp(_tmp8FE,Cyc_Toc_curr_sp,0U);}));});e2->r=_tmp900;});
e2->topt=t;}
# 1820
goto _LL62;}default: _LL75: _LL76:
 goto _LL62;}_LL62:;}
# 1823
goto _LL7;}case 5U: _LL16: _tmp343=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp344=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL17: {struct Cyc_Absyn_Exp*e2=_tmp343;enum Cyc_Absyn_Incrementor incr=_tmp344;
# 1825
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp36A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C8;_tmp7C8.tag=0U,({struct _fat_ptr _tmp901=({const char*_tmp370="in-place ";_tag_fat(_tmp370,sizeof(char),10U);});_tmp7C8.f1=_tmp901;});_tmp7C8;});struct Cyc_Warn_String_Warn_Warg_struct _tmp36B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C7;_tmp7C7.tag=0U,_tmp7C7.f1=incr_str;_tmp7C7;});struct Cyc_Warn_String_Warn_Warg_struct _tmp36C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C6;_tmp7C6.tag=0U,({struct _fat_ptr _tmp902=({const char*_tmp36F=" is not supported when ";_tag_fat(_tmp36F,sizeof(char),24U);});_tmp7C6.f1=_tmp902;});_tmp7C6;});struct Cyc_Warn_String_Warn_Warg_struct _tmp36D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C5;_tmp7C5.tag=0U,({
struct _fat_ptr _tmp903=({const char*_tmp36E="dereferencing a zero-terminated pointer";_tag_fat(_tmp36E,sizeof(char),40U);});_tmp7C5.f1=_tmp903;});_tmp7C5;});void*_tmp369[4U];_tmp369[0]=& _tmp36A,_tmp369[1]=& _tmp36B,_tmp369[2]=& _tmp36C,_tmp369[3]=& _tmp36D;({unsigned _tmp904=e->loc;((int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2)(_tmp904,_tag_fat(_tmp369,sizeof(void*),4U));});});
...
{enum Cyc_Absyn_Incrementor _tmp371=incr;switch(_tmp371){case Cyc_Absyn_PreInc: _LL82: _LL83:
 op=0U;goto _LL81;case Cyc_Absyn_PreDec: _LL84: _LL85:
 op=2U;goto _LL81;default: _LL86: _LL87:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp373=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7CB;_tmp7CB.tag=0U,({struct _fat_ptr _tmp905=({const char*_tmp377="in-place post";_tag_fat(_tmp377,sizeof(char),14U);});_tmp7CB.f1=_tmp905;});_tmp7CB;});struct Cyc_Warn_String_Warn_Warg_struct _tmp374=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7CA;_tmp7CA.tag=0U,_tmp7CA.f1=incr_str;_tmp7CA;});struct Cyc_Warn_String_Warn_Warg_struct _tmp375=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C9;_tmp7C9.tag=0U,({
struct _fat_ptr _tmp906=({const char*_tmp376=" is not supported on @tagged union members";_tag_fat(_tmp376,sizeof(char),43U);});_tmp7C9.f1=_tmp906;});_tmp7C9;});void*_tmp372[3U];_tmp372[0]=& _tmp373,_tmp372[1]=& _tmp374,_tmp372[2]=& _tmp375;({unsigned _tmp907=e->loc;((int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2)(_tmp907,_tag_fat(_tmp372,sizeof(void*),3U));});});}_LL81:;}
# 1852
({void*_tmp909=(void*)({struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmp379=_cycalloc(sizeof(*_tmp379));_tmp379->tag=4U,_tmp379->f1=e2,({struct Cyc_Core_Opt*_tmp908=({struct Cyc_Core_Opt*_tmp378=_cycalloc(sizeof(*_tmp378));_tmp378->v=(void*)op;_tmp378;});_tmp379->f2=_tmp908;}),_tmp379->f3=one;_tmp379;});e->r=_tmp909;});
...
change=-1;
({void*_tmp90E=({struct Cyc_Absyn_Exp*_tmp37A[3U];({struct Cyc_Absyn_Exp*_tmp90C=Cyc_Toc_push_address_exp(e2);_tmp37A[0]=_tmp90C;}),({
struct Cyc_Absyn_Exp*_tmp90B=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_typ),0U);_tmp37A[1]=_tmp90B;}),({
struct Cyc_Absyn_Exp*_tmp90A=Cyc_Absyn_signed_int_exp(change,0U);_tmp37A[2]=_tmp90A;});({struct Cyc_Absyn_Exp*_tmp90D=fn_e;Cyc_Toc_fncall_exp_r(_tmp90D,_tag_fat(_tmp37A,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 1869
e->r=_tmp90E;});}else{
# 1872
...
void*_tmp37C=({void*_tmp90F=Cyc_Toc_typ_to_c(old_typ);Cyc_Absyn_cstar_type(_tmp90F,Cyc_Toc_mt_tq);});void*t=_tmp37C;
struct Cyc_Absyn_Exp*_tmp37D=Cyc_Toc_push_address_exp(e2);struct Cyc_Absyn_Exp*xexp=_tmp37D;
struct Cyc_Absyn_Exp*_tmp37E=({struct Cyc_Absyn_Exp*_tmp910=Cyc_Absyn_deref_exp(Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(x,0U),0U),0U);Cyc_Absyn_neq_exp(_tmp910,
Cyc_Absyn_int_exp(Cyc_Absyn_None,0,0U),0U);});
# 1883
struct Cyc_Absyn_Exp*testexp=_tmp37E;
# 1885
if(Cyc_Toc_do_null_check(e))
testexp=({struct Cyc_Absyn_Exp*_tmp912=({struct Cyc_Absyn_Exp*_tmp911=Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(x,0U),0U);Cyc_Absyn_neq_exp(_tmp911,
Cyc_Absyn_int_exp(Cyc_Absyn_None,0,0U),0U);});
# 1886
Cyc_Absyn_and_exp(_tmp912,testexp,0U);});{
# 1888
struct Cyc_Absyn_Stmt*_tmp37F=({struct Cyc_Absyn_Exp*_tmp915=testexp;struct Cyc_Absyn_Stmt*_tmp914=
Cyc_Absyn_exp_stmt(Cyc_Absyn_increment_exp(Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(x,0U),0U),Cyc_Absyn_PreInc,0U),0U);
# 1888
Cyc_Absyn_ifthenelse_stmt(_tmp915,_tmp914,
# 1890
Cyc_Absyn_exp_stmt(({void*_tmp380=0U;({struct Cyc_Absyn_Exp*_tmp913=Cyc_Toc__throw_arraybounds_e;Cyc_Toc_fncall_exp_dl(_tmp913,_tag_fat(_tmp380,sizeof(struct Cyc_Absyn_Exp*),0U));});}),0U),0U);});
# 1888
struct Cyc_Absyn_Stmt*s=_tmp37F;
# 1891
s=({struct Cyc_Absyn_Stmt*_tmp916=s;Cyc_Absyn_seq_stmt(_tmp916,Cyc_Absyn_exp_stmt(Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(x,0U),0U),0U),0U);});
({void*_tmp917=(Cyc_Absyn_stmt_exp(Cyc_Absyn_declare_stmt(x,t,xexp,s,0U),0U))->r;e->r=_tmp917;});}}else{
# 1895
...
({void*_tmp91B=({struct Cyc_Absyn_Exp*_tmp382[2U];({struct Cyc_Absyn_Exp*_tmp919=Cyc_Toc_push_address_exp(e2);_tmp382[0]=_tmp919;}),({struct Cyc_Absyn_Exp*_tmp918=Cyc_Absyn_signed_int_exp(1,0U);_tmp382[1]=_tmp918;});({struct Cyc_Absyn_Exp*_tmp91A=fn_e;Cyc_Toc_fncall_exp_r(_tmp91A,_tag_fat(_tmp382,sizeof(struct Cyc_Absyn_Exp*),2U));});});e->r=_tmp91B;});}}else{
# 1899
...
e->r=e2->r;}}}
# 1903
goto _LL7;}}case 4U: _LL18: _tmp340=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp341=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_tmp342=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3;_LL19: {struct Cyc_Absyn_Exp*e1=_tmp340;struct Cyc_Core_Opt*popt=_tmp341;struct Cyc_Absyn_Exp*e2=_tmp342;
# 1922 "toc.cyc"
...
Cyc_Toc_set_lhs(nv,0);
Cyc_Toc_exp_to_c(nv,e2);
({void*_tmp91C=Cyc_Toc_tagged_union_assignop(e1,e1_old_typ,popt,e2,e2_old_typ,f_tag,tagged_member_struct_type);e->r=_tmp91C;});
# 1933
goto _LL7;}{
# 1935
...
{enum Cyc_Absyn_Primop _tmp384=(enum Cyc_Absyn_Primop)popt->v;enum Cyc_Absyn_Primop _stmttmp30=_tmp384;enum Cyc_Absyn_Primop _tmp385=_stmttmp30;switch(_tmp385){case Cyc_Absyn_Plus: _LL89: _LL8A:
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp387=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7CC;_tmp7CC.tag=0U,({struct _fat_ptr _tmp91D=({const char*_tmp388="bad t ? pointer arithmetic";_tag_fat(_tmp388,sizeof(char),27U);});_tmp7CC.f1=_tmp91D;});_tmp7CC;});void*_tmp386[1U];_tmp386[0]=& _tmp387;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp386,sizeof(void*),1U));});}_LL88:;}
# 1961
done=1;{
# 1963
struct Cyc_Absyn_Exp*_tmp389=Cyc_Toc__fat_ptr_inplace_plus_e;struct Cyc_Absyn_Exp*fn_e=_tmp389;
({void*_tmp921=({struct Cyc_Absyn_Exp*_tmp38A[3U];({struct Cyc_Absyn_Exp*_tmp91F=Cyc_Toc_push_address_exp(e1);_tmp38A[0]=_tmp91F;}),({
struct Cyc_Absyn_Exp*_tmp91E=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_typ),0U);_tmp38A[1]=_tmp91E;}),_tmp38A[2]=change;({struct Cyc_Absyn_Exp*_tmp920=fn_e;Cyc_Toc_fncall_exp_r(_tmp920,_tag_fat(_tmp38A,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 1964
e->r=_tmp921;});}}else{
# 1967
if(Cyc_Tcutil_is_zero_pointer_type_elt(old_typ,& elt_typ)){
# 1970
enum Cyc_Absyn_Primop _tmp38B=(enum Cyc_Absyn_Primop)popt->v;enum Cyc_Absyn_Primop _stmttmp31=_tmp38B;enum Cyc_Absyn_Primop _tmp38C=_stmttmp31;if(_tmp38C == Cyc_Absyn_Plus){_LL90: _LL91:
# 1972
 done=1;
({void*_tmp923=({struct Cyc_Absyn_Exp*_tmp38D[2U];_tmp38D[0]=e1,_tmp38D[1]=e2;({struct Cyc_Absyn_Exp*_tmp922=Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__zero_arr_inplace_plus_functionSet,e1);Cyc_Toc_fncall_exp_r(_tmp922,_tag_fat(_tmp38D,sizeof(struct Cyc_Absyn_Exp*),2U));});});e->r=_tmp923;});
goto _LL8F;}else{_LL92: _LL93:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp38F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7CD;_tmp7CD.tag=0U,({struct _fat_ptr _tmp924=({const char*_tmp390="bad zero-terminated pointer arithmetic";_tag_fat(_tmp390,sizeof(char),39U);});_tmp7CD.f1=_tmp924;});_tmp7CD;});void*_tmp38E[1U];_tmp38E[0]=& _tmp38F;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp38E,sizeof(void*),1U));});}_LL8F:;}}}
# 1979
if(!done){
# 1981
if(e1_poly)
({void*_tmp926=({void*_tmp925=Cyc_Toc_void_star_type();Cyc_Toc_cast_it_r(_tmp925,Cyc_Absyn_new_exp(e2->r,0U));});e2->r=_tmp926;});
# 1987
if(!Cyc_Absyn_is_lvalue(e1)){
({struct Cyc_Absyn_Exp*_tmp927=e1;((void(*)(struct Cyc_Absyn_Exp*e1,struct Cyc_List_List*fs,struct Cyc_Absyn_Exp*(*f)(struct Cyc_Absyn_Exp*,struct _tuple32*),struct _tuple32*f_env))Cyc_Toc_lvalue_assign)(_tmp927,0,Cyc_Toc_assignop_lvalue,({struct _tuple32*_tmp391=_cycalloc(sizeof(*_tmp391));_tmp391->f1=popt,_tmp391->f2=e2;_tmp391;}));});
e->r=e1->r;}}
# 1992
goto _LL7;}}}}case 6U: _LL1A: _tmp33D=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp33E=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_tmp33F=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3;_LL1B: {struct Cyc_Absyn_Exp*e1=_tmp33D;struct Cyc_Absyn_Exp*e2=_tmp33E;struct Cyc_Absyn_Exp*e3=_tmp33F;
# 1994
Cyc_Toc_exp_to_c(nv,e1);
Cyc_Toc_exp_to_c(nv,e2);
Cyc_Toc_exp_to_c(nv,e3);
goto _LL7;}case 7U: _LL1C: _tmp33B=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp33C=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL1D: {struct Cyc_Absyn_Exp*e1=_tmp33B;struct Cyc_Absyn_Exp*e2=_tmp33C;
_tmp339=e1;_tmp33A=e2;goto _LL1F;}case 8U: _LL1E: _tmp339=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp33A=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL1F: {struct Cyc_Absyn_Exp*e1=_tmp339;struct Cyc_Absyn_Exp*e2=_tmp33A;
_tmp337=e1;_tmp338=e2;goto _LL21;}case 9U: _LL20: _tmp337=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp338=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL21: {struct Cyc_Absyn_Exp*e1=_tmp337;struct Cyc_Absyn_Exp*e2=_tmp338;
# 2001
Cyc_Toc_exp_to_c(nv,e1);
Cyc_Toc_exp_to_c(nv,e2);
goto _LL7;}case 10U: if(((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3 == 0){_LL22: _tmp335=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp336=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL23: {struct Cyc_Absyn_Exp*e1=_tmp335;struct Cyc_List_List*es=_tmp336;
# 2005
...
if(Cyc_Toc_do_null_check(e))
# 2010
({void*_tmp92B=({void*_tmp92A=Cyc_Toc_typ_to_c(e1_typ);Cyc_Toc_cast_it_r(_tmp92A,({struct Cyc_Absyn_Exp*_tmp392[1U];({struct Cyc_Absyn_Exp*_tmp928=
Cyc_Absyn_copy_exp(e1);_tmp392[0]=_tmp928;});({struct Cyc_Absyn_Exp*_tmp929=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_dl(_tmp929,_tag_fat(_tmp392,sizeof(struct Cyc_Absyn_Exp*),1U));});}));});
# 2010
e1->r=_tmp92B;});
# 2012
((void(*)(void(*f)(struct Cyc_Toc_Env*,struct Cyc_Absyn_Exp*),struct Cyc_Toc_Env*env,struct Cyc_List_List*x))Cyc_List_iter_c)(Cyc_Toc_exp_to_c,nv,es);
goto _LL7;}}else{_LL24: _tmp330=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp331=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_tmp332=(((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3)->num_varargs;_tmp333=(((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3)->injectors;_tmp334=(((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3)->vai;_LL25: {struct Cyc_Absyn_Exp*e1=_tmp330;struct Cyc_List_List*es=_tmp331;int num_varargs=_tmp332;struct Cyc_List_List*injectors=_tmp333;struct Cyc_Absyn_VarargInfo*vai=_tmp334;
# 2023 "toc.cyc"
struct _RegionHandle _tmp393=_new_region("r");struct _RegionHandle*r=& _tmp393;_push_region(r);{
struct _tuple30 _tmp394=Cyc_Toc_temp_var_and_exp();struct _tuple30 _stmttmp32=_tmp394;struct _tuple30 _tmp395=_stmttmp32;struct Cyc_Absyn_Exp*_tmp397;struct _tuple1*_tmp396;_LL95: _tmp396=_tmp395.f1;_tmp397=_tmp395.f2;_LL96: {struct _tuple1*argv=_tmp396;struct Cyc_Absyn_Exp*argvexp=_tmp397;
...
# 2039
new_args=({struct Cyc_List_List*_tmp39A=_cycalloc(sizeof(*_tmp39A));({struct Cyc_Absyn_Exp*_tmp92E=({struct Cyc_Absyn_Exp*_tmp399[3U];_tmp399[0]=argvexp,({
# 2041
struct Cyc_Absyn_Exp*_tmp92C=Cyc_Absyn_sizeoftype_exp(cva_type,0U);_tmp399[1]=_tmp92C;}),_tmp399[2]=num_varargs_exp;({struct Cyc_Absyn_Exp*_tmp92D=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_dl(_tmp92D,_tag_fat(_tmp399,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 2039
_tmp39A->hd=_tmp92E;}),_tmp39A->tl=new_args;_tmp39A;});
# 2044
...
if(Cyc_Toc_do_null_check(e))
# 2051
({void*_tmp932=({void*_tmp931=Cyc_Toc_typ_to_c(e1_typ);Cyc_Toc_cast_it_r(_tmp931,({struct Cyc_Absyn_Exp*_tmp39B[1U];({struct Cyc_Absyn_Exp*_tmp92F=
Cyc_Absyn_copy_exp(e1);_tmp39B[0]=_tmp92F;});({struct Cyc_Absyn_Exp*_tmp930=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_dl(_tmp930,_tag_fat(_tmp39B,sizeof(struct Cyc_Absyn_Exp*),1U));});}));});
# 2051
e1->r=_tmp932;});{
# 2053
...
{void*_tmp39C=Cyc_Tcutil_compress(Cyc_Tcutil_pointer_elt_type(vai->type));void*_stmttmp33=_tmp39C;void*_tmp39D=_stmttmp33;struct Cyc_Absyn_Datatypedecl*_tmp39E;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp39D)->tag == 0U){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp39D)->f1)->tag == 18U){if(((((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp39D)->f1)->f1).KnownDatatype).tag == 2){_LL98: _tmp39E=*((((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp39D)->f1)->f1).KnownDatatype).val;_LL99: {struct Cyc_Absyn_Datatypedecl*x=_tmp39E;
tud=x;goto _LL97;}}else{goto _LL9A;}}else{goto _LL9A;}}else{_LL9A: _LL9B:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3A0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7CE;_tmp7CE.tag=0U,({struct _fat_ptr _tmp933=({const char*_tmp3A1="unknown datatype in vararg with inject";_tag_fat(_tmp3A1,sizeof(char),39U);});_tmp7CE.f1=_tmp933;});_tmp7CE;});void*_tmp39F[1U];_tmp39F[0]=& _tmp3A0;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp39F,sizeof(void*),1U));});}_LL97:;}{
# 2062
struct _fat_ptr vs=({unsigned _tmp3AD=(unsigned)num_varargs;struct _tuple1**_tmp3AC=({struct _RegionHandle*_tmp934=r;_region_malloc(_tmp934,_check_times(_tmp3AD,sizeof(struct _tuple1*)));});({{unsigned _tmp7CF=(unsigned)num_varargs;unsigned i;for(i=0;i < _tmp7CF;++ i){({struct _tuple1*_tmp935=Cyc_Toc_temp_var();_tmp3AC[i]=_tmp935;});}}0;});_tag_fat(_tmp3AC,sizeof(struct _tuple1*),_tmp3AD);});
# 2064
if(num_varargs != 0){
# 2068
struct Cyc_List_List*_tmp3A2=0;struct Cyc_List_List*array_args=_tmp3A2;
{int i=num_varargs - 1;for(0;i >= 0;-- i){
array_args=({struct Cyc_List_List*_tmp3A3=_cycalloc(sizeof(*_tmp3A3));({struct Cyc_Absyn_Exp*_tmp936=Cyc_Absyn_address_exp(Cyc_Absyn_var_exp(*((struct _tuple1**)_check_fat_subscript(vs,sizeof(struct _tuple1*),i)),0U),0U);_tmp3A3->hd=_tmp936;}),_tmp3A3->tl=array_args;_tmp3A3;});}}
s=({struct _tuple1*_tmp939=argv;void*_tmp938=arr_type;struct Cyc_Absyn_Exp*_tmp937=Cyc_Absyn_array_exp(array_args,0U);Cyc_Absyn_declare_stmt(_tmp939,_tmp938,_tmp937,s,0U);});
# 2073
...
struct Cyc_Absyn_Datatypefield*_tmp3A4=(struct Cyc_Absyn_Datatypefield*)((struct Cyc_List_List*)_check_null(injectors))->hd;struct Cyc_Absyn_Datatypefield*_stmttmp34=_tmp3A4;struct Cyc_Absyn_Datatypefield*_tmp3A5=_stmttmp34;struct Cyc_List_List*_tmp3A7;struct _tuple1*_tmp3A6;_LL9D: _tmp3A6=_tmp3A5->name;_tmp3A7=_tmp3A5->typs;_LL9E: {struct _tuple1*qv=_tmp3A6;struct Cyc_List_List*tqts=_tmp3A7;
...
struct Cyc_List_List*_tmp3A9=({struct _tuple20*_tmp3AB[2U];({struct _tuple20*_tmp93D=({struct _fat_ptr*_tmp93C=Cyc_Toc_tag_sp;Cyc_Toc_make_field(_tmp93C,Cyc_Toc_datatype_tag(tud,qv));});_tmp3AB[0]=_tmp93D;}),({
struct _tuple20*_tmp93B=({struct _fat_ptr*_tmp93A=Cyc_Absyn_fieldname(1);Cyc_Toc_make_field(_tmp93A,arg);});_tmp3AB[1]=_tmp93B;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp3AB,sizeof(struct _tuple20*),2U));});
# 2088
struct Cyc_List_List*dles=_tmp3A9;
# 2090
s=({struct _tuple1*_tmp940=var;void*_tmp93F=Cyc_Absyn_strctq(tdn);struct Cyc_Absyn_Exp*_tmp93E=
...
# 2090
Cyc_Absyn_declare_stmt(_tmp940,_tmp93F,_tmp93E,s,0U);});}}}}}else{
# 2098
s=({struct _tuple1*_tmp943=argv;void*_tmp942=Cyc_Toc_void_star_type();struct Cyc_Absyn_Exp*_tmp941=Cyc_Absyn_uint_exp(0U,0U);Cyc_Absyn_declare_stmt(_tmp943,_tmp942,_tmp941,s,0U);});}}}else{
# 2103
if(num_varargs != 0){
...
# 2112
s=({struct _tuple1*_tmp946=argv;void*_tmp945=Cyc_Toc_void_star_type();struct Cyc_Absyn_Exp*_tmp944=Cyc_Absyn_uint_exp(0U,0U);Cyc_Absyn_declare_stmt(_tmp946,_tmp945,_tmp944,s,0U);});}}
# 2115
({void*_tmp947=Cyc_Toc_stmt_exp_r(s);e->r=_tmp947;});}}}}
# 2117
_npop_handler(0U);goto _LL7;
# 2023
;_pop_region();}}case 11U: _LL26: _tmp32E=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp32F=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL27: {struct Cyc_Absyn_Exp*e1=_tmp32E;int b=_tmp32F;
# 2120
Cyc_Toc_exp_to_c(nv,e1);{
struct Cyc_Absyn_Exp*fn_e=b?Cyc_Toc__rethrow_e: Cyc_Toc__throw_e;
({void*_tmp94A=({void*_tmp949=Cyc_Toc_typ_to_c(old_typ);Cyc_Toc_array_to_ptr_cast(_tmp949,({struct Cyc_Absyn_Exp*_tmp3B0[1U];_tmp3B0[0]=e1;({struct Cyc_Absyn_Exp*_tmp948=fn_e;Cyc_Toc_fncall_exp_dl(_tmp948,_tag_fat(_tmp3B0,sizeof(struct Cyc_Absyn_Exp*),1U));});}),0U);})->r;e->r=_tmp94A;});
goto _LL7;}}case 12U: _LL28: _tmp32D=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_LL29: {struct Cyc_Absyn_Exp*e1=_tmp32D;
Cyc_Toc_exp_to_c(nv,e1);goto _LL7;}case 13U: _LL2A: _tmp32B=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp32C=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL2B: {struct Cyc_Absyn_Exp*e1=_tmp32B;struct Cyc_List_List*ts=_tmp32C;
# 2126
Cyc_Toc_exp_to_c(nv,e1);
# 2135 "toc.cyc"
for(0;ts != 0;ts=ts->tl){
...
{void*_tmp3B2=Cyc_Tcutil_compress((void*)ts->hd);void*_stmttmp35=_tmp3B2;void*_tmp3B3=_stmttmp35;switch(*((int*)_tmp3B3)){case 2U: _LLA0: _LLA1:
 goto _LLA3;case 0U: if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp3B3)->f1)->tag == 18U){_LLA2: _LLA3:
 continue;}else{goto _LLA4;}default: _LLA4: _LLA5:
# 2142
({void*_tmp94C=({void*_tmp94B=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_array_to_ptr_cast(_tmp94B,e1,0U);})->r;e->r=_tmp94C;});
goto _LL9F;}_LL9F:;}
# 2145
break;}}
# 2148
goto _LL7;}case 14U: _LL2C: _tmp327=(void**)&((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp328=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_tmp329=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3;_tmp32A=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp2F7)->f4;_LL2D: {void**t=_tmp327;struct Cyc_Absyn_Exp*e1=_tmp328;int user_inserted=_tmp329;enum Cyc_Absyn_Coercion coercion=_tmp32A;
# 2150
...
Cyc_Toc_exp_to_c(nv,e1);
# 2157
{struct _tuple33 _tmp3B4=({struct _tuple33 _tmp7D1;({void*_tmp94E=Cyc_Tcutil_compress(old_t2);_tmp7D1.f1=_tmp94E;}),({void*_tmp94D=Cyc_Tcutil_compress(new_typ);_tmp7D1.f2=_tmp94D;});_tmp7D1;});struct _tuple33 _stmttmp36=_tmp3B4;struct _tuple33 _tmp3B5=_stmttmp36;struct Cyc_Absyn_PtrInfo _tmp3B6;struct Cyc_Absyn_PtrInfo _tmp3B8;struct Cyc_Absyn_PtrInfo _tmp3B7;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp3B5.f1)->tag == 3U)switch(*((int*)_tmp3B5.f2)){case 3U: _LLA7: _tmp3B7=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp3B5.f1)->f1;_tmp3B8=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp3B5.f2)->f1;_LLA8: {struct Cyc_Absyn_PtrInfo p1=_tmp3B7;struct Cyc_Absyn_PtrInfo p2=_tmp3B8;
# 2159
struct Cyc_Absyn_Exp*_tmp3B9=({void*_tmp94F=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp94F,(p1.ptr_atts).bounds);});struct Cyc_Absyn_Exp*b1=_tmp3B9;
struct Cyc_Absyn_Exp*_tmp3BA=({void*_tmp950=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp950,(p2.ptr_atts).bounds);});struct Cyc_Absyn_Exp*b2=_tmp3BA;
...
{struct _tuple34 _tmp3BD=({struct _tuple34 _tmp7D0;_tmp7D0.f1=b1,_tmp7D0.f2=b2;_tmp7D0;});struct _tuple34 _stmttmp37=_tmp3BD;struct _tuple34 _tmp3BE=_stmttmp37;if(_tmp3BE.f1 != 0){if(_tmp3BE.f2 != 0){_LLAE: _LLAF:
# 2166
 did_inserted_checks=1;
if(Cyc_Toc_do_null_check(e))
({void*_tmp953=({void*_tmp952=*t;Cyc_Toc_cast_it_r(_tmp952,({struct Cyc_Absyn_Exp*_tmp3BF[1U];_tmp3BF[0]=e1;({struct Cyc_Absyn_Exp*_tmp951=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_dl(_tmp951,_tag_fat(_tmp3BF,sizeof(struct Cyc_Absyn_Exp*),1U));});}));});e->r=_tmp953;});else{
...
struct _tuple14 _tmp3C1=Cyc_Evexp_eval_const_uint_exp(e2);struct _tuple14 _stmttmp38=_tmp3C1;struct _tuple14 _tmp3C2=_stmttmp38;int _tmp3C4;unsigned _tmp3C3;_LLB7: _tmp3C3=_tmp3C2.f1;_tmp3C4=_tmp3C2.f2;_LLB8: {unsigned i=_tmp3C3;int valid=_tmp3C4;
if(Cyc_Toc_is_toplevel(nv)){
# 2183
if((zt1 && !(p2.elt_tq).real_const)&& !zt2)
e2=({struct Cyc_Absyn_Exp*_tmp954=e2;Cyc_Absyn_prim2_exp(Cyc_Absyn_Minus,_tmp954,Cyc_Absyn_uint_exp(1U,0U),0U);});
({void*_tmp955=(Cyc_Toc_make_toplevel_dyn_arr(old_t2,e2,e1))->r;e->r=_tmp955;});}else{
# 2188
if(zt1){
# 2193
struct _tuple30 _tmp3C5=Cyc_Toc_temp_var_and_exp();struct _tuple30 _stmttmp39=_tmp3C5;struct _tuple30 _tmp3C6=_stmttmp39;struct Cyc_Absyn_Exp*_tmp3C8;struct _tuple1*_tmp3C7;_LLBA: _tmp3C7=_tmp3C6.f1;_tmp3C8=_tmp3C6.f2;_LLBB: {struct _tuple1*x=_tmp3C7;struct Cyc_Absyn_Exp*x_exp=_tmp3C8;
struct Cyc_Absyn_Exp*arg3;
# 2197
{void*_tmp3C9=e1->r;void*_stmttmp3A=_tmp3C9;void*_tmp3CA=_stmttmp3A;struct Cyc_Absyn_Vardecl*_tmp3CB;struct Cyc_Absyn_Vardecl*_tmp3CC;switch(*((int*)_tmp3CA)){case 0U: switch(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp3CA)->f1).Wstring_c).tag){case 8U: _LLBD: _LLBE:
 arg3=e2;goto _LLBC;case 9U: _LLBF: _LLC0:
 arg3=e2;goto _LLBC;default: goto _LLC5;}case 1U: switch(*((int*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp3CA)->f1)){case 1U: _LLC1: _tmp3CC=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp3CA)->f1)->f1;_LLC2: {struct Cyc_Absyn_Vardecl*vd=_tmp3CC;
_tmp3CB=vd;goto _LLC4;}case 4U: _LLC3: _tmp3CB=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp3CA)->f1)->f1;_LLC4: {struct Cyc_Absyn_Vardecl*vd=_tmp3CB;
# 2202
...
struct Cyc_Absyn_Exp*_tmp957=({void*_tmp956=Cyc_Toc_void_star_type();Cyc_Toc_cast_it(_tmp956,x_exp);});_tmp3CD[0]=_tmp957;}),_tmp3CD[1]=e2;({struct Cyc_Absyn_Exp*_tmp958=
# 2212
Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__get_zero_arr_size_functionSet,e1);Cyc_Toc_fncall_exp_dl(_tmp958,_tag_fat(_tmp3CD,sizeof(struct Cyc_Absyn_Exp*),2U));});});}
# 2214
goto _LLBC;}_LLBC:;}
# 2216
if(!zt2 && !(p2.elt_tq).real_const)
# 2219
arg3=({struct Cyc_Absyn_Exp*_tmp959=arg3;Cyc_Absyn_prim2_exp(Cyc_Absyn_Minus,_tmp959,Cyc_Absyn_uint_exp(1U,0U),0U);});{
# 2221
struct Cyc_Absyn_Exp*_tmp3CE=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(p2.elt_type),0U);struct Cyc_Absyn_Exp*arg2=_tmp3CE;
struct Cyc_Absyn_Exp*_tmp3CF=({struct Cyc_Absyn_Exp*_tmp3D1[3U];_tmp3D1[0]=x_exp,_tmp3D1[1]=arg2,_tmp3D1[2]=arg3;({struct Cyc_Absyn_Exp*_tmp95A=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_dl(_tmp95A,_tag_fat(_tmp3D1,sizeof(struct Cyc_Absyn_Exp*),3U));});});struct Cyc_Absyn_Exp*tg_exp=_tmp3CF;
struct Cyc_Absyn_Stmt*_tmp3D0=Cyc_Absyn_exp_stmt(tg_exp,0U);struct Cyc_Absyn_Stmt*s=_tmp3D0;
s=({struct _tuple1*_tmp95D=x;void*_tmp95C=Cyc_Toc_typ_to_c(old_t2);struct Cyc_Absyn_Exp*_tmp95B=e1;Cyc_Absyn_declare_stmt(_tmp95D,_tmp95C,_tmp95B,s,0U);});
({void*_tmp95E=Cyc_Toc_stmt_exp_r(s);e->r=_tmp95E;});}}}else{
# 2228
({void*_tmp961=({struct Cyc_Absyn_Exp*_tmp3D2[3U];_tmp3D2[0]=e1,({
# 2230
struct Cyc_Absyn_Exp*_tmp95F=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(p2.elt_type),0U);_tmp3D2[1]=_tmp95F;}),_tmp3D2[2]=e2;({struct Cyc_Absyn_Exp*_tmp960=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_r(_tmp960,_tag_fat(_tmp3D2,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 2228
e->r=_tmp961;});}}
# 2233
goto _LLAD;}}}}else{if(_tmp3BE.f2 != 0){_LLB2: _LLB3: {
# 2243 "toc.cyc"
struct Cyc_Absyn_Exp*_tmp3D3=(struct Cyc_Absyn_Exp*)_check_null(b2);struct Cyc_Absyn_Exp*new_e2=_tmp3D3;
if(zt1 && !zt2)
new_e2=({struct Cyc_Absyn_Exp*_tmp962=b2;Cyc_Absyn_add_exp(_tmp962,Cyc_Absyn_uint_exp(1U,0U),0U);});{
# 2250
struct Cyc_Absyn_Exp*_tmp3D4=({struct Cyc_Absyn_Exp*_tmp3D6[3U];_tmp3D6[0]=e1,({
# 2252
struct Cyc_Absyn_Exp*_tmp963=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(p1.elt_type),0U);_tmp3D6[1]=_tmp963;}),_tmp3D6[2]=new_e2;({struct Cyc_Absyn_Exp*_tmp964=Cyc_Toc__untag_fat_ptr_e;Cyc_Toc_fncall_exp_dl(_tmp964,_tag_fat(_tmp3D6,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 2250
struct Cyc_Absyn_Exp*ptr_exp=_tmp3D4;
# 2254
did_inserted_checks=1;
if(Cyc_Toc_do_null_check(e))
({void*_tmp967=({struct Cyc_Absyn_Exp*_tmp3D5[1U];({struct Cyc_Absyn_Exp*_tmp965=Cyc_Absyn_copy_exp(ptr_exp);_tmp3D5[0]=_tmp965;});({struct Cyc_Absyn_Exp*_tmp966=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_r(_tmp966,_tag_fat(_tmp3D5,sizeof(struct Cyc_Absyn_Exp*),1U));});});ptr_exp->r=_tmp967;});
({void*_tmp968=Cyc_Toc_cast_it_r(*t,ptr_exp);e->r=_tmp968;});
...
({void*_tmp96C=({struct Cyc_Absyn_Exp*_tmp3D8[3U];_tmp3D8[0]=e1,({
struct Cyc_Absyn_Exp*_tmp96A=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(p1.elt_type),0U);_tmp3D8[1]=_tmp96A;}),({
struct Cyc_Absyn_Exp*_tmp969=Cyc_Absyn_uint_exp(1U,0U);_tmp3D8[2]=_tmp969;});({struct Cyc_Absyn_Exp*_tmp96B=Cyc_Toc__fat_ptr_decrease_size_e;Cyc_Toc_fncall_exp_r(_tmp96B,_tag_fat(_tmp3D8,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 2265
e->r=_tmp96C;});}
# 2269
goto _LLAD;}}_LLAD:;}
# 2271
goto _LLA6;}case 0U: if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp3B5.f2)->f1)->tag == 1U){_LLA9: _tmp3B6=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp3B5.f1)->f1;_LLAA: {struct Cyc_Absyn_PtrInfo p1=_tmp3B6;
# 2273
{struct Cyc_Absyn_Exp*_tmp3D9=({void*_tmp96D=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp96D,(p1.ptr_atts).bounds);});struct Cyc_Absyn_Exp*_stmttmp3B=_tmp3D9;struct Cyc_Absyn_Exp*_tmp3DA=_stmttmp3B;if(_tmp3DA == 0){_LLC8: _LLC9:
# 2275
({void*_tmp96F=({struct Cyc_Absyn_Exp*_tmp96E=Cyc_Absyn_new_exp(e1->r,e1->loc);Cyc_Toc_aggrmember_exp_r(_tmp96E,Cyc_Toc_curr_sp);});e1->r=_tmp96F;});
e1->topt=new_typ_c;
...
goto _LLA6;}_LLA6:;}
# 2286
goto _LL7;}case 15U: _LL2E: _tmp326=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_LL2F: {struct Cyc_Absyn_Exp*e1=_tmp326;
# 2289
Cyc_Toc_set_lhs(nv,1);
Cyc_Toc_exp_to_c(nv,e1);
Cyc_Toc_set_lhs(nv,0);
...
# 2295
({void*_tmp971=({void*_tmp970=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_cast_it_r(_tmp970,e1);});e->r=_tmp971;});}else{
if(Cyc_Tcutil_kind_leq(& Cyc_Tcutil_ak,Cyc_Tcutil_type_kind((void*)_check_null(e1->topt))))
# 2299
({void*_tmp973=({void*_tmp972=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_cast_it_r(_tmp972,e1);});e->r=_tmp973;});}
# 2301
goto _LL7;}case 16U: _LL30: _tmp324=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp325=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL31: {struct Cyc_Absyn_Exp*rgnopt=_tmp324;struct Cyc_Absyn_Exp*e1=_tmp325;
# 2308
Cyc_Toc_exp_to_c(nv,e1);{
# 2310
void*elt_typ=Cyc_Toc_typ_to_c((void*)_check_null(e1->topt));
struct _tuple30 _tmp3DB=Cyc_Toc_temp_var_and_exp();struct _tuple30 _stmttmp3C=_tmp3DB;struct _tuple30 _tmp3DC=_stmttmp3C;struct Cyc_Absyn_Exp*_tmp3DE;struct _tuple1*_tmp3DD;_LLCD: _tmp3DD=_tmp3DC.f1;_tmp3DE=_tmp3DC.f2;_LLCE: {struct _tuple1*x=_tmp3DD;struct Cyc_Absyn_Exp*xexp=_tmp3DE;
struct Cyc_Absyn_Exp*lhs;
{void*_tmp3DF=Cyc_Tcutil_compress(elt_typ);void*_stmttmp3D=_tmp3DF;void*_tmp3E0=_stmttmp3D;void*_tmp3E1;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp3E0)->tag == 4U){_LLD0: _tmp3E1=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp3E0)->f1).elt_type;_LLD1: {void*t2=_tmp3E1;
# 2315
...
if((unsigned)lenexp)
mexp=({struct Cyc_Absyn_Exp*_tmp3E4[2U];_tmp3E4[0]=lenexp,({struct Cyc_Absyn_Exp*_tmp974=Cyc_Absyn_sizeoftype_exp(elt_typ,0U);_tmp3E4[1]=_tmp974;});({struct Cyc_Absyn_Exp*_tmp975=Cyc_Toc__check_times_e;Cyc_Toc_fncall_exp_dl(_tmp975,_tag_fat(_tmp3E4,sizeof(struct Cyc_Absyn_Exp*),2U));});});else{
# 2329
...
struct Cyc_Absyn_Exp*_tmp978=Cyc_Absyn_copy_exp(xexp);_tmp3E6[0]=_tmp978;}),({
struct Cyc_Absyn_Exp*_tmp977=Cyc_Absyn_sizeoftype_exp(elt_typ,0U);_tmp3E6[1]=_tmp977;}),
(unsigned)lenexp?_tmp3E6[2]=lenexp:({struct Cyc_Absyn_Exp*_tmp976=Cyc_Absyn_uint_exp(1U,0U);_tmp3E6[2]=_tmp976;});({struct Cyc_Absyn_Exp*_tmp979=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_dl(_tmp979,_tag_fat(_tmp3E6,sizeof(struct Cyc_Absyn_Exp*),3U));});});else{
# 2349
answer=Cyc_Absyn_copy_exp(xexp);}
({void*_tmp97A=(void*)({struct Cyc_Toc_Dest_Absyn_AbsynAnnot_struct*_tmp3E7=_cycalloc(sizeof(*_tmp3E7));_tmp3E7->tag=Cyc_Toc_Dest,_tmp3E7->f1=xexp;_tmp3E7;});e->annot=_tmp97A;});{
struct Cyc_Absyn_Stmt*_tmp3E8=({struct _tuple1*_tmp97E=x;void*_tmp97D=Cyc_Absyn_cstar_type(elt_typ,Cyc_Toc_mt_tq);struct Cyc_Absyn_Exp*_tmp97C=mexp;Cyc_Absyn_declare_stmt(_tmp97E,_tmp97D,_tmp97C,({
struct Cyc_Absyn_Stmt*_tmp97B=Cyc_Absyn_exp_stmt(Cyc_Absyn_copy_exp(e),0U);Cyc_Absyn_seq_stmt(_tmp97B,
...
({void*_tmp97F=Cyc_Toc_stmt_exp_r(s);e->r=_tmp97F;});
if(vse != 0)
({void*_tmp981=({void*_tmp980=Cyc_Toc_typ_to_c(old_typ);Cyc_Toc_cast_it_r(_tmp980,Cyc_Absyn_copy_exp(e));});e->r=_tmp981;});
goto _LL7;}}}}}}}case 18U: _LL32: _tmp323=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_LL33: {struct Cyc_Absyn_Exp*e1=_tmp323;
# 2363
Cyc_Toc_exp_to_c(nv,e1);goto _LL7;}case 17U: _LL34: _tmp322=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_LL35: {void*t=_tmp322;
({void*_tmp983=(void*)({struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*_tmp3E9=_cycalloc(sizeof(*_tmp3E9));_tmp3E9->tag=17U,({void*_tmp982=Cyc_Toc_typ_to_c(t);_tmp3E9->f1=_tmp982;});_tmp3E9;});e->r=_tmp983;});goto _LL7;}case 19U: _LL36: _tmp320=(void*)((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp321=((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL37: {void*t=_tmp320;struct Cyc_List_List*fs=_tmp321;
# 2366
void*_tmp3EA=t;void*t2=_tmp3EA;
struct Cyc_List_List*_tmp3EB=fs;struct Cyc_List_List*l=_tmp3EB;
for(0;l != 0;l=l->tl){
void*_tmp3EC=(void*)l->hd;void*_stmttmp3E=_tmp3EC;void*_tmp3ED=_stmttmp3E;unsigned _tmp3EE;struct _fat_ptr*_tmp3EF;if(((struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*)_tmp3ED)->tag == 0U){_LLD5: _tmp3EF=((struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*)_tmp3ED)->f1;_LLD6: {struct _fat_ptr*n=_tmp3EF;
goto _LLD4;}}else{_LLD7: _tmp3EE=((struct Cyc_Absyn_TupleIndex_Absyn_OffsetofField_struct*)_tmp3ED)->f1;_LLD8: {unsigned n=_tmp3EE;
# 2372
{void*_tmp3F0=Cyc_Tcutil_compress(t2);void*_stmttmp3F=_tmp3F0;void*_tmp3F1=_stmttmp3F;struct Cyc_List_List*_tmp3F2;struct Cyc_List_List*_tmp3F3;struct Cyc_Absyn_Datatypefield*_tmp3F4;union Cyc_Absyn_AggrInfo _tmp3F5;switch(*((int*)_tmp3F1)){case 0U: switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp3F1)->f1)){case 20U: _LLDA: _tmp3F5=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp3F1)->f1)->f1;_LLDB: {union Cyc_Absyn_AggrInfo info=_tmp3F5;
# 2374
struct Cyc_Absyn_Aggrdecl*_tmp3F6=Cyc_Absyn_get_known_aggrdecl(info);struct Cyc_Absyn_Aggrdecl*ad=_tmp3F6;
if(ad->impl == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3F8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D2;_tmp7D2.tag=0U,({struct _fat_ptr _tmp984=({const char*_tmp3F9="struct fields must be known";_tag_fat(_tmp3F9,sizeof(char),28U);});_tmp7D2.f1=_tmp984;});_tmp7D2;});void*_tmp3F7[1U];_tmp3F7[0]=& _tmp3F8;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp3F7,sizeof(void*),1U));});
_tmp3F3=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->fields;goto _LLDD;}case 19U: if(((((struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp3F1)->f1)->f1).KnownDatatypefield).tag == 2){_LLE0: _tmp3F4=(((((struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp3F1)->f1)->f1).KnownDatatypefield).val).f2;_LLE1: {struct Cyc_Absyn_Datatypefield*tuf=_tmp3F4;
# 2388
if(n == (unsigned)0)
({void*_tmp985=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp3FD=_cycalloc(sizeof(*_tmp3FD));_tmp3FD->tag=0U,_tmp3FD->f1=Cyc_Toc_tag_sp;_tmp3FD;}));l->hd=_tmp985;});else{
# 2391
t2=(*((struct _tuple13*(*)(struct Cyc_List_List*x,int n))Cyc_List_nth)(tuf->typs,(int)(n - (unsigned)1))).f2;
({void*_tmp987=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp3FE=_cycalloc(sizeof(*_tmp3FE));_tmp3FE->tag=0U,({struct _fat_ptr*_tmp986=Cyc_Absyn_fieldname((int)n);_tmp3FE->f1=_tmp986;});_tmp3FE;}));l->hd=_tmp987;});}
# 2394
goto _LLD9;}}else{goto _LLE2;}default: goto _LLE2;}case 7U: _LLDC: _tmp3F3=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp3F1)->f2;_LLDD: {struct Cyc_List_List*fields=_tmp3F3;
# 2379
...
({void*_tmp988=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp3FB=_cycalloc(sizeof(*_tmp3FB));_tmp3FB->tag=0U,_tmp3FB->f1=nth_field->name;_tmp3FB;}));l->hd=_tmp988;});
t2=nth_field->type;
goto _LLD9;}case 6U: _LLDE: _tmp3F2=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp3F1)->f1;_LLDF: {struct Cyc_List_List*ts=_tmp3F2;
# 2384
({void*_tmp98A=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp3FC=_cycalloc(sizeof(*_tmp3FC));_tmp3FC->tag=0U,({struct _fat_ptr*_tmp989=Cyc_Absyn_fieldname((int)(n + (unsigned)1));_tmp3FC->f1=_tmp989;});_tmp3FC;}));l->hd=_tmp98A;});
t2=(*((struct _tuple13*(*)(struct Cyc_List_List*x,int n))Cyc_List_nth)(ts,(int)n)).f2;
goto _LLD9;}default: _LLE2: _LLE3:
# 2395
({struct Cyc_Warn_String_Warn_Warg_struct _tmp400=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D3;_tmp7D3.tag=0U,({struct _fat_ptr _tmp98B=({const char*_tmp401="impossible type for offsetof tuple index";_tag_fat(_tmp401,sizeof(char),41U);});_tmp7D3.f1=_tmp98B;});_tmp7D3;});void*_tmp3FF[1U];_tmp3FF[0]=& _tmp400;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp3FF,sizeof(void*),1U));});}_LLD9:;}
# 2397
goto _LLD4;}}_LLD4:;}
# 2400
({void*_tmp98D=(void*)({struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmp402=_cycalloc(sizeof(*_tmp402));_tmp402->tag=19U,({void*_tmp98C=Cyc_Toc_typ_to_c(t);_tmp402->f1=_tmp98C;}),_tmp402->f2=fs;_tmp402;});e->r=_tmp98D;});
goto _LL7;}case 21U: _LL38: _tmp31C=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp31D=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_tmp31E=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3;_tmp31F=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp2F7)->f4;_LL39: {struct Cyc_Absyn_Exp*e1=_tmp31C;struct _fat_ptr*f=_tmp31D;int is_tagged=_tmp31E;int is_read=_tmp31F;
# 2403
int is_poly=Cyc_Toc_is_poly_project(e);
void*e1_cyc_type=(void*)_check_null(e1->topt);
Cyc_Toc_exp_to_c(nv,e1);
if(is_tagged && is_read)
({void*_tmp992=({struct Cyc_Absyn_Exp*_tmp991=e1;void*_tmp990=Cyc_Toc_typ_to_c(e1_cyc_type);void*_tmp98F=e1_cyc_type;struct _fat_ptr*_tmp98E=f;Cyc_Toc_check_tagged_union(_tmp991,_tmp990,_tmp98F,_tmp98E,
Cyc_Toc_in_lhs(nv),Cyc_Toc_member_exp);});
# 2407
e->r=_tmp992;});
# 2409
if(is_poly)
({void*_tmp994=({void*_tmp993=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_array_to_ptr_cast(_tmp993,Cyc_Absyn_new_exp(e->r,0U),0U);})->r;e->r=_tmp994;});
goto _LL7;}case 22U: _LL3A: _tmp318=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp319=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_tmp31A=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3;_tmp31B=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp2F7)->f4;_LL3B: {struct Cyc_Absyn_Exp*e1=_tmp318;struct _fat_ptr*f=_tmp319;int is_tagged=_tmp31A;int is_read=_tmp31B;
# 2413
int is_poly=Cyc_Toc_is_poly_project(e);
void*e1typ=(void*)_check_null(e1->topt);
void*ta;
{void*_tmp403=Cyc_Tcutil_compress(e1typ);void*_stmttmp40=_tmp403;void*_tmp404=_stmttmp40;struct Cyc_Absyn_PtrInfo _tmp405;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp404)->tag == 3U){_LLE5: _tmp405=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp404)->f1;_LLE6: {struct Cyc_Absyn_PtrInfo p=_tmp405;
ta=p.elt_type;goto _LLE4;}}else{_LLE7: _LLE8:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp407=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D4;_tmp7D4.tag=0U,({struct _fat_ptr _tmp995=({const char*_tmp408="get_ptr_typ: not a pointer!";_tag_fat(_tmp408,sizeof(char),28U);});_tmp7D4.f1=_tmp995;});_tmp7D4;});void*_tmp406[1U];_tmp406[0]=& _tmp407;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp406,sizeof(void*),1U));});}_LLE4:;}
# 2420
did_inserted_checks=1;
Cyc_Toc_ptr_use_to_c(nv,e1,e->annot,0);
if(is_tagged && is_read)
({void*_tmp99A=({struct Cyc_Absyn_Exp*_tmp999=e1;void*_tmp998=Cyc_Toc_typ_to_c(e1typ);void*_tmp997=ta;struct _fat_ptr*_tmp996=f;Cyc_Toc_check_tagged_union(_tmp999,_tmp998,_tmp997,_tmp996,Cyc_Toc_in_lhs(nv),Cyc_Absyn_aggrarrow_exp);});e->r=_tmp99A;});
if(is_poly && is_read)
...
goto _LL7;}case 20U: _LL3C: _tmp317=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_LL3D: {struct Cyc_Absyn_Exp*e1=_tmp317;
# 2428
did_inserted_checks=1;
Cyc_Toc_ptr_use_to_c(nv,e1,e->annot,0);
goto _LL7;}case 23U: _LL3E: _tmp315=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp316=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL3F: {struct Cyc_Absyn_Exp*e1=_tmp315;struct Cyc_Absyn_Exp*e2=_tmp316;
# 2432
{void*_tmp409=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*_stmttmp41=_tmp409;void*_tmp40A=_stmttmp41;struct Cyc_List_List*_tmp40B;if(((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp40A)->tag == 6U){_LLEA: _tmp40B=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp40A)->f1;_LLEB: {struct Cyc_List_List*ts=_tmp40B;
# 2434
Cyc_Toc_exp_to_c(nv,e1);{
int _tmp40C=Cyc_Toc_in_lhs(nv);int old_lhs=_tmp40C;
Cyc_Toc_set_lhs(nv,0);
Cyc_Toc_exp_to_c(nv,e2);{
struct _tuple14 _tmp40D=Cyc_Evexp_eval_const_uint_exp(e2);struct _tuple14 _stmttmp42=_tmp40D;struct _tuple14 _tmp40E=_stmttmp42;int _tmp410;unsigned _tmp40F;_LLEF: _tmp40F=_tmp40E.f1;_tmp410=_tmp40E.f2;_LLF0: {unsigned i=_tmp40F;int known=_tmp410;
if(!known)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp412=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D5;_tmp7D5.tag=0U,({struct _fat_ptr _tmp99D=({const char*_tmp413="unknown tuple subscript in translation to C";_tag_fat(_tmp413,sizeof(char),44U);});_tmp7D5.f1=_tmp99D;});_tmp7D5;});void*_tmp411[1U];_tmp411[0]=& _tmp412;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp411,sizeof(void*),1U));});
({void*_tmp99F=({struct Cyc_Absyn_Exp*_tmp99E=e1;Cyc_Toc_aggrmember_exp_r(_tmp99E,Cyc_Absyn_fieldname((int)(i + (unsigned)1)));});e->r=_tmp99F;});
goto _LLE9;}}}}}else{_LLEC: _LLED:
# 2444
 did_inserted_checks=1;{
int index_used=Cyc_Toc_ptr_use_to_c(nv,e1,e->annot,e2);
if(index_used)
({void*_tmp9A0=Cyc_Toc_deref_exp_r(e1);e->r=_tmp9A0;});
goto _LLE9;}}_LLE9:;}
# 2450
goto _LL7;}case 24U: _LL40: _tmp314=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_LL41: {struct Cyc_List_List*es=_tmp314;
# 2452
if(!Cyc_Toc_is_toplevel(nv)){
# 2454
...
{void*_tmp415=strct_typ;union Cyc_Absyn_AggrInfo _tmp416;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp415)->tag == 0U){if(((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp415)->f1)->tag == 20U){if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp415)->f2 == 0){_LLF2: _tmp416=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp415)->f1)->f1;_LLF3: {union Cyc_Absyn_AggrInfo aggrinfo=_tmp416;
# 2457
struct Cyc_List_List*dles=0;
struct Cyc_Absyn_Aggrdecl*sd=Cyc_Absyn_get_known_aggrdecl(aggrinfo);
{int i=1;for(0;es != 0;(es=es->tl,++ i)){
Cyc_Toc_exp_to_c(nv,(struct Cyc_Absyn_Exp*)es->hd);
dles=({struct Cyc_List_List*_tmp417=_cycalloc(sizeof(*_tmp417));({struct _tuple20*_tmp9A2=({struct _fat_ptr*_tmp9A1=Cyc_Absyn_fieldname(i);Cyc_Toc_make_field(_tmp9A1,(struct Cyc_Absyn_Exp*)es->hd);});_tmp417->hd=_tmp9A2;}),_tmp417->tl=dles;_tmp417;});}}
# 2463
({void*_tmp9A4=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp418=_cycalloc(sizeof(*_tmp418));_tmp418->tag=29U,_tmp418->f1=sd->name,_tmp418->f2=0,({struct Cyc_List_List*_tmp9A3=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);_tmp418->f3=_tmp9A3;}),_tmp418->f4=sd;_tmp418;});e->r=_tmp9A4;});
e->topt=strct_typ;
goto _LLF1;}}else{goto _LLF4;}}else{goto _LLF4;}}else{_LLF4: _LLF5:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp41A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D6;_tmp7D6.tag=0U,({struct _fat_ptr _tmp9A5=({const char*_tmp41B="tuple type not an aggregate";_tag_fat(_tmp41B,sizeof(char),28U);});_tmp7D6.f1=_tmp9A5;});_tmp7D6;});void*_tmp419[1U];_tmp419[0]=& _tmp41A;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp419,sizeof(void*),1U));});}_LLF1:;}
# 2468
goto _LL7;}else{
# 2472
struct Cyc_List_List*dles=0;
for(0;es != 0;es=es->tl){
Cyc_Toc_exp_to_c(nv,(struct Cyc_Absyn_Exp*)es->hd);
dles=({struct Cyc_List_List*_tmp41D=_cycalloc(sizeof(*_tmp41D));({struct _tuple20*_tmp9A6=({struct _tuple20*_tmp41C=_cycalloc(sizeof(*_tmp41C));_tmp41C->f1=0,_tmp41C->f2=(struct Cyc_Absyn_Exp*)es->hd;_tmp41C;});_tmp41D->hd=_tmp9A6;}),_tmp41D->tl=dles;_tmp41D;});}
# 2477
({void*_tmp9A7=Cyc_Toc_unresolvedmem_exp_r(0,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles));e->r=_tmp9A7;});}
# 2479
goto _LL7;}case 26U: _LL42: _tmp313=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_LL43: {struct Cyc_List_List*dles0=_tmp313;
# 2485
...
if(Cyc_Toc_is_toplevel(nv))
({void*_tmp9A8=Cyc_Toc_unresolvedmem_exp_r(0,dles0);e->r=_tmp9A8;});
goto _LL7;}case 27U: _LL44: _tmp30F=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp310=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_tmp311=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3;_tmp312=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp2F7)->f4;_LL45: {struct Cyc_Absyn_Vardecl*vd=_tmp30F;struct Cyc_Absyn_Exp*e1=_tmp310;struct Cyc_Absyn_Exp*e2=_tmp311;int iszeroterm=_tmp312;
# 2493
Cyc_Toc_exp_to_c(nv,e1);
Cyc_Toc_exp_to_c(nv,e2);
if(Cyc_Toc_is_toplevel(nv)){
struct _tuple14 _tmp41F=Cyc_Evexp_eval_const_uint_exp(e1);struct _tuple14 _stmttmp43=_tmp41F;struct _tuple14 _tmp420=_stmttmp43;int _tmp422;unsigned _tmp421;_LLF7: _tmp421=_tmp420.f1;_tmp422=_tmp420.f2;_LLF8: {unsigned sz=_tmp421;int known=_tmp422;
void*_tmp423=Cyc_Toc_typ_to_c((void*)_check_null(e2->topt));void*elt_typ=_tmp423;
struct Cyc_List_List*es=0;
# 2500
if(!Cyc_Toc_is_zero(e2)){
if(!known)
({void*_tmp424=0U;({unsigned _tmp9AA=e1->loc;struct _fat_ptr _tmp9A9=({const char*_tmp425="cannot determine value of constant";_tag_fat(_tmp425,sizeof(char),35U);});Cyc_Tcutil_terr(_tmp9AA,_tmp9A9,_tag_fat(_tmp424,sizeof(void*),0U));});});
{unsigned i=0U;for(0;i < sz;++ i){
es=({struct Cyc_List_List*_tmp427=_cycalloc(sizeof(*_tmp427));({struct _tuple20*_tmp9AB=({struct _tuple20*_tmp426=_cycalloc(sizeof(*_tmp426));_tmp426->f1=0,_tmp426->f2=e2;_tmp426;});_tmp427->hd=_tmp9AB;}),_tmp427->tl=es;_tmp427;});}}
# 2506
if(iszeroterm){
struct Cyc_Absyn_Exp*_tmp428=({void*_tmp9AC=elt_typ;Cyc_Toc_cast_it(_tmp9AC,Cyc_Absyn_uint_exp(0U,0U));});struct Cyc_Absyn_Exp*ezero=_tmp428;
es=({struct Cyc_List_List*_tmp9AE=es;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp9AE,({struct Cyc_List_List*_tmp42A=_cycalloc(sizeof(*_tmp42A));({struct _tuple20*_tmp9AD=({struct _tuple20*_tmp429=_cycalloc(sizeof(*_tmp429));_tmp429->f1=0,_tmp429->f2=ezero;_tmp429;});_tmp42A->hd=_tmp9AD;}),_tmp42A->tl=0;_tmp42A;}));});}}
# 2511
({void*_tmp9AF=Cyc_Toc_unresolvedmem_exp_r(0,es);e->r=_tmp9AF;});}}
# 2513
goto _LL7;}case 28U: _LL46: _tmp30C=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp30D=(void*)((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_tmp30E=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3;_LL47: {struct Cyc_Absyn_Exp*e1=_tmp30C;void*t1=_tmp30D;int iszeroterm=_tmp30E;
# 2520
if(Cyc_Toc_is_toplevel(nv))
({void*_tmp9B0=Cyc_Toc_unresolvedmem_exp_r(0,0);e->r=_tmp9B0;});else{
# 2523
Cyc_Toc_exp_to_c(nv,e1);}
goto _LL7;}case 30U: _LL48: _tmp30A=(void*)((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp30B=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL49: {void*st=_tmp30A;struct Cyc_List_List*dles=_tmp30B;
# 2527
...
e->topt=strct_typ;
if(!Cyc_Toc_is_toplevel(nv)){
void*_tmp42D=Cyc_Tcutil_compress(strct_typ);void*_stmttmp44=_tmp42D;void*_tmp42E=_stmttmp44;union Cyc_Absyn_AggrInfo _tmp42F;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp42E)->tag == 0U){if(((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp42E)->f1)->tag == 20U){if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp42E)->f2 == 0){_LLFA: _tmp42F=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp42E)->f1)->f1;_LLFB: {union Cyc_Absyn_AggrInfo aggrinfo=_tmp42F;
# 2534
struct Cyc_Absyn_Aggrdecl*sd=Cyc_Absyn_get_known_aggrdecl(aggrinfo);
({void*_tmp9B1=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp430=_cycalloc(sizeof(*_tmp430));_tmp430->tag=29U,_tmp430->f1=sd->name,_tmp430->f2=0,_tmp430->f3=dles,_tmp430->f4=sd;_tmp430;});e->r=_tmp9B1;});
e->topt=strct_typ;
goto _LLF9;}}else{goto _LLFC;}}else{goto _LLFC;}}else{_LLFC: _LLFD:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp432=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D7;_tmp7D7.tag=0U,({struct _fat_ptr _tmp9B2=({const char*_tmp433="anonStruct type not an aggregate";_tag_fat(_tmp433,sizeof(char),33U);});_tmp7D7.f1=_tmp9B2;});_tmp7D7;});void*_tmp431[1U];_tmp431[0]=& _tmp432;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp431,sizeof(void*),1U));});}_LLF9:;}else{
# 2541
({void*_tmp9B3=Cyc_Toc_unresolvedmem_exp_r(0,dles);e->r=_tmp9B3;});}
goto _LL7;}}case 29U: _LL4A: _tmp306=(struct _tuple1**)&((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp307=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_tmp308=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3;_tmp309=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp2F7)->f4;_LL4B: {struct _tuple1**tdn=_tmp306;struct Cyc_List_List*exist_ts=_tmp307;struct Cyc_List_List*dles=_tmp308;struct Cyc_Absyn_Aggrdecl*sd=_tmp309;
# 2547
if(sd == 0 || sd->impl == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp435=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D8;_tmp7D8.tag=0U,({struct _fat_ptr _tmp9B4=({const char*_tmp436="exp_to_c, Aggregate_e: missing aggrdecl pointer or fields";_tag_fat(_tmp436,sizeof(char),58U);});_tmp7D8.f1=_tmp9B4;});_tmp7D8;});void*_tmp434[1U];_tmp434[0]=& _tmp435;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp434,sizeof(void*),1U));});{
void*_tmp437=Cyc_Toc_typ_to_c(old_typ);void*new_typ=_tmp437;
{void*_tmp438=Cyc_Tcutil_compress(new_typ);void*_stmttmp45=_tmp438;void*_tmp439=_stmttmp45;union Cyc_Absyn_AggrInfo _tmp43A;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp439)->tag == 0U){if(((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp439)->f1)->tag == 20U){_LLFF: _tmp43A=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp439)->f1)->f1;_LL100: {union Cyc_Absyn_AggrInfo info=_tmp43A;
({struct _tuple1*_tmp9B5=(Cyc_Absyn_aggr_kinded_name(info)).f2;*tdn=_tmp9B5;});goto _LLFE;}}else{goto _LL101;}}else{_LL101: _LL102:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp43C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D9;_tmp7D9.tag=0U,({struct _fat_ptr _tmp9B6=({const char*_tmp43D="exp_to_c, Aggregate_e: bad type translation";_tag_fat(_tmp43D,sizeof(char),44U);});_tmp7D9.f1=_tmp9B6;});_tmp7D9;});void*_tmp43B[1U];_tmp43B[0]=& _tmp43C;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp43B,sizeof(void*),1U));});}_LLFE:;}{
# 2558
...
({void*_tmp9B8=({void*_tmp9B7=Cyc_Toc_typ_to_c(aggrfield->type);Cyc_Toc_cast_it(_tmp9B7,
...
struct _tuple1*s=({struct _tuple1*_tmp458=_cycalloc(sizeof(*_tmp458));({union Cyc_Absyn_Nmspace _tmp9BC=Cyc_Absyn_Abs_n(0,1);_tmp458->f1=_tmp9BC;}),({
struct _fat_ptr*_tmp9BB=({struct _fat_ptr*_tmp457=_cycalloc(sizeof(*_tmp457));({struct _fat_ptr _tmp9BA=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp455=({struct Cyc_String_pa_PrintArg_struct _tmp7DB;_tmp7DB.tag=0U,_tmp7DB.f1=(struct _fat_ptr)((struct _fat_ptr)*(*sd->name).f2);_tmp7DB;});struct Cyc_String_pa_PrintArg_struct _tmp456=({struct Cyc_String_pa_PrintArg_struct _tmp7DA;_tmp7DA.tag=0U,_tmp7DA.f1=(struct _fat_ptr)((struct _fat_ptr)*n);_tmp7DA;});void*_tmp453[2U];_tmp453[0]=& _tmp455,_tmp453[1]=& _tmp456;({struct _fat_ptr _tmp9B9=({const char*_tmp454="_union_%s_%s";_tag_fat(_tmp454,sizeof(char),13U);});Cyc_aprintf(_tmp9B9,_tag_fat(_tmp453,sizeof(void*),2U));});});*_tmp457=_tmp9BA;});_tmp457;});_tmp458->f2=_tmp9BB;});_tmp458;});
# 2587
struct _tuple20*_tmp44E=({
struct _fat_ptr*_tmp9BE=n;Cyc_Toc_make_field(_tmp9BE,Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp452=_cycalloc(sizeof(*_tmp452));_tmp452->tag=29U,_tmp452->f1=s,_tmp452->f2=0,({struct Cyc_List_List*_tmp9BD=({struct _tuple20*_tmp451[2U];_tmp451[0]=tag_dle,_tmp451[1]=val_dle;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp451,sizeof(struct _tuple20*),2U));});_tmp452->f3=_tmp9BD;}),_tmp452->f4=0;_tmp452;}),0U));});
# 2587
struct _tuple20*u_dle=_tmp44E;
# 2590
({void*_tmp9C0=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp450=_cycalloc(sizeof(*_tmp450));_tmp450->tag=29U,_tmp450->f1=*tdn,_tmp450->f2=0,({struct Cyc_List_List*_tmp9BF=({struct _tuple20*_tmp44F[1U];_tmp44F[0]=u_dle;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp44F,sizeof(struct _tuple20*),1U));});_tmp450->f3=_tmp9BF;}),_tmp450->f4=sd;_tmp450;});e->r=_tmp9C0;});}
# 2596
if(Cyc_Toc_is_abstract_type(old_typ)&& last_typ_field == aggrfield){
struct Cyc_List_List*_tmp459=({struct Cyc_List_List*_tmp9C1=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_zip)(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(sd->impl))->exist_vars,exist_ts);((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp9C1,
...
struct Cyc_Absyn_Aggrfield*_tmp45D=({struct Cyc_Absyn_Aggrfield*_tmp9C2=old_f;Cyc_Toc_aggrfield_to_c(_tmp9C2,
...
# 2611
if(fs->tl == 0){
{void*_tmp45F=Cyc_Tcutil_compress(new_f->type);void*_stmttmp48=_tmp45F;void*_tmp460=_stmttmp48;struct Cyc_Absyn_ArrayInfo _tmp461;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp460)->tag == 4U){_LL10C: _tmp461=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp460)->f1;_LL10D: {struct Cyc_Absyn_ArrayInfo ai=_tmp461;
# 2614
...
({struct Cyc_Absyn_Exp*_tmp9C3=Cyc_Absyn_uint_exp(0U,0U);ai2.num_elts=_tmp9C3;});
({void*_tmp9C4=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp463=_cycalloc(sizeof(*_tmp463));_tmp463->tag=4U,_tmp463->f1=ai2;_tmp463;});new_f->type=_tmp9C4;});}
# 2619
goto _LL10B;}}else{_LL10E: _LL10F:
# 2623
 if(fieldexp->topt == 0)
goto _LL10B;
{void*_tmp464=Cyc_Tcutil_compress((void*)_check_null(fieldexp->topt));void*_stmttmp49=_tmp464;void*_tmp465=_stmttmp49;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp465)->tag == 0U){if(((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp465)->f1)->tag == 20U){_LL111: _LL112:
# 2627
...
({struct Cyc_List_List*_tmp9C6=({struct Cyc_List_List*_tmp467=_cycalloc(sizeof(*_tmp467));({void*_tmp9C5=(void*)({struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_tmp466=_cycalloc(sizeof(*_tmp466));_tmp466->tag=6U,_tmp466->f1=0;_tmp466;});_tmp467->hd=_tmp9C5;}),_tmp467->tl=new_f->attributes;_tmp467;});new_f->attributes=_tmp9C6;});}}}
# 2640
sd=({struct _fat_ptr*_tmp9C9=({struct _fat_ptr*_tmp46B=_cycalloc(sizeof(*_tmp46B));({struct _fat_ptr _tmp9C8=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp46A=({struct Cyc_Int_pa_PrintArg_struct _tmp7DC;_tmp7DC.tag=1U,_tmp7DC.f1=(unsigned long)Cyc_Toc_tuple_type_counter ++;_tmp7DC;});void*_tmp468[1U];_tmp468[0]=& _tmp46A;({struct _fat_ptr _tmp9C7=({const char*_tmp469="_genStruct%d";_tag_fat(_tmp469,sizeof(char),13U);});Cyc_aprintf(_tmp9C7,_tag_fat(_tmp468,sizeof(void*),1U));});});*_tmp46B=_tmp9C8;});_tmp46B;});Cyc_Toc_make_c_struct_defn(_tmp9C9,
# 2642
((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(new_fields));});
*tdn=sd->name;
Cyc_Toc_aggrdecl_to_c(sd);
# 2646
({void*_tmp9CA=Cyc_Absyn_aggr_type(Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp46C=_cycalloc(sizeof(*_tmp46C));*_tmp46C=sd;_tmp46C;})),0);e->topt=_tmp9CA;});}}}}
# 2649
goto _LL103;}}else{goto _LL106;}}else{_LL106: _LL107:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp46E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7DD;_tmp7DD.tag=0U,({struct _fat_ptr _tmp9CB=({const char*_tmp46F="exp_to_c, Aggregate_e: bad struct type";_tag_fat(_tmp46F,sizeof(char),39U);});_tmp7DD.f1=_tmp9CB;});_tmp7DD;});void*_tmp46D[1U];_tmp46D[0]=& _tmp46E;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp46D,sizeof(void*),1U));});}_LL103:;}else{
# 2658
if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(sd->impl))->tagged){
# 2660
struct _tuple35*_tmp470=(struct _tuple35*)((struct Cyc_List_List*)_check_null(fields))->hd;struct _tuple35*_stmttmp4A=_tmp470;struct _tuple35*_tmp471=_stmttmp4A;struct Cyc_Absyn_Exp*_tmp473;struct Cyc_Absyn_Aggrfield*_tmp472;_LL116: _tmp472=_tmp471->f1;_tmp473=_tmp471->f2;_LL117: {struct Cyc_Absyn_Aggrfield*field=_tmp472;struct Cyc_Absyn_Exp*fieldexp=_tmp473;
...
({void*_tmp9CD=({
void*_tmp9CC=Cyc_Toc_void_star_type();Cyc_Toc_cast_it_r(_tmp9CC,Cyc_Absyn_new_exp(fieldexp->r,0U));});
# 2666
fieldexp->r=_tmp9CD;});{
# 2669
int i=Cyc_Toc_get_member_offset(sd,field->name);
struct Cyc_Absyn_Exp*field_tag_exp=Cyc_Absyn_signed_int_exp(i,0U);
struct Cyc_List_List*_tmp476=({struct _tuple20*_tmp478[2U];({struct _tuple20*_tmp9CF=({struct _tuple20*_tmp479=_cycalloc(sizeof(*_tmp479));_tmp479->f1=0,_tmp479->f2=field_tag_exp;_tmp479;});_tmp478[0]=_tmp9CF;}),({struct _tuple20*_tmp9CE=({struct _tuple20*_tmp47A=_cycalloc(sizeof(*_tmp47A));_tmp47A->f1=0,_tmp47A->f2=fieldexp;_tmp47A;});_tmp478[1]=_tmp9CE;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp478,sizeof(struct _tuple20*),2U));});struct Cyc_List_List*newdles=_tmp476;
struct Cyc_Absyn_Exp*umem=Cyc_Absyn_unresolvedmem_exp(0,newdles,0U);
({void*_tmp9D1=Cyc_Toc_unresolvedmem_exp_r(0,({struct _tuple20*_tmp477[1U];({struct _tuple20*_tmp9D0=Cyc_Toc_make_field(field->name,umem);_tmp477[0]=_tmp9D0;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp477,sizeof(struct _tuple20*),1U));}));e->r=_tmp9D1;});}}}else{
# 2676
...
fieldexp=({void*_tmp9D2=fieldtyp;Cyc_Toc_cast_it(_tmp9D2,Cyc_Absyn_copy_exp(fieldexp));});}
newdles=({struct Cyc_List_List*_tmp485=_cycalloc(sizeof(*_tmp485));({struct _tuple20*_tmp9D3=({struct _tuple20*_tmp484=_cycalloc(sizeof(*_tmp484));_tmp484->f1=0,_tmp484->f2=fieldexp;_tmp484;});_tmp485->hd=_tmp9D3;}),_tmp485->tl=newdles;_tmp485;});
break;}}}}
# 2695
({void*_tmp9D4=Cyc_Toc_unresolvedmem_exp_r(0,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(newdles));e->r=_tmp9D4;});}}
# 2698
goto _LL7;}}}}case 31U: _LL4C: _tmp303=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp304=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_tmp305=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp2F7)->f3;_LL4D: {struct Cyc_List_List*es=_tmp303;struct Cyc_Absyn_Datatypedecl*tud=_tmp304;struct Cyc_Absyn_Datatypefield*tuf=_tmp305;
# 2702
...
({void*_tmp9D5=(Cyc_Toc_cast_it(field_typ,cur_e))->r;cur_e->r=_tmp9D5;});}}{
# 2713
...
struct Cyc_List_List*dles=0;
{int i=1;for(0;es != 0;(es=es->tl,++ i)){
dles=({struct Cyc_List_List*_tmp48A=_cycalloc(sizeof(*_tmp48A));({struct _tuple20*_tmp9D7=({struct _fat_ptr*_tmp9D6=Cyc_Absyn_fieldname(i);Cyc_Toc_make_field(_tmp9D6,(struct Cyc_Absyn_Exp*)es->hd);});_tmp48A->hd=_tmp9D7;}),_tmp48A->tl=dles;_tmp48A;});}}{
# 2724
struct _tuple20*_tmp48B=Cyc_Toc_make_field(Cyc_Toc_tag_sp,tag_exp);struct _tuple20*tag_dle=_tmp48B;
({void*_tmp9DB=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp48D=_cycalloc(sizeof(*_tmp48D));_tmp48D->tag=29U,({struct _tuple1*_tmp9DA=Cyc_Toc_collapse_qvars(tuf->name,tud->name);_tmp48D->f1=_tmp9DA;}),_tmp48D->f2=0,({
struct Cyc_List_List*_tmp9D9=({struct Cyc_List_List*_tmp48C=_cycalloc(sizeof(*_tmp48C));_tmp48C->hd=tag_dle,({struct Cyc_List_List*_tmp9D8=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);_tmp48C->tl=_tmp9D8;});_tmp48C;});_tmp48D->f3=_tmp9D9;}),_tmp48D->f4=0;_tmp48D;});
# 2725
e->r=_tmp9DB;});}}else{
# 2730
struct Cyc_List_List*_tmp48E=0;struct Cyc_List_List*dles=_tmp48E;
for(0;es != 0;es=es->tl){
dles=({struct Cyc_List_List*_tmp490=_cycalloc(sizeof(*_tmp490));({struct _tuple20*_tmp9DC=({struct _tuple20*_tmp48F=_cycalloc(sizeof(*_tmp48F));_tmp48F->f1=0,_tmp48F->f2=(struct Cyc_Absyn_Exp*)es->hd;_tmp48F;});_tmp490->hd=_tmp9DC;}),_tmp490->tl=dles;_tmp490;});}
({void*_tmp9DF=Cyc_Toc_unresolvedmem_exp_r(0,({struct Cyc_List_List*_tmp492=_cycalloc(sizeof(*_tmp492));({struct _tuple20*_tmp9DE=({struct _tuple20*_tmp491=_cycalloc(sizeof(*_tmp491));_tmp491->f1=0,_tmp491->f2=tag_exp;_tmp491;});_tmp492->hd=_tmp9DE;}),({
struct Cyc_List_List*_tmp9DD=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);_tmp492->tl=_tmp9DD;});_tmp492;}));
# 2733
e->r=_tmp9DF;});}
# 2736
...
struct Cyc_Absyn_Exp*_tmp9E0=Cyc_Absyn_sizeoftype_exp(t_c,0U);_tmp493[1]=_tmp9E0;}),_tmp493[2]=num_elts2;({struct Cyc_Absyn_Exp*_tmp9E1=Cyc_Toc__region_calloc_e;Cyc_Toc_fncall_exp_dl(_tmp9E1,_tag_fat(_tmp493,sizeof(struct Cyc_Absyn_Exp*),3U));});});}else{
# 2757
pexp=({void*_tmp9E3=*topt;struct Cyc_Absyn_Exp*_tmp9E2=Cyc_Absyn_sizeoftype_exp(t_c,0U);Cyc_Toc_calloc_exp(_tmp9E3,_tmp9E2,num_elts2);});}}else{
# 2759
if(rgnopt != 0 && !Cyc_Absyn_no_regions){
Cyc_Toc_exp_to_c(nv,rgnopt);
if(inline_call)
...
struct Cyc_Absyn_Exp*rexp=({struct Cyc_Absyn_Exp*_tmp494[3U];_tmp494[0]=pexp,_tmp494[1]=elt_sz,_tmp494[2]=num_elts2;({struct Cyc_Absyn_Exp*_tmp9E4=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_dl(_tmp9E4,_tag_fat(_tmp494,sizeof(struct Cyc_Absyn_Exp*),3U));});});
struct Cyc_Absyn_Stmt*s=({struct _tuple1*_tmp9E7=(struct _tuple1*)_check_null(x);void*_tmp9E6=Cyc_Absyn_uint_type;struct Cyc_Absyn_Exp*_tmp9E5=num_elts;Cyc_Absyn_declare_stmt(_tmp9E7,_tmp9E6,_tmp9E5,
Cyc_Absyn_exp_stmt(rexp,0U),0U);});
({void*_tmp9E8=Cyc_Toc_stmt_exp_r(s);e->r=_tmp9E8;});}else{
# 2775
e->r=pexp->r;}
goto _LL7;}}case 35U: _LL54: _tmp2FB=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp2FC=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL55: {struct Cyc_Absyn_Exp*e1=_tmp2FB;struct Cyc_Absyn_Exp*e2=_tmp2FC;
# 2785
void*e1_old_typ=(void*)_check_null(e1->topt);
void*e2_old_typ=(void*)_check_null(e2->topt);
if(!Cyc_Tcutil_is_boxed(e1_old_typ)&& !Cyc_Tcutil_is_pointer_type(e1_old_typ))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp496=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7DE;_tmp7DE.tag=0U,({struct _fat_ptr _tmp9E9=({const char*_tmp497="Swap_e: is_pointer_or_boxed: not a pointer or boxed type";_tag_fat(_tmp497,sizeof(char),57U);});_tmp7DE.f1=_tmp9E9;});_tmp7DE;});void*_tmp495[1U];_tmp495[0]=& _tmp496;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp495,sizeof(void*),1U));});{
# 2793
...
# 2799
struct Cyc_Absyn_Exp*_tmp49D=({struct Cyc_Absyn_Exp*_tmp9EB=Cyc_Tcutil_deep_copy_exp(1,e1);struct Cyc_Absyn_Exp*_tmp9EA=v2e;Cyc_Absyn_assign_exp(_tmp9EB,_tmp9EA,loc);});struct Cyc_Absyn_Exp*s1e=_tmp49D;s1e->topt=e1_old_typ;{
struct Cyc_Absyn_Stmt*_tmp49E=Cyc_Absyn_exp_stmt(s1e,loc);struct Cyc_Absyn_Stmt*s1=_tmp49E;
struct Cyc_Absyn_Exp*_tmp49F=({struct Cyc_Absyn_Exp*_tmp9ED=Cyc_Tcutil_deep_copy_exp(1,e2);struct Cyc_Absyn_Exp*_tmp9EC=v1e;Cyc_Absyn_assign_exp(_tmp9ED,_tmp9EC,loc);});struct Cyc_Absyn_Exp*s2e=_tmp49F;s2e->topt=e2_old_typ;{
struct Cyc_Absyn_Stmt*_tmp4A0=Cyc_Absyn_exp_stmt(s2e,loc);struct Cyc_Absyn_Stmt*s2=_tmp4A0;
# 2804
struct Cyc_Absyn_Stmt*_tmp4A1=({struct _tuple1*_tmp9F5=v1;void*_tmp9F4=e1_old_typ;struct Cyc_Absyn_Exp*_tmp9F3=e1;struct Cyc_Absyn_Stmt*_tmp9F2=({
struct _tuple1*_tmp9F1=v2;void*_tmp9F0=e2_old_typ;struct Cyc_Absyn_Exp*_tmp9EF=e2;struct Cyc_Absyn_Stmt*_tmp9EE=
Cyc_Absyn_seq_stmt(s1,s2,loc);
# 2805
Cyc_Absyn_declare_stmt(_tmp9F1,_tmp9F0,_tmp9EF,_tmp9EE,loc);});
# 2804
Cyc_Absyn_declare_stmt(_tmp9F5,_tmp9F4,_tmp9F3,_tmp9F2,loc);});struct Cyc_Absyn_Stmt*s=_tmp4A1;
# 2807
Cyc_Toc_stmt_to_c(nv,s);
({void*_tmp9F6=Cyc_Toc_stmt_exp_r(s);e->r=_tmp9F6;});
goto _LL7;}}}}}}case 38U: _LL56: _tmp2F9=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_tmp2FA=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp2F7)->f2;_LL57: {struct Cyc_Absyn_Exp*e1=_tmp2F9;struct _fat_ptr*f=_tmp2FA;
# 2812
void*_tmp4A2=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*e1_typ=_tmp4A2;
Cyc_Toc_exp_to_c(nv,e1);
{void*_tmp4A3=e1_typ;struct Cyc_Absyn_Aggrdecl*_tmp4A4;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4A3)->tag == 0U){if(((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4A3)->f1)->tag == 20U){if(((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4A3)->f1)->f1).KnownAggr).tag == 2){_LL11C: _tmp4A4=*((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4A3)->f1)->f1).KnownAggr).val;_LL11D: {struct Cyc_Absyn_Aggrdecl*ad=_tmp4A4;
# 2816
...
({void*_tmp9F7=(Cyc_Absyn_eq_exp(e1_f_tag,f_tag,0U))->r;e->r=_tmp9F7;});
goto _LL11B;}}else{goto _LL11E;}}else{goto _LL11E;}}else{_LL11E: _LL11F:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4A9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7DF;_tmp7DF.tag=0U,({struct _fat_ptr _tmp9F8=({const char*_tmp4AA="non-aggregate type in tagcheck";_tag_fat(_tmp4AA,sizeof(char),31U);});_tmp7DF.f1=_tmp9F8;});_tmp7DF;});void*_tmp4A8[1U];_tmp4A8[0]=& _tmp4A9;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4A8,sizeof(void*),1U));});}_LL11B:;}
# 2823
goto _LL7;}case 37U: _LL58: _tmp2F8=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp2F7)->f1;_LL59: {struct Cyc_Absyn_Stmt*s=_tmp2F8;
Cyc_Toc_stmt_to_c(nv,s);goto _LL7;}case 36U: _LL5A: _LL5B:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4AC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E0;_tmp7E0.tag=0U,({struct _fat_ptr _tmp9F9=({const char*_tmp4AD="UnresolvedMem";_tag_fat(_tmp4AD,sizeof(char),14U);});_tmp7E0.f1=_tmp9F9;});_tmp7E0;});void*_tmp4AB[1U];_tmp4AB[0]=& _tmp4AC;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4AB,sizeof(void*),1U));});case 25U: _LL5C: _LL5D:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4AF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E1;_tmp7E1.tag=0U,({struct _fat_ptr _tmp9FA=({const char*_tmp4B0="compoundlit";_tag_fat(_tmp4B0,sizeof(char),12U);});_tmp7E1.f1=_tmp9FA;});_tmp7E1;});void*_tmp4AE[1U];_tmp4AE[0]=& _tmp4AF;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4AE,sizeof(void*),1U));});case 39U: _LL5E: _LL5F:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4B2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E2;_tmp7E2.tag=0U,({struct _fat_ptr _tmp9FB=({const char*_tmp4B3="valueof(-)";_tag_fat(_tmp4B3,sizeof(char),11U);});_tmp7E2.f1=_tmp9FB;});_tmp7E2;});void*_tmp4B1[1U];_tmp4B1[0]=& _tmp4B2;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4B1,sizeof(void*),1U));});default: _LL60: _LL61:
 goto _LL7;}_LL7:;}
# 2830
if(!did_inserted_checks)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4B5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E4;_tmp7E4.tag=0U,({struct _fat_ptr _tmp9FC=({const char*_tmp4B7="Toc did not examine an inserted check: ";_tag_fat(_tmp4B7,sizeof(char),40U);});_tmp7E4.f1=_tmp9FC;});_tmp7E4;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp4B6=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp7E3;_tmp7E3.tag=4U,_tmp7E3.f1=e;_tmp7E3;});void*_tmp4B4[2U];_tmp4B4[0]=& _tmp4B5,_tmp4B4[1]=& _tmp4B6;({unsigned _tmp9FD=e->loc;((int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2)(_tmp9FD,_tag_fat(_tmp4B4,sizeof(void*),2U));});});}}struct _tuple36{int f1;struct _fat_ptr*f2;struct _fat_ptr*f3;struct Cyc_Absyn_Switch_clause*f4;};
# 2858 "toc.cyc"
static struct _tuple36*Cyc_Toc_gen_labels(struct _RegionHandle*r,struct Cyc_Absyn_Switch_clause*sc){
# 2860
return({struct _tuple36*_tmp4B8=_region_malloc(r,sizeof(*_tmp4B8));_tmp4B8->f1=0,({struct _fat_ptr*_tmp9FF=Cyc_Toc_fresh_label();_tmp4B8->f2=_tmp9FF;}),({struct _fat_ptr*_tmp9FE=Cyc_Toc_fresh_label();_tmp4B8->f3=_tmp9FE;}),_tmp4B8->f4=sc;_tmp4B8;});}
# 2866
...
# 2877
 ...
 goto _LL0;default: _LL7: _LL8:
 v=({void*_tmpA00=Cyc_Toc_typ_to_c_array(t);Cyc_Toc_cast_it(_tmpA00,v);});goto _LL0;}_LL0:;}{
# 2883
...
# 2895
ps=ps->tl;
v=({void*_tmpA02=({void*_tmpA01=Cyc_Absyn_strctq(Cyc_Toc_collapse_qvars(tuf->name,tud->name));Cyc_Absyn_cstar_type(_tmpA01,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpA02,v);});
v=({struct Cyc_Absyn_Exp*_tmpA03=v;Cyc_Absyn_aggrarrow_exp(_tmpA03,Cyc_Absyn_fieldname((int)(i + (unsigned)1)),0U);});
...
v=({struct Cyc_Absyn_Exp*_tmpA04=v;Cyc_Toc_member_exp(_tmpA04,Cyc_Absyn_fieldname((int)(i + (unsigned)1)),0U);});goto _LL9;}default: _LL12: _tmp4BF=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp4BE)->f1;_tmp4C0=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp4BE)->f2;_LL13: {int tagged=_tmp4BF;struct _fat_ptr*f=_tmp4C0;
# 2907
...
return e == 0?v: e;}case 1U: _LL3: _LL4:
 return({struct Cyc_Absyn_Exp*_tmpA05=v;Cyc_Absyn_eq_exp(_tmpA05,Cyc_Absyn_signed_int_exp(0,0U),0U);});case 2U: _LL5: _LL6:
 return({struct Cyc_Absyn_Exp*_tmpA06=v;Cyc_Absyn_neq_exp(_tmpA06,Cyc_Absyn_signed_int_exp(0,0U),0U);});case 3U: _LL7: _tmp4D5=((struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*)_tmp4C8)->f1;_tmp4D6=((struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*)_tmp4C8)->f2;_LL8: {struct Cyc_Absyn_Enumdecl*ed=_tmp4D5;struct Cyc_Absyn_Enumfield*ef=_tmp4D6;
return({struct Cyc_Absyn_Exp*_tmpA07=v;Cyc_Absyn_eq_exp(_tmpA07,Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmp4D8=_cycalloc(sizeof(*_tmp4D8));_tmp4D8->tag=32U,_tmp4D8->f1=ed,_tmp4D8->f2=ef;_tmp4D8;}),0U),0U);});}case 4U: _LL9: _tmp4D3=(void*)((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp4C8)->f1;_tmp4D4=((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp4C8)->f2;_LLA: {void*t=_tmp4D3;struct Cyc_Absyn_Enumfield*ef=_tmp4D4;
return({struct Cyc_Absyn_Exp*_tmpA08=v;Cyc_Absyn_eq_exp(_tmpA08,Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmp4D9=_cycalloc(sizeof(*_tmp4D9));_tmp4D9->tag=33U,_tmp4D9->f1=t,_tmp4D9->f2=ef;_tmp4D9;}),0U),0U);});}case 5U: _LLB: _tmp4D1=((struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*)_tmp4C8)->f1;_tmp4D2=((struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*)_tmp4C8)->f2;_LLC: {struct _fat_ptr s=_tmp4D1;int i=_tmp4D2;
return({struct Cyc_Absyn_Exp*_tmpA09=v;Cyc_Absyn_eq_exp(_tmpA09,Cyc_Absyn_float_exp(s,i,0U),0U);});}case 6U: _LLD: _tmp4D0=((struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*)_tmp4C8)->f1;_LLE: {unsigned i=_tmp4D0;
return({struct Cyc_Absyn_Exp*_tmpA0A=v;Cyc_Absyn_eq_exp(_tmpA0A,Cyc_Absyn_signed_int_exp((int)i,0U),0U);});}case 7U: _LLF: _tmp4CD=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp4C8)->f1;_tmp4CE=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp4C8)->f2;_tmp4CF=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp4C8)->f3;_LL10: {int i=_tmp4CD;struct Cyc_Absyn_Datatypedecl*tud=_tmp4CE;struct Cyc_Absyn_Datatypefield*tuf=_tmp4CF;
# 2930
LOOP1: {
...
v=e;goto _LL15;}default: _LL1A: _LL1B:
 goto _LL15;}_LL15:;}
# 2937
v=({void*_tmpA0C=({void*_tmpA0B=Cyc_Absyn_strctq(Cyc_Toc_collapse_qvars(tuf->name,tud->name));Cyc_Absyn_cstar_type(_tmpA0B,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpA0C,v);});return({struct Cyc_Absyn_Exp*_tmpA0D=Cyc_Absyn_aggrarrow_exp(v,Cyc_Toc_tag_sp,0U);Cyc_Absyn_eq_exp(_tmpA0D,Cyc_Absyn_uint_exp((unsigned)i,0U),0U);});}case 8U: _LL11: _tmp4CB=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp4C8)->f1;_tmp4CC=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp4C8)->f2;_LL12: {struct _fat_ptr*f=_tmp4CB;int i=_tmp4CC;
# 2941
return({struct Cyc_Absyn_Exp*_tmpA0F=({struct Cyc_Absyn_Exp*_tmpA0E=Cyc_Toc_member_exp(v,f,0U);Cyc_Toc_member_exp(_tmpA0E,Cyc_Toc_tag_sp,0U);});Cyc_Absyn_eq_exp(_tmpA0F,
...
return({struct Cyc_Absyn_Exp*_tmpA12=Cyc_Absyn_aggrarrow_exp(v,Cyc_Toc_tag_sp,0U);Cyc_Absyn_eq_exp(_tmpA12,Cyc_Absyn_var_exp(tuf->name,0U),0U);});}}_LL0:;}struct Cyc_Toc_OtherTest_Toc_TestKind_struct{int tag;};struct Cyc_Toc_DatatypeTagTest_Toc_TestKind_struct{int tag;};struct Cyc_Toc_WhereTest_Toc_TestKind_struct{int tag;struct Cyc_Absyn_Exp*f1;};struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct{int tag;struct _fat_ptr*f1;};
# 2964
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E8;_tmp7E8.tag=0U,({struct _fat_ptr _tmpA13=({const char*_tmp4F6="compile_pat_test_as_case!";_tag_fat(_tmp4F6,sizeof(char),26U);});_tmp7E8.f1=_tmpA13;});_tmp7E8;});void*_tmp4F4[1U];_tmp4F4[0]=& _tmp4F5;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4F4,sizeof(void*),1U));});}_LL0:;}
# 3011
...
# 3038
struct Cyc_Absyn_Vardecl*_tmp509=({struct _tuple1*_tmpA14=Cyc_Toc_temp_var();Cyc_Absyn_new_vardecl(0U,_tmpA14,Cyc_Toc_typ_to_c_array(vd->type),0);});struct Cyc_Absyn_Vardecl*new_vd=_tmp509;
({struct Cyc_List_List*_tmpA16=({struct Cyc_List_List*_tmp50B=_region_malloc(rgn,sizeof(*_tmp50B));({struct _tuple38*_tmpA15=({struct _tuple38*_tmp50A=_region_malloc(rgn,sizeof(*_tmp50A));_tmp50A->f1=vd,_tmp50A->f2=new_vd;_tmp50A;});_tmp50B->hd=_tmpA15;}),_tmp50B->tl=*decls;_tmp50B;});*decls=_tmpA16;});{
struct Cyc_Absyn_Stmt*_tmp50C=({struct Cyc_Absyn_Exp*_tmpA17=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp50D=_cycalloc(sizeof(*_tmp50D));_tmp50D->tag=4U,_tmp50D->f1=new_vd;_tmp50D;}),0U);Cyc_Absyn_assign_stmt(_tmpA17,Cyc_Absyn_copy_exp(path),0U);});struct Cyc_Absyn_Stmt*s=_tmp50C;
return({struct Cyc_Absyn_Stmt*_tmpA18=s;Cyc_Toc_seq_stmt_opt(_tmpA18,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,path,p2));});}}case 4U: _LL5: _tmp504=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp4F9)->f2;_LL6: {struct Cyc_Absyn_Vardecl*vd=_tmp504;
# 3044
struct Cyc_Absyn_Vardecl*_tmp50E=({struct _tuple1*_tmpA19=Cyc_Toc_temp_var();Cyc_Absyn_new_vardecl(0U,_tmpA19,Cyc_Toc_typ_to_c_array(vd->type),0);});struct Cyc_Absyn_Vardecl*new_vd=_tmp50E;
({struct Cyc_List_List*_tmpA1B=({struct Cyc_List_List*_tmp510=_region_malloc(rgn,sizeof(*_tmp510));({struct _tuple38*_tmpA1A=({struct _tuple38*_tmp50F=_region_malloc(rgn,sizeof(*_tmp50F));_tmp50F->f1=vd,_tmp50F->f2=new_vd;_tmp50F;});_tmp510->hd=_tmpA1A;}),_tmp510->tl=*decls;_tmp510;});*decls=_tmpA1B;});
return({struct Cyc_Absyn_Exp*_tmpA1C=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp511=_cycalloc(sizeof(*_tmp511));_tmp511->tag=4U,_tmp511->f1=new_vd;_tmp511;}),0U);Cyc_Absyn_assign_stmt(_tmpA1C,Cyc_Absyn_copy_exp(path),0U);});}case 0U: _LL7: _LL8:
...
# 3050
({void*_tmpA1D=Cyc_Absyn_cstar_type(t,Cyc_Toc_mt_tq);vd->type=_tmpA1D;});{
struct Cyc_Absyn_Vardecl*_tmp512=({struct _tuple1*_tmpA1E=Cyc_Toc_temp_var();Cyc_Absyn_new_vardecl(0U,_tmpA1E,Cyc_Toc_typ_to_c_array(vd->type),0);});struct Cyc_Absyn_Vardecl*new_vd=_tmp512;
({struct Cyc_List_List*_tmpA20=({struct Cyc_List_List*_tmp514=_region_malloc(rgn,sizeof(*_tmp514));({struct _tuple38*_tmpA1F=({struct _tuple38*_tmp513=_region_malloc(rgn,sizeof(*_tmp513));_tmp513->f1=vd,_tmp513->f2=new_vd;_tmp513;});_tmp514->hd=_tmpA1F;}),_tmp514->tl=*decls;_tmp514;});*decls=_tmpA20;});{
# 3054
struct Cyc_Absyn_Stmt*_tmp515=({struct Cyc_Absyn_Exp*_tmpA23=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp516=_cycalloc(sizeof(*_tmp516));_tmp516->tag=4U,_tmp516->f1=new_vd;_tmp516;}),0U);Cyc_Absyn_assign_stmt(_tmpA23,({
void*_tmpA22=({void*_tmpA21=Cyc_Toc_typ_to_c_array(t);Cyc_Absyn_cstar_type(_tmpA21,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpA22,
Cyc_Toc_push_address_exp(Cyc_Absyn_copy_exp(path)));}),0U);});
# 3054
struct Cyc_Absyn_Stmt*s=_tmp515;
# 3057
return({struct Cyc_Absyn_Stmt*_tmpA24=s;Cyc_Toc_seq_stmt_opt(_tmpA24,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,path,p2));});}}}case 9U: _LLB: _LLC:
# 3059
...
void*_tmp517=({void*_tmpA25=Cyc_Absyn_strctq(tufstrct);Cyc_Absyn_cstar_type(_tmpA25,Cyc_Toc_mt_tq);});void*field_ptr_typ=_tmp517;
...
struct Cyc_Absyn_Exp*_tmp51D=({struct Cyc_Absyn_Exp*_tmpA26=path;Cyc_Absyn_aggrarrow_exp(_tmpA26,Cyc_Absyn_fieldname(cnt),0U);});struct Cyc_Absyn_Exp*arrow_exp=_tmp51D;
if(Cyc_Toc_is_void_star_or_boxed_tvar(Cyc_Toc_typ_to_c(tuf_typ)))
arrow_exp=Cyc_Toc_cast_it(t2c,arrow_exp);
s=({struct Cyc_Absyn_Stmt*_tmpA27=s;Cyc_Toc_seq_stmt_opt(_tmpA27,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,arrow_exp,p2));});}}
# 3086
...
# 3131
return({struct _RegionHandle*_tmpA2B=rgn;struct Cyc_Toc_Env**_tmpA2A=nv;struct Cyc_List_List**_tmpA29=decls;struct Cyc_Absyn_Exp*_tmpA28=Cyc_Absyn_deref_exp(path,0U);Cyc_Toc_extract_pattern_vars(_tmpA2B,_tmpA2A,_tmpA29,_tmpA28,p2);});}}case 8U: _LL19: _tmp4FD=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp4F9)->f3;_LL1A: {struct Cyc_List_List*ps=_tmp4FD;
# 3088
...
s=({struct Cyc_Absyn_Stmt*_tmpA30=s;Cyc_Toc_seq_stmt_opt(_tmpA30,({struct _RegionHandle*_tmpA2F=rgn;struct Cyc_Toc_Env**_tmpA2E=nv;struct Cyc_List_List**_tmpA2D=decls;struct Cyc_Absyn_Exp*_tmpA2C=Cyc_Toc_member_exp(path,f,0U);Cyc_Toc_extract_pattern_vars(_tmpA2F,_tmpA2E,_tmpA2D,_tmpA2C,p2);}));});}}
# 3100
return s;}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp4F9)->f1 == 0){_LL1D: _LL1E:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp522=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E9;_tmp7E9.tag=0U,({struct _fat_ptr _tmpA31=({const char*_tmp523="unresolved aggregate pattern!";_tag_fat(_tmp523,sizeof(char),30U);});_tmp7E9.f1=_tmpA31;});_tmp7E9;});void*_tmp521[1U];_tmp521[0]=& _tmp522;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp521,sizeof(void*),1U));});}else{_LL1F: _tmp4FA=*((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp4F9)->f1;_tmp4FB=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp4F9)->f3;_LL20: {union Cyc_Absyn_AggrInfo info=_tmp4FA;struct Cyc_List_List*dlps=_tmp4FB;
# 3104
...
# 3123
memexp=Cyc_Absyn_deref_exp(({void*_tmpA32=Cyc_Absyn_cstar_type(t2c,Cyc_Toc_mt_tq);Cyc_Toc_cast_it(_tmpA32,
Cyc_Absyn_address_exp(memexp,0U));}),0U);}
# 3126
s=({struct Cyc_Absyn_Stmt*_tmpA33=s;Cyc_Toc_seq_stmt_opt(_tmpA33,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,memexp,p2));});}}}
# 3128
return s;}}case 15U: _LL23: _LL24:
# 3133
({struct Cyc_Warn_String_Warn_Warg_struct _tmp52D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7EA;_tmp7EA.tag=0U,({struct _fat_ptr _tmpA34=({const char*_tmp52E="unknownid pat";_tag_fat(_tmp52E,sizeof(char),14U);});_tmp7EA.f1=_tmpA34;});_tmp7EA;});void*_tmp52C[1U];_tmp52C[0]=& _tmp52D;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp52C,sizeof(void*),1U));});case 16U: _LL25: _LL26:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp530=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7EB;_tmp7EB.tag=0U,({struct _fat_ptr _tmpA35=({const char*_tmp531="unknowncall pat";_tag_fat(_tmp531,sizeof(char),16U);});_tmp7EB.f1=_tmpA35;});_tmp7EB;});void*_tmp52F[1U];_tmp52F[0]=& _tmp530;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp52F,sizeof(void*),1U));});default: _LL27: _LL28:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp533=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7EC;_tmp7EC.tag=0U,({struct _fat_ptr _tmpA36=({const char*_tmp534="exp pat";_tag_fat(_tmp534,sizeof(char),8U);});_tmp7EC.f1=_tmpA36;});_tmp7EC;});void*_tmp532[1U];_tmp532[0]=& _tmp533;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp532,sizeof(void*),1U));});}_LL0:;}
# 3139
...
# 3144
({void*_tmp539=0U;({struct _fat_ptr _tmpA37=({const char*_tmp53A="find_new_var";_tag_fat(_tmp53A,sizeof(char),13U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Toc_toc_impos)(_tmpA37,_tag_fat(_tmp539,sizeof(void*),0U));});});}
# 3150
...
({void*_tmpA3A=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp568=_cycalloc(sizeof(*_tmp568));_tmp568->tag=1U,({void*_tmpA39=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp567=_cycalloc(sizeof(*_tmp567));_tmp567->tag=4U,({struct Cyc_Absyn_Vardecl*_tmpA38=((struct Cyc_Absyn_Vardecl*(*)(struct Cyc_List_List*l,struct Cyc_Absyn_Vardecl*k))Cyc_List_assoc)(env,vd);_tmp567->f1=_tmpA38;});_tmp567;});_tmp568->f1=_tmpA39;});_tmp568;});e->r=_tmpA3A;});;_pop_handler();}else{void*_tmp565=(void*)Cyc_Core_get_exn_thrown();void*_tmp569=_tmp565;void*_tmp56A;if(((struct Cyc_Core_Not_found_exn_struct*)_tmp569)->tag == Cyc_Core_Not_found){_LL40: _LL41:
# 3157
...
# 3230
struct Cyc_Absyn_Stmt*init_opt=({struct _RegionHandle*_tmpA3C=rgn;struct Cyc_Absyn_Exp*_tmpA3B=
Cyc_Absyn_var_exp(v,0U);
# 3230
Cyc_Toc_extract_pattern_vars(_tmpA3C,& nv,& newdecls,_tmpA3B,sc->pattern);});
# 3234
...
({struct Cyc_List_List*_tmpA3E=({struct Cyc_List_List*_tmp580=_region_malloc(rgn,sizeof(*_tmp580));({struct _tuple38*_tmpA3D=({struct _tuple38*_tmp57F=_region_malloc(rgn,sizeof(*_tmp57F));_tmp57F->f1=oldv,_tmp57F->f2=newv;_tmp57F;});_tmp580->hd=_tmpA3D;}),_tmp580->tl=*decls;_tmp580;});*decls=_tmpA3E;});
({struct Cyc_Absyn_Exp*_tmpA3F=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp581=_cycalloc(sizeof(*_tmp581));_tmp581->tag=4U,_tmp581->f1=newv;_tmp581;}),0U);oldv->initializer=_tmpA3F;});
((struct Cyc_Absyn_Exp*)_check_null(oldv->initializer))->topt=newv->type;
oldv->type=newv->type;
res=({struct Cyc_Absyn_Decl*_tmpA41=({struct Cyc_Absyn_Decl*_tmp583=_cycalloc(sizeof(*_tmp583));({void*_tmpA40=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp582=_cycalloc(sizeof(*_tmp582));_tmp582->tag=0U,_tmp582->f1=oldv;_tmp582;});_tmp583->r=_tmpA40;}),_tmp583->loc=0U;_tmp583;});Cyc_Absyn_decl_stmt(_tmpA41,res,0U);});}}}
# 3243
res=Cyc_Absyn_label_stmt(code_lab,res,0U);
if(init_opt != 0)
res=Cyc_Absyn_seq_stmt(init_opt,res,0U);
res=Cyc_Absyn_label_stmt(init_lab,res,0U);
({struct Cyc_List_List*_tmpA43=({struct Cyc_List_List*_tmp585=_region_malloc(rgn,sizeof(*_tmp585));({struct _tuple40*_tmpA42=({struct _tuple40*_tmp584=_region_malloc(rgn,sizeof(*_tmp584));_tmp584->f1=nv,_tmp584->f2=code_lab,_tmp584->f3=body;_tmp584;});_tmp585->hd=_tmpA42;}),_tmp585->tl=*bodies;_tmp585;});*bodies=_tmpA43;});
return res;}}}}
# 3251
({struct Cyc_Warn_String_Warn_Warg_struct _tmp587=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7ED;_tmp7ED.tag=0U,({struct _fat_ptr _tmpA44=({const char*_tmp588="couldn't find rhs!";_tag_fat(_tmp588,sizeof(char),19U);});_tmp7ED.f1=_tmpA44;});_tmp7ED;});void*_tmp586[1U];_tmp586[0]=& _tmp587;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp586,sizeof(void*),1U));});}default: _LL7: _tmp56F=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp56E)->f1;_tmp570=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp56E)->f2;_tmp571=(void*)((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp56E)->f3;_LL8: {struct Cyc_List_List*symbolic_path=_tmp56F;struct Cyc_List_List*switches=_tmp570;void*other_decision=_tmp571;
# 3254
struct Cyc_Absyn_Stmt*res=Cyc_Toc_compile_decision_tree(rgn,nv,decls,bodies,other_decision,lscs,v);
# 3256
struct Cyc_Absyn_Exp*_tmp589=({struct Cyc_List_List*_tmpA45=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(symbolic_path);Cyc_Toc_compile_path(_tmpA45,Cyc_Absyn_var_exp(v,0U));});struct Cyc_Absyn_Exp*p=_tmp589;
...
({struct Cyc_Absyn_Switch_clause*_tmpA47=({struct Cyc_Absyn_Switch_clause*_tmp59E=_cycalloc(sizeof(*_tmp59E));({struct Cyc_Absyn_Pat*_tmpA46=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0U);_tmp59E->pattern=_tmpA46;}),_tmp59E->pat_vars=0,_tmp59E->where_clause=0,_tmp59E->body=res,_tmp59E->loc=0U;_tmp59E;});_tmp59F->hd=_tmpA47;}),_tmp59F->tl=0;_tmp59F;});
# 3266
for(0;ss != 0;ss=ss->tl){
...
# 3273
new_lscs=({struct Cyc_List_List*_tmp596=_cycalloc(sizeof(*_tmp596));({struct Cyc_Absyn_Switch_clause*_tmpA48=({struct Cyc_Absyn_Switch_clause*_tmp595=_cycalloc(sizeof(*_tmp595));_tmp595->pattern=case_exp,_tmp595->pat_vars=0,_tmp595->where_clause=0,_tmp595->body=s,_tmp595->loc=0U;_tmp595;});_tmp596->hd=_tmpA48;}),_tmp596->tl=new_lscs;_tmp596;});}}
# 3275
...
p=e;goto _LL1E;}default: _LL23: _LL24:
 goto _LL1E;}_LL1E:;}
# 3283
p=Cyc_Absyn_deref_exp(({void*_tmpA49=Cyc_Absyn_cstar_type(Cyc_Absyn_sint_type,Cyc_Toc_mt_tq);Cyc_Toc_cast_it(_tmpA49,p);}),0U);goto _LL15;case 3U: _LL18: _tmp598=((struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct*)_tmp597)->f1;_LL19: {struct _fat_ptr*f=_tmp598;
# 3285
p=({struct Cyc_Absyn_Exp*_tmpA4A=Cyc_Toc_member_exp(p,f,0U);Cyc_Toc_member_exp(_tmpA4A,Cyc_Toc_tag_sp,0U);});goto _LL15;}case 2U: _LL1A: _LL1B:
...
struct Cyc_List_List*newdecls=0;
# 3311
struct Cyc_Absyn_Stmt*init_opt=({struct _RegionHandle*_tmpA4C=rgn;struct Cyc_Absyn_Exp*_tmpA4B=Cyc_Absyn_var_exp(v,0U);Cyc_Toc_extract_pattern_vars(_tmpA4C,& nv,& newdecls,_tmpA4B,sc->pattern);});
# 3315
...
({struct Cyc_List_List*_tmpA4E=({struct Cyc_List_List*_tmp5B2=_region_malloc(rgn,sizeof(*_tmp5B2));({struct _tuple38*_tmpA4D=({struct _tuple38*_tmp5B1=_region_malloc(rgn,sizeof(*_tmp5B1));_tmp5B1->f1=oldv,_tmp5B1->f2=newv;_tmp5B1;});_tmp5B2->hd=_tmpA4D;}),_tmp5B2->tl=*decls;_tmp5B2;});*decls=_tmpA4E;});
({struct Cyc_Absyn_Exp*_tmpA4F=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp5B3=_cycalloc(sizeof(*_tmp5B3));_tmp5B3->tag=4U,_tmp5B3->f1=newv;_tmp5B3;}),0U);oldv->initializer=_tmpA4F;});
((struct Cyc_Absyn_Exp*)_check_null(oldv->initializer))->topt=newv->type;
oldv->type=newv->type;
r=({struct Cyc_Absyn_Decl*_tmpA51=({struct Cyc_Absyn_Decl*_tmp5B5=_cycalloc(sizeof(*_tmp5B5));({void*_tmpA50=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp5B4=_cycalloc(sizeof(*_tmp5B4));_tmp5B4->tag=0U,_tmp5B4->f1=oldv;_tmp5B4;});_tmp5B5->r=_tmpA50;}),_tmp5B5->loc=0U;_tmp5B5;});Cyc_Absyn_decl_stmt(_tmpA51,r,0U);});}}}
# 3324
...
({struct Cyc_List_List*_tmpA53=({struct Cyc_List_List*_tmp5B7=_region_malloc(rgn,sizeof(*_tmp5B7));({struct _tuple40*_tmpA52=({struct _tuple40*_tmp5B6=_region_malloc(rgn,sizeof(*_tmp5B6));_tmp5B6->f1=nv,_tmp5B6->f2=code_lab,_tmp5B6->f3=body;_tmp5B6;});_tmp5B7->hd=_tmpA52;}),_tmp5B7->tl=*bodies;_tmp5B7;});*bodies=_tmpA53;});
return r;}}}}
# 3338
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5B9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7EE;_tmp7EE.tag=0U,({struct _fat_ptr _tmpA54=({const char*_tmp5BA="couldn't find rhs!";_tag_fat(_tmp5BA,sizeof(char),19U);});_tmp7EE.f1=_tmpA54;});_tmp7EE;});void*_tmp5B8[1U];_tmp5B8[0]=& _tmp5B9;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp5B8,sizeof(void*),1U));});}}else{goto _LL2D;}}else{goto _LL2D;}}else{_LL2D: _LL2E:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5BC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7EF;_tmp7EF.tag=0U,({struct _fat_ptr _tmpA55=({const char*_tmp5BD="bad where clause in match compiler";_tag_fat(_tmp5BD,sizeof(char),35U);});_tmp7EF.f1=_tmpA55;});_tmp7EF;});void*_tmp5BB[1U];_tmp5BB[0]=& _tmp5BC;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp5BB,sizeof(void*),1U));});}_LL2A:;}}else{_LL28: _LL29:
# 3343
 for(0;ss != 0;ss=ss->tl){
...
# 3417
if(next_case_env == 0)
({struct Cyc_Toc_Env*_tmpA56=Cyc_Toc_last_switchclause_env(rgn,env,end_l);Cyc_Toc_stmt_to_c(_tmpA56,s);});else{
# 3421
...
vs=({struct Cyc_List_List*_tmpA57=mydecls;((struct Cyc_List_List*(*)(struct Cyc_Absyn_Vardecl*(*f)(struct Cyc_List_List*,struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*env,struct Cyc_List_List*x))Cyc_List_map_c)((struct Cyc_Absyn_Vardecl*(*)(struct Cyc_List_List*l,struct Cyc_Absyn_Vardecl*k))Cyc_List_assoc,_tmpA57,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(vs));});}
# 3426
({struct Cyc_Toc_Env*_tmpA58=Cyc_Toc_non_last_switchclause_env(rgn,env,end_l,fallthru_lab,vs);Cyc_Toc_stmt_to_c(_tmpA58,s);});}}}else{
# 3430
({struct Cyc_Toc_Env*_tmpA59=Cyc_Toc_last_switchclause_env(rgn,env,end_l);Cyc_Toc_stmt_to_c(_tmpA59,s);});}}}}}{
# 3434
struct Cyc_Absyn_Stmt*res=({struct Cyc_Absyn_Stmt*_tmpA5B=test_tree;Cyc_Absyn_seq_stmt(_tmpA5B,({struct _fat_ptr*_tmpA5A=end_l;Cyc_Absyn_label_stmt(_tmpA5A,Cyc_Toc_skip_stmt_dl(),0U);}),0U);});
# 3436
...
res=({struct Cyc_Absyn_Decl*_tmpA5C=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp5DD=_cycalloc(sizeof(*_tmp5DD));_tmp5DD->tag=0U,_tmp5DD->f1=vd;_tmp5DD;}),0U);Cyc_Absyn_decl_stmt(_tmpA5C,res,0U);});}}
# 3441
({void*_tmpA60=({struct _tuple1*_tmpA5F=v;void*_tmpA5E=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));struct Cyc_Absyn_Exp*_tmpA5D=e;Cyc_Absyn_declare_stmt(_tmpA5F,_tmpA5E,_tmpA5D,res,0U);})->r;whole_s->r=_tmpA60;});
...
return Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmp5DE[1U];({struct Cyc_Absyn_Exp*_tmpA61=Cyc_Absyn_uint_exp((unsigned)(n - 1),0U);_tmp5DE[0]=_tmpA61;});({struct Cyc_Absyn_Exp*_tmpA62=Cyc_Toc__npop_handler_e;Cyc_Toc_fncall_exp_dl(_tmpA62,_tag_fat(_tmp5DE,sizeof(struct Cyc_Absyn_Exp*),1U));});}),0U);}
# 3459
void Cyc_Toc_do_npop_before(int n,struct Cyc_Absyn_Stmt*s){
if(n > 0)
({void*_tmpA64=({struct Cyc_Absyn_Stmt*_tmpA63=Cyc_Toc_make_npop_handler(n);Cyc_Toc_seq_stmt_r(_tmpA63,Cyc_Absyn_new_stmt(s->r,0U));});s->r=_tmpA64;});}
# 3464
static void Cyc_Toc_stmt_to_c(struct Cyc_Toc_Env*nv,struct Cyc_Absyn_Stmt*s){
# 3466
while(1){
...
({int _tmpA65=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpA65,s);});return;}else{_LL7: _tmp5FA=((struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp5E0)->f1;_LL8: {struct Cyc_Absyn_Exp*e=_tmp5FA;
# 3473
...
({void*_tmpA66=(Cyc_Absyn_declare_stmt(x,t,e,retn_stmt,0U))->r;s->r=_tmpA66;});}
# 3482
...
# 3498
Cyc_Toc_exp_to_c(nv,e);{
struct _RegionHandle _tmp5FE=_new_region("temp");struct _RegionHandle*temp=& _tmp5FE;_push_region(temp);({struct Cyc_Toc_Env*_tmpA67=Cyc_Toc_loop_env(temp,nv);Cyc_Toc_stmt_to_c(_tmpA67,s2);});
_npop_handler(0U);return;
# 3499
...
if(b != 0)
({void*_tmpA68=Cyc_Toc_goto_stmt_r(*b);s->r=_tmpA68;});
# 3506
({int _tmpA69=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpA69,s);});
...
if(c != 0)
({void*_tmpA6A=Cyc_Toc_goto_stmt_r(*c);s->r=_tmpA6A;});
goto _LL18;}}case 8U: _LL17: _LL18:
# 3514
({int _tmpA6B=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpA6B,s);});
...
if(fi == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp606=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F0;_tmp7F0.tag=0U,({struct _fat_ptr _tmpA6C=({const char*_tmp607="fallthru in unexpected place";_tag_fat(_tmp607,sizeof(char),29U);});_tmp7F0.f1=_tmpA6C;});_tmp7F0;});void*_tmp605[1U];_tmp605[0]=& _tmp606;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp605,sizeof(void*),1U));});{
...
# 3527
({int _tmpA6D=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpA6D,s2);});{
...
s2=({struct Cyc_Absyn_Stmt*_tmpA6F=({struct Cyc_Absyn_Exp*_tmpA6E=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*_tmp60E=_cycalloc(sizeof(*_tmp60E));_tmp60E->tag=5U,_tmp60E->f1=(struct Cyc_Absyn_Vardecl*)vs2->hd;_tmp60E;}),0U);Cyc_Absyn_assign_stmt(_tmpA6E,(struct Cyc_Absyn_Exp*)es2->hd,0U);});Cyc_Absyn_seq_stmt(_tmpA6F,s2,0U);});}
# 3535
s->r=s2->r;
...
# 3551
struct Cyc_Absyn_Vardecl*_tmp61D=({struct _tuple1*_tmpA71=Cyc_Toc_temp_var();void*_tmpA70=vd->type;Cyc_Absyn_new_vardecl(0U,_tmpA71,_tmpA70,e);});struct Cyc_Absyn_Vardecl*new_vd=_tmp61D;
({struct Cyc_Absyn_Exp*_tmpA72=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp61E=_cycalloc(sizeof(*_tmp61E));_tmp61E->tag=4U,_tmp61E->f1=new_vd;_tmp61E;}),0U);vd->initializer=_tmpA72;});
((struct Cyc_Absyn_Exp*)_check_null(vd->initializer))->topt=new_vd->type;
({void*_tmpA79=({struct Cyc_Absyn_Decl*_tmpA78=({void*_tmpA73=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp61F=_cycalloc(sizeof(*_tmp61F));_tmp61F->tag=0U,_tmp61F->f1=new_vd;_tmp61F;});Cyc_Absyn_new_decl(_tmpA73,s->loc);});struct Cyc_Absyn_Stmt*_tmpA77=({
struct Cyc_Absyn_Decl*_tmpA76=({void*_tmpA74=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp620=_cycalloc(sizeof(*_tmp620));_tmp620->tag=0U,_tmp620->f1=vd;_tmp620;});Cyc_Absyn_new_decl(_tmpA74,s->loc);});struct Cyc_Absyn_Stmt*_tmpA75=s1;Cyc_Absyn_decl_stmt(_tmpA76,_tmpA75,s->loc);});
# 3554
Cyc_Absyn_decl_stmt(_tmpA78,_tmpA77,s->loc);})->r;s->r=_tmpA79;});
# 3557
Cyc_Toc_stmt_to_c(nv,s);
goto _LL3C;}}else{goto _LL3F;}}else{_LL3F: _LL40:
# 3563
({void*_tmpA7A=(Cyc_Toc_letdecl_to_c(nv,p,dec_tree,(void*)_check_null(e->topt),e,s1))->r;s->r=_tmpA7A;});
goto _LL3C;}_LL3C:;}
# 3566
...
if(rvds == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp623=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F1;_tmp7F1.tag=0U,({struct _fat_ptr _tmpA7B=({const char*_tmp624="empty Letv_d";_tag_fat(_tmp624,sizeof(char),13U);});_tmp7F1.f1=_tmpA7B;});_tmp7F1;});void*_tmp622[1U];_tmp622[0]=& _tmp623;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp622,sizeof(void*),1U));});
({void*_tmpA7C=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp625=_cycalloc(sizeof(*_tmp625));_tmp625->tag=0U,_tmp625->f1=(struct Cyc_Absyn_Vardecl*)rvds->hd;_tmp625;});d->r=_tmpA7C;});
rvds=rvds->tl;
...
({void*_tmpA7E=({struct Cyc_Absyn_Decl*_tmpA7D=d2;Cyc_Absyn_decl_stmt(_tmpA7D,Cyc_Absyn_new_stmt(s->r,0U),0U);})->r;s->r=_tmpA7E;});}
# 3579
Cyc_Toc_stmt_to_c(nv,s);
...
({void*_tmpA82=({struct _tuple1*_tmpA81=x_var;void*_tmpA80=rh_struct_ptr_typ;struct Cyc_Absyn_Exp*_tmpA7F=
Cyc_Absyn_uint_exp(0U,0U);
# 3596
Cyc_Absyn_declare_stmt(_tmpA81,_tmpA80,_tmpA7F,body,0U);})->r;s->r=_tmpA82;});else{
# 3598
if((unsigned)open_exp_opt){
# 3600
Cyc_Toc_exp_to_c(nv,open_exp_opt);{
struct Cyc_Absyn_Exp*arg=Cyc_Absyn_address_exp(({struct Cyc_Absyn_Exp*_tmpA84=open_exp_opt;Cyc_Absyn_aggrarrow_exp(_tmpA84,({struct _fat_ptr*_tmp62E=_cycalloc(sizeof(*_tmp62E));({struct _fat_ptr _tmpA83=({const char*_tmp62D="h";_tag_fat(_tmp62D,sizeof(char),2U);});*_tmp62E=_tmpA83;});_tmp62E;}),0U);}),0U);
({void*_tmpA85=(Cyc_Absyn_declare_stmt(x_var,rh_struct_ptr_typ,arg,body,0U))->r;s->r=_tmpA85;});}}else{
# 3609
({void*_tmpA92=({struct _tuple1*_tmpA91=rh_var;void*_tmpA90=rh_struct_typ;struct Cyc_Absyn_Exp*_tmpA8F=({struct Cyc_Absyn_Exp*_tmp62F[1U];({struct Cyc_Absyn_Exp*_tmpA86=
Cyc_Absyn_string_exp(*(*x_var).f2,0U);_tmp62F[0]=_tmpA86;});({struct Cyc_Absyn_Exp*_tmpA87=Cyc_Toc__new_region_e;Cyc_Toc_fncall_exp_dl(_tmpA87,_tag_fat(_tmp62F,sizeof(struct Cyc_Absyn_Exp*),1U));});});
# 3609
Cyc_Absyn_declare_stmt(_tmpA91,_tmpA90,_tmpA8F,({
# 3611
struct _tuple1*_tmpA8E=x_var;void*_tmpA8D=rh_struct_ptr_typ;struct Cyc_Absyn_Exp*_tmpA8C=Cyc_Absyn_address_exp(rh_exp,0U);Cyc_Absyn_declare_stmt(_tmpA8E,_tmpA8D,_tmpA8C,({
struct Cyc_Absyn_Stmt*_tmpA8B=Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmp630[1U];_tmp630[0]=x_exp;({struct Cyc_Absyn_Exp*_tmpA88=Cyc_Toc__push_region_e;Cyc_Toc_fncall_exp_dl(_tmpA88,_tag_fat(_tmp630,sizeof(struct Cyc_Absyn_Exp*),1U));});}),0U);Cyc_Absyn_seq_stmt(_tmpA8B,({
struct Cyc_Absyn_Stmt*_tmpA8A=body;Cyc_Absyn_seq_stmt(_tmpA8A,
Cyc_Absyn_exp_stmt(({void*_tmp631=0U;({struct Cyc_Absyn_Exp*_tmpA89=Cyc_Toc__pop_region_e;Cyc_Toc_fncall_exp_dl(_tmpA89,_tag_fat(_tmp631,sizeof(struct Cyc_Absyn_Exp*),0U));});}),0U),0U);}),0U);}),0U);}),0U);})->r;
# 3609
s->r=_tmpA92;});}}
# 3617
return;}}default: _LL3A: _LL3B:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp633=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F2;_tmp7F2.tag=0U,({struct _fat_ptr _tmpA93=({const char*_tmp634="bad nested declaration within function";_tag_fat(_tmp634,sizeof(char),39U);});_tmp7F2.f1=_tmpA93;});_tmp7F2;});void*_tmp632[1U];_tmp632[0]=& _tmp633;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp632,sizeof(void*),1U));});}_LL2F:;}
# 3620
...
# 3644
Cyc_Toc_stmt_to_c(nv,body);{
struct Cyc_Absyn_Stmt*_tmp642=({struct Cyc_Absyn_Stmt*_tmpA95=body;Cyc_Absyn_seq_stmt(_tmpA95,
Cyc_Absyn_exp_stmt(({void*_tmp64B=0U;({struct Cyc_Absyn_Exp*_tmpA94=Cyc_Toc__pop_handler_e;Cyc_Toc_fncall_exp_dl(_tmpA94,_tag_fat(_tmp64B,sizeof(struct Cyc_Absyn_Exp*),0U));});}),0U),0U);});
# 3645
...
# 3653
struct Cyc_Absyn_Exp*_tmp644=({struct Cyc_Absyn_Exp*_tmp649[1U];({struct Cyc_Absyn_Exp*_tmpA96=
Cyc_Toc_member_exp(h_exp,Cyc_Toc_handler_sp,0U);_tmp649[0]=_tmpA96;});({struct Cyc_Absyn_Exp*_tmpA97=Cyc_Toc_setjmp_e;Cyc_Toc_fncall_exp_dl(_tmpA97,_tag_fat(_tmp649,sizeof(struct Cyc_Absyn_Exp*),1U));});});
# 3653
struct Cyc_Absyn_Exp*setjmp_call=_tmp644;
# 3655
struct Cyc_Absyn_Stmt*_tmp645=
Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmp648[1U];({struct Cyc_Absyn_Exp*_tmpA98=Cyc_Absyn_address_exp(h_exp,0U);_tmp648[0]=_tmpA98;});({struct Cyc_Absyn_Exp*_tmpA99=Cyc_Toc__push_handler_e;Cyc_Toc_fncall_exp_dl(_tmpA99,_tag_fat(_tmp648,sizeof(struct Cyc_Absyn_Exp*),1U));});}),0U);
# 3655
...
({void*_tmpAA9=({
struct _tuple1*_tmpAA8=h_var;void*_tmpAA7=h_typ;Cyc_Absyn_declare_stmt(_tmpAA8,_tmpAA7,0,({
struct Cyc_Absyn_Stmt*_tmpAA6=pushhandler_call;Cyc_Absyn_seq_stmt(_tmpAA6,({
struct _tuple1*_tmpAA5=was_thrown_var;void*_tmpAA4=was_thrown_typ;struct Cyc_Absyn_Exp*_tmpAA3=zero_exp;Cyc_Absyn_declare_stmt(_tmpAA5,_tmpAA4,_tmpAA3,({
struct Cyc_Absyn_Stmt*_tmpAA2=({struct Cyc_Absyn_Exp*_tmpA9B=setjmp_call;struct Cyc_Absyn_Stmt*_tmpA9A=
Cyc_Absyn_assign_stmt(was_thrown_exp,one_exp,0U);
# 3663
Cyc_Absyn_ifthenelse_stmt(_tmpA9B,_tmpA9A,
# 3665
Cyc_Toc_skip_stmt_dl(),0U);});
# 3663
Cyc_Absyn_seq_stmt(_tmpAA2,({
# 3666
struct Cyc_Absyn_Exp*_tmpAA1=Cyc_Absyn_prim1_exp(Cyc_Absyn_Not,was_thrown_exp,0U);struct Cyc_Absyn_Stmt*_tmpAA0=tryandpop_stmt;Cyc_Absyn_ifthenelse_stmt(_tmpAA1,_tmpAA0,({
# 3668
struct _tuple1*_tmpA9F=e_var;void*_tmpA9E=e_typ;struct Cyc_Absyn_Exp*_tmpA9D=({
void*_tmpA9C=e_typ;Cyc_Toc_cast_it(_tmpA9C,Cyc_Toc_get_exn_thrown_expression());});
# 3668
Cyc_Absyn_declare_stmt(_tmpA9F,_tmpA9E,_tmpA9D,handler_stmt,0U);}),0U);}),0U);}),0U);}),0U);}),0U);})->r;
# 3659
s->r=_tmpAA9;});}}
# 3672
_npop_handler(0U);return;
...
({void*_tmpAAA=Cyc_Toc_typ_to_c((f->i).ret_type);(f->i).ret_type=_tmpAAA;});
({void*_tmpAAB=Cyc_Toc_typ_to_c((void*)_check_null(f->cached_type));f->cached_type=_tmpAAB;});{
...
({void*_tmpAAC=Cyc_Toc_typ_to_c((*((struct _tuple9*)args->hd)).f3);(*((struct _tuple9*)args->hd)).f3=_tmpAAC;});}}
# 3698
if(cinclude){
Cyc_Toc_stmttypes_to_c(f->body);
_npop_handler(0U);return;}
# 3702
Cyc_Toc_fn_pop_table=({struct Cyc_Hashtable_Table**_tmp651=_cycalloc(sizeof(*_tmp651));({struct Cyc_Hashtable_Table*_tmpAAD=((struct Cyc_Hashtable_Table*(*)(struct Cyc_Hashtable_Table*t,struct Cyc_Absyn_Fndecl*key))Cyc_Hashtable_lookup)(*((struct Cyc_Hashtable_Table**)_check_null(Cyc_Toc_gpop_tables)),f);*_tmp651=_tmpAAD;});_tmp651;});
...
({struct Cyc_List_List*_tmpAB0=({struct Cyc_List_List*_tmpAAF=(f->i).args;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmpAAF,({struct Cyc_List_List*_tmp65B=_cycalloc(sizeof(*_tmp65B));({struct _tuple9*_tmpAAE=({struct _tuple9*_tmp65A=_cycalloc(sizeof(*_tmp65A));_tmp65A->f1=n,_tmp65A->f2=tq,_tmp65A->f3=t2;_tmp65A;});_tmp65B->hd=_tmpAAE;}),_tmp65B->tl=0;_tmp65B;}));});(f->i).args=_tmpAB0;});
(f->i).cyc_varargs=0;}}
# 3711
...
({void*_tmpAB1=Cyc_Toc_typ_to_c(((struct Cyc_Absyn_Vardecl*)arg_vds->hd)->type);((struct Cyc_Absyn_Vardecl*)arg_vds->hd)->type=_tmpAB1;});}}
({struct Cyc_Toc_Env*_tmpAB2=Cyc_Toc_clear_toplevel(frgn,nv);Cyc_Toc_stmt_to_c(_tmpAB2,f->body);});}
# 3691
;_pop_region();}}
# 3716
...
v=({struct _tuple19*_tmp668=_region_malloc(d,sizeof(*_tmp668));_tmp668->f1=ad,({void*_tmpAB3=Cyc_Absyn_strctq(n);_tmp668->f2=_tmpAB3;});_tmp668;});else{
# 3745
v=({struct _tuple19*_tmp669=_region_malloc(d,sizeof(*_tmp669));_tmp669->f1=ad,({void*_tmpAB4=Cyc_Absyn_unionq_type(n);_tmp669->f2=_tmpAB4;});_tmp669;});}
({struct Cyc_Dict_Dict _tmpAB5=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple1*k,struct _tuple19*v))Cyc_Dict_insert)(*aggrs_so_far,n,v);*aggrs_so_far=_tmpAB5;});}}else{
# 3748
...
if(ad2->impl == 0){
({struct Cyc_Dict_Dict _tmpAB8=({struct Cyc_Dict_Dict _tmpAB7=*aggrs_so_far;struct _tuple1*_tmpAB6=n;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple1*k,struct _tuple19*v))Cyc_Dict_insert)(_tmpAB7,_tmpAB6,({struct _tuple19*_tmp66E=_region_malloc(d,sizeof(*_tmp66E));_tmp66E->f1=ad,_tmp66E->f2=t;_tmp66E;}));});*aggrs_so_far=_tmpAB8;});
...
({struct Cyc_Absyn_AggrdeclImpl*_tmpAB9=({struct Cyc_Absyn_AggrdeclImpl*_tmp66F=_cycalloc(sizeof(*_tmp66F));_tmp66F->exist_vars=0,_tmp66F->rgn_po=0,_tmp66F->fields=0,_tmp66F->tagged=0;_tmp66F;});new_ad->impl=_tmpAB9;});{
# 3767
struct Cyc_List_List*new_fields=0;
...
# 3788
old_type=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp67A=_cycalloc(sizeof(*_tmp67A));_tmp67A->tag=4U,(_tmp67A->f1).elt_type=et,(_tmp67A->f1).tq=tq,({struct Cyc_Absyn_Exp*_tmpABA=Cyc_Absyn_uint_exp(0U,0U);(_tmp67A->f1).num_elts=_tmpABA;}),(_tmp67A->f1).zero_term=zt,(_tmp67A->f1).zt_loc=ztl;_tmp67A;});
goto _LL9;}}else{_LLC: _LLD:
# 3791
 old_atts=({struct Cyc_List_List*_tmp67C=_cycalloc(sizeof(*_tmp67C));({void*_tmpABB=(void*)({struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_tmp67B=_cycalloc(sizeof(*_tmp67B));_tmp67B->tag=6U,_tmp67B->f1=0;_tmp67B;});_tmp67C->hd=_tmpABB;}),_tmp67C->tl=old_atts;_tmp67C;});
old_type=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp67D=_cycalloc(sizeof(*_tmp67D));_tmp67D->tag=4U,({void*_tmpABE=Cyc_Toc_void_star_type();(_tmp67D->f1).elt_type=_tmpABE;}),({
struct Cyc_Absyn_Tqual _tmpABD=Cyc_Absyn_empty_tqual(0U);(_tmp67D->f1).tq=_tmpABD;}),({
struct Cyc_Absyn_Exp*_tmpABC=Cyc_Absyn_uint_exp(0U,0U);(_tmp67D->f1).num_elts=_tmpABC;}),(_tmp67D->f1).zero_term=Cyc_Absyn_false_type,(_tmp67D->f1).zt_loc=0U;_tmp67D;});}_LL9:;}{
# 3798
...
# 3800
void*_tmpABF=Cyc_Toc_typ_to_c(old_type);_tmp68F->type=_tmpABF;}),_tmp68F->width=old_field->width,_tmp68F->attributes=old_atts,_tmp68F->requires_clause=0;_tmp68F;});
# 3798
...
struct Cyc_Absyn_Aggrdecl*_tmp683=({struct _fat_ptr*_tmpAC1=str;Cyc_Toc_make_c_struct_defn(_tmpAC1,({struct Cyc_Absyn_Aggrfield*_tmp686[2U];_tmp686[0]=tag_field,_tmp686[1]=value_field;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp686,sizeof(struct Cyc_Absyn_Aggrfield*),2U));}));});struct Cyc_Absyn_Aggrdecl*ad2=_tmp683;
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp685=_cycalloc(sizeof(*_tmp685));({struct Cyc_Absyn_Decl*_tmpAC2=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp684=_cycalloc(sizeof(*_tmp684));_tmp684->tag=5U,_tmp684->f1=ad2;_tmp684;}),0U);_tmp685->hd=_tmpAC2;}),_tmp685->tl=Cyc_Toc_result_decls;_tmp685;});
({void*_tmpAC3=Cyc_Absyn_strct(str);new_field->type=_tmpAC3;});}
# 3819
new_fields=({struct Cyc_List_List*_tmp68E=_cycalloc(sizeof(*_tmp68E));_tmp68E->hd=new_field,_tmp68E->tl=new_fields;_tmp68E;});}}}
# 3821
({struct Cyc_List_List*_tmpAC4=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(new_fields);(new_ad->impl)->fields=_tmpAC4;});}}
# 3824
if(!seen_defn_before)
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp692=_cycalloc(sizeof(*_tmp692));({struct Cyc_Absyn_Decl*_tmpAC6=({struct Cyc_Absyn_Decl*_tmp691=_cycalloc(sizeof(*_tmp691));({void*_tmpAC5=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp690=_cycalloc(sizeof(*_tmp690));_tmp690->tag=5U,_tmp690->f1=new_ad;_tmp690;});_tmp691->r=_tmpAC5;}),_tmp691->loc=0U;_tmp691;});_tmp692->hd=_tmpAC6;}),_tmp692->tl=Cyc_Toc_result_decls;_tmp692;});
return 0;}}}}
# 3828
static void Cyc_Toc_aggrdecl_to_c(struct Cyc_Absyn_Aggrdecl*ad){
...
return 0;
({struct Cyc_Set_Set*_tmpAC7=((struct Cyc_Set_Set*(*)(struct _RegionHandle*r,struct Cyc_Set_Set*s,struct _tuple1*elt))Cyc_Set_rinsert)(d,*datatypes_so_far,n);*datatypes_so_far=_tmpAC7;});
...
void*_tmpAC8=Cyc_Toc_typ_to_c((*((struct _tuple13*)ts->hd)).f2);_tmp69F->type=_tmpAC8;}),_tmp69F->width=0,_tmp69F->attributes=0,_tmp69F->requires_clause=0;_tmp69F;});
# 3871
...
# 3875
fs=({struct Cyc_List_List*_tmp6A1=_cycalloc(sizeof(*_tmp6A1));({struct Cyc_Absyn_Aggrfield*_tmpACA=({struct Cyc_Absyn_Aggrfield*_tmp6A0=_cycalloc(sizeof(*_tmp6A0));_tmp6A0->name=Cyc_Toc_tag_sp,_tmp6A0->tq=Cyc_Toc_mt_tq,_tmp6A0->type=Cyc_Absyn_sint_type,_tmp6A0->width=0,_tmp6A0->attributes=0,_tmp6A0->requires_clause=0;_tmp6A0;});_tmp6A1->hd=_tmpACA;}),({
struct Cyc_List_List*_tmpAC9=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(fs);_tmp6A1->tl=_tmpAC9;});_tmp6A1;});{
struct Cyc_Absyn_Aggrdecl*_tmp6A2=({struct _fat_ptr*_tmpACC=({struct _fat_ptr*_tmp6A6=_cycalloc(sizeof(*_tmp6A6));({struct _fat_ptr _tmpACB=({const char*_tmp6A5="";_tag_fat(_tmp6A5,sizeof(char),1U);});*_tmp6A6=_tmpACB;});_tmp6A6;});Cyc_Toc_make_c_struct_defn(_tmpACC,fs);});struct Cyc_Absyn_Aggrdecl*ad=_tmp6A2;
({struct _tuple1*_tmpACD=Cyc_Toc_collapse_qvars(f->name,tud->name);ad->name=_tmpACD;});
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp6A4=_cycalloc(sizeof(*_tmp6A4));({struct Cyc_Absyn_Decl*_tmpACE=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp6A3=_cycalloc(sizeof(*_tmp6A3));_tmp6A3->tag=5U,_tmp6A3->f1=ad;_tmp6A3;}),0U);_tmp6A4->hd=_tmpACE;}),_tmp6A4->tl=Cyc_Toc_result_decls;_tmp6A4;});}}}
# 3881
return 0;}}
# 3884
static void Cyc_Toc_datatypedecl_to_c(struct Cyc_Absyn_Datatypedecl*tud){
...
tag_decl->sc=f->sc;
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp6B6=_cycalloc(sizeof(*_tmp6B6));({struct Cyc_Absyn_Decl*_tmpACF=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp6B5=_cycalloc(sizeof(*_tmp6B5));_tmp6B5->tag=0U,_tmp6B5->f1=tag_decl;_tmp6B5;}),0U);_tmp6B6->hd=_tmpACF;}),_tmp6B6->tl=Cyc_Toc_result_decls;_tmp6B6;});
({struct Cyc_Dict_Dict _tmpAD0=
...
# 3926
*xdatatypes_so_far=_tmpAD0;});{
# 3928
struct Cyc_List_List*fields=0;
int i=1;
{struct Cyc_List_List*_tmp6B7=f->typs;struct Cyc_List_List*tqts=_tmp6B7;for(0;tqts != 0;(tqts=tqts->tl,i ++)){
struct _fat_ptr*_tmp6B8=({struct _fat_ptr*_tmp6BF=_cycalloc(sizeof(*_tmp6BF));({struct _fat_ptr _tmpAD2=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp6BE=({struct Cyc_Int_pa_PrintArg_struct _tmp7F5;_tmp7F5.tag=1U,_tmp7F5.f1=(unsigned long)i;_tmp7F5;});void*_tmp6BC[1U];_tmp6BC[0]=& _tmp6BE;({struct _fat_ptr _tmpAD1=({const char*_tmp6BD="f%d";_tag_fat(_tmp6BD,sizeof(char),4U);});Cyc_aprintf(_tmpAD1,_tag_fat(_tmp6BC,sizeof(void*),1U));});});*_tmp6BF=_tmpAD2;});_tmp6BF;});struct _fat_ptr*field_n=_tmp6B8;
...
void*_tmpAD3=Cyc_Toc_typ_to_c((*((struct _tuple13*)tqts->hd)).f2);_tmp6BB->type=_tmpAD3;}),_tmp6BB->width=0,_tmp6BB->attributes=0,_tmp6BB->requires_clause=0;_tmp6BB;});
# 3932
...
# 3936
fields=({struct Cyc_List_List*_tmp6C1=_cycalloc(sizeof(*_tmp6C1));({struct Cyc_Absyn_Aggrfield*_tmpAD6=({struct Cyc_Absyn_Aggrfield*_tmp6C0=_cycalloc(sizeof(*_tmp6C0));_tmp6C0->name=Cyc_Toc_tag_sp,_tmp6C0->tq=Cyc_Toc_mt_tq,({
void*_tmpAD5=Cyc_Absyn_cstar_type(Cyc_Absyn_char_type,Cyc_Toc_mt_tq);_tmp6C0->type=_tmpAD5;}),_tmp6C0->width=0,_tmp6C0->attributes=0,_tmp6C0->requires_clause=0;_tmp6C0;});
# 3936
_tmp6C1->hd=_tmpAD6;}),({
# 3938
struct Cyc_List_List*_tmpAD4=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(fields);_tmp6C1->tl=_tmpAD4;});_tmp6C1;});{
struct Cyc_Absyn_Aggrdecl*_tmp6C2=({struct _fat_ptr*_tmpAD8=({struct _fat_ptr*_tmp6C6=_cycalloc(sizeof(*_tmp6C6));({struct _fat_ptr _tmpAD7=({const char*_tmp6C5="";_tag_fat(_tmp6C5,sizeof(char),1U);});*_tmp6C6=_tmpAD7;});_tmp6C6;});Cyc_Toc_make_c_struct_defn(_tmpAD8,fields);});struct Cyc_Absyn_Aggrdecl*strct_decl=_tmp6C2;
({struct _tuple1*_tmpAD9=Cyc_Toc_collapse_qvars(f->name,xd->name);strct_decl->name=_tmpAD9;});
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp6C4=_cycalloc(sizeof(*_tmp6C4));({struct Cyc_Absyn_Decl*_tmpADA=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp6C3=_cycalloc(sizeof(*_tmp6C3));_tmp6C3->tag=5U,_tmp6C3->f1=strct_decl;_tmp6C3;}),0U);_tmp6C4->hd=_tmpADA;}),_tmp6C4->tl=Cyc_Toc_result_decls;_tmp6C4;});
...
tag_decl->sc=f->sc;
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp6CA=_cycalloc(sizeof(*_tmp6CA));({struct Cyc_Absyn_Decl*_tmpADB=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp6C9=_cycalloc(sizeof(*_tmp6C9));_tmp6C9->tag=0U,_tmp6C9->f1=tag_decl;_tmp6C9;}),0U);_tmp6CA->hd=_tmpADB;}),_tmp6CA->tl=Cyc_Toc_result_decls;_tmp6CA;});
({struct Cyc_Dict_Dict _tmpADC=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple1*k,int v))Cyc_Dict_insert)(*xdatatypes_so_far,f->name,1);*xdatatypes_so_far=_tmpADC;});}
# 3951
...
({void*_tmpADD=Cyc_Toc_typ_to_c(old_typ);vd->type=_tmpADD;});
# 3972
...
if(Cyc_Tcutil_force_type2bool(0,zt)){
if(num_elts_opt == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp6D3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F6;_tmp7F6.tag=0U,({struct _fat_ptr _tmpADE=({const char*_tmp6D4="can't initialize zero-terminated array -- size unknown";_tag_fat(_tmp6D4,sizeof(char),55U);});_tmp7F6.f1=_tmpADE;});_tmp7F6;});void*_tmp6D2[1U];_tmp6D2[0]=& _tmp6D3;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp6D2,sizeof(void*),1U));});{
struct Cyc_Absyn_Exp*num_elts=num_elts_opt;
struct Cyc_Absyn_Exp*_tmp6D5=({struct Cyc_Absyn_Exp*_tmpAE0=Cyc_Absyn_var_exp(vd->name,0U);Cyc_Absyn_subscript_exp(_tmpAE0,({
struct Cyc_Absyn_Exp*_tmpADF=num_elts;Cyc_Absyn_add_exp(_tmpADF,Cyc_Absyn_signed_int_exp(- 1,0U),0U);}),0U);});
# 3995
...
({void*_tmpAE2=({struct Cyc_Absyn_Stmt*_tmpAE1=Cyc_Absyn_exp_stmt(Cyc_Absyn_assign_exp(lhs,rhs,0U),0U);Cyc_Toc_seq_stmt_r(_tmpAE1,
...
({void*_tmpAE4=Cyc_Toc_rewrite_decision(*d2,success);*d2=_tmpAE4;});}}
# 4020
return d;}}_LL0:;}
# 4031 "toc.cyc"
...
struct Cyc_List_List*_tmp6E4=({struct _RegionHandle*_tmpAE7=rgn;struct _RegionHandle*_tmpAE6=rgn;((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple36*(*f)(struct _RegionHandle*,struct Cyc_Absyn_Switch_clause*),struct _RegionHandle*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(_tmpAE7,Cyc_Toc_gen_labels,_tmpAE6,({struct Cyc_Absyn_Switch_clause*_tmp6F1[1U];_tmp6F1[0]=c1;({struct _RegionHandle*_tmpAE5=rgn;((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _fat_ptr))Cyc_List_rlist)(_tmpAE5,_tag_fat(_tmp6F1,sizeof(struct Cyc_Absyn_Switch_clause*),1U));});}));});struct Cyc_List_List*lscs=_tmp6E4;
# 4052
struct Cyc_List_List*mydecls=0;
struct Cyc_List_List*mybodies=0;
# 4056
...
# 4064
({struct Cyc_Warn_String_Warn_Warg_struct _tmp6EA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F7;_tmp7F7.tag=0U,({struct _fat_ptr _tmpAE8=({const char*_tmp6EB="letdecl_to_c: couldn't find env!";_tag_fat(_tmp6EB,sizeof(char),33U);});_tmp7F7.f1=_tmpAE8;});_tmp7F7;});void*_tmp6E9[1U];_tmp6E9[0]=& _tmp6EA;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp6E9,sizeof(void*),1U));});
FOUND_ENV:
# 4068
...
res=({struct Cyc_Absyn_Decl*_tmpAE9=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp6EF=_cycalloc(sizeof(*_tmp6EF));_tmp6EF->tag=0U,_tmp6EF->f1=vd;_tmp6EF;}),0U);Cyc_Absyn_decl_stmt(_tmpAE9,res,0U);});}}
# 4077
res=({struct _tuple1*_tmpAEC=v;void*_tmpAEB=Cyc_Toc_typ_to_c(t);struct Cyc_Absyn_Exp*_tmpAEA=e;Cyc_Absyn_declare_stmt(_tmpAEC,_tmpAEB,_tmpAEA,res,0U);});{
...
({void*_tmpAED=Cyc_Toc_typ_to_c(*t);*t=_tmpAED;});Cyc_Toc_exptypes_to_c(e);goto _LL0;}case 25U: _LL27: _tmp6FB=(void**)&(((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp6F4)->f1)->f3;_tmp6FC=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp6F4)->f2;_LL28: {void**t=_tmp6FB;struct Cyc_List_List*dles=_tmp6FC;
# 4109
({void*_tmpAEE=Cyc_Toc_typ_to_c(*t);*t=_tmpAEE;});
...
({void*_tmpAEF=Cyc_Toc_typ_to_c(*t);*t=_tmpAEF;});goto _LL0;}case 37U: _LL31: _tmp6F6=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp6F4)->f1;_LL32: {struct Cyc_Absyn_Stmt*s=_tmp6F6;
...
# 4120
if(m->elt_type != 0)
({void**_tmpAF1=({void**_tmp71A=_cycalloc(sizeof(*_tmp71A));({void*_tmpAF0=Cyc_Toc_typ_to_c(*((void**)_check_null(m->elt_type)));*_tmp71A=_tmpAF0;});_tmp71A;});m->elt_type=_tmpAF1;});
...
({void*_tmp71B=0U;({unsigned _tmpAF3=e->loc;struct _fat_ptr _tmpAF2=({const char*_tmp71C="Cyclone expression in C code";_tag_fat(_tmp71C,sizeof(char),29U);});((int(*)(unsigned,struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos_loc)(_tmpAF3,_tmpAF2,_tag_fat(_tmp71B,sizeof(void*),0U));});});}_LL0:;}
# 4145
...
# 4148
({void*_tmpAF4=Cyc_Toc_typ_to_c(vd->type);vd->type=_tmpAF4;});
...
# 4152
({void*_tmpAF5=Cyc_Toc_typ_to_c((fd->i).ret_type);(fd->i).ret_type=_tmpAF5;});
{struct Cyc_List_List*_tmp724=(fd->i).args;struct Cyc_List_List*args=_tmp724;for(0;args != 0;args=args->tl){
({void*_tmpAF6=Cyc_Toc_typ_to_c((*((struct _tuple9*)args->hd)).f3);(*((struct _tuple9*)args->hd)).f3=_tmpAF6;});}}
...
({void*_tmpAF7=Cyc_Toc_typ_to_c((void*)_check_null(td->defn));td->defn=_tmpAF7;});goto _LL0;}case 2U: _LLB: _LLC:
...
# 4173
({void*_tmp727=0U;({unsigned _tmpAF9=d->loc;struct _fat_ptr _tmpAF8=({const char*_tmp728="Cyclone declaration in C code";_tag_fat(_tmp728,sizeof(char),30U);});((int(*)(unsigned,struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos_loc)(_tmpAF9,_tmpAF8,_tag_fat(_tmp727,sizeof(void*),0U));});});case 13U: _LL1B: _LL1C:
...
# 4206
({void*_tmpAFA=(void*)({struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*_tmp740=_cycalloc(sizeof(*_tmp740));_tmp740->tag=0U;_tmp740;});s->r=_tmpAFA;});goto _LL0;default: _LL1F: _LL20:
({void*_tmp741=0U;({unsigned _tmpAFC=s->loc;struct _fat_ptr _tmpAFB=({const char*_tmp742="Cyclone statement in C code";_tag_fat(_tmp742,sizeof(char),28U);});((int(*)(unsigned,struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos_loc)(_tmpAFC,_tmpAFB,_tag_fat(_tmp741,sizeof(void*),0U));});});}_LL0:;}
# 4214
...
for(0;ds != 0;ds=ds->tl){
if(!Cyc_Toc_is_toplevel(nv))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp744=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F8;_tmp7F8.tag=0U,({struct _fat_ptr _tmpAFD=({const char*_tmp745="decls_to_c: not at toplevel!";_tag_fat(_tmp745,sizeof(char),29U);});_tmp7F8.f1=_tmpAFD;});_tmp7F8;});void*_tmp743[1U];_tmp743[0]=& _tmp744;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp743,sizeof(void*),1U));});
...
c_name=({struct _tuple1*_tmp753=_cycalloc(sizeof(*_tmp753));({union Cyc_Absyn_Nmspace _tmpAFE=Cyc_Absyn_Abs_n(0,1);_tmp753->f1=_tmpAFE;}),_tmp753->f2=(*c_name).f2;_tmp753;});
if(vd->initializer != 0){
...
# 4234
vd->name=c_name;
({enum Cyc_Absyn_Scope _tmpAFF=Cyc_Toc_scope_to_c(vd->sc);vd->sc=_tmpAFF;});
...
({struct _tuple1*_tmpB02=({struct _tuple1*_tmp755=_cycalloc(sizeof(*_tmp755));({union Cyc_Absyn_Nmspace _tmpB01=Cyc_Absyn_Abs_n(0,1);_tmp755->f1=_tmpB01;}),_tmp755->f2=(*fd->name).f2;_tmp755;});fd->name=_tmpB02;});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp758=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F9;_tmp7F9.tag=0U,({struct _fat_ptr _tmpB03=({const char*_tmp759="letdecl at toplevel";_tag_fat(_tmp759,sizeof(char),20U);});_tmp7F9.f1=_tmpB03;});_tmp7F9;});void*_tmp757[1U];_tmp757[0]=& _tmp758;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp757,sizeof(void*),1U));});case 4U: _LL9: _LLA:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp75B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7FA;_tmp7FA.tag=0U,({struct _fat_ptr _tmpB04=({const char*_tmp75C="region decl at toplevel";_tag_fat(_tmp75C,sizeof(char),24U);});_tmp7FA.f1=_tmpB04;});_tmp7FA;});void*_tmp75A[1U];_tmp75A[0]=& _tmp75B;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp75A,sizeof(void*),1U));});case 5U: _LLB: _tmp74F=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp747)->f1;_LLC: {struct Cyc_Absyn_Aggrdecl*sd=_tmp74F;
...
td->tvs=0;
if(td->defn != 0){
({void*_tmpB05=Cyc_Toc_typ_to_c((void*)_check_null(td->defn));td->defn=_tmpB05;});{
# 4265
...
# 4268
ed=({struct Cyc_Absyn_Decl*_tmp763=_cycalloc(sizeof(*_tmp763));({void*_tmpB06=(void*)({struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*_tmp762=_cycalloc(sizeof(*_tmp762));_tmp762->tag=7U,_tmp762->f1=ed2;_tmp762;});_tmp763->r=_tmpB06;}),_tmp763->loc=loc;_tmp763;});goto _LL23;}}else{goto _LL26;}}else{goto _LL26;}}else{_LL26: _LL27:
 ed=0;}_LL23:;}
# 4271
if(ed != 0){
...
# 4275
({void*_tmpB08=(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp769=_cycalloc(sizeof(*_tmp769));_tmp769->tag=0U,({void*_tmpB07=(void*)({struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*_tmp768=_cycalloc(sizeof(*_tmp768));_tmp768->tag=15U,_tmp768->f1=ed->name,_tmp768->f2=ed;_tmp768;});_tmp769->f1=_tmpB07;}),_tmp769->f2=0;_tmp769;});td->defn=_tmpB08;});goto _LL28;}}else{_LL2B: _LL2C:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp76B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7FB;_tmp7FB.tag=0U,({struct _fat_ptr _tmpB09=({const char*_tmp76C="Toc: enumdecl to name";_tag_fat(_tmp76C,sizeof(char),22U);});_tmp7FB.f1=_tmpB09;});_tmp7FB;});void*_tmp76A[1U];_tmp76A[0]=& _tmp76B;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp76A,sizeof(void*),1U));});}_LL28:;}}}}else{
# 4280
...
({void*_tmpB0A=Cyc_Toc_void_star_type();td->defn=_tmpB0A;});goto _LL2D;}else{_LL30: _LL31:
...
({struct _RegionHandle*_tmpB0C=start;struct Cyc_Toc_Env*_tmpB0B=Cyc_Toc_empty_env(start);Cyc_Toc_decls_to_c(_tmpB0C,_tmpB0B,ds,0);});{
