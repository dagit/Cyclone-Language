...
goto _LL0;}}_LL0:;}
# 1636
{void*_stmttmp2C=e->r;void*_Tmp0=_stmttmp2C;int _Tmp1;int _Tmp2;enum Cyc_Absyn_Coercion _Tmp3;void*_Tmp4;int _Tmp5;void*_Tmp6;void*_Tmp7;enum Cyc_Absyn_Incrementor _Tmp8;enum Cyc_Absyn_Primop _Tmp9;void*_TmpA;switch(*((int*)_Tmp0)){case 2:
# 1638
...
if(rgnopt != 0 && !Cyc_Flags_no_regions){
Cyc_Toc_exp_to_c(nv,rgnopt);{
struct Cyc_Absyn_Exp*(*fn_e)(struct Cyc_Absyn_Exp*,struct Cyc_Absyn_Exp*)=inline_call?Cyc_Toc_rmalloc_inline_exp: Cyc_Toc_rmalloc_exp;
