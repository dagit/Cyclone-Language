...
# 285
int Cyc_Tcutil_is_zero_ptr_deref(struct Cyc_Absyn_Exp*e1,void**ptr_type,int*is_fat,void**elt_type);struct _tuple12{struct Cyc_Absyn_Tqual f1;void*f2;};
# 331
...
if(!Cyc_Tcutil_unify((*((struct _tuple12*)_tmpC7->hd)).f2,(void*)_tmpC8->hd))
break;}
...
struct Cyc_List_List*_tmp3BF=((struct Cyc_List_List*(*)(struct _RegionHandle*rgn,unsigned loc,struct Cyc_List_List*des,enum Cyc_Absyn_AggrKind,struct Cyc_List_List*fields))Cyc_Tcutil_resolve_aggregate_designators)(Cyc_Core_heap_region,e->loc,_tmp46E,_tmp46D->kind,((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp46D->impl))->fields);
# 2562
if(!Cyc_Toc_is_toplevel(nv)){
...
vs=((struct Cyc_List_List*(*)(struct Cyc_List_List*l))Cyc_Tcutil_filter_nulls)((((struct _tuple0(*)(struct Cyc_List_List*x))Cyc_List_split)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp544->pat_vars))->v)).f1);
