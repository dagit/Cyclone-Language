...
{const char*_tmp9AD;void*_tmp9AC;(_tmp9AC=0,Cyc_fprintf(Cyc_stderr,((_tmp9AD="\n",_tag_dyneither(_tmp9AD,sizeof(char),2))),_tag_dyneither(_tmp9AC,sizeof(void*),0)));}
Cyc_fflush(Cyc_stderr);{
struct Cyc_Toc_Toc_Unimplemented_exn_struct _tmp9B0;struct Cyc_Toc_Toc_Unimplemented_exn_struct*_tmp9AF;(int)_throw((void*)((_tmp9AF=_cycalloc_atomic(sizeof(*_tmp9AF)),((_tmp9AF[0]=((_tmp9B0.tag=Cyc_Toc_Toc_Unimplemented,_tmp9B0)),_tmp9AF)))));};}
# 141
static void*Cyc_Toc_toc_impos(struct _dyneither_ptr fmt,struct _dyneither_ptr ap){
# 144
Cyc_vfprintf(Cyc_stderr,fmt,ap);
{const char*_tmp9B3;void*_tmp9B2;(_tmp9B2=0,Cyc_fprintf(Cyc_stderr,((_tmp9B3="\n",_tag_dyneither(_tmp9B3,sizeof(char),2))),_tag_dyneither(_tmp9B2,sizeof(void*),0)));}
Cyc_fflush(Cyc_stderr);{
struct Cyc_Toc_Toc_Impossible_exn_struct _tmp9B6;struct Cyc_Toc_Toc_Impossible_exn_struct*_tmp9B5;(int)_throw((void*)((_tmp9B5=_cycalloc_atomic(sizeof(*_tmp9B5)),((_tmp9B5[0]=((_tmp9B6.tag=Cyc_Toc_Toc_Impossible,_tmp9B6)),_tmp9B5)))));};}char Cyc_Toc_Match_error[12]="Match_error";struct Cyc_Toc_Match_error_exn_struct{char*tag;};static char _tmp16[5]="curr";
# 159 "toc.cyc"
...
if(skip_stmt_opt == 0){
struct Cyc_Absyn_Stmt**_tmp9B7;skip_stmt_opt=((_tmp9B7=_cycalloc(sizeof(*_tmp9B7)),((_tmp9B7[0]=Cyc_Absyn_skip_stmt(0),_tmp9B7))));}
...
struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct _tmp9BA;struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp9B9;return(void*)((_tmp9B9=_cycalloc(sizeof(*_tmp9B9)),((_tmp9B9[0]=((_tmp9BA.tag=13,((_tmp9BA.f1=t,((_tmp9BA.f2=e,((_tmp9BA.f3=0,((_tmp9BA.f4=Cyc_Absyn_No_coercion,_tmp9BA)))))))))),_tmp9B9))));}
# 276
static void*Cyc_Toc_deref_exp_r(struct Cyc_Absyn_Exp*e){
struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct _tmp9BD;struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_tmp9BC;return(void*)((_tmp9BC=_cycalloc(sizeof(*_tmp9BC)),((_tmp9BC[0]=((_tmp9BD.tag=19,((_tmp9BD.f1=e,_tmp9BD)))),_tmp9BC))));}
# 279
static void*Cyc_Toc_subscript_exp_r(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2){
struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct _tmp9C0;struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*_tmp9BF;return(void*)((_tmp9BF=_cycalloc(sizeof(*_tmp9BF)),((_tmp9BF[0]=((_tmp9C0.tag=22,((_tmp9C0.f1=e1,((_tmp9C0.f2=e2,_tmp9C0)))))),_tmp9BF))));}
# 282
static void*Cyc_Toc_stmt_exp_r(struct Cyc_Absyn_Stmt*s){
struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct _tmp9C3;struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_tmp9C2;return(void*)((_tmp9C2=_cycalloc(sizeof(*_tmp9C2)),((_tmp9C2[0]=((_tmp9C3.tag=35,((_tmp9C3.f1=s,_tmp9C3)))),_tmp9C2))));}
# 285
static void*Cyc_Toc_sizeoftyp_exp_r(void*t){
struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct _tmp9C6;struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*_tmp9C5;return(void*)((_tmp9C5=_cycalloc(sizeof(*_tmp9C5)),((_tmp9C5[0]=((_tmp9C6.tag=16,((_tmp9C6.f1=t,_tmp9C6)))),_tmp9C5))));}
# 288
static void*Cyc_Toc_fncall_exp_r(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*es){
struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct _tmp9C9;struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp9C8;return(void*)((_tmp9C8=_cycalloc(sizeof(*_tmp9C8)),((_tmp9C8[0]=((_tmp9C9.tag=9,((_tmp9C9.f1=e,((_tmp9C9.f2=es,((_tmp9C9.f3=0,((_tmp9C9.f4=1,_tmp9C9)))))))))),_tmp9C8))));}
# 291
static void*Cyc_Toc_exp_stmt_r(struct Cyc_Absyn_Exp*e){
struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct _tmp9CC;struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*_tmp9CB;return(void*)((_tmp9CB=_cycalloc(sizeof(*_tmp9CB)),((_tmp9CB[0]=((_tmp9CC.tag=1,((_tmp9CC.f1=e,_tmp9CC)))),_tmp9CB))));}
# 294
static void*Cyc_Toc_seq_stmt_r(struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2){
struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct _tmp9CF;struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmp9CE;return(void*)((_tmp9CE=_cycalloc(sizeof(*_tmp9CE)),((_tmp9CE[0]=((_tmp9CF.tag=2,((_tmp9CF.f1=s1,((_tmp9CF.f2=s2,_tmp9CF)))))),_tmp9CE))));}
# 297
static void*Cyc_Toc_conditional_exp_r(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,struct Cyc_Absyn_Exp*e3){
struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct _tmp9D2;struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_tmp9D1;return(void*)((_tmp9D1=_cycalloc(sizeof(*_tmp9D1)),((_tmp9D1[0]=((_tmp9D2.tag=5,((_tmp9D2.f1=e1,((_tmp9D2.f2=e2,((_tmp9D2.f3=e3,_tmp9D2)))))))),_tmp9D1))));}
# 300
static void*Cyc_Toc_aggrmember_exp_r(struct Cyc_Absyn_Exp*e,struct _dyneither_ptr*n){
struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct _tmp9D5;struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_tmp9D4;return(void*)((_tmp9D4=_cycalloc(sizeof(*_tmp9D4)),((_tmp9D4[0]=((_tmp9D5.tag=20,((_tmp9D5.f1=e,((_tmp9D5.f2=n,((_tmp9D5.f3=0,((_tmp9D5.f4=0,_tmp9D5)))))))))),_tmp9D4))));}
# 303
static void*Cyc_Toc_aggrarrow_exp_r(struct Cyc_Absyn_Exp*e,struct _dyneither_ptr*n){
struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct _tmp9D8;struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp9D7;return(void*)((_tmp9D7=_cycalloc(sizeof(*_tmp9D7)),((_tmp9D7[0]=((_tmp9D8.tag=21,((_tmp9D8.f1=e,((_tmp9D8.f2=n,((_tmp9D8.f3=0,((_tmp9D8.f4=0,_tmp9D8)))))))))),_tmp9D7))));}
# 306
static void*Cyc_Toc_unresolvedmem_exp_r(struct Cyc_Core_Opt*tdopt,struct Cyc_List_List*ds){
# 309
struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct _tmp9DB;struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmp9DA;return(void*)((_tmp9DA=_cycalloc(sizeof(*_tmp9DA)),((_tmp9DA[0]=((_tmp9DB.tag=34,((_tmp9DB.f1=tdopt,((_tmp9DB.f2=ds,_tmp9DB)))))),_tmp9DA))));}
# 311
static void*Cyc_Toc_goto_stmt_r(struct _dyneither_ptr*v,struct Cyc_Absyn_Stmt*s){
struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct _tmp9DE;struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*_tmp9DD;return(void*)((_tmp9DD=_cycalloc(sizeof(*_tmp9DD)),((_tmp9DD[0]=((_tmp9DE.tag=8,((_tmp9DE.f1=v,((_tmp9DE.f2=s,_tmp9DE)))))),_tmp9DD))));}
# 314
...
struct Cyc_Core_Impossible_exn_struct _tmp9E4;const char*_tmp9E3;struct Cyc_Core_Impossible_exn_struct*_tmp9E2;(int)_throw((void*)((_tmp9E2=_cycalloc(sizeof(*_tmp9E2)),((_tmp9E2[0]=((_tmp9E4.tag=Cyc_Core_Impossible,((_tmp9E4.f1=((_tmp9E3="impossible IntType (not char, short or int)",_tag_dyneither(_tmp9E3,sizeof(char),44))),_tmp9E4)))),_tmp9E2)))));}}
# 383
...
# 397
struct Cyc_Core_Impossible_exn_struct _tmp9F1;const char*_tmp9F0;void*_tmp9EF[1];struct Cyc_String_pa_PrintArg_struct _tmp9EE;struct Cyc_Core_Impossible_exn_struct*_tmp9ED;(int)_throw((void*)((_tmp9ED=_cycalloc(sizeof(*_tmp9ED)),((_tmp9ED[0]=((_tmp9F1.tag=Cyc_Core_Impossible,((_tmp9F1.f1=(struct _dyneither_ptr)((_tmp9EE.tag=0,((_tmp9EE.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp9EF[0]=& _tmp9EE,Cyc_aprintf(((_tmp9F0="impossible expression type %s (not int, float, double, or pointer)",_tag_dyneither(_tmp9F0,sizeof(char),67))),_tag_dyneither(_tmp9EF,sizeof(void*),1)))))))),_tmp9F1)))),_tmp9ED)))));}_LL5:;}
# 399
return function;}
# 401
...
struct Cyc_Core_Impossible_exn_struct _tmp9F7;const char*_tmp9F6;struct Cyc_Core_Impossible_exn_struct*_tmp9F5;(int)_throw((void*)((_tmp9F5=_cycalloc(sizeof(*_tmp9F5)),((_tmp9F5[0]=((_tmp9F7.tag=Cyc_Core_Impossible,((_tmp9F7.f1=((_tmp9F6="impossible type (not pointer)",_tag_dyneither(_tmp9F6,sizeof(char),30))),_tmp9F7)))),_tmp9F5)))));}_LL17:;}struct _tuple16{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
# 415
...
const char*_tmp9FA;void*_tmp9F9;(_tmp9F9=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmp9FA="is_nullable",_tag_dyneither(_tmp9FA,sizeof(char),12))),_tag_dyneither(_tmp9F9,sizeof(void*),0)));}_LL37:;}
# 457
...
char*_tmp9FC;unsigned int _tmp9FB;struct _dyneither_ptr buf=(_tmp9FB=len,((_tmp9FC=_cyccalloc_atomic(sizeof(char),_tmp9FB),_tag_dyneither(_tmp9FC,sizeof(char),_tmp9FB))));
...
{char _tmp9FF;char _tmp9FE;struct _dyneither_ptr _tmp9FD;(_tmp9FD=p,((_tmp9FE=*((char*)_check_dyneither_subscript(_tmp9FD,sizeof(char),0)),((_tmp9FF='_',((_get_dyneither_size(_tmp9FD,sizeof(char))== 1  && (_tmp9FE == '\000'  && _tmp9FF != '\000')?_throw_arraybounds(): 1,*((char*)_tmp9FD.curr)=_tmp9FF)))))));}_dyneither_ptr_inplace_plus(& p,sizeof(char),1);
...
# 481
{char _tmpA02;char _tmpA01;struct _dyneither_ptr _tmpA00;(_tmpA00=p,((_tmpA01=*((char*)_check_dyneither_subscript(_tmpA00,sizeof(char),0)),((_tmpA02='_',((_get_dyneither_size(_tmpA00,sizeof(char))== 1  && (_tmpA01 == '\000'  && _tmpA02 != '\000')?_throw_arraybounds(): 1,*((char*)_tmpA00.curr)=_tmpA02)))))));}_dyneither_ptr_inplace_plus(& p,sizeof(char),1);
Cyc_strcpy(p,(struct _dyneither_ptr)_tmpFD);_dyneither_ptr_inplace_plus(& p,sizeof(char),(int)vlen);
{const char*_tmpA03;Cyc_strcpy(p,((_tmpA03="_struct",_tag_dyneither(_tmpA03,sizeof(char),8))));}
...
{struct _tuple14 _tmpA04;pair=((_tmpA04.f1=fieldname,((_tmpA04.f2=dtname,_tmpA04))));}{
...
struct _tuple14*_tmpA05;struct _tuple14*_tmp115=(_tmpA05=_cycalloc(sizeof(*_tmpA05)),((_tmpA05->f1=fieldname,((_tmpA05->f2=dtname,_tmpA05)))));
...
struct _dyneither_ptr*_tmpA08;struct _tuple0*_tmpA07;struct _tuple0*res=(_tmpA07=_cycalloc(sizeof(*_tmpA07)),((_tmpA07->f1=_tmp117,((_tmpA07->f2=((_tmpA08=_cycalloc(sizeof(*_tmpA08)),((_tmpA08[0]=newvar,_tmpA08)))),_tmpA07)))));
...
# 529
struct Cyc_Int_pa_PrintArg_struct _tmpA10;void*_tmpA0F[1];const char*_tmpA0E;struct _dyneither_ptr*_tmpA0D;struct _dyneither_ptr*xname=(_tmpA0D=_cycalloc(sizeof(*_tmpA0D)),((_tmpA0D[0]=(struct _dyneither_ptr)((_tmpA10.tag=1,((_tmpA10.f1=(unsigned long)Cyc_Toc_tuple_type_counter ++,((_tmpA0F[0]=& _tmpA10,Cyc_aprintf(((_tmpA0E="_tuple%d",_tag_dyneither(_tmpA0E,sizeof(char),9))),_tag_dyneither(_tmpA0F,sizeof(void*),1)))))))),_tmpA0D)));
...
struct Cyc_Absyn_Aggrfield*_tmpA13;struct Cyc_List_List*_tmpA12;_tmp128=((_tmpA12=_cycalloc(sizeof(*_tmpA12)),((_tmpA12->hd=((_tmpA13=_cycalloc(sizeof(*_tmpA13)),((_tmpA13->name=Cyc_Absyn_fieldname(i),((_tmpA13->tq=Cyc_Toc_mt_tq,((_tmpA13->type=(void*)ts2->hd,((_tmpA13->width=0,((_tmpA13->attributes=0,_tmpA13)))))))))))),((_tmpA12->tl=_tmp128,_tmpA12))))));}}
_tmp128=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp128);{
struct Cyc_Absyn_AggrdeclImpl*_tmpA18;struct _tuple0*_tmpA17;struct Cyc_Absyn_Aggrdecl*_tmpA16;struct Cyc_Absyn_Aggrdecl*_tmp12B=(_tmpA16=_cycalloc(sizeof(*_tmpA16)),((_tmpA16->kind=Cyc_Absyn_StructA,((_tmpA16->sc=Cyc_Absyn_Public,((_tmpA16->name=(
(_tmpA17=_cycalloc(sizeof(*_tmpA17)),((_tmpA17->f1=Cyc_Absyn_Rel_n(0),((_tmpA17->f2=xname,_tmpA17)))))),((_tmpA16->tvs=0,((_tmpA16->impl=(
(_tmpA18=_cycalloc(sizeof(*_tmpA18)),((_tmpA18->exist_vars=0,((_tmpA18->rgn_po=0,((_tmpA18->fields=_tmp128,((_tmpA18->tagged=0,_tmpA18)))))))))),((_tmpA16->attributes=0,_tmpA16)))))))))))));
# 544
{struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpA1E;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct _tmpA1D;struct Cyc_List_List*_tmpA1C;Cyc_Toc_result_decls=((_tmpA1C=_cycalloc(sizeof(*_tmpA1C)),((_tmpA1C->hd=Cyc_Absyn_new_decl((void*)((_tmpA1E=_cycalloc(sizeof(*_tmpA1E)),((_tmpA1E[0]=((_tmpA1D.tag=6,((_tmpA1D.f1=_tmp12B,_tmpA1D)))),_tmpA1E)))),0),((_tmpA1C->tl=Cyc_Toc_result_decls,_tmpA1C))))));}
{struct _tuple17*_tmpA21;struct Cyc_List_List*_tmpA20;*_tmp120=((_tmpA20=_region_malloc(d,sizeof(*_tmpA20)),((_tmpA20->hd=((_tmpA21=_region_malloc(d,sizeof(*_tmpA21)),((_tmpA21->f1=x,((_tmpA21->f2=ts,_tmpA21)))))),((_tmpA20->tl=*_tmp120,_tmpA20))))));}{
...
# 608
{struct _tuple18*_tmpA2C;struct Cyc_List_List*_tmpA2B;*_tmp13B=((_tmpA2B=_region_malloc(d,sizeof(*_tmpA2B)),((_tmpA2B->hd=((_tmpA2C=_region_malloc(d,sizeof(*_tmpA2C)),((_tmpA2C->f1=struct_name,((_tmpA2C->f2=type_args,((_tmpA2C->f3=x,_tmpA2C)))))))),((_tmpA2B->tl=*_tmp13B,_tmpA2B))))));}{
# 611
...
struct Cyc_Absyn_Aggrfield*_tmpA2F;struct Cyc_List_List*_tmpA2E;_tmp147=((_tmpA2E=_cycalloc(sizeof(*_tmpA2E)),((_tmpA2E->hd=((_tmpA2F=_cycalloc(sizeof(*_tmpA2F)),((_tmpA2F->name=_tmp14C->name,((_tmpA2F->tq=Cyc_Toc_mt_tq,((_tmpA2F->type=t,((_tmpA2F->width=_tmp14C->width,((_tmpA2F->attributes=_tmp14C->attributes,_tmpA2F)))))))))))),((_tmpA2E->tl=_tmp147,_tmpA2E))))));};}
# 622
_tmp147=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp147);{
struct Cyc_Absyn_AggrdeclImpl*_tmpA34;struct _tuple0*_tmpA33;struct Cyc_Absyn_Aggrdecl*_tmpA32;struct Cyc_Absyn_Aggrdecl*_tmp14F=(_tmpA32=_cycalloc(sizeof(*_tmpA32)),((_tmpA32->kind=Cyc_Absyn_StructA,((_tmpA32->sc=Cyc_Absyn_Public,((_tmpA32->name=(
(_tmpA33=_cycalloc(sizeof(*_tmpA33)),((_tmpA33->f1=Cyc_Absyn_Rel_n(0),((_tmpA33->f2=xname,_tmpA33)))))),((_tmpA32->tvs=0,((_tmpA32->impl=(
(_tmpA34=_cycalloc(sizeof(*_tmpA34)),((_tmpA34->exist_vars=0,((_tmpA34->rgn_po=0,((_tmpA34->fields=_tmp147,((_tmpA34->tagged=0,_tmpA34)))))))))),((_tmpA32->attributes=0,_tmpA32)))))))))))));
# 630
{struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpA3A;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct _tmpA39;struct Cyc_List_List*_tmpA38;Cyc_Toc_result_decls=((_tmpA38=_cycalloc(sizeof(*_tmpA38)),((_tmpA38->hd=Cyc_Absyn_new_decl((void*)((_tmpA3A=_cycalloc(sizeof(*_tmpA3A)),((_tmpA3A[0]=((_tmpA39.tag=6,((_tmpA39.f1=_tmp14F,_tmpA39)))),_tmpA3A)))),0),((_tmpA38->tl=Cyc_Toc_result_decls,_tmpA38))))));}{
...
struct _dyneither_ptr*_tmpA47;const char*_tmpA46;void*_tmpA45[1];struct Cyc_Int_pa_PrintArg_struct _tmpA44;struct _tuple0*_tmpA43;struct _tuple0*res=(_tmpA43=_cycalloc(sizeof(*_tmpA43)),((_tmpA43->f1=Cyc_Absyn_Loc_n,((_tmpA43->f2=((_tmpA47=_cycalloc(sizeof(*_tmpA47)),((_tmpA47[0]=(struct _dyneither_ptr)((_tmpA44.tag=1,((_tmpA44.f1=(unsigned int)_tmp15B,((_tmpA45[0]=& _tmpA44,Cyc_aprintf(((_tmpA46="_tmp%X",_tag_dyneither(_tmpA46,sizeof(char),7))),_tag_dyneither(_tmpA45,sizeof(void*),1)))))))),_tmpA47)))),_tmpA43)))));
return res;}
# 647
...
struct Cyc_Int_pa_PrintArg_struct _tmpA4F;void*_tmpA4E[1];const char*_tmpA4D;struct _dyneither_ptr*_tmpA4C;struct _dyneither_ptr*res=(_tmpA4C=_cycalloc(sizeof(*_tmpA4C)),((_tmpA4C[0]=(struct _dyneither_ptr)((_tmpA4F.tag=1,((_tmpA4F.f1=(unsigned int)_tmp165,((_tmpA4E[0]=& _tmpA4F,Cyc_aprintf(((_tmpA4D="_LL%X",_tag_dyneither(_tmpA4D,sizeof(char),6))),_tag_dyneither(_tmpA4E,sizeof(void*),1)))))))),_tmpA4C)));
if(((int(*)(struct Cyc_Xarray_Xarray*,struct _dyneither_ptr*))Cyc_Xarray_add_ind)(_tmp163,res)!= _tmp165){
const char*_tmpA52;void*_tmpA51;(_tmpA51=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpA52="fresh_label: add_ind returned bad index...",_tag_dyneither(_tmpA52,sizeof(char),43))),_tag_dyneither(_tmpA51,sizeof(void*),0)));}{
...
struct _tuple8*_tmpA53;return(_tmpA53=_cycalloc(sizeof(*_tmpA53)),((_tmpA53->f1=_tmp170,((_tmpA53->f2=_tmp171,((_tmpA53->f3=Cyc_Toc_typ_to_c(_tmp172),_tmpA53)))))));};}
# 684
...
struct _tuple10*_tmpA54;return(_tmpA54=_cycalloc(sizeof(*_tmpA54)),((_tmpA54->f1=_tmp175,((_tmpA54->f2=Cyc_Toc_typ_to_c(_tmp176),_tmpA54)))));};}
# 703 "toc.cyc"
...
# 714
struct Cyc_Absyn_Aggrfield*_tmpA55;return(_tmpA55=_cycalloc(sizeof(*_tmpA55)),((_tmpA55->name=f->name,((_tmpA55->tq=Cyc_Toc_mt_tq,((_tmpA55->type=
# 716
Cyc_Toc_typ_to_c(f->type),((_tmpA55->width=f->width,((_tmpA55->attributes=f->attributes,_tmpA55)))))))))));}
# 720
...
static void**cs=0;
if(cs == 0){
void**_tmpA56;cs=((_tmpA56=_cycalloc(sizeof(*_tmpA56)),((_tmpA56[0]=Cyc_Absyn_star_typ(Cyc_Absyn_char_typ,(void*)& Cyc_Absyn_HeapRgn_val,Cyc_Toc_mt_tq,Cyc_Absyn_false_conref),_tmpA56))));}
# 730
return*cs;}
# 732
...
static void**r=0;
if(r == 0){
void**_tmpA57;r=((_tmpA57=_cycalloc(sizeof(*_tmpA57)),((_tmpA57[0]=Cyc_Absyn_cstar_typ(Cyc_Absyn_strct(Cyc_Toc__RegionHandle_sp),Cyc_Toc_mt_tq),_tmpA57))));}
# 737
return*r;}
# 739
...
static void**r=0;
if(r == 0){
void**_tmpA58;r=((_tmpA58=_cycalloc(sizeof(*_tmpA58)),((_tmpA58[0]=Cyc_Absyn_cstar_typ(Cyc_Absyn_strct(Cyc_Toc__DynRegionHandle_sp),Cyc_Toc_mt_tq),_tmpA58))));}
# 744
return*r;}
# 746
...
const char*_tmpA5B;void*_tmpA5A;(_tmpA5A=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpA5B="unresolved DatatypeFieldType",_tag_dyneither(_tmpA5B,sizeof(char),29))),_tag_dyneither(_tmpA5A,sizeof(void*),0)));}_LL6A: {struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp194=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp189;if(_tmp194->tag != 5)goto _LL6C;else{_tmp195=(_tmp194->f1).elt_typ;_tmp196=(_tmp194->f1).elt_tq;_tmp197=((_tmp194->f1).ptr_atts).bounds;}}_LL6B:
# 784
...
{struct Cyc_List_List*_tmpA5C;_tmp1D1=((_tmpA5C=_cycalloc(sizeof(*_tmpA5C)),((_tmpA5C->hd=(void*)_tmp1A5->hd,((_tmpA5C->tl=_tmp1D1,_tmpA5C))))));}goto _LL9F;_LL9F:;}{
# 809
...
struct _tuple8*_tmpA5D;struct _tuple8*_tmp1DC=(_tmpA5D=_cycalloc(sizeof(*_tmpA5D)),((_tmpA5D->f1=_tmp1A4->name,((_tmpA5D->f2=_tmp1A4->tq,((_tmpA5D->f3=_tmp1DB,_tmpA5D)))))));
struct Cyc_List_List*_tmpA5E;_tmp1DA=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp1DA,((_tmpA5E=_cycalloc(sizeof(*_tmpA5E)),((_tmpA5E->hd=_tmp1DC,((_tmpA5E->tl=0,_tmpA5E)))))));}{
# 816
struct Cyc_Absyn_FnType_Absyn_Type_struct _tmpA64;struct Cyc_Absyn_FnInfo _tmpA63;struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmpA62;return(void*)((_tmpA62=_cycalloc(sizeof(*_tmpA62)),((_tmpA62[0]=((_tmpA64.tag=9,((_tmpA64.f1=((_tmpA63.tvars=0,((_tmpA63.effect=0,((_tmpA63.ret_tqual=_tmp1A0,((_tmpA63.ret_typ=Cyc_Toc_typ_to_c(_tmp1A1),((_tmpA63.args=_tmp1DA,((_tmpA63.c_varargs=_tmp1A3,((_tmpA63.cyc_varargs=0,((_tmpA63.rgn_po=0,((_tmpA63.attributes=_tmp1D1,_tmpA63)))))))))))))))))),_tmpA64)))),_tmpA62))));};};}_LL74: {struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmp1A6=(struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp189;if(_tmp1A6->tag != 10)goto _LL76;else{_tmp1A7=_tmp1A6->f1;}}_LL75:
# 821
...
# 826
struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct _tmpA67;struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_tmpA66;return(void*)((_tmpA66=_cycalloc(sizeof(*_tmpA66)),((_tmpA66[0]=((_tmpA67.tag=12,((_tmpA67.f1=_tmp1A9,((_tmpA67.f2=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Aggrfield*(*f)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Toc_aggrfield_to_c,_tmp1AA),_tmpA67)))))),_tmpA66))));}_LL78: {struct Cyc_Absyn_AggrType_Absyn_Type_struct*_tmp1AB=(struct Cyc_Absyn_AggrType_Absyn_Type_struct*)_tmp189;if(_tmp1AB->tag != 11)goto _LL7A;else{_tmp1AC=(_tmp1AB->f1).aggr_info;_tmp1AD=(_tmp1AB->f1).targs;}}_LL79:
# 830
...
if(_tmp1B4 != 0){
struct Cyc_Absyn_TypedefType_Absyn_Type_struct _tmpA6A;struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmpA69;return(void*)((_tmpA69=_cycalloc(sizeof(*_tmpA69)),((_tmpA69[0]=((_tmpA6A.tag=17,((_tmpA6A.f1=_tmp1B3,((_tmpA6A.f2=0,((_tmpA6A.f3=_tmp1B5,((_tmpA6A.f4=0,_tmpA6A)))))))))),_tmpA69))));}else{
return t;}}else{
# 863
struct Cyc_Absyn_TypedefType_Absyn_Type_struct _tmpA6D;struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmpA6C;return(void*)((_tmpA6C=_cycalloc(sizeof(*_tmpA6C)),((_tmpA6C[0]=((_tmpA6D.tag=17,((_tmpA6D.f1=_tmp1B3,((_tmpA6D.f2=0,((_tmpA6D.f3=_tmp1B5,((_tmpA6D.f4=Cyc_Toc_typ_to_c(_tmp1B6),_tmpA6D)))))))))),_tmpA6C))));}_LL80: {struct Cyc_Absyn_TagType_Absyn_Type_struct*_tmp1B7=(struct Cyc_Absyn_TagType_Absyn_Type_struct*)_tmp189;if(_tmp1B7->tag != 19)goto _LL82;}_LL81:
...
const char*_tmpA71;void*_tmpA70[1];struct Cyc_String_pa_PrintArg_struct _tmpA6F;(_tmpA6F.tag=0,((_tmpA6F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmpA70[0]=& _tmpA6F,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpA71="atomic_typ:  bad type %s",_tag_dyneither(_tmpA71,sizeof(char),25))),_tag_dyneither(_tmpA70,sizeof(void*),1)))))));}_LLB8:;}
# 951
...
if(_tmp21D->impl == 0){
const char*_tmpA74;void*_tmpA73;(_tmpA73=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpA74="is_poly_field: type missing fields",_tag_dyneither(_tmpA74,sizeof(char),35))),_tag_dyneither(_tmpA73,sizeof(void*),0)));}
...
if(_tmp220 == 0){
const char*_tmpA78;void*_tmpA77[1];struct Cyc_String_pa_PrintArg_struct _tmpA76;(_tmpA76.tag=0,((_tmpA76.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f),((_tmpA77[0]=& _tmpA76,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpA78="is_poly_field: bad field %s",_tag_dyneither(_tmpA78,sizeof(char),28))),_tag_dyneither(_tmpA77,sizeof(void*),1)))))));}
return Cyc_Toc_is_void_star_or_boxed_tvar(_tmp220->type);}_LLF1:;_LLF2: {
const char*_tmpA7C;void*_tmpA7B[1];struct Cyc_String_pa_PrintArg_struct _tmpA7A;(_tmpA7A.tag=0,((_tmpA7A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmpA7B[0]=& _tmpA7A,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpA7C="is_poly_field: bad type %s",_tag_dyneither(_tmpA7C,sizeof(char),27))),_tag_dyneither(_tmpA7B,sizeof(void*),1)))))));}_LLEC:;}
# 990
...
const char*_tmpA80;void*_tmpA7F[1];struct Cyc_String_pa_PrintArg_struct _tmpA7E;(_tmpA7E.tag=0,((_tmpA7E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmp22C->topt))),((_tmpA7F[0]=& _tmpA7E,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpA80="is_poly_project: bad type %s",_tag_dyneither(_tmpA80,sizeof(char),29))),_tag_dyneither(_tmpA7F,sizeof(void*),1)))))));}_LLFA:;}_LLF8:;_LLF9:
# 1001
 return 0;_LLF3:;}
# 1006
static struct Cyc_Absyn_Exp*Cyc_Toc_malloc_ptr(struct Cyc_Absyn_Exp*s){
struct Cyc_List_List*_tmpA81;return Cyc_Absyn_fncall_exp(Cyc_Toc__cycalloc_e,((_tmpA81=_cycalloc(sizeof(*_tmpA81)),((_tmpA81->hd=s,((_tmpA81->tl=0,_tmpA81)))))),0);}
# 1010
static struct Cyc_Absyn_Exp*Cyc_Toc_malloc_atomic(struct Cyc_Absyn_Exp*s){
struct Cyc_List_List*_tmpA82;return Cyc_Absyn_fncall_exp(Cyc_Toc__cycalloc_atomic_e,((_tmpA82=_cycalloc(sizeof(*_tmpA82)),((_tmpA82->hd=s,((_tmpA82->tl=0,_tmpA82)))))),0);}
# 1014
...
struct Cyc_Absyn_Exp*_tmpA83[2];return Cyc_Absyn_fncall_exp(Cyc_Toc__region_malloc_e,((_tmpA83[1]=s,((_tmpA83[0]=rgn,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpA83,sizeof(struct Cyc_Absyn_Exp*),2)))))),0);}
# 1024
static struct Cyc_Absyn_Exp*Cyc_Toc_calloc_exp(void*elt_type,struct Cyc_Absyn_Exp*s,struct Cyc_Absyn_Exp*n){
if(Cyc_Toc_atomic_typ(elt_type)){
struct Cyc_Absyn_Exp*_tmpA84[2];return Cyc_Absyn_fncall_exp(Cyc_Toc__cyccalloc_atomic_e,((_tmpA84[1]=n,((_tmpA84[0]=s,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpA84,sizeof(struct Cyc_Absyn_Exp*),2)))))),0);}else{
# 1028
struct Cyc_Absyn_Exp*_tmpA85[2];return Cyc_Absyn_fncall_exp(Cyc_Toc__cyccalloc_e,((_tmpA85[1]=n,((_tmpA85[0]=s,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpA85,sizeof(struct Cyc_Absyn_Exp*),2)))))),0);}}
# 1031
static struct Cyc_Absyn_Exp*Cyc_Toc_rcalloc_exp(struct Cyc_Absyn_Exp*rgn,struct Cyc_Absyn_Exp*s,struct Cyc_Absyn_Exp*n){
struct Cyc_Absyn_Exp*_tmpA86[3];return Cyc_Absyn_fncall_exp(Cyc_Toc__region_calloc_e,((_tmpA86[2]=n,((_tmpA86[1]=s,((_tmpA86[0]=rgn,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpA86,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0);}
# 1036
static struct Cyc_Absyn_Exp*Cyc_Toc_newthrow_exp(struct Cyc_Absyn_Exp*e){
struct Cyc_List_List*_tmpA87;return Cyc_Absyn_fncall_exp(Cyc_Toc__throw_e,((_tmpA87=_cycalloc(sizeof(*_tmpA87)),((_tmpA87->hd=e,((_tmpA87->tl=0,_tmpA87)))))),0);}
# 1040
static struct Cyc_Absyn_Stmt*Cyc_Toc_throw_match_stmt(){
struct Cyc_Absyn_Exp*_tmpA88[0];return Cyc_Absyn_exp_stmt(Cyc_Absyn_fncall_exp(Cyc_Toc__throw_match_e,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpA88,sizeof(struct Cyc_Absyn_Exp*),0)),0),0);}
# 1046
...
{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmpA8E;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmpA8D;struct Cyc_List_List*_tmpA8C;Cyc_Toc_result_decls=((_tmpA8C=_cycalloc(sizeof(*_tmpA8C)),((_tmpA8C->hd=Cyc_Absyn_new_decl((void*)((_tmpA8E=_cycalloc(sizeof(*_tmpA8E)),((_tmpA8E[0]=((_tmpA8D.tag=0,((_tmpA8D.f1=vd,_tmpA8D)))),_tmpA8E)))),0),((_tmpA8C->tl=Cyc_Toc_result_decls,_tmpA8C))))));}
...
{struct _tuple16*_tmpA95;struct _tuple16*_tmpA94;struct _tuple16*_tmpA93;struct _tuple16*_tmpA92[3];urm_exp=Cyc_Absyn_unresolvedmem_exp(0,((_tmpA92[2]=(
# 1077
(_tmpA93=_cycalloc(sizeof(*_tmpA93)),((_tmpA93->f1=0,((_tmpA93->f2=xplussz,_tmpA93)))))),((_tmpA92[1]=(
# 1076
(_tmpA94=_cycalloc(sizeof(*_tmpA94)),((_tmpA94->f1=0,((_tmpA94->f2=xexp,_tmpA94)))))),((_tmpA92[0]=(
# 1075
(_tmpA95=_cycalloc(sizeof(*_tmpA95)),((_tmpA95->f1=0,((_tmpA95->f2=xexp,_tmpA95)))))),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpA92,sizeof(struct _tuple16*),3)))))))),0);}
# 1078
...
int*_tmpA98;struct Cyc_Toc_Env*_tmpA97;return(_tmpA97=_region_malloc(r,sizeof(*_tmpA97)),((_tmpA97->break_lab=(struct _dyneither_ptr**)0,((_tmpA97->continue_lab=(struct _dyneither_ptr**)0,((_tmpA97->fallthru_info=(struct Cyc_Toc_FallthruInfo*)0,((_tmpA97->varmap=(struct Cyc_Dict_Dict)
# 1135
((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _tuple0*,struct _tuple0*)))Cyc_Dict_rempty)(r,Cyc_Absyn_qvar_cmp),((_tmpA97->toplevel=(int)1,((_tmpA97->in_lhs=(int*)(
# 1137
(_tmpA98=_region_malloc(r,sizeof(*_tmpA98)),((_tmpA98[0]=0,_tmpA98)))),((_tmpA97->rgn=(struct _RegionHandle*)r,(struct Cyc_Toc_Env*)_tmpA97)))))))))))))));}
# 1141
...
struct Cyc_Toc_Env*_tmpA99;return(_tmpA99=_region_malloc(r,sizeof(*_tmpA99)),((_tmpA99->break_lab=(struct _dyneither_ptr**)_tmp24F,((_tmpA99->continue_lab=(struct _dyneither_ptr**)_tmp250,((_tmpA99->fallthru_info=(struct Cyc_Toc_FallthruInfo*)_tmp251,((_tmpA99->varmap=(struct Cyc_Dict_Dict)((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,struct Cyc_Dict_Dict))Cyc_Dict_rshare)(r,_tmp252),((_tmpA99->toplevel=(int)_tmp253,((_tmpA99->in_lhs=(int*)_tmp254,((_tmpA99->rgn=(struct _RegionHandle*)r,(struct Cyc_Toc_Env*)_tmpA99)))))))))))))));};}
# 1146
...
struct Cyc_Toc_Env*_tmpA9A;return(_tmpA9A=_region_malloc(r,sizeof(*_tmpA9A)),((_tmpA9A->break_lab=(struct _dyneither_ptr**)_tmp257,((_tmpA9A->continue_lab=(struct _dyneither_ptr**)_tmp258,((_tmpA9A->fallthru_info=(struct Cyc_Toc_FallthruInfo*)_tmp259,((_tmpA9A->varmap=(struct Cyc_Dict_Dict)((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,struct Cyc_Dict_Dict))Cyc_Dict_rshare)(r,_tmp25A),((_tmpA9A->toplevel=(int)0,((_tmpA9A->in_lhs=(int*)_tmp25C,((_tmpA9A->rgn=(struct _RegionHandle*)r,(struct Cyc_Toc_Env*)_tmpA9A)))))))))))))));};}
# 1150
...
struct Cyc_Toc_Env*_tmpA9B;return(_tmpA9B=_region_malloc(r,sizeof(*_tmpA9B)),((_tmpA9B->break_lab=(struct _dyneither_ptr**)_tmp25F,((_tmpA9B->continue_lab=(struct _dyneither_ptr**)_tmp260,((_tmpA9B->fallthru_info=(struct Cyc_Toc_FallthruInfo*)_tmp261,((_tmpA9B->varmap=(struct Cyc_Dict_Dict)((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,struct Cyc_Dict_Dict))Cyc_Dict_rshare)(r,_tmp262),((_tmpA9B->toplevel=(int)1,((_tmpA9B->in_lhs=(int*)_tmp264,((_tmpA9B->rgn=(struct _RegionHandle*)r,(struct Cyc_Toc_Env*)_tmpA9B)))))))))))))));};}
# 1154
...
# 1164
const char*_tmpA9F;void*_tmpA9E[1];struct Cyc_String_pa_PrintArg_struct _tmpA9D;(_tmpA9D.tag=0,((_tmpA9D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(x)),((_tmpA9E[0]=& _tmpA9D,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpA9F="Toc::add_varmap on Rel_n: %s\n",_tag_dyneither(_tmpA9F,sizeof(char),30))),_tag_dyneither(_tmpA9E,sizeof(void*),1)))))));}_LL109:;_LL10A:
 goto _LL106;_LL106:;}{
# 1167
...
struct Cyc_Toc_Env*_tmpAA0;return(_tmpAA0=_region_malloc(r,sizeof(*_tmpAA0)),((_tmpAA0->break_lab=(struct _dyneither_ptr**)_tmp26D,((_tmpAA0->continue_lab=(struct _dyneither_ptr**)_tmp26E,((_tmpAA0->fallthru_info=(struct Cyc_Toc_FallthruInfo*)_tmp26F,((_tmpAA0->varmap=(struct Cyc_Dict_Dict)_tmp273,((_tmpAA0->toplevel=(int)_tmp271,((_tmpAA0->in_lhs=(int*)_tmp272,((_tmpAA0->rgn=(struct _RegionHandle*)r,(struct Cyc_Toc_Env*)_tmpAA0)))))))))))))));};};}
# 1174
...
struct Cyc_Toc_Env*_tmpAA1;return(_tmpAA1=_region_malloc(r,sizeof(*_tmpAA1)),((_tmpAA1->break_lab=(struct _dyneither_ptr**)0,((_tmpAA1->continue_lab=(struct _dyneither_ptr**)0,((_tmpAA1->fallthru_info=(struct Cyc_Toc_FallthruInfo*)_tmp278,((_tmpAA1->varmap=(struct Cyc_Dict_Dict)((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,struct Cyc_Dict_Dict))Cyc_Dict_rshare)(r,_tmp279),((_tmpAA1->toplevel=(int)_tmp27A,((_tmpAA1->in_lhs=(int*)_tmp27B,((_tmpAA1->rgn=(struct _RegionHandle*)r,(struct Cyc_Toc_Env*)_tmpAA1)))))))))))))));};}
# 1180
...
struct Cyc_List_List*_tmpAA2;fallthru_vars=((_tmpAA2=_region_malloc(r,sizeof(*_tmpAA2)),((_tmpAA2->hd=((struct Cyc_Absyn_Vardecl*)fallthru_binders->hd)->name,((_tmpAA2->tl=fallthru_vars,_tmpAA2))))));}
...
struct Cyc_Toc_FallthruInfo*_tmpAA3;struct Cyc_Toc_FallthruInfo*fi=
(_tmpAA3=_region_malloc(r,sizeof(*_tmpAA3)),((_tmpAA3->label=fallthru_l,((_tmpAA3->binders=fallthru_vars,((_tmpAA3->next_case_env=
((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,struct Cyc_Dict_Dict))Cyc_Dict_rshare)(r,_tmp286),_tmpAA3)))))));
struct _dyneither_ptr**_tmpAA6;struct Cyc_Toc_Env*_tmpAA5;return(_tmpAA5=_region_malloc(r,sizeof(*_tmpAA5)),((_tmpAA5->break_lab=(struct _dyneither_ptr**)((_tmpAA6=_region_malloc(r,sizeof(*_tmpAA6)),((_tmpAA6[0]=break_l,_tmpAA6)))),((_tmpAA5->continue_lab=(struct _dyneither_ptr**)_tmp280,((_tmpAA5->fallthru_info=(struct Cyc_Toc_FallthruInfo*)fi,((_tmpAA5->varmap=(struct Cyc_Dict_Dict)((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,struct Cyc_Dict_Dict))Cyc_Dict_rshare)(r,_tmp282),((_tmpAA5->toplevel=(int)_tmp283,((_tmpAA5->in_lhs=(int*)_tmp284,((_tmpAA5->rgn=(struct _RegionHandle*)r,(struct Cyc_Toc_Env*)_tmpAA5)))))))))))))));};};};}
# 1197
...
struct _dyneither_ptr**_tmpAA9;struct Cyc_Toc_Env*_tmpAA8;return(_tmpAA8=_region_malloc(r,sizeof(*_tmpAA8)),((_tmpAA8->break_lab=(struct _dyneither_ptr**)((_tmpAA9=_region_malloc(r,sizeof(*_tmpAA9)),((_tmpAA9[0]=break_l,_tmpAA9)))),((_tmpAA8->continue_lab=(struct _dyneither_ptr**)_tmp28C,((_tmpAA8->fallthru_info=(struct Cyc_Toc_FallthruInfo*)0,((_tmpAA8->varmap=(struct Cyc_Dict_Dict)((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,struct Cyc_Dict_Dict))Cyc_Dict_rshare)(r,_tmp28E),((_tmpAA8->toplevel=(int)_tmp28F,((_tmpAA8->in_lhs=(int*)_tmp290,((_tmpAA8->rgn=(struct _RegionHandle*)r,(struct Cyc_Toc_Env*)_tmpAA8)))))))))))))));};}
# 1207
...
struct Cyc_Toc_FallthruInfo*_tmpAAC;struct Cyc_Toc_Env*_tmpAAB;return(_tmpAAB=_region_malloc(r,sizeof(*_tmpAAB)),((_tmpAAB->break_lab=(struct _dyneither_ptr**)0,((_tmpAAB->continue_lab=(struct _dyneither_ptr**)_tmp295,((_tmpAAB->fallthru_info=(struct Cyc_Toc_FallthruInfo*)((_tmpAAC=_region_malloc(r,sizeof(*_tmpAAC)),((_tmpAAC->label=next_l,((_tmpAAC->binders=0,((_tmpAAC->next_case_env=
((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _tuple0*,struct _tuple0*)))Cyc_Dict_rempty)(r,Cyc_Absyn_qvar_cmp),_tmpAAC)))))))),((_tmpAAB->varmap=(struct Cyc_Dict_Dict)
((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,struct Cyc_Dict_Dict))Cyc_Dict_rshare)(r,_tmp297),((_tmpAAB->toplevel=(int)_tmp298,((_tmpAAB->in_lhs=(int*)_tmp299,((_tmpAAB->rgn=(struct _RegionHandle*)r,(struct Cyc_Toc_Env*)_tmpAAB)))))))))))))));};}
# 1225 "toc.cyc"
...
# 1233
{const char*_tmpAAF;void*_tmpAAE;(_tmpAAE=0,Cyc_Tcutil_terr(e->loc,((_tmpAAF="dereference of NULL pointer",_tag_dyneither(_tmpAAF,sizeof(char),28))),_tag_dyneither(_tmpAAE,sizeof(void*),0)));}
...
const char*_tmpAB2;void*_tmpAB1;(_tmpAB1=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpAB2="need_null_check",_tag_dyneither(_tmpAB2,sizeof(char),16))),_tag_dyneither(_tmpAB1,sizeof(void*),0)));}_LL10B:;}
# 1243
...
# 1248
{const char*_tmpAB5;void*_tmpAB4;(_tmpAB4=0,Cyc_Tcutil_terr(e->loc,((_tmpAB5="dereference of NULL pointer",_tag_dyneither(_tmpAB5,sizeof(char),28))),_tag_dyneither(_tmpAB4,sizeof(void*),0)));}
...
const char*_tmpAB8;void*_tmpAB7;(_tmpAB7=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpAB8="get_relns",_tag_dyneither(_tmpAB8,sizeof(char),10))),_tag_dyneither(_tmpAB7,sizeof(void*),0)));}_LL116:;}
# 1256
...
if(e->topt == 0){const char*_tmpABC;void*_tmpABB;(_tmpABB=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpABC="Missing type in primop ",_tag_dyneither(_tmpABC,sizeof(char),24))),_tag_dyneither(_tmpABB,sizeof(void*),0)));}
return Cyc_Toc_typ_to_c((void*)_check_null(e->topt));}
# 1456
static void*Cyc_Toc_get_cyc_typ(struct Cyc_Absyn_Exp*e){
if(e->topt == 0){const char*_tmpABF;void*_tmpABE;(_tmpABE=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpABF="Missing type in primop ",_tag_dyneither(_tmpABF,sizeof(char),24))),_tag_dyneither(_tmpABE,sizeof(void*),0)));}
return(void*)_check_null(e->topt);}
# 1460
static struct _tuple10*Cyc_Toc_tup_to_c(struct Cyc_Absyn_Exp*e){
struct _tuple10*_tmpAC0;return(_tmpAC0=_cycalloc(sizeof(*_tmpAC0)),((_tmpAC0->f1=Cyc_Toc_mt_tq,((_tmpAC0->f2=Cyc_Toc_typ_to_c((void*)_check_null(e->topt)),_tmpAC0)))));}
# 1463
static struct _tuple16*Cyc_Toc_add_designator(struct Cyc_Toc_Env*nv,struct Cyc_Absyn_Exp*e){
Cyc_Toc_exp_to_c(nv,e);{
struct _tuple16*_tmpAC1;return(_tmpAC1=_cycalloc(sizeof(*_tmpAC1)),((_tmpAC1->f1=0,((_tmpAC1->f2=e,_tmpAC1)))));};}
# 1468
...
if(_tmp333 != 0){
const char*_tmpAC4;void*_tmpAC3;(_tmpAC3=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpAC4="oops; get_offset_... called without subsituting types first",_tag_dyneither(_tmpAC4,sizeof(char),60))),_tag_dyneither(_tmpAC3,sizeof(void*),0)));}
...
# 1528
struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct _tmpAC7;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmpAC6;struct Cyc_Absyn_Exp*_tmp33C=Cyc_Absyn_offsetof_exp(struct_typ,(void*)((_tmpAC6=_cycalloc(sizeof(*_tmpAC6)),((_tmpAC6[0]=((_tmpAC7.tag=0,((_tmpAC7.f1=index,_tmpAC7)))),_tmpAC6)))),0);
void*_tmp33D=Cyc_Toc_aggr_lookup_field(struct_typ,index);
if(_tmp33D == 0){
const char*_tmpACA;void*_tmpAC9;(_tmpAC9=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpACA="make_variable_struct: couldn't find field type for offsetof",_tag_dyneither(_tmpACA,sizeof(char),60))),_tag_dyneither(_tmpAC9,sizeof(void*),0)));}else{
# 1533
...
# 1560
if(_tmp344->tl != 0){const char*_tmpACD;void*_tmpACC;(_tmpACC=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(((_tmpACD="multiple designators in array",_tag_dyneither(_tmpACD,sizeof(char),30))),_tag_dyneither(_tmpACC,sizeof(void*),0)));}{
...
const char*_tmpAD0;void*_tmpACF;(_tmpACF=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(((_tmpAD0="field name designators in array",_tag_dyneither(_tmpAD0,sizeof(char),32))),_tag_dyneither(_tmpACF,sizeof(void*),0)));}_LL1A0:;};}{
# 1570
...
{struct Cyc_Absyn_Local_b_Absyn_Binding_struct _tmpAD3;struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmpAD2;struct Cyc_Toc_Env*nv2=Cyc_Toc_add_varmap(r2,nv,_tmp35A,Cyc_Absyn_varb_exp(_tmp35A,(void*)((_tmpAD2=_cycalloc(sizeof(*_tmpAD2)),((_tmpAD2[0]=((_tmpAD3.tag=4,((_tmpAD3.f1=vd,_tmpAD3)))),_tmpAD2)))),0));
...
if(_tmp36D == 0){
const char*_tmpAD6;void*_tmpAD5;(_tmpAD5=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpAD6="empty designator list",_tag_dyneither(_tmpAD6,sizeof(char),22))),_tag_dyneither(_tmpAD5,sizeof(void*),0)));}
if(_tmp36D->tl != 0){
const char*_tmpAD9;void*_tmpAD8;(_tmpAD8=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpAD9="too many designators in anonymous struct",_tag_dyneither(_tmpAD9,sizeof(char),41))),_tag_dyneither(_tmpAD8,sizeof(void*),0)));}{
...
const char*_tmpADC;void*_tmpADB;(_tmpADB=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpADC="array designator in struct",_tag_dyneither(_tmpADC,sizeof(char),27))),_tag_dyneither(_tmpADB,sizeof(void*),0)));}_LL1B7:;};}}
# 1676
return s;}
# 1681
...
++ i;}}{
# 1727
struct Cyc_String_pa_PrintArg_struct _tmpAE4;void*_tmpAE3[1];const char*_tmpAE2;void*_tmpAE1;(_tmpAE1=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)((struct _dyneither_ptr)((_tmpAE4.tag=0,((_tmpAE4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f),((_tmpAE3[0]=& _tmpAE4,Cyc_aprintf(((_tmpAE2="get_member_offset %s failed",_tag_dyneither(_tmpAE2,sizeof(char),28))),_tag_dyneither(_tmpAE3,sizeof(void*),1)))))))),_tag_dyneither(_tmpAE1,sizeof(void*),0)));};}
# 1730
...
const char*_tmpAE7;void*_tmpAE6;(_tmpAE6=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpAE7="init_struct: bad struct type",_tag_dyneither(_tmpAE7,sizeof(char),29))),_tag_dyneither(_tmpAE6,sizeof(void*),0)));}_LL1D8:;}{
# 1778
...
struct Cyc_Absyn_Aggrfield*_tmpAE8;struct Cyc_Absyn_Aggrfield*_tmp3B5=(_tmpAE8=_cycalloc(sizeof(*_tmpAE8)),((_tmpAE8->name=_tmp3B4->name,((_tmpAE8->tq=Cyc_Toc_mt_tq,((_tmpAE8->type=
# 1804
Cyc_Tcutil_rsubstitute(temp,_tmp3B3,_tmp3B4->type),((_tmpAE8->width=_tmp3B4->width,((_tmpAE8->attributes=_tmp3B4->attributes,_tmpAE8)))))))))));
# 1811
if(_tmp3AE->tl == 0){
if(Cyc_Toc_init_variable_array(_tmp3B5->type)){
struct _dyneither_ptr**_tmpAE9;index=((_tmpAE9=_cycalloc(sizeof(*_tmpAE9)),((_tmpAE9[0]=_tmp3B5->name,_tmpAE9))));}}{
# 1818
struct Cyc_List_List*_tmpAEA;new_fields=((_tmpAEA=_cycalloc(sizeof(*_tmpAEA)),((_tmpAEA->hd=_tmp3B5,((_tmpAEA->tl=new_fields,_tmpAEA))))));};}
# 1820
exist_types=0;
aggrfields=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(new_fields);
{struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct _tmpAED;struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_tmpAEC;struct_type=(void*)((_tmpAEC=_cycalloc(sizeof(*_tmpAEC)),((_tmpAEC[0]=((_tmpAED.tag=12,((_tmpAED.f1=ad->kind,((_tmpAED.f2=aggrfields,_tmpAED)))))),_tmpAEC))));}
...
if(_tmp3BE == 0){
const char*_tmpAF0;void*_tmpAEF;(_tmpAEF=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpAF0="empty designator list",_tag_dyneither(_tmpAF0,sizeof(char),22))),_tag_dyneither(_tmpAEF,sizeof(void*),0)));}
if(_tmp3BE->tl != 0){
# 1837
...
const char*_tmpAF3;void*_tmpAF2;(_tmpAF2=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpAF3="array designator in struct",_tag_dyneither(_tmpAF3,sizeof(char),27))),_tag_dyneither(_tmpAF2,sizeof(void*),0)));}_LL1DD:;}
# 1851
...
const char*_tmpAF6;void*_tmpAF5;(_tmpAF5=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpAF6="array designator in struct",_tag_dyneither(_tmpAF6,sizeof(char),27))),_tag_dyneither(_tmpAF5,sizeof(void*),0)));}_LL1E2:;}}}
# 1895
if(index != 0){
...
struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct _tmpAF9;struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmpAF8;return Cyc_Absyn_new_exp((void*)((_tmpAF8=_cycalloc(sizeof(*_tmpAF8)),((_tmpAF8[0]=((_tmpAF9.tag=4,((_tmpAF9.f1=e1,((_tmpAF9.f2=incr,_tmpAF9)))))),_tmpAF8)))),0);}
# 1914
...
# 1929
 e1->r=_tmp3E5->r;
{struct Cyc_List_List*_tmpAFA;Cyc_Toc_lvalue_assign(e1,((_tmpAFA=_cycalloc(sizeof(*_tmpAFA)),((_tmpAFA->hd=_tmp3E6,((_tmpAFA->tl=fs,_tmpAFA)))))),f,f_env);}
...
const char*_tmpAFE;void*_tmpAFD[1];struct Cyc_String_pa_PrintArg_struct _tmpAFC;(_tmpAFC.tag=0,((_tmpAFC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_stmt2string(s)),((_tmpAFD[0]=& _tmpAFC,Cyc_Toc_toc_impos(((_tmpAFE="lvalue_assign_stmt: %s",_tag_dyneither(_tmpAFE,sizeof(char),23))),_tag_dyneither(_tmpAFD,sizeof(void*),1)))))));}_LL1F9:;}
# 1956
...
const char*_tmpB02;void*_tmpB01[1];struct Cyc_String_pa_PrintArg_struct _tmpB00;(_tmpB00.tag=0,((_tmpB00.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmpB01[0]=& _tmpB00,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB02="can't take & of exp %s",_tag_dyneither(_tmpB02,sizeof(char),23))),_tag_dyneither(_tmpB01,sizeof(void*),1)))))));};_LL202:;}
# 1979
static void Cyc_Toc_push_address_stmt(struct Cyc_Absyn_Stmt*s){
...
# 1985
const char*_tmpB06;void*_tmpB05[1];struct Cyc_String_pa_PrintArg_struct _tmpB04;(_tmpB04.tag=0,((_tmpB04.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_stmt2string(s)),((_tmpB05[0]=& _tmpB04,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB06="can't take & of stmt %s",_tag_dyneither(_tmpB06,sizeof(char),24))),_tag_dyneither(_tmpB05,sizeof(void*),1)))))));}_LL20B:;}
# 1990
...
# 1994
if(x == 0)return 0;
{struct Cyc_List_List*_tmpB07;result=((_tmpB07=_region_malloc(r2,sizeof(*_tmpB07)),((_tmpB07->hd=f(x->hd,env),((_tmpB07->tl=0,_tmpB07))))));}
prev=result;
for(x=x->tl;x != 0;x=x->tl){
{struct Cyc_List_List*_tmpB08;((struct Cyc_List_List*)_check_null(prev))->tl=((_tmpB08=_region_malloc(r2,sizeof(*_tmpB08)),((_tmpB08->hd=f(x->hd,env),((_tmpB08->tl=0,_tmpB08))))));}
prev=prev->tl;}
# 2001
return result;}
# 2003
...
struct _tuple16*_tmpB09;return(_tmpB09=_cycalloc(sizeof(*_tmpB09)),((_tmpB09->f1=0,((_tmpB09->f2=e,_tmpB09)))));}
# 2011
...
const char*_tmpB0C;void*_tmpB0B;(_tmpB0B=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB0C="get_ptr_typ: not a pointer!",_tag_dyneither(_tmpB0C,sizeof(char),28))),_tag_dyneither(_tmpB0B,sizeof(void*),0)));}_LL214:;}
# 2021
...
{const char*_tmpB0D;res=Cyc_Absyn_const_exp(Cyc_Absyn_Float_c(((_tmpB0D="0.0F",_tag_dyneither(_tmpB0D,sizeof(char),5))),0),0);}goto _LL219;_LL22C: {struct Cyc_Absyn_FloatType_Absyn_Type_struct*_tmp421=(struct Cyc_Absyn_FloatType_Absyn_Type_struct*)_tmp412;if(_tmp421->tag != 7)goto _LL22E;else{if(_tmp421->f1 != 1)goto _LL22E;}}_LL22D:
{const char*_tmpB0E;res=Cyc_Absyn_const_exp(Cyc_Absyn_Float_c(((_tmpB0E="0.0",_tag_dyneither(_tmpB0E,sizeof(char),4))),1),0);}goto _LL219;_LL22E: {struct Cyc_Absyn_FloatType_Absyn_Type_struct*_tmp422=(struct Cyc_Absyn_FloatType_Absyn_Type_struct*)_tmp412;if(_tmp422->tag != 7)goto _LL230;else{_tmp423=_tmp422->f1;}}_LL22F:
{const char*_tmpB0F;res=Cyc_Absyn_const_exp(Cyc_Absyn_Float_c(((_tmpB0F="0.0L",_tag_dyneither(_tmpB0F,sizeof(char),5))),_tmp423),0);}goto _LL219;_LL230:;_LL231: {
# 2038
const char*_tmpB13;void*_tmpB12[1];struct Cyc_String_pa_PrintArg_struct _tmpB11;(_tmpB11.tag=0,((_tmpB11.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmpB12[0]=& _tmpB11,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB13="found non-zero type %s in generate_zero",_tag_dyneither(_tmpB13,sizeof(char),40))),_tag_dyneither(_tmpB12,sizeof(void*),1)))))));}_LL219:;}
# 2040
res->topt=t;
return res;}
# 2047
...
struct Cyc_Core_Opt*_tmpB14;struct Cyc_Core_Opt*_tmp42D=(_tmpB14=_cycalloc(sizeof(*_tmpB14)),((_tmpB14->v=_tmp42C,_tmpB14)));
...
{struct Cyc_Absyn_Exp*_tmpB15[3];xinit=Cyc_Absyn_fncall_exp(Cyc_Toc__dyneither_ptr_plus_e,(
(_tmpB15[2]=_tmp433,((_tmpB15[1]=Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(elt_type),0),((_tmpB15[0]=_tmp432,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB15,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0);}
goto _LL232;_LL237:;_LL238: {
const char*_tmpB18;void*_tmpB17;(_tmpB17=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB18="found bad lhs for zero-terminated pointer assignment",_tag_dyneither(_tmpB18,sizeof(char),53))),_tag_dyneither(_tmpB17,sizeof(void*),0)));}_LL232:;}{
# 2084
...
struct Cyc_Absyn_Vardecl*_tmpB19;struct Cyc_Absyn_Vardecl*_tmp43A=(_tmpB19=_cycalloc(sizeof(*_tmpB19)),((_tmpB19->sc=Cyc_Absyn_Public,((_tmpB19->name=_tmp437,((_tmpB19->tq=Cyc_Toc_mt_tq,((_tmpB19->type=_tmp42B,((_tmpB19->initializer=xinit,((_tmpB19->rgn=0,((_tmpB19->attributes=0,((_tmpB19->escapes=0,_tmpB19)))))))))))))))));
struct Cyc_Absyn_Local_b_Absyn_Binding_struct _tmpB1C;struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmpB1B;struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp43B=(_tmpB1B=_cycalloc(sizeof(*_tmpB1B)),((_tmpB1B[0]=((_tmpB1C.tag=4,((_tmpB1C.f1=_tmp43A,_tmpB1C)))),_tmpB1B)));
...
struct Cyc_Absyn_Vardecl*_tmpB1D;struct Cyc_Absyn_Vardecl*_tmp43F=(_tmpB1D=_cycalloc(sizeof(*_tmpB1D)),((_tmpB1D->sc=Cyc_Absyn_Public,((_tmpB1D->name=_tmp43E,((_tmpB1D->tq=Cyc_Toc_mt_tq,((_tmpB1D->type=_tmp42A,((_tmpB1D->initializer=_tmp43D,((_tmpB1D->rgn=0,((_tmpB1D->attributes=0,((_tmpB1D->escapes=0,_tmpB1D)))))))))))))))));
struct Cyc_Absyn_Local_b_Absyn_Binding_struct _tmpB20;struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmpB1F;struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp440=(_tmpB1F=_cycalloc(sizeof(*_tmpB1F)),((_tmpB1F[0]=((_tmpB20.tag=4,((_tmpB20.f1=_tmp43F,_tmpB20)))),_tmpB1F)));
...
struct Cyc_Absyn_Vardecl*_tmpB21;struct Cyc_Absyn_Vardecl*_tmp443=(_tmpB21=_cycalloc(sizeof(*_tmpB21)),((_tmpB21->sc=Cyc_Absyn_Public,((_tmpB21->name=_tmp442,((_tmpB21->tq=Cyc_Toc_mt_tq,((_tmpB21->type=_tmp42A,((_tmpB21->initializer=z_init,((_tmpB21->rgn=0,((_tmpB21->attributes=0,((_tmpB21->escapes=0,_tmpB21)))))))))))))))));
struct Cyc_Absyn_Local_b_Absyn_Binding_struct _tmpB24;struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmpB23;struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp444=(_tmpB23=_cycalloc(sizeof(*_tmpB23)),((_tmpB23[0]=((_tmpB24.tag=4,((_tmpB24.f1=_tmp443,_tmpB24)))),_tmpB23)));
...
# 2124
struct Cyc_Absyn_Exp*_tmpB25[2];struct Cyc_List_List*_tmp44B=(_tmpB25[1]=
Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(elt_type),0),((_tmpB25[0]=
# 2124
Cyc_Absyn_varb_exp(_tmp437,(void*)_tmp43B,0),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB25,sizeof(struct Cyc_Absyn_Exp*),2)))));
# 2126
...
{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmpB2B;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmpB2A;struct Cyc_Absyn_Decl*_tmpB29;_tmp452=Cyc_Absyn_decl_stmt(((_tmpB29=_cycalloc(sizeof(*_tmpB29)),((_tmpB29->r=(void*)((_tmpB2B=_cycalloc(sizeof(*_tmpB2B)),((_tmpB2B[0]=((_tmpB2A.tag=0,((_tmpB2A.f1=_tmp443,_tmpB2A)))),_tmpB2B)))),((_tmpB29->loc=0,_tmpB29)))))),_tmp452,0);}
{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmpB31;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmpB30;struct Cyc_Absyn_Decl*_tmpB2F;_tmp452=Cyc_Absyn_decl_stmt(((_tmpB2F=_cycalloc(sizeof(*_tmpB2F)),((_tmpB2F->r=(void*)((_tmpB31=_cycalloc(sizeof(*_tmpB31)),((_tmpB31[0]=((_tmpB30.tag=0,((_tmpB30.f1=_tmp43F,_tmpB30)))),_tmpB31)))),((_tmpB2F->loc=0,_tmpB2F)))))),_tmp452,0);}
{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmpB37;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmpB36;struct Cyc_Absyn_Decl*_tmpB35;_tmp452=Cyc_Absyn_decl_stmt(((_tmpB35=_cycalloc(sizeof(*_tmpB35)),((_tmpB35->r=(void*)((_tmpB37=_cycalloc(sizeof(*_tmpB37)),((_tmpB37[0]=((_tmpB36.tag=0,((_tmpB36.f1=_tmp43A,_tmpB36)))),_tmpB37)))),((_tmpB35->loc=0,_tmpB35)))))),_tmp452,0);}
...
struct Cyc_String_pa_PrintArg_struct _tmpB3F;void*_tmpB3E[1];const char*_tmpB3D;void*_tmpB3C;(_tmpB3C=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)((struct _dyneither_ptr)((_tmpB3F.tag=0,((_tmpB3F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(aggrtype)),((_tmpB3E[0]=& _tmpB3F,Cyc_aprintf(((_tmpB3D="expecting union but found %s in check_tagged_union",_tag_dyneither(_tmpB3D,sizeof(char),51))),_tag_dyneither(_tmpB3E,sizeof(void*),1)))))))),_tag_dyneither(_tmpB3C,sizeof(void*),0)));}_LL239:;}{
# 2168
...
const char*_tmpB42;void*_tmpB41;(_tmpB41=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB42="cast on lhs!",_tag_dyneither(_tmpB42,sizeof(char),13))),_tag_dyneither(_tmpB41,sizeof(void*),0)));}_LL241: {struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_tmp482=(struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp47F;if(_tmp482->tag != 20)goto _LL243;else{_tmp483=_tmp482->f1;_tmp484=_tmp482->f2;_tmp485=(int*)& _tmp482->f4;}}_LL242: {
# 2201
...
# 2206
const char*_tmpB47;void*_tmpB46[2];struct Cyc_String_pa_PrintArg_struct _tmpB45;struct Cyc_String_pa_PrintArg_struct _tmpB44;struct _dyneither_ptr str=(struct _dyneither_ptr)((_tmpB44.tag=0,((_tmpB44.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp484),((_tmpB45.tag=0,((_tmpB45.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp48F->name).f2),((_tmpB46[0]=& _tmpB45,((_tmpB46[1]=& _tmpB44,Cyc_aprintf(((_tmpB47="_union_%s_%s",_tag_dyneither(_tmpB47,sizeof(char),13))),_tag_dyneither(_tmpB46,sizeof(void*),2))))))))))))));
{struct _dyneither_ptr*_tmpB48;*tagged_member_type=Cyc_Absyn_strct(((_tmpB48=_cycalloc(sizeof(*_tmpB48)),((_tmpB48[0]=str,_tmpB48)))));}
...
# 2220
const char*_tmpB4D;void*_tmpB4C[2];struct Cyc_String_pa_PrintArg_struct _tmpB4B;struct Cyc_String_pa_PrintArg_struct _tmpB4A;struct _dyneither_ptr str=(struct _dyneither_ptr)((_tmpB4A.tag=0,((_tmpB4A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp488),((_tmpB4B.tag=0,((_tmpB4B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp49B->name).f2),((_tmpB4C[0]=& _tmpB4B,((_tmpB4C[1]=& _tmpB4A,Cyc_aprintf(((_tmpB4D="_union_%s_%s",_tag_dyneither(_tmpB4D,sizeof(char),13))),_tag_dyneither(_tmpB4C,sizeof(void*),2))))))))))))));
{struct _dyneither_ptr*_tmpB4E;*tagged_member_type=Cyc_Absyn_strct(((_tmpB4E=_cycalloc(sizeof(*_tmpB4E)),((_tmpB4E[0]=str,_tmpB4E)))));}
...
void*_tmp4A5=e->r;
if(e->topt == 0){
const char*_tmpB52;void*_tmpB51[1];struct Cyc_String_pa_PrintArg_struct _tmpB50;(_tmpB50.tag=0,((_tmpB50.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmpB51[0]=& _tmpB50,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB52="exp_to_c: no type for %s",_tag_dyneither(_tmpB52,sizeof(char),25))),_tag_dyneither(_tmpB51,sizeof(void*),1)))))));}{
# 2293
...
# 2305
struct Cyc_Absyn_Exp*_tmpB53[3];e->r=Cyc_Toc_fncall_exp_r(Cyc_Toc__tag_dyneither_e,((_tmpB53[2]=_tmp524,((_tmpB53[1]=_tmp524,((_tmpB53[0]=_tmp524,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB53,sizeof(struct Cyc_Absyn_Exp*),3)))))))));}}else{
# 2307
...
# 2314
const char*_tmpB57;void*_tmpB56[1];struct Cyc_String_pa_PrintArg_struct _tmpB55;(_tmpB55.tag=0,((_tmpB55.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp4AD)),((_tmpB56[0]=& _tmpB55,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB57="Can't find %s in exp_to_c, Var\n",_tag_dyneither(_tmpB57,sizeof(char),32))),_tag_dyneither(_tmpB56,sizeof(void*),1)))))));}_LL2AE: _tmp52C=_tmp52A;_LL2AF:(void)_throw(_tmp52C);_LL2AB:;}};}
# 2316
...
const char*_tmpB5A;void*_tmpB59;(_tmpB59=0,Cyc_Tcutil_terr(e->loc,((_tmpB5A="can't calculate numelts",_tag_dyneither(_tmpB5A,sizeof(char),24))),_tag_dyneither(_tmpB59,sizeof(void*),0)));}
...
# 2334
{struct Cyc_Absyn_Exp*_tmpB5B[2];e->r=Cyc_Toc_fncall_exp_r(Cyc_Toc__get_dyneither_size_e,(
(_tmpB5B[1]=
Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(_tmp535),0),((_tmpB5B[0]=(struct Cyc_Absyn_Exp*)_tmp4B1->hd,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB5B,sizeof(struct Cyc_Absyn_Exp*),2)))))));}
...
# 2344
struct Cyc_Absyn_Exp*_tmpB5C[2];e->r=Cyc_Toc_fncall_exp_r(function_e,((_tmpB5C[1]=_tmp53E,((_tmpB5C[0]=(struct Cyc_Absyn_Exp*)_tmp4B1->hd,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB5C,sizeof(struct Cyc_Absyn_Exp*),2)))))));}else{
if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp536)){
if(!Cyc_Evexp_c_can_eval(_tmp53E)){
const char*_tmpB5F;void*_tmpB5E;(_tmpB5E=0,Cyc_Tcutil_terr(e->loc,((_tmpB5F="can't calculate numelts",_tag_dyneither(_tmpB5F,sizeof(char),24))),_tag_dyneither(_tmpB5E,sizeof(void*),0)));}
# 2349
...
# 2357
const char*_tmpB64;void*_tmpB63[2];struct Cyc_String_pa_PrintArg_struct _tmpB62;struct Cyc_String_pa_PrintArg_struct _tmpB61;(_tmpB61.tag=0,((_tmpB61.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string((void*)_check_null(arg->topt))),((_tmpB62.tag=0,((_tmpB62.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(arg->topt))),((_tmpB63[0]=& _tmpB62,((_tmpB63[1]=& _tmpB61,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB64="size primop applied to non-array %s (%s)",_tag_dyneither(_tmpB64,sizeof(char),41))),_tag_dyneither(_tmpB63,sizeof(void*),2)))))))))))));}_LL2B2:;}
# 2360
...
(_tmpB65[2]=e2,((_tmpB65[1]=Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(_tmp549),0),((_tmpB65[0]=e1,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB65,sizeof(struct Cyc_Absyn_Exp*),3)))))))));}
...
struct Cyc_Absyn_Exp*e1=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp4B1))->hd;
struct Cyc_Absyn_Exp*e2=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp4B1->tl))->hd;
struct Cyc_Absyn_Exp*_tmpB66[3];e->r=(Cyc_Absyn_fncall_exp(Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__zero_arr_plus_functionSet,e1),((_tmpB66[2]=e2,((_tmpB66[1]=_tmp54F,((_tmpB66[0]=e1,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB66,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0))->r;}
# 2380
goto _LL2C4;_LL2C4:;}
# 2382
...
# 2401
struct Cyc_Absyn_Exp*_tmpB67[3];e->r=Cyc_Toc_fncall_exp_r(Cyc_Toc__dyneither_ptr_plus_e,(
(_tmpB67[2]=
Cyc_Absyn_prim1_exp(Cyc_Absyn_Minus,e2,0),((_tmpB67[1]=
# 2402
Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(elt_typ),0),((_tmpB67[0]=e1,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB67,sizeof(struct Cyc_Absyn_Exp*),3)))))))));}}
# 2406
...
int is_dyneither=0;
const char*_tmpB68;struct _dyneither_ptr incr_str=(_tmpB68="increment",_tag_dyneither(_tmpB68,sizeof(char),10));
if(_tmp4B4 == Cyc_Absyn_PreDec  || _tmp4B4 == Cyc_Absyn_PostDec){const char*_tmpB69;incr_str=((_tmpB69="decrement",_tag_dyneither(_tmpB69,sizeof(char),10)));}
if(Cyc_Tcutil_is_zero_ptr_deref(_tmp4B3,& ptr_type,& is_dyneither,& elt_type)){
{const char*_tmpB6D;void*_tmpB6C[1];struct Cyc_String_pa_PrintArg_struct _tmpB6B;(_tmpB6B.tag=0,((_tmpB6B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)incr_str),((_tmpB6C[0]=& _tmpB6B,Cyc_Tcutil_terr(e->loc,((_tmpB6D="in-place %s is not supported when dereferencing a zero-terminated pointer",_tag_dyneither(_tmpB6D,sizeof(char),74))),_tag_dyneither(_tmpB6C,sizeof(void*),1)))))));}{
const char*_tmpB70;void*_tmpB6F;(_tmpB6F=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB70="in-place inc/dec on zero-term",_tag_dyneither(_tmpB70,sizeof(char),30))),_tag_dyneither(_tmpB6F,sizeof(void*),0)));};}{
# 2446
...
# 2453
{struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct _tmpB76;struct Cyc_Core_Opt*_tmpB75;struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmpB74;e->r=(void*)((_tmpB74=_cycalloc(sizeof(*_tmpB74)),((_tmpB74[0]=((_tmpB76.tag=3,((_tmpB76.f1=_tmp4B3,((_tmpB76.f2=((_tmpB75=_cycalloc_atomic(sizeof(*_tmpB75)),((_tmpB75->v=(void*)Cyc_Absyn_Plus,_tmpB75)))),((_tmpB76.f3=_tmp559,_tmpB76)))))))),_tmpB74))));}
Cyc_Toc_exp_to_c(nv,e);
return;case Cyc_Absyn_PreDec: _LL2D2:
# 2457
{struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct _tmpB7C;struct Cyc_Core_Opt*_tmpB7B;struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmpB7A;e->r=(void*)((_tmpB7A=_cycalloc(sizeof(*_tmpB7A)),((_tmpB7A[0]=((_tmpB7C.tag=3,((_tmpB7C.f1=_tmp4B3,((_tmpB7C.f2=((_tmpB7B=_cycalloc_atomic(sizeof(*_tmpB7B)),((_tmpB7B->v=(void*)Cyc_Absyn_Minus,_tmpB7B)))),((_tmpB7C.f3=_tmp559,_tmpB7C)))))))),_tmpB7A))));}
Cyc_Toc_exp_to_c(nv,e);
return;default: _LL2D3:
# 2461
{const char*_tmpB80;void*_tmpB7F[1];struct Cyc_String_pa_PrintArg_struct _tmpB7E;(_tmpB7E.tag=0,((_tmpB7E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)incr_str),((_tmpB7F[0]=& _tmpB7E,Cyc_Tcutil_terr(e->loc,((_tmpB80="in-place post-%s is not supported on @tagged union members",_tag_dyneither(_tmpB80,sizeof(char),59))),_tag_dyneither(_tmpB7F,sizeof(void*),1)))))));}{
# 2463
const char*_tmpB83;void*_tmpB82;(_tmpB82=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB83="in-place inc/dec on @tagged union",_tag_dyneither(_tmpB83,sizeof(char),34))),_tag_dyneither(_tmpB82,sizeof(void*),0)));};}}
# 2466
...
change=- 1;{
struct Cyc_Absyn_Exp*_tmpB84[3];e->r=Cyc_Toc_fncall_exp_r(fn_e,((_tmpB84[2]=
# 2481
Cyc_Absyn_signed_int_exp(change,0),((_tmpB84[1]=
# 2480
Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(elt_typ),0),((_tmpB84[0]=
# 2479
Cyc_Toc_push_address_exp(_tmp4B3),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB84,sizeof(struct Cyc_Absyn_Exp*),3)))))))));};}else{
# 2482
...
struct Cyc_Absyn_Exp*_tmpB85[2];e->r=Cyc_Toc_fncall_exp_r(fn_e,((_tmpB85[1]=
Cyc_Absyn_signed_int_exp(1,0),((_tmpB85[0]=
# 2489
Cyc_Toc_push_address_exp(_tmp4B3),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB85,sizeof(struct Cyc_Absyn_Exp*),2)))))));}else{
# 2491
...
const char*_tmpB88;void*_tmpB87;(_tmpB87=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB88="bad t ? pointer arithmetic",_tag_dyneither(_tmpB88,sizeof(char),27))),_tag_dyneither(_tmpB87,sizeof(void*),0)));}}
# 2554
done=1;{
# 2556
struct Cyc_Absyn_Exp*_tmp56B=Cyc_Toc__dyneither_ptr_inplace_plus_e;
struct Cyc_Absyn_Exp*_tmpB89[3];e->r=Cyc_Toc_fncall_exp_r(_tmp56B,((_tmpB89[2]=change,((_tmpB89[1]=
Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(elt_typ),0),((_tmpB89[0]=
# 2557
Cyc_Toc_push_address_exp(_tmp4B6),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB89,sizeof(struct Cyc_Absyn_Exp*),3)))))))));};}else{
# 2560
if(Cyc_Tcutil_is_zero_pointer_typ_elt(old_typ,& elt_typ))
# 2563
...
{struct Cyc_Absyn_Exp*_tmpB8A[2];e->r=Cyc_Toc_fncall_exp_r(Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__zero_arr_inplace_plus_functionSet,_tmp4B6),((_tmpB8A[1]=_tmp4B8,((_tmpB8A[0]=_tmp4B6,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB8A,sizeof(struct Cyc_Absyn_Exp*),2)))))));}
break;default: _LL2DA: {
const char*_tmpB8D;void*_tmpB8C;(_tmpB8C=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB8D="bad zero-terminated pointer arithmetic",_tag_dyneither(_tmpB8D,sizeof(char),39))),_tag_dyneither(_tmpB8C,sizeof(void*),0)));}}}}
# 2572
if(!done){
# 2574
if(e1_poly)
...
{struct _tuple20 _tmpB90;struct _tuple20*_tmpB8F;((void(*)(struct Cyc_Absyn_Exp*e1,struct Cyc_List_List*fs,struct Cyc_Absyn_Exp*(*f)(struct Cyc_Absyn_Exp*,struct _tuple20*),struct _tuple20*f_env))Cyc_Toc_lvalue_assign)(_tmp4B6,0,Cyc_Toc_assignop_lvalue,((_tmpB8F=_cycalloc(sizeof(struct _tuple20)* 1),((_tmpB8F[0]=((_tmpB90.f1=_tmp4B7,((_tmpB90.f2=_tmp4B8,_tmpB90)))),_tmpB8F)))));}
e->r=_tmp4B6->r;}}
# 2585
...
struct Cyc_List_List*_tmpB91;new_args=((_tmpB91=_cycalloc(sizeof(*_tmpB91)),((_tmpB91->hd=(struct Cyc_Absyn_Exp*)_tmp4CB->hd,((_tmpB91->tl=new_args,_tmpB91))))));};}}
# 2633
{struct Cyc_Absyn_Exp*_tmpB94[3];struct Cyc_List_List*_tmpB93;new_args=((_tmpB93=_cycalloc(sizeof(*_tmpB93)),((_tmpB93->hd=Cyc_Absyn_fncall_exp(Cyc_Toc__tag_dyneither_e,(
(_tmpB94[2]=num_varargs_exp,((_tmpB94[1]=
Cyc_Absyn_sizeoftyp_exp(cva_type,0),((_tmpB94[0]=argvexp,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB94,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0),((_tmpB93->tl=new_args,_tmpB93))))));}
# 2638
...
const char*_tmpB97;void*_tmpB96;(_tmpB96=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpB97="toc: unknown datatype in vararg with inject",_tag_dyneither(_tmpB97,sizeof(char),44))),_tag_dyneither(_tmpB96,sizeof(void*),0)));}_LL2DC:;}{
# 2650
unsigned int _tmpB9C;unsigned int _tmpB9B;struct _dyneither_ptr _tmpB9A;struct _tuple0**_tmpB99;unsigned int _tmpB98;struct _dyneither_ptr vs=(_tmpB98=(unsigned int)_tmp4CC,((_tmpB99=(struct _tuple0**)_region_malloc(r,_check_times(sizeof(struct _tuple0*),_tmpB98)),((_tmpB9A=_tag_dyneither(_tmpB99,sizeof(struct _tuple0*),_tmpB98),((((_tmpB9B=_tmpB98,_tmpB9D(& _tmpB9C,& _tmpB9B,& _tmpB99))),_tmpB9A)))))));
# 2652
if(_tmp4CC != 0){
# 2654
struct Cyc_List_List*_tmp57B=0;
{int i=_tmp4CC - 1;for(0;i >= 0;-- i){
struct Cyc_List_List*_tmpB9E;_tmp57B=((_tmpB9E=_cycalloc(sizeof(*_tmpB9E)),((_tmpB9E->hd=Cyc_Toc_make_dle(Cyc_Absyn_address_exp(Cyc_Absyn_var_exp(*((struct _tuple0**)_check_dyneither_subscript(vs,sizeof(struct _tuple0*),i)),0),0)),((_tmpB9E->tl=_tmp57B,_tmpB9E))))));}}
# 2658
...
# 2689
struct _tuple16*_tmpB9F[3];struct Cyc_List_List*_tmp580=(_tmpB9F[2]=
Cyc_Toc_make_dle(Cyc_Absyn_uint_exp(0,0)),((_tmpB9F[1]=
# 2689
Cyc_Toc_make_dle(Cyc_Absyn_uint_exp(0,0)),((_tmpB9F[0]=Cyc_Toc_make_dle(Cyc_Absyn_uint_exp(0,0)),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpB9F,sizeof(struct _tuple16*),3)))))));
# 2691
...
{struct _tuple19 _tmpBA1;struct _tuple19 _tmp59A=(_tmpBA1.f1=_tmp595,((_tmpBA1.f2=_tmp596,_tmpBA1)));struct Cyc_Absyn_Exp*_tmp59C;struct Cyc_Absyn_Exp*_tmp59E;struct Cyc_Absyn_Exp*_tmp5A0;struct Cyc_Absyn_Exp*_tmp5A4;_LL2F0:{struct Cyc_Absyn_Upper_b_Absyn_Bounds_struct*_tmp59B=(struct Cyc_Absyn_Upper_b_Absyn_Bounds_struct*)_tmp59A.f1;if(_tmp59B->tag != 1)goto _LL2F2;else{_tmp59C=_tmp59B->f1;}}{struct Cyc_Absyn_Upper_b_Absyn_Bounds_struct*_tmp59D=(struct Cyc_Absyn_Upper_b_Absyn_Bounds_struct*)_tmp59A.f2;if(_tmp59D->tag != 1)goto _LL2F2;else{_tmp59E=_tmp59D->f1;}};_LL2F1:
# 2771
 if((!Cyc_Evexp_c_can_eval(_tmp59C) || !Cyc_Evexp_c_can_eval(_tmp59E)) && !
Cyc_Evexp_same_const_exp(_tmp59C,_tmp59E)){
const char*_tmpBA4;void*_tmpBA3;(_tmpBA3=0,Cyc_Tcutil_terr(e->loc,((_tmpBA4="can't validate cast due to potential size differences",_tag_dyneither(_tmpBA4,sizeof(char),54))),_tag_dyneither(_tmpBA3,sizeof(void*),0)));}
if(_tmp593  && !_tmp594){
if(Cyc_Toc_is_toplevel(nv)){
const char*_tmpBA7;void*_tmpBA6;(_tmpBA6=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(((_tmpBA7="can't do NULL-check conversion at top-level",_tag_dyneither(_tmpBA7,sizeof(char),44))),_tag_dyneither(_tmpBA6,sizeof(void*),0)));}
# 2780
if(_tmp4DA != Cyc_Absyn_NonNull_to_Null){
const char*_tmpBAB;void*_tmpBAA[1];struct Cyc_String_pa_PrintArg_struct _tmpBA9;(_tmpBA9.tag=0,((_tmpBA9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmpBAA[0]=& _tmpBA9,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpBAB="null-check conversion mis-classified: %s",_tag_dyneither(_tmpBAB,sizeof(char),41))),_tag_dyneither(_tmpBAA,sizeof(void*),1)))))));}{
int do_null_check=Cyc_Toc_need_null_check(_tmp4D8);
if(do_null_check){
if(!_tmp4D9){
const char*_tmpBAE;void*_tmpBAD;(_tmpBAD=0,Cyc_Tcutil_warn(e->loc,((_tmpBAE="inserted null check due to implicit cast from * to @ type",_tag_dyneither(_tmpBAE,sizeof(char),58))),_tag_dyneither(_tmpBAD,sizeof(void*),0)));}{
# 2787
struct Cyc_List_List*_tmpBAF;e->r=Cyc_Toc_cast_it_r(*_tmp4D7,Cyc_Absyn_fncall_exp(Cyc_Toc__check_null_e,(
(_tmpBAF=_cycalloc(sizeof(*_tmpBAF)),((_tmpBAF->hd=_tmp4D8,((_tmpBAF->tl=0,_tmpBAF)))))),0));};}else{
# 2790
...
const char*_tmpBB2;void*_tmpBB1;(_tmpBB1=0,Cyc_Tcutil_terr(e->loc,((_tmpBB2="cannot perform coercion since numelts cannot be determined statically.",_tag_dyneither(_tmpBB2,sizeof(char),71))),_tag_dyneither(_tmpBB1,sizeof(void*),0)));}
# 2807
if(_tmp4DA == Cyc_Absyn_NonNull_to_Null){
const char*_tmpBB6;void*_tmpBB5[1];struct Cyc_String_pa_PrintArg_struct _tmpBB4;(_tmpBB4.tag=0,((_tmpBB4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmpBB5[0]=& _tmpBB4,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpBB6="conversion mis-classified as null-check: %s",_tag_dyneither(_tmpBB6,sizeof(char),44))),_tag_dyneither(_tmpBB5,sizeof(void*),1)))))));}
if(Cyc_Toc_is_toplevel(nv)){
# 2811
...
# 2836
{struct Cyc_Absyn_Exp*_tmpBB7[2];arg3=Cyc_Absyn_fncall_exp(Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__get_zero_arr_size_functionSet,_tmp4D8),(
# 2838
(_tmpBB7[1]=_tmp5A0,((_tmpBB7[0]=Cyc_Toc_cast_it(Cyc_Absyn_void_star_typ(),_tmp5B8),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpBB7,sizeof(struct Cyc_Absyn_Exp*),2)))))),0);}
goto _LL2F8;_LL2F8:;}
# 2841
...
struct Cyc_Absyn_Exp*_tmpBB8[3];struct Cyc_Absyn_Exp*_tmp5BE=Cyc_Absyn_fncall_exp(_tmp5B6,((_tmpBB8[2]=arg3,((_tmpBB8[1]=_tmp5BD,((_tmpBB8[0]=_tmp5B8,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpBB8,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0);
...
# 2853
struct Cyc_Absyn_Exp*_tmpBB9[3];e->r=Cyc_Toc_fncall_exp_r(_tmp5B6,(
(_tmpBB9[2]=_tmp5A0,((_tmpBB9[1]=
Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(_tmp58F.elt_typ),0),((_tmpBB9[0]=_tmp4D8,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpBB9,sizeof(struct Cyc_Absyn_Exp*),3)))))))));}}
# 2859
...
const char*_tmpBBC;void*_tmpBBB;(_tmpBBB=0,Cyc_Tcutil_terr(e->loc,((_tmpBBC="cannot perform coercion since numelts cannot be determined statically.",_tag_dyneither(_tmpBBC,sizeof(char),71))),_tag_dyneither(_tmpBBB,sizeof(void*),0)));}
if(Cyc_Toc_is_toplevel(nv)){
const char*_tmpBBF;void*_tmpBBE;(_tmpBBE=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(((_tmpBBF="can't coerce t? to t* or t@ at the top-level",_tag_dyneither(_tmpBBF,sizeof(char),45))),_tag_dyneither(_tmpBBE,sizeof(void*),0)));}{
# 2873 "toc.cyc"
...
struct Cyc_Absyn_Exp*_tmpBC0[3];struct Cyc_Absyn_Exp*_tmp5C8=Cyc_Absyn_fncall_exp(_tmp5C7,(
(_tmpBC0[2]=_tmp5C6,((_tmpBC0[1]=
Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(_tmp58D.elt_typ),0),((_tmpBC0[0]=_tmp4D8,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpBC0,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0);
# 2885
if(_tmp594){
struct Cyc_List_List*_tmpBC1;_tmp5C8->r=Cyc_Toc_fncall_exp_r(Cyc_Toc__check_null_e,(
(_tmpBC1=_cycalloc(sizeof(*_tmpBC1)),((_tmpBC1->hd=Cyc_Absyn_copy_exp(_tmp5C8),((_tmpBC1->tl=0,_tmpBC1)))))));}
...
if(Cyc_Toc_is_toplevel(nv)){
const char*_tmpBC4;void*_tmpBC3;(_tmpBC3=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(((_tmpBC4="can't coerce a ZEROTERM to a non-const NOZEROTERM pointer at toplevel",_tag_dyneither(_tmpBC4,sizeof(char),70))),_tag_dyneither(_tmpBC3,sizeof(void*),0)));}{
struct Cyc_Absyn_Exp*_tmp5CD=Cyc_Toc__dyneither_ptr_decrease_size_e;
struct Cyc_Absyn_Exp*_tmpBC5[3];e->r=Cyc_Toc_fncall_exp_r(_tmp5CD,(
(_tmpBC5[2]=
Cyc_Absyn_uint_exp(1,0),((_tmpBC5[1]=
# 2899
Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(_tmp58D.elt_typ),0),((_tmpBC5[0]=_tmp4D8,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpBC5,sizeof(struct Cyc_Absyn_Exp*),3)))))))));};}
# 2902
goto _LL2EF;_LL2EF:;}
# 2904
...
# 2923
 if(Cyc_Toc_is_toplevel(nv)){
const char*_tmpBC9;void*_tmpBC8[1];struct Cyc_String_pa_PrintArg_struct _tmpBC7;(_tmpBC7.tag=0,((_tmpBC7.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Position_string_of_segment(_tmp4DC->loc)),((_tmpBC8[0]=& _tmpBC7,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(((_tmpBC9="%s: & on non-identifiers at the top-level",_tag_dyneither(_tmpBC9,sizeof(char),42))),_tag_dyneither(_tmpBC8,sizeof(void*),1)))))));}
...
# 2929
 if(Cyc_Toc_is_toplevel(nv)){
const char*_tmpBCD;void*_tmpBCC[1];struct Cyc_String_pa_PrintArg_struct _tmpBCB;(_tmpBCB.tag=0,((_tmpBCB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Position_string_of_segment(_tmp4DC->loc)),((_tmpBCC[0]=& _tmpBCB,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(((_tmpBCD="%s: & on non-identifiers at the top-level",_tag_dyneither(_tmpBCD,sizeof(char),42))),_tag_dyneither(_tmpBCC,sizeof(void*),1)))))));}
...
# 2948
 if(Cyc_Toc_is_toplevel(nv)){
const char*_tmpBD1;void*_tmpBD0[1];struct Cyc_String_pa_PrintArg_struct _tmpBCF;(_tmpBCF.tag=0,((_tmpBCF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Position_string_of_segment(_tmp4DF->loc)),((_tmpBD0[0]=& _tmpBCF,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(((_tmpBD1="%s: new at top-level",_tag_dyneither(_tmpBD1,sizeof(char),21))),_tag_dyneither(_tmpBD0,sizeof(void*),1)))))));}
...
# 2963
const char*_tmpBD4;void*_tmpBD3;old_elt_typ=(
(_tmpBD3=0,((void*(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpBD4="exp_to_c:new array expression doesn't have ptr type",_tag_dyneither(_tmpBD4,sizeof(char),52))),_tag_dyneither(_tmpBD3,sizeof(void*),0))));}_LL316:;}{
# 2966
...
const char*_tmpBD7;void*_tmpBD6;(_tmpBD6=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpBD7="exp_to_c: comprehension not an array type",_tag_dyneither(_tmpBD7,sizeof(char),42))),_tag_dyneither(_tmpBD6,sizeof(void*),0)));}_LL31B:;}{
# 2999
struct _tuple0*max=Cyc_Toc_temp_var();
...
struct _tuple21*_tmpBDA;struct Cyc_List_List*_tmpBD9;struct Cyc_List_List*decls=
(_tmpBD9=_region_malloc(r,sizeof(*_tmpBD9)),((_tmpBD9->hd=((_tmpBDA=_region_malloc(r,sizeof(*_tmpBDA)),((_tmpBDA->f1=max,((_tmpBDA->f2=Cyc_Absyn_uint_typ,((_tmpBDA->f3=_tmp5E6,_tmpBDA)))))))),((_tmpBD9->tl=0,_tmpBD9)))));
struct Cyc_Absyn_Exp*ai;
if(_tmp4DE == 0  || Cyc_Absyn_no_regions){
struct Cyc_Absyn_Exp*_tmpBDB[2];ai=Cyc_Toc_malloc_exp(old_elt_typ,
Cyc_Absyn_fncall_exp(Cyc_Toc__check_times_e,(
(_tmpBDB[1]=_tmp604,((_tmpBDB[0]=Cyc_Absyn_sizeoftyp_exp(elt_typ,0),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpBDB,sizeof(struct Cyc_Absyn_Exp*),2)))))),0));}else{
# 3022
struct Cyc_Absyn_Exp*r=_tmp4DE;
Cyc_Toc_exp_to_c(nv,r);{
struct Cyc_Absyn_Exp*_tmpBDC[2];ai=Cyc_Toc_rmalloc_exp(r,Cyc_Absyn_fncall_exp(Cyc_Toc__check_times_e,(
(_tmpBDC[1]=_tmp604,((_tmpBDC[0]=Cyc_Absyn_sizeoftyp_exp(elt_typ,0),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpBDC,sizeof(struct Cyc_Absyn_Exp*),2)))))),0));};}{
# 3029
struct Cyc_Absyn_Exp*ainit=Cyc_Toc_cast_it(ptr_typ,ai);
{struct _tuple21*_tmpBDF;struct Cyc_List_List*_tmpBDE;decls=((_tmpBDE=_region_malloc(r,sizeof(*_tmpBDE)),((_tmpBDE->hd=((_tmpBDF=_region_malloc(r,sizeof(*_tmpBDF)),((_tmpBDF->f1=a,((_tmpBDF->f2=ptr_typ,((_tmpBDF->f3=ainit,_tmpBDF)))))))),((_tmpBDE->tl=decls,_tmpBDE))))));}
if(is_dyneither_ptr){
...
struct Cyc_Absyn_Exp*_tmpBE0[3];struct Cyc_Absyn_Exp*_tmp60D=
Cyc_Absyn_fncall_exp(_tmp60C,(
(_tmpBE0[2]=_tmp604,((_tmpBE0[1]=Cyc_Absyn_sizeoftyp_exp(elt_typ,0),((_tmpBE0[0]=Cyc_Absyn_var_exp(a,0),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpBE0,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0);
# 3039
{struct _tuple21*_tmpBE3;struct Cyc_List_List*_tmpBE2;decls=((_tmpBE2=_region_malloc(r,sizeof(*_tmpBE2)),((_tmpBE2->hd=((_tmpBE3=_region_malloc(r,sizeof(*_tmpBE3)),((_tmpBE3->f1=_tmp60A,((_tmpBE3->f2=_tmp60B,((_tmpBE3->f3=_tmp60D,_tmpBE3)))))))),((_tmpBE2->tl=decls,_tmpBE2))))));}
...
{struct Cyc_Absyn_Exp*_tmpBE6[4];e->r=Cyc_Toc_fncall_exp_r(_tmp62A,(
(_tmpBE6[3]=_tmp629,((_tmpBE6[2]=
Cyc_Absyn_sizeoftyp_exp(Cyc_Toc_typ_to_c(_tmp621),0),((_tmpBE6[1]=_tmp61D,((_tmpBE6[0]=mexp,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpBE6,sizeof(struct Cyc_Absyn_Exp*),4)))))))))));}
# 3097
...
{struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct _tmpBE9;struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*_tmpBE8;e->r=(void*)((_tmpBE8=_cycalloc(sizeof(*_tmpBE8)),((_tmpBE8[0]=((_tmpBE9.tag=16,((_tmpBE9.f1=Cyc_Toc_typ_to_c(_tmp4E3),_tmpBE9)))),_tmpBE8))));}goto _LL256;_LL27F: {struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmp4E4=(struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp4A9;if(_tmp4E4->tag != 18)goto _LL281;else{_tmp4E5=(void*)_tmp4E4->f1;{struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp4E6=(struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*)((void*)_tmp4E4->f2);if(_tmp4E6->tag != 0)goto _LL281;else{_tmp4E7=_tmp4E6->f1;}};}}_LL280:
# 3121
{struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct _tmpBF3;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct _tmpBF2;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmpBF1;struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmpBF0;e->r=(void*)((_tmpBF0=_cycalloc(sizeof(*_tmpBF0)),((_tmpBF0[0]=((_tmpBF3.tag=18,((_tmpBF3.f1=Cyc_Toc_typ_to_c(_tmp4E5),((_tmpBF3.f2=(void*)((_tmpBF1=_cycalloc(sizeof(*_tmpBF1)),((_tmpBF1[0]=((_tmpBF2.tag=0,((_tmpBF2.f1=_tmp4E7,_tmpBF2)))),_tmpBF1)))),_tmpBF3)))))),_tmpBF0))));}goto _LL256;_LL281: {struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmp4E8=(struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp4A9;if(_tmp4E8->tag != 18)goto _LL283;else{_tmp4E9=(void*)_tmp4E8->f1;{struct Cyc_Absyn_TupleIndex_Absyn_OffsetofField_struct*_tmp4EA=(struct Cyc_Absyn_TupleIndex_Absyn_OffsetofField_struct*)((void*)_tmp4E8->f2);if(_tmp4EA->tag != 1)goto _LL283;else{_tmp4EB=_tmp4EA->f1;}};}}_LL282:
# 3123
...
if(_tmp63C->impl == 0){
const char*_tmpBF6;void*_tmpBF5;(_tmpBF5=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpBF6="struct fields must be known",_tag_dyneither(_tmpBF6,sizeof(char),28))),_tag_dyneither(_tmpBF5,sizeof(void*),0)));}
...
{struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct _tmpC00;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct _tmpBFF;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmpBFE;struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmpBFD;e->r=(void*)((_tmpBFD=_cycalloc(sizeof(*_tmpBFD)),((_tmpBFD[0]=((_tmpC00.tag=18,((_tmpC00.f1=Cyc_Toc_typ_to_c(_tmp4E9),((_tmpC00.f2=(void*)((_tmpBFE=_cycalloc(sizeof(*_tmpBFE)),((_tmpBFE[0]=((_tmpBFF.tag=0,((_tmpBFF.f1=_tmp63F->name,_tmpBFF)))),_tmpBFE)))),_tmpC00)))))),_tmpBFD))));}
...
# 3134
{struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct _tmpC0A;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct _tmpC09;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmpC08;struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmpC07;e->r=(void*)((_tmpC07=_cycalloc(sizeof(*_tmpC07)),((_tmpC07[0]=((_tmpC0A.tag=18,((_tmpC0A.f1=Cyc_Toc_typ_to_c(_tmp4E9),((_tmpC0A.f2=(void*)((_tmpC08=_cycalloc(sizeof(*_tmpC08)),((_tmpC08[0]=((_tmpC09.tag=0,((_tmpC09.f1=Cyc_Absyn_fieldname((int)(_tmp4EB + 1)),_tmpC09)))),_tmpC08)))),_tmpC0A)))))),_tmpC07))));}
...
# 3137
 if(_tmp4EB == 0){
struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct _tmpC14;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct _tmpC13;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmpC12;struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmpC11;e->r=(void*)((_tmpC11=_cycalloc(sizeof(*_tmpC11)),((_tmpC11[0]=((_tmpC14.tag=18,((_tmpC14.f1=Cyc_Toc_typ_to_c(_tmp4E9),((_tmpC14.f2=(void*)((_tmpC12=_cycalloc(sizeof(*_tmpC12)),((_tmpC12[0]=((_tmpC13.tag=0,((_tmpC13.f1=Cyc_Toc_tag_sp,_tmpC13)))),_tmpC12)))),_tmpC14)))))),_tmpC11))));}else{
# 3140
struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct _tmpC1E;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct _tmpC1D;struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmpC1C;struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmpC1B;e->r=(void*)((_tmpC1B=_cycalloc(sizeof(*_tmpC1B)),((_tmpC1B[0]=((_tmpC1E.tag=18,((_tmpC1E.f1=Cyc_Toc_typ_to_c(_tmp4E9),((_tmpC1E.f2=(void*)((_tmpC1C=_cycalloc(sizeof(*_tmpC1C)),((_tmpC1C[0]=((_tmpC1D.tag=0,((_tmpC1D.f1=Cyc_Absyn_fieldname((int)_tmp4EB),_tmpC1D)))),_tmpC1C)))),_tmpC1E)))))),_tmpC1B))));}
goto _LL32F;_LL338:;_LL339: {
const char*_tmpC21;void*_tmpC20;(_tmpC20=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpC21="impossible type for offsetof tuple index",_tag_dyneither(_tmpC21,sizeof(char),41))),_tag_dyneither(_tmpC20,sizeof(void*),0)));}_LL32F:;}
# 3144
...
const char*_tmpC24;void*_tmpC23;(_tmpC23=0,Cyc_Tcutil_warn(e->loc,((_tmpC24="inserted null check due to dereference",_tag_dyneither(_tmpC24,sizeof(char),39))),_tag_dyneither(_tmpC23,sizeof(void*),0)));}{
# 3159
struct Cyc_List_List*_tmpC25;_tmp4ED->r=Cyc_Toc_cast_it_r(Cyc_Toc_typ_to_c(_tmp653),
Cyc_Absyn_fncall_exp(Cyc_Toc__check_null_e,(
(_tmpC25=_cycalloc(sizeof(*_tmpC25)),((_tmpC25->hd=Cyc_Absyn_copy_exp(_tmp4ED),((_tmpC25->tl=0,_tmpC25)))))),0));};}
# 3167
...
const char*_tmpC28;void*_tmpC27;(_tmpC27=0,Cyc_Tcutil_terr(e->loc,((_tmpC28="cannot determine dereference is in bounds",_tag_dyneither(_tmpC28,sizeof(char),42))),_tag_dyneither(_tmpC27,sizeof(void*),0)));}}
# 3176
...
const char*_tmpC2B;void*_tmpC2A;(_tmpC2A=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpC2B="exp_to_c: Deref: non-pointer",_tag_dyneither(_tmpC2B,sizeof(char),29))),_tag_dyneither(_tmpC2A,sizeof(void*),0)));}_LL33A:;}
# 3188
...
if(_tmp679){
if(_tmp678 < 1){
const char*_tmpC2E;void*_tmpC2D;(_tmpC2D=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpC2E="exp_to_c:  AggrArrow_e on pointer of size 0",_tag_dyneither(_tmpC2E,sizeof(char),44))),_tag_dyneither(_tmpC2D,sizeof(void*),0)));}
if(do_null_check){
if(Cyc_Toc_warn_all_null_deref){
const char*_tmpC31;void*_tmpC30;(_tmpC30=0,Cyc_Tcutil_warn(e->loc,((_tmpC31="inserted null check due to dereference",_tag_dyneither(_tmpC31,sizeof(char),39))),_tag_dyneither(_tmpC30,sizeof(void*),0)));}{
# 3222
struct Cyc_Absyn_Exp*_tmpC32[1];_tmp4F4->r=Cyc_Toc_cast_it_r(Cyc_Toc_typ_to_c(e1typ),
Cyc_Absyn_fncall_exp(Cyc_Toc__check_null_e,(
(_tmpC32[0]=Cyc_Absyn_new_exp(_tmp4F4->r,0),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC32,sizeof(struct Cyc_Absyn_Exp*),1)))),0));};}}else{
# 3227
if(!Cyc_Evexp_c_can_eval(_tmp675)){
const char*_tmpC35;void*_tmpC34;(_tmpC34=0,Cyc_Tcutil_terr(e->loc,((_tmpC35="cannot determine pointer dereference in bounds",_tag_dyneither(_tmpC35,sizeof(char),47))),_tag_dyneither(_tmpC34,sizeof(void*),0)));}{
# 3231
struct Cyc_Absyn_Exp*_tmpC36[4];_tmp4F4->r=Cyc_Toc_cast_it_r(Cyc_Toc_typ_to_c(e1typ),
Cyc_Absyn_fncall_exp(Cyc_Toc__check_known_subscript_null_e,(
(_tmpC36[3]=
# 3235
Cyc_Absyn_uint_exp(0,0),((_tmpC36[2]=
# 3234
Cyc_Absyn_sizeoftyp_exp(_tmp66D,0),((_tmpC36[1]=_tmp675,((_tmpC36[0]=
# 3233
Cyc_Absyn_new_exp(_tmp4F4->r,0),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC36,sizeof(struct Cyc_Absyn_Exp*),4)))))))))),0));};}
# 3237
...
{struct Cyc_Absyn_Exp*_tmpC37[3];_tmp4F4->r=Cyc_Toc_cast_it_r(Cyc_Absyn_cstar_typ(ta1,_tmp66E),
Cyc_Absyn_fncall_exp(Cyc_Toc__check_dyneither_subscript_e,(
(_tmpC37[2]=
# 3245
Cyc_Absyn_uint_exp(0,0),((_tmpC37[1]=
# 3244
Cyc_Absyn_sizeoftyp_exp(ta1,0),((_tmpC37[0]=
# 3243
Cyc_Absyn_new_exp(_tmp4F4->r,0),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC37,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0));}
# 3248
goto _LL344;}_LL344:;}
# 3250
if(_tmp4F6  && _tmp4F7)
...
if(!_tmp691){
const char*_tmpC3A;void*_tmpC39;(_tmpC39=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpC3A="unknown tuple subscript in translation to C",_tag_dyneither(_tmpC3A,sizeof(char),44))),_tag_dyneither(_tmpC39,sizeof(void*),0)));}
...
const char*_tmpC3E;void*_tmpC3D[1];struct Cyc_String_pa_PrintArg_struct _tmpC3C;(_tmpC3C.tag=0,((_tmpC3C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmpC3D[0]=& _tmpC3C,Cyc_Tcutil_warn(e->loc,((_tmpC3E="bounds check necessary for %s",_tag_dyneither(_tmpC3E,sizeof(char),30))),_tag_dyneither(_tmpC3D,sizeof(void*),1)))))));}_LL350:;}
# 3289
Cyc_Toc_exp_to_c(nv,_tmp4F9);
Cyc_Toc_exp_to_c(nv,_tmp4FA);
...
const char*_tmpC41;void*_tmpC40;(_tmpC40=0,Cyc_Tcutil_terr(e->loc,((_tmpC41="cannot determine subscript is in bounds",_tag_dyneither(_tmpC41,sizeof(char),40))),_tag_dyneither(_tmpC40,sizeof(void*),0)));}{
struct Cyc_Absyn_Exp*function_e=Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__zero_arr_plus_functionSet,_tmp4F9);
struct Cyc_Absyn_Exp*_tmpC42[3];e->r=Cyc_Toc_deref_exp_r(Cyc_Toc_cast_it(ta2,
Cyc_Absyn_fncall_exp(function_e,(
(_tmpC42[2]=_tmp4FA,((_tmpC42[1]=_tmp69B,((_tmpC42[0]=_tmp4F9,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC42,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0)));};}else{
if(possibly_null){
if(!Cyc_Evexp_c_can_eval(_tmp69B)){
const char*_tmpC45;void*_tmpC44;(_tmpC44=0,Cyc_Tcutil_terr(e->loc,((_tmpC45="cannot determine subscript is in bounds",_tag_dyneither(_tmpC45,sizeof(char),40))),_tag_dyneither(_tmpC44,sizeof(void*),0)));}
if(Cyc_Toc_warn_all_null_deref){
const char*_tmpC48;void*_tmpC47;(_tmpC47=0,Cyc_Tcutil_warn(e->loc,((_tmpC48="inserted null check due to dereference",_tag_dyneither(_tmpC48,sizeof(char),39))),_tag_dyneither(_tmpC47,sizeof(void*),0)));}{
# 3314
struct Cyc_Absyn_Exp*_tmpC49[4];e->r=Cyc_Toc_deref_exp_r(Cyc_Toc_cast_it(ta2,
Cyc_Absyn_fncall_exp(Cyc_Toc__check_known_subscript_null_e,(
(_tmpC49[3]=_tmp4FA,((_tmpC49[2]=
Cyc_Absyn_sizeoftyp_exp(ta1,0),((_tmpC49[1]=_tmp69B,((_tmpC49[0]=_tmp4F9,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC49,sizeof(struct Cyc_Absyn_Exp*),4)))))))))),0)));};}else{
# 3320
if(!Cyc_Evexp_c_can_eval(_tmp69B)){
...
# 3323
struct Cyc_Absyn_Exp*_tmpC4D[2];_tmp4FA->r=Cyc_Toc_fncall_exp_r(Cyc_Toc__check_known_subscript_notnull_e,(
(_tmpC4D[1]=Cyc_Absyn_copy_exp(_tmp4FA),((_tmpC4D[0]=_tmp69B,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC4D,sizeof(struct Cyc_Absyn_Exp*),2)))))));};}}}
# 3326
...
struct Cyc_Absyn_Exp*_tmpC4E[3];e->r=Cyc_Toc_deref_exp_r(Cyc_Toc_cast_it(Cyc_Absyn_cstar_typ(ta1,_tmp68A),
Cyc_Absyn_fncall_exp(_tmp6A8,(
(_tmpC4E[2]=_tmp4FA,((_tmpC4E[1]=Cyc_Absyn_sizeoftyp_exp(ta1,0),((_tmpC4E[0]=_tmp4F9,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC4E,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0)));}
# 3343
goto _LL353;}_LL353:;}
# 3345
goto _LL349;}_LL34E:;_LL34F: {
const char*_tmpC51;void*_tmpC50;(_tmpC50=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpC51="exp_to_c: Subscript on non-tuple/array/tuple ptr",_tag_dyneither(_tmpC51,sizeof(char),49))),_tag_dyneither(_tmpC50,sizeof(void*),0)));}_LL349:;}
# 3348
...
struct _tuple16*_tmpC54;struct Cyc_List_List*_tmpC53;dles=((_tmpC53=_cycalloc(sizeof(*_tmpC53)),((_tmpC53->hd=((_tmpC54=_cycalloc(sizeof(*_tmpC54)),((_tmpC54->f1=0,((_tmpC54->f2=(struct Cyc_Absyn_Exp*)_tmp4FC->hd,_tmpC54)))))),((_tmpC53->tl=dles,_tmpC53))))));};}}
# 3363
...
if(!_tmp6B5){
const char*_tmpC57;void*_tmpC56;(_tmpC56=0,Cyc_Tcutil_terr(_tmp501->loc,((_tmpC57="cannot determine value of constant",_tag_dyneither(_tmpC57,sizeof(char),35))),_tag_dyneither(_tmpC56,sizeof(void*),0)));}
{unsigned int i=0;for(0;i < _tmp6B4;++ i){
struct _tuple16*_tmpC5A;struct Cyc_List_List*_tmpC59;es=((_tmpC59=_cycalloc(sizeof(*_tmpC59)),((_tmpC59->hd=((_tmpC5A=_cycalloc(sizeof(*_tmpC5A)),((_tmpC5A->f1=0,((_tmpC5A->f2=_tmp502,_tmpC5A)))))),((_tmpC59->tl=es,_tmpC59))))));}}
# 3390
if(_tmp503){
struct Cyc_Absyn_Exp*_tmp6BB=Cyc_Toc_cast_it(_tmp6B6,Cyc_Absyn_uint_exp(0,0));
struct _tuple16*_tmpC5D;struct Cyc_List_List*_tmpC5C;es=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(es,((_tmpC5C=_cycalloc(sizeof(*_tmpC5C)),((_tmpC5C->hd=((_tmpC5D=_cycalloc(sizeof(*_tmpC5D)),((_tmpC5D->f1=0,((_tmpC5D->f2=_tmp6BB,_tmpC5D)))))),((_tmpC5C->tl=0,_tmpC5C)))))));}}
# 3395
...
# 3408
if(_tmp508 == 0){
const char*_tmpC60;void*_tmpC5F;(_tmpC5F=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpC60="Aggregate_e: missing aggrdecl pointer",_tag_dyneither(_tmpC60,sizeof(char),38))),_tag_dyneither(_tmpC5F,sizeof(void*),0)));}{
...
struct _tuple16*_tmpC65;struct _tuple16*_tmpC64;struct _tuple16*_tmpC63[2];struct Cyc_List_List*_tmp6C7=(_tmpC63[1]=((_tmpC64=_cycalloc(sizeof(*_tmpC64)),((_tmpC64->f1=0,((_tmpC64->f2=_tmp6C4,_tmpC64)))))),((_tmpC63[0]=((_tmpC65=_cycalloc(sizeof(*_tmpC65)),((_tmpC65->f1=0,((_tmpC65->f2=field_tag_exp,_tmpC65)))))),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC63,sizeof(struct _tuple16*),2)))));
struct Cyc_Absyn_Exp*umem=Cyc_Absyn_unresolvedmem_exp(0,_tmp6C7,0);
struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_tmpC6B;struct Cyc_Absyn_FieldName_Absyn_Designator_struct _tmpC6A;void*_tmpC69[1];struct Cyc_List_List*ds=(_tmpC69[0]=(void*)((_tmpC6B=_cycalloc(sizeof(*_tmpC6B)),((_tmpC6B[0]=((_tmpC6A.tag=1,((_tmpC6A.f1=_tmp6C3->name,_tmpC6A)))),_tmpC6B)))),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC69,sizeof(void*),1)));
struct _tuple16*_tmpC6E;struct _tuple16*_tmpC6D[1];struct Cyc_List_List*dles=(_tmpC6D[0]=((_tmpC6E=_cycalloc(sizeof(*_tmpC6E)),((_tmpC6E->f1=ds,((_tmpC6E->f2=umem,_tmpC6E)))))),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC6D,sizeof(struct _tuple16*),1)));
...
void*_tmp6D6=Cyc_Toc_typ_to_c(_tmp6D4->type);
void*_tmp6D7=Cyc_Toc_typ_to_c((void*)_check_null(_tmp6D5->topt));
Cyc_Toc_exp_to_c(nv,_tmp6D5);
# 3446
if(!Cyc_Tcutil_unify(_tmp6D6,_tmp6D7)){
# 3448
if(!Cyc_Tcutil_is_arithmetic_type(_tmp6D6) || !
Cyc_Tcutil_is_arithmetic_type(_tmp6D7))
_tmp6D5=Cyc_Toc_cast_it(_tmp6D6,Cyc_Absyn_copy_exp(_tmp6D5));}
{struct _tuple16*_tmpC71;struct Cyc_List_List*_tmpC70;_tmp6D0=((_tmpC70=_cycalloc(sizeof(*_tmpC70)),((_tmpC70->hd=((_tmpC71=_cycalloc(sizeof(*_tmpC71)),((_tmpC71->f1=0,((_tmpC71->f2=_tmp6D5,_tmpC71)))))),((_tmpC70->tl=_tmp6D0,_tmpC70))))));}
break;};}}}
# 3455
...
const char*_tmpC75;void*_tmpC74[1];struct Cyc_String_pa_PrintArg_struct _tmpC73;(_tmpC73.tag=0,((_tmpC73.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp50A)),((_tmpC74[0]=& _tmpC73,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpC75="anon struct has type %s",_tag_dyneither(_tmpC75,sizeof(char),24))),_tag_dyneither(_tmpC74,sizeof(void*),1)))))));}_LL358:;}{
# 3466
...
struct _tuple16*_tmpC78;struct Cyc_List_List*_tmpC77;dles=((_tmpC77=_cycalloc(sizeof(*_tmpC77)),((_tmpC77->hd=((_tmpC78=_cycalloc(sizeof(*_tmpC78)),((_tmpC78->f1=0,((_tmpC78->f2=cur_e,_tmpC78)))))),((_tmpC77->tl=dles,_tmpC77))))));};}
# 3509
{struct _tuple16*_tmpC7B;struct Cyc_List_List*_tmpC7A;dles=((_tmpC7A=_cycalloc(sizeof(*_tmpC7A)),((_tmpC7A->hd=((_tmpC7B=_cycalloc(sizeof(*_tmpC7B)),((_tmpC7B->f1=0,((_tmpC7B->f2=tag_exp,_tmpC7B)))))),((_tmpC7A->tl=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles),_tmpC7A))))));}
e->r=Cyc_Toc_unresolvedmem_exp_r(0,dles);}else{
# 3515
struct Cyc_List_List*_tmpC7C;struct Cyc_List_List*_tmp6EF=
(_tmpC7C=_cycalloc(sizeof(*_tmpC7C)),((_tmpC7C->hd=Cyc_Absyn_assign_stmt(Cyc_Toc_member_exp(mem_exp,Cyc_Toc_tag_sp,0),tag_exp,0),((_tmpC7C->tl=0,_tmpC7C)))));
# 3518
...
# 3528
struct Cyc_List_List*_tmpC7D;_tmp6EF=((_tmpC7D=_cycalloc(sizeof(*_tmpC7D)),((_tmpC7D->hd=_tmp6F1,((_tmpC7D->tl=_tmp6EF,_tmpC7D))))));};}}{
# 3530
struct Cyc_Absyn_Stmt*_tmp6F3=Cyc_Absyn_exp_stmt(_tmp6E8,0);
struct Cyc_List_List*_tmpC7E;struct Cyc_Absyn_Stmt*_tmp6F4=Cyc_Absyn_seq_stmts(((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(((_tmpC7E=_cycalloc(sizeof(*_tmpC7E)),((_tmpC7E->hd=_tmp6F3,((_tmpC7E->tl=_tmp6EF,_tmpC7E))))))),0);
...
# 3557
struct Cyc_Absyn_Exp*_tmpC7F[3];rexp=Cyc_Absyn_fncall_exp(Cyc_Toc__tag_dyneither_e,(
(_tmpC7F[2]=
Cyc_Absyn_var_exp(_tmp6F7,0),((_tmpC7F[1]=
# 3558
Cyc_Absyn_sizeoftyp_exp(t_c,0),((_tmpC7F[0]=Cyc_Absyn_var_exp(_tmp6F8,0),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC7F,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0);};}else{
# 3561
if(_tmp514 != 0  && !Cyc_Absyn_no_regions){
struct Cyc_Absyn_Exp*rgn=_tmp514;
Cyc_Toc_exp_to_c(nv,rgn);
...
# 3568
struct Cyc_Absyn_Exp*_tmpC80[3];rexp=Cyc_Absyn_fncall_exp(Cyc_Toc__tag_dyneither_e,((_tmpC80[2]=
Cyc_Absyn_var_exp(_tmp6F7,0),((_tmpC80[1]=
# 3568
Cyc_Absyn_uint_exp(1,0),((_tmpC80[0]=Cyc_Absyn_var_exp(_tmp6F8,0),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC80,sizeof(struct Cyc_Absyn_Exp*),3)))))))),0);};}{
# 3571
...
const char*_tmpC83;void*_tmpC82;(_tmpC82=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpC83="Swap_e: is_pointer_or_boxed: not a pointer or boxed type",_tag_dyneither(_tmpC83,sizeof(char),57))),_tag_dyneither(_tmpC82,sizeof(void*),0)));}{
# 3610
...
# 3643
{struct Cyc_Absyn_Exp*_tmpC84[2];e->r=Cyc_Toc_fncall_exp_r(swap_fn,((_tmpC84[1]=_tmp51A,((_tmpC84[0]=_tmp519,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpC84,sizeof(struct Cyc_Absyn_Exp*),2)))))));}
# 3645
...
const char*_tmpC87;void*_tmpC86;(_tmpC86=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpC87="non-aggregate type in tagcheck",_tag_dyneither(_tmpC87,sizeof(char),31))),_tag_dyneither(_tmpC86,sizeof(void*),0)));}_LL35D:;}
# 3659
...
const char*_tmpC8A;void*_tmpC89;(_tmpC89=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpC8A="UnresolvedMem",_tag_dyneither(_tmpC8A,sizeof(char),14))),_tag_dyneither(_tmpC89,sizeof(void*),0)));}_LL2A5: {struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*_tmp521=(struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp4A9;if(_tmp521->tag != 24)goto _LL2A7;}_LL2A6: {
const char*_tmpC8D;void*_tmpC8C;(_tmpC8C=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_unimp)(((_tmpC8D="compoundlit",_tag_dyneither(_tmpC8D,sizeof(char),12))),_tag_dyneither(_tmpC8C,sizeof(void*),0)));}_LL2A7: {struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp522=(struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmp4A9;if(_tmp522->tag != 37)goto _LL2A9;}_LL2A8: {
const char*_tmpC90;void*_tmpC8F;(_tmpC8F=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpC90="valueof(-)",_tag_dyneither(_tmpC90,sizeof(char),11))),_tag_dyneither(_tmpC8F,sizeof(void*),0)));}_LL2A9: {struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*_tmp523=(struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmp4A9;if(_tmp523->tag != 38)goto _LL256;}_LL2AA: {
const char*_tmpC93;void*_tmpC92;(_tmpC92=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpC93="__asm__",_tag_dyneither(_tmpC93,sizeof(char),8))),_tag_dyneither(_tmpC92,sizeof(void*),0)));}_LL256:;};}
# 3696 "toc.cyc"
...
{struct _tuple24*_tmpC96;struct Cyc_List_List*_tmpC95;decls=((_tmpC95=_region_malloc(rgn,sizeof(*_tmpC95)),((_tmpC95->hd=((_tmpC96=_region_malloc(rgn,sizeof(*_tmpC96)),((_tmpC96->f1=v,((_tmpC96->f2=Cyc_Toc_typ_to_c_array(_tmp742),_tmpC96)))))),((_tmpC95->tl=decls,_tmpC95))))));}{
...
{struct _tuple24*_tmpC99;struct Cyc_List_List*_tmpC98;decls=((_tmpC98=_region_malloc(rgn,sizeof(*_tmpC98)),((_tmpC98->hd=((_tmpC99=_region_malloc(rgn,sizeof(*_tmpC99)),((_tmpC99->f1=_tmp748,((_tmpC99->f2=Cyc_Toc_typ_to_c_array(_tmp749),_tmpC99)))))),((_tmpC98->tl=decls,_tmpC98))))));}
...
{struct _tuple24*_tmpC9C;struct Cyc_List_List*_tmpC9B;decls=((_tmpC9B=_region_malloc(rgn,sizeof(*_tmpC9B)),((_tmpC9B->hd=((_tmpC9C=_region_malloc(rgn,sizeof(*_tmpC9C)),((_tmpC9C->f1=_tmp74C,((_tmpC9C->f2=Cyc_Absyn_cstar_typ(Cyc_Toc_typ_to_c_array(t),Cyc_Toc_mt_tq),_tmpC9C)))))),((_tmpC9B->tl=decls,_tmpC9B))))));}
...
# 3758
{struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct _tmpC9F;struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmpC9E;s=Cyc_Toc_if_neq_stmt(r,Cyc_Absyn_new_exp((void*)((_tmpC9E=_cycalloc(sizeof(*_tmpC9E)),((_tmpC9E[0]=((_tmpC9F.tag=30,((_tmpC9F.f1=_tmp72C->name,((_tmpC9F.f2=_tmp72B,((_tmpC9F.f3=_tmp72C,_tmpC9F)))))))),_tmpC9E)))),0),fail_stmt);}
...
# 3761
{struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct _tmpCA2;struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmpCA1;s=Cyc_Toc_if_neq_stmt(r,Cyc_Absyn_new_exp((void*)((_tmpCA1=_cycalloc(sizeof(*_tmpCA1)),((_tmpCA1[0]=((_tmpCA2.tag=31,((_tmpCA2.f1=_tmp72F->name,((_tmpCA2.f2=_tmp72E,((_tmpCA2.f3=_tmp72F,_tmpCA2)))))))),_tmpCA1)))),0),fail_stmt);}
...
# 3833
const char*_tmpCA5;void*_tmpCA4;(_tmpCA4=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpCA5="unresolved aggregate pattern!",_tag_dyneither(_tmpCA5,sizeof(char),30))),_tag_dyneither(_tmpCA4,sizeof(void*),0)));}_LL388: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp73A=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp717;if(_tmp73A->tag != 6)goto _LL38A;else{if(_tmp73A->f1 == 0)goto _LL38A;_tmp73B=(_tmp73A->f1)->aggr_info;_tmp73C=_tmp73A->f3;}}_LL389: {
# 3835
...
const char*_tmpCA8;void*_tmpCA7;(_tmpCA7=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpCA8="no field name in tagged union pattern",_tag_dyneither(_tmpCA8,sizeof(char),38))),_tag_dyneither(_tmpCA7,sizeof(void*),0)));}_LL392:;}{
# 3846
...
struct Cyc_Toc_Match_error_exn_struct _tmpCAB;struct Cyc_Toc_Match_error_exn_struct*_tmpCAA;(int)_throw((void*)((_tmpCAA=_cycalloc_atomic(sizeof(*_tmpCAA)),((_tmpCAA[0]=((_tmpCAB.tag=Cyc_Toc_Match_error,_tmpCAB)),_tmpCAA)))));}_LL397:;}{
# 3879
...
const char*_tmpCAE;void*_tmpCAD;(_tmpCAD=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpCAE="unknownid pat",_tag_dyneither(_tmpCAE,sizeof(char),14))),_tag_dyneither(_tmpCAD,sizeof(void*),0)));}_LL38E: {struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*_tmp740=(struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*)_tmp717;if(_tmp740->tag != 15)goto _LL390;}_LL38F: {
const char*_tmpCB1;void*_tmpCB0;(_tmpCB0=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpCB1="unknowncall pat",_tag_dyneither(_tmpCB1,sizeof(char),16))),_tag_dyneither(_tmpCB0,sizeof(void*),0)));}_LL390: {struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*_tmp741=(struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp717;if(_tmp741->tag != 16)goto _LL36B;}_LL391: {
const char*_tmpCB4;void*_tmpCB3;(_tmpCB3=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpCB4="exp pat",_tag_dyneither(_tmpCB4,sizeof(char),8))),_tag_dyneither(_tmpCB3,sizeof(void*),0)));}_LL36B:;}{
# 3913
struct _tuple23 _tmpCB5;return(_tmpCB5.f1=nv,((_tmpCB5.f2=decls,((_tmpCB5.f3=s,_tmpCB5)))));};}struct _tuple26{struct _dyneither_ptr*f1;struct _dyneither_ptr*f2;struct Cyc_Absyn_Switch_clause*f3;};
# 3950 "toc.cyc"
static struct _tuple26*Cyc_Toc_gen_label(struct _RegionHandle*r,struct Cyc_Absyn_Switch_clause*sc){
# 3952
struct _tuple26*_tmpCB6;return(_tmpCB6=_region_malloc(r,sizeof(*_tmpCB6)),((_tmpCB6->f1=Cyc_Toc_fresh_label(),((_tmpCB6->f2=Cyc_Toc_fresh_label(),((_tmpCB6->f3=sc,_tmpCB6)))))));}
# 3955
...
# 4016
decls=_tmp796;
{struct Cyc_List_List*_tmpCB7;nvs=((_tmpCB7=_region_malloc(rgn,sizeof(*_tmpCB7)),((_tmpCB7->hd=_tmp795,((_tmpCB7->tl=nvs,_tmpCB7))))));}{
struct Cyc_List_List*_tmpCB8;test_stmts=((_tmpCB8=_region_malloc(rgn,sizeof(*_tmpCB8)),((_tmpCB8->hd=_tmp797,((_tmpCB8->tl=test_stmts,_tmpCB8))))));};}}
# 4020
...
struct Cyc_List_List*_tmpCB9;stmts=((_tmpCB9=_region_malloc(rgn,sizeof(*_tmpCB9)),((_tmpCB9->hd=s,((_tmpCB9->tl=stmts,_tmpCB9))))));};
# 4030
;_pop_region(rgn2);};}{
# 4044
...
struct Cyc_List_List*_tmpCBA;return Cyc_Absyn_exp_stmt(Cyc_Absyn_fncall_exp(Cyc_Toc__npop_handler_e,(
(_tmpCBA=_cycalloc(sizeof(*_tmpCBA)),((_tmpCBA->hd=Cyc_Absyn_uint_exp((unsigned int)(n - 1),0),((_tmpCBA->tl=0,_tmpCBA)))))),0),0);}
# 4069
...
if(_tmp7E1 == 0){
const char*_tmpCBD;void*_tmpCBC;(_tmpCBC=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpCBD="fallthru in unexpected place",_tag_dyneither(_tmpCBD,sizeof(char),29))),_tag_dyneither(_tmpCBC,sizeof(void*),0)));}{
...
struct Cyc_Absyn_Local_b_Absyn_Binding_struct _tmpCC0;struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmpCBF;struct Cyc_Toc_Env*_tmp7FD=Cyc_Toc_add_varmap(temp,nv,_tmp7EC->name,
Cyc_Absyn_varb_exp(_tmp7EC->name,(void*)((_tmpCBF=_cycalloc(sizeof(*_tmpCBF)),((_tmpCBF[0]=((_tmpCC0.tag=4,((_tmpCC0.f1=_tmp7EC,_tmpCC0)))),_tmpCBF)))),0));
...
{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmpCC3;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmpCC2;_tmp7CB->r=(void*)((_tmpCC2=_cycalloc(sizeof(*_tmpCC2)),((_tmpCC2[0]=((_tmpCC3.tag=0,((_tmpCC3.f1=_tmp802,_tmpCC3)))),_tmpCC2))));}{
struct _RegionHandle _tmp806=_new_region("temp");struct _RegionHandle*temp=& _tmp806;_push_region(temp);{
struct Cyc_Absyn_Local_b_Absyn_Binding_struct _tmpCC6;struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmpCC5;struct Cyc_Toc_Env*_tmp807=
Cyc_Toc_add_varmap(temp,nv,old_name,
Cyc_Absyn_varb_exp(new_name,(void*)((_tmpCC5=_cycalloc(sizeof(*_tmpCC5)),((_tmpCC5[0]=((_tmpCC6.tag=4,((_tmpCC6.f1=_tmp802,_tmpCC6)))),_tmpCC5)))),0));
...
if(_tmp80A == 0){
const char*_tmpCC9;void*_tmpCC8;(_tmpCC8=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpCC9="empty Letv_d",_tag_dyneither(_tmpCC9,sizeof(char),13))),_tag_dyneither(_tmpCC8,sizeof(void*),0)));}
{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmpCCC;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmpCCB;_tmp7CB->r=(void*)((_tmpCCB=_cycalloc(sizeof(*_tmpCCB)),((_tmpCCB[0]=((_tmpCCC.tag=0,((_tmpCCC.f1=(struct Cyc_Absyn_Vardecl*)_tmp80A->hd,_tmpCCC)))),_tmpCCB))));}
_tmp80A=_tmp80A->tl;
for(0;_tmp80A != 0;_tmp80A=_tmp80A->tl){
struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmpCCF;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmpCCE;struct Cyc_Absyn_Decl*_tmp80F=Cyc_Absyn_new_decl((void*)((_tmpCCE=_cycalloc(sizeof(*_tmpCCE)),((_tmpCCE[0]=((_tmpCCF.tag=0,((_tmpCCF.f1=(struct Cyc_Absyn_Vardecl*)_tmp80A->hd,_tmpCCF)))),_tmpCCE)))),0);
...
if(_tmp7F8 == 0){
struct Cyc_Absyn_Exp*_tmpCD2[1];struct Cyc_Absyn_Exp*_tmpCD1[1];struct Cyc_List_List*_tmpCD0;s->r=(
Cyc_Absyn_declare_stmt(rh_var,rh_struct_typ,
Cyc_Absyn_fncall_exp(Cyc_Toc__new_region_e,(
(_tmpCD0=_cycalloc(sizeof(*_tmpCD0)),((_tmpCD0->hd=Cyc_Absyn_string_exp(Cyc_Absynpp_qvar2string(x_var),0),((_tmpCD0->tl=0,_tmpCD0)))))),0),
# 4264
Cyc_Absyn_declare_stmt(x_var,rh_struct_ptr_typ,Cyc_Absyn_address_exp(rh_exp,0),
Cyc_Absyn_seq_stmt(Cyc_Absyn_exp_stmt(Cyc_Absyn_fncall_exp(Cyc_Toc__push_region_e,((_tmpCD1[0]=x_exp,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpCD1,sizeof(struct Cyc_Absyn_Exp*),1)))),0),0),
Cyc_Absyn_seq_stmt(_tmp815,
Cyc_Absyn_exp_stmt(Cyc_Absyn_fncall_exp(Cyc_Toc__pop_region_e,((_tmpCD2[0]=x_exp,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpCD2,sizeof(struct Cyc_Absyn_Exp*),1)))),0),0),0),0),0),0))->r;}else{
# 4270
Cyc_Toc_exp_to_c(nv,_tmp7F8);{
struct Cyc_Absyn_Exp*_tmpCD4[1];struct Cyc_Absyn_Exp*_tmpCD3[2];s->r=(
...
(_tmpCD3[1]=_tmp7F8,((_tmpCD3[0]=Cyc_Absyn_address_exp(rh_exp,0),((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpCD3,sizeof(struct Cyc_Absyn_Exp*),2)))))),0),
# 4278
Cyc_Absyn_seq_stmt(_tmp815,
Cyc_Absyn_exp_stmt(Cyc_Absyn_fncall_exp(Cyc_Toc__pop_dynregion_e,(
(_tmpCD4[0]=x_exp,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpCD4,sizeof(struct Cyc_Absyn_Exp*),1)))),0),0),0),0),0))->r;};}}
# 4283
_npop_handler(0);return;
# 4252
...
{struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct _tmpCE3;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmpCE2;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmpCE1;struct Cyc_Absyn_Decl*_tmpCE0;struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*_tmpCDF;s->r=(void*)((_tmpCDF=_cycalloc(sizeof(*_tmpCDF)),((_tmpCDF[0]=((_tmpCE3.tag=12,((_tmpCE3.f1=((_tmpCE0=_cycalloc(sizeof(*_tmpCE0)),((_tmpCE0->r=(void*)((_tmpCE2=_cycalloc(sizeof(*_tmpCE2)),((_tmpCE2[0]=((_tmpCE1.tag=0,((_tmpCE1.f1=_tmp7FB,_tmpCE1)))),_tmpCE2)))),((_tmpCE0->loc=0,_tmpCE0)))))),((_tmpCE3.f2=_tmp7CC,_tmpCE3)))))),_tmpCDF))));}{
struct _RegionHandle _tmp821=_new_region("temp");struct _RegionHandle*temp=& _tmp821;_push_region(temp);{
struct Cyc_Absyn_Local_b_Absyn_Binding_struct _tmpCE6;struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmpCE5;struct Cyc_Toc_Env*_tmp822=
Cyc_Toc_add_varmap(temp,nv,old_name,
Cyc_Absyn_varb_exp(new_name,(void*)((_tmpCE5=_cycalloc(sizeof(*_tmpCE5)),((_tmpCE5[0]=((_tmpCE6.tag=4,((_tmpCE6.f1=_tmp7FB,_tmpCE6)))),_tmpCE5)))),0));
...
# 4298
const char*_tmpCE9;void*_tmpCE8;(_tmpCE8=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpCE9="bad nested declaration within function",_tag_dyneither(_tmpCE9,sizeof(char),39))),_tag_dyneither(_tmpCE8,sizeof(void*),0)));}_LL3C6:;}
# 4300
...
struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmpCF3;struct Cyc_Absyn_Pat*_tmpCF2;struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct _tmpCF1;struct Cyc_Absyn_Pat*_tmpCF0;struct Cyc_Absyn_Pat*_tmp82E=(_tmpCF0=_cycalloc(sizeof(*_tmpCF0)),((_tmpCF0->r=(void*)((_tmpCF3=_cycalloc(sizeof(*_tmpCF3)),((_tmpCF3[0]=((_tmpCF1.tag=1,((_tmpCF1.f1=_tmp82D,((_tmpCF1.f2=((_tmpCF2=_cycalloc(sizeof(*_tmpCF2)),((_tmpCF2->r=(void*)& Cyc_Absyn_Wild_p_val,((_tmpCF2->topt=Cyc_Absyn_exn_typ(),((_tmpCF2->loc=0,_tmpCF2)))))))),_tmpCF1)))))),_tmpCF3)))),((_tmpCF0->topt=Cyc_Absyn_exn_typ(),((_tmpCF0->loc=0,_tmpCF0)))))));
...
struct Cyc_Core_Opt*_tmpCF9;struct Cyc_List_List*_tmpCF8;struct Cyc_Absyn_Switch_clause*_tmpCF7;struct Cyc_Absyn_Switch_clause*_tmp831=
(_tmpCF7=_cycalloc(sizeof(*_tmpCF7)),((_tmpCF7->pattern=_tmp82E,((_tmpCF7->pat_vars=((_tmpCF9=_cycalloc(sizeof(*_tmpCF9)),((_tmpCF9->v=((_tmpCF8=_cycalloc(sizeof(*_tmpCF8)),((_tmpCF8->hd=_tmp82D,((_tmpCF8->tl=0,_tmpCF8)))))),_tmpCF9)))),((_tmpCF7->where_clause=0,((_tmpCF7->body=_tmp830,((_tmpCF7->loc=0,_tmpCF7)))))))))));
# 4357
struct Cyc_List_List*_tmpCFA;struct Cyc_Absyn_Stmt*_tmp832=Cyc_Absyn_switch_stmt(e_exp,
((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp7D5,(
(_tmpCFA=_cycalloc(sizeof(*_tmpCFA)),((_tmpCFA->hd=_tmp831,((_tmpCFA->tl=0,_tmpCFA))))))),0);
# 4361
Cyc_Toc_stmt_to_c(_tmp829,_tmp832);{
# 4364
struct Cyc_List_List*_tmpCFB;struct Cyc_Absyn_Exp*_tmp833=
Cyc_Absyn_fncall_exp(Cyc_Toc_setjmp_e,(
(_tmpCFB=_cycalloc(sizeof(*_tmpCFB)),((_tmpCFB->hd=Cyc_Toc_member_exp(h_exp,Cyc_Toc_handler_sp,0),((_tmpCFB->tl=0,_tmpCFB)))))),0);
# 4368
struct Cyc_List_List*_tmpCFC;struct Cyc_Absyn_Stmt*_tmp834=
Cyc_Absyn_exp_stmt(Cyc_Absyn_fncall_exp(Cyc_Toc__push_handler_e,(
(_tmpCFC=_cycalloc(sizeof(*_tmpCFC)),((_tmpCFC->hd=Cyc_Absyn_address_exp(h_exp,0),((_tmpCFC->tl=0,_tmpCFC)))))),0),0);
# 4372
...
struct Cyc_List_List*_tmpCFD;s->r=Cyc_Toc_exp_stmt_r(Cyc_Absyn_fncall_exp(Cyc_Toc__reset_region_e,((_tmpCFD=_cycalloc(sizeof(*_tmpCFD)),((_tmpCFD->hd=_tmp7D7,((_tmpCFD->tl=0,_tmpCFD)))))),0));};}
# 4395
return;_LL3A3:;}}
# 4404
...
struct _tuple0*_tmpCFE;struct _tuple0*_tmp845=(_tmpCFE=_cycalloc(sizeof(*_tmpCFE)),((_tmpCFE->f1=Cyc_Absyn_Loc_n,((_tmpCFE->f2=(*((struct _tuple8*)_tmp844->hd)).f1,_tmpCFE)))));
...
struct _tuple0*_tmpCFF;struct _tuple0*_tmp84D=(_tmpCFF=_cycalloc(sizeof(*_tmpCFF)),((_tmpCFF->f1=Cyc_Absyn_Loc_n,((_tmpCFF->f2=(struct _dyneither_ptr*)_check_null(_tmp848),_tmpCFF)))));
{struct _tuple8*_tmpD02;struct Cyc_List_List*_tmpD01;f->args=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(f->args,((_tmpD01=_cycalloc(sizeof(*_tmpD01)),((_tmpD01->hd=((_tmpD02=_cycalloc(sizeof(*_tmpD02)),((_tmpD02->f1=_tmp848,((_tmpD02->f2=_tmp849,((_tmpD02->f3=_tmp84C,_tmpD02)))))))),((_tmpD01->tl=0,_tmpD01)))))));}
...
struct _tuple15*_tmpD03;v=((_tmpD03=_region_malloc(d,sizeof(*_tmpD03)),((_tmpD03->f1=ad,((_tmpD03->f2=Cyc_Absyn_strctq(_tmp852),_tmpD03))))));}else{
# 4468
struct _tuple15*_tmpD04;v=((_tmpD04=_region_malloc(d,sizeof(*_tmpD04)),((_tmpD04->f1=ad,((_tmpD04->f2=Cyc_Absyn_unionq_typ(_tmp852),_tmpD04))))));}
...
if(_tmp85B->impl == 0){
{struct _tuple15*_tmpD05;*_tmp855=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple0*k,struct _tuple15*v))Cyc_Dict_insert)(*_tmp855,_tmp852,((_tmpD05=_region_malloc(d,sizeof(*_tmpD05)),((_tmpD05->f1=ad,((_tmpD05->f2=_tmp85C,_tmpD05)))))));}
seen_defn_before=0;}else{
# 4476
seen_defn_before=1;}}{
# 4478
struct Cyc_Absyn_Aggrdecl*_tmpD06;struct Cyc_Absyn_Aggrdecl*new_ad=(_tmpD06=_cycalloc(sizeof(*_tmpD06)),((_tmpD06->kind=ad->kind,((_tmpD06->sc=Cyc_Absyn_Public,((_tmpD06->name=ad->name,((_tmpD06->tvs=0,((_tmpD06->impl=0,((_tmpD06->attributes=ad->attributes,_tmpD06)))))))))))));
# 4484
if(ad->impl != 0  && !seen_defn_before){
{struct Cyc_Absyn_AggrdeclImpl*_tmpD07;new_ad->impl=((_tmpD07=_cycalloc(sizeof(*_tmpD07)),((_tmpD07->exist_vars=0,((_tmpD07->rgn_po=0,((_tmpD07->fields=0,((_tmpD07->tagged=0,_tmpD07))))))))));}{
# 4489
struct Cyc_List_List*new_fields=0;
...
# 4501
{struct Cyc_Absyn_ArrayType_Absyn_Type_struct _tmpD0D;struct Cyc_Absyn_ArrayInfo _tmpD0C;struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmpD0B;_tmp861=(void*)((_tmpD0B=_cycalloc(sizeof(*_tmpD0B)),((_tmpD0B[0]=((_tmpD0D.tag=8,((_tmpD0D.f1=((_tmpD0C.elt_type=_tmp864,((_tmpD0C.tq=_tmp865,((_tmpD0C.num_elts=0,((_tmpD0C.zero_term=_tmp866,((_tmpD0C.zt_loc=_tmp867,_tmpD0C)))))))))),_tmpD0D)))),_tmpD0B))));}
goto _LL3DE;_LL3E1:;_LL3E2:
 continue;_LL3DE:;}{
# 4506
struct Cyc_Absyn_Aggrfield*_tmpD0E;struct Cyc_Absyn_Aggrfield*_tmp86B=(_tmpD0E=_cycalloc(sizeof(*_tmpD0E)),((_tmpD0E->name=_tmp860->name,((_tmpD0E->tq=Cyc_Toc_mt_tq,((_tmpD0E->type=
# 4508
Cyc_Toc_typ_to_c(_tmp861),((_tmpD0E->width=_tmp860->width,((_tmpD0E->attributes=_tmp860->attributes,_tmpD0E)))))))))));
# 4514
...
const char*_tmpD13;void*_tmpD12[2];struct Cyc_String_pa_PrintArg_struct _tmpD11;struct Cyc_String_pa_PrintArg_struct _tmpD10;struct _dyneither_ptr s=(struct _dyneither_ptr)((_tmpD10.tag=0,((_tmpD10.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp86D),((_tmpD11.tag=0,((_tmpD11.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*ad->name).f2),((_tmpD12[0]=& _tmpD11,((_tmpD12[1]=& _tmpD10,Cyc_aprintf(((_tmpD13="_union_%s_%s",_tag_dyneither(_tmpD13,sizeof(char),13))),_tag_dyneither(_tmpD12,sizeof(void*),2))))))))))))));
struct _dyneither_ptr*_tmpD14;struct _dyneither_ptr*str=(_tmpD14=_cycalloc(sizeof(*_tmpD14)),((_tmpD14[0]=s,_tmpD14)));
struct Cyc_Absyn_Aggrfield*_tmpD15;struct Cyc_Absyn_Aggrfield*_tmp86E=(_tmpD15=_cycalloc(sizeof(*_tmpD15)),((_tmpD15->name=Cyc_Toc_val_sp,((_tmpD15->tq=Cyc_Toc_mt_tq,((_tmpD15->type=_tmp86C,((_tmpD15->width=0,((_tmpD15->attributes=0,_tmpD15)))))))))));
struct Cyc_Absyn_Aggrfield*_tmpD16;struct Cyc_Absyn_Aggrfield*_tmp86F=(_tmpD16=_cycalloc(sizeof(*_tmpD16)),((_tmpD16->name=Cyc_Toc_tag_sp,((_tmpD16->tq=Cyc_Toc_mt_tq,((_tmpD16->type=Cyc_Absyn_sint_typ,((_tmpD16->width=0,((_tmpD16->attributes=0,_tmpD16)))))))))));
struct Cyc_Absyn_Aggrfield*_tmpD17[2];struct Cyc_List_List*_tmp870=(_tmpD17[1]=_tmp86E,((_tmpD17[0]=_tmp86F,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpD17,sizeof(struct Cyc_Absyn_Aggrfield*),2)))));
struct Cyc_Absyn_AggrdeclImpl*_tmpD1C;struct _tuple0*_tmpD1B;struct Cyc_Absyn_Aggrdecl*_tmpD1A;struct Cyc_Absyn_Aggrdecl*_tmp871=(_tmpD1A=_cycalloc(sizeof(*_tmpD1A)),((_tmpD1A->kind=Cyc_Absyn_StructA,((_tmpD1A->sc=Cyc_Absyn_Public,((_tmpD1A->name=(
(_tmpD1B=_cycalloc(sizeof(*_tmpD1B)),((_tmpD1B->f1=Cyc_Absyn_Loc_n,((_tmpD1B->f2=str,_tmpD1B)))))),((_tmpD1A->tvs=0,((_tmpD1A->impl=(
(_tmpD1C=_cycalloc(sizeof(*_tmpD1C)),((_tmpD1C->exist_vars=0,((_tmpD1C->rgn_po=0,((_tmpD1C->fields=_tmp870,((_tmpD1C->tagged=0,_tmpD1C)))))))))),((_tmpD1A->attributes=0,_tmpD1A)))))))))))));
# 4526
{struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpD22;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct _tmpD21;struct Cyc_List_List*_tmpD20;Cyc_Toc_result_decls=((_tmpD20=_cycalloc(sizeof(*_tmpD20)),((_tmpD20->hd=Cyc_Absyn_new_decl((void*)((_tmpD22=_cycalloc(sizeof(*_tmpD22)),((_tmpD22[0]=((_tmpD21.tag=6,((_tmpD21.f1=_tmp871,_tmpD21)))),_tmpD22)))),0),((_tmpD20->tl=Cyc_Toc_result_decls,_tmpD20))))));}
_tmp86B->type=Cyc_Absyn_strct(str);}{
# 4529
struct Cyc_List_List*_tmpD23;new_fields=((_tmpD23=_cycalloc(sizeof(*_tmpD23)),((_tmpD23->hd=_tmp86B,((_tmpD23->tl=new_fields,_tmpD23))))));};};}}
# 4531
(new_ad->impl)->fields=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(new_fields);};}
# 4533
if(add_to_decls){
struct Cyc_Absyn_Decl*_tmpD2D;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct _tmpD2C;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpD2B;struct Cyc_List_List*_tmpD2A;Cyc_Toc_result_decls=((_tmpD2A=_cycalloc(sizeof(*_tmpD2A)),((_tmpD2A->hd=((_tmpD2D=_cycalloc(sizeof(*_tmpD2D)),((_tmpD2D->r=(void*)((_tmpD2B=_cycalloc(sizeof(*_tmpD2B)),((_tmpD2B[0]=((_tmpD2C.tag=6,((_tmpD2C.f1=new_ad,_tmpD2C)))),_tmpD2B)))),((_tmpD2D->loc=0,_tmpD2D)))))),((_tmpD2A->tl=Cyc_Toc_result_decls,_tmpD2A))))));}};}
# 4460
;_pop_dynregion(d);};}
# 4562 "toc.cyc"
static void Cyc_Toc_datatypedecl_to_c(struct Cyc_Absyn_Datatypedecl*tud){
...
struct Cyc_Absyn_Aggrfield*_tmpD2E;struct Cyc_Absyn_Aggrfield*_tmp890=(_tmpD2E=_cycalloc(sizeof(*_tmpD2E)),((_tmpD2E->name=_tmp88F,((_tmpD2E->tq=(*((struct _tuple10*)_tmp88E->hd)).f1,((_tmpD2E->type=
Cyc_Toc_typ_to_c((*((struct _tuple10*)_tmp88E->hd)).f2),((_tmpD2E->width=0,((_tmpD2E->attributes=0,_tmpD2E)))))))))));
struct Cyc_List_List*_tmpD2F;_tmp88D=((_tmpD2F=_cycalloc(sizeof(*_tmpD2F)),((_tmpD2F->hd=_tmp890,((_tmpD2F->tl=_tmp88D,_tmpD2F))))));}}
# 4581
{struct Cyc_Absyn_Aggrfield*_tmpD32;struct Cyc_List_List*_tmpD31;_tmp88D=((_tmpD31=_cycalloc(sizeof(*_tmpD31)),((_tmpD31->hd=((_tmpD32=_cycalloc(sizeof(*_tmpD32)),((_tmpD32->name=Cyc_Toc_tag_sp,((_tmpD32->tq=Cyc_Toc_mt_tq,((_tmpD32->type=Cyc_Absyn_sint_typ,((_tmpD32->width=0,((_tmpD32->attributes=0,_tmpD32)))))))))))),((_tmpD31->tl=
((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp88D),_tmpD31))))));}{
struct Cyc_Absyn_AggrdeclImpl*_tmpD35;struct Cyc_Absyn_Aggrdecl*_tmpD34;struct Cyc_Absyn_Aggrdecl*_tmp895=
(_tmpD34=_cycalloc(sizeof(*_tmpD34)),((_tmpD34->kind=Cyc_Absyn_StructA,((_tmpD34->sc=Cyc_Absyn_Public,((_tmpD34->name=
Cyc_Toc_collapse_qvars(f->name,tud->name),((_tmpD34->tvs=0,((_tmpD34->impl=(
# 4587
(_tmpD35=_cycalloc(sizeof(*_tmpD35)),((_tmpD35->exist_vars=0,((_tmpD35->rgn_po=0,((_tmpD35->fields=_tmp88D,((_tmpD35->tagged=0,_tmpD35)))))))))),((_tmpD34->attributes=0,_tmpD34)))))))))))));
# 4589
struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpD3B;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct _tmpD3A;struct Cyc_List_List*_tmpD39;Cyc_Toc_result_decls=((_tmpD39=_cycalloc(sizeof(*_tmpD39)),((_tmpD39->hd=Cyc_Absyn_new_decl((void*)((_tmpD3B=_cycalloc(sizeof(*_tmpD3B)),((_tmpD3B[0]=((_tmpD3A.tag=6,((_tmpD3A.f1=_tmp895,_tmpD3A)))),_tmpD3B)))),0),((_tmpD39->tl=Cyc_Toc_result_decls,_tmpD39))))));};}};
# 4564
;_pop_dynregion(d);};}
# 4610 "toc.cyc"
...
_tmp8A4->sc=f->sc;
{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmpD41;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmpD40;struct Cyc_List_List*_tmpD3F;Cyc_Toc_result_decls=((_tmpD3F=_cycalloc(sizeof(*_tmpD3F)),((_tmpD3F->hd=Cyc_Absyn_new_decl((void*)((_tmpD41=_cycalloc(sizeof(*_tmpD41)),((_tmpD41[0]=((_tmpD40.tag=0,((_tmpD40.f1=_tmp8A4,_tmpD40)))),_tmpD41)))),0),((_tmpD3F->tl=Cyc_Toc_result_decls,_tmpD3F))))));}
*_tmp89D=
...
struct Cyc_Int_pa_PrintArg_struct _tmpD49;void*_tmpD48[1];const char*_tmpD47;struct _dyneither_ptr*_tmpD46;struct _dyneither_ptr*_tmp8A9=(_tmpD46=_cycalloc(sizeof(*_tmpD46)),((_tmpD46[0]=(struct _dyneither_ptr)((_tmpD49.tag=1,((_tmpD49.f1=(unsigned long)i,((_tmpD48[0]=& _tmpD49,Cyc_aprintf(((_tmpD47="f%d",_tag_dyneither(_tmpD47,sizeof(char),4))),_tag_dyneither(_tmpD48,sizeof(void*),1)))))))),_tmpD46)));
struct Cyc_Absyn_Aggrfield*_tmpD4A;struct Cyc_Absyn_Aggrfield*_tmp8AA=(_tmpD4A=_cycalloc(sizeof(*_tmpD4A)),((_tmpD4A->name=_tmp8A9,((_tmpD4A->tq=(*((struct _tuple10*)_tmp8A8->hd)).f1,((_tmpD4A->type=
Cyc_Toc_typ_to_c((*((struct _tuple10*)_tmp8A8->hd)).f2),((_tmpD4A->width=0,((_tmpD4A->attributes=0,_tmpD4A)))))))))));
struct Cyc_List_List*_tmpD4B;fields=((_tmpD4B=_cycalloc(sizeof(*_tmpD4B)),((_tmpD4B->hd=_tmp8AA,((_tmpD4B->tl=fields,_tmpD4B))))));}}
# 4641
{struct Cyc_Absyn_Aggrfield*_tmpD4E;struct Cyc_List_List*_tmpD4D;fields=((_tmpD4D=_cycalloc(sizeof(*_tmpD4D)),((_tmpD4D->hd=((_tmpD4E=_cycalloc(sizeof(*_tmpD4E)),((_tmpD4E->name=Cyc_Toc_tag_sp,((_tmpD4E->tq=Cyc_Toc_mt_tq,((_tmpD4E->type=
Cyc_Absyn_cstar_typ(Cyc_Absyn_char_typ,Cyc_Toc_mt_tq),((_tmpD4E->width=0,((_tmpD4E->attributes=0,_tmpD4E)))))))))))),((_tmpD4D->tl=
((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(fields),_tmpD4D))))));}{
struct Cyc_Absyn_AggrdeclImpl*_tmpD51;struct Cyc_Absyn_Aggrdecl*_tmpD50;struct Cyc_Absyn_Aggrdecl*_tmp8B3=
(_tmpD50=_cycalloc(sizeof(*_tmpD50)),((_tmpD50->kind=Cyc_Absyn_StructA,((_tmpD50->sc=Cyc_Absyn_Public,((_tmpD50->name=
Cyc_Toc_collapse_qvars(f->name,xd->name),((_tmpD50->tvs=0,((_tmpD50->impl=(
# 4648
(_tmpD51=_cycalloc(sizeof(*_tmpD51)),((_tmpD51->exist_vars=0,((_tmpD51->rgn_po=0,((_tmpD51->fields=fields,((_tmpD51->tagged=0,_tmpD51)))))))))),((_tmpD50->attributes=0,_tmpD50)))))))))))));
# 4650
{struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpD57;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct _tmpD56;struct Cyc_List_List*_tmpD55;Cyc_Toc_result_decls=((_tmpD55=_cycalloc(sizeof(*_tmpD55)),((_tmpD55->hd=Cyc_Absyn_new_decl((void*)((_tmpD57=_cycalloc(sizeof(*_tmpD57)),((_tmpD57[0]=((_tmpD56.tag=6,((_tmpD56.f1=_tmp8B3,_tmpD56)))),_tmpD57)))),0),((_tmpD55->tl=Cyc_Toc_result_decls,_tmpD55))))));}
# 4652
...
_tmp8BA->sc=f->sc;
{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmpD5D;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmpD5C;struct Cyc_List_List*_tmpD5B;Cyc_Toc_result_decls=((_tmpD5B=_cycalloc(sizeof(*_tmpD5B)),((_tmpD5B->hd=Cyc_Absyn_new_decl((void*)((_tmpD5D=_cycalloc(sizeof(*_tmpD5D)),((_tmpD5D[0]=((_tmpD5C.tag=0,((_tmpD5C.f1=_tmp8BA,_tmpD5C)))),_tmpD5D)))),0),((_tmpD5B->tl=Cyc_Toc_result_decls,_tmpD5B))))));}
...
((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp8CA))goto _LL3F2;_LL3F1:
 if(_tmp8C9 == 0){
const char*_tmpD60;void*_tmpD5F;(_tmpD5F=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpD60="can't initialize zero-terminated array -- size unknown",_tag_dyneither(_tmpD60,sizeof(char),55))),_tag_dyneither(_tmpD5F,sizeof(void*),0)));}{
...
void**_tmpD61;_tmp917->elt_type=((_tmpD61=_cycalloc(sizeof(*_tmpD61)),((_tmpD61[0]=Cyc_Toc_typ_to_c(*((void**)_check_null(_tmp917->elt_type))),_tmpD61))));}
...
# 4805
{const char*_tmpD64;void*_tmpD63;(_tmpD63=0,Cyc_Tcutil_terr(e->loc,((_tmpD64="Cyclone expression within C code",_tag_dyneither(_tmpD64,sizeof(char),33))),_tag_dyneither(_tmpD63,sizeof(void*),0)));}
goto _LL3F4;_LL3F4:;}
# 4810
...
# 4840
{const char*_tmpD67;void*_tmpD66;(_tmpD66=0,Cyc_Tcutil_terr(d->loc,((_tmpD67="Cyclone declaration within C code",_tag_dyneither(_tmpD67,sizeof(char),34))),_tag_dyneither(_tmpD66,sizeof(void*),0)));}
...
{const char*_tmpD6A;void*_tmpD69;(_tmpD69=0,Cyc_Tcutil_terr(s->loc,((_tmpD6A="Cyclone statement in C code",_tag_dyneither(_tmpD6A,sizeof(char),28))),_tag_dyneither(_tmpD69,sizeof(void*),0)));}
goto _LL464;_LL464:;}
# 4882
...
for(0;ds != 0;ds=ds->tl){
if(!Cyc_Toc_is_toplevel(nv)){
const char*_tmpD6D;void*_tmpD6C;(_tmpD6C=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpD6D="decls_to_c: not at toplevel!",_tag_dyneither(_tmpD6D,sizeof(char),29))),_tag_dyneither(_tmpD6C,sizeof(void*),0)));}{
...
struct _tuple0*_tmpD6E;_tmp98A=((_tmpD6E=_cycalloc(sizeof(*_tmpD6E)),((_tmpD6E->f1=Cyc_Absyn_Rel_n(0),((_tmpD6E->f2=(*_tmp98A).f2,_tmpD6E))))));}
...
# 4899
{struct Cyc_Absyn_Global_b_Absyn_Binding_struct _tmpD71;struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmpD70;nv=Cyc_Toc_add_varmap(r,nv,_tmp971->name,Cyc_Absyn_varb_exp(_tmp98A,(void*)((_tmpD70=_cycalloc(sizeof(*_tmpD70)),((_tmpD70[0]=((_tmpD71.tag=1,((_tmpD71.f1=_tmp971,_tmpD71)))),_tmpD70)))),0));}
...
{struct _tuple0*_tmpD73;_tmp98F=((_tmpD73=_cycalloc(sizeof(*_tmpD73)),((_tmpD73->f1=Cyc_Absyn_Abs_n(0,1),((_tmpD73->f2=(*_tmp98F).f2,_tmpD73))))));}
...
{struct Cyc_List_List*_tmpD74;Cyc_Toc_result_decls=((_tmpD74=_cycalloc(sizeof(*_tmpD74)),((_tmpD74->hd=d,((_tmpD74->tl=Cyc_Toc_result_decls,_tmpD74))))));}
...
# 4919
const char*_tmpD77;void*_tmpD76;(_tmpD76=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpD77="letdecl at toplevel",_tag_dyneither(_tmpD77,sizeof(char),20))),_tag_dyneither(_tmpD76,sizeof(void*),0)));}_LL490: {struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*_tmp976=(struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp96F;if(_tmp976->tag != 4)goto _LL492;}_LL491: {
# 4921
const char*_tmpD7A;void*_tmpD79;(_tmpD79=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpD7A="region decl at toplevel",_tag_dyneither(_tmpD7A,sizeof(char),24))),_tag_dyneither(_tmpD79,sizeof(void*),0)));}_LL492: {struct Cyc_Absyn_Alias_d_Absyn_Raw_decl_struct*_tmp977=(struct Cyc_Absyn_Alias_d_Absyn_Raw_decl_struct*)_tmp96F;if(_tmp977->tag != 5)goto _LL494;}_LL493: {
# 4923
const char*_tmpD7D;void*_tmpD7C;(_tmpD7C=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Toc_toc_impos)(((_tmpD7D="alias decl at toplevel",_tag_dyneither(_tmpD7D,sizeof(char),23))),_tag_dyneither(_tmpD7C,sizeof(void*),0)));}_LL494: {struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp978=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp96F;if(_tmp978->tag != 6)goto _LL496;else{_tmp979=_tmp978->f1;}}_LL495:
# 4925
...
{struct Cyc_List_List*_tmpD7E;Cyc_Toc_result_decls=((_tmpD7E=_cycalloc(sizeof(*_tmpD7E)),((_tmpD7E->hd=d,((_tmpD7E->tl=Cyc_Toc_result_decls,_tmpD7E))))));}
...
# 4948
{struct Cyc_List_List*_tmpD7F;Cyc_Toc_result_decls=((_tmpD7F=_cycalloc(sizeof(*_tmpD7F)),((_tmpD7F->hd=d,((_tmpD7F->tl=Cyc_Toc_result_decls,_tmpD7F))))));}
...
struct Cyc_Dict_Dict*_tmpD8C;struct Cyc_Dict_Dict*_tmpD8B;struct Cyc_Set_Set**_tmpD8A;struct Cyc_List_List**_tmpD89;struct Cyc_Dict_Dict*_tmpD88;struct Cyc_List_List**_tmpD87;struct Cyc_Toc_TocState*_tmpD86;Cyc_Toc_toc_state=(
(_tmpD86=_cycalloc(sizeof(*_tmpD86)),((_tmpD86->dyn=(struct _DynRegionHandle*)_tmp99B,((_tmpD86->tuple_types=(struct Cyc_List_List**)(
(_tmpD87=_region_malloc(d,sizeof(*_tmpD87)),((_tmpD87[0]=0,_tmpD87)))),((_tmpD86->aggrs_so_far=(struct Cyc_Dict_Dict*)(
(_tmpD88=_region_malloc(d,sizeof(*_tmpD88)),((_tmpD88[0]=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _tuple0*,struct _tuple0*)))Cyc_Dict_rempty)(d,Cyc_Absyn_qvar_cmp),_tmpD88)))),((_tmpD86->abs_struct_types=(struct Cyc_List_List**)(
(_tmpD89=_region_malloc(d,sizeof(*_tmpD89)),((_tmpD89[0]=0,_tmpD89)))),((_tmpD86->datatypes_so_far=(struct Cyc_Set_Set**)(
(_tmpD8A=_region_malloc(d,sizeof(*_tmpD8A)),((_tmpD8A[0]=((struct Cyc_Set_Set*(*)(struct _RegionHandle*r,int(*cmp)(struct _tuple0*,struct _tuple0*)))Cyc_Set_rempty)(d,Cyc_Absyn_qvar_cmp),_tmpD8A)))),((_tmpD86->xdatatypes_so_far=(struct Cyc_Dict_Dict*)(
(_tmpD8B=_region_malloc(d,sizeof(*_tmpD8B)),((_tmpD8B[0]=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _tuple0*,struct _tuple0*)))Cyc_Dict_rempty)(d,Cyc_Absyn_qvar_cmp),_tmpD8B)))),((_tmpD86->qvar_tags=(struct Cyc_Dict_Dict*)(
(_tmpD8C=_region_malloc(d,sizeof(*_tmpD8C)),((_tmpD8C[0]=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _tuple14*,struct _tuple14*)))Cyc_Dict_rempty)(d,Cyc_Toc_qvar_tag_cmp),_tmpD8C)))),((_tmpD86->temp_labels=(struct Cyc_Xarray_Xarray*)
((struct Cyc_Xarray_Xarray*(*)(struct _RegionHandle*))Cyc_Xarray_rcreate_empty)(d),(struct Cyc_Toc_TocState*)_tmpD86))))))))))))))))));}
# 4977
...
struct _dyneither_ptr**_tmpD8D;Cyc_Toc_globals=_tag_dyneither(((_tmpD8D=_cycalloc(sizeof(struct _dyneither_ptr*)* 41),((_tmpD8D[0]=& Cyc_Toc__throw_str,((_tmpD8D[1]=& Cyc_Toc_setjmp_str,((_tmpD8D[2]=& Cyc_Toc__push_handler_str,((_tmpD8D[3]=& Cyc_Toc__pop_handler_str,((_tmpD8D[4]=& Cyc_Toc__exn_thrown_str,((_tmpD8D[5]=& Cyc_Toc__npop_handler_str,((_tmpD8D[6]=& Cyc_Toc__check_null_str,((_tmpD8D[7]=& Cyc_Toc__check_known_subscript_null_str,((_tmpD8D[8]=& Cyc_Toc__check_known_subscript_notnull_str,((_tmpD8D[9]=& Cyc_Toc__check_dyneither_subscript_str,((_tmpD8D[10]=& Cyc_Toc__dyneither_ptr_str,((_tmpD8D[11]=& Cyc_Toc__tag_dyneither_str,((_tmpD8D[12]=& Cyc_Toc__init_dyneither_ptr_str,((_tmpD8D[13]=& Cyc_Toc__untag_dyneither_ptr_str,((_tmpD8D[14]=& Cyc_Toc__get_dyneither_size_str,((_tmpD8D[15]=& Cyc_Toc__get_zero_arr_size_str,((_tmpD8D[16]=& Cyc_Toc__dyneither_ptr_plus_str,((_tmpD8D[17]=& Cyc_Toc__zero_arr_plus_str,((_tmpD8D[18]=& Cyc_Toc__dyneither_ptr_inplace_plus_str,((_tmpD8D[19]=& Cyc_Toc__zero_arr_inplace_plus_str,((_tmpD8D[20]=& Cyc_Toc__dyneither_ptr_inplace_plus_post_str,((_tmpD8D[21]=& Cyc_Toc__zero_arr_inplace_plus_post_str,((_tmpD8D[22]=& Cyc_Toc__cycalloc_str,((_tmpD8D[23]=& Cyc_Toc__cyccalloc_str,((_tmpD8D[24]=& Cyc_Toc__cycalloc_atomic_str,((_tmpD8D[25]=& Cyc_Toc__cyccalloc_atomic_str,((_tmpD8D[26]=& Cyc_Toc__region_malloc_str,((_tmpD8D[27]=& Cyc_Toc__region_calloc_str,((_tmpD8D[28]=& Cyc_Toc__check_times_str,((_tmpD8D[29]=& Cyc_Toc__new_region_str,((_tmpD8D[30]=& Cyc_Toc__push_region_str,((_tmpD8D[31]=& Cyc_Toc__pop_region_str,((_tmpD8D[32]=& Cyc_Toc__open_dynregion_str,((_tmpD8D[33]=& Cyc_Toc__push_dynregion_str,((_tmpD8D[34]=& Cyc_Toc__pop_dynregion_str,((_tmpD8D[35]=& Cyc_Toc__reset_region_str,((_tmpD8D[36]=& Cyc_Toc__throw_arraybounds_str,((_tmpD8D[37]=& Cyc_Toc__dyneither_ptr_decrease_size_str,((_tmpD8D[38]=& Cyc_Toc__throw_match_str,((_tmpD8D[39]=& Cyc_Toc__swap_word_str,((_tmpD8D[40]=& Cyc_Toc__swap_dyneither_str,_tmpD8D)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))),sizeof(struct _dyneither_ptr*),41);};
# 4965
;_pop_dynregion(d);};}
# 5030
struct Cyc_List_List*Cyc_Toc_toc(struct Cyc_List_List*ds){
...
# 5039
struct _DynRegionHandle*_tmp9A7;struct Cyc_Xarray_Xarray*_tmp9A8;struct Cyc_Toc_TocState _tmp9A6=*((struct Cyc_Toc_TocState*)_check_null(Cyc_Toc_toc_state));_tmp9A7=_tmp9A6.dyn;_tmp9A8=_tmp9A6.temp_labels;
{struct _DynRegionFrame _tmp9A9;struct _RegionHandle*d=_open_dynregion(& _tmp9A9,_tmp9A7);
((void(*)(struct Cyc_Xarray_Xarray*xarr))Cyc_Xarray_reuse)(_tmp9A8);;_pop_dynregion(d);}
# 5043
Cyc_Core_free_dynregion(_tmp9A7);};{
# 5045
struct Cyc_List_List*_tmp9AA=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(Cyc_Toc_result_decls);_npop_handler(0);return _tmp9AA;};
# 5032
;_pop_region(start);};}
