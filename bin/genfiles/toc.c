...
return(void*)({struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*_tmpDB=_cycalloc(sizeof(*_tmpDB));_tmpDB[0]=({struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct _tmpDC;_tmpDC.tag=8;_tmpDC.f1=v;_tmpDC;});_tmpDB;});}
# 370
...
if(_tmp78D != 0)
s->r=Cyc_Toc_goto_stmt_r(*_tmp78D);
# 4520
...
if(_tmp78F != 0)
s->r=Cyc_Toc_goto_stmt_r(*_tmp78F);
