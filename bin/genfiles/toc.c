...
goto _LLA6;}}_LLA6:;}
# 2179
goto _LL9F;}case 0: if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_TmpB.f1)->f1)==1){_TmpD=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_TmpB.f0)->f1;{struct Cyc_Absyn_PtrInfo p1=_TmpD;
# 2181
...
ta=p.elt_type;goto _LLCA;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("get_ptr_typ: not a pointer!",sizeof(char),28U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLCA:;}
# 2287
did_inserted_checks=1;
...
e->topt=strct_typ;
goto _LLD2;}}else{goto _LLD5;}}else{goto _LLD5;}}else{_LLD5:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("anonStruct type not an aggregate",sizeof(char),33U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLD2:;}else{
# 2365
...
({struct _tuple1*_TmpD=Cyc_Absyn_aggr_kinded_name(info).f1;*tdn=_TmpD;});goto _LLD7;}}else{goto _LLDA;}}else{_LLDA:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("exp_to_c, Aggregate_e: bad type translation",sizeof(char),44U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLD7:;}{
# 2382
...
# 2451
new_f->type=_check_null(fieldexp->topt);goto _LLE9;}else{goto _LLEC;}}else{_LLEC:
 goto _LLE9;}_LLE9:;}
# 2454
goto _LLE4;}_LLE4:;}
# 2458
...
# 2473
goto _LLDC;}}else{goto _LLDF;}}else{_LLDF:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("exp_to_c, Aggregate_e: bad struct type",sizeof(char),39U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLDC:;}else{
# 2482
if(sd->impl->tagged){
# 2484
...
goto _LLF4;}}else{goto _LLF7;}}else{goto _LLF7;}}else{_LLF7:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpC=({struct Cyc_Warn_String_Warn_Warg_struct _TmpD;_TmpD.tag=0,_TmpD.f1=_tag_fat("non-aggregate type in tagcheck",sizeof(char),31U);_TmpD;});void*_TmpD[1];_TmpD[0]=& _TmpC;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpD,sizeof(void*),1));});}_LLF4:;}
# 2668
