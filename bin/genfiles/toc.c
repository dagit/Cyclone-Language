...
_TL161: ea=Cyc_Absyn_cast_exp(fat_ptr_type,ea,0,4U,0U);_T5=ea;
...
_TL164: ea=Cyc_Absyn_cast_exp(fat_ptr_type,ea,0,4U,0U);_TA=ea;
...
Cyc_Toc_deep_copy(e1);_T1BF=Cyc_Toc__check_null_e;_T1C0=_tag_fat(_T601,sizeof(struct Cyc_Absyn_Exp*),1);_T1BE=Cyc_Toc_fncall_exp_dl(_T1BF,_T1C0);}_T1BD->r=_T1BE->r;goto _TL1E3;_TL1E2: _TL1E3: _T1C2=Cyc_List_iter_c;{
...
Cyc_Toc_deep_copy(e1);_T1E2=Cyc_Toc__check_null_e;_T1E3=_tag_fat(_T605,sizeof(struct Cyc_Absyn_Exp*),1);_T1E1=Cyc_Toc_fncall_exp_dl(_T1E2,_T1E3);}_T1E0->r=_T1E1->r;goto _TL1EB;_TL1EA: _TL1EB:
...
_T607.f1=_tag_fat("unknown datatype in vararg with inject",sizeof(char),39U);_T201=_T607;}{struct Cyc_Warn_String_Warn_Warg_struct _T607=_T201;void*_T608[1];_T608[0]=& _T607;{int(*_T609)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_T202=_T609;}_T203=_tag_fat(_T608,sizeof(void*),1);_T202(_T203);}_LLA1:;}_T205=num_varargs;{unsigned _T605=(unsigned)_T205;_T207=r;_T208=_check_times(_T605,sizeof(struct _tuple35));{struct _tuple35*_T606=_region_malloc(_T207,0U,_T208);{unsigned _T607=_T605;unsigned i;i=0;_TL1F9: if(i < _T607)goto _TL1F7;else{goto _TL1F8;}_TL1F7: _T209=i;
# 2097
_T606[_T209].f0=Cyc_Toc_temp_var();_T20A=i;_T606[_T20A].f1=0;i=i + 1;goto _TL1F9;_TL1F8:;}_T206=(struct _tuple35*)_T606;}_T204=_tag_fat(_T206,sizeof(struct _tuple35),_T605);}{struct _fat_ptr vs=_T204;
# 2099
...
_TL1FF: _T225=vs;_T226=i;_T227=_check_fat_subscript(_T225,sizeof(struct _tuple35),_T226);_T228=(struct _tuple35*)_T227;{struct _tuple35 _T605=*_T228;void*_T606;struct _tuple1*_T607;_T607=_T605.f0;_T606=_T605.f1;{struct _tuple1*v=_T607;void*t=_T606;_T229=
...
_TL209: _T25A=nv;_T25B=es;_T25C=_T25B->hd;_T25D=(struct Cyc_Absyn_Exp*)_T25C;Cyc_Toc_exp_to_c(_T25A,_T25D);{struct Cyc_List_List*_T605=_cycalloc(sizeof(struct Cyc_List_List));_T25F=es;_T260=_T25F->hd;
...
# 2194
Cyc_Absyn_declare_stmt(_T278,_T279,_T27A,_T27E,_T280);_T277->r=Cyc_Toc_stmt_exp_r(_T281);}}goto _TL20F;_TL20E: _TL20F: goto _LL7;}}}case 14:{struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_T5EC;_T282=(struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_T5EC;_T283=& _T282->f1;_T600=(void**)_T283;_T5FB=_T601->f2;_T5FF=_T601->f3;_T5F7=_T601->f4;}{void**t=_T600;struct Cyc_Absyn_Exp*e1=_T5FB;int user_inserted=_T5FF;enum Cyc_Absyn_Coercion coercion=_T5F7;_T284=e1;_T285=_T284->topt;{
# 2199
...
# 2206
_T601.f0=Cyc_Absyn_compress(old_t2);_T601.f1=Cyc_Absyn_compress(new_typ);_T288=_T601;}{struct _tuple36 _T601=_T288;struct Cyc_Absyn_PtrInfo _T602;struct Cyc_Absyn_PtrInfo _T603;_T289=_T601.f0;_T28A=(int*)_T289;_T28B=*_T28A;if(_T28B!=4)goto _TL210;_T28C=_T601.f1;_T28D=(int*)_T28C;_T28E=*_T28D;switch(_T28E){case 4: _T28F=_T601.f0;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T604=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T28F;_T603=_T604->f1;}_T290=_T601.f1;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T604=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T290;_T602=_T604->f1;}{struct Cyc_Absyn_PtrInfo p1=_T603;struct Cyc_Absyn_PtrInfo p2=_T602;_T291=
# 2208
...
_T604.f0=b1;_T604.f1=b2;_T29F=_T604;}{struct _tuple37 _T604=_T29F;_T2A0=_T604.f0;if(_T2A0==0)goto _TL213;_T2A1=_T604.f1;if(_T2A1==0)goto _TL215;
# 2215
did_inserted_checks=1;_T2A2=
Cyc_Toc_do_null_check(e);if(!_T2A2)goto _TL217;_T2A3=e;{struct Cyc_Absyn_Exp*_T605[1];_T605[0]=e1;_T2A5=Cyc_Toc__check_null_e;_T2A6=_tag_fat(_T605,sizeof(struct Cyc_Absyn_Exp*),1);_T2A4=Cyc_Toc_fncall_exp_dl(_T2A5,_T2A6);}
...
arg3=e2;goto _TL22A;
_TL229: _T2D0=Cyc_Toc_isCharStar(e1);if(!_T2D0)goto _TL22B;{struct Cyc_Absyn_Exp*_T60D[2];
_T60D[0]=x_exp;_T60D[1]=e2;_T2D2=Cyc_Toc__get_zero_arr_size_char_e;_T2D3=_tag_fat(_T60D,sizeof(struct Cyc_Absyn_Exp*),2);_T2D1=Cyc_Toc_fncall_exp_dl(_T2D2,_T2D3);}arg3=_T2D1;goto _TL22C;
# 2264
_TL22B:{struct Cyc_Absyn_Exp*_T60D[3];_T2D5=
...
# 2308
_TL23A:{struct Cyc_Absyn_Exp*_T605[1];_T605[0]=ptr_exp;_T31C=Cyc_Toc__check_fat_at_base_e;_T31D=_tag_fat(_T605,sizeof(struct Cyc_Absyn_Exp*),1);_T31B=Cyc_Toc_fncall_exp_dl(_T31C,_T31D);}_T31E=Cyc_Toc_fat_ptr_type();ptr_exp=Cyc_Absyn_set_type(_T31B,_T31E);goto _TL239;_TL238: _TL239: _T31F=e;{
# 2310
void*_T605=_T31F->annot;_T320=(struct Cyc_InsertChecks_FatBound_Absyn_AbsynAnnot_struct*)_T605;_T321=_T320->tag;_T322=Cyc_InsertChecks_FatBound;if(_T321!=_T322)goto _TL23B;goto _LLD7;_TL23B: _T323=(struct Cyc_InsertChecks_NullAndFatBound_Absyn_AbsynAnnot_struct*)_T605;_T324=_T323->tag;_T325=Cyc_InsertChecks_NullAndFatBound;if(_T324!=_T325)goto _TL23D;_LLD7:{struct Cyc_Absyn_Exp*_T606[3];
# 2319
...
# 2317
ptr_exp=
Cyc_Absyn_set_type(_T326,_T330);goto _LLD3;_TL23D:{struct Cyc_Absyn_Exp*_T606[3];
# 2327
...
Cyc_Toc_do_null_check(e);if(!_T33C)goto _TL23F;_T33D=ptr_exp;{struct Cyc_Absyn_Exp*_T605[1];_T605[0]=
Cyc_Toc_deep_copy(ptr_exp);_T33F=Cyc_Toc__check_null_e;_T340=_tag_fat(_T605,sizeof(struct Cyc_Absyn_Exp*),1);_T33E=Cyc_Toc_fncall_exp_r(_T33F,_T340);}_T33D->r=_T33E;goto _TL240;_TL23F: _TL240: _T341=e;_T342=t;_T343=*_T342;_T344=ptr_exp;
...
int(*_T605)(struct _fat_ptr)=(int(*)(struct _fat_ptr))Cyc_Toc_unimp;_T34B=_T605;}_T34C=_tag_fat("can't coerce a ZEROTERM to a non-const NOZEROTERM pointer at toplevel",sizeof(char),70U);_T34B(_T34C);goto _TL246;_TL245: _TL246: _T34D=e;{struct Cyc_Absyn_Exp*_T605[3];
# 2345
...
# 2344
_T34D->r=_T34E;goto _TL242;_TL241: _TL242: goto _LLB9;_LLB9:;}goto _LLB2;}}}}}case 0: _T35A=_T601.f1;_T35B=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T35A;_T35C=_T35B->f1;_T35D=(int*)_T35C;_T35E=*_T35D;if(_T35E!=1)goto _TL247;_T35F=_T601.f0;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T604=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T35F;_T603=_T604->f1;}{struct Cyc_Absyn_PtrInfo p1=_T603;_T360=
# 2354
Cyc_Absyn_bounds_one();_T361=p1;_T362=_T361.ptr_atts;_T363=_T362.bounds;{struct Cyc_Absyn_Exp*_T604=Cyc_Tcutil_get_bounds_exp_constrain(_T360,_T363,1);if(_T604!=0)goto _TL249;_T364=e1;_T365=
# 2356
...
*_T369=*_T36A;goto _TL24C;_TL24B: _TL24C: goto _LLB2;_TL211: _LLB2:;}goto _LL7;}}}case 15:{struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_T5EC;_T600=_T601->f1;}{struct Cyc_Absyn_Exp*e1=_T600;
# 2370
Cyc_Toc_set_lhs(nv,1);
Cyc_Toc_exp_to_c(nv,e1);
...
# 2379
_T378->r=Cyc_Toc_cast_it_r(_T379,_T380);goto _TL251;_TL250: _TL251: _TL24E: goto _LL7;}case 16:{struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_T5EC;_T600=_T601->f1;_T5FB=_T601->f2;_T5FA=_T601->f3;}{struct Cyc_Absyn_Exp*rgnopt=_T600;struct Cyc_Absyn_Exp*e1=_T5FB;struct Cyc_Absyn_Exp*qual=_T5FA;
# 2389
Cyc_Toc_exp_to_c(nv,e1);_T381=e1;_T382=_T381->topt;_T383=
# 2391
_check_null(_T382);{void*elt_typ=Cyc_Toc_typ_to_c(_T383);{
void*_T601=Cyc_Absyn_compress(elt_typ);void*_T602;_T384=(int*)_T601;_T385=*_T384;if(_T385!=5)goto _TL252;{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_T603=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T601;_T386=_T603->f1;_T602=_T386.elt_type;}{void*t2=_T602;
...
if(!_T3AB)goto _TL266;_T601[2]=lenexp;goto _TL267;_TL266: _T3AC=
Cyc_Absyn_uint_exp(1U,0U);_T3AD=Cyc_Absyn_uint_type;_T601[2]=Cyc_Absyn_set_type(_T3AC,_T3AD);_TL267: _T3AE=Cyc_Toc__tag_fat_e;_T3AF=_tag_fat(_T601,sizeof(struct Cyc_Absyn_Exp*),3);_T3A7=Cyc_Toc_fncall_exp_dl(_T3AE,_T3AF);}
# 2441
...
# 2451
_T3BA->r=Cyc_Toc_stmt_exp_r(s);}goto _TL26B;_TL26A: _TL26B: goto _LL7;}}}}case 18:{struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_T5EC;_T600=_T601->f1;}{struct Cyc_Absyn_Exp*e1=_T600;
# 2456
...
_T3D3->topt=t;}goto _TL273;_TL272: _TL273: goto _LL7;}}}case 22:{struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_T5EC;_T600=_T601->f1;_T5FB=_T601->f2;_T5FF=_T601->f3;_T5FE=_T601->f4;}{struct Cyc_Absyn_Exp*e1=_T600;struct _fat_ptr*f=_T5FB;int is_tagged=_T5FF;int is_read=_T5FE;
# 2481
...
void*_T601=Cyc_Absyn_compress(e1typ);struct Cyc_Absyn_PtrInfo _T602;_T3D8=(int*)_T601;_T3D9=*_T3D8;if(_T3D9!=4)goto _TL276;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T603=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T601;_T602=_T603->f1;}{struct Cyc_Absyn_PtrInfo p=_T602;_T3DA=p;
ta=_T3DA.elt_type;goto _LLEB;}_TL276:{struct Cyc_Warn_String_Warn_Warg_struct _T603;_T603.tag=0;
...
_T3F4->topt=Cyc_Toc_void_star_type();goto _TL27F;_TL27E: _TL27F: _TL27D: goto _LL7;}}}case 20:{struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_T5EC;_T600=_T601->f1;}{struct Cyc_Absyn_Exp*e1=_T600;
# 2507
...
_T403->r=_T404->r;goto _TL283;_TL282: _TL283: _TL281: goto _LL7;}}case 25:{struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_T5EC;_T600=_T601->f1;}{struct Cyc_List_List*dles0=_T600;{
# 2523
...
_T40D->r=Cyc_Toc_unresolvedmem_exp_r(0,dles0);goto _TL289;_TL288: _TL289: goto _LL7;}case 26:{struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_T5EC;_T600=_T601->f1;_T5FB=_T601->f2;_T5FA=_T601->f3;_T5FF=_T601->f4;}{struct Cyc_Absyn_Vardecl*vd=_T600;struct Cyc_Absyn_Exp*e1=_T5FB;struct Cyc_Absyn_Exp*e2=_T5FA;int iszeroterm=_T5FF;
# 2531
Cyc_Toc_exp_to_c(nv,e1);
...
_TL291:{struct Cyc_Warn_String_Warn_Warg_struct _T604;_T604.tag=0;_T604.f1=_tag_fat("cannot determine value of constant",sizeof(char),35U);_T414=_T604;}{struct Cyc_Warn_String_Warn_Warg_struct _T604=_T414;void*_T605[1];_T605[0]=& _T604;_T415=e1;_T416=_T415->loc;_T417=_tag_fat(_T605,sizeof(void*),1);Cyc_Warn_err2(_T416,_T417);}goto _TL290;_TL28F: _TL290:{
unsigned i=0U;_TL295: if(i < sz)goto _TL293;else{goto _TL294;}
_TL293:{struct Cyc_List_List*_T604=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple20*_T605=_cycalloc(sizeof(struct _tuple20));_T605->f0=0;_T605->f1=e2;_T419=(struct _tuple20*)_T605;}_T604->hd=_T419;_T604->tl=es;_T418=(struct Cyc_List_List*)_T604;}es=_T418;
# 2541
...
_T605->f0=0;_T605->f1=ezero;_T421=(struct _tuple20*)_T605;}_T604->hd=_T421;_T604->tl=0;_T420=(struct Cyc_List_List*)_T604;}es=Cyc_List_imp_append(_T41F,_T420);}goto _TL297;_TL296: _TL297: goto _TL28D;_TL28C: _TL28D: _T422=e;
# 2549
...
# 2561
_TL298: Cyc_Toc_exp_to_c(nv,e1);_TL299: goto _LL7;}case 29:{struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_T5EC;_T426=_T601->f1;_T600=(void*)_T426;_T5F9=_T601->f3;}{void*st=_T600;struct Cyc_List_List*dles=_T5F9;{
# 2565
...
_T43C->topt=strct_typ;goto _LLF3;}_TL2A5: goto _LLF6;_TL2A3: goto _LLF6;_TL2A1: _LLF6:{struct Cyc_Warn_String_Warn_Warg_struct _T603;_T603.tag=0;
# 2576
_T603.f1=_tag_fat("anonStruct type not an aggregate",sizeof(char),33U);_T43D=_T603;}{struct Cyc_Warn_String_Warn_Warg_struct _T603=_T43D;void*_T604[1];_T604[0]=& _T603;{int(*_T605)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_T43E=_T605;}_T43F=_tag_fat(_T604,sizeof(void*),1);_T43E(_T43F);}_LLF3:;}goto _TL29F;
# 2579
_TL29E: _T440=e;_T440->r=Cyc_Toc_unresolvedmem_exp_r(0,dles);_TL29F: goto _LL7;}}case 28:{struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_T5EC;_T441=(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_T5EC;_T442=& _T441->f1;_T600=(struct _tuple1**)_T442;_T5F9=_T601->f2;_T5F6=_T601->f3;_T5F5=_T601->f4;}{struct _tuple1**tdn=(struct _tuple1**)_T600;struct Cyc_List_List*exist_ts=_T5F9;struct Cyc_List_List*dles=_T5F6;struct Cyc_Absyn_Aggrdecl*sd=_T5F5;
# 2585
if(sd==0)goto _TL2A9;else{goto _TL2AA;}_TL2AA: _T443=sd;_T444=_T443->impl;if(_T444==0)goto _TL2A9;else{goto _TL2A7;}
_TL2A9:{struct Cyc_Warn_String_Warn_Warg_struct _T601;_T601.tag=0;_T601.f1=_tag_fat("exp_to_c, Aggregate_e: missing aggrdecl pointer or fields",sizeof(char),58U);_T445=_T601;}{struct Cyc_Warn_String_Warn_Warg_struct _T601=_T445;void*_T602[1];_T602[0]=& _T601;{int(*_T603)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_T446=_T603;}_T447=_tag_fat(_T602,sizeof(void*),1);_T446(_T447);}goto _TL2A8;_TL2A7: _TL2A8: {
void*new_typ=Cyc_Toc_typ_to_c(old_typ);{
void*_T601=Cyc_Absyn_compress(new_typ);union Cyc_Absyn_AggrInfo _T602;_T448=(int*)_T601;_T449=*_T448;if(_T449!=0)goto _TL2AB;_T44A=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T601;_T44B=_T44A->f1;_T44C=(int*)_T44B;_T44D=*_T44C;if(_T44D!=24)goto _TL2AD;{struct Cyc_Absyn_AppType_Absyn_Type_struct*_T603=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T601;_T44E=_T603->f1;{struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_T604=(struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_T44E;_T602=_T604->f1;}}{union Cyc_Absyn_AggrInfo info=_T602;_T44F=tdn;_T450=
Cyc_Absyn_aggr_kinded_name(info);*_T44F=_T450.f1;goto _LLF8;}_TL2AD: goto _LLFB;_TL2AB: _LLFB:{struct Cyc_Warn_String_Warn_Warg_struct _T603;_T603.tag=0;
...
old_typ=_T468->type;goto loop;}case 0: _T469=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T601;_T46A=_T469->f1;_T46B=(int*)_T46A;_T46C=*_T46B;if(_T46C!=24)goto _TL2B9;{struct Cyc_Absyn_AppType_Absyn_Type_struct*_T604=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T601;_T602=_T604->f2;}{struct Cyc_List_List*param_ts=_T602;{
# 2609
struct Cyc_List_List*fields2=fields;_TL2BE: if(fields2!=0)goto _TL2BC;else{goto _TL2BD;}
_TL2BC: _T46D=fields2;_T46E=_T46D->hd;{struct _tuple38*_T604=(struct _tuple38*)_T46E;struct Cyc_Absyn_Exp*_T605;struct Cyc_Absyn_Aggrfield*_T606;{struct _tuple38 _T607=*_T604;_T606=_T607.f0;_T605=_T607.f1;}{struct Cyc_Absyn_Aggrfield*aggrfield=_T606;struct Cyc_Absyn_Exp*fieldexp=_T605;_T46F=fieldexp;{
void*old_field_typ=_T46F->topt;
Cyc_Toc_exp_to_c(nv,fieldexp);_T470=aggrfield;_T471=_T470->type;_T472=
# 2614
Cyc_Toc_is_void_star_or_boxed_tvar(_T471);if(!_T472)goto _TL2BF;_T473=fieldexp;_T474=_T473->topt;_T475=
_check_null(_T474);_T476=Cyc_Toc_is_pointer_or_boxed_tvar(_T475);
# 2614
if(_T476)goto _TL2BF;else{goto _TL2C1;}
# 2616
_TL2C1: _T477=aggrfield;_T478=_T477->type;{void*t=Cyc_Toc_typ_to_c(_T478);_T479=fieldexp;_T47A=t;_T47B=
Cyc_Toc_deep_copy(fieldexp);_T47C=Cyc_Toc_cast_it(_T47A,_T47B);_T479->r=_T47C->r;_T47D=fieldexp;
_T47D->topt=t;}goto _TL2C0;_TL2BF: _TL2C0: _T47E=sd;_T47F=_T47E->impl;_T480=
# 2621
_check_null(_T47F);_T481=_T480->tagged;if(!_T481)goto _TL2C2;_T482=aggrfield;{
...
_T607->f1=*_T49C;_T607->f2=0;{struct _tuple20*_T608[1];_T608[0]=u_dle;_T49E=_tag_fat(_T608,sizeof(struct _tuple20*),1);_T49D=Cyc_List_list(_T49E);}_T607->f3=_T49D;_T607->f4=sd;_T49B=(struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_T607;}_T49A->r=(void*)_T49B;}}}}goto _TL2C3;_TL2C2: _TL2C3: _T49F=
# 2638
Cyc_Toc_is_abstract_type(old_typ);if(!_T49F)goto _TL2C4;if(last_typ_field!=aggrfield)goto _TL2C4;_T4A0=sd;_T4A1=_T4A0->impl;_T4A2=
...
_check_null(_T4AB);{struct Cyc_List_List*fs=_T4AC->fields;_TL2C9: if(fs!=0)goto _TL2C7;else{goto _TL2C8;}
_TL2C7: _T4AD=fs;_T4AE=_T4AD->hd;{struct Cyc_Absyn_Aggrfield*old_f=(struct Cyc_Absyn_Aggrfield*)_T4AE;_T4AF=inst;_T4B0=old_f;_T4B1=_T4B0->type;{
...
# 2653
if(_T4B7!=0)goto _TL2CA;_T4B8=new_f;_T4B9=_T4B8->type;{
void*_T607=Cyc_Absyn_compress(_T4B9);struct Cyc_Absyn_ArrayInfo _T608;_T4BA=(int*)_T607;_T4BB=*_T4BA;if(_T4BB!=5)goto _TL2CC;{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_T609=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T607;_T608=_T609->f1;}{struct Cyc_Absyn_ArrayInfo ai=_T608;_T4BC=ai;_T4BD=_T4BC.num_elts;_T4BE=
# 2656
_check_null(_T4BD);_T4BF=Cyc_Evexp_c_can_eval(_T4BE);if(_T4BF)goto _TL2CE;else{goto _TL2D0;}
_TL2D0:{struct Cyc_Absyn_ArrayInfo ai2=ai;_T4C0=
...
_T609->f1=ai2;_T4C3=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T609;}_T4C2->type=(void*)_T4C3;}goto _TL2CF;_TL2CE: _TL2CF: goto _LL107;}_TL2CC: _T4C4=fieldexp;_T4C5=_T4C4->topt;
# 2665
if(_T4C5!=0)goto _TL2D1;goto _LL107;_TL2D1: _T4C6=fieldexp;_T4C7=_T4C6->topt;{
# 2667
void*_T609=Cyc_Absyn_compress(_T4C7);_T4C8=(int*)_T609;_T4C9=*_T4C8;if(_T4C9!=0)goto _TL2D3;_T4CA=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T609;_T4CB=_T4CA->f1;_T4CC=(int*)_T4CB;_T4CD=*_T4CC;if(_T4CD!=24)goto _TL2D5;_T4CE=new_f;_T4CF=fieldexp;_T4D0=_T4CF->topt;
# 2669
_T4CE->type=_check_null(_T4D0);goto _LL10C;_TL2D5: goto _LL10F;_TL2D3: _LL10F: goto _LL10C;_LL10C:;}goto _LL107;_LL107:;}_T4D1=old_f;_T4D2=_T4D1->type;_T4D3=
# 2676
Cyc_Tcutil_is_array_type(_T4D2);if(_T4D3)goto _TL2D7;else{goto _TL2D9;}_TL2D9: _T4D4=& Cyc_Kinds_ak;_T4D5=(struct Cyc_Absyn_Kind*)_T4D4;_T4D6=old_f;_T4D7=_T4D6->type;_T4D8=
Cyc_Tcutil_type_kind(_T4D7);_T4D9=Cyc_Kinds_kind_leq(_T4D5,_T4D8);
# 2676
if(!_T4D9)goto _TL2D7;_T4DA=new_f;{struct Cyc_List_List*_T607=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_T608=_cycalloc(sizeof(struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct));_T608->tag=6;
# 2678
...
# 2678
_T4DA->attributes=_T4DB;goto _TL2D8;_TL2D7: _TL2D8: goto _TL2CB;_TL2CA: _TL2CB:;}}}_T4DE=fs;
# 2642
fs=_T4DE->tl;goto _TL2C9;_TL2C8:;}{struct _fat_ptr*_T607=_cycalloc(sizeof(struct _fat_ptr));{struct Cyc_Int_pa_PrintArg_struct _T608;_T608.tag=1;_T4E2=Cyc_Toc_tuple_type_counter;
# 2683
...
# 2688
*_T607=sd;_T4EA=(struct Cyc_Absyn_Aggrdecl**)_T607;}_T4EB=Cyc_Absyn_KnownAggr(_T4EA);_T4E9->topt=Cyc_Absyn_aggr_type(_T4EB,0);}goto _TL2C5;_TL2C4: _TL2C5:;}}}_T4EC=fields2;
# 2609
fields2=_T4EC->tl;goto _TL2BE;_TL2BD:;}goto _LLFD;}_TL2B9: goto _LL102;default: _LL102:{struct Cyc_Warn_String_Warn_Warg_struct _T604;_T604.tag=0;
# 2692
_T604.f1=_tag_fat("exp_to_c, Aggregate_e: bad struct type",sizeof(char),39U);_T4ED=_T604;}{struct Cyc_Warn_String_Warn_Warg_struct _T604=_T4ED;void*_T605[1];_T605[0]=& _T604;{int(*_T606)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_T4EE=_T606;}_T4EF=_tag_fat(_T605,sizeof(void*),1);_T4EE(_T4EF);}}_LLFD:;}goto _TL2B6;
# 2700
_TL2B5: _T4F0=sd;_T4F1=_T4F0->impl;_T4F2=_check_null(_T4F1);_T4F3=_T4F2->tagged;if(!_T4F3)goto _TL2DA;_T4F4=
# 2702
...
Cyc_Toc_is_void_star_or_boxed_tvar(fieldtyp);if(!_T4F9)goto _TL2DC;_T4FA=
Cyc_Toc_is_void_star_or_boxed_tvar(fieldexp_type);
# 2706
if(_T4FA)goto _TL2DC;else{goto _TL2DE;}
# 2708
_TL2DE: _T4FB=fieldexp;_T4FC=
Cyc_Toc_void_star_type();_T4FD=Cyc_Toc_deep_copy(fieldexp);
# 2708
_T4FB->r=
Cyc_Toc_cast_it_r(_T4FC,_T4FD);goto _TL2DD;_TL2DC: _TL2DD: _T4FE=sd;_T4FF=field;_T500=_T4FF->name;{
# 2711
...
Cyc_Toc_make_field(_T50A,_T50B);_T50C=_tag_fat(_T604,sizeof(struct _tuple20*),1);_T508=Cyc_List_list(_T50C);}_T507->r=Cyc_Toc_unresolvedmem_exp_r(0,_T508);}}}}}}}goto _TL2DB;
# 2718
_TL2DA:{struct Cyc_List_List*newdles=0;_T50D=sd;_T50E=_T50D->impl;{
struct Cyc_List_List*sdfields=_T50E->fields;
_TL2E2: if(sdfields!=0)goto _TL2E0;else{goto _TL2E1;}
_TL2E0:{struct Cyc_List_List*fields2=fields;_TL2E6: if(fields2!=0)goto _TL2E4;else{goto _TL2E5;}
_TL2E4: _T50F=fields2;_T510=_T50F->hd;_T511=(struct _tuple38*)_T510;_T512=*_T511;_T513=_T512.f0;_T514=sdfields;_T515=_T514->hd;_T516=(struct Cyc_Absyn_Aggrfield*)_T515;if(_T513!=_T516)goto _TL2E7;_T517=fields2;_T518=_T517->hd;{
...
# 2730
Cyc_Unify_unify(fieldtyp,Cyc_Absyn_void_type);if(_T51E)goto _TL2E9;else{goto _TL2EB;}_TL2EB: _T51F=
Cyc_Unify_unify(fieldtyp,fieldexp_typ);
# 2730
if(_T51F)goto _TL2E9;else{goto _TL2EC;}
# 2733
_TL2EC: _T520=Cyc_Tcutil_is_arithmetic_type(fieldtyp);if(_T520)goto _TL2F0;else{goto _TL2EF;}_TL2F0: _T521=
Cyc_Tcutil_is_arithmetic_type(fieldexp_typ);
# 2733
if(_T521)goto _TL2ED;else{goto _TL2EF;}
# 2735
_TL2EF: _T522=fieldtyp;_T523=Cyc_Toc_deep_copy(fieldexp);fieldexp=Cyc_Toc_cast_it(_T522,_T523);goto _TL2EE;_TL2ED: _TL2EE: goto _TL2EA;_TL2E9: _TL2EA:{struct Cyc_List_List*_T604=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple20*_T605=_cycalloc(sizeof(struct _tuple20));
_T605->f0=0;_T605->f1=fieldexp;_T525=(struct _tuple20*)_T605;}_T604->hd=_T525;_T604->tl=newdles;_T524=(struct Cyc_List_List*)_T604;}newdles=_T524;goto _TL2E5;}}}}_TL2E7: _T526=fields2;
# 2721
fields2=_T526->tl;goto _TL2E6;_TL2E5:;}_T527=sdfields;
# 2720
sdfields=_T527->tl;goto _TL2E2;_TL2E1: _T528=e;_T529=
# 2740
Cyc_List_imp_rev(newdles);_T528->r=Cyc_Toc_unresolvedmem_exp_r(0,_T529);}}_TL2DB: _TL2B6: goto _LL7;}}}}}case 30:{struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_T5EC;_T5F9=_T601->f1;_T5F4=_T601->f2;_T5F3=_T601->f3;}{struct Cyc_List_List*es=_T5F9;struct Cyc_Absyn_Datatypedecl*tud=_T5F4;struct Cyc_Absyn_Datatypefield*tuf=_T5F3;_T52A=tuf;{
# 2747
struct Cyc_List_List*tqts=_T52A->typs;{
struct Cyc_List_List*es2=es;_TL2F4: if(es2!=0)goto _TL2F2;else{goto _TL2F3;}
_TL2F2: _T52B=es2;_T52C=_T52B->hd;{struct Cyc_Absyn_Exp*cur_e=(struct Cyc_Absyn_Exp*)_T52C;_T52D=cur_e;_T52E=_T52D->topt;{
...
Cyc_Toc_is_void_star_or_boxed_tvar(field_typ);if(!_T534)goto _TL2F5;_T535=
Cyc_Toc_is_pointer_or_boxed_tvar(cur_e_typ);
# 2753
if(_T535)goto _TL2F5;else{goto _TL2F7;}
# 2755
_TL2F7: _T536=cur_e;_T537=field_typ;_T538=Cyc_Toc_deep_copy(cur_e);_T539=Cyc_Toc_cast_it(_T537,_T538);_T536->r=_T539->r;goto _TL2F6;_TL2F5: _TL2F6:;}}}_T53A=es2;
# 2748
es2=_T53A->tl;_T53B=tqts;tqts=_T53B->tl;goto _TL2F4;_TL2F3:;}_T53D=tud;_T53E=_T53D->is_extensible;
# 2759
if(!_T53E)goto _TL2F8;_T53F=tuf;_T540=_T53F->name;_T541=Cyc_Absyn_var_exp(_T540,0U);_T542=Cyc_Absyn_cstar_type(Cyc_Absyn_char_type,Cyc_Toc_mt_tq);_T53C=Cyc_Absyn_set_type(_T541,_T542);goto _TL2F9;_TL2F8: _T543=tud;_T544=tuf;_T545=_T544->name;_T53C=Cyc_Toc_datatype_tag(_T543,_T545);_TL2F9: {
# 2758
struct Cyc_Absyn_Exp*tag_exp=_T53C;_T546=
# 2762
Cyc_Toc_is_toplevel(nv);if(_T546)goto _TL2FA;else{goto _TL2FC;}
# 2764
_TL2FC:{struct Cyc_List_List*dles=0;{
int i=1;_TL300: if(es!=0)goto _TL2FE;else{goto _TL2FF;}
_TL2FE:{struct Cyc_List_List*_T601=_cycalloc(sizeof(struct Cyc_List_List));_T548=Cyc_Absyn_fieldname(i);_T549=es;_T54A=_T549->hd;_T54B=(struct Cyc_Absyn_Exp*)_T54A;_T601->hd=Cyc_Toc_make_field(_T548,_T54B);_T601->tl=dles;_T547=(struct Cyc_List_List*)_T601;}dles=_T547;_T54C=es;
# 2765
es=_T54C->tl;i=i + 1;goto _TL300;_TL2FF:;}{
# 2770
...
# 2771
_T54D->r=(void*)_T54E;}}goto _TL2FB;
# 2776
_TL2FA:{struct Cyc_List_List*dles=0;
_TL304: if(es!=0)goto _TL302;else{goto _TL303;}
_TL302:{struct Cyc_List_List*_T601=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple20*_T602=_cycalloc(sizeof(struct _tuple20));_T602->f0=0;_T556=es;_T557=_T556->hd;_T602->f1=(struct Cyc_Absyn_Exp*)_T557;_T555=(struct _tuple20*)_T602;}_T601->hd=_T555;_T601->tl=dles;_T554=(struct Cyc_List_List*)_T601;}dles=_T554;_T558=es;
# 2777
es=_T558->tl;goto _TL304;_TL303: _T559=e;{struct Cyc_List_List*_T601=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple20*_T602=_cycalloc(sizeof(struct _tuple20));
# 2779
...
if(!_T565)goto _TL305;
x=Cyc_Toc_temp_var();
num_elts2=Cyc_Absyn_var_exp(x,0U);goto _TL306;_TL305: _TL306: _T566=mknd;_T567=(int)_T566;
# 2797
if(_T567!=1)goto _TL307;
if(rgnopt==0)goto _TL30D;else{goto _TL30C;}_TL30D: if(aqopt==0)goto _TL30B;else{goto _TL30C;}_TL30C: _T568=Cyc_Flags_no_regions;if(_T568)goto _TL30B;else{goto _TL309;}
_TL30B: _T569=topt;_T56A=*_T569;_T56B=Cyc_Absyn_sizeoftype_exp(t_c,0U);_T56C=Cyc_Absyn_uint_type;_T56D=Cyc_Absyn_set_type(_T56B,_T56C);_T56E=num_elts2;pexp=Cyc_Toc_calloc_exp(_T56A,_T56D,_T56E);goto _TL30A;
# 2801
_TL309: if(aqopt==0)goto _TL30E;Cyc_Toc_exp_to_c(nv,aqopt);goto _TL30F;_TL30E: _TL30F:
 if(rgnopt==0)goto _TL310;
Cyc_Toc_exp_to_c(nv,rgnopt);_T56F=rgnopt;
if(aqopt!=0)goto _TL312;_T570=Cyc_Toc_aliasable_qual_exp();goto _TL313;_TL312: _T570=aqopt;_TL313: _T571=
Cyc_Absyn_sizeoftype_exp(t_c,0U);_T572=Cyc_Absyn_uint_type;_T573=Cyc_Absyn_set_type(_T571,_T572);_T574=num_elts2;
# 2804
pexp=Cyc_Toc_rcalloc_exp(_T56F,_T570,_T573,_T574);goto _TL311;
# 2808
_TL310: _T575=aqopt;_T576=Cyc_Absyn_sizeoftype_exp(t_c,0U);_T577=Cyc_Absyn_uint_type;_T578=Cyc_Absyn_set_type(_T576,_T577);_T579=num_elts2;pexp=Cyc_Toc_aqcalloc_exp(_T575,_T578,_T579);_TL311: _TL30A: goto _TL308;
# 2812
_TL307: if(rgnopt==0)goto _TL318;else{goto _TL317;}_TL318: if(aqopt==0)goto _TL316;else{goto _TL317;}_TL317: _T57A=Cyc_Flags_no_regions;if(_T57A)goto _TL316;else{goto _TL314;}
_TL316: _T57B=topt;_T57C=*_T57B;_T57D=num_elts2;pexp=Cyc_Toc_malloc_exp(_T57C,_T57D);goto _TL315;
# 2815
_TL314: if(aqopt==0)goto _TL319;Cyc_Toc_exp_to_c(nv,aqopt);goto _TL31A;_TL319: _TL31A:
 if(rgnopt==0)goto _TL31B;
Cyc_Toc_exp_to_c(nv,rgnopt);_T57E=mknd;_T57F=(int)_T57E;
if(_T57F!=2)goto _TL31D;
pexp=Cyc_Toc_rvmalloc_exp(rgnopt,num_elts2);goto _TL31E;
# 2821
_TL31D: _T581=inline_call;if(!_T581)goto _TL31F;_T580=Cyc_Toc_rmalloc_inline_exp;goto _TL320;_TL31F: _T580=Cyc_Toc_rmalloc_exp;_TL320:{struct Cyc_Absyn_Exp*(*fn_e)(struct Cyc_Absyn_Exp*,struct Cyc_Absyn_Exp*,struct Cyc_Absyn_Exp*)=_T580;_T582=rgnopt;
if(aqopt!=0)goto _TL321;_T583=Cyc_Toc_aliasable_qual_exp();goto _TL322;_TL321: _T583=aqopt;_TL322: _T584=num_elts2;pexp=fn_e(_T582,_T583,_T584);}_TL31E: goto _TL31C;
# 2826
_TL31B: pexp=Cyc_Toc_aqmalloc_exp(aqopt,num_elts2);_TL31C: _TL315: _TL308: _T585=is_fat;
# 2829
if(!_T585)goto _TL323;_T587=mknd;_T588=(int)_T587;
if(_T588!=1)goto _TL325;_T589=Cyc_Absyn_sizeoftype_exp(t_c,0U);_T58A=Cyc_Absyn_uint_type;_T586=Cyc_Absyn_set_type(_T589,_T58A);goto _TL326;_TL325: _T58B=Cyc_Absyn_uint_exp(1U,0U);_T58C=Cyc_Absyn_uint_type;_T586=Cyc_Absyn_set_type(_T58B,_T58C);_TL326:{struct Cyc_Absyn_Exp*elt_sz=_T586;{struct Cyc_Absyn_Exp*_T601[3];
...
# 2835
_T595->r=Cyc_Toc_stmt_exp_r(s);}}}goto _TL324;
# 2837
_TL323: _T596=e;_T597=Cyc_Toc_typ_to_c(old_typ);_T598=pexp;_T596->r=Cyc_Toc_cast_it_r(_T597,_T598);_TL324: goto _LL7;}}}case 34:{struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*_T601=(struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_T5EC;_T5FA=_T601->f1;_T5F1=_T601->f2;}{struct Cyc_Absyn_Exp*e1=_T5FA;struct Cyc_Absyn_Exp*e2=_T5F1;_T599=e1;_T59A=_T599->topt;{
# 2852
void*e1_old_typ=_check_null(_T59A);_T59B=e2;_T59C=_T59B->topt;{
void*e2_old_typ=_check_null(_T59C);_T59D=
Cyc_Tcutil_is_boxed(e1_old_typ);if(_T59D)goto _TL327;else{goto _TL329;}_TL329: _T59E=Cyc_Tcutil_is_pointer_type(e1_old_typ);if(_T59E)goto _TL327;else{goto _TL32A;}
_TL32A:{struct Cyc_Warn_String_Warn_Warg_struct _T601;_T601.tag=0;_T601.f1=_tag_fat("Swap_e: is_pointer_or_boxed: not a pointer or boxed type",sizeof(char),57U);_T59F=_T601;}{struct Cyc_Warn_String_Warn_Warg_struct _T601=_T59F;void*_T602[1];_T602[0]=& _T601;{int(*_T603)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_T5A0=_T603;}_T5A1=_tag_fat(_T602,sizeof(void*),1);_T5A0(_T5A1);}goto _TL328;_TL327: _TL328: _T5A2=e;{
# 2860
...
Cyc_Toc_exp_to_c(nv,e1);{struct Cyc_Absyn_Aggrdecl*_T601;_T5BB=e1_typ;_T5BC=(int*)_T5BB;_T5BD=*_T5BC;if(_T5BD!=0)goto _TL32B;_T5BE=e1_typ;_T5BF=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T5BE;_T5C0=_T5BF->f1;_T5C1=(int*)_T5C0;_T5C2=*_T5C1;if(_T5C2!=24)goto _TL32D;_T5C3=e1_typ;_T5C4=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T5C3;_T5C5=_T5C4->f1;_T5C6=(struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_T5C5;_T5C7=_T5C6->f1;_T5C8=_T5C7.KnownAggr;_T5C9=_T5C8.tag;if(_T5C9!=2)goto _TL32F;_T5CA=e1_typ;{struct Cyc_Absyn_AppType_Absyn_Type_struct*_T602=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T5CA;_T5CB=_T602->f1;{struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_T603=(struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_T5CB;_T5CC=_T603->f1;_T5CD=_T5CC.KnownAggr;_T5CE=_T5CD.val;{struct Cyc_Absyn_Aggrdecl*_T604=*_T5CE;_T601=_T604;}}}{struct Cyc_Absyn_Aggrdecl*ad=_T601;_T5CF=
# 2883
...
Cyc_Absyn_eq_exp(e1_f_tag,f_tag,0U);_T5D6->r=_T5D7->r;goto _LL117;}}}}_TL32F: goto _LL11A;_TL32D: goto _LL11A;_TL32B: _LL11A:{struct Cyc_Warn_String_Warn_Warg_struct _T602;_T602.tag=0;
# 2888
...
# 2900
if(_T5E4)goto _TL331;else{goto _TL333;}
_TL333:{struct Cyc_Warn_String_Warn_Warg_struct _T5EC;_T5EC.tag=0;_T5EC.f1=_tag_fat("Toc did not examine an inserted check: ",sizeof(char),40U);_T5E5=_T5EC;}{struct Cyc_Warn_String_Warn_Warg_struct _T5EC=_T5E5;{struct Cyc_Warn_Exp_Warn_Warg_struct _T5ED;_T5ED.tag=4;_T5ED.f1=e;_T5E6=_T5ED;}{struct Cyc_Warn_Exp_Warn_Warg_struct _T5ED=_T5E6;void*_T5EE[2];_T5EE[0]=& _T5EC;_T5EE[1]=& _T5ED;_T5E8=Cyc_Warn_impos_loc2;{int(*_T5EF)(unsigned,struct _fat_ptr)=(int(*)(unsigned,struct _fat_ptr))_T5E8;_T5E7=_T5EF;}_T5E9=e;_T5EA=_T5E9->loc;_T5EB=_tag_fat(_T5EE,sizeof(void*),2);_T5E7(_T5EA,_T5EB);}}goto _TL332;_TL331: _TL332:;}}}struct _tuple39{int f0;struct _fat_ptr*f1;struct _fat_ptr*f2;struct Cyc_Absyn_Switch_clause*f3;};
# 2929 "toc.cyc"
...
_TL337: if(ps!=0)goto _TL335;else{goto _TL336;}
_TL335: _T0=ps;_T1=_T0->hd;{struct Cyc_Tcpat_PathNode*p=(struct Cyc_Tcpat_PathNode*)_T1;_T2=p;_T3=_T2->orig_pat;_T4=_T3.pattern;_T5=_T4.tag;_T6=_T5==1;_T7=(int)_T6;
# 2943
if(!_T7)goto _TL338;_T9=p;{union Cyc_Tcpat_PatOrWhere _T46=_T9->orig_pat;_TA=_T46.pattern;_TB=_TA.tag;if(_TB==1)goto _TL33A;_throw_match();goto _TL33B;_TL33A: _TL33B: _TC=_T46.pattern;_T8=_TC.val;}_TD=_T8->topt;{
...
# 2951
 v=Cyc_Toc_cast_it(t2,v);goto _LL0;}_LL0:;}}goto _TL339;_TL338: _TL339: _T17=p;{
# 2954
...
# 2963
if(_T1C==0)goto _TL33F;_T1D=ps;_T1E=_T1D->tl;_T1F=_T1E->hd;_T20=(struct Cyc_Tcpat_PathNode*)_T1F;{
void*_T4C=_T20->access;void*_T4D;unsigned _T4E;struct Cyc_Absyn_Datatypefield*_T4F;struct Cyc_Absyn_Datatypedecl*_T50;_T21=(int*)_T4C;_T22=*_T21;if(_T22!=2)goto _TL341;{struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*_T51=(struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_T4C;_T50=_T51->f1;_T4F=_T51->f2;_T4E=_T51->f3;_T23=_T51->f4;_T4D=(void*)_T23;}{struct Cyc_Absyn_Datatypedecl*tud=_T50;struct Cyc_Absyn_Datatypefield*tuf=_T4F;unsigned i=_T4E;void*res_type2=_T4D;_T24=ps;
# 2966
...
Cyc_Absyn_fieldname(_T30);_T32=Cyc_Absyn_aggrarrow_exp(_T2E,_T31,0U);_T33=Cyc_Toc_typ_to_c_array(res_type2);v=Cyc_Absyn_set_type(_T32,_T33);goto _TL334;}_TL341: goto _LL12;_LL12:;}goto _TL340;_TL33F: _TL340: _T34=
# 2972
...
if(!_T3F)goto _TL343;_T40=v;_T41=
# 2981
Cyc_Toc_tagged_union_field_struct(at,f);Cyc_Absyn_set_type(_T40,_T41);
v=Cyc_Toc_member_exp(v,Cyc_Toc_val_sp,0U);goto _TL344;_TL343: _TL344: _T42=v;_T43=
# 2984
Cyc_Toc_typ_to_c_array(res_type);v=Cyc_Absyn_set_type(_T42,_T43);goto _LL9;}}_LL9:;}}_TL334: _T44=ps;
# 2938
ps=_T44->tl;goto _TL337;_TL336: _T45=v;
# 2988
return _T45;}
# 2993
...
# 2995
if(e!=0)goto _TL346;_T4=v;goto _TL347;_TL346: _T4=e;_TL347: return _T4;}case 1: _T5=v;_T6=
# 2997
...
void*k=(void*)_T1;
_TL34D: if(ss!=0)goto _TL34B;else{goto _TL34C;}
_TL34B: _T2=ss;_T3=_T2->hd;_T4=(struct _tuple36*)_T3;{struct _tuple36 _T18=*_T4;void*_T19;_T19=_T18.f0;{void*ptest=_T19;struct Cyc_Absyn_Exp*_T1A;struct _fat_ptr*_T1B;void*_T1C;_T5=ptest;_T6=(int*)_T5;_T7=*_T6;switch(_T7){case 3: goto _LL7;case 4: _LL7: goto _LL9;case 6: _LL9: goto _TL34A;case 8: _T8=ptest;{struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*_T1D=(struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_T8;_T9=_T1D->f1;_T1C=(void*)_T9;_T1B=_T1D->f2;}{void*t=_T1C;struct _fat_ptr*f=_T1B;_TA=k;_TB=& Cyc_Toc_OtherTest_val;_TC=(struct Cyc_Toc_OtherTest_Toc_TestKind_struct*)_TB;_TD=(void*)_TC;
# 3077
if(_TA!=_TD)goto _TL34F;{struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct*_T1D=_cycalloc(sizeof(struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct));_T1D->tag=3;
_T1D->f1=t;_T1D->f2=f;_TE=(struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct*)_T1D;}k=(void*)_TE;goto _TL350;_TL34F: _TL350: goto _TL34A;}case 7: _TF=& Cyc_Toc_DatatypeTagTest_val;_T10=(struct Cyc_Toc_DatatypeTagTest_Toc_TestKind_struct*)_TF;
# 3080
k=(void*)_T10;goto _TL34A;case 0: _T11=ptest;{struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct*_T1D=(struct Cyc_Tcpat_WhereTest_Tcpat_PatTest_struct*)_T11;_T1A=_T1D->f1;}_T12=(struct Cyc_Absyn_Exp*)_T1A;if(_T12==0)goto _TL351;{struct Cyc_Absyn_Exp*e=_T1A;{struct Cyc_Toc_WhereTest_Toc_TestKind_struct*_T1D=_cycalloc(sizeof(struct Cyc_Toc_WhereTest_Toc_TestKind_struct));_T1D->tag=2;
# 3082
_T1D->f1=e;_T13=(struct Cyc_Toc_WhereTest_Toc_TestKind_struct*)_T1D;}k=(void*)_T13;{struct _tuple40 _T1D;_T1D.f0=0;_T1D.f1=k;_T14=_T1D;}return _T14;}_TL351: goto _LL13;case 1: _LL13: goto _LL15;case 2: _LL15: goto _LL17;case 5: _LL17: goto _LL19;default: _LL19:{struct _tuple40 _T1D;
# 3087
_T1D.f0=0;_T1D.f1=k;_T15=_T1D;}return _T15;};}}_TL34A: _T16=ss;
# 3069
ss=_T16->tl;c=c + 1;goto _TL34D;_TL34C:{struct _tuple40 _T18;
# 3090
...
if(s1!=0)goto _TL354;_T0=s2;return _T0;_TL354:
 if(s2!=0)goto _TL356;_T1=s1;return _T1;_TL356: _T2=
...
struct Cyc_List_List*ds=*_T0;_TL35B: if(ds!=0)goto _TL359;else{goto _TL35A;}
# 3125
_TL359: _T1=other_vd;_T2=ds;_T3=_T2->hd;_T4=(struct _tuple41*)_T3;_T5=*_T4;_T6=_T5.f1;if(_T1!=_T6)goto _TL35C;return 1;_TL35C: _T7=ds;
# 3122
ds=_T7->tl;goto _TL35B;_TL35A:;}
# 3126
return 0;}
# 3129
...
void*_T7=Cyc_Absyn_compress(ctype);struct Cyc_Absyn_Tqual _T8;_T0=(int*)_T7;_T1=*_T0;if(_T1!=4)goto _TL35E;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T9=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T7;_T2=_T9->f1;_T8=_T2.elt_tq;}{struct Cyc_Absyn_Tqual tq=_T8;_T3=
# 3132
Cyc_Absyn_equal_tqual(tq,Cyc_Toc_mt_tq);if(!_T3)goto _TL360;_T4=Cyc_Toc_is_void_star(other);if(!_T4)goto _TL360;
return 1;_TL360: goto _LL4;}_TL35E: _LL4: _T5=
# 3135
...
void*_T4=Cyc_Absyn_compress(ctype);struct Cyc_Absyn_Tqual _T5;_T0=(int*)_T4;_T1=*_T0;if(_T1!=4)goto _TL362;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T6=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T4;_T2=_T6->f1;_T5=_T2.elt_tq;}{struct Cyc_Absyn_Tqual tq=_T5;_T3=
Cyc_Absyn_equal_tqual(tq,Cyc_Toc_mt_tq);return _T3;}_TL362:
...
# 3165
struct Cyc_List_List*pds=*_TC;_TL368: if(pds!=0)goto _TL366;else{goto _TL367;}
_TL366: _TD=pds;_TE=_TD->hd;_TF=(struct _tuple42*)_TE;{struct _tuple42 _T161=*_TF;struct Cyc_Absyn_Vardecl*_T162;_T162=_T161.f1;{struct Cyc_Absyn_Vardecl*other_vd=_T162;_T10=ctype;_T11=other_vd;_T12=_T11->type;_T13=
# 3169
Cyc_Toc_is_usuable_type(_T10,_T12);if(!_T13)goto _TL369;_T14=
Cyc_Toc_vd_in_use(other_vd,newdecls);
# 3169
if(_T14)goto _TL369;else{goto _TL36B;}
# 3171
_TL36B: _T15=newdecls;_T17=rgn;{struct Cyc_List_List*_T163=_region_malloc(_T17,0U,sizeof(struct Cyc_List_List));_T19=rgn;{struct _tuple41*_T164=_region_malloc(_T19,0U,sizeof(struct _tuple41));_T164->f0=vd;_T164->f1=other_vd;_T164->f2=ctype;_T164->f3=0;_T18=(struct _tuple41*)_T164;}_T163->hd=_T18;_T1A=newdecls;
...
# 3175
Cyc_Toc_extract_pattern_vars(_T22,_T23,_T24,_T25,_T26,_T27,_T28);_T2A=Cyc_Toc_seq_stmt_opt(_T21,_T29);return _T2A;}}_TL369:;}}_T2B=pds;
# 3165
pds=_T2B->tl;goto _TL368;_TL367:;}{
# 3182
...
# 3196
struct Cyc_List_List*pds=*_T47;_TL36F: if(pds!=0)goto _TL36D;else{goto _TL36E;}
_TL36D: _T48=pds;_T49=_T48->hd;_T4A=(struct _tuple42*)_T49;{struct _tuple42 _T161=*_T4A;struct Cyc_Absyn_Vardecl*_T162;_T162=_T161.f1;{struct Cyc_Absyn_Vardecl*other_vd=_T162;_T4B=ctype;_T4C=other_vd;_T4D=_T4C->type;_T4E=
# 3200
Cyc_Toc_is_usuable_type(_T4B,_T4D);if(!_T4E)goto _TL370;_T4F=
Cyc_Toc_vd_in_use(other_vd,newdecls);
# 3200
if(_T4F)goto _TL370;else{goto _TL372;}
# 3202
_TL372: _T50=newdecls;_T52=rgn;{struct Cyc_List_List*_T163=_region_malloc(_T52,0U,sizeof(struct Cyc_List_List));_T54=rgn;{struct _tuple41*_T164=_region_malloc(_T54,0U,sizeof(struct _tuple41));_T164->f0=vd;_T164->f1=other_vd;_T164->f2=ctype;_T164->f3=0;_T53=(struct _tuple41*)_T164;}_T163->hd=_T53;_T55=newdecls;
...
# 3206
Cyc_Toc_deep_copy(rpath);_T5D=Cyc_Absyn_assign_stmt(_T5B,_T5C,0U);return _T5D;}_TL370:;}}_T5E=pds;
# 3196
pds=_T5E->tl;goto _TL36F;_TL36E:;}{
# 3210
struct Cyc_Absyn_Vardecl*new_vd;_T5F=
Cyc_Toc_can_use_voidstar(ctype);if(!_T5F)goto _TL373;_T60=
...
# 3213
*_T62=_T63;goto _TL374;
# 3216
_TL373: _T68=Cyc_Toc_temp_var();_T69=ctype;new_vd=Cyc_Absyn_new_vardecl(0U,_T68,_T69,0,0);_T6A=newdecls;_T6C=rgn;{struct Cyc_List_List*_T161=_region_malloc(_T6C,0U,sizeof(struct Cyc_List_List));_T6E=rgn;{struct _tuple41*_T162=_region_malloc(_T6E,0U,sizeof(struct _tuple41));
...
# 3217
*_T6A=_T6B;_TL374:{struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_T161=_cycalloc(sizeof(struct Cyc_Absyn_Local_b_Absyn_Binding_struct));_T161->tag=4;
# 3220
...
# 3229
struct Cyc_List_List*pds=*_T7B;_TL378: if(pds!=0)goto _TL376;else{goto _TL377;}
_TL376: _T7C=pds;_T7D=_T7C->hd;_T7E=(struct _tuple42*)_T7D;{struct _tuple42 _T161=*_T7E;struct Cyc_Absyn_Vardecl*_T162;_T162=_T161.f1;{struct Cyc_Absyn_Vardecl*other_vd=_T162;_T7F=ctype;_T80=other_vd;_T81=_T80->type;_T82=
# 3233
Cyc_Toc_is_usuable_type(_T7F,_T81);if(!_T82)goto _TL379;_T83=
Cyc_Toc_vd_in_use(other_vd,newdecls);
# 3233
if(_T83)goto _TL379;else{goto _TL37B;}
# 3235
_TL37B: _T84=newdecls;_T86=rgn;{struct Cyc_List_List*_T163=_region_malloc(_T86,0U,sizeof(struct Cyc_List_List));_T88=rgn;{struct _tuple41*_T164=_region_malloc(_T88,0U,sizeof(struct _tuple41));_T164->f0=vd;_T164->f1=other_vd;_T164->f2=ctype;_T164->f3=0;_T87=(struct _tuple41*)_T164;}_T163->hd=_T87;_T89=newdecls;
...
Cyc_Toc_extract_pattern_vars(rgn,nv,newdecls,prevdecls,lpath,rpath,p2);_T98=Cyc_Toc_seq_stmt_opt(_T96,_T97);return _T98;}}}}_TL379:;}}_T99=pds;
# 3229
pds=_T99->tl;goto _TL378;_TL377:;}{
# 3249
struct Cyc_Absyn_Vardecl*new_vd;_T9A=
Cyc_Toc_can_use_voidstar(ctype);if(!_T9A)goto _TL37C;_T9B=
...
# 3252
*_T9D=_T9E;goto _TL37D;
# 3255
_TL37C: _TA3=Cyc_Toc_temp_var();_TA4=ctype;new_vd=Cyc_Absyn_new_vardecl(0U,_TA3,_TA4,0,0);_TA5=newdecls;_TA7=rgn;{struct Cyc_List_List*_T161=_region_malloc(_TA7,0U,sizeof(struct Cyc_List_List));_TA9=rgn;{struct _tuple41*_T162=_region_malloc(_TA9,0U,sizeof(struct _tuple41));
...
_TL385: if(ps!=0)goto _TL383;else{goto _TL384;}
_TL383: _TD0=ps;_TD1=_TD0->hd;{struct Cyc_Absyn_Pat*p2=(struct Cyc_Absyn_Pat*)_TD1;_TD2=p2;_TD3=_TD2->r;_TD4=& Cyc_Absyn_Wild_p_val;_TD5=(struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*)_TD4;_TD6=(void*)_TD5;
if(_TD3!=_TD6)goto _TL386;goto _TL382;_TL386: _TD7=
...
Cyc_Toc_typ_to_c(tuf_typ);_TE2=Cyc_Toc_is_void_star_or_boxed_tvar(_TE1);if(!_TE2)goto _TL388;
rarrow_exp=Cyc_Toc_cast_it(t2c,rarrow_exp);
larrow_exp=Cyc_Toc_cast_it(t2c,larrow_exp);goto _TL389;_TL388: _TL389: _TE3=s;_TE4=
# 3300
Cyc_Toc_extract_pattern_vars(rgn,nv,newdecls,prevdecls,larrow_exp,rarrow_exp,p2);s=Cyc_Toc_seq_stmt_opt(_TE3,_TE4);}}}}}_TL382: _TE5=ps;
# 3286
ps=_TE5->tl;_TE6=_check_null(tuf_tqts);tuf_tqts=_TE6->tl;cnt=cnt + 1;goto _TL385;_TL384:
# 3302
...
_T161->f1=new_vd;_TE7=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_T161;}_TE8=(void*)_TE7;_TE9=Cyc_Absyn_new_decl(_TE8,0U);_TEA=s;s=Cyc_Absyn_decl_stmt(_TE9,_TEA,0U);goto _TL38B;_TL38A: _TL38B: _TEB=s;
return _TEB;}}}}}}}_TL37E:{struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*_T161=(struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_T15C;_T160=_T161->f1;}{struct Cyc_Absyn_Pat*p2=_T160;_TEC=p2;_TED=_TEC->topt;{
# 3381
...
# 3388
if(s==0)goto _TL38C;{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_T161=_cycalloc(sizeof(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct));_T161->tag=0;
_T161->f1=new_vd;_T100=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_T161;}_T101=(void*)_T100;_T102=Cyc_Absyn_new_decl(_T101,0U);_T103=s;s=Cyc_Absyn_decl_stmt(_T102,_T103,0U);goto _TL38D;_TL38C: _TL38D: _T104=s;
...
int cnt=1;_TL391: if(ps!=0)goto _TL38F;else{goto _TL390;}
_TL38F: _T105=ps;_T106=_T105->hd;{struct Cyc_Absyn_Pat*p2=(struct Cyc_Absyn_Pat*)_T106;_T107=p2;_T108=_T107->r;_T109=& Cyc_Absyn_Wild_p_val;_T10A=(struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*)_T109;_T10B=(void*)_T10A;
if(_T108!=_T10B)goto _TL392;goto _TL38E;_TL392: _T10C=p2;_T10D=_T10C->topt;{
# 3312
...
Cyc_Toc_extract_pattern_vars(rgn,nv,newdecls,prevdecls,lp,rp,p2);s=Cyc_Toc_seq_stmt_opt(_T112,_T113);}}}}_TL38E: _T114=ps;
# 3308
ps=_T114->tl;cnt=cnt + 1;goto _TL391;_TL390:;}_T115=s;
# 3319
...
is_tagged=_T125->tagged;goto _LL2E;}_TL397: goto _LL33;case 7:{struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_T166=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_T161;_T164=_T166->f1;_T163=_T166->f2;_T162=_T166->f3;}{enum Cyc_Absyn_AggrKind ak=_T164;int is_tuple=_T163;struct Cyc_List_List*fs=_T162;
# 3333
...
# 3337
struct Cyc_Absyn_Stmt*s=0;
_TL39C: if(dlps!=0)goto _TL39A;else{goto _TL39B;}
_TL39A: _T129=dlps;_T12A=_T129->hd;{struct _tuple43*tup=(struct _tuple43*)_T12A;_T12B=tup;_T12C=*_T12B;{
...
if(_T12E!=_T131)goto _TL39D;goto _TL399;_TL39D: _T132=tup;_T133=*_T132;_T134=_T133.f0;{
# 3343
...
rmemexp=Cyc_Toc_member_exp(rmemexp,Cyc_Toc_val_sp,0U);}goto _TL3A0;_TL39F: _TL3A0: _T13A=lmemexp;
# 3357
_T13A->topt=Cyc_Toc_typ_to_c_array(ftype);_T13B=rmemexp;
_T13B->topt=Cyc_Toc_typ_to_c_array(ftype);_T13C=
Cyc_Toc_is_void_star_or_boxed_tvar(ftype);if(!_T13C)goto _TL3A1;
lmemexp=Cyc_Toc_cast_it(t2c,lmemexp);
rmemexp=Cyc_Toc_cast_it(t2c,rmemexp);goto _TL3A2;
# 3363
_TL3A1: _T13D=Cyc_Tcutil_is_array_type(ftype);if(!_T13D)goto _TL3A3;
rmemexp=Cyc_Toc_deep_copy(lmemexp);goto _TL3A4;
# 3366
_TL3A3: _T13E=Cyc_Tcutil_is_array_type(ftype);if(_T13E)goto _TL3A5;else{goto _TL3A7;}_TL3A7: _T13F=& Cyc_Kinds_ak;_T140=(struct Cyc_Absyn_Kind*)_T13F;_T141=
Cyc_Tcutil_type_kind(ftype);_T142=Cyc_Kinds_kind_leq(_T140,_T141);
# 3366
if(!_T142)goto _TL3A5;{
# 3370
...
_T14E->topt=t2c;}goto _TL3A6;_TL3A5: _TL3A6: _TL3A4: _TL3A2: _T14F=s;_T150=
# 3376
Cyc_Toc_extract_pattern_vars(rgn,nv,newdecls,prevdecls,lmemexp,rmemexp,p2);s=Cyc_Toc_seq_stmt_opt(_T14F,_T150);}}}}}_TL399: _T151=dlps;
# 3338
dlps=_T151->tl;goto _TL39C;_TL39B: _T152=s;
# 3378
...
_T33->f1=ctype;_T33->f2=e1;_T33->f3=0;_T33->f4=1U;_T17=(struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_T33;}_T16->r=(void*)_T17;}}}_pop_handler();goto _TL3AD;_TL3AC: _T18=Cyc_Core_get_exn_thrown();{void*_T33=(void*)_T18;void*_T34;_T19=(struct Cyc_Core_Not_found_exn_struct*)_T33;_T1A=_T19->tag;_T1B=Cyc_Core_Not_found;if(_T1A!=_T1B)goto _TL3AF;goto _LL41;_TL3AF: _T34=_T33;{void*exn=_T34;_rethrow(exn);}_LL41:;}_TL3AD:;}}goto _LL0;}default: goto _LL3F;};case 6:{struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_T31=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_T2B;_T2F=_T31->f1;_T2E=_T31->f2;_T2D=_T31->f3;}{struct Cyc_Absyn_Exp*e1=_T2F;struct Cyc_Absyn_Exp*e2=_T2E;struct Cyc_Absyn_Exp*e3=_T2D;
# 3416
...
# 3444
_TL3B4: if(dles!=0)goto _TL3B2;else{goto _TL3B3;}
_TL3B2: _T20=env;_T21=dles;_T22=_T21->hd;_T23=(struct _tuple20*)_T22;_T24=*_T23;_T25=_T24.f1;Cyc_Toc_subst_pattern_vars(_T20,_T25);_T26=dles;
# 3444
dles=_T26->tl;goto _TL3B4;_TL3B3: goto _LL0;}case 37: goto _LL38;case 11: _LL38: goto _LL3A;case 33: _LL3A: goto _LL3C;case 16: _LL3C: goto _LL3E;case 30: _LL3E:{struct Cyc_Warn_String_Warn_Warg_struct _T31;_T31.tag=0;
# 3451
...
# 3475
_TL3BB: if(lscs!=0)goto _TL3B9;else{goto _TL3BA;}
_TL3B9: _T6=lscs;_T7=_T6->hd;{struct _tuple39*_TC1=(struct _tuple39*)_T7;struct Cyc_Absyn_Switch_clause*_TC2;struct _fat_ptr*_TC3;struct _fat_ptr*_TC4;void*_TC5;{struct _tuple39 _TC6=*_TC1;_T8=& _TC1->f0;_TC5=(int*)_T8;_TC4=_TC6.f1;_TC3=_TC6.f2;_TC2=_TC6.f3;}{int*already_emitted=(int*)_TC5;struct _fat_ptr*init_lab=_TC4;struct _fat_ptr*code_lab=_TC3;struct Cyc_Absyn_Switch_clause*sc=_TC2;_T9=sc;{
struct Cyc_Absyn_Stmt*body=_T9->body;_TA=body;_TB=rhs;_TC=_TB->rhs;
if(_TA!=_TC)goto _TL3BC;_TD=already_emitted;_TE=*_TD;
# 3480
if(!_TE)goto _TL3BE;_TF=
Cyc_Absyn_goto_stmt(init_lab,0U);return _TF;_TL3BE: _T10=already_emitted;
*_T10=1;{
...
if(!_T23)goto _TL3C4;_T24=oldv;_T25=oldvt;{struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_TCB=_cycalloc(sizeof(struct Cyc_Absyn_Local_b_Absyn_Binding_struct));_TCB->tag=4;
_TCB->f1=newv;_T26=(struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)_TCB;}_T27=(void*)_T26;_T28=Cyc_Absyn_varb_exp(_T27,0U);_T29=newv;_T2A=_T29->type;_T2B=Cyc_Absyn_set_type(_T28,_T2A);_T24->initializer=Cyc_Toc_cast_it(_T25,_T2B);goto _TL3C5;
_TL3C4: _T2C=oldv;{struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_TCB=_cycalloc(sizeof(struct Cyc_Absyn_Local_b_Absyn_Binding_struct));_TCB->tag=4;_TCB->f1=newv;_T2D=(struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)_TCB;}_T2E=(void*)_T2D;_T2F=Cyc_Absyn_varb_exp(_T2E,0U);_T30=newv;_T31=_T30->type;_T2C->initializer=Cyc_Absyn_set_type(_T2F,_T31);_TL3C5: _T32=oldv;_T33=_T32->initializer;_T34=newv;
...
# 3493
ds=_T39->tl;goto _TL3C3;_TL3C2:;}
# 3504
res=Cyc_Absyn_label_stmt(code_lab,res,0U);
if(init_opt==0)goto _TL3C6;
res=Cyc_Absyn_seq_stmt(init_opt,res,0U);goto _TL3C7;_TL3C6: _TL3C7:
...
return _T40;}}}_TL3BC:;}}}_T41=lscs;
# 3475
lscs=_T41->tl;goto _TL3BB;_TL3BA:{struct Cyc_Warn_String_Warn_Warg_struct _TC1;_TC1.tag=0;
# 3512
...
if(allows_switch <= 1)goto _TL3C8;{
# 3524
...
# 3527
_TL3CD: if(ss!=0)goto _TL3CB;else{goto _TL3CC;}
_TL3CB: _T4F=ss;_T50=_T4F->hd;_T51=(struct _tuple36*)_T50;{struct _tuple36 _TC4=*_T51;void*_TC5;void*_TC6;_TC6=_TC4.f0;_TC5=_TC4.f1;{void*pat_test=_TC6;void*dec_tree=_TC5;
# 3530
...
# 3527
ss=_T54->tl;goto _TL3CD;_TL3CC:{struct _fat_ptr*_TC4;void*_TC5;_T55=test_kind;_T56=(int*)_T55;_T57=*_T56;switch(_T57){case 1:
# 3538
 LOOP1: _T58=p;{
...
# 3559
_TC4->f1=p;_TC4->f2=new_lscs;_TC4->f3=0;_T66=(struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_TC4;}_T67=(void*)_T66;res=Cyc_Absyn_new_stmt(_T67,0U);}goto _TL3C9;
# 3563
_TL3C8:{struct Cyc_Absyn_Exp*_TC4;_T68=test_kind;_T69=(int*)_T68;_T6A=*_T69;if(_T6A!=2)goto _TL3D0;_T6B=test_kind;{struct Cyc_Toc_WhereTest_Toc_TestKind_struct*_TC5=(struct Cyc_Toc_WhereTest_Toc_TestKind_struct*)_T6B;_TC4=_TC5->f1;}{struct Cyc_Absyn_Exp*e=_TC4;struct Cyc_Tcpat_Rhs*_TC5;void*_TC6;if(ss==0)goto _TL3D2;_T6C=ss;_T6D=(struct Cyc_List_List*)_T6C;_T6E=_T6D->hd;_T6F=(struct _tuple36*)_T6E;_T70=_T6F->f1;_T71=(int*)_T70;_T72=*_T71;if(_T72!=1)goto _TL3D4;_T73=ss;_T74=(struct Cyc_List_List*)_T73;_T75=_T74->tl;if(_T75!=0)goto _TL3D6;_T76=ss;{struct Cyc_List_List _TC7=*_T76;_T77=_TC7.hd;_T78=(struct _tuple36*)_T77;{struct _tuple36 _TC8=*_T78;_TC6=_TC8.f0;_T79=_TC8.f1;{struct Cyc_Tcpat_Success_Tcpat_Decision_struct*_TC9=(struct Cyc_Tcpat_Success_Tcpat_Decision_struct*)_T79;_TC5=_TC9->f1;}}}{void*pat_test=_TC6;struct Cyc_Tcpat_Rhs*rhs=_TC5;
# 3571
_TL3DB: if(lscs!=0)goto _TL3D9;else{goto _TL3DA;}
_TL3D9: _T7A=lscs;_T7B=_T7A->hd;{struct _tuple39*_TC7=(struct _tuple39*)_T7B;struct Cyc_Absyn_Switch_clause*_TC8;struct _fat_ptr*_TC9;struct _fat_ptr*_TCA;void*_TCB;{struct _tuple39 _TCC=*_TC7;_T7C=& _TC7->f0;_TCB=(int*)_T7C;_TCA=_TCC.f1;_TC9=_TCC.f2;_TC8=_TCC.f3;}{int*already_emitted=(int*)_TCB;struct _fat_ptr*init_lab=_TCA;struct _fat_ptr*code_lab=_TC9;struct Cyc_Absyn_Switch_clause*sc=_TC8;_T7D=sc;{
struct Cyc_Absyn_Stmt*body=_T7D->body;_T7E=body;_T7F=rhs;_T80=_T7F->rhs;
if(_T7E!=_T80)goto _TL3DC;_T81=already_emitted;_T82=*_T81;
# 3576
if(!_T82)goto _TL3DE;_T83=
Cyc_Absyn_goto_stmt(init_lab,0U);return _T83;_TL3DE: _T84=already_emitted;
*_T84=1;{
...
struct Cyc_List_List*ds=newdecls;_TL3E3: if(ds!=0)goto _TL3E1;else{goto _TL3E2;}
_TL3E1: _T8E=ds;_T8F=_T8E->hd;_T90=(struct _tuple41*)_T8F;{struct _tuple41 _TCC=*_T90;int _TCD;void*_TCE;struct Cyc_Absyn_Vardecl*_TCF;struct Cyc_Absyn_Vardecl*_TD0;_TD0=_TCC.f0;_TCF=_TCC.f1;_TCE=_TCC.f2;_TCD=_TCC.f3;{struct Cyc_Absyn_Vardecl*oldv=_TD0;struct Cyc_Absyn_Vardecl*newv=_TCF;void*oldvt=_TCE;int cast=_TCD;_T91=decls;_T93=rgn;{struct Cyc_List_List*_TD1=_region_malloc(_T93,0U,sizeof(struct Cyc_List_List));_T95=rgn;{struct _tuple42*_TD2=_region_malloc(_T95,0U,sizeof(struct _tuple42));
...
if(init_opt==0)goto _TL3E6;
r=Cyc_Absyn_seq_stmt(init_opt,r,0U);goto _TL3E7;_TL3E6: _TL3E7:
...
return _TB1;}}}_TL3DC:;}}}_TB2=lscs;
# 3571
lscs=_TB2->tl;goto _TL3DB;_TL3DA:{struct Cyc_Warn_String_Warn_Warg_struct _TC7;_TC7.tag=0;
# 3609
_TC7.f1=_tag_fat("couldn't find rhs!",sizeof(char),19U);_TB3=_TC7;}{struct Cyc_Warn_String_Warn_Warg_struct _TC7=_TB3;void*_TC8[1];_TC8[0]=& _TC7;{int(*_TC9)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_TB4=_TC9;}_TB5=_tag_fat(_TC8,sizeof(void*),1);_TB4(_TB5);}}goto _TL3D7;_TL3D6: goto _LL2D;_TL3D7: goto _TL3D5;_TL3D4: goto _LL2D;_TL3D5: goto _TL3D3;_TL3D2: _LL2D:{struct Cyc_Warn_String_Warn_Warg_struct _TC7;_TC7.tag=0;
_TC7.f1=_tag_fat("bad where clause in match compiler",sizeof(char),35U);_TB6=_TC7;}{struct Cyc_Warn_String_Warn_Warg_struct _TC7=_TB6;void*_TC8[1];_TC8[0]=& _TC7;{int(*_TC9)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_TB7=_TC9;}_TB8=_tag_fat(_TC8,sizeof(void*),1);_TB7(_TB8);}_TL3D3:;}goto _TL3D1;_TL3D0:
# 3614
 _TL3EB: if(ss!=0)goto _TL3E9;else{goto _TL3EA;}
_TL3E9: _TB9=ss;_TBA=_TB9->hd;_TBB=(struct _tuple36*)_TBA;{struct _tuple36 _TC5=*_TBB;void*_TC6;void*_TC7;_TC7=_TC5.f0;_TC6=_TC5.f1;{void*pat_test=_TC7;void*dec_tree=_TC6;
...
# 3614
ss=_TBC->tl;goto _TL3EB;_TL3EA: _TL3D1:;}_TL3C9: _TBD=res;
# 3622
return _TBD;}}}};}
# 3632
...
# 3634
_TL3EF: if(bodies!=0)goto _TL3ED;else{goto _TL3EE;}
_TL3ED: _T0=bodies;_T1=_T0->hd;{struct _tuple44*_T5=(struct _tuple44*)_T1;struct Cyc_Absyn_Stmt*_T6;void*_T7;{struct _tuple44 _T8=*_T5;_T2=& _T5->f0;_T7=(struct Cyc_Toc_Env**)_T2;_T6=_T8.f2;}{struct Cyc_Toc_Env**nv=(struct Cyc_Toc_Env**)_T7;struct Cyc_Absyn_Stmt*s2=_T6;
if(s2!=s)goto _TL3F0;_T3=nv;return _T3;_TL3F0:;}}_T4=bodies;
# 3634
bodies=_T4->tl;goto _TL3EF;_TL3EE:
# 3640
 return 0;}
# 3644
...
void*_T54=_T2->r;void*_T55;_T3=(int*)_T54;_T4=*_T3;if(_T4!=1)goto _TL3F2;{struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_T56=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_T54;_T5=_T56->f1;_T55=(void*)_T5;}{void*b=_T55;goto _LL0;}_TL3F2:{
# 3655
...
# 3678
struct Cyc_List_List*lscs2=lscs;_TL3F7: if(lscs2!=0)goto _TL3F5;else{goto _TL3F6;}
_TL3F5: _T1A=lscs2;_T1B=_T1A->hd;{struct _tuple39*_T56=(struct _tuple39*)_T1B;struct Cyc_Absyn_Switch_clause*_T57;struct _fat_ptr*_T58;{struct _tuple39 _T59=*_T56;_T58=_T59.f2;_T57=_T59.f3;}{struct _fat_ptr*body_lab=_T58;struct Cyc_Absyn_Switch_clause*body_sc=_T57;_T1C=body_sc;{
struct Cyc_Absyn_Stmt*s=_T1C->body;
# 3682
struct Cyc_Toc_Env**envp=Cyc_Toc_find_case_env(mybodies,s);
# 3685
if(envp!=0)goto _TL3F8;goto _TL3F4;_TL3F8: _T1D=envp;{
struct Cyc_Toc_Env*env=*_T1D;_T1E=lscs2;_T1F=_T1E->tl;
# 3688
if(_T1F==0)goto _TL3FA;_T20=lscs2;_T21=_T20->tl;_T22=_T21->hd;{
...
# 3697
if(next_case_env!=0)goto _TL3FC;_T26=
Cyc_Toc_last_switchclause_env(rgn,env,end_l);_T27=s;Cyc_Toc_stmt_to_c(_T26,_T27);goto _TL3FD;
# 3701
_TL3FC:{struct Cyc_List_List*vs=0;_T28=next_sc;_T29=_T28->pat_vars;
if(_T29==0)goto _TL3FE;_T2A=next_sc;_T2B=_T2A->pat_vars;_T2C=_T2B->v;_T2D=(struct Cyc_List_List*)_T2C;_T2E=
Cyc_List_split(_T2D);_T2F=_T2E.f0;vs=Cyc_Tcutil_filter_nulls(_T2F);_T31=Cyc_List_map_c;{
struct Cyc_List_List*(*_T5C)(struct Cyc_Absyn_Vardecl*(*)(struct Cyc_List_List*,struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct Cyc_Absyn_Vardecl*(*)(struct Cyc_List_List*,struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*,struct Cyc_List_List*))_T31;_T30=_T5C;}_T33=Cyc_List_assoc;{struct Cyc_Absyn_Vardecl*(*_T5C)(struct Cyc_List_List*,struct Cyc_Absyn_Vardecl*)=(struct Cyc_Absyn_Vardecl*(*)(struct Cyc_List_List*,struct Cyc_Absyn_Vardecl*))_T33;_T32=_T5C;}_T34=mydecls;_T35=Cyc_List_imp_rev(vs);vs=_T30(_T32,_T34,_T35);goto _TL3FF;_TL3FE: _TL3FF: _T36=
# 3706
Cyc_Toc_non_last_switchclause_env(rgn,env,end_l,fallthru_lab,vs);_T37=s;Cyc_Toc_stmt_to_c(_T36,_T37);}_TL3FD:;}}}goto _TL3FB;
# 3710
_TL3FA: _T38=Cyc_Toc_last_switchclause_env(rgn,env,end_l);_T39=s;Cyc_Toc_stmt_to_c(_T38,_T39);_TL3FB:;}}}}_TL3F4: _T3A=lscs2;
# 3678
lscs2=_T3A->tl;goto _TL3F7;_TL3F6:;}_T3B=test_tree;_T3C=end_l;_T3D=
# 3714
...
_TL403: if(mydecls!=0)goto _TL401;else{goto _TL402;}
_TL401: _T3F=mydecls;_T40=_T3F->hd;_T41=(struct _tuple42*)_T40;{struct _tuple42 _T56=*_T41;struct Cyc_Absyn_Vardecl*_T57;_T57=_T56.f1;{struct Cyc_Absyn_Vardecl*vd=_T57;{
struct Cyc_List_List*itr=added;_TL407: if(itr!=0)goto _TL405;else{goto _TL406;}
_TL405: _T42=itr;_T43=_T42->hd;_T44=(struct Cyc_Absyn_Vardecl*)_T43;_T45=vd;if(_T44!=_T45)goto _TL408;goto bottom;_TL408: _T46=itr;
# 3719
itr=_T46->tl;goto _TL407;_TL406:;}_T48=rgn;{struct Cyc_List_List*_T58=_region_malloc(_T48,0U,sizeof(struct Cyc_List_List));
# 3721
...
bottom: goto _TL400;}}_TL400: _T4D=
# 3717
_check_null(mydecls);mydecls=_T4D->tl;goto _TL403;_TL402:
# 3727
 if(v==0)goto _TL40A;{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_T56=_cycalloc(sizeof(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct));_T56->tag=0;
_T56->f1=v;_T4E=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_T56;}_T4F=(void*)_T4E;_T50=Cyc_Absyn_new_decl(_T4F,0U);_T51=res;res=Cyc_Absyn_decl_stmt(_T50,_T51,0U);goto _TL40B;_TL40A: _TL40B: _T52=whole_s;_T53=res;
# 3730
...
if(n <= 0)goto _TL40C;_T0=s;_T1=
Cyc_Toc_make_npop_handler(n);_T2=s;_T3=_T2->r;_T4=Cyc_Absyn_new_stmt(_T3,0U);_T0->r=Cyc_Toc_seq_stmt_r(_T1,_T4);goto _TL40D;_TL40C: _TL40D:;}
# 3747
...
# 3749
_TL40E: if(1)goto _TL40F;else{goto _TL410;}
_TL40F: _T0=s;{void*_T10B=_T0->r;struct Cyc_Absyn_Switch_clause**_T10C;struct Cyc_List_List*_T10D;struct Cyc_Absyn_Exp*_T10E;struct Cyc_Absyn_Stmt*_T10F;void*_T110;void*_T111;_T1=(int*)_T10B;_T2=*_T1;switch(_T2){case 0:
...
Cyc_Toc_exp_to_c(nv,e);return;}case 3: _T3=(struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_T10B;_T4=_T3->f1;if(_T4!=0)goto _TL412;_T5=
Cyc_Toc_get_npop(s);_T6=s;Cyc_Toc_do_npop_before(_T5,_T6);return;_TL412:{struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*_T112=(struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_T10B;_T111=_T112->f1;}{struct Cyc_Absyn_Exp*e=_T111;_T7=e;_T8=_T7->topt;_T9=
# 3756
_check_null(_T8);{void*t=Cyc_Toc_typ_to_c(_T9);
Cyc_Toc_exp_to_c(nv,e);{
int npop=Cyc_Toc_get_npop(s);
if(npop <= 0)goto _TL414;{
...
Cyc_Absyn_declare_stmt(x,t,e,retn_stmt,0U);_TD->r=_TE->r;}}goto _TL415;_TL414: _TL415:
# 3765
...
s=s2;goto _TL40E;}case 4:{struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*_T112=(struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_T10B;_T111=_T112->f1;_T110=_T112->f2;_T10F=_T112->f3;}{struct Cyc_Absyn_Exp*e=_T111;struct Cyc_Absyn_Stmt*s1=_T110;struct Cyc_Absyn_Stmt*s2=_T10F;
# 3771
Cyc_Toc_exp_to_c(nv,e);
Cyc_Toc_stmt_to_c(nv,s1);
...
# 3786
if(b==0)goto _TL416;_T16=s;_T17=b;_T18=*_T17;
_T16->r=Cyc_Toc_goto_stmt_r(_T18);goto _TL417;_TL416: _TL417: _T19=
# 3789
...
# 3793
if(c==0)goto _TL418;_T1C=s;_T1D=c;_T1E=*_T1D;
_T1C->r=Cyc_Toc_goto_stmt_r(_T1E);goto _TL419;_TL418: _TL419: goto _LL18;}}case 8: _LL18: _T1F=
# 3797
...
s=s1;goto _TL40E;}case 10:{struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*_T112=(struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_T10B;_T111=_T112->f1;_T10D=_T112->f2;_T21=_T112->f3;_T110=(void*)_T21;}{struct Cyc_Absyn_Exp*e=_T111;struct Cyc_List_List*scs=_T10D;void*dec_tree_opt=_T110;
# 3801
...
_TL41F: if(vs2!=0)goto _TL41D;else{goto _TL41E;}
_TL41D: _T29=nv;_T2A=_check_null(es2);_T2B=_T2A->hd;_T2C=(struct Cyc_Absyn_Exp*)_T2B;Cyc_Toc_exp_to_c(_T29,_T2C);{struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*_T116=_cycalloc(sizeof(struct Cyc_Absyn_Pat_b_Absyn_Binding_struct));_T116->tag=5;_T2E=vs2;_T2F=_T2E->hd;
...
# 3813
vs2=_T37->tl;_T38=es2;es2=_T38->tl;goto _TL41F;_TL41E: _T39=s;_T3A=s2;
# 3818
_T39->r=_T3A->r;
...
# 3831
void*_T11A=_T3F->r;struct Cyc_Absyn_Vardecl*_T11B;_T40=(int*)_T11A;_T41=*_T40;if(_T41!=1)goto _TL421;_T42=(struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_T11A;_T43=_T42->f2;_T44=(struct Cyc_Absyn_Pat*)_T43;_T45=_T44->r;_T46=(int*)_T45;_T47=*_T46;if(_T47!=0)goto _TL423;{struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_T11C=(struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_T11A;_T11B=_T11C->f1;}{struct Cyc_Absyn_Vardecl*vd=_T11B;_T48=vd;_T49=_T48->name;_T4A=e;_T4B=
# 3833
Cyc_Absyn_var_may_appear_exp(_T49,_T4A);if(!_T4B)goto _TL425;_T4C=
...
# 3837
Cyc_Absyn_decl_stmt(_T5B,_T64,_T66);_T56->r=_T67->r;}goto _TL426;
# 3841
_TL425: _T68=vd;_T68->initializer=e;_T69=s;{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_T11C=_cycalloc(sizeof(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct));_T11C->tag=0;
_T11C->f1=vd;_T6A=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_T11C;}_T6B=(void*)_T6A;_T6C=s;_T6D=_T6C->loc;_T6E=Cyc_Absyn_new_decl(_T6B,_T6D);_T6F=body;_T70=s;_T71=_T70->loc;_T72=Cyc_Absyn_decl_stmt(_T6E,_T6F,_T71);_T69->r=_T72->r;_TL426:
# 3844
 Cyc_Toc_stmt_to_c(nv,s);goto _LL3C;}_TL423: goto _LL3F;_TL421: _LL3F: _T73=s;_T74=nv;_T75=p;_T76=dec_tree;_T77=e;_T78=_T77->topt;_T79=
# 3850
...
if(rvds!=0)goto _TL427;{struct Cyc_Warn_String_Warn_Warg_struct _T11A;_T11A.tag=0;
_T11A.f1=_tag_fat("empty Letv_d",sizeof(char),13U);_T7D=_T11A;}{struct Cyc_Warn_String_Warn_Warg_struct _T11A=_T7D;void*_T11B[1];_T11B[0]=& _T11A;{int(*_T11C)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_T7E=_T11C;}_T7F=_tag_fat(_T11B,sizeof(void*),1);_T7E(_T7F);}goto _TL428;_TL427: _TL428: _T80=d;{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_T11A=_cycalloc(sizeof(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct));_T11A->tag=0;_T82=rvds;_T83=_T82->hd;
...
if(!_T93)goto _TL42D;_T94=s;_T95=x_var;_T96=rh_struct_ptr_typ;_T97=
# 3884
Cyc_Absyn_signed_int_exp(0,0U);_T98=Cyc_Absyn_sint_type;_T99=Cyc_Absyn_set_type(_T97,_T98);_T9A=body;_T9B=
# 3883
Cyc_Absyn_declare_stmt(_T95,_T96,_T99,_T9A,0U);_T94->r=_T9B->r;goto _TL42E;
# 3885
_TL42D: _T9C=open_exp_opt;_T9D=(unsigned)_T9C;if(!_T9D)goto _TL42F;
# 3887
...
Cyc_Absyn_declare_stmt(x_var,rh_struct_ptr_typ,arg,body,0U);_TA0->r=_TA1->r;}}goto _TL430;
# 3899
_TL42F: _TA2=Cyc_Absyn_uint_exp(0U,0U);_TA3=Cyc_Absyn_uint_type;{struct Cyc_Absyn_Exp*_zero_exp=Cyc_Absyn_set_type(_TA2,_TA3);_TA4=
...
if(!_TA7)goto _TL431;_TA6=_one_exp;goto _TL432;_TL431: _TA6=_zero_exp;_TL432: {struct Cyc_Absyn_Exp*rgn_flag_exp=_TA6;_TA8=s;_TA9=rh_var;_TAA=rh_struct_typ;{struct Cyc_Absyn_Exp*_T11D[2];
# 3903
...
# 3902
Cyc_Absyn_declare_stmt(_TA9,_TAA,_TB3,_TC8,0U);_TA8->r=_TC9->r;}}}_TL430: _TL42E:
# 3910
...
# 3958
_TEC->r=_T10A->r;}}}}}}_npop_handler(0);return;_pop_region();}}}}}}};}goto _TL40E;_TL410:;}
# 3978
...
struct Cyc_List_List*args=_T11.args;_TL436: if(args!=0)goto _TL434;else{goto _TL435;}
_TL434: _T12=args;_T13=_T12->hd;_T14=(struct _tuple9*)_T13;_T15=args;_T16=_T15->hd;_T17=(struct _tuple9*)_T16;_T18=*_T17;_T19=_T18.f2;(*_T14).f2=Cyc_Toc_typ_to_c(_T19);_T1A=args;
# 3992
args=_T1A->tl;goto _TL436;_TL435:;}_T1B=cinclude;
# 3996
if(!_T1B)goto _TL437;_T1C=f;_T1D=_T1C->body;
Cyc_Toc_stmttypes_to_c(_T1D);_npop_handler(0);return;_TL437:{struct Cyc_Hashtable_Table**_T4A=_cycalloc(sizeof(struct Cyc_Hashtable_Table*));_T20=Cyc_Hashtable_lookup;{
# 4000
...
if(!_T27)goto _TL439;_T28=f;_T29=_T28->i;_T2A=_T29.cyc_varargs;_T2B=_T2A->name;if(_T2B==0)goto _TL439;_T2C=f;_T2D=_T2C->i;_T2E=_T2D.cyc_varargs;{
...
_T38->i.cyc_varargs=0;}}}goto _TL43A;_TL439: _TL43A: _T39=f;_T3A=_T39->param_vardecls;_T3B=
# 4009
_check_null(_T3A);_T3C=_T3B->v;{struct Cyc_List_List*arg_vds=(struct Cyc_List_List*)_T3C;_TL43E: if(arg_vds!=0)goto _TL43C;else{goto _TL43D;}
_TL43C: _T3D=arg_vds;_T3E=_T3D->hd;_T3F=(struct Cyc_Absyn_Vardecl*)_T3E;_T40=arg_vds;_T41=_T40->hd;_T42=(struct Cyc_Absyn_Vardecl*)_T41;_T43=_T42->type;_T3F->type=Cyc_Toc_typ_to_c(_T43);_T44=arg_vds;
# 4009
arg_vds=_T44->tl;goto _TL43E;_TL43D:;}_T45=
# 4011
...
if(dopt!=0)goto _TL440;
seen_defn_before=0;{
struct _tuple18*v;_T9=d;v=_region_malloc(_T9,0U,sizeof(struct _tuple18));_TA=v;
_TA->f0=ad;_TB=ad;_TC=_TB->kind;_TD=(int)_TC;if(_TD!=0)goto _TL442;_TE=v;_TE->f1=Cyc_Absyn_strctq(n);goto _TL443;_TL442: _TF=v;_TF->f1=Cyc_Absyn_unionq_type(n);_TL443: _T10=aggrs_so_far;_T12=Cyc_Dict_insert;{
struct Cyc_Dict_Dict(*_T8B)(struct Cyc_Dict_Dict,struct _tuple1*,struct _tuple18*)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple1*,struct _tuple18*))_T12;_T11=_T8B;}_T13=aggrs_so_far;_T14=*_T13;_T15=n;_T16=v;*_T10=_T11(_T14,_T15,_T16);}goto _TL441;
# 4043
_TL440: _T17=dopt;{struct _tuple18*_T8B=*_T17;void*_T8C;struct Cyc_Absyn_Aggrdecl*_T8D;{struct _tuple18 _T8E=*_T8B;_T8D=_T8E.f0;_T8C=_T8E.f1;}{struct Cyc_Absyn_Aggrdecl*ad2=_T8D;void*t=_T8C;_T18=ad2;_T19=_T18->impl;
if(_T19!=0)goto _TL444;_T1A=aggrs_so_far;_T1C=Cyc_Dict_insert;{
...
seen_defn_before=0;goto _TL445;
# 4048
_TL444: seen_defn_before=1;_TL445:;}}_TL441: {
# 4050
...
if(_T2D==0)goto _TL446;_T2E=seen_defn_before;if(_T2E)goto _TL446;else{goto _TL448;}
_TL448: _T2F=new_ad;{struct Cyc_Absyn_AggrdeclImpl*_T8B=_cycalloc(sizeof(struct Cyc_Absyn_AggrdeclImpl));_T8B->exist_vars=0;
# 4060
_T8B->qual_bnd=0;
_T8B->fields=0;
_T8B->tagged=0;
...
_check_null(_T32);{struct Cyc_List_List*fields=_T33->fields;_TL44C: if(fields!=0)goto _TL44A;else{goto _TL44B;}
# 4068
_TL44A: _T34=fields;_T35=_T34->hd;{struct Cyc_Absyn_Aggrfield*old_field=(struct Cyc_Absyn_Aggrfield*)_T35;_T36=old_field;{
...
Cyc_Tcutil_type_kind(old_type);_T3B=Cyc_Kinds_kind_leq(_T39,_T3A);if(!_T3B)goto _TL44D;_T3C=ad;_T3D=_T3C->kind;_T3E=(int)_T3D;if(_T3E==0)goto _TL451;else{goto _TL450;}_TL451: _T3F=fields;_T40=_T3F->tl;if(_T40==0)goto _TL44F;else{goto _TL450;}_TL450: _T41=ad;_T42=_T41->kind;_T43=(int)_T42;if(_T43==1)goto _TL44F;else{goto _TL44D;}
# 4082 "toc.cyc"
_TL44F:{void*_T8B=Cyc_Absyn_compress(old_type);unsigned _T8C;void*_T8D;struct Cyc_Absyn_Tqual _T8E;void*_T8F;_T44=(int*)_T8B;_T45=*_T44;if(_T45!=5)goto _TL452;{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_T90=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T8B;_T46=_T90->f1;_T8F=_T46.elt_type;_T47=_T90->f1;_T8E=_T47.tq;_T48=_T90->f1;_T8D=_T48.zero_term;_T49=_T90->f1;_T8C=_T49.zt_loc;}{void*et=_T8F;struct Cyc_Absyn_Tqual tq=_T8E;void*zt=_T8D;unsigned ztl=_T8C;{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_T90=_cycalloc(sizeof(struct Cyc_Absyn_ArrayType_Absyn_Type_struct));_T90->tag=5;
# 4085
_T90->f1.elt_type=et;_T90->f1.tq=tq;_T4B=Cyc_Absyn_uint_exp(0U,0U);_T4C=Cyc_Absyn_uint_type;_T90->f1.num_elts=Cyc_Absyn_set_type(_T4B,_T4C);_T90->f1.zero_term=zt;_T90->f1.zt_loc=ztl;_T4A=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T90;}old_type=(void*)_T4A;goto _LL9;}_TL452:{struct Cyc_List_List*_T90=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_T91=_cycalloc(sizeof(struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct));_T91->tag=6;
# 4088
...
# 4089
old_type=(void*)_T4F;_LL9:;}goto _TL44E;_TL44D: _TL44E: {
# 4095
...
# 4105
_check_null(_T5B);_T5D=_T5C->tagged;if(!_T5D)goto _TL454;_T5E=new_field;{
...
_T7D->type=Cyc_Absyn_strct(str);}}}}}}goto _TL455;_TL454: _TL455:{struct Cyc_List_List*_T8B=_cycalloc(sizeof(struct Cyc_List_List));
# 4116
_T8B->hd=new_field;_T8B->tl=new_fields;_T7E=(struct Cyc_List_List*)_T8B;}new_fields=_T7E;}}}}_T7F=fields;
# 4065 "toc.cyc"
fields=_T7F->tl;goto _TL44C;_TL44B:;}_T80=new_ad;_T81=_T80->impl;
# 4118 "toc.cyc"
_T81->fields=Cyc_List_imp_rev(new_fields);}goto _TL447;_TL446: _TL447: _T82=seen_defn_before;
# 4121
if(_T82)goto _TL456;else{goto _TL458;}
_TL458:{struct Cyc_List_List*_T8B=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Absyn_Decl*_T8C=_cycalloc(sizeof(struct Cyc_Absyn_Decl));{struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_T8D=_cycalloc(sizeof(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct));_T8D->tag=5;_T8D->f1=new_ad;_T85=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_T8D;}_T8C->r=(void*)_T85;_T8C->loc=0U;_T84=(struct Cyc_Absyn_Decl*)_T8C;}_T8B->hd=_T84;_T8B->tl=Cyc_Toc_result_decls;_T83=(struct Cyc_List_List*)_T8B;}Cyc_Toc_result_decls=_T83;goto _TL457;_TL456: _TL457:
 return 0;}}}}}}}}
# 4125
...
if(_T4==0)goto _TL45B;else{goto _TL45C;}_TL45C: _T6=Cyc_Set_member;{int(*_T3A)(struct Cyc_Set_Set*,struct _tuple1*)=(int(*)(struct Cyc_Set_Set*,struct _tuple1*))_T6;_T5=_T3A;}_T7=datatypes_so_far;_T8=*_T7;_T9=n;_TA=_T5(_T8,_T9);if(_TA)goto _TL45B;else{goto _TL459;}
_TL45B: return 0;_TL459: _TB=datatypes_so_far;_TD=Cyc_Set_rinsert;{
...
_check_null(_T13);_T15=_T14->v;{struct Cyc_List_List*fields=(struct Cyc_List_List*)_T15;_TL460: if(fields!=0)goto _TL45E;else{goto _TL45F;}
_TL45E: _T16=fields;_T17=_T16->hd;{struct Cyc_Absyn_Datatypefield*f=(struct Cyc_Absyn_Datatypefield*)_T17;
# 4164
struct Cyc_List_List*fs=0;
int i=1;_T18=f;{
struct Cyc_List_List*ts=_T18->typs;_TL464: if(ts!=0)goto _TL462;else{goto _TL463;}
_TL462:{struct Cyc_Absyn_Aggrfield*f;f=_cycalloc(sizeof(struct Cyc_Absyn_Aggrfield));_T19=f;_T19->name=Cyc_Absyn_fieldname(i);_T1A=f;_T1B=ts;_T1C=_T1B->hd;_T1D=(struct _tuple24*)_T1C;_T1E=*_T1D;_T1A->tq=_T1E.f0;_T1F=f;_T20=ts;_T21=_T20->hd;_T22=(struct _tuple24*)_T21;_T23=*_T22;_T24=_T23.f1;
...
# 4166
ts=_T29->tl;i=i + 1;goto _TL464;_TL463:;}{struct Cyc_List_List*_T3A=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Absyn_Aggrfield*_T3B=_cycalloc(sizeof(struct Cyc_Absyn_Aggrfield));
# 4171
...
# 4161
fields=_T36->tl;goto _TL460;_TL45F:;}
# 4177
return 0;}}}}
# 4180
...
if(_T2!=0)goto _TL465;
return 0;_TL465: _T3=s;{
...
struct Cyc_List_List*fs=(struct Cyc_List_List*)_T7;_TL46A: if(fs!=0)goto _TL468;else{goto _TL469;}
_TL468: _T8=fs;_T9=_T8->hd;{struct Cyc_Absyn_Datatypefield*f=(struct Cyc_Absyn_Datatypefield*)_T9;_TA=f;_TB=_TA->name;_TC=*_TB;{
...
# 4213
int*(*_T6C)(struct Cyc_Dict_Dict,struct _tuple1*)=(int*(*)(struct Cyc_Dict_Dict,struct _tuple1*))_T13;_T12=_T6C;}_T14=xdatatypes_so_far;_T15=*_T14;_T16=f;_T17=_T16->name;{int*_T6C=_T12(_T15,_T17);if(_T6C!=0)goto _TL46B;{
# 4215
struct Cyc_Absyn_Exp*initopt=0;_T18=f;_T19=_T18->sc;_T1A=(int)_T19;
if(_T1A==3)goto _TL46D;_T1B=fn;_T1C=*_T1B;
initopt=Cyc_Absyn_string_exp(_T1C,0U);goto _TL46E;_TL46D: _TL46E: _T1D=f;_T1E=_T1D->name;_T1F=tag_typ;_T20=initopt;{
...
int i=1;_T31=f;{
struct Cyc_List_List*tqts=_T31->typs;_TL472: if(tqts!=0)goto _TL470;else{goto _TL471;}
_TL470:{struct _fat_ptr*field_n=Cyc_Absyn_fieldname(i);
...
# 4225
tqts=_T42->tl;i=i + 1;goto _TL472;_TL471:;}{struct Cyc_List_List*_T6D=_cycalloc(sizeof(struct Cyc_List_List));{struct Cyc_Absyn_Aggrfield*_T6E=_cycalloc(sizeof(struct Cyc_Absyn_Aggrfield));
# 4231
...
_T6E->f1=strct_decl;_T4D=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_T6E;}_T4E=(void*)_T4D;_T6D->hd=Cyc_Absyn_new_decl(_T4E,0U);_T6D->tl=Cyc_Toc_result_decls;_T4C=(struct Cyc_List_List*)_T6D;}Cyc_Toc_result_decls=_T4C;goto _LL6;}}}}_TL46B: _T4F=(int*)_T6C;_T50=*_T4F;if(_T50!=0)goto _TL473;_T51=f;_T52=_T51->sc;_T53=(int)_T52;
# 4239
if(_T53==3)goto _TL475;_T54=fn;_T55=*_T54;{
...
struct Cyc_Dict_Dict(*_T6D)(struct Cyc_Dict_Dict,struct _tuple1*,int)=(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple1*,int))_T61;_T60=_T6D;}_T62=xdatatypes_so_far;_T63=*_T62;_T64=f;_T65=_T64->name;*_T5F=_T60(_T63,_T65,1);}}goto _TL476;_TL475: _TL476: goto _LL6;_TL473: goto _LL6;_LL6:;}}}}_T66=fs;
# 4207
fs=_T66->tl;goto _TL46A;_TL469:;}
# 4250
return 0;}}}}}}
# 4253
...
if(_T2==0)goto _TL477;_T3=ed;_T4=_T3->fields;_T5=_T4->v;_T6=(struct Cyc_List_List*)_T5;
Cyc_Toc_enumfields_to_c(_T6);goto _TL478;_TL477: _TL478:;}
# 4263
...
# 4267
if(_T4!=5)goto _TL479;_T5=Cyc_Tcutil_is_fat_pointer_type(old_typ);if(!_T5)goto _TL479;_T6=vd;
_T6->sc=2U;goto _TL47A;_TL479: _TL47A:
 Cyc_Toc_stmt_to_c(nv,s);_T7=vd;_T8=_T7->initializer;
if(_T8==0)goto _TL47B;_T9=vd;{
struct Cyc_Absyn_Exp*init=_T9->initializer;_TA=vd;_TB=_TA->sc;_TC=(int)_TB;
if(_TC!=0)goto _TL47D;{struct _RegionHandle _T2B=_new_region(0U,"temp");struct _RegionHandle*temp=& _T2B;_push_region(temp);{
# 4277
struct Cyc_Toc_Env*nv2=Cyc_Toc_set_toplevel(temp,nv);
Cyc_Toc_exp_to_c(nv2,init);}_pop_region();}goto _TL47E;
# 4281
_TL47D: Cyc_Toc_exp_to_c(nv,init);_TL47E:;}goto _TL47C;
# 4284
_TL47B:{void*_T2B=Cyc_Absyn_compress(old_typ);void*_T2C;struct Cyc_Absyn_Exp*_T2D;void*_T2E;_TD=(int*)_T2B;_TE=*_TD;if(_TE!=5)goto _TL47F;{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_T2F=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T2B;_TF=_T2F->f1;_T2E=_TF.elt_type;_T10=_T2F->f1;_T2D=_T10.num_elts;_T11=_T2F->f1;_T2C=_T11.zero_term;}{void*et=_T2E;struct Cyc_Absyn_Exp*num_elts_opt=_T2D;void*zt=_T2C;_T12=
# 4286
Cyc_Tcutil_force_type2bool(0,zt);if(!_T12)goto _TL481;
if(num_elts_opt!=0)goto _TL483;{struct Cyc_Warn_String_Warn_Warg_struct _T2F;_T2F.tag=0;
_T2F.f1=_tag_fat("can't initialize zero-terminated array -- size unknown",sizeof(char),55U);_T13=_T2F;}{struct Cyc_Warn_String_Warn_Warg_struct _T2F=_T13;void*_T30[1];_T30[0]=& _T2F;{int(*_T31)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_T14=_T31;}_T15=_tag_fat(_T30,sizeof(void*),1);_T14(_T15);}goto _TL484;_TL483: _TL484: _T16=vd;_T17=_T16->name;_T18=
...
# 4296
_T25->r=Cyc_Toc_seq_stmt_r(_T27,_T2A);}}goto _TL482;_TL481: _TL482: goto _LL0;}_TL47F: goto _LL0;_LL0:;}_TL47C:;}}
# 4306
...
_TL489: if(sws!=0)goto _TL487;else{goto _TL488;}
_TL487: _TF=sws;_T10=_TF->hd;{struct _tuple36*_T1B=(struct _tuple36*)_T10;void*_T1C;{struct _tuple36 _T1D=*_T1B;_T11=& _T1B->f1;_T1C=(void**)_T11;}{void**d2=(void**)_T1C;_T12=d2;_T13=d2;_T14=*_T13;_T15=success;
*_T12=Cyc_Toc_rewrite_decision(_T14,_T15);}}_T16=sws;
# 4312
sws=_T16->tl;goto _TL489;_TL488: _T17=d;
# 4316
return _T17;}};}
# 4327 "toc.cyc"
...
struct Cyc_Absyn_Vardecl*v=0;
struct Cyc_Absyn_Exp*vexp=e;_T2=e;{
void*_T34=_T2->r;void*_T35;_T3=(int*)_T34;_T4=*_T3;if(_T4!=1)goto _TL48A;{struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_T36=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_T34;_T5=_T36->f1;_T35=(void*)_T5;}{void*b=_T35;goto _LL0;}_TL48A:{
# 4339
struct _tuple1*x=Cyc_Toc_temp_var();_T6=x;_T7=
...
if(dopt==0)goto _TL48C;
# 4353
dopt=Cyc_Toc_rewrite_decision(dopt,succ_stmt);goto _TL48D;_TL48C: _TL48D: {
# 4355
...
# 4366
struct Cyc_Absyn_Stmt*test_tree=Cyc_Toc_compile_decision_tree(_T1A,_T1B,_T1C,_T1D,_T1E,_T1F,_T20);_TL491:
# 4370
 if(1)goto _TL48F;else{goto _TL490;}
_TL48F: if(mybodies!=0)goto _TL492;{struct Cyc_Warn_String_Warn_Warg_struct _T34;_T34.tag=0;
_T34.f1=_tag_fat("letdecl_to_c: couldn't find env!",sizeof(char),33U);_T21=_T34;}{struct Cyc_Warn_String_Warn_Warg_struct _T34=_T21;void*_T35[1];_T35[0]=& _T34;{int(*_T36)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_T22=_T36;}_T23=_tag_fat(_T35,sizeof(void*),1);_T22(_T23);}goto _TL493;_TL492: _TL493: _T24=mybodies;_T25=_T24->hd;{
...
if(st!=succ_stmt)goto _TL494;Cyc_Toc_stmt_to_c(env,s);goto _TL490;_TL494:;}}_T26=mybodies;
# 4370
mybodies=_T26->tl;goto _TL491;_TL490: {
# 4377
struct Cyc_Absyn_Stmt*res=test_tree;
# 4379
_TL499: if(mydecls!=0)goto _TL497;else{goto _TL498;}
_TL497: _T27=mydecls;_T28=_T27->hd;{struct _tuple42*_T34=(struct _tuple42*)_T28;struct Cyc_Absyn_Vardecl*_T35;{struct _tuple42 _T36=*_T34;_T35=_T36.f1;}{struct Cyc_Absyn_Vardecl*vd=_T35;{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_T36=_cycalloc(sizeof(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct));_T36->tag=0;
...
# 4379
_check_null(mydecls);mydecls=_T2D->tl;goto _TL499;_TL498:
# 4383
 if(v==0)goto _TL49A;{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_T34=_cycalloc(sizeof(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct));_T34->tag=0;
_T34->f1=v;_T2E=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_T34;}_T2F=(void*)_T2E;_T30=Cyc_Absyn_new_decl(_T2F,0U);_T31=res;res=Cyc_Absyn_decl_stmt(_T30,_T31,0U);goto _TL49B;_TL49A: _TL49B: {struct Cyc_Absyn_Stmt*_T34=res;_npop_handler(0);return _T34;}}}}}}}}}_pop_region();}
# 4390
...
# 4397
if(_T13==0)goto _TL49D;_T14=m;{void**_T1B=_cycalloc(sizeof(void*));_T16=m;_T17=_T16->elt_type;_T18=*_T17;
*_T1B=Cyc_Toc_typ_to_c(_T18);_T15=(void**)_T1B;}_T14->elt_type=_T15;goto _TL49E;_TL49D: _TL49E: goto _LL0;}default: goto _LL0;}_LL0:;}
# 4402
return 1;}
# 4404
...
struct Cyc_List_List*args=_TE.args;_TL4A4: if(args!=0)goto _TL4A2;else{goto _TL4A3;}
_TL4A2: _TF=args;_T10=_TF->hd;_T11=(struct _tuple9*)_T10;_T12=args;_T13=_T12->hd;_T14=(struct _tuple9*)_T13;_T15=*_T14;_T16=_T15.f2;(*_T11).f2=Cyc_Toc_typ_to_c(_T16);_T17=args;
# 4411
args=_T17->tl;goto _TL4A4;_TL4A3:;}goto _LL7;}case 5:{struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_T34=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_T2E;_T31=_T34->f1;}{struct Cyc_Absyn_Aggrdecl*ad=_T31;
# 4414
...
# 4416
if(_T19==0)goto _TL4A5;_T1A=ed;_T1B=_T1A->fields;_T1C=_T1B->v;{
struct Cyc_List_List*fs=(struct Cyc_List_List*)_T1C;_TL4AA: if(fs!=0)goto _TL4A8;else{goto _TL4A9;}
_TL4A8: _T1D=fs;_T1E=_T1D->hd;_T1F=(struct Cyc_Absyn_Enumfield*)_T1E;_T20=_T1F->tag;if(_T20==0)goto _TL4AB;_T21=fs;_T22=_T21->hd;_T23=(struct Cyc_Absyn_Enumfield*)_T22;_T24=_T23->tag;Cyc_Toc_exptypes_to_c(_T24);goto _TL4AC;_TL4AB: _TL4AC: _T25=fs;
# 4417
fs=_T25->tl;goto _TL4AA;_TL4A9:;}goto _TL4A6;_TL4A5: _TL4A6: goto _LL7;}case 8:{struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*_T34=(struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_T2E;_T2F=_T34->f1;}{struct Cyc_Absyn_Typedefdecl*td=_T2F;_T26=td;_T27=td;_T28=_T27->defn;_T29=
# 4420
...
_TL4B0: if(ds!=0)goto _TL4AE;else{goto _TL4AF;}
_TL4AE: Cyc_Toc_fresh_label_counter=0;_T0=ds;_T1=_T0->hd;{
...
# 4450
if(_T8!=4)goto _TL4B2;{struct _tuple1*_T60=_cycalloc(sizeof(struct _tuple1));
_T60->f0=Cyc_Absyn_Abs_n(0,1);_TA=c_name;_TB=*_TA;_T60->f1=_TB.f1;_T9=(struct _tuple1*)_T60;}c_name=_T9;goto _TL4B3;_TL4B2: _TL4B3: _TC=vd;_TD=_TC->initializer;
if(_TD==0)goto _TL4B4;_TE=vd;_TF=_TE->sc;_T10=(int)_TF;
if(_T10!=4)goto _TL4B6;_T11=vd;_T11->sc=2U;goto _TL4B7;_TL4B6: _TL4B7: _T12=cinclude;
if(!_T12)goto _TL4B8;_T13=vd;_T14=_T13->initializer;
Cyc_Toc_exptypes_to_c(_T14);goto _TL4B9;
# 4457
_TL4B8: _T15=nv;_T16=vd;_T17=_T16->initializer;Cyc_Toc_exp_to_c(_T15,_T17);_TL4B9: goto _TL4B5;_TL4B4: _TL4B5: _T18=vd;
# 4459
...
# 4466
if(_T22!=4)goto _TL4BA;_T23=fd;{struct _tuple1*_T60=_cycalloc(sizeof(struct _tuple1));
...
_T28->sc=2U;goto _TL4BB;_TL4BA: _TL4BB:
# 4470
...
# 4478
if(!_T31)goto _TL4BC;Cyc_Toc_xdatatypedecl_to_c(tud);goto _TL4BD;_TL4BC: Cyc_Toc_datatypedecl_to_c(tud);_TL4BD: goto _LL0;}case 7:{struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*_T60=(struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_T58;_T5B=_T60->f1;}{struct Cyc_Absyn_Enumdecl*ed=_T5B;
# 4481
...
if(_T35==0)goto _TL4BE;_T36=td;_T37=td;_T38=_T37->defn;
_T36->defn=Cyc_Toc_typ_to_c(_T38);_T39=td;{
# 4490
void*_T60=_T39->defn;unsigned _T61;struct Cyc_Absyn_Enumdecl*_T62;if(_T60==0)goto _TL4C0;_T3A=(int*)_T60;_T3B=*_T3A;if(_T3B!=10)goto _TL4C2;_T3C=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_T60;_T3D=_T3C->f1;_T3E=(struct Cyc_Absyn_TypeDecl*)_T3D;_T3F=_T3E->r;_T40=(int*)_T3F;_T41=*_T40;if(_T41!=1)goto _TL4C4;{struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*_T63=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_T60;_T42=_T63->f1;{struct Cyc_Absyn_TypeDecl _T64=*_T42;_T43=_T64.r;{struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*_T65=(struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)_T43;_T62=_T65->f1;}_T61=_T64.loc;}}{struct Cyc_Absyn_Enumdecl*ed2=_T62;unsigned loc=_T61;
# 4492
...
_T64->f1=_T4B->name;_T64->f2=ed2;_T4A=(struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*)_T64;}_T63->f1=(void*)_T4A;_T63->f2=0;_T49=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T63;}_T48->defn=(void*)_T49;goto _LL23;}_TL4C4: goto _LL26;_TL4C2: goto _LL26;_TL4C0: _LL26: goto _LL23;_LL23:;}goto _TL4BF;
# 4499
_TL4BE: _T4C=td;_T4E=td;_T4F=_T4E->kind;_T50=_check_null(_T4F);_T51=_T50->v;_T52=(struct Cyc_Absyn_Kind*)_T51;_T53=_T52->kind;_T54=(int)_T53;if(_T54!=2)goto _TL4C6;_T4D=Cyc_Toc_void_star_type();goto _TL4C7;_TL4C6: _T4D=Cyc_Absyn_void_type;_TL4C7: _T4C->defn=_T4D;_TL4BF: _T55=Cyc_Flags_noexpand_r;
# 4503
if(!_T55)goto _TL4C8;{struct Cyc_List_List*_T60=_cycalloc(sizeof(struct Cyc_List_List));
_T60->hd=d;_T60->tl=Cyc_Toc_result_decls;_T56=(struct Cyc_List_List*)_T60;}Cyc_Toc_result_decls=_T56;goto _TL4C9;_TL4C8: _TL4C9: goto _LL0;}case 13: goto _LL16;case 14: _LL16: goto _LL18;case 15: _LL18: goto _LL1A;case 16: _LL1A: goto _LL0;case 9:{struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*_T60=(struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_T58;_T59=_T60->f2;}{struct Cyc_List_List*ds2=_T59;_T59=ds2;goto _LL1E;}case 10:{struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*_T60=(struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_T58;_T59=_T60->f2;}_LL1E: {struct Cyc_List_List*ds2=_T59;_T59=ds2;goto _LL20;}case 11:{struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*_T60=(struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_T58;_T59=_T60->f1;}_LL20: {struct Cyc_List_List*ds2=_T59;
# 4512
