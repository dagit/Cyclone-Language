...
return({int(*_Tmp0)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Stmt*)=(int(*)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Stmt*))Cyc_Hashtable_lookup;_Tmp0;})(*Cyc_Toc_fn_pop_table,s);}struct Cyc_Toc_TocState{struct Cyc_List_List**tuple_types;struct Cyc_List_List**anon_aggr_types;struct Cyc_Dict_Dict*aggrs_so_far;struct Cyc_List_List**abs_struct_types;struct Cyc_Set_Set**datatypes_so_far;struct Cyc_Dict_Dict*xdatatypes_so_far;struct Cyc_Dict_Dict*qvar_tags;struct Cyc_Xarray_Xarray*temp_labels;};struct _tuple14{struct _tuple1*f0;struct _tuple1*f1;};
# 117
...
void*res;
{struct _RegionHandle*h=&((struct Cyc_Core_DynamicRegion*)_untag_fat_ptr_check_bound(_check_fat_at_base(dyn2),sizeof(struct Cyc_Core_DynamicRegion),1U))->h;
...
void*_Tmp0=Cyc_Absyn_compress(e->topt);struct Cyc_Absyn_PtrInfo _Tmp1;if(*((int*)_Tmp0)==4){_Tmp1=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp0)->f1;{struct Cyc_Absyn_PtrInfo pi=_Tmp1;
...
# 403
if(vs==0){
struct Cyc_String_pa_PrintArg_struct _Tmp3=({struct Cyc_String_pa_PrintArg_struct _Tmp4;_Tmp4.tag=0,_Tmp4.f1=*s;_Tmp4;});struct Cyc_String_pa_PrintArg_struct _Tmp4=({struct Cyc_String_pa_PrintArg_struct _Tmp5;_Tmp5.tag=0,_Tmp5.f1=*v;_Tmp5;});void*_Tmp5[2];_Tmp5[0]=& _Tmp3,_Tmp5[1]=& _Tmp4;return Cyc_aprintf(_tag_fat("%s_%s_struct",sizeof(char),13U),_tag_fat(_Tmp5,sizeof(void*),2));}{
struct _RegionHandle _Tmp3=_new_region(0U,"r");struct _RegionHandle*r=& _Tmp3;_push_region(r);
{struct _fat_ptr _Tmp4=({struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,_Tmp6.f1=*s;_Tmp6;});struct Cyc_String_pa_PrintArg_struct _Tmp6=({struct Cyc_String_pa_PrintArg_struct _Tmp7;_Tmp7.tag=0,({struct _fat_ptr _Tmp8=Cyc_rstr_sepstr(r,vs,_tag_fat("_",sizeof(char),2U));_Tmp7.f1=_Tmp8;});_Tmp7;});struct Cyc_String_pa_PrintArg_struct _Tmp7=({struct Cyc_String_pa_PrintArg_struct _Tmp8;_Tmp8.tag=0,_Tmp8.f1=*v;_Tmp8;});void*_Tmp8[3];_Tmp8[0]=& _Tmp5,_Tmp8[1]=& _Tmp6,_Tmp8[2]=& _Tmp7;Cyc_aprintf(_tag_fat("%s_%s_%s_struct",sizeof(char),16U),_tag_fat(_Tmp8,sizeof(void*),3));});_npop_handler(0);return _Tmp4;};_pop_region();}}};}}struct _tuple20{struct Cyc_Toc_TocState*f0;struct _tuple14*f1;};
# 416
...
t=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_Tmp7=_cycalloc(sizeof(struct Cyc_Absyn_ArrayType_Absyn_Type_struct));_Tmp7->tag=5,({void*_Tmp8=Cyc_Toc_void_star_type();_Tmp7->f1.elt_type=_Tmp8;}),_Tmp7->f1.tq=Cyc_Toc_mt_tq,({
...
int ans=0;
{struct Cyc_List_List*fs=(struct Cyc_List_List*)td->fields->v;for(0;Cyc_Absyn_qvar_cmp(name,((struct Cyc_Absyn_Datatypefield*)fs->hd)->name)!=0;fs=fs->tl){
++ ans;}}
...
void*_Tmp0=Cyc_Absyn_compress(t);struct Cyc_Absyn_ArrayInfo _Tmp1;if(*((int*)_Tmp0)==5){_Tmp1=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp0)->f1;{struct Cyc_Absyn_ArrayInfo ai=_Tmp1;
...
void*_Tmp0=Cyc_Absyn_compress(t);void*_Tmp1;if(*((int*)_Tmp0)==4){_Tmp1=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp0)->f1.elt_type;{void*t2=_Tmp1;
...
# 792
 ...
 return t;default:
# 799
 return Cyc_Toc_void_star_type();}case 3:
# 709
...
# 745
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_Tmp9=_cycalloc(sizeof(struct Cyc_Absyn_FnType_Absyn_Type_struct));_Tmp9->tag=6,_Tmp9->f1.tvars=0,_Tmp9->f1.effect=0,_Tmp9->f1.ret_tqual=tq2,({void*_TmpA=Cyc_Toc_typ_to_c(t2);_Tmp9->f1.ret_type=_TmpA;}),_Tmp9->f1.args=new_args,_Tmp9->f1.c_varargs=c_vararg,_Tmp9->f1.cyc_varargs=0,_Tmp9->f1.qual_bnd=0,_Tmp9->f1.attributes=new_atts,_Tmp9->f1.checks_clause=0,_Tmp9->f1.checks_assn=0,_Tmp9->f1.requires_clause=0,_Tmp9->f1.requires_assn=0,_Tmp9->f1.ensures_clause=0,_Tmp9->f1.ensures_assn=0,_Tmp9->f1.throws_clause=0,_Tmp9->f1.throws_assn=0,_Tmp9->f1.return_value=0,_Tmp9->f1.arg_vardecls=0,_Tmp9->f1.effconstr=0;_Tmp9;});}case 7: _Tmp0=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)t)->f1;_Tmp8=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)t)->f3;{enum Cyc_Absyn_AggrKind k=_Tmp0;struct Cyc_List_List*fs=_Tmp8;
# 750
...
# 789
if(topt==0){
if(ts==0)return t;else{return(void*)({struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_Tmp9=_cycalloc(sizeof(struct Cyc_Absyn_TypedefType_Absyn_Type_struct));_Tmp9->tag=8,_Tmp9->f1=tdn,_Tmp9->f2=0,_Tmp9->f3=td,_Tmp9->f4=0;_Tmp9;});}}
...
struct Cyc_Absyn_Tqual _Tmp0;void*_Tmp1;if(*((int*)t)==5){_Tmp1=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)t)->f1.elt_type;_Tmp0=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)t)->f1.tq;{void*t2=_Tmp1;struct Cyc_Absyn_Tqual tq=_Tmp0;
# 826
...
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp6=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp7;_Tmp7.tag=0,_Tmp7.f1=_tag_fat("atomic_typ: bad type ",sizeof(char),22U);_Tmp7;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp7=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp8;_Tmp8.tag=2,_Tmp8.f1=(void*)t;_Tmp8;});void*_Tmp8[2];_Tmp8[0]=& _Tmp6,_Tmp8[1]=& _Tmp7;({int(*_Tmp9)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_Tmp9;})(_tag_fat(_Tmp8,sizeof(void*),2));});};}case 6:
# 865
 return 1;case 5: _Tmp2=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp0)->f1.elt_type;{void*t=_Tmp2;
return Cyc_Toc_atomic_type(t);}case 7: _Tmp2=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp0)->f3;{struct Cyc_List_List*fs=_Tmp2;
# 868
for(1;fs!=0;fs=fs->tl){
if(!Cyc_Toc_atomic_type(((struct Cyc_Absyn_Aggrfield*)fs->hd)->type))return 0;}
return 1;}case 4:
...
_Tmp1=ad->impl->fields;goto _LL4;}}else{goto _LL5;}case 7: _Tmp1=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp0)->f3;_LL4: {struct Cyc_List_List*fs=_Tmp1;
# 885
...
# 899
return Cyc_Toc_is_poly_field(e1->topt,f)&& !
Cyc_Toc_is_void_star_or_boxed_tvar(e->topt);}case 22: _Tmp2=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp1=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_Tmp2;struct _fat_ptr*f=_Tmp1;
# 902
void*_Tmp3=Cyc_Absyn_compress(e1->topt);void*_Tmp4;if(*((int*)_Tmp3)==4){_Tmp4=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp3)->f1.elt_type;{void*t=_Tmp4;
# 904
return Cyc_Toc_is_poly_field(t,f)&& !Cyc_Toc_is_void_star_or_boxed_tvar(e->topt);}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp5=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp6;_Tmp6.tag=0,_Tmp6.f1=_tag_fat("is_poly_project: bad type ",sizeof(char),27U);_Tmp6;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp6=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp7;_Tmp7.tag=2,_Tmp7.f1=(void*)e1->topt;_Tmp7;});void*_Tmp7[2];_Tmp7[0]=& _Tmp5,_Tmp7[1]=& _Tmp6;({int(*_Tmp8)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_Tmp8;})(_tag_fat(_Tmp7,sizeof(void*),2));});};}default:
# 907
 return 0;};}
# 912
...
# 1104
static enum Cyc_Toc_PTR_ANS Cyc_Toc_ptr_use_to_c(struct Cyc_Toc_Env*nv,struct Cyc_Absyn_Exp*ptr,void*annot,struct Cyc_Absyn_Exp*index){
# 1106
enum Cyc_Toc_PTR_ANS ans;
int old_lhs=Cyc_Toc_in_lhs(nv);
void*old_typ=Cyc_Absyn_compress(ptr->topt);
...
if((!valid || i!=1U)|| !Cyc_Tcutil_is_zeroterm_pointer_type(ptr->topt)){
# 1171
struct Cyc_Absyn_Exp*newp=Cyc_Absyn_new_exp(ptr->r,0U);
void*_Tmp8=Cyc_Absyn_compress(ta1);struct Cyc_Absyn_ArrayInfo _Tmp9;if(*((int*)_Tmp8)==5){_Tmp9=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp8)->f1;{struct Cyc_Absyn_ArrayInfo ainfo=_Tmp9;
# 1174
({void*_TmpA=Cyc_Absyn_cstar_type(ainfo.elt_type,tq);newp->topt=_TmpA;});
({void*_TmpA=({void*_TmpB=Cyc_Absyn_cstar_type(ainfo.elt_type,tq);Cyc_Toc_cast_it_r(_TmpB,({struct Cyc_Absyn_Exp*_TmpC[4];_TmpC[0]=newp,_TmpC[1]=bd,({
# 1177
struct Cyc_Absyn_Exp*_TmpD=({struct Cyc_Absyn_Exp*_TmpE=ainfo.num_elts;Cyc_Absyn_times_exp(_TmpE,Cyc_Absyn_sizeoftype_exp(ainfo.elt_type,0U),0U);});_TmpC[2]=_TmpD;}),_TmpC[3]=ind;Cyc_Toc_fncall_exp_dl(fn_e,_tag_fat(_TmpC,sizeof(struct Cyc_Absyn_Exp*),4));}));});
# 1175
ptr->r=_TmpA;});
# 1178
ans=1U;
goto _LL17;}}else{
# 1181
({void*_TmpA=Cyc_Absyn_cstar_type(ta1,tq);newp->topt=_TmpA;});
({void*_TmpA=({void*_TmpB=Cyc_Absyn_cstar_type(ta1,tq);Cyc_Toc_cast_it_r(_TmpB,({struct Cyc_Absyn_Exp*_TmpC[4];_TmpC[0]=newp,_TmpC[1]=bd,({
# 1184
...
struct _tuple23*_Tmp0=_cycalloc(sizeof(struct _tuple23));_Tmp0->f0=Cyc_Toc_mt_tq,({void*_Tmp1=Cyc_Toc_typ_to_c(e->topt);_Tmp0->f1=_Tmp1;});return _Tmp0;}
# 1227
...
if(field_types==0)
return 0;
for(1;field_types->tl!=0;field_types=field_types->tl){
;}{
...
if(nested_ans!=0)
return nested_ans;{
void*_Tmp3=Cyc_Absyn_compress(last_type_field->type);void*_Tmp4;void*_Tmp5;if(*((int*)_Tmp3)==5){_Tmp5=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp3)->f1.elt_type;_Tmp4=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp3)->f1.num_elts;{void*elt_type=_Tmp5;struct Cyc_Absyn_Exp*type_bd=_Tmp4;
# 1284
...
{struct Cyc_Absyn_Vardecl*x_vd;x_vd=_cycalloc(sizeof(struct Cyc_Absyn_Vardecl)),x_vd->sc=2U,x_vd->name=x,x_vd->varloc=0U,x_vd->tq=Cyc_Toc_mt_tq,x_vd->type=c_fat_ptr_type,x_vd->initializer=xinit,x_vd->rgn=0,x_vd->attributes=0,x_vd->escapes=0,x_vd->is_proto=0,x_vd->rename=0;{
...
struct Cyc_Absyn_Vardecl*y_vd;y_vd=_cycalloc(sizeof(struct Cyc_Absyn_Vardecl)),y_vd->sc=2U,y_vd->name=y,y_vd->varloc=0U,y_vd->tq=Cyc_Toc_mt_tq,y_vd->type=c_elt_type,y_vd->initializer=deref_x,y_vd->rgn=0,y_vd->attributes=0,y_vd->escapes=0,y_vd->is_proto=0,y_vd->rename=0;{
...
struct Cyc_Absyn_Vardecl*z_vd;z_vd=_cycalloc(sizeof(struct Cyc_Absyn_Vardecl)),z_vd->sc=2U,z_vd->name=z,z_vd->varloc=0U,z_vd->tq=Cyc_Toc_mt_tq,z_vd->type=c_elt_type,z_vd->initializer=z_init,z_vd->rgn=0,z_vd->attributes=0,z_vd->escapes=0,z_vd->is_proto=0,z_vd->rename=0;{
...
if(clear_read)*is_read=0;
return ad->impl->tagged;}}}else{goto _LL3;}}else{_LL3:
 return 0;};}
# 1559
...
# 1565
return Cyc_Toc_is_tagged_union_project_impl(e1->topt,f,f_tag,tagged_member_type,clear_read,is_read);}case 22: _Tmp3=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp2=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp1=(int*)&((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f4;{struct Cyc_Absyn_Exp*e1=_Tmp3;struct _fat_ptr*f=_Tmp2;int*is_read=(int*)_Tmp1;
# 1568
void*_Tmp4=Cyc_Absyn_compress(e1->topt);void*_Tmp5;if(*((int*)_Tmp4)==4){_Tmp5=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp4)->f1.elt_type;{void*et=_Tmp5;
# 1570
...
goto _LL0;}}_LL0:;}
# 1621
{void*_Tmp0=e->r;enum Cyc_Absyn_MallocKind _Tmp1;int _Tmp2;enum Cyc_Absyn_Coercion _Tmp3;void*_Tmp4;void*_Tmp5;void*_Tmp6;enum Cyc_Absyn_Incrementor _Tmp7;enum Cyc_Absyn_Primop _Tmp8;int _Tmp9;void*_TmpA;switch(*((int*)_Tmp0)){case 2:
# 1623
...
goto _LL7;}else{
goto _LL7;}case 1:
 goto _LL7;case 41: _TmpA=((struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp9=((struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_TmpA;int static_only=_Tmp9;
# 1641
if(static_only)
({void*_TmpB=Cyc_Absyn_int_exp(0U,1,0U)->r;e->r=_TmpB;});else{
# 1645
Cyc_Toc_exp_to_c(nv,e1);
({void*_TmpB=({struct Cyc_Absyn_Exp*_TmpC=e1;struct Cyc_Absyn_Exp*_TmpD=Cyc_Absyn_int_exp(0U,1,0U);Cyc_Absyn_conditional_exp(_TmpC,_TmpD,({
void*_TmpE=Cyc_Toc_typ_to_c(old_typ);Cyc_Toc_array_to_ptr_cast(_TmpE,
Cyc_Toc_fncall_exp_dl(Cyc_Toc__throw_assert_e,_tag_fat(0U,sizeof(struct Cyc_Absyn_Exp*),0)),0U);}),0U);})->r;
# 1646
e->r=_TmpB;});}
# 1650
goto _LL7;}case 42:
...
Cyc_Toc_exp_to_c(nv,e1);goto _LL7;}case 3: _Tmp8=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_TmpA=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{enum Cyc_Absyn_Primop p=_Tmp8;struct Cyc_List_List*es=_TmpA;
# 1655
...
# 1690
int(*_Tmp13)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_Tmp13;})(_tag_fat(_Tmp12,sizeof(void*),2));});}_LL81:;}
# 1693
...
{void*_TmpB=Cyc_Absyn_compress((void*)_check_null(old_types)->hd);void*_TmpC;void*_TmpD;void*_TmpE;if(*((int*)_TmpB)==4){_TmpE=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_TmpB)->f1.elt_type;_TmpD=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_TmpB)->f1.ptr_atts.bounds;_TmpC=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_TmpB)->f1.ptr_atts.zero_term;{void*elt_type=_TmpE;void*b=_TmpD;void*zt=_TmpC;
# 1702
struct Cyc_Absyn_Exp*eopt=({void*_TmpF=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp_constrain(_TmpF,b,1);});
...
goto _LL62;}case Cyc_Absyn_Eq:
 goto _LL6E;case Cyc_Absyn_Neq: _LL6E: goto _LL70;case Cyc_Absyn_Gt: _LL70:
 goto _LL72;case Cyc_Absyn_Gte: _LL72: goto _LL74;case Cyc_Absyn_Lt: _LL74: goto _LL76;case Cyc_Absyn_Lte: _LL76: goto _LL78;case Cyc_Absyn_UGt: _LL78:
 goto _LL7A;case Cyc_Absyn_UGte: _LL7A: goto _LL7C;case Cyc_Absyn_ULt: _LL7C: goto _LL7E;case Cyc_Absyn_ULte: _LL7E: {
# 1744
struct Cyc_Absyn_Exp*e1=(struct Cyc_Absyn_Exp*)_check_null(es)->hd;
struct Cyc_Absyn_Exp*e2=(struct Cyc_Absyn_Exp*)_check_null(es->tl)->hd;
...
goto _LL62;}default:
 goto _LL62;}_LL62:;
# 1762
goto _LL7;}case 5: _TmpA=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp7=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e2=_TmpA;enum Cyc_Absyn_Incrementor incr=_Tmp7;
# 1764
...
# 1788
int(*_TmpF)(unsigned,struct _fat_ptr)=(int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2;_TmpF;})(e->loc,_tag_fat(_TmpE,sizeof(void*),3));});}_LL8B:;
# 1791
...
*e=*e2;}}}
# 1847
goto _LL7;}}case 4: _TmpA=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp5=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;{struct Cyc_Absyn_Exp*e1=_TmpA;struct Cyc_Core_Opt*popt=_Tmp6;struct Cyc_Absyn_Exp*e2=_Tmp5;
# 1866 "toc.cyc"
...
{enum Cyc_Absyn_Primop _TmpB=(enum Cyc_Absyn_Primop)popt->v;switch((int)_TmpB){case Cyc_Absyn_Plus:
 change=e2;goto _LL92;case Cyc_Absyn_Minus:
 change=Cyc_Absyn_prim1_exp(2U,e2,0U);goto _LL92;default:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpC=({struct Cyc_Warn_String_Warn_Warg_struct _TmpD;_TmpD.tag=0,_TmpD.f1=_tag_fat("bad t ? pointer arithmetic",sizeof(char),27U);_TmpD;});void*_TmpD[1];_TmpD[0]=& _TmpC;({int(*_TmpE)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_TmpE;})(_tag_fat(_TmpD,sizeof(void*),1));});}_LL92:;}
# 1904
done=1;{
# 1906
...
# 1924
goto _LL99;}else{
({struct Cyc_Warn_String_Warn_Warg_struct _TmpC=({struct Cyc_Warn_String_Warn_Warg_struct _TmpD;_TmpD.tag=0,_TmpD.f1=_tag_fat("bad zero-terminated pointer arithmetic",sizeof(char),39U);_TmpD;});void*_TmpD[1];_TmpD[0]=& _TmpC;({int(*_TmpE)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_TmpE;})(_tag_fat(_TmpD,sizeof(void*),1));});}_LL99:;}}}
# 1928
if(!done){
# 1930
if(e1_poly)
...
goto _LL7;}case 7: _TmpA=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_TmpA;struct Cyc_Absyn_Exp*e2=_Tmp6;
_TmpA=e1;_Tmp6=e2;goto _LL21;}case 8: _TmpA=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_LL21: {struct Cyc_Absyn_Exp*e1=_TmpA;struct Cyc_Absyn_Exp*e2=_Tmp6;
_TmpA=e1;_Tmp6=e2;goto _LL23;}case 9: _TmpA=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_LL23: {struct Cyc_Absyn_Exp*e1=_TmpA;struct Cyc_Absyn_Exp*e2=_Tmp6;
# 1950
Cyc_Toc_exp_to_c(nv,e1);
Cyc_Toc_exp_to_c(nv,e2);
goto _LL7;}case 10: if(((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_Tmp0)->f3==0){_TmpA=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_TmpA;struct Cyc_List_List*es=_Tmp6;
# 1954
...
({void(*_TmpB)(void(*)(struct Cyc_Toc_Env*,struct Cyc_Absyn_Exp*),struct Cyc_Toc_Env*,struct Cyc_List_List*)=(void(*)(void(*)(struct Cyc_Toc_Env*,struct Cyc_Absyn_Exp*),struct Cyc_Toc_Env*,struct Cyc_List_List*))Cyc_List_iter_c;_TmpB;})(Cyc_Toc_exp_to_c,nv,es);
goto _LL7;}}else{_TmpA=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp9=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_Tmp0)->f3->num_varargs;_Tmp5=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_Tmp0)->f3->injectors;_Tmp4=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_Tmp0)->f3->vai;{struct Cyc_Absyn_Exp*e1=_TmpA;struct Cyc_List_List*es=_Tmp6;int num_varargs=_Tmp9;struct Cyc_List_List*injectors=_Tmp5;struct Cyc_Absyn_VarargInfo*vai=_Tmp4;
# 1970 "toc.cyc"
...
tud=x;goto _LLA1;}}else{goto _LLA4;}}else{goto _LLA4;}}else{_LLA4:
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp11=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp12;_Tmp12.tag=0,_Tmp12.f1=_tag_fat("unknown datatype in vararg with inject",sizeof(char),39U);_Tmp12;});void*_Tmp12[1];_Tmp12[0]=& _Tmp11;({int(*_Tmp13)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_Tmp13;})(_tag_fat(_Tmp12,sizeof(void*),1));});}_LLA1:;}{
# 2011
...
_npop_handler(0);goto _LL7;
# 1970
;_pop_region();}}case 11: _TmpA=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp9=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_TmpA;int b=_Tmp9;
# 2057
Cyc_Toc_exp_to_c(nv,e1);{
...
Cyc_Toc_exp_to_c(nv,e1);goto _LL7;}case 13: _TmpA=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_TmpA;struct Cyc_List_List*ts=_Tmp6;
# 2063
Cyc_Toc_exp_to_c(nv,e1);{
# 2072 "toc.cyc"
...
# 2088
goto _LL7;}}case 14: _TmpA=(void**)&((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp9=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;_Tmp3=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_Tmp0)->f4;{void**t=_TmpA;struct Cyc_Absyn_Exp*e1=_Tmp6;int user_inserted=_Tmp9;enum Cyc_Absyn_Coercion coercion=_Tmp3;
# 2090
...
Cyc_Toc_exp_to_c(nv,e1);
# 2097
{struct _tuple34 _TmpB=({struct _tuple34 _TmpC;({void*_TmpD=Cyc_Absyn_compress(old_t2);_TmpC.f0=_TmpD;}),({void*_TmpD=Cyc_Absyn_compress(new_typ);_TmpC.f1=_TmpD;});_TmpC;});struct Cyc_Absyn_PtrInfo _TmpC;struct Cyc_Absyn_PtrInfo _TmpD;if(*((int*)_TmpB.f0)==4)switch(*((int*)_TmpB.f1)){case 4: _TmpD=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_TmpB.f0)->f1;_TmpC=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_TmpB.f1)->f1;{struct Cyc_Absyn_PtrInfo p1=_TmpD;struct Cyc_Absyn_PtrInfo p2=_TmpC;
# 2099
struct Cyc_Absyn_Exp*b1=({void*_TmpE=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp_constrain(_TmpE,p1.ptr_atts.bounds,1);});
struct Cyc_Absyn_Exp*b2=({void*_TmpE=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp_constrain(_TmpE,p2.ptr_atts.bounds,1);});
...
{void*_Tmp15=e1->r;void*_Tmp16;switch(*((int*)_Tmp15)){case 0: switch(((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_Tmp15)->f1.Wstring_c.tag){case 8:
 arg3=e2;goto _LLC2;case 9:
 arg3=e2;goto _LLC2;default: goto _LLCB;}case 1: switch(*((int*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp15)->f1)){case 1: _Tmp16=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp15)->f1)->f1;{struct Cyc_Absyn_Vardecl*vd=_Tmp16;
_Tmp16=vd;goto _LLCA;}case 4: _Tmp16=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp15)->f1)->f1;_LLCA: {struct Cyc_Absyn_Vardecl*vd=_Tmp16;
# 2141
if(!Cyc_Tcutil_is_array_type(vd->type))
goto _LLCC;
arg3=e2;
goto _LLC2;}default: goto _LLCB;}default: _LLCB: _LLCC:
# 2148
...
# 2198
{void*_TmpF=e->annot;if(((struct Cyc_InsertChecks_FatBound_Absyn_AbsynAnnot_struct*)_TmpF)->tag==Cyc_InsertChecks_FatBound)
goto _LLD1;else{if(((struct Cyc_InsertChecks_NullAndFatBound_Absyn_AbsynAnnot_struct*)_TmpF)->tag==Cyc_InsertChecks_NullAndFatBound){_LLD1:
# 2205
 ptr_exp=({struct Cyc_Absyn_Exp*_Tmp10[3];_Tmp10[0]=ptr_exp,({
# 2207
struct Cyc_Absyn_Exp*_Tmp11=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(p1.elt_type),0U);_Tmp10[1]=_Tmp11;}),_Tmp10[2]=new_e2;Cyc_Toc_fncall_exp_dl(Cyc_Toc__untag_fat_ptr_check_bound_e,_tag_fat(_Tmp10,sizeof(struct Cyc_Absyn_Exp*),3));});
# 2209
goto _LLCD;}else{
# 2211
ptr_exp=({struct Cyc_Absyn_Exp*_Tmp10[3];_Tmp10[0]=ptr_exp,({
# 2213
struct Cyc_Absyn_Exp*_Tmp11=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(p1.elt_type),0U);_Tmp10[1]=_Tmp11;}),_Tmp10[2]=new_e2;Cyc_Toc_fncall_exp_dl(Cyc_Toc__untag_fat_ptr_e,_tag_fat(_Tmp10,sizeof(struct Cyc_Absyn_Exp*),3));});
# 2215
goto _LLCD;}}_LLCD:;}
# 2217
did_inserted_checks=1;
...
goto _LLB3;}}_LLB3:;}
# 2234
goto _LLAC;}case 0: if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_TmpB.f1)->f1)==1){_TmpD=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_TmpB.f0)->f1;{struct Cyc_Absyn_PtrInfo p1=_TmpD;
# 2236
{struct Cyc_Absyn_Exp*_TmpE=({void*_TmpF=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp_constrain(_TmpF,p1.ptr_atts.bounds,1);});if(_TmpE==0){
# 2238
...
goto _LLD4;}_LLD4:;}
# 2243
goto _LLAC;}}else{goto _LLB1;}default: goto _LLB1;}else{_LLB1:
# 2245
 if(Cyc_Unify_unify(old_t2_c,new_typ_c))
*e=*e1;
goto _LLAC;}_LLAC:;}
...
goto _LL7;}case 16: _TmpA=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp5=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;{struct Cyc_Absyn_Exp*rgnopt=_TmpA;struct Cyc_Absyn_Exp*e1=_Tmp6;struct Cyc_Absyn_Exp*qual=_Tmp5;
# 2269
Cyc_Toc_exp_to_c(nv,e1);{
# 2271
void*elt_typ=Cyc_Toc_typ_to_c(_check_null(e1->topt));
{void*_TmpB=Cyc_Absyn_compress(elt_typ);void*_TmpC;if(*((int*)_TmpB)==5){_TmpC=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_TmpB)->f1.elt_type;{void*t2=_TmpC;
elt_typ=Cyc_Toc_typ_to_c(t2);goto _LLD9;}}else{
goto _LLD9;}_LLD9:;}{
# 2276
...
goto _LL7;}case 22: _TmpA=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp9=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;_Tmp2=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f4;{struct Cyc_Absyn_Exp*e1=_TmpA;struct _fat_ptr*f=_Tmp6;int is_tagged=_Tmp9;int is_read=_Tmp2;
# 2335
int is_poly=Cyc_Toc_is_poly_project(e);
void*e1typ=_check_null(e1->topt);
void*ta;
{void*_TmpB=Cyc_Absyn_compress(e1typ);struct Cyc_Absyn_PtrInfo _TmpC;if(*((int*)_TmpB)==4){_TmpC=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_TmpB)->f1;{struct Cyc_Absyn_PtrInfo p=_TmpC;
ta=p.elt_type;goto _LLDE;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("get_ptr_typ: not a pointer!",sizeof(char),28U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({int(*_TmpF)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_TmpF;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLDE:;}
# 2342
did_inserted_checks=1;
...
did_inserted_checks=1;
Cyc_Toc_ptr_use_to_c(nv,e1,e->annot,0);
goto _LL7;}case 23: _TmpA=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_TmpA;struct Cyc_Absyn_Exp*e2=_Tmp6;
# 2354
did_inserted_checks=1;{
enum Cyc_Toc_PTR_ANS res=Cyc_Toc_ptr_use_to_c(nv,e1,e->annot,e2);
if((int)res==0)
({void*_TmpB=Cyc_Toc_deref_exp_r(e1);e->r=_TmpB;});else{
if((int)res==1)
e->r=e1->r;}
...
goto _LL7;}case 26: _TmpA=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp5=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;_Tmp9=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_Tmp0)->f4;{struct Cyc_Absyn_Vardecl*vd=_TmpA;struct Cyc_Absyn_Exp*e1=_Tmp6;struct Cyc_Absyn_Exp*e2=_Tmp5;int iszeroterm=_Tmp9;
# 2374
Cyc_Toc_exp_to_c(nv,e1);
Cyc_Toc_exp_to_c(nv,e2);
if(Cyc_Toc_is_toplevel(nv)){
...
# 2394
goto _LL7;}case 27: _TmpA=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=(void*)((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp9=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;{struct Cyc_Absyn_Exp*e1=_TmpA;void*t1=_Tmp6;int iszeroterm=_Tmp9;
# 2401
if(Cyc_Toc_is_toplevel(nv))
({void*_TmpB=Cyc_Toc_unresolvedmem_exp_r(0,0);e->r=_TmpB;});else{
# 2404
Cyc_Toc_exp_to_c(nv,e1);}
goto _LL7;}case 29: _TmpA=(void*)((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;{void*st=_TmpA;struct Cyc_List_List*dles=_Tmp6;
# 2408
{struct Cyc_List_List*dles2=dles;for(0;dles2!=0;dles2=dles2->tl){
...
e->topt=strct_typ;
goto _LLE6;}}else{goto _LLE9;}}else{goto _LLE9;}}else{_LLE9:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("anonStruct type not an aggregate",sizeof(char),33U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({int(*_TmpF)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_TmpF;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLE6:;}else{
# 2422
({void*_TmpB=Cyc_Toc_unresolvedmem_exp_r(0,dles);e->r=_TmpB;});}
goto _LL7;}}case 28: _TmpA=(struct _tuple1**)&((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp5=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;_Tmp4=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_Tmp0)->f4;{struct _tuple1**tdn=_TmpA;struct Cyc_List_List*exist_ts=_Tmp6;struct Cyc_List_List*dles=_Tmp5;struct Cyc_Absyn_Aggrdecl*sd=_Tmp4;
# 2428
if(sd==0 || sd->impl==0)
...
({struct _tuple1*_TmpD=Cyc_Absyn_aggr_kinded_name(info).f1;*tdn=_TmpD;});goto _LLEB;}}else{goto _LLEE;}}else{_LLEE:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("exp_to_c, Aggregate_e: bad type translation",sizeof(char),44U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({int(*_TmpF)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_TmpF;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLEB:;}{
# 2439
...
struct Cyc_List_List*fields=Cyc_Tcutil_resolve_aggregate_designators(Cyc_Core_heap_region,e->loc,dles,sd->kind,sd->impl->fields);
# 2446
if(!Cyc_Toc_is_toplevel(nv)){
...
struct _fat_ptr*_Tmp10=({struct _fat_ptr*_Tmp11=_cycalloc(sizeof(struct _fat_ptr));({struct _fat_ptr _Tmp12=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _Tmp13=({struct Cyc_String_pa_PrintArg_struct _Tmp14;_Tmp14.tag=0,_Tmp14.f1=*(*sd->name).f1;_Tmp14;});struct Cyc_String_pa_PrintArg_struct _Tmp14=({struct Cyc_String_pa_PrintArg_struct _Tmp15;_Tmp15.tag=0,_Tmp15.f1=*n;_Tmp15;});void*_Tmp15[2];_Tmp15[0]=& _Tmp13,_Tmp15[1]=& _Tmp14;Cyc_aprintf(_tag_fat("_union_%s_%s",sizeof(char),13U),_tag_fat(_Tmp15,sizeof(void*),2));});*_Tmp11=_Tmp12;});_Tmp11;});s->f1=_Tmp10;});{
# 2468
...
# 2492
if(fs->tl==0){
{void*_Tmp10=Cyc_Absyn_compress(new_f->type);struct Cyc_Absyn_ArrayInfo _Tmp11;if(*((int*)_Tmp10)==5){_Tmp11=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp10)->f1;{struct Cyc_Absyn_ArrayInfo ai=_Tmp11;
# 2495
...
({void*_Tmp12=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_Tmp13=_cycalloc(sizeof(struct Cyc_Absyn_ArrayType_Absyn_Type_struct));_Tmp13->tag=5,_Tmp13->f1=ai2;_Tmp13;});new_f->type=_Tmp12;});}
# 2500
goto _LLF8;}}else{
# 2504
if(fieldexp->topt==0)
...
# 2508
new_f->type=_check_null(fieldexp->topt);goto _LLFD;}else{goto _LL100;}}else{_LL100:
 goto _LLFD;}_LLFD:;}
# 2511
goto _LLF8;}_LLF8:;}
# 2515
...
# 2530
goto _LLF0;}}else{goto _LLF3;}}else{_LLF3:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("exp_to_c, Aggregate_e: bad struct type",sizeof(char),39U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({int(*_TmpF)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_TmpF;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLF0:;}else{
# 2539
if(_check_null(sd->impl)->tagged){
# 2541
...
# 2582
goto _LL7;}}}}case 30: _TmpA=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp5=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;{struct Cyc_List_List*es=_TmpA;struct Cyc_Absyn_Datatypedecl*tud=_Tmp6;struct Cyc_Absyn_Datatypefield*tuf=_Tmp5;
# 2586
...
goto _LL7;}}case 34: _TmpA=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_TmpA;struct Cyc_Absyn_Exp*e2=_Tmp6;
# 2687
void*e1_old_typ=_check_null(e1->topt);
void*e2_old_typ=_check_null(e2->topt);
...
({void*_TmpB=Cyc_Toc_stmt_exp_r(s);e->r=_TmpB;});
goto _LL7;}}}}}}case 37: _TmpA=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp6=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_TmpA;struct _fat_ptr*f=_Tmp6;
# 2714
...
goto _LL108;}}else{goto _LL10B;}}else{goto _LL10B;}}else{_LL10B:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpC=({struct Cyc_Warn_String_Warn_Warg_struct _TmpD;_TmpD.tag=0,_TmpD.f1=_tag_fat("non-aggregate type in tagcheck",sizeof(char),31U);_TmpD;});void*_TmpD[1];_TmpD[0]=& _TmpC;({int(*_TmpE)(struct _fat_ptr ap)=(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;_TmpE;})(_tag_fat(_TmpD,sizeof(void*),1));});}_LL108:;}
# 2725
...
void*t=({union Cyc_Tcpat_PatOrWhere _Tmp0=p->orig_pat;if(_Tmp0.pattern.tag!=1)_throw_match();_Tmp0.pattern.val;})->topt;
...
void*_Tmp0=Cyc_Absyn_compress(ctype);struct Cyc_Absyn_Tqual _Tmp1;if(*((int*)_Tmp0)==4){_Tmp1=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp0)->f1.elt_tq;{struct Cyc_Absyn_Tqual tq=_Tmp1;
# 2944
...
new_vd=({struct _tuple1*_Tmp4=Cyc_Toc_temp_var();Cyc_Absyn_new_vardecl(0U,_Tmp4,Cyc_Toc_void_star_type(),0,0);});
...
# 2996
new_vd=({struct _tuple1*_Tmp4=Cyc_Toc_temp_var();Cyc_Absyn_new_vardecl(0U,_Tmp4,ctype,0,0);});
...
void*tuf_typ=(*((struct _tuple23*)tuf_tqts->hd)).f1;
void*t2=p2->topt;
...
goto _LL2E;}}else{goto _LL33;}case 7: _Tmp7=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp4)->f1;_Tmp6=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp4)->f2;_Tmp5=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp4)->f3;{enum Cyc_Absyn_AggrKind ak=_Tmp7;int is_tuple=_Tmp6;struct Cyc_List_List*fs=_Tmp5;
# 3126
fields=fs;
...
void*ftype=Cyc_Absyn_lookup_field(fields,f)->type;
...
# 3486
if(!already_var)
res=({struct _tuple1*_Tmp2=v;void*_Tmp3=Cyc_Toc_typ_to_c(e->topt);struct Cyc_Absyn_Exp*_Tmp4=e;Cyc_Absyn_declare_stmt(_Tmp2,_Tmp3,_Tmp4,res,0U);});
whole_s->r=res->r;
...
# 3513
void*t=Cyc_Toc_typ_to_c(e->topt);
Cyc_Toc_exp_to_c(nv,e);{
...
Cyc_Toc_exp_to_c(nv,(struct Cyc_Absyn_Exp*)es2->hd);
...
struct Cyc_Absyn_Vardecl*new_vd=({struct _tuple1*_TmpB=Cyc_Toc_temp_var();void*_TmpC=vd->type;Cyc_Absyn_new_vardecl(0U,_TmpB,_TmpC,e,0);});
...
# 3607
({void*_TmpB=Cyc_Toc_letdecl_to_c(nv,p,dec_tree,e->topt,e,body)->r;s->r=_TmpB;});
goto _LL3C;}_LL3C:;}
# 3610
...
({void*_Tmp0=Cyc_Toc_typ_to_c(f->cached_type);f->cached_type=_Tmp0;});{
...
_npop_handler(0);return;}
# 3747
Cyc_Toc_fn_pop_table=({struct Cyc_Hashtable_Table**_Tmp2=_cycalloc(sizeof(struct Cyc_Hashtable_Table*));({struct Cyc_Hashtable_Table*_Tmp3=({struct Cyc_Hashtable_Table*(*_Tmp4)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Fndecl*)=(struct Cyc_Hashtable_Table*(*)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Fndecl*))Cyc_Hashtable_lookup;_Tmp4;})(*Cyc_Toc_gpop_tables,f);*_Tmp2=_Tmp3;});_Tmp2;});
...
f->i.cyc_varargs=0;}}
# 3756
{struct Cyc_List_List*arg_vds=(struct Cyc_List_List*)f->param_vardecls->v;for(0;arg_vds!=0;arg_vds=arg_vds->tl){
...
# 3829 "toc.cyc"
void*_Tmp5=Cyc_Absyn_compress(old_type);unsigned _Tmp6;void*_Tmp7;struct Cyc_Absyn_Tqual _Tmp8;void*_Tmp9;if(*((int*)_Tmp5)==5){_Tmp9=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp5)->f1.elt_type;_Tmp8=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp5)->f1.tq;_Tmp7=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp5)->f1.zero_term;_Tmp6=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp5)->f1.zt_loc;{void*et=_Tmp9;struct Cyc_Absyn_Tqual tq=_Tmp8;void*zt=_Tmp7;unsigned ztl=_Tmp6;
# 3832
old_type=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_TmpA=_cycalloc(sizeof(struct Cyc_Absyn_ArrayType_Absyn_Type_struct));_TmpA->tag=5,_TmpA->f1.elt_type=et,_TmpA->f1.tq=tq,({struct Cyc_Absyn_Exp*_TmpB=Cyc_Absyn_uint_exp(0U,0U);_TmpA->f1.num_elts=_TmpB;}),_TmpA->f1.zero_term=zt,_TmpA->f1.zt_loc=ztl;_TmpA;});
goto _LL9;}}else{
# 3835
...
old_type=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_TmpA=_cycalloc(sizeof(struct Cyc_Absyn_ArrayType_Absyn_Type_struct));_TmpA->tag=5,({void*_TmpB=Cyc_Toc_void_star_type();_TmpA->f1.elt_type=_TmpB;}),_TmpA->f1.tq=Cyc_Toc_mt_tq,({
# 3838
...
struct _fat_ptr s=({struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,_Tmp6.f1=*(*ad->name).f1;_Tmp6;});struct Cyc_String_pa_PrintArg_struct _Tmp6=({struct Cyc_String_pa_PrintArg_struct _Tmp7;_Tmp7.tag=0,_Tmp7.f1=*f;_Tmp7;});void*_Tmp7[2];_Tmp7[0]=& _Tmp5,_Tmp7[1]=& _Tmp6;Cyc_aprintf(_tag_fat("_union_%s_%s",sizeof(char),13U),_tag_fat(_Tmp7,sizeof(void*),2));});
...
struct Cyc_Absyn_Vardecl*tag_decl=Cyc_Absyn_new_vardecl(0U,f->name,tag_typ,initopt,0);
tag_decl->sc=f->sc;
...
# 4031
void*_Tmp0=Cyc_Absyn_compress(old_typ);void*_Tmp1;void*_Tmp2;void*_Tmp3;if(*((int*)_Tmp0)==5){_Tmp3=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp0)->f1.elt_type;_Tmp2=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp0)->f1.num_elts;_Tmp1=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp0)->f1.zero_term;{void*et=_Tmp3;struct Cyc_Absyn_Exp*num_elts_opt=_Tmp2;void*zt=_Tmp1;
# 4033
if(Cyc_Tcutil_force_type2bool(0,zt)){
if(num_elts_opt==0)
...
# 4241
({void*_Tmp2=(int)((struct Cyc_Absyn_Kind*)td->kind->v)->kind==2?Cyc_Toc_void_star_type(): Cyc_Absyn_void_type;td->defn=_Tmp2;});}
# 4245
