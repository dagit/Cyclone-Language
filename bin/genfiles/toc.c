...
static void*t=0;
if(t == 0)
t=({void*_tmp82F=Cyc_Absyn_void_type;void*_tmp82E=Cyc_Absyn_heap_rgn_type;struct Cyc_Absyn_Tqual _tmp82D=Cyc_Absyn_empty_tqual(0U);void*_tmp82C=Cyc_Absyn_false_type;Cyc_Absyn_star_type(_tmp82F,_tmp82E,_tmp82D,_tmp82C,Cyc_Absyn_false_type);});
...
static void*r=0;
if(r == 0)
r=({void*_tmp830=Cyc_Absyn_strct(Cyc_Toc__RegionHandle_sp);Cyc_Absyn_cstar_type(_tmp830,Cyc_Toc_mt_tq);});
...
return({struct _tuple19*_tmp76=_cycalloc(sizeof(*_tmp76));({struct Cyc_List_List*_tmp832=({struct Cyc_List_List*_tmp75=_cycalloc(sizeof(*_tmp75));({void*_tmp831=(void*)({struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_tmp74=_cycalloc(sizeof(*_tmp74));_tmp74->tag=1U,_tmp74->f1=name;_tmp74;});_tmp75->hd=_tmp831;}),_tmp75->tl=0;_tmp75;});_tmp76->f1=_tmp832;}),_tmp76->f2=e;_tmp76;});}
# 325
static struct Cyc_Absyn_Exp*Cyc_Toc_fncall_exp_dl(struct Cyc_Absyn_Exp*f,struct _fat_ptr args){
return({struct Cyc_Absyn_Exp*_tmp833=f;Cyc_Absyn_fncall_exp(_tmp833,((struct Cyc_List_List*(*)(struct _fat_ptr arr))Cyc_List_from_array)(args),0U);});}
# 328
...
return(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp7F=_cycalloc(sizeof(*_tmp7F));_tmp7F->tag=10U,_tmp7F->f1=e,({struct Cyc_List_List*_tmp834=((struct Cyc_List_List*(*)(struct _fat_ptr arr))Cyc_List_from_array)(es);_tmp7F->f2=_tmp834;}),_tmp7F->f3=0,_tmp7F->f4=1;_tmp7F;});}
# 354
...
# 420
({struct Cyc_Warn_String_Warn_Warg_struct _tmp8B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7A4;_tmp7A4.tag=0U,({struct _fat_ptr _tmp835=({const char*_tmp8F="expression type ";_tag_fat(_tmp8F,sizeof(char),17U);});_tmp7A4.f1=_tmp835;});_tmp7A4;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp8C=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp7A3;_tmp7A3.tag=2U,_tmp7A3.f1=(void*)t;_tmp7A3;});struct Cyc_Warn_String_Warn_Warg_struct _tmp8D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7A2;_tmp7A2.tag=0U,({struct _fat_ptr _tmp836=({const char*_tmp8E=" (not int, float, double, or pointer)";_tag_fat(_tmp8E,sizeof(char),38U);});_tmp7A2.f1=_tmp836;});_tmp7A2;});void*_tmp8A[3U];_tmp8A[0]=& _tmp8B,_tmp8A[1]=& _tmp8C,_tmp8A[2]=& _tmp8D;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp8A,sizeof(void*),3U));});}_LL0:;}
# 423
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp94=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7A5;_tmp7A5.tag=0U,({struct _fat_ptr _tmp837=({const char*_tmp95="impossible type (not pointer)";_tag_fat(_tmp95,sizeof(char),30U);});_tmp7A5.f1=_tmp837;});_tmp7A5;});void*_tmp93[1U];_tmp93[0]=& _tmp94;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp93,sizeof(void*),1U));});}_LL0:;}
# 433
...
# 476
if(vs == 0)
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpAD=({struct Cyc_String_pa_PrintArg_struct _tmp7A7;_tmp7A7.tag=0U,_tmp7A7.f1=(struct _fat_ptr)((struct _fat_ptr)*s);_tmp7A7;});struct Cyc_String_pa_PrintArg_struct _tmpAE=({struct Cyc_String_pa_PrintArg_struct _tmp7A6;_tmp7A6.tag=0U,_tmp7A6.f1=(struct _fat_ptr)((struct _fat_ptr)*v);_tmp7A6;});void*_tmpAB[2U];_tmpAB[0]=& _tmpAD,_tmpAB[1]=& _tmpAE;({struct _fat_ptr _tmp838=({const char*_tmpAC="%s_%s_struct";_tag_fat(_tmpAC,sizeof(char),13U);});Cyc_aprintf(_tmp838,_tag_fat(_tmpAB,sizeof(void*),2U));});});{
struct _RegionHandle _tmpAF=_new_region("r");struct _RegionHandle*r=& _tmpAF;_push_region(r);
{struct _fat_ptr _tmpB6=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpB2=({struct Cyc_String_pa_PrintArg_struct _tmp7AA;_tmp7AA.tag=0U,_tmp7AA.f1=(struct _fat_ptr)((struct _fat_ptr)*s);_tmp7AA;});struct Cyc_String_pa_PrintArg_struct _tmpB3=({struct Cyc_String_pa_PrintArg_struct _tmp7A9;_tmp7A9.tag=0U,({struct _fat_ptr _tmp83B=(struct _fat_ptr)((struct _fat_ptr)({struct _RegionHandle*_tmp83A=r;struct Cyc_List_List*_tmp839=vs;Cyc_rstr_sepstr(_tmp83A,_tmp839,({const char*_tmpB5="_";_tag_fat(_tmpB5,sizeof(char),2U);}));}));_tmp7A9.f1=_tmp83B;});_tmp7A9;});struct Cyc_String_pa_PrintArg_struct _tmpB4=({struct Cyc_String_pa_PrintArg_struct _tmp7A8;_tmp7A8.tag=0U,_tmp7A8.f1=(struct _fat_ptr)((struct _fat_ptr)*v);_tmp7A8;});void*_tmpB0[3U];_tmpB0[0]=& _tmpB2,_tmpB0[1]=& _tmpB3,_tmpB0[2]=& _tmpB4;({struct _fat_ptr _tmp83C=({const char*_tmpB1="%s_%s_%s_struct";_tag_fat(_tmpB1,sizeof(char),16U);});Cyc_aprintf(_tmp83C,_tag_fat(_tmpB0,sizeof(void*),3U));});});_npop_handler(0U);return _tmpB6;};_pop_region();}}}_LL3:;}}struct _tuple20{struct Cyc_Toc_TocState*f1;struct _tuple14*f2;};
# 489
...
struct _tuple1*res=({struct _tuple1*_tmpCA=_cycalloc(sizeof(*_tmpCA));_tmpCA->f1=nmspace,({struct _fat_ptr*_tmp83D=({struct _fat_ptr*_tmpC9=_cycalloc(sizeof(*_tmpC9));*_tmpC9=newvar;_tmpC9;});_tmpCA->f2=_tmp83D;});_tmpCA;});
({struct Cyc_Dict_Dict _tmp83E=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple14*k,struct _tuple1*v))Cyc_Dict_insert)(*qvs,new_pair,res);*qvs=_tmp83E;});
...
# 514
struct _tuple1*_tmp841=({struct _tuple1*_tmpCC=_cycalloc(sizeof(*_tmpCC));({union Cyc_Absyn_Nmspace _tmp840=Cyc_Absyn_Rel_n(0);_tmpCC->f1=_tmp840;}),_tmpCC->f2=name;_tmpCC;});_tmpCE->name=_tmp841;}),({
struct Cyc_Absyn_AggrdeclImpl*_tmp83F=({struct Cyc_Absyn_AggrdeclImpl*_tmpCD=_cycalloc(sizeof(*_tmpCD));_tmpCD->exist_vars=0,_tmpCD->rgn_po=0,_tmpCD->fields=fs,_tmpCD->tagged=0;_tmpCD;});_tmpCE->impl=_tmp83F;});_tmpCE;});}struct _tuple21{struct Cyc_Toc_TocState*f1;struct Cyc_List_List*f2;};struct _tuple22{void*f1;struct Cyc_List_List*f2;};struct _tuple23{struct Cyc_Absyn_Tqual f1;void*f2;};
# 520
...
return x;}}}{
# 536
struct _fat_ptr*xname=({struct _fat_ptr*_tmpE8=_cycalloc(sizeof(*_tmpE8));({struct _fat_ptr _tmp843=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpE7=({struct Cyc_Int_pa_PrintArg_struct _tmp7AC;_tmp7AC.tag=1U,_tmp7AC.f1=(unsigned long)Cyc_Toc_tuple_type_counter ++;_tmp7AC;});void*_tmpE5[1U];_tmpE5[0]=& _tmpE7;({struct _fat_ptr _tmp842=({const char*_tmpE6="_tuple%d";_tag_fat(_tmpE6,sizeof(char),9U);});Cyc_aprintf(_tmp842,_tag_fat(_tmpE5,sizeof(void*),1U));});});*_tmpE8=_tmp843;});_tmpE8;});
...
fs=({struct Cyc_List_List*_tmpDC=_cycalloc(sizeof(*_tmpDC));({struct Cyc_Absyn_Aggrfield*_tmp845=({struct Cyc_Absyn_Aggrfield*_tmpDB=_cycalloc(sizeof(*_tmpDB));({struct _fat_ptr*_tmp844=Cyc_Absyn_fieldname(i);_tmpDB->name=_tmp844;}),_tmpDB->tq=Cyc_Toc_mt_tq,_tmpDB->type=t,_tmpDB->width=0,_tmpDB->attributes=0,_tmpDB->requires_clause=0;_tmpDB;});_tmpDC->hd=_tmp845;}),_tmpDC->tl=fs;_tmpDC;});
...
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmpE1=_cycalloc(sizeof(*_tmpE1));({struct Cyc_Absyn_Decl*_tmp846=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpE0=_cycalloc(sizeof(*_tmpE0));_tmpE0->tag=6U,_tmpE0->f1=sd;_tmpE0;}),0U);_tmpE1->hd=_tmp846;}),_tmpE1->tl=Cyc_Toc_result_decls;_tmpE1;});
({struct Cyc_List_List*_tmp848=({struct Cyc_List_List*_tmpE3=_region_malloc(d,sizeof(*_tmpE3));({struct _tuple22*_tmp847=({struct _tuple22*_tmpE2=_region_malloc(d,sizeof(*_tmpE2));_tmpE2->f1=ans,_tmpE2->f2=ts;_tmpE2;});_tmpE3->hd=_tmp847;}),_tmpE3->tl=*tuple_types;_tmpE3;});*tuple_types=_tmp848;});
return ans;}}}}
# 552
...
return x;}}}{
# 571
struct _fat_ptr*xname=({struct _fat_ptr*_tmpFD=_cycalloc(sizeof(*_tmpFD));({struct _fat_ptr _tmp84A=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpFC=({struct Cyc_Int_pa_PrintArg_struct _tmp7AD;_tmp7AD.tag=1U,_tmp7AD.f1=(unsigned long)Cyc_Toc_tuple_type_counter ++;_tmp7AD;});void*_tmpFA[1U];_tmpFA[0]=& _tmpFC;({struct _fat_ptr _tmp849=({const char*_tmpFB="_tuple%d";_tag_fat(_tmpFB,sizeof(char),9U);});Cyc_aprintf(_tmp849,_tag_fat(_tmpFA,sizeof(void*),1U));});});*_tmpFD=_tmp84A;});_tmpFD;});
...
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmpF6=_cycalloc(sizeof(*_tmpF6));({struct Cyc_Absyn_Decl*_tmp84B=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpF5=_cycalloc(sizeof(*_tmpF5));_tmpF5->tag=6U,_tmpF5->f1=sd;_tmpF5;}),0U);_tmpF6->hd=_tmp84B;}),_tmpF6->tl=Cyc_Toc_result_decls;_tmpF6;});
({struct Cyc_List_List*_tmp84D=({struct Cyc_List_List*_tmpF8=_region_malloc(d,sizeof(*_tmpF8));({struct _tuple26*_tmp84C=({struct _tuple26*_tmpF7=_region_malloc(d,sizeof(*_tmpF7));_tmpF7->f1=ans,_tmpF7->f2=ak,_tmpF7->f3=fs;_tmpF7;});_tmpF8->hd=_tmp84C;}),_tmpF8->tl=*anon_aggr_types;_tmpF8;});*anon_aggr_types=_tmp84D;});
return ans;}}}}
# 579
...
int _tmp84E=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(type_args);_tmp84E == ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ts2);})){
int okay=1;
...
# 614
 if(Cyc_Unify_unify(t,t2)||({void*_tmp84F=Cyc_Toc_typ_to_c(t);Cyc_Unify_unify(_tmp84F,Cyc_Toc_typ_to_c(t2));}))
continue;
okay=0;
goto _LL6;}_LL6:;}
# 619
...
return t;}}}}{
# 628
struct _fat_ptr*xname=({struct _fat_ptr*_tmp123=_cycalloc(sizeof(*_tmp123));({struct _fat_ptr _tmp851=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp122=({struct Cyc_Int_pa_PrintArg_struct _tmp7AE;_tmp7AE.tag=1U,_tmp7AE.f1=(unsigned long)Cyc_Toc_tuple_type_counter ++;_tmp7AE;});void*_tmp120[1U];_tmp120[0]=& _tmp122;({struct _fat_ptr _tmp850=({const char*_tmp121="_tuple%d";_tag_fat(_tmp121,sizeof(char),9U);});Cyc_aprintf(_tmp850,_tag_fat(_tmp120,sizeof(void*),1U));});});*_tmp123=_tmp851;});_tmp123;});
void*x=Cyc_Absyn_strct(xname);
struct Cyc_List_List*_tmp111=0;struct Cyc_List_List*fs=_tmp111;
# 632
({struct Cyc_List_List*_tmp853=({struct Cyc_List_List*_tmp113=_region_malloc(d,sizeof(*_tmp113));({struct _tuple29*_tmp852=({struct _tuple29*_tmp112=_region_malloc(d,sizeof(*_tmp112));_tmp112->f1=struct_name,_tmp112->f2=type_args,_tmp112->f3=x;_tmp112;});_tmp113->hd=_tmp852;}),_tmp113->tl=*abs_struct_types;_tmp113;});*abs_struct_types=_tmp853;});{
# 635
...
atts=({struct Cyc_List_List*_tmp118=_cycalloc(sizeof(*_tmp118));({void*_tmp854=(void*)({struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_tmp117=_cycalloc(sizeof(*_tmp117));_tmp117->tag=6U,_tmp117->f1=0;_tmp117;});_tmp118->hd=_tmp854;}),_tmp118->tl=atts;_tmp118;});
t=Cyc_Toc_typ_to_c(Cyc_Tcutil_rsubstitute(r,inst,t));
# 652
if(Cyc_Unify_unify(t,Cyc_Absyn_void_type))
t=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp119=_cycalloc(sizeof(*_tmp119));_tmp119->tag=4U,({void*_tmp857=Cyc_Toc_void_star_type();(_tmp119->f1).elt_type=_tmp857;}),({struct Cyc_Absyn_Tqual _tmp856=Cyc_Absyn_empty_tqual(0U);(_tmp119->f1).tq=_tmp856;}),({
struct Cyc_Absyn_Exp*_tmp855=Cyc_Absyn_uint_exp(0U,0U);(_tmp119->f1).num_elts=_tmp855;}),(_tmp119->f1).zero_term=Cyc_Absyn_false_type,(_tmp119->f1).zt_loc=0U;_tmp119;});
# 656
fs=({struct Cyc_List_List*_tmp11B=_cycalloc(sizeof(*_tmp11B));({struct Cyc_Absyn_Aggrfield*_tmp858=({struct Cyc_Absyn_Aggrfield*_tmp11A=_cycalloc(sizeof(*_tmp11A));_tmp11A->name=f->name,_tmp11A->tq=Cyc_Toc_mt_tq,_tmp11A->type=t,_tmp11A->width=f->width,_tmp11A->attributes=atts,_tmp11A->requires_clause=0;_tmp11A;});_tmp11B->hd=_tmp858;}),_tmp11B->tl=fs;_tmp11B;});}
# 658
fs=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(fs);{
struct Cyc_Absyn_Aggrdecl*_tmp11C=Cyc_Toc_make_c_struct_defn(xname,fs);struct Cyc_Absyn_Aggrdecl*sd=_tmp11C;
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp11E=_cycalloc(sizeof(*_tmp11E));({struct Cyc_Absyn_Decl*_tmp859=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp11D=_cycalloc(sizeof(*_tmp11D));_tmp11D->tag=6U,_tmp11D->f1=sd;_tmp11D;}),0U);_tmp11E->hd=_tmp859;}),_tmp11E->tl=Cyc_Toc_result_decls;_tmp11E;});{
...
# 676
struct _tuple1*Cyc_Toc_temp_var (void){
return({struct _tuple1*_tmp128=_cycalloc(sizeof(*_tmp128));_tmp128->f1=Cyc_Absyn_Loc_n,({struct _fat_ptr*_tmp85C=({struct _fat_ptr*_tmp127=_cycalloc(sizeof(*_tmp127));({struct _fat_ptr _tmp85B=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp126=({struct Cyc_Int_pa_PrintArg_struct _tmp7B0;_tmp7B0.tag=1U,_tmp7B0.f1=(unsigned)Cyc_Toc_temp_var_counter ++;_tmp7B0;});void*_tmp124[1U];_tmp124[0]=& _tmp126;({struct _fat_ptr _tmp85A=({const char*_tmp125="_tmp%X";_tag_fat(_tmp125,sizeof(char),7U);});Cyc_aprintf(_tmp85A,_tag_fat(_tmp124,sizeof(void*),1U));});});*_tmp127=_tmp85B;});_tmp127;});_tmp128->f2=_tmp85C;});_tmp128;});}struct _tuple30{struct _tuple1*f1;struct Cyc_Absyn_Exp*f2;};
# 679
struct _tuple30 Cyc_Toc_temp_var_and_exp (void){
struct _tuple1*v=Cyc_Toc_temp_var();
return({struct _tuple30 _tmp7B1;_tmp7B1.f1=v,({struct Cyc_Absyn_Exp*_tmp85D=Cyc_Absyn_var_exp(v,0U);_tmp7B1.f2=_tmp85D;});_tmp7B1;});}struct _tuple31{struct Cyc_Toc_TocState*f1;int f2;};
# 686
...
if(({int _tmp85E=i;_tmp85E < ((int(*)(struct Cyc_Xarray_Xarray*))Cyc_Xarray_length)(temp_labels);}))
return((struct _fat_ptr*(*)(struct Cyc_Xarray_Xarray*,int))Cyc_Xarray_get)(temp_labels,i);{
struct _fat_ptr*res=({struct _fat_ptr*_tmp133=_cycalloc(sizeof(*_tmp133));({struct _fat_ptr _tmp860=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp132=({struct Cyc_Int_pa_PrintArg_struct _tmp7B3;_tmp7B3.tag=1U,_tmp7B3.f1=(unsigned)i;_tmp7B3;});void*_tmp130[1U];_tmp130[0]=& _tmp132;({struct _fat_ptr _tmp85F=({const char*_tmp131="_LL%X";_tag_fat(_tmp131,sizeof(char),6U);});Cyc_aprintf(_tmp85F,_tag_fat(_tmp130,sizeof(void*),1U));});});*_tmp133=_tmp860;});_tmp133;});
if(({int _tmp861=((int(*)(struct Cyc_Xarray_Xarray*,struct _fat_ptr*))Cyc_Xarray_add_ind)(temp_labels,res);_tmp861 != i;}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp12E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7B2;_tmp7B2.tag=0U,({struct _fat_ptr _tmp862=({const char*_tmp12F="fresh_label: add_ind returned bad index...";_tag_fat(_tmp12F,sizeof(char),43U);});_tmp7B2.f1=_tmp862;});_tmp7B2;});void*_tmp12D[1U];_tmp12D[0]=& _tmp12E;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp12D,sizeof(void*),1U));});
return res;}}}
# 696
...
return({struct _tuple9*_tmp135=_cycalloc(sizeof(*_tmp135));_tmp135->f1=(*a).f1,_tmp135->f2=(*a).f2,({void*_tmp863=Cyc_Toc_typ_to_c((*a).f3);_tmp135->f3=_tmp863;});_tmp135;});}
# 737 "toc.cyc"
...
return({void*_tmp864=Cyc_Toc_typ_to_c_array(ai.elt_type);Cyc_Absyn_cstar_type(_tmp864,ai.tq);});}}else{_LL3: _LL4:
...
# 802
({struct Cyc_Warn_String_Warn_Warg_struct _tmp168=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7B4;_tmp7B4.tag=0U,({struct _fat_ptr _tmp865=({const char*_tmp169="unresolved DatatypeFieldType";_tag_fat(_tmp169,sizeof(char),29U);});_tmp7B4.f1=_tmp865;});_tmp7B4;});void*_tmp167[1U];_tmp167[0]=& _tmp168;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp167,sizeof(void*),1U));});}case 1U: _LLF: _LL10:
# 811
...
# 855
if(ad->impl == 0)
({struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmp17A=({struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmp7B6;_tmp7B6.tag=6U,_tmp7B6.f1=ad;_tmp7B6;});struct Cyc_Warn_String_Warn_Warg_struct _tmp17B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7B5;_tmp7B5.tag=0U,({struct _fat_ptr _tmp866=({const char*_tmp17C=" was never defined.";_tag_fat(_tmp17C,sizeof(char),20U);});_tmp7B5.f1=_tmp866;});_tmp7B5;});void*_tmp179[2U];_tmp179[0]=& _tmp17A,_tmp179[1]=& _tmp17B;Cyc_Warn_warn2(0U,_tag_fat(_tmp179,sizeof(void*),2U));});}
# 859
...
if(ad->expected_mem_kind)
({struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmp180=({struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmp7B8;_tmp7B8.tag=6U,_tmp7B8.f1=ad;_tmp7B8;});struct Cyc_Warn_String_Warn_Warg_struct _tmp181=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7B7;_tmp7B7.tag=0U,({struct _fat_ptr _tmp867=({const char*_tmp182=" ended up being abstract.";_tag_fat(_tmp182,sizeof(char),26U);});_tmp7B7.f1=_tmp867;});_tmp7B7;});void*_tmp17F[2U];_tmp17F[0]=& _tmp180,_tmp17F[1]=& _tmp181;Cyc_Warn_warn2(0U,_tag_fat(_tmp17F,sizeof(void*),2U));});{
# 871
...
new_args=({struct Cyc_List_List*_tmp86C=new_args;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp86C,({struct Cyc_List_List*_tmp16E=_cycalloc(sizeof(*_tmp16E));_tmp16E->hd=vararg,_tmp16E->tl=0;_tmp16E;}));});}
# 826
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp170=_cycalloc(sizeof(*_tmp170));_tmp170->tag=5U,(_tmp170->f1).tvars=0,(_tmp170->f1).effect=0,(_tmp170->f1).ret_tqual=tq2,({void*_tmp86D=Cyc_Toc_typ_to_c(t2);(_tmp170->f1).ret_type=_tmp86D;}),(_tmp170->f1).args=new_args,(_tmp170->f1).c_varargs=c_vararg,(_tmp170->f1).cyc_varargs=0,(_tmp170->f1).rgn_po=0,(_tmp170->f1).attributes=new_atts,(_tmp170->f1).requires_clause=0,(_tmp170->f1).requires_relns=0,(_tmp170->f1).ensures_clause=0,(_tmp170->f1).ensures_relns=0,(_tmp170->f1).return_value=0;_tmp170;});}case 6U: _LL17: _tmp150=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp143)->f1;_LL18: {struct Cyc_List_List*tqs=_tmp150;
# 831
struct Cyc_List_List*_tmp171=0;struct Cyc_List_List*tqs2=_tmp171;
for(0;tqs != 0;tqs=tqs->tl){
tqs2=({struct Cyc_List_List*_tmp173=_cycalloc(sizeof(*_tmp173));({struct _tuple23*_tmp86F=({struct _tuple23*_tmp172=_cycalloc(sizeof(*_tmp172));_tmp172->f1=(*((struct _tuple23*)tqs->hd)).f1,({void*_tmp86E=Cyc_Toc_typ_to_c((*((struct _tuple23*)tqs->hd)).f2);_tmp172->f2=_tmp86E;});_tmp172;});_tmp173->hd=_tmp86F;}),_tmp173->tl=tqs2;_tmp173;});}
...
for(0;fs != 0;fs=fs->tl){
fs2=({struct Cyc_List_List*_tmp175=_cycalloc(sizeof(*_tmp175));({struct Cyc_Absyn_Aggrfield*_tmp871=({struct Cyc_Absyn_Aggrfield*_tmp870=(struct Cyc_Absyn_Aggrfield*)fs->hd;Cyc_Toc_aggrfield_to_c(_tmp870,Cyc_Toc_typ_to_c(((struct Cyc_Absyn_Aggrfield*)fs->hd)->type));});_tmp175->hd=_tmp871;}),_tmp175->tl=fs2;_tmp175;});}
return({enum Cyc_Absyn_AggrKind _tmp872=k;Cyc_Toc_add_anon_aggr_type(_tmp872,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(fs2));});}case 8U: _LL21: _tmp14A=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp143)->f1;_tmp14B=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp143)->f2;_tmp14C=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp143)->f3;_tmp14D=(void*)((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp143)->f4;_LL22: {struct _tuple1*tdn=_tmp14A;struct Cyc_List_List*ts=_tmp14B;struct Cyc_Absyn_Typedefdecl*td=_tmp14C;void*topt=_tmp14D;
# 883
if(topt == 0){
if(ts != 0)
...
return t;}}else{
# 888
return(void*)({struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmp189=_cycalloc(sizeof(*_tmp189));_tmp189->tag=8U,_tmp189->f1=tdn,_tmp189->f2=0,_tmp189->f3=td,({void*_tmp873=Cyc_Toc_typ_to_c(topt);_tmp189->f4=_tmp873;});_tmp189;});}}case 9U: _LL2B: _tmp149=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp143)->f1;_LL2C: {struct Cyc_Absyn_Exp*e=_tmp149;
# 899
...
# 925
return({void*_tmp874=Cyc_Absyn_star_type(t2,Cyc_Absyn_heap_rgn_type,tq,Cyc_Absyn_false_type,Cyc_Absyn_false_type);Cyc_Toc_cast_it(_tmp874,e);});}}else{_LL3: _LL4:
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp19D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7BA;_tmp7BA.tag=0U,({struct _fat_ptr _tmp875=({const char*_tmp19F="atomic_typ: bad type ";_tag_fat(_tmp19F,sizeof(char),22U);});_tmp7BA.f1=_tmp875;});_tmp7BA;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp19E=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp7B9;_tmp7B9.tag=2U,_tmp7B9.f1=(void*)t;_tmp7B9;});void*_tmp19C[2U];_tmp19C[0]=& _tmp19D,_tmp19C[1]=& _tmp19E;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp19C,sizeof(void*),2U));});}_LL11:;}case 5U: _LL5: _LL6:
# 959
...
if(ad->impl == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1AA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7BD;_tmp7BD.tag=0U,({struct _fat_ptr _tmp877=({const char*_tmp1AB="is_poly_field: type missing fields";_tag_fat(_tmp1AB,sizeof(char),35U);});_tmp7BD.f1=_tmp877;});_tmp7BD;});void*_tmp1A9[1U];_tmp1A9[0]=& _tmp1AA;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp1A9,sizeof(void*),1U));});
...
if(field == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1AE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7BF;_tmp7BF.tag=0U,({struct _fat_ptr _tmp878=({const char*_tmp1B0="is_poly_field: bad field ";_tag_fat(_tmp1B0,sizeof(char),26U);});_tmp7BF.f1=_tmp878;});_tmp7BF;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1AF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7BE;_tmp7BE.tag=0U,_tmp7BE.f1=*f;_tmp7BE;});void*_tmp1AD[2U];_tmp1AD[0]=& _tmp1AE,_tmp1AD[1]=& _tmp1AF;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp1AD,sizeof(void*),2U));});
return Cyc_Toc_is_void_star_or_boxed_tvar(field->type);}default: _LL5: _LL6:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1B2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C1;_tmp7C1.tag=0U,({struct _fat_ptr _tmp879=({const char*_tmp1B4="is_poly_field: bad type ";_tag_fat(_tmp1B4,sizeof(char),25U);});_tmp7C1.f1=_tmp879;});_tmp7C1;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1B3=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp7C0;_tmp7C0.tag=2U,_tmp7C0.f1=(void*)t;_tmp7C0;});void*_tmp1B1[2U];_tmp1B1[0]=& _tmp1B2,_tmp1B1[1]=& _tmp1B3;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp1B1,sizeof(void*),2U));});}_LL0:;}
# 1001
...
return({struct Cyc_Absyn_Exp*_tmp1C3[2U];_tmp1C3[0]=s,_tmp1C3[1]=n;({struct Cyc_Absyn_Exp*_tmp87C=fn_e;Cyc_Toc_fncall_exp_dl(_tmp87C,_tag_fat(_tmp1C3,sizeof(struct Cyc_Absyn_Exp*),2U));});});}
# 1027
static struct Cyc_Absyn_Exp*Cyc_Toc_rmalloc_exp(struct Cyc_Absyn_Exp*rgn,struct Cyc_Absyn_Exp*s){
return({struct Cyc_Absyn_Exp*_tmp1C4[2U];_tmp1C4[0]=rgn,_tmp1C4[1]=s;({struct Cyc_Absyn_Exp*_tmp87D=Cyc_Toc__region_malloc_e;Cyc_Toc_fncall_exp_dl(_tmp87D,_tag_fat(_tmp1C4,sizeof(struct Cyc_Absyn_Exp*),2U));});});}
# 1031
static struct Cyc_Absyn_Exp*Cyc_Toc_rmalloc_inline_exp(struct Cyc_Absyn_Exp*rgn,struct Cyc_Absyn_Exp*s){
return({struct Cyc_Absyn_Exp*_tmp1C5[2U];_tmp1C5[0]=rgn,_tmp1C5[1]=s;({struct Cyc_Absyn_Exp*_tmp87E=Cyc_Toc__fast_region_malloc_e;Cyc_Toc_fncall_exp_dl(_tmp87E,_tag_fat(_tmp1C5,sizeof(struct Cyc_Absyn_Exp*),2U));});});}
# 1035
static struct Cyc_Absyn_Exp*Cyc_Toc_rcalloc_exp(struct Cyc_Absyn_Exp*rgn,struct Cyc_Absyn_Exp*s,struct Cyc_Absyn_Exp*n){
return({struct Cyc_Absyn_Exp*_tmp1C6[3U];_tmp1C6[0]=rgn,_tmp1C6[1]=s,_tmp1C6[2]=n;({struct Cyc_Absyn_Exp*_tmp87F=Cyc_Toc__region_calloc_e;Cyc_Toc_fncall_exp_dl(_tmp87F,_tag_fat(_tmp1C6,sizeof(struct Cyc_Absyn_Exp*),3U));});});}
# 1039
static struct Cyc_Absyn_Stmt*Cyc_Toc_throw_match_stmt (void){
return Cyc_Absyn_exp_stmt(({void*_tmp1C7=0U;({struct Cyc_Absyn_Exp*_tmp880=Cyc_Toc__throw_match_e;Cyc_Toc_fncall_exp_dl(_tmp880,_tag_fat(_tmp1C7,sizeof(struct Cyc_Absyn_Exp*),0U));});}),0U);}
# 1044
...
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp1CB=_cycalloc(sizeof(*_tmp1CB));({struct Cyc_Absyn_Decl*_tmp881=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp1CA=_cycalloc(sizeof(*_tmp1CA));_tmp1CA->tag=0U,_tmp1CA->f1=vd;_tmp1CA;}),0U);_tmp1CB->hd=_tmp881;}),_tmp1CB->tl=Cyc_Toc_result_decls;_tmp1CB;});
xexp=Cyc_Absyn_var_exp(x,0U);
xplussz=Cyc_Absyn_add_exp(xexp,sz,0U);
goto _LL0;}default: goto _LL5;}else{_LL5: _LL6:
# 1065
 xexp=({void*_tmp882=Cyc_Toc_void_star_type();Cyc_Toc_cast_it(_tmp882,e);});
# 1067
xplussz=({void*_tmp883=Cyc_Toc_void_star_type();Cyc_Toc_cast_it(_tmp883,Cyc_Absyn_add_exp(e,sz,0U));});
goto _LL0;}_LL0:;}
# 1070
return Cyc_Absyn_unresolvedmem_exp(0,({struct _tuple19*_tmp1CC[3U];({struct _tuple19*_tmp886=({struct _tuple19*_tmp1CD=_cycalloc(sizeof(*_tmp1CD));_tmp1CD->f1=0,_tmp1CD->f2=xexp;_tmp1CD;});_tmp1CC[0]=_tmp886;}),({
struct _tuple19*_tmp885=({struct _tuple19*_tmp1CE=_cycalloc(sizeof(*_tmp1CE));_tmp1CE->f1=0,_tmp1CE->f2=xexp;_tmp1CE;});_tmp1CC[1]=_tmp885;}),({
struct _tuple19*_tmp884=({struct _tuple19*_tmp1CF=_cycalloc(sizeof(*_tmp1CF));_tmp1CF->f1=0,_tmp1CF->f2=xplussz;_tmp1CF;});_tmp1CC[2]=_tmp884;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1CC,sizeof(struct _tuple19*),3U));}),0U);}struct Cyc_Toc_FallthruInfo{struct _fat_ptr*label;struct Cyc_List_List*binders;};struct Cyc_Toc_Env{struct _fat_ptr**break_lab;struct _fat_ptr**continue_lab;struct Cyc_Toc_FallthruInfo*fallthru_info;int toplevel;int*in_lhs;struct _RegionHandle*rgn;};
# 1105 "toc.cyc"
static struct Cyc_Toc_Env*Cyc_Toc_empty_env(struct _RegionHandle*r){
return({struct Cyc_Toc_Env*_tmp1D1=_region_malloc(r,sizeof(*_tmp1D1));_tmp1D1->break_lab=0,_tmp1D1->continue_lab=0,_tmp1D1->fallthru_info=0,_tmp1D1->toplevel=1,({int*_tmp887=({int*_tmp1D0=_region_malloc(r,sizeof(*_tmp1D0));*_tmp1D0=0;_tmp1D0;});_tmp1D1->in_lhs=_tmp887;}),_tmp1D1->rgn=r;_tmp1D1;});}
# 1109
...
return({struct Cyc_Toc_Env*_tmp1FB=_region_malloc(r,sizeof(*_tmp1FB));({struct _fat_ptr**_tmp888=({struct _fat_ptr**_tmp1FA=_region_malloc(r,sizeof(*_tmp1FA));*_tmp1FA=break_l;_tmp1FA;});_tmp1FB->break_lab=_tmp888;}),_tmp1FB->continue_lab=c,_tmp1FB->fallthru_info=fi,_tmp1FB->toplevel=t,_tmp1FB->in_lhs=lhs,_tmp1FB->rgn=r;_tmp1FB;});}}
# 1152
...
return({struct Cyc_Toc_Env*_tmp204=_region_malloc(r,sizeof(*_tmp204));({struct _fat_ptr**_tmp889=({struct _fat_ptr**_tmp203=_region_malloc(r,sizeof(*_tmp203));*_tmp203=break_l;_tmp203;});_tmp204->break_lab=_tmp889;}),_tmp204->continue_lab=c,_tmp204->fallthru_info=0,_tmp204->toplevel=t,_tmp204->in_lhs=lhs,_tmp204->rgn=r;_tmp204;});}}
# 1161
...
return({struct Cyc_Toc_Env*_tmp20C=_region_malloc(r,sizeof(*_tmp20C));_tmp20C->break_lab=0,_tmp20C->continue_lab=c,({struct Cyc_Toc_FallthruInfo*_tmp88A=({struct Cyc_Toc_FallthruInfo*_tmp20B=_region_malloc(r,sizeof(*_tmp20B));_tmp20B->label=next_l,_tmp20B->binders=0;_tmp20B;});_tmp20C->fallthru_info=_tmp88A;}),_tmp20C->toplevel=t,_tmp20C->in_lhs=lhs,_tmp20C->rgn=r;_tmp20C;});}}
# 1176 "toc.cyc"
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp216=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C4;_tmp7C4.tag=0U,({struct _fat_ptr _tmp88B=({const char*_tmp217="Toc: do_null_check";_tag_fat(_tmp217,sizeof(char),19U);});_tmp7C4.f1=_tmp88B;});_tmp7C4;});void*_tmp215[1U];_tmp215[0]=& _tmp216;({unsigned _tmp88C=e->loc;((int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2)(_tmp88C,_tag_fat(_tmp215,sizeof(void*),1U));});});}}}}}}_LL0:;}
# 1211
...
# 1226
 if(!((unsigned)({void*_tmp88D=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp88D,b);}))){
# 1229
void*_tmp223=({void*_tmp88E=Cyc_Toc_typ_to_c(ta);Cyc_Absyn_cstar_type(_tmp88E,tq);});void*newt=_tmp223;
({void*_tmp891=({void*_tmp890=newt;Cyc_Toc_cast_it_r(_tmp890,({struct Cyc_Absyn_Exp*_tmp88F=Cyc_Absyn_new_exp(ptr->r,0U);Cyc_Toc_member_exp(_tmp88F,Cyc_Toc_curr_sp,0U);}));});ptr->r=_tmp891;});
ptr->topt=newt;}
# 1233
ans=0;
...
# 1236
 if(!((unsigned)({void*_tmp892=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp892,b);}))){
# 1238
void*_tmp224=({void*_tmp893=Cyc_Toc_typ_to_c(ta);Cyc_Absyn_cstar_type(_tmp893,tq);});void*newt=_tmp224;
({void*_tmp896=({void*_tmp895=newt;Cyc_Toc_cast_it_r(_tmp895,({struct Cyc_Absyn_Exp*_tmp894=Cyc_Absyn_new_exp(ptr->r,0U);Cyc_Toc_member_exp(_tmp894,Cyc_Toc_curr_sp,0U);}));});ptr->r=_tmp896;});
ptr->topt=newt;
# 1245
if(index != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp226=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C5;_tmp7C5.tag=0U,({struct _fat_ptr _tmp897=({const char*_tmp227="subscript of ? with no bounds check but need null check";_tag_fat(_tmp227,sizeof(char),56U);});_tmp7C5.f1=_tmp897;});_tmp7C5;});void*_tmp225[1U];_tmp225[0]=& _tmp226;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp225,sizeof(void*),1U));});}
# 1249
({void*_tmp89B=({void*_tmp89A=new_typ;Cyc_Toc_cast_it_r(_tmp89A,({struct Cyc_Absyn_Exp*_tmp228[1U];({struct Cyc_Absyn_Exp*_tmp898=Cyc_Absyn_new_exp(ptr->r,0U);_tmp228[0]=_tmp898;});({struct Cyc_Absyn_Exp*_tmp899=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_dl(_tmp899,_tag_fat(_tmp228,sizeof(struct Cyc_Absyn_Exp*),1U));});}));});ptr->r=_tmp89B;});
ans=0;
...
({void*_tmp8A0=({void*_tmp89F=newt;Cyc_Toc_cast_it_r(_tmp89F,({struct Cyc_Absyn_Exp*_tmp229[3U];({
struct Cyc_Absyn_Exp*_tmp89D=Cyc_Absyn_new_exp(ptr->r,0U);_tmp229[0]=_tmp89D;}),({
struct Cyc_Absyn_Exp*_tmp89C=Cyc_Absyn_sizeoftype_exp(ta1,0U);_tmp229[1]=_tmp89C;}),_tmp229[2]=ind;({struct Cyc_Absyn_Exp*_tmp89E=Cyc_Toc__check_fat_subscript_e;Cyc_Toc_fncall_exp_dl(_tmp89E,_tag_fat(_tmp229,sizeof(struct Cyc_Absyn_Exp*),3U));});}));});
# 1258
ptr->r=_tmp8A0;});
# 1262
ptr->topt=newt;
...
# 1277
({void*_tmp8A5=({void*_tmp8A4=Cyc_Absyn_cstar_type(ta1,tq);Cyc_Toc_cast_it_r(_tmp8A4,({struct Cyc_Absyn_Exp*_tmp22E[4U];({
struct Cyc_Absyn_Exp*_tmp8A2=Cyc_Absyn_new_exp(ptr->r,0U);_tmp22E[0]=_tmp8A2;}),_tmp22E[1]=bd,({
struct Cyc_Absyn_Exp*_tmp8A1=Cyc_Absyn_sizeoftype_exp(ta1,0U);_tmp22E[2]=_tmp8A1;}),_tmp22E[3]=ind;({struct Cyc_Absyn_Exp*_tmp8A3=fn_e;Cyc_Toc_fncall_exp_dl(_tmp8A3,_tag_fat(_tmp22E,sizeof(struct Cyc_Absyn_Exp*),4U));});}));});
# 1277
ptr->r=_tmp8A5;});
# 1280
ans=1;}else{
...
# 1286
({void*_tmp8A9=({void*_tmp8A8=new_typ;Cyc_Toc_cast_it_r(_tmp8A8,({struct Cyc_Absyn_Exp*_tmp22F[1U];({struct Cyc_Absyn_Exp*_tmp8A6=
Cyc_Absyn_new_exp(ptr->r,0U);_tmp22F[0]=_tmp8A6;});({struct Cyc_Absyn_Exp*_tmp8A7=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_dl(_tmp8A7,_tag_fat(_tmp22F,sizeof(struct Cyc_Absyn_Exp*),1U));});}));});
# 1286
ptr->r=_tmp8A9;});
# 1288
ans=0;}else{
...
({void*_tmp8AD=({void*_tmp8AC=Cyc_Absyn_cstar_type(ta1,tq);Cyc_Toc_cast_it_r(_tmp8AC,({struct Cyc_Absyn_Exp*_tmp230[3U];({
struct Cyc_Absyn_Exp*_tmp8AA=Cyc_Absyn_new_exp(ptr->r,0U);_tmp230[0]=_tmp8AA;}),_tmp230[1]=bd,_tmp230[2]=ind;({struct Cyc_Absyn_Exp*_tmp8AB=fn_e;Cyc_Toc_fncall_exp_dl(_tmp8AB,_tag_fat(_tmp230,sizeof(struct Cyc_Absyn_Exp*),3U));});}));});
# 1293
ptr->r=_tmp8AD;});
# 1295
ans=1;}}
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp232=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C6;_tmp7C6.tag=0U,({struct _fat_ptr _tmp8AE=({const char*_tmp233="FIX: ptr_use_to_c, bad annotation";_tag_fat(_tmp233,sizeof(char),34U);});_tmp7C6.f1=_tmp8AE;});_tmp7C6;});void*_tmp231[1U];_tmp231[0]=& _tmp232;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp231,sizeof(void*),1U));});}}}}}}_LL5:;}
# 1301
Cyc_Toc_set_lhs(nv,old_lhs);
return ans;}}else{_LL3: _LL4:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp235=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C7;_tmp7C7.tag=0U,({struct _fat_ptr _tmp8AF=({const char*_tmp236="ptr_use_to_c: non-pointer-type";_tag_fat(_tmp236,sizeof(char),31U);});_tmp7C7.f1=_tmp8AF;});_tmp7C7;});void*_tmp234[1U];_tmp234[0]=& _tmp235;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp234,sizeof(void*),1U));});}_LL0:;}}
# 1307
static void*Cyc_Toc_get_cyc_type(struct Cyc_Absyn_Exp*e){
if(e->topt == 0)({struct Cyc_Warn_String_Warn_Warg_struct _tmp238=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C8;_tmp7C8.tag=0U,({struct _fat_ptr _tmp8B0=({const char*_tmp239="Missing type in primop ";_tag_fat(_tmp239,sizeof(char),24U);});_tmp7C8.f1=_tmp8B0;});_tmp7C8;});void*_tmp237[1U];_tmp237[0]=& _tmp238;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp237,sizeof(void*),1U));});
return(void*)_check_null(e->topt);}
# 1311
static struct _tuple23*Cyc_Toc_tup_to_c(struct Cyc_Absyn_Exp*e){
return({struct _tuple23*_tmp23A=_cycalloc(sizeof(*_tmp23A));_tmp23A->f1=Cyc_Toc_mt_tq,({void*_tmp8B1=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));_tmp23A->f2=_tmp8B1;});_tmp23A;});}
# 1316
...
return zt?({struct Cyc_Absyn_Exp*_tmp8B2=bd;Cyc_Absyn_add_exp(_tmp8B2,Cyc_Absyn_uint_exp(1U,0U),0U);}): bd;}default: _LL7: _LL8:
 return 0;}_LL0:;}
# 1334
...
return 0;
# 1381
return({struct Cyc_Absyn_Exp*_tmp8B5=({struct Cyc_Absyn_Exp*_tmp255[2U];_tmp255[0]=(struct Cyc_Absyn_Exp*)_check_null(Cyc_Toc_array_length_exp(e2)),({
# 1383
struct Cyc_Absyn_Exp*_tmp8B3=Cyc_Absyn_sizeoftype_exp(elt_type,0U);_tmp255[1]=_tmp8B3;});({struct Cyc_Absyn_Exp*_tmp8B4=Cyc_Toc__check_times_e;Cyc_Toc_fncall_exp_dl(_tmp8B4,_tag_fat(_tmp255,sizeof(struct Cyc_Absyn_Exp*),2U));});});
# 1381
Cyc_Absyn_add_exp(_tmp8B5,
# 1384
Cyc_Absyn_signed_int_exp((int)sizeof(double),0U),0U);});}}else{_LL10: _LL11:
 return 0;}_LLD:;}}}}
# 1389
({struct Cyc_Warn_String_Warn_Warg_struct _tmp257=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7C9;_tmp7C9.tag=0U,({struct _fat_ptr _tmp8B6=({const char*_tmp258="get_varsizeexp: did not find last struct field";_tag_fat(_tmp258,sizeof(char),47U);});_tmp7C9.f1=_tmp8B6;});_tmp7C9;});void*_tmp256[1U];_tmp256[0]=& _tmp257;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp256,sizeof(void*),1U));});}}
# 1392
...
++ i;}}
# 1399
({struct Cyc_Warn_String_Warn_Warg_struct _tmp25C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7CC;_tmp7CC.tag=0U,({struct _fat_ptr _tmp8B7=({const char*_tmp260="get_member_offset ";_tag_fat(_tmp260,sizeof(char),19U);});_tmp7CC.f1=_tmp8B7;});_tmp7CC;});struct Cyc_Warn_String_Warn_Warg_struct _tmp25D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7CB;_tmp7CB.tag=0U,_tmp7CB.f1=*f;_tmp7CB;});struct Cyc_Warn_String_Warn_Warg_struct _tmp25E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7CA;_tmp7CA.tag=0U,({struct _fat_ptr _tmp8B8=({const char*_tmp25F=" failed";_tag_fat(_tmp25F,sizeof(char),8U);});_tmp7CA.f1=_tmp8B8;});_tmp7CA;});void*_tmp25B[3U];_tmp25B[0]=& _tmp25C,_tmp25B[1]=& _tmp25D,_tmp25B[2]=& _tmp25E;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp25B,sizeof(void*),3U));});}struct _tuple33{struct Cyc_Core_Opt*f1;struct Cyc_Absyn_Exp*f2;};
# 1403
...
# 1429
e1->r=e->r;
({struct Cyc_Absyn_Exp*_tmp8BB=e1;struct Cyc_List_List*_tmp8BA=({struct Cyc_List_List*_tmp26B=_cycalloc(sizeof(*_tmp26B));_tmp26B->hd=fld,_tmp26B->tl=fs;_tmp26B;});struct Cyc_Absyn_Exp*(*_tmp8B9)(struct Cyc_Absyn_Exp*,void*)=f;Cyc_Toc_lvalue_assign(_tmp8BB,_tmp8BA,_tmp8B9,f_env);});
...
({void*_tmp8BC=(f(e1_copy,f_env))->r;e1->r=_tmp8BC;});
goto _LL0;}}_LL0:;}
# 1445
static void Cyc_Toc_lvalue_assign_stmt(struct Cyc_Absyn_Stmt*s,struct Cyc_List_List*fs,struct Cyc_Absyn_Exp*(*f)(struct Cyc_Absyn_Exp*,void*),void*f_env){
# 1447
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp273=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7CE;_tmp7CE.tag=0U,({struct _fat_ptr _tmp8BD=({const char*_tmp275="lvalue_assign_stmt: ";_tag_fat(_tmp275,sizeof(char),21U);});_tmp7CE.f1=_tmp8BD;});_tmp7CE;});struct Cyc_Warn_Stmt_Warn_Warg_struct _tmp274=({struct Cyc_Warn_Stmt_Warn_Warg_struct _tmp7CD;_tmp7CD.tag=5U,_tmp7CD.f1=s;_tmp7CD;});void*_tmp272[2U];_tmp272[0]=& _tmp273,_tmp272[1]=& _tmp274;Cyc_Toc_toc_impos2(_tag_fat(_tmp272,sizeof(void*),2U));});}_LL0:;}
# 1456
...
# 1463
({struct Cyc_Absyn_Exp*_tmp8BE=Cyc_Toc_push_address_exp(*e1);*e1=_tmp8BE;});
({void*_tmp8BF=Cyc_Absyn_cstar_type(*t,Cyc_Toc_mt_tq);*t=_tmp8BF;});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp27D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D0;_tmp7D0.tag=0U,({struct _fat_ptr _tmp8C0=({const char*_tmp27F="can't take & of exp ";_tag_fat(_tmp27F,sizeof(char),21U);});_tmp7D0.f1=_tmp8C0;});_tmp7D0;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp27E=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp7CF;_tmp7CF.tag=4U,_tmp7CF.f1=e;_tmp7CF;});void*_tmp27C[2U];_tmp27C[0]=& _tmp27D,_tmp27C[1]=& _tmp27E;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp27C,sizeof(void*),2U));});}_LL0:;}
# 1478
static void Cyc_Toc_push_address_stmt(struct Cyc_Absyn_Stmt*s){
...
({struct Cyc_Absyn_Exp*_tmp8C1=Cyc_Toc_push_address_exp(*e);*e=_tmp8C1;});goto _LL0;}default: _LL7: _LL8:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp286=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D2;_tmp7D2.tag=0U,({struct _fat_ptr _tmp8C2=({const char*_tmp288="can't take & of stmt ";_tag_fat(_tmp288,sizeof(char),22U);});_tmp7D2.f1=_tmp8C2;});_tmp7D2;});struct Cyc_Warn_Stmt_Warn_Warg_struct _tmp287=({struct Cyc_Warn_Stmt_Warn_Warg_struct _tmp7D1;_tmp7D1.tag=5U,_tmp7D1.f1=s;_tmp7D1;});void*_tmp285[2U];_tmp285[0]=& _tmp286,_tmp285[1]=& _tmp287;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp285,sizeof(void*),2U));});}_LL0:;}
# 1490
...
struct Cyc_Absyn_Exp*_tmp8C3=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp292[1]=_tmp8C3;}),_tmp292[2]=eb;({struct Cyc_Absyn_Exp*_tmp8C4=Cyc_Toc__fat_ptr_plus_e;Cyc_Toc_fncall_exp_dl(_tmp8C4,_tag_fat(_tmp292,sizeof(struct Cyc_Absyn_Exp*),3U));});});
goto _LL0;}default: _LL5: _LL6:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp294=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D3;_tmp7D3.tag=0U,({struct _fat_ptr _tmp8C5=({const char*_tmp295="found bad lhs for zero-terminated pointer assignment";_tag_fat(_tmp295,sizeof(char),53U);});_tmp7D3.f1=_tmp8C5;});_tmp7D3;});void*_tmp293[1U];_tmp293[0]=& _tmp294;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp293,sizeof(void*),1U));});}_LL0:;}{
# 1528
...
z_init=({enum Cyc_Absyn_Primop _tmp8C7=(enum Cyc_Absyn_Primop)popt->v;struct Cyc_Absyn_Exp*_tmp8C6=y_exp;Cyc_Absyn_prim2_exp(_tmp8C7,_tmp8C6,Cyc_Absyn_copy_exp(e2),0U);});
...
# 1569
struct Cyc_List_List*_tmp2A9=({struct Cyc_Absyn_Exp*_tmp2B8[2U];({struct Cyc_Absyn_Exp*_tmp8C9=Cyc_Absyn_varb_exp((void*)x_bnd,0U);_tmp2B8[0]=_tmp8C9;}),({
struct Cyc_Absyn_Exp*_tmp8C8=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp2B8[1]=_tmp8C8;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp2B8,sizeof(struct Cyc_Absyn_Exp*),2U));});
# 1569
...
xsize=({struct Cyc_Absyn_Exp*_tmp8CA=Cyc_Absyn_fncall_exp(Cyc_Toc__get_fat_size_e,xsizeargs,0U);Cyc_Absyn_prim2_exp(Cyc_Absyn_Eq,_tmp8CA,oneexp,0U);});{
# 1576
struct Cyc_Absyn_Exp*_tmp2AB=({struct Cyc_Absyn_Exp*_tmp8CB=xsize;Cyc_Absyn_and_exp(_tmp8CB,Cyc_Absyn_and_exp(comp1_exp,comp2_exp,0U),0U);});struct Cyc_Absyn_Exp*comp_exp=_tmp2AB;
struct Cyc_Absyn_Stmt*_tmp2AC=Cyc_Absyn_exp_stmt(({void*_tmp2B7=0U;({struct Cyc_Absyn_Exp*_tmp8CC=Cyc_Toc__throw_arraybounds_e;Cyc_Toc_fncall_exp_dl(_tmp8CC,_tag_fat(_tmp2B7,sizeof(struct Cyc_Absyn_Exp*),0U));});}),0U);struct Cyc_Absyn_Stmt*thr_stmt=_tmp2AC;
struct Cyc_Absyn_Exp*_tmp2AD=({struct Cyc_Absyn_Exp*_tmp8CD=Cyc_Absyn_varb_exp((void*)x_bnd,0U);Cyc_Toc_member_exp(_tmp8CD,Cyc_Toc_curr_sp,0U);});struct Cyc_Absyn_Exp*xcurr=_tmp2AD;
...
struct Cyc_Absyn_Exp*_tmp2AF=({struct Cyc_Absyn_Exp*_tmp8CE=deref_xcurr;Cyc_Absyn_assign_exp(_tmp8CE,Cyc_Absyn_var_exp(z,0U),0U);});struct Cyc_Absyn_Exp*asn_exp=_tmp2AF;
struct Cyc_Absyn_Stmt*_tmp2B0=Cyc_Absyn_exp_stmt(asn_exp,0U);struct Cyc_Absyn_Stmt*s=_tmp2B0;
s=({struct Cyc_Absyn_Stmt*_tmp8D1=({struct Cyc_Absyn_Exp*_tmp8D0=comp_exp;struct Cyc_Absyn_Stmt*_tmp8CF=thr_stmt;Cyc_Absyn_ifthenelse_stmt(_tmp8D0,_tmp8CF,Cyc_Absyn_skip_stmt(0U),0U);});Cyc_Absyn_seq_stmt(_tmp8D1,s,0U);});
s=({struct Cyc_Absyn_Decl*_tmp8D3=({struct Cyc_Absyn_Decl*_tmp2B2=_cycalloc(sizeof(*_tmp2B2));({void*_tmp8D2=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp2B1=_cycalloc(sizeof(*_tmp2B1));_tmp2B1->tag=0U,_tmp2B1->f1=z_vd;_tmp2B1;});_tmp2B2->r=_tmp8D2;}),_tmp2B2->loc=0U;_tmp2B2;});Cyc_Absyn_decl_stmt(_tmp8D3,s,0U);});
s=({struct Cyc_Absyn_Decl*_tmp8D5=({struct Cyc_Absyn_Decl*_tmp2B4=_cycalloc(sizeof(*_tmp2B4));({void*_tmp8D4=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp2B3=_cycalloc(sizeof(*_tmp2B3));_tmp2B3->tag=0U,_tmp2B3->f1=y_vd;_tmp2B3;});_tmp2B4->r=_tmp8D4;}),_tmp2B4->loc=0U;_tmp2B4;});Cyc_Absyn_decl_stmt(_tmp8D5,s,0U);});
s=({struct Cyc_Absyn_Decl*_tmp8D7=({struct Cyc_Absyn_Decl*_tmp2B6=_cycalloc(sizeof(*_tmp2B6));({void*_tmp8D6=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp2B5=_cycalloc(sizeof(*_tmp2B5));_tmp2B5->tag=0U,_tmp2B5->f1=x_vd;_tmp2B5;});_tmp2B6->r=_tmp8D6;}),_tmp2B6->loc=0U;_tmp2B6;});Cyc_Absyn_decl_stmt(_tmp8D7,s,0U);});
({void*_tmp8D8=Cyc_Toc_stmt_exp_r(s);e->r=_tmp8D8;});}}}}}}}}}}
# 1530
;_pop_region();}}
# 1602 "toc.cyc"
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D6;_tmp7D6.tag=0U,({struct _fat_ptr _tmp8D9=({const char*_tmp2C8="expecting union but found ";_tag_fat(_tmp2C8,sizeof(char),27U);});_tmp7D6.f1=_tmp8D9;});_tmp7D6;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2C5=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp7D5;_tmp7D5.tag=2U,_tmp7D5.f1=(void*)aggrtype;_tmp7D5;});struct Cyc_Warn_String_Warn_Warg_struct _tmp2C6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D4;_tmp7D4.tag=0U,({
struct _fat_ptr _tmp8DA=({const char*_tmp2C7=" in check_tagged_union";_tag_fat(_tmp2C7,sizeof(char),23U);});_tmp7D4.f1=_tmp8DA;});_tmp7D4;});void*_tmp2C3[3U];_tmp2C3[0]=& _tmp2C4,_tmp2C3[1]=& _tmp2C5,_tmp2C3[2]=& _tmp2C6;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp2C3,sizeof(void*),3U));});}_LL0:;}{
# 1612
...
struct Cyc_Absyn_Stmt*_tmp2D2=({struct Cyc_Absyn_Exp*_tmp8DC=test_exp;struct Cyc_Absyn_Stmt*_tmp8DB=Cyc_Toc_throw_match_stmt();Cyc_Absyn_ifthenelse_stmt(_tmp8DC,_tmp8DB,Cyc_Toc_skip_stmt_dl(),0U);});struct Cyc_Absyn_Stmt*ifs=_tmp2D2;
...
struct Cyc_Absyn_Stmt*_tmp2D5=({struct _tuple1*_tmp8DF=temp;void*_tmp8DE=e1_p_type;struct Cyc_Absyn_Exp*_tmp8DD=e1_f;Cyc_Absyn_declare_stmt(_tmp8DF,_tmp8DE,_tmp8DD,Cyc_Absyn_seq_stmt(ifs,sres,0U),0U);});struct Cyc_Absyn_Stmt*s=_tmp2D5;
return Cyc_Toc_stmt_exp_r(s);}else{
# 1625
struct Cyc_Absyn_Exp*_tmp2D6=({struct Cyc_Absyn_Exp*_tmp8E0=aggrproj(temp_exp,f,0U);Cyc_Toc_member_exp(_tmp8E0,Cyc_Toc_tag_sp,0U);});struct Cyc_Absyn_Exp*temp_f_tag=_tmp2D6;
struct Cyc_Absyn_Exp*_tmp2D7=Cyc_Absyn_neq_exp(temp_f_tag,f_tag,0U);struct Cyc_Absyn_Exp*test_exp=_tmp2D7;
struct Cyc_Absyn_Exp*_tmp2D8=({struct Cyc_Absyn_Exp*_tmp8E1=aggrproj(temp_exp,f,0U);Cyc_Toc_member_exp(_tmp8E1,Cyc_Toc_val_sp,0U);});struct Cyc_Absyn_Exp*temp_f_val=_tmp2D8;
struct Cyc_Absyn_Stmt*_tmp2D9=Cyc_Absyn_exp_stmt(temp_f_val,0U);struct Cyc_Absyn_Stmt*sres=_tmp2D9;
struct Cyc_Absyn_Stmt*_tmp2DA=({struct Cyc_Absyn_Exp*_tmp8E3=test_exp;struct Cyc_Absyn_Stmt*_tmp8E2=Cyc_Toc_throw_match_stmt();Cyc_Absyn_ifthenelse_stmt(_tmp8E3,_tmp8E2,Cyc_Toc_skip_stmt_dl(),0U);});struct Cyc_Absyn_Stmt*ifs=_tmp2DA;
struct Cyc_Absyn_Stmt*_tmp2DB=({struct _tuple1*_tmp8E6=temp;void*_tmp8E5=e1_c_type;struct Cyc_Absyn_Exp*_tmp8E4=e1;Cyc_Absyn_declare_stmt(_tmp8E6,_tmp8E5,_tmp8E4,Cyc_Absyn_seq_stmt(ifs,sres,0U),0U);});struct Cyc_Absyn_Stmt*s=_tmp2DB;
...
s2=({struct Cyc_Absyn_Exp*_tmp8EC=test_exp;struct Cyc_Absyn_Stmt*_tmp8EB=Cyc_Toc_throw_match_stmt();Cyc_Absyn_ifthenelse_stmt(_tmp8EC,_tmp8EB,Cyc_Toc_skip_stmt_dl(),0U);});}{
# 1698
struct Cyc_Absyn_Stmt*s1=({struct _tuple1*_tmp8EF=temp;void*_tmp8EE=Cyc_Absyn_cstar_type(member_type,Cyc_Toc_mt_tq);struct Cyc_Absyn_Exp*_tmp8ED=
Cyc_Toc_push_address_exp(e1);
# 1698
Cyc_Absyn_declare_stmt(_tmp8EF,_tmp8EE,_tmp8ED,
# 1700
...
static void Cyc_Toc_exp_to_c(struct Cyc_Toc_Env*nv,struct Cyc_Absyn_Exp*e){
if(e->topt == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7DB;_tmp7DB.tag=0U,({struct _fat_ptr _tmp8F0=({const char*_tmp2FC="exp_to_c: no type for ";_tag_fat(_tmp2FC,sizeof(char),23U);});_tmp7DB.f1=_tmp8F0;});_tmp7DB;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp2FB=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp7DA;_tmp7DA.tag=4U,_tmp7DA.f1=e;_tmp7DA;});void*_tmp2F9[2U];_tmp2F9[0]=& _tmp2FA,_tmp2F9[1]=& _tmp2FB;({unsigned _tmp8F1=e->loc;((int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2)(_tmp8F1,_tag_fat(_tmp2F9,sizeof(void*),2U));});});{
...
({void*_tmp8F2=(Cyc_Toc_make_toplevel_dyn_arr(old_typ,zero,zero))->r;e->r=_tmp8F2;});else{
# 1730
({void*_tmp8F4=({struct Cyc_Absyn_Exp*_tmp354[3U];_tmp354[0]=zero,_tmp354[1]=zero,_tmp354[2]=zero;({struct Cyc_Absyn_Exp*_tmp8F3=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_r(_tmp8F3,_tag_fat(_tmp354,sizeof(struct Cyc_Absyn_Exp*),3U));});});e->r=_tmp8F4;});}}else{
# 1732
e->r=(void*)& Cyc_Toc_zero_exp;}
# 1734
...
({void*_tmp8F5=(Cyc_Absyn_int_exp(Cyc_Absyn_Signed,1,0U))->r;e->r=_tmp8F5;});goto _LL7;case 41U: _LL12: _tmp352=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmp300)->f1;_LL13: {struct Cyc_Absyn_Exp*e1=_tmp352;
...
# 1749
struct Cyc_Absyn_Exp*_tmp35D=({void*_tmp8F6=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp8F6,bound);});struct Cyc_Absyn_Exp*eopt=_tmp35D;
if(eopt == 0)
# 1752
({void*_tmp8F9=({struct Cyc_Absyn_Exp*_tmp35E[2U];_tmp35E[0]=(struct Cyc_Absyn_Exp*)es->hd,({
struct Cyc_Absyn_Exp*_tmp8F7=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp35E[1]=_tmp8F7;});({struct Cyc_Absyn_Exp*_tmp8F8=Cyc_Toc__get_fat_size_e;Cyc_Toc_fncall_exp_r(_tmp8F8,_tag_fat(_tmp35E,sizeof(struct Cyc_Absyn_Exp*),2U));});});
# 1752
e->r=_tmp8F9;});else{
# 1755
...
# 1761
({void*_tmp8FB=({struct Cyc_Absyn_Exp*_tmp360[2U];_tmp360[0]=(struct Cyc_Absyn_Exp*)es->hd,_tmp360[1]=e2;({struct Cyc_Absyn_Exp*_tmp8FA=function_e;Cyc_Toc_fncall_exp_r(_tmp8FA,_tag_fat(_tmp360,sizeof(struct Cyc_Absyn_Exp*),2U));});});e->r=_tmp8FB;});}else{
if(Cyc_Tcutil_force_type2bool(0,nbl)){
if(!Cyc_Evexp_c_can_eval(e2))
({void*_tmp361=0U;({unsigned _tmp8FD=e->loc;struct _fat_ptr _tmp8FC=({const char*_tmp362="can't calculate numelts";_tag_fat(_tmp362,sizeof(char),24U);});Cyc_Tcutil_terr(_tmp8FD,_tmp8FC,_tag_fat(_tmp361,sizeof(void*),0U));});});
# 1766
({void*_tmp900=({struct Cyc_Absyn_Exp*_tmp8FF=arg;struct Cyc_Absyn_Exp*_tmp8FE=e2;Cyc_Toc_conditional_exp_r(_tmp8FF,_tmp8FE,Cyc_Absyn_uint_exp(0U,0U));});e->r=_tmp900;});}else{
# 1768
e->r=e2->r;goto _LL77;}}}
# 1771
goto _LL77;}}else{_LL7A: _LL7B:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp364=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7DD;_tmp7DD.tag=0U,({struct _fat_ptr _tmp901=({const char*_tmp366="numelts primop applied to non-pointer ";_tag_fat(_tmp366,sizeof(char),39U);});_tmp7DD.f1=_tmp901;});_tmp7DD;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp365=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp7DC;_tmp7DC.tag=2U,_tmp7DC.f1=(void*)_check_null(arg->topt);_tmp7DC;});void*_tmp363[2U];_tmp363[0]=& _tmp364,_tmp363[1]=& _tmp365;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp363,sizeof(void*),2U));});}_LL77:;}
# 1775
...
# 1784
struct Cyc_Absyn_Exp*_tmp36D=({void*_tmp902=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp902,b);});struct Cyc_Absyn_Exp*eopt=_tmp36D;
...
if(eopt == 0)
({void*_tmp905=({struct Cyc_Absyn_Exp*_tmp36E[3U];_tmp36E[0]=e1,({
struct Cyc_Absyn_Exp*_tmp903=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp36E[1]=_tmp903;}),_tmp36E[2]=e2;({struct Cyc_Absyn_Exp*_tmp904=Cyc_Toc__fat_ptr_plus_e;Cyc_Toc_fncall_exp_r(_tmp904,_tag_fat(_tmp36E,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 1788
e->r=_tmp905;});else{
# 1790
if(Cyc_Tcutil_force_type2bool(0,zt))
({void*_tmp907=({struct Cyc_Absyn_Exp*_tmp36F[3U];_tmp36F[0]=e1,_tmp36F[1]=eopt,_tmp36F[2]=e2;({struct Cyc_Absyn_Exp*_tmp906=Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__zero_arr_plus_functionSet,e1);Cyc_Toc_fncall_exp_r(_tmp906,_tag_fat(_tmp36F,sizeof(struct Cyc_Absyn_Exp*),3U));});});e->r=_tmp907;});}
...
({void*_tmp909=({struct Cyc_Absyn_Exp*_tmp908=Cyc_Absyn_new_exp(e1->r,0U);Cyc_Toc_aggrmember_exp_r(_tmp908,Cyc_Toc_curr_sp);});e1->r=_tmp909;});
({void*_tmp90B=({struct Cyc_Absyn_Exp*_tmp90A=Cyc_Absyn_new_exp(e2->r,0U);Cyc_Toc_aggrmember_exp_r(_tmp90A,Cyc_Toc_curr_sp);});e2->r=_tmp90B;});
({void*_tmp90D=({void*_tmp90C=Cyc_Absyn_cstar_type(Cyc_Absyn_uchar_type,Cyc_Toc_mt_tq);e2->topt=_tmp90C;});e1->topt=_tmp90D;});
({void*_tmp90F=({struct Cyc_Absyn_Exp*_tmp90E=Cyc_Absyn_copy_exp(e);Cyc_Absyn_divide_exp(_tmp90E,
Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U),0U);})->r;
# 1808
e->r=_tmp90F;});}else{
# 1811
({void*_tmp913=({struct Cyc_Absyn_Exp*_tmp370[3U];_tmp370[0]=e1,({
struct Cyc_Absyn_Exp*_tmp911=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_type),0U);_tmp370[1]=_tmp911;}),({
struct Cyc_Absyn_Exp*_tmp910=Cyc_Absyn_prim1_exp(Cyc_Absyn_Minus,e2,0U);_tmp370[2]=_tmp910;});({struct Cyc_Absyn_Exp*_tmp912=Cyc_Toc__fat_ptr_plus_e;Cyc_Toc_fncall_exp_r(_tmp912,_tag_fat(_tmp370,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 1811
e->r=_tmp913;});}}
# 1815
...
void*_tmp371=({void*_tmp914=Cyc_Toc_typ_to_c(elt_type);Cyc_Absyn_cstar_type(_tmp914,Cyc_Toc_mt_tq);});void*t=_tmp371;
({void*_tmp917=({void*_tmp916=t;Cyc_Toc_cast_it_r(_tmp916,({struct Cyc_Absyn_Exp*_tmp915=Cyc_Absyn_new_exp(e1->r,0U);Cyc_Toc_member_exp(_tmp915,Cyc_Toc_curr_sp,0U);}));});e1->r=_tmp917;});
e1->topt=t;}
# 1828
if(Cyc_Tcutil_is_fat_pointer_type(t2)){
void*_tmp372=({void*_tmp918=Cyc_Toc_typ_to_c(elt_type);Cyc_Absyn_cstar_type(_tmp918,Cyc_Toc_mt_tq);});void*t=_tmp372;
({void*_tmp91B=({void*_tmp91A=t;Cyc_Toc_cast_it_r(_tmp91A,({struct Cyc_Absyn_Exp*_tmp919=Cyc_Absyn_new_exp(e2->r,0U);Cyc_Toc_member_exp(_tmp919,Cyc_Toc_curr_sp,0U);}));});e2->r=_tmp91B;});
e2->topt=t;}
# 1833
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp375=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E1;_tmp7E1.tag=0U,({struct _fat_ptr _tmp91C=({const char*_tmp37B="in-place ";_tag_fat(_tmp37B,sizeof(char),10U);});_tmp7E1.f1=_tmp91C;});_tmp7E1;});struct Cyc_Warn_String_Warn_Warg_struct _tmp376=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E0;_tmp7E0.tag=0U,_tmp7E0.f1=incr_str;_tmp7E0;});struct Cyc_Warn_String_Warn_Warg_struct _tmp377=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7DF;_tmp7DF.tag=0U,({struct _fat_ptr _tmp91D=({const char*_tmp37A=" is not supported when ";_tag_fat(_tmp37A,sizeof(char),24U);});_tmp7DF.f1=_tmp91D;});_tmp7DF;});struct Cyc_Warn_String_Warn_Warg_struct _tmp378=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7DE;_tmp7DE.tag=0U,({
struct _fat_ptr _tmp91E=({const char*_tmp379="dereferencing a zero-terminated pointer";_tag_fat(_tmp379,sizeof(char),40U);});_tmp7DE.f1=_tmp91E;});_tmp7DE;});void*_tmp374[4U];_tmp374[0]=& _tmp375,_tmp374[1]=& _tmp376,_tmp374[2]=& _tmp377,_tmp374[3]=& _tmp378;({unsigned _tmp91F=e->loc;((int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2)(_tmp91F,_tag_fat(_tmp374,sizeof(void*),4U));});});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp37E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E4;_tmp7E4.tag=0U,({struct _fat_ptr _tmp920=({const char*_tmp382="in-place post";_tag_fat(_tmp382,sizeof(char),14U);});_tmp7E4.f1=_tmp920;});_tmp7E4;});struct Cyc_Warn_String_Warn_Warg_struct _tmp37F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E3;_tmp7E3.tag=0U,_tmp7E3.f1=incr_str;_tmp7E3;});struct Cyc_Warn_String_Warn_Warg_struct _tmp380=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E2;_tmp7E2.tag=0U,({
struct _fat_ptr _tmp921=({const char*_tmp381=" is not supported on @tagged union members";_tag_fat(_tmp381,sizeof(char),43U);});_tmp7E2.f1=_tmp921;});_tmp7E2;});void*_tmp37D[3U];_tmp37D[0]=& _tmp37E,_tmp37D[1]=& _tmp37F,_tmp37D[2]=& _tmp380;({unsigned _tmp922=e->loc;((int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2)(_tmp922,_tag_fat(_tmp37D,sizeof(void*),3U));});});}_LL81:;}
# 1865
({void*_tmp924=(void*)({struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmp384=_cycalloc(sizeof(*_tmp384));_tmp384->tag=4U,_tmp384->f1=e2,({struct Cyc_Core_Opt*_tmp923=({struct Cyc_Core_Opt*_tmp383=_cycalloc(sizeof(*_tmp383));_tmp383->v=(void*)op;_tmp383;});_tmp384->f2=_tmp923;}),_tmp384->f3=one;_tmp384;});e->r=_tmp924;});
Cyc_Toc_exp_to_c(nv,e);
return;}
# 1869
...
change=-1;
({void*_tmp929=({struct Cyc_Absyn_Exp*_tmp385[3U];({struct Cyc_Absyn_Exp*_tmp927=Cyc_Toc_push_address_exp(e2);_tmp385[0]=_tmp927;}),({
struct Cyc_Absyn_Exp*_tmp926=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_typ),0U);_tmp385[1]=_tmp926;}),({
struct Cyc_Absyn_Exp*_tmp925=Cyc_Absyn_signed_int_exp(change,0U);_tmp385[2]=_tmp925;});({struct Cyc_Absyn_Exp*_tmp928=fn_e;Cyc_Toc_fncall_exp_r(_tmp928,_tag_fat(_tmp385,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 1882
e->r=_tmp929;});}else{
# 1885
...
void*_tmp387=({void*_tmp92A=Cyc_Toc_typ_to_c(old_typ);Cyc_Absyn_cstar_type(_tmp92A,Cyc_Toc_mt_tq);});void*t=_tmp387;
struct Cyc_Absyn_Exp*_tmp388=Cyc_Toc_push_address_exp(e2);struct Cyc_Absyn_Exp*xexp=_tmp388;
struct Cyc_Absyn_Exp*_tmp389=({struct Cyc_Absyn_Exp*_tmp92B=Cyc_Absyn_deref_exp(Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(x,0U),0U),0U);Cyc_Absyn_neq_exp(_tmp92B,
Cyc_Absyn_int_exp(Cyc_Absyn_None,0,0U),0U);});
# 1896
struct Cyc_Absyn_Exp*testexp=_tmp389;
# 1898
if(Cyc_Toc_do_null_check(e))
testexp=({struct Cyc_Absyn_Exp*_tmp92D=({struct Cyc_Absyn_Exp*_tmp92C=Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(x,0U),0U);Cyc_Absyn_neq_exp(_tmp92C,
Cyc_Absyn_int_exp(Cyc_Absyn_None,0,0U),0U);});
# 1899
Cyc_Absyn_and_exp(_tmp92D,testexp,0U);});{
# 1901
struct Cyc_Absyn_Stmt*_tmp38A=({struct Cyc_Absyn_Exp*_tmp930=testexp;struct Cyc_Absyn_Stmt*_tmp92F=
Cyc_Absyn_exp_stmt(Cyc_Absyn_increment_exp(Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(x,0U),0U),Cyc_Absyn_PreInc,0U),0U);
# 1901
Cyc_Absyn_ifthenelse_stmt(_tmp930,_tmp92F,
# 1903
Cyc_Absyn_exp_stmt(({void*_tmp38B=0U;({struct Cyc_Absyn_Exp*_tmp92E=Cyc_Toc__throw_arraybounds_e;Cyc_Toc_fncall_exp_dl(_tmp92E,_tag_fat(_tmp38B,sizeof(struct Cyc_Absyn_Exp*),0U));});}),0U),0U);});
# 1901
struct Cyc_Absyn_Stmt*s=_tmp38A;
# 1904
s=({struct Cyc_Absyn_Stmt*_tmp931=s;Cyc_Absyn_seq_stmt(_tmp931,Cyc_Absyn_exp_stmt(Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(x,0U),0U),0U),0U);});
({void*_tmp932=(Cyc_Absyn_stmt_exp(Cyc_Absyn_declare_stmt(x,t,xexp,s,0U),0U))->r;e->r=_tmp932;});}}else{
# 1908
...
({void*_tmp936=({struct Cyc_Absyn_Exp*_tmp38D[2U];({struct Cyc_Absyn_Exp*_tmp934=Cyc_Toc_push_address_exp(e2);_tmp38D[0]=_tmp934;}),({struct Cyc_Absyn_Exp*_tmp933=Cyc_Absyn_signed_int_exp(1,0U);_tmp38D[1]=_tmp933;});({struct Cyc_Absyn_Exp*_tmp935=fn_e;Cyc_Toc_fncall_exp_r(_tmp935,_tag_fat(_tmp38D,sizeof(struct Cyc_Absyn_Exp*),2U));});});e->r=_tmp936;});}}else{
# 1912
...
Cyc_Toc_set_lhs(nv,0);
Cyc_Toc_exp_to_c(nv,e2);
({void*_tmp937=Cyc_Toc_tagged_union_assignop(e1,e1_old_typ,popt,e2,e2_old_typ,f_tag,tagged_member_struct_type);e->r=_tmp937;});
# 1946
goto _LL7;}{
# 1948
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp392=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E5;_tmp7E5.tag=0U,({struct _fat_ptr _tmp938=({const char*_tmp393="bad t ? pointer arithmetic";_tag_fat(_tmp393,sizeof(char),27U);});_tmp7E5.f1=_tmp938;});_tmp7E5;});void*_tmp391[1U];_tmp391[0]=& _tmp392;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp391,sizeof(void*),1U));});}_LL88:;}
# 1974
done=1;{
# 1976
struct Cyc_Absyn_Exp*_tmp394=Cyc_Toc__fat_ptr_inplace_plus_e;struct Cyc_Absyn_Exp*fn_e=_tmp394;
({void*_tmp93C=({struct Cyc_Absyn_Exp*_tmp395[3U];({struct Cyc_Absyn_Exp*_tmp93A=Cyc_Toc_push_address_exp(e1);_tmp395[0]=_tmp93A;}),({
struct Cyc_Absyn_Exp*_tmp939=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(elt_typ),0U);_tmp395[1]=_tmp939;}),_tmp395[2]=change;({struct Cyc_Absyn_Exp*_tmp93B=fn_e;Cyc_Toc_fncall_exp_r(_tmp93B,_tag_fat(_tmp395,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 1977
e->r=_tmp93C;});}}else{
# 1980
if(Cyc_Tcutil_is_zero_pointer_type_elt(old_typ,& elt_typ)){
...
({void*_tmp93E=({struct Cyc_Absyn_Exp*_tmp398[2U];_tmp398[0]=e1,_tmp398[1]=e2;({struct Cyc_Absyn_Exp*_tmp93D=Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__zero_arr_inplace_plus_functionSet,e1);Cyc_Toc_fncall_exp_r(_tmp93D,_tag_fat(_tmp398,sizeof(struct Cyc_Absyn_Exp*),2U));});});e->r=_tmp93E;});
goto _LL8F;}else{_LL92: _LL93:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp39A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E6;_tmp7E6.tag=0U,({struct _fat_ptr _tmp93F=({const char*_tmp39B="bad zero-terminated pointer arithmetic";_tag_fat(_tmp39B,sizeof(char),39U);});_tmp7E6.f1=_tmp93F;});_tmp7E6;});void*_tmp399[1U];_tmp399[0]=& _tmp39A;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp399,sizeof(void*),1U));});}_LL8F:;}}}
# 1992
if(!done){
# 1994
if(e1_poly)
({void*_tmp941=({void*_tmp940=Cyc_Toc_void_star_type();Cyc_Toc_cast_it_r(_tmp940,Cyc_Absyn_new_exp(e2->r,0U));});e2->r=_tmp941;});
# 2000
if(!Cyc_Absyn_is_lvalue(e1)){
({struct Cyc_Absyn_Exp*_tmp942=e1;((void(*)(struct Cyc_Absyn_Exp*e1,struct Cyc_List_List*fs,struct Cyc_Absyn_Exp*(*f)(struct Cyc_Absyn_Exp*,struct _tuple33*),struct _tuple33*f_env))Cyc_Toc_lvalue_assign)(_tmp942,0,Cyc_Toc_assignop_lvalue,({struct _tuple33*_tmp39C=_cycalloc(sizeof(*_tmp39C));_tmp39C->f1=popt,_tmp39C->f2=e2;_tmp39C;}));});
e->r=e1->r;}}
# 2005
...
if(Cyc_Toc_do_null_check(e))
# 2023
({void*_tmp946=({void*_tmp945=Cyc_Toc_typ_to_c(e1_typ);Cyc_Toc_cast_it_r(_tmp945,({struct Cyc_Absyn_Exp*_tmp39D[1U];({struct Cyc_Absyn_Exp*_tmp943=
Cyc_Absyn_copy_exp(e1);_tmp39D[0]=_tmp943;});({struct Cyc_Absyn_Exp*_tmp944=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_dl(_tmp944,_tag_fat(_tmp39D,sizeof(struct Cyc_Absyn_Exp*),1U));});}));});
# 2023
e1->r=_tmp946;});
# 2025
((void(*)(void(*f)(struct Cyc_Toc_Env*,struct Cyc_Absyn_Exp*),struct Cyc_Toc_Env*env,struct Cyc_List_List*x))Cyc_List_iter_c)(Cyc_Toc_exp_to_c,nv,es);
...
# 2052
new_args=({struct Cyc_List_List*_tmp3A5=_cycalloc(sizeof(*_tmp3A5));({struct Cyc_Absyn_Exp*_tmp949=({struct Cyc_Absyn_Exp*_tmp3A4[3U];_tmp3A4[0]=argvexp,({
# 2054
struct Cyc_Absyn_Exp*_tmp947=Cyc_Absyn_sizeoftype_exp(cva_type,0U);_tmp3A4[1]=_tmp947;}),_tmp3A4[2]=num_varargs_exp;({struct Cyc_Absyn_Exp*_tmp948=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_dl(_tmp948,_tag_fat(_tmp3A4,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 2052
_tmp3A5->hd=_tmp949;}),_tmp3A5->tl=new_args;_tmp3A5;});
# 2057
...
if(Cyc_Toc_do_null_check(e))
# 2064
({void*_tmp94D=({void*_tmp94C=Cyc_Toc_typ_to_c(e1_typ);Cyc_Toc_cast_it_r(_tmp94C,({struct Cyc_Absyn_Exp*_tmp3A6[1U];({struct Cyc_Absyn_Exp*_tmp94A=
Cyc_Absyn_copy_exp(e1);_tmp3A6[0]=_tmp94A;});({struct Cyc_Absyn_Exp*_tmp94B=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_dl(_tmp94B,_tag_fat(_tmp3A6,sizeof(struct Cyc_Absyn_Exp*),1U));});}));});
# 2064
e1->r=_tmp94D;});{
# 2066
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3AB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7E7;_tmp7E7.tag=0U,({struct _fat_ptr _tmp94E=({const char*_tmp3AC="unknown datatype in vararg with inject";_tag_fat(_tmp3AC,sizeof(char),39U);});_tmp7E7.f1=_tmp94E;});_tmp7E7;});void*_tmp3AA[1U];_tmp3AA[0]=& _tmp3AB;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp3AA,sizeof(void*),1U));});}_LL97:;}{
# 2075
struct _fat_ptr vs=({unsigned _tmp3B8=(unsigned)num_varargs;struct _tuple1**_tmp3B7=({struct _RegionHandle*_tmp94F=r;_region_malloc(_tmp94F,_check_times(_tmp3B8,sizeof(struct _tuple1*)));});({{unsigned _tmp7E8=(unsigned)num_varargs;unsigned i;for(i=0;i < _tmp7E8;++ i){({struct _tuple1*_tmp950=Cyc_Toc_temp_var();_tmp3B7[i]=_tmp950;});}}0;});_tag_fat(_tmp3B7,sizeof(struct _tuple1*),_tmp3B8);});
# 2077
if(num_varargs != 0){
# 2081
struct Cyc_List_List*_tmp3AD=0;struct Cyc_List_List*array_args=_tmp3AD;
{int i=num_varargs - 1;for(0;i >= 0;-- i){
array_args=({struct Cyc_List_List*_tmp3AE=_cycalloc(sizeof(*_tmp3AE));({struct Cyc_Absyn_Exp*_tmp951=Cyc_Absyn_address_exp(Cyc_Absyn_var_exp(*((struct _tuple1**)_check_fat_subscript(vs,sizeof(struct _tuple1*),i)),0U),0U);_tmp3AE->hd=_tmp951;}),_tmp3AE->tl=array_args;_tmp3AE;});}}
s=({struct _tuple1*_tmp954=argv;void*_tmp953=arr_type;struct Cyc_Absyn_Exp*_tmp952=Cyc_Absyn_array_exp(array_args,0U);Cyc_Absyn_declare_stmt(_tmp954,_tmp953,_tmp952,s,0U);});
# 2086
...
struct Cyc_List_List*_tmp3B4=({struct _tuple19*_tmp3B6[2U];({struct _tuple19*_tmp958=({struct _fat_ptr*_tmp957=Cyc_Toc_tag_sp;Cyc_Toc_make_field(_tmp957,Cyc_Toc_datatype_tag(tud,qv));});_tmp3B6[0]=_tmp958;}),({
struct _tuple19*_tmp956=({struct _fat_ptr*_tmp955=Cyc_Absyn_fieldname(1);Cyc_Toc_make_field(_tmp955,arg);});_tmp3B6[1]=_tmp956;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp3B6,sizeof(struct _tuple19*),2U));});
# 2101
struct Cyc_List_List*dles=_tmp3B4;
# 2103
s=({struct _tuple1*_tmp95B=var;void*_tmp95A=Cyc_Absyn_strctq(tdn);struct Cyc_Absyn_Exp*_tmp959=
...
# 2103
Cyc_Absyn_declare_stmt(_tmp95B,_tmp95A,_tmp959,s,0U);});}}}}}else{
# 2111
s=({struct _tuple1*_tmp95E=argv;void*_tmp95D=Cyc_Toc_void_star_type();struct Cyc_Absyn_Exp*_tmp95C=Cyc_Absyn_uint_exp(0U,0U);Cyc_Absyn_declare_stmt(_tmp95E,_tmp95D,_tmp95C,s,0U);});}}}else{
# 2116
if(num_varargs != 0){
...
# 2125
s=({struct _tuple1*_tmp961=argv;void*_tmp960=Cyc_Toc_void_star_type();struct Cyc_Absyn_Exp*_tmp95F=Cyc_Absyn_uint_exp(0U,0U);Cyc_Absyn_declare_stmt(_tmp961,_tmp960,_tmp95F,s,0U);});}}
# 2128
({void*_tmp962=Cyc_Toc_stmt_exp_r(s);e->r=_tmp962;});}}}}
# 2130
...
({void*_tmp965=({void*_tmp964=Cyc_Toc_typ_to_c(old_typ);Cyc_Toc_array_to_ptr_cast(_tmp964,({struct Cyc_Absyn_Exp*_tmp3BB[1U];_tmp3BB[0]=e1;({struct Cyc_Absyn_Exp*_tmp963=fn_e;Cyc_Toc_fncall_exp_dl(_tmp963,_tag_fat(_tmp3BB,sizeof(struct Cyc_Absyn_Exp*),1U));});}),0U);})->r;e->r=_tmp965;});
...
# 2155
({void*_tmp967=({void*_tmp966=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_array_to_ptr_cast(_tmp966,e1,0U);})->r;e->r=_tmp967;});
goto _LL9F;}_LL9F:;}
# 2158
break;}}
# 2161
...
Cyc_Toc_exp_to_c(nv,e1);
# 2170
{struct _tuple34 _tmp3BF=({struct _tuple34 _tmp7EA;({void*_tmp969=Cyc_Absyn_compress(old_t2);_tmp7EA.f1=_tmp969;}),({void*_tmp968=Cyc_Absyn_compress(new_typ);_tmp7EA.f2=_tmp968;});_tmp7EA;});struct _tuple34 _stmttmp37=_tmp3BF;struct _tuple34 _tmp3C0=_stmttmp37;struct Cyc_Absyn_PtrInfo _tmp3C1;struct Cyc_Absyn_PtrInfo _tmp3C3;struct Cyc_Absyn_PtrInfo _tmp3C2;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp3C0.f1)->tag == 3U)switch(*((int*)_tmp3C0.f2)){case 3U: _LLA7: _tmp3C2=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp3C0.f1)->f1;_tmp3C3=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp3C0.f2)->f1;_LLA8: {struct Cyc_Absyn_PtrInfo p1=_tmp3C2;struct Cyc_Absyn_PtrInfo p2=_tmp3C3;
# 2172
struct Cyc_Absyn_Exp*_tmp3C4=({void*_tmp96A=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp96A,(p1.ptr_atts).bounds);});struct Cyc_Absyn_Exp*b1=_tmp3C4;
struct Cyc_Absyn_Exp*_tmp3C5=({void*_tmp96B=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp96B,(p2.ptr_atts).bounds);});struct Cyc_Absyn_Exp*b2=_tmp3C5;
...
# 2179
 did_inserted_checks=1;
if(Cyc_Toc_do_null_check(e))
({void*_tmp96E=({void*_tmp96D=*t;Cyc_Toc_cast_it_r(_tmp96D,({struct Cyc_Absyn_Exp*_tmp3CA[1U];_tmp3CA[0]=e1;({struct Cyc_Absyn_Exp*_tmp96C=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_dl(_tmp96C,_tag_fat(_tmp3CA,sizeof(struct Cyc_Absyn_Exp*),1U));});}));});e->r=_tmp96E;});else{
...
e2=({struct Cyc_Absyn_Exp*_tmp96F=e2;Cyc_Absyn_prim2_exp(Cyc_Absyn_Minus,_tmp96F,Cyc_Absyn_uint_exp(1U,0U),0U);});
({void*_tmp970=(Cyc_Toc_make_toplevel_dyn_arr(old_t2,e2,e1))->r;e->r=_tmp970;});}else{
# 2201
if(zt1){
# 2206
...
struct Cyc_Absyn_Exp*_tmp972=({void*_tmp971=Cyc_Toc_void_star_type();Cyc_Toc_cast_it(_tmp971,x_exp);});_tmp3D8[0]=_tmp972;}),_tmp3D8[1]=e2;({struct Cyc_Absyn_Exp*_tmp973=
# 2225
Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__get_zero_arr_size_functionSet,e1);Cyc_Toc_fncall_exp_dl(_tmp973,_tag_fat(_tmp3D8,sizeof(struct Cyc_Absyn_Exp*),2U));});});}
# 2227
goto _LLBC;}_LLBC:;}
# 2229
if(!zt2 && !(p2.elt_tq).real_const)
# 2232
arg3=({struct Cyc_Absyn_Exp*_tmp974=arg3;Cyc_Absyn_prim2_exp(Cyc_Absyn_Minus,_tmp974,Cyc_Absyn_uint_exp(1U,0U),0U);});{
# 2234
struct Cyc_Absyn_Exp*_tmp3D9=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(p2.elt_type),0U);struct Cyc_Absyn_Exp*arg2=_tmp3D9;
struct Cyc_Absyn_Exp*_tmp3DA=({struct Cyc_Absyn_Exp*_tmp3DC[3U];_tmp3DC[0]=x_exp,_tmp3DC[1]=arg2,_tmp3DC[2]=arg3;({struct Cyc_Absyn_Exp*_tmp975=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_dl(_tmp975,_tag_fat(_tmp3DC,sizeof(struct Cyc_Absyn_Exp*),3U));});});struct Cyc_Absyn_Exp*tg_exp=_tmp3DA;
struct Cyc_Absyn_Stmt*_tmp3DB=Cyc_Absyn_exp_stmt(tg_exp,0U);struct Cyc_Absyn_Stmt*s=_tmp3DB;
s=({struct _tuple1*_tmp978=x;void*_tmp977=Cyc_Toc_typ_to_c(old_t2);struct Cyc_Absyn_Exp*_tmp976=e1;Cyc_Absyn_declare_stmt(_tmp978,_tmp977,_tmp976,s,0U);});
({void*_tmp979=Cyc_Toc_stmt_exp_r(s);e->r=_tmp979;});}}}else{
# 2241
({void*_tmp97C=({struct Cyc_Absyn_Exp*_tmp3DD[3U];_tmp3DD[0]=e1,({
# 2243
struct Cyc_Absyn_Exp*_tmp97A=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(p2.elt_type),0U);_tmp3DD[1]=_tmp97A;}),_tmp3DD[2]=e2;({struct Cyc_Absyn_Exp*_tmp97B=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_r(_tmp97B,_tag_fat(_tmp3DD,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 2241
e->r=_tmp97C;});}}
# 2246
...
if(zt1 && !zt2)
new_e2=({struct Cyc_Absyn_Exp*_tmp97D=b2;Cyc_Absyn_add_exp(_tmp97D,Cyc_Absyn_uint_exp(1U,0U),0U);});{
# 2263
struct Cyc_Absyn_Exp*_tmp3DF=({struct Cyc_Absyn_Exp*_tmp3E1[3U];_tmp3E1[0]=e1,({
# 2265
struct Cyc_Absyn_Exp*_tmp97E=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(p1.elt_type),0U);_tmp3E1[1]=_tmp97E;}),_tmp3E1[2]=new_e2;({struct Cyc_Absyn_Exp*_tmp97F=Cyc_Toc__untag_fat_ptr_e;Cyc_Toc_fncall_exp_dl(_tmp97F,_tag_fat(_tmp3E1,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 2263
struct Cyc_Absyn_Exp*ptr_exp=_tmp3DF;
# 2267
did_inserted_checks=1;
if(Cyc_Toc_do_null_check(e))
({void*_tmp982=({struct Cyc_Absyn_Exp*_tmp3E0[1U];({struct Cyc_Absyn_Exp*_tmp980=Cyc_Absyn_copy_exp(ptr_exp);_tmp3E0[0]=_tmp980;});({struct Cyc_Absyn_Exp*_tmp981=Cyc_Toc__check_null_e;Cyc_Toc_fncall_exp_r(_tmp981,_tag_fat(_tmp3E0,sizeof(struct Cyc_Absyn_Exp*),1U));});});ptr_exp->r=_tmp982;});
({void*_tmp983=Cyc_Toc_cast_it_r(*t,ptr_exp);e->r=_tmp983;});
...
({void*_tmp987=({struct Cyc_Absyn_Exp*_tmp3E3[3U];_tmp3E3[0]=e1,({
struct Cyc_Absyn_Exp*_tmp985=Cyc_Absyn_sizeoftype_exp(Cyc_Toc_typ_to_c(p1.elt_type),0U);_tmp3E3[1]=_tmp985;}),({
struct Cyc_Absyn_Exp*_tmp984=Cyc_Absyn_uint_exp(1U,0U);_tmp3E3[2]=_tmp984;});({struct Cyc_Absyn_Exp*_tmp986=Cyc_Toc__fat_ptr_decrease_size_e;Cyc_Toc_fncall_exp_r(_tmp986,_tag_fat(_tmp3E3,sizeof(struct Cyc_Absyn_Exp*),3U));});});
# 2278
e->r=_tmp987;});}
# 2282
goto _LLAD;}}_LLAD:;}
...
# 2286
{struct Cyc_Absyn_Exp*_tmp3E4=({void*_tmp988=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp988,(p1.ptr_atts).bounds);});struct Cyc_Absyn_Exp*_stmttmp3C=_tmp3E4;struct Cyc_Absyn_Exp*_tmp3E5=_stmttmp3C;if(_tmp3E5 == 0){_LLC8: _LLC9:
# 2288
({void*_tmp98A=({struct Cyc_Absyn_Exp*_tmp989=Cyc_Absyn_new_exp(e1->r,e1->loc);Cyc_Toc_aggrmember_exp_r(_tmp989,Cyc_Toc_curr_sp);});e1->r=_tmp98A;});
e1->topt=new_typ_c;
...
# 2308
({void*_tmp98C=({void*_tmp98B=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_cast_it_r(_tmp98B,e1);});e->r=_tmp98C;});}else{
if(Cyc_Kinds_kind_leq(& Cyc_Kinds_ak,Cyc_Tcutil_type_kind((void*)_check_null(e1->topt))))
# 2312
({void*_tmp98E=({void*_tmp98D=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));Cyc_Toc_cast_it_r(_tmp98D,e1);});e->r=_tmp98E;});}
# 2314
...
if((unsigned)lenexp)
mexp=({struct Cyc_Absyn_Exp*_tmp3EF[2U];_tmp3EF[0]=lenexp,({struct Cyc_Absyn_Exp*_tmp98F=Cyc_Absyn_sizeoftype_exp(elt_typ,0U);_tmp3EF[1]=_tmp98F;});({struct Cyc_Absyn_Exp*_tmp990=Cyc_Toc__check_times_e;Cyc_Toc_fncall_exp_dl(_tmp990,_tag_fat(_tmp3EF,sizeof(struct Cyc_Absyn_Exp*),2U));});});else{
# 2342
...
struct Cyc_Absyn_Exp*_tmp993=Cyc_Absyn_copy_exp(xexp);_tmp3F1[0]=_tmp993;}),({
struct Cyc_Absyn_Exp*_tmp992=Cyc_Absyn_sizeoftype_exp(elt_typ,0U);_tmp3F1[1]=_tmp992;}),
(unsigned)lenexp?_tmp3F1[2]=lenexp:({struct Cyc_Absyn_Exp*_tmp991=Cyc_Absyn_uint_exp(1U,0U);_tmp3F1[2]=_tmp991;});({struct Cyc_Absyn_Exp*_tmp994=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_dl(_tmp994,_tag_fat(_tmp3F1,sizeof(struct Cyc_Absyn_Exp*),3U));});});else{
# 2362
answer=Cyc_Absyn_copy_exp(xexp);}
({void*_tmp995=(void*)({struct Cyc_Toc_Dest_Absyn_AbsynAnnot_struct*_tmp3F2=_cycalloc(sizeof(*_tmp3F2));_tmp3F2->tag=Cyc_Toc_Dest,_tmp3F2->f1=xexp;_tmp3F2;});e->annot=_tmp995;});{
struct Cyc_Absyn_Stmt*_tmp3F3=({struct _tuple1*_tmp999=x;void*_tmp998=Cyc_Absyn_cstar_type(elt_typ,Cyc_Toc_mt_tq);struct Cyc_Absyn_Exp*_tmp997=mexp;Cyc_Absyn_declare_stmt(_tmp999,_tmp998,_tmp997,({
struct Cyc_Absyn_Stmt*_tmp996=Cyc_Absyn_exp_stmt(Cyc_Absyn_copy_exp(e),0U);Cyc_Absyn_seq_stmt(_tmp996,
...
({void*_tmp99A=Cyc_Toc_stmt_exp_r(s);e->r=_tmp99A;});
if(vse != 0)
({void*_tmp99C=({void*_tmp99B=Cyc_Toc_typ_to_c(old_typ);Cyc_Toc_cast_it_r(_tmp99B,Cyc_Absyn_copy_exp(e));});e->r=_tmp99C;});
...
({void*_tmp99E=(void*)({struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*_tmp3F4=_cycalloc(sizeof(*_tmp3F4));_tmp3F4->tag=17U,({void*_tmp99D=Cyc_Toc_typ_to_c(t);_tmp3F4->f1=_tmp99D;});_tmp3F4;});e->r=_tmp99E;});goto _LL7;}case 19U: _LL36: _tmp32B=(void*)((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp300)->f1;_tmp32C=((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp300)->f2;_LL37: {void*t=_tmp32B;struct Cyc_List_List*fs=_tmp32C;
# 2379
...
if(ad->impl == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp403=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7EB;_tmp7EB.tag=0U,({struct _fat_ptr _tmp99F=({const char*_tmp404="struct fields must be known";_tag_fat(_tmp404,sizeof(char),28U);});_tmp7EB.f1=_tmp99F;});_tmp7EB;});void*_tmp402[1U];_tmp402[0]=& _tmp403;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp402,sizeof(void*),1U));});
...
# 2401
if(n == (unsigned)0)
({void*_tmp9A0=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp408=_cycalloc(sizeof(*_tmp408));_tmp408->tag=0U,_tmp408->f1=Cyc_Toc_tag_sp;_tmp408;}));l->hd=_tmp9A0;});else{
# 2404
t2=(*((struct _tuple23*(*)(struct Cyc_List_List*x,int n))Cyc_List_nth)(tuf->typs,(int)(n - (unsigned)1))).f2;
({void*_tmp9A2=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp409=_cycalloc(sizeof(*_tmp409));_tmp409->tag=0U,({struct _fat_ptr*_tmp9A1=Cyc_Absyn_fieldname((int)n);_tmp409->f1=_tmp9A1;});_tmp409;}));l->hd=_tmp9A2;});}
# 2407
...
({void*_tmp9A3=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp406=_cycalloc(sizeof(*_tmp406));_tmp406->tag=0U,_tmp406->f1=nth_field->name;_tmp406;}));l->hd=_tmp9A3;});
t2=nth_field->type;
...
# 2397
({void*_tmp9A5=(void*)((void*)({struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp407=_cycalloc(sizeof(*_tmp407));_tmp407->tag=0U,({struct _fat_ptr*_tmp9A4=Cyc_Absyn_fieldname((int)(n + (unsigned)1));_tmp407->f1=_tmp9A4;});_tmp407;}));l->hd=_tmp9A5;});
t2=(*((struct _tuple23*(*)(struct Cyc_List_List*x,int n))Cyc_List_nth)(ts,(int)n)).f2;
goto _LLD9;}default: _LLE2: _LLE3:
# 2408
({struct Cyc_Warn_String_Warn_Warg_struct _tmp40B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7EC;_tmp7EC.tag=0U,({struct _fat_ptr _tmp9A6=({const char*_tmp40C="impossible type for offsetof tuple index";_tag_fat(_tmp40C,sizeof(char),41U);});_tmp7EC.f1=_tmp9A6;});_tmp7EC;});void*_tmp40A[1U];_tmp40A[0]=& _tmp40B;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp40A,sizeof(void*),1U));});}_LLD9:;}
# 2410
goto _LLD4;}}_LLD4:;}
# 2413
({void*_tmp9A8=(void*)({struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmp40D=_cycalloc(sizeof(*_tmp40D));_tmp40D->tag=19U,({void*_tmp9A7=Cyc_Toc_typ_to_c(t);_tmp40D->f1=_tmp9A7;}),_tmp40D->f2=fs;_tmp40D;});e->r=_tmp9A8;});
...
({void*_tmp9AD=({struct Cyc_Absyn_Exp*_tmp9AC=e1;void*_tmp9AB=Cyc_Toc_typ_to_c(e1_cyc_type);void*_tmp9AA=e1_cyc_type;struct _fat_ptr*_tmp9A9=f;Cyc_Toc_check_tagged_union(_tmp9AC,_tmp9AB,_tmp9AA,_tmp9A9,
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp412=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7ED;_tmp7ED.tag=0U,({struct _fat_ptr _tmp9B0=({const char*_tmp413="get_ptr_typ: not a pointer!";_tag_fat(_tmp413,sizeof(char),28U);});_tmp7ED.f1=_tmp9B0;});_tmp7ED;});void*_tmp411[1U];_tmp411[0]=& _tmp412;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp411,sizeof(void*),1U));});}_LLE4:;}
# 2433
did_inserted_checks=1;
Cyc_Toc_ptr_use_to_c(nv,e1,e->annot,0);
if(is_tagged && is_read)
({void*_tmp9B5=({struct Cyc_Absyn_Exp*_tmp9B4=e1;void*_tmp9B3=Cyc_Toc_typ_to_c(e1typ);void*_tmp9B2=ta;struct _fat_ptr*_tmp9B1=f;Cyc_Toc_check_tagged_union(_tmp9B4,_tmp9B3,_tmp9B2,_tmp9B1,Cyc_Toc_in_lhs(nv),Cyc_Absyn_aggrarrow_exp);});e->r=_tmp9B5;});
if(is_poly && is_read)
...
if(!known)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp41D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7EE;_tmp7EE.tag=0U,({struct _fat_ptr _tmp9B8=({const char*_tmp41E="unknown tuple subscript in translation to C";_tag_fat(_tmp41E,sizeof(char),44U);});_tmp7EE.f1=_tmp9B8;});_tmp7EE;});void*_tmp41C[1U];_tmp41C[0]=& _tmp41D;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp41C,sizeof(void*),1U));});
({void*_tmp9BA=({struct Cyc_Absyn_Exp*_tmp9B9=e1;Cyc_Toc_aggrmember_exp_r(_tmp9B9,Cyc_Absyn_fieldname((int)(i + (unsigned)1)));});e->r=_tmp9BA;});
goto _LLE9;}}}}}else{_LLEC: _LLED:
# 2457
 did_inserted_checks=1;{
int index_used=Cyc_Toc_ptr_use_to_c(nv,e1,e->annot,e2);
if(index_used)
({void*_tmp9BB=Cyc_Toc_deref_exp_r(e1);e->r=_tmp9BB;});
goto _LLE9;}}_LLE9:;}
# 2463
...
Cyc_Toc_exp_to_c(nv,(struct Cyc_Absyn_Exp*)es->hd);
dles=({struct Cyc_List_List*_tmp422=_cycalloc(sizeof(*_tmp422));({struct _tuple19*_tmp9BD=({struct _fat_ptr*_tmp9BC=Cyc_Absyn_fieldname(i);Cyc_Toc_make_field(_tmp9BC,(struct Cyc_Absyn_Exp*)es->hd);});_tmp422->hd=_tmp9BD;}),_tmp422->tl=dles;_tmp422;});}}
# 2476
({void*_tmp9BF=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp423=_cycalloc(sizeof(*_tmp423));_tmp423->tag=29U,_tmp423->f1=sd->name,_tmp423->f2=0,({struct Cyc_List_List*_tmp9BE=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);_tmp423->f3=_tmp9BE;}),_tmp423->f4=sd;_tmp423;});e->r=_tmp9BF;});
e->topt=strct_typ;
goto _LLF1;}}else{goto _LLF4;}}else{goto _LLF4;}}else{_LLF4: _LLF5:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp425=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7EF;_tmp7EF.tag=0U,({struct _fat_ptr _tmp9C0=({const char*_tmp426="tuple type not an aggregate";_tag_fat(_tmp426,sizeof(char),28U);});_tmp7EF.f1=_tmp9C0;});_tmp7EF;});void*_tmp424[1U];_tmp424[0]=& _tmp425;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp424,sizeof(void*),1U));});}_LLF1:;}
# 2481
goto _LL7;}else{
# 2485
struct Cyc_List_List*dles=0;
for(0;es != 0;es=es->tl){
Cyc_Toc_exp_to_c(nv,(struct Cyc_Absyn_Exp*)es->hd);
dles=({struct Cyc_List_List*_tmp428=_cycalloc(sizeof(*_tmp428));({struct _tuple19*_tmp9C1=({struct _tuple19*_tmp427=_cycalloc(sizeof(*_tmp427));_tmp427->f1=0,_tmp427->f2=(struct Cyc_Absyn_Exp*)es->hd;_tmp427;});_tmp428->hd=_tmp9C1;}),_tmp428->tl=dles;_tmp428;});}
# 2490
({void*_tmp9C2=Cyc_Toc_unresolvedmem_exp_r(0,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles));e->r=_tmp9C2;});}
# 2492
...
if(Cyc_Toc_is_toplevel(nv))
({void*_tmp9C3=Cyc_Toc_unresolvedmem_exp_r(0,dles0);e->r=_tmp9C3;});
...
if(!known)
({void*_tmp42F=0U;({unsigned _tmp9C5=e1->loc;struct _fat_ptr _tmp9C4=({const char*_tmp430="cannot determine value of constant";_tag_fat(_tmp430,sizeof(char),35U);});Cyc_Tcutil_terr(_tmp9C5,_tmp9C4,_tag_fat(_tmp42F,sizeof(void*),0U));});});
{unsigned i=0U;for(0;i < sz;++ i){
es=({struct Cyc_List_List*_tmp432=_cycalloc(sizeof(*_tmp432));({struct _tuple19*_tmp9C6=({struct _tuple19*_tmp431=_cycalloc(sizeof(*_tmp431));_tmp431->f1=0,_tmp431->f2=e2;_tmp431;});_tmp432->hd=_tmp9C6;}),_tmp432->tl=es;_tmp432;});}}
# 2519
if(iszeroterm){
struct Cyc_Absyn_Exp*_tmp433=({void*_tmp9C7=elt_typ;Cyc_Toc_cast_it(_tmp9C7,Cyc_Absyn_uint_exp(0U,0U));});struct Cyc_Absyn_Exp*ezero=_tmp433;
es=({struct Cyc_List_List*_tmp9C9=es;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp9C9,({struct Cyc_List_List*_tmp435=_cycalloc(sizeof(*_tmp435));({struct _tuple19*_tmp9C8=({struct _tuple19*_tmp434=_cycalloc(sizeof(*_tmp434));_tmp434->f1=0,_tmp434->f2=ezero;_tmp434;});_tmp435->hd=_tmp9C8;}),_tmp435->tl=0;_tmp435;}));});}}
# 2524
({void*_tmp9CA=Cyc_Toc_unresolvedmem_exp_r(0,es);e->r=_tmp9CA;});}}
# 2526
...
# 2533
if(Cyc_Toc_is_toplevel(nv))
({void*_tmp9CB=Cyc_Toc_unresolvedmem_exp_r(0,0);e->r=_tmp9CB;});else{
# 2536
Cyc_Toc_exp_to_c(nv,e1);}
...
# 2547
struct Cyc_Absyn_Aggrdecl*sd=Cyc_Absyn_get_known_aggrdecl(aggrinfo);
({void*_tmp9CC=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp43B=_cycalloc(sizeof(*_tmp43B));_tmp43B->tag=29U,_tmp43B->f1=sd->name,_tmp43B->f2=0,_tmp43B->f3=dles,_tmp43B->f4=sd;_tmp43B;});e->r=_tmp9CC;});
e->topt=strct_typ;
goto _LLF9;}}else{goto _LLFC;}}else{goto _LLFC;}}else{_LLFC: _LLFD:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp43D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F0;_tmp7F0.tag=0U,({struct _fat_ptr _tmp9CD=({const char*_tmp43E="anonStruct type not an aggregate";_tag_fat(_tmp43E,sizeof(char),33U);});_tmp7F0.f1=_tmp9CD;});_tmp7F0;});void*_tmp43C[1U];_tmp43C[0]=& _tmp43D;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp43C,sizeof(void*),1U));});}_LLF9:;}else{
# 2554
({void*_tmp9CE=Cyc_Toc_unresolvedmem_exp_r(0,dles);e->r=_tmp9CE;});}
...
# 2560
if(sd == 0 || sd->impl == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp440=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F1;_tmp7F1.tag=0U,({struct _fat_ptr _tmp9CF=({const char*_tmp441="exp_to_c, Aggregate_e: missing aggrdecl pointer or fields";_tag_fat(_tmp441,sizeof(char),58U);});_tmp7F1.f1=_tmp9CF;});_tmp7F1;});void*_tmp43F[1U];_tmp43F[0]=& _tmp440;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp43F,sizeof(void*),1U));});{
...
({struct _tuple1*_tmp9D0=(Cyc_Absyn_aggr_kinded_name(info)).f2;*tdn=_tmp9D0;});goto _LLFE;}}else{goto _LL101;}}else{_LL101: _LL102:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp447=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F2;_tmp7F2.tag=0U,({struct _fat_ptr _tmp9D1=({const char*_tmp448="exp_to_c, Aggregate_e: bad type translation";_tag_fat(_tmp448,sizeof(char),44U);});_tmp7F2.f1=_tmp9D1;});_tmp7F2;});void*_tmp446[1U];_tmp446[0]=& _tmp447;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp446,sizeof(void*),1U));});}_LLFE:;}{
# 2571
...
({void*_tmp9D3=({void*_tmp9D2=Cyc_Toc_typ_to_c(aggrfield->type);Cyc_Toc_cast_it(_tmp9D2,
...
struct _tuple1*s=({struct _tuple1*_tmp463=_cycalloc(sizeof(*_tmp463));({union Cyc_Absyn_Nmspace _tmp9D7=Cyc_Absyn_Abs_n(0,1);_tmp463->f1=_tmp9D7;}),({
struct _fat_ptr*_tmp9D6=({struct _fat_ptr*_tmp462=_cycalloc(sizeof(*_tmp462));({struct _fat_ptr _tmp9D5=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp460=({struct Cyc_String_pa_PrintArg_struct _tmp7F4;_tmp7F4.tag=0U,_tmp7F4.f1=(struct _fat_ptr)((struct _fat_ptr)*(*sd->name).f2);_tmp7F4;});struct Cyc_String_pa_PrintArg_struct _tmp461=({struct Cyc_String_pa_PrintArg_struct _tmp7F3;_tmp7F3.tag=0U,_tmp7F3.f1=(struct _fat_ptr)((struct _fat_ptr)*n);_tmp7F3;});void*_tmp45E[2U];_tmp45E[0]=& _tmp460,_tmp45E[1]=& _tmp461;({struct _fat_ptr _tmp9D4=({const char*_tmp45F="_union_%s_%s";_tag_fat(_tmp45F,sizeof(char),13U);});Cyc_aprintf(_tmp9D4,_tag_fat(_tmp45E,sizeof(void*),2U));});});*_tmp462=_tmp9D5;});_tmp462;});_tmp463->f2=_tmp9D6;});_tmp463;});
# 2600
struct _tuple19*_tmp459=({
struct _fat_ptr*_tmp9D9=n;Cyc_Toc_make_field(_tmp9D9,Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp45D=_cycalloc(sizeof(*_tmp45D));_tmp45D->tag=29U,_tmp45D->f1=s,_tmp45D->f2=0,({struct Cyc_List_List*_tmp9D8=({struct _tuple19*_tmp45C[2U];_tmp45C[0]=tag_dle,_tmp45C[1]=val_dle;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp45C,sizeof(struct _tuple19*),2U));});_tmp45D->f3=_tmp9D8;}),_tmp45D->f4=0;_tmp45D;}),0U));});
# 2600
struct _tuple19*u_dle=_tmp459;
# 2603
({void*_tmp9DB=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp45B=_cycalloc(sizeof(*_tmp45B));_tmp45B->tag=29U,_tmp45B->f1=*tdn,_tmp45B->f2=0,({struct Cyc_List_List*_tmp9DA=({struct _tuple19*_tmp45A[1U];_tmp45A[0]=u_dle;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp45A,sizeof(struct _tuple19*),1U));});_tmp45B->f3=_tmp9DA;}),_tmp45B->f4=sd;_tmp45B;});e->r=_tmp9DB;});}
# 2609
if(Cyc_Toc_is_abstract_type(old_typ)&& last_typ_field == aggrfield){
struct Cyc_List_List*_tmp464=({struct Cyc_List_List*_tmp9DC=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_zip)(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(sd->impl))->exist_vars,exist_ts);((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp9DC,
...
struct Cyc_Absyn_Aggrfield*_tmp468=({struct Cyc_Absyn_Aggrfield*_tmp9DD=old_f;Cyc_Toc_aggrfield_to_c(_tmp9DD,
...
({struct Cyc_Absyn_Exp*_tmp9DE=Cyc_Absyn_uint_exp(0U,0U);ai2.num_elts=_tmp9DE;});
({void*_tmp9DF=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp46E=_cycalloc(sizeof(*_tmp46E));_tmp46E->tag=4U,_tmp46E->f1=ai2;_tmp46E;});new_f->type=_tmp9DF;});}
# 2632
...
({struct Cyc_List_List*_tmp9E1=({struct Cyc_List_List*_tmp472=_cycalloc(sizeof(*_tmp472));({void*_tmp9E0=(void*)({struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_tmp471=_cycalloc(sizeof(*_tmp471));_tmp471->tag=6U,_tmp471->f1=0;_tmp471;});_tmp472->hd=_tmp9E0;}),_tmp472->tl=new_f->attributes;_tmp472;});new_f->attributes=_tmp9E1;});}}}
# 2653
sd=({struct _fat_ptr*_tmp9E4=({struct _fat_ptr*_tmp476=_cycalloc(sizeof(*_tmp476));({struct _fat_ptr _tmp9E3=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp475=({struct Cyc_Int_pa_PrintArg_struct _tmp7F5;_tmp7F5.tag=1U,_tmp7F5.f1=(unsigned long)Cyc_Toc_tuple_type_counter ++;_tmp7F5;});void*_tmp473[1U];_tmp473[0]=& _tmp475;({struct _fat_ptr _tmp9E2=({const char*_tmp474="_genStruct%d";_tag_fat(_tmp474,sizeof(char),13U);});Cyc_aprintf(_tmp9E2,_tag_fat(_tmp473,sizeof(void*),1U));});});*_tmp476=_tmp9E3;});_tmp476;});Cyc_Toc_make_c_struct_defn(_tmp9E4,
# 2655
((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(new_fields));});
*tdn=sd->name;
Cyc_Toc_aggrdecl_to_c(sd);
# 2659
({void*_tmp9E5=Cyc_Absyn_aggr_type(Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp477=_cycalloc(sizeof(*_tmp477));*_tmp477=sd;_tmp477;})),0);e->topt=_tmp9E5;});}}}}
# 2662
goto _LL103;}}else{goto _LL106;}}else{_LL106: _LL107:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp479=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F6;_tmp7F6.tag=0U,({struct _fat_ptr _tmp9E6=({const char*_tmp47A="exp_to_c, Aggregate_e: bad struct type";_tag_fat(_tmp47A,sizeof(char),39U);});_tmp7F6.f1=_tmp9E6;});_tmp7F6;});void*_tmp478[1U];_tmp478[0]=& _tmp479;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp478,sizeof(void*),1U));});}_LL103:;}else{
# 2671
if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(sd->impl))->tagged){
# 2673
...
({void*_tmp9E8=({
void*_tmp9E7=Cyc_Toc_void_star_type();Cyc_Toc_cast_it_r(_tmp9E7,Cyc_Absyn_new_exp(fieldexp->r,0U));});
# 2679
fieldexp->r=_tmp9E8;});{
# 2682
int i=Cyc_Toc_get_member_offset(sd,field->name);
struct Cyc_Absyn_Exp*field_tag_exp=Cyc_Absyn_signed_int_exp(i,0U);
struct Cyc_List_List*_tmp481=({struct _tuple19*_tmp483[2U];({struct _tuple19*_tmp9EA=({struct _tuple19*_tmp484=_cycalloc(sizeof(*_tmp484));_tmp484->f1=0,_tmp484->f2=field_tag_exp;_tmp484;});_tmp483[0]=_tmp9EA;}),({struct _tuple19*_tmp9E9=({struct _tuple19*_tmp485=_cycalloc(sizeof(*_tmp485));_tmp485->f1=0,_tmp485->f2=fieldexp;_tmp485;});_tmp483[1]=_tmp9E9;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp483,sizeof(struct _tuple19*),2U));});struct Cyc_List_List*newdles=_tmp481;
struct Cyc_Absyn_Exp*umem=Cyc_Absyn_unresolvedmem_exp(0,newdles,0U);
({void*_tmp9EC=Cyc_Toc_unresolvedmem_exp_r(0,({struct _tuple19*_tmp482[1U];({struct _tuple19*_tmp9EB=Cyc_Toc_make_field(field->name,umem);_tmp482[0]=_tmp9EB;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp482,sizeof(struct _tuple19*),1U));}));e->r=_tmp9EC;});}}}else{
# 2689
...
fieldexp=({void*_tmp9ED=fieldtyp;Cyc_Toc_cast_it(_tmp9ED,Cyc_Absyn_copy_exp(fieldexp));});}
newdles=({struct Cyc_List_List*_tmp490=_cycalloc(sizeof(*_tmp490));({struct _tuple19*_tmp9EE=({struct _tuple19*_tmp48F=_cycalloc(sizeof(*_tmp48F));_tmp48F->f1=0,_tmp48F->f2=fieldexp;_tmp48F;});_tmp490->hd=_tmp9EE;}),_tmp490->tl=newdles;_tmp490;});
break;}}}}
# 2708
({void*_tmp9EF=Cyc_Toc_unresolvedmem_exp_r(0,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(newdles));e->r=_tmp9EF;});}}
# 2711
...
({void*_tmp9F1=({void*_tmp9F0=field_typ;Cyc_Toc_cast_it(_tmp9F0,Cyc_Absyn_copy_exp(cur_e));})->r;cur_e->r=_tmp9F1;});}}{
# 2726
...
struct Cyc_List_List*dles=0;
{int i=1;for(0;es != 0;(es=es->tl,++ i)){
dles=({struct Cyc_List_List*_tmp495=_cycalloc(sizeof(*_tmp495));({struct _tuple19*_tmp9F3=({struct _fat_ptr*_tmp9F2=Cyc_Absyn_fieldname(i);Cyc_Toc_make_field(_tmp9F2,(struct Cyc_Absyn_Exp*)es->hd);});_tmp495->hd=_tmp9F3;}),_tmp495->tl=dles;_tmp495;});}}{
# 2737
struct _tuple19*_tmp496=Cyc_Toc_make_field(Cyc_Toc_tag_sp,tag_exp);struct _tuple19*tag_dle=_tmp496;
({void*_tmp9F7=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp498=_cycalloc(sizeof(*_tmp498));_tmp498->tag=29U,({struct _tuple1*_tmp9F6=Cyc_Toc_collapse_qvars(tuf->name,tud->name);_tmp498->f1=_tmp9F6;}),_tmp498->f2=0,({
struct Cyc_List_List*_tmp9F5=({struct Cyc_List_List*_tmp497=_cycalloc(sizeof(*_tmp497));_tmp497->hd=tag_dle,({struct Cyc_List_List*_tmp9F4=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);_tmp497->tl=_tmp9F4;});_tmp497;});_tmp498->f3=_tmp9F5;}),_tmp498->f4=0;_tmp498;});
# 2738
e->r=_tmp9F7;});}}else{
# 2743
struct Cyc_List_List*_tmp499=0;struct Cyc_List_List*dles=_tmp499;
for(0;es != 0;es=es->tl){
dles=({struct Cyc_List_List*_tmp49B=_cycalloc(sizeof(*_tmp49B));({struct _tuple19*_tmp9F8=({struct _tuple19*_tmp49A=_cycalloc(sizeof(*_tmp49A));_tmp49A->f1=0,_tmp49A->f2=(struct Cyc_Absyn_Exp*)es->hd;_tmp49A;});_tmp49B->hd=_tmp9F8;}),_tmp49B->tl=dles;_tmp49B;});}
({void*_tmp9FB=Cyc_Toc_unresolvedmem_exp_r(0,({struct Cyc_List_List*_tmp49D=_cycalloc(sizeof(*_tmp49D));({struct _tuple19*_tmp9FA=({struct _tuple19*_tmp49C=_cycalloc(sizeof(*_tmp49C));_tmp49C->f1=0,_tmp49C->f2=tag_exp;_tmp49C;});_tmp49D->hd=_tmp9FA;}),({
struct Cyc_List_List*_tmp9F9=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);_tmp49D->tl=_tmp9F9;});_tmp49D;}));
# 2746
e->r=_tmp9FB;});}
# 2749
...
struct Cyc_Absyn_Exp*_tmp9FC=Cyc_Absyn_sizeoftype_exp(t_c,0U);_tmp49E[1]=_tmp9FC;}),_tmp49E[2]=num_elts2;({struct Cyc_Absyn_Exp*_tmp9FD=Cyc_Toc__region_calloc_e;Cyc_Toc_fncall_exp_dl(_tmp9FD,_tag_fat(_tmp49E,sizeof(struct Cyc_Absyn_Exp*),3U));});});}else{
# 2770
pexp=({void*_tmp9FF=*topt;struct Cyc_Absyn_Exp*_tmp9FE=Cyc_Absyn_sizeoftype_exp(t_c,0U);Cyc_Toc_calloc_exp(_tmp9FF,_tmp9FE,num_elts2);});}}else{
# 2772
if(rgnopt != 0 && !Cyc_Flags_no_regions){
Cyc_Toc_exp_to_c(nv,rgnopt);
if(inline_call)
...
struct Cyc_Absyn_Exp*rexp=({struct Cyc_Absyn_Exp*_tmp49F[3U];_tmp49F[0]=pexp,_tmp49F[1]=elt_sz,_tmp49F[2]=num_elts2;({struct Cyc_Absyn_Exp*_tmpA00=Cyc_Toc__tag_fat_e;Cyc_Toc_fncall_exp_dl(_tmpA00,_tag_fat(_tmp49F,sizeof(struct Cyc_Absyn_Exp*),3U));});});
struct Cyc_Absyn_Stmt*s=({struct _tuple1*_tmpA03=(struct _tuple1*)_check_null(x);void*_tmpA02=Cyc_Absyn_uint_type;struct Cyc_Absyn_Exp*_tmpA01=num_elts;Cyc_Absyn_declare_stmt(_tmpA03,_tmpA02,_tmpA01,
Cyc_Absyn_exp_stmt(rexp,0U),0U);});
({void*_tmpA04=Cyc_Toc_stmt_exp_r(s);e->r=_tmpA04;});}else{
# 2788
e->r=pexp->r;}
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4A1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F7;_tmp7F7.tag=0U,({struct _fat_ptr _tmpA05=({const char*_tmp4A2="Swap_e: is_pointer_or_boxed: not a pointer or boxed type";_tag_fat(_tmp4A2,sizeof(char),57U);});_tmp7F7.f1=_tmpA05;});_tmp7F7;});void*_tmp4A0[1U];_tmp4A0[0]=& _tmp4A1;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4A0,sizeof(void*),1U));});{
# 2806
...
# 2812
struct Cyc_Absyn_Exp*_tmp4A8=({struct Cyc_Absyn_Exp*_tmpA07=Cyc_Tcutil_deep_copy_exp(1,e1);struct Cyc_Absyn_Exp*_tmpA06=v2e;Cyc_Absyn_assign_exp(_tmpA07,_tmpA06,loc);});struct Cyc_Absyn_Exp*s1e=_tmp4A8;s1e->topt=e1_old_typ;{
struct Cyc_Absyn_Stmt*_tmp4A9=Cyc_Absyn_exp_stmt(s1e,loc);struct Cyc_Absyn_Stmt*s1=_tmp4A9;
struct Cyc_Absyn_Exp*_tmp4AA=({struct Cyc_Absyn_Exp*_tmpA09=Cyc_Tcutil_deep_copy_exp(1,e2);struct Cyc_Absyn_Exp*_tmpA08=v1e;Cyc_Absyn_assign_exp(_tmpA09,_tmpA08,loc);});struct Cyc_Absyn_Exp*s2e=_tmp4AA;s2e->topt=e2_old_typ;{
struct Cyc_Absyn_Stmt*_tmp4AB=Cyc_Absyn_exp_stmt(s2e,loc);struct Cyc_Absyn_Stmt*s2=_tmp4AB;
# 2817
struct Cyc_Absyn_Stmt*_tmp4AC=({struct _tuple1*_tmpA11=v1;void*_tmpA10=e1_old_typ;struct Cyc_Absyn_Exp*_tmpA0F=e1;struct Cyc_Absyn_Stmt*_tmpA0E=({
struct _tuple1*_tmpA0D=v2;void*_tmpA0C=e2_old_typ;struct Cyc_Absyn_Exp*_tmpA0B=e2;struct Cyc_Absyn_Stmt*_tmpA0A=
Cyc_Absyn_seq_stmt(s1,s2,loc);
# 2818
Cyc_Absyn_declare_stmt(_tmpA0D,_tmpA0C,_tmpA0B,_tmpA0A,loc);});
# 2817
Cyc_Absyn_declare_stmt(_tmpA11,_tmpA10,_tmpA0F,_tmpA0E,loc);});struct Cyc_Absyn_Stmt*s=_tmp4AC;
# 2820
Cyc_Toc_stmt_to_c(nv,s);
({void*_tmpA12=Cyc_Toc_stmt_exp_r(s);e->r=_tmpA12;});
...
({void*_tmpA13=(Cyc_Absyn_eq_exp(e1_f_tag,f_tag,0U))->r;e->r=_tmpA13;});
goto _LL11B;}}else{goto _LL11E;}}else{goto _LL11E;}}else{_LL11E: _LL11F:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4B4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F8;_tmp7F8.tag=0U,({struct _fat_ptr _tmpA14=({const char*_tmp4B5="non-aggregate type in tagcheck";_tag_fat(_tmp4B5,sizeof(char),31U);});_tmp7F8.f1=_tmpA14;});_tmp7F8;});void*_tmp4B3[1U];_tmp4B3[0]=& _tmp4B4;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4B3,sizeof(void*),1U));});}_LL11B:;}
# 2836
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4B7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7F9;_tmp7F9.tag=0U,({struct _fat_ptr _tmpA15=({const char*_tmp4B8="UnresolvedMem";_tag_fat(_tmp4B8,sizeof(char),14U);});_tmp7F9.f1=_tmpA15;});_tmp7F9;});void*_tmp4B6[1U];_tmp4B6[0]=& _tmp4B7;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4B6,sizeof(void*),1U));});case 25U: _LL5C: _LL5D:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4BA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7FA;_tmp7FA.tag=0U,({struct _fat_ptr _tmpA16=({const char*_tmp4BB="compoundlit";_tag_fat(_tmp4BB,sizeof(char),12U);});_tmp7FA.f1=_tmpA16;});_tmp7FA;});void*_tmp4B9[1U];_tmp4B9[0]=& _tmp4BA;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4B9,sizeof(void*),1U));});case 39U: _LL5E: _LL5F:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4BD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7FB;_tmp7FB.tag=0U,({struct _fat_ptr _tmpA17=({const char*_tmp4BE="valueof(-)";_tag_fat(_tmp4BE,sizeof(char),11U);});_tmp7FB.f1=_tmpA17;});_tmp7FB;});void*_tmp4BC[1U];_tmp4BC[0]=& _tmp4BD;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4BC,sizeof(void*),1U));});default: _LL60: _tmp301=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmp300)->f3;_tmp302=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmp300)->f4;_LL61: {struct Cyc_List_List*o=_tmp301;struct Cyc_List_List*i=_tmp302;
# 2842
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4C0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp7FD;_tmp7FD.tag=0U,({struct _fat_ptr _tmpA18=({const char*_tmp4C2="Toc did not examine an inserted check: ";_tag_fat(_tmp4C2,sizeof(char),40U);});_tmp7FD.f1=_tmpA18;});_tmp7FD;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp4C1=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp7FC;_tmp7FC.tag=4U,_tmp7FC.f1=e;_tmp7FC;});void*_tmp4BF[2U];_tmp4BF[0]=& _tmp4C0,_tmp4BF[1]=& _tmp4C1;({unsigned _tmpA19=e->loc;((int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2)(_tmpA19,_tag_fat(_tmp4BF,sizeof(void*),2U));});});}}struct _tuple37{int f1;struct _fat_ptr*f2;struct _fat_ptr*f3;struct Cyc_Absyn_Switch_clause*f4;};
# 2875 "toc.cyc"
static struct _tuple37*Cyc_Toc_gen_labels(struct _RegionHandle*r,struct Cyc_Absyn_Switch_clause*sc){
# 2877
return({struct _tuple37*_tmp4C3=_region_malloc(r,sizeof(*_tmp4C3));_tmp4C3->f1=0,({struct _fat_ptr*_tmpA1B=Cyc_Toc_fresh_label();_tmp4C3->f2=_tmpA1B;}),({struct _fat_ptr*_tmpA1A=Cyc_Toc_fresh_label();_tmp4C3->f3=_tmpA1A;}),_tmp4C3->f4=sc;_tmp4C3;});}
# 2883
...
# 2894
 ...
 goto _LL0;default: _LL7: _LL8:
 v=({void*_tmpA1C=Cyc_Toc_typ_to_c_array(t);Cyc_Toc_cast_it(_tmpA1C,v);});goto _LL0;}_LL0:;}{
# 2900
...
# 2912
ps=ps->tl;
v=({void*_tmpA1E=({void*_tmpA1D=Cyc_Absyn_strctq(Cyc_Toc_collapse_qvars(tuf->name,tud->name));Cyc_Absyn_cstar_type(_tmpA1D,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpA1E,v);});
v=({struct Cyc_Absyn_Exp*_tmpA1F=v;Cyc_Absyn_aggrarrow_exp(_tmpA1F,Cyc_Absyn_fieldname((int)(i + (unsigned)1)),0U);});
...
v=({struct Cyc_Absyn_Exp*_tmpA20=v;Cyc_Toc_member_exp(_tmpA20,Cyc_Absyn_fieldname((int)(i + (unsigned)1)),0U);});goto _LL9;}default: _LL12: _tmp4CA=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp4C9)->f1;_tmp4CB=((struct Cyc_Tcpat_AggrField_Tcpat_Access_struct*)_tmp4C9)->f2;_LL13: {int tagged=_tmp4CA;struct _fat_ptr*f=_tmp4CB;
# 2924
...
return e == 0?v: e;}case 1U: _LL3: _LL4:
 return({struct Cyc_Absyn_Exp*_tmpA21=v;Cyc_Absyn_eq_exp(_tmpA21,Cyc_Absyn_signed_int_exp(0,0U),0U);});case 2U: _LL5: _LL6:
 return({struct Cyc_Absyn_Exp*_tmpA22=v;Cyc_Absyn_neq_exp(_tmpA22,Cyc_Absyn_signed_int_exp(0,0U),0U);});case 3U: _LL7: _tmp4E0=((struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*)_tmp4D3)->f1;_tmp4E1=((struct Cyc_Tcpat_EqEnum_Tcpat_PatTest_struct*)_tmp4D3)->f2;_LL8: {struct Cyc_Absyn_Enumdecl*ed=_tmp4E0;struct Cyc_Absyn_Enumfield*ef=_tmp4E1;
return({struct Cyc_Absyn_Exp*_tmpA23=v;Cyc_Absyn_eq_exp(_tmpA23,Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmp4E3=_cycalloc(sizeof(*_tmp4E3));_tmp4E3->tag=32U,_tmp4E3->f1=ed,_tmp4E3->f2=ef;_tmp4E3;}),0U),0U);});}case 4U: _LL9: _tmp4DE=(void*)((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp4D3)->f1;_tmp4DF=((struct Cyc_Tcpat_EqAnonEnum_Tcpat_PatTest_struct*)_tmp4D3)->f2;_LLA: {void*t=_tmp4DE;struct Cyc_Absyn_Enumfield*ef=_tmp4DF;
return({struct Cyc_Absyn_Exp*_tmpA24=v;Cyc_Absyn_eq_exp(_tmpA24,Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmp4E4=_cycalloc(sizeof(*_tmp4E4));_tmp4E4->tag=33U,_tmp4E4->f1=t,_tmp4E4->f2=ef;_tmp4E4;}),0U),0U);});}case 5U: _LLB: _tmp4DC=((struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*)_tmp4D3)->f1;_tmp4DD=((struct Cyc_Tcpat_EqFloat_Tcpat_PatTest_struct*)_tmp4D3)->f2;_LLC: {struct _fat_ptr s=_tmp4DC;int i=_tmp4DD;
return({struct Cyc_Absyn_Exp*_tmpA25=v;Cyc_Absyn_eq_exp(_tmpA25,Cyc_Absyn_float_exp(s,i,0U),0U);});}case 6U: _LLD: _tmp4DB=((struct Cyc_Tcpat_EqConst_Tcpat_PatTest_struct*)_tmp4D3)->f1;_LLE: {unsigned i=_tmp4DB;
return({struct Cyc_Absyn_Exp*_tmpA26=v;Cyc_Absyn_eq_exp(_tmpA26,Cyc_Absyn_signed_int_exp((int)i,0U),0U);});}case 7U: _LLF: _tmp4D8=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp4D3)->f1;_tmp4D9=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp4D3)->f2;_tmp4DA=((struct Cyc_Tcpat_EqDatatypeTag_Tcpat_PatTest_struct*)_tmp4D3)->f3;_LL10: {int i=_tmp4D8;struct Cyc_Absyn_Datatypedecl*tud=_tmp4D9;struct Cyc_Absyn_Datatypefield*tuf=_tmp4DA;
# 2947
LOOP1: {
...
v=e;goto _LL15;}default: _LL1A: _LL1B:
 goto _LL15;}_LL15:;}
# 2954
v=({void*_tmpA28=({void*_tmpA27=Cyc_Absyn_strctq(Cyc_Toc_collapse_qvars(tuf->name,tud->name));Cyc_Absyn_cstar_type(_tmpA27,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpA28,v);});return({struct Cyc_Absyn_Exp*_tmpA29=Cyc_Absyn_aggrarrow_exp(v,Cyc_Toc_tag_sp,0U);Cyc_Absyn_eq_exp(_tmpA29,Cyc_Absyn_uint_exp((unsigned)i,0U),0U);});}case 8U: _LL11: _tmp4D6=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp4D3)->f1;_tmp4D7=((struct Cyc_Tcpat_EqTaggedUnion_Tcpat_PatTest_struct*)_tmp4D3)->f2;_LL12: {struct _fat_ptr*f=_tmp4D6;int i=_tmp4D7;
# 2958
return({struct Cyc_Absyn_Exp*_tmpA2B=({struct Cyc_Absyn_Exp*_tmpA2A=Cyc_Toc_member_exp(v,f,0U);Cyc_Toc_member_exp(_tmpA2A,Cyc_Toc_tag_sp,0U);});Cyc_Absyn_eq_exp(_tmpA2B,
...
v=e;goto _LL1C;}default: _LL21: _LL22:
 goto _LL1C;}_LL1C:;}
# 2969
v=({void*_tmpA2D=({void*_tmpA2C=Cyc_Absyn_strctq(Cyc_Toc_collapse_qvars(tuf->name,tud->name));Cyc_Absyn_cstar_type(_tmpA2C,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpA2D,v);});
return({struct Cyc_Absyn_Exp*_tmpA2E=Cyc_Absyn_aggrarrow_exp(v,Cyc_Toc_tag_sp,0U);Cyc_Absyn_eq_exp(_tmpA2E,Cyc_Absyn_var_exp(tuf->name,0U),0U);});}}_LL0:;}struct Cyc_Toc_OtherTest_Toc_TestKind_struct{int tag;};struct Cyc_Toc_DatatypeTagTest_Toc_TestKind_struct{int tag;};struct Cyc_Toc_WhereTest_Toc_TestKind_struct{int tag;struct Cyc_Absyn_Exp*f1;};struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct{int tag;struct _fat_ptr*f1;};
# 2981
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp500=({struct Cyc_Warn_String_Warn_Warg_struct _tmp801;_tmp801.tag=0U,({struct _fat_ptr _tmpA2F=({const char*_tmp501="compile_pat_test_as_case!";_tag_fat(_tmp501,sizeof(char),26U);});_tmp801.f1=_tmpA2F;});_tmp801;});void*_tmp4FF[1U];_tmp4FF[0]=& _tmp500;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp4FF,sizeof(void*),1U));});}_LL0:;}
# 3028
...
# 3055
struct Cyc_Absyn_Vardecl*_tmp514=({struct _tuple1*_tmpA30=Cyc_Toc_temp_var();Cyc_Absyn_new_vardecl(0U,_tmpA30,Cyc_Toc_typ_to_c_array(vd->type),0);});struct Cyc_Absyn_Vardecl*new_vd=_tmp514;
({struct Cyc_List_List*_tmpA32=({struct Cyc_List_List*_tmp516=_region_malloc(rgn,sizeof(*_tmp516));({struct _tuple39*_tmpA31=({struct _tuple39*_tmp515=_region_malloc(rgn,sizeof(*_tmp515));_tmp515->f1=vd,_tmp515->f2=new_vd;_tmp515;});_tmp516->hd=_tmpA31;}),_tmp516->tl=*decls;_tmp516;});*decls=_tmpA32;});{
struct Cyc_Absyn_Stmt*_tmp517=({struct Cyc_Absyn_Exp*_tmpA33=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp518=_cycalloc(sizeof(*_tmp518));_tmp518->tag=4U,_tmp518->f1=new_vd;_tmp518;}),0U);Cyc_Absyn_assign_stmt(_tmpA33,Cyc_Absyn_copy_exp(path),0U);});struct Cyc_Absyn_Stmt*s=_tmp517;
return({struct Cyc_Absyn_Stmt*_tmpA34=s;Cyc_Toc_seq_stmt_opt(_tmpA34,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,path,p2));});}}case 4U: _LL5: _tmp50F=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp504)->f2;_LL6: {struct Cyc_Absyn_Vardecl*vd=_tmp50F;
# 3061
struct Cyc_Absyn_Vardecl*_tmp519=({struct _tuple1*_tmpA35=Cyc_Toc_temp_var();Cyc_Absyn_new_vardecl(0U,_tmpA35,Cyc_Toc_typ_to_c_array(vd->type),0);});struct Cyc_Absyn_Vardecl*new_vd=_tmp519;
({struct Cyc_List_List*_tmpA37=({struct Cyc_List_List*_tmp51B=_region_malloc(rgn,sizeof(*_tmp51B));({struct _tuple39*_tmpA36=({struct _tuple39*_tmp51A=_region_malloc(rgn,sizeof(*_tmp51A));_tmp51A->f1=vd,_tmp51A->f2=new_vd;_tmp51A;});_tmp51B->hd=_tmpA36;}),_tmp51B->tl=*decls;_tmp51B;});*decls=_tmpA37;});
return({struct Cyc_Absyn_Exp*_tmpA38=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp51C=_cycalloc(sizeof(*_tmp51C));_tmp51C->tag=4U,_tmp51C->f1=new_vd;_tmp51C;}),0U);Cyc_Absyn_assign_stmt(_tmpA38,Cyc_Absyn_copy_exp(path),0U);});}case 0U: _LL7: _LL8:
...
# 3067
({void*_tmpA39=Cyc_Absyn_cstar_type(t,Cyc_Toc_mt_tq);vd->type=_tmpA39;});{
struct Cyc_Absyn_Vardecl*_tmp51D=({struct _tuple1*_tmpA3A=Cyc_Toc_temp_var();Cyc_Absyn_new_vardecl(0U,_tmpA3A,Cyc_Toc_typ_to_c_array(vd->type),0);});struct Cyc_Absyn_Vardecl*new_vd=_tmp51D;
({struct Cyc_List_List*_tmpA3C=({struct Cyc_List_List*_tmp51F=_region_malloc(rgn,sizeof(*_tmp51F));({struct _tuple39*_tmpA3B=({struct _tuple39*_tmp51E=_region_malloc(rgn,sizeof(*_tmp51E));_tmp51E->f1=vd,_tmp51E->f2=new_vd;_tmp51E;});_tmp51F->hd=_tmpA3B;}),_tmp51F->tl=*decls;_tmp51F;});*decls=_tmpA3C;});{
# 3071
struct Cyc_Absyn_Stmt*_tmp520=({struct Cyc_Absyn_Exp*_tmpA3F=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp521=_cycalloc(sizeof(*_tmp521));_tmp521->tag=4U,_tmp521->f1=new_vd;_tmp521;}),0U);Cyc_Absyn_assign_stmt(_tmpA3F,({
void*_tmpA3E=({void*_tmpA3D=Cyc_Toc_typ_to_c_array(t);Cyc_Absyn_cstar_type(_tmpA3D,Cyc_Toc_mt_tq);});Cyc_Toc_cast_it(_tmpA3E,
Cyc_Toc_push_address_exp(Cyc_Absyn_copy_exp(path)));}),0U);});
# 3071
struct Cyc_Absyn_Stmt*s=_tmp520;
# 3074
return({struct Cyc_Absyn_Stmt*_tmpA40=s;Cyc_Toc_seq_stmt_opt(_tmpA40,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,path,p2));});}}}case 9U: _LLB: _LLC:
# 3076
...
void*_tmp522=({void*_tmpA41=Cyc_Absyn_strctq(tufstrct);Cyc_Absyn_cstar_type(_tmpA41,Cyc_Toc_mt_tq);});void*field_ptr_typ=_tmp522;
...
struct Cyc_Absyn_Exp*_tmp528=({struct Cyc_Absyn_Exp*_tmpA42=path;Cyc_Absyn_aggrarrow_exp(_tmpA42,Cyc_Absyn_fieldname(cnt),0U);});struct Cyc_Absyn_Exp*arrow_exp=_tmp528;
if(Cyc_Toc_is_void_star_or_boxed_tvar(Cyc_Toc_typ_to_c(tuf_typ)))
arrow_exp=Cyc_Toc_cast_it(t2c,arrow_exp);
s=({struct Cyc_Absyn_Stmt*_tmpA43=s;Cyc_Toc_seq_stmt_opt(_tmpA43,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,arrow_exp,p2));});}}
# 3103
...
# 3149
return({struct _RegionHandle*_tmpA47=rgn;struct Cyc_Toc_Env**_tmpA46=nv;struct Cyc_List_List**_tmpA45=decls;struct Cyc_Absyn_Exp*_tmpA44=Cyc_Absyn_deref_exp(path,0U);Cyc_Toc_extract_pattern_vars(_tmpA47,_tmpA46,_tmpA45,_tmpA44,p2);});}}case 8U: _LL19: _tmp508=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp504)->f3;_LL1A: {struct Cyc_List_List*ps=_tmp508;
# 3105
...
s=({struct Cyc_Absyn_Stmt*_tmpA4C=s;Cyc_Toc_seq_stmt_opt(_tmpA4C,({struct _RegionHandle*_tmpA4B=rgn;struct Cyc_Toc_Env**_tmpA4A=nv;struct Cyc_List_List**_tmpA49=decls;struct Cyc_Absyn_Exp*_tmpA48=Cyc_Toc_member_exp(path,f,0U);Cyc_Toc_extract_pattern_vars(_tmpA4B,_tmpA4A,_tmpA49,_tmpA48,p2);}));});}}
# 3117
return s;}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp504)->f1 == 0){_LL1D: _LL1E:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp52D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp802;_tmp802.tag=0U,({struct _fat_ptr _tmpA4D=({const char*_tmp52E="unresolved aggregate pattern!";_tag_fat(_tmp52E,sizeof(char),30U);});_tmp802.f1=_tmpA4D;});_tmp802;});void*_tmp52C[1U];_tmp52C[0]=& _tmp52D;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp52C,sizeof(void*),1U));});}else{_LL1F: _tmp505=*((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp504)->f1;_tmp506=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp504)->f3;_LL20: {union Cyc_Absyn_AggrInfo info=_tmp505;struct Cyc_List_List*dlps=_tmp506;
# 3121
...
# 3141
memexp=Cyc_Absyn_deref_exp(({void*_tmpA4E=Cyc_Absyn_cstar_type(t2c,Cyc_Toc_mt_tq);Cyc_Toc_cast_it(_tmpA4E,
Cyc_Absyn_address_exp(memexp,0U));}),0U);}
# 3144
s=({struct Cyc_Absyn_Stmt*_tmpA4F=s;Cyc_Toc_seq_stmt_opt(_tmpA4F,Cyc_Toc_extract_pattern_vars(rgn,nv,decls,memexp,p2));});}}}
# 3146
return s;}}case 15U: _LL23: _LL24:
# 3151
({struct Cyc_Warn_String_Warn_Warg_struct _tmp538=({struct Cyc_Warn_String_Warn_Warg_struct _tmp803;_tmp803.tag=0U,({struct _fat_ptr _tmpA50=({const char*_tmp539="unknownid pat";_tag_fat(_tmp539,sizeof(char),14U);});_tmp803.f1=_tmpA50;});_tmp803;});void*_tmp537[1U];_tmp537[0]=& _tmp538;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp537,sizeof(void*),1U));});case 16U: _LL25: _LL26:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp53B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp804;_tmp804.tag=0U,({struct _fat_ptr _tmpA51=({const char*_tmp53C="unknowncall pat";_tag_fat(_tmp53C,sizeof(char),16U);});_tmp804.f1=_tmpA51;});_tmp804;});void*_tmp53A[1U];_tmp53A[0]=& _tmp53B;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp53A,sizeof(void*),1U));});default: _LL27: _LL28:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp53E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp805;_tmp805.tag=0U,({struct _fat_ptr _tmpA52=({const char*_tmp53F="exp pat";_tag_fat(_tmp53F,sizeof(char),8U);});_tmp805.f1=_tmpA52;});_tmp805;});void*_tmp53D[1U];_tmp53D[0]=& _tmp53E;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp53D,sizeof(void*),1U));});}_LL0:;}
# 3157
...
# 3162
({void*_tmp544=0U;({struct _fat_ptr _tmpA53=({const char*_tmp545="find_new_var";_tag_fat(_tmp545,sizeof(char),13U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Toc_toc_impos)(_tmpA53,_tag_fat(_tmp544,sizeof(void*),0U));});});}
# 3168
...
({void*_tmpA56=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp573=_cycalloc(sizeof(*_tmp573));_tmp573->tag=1U,({void*_tmpA55=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp572=_cycalloc(sizeof(*_tmp572));_tmp572->tag=4U,({struct Cyc_Absyn_Vardecl*_tmpA54=((struct Cyc_Absyn_Vardecl*(*)(struct Cyc_List_List*l,struct Cyc_Absyn_Vardecl*k))Cyc_List_assoc)(env,vd);_tmp572->f1=_tmpA54;});_tmp572;});_tmp573->f1=_tmpA55;});_tmp573;});e->r=_tmpA56;});;_pop_handler();}else{void*_tmp570=(void*)Cyc_Core_get_exn_thrown();void*_tmp574=_tmp570;void*_tmp575;if(((struct Cyc_Core_Not_found_exn_struct*)_tmp574)->tag == Cyc_Core_Not_found){_LL40: _LL41:
# 3175
...
# 3248
struct Cyc_Absyn_Stmt*init_opt=({struct _RegionHandle*_tmpA58=rgn;struct Cyc_Absyn_Exp*_tmpA57=
Cyc_Absyn_var_exp(v,0U);
# 3248
Cyc_Toc_extract_pattern_vars(_tmpA58,& nv,& newdecls,_tmpA57,sc->pattern);});
# 3252
...
({struct Cyc_List_List*_tmpA5A=({struct Cyc_List_List*_tmp58B=_region_malloc(rgn,sizeof(*_tmp58B));({struct _tuple39*_tmpA59=({struct _tuple39*_tmp58A=_region_malloc(rgn,sizeof(*_tmp58A));_tmp58A->f1=oldv,_tmp58A->f2=newv;_tmp58A;});_tmp58B->hd=_tmpA59;}),_tmp58B->tl=*decls;_tmp58B;});*decls=_tmpA5A;});
({struct Cyc_Absyn_Exp*_tmpA5B=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp58C=_cycalloc(sizeof(*_tmp58C));_tmp58C->tag=4U,_tmp58C->f1=newv;_tmp58C;}),0U);oldv->initializer=_tmpA5B;});
((struct Cyc_Absyn_Exp*)_check_null(oldv->initializer))->topt=newv->type;
oldv->type=newv->type;
res=({struct Cyc_Absyn_Decl*_tmpA5D=({struct Cyc_Absyn_Decl*_tmp58E=_cycalloc(sizeof(*_tmp58E));({void*_tmpA5C=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp58D=_cycalloc(sizeof(*_tmp58D));_tmp58D->tag=0U,_tmp58D->f1=oldv;_tmp58D;});_tmp58E->r=_tmpA5C;}),_tmp58E->loc=0U;_tmp58E;});Cyc_Absyn_decl_stmt(_tmpA5D,res,0U);});}}}
# 3261
res=Cyc_Absyn_label_stmt(code_lab,res,0U);
if(init_opt != 0)
res=Cyc_Absyn_seq_stmt(init_opt,res,0U);
res=Cyc_Absyn_label_stmt(init_lab,res,0U);
({struct Cyc_List_List*_tmpA5F=({struct Cyc_List_List*_tmp590=_region_malloc(rgn,sizeof(*_tmp590));({struct _tuple41*_tmpA5E=({struct _tuple41*_tmp58F=_region_malloc(rgn,sizeof(*_tmp58F));_tmp58F->f1=nv,_tmp58F->f2=code_lab,_tmp58F->f3=body;_tmp58F;});_tmp590->hd=_tmpA5E;}),_tmp590->tl=*bodies;_tmp590;});*bodies=_tmpA5F;});
return res;}}}}
# 3269
({struct Cyc_Warn_String_Warn_Warg_struct _tmp592=({struct Cyc_Warn_String_Warn_Warg_struct _tmp806;_tmp806.tag=0U,({struct _fat_ptr _tmpA60=({const char*_tmp593="couldn't find rhs!";_tag_fat(_tmp593,sizeof(char),19U);});_tmp806.f1=_tmpA60;});_tmp806;});void*_tmp591[1U];_tmp591[0]=& _tmp592;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp591,sizeof(void*),1U));});}default: _LL7: _tmp57A=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp579)->f1;_tmp57B=((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp579)->f2;_tmp57C=(void*)((struct Cyc_Tcpat_SwitchDec_Tcpat_Decision_struct*)_tmp579)->f3;_LL8: {struct Cyc_List_List*symbolic_path=_tmp57A;struct Cyc_List_List*switches=_tmp57B;void*other_decision=_tmp57C;
# 3272
struct Cyc_Absyn_Stmt*res=Cyc_Toc_compile_decision_tree(rgn,nv,decls,bodies,other_decision,lscs,v);
# 3274
struct Cyc_Absyn_Exp*_tmp594=({struct Cyc_List_List*_tmpA61=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(symbolic_path);Cyc_Toc_compile_path(_tmpA61,Cyc_Absyn_var_exp(v,0U));});struct Cyc_Absyn_Exp*p=_tmp594;
...
({struct Cyc_Absyn_Switch_clause*_tmpA63=({struct Cyc_Absyn_Switch_clause*_tmp5A9=_cycalloc(sizeof(*_tmp5A9));({struct Cyc_Absyn_Pat*_tmpA62=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0U);_tmp5A9->pattern=_tmpA62;}),_tmp5A9->pat_vars=0,_tmp5A9->where_clause=0,_tmp5A9->body=res,_tmp5A9->loc=0U;_tmp5A9;});_tmp5AA->hd=_tmpA63;}),_tmp5AA->tl=0;_tmp5AA;});
# 3284
for(0;ss != 0;ss=ss->tl){
...
# 3291
new_lscs=({struct Cyc_List_List*_tmp5A1=_cycalloc(sizeof(*_tmp5A1));({struct Cyc_Absyn_Switch_clause*_tmpA64=({struct Cyc_Absyn_Switch_clause*_tmp5A0=_cycalloc(sizeof(*_tmp5A0));_tmp5A0->pattern=case_exp,_tmp5A0->pat_vars=0,_tmp5A0->where_clause=0,_tmp5A0->body=s,_tmp5A0->loc=0U;_tmp5A0;});_tmp5A1->hd=_tmpA64;}),_tmp5A1->tl=new_lscs;_tmp5A1;});}}
# 3293
...
p=e;goto _LL1E;}default: _LL23: _LL24:
 goto _LL1E;}_LL1E:;}
# 3301
p=Cyc_Absyn_deref_exp(({void*_tmpA65=Cyc_Absyn_cstar_type(Cyc_Absyn_sint_type,Cyc_Toc_mt_tq);Cyc_Toc_cast_it(_tmpA65,p);}),0U);goto _LL15;case 3U: _LL18: _tmp5A3=((struct Cyc_Toc_TaggedUnionTest_Toc_TestKind_struct*)_tmp5A2)->f1;_LL19: {struct _fat_ptr*f=_tmp5A3;
# 3303
p=({struct Cyc_Absyn_Exp*_tmpA66=Cyc_Toc_member_exp(p,f,0U);Cyc_Toc_member_exp(_tmpA66,Cyc_Toc_tag_sp,0U);});goto _LL15;}case 2U: _LL1A: _LL1B:
...
struct Cyc_List_List*newdecls=0;
# 3329
struct Cyc_Absyn_Stmt*init_opt=({struct _RegionHandle*_tmpA68=rgn;struct Cyc_Absyn_Exp*_tmpA67=Cyc_Absyn_var_exp(v,0U);Cyc_Toc_extract_pattern_vars(_tmpA68,& nv,& newdecls,_tmpA67,sc->pattern);});
# 3333
...
({struct Cyc_List_List*_tmpA6A=({struct Cyc_List_List*_tmp5BD=_region_malloc(rgn,sizeof(*_tmp5BD));({struct _tuple39*_tmpA69=({struct _tuple39*_tmp5BC=_region_malloc(rgn,sizeof(*_tmp5BC));_tmp5BC->f1=oldv,_tmp5BC->f2=newv;_tmp5BC;});_tmp5BD->hd=_tmpA69;}),_tmp5BD->tl=*decls;_tmp5BD;});*decls=_tmpA6A;});
({struct Cyc_Absyn_Exp*_tmpA6B=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp5BE=_cycalloc(sizeof(*_tmp5BE));_tmp5BE->tag=4U,_tmp5BE->f1=newv;_tmp5BE;}),0U);oldv->initializer=_tmpA6B;});
((struct Cyc_Absyn_Exp*)_check_null(oldv->initializer))->topt=newv->type;
oldv->type=newv->type;
r=({struct Cyc_Absyn_Decl*_tmpA6D=({struct Cyc_Absyn_Decl*_tmp5C0=_cycalloc(sizeof(*_tmp5C0));({void*_tmpA6C=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp5BF=_cycalloc(sizeof(*_tmp5BF));_tmp5BF->tag=0U,_tmp5BF->f1=oldv;_tmp5BF;});_tmp5C0->r=_tmpA6C;}),_tmp5C0->loc=0U;_tmp5C0;});Cyc_Absyn_decl_stmt(_tmpA6D,r,0U);});}}}
# 3342
...
({struct Cyc_List_List*_tmpA6F=({struct Cyc_List_List*_tmp5C2=_region_malloc(rgn,sizeof(*_tmp5C2));({struct _tuple41*_tmpA6E=({struct _tuple41*_tmp5C1=_region_malloc(rgn,sizeof(*_tmp5C1));_tmp5C1->f1=nv,_tmp5C1->f2=code_lab,_tmp5C1->f3=body;_tmp5C1;});_tmp5C2->hd=_tmpA6E;}),_tmp5C2->tl=*bodies;_tmp5C2;});*bodies=_tmpA6F;});
return r;}}}}
# 3356
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5C4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp807;_tmp807.tag=0U,({struct _fat_ptr _tmpA70=({const char*_tmp5C5="couldn't find rhs!";_tag_fat(_tmp5C5,sizeof(char),19U);});_tmp807.f1=_tmpA70;});_tmp807;});void*_tmp5C3[1U];_tmp5C3[0]=& _tmp5C4;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp5C3,sizeof(void*),1U));});}}else{goto _LL2D;}}else{goto _LL2D;}}else{_LL2D: _LL2E:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5C7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp808;_tmp808.tag=0U,({struct _fat_ptr _tmpA71=({const char*_tmp5C8="bad where clause in match compiler";_tag_fat(_tmp5C8,sizeof(char),35U);});_tmp808.f1=_tmpA71;});_tmp808;});void*_tmp5C6[1U];_tmp5C6[0]=& _tmp5C7;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp5C6,sizeof(void*),1U));});}_LL2A:;}}else{_LL28: _LL29:
# 3361
 for(0;ss != 0;ss=ss->tl){
...
# 3435
if(next_case_env == 0)
({struct Cyc_Toc_Env*_tmpA72=Cyc_Toc_last_switchclause_env(rgn,env,end_l);Cyc_Toc_stmt_to_c(_tmpA72,s);});else{
# 3439
...
vs=({struct Cyc_List_List*_tmpA73=mydecls;((struct Cyc_List_List*(*)(struct Cyc_Absyn_Vardecl*(*f)(struct Cyc_List_List*,struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*env,struct Cyc_List_List*x))Cyc_List_map_c)((struct Cyc_Absyn_Vardecl*(*)(struct Cyc_List_List*l,struct Cyc_Absyn_Vardecl*k))Cyc_List_assoc,_tmpA73,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(vs));});}
# 3444
({struct Cyc_Toc_Env*_tmpA74=Cyc_Toc_non_last_switchclause_env(rgn,env,end_l,fallthru_lab,vs);Cyc_Toc_stmt_to_c(_tmpA74,s);});}}}else{
# 3448
({struct Cyc_Toc_Env*_tmpA75=Cyc_Toc_last_switchclause_env(rgn,env,end_l);Cyc_Toc_stmt_to_c(_tmpA75,s);});}}}}}{
# 3452
struct Cyc_Absyn_Stmt*res=({struct Cyc_Absyn_Stmt*_tmpA77=test_tree;Cyc_Absyn_seq_stmt(_tmpA77,({struct _fat_ptr*_tmpA76=end_l;Cyc_Absyn_label_stmt(_tmpA76,Cyc_Toc_skip_stmt_dl(),0U);}),0U);});
# 3454
...
res=({struct Cyc_Absyn_Decl*_tmpA78=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp5E8=_cycalloc(sizeof(*_tmp5E8));_tmp5E8->tag=0U,_tmp5E8->f1=vd;_tmp5E8;}),0U);Cyc_Absyn_decl_stmt(_tmpA78,res,0U);});}}
# 3459
({void*_tmpA7C=({struct _tuple1*_tmpA7B=v;void*_tmpA7A=Cyc_Toc_typ_to_c((void*)_check_null(e->topt));struct Cyc_Absyn_Exp*_tmpA79=e;Cyc_Absyn_declare_stmt(_tmpA7B,_tmpA7A,_tmpA79,res,0U);})->r;whole_s->r=_tmpA7C;});
...
return Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmp5E9[1U];({struct Cyc_Absyn_Exp*_tmpA7D=Cyc_Absyn_uint_exp((unsigned)(n - 1),0U);_tmp5E9[0]=_tmpA7D;});({struct Cyc_Absyn_Exp*_tmpA7E=Cyc_Toc__npop_handler_e;Cyc_Toc_fncall_exp_dl(_tmpA7E,_tag_fat(_tmp5E9,sizeof(struct Cyc_Absyn_Exp*),1U));});}),0U);}
# 3477
void Cyc_Toc_do_npop_before(int n,struct Cyc_Absyn_Stmt*s){
if(n > 0)
({void*_tmpA80=({struct Cyc_Absyn_Stmt*_tmpA7F=Cyc_Toc_make_npop_handler(n);Cyc_Toc_seq_stmt_r(_tmpA7F,Cyc_Absyn_new_stmt(s->r,0U));});s->r=_tmpA80;});}
# 3482
...
({int _tmpA81=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpA81,s);});return;}else{_LL7: _tmp605=((struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp5EB)->f1;_LL8: {struct Cyc_Absyn_Exp*e=_tmp605;
# 3491
...
({void*_tmpA82=(Cyc_Absyn_declare_stmt(x,t,e,retn_stmt,0U))->r;s->r=_tmpA82;});}
# 3500
...
# 3516
Cyc_Toc_exp_to_c(nv,e);{
struct _RegionHandle _tmp609=_new_region("temp");struct _RegionHandle*temp=& _tmp609;_push_region(temp);({struct Cyc_Toc_Env*_tmpA83=Cyc_Toc_loop_env(temp,nv);Cyc_Toc_stmt_to_c(_tmpA83,s2);});
_npop_handler(0U);return;
# 3517
...
if(b != 0)
({void*_tmpA84=Cyc_Toc_goto_stmt_r(*b);s->r=_tmpA84;});
# 3524
({int _tmpA85=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpA85,s);});
...
if(c != 0)
({void*_tmpA86=Cyc_Toc_goto_stmt_r(*c);s->r=_tmpA86;});
goto _LL18;}}case 8U: _LL17: _LL18:
# 3532
({int _tmpA87=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpA87,s);});
...
if(fi == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp611=({struct Cyc_Warn_String_Warn_Warg_struct _tmp809;_tmp809.tag=0U,({struct _fat_ptr _tmpA88=({const char*_tmp612="fallthru in unexpected place";_tag_fat(_tmp612,sizeof(char),29U);});_tmp809.f1=_tmpA88;});_tmp809;});void*_tmp610[1U];_tmp610[0]=& _tmp611;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp610,sizeof(void*),1U));});{
...
# 3545
({int _tmpA89=Cyc_Toc_get_npop(s);Cyc_Toc_do_npop_before(_tmpA89,s2);});{
...
s2=({struct Cyc_Absyn_Stmt*_tmpA8B=({struct Cyc_Absyn_Exp*_tmpA8A=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*_tmp619=_cycalloc(sizeof(*_tmp619));_tmp619->tag=5U,_tmp619->f1=(struct Cyc_Absyn_Vardecl*)vs2->hd;_tmp619;}),0U);Cyc_Absyn_assign_stmt(_tmpA8A,(struct Cyc_Absyn_Exp*)es2->hd,0U);});Cyc_Absyn_seq_stmt(_tmpA8B,s2,0U);});}
# 3553
s->r=s2->r;
...
# 3569
struct Cyc_Absyn_Vardecl*_tmp629=({struct _tuple1*_tmpA8D=Cyc_Toc_temp_var();void*_tmpA8C=vd->type;Cyc_Absyn_new_vardecl(0U,_tmpA8D,_tmpA8C,e);});struct Cyc_Absyn_Vardecl*new_vd=_tmp629;
({struct Cyc_Absyn_Exp*_tmpA8E=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp62A=_cycalloc(sizeof(*_tmp62A));_tmp62A->tag=4U,_tmp62A->f1=new_vd;_tmp62A;}),0U);vd->initializer=_tmpA8E;});
((struct Cyc_Absyn_Exp*)_check_null(vd->initializer))->topt=new_vd->type;
({void*_tmpA95=({struct Cyc_Absyn_Decl*_tmpA94=({void*_tmpA8F=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp62B=_cycalloc(sizeof(*_tmp62B));_tmp62B->tag=0U,_tmp62B->f1=new_vd;_tmp62B;});Cyc_Absyn_new_decl(_tmpA8F,s->loc);});struct Cyc_Absyn_Stmt*_tmpA93=({
struct Cyc_Absyn_Decl*_tmpA92=({void*_tmpA90=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp62C=_cycalloc(sizeof(*_tmp62C));_tmp62C->tag=0U,_tmp62C->f1=vd;_tmp62C;});Cyc_Absyn_new_decl(_tmpA90,s->loc);});struct Cyc_Absyn_Stmt*_tmpA91=s1;Cyc_Absyn_decl_stmt(_tmpA92,_tmpA91,s->loc);});
# 3572
Cyc_Absyn_decl_stmt(_tmpA94,_tmpA93,s->loc);})->r;s->r=_tmpA95;});
# 3575
Cyc_Toc_stmt_to_c(nv,s);
goto _LL3E;}}else{goto _LL41;}}else{_LL41: _LL42:
# 3581
({void*_tmpA96=(Cyc_Toc_letdecl_to_c(nv,p,dec_tree,(void*)_check_null(e->topt),e,s1))->r;s->r=_tmpA96;});
goto _LL3E;}_LL3E:;}
# 3584
...
if(rvds == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp62F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp80A;_tmp80A.tag=0U,({struct _fat_ptr _tmpA97=({const char*_tmp630="empty Letv_d";_tag_fat(_tmp630,sizeof(char),13U);});_tmp80A.f1=_tmpA97;});_tmp80A;});void*_tmp62E[1U];_tmp62E[0]=& _tmp62F;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp62E,sizeof(void*),1U));});
({void*_tmpA98=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp631=_cycalloc(sizeof(*_tmp631));_tmp631->tag=0U,_tmp631->f1=(struct Cyc_Absyn_Vardecl*)rvds->hd;_tmp631;});d->r=_tmpA98;});
rvds=rvds->tl;
...
({void*_tmpA9A=({struct Cyc_Absyn_Decl*_tmpA99=d2;Cyc_Absyn_decl_stmt(_tmpA99,Cyc_Absyn_new_stmt(s->r,0U),0U);})->r;s->r=_tmpA9A;});}
# 3597
Cyc_Toc_stmt_to_c(nv,s);
...
({void*_tmpA9E=({struct _tuple1*_tmpA9D=x_var;void*_tmpA9C=rh_struct_ptr_typ;struct Cyc_Absyn_Exp*_tmpA9B=
Cyc_Absyn_uint_exp(0U,0U);
# 3614
Cyc_Absyn_declare_stmt(_tmpA9D,_tmpA9C,_tmpA9B,body,0U);})->r;s->r=_tmpA9E;});else{
# 3616
if((unsigned)open_exp_opt){
# 3618
Cyc_Toc_exp_to_c(nv,open_exp_opt);{
struct Cyc_Absyn_Exp*arg=Cyc_Absyn_address_exp(({struct Cyc_Absyn_Exp*_tmpAA0=open_exp_opt;Cyc_Absyn_aggrarrow_exp(_tmpAA0,({struct _fat_ptr*_tmp63A=_cycalloc(sizeof(*_tmp63A));({struct _fat_ptr _tmpA9F=({const char*_tmp639="h";_tag_fat(_tmp639,sizeof(char),2U);});*_tmp63A=_tmpA9F;});_tmp63A;}),0U);}),0U);
({void*_tmpAA1=(Cyc_Absyn_declare_stmt(x_var,rh_struct_ptr_typ,arg,body,0U))->r;s->r=_tmpAA1;});}}else{
# 3627
({void*_tmpAAE=({struct _tuple1*_tmpAAD=rh_var;void*_tmpAAC=rh_struct_typ;struct Cyc_Absyn_Exp*_tmpAAB=({struct Cyc_Absyn_Exp*_tmp63B[1U];({struct Cyc_Absyn_Exp*_tmpAA2=
Cyc_Absyn_string_exp(*(*x_var).f2,0U);_tmp63B[0]=_tmpAA2;});({struct Cyc_Absyn_Exp*_tmpAA3=Cyc_Toc__new_region_e;Cyc_Toc_fncall_exp_dl(_tmpAA3,_tag_fat(_tmp63B,sizeof(struct Cyc_Absyn_Exp*),1U));});});
# 3627
Cyc_Absyn_declare_stmt(_tmpAAD,_tmpAAC,_tmpAAB,({
# 3629
struct _tuple1*_tmpAAA=x_var;void*_tmpAA9=rh_struct_ptr_typ;struct Cyc_Absyn_Exp*_tmpAA8=Cyc_Absyn_address_exp(rh_exp,0U);Cyc_Absyn_declare_stmt(_tmpAAA,_tmpAA9,_tmpAA8,({
struct Cyc_Absyn_Stmt*_tmpAA7=Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmp63C[1U];_tmp63C[0]=x_exp;({struct Cyc_Absyn_Exp*_tmpAA4=Cyc_Toc__push_region_e;Cyc_Toc_fncall_exp_dl(_tmpAA4,_tag_fat(_tmp63C,sizeof(struct Cyc_Absyn_Exp*),1U));});}),0U);Cyc_Absyn_seq_stmt(_tmpAA7,({
struct Cyc_Absyn_Stmt*_tmpAA6=body;Cyc_Absyn_seq_stmt(_tmpAA6,
Cyc_Absyn_exp_stmt(({void*_tmp63D=0U;({struct Cyc_Absyn_Exp*_tmpAA5=Cyc_Toc__pop_region_e;Cyc_Toc_fncall_exp_dl(_tmpAA5,_tag_fat(_tmp63D,sizeof(struct Cyc_Absyn_Exp*),0U));});}),0U),0U);}),0U);}),0U);}),0U);})->r;
# 3627
s->r=_tmpAAE;});}}
# 3635
...
Cyc_Toc_stmt_to_c(nv,body);
# 3648
({void*_tmpAB8=({struct _tuple1*_tmpAB7=ph_var;void*_tmpAB6=ph_struct_typ;struct Cyc_Absyn_Exp*_tmpAB5=({void*_tmp643=0U;({struct Cyc_Absyn_Exp*_tmpAAF=Cyc_Toc__new_pool_e;Cyc_Toc_fncall_exp_dl(_tmpAAF,_tag_fat(_tmp643,sizeof(struct Cyc_Absyn_Exp*),0U));});});Cyc_Absyn_declare_stmt(_tmpAB7,_tmpAB6,_tmpAB5,({
struct Cyc_Absyn_Stmt*_tmpAB4=Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmp644[1U];({struct Cyc_Absyn_Exp*_tmpAB0=
Cyc_Absyn_address_exp(ph_exp,0U);_tmp644[0]=_tmpAB0;});({struct Cyc_Absyn_Exp*_tmpAB1=Cyc_Toc__push_pool_e;Cyc_Toc_fncall_exp_dl(_tmpAB1,_tag_fat(_tmp644,sizeof(struct Cyc_Absyn_Exp*),1U));});}),0U);
# 3649
Cyc_Absyn_seq_stmt(_tmpAB4,({
# 3651
struct Cyc_Absyn_Stmt*_tmpAB3=body;Cyc_Absyn_seq_stmt(_tmpAB3,
Cyc_Absyn_exp_stmt(({void*_tmp645=0U;({struct Cyc_Absyn_Exp*_tmpAB2=Cyc_Toc__pop_pool_e;Cyc_Toc_fncall_exp_dl(_tmpAB2,_tag_fat(_tmp645,sizeof(struct Cyc_Absyn_Exp*),0U));});}),0U),0U);}),0U);}),0U);})->r;
# 3648
s->r=_tmpAB8;});
# 3654
return;}}default: _LL3C: _LL3D:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp647=({struct Cyc_Warn_String_Warn_Warg_struct _tmp80B;_tmp80B.tag=0U,({struct _fat_ptr _tmpAB9=({const char*_tmp648="bad nested declaration within function";_tag_fat(_tmp648,sizeof(char),39U);});_tmp80B.f1=_tmpAB9;});_tmp80B;});void*_tmp646[1U];_tmp646[0]=& _tmp647;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp646,sizeof(void*),1U));});}_LL2F:;}
# 3657
...
# 3681
Cyc_Toc_stmt_to_c(nv,body);{
struct Cyc_Absyn_Stmt*_tmp656=({struct Cyc_Absyn_Stmt*_tmpABB=body;Cyc_Absyn_seq_stmt(_tmpABB,
Cyc_Absyn_exp_stmt(({void*_tmp65F=0U;({struct Cyc_Absyn_Exp*_tmpABA=Cyc_Toc__pop_handler_e;Cyc_Toc_fncall_exp_dl(_tmpABA,_tag_fat(_tmp65F,sizeof(struct Cyc_Absyn_Exp*),0U));});}),0U),0U);});
# 3682
...
# 3690
struct Cyc_Absyn_Exp*_tmp658=({struct Cyc_Absyn_Exp*_tmp65D[1U];({struct Cyc_Absyn_Exp*_tmpABC=
Cyc_Toc_member_exp(h_exp,Cyc_Toc_handler_sp,0U);_tmp65D[0]=_tmpABC;});({struct Cyc_Absyn_Exp*_tmpABD=Cyc_Toc_setjmp_e;Cyc_Toc_fncall_exp_dl(_tmpABD,_tag_fat(_tmp65D,sizeof(struct Cyc_Absyn_Exp*),1U));});});
# 3690
struct Cyc_Absyn_Exp*setjmp_call=_tmp658;
# 3692
struct Cyc_Absyn_Stmt*_tmp659=
Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmp65C[1U];({struct Cyc_Absyn_Exp*_tmpABE=Cyc_Absyn_address_exp(h_exp,0U);_tmp65C[0]=_tmpABE;});({struct Cyc_Absyn_Exp*_tmpABF=Cyc_Toc__push_handler_e;Cyc_Toc_fncall_exp_dl(_tmpABF,_tag_fat(_tmp65C,sizeof(struct Cyc_Absyn_Exp*),1U));});}),0U);
# 3692
...
({void*_tmpACF=({
struct _tuple1*_tmpACE=h_var;void*_tmpACD=h_typ;Cyc_Absyn_declare_stmt(_tmpACE,_tmpACD,0,({
struct Cyc_Absyn_Stmt*_tmpACC=pushhandler_call;Cyc_Absyn_seq_stmt(_tmpACC,({
struct _tuple1*_tmpACB=was_thrown_var;void*_tmpACA=was_thrown_typ;struct Cyc_Absyn_Exp*_tmpAC9=zero_exp;Cyc_Absyn_declare_stmt(_tmpACB,_tmpACA,_tmpAC9,({
struct Cyc_Absyn_Stmt*_tmpAC8=({struct Cyc_Absyn_Exp*_tmpAC1=setjmp_call;struct Cyc_Absyn_Stmt*_tmpAC0=
Cyc_Absyn_assign_stmt(was_thrown_exp,one_exp,0U);
# 3700
Cyc_Absyn_ifthenelse_stmt(_tmpAC1,_tmpAC0,
# 3702
Cyc_Toc_skip_stmt_dl(),0U);});
# 3700
Cyc_Absyn_seq_stmt(_tmpAC8,({
# 3703
struct Cyc_Absyn_Exp*_tmpAC7=Cyc_Absyn_prim1_exp(Cyc_Absyn_Not,was_thrown_exp,0U);struct Cyc_Absyn_Stmt*_tmpAC6=tryandpop_stmt;Cyc_Absyn_ifthenelse_stmt(_tmpAC7,_tmpAC6,({
# 3705
struct _tuple1*_tmpAC5=e_var;void*_tmpAC4=e_typ;struct Cyc_Absyn_Exp*_tmpAC3=({
void*_tmpAC2=e_typ;Cyc_Toc_cast_it(_tmpAC2,Cyc_Toc_get_exn_thrown_expression());});
# 3705
Cyc_Absyn_declare_stmt(_tmpAC5,_tmpAC4,_tmpAC3,handler_stmt,0U);}),0U);}),0U);}),0U);}),0U);}),0U);})->r;
# 3696
s->r=_tmpACF;});}}
# 3709
_npop_handler(0U);return;
...
({void*_tmpAD0=Cyc_Toc_typ_to_c((f->i).ret_type);(f->i).ret_type=_tmpAD0;});
({void*_tmpAD1=Cyc_Toc_typ_to_c((void*)_check_null(f->cached_type));f->cached_type=_tmpAD1;});{
...
({void*_tmpAD2=Cyc_Toc_typ_to_c((*((struct _tuple9*)args->hd)).f3);(*((struct _tuple9*)args->hd)).f3=_tmpAD2;});}}
# 3735
if(cinclude){
Cyc_Toc_stmttypes_to_c(f->body);
_npop_handler(0U);return;}
# 3739
Cyc_Toc_fn_pop_table=({struct Cyc_Hashtable_Table**_tmp665=_cycalloc(sizeof(*_tmp665));({struct Cyc_Hashtable_Table*_tmpAD3=((struct Cyc_Hashtable_Table*(*)(struct Cyc_Hashtable_Table*t,struct Cyc_Absyn_Fndecl*key))Cyc_Hashtable_lookup)(*((struct Cyc_Hashtable_Table**)_check_null(Cyc_Toc_gpop_tables)),f);*_tmp665=_tmpAD3;});_tmp665;});
...
void*_tmp66C=Cyc_Toc_typ_to_c(Cyc_Absyn_fatptr_type(t,Cyc_Absyn_heap_rgn_type,tq,Cyc_Absyn_false_type,Cyc_Absyn_false_type));void*t2=_tmp66C;
...
({struct Cyc_List_List*_tmpAD6=({struct Cyc_List_List*_tmpAD5=(f->i).args;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmpAD5,({struct Cyc_List_List*_tmp66F=_cycalloc(sizeof(*_tmp66F));({struct _tuple9*_tmpAD4=({struct _tuple9*_tmp66E=_cycalloc(sizeof(*_tmp66E));_tmp66E->f1=n,_tmp66E->f2=tq,_tmp66E->f3=t2;_tmp66E;});_tmp66F->hd=_tmpAD4;}),_tmp66F->tl=0;_tmp66F;}));});(f->i).args=_tmpAD6;});
(f->i).cyc_varargs=0;}}
# 3748
...
({void*_tmpAD7=Cyc_Toc_typ_to_c(((struct Cyc_Absyn_Vardecl*)arg_vds->hd)->type);((struct Cyc_Absyn_Vardecl*)arg_vds->hd)->type=_tmpAD7;});}}
({struct Cyc_Toc_Env*_tmpAD8=Cyc_Toc_clear_toplevel(frgn,nv);Cyc_Toc_stmt_to_c(_tmpAD8,f->body);});}
# 3728
;_pop_region();}}
# 3753
...
v=({struct _tuple18*_tmp67C=_region_malloc(d,sizeof(*_tmp67C));_tmp67C->f1=ad,({void*_tmpAD9=Cyc_Absyn_strctq(n);_tmp67C->f2=_tmpAD9;});_tmp67C;});else{
# 3782
v=({struct _tuple18*_tmp67D=_region_malloc(d,sizeof(*_tmp67D));_tmp67D->f1=ad,({void*_tmpADA=Cyc_Absyn_unionq_type(n);_tmp67D->f2=_tmpADA;});_tmp67D;});}
({struct Cyc_Dict_Dict _tmpADB=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple1*k,struct _tuple18*v))Cyc_Dict_insert)(*aggrs_so_far,n,v);*aggrs_so_far=_tmpADB;});}}else{
# 3785
...
if(ad2->impl == 0){
({struct Cyc_Dict_Dict _tmpADE=({struct Cyc_Dict_Dict _tmpADD=*aggrs_so_far;struct _tuple1*_tmpADC=n;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple1*k,struct _tuple18*v))Cyc_Dict_insert)(_tmpADD,_tmpADC,({struct _tuple18*_tmp682=_region_malloc(d,sizeof(*_tmp682));_tmp682->f1=ad,_tmp682->f2=t;_tmp682;}));});*aggrs_so_far=_tmpADE;});
...
({struct Cyc_Absyn_AggrdeclImpl*_tmpADF=({struct Cyc_Absyn_AggrdeclImpl*_tmp683=_cycalloc(sizeof(*_tmp683));_tmp683->exist_vars=0,_tmp683->rgn_po=0,_tmp683->fields=0,_tmp683->tagged=0;_tmp683;});new_ad->impl=_tmpADF;});{
# 3804
struct Cyc_List_List*new_fields=0;
...
# 3825
old_type=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp68E=_cycalloc(sizeof(*_tmp68E));_tmp68E->tag=4U,(_tmp68E->f1).elt_type=et,(_tmp68E->f1).tq=tq,({struct Cyc_Absyn_Exp*_tmpAE0=Cyc_Absyn_uint_exp(0U,0U);(_tmp68E->f1).num_elts=_tmpAE0;}),(_tmp68E->f1).zero_term=zt,(_tmp68E->f1).zt_loc=ztl;_tmp68E;});
goto _LL9;}}else{_LLC: _LLD:
# 3828
 old_atts=({struct Cyc_List_List*_tmp690=_cycalloc(sizeof(*_tmp690));({void*_tmpAE1=(void*)({struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_tmp68F=_cycalloc(sizeof(*_tmp68F));_tmp68F->tag=6U,_tmp68F->f1=0;_tmp68F;});_tmp690->hd=_tmpAE1;}),_tmp690->tl=old_atts;_tmp690;});
old_type=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp691=_cycalloc(sizeof(*_tmp691));_tmp691->tag=4U,({void*_tmpAE4=Cyc_Toc_void_star_type();(_tmp691->f1).elt_type=_tmpAE4;}),({
struct Cyc_Absyn_Tqual _tmpAE3=Cyc_Absyn_empty_tqual(0U);(_tmp691->f1).tq=_tmpAE3;}),({
struct Cyc_Absyn_Exp*_tmpAE2=Cyc_Absyn_uint_exp(0U,0U);(_tmp691->f1).num_elts=_tmpAE2;}),(_tmp691->f1).zero_term=Cyc_Absyn_false_type,(_tmp691->f1).zt_loc=0U;_tmp691;});}_LL9:;}{
# 3835
...
# 3837
void*_tmpAE6=Cyc_Toc_typ_to_c(old_type);_tmp6A3->type=_tmpAE6;}),_tmp6A3->width=old_field->width,({
# 3839
struct Cyc_List_List*_tmpAE5=Cyc_Atts_atts2c(old_atts);_tmp6A3->attributes=_tmpAE5;}),_tmp6A3->requires_clause=0;_tmp6A3;});
# 3835
...
struct Cyc_Absyn_Aggrdecl*_tmp697=({struct _fat_ptr*_tmpAE8=str;Cyc_Toc_make_c_struct_defn(_tmpAE8,({struct Cyc_Absyn_Aggrfield*_tmp69A[2U];_tmp69A[0]=tag_field,_tmp69A[1]=value_field;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp69A,sizeof(struct Cyc_Absyn_Aggrfield*),2U));}));});struct Cyc_Absyn_Aggrdecl*ad2=_tmp697;
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp699=_cycalloc(sizeof(*_tmp699));({struct Cyc_Absyn_Decl*_tmpAE9=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp698=_cycalloc(sizeof(*_tmp698));_tmp698->tag=6U,_tmp698->f1=ad2;_tmp698;}),0U);_tmp699->hd=_tmpAE9;}),_tmp699->tl=Cyc_Toc_result_decls;_tmp699;});
({void*_tmpAEA=Cyc_Absyn_strct(str);new_field->type=_tmpAEA;});}
# 3856
new_fields=({struct Cyc_List_List*_tmp6A2=_cycalloc(sizeof(*_tmp6A2));_tmp6A2->hd=new_field,_tmp6A2->tl=new_fields;_tmp6A2;});}}}
# 3858
({struct Cyc_List_List*_tmpAEB=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(new_fields);(new_ad->impl)->fields=_tmpAEB;});}}
# 3861
if(!seen_defn_before)
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp6A6=_cycalloc(sizeof(*_tmp6A6));({struct Cyc_Absyn_Decl*_tmpAED=({struct Cyc_Absyn_Decl*_tmp6A5=_cycalloc(sizeof(*_tmp6A5));({void*_tmpAEC=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp6A4=_cycalloc(sizeof(*_tmp6A4));_tmp6A4->tag=6U,_tmp6A4->f1=new_ad;_tmp6A4;});_tmp6A5->r=_tmpAEC;}),_tmp6A5->loc=0U;_tmp6A5;});_tmp6A6->hd=_tmpAED;}),_tmp6A6->tl=Cyc_Toc_result_decls;_tmp6A6;});
return 0;}}}}
# 3865
static void Cyc_Toc_aggrdecl_to_c(struct Cyc_Absyn_Aggrdecl*ad){
...
return 0;
({struct Cyc_Set_Set*_tmpAEE=((struct Cyc_Set_Set*(*)(struct _RegionHandle*r,struct Cyc_Set_Set*s,struct _tuple1*elt))Cyc_Set_rinsert)(d,*datatypes_so_far,n);*datatypes_so_far=_tmpAEE;});
...
void*_tmpAEF=Cyc_Toc_typ_to_c((*((struct _tuple23*)ts->hd)).f2);_tmp6B3->type=_tmpAEF;}),_tmp6B3->width=0,_tmp6B3->attributes=0,_tmp6B3->requires_clause=0;_tmp6B3;});
# 3908
...
# 3912
fs=({struct Cyc_List_List*_tmp6B5=_cycalloc(sizeof(*_tmp6B5));({struct Cyc_Absyn_Aggrfield*_tmpAF1=({struct Cyc_Absyn_Aggrfield*_tmp6B4=_cycalloc(sizeof(*_tmp6B4));_tmp6B4->name=Cyc_Toc_tag_sp,_tmp6B4->tq=Cyc_Toc_mt_tq,_tmp6B4->type=Cyc_Absyn_sint_type,_tmp6B4->width=0,_tmp6B4->attributes=0,_tmp6B4->requires_clause=0;_tmp6B4;});_tmp6B5->hd=_tmpAF1;}),({
struct Cyc_List_List*_tmpAF0=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(fs);_tmp6B5->tl=_tmpAF0;});_tmp6B5;});{
struct Cyc_Absyn_Aggrdecl*_tmp6B6=({struct _fat_ptr*_tmpAF3=({struct _fat_ptr*_tmp6BA=_cycalloc(sizeof(*_tmp6BA));({struct _fat_ptr _tmpAF2=({const char*_tmp6B9="";_tag_fat(_tmp6B9,sizeof(char),1U);});*_tmp6BA=_tmpAF2;});_tmp6BA;});Cyc_Toc_make_c_struct_defn(_tmpAF3,fs);});struct Cyc_Absyn_Aggrdecl*ad=_tmp6B6;
({struct _tuple1*_tmpAF4=Cyc_Toc_collapse_qvars(f->name,tud->name);ad->name=_tmpAF4;});
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp6B8=_cycalloc(sizeof(*_tmp6B8));({struct Cyc_Absyn_Decl*_tmpAF5=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp6B7=_cycalloc(sizeof(*_tmp6B7));_tmp6B7->tag=6U,_tmp6B7->f1=ad;_tmp6B7;}),0U);_tmp6B8->hd=_tmpAF5;}),_tmp6B8->tl=Cyc_Toc_result_decls;_tmp6B8;});}}}
# 3918
return 0;}}
# 3921
static void Cyc_Toc_datatypedecl_to_c(struct Cyc_Absyn_Datatypedecl*tud){
...
tag_decl->sc=f->sc;
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp6CA=_cycalloc(sizeof(*_tmp6CA));({struct Cyc_Absyn_Decl*_tmpAF6=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp6C9=_cycalloc(sizeof(*_tmp6C9));_tmp6C9->tag=0U,_tmp6C9->f1=tag_decl;_tmp6C9;}),0U);_tmp6CA->hd=_tmpAF6;}),_tmp6CA->tl=Cyc_Toc_result_decls;_tmp6CA;});
({struct Cyc_Dict_Dict _tmpAF7=
...
# 3963
*xdatatypes_so_far=_tmpAF7;});{
# 3965
struct Cyc_List_List*fields=0;
int i=1;
{struct Cyc_List_List*_tmp6CB=f->typs;struct Cyc_List_List*tqts=_tmp6CB;for(0;tqts != 0;(tqts=tqts->tl,i ++)){
struct _fat_ptr*_tmp6CC=({struct _fat_ptr*_tmp6D3=_cycalloc(sizeof(*_tmp6D3));({struct _fat_ptr _tmpAF9=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp6D2=({struct Cyc_Int_pa_PrintArg_struct _tmp80E;_tmp80E.tag=1U,_tmp80E.f1=(unsigned long)i;_tmp80E;});void*_tmp6D0[1U];_tmp6D0[0]=& _tmp6D2;({struct _fat_ptr _tmpAF8=({const char*_tmp6D1="f%d";_tag_fat(_tmp6D1,sizeof(char),4U);});Cyc_aprintf(_tmpAF8,_tag_fat(_tmp6D0,sizeof(void*),1U));});});*_tmp6D3=_tmpAF9;});_tmp6D3;});struct _fat_ptr*field_n=_tmp6CC;
...
void*_tmpAFA=Cyc_Toc_typ_to_c((*((struct _tuple23*)tqts->hd)).f2);_tmp6CF->type=_tmpAFA;}),_tmp6CF->width=0,_tmp6CF->attributes=0,_tmp6CF->requires_clause=0;_tmp6CF;});
# 3969
...
# 3973
fields=({struct Cyc_List_List*_tmp6D5=_cycalloc(sizeof(*_tmp6D5));({struct Cyc_Absyn_Aggrfield*_tmpAFD=({struct Cyc_Absyn_Aggrfield*_tmp6D4=_cycalloc(sizeof(*_tmp6D4));_tmp6D4->name=Cyc_Toc_tag_sp,_tmp6D4->tq=Cyc_Toc_mt_tq,({
void*_tmpAFC=Cyc_Absyn_cstar_type(Cyc_Absyn_char_type,Cyc_Toc_mt_tq);_tmp6D4->type=_tmpAFC;}),_tmp6D4->width=0,_tmp6D4->attributes=0,_tmp6D4->requires_clause=0;_tmp6D4;});
# 3973
_tmp6D5->hd=_tmpAFD;}),({
# 3975
struct Cyc_List_List*_tmpAFB=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(fields);_tmp6D5->tl=_tmpAFB;});_tmp6D5;});{
struct Cyc_Absyn_Aggrdecl*_tmp6D6=({struct _fat_ptr*_tmpAFF=({struct _fat_ptr*_tmp6DA=_cycalloc(sizeof(*_tmp6DA));({struct _fat_ptr _tmpAFE=({const char*_tmp6D9="";_tag_fat(_tmp6D9,sizeof(char),1U);});*_tmp6DA=_tmpAFE;});_tmp6DA;});Cyc_Toc_make_c_struct_defn(_tmpAFF,fields);});struct Cyc_Absyn_Aggrdecl*strct_decl=_tmp6D6;
({struct _tuple1*_tmpB00=Cyc_Toc_collapse_qvars(f->name,xd->name);strct_decl->name=_tmpB00;});
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp6D8=_cycalloc(sizeof(*_tmp6D8));({struct Cyc_Absyn_Decl*_tmpB01=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp6D7=_cycalloc(sizeof(*_tmp6D7));_tmp6D7->tag=6U,_tmp6D7->f1=strct_decl;_tmp6D7;}),0U);_tmp6D8->hd=_tmpB01;}),_tmp6D8->tl=Cyc_Toc_result_decls;_tmp6D8;});
...
tag_decl->sc=f->sc;
Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp6DE=_cycalloc(sizeof(*_tmp6DE));({struct Cyc_Absyn_Decl*_tmpB02=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp6DD=_cycalloc(sizeof(*_tmp6DD));_tmp6DD->tag=0U,_tmp6DD->f1=tag_decl;_tmp6DD;}),0U);_tmp6DE->hd=_tmpB02;}),_tmp6DE->tl=Cyc_Toc_result_decls;_tmp6DE;});
({struct Cyc_Dict_Dict _tmpB03=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple1*k,int v))Cyc_Dict_insert)(*xdatatypes_so_far,f->name,1);*xdatatypes_so_far=_tmpB03;});}
# 3988
...
({void*_tmpB04=Cyc_Toc_typ_to_c(old_typ);vd->type=_tmpB04;});
# 4009
...
if(Cyc_Tcutil_force_type2bool(0,zt)){
if(num_elts_opt == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp6E7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp80F;_tmp80F.tag=0U,({struct _fat_ptr _tmpB05=({const char*_tmp6E8="can't initialize zero-terminated array -- size unknown";_tag_fat(_tmp6E8,sizeof(char),55U);});_tmp80F.f1=_tmpB05;});_tmp80F;});void*_tmp6E6[1U];_tmp6E6[0]=& _tmp6E7;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp6E6,sizeof(void*),1U));});{
struct Cyc_Absyn_Exp*num_elts=num_elts_opt;
struct Cyc_Absyn_Exp*_tmp6E9=({struct Cyc_Absyn_Exp*_tmpB07=Cyc_Absyn_var_exp(vd->name,0U);Cyc_Absyn_subscript_exp(_tmpB07,({
struct Cyc_Absyn_Exp*_tmpB06=num_elts;Cyc_Absyn_add_exp(_tmpB06,Cyc_Absyn_signed_int_exp(- 1,0U),0U);}),0U);});
# 4032
...
({void*_tmpB09=({struct Cyc_Absyn_Stmt*_tmpB08=Cyc_Absyn_exp_stmt(Cyc_Absyn_assign_exp(lhs,rhs,0U),0U);Cyc_Toc_seq_stmt_r(_tmpB08,
...
({void*_tmpB0B=Cyc_Toc_rewrite_decision(*d2,success);*d2=_tmpB0B;});}}
# 4057
return d;}}_LL0:;}
# 4068 "toc.cyc"
...
struct Cyc_List_List*_tmp6F8=({struct _RegionHandle*_tmpB0E=rgn;struct _RegionHandle*_tmpB0D=rgn;((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple37*(*f)(struct _RegionHandle*,struct Cyc_Absyn_Switch_clause*),struct _RegionHandle*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(_tmpB0E,Cyc_Toc_gen_labels,_tmpB0D,({struct Cyc_Absyn_Switch_clause*_tmp705[1U];_tmp705[0]=c1;({struct _RegionHandle*_tmpB0C=rgn;((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _fat_ptr))Cyc_List_rlist)(_tmpB0C,_tag_fat(_tmp705,sizeof(struct Cyc_Absyn_Switch_clause*),1U));});}));});struct Cyc_List_List*lscs=_tmp6F8;
# 4089
struct Cyc_List_List*mydecls=0;
struct Cyc_List_List*mybodies=0;
# 4093
...
# 4101
({struct Cyc_Warn_String_Warn_Warg_struct _tmp6FE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp810;_tmp810.tag=0U,({struct _fat_ptr _tmpB0F=({const char*_tmp6FF="letdecl_to_c: couldn't find env!";_tag_fat(_tmp6FF,sizeof(char),33U);});_tmp810.f1=_tmpB0F;});_tmp810;});void*_tmp6FD[1U];_tmp6FD[0]=& _tmp6FE;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp6FD,sizeof(void*),1U));});
FOUND_ENV:
# 4105
...
res=({struct Cyc_Absyn_Decl*_tmpB10=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp703=_cycalloc(sizeof(*_tmp703));_tmp703->tag=0U,_tmp703->f1=vd;_tmp703;}),0U);Cyc_Absyn_decl_stmt(_tmpB10,res,0U);});}}
# 4114
res=({struct _tuple1*_tmpB13=v;void*_tmpB12=Cyc_Toc_typ_to_c(t);struct Cyc_Absyn_Exp*_tmpB11=e;Cyc_Absyn_declare_stmt(_tmpB13,_tmpB12,_tmpB11,res,0U);});{
...
({void*_tmpB14=Cyc_Toc_typ_to_c(*t);*t=_tmpB14;});Cyc_Toc_exptypes_to_c(e);goto _LL0;}case 25U: _LL27: _tmp711=(void**)&(((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp708)->f1)->f3;_tmp712=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp708)->f2;_LL28: {void**t=_tmp711;struct Cyc_List_List*dles=_tmp712;
# 4147
({void*_tmpB15=Cyc_Toc_typ_to_c(*t);*t=_tmpB15;});
...
({void*_tmpB16=Cyc_Toc_typ_to_c(*t);*t=_tmpB16;});goto _LL0;}case 37U: _LL31: _tmp70C=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp708)->f1;_LL32: {struct Cyc_Absyn_Stmt*s=_tmp70C;
...
# 4158
if(m->elt_type != 0)
({void**_tmpB18=({void**_tmp730=_cycalloc(sizeof(*_tmp730));({void*_tmpB17=Cyc_Toc_typ_to_c(*((void**)_check_null(m->elt_type)));*_tmp730=_tmpB17;});_tmp730;});m->elt_type=_tmpB18;});
...
({void*_tmp731=0U;({unsigned _tmpB1A=e->loc;struct _fat_ptr _tmpB19=({const char*_tmp732="Cyclone expression in C code";_tag_fat(_tmp732,sizeof(char),29U);});((int(*)(unsigned,struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos_loc)(_tmpB1A,_tmpB19,_tag_fat(_tmp731,sizeof(void*),0U));});});}_LL0:;}
# 4186
...
# 4189
({void*_tmpB1B=Cyc_Toc_typ_to_c(vd->type);vd->type=_tmpB1B;});
...
# 4193
({void*_tmpB1C=Cyc_Toc_typ_to_c((fd->i).ret_type);(fd->i).ret_type=_tmpB1C;});
{struct Cyc_List_List*_tmp73A=(fd->i).args;struct Cyc_List_List*args=_tmp73A;for(0;args != 0;args=args->tl){
({void*_tmpB1D=Cyc_Toc_typ_to_c((*((struct _tuple9*)args->hd)).f3);(*((struct _tuple9*)args->hd)).f3=_tmpB1D;});}}
...
({void*_tmpB1E=Cyc_Toc_typ_to_c((void*)_check_null(td->defn));td->defn=_tmpB1E;});goto _LL0;}case 2U: _LLB: _LLC:
...
# 4215
({void*_tmp73D=0U;({unsigned _tmpB20=d->loc;struct _fat_ptr _tmpB1F=({const char*_tmp73E="Cyclone declaration in C code";_tag_fat(_tmp73E,sizeof(char),30U);});((int(*)(unsigned,struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos_loc)(_tmpB20,_tmpB1F,_tag_fat(_tmp73D,sizeof(void*),0U));});});case 14U: _LL1D: _LL1E:
...
# 4248
({void*_tmpB21=(void*)({struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*_tmp756=_cycalloc(sizeof(*_tmp756));_tmp756->tag=0U;_tmp756;});s->r=_tmpB21;});goto _LL0;default: _LL1F: _LL20:
({void*_tmp757=0U;({unsigned _tmpB23=s->loc;struct _fat_ptr _tmpB22=({const char*_tmp758="Cyclone statement in C code";_tag_fat(_tmp758,sizeof(char),28U);});((int(*)(unsigned,struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos_loc)(_tmpB23,_tmpB22,_tag_fat(_tmp757,sizeof(void*),0U));});});}_LL0:;}
# 4256
...
for(0;ds != 0;ds=ds->tl){
if(!Cyc_Toc_is_toplevel(nv))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp75A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp811;_tmp811.tag=0U,({struct _fat_ptr _tmpB24=({const char*_tmp75B="decls_to_c: not at toplevel!";_tag_fat(_tmp75B,sizeof(char),29U);});_tmp811.f1=_tmpB24;});_tmp811;});void*_tmp759[1U];_tmp759[0]=& _tmp75A;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp759,sizeof(void*),1U));});
...
c_name=({struct _tuple1*_tmp769=_cycalloc(sizeof(*_tmp769));({union Cyc_Absyn_Nmspace _tmpB25=Cyc_Absyn_Abs_n(0,1);_tmp769->f1=_tmpB25;}),_tmp769->f2=(*c_name).f2;_tmp769;});
if(vd->initializer != 0){
...
# 4276
vd->name=c_name;
({enum Cyc_Absyn_Scope _tmpB26=Cyc_Toc_scope_to_c(vd->sc);vd->sc=_tmpB26;});
({void*_tmpB27=Cyc_Toc_typ_to_c(vd->type);vd->type=_tmpB27;});
...
({struct _tuple1*_tmpB29=({struct _tuple1*_tmp76B=_cycalloc(sizeof(*_tmp76B));({union Cyc_Absyn_Nmspace _tmpB28=Cyc_Absyn_Abs_n(0,1);_tmp76B->f1=_tmpB28;}),_tmp76B->f2=(*fd->name).f2;_tmp76B;});fd->name=_tmpB29;});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp76E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp812;_tmp812.tag=0U,({struct _fat_ptr _tmpB2A=({const char*_tmp76F="letdecl at toplevel";_tag_fat(_tmp76F,sizeof(char),20U);});_tmp812.f1=_tmpB2A;});_tmp812;});void*_tmp76D[1U];_tmp76D[0]=& _tmp76E;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp76D,sizeof(void*),1U));});case 5U: _LL9: _LLA:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp771=({struct Cyc_Warn_String_Warn_Warg_struct _tmp813;_tmp813.tag=0U,({struct _fat_ptr _tmpB2B=({const char*_tmp772="pool decl at toplevel";_tag_fat(_tmp772,sizeof(char),22U);});_tmp813.f1=_tmpB2B;});_tmp813;});void*_tmp770[1U];_tmp770[0]=& _tmp771;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp770,sizeof(void*),1U));});case 4U: _LLB: _LLC:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp774=({struct Cyc_Warn_String_Warn_Warg_struct _tmp814;_tmp814.tag=0U,({struct _fat_ptr _tmpB2C=({const char*_tmp775="region decl at toplevel";_tag_fat(_tmp775,sizeof(char),24U);});_tmp814.f1=_tmpB2C;});_tmp814;});void*_tmp773[1U];_tmp773[0]=& _tmp774;((int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos2)(_tag_fat(_tmp773,sizeof(void*),1U));});case 6U: _LLD: _tmp765=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp75D)->f1;_LLE: {struct Cyc_Absyn_Aggrdecl*sd=_tmp765;
...
td->tvs=0;
if(td->defn != 0){
({void*_tmpB2D=Cyc_Toc_typ_to_c((void*)_check_null(td->defn));td->defn=_tmpB2D;});{
# 4308
...
# 4311
ed=({struct Cyc_Absyn_Decl*_tmp77C=_cycalloc(sizeof(*_tmp77C));({void*_tmpB2E=(void*)({struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*_tmp77B=_cycalloc(sizeof(*_tmp77B));_tmp77B->tag=8U,_tmp77B->f1=ed2;_tmp77B;});_tmp77C->r=_tmpB2E;}),_tmp77C->loc=loc;_tmp77C;});goto _LL25;}}else{goto _LL28;}}else{goto _LL28;}}else{_LL28: _LL29:
 ed=0;}_LL25:;}
# 4314
if(ed != 0){
...
# 4318
({void*_tmpB30=(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp782=_cycalloc(sizeof(*_tmp782));_tmp782->tag=0U,({void*_tmpB2F=(void*)({struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*_tmp781=_cycalloc(sizeof(*_tmp781));_tmp781->tag=15U,_tmp781->f1=ed->name,_tmp781->f2=ed;_tmp781;});_tmp782->f1=_tmpB2F;}),_tmp782->f2=0;_tmp782;});td->defn=_tmpB30;});goto _LL2A;}}else{_LL2D: _LL2E:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp784=({struct Cyc_Warn_String_Warn_Warg_struct _tmp815;_tmp815.tag=0U,({struct _fat_ptr _tmpB31=({const char*_tmp785="Toc: enumdecl to name";_tag_fat(_tmp785,sizeof(char),22U);});_tmp815.f1=_tmpB31;});_tmp815;});void*_tmp783[1U];_tmp783[0]=& _tmp784;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp783,sizeof(void*),1U));});}_LL2A:;}}}}else{
# 4323
...
({void*_tmpB32=Cyc_Toc_void_star_type();td->defn=_tmpB32;});goto _LL2F;}else{_LL32: _LL33:
...
({struct _RegionHandle*_tmpB34=start;struct Cyc_Toc_Env*_tmpB33=Cyc_Toc_empty_env(start);Cyc_Toc_decls_to_c(_tmpB34,_tmpB33,ds,0);});{
