...
{struct _fat_ptr _Tmp4=({struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,_Tmp6.f1=(struct _fat_ptr)((struct _fat_ptr)*s);_Tmp6;});struct Cyc_String_pa_PrintArg_struct _Tmp6=({struct Cyc_String_pa_PrintArg_struct _Tmp7;_Tmp7.tag=0,({struct _fat_ptr _Tmp8=(struct _fat_ptr)((struct _fat_ptr)Cyc_rstr_sepstr(r,vs,_tag_fat("_",sizeof(char),2U)));_Tmp7.f1=_Tmp8;});_Tmp7;});struct Cyc_String_pa_PrintArg_struct _Tmp7=({struct Cyc_String_pa_PrintArg_struct _Tmp8;_Tmp8.tag=0,_Tmp8.f1=(struct _fat_ptr)((struct _fat_ptr)*v);_Tmp8;});void*_Tmp8[3];_Tmp8[0]=& _Tmp5,_Tmp8[1]=& _Tmp6,_Tmp8[2]=& _Tmp7;Cyc_aprintf(_tag_fat("%s_%s_%s_struct",sizeof(char),16U),_tag_fat(_Tmp8,sizeof(void*),3));});_npop_handler(0);return _Tmp4;};_pop_region();}}};}}struct _tuple20{struct Cyc_Toc_TocState*f0;struct _tuple14*f1;};
# 414
...
# 421
struct _tuple14*new_pair;new_pair=_cycalloc(sizeof(struct _tuple14)),new_pair->f0=fieldname,new_pair->f1=dtname;{
...
return({(void*(*)(struct _tuple24*,void*(*)(struct _RegionHandle*,struct _tuple25*)))Cyc_Toc_use_toc_state;})(({struct _tuple24*_Tmp0=_cycalloc(sizeof(struct _tuple24));_Tmp0->f0=ak,_Tmp0->f1=fs;_Tmp0;}),Cyc_Toc_add_anon_aggr_type_body);}struct _tuple27{struct _tuple1*f0;struct Cyc_List_List*f1;struct Cyc_List_List*f2;struct Cyc_List_List*f3;};struct _tuple28{struct Cyc_Toc_TocState*f0;struct _tuple27*f1;};struct _tuple29{struct _tuple1*f0;struct Cyc_List_List*f1;void*f2;};
# 511
...
return({struct _tuple1*_Tmp0=_cycalloc(sizeof(struct _tuple1));_Tmp0->f0=Cyc_Absyn_Loc_n,({struct _fat_ptr*_Tmp1=({struct _fat_ptr*_Tmp2=_cycalloc(sizeof(struct _fat_ptr));({struct _fat_ptr _Tmp3=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _Tmp4=({struct Cyc_Int_pa_PrintArg_struct _Tmp5;_Tmp5.tag=1,_Tmp5.f1=(unsigned)Cyc_Toc_temp_var_counter ++;_Tmp5;});void*_Tmp5[1];_Tmp5[0]=& _Tmp4;Cyc_aprintf(_tag_fat("_tmp%X",sizeof(char),7U),_tag_fat(_Tmp5,sizeof(void*),1));});*_Tmp2=_Tmp3;});_Tmp2;});_Tmp0->f1=_Tmp1;});_Tmp0;});}struct _tuple30{struct _tuple1*f0;struct Cyc_Absyn_Exp*f1;};
# 600
struct _tuple30 Cyc_Toc_temp_var_and_exp (void){
struct _tuple1*v=Cyc_Toc_temp_var();
return({struct _tuple30 _Tmp0;_Tmp0.f0=v,({struct Cyc_Absyn_Exp*_Tmp1=Cyc_Absyn_var_exp(v,0U);_Tmp0.f1=_Tmp1;});_Tmp0;});}struct _tuple31{struct Cyc_Toc_TocState*f0;int f1;};
# 607
...
return({struct _tuple9*_Tmp0=_cycalloc(sizeof(struct _tuple9));_Tmp0->f0=0,_Tmp0->f1=(*a).f1,({void*_Tmp1=Cyc_Toc_typ_to_c((*a).f2);_Tmp0->f2=_Tmp1;});_Tmp0;});}
# 659 "toc.cyc"
...
# 742
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_Tmp9=_cycalloc(sizeof(struct Cyc_Absyn_FnType_Absyn_Type_struct));_Tmp9->tag=5,_Tmp9->f1.tvars=0,_Tmp9->f1.effect=0,_Tmp9->f1.ret_tqual=tq2,({void*_TmpA=Cyc_Toc_typ_to_c(t2);_Tmp9->f1.ret_type=_TmpA;}),_Tmp9->f1.args=new_args,_Tmp9->f1.c_varargs=c_vararg,_Tmp9->f1.cyc_varargs=0,_Tmp9->f1.rgn_po=0,_Tmp9->f1.qual_bnd=0,_Tmp9->f1.attributes=new_atts,_Tmp9->f1.requires_clause=0,_Tmp9->f1.requires_relns=0,_Tmp9->f1.ensures_clause=0,_Tmp9->f1.ensures_relns=0,_Tmp9->f1.return_value=0,_Tmp9->f1.arg_vardecls=0;_Tmp9;});}case 6: _Tmp0=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)t)->f1;_Tmp8=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)t)->f3;{enum Cyc_Absyn_AggrKind k=_Tmp0;struct Cyc_List_List*fs=_Tmp8;
# 747
...
# 786
if(topt==0)
return ts==0?t:(void*)({struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_Tmp9=_cycalloc(sizeof(struct Cyc_Absyn_TypedefType_Absyn_Type_struct));_Tmp9->tag=7,_Tmp9->f1=tdn,_Tmp9->f2=0,_Tmp9->f3=td,_Tmp9->f4=0;_Tmp9;});
...
void*_Tmp3;void*_Tmp4;union Cyc_Absyn_AggrInfo _Tmp5;switch(*((int*)c)){case 0:
 ...
 goto _LL19;case 20: _LL19: goto _LL1B;case 21: _LL1B: return 1;case 23:
...
_Tmp1=_check_null(ad->impl)->fields;goto _LL4;}}else{goto _LL5;}case 6: _Tmp1=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp0)->f3;_LL4: {struct Cyc_List_List*fs=_Tmp1;
# 882
...
return({struct _tuple23*_Tmp0=_cycalloc(sizeof(struct _tuple23));_Tmp0->f0=Cyc_Toc_mt_tq,({void*_Tmp1=Cyc_Toc_typ_to_c(_check_null(e->topt));_Tmp0->f1=_Tmp1;});_Tmp0;});}
# 1206
...
goto _LL7;}case 1:
 goto _LL7;case 41:
({void*_TmpB=Cyc_Absyn_int_exp(0U,1,0U)->r;e->r=_TmpB;});goto _LL7;case 40: _TmpA=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{struct Cyc_Absyn_Exp*e1=_TmpA;
...
# 1652
(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_Tmp12,sizeof(void*),2));});}_LL75:;}
# 1655
goto _LL60;}case Cyc_Absyn_Plus:
# 1660
 if(Cyc_Toc_is_toplevel(nv))
...
goto _LL7A;}_LL7A:;}
# 1681
goto _LL60;case Cyc_Absyn_Minus:  {
# 1686
...
switch((int)incr){case Cyc_Absyn_PreInc:
 op=0U;goto _LL7F;case Cyc_Absyn_PreDec:
 op=2U;goto _LL7F;default:
...
# 1748
(int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2;})(e->loc,_tag_fat(_TmpE,sizeof(void*),3));});}_LL7F:;
# 1751
...
{enum Cyc_Absyn_Primop _TmpB=(enum Cyc_Absyn_Primop)popt->v;switch((int)_TmpB){case Cyc_Absyn_Plus:
 change=e2;goto _LL86;case Cyc_Absyn_Minus:
 change=Cyc_Absyn_prim1_exp(2U,e2,0U);goto _LL86;default:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpC=({struct Cyc_Warn_String_Warn_Warg_struct _TmpD;_TmpD.tag=0,_TmpD.f1=_tag_fat("bad t ? pointer arithmetic",sizeof(char),27U);_TmpD;});void*_TmpD[1];_TmpD[0]=& _TmpC;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpD,sizeof(void*),1));});}_LL86:;}
# 1864
done=1;{
# 1866
...
# 1884
goto _LL8D;}else{
({struct Cyc_Warn_String_Warn_Warg_struct _TmpC=({struct Cyc_Warn_String_Warn_Warg_struct _TmpD;_TmpD.tag=0,_TmpD.f1=_tag_fat("bad zero-terminated pointer arithmetic",sizeof(char),39U);_TmpD;});void*_TmpD[1];_TmpD[0]=& _TmpC;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpD,sizeof(void*),1));});}_LL8D:;}}}
# 1888
if(!done){
# 1890
if(e1_poly)
...
({struct Cyc_Absyn_Exp*_TmpB=e1;({(void(*)(struct Cyc_Absyn_Exp*,struct Cyc_List_List*,struct Cyc_Absyn_Exp*(*)(struct Cyc_Absyn_Exp*,struct _tuple33*),struct _tuple33*))Cyc_Toc_lvalue_assign;})(_TmpB,0,Cyc_Toc_assignop_lvalue,({struct _tuple33*_TmpC=_cycalloc(sizeof(struct _tuple33));_TmpC->f0=popt,_TmpC->f1=e2;_TmpC;}));});
*e=*e1;}}
# 1901
...
tud=x;goto _LL95;}}else{goto _LL98;}}else{goto _LL98;}}else{_LL98:
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp11=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp12;_Tmp12.tag=0,_Tmp12.f1=_tag_fat("unknown datatype in vararg with inject",sizeof(char),39U);_Tmp12;});void*_Tmp12[1];_Tmp12[0]=& _Tmp11;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_Tmp12,sizeof(void*),1));});}_LL95:;}{
# 1971
...
{void*_Tmp15=e1->r;void*_Tmp16;switch(*((int*)_Tmp15)){case 0: switch(((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_Tmp15)->f1.Wstring_c.tag){case 8:
 arg3=e2;goto _LLB3;case 9:
 arg3=e2;goto _LLB3;default: goto _LLBC;}case 1: switch(*((int*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp15)->f1)){case 1: _Tmp16=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp15)->f1)->f1;{struct Cyc_Absyn_Vardecl*vd=_Tmp16;
_Tmp16=vd;goto _LLBB;}case 4: _Tmp16=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp15)->f1)->f1;_LLBB: {struct Cyc_Absyn_Vardecl*vd=_Tmp16;
# 2096
if(!Cyc_Tcutil_is_array_type(vd->type))
goto _LLBD;
arg3=e2;
goto _LLB3;}default: goto _LLBC;}default: _LLBC: _LLBD:
# 2103
...
goto _LLA4;}}_LLA4:;}
# 2178
goto _LL9D;}case 0: if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_TmpB.f1)->f1)==1){_TmpD=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_TmpB.f0)->f1;{struct Cyc_Absyn_PtrInfo p1=_TmpD;
# 2180
...
goto _LLBE;}_LLBE:;}
# 2187
goto _LL9D;}}else{goto _LLA2;}default: goto _LLA2;}else{_LLA2:
# 2189
 if(Cyc_Unify_unify(old_t2_c,new_typ_c))
*e=*e1;
goto _LL9D;}_LL9D:;}
...
elt_typ=Cyc_Toc_typ_to_c(t2);goto _LLC3;}}else{
goto _LLC3;}_LLC3:;}{
# 2220
...
ta=p.elt_type;goto _LLC8;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("get_ptr_typ: not a pointer!",sizeof(char),28U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLC8:;}
# 2286
did_inserted_checks=1;
...
e->topt=strct_typ;
goto _LLD0;}}else{goto _LLD3;}}else{goto _LLD3;}}else{_LLD3:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("anonStruct type not an aggregate",sizeof(char),33U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLD0:;}else{
# 2364
...
({struct _tuple1*_TmpD=Cyc_Absyn_aggr_kinded_name(info).f1;*tdn=_TmpD;});goto _LLD5;}}else{goto _LLD8;}}else{_LLD8:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("exp_to_c, Aggregate_e: bad type translation",sizeof(char),44U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLD5:;}{
# 2381
...
struct _fat_ptr*_Tmp10=({struct _fat_ptr*_Tmp11=_cycalloc(sizeof(struct _fat_ptr));({struct _fat_ptr _Tmp12=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _Tmp13=({struct Cyc_String_pa_PrintArg_struct _Tmp14;_Tmp14.tag=0,_Tmp14.f1=(struct _fat_ptr)((struct _fat_ptr)*(*sd->name).f1);_Tmp14;});struct Cyc_String_pa_PrintArg_struct _Tmp14=({struct Cyc_String_pa_PrintArg_struct _Tmp15;_Tmp15.tag=0,_Tmp15.f1=(struct _fat_ptr)((struct _fat_ptr)*n);_Tmp15;});void*_Tmp15[2];_Tmp15[0]=& _Tmp13,_Tmp15[1]=& _Tmp14;Cyc_aprintf(_tag_fat("_union_%s_%s",sizeof(char),13U),_tag_fat(_Tmp15,sizeof(void*),2));});*_Tmp11=_Tmp12;});_Tmp11;});s->f1=_Tmp10;});{
# 2410
...
# 2450
new_f->type=_check_null(fieldexp->topt);goto _LLE7;}else{goto _LLEA;}}else{_LLEA:
 goto _LLE7;}_LLE7:;}
# 2453
goto _LLE2;}_LLE2:;}
# 2457
...
# 2472
goto _LLDA;}}else{goto _LLDD;}}else{_LLDD:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpD=({struct Cyc_Warn_String_Warn_Warg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=_tag_fat("exp_to_c, Aggregate_e: bad struct type",sizeof(char),39U);_TmpE;});void*_TmpE[1];_TmpE[0]=& _TmpD;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpE,sizeof(void*),1));});}_LLDA:;}else{
# 2481
if(_check_null(sd->impl)->tagged){
# 2483
struct _tuple36*_TmpB=(struct _tuple36*)fields->hd;void*_TmpC;void*_TmpD;_TmpD=_TmpB->f0;_TmpC=_TmpB->f1;{struct Cyc_Absyn_Aggrfield*field=_TmpD;struct Cyc_Absyn_Exp*fieldexp=_TmpC;
...
goto _LLF2;}}else{goto _LLF5;}}else{goto _LLF5;}}else{_LLF5:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpC=({struct Cyc_Warn_String_Warn_Warg_struct _TmpD;_TmpD.tag=0,_TmpD.f1=_tag_fat("non-aggregate type in tagcheck",sizeof(char),31U);_TmpD;});void*_TmpD[1];_TmpD[0]=& _TmpC;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpD,sizeof(void*),1));});}_LLF2:;}
# 2667
...
({struct Cyc_Warn_String_Warn_Warg_struct _TmpB=({struct Cyc_Warn_String_Warn_Warg_struct _TmpC;_TmpC.tag=0,_TmpC.f1=_tag_fat("UnresolvedMem",sizeof(char),14U);_TmpC;});void*_TmpC[1];_TmpC[0]=& _TmpB;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpC,sizeof(void*),1));});case 24:
({struct Cyc_Warn_String_Warn_Warg_struct _TmpB=({struct Cyc_Warn_String_Warn_Warg_struct _TmpC;_TmpC.tag=0,_TmpC.f1=_tag_fat("compoundlit",sizeof(char),12U);_TmpC;});void*_TmpC[1];_TmpC[0]=& _TmpB;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpC,sizeof(void*),1));});case 38:
...
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp0=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1;_Tmp1.tag=0,_Tmp1.f1=_tag_fat("Toc did not examine an inserted check: ",sizeof(char),40U);_Tmp1;});struct Cyc_Warn_Exp_Warn_Warg_struct _Tmp1=({struct Cyc_Warn_Exp_Warn_Warg_struct _Tmp2;_Tmp2.tag=4,_Tmp2.f1=e;_Tmp2;});void*_Tmp2[2];_Tmp2[0]=& _Tmp0,_Tmp2[1]=& _Tmp1;({(int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2;})(e->loc,_tag_fat(_Tmp2,sizeof(void*),2));});}}struct _tuple37{int f0;struct _fat_ptr*f1;struct _fat_ptr*f2;struct Cyc_Absyn_Switch_clause*f3;};
# 2706 "toc.cyc"
static struct _tuple37*Cyc_Toc_gen_labels(struct _RegionHandle*r,struct Cyc_Absyn_Switch_clause*sc){
# 2708
return({struct _tuple37*_Tmp0=_region_malloc(r,0U,sizeof(struct _tuple37));_Tmp0->f0=0,({struct _fat_ptr*_Tmp1=Cyc_Toc_fresh_label();_Tmp0->f1=_Tmp1;}),({struct _fat_ptr*_Tmp1=Cyc_Toc_fresh_label();_Tmp0->f2=_Tmp1;}),_Tmp0->f3=sc;_Tmp0;});}
# 2714
...
# 2740
 if(ps->tl!=0){
void*_Tmp4=((struct Cyc_Tcpat_PathNode*)_check_null(ps->tl)->hd)->access;unsigned _Tmp5;void*_Tmp6;void*_Tmp7;if(*((int*)_Tmp4)==2){_Tmp7=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_Tmp4)->f1;_Tmp6=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_Tmp4)->f2;_Tmp5=((struct Cyc_Tcpat_DatatypeField_Tcpat_Access_struct*)_Tmp4)->f3;{struct Cyc_Absyn_Datatypedecl*tud=_Tmp7;struct Cyc_Absyn_Datatypefield*tuf=_Tmp6;unsigned i=_Tmp5;
# 2743
ps=ps->tl;
...
# 2836
k=(void*)({struct Cyc_Toc_WhereTest_Toc_TestKind_struct*_Tmp3=_cycalloc(sizeof(struct Cyc_Toc_WhereTest_Toc_TestKind_struct));_Tmp3->tag=2,_Tmp3->f1=e;_Tmp3;});return({struct _tuple38 _Tmp3;_Tmp3.f0=0,_Tmp3.f1=k;_Tmp3;});}else{
goto _LL13;}case 1: _LL13:
 goto _LL15;case 2: _LL15:
 goto _LL17;case 5: _LL17:
 goto _LL19;default: _LL19:
 return({struct _tuple38 _Tmp3;_Tmp3.f0=0,_Tmp3.f1=k;_Tmp3;});};}}
# 2844
return({struct _tuple38 _Tmp0;_Tmp0.f0=c,_Tmp0.f1=k;_Tmp0;});}
# 2849
...
return({struct Cyc_Absyn_Stmt*_Tmp6=s;Cyc_Toc_seq_stmt_opt(_Tmp6,Cyc_Toc_extract_pattern_vars(rgn,nv,newdecls,prevdecls,path,p2));});}}}}}{
# 2932
...
Cyc_Absyn_copy_exp(path),0U);});
return({struct Cyc_Absyn_Stmt*_Tmp4=s;Cyc_Toc_seq_stmt_opt(_Tmp4,Cyc_Toc_extract_pattern_vars(rgn,nv,newdecls,prevdecls,path,p2));});}}}case 4: _Tmp3=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Vardecl*vd=_Tmp3;
# 2948
void*ctype=Cyc_Toc_typ_to_c_array(vd->type);
# 2950
{struct Cyc_List_List*pds=*prevdecls;for(0;pds!=0;pds=pds->tl){
...
({struct Cyc_List_List*_Tmp6=({struct Cyc_List_List*_Tmp7=_region_malloc(rgn,0U,sizeof(struct Cyc_List_List));({struct _tuple39*_Tmp8=({struct _tuple39*_Tmp9=_region_malloc(rgn,0U,sizeof(struct _tuple39));_Tmp9->f0=vd,_Tmp9->f1=other_vd,_Tmp9->f2=ctype,_Tmp9->f3=0;_Tmp9;});_Tmp7->hd=_Tmp8;}),_Tmp7->tl=*newdecls;_Tmp7;});*newdecls=_Tmp6;});
# 2958
return({struct Cyc_Absyn_Exp*_Tmp6=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_Tmp7=_cycalloc(sizeof(struct Cyc_Absyn_Local_b_Absyn_Binding_struct));_Tmp7->tag=4,_Tmp7->f1=other_vd;_Tmp7;}),0U);Cyc_Absyn_assign_stmt(_Tmp6,
Cyc_Absyn_copy_exp(path),0U);});}}}}{
# 2963
struct Cyc_Absyn_Vardecl*new_vd;
if(Cyc_Toc_can_use_voidstar(ctype)){
...
({struct Cyc_List_List*_Tmp4=({struct Cyc_List_List*_Tmp5=_region_malloc(rgn,0U,sizeof(struct Cyc_List_List));({struct _tuple39*_Tmp6=({struct _tuple39*_Tmp7=_region_malloc(rgn,0U,sizeof(struct _tuple39));_Tmp7->f0=vd,_Tmp7->f1=new_vd,_Tmp7->f2=ctype,_Tmp7->f3=0;_Tmp7;});_Tmp5->hd=_Tmp6;}),_Tmp5->tl=*newdecls;_Tmp5;});*newdecls=_Tmp4;});}
# 2973
return({struct Cyc_Absyn_Exp*_Tmp4=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_Tmp5=_cycalloc(sizeof(struct Cyc_Absyn_Local_b_Absyn_Binding_struct));_Tmp5->tag=4,_Tmp5->f1=new_vd;_Tmp5;}),0U);Cyc_Absyn_assign_stmt(_Tmp4,Cyc_Absyn_copy_exp(path),0U);});}}case 0:
...
Cyc_Toc_push_address_exp(Cyc_Absyn_copy_exp(path)));}),0U);});
return({struct Cyc_Absyn_Stmt*_Tmp4=s;Cyc_Toc_seq_stmt_opt(_Tmp4,Cyc_Toc_extract_pattern_vars(rgn,nv,newdecls,prevdecls,path,p2));});}}}}case 8:
# 3015
...
# 3057
if(topt==0)({struct Cyc_Warn_String_Warn_Warg_struct _Tmp4=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp5;_Tmp5.tag=0,_Tmp5.f1=_tag_fat("unresolved aggregate pattern!",sizeof(char),30U);_Tmp5;});void*_Tmp5[1];_Tmp5[0]=& _Tmp4;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_Tmp5,sizeof(void*),1));});{
void*atype=topt;
struct Cyc_List_List*fields;
int is_tagged=0;
{void*_Tmp4=Cyc_Absyn_compress(atype);void*_Tmp5;int _Tmp6;enum Cyc_Absyn_AggrKind _Tmp7;union Cyc_Absyn_AggrInfo _Tmp8;switch(*((int*)_Tmp4)){case 0: if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp4)->f1)==25){_Tmp8=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp4)->f1)->f1;{union Cyc_Absyn_AggrInfo info=_Tmp8;
# 3063
struct Cyc_Absyn_Aggrdecl*ad=Cyc_Absyn_get_known_aggrdecl(info);
...
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp9=({struct Cyc_Warn_String_Warn_Warg_struct _TmpA;_TmpA.tag=0,_TmpA.f1=_tag_fat("bad type in aggr pattern",sizeof(char),25U);_TmpA;});void*_TmpA[1];_TmpA[0]=& _Tmp9;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_TmpA,sizeof(void*),1));});}_LL2E:;}{
# 3072
struct Cyc_Absyn_Stmt*s=0;
...
return s;}}}case 14:
# 3101
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp4=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp5;_Tmp5.tag=0,_Tmp5.f1=_tag_fat("unknownid pat",sizeof(char),14U);_Tmp5;});void*_Tmp5[1];_Tmp5[0]=& _Tmp4;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_Tmp5,sizeof(void*),1));});case 15:
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp4=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp5;_Tmp5.tag=0,_Tmp5.f1=_tag_fat("unknowncall pat",sizeof(char),16U);_Tmp5;});void*_Tmp5[1];_Tmp5[0]=& _Tmp4;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_Tmp5,sizeof(void*),1));});default:
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp4=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp5;_Tmp5.tag=0,_Tmp5.f1=_tag_fat("exp pat",sizeof(char),8U);_Tmp5;});void*_Tmp5[1];_Tmp5[0]=& _Tmp4;({(int(*)(struct _fat_ptr ap))Cyc_Toc_toc_impos;})(_tag_fat(_Tmp5,sizeof(void*),1));});};}
# 3110
...
({(void(*)(void(*)(struct Cyc_List_List*,struct Cyc_Absyn_Exp*),struct Cyc_List_List*,struct Cyc_List_List*))Cyc_List_iter_c;})(Cyc_Toc_subst_pattern_vars,env,es);goto _LL0;}case 35: _Tmp3=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_List_List*dles=_Tmp3;
...
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp4=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp5;_Tmp5.tag=0,_Tmp5.f1=_tag_fat("subst_pattern_vars, unexpected exp",sizeof(char),35U);_Tmp5;});void*_Tmp5[1];_Tmp5[0]=& _Tmp4;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_Tmp5,sizeof(void*),1));});default: _LL3F:
...
# 3389
if(lscs2->tl!=0){
struct _tuple37*_Tmp5=(struct _tuple37*)_check_null(lscs2->tl)->hd;void*_Tmp6;void*_Tmp7;_Tmp7=_Tmp5->f2;_Tmp6=_Tmp5->f3;{struct _fat_ptr*fallthru_lab=_Tmp7;struct Cyc_Absyn_Switch_clause*next_sc=_Tmp6;
# 3393
...
vs=Cyc_Tcutil_filter_nulls(Cyc_List_split((struct Cyc_List_List*)_check_null(next_sc->pat_vars)->v).f0);
...
Cyc_Absyn_string_exp(*(*x_var).f1,0U);_Tmp10[0]=_Tmp11;});Cyc_Toc_fncall_exp_dl(Cyc_Toc__new_region_e,_tag_fat(_Tmp10,sizeof(struct Cyc_Absyn_Exp*),1));});
# 3594
...
struct _tuple1*x2;x2=_cycalloc(sizeof(struct _tuple1)),x2->f0=Cyc_Absyn_Loc_n,x2->f1=_check_null(n);
...
if(ad2->impl==0){
({struct Cyc_Dict_Dict _Tmp8=({struct Cyc_Dict_Dict _Tmp9=*aggrs_so_far;struct _tuple1*_TmpA=n;({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple1*,struct _tuple18*))Cyc_Dict_insert;})(_Tmp9,_TmpA,({struct _tuple18*_TmpB=_region_malloc(d,0U,sizeof(struct _tuple18));_TmpB->f0=ad,_TmpB->f1=t;_TmpB;}));});*aggrs_so_far=_Tmp8;});
...
struct _fat_ptr s=({struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,_Tmp6.f1=(struct _fat_ptr)((struct _fat_ptr)*(*ad->name).f1);_Tmp6;});struct Cyc_String_pa_PrintArg_struct _Tmp6=({struct Cyc_String_pa_PrintArg_struct _Tmp7;_Tmp7.tag=0,_Tmp7.f1=(struct _fat_ptr)((struct _fat_ptr)*f);_Tmp7;});void*_Tmp7[2];_Tmp7[0]=& _Tmp5,_Tmp7[1]=& _Tmp6;Cyc_aprintf(_tag_fat("_union_%s_%s",sizeof(char),13U),_tag_fat(_Tmp7,sizeof(void*),2));});
...
({(int(*)(struct Cyc_Absyn_Aggrdecl**,int(*)(struct _RegionHandle*,struct _tuple43*)))Cyc_Toc_use_toc_state;})(& ad,Cyc_Toc_aggrdecl_to_c_body);}struct _tuple44{struct Cyc_Toc_TocState*f0;struct Cyc_Absyn_Datatypedecl*f1;};
# 3834 "toc.cyc"
