...
void*_Tmp0=Cyc_Absyn_compress(t);switch(*((int*)_Tmp0)){case 0: switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp0)->f1)){case 1: switch((int)((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp0)->f1)->f2){case Cyc_Absyn_Char_sz:
...
void*_Tmp0=Cyc_Absyn_compress(_check_null(arr->topt));void*_Tmp1;if(*((int*)_Tmp0)==3){_Tmp1=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp0)->f1.elt_type;{void*et=_Tmp1;
...
# 776
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_Tmp9=_cycalloc(sizeof(struct Cyc_Absyn_FnType_Absyn_Type_struct));_Tmp9->tag=5,_Tmp9->f1.tvars=0,_Tmp9->f1.effect=0,_Tmp9->f1.ret_tqual=tq2,({void*_TmpA=Cyc_Toc_typ_to_c(t2);_Tmp9->f1.ret_type=_TmpA;}),_Tmp9->f1.args=new_args,_Tmp9->f1.c_varargs=c_vararg,_Tmp9->f1.cyc_varargs=0,_Tmp9->f1.rgn_po=0,_Tmp9->f1.attributes=new_atts,_Tmp9->f1.requires_clause=0,_Tmp9->f1.requires_relns=0,_Tmp9->f1.ensures_clause=0,_Tmp9->f1.ensures_relns=0,_Tmp9->f1.return_value=0;_Tmp9;});}case 6: _Tmp8=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)t)->f1;{struct Cyc_List_List*tqs=_Tmp8;
# 781
...
({void*_Tmp8=({void*_Tmp9=Cyc_Absyn_cstar_type(ta1,tq);Cyc_Toc_cast_it_r(_Tmp9,({struct Cyc_Absyn_Exp*_TmpA[3];({
struct Cyc_Absyn_Exp*_TmpB=Cyc_Absyn_new_exp(ptr->r,0U);_TmpA[0]=_TmpB;}),_TmpA[1]=bd,_TmpA[2]=ind;Cyc_Toc_fncall_exp_dl(fn_e,_tag_fat(_TmpA,sizeof(struct Cyc_Absyn_Exp*),3));}));});
# 1224
ptr->r=_Tmp8;});
# 1226
ans=1;}}
...
({void*_Tmp10=({struct Cyc_Absyn_Exp*_Tmp11[2];_Tmp11[0]=(struct Cyc_Absyn_Exp*)es->hd,_Tmp11[1]=eopt;Cyc_Toc_fncall_exp_r(function_e,_tag_fat(_Tmp11,sizeof(struct Cyc_Absyn_Exp*),2));});e->r=_Tmp10;});}else{
...
# 1708
if(Cyc_Tcutil_force_type2bool(0,zt))
({void*_TmpF=({struct Cyc_Absyn_Exp*_Tmp10[3];_Tmp10[0]=e1,_Tmp10[1]=eopt,_Tmp10[2]=e2;({struct Cyc_Absyn_Exp*_Tmp11=Cyc_Toc_getFunctionRemovePointer(& Cyc_Toc__zero_arr_plus_functionSet,e1);Cyc_Toc_fncall_exp_r(_Tmp11,_tag_fat(_Tmp10,sizeof(struct Cyc_Absyn_Exp*),3));});});e->r=_TmpF;});}
goto _LL7C;}}else{
goto _LL7C;}_LL7C:;}
# 1713
...
# 3158
goto _LL3F;else{_Tmp7=_Tmp6;{void*exn=_Tmp7;(void*)_rethrow(exn);}}_LL3F:;}}}
...
v=Cyc_Absyn_binding2qvar(b);goto _LL0;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp2=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp3;_Tmp3.tag=0,_Tmp3.f1=({const char*_Tmp4="pattern expression not a variable: ";_tag_fat(_Tmp4,sizeof(char),36U);});_Tmp3;});struct Cyc_Warn_Exp_Warn_Warg_struct _Tmp3=({struct Cyc_Warn_Exp_Warn_Warg_struct _Tmp4;_Tmp4.tag=4,_Tmp4.f1=e;_Tmp4;});void*_Tmp4[2];_Tmp4[0]=& _Tmp2,_Tmp4[1]=& _Tmp3;({(int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2;})(e->loc,_tag_fat(_Tmp4,sizeof(void*),2));});}_LL0:;}{
# 3396
...
v=Cyc_Absyn_binding2qvar(b);goto _LL0;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp4=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp5;_Tmp5.tag=0,_Tmp5.f1=({const char*_Tmp6="pattern expression not a variable: ";_tag_fat(_Tmp6,sizeof(char),36U);});_Tmp5;});struct Cyc_Warn_Exp_Warn_Warg_struct _Tmp5=({struct Cyc_Warn_Exp_Warn_Warg_struct _Tmp6;_Tmp6.tag=4,_Tmp6.f1=e;_Tmp6;});void*_Tmp6[2];_Tmp6[0]=& _Tmp4,_Tmp6[1]=& _Tmp5;({(int(*)(unsigned,struct _fat_ptr))Cyc_Warn_impos_loc2;})(e->loc,_tag_fat(_Tmp6,sizeof(void*),2));});}_LL0:;}{
# 4049
