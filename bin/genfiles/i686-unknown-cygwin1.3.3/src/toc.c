...
if(_tmpB8 <= (void*)16?1:*((int*)_tmpB8)!= 3)goto _LL6A;_LL69: continue;_LL6A: if(
_tmpB8 <= (void*)16?1:*((int*)_tmpB8)!= 4)goto _LL6C;_LL6B: continue;_LL6C:;_LL6D:
_tmpB7=({struct Cyc_List_List*_tmpB9=_cycalloc(sizeof(*_tmpB9));_tmpB9->hd=(void*)((
void*)_tmpA3->hd);_tmpB9->tl=_tmpB7;_tmpB9;});goto _LL63;_LL63:;}{struct Cyc_List_List*
_tmpBA=((struct Cyc_List_List*(*)(struct _tuple2*(*f)(struct _tuple2*),struct Cyc_List_List*
x))Cyc_List_map)(Cyc_Toc_arg_to_c,_tmpA0);if(_tmpA2 != 0){void*_tmpBB=Cyc_Toc_typ_to_c(
Cyc_Absyn_tagged_typ((void*)_tmpA2->type,(void*)2,Cyc_Toc_mt_tq));struct _tuple2*
_tmpBC=({struct _tuple2*_tmpBE=_cycalloc(sizeof(*_tmpBE));_tmpBE->f1=_tmpA2->name;
_tmpBE->f2=_tmpA2->tq;_tmpBE->f3=_tmpBB;_tmpBE;});_tmpBA=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmpBA,({
struct Cyc_List_List*_tmpBD=_cycalloc(sizeof(*_tmpBD));_tmpBD->hd=_tmpBC;_tmpBD->tl=
0;_tmpBD;}));}return(void*)({struct Cyc_Absyn_FnType_struct*_tmpBF=_cycalloc(
sizeof(*_tmpBF));_tmpBF[0]=({struct Cyc_Absyn_FnType_struct _tmpC0;_tmpC0.tag=8;
_tmpC0.f1=({struct Cyc_Absyn_FnInfo _tmpC1;_tmpC1.tvars=0;_tmpC1.effect=0;_tmpC1.ret_typ=(
void*)Cyc_Toc_typ_to_c(_tmp9F);_tmpC1.args=_tmpBA;_tmpC1.c_varargs=_tmpA1;_tmpC1.cyc_varargs=
0;_tmpC1.rgn_po=0;_tmpC1.attributes=_tmpB7;_tmpC1;});_tmpC0;});_tmpBF;});}}_LL42:
if(_tmp8B <= (void*)3?1:*((int*)_tmp8B)!= 9)goto _LL44;_tmpA4=((struct Cyc_Absyn_TupleType_struct*)
_tmp8B)->f1;_LL43: _tmpA4=((struct Cyc_List_List*(*)(struct _tuple4*(*f)(struct
_tuple4*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Toc_typ_to_c_f,_tmpA4);{
struct _tagged_arr*_tmpC2=Cyc_Toc_add_tuple_type(_tmpA4);return Cyc_Absyn_strct(
_tmpC2);}_LL44: if(_tmp8B <= (void*)3?1:*((int*)_tmp8B)!= 11)goto _LL46;_tmpA5=(
void*)((struct Cyc_Absyn_AnonAggrType_struct*)_tmp8B)->f1;_tmpA6=((struct Cyc_Absyn_AnonAggrType_struct*)
_tmp8B)->f2;_LL45: return(void*)({struct Cyc_Absyn_AnonAggrType_struct*_tmpC3=
_cycalloc(sizeof(*_tmpC3));_tmpC3[0]=({struct Cyc_Absyn_AnonAggrType_struct _tmpC4;
_tmpC4.tag=11;_tmpC4.f1=(void*)_tmpA5;_tmpC4.f2=((struct Cyc_List_List*(*)(struct
Cyc_Absyn_Aggrfield*(*f)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*x))Cyc_List_map)(
Cyc_Toc_aggrfield_to_c,_tmpA6);_tmpC4;});_tmpC3;});_LL46: if(_tmp8B <= (void*)3?1:*((
int*)_tmp8B)!= 10)goto _LL48;_tmpA7=((struct Cyc_Absyn_AggrType_struct*)_tmp8B)->f1;
_tmpA8=(void*)_tmpA7.aggr_info;_tmpA9=_tmpA7.targs;_LL47: {struct Cyc_Absyn_Aggrdecl*
_tmpC5=Cyc_Absyn_get_known_aggrdecl(_tmpA8);if((void*)_tmpC5->kind == (void*)1)
return Cyc_Absyn_unionq_typ(_tmpC5->name);return Cyc_Absyn_strctq(_tmpC5->name);}
_LL48: if(_tmp8B <= (void*)3?1:*((int*)_tmp8B)!= 12)goto _LL4A;_tmpAA=((struct Cyc_Absyn_EnumType_struct*)
_tmp8B)->f1;_LL49: return t;_LL4A: if(_tmp8B <= (void*)3?1:*((int*)_tmp8B)!= 13)goto
_LL4C;_tmpAB=((struct Cyc_Absyn_AnonEnumType_struct*)_tmp8B)->f1;_LL4B: Cyc_Toc_enumfields_to_c(
...
l){void*_tmpD0=t;void*_tmpD1;struct Cyc_Absyn_Tqual _tmpD2;_LL6F: if(_tmpD0 <= (void*)
3?1:*((int*)_tmpD0)!= 7)goto _LL71;_tmpD1=(void*)((struct Cyc_Absyn_ArrayType_struct*)
_tmpD0)->f1;_tmpD2=((struct Cyc_Absyn_ArrayType_struct*)_tmpD0)->f2;_LL70: return
Cyc_Absyn_cast_exp(Cyc_Absyn_star_typ(_tmpD1,(void*)2,_tmpD2),e,l);_LL71:;_LL72:
return Cyc_Absyn_cast_exp(t,e,l);_LL6E:;}static int Cyc_Toc_atomic_typ(void*t){void*
...
struct Cyc_List_List*_tmpDC;_LL74: if((int)_tmpD3 != 0)goto _LL76;_LL75: return 1;
_LL76: if(_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 1)goto _LL78;_LL77: return 0;_LL78:
if(_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 5)goto _LL7A;_LL79: goto _LL7B;_LL7A: if(
_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 12)goto _LL7C;_LL7B: goto _LL7D;_LL7C: if(
_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 13)goto _LL7E;_LL7D: goto _LL7F;_LL7E: if((int)
_tmpD3 != 1)goto _LL80;_LL7F: goto _LL81;_LL80: if(_tmpD3 <= (void*)3?1:*((int*)_tmpD3)
!= 6)goto _LL82;_LL81: goto _LL83;_LL82: if(_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 8)
goto _LL84;_LL83: goto _LL85;_LL84: if(_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 17)goto
_LL86;_LL85: goto _LL87;_LL86: if(_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 14)goto
_LL88;_LL87: return 1;_LL88: if(_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 7)goto _LL8A;
_tmpD4=(void*)((struct Cyc_Absyn_ArrayType_struct*)_tmpD3)->f1;_LL89: return Cyc_Toc_atomic_typ(
_tmpD4);_LL8A: if(_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 10)goto _LL8C;_tmpD5=((
struct Cyc_Absyn_AggrType_struct*)_tmpD3)->f1;_tmpD6=(void*)_tmpD5.aggr_info;
_LL8B:{void*_tmpDD=_tmpD6;_LL9B: if(*((int*)_tmpDD)!= 0)goto _LL9D;_LL9C: return 0;
_LL9D:;_LL9E: goto _LL9A;_LL9A:;}{struct Cyc_Absyn_Aggrdecl*_tmpDE=Cyc_Absyn_get_known_aggrdecl(
...
void*)((struct Cyc_Absyn_Aggrfield*)_tmpDF->hd)->type))return 0;}}return 1;}_LL8C:
if(_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 11)goto _LL8E;_tmpD7=((struct Cyc_Absyn_AnonAggrType_struct*)
_tmpD3)->f2;_LL8D: for(0;_tmpD7 != 0;_tmpD7=_tmpD7->tl){if(!Cyc_Toc_atomic_typ((
void*)((struct Cyc_Absyn_Aggrfield*)_tmpD7->hd)->type))return 0;}return 1;_LL8E: if(
_tmpD3 <= (void*)3?1:*((int*)_tmpD3)!= 3)goto _LL90;_tmpD8=((struct Cyc_Absyn_TunionFieldType_struct*)
_tmpD3)->f1;_tmpD9=(void*)_tmpD8.field_info;if(*((int*)_tmpD9)!= 1)goto _LL90;
_tmpDA=((struct Cyc_Absyn_KnownTunionfield_struct*)_tmpD9)->f1;_tmpDB=((struct Cyc_Absyn_KnownTunionfield_struct*)
_tmpD9)->f2;_LL8F: _tmpDC=_tmpDB->typs;goto _LL91;_LL90: if(_tmpD3 <= (void*)3?1:*((
int*)_tmpD3)!= 9)goto _LL92;_tmpDC=((struct Cyc_Absyn_TupleType_struct*)_tmpD3)->f1;
_LL91: for(0;_tmpDC != 0;_tmpDC=_tmpDC->tl){if(!Cyc_Toc_atomic_typ((*((struct
_tuple4*)_tmpDC->hd)).f2))return 0;}return 1;_LL92: if(_tmpD3 <= (void*)3?1:*((int*)
_tmpD3)!= 2)goto _LL94;_LL93: goto _LL95;_LL94: if(_tmpD3 <= (void*)3?1:*((int*)
_tmpD3)!= 4)goto _LL96;_LL95: goto _LL97;_LL96: if(_tmpD3 <= (void*)3?1:*((int*)
_tmpD3)!= 15)goto _LL98;_LL97: return 0;_LL98:;_LL99:({struct Cyc_Std_String_pa_struct
...
1));}});_LL73:;}static int Cyc_Toc_is_void_star(void*t){void*_tmpE2=Cyc_Tcutil_compress(
t);struct Cyc_Absyn_PtrInfo _tmpE3;void*_tmpE4;_LLA0: if(_tmpE2 <= (void*)3?1:*((int*)
_tmpE2)!= 4)goto _LLA2;_tmpE3=((struct Cyc_Absyn_PointerType_struct*)_tmpE2)->f1;
_tmpE4=(void*)_tmpE3.elt_typ;_LLA1: {void*_tmpE5=Cyc_Tcutil_compress(_tmpE4);
_LLA5: if((int)_tmpE5 != 0)goto _LLA7;_LLA6: return 1;_LLA7:;_LLA8: return 0;_LLA4:;}
...
void*_tmpE8;struct Cyc_List_List*_tmpE9;_LLAA: if(_tmpE6 <= (void*)3?1:*((int*)
_tmpE6)!= 10)goto _LLAC;_tmpE7=((struct Cyc_Absyn_AggrType_struct*)_tmpE6)->f1;
_tmpE8=(void*)_tmpE7.aggr_info;_LLAB: {struct Cyc_Absyn_Aggrdecl*_tmpEA=Cyc_Absyn_get_known_aggrdecl(
...
_check_null(_tmpEA->impl))->fields;goto _LLAD;}_LLAC: if(_tmpE6 <= (void*)3?1:*((
int*)_tmpE6)!= 11)goto _LLAE;_tmpE9=((struct Cyc_Absyn_AnonAggrType_struct*)_tmpE6)->f2;
_LLAD: {struct Cyc_Absyn_Aggrfield*_tmpEC=Cyc_Absyn_lookup_field(_tmpE9,f);if(
...
_tmpEC->type);}_LLAE:;_LLAF:({struct Cyc_Std_String_pa_struct _tmpF0;_tmpF0.tag=0;
...
sizeof(char),27),_tag_arr(_tmpEF,sizeof(void*),1));}});_LLA9:;}static int Cyc_Toc_is_poly_project(
struct Cyc_Absyn_Exp*e){void*_tmpF1=(void*)e->r;struct Cyc_Absyn_Exp*_tmpF2;struct
_tagged_arr*_tmpF3;struct Cyc_Absyn_Exp*_tmpF4;struct _tagged_arr*_tmpF5;_LLB1: if(*((
int*)_tmpF1)!= 21)goto _LLB3;_tmpF2=((struct Cyc_Absyn_AggrMember_e_struct*)_tmpF1)->f1;
_tmpF3=((struct Cyc_Absyn_AggrMember_e_struct*)_tmpF1)->f2;_LLB2: return Cyc_Toc_is_poly_field((
void*)((struct Cyc_Core_Opt*)_check_null(_tmpF2->topt))->v,_tmpF3);_LLB3: if(*((
int*)_tmpF1)!= 22)goto _LLB5;_tmpF4=((struct Cyc_Absyn_AggrArrow_e_struct*)_tmpF1)->f1;
_tmpF5=((struct Cyc_Absyn_AggrArrow_e_struct*)_tmpF1)->f2;_LLB4: {void*_tmpF6=Cyc_Tcutil_compress((
void*)((struct Cyc_Core_Opt*)_check_null(_tmpF4->topt))->v);struct Cyc_Absyn_PtrInfo
_tmpF7;void*_tmpF8;_LLB8: if(_tmpF6 <= (void*)3?1:*((int*)_tmpF6)!= 4)goto _LLBA;
_tmpF7=((struct Cyc_Absyn_PointerType_struct*)_tmpF6)->f1;_tmpF8=(void*)_tmpF7.elt_typ;
_LLB9: return Cyc_Toc_is_poly_field(_tmpF8,_tmpF5);_LLBA:;_LLBB:({struct Cyc_Std_String_pa_struct
...
sizeof(char),30),_tag_arr(_tmpF9,sizeof(void*),1));}});_LLB7:;}_LLB5:;_LLB6:
return 0;_LLB0:;}static struct Cyc_Absyn_Exp*Cyc_Toc_malloc_ptr(struct Cyc_Absyn_Exp*
...
_LLBD: if(*((int*)_tmp102)!= 0)goto _LLBF;_tmp103=(void*)((struct Cyc_Absyn_Const_e_struct*)
_tmp102)->f1;if(_tmp103 <= (void*)1?1:*((int*)_tmp103)!= 5)goto _LLBF;_LLBE:
...
Cyc_Absyn_Exp*y){{void*_tmp10F=(*x).f1;_LLC2: if(_tmp10F <= (void*)1?1:*((int*)
_tmp10F)!= 0)goto _LLC4;_LLC3:({struct Cyc_Std_String_pa_struct _tmp111;_tmp111.tag=
...
sizeof(void*),1));}});_LLC4:;_LLC5: goto _LLC1;_LLC1:;}{struct Cyc_Toc_Env*ans=({
...
struct Cyc_Absyn_Exp*e){void*_tmp11F=(void*)e->annot;_LLC7: if(*((void**)_tmp11F)
!= Cyc_CfFlowInfo_UnknownZ)goto _LLC9;_LLC8: return Cyc_Toc_is_nullable((void*)((
struct Cyc_Core_Opt*)_check_null(e->topt))->v);_LLC9: if(*((void**)_tmp11F)!= Cyc_CfFlowInfo_NotZero)
goto _LLCB;_LLCA: return 0;_LLCB: if(*((void**)_tmp11F)!= Cyc_CfFlowInfo_IsZero)goto
_LLCD;_LLCC:({void*_tmp120[0]={};Cyc_Tcutil_terr(e->loc,_tag_arr("dereference of NULL pointer",
sizeof(char),28),_tag_arr(_tmp120,sizeof(void*),0));});return 0;_LLCD: if(_tmp11F
!= Cyc_Absyn_EmptyAnnot)goto _LLCF;_LLCE: return 0;_LLCF:;_LLD0:(int)_throw((void*)({
...
_tag_arr("need_null_check",sizeof(char),16);_tmp122;});_tmp121;}));_LLC6:;}
static struct Cyc_List_List*Cyc_Toc_get_relns(struct Cyc_Absyn_Exp*e){void*_tmp123=(
void*)e->annot;struct Cyc_List_List*_tmp124;struct Cyc_List_List*_tmp125;_LLD2: if(*((
void**)_tmp123)!= Cyc_CfFlowInfo_UnknownZ)goto _LLD4;_tmp124=((struct Cyc_CfFlowInfo_UnknownZ_struct*)
_tmp123)->f1;_LLD3: return _tmp124;_LLD4: if(*((void**)_tmp123)!= Cyc_CfFlowInfo_NotZero)
goto _LLD6;_tmp125=((struct Cyc_CfFlowInfo_NotZero_struct*)_tmp123)->f1;_LLD5:
return _tmp125;_LLD6: if(*((void**)_tmp123)!= Cyc_CfFlowInfo_IsZero)goto _LLD8;
_LLD7:({void*_tmp126[0]={};Cyc_Tcutil_terr(e->loc,_tag_arr("dereference of NULL pointer",
sizeof(char),28),_tag_arr(_tmp126,sizeof(void*),0));});return 0;_LLD8: if(_tmp123
!= Cyc_Absyn_EmptyAnnot)goto _LLDA;_LLD9: return 0;_LLDA:;_LLDB:(int)_throw((void*)({
...
_tag_arr("get_relns",sizeof(char),10);_tmp128;});_tmp127;}));_LLD1:;}static int
...
_tmp12C;_LLDD: if(_tmp129 <= (void*)3?1:*((int*)_tmp129)!= 4)goto _LLDF;_tmp12A=((
struct Cyc_Absyn_PointerType_struct*)_tmp129)->f1;_tmp12B=_tmp12A.bounds;_LLDE: {
void*_tmp12D=Cyc_Absyn_conref_def(Cyc_Absyn_bounds_one,_tmp12B);struct Cyc_Absyn_Exp*
_tmp12E;_LLE4: if((int)_tmp12D != 0)goto _LLE6;_LLE5: return 0;_LLE6: if(_tmp12D <= (
void*)1?1:*((int*)_tmp12D)!= 0)goto _LLE3;_tmp12E=((struct Cyc_Absyn_Upper_b_struct*)
_tmp12D)->f1;_LLE7: {unsigned int _tmp130;int _tmp131;struct _tuple5 _tmp12F=Cyc_Evexp_eval_const_uint_exp(
_tmp12E);_tmp130=_tmp12F.f1;_tmp131=_tmp12F.f2;return _tmp131?i <= _tmp130: 0;}
_LLE3:;}_LLDF: if(_tmp129 <= (void*)3?1:*((int*)_tmp129)!= 7)goto _LLE1;_tmp12C=((
struct Cyc_Absyn_ArrayType_struct*)_tmp129)->f3;_LLE0: if(_tmp12C == 0)return 0;{
...
return _tmp134?i <= _tmp133: 0;}_LLE1:;_LLE2: return 0;_LLDC:;}static int Cyc_Toc_check_leq_size_var(
...
Cyc_Absyn_Vardecl*_tmp137;struct Cyc_Absyn_Vardecl*_tmp138;_LLE9: if(*((int*)
_tmp136)!= 2)goto _LLEB;_tmp137=((struct Cyc_CfFlowInfo_LessSize_struct*)_tmp136)->f1;
_LLEA: _tmp138=_tmp137;goto _LLEC;_LLEB: if(*((int*)_tmp136)!= 4)goto _LLED;_tmp138=((
struct Cyc_CfFlowInfo_LessEqSize_struct*)_tmp136)->f1;_LLEC: if(_tmp138 == v)return
...
_tmp143;struct Cyc_List_List _tmp144;struct Cyc_Absyn_Exp*_tmp145;_LLF0: if(*((int*)
_tmp139)!= 1)goto _LLF2;_tmp13A=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp139)->f2;
if(_tmp13A <= (void*)1?1:*((int*)_tmp13A)!= 4)goto _LLF2;_tmp13B=((struct Cyc_Absyn_Pat_b_struct*)
_tmp13A)->f1;_LLF1: _tmp13D=_tmp13B;goto _LLF3;_LLF2: if(*((int*)_tmp139)!= 1)goto
_LLF4;_tmp13C=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp139)->f2;if(_tmp13C <= (
void*)1?1:*((int*)_tmp13C)!= 3)goto _LLF4;_tmp13D=((struct Cyc_Absyn_Local_b_struct*)
_tmp13C)->f1;_LLF3: _tmp13F=_tmp13D;goto _LLF5;_LLF4: if(*((int*)_tmp139)!= 1)goto
_LLF6;_tmp13E=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp139)->f2;if(_tmp13E <= (
void*)1?1:*((int*)_tmp13E)!= 0)goto _LLF6;_tmp13F=((struct Cyc_Absyn_Global_b_struct*)
_tmp13E)->f1;_LLF5: _tmp141=_tmp13F;goto _LLF7;_LLF6: if(*((int*)_tmp139)!= 1)goto
_LLF8;_tmp140=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp139)->f2;if(_tmp140 <= (
void*)1?1:*((int*)_tmp140)!= 2)goto _LLF8;_tmp141=((struct Cyc_Absyn_Param_b_struct*)
_tmp140)->f1;_LLF7: if(_tmp141->escapes)return 0;if(Cyc_Toc_check_leq_size_var(
relns,v,_tmp141))return 1;goto _LLEF;_LLF8: if(*((int*)_tmp139)!= 3)goto _LLFA;
_tmp142=(void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp139)->f1;if((int)_tmp142 != 
19)goto _LLFA;_tmp143=((struct Cyc_Absyn_Primop_e_struct*)_tmp139)->f2;if(_tmp143
== 0)goto _LLFA;_tmp144=*_tmp143;_tmp145=(struct Cyc_Absyn_Exp*)_tmp144.hd;_LLF9:{
...
_tmp14C;void*_tmp14D;struct Cyc_Absyn_Vardecl*_tmp14E;_LLFD: if(*((int*)_tmp146)!= 
1)goto _LLFF;_tmp147=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp146)->f2;if(
_tmp147 <= (void*)1?1:*((int*)_tmp147)!= 4)goto _LLFF;_tmp148=((struct Cyc_Absyn_Pat_b_struct*)
_tmp147)->f1;_LLFE: _tmp14A=_tmp148;goto _LL100;_LLFF: if(*((int*)_tmp146)!= 1)goto
_LL101;_tmp149=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp146)->f2;if(_tmp149 <= (
void*)1?1:*((int*)_tmp149)!= 3)goto _LL101;_tmp14A=((struct Cyc_Absyn_Local_b_struct*)
_tmp149)->f1;_LL100: _tmp14C=_tmp14A;goto _LL102;_LL101: if(*((int*)_tmp146)!= 1)
goto _LL103;_tmp14B=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp146)->f2;if(
_tmp14B <= (void*)1?1:*((int*)_tmp14B)!= 0)goto _LL103;_tmp14C=((struct Cyc_Absyn_Global_b_struct*)
_tmp14B)->f1;_LL102: _tmp14E=_tmp14C;goto _LL104;_LL103: if(*((int*)_tmp146)!= 1)
goto _LL105;_tmp14D=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp146)->f2;if(
_tmp14D <= (void*)1?1:*((int*)_tmp14D)!= 2)goto _LL105;_tmp14E=((struct Cyc_Absyn_Param_b_struct*)
_tmp14D)->f1;_LL104: return _tmp14E == v;_LL105:;_LL106: goto _LLFC;_LLFC:;}goto _LLEF;
...
_tmp157;_LL108: if(*((int*)_tmp14F)!= 1)goto _LL10A;_tmp150=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp14F)->f2;if(_tmp150 <= (void*)1?1:*((int*)_tmp150)!= 4)goto _LL10A;_tmp151=((
struct Cyc_Absyn_Pat_b_struct*)_tmp150)->f1;_LL109: _tmp153=_tmp151;goto _LL10B;
_LL10A: if(*((int*)_tmp14F)!= 1)goto _LL10C;_tmp152=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp14F)->f2;if(_tmp152 <= (void*)1?1:*((int*)_tmp152)!= 3)goto _LL10C;_tmp153=((
struct Cyc_Absyn_Local_b_struct*)_tmp152)->f1;_LL10B: _tmp155=_tmp153;goto _LL10D;
_LL10C: if(*((int*)_tmp14F)!= 1)goto _LL10E;_tmp154=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp14F)->f2;if(_tmp154 <= (void*)1?1:*((int*)_tmp154)!= 0)goto _LL10E;_tmp155=((
struct Cyc_Absyn_Global_b_struct*)_tmp154)->f1;_LL10D: _tmp157=_tmp155;goto _LL10F;
_LL10E: if(*((int*)_tmp14F)!= 1)goto _LL110;_tmp156=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp14F)->f2;if(_tmp156 <= (void*)1?1:*((int*)_tmp156)!= 2)goto _LL110;_tmp157=((
struct Cyc_Absyn_Param_b_struct*)_tmp156)->f1;_LL10F: if(_tmp157->escapes)return 0;
...
_tmp170;void*_tmp171;struct Cyc_Absyn_Vardecl*_tmp172;_LL113: if(*((int*)_tmp158)
!= 13)goto _LL115;_tmp159=(void*)((struct Cyc_Absyn_Cast_e_struct*)_tmp158)->f1;
_tmp15A=((struct Cyc_Absyn_Cast_e_struct*)_tmp158)->f2;_LL114: i=_tmp15A;goto
inner_loop;_LL115: if(*((int*)_tmp158)!= 0)goto _LL117;_tmp15B=(void*)((struct Cyc_Absyn_Const_e_struct*)
_tmp158)->f1;if(_tmp15B <= (void*)1?1:*((int*)_tmp15B)!= 2)goto _LL117;_tmp15C=(
void*)((struct Cyc_Absyn_Int_c_struct*)_tmp15B)->f1;if((int)_tmp15C != 2)goto
_LL117;_tmp15D=((struct Cyc_Absyn_Int_c_struct*)_tmp15B)->f2;_LL116: _tmp160=
_tmp15D;goto _LL118;_LL117: if(*((int*)_tmp158)!= 0)goto _LL119;_tmp15E=(void*)((
struct Cyc_Absyn_Const_e_struct*)_tmp158)->f1;if(_tmp15E <= (void*)1?1:*((int*)
_tmp15E)!= 2)goto _LL119;_tmp15F=(void*)((struct Cyc_Absyn_Int_c_struct*)_tmp15E)->f1;
if((int)_tmp15F != 0)goto _LL119;_tmp160=((struct Cyc_Absyn_Int_c_struct*)_tmp15E)->f2;
_LL118: return _tmp160 >= 0?Cyc_Toc_check_const_array((unsigned int)(_tmp160 + 1),(
void*)_tmp157->type): 0;_LL119: if(*((int*)_tmp158)!= 0)goto _LL11B;_tmp161=(void*)((
struct Cyc_Absyn_Const_e_struct*)_tmp158)->f1;if(_tmp161 <= (void*)1?1:*((int*)
_tmp161)!= 2)goto _LL11B;_tmp162=(void*)((struct Cyc_Absyn_Int_c_struct*)_tmp161)->f1;
if((int)_tmp162 != 1)goto _LL11B;_tmp163=((struct Cyc_Absyn_Int_c_struct*)_tmp161)->f2;
_LL11A: return Cyc_Toc_check_const_array((unsigned int)(_tmp163 + 1),(void*)_tmp157->type);
_LL11B: if(*((int*)_tmp158)!= 3)goto _LL11D;_tmp164=(void*)((struct Cyc_Absyn_Primop_e_struct*)
_tmp158)->f1;if((int)_tmp164 != 4)goto _LL11D;_tmp165=((struct Cyc_Absyn_Primop_e_struct*)
_tmp158)->f2;if(_tmp165 == 0)goto _LL11D;_tmp166=*_tmp165;_tmp167=(struct Cyc_Absyn_Exp*)
_tmp166.hd;_tmp168=_tmp166.tl;if(_tmp168 == 0)goto _LL11D;_tmp169=*_tmp168;_tmp16A=(
struct Cyc_Absyn_Exp*)_tmp169.hd;_LL11C: return Cyc_Toc_check_leq_size(relns,
_tmp157,_tmp16A);_LL11D: if(*((int*)_tmp158)!= 1)goto _LL11F;_tmp16B=(void*)((
struct Cyc_Absyn_Var_e_struct*)_tmp158)->f2;if(_tmp16B <= (void*)1?1:*((int*)
_tmp16B)!= 4)goto _LL11F;_tmp16C=((struct Cyc_Absyn_Pat_b_struct*)_tmp16B)->f1;
_LL11E: _tmp16E=_tmp16C;goto _LL120;_LL11F: if(*((int*)_tmp158)!= 1)goto _LL121;
_tmp16D=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp158)->f2;if(_tmp16D <= (void*)
1?1:*((int*)_tmp16D)!= 3)goto _LL121;_tmp16E=((struct Cyc_Absyn_Local_b_struct*)
_tmp16D)->f1;_LL120: _tmp170=_tmp16E;goto _LL122;_LL121: if(*((int*)_tmp158)!= 1)
goto _LL123;_tmp16F=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp158)->f2;if(
_tmp16F <= (void*)1?1:*((int*)_tmp16F)!= 0)goto _LL123;_tmp170=((struct Cyc_Absyn_Global_b_struct*)
_tmp16F)->f1;_LL122: _tmp172=_tmp170;goto _LL124;_LL123: if(*((int*)_tmp158)!= 1)
goto _LL125;_tmp171=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp158)->f2;if(
_tmp171 <= (void*)1?1:*((int*)_tmp171)!= 2)goto _LL125;_tmp172=((struct Cyc_Absyn_Param_b_struct*)
_tmp171)->f1;_LL124: if(_tmp172->escapes)return 0;{struct Cyc_List_List*_tmp173=
...
_tmp177;unsigned int _tmp178;_LL128: if(*((int*)_tmp175)!= 2)goto _LL12A;_tmp176=((
struct Cyc_CfFlowInfo_LessSize_struct*)_tmp175)->f1;_LL129: if(_tmp157 == _tmp176)
return 1;else{goto _LL127;}_LL12A: if(*((int*)_tmp175)!= 1)goto _LL12C;_tmp177=((
struct Cyc_CfFlowInfo_LessVar_struct*)_tmp175)->f1;_LL12B:{struct Cyc_List_List*
...
_tmp17D;unsigned int _tmp17E;struct Cyc_Absyn_Vardecl*_tmp17F;_LL131: if(*((int*)
_tmp17B)!= 4)goto _LL133;_tmp17C=((struct Cyc_CfFlowInfo_LessEqSize_struct*)
_tmp17B)->f1;_LL132: _tmp17D=_tmp17C;goto _LL134;_LL133: if(*((int*)_tmp17B)!= 2)
goto _LL135;_tmp17D=((struct Cyc_CfFlowInfo_LessSize_struct*)_tmp17B)->f1;_LL134:
if(_tmp157 == _tmp17D)return 1;else{goto _LL130;}_LL135: if(*((int*)_tmp17B)!= 0)
goto _LL137;_tmp17E=((struct Cyc_CfFlowInfo_EqualConst_struct*)_tmp17B)->f1;_LL136:
return Cyc_Toc_check_const_array(_tmp17E,(void*)_tmp157->type);_LL137: if(*((int*)
_tmp17B)!= 1)goto _LL139;_tmp17F=((struct Cyc_CfFlowInfo_LessVar_struct*)_tmp17B)->f1;
_LL138: if(Cyc_Toc_check_leq_size_var(relns,_tmp157,_tmp17F))return 1;else{goto
_LL130;}_LL139:;_LL13A: goto _LL130;_LL130:;}}}goto _LL127;_LL12C: if(*((int*)
_tmp175)!= 3)goto _LL12E;_tmp178=((struct Cyc_CfFlowInfo_LessConst_struct*)_tmp175)->f1;
_LL12D: return Cyc_Toc_check_const_array(_tmp178,(void*)_tmp157->type);_LL12E:;
...
void*_tmp18C=_tmp18B;struct Cyc_Absyn_Exp*_tmp18D;_LL13C: if(*((int*)_tmp18C)!= 0)
goto _LL13E;_tmp18D=((struct Cyc_Absyn_ArrayElement_struct*)_tmp18C)->f1;_LL13D:
Cyc_Toc_exp_to_c(nv,_tmp18D);e_index=_tmp18D;goto _LL13B;_LL13E: if(*((int*)
_tmp18C)!= 1)goto _LL13B;_LL13F:({void*_tmp18E[0]={};((int(*)(struct _tagged_arr
fmt,struct _tagged_arr ap))Cyc_Toc_unimp)(_tag_arr("field name designators in array",
sizeof(char),32),_tag_arr(_tmp18E,sizeof(void*),0));});_LL13B:;}}{struct Cyc_Absyn_Exp*
...
_LL141: if(*((int*)_tmp18F)!= 26)goto _LL143;_tmp190=((struct Cyc_Absyn_Array_e_struct*)
_tmp18F)->f1;_LL142: s=Cyc_Toc_init_array(nv,lval,_tmp190,s);goto _LL140;_LL143:
if(*((int*)_tmp18F)!= 27)goto _LL145;_tmp191=((struct Cyc_Absyn_Comprehension_e_struct*)
_tmp18F)->f1;_tmp192=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp18F)->f2;
_tmp193=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp18F)->f3;_LL144: s=Cyc_Toc_init_comprehension(
nv,lval,_tmp191,_tmp192,_tmp193,s,0);goto _LL140;_LL145: if(*((int*)_tmp18F)!= 29)
goto _LL147;_tmp194=(void*)((struct Cyc_Absyn_AnonStruct_e_struct*)_tmp18F)->f1;
_tmp195=((struct Cyc_Absyn_AnonStruct_e_struct*)_tmp18F)->f2;_LL146: s=Cyc_Toc_init_anon_struct(
nv,lval,_tmp194,_tmp195,s);goto _LL140;_LL147:;_LL148: Cyc_Toc_exp_to_c(nv,_tmp189);
s=Cyc_Absyn_seq_stmt(Cyc_Absyn_assign_stmt(Cyc_Absyn_subscript_exp(lhs,e_index,0),
_tmp189,0),s,0);goto _LL140;_LL140:;}}}}return s;}static struct Cyc_Absyn_Stmt*Cyc_Toc_init_comprehension(
...
_tmp19B;void*_tmp19C;struct Cyc_List_List*_tmp19D;_LL14A: if(*((int*)_tmp197)!= 26)
goto _LL14C;_tmp198=((struct Cyc_Absyn_Array_e_struct*)_tmp197)->f1;_LL14B: body=
Cyc_Toc_init_array(nv2,lval,_tmp198,Cyc_Toc_skip_stmt_dl());goto _LL149;_LL14C:
if(*((int*)_tmp197)!= 27)goto _LL14E;_tmp199=((struct Cyc_Absyn_Comprehension_e_struct*)
_tmp197)->f1;_tmp19A=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp197)->f2;
_tmp19B=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp197)->f3;_LL14D: body=Cyc_Toc_init_comprehension(
nv2,lval,_tmp199,_tmp19A,_tmp19B,Cyc_Toc_skip_stmt_dl(),0);goto _LL149;_LL14E: if(*((
int*)_tmp197)!= 29)goto _LL150;_tmp19C=(void*)((struct Cyc_Absyn_AnonStruct_e_struct*)
_tmp197)->f1;_tmp19D=((struct Cyc_Absyn_AnonStruct_e_struct*)_tmp197)->f2;_LL14F:
body=Cyc_Toc_init_anon_struct(nv,lval,_tmp19C,_tmp19D,Cyc_Toc_skip_stmt_dl());
goto _LL149;_LL150:;_LL151: Cyc_Toc_exp_to_c(nv2,e2);body=Cyc_Absyn_assign_stmt(
lval,e2,0);goto _LL149;_LL149:;}{struct Cyc_Absyn_Stmt*s2=Cyc_Absyn_for_stmt(ea,eb,
...
_tmp1A3->hd;struct _tagged_arr*_tmp1A8;_LL153: if(*((int*)_tmp1A7)!= 1)goto _LL155;
_tmp1A8=((struct Cyc_Absyn_FieldName_struct*)_tmp1A7)->f1;_LL154: {struct Cyc_Absyn_Exp*
...
_LL158: if(*((int*)_tmp1A9)!= 26)goto _LL15A;_tmp1AA=((struct Cyc_Absyn_Array_e_struct*)
_tmp1A9)->f1;_LL159: s=Cyc_Toc_init_array(nv,lval,_tmp1AA,s);goto _LL157;_LL15A:
if(*((int*)_tmp1A9)!= 27)goto _LL15C;_tmp1AB=((struct Cyc_Absyn_Comprehension_e_struct*)
_tmp1A9)->f1;_tmp1AC=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp1A9)->f2;
_tmp1AD=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp1A9)->f3;_LL15B: s=Cyc_Toc_init_comprehension(
nv,lval,_tmp1AB,_tmp1AC,_tmp1AD,s,0);goto _LL157;_LL15C: if(*((int*)_tmp1A9)!= 29)
goto _LL15E;_tmp1AE=(void*)((struct Cyc_Absyn_AnonStruct_e_struct*)_tmp1A9)->f1;
_tmp1AF=((struct Cyc_Absyn_AnonStruct_e_struct*)_tmp1A9)->f2;_LL15D: s=Cyc_Toc_init_anon_struct(
nv,lval,_tmp1AE,_tmp1AF,s);goto _LL157;_LL15E:;_LL15F: Cyc_Toc_exp_to_c(nv,_tmp1A4);
...
_tmp1A4,0),0),s,0);goto _LL157;_LL157:;}goto _LL152;}_LL155:;_LL156:({void*_tmp1B0[
...
void*),0));});_LL152:;}}}return s;}static struct Cyc_Absyn_Exp*Cyc_Toc_init_tuple(
...
_tmp1BC;struct Cyc_Absyn_Exp*_tmp1BD;_LL161: if(*((int*)_tmp1B9)!= 26)goto _LL163;
_tmp1BA=((struct Cyc_Absyn_Array_e_struct*)_tmp1B9)->f1;_LL162: _tmp1B6=Cyc_Toc_init_array(
nv,lval,_tmp1BA,_tmp1B6);goto _LL160;_LL163: if(*((int*)_tmp1B9)!= 27)goto _LL165;
...
_tmp1B9)->f3;_LL164: _tmp1B6=Cyc_Toc_init_comprehension(nv,lval,_tmp1BB,_tmp1BC,
_tmp1BD,_tmp1B6,0);goto _LL160;_LL165:;_LL166: Cyc_Toc_exp_to_c(nv,e);_tmp1B6=Cyc_Absyn_seq_stmt(
Cyc_Absyn_exp_stmt(Cyc_Absyn_assign_exp(_tmp1B7(_tmp1B5,Cyc_Absyn_fieldname(i),0),
e,0),0),_tmp1B6,0);goto _LL160;_LL160:;}}}{struct Cyc_Absyn_Exp*_tmp1BE=Cyc_Toc_make_struct(
...
_tmp1C5;_LL168: if(_tmp1C3 <= (void*)3?1:*((int*)_tmp1C3)!= 10)goto _LL16A;_tmp1C4=((
struct Cyc_Absyn_AggrType_struct*)_tmp1C3)->f1;_tmp1C5=(void*)_tmp1C4.aggr_info;
_LL169: ad=Cyc_Absyn_get_known_aggrdecl(_tmp1C5);goto _LL167;_LL16A:;_LL16B:({void*
...
sizeof(void*),0));});_LL167:;}{struct _RegionHandle _tmp1C7=_new_region("r");
...
_tagged_arr*_tmp1D1;_LL16D: if(*((int*)_tmp1D0)!= 1)goto _LL16F;_tmp1D1=((struct
Cyc_Absyn_FieldName_struct*)_tmp1D0)->f1;_LL16E: if(Cyc_Toc_is_poly_field(
...
_tmp1C2(_tmp1C0,_tmp1D1,0),_tmp1CF,0),0),_tmp1C1,0);goto _LL16C;_LL16F:;_LL170:({
...
void*),0));});_LL16C:;}Cyc_Toc_exp_to_c(nv,_tmp1CC);_tmp1C1=Cyc_Absyn_seq_stmt(
Cyc_Absyn_exp_stmt(Cyc_Absyn_assign_exp(_tmp1CF,_tmp1CC,0),0),_tmp1C1,0);}else{
void*_tmp1D3=(void*)_tmp1CB->hd;struct _tagged_arr*_tmp1D4;_LL172: if(*((int*)
_tmp1D3)!= 1)goto _LL174;_tmp1D4=((struct Cyc_Absyn_FieldName_struct*)_tmp1D3)->f1;
_LL173: {struct Cyc_Absyn_Exp*lval=_tmp1C2(_tmp1C0,_tmp1D4,0);{void*_tmp1D5=(void*)
...
_LL177: if(*((int*)_tmp1D5)!= 26)goto _LL179;_tmp1D6=((struct Cyc_Absyn_Array_e_struct*)
_tmp1D5)->f1;_LL178: _tmp1C1=Cyc_Toc_init_array(nv,lval,_tmp1D6,_tmp1C1);goto
_LL176;_LL179: if(*((int*)_tmp1D5)!= 27)goto _LL17B;_tmp1D7=((struct Cyc_Absyn_Comprehension_e_struct*)
_tmp1D5)->f1;_tmp1D8=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp1D5)->f2;
_tmp1D9=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp1D5)->f3;_LL17A: _tmp1C1=
Cyc_Toc_init_comprehension(nv,lval,_tmp1D7,_tmp1D8,_tmp1D9,_tmp1C1,0);goto _LL176;
_LL17B: if(*((int*)_tmp1D5)!= 29)goto _LL17D;_tmp1DA=(void*)((struct Cyc_Absyn_AnonStruct_e_struct*)
_tmp1D5)->f1;_tmp1DB=((struct Cyc_Absyn_AnonStruct_e_struct*)_tmp1D5)->f2;_LL17C:
_tmp1C1=Cyc_Toc_init_anon_struct(nv,lval,_tmp1DA,_tmp1DB,_tmp1C1);goto _LL176;
...
_tmp1C1,0);goto _LL176;}_LL176:;}goto _LL171;}_LL174:;_LL175:({void*_tmp1DC[0]={};((
int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_toc_impos)(_tag_arr("array designator in struct",
sizeof(char),27),_tag_arr(_tmp1DC,sizeof(void*),0));});_LL171:;}}}{struct Cyc_Absyn_Exp*
...
_tmp1E3;struct Cyc_Absyn_Exp*_tmp1E4;struct _tagged_arr*_tmp1E5;_LL180: if(*((int*)
_tmp1E0)!= 35)goto _LL182;_tmp1E1=((struct Cyc_Absyn_StmtExp_e_struct*)_tmp1E0)->f1;
_LL181: Cyc_Toc_lvalue_assign_stmt(_tmp1E1,fs,f,f_env);goto _LL17F;_LL182: if(*((
int*)_tmp1E0)!= 13)goto _LL184;_tmp1E2=(void*)((struct Cyc_Absyn_Cast_e_struct*)
_tmp1E0)->f1;_tmp1E3=((struct Cyc_Absyn_Cast_e_struct*)_tmp1E0)->f2;_LL183: Cyc_Toc_lvalue_assign(
_tmp1E3,fs,f,f_env);goto _LL17F;_LL184: if(*((int*)_tmp1E0)!= 21)goto _LL186;
_tmp1E4=((struct Cyc_Absyn_AggrMember_e_struct*)_tmp1E0)->f1;_tmp1E5=((struct Cyc_Absyn_AggrMember_e_struct*)
_tmp1E0)->f2;_LL185:(void*)(e1->r=(void*)((void*)_tmp1E4->r));Cyc_Toc_lvalue_assign(
e1,(struct Cyc_List_List*)({struct Cyc_List_List*_tmp1E6=_cycalloc(sizeof(*_tmp1E6));
_tmp1E6->hd=_tmp1E5;_tmp1E6->tl=fs;_tmp1E6;}),f,f_env);goto _LL17F;_LL186:;_LL187: {
...
void*)(e1->r=(void*)((void*)(f(e1_copy,f_env))->r));goto _LL17F;}_LL17F:;}static
...
_tmp1EA;struct Cyc_Absyn_Stmt*_tmp1EB;_LL189: if(_tmp1E7 <= (void*)1?1:*((int*)
_tmp1E7)!= 0)goto _LL18B;_tmp1E8=((struct Cyc_Absyn_Exp_s_struct*)_tmp1E7)->f1;
_LL18A: Cyc_Toc_lvalue_assign(_tmp1E8,fs,f,f_env);goto _LL188;_LL18B: if(_tmp1E7 <= (
void*)1?1:*((int*)_tmp1E7)!= 12)goto _LL18D;_tmp1E9=((struct Cyc_Absyn_Decl_s_struct*)
_tmp1E7)->f1;_tmp1EA=((struct Cyc_Absyn_Decl_s_struct*)_tmp1E7)->f2;_LL18C: Cyc_Toc_lvalue_assign_stmt(
_tmp1EA,fs,f,f_env);goto _LL188;_LL18D: if(_tmp1E7 <= (void*)1?1:*((int*)_tmp1E7)!= 
1)goto _LL18F;_tmp1EB=((struct Cyc_Absyn_Seq_s_struct*)_tmp1E7)->f2;_LL18E: Cyc_Toc_lvalue_assign_stmt(
_tmp1EB,fs,f,f_env);goto _LL188;_LL18F:;_LL190:({struct Cyc_Std_String_pa_struct
...
sizeof(char),23),_tag_arr(_tmp1EC,sizeof(void*),1));}});_LL188:;}static struct Cyc_List_List*
...
t);struct Cyc_Absyn_PtrInfo _tmp1F2;_LL192: if(_tmp1F1 <= (void*)3?1:*((int*)_tmp1F1)
!= 4)goto _LL194;_tmp1F2=((struct Cyc_Absyn_PointerType_struct*)_tmp1F1)->f1;
_LL193: return _tmp1F2;_LL194:;_LL195:({void*_tmp1F3[0]={};((int(*)(struct
_tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_toc_impos)(_tag_arr("get_ptr_typ: not a pointer!",
sizeof(char),28),_tag_arr(_tmp1F3,sizeof(void*),0));});_LL191:;}struct _tuple10{
...
_LL197: if(*((int*)_tmp1F7)!= 0)goto _LL199;_tmp1F8=(void*)((struct Cyc_Absyn_Const_e_struct*)
_tmp1F7)->f1;if((int)_tmp1F8 != 0)goto _LL199;_LL198: {struct Cyc_Absyn_Exp*_tmp246=
...
void*)(Cyc_Absyn_signed_int_exp(0,0))->r));}goto _LL196;}_LL199: if(*((int*)
_tmp1F7)!= 0)goto _LL19B;_LL19A: goto _LL196;_LL19B: if(*((int*)_tmp1F7)!= 1)goto
_LL19D;_tmp1F9=((struct Cyc_Absyn_Var_e_struct*)_tmp1F7)->f1;_tmp1FA=(void*)((
struct Cyc_Absyn_Var_e_struct*)_tmp1F7)->f2;_LL19C:{struct _handler_cons _tmp248;
...
else{void*_tmp249=(void*)_exn_thrown;void*_tmp24C=_tmp249;_LL1EC: if(_tmp24C != 
Cyc_Dict_Absent)goto _LL1EE;_LL1ED:({struct Cyc_Std_String_pa_struct _tmp24E;
...
_tag_arr(_tmp24D,sizeof(void*),1));}});_LL1EE:;_LL1EF:(void)_throw(_tmp24C);
_LL1EB:;}}}goto _LL196;_LL19D: if(*((int*)_tmp1F7)!= 2)goto _LL19F;_tmp1FB=((struct
Cyc_Absyn_UnknownId_e_struct*)_tmp1F7)->f1;_LL19E:({void*_tmp24F[0]={};((int(*)(
struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_toc_impos)(_tag_arr("unknownid",
sizeof(char),10),_tag_arr(_tmp24F,sizeof(void*),0));});_LL19F: if(*((int*)_tmp1F7)
!= 3)goto _LL1A1;_tmp1FC=(void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp1F7)->f1;
_tmp1FD=((struct Cyc_Absyn_Primop_e_struct*)_tmp1F7)->f2;_LL1A0: {struct Cyc_List_List*
...
Cyc_Toc_exp_to_c,nv,_tmp1FD);{void*_tmp251=_tmp1FC;_LL1F1: if((int)_tmp251 != 19)
goto _LL1F3;_LL1F2: {struct Cyc_Absyn_Exp*arg=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)
...
_tmp257;_LL206: if(_tmp252 <= (void*)3?1:*((int*)_tmp252)!= 7)goto _LL208;_tmp253=((
struct Cyc_Absyn_ArrayType_struct*)_tmp252)->f3;_LL207:(void*)(e->r=(void*)((void*)((
struct Cyc_Absyn_Exp*)_check_null(_tmp253))->r));goto _LL205;_LL208: if(_tmp252 <= (
void*)3?1:*((int*)_tmp252)!= 4)goto _LL20A;_tmp254=((struct Cyc_Absyn_PointerType_struct*)
_tmp252)->f1;_tmp255=(void*)_tmp254.elt_typ;_tmp256=_tmp254.nullable;_tmp257=
_tmp254.bounds;_LL209:{void*_tmp258=Cyc_Absyn_conref_def(Cyc_Absyn_bounds_one,
_tmp257);struct Cyc_Absyn_Exp*_tmp259;_LL20D: if((int)_tmp258 != 0)goto _LL20F;
_LL20E:(void*)(e->r=(void*)((void*)(Cyc_Absyn_fncall_exp(Cyc_Toc__get_arr_size_e,({
...
2));}),0))->r));goto _LL20C;_LL20F: if(_tmp258 <= (void*)1?1:*((int*)_tmp258)!= 0)
goto _LL20C;_tmp259=((struct Cyc_Absyn_Upper_b_struct*)_tmp258)->f1;_LL210: if(((
...
else{(void*)(e->r=(void*)((void*)_tmp259->r));goto _LL20C;}_LL20C:;}goto _LL205;
_LL20A:;_LL20B:({struct Cyc_Std_String_pa_struct _tmp25D;_tmp25D.tag=0;_tmp25D.f1=(
...
sizeof(char),41),_tag_arr(_tmp25B,sizeof(void*),2));}}});_LL205:;}goto _LL1F0;}
_LL1F3: if((int)_tmp251 != 0)goto _LL1F5;_LL1F4: {void*elt_typ=(void*)0;if(Cyc_Tcutil_is_tagged_pointer_typ_elt((
...
0))->r));}goto _LL1F0;}_LL1F5: if((int)_tmp251 != 2)goto _LL1F7;_LL1F6: {void*
...
sizeof(struct Cyc_Absyn_Exp*),3));}),0))->r));}}goto _LL1F0;}_LL1F7: if((int)
_tmp251 != 5)goto _LL1F9;_LL1F8: goto _LL1FA;_LL1F9: if((int)_tmp251 != 6)goto _LL1FB;
_LL1FA: goto _LL1FC;_LL1FB: if((int)_tmp251 != 7)goto _LL1FD;_LL1FC: goto _LL1FE;_LL1FD:
if((int)_tmp251 != 9)goto _LL1FF;_LL1FE: goto _LL200;_LL1FF: if((int)_tmp251 != 8)goto
_LL201;_LL200: goto _LL202;_LL201: if((int)_tmp251 != 10)goto _LL203;_LL202: {struct
...
void*)e2->r,0),Cyc_Toc_curr_sp,0))->r));goto _LL1F0;}_LL203:;_LL204: goto _LL1F0;
_LL1F0:;}goto _LL196;}_LL1A1: if(*((int*)_tmp1F7)!= 5)goto _LL1A3;_tmp1FE=((struct
Cyc_Absyn_Increment_e_struct*)_tmp1F7)->f1;_tmp1FF=(void*)((struct Cyc_Absyn_Increment_e_struct*)
_tmp1F7)->f2;_LL1A2: {void*e2_cyc_typ=(void*)((struct Cyc_Core_Opt*)_check_null(
...
goto _LL196;}}_LL1A3: if(*((int*)_tmp1F7)!= 4)goto _LL1A5;_tmp200=((struct Cyc_Absyn_AssignOp_e_struct*)
_tmp1F7)->f1;_tmp201=((struct Cyc_Absyn_AssignOp_e_struct*)_tmp1F7)->f2;_tmp202=((
struct Cyc_Absyn_AssignOp_e_struct*)_tmp1F7)->f3;_LL1A4: {int e1_poly=Cyc_Toc_is_poly_project(
...
change;{void*_tmp263=(void*)_tmp201->v;_LL212: if((int)_tmp263 != 0)goto _LL214;
_LL213: change=_tmp202;goto _LL211;_LL214: if((int)_tmp263 != 2)goto _LL216;_LL215:
change=Cyc_Absyn_prim1_exp((void*)2,_tmp202,0);goto _LL211;_LL216:;_LL217:({void*
...
void*),0));});_LL211:;}done=1;(void*)(e->r=(void*)((void*)(Cyc_Absyn_fncall_exp(
...
_LL196;}}_LL1A5: if(*((int*)_tmp1F7)!= 6)goto _LL1A7;_tmp203=((struct Cyc_Absyn_Conditional_e_struct*)
_tmp1F7)->f1;_tmp204=((struct Cyc_Absyn_Conditional_e_struct*)_tmp1F7)->f2;
_tmp205=((struct Cyc_Absyn_Conditional_e_struct*)_tmp1F7)->f3;_LL1A6: Cyc_Toc_exp_to_c(
nv,_tmp203);Cyc_Toc_exp_to_c(nv,_tmp204);Cyc_Toc_exp_to_c(nv,_tmp205);goto _LL196;
_LL1A7: if(*((int*)_tmp1F7)!= 7)goto _LL1A9;_tmp206=((struct Cyc_Absyn_SeqExp_e_struct*)
_tmp1F7)->f1;_tmp207=((struct Cyc_Absyn_SeqExp_e_struct*)_tmp1F7)->f2;_LL1A8: Cyc_Toc_exp_to_c(
nv,_tmp206);Cyc_Toc_exp_to_c(nv,_tmp207);goto _LL196;_LL1A9: if(*((int*)_tmp1F7)!= 
8)goto _LL1AB;_tmp208=((struct Cyc_Absyn_UnknownCall_e_struct*)_tmp1F7)->f1;
_tmp209=((struct Cyc_Absyn_UnknownCall_e_struct*)_tmp1F7)->f2;_LL1AA: _tmp20A=
_tmp208;_tmp20B=_tmp209;goto _LL1AC;_LL1AB: if(*((int*)_tmp1F7)!= 9)goto _LL1AD;
...
!= 0)goto _LL1AD;_LL1AC: Cyc_Toc_exp_to_c(nv,_tmp20A);((void(*)(void(*f)(struct Cyc_Toc_Env*,
struct Cyc_Absyn_Exp*),struct Cyc_Toc_Env*env,struct Cyc_List_List*x))Cyc_List_iter_c)(
Cyc_Toc_exp_to_c,nv,_tmp20B);goto _LL196;_LL1AD: if(*((int*)_tmp1F7)!= 9)goto
_LL1AF;_tmp20D=((struct Cyc_Absyn_FnCall_e_struct*)_tmp1F7)->f1;_tmp20E=((struct
Cyc_Absyn_FnCall_e_struct*)_tmp1F7)->f2;_tmp20F=((struct Cyc_Absyn_FnCall_e_struct*)
_tmp1F7)->f3;if(_tmp20F == 0)goto _LL1AF;_tmp210=*_tmp20F;_tmp211=_tmp210.num_varargs;
_tmp212=_tmp210.injectors;_tmp213=_tmp210.vai;_LL1AE:{struct _RegionHandle _tmp268=
...
_tmp270;_LL219: if(_tmp26C <= (void*)3?1:*((int*)_tmp26C)!= 2)goto _LL21B;_tmp26D=((
struct Cyc_Absyn_TunionType_struct*)_tmp26C)->f1;_tmp26E=(void*)_tmp26D.tunion_info;
if(*((int*)_tmp26E)!= 1)goto _LL21B;_tmp26F=((struct Cyc_Absyn_KnownTunion_struct*)
_tmp26E)->f1;_tmp270=*_tmp26F;_LL21A: tud=_tmp270;goto _LL218;_LL21B:;_LL21C:({
...
_tmp271,sizeof(void*),0));});_LL218:;}{struct _tagged_arr vs=({unsigned int _tmp278=(
...
void*)(Cyc_Absyn_stmt_exp(s,0))->r));}};_pop_region(r);}goto _LL196;_LL1AF: if(*((
int*)_tmp1F7)!= 10)goto _LL1B1;_tmp214=((struct Cyc_Absyn_Throw_e_struct*)_tmp1F7)->f1;
_LL1B0: Cyc_Toc_exp_to_c(nv,_tmp214);(void*)(e->r=(void*)((void*)(Cyc_Toc_array_to_ptr_cast(
Cyc_Toc_typ_to_c(old_typ),Cyc_Toc_newthrow_exp(_tmp214),0))->r));goto _LL196;
_LL1B1: if(*((int*)_tmp1F7)!= 11)goto _LL1B3;_tmp215=((struct Cyc_Absyn_NoInstantiate_e_struct*)
_tmp1F7)->f1;_LL1B2: Cyc_Toc_exp_to_c(nv,_tmp215);goto _LL196;_LL1B3: if(*((int*)
_tmp1F7)!= 12)goto _LL1B5;_tmp216=((struct Cyc_Absyn_Instantiate_e_struct*)_tmp1F7)->f1;
_tmp217=((struct Cyc_Absyn_Instantiate_e_struct*)_tmp1F7)->f2;_LL1B4: Cyc_Toc_exp_to_c(
...
void*)_tmp217->hd);_LL21E: if(_tmp27E <= (void*)3?1:*((int*)_tmp27E)!= 1)goto
_LL220;_LL21F: goto _LL221;_LL220: if(_tmp27E <= (void*)3?1:*((int*)_tmp27E)!= 2)
goto _LL222;_LL221: continue;_LL222:;_LL223:(void*)(e->r=(void*)((void*)(Cyc_Toc_array_to_ptr_cast(
Cyc_Toc_typ_to_c((void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v),_tmp216,
0))->r));goto _LL21D;_LL21D:;}break;}}goto _LL196;_LL1B5: if(*((int*)_tmp1F7)!= 13)
goto _LL1B7;_tmp218=(void*)((struct Cyc_Absyn_Cast_e_struct*)_tmp1F7)->f1;_tmp219=(
void**)&((void*)((struct Cyc_Absyn_Cast_e_struct*)_tmp1F7)->f1);_tmp21A=((struct
Cyc_Absyn_Cast_e_struct*)_tmp1F7)->f2;_LL1B6: {void*old_t2=(void*)((struct Cyc_Core_Opt*)
...
_tmp287;_LL225: _tmp281=_tmp280.f1;if(_tmp281 <= (void*)3?1:*((int*)_tmp281)!= 4)
goto _LL227;_tmp282=((struct Cyc_Absyn_PointerType_struct*)_tmp281)->f1;_tmp283=
_tmp280.f2;if(_tmp283 <= (void*)3?1:*((int*)_tmp283)!= 4)goto _LL227;_tmp284=((
struct Cyc_Absyn_PointerType_struct*)_tmp283)->f1;_LL226: {int _tmp288=((int(*)(
...
void*_tmp293;void*_tmp294;struct Cyc_Absyn_Exp*_tmp295;_LL22C: _tmp28E=_tmp28D.f1;
if(_tmp28E <= (void*)1?1:*((int*)_tmp28E)!= 0)goto _LL22E;_tmp28F=_tmp28D.f2;if(
_tmp28F <= (void*)1?1:*((int*)_tmp28F)!= 0)goto _LL22E;_LL22D: if(_tmp288?!_tmp289:
...
_tmp297->tl=0;_tmp297;}),0),0))->r));}goto _LL22B;_LL22E: _tmp290=_tmp28D.f1;if(
_tmp290 <= (void*)1?1:*((int*)_tmp290)!= 0)goto _LL230;_tmp291=((struct Cyc_Absyn_Upper_b_struct*)
_tmp290)->f1;_tmp292=_tmp28D.f2;if((int)_tmp292 != 0)goto _LL230;_LL22F: if(nv->toplevel)(
...
3));}),0))->r));}goto _LL22B;_LL230: _tmp293=_tmp28D.f1;if((int)_tmp293 != 0)goto
_LL232;_tmp294=_tmp28D.f2;if(_tmp294 <= (void*)1?1:*((int*)_tmp294)!= 0)goto
_LL232;_tmp295=((struct Cyc_Absyn_Upper_b_struct*)_tmp294)->f1;_LL231: if(nv->toplevel)({
...
_tmp219,_tmp29A,0))->r));goto _LL22B;}_LL232:;_LL233: goto _LL22B;_LL22B:;}goto
_LL224;}_LL227: _tmp285=_tmp280.f1;if(_tmp285 <= (void*)3?1:*((int*)_tmp285)!= 4)
goto _LL229;_tmp286=((struct Cyc_Absyn_PointerType_struct*)_tmp285)->f1;_tmp287=
_tmp280.f2;if(_tmp287 <= (void*)3?1:*((int*)_tmp287)!= 5)goto _LL229;_LL228:{void*
_tmp29D=Cyc_Absyn_conref_def(Cyc_Absyn_bounds_one,_tmp286.bounds);_LL235: if((int)
_tmp29D != 0)goto _LL237;_LL236:(void*)(_tmp21A->r=(void*)((void*)(Cyc_Absyn_aggrmember_exp(
Cyc_Absyn_new_exp((void*)_tmp21A->r,_tmp21A->loc),Cyc_Toc_curr_sp,0))->r));goto
_LL234;_LL237:;_LL238: goto _LL234;_LL234:;}goto _LL224;_LL229:;_LL22A: goto _LL224;
_LL224:;}goto _LL196;}_LL1B7: if(*((int*)_tmp1F7)!= 14)goto _LL1B9;_tmp21B=((struct
Cyc_Absyn_Address_e_struct*)_tmp1F7)->f1;_LL1B8:{void*_tmp29E=(void*)_tmp21B->r;
struct _tuple1*_tmp29F;struct Cyc_List_List*_tmp2A0;struct Cyc_List_List*_tmp2A1;
struct Cyc_List_List*_tmp2A2;_LL23A: if(*((int*)_tmp29E)!= 28)goto _LL23C;_tmp29F=((
struct Cyc_Absyn_Struct_e_struct*)_tmp29E)->f1;_tmp2A0=((struct Cyc_Absyn_Struct_e_struct*)
_tmp29E)->f2;_tmp2A1=((struct Cyc_Absyn_Struct_e_struct*)_tmp29E)->f3;_LL23B: if(
...
_tmp2A1,_tmp29F))->r));goto _LL239;_LL23C: if(*((int*)_tmp29E)!= 24)goto _LL23E;
_tmp2A2=((struct Cyc_Absyn_Tuple_e_struct*)_tmp29E)->f1;_LL23D: if(nv->toplevel)({
...
1,0,_tmp2A2))->r));goto _LL239;_LL23E:;_LL23F: Cyc_Toc_exp_to_c(nv,_tmp21B);if(!
...
0))->r));}goto _LL239;_LL239:;}goto _LL196;_LL1B9: if(*((int*)_tmp1F7)!= 15)goto
_LL1BB;_tmp21C=((struct Cyc_Absyn_New_e_struct*)_tmp1F7)->f1;_tmp21D=((struct Cyc_Absyn_New_e_struct*)
_tmp1F7)->f2;_LL1BA: if(nv->toplevel)({struct Cyc_Std_String_pa_struct _tmp2A8;
...
_tmp2B0;struct Cyc_List_List*_tmp2B1;_LL241: if(*((int*)_tmp2A9)!= 26)goto _LL243;
_tmp2AA=((struct Cyc_Absyn_Array_e_struct*)_tmp2A9)->f1;_LL242: {struct _tuple1*
...
Cyc_Absyn_PtrInfo _tmp2B6;void*_tmp2B7;struct Cyc_Absyn_Tqual _tmp2B8;_LL24C: if(
_tmp2B5 <= (void*)3?1:*((int*)_tmp2B5)!= 4)goto _LL24E;_tmp2B6=((struct Cyc_Absyn_PointerType_struct*)
_tmp2B5)->f1;_tmp2B7=(void*)_tmp2B6.elt_typ;_tmp2B8=_tmp2B6.tq;_LL24D:
old_elt_typ=_tmp2B7;goto _LL24B;_LL24E:;_LL24F: old_elt_typ=({void*_tmp2B9[0]={};
Cyc_Toc_toc_impos(_tag_arr("exp_to_c:new array expression doesn't have ptr type",
sizeof(char),52),_tag_arr(_tmp2B9,sizeof(void*),0));});_LL24B:;}{void*elt_typ=
...
_tmp2BA,(struct Cyc_Absyn_Exp*)e1,_tmp2B4,0),0))->r));goto _LL240;}}_LL243: if(*((
int*)_tmp2A9)!= 27)goto _LL245;_tmp2AB=((struct Cyc_Absyn_Comprehension_e_struct*)
_tmp2A9)->f1;_tmp2AC=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp2A9)->f2;
_tmp2AD=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp2A9)->f3;_LL244: {int
...
_LL251: if(_tmp2BC <= (void*)3?1:*((int*)_tmp2BC)!= 4)goto _LL253;_tmp2BD=((struct
Cyc_Absyn_PointerType_struct*)_tmp2BC)->f1;_tmp2BE=(void*)_tmp2BD.elt_typ;
_tmp2BF=_tmp2BD.tq;_tmp2C0=_tmp2BD.bounds;_LL252: is_tagged_ptr=Cyc_Absyn_conref_def(
Cyc_Absyn_bounds_one,_tmp2C0)== (void*)0;goto _LL250;_LL253:;_LL254:({void*
...
_tmp2C1,sizeof(void*),0));});_LL250:;}{struct _tuple1*max=Cyc_Toc_temp_var();
...
e->r=(void*)((void*)(Cyc_Absyn_stmt_exp(s,0))->r));}};_pop_region(r);}goto _LL240;}}}
_LL245: if(*((int*)_tmp2A9)!= 28)goto _LL247;_tmp2AE=((struct Cyc_Absyn_Struct_e_struct*)
_tmp2A9)->f1;_tmp2AF=((struct Cyc_Absyn_Struct_e_struct*)_tmp2A9)->f2;_tmp2B0=((
struct Cyc_Absyn_Struct_e_struct*)_tmp2A9)->f3;_LL246:(void*)(e->r=(void*)((void*)(
Cyc_Toc_init_struct(nv,(void*)((struct Cyc_Core_Opt*)_check_null(_tmp21D->topt))->v,
_tmp2AF != 0,1,_tmp21C,_tmp2B0,_tmp2AE))->r));goto _LL240;_LL247: if(*((int*)
_tmp2A9)!= 24)goto _LL249;_tmp2B1=((struct Cyc_Absyn_Tuple_e_struct*)_tmp2A9)->f1;
_LL248:(void*)(e->r=(void*)((void*)(Cyc_Toc_init_tuple(nv,1,_tmp21C,_tmp2B1))->r));
goto _LL240;_LL249:;_LL24A: {void*old_elt_typ=(void*)((struct Cyc_Core_Opt*)
...
void*_tmp2D6=(void*)_tmp21D->r;void*_tmp2D7;struct Cyc_Absyn_Exp*_tmp2D8;_LL256:
if(*((int*)_tmp2D6)!= 13)goto _LL258;_tmp2D7=(void*)((struct Cyc_Absyn_Cast_e_struct*)
_tmp2D6)->f1;_tmp2D8=((struct Cyc_Absyn_Cast_e_struct*)_tmp2D6)->f2;_LL257:{
...
_tmp2E0;struct Cyc_Absyn_Conref*_tmp2E1;_LL25B: _tmp2DB=_tmp2DA.f1;if(_tmp2DB <= (
void*)3?1:*((int*)_tmp2DB)!= 4)goto _LL25D;_tmp2DC=((struct Cyc_Absyn_PointerType_struct*)
_tmp2DB)->f1;_tmp2DD=(void*)_tmp2DC.elt_typ;_tmp2DE=_tmp2DC.bounds;_tmp2DF=
_tmp2DA.f2;if(_tmp2DF <= (void*)3?1:*((int*)_tmp2DF)!= 4)goto _LL25D;_tmp2E0=((
struct Cyc_Absyn_PointerType_struct*)_tmp2DF)->f1;_tmp2E1=_tmp2E0.bounds;_LL25C:{
...
void*_tmp2E4;void*_tmp2E5;struct Cyc_Absyn_Exp*_tmp2E6;_LL260: _tmp2E4=_tmp2E3.f1;
if((int)_tmp2E4 != 0)goto _LL262;_tmp2E5=_tmp2E3.f2;if(_tmp2E5 <= (void*)1?1:*((int*)
_tmp2E5)!= 0)goto _LL262;_tmp2E6=((struct Cyc_Absyn_Upper_b_struct*)_tmp2E5)->f1;
_LL261: Cyc_Toc_exp_to_c(nv,_tmp2D8);(void*)(inner_mexp->r=(void*)((void*)(Cyc_Absyn_sizeoftyp_exp(
...
4));}),0))->r));goto _LL25F;_LL262:;_LL263: goto _LL25F;_LL25F:;}goto _LL25A;_LL25D:;
_LL25E: goto _LL25A;_LL25A:;}goto _LL255;_LL258:;_LL259: goto _LL255;_LL255:;}if(!
...
Cyc_Absyn_Exp*)mexp,_tmp2E8,0),0))->r));}}goto _LL240;}}_LL240:;}goto _LL196;
_LL1BB: if(*((int*)_tmp1F7)!= 17)goto _LL1BD;_tmp21E=((struct Cyc_Absyn_Sizeofexp_e_struct*)
_tmp1F7)->f1;_LL1BC: Cyc_Toc_exp_to_c(nv,_tmp21E);goto _LL196;_LL1BD: if(*((int*)
_tmp1F7)!= 16)goto _LL1BF;_tmp21F=(void*)((struct Cyc_Absyn_Sizeoftyp_e_struct*)
_tmp1F7)->f1;_LL1BE:(void*)(e->r=(void*)((void*)({struct Cyc_Absyn_Sizeoftyp_e_struct*
...
_tmp2EB;})));goto _LL196;_LL1BF: if(*((int*)_tmp1F7)!= 19)goto _LL1C1;_LL1C0:({void*
...
void*),0));});_LL1C1: if(*((int*)_tmp1F7)!= 18)goto _LL1C3;_tmp220=(void*)((struct
Cyc_Absyn_Offsetof_e_struct*)_tmp1F7)->f1;_tmp221=(void*)((struct Cyc_Absyn_Offsetof_e_struct*)
_tmp1F7)->f2;if(*((int*)_tmp221)!= 0)goto _LL1C3;_tmp222=((struct Cyc_Absyn_StructField_struct*)
_tmp221)->f1;_LL1C2:(void*)(e->r=(void*)((void*)({struct Cyc_Absyn_Offsetof_e_struct*
...
_tmp2F1.f1=_tmp222;_tmp2F1;});_tmp2F0;}));_tmp2EF;});_tmp2EE;})));goto _LL196;
_LL1C3: if(*((int*)_tmp1F7)!= 18)goto _LL1C5;_tmp223=(void*)((struct Cyc_Absyn_Offsetof_e_struct*)
_tmp1F7)->f1;_tmp224=(void*)((struct Cyc_Absyn_Offsetof_e_struct*)_tmp1F7)->f2;
if(*((int*)_tmp224)!= 1)goto _LL1C5;_tmp225=((struct Cyc_Absyn_TupleIndex_struct*)
_tmp224)->f1;_LL1C4:{void*_tmp2F2=Cyc_Tcutil_compress(_tmp223);struct Cyc_Absyn_AggrInfo
_tmp2F3;void*_tmp2F4;struct Cyc_List_List*_tmp2F5;_LL265: if(_tmp2F2 <= (void*)3?1:*((
int*)_tmp2F2)!= 10)goto _LL267;_tmp2F3=((struct Cyc_Absyn_AggrType_struct*)_tmp2F2)->f1;
_tmp2F4=(void*)_tmp2F3.aggr_info;_LL266: {struct Cyc_Absyn_Aggrdecl*_tmp2F6=Cyc_Absyn_get_known_aggrdecl(
...
_check_null(_tmp2F6->impl))->fields;goto _LL268;}_LL267: if(_tmp2F2 <= (void*)3?1:*((
int*)_tmp2F2)!= 11)goto _LL269;_tmp2F5=((struct Cyc_Absyn_AnonAggrType_struct*)
_tmp2F2)->f2;_LL268: {struct Cyc_Absyn_Aggrfield*_tmp2F8=((struct Cyc_Absyn_Aggrfield*(*)(
...
_tmp2FC;});_tmp2FB;}));_tmp2FA;});_tmp2F9;})));goto _LL264;}_LL269: if(_tmp2F2 <= (
void*)3?1:*((int*)_tmp2F2)!= 9)goto _LL26B;_LL26A:(void*)(e->r=(void*)((void*)({
...
_tmp2FF;}));_tmp2FE;});_tmp2FD;})));goto _LL264;_LL26B: if(_tmp2F2 <= (void*)3?1:*((
int*)_tmp2F2)!= 3)goto _LL26D;_LL26C: if(_tmp225 == 0)(void*)(e->r=(void*)((void*)({
...
_tmp305;})));}goto _LL264;_LL26D:;_LL26E:({void*_tmp309[0]={};((int(*)(struct
_tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_toc_impos)(_tag_arr("impossible type for offsetof tuple index",
sizeof(char),41),_tag_arr(_tmp309,sizeof(void*),0));});_LL264:;}goto _LL196;
_LL1C5: if(*((int*)_tmp1F7)!= 20)goto _LL1C7;_tmp226=((struct Cyc_Absyn_Deref_e_struct*)
_tmp1F7)->f1;_LL1C6: {void*_tmp30A=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
...
_tmp310;struct Cyc_Absyn_Conref*_tmp311;_LL270: if(_tmp30B <= (void*)3?1:*((int*)
_tmp30B)!= 4)goto _LL272;_tmp30C=((struct Cyc_Absyn_PointerType_struct*)_tmp30B)->f1;
_tmp30D=(void*)_tmp30C.elt_typ;_tmp30E=(void*)_tmp30C.rgn_typ;_tmp30F=_tmp30C.nullable;
_tmp310=_tmp30C.tq;_tmp311=_tmp30C.bounds;_LL271:{void*_tmp312=Cyc_Absyn_conref_def(
Cyc_Absyn_bounds_one,_tmp311);_LL275: if(_tmp312 <= (void*)1?1:*((int*)_tmp312)!= 
0)goto _LL277;_LL276: {int do_null_check=Cyc_Toc_need_null_check(_tmp226);Cyc_Toc_exp_to_c(
...
0),0),0))->r));goto _LL274;}_LL277: if((int)_tmp312 != 0)goto _LL274;_LL278: {struct
...
nv,e);goto _LL274;}_LL274:;}goto _LL26F;_LL272:;_LL273:({void*_tmp316[0]={};((int(*)(
struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_toc_impos)(_tag_arr("exp_to_c: Deref: non-pointer",
sizeof(char),29),_tag_arr(_tmp316,sizeof(void*),0));});_LL26F:;}goto _LL196;}
_LL1C7: if(*((int*)_tmp1F7)!= 21)goto _LL1C9;_tmp227=((struct Cyc_Absyn_AggrMember_e_struct*)
_tmp1F7)->f1;_tmp228=((struct Cyc_Absyn_AggrMember_e_struct*)_tmp1F7)->f2;_LL1C8:
...
_check_null(e->topt))->v),Cyc_Absyn_new_exp((void*)e->r,0),0))->r));goto _LL196;
_LL1C9: if(*((int*)_tmp1F7)!= 22)goto _LL1CB;_tmp229=((struct Cyc_Absyn_AggrArrow_e_struct*)
_tmp1F7)->f1;_tmp22A=((struct Cyc_Absyn_AggrArrow_e_struct*)_tmp1F7)->f2;_LL1CA: {
...
_tmp31E;_LL27A: if(_tmp31D <= (void*)1?1:*((int*)_tmp31D)!= 0)goto _LL27C;_tmp31E=((
struct Cyc_Absyn_Upper_b_struct*)_tmp31D)->f1;_LL27B: {unsigned int _tmp320;int
...
goto _LL279;}_LL27C: if((int)_tmp31D != 0)goto _LL279;_LL27D: {void*ta1=Cyc_Toc_typ_to_c_array(
...
0),0))->r));goto _LL279;}_LL279:;}if(is_poly)(void*)(e->r=(void*)((void*)(Cyc_Toc_array_to_ptr_cast(
Cyc_Toc_typ_to_c((void*)((struct Cyc_Core_Opt*)_check_null(e->topt))->v),Cyc_Absyn_new_exp((
void*)e->r,0),0))->r));goto _LL196;}}_LL1CB: if(*((int*)_tmp1F7)!= 23)goto _LL1CD;
_tmp22B=((struct Cyc_Absyn_Subscript_e_struct*)_tmp1F7)->f1;_tmp22C=((struct Cyc_Absyn_Subscript_e_struct*)
_tmp1F7)->f2;_LL1CC: {void*_tmp326=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
...
_tmp32C;struct Cyc_Absyn_Tqual _tmp32D;struct Cyc_Absyn_Conref*_tmp32E;_LL27F: if(
_tmp327 <= (void*)3?1:*((int*)_tmp327)!= 9)goto _LL281;_tmp328=((struct Cyc_Absyn_TupleType_struct*)
_tmp327)->f1;_LL280: Cyc_Toc_exp_to_c(nv,_tmp22B);Cyc_Toc_exp_to_c(nv,_tmp22C);{
...
goto _LL27E;}_LL281: if(_tmp327 <= (void*)3?1:*((int*)_tmp327)!= 4)goto _LL283;
...
_tmp329.tq;_tmp32E=_tmp329.bounds;_LL282: {struct Cyc_List_List*_tmp333=Cyc_Toc_get_relns(
...
_tmp32E);struct Cyc_Absyn_Exp*_tmp338;_LL286: if(_tmp337 <= (void*)1?1:*((int*)
_tmp337)!= 0)goto _LL288;_tmp338=((struct Cyc_Absyn_Upper_b_struct*)_tmp337)->f1;
_LL287: {int possibly_null=((int(*)(int,struct Cyc_Absyn_Conref*x))Cyc_Absyn_conref_def)(
...
_tmp33A,sizeof(struct Cyc_Absyn_Exp*),2));}),0))->r));}}goto _LL285;}_LL288: if((
int)_tmp337 != 0)goto _LL285;_LL289: {void*ta1=Cyc_Toc_typ_to_c_array(_tmp32A);if(
...
3));}),0),0),0))->r));}goto _LL285;}_LL285:;}goto _LL27E;}_LL283:;_LL284:({void*
...
_tag_arr(_tmp33C,sizeof(void*),0));});_LL27E:;}goto _LL196;}_LL1CD: if(*((int*)
_tmp1F7)!= 24)goto _LL1CF;_tmp22D=((struct Cyc_Absyn_Tuple_e_struct*)_tmp1F7)->f1;
_LL1CE: if(!nv->toplevel)(void*)(e->r=(void*)((void*)(Cyc_Toc_init_tuple(nv,0,0,
...
goto _LL196;_LL1CF: if(*((int*)_tmp1F7)!= 26)goto _LL1D1;_tmp22E=((struct Cyc_Absyn_Array_e_struct*)
_tmp1F7)->f1;_LL1D0:(void*)(e->r=(void*)((void*)(Cyc_Absyn_unresolvedmem_exp(0,
...
nv,_tmp344);}}goto _LL196;_LL1D1: if(*((int*)_tmp1F7)!= 27)goto _LL1D3;_tmp22F=((
...
_LL1D2: {unsigned int _tmp346;int _tmp347;struct _tuple5 _tmp345=Cyc_Evexp_eval_const_uint_exp(
...
void*)(Cyc_Absyn_unresolvedmem_exp(0,es,0))->r));goto _LL196;}}_LL1D3: if(*((int*)
_tmp1F7)!= 28)goto _LL1D5;_tmp232=((struct Cyc_Absyn_Struct_e_struct*)_tmp1F7)->f1;
_tmp233=((struct Cyc_Absyn_Struct_e_struct*)_tmp1F7)->f2;_tmp234=((struct Cyc_Absyn_Struct_e_struct*)
_tmp1F7)->f3;_tmp235=((struct Cyc_Absyn_Struct_e_struct*)_tmp1F7)->f4;_LL1D4: if(!
...
x))Cyc_List_imp_rev)(_tmp34E),0))->r));};_pop_region(rgn);}}goto _LL196;_LL1D5:
if(*((int*)_tmp1F7)!= 29)goto _LL1D7;_tmp236=(void*)((struct Cyc_Absyn_AnonStruct_e_struct*)
_tmp1F7)->f1;_tmp237=((struct Cyc_Absyn_AnonStruct_e_struct*)_tmp1F7)->f2;_LL1D6: {
struct Cyc_List_List*fs;{void*_tmp358=Cyc_Tcutil_compress(_tmp236);struct Cyc_List_List*
_tmp359;_LL28B: if(_tmp358 <= (void*)3?1:*((int*)_tmp358)!= 11)goto _LL28D;_tmp359=((
struct Cyc_Absyn_AnonAggrType_struct*)_tmp358)->f2;_LL28C: fs=_tmp359;goto _LL28A;
_LL28D:;_LL28E:({struct Cyc_Std_String_pa_struct _tmp35B;_tmp35B.tag=0;_tmp35B.f1=(
...
sizeof(char),24),_tag_arr(_tmp35A,sizeof(void*),1));}});_LL28A:;}{struct
...
Cyc_Absyn_unresolvedmem_exp(0,_tmp237,0))->r));};_pop_region(rgn);}goto _LL196;}
_LL1D7: if(*((int*)_tmp1F7)!= 30)goto _LL1D9;_tmp238=((struct Cyc_Absyn_Tunion_e_struct*)
_tmp1F7)->f1;if(_tmp238 != 0)goto _LL1D9;_tmp239=((struct Cyc_Absyn_Tunion_e_struct*)
_tmp1F7)->f2;_tmp23A=((struct Cyc_Absyn_Tunion_e_struct*)_tmp1F7)->f3;_LL1D8: {
...
void*)tag_exp->r));goto _LL196;}_LL1D9: if(*((int*)_tmp1F7)!= 30)goto _LL1DB;
_tmp23B=((struct Cyc_Absyn_Tunion_e_struct*)_tmp1F7)->f1;_tmp23C=((struct Cyc_Absyn_Tunion_e_struct*)
_tmp1F7)->f2;_tmp23D=((struct Cyc_Absyn_Tunion_e_struct*)_tmp1F7)->f3;_LL1DA: {
...
_tmp365,_tmp367,0,_tmp371,0),0))->r));}}goto _LL196;}_LL1DB: if(*((int*)_tmp1F7)!= 
31)goto _LL1DD;_LL1DC: goto _LL1DE;_LL1DD: if(*((int*)_tmp1F7)!= 32)goto _LL1DF;
_LL1DE: goto _LL196;_LL1DF: if(*((int*)_tmp1F7)!= 33)goto _LL1E1;_tmp23E=((struct Cyc_Absyn_Malloc_e_struct*)
_tmp1F7)->f1;_tmp23F=_tmp23E.is_calloc;_tmp240=_tmp23E.rgn;_tmp241=_tmp23E.elt_type;
_tmp242=_tmp23E.num_elts;_tmp243=_tmp23E.fat_result;_LL1E0: {void*t_c=Cyc_Toc_typ_to_c(*((
...
t_c,0)))->r));}}goto _LL196;}_LL1E1: if(*((int*)_tmp1F7)!= 35)goto _LL1E3;_tmp244=((
struct Cyc_Absyn_StmtExp_e_struct*)_tmp1F7)->f1;_LL1E2: Cyc_Toc_stmt_to_c(nv,
_tmp244);goto _LL196;_LL1E3: if(*((int*)_tmp1F7)!= 34)goto _LL1E5;_LL1E4:({void*
...
_LL1E5: if(*((int*)_tmp1F7)!= 25)goto _LL1E7;_LL1E6:({void*_tmp37A[0]={};((int(*)(
struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_unimp)(_tag_arr("compoundlit",
sizeof(char),12),_tag_arr(_tmp37A,sizeof(void*),0));});_LL1E7: if(*((int*)_tmp1F7)
!= 36)goto _LL1E9;_tmp245=((struct Cyc_Absyn_Codegen_e_struct*)_tmp1F7)->f1;_LL1E8:({
void*_tmp37B[0]={};((int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_unimp)(
_tag_arr("codegen",sizeof(char),8),_tag_arr(_tmp37B,sizeof(void*),0));});_LL1E9:
if(*((int*)_tmp1F7)!= 37)goto _LL196;_LL1EA:({void*_tmp37C[0]={};((int(*)(struct
_tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_unimp)(_tag_arr("fill",sizeof(char),
5),_tag_arr(_tmp37C,sizeof(void*),0));});_LL196:;}}static struct Cyc_Absyn_Stmt*
...
struct Cyc_Absyn_Pat*_tmp398;_LL290: if(_tmp37D <= (void*)2?1:*((int*)_tmp37D)!= 0)
goto _LL292;_tmp37E=((struct Cyc_Absyn_Var_p_struct*)_tmp37D)->f1;_tmp37F=*_tmp37E;
_tmp380=_tmp37F.name;_LL291: nv=Cyc_Toc_add_varmap(nv,_tmp380,r);goto _LL293;
_LL292: if((int)_tmp37D != 0)goto _LL294;_LL293: s=Cyc_Toc_skip_stmt_dl();goto _LL28F;
_LL294: if(_tmp37D <= (void*)2?1:*((int*)_tmp37D)!= 6)goto _LL296;_tmp381=((struct
Cyc_Absyn_Reference_p_struct*)_tmp37D)->f1;_LL295: {struct _tuple1*_tmp399=Cyc_Toc_temp_var();
...
path,0),0),0);goto _LL28F;}_LL296: if((int)_tmp37D != 1)goto _LL298;_LL297: s=Cyc_Toc_if_neq_stmt(
r,Cyc_Absyn_signed_int_exp(0,0),fail_stmt);goto _LL28F;_LL298: if(_tmp37D <= (void*)
2?1:*((int*)_tmp37D)!= 1)goto _LL29A;_tmp382=(void*)((struct Cyc_Absyn_Int_p_struct*)
_tmp37D)->f1;_tmp383=((struct Cyc_Absyn_Int_p_struct*)_tmp37D)->f2;_LL299: s=Cyc_Toc_if_neq_stmt(
r,Cyc_Absyn_int_exp(_tmp382,_tmp383,0),fail_stmt);goto _LL28F;_LL29A: if(_tmp37D <= (
void*)2?1:*((int*)_tmp37D)!= 2)goto _LL29C;_tmp384=((struct Cyc_Absyn_Char_p_struct*)
_tmp37D)->f1;_LL29B: s=Cyc_Toc_if_neq_stmt(r,Cyc_Absyn_char_exp(_tmp384,0),
fail_stmt);goto _LL28F;_LL29C: if(_tmp37D <= (void*)2?1:*((int*)_tmp37D)!= 3)goto
_LL29E;_tmp385=((struct Cyc_Absyn_Float_p_struct*)_tmp37D)->f1;_LL29D: s=Cyc_Toc_if_neq_stmt(
r,Cyc_Absyn_float_exp(_tmp385,0),fail_stmt);goto _LL28F;_LL29E: if(_tmp37D <= (void*)
2?1:*((int*)_tmp37D)!= 9)goto _LL2A0;_tmp386=((struct Cyc_Absyn_Enum_p_struct*)
_tmp37D)->f1;_tmp387=((struct Cyc_Absyn_Enum_p_struct*)_tmp37D)->f2;_LL29F: s=Cyc_Toc_if_neq_stmt(
...
fail_stmt);goto _LL28F;_LL2A0: if(_tmp37D <= (void*)2?1:*((int*)_tmp37D)!= 10)goto
_LL2A2;_tmp388=(void*)((struct Cyc_Absyn_AnonEnum_p_struct*)_tmp37D)->f1;_tmp389=((
struct Cyc_Absyn_AnonEnum_p_struct*)_tmp37D)->f2;_LL2A1: s=Cyc_Toc_if_neq_stmt(r,
...
_tmp389;_tmp39F;});_tmp39E;}),0),fail_stmt);goto _LL28F;_LL2A2: if(_tmp37D <= (void*)
2?1:*((int*)_tmp37D)!= 8)goto _LL2A4;_tmp38A=((struct Cyc_Absyn_Tunion_p_struct*)
_tmp37D)->f1;_tmp38B=((struct Cyc_Absyn_Tunion_p_struct*)_tmp37D)->f2;_tmp38C=((
struct Cyc_Absyn_Tunion_p_struct*)_tmp37D)->f3;if(_tmp38C != 0)goto _LL2A4;_LL2A3: {
...
Cyc_Absyn_sint_typ,r,0);}s=Cyc_Toc_if_neq_stmt(r,cmp_exp,fail_stmt);goto _LL28F;}
_LL2A4: if(_tmp37D <= (void*)2?1:*((int*)_tmp37D)!= 5)goto _LL2A6;_tmp38D=((struct
Cyc_Absyn_Pointer_p_struct*)_tmp37D)->f1;_tmp38E=*_tmp38D;_tmp38F=(void*)_tmp38E.r;
if(_tmp38F <= (void*)2?1:*((int*)_tmp38F)!= 8)goto _LL2A6;_tmp390=((struct Cyc_Absyn_Tunion_p_struct*)
_tmp38F)->f1;_tmp391=((struct Cyc_Absyn_Tunion_p_struct*)_tmp38F)->f2;_tmp392=((
struct Cyc_Absyn_Tunion_p_struct*)_tmp38F)->f3;if(!(_tmp392 != 0))goto _LL2A6;
_LL2A5: s=Cyc_Toc_skip_stmt_dl();{int cnt=1;struct _tuple1*tufstrct=Cyc_Toc_collapse_qvar_tag(
...
0),s,0);goto _LL28F;}}_LL2A6: if(_tmp37D <= (void*)2?1:*((int*)_tmp37D)!= 8)goto
_LL2A8;_tmp393=((struct Cyc_Absyn_Tunion_p_struct*)_tmp37D)->f3;_LL2A7: _tmp394=
_tmp393;goto _LL2A9;_LL2A8: if(_tmp37D <= (void*)2?1:*((int*)_tmp37D)!= 4)goto
_LL2AA;_tmp394=((struct Cyc_Absyn_Tuple_p_struct*)_tmp37D)->f1;_LL2A9: s=Cyc_Toc_skip_stmt_dl();{
...
s,Cyc_Absyn_seq_stmt(_tmp3B3,_tmp3B2,0),0);}}}}goto _LL28F;}_LL2AA: if(_tmp37D <= (
void*)2?1:*((int*)_tmp37D)!= 7)goto _LL2AC;_tmp395=((struct Cyc_Absyn_Aggr_p_struct*)
_tmp37D)->f1;_tmp396=(void*)_tmp395.aggr_info;_tmp397=((struct Cyc_Absyn_Aggr_p_struct*)
_tmp37D)->f3;_LL2AB: {struct Cyc_Absyn_Aggrdecl*_tmp3B4=Cyc_Absyn_get_known_aggrdecl(
...
_tagged_arr*_tmp3B8;_LL2B3: if(*((int*)_tmp3B7)!= 1)goto _LL2B5;_tmp3B8=((struct
Cyc_Absyn_FieldName_struct*)_tmp3B7)->f1;_LL2B4: f=_tmp3B8;goto _LL2B2;_LL2B5:;
_LL2B6:(int)_throw((void*)Cyc_Toc_Match_error);_LL2B2:;}{struct _tuple1*_tmp3B9=
...
s,Cyc_Absyn_seq_stmt(_tmp3C1,_tmp3C0,0),0);}}}}}}goto _LL28F;}_LL2AC: if(_tmp37D <= (
void*)2?1:*((int*)_tmp37D)!= 5)goto _LL2AE;_tmp398=((struct Cyc_Absyn_Pointer_p_struct*)
_tmp37D)->f1;_LL2AD: {struct _tuple1*_tmp3C2=Cyc_Toc_temp_var();void*_tmp3C3=(
...
_LL28F;}}}_LL2AE: if(_tmp37D <= (void*)2?1:*((int*)_tmp37D)!= 11)goto _LL2B0;_LL2AF:({
...
_LL2B0: if(_tmp37D <= (void*)2?1:*((int*)_tmp37D)!= 12)goto _LL28F;_LL2B1:({void*
...
_LL28F:;}return({struct _tuple12 _tmp3CB;_tmp3CB.f1=nv;_tmp3CB.f2=decls;_tmp3CB.f3=
...
void*_tmp3CE=Cyc_Tcutil_compress(_tmp3CD);_LL2B8: if(_tmp3CE <= (void*)3?1:*((int*)
_tmp3CE)!= 5)goto _LL2BA;_LL2B9: goto _LL2BB;_LL2BA: if(_tmp3CE <= (void*)3?1:*((int*)
_tmp3CE)!= 12)goto _LL2BC;_LL2BB: leave_as_switch=1;goto _LL2B7;_LL2BC:;_LL2BD:
leave_as_switch=0;goto _LL2B7;_LL2B7:;}{struct Cyc_List_List*_tmp3CF=scs;for(0;
...
struct Cyc_Absyn_Exp*_tmp410;_LL2BF: if((int)_tmp3EB != 0)goto _LL2C1;_LL2C0: return;
_LL2C1: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 0)goto _LL2C3;_tmp3EC=((struct
Cyc_Absyn_Exp_s_struct*)_tmp3EB)->f1;_LL2C2: Cyc_Toc_exp_to_c(nv,_tmp3EC);return;
_LL2C3: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 1)goto _LL2C5;_tmp3ED=((struct
Cyc_Absyn_Seq_s_struct*)_tmp3EB)->f1;_tmp3EE=((struct Cyc_Absyn_Seq_s_struct*)
_tmp3EB)->f2;_LL2C4: Cyc_Toc_stmt_to_c(nv,_tmp3ED);s=_tmp3EE;continue;_LL2C5: if(
_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 2)goto _LL2C7;_tmp3EF=((struct Cyc_Absyn_Return_s_struct*)
_tmp3EB)->f1;_LL2C6: {struct Cyc_Core_Opt*topt=0;if(_tmp3EF != 0){topt=({struct Cyc_Core_Opt*
...
return;}_LL2C7: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 3)goto _LL2C9;_tmp3F0=((
struct Cyc_Absyn_IfThenElse_s_struct*)_tmp3EB)->f1;_tmp3F1=((struct Cyc_Absyn_IfThenElse_s_struct*)
_tmp3EB)->f2;_tmp3F2=((struct Cyc_Absyn_IfThenElse_s_struct*)_tmp3EB)->f3;_LL2C8:
Cyc_Toc_exp_to_c(nv,_tmp3F0);Cyc_Toc_stmt_to_c(nv,_tmp3F1);s=_tmp3F2;continue;
_LL2C9: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 4)goto _LL2CB;_tmp3F3=((struct
Cyc_Absyn_While_s_struct*)_tmp3EB)->f1;_tmp3F4=_tmp3F3.f1;_tmp3F5=((struct Cyc_Absyn_While_s_struct*)
_tmp3EB)->f2;_LL2CA: Cyc_Toc_exp_to_c(nv,_tmp3F4);Cyc_Toc_stmt_to_c(Cyc_Toc_loop_env(
nv),_tmp3F5);return;_LL2CB: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 5)goto
_LL2CD;_tmp3F6=((struct Cyc_Absyn_Break_s_struct*)_tmp3EB)->f1;_LL2CC: if(nv->break_lab
...
s);return;}_LL2CD: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 6)goto _LL2CF;
_tmp3F7=((struct Cyc_Absyn_Continue_s_struct*)_tmp3EB)->f1;_LL2CE: if(nv->continue_lab
!= 0)(void*)(s->r=(void*)((void*)(Cyc_Absyn_goto_stmt((struct _tagged_arr*)((
struct Cyc_Core_Opt*)_check_null(nv->continue_lab))->v,0))->r));_tmp3F8=_tmp3F7;
goto _LL2D0;_LL2CF: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 7)goto _LL2D1;
_tmp3F8=((struct Cyc_Absyn_Goto_s_struct*)_tmp3EB)->f2;_LL2D0: Cyc_Toc_do_npop_before(
s->try_depth - ((struct Cyc_Absyn_Stmt*)_check_null(_tmp3F8))->try_depth,s);
return;_LL2D1: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 8)goto _LL2D3;_tmp3F9=((
...
_tmp3FD=_tmp3FC.f1;_tmp3FE=((struct Cyc_Absyn_For_s_struct*)_tmp3EB)->f4;_LL2D2:
Cyc_Toc_exp_to_c(nv,_tmp3F9);Cyc_Toc_exp_to_c(nv,_tmp3FB);Cyc_Toc_exp_to_c(nv,
_tmp3FD);Cyc_Toc_stmt_to_c(Cyc_Toc_loop_env(nv),_tmp3FE);return;_LL2D3: if(
_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 9)goto _LL2D5;_tmp3FF=((struct Cyc_Absyn_Switch_s_struct*)
_tmp3EB)->f1;_tmp400=((struct Cyc_Absyn_Switch_s_struct*)_tmp3EB)->f2;_LL2D4: Cyc_Toc_xlate_switch(
nv,s,_tmp3FF,_tmp400);return;_LL2D5: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 
11)goto _LL2D7;_tmp401=((struct Cyc_Absyn_Fallthru_s_struct*)_tmp3EB)->f1;_tmp402=((
struct Cyc_Absyn_Fallthru_s_struct*)_tmp3EB)->f2;_LL2D6: if(nv->fallthru_info == 0)({
...
_tmp41B->hd,0),s2,0);}(void*)(s->r=(void*)((void*)s2->r));return;}}}_LL2D7: if(
_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 12)goto _LL2D9;_tmp403=((struct Cyc_Absyn_Decl_s_struct*)
_tmp3EB)->f1;_tmp404=((struct Cyc_Absyn_Decl_s_struct*)_tmp3EB)->f2;_LL2D8:{void*
_tmp41C=(void*)_tmp403->r;struct Cyc_Absyn_Vardecl*_tmp41D;struct Cyc_Absyn_Pat*
_tmp41E;struct Cyc_Absyn_Exp*_tmp41F;struct Cyc_List_List*_tmp420;_LL2EC: if(*((int*)
_tmp41C)!= 0)goto _LL2EE;_tmp41D=((struct Cyc_Absyn_Var_d_struct*)_tmp41C)->f1;
_LL2ED: {struct Cyc_Toc_Env*_tmp421=Cyc_Toc_add_varmap(nv,_tmp41D->name,Cyc_Absyn_varb_exp(
...
_tmp421,_tmp41D,_tmp404);goto _LL2EB;}_LL2EE: if(*((int*)_tmp41C)!= 2)goto _LL2F0;
_tmp41E=((struct Cyc_Absyn_Let_d_struct*)_tmp41C)->f1;_tmp41F=((struct Cyc_Absyn_Let_d_struct*)
_tmp41C)->f3;_LL2EF:{void*_tmp424=(void*)_tmp41E->r;struct Cyc_Absyn_Vardecl*
_tmp425;_LL2F5: if(_tmp424 <= (void*)2?1:*((int*)_tmp424)!= 0)goto _LL2F7;_tmp425=((
struct Cyc_Absyn_Var_p_struct*)_tmp424)->f1;_LL2F6: {struct _tuple1*old_name=
...
_tmp428,nv,_tmp425,_tmp404);goto _LL2F4;}}_LL2F7:;_LL2F8:(void*)(s->r=(void*)((
void*)(Cyc_Toc_letdecl_to_c(nv,_tmp41E,(void*)((struct Cyc_Core_Opt*)_check_null(
_tmp41F->topt))->v,_tmp41F,_tmp404))->r));goto _LL2F4;_LL2F4:;}goto _LL2EB;_LL2F0:
if(*((int*)_tmp41C)!= 3)goto _LL2F2;_tmp420=((struct Cyc_Absyn_Letv_d_struct*)
_tmp41C)->f1;_LL2F1: {struct Cyc_List_List*_tmp42B=((struct Cyc_List_List*(*)(
...
_LL2EB;}_LL2F2:;_LL2F3:({void*_tmp432[0]={};((int(*)(struct _tagged_arr fmt,struct
_tagged_arr ap))Cyc_Tcutil_impos)(_tag_arr("bad nested declaration within function",
sizeof(char),39),_tag_arr(_tmp432,sizeof(void*),0));});_LL2EB:;}return;_LL2D9:
if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 15)goto _LL2DB;_tmp405=((struct Cyc_Absyn_Label_s_struct*)
_tmp3EB)->f1;_tmp406=((struct Cyc_Absyn_Label_s_struct*)_tmp3EB)->f2;_LL2DA: s=
_tmp406;continue;_LL2DB: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 16)goto _LL2DD;
_tmp407=((struct Cyc_Absyn_Do_s_struct*)_tmp3EB)->f1;_tmp408=((struct Cyc_Absyn_Do_s_struct*)
_tmp3EB)->f2;_tmp409=_tmp408.f1;_LL2DC: Cyc_Toc_stmt_to_c(Cyc_Toc_loop_env(nv),
_tmp407);Cyc_Toc_exp_to_c(nv,_tmp409);return;_LL2DD: if(_tmp3EB <= (void*)1?1:*((
int*)_tmp3EB)!= 17)goto _LL2DF;_tmp40A=((struct Cyc_Absyn_TryCatch_s_struct*)
_tmp3EB)->f1;_tmp40B=((struct Cyc_Absyn_TryCatch_s_struct*)_tmp3EB)->f2;_LL2DE: {
...
_LL2DF: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 18)goto _LL2E1;_tmp40C=((struct
...
struct Cyc_Absyn_Region_s_struct*)_tmp3EB)->f4;_LL2E0: {void*rh_struct_typ=Cyc_Absyn_strct(
...
0),0),0),0),0),0))->r));return;}_LL2E1: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)
!= 20)goto _LL2E3;_tmp410=((struct Cyc_Absyn_ResetRegion_s_struct*)_tmp3EB)->f1;
_LL2E2: Cyc_Toc_exp_to_c(nv,_tmp410);(void*)(s->r=(void*)((void*)(Cyc_Absyn_exp_stmt(
...
return;_LL2E3: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 10)goto _LL2E5;_LL2E4:({
...
_LL2E5: if(_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 13)goto _LL2E7;_LL2E6:({void*
_tmp452[0]={};((int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_unimp)(
_tag_arr("cut",sizeof(char),4),_tag_arr(_tmp452,sizeof(void*),0));});_LL2E7: if(
_tmp3EB <= (void*)1?1:*((int*)_tmp3EB)!= 14)goto _LL2E9;_LL2E8:({void*_tmp453[0]={};((
int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_unimp)(_tag_arr("splice",
sizeof(char),7),_tag_arr(_tmp453,sizeof(void*),0));});_LL2E9: if(_tmp3EB <= (void*)
1?1:*((int*)_tmp3EB)!= 19)goto _LL2BE;_LL2EA:({void*_tmp454[0]={};((int(*)(struct
_tagged_arr fmt,struct _tagged_arr ap))Cyc_Toc_unimp)(_tag_arr("forarray",sizeof(
char),9),_tag_arr(_tmp454,sizeof(void*),0));});_LL2BE:;}}struct _tuple16{struct
...
static void*Cyc_Toc_scope_to_c(void*s){void*_tmp463=s;_LL2FA: if((int)_tmp463 != 1)
goto _LL2FC;_LL2FB: return(void*)2;_LL2FC: if((int)_tmp463 != 4)goto _LL2FE;_LL2FD:
return(void*)3;_LL2FE:;_LL2FF: return s;_LL2F9:;}struct Cyc_Core_Opt*Cyc_Toc_aggrs_so_far=
...
cmp)(struct _tuple1*,struct _tuple1*)))Cyc_Dict_empty)(Cyc_Absyn_qvar_cmp);_tmp465;});{
int seen_defn_before;struct Cyc_Core_Opt*_tmp466=((struct Cyc_Core_Opt*(*)(struct
Cyc_Dict_Dict*d,struct _tuple1*k))Cyc_Dict_lookup_opt)((struct Cyc_Dict_Dict*)((
struct Cyc_Core_Opt*)_check_null(Cyc_Toc_aggrs_so_far))->v,_tmp464);if(_tmp466 == 
...
struct Cyc_Core_Opt*)_check_null(Cyc_Toc_aggrs_so_far))->v,_tmp464,ad));}else{if(((
struct Cyc_Absyn_Aggrdecl*)_tmp466->v)->impl == 0){(struct Cyc_Dict_Dict*)(((struct
...
_tmp464,ad));seen_defn_before=0;}else{seen_defn_before=1;}}(void*)(ad->sc=(void*)((
...
0;if(seen_defn_before)ad->impl=0;else{struct Cyc_List_List*_tmp467=((struct Cyc_Absyn_AggrdeclImpl*)
_check_null(ad->impl))->fields;for(0;_tmp467 != 0;_tmp467=_tmp467->tl){(void*)(((
struct Cyc_Absyn_Aggrfield*)_tmp467->hd)->type=(void*)Cyc_Toc_typ_to_c_array((
void*)((struct Cyc_Absyn_Aggrfield*)_tmp467->hd)->type));}}}}}static struct Cyc_Core_Opt*
...
_tmp468=_cycalloc(sizeof(*_tmp468));_tmp468->v=((struct Cyc_Set_Set*(*)(int(*cmp)(
struct _tuple1*,struct _tuple1*)))Cyc_Set_empty)(Cyc_Absyn_qvar_cmp);_tmp468;});{
struct _tuple1*_tmp469=tud->name;if(tud->fields == 0?1:((int(*)(struct Cyc_Set_Set*
...
_tmp47F;int _tmp480;_LL301: if(_tmp47E != 0)goto _LL303;_LL302: {struct Cyc_Absyn_Exp*
...
goto _LL300;}}_LL303: if(_tmp47E == 0)goto _LL305;_tmp47F=*_tmp47E;_tmp480=(int)
_tmp47F.v;if(_tmp480 != 0)goto _LL305;_LL304: if((void*)f->sc != (void*)3){struct Cyc_Absyn_Exp*
...
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tuple1*k,int v))Cyc_Dict_insert)((
struct Cyc_Dict_Dict*)((struct Cyc_Core_Opt*)_check_null(Cyc_Toc_xtunion_fields_so_far))->v,
f->name,1));}goto _LL300;_LL305:;_LL306: goto _LL300;_LL300:;}}}static void Cyc_Toc_enumdecl_to_c(
...
_tmp4A9;struct Cyc_Absyn_Exp*_tmp4AA;struct Cyc_Absyn_Exp*_tmp4AB;_LL308: if(*((int*)
_tmp4A8)!= 27)goto _LL30A;_tmp4A9=((struct Cyc_Absyn_Comprehension_e_struct*)
_tmp4A8)->f1;_tmp4AA=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp4A8)->f2;
_tmp4AB=((struct Cyc_Absyn_Comprehension_e_struct*)_tmp4A8)->f3;_LL309: vd->initializer=
...
goto _LL307;_LL30A:;_LL30B: if((void*)vd->sc == (void*)0){struct Cyc_Toc_Env*_tmp4AC=({
...
init_nv,init);}goto _LL307;_LL307:;}}static struct Cyc_Absyn_Stmt**Cyc_Toc_throw_match_stmt_opt=
...
_tmp4C2;_LL30D: if(*((int*)_tmp4B9)!= 0)goto _LL30F;_tmp4BA=((struct Cyc_Absyn_Var_d_struct*)
_tmp4B9)->f1;_LL30E: {struct _tuple1*_tmp4C3=_tmp4BA->name;if((void*)_tmp4BA->sc
...
_LL30C;}_LL30F: if(*((int*)_tmp4B9)!= 1)goto _LL311;_tmp4BB=((struct Cyc_Absyn_Fn_d_struct*)
_tmp4B9)->f1;_LL310: {struct _tuple1*_tmp4C8=_tmp4BB->name;if((void*)_tmp4BB->sc
...
_tmp4CA));_tmp4CA->hd=d;_tmp4CA->tl=Cyc_Toc_result_decls;_tmp4CA;});goto _LL30C;}
_LL311: if(*((int*)_tmp4B9)!= 2)goto _LL313;_LL312: goto _LL314;_LL313: if(*((int*)
_tmp4B9)!= 3)goto _LL315;_LL314:({void*_tmp4CB[0]={};((int(*)(struct _tagged_arr
fmt,struct _tagged_arr ap))Cyc_Toc_toc_impos)(_tag_arr("letdecl at toplevel",
sizeof(char),20),_tag_arr(_tmp4CB,sizeof(void*),0));});_LL315: if(*((int*)_tmp4B9)
!= 4)goto _LL317;_tmp4BC=((struct Cyc_Absyn_Aggr_d_struct*)_tmp4B9)->f1;_LL316: Cyc_Toc_aggrdecl_to_c(
_tmp4BC);Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp4CC=_cycalloc(sizeof(*
_tmp4CC));_tmp4CC->hd=d;_tmp4CC->tl=Cyc_Toc_result_decls;_tmp4CC;});goto _LL30C;
_LL317: if(*((int*)_tmp4B9)!= 5)goto _LL319;_tmp4BD=((struct Cyc_Absyn_Tunion_d_struct*)
_tmp4B9)->f1;_LL318: if(_tmp4BD->is_xtunion)Cyc_Toc_xtuniondecl_to_c(_tmp4BD);
else{Cyc_Toc_tuniondecl_to_c(_tmp4BD);}goto _LL30C;_LL319: if(*((int*)_tmp4B9)!= 6)
goto _LL31B;_tmp4BE=((struct Cyc_Absyn_Enum_d_struct*)_tmp4B9)->f1;_LL31A: Cyc_Toc_enumdecl_to_c(
nv,_tmp4BE);Cyc_Toc_result_decls=({struct Cyc_List_List*_tmp4CD=_cycalloc(sizeof(*
_tmp4CD));_tmp4CD->hd=d;_tmp4CD->tl=Cyc_Toc_result_decls;_tmp4CD;});goto _LL30C;
_LL31B: if(*((int*)_tmp4B9)!= 7)goto _LL31D;_tmp4BF=((struct Cyc_Absyn_Typedef_d_struct*)
_tmp4B9)->f1;_LL31C: _tmp4BF->name=_tmp4BF->name;_tmp4BF->tvs=0;if(_tmp4BF->defn
...
_check_null(_tmp4BF->kind))->v;_LL324: if((int)_tmp4CF != 2)goto _LL326;_LL325:
_tmp4BF->defn=({struct Cyc_Core_Opt*_tmp4D0=_cycalloc(sizeof(*_tmp4D0));_tmp4D0->v=(
void*)Cyc_Absyn_void_star_typ();_tmp4D0;});goto _LL323;_LL326:;_LL327: _tmp4BF->defn=({
struct Cyc_Core_Opt*_tmp4D1=_cycalloc(sizeof(*_tmp4D1));_tmp4D1->v=(void*)((void*)
0);_tmp4D1;});goto _LL323;_LL323:;}Cyc_Toc_result_decls=({struct Cyc_List_List*
_tmp4D2=_cycalloc(sizeof(*_tmp4D2));_tmp4D2->hd=d;_tmp4D2->tl=Cyc_Toc_result_decls;
_tmp4D2;});goto _LL30C;_LL31D: if(*((int*)_tmp4B9)!= 8)goto _LL31F;_tmp4C0=((struct
Cyc_Absyn_Namespace_d_struct*)_tmp4B9)->f2;_LL31E: _tmp4C1=_tmp4C0;goto _LL320;
_LL31F: if(*((int*)_tmp4B9)!= 9)goto _LL321;_tmp4C1=((struct Cyc_Absyn_Using_d_struct*)
_tmp4B9)->f2;_LL320: _tmp4C2=_tmp4C1;goto _LL322;_LL321: if(*((int*)_tmp4B9)!= 10)
goto _LL30C;_tmp4C2=((struct Cyc_Absyn_ExternC_d_struct*)_tmp4B9)->f1;_LL322: nv=
Cyc_Toc_decls_to_c(nv,_tmp4C2,top);goto _LL30C;_LL30C:;}}return nv;}static void Cyc_Toc_init(){
