...
Cyc_List_filter(int(*f)(void*),struct Cyc_List_List*x);struct Cyc_Dict_Dict;extern
...
void Cyc_Dict_iter(void(*f)(void*,void*),struct Cyc_Dict_Dict*d);struct Cyc_Dict_Dict*
