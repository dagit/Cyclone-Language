...
struct Cyc_List_List*x);extern unsigned char Cyc_List_Nth[8];extern int isdigit(int);
extern unsigned int Cyc_Std_strlen(struct _tagged_arr s);extern struct _tagged_arr Cyc_Std_implode(
