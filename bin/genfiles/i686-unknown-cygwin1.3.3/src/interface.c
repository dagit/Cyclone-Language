...
Cyc_Dict_map(void*(*f)(void*),struct Cyc_Dict_Dict*d);struct Cyc_Tcenv_VarRes_struct{
...
_tuple3{struct _tagged_arr f1;struct _tagged_arr f2;};int Cyc_Interface_is_subinterface(
struct Cyc_Interface_I*i1,struct Cyc_Interface_I*i2,struct _tuple3*info);struct Cyc_Interface_I*
Cyc_Interface_merge(struct Cyc_Interface_I*i1,struct Cyc_Interface_I*i2,struct
_tuple3*info);struct Cyc_Interface_I*Cyc_Interface_merge_list(struct Cyc_List_List*
...
_tmp32;}}struct _tuple9{struct Cyc_Absyn_Tqual f1;void*f2;};static void*Cyc_Interface_get_type1(
struct _tuple9*x){return(*x).f2;}static void*Cyc_Interface_get_type2(struct _tuple1*
x){return(*x).f3;}static int Cyc_Interface_check_public_tuniondecl(struct Cyc_Dict_Dict*
...
struct _tuple0*name,void*(*f)(struct _tuple9*),struct Cyc_List_List*l))Cyc_Interface_check_public_type_list)(
...
_LL22:;_LL23: return 1;_LLF:;}struct _tuple10{struct Cyc_Interface_Ienv*f1;struct Cyc_Interface_Ienv*
...
_tagged_arr*x,struct Cyc_Absyn_Aggrdecl**dp){struct _tuple10 _tmp8A;struct Cyc_Interface_Ienv*
_tmp8B;struct Cyc_Interface_Ienv*_tmp8C;int _tmp8D;struct Cyc_Dict_Dict*_tmp8E;
struct Cyc_Interface_Seen*_tmp8F;struct _tuple10*_tmp89=env;_tmp8A=*_tmp89;_tmp8B=
...
struct Cyc_Dict_Dict*_tmp99;struct Cyc_Interface_Seen*_tmp9A;struct _tuple10*_tmp94=
...
struct _tuple10*env,struct _tagged_arr*x,struct Cyc_Absyn_Tuniondecl**dp){struct
_tuple10 _tmpAB;struct Cyc_Interface_Ienv*_tmpAC;struct Cyc_Interface_Ienv*_tmpAD;
int _tmpAE;struct Cyc_Dict_Dict*_tmpAF;struct Cyc_Interface_Seen*_tmpB0;struct Cyc_Interface_I*
_tmpB1;struct _tuple10*_tmpAA=env;_tmpAB=*_tmpAA;_tmpAC=_tmpAB.f1;_tmpAD=_tmpAB.f2;
...
d){struct _tuple10 _tmpBC;struct Cyc_Interface_Ienv*_tmpBD;struct Cyc_Dict_Dict*
_tmpBE;struct Cyc_Interface_Seen*_tmpBF;struct _tuple10*_tmpBB=env;_tmpBC=*_tmpBB;
...
_tagged_arr*x,struct _tuple6*v){struct _tuple10 _tmpC1;struct Cyc_Interface_Ienv*
_tmpC2;struct Cyc_Interface_Ienv*_tmpC3;int _tmpC4;struct Cyc_Dict_Dict*_tmpC5;
struct Cyc_Interface_Seen*_tmpC6;struct _tuple10*_tmpC0=env;_tmpC1=*_tmpC0;_tmpC2=
...
_LL6C:;_LL6D: goto _LL69;_LL69:;}}struct _tuple11{struct Cyc_Interface_I*f1;int f2;
struct Cyc_Dict_Dict*f3;struct Cyc_Interface_Seen*f4;};static void Cyc_Interface_extract_f(
struct _tuple11*env_f,struct Cyc_List_List*ns,struct Cyc_Tcenv_Genv*ge){struct
_tuple11 _tmpD3;struct Cyc_Interface_I*_tmpD4;int _tmpD5;struct Cyc_Dict_Dict*_tmpD6;
struct Cyc_Interface_Seen*_tmpD7;struct _tuple11*_tmpD2=env_f;_tmpD3=*_tmpD2;
_tmpD4=_tmpD3.f1;_tmpD5=_tmpD3.f2;_tmpD6=_tmpD3.f3;_tmpD7=_tmpD3.f4;{struct
_tuple10 _tmpD8=({struct _tuple10 _tmpD9;_tmpD9.f1=((struct Cyc_Interface_Ienv*(*)(
...
_tmpD7;_tmpD9.f6=_tmpD4;_tmpD9;});((void(*)(void(*f)(struct _tuple10*,struct
_tagged_arr*,struct Cyc_Absyn_Aggrdecl**),struct _tuple10*env,struct Cyc_Dict_Dict*
d))Cyc_Dict_iter_c)(Cyc_Interface_extract_aggrdecl,& _tmpD8,ge->aggrdecls);((void(*)(
void(*f)(struct _tuple10*,struct _tagged_arr*,struct Cyc_Absyn_Tuniondecl**),struct
_tuple10*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_extract_tuniondecl,&
_tmpD8,ge->tuniondecls);((void(*)(void(*f)(struct _tuple10*,struct _tagged_arr*,
...
struct Cyc_Dict_Dict*ae,int check_complete_defs){struct _tuple11 _tmpDA=({struct
_tuple11 _tmpDB;_tmpDB.f1=((struct Cyc_Interface_I*(*)(struct Cyc_Dict_Dict*skel))
Cyc_Interface_skel2i)(ae);_tmpDB.f2=check_complete_defs;_tmpDB.f3=ae;_tmpDB.f4=
Cyc_Interface_new_seen();_tmpDB;});((void(*)(void(*f)(struct _tuple11*,struct Cyc_List_List*,
...
unsigned char),3),_tag_arr(_tmpDC,sizeof(void*),1));}});}struct _tuple12{int f1;
...
_tuple12*env,struct _tagged_arr*x,void*y1){struct _tuple12 _tmpDF;int _tmpE0;int*
_tmpE1;struct Cyc_Dict_Dict*_tmpE2;int(*_tmpE3)(void*,void*,struct _tagged_arr*);
struct _tagged_arr _tmpE4;struct _tagged_arr*_tmpE5;struct _tuple12*_tmpDE=env;
...
struct _tagged_arr t,struct _tagged_arr*msg){struct _tuple12 _tmpEF=({struct _tuple12
_tmpF0;_tmpF0.f1=1;_tmpF0.f2=dic2;_tmpF0.f3=incl_f;_tmpF0.f4=t;_tmpF0.f5=msg;
_tmpF0;});((void(*)(void(*f)(struct _tuple12*,struct _tagged_arr*,void*),struct
_tuple12*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_incl_dict_f,&
...
_tuple13 _tmp10A;int _tmp10B;int*_tmp10C;struct Cyc_Dict_Dict*_tmp10D;struct
_tagged_arr*_tmp10E;struct _tuple13*_tmp109=env;_tmp10A=*_tmp109;_tmp10B=_tmp10A.f1;
...
_tuple14{int f1;struct Cyc_Dict_Dict*f2;struct Cyc_Dict_Dict*f3;struct Cyc_Dict_Dict*
...
struct _tuple14*env,struct _tagged_arr*x,void*y2){struct _tuple14 _tmp126;int _tmp127;
...
_tuple14*_tmp125=env;_tmp126=*_tmp125;_tmp127=_tmp126.f1;_tmp128=(int*)&(*
...
_tuple15 _tmp14C;int _tmp14D;int*_tmp14E;struct Cyc_Dict_Dict*_tmp14F;struct Cyc_Dict_Dict**
_tmp150;struct Cyc_Dict_Dict*_tmp151;struct Cyc_Dict_Dict*_tmp152;struct
_tagged_arr*_tmp153;struct _tuple15*_tmp14B=env;_tmp14C=*_tmp14B;_tmp14D=_tmp14C.f1;
...
struct Cyc_List_List*,struct Cyc_List_List*)))Cyc_Dict_empty)(Cyc_Absyn_varlist_cmp);
struct _tuple15 _tmp160=({struct _tuple15 _tmp162;_tmp162.f1=1;_tmp162.f2=d;_tmp162.f3=
dic1;_tmp162.f4=excl;_tmp162.f5=msg;_tmp162;});((void(*)(void(*f)(struct _tuple15*,
struct Cyc_List_List*,struct Cyc_Interface_Ienv*),struct _tuple15*env,struct Cyc_Dict_Dict*
...
_tmp160.f2;_tmp161;});return 0;}struct _tuple16{int f1;struct Cyc_Dict_Dict*f2;
struct Cyc_Dict_Dict*f3;struct _tagged_arr f4;struct _tagged_arr*f5;};void Cyc_Interface_disj_merge_dict_f(
struct _tuple16*env,struct _tagged_arr*x,void*y){struct _tuple16 _tmp164;int _tmp165;
int*_tmp166;struct Cyc_Dict_Dict*_tmp167;struct Cyc_Dict_Dict**_tmp168;struct Cyc_Dict_Dict*
_tmp169;struct _tagged_arr _tmp16A;struct _tagged_arr*_tmp16B;struct _tuple16*
...
_tuple17 _tmp17A;int _tmp17B;int*_tmp17C;struct Cyc_Dict_Dict*_tmp17D;struct Cyc_Dict_Dict**
_tmp17E;struct Cyc_Dict_Dict*_tmp17F;struct _tagged_arr*_tmp180;struct _tuple17*
...
struct _tagged_arr*msg){struct _tuple17 _tmp187=({struct _tuple17 _tmp189;_tmp189.f1=
...
struct Cyc_Interface_I*i1,struct Cyc_Interface_I*i2,struct _tuple3*info){struct
...
curr_info != 0?linfo != 0: 0)?({struct _tuple3*_tmp1A8=_cycalloc(sizeof(*_tmp1A8));
