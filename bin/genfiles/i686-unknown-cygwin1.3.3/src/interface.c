...
args,int c_varargs,struct Cyc_Absyn_VarargInfo*cyc_varargs,struct Cyc_List_List*
rgn_po,struct Cyc_List_List*);struct Cyc_Absyn_Aggrdecl*Cyc_Absyn_get_known_aggrdecl(
...
le;};struct Cyc_Tcenv_Tenv*Cyc_Tcenv_tc_init();struct Cyc_Interface_I;struct Cyc_Interface_I*
Cyc_Interface_empty();struct Cyc_Interface_I*Cyc_Interface_final();struct Cyc_Interface_I*
Cyc_Interface_extract(struct Cyc_Dict_Dict*ae);struct _tuple4{struct _tagged_arr f1;
struct _tagged_arr f2;};int Cyc_Interface_is_subinterface(struct Cyc_Interface_I*i1,
...
struct Cyc_Interface_I*,struct Cyc_Std___cycFILE*);struct Cyc_Interface_I*Cyc_Interface_parse(
struct Cyc_Std___cycFILE*);void Cyc_Interface_save(struct Cyc_Interface_I*,struct
Cyc_Std___cycFILE*);struct Cyc_Interface_I*Cyc_Interface_load(struct Cyc_Std___cycFILE*);
...
struct Cyc_List_List*tdl,struct Cyc_Std___cycFILE*f);struct _tagged_arr Cyc_Absynpp_qvar2string(
struct _tuple0*);void Cyc_Tc_tc(struct Cyc_Tcenv_Tenv*te,int var_default_init,struct
Cyc_List_List*ds);extern unsigned char Cyc_Lexing_Error[10];struct Cyc_Lexing_Error_struct{
...
d,struct _tuple0*k,int v))Cyc_Dict_insert)(seen->aggrs,d->name,_tmp32);if(d->fields
!= 0){struct Cyc_List_List*_tmp33=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)
_check_null(d->fields))->v;for(0;_tmp33 != 0;_tmp33=_tmp33->tl){if(!Cyc_Interface_check_public_type(
ae,seen,_tag_arr("type",sizeof(unsigned char),5),d->name,(void*)((struct Cyc_Absyn_Aggrfield*)
...
_tmp32;}}struct _tuple10{struct Cyc_Absyn_Tqual f1;void*f2;};static void*Cyc_Interface_get_type1(
struct _tuple10*x){return(*x).f2;}static void*Cyc_Interface_get_type2(struct
...
_tuple0*name,void*(*f)(struct _tuple10*),struct Cyc_List_List*l))Cyc_Interface_check_public_type_list)(
...
void*ns){void*_tmp3C=ns;struct Cyc_List_List*_tmp3D;_LLB: if(_tmp3C <= (void*)1?1:*((
int*)_tmp3C)!= 1)goto _LLD;_tmp3D=((struct Cyc_Absyn_Abs_n_struct*)_tmp3C)->f1;
_LLC: return _tmp3D;_LLD:;_LLE:((int(*)(struct _tagged_arr s))Cyc_Interface_invalid_arg)(
_tag_arr("get_abs_ns",sizeof(unsigned char),11));_LLA:;}static int Cyc_Interface_check_public_type(
struct Cyc_Dict_Dict*ae,struct Cyc_Interface_Seen*seen,struct _tagged_arr obj,struct
...
goto _LL16;_tmp42=((struct Cyc_Absyn_TypedefType_struct*)_tmp3E)->f3;if(_tmp42 == 0)
...
struct _tuple0*name,void*(*f)(struct _tuple10*),struct Cyc_List_List*l))Cyc_Interface_check_public_type_list)(
...
_LL22:;_LL23: return 1;_LLF:;}struct _tuple11{struct Cyc_Interface_Ienv*f1;struct Cyc_Interface_Ienv*
f2;int f3;struct Cyc_Dict_Dict*f4;struct Cyc_Interface_Seen*f5;struct Cyc_Interface_I*
f6;};static void Cyc_Interface_extract_aggrdecl(struct _tuple11*env,struct
_tagged_arr*x,struct Cyc_Absyn_Aggrdecl**dp){struct _tuple11 _tmp8A;struct Cyc_Interface_Ienv*
_tmp8B;struct Cyc_Interface_Ienv*_tmp8C;int _tmp8D;struct Cyc_Dict_Dict*_tmp8E;
struct Cyc_Interface_Seen*_tmp8F;struct _tuple11*_tmp89=env;_tmp8A=*_tmp89;_tmp8B=
...
_tmp91 != 0)goto _LL36;_LL35: if(_tmp8D?_tmp90->fields == 0: 0)Cyc_Interface_fields_err(
_tag_arr("static",sizeof(unsigned char),7),_tag_arr("aggr",sizeof(unsigned char),
5),_tmp90->name);goto _LL33;_LL36: if((int)_tmp91 != 1)goto _LL38;_LL37: if(_tmp90->fields
== 0){if(_tmp8D)Cyc_Interface_fields_err(_tag_arr("abstract",sizeof(
unsigned char),9),_tag_arr("aggr",sizeof(unsigned char),5),_tmp90->name);}else{
_tmp90=({struct Cyc_Absyn_Aggrdecl*_tmp92=_cycalloc(sizeof(*_tmp92));_tmp92[0]=*
_tmp90;_tmp92;});_tmp90->fields=0;}if(Cyc_Interface_check_public_aggrdecl(_tmp8E,
...
x,_tmp90);goto _LL33;_LL38: if((int)_tmp91 != 2)goto _LL3A;_LL39: if(_tmp90->fields == 
0){Cyc_Interface_fields_err(_tag_arr("public",sizeof(unsigned char),7),_tag_arr("aggr",
sizeof(unsigned char),5),_tmp90->name);_tmp90=({struct Cyc_Absyn_Aggrdecl*_tmp93=
...
_tuple11*env,struct _tagged_arr*x,struct Cyc_Absyn_Enumdecl**dp){struct _tuple11
_tmp95;struct Cyc_Interface_Ienv*_tmp96;struct Cyc_Interface_Ienv*_tmp97;int _tmp98;
struct Cyc_Dict_Dict*_tmp99;struct Cyc_Interface_Seen*_tmp9A;struct _tuple11*_tmp94=
...
== 0: 0)Cyc_Interface_fields_err(_tag_arr("static",sizeof(unsigned char),7),
_tag_arr("enum",sizeof(unsigned char),5),_tmp9B->name);goto _LL3E;_LL41: if((int)
_tmp9C != 1)goto _LL43;_LL42: if(_tmp9B->fields == 0){if(_tmp98)Cyc_Interface_fields_err(
_tag_arr("abstract",sizeof(unsigned char),9),_tag_arr("enum",sizeof(
unsigned char),5),_tmp9B->name);}else{_tmp9B=({struct Cyc_Absyn_Enumdecl*_tmp9D=
_cycalloc(sizeof(*_tmp9D));_tmp9D[0]=*_tmp9B;_tmp9D;});_tmp9B->fields=0;}if(Cyc_Interface_check_public_enumdecl(
...
x,_tmp9B);goto _LL3E;_LL43: if((int)_tmp9C != 2)goto _LL45;_LL44: if(_tmp9B->fields == 
0){Cyc_Interface_fields_err(_tag_arr("public",sizeof(unsigned char),7),_tag_arr("enum",
sizeof(unsigned char),5),_tmp9B->name);_tmp9B=({struct Cyc_Absyn_Enumdecl*_tmp9E=
_cycalloc(sizeof(*_tmp9E));_tmp9E[0]=*_tmp9B;_tmp9E;});(void*)(_tmp9B->sc=(void*)((
void*)1));}if(Cyc_Interface_check_public_enumdecl(_tmp99,_tmp9A,_tmp9B))_tmp97->enumdecls=((
...
_tag_arr("add_xtunionfielddecl",sizeof(unsigned char),21));_LL50:;}{struct Cyc_Interface_Ienv*
...
struct _tuple11*env,struct _tagged_arr*x,struct Cyc_Absyn_Tuniondecl**dp){struct
_tuple11 _tmpAB;struct Cyc_Interface_Ienv*_tmpAC;struct Cyc_Interface_Ienv*_tmpAD;
int _tmpAE;struct Cyc_Dict_Dict*_tmpAF;struct Cyc_Interface_Seen*_tmpB0;struct Cyc_Interface_I*
_tmpB1;struct _tuple11*_tmpAA=env;_tmpAB=*_tmpAA;_tmpAC=_tmpAB.f1;_tmpAD=_tmpAB.f2;
...
unsigned char),7),_tmpB2->name);goto _LL5E;_LL61: if((int)_tmpB3 != 1)goto _LL63;
_LL62: if(_tmpB2->fields == 0){if(!_tmpB2->is_xtunion?_tmpAE: 0)Cyc_Interface_fields_err(
...
d,struct _tagged_arr*k,struct Cyc_Absyn_Tuniondecl*v))Cyc_Dict_insert)(_tmpAD->tuniondecls,
x,_tmpB2);}goto _LL5E;_LL65: if((int)_tmpB3 != 4)goto _LL67;_LL66:((int(*)(struct
_tagged_arr s))Cyc_Interface_invalid_arg)(_tag_arr("extract_tuniondecl",sizeof(
unsigned char),19));_LL67: if((int)_tmpB3 != 3)goto _LL5E;_LL68: if(Cyc_Interface_check_public_tuniondecl(
...
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,struct Cyc_Absyn_Tuniondecl*
v))Cyc_Dict_insert)(_tmpAC->tuniondecls,x,_tmpB2);}goto _LL5E;_LL5E:;}}static void
Cyc_Interface_extract_typedef(struct _tuple11*env,struct _tagged_arr*x,struct Cyc_Absyn_Typedefdecl*
d){struct _tuple11 _tmpBC;struct Cyc_Interface_Ienv*_tmpBD;struct Cyc_Dict_Dict*
_tmpBE;struct Cyc_Interface_Seen*_tmpBF;struct _tuple11*_tmpBB=env;_tmpBC=*_tmpBB;
_tmpBD=_tmpBC.f2;_tmpBE=_tmpBC.f4;_tmpBF=_tmpBC.f5;if(Cyc_Interface_check_public_typedefdecl(
...
x,d);}static void Cyc_Interface_extract_ordinarie(struct _tuple11*env,struct
_tagged_arr*x,struct _tuple7*v){struct _tuple11 _tmpC1;struct Cyc_Interface_Ienv*
_tmpC2;struct Cyc_Interface_Ienv*_tmpC3;int _tmpC4;struct Cyc_Dict_Dict*_tmpC5;
struct Cyc_Interface_Seen*_tmpC6;struct _tuple11*_tmpC0=env;_tmpC1=*_tmpC0;_tmpC2=
...
_tag_arr("static",sizeof(unsigned char),7),_tmpCC->name);goto _LL75;_LL78: if((int)
_tmpD1 != 1)goto _LL7A;_LL79:((int(*)(struct _tagged_arr s))Cyc_Interface_invalid_arg)(
_tag_arr("extract_ordinarie",sizeof(unsigned char),18));_LL7A: if((int)_tmpD1 != 2)
goto _LL7C;_LL7B: if(_tmpC4?Cyc_Tcutil_is_function_type((void*)_tmpCC->type): 0)Cyc_Interface_body_err(
...
_LL6C:;_LL6D: goto _LL69;_LL69:;}}struct _tuple12{struct Cyc_Interface_I*f1;int f2;
struct Cyc_Dict_Dict*f3;struct Cyc_Interface_Seen*f4;};static void Cyc_Interface_extract_f(
struct _tuple12*env_f,struct Cyc_List_List*ns,struct Cyc_Tcenv_Genv*ge){struct
_tuple12 _tmpD3;struct Cyc_Interface_I*_tmpD4;int _tmpD5;struct Cyc_Dict_Dict*_tmpD6;
struct Cyc_Interface_Seen*_tmpD7;struct _tuple12*_tmpD2=env_f;_tmpD3=*_tmpD2;
_tmpD4=_tmpD3.f1;_tmpD5=_tmpD3.f2;_tmpD6=_tmpD3.f3;_tmpD7=_tmpD3.f4;{struct
_tuple11 _tmpD8=({struct _tuple11 _tmpD9;_tmpD9.f1=((struct Cyc_Interface_Ienv*(*)(
...
_tmpD7;_tmpD9.f6=_tmpD4;_tmpD9;});((void(*)(void(*f)(struct _tuple11*,struct
_tagged_arr*,struct Cyc_Absyn_Aggrdecl**),struct _tuple11*env,struct Cyc_Dict_Dict*
d))Cyc_Dict_iter_c)(Cyc_Interface_extract_aggrdecl,& _tmpD8,ge->aggrdecls);((void(*)(
void(*f)(struct _tuple11*,struct _tagged_arr*,struct Cyc_Absyn_Tuniondecl**),struct
_tuple11*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_extract_tuniondecl,&
_tmpD8,ge->tuniondecls);((void(*)(void(*f)(struct _tuple11*,struct _tagged_arr*,
struct Cyc_Absyn_Enumdecl**),struct _tuple11*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(
Cyc_Interface_extract_enumdecl,& _tmpD8,ge->enumdecls);((void(*)(void(*f)(struct
_tuple11*,struct _tagged_arr*,struct Cyc_Absyn_Typedefdecl*),struct _tuple11*env,
struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_extract_typedef,& _tmpD8,ge->typedefs);((
void(*)(void(*f)(struct _tuple11*,struct _tagged_arr*,struct _tuple7*),struct
_tuple11*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_extract_ordinarie,&
_tmpD8,ge->ordinaries);}}static struct Cyc_Interface_I*Cyc_Interface_gen_extract(
struct Cyc_Dict_Dict*ae,int check_complete_defs){struct _tuple12 _tmpDA=({struct
_tuple12 _tmpDB;_tmpDB.f1=((struct Cyc_Interface_I*(*)(struct Cyc_Dict_Dict*skel))
Cyc_Interface_skel2i)(ae);_tmpDB.f2=check_complete_defs;_tmpDB.f3=ae;_tmpDB.f4=
Cyc_Interface_new_seen();_tmpDB;});((void(*)(void(*f)(struct _tuple12*,struct Cyc_List_List*,
...
unsigned char),3),_tag_arr(_tmpDC,sizeof(void*),1));}});}struct _tuple13{int f1;
...
_tuple13*env,struct _tagged_arr*x,void*y1){struct _tuple13 _tmpDF;int _tmpE0;int*
_tmpE1;struct Cyc_Dict_Dict*_tmpE2;int(*_tmpE3)(void*,void*,struct _tagged_arr*);
struct _tagged_arr _tmpE4;struct _tagged_arr*_tmpE5;struct _tuple13*_tmpDE=env;
...
_tmpE7=(void*)_exn_thrown;void*_tmpEB=_tmpE7;_LL81: if(_tmpEB != Cyc_Dict_Absent)
goto _LL83;_LL82: Cyc_Interface_check_err(_tmpE5,(struct _tagged_arr)({struct Cyc_Std_String_pa_struct
...
_tag_arr(_tmpEC,sizeof(void*),2));}}}));*_tmpE1=0;goto _LL80;_LL83:;_LL84:(void)
_throw(_tmpEB);_LL80:;}}}}static int Cyc_Interface_incl_dict(struct Cyc_Dict_Dict*
dic1,struct Cyc_Dict_Dict*dic2,int(*incl_f)(void*,void*,struct _tagged_arr*),
struct _tagged_arr t,struct _tagged_arr*msg){struct _tuple13 _tmpEF=({struct _tuple13
_tmpF0;_tmpF0.f1=1;_tmpF0.f2=dic2;_tmpF0.f3=incl_f;_tmpF0.f4=t;_tmpF0.f5=msg;
_tmpF0;});((void(*)(void(*f)(struct _tuple13*,struct _tagged_arr*,void*),struct
_tuple13*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_incl_dict_f,&
...
struct _tuple14{int f1;struct Cyc_Dict_Dict*f2;struct _tagged_arr*f3;};static void Cyc_Interface_incl_ns_f(
struct _tuple14*env,struct Cyc_List_List*ns,struct Cyc_Interface_Ienv*ie1){struct
_tuple14 _tmp10A;int _tmp10B;int*_tmp10C;struct Cyc_Dict_Dict*_tmp10D;struct
_tagged_arr*_tmp10E;struct _tuple14*_tmp109=env;_tmp10A=*_tmp109;_tmp10B=_tmp10A.f1;
...
dic1,struct Cyc_Dict_Dict*dic2,struct _tagged_arr*msg){struct _tuple14 _tmp114=({
struct _tuple14 _tmp115;_tmp115.f1=1;_tmp115.f2=dic2;_tmp115.f3=msg;_tmp115;});((
void(*)(void(*f)(struct _tuple14*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),
struct _tuple14*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_incl_ns_f,&
...
void*)_exn_thrown;void*_tmp124=_tmp117;_LL8B: if(_tmp124 != Cyc_Tcdecl_Incompatible)
goto _LL8D;_LL8C: return 0;_LL8D:;_LL8E:(void)_throw(_tmp124);_LL8A:;}}}struct
_tuple15{int f1;struct Cyc_Dict_Dict*f2;struct Cyc_Dict_Dict*f3;struct Cyc_Dict_Dict*
...
struct _tuple15*env,struct _tagged_arr*x,void*y2){struct _tuple15 _tmp126;int _tmp127;
...
_tuple15*_tmp125=env;_tmp126=*_tmp125;_tmp127=_tmp126.f1;_tmp128=(int*)&(*
...
void*_tmp138=(void*)_exn_thrown;void*_tmp140=_tmp138;_LL95: if(_tmp140 != Cyc_Dict_Absent)
...
_tagged_arr t,struct _tagged_arr*msg){struct _tuple15 _tmp141=({struct _tuple15
_tmp143;_tmp143.f1=1;_tmp143.f2=dic1;_tmp143.f3=dic1;_tmp143.f4=excl;_tmp143.f5=
merge_f;_tmp143.f6=t;_tmp143.f7=msg;_tmp143;});((void(*)(void(*f)(struct _tuple15*,
struct _tagged_arr*,void*),struct _tuple15*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(
...
_tmp149->v;_tmp14A;});}struct _tuple16{int f1;struct Cyc_Dict_Dict*f2;struct Cyc_Dict_Dict*
f3;struct Cyc_Dict_Dict*f4;struct _tagged_arr*f5;};void Cyc_Interface_compat_merge_ns_f(
struct _tuple16*env,struct Cyc_List_List*ns,struct Cyc_Interface_Ienv*ie2){struct
_tuple16 _tmp14C;int _tmp14D;int*_tmp14E;struct Cyc_Dict_Dict*_tmp14F;struct Cyc_Dict_Dict**
_tmp150;struct Cyc_Dict_Dict*_tmp151;struct Cyc_Dict_Dict*_tmp152;struct
_tagged_arr*_tmp153;struct _tuple16*_tmp14B=env;_tmp14C=*_tmp14B;_tmp14D=_tmp14C.f1;
...
struct Cyc_List_List*,struct Cyc_List_List*)))Cyc_Dict_empty)(Cyc_Absyn_varlist_cmp);
struct _tuple16 _tmp160=({struct _tuple16 _tmp162;_tmp162.f1=1;_tmp162.f2=d;_tmp162.f3=
dic1;_tmp162.f4=excl;_tmp162.f5=msg;_tmp162;});((void(*)(void(*f)(struct _tuple16*,
struct Cyc_List_List*,struct Cyc_Interface_Ienv*),struct _tuple16*env,struct Cyc_Dict_Dict*
...
_tmp160.f2;_tmp161;});return 0;}struct _tuple17{int f1;struct Cyc_Dict_Dict*f2;
struct Cyc_Dict_Dict*f3;struct _tagged_arr f4;struct _tagged_arr*f5;};void Cyc_Interface_disj_merge_dict_f(
struct _tuple17*env,struct _tagged_arr*x,void*y){struct _tuple17 _tmp164;int _tmp165;
int*_tmp166;struct Cyc_Dict_Dict*_tmp167;struct Cyc_Dict_Dict**_tmp168;struct Cyc_Dict_Dict*
_tmp169;struct _tagged_arr _tmp16A;struct _tagged_arr*_tmp16B;struct _tuple17*
...
_tuple17 _tmp16F=({struct _tuple17 _tmp171;_tmp171.f1=1;_tmp171.f2=dic1;_tmp171.f3=
dic1;_tmp171.f4=t;_tmp171.f5=msg;_tmp171;});((void(*)(void(*f)(struct _tuple17*,
struct _tagged_arr*,void*),struct _tuple17*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(
...
struct Cyc_Dict_Dict*)_tmp177->v;_tmp178;});}struct _tuple18{int f1;struct Cyc_Dict_Dict*
f2;struct Cyc_Dict_Dict*f3;struct _tagged_arr*f4;};void Cyc_Interface_disj_merge_ns_f(
struct _tuple18*env,struct Cyc_List_List*ns,struct Cyc_Interface_Ienv*ie2){struct
_tuple18 _tmp17A;int _tmp17B;int*_tmp17C;struct Cyc_Dict_Dict*_tmp17D;struct Cyc_Dict_Dict**
_tmp17E;struct Cyc_Dict_Dict*_tmp17F;struct _tagged_arr*_tmp180;struct _tuple18*
...
struct _tagged_arr*msg){struct _tuple18 _tmp187=({struct _tuple18 _tmp189;_tmp189.f1=
1;_tmp189.f2=dic1;_tmp189.f3=dic1;_tmp189.f4=msg;_tmp189;});((void(*)(void(*f)(
struct _tuple18*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),struct _tuple18*
...
_tmp1AF=_cycalloc(sizeof(*_tmp1AF));_tmp1AF[0]=*d;_tmp1AF;});d->fields=0;if((
...
_tuple10*Cyc_Interface_rewrite_tunionfield_type(struct _tuple10*x){return({struct
_tuple10*_tmp1B7=_cycalloc(sizeof(*_tmp1B7));_tmp1B7->f1=Cyc_Absyn_empty_tqual();
...
struct _tuple10*(*f)(struct _tuple10*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Interface_rewrite_tunionfield_type,
