...
struct Cyc_List_List*);extern struct Cyc_Absyn_Aggrdecl*Cyc_Absyn_get_known_aggrdecl(
void*info);struct Cyc_Set_Set;extern unsigned char Cyc_Set_Absent[11];struct Cyc_Dict_Dict;
extern unsigned char Cyc_Dict_Present[12];extern unsigned char Cyc_Dict_Absent[11];
extern struct Cyc_Dict_Dict*Cyc_Dict_empty(int(*cmp)(void*,void*));extern int Cyc_Dict_member(
struct Cyc_Dict_Dict*d,void*k);extern struct Cyc_Dict_Dict*Cyc_Dict_insert(struct
Cyc_Dict_Dict*d,void*k,void*v);extern void*Cyc_Dict_lookup(struct Cyc_Dict_Dict*d,
void*k);extern void*Cyc_Dict_fold(void*(*f)(void*,void*,void*),struct Cyc_Dict_Dict*
d,void*accum);extern void Cyc_Dict_iter_c(void(*f)(void*,void*,void*),void*env,
struct Cyc_Dict_Dict*d);extern struct Cyc_Dict_Dict*Cyc_Dict_map(void*(*f)(void*),
struct Cyc_Dict_Dict*d);struct Cyc_Tcenv_VarRes_struct{int tag;void*f1;};struct Cyc_Tcenv_AggrRes_struct{
...
struct Cyc_Std___cycFILE*);extern struct Cyc_Interface_I*Cyc_Interface_parse(struct
Cyc_Std___cycFILE*);extern void Cyc_Interface_save(struct Cyc_Interface_I*,struct
Cyc_Std___cycFILE*);extern struct Cyc_Interface_I*Cyc_Interface_load(struct Cyc_Std___cycFILE*);
...
struct Cyc_List_List*tdl,struct Cyc_Std___cycFILE*f);extern struct _tagged_arr Cyc_Absynpp_qvar2string(
...
Cyc_List_List*Cyc_Parse_parse_file(struct Cyc_Std___cycFILE*f);struct Cyc_Declaration_spec;
...
_tagged_arr*msg1,struct _tagged_arr fmt,struct _tagged_arr ap);extern struct Cyc_Absyn_Aggrdecl*
...
sizeof(unsigned char),43),_tag_arr(_tmp19,sizeof(void*),3));}}}}));}static void
Cyc_Interface_body_err(struct _tagged_arr sc,struct _tuple0*n){Cyc_Interface_err((
struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmp1F;_tmp1F.tag=0;_tmp1F.f1=(
struct _tagged_arr)Cyc_Absynpp_qvar2string(n);{struct Cyc_Std_String_pa_struct
_tmp1E;_tmp1E.tag=0;_tmp1E.f1=(struct _tagged_arr)sc;{void*_tmp1D[2]={& _tmp1E,&
_tmp1F};Cyc_Std_aprintf(_tag_arr("the body of %s function %s has never been defined",
sizeof(unsigned char),50),_tag_arr(_tmp1D,sizeof(void*),2));}}}));}static void Cyc_Interface_static_err(
...
sizeof(unsigned char),44),_tag_arr(_tmp20,sizeof(void*),4));}}}}}));}}static void
...
_tmp29;_tmp29.tag=0;_tmp29.f1=(struct _tagged_arr)Cyc_Absynpp_qvar2string(name2);{
struct Cyc_Std_String_pa_struct _tmp28;_tmp28.tag=0;_tmp28.f1=(struct _tagged_arr)
obj2;{struct Cyc_Std_String_pa_struct _tmp27;_tmp27.tag=0;_tmp27.f1=(struct
_tagged_arr)Cyc_Absynpp_qvar2string(name1);{struct Cyc_Std_String_pa_struct _tmp26;
_tmp26.tag=0;_tmp26.f1=(struct _tagged_arr)obj1;{void*_tmp25[4]={& _tmp26,& _tmp27,&
_tmp28,& _tmp29};Cyc_Std_aprintf(_tag_arr("declaration of %s %s relies on fields of abstract %s %s",
sizeof(unsigned char),56),_tag_arr(_tmp25,sizeof(void*),4));}}}}}));}}struct Cyc_Interface_Seen{
...
_tmp31 == Cyc_Dict_Absent){goto _LL2;}else{goto _LL3;}_LL3: goto _LL4;_LL2: goto _LL0;
_LL4:(void)_throw(_tmp31);_LL0:;}}}{int _tmp32=1;seen->aggrs=((struct Cyc_Dict_Dict*(*)(
struct Cyc_Dict_Dict*d,struct _tuple0*k,int v))Cyc_Dict_insert)(seen->aggrs,d->name,
_tmp32);if(d->fields != 0){struct Cyc_List_List*_tmp33=(struct Cyc_List_List*)((
struct Cyc_Core_Opt*)_check_null(d->fields))->v;for(0;_tmp33 != 0;_tmp33=_tmp33->tl){
if(! Cyc_Interface_check_public_type(ae,seen,_tag_arr("type",sizeof(unsigned char),
5),d->name,(void*)((struct Cyc_Absyn_Aggrfield*)_tmp33->hd)->type)){_tmp32=0;}}}
seen->aggrs=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tuple0*k,int v))
Cyc_Dict_insert)(seen->aggrs,d->name,_tmp32);return _tmp32;}}struct _tuple9{struct
Cyc_Absyn_Tqual f1;void*f2;};static void*Cyc_Interface_get_type1(struct _tuple9*x){
return(*x).f2;}static void*Cyc_Interface_get_type2(struct _tuple1*x){return(*x).f3;}
static int Cyc_Interface_check_public_tuniondecl(struct Cyc_Dict_Dict*ae,struct Cyc_Interface_Seen*
seen,struct Cyc_Absyn_Tuniondecl*d){{struct _handler_cons _tmp34;_push_handler(&
_tmp34);{int _tmp36=0;if(setjmp(_tmp34.handler)){_tmp36=1;}if(! _tmp36){{int _tmp37=((
int(*)(struct Cyc_Dict_Dict*d,struct _tuple0*k))Cyc_Dict_lookup)(seen->tunions,d->name);
_npop_handler(0);return _tmp37;};_pop_handler();}else{void*_tmp35=(void*)
_exn_thrown;void*_tmp39=_tmp35;_LL6: if(_tmp39 == Cyc_Dict_Absent){goto _LL7;}else{
goto _LL8;}_LL8: goto _LL9;_LL7: goto _LL5;_LL9:(void)_throw(_tmp39);_LL5:;}}}{int
_tmp3A=1;seen->tunions=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct
_tuple0*k,int v))Cyc_Dict_insert)(seen->tunions,d->name,_tmp3A);if(d->fields != 0){
struct Cyc_List_List*_tmp3B=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)
...
ae,seen,(struct _tagged_arr)_tag_arr(0,0,0),d->name,(void*)d->defn);}static int Cyc_Interface_check_public_vardecl(
struct Cyc_Dict_Dict*ae,struct Cyc_Interface_Seen*seen,struct Cyc_Absyn_Vardecl*d){
return Cyc_Interface_check_public_type(ae,seen,_tag_arr("variable",sizeof(
unsigned char),9),d->name,(void*)d->type);}static struct Cyc_List_List*Cyc_Interface_get_abs_ns(
void*ns){void*_tmp3C=ns;struct Cyc_List_List*_tmp3D;_LLB: if((unsigned int)_tmp3C > 
1?*((int*)_tmp3C)== 1: 0){_LLF: _tmp3D=((struct Cyc_Absyn_Abs_n_struct*)_tmp3C)->f1;
goto _LLC;}else{goto _LLD;}_LLD: goto _LLE;_LLC: return _tmp3D;_LLE:((int(*)(struct
_tagged_arr s))Cyc_Interface_invalid_arg)(_tag_arr("get_abs_ns",sizeof(
unsigned char),11));_LLA:;}static int Cyc_Interface_check_public_type(struct Cyc_Dict_Dict*
ae,struct Cyc_Interface_Seen*seen,struct _tagged_arr obj,struct _tuple0*name,void*t){
void*_tmp3E=Cyc_Tcutil_compress(t);struct Cyc_Absyn_PtrInfo _tmp3F;void*_tmp40;
void*_tmp41;struct Cyc_Core_Opt*_tmp42;struct Cyc_Core_Opt _tmp43;void*_tmp44;
struct Cyc_Absyn_FnInfo _tmp45;struct Cyc_Absyn_VarargInfo*_tmp46;struct Cyc_List_List*
_tmp47;void*_tmp48;struct Cyc_List_List*_tmp49;struct Cyc_Absyn_AggrInfo _tmp4A;
struct Cyc_List_List*_tmp4B;void*_tmp4C;struct _tuple0*_tmp4D;struct Cyc_Absyn_TunionInfo
_tmp4E;struct Cyc_List_List*_tmp4F;void*_tmp50;struct Cyc_Absyn_Tuniondecl**_tmp51;
struct Cyc_Absyn_Tuniondecl*_tmp52;struct Cyc_Absyn_TunionFieldInfo _tmp53;struct
Cyc_List_List*_tmp54;void*_tmp55;struct Cyc_Absyn_Tunionfield*_tmp56;struct Cyc_Absyn_Tuniondecl*
_tmp57;_LL11: if((unsigned int)_tmp3E > 3?*((int*)_tmp3E)== 4: 0){_LL25: _tmp3F=((
struct Cyc_Absyn_PointerType_struct*)_tmp3E)->f1;_LL26: _tmp40=(void*)_tmp3F.elt_typ;
goto _LL12;}else{goto _LL13;}_LL13: if((unsigned int)_tmp3E > 3?*((int*)_tmp3E)== 7:
0){_LL27: _tmp41=(void*)((struct Cyc_Absyn_ArrayType_struct*)_tmp3E)->f1;goto _LL14;}
else{goto _LL15;}_LL15: if((unsigned int)_tmp3E > 3?*((int*)_tmp3E)== 16: 0){_LL28:
_tmp42=((struct Cyc_Absyn_TypedefType_struct*)_tmp3E)->f3;if(_tmp42 == 0){goto
_LL17;}else{_tmp43=*_tmp42;_LL29: _tmp44=(void*)_tmp43.v;goto _LL16;}}else{goto
_LL17;}_LL17: if((unsigned int)_tmp3E > 3?*((int*)_tmp3E)== 8: 0){_LL2A: _tmp45=((
struct Cyc_Absyn_FnType_struct*)_tmp3E)->f1;_LL2D: _tmp48=(void*)_tmp45.ret_typ;
goto _LL2C;_LL2C: _tmp47=_tmp45.args;goto _LL2B;_LL2B: _tmp46=_tmp45.cyc_varargs;
goto _LL18;}else{goto _LL19;}_LL19: if((unsigned int)_tmp3E > 3?*((int*)_tmp3E)== 9:
0){_LL2E: _tmp49=((struct Cyc_Absyn_TupleType_struct*)_tmp3E)->f1;goto _LL1A;}else{
goto _LL1B;}_LL1B: if((unsigned int)_tmp3E > 3?*((int*)_tmp3E)== 10: 0){_LL2F: _tmp4A=((
struct Cyc_Absyn_AggrType_struct*)_tmp3E)->f1;_LL31: _tmp4C=(void*)_tmp4A.aggr_info;
goto _LL30;_LL30: _tmp4B=_tmp4A.targs;goto _LL1C;}else{goto _LL1D;}_LL1D: if((
unsigned int)_tmp3E > 3?*((int*)_tmp3E)== 12: 0){_LL32: _tmp4D=((struct Cyc_Absyn_EnumType_struct*)
_tmp3E)->f1;goto _LL1E;}else{goto _LL1F;}_LL1F: if((unsigned int)_tmp3E > 3?*((int*)
_tmp3E)== 2: 0){_LL33: _tmp4E=((struct Cyc_Absyn_TunionType_struct*)_tmp3E)->f1;
_LL35: _tmp50=(void*)_tmp4E.tunion_info;if(*((int*)_tmp50)== 1){_LL36: _tmp51=((
struct Cyc_Absyn_KnownTunion_struct*)_tmp50)->f1;_tmp52=*_tmp51;goto _LL34;}else{
goto _LL21;}_LL34: _tmp4F=_tmp4E.targs;goto _LL20;}else{goto _LL21;}_LL21: if((
unsigned int)_tmp3E > 3?*((int*)_tmp3E)== 3: 0){_LL37: _tmp53=((struct Cyc_Absyn_TunionFieldType_struct*)
_tmp3E)->f1;_LL39: _tmp55=(void*)_tmp53.field_info;if(*((int*)_tmp55)== 1){_LL3B:
_tmp57=((struct Cyc_Absyn_KnownTunionfield_struct*)_tmp55)->f1;goto _LL3A;_LL3A:
_tmp56=((struct Cyc_Absyn_KnownTunionfield_struct*)_tmp55)->f2;goto _LL38;}else{
goto _LL23;}_LL38: _tmp54=_tmp53.targs;goto _LL22;}else{goto _LL23;}_LL23: goto _LL24;
_LL12: _tmp41=_tmp40;goto _LL14;_LL14: _tmp44=_tmp41;goto _LL16;_LL16: return Cyc_Interface_check_public_type(
ae,seen,obj,name,_tmp44);_LL18: {int b=((int(*)(struct Cyc_Dict_Dict*ae,struct Cyc_Interface_Seen*
...
_tmp47)? Cyc_Interface_check_public_type(ae,seen,obj,name,_tmp48): 0;if(_tmp46 != 0){
void*_tmp59;struct Cyc_Absyn_VarargInfo _tmp58=*_tmp46;_LL3D: _tmp59=(void*)_tmp58.type;
goto _LL3C;_LL3C: b=Cyc_Interface_check_public_type(ae,seen,obj,name,_tmp59);}
return b;}_LL1A: return((int(*)(struct Cyc_Dict_Dict*ae,struct Cyc_Interface_Seen*
...
_tmp49);_LL1C: {struct Cyc_Absyn_Aggrdecl*_tmp5A=Cyc_Absyn_get_known_aggrdecl(
_tmp4C);if((void*)_tmp5A->sc == (void*)0){Cyc_Interface_static_err(obj,name,
_tag_arr("type",sizeof(unsigned char),5),_tmp5A->name);return 0;}return Cyc_Interface_check_public_type_list(
ae,seen,obj,name,Cyc_Core_identity,_tmp4B)? Cyc_Interface_check_public_aggrdecl(
ae,seen,_tmp5A): 0;}_LL1E: {struct _tuple0 _tmp5C;struct _tagged_arr*_tmp5D;void*
_tmp5E;struct _tuple0*_tmp5B=_tmp4D;_tmp5C=*_tmp5B;_LL40: _tmp5E=_tmp5C.f1;goto
_LL3F;_LL3F: _tmp5D=_tmp5C.f2;goto _LL3E;_LL3E: {struct Cyc_List_List*_tmp5F=Cyc_Interface_get_abs_ns(
_tmp5E);struct Cyc_Absyn_Enumdecl*ed;{struct _handler_cons _tmp60;_push_handler(&
...
d,struct _tagged_arr*k))Cyc_Dict_lookup)(_tmp63->enumdecls,_tmp5D);};_pop_handler();}
else{void*_tmp61=(void*)_exn_thrown;void*_tmp65=_tmp61;_LL42: if(_tmp65 == Cyc_Dict_Absent){
goto _LL43;}else{goto _LL44;}_LL44: goto _LL45;_LL43:((int(*)(struct _tagged_arr s))
Cyc_Interface_invalid_arg)((struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmp67;_tmp67.tag=0;_tmp67.f1=(struct _tagged_arr)Cyc_Absynpp_qvar2string(_tmp4D);{
void*_tmp66[1]={& _tmp67};Cyc_Std_aprintf(_tag_arr("check_public_type (can't find enum %s)",
sizeof(unsigned char),39),_tag_arr(_tmp66,sizeof(void*),1));}}));_LL45:(void)
_throw(_tmp65);_LL41:;}}}if((void*)ed->sc == (void*)0){Cyc_Interface_static_err(
obj,_tmp4D,_tag_arr("enum",sizeof(unsigned char),5),ed->name);return 0;}return 1;}}
_LL20: {struct _tuple0 _tmp69;struct _tagged_arr*_tmp6A;void*_tmp6B;struct _tuple0*
_tmp68=_tmp52->name;_tmp69=*_tmp68;_LL48: _tmp6B=_tmp69.f1;goto _LL47;_LL47: _tmp6A=
_tmp69.f2;goto _LL46;_LL46: {struct Cyc_List_List*_tmp6C=Cyc_Interface_get_abs_ns(
_tmp6B);struct Cyc_Absyn_Tuniondecl*tud;{struct _handler_cons _tmp6D;_push_handler(&
_tmp6D);{int _tmp6F=0;if(setjmp(_tmp6D.handler)){_tmp6F=1;}if(! _tmp6F){{struct Cyc_Tcenv_Genv*
_tmp70=((struct Cyc_Tcenv_Genv*(*)(struct Cyc_Dict_Dict*d,struct Cyc_List_List*k))
Cyc_Dict_lookup)(ae,_tmp6C);tud=*((struct Cyc_Absyn_Tuniondecl**(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k))Cyc_Dict_lookup)(_tmp70->tuniondecls,_tmp6A);};
_pop_handler();}else{void*_tmp6E=(void*)_exn_thrown;void*_tmp72=_tmp6E;_LL4A: if(
_tmp72 == Cyc_Dict_Absent){goto _LL4B;}else{goto _LL4C;}_LL4C: goto _LL4D;_LL4B:((int(*)(
struct _tagged_arr s))Cyc_Interface_invalid_arg)((struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmp74;_tmp74.tag=0;_tmp74.f1=(struct _tagged_arr)Cyc_Absynpp_qvar2string(_tmp52->name);{
void*_tmp73[1]={& _tmp74};Cyc_Std_aprintf(_tag_arr("check_public_type (can't find [x]tunion %s)",
sizeof(unsigned char),44),_tag_arr(_tmp73,sizeof(void*),1));}}));_LL4D:(void)
_throw(_tmp72);_LL49:;}}}if((void*)tud->sc == (void*)0){Cyc_Interface_static_err(
...
_tmp4F)? Cyc_Interface_check_public_tuniondecl(ae,seen,tud): 0;}}_LL22: {struct
_tuple0 _tmp76;struct _tagged_arr*_tmp77;void*_tmp78;struct _tuple0*_tmp75=_tmp57->name;
_tmp76=*_tmp75;_LL50: _tmp78=_tmp76.f1;goto _LL4F;_LL4F: _tmp77=_tmp76.f2;goto _LL4E;
_LL4E: {struct Cyc_List_List*_tmp79=Cyc_Interface_get_abs_ns(_tmp78);struct Cyc_Absyn_Tuniondecl*
...
_tmp7D->tuniondecls,_tmp77);};_pop_handler();}else{void*_tmp7B=(void*)
_exn_thrown;void*_tmp7F=_tmp7B;_LL52: if(_tmp7F == Cyc_Dict_Absent){goto _LL53;}
else{goto _LL54;}_LL54: goto _LL55;_LL53:((int(*)(struct _tagged_arr s))Cyc_Interface_invalid_arg)((
struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmp81;_tmp81.tag=0;_tmp81.f1=(
struct _tagged_arr)Cyc_Absynpp_qvar2string(_tmp57->name);{void*_tmp80[1]={& _tmp81};
Cyc_Std_aprintf(_tag_arr("check_public_type (can't find [x]tunion %s and search its fields)",
sizeof(unsigned char),66),_tag_arr(_tmp80,sizeof(void*),1));}}));_LL55:(void)
_throw(_tmp7F);_LL51:;}}}if(tud->fields == 0){((int(*)(struct _tagged_arr s))Cyc_Interface_invalid_arg)((
...
sizeof(unsigned char),47),_tag_arr(_tmp82,sizeof(void*),1));}}));}{struct Cyc_Absyn_Tunionfield*
...
sizeof(unsigned char),49),_tag_arr(_tmp85,sizeof(void*),1));}}));}{struct Cyc_Absyn_Tunionfield*
...
struct Cyc_Std_String_pa_struct _tmp88;_tmp88.tag=0;_tmp88.f1=(struct _tagged_arr)
Cyc_Absynpp_qvar2string(tuf->name);{void*_tmp87[1]={& _tmp88};Cyc_Std_aprintf(
_tag_arr("field %s of",sizeof(unsigned char),12),_tag_arr(_tmp87,sizeof(void*),1));}}),
tud->name);return 0;}return Cyc_Interface_check_public_type_list(ae,seen,obj,name,
Cyc_Core_identity,_tmp54)? Cyc_Interface_check_public_tuniondecl(ae,seen,tud): 0;}}}}
_LL24: return 1;_LL10:;}struct _tuple10{struct Cyc_Interface_Ienv*f1;struct Cyc_Interface_Ienv*
f2;int f3;struct Cyc_Dict_Dict*f4;struct Cyc_Interface_Seen*f5;struct Cyc_Interface_I*
f6;};static void Cyc_Interface_extract_aggrdecl(struct _tuple10*env,struct
_tagged_arr*x,struct Cyc_Absyn_Aggrdecl**dp){struct _tuple10 _tmp8A;struct Cyc_Interface_Seen*
_tmp8B;struct Cyc_Dict_Dict*_tmp8C;int _tmp8D;struct Cyc_Interface_Ienv*_tmp8E;
struct Cyc_Interface_Ienv*_tmp8F;struct _tuple10*_tmp89=env;_tmp8A=*_tmp89;_LL5B:
_tmp8F=_tmp8A.f1;goto _LL5A;_LL5A: _tmp8E=_tmp8A.f2;goto _LL59;_LL59: _tmp8D=_tmp8A.f3;
goto _LL58;_LL58: _tmp8C=_tmp8A.f4;goto _LL57;_LL57: _tmp8B=_tmp8A.f5;goto _LL56;
_LL56: {struct Cyc_Absyn_Aggrdecl*_tmp90=*dp;void*_tmp91=(void*)_tmp90->sc;_LL5D:
if((int)_tmp91 == 0){goto _LL5E;}else{goto _LL5F;}_LL5F: if((int)_tmp91 == 1){goto
_LL60;}else{goto _LL61;}_LL61: if((int)_tmp91 == 2){goto _LL62;}else{goto _LL63;}
_LL63: if((int)_tmp91 == 4){goto _LL64;}else{goto _LL65;}_LL65: if((int)_tmp91 == 3){
goto _LL66;}else{goto _LL5C;}_LL5E: if(_tmp8D? _tmp90->fields == 0: 0){Cyc_Interface_fields_err(
_tag_arr("static",sizeof(unsigned char),7),_tag_arr("aggr",sizeof(unsigned char),
5),_tmp90->name);}goto _LL5C;_LL60: if(_tmp90->fields == 0){if(_tmp8D){Cyc_Interface_fields_err(
_tag_arr("abstract",sizeof(unsigned char),9),_tag_arr("aggr",sizeof(
unsigned char),5),_tmp90->name);}}else{_tmp90=({struct Cyc_Absyn_Aggrdecl*_tmp92=
_cycalloc(sizeof(*_tmp92));_tmp92[0]=*_tmp90;_tmp92;});_tmp90->fields=0;}if(Cyc_Interface_check_public_aggrdecl(
_tmp8C,_tmp8B,_tmp90)){_tmp8E->aggrdecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Aggrdecl*v))Cyc_Dict_insert)(_tmp8E->aggrdecls,
x,_tmp90);}goto _LL5C;_LL62: if(_tmp90->fields == 0){Cyc_Interface_fields_err(
_tag_arr("public",sizeof(unsigned char),7),_tag_arr("aggr",sizeof(unsigned char),
5),_tmp90->name);_tmp90=({struct Cyc_Absyn_Aggrdecl*_tmp93=_cycalloc(sizeof(*
_tmp93));_tmp93[0]=*_tmp90;_tmp93;});(void*)(_tmp90->sc=(void*)((void*)1));}if(
Cyc_Interface_check_public_aggrdecl(_tmp8C,_tmp8B,_tmp90)){_tmp8E->aggrdecls=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,struct Cyc_Absyn_Aggrdecl*
v))Cyc_Dict_insert)(_tmp8E->aggrdecls,x,_tmp90);}goto _LL5C;_LL64: goto _LL66;_LL66:
if(Cyc_Interface_check_public_aggrdecl(_tmp8C,_tmp8B,_tmp90)){_tmp8F->aggrdecls=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,struct Cyc_Absyn_Aggrdecl*
v))Cyc_Dict_insert)(_tmp8F->aggrdecls,x,_tmp90);}goto _LL5C;_LL5C:;}}static void
Cyc_Interface_extract_enumdecl(struct _tuple10*env,struct _tagged_arr*x,struct Cyc_Absyn_Enumdecl**
dp){struct _tuple10 _tmp95;struct Cyc_Interface_Seen*_tmp96;struct Cyc_Dict_Dict*
_tmp97;int _tmp98;struct Cyc_Interface_Ienv*_tmp99;struct Cyc_Interface_Ienv*_tmp9A;
struct _tuple10*_tmp94=env;_tmp95=*_tmp94;_LL6C: _tmp9A=_tmp95.f1;goto _LL6B;_LL6B:
_tmp99=_tmp95.f2;goto _LL6A;_LL6A: _tmp98=_tmp95.f3;goto _LL69;_LL69: _tmp97=_tmp95.f4;
goto _LL68;_LL68: _tmp96=_tmp95.f5;goto _LL67;_LL67: {struct Cyc_Absyn_Enumdecl*
_tmp9B=*dp;void*_tmp9C=(void*)_tmp9B->sc;_LL6E: if((int)_tmp9C == 0){goto _LL6F;}
else{goto _LL70;}_LL70: if((int)_tmp9C == 1){goto _LL71;}else{goto _LL72;}_LL72: if((
int)_tmp9C == 2){goto _LL73;}else{goto _LL74;}_LL74: if((int)_tmp9C == 4){goto _LL75;}
else{goto _LL76;}_LL76: if((int)_tmp9C == 3){goto _LL77;}else{goto _LL6D;}_LL6F: if(
_tmp98? _tmp9B->fields == 0: 0){Cyc_Interface_fields_err(_tag_arr("static",sizeof(
unsigned char),7),_tag_arr("enum",sizeof(unsigned char),5),_tmp9B->name);}goto
_LL6D;_LL71: if(_tmp9B->fields == 0){if(_tmp98){Cyc_Interface_fields_err(_tag_arr("abstract",
sizeof(unsigned char),9),_tag_arr("enum",sizeof(unsigned char),5),_tmp9B->name);}}
else{_tmp9B=({struct Cyc_Absyn_Enumdecl*_tmp9D=_cycalloc(sizeof(*_tmp9D));_tmp9D[
0]=*_tmp9B;_tmp9D;});_tmp9B->fields=0;}if(Cyc_Interface_check_public_enumdecl(
_tmp97,_tmp96,_tmp9B)){_tmp99->enumdecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Enumdecl*v))Cyc_Dict_insert)(_tmp99->enumdecls,
x,_tmp9B);}goto _LL6D;_LL73: if(_tmp9B->fields == 0){Cyc_Interface_fields_err(
_tag_arr("public",sizeof(unsigned char),7),_tag_arr("enum",sizeof(unsigned char),
5),_tmp9B->name);_tmp9B=({struct Cyc_Absyn_Enumdecl*_tmp9E=_cycalloc(sizeof(*
_tmp9E));_tmp9E[0]=*_tmp9B;_tmp9E;});(void*)(_tmp9B->sc=(void*)((void*)1));}if(
Cyc_Interface_check_public_enumdecl(_tmp97,_tmp96,_tmp9B)){_tmp99->enumdecls=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,struct Cyc_Absyn_Enumdecl*
v))Cyc_Dict_insert)(_tmp99->enumdecls,x,_tmp9B);}goto _LL6D;_LL75: goto _LL77;_LL77:
if(Cyc_Interface_check_public_enumdecl(_tmp97,_tmp96,_tmp9B)){_tmp9A->enumdecls=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,struct Cyc_Absyn_Enumdecl*
v))Cyc_Dict_insert)(_tmp9A->enumdecls,x,_tmp9B);}goto _LL6D;_LL6D:;}}static void
Cyc_Interface_extract_xtunionfielddecl(struct Cyc_Interface_I*i,struct Cyc_Absyn_Tuniondecl*
d,struct Cyc_Absyn_Tunionfield*f){struct Cyc_List_List*_tmp9F=0;{void*_tmpA0=(*f->name).f1;
struct Cyc_List_List*_tmpA1;struct Cyc_List_List*_tmpA2;_LL79: if((unsigned int)
_tmpA0 > 1?*((int*)_tmpA0)== 0: 0){_LL7F: _tmpA1=((struct Cyc_Absyn_Rel_n_struct*)
_tmpA0)->f1;goto _LL7A;}else{goto _LL7B;}_LL7B: if((unsigned int)_tmpA0 > 1?*((int*)
_tmpA0)== 1: 0){_LL80: _tmpA2=((struct Cyc_Absyn_Abs_n_struct*)_tmpA0)->f1;goto
_LL7C;}else{goto _LL7D;}_LL7D: goto _LL7E;_LL7A: _tmpA2=_tmpA1;goto _LL7C;_LL7C:
_tmp9F=_tmpA2;goto _LL78;_LL7E: goto _LL78;_LL78:;}{struct Cyc_Dict_Dict**dict;{void*
_tmpA3=(void*)f->sc;_LL82: if((int)_tmpA3 == 0){goto _LL83;}else{goto _LL84;}_LL84:
if((int)_tmpA3 == 3){goto _LL85;}else{goto _LL86;}_LL86: if((int)_tmpA3 == 2){goto
_LL87;}else{goto _LL88;}_LL88: goto _LL89;_LL83: return;_LL85: dict=& i->imports;goto
_LL81;_LL87: dict=& i->exports;goto _LL81;_LL89:((int(*)(struct _tagged_arr s))Cyc_Interface_invalid_arg)(
_tag_arr("add_xtunionfielddecl",sizeof(unsigned char),21));_LL81:;}{struct Cyc_Interface_Ienv*
...
_pop_handler();}else{void*_tmpA5=(void*)_exn_thrown;void*_tmpA8=_tmpA5;_LL8B: if(
_tmpA8 == Cyc_Dict_Absent){goto _LL8C;}else{goto _LL8D;}_LL8D: goto _LL8E;_LL8C: env=
Cyc_Interface_new_ienv();*dict=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,
struct Cyc_List_List*k,struct Cyc_Interface_Ienv*v))Cyc_Dict_insert)(*dict,_tmp9F,
env);goto _LL8A;_LL8E:(void)_throw(_tmpA8);_LL8A:;}}}env->xtunionfielddecls=((
...
_tmpA9=_cycalloc(sizeof(*_tmpA9));_tmpA9->base=d;_tmpA9->field=f;_tmpA9;}));}}}
static void Cyc_Interface_extract_tuniondecl(struct _tuple10*env,struct _tagged_arr*
x,struct Cyc_Absyn_Tuniondecl**dp){struct _tuple10 _tmpAB;struct Cyc_Interface_I*
_tmpAC;struct Cyc_Interface_Seen*_tmpAD;struct Cyc_Dict_Dict*_tmpAE;int _tmpAF;
struct Cyc_Interface_Ienv*_tmpB0;struct Cyc_Interface_Ienv*_tmpB1;struct _tuple10*
_tmpAA=env;_tmpAB=*_tmpAA;_LL95: _tmpB1=_tmpAB.f1;goto _LL94;_LL94: _tmpB0=_tmpAB.f2;
goto _LL93;_LL93: _tmpAF=_tmpAB.f3;goto _LL92;_LL92: _tmpAE=_tmpAB.f4;goto _LL91;
_LL91: _tmpAD=_tmpAB.f5;goto _LL90;_LL90: _tmpAC=_tmpAB.f6;goto _LL8F;_LL8F: {struct
Cyc_Absyn_Tuniondecl*_tmpB2=*dp;void*_tmpB3=(void*)_tmpB2->sc;_LL97: if((int)
_tmpB3 == 0){goto _LL98;}else{goto _LL99;}_LL99: if((int)_tmpB3 == 1){goto _LL9A;}
else{goto _LL9B;}_LL9B: if((int)_tmpB3 == 2){goto _LL9C;}else{goto _LL9D;}_LL9D: if((
int)_tmpB3 == 4){goto _LL9E;}else{goto _LL9F;}_LL9F: if((int)_tmpB3 == 3){goto _LLA0;}
else{goto _LL96;}_LL98: if((! _tmpB2->is_xtunion? _tmpAF: 0)? _tmpB2->fields == 0: 0){
Cyc_Interface_fields_err(_tag_arr("static",sizeof(unsigned char),7),_tag_arr("tunion",
sizeof(unsigned char),7),_tmpB2->name);}goto _LL96;_LL9A: if(_tmpB2->fields == 0){
if(! _tmpB2->is_xtunion? _tmpAF: 0){Cyc_Interface_fields_err(_tag_arr("abstract",
sizeof(unsigned char),9),_tag_arr("tunion",sizeof(unsigned char),7),_tmpB2->name);}}
else{_tmpB2=({struct Cyc_Absyn_Tuniondecl*_tmpB4=_cycalloc(sizeof(*_tmpB4));
_tmpB4[0]=*_tmpB2;_tmpB4;});_tmpB2->fields=0;}if(Cyc_Interface_check_public_tuniondecl(
_tmpAE,_tmpAD,_tmpB2)){_tmpB0->tuniondecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Tuniondecl*v))Cyc_Dict_insert)(_tmpB0->tuniondecls,
x,_tmpB2);}goto _LL96;_LL9C: _tmpB2=({struct Cyc_Absyn_Tuniondecl*_tmpB5=_cycalloc(
sizeof(*_tmpB5));_tmpB5[0]=*_tmpB2;_tmpB5;});if(! _tmpB2->is_xtunion? _tmpB2->fields
== 0: 0){Cyc_Interface_fields_err(_tag_arr("public",sizeof(unsigned char),7),
_tag_arr("tunion",sizeof(unsigned char),7),_tmpB2->name);(void*)(_tmpB2->sc=(
void*)((void*)1));}if(Cyc_Interface_check_public_tuniondecl(_tmpAE,_tmpAD,_tmpB2)){
if(_tmpB2->is_xtunion? _tmpB2->fields != 0: 0){struct Cyc_List_List*_tmpB6=(struct
Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmpB2->fields))->v;_tmpB2->fields=
0;{struct Cyc_List_List*_tmpB7=_tmpB6;for(0;_tmpB7 != 0;_tmpB7=_tmpB7->tl){Cyc_Interface_extract_xtunionfielddecl(
_tmpAC,_tmpB2,(struct Cyc_Absyn_Tunionfield*)_tmpB7->hd);}}}_tmpB0->tuniondecls=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,struct Cyc_Absyn_Tuniondecl*
v))Cyc_Dict_insert)(_tmpB0->tuniondecls,x,_tmpB2);}goto _LL96;_LL9E:((int(*)(
struct _tagged_arr s))Cyc_Interface_invalid_arg)(_tag_arr("extract_tuniondecl",
sizeof(unsigned char),19));_LLA0: if(Cyc_Interface_check_public_tuniondecl(_tmpAE,
_tmpAD,_tmpB2)){if(_tmpB2->is_xtunion? _tmpB2->fields != 0: 0){_tmpB2=({struct Cyc_Absyn_Tuniondecl*
...
_tmpBA->tl){Cyc_Interface_extract_xtunionfielddecl(_tmpAC,_tmpB2,(struct Cyc_Absyn_Tunionfield*)
_tmpBA->hd);}}}}_tmpB1->tuniondecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Tuniondecl*v))Cyc_Dict_insert)(_tmpB1->tuniondecls,
x,_tmpB2);}goto _LL96;_LL96:;}}static void Cyc_Interface_extract_typedef(struct
_tuple10*env,struct _tagged_arr*x,struct Cyc_Absyn_Typedefdecl*d){struct _tuple10
_tmpBC;struct Cyc_Interface_Seen*_tmpBD;struct Cyc_Dict_Dict*_tmpBE;struct Cyc_Interface_Ienv*
_tmpBF;struct _tuple10*_tmpBB=env;_tmpBC=*_tmpBB;_LLA4: _tmpBF=_tmpBC.f2;goto _LLA3;
_LLA3: _tmpBE=_tmpBC.f4;goto _LLA2;_LLA2: _tmpBD=_tmpBC.f5;goto _LLA1;_LLA1: if(Cyc_Interface_check_public_typedefdecl(
_tmpBE,_tmpBD,d)){_tmpBF->typedefdecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Typedefdecl*v))Cyc_Dict_insert)(_tmpBF->typedefdecls,
x,d);}}static void Cyc_Interface_extract_ordinarie(struct _tuple10*env,struct
_tagged_arr*x,struct _tuple6*v){struct _tuple10 _tmpC1;struct Cyc_Interface_Seen*
_tmpC2;struct Cyc_Dict_Dict*_tmpC3;int _tmpC4;struct Cyc_Interface_Ienv*_tmpC5;
struct Cyc_Interface_Ienv*_tmpC6;struct _tuple10*_tmpC0=env;_tmpC1=*_tmpC0;_LLAA:
_tmpC6=_tmpC1.f1;goto _LLA9;_LLA9: _tmpC5=_tmpC1.f2;goto _LLA8;_LLA8: _tmpC4=_tmpC1.f3;
goto _LLA7;_LLA7: _tmpC3=_tmpC1.f4;goto _LLA6;_LLA6: _tmpC2=_tmpC1.f5;goto _LLA5;
_LLA5: {void*_tmpC7=(*v).f1;void*_tmpC8=_tmpC7;void*_tmpC9;_LLAC: if(*((int*)
_tmpC8)== 0){_LLB0: _tmpC9=(void*)((struct Cyc_Tcenv_VarRes_struct*)_tmpC8)->f1;
goto _LLAD;}else{goto _LLAE;}_LLAE: goto _LLAF;_LLAD:{void*_tmpCA=_tmpC9;struct Cyc_Absyn_Fndecl*
_tmpCB;struct Cyc_Absyn_Vardecl*_tmpCC;_LLB2: if((unsigned int)_tmpCA > 1?*((int*)
_tmpCA)== 1: 0){_LLB8: _tmpCB=((struct Cyc_Absyn_Funname_b_struct*)_tmpCA)->f1;goto
_LLB3;}else{goto _LLB4;}_LLB4: if((unsigned int)_tmpCA > 1?*((int*)_tmpCA)== 0: 0){
_LLB9: _tmpCC=((struct Cyc_Absyn_Global_b_struct*)_tmpCA)->f1;goto _LLB5;}else{goto
_LLB6;}_LLB6: goto _LLB7;_LLB3: {struct Cyc_Absyn_Vardecl*_tmpCD=({struct Cyc_Absyn_Vardecl*
...
0;_tmpCE->escapes=0;_tmpCE;});_tmpC4=0;_tmpCC=_tmpCD;goto _LLB5;}_LLB5: if(_tmpCC->initializer
!= 0){_tmpCC=({struct Cyc_Absyn_Vardecl*_tmpD0=_cycalloc(sizeof(*_tmpD0));_tmpD0[
0]=*_tmpCC;_tmpD0;});_tmpCC->initializer=0;}{void*_tmpD1=(void*)_tmpCC->sc;_LLBB:
if((int)_tmpD1 == 0){goto _LLBC;}else{goto _LLBD;}_LLBD: if((int)_tmpD1 == 1){goto
_LLBE;}else{goto _LLBF;}_LLBF: if((int)_tmpD1 == 2){goto _LLC0;}else{goto _LLC1;}
_LLC1: if((int)_tmpD1 == 4){goto _LLC2;}else{goto _LLC3;}_LLC3: if((int)_tmpD1 == 3){
goto _LLC4;}else{goto _LLBA;}_LLBC: if(_tmpC4? Cyc_Tcutil_is_function_type((void*)
_tmpCC->type): 0){Cyc_Interface_body_err(_tag_arr("static",sizeof(unsigned char),
7),_tmpCC->name);}goto _LLBA;_LLBE:((int(*)(struct _tagged_arr s))Cyc_Interface_invalid_arg)(
_tag_arr("extract_ordinarie",sizeof(unsigned char),18));_LLC0: if(_tmpC4? Cyc_Tcutil_is_function_type((
void*)_tmpCC->type): 0){Cyc_Interface_body_err(_tag_arr("public",sizeof(
unsigned char),7),_tmpCC->name);}if(Cyc_Interface_check_public_vardecl(_tmpC3,
_tmpC2,_tmpCC)){_tmpC5->vardecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,
struct _tagged_arr*k,struct Cyc_Absyn_Vardecl*v))Cyc_Dict_insert)(_tmpC5->vardecls,
x,_tmpCC);}goto _LLBA;_LLC2: goto _LLC4;_LLC4: if(Cyc_Interface_check_public_vardecl(
_tmpC3,_tmpC2,_tmpCC)){_tmpC6->vardecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Vardecl*v))Cyc_Dict_insert)(_tmpC6->vardecls,
x,_tmpCC);}goto _LLBA;_LLBA:;}goto _LLB1;_LLB7: goto _LLB1;_LLB1:;}goto _LLAB;_LLAF:
goto _LLAB;_LLAB:;}}struct _tuple11{struct Cyc_Interface_I*f1;int f2;struct Cyc_Dict_Dict*
...
_tmpD3;struct Cyc_Interface_Seen*_tmpD4;struct Cyc_Dict_Dict*_tmpD5;int _tmpD6;
struct Cyc_Interface_I*_tmpD7;struct _tuple11*_tmpD2=env_f;_tmpD3=*_tmpD2;_LLC9:
_tmpD7=_tmpD3.f1;goto _LLC8;_LLC8: _tmpD6=_tmpD3.f2;goto _LLC7;_LLC7: _tmpD5=_tmpD3.f3;
goto _LLC6;_LLC6: _tmpD4=_tmpD3.f4;goto _LLC5;_LLC5: {struct _tuple10 _tmpD8=({struct
_tuple10 _tmpD9;_tmpD9.f1=((struct Cyc_Interface_Ienv*(*)(struct Cyc_Dict_Dict*d,
struct Cyc_List_List*k))Cyc_Dict_lookup)(_tmpD7->imports,ns);_tmpD9.f2=((struct
Cyc_Interface_Ienv*(*)(struct Cyc_Dict_Dict*d,struct Cyc_List_List*k))Cyc_Dict_lookup)(
_tmpD7->exports,ns);_tmpD9.f3=_tmpD6;_tmpD9.f4=_tmpD5;_tmpD9.f5=_tmpD4;_tmpD9.f6=
_tmpD7;_tmpD9;});((void(*)(void(*f)(struct _tuple10*,struct _tagged_arr*,struct Cyc_Absyn_Aggrdecl**),
struct _tuple10*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_extract_aggrdecl,&
_tmpD8,ge->aggrdecls);((void(*)(void(*f)(struct _tuple10*,struct _tagged_arr*,
struct Cyc_Absyn_Tuniondecl**),struct _tuple10*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(
Cyc_Interface_extract_tuniondecl,& _tmpD8,ge->tuniondecls);((void(*)(void(*f)(
...
_tmpD8,ge->enumdecls);((void(*)(void(*f)(struct _tuple10*,struct _tagged_arr*,
struct Cyc_Absyn_Typedefdecl*),struct _tuple10*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(
Cyc_Interface_extract_typedef,& _tmpD8,ge->typedefs);((void(*)(void(*f)(struct
_tuple10*,struct _tagged_arr*,struct _tuple6*),struct _tuple10*env,struct Cyc_Dict_Dict*
d))Cyc_Dict_iter_c)(Cyc_Interface_extract_ordinarie,& _tmpD8,ge->ordinaries);}}
static struct Cyc_Interface_I*Cyc_Interface_gen_extract(struct Cyc_Dict_Dict*ae,int
check_complete_defs){struct _tuple11 _tmpDA=({struct _tuple11 _tmpDB;_tmpDB.f1=((
struct Cyc_Interface_I*(*)(struct Cyc_Dict_Dict*skel))Cyc_Interface_skel2i)(ae);
_tmpDB.f2=check_complete_defs;_tmpDB.f3=ae;_tmpDB.f4=Cyc_Interface_new_seen();
_tmpDB;});((void(*)(void(*f)(struct _tuple11*,struct Cyc_List_List*,struct Cyc_Tcenv_Genv*),
struct _tuple11*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_extract_f,&
_tmpDA,ae);return _tmpDA.f1;}struct Cyc_Interface_I*Cyc_Interface_extract(struct
...
_tmpDD;_tmpDD.tag=0;_tmpDD.f1=(struct _tagged_arr)msg2;{void*_tmpDC[1]={& _tmpDD};
Cyc_Tcdecl_merr(0,msg1,_tag_arr("%s",sizeof(unsigned char),3),_tag_arr(_tmpDC,
sizeof(void*),1));}});}struct _tuple12{int f1;struct Cyc_Dict_Dict*f2;int(*f3)(void*,
void*,struct _tagged_arr*);struct _tagged_arr f4;struct _tagged_arr*f5;};static void
Cyc_Interface_incl_dict_f(struct _tuple12*env,struct _tagged_arr*x,void*y1){struct
_tuple12 _tmpDF;struct _tagged_arr*_tmpE0;struct _tagged_arr _tmpE1;int(*_tmpE2)(
void*,void*,struct _tagged_arr*);struct Cyc_Dict_Dict*_tmpE3;int _tmpE4;int*_tmpE5;
struct _tuple12*_tmpDE=env;_tmpDF=*_tmpDE;_LLCF: _tmpE4=_tmpDF.f1;_tmpE5=(int*)&(*
_tmpDE).f1;goto _LLCE;_LLCE: _tmpE3=_tmpDF.f2;goto _LLCD;_LLCD: _tmpE2=_tmpDF.f3;
goto _LLCC;_LLCC: _tmpE1=_tmpDF.f4;goto _LLCB;_LLCB: _tmpE0=_tmpDF.f5;goto _LLCA;
_LLCA: {struct _handler_cons _tmpE6;_push_handler(& _tmpE6);{int _tmpE8=0;if(setjmp(
_tmpE6.handler)){_tmpE8=1;}if(! _tmpE8){{void*_tmpE9=((void*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k))Cyc_Dict_lookup)(_tmpE3,x);if(! _tmpE2(y1,_tmpE9,_tmpE0)){*
_tmpE5=0;}};_pop_handler();}else{void*_tmpE7=(void*)_exn_thrown;void*_tmpEB=
_tmpE7;_LLD1: if(_tmpEB == Cyc_Dict_Absent){goto _LLD2;}else{goto _LLD3;}_LLD3: goto
_LLD4;_LLD2: Cyc_Interface_check_err(_tmpE0,(struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmpEE;_tmpEE.tag=0;_tmpEE.f1=(struct _tagged_arr)*x;{struct Cyc_Std_String_pa_struct
_tmpED;_tmpED.tag=0;_tmpED.f1=(struct _tagged_arr)_tmpE1;{void*_tmpEC[2]={& _tmpED,&
_tmpEE};Cyc_Std_aprintf(_tag_arr("%s %s is missing",sizeof(unsigned char),17),
_tag_arr(_tmpEC,sizeof(void*),2));}}}));*_tmpE5=0;goto _LLD0;_LLD4:(void)_throw(
_tmpEB);_LLD0:;}}}}static int Cyc_Interface_incl_dict(struct Cyc_Dict_Dict*dic1,
struct Cyc_Dict_Dict*dic2,int(*incl_f)(void*,void*,struct _tagged_arr*),struct
_tagged_arr t,struct _tagged_arr*msg){struct _tuple12 _tmpEF=({struct _tuple12 _tmpF0;
_tmpF0.f1=1;_tmpF0.f2=dic2;_tmpF0.f3=incl_f;_tmpF0.f4=t;_tmpF0.f5=msg;_tmpF0;});((
void(*)(void(*f)(struct _tuple12*,struct _tagged_arr*,void*),struct _tuple12*env,
struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_incl_dict_f,& _tmpEF,dic1);
return _tmpEF.f1;}static int Cyc_Interface_incl_aggrdecl(struct Cyc_Absyn_Aggrdecl*
...
_tag_arr("declaration of type %s discloses too much information",sizeof(
unsigned char),54),_tag_arr(_tmpF2,sizeof(void*),1));}}));return 0;}return 1;}
static int Cyc_Interface_incl_tuniondecl(struct Cyc_Absyn_Tuniondecl*d0,struct Cyc_Absyn_Tuniondecl*
d1,struct _tagged_arr*msg){struct Cyc_Absyn_Tuniondecl*_tmpF4=Cyc_Tcdecl_merge_tuniondecl(
d0,d1,0,msg);if(_tmpF4 == 0){return 0;}if((struct Cyc_Absyn_Tuniondecl*)d0 != _tmpF4){
Cyc_Interface_check_err(msg,(struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmpF6;_tmpF6.tag=0;_tmpF6.f1=(struct _tagged_arr)Cyc_Absynpp_qvar2string(d1->name);{
void*_tmpF5[1]={& _tmpF6};Cyc_Std_aprintf(_tag_arr("declaration of tunion %s discloses too much information",
sizeof(unsigned char),56),_tag_arr(_tmpF5,sizeof(void*),1));}}));return 0;}return
1;}static int Cyc_Interface_incl_enumdecl(struct Cyc_Absyn_Enumdecl*d0,struct Cyc_Absyn_Enumdecl*
...
sizeof(unsigned char),54),_tag_arr(_tmpF8,sizeof(void*),1));}}));return 0;}return
1;}static int Cyc_Interface_incl_vardecl(struct Cyc_Absyn_Vardecl*d0,struct Cyc_Absyn_Vardecl*
d1,struct _tagged_arr*msg){struct Cyc_Absyn_Vardecl*_tmpFA=Cyc_Tcdecl_merge_vardecl(
d0,d1,0,msg);if(_tmpFA == 0){return 0;}if((struct Cyc_Absyn_Vardecl*)d0 != _tmpFA){
Cyc_Interface_check_err(msg,(struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmpFC;_tmpFC.tag=0;_tmpFC.f1=(struct _tagged_arr)Cyc_Absynpp_qvar2string(d1->name);{
void*_tmpFB[1]={& _tmpFC};Cyc_Std_aprintf(_tag_arr("declaration of variable %s discloses too much information",
sizeof(unsigned char),58),_tag_arr(_tmpFB,sizeof(void*),1));}}));return 0;}return
1;}static int Cyc_Interface_incl_typedefdecl(struct Cyc_Absyn_Typedefdecl*d0,struct
Cyc_Absyn_Typedefdecl*d1,struct _tagged_arr*msg){struct Cyc_Absyn_Typedefdecl*
_tmpFD=Cyc_Tcdecl_merge_typedefdecl(d0,d1,0,msg);if(_tmpFD == 0){return 0;}if((
struct Cyc_Absyn_Typedefdecl*)d0 != _tmpFD){Cyc_Interface_check_err(msg,(struct
_tagged_arr)({struct Cyc_Std_String_pa_struct _tmpFF;_tmpFF.tag=0;_tmpFF.f1=(
struct _tagged_arr)Cyc_Absynpp_qvar2string(d1->name);{void*_tmpFE[1]={& _tmpFF};
Cyc_Std_aprintf(_tag_arr("declaration of typedef %s discloses too much information",
sizeof(unsigned char),57),_tag_arr(_tmpFE,sizeof(void*),1));}}));return 0;}return
1;}static int Cyc_Interface_incl_xtunionfielddecl(struct Cyc_Tcdecl_Xtunionfielddecl*
...
sizeof(unsigned char),62),_tag_arr(_tmp101,sizeof(void*),1));}}));return 0;}
...
_tag_arr("type",sizeof(unsigned char),5),msg);int _tmp104=((int(*)(struct Cyc_Dict_Dict*
...
sizeof(unsigned char),7),msg);int _tmp105=((int(*)(struct Cyc_Dict_Dict*dic1,
...
sizeof(unsigned char),5),msg);int _tmp106=((struct Cyc_Core_Opt*(*)(struct Cyc_Dict_Dict*
...
_tag_arr("typedef",sizeof(unsigned char),8),msg)!= 0;int _tmp107=((int(*)(struct
...
_tag_arr("variable",sizeof(unsigned char),9),msg);int _tmp108=((int(*)(struct Cyc_Dict_Dict*
...
13),msg);return((((_tmp103? _tmp104: 0)? _tmp105: 0)? _tmp106: 0)? _tmp107: 0)? _tmp108: 0;}
struct _tuple13{int f1;struct Cyc_Dict_Dict*f2;struct _tagged_arr*f3;};static void Cyc_Interface_incl_ns_f(
struct _tuple13*env,struct Cyc_List_List*ns,struct Cyc_Interface_Ienv*ie1){struct
_tuple13 _tmp10A;struct _tagged_arr*_tmp10B;struct Cyc_Dict_Dict*_tmp10C;int _tmp10D;
int*_tmp10E;struct _tuple13*_tmp109=env;_tmp10A=*_tmp109;_LLD8: _tmp10D=_tmp10A.f1;
_tmp10E=(int*)&(*_tmp109).f1;goto _LLD7;_LLD7: _tmp10C=_tmp10A.f2;goto _LLD6;_LLD6:
_tmp10B=_tmp10A.f3;goto _LLD5;_LLD5: {struct Cyc_Interface_Ienv*ie2;{struct
_handler_cons _tmp10F;_push_handler(& _tmp10F);{int _tmp111=0;if(setjmp(_tmp10F.handler)){
_tmp111=1;}if(! _tmp111){ie2=((struct Cyc_Interface_Ienv*(*)(struct Cyc_Dict_Dict*d,
struct Cyc_List_List*k))Cyc_Dict_lookup)(_tmp10C,ns);;_pop_handler();}else{void*
_tmp110=(void*)_exn_thrown;void*_tmp113=_tmp110;_LLDA: if(_tmp113 == Cyc_Dict_Absent){
goto _LLDB;}else{goto _LLDC;}_LLDC: goto _LLDD;_LLDB: ie2=Cyc_Interface_lazy_new_ienv();
goto _LLD9;_LLDD:(void)_throw(_tmp113);_LLD9:;}}}if(! Cyc_Interface_incl_ienv(ie1,
ie2,_tmp10B)){*_tmp10E=0;}}}static int Cyc_Interface_incl_ns(struct Cyc_Dict_Dict*
dic1,struct Cyc_Dict_Dict*dic2,struct _tagged_arr*msg){struct _tuple13 _tmp114=({
struct _tuple13 _tmp115;_tmp115.f1=1;_tmp115.f2=dic2;_tmp115.f3=msg;_tmp115;});((
void(*)(void(*f)(struct _tuple13*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),
...
i1,struct Cyc_Interface_I*i2,struct _tuple3*info){struct _handler_cons _tmp116;
...
sizeof(unsigned char),50),_tag_arr(_tmp11B,sizeof(void*),2));}}});_tmp11A;});}
if(! Cyc_Interface_incl_ns(i1->exports,i2->exports,msg)){_tmp119=0;}if(info != 0){
msg=({struct _tagged_arr*_tmp11E=_cycalloc(sizeof(*_tmp11E));_tmp11E[0]=(struct
_tagged_arr)({struct Cyc_Std_String_pa_struct _tmp121;_tmp121.tag=0;_tmp121.f1=(
struct _tagged_arr)(*info).f1;{struct Cyc_Std_String_pa_struct _tmp120;_tmp120.tag=
0;_tmp120.f1=(struct _tagged_arr)(*info).f2;{void*_tmp11F[2]={& _tmp120,& _tmp121};
Cyc_Std_aprintf(_tag_arr("checking inclusion of %s imports into %s imports,",
sizeof(unsigned char),50),_tag_arr(_tmp11F,sizeof(void*),2));}}});_tmp11E;});}
if(! Cyc_Interface_incl_ns(i2->imports,i1->imports,msg)){_tmp119=0;}{int _tmp122=
_tmp119;_npop_handler(0);return _tmp122;}};_pop_handler();}else{void*_tmp117=(
void*)_exn_thrown;void*_tmp124=_tmp117;_LLDF: if(_tmp124 == Cyc_Tcdecl_Incompatible){
goto _LLE0;}else{goto _LLE1;}_LLE1: goto _LLE2;_LLE0: return 0;_LLE2:(void)_throw(
_tmp124);_LLDE:;}}}struct _tuple14{int f1;struct Cyc_Dict_Dict*f2;struct Cyc_Dict_Dict*
...
struct _tuple14*env,struct _tagged_arr*x,void*y2){struct _tuple14 _tmp126;struct
_tagged_arr*_tmp127;struct _tagged_arr _tmp128;void*(*_tmp129)(void*,void*,struct
Cyc_Position_Segment*,struct _tagged_arr*);struct Cyc_Dict_Dict*_tmp12A;struct Cyc_Dict_Dict*
_tmp12B;struct Cyc_Dict_Dict*_tmp12C;struct Cyc_Dict_Dict**_tmp12D;int _tmp12E;int*
_tmp12F;struct _tuple14*_tmp125=env;_tmp126=*_tmp125;_LLEA: _tmp12E=_tmp126.f1;
_tmp12F=(int*)&(*_tmp125).f1;goto _LLE9;_LLE9: _tmp12C=_tmp126.f2;_tmp12D=(struct
Cyc_Dict_Dict**)&(*_tmp125).f2;goto _LLE8;_LLE8: _tmp12B=_tmp126.f3;goto _LLE7;
_LLE7: _tmp12A=_tmp126.f4;goto _LLE6;_LLE6: _tmp129=_tmp126.f5;goto _LLE5;_LLE5:
_tmp128=_tmp126.f6;goto _LLE4;_LLE4: _tmp127=_tmp126.f7;goto _LLE3;_LLE3: {void*y;{
struct _handler_cons _tmp130;_push_handler(& _tmp130);{int _tmp132=0;if(setjmp(
_tmp130.handler)){_tmp132=1;}if(! _tmp132){{void*_tmp133=((void*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k))Cyc_Dict_lookup)(_tmp12B,x);void*_tmp134=_tmp129(_tmp133,
y2,0,_tmp127);if(!((unsigned int)_tmp134)){*_tmp12F=0;_npop_handler(0);return;}y=(
void*)_check_null(_tmp134);};_pop_handler();}else{void*_tmp131=(void*)
_exn_thrown;void*_tmp136=_tmp131;_LLEC: if(_tmp136 == Cyc_Dict_Absent){goto _LLED;}
else{goto _LLEE;}_LLEE: goto _LLEF;_LLED: y=y2;goto _LLEB;_LLEF:(void)_throw(_tmp136);
_LLEB:;}}}{struct _handler_cons _tmp137;_push_handler(& _tmp137);{int _tmp139=0;if(
setjmp(_tmp137.handler)){_tmp139=1;}if(! _tmp139){{void*_tmp13A=((void*(*)(struct
Cyc_Dict_Dict*d,struct _tagged_arr*k))Cyc_Dict_lookup)(_tmp12A,x);void*_tmp13B=
_tmp129(_tmp13A,y,0,_tmp127);if(_tmp13B != (void*)_tmp13A){if((unsigned int)
_tmp13B){Cyc_Interface_check_err(_tmp127,(struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmp13E;_tmp13E.tag=0;_tmp13E.f1=(struct _tagged_arr)*x;{struct Cyc_Std_String_pa_struct
_tmp13D;_tmp13D.tag=0;_tmp13D.f1=(struct _tagged_arr)_tmp128;{void*_tmp13C[2]={&
_tmp13D,& _tmp13E};Cyc_Std_aprintf(_tag_arr("abstract %s %s is being imported as non-abstract",
sizeof(unsigned char),49),_tag_arr(_tmp13C,sizeof(void*),2));}}}));}*_tmp12F=0;}};
_pop_handler();}else{void*_tmp138=(void*)_exn_thrown;void*_tmp140=_tmp138;_LLF1:
if(_tmp140 == Cyc_Dict_Absent){goto _LLF2;}else{goto _LLF3;}_LLF3: goto _LLF4;_LLF2:
if(*_tmp12F){*_tmp12D=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct
_tagged_arr*k,void*v))Cyc_Dict_insert)(*_tmp12D,x,y);}goto _LLF0;_LLF4:(void)
_throw(_tmp140);_LLF0:;}}}}}struct Cyc_Core_Opt*Cyc_Interface_compat_merge_dict(
...
_tagged_arr t,struct _tagged_arr*msg){struct _tuple14 _tmp141=({struct _tuple14
_tmp143;_tmp143.f1=1;_tmp143.f2=dic1;_tmp143.f3=dic1;_tmp143.f4=excl;_tmp143.f5=
merge_f;_tmp143.f6=t;_tmp143.f7=msg;_tmp143;});((void(*)(void(*f)(struct _tuple14*,
struct _tagged_arr*,void*),struct _tuple14*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(
Cyc_Interface_compat_merge_dict_f,& _tmp141,dic2);if(_tmp141.f1){return({struct
Cyc_Core_Opt*_tmp142=_cycalloc(sizeof(*_tmp142));_tmp142->v=_tmp141.f2;_tmp142;});}
return 0;}struct Cyc_Interface_Ienv*Cyc_Interface_compat_merge_ienv(struct Cyc_Interface_Ienv*
...
_tag_arr("type",sizeof(unsigned char),5),msg);struct Cyc_Core_Opt*_tmp145=((
...
ie2->tuniondecls,iexcl->tuniondecls,Cyc_Tcdecl_merge_tuniondecl,_tag_arr("tunion",
sizeof(unsigned char),7),msg);struct Cyc_Core_Opt*_tmp146=((struct Cyc_Core_Opt*(*)(
...
5),msg);struct Cyc_Core_Opt*_tmp147=((struct Cyc_Core_Opt*(*)(struct Cyc_Dict_Dict*
dic1,struct Cyc_Dict_Dict*dic2,struct Cyc_Dict_Dict*excl,struct Cyc_Absyn_Typedefdecl*(*
merge_f)(struct Cyc_Absyn_Typedefdecl*,struct Cyc_Absyn_Typedefdecl*,struct Cyc_Position_Segment*,
struct _tagged_arr*),struct _tagged_arr t,struct _tagged_arr*msg))Cyc_Interface_compat_merge_dict)(
ie1->typedefdecls,ie2->typedefdecls,iexcl->typedefdecls,Cyc_Tcdecl_merge_typedefdecl,
_tag_arr("typedef",sizeof(unsigned char),8),msg);struct Cyc_Core_Opt*_tmp148=((
struct Cyc_Core_Opt*(*)(struct Cyc_Dict_Dict*dic1,struct Cyc_Dict_Dict*dic2,struct
...
sizeof(unsigned char),9),msg);struct Cyc_Core_Opt*_tmp149=((struct Cyc_Core_Opt*(*)(
struct Cyc_Dict_Dict*dic1,struct Cyc_Dict_Dict*dic2,struct Cyc_Dict_Dict*excl,
...
_tmp144)? 1: !((unsigned int)_tmp145))? 1: !((unsigned int)_tmp146))? 1: !((
unsigned int)_tmp147))? 1: !((unsigned int)_tmp148))? 1: !((unsigned int)_tmp149)){
return 0;}return({struct Cyc_Interface_Ienv*_tmp14A=_cycalloc(sizeof(*_tmp14A));
_tmp14A->aggrdecls=(struct Cyc_Dict_Dict*)_tmp144->v;_tmp14A->tuniondecls=(struct
Cyc_Dict_Dict*)_tmp145->v;_tmp14A->enumdecls=(struct Cyc_Dict_Dict*)_tmp146->v;
_tmp14A->typedefdecls=(struct Cyc_Dict_Dict*)_tmp147->v;_tmp14A->vardecls=(struct
Cyc_Dict_Dict*)_tmp148->v;_tmp14A->xtunionfielddecls=(struct Cyc_Dict_Dict*)
_tmp149->v;_tmp14A;});}struct _tuple15{int f1;struct Cyc_Dict_Dict*f2;struct Cyc_Dict_Dict*
...
_tuple15 _tmp14C;struct _tagged_arr*_tmp14D;struct Cyc_Dict_Dict*_tmp14E;struct Cyc_Dict_Dict*
_tmp14F;struct Cyc_Dict_Dict*_tmp150;struct Cyc_Dict_Dict**_tmp151;int _tmp152;int*
_tmp153;struct _tuple15*_tmp14B=env;_tmp14C=*_tmp14B;_LLFA: _tmp152=_tmp14C.f1;
_tmp153=(int*)&(*_tmp14B).f1;goto _LLF9;_LLF9: _tmp150=_tmp14C.f2;_tmp151=(struct
Cyc_Dict_Dict**)&(*_tmp14B).f2;goto _LLF8;_LLF8: _tmp14F=_tmp14C.f3;goto _LLF7;
_LLF7: _tmp14E=_tmp14C.f4;goto _LLF6;_LLF6: _tmp14D=_tmp14C.f5;goto _LLF5;_LLF5: {
struct Cyc_Interface_Ienv*ie1;struct Cyc_Interface_Ienv*iexcl;{struct _handler_cons
_tmp154;_push_handler(& _tmp154);{int _tmp156=0;if(setjmp(_tmp154.handler)){
_tmp156=1;}if(! _tmp156){iexcl=((struct Cyc_Interface_Ienv*(*)(struct Cyc_Dict_Dict*
d,struct Cyc_List_List*k))Cyc_Dict_lookup)(_tmp14E,ns);;_pop_handler();}else{void*
_tmp155=(void*)_exn_thrown;void*_tmp158=_tmp155;_LLFC: if(_tmp158 == Cyc_Dict_Absent){
goto _LLFD;}else{goto _LLFE;}_LLFE: goto _LLFF;_LLFD: iexcl=Cyc_Interface_lazy_new_ienv();
goto _LLFB;_LLFF:(void)_throw(_tmp158);_LLFB:;}}}{struct _handler_cons _tmp159;
_push_handler(& _tmp159);{int _tmp15B=0;if(setjmp(_tmp159.handler)){_tmp15B=1;}if(
! _tmp15B){ie1=((struct Cyc_Interface_Ienv*(*)(struct Cyc_Dict_Dict*d,struct Cyc_List_List*
k))Cyc_Dict_lookup)(_tmp14F,ns);{struct Cyc_Interface_Ienv*_tmp15C=Cyc_Interface_compat_merge_ienv(
Cyc_Interface_lazy_new_ienv(),ie1,iexcl,_tmp14D);if(_tmp15C == 0){*_tmp153=0;
_npop_handler(0);return;}ie1=(struct Cyc_Interface_Ienv*)_check_null(_tmp15C);};
_pop_handler();}else{void*_tmp15A=(void*)_exn_thrown;void*_tmp15E=_tmp15A;_LL101:
if(_tmp15E == Cyc_Dict_Absent){goto _LL102;}else{goto _LL103;}_LL103: goto _LL104;
_LL102: ie1=Cyc_Interface_lazy_new_ienv();goto _LL100;_LL104:(void)_throw(_tmp15E);
_LL100:;}}}{struct Cyc_Interface_Ienv*_tmp15F=Cyc_Interface_compat_merge_ienv(ie1,
ie2,iexcl,_tmp14D);if(_tmp15F == 0){*_tmp153=0;}else{if(*_tmp153){*_tmp151=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct Cyc_List_List*k,struct Cyc_Interface_Ienv*
v))Cyc_Dict_insert)(*_tmp151,ns,(struct Cyc_Interface_Ienv*)_check_null(_tmp15F));}}}}}
...
Cyc_Dict_empty)(Cyc_Absyn_varlist_cmp);struct _tuple15 _tmp160=({struct _tuple15
_tmp162;_tmp162.f1=1;_tmp162.f2=d;_tmp162.f3=dic1;_tmp162.f4=excl;_tmp162.f5=msg;
_tmp162;});((void(*)(void(*f)(struct _tuple15*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),
struct _tuple15*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_compat_merge_ns_f,&
_tmp160,dic2);if(_tmp160.f1){return({struct Cyc_Core_Opt*_tmp161=_cycalloc(
sizeof(*_tmp161));_tmp161->v=_tmp160.f2;_tmp161;});}return 0;}struct _tuple16{int
f1;struct Cyc_Dict_Dict*f2;struct Cyc_Dict_Dict*f3;struct _tagged_arr f4;struct
_tagged_arr*f5;};void Cyc_Interface_disj_merge_dict_f(struct _tuple16*env,struct
_tagged_arr*x,void*y){struct _tuple16 _tmp164;struct _tagged_arr*_tmp165;struct
_tagged_arr _tmp166;struct Cyc_Dict_Dict*_tmp167;struct Cyc_Dict_Dict*_tmp168;
struct Cyc_Dict_Dict**_tmp169;int _tmp16A;int*_tmp16B;struct _tuple16*_tmp163=env;
_tmp164=*_tmp163;_LL10A: _tmp16A=_tmp164.f1;_tmp16B=(int*)&(*_tmp163).f1;goto
_LL109;_LL109: _tmp168=_tmp164.f2;_tmp169=(struct Cyc_Dict_Dict**)&(*_tmp163).f2;
goto _LL108;_LL108: _tmp167=_tmp164.f3;goto _LL107;_LL107: _tmp166=_tmp164.f4;goto
_LL106;_LL106: _tmp165=_tmp164.f5;goto _LL105;_LL105: if(((int(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k))Cyc_Dict_member)(_tmp167,x)){Cyc_Interface_check_err(
_tmp165,(struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmp16E;_tmp16E.tag=0;
_tmp16E.f1=(struct _tagged_arr)*x;{struct Cyc_Std_String_pa_struct _tmp16D;_tmp16D.tag=
0;_tmp16D.f1=(struct _tagged_arr)_tmp166;{void*_tmp16C[2]={& _tmp16D,& _tmp16E};Cyc_Std_aprintf(
_tag_arr("%s %s is exported more than once",sizeof(unsigned char),33),_tag_arr(
_tmp16C,sizeof(void*),2));}}}));*_tmp16B=0;}else{if(*_tmp16B){*_tmp169=((struct
Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,void*v))Cyc_Dict_insert)(*
_tmp169,x,y);}}}struct Cyc_Core_Opt*Cyc_Interface_disj_merge_dict(struct Cyc_Dict_Dict*
dic1,struct Cyc_Dict_Dict*dic2,struct _tagged_arr t,struct _tagged_arr*msg){struct
_tuple16 _tmp16F=({struct _tuple16 _tmp171;_tmp171.f1=1;_tmp171.f2=dic1;_tmp171.f3=
dic1;_tmp171.f4=t;_tmp171.f5=msg;_tmp171;});((void(*)(void(*f)(struct _tuple16*,
...
_tag_arr("type",sizeof(unsigned char),5),msg);struct Cyc_Core_Opt*_tmp173=((
struct Cyc_Core_Opt*(*)(struct Cyc_Dict_Dict*dic1,struct Cyc_Dict_Dict*dic2,struct
_tagged_arr t,struct _tagged_arr*msg))Cyc_Interface_disj_merge_dict)(ie1->tuniondecls,
ie2->tuniondecls,_tag_arr("[x]tunion",sizeof(unsigned char),10),msg);struct Cyc_Core_Opt*
_tmp174=((struct Cyc_Core_Opt*(*)(struct Cyc_Dict_Dict*dic1,struct Cyc_Dict_Dict*
...
struct Cyc_Core_Opt*_tmp175=((struct Cyc_Core_Opt*(*)(struct Cyc_Dict_Dict*dic1,
...
_tag_arr("typedef",sizeof(unsigned char),8),msg);struct Cyc_Core_Opt*_tmp176=((
struct Cyc_Core_Opt*(*)(struct Cyc_Dict_Dict*dic1,struct Cyc_Dict_Dict*dic2,struct
...
_tmp177=((struct Cyc_Core_Opt*(*)(struct Cyc_Dict_Dict*dic1,struct Cyc_Dict_Dict*
dic2,struct _tagged_arr t,struct _tagged_arr*msg))Cyc_Interface_disj_merge_dict)(
ie1->xtunionfielddecls,ie2->xtunionfielddecls,_tag_arr("xtunionfield",sizeof(
unsigned char),13),msg);if(((((!((unsigned int)_tmp172)? 1: !((unsigned int)
_tmp173))? 1: !((unsigned int)_tmp174))? 1: !((unsigned int)_tmp175))? 1: !((
unsigned int)_tmp176))? 1: !((unsigned int)_tmp177)){return 0;}return({struct Cyc_Interface_Ienv*
...
struct Cyc_Dict_Dict*)_tmp177->v;_tmp178;});}struct _tuple17{int f1;struct Cyc_Dict_Dict*
f2;struct Cyc_Dict_Dict*f3;struct _tagged_arr*f4;};void Cyc_Interface_disj_merge_ns_f(
struct _tuple17*env,struct Cyc_List_List*ns,struct Cyc_Interface_Ienv*ie2){struct
_tuple17 _tmp17A;struct _tagged_arr*_tmp17B;struct Cyc_Dict_Dict*_tmp17C;struct Cyc_Dict_Dict*
_tmp17D;struct Cyc_Dict_Dict**_tmp17E;int _tmp17F;int*_tmp180;struct _tuple17*
_tmp179=env;_tmp17A=*_tmp179;_LL10F: _tmp17F=_tmp17A.f1;_tmp180=(int*)&(*_tmp179).f1;
goto _LL10E;_LL10E: _tmp17D=_tmp17A.f2;_tmp17E=(struct Cyc_Dict_Dict**)&(*_tmp179).f2;
goto _LL10D;_LL10D: _tmp17C=_tmp17A.f3;goto _LL10C;_LL10C: _tmp17B=_tmp17A.f4;goto
_LL10B;_LL10B: {struct Cyc_Interface_Ienv*ie1;{struct _handler_cons _tmp181;
...
k))Cyc_Dict_lookup)(_tmp17C,ns);;_pop_handler();}else{void*_tmp182=(void*)
_exn_thrown;void*_tmp185=_tmp182;_LL111: if(_tmp185 == Cyc_Dict_Absent){goto _LL112;}
else{goto _LL113;}_LL113: goto _LL114;_LL112: ie1=Cyc_Interface_lazy_new_ienv();goto
_LL110;_LL114:(void)_throw(_tmp185);_LL110:;}}}{struct Cyc_Interface_Ienv*_tmp186=
Cyc_Interface_disj_merge_ienv(ie1,ie2,_tmp17B);if(_tmp186 == 0){*_tmp180=0;}else{
if(*_tmp180){*_tmp17E=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct Cyc_List_List*
k,struct Cyc_Interface_Ienv*v))Cyc_Dict_insert)(*_tmp17E,ns,(struct Cyc_Interface_Ienv*)
_check_null(_tmp186));}}}}}struct Cyc_Core_Opt*Cyc_Interface_disj_merge_ns(struct
Cyc_Dict_Dict*dic1,struct Cyc_Dict_Dict*dic2,struct _tagged_arr*msg){struct
_tuple17 _tmp187=({struct _tuple17 _tmp189;_tmp189.f1=1;_tmp189.f2=dic1;_tmp189.f3=
dic1;_tmp189.f4=msg;_tmp189;});((void(*)(void(*f)(struct _tuple17*,struct Cyc_List_List*,
struct Cyc_Interface_Ienv*),struct _tuple17*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(
Cyc_Interface_disj_merge_ns_f,& _tmp187,dic2);if(_tmp187.f1){return({struct Cyc_Core_Opt*
_tmp188=_cycalloc(sizeof(*_tmp188));_tmp188->v=_tmp187.f2;_tmp188;});}return 0;}
struct Cyc_Interface_I*Cyc_Interface_merge(struct Cyc_Interface_I*i1,struct Cyc_Interface_I*
i2,struct _tuple3*info){struct _handler_cons _tmp18A;_push_handler(& _tmp18A);{int
_tmp18C=0;if(setjmp(_tmp18A.handler)){_tmp18C=1;}if(! _tmp18C){{struct _tagged_arr*
msg=0;if(info != 0){msg=({struct _tagged_arr*_tmp18D=_cycalloc(sizeof(*_tmp18D));
_tmp18D[0]=(struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmp190;_tmp190.tag=
0;_tmp190.f1=(struct _tagged_arr)(*info).f2;{struct Cyc_Std_String_pa_struct
_tmp18F;_tmp18F.tag=0;_tmp18F.f1=(struct _tagged_arr)(*info).f1;{void*_tmp18E[2]={&
_tmp18F,& _tmp190};Cyc_Std_aprintf(_tag_arr("merging exports of %s and %s,",
sizeof(unsigned char),30),_tag_arr(_tmp18E,sizeof(void*),2));}}});_tmp18D;});}{
struct Cyc_Core_Opt*_tmp191=Cyc_Interface_disj_merge_ns(i1->exports,i2->exports,
msg);if(_tmp191 == 0){struct Cyc_Interface_I*_tmp192=0;_npop_handler(0);return
_tmp192;}if(info != 0){msg=({struct _tagged_arr*_tmp193=_cycalloc(sizeof(*_tmp193));
_tmp193[0]=(struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmp196;_tmp196.tag=
0;_tmp196.f1=(struct _tagged_arr)(*info).f2;{struct Cyc_Std_String_pa_struct
_tmp195;_tmp195.tag=0;_tmp195.f1=(struct _tagged_arr)(*info).f1;{void*_tmp194[2]={&
_tmp195,& _tmp196};Cyc_Std_aprintf(_tag_arr("merging imports of %s and %s,",
sizeof(unsigned char),30),_tag_arr(_tmp194,sizeof(void*),2));}}});_tmp193;});}{
struct Cyc_Core_Opt*_tmp197=Cyc_Interface_compat_merge_ns(i1->imports,i2->imports,(
struct Cyc_Dict_Dict*)_tmp191->v,msg);if(_tmp197 == 0){struct Cyc_Interface_I*
_tmp198=0;_npop_handler(0);return _tmp198;}{struct Cyc_Interface_I*_tmp19A=({
struct Cyc_Interface_I*_tmp199=_cycalloc(sizeof(*_tmp199));_tmp199->imports=(
struct Cyc_Dict_Dict*)_tmp197->v;_tmp199->exports=(struct Cyc_Dict_Dict*)_tmp191->v;
_tmp199;});_npop_handler(0);return _tmp19A;}}}};_pop_handler();}else{void*_tmp18B=(
void*)_exn_thrown;void*_tmp19C=_tmp18B;_LL116: if(_tmp19C == Cyc_Tcdecl_Incompatible){
goto _LL117;}else{goto _LL118;}_LL118: goto _LL119;_LL117: return 0;_LL119:(void)
_throw(_tmp19C);_LL115:;}}}struct Cyc_Interface_I*Cyc_Interface_merge_list(struct
...
li->hd,(curr_info != 0? linfo != 0: 0)?({struct _tuple3*_tmp1A2=_cycalloc(sizeof(*
_tmp1A2));_tmp1A2->f1=*curr_info;_tmp1A2->f2=*((struct _tagged_arr*)linfo->hd);
_tmp1A2;}): 0);if(_tmp19D == 0){return 0;}curr_i=(struct Cyc_Interface_I*)
_check_null(_tmp19D);if(curr_info != 0){curr_info=linfo != 0?({struct _tagged_arr*
_tmp19E=_cycalloc(sizeof(*_tmp19E));_tmp19E[0]=(struct _tagged_arr)({struct Cyc_Std_String_pa_struct
...
_tag_arr("%s+%s",sizeof(unsigned char),6),_tag_arr(_tmp19F,sizeof(void*),2));}}});
_tmp19E;}): 0;}if(linfo != 0){linfo=linfo->tl;}}return(struct Cyc_Interface_I*)
...
_tagged_arr*)linfo->hd): 0;la=la->tl;if(linfo != 0){linfo=linfo->tl;}for(0;la != 0;
la=la->tl){struct Cyc_Interface_I*_tmp1A3=Cyc_Interface_merge(curr_i,get((void*)
la->hd),(curr_info != 0? linfo != 0: 0)?({struct _tuple3*_tmp1A8=_cycalloc(sizeof(*
_tmp1A8));_tmp1A8->f1=*curr_info;_tmp1A8->f2=*((struct _tagged_arr*)linfo->hd);
_tmp1A8;}): 0);if(_tmp1A3 == 0){return 0;}curr_i=(struct Cyc_Interface_I*)
_check_null(_tmp1A3);if(curr_info != 0){curr_info=linfo != 0?({struct _tagged_arr*
_tmp1A4=_cycalloc(sizeof(*_tmp1A4));_tmp1A4[0]=(struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmp1A7;_tmp1A7.tag=0;_tmp1A7.f1=(struct _tagged_arr)*((struct _tagged_arr*)linfo->hd);{
struct Cyc_Std_String_pa_struct _tmp1A6;_tmp1A6.tag=0;_tmp1A6.f1=(struct
_tagged_arr)*curr_info;{void*_tmp1A5[2]={& _tmp1A6,& _tmp1A7};Cyc_Std_aprintf(
_tag_arr("%s+%s",sizeof(unsigned char),6),_tag_arr(_tmp1A5,sizeof(void*),2));}}});
_tmp1A4;}): 0;}if(linfo != 0){linfo=linfo->tl;}}return(struct Cyc_Interface_I*)
...
_tmp1A9=_cycalloc(sizeof(*_tmp1A9));_tmp1A9->hd=Cyc_Absyn_new_decl((void*)({
struct Cyc_Absyn_Namespace_d_struct*_tmp1AA=_cycalloc(sizeof(*_tmp1AA));_tmp1AA[0]=({
struct Cyc_Absyn_Namespace_d_struct _tmp1AB;_tmp1AB.tag=8;_tmp1AB.f1=(struct
_tagged_arr*)ns->hd;_tmp1AB.f2=Cyc_Interface_add_namespace(tds,ns->tl);_tmp1AB;});
_tmp1AA;}),0);_tmp1A9->tl=0;_tmp1A9;});}static struct Cyc_List_List*Cyc_Interface_add_aggrdecl(
...
_tmp1AF));_tmp1AF[0]=*d;_tmp1AF;});d->fields=0;if((void*)d->sc != (void*)4){(void*)(
...
_tmp1B5;});_tmp1B4;}),0);_tmp1B3->tl=tds;_tmp1B3;});}static unsigned char _tmp1B6[
2]="_";static struct _tagged_arr Cyc_Interface_us={_tmp1B6,_tmp1B6,_tmp1B6 + 2};
...
_tmp1B7=_cycalloc(sizeof(*_tmp1B7));_tmp1B7->f1=Cyc_Absyn_empty_tqual();_tmp1B7->f2=(
void*)({struct Cyc_Absyn_VarType_struct*_tmp1B8=_cycalloc(sizeof(*_tmp1B8));
_tmp1B8[0]=({struct Cyc_Absyn_VarType_struct _tmp1B9;_tmp1B9.tag=1;_tmp1B9.f1=({
struct Cyc_Absyn_Tvar*_tmp1BA=_cycalloc(sizeof(*_tmp1BA));_tmp1BA->name=Cyc_Interface_us_p;
_tmp1BA->identity=0;_tmp1BA->kind=(void*)((void*)({struct Cyc_Absyn_Eq_kb_struct*
_tmp1BB=_cycalloc(sizeof(*_tmp1BB));_tmp1BB[0]=({struct Cyc_Absyn_Eq_kb_struct
_tmp1BC;_tmp1BC.tag=0;_tmp1BC.f1=(void*)((void*)2);_tmp1BC;});_tmp1BB;}));
_tmp1BA;});_tmp1B9;});_tmp1B8;});_tmp1B7;});}static struct Cyc_Absyn_Tunionfield*
Cyc_Interface_rewrite_tunionfield(struct Cyc_Absyn_Tunionfield*f){f=({struct Cyc_Absyn_Tunionfield*
_tmp1BD=_cycalloc(sizeof(*_tmp1BD));_tmp1BD[0]=*f;_tmp1BD;});f->typs=((struct Cyc_List_List*(*)(
...
struct Cyc_List_List*)(d->fields)->v);_tmp1BF;});}if((void*)d->sc != (void*)4){(
void*)(d->sc=(void*)((void*)3));}return({struct Cyc_List_List*_tmp1C0=_cycalloc(
sizeof(*_tmp1C0));_tmp1C0->hd=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Tunion_d_struct*
...
_tmp1D1;struct Cyc_Absyn_Tunionfield*_tmp1D2;struct Cyc_Absyn_Tuniondecl*_tmp1D3;
struct Cyc_Tcdecl_Xtunionfielddecl*_tmp1D0=d;_tmp1D1=*_tmp1D0;_LL11C: _tmp1D3=
_tmp1D1.base;goto _LL11B;_LL11B: _tmp1D2=_tmp1D1.field;goto _LL11A;_LL11A: _tmp1D3=({
struct Cyc_Absyn_Tuniondecl*_tmp1D4=_cycalloc(sizeof(*_tmp1D4));_tmp1D4[0]=*
_tmp1D3;_tmp1D4;});_tmp1D3->fields=({struct Cyc_Core_Opt*_tmp1D5=_cycalloc(
sizeof(*_tmp1D5));_tmp1D5->v=({struct Cyc_List_List*_tmp1D6=_cycalloc(sizeof(*
_tmp1D6));_tmp1D6->hd=_tmp1D2;_tmp1D6->tl=0;_tmp1D6;});_tmp1D5;});(void*)(
_tmp1D3->sc=(void*)((void*)3));return({struct Cyc_List_List*_tmp1D7=_cycalloc(
sizeof(*_tmp1D7));_tmp1D7->hd=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Tunion_d_struct*
_tmp1D8=_cycalloc(sizeof(*_tmp1D8));_tmp1D8[0]=({struct Cyc_Absyn_Tunion_d_struct
_tmp1D9;_tmp1D9.tag=5;_tmp1D9.f1=_tmp1D3;_tmp1D9;});_tmp1D8;}),0);_tmp1D7->tl=
...
struct Cyc_Tcdecl_Xtunionfielddecl _tmp1DB;struct Cyc_Absyn_Tunionfield*_tmp1DC;
struct Cyc_Absyn_Tuniondecl*_tmp1DD;struct Cyc_Tcdecl_Xtunionfielddecl*_tmp1DA=d;
_tmp1DB=*_tmp1DA;_LL11F: _tmp1DD=_tmp1DB.base;goto _LL11E;_LL11E: _tmp1DC=_tmp1DB.field;
goto _LL11D;_LL11D: _tmp1DD=({struct Cyc_Absyn_Tuniondecl*_tmp1DE=_cycalloc(sizeof(*
_tmp1DE));_tmp1DE[0]=*_tmp1DD;_tmp1DE;});_tmp1DC=Cyc_Interface_rewrite_tunionfield(
_tmp1DC);(void*)(_tmp1DC->sc=(void*)((void*)3));_tmp1DD->fields=({struct Cyc_Core_Opt*
_tmp1DF=_cycalloc(sizeof(*_tmp1DF));_tmp1DF->v=({struct Cyc_List_List*_tmp1E0=
_cycalloc(sizeof(*_tmp1E0));_tmp1E0->hd=_tmp1DC;_tmp1E0->tl=0;_tmp1E0;});_tmp1DF;});(
void*)(_tmp1DD->sc=(void*)((void*)3));return({struct Cyc_List_List*_tmp1E1=
...
_tmp1E3;_tmp1E3.tag=5;_tmp1E3.f1=_tmp1DD;_tmp1E3;});_tmp1E2;}),0);_tmp1E1->tl=
...
sizeof(unsigned char),34),_tag_arr(_tmp1E8,sizeof(void*),0));});((void(*)(void(*
f)(struct Cyc_Std___cycFILE*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),
struct Cyc_Std___cycFILE*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_print_ns_headers,
f,i->imports);({void*_tmp1E9[0]={};Cyc_Std_fprintf(f,_tag_arr("\n/****** provided (headers) ******/\n",
sizeof(unsigned char),37),_tag_arr(_tmp1E9,sizeof(void*),0));});((void(*)(void(*
f)(struct Cyc_Std___cycFILE*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),
struct Cyc_Std___cycFILE*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_print_ns_headers,
f,i->exports);({void*_tmp1EA[0]={};Cyc_Std_fprintf(f,_tag_arr("\n/****** needed (headers of xtunionfielddecls) ******/\n",
sizeof(unsigned char),56),_tag_arr(_tmp1EA,sizeof(void*),0));});((void(*)(void(*
f)(struct Cyc_Std___cycFILE*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),
struct Cyc_Std___cycFILE*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_print_ns_xtunionfielddecl_headers,
f,i->imports);({void*_tmp1EB[0]={};Cyc_Std_fprintf(f,_tag_arr("\n/****** provided (headers of xtunionfielddecls) ******/\n",
sizeof(unsigned char),58),_tag_arr(_tmp1EB,sizeof(void*),0));});((void(*)(void(*
f)(struct Cyc_Std___cycFILE*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),
struct Cyc_Std___cycFILE*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_print_ns_xtunionfielddecl_headers,
f,i->exports);({void*_tmp1EC[0]={};Cyc_Std_fprintf(f,_tag_arr("\n/****** provided (typedefs) ******/\n",
sizeof(unsigned char),38),_tag_arr(_tmp1EC,sizeof(void*),0));});((void(*)(void(*
f)(struct Cyc_Std___cycFILE*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),
struct Cyc_Std___cycFILE*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_print_ns_typedefs,
f,i->exports);({void*_tmp1ED[0]={};Cyc_Std_fprintf(f,_tag_arr("\n/****** needed (declarations) ******/\n",
sizeof(unsigned char),40),_tag_arr(_tmp1ED,sizeof(void*),0));});((void(*)(void(*
f)(struct Cyc_Std___cycFILE*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),
struct Cyc_Std___cycFILE*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_print_ns_decls,
f,i->imports);({void*_tmp1EE[0]={};Cyc_Std_fprintf(f,_tag_arr("\n/****** provided (declarations) ******/\n",
sizeof(unsigned char),42),_tag_arr(_tmp1EE,sizeof(void*),0));});((void(*)(void(*
f)(struct Cyc_Std___cycFILE*,struct Cyc_List_List*,struct Cyc_Interface_Ienv*),
struct Cyc_Std___cycFILE*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_print_ns_decls,
f,i->exports);}struct Cyc_Interface_I*Cyc_Interface_parse(struct Cyc_Std___cycFILE*
f){Cyc_Lex_lex_init();{struct Cyc_List_List*_tmp1EF=Cyc_Parse_parse_file(f);
struct Cyc_Tcenv_Tenv*_tmp1F0=Cyc_Tcenv_tc_init();Cyc_Tc_tc(_tmp1F0,0,_tmp1EF);
return Cyc_Interface_gen_extract(_tmp1F0->ae,0);}}void Cyc_Interface_save(struct
Cyc_Interface_I*i,struct Cyc_Std___cycFILE*f){Cyc_Interface_print(i,f);}struct Cyc_Interface_I*
Cyc_Interface_load(struct Cyc_Std___cycFILE*f){return Cyc_Interface_parse(f);}
