...
Cyc_Core_identity(void*);extern unsigned char Cyc_Core_Invalid_argument[21];struct
Cyc_Core_Invalid_argument_struct{unsigned char*tag;struct _tagged_arr f1;};extern
unsigned char Cyc_Core_Failure[12];struct Cyc_Core_Failure_struct{unsigned char*
tag;struct _tagged_arr f1;};extern unsigned char Cyc_Core_Impossible[15];struct Cyc_Core_Impossible_struct{
...
struct Cyc_List_List*);struct Cyc_Absyn_Tqual Cyc_Absyn_empty_tqual();extern void*
...
void*Cyc_Absyn_tagged_typ(void*t,void*rgn,struct Cyc_Absyn_Tqual tq);struct Cyc_Absyn_Decl*
Cyc_Absyn_new_decl(void*r,struct Cyc_Position_Segment*loc);struct Cyc_Absyn_Vardecl*
Cyc_Absyn_new_vardecl(struct _tuple0*x,void*t,struct Cyc_Absyn_Exp*init);void*Cyc_Absyn_function_typ(
...
unsigned char Cyc_Dict_Absent[11];struct Cyc_Dict_Dict*Cyc_Dict_empty(int(*cmp)(
void*,void*));int Cyc_Dict_member(struct Cyc_Dict_Dict*d,void*k);struct Cyc_Dict_Dict*
Cyc_Dict_insert(struct Cyc_Dict_Dict*d,void*k,void*v);void*Cyc_Dict_lookup(struct
Cyc_Dict_Dict*d,void*k);void*Cyc_Dict_fold(void*(*f)(void*,void*,void*),struct
Cyc_Dict_Dict*d,void*accum);void Cyc_Dict_iter_c(void(*f)(void*,void*,void*),void*
env,struct Cyc_Dict_Dict*d);struct Cyc_Dict_Dict*Cyc_Dict_map(void*(*f)(void*),
...
lex_trans;struct _tagged_arr lex_check;};struct Cyc_List_List*Cyc_Parse_parse_file(
struct Cyc_Std___cycFILE*f);struct Cyc_Declaration_spec;struct Cyc_Declarator;
struct Cyc_Abstractdeclarator;int Cyc_yyparse();extern unsigned char Cyc_AbstractDeclarator_tok[
...
int last_column;};int Cyc_Std_strptrcmp(struct _tagged_arr*s1,struct _tagged_arr*s2);
int Cyc_Std_zstrptrcmp(struct _tagged_arr*,struct _tagged_arr*);void Cyc_Tcutil_terr(
struct Cyc_Position_Segment*,struct _tagged_arr fmt,struct _tagged_arr ap);void*Cyc_Tcutil_compress(
void*t);int Cyc_Tcutil_is_function_type(void*t);extern unsigned char Cyc_Tcdecl_Incompatible[
...
_tmp10));_tmp10->f1=0;_tmp10->f2=Cyc_Absyn_empty_tqual();_tmp10->f3=Cyc_Absyn_uint_typ;
...
_tag_arr("type",sizeof(unsigned char),5),d->name,(void*)((struct Cyc_Absyn_Aggrfield*)
...
_tag_arr("variable",sizeof(unsigned char),9),d->name,(void*)d->type);}static
struct Cyc_List_List*Cyc_Interface_get_abs_ns(void*ns){void*_tmp3C=ns;struct Cyc_List_List*
_tmp3D;_LLB: if(_tmp3C <= (void*)1?1:*((int*)_tmp3C)!= 1)goto _LLD;_tmp3D=((struct
Cyc_Absyn_Abs_n_struct*)_tmp3C)->f1;_LLC: return _tmp3D;_LLD:;_LLE:((int(*)(struct
...
struct Cyc_Absyn_FnInfo _tmp45;void*_tmp46;struct Cyc_List_List*_tmp47;struct Cyc_Absyn_VarargInfo*
_tmp48;struct Cyc_List_List*_tmp49;struct Cyc_Absyn_AggrInfo _tmp4A;void*_tmp4B;
struct Cyc_List_List*_tmp4C;struct _tuple0*_tmp4D;struct Cyc_Absyn_TunionInfo _tmp4E;
void*_tmp4F;struct Cyc_Absyn_Tuniondecl**_tmp50;struct Cyc_Absyn_Tuniondecl*_tmp51;
struct Cyc_List_List*_tmp52;struct Cyc_Absyn_TunionFieldInfo _tmp53;void*_tmp54;
struct Cyc_Absyn_Tuniondecl*_tmp55;struct Cyc_Absyn_Tunionfield*_tmp56;struct Cyc_List_List*
_tmp57;_LL10: if(_tmp3E <= (void*)3?1:*((int*)_tmp3E)!= 4)goto _LL12;_tmp3F=((
struct Cyc_Absyn_PointerType_struct*)_tmp3E)->f1;_tmp40=(void*)_tmp3F.elt_typ;
_LL11: _tmp41=_tmp40;goto _LL13;_LL12: if(_tmp3E <= (void*)3?1:*((int*)_tmp3E)!= 7)
goto _LL14;_tmp41=(void*)((struct Cyc_Absyn_ArrayType_struct*)_tmp3E)->f1;_LL13:
_tmp44=_tmp41;goto _LL15;_LL14: if(_tmp3E <= (void*)3?1:*((int*)_tmp3E)!= 16)goto
_LL16;_tmp42=((struct Cyc_Absyn_TypedefType_struct*)_tmp3E)->f4;if(_tmp42 == 0)
...
obj,name,_tag_arr("type",sizeof(unsigned char),5),_tmp5A->name);return 0;}return
Cyc_Interface_check_public_type_list(ae,seen,obj,name,Cyc_Core_identity,_tmp4C)?
Cyc_Interface_check_public_aggrdecl(ae,seen,_tmp5A): 0;}_LL1C: if(_tmp3E <= (void*)
3?1:*((int*)_tmp3E)!= 12)goto _LL1E;_tmp4D=((struct Cyc_Absyn_EnumType_struct*)
_tmp3E)->f1;_LL1D: {struct _tuple0 _tmp5C;void*_tmp5D;struct _tagged_arr*_tmp5E;
struct _tuple0*_tmp5B=_tmp4D;_tmp5C=*_tmp5B;_tmp5D=_tmp5C.f1;_tmp5E=_tmp5C.f2;{
struct Cyc_List_List*_tmp5F=Cyc_Interface_get_abs_ns(_tmp5D);struct Cyc_Absyn_Enumdecl*
ed;{struct _handler_cons _tmp60;_push_handler(& _tmp60);{int _tmp62=0;if(setjmp(
_tmp60.handler))_tmp62=1;if(!_tmp62){{struct Cyc_Tcenv_Genv*_tmp63=((struct Cyc_Tcenv_Genv*(*)(
struct Cyc_Dict_Dict*d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ae,_tmp5F);ed=*((
struct Cyc_Absyn_Enumdecl**(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k))Cyc_Dict_lookup)(
_tmp63->enumdecls,_tmp5E);};_pop_handler();}else{void*_tmp61=(void*)_exn_thrown;
void*_tmp65=_tmp61;_LL25: if(_tmp65 != Cyc_Dict_Absent)goto _LL27;_LL26:((int(*)(
...
sizeof(unsigned char),39),_tag_arr(_tmp66,sizeof(void*),1));}}));_LL27:;_LL28:(
void)_throw(_tmp65);_LL24:;}}}if((void*)ed->sc == (void*)0){Cyc_Interface_static_err(
obj,_tmp4D,_tag_arr("enum",sizeof(unsigned char),5),ed->name);return 0;}return 1;}}
_LL1E: if(_tmp3E <= (void*)3?1:*((int*)_tmp3E)!= 2)goto _LL20;_tmp4E=((struct Cyc_Absyn_TunionType_struct*)
_tmp3E)->f1;_tmp4F=(void*)_tmp4E.tunion_info;if(*((int*)_tmp4F)!= 1)goto _LL20;
_tmp50=((struct Cyc_Absyn_KnownTunion_struct*)_tmp4F)->f1;_tmp51=*_tmp50;_tmp52=
_tmp4E.targs;_LL1F: {struct _tuple0 _tmp69;void*_tmp6A;struct _tagged_arr*_tmp6B;
struct _tuple0*_tmp68=_tmp51->name;_tmp69=*_tmp68;_tmp6A=_tmp69.f1;_tmp6B=_tmp69.f2;{
struct Cyc_List_List*_tmp6C=Cyc_Interface_get_abs_ns(_tmp6A);struct Cyc_Absyn_Tuniondecl*
tud;{struct _handler_cons _tmp6D;_push_handler(& _tmp6D);{int _tmp6F=0;if(setjmp(
_tmp6D.handler))_tmp6F=1;if(!_tmp6F){{struct Cyc_Tcenv_Genv*_tmp70=((struct Cyc_Tcenv_Genv*(*)(
...
_tag_arr(_tmp73,sizeof(void*),1));}}));_LL2C:;_LL2D:(void)_throw(_tmp72);_LL29:;}}}
if((void*)tud->sc == (void*)0){Cyc_Interface_static_err(obj,name,_tag_arr("[x]tunion",
sizeof(unsigned char),10),tud->name);return 0;}return Cyc_Interface_check_public_type_list(
...
sizeof(unsigned char),66),_tag_arr(_tmp80,sizeof(void*),1));}}));_LL31:;_LL32:(
void)_throw(_tmp7F);_LL2E:;}}}if(tud->fields == 0)((int(*)(struct _tagged_arr s))
Cyc_Interface_invalid_arg)((struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmp83;_tmp83.tag=0;_tmp83.f1=(struct _tagged_arr)Cyc_Absynpp_qvar2string(tud->name);{
void*_tmp82[1]={& _tmp83};Cyc_Std_aprintf(_tag_arr("check_public_type ([x]tunion %s has no fields)",
...
Cyc_Core_identity,_tmp57)?Cyc_Interface_check_public_tuniondecl(ae,seen,tud): 0;}}}}
_LL22:;_LL23: return 1;_LLF:;}struct _tuple17{struct Cyc_Interface_Ienv*f1;struct Cyc_Interface_Ienv*
...
_tagged_arr*x,struct Cyc_Absyn_Aggrdecl**dp){struct _tuple17 _tmp8A;struct Cyc_Interface_Ienv*
_tmp8B;struct Cyc_Interface_Ienv*_tmp8C;int _tmp8D;struct Cyc_Dict_Dict*_tmp8E;
struct Cyc_Interface_Seen*_tmp8F;struct _tuple17*_tmp89=env;_tmp8A=*_tmp89;_tmp8B=
_tmp8A.f1;_tmp8C=_tmp8A.f2;_tmp8D=_tmp8A.f3;_tmp8E=_tmp8A.f4;_tmp8F=_tmp8A.f5;{
struct Cyc_Absyn_Aggrdecl*_tmp90=*dp;void*_tmp91=(void*)_tmp90->sc;_LL34: if((int)
_tmp91 != 0)goto _LL36;_LL35: if(_tmp8D?_tmp90->impl == 0: 0)Cyc_Interface_fields_err(
_tag_arr("static",sizeof(unsigned char),7),_tag_arr("struct/union",sizeof(
unsigned char),13),_tmp90->name);goto _LL33;_LL36: if((int)_tmp91 != 1)goto _LL38;
_LL37: if(_tmp90->impl == 0){if(_tmp8D)Cyc_Interface_fields_err(_tag_arr("abstract",
sizeof(unsigned char),9),_tag_arr("struct/union",sizeof(unsigned char),13),
_tmp90->name);}else{_tmp90=({struct Cyc_Absyn_Aggrdecl*_tmp92=_cycalloc(sizeof(*
_tmp92));_tmp92[0]=*_tmp90;_tmp92;});_tmp90->impl=0;}if(Cyc_Interface_check_public_aggrdecl(
_tmp8E,_tmp8F,_tmp90))_tmp8C->aggrdecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Aggrdecl*v))Cyc_Dict_insert)(_tmp8C->aggrdecls,
x,_tmp90);goto _LL33;_LL38: if((int)_tmp91 != 2)goto _LL3A;_LL39: if(_tmp90->impl == 0){
Cyc_Interface_fields_err(_tag_arr("public",sizeof(unsigned char),7),_tag_arr("struct/union",
sizeof(unsigned char),13),_tmp90->name);_tmp90=({struct Cyc_Absyn_Aggrdecl*_tmp93=
...
4)goto _LL3C;_LL3B: goto _LL3D;_LL3C: if((int)_tmp91 != 3)goto _LL3E;_LL3D: if(Cyc_Interface_check_public_aggrdecl(
...
x,_tmp90);goto _LL33;_LL3E: if((int)_tmp91 != 5)goto _LL33;_LL3F:((int(*)(struct
_tagged_arr s))Cyc_Interface_invalid_arg)(_tag_arr("add_aggrdecl",sizeof(
unsigned char),13));goto _LL33;_LL33:;}}static void Cyc_Interface_extract_enumdecl(
struct _tuple17*env,struct _tagged_arr*x,struct Cyc_Absyn_Enumdecl**dp){struct
_tuple17 _tmp95;struct Cyc_Interface_Ienv*_tmp96;struct Cyc_Interface_Ienv*_tmp97;
int _tmp98;struct Cyc_Dict_Dict*_tmp99;struct Cyc_Interface_Seen*_tmp9A;struct
_tuple17*_tmp94=env;_tmp95=*_tmp94;_tmp96=_tmp95.f1;_tmp97=_tmp95.f2;_tmp98=
_tmp95.f3;_tmp99=_tmp95.f4;_tmp9A=_tmp95.f5;{struct Cyc_Absyn_Enumdecl*_tmp9B=*dp;
void*_tmp9C=(void*)_tmp9B->sc;_LL41: if((int)_tmp9C != 0)goto _LL43;_LL42: if(_tmp98?
_tmp9B->fields == 0: 0)Cyc_Interface_fields_err(_tag_arr("static",sizeof(
unsigned char),7),_tag_arr("enum",sizeof(unsigned char),5),_tmp9B->name);goto
_LL40;_LL43: if((int)_tmp9C != 1)goto _LL45;_LL44: if(_tmp9B->fields == 0){if(_tmp98)
Cyc_Interface_fields_err(_tag_arr("abstract",sizeof(unsigned char),9),_tag_arr("enum",
sizeof(unsigned char),5),_tmp9B->name);}else{_tmp9B=({struct Cyc_Absyn_Enumdecl*
_tmp9D=_cycalloc(sizeof(*_tmp9D));_tmp9D[0]=*_tmp9B;_tmp9D;});_tmp9B->fields=0;}
...
v))Cyc_Dict_insert)(_tmp97->enumdecls,x,_tmp9B);goto _LL40;_LL45: if((int)_tmp9C != 
2)goto _LL47;_LL46: if(_tmp9B->fields == 0){Cyc_Interface_fields_err(_tag_arr("public",
sizeof(unsigned char),7),_tag_arr("enum",sizeof(unsigned char),5),_tmp9B->name);
_tmp9B=({struct Cyc_Absyn_Enumdecl*_tmp9E=_cycalloc(sizeof(*_tmp9E));_tmp9E[0]=*
_tmp9B;_tmp9E;});(void*)(_tmp9B->sc=(void*)((void*)1));}if(Cyc_Interface_check_public_enumdecl(
_tmp99,_tmp9A,_tmp9B))_tmp97->enumdecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Enumdecl*v))Cyc_Dict_insert)(_tmp97->enumdecls,
x,_tmp9B);goto _LL40;_LL47: if((int)_tmp9C != 4)goto _LL49;_LL48: goto _LL4A;_LL49: if((
int)_tmp9C != 3)goto _LL4B;_LL4A: if(Cyc_Interface_check_public_enumdecl(_tmp99,
_tmp9A,_tmp9B))_tmp96->enumdecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,
struct _tagged_arr*k,struct Cyc_Absyn_Enumdecl*v))Cyc_Dict_insert)(_tmp96->enumdecls,
x,_tmp9B);goto _LL40;_LL4B: if((int)_tmp9C != 5)goto _LL40;_LL4C:((int(*)(struct
_tagged_arr s))Cyc_Interface_invalid_arg)(_tag_arr("add_enumdecl",sizeof(
unsigned char),13));goto _LL40;_LL40:;}}static void Cyc_Interface_extract_xtunionfielddecl(
...
_tmpA1;struct Cyc_List_List*_tmpA2;_LL4E: if(_tmpA0 <= (void*)1?1:*((int*)_tmpA0)!= 
0)goto _LL50;_tmpA1=((struct Cyc_Absyn_Rel_n_struct*)_tmpA0)->f1;_LL4F: _tmpA2=
_tmpA1;goto _LL51;_LL50: if(_tmpA0 <= (void*)1?1:*((int*)_tmpA0)!= 1)goto _LL52;
_tmpA2=((struct Cyc_Absyn_Abs_n_struct*)_tmpA0)->f1;_LL51: _tmp9F=_tmpA2;goto _LL4D;
_LL52:;_LL53: goto _LL4D;_LL4D:;}{struct Cyc_Dict_Dict**dict;{void*_tmpA3=(void*)f->sc;
_LL55: if((int)_tmpA3 != 0)goto _LL57;_LL56: return;_LL57: if((int)_tmpA3 != 3)goto
_LL59;_LL58: dict=& i->imports;goto _LL54;_LL59: if((int)_tmpA3 != 2)goto _LL5B;_LL5A:
dict=& i->exports;goto _LL54;_LL5B:;_LL5C:((int(*)(struct _tagged_arr s))Cyc_Interface_invalid_arg)(
_tag_arr("add_xtunionfielddecl",sizeof(unsigned char),21));_LL54:;}{struct Cyc_Interface_Ienv*
...
_pop_handler();}else{void*_tmpA5=(void*)_exn_thrown;void*_tmpA8=_tmpA5;_LL5E: if(
_tmpA8 != Cyc_Dict_Absent)goto _LL60;_LL5F: env=Cyc_Interface_new_ienv();*dict=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct Cyc_List_List*k,struct Cyc_Interface_Ienv*
v))Cyc_Dict_insert)(*dict,_tmp9F,env);goto _LL5D;_LL60:;_LL61:(void)_throw(_tmpA8);
...
_tmpB2=*dp;void*_tmpB3=(void*)_tmpB2->sc;_LL63: if((int)_tmpB3 != 0)goto _LL65;
_LL64: if((!_tmpB2->is_xtunion?_tmpAE: 0)?_tmpB2->fields == 0: 0)Cyc_Interface_fields_err(
_tag_arr("static",sizeof(unsigned char),7),_tag_arr("tunion",sizeof(
unsigned char),7),_tmpB2->name);goto _LL62;_LL65: if((int)_tmpB3 != 1)goto _LL67;
_LL66: if(_tmpB2->fields == 0){if(!_tmpB2->is_xtunion?_tmpAE: 0)Cyc_Interface_fields_err(
_tag_arr("abstract",sizeof(unsigned char),9),_tag_arr("tunion",sizeof(
unsigned char),7),_tmpB2->name);}else{_tmpB2=({struct Cyc_Absyn_Tuniondecl*_tmpB4=
_cycalloc(sizeof(*_tmpB4));_tmpB4[0]=*_tmpB2;_tmpB4;});_tmpB2->fields=0;}if(Cyc_Interface_check_public_tuniondecl(
_tmpAF,_tmpB0,_tmpB2))_tmpAD->tuniondecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Tuniondecl*v))Cyc_Dict_insert)(_tmpAD->tuniondecls,
x,_tmpB2);goto _LL62;_LL67: if((int)_tmpB3 != 2)goto _LL69;_LL68: _tmpB2=({struct Cyc_Absyn_Tuniondecl*
_tmpB5=_cycalloc(sizeof(*_tmpB5));_tmpB5[0]=*_tmpB2;_tmpB5;});if(!_tmpB2->is_xtunion?
_tmpB2->fields == 0: 0){Cyc_Interface_fields_err(_tag_arr("public",sizeof(
unsigned char),7),_tag_arr("tunion",sizeof(unsigned char),7),_tmpB2->name);(void*)(
_tmpB2->sc=(void*)((void*)1));}if(Cyc_Interface_check_public_tuniondecl(_tmpAF,
_tmpB0,_tmpB2)){if(_tmpB2->is_xtunion?_tmpB2->fields != 0: 0){struct Cyc_List_List*
_tmpB6=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmpB2->fields))->v;
_tmpB2->fields=0;{struct Cyc_List_List*_tmpB7=_tmpB6;for(0;_tmpB7 != 0;_tmpB7=
_tmpB7->tl){Cyc_Interface_extract_xtunionfielddecl(_tmpB1,_tmpB2,(struct Cyc_Absyn_Tunionfield*)
_tmpB7->hd);}}}_tmpAD->tuniondecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Tuniondecl*v))Cyc_Dict_insert)(_tmpAD->tuniondecls,
x,_tmpB2);}goto _LL62;_LL69: if((int)_tmpB3 != 4)goto _LL6B;_LL6A:((int(*)(struct
_tagged_arr s))Cyc_Interface_invalid_arg)(_tag_arr("extract_tuniondecl",sizeof(
unsigned char),19));_LL6B: if((int)_tmpB3 != 3)goto _LL6D;_LL6C: if(Cyc_Interface_check_public_tuniondecl(
_tmpAF,_tmpB0,_tmpB2)){if(_tmpB2->is_xtunion?_tmpB2->fields != 0: 0){_tmpB2=({
struct Cyc_Absyn_Tuniondecl*_tmpB8=_cycalloc(sizeof(*_tmpB8));_tmpB8[0]=*_tmpB2;
_tmpB8;});{struct Cyc_List_List*_tmpB9=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)
_check_null(_tmpB2->fields))->v;_tmpB2->fields=0;{struct Cyc_List_List*_tmpBA=
_tmpB9;for(0;_tmpBA != 0;_tmpBA=_tmpBA->tl){Cyc_Interface_extract_xtunionfielddecl(
_tmpB1,_tmpB2,(struct Cyc_Absyn_Tunionfield*)_tmpBA->hd);}}}}_tmpAC->tuniondecls=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,struct Cyc_Absyn_Tuniondecl*
v))Cyc_Dict_insert)(_tmpAC->tuniondecls,x,_tmpB2);}goto _LL62;_LL6D: if((int)
_tmpB3 != 5)goto _LL62;_LL6E:((int(*)(struct _tagged_arr s))Cyc_Interface_invalid_arg)(
_tag_arr("add_tuniondecl",sizeof(unsigned char),15));goto _LL62;_LL62:;}}static
void Cyc_Interface_extract_typedef(struct _tuple17*env,struct _tagged_arr*x,struct
Cyc_Absyn_Typedefdecl*d){struct _tuple17 _tmpBC;struct Cyc_Interface_Ienv*_tmpBD;
struct Cyc_Dict_Dict*_tmpBE;struct Cyc_Interface_Seen*_tmpBF;struct _tuple17*_tmpBB=
env;_tmpBC=*_tmpBB;_tmpBD=_tmpBC.f2;_tmpBE=_tmpBC.f4;_tmpBF=_tmpBC.f5;if(Cyc_Interface_check_public_typedefdecl(
_tmpBE,_tmpBF,d))_tmpBD->typedefdecls=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,struct Cyc_Absyn_Typedefdecl*v))Cyc_Dict_insert)(_tmpBD->typedefdecls,
...
void*_tmpC7=(*v).f1;void*_tmpC8=_tmpC7;void*_tmpC9;_LL70: if(*((int*)_tmpC8)!= 0)
goto _LL72;_tmpC9=(void*)((struct Cyc_Tcenv_VarRes_struct*)_tmpC8)->f1;_LL71:{void*
_tmpCA=_tmpC9;struct Cyc_Absyn_Fndecl*_tmpCB;struct Cyc_Absyn_Vardecl*_tmpCC;_LL75:
if(_tmpCA <= (void*)1?1:*((int*)_tmpCA)!= 1)goto _LL77;_tmpCB=((struct Cyc_Absyn_Funname_b_struct*)
_tmpCA)->f1;_LL76: {struct Cyc_Absyn_Vardecl*_tmpCD=({struct Cyc_Absyn_Vardecl*
...
0;_tmpCE->escapes=0;_tmpCE;});_tmpC4=0;_tmpCC=_tmpCD;goto _LL78;}_LL77: if(_tmpCA
<= (void*)1?1:*((int*)_tmpCA)!= 0)goto _LL79;_tmpCC=((struct Cyc_Absyn_Global_b_struct*)
_tmpCA)->f1;_LL78: if(_tmpCC->initializer != 0){_tmpCC=({struct Cyc_Absyn_Vardecl*
_tmpD0=_cycalloc(sizeof(*_tmpD0));_tmpD0[0]=*_tmpCC;_tmpD0;});_tmpCC->initializer=
0;}{void*_tmpD1=(void*)_tmpCC->sc;_LL7C: if((int)_tmpD1 != 0)goto _LL7E;_LL7D: if(
_tmpC4?Cyc_Tcutil_is_function_type((void*)_tmpCC->type): 0)Cyc_Interface_body_err(
_tag_arr("static",sizeof(unsigned char),7),_tmpCC->name);goto _LL7B;_LL7E: if((int)
_tmpD1 != 5)goto _LL80;_LL7F: goto _LL81;_LL80: if((int)_tmpD1 != 1)goto _LL82;_LL81:((
int(*)(struct _tagged_arr s))Cyc_Interface_invalid_arg)(_tag_arr("extract_ordinarie",
sizeof(unsigned char),18));_LL82: if((int)_tmpD1 != 2)goto _LL84;_LL83: if(_tmpC4?
Cyc_Tcutil_is_function_type((void*)_tmpCC->type): 0)Cyc_Interface_body_err(
_tag_arr("public",sizeof(unsigned char),7),_tmpCC->name);if(Cyc_Interface_check_public_vardecl(
...
x,_tmpCC);goto _LL7B;_LL84: if((int)_tmpD1 != 4)goto _LL86;_LL85: goto _LL87;_LL86: if((
int)_tmpD1 != 3)goto _LL7B;_LL87: if(Cyc_Interface_check_public_vardecl(_tmpC5,
...
x,_tmpCC);goto _LL7B;_LL7B:;}goto _LL74;_LL79:;_LL7A: goto _LL74;_LL74:;}goto _LL6F;
...
void*_tmpDC[1]={& _tmpDD};Cyc_Tcdecl_merr(0,msg1,_tag_arr("%s",sizeof(
unsigned char),3),_tag_arr(_tmpDC,sizeof(void*),1));}});}struct _tuple19{int f1;
...
_tuple19*env,struct _tagged_arr*x,void*y1){struct _tuple19 _tmpDF;int _tmpE0;int*
_tmpE1;struct Cyc_Dict_Dict*_tmpE2;int(*_tmpE3)(void*,void*,struct _tagged_arr*);
struct _tagged_arr _tmpE4;struct _tagged_arr*_tmpE5;struct _tuple19*_tmpDE=env;
_tmpDF=*_tmpDE;_tmpE0=_tmpDF.f1;_tmpE1=(int*)&(*_tmpDE).f1;_tmpE2=_tmpDF.f2;
_tmpE3=_tmpDF.f3;_tmpE4=_tmpDF.f4;_tmpE5=_tmpDF.f5;{struct _handler_cons _tmpE6;
_push_handler(& _tmpE6);{int _tmpE8=0;if(setjmp(_tmpE6.handler))_tmpE8=1;if(!
_tmpE8){{void*_tmpE9=((void*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k))Cyc_Dict_lookup)(
_tmpE2,x);if(!_tmpE3(y1,_tmpE9,_tmpE5))*_tmpE1=0;};_pop_handler();}else{void*
_tmpE7=(void*)_exn_thrown;void*_tmpEB=_tmpE7;_LL89: if(_tmpEB != Cyc_Dict_Absent)
goto _LL8B;_LL8A: Cyc_Interface_check_err(_tmpE5,(struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmpEE;_tmpEE.tag=0;_tmpEE.f1=(struct _tagged_arr)*x;{struct Cyc_Std_String_pa_struct
_tmpED;_tmpED.tag=0;_tmpED.f1=(struct _tagged_arr)_tmpE4;{void*_tmpEC[2]={& _tmpED,&
_tmpEE};Cyc_Std_aprintf(_tag_arr("%s %s is missing",sizeof(unsigned char),17),
_tag_arr(_tmpEC,sizeof(void*),2));}}}));*_tmpE1=0;goto _LL88;_LL8B:;_LL8C:(void)
_throw(_tmpEB);_LL88:;}}}}static int Cyc_Interface_incl_dict(struct Cyc_Dict_Dict*
dic1,struct Cyc_Dict_Dict*dic2,int(*incl_f)(void*,void*,struct _tagged_arr*),
struct _tagged_arr t,struct _tagged_arr*msg){struct _tuple19 _tmpEF=({struct _tuple19
_tmpF0;_tmpF0.f1=1;_tmpF0.f2=dic2;_tmpF0.f3=incl_f;_tmpF0.f4=t;_tmpF0.f5=msg;
_tmpF0;});((void(*)(void(*f)(struct _tuple19*,struct _tagged_arr*,void*),struct
_tuple19*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Interface_incl_dict_f,&
...
struct _tuple20{int f1;struct Cyc_Dict_Dict*f2;struct _tagged_arr*f3;};static void Cyc_Interface_incl_ns_f(
struct _tuple20*env,struct Cyc_List_List*ns,struct Cyc_Interface_Ienv*ie1){struct
_tuple20 _tmp10A;int _tmp10B;int*_tmp10C;struct Cyc_Dict_Dict*_tmp10D;struct
_tagged_arr*_tmp10E;struct _tuple20*_tmp109=env;_tmp10A=*_tmp109;_tmp10B=_tmp10A.f1;
_tmp10C=(int*)&(*_tmp109).f1;_tmp10D=_tmp10A.f2;_tmp10E=_tmp10A.f3;{struct Cyc_Interface_Ienv*
ie2;{struct _handler_cons _tmp10F;_push_handler(& _tmp10F);{int _tmp111=0;if(setjmp(
...
_pop_handler();}else{void*_tmp110=(void*)_exn_thrown;void*_tmp113=_tmp110;_LL8E:
if(_tmp113 != Cyc_Dict_Absent)goto _LL90;_LL8F: ie2=Cyc_Interface_lazy_new_ienv();
goto _LL8D;_LL90:;_LL91:(void)_throw(_tmp113);_LL8D:;}}}if(!Cyc_Interface_incl_ienv(
...
sizeof(unsigned char),50),_tag_arr(_tmp11B,sizeof(void*),2));}}});_tmp11A;});if(
!Cyc_Interface_incl_ns(i1->exports,i2->exports,msg))_tmp119=0;if(info != 0)msg=({
struct _tagged_arr*_tmp11E=_cycalloc(sizeof(*_tmp11E));_tmp11E[0]=(struct
...
sizeof(unsigned char),50),_tag_arr(_tmp11F,sizeof(void*),2));}}});_tmp11E;});if(
!Cyc_Interface_incl_ns(i2->imports,i1->imports,msg))_tmp119=0;{int _tmp122=
_tmp119;_npop_handler(0);return _tmp122;}};_pop_handler();}else{void*_tmp117=(
void*)_exn_thrown;void*_tmp124=_tmp117;_LL93: if(_tmp124 != Cyc_Tcdecl_Incompatible)
goto _LL95;_LL94: return 0;_LL95:;_LL96:(void)_throw(_tmp124);_LL92:;}}}struct
_tuple21{int f1;struct Cyc_Dict_Dict*f2;struct Cyc_Dict_Dict*f3;struct Cyc_Dict_Dict*
...
struct _tuple21*env,struct _tagged_arr*x,void*y2){struct _tuple21 _tmp126;int _tmp127;
int*_tmp128;struct Cyc_Dict_Dict*_tmp129;struct Cyc_Dict_Dict**_tmp12A;struct Cyc_Dict_Dict*
_tmp12B;struct Cyc_Dict_Dict*_tmp12C;void*(*_tmp12D)(void*,void*,struct Cyc_Position_Segment*,
struct _tagged_arr*);struct _tagged_arr _tmp12E;struct _tagged_arr*_tmp12F;struct
_tuple21*_tmp125=env;_tmp126=*_tmp125;_tmp127=_tmp126.f1;_tmp128=(int*)&(*
_tmp125).f1;_tmp129=_tmp126.f2;_tmp12A=(struct Cyc_Dict_Dict**)&(*_tmp125).f2;
_tmp12B=_tmp126.f3;_tmp12C=_tmp126.f4;_tmp12D=_tmp126.f5;_tmp12E=_tmp126.f6;
_tmp12F=_tmp126.f7;{void*y;{struct _handler_cons _tmp130;_push_handler(& _tmp130);{
int _tmp132=0;if(setjmp(_tmp130.handler))_tmp132=1;if(!_tmp132){{void*_tmp133=((
void*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k))Cyc_Dict_lookup)(_tmp12B,x);
void*_tmp134=_tmp12D(_tmp133,y2,0,_tmp12F);if(!((unsigned int)_tmp134)){*_tmp128=
0;_npop_handler(0);return;}y=(void*)_check_null(_tmp134);};_pop_handler();}else{
void*_tmp131=(void*)_exn_thrown;void*_tmp136=_tmp131;_LL98: if(_tmp136 != Cyc_Dict_Absent)
goto _LL9A;_LL99: y=y2;goto _LL97;_LL9A:;_LL9B:(void)_throw(_tmp136);_LL97:;}}}{
...
49),_tag_arr(_tmp13C,sizeof(void*),2));}}}));*_tmp128=0;}};_pop_handler();}else{
void*_tmp138=(void*)_exn_thrown;void*_tmp140=_tmp138;_LL9D: if(_tmp140 != Cyc_Dict_Absent)
goto _LL9F;_LL9E: if(*_tmp128)*_tmp12A=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,void*v))Cyc_Dict_insert)(*_tmp12A,x,y);goto _LL9C;_LL9F:;
_LLA0:(void)_throw(_tmp140);_LL9C:;}}}}}struct Cyc_Core_Opt*Cyc_Interface_compat_merge_dict(
...
_tmp149->v;_tmp14A;});}struct _tuple22{int f1;struct Cyc_Dict_Dict*f2;struct Cyc_Dict_Dict*
...
_tmp155;_LLA2: if(_tmp158 != Cyc_Dict_Absent)goto _LLA4;_LLA3: iexcl=Cyc_Interface_lazy_new_ienv();
goto _LLA1;_LLA4:;_LLA5:(void)_throw(_tmp158);_LLA1:;}}}{struct _handler_cons
...
_tmp15E=_tmp15A;_LLA7: if(_tmp15E != Cyc_Dict_Absent)goto _LLA9;_LLA8: ie1=Cyc_Interface_lazy_new_ienv();
goto _LLA6;_LLA9:;_LLAA:(void)_throw(_tmp15E);_LLA6:;}}}{struct Cyc_Interface_Ienv*
...
_tmp16C,sizeof(void*),2));}}}));*_tmp166=0;}else{if(*_tmp166)*_tmp168=((struct
Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,void*v))Cyc_Dict_insert)(*
_tmp168,x,y);}}struct Cyc_Core_Opt*Cyc_Interface_disj_merge_dict(struct Cyc_Dict_Dict*
dic1,struct Cyc_Dict_Dict*dic2,struct _tagged_arr t,struct _tagged_arr*msg){struct
_tuple23 _tmp16F=({struct _tuple23 _tmp171;_tmp171.f1=1;_tmp171.f2=dic1;_tmp171.f3=
dic1;_tmp171.f4=t;_tmp171.f5=msg;_tmp171;});((void(*)(void(*f)(struct _tuple23*,
...
_exn_thrown;void*_tmp185=_tmp182;_LLAC: if(_tmp185 != Cyc_Dict_Absent)goto _LLAE;
_LLAD: ie1=Cyc_Interface_lazy_new_ienv();goto _LLAB;_LLAE:;_LLAF:(void)_throw(
_tmp185);_LLAB:;}}}{struct Cyc_Interface_Ienv*_tmp186=Cyc_Interface_disj_merge_ienv(
...
30),_tag_arr(_tmp18E,sizeof(void*),2));}}});_tmp18D;});{struct Cyc_Core_Opt*
_tmp191=Cyc_Interface_disj_merge_ns(i1->exports,i2->exports,msg);if(_tmp191 == 0){
struct Cyc_Interface_I*_tmp192=0;_npop_handler(0);return _tmp192;}if(info != 0)msg=({
...
30),_tag_arr(_tmp194,sizeof(void*),2));}}});_tmp193;});{struct Cyc_Core_Opt*
_tmp197=Cyc_Interface_compat_merge_ns(i1->imports,i2->imports,(struct Cyc_Dict_Dict*)
...
_tmp19C=_tmp18B;_LLB1: if(_tmp19C != Cyc_Tcdecl_Incompatible)goto _LLB3;_LLB2:
return 0;_LLB3:;_LLB4:(void)_throw(_tmp19C);_LLB0:;}}}struct Cyc_Interface_I*Cyc_Interface_merge_list(
...
_tmp19E;}): 0;if(linfo != 0)linfo=linfo->tl;}return(struct Cyc_Interface_I*)curr_i;}}
...
la->tl){struct Cyc_Interface_I*_tmp1A3=Cyc_Interface_merge(curr_i,get((void*)la->hd),(
curr_info != 0?linfo != 0: 0)?({struct _tuple4*_tmp1A8=_cycalloc(sizeof(*_tmp1A8));
_tmp1A8->f1=*curr_info;_tmp1A8->f2=*((struct _tagged_arr*)linfo->hd);_tmp1A8;}): 0);
if(_tmp1A3 == 0)return 0;curr_i=(struct Cyc_Interface_I*)_check_null(_tmp1A3);if(
curr_info != 0)curr_info=linfo != 0?({struct _tagged_arr*_tmp1A4=_cycalloc(sizeof(*
_tmp1A4));_tmp1A4[0]=(struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmp1A7;
_tmp1A7.tag=0;_tmp1A7.f1=(struct _tagged_arr)*((struct _tagged_arr*)linfo->hd);{
...
_tmp1A4;}): 0;if(linfo != 0)linfo=linfo->tl;}return(struct Cyc_Interface_I*)curr_i;}}
static struct Cyc_List_List*Cyc_Interface_add_namespace(struct Cyc_List_List*tds,
struct Cyc_List_List*ns){if(ns == 0)return tds;return({struct Cyc_List_List*_tmp1A9=
_cycalloc(sizeof(*_tmp1A9));_tmp1A9->hd=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Namespace_d_struct*
_tmp1AA=_cycalloc(sizeof(*_tmp1AA));_tmp1AA[0]=({struct Cyc_Absyn_Namespace_d_struct
_tmp1AB;_tmp1AB.tag=8;_tmp1AB.f1=(struct _tagged_arr*)ns->hd;_tmp1AB.f2=Cyc_Interface_add_namespace(
tds,ns->tl);_tmp1AB;});_tmp1AA;}),0);_tmp1A9->tl=0;_tmp1A9;});}static struct Cyc_List_List*
Cyc_Interface_add_aggrdecl(struct _tagged_arr*x,struct Cyc_Absyn_Aggrdecl*d,struct
Cyc_List_List*tds){return({struct Cyc_List_List*_tmp1AC=_cycalloc(sizeof(*_tmp1AC));
_tmp1AC->hd=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Aggr_d_struct*_tmp1AD=
_cycalloc(sizeof(*_tmp1AD));_tmp1AD[0]=({struct Cyc_Absyn_Aggr_d_struct _tmp1AE;
_tmp1AE.tag=4;_tmp1AE.f1=d;_tmp1AE;});_tmp1AD;}),0);_tmp1AC->tl=tds;_tmp1AC;});}
...
_tmp1AF=_cycalloc(sizeof(*_tmp1AF));_tmp1AF[0]=*d;_tmp1AF;});d->impl=0;if((void*)
d->sc != (void*)4)(void*)(d->sc=(void*)((void*)3));return({struct Cyc_List_List*
_tmp1B0=_cycalloc(sizeof(*_tmp1B0));_tmp1B0->hd=Cyc_Absyn_new_decl((void*)({
struct Cyc_Absyn_Aggr_d_struct*_tmp1B1=_cycalloc(sizeof(*_tmp1B1));_tmp1B1[0]=({
struct Cyc_Absyn_Aggr_d_struct _tmp1B2;_tmp1B2.tag=4;_tmp1B2.f1=d;_tmp1B2;});
_tmp1B1;}),0);_tmp1B0->tl=tds;_tmp1B0;});}static struct Cyc_List_List*Cyc_Interface_add_tuniondecl(
...
static struct _tagged_arr*Cyc_Interface_us_p=& Cyc_Interface_us;static struct
_tuple16*Cyc_Interface_rewrite_tunionfield_type(struct _tuple16*x){return({struct
_tuple16*_tmp1B7=_cycalloc(sizeof(*_tmp1B7));_tmp1B7->f1=Cyc_Absyn_empty_tqual();
_tmp1B7->f2=(void*)({struct Cyc_Absyn_VarType_struct*_tmp1B8=_cycalloc(sizeof(*
_tmp1B8));_tmp1B8[0]=({struct Cyc_Absyn_VarType_struct _tmp1B9;_tmp1B9.tag=1;
_tmp1B9.f1=({struct Cyc_Absyn_Tvar*_tmp1BA=_cycalloc(sizeof(*_tmp1BA));_tmp1BA->name=
Cyc_Interface_us_p;_tmp1BA->identity=0;_tmp1BA->kind=(void*)((void*)({struct Cyc_Absyn_Eq_kb_struct*
...
struct _tuple16*(*f)(struct _tuple16*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Interface_rewrite_tunionfield_type,
...
return Cyc_Interface_gen_extract(_tmp1F0->ae,0);}}extern struct Cyc_Typerep_Struct_struct
...
void*Cyc_tunionfield_rep=(void*)& Cyc_tunionfield_p;static struct _tuple14 Cyc_Interface_write_aggrdecl_t(
