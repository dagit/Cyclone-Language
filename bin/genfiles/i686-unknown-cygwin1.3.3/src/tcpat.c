...
struct _tuple1*x,void*t,struct Cyc_Absyn_Exp*init);struct Cyc_Cstdio___sFILE;struct
...
_cycalloc(sizeof(struct Cyc_Absyn_Tunion_p_struct));_tmp13[0]=({struct Cyc_Absyn_Tunion_p_struct
_tmp14;_tmp14.tag=8;_tmp14.f1=_tmpD;_tmp14.f2=_tmpC;_tmp14.f3=0;_tmp14.f4=0;
_tmp14;});_tmp13;})));_npop_handler(0);return;_LL16:(void*)(p->r=(void*)((void*)({
struct Cyc_Absyn_Enum_p_struct*_tmp15=_cycalloc(sizeof(struct Cyc_Absyn_Enum_p_struct));
_tmp15[0]=({struct Cyc_Absyn_Enum_p_struct _tmp16;_tmp16.tag=9;_tmp16.f1=_tmpF;
_tmp16.f2=_tmpE;_tmp16;});_tmp15;})));_npop_handler(0);return;_LL18:(void*)(p->r=(
void*)((void*)({struct Cyc_Absyn_AnonEnum_p_struct*_tmp17=_cycalloc(sizeof(struct
Cyc_Absyn_AnonEnum_p_struct));_tmp17[0]=({struct Cyc_Absyn_AnonEnum_p_struct
...
_tmp1D=_cycalloc(sizeof(struct Cyc_Absyn_Var_p_struct));_tmp1D[0]=({struct Cyc_Absyn_Var_p_struct
_tmp1E;_tmp1E.tag=0;_tmp1E.f1=Cyc_Absyn_new_vardecl(_tmp1,(void*)0,0);_tmp1E;});
_tmp1D;})));return;_LL2C:({void*_tmp1F[0]={};Cyc_Tcutil_terr(p->loc,_tag_arr("qualified variable in pattern",
...
sizeof(struct Cyc_List_List));_tmp28->hd=({struct _tuple7*_tmp29=_cycalloc(sizeof(
struct _tuple7));_tmp29->f1=0;_tmp29->f2=(struct Cyc_Absyn_Pat*)_tmp2->hd;_tmp29;});
_tmp28->tl=_tmp27;_tmp28;});}(void*)(p->r=(void*)((void*)({struct Cyc_Absyn_Struct_p_struct*
_tmp2A=_cycalloc(sizeof(struct Cyc_Absyn_Struct_p_struct));_tmp2A[0]=({struct Cyc_Absyn_Struct_p_struct
...
Cyc_Absyn_Tunion_p_struct*_tmp2C=_cycalloc(sizeof(struct Cyc_Absyn_Tunion_p_struct));
_tmp2C[0]=({struct Cyc_Absyn_Tunion_p_struct _tmp2D;_tmp2D.tag=8;_tmp2D.f1=_tmp26;
_tmp2D.f2=_tmp25;_tmp2D.f3=_tmp3;_tmp2D.f4=_tmp2;_tmp2D;});_tmp2C;})));
_npop_handler(0);return;_LL34: goto _LL36;_LL36:({struct Cyc_Std_String_pa_struct
_tmp2F;_tmp2F.tag=0;_tmp2F.f1=(struct _tagged_arr)Cyc_Absynpp_qvar2string(_tmp4);{
void*_tmp2E[1]={& _tmp2F};Cyc_Tcutil_terr(p->loc,_tag_arr("bad enum constructor %s in pattern",
sizeof(unsigned char),35),_tag_arr(_tmp2E,sizeof(void*),1));}});_npop_handler(0);
return;_LL38: goto _LL2E;_LL2E:;};_pop_handler();}else{void*_tmp21=(void*)
_exn_thrown;void*_tmp31=_tmp21;_LL3D: if(_tmp31 == Cyc_Dict_Absent){goto _LL3E;}
else{goto _LL3F;}_LL3F: goto _LL40;_LL3E: goto _LL3C;_LL40:(void)_throw(_tmp31);_LL3C:;}}}({
struct Cyc_Std_String_pa_struct _tmp33;_tmp33.tag=0;_tmp33.f1=(struct _tagged_arr)
Cyc_Absynpp_qvar2string(_tmp4);{void*_tmp32[1]={& _tmp33};Cyc_Tcutil_terr(p->loc,
_tag_arr("%s is not a constructor in pattern",sizeof(unsigned char),35),_tag_arr(
_tmp32,sizeof(void*),1));}});return;_LL6:{struct _handler_cons _tmp34;
_push_handler(& _tmp34);{int _tmp36=0;if(setjmp(_tmp34.handler)){_tmp36=1;}if(!
_tmp36){{void*_tmp37=Cyc_Tcenv_lookup_ordinary(te,p->loc,_tmp7);struct Cyc_Absyn_Structdecl*
_tmp38;_LL42: if(*((int*)_tmp37)== 1){_LL46: _tmp38=((struct Cyc_Tcenv_StructRes_struct*)
_tmp37)->f1;goto _LL43;}else{goto _LL44;}_LL44: goto _LL45;_LL43:(void*)(p->r=(void*)((
void*)({struct Cyc_Absyn_Struct_p_struct*_tmp39=_cycalloc(sizeof(struct Cyc_Absyn_Struct_p_struct));
_tmp39[0]=({struct Cyc_Absyn_Struct_p_struct _tmp3A;_tmp3A.tag=7;_tmp3A.f1=_tmp38;
_tmp3A.f2=0;_tmp3A.f3=_tmp6;_tmp3A.f4=_tmp5;_tmp3A;});_tmp39;})));_npop_handler(
0);return;_LL45: goto _LL41;_LL41:;};_pop_handler();}else{void*_tmp35=(void*)
_exn_thrown;void*_tmp3C=_tmp35;_LL48: if(_tmp3C == Cyc_Dict_Absent){goto _LL49;}
else{goto _LL4A;}_LL4A: goto _LL4B;_LL49: goto _LL47;_LL4B:(void)_throw(_tmp3C);_LL47:;}}}({
struct Cyc_Std_String_pa_struct _tmp3E;_tmp3E.tag=0;_tmp3E.f1=(struct _tagged_arr)
Cyc_Absynpp_qvar2string(_tmp7);{void*_tmp3D[1]={& _tmp3E};Cyc_Tcutil_terr(p->loc,
_tag_arr("%s is not a struct name, but pattern has designators",sizeof(
unsigned char),53),_tag_arr(_tmp3D,sizeof(void*),1));}});return;_LL8: return;_LL0:;}
...
struct Cyc_Core_Opt*_tmp3F=_cycalloc(sizeof(struct Cyc_Core_Opt));_tmp3F->v=s;
...
sizeof(struct Cyc_List_List));_tmp41->hd=vd;_tmp41->tl=*v_result_ptr;_tmp41;});}
struct _tuple8{struct Cyc_Absyn_Tqual f1;void*f2;};struct _tuple9{struct Cyc_Absyn_Structfield*
...
sizeof(struct Cyc_Absyn_PointerType_struct));_tmp57[0]=({struct Cyc_Absyn_PointerType_struct
_tmp58;_tmp58.tag=4;_tmp58.f1=({struct Cyc_Absyn_PtrInfo _tmp59;_tmp59.elt_typ=(
void*)t;_tmp59.rgn_typ=(void*)*region_opt;_tmp59.nullable=((struct Cyc_Absyn_Conref*(*)(
int x))Cyc_Absyn_new_conref)(0);_tmp59.tq=Cyc_Absyn_empty_tqual();_tmp59.bounds=
Cyc_Absyn_empty_conref();_tmp59;});_tmp58;});_tmp57;}));goto _LL51;_LL59: t=Cyc_Tcpat_num_type(
topt,Cyc_Absyn_uint_t);goto _LL51;_LL5B: t=Cyc_Tcpat_num_type(topt,Cyc_Absyn_sint_t);
goto _LL51;_LL5D: t=Cyc_Tcpat_num_type(topt,Cyc_Absyn_uchar_t);goto _LL51;_LL5F: t=
Cyc_Tcpat_num_type(topt,Cyc_Absyn_float_t);goto _LL51;_LL61: t=Cyc_Tcpat_num_type(
topt,(void*)({struct Cyc_Absyn_EnumType_struct*_tmp5A=_cycalloc(sizeof(struct Cyc_Absyn_EnumType_struct));
_tmp5A[0]=({struct Cyc_Absyn_EnumType_struct _tmp5B;_tmp5B.tag=12;_tmp5B.f1=_tmp48->name;
...
_tmp5E=_cycalloc(sizeof(struct Cyc_Absyn_PointerType_struct));_tmp5E[0]=({struct
Cyc_Absyn_PointerType_struct _tmp5F;_tmp5F.tag=4;_tmp5F.f1=({struct Cyc_Absyn_PtrInfo
_tmp60;_tmp60.elt_typ=(void*)Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_ak,({
struct Cyc_Core_Opt*_tmp62=_cycalloc(sizeof(struct Cyc_Core_Opt));_tmp62->v=_tmp5D;
_tmp62;}));_tmp60.rgn_typ=(void*)Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,({
struct Cyc_Core_Opt*_tmp61=_cycalloc(sizeof(struct Cyc_Core_Opt));_tmp61->v=_tmp5D;
_tmp61;}));_tmp60.nullable=((struct Cyc_Absyn_Conref*(*)(int x))Cyc_Absyn_new_conref)(
1);_tmp60.tq=Cyc_Absyn_empty_tqual();_tmp60.bounds=Cyc_Absyn_empty_conref();
_tmp60;});_tmp5F;});_tmp5E;});goto _LL51;}_LL67: {void*inner_typ=(void*)0;void**
_tmp63=0;if(topt != 0){void*_tmp64=Cyc_Tcutil_compress(*topt);struct Cyc_Absyn_PtrInfo
_tmp65;void*_tmp66;_LL8C: if((unsigned int)_tmp64 > 3?*((int*)_tmp64)== 4: 0){_LL90:
_tmp65=((struct Cyc_Absyn_PointerType_struct*)_tmp64)->f1;_LL91: _tmp66=(void*)
_tmp65.elt_typ;goto _LL8D;}else{goto _LL8E;}_LL8E: goto _LL8F;_LL8D: inner_typ=_tmp66;
_tmp63=(void**)& inner_typ;goto _LL8B;_LL8F: goto _LL8B;_LL8B:;}{void*ptr_rgn=Cyc_Absyn_new_evar((
struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,({struct Cyc_Core_Opt*_tmp7C=_cycalloc(sizeof(
struct Cyc_Core_Opt));_tmp7C->v=Cyc_Tcenv_lookup_type_vars(te);_tmp7C;}));struct
Cyc_List_List*_tmp68;struct Cyc_List_List*_tmp69;struct _tuple6 _tmp67=Cyc_Tcpat_tcPatRec(
te,_tmp4B,_tmp63,(void**)& ptr_rgn);_LL94: _tmp69=_tmp67.f1;goto _LL93;_LL93: _tmp68=
_tmp67.f2;goto _LL92;_LL92: tv_result=((struct Cyc_List_List*(*)(struct Cyc_List_List*
x,struct Cyc_List_List*y))Cyc_List_append)(tv_result,_tmp69);v_result=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(v_result,_tmp68);
if(_tmp63 == 0){void*_tmp6A=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
_check_null(_tmp4B->topt))->v);struct Cyc_Absyn_TunionFieldInfo _tmp6B;struct Cyc_List_List*
_tmp6C;void*_tmp6D;struct Cyc_Absyn_Tunionfield*_tmp6E;struct Cyc_Absyn_Tuniondecl*
_tmp6F;_LL96: if((unsigned int)_tmp6A > 3?*((int*)_tmp6A)== 3: 0){_LL9A: _tmp6B=((
struct Cyc_Absyn_TunionFieldType_struct*)_tmp6A)->f1;_LL9C: _tmp6D=(void*)_tmp6B.field_info;
if(*((int*)_tmp6D)== 1){_LL9E: _tmp6F=((struct Cyc_Absyn_KnownTunionfield_struct*)
_tmp6D)->f1;goto _LL9D;_LL9D: _tmp6E=((struct Cyc_Absyn_KnownTunionfield_struct*)
_tmp6D)->f2;goto _LL9B;}else{goto _LL98;}_LL9B: _tmp6C=_tmp6B.targs;goto _LL97;}
else{goto _LL98;}_LL98: goto _LL99;_LL97: t=(void*)({struct Cyc_Absyn_TunionType_struct*
_tmp70=_cycalloc(sizeof(struct Cyc_Absyn_TunionType_struct));_tmp70[0]=({struct
Cyc_Absyn_TunionType_struct _tmp71;_tmp71.tag=2;_tmp71.f1=({struct Cyc_Absyn_TunionInfo
_tmp72;_tmp72.tunion_info=(void*)((void*)({struct Cyc_Absyn_KnownTunion_struct*
_tmp73=_cycalloc(sizeof(struct Cyc_Absyn_KnownTunion_struct));_tmp73[0]=({struct
Cyc_Absyn_KnownTunion_struct _tmp74;_tmp74.tag=1;_tmp74.f1=({struct Cyc_Absyn_Tuniondecl**
_tmp75=_cycalloc(sizeof(struct Cyc_Absyn_Tuniondecl*));_tmp75[0]=_tmp6F;_tmp75;});
_tmp74;});_tmp73;}));_tmp72.targs=_tmp6C;_tmp72.rgn=(void*)ptr_rgn;_tmp72;});
_tmp71;});_tmp70;});goto _LL95;_LL99: t=(void*)({struct Cyc_Absyn_PointerType_struct*
_tmp76=_cycalloc(sizeof(struct Cyc_Absyn_PointerType_struct));_tmp76[0]=({struct
Cyc_Absyn_PointerType_struct _tmp77;_tmp77.tag=4;_tmp77.f1=({struct Cyc_Absyn_PtrInfo
_tmp78;_tmp78.elt_typ=(void*)((void*)((struct Cyc_Core_Opt*)_check_null(_tmp4B->topt))->v);
_tmp78.rgn_typ=(void*)ptr_rgn;_tmp78.nullable=((struct Cyc_Absyn_Conref*(*)())Cyc_Absyn_empty_conref)();
_tmp78.tq=Cyc_Absyn_empty_tqual();_tmp78.bounds=Cyc_Absyn_empty_conref();_tmp78;});
_tmp77;});_tmp76;});goto _LL95;_LL95:;}else{t=(void*)({struct Cyc_Absyn_PointerType_struct*
_tmp79=_cycalloc(sizeof(struct Cyc_Absyn_PointerType_struct));_tmp79[0]=({struct
Cyc_Absyn_PointerType_struct _tmp7A;_tmp7A.tag=4;_tmp7A.f1=({struct Cyc_Absyn_PtrInfo
_tmp7B;_tmp7B.elt_typ=(void*)((void*)((struct Cyc_Core_Opt*)_check_null(_tmp4B->topt))->v);
_tmp7B.rgn_typ=(void*)ptr_rgn;_tmp7B.nullable=((struct Cyc_Absyn_Conref*(*)())Cyc_Absyn_empty_conref)();
_tmp7B.tq=Cyc_Absyn_empty_tqual();_tmp7B.bounds=Cyc_Absyn_empty_conref();_tmp7B;});
_tmp7A;});_tmp79;});}goto _LL51;}}_LL69: {struct Cyc_List_List*pat_ts=0;struct Cyc_List_List*
...
pat_ts=({struct Cyc_List_List*_tmp83=_cycalloc(sizeof(struct Cyc_List_List));
_tmp83->hd=({struct _tuple8*_tmp84=_cycalloc(sizeof(struct _tuple8));_tmp84->f1=
Cyc_Absyn_empty_tqual();_tmp84->f2=(void*)((struct Cyc_Core_Opt*)_check_null(((
struct Cyc_Absyn_Pat*)_tmp4C->hd)->topt))->v;_tmp84;});_tmp83->tl=pat_ts;_tmp83;});}}
t=(void*)({struct Cyc_Absyn_TupleType_struct*_tmp85=_cycalloc(sizeof(struct Cyc_Absyn_TupleType_struct));
_tmp85[0]=({struct Cyc_Absyn_TupleType_struct _tmp86;_tmp86.tag=9;_tmp86.f1=((
struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(pat_ts);_tmp86;});
_tmp85;});goto _LL51;}_LL6B: if(_tmp4E != 0){(int)_throw(({void*_tmp87[0]={};Cyc_Tcutil_impos(
_tag_arr("tcPat: struct<...> not implemented",sizeof(unsigned char),35),_tag_arr(
_tmp87,sizeof(void*),0));}));}{struct _RegionHandle _tmp88=_new_region("rgn");
struct _RegionHandle*rgn=& _tmp88;_push_region(rgn);{struct _tuple4 _tmp89=({struct
_tuple4 _tmp9D;_tmp9D.f1=Cyc_Tcenv_lookup_type_vars(te);_tmp9D.f2=rgn;_tmp9D;});
struct Cyc_List_List*_tmp8A=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct
_tuple5*(*f)(struct _tuple4*,struct Cyc_Absyn_Tvar*),struct _tuple4*env,struct Cyc_List_List*
x))Cyc_List_rmap_c)(rgn,Cyc_Tcutil_r_make_inst_var,& _tmp89,_tmp51->tvs);struct
Cyc_List_List*_tmp8B=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple5*),struct
Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple5*))Cyc_Core_snd,_tmp8A);t=(
void*)({struct Cyc_Absyn_StructType_struct*_tmp8C=_cycalloc(sizeof(struct Cyc_Absyn_StructType_struct));
_tmp8C[0]=({struct Cyc_Absyn_StructType_struct _tmp8D;_tmp8D.tag=10;_tmp8D.f1=(
struct _tuple1*)((struct _tuple1*)((struct Cyc_Core_Opt*)_check_null(_tmp51->name))->v);
_tmp8D.f2=_tmp8B;_tmp8D.f3=({struct Cyc_Absyn_Structdecl**_tmp8E=_cycalloc(
sizeof(struct Cyc_Absyn_Structdecl*));_tmp8E[0]=_tmp51;_tmp8E;});_tmp8D;});_tmp8C;});
if(topt != 0){Cyc_Tcutil_unify(t,*topt);}*_tmp50=({struct Cyc_Core_Opt*_tmp8F=
_cycalloc(sizeof(struct Cyc_Core_Opt));_tmp8F->v=_tmp8B;_tmp8F;});if(_tmp51->fields
== 0){({void*_tmp90[0]={};Cyc_Tcutil_terr(p->loc,_tag_arr("can't destructure an abstract struct",
...
_cycalloc(sizeof(struct Cyc_Core_Opt));_tmpAD->v=(void*)((void*)({struct Cyc_Absyn_Eq_kb_struct*
_tmpAE=_cycalloc(sizeof(struct Cyc_Absyn_Eq_kb_struct));_tmpAE[0]=({struct Cyc_Absyn_Eq_kb_struct
_tmpAF;_tmpAF.tag=0;_tmpAF.f1=(void*)((void*)2);_tmpAF;});_tmpAE;}));_tmpAD;});
goto _LLAE;_LLB8: _tmpAC=_tmpAB;goto _LLBA;_LLBA:({struct Cyc_Std_String_pa_struct
_tmpB3;_tmpB3.tag=0;_tmpB3.f1=(struct _tagged_arr)Cyc_Absynpp_kind2string(_tmpAC);{
...
_LLAE:;}_tmpA0=({struct Cyc_List_List*_tmpB4=_region_malloc(rgn,sizeof(struct Cyc_List_List));
_tmpB4->hd=(void*)((void*)({struct Cyc_Absyn_VarType_struct*_tmpB5=_cycalloc(
sizeof(struct Cyc_Absyn_VarType_struct));_tmpB5[0]=({struct Cyc_Absyn_VarType_struct
_tmpB6;_tmpB6.tag=1;_tmpB6.f1=tv;_tmpB6;});_tmpB5;}));_tmpB4->tl=_tmpA0;_tmpB4;});}}
_tmpA0=Cyc_List_imp_rev(_tmpA0);tv_result=((struct Cyc_List_List*(*)(struct Cyc_List_List*
x,struct Cyc_List_List*y))Cyc_List_append)(tv_result,_tmp53);{struct Cyc_Tcenv_Tenv*
te2=Cyc_Tcenv_add_type_vars(p->loc,te,_tmp53);struct Cyc_List_List*tqts=_tmp54->typs;
struct Cyc_List_List*_tmpB7=Cyc_Tcenv_lookup_type_vars(te);struct _tuple4 _tmpB8=({
struct _tuple4 _tmpE0;_tmpE0.f1=_tmpB7;_tmpE0.f2=rgn;_tmpE0;});struct Cyc_List_List*
_tmpB9=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple5*(*f)(struct
_tuple4*,struct Cyc_Absyn_Tvar*),struct _tuple4*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(
rgn,Cyc_Tcutil_r_make_inst_var,& _tmpB8,_tmp55->tvs);struct Cyc_List_List*_tmpBA=((
struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*
x,struct Cyc_List_List*y))Cyc_List_rzip)(rgn,rgn,_tmp54->tvs,_tmpA0);struct Cyc_List_List*
_tmpBB=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple5*),struct Cyc_List_List*x))
Cyc_List_map)((void*(*)(struct _tuple5*))Cyc_Core_snd,_tmpB9);struct Cyc_List_List*
_tmpBC=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple5*),struct Cyc_List_List*x))
Cyc_List_map)((void*(*)(struct _tuple5*))Cyc_Core_snd,_tmpBA);struct Cyc_List_List*
_tmpBD=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x,
struct Cyc_List_List*y))Cyc_List_rappend)(rgn,_tmpB9,_tmpBA);if(tqts == 0){t=(void*)({
struct Cyc_Absyn_TunionType_struct*_tmpBE=_cycalloc(sizeof(struct Cyc_Absyn_TunionType_struct));
_tmpBE[0]=({struct Cyc_Absyn_TunionType_struct _tmpBF;_tmpBF.tag=2;_tmpBF.f1=({
struct Cyc_Absyn_TunionInfo _tmpC0;_tmpC0.tunion_info=(void*)((void*)({struct Cyc_Absyn_KnownTunion_struct*
_tmpC2=_cycalloc(sizeof(struct Cyc_Absyn_KnownTunion_struct));_tmpC2[0]=({struct
Cyc_Absyn_KnownTunion_struct _tmpC3;_tmpC3.tag=1;_tmpC3.f1=({struct Cyc_Absyn_Tuniondecl**
_tmpC4=_cycalloc(sizeof(struct Cyc_Absyn_Tuniondecl*));_tmpC4[0]=_tmp55;_tmpC4;});
_tmpC3;});_tmpC2;}));_tmpC0.targs=_tmpBB;_tmpC0.rgn=(void*)Cyc_Absyn_new_evar((
struct Cyc_Core_Opt*)& Cyc_Tcutil_rk,({struct Cyc_Core_Opt*_tmpC1=_cycalloc(sizeof(
struct Cyc_Core_Opt));_tmpC1->v=_tmpB7;_tmpC1;}));_tmpC0;});_tmpBF;});_tmpBE;});}
else{t=(void*)({struct Cyc_Absyn_TunionFieldType_struct*_tmpC5=_cycalloc(sizeof(
struct Cyc_Absyn_TunionFieldType_struct));_tmpC5[0]=({struct Cyc_Absyn_TunionFieldType_struct
...
struct Cyc_Absyn_KnownTunionfield_struct));_tmpC8[0]=({struct Cyc_Absyn_KnownTunionfield_struct
_tmpC9;_tmpC9.tag=1;_tmpC9.f1=_tmp55;_tmpC9.f2=_tmp54;_tmpC9;});_tmpC8;}));
_tmpC7.targs=_tmpBB;_tmpC7;});_tmpC6;});_tmpC5;});}if(topt != 0? tqts == 0: 0){void*
_tmpCA=Cyc_Tcutil_compress(*topt);struct Cyc_Absyn_TunionInfo _tmpCB;struct Cyc_List_List*
_tmpCC;_LLC4: if((unsigned int)_tmpCA > 3?*((int*)_tmpCA)== 3: 0){goto _LLC5;}else{
goto _LLC6;}_LLC6: if((unsigned int)_tmpCA > 3?*((int*)_tmpCA)== 2: 0){_LLCA: _tmpCB=((
struct Cyc_Absyn_TunionType_struct*)_tmpCA)->f1;_LLCB: _tmpCC=_tmpCB.targs;goto
_LLC7;}else{goto _LLC8;}_LLC8: goto _LLC9;_LLC5: t=(void*)({struct Cyc_Absyn_TunionFieldType_struct*
_tmpCD=_cycalloc(sizeof(struct Cyc_Absyn_TunionFieldType_struct));_tmpCD[0]=({
struct Cyc_Absyn_TunionFieldType_struct _tmpCE;_tmpCE.tag=3;_tmpCE.f1=({struct Cyc_Absyn_TunionFieldInfo
_tmpCF;_tmpCF.field_info=(void*)((void*)({struct Cyc_Absyn_KnownTunionfield_struct*
_tmpD0=_cycalloc(sizeof(struct Cyc_Absyn_KnownTunionfield_struct));_tmpD0[0]=({
struct Cyc_Absyn_KnownTunionfield_struct _tmpD1;_tmpD1.tag=1;_tmpD1.f1=_tmp55;
_tmpD1.f2=_tmp54;_tmpD1;});_tmpD0;}));_tmpCF.targs=_tmpBB;_tmpCF;});_tmpCE;});
_tmpCD;});goto _LLC3;_LLC7: {struct Cyc_List_List*_tmpD2=_tmpBB;for(0;_tmpD2 != 0?
_tmpCC != 0: 0;(_tmpD2=_tmpD2->tl,_tmpCC=_tmpCC->tl)){Cyc_Tcutil_unify((void*)
_tmpD2->hd,(void*)_tmpCC->hd);}goto _LLC3;}_LLC9: goto _LLC3;_LLC3:;}for(0;_tmp52 != 
0? tqts != 0: 0;(_tmp52=_tmp52->tl,tqts=tqts->tl)){struct Cyc_Absyn_Pat*_tmpD3=(
struct Cyc_Absyn_Pat*)_tmp52->hd;void*_tmpD4=Cyc_Tcutil_rsubstitute(rgn,_tmpBD,(*((
struct _tuple8*)tqts->hd)).f2);struct Cyc_List_List*_tmpD6;struct Cyc_List_List*
...
struct Cyc_Core_Opt*_tmpE1=_cycalloc(sizeof(struct Cyc_Core_Opt));_tmpE1->v=Cyc_Tcenv_lookup_type_vars(
te);_tmpE1;}));goto _LL51;_LL51:;}tcpat_end: p->topt=({struct Cyc_Core_Opt*_tmpE2=
_cycalloc(sizeof(struct Cyc_Core_Opt));_tmpE2->v=(void*)t;_tmpE2;});return({
struct _tuple6 _tmpE3;_tmpE3.f1=tv_result;_tmpE3.f2=v_result;_tmpE3;});}}struct
_tuple6 Cyc_Tcpat_tcPat(struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Pat*p,void**topt,
void**region_opt){struct _tuple6 _tmpE4=Cyc_Tcpat_tcPatRec(te,p,topt,region_opt);{
struct _RegionHandle _tmpE5=_new_region("r");struct _RegionHandle*r=& _tmpE5;
...
x))Cyc_List_rmap)(r,Cyc_Tcpat_get_name,_tmpE4.f2),p->loc,_tag_arr("pattern contains a repeated variable",
...
_tmpF0=_cycalloc(sizeof(struct Cyc_Core_Impossible_struct));_tmpF0[0]=({struct Cyc_Core_Impossible_struct
...
_tmpF5=_cycalloc(sizeof(struct Cyc_Core_Impossible_struct));_tmpF5[0]=({struct Cyc_Core_Impossible_struct
...
int i){return({struct Cyc_Tcpat_Con_s*_tmp104=_cycalloc(sizeof(struct Cyc_Tcpat_Con_s));
_tmp104->name=(void*)((void*)({struct Cyc_Tcpat_Int_v_struct*_tmp105=
_cycalloc_atomic(sizeof(struct Cyc_Tcpat_Int_v_struct));_tmp105[0]=({struct Cyc_Tcpat_Int_v_struct
_tmp106;_tmp106.tag=1;_tmp106.f1=i;_tmp106;});_tmp105;}));_tmp104->arity=0;
_tmp104->span=0;_tmp104;});}static struct Cyc_Tcpat_Con_s*Cyc_Tcpat_float_con(
struct _tagged_arr f){return({struct Cyc_Tcpat_Con_s*_tmp107=_cycalloc(sizeof(
struct Cyc_Tcpat_Con_s));_tmp107->name=(void*)((void*)({struct Cyc_Tcpat_Name_v_struct*
_tmp108=_cycalloc(sizeof(struct Cyc_Tcpat_Name_v_struct));_tmp108[0]=({struct Cyc_Tcpat_Name_v_struct
...
unsigned char c){return({struct Cyc_Tcpat_Con_s*_tmp10A=_cycalloc(sizeof(struct Cyc_Tcpat_Con_s));
_tmp10A->name=(void*)((void*)({struct Cyc_Tcpat_Int_v_struct*_tmp10C=
_cycalloc_atomic(sizeof(struct Cyc_Tcpat_Int_v_struct));_tmp10C[0]=({struct Cyc_Tcpat_Int_v_struct
_tmp10D;_tmp10D.tag=1;_tmp10D.f1=(int)c;_tmp10D;});_tmp10C;}));_tmp10A->arity=0;
_tmp10A->span=({struct Cyc_Core_Opt*_tmp10B=_cycalloc_atomic(sizeof(struct Cyc_Core_Opt));
_tmp10B->v=(void*)256;_tmp10B;});_tmp10A;});}static struct Cyc_Tcpat_Con_s*Cyc_Tcpat_tuple_con(
int i){return({struct Cyc_Tcpat_Con_s*_tmp10E=_cycalloc(sizeof(struct Cyc_Tcpat_Con_s));
_tmp10E->name=(void*)((void*)& Cyc_Tcpat_tuple_name_value);_tmp10E->arity=i;
_tmp10E->span=Cyc_Tcpat_one_opt_ptr;_tmp10E;});}static void*Cyc_Tcpat_null_pat(){
return(void*)({struct Cyc_Tcpat_Con_struct*_tmp10F=_cycalloc(sizeof(struct Cyc_Tcpat_Con_struct));
_tmp10F[0]=({struct Cyc_Tcpat_Con_struct _tmp110;_tmp110.tag=0;_tmp110.f1=Cyc_Tcpat_null_con;
_tmp110.f2=0;_tmp110;});_tmp10F;});}static void*Cyc_Tcpat_int_pat(int i){return(
void*)({struct Cyc_Tcpat_Con_struct*_tmp111=_cycalloc(sizeof(struct Cyc_Tcpat_Con_struct));
_tmp111[0]=({struct Cyc_Tcpat_Con_struct _tmp112;_tmp112.tag=0;_tmp112.f1=Cyc_Tcpat_int_con(
i);_tmp112.f2=0;_tmp112;});_tmp111;});}static void*Cyc_Tcpat_char_pat(
unsigned char c){return(void*)({struct Cyc_Tcpat_Con_struct*_tmp113=_cycalloc(
sizeof(struct Cyc_Tcpat_Con_struct));_tmp113[0]=({struct Cyc_Tcpat_Con_struct
...
struct Cyc_Tcpat_Con_struct*_tmp115=_cycalloc(sizeof(struct Cyc_Tcpat_Con_struct));
_tmp115[0]=({struct Cyc_Tcpat_Con_struct _tmp116;_tmp116.tag=0;_tmp116.f1=Cyc_Tcpat_float_con(
f);_tmp116.f2=0;_tmp116;});_tmp115;});}static void*Cyc_Tcpat_null_ptr_pat(void*p){
return(void*)({struct Cyc_Tcpat_Con_struct*_tmp117=_cycalloc(sizeof(struct Cyc_Tcpat_Con_struct));
_tmp117[0]=({struct Cyc_Tcpat_Con_struct _tmp118;_tmp118.tag=0;_tmp118.f1=Cyc_Tcpat_null_ptr_con;
_tmp118.f2=({struct Cyc_List_List*_tmp119=_cycalloc(sizeof(struct Cyc_List_List));
_tmp119->hd=(void*)p;_tmp119->tl=0;_tmp119;});_tmp118;});_tmp117;});}static void*
Cyc_Tcpat_ptr_pat(void*p){return(void*)({struct Cyc_Tcpat_Con_struct*_tmp11A=
_cycalloc(sizeof(struct Cyc_Tcpat_Con_struct));_tmp11A[0]=({struct Cyc_Tcpat_Con_struct
_tmp11B;_tmp11B.tag=0;_tmp11B.f1=Cyc_Tcpat_ptr_con;_tmp11B.f2=({struct Cyc_List_List*
_tmp11C=_cycalloc(sizeof(struct Cyc_List_List));_tmp11C->hd=(void*)p;_tmp11C->tl=
0;_tmp11C;});_tmp11B;});_tmp11A;});}static void*Cyc_Tcpat_tuple_pat(struct Cyc_List_List*
ss){return(void*)({struct Cyc_Tcpat_Con_struct*_tmp11D=_cycalloc(sizeof(struct Cyc_Tcpat_Con_struct));
_tmp11D[0]=({struct Cyc_Tcpat_Con_struct _tmp11E;_tmp11E.tag=0;_tmp11E.f1=Cyc_Tcpat_tuple_con(
Cyc_List_length(ss));_tmp11E.f2=ss;_tmp11E;});_tmp11D;});}static void*Cyc_Tcpat_con_pat(
struct _tagged_arr con_name,struct Cyc_Core_Opt*span,struct Cyc_List_List*ps){struct
Cyc_Tcpat_Con_s*c=({struct Cyc_Tcpat_Con_s*_tmp121=_cycalloc(sizeof(struct Cyc_Tcpat_Con_s));
_tmp121->name=(void*)((void*)({struct Cyc_Tcpat_Name_v_struct*_tmp122=_cycalloc(
sizeof(struct Cyc_Tcpat_Name_v_struct));_tmp122[0]=({struct Cyc_Tcpat_Name_v_struct
_tmp123;_tmp123.tag=0;_tmp123.f1=con_name;_tmp123;});_tmp122;}));_tmp121->arity=
Cyc_List_length(ps);_tmp121->span=span;_tmp121;});return(void*)({struct Cyc_Tcpat_Con_struct*
_tmp11F=_cycalloc(sizeof(struct Cyc_Tcpat_Con_struct));_tmp11F[0]=({struct Cyc_Tcpat_Con_struct
_tmp120;_tmp120.tag=0;_tmp120.f1=c;_tmp120.f2=ps;_tmp120;});_tmp11F;});}static
void*Cyc_Tcpat_compile_pat(struct Cyc_Absyn_Pat*p){void*s;{void*_tmp124=(void*)p->r;
int _tmp125;void*_tmp126;unsigned char _tmp127;struct _tagged_arr _tmp128;struct Cyc_Absyn_Pat*
_tmp129;struct Cyc_List_List*_tmp12A;struct Cyc_Absyn_Tunionfield*_tmp12B;struct
Cyc_Absyn_Tuniondecl*_tmp12C;struct Cyc_List_List*_tmp12D;struct Cyc_List_List*
_tmp12E;struct Cyc_List_List*_tmp12F;struct Cyc_Absyn_Structdecl*_tmp130;struct Cyc_Absyn_Enumfield*
_tmp131;struct Cyc_Absyn_Enumdecl*_tmp132;struct Cyc_Absyn_Enumfield*_tmp133;void*
_tmp134;_LL106: if((int)_tmp124 == 0){goto _LL107;}else{goto _LL108;}_LL108: if((
unsigned int)_tmp124 > 2?*((int*)_tmp124)== 0: 0){goto _LL109;}else{goto _LL10A;}
_LL10A: if((int)_tmp124 == 1){goto _LL10B;}else{goto _LL10C;}_LL10C: if((unsigned int)
_tmp124 > 2?*((int*)_tmp124)== 1: 0){_LL129: _tmp126=(void*)((struct Cyc_Absyn_Int_p_struct*)
...
_tmp13B=_cycalloc(sizeof(struct Cyc_Absyn_Eq_constr_struct));_tmp13B[0]=({struct
Cyc_Absyn_Eq_constr_struct _tmp13C;_tmp13C.tag=0;_tmp13C.f1=(void*)0;_tmp13C;});
_tmp13B;})));is_nullable=0;still_working=0;goto _LL141;_LL147: is_nullable=(int)
_tmp13A;still_working=0;goto _LL141;_LL141:;}{void*ss=Cyc_Tcpat_compile_pat(
_tmp129);if(is_nullable){s=Cyc_Tcpat_null_ptr_pat(ss);}else{s=Cyc_Tcpat_ptr_pat(
ss);}goto _LL138;}}_LL13C:{void*_tmp13D=(void*)_tmp129->r;struct Cyc_List_List*
_tmp13E;struct Cyc_Absyn_Tunionfield*_tmp13F;struct Cyc_Absyn_Tuniondecl*_tmp140;
_LL14B: if((unsigned int)_tmp13D > 2?*((int*)_tmp13D)== 8: 0){_LL151: _tmp140=((
struct Cyc_Absyn_Tunion_p_struct*)_tmp13D)->f1;goto _LL150;_LL150: _tmp13F=((struct
Cyc_Absyn_Tunion_p_struct*)_tmp13D)->f2;goto _LL14F;_LL14F: _tmp13E=((struct Cyc_Absyn_Tunion_p_struct*)
_tmp13D)->f4;goto _LL14C;}else{goto _LL14D;}_LL14D: goto _LL14E;_LL14C: {struct Cyc_Core_Opt*
span;if(_tmp140->is_xtunion){span=0;}else{span=({struct Cyc_Core_Opt*_tmp141=
_cycalloc_atomic(sizeof(struct Cyc_Core_Opt));_tmp141->v=(void*)((int(*)(struct
Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)
_check_null(_tmp140->fields))->v);_tmp141;});}s=Cyc_Tcpat_con_pat(*(*_tmp13F->name).f2,
span,((struct Cyc_List_List*(*)(void*(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*
x))Cyc_List_map)(Cyc_Tcpat_compile_pat,_tmp13E));goto _LL14A;}_LL14E: s=({void*
_tmp142[0]={};Cyc_Tcutil_impos(_tag_arr("non-[x]tunion pattern has tunion type",
...
_tmp145=_cycalloc_atomic(sizeof(struct Cyc_Core_Opt));_tmp145->v=(void*)((int(*)(
struct Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)
_check_null(_tmp12C->fields))->v);_tmp145;});}goto _LL152;_LL156: span=({struct Cyc_Core_Opt*
_tmp146=_cycalloc_atomic(sizeof(struct Cyc_Core_Opt));_tmp146->v=(void*)1;_tmp146;});
goto _LL152;_LL158: span=({void*_tmp147[0]={};((struct Cyc_Core_Opt*(*)(struct
...
fields->hd)->name)== 0){ps=({struct Cyc_List_List*_tmp151=_cycalloc(sizeof(struct
Cyc_List_List));_tmp151->hd=(void*)Cyc_Tcpat_compile_pat(_tmp14A);_tmp151->tl=ps;
...
_cycalloc_atomic(sizeof(struct Cyc_Core_Opt));_tmp154->v=(void*)span;_tmp154;}),0);
goto _LL105;}_LL121: {struct Cyc_List_List*fields;{void*_tmp155=Cyc_Tcutil_compress(
...
_tmp133->name).f2,({struct Cyc_Core_Opt*_tmp158=_cycalloc_atomic(sizeof(struct Cyc_Core_Opt));
...
_tmp160=_cycalloc(sizeof(struct Cyc_Tcpat_Neg_struct));_tmp160[0]=({struct Cyc_Tcpat_Neg_struct
...
struct Cyc_List_List));_tmp16D->hd=({struct _tuple11*_tmp16E=_cycalloc(sizeof(
struct _tuple11));_tmp16E->f1=_tmp16C;_tmp16E->f2=(struct Cyc_List_List*)({struct
Cyc_List_List*_tmp16F=_cycalloc(sizeof(struct Cyc_List_List));_tmp16F->hd=(void*)
dsc;_tmp16F->tl=_tmp16B;_tmp16F;});_tmp16E;});_tmp16D->tl=_tmp168;_tmp16D;});
_LL177:;}static struct Cyc_List_List*Cyc_Tcpat_norm_context(struct Cyc_List_List*
ctxt){struct Cyc_List_List*_tmp170=ctxt;struct Cyc_List_List _tmp171;struct Cyc_List_List*
_tmp172;struct _tuple11*_tmp173;struct _tuple11 _tmp174;struct Cyc_List_List*_tmp175;
struct Cyc_Tcpat_Con_s*_tmp176;_LL181: if(_tmp170 == 0){goto _LL182;}else{goto _LL183;}
_LL183: if(_tmp170 == 0){goto _LL180;}else{_tmp171=*_tmp170;_LL186: _tmp173=(struct
_tuple11*)_tmp171.hd;_tmp174=*_tmp173;_LL188: _tmp176=_tmp174.f1;goto _LL187;
_LL187: _tmp175=_tmp174.f2;goto _LL185;_LL185: _tmp172=_tmp171.tl;goto _LL184;}
_LL182: return({void*_tmp177[0]={};((struct Cyc_List_List*(*)(struct _tagged_arr fmt,
struct _tagged_arr ap))Cyc_Tcutil_impos)(_tag_arr("norm_context: empty context",
sizeof(unsigned char),28),_tag_arr(_tmp177,sizeof(void*),0));});_LL184: return Cyc_Tcpat_augment(
_tmp172,(void*)({struct Cyc_Tcpat_Pos_struct*_tmp178=_cycalloc(sizeof(struct Cyc_Tcpat_Pos_struct));
_tmp178[0]=({struct Cyc_Tcpat_Pos_struct _tmp179;_tmp179.tag=0;_tmp179.f1=_tmp176;
_tmp179.f2=Cyc_List_rev(_tmp175);_tmp179;});_tmp178;}));_LL180:;}static void*Cyc_Tcpat_build_desc(
...
_tmp18F=({struct Cyc_Tcpat_Pos_struct*_tmp190=_cycalloc(sizeof(struct Cyc_Tcpat_Pos_struct));
_tmp190[0]=({struct Cyc_Tcpat_Pos_struct _tmp191;_tmp191.tag=0;_tmp191.f1=_tmp18C;
_tmp191.f2=Cyc_List_append(Cyc_List_rev(_tmp18B),({struct Cyc_List_List*_tmp192=
_cycalloc(sizeof(struct Cyc_List_List));_tmp192->hd=(void*)dsc;_tmp192->tl=
_tmp185;_tmp192;}));_tmp191;});_tmp190;});return Cyc_Tcpat_build_desc(_tmp188,(
void*)_tmp18F,_tmp182);}_LL189:;}static void*Cyc_Tcpat_match(void*p,struct Cyc_List_List*
...
dsc,struct Cyc_List_List*allmrules){struct Cyc_List_List*_tmp193=allmrules;struct
Cyc_List_List _tmp194;struct Cyc_List_List*_tmp195;struct _tuple0*_tmp196;struct
_tuple0 _tmp197;void*_tmp198;void*_tmp199;_LL1A0: if(_tmp193 == 0){goto _LL1A1;}
else{goto _LL1A2;}_LL1A2: if(_tmp193 == 0){goto _LL19F;}else{_tmp194=*_tmp193;_LL1A5:
_tmp196=(struct _tuple0*)_tmp194.hd;_tmp197=*_tmp196;_LL1A7: _tmp199=_tmp197.f1;
goto _LL1A6;_LL1A6: _tmp198=_tmp197.f2;goto _LL1A4;_LL1A4: _tmp195=_tmp194.tl;goto
_LL1A3;}_LL1A1: return(void*)0;_LL1A3: return Cyc_Tcpat_match(_tmp199,0,dsc,0,0,
_tmp198,_tmp195);_LL19F:;}static void*Cyc_Tcpat_match_compile(struct Cyc_List_List*
allmrules){return Cyc_Tcpat_or_match((void*)({struct Cyc_Tcpat_Neg_struct*_tmp19A=
_cycalloc(sizeof(struct Cyc_Tcpat_Neg_struct));_tmp19A[0]=({struct Cyc_Tcpat_Neg_struct
...
_tmp1AB=_cycalloc(sizeof(struct Cyc_Tcpat_Success_struct));_tmp1AB[0]=({struct Cyc_Tcpat_Success_struct
...
_cycalloc(sizeof(struct _tuple10));_tmp1BC->f1=_tmp1B0;_tmp1BC->f2=_tmp1B4;
_tmp1BC->f3=_tmp1B8;_tmp1BC;});return Cyc_Tcpat_match(_tmp1B1,_tmp1B5,_tmp1B9,ctx,({
struct Cyc_List_List*_tmp1BB=_cycalloc(sizeof(struct Cyc_List_List));_tmp1BB->hd=
_tmp1BA;_tmp1BB->tl=_tmp1A5;_tmp1BB;}),right_hand_side,rules);}}}}_LL1A8:;}
static struct Cyc_List_List*Cyc_Tcpat_getdargs(struct Cyc_Tcpat_Con_s*pcon,void*dsc){
void*_tmp1BD=dsc;struct Cyc_Set_Set*_tmp1BE;struct Cyc_List_List*_tmp1BF;_LL1C3:
if(*((int*)_tmp1BD)== 1){_LL1C7: _tmp1BE=((struct Cyc_Tcpat_Neg_struct*)_tmp1BD)->f1;
goto _LL1C4;}else{goto _LL1C5;}_LL1C5: if(*((int*)_tmp1BD)== 0){_LL1C8: _tmp1BF=((
struct Cyc_Tcpat_Pos_struct*)_tmp1BD)->f2;goto _LL1C6;}else{goto _LL1C2;}_LL1C4: {
void*any=(void*)({struct Cyc_Tcpat_Neg_struct*_tmp1C2=_cycalloc(sizeof(struct Cyc_Tcpat_Neg_struct));
_tmp1C2[0]=({struct Cyc_Tcpat_Neg_struct _tmp1C3;_tmp1C3.tag=1;_tmp1C3.f1=Cyc_Tcpat_empty_con_set();
_tmp1C3;});_tmp1C2;});struct Cyc_List_List*_tmp1C0=0;{int i=0;for(0;i < pcon->arity;
++ i){_tmp1C0=({struct Cyc_List_List*_tmp1C1=_cycalloc(sizeof(struct Cyc_List_List));
_tmp1C1->hd=(void*)any;_tmp1C1->tl=_tmp1C0;_tmp1C1;});}}return _tmp1C0;}_LL1C6:
return _tmp1BF;_LL1C2:;}static struct Cyc_List_List*Cyc_Tcpat_getoarg(struct Cyc_List_List*
obj,int i){return({struct Cyc_List_List*_tmp1C4=_cycalloc(sizeof(struct Cyc_List_List));
_tmp1C4->hd=(void*)(i + 1);_tmp1C4->tl=obj;_tmp1C4;});}static struct Cyc_List_List*
...
void*_tmp1C5=p;struct Cyc_List_List*_tmp1C6;struct Cyc_Tcpat_Con_s*_tmp1C7;_LL1CA:
if((int)_tmp1C5 == 0){goto _LL1CB;}else{goto _LL1CC;}_LL1CC: if((unsigned int)
_tmp1C5 > 1?*((int*)_tmp1C5)== 0: 0){_LL1CF: _tmp1C7=((struct Cyc_Tcpat_Con_struct*)
_tmp1C5)->f1;goto _LL1CE;_LL1CE: _tmp1C6=((struct Cyc_Tcpat_Con_struct*)_tmp1C5)->f2;
goto _LL1CD;}else{goto _LL1C9;}_LL1CB: return Cyc_Tcpat_and_match(Cyc_Tcpat_augment(
ctx,dsc),work,right_hand_side,rules);_LL1CD: {void*_tmp1C8=Cyc_Tcpat_static_match(
_tmp1C7,dsc);_LL1D1: if((int)_tmp1C8 == 0){goto _LL1D2;}else{goto _LL1D3;}_LL1D3: if((
int)_tmp1C8 == 1){goto _LL1D4;}else{goto _LL1D5;}_LL1D5: if((int)_tmp1C8 == 2){goto
_LL1D6;}else{goto _LL1D0;}_LL1D2: {struct Cyc_List_List*_tmp1C9=({struct Cyc_List_List*
_tmp1CE=_cycalloc(sizeof(struct Cyc_List_List));_tmp1CE->hd=({struct _tuple11*
_tmp1CF=_cycalloc(sizeof(struct _tuple11));_tmp1CF->f1=_tmp1C7;_tmp1CF->f2=0;
_tmp1CF;});_tmp1CE->tl=ctx;_tmp1CE;});struct _tuple10*_tmp1CA=({struct _tuple10*
_tmp1CD=_cycalloc(sizeof(struct _tuple10));_tmp1CD->f1=_tmp1C6;_tmp1CD->f2=Cyc_Tcpat_getoargs(
_tmp1C7,obj);_tmp1CD->f3=Cyc_Tcpat_getdargs(_tmp1C7,dsc);_tmp1CD;});struct Cyc_List_List*
_tmp1CB=({struct Cyc_List_List*_tmp1CC=_cycalloc(sizeof(struct Cyc_List_List));
_tmp1CC->hd=_tmp1CA;_tmp1CC->tl=work;_tmp1CC;});return Cyc_Tcpat_and_match(
_tmp1C9,_tmp1CB,right_hand_side,rules);}_LL1D4: return Cyc_Tcpat_or_match(Cyc_Tcpat_build_desc(
ctx,dsc,work),rules);_LL1D6: {struct Cyc_List_List*_tmp1D0=({struct Cyc_List_List*
_tmp1D9=_cycalloc(sizeof(struct Cyc_List_List));_tmp1D9->hd=({struct _tuple11*
_tmp1DA=_cycalloc(sizeof(struct _tuple11));_tmp1DA->f1=_tmp1C7;_tmp1DA->f2=0;
_tmp1DA;});_tmp1D9->tl=ctx;_tmp1D9;});struct _tuple10*_tmp1D1=({struct _tuple10*
_tmp1D8=_cycalloc(sizeof(struct _tuple10));_tmp1D8->f1=_tmp1C6;_tmp1D8->f2=Cyc_Tcpat_getoargs(
_tmp1C7,obj);_tmp1D8->f3=Cyc_Tcpat_getdargs(_tmp1C7,dsc);_tmp1D8;});struct Cyc_List_List*
_tmp1D2=({struct Cyc_List_List*_tmp1D7=_cycalloc(sizeof(struct Cyc_List_List));
_tmp1D7->hd=_tmp1D1;_tmp1D7->tl=work;_tmp1D7;});void*_tmp1D3=Cyc_Tcpat_and_match(
_tmp1D0,_tmp1D2,right_hand_side,rules);void*_tmp1D4=Cyc_Tcpat_or_match(Cyc_Tcpat_build_desc(
ctx,Cyc_Tcpat_add_neg(dsc,_tmp1C7),work),rules);return(void*)({struct Cyc_Tcpat_IfEq_struct*
_tmp1D5=_cycalloc(sizeof(struct Cyc_Tcpat_IfEq_struct));_tmp1D5[0]=({struct Cyc_Tcpat_IfEq_struct
...
_tuple12*_tmp1E4=_cycalloc(sizeof(struct _tuple12));_tmp1E4->f1=0;_tmp1E4->f2=(
swc->pattern)->loc;_tmp1E4;});void*sp;if(swc->where_clause != 0){sp=Cyc_Tcpat_tuple_pat(({
struct Cyc_List_List*_tmp1DF=_cycalloc(sizeof(struct Cyc_List_List));_tmp1DF->hd=(
void*)sp0;_tmp1DF->tl=({struct Cyc_List_List*_tmp1E0=_cycalloc(sizeof(struct Cyc_List_List));
_tmp1E0->hd=(void*)Cyc_Tcpat_int_pat(*r);_tmp1E0->tl=0;_tmp1E0;});_tmp1DF;}));*r=*
r + 1;}else{sp=Cyc_Tcpat_tuple_pat(({struct Cyc_List_List*_tmp1E1=_cycalloc(
sizeof(struct Cyc_List_List));_tmp1E1->hd=(void*)sp0;_tmp1E1->tl=({struct Cyc_List_List*
_tmp1E2=_cycalloc(sizeof(struct Cyc_List_List));_tmp1E2->hd=(void*)((void*)0);
_tmp1E2->tl=0;_tmp1E2;});_tmp1E1;}));}return({struct _tuple13*_tmp1E3=_cycalloc(
sizeof(struct _tuple13));_tmp1E3->f1=sp;_tmp1E3->f2=rhs;_tmp1E3;});}static void Cyc_Tcpat_not_exhaust_err(
struct Cyc_Position_Segment*loc){({void*_tmp1E5[0]={};Cyc_Tcutil_terr(loc,
_tag_arr("patterns may not be exhaustive",sizeof(unsigned char),31),_tag_arr(
_tmp1E5,sizeof(void*),0));});}static void Cyc_Tcpat_rule_occurs(int dummy,struct
_tuple12*rhs){(*rhs).f1=1;}void Cyc_Tcpat_check_switch_exhaustive(struct Cyc_Position_Segment*
loc,struct Cyc_List_List*swcs){int _tmp1E6=0;struct Cyc_List_List*_tmp1E7=((struct
Cyc_List_List*(*)(struct _tuple13*(*f)(int*,struct Cyc_Absyn_Switch_clause*),int*
env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcpat_get_match,& _tmp1E6,swcs);
...
_tmp1F5=_cycalloc(sizeof(struct Cyc_List_List));_tmp1F5->hd=({struct _tuple15*
_tmp1F6=_cycalloc(sizeof(struct _tuple15));_tmp1F6->f1=Cyc_Tcpat_compile_pat(p);
_tmp1F6->f2=0;_tmp1F6;});_tmp1F5->tl=0;_tmp1F5;});void*_tmp1F2=((void*(*)(struct
Cyc_List_List*allmrules))Cyc_Tcpat_match_compile)(_tmp1F1);struct _tuple14*
_tmp1F3=({struct _tuple14*_tmp1F4=_cycalloc(sizeof(struct _tuple14));_tmp1F4->f1=
loc;_tmp1F4->f2=1;_tmp1F4;});((void(*)(void*d,void(*not_exhaust)(struct _tuple14*),
...
_tmp1F8=_cycalloc(sizeof(struct _tuple12));_tmp1F8->f1=0;_tmp1F8->f2=(swc->pattern)->loc;
_tmp1F8;});return({struct _tuple13*_tmp1F7=_cycalloc(sizeof(struct _tuple13));
_tmp1F7->f1=sp0;_tmp1F7->f2=rhs;_tmp1F7;});}static void Cyc_Tcpat_not_exhaust_err2(
struct Cyc_Position_Segment*loc){;}void Cyc_Tcpat_check_catch_overlap(struct Cyc_Position_Segment*
loc,struct Cyc_List_List*swcs){struct Cyc_List_List*_tmp1F9=((struct Cyc_List_List*(*)(
