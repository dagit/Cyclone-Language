...
tl;};void*Cyc_List_hd(struct Cyc_List_List*x);struct Cyc_List_List*Cyc_List_tl(
struct Cyc_List_List*x);extern unsigned char Cyc_List_List_mismatch[18];extern
unsigned char Cyc_List_Nth[8];int Cyc_List_mem(int(*compare)(void*,void*),struct
Cyc_List_List*l,void*x);int Cyc_List_list_cmp(int(*cmp)(void*,void*),struct Cyc_List_List*
l1,struct Cyc_List_List*l2);struct Cyc_Set_Set;struct Cyc_Set_Set*Cyc_Set_empty(int(*
cmp)(void*,void*));struct Cyc_Set_Set*Cyc_Set_insert(struct Cyc_Set_Set*s,void*elt);
int Cyc_Set_member(struct Cyc_Set_Set*s,void*elt);struct Cyc_List_List*Cyc_Set_elements(
struct Cyc_Set_Set*s);extern unsigned char Cyc_Set_Absent[11];struct Cyc_Dict_Dict;
...
void*env,struct Cyc_Dict_Dict*d,void*accum);void Cyc_Dict_iter_c(void(*f)(void*,
void*,void*),void*env,struct Cyc_Dict_Dict*d);struct Cyc_Dict_Dict*Cyc_Dict_map_c(
void*(*f)(void*,void*),void*env,struct Cyc_Dict_Dict*d);struct Cyc_Dict_Dict*Cyc_Dict_union_two_c(
...
int(*f)(void*,void*,void*),struct Cyc_Dict_Dict*d1,struct Cyc_Dict_Dict*d2);int Cyc_Std_zstrptrcmp(
...
15];struct _tagged_arr*Cyc_Absyn_fieldname(int);struct Cyc_Absyn_Aggrdecl*Cyc_Absyn_get_known_aggrdecl(
void*info);int Cyc_Absyn_is_union_type(void*);struct Cyc_Cstdio___abstractFILE;
...
struct _tuple0*);struct Cyc_CfFlowInfo_VarRoot_struct{int tag;struct Cyc_Absyn_Vardecl*
...
extern void*Cyc_CfFlowInfo_unknown_all;int Cyc_CfFlowInfo_root_cmp(void*,void*);
...
int Cyc_CfFlowInfo_root_cmp(void*r1,void*r2){if((int)r1 == (int)r2)return 0;{int p1;
int p2;{void*_tmp7=r1;struct Cyc_Absyn_Vardecl*_tmp8;struct Cyc_Absyn_Exp*_tmp9;
_LL1: if(*((int*)_tmp7)!= 0)goto _LL3;_tmp8=((struct Cyc_CfFlowInfo_VarRoot_struct*)
...
_tmp12,sizeof(void*),1));}});_tmp11;});_tmp10->tl=sl;_tmp10;});goto _LLA;_LLD: if(*((
int*)_tmpD)!= 1)goto _LLA;_tmpF=((struct Cyc_CfFlowInfo_MallocPt_struct*)_tmpD)->f1;
...
_tmp16,sizeof(void*),1));}});_tmp15;});_tmp14->tl=sl;_tmp14;});_LLA:;}{struct Cyc_List_List*
...
_tmp2E=Cyc_Absyn_get_known_aggrdecl(_tmp29);if(_tmp2E->fields == 0)goto _LLF;
_tmp2B=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp2E->fields))->v;
goto _LL17;}_LL16: if(_tmp23 <= (void*)3?1:*((int*)_tmp23)!= 11)goto _LL18;_tmp2A=(
void*)((struct Cyc_Absyn_AnonAggrType_struct*)_tmp23)->f1;if((int)_tmp2A != 0)goto
_LL18;_tmp2B=((struct Cyc_Absyn_AnonAggrType_struct*)_tmp23)->f2;_LL17: {struct
Cyc_Dict_Dict*d=((struct Cyc_Dict_Dict*(*)(int(*cmp)(struct _tagged_arr*,struct
_tagged_arr*)))Cyc_Dict_empty)(Cyc_Std_zstrptrcmp);for(0;_tmp2B != 0;_tmp2B=
_tmp2B->tl){struct Cyc_Absyn_Aggrfield _tmp30;struct _tagged_arr*_tmp31;void*_tmp32;
struct Cyc_Absyn_Aggrfield*_tmp2F=(struct Cyc_Absyn_Aggrfield*)_tmp2B->hd;_tmp30=*
_tmp2F;_tmp31=_tmp30.name;_tmp32=(void*)_tmp30.type;if(_get_arr_size(*_tmp31,
sizeof(unsigned char))!= 1)d=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,
struct _tagged_arr*k,void*v))Cyc_Dict_insert)(d,_tmp31,Cyc_CfFlowInfo_typ_to_absrval(
_tmp32,leafval));}return(void*)({struct Cyc_CfFlowInfo_Aggregate_struct*_tmp33=
_cycalloc(sizeof(*_tmp33));_tmp33[0]=({struct Cyc_CfFlowInfo_Aggregate_struct
_tmp34;_tmp34.tag=3;_tmp34.f1=d;_tmp34;});_tmp33;});}_LL18:;_LL19: goto _LLF;_LLF:;}
return Cyc_Tcutil_bits_only(t)?Cyc_CfFlowInfo_unknown_all: leafval;}static int Cyc_CfFlowInfo_prefix_of_member(
...
0)continue;{struct Cyc_List_List*_tmp37=place->fields;struct Cyc_List_List*_tmp38=
_tmp36->fields;for(0;_tmp37 != 0?_tmp38 != 0: 0;(_tmp37=_tmp37->tl,_tmp38=_tmp38->tl)){
if(Cyc_Std_zstrptrcmp((struct _tagged_arr*)_tmp37->hd,(struct _tagged_arr*)_tmp38->hd)
!= 0)break;}if(_tmp37 == 0)return 1;}}}return 0;}struct Cyc_CfFlowInfo_EscPile{
...
place))pile->places=({struct Cyc_List_List*_tmp39=_region_malloc(pile->rgn,
sizeof(*_tmp39));_tmp39->hd=place;_tmp39->tl=pile->places;_tmp39;});}static void
Cyc_CfFlowInfo_add_places(struct Cyc_CfFlowInfo_EscPile*pile,void*a,void*r){void*
_tmp3A=r;struct Cyc_CfFlowInfo_Place*_tmp3B;struct Cyc_Dict_Dict*_tmp3C;_LL1B: if(
_tmp3A <= (void*)3?1:*((int*)_tmp3A)!= 2)goto _LL1D;_tmp3B=((struct Cyc_CfFlowInfo_AddressOf_struct*)
_tmp3A)->f1;_LL1C: Cyc_CfFlowInfo_add_place(pile,_tmp3B);return;_LL1D: if(_tmp3A <= (
void*)3?1:*((int*)_tmp3A)!= 3)goto _LL1F;_tmp3C=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmp3A)->f1;_LL1E:((void(*)(void(*f)(struct Cyc_CfFlowInfo_EscPile*,struct
...
pile,_tmp3C);return;_LL1F:;_LL20: return;_LL1A:;}static void*Cyc_CfFlowInfo_insert_place_inner(
void*new_val,void*old_val){void*_tmp3D=old_val;struct Cyc_Dict_Dict*_tmp3E;_LL22:
if(_tmp3D <= (void*)3?1:*((int*)_tmp3D)!= 3)goto _LL24;_tmp3E=((struct Cyc_CfFlowInfo_Aggregate_struct*)
...
_tuple4{struct Cyc_List_List*f1;void*f2;};static void*Cyc_CfFlowInfo_insert_place_outer(
...
_tmp4D.f1=_tag_arr("bad insert place",sizeof(unsigned char),17);_tmp4D;});_tmp4C;}));
...
Cyc_Core_Impossible;_tmp59.f1=_tag_arr("initlevel_approx",sizeof(unsigned char),
17);_tmp59;});_tmp58;}));_LL37:;}static void*Cyc_CfFlowInfo_initlevel_rec(struct
Cyc_CfFlowInfo_InitlevelEnv*env,void*a,void*r,void*acc){void*this_ans;if(acc == (
void*)0)return(void*)0;{void*_tmp5A=r;struct Cyc_Dict_Dict*_tmp5B;struct Cyc_CfFlowInfo_Place*
_tmp5C;_LL45: if(_tmp5A <= (void*)3?1:*((int*)_tmp5A)!= 3)goto _LL47;_tmp5B=((
struct Cyc_CfFlowInfo_Aggregate_struct*)_tmp5A)->f1;_LL46: this_ans=((void*(*)(
void*(*f)(struct Cyc_CfFlowInfo_InitlevelEnv*,struct _tagged_arr*,void*,void*),
struct Cyc_CfFlowInfo_InitlevelEnv*env,struct Cyc_Dict_Dict*d,void*accum))Cyc_Dict_fold_c)((
void*(*)(struct Cyc_CfFlowInfo_InitlevelEnv*env,struct _tagged_arr*a,void*r,void*
acc))Cyc_CfFlowInfo_initlevel_rec,env,_tmp5B,(void*)2);goto _LL44;_LL47: if(_tmp5A
<= (void*)3?1:*((int*)_tmp5A)!= 2)goto _LL49;_tmp5C=((struct Cyc_CfFlowInfo_AddressOf_struct*)
_tmp5A)->f1;_LL48: if(((int(*)(int(*compare)(struct Cyc_CfFlowInfo_Place*,struct
Cyc_CfFlowInfo_Place*),struct Cyc_List_List*l,struct Cyc_CfFlowInfo_Place*x))Cyc_List_mem)(
Cyc_CfFlowInfo_place_cmp,env->seen,_tmp5C))this_ans=(void*)2;else{env->seen=({
struct Cyc_List_List*_tmp5D=_cycalloc(sizeof(*_tmp5D));_tmp5D->hd=_tmp5C;_tmp5D->tl=
env->seen;_tmp5D;});this_ans=((void*(*)(struct Cyc_CfFlowInfo_InitlevelEnv*env,
int a,void*r,void*acc))Cyc_CfFlowInfo_initlevel_rec)(env,0,Cyc_CfFlowInfo_lookup_place(
env->d,_tmp5C),(void*)2);env->seen=((struct Cyc_List_List*)_check_null(env->seen))->tl;
if(this_ans == (void*)0)this_ans=(void*)1;}goto _LL44;_LL49:;_LL4A: this_ans=Cyc_CfFlowInfo_initlevel_approx(
r);_LL44:;}if(this_ans == (void*)0)return(void*)0;if(this_ans == (void*)1?1: acc == (
void*)1)return(void*)1;return(void*)2;}void*Cyc_CfFlowInfo_initlevel(struct Cyc_Dict_Dict*
d,void*r){struct Cyc_CfFlowInfo_InitlevelEnv _tmp5E=({struct Cyc_CfFlowInfo_InitlevelEnv
...
_tmp63=_tmp63->tl){struct _tuple0 _tmp66=({struct _tuple0 _tmp65;_tmp65.f1=_tmp64;
...
_tmp6B.f1=_tag_arr("bad lookup_place",sizeof(unsigned char),17);_tmp6B;});_tmp6A;}));
...
_tmp73;void*_tmp74;struct Cyc_CfFlowInfo_Place*_tmp75;void*_tmp76;void*_tmp77;
struct Cyc_Dict_Dict*_tmp78;void*_tmp79;struct Cyc_Dict_Dict*_tmp7A;void*_tmp7B;
void*_tmp7C;_LL58: _tmp73=_tmp72.f1;if(_tmp73 <= (void*)3?1:*((int*)_tmp73)!= 1)
goto _LL5A;_tmp74=_tmp72.f2;if(_tmp74 <= (void*)3?1:*((int*)_tmp74)!= 2)goto _LL5A;
_tmp75=((struct Cyc_CfFlowInfo_AddressOf_struct*)_tmp74)->f1;_LL59: Cyc_CfFlowInfo_add_place(
env->pile,_tmp75);goto _LL5B;_LL5A: _tmp76=_tmp72.f1;if(_tmp76 <= (void*)3?1:*((int*)
_tmp76)!= 1)goto _LL5C;_LL5B: if(Cyc_CfFlowInfo_initlevel(env->d,newval)!= (void*)
2)({void*_tmp7D[0]={};Cyc_Tcutil_terr(env->loc,_tag_arr("assignment puts possibly-uninitialized data in an escaped location",
...
env,0,oldval,newval);{struct _tuple4 _tmp83=({struct _tuple4 _tmp82;_tmp82.f1=fs;
...
sizeof(unsigned char),17);_tmp8E;});_tmp8D;}));_LL69:;}}struct Cyc_Dict_Dict*Cyc_CfFlowInfo_assign_place(
...
r2);struct _tuple5 _tmpAD=({struct _tuple5 _tmpAC;_tmpAC.f1=r1;_tmpAC.f2=r2;_tmpAC;});
...
3?1:*((int*)_tmpAF)!= 1)goto _LL82;_LL81: {struct _tuple5 _tmpB1=({struct _tuple5
...
_LL8E: return Cyc_CfFlowInfo_esc_all;_LL84:;}_LL82:;_LL83: {struct _tuple5 _tmpB7=({
struct _tuple5 _tmpB6;_tmpB6.f1=il1;_tmpB6.f2=il2;_tmpB6;});void*_tmpB8;void*
...
1;{struct _tuple5 _tmpBD=({struct _tuple5 _tmpBC;_tmpBC.f1=r1;_tmpBC.f2=r2;_tmpBC;});
...
_tmpEC;struct Cyc_Dict_Dict*_tmpED;void*_tmpEE;struct Cyc_Dict_Dict*_tmpEF;_LLAF:
_tmpEC=_tmpEB.f1;if(_tmpEC <= (void*)3?1:*((int*)_tmpEC)!= 3)goto _LLB1;_tmpED=((
struct Cyc_CfFlowInfo_Aggregate_struct*)_tmpEC)->f1;_tmpEE=_tmpEB.f2;if(_tmpEE <= (
void*)3?1:*((int*)_tmpEE)!= 3)goto _LLB1;_tmpEF=((struct Cyc_CfFlowInfo_Aggregate_struct*)
...
_tag_arr("after_pathinfo -- non-aggregates!",sizeof(unsigned char),34);_tmpF4;});
_tmpF3;}));_LLAE:;}}static void*Cyc_CfFlowInfo_after_absRval_d(struct Cyc_CfFlowInfo_AfterEnv*
...
_tmpFE;struct Cyc_Dict_Dict*_tmpFF;struct Cyc_List_List*_tmp100;void*_tmp101;
struct Cyc_Dict_Dict*_tmp102;struct Cyc_List_List*_tmp103;_LLB4: _tmpFC=_tmpFB.f1;
if((int)_tmpFC != 0)goto _LLB6;_LLB5: goto _LLB7;_LLB6: _tmpFD=_tmpFB.f2;if((int)
_tmpFD != 0)goto _LLB8;_LLB7: return(void*)0;_LLB8: _tmpFE=_tmpFB.f1;if(_tmpFE <= (
void*)1?1:*((int*)_tmpFE)!= 0)goto _LLB3;_tmpFF=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
...
goto _LLCD;_LLCC: return 0;_LLCD:;_LLCE: goto _LLBA;_LLBA:;}{struct _tuple5 _tmp125=({
struct _tuple5 _tmp124;_tmp124.f1=Cyc_CfFlowInfo_initlevel_approx(r1);_tmp124.f2=
...
return 1;{struct _tuple5 _tmp130=({struct _tuple5 _tmp12F;_tmp12F.f1=f1;_tmp12F.f2=f2;
...
sizeof(unsigned char),5),_tag_arr(_tmp1A3,sizeof(void*),1));}});goto _LL146;
_LL149: if(*((int*)_tmp19D)!= 1)goto _LL14B;_tmp19F=((struct Cyc_CfFlowInfo_LessVar_struct*)
...
unsigned char),4),_tag_arr(_tmp1A5,sizeof(void*),1));}});goto _LL146;_LL14B: if(*((
int*)_tmp19D)!= 2)goto _LL14D;_tmp1A0=((struct Cyc_CfFlowInfo_LessSize_struct*)
_tmp19D)->f1;_LL14C:({struct Cyc_Std_String_pa_struct _tmp1A8;_tmp1A8.tag=0;
_tmp1A8.f1=(struct _tagged_arr)Cyc_Absynpp_qvar2string(_tmp1A0->name);{void*
_tmp1A7[1]={& _tmp1A8};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("<%s.size",sizeof(
unsigned char),9),_tag_arr(_tmp1A7,sizeof(void*),1));}});goto _LL146;_LL14D: if(*((
int*)_tmp19D)!= 3)goto _LL14F;_tmp1A1=((struct Cyc_CfFlowInfo_LessConst_struct*)
_tmp19D)->f1;_LL14E:({struct Cyc_Std_Int_pa_struct _tmp1AA;_tmp1AA.tag=1;_tmp1AA.f1=(
int)_tmp1A1;{void*_tmp1A9[1]={& _tmp1AA};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("<%d",
sizeof(unsigned char),4),_tag_arr(_tmp1A9,sizeof(void*),1));}});goto _LL146;
_LL14F: if(*((int*)_tmp19D)!= 4)goto _LL146;_tmp1A2=((struct Cyc_CfFlowInfo_LessEqSize_struct*)
_tmp19D)->f1;_LL150:({struct Cyc_Std_String_pa_struct _tmp1AC;_tmp1AC.tag=0;
_tmp1AC.f1=(struct _tagged_arr)Cyc_Absynpp_qvar2string(_tmp1A2->name);{void*
_tmp1AB[1]={& _tmp1AC};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("<=%s.size",
sizeof(unsigned char),10),_tag_arr(_tmp1AB,sizeof(void*),1));}});goto _LL146;
_LL146:;}}void Cyc_CfFlowInfo_print_relns(struct Cyc_List_List*r){for(0;r != 0;r=r->tl){
Cyc_CfFlowInfo_print_reln((struct Cyc_CfFlowInfo_Reln*)r->hd);if(r->tl != 0)({void*
_tmp1AD[0]={};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr(",",sizeof(unsigned char),
2),_tag_arr(_tmp1AD,sizeof(void*),0));});}}
