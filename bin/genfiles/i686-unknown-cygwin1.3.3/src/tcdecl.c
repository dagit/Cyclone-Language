...
extern unsigned char Cyc_List_Nth[8];struct Cyc_Lineno_Pos{struct _tagged_arr
...
struct _tuple0*,struct _tuple0*);struct Cyc_Absyn_Tqual Cyc_Absyn_empty_tqual();void*
Cyc_Absyn_force_kb(void*kb);struct _tagged_arr Cyc_Absyn_attribute2string(void*);
extern unsigned char Cyc_Tcdecl_Incompatible[17];struct Cyc_Tcdecl_Xtunionfielddecl{
...
_tuple4{void*f1;void*f2;};struct _tuple4*Cyc_Dict_rchoose(struct _RegionHandle*r,
struct Cyc_Dict_Dict*d);struct _tuple4*Cyc_Dict_rchoose(struct _RegionHandle*,
...
_tagged_arr);struct Cyc_Set_Set;extern unsigned char Cyc_Set_Absent[11];struct Cyc_RgnOrder_RgnPO;
...
struct _tuple0*);struct _tagged_arr Cyc_Absynpp_scope2string(void*sc);unsigned char
Cyc_Tcdecl_Incompatible[17]="\000\000\000\000Incompatible";void Cyc_Tcdecl_merr(
struct Cyc_Position_Segment*loc,struct _tagged_arr*msg1,struct _tagged_arr fmt,
struct _tagged_arr ap){if(msg1 == 0)(int)_throw((void*)Cyc_Tcdecl_Incompatible);{
struct _tagged_arr fmt2=(struct _tagged_arr)Cyc_Std_strconcat(_tag_arr("%s ",
sizeof(unsigned char),4),fmt);struct _tagged_arr ap2=({unsigned int _tmp0=
_get_arr_size(ap,sizeof(void*))+ 1;void**_tmp1=(void**)_cycalloc(_check_times(
sizeof(void*),_tmp0));struct _tagged_arr _tmp5=_tag_arr(_tmp1,sizeof(void*),
_get_arr_size(ap,sizeof(void*))+ 1);{unsigned int _tmp2=_tmp0;unsigned int i;for(i=
0;i < _tmp2;i ++){_tmp1[i]=i == 0?(void*)({struct Cyc_Std_String_pa_struct*_tmp3=
_cycalloc(sizeof(*_tmp3));_tmp3[0]=({struct Cyc_Std_String_pa_struct _tmp4;_tmp4.tag=
0;_tmp4.f1=(struct _tagged_arr)*msg1;_tmp4;});_tmp3;}):*((void**)
...
msg){({struct Cyc_Std_String_pa_struct _tmpA;_tmpA.tag=0;_tmpA.f1=(struct
_tagged_arr)Cyc_Absynpp_scope2string(s0);{struct Cyc_Std_String_pa_struct _tmp9;
_tmp9.tag=0;_tmp9.f1=(struct _tagged_arr)Cyc_Absynpp_scope2string(s1);{struct Cyc_Std_String_pa_struct
_tmp8;_tmp8.tag=0;_tmp8.f1=(struct _tagged_arr)v;{struct Cyc_Std_String_pa_struct
_tmp7;_tmp7.tag=0;_tmp7.f1=(struct _tagged_arr)t;{void*_tmp6[4]={& _tmp7,& _tmp8,&
_tmp9,& _tmpA};Cyc_Tcdecl_merr(loc,msg,_tag_arr("%s %s is %s whereas expected scope is %s",
sizeof(unsigned char),41),_tag_arr(_tmp6,sizeof(void*),4));}}}}});}struct _tuple3
Cyc_Tcdecl_merge_scope(void*s0,void*s1,struct _tagged_arr t,struct _tagged_arr v,
struct Cyc_Position_Segment*loc,struct _tagged_arr*msg){{struct _tuple4 _tmpC=({
struct _tuple4 _tmpB;_tmpB.f1=s0;_tmpB.f2=s1;_tmpB;});void*_tmpD;void*_tmpE;void*
_tmpF;void*_tmp10;void*_tmp11;void*_tmp12;void*_tmp13;void*_tmp14;void*_tmp15;
void*_tmp16;void*_tmp17;void*_tmp18;void*_tmp19;void*_tmp1A;_LL1: _tmpD=_tmpC.f1;
if((int)_tmpD != 4)goto _LL3;_tmpE=_tmpC.f2;if((int)_tmpE != 4)goto _LL3;_LL2: goto
_LL0;_LL3: _tmpF=_tmpC.f1;if((int)_tmpF != 4)goto _LL5;_LL4: goto _LL6;_LL5: _tmp10=
_tmpC.f2;if((int)_tmp10 != 4)goto _LL7;_LL6: Cyc_Tcdecl_merge_scope_err(s0,s1,t,v,
loc,msg);return({struct _tuple3 _tmp1B;_tmp1B.f1=s1;_tmp1B.f2=0;_tmp1B;});_LL7:
_tmp11=_tmpC.f2;if((int)_tmp11 != 3)goto _LL9;_LL8: s1=s0;goto _LL0;_LL9: _tmp12=
...
_tmp18=_tmpC.f2;if((int)_tmp18 != 1)goto _LL11;_LL10: goto _LL0;_LL11: _tmp19=_tmpC.f1;
if((int)_tmp19 != 5)goto _LL13;_tmp1A=_tmpC.f2;if((int)_tmp1A != 5)goto _LL13;_LL12:
goto _LL0;_LL13:;_LL14: Cyc_Tcdecl_merge_scope_err(s0,s1,t,v,loc,msg);return({
struct _tuple3 _tmp1C;_tmp1C.f1=s1;_tmp1C.f2=0;_tmp1C;});_LL0:;}return({struct
_tuple3 _tmp1D;_tmp1D.f1=s1;_tmp1D.f2=1;_tmp1D;});}static int Cyc_Tcdecl_check_type(
void*t0,void*t1){return Cyc_Tcutil_unify(t0,t1);}static unsigned int Cyc_Tcdecl_get_uint_const_value(
struct Cyc_Absyn_Exp*e){void*_tmp1E=(void*)e->r;void*_tmp1F;int _tmp20;_LL16: if(*((
int*)_tmp1E)!= 0)goto _LL18;_tmp1F=(void*)((struct Cyc_Absyn_Const_e_struct*)
_tmp1E)->f1;if(_tmp1F <= (void*)1?1:*((int*)_tmp1F)!= 2)goto _LL18;_tmp20=((struct
Cyc_Absyn_Int_c_struct*)_tmp1F)->f2;_LL17: return(unsigned int)_tmp20;_LL18:;
_LL19:(int)_throw((void*)({struct Cyc_Core_Invalid_argument_struct*_tmp21=
_cycalloc(sizeof(*_tmp21));_tmp21[0]=({struct Cyc_Core_Invalid_argument_struct
_tmp22;_tmp22.tag=Cyc_Core_Invalid_argument;_tmp22.f1=_tag_arr("Tcdecl::get_uint_const_value",
sizeof(unsigned char),29);_tmp22;});_tmp21;}));_LL15:;}inline static int Cyc_Tcdecl_check_tvs(
...
unsigned char),48),_tag_arr(_tmp23,sizeof(void*),2));}}});return 0;}{struct Cyc_List_List*
_tmp26=tvs0;struct Cyc_List_List*_tmp27=tvs1;for(0;_tmp26 != 0;(_tmp26=_tmp26->tl,
_tmp27=_tmp27->tl)){void*_tmp28=Cyc_Absyn_force_kb((void*)((struct Cyc_Absyn_Tvar*)
...
sizeof(unsigned char),59),_tag_arr(_tmp2A,sizeof(void*),5));}}}}}});return 0;}
...
sizeof(unsigned char),31),_tag_arr(_tmp30,sizeof(void*),2));}}});return 0;}return
...
d0->tvs,d1->tvs,_tag_arr("type",sizeof(unsigned char),5),_tmp37,loc,msg))return 0;{
void*_tmp3A;int _tmp3B;struct _tuple3 _tmp39=Cyc_Tcdecl_merge_scope((void*)d0->sc,(
void*)d1->sc,_tag_arr("type",sizeof(unsigned char),5),_tmp37,loc,msg);_tmp3A=
_tmp39.f1;_tmp3B=_tmp39.f2;if(!_tmp3B)_tmp38=0;if(!Cyc_Tcdecl_check_atts(d0->attributes,
d1->attributes,_tag_arr("type",sizeof(unsigned char),5),_tmp37,loc,msg))_tmp38=0;{
struct Cyc_Absyn_Aggrdecl*d2;{struct _tuple6 _tmp3D=({struct _tuple6 _tmp3C;_tmp3C.f1=
d0->impl;_tmp3C.f2=d1->impl;_tmp3C;});struct Cyc_Absyn_AggrdeclImpl*_tmp3E;struct
Cyc_Absyn_AggrdeclImpl*_tmp3F;struct Cyc_Absyn_AggrdeclImpl*_tmp40;struct Cyc_Absyn_AggrdeclImpl
_tmp41;struct Cyc_List_List*_tmp42;struct Cyc_List_List*_tmp43;struct Cyc_List_List*
_tmp44;struct Cyc_Absyn_AggrdeclImpl*_tmp45;struct Cyc_Absyn_AggrdeclImpl _tmp46;
struct Cyc_List_List*_tmp47;struct Cyc_List_List*_tmp48;struct Cyc_List_List*_tmp49;
_LL1B: _tmp3E=_tmp3D.f2;if(_tmp3E != 0)goto _LL1D;_LL1C: d2=d0;goto _LL1A;_LL1D:
_tmp3F=_tmp3D.f1;if(_tmp3F != 0)goto _LL1F;_LL1E: d2=d1;goto _LL1A;_LL1F: _tmp40=
_tmp3D.f1;if(_tmp40 == 0)goto _LL1A;_tmp41=*_tmp40;_tmp42=_tmp41.exist_vars;_tmp43=
_tmp41.rgn_po;_tmp44=_tmp41.fields;_tmp45=_tmp3D.f2;if(_tmp45 == 0)goto _LL1A;
_tmp46=*_tmp45;_tmp47=_tmp46.exist_vars;_tmp48=_tmp46.rgn_po;_tmp49=_tmp46.fields;
_LL20: if(!Cyc_Tcdecl_check_tvs(_tmp42,_tmp47,_tag_arr("type",sizeof(
unsigned char),5),_tmp37,loc,msg))return 0;{struct Cyc_List_List*_tmp4A=Cyc_Tcdecl_build_tvs_map(((
struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(
d0->tvs,_tmp42),((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*
y))Cyc_List_append)(d1->tvs,_tmp47));for(0;_tmp43 != 0?_tmp48 != 0: 0;(_tmp43=
_tmp43->tl,_tmp48=_tmp48->tl)){Cyc_Tcdecl_check_type((*((struct _tuple4*)_tmp43->hd)).f1,(*((
struct _tuple4*)_tmp48->hd)).f1);Cyc_Tcdecl_check_type((*((struct _tuple4*)_tmp43->hd)).f2,(*((
struct _tuple4*)_tmp48->hd)).f2);}for(0;_tmp44 != 0?_tmp49 != 0: 0;(_tmp44=_tmp44->tl,
_tmp49=_tmp49->tl)){struct Cyc_Absyn_Aggrfield _tmp4C;struct _tagged_arr*_tmp4D;
struct Cyc_Absyn_Tqual _tmp4E;void*_tmp4F;struct Cyc_Absyn_Exp*_tmp50;struct Cyc_List_List*
_tmp51;struct Cyc_Absyn_Aggrfield*_tmp4B=(struct Cyc_Absyn_Aggrfield*)_tmp44->hd;
_tmp4C=*_tmp4B;_tmp4D=_tmp4C.name;_tmp4E=_tmp4C.tq;_tmp4F=(void*)_tmp4C.type;
_tmp50=_tmp4C.width;_tmp51=_tmp4C.attributes;{struct Cyc_Absyn_Aggrfield _tmp53;
struct _tagged_arr*_tmp54;struct Cyc_Absyn_Tqual _tmp55;void*_tmp56;struct Cyc_Absyn_Exp*
_tmp57;struct Cyc_List_List*_tmp58;struct Cyc_Absyn_Aggrfield*_tmp52=(struct Cyc_Absyn_Aggrfield*)
_tmp49->hd;_tmp53=*_tmp52;_tmp54=_tmp53.name;_tmp55=_tmp53.tq;_tmp56=(void*)
_tmp53.type;_tmp57=_tmp53.width;_tmp58=_tmp53.attributes;if(Cyc_Std_zstrptrcmp(
_tmp4D,_tmp54)!= 0){({struct Cyc_Std_String_pa_struct _tmp5D;_tmp5D.tag=0;_tmp5D.f1=(
struct _tagged_arr)*_tmp54;{struct Cyc_Std_String_pa_struct _tmp5C;_tmp5C.tag=0;
_tmp5C.f1=(struct _tagged_arr)*_tmp4D;{struct Cyc_Std_String_pa_struct _tmp5B;
_tmp5B.tag=0;_tmp5B.f1=(struct _tagged_arr)_tmp37;{struct Cyc_Std_String_pa_struct
_tmp5A;_tmp5A.tag=0;_tmp5A.f1=_tag_arr("type",sizeof(unsigned char),5);{void*
_tmp59[4]={& _tmp5A,& _tmp5B,& _tmp5C,& _tmp5D};Cyc_Tcdecl_merr(loc,msg,_tag_arr("%s %s : field name mismatch %s != %s",
sizeof(unsigned char),37),_tag_arr(_tmp59,sizeof(void*),4));}}}}});return 0;}if(!
Cyc_Tcutil_same_atts(_tmp51,_tmp58)){({struct Cyc_Std_String_pa_struct _tmp61;
_tmp61.tag=0;_tmp61.f1=(struct _tagged_arr)*_tmp4D;{struct Cyc_Std_String_pa_struct
_tmp60;_tmp60.tag=0;_tmp60.f1=(struct _tagged_arr)_tmp37;{struct Cyc_Std_String_pa_struct
_tmp5F;_tmp5F.tag=0;_tmp5F.f1=_tag_arr("type",sizeof(unsigned char),5);{void*
_tmp5E[3]={& _tmp5F,& _tmp60,& _tmp61};Cyc_Tcdecl_merr(loc,msg,_tag_arr("%s %s : attribute mismatch on field %s",
sizeof(unsigned char),39),_tag_arr(_tmp5E,sizeof(void*),3));}}}});_tmp38=0;}if(!
Cyc_Tcutil_equal_tqual(_tmp4E,_tmp55)){({struct Cyc_Std_String_pa_struct _tmp65;
_tmp65.tag=0;_tmp65.f1=(struct _tagged_arr)*_tmp4D;{struct Cyc_Std_String_pa_struct
_tmp64;_tmp64.tag=0;_tmp64.f1=(struct _tagged_arr)_tmp37;{struct Cyc_Std_String_pa_struct
_tmp63;_tmp63.tag=0;_tmp63.f1=_tag_arr("type",sizeof(unsigned char),5);{void*
_tmp62[3]={& _tmp63,& _tmp64,& _tmp65};Cyc_Tcdecl_merr(loc,msg,_tag_arr("%s %s : qualifier mismatch on field %s",
sizeof(unsigned char),39),_tag_arr(_tmp62,sizeof(void*),3));}}}});_tmp38=0;}if((((
_tmp50 != 0?_tmp57 != 0: 0)?Cyc_Tcdecl_get_uint_const_value((struct Cyc_Absyn_Exp*)
...
_tag_arr("type",sizeof(unsigned char),5);{void*_tmp66[3]={& _tmp67,& _tmp68,&
_tmp69};Cyc_Tcdecl_merr(loc,msg,_tag_arr("%s %s : bitfield mismatch on field %s",
sizeof(unsigned char),38),_tag_arr(_tmp66,sizeof(void*),3));}}}});_tmp38=0;}{
void*subst_t1=Cyc_Tcutil_substitute(_tmp4A,_tmp56);if(!Cyc_Tcdecl_check_type(
_tmp4F,subst_t1)){({struct Cyc_Std_String_pa_struct _tmp6E;_tmp6E.tag=0;_tmp6E.f1=(
struct _tagged_arr)Cyc_Absynpp_typ2string(subst_t1);{struct Cyc_Std_String_pa_struct
_tmp6D;_tmp6D.tag=0;_tmp6D.f1=(struct _tagged_arr)Cyc_Absynpp_typ2string(_tmp4F);{
struct Cyc_Std_String_pa_struct _tmp6C;_tmp6C.tag=0;_tmp6C.f1=(struct _tagged_arr)*
_tmp4D;{struct Cyc_Std_String_pa_struct _tmp6B;_tmp6B.tag=0;_tmp6B.f1=(struct
_tagged_arr)_tmp37;{void*_tmp6A[4]={& _tmp6B,& _tmp6C,& _tmp6D,& _tmp6E};Cyc_Tcdecl_merr(
loc,msg,_tag_arr("type %s : type mismatch on field %s: %s != %s",sizeof(
unsigned char),46),_tag_arr(_tmp6A,sizeof(void*),4));}}}}});Cyc_Tcutil_explain_failure();
...
sizeof(unsigned char),28),_tag_arr(_tmp6F,sizeof(void*),2));}}});_tmp38=0;}if(
_tmp49 != 0){({struct Cyc_Std_String_pa_struct _tmp74;_tmp74.tag=0;_tmp74.f1=(
struct _tagged_arr)*((struct Cyc_Absyn_Aggrfield*)_tmp49->hd)->name;{struct Cyc_Std_String_pa_struct
...
unsigned char),27),_tag_arr(_tmp72,sizeof(void*),2));}}});_tmp38=0;}d2=d0;goto
_LL1A;}_LL1A:;}if(!_tmp38)return 0;if(_tmp3A == (void*)d2->sc)return(struct Cyc_Absyn_Aggrdecl*)
...
sizeof(unsigned char),8): _tag_arr("tunion",sizeof(unsigned char),7);}struct
_tuple7{struct Cyc_Absyn_Tqual f1;void*f2;};static struct Cyc_Absyn_Tunionfield*Cyc_Tcdecl_merge_tunionfield(
...
loc,msg,_tag_arr("%s %s: field name mismatch %s != %s",sizeof(unsigned char),36),
_tag_arr(_tmp76,sizeof(void*),4));}}}}});return 0;}{struct _tagged_arr _tmp7B=*(*f0->name).f2;
...
_tag_arr("in %s %s, field",sizeof(unsigned char),16),_tag_arr(_tmp7C,sizeof(void*),
2));}}}),_tmp7B,loc,msg);_tmp80=_tmp7F.f1;_tmp81=_tmp7F.f2;{struct Cyc_List_List*
_tmp82=f0->typs;struct Cyc_List_List*_tmp83=f1->typs;if(((int(*)(struct Cyc_List_List*
x))Cyc_List_length)(_tmp82)!= ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmp83)){({struct Cyc_Std_String_pa_struct _tmp87;_tmp87.tag=0;_tmp87.f1=(struct
_tagged_arr)_tmp7B;{struct Cyc_Std_String_pa_struct _tmp86;_tmp86.tag=0;_tmp86.f1=(
struct _tagged_arr)v;{struct Cyc_Std_String_pa_struct _tmp85;_tmp85.tag=0;_tmp85.f1=(
struct _tagged_arr)t;{void*_tmp84[3]={& _tmp85,& _tmp86,& _tmp87};Cyc_Tcdecl_merr(
loc,msg,_tag_arr("%s %s, field %s: parameter number mismatch",sizeof(
unsigned char),43),_tag_arr(_tmp84,sizeof(void*),3));}}}});_tmp81=0;}for(0;
_tmp82 != 0;(_tmp82=_tmp82->tl,_tmp83=_tmp83->tl)){if(!Cyc_Tcutil_equal_tqual((*((
...
sizeof(unsigned char),37),_tag_arr(_tmp88,sizeof(void*),3));}}}});_tmp81=0;}{
void*subst_t1=Cyc_Tcutil_substitute(inst,(*((struct _tuple7*)_tmp83->hd)).f2);if(
!Cyc_Tcdecl_check_type((*((struct _tuple7*)_tmp82->hd)).f2,subst_t1)){({struct Cyc_Std_String_pa_struct
_tmp91;_tmp91.tag=0;_tmp91.f1=(struct _tagged_arr)Cyc_Absynpp_typ2string(subst_t1);{
...
sizeof(unsigned char),50),_tag_arr(_tmp8C,sizeof(void*),5));}}}}}});Cyc_Tcutil_explain_failure();
...
_tag_arr("xtunion",sizeof(unsigned char),8),*v,loc,msg);}struct _tuple9{struct Cyc_Core_Opt*
...
struct _tagged_arr t=_tag_arr("[x]tunion",sizeof(unsigned char),10);int _tmpB1=1;
if(d0->is_xtunion != d1->is_xtunion){({struct Cyc_Std_String_pa_struct _tmpB5;
_tmpB5.tag=0;_tmpB5.f1=(struct _tagged_arr)Cyc_Tcdecl_is_x2string(d1->is_xtunion);{
struct Cyc_Std_String_pa_struct _tmpB4;_tmpB4.tag=0;_tmpB4.f1=(struct _tagged_arr)
Cyc_Tcdecl_is_x2string(d0->is_xtunion);{struct Cyc_Std_String_pa_struct _tmpB3;
_tmpB3.tag=0;_tmpB3.f1=(struct _tagged_arr)_tmpB0;{void*_tmpB2[3]={& _tmpB3,&
_tmpB4,& _tmpB5};Cyc_Tcdecl_merr(loc,msg,_tag_arr("expected %s to be a %s instead of a %s",
sizeof(unsigned char),39),_tag_arr(_tmpB2,sizeof(void*),3));}}}});_tmpB1=0;}
else{t=Cyc_Tcdecl_is_x2string(d0->is_xtunion);}if(!Cyc_Tcdecl_check_tvs(d0->tvs,
d1->tvs,t,_tmpB0,loc,msg))return 0;{void*_tmpB7;int _tmpB8;struct _tuple3 _tmpB6=Cyc_Tcdecl_merge_scope((
void*)d0->sc,(void*)d1->sc,t,_tmpB0,loc,msg);_tmpB7=_tmpB6.f1;_tmpB8=_tmpB6.f2;
if(!_tmpB8)_tmpB1=0;{struct Cyc_Absyn_Tuniondecl*d2;{struct _tuple9 _tmpBA=({struct
_tuple9 _tmpB9;_tmpB9.f1=d0->fields;_tmpB9.f2=d1->fields;_tmpB9;});struct Cyc_Core_Opt*
_tmpBB;struct Cyc_Core_Opt*_tmpBC;struct Cyc_Core_Opt*_tmpBD;struct Cyc_Core_Opt
_tmpBE;struct Cyc_List_List*_tmpBF;struct Cyc_Core_Opt*_tmpC0;struct Cyc_Core_Opt
_tmpC1;struct Cyc_List_List*_tmpC2;_LL22: _tmpBB=_tmpBA.f2;if(_tmpBB != 0)goto _LL24;
_LL23: d2=d0;goto _LL21;_LL24: _tmpBC=_tmpBA.f1;if(_tmpBC != 0)goto _LL26;_LL25: d2=d1;
goto _LL21;_LL26: _tmpBD=_tmpBA.f1;if(_tmpBD == 0)goto _LL21;_tmpBE=*_tmpBD;_tmpBF=(
struct Cyc_List_List*)_tmpBE.v;_tmpC0=_tmpBA.f2;if(_tmpC0 == 0)goto _LL21;_tmpC1=*
_tmpC0;_tmpC2=(struct Cyc_List_List*)_tmpC1.v;_LL27: {struct Cyc_List_List*_tmpC3=
Cyc_Tcdecl_build_tvs_map(d0->tvs,d1->tvs);if(d0->is_xtunion){int _tmpC4=1;struct
Cyc_List_List*_tmpC5=Cyc_Tcdecl_merge_xtunion_fields(_tmpBF,_tmpC2,_tmpC3,d0->tvs,
d1->tvs,& _tmpB1,& _tmpC4,t,_tmpB0,loc,msg);if(_tmpC4)d2=d0;else{d2=({struct Cyc_Absyn_Tuniondecl*
_tmpC6=_cycalloc(sizeof(*_tmpC6));_tmpC6[0]=*d0;_tmpC6;});(void*)(d2->sc=(void*)
_tmpB7);d2->fields=({struct Cyc_Core_Opt*_tmpC7=_cycalloc(sizeof(*_tmpC7));_tmpC7->v=
_tmpC5;_tmpC7;});}}else{for(0;_tmpBF != 0?_tmpC2 != 0: 0;(_tmpBF=_tmpBF->tl,_tmpC2=
_tmpC2->tl)){Cyc_Tcdecl_merge_tunionfield((struct Cyc_Absyn_Tunionfield*)_tmpBF->hd,(
struct Cyc_Absyn_Tunionfield*)_tmpC2->hd,_tmpC3,t,_tmpB0,msg);}if(_tmpBF != 0){({
struct Cyc_Std_String_pa_struct _tmpCB;_tmpCB.tag=0;_tmpCB.f1=(struct _tagged_arr)*(*((
struct Cyc_Absyn_Tunionfield*)((struct Cyc_List_List*)_check_null(_tmpC2))->hd)->name).f2;{
struct Cyc_Std_String_pa_struct _tmpCA;_tmpCA.tag=0;_tmpCA.f1=(struct _tagged_arr)
_tmpB0;{struct Cyc_Std_String_pa_struct _tmpC9;_tmpC9.tag=0;_tmpC9.f1=(struct
_tagged_arr)t;{void*_tmpC8[3]={& _tmpC9,& _tmpCA,& _tmpCB};Cyc_Tcdecl_merr(loc,msg,
_tag_arr("%s %s has extra field %s",sizeof(unsigned char),25),_tag_arr(_tmpC8,
sizeof(void*),3));}}}});_tmpB1=0;}if(_tmpC2 != 0){({struct Cyc_Std_String_pa_struct
_tmpCF;_tmpCF.tag=0;_tmpCF.f1=(struct _tagged_arr)*(*((struct Cyc_Absyn_Tunionfield*)
_tmpC2->hd)->name).f2;{struct Cyc_Std_String_pa_struct _tmpCE;_tmpCE.tag=0;_tmpCE.f1=(
struct _tagged_arr)_tmpB0;{struct Cyc_Std_String_pa_struct _tmpCD;_tmpCD.tag=0;
_tmpCD.f1=(struct _tagged_arr)t;{void*_tmpCC[3]={& _tmpCD,& _tmpCE,& _tmpCF};Cyc_Tcdecl_merr(
loc,msg,_tag_arr("%s %s is missing field %s",sizeof(unsigned char),26),_tag_arr(
_tmpCC,sizeof(void*),3));}}}});_tmpB1=0;}d2=d0;}goto _LL21;}_LL21:;}if(!_tmpB1)
return 0;if(_tmpB7 == (void*)d2->sc)return(struct Cyc_Absyn_Tuniondecl*)d2;else{d2=({
struct Cyc_Absyn_Tuniondecl*_tmpD0=_cycalloc(sizeof(*_tmpD0));_tmpD0[0]=*d2;
_tmpD0;});(void*)(d2->sc=(void*)_tmpB7);return(struct Cyc_Absyn_Tuniondecl*)d2;}}}}
...
struct _tagged_arr _tmpD1=Cyc_Absynpp_qvar2string(d0->name);int _tmpD2=1;void*
_tmpD4;int _tmpD5;struct _tuple3 _tmpD3=Cyc_Tcdecl_merge_scope((void*)d0->sc,(void*)
d1->sc,_tag_arr("enum",sizeof(unsigned char),5),_tmpD1,loc,msg);_tmpD4=_tmpD3.f1;
_tmpD5=_tmpD3.f2;if(!_tmpD5)_tmpD2=0;{struct Cyc_Absyn_Enumdecl*d2;{struct _tuple9
_tmpD7=({struct _tuple9 _tmpD6;_tmpD6.f1=d0->fields;_tmpD6.f2=d1->fields;_tmpD6;});
struct Cyc_Core_Opt*_tmpD8;struct Cyc_Core_Opt*_tmpD9;struct Cyc_Core_Opt*_tmpDA;
struct Cyc_Core_Opt _tmpDB;struct Cyc_List_List*_tmpDC;struct Cyc_Core_Opt*_tmpDD;
struct Cyc_Core_Opt _tmpDE;struct Cyc_List_List*_tmpDF;_LL29: _tmpD8=_tmpD7.f2;if(
_tmpD8 != 0)goto _LL2B;_LL2A: d2=d0;goto _LL28;_LL2B: _tmpD9=_tmpD7.f1;if(_tmpD9 != 0)
goto _LL2D;_LL2C: d2=d1;goto _LL28;_LL2D: _tmpDA=_tmpD7.f1;if(_tmpDA == 0)goto _LL28;
_tmpDB=*_tmpDA;_tmpDC=(struct Cyc_List_List*)_tmpDB.v;_tmpDD=_tmpD7.f2;if(_tmpDD
== 0)goto _LL28;_tmpDE=*_tmpDD;_tmpDF=(struct Cyc_List_List*)_tmpDE.v;_LL2E: for(0;
_tmpDC != 0?_tmpDF != 0: 0;(_tmpDC=_tmpDC->tl,_tmpDF=_tmpDF->tl)){struct Cyc_Absyn_Enumfield
...
sizeof(unsigned char),38),_tag_arr(_tmpEE,sizeof(void*),3));}}}});_tmpD2=0;}if(
Cyc_Tcdecl_get_uint_const_value((struct Cyc_Absyn_Exp*)_check_null(_tmpE5))!= Cyc_Tcdecl_get_uint_const_value((
...
sizeof(unsigned char),34),_tag_arr(_tmpF2,sizeof(void*),2));}}});_tmpD2=0;}}}d2=
d0;goto _LL28;_LL28:;}if(!_tmpD2)return 0;if((void*)d2->sc == _tmpD4)return(struct
Cyc_Absyn_Enumdecl*)d2;else{d2=({struct Cyc_Absyn_Enumdecl*_tmpF5=_cycalloc(
sizeof(*_tmpF5));_tmpF5[0]=*d2;_tmpF5;});(void*)(d2->sc=(void*)_tmpD4);return(
...
_tmpF6=1;void*_tmpF8;int _tmpF9;struct _tuple3 _tmpF7=Cyc_Tcdecl_merge_scope(sc0,
sc1,t,v,loc,msg);_tmpF8=_tmpF7.f1;_tmpF9=_tmpF7.f2;if(!_tmpF9)_tmpF6=0;if(!Cyc_Tcdecl_check_type(
t0,t1)){({struct Cyc_Std_String_pa_struct _tmpFE;_tmpFE.tag=0;_tmpFE.f1=(struct
_tagged_arr)Cyc_Absynpp_typ2string(t0);{struct Cyc_Std_String_pa_struct _tmpFD;
_tmpFD.tag=0;_tmpFD.f1=(struct _tagged_arr)Cyc_Absynpp_typ2string(t1);{struct Cyc_Std_String_pa_struct
_tmpFC;_tmpFC.tag=0;_tmpFC.f1=(struct _tagged_arr)v;{struct Cyc_Std_String_pa_struct
_tmpFB;_tmpFB.tag=0;_tmpFB.f1=(struct _tagged_arr)t;{void*_tmpFA[4]={& _tmpFB,&
_tmpFC,& _tmpFD,& _tmpFE};Cyc_Tcdecl_merr(loc,msg,_tag_arr("%s %s has type \n%s\n instead of \n%s\n",
sizeof(unsigned char),36),_tag_arr(_tmpFA,sizeof(void*),4));}}}}});Cyc_Tcutil_explain_failure();
...
sizeof(unsigned char),36),_tag_arr(_tmpFF,sizeof(void*),2));}}});_tmpF6=0;}if(!
Cyc_Tcutil_same_atts(atts0,atts1)){({struct Cyc_Std_String_pa_struct _tmp104;
_tmp104.tag=0;_tmp104.f1=(struct _tagged_arr)v;{struct Cyc_Std_String_pa_struct
_tmp103;_tmp103.tag=0;_tmp103.f1=(struct _tagged_arr)t;{void*_tmp102[2]={& _tmp103,&
_tmp104};Cyc_Tcdecl_merr(loc,msg,_tag_arr("%s %s has different attributes",
sizeof(unsigned char),31),_tag_arr(_tmp102,sizeof(void*),2));}}});({void*_tmp105[
0]={};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("previous attributes: ",sizeof(
unsigned char),22),_tag_arr(_tmp105,sizeof(void*),0));});for(0;atts0 != 0;atts0=
atts0->tl){({struct Cyc_Std_String_pa_struct _tmp107;_tmp107.tag=0;_tmp107.f1=(
struct _tagged_arr)Cyc_Absyn_attribute2string((void*)atts0->hd);{void*_tmp106[1]={&
_tmp107};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("%s ",sizeof(unsigned char),4),
_tag_arr(_tmp106,sizeof(void*),1));}});}({void*_tmp108[0]={};Cyc_Std_fprintf(Cyc_Std_stderr,
_tag_arr("\ncurrent attributes: ",sizeof(unsigned char),22),_tag_arr(_tmp108,
...
_tag_arr("%s ",sizeof(unsigned char),4),_tag_arr(_tmp109,sizeof(void*),1));}});}({
void*_tmp10B[0]={};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("\n",sizeof(
unsigned char),2),_tag_arr(_tmp10B,sizeof(void*),0));});_tmpF6=0;}return({struct
_tuple3 _tmp10C;_tmp10C.f1=_tmpF8;_tmp10C.f2=_tmpF6;_tmp10C;});}struct Cyc_Absyn_Vardecl*
Cyc_Tcdecl_merge_vardecl(struct Cyc_Absyn_Vardecl*d0,struct Cyc_Absyn_Vardecl*d1,
struct Cyc_Position_Segment*loc,struct _tagged_arr*msg){struct _tagged_arr _tmp10D=
Cyc_Absynpp_qvar2string(d0->name);void*_tmp10F;int _tmp110;struct _tuple3 _tmp10E=
...
unsigned char),9),_tmp10D,loc,msg);_tmp10F=_tmp10E.f1;_tmp110=_tmp10E.f2;if(!
_tmp110)return 0;if((void*)d0->sc == _tmp10F)return(struct Cyc_Absyn_Vardecl*)d0;
else{struct Cyc_Absyn_Vardecl*_tmp111=({struct Cyc_Absyn_Vardecl*_tmp112=_cycalloc(
sizeof(*_tmp112));_tmp112[0]=*d0;_tmp112;});(void*)(((struct Cyc_Absyn_Vardecl*)
_check_null(_tmp111))->sc=(void*)_tmp10F);return _tmp111;}}struct Cyc_Absyn_Typedefdecl*
...
_tmp113=Cyc_Absynpp_qvar2string(d0->name);if(!Cyc_Tcdecl_check_tvs(d0->tvs,d1->tvs,
_tag_arr("typedef",sizeof(unsigned char),8),_tmp113,loc,msg))return 0;{struct Cyc_List_List*
_tmp114=Cyc_Tcdecl_build_tvs_map(d0->tvs,d1->tvs);if(d0->defn != 0?d1->defn != 0: 0){
void*subst_defn1=Cyc_Tcutil_substitute(_tmp114,(void*)((struct Cyc_Core_Opt*)
_check_null(d1->defn))->v);if(!Cyc_Tcdecl_check_type((void*)((struct Cyc_Core_Opt*)
_check_null(d0->defn))->v,subst_defn1)){({struct Cyc_Std_String_pa_struct _tmp118;
_tmp118.tag=0;_tmp118.f1=(struct _tagged_arr)Cyc_Absynpp_typ2string((void*)((
...
unsigned char),53),_tag_arr(_tmp115,sizeof(void*),3));}}}});return 0;}}return(
struct Cyc_Absyn_Typedefdecl*)d0;}}void*Cyc_Tcdecl_merge_binding(void*b0,void*b1,
struct Cyc_Position_Segment*loc,struct _tagged_arr*msg){struct _tuple4 _tmp11A=({
struct _tuple4 _tmp119;_tmp119.f1=b0;_tmp119.f2=b1;_tmp119;});void*_tmp11B;void*
_tmp11C;void*_tmp11D;struct Cyc_Absyn_Vardecl*_tmp11E;void*_tmp11F;struct Cyc_Absyn_Vardecl*
_tmp120;void*_tmp121;struct Cyc_Absyn_Vardecl*_tmp122;void*_tmp123;struct Cyc_Absyn_Fndecl*
_tmp124;void*_tmp125;void*_tmp126;struct Cyc_Absyn_Fndecl*_tmp127;void*_tmp128;
struct Cyc_Absyn_Fndecl*_tmp129;void*_tmp12A;struct Cyc_Absyn_Vardecl*_tmp12B;
_LL30: _tmp11B=_tmp11A.f1;if((int)_tmp11B != 0)goto _LL32;_tmp11C=_tmp11A.f2;if((
int)_tmp11C != 0)goto _LL32;_LL31: return(void*)0;_LL32: _tmp11D=_tmp11A.f1;if(
_tmp11D <= (void*)1?1:*((int*)_tmp11D)!= 0)goto _LL34;_tmp11E=((struct Cyc_Absyn_Global_b_struct*)
_tmp11D)->f1;_tmp11F=_tmp11A.f2;if(_tmp11F <= (void*)1?1:*((int*)_tmp11F)!= 0)
goto _LL34;_tmp120=((struct Cyc_Absyn_Global_b_struct*)_tmp11F)->f1;_LL33: {struct
Cyc_Absyn_Vardecl*_tmp12C=Cyc_Tcdecl_merge_vardecl(_tmp11E,_tmp120,loc,msg);if(
_tmp12C == 0)return(void*)0;if(_tmp12C == (struct Cyc_Absyn_Vardecl*)_tmp11E)return
b0;if(_tmp12C == (struct Cyc_Absyn_Vardecl*)_tmp120)return b1;return(void*)({struct
Cyc_Absyn_Global_b_struct*_tmp12D=_cycalloc(sizeof(*_tmp12D));_tmp12D[0]=({
struct Cyc_Absyn_Global_b_struct _tmp12E;_tmp12E.tag=0;_tmp12E.f1=(struct Cyc_Absyn_Vardecl*)
_check_null(_tmp12C);_tmp12E;});_tmp12D;});}_LL34: _tmp121=_tmp11A.f1;if(_tmp121
<= (void*)1?1:*((int*)_tmp121)!= 0)goto _LL36;_tmp122=((struct Cyc_Absyn_Global_b_struct*)
_tmp121)->f1;_tmp123=_tmp11A.f2;if(_tmp123 <= (void*)1?1:*((int*)_tmp123)!= 1)
goto _LL36;_tmp124=((struct Cyc_Absyn_Funname_b_struct*)_tmp123)->f1;_LL35: {int
_tmp130;struct _tuple3 _tmp12F=Cyc_Tcdecl_check_var_or_fn_decl((void*)_tmp122->sc,(
void*)_tmp122->type,_tmp122->tq,_tmp122->attributes,(void*)_tmp124->sc,(void*)((
struct Cyc_Core_Opt*)_check_null(_tmp124->cached_typ))->v,Cyc_Absyn_empty_tqual(),
_tmp124->attributes,_tag_arr("function",sizeof(unsigned char),9),Cyc_Absynpp_qvar2string(
...
sizeof(unsigned char),28),_tag_arr(_tmp131,sizeof(void*),1));}});return(void*)0;
_LL38: _tmp128=_tmp11A.f1;if(_tmp128 <= (void*)1?1:*((int*)_tmp128)!= 1)goto _LL3A;
...
_tmp12B->tq,_tmp12B->attributes,_tag_arr("variable",sizeof(unsigned char),9),Cyc_Absynpp_qvar2string(
...
sizeof(unsigned char),22);_tmp136;});_tmp135;}));_LL2F:;}struct Cyc_Tcdecl_Xtunionfielddecl*
Cyc_Tcdecl_merge_xtunionfielddecl(struct Cyc_Tcdecl_Xtunionfielddecl*d0,struct Cyc_Tcdecl_Xtunionfielddecl*
...
sizeof(unsigned char),46),_tag_arr(_tmp140,sizeof(void*),3));}}}});return 0;}if(!
Cyc_Tcdecl_check_tvs(_tmp139->tvs,_tmp13D->tvs,_tag_arr("xtunion",sizeof(
unsigned char),8),Cyc_Absynpp_qvar2string(_tmp139->name),loc,msg))return 0;{
struct Cyc_List_List*_tmp144=Cyc_Tcdecl_build_tvs_map(_tmp139->tvs,_tmp13D->tvs);
struct Cyc_Absyn_Tunionfield*_tmp145=Cyc_Tcdecl_merge_tunionfield(_tmp13A,_tmp13E,
_tmp144,_tag_arr("xtunionfield",sizeof(unsigned char),13),_tmp13F,msg);if(
_tmp145 == 0)return 0;if(_tmp145 == (struct Cyc_Absyn_Tunionfield*)_tmp13A)return(
