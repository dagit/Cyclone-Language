...
Cyc_remove_cfiles();exit(1);}return*_tmp59;}static struct Cyc_List_List*Cyc_also_suffix(
...
sizeof(*_tmp5E));_tmp5E->hd=(struct _tagged_arr*)dirs->hd;_tmp5E->tl=_tmp5D;
_tmp5E;});_tmp5D=({struct Cyc_List_List*_tmp5F=_cycalloc(sizeof(*_tmp5F));_tmp5F->hd=({
struct _tagged_arr*_tmp60=_cycalloc(sizeof(*_tmp60));_tmp60[0]=(struct _tagged_arr)
Cyc_Filename_concat(*((struct _tagged_arr*)dirs->hd),subdir);_tmp60;});_tmp5F->tl=
_tmp5D;_tmp5F;});}_tmp5D=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(
_tmp5D);return _tmp5D;}static int Cyc_is_other_special(char c){switch(c){case '\\':
_LL17: goto _LL18;case '"': _LL18: goto _LL19;case ';': _LL19: goto _LL1A;case '&': _LL1A:
goto _LL1B;case '(': _LL1B: goto _LL1C;case ')': _LL1C: goto _LL1D;case '|': _LL1D: goto
_LL1E;case '^': _LL1E: goto _LL1F;case '<': _LL1F: goto _LL20;case '>': _LL20: goto _LL21;
case ' ': _LL21: goto _LL22;case '\n': _LL22: goto _LL23;case '\t': _LL23: return 1;default:
_LL24: return 0;}}static struct _tagged_arr Cyc_sh_escape_string(struct _tagged_arr s){
unsigned int _tmp61=Cyc_Std_strlen(s);int _tmp62=0;int _tmp63=0;{int i=0;for(0;i < 
_tmp61;i ++){char _tmp64=*((const char*)_check_unknown_subscript(s,sizeof(char),i));
if(_tmp64 == '\'')_tmp62 ++;else{if(Cyc_is_other_special(_tmp64))_tmp63 ++;}}}if(
_tmp62 == 0?_tmp63 == 0: 0)return s;if(_tmp62 == 0)return(struct _tagged_arr)Cyc_Std_strconcat_l(({
struct _tagged_arr*_tmp65[3];_tmp65[2]=_init_tag_arr(_cycalloc(sizeof(struct
_tagged_arr)),"'",sizeof(char),2);_tmp65[1]=({struct _tagged_arr*_tmp67=_cycalloc(
sizeof(*_tmp67));_tmp67[0]=(struct _tagged_arr)s;_tmp67;});_tmp65[0]=
_init_tag_arr(_cycalloc(sizeof(struct _tagged_arr)),"'",sizeof(char),2);((struct
Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(_tag_arr(_tmp65,sizeof(
struct _tagged_arr*),3));}));{unsigned int _tmp69=(_tmp61 + _tmp62)+ _tmp63;struct
_tagged_arr _tmp6A=({unsigned int _tmp6E=_tmp69 + 1;char*_tmp6F=(char*)
_cycalloc_atomic(_check_times(sizeof(char),_tmp6E));struct _tagged_arr _tmp71=
_tag_arr(_tmp6F,sizeof(char),_tmp69 + 1);{unsigned int _tmp70=_tmp6E;unsigned int i;
for(i=0;i < _tmp70;i ++){_tmp6F[i]='\000';}}_tmp71;});int _tmp6B=0;int _tmp6C=0;for(
0;_tmp6B < _tmp61;_tmp6B ++){char _tmp6D=*((const char*)_check_unknown_subscript(s,
sizeof(char),_tmp6B));if(_tmp6D == '\''?1: Cyc_is_other_special(_tmp6D))*((char*)
_check_unknown_subscript(_tmp6A,sizeof(char),_tmp6C ++))='\\';*((char*)
_check_unknown_subscript(_tmp6A,sizeof(char),_tmp6C ++))=_tmp6D;}return(struct
_tagged_arr)_tmp6A;}}static struct _tagged_arr*Cyc_sh_escape_stringptr(struct
_tagged_arr*sp){return({struct _tagged_arr*_tmp72=_cycalloc(sizeof(*_tmp72));
_tmp72[0]=Cyc_sh_escape_string(*sp);_tmp72;});}static void Cyc_process_file(struct
_tagged_arr filename){struct _tagged_arr _tmp73=Cyc_make_base_filename(filename,Cyc_output_file);
struct _tagged_arr _tmp74=Cyc_Std_strconcat(_tmp73,_tag_arr(".cyp",sizeof(char),5));
struct _tagged_arr _tmp75=Cyc_Std_strconcat(_tmp73,_tag_arr(".cyci",sizeof(char),6));
struct _tagged_arr _tmp76=Cyc_Std_strconcat(_tmp73,_tag_arr(".cycio",sizeof(char),
7));struct _tagged_arr _tmp77=Cyc_Std_strconcat(_tmp73,_tag_arr(".c",sizeof(char),
3));if(Cyc_v_r)({struct Cyc_Std_String_pa_struct _tmp79;_tmp79.tag=0;_tmp79.f1=(
struct _tagged_arr)filename;{void*_tmp78[1]={& _tmp79};Cyc_Std_fprintf(Cyc_Std_stderr,
_tag_arr("Compiling %s\n",sizeof(char),14),_tag_arr(_tmp78,sizeof(void*),1));}});{
...
struct Cyc_Std___cycFILE*)_check_null(f0));{struct _tagged_arr _tmp7A=Cyc_Std_str_sepstr(({
struct Cyc_List_List*_tmpA6=_cycalloc(sizeof(*_tmpA6));_tmpA6->hd=_init_tag_arr(
_cycalloc(sizeof(struct _tagged_arr)),"",sizeof(char),1);_tmpA6->tl=((struct Cyc_List_List*(*)(
...
Cyc_cppargs));_tmpA6;}),_tag_arr(" ",sizeof(char),2));struct _tagged_arr
...
struct _tagged_arr)def_inc_path;{void*_tmp7B[1]={& _tmp7C};Cyc_Std_aprintf(
_tag_arr(" -I%s",sizeof(char),6),_tag_arr(_tmp7B,sizeof(void*),1));}});else{
stdinc_string=_tag_arr("",sizeof(char),1);}{struct _tagged_arr _tmp7D=Cyc_Std_getenv(
_tag_arr("CYCLONE_INCLUDE_PATH",sizeof(char),21));if(_tmp7D.curr != (_tag_arr(0,0,
0)).curr){struct Cyc_List_List*_tmp7E=Cyc_split_by_char((struct _tagged_arr)_tmp7D,':');
struct _tagged_arr _tmp7F=Cyc_Std_str_sepstr(({struct Cyc_List_List*_tmp83=
_cycalloc(sizeof(*_tmp83));_tmp83->hd=_init_tag_arr(_cycalloc(sizeof(struct
_tagged_arr)),"",sizeof(char),1);_tmp83->tl=((struct Cyc_List_List*(*)(struct
_tagged_arr*(*f)(struct _tagged_arr*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_sh_escape_stringptr,
_tmp7E);_tmp83;}),_tag_arr(" -I",sizeof(char),4));stdinc_string=(struct
_tagged_arr)({struct Cyc_Std_String_pa_struct _tmp82;_tmp82.tag=0;_tmp82.f1=(
struct _tagged_arr)stdinc_string;{struct Cyc_Std_String_pa_struct _tmp81;_tmp81.tag=
0;_tmp81.f1=(struct _tagged_arr)_tmp7F;{void*_tmp80[2]={& _tmp81,& _tmp82};Cyc_Std_aprintf(
_tag_arr("%s%s",sizeof(char),5),_tag_arr(_tmp80,sizeof(void*),2));}}});}{struct
_tagged_arr ofile_string;if(Cyc_stop_after_cpp_r){if(Cyc_output_file != 0)
ofile_string=(struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmp86;_tmp86.tag=
0;_tmp86.f1=(struct _tagged_arr)*((struct _tagged_arr*)_check_null(Cyc_output_file));{
void*_tmp85[1]={& _tmp86};Cyc_Std_aprintf(_tag_arr(" > %s",sizeof(char),6),
_tag_arr(_tmp85,sizeof(void*),1));}});else{ofile_string=_tag_arr("",sizeof(char),
1);}}else{ofile_string=(struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmp88;
_tmp88.tag=0;_tmp88.f1=(struct _tagged_arr)Cyc_sh_escape_string((struct
_tagged_arr)_tmp74);{void*_tmp87[1]={& _tmp88};Cyc_Std_aprintf(_tag_arr(" > %s",
sizeof(char),6),_tag_arr(_tmp87,sizeof(void*),1));}});}{struct _tagged_arr
...
else{fixup_string=(struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmp8A;
_tmp8A.tag=0;_tmp8A.f1=(struct _tagged_arr)*((struct _tagged_arr*)_check_null(Cyc_dependencies_target));{
void*_tmp89[1]={& _tmp8A};Cyc_Std_aprintf(_tag_arr(" | sed 's/^.*\\.cyc\\.o:/%s:/'",
sizeof(char),29),_tag_arr(_tmp89,sizeof(void*),1));}});}}else{fixup_string=
_tag_arr("",sizeof(char),1);}{struct _tagged_arr _tmp8B=({struct Cyc_Std_String_pa_struct
_tmpA5;_tmpA5.tag=0;_tmpA5.f1=(struct _tagged_arr)ofile_string;{struct Cyc_Std_String_pa_struct
_tmpA4;_tmpA4.tag=0;_tmpA4.f1=(struct _tagged_arr)fixup_string;{struct Cyc_Std_String_pa_struct
_tmpA3;_tmpA3.tag=0;_tmpA3.f1=(struct _tagged_arr)Cyc_sh_escape_string(filename);{
struct Cyc_Std_String_pa_struct _tmpA2;_tmpA2.tag=0;_tmpA2.f1=(struct _tagged_arr)
stdinc_string;{struct Cyc_Std_String_pa_struct _tmpA1;_tmpA1.tag=0;_tmpA1.f1=(
struct _tagged_arr)_tmp7A;{struct Cyc_Std_String_pa_struct _tmpA0;_tmpA0.tag=0;
_tmpA0.f1=(struct _tagged_arr)Cyc_cpp;{void*_tmp9F[6]={& _tmpA0,& _tmpA1,& _tmpA2,&
_tmpA3,& _tmpA4,& _tmpA5};Cyc_Std_aprintf(_tag_arr("%s %s%s %s%s%s",sizeof(char),
15),_tag_arr(_tmp9F,sizeof(void*),6));}}}}}}});if(Cyc_v_r)({struct Cyc_Std_String_pa_struct
_tmp8D;_tmp8D.tag=0;_tmp8D.f1=(struct _tagged_arr)_tmp8B;{void*_tmp8C[1]={& _tmp8D};
Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("%s\n",sizeof(char),4),_tag_arr(_tmp8C,
sizeof(void*),1));}});if(Cyc_Std_system((struct _tagged_arr)_tmp8B)!= 0){Cyc_compile_failure=
1;({void*_tmp8E[0]={};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("\nError: preprocessing\n",
sizeof(char),23),_tag_arr(_tmp8E,sizeof(void*),0));});return;}if(Cyc_stop_after_cpp_r)
return;Cyc_Position_reset_position((struct _tagged_arr)_tmp74);{struct Cyc_Std___cycFILE*
in_file=Cyc_try_file_open((struct _tagged_arr)_tmp74,_tag_arr("r",sizeof(char),2),
_tag_arr("file",sizeof(char),5));if(Cyc_compile_failure)return;{struct Cyc_List_List*
tds=0;{struct _handler_cons _tmp8F;_push_handler(& _tmp8F);{int _tmp91=0;if(setjmp(
_tmp8F.handler))_tmp91=1;if(!_tmp91){tds=((struct Cyc_List_List*(*)(struct
...
_check_null(in_file),tds);;_pop_handler();}else{void*_tmp90=(void*)_exn_thrown;
void*_tmp93=_tmp90;_LL27:;_LL28: Cyc_Std_file_close((struct Cyc_Std___cycFILE*)
_check_null(in_file));Cyc_remove_file((struct _tagged_arr)_tmp74);(int)_throw(
_tmp93);_LL29:;_LL2A:(void)_throw(_tmp93);_LL26:;}}}Cyc_Std_file_close((struct
Cyc_Std___cycFILE*)_check_null(in_file));if(Cyc_compile_failure){Cyc_remove_file((
struct _tagged_arr)_tmp74);return;}{struct Cyc_Tcenv_Tenv*_tmp94=Cyc_Tcenv_tc_init();
...
sizeof(char),14),Cyc_do_typecheck,_tmp94,tds);if(Cyc_compile_failure){Cyc_remove_file((
struct _tagged_arr)_tmp74);return;}tds=((struct Cyc_List_List*(*)(struct
...
_tagged_arr)_tmp74);return;}if(Cyc_ic_r){struct Cyc_Std___cycFILE*inter_file=Cyc_Std_fopen((
struct _tagged_arr)_tmp75,_tag_arr("r",sizeof(char),2));struct Cyc_Std___cycFILE*
inter_objfile=Cyc_try_file_open((struct _tagged_arr)_tmp76,_tag_arr("w",sizeof(
...
_tmp75);tds=((struct Cyc_List_List*(*)(struct _tagged_arr stage_name,struct Cyc_List_List*(*
...
struct _tuple10*_tmp95=_cycalloc(sizeof(*_tmp95));_tmp95->f1=_tmp94;_tmp95->f2=
inter_file;_tmp95->f3=(struct Cyc_Std___cycFILE*)_check_null(inter_objfile);
_tmp95;}),tds);if(inter_file != 0)Cyc_Std_file_close((struct Cyc_Std___cycFILE*)
...
struct _tagged_arr)_tmp74);return;}if(!Cyc_compile_failure)Cyc_Tcutil_flush_warnings();
Cyc_remove_file((struct _tagged_arr)_tmp74);if(Cyc_compile_failure)return;if(Cyc_tovc_r)
...
sizeof(char),12));else{out_file=Cyc_try_file_open((struct _tagged_arr)_tmp77,
_tag_arr("w",sizeof(char),2),_tag_arr("output file",sizeof(char),12));}}if(Cyc_compile_failure)
return;{struct _handler_cons _tmp96;_push_handler(& _tmp96);{int _tmp98=0;if(setjmp(
_tmp96.handler))_tmp98=1;if(!_tmp98){tds=((struct Cyc_List_List*(*)(struct
_tagged_arr stage_name,struct Cyc_List_List*(*f)(struct Cyc_Std___cycFILE*,struct
Cyc_List_List*),struct Cyc_Std___cycFILE*env,struct Cyc_List_List*tds))Cyc_do_stage)(
_tag_arr("printing",sizeof(char),9),Cyc_do_print,(struct Cyc_Std___cycFILE*)
_check_null(out_file),tds);;_pop_handler();}else{void*_tmp97=(void*)_exn_thrown;
void*_tmp9A=_tmp97;_LL2C:;_LL2D: Cyc_compile_failure=1;Cyc_Std_file_close((struct
Cyc_Std___cycFILE*)_check_null(out_file));Cyc_cfiles=({struct Cyc_List_List*
_tmp9B=_cycalloc(sizeof(*_tmp9B));_tmp9B->hd=({struct _tagged_arr*_tmp9C=
_cycalloc(sizeof(*_tmp9C));_tmp9C[0]=(struct _tagged_arr)_tmp77;_tmp9C;});_tmp9B->tl=
Cyc_cfiles;_tmp9B;});(int)_throw(_tmp9A);_LL2E:;_LL2F:(void)_throw(_tmp9A);_LL2B:;}}}
Cyc_Std_file_close((struct Cyc_Std___cycFILE*)_check_null(out_file));Cyc_cfiles=({
struct Cyc_List_List*_tmp9D=_cycalloc(sizeof(*_tmp9D));_tmp9D->hd=({struct
_tagged_arr*_tmp9E=_cycalloc(sizeof(*_tmp9E));_tmp9E[0]=(struct _tagged_arr)
_tmp77;_tmp9E;});_tmp9D->tl=Cyc_cfiles;_tmp9D;});}}}}}}}}}}}static char _tmpA8[8]="<final>";
static struct _tagged_arr Cyc_final_str={_tmpA8,_tmpA8,_tmpA8 + 8};static struct
...
struct _tagged_arr basename;{struct _handler_cons _tmpA9;_push_handler(& _tmpA9);{int
_tmpAB=0;if(setjmp(_tmpA9.handler))_tmpAB=1;if(!_tmpAB){basename=(struct
_tagged_arr)Cyc_Filename_chop_extension(*n);;_pop_handler();}else{void*_tmpAA=(
void*)_exn_thrown;void*_tmpAD=_tmpAA;_LL31: if(*((void**)_tmpAD)!= Cyc_Core_Invalid_argument)
goto _LL33;_LL32: basename=*n;goto _LL30;_LL33:;_LL34:(void)_throw(_tmpAD);_LL30:;}}}{
struct _tagged_arr _tmpAE=Cyc_Std_strconcat(basename,_tag_arr(".cycio",sizeof(char),
7));struct Cyc_Std___cycFILE*_tmpAF=Cyc_try_file_open((struct _tagged_arr)_tmpAE,
_tag_arr("rb",sizeof(char),3),_tag_arr("interface object file",sizeof(char),22));
if(_tmpAF == 0){Cyc_compile_failure=1;Cyc_remove_cfiles();exit(1);}Cyc_Position_reset_position((
struct _tagged_arr)_tmpAE);{struct Cyc_Interface_I*_tmpB0=Cyc_Interface_load((
struct Cyc_Std___cycFILE*)_check_null(_tmpAF));Cyc_Std_file_close((struct Cyc_Std___cycFILE*)
_check_null(_tmpAF));return _tmpB0;}}}}static int Cyc_is_cfile(struct _tagged_arr*n){
...
options=({struct _tuple11*_tmpEB[49];_tmpEB[48]=({struct _tuple11*_tmp17C=
_cycalloc(sizeof(*_tmp17C));_tmp17C->f1=_tag_arr("-noregister",sizeof(char),12);
_tmp17C->f2=0;_tmp17C->f3=_tag_arr("",sizeof(char),1);_tmp17C->f4=(void*)({
struct Cyc_Arg_Set_spec_struct*_tmp17D=_cycalloc(sizeof(*_tmp17D));_tmp17D[0]=({
struct Cyc_Arg_Set_spec_struct _tmp17E;_tmp17E.tag=3;_tmp17E.f1=& Cyc_Parse_no_register;
_tmp17E;});_tmp17D;});_tmp17C->f5=_tag_arr("Treat register storage class as public",
sizeof(char),39);_tmp17C;});_tmpEB[47]=({struct _tuple11*_tmp179=_cycalloc(
sizeof(*_tmp179));_tmp179->f1=_tag_arr("-warnboundschecks",sizeof(char),18);
_tmp179->f2=0;_tmp179->f3=_tag_arr("",sizeof(char),1);_tmp179->f4=(void*)({
struct Cyc_Arg_Set_spec_struct*_tmp17A=_cycalloc(sizeof(*_tmp17A));_tmp17A[0]=({
struct Cyc_Arg_Set_spec_struct _tmp17B;_tmp17B.tag=3;_tmp17B.f1=& Cyc_Toc_warn_bounds_checks;
_tmp17B;});_tmp17A;});_tmp179->f5=_tag_arr("Warn when bounds checks can't be eliminated",
sizeof(char),44);_tmp179;});_tmpEB[46]=({struct _tuple11*_tmp176=_cycalloc(
sizeof(*_tmp176));_tmp176->f1=_tag_arr("-printfullevars",sizeof(char),16);
_tmp176->f2=0;_tmp176->f3=_tag_arr("",sizeof(char),1);_tmp176->f4=(void*)({
struct Cyc_Arg_Set_spec_struct*_tmp177=_cycalloc(sizeof(*_tmp177));_tmp177[0]=({
struct Cyc_Arg_Set_spec_struct _tmp178;_tmp178.tag=3;_tmp178.f1=& Cyc_print_full_evars_r;
_tmp178;});_tmp177;});_tmp176->f5=_tag_arr("Print full information for evars (type debugging)",
sizeof(char),50);_tmp176;});_tmpEB[45]=({struct _tuple11*_tmp173=_cycalloc(
sizeof(*_tmp173));_tmp173->f1=_tag_arr("-printallkinds",sizeof(char),15);_tmp173->f2=
0;_tmp173->f3=_tag_arr("",sizeof(char),1);_tmp173->f4=(void*)({struct Cyc_Arg_Set_spec_struct*
_tmp174=_cycalloc(sizeof(*_tmp174));_tmp174[0]=({struct Cyc_Arg_Set_spec_struct
_tmp175;_tmp175.tag=3;_tmp175.f1=& Cyc_print_all_kinds_r;_tmp175;});_tmp174;});
_tmp173->f5=_tag_arr("Always print kinds of type variables",sizeof(char),37);
_tmp173;});_tmpEB[44]=({struct _tuple11*_tmp170=_cycalloc(sizeof(*_tmp170));
_tmp170->f1=_tag_arr("-printalltvars",sizeof(char),15);_tmp170->f2=0;_tmp170->f3=
_tag_arr("",sizeof(char),1);_tmp170->f4=(void*)({struct Cyc_Arg_Set_spec_struct*
_tmp171=_cycalloc(sizeof(*_tmp171));_tmp171[0]=({struct Cyc_Arg_Set_spec_struct
_tmp172;_tmp172.tag=3;_tmp172.f1=& Cyc_print_all_tvars_r;_tmp172;});_tmp171;});
_tmp170->f5=_tag_arr("Print all type variables (even implicit default effects)",
sizeof(char),57);_tmp170;});_tmpEB[43]=({struct _tuple11*_tmp16D=_cycalloc(
sizeof(*_tmp16D));_tmp16D->f1=_tag_arr("-noexpandtypedefs",sizeof(char),18);
_tmp16D->f2=0;_tmp16D->f3=_tag_arr("",sizeof(char),1);_tmp16D->f4=(void*)({
struct Cyc_Arg_Set_spec_struct*_tmp16E=_cycalloc(sizeof(*_tmp16E));_tmp16E[0]=({
struct Cyc_Arg_Set_spec_struct _tmp16F;_tmp16F.tag=3;_tmp16F.f1=& Cyc_noexpand_r;
_tmp16F;});_tmp16E;});_tmp16D->f5=_tag_arr("Don't expand typedefs in pretty printing",
sizeof(char),41);_tmp16D;});_tmpEB[42]=({struct _tuple11*_tmp16A=_cycalloc(
sizeof(*_tmp16A));_tmp16A->f1=_tag_arr("-noremoveunused",sizeof(char),16);
...
struct Cyc_Arg_Set_spec_struct _tmp16C;_tmp16C.tag=3;_tmp16C.f1=& Cyc_noshake_r;
_tmp16C;});_tmp16B;});_tmp16A->f5=_tag_arr("Don't remove externed variables that aren't used",
sizeof(char),49);_tmp16A;});_tmpEB[41]=({struct _tuple11*_tmp167=_cycalloc(
sizeof(*_tmp167));_tmp167->f1=_tag_arr("-nogc",sizeof(char),6);_tmp167->f2=0;
_tmp167->f3=_tag_arr("",sizeof(char),1);_tmp167->f4=(void*)({struct Cyc_Arg_Set_spec_struct*
_tmp168=_cycalloc(sizeof(*_tmp168));_tmp168[0]=({struct Cyc_Arg_Set_spec_struct
_tmp169;_tmp169.tag=3;_tmp169.f1=& Cyc_nogc_r;_tmp169;});_tmp168;});_tmp167->f5=
_tag_arr("Don't link in the garbage collector",sizeof(char),36);_tmp167;});
_tmpEB[40]=({struct _tuple11*_tmp164=_cycalloc(sizeof(*_tmp164));_tmp164->f1=
_tag_arr("-nocyc",sizeof(char),7);_tmp164->f2=0;_tmp164->f3=_tag_arr("",sizeof(
char),1);_tmp164->f4=(void*)({struct Cyc_Arg_Unit_spec_struct*_tmp165=_cycalloc(
sizeof(*_tmp165));_tmp165[0]=({struct Cyc_Arg_Unit_spec_struct _tmp166;_tmp166.tag=
0;_tmp166.f1=Cyc_set_nocyc;_tmp166;});_tmp165;});_tmp164->f5=_tag_arr("Don't add implicit namespace Cyc",
sizeof(char),33);_tmp164;});_tmpEB[39]=({struct _tuple11*_tmp161=_cycalloc(
sizeof(*_tmp161));_tmp161->f1=_tag_arr("-no-cpp-precomp",sizeof(char),16);
_tmp161->f2=0;_tmp161->f3=_tag_arr("",sizeof(char),1);_tmp161->f4=(void*)({
struct Cyc_Arg_Unit_spec_struct*_tmp162=_cycalloc(sizeof(*_tmp162));_tmp162[0]=({
struct Cyc_Arg_Unit_spec_struct _tmp163;_tmp163.tag=0;_tmp163.f1=Cyc_set_nocppprecomp;
_tmp163;});_tmp162;});_tmp161->f5=_tag_arr("Don't do smart preprocessing (mac only)",
sizeof(char),40);_tmp161;});_tmpEB[38]=({struct _tuple11*_tmp15E=_cycalloc(
sizeof(*_tmp15E));_tmp15E->f1=_tag_arr("-use-cpp",sizeof(char),9);_tmp15E->f2=0;
_tmp15E->f3=_tag_arr("<path>",sizeof(char),7);_tmp15E->f4=(void*)({struct Cyc_Arg_String_spec_struct*
_tmp15F=_cycalloc(sizeof(*_tmp15F));_tmp15F[0]=({struct Cyc_Arg_String_spec_struct
_tmp160;_tmp160.tag=5;_tmp160.f1=Cyc_set_cpp;_tmp160;});_tmp15F;});_tmp15E->f5=
_tag_arr("Indicate which preprocessor to use",sizeof(char),35);_tmp15E;});_tmpEB[
37]=({struct _tuple11*_tmp15B=_cycalloc(sizeof(*_tmp15B));_tmp15B->f1=_tag_arr("--noboundschecks",
sizeof(char),17);_tmp15B->f2=0;_tmp15B->f3=_tag_arr("",sizeof(char),1);_tmp15B->f4=(
void*)({struct Cyc_Arg_Unit_spec_struct*_tmp15C=_cycalloc(sizeof(*_tmp15C));
_tmp15C[0]=({struct Cyc_Arg_Unit_spec_struct _tmp15D;_tmp15D.tag=0;_tmp15D.f1=Cyc_set_noboundschecks;
_tmp15D;});_tmp15C;});_tmp15B->f5=_tag_arr("Disable bounds checks",sizeof(char),
22);_tmp15B;});_tmpEB[36]=({struct _tuple11*_tmp158=_cycalloc(sizeof(*_tmp158));
_tmp158->f1=_tag_arr("--nonullchecks",sizeof(char),15);_tmp158->f2=0;_tmp158->f3=
_tag_arr("",sizeof(char),1);_tmp158->f4=(void*)({struct Cyc_Arg_Unit_spec_struct*
_tmp159=_cycalloc(sizeof(*_tmp159));_tmp159[0]=({struct Cyc_Arg_Unit_spec_struct
_tmp15A;_tmp15A.tag=0;_tmp15A.f1=Cyc_set_nonullchecks;_tmp15A;});_tmp159;});
_tmp158->f5=_tag_arr("Disable null checks",sizeof(char),20);_tmp158;});_tmpEB[35]=({
struct _tuple11*_tmp155=_cycalloc(sizeof(*_tmp155));_tmp155->f1=_tag_arr("--nochecks",
sizeof(char),11);_tmp155->f2=0;_tmp155->f3=_tag_arr("",sizeof(char),1);_tmp155->f4=(
void*)({struct Cyc_Arg_Unit_spec_struct*_tmp156=_cycalloc(sizeof(*_tmp156));
_tmp156[0]=({struct Cyc_Arg_Unit_spec_struct _tmp157;_tmp157.tag=0;_tmp157.f1=Cyc_set_nochecks;
_tmp157;});_tmp156;});_tmp155->f5=_tag_arr("Disable bounds/null checks",sizeof(
char),27);_tmp155;});_tmpEB[34]=({struct _tuple11*_tmp152=_cycalloc(sizeof(*
_tmp152));_tmp152->f1=_tag_arr("--lineno",sizeof(char),9);_tmp152->f2=0;_tmp152->f3=
_tag_arr("",sizeof(char),1);_tmp152->f4=(void*)({struct Cyc_Arg_Unit_spec_struct*
_tmp153=_cycalloc(sizeof(*_tmp153));_tmp153[0]=({struct Cyc_Arg_Unit_spec_struct
_tmp154;_tmp154.tag=0;_tmp154.f1=Cyc_set_lineno;_tmp154;});_tmp153;});_tmp152->f5=
_tag_arr("Generate line numbers for debugging",sizeof(char),36);_tmp152;});
_tmpEB[33]=({struct _tuple11*_tmp14F=_cycalloc(sizeof(*_tmp14F));_tmp14F->f1=
_tag_arr("-save-c",sizeof(char),8);_tmp14F->f2=0;_tmp14F->f3=_tag_arr("",sizeof(
char),1);_tmp14F->f4=(void*)({struct Cyc_Arg_Set_spec_struct*_tmp150=_cycalloc(
sizeof(*_tmp150));_tmp150[0]=({struct Cyc_Arg_Set_spec_struct _tmp151;_tmp151.tag=
3;_tmp151.f1=& Cyc_save_c_r;_tmp151;});_tmp150;});_tmp14F->f5=_tag_arr("Don't delete temporary C files",
sizeof(char),31);_tmp14F;});_tmpEB[32]=({struct _tuple11*_tmp14C=_cycalloc(
sizeof(*_tmp14C));_tmp14C->f1=_tag_arr("-save-temps",sizeof(char),12);_tmp14C->f2=
0;_tmp14C->f3=_tag_arr("",sizeof(char),1);_tmp14C->f4=(void*)({struct Cyc_Arg_Unit_spec_struct*
_tmp14D=_cycalloc(sizeof(*_tmp14D));_tmp14D[0]=({struct Cyc_Arg_Unit_spec_struct
_tmp14E;_tmp14E.tag=0;_tmp14E.f1=Cyc_set_save_temps;_tmp14E;});_tmp14D;});
_tmp14C->f5=_tag_arr("Don't delete temporary files",sizeof(char),29);_tmp14C;});
_tmpEB[31]=({struct _tuple11*_tmp149=_cycalloc(sizeof(*_tmp149));_tmp149->f1=
_tag_arr("-tovc",sizeof(char),6);_tmp149->f2=0;_tmp149->f3=_tag_arr("",sizeof(
char),1);_tmp149->f4=(void*)({struct Cyc_Arg_Set_spec_struct*_tmp14A=_cycalloc(
sizeof(*_tmp14A));_tmp14A[0]=({struct Cyc_Arg_Set_spec_struct _tmp14B;_tmp14B.tag=
3;_tmp14B.f1=& Cyc_tovc_r;_tmp14B;});_tmp14A;});_tmp149->f5=_tag_arr("Avoid gcc extensions in C output",
sizeof(char),33);_tmp149;});_tmpEB[30]=({struct _tuple11*_tmp146=_cycalloc(
sizeof(*_tmp146));_tmp146->f1=_tag_arr("-up",sizeof(char),4);_tmp146->f2=0;
_tmp146->f3=_tag_arr("",sizeof(char),1);_tmp146->f4=(void*)({struct Cyc_Arg_Clear_spec_struct*
_tmp147=_cycalloc(sizeof(*_tmp147));_tmp147[0]=({struct Cyc_Arg_Clear_spec_struct
_tmp148;_tmp148.tag=4;_tmp148.f1=& Cyc_pp_r;_tmp148;});_tmp147;});_tmp146->f5=
_tag_arr("Ugly print",sizeof(char),11);_tmp146;});_tmpEB[29]=({struct _tuple11*
_tmp143=_cycalloc(sizeof(*_tmp143));_tmp143->f1=_tag_arr("-pp",sizeof(char),4);
_tmp143->f2=0;_tmp143->f3=_tag_arr("",sizeof(char),1);_tmp143->f4=(void*)({
struct Cyc_Arg_Set_spec_struct*_tmp144=_cycalloc(sizeof(*_tmp144));_tmp144[0]=({
struct Cyc_Arg_Set_spec_struct _tmp145;_tmp145.tag=3;_tmp145.f1=& Cyc_pp_r;_tmp145;});
_tmp144;});_tmp143->f5=_tag_arr("Pretty print",sizeof(char),13);_tmp143;});
_tmpEB[28]=({struct _tuple11*_tmp140=_cycalloc(sizeof(*_tmp140));_tmp140->f1=
_tag_arr("-ic",sizeof(char),4);_tmp140->f2=0;_tmp140->f3=_tag_arr("",sizeof(char),
1);_tmp140->f4=(void*)({struct Cyc_Arg_Set_spec_struct*_tmp141=_cycalloc(sizeof(*
_tmp141));_tmp141[0]=({struct Cyc_Arg_Set_spec_struct _tmp142;_tmp142.tag=3;
_tmp142.f1=& Cyc_ic_r;_tmp142;});_tmp141;});_tmp140->f5=_tag_arr("Activate the link-checker",
sizeof(char),26);_tmp140;});_tmpEB[27]=({struct _tuple11*_tmp13D=_cycalloc(
sizeof(*_tmp13D));_tmp13D->f1=_tag_arr("-stopafter-toc",sizeof(char),15);_tmp13D->f2=
0;_tmp13D->f3=_tag_arr("",sizeof(char),1);_tmp13D->f4=(void*)({struct Cyc_Arg_Set_spec_struct*
_tmp13E=_cycalloc(sizeof(*_tmp13E));_tmp13E[0]=({struct Cyc_Arg_Set_spec_struct
_tmp13F;_tmp13F.tag=3;_tmp13F.f1=& Cyc_toc_r;_tmp13F;});_tmp13E;});_tmp13D->f5=
_tag_arr("Stop after translation to C",sizeof(char),28);_tmp13D;});_tmpEB[26]=({
struct _tuple11*_tmp13A=_cycalloc(sizeof(*_tmp13A));_tmp13A->f1=_tag_arr("-stopafter-tc",
sizeof(char),14);_tmp13A->f2=0;_tmp13A->f3=_tag_arr("",sizeof(char),1);_tmp13A->f4=(
void*)({struct Cyc_Arg_Set_spec_struct*_tmp13B=_cycalloc(sizeof(*_tmp13B));
_tmp13B[0]=({struct Cyc_Arg_Set_spec_struct _tmp13C;_tmp13C.tag=3;_tmp13C.f1=& Cyc_tc_r;
_tmp13C;});_tmp13B;});_tmp13A->f5=_tag_arr("Stop after type checking",sizeof(
char),25);_tmp13A;});_tmpEB[25]=({struct _tuple11*_tmp137=_cycalloc(sizeof(*
_tmp137));_tmp137->f1=_tag_arr("-stopafter-parse",sizeof(char),17);_tmp137->f2=0;
_tmp137->f3=_tag_arr("",sizeof(char),1);_tmp137->f4=(void*)({struct Cyc_Arg_Set_spec_struct*
_tmp138=_cycalloc(sizeof(*_tmp138));_tmp138[0]=({struct Cyc_Arg_Set_spec_struct
_tmp139;_tmp139.tag=3;_tmp139.f1=& Cyc_parseonly_r;_tmp139;});_tmp138;});_tmp137->f5=
_tag_arr("Stop after parsing",sizeof(char),19);_tmp137;});_tmpEB[24]=({struct
_tuple11*_tmp134=_cycalloc(sizeof(*_tmp134));_tmp134->f1=_tag_arr("-E",sizeof(
char),3);_tmp134->f2=0;_tmp134->f3=_tag_arr("",sizeof(char),1);_tmp134->f4=(void*)({
struct Cyc_Arg_Set_spec_struct*_tmp135=_cycalloc(sizeof(*_tmp135));_tmp135[0]=({
struct Cyc_Arg_Set_spec_struct _tmp136;_tmp136.tag=3;_tmp136.f1=& Cyc_stop_after_cpp_r;
_tmp136;});_tmp135;});_tmp134->f5=_tag_arr("Stop after preprocessing",sizeof(
char),25);_tmp134;});_tmpEB[23]=({struct _tuple11*_tmp131=_cycalloc(sizeof(*
_tmp131));_tmp131->f1=_tag_arr("-MT",sizeof(char),4);_tmp131->f2=0;_tmp131->f3=
_tag_arr(" <target>",sizeof(char),10);_tmp131->f4=(void*)({struct Cyc_Arg_String_spec_struct*
_tmp132=_cycalloc(sizeof(*_tmp132));_tmp132[0]=({struct Cyc_Arg_String_spec_struct
_tmp133;_tmp133.tag=5;_tmp133.f1=Cyc_set_dependencies_target;_tmp133;});_tmp132;});
_tmp131->f5=_tag_arr("Give target for dependencies",sizeof(char),29);_tmp131;});
_tmpEB[22]=({struct _tuple11*_tmp12E=_cycalloc(sizeof(*_tmp12E));_tmp12E->f1=
_tag_arr("-MG",sizeof(char),4);_tmp12E->f2=0;_tmp12E->f3=_tag_arr("",sizeof(char),
1);_tmp12E->f4=(void*)({struct Cyc_Arg_Flag_spec_struct*_tmp12F=_cycalloc(sizeof(*
_tmp12F));_tmp12F[0]=({struct Cyc_Arg_Flag_spec_struct _tmp130;_tmp130.tag=1;
_tmp130.f1=Cyc_add_cpparg;_tmp130;});_tmp12F;});_tmp12E->f5=_tag_arr("When producing dependencies assume that missing files are generated",
sizeof(char),68);_tmp12E;});_tmpEB[21]=({struct _tuple11*_tmp12B=_cycalloc(
sizeof(*_tmp12B));_tmp12B->f1=_tag_arr("-M",sizeof(char),3);_tmp12B->f2=0;
_tmp12B->f3=_tag_arr("",sizeof(char),1);_tmp12B->f4=(void*)({struct Cyc_Arg_Unit_spec_struct*
_tmp12C=_cycalloc(sizeof(*_tmp12C));_tmp12C[0]=({struct Cyc_Arg_Unit_spec_struct
_tmp12D;_tmp12D.tag=0;_tmp12D.f1=Cyc_set_produce_dependencies;_tmp12D;});_tmp12C;});
_tmp12B->f5=_tag_arr("Produce dependencies",sizeof(char),21);_tmp12B;});_tmpEB[
20]=({struct _tuple11*_tmp128=_cycalloc(sizeof(*_tmp128));_tmp128->f1=_tag_arr("-S",
sizeof(char),3);_tmp128->f2=0;_tmp128->f3=_tag_arr("",sizeof(char),1);_tmp128->f4=(
void*)({struct Cyc_Arg_Unit_spec_struct*_tmp129=_cycalloc(sizeof(*_tmp129));
_tmp129[0]=({struct Cyc_Arg_Unit_spec_struct _tmp12A;_tmp12A.tag=0;_tmp12A.f1=Cyc_set_stop_after_asmfile;
_tmp12A;});_tmp129;});_tmp128->f5=_tag_arr("Stop after producing assembly code",
sizeof(char),35);_tmp128;});_tmpEB[19]=({struct _tuple11*_tmp125=_cycalloc(
sizeof(*_tmp125));_tmp125->f1=_tag_arr("-pa",sizeof(char),4);_tmp125->f2=0;
_tmp125->f3=_tag_arr("",sizeof(char),1);_tmp125->f4=(void*)({struct Cyc_Arg_Unit_spec_struct*
_tmp126=_cycalloc(sizeof(*_tmp126));_tmp126[0]=({struct Cyc_Arg_Unit_spec_struct
_tmp127;_tmp127.tag=0;_tmp127.f1=Cyc_set_pa;_tmp127;});_tmp126;});_tmp125->f5=
_tag_arr("Compile for profiling with aprof",sizeof(char),33);_tmp125;});_tmpEB[
18]=({struct _tuple11*_tmp122=_cycalloc(sizeof(*_tmp122));_tmp122->f1=_tag_arr("-pg",
sizeof(char),4);_tmp122->f2=0;_tmp122->f3=_tag_arr("",sizeof(char),1);_tmp122->f4=(
void*)({struct Cyc_Arg_Flag_spec_struct*_tmp123=_cycalloc(sizeof(*_tmp123));
_tmp123[0]=({struct Cyc_Arg_Flag_spec_struct _tmp124;_tmp124.tag=1;_tmp124.f1=Cyc_add_ccarg;
_tmp124;});_tmp123;});_tmp122->f5=_tag_arr("Compile for profiling with gprof",
sizeof(char),33);_tmp122;});_tmpEB[17]=({struct _tuple11*_tmp11F=_cycalloc(
sizeof(*_tmp11F));_tmp11F->f1=_tag_arr("-p",sizeof(char),3);_tmp11F->f2=0;
_tmp11F->f3=_tag_arr("",sizeof(char),1);_tmp11F->f4=(void*)({struct Cyc_Arg_Flag_spec_struct*
_tmp120=_cycalloc(sizeof(*_tmp120));_tmp120[0]=({struct Cyc_Arg_Flag_spec_struct
_tmp121;_tmp121.tag=1;_tmp121.f1=Cyc_add_ccarg;_tmp121;});_tmp120;});_tmp11F->f5=
_tag_arr("Compile for profiling with prof",sizeof(char),32);_tmp11F;});_tmpEB[16]=({
struct _tuple11*_tmp11C=_cycalloc(sizeof(*_tmp11C));_tmp11C->f1=_tag_arr("-g",
sizeof(char),3);_tmp11C->f2=0;_tmp11C->f3=_tag_arr("",sizeof(char),1);_tmp11C->f4=(
void*)({struct Cyc_Arg_Flag_spec_struct*_tmp11D=_cycalloc(sizeof(*_tmp11D));
_tmp11D[0]=({struct Cyc_Arg_Flag_spec_struct _tmp11E;_tmp11E.tag=1;_tmp11E.f1=Cyc_add_ccarg;
_tmp11E;});_tmp11D;});_tmp11C->f5=_tag_arr("Compile for debugging",sizeof(char),
22);_tmp11C;});_tmpEB[15]=({struct _tuple11*_tmp119=_cycalloc(sizeof(*_tmp119));
_tmp119->f1=_tag_arr("-fomit-frame-pointer",sizeof(char),21);_tmp119->f2=0;
_tmp119->f3=_tag_arr("",sizeof(char),1);_tmp119->f4=(void*)({struct Cyc_Arg_Flag_spec_struct*
_tmp11A=_cycalloc(sizeof(*_tmp11A));_tmp11A[0]=({struct Cyc_Arg_Flag_spec_struct
_tmp11B;_tmp11B.tag=1;_tmp11B.f1=Cyc_add_ccarg;_tmp11B;});_tmp11A;});_tmp119->f5=
_tag_arr("Omit frame pointer",sizeof(char),19);_tmp119;});_tmpEB[14]=({struct
_tuple11*_tmp116=_cycalloc(sizeof(*_tmp116));_tmp116->f1=_tag_arr("-O3",sizeof(
char),4);_tmp116->f2=0;_tmp116->f3=_tag_arr("",sizeof(char),1);_tmp116->f4=(void*)({
struct Cyc_Arg_Flag_spec_struct*_tmp117=_cycalloc(sizeof(*_tmp117));_tmp117[0]=({
struct Cyc_Arg_Flag_spec_struct _tmp118;_tmp118.tag=1;_tmp118.f1=Cyc_add_ccarg;
_tmp118;});_tmp117;});_tmp116->f5=_tag_arr("Even more optimization",sizeof(char),
23);_tmp116;});_tmpEB[13]=({struct _tuple11*_tmp113=_cycalloc(sizeof(*_tmp113));
_tmp113->f1=_tag_arr("-O2",sizeof(char),4);_tmp113->f2=0;_tmp113->f3=_tag_arr("",
sizeof(char),1);_tmp113->f4=(void*)({struct Cyc_Arg_Flag_spec_struct*_tmp114=
_cycalloc(sizeof(*_tmp114));_tmp114[0]=({struct Cyc_Arg_Flag_spec_struct _tmp115;
_tmp115.tag=1;_tmp115.f1=Cyc_add_ccarg;_tmp115;});_tmp114;});_tmp113->f5=
_tag_arr("A higher level of optimization",sizeof(char),31);_tmp113;});_tmpEB[12]=({
struct _tuple11*_tmp110=_cycalloc(sizeof(*_tmp110));_tmp110->f1=_tag_arr("-O",
sizeof(char),3);_tmp110->f2=0;_tmp110->f3=_tag_arr("",sizeof(char),1);_tmp110->f4=(
void*)({struct Cyc_Arg_Flag_spec_struct*_tmp111=_cycalloc(sizeof(*_tmp111));
_tmp111[0]=({struct Cyc_Arg_Flag_spec_struct _tmp112;_tmp112.tag=1;_tmp112.f1=Cyc_add_ccarg;
_tmp112;});_tmp111;});_tmp110->f5=_tag_arr("Optimize",sizeof(char),9);_tmp110;});
_tmpEB[11]=({struct _tuple11*_tmp10D=_cycalloc(sizeof(*_tmp10D));_tmp10D->f1=
_tag_arr("-O0",sizeof(char),4);_tmp10D->f2=0;_tmp10D->f3=_tag_arr("",sizeof(char),
1);_tmp10D->f4=(void*)({struct Cyc_Arg_Flag_spec_struct*_tmp10E=_cycalloc(sizeof(*
_tmp10E));_tmp10E[0]=({struct Cyc_Arg_Flag_spec_struct _tmp10F;_tmp10F.tag=1;
_tmp10F.f1=Cyc_add_ccarg;_tmp10F;});_tmp10E;});_tmp10D->f5=_tag_arr("Don't optimize",
sizeof(char),15);_tmp10D;});_tmpEB[10]=({struct _tuple11*_tmp10A=_cycalloc(
sizeof(*_tmp10A));_tmp10A->f1=_tag_arr("-s",sizeof(char),3);_tmp10A->f2=0;
_tmp10A->f3=_tag_arr("",sizeof(char),1);_tmp10A->f4=(void*)({struct Cyc_Arg_Flag_spec_struct*
...
char),60);_tmp10A;});_tmpEB[9]=({struct _tuple11*_tmp107=_cycalloc(sizeof(*
_tmp107));_tmp107->f1=_tag_arr("-x",sizeof(char),3);_tmp107->f2=0;_tmp107->f3=
_tag_arr(" <language>",sizeof(char),12);_tmp107->f4=(void*)({struct Cyc_Arg_String_spec_struct*
_tmp108=_cycalloc(sizeof(*_tmp108));_tmp108[0]=({struct Cyc_Arg_String_spec_struct
_tmp109;_tmp109.tag=5;_tmp109.f1=Cyc_set_inputtype;_tmp109;});_tmp108;});_tmp107->f5=
_tag_arr("Specify <language> for the following input files",sizeof(char),49);
_tmp107;});_tmpEB[8]=({struct _tuple11*_tmp104=_cycalloc(sizeof(*_tmp104));
_tmp104->f1=_tag_arr("-c",sizeof(char),3);_tmp104->f2=0;_tmp104->f3=_tag_arr("",
sizeof(char),1);_tmp104->f4=(void*)({struct Cyc_Arg_Unit_spec_struct*_tmp105=
_cycalloc(sizeof(*_tmp105));_tmp105[0]=({struct Cyc_Arg_Unit_spec_struct _tmp106;
_tmp106.tag=0;_tmp106.f1=Cyc_set_stop_after_objectfile;_tmp106;});_tmp105;});
_tmp104->f5=_tag_arr("Produce an object file instead of an executable; do not link",
sizeof(char),61);_tmp104;});_tmpEB[7]=({struct _tuple11*_tmp101=_cycalloc(sizeof(*
_tmp101));_tmp101->f1=_tag_arr("-l",sizeof(char),3);_tmp101->f2=1;_tmp101->f3=
_tag_arr("<file>",sizeof(char),7);_tmp101->f4=(void*)({struct Cyc_Arg_Flag_spec_struct*
_tmp102=_cycalloc(sizeof(*_tmp102));_tmp102[0]=({struct Cyc_Arg_Flag_spec_struct
_tmp103;_tmp103.tag=1;_tmp103.f1=Cyc_add_libarg;_tmp103;});_tmp102;});_tmp101->f5=
_tag_arr("Library file",sizeof(char),13);_tmp101;});_tmpEB[6]=({struct _tuple11*
_tmpFE=_cycalloc(sizeof(*_tmpFE));_tmpFE->f1=_tag_arr("-L",sizeof(char),3);
_tmpFE->f2=1;_tmpFE->f3=_tag_arr("<dir>",sizeof(char),6);_tmpFE->f4=(void*)({
struct Cyc_Arg_Flag_spec_struct*_tmpFF=_cycalloc(sizeof(*_tmpFF));_tmpFF[0]=({
struct Cyc_Arg_Flag_spec_struct _tmp100;_tmp100.tag=1;_tmp100.f1=Cyc_add_ccarg;
_tmp100;});_tmpFF;});_tmpFE->f5=_tag_arr("Add to the list of directories for -l",
sizeof(char),38);_tmpFE;});_tmpEB[5]=({struct _tuple11*_tmpFB=_cycalloc(sizeof(*
_tmpFB));_tmpFB->f1=_tag_arr("-I",sizeof(char),3);_tmpFB->f2=1;_tmpFB->f3=
_tag_arr("<dir>",sizeof(char),6);_tmpFB->f4=(void*)({struct Cyc_Arg_Flag_spec_struct*
_tmpFC=_cycalloc(sizeof(*_tmpFC));_tmpFC[0]=({struct Cyc_Arg_Flag_spec_struct
_tmpFD;_tmpFD.tag=1;_tmpFD.f1=Cyc_add_cpparg;_tmpFD;});_tmpFC;});_tmpFB->f5=
_tag_arr("Add to the list of directories to search for include files",sizeof(
char),59);_tmpFB;});_tmpEB[4]=({struct _tuple11*_tmpF8=_cycalloc(sizeof(*_tmpF8));
_tmpF8->f1=_tag_arr("-B",sizeof(char),3);_tmpF8->f2=1;_tmpF8->f3=_tag_arr("<file>",
sizeof(char),7);_tmpF8->f4=(void*)({struct Cyc_Arg_Flag_spec_struct*_tmpF9=
_cycalloc(sizeof(*_tmpF9));_tmpF9[0]=({struct Cyc_Arg_Flag_spec_struct _tmpFA;
_tmpFA.tag=1;_tmpFA.f1=Cyc_add_cyclone_exec_path;_tmpFA;});_tmpF9;});_tmpF8->f5=
_tag_arr("Add to the list of directories to search for compiler files",sizeof(
char),60);_tmpF8;});_tmpEB[3]=({struct _tuple11*_tmpF5=_cycalloc(sizeof(*_tmpF5));
_tmpF5->f1=_tag_arr("-D",sizeof(char),3);_tmpF5->f2=1;_tmpF5->f3=_tag_arr("<name>[=<value>]",
sizeof(char),17);_tmpF5->f4=(void*)({struct Cyc_Arg_Flag_spec_struct*_tmpF6=
_cycalloc(sizeof(*_tmpF6));_tmpF6[0]=({struct Cyc_Arg_Flag_spec_struct _tmpF7;
_tmpF7.tag=1;_tmpF7.f1=Cyc_add_cpparg;_tmpF7;});_tmpF6;});_tmpF5->f5=_tag_arr("Pass definition to preprocessor",
sizeof(char),32);_tmpF5;});_tmpEB[2]=({struct _tuple11*_tmpF2=_cycalloc(sizeof(*
_tmpF2));_tmpF2->f1=_tag_arr("-o",sizeof(char),3);_tmpF2->f2=0;_tmpF2->f3=
_tag_arr(" <file>",sizeof(char),8);_tmpF2->f4=(void*)({struct Cyc_Arg_String_spec_struct*
_tmpF3=_cycalloc(sizeof(*_tmpF3));_tmpF3[0]=({struct Cyc_Arg_String_spec_struct
_tmpF4;_tmpF4.tag=5;_tmpF4.f1=Cyc_set_output_file;_tmpF4;});_tmpF3;});_tmpF2->f5=
_tag_arr("Set the output file name to <file>",sizeof(char),35);_tmpF2;});_tmpEB[
1]=({struct _tuple11*_tmpEF=_cycalloc(sizeof(*_tmpEF));_tmpEF->f1=_tag_arr("--version",
sizeof(char),10);_tmpEF->f2=0;_tmpEF->f3=_tag_arr("",sizeof(char),1);_tmpEF->f4=(
void*)({struct Cyc_Arg_Unit_spec_struct*_tmpF0=_cycalloc(sizeof(*_tmpF0));_tmpF0[
0]=({struct Cyc_Arg_Unit_spec_struct _tmpF1;_tmpF1.tag=0;_tmpF1.f1=Cyc_print_version;
_tmpF1;});_tmpF0;});_tmpEF->f5=_tag_arr("Print version information and exit",
sizeof(char),35);_tmpEF;});_tmpEB[0]=({struct _tuple11*_tmpEC=_cycalloc(sizeof(*
_tmpEC));_tmpEC->f1=_tag_arr("-v",sizeof(char),3);_tmpEC->f2=0;_tmpEC->f3=
_tag_arr("",sizeof(char),1);_tmpEC->f4=(void*)({struct Cyc_Arg_Set_spec_struct*
_tmpED=_cycalloc(sizeof(*_tmpED));_tmpED[0]=({struct Cyc_Arg_Set_spec_struct
_tmpEE;_tmpEE.tag=3;_tmpEE.f1=& Cyc_v_r;_tmpEE;});_tmpED;});_tmpEC->f5=_tag_arr("Print compilation stages verbosely",
sizeof(char),35);_tmpEC;});((struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(
_tag_arr(_tmpEB,sizeof(struct _tuple11*),49));});Cyc_Arg_parse(options,Cyc_add_other,
_tag_arr("Options:",sizeof(char),9),argv);if(Cyc_cyclone_files == 0?Cyc_ccargs == 
0: 0){({void*_tmpB1[0]={};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("missing file\n",
sizeof(char),14),_tag_arr(_tmpB1,sizeof(void*),0));});exit(1);}{struct
...
0)).curr)Cyc_cyclone_exec_path=({struct Cyc_List_List*_tmpB2=_cycalloc(sizeof(*
_tmpB2));_tmpB2->hd=({struct _tagged_arr*_tmpB3=_cycalloc(sizeof(*_tmpB3));_tmpB3[
0]=cyclone_exec_prefix;_tmpB3;});_tmpB2->tl=Cyc_cyclone_exec_path;_tmpB2;});{
...
_cycalloc(sizeof(*_tmpB5));_tmpB5[0]=def_lib_path;_tmpB5;});_tmpB4->tl=Cyc_cyclone_exec_path;
_tmpB4;});Cyc_cyclone_exec_path=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))
Cyc_List_imp_rev)(Cyc_cyclone_exec_path);if(!Cyc_stop_after_cpp_r)Cyc_cyc_include=
Cyc_do_find(Cyc_cyclone_exec_path,_tag_arr("cyc_include.h",sizeof(char),14));{
struct Cyc_List_List*_tmpB6=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(
Cyc_cyclone_files);for(0;_tmpB6 != 0;_tmpB6=_tmpB6->tl){Cyc_process_file(*((
struct _tagged_arr*)_tmpB6->hd));if(Cyc_compile_failure)return 1;}}if(((Cyc_stop_after_cpp_r?
1: Cyc_parseonly_r)?1: Cyc_tc_r)?1: Cyc_toc_r)return 0;if(Cyc_ccargs == 0)return 0;Cyc_add_ccarg((
struct _tagged_arr)Cyc_Std_strconcat(_tag_arr("-L",sizeof(char),3),def_lib_path));
Cyc_ccargs=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(Cyc_ccargs);{
struct _tagged_arr _tmpB7=Cyc_Std_str_sepstr(((struct Cyc_List_List*(*)(struct
_tagged_arr*(*f)(struct _tagged_arr*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_sh_escape_stringptr,
Cyc_ccargs),_tag_arr(" ",sizeof(char),2));Cyc_libargs=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x))Cyc_List_rev)(Cyc_libargs);{struct _tagged_arr _tmpB8=Cyc_Std_str_sepstr(({
struct Cyc_List_List*_tmpE9=_cycalloc(sizeof(*_tmpE9));_tmpE9->hd=_init_tag_arr(
_cycalloc(sizeof(struct _tagged_arr)),"",sizeof(char),1);_tmpE9->tl=((struct Cyc_List_List*(*)(
struct _tagged_arr*(*f)(struct _tagged_arr*),struct Cyc_List_List*x))Cyc_List_map)(
Cyc_sh_escape_stringptr,Cyc_libargs);_tmpE9;}),_tag_arr(" ",sizeof(char),2));
struct Cyc_List_List*stdlib;struct _tagged_arr stdlib_string;int _tmpB9=((Cyc_stop_after_asmfile_r?
...
_check_null(Cyc_output_file)),_tag_arr(".lib",sizeof(char),5)): 0);if(_tmpB9){
...
else{libcyc_flag=_tag_arr("-lcyc",sizeof(char),6);nogc_filename=_tag_arr("nogc.a",
sizeof(char),7);runtime_filename=_tag_arr("runtime_cyc.o",sizeof(char),14);}}
gc_filename=_tag_arr("gc.a",sizeof(char),5);{struct _tagged_arr _tmpBA=Cyc_nogc_r?
Cyc_do_find(Cyc_cyclone_exec_path,nogc_filename): Cyc_do_find(Cyc_cyclone_exec_path,
gc_filename);struct _tagged_arr _tmpBB=Cyc_do_find(Cyc_cyclone_exec_path,
runtime_filename);stdlib=0;stdlib_string=(struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmpBF;_tmpBF.tag=0;_tmpBF.f1=(struct _tagged_arr)_tmpBA;{struct Cyc_Std_String_pa_struct
_tmpBE;_tmpBE.tag=0;_tmpBE.f1=(struct _tagged_arr)libcyc_flag;{struct Cyc_Std_String_pa_struct
_tmpBD;_tmpBD.tag=0;_tmpBD.f1=(struct _tagged_arr)_tmpBB;{void*_tmpBC[3]={& _tmpBD,&
_tmpBE,& _tmpBF};Cyc_Std_aprintf(_tag_arr(" %s %s %s",sizeof(char),10),_tag_arr(
_tmpBC,sizeof(void*),3));}}}});}}if(Cyc_ic_r){struct _handler_cons _tmpC0;
_push_handler(& _tmpC0);{int _tmpC2=0;if(setjmp(_tmpC0.handler))_tmpC2=1;if(!
_tmpC2){Cyc_ccargs=((struct Cyc_List_List*(*)(int(*f)(struct _tagged_arr*),struct
...
Cyc_is_cfile,Cyc_libargs);{struct Cyc_List_List*_tmpC3=((struct Cyc_List_List*(*)(
...
if(!_tmpB9)_tmpC3=({struct Cyc_List_List*_tmpC4=_cycalloc(sizeof(*_tmpC4));_tmpC4->hd=
Cyc_final_strptr;_tmpC4->tl=_tmpC3;_tmpC4;});{struct Cyc_Interface_I*_tmpC5=((
...
Cyc_read_cycio,_tmpC3,_tmpC3);if(_tmpC5 == 0){({void*_tmpC6[0]={};Cyc_Std_fprintf(
Cyc_Std_stderr,_tag_arr("Error: interfaces incompatible\n",sizeof(char),32),
_tag_arr(_tmpC6,sizeof(void*),0));});Cyc_compile_failure=1;Cyc_remove_cfiles();{
int _tmpC7=1;_npop_handler(0);return _tmpC7;}}if(_tmpB9){if(Cyc_output_file != 0){
struct _tagged_arr _tmpC8=({struct Cyc_Std_String_pa_struct _tmpCC;_tmpCC.tag=0;
_tmpCC.f1=(struct _tagged_arr)Cyc_Filename_chop_extension(*((struct _tagged_arr*)
_check_null(Cyc_output_file)));{void*_tmpCB[1]={& _tmpCC};Cyc_Std_aprintf(
_tag_arr("%s.cycio",sizeof(char),9),_tag_arr(_tmpCB,sizeof(void*),1));}});struct
Cyc_Std___cycFILE*_tmpC9=Cyc_try_file_open((struct _tagged_arr)_tmpC8,_tag_arr("wb",
sizeof(char),3),_tag_arr("interface object file",sizeof(char),22));if(_tmpC9 == 0){
Cyc_compile_failure=1;Cyc_remove_cfiles();{int _tmpCA=1;_npop_handler(0);return
_tmpCA;}}Cyc_Interface_save((struct Cyc_Interface_I*)_check_null(_tmpC5),(struct
Cyc_Std___cycFILE*)_check_null(_tmpC9));Cyc_Std_file_close((struct Cyc_Std___cycFILE*)
_check_null(_tmpC9));}}else{if(!Cyc_Interface_is_subinterface(Cyc_Interface_empty(),(
struct Cyc_Interface_I*)_check_null(_tmpC5),({struct _tuple9*_tmpCD=_cycalloc(
sizeof(*_tmpCD));_tmpCD->f1=_tag_arr("empty interface",sizeof(char),16);_tmpCD->f2=
_tag_arr("global interface",sizeof(char),17);_tmpCD;}))){({void*_tmpCE[0]={};Cyc_Std_fprintf(
Cyc_Std_stderr,_tag_arr("Error: some objects are still undefined\n",sizeof(char),
41),_tag_arr(_tmpCE,sizeof(void*),0));});Cyc_compile_failure=1;Cyc_remove_cfiles();{
int _tmpCF=1;_npop_handler(0);return _tmpCF;}}}}};_pop_handler();}else{void*_tmpC1=(
void*)_exn_thrown;void*_tmpD1=_tmpC1;struct _tagged_arr _tmpD2;struct _tagged_arr
_tmpD3;struct _tagged_arr _tmpD4;_LL36: if(*((void**)_tmpD1)!= Cyc_Core_Failure)
goto _LL38;_tmpD2=((struct Cyc_Core_Failure_struct*)_tmpD1)->f1;_LL37:({struct Cyc_Std_String_pa_struct
_tmpD6;_tmpD6.tag=0;_tmpD6.f1=(struct _tagged_arr)_tmpD2;{void*_tmpD5[1]={& _tmpD6};
Cyc_Std_printf(_tag_arr("Exception Core::Failure %s\n",sizeof(char),28),_tag_arr(
_tmpD5,sizeof(void*),1));}});Cyc_compile_failure=1;Cyc_remove_cfiles();return 1;
_LL38: if(*((void**)_tmpD1)!= Cyc_Core_Impossible)goto _LL3A;_tmpD3=((struct Cyc_Core_Impossible_struct*)
_tmpD1)->f1;_LL39:({struct Cyc_Std_String_pa_struct _tmpD8;_tmpD8.tag=0;_tmpD8.f1=(
struct _tagged_arr)_tmpD3;{void*_tmpD7[1]={& _tmpD8};Cyc_Std_printf(_tag_arr("Exception Core::Impossible %s\n",
sizeof(char),31),_tag_arr(_tmpD7,sizeof(void*),1));}});Cyc_compile_failure=1;Cyc_remove_cfiles();
return 1;_LL3A: if(_tmpD1 != Cyc_Dict_Absent)goto _LL3C;_LL3B:({void*_tmpD9[0]={};
Cyc_Std_printf(_tag_arr("Exception Dict::Absent\n",sizeof(char),24),_tag_arr(
_tmpD9,sizeof(void*),0));});Cyc_compile_failure=1;Cyc_remove_cfiles();return 1;
_LL3C: if(*((void**)_tmpD1)!= Cyc_Core_Invalid_argument)goto _LL3E;_tmpD4=((struct
Cyc_Core_Invalid_argument_struct*)_tmpD1)->f1;_LL3D:({struct Cyc_Std_String_pa_struct
_tmpDB;_tmpDB.tag=0;_tmpDB.f1=(struct _tagged_arr)_tmpD4;{void*_tmpDA[1]={& _tmpDB};
Cyc_Std_printf(_tag_arr("Exception Core::Invalid_argument %s\n",sizeof(char),37),
_tag_arr(_tmpDA,sizeof(void*),1));}});Cyc_compile_failure=1;Cyc_remove_cfiles();
return 1;_LL3E:;_LL3F:({void*_tmpDC[0]={};Cyc_Std_printf(_tag_arr("Uncaught exception\n",
sizeof(char),20),_tag_arr(_tmpDC,sizeof(void*),0));});Cyc_compile_failure=1;Cyc_remove_cfiles();
return 1;_LL40:;_LL41:(void)_throw(_tmpD1);_LL35:;}}}{struct _tagged_arr _tmpDD=({
struct Cyc_Std_String_pa_struct _tmpE6;_tmpE6.tag=0;_tmpE6.f1=(struct _tagged_arr)
_tmpB8;{struct Cyc_Std_String_pa_struct _tmpE5;_tmpE5.tag=0;_tmpE5.f1=(struct
_tagged_arr)stdlib_string;{struct Cyc_Std_String_pa_struct _tmpE4;_tmpE4.tag=0;
_tmpE4.f1=(struct _tagged_arr)_tmpB7;{struct Cyc_Std_String_pa_struct _tmpE3;_tmpE3.tag=
0;_tmpE3.f1=(struct _tagged_arr)(Cyc_output_file == 0?_tag_arr("",sizeof(char),1):(
struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmpE8;_tmpE8.tag=0;_tmpE8.f1=(
struct _tagged_arr)Cyc_sh_escape_string(*((struct _tagged_arr*)_check_null(Cyc_output_file)));{
void*_tmpE7[1]={& _tmpE8};Cyc_Std_aprintf(_tag_arr(" -o %s",sizeof(char),7),
_tag_arr(_tmpE7,sizeof(void*),1));}}));{struct Cyc_Std_String_pa_struct _tmpE2;
_tmpE2.tag=0;_tmpE2.f1=(struct _tagged_arr)comp;{void*_tmpE1[5]={& _tmpE2,& _tmpE3,&
_tmpE4,& _tmpE5,& _tmpE6};Cyc_Std_aprintf(_tag_arr("%s %s %s%s%s",sizeof(char),13),
_tag_arr(_tmpE1,sizeof(void*),5));}}}}}});if(Cyc_v_r)({struct Cyc_Std_String_pa_struct
_tmpDF;_tmpDF.tag=0;_tmpDF.f1=(struct _tagged_arr)_tmpDD;{void*_tmpDE[1]={& _tmpDF};
Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("%s\n",sizeof(char),4),_tag_arr(_tmpDE,
sizeof(void*),1));}});if(Cyc_Std_system((struct _tagged_arr)_tmpDD)!= 0){({void*
_tmpE0[0]={};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("Error: C compiler failed\n",
sizeof(char),26),_tag_arr(_tmpE0,sizeof(void*),0));});Cyc_compile_failure=1;Cyc_remove_cfiles();
