...
struct _tagged_arr s){ unsigned int _temp18= Cyc_Std_strlen( s); if( _temp18 <= 
2){ return;}{ struct _tagged_arr _temp19=( struct _tagged_arr) Cyc_Std_substring(
s, 2, _temp18 -  2); Cyc_cyclone_lib_path=({ struct Cyc_List_List* _temp20=(
struct Cyc_List_List*) _cycalloc( sizeof( struct Cyc_List_List)); _temp20->hd=(
void*)({ struct _tagged_arr* _temp21=( struct _tagged_arr*) _cycalloc( sizeof(
struct _tagged_arr)); _temp21[ 0]= _temp19; _temp21;}); _temp20->tl= Cyc_cyclone_lib_path;
_temp20;});}} static struct Cyc_List_List* Cyc_libargs= 0; static void Cyc_add_libarg(
...
_temp22->hd=( void*)({ struct _tagged_arr* _temp23=( struct _tagged_arr*)
_cycalloc( sizeof( struct _tagged_arr)); _temp23[ 0]= s; _temp23;}); _temp22->tl=
Cyc_libargs; _temp22;});}} static void Cyc_set_save_temps(){ Cyc_save_temps_r= 1;
...
struct _tagged_arr* _temp24=( struct _tagged_arr*) _cycalloc( sizeof( struct
_tagged_arr)); _temp24[ 0]= s; _temp24;});} static void Cyc_set_stop_after_objectfile(){
...
_temp26; _temp26.tag= Cyc_Std_String_pa; _temp26.f1=( struct _tagged_arr) s;{
void* _temp25[ 1u]={& _temp26}; Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("Input type '%s' not supported\n",
sizeof( unsigned char), 31u), _tag_arr( _temp25, sizeof( void*), 1u));}});}}}
...
s)){ Cyc_cyclone_files=({ struct Cyc_List_List* _temp27=( struct Cyc_List_List*)
_cycalloc( sizeof( struct Cyc_List_List)); _temp27->hd=( void*)({ struct
_tagged_arr* _temp28=( struct _tagged_arr*) _cycalloc( sizeof( struct
_tagged_arr)); _temp28[ 0]= s; _temp28;}); _temp27->tl= Cyc_cyclone_files;
_temp27;});{ struct _tagged_arr _temp29= Cyc_Filename_chop_extension( s); struct
_tagged_arr _temp30= Cyc_Std_strconcat(( struct _tagged_arr) _temp29, _tag_arr(".c",
sizeof( unsigned char), 3u)); Cyc_add_ccarg(( struct _tagged_arr) _temp30);}}
...
_temp33= 1;} if( ! _temp33){{ struct Cyc_Std___sFILE* _temp34=( struct Cyc_Std___sFILE*)
Cyc_Std_file_open( filename, mode); _npop_handler( 0u); return _temp34;};
_pop_handler();} else{ void* _temp32=( void*) _exn_thrown; void* _temp36=
_temp32; _LL38: goto _LL39; _LL40: goto _LL41; _LL39: Cyc_compile_failure= 1;({
struct Cyc_Std_String_pa_struct _temp44; _temp44.tag= Cyc_Std_String_pa; _temp44.f1=(
struct _tagged_arr) filename;{ struct Cyc_Std_String_pa_struct _temp43; _temp43.tag=
Cyc_Std_String_pa; _temp43.f1=( struct _tagged_arr) msg_part;{ void* _temp42[ 2u]={&
_temp43,& _temp44}; Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("\nError: couldn't open %s %s\n",
sizeof( unsigned char), 29u), _tag_arr( _temp42, sizeof( void*), 2u));}}}); Cyc_Std_fflush((
struct Cyc_Std___sFILE*) Cyc_Std_stderr); return 0; _LL41:( void) _throw(
_temp36); _LL37:;}}} struct Cyc_List_List* Cyc_do_stage( struct _tagged_arr
...
_exn_thrown; void* _temp50= _temp47; struct _tagged_arr _temp64; struct
_tagged_arr _temp66; struct _tagged_arr _temp68; _LL52: if(*(( void**) _temp50)
==  Cyc_Core_Impossible){ _LL65: _temp64=(( struct Cyc_Core_Impossible_struct*)
_temp50)->f1; goto _LL53;} else{ goto _LL54;} _LL54: if( _temp50 ==  Cyc_Dict_Absent){
goto _LL55;} else{ goto _LL56;} _LL56: if(*(( void**) _temp50) ==  Cyc_Core_Invalid_argument){
_LL67: _temp66=(( struct Cyc_Core_Invalid_argument_struct*) _temp50)->f1; goto
_LL57;} else{ goto _LL58;} _LL58: if(*(( void**) _temp50) ==  Cyc_Core_Failure){
_LL69: _temp68=(( struct Cyc_Core_Failure_struct*) _temp50)->f1; goto _LL59;}
else{ goto _LL60;} _LL60: goto _LL61; _LL62: goto _LL63; _LL53: exn_string=
_tag_arr("Exception Core::Impossible", sizeof( unsigned char), 27u);
explain_string= _temp64; goto _LL51; _LL55: exn_string= _tag_arr("Exception Dict::Absent",
sizeof( unsigned char), 23u); goto _LL51; _LL57: exn_string= _tag_arr("Exception Core::Invalid_argument",
sizeof( unsigned char), 33u); explain_string= _temp66; goto _LL51; _LL59:
exn_string= _tag_arr("Exception Core::Failure", sizeof( unsigned char), 24u);
explain_string= _temp68; goto _LL51; _LL61: ex= _temp50; other_exn= 1;
exn_string= _tag_arr("Uncaught exception", sizeof( unsigned char), 19u); goto
_LL51; _LL63:( void) _throw( _temp50); _LL51:;}}} if( Cyc_Position_error_p()){
...
explain_string;{ struct Cyc_Std_String_pa_struct _temp72; _temp72.tag= Cyc_Std_String_pa;
_temp72.f1=( struct _tagged_arr) stage_name;{ struct Cyc_Std_String_pa_struct
_temp71; _temp71.tag= Cyc_Std_String_pa; _temp71.f1=( struct _tagged_arr)
exn_string;{ void* _temp70[ 3u]={& _temp71,& _temp72,& _temp73}; Cyc_Std_fprintf(
Cyc_Std_stderr, _tag_arr("\n%s thrown during %s: %s", sizeof( unsigned char), 25u),
_tag_arr( _temp70, sizeof( void*), 3u));}}}});} if( Cyc_compile_failure){({ void*
_temp74[ 0u]={}; Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("\nCOMPILATION FAILED!\n",
sizeof( unsigned char), 22u), _tag_arr( _temp74, sizeof( void*), 0u));}); Cyc_Std_fflush((
struct Cyc_Std___sFILE*) Cyc_Std_stderr); if( other_exn){( int) _throw( ex);}
return _temp45;} else{ if( Cyc_v_r){({ struct Cyc_Std_String_pa_struct _temp76;
_temp76.tag= Cyc_Std_String_pa; _temp76.f1=( struct _tagged_arr) stage_name;{
void* _temp75[ 1u]={& _temp76}; Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("%s completed.\n",
sizeof( unsigned char), 15u), _tag_arr( _temp75, sizeof( void*), 1u));}}); Cyc_Std_fflush((
struct Cyc_Std___sFILE*) Cyc_Std_stderr); return _temp45;}} return _temp45;}
struct Cyc_List_List* Cyc_do_parse( struct Cyc_Std___sFILE* f, struct Cyc_List_List*
ignore){ Cyc_Lex_lex_init();{ struct Cyc_List_List* _temp79= Cyc_Parse_parse_file(
f); Cyc_Lex_lex_init(); return _temp79;}} struct Cyc_List_List* Cyc_do_typecheck(
...
1u); for( 0; dirs !=  0; dirs= dirs->tl){ struct _tagged_arr _temp115=*(( struct
_tagged_arr*) dirs->hd); if( _temp115.curr == (( struct _tagged_arr) _tag_arr( 0u,
0u, 0u)).curr? 1: Cyc_Std_strlen( _temp115) ==  0){ continue;} _temp115=( struct
_tagged_arr) Cyc_Std_strconcat( _temp115, _tag_arr(":", sizeof( unsigned char),
2u)); tmp=( struct _tagged_arr) Cyc_Std_strconcat( _temp115, tmp);} return tmp;}
...
return 0;} for( 0; dirs !=  0; dirs= dirs->tl){ struct _tagged_arr _temp116=*((
struct _tagged_arr*) dirs->hd); if( _temp116.curr == (( struct _tagged_arr)
_tag_arr( 0u, 0u, 0u)).curr? 1: Cyc_Std_strlen( _temp116) ==  0){ continue;}{
struct _tagged_arr s=( struct _tagged_arr) Cyc_Filename_concat( _temp116, file);
if( Cyc_file_exists( s)){ return({ struct _tagged_arr* _temp117=( struct
_tagged_arr*) _cycalloc( sizeof( struct _tagged_arr)); _temp117[ 0]= s; _temp117;});}}}
return 0;} static struct _tagged_arr Cyc_do_find( struct Cyc_List_List* dirs,
struct _tagged_arr file){ struct _tagged_arr* _temp118= Cyc_find( dirs, file);
if( _temp118 ==  0){({ struct Cyc_Std_String_pa_struct _temp121; _temp121.tag=
...
Cyc_remove_file(( struct _tagged_arr) _temp154); return;} if( Cyc_ic_r){ struct
Cyc_Std___sFILE* inter_file= Cyc_Std_fopen(( struct _tagged_arr) _temp155,
_tag_arr("r", sizeof( unsigned char), 2u)); struct Cyc_Std___sFILE*
inter_objfile= Cyc_try_file_open(( struct _tagged_arr) _temp156, _tag_arr("w",
...
Cyc_Position_reset_position(( struct _tagged_arr) _temp155); tds=(( struct Cyc_List_List*(*)(
...
struct _tuple9* _temp191=( struct _tuple9*) _cycalloc( sizeof( struct _tuple9));
_temp191->f1= _temp190; _temp191->f2= inter_file; _temp191->f3=( struct Cyc_Std___sFILE*)
_check_null( inter_objfile); _temp191;}), tds); if( inter_file !=  0){ Cyc_Std_file_close((
...
tds); if( Cyc_compile_failure){ Cyc_remove_file(( struct _tagged_arr) _temp154);
return;} if( ! Cyc_compile_failure){ Cyc_Tcutil_flush_warnings();} Cyc_remove_file((
struct _tagged_arr) _temp154); if( Cyc_compile_failure){ return;} if( Cyc_tovc_r){
tds=(( struct Cyc_List_List*(*)( struct _tagged_arr stage_name, struct Cyc_List_List*(*
f)( int, struct Cyc_List_List*), int env, struct Cyc_List_List* tds)) Cyc_do_stage)(
...
struct Cyc_List_List* options=({ struct _tuple10* _temp302[ 45u]; _temp302[ 44u]=({
struct _tuple10* _temp435=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10));
_temp435->f1= _tag_arr("-printfullevars", sizeof( unsigned char), 16u); _temp435->f2=
0; _temp435->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp435->f4=( void*)({
...
_temp437; _temp437.tag= Cyc_Arg_Set_spec; _temp437.f1=& Cyc_print_full_evars_r;
_temp437;}); _temp436;}); _temp435->f5= _tag_arr("Print full information for evars (type debugging)",
sizeof( unsigned char), 50u); _temp435;}); _temp302[ 43u]=({ struct _tuple10*
_temp432=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp432->f1=
_tag_arr("-printallkinds", sizeof( unsigned char), 15u); _temp432->f2= 0;
...
_temp434; _temp434.tag= Cyc_Arg_Set_spec; _temp434.f1=& Cyc_print_all_kinds_r;
_temp434;}); _temp433;}); _temp432->f5= _tag_arr("Always print kinds of type variables",
sizeof( unsigned char), 37u); _temp432;}); _temp302[ 42u]=({ struct _tuple10*
_temp429=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp429->f1=
_tag_arr("-printalltvars", sizeof( unsigned char), 15u); _temp429->f2= 0;
...
_temp431;}); _temp430;}); _temp429->f5= _tag_arr("Print all type variables (even implicit default effects)",
sizeof( unsigned char), 57u); _temp429;}); _temp302[ 41u]=({ struct _tuple10*
_temp426=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp426->f1=
_tag_arr("-noexpandtypedefs", sizeof( unsigned char), 18u); _temp426->f2= 0;
...
_temp428; _temp428.tag= Cyc_Arg_Set_spec; _temp428.f1=& Cyc_noexpand_r; _temp428;});
_temp427;}); _temp426->f5= _tag_arr("Don't expand typedefs in pretty printing",
sizeof( unsigned char), 41u); _temp426;}); _temp302[ 40u]=({ struct _tuple10*
_temp423=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp423->f1=
_tag_arr("-noremoveunused", sizeof( unsigned char), 16u); _temp423->f2= 0;
...
_temp425; _temp425.tag= Cyc_Arg_Set_spec; _temp425.f1=& Cyc_noshake_r; _temp425;});
_temp424;}); _temp423->f5= _tag_arr("Don't remove externed variables that aren't used",
sizeof( unsigned char), 49u); _temp423;}); _temp302[ 39u]=({ struct _tuple10*
_temp420=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp420->f1=
_tag_arr("-nogc", sizeof( unsigned char), 6u); _temp420->f2= 0; _temp420->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp420->f4=( void*)({ struct Cyc_Arg_Set_spec_struct*
_temp421=( struct Cyc_Arg_Set_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct));
_temp421[ 0]=({ struct Cyc_Arg_Set_spec_struct _temp422; _temp422.tag= Cyc_Arg_Set_spec;
_temp422.f1=& Cyc_nogc_r; _temp422;}); _temp421;}); _temp420->f5= _tag_arr("Don't link in the garbage collector",
sizeof( unsigned char), 36u); _temp420;}); _temp302[ 38u]=({ struct _tuple10*
_temp417=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp417->f1=
_tag_arr("-nocyc", sizeof( unsigned char), 7u); _temp417->f2= 0; _temp417->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp417->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp418=( struct Cyc_Arg_Unit_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp418[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp419; _temp419.tag= Cyc_Arg_Unit_spec;
_temp419.f1= Cyc_set_nocyc; _temp419;}); _temp418;}); _temp417->f5= _tag_arr("Don't add implicit namespace Cyc",
sizeof( unsigned char), 33u); _temp417;}); _temp302[ 37u]=({ struct _tuple10*
_temp414=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp414->f1=
_tag_arr("-no-cpp-precomp", sizeof( unsigned char), 16u); _temp414->f2= 0;
_temp414->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp414->f4=( void*)({
struct Cyc_Arg_Unit_spec_struct* _temp415=( struct Cyc_Arg_Unit_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct)); _temp415[ 0]=({ struct Cyc_Arg_Unit_spec_struct
_temp416; _temp416.tag= Cyc_Arg_Unit_spec; _temp416.f1= Cyc_set_nocppprecomp;
_temp416;}); _temp415;}); _temp414->f5= _tag_arr("Don't do smart preprocessing (mac only)",
sizeof( unsigned char), 40u); _temp414;}); _temp302[ 36u]=({ struct _tuple10*
_temp411=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp411->f1=
_tag_arr("-use-cpp", sizeof( unsigned char), 9u); _temp411->f2= 0; _temp411->f3=
_tag_arr("<path>", sizeof( unsigned char), 7u); _temp411->f4=( void*)({ struct
Cyc_Arg_String_spec_struct* _temp412=( struct Cyc_Arg_String_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_String_spec_struct)); _temp412[ 0]=({ struct
Cyc_Arg_String_spec_struct _temp413; _temp413.tag= Cyc_Arg_String_spec; _temp413.f1=
Cyc_set_cpp; _temp413;}); _temp412;}); _temp411->f5= _tag_arr("Indicate which preprocessor to use",
sizeof( unsigned char), 35u); _temp411;}); _temp302[ 35u]=({ struct _tuple10*
_temp408=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp408->f1=
_tag_arr("--noboundschecks", sizeof( unsigned char), 17u); _temp408->f2= 0;
...
_temp410; _temp410.tag= Cyc_Arg_Unit_spec; _temp410.f1= Cyc_set_noboundschecks;
_temp410;}); _temp409;}); _temp408->f5= _tag_arr("Disable bounds checks",
sizeof( unsigned char), 22u); _temp408;}); _temp302[ 34u]=({ struct _tuple10*
_temp405=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp405->f1=
_tag_arr("--nonullchecks", sizeof( unsigned char), 15u); _temp405->f2= 0;
_temp405->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp405->f4=( void*)({
struct Cyc_Arg_Unit_spec_struct* _temp406=( struct Cyc_Arg_Unit_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct)); _temp406[ 0]=({ struct Cyc_Arg_Unit_spec_struct
_temp407; _temp407.tag= Cyc_Arg_Unit_spec; _temp407.f1= Cyc_set_nonullchecks;
_temp407;}); _temp406;}); _temp405->f5= _tag_arr("Disable null checks", sizeof(
unsigned char), 20u); _temp405;}); _temp302[ 33u]=({ struct _tuple10* _temp402=(
struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp402->f1= _tag_arr("--nochecks",
sizeof( unsigned char), 11u); _temp402->f2= 0; _temp402->f3= _tag_arr("",
sizeof( unsigned char), 1u); _temp402->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
...
_temp404.f1= Cyc_set_nochecks; _temp404;}); _temp403;}); _temp402->f5= _tag_arr("Disable bounds/null checks",
sizeof( unsigned char), 27u); _temp402;}); _temp302[ 32u]=({ struct _tuple10*
_temp399=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp399->f1=
_tag_arr("--lineno", sizeof( unsigned char), 9u); _temp399->f2= 0; _temp399->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp399->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp400=( struct Cyc_Arg_Unit_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp400[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp401; _temp401.tag= Cyc_Arg_Unit_spec;
_temp401.f1= Cyc_set_lineno; _temp401;}); _temp400;}); _temp399->f5= _tag_arr("Generate line numbers for debugging",
sizeof( unsigned char), 36u); _temp399;}); _temp302[ 31u]=({ struct _tuple10*
...
_tagged_arr)) Cyc_List_list)( _tag_arr( _temp302, sizeof( struct _tuple10*), 45u));});
...
unsigned char), 22u));{ struct Cyc_List_List* _temp233=(( struct Cyc_List_List*(*)(
struct Cyc_List_List* x)) Cyc_List_rev)( Cyc_cyclone_files); for( 0; _temp233 != 
0; _temp233= _temp233->tl){ Cyc_process_file(*(( struct _tagged_arr*) _temp233->hd));
...
_temp237= Cyc_do_find( Cyc_cyclone_lib_path, libcyc_filename); struct
_tagged_arr _temp238= Cyc_nogc_r? Cyc_do_find( Cyc_cyclone_lib_path,
