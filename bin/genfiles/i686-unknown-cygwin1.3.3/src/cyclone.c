...
extern struct _tagged_arr Cyc_Filename_basename( struct _tagged_arr); extern int
Cyc_Filename_check_suffix( struct _tagged_arr, struct _tagged_arr); struct Cyc_Lineno_Pos{
...
14u]; extern int Cyc_Position_error_p(); static const int Cyc_Absyn_Loc_n= 0;
...
struct Cyc_List_List* f2; } ; extern void Cyc_NewControlFlow_cf_check( struct
Cyc_List_List* ds); struct Cyc_Interface_I; extern struct Cyc_Interface_I* Cyc_Interface_empty();
...
extern void Cyc_Lex_lex_init(); int Cyc_Toc_warn_bounds_checks; static int Cyc_pp_r=
...
struct _tagged_arr Cyc_make_base_filename( struct _tagged_arr s, struct
_tagged_arr* output_file){ struct _tagged_arr _temp25= Cyc_Filename_dirname(
output_file ==  0? s:* output_file); struct _tagged_arr _temp26= Cyc_Filename_chop_extension((
struct _tagged_arr) Cyc_Filename_basename( s)); struct _tagged_arr _temp27= Cyc_Std_strlen((
struct _tagged_arr) _temp25) >  0? Cyc_Filename_concat(( struct _tagged_arr)
_temp25,( struct _tagged_arr) _temp26): _temp26; return( struct _tagged_arr)
...
s)){ Cyc_cyclone_files=({ struct Cyc_List_List* _temp28=( struct Cyc_List_List*)
...
_tagged_arr)); _temp29[ 0]= s; _temp29;}); _temp28->tl= Cyc_cyclone_files;
_temp28;});{ struct _tagged_arr _temp30= Cyc_make_base_filename( s, Cyc_output_file);
struct _tagged_arr _temp31= Cyc_Std_strconcat( _temp30, _tag_arr(".c", sizeof(
unsigned char), 3u)); Cyc_add_ccarg(( struct _tagged_arr) _temp31);}} else{ Cyc_add_ccarg(
s);}} static void Cyc_remove_file( struct _tagged_arr s){ if( Cyc_save_temps_r){
return;} else{ Cyc_Std_remove( s);}} int Cyc_compile_failure= 0; struct Cyc_Std___sFILE*
Cyc_try_file_open( struct _tagged_arr filename, struct _tagged_arr mode, struct
_tagged_arr msg_part){ struct _handler_cons _temp32; _push_handler(& _temp32);{
int _temp34= 0; if( setjmp( _temp32.handler)){ _temp34= 1;} if( ! _temp34){{
struct Cyc_Std___sFILE* _temp35=( struct Cyc_Std___sFILE*) Cyc_Std_file_open(
filename, mode); _npop_handler( 0u); return _temp35;}; _pop_handler();} else{
void* _temp33=( void*) _exn_thrown; void* _temp37= _temp33; _LL39: goto _LL40;
_LL41: goto _LL42; _LL40: Cyc_compile_failure= 1;({ struct Cyc_Std_String_pa_struct
_temp45; _temp45.tag= Cyc_Std_String_pa; _temp45.f1=( struct _tagged_arr)
filename;{ struct Cyc_Std_String_pa_struct _temp44; _temp44.tag= Cyc_Std_String_pa;
_temp44.f1=( struct _tagged_arr) msg_part;{ void* _temp43[ 2u]={& _temp44,&
_temp45}; Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("\nError: couldn't open %s %s\n",
sizeof( unsigned char), 29u), _tag_arr( _temp43, sizeof( void*), 2u));}}}); Cyc_Std_fflush((
struct Cyc_Std___sFILE*) Cyc_Std_stderr); return 0; _LL42:( void) _throw(
_temp37); _LL38:;}}} struct Cyc_List_List* Cyc_do_stage( struct _tagged_arr
...
_temp78=( struct Cyc_Core_Impossible_struct*) _cycalloc( sizeof( struct Cyc_Core_Impossible_struct));
_temp78[ 0]=({ struct Cyc_Core_Impossible_struct _temp79; _temp79.tag= Cyc_Core_Impossible;
_temp79.f1= _tag_arr("", sizeof( unsigned char), 1u); _temp79;}); _temp78;});
struct Cyc_List_List* _temp46= 0;{ struct _handler_cons _temp47; _push_handler(&
_temp47);{ int _temp49= 0; if( setjmp( _temp47.handler)){ _temp49= 1;} if( !
_temp49){ _temp46= f( env, tds);; _pop_handler();} else{ void* _temp48=( void*)
_exn_thrown; void* _temp51= _temp48; struct _tagged_arr _temp65; struct
_tagged_arr _temp67; struct _tagged_arr _temp69; _LL53: if(*(( void**) _temp51)
==  Cyc_Core_Impossible){ _LL66: _temp65=(( struct Cyc_Core_Impossible_struct*)
_temp51)->f1; goto _LL54;} else{ goto _LL55;} _LL55: if( _temp51 ==  Cyc_Dict_Absent){
goto _LL56;} else{ goto _LL57;} _LL57: if(*(( void**) _temp51) ==  Cyc_Core_Invalid_argument){
_LL68: _temp67=(( struct Cyc_Core_Invalid_argument_struct*) _temp51)->f1; goto
_LL58;} else{ goto _LL59;} _LL59: if(*(( void**) _temp51) ==  Cyc_Core_Failure){
_LL70: _temp69=(( struct Cyc_Core_Failure_struct*) _temp51)->f1; goto _LL60;}
else{ goto _LL61;} _LL61: goto _LL62; _LL63: goto _LL64; _LL54: exn_string=
_tag_arr("Exception Core::Impossible", sizeof( unsigned char), 27u);
explain_string= _temp65; goto _LL52; _LL56: exn_string= _tag_arr("Exception Dict::Absent",
sizeof( unsigned char), 23u); goto _LL52; _LL58: exn_string= _tag_arr("Exception Core::Invalid_argument",
sizeof( unsigned char), 33u); explain_string= _temp67; goto _LL52; _LL60:
exn_string= _tag_arr("Exception Core::Failure", sizeof( unsigned char), 24u);
explain_string= _temp69; goto _LL52; _LL62: ex= _temp51; other_exn= 1;
exn_string= _tag_arr("Uncaught exception", sizeof( unsigned char), 19u); goto
_LL52; _LL64:( void) _throw( _temp51); _LL52:;}}} if( Cyc_Position_error_p()){
...
_temp74; _temp74.tag= Cyc_Std_String_pa; _temp74.f1=( struct _tagged_arr)
explain_string;{ struct Cyc_Std_String_pa_struct _temp73; _temp73.tag= Cyc_Std_String_pa;
_temp73.f1=( struct _tagged_arr) stage_name;{ struct Cyc_Std_String_pa_struct
_temp72; _temp72.tag= Cyc_Std_String_pa; _temp72.f1=( struct _tagged_arr)
exn_string;{ void* _temp71[ 3u]={& _temp72,& _temp73,& _temp74}; Cyc_Std_fprintf(
Cyc_Std_stderr, _tag_arr("\n%s thrown during %s: %s", sizeof( unsigned char), 25u),
_tag_arr( _temp71, sizeof( void*), 3u));}}}});} if( Cyc_compile_failure){({ void*
_temp75[ 0u]={}; Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("\nCOMPILATION FAILED!\n",
sizeof( unsigned char), 22u), _tag_arr( _temp75, sizeof( void*), 0u));}); Cyc_Std_fflush((
struct Cyc_Std___sFILE*) Cyc_Std_stderr); if( other_exn){( int) _throw( ex);}
return _temp46;} else{ if( Cyc_v_r){({ struct Cyc_Std_String_pa_struct _temp77;
_temp77.tag= Cyc_Std_String_pa; _temp77.f1=( struct _tagged_arr) stage_name;{
void* _temp76[ 1u]={& _temp77}; Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("%s completed.\n",
sizeof( unsigned char), 15u), _tag_arr( _temp76, sizeof( void*), 1u));}}); Cyc_Std_fflush((
struct Cyc_Std___sFILE*) Cyc_Std_stderr); return _temp46;}} return _temp46;}
struct Cyc_List_List* Cyc_do_parse( struct Cyc_Std___sFILE* f, struct Cyc_List_List*
ignore){ Cyc_Lex_lex_init();{ struct Cyc_List_List* _temp80= Cyc_Parse_parse_file(
f); Cyc_Lex_lex_init(); return _temp80;}} struct Cyc_List_List* Cyc_do_typecheck(
...
struct _tuple9* params, struct Cyc_List_List* tds){ struct _tuple9 _temp83;
struct Cyc_Std___sFILE* _temp84; struct Cyc_Std___sFILE* _temp86; struct Cyc_Tcenv_Tenv*
_temp88; struct _tuple9* _temp81= params; _temp83=* _temp81; _LL89: _temp88=
_temp83.f1; goto _LL87; _LL87: _temp86= _temp83.f2; goto _LL85; _LL85: _temp84=
_temp83.f3; goto _LL82; _LL82: { struct Cyc_Interface_I* _temp90= Cyc_Interface_extract(
_temp88->ae); if( _temp86 ==  0){ Cyc_Interface_save( _temp90, _temp84);} else{
struct Cyc_Interface_I* _temp91= Cyc_Interface_parse(( struct Cyc_Std___sFILE*)
_check_null( _temp86)); if( ! Cyc_Interface_is_subinterface( _temp91, _temp90,({
struct _tuple8* _temp92=( struct _tuple8*) _cycalloc( sizeof( struct _tuple8));
_temp92->f1= _tag_arr("written interface", sizeof( unsigned char), 18u); _temp92->f2=
_tag_arr("maximal interface", sizeof( unsigned char), 18u); _temp92;}))){ Cyc_compile_failure=
1;} else{ Cyc_Interface_save( _temp91, _temp84);}} return tds;}} struct Cyc_List_List*
...
return Cyc_Tovc_tovc( tds);} static unsigned char _temp93[ 1u]=""; static struct
_tagged_arr Cyc_cyc_include={ _temp93, _temp93, _temp93 +  1u}; struct Cyc_List_List*
...
_temp94= Cyc_try_file_open( Cyc_cyc_include, _tag_arr("r", sizeof( unsigned char),
2u), _tag_arr("internal compiler file", sizeof( unsigned char), 23u)); if(
_temp94 ==  0){ return tds;}{ struct Cyc_Std___sFILE* _temp95=( struct Cyc_Std___sFILE*)
_check_null( _temp94); unsigned int n_read= 1024; unsigned int n_written;
unsigned char buf[ 1024u];{ unsigned int _temp98= 1024u; unsigned int i; for( i=
0; i <  _temp98; i ++){ buf[ i]='\000';}} while( n_read ==  1024) { n_read= Cyc_Std_fread(
_tag_arr( buf, sizeof( unsigned char), 1024u), 1, 1024, _temp95); if( n_read != 
1024? ! Cyc_Std_feof( _temp95): 0){ Cyc_compile_failure= 1;({ void* _temp96[ 0u]={};
Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("\nError: problem copying cyc_include.h\n",
sizeof( unsigned char), 39u), _tag_arr( _temp96, sizeof( void*), 0u));}); Cyc_Std_fflush((
...
!=  n_written){ Cyc_compile_failure= 1;({ void* _temp97[ 0u]={}; Cyc_Std_fprintf(
Cyc_Std_stderr, _tag_arr("\nError: problem copying cyc_include.h\n", sizeof(
unsigned char), 39u), _tag_arr( _temp97, sizeof( void*), 0u));}); Cyc_Std_fflush((
struct Cyc_Std___sFILE*) Cyc_Std_stderr); return tds;}} Cyc_Std_fclose( _temp95);
...
_temp99= 0; unsigned int _temp100= Cyc_Std_strlen( s); while( _temp100 >  0) {
struct _tagged_arr _temp101= Cyc_Std_strchr( s, c); if( _temp101.curr == ((
struct _tagged_arr) _tag_arr( 0u, 0u, 0u)).curr){ _temp99=({ struct Cyc_List_List*
_temp102=( struct Cyc_List_List*) _cycalloc( sizeof( struct Cyc_List_List));
_temp102->hd=( void*)({ struct _tagged_arr* _temp103=( struct _tagged_arr*)
_cycalloc( sizeof( struct _tagged_arr)); _temp103[ 0]= s; _temp103;}); _temp102->tl=
_temp99; _temp102;}); break;} else{ _temp99=({ struct Cyc_List_List* _temp104=(
struct Cyc_List_List*) _cycalloc( sizeof( struct Cyc_List_List)); _temp104->hd=(
void*)({ struct _tagged_arr* _temp105=( struct _tagged_arr*) _cycalloc( sizeof(
struct _tagged_arr)); _temp105[ 0]=( struct _tagged_arr) Cyc_Std_substring( s, 0,(
unsigned int)(((( struct _tagged_arr) _temp101).curr -  s.curr) /  sizeof(
unsigned char))); _temp105;}); _temp104->tl= _temp99; _temp104;}); _temp100 -=(((
struct _tagged_arr) _temp101).curr -  s.curr) /  sizeof( unsigned char); s=
_tagged_arr_plus( _temp101, sizeof( unsigned char), 1);}} return(( struct Cyc_List_List*(*)(
struct Cyc_List_List* x)) Cyc_List_imp_rev)( _temp99);}} static int Cyc_file_exists(
struct _tagged_arr file){ struct Cyc_Std___sFILE* f= 0;{ struct _handler_cons
_temp106; _push_handler(& _temp106);{ int _temp108= 0; if( setjmp( _temp106.handler)){
_temp108= 1;} if( ! _temp108){ f=( struct Cyc_Std___sFILE*) Cyc_Std_file_open(
file, _tag_arr("r", sizeof( unsigned char), 2u));; _pop_handler();} else{ void*
_temp107=( void*) _exn_thrown; void* _temp110= _temp107; _LL112: goto _LL113;
_LL114: goto _LL115; _LL113: goto _LL111; _LL115:( void) _throw( _temp110);
_LL111:;}}} if( f ==  0){ return 0;} else{ Cyc_Std_fclose(( struct Cyc_Std___sFILE*)
...
1u); for( 0; dirs !=  0; dirs= dirs->tl){ struct _tagged_arr _temp116=*(( struct
_tagged_arr*) dirs->hd); if( _temp116.curr == (( struct _tagged_arr) _tag_arr( 0u,
0u, 0u)).curr? 1: Cyc_Std_strlen( _temp116) ==  0){ continue;} _temp116=( struct
_tagged_arr) Cyc_Std_strconcat( _temp116, _tag_arr(":", sizeof( unsigned char),
2u)); tmp=( struct _tagged_arr) Cyc_Std_strconcat( _temp116, tmp);} return tmp;}
...
return 0;} for( 0; dirs !=  0; dirs= dirs->tl){ struct _tagged_arr _temp117=*((
struct _tagged_arr*) dirs->hd); if( _temp117.curr == (( struct _tagged_arr)
_tag_arr( 0u, 0u, 0u)).curr? 1: Cyc_Std_strlen( _temp117) ==  0){ continue;}{
struct _tagged_arr s=( struct _tagged_arr) Cyc_Filename_concat( _temp117, file);
if( Cyc_file_exists( s)){ return({ struct _tagged_arr* _temp118=( struct
_tagged_arr*) _cycalloc( sizeof( struct _tagged_arr)); _temp118[ 0]= s; _temp118;});}}}
return 0;} static struct _tagged_arr Cyc_do_find( struct Cyc_List_List* dirs,
struct _tagged_arr file){ struct _tagged_arr* _temp119= Cyc_find( dirs, file);
if( _temp119 ==  0){({ struct Cyc_Std_String_pa_struct _temp122; _temp122.tag=
Cyc_Std_String_pa; _temp122.f1=( struct _tagged_arr) Cyc_sprint_list( dirs);{
struct Cyc_Std_String_pa_struct _temp121; _temp121.tag= Cyc_Std_String_pa;
_temp121.f1=( struct _tagged_arr) file;{ void* _temp120[ 2u]={& _temp121,&
_temp122}; Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("Error: can't find internal compiler file %s in path %s\n",
sizeof( unsigned char), 56u), _tag_arr( _temp120, sizeof( void*), 2u));}}}); Cyc_compile_failure=
1; Cyc_remove_cfiles(); exit( 1);} return* _temp119;} static int Cyc_is_other_special(
unsigned char c){ switch( c){ case '\\': _LL123: goto _LL124; case '"': _LL124:
goto _LL125; case ';': _LL125: goto _LL126; case '&': _LL126: goto _LL127; case
'(': _LL127: goto _LL128; case ')': _LL128: goto _LL129; case '|': _LL129: goto
_LL130; case '^': _LL130: goto _LL131; case '<': _LL131: goto _LL132; case '>':
_LL132: goto _LL133; case ' ': _LL133: goto _LL134; case '\n': _LL134: goto
_LL135; case '\t': _LL135: return 1; default: _LL136: return 0;}} static struct
_tagged_arr Cyc_sh_escape_string( struct _tagged_arr s){ unsigned int _temp138=
Cyc_Std_strlen( s); int _temp139= 0; int _temp140= 0;{ int i= 0; for( 0; i < 
_temp138; i ++){ unsigned char _temp141=(( const unsigned char*) s.curr)[ i];
if( _temp141 == '\''){ _temp139 ++;} else{ if( Cyc_is_other_special( _temp141)){
_temp140 ++;}}}} if( _temp139 ==  0? _temp140 ==  0: 0){ return s;} if( _temp139
==  0){ return( struct _tagged_arr) Cyc_Std_strconcat_l(({ struct _tagged_arr*
_temp142[ 3u]; _temp142[ 2u]= _init_tag_arr(( struct _tagged_arr*) _cycalloc(
sizeof( struct _tagged_arr)),"'", sizeof( unsigned char), 2u); _temp142[ 1u]=({
struct _tagged_arr* _temp143=( struct _tagged_arr*) _cycalloc( sizeof( struct
_tagged_arr)); _temp143[ 0]=( struct _tagged_arr) s; _temp143;}); _temp142[ 0u]=
...
Cyc_List_list)( _tag_arr( _temp142, sizeof( struct _tagged_arr*), 3u));}));}{
unsigned int _temp144=( _temp138 +  _temp139) +  _temp140; struct _tagged_arr
_temp145=({ unsigned int _temp149= _temp144 +  1; unsigned char* _temp150=(
unsigned char*) _cycalloc_atomic( _check_times( sizeof( unsigned char), _temp149));
struct _tagged_arr _temp152= _tag_arr( _temp150, sizeof( unsigned char),
_temp144 +  1);{ unsigned int _temp151= _temp149; unsigned int i; for( i= 0; i < 
_temp151; i ++){ _temp150[ i]='\000';}}; _temp152;}); int _temp146= 0; int
_temp147= 0; for( 0; _temp146 <  _temp138; _temp146 ++){ unsigned char _temp148=((
const unsigned char*) s.curr)[ _temp146]; if( _temp148 == '\''? 1: Cyc_is_other_special(
_temp148)){*(( unsigned char*) _check_unknown_subscript( _temp145, sizeof(
unsigned char), _temp147 ++))='\\';}*(( unsigned char*) _check_unknown_subscript(
_temp145, sizeof( unsigned char), _temp147 ++))= _temp148;} return( struct
_tagged_arr) _temp145;}} static struct _tagged_arr* Cyc_sh_escape_stringptr(
struct _tagged_arr* sp){ return({ struct _tagged_arr* _temp153=( struct
_tagged_arr*) _cycalloc( sizeof( struct _tagged_arr)); _temp153[ 0]= Cyc_sh_escape_string(*
sp); _temp153;});} static void Cyc_process_file( struct _tagged_arr filename){
struct _tagged_arr _temp154= Cyc_make_base_filename( filename, Cyc_output_file);
struct _tagged_arr _temp155= Cyc_Std_strconcat( _temp154, _tag_arr(".cyp",
sizeof( unsigned char), 5u)); struct _tagged_arr _temp156= Cyc_Std_strconcat(
_temp154, _tag_arr(".cyci", sizeof( unsigned char), 6u)); struct _tagged_arr
_temp157= Cyc_Std_strconcat( _temp154, _tag_arr(".cycio", sizeof( unsigned char),
7u)); struct _tagged_arr _temp158= Cyc_Std_strconcat( _temp154, _tag_arr(".c",
sizeof( unsigned char), 3u)); if( Cyc_v_r){({ struct Cyc_Std_String_pa_struct
_temp160; _temp160.tag= Cyc_Std_String_pa; _temp160.f1=( struct _tagged_arr)
filename;{ void* _temp159[ 1u]={& _temp160}; Cyc_Std_fprintf( Cyc_Std_stderr,
_tag_arr("Compiling %s\n", sizeof( unsigned char), 14u), _tag_arr( _temp159,
...
struct Cyc_Std___sFILE*) _check_null( f0));{ struct _tagged_arr _temp161= Cyc_Std_str_sepstr(({
...
stdinc_string=( struct _tagged_arr)({ struct Cyc_Std_String_pa_struct _temp163;
_temp163.tag= Cyc_Std_String_pa; _temp163.f1=( struct _tagged_arr) def_inc_path;{
void* _temp162[ 1u]={& _temp163}; Cyc_Std_aprintf( _tag_arr(" -I%s", sizeof(
unsigned char), 6u), _tag_arr( _temp162, sizeof( void*), 1u));}});} else{
stdinc_string= _tag_arr("", sizeof( unsigned char), 1u);}{ struct _tagged_arr
_temp164= Cyc_Std_getenv( _tag_arr("CYCLONE_INCLUDE_PATH", sizeof( unsigned char),
21u)); if( _temp164.curr != ( _tag_arr( 0u, 0u, 0u)).curr){ struct Cyc_List_List*
_temp165= Cyc_split_by_char(( struct _tagged_arr) _temp164,':'); struct
_tagged_arr _temp166= Cyc_Std_str_sepstr(({ struct Cyc_List_List* _temp170=(
...
_tagged_arr)),"", sizeof( unsigned char), 1u); _temp170->tl=(( struct Cyc_List_List*(*)(
struct _tagged_arr*(* f)( struct _tagged_arr*), struct Cyc_List_List* x)) Cyc_List_map)(
Cyc_sh_escape_stringptr, _temp165); _temp170;}), _tag_arr(" -I", sizeof(
...
stdinc_string;{ struct Cyc_Std_String_pa_struct _temp168; _temp168.tag= Cyc_Std_String_pa;
_temp168.f1=( struct _tagged_arr) _temp166;{ void* _temp167[ 2u]={& _temp168,&
_temp169}; Cyc_Std_aprintf( _tag_arr("%s%s", sizeof( unsigned char), 5u),
_tag_arr( _temp167, sizeof( void*), 2u));}}});}{ struct _tagged_arr ofile_string;
if( Cyc_stop_after_cpp_r){ if( Cyc_output_file !=  0){ ofile_string=( struct
_tagged_arr)({ struct Cyc_Std_String_pa_struct _temp172; _temp172.tag= Cyc_Std_String_pa;
_temp172.f1=( struct _tagged_arr)*(( struct _tagged_arr*) _check_null( Cyc_output_file));{
void* _temp171[ 1u]={& _temp172}; Cyc_Std_aprintf( _tag_arr(" > %s", sizeof(
unsigned char), 6u), _tag_arr( _temp171, sizeof( void*), 1u));}});} else{
ofile_string= _tag_arr("", sizeof( unsigned char), 1u);}} else{ ofile_string=(
struct _tagged_arr)({ struct Cyc_Std_String_pa_struct _temp174; _temp174.tag=
Cyc_Std_String_pa; _temp174.f1=( struct _tagged_arr) Cyc_sh_escape_string((
struct _tagged_arr) _temp155);{ void* _temp173[ 1u]={& _temp174}; Cyc_Std_aprintf(
_tag_arr(" > %s", sizeof( unsigned char), 6u), _tag_arr( _temp173, sizeof( void*),
...
void* _temp175[ 1u]={& _temp176}; Cyc_Std_aprintf( _tag_arr(" | sed 's/^.*\\.cyc\\.o:/%s:/'",
sizeof( unsigned char), 29u), _tag_arr( _temp175, sizeof( void*), 1u));}});}}
else{ fixup_string= _tag_arr("", sizeof( unsigned char), 1u);}{ struct
_tagged_arr _temp177=({ struct Cyc_Std_String_pa_struct _temp213; _temp213.tag=
...
_temp209.f1=( struct _tagged_arr) _temp161;{ struct Cyc_Std_String_pa_struct
_temp208; _temp208.tag= Cyc_Std_String_pa; _temp208.f1=( struct _tagged_arr) Cyc_cpp;{
void* _temp207[ 6u]={& _temp208,& _temp209,& _temp210,& _temp211,& _temp212,&
_temp213}; Cyc_Std_aprintf( _tag_arr("%s %s%s %s%s%s", sizeof( unsigned char),
15u), _tag_arr( _temp207, sizeof( void*), 6u));}}}}}}}); if( Cyc_v_r){({ struct
Cyc_Std_String_pa_struct _temp179; _temp179.tag= Cyc_Std_String_pa; _temp179.f1=(
struct _tagged_arr) _temp177;{ void* _temp178[ 1u]={& _temp179}; Cyc_Std_fprintf(
Cyc_Std_stderr, _tag_arr("%s\n", sizeof( unsigned char), 4u), _tag_arr( _temp178,
sizeof( void*), 1u));}});} if( Cyc_Std_system(( struct _tagged_arr) _temp177) != 
0){ Cyc_compile_failure= 1;({ void* _temp180[ 0u]={}; Cyc_Std_fprintf( Cyc_Std_stderr,
_tag_arr("\nError: preprocessing\n", sizeof( unsigned char), 23u), _tag_arr(
_temp180, sizeof( void*), 0u));}); return;} if( Cyc_stop_after_cpp_r){ return;}
Cyc_Position_reset_position(( struct _tagged_arr) _temp155);{ struct Cyc_Std___sFILE*
in_file= Cyc_try_file_open(( struct _tagged_arr) _temp155, _tag_arr("r", sizeof(
unsigned char), 2u), _tag_arr("file", sizeof( unsigned char), 5u)); if( Cyc_compile_failure){
return;}{ struct Cyc_List_List* tds= 0;{ struct _handler_cons _temp181;
_push_handler(& _temp181);{ int _temp183= 0; if( setjmp( _temp181.handler)){
_temp183= 1;} if( ! _temp183){ tds=(( struct Cyc_List_List*(*)( struct
...
void* _temp182=( void*) _exn_thrown; void* _temp185= _temp182; _LL187: goto
_LL188; _LL189: goto _LL190; _LL188: Cyc_Std_file_close(( struct Cyc_Std___sFILE*)
_check_null( in_file)); Cyc_remove_file(( struct _tagged_arr) _temp155);( int)
_throw( _temp185); _LL190:( void) _throw( _temp185); _LL186:;}}} Cyc_Std_file_close((
struct Cyc_Std___sFILE*) _check_null( in_file)); if( Cyc_compile_failure){ Cyc_remove_file((
struct _tagged_arr) _temp155); return;}{ struct Cyc_Tcenv_Tenv* _temp191= Cyc_Tcenv_tc_init();
...
_temp191, tds); if( Cyc_compile_failure){ Cyc_remove_file(( struct _tagged_arr)
_temp155); return;} tds=(( struct Cyc_List_List*(*)( struct _tagged_arr
...
Cyc_remove_file(( struct _tagged_arr) _temp155); return;} if( Cyc_ic_r){ struct
Cyc_Std___sFILE* inter_file= Cyc_Std_fopen(( struct _tagged_arr) _temp156,
_tag_arr("r", sizeof( unsigned char), 2u)); struct Cyc_Std___sFILE*
inter_objfile= Cyc_try_file_open(( struct _tagged_arr) _temp157, _tag_arr("w",
...
Cyc_Position_reset_position(( struct _tagged_arr) _temp156); tds=(( struct Cyc_List_List*(*)(
...
struct _tuple9* _temp192=( struct _tuple9*) _cycalloc( sizeof( struct _tuple9));
_temp192->f1= _temp191; _temp192->f2= inter_file; _temp192->f3=( struct Cyc_Std___sFILE*)
_check_null( inter_objfile); _temp192;}), tds); if( inter_file !=  0){ Cyc_Std_file_close((
...
tds); if( Cyc_compile_failure){ Cyc_remove_file(( struct _tagged_arr) _temp155);
return;} if( ! Cyc_compile_failure){ Cyc_Tcutil_flush_warnings();} Cyc_remove_file((
struct _tagged_arr) _temp155); if( Cyc_compile_failure){ return;} if( Cyc_tovc_r){
tds=(( struct Cyc_List_List*(*)( struct _tagged_arr stage_name, struct Cyc_List_List*(*
f)( int, struct Cyc_List_List*), int env, struct Cyc_List_List* tds)) Cyc_do_stage)(
...
struct _tagged_arr) _temp158, _tag_arr("w", sizeof( unsigned char), 2u),
_tag_arr("output file", sizeof( unsigned char), 12u));}} if( Cyc_compile_failure){
return;}{ struct _handler_cons _temp193; _push_handler(& _temp193);{ int
_temp195= 0; if( setjmp( _temp193.handler)){ _temp195= 1;} if( ! _temp195){ tds=((
...
out_file), tds);; _pop_handler();} else{ void* _temp194=( void*) _exn_thrown;
void* _temp197= _temp194; _LL199: goto _LL200; _LL201: goto _LL202; _LL200: Cyc_compile_failure=
1; Cyc_Std_file_close(( struct Cyc_Std___sFILE*) _check_null( out_file)); Cyc_cfiles=({
struct Cyc_List_List* _temp203=( struct Cyc_List_List*) _cycalloc( sizeof(
struct Cyc_List_List)); _temp203->hd=( void*)({ struct _tagged_arr* _temp204=(
struct _tagged_arr*) _cycalloc( sizeof( struct _tagged_arr)); _temp204[ 0]=(
struct _tagged_arr) _temp158; _temp204;}); _temp203->tl= Cyc_cfiles; _temp203;});(
int) _throw( _temp197); _LL202:( void) _throw( _temp197); _LL198:;}}} Cyc_Std_file_close((
struct Cyc_Std___sFILE*) _check_null( out_file)); Cyc_cfiles=({ struct Cyc_List_List*
_temp205=( struct Cyc_List_List*) _cycalloc( sizeof( struct Cyc_List_List));
_temp205->hd=( void*)({ struct _tagged_arr* _temp206=( struct _tagged_arr*)
_cycalloc( sizeof( struct _tagged_arr)); _temp206[ 0]=( struct _tagged_arr)
_temp158; _temp206;}); _temp205->tl= Cyc_cfiles; _temp205;});}}}}}}}}}}} static
...
struct Cyc_List_List* options=({ struct _tuple10* _temp303[ 48u]; _temp303[ 47u]=({
struct _tuple10* _temp445=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10));
_temp445->f1= _tag_arr("-warnboundschecks", sizeof( unsigned char), 18u);
_temp445->f2= 0; _temp445->f3= _tag_arr("", sizeof( unsigned char), 1u);
_temp445->f4=( void*)({ struct Cyc_Arg_Set_spec_struct* _temp446=( struct Cyc_Arg_Set_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct)); _temp446[ 0]=({ struct Cyc_Arg_Set_spec_struct
_temp447; _temp447.tag= Cyc_Arg_Set_spec; _temp447.f1=& Cyc_Toc_warn_bounds_checks;
_temp447;}); _temp446;}); _temp445->f5= _tag_arr("Warn when bounds checks can't be eliminated",
sizeof( unsigned char), 44u); _temp445;}); _temp303[ 46u]=({ struct _tuple10*
_temp442=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp442->f1=
_tag_arr("-printfullevars", sizeof( unsigned char), 16u); _temp442->f2= 0;
_temp442->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp442->f4=( void*)({
struct Cyc_Arg_Set_spec_struct* _temp443=( struct Cyc_Arg_Set_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct)); _temp443[ 0]=({ struct Cyc_Arg_Set_spec_struct
_temp444; _temp444.tag= Cyc_Arg_Set_spec; _temp444.f1=& Cyc_print_full_evars_r;
_temp444;}); _temp443;}); _temp442->f5= _tag_arr("Print full information for evars (type debugging)",
sizeof( unsigned char), 50u); _temp442;}); _temp303[ 45u]=({ struct _tuple10*
_temp439=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp439->f1=
_tag_arr("-printallkinds", sizeof( unsigned char), 15u); _temp439->f2= 0;
_temp439->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp439->f4=( void*)({
struct Cyc_Arg_Set_spec_struct* _temp440=( struct Cyc_Arg_Set_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct)); _temp440[ 0]=({ struct Cyc_Arg_Set_spec_struct
_temp441; _temp441.tag= Cyc_Arg_Set_spec; _temp441.f1=& Cyc_print_all_kinds_r;
_temp441;}); _temp440;}); _temp439->f5= _tag_arr("Always print kinds of type variables",
sizeof( unsigned char), 37u); _temp439;}); _temp303[ 44u]=({ struct _tuple10*
_temp436=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp436->f1=
_tag_arr("-printalltvars", sizeof( unsigned char), 15u); _temp436->f2= 0;
_temp436->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp436->f4=( void*)({
struct Cyc_Arg_Set_spec_struct* _temp437=( struct Cyc_Arg_Set_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct)); _temp437[ 0]=({ struct Cyc_Arg_Set_spec_struct
_temp438; _temp438.tag= Cyc_Arg_Set_spec; _temp438.f1=& Cyc_print_all_tvars_r;
_temp438;}); _temp437;}); _temp436->f5= _tag_arr("Print all type variables (even implicit default effects)",
sizeof( unsigned char), 57u); _temp436;}); _temp303[ 43u]=({ struct _tuple10*
_temp433=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp433->f1=
_tag_arr("-noexpandtypedefs", sizeof( unsigned char), 18u); _temp433->f2= 0;
_temp433->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp433->f4=( void*)({
struct Cyc_Arg_Set_spec_struct* _temp434=( struct Cyc_Arg_Set_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct)); _temp434[ 0]=({ struct Cyc_Arg_Set_spec_struct
_temp435; _temp435.tag= Cyc_Arg_Set_spec; _temp435.f1=& Cyc_noexpand_r; _temp435;});
_temp434;}); _temp433->f5= _tag_arr("Don't expand typedefs in pretty printing",
sizeof( unsigned char), 41u); _temp433;}); _temp303[ 42u]=({ struct _tuple10*
_temp430=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp430->f1=
_tag_arr("-noremoveunused", sizeof( unsigned char), 16u); _temp430->f2= 0;
_temp430->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp430->f4=( void*)({
...
_temp432; _temp432.tag= Cyc_Arg_Set_spec; _temp432.f1=& Cyc_noshake_r; _temp432;});
_temp431;}); _temp430->f5= _tag_arr("Don't remove externed variables that aren't used",
sizeof( unsigned char), 49u); _temp430;}); _temp303[ 41u]=({ struct _tuple10*
_temp427=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp427->f1=
_tag_arr("-nogc", sizeof( unsigned char), 6u); _temp427->f2= 0; _temp427->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp427->f4=( void*)({ struct Cyc_Arg_Set_spec_struct*
_temp428=( struct Cyc_Arg_Set_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct));
_temp428[ 0]=({ struct Cyc_Arg_Set_spec_struct _temp429; _temp429.tag= Cyc_Arg_Set_spec;
_temp429.f1=& Cyc_nogc_r; _temp429;}); _temp428;}); _temp427->f5= _tag_arr("Don't link in the garbage collector",
sizeof( unsigned char), 36u); _temp427;}); _temp303[ 40u]=({ struct _tuple10*
_temp424=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp424->f1=
_tag_arr("-nocyc", sizeof( unsigned char), 7u); _temp424->f2= 0; _temp424->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp424->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp425=( struct Cyc_Arg_Unit_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp425[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp426; _temp426.tag= Cyc_Arg_Unit_spec;
_temp426.f1= Cyc_set_nocyc; _temp426;}); _temp425;}); _temp424->f5= _tag_arr("Don't add implicit namespace Cyc",
sizeof( unsigned char), 33u); _temp424;}); _temp303[ 39u]=({ struct _tuple10*
_temp421=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp421->f1=
_tag_arr("-no-cpp-precomp", sizeof( unsigned char), 16u); _temp421->f2= 0;
_temp421->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp421->f4=( void*)({
struct Cyc_Arg_Unit_spec_struct* _temp422=( struct Cyc_Arg_Unit_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct)); _temp422[ 0]=({ struct Cyc_Arg_Unit_spec_struct
_temp423; _temp423.tag= Cyc_Arg_Unit_spec; _temp423.f1= Cyc_set_nocppprecomp;
_temp423;}); _temp422;}); _temp421->f5= _tag_arr("Don't do smart preprocessing (mac only)",
sizeof( unsigned char), 40u); _temp421;}); _temp303[ 38u]=({ struct _tuple10*
_temp418=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp418->f1=
_tag_arr("-use-cpp", sizeof( unsigned char), 9u); _temp418->f2= 0; _temp418->f3=
_tag_arr("<path>", sizeof( unsigned char), 7u); _temp418->f4=( void*)({ struct
Cyc_Arg_String_spec_struct* _temp419=( struct Cyc_Arg_String_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_String_spec_struct)); _temp419[ 0]=({ struct
Cyc_Arg_String_spec_struct _temp420; _temp420.tag= Cyc_Arg_String_spec; _temp420.f1=
Cyc_set_cpp; _temp420;}); _temp419;}); _temp418->f5= _tag_arr("Indicate which preprocessor to use",
sizeof( unsigned char), 35u); _temp418;}); _temp303[ 37u]=({ struct _tuple10*
_temp415=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp415->f1=
_tag_arr("--noboundschecks", sizeof( unsigned char), 17u); _temp415->f2= 0;
_temp415->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp415->f4=( void*)({
struct Cyc_Arg_Unit_spec_struct* _temp416=( struct Cyc_Arg_Unit_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct)); _temp416[ 0]=({ struct Cyc_Arg_Unit_spec_struct
_temp417; _temp417.tag= Cyc_Arg_Unit_spec; _temp417.f1= Cyc_set_noboundschecks;
_temp417;}); _temp416;}); _temp415->f5= _tag_arr("Disable bounds checks",
sizeof( unsigned char), 22u); _temp415;}); _temp303[ 36u]=({ struct _tuple10*
_temp412=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp412->f1=
_tag_arr("--nonullchecks", sizeof( unsigned char), 15u); _temp412->f2= 0;
_temp412->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp412->f4=( void*)({
struct Cyc_Arg_Unit_spec_struct* _temp413=( struct Cyc_Arg_Unit_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct)); _temp413[ 0]=({ struct Cyc_Arg_Unit_spec_struct
_temp414; _temp414.tag= Cyc_Arg_Unit_spec; _temp414.f1= Cyc_set_nonullchecks;
_temp414;}); _temp413;}); _temp412->f5= _tag_arr("Disable null checks", sizeof(
unsigned char), 20u); _temp412;}); _temp303[ 35u]=({ struct _tuple10* _temp409=(
struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp409->f1= _tag_arr("--nochecks",
sizeof( unsigned char), 11u); _temp409->f2= 0; _temp409->f3= _tag_arr("",
sizeof( unsigned char), 1u); _temp409->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp410=( struct Cyc_Arg_Unit_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp410[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp411; _temp411.tag= Cyc_Arg_Unit_spec;
_temp411.f1= Cyc_set_nochecks; _temp411;}); _temp410;}); _temp409->f5= _tag_arr("Disable bounds/null checks",
sizeof( unsigned char), 27u); _temp409;}); _temp303[ 34u]=({ struct _tuple10*
_temp406=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp406->f1=
_tag_arr("--lineno", sizeof( unsigned char), 9u); _temp406->f2= 0; _temp406->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp406->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp407=( struct Cyc_Arg_Unit_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp407[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp408; _temp408.tag= Cyc_Arg_Unit_spec;
_temp408.f1= Cyc_set_lineno; _temp408;}); _temp407;}); _temp406->f5= _tag_arr("Generate line numbers for debugging",
sizeof( unsigned char), 36u); _temp406;}); _temp303[ 33u]=({ struct _tuple10*
_temp403=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp403->f1=
_tag_arr("-save-c", sizeof( unsigned char), 8u); _temp403->f2= 0; _temp403->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp403->f4=( void*)({ struct Cyc_Arg_Set_spec_struct*
...
_temp405.f1=& Cyc_save_c_r; _temp405;}); _temp404;}); _temp403->f5= _tag_arr("Don't delete temporary C files",
sizeof( unsigned char), 31u); _temp403;}); _temp303[ 32u]=({ struct _tuple10*
_temp400=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp400->f1=
_tag_arr("-save-temps", sizeof( unsigned char), 12u); _temp400->f2= 0; _temp400->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp400->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp401=( struct Cyc_Arg_Unit_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp401[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp402; _temp402.tag= Cyc_Arg_Unit_spec;
_temp402.f1= Cyc_set_save_temps; _temp402;}); _temp401;}); _temp400->f5=
_tag_arr("Don't delete temporary files", sizeof( unsigned char), 29u); _temp400;});
_temp303[ 31u]=({ struct _tuple10* _temp397=( struct _tuple10*) _cycalloc(
sizeof( struct _tuple10)); _temp397->f1= _tag_arr("-tovc", sizeof( unsigned char),
6u); _temp397->f2= 0; _temp397->f3= _tag_arr("", sizeof( unsigned char), 1u);
_temp397->f4=( void*)({ struct Cyc_Arg_Set_spec_struct* _temp398=( struct Cyc_Arg_Set_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct)); _temp398[ 0]=({ struct Cyc_Arg_Set_spec_struct
_temp399; _temp399.tag= Cyc_Arg_Set_spec; _temp399.f1=& Cyc_tovc_r; _temp399;});
_temp398;}); _temp397->f5= _tag_arr("Avoid gcc extensions in C output", sizeof(
unsigned char), 33u); _temp397;}); _temp303[ 30u]=({ struct _tuple10* _temp394=(
struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp394->f1= _tag_arr("-up",
sizeof( unsigned char), 4u); _temp394->f2= 0; _temp394->f3= _tag_arr("", sizeof(
unsigned char), 1u); _temp394->f4=( void*)({ struct Cyc_Arg_Clear_spec_struct*
_temp395=( struct Cyc_Arg_Clear_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Clear_spec_struct));
_temp395[ 0]=({ struct Cyc_Arg_Clear_spec_struct _temp396; _temp396.tag= Cyc_Arg_Clear_spec;
_temp396.f1=& Cyc_pp_r; _temp396;}); _temp395;}); _temp394->f5= _tag_arr("Ugly print",
sizeof( unsigned char), 11u); _temp394;}); _temp303[ 29u]=({ struct _tuple10*
_temp391=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp391->f1=
_tag_arr("-pp", sizeof( unsigned char), 4u); _temp391->f2= 0; _temp391->f3=
...
_temp393.f1=& Cyc_pp_r; _temp393;}); _temp392;}); _temp391->f5= _tag_arr("Pretty print",
sizeof( unsigned char), 13u); _temp391;}); _temp303[ 28u]=({ struct _tuple10*
_temp388=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp388->f1=
_tag_arr("-ic", sizeof( unsigned char), 4u); _temp388->f2= 0; _temp388->f3=
...
_temp390.f1=& Cyc_ic_r; _temp390;}); _temp389;}); _temp388->f5= _tag_arr("Activate the link-checker",
sizeof( unsigned char), 26u); _temp388;}); _temp303[ 27u]=({ struct _tuple10*
_temp385=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp385->f1=
_tag_arr("-stopafter-toc", sizeof( unsigned char), 15u); _temp385->f2= 0;
...
_cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct)); _temp386[ 0]=({ struct Cyc_Arg_Set_spec_struct
_temp387; _temp387.tag= Cyc_Arg_Set_spec; _temp387.f1=& Cyc_toc_r; _temp387;});
_temp386;}); _temp385->f5= _tag_arr("Stop after translation to C", sizeof(
unsigned char), 28u); _temp385;}); _temp303[ 26u]=({ struct _tuple10* _temp382=(
struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp382->f1= _tag_arr("-stopafter-tc",
sizeof( unsigned char), 14u); _temp382->f2= 0; _temp382->f3= _tag_arr("",
...
_temp384.f1=& Cyc_tc_r; _temp384;}); _temp383;}); _temp382->f5= _tag_arr("Stop after type checking",
sizeof( unsigned char), 25u); _temp382;}); _temp303[ 25u]=({ struct _tuple10*
_temp379=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp379->f1=
_tag_arr("-stopafter-parse", sizeof( unsigned char), 17u); _temp379->f2= 0;
_temp379->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp379->f4=( void*)({
struct Cyc_Arg_Set_spec_struct* _temp380=( struct Cyc_Arg_Set_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct)); _temp380[ 0]=({ struct Cyc_Arg_Set_spec_struct
_temp381; _temp381.tag= Cyc_Arg_Set_spec; _temp381.f1=& Cyc_parseonly_r;
_temp381;}); _temp380;}); _temp379->f5= _tag_arr("Stop after parsing", sizeof(
unsigned char), 19u); _temp379;}); _temp303[ 24u]=({ struct _tuple10* _temp376=(
struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp376->f1= _tag_arr("-E",
sizeof( unsigned char), 3u); _temp376->f2= 0; _temp376->f3= _tag_arr("", sizeof(
unsigned char), 1u); _temp376->f4=( void*)({ struct Cyc_Arg_Set_spec_struct*
_temp377=( struct Cyc_Arg_Set_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct));
_temp377[ 0]=({ struct Cyc_Arg_Set_spec_struct _temp378; _temp378.tag= Cyc_Arg_Set_spec;
_temp378.f1=& Cyc_stop_after_cpp_r; _temp378;}); _temp377;}); _temp376->f5=
_tag_arr("Stop after preprocessing", sizeof( unsigned char), 25u); _temp376;});
_temp303[ 23u]=({ struct _tuple10* _temp373=( struct _tuple10*) _cycalloc(
sizeof( struct _tuple10)); _temp373->f1= _tag_arr("-MT", sizeof( unsigned char),
4u); _temp373->f2= 0; _temp373->f3= _tag_arr(" <target>", sizeof( unsigned char),
10u); _temp373->f4=( void*)({ struct Cyc_Arg_String_spec_struct* _temp374=(
struct Cyc_Arg_String_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_String_spec_struct));
_temp374[ 0]=({ struct Cyc_Arg_String_spec_struct _temp375; _temp375.tag= Cyc_Arg_String_spec;
_temp375.f1= Cyc_set_dependencies_target; _temp375;}); _temp374;}); _temp373->f5=
_tag_arr("Give target for dependencies", sizeof( unsigned char), 29u); _temp373;});
_temp303[ 22u]=({ struct _tuple10* _temp370=( struct _tuple10*) _cycalloc(
sizeof( struct _tuple10)); _temp370->f1= _tag_arr("-MG", sizeof( unsigned char),
4u); _temp370->f2= 0; _temp370->f3= _tag_arr("", sizeof( unsigned char), 1u);
_temp370->f4=( void*)({ struct Cyc_Arg_Flag_spec_struct* _temp371=( struct Cyc_Arg_Flag_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Flag_spec_struct)); _temp371[ 0]=({ struct Cyc_Arg_Flag_spec_struct
_temp372; _temp372.tag= Cyc_Arg_Flag_spec; _temp372.f1= Cyc_add_cpparg; _temp372;});
_temp371;}); _temp370->f5= _tag_arr("When producing dependencies assume that missing files are generated",
sizeof( unsigned char), 68u); _temp370;}); _temp303[ 21u]=({ struct _tuple10*
_temp367=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp367->f1=
_tag_arr("-M", sizeof( unsigned char), 3u); _temp367->f2= 0; _temp367->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp367->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp368=( struct Cyc_Arg_Unit_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp368[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp369; _temp369.tag= Cyc_Arg_Unit_spec;
_temp369.f1= Cyc_set_produce_dependencies; _temp369;}); _temp368;}); _temp367->f5=
_tag_arr("Produce dependencies", sizeof( unsigned char), 21u); _temp367;});
_temp303[ 20u]=({ struct _tuple10* _temp364=( struct _tuple10*) _cycalloc(
sizeof( struct _tuple10)); _temp364->f1= _tag_arr("-S", sizeof( unsigned char),
3u); _temp364->f2= 0; _temp364->f3= _tag_arr("", sizeof( unsigned char), 1u);
_temp364->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct* _temp365=( struct Cyc_Arg_Unit_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct)); _temp365[ 0]=({ struct Cyc_Arg_Unit_spec_struct
_temp366; _temp366.tag= Cyc_Arg_Unit_spec; _temp366.f1= Cyc_set_stop_after_asmfile;
_temp366;}); _temp365;}); _temp364->f5= _tag_arr("Stop after producing assembly code",
sizeof( unsigned char), 35u); _temp364;}); _temp303[ 19u]=({ struct _tuple10*
_temp361=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp361->f1=
_tag_arr("-pa", sizeof( unsigned char), 4u); _temp361->f2= 0; _temp361->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp361->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp362=( struct Cyc_Arg_Unit_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp362[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp363; _temp363.tag= Cyc_Arg_Unit_spec;
_temp363.f1= Cyc_set_pa; _temp363;}); _temp362;}); _temp361->f5= _tag_arr("Compile for profiling with aprof",
sizeof( unsigned char), 33u); _temp361;}); _temp303[ 18u]=({ struct _tuple10*
_temp358=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp358->f1=
_tag_arr("-pg", sizeof( unsigned char), 4u); _temp358->f2= 0; _temp358->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp358->f4=( void*)({ struct Cyc_Arg_Flag_spec_struct*
_temp359=( struct Cyc_Arg_Flag_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Flag_spec_struct));
_temp359[ 0]=({ struct Cyc_Arg_Flag_spec_struct _temp360; _temp360.tag= Cyc_Arg_Flag_spec;
_temp360.f1= Cyc_add_ccarg; _temp360;}); _temp359;}); _temp358->f5= _tag_arr("Compile for profiling with gprof",
sizeof( unsigned char), 33u); _temp358;}); _temp303[ 17u]=({ struct _tuple10*
_temp355=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp355->f1=
_tag_arr("-p", sizeof( unsigned char), 3u); _temp355->f2= 0; _temp355->f3=
...
_temp357.f1= Cyc_add_ccarg; _temp357;}); _temp356;}); _temp355->f5= _tag_arr("Compile for profiling with prof",
sizeof( unsigned char), 32u); _temp355;}); _temp303[ 16u]=({ struct _tuple10*
_temp352=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp352->f1=
_tag_arr("-g", sizeof( unsigned char), 3u); _temp352->f2= 0; _temp352->f3=
...
_temp354.f1= Cyc_add_ccarg; _temp354;}); _temp353;}); _temp352->f5= _tag_arr("Compile for debugging",
sizeof( unsigned char), 22u); _temp352;}); _temp303[ 15u]=({ struct _tuple10*
_temp349=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp349->f1=
_tag_arr("-fomit-frame-pointer", sizeof( unsigned char), 21u); _temp349->f2= 0;
_temp349->f3= _tag_arr("", sizeof( unsigned char), 1u); _temp349->f4=( void*)({
struct Cyc_Arg_Flag_spec_struct* _temp350=( struct Cyc_Arg_Flag_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Flag_spec_struct)); _temp350[ 0]=({ struct Cyc_Arg_Flag_spec_struct
_temp351; _temp351.tag= Cyc_Arg_Flag_spec; _temp351.f1= Cyc_add_ccarg; _temp351;});
_temp350;}); _temp349->f5= _tag_arr("Omit frame pointer", sizeof( unsigned char),
19u); _temp349;}); _temp303[ 14u]=({ struct _tuple10* _temp346=( struct _tuple10*)
_cycalloc( sizeof( struct _tuple10)); _temp346->f1= _tag_arr("-O3", sizeof(
unsigned char), 4u); _temp346->f2= 0; _temp346->f3= _tag_arr("", sizeof(
unsigned char), 1u); _temp346->f4=( void*)({ struct Cyc_Arg_Flag_spec_struct*
...
sizeof( unsigned char), 23u); _temp346;}); _temp303[ 13u]=({ struct _tuple10*
...
sizeof( unsigned char), 31u); _temp343;}); _temp303[ 12u]=({ struct _tuple10*
...
sizeof( unsigned char), 9u); _temp340;}); _temp303[ 11u]=({ struct _tuple10*
_temp337=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp337->f1=
_tag_arr("-O0", sizeof( unsigned char), 4u); _temp337->f2= 0; _temp337->f3=
...
_temp339.f1= Cyc_add_ccarg; _temp339;}); _temp338;}); _temp337->f5= _tag_arr("Don't optimize",
sizeof( unsigned char), 15u); _temp337;}); _temp303[ 10u]=({ struct _tuple10*
_temp334=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp334->f1=
_tag_arr("-s", sizeof( unsigned char), 3u); _temp334->f2= 0; _temp334->f3=
...
_temp336.f1= Cyc_add_ccarg; _temp336;}); _temp335;}); _temp334->f5= _tag_arr("Remove all symbol table and relocation info from executable",
sizeof( unsigned char), 60u); _temp334;}); _temp303[ 9u]=({ struct _tuple10*
_temp331=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp331->f1=
_tag_arr("-x", sizeof( unsigned char), 3u); _temp331->f2= 0; _temp331->f3=
_tag_arr(" <language>", sizeof( unsigned char), 12u); _temp331->f4=( void*)({
struct Cyc_Arg_String_spec_struct* _temp332=( struct Cyc_Arg_String_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_String_spec_struct)); _temp332[ 0]=({ struct
Cyc_Arg_String_spec_struct _temp333; _temp333.tag= Cyc_Arg_String_spec; _temp333.f1=
Cyc_set_inputtype; _temp333;}); _temp332;}); _temp331->f5= _tag_arr("Specify <language> for the following input files",
sizeof( unsigned char), 49u); _temp331;}); _temp303[ 8u]=({ struct _tuple10*
_temp328=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp328->f1=
_tag_arr("-c", sizeof( unsigned char), 3u); _temp328->f2= 0; _temp328->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp328->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp329=( struct Cyc_Arg_Unit_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp329[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp330; _temp330.tag= Cyc_Arg_Unit_spec;
_temp330.f1= Cyc_set_stop_after_objectfile; _temp330;}); _temp329;}); _temp328->f5=
_tag_arr("Produce an object file instead of an executable; do not link", sizeof(
unsigned char), 61u); _temp328;}); _temp303[ 7u]=({ struct _tuple10* _temp325=(
struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp325->f1= _tag_arr("-l",
sizeof( unsigned char), 3u); _temp325->f2= 1; _temp325->f3= _tag_arr("<file>",
sizeof( unsigned char), 7u); _temp325->f4=( void*)({ struct Cyc_Arg_Flag_spec_struct*
...
_temp327.f1= Cyc_add_libarg; _temp327;}); _temp326;}); _temp325->f5= _tag_arr("Library file",
sizeof( unsigned char), 13u); _temp325;}); _temp303[ 6u]=({ struct _tuple10*
_temp322=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp322->f1=
_tag_arr("-L", sizeof( unsigned char), 3u); _temp322->f2= 1; _temp322->f3=
...
_temp324; _temp324.tag= Cyc_Arg_Flag_spec; _temp324.f1= Cyc_add_cyclone_lib_path;
_temp324;}); _temp323;}); _temp322->f5= _tag_arr("Add to the list of directories for -l",
sizeof( unsigned char), 38u); _temp322;}); _temp303[ 5u]=({ struct _tuple10*
_temp319=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp319->f1=
_tag_arr("-I", sizeof( unsigned char), 3u); _temp319->f2= 1; _temp319->f3=
...
_temp320;}); _temp319->f5= _tag_arr("Add to the list of directories to search for include files",
sizeof( unsigned char), 59u); _temp319;}); _temp303[ 4u]=({ struct _tuple10*
_temp316=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp316->f1=
_tag_arr("-B", sizeof( unsigned char), 3u); _temp316->f2= 1; _temp316->f3=
_tag_arr("<file>", sizeof( unsigned char), 7u); _temp316->f4=( void*)({ struct
Cyc_Arg_Flag_spec_struct* _temp317=( struct Cyc_Arg_Flag_spec_struct*) _cycalloc(
sizeof( struct Cyc_Arg_Flag_spec_struct)); _temp317[ 0]=({ struct Cyc_Arg_Flag_spec_struct
_temp318; _temp318.tag= Cyc_Arg_Flag_spec; _temp318.f1= Cyc_add_cyclone_lib_path;
_temp318;}); _temp317;}); _temp316->f5= _tag_arr("Add to the list of directories to search for compiler files",
sizeof( unsigned char), 60u); _temp316;}); _temp303[ 3u]=({ struct _tuple10*
_temp313=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp313->f1=
_tag_arr("-D", sizeof( unsigned char), 3u); _temp313->f2= 1; _temp313->f3=
_tag_arr("<name>[=<value>]", sizeof( unsigned char), 17u); _temp313->f4=( void*)({
struct Cyc_Arg_Flag_spec_struct* _temp314=( struct Cyc_Arg_Flag_spec_struct*)
_cycalloc( sizeof( struct Cyc_Arg_Flag_spec_struct)); _temp314[ 0]=({ struct Cyc_Arg_Flag_spec_struct
_temp315; _temp315.tag= Cyc_Arg_Flag_spec; _temp315.f1= Cyc_add_cpparg; _temp315;});
_temp314;}); _temp313->f5= _tag_arr("Pass definition to preprocessor", sizeof(
unsigned char), 32u); _temp313;}); _temp303[ 2u]=({ struct _tuple10* _temp310=(
struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp310->f1= _tag_arr("-o",
sizeof( unsigned char), 3u); _temp310->f2= 0; _temp310->f3= _tag_arr(" <file>",
sizeof( unsigned char), 8u); _temp310->f4=( void*)({ struct Cyc_Arg_String_spec_struct*
_temp311=( struct Cyc_Arg_String_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_String_spec_struct));
_temp311[ 0]=({ struct Cyc_Arg_String_spec_struct _temp312; _temp312.tag= Cyc_Arg_String_spec;
_temp312.f1= Cyc_set_output_file; _temp312;}); _temp311;}); _temp310->f5=
_tag_arr("Set the output file name to <file>", sizeof( unsigned char), 35u);
_temp310;}); _temp303[ 1u]=({ struct _tuple10* _temp307=( struct _tuple10*)
_cycalloc( sizeof( struct _tuple10)); _temp307->f1= _tag_arr("--version",
sizeof( unsigned char), 10u); _temp307->f2= 0; _temp307->f3= _tag_arr("",
sizeof( unsigned char), 1u); _temp307->f4=( void*)({ struct Cyc_Arg_Unit_spec_struct*
_temp308=( struct Cyc_Arg_Unit_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Unit_spec_struct));
_temp308[ 0]=({ struct Cyc_Arg_Unit_spec_struct _temp309; _temp309.tag= Cyc_Arg_Unit_spec;
_temp309.f1= Cyc_print_version; _temp309;}); _temp308;}); _temp307->f5= _tag_arr("Print version information and exit",
sizeof( unsigned char), 35u); _temp307;}); _temp303[ 0u]=({ struct _tuple10*
_temp304=( struct _tuple10*) _cycalloc( sizeof( struct _tuple10)); _temp304->f1=
_tag_arr("-v", sizeof( unsigned char), 3u); _temp304->f2= 0; _temp304->f3=
_tag_arr("", sizeof( unsigned char), 1u); _temp304->f4=( void*)({ struct Cyc_Arg_Set_spec_struct*
_temp305=( struct Cyc_Arg_Set_spec_struct*) _cycalloc( sizeof( struct Cyc_Arg_Set_spec_struct));
_temp305[ 0]=({ struct Cyc_Arg_Set_spec_struct _temp306; _temp306.tag= Cyc_Arg_Set_spec;
_temp306.f1=& Cyc_v_r; _temp306;}); _temp305;}); _temp304->f5= _tag_arr("Print compilation stages verbosely",
sizeof( unsigned char), 35u); _temp304;});(( struct Cyc_List_List*(*)( struct
_tagged_arr)) Cyc_List_list)( _tag_arr( _temp303, sizeof( struct _tuple10*), 48u));});
Cyc_Arg_parse( options, Cyc_add_other, _tag_arr("Options:", sizeof(
unsigned char), 9u), argv); if( Cyc_cyclone_files ==  0? Cyc_ccargs ==  0: 0){({
void* _temp229[ 0u]={}; Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("missing file",
sizeof( unsigned char), 13u), _tag_arr( _temp229, sizeof( void*), 0u));}); exit(
1);}{ struct _tagged_arr cyclone_exec_prefix=( struct _tagged_arr) Cyc_Std_getenv(
...
Cyc_cyclone_lib_path=({ struct Cyc_List_List* _temp230=( struct Cyc_List_List*)
_cycalloc( sizeof( struct Cyc_List_List)); _temp230->hd=( void*)({ struct
_tagged_arr* _temp231=( struct _tagged_arr*) _cycalloc( sizeof( struct
_tagged_arr)); _temp231[ 0]= cyclone_exec_prefix; _temp231;}); _temp230->tl= Cyc_cyclone_lib_path;
_temp230;});}{ struct _tagged_arr def_lib_path=( struct _tagged_arr)
...
struct Cyc_List_List)); _temp232->hd=( void*)({ struct _tagged_arr* _temp233=(
struct _tagged_arr*) _cycalloc( sizeof( struct _tagged_arr)); _temp233[ 0]=
def_lib_path; _temp233;}); _temp232->tl= Cyc_cyclone_lib_path; _temp232;});}{
...
unsigned char), 22u));{ struct Cyc_List_List* _temp234=(( struct Cyc_List_List*(*)(
struct Cyc_List_List* x)) Cyc_List_rev)( Cyc_cyclone_files); for( 0; _temp234 != 
0; _temp234= _temp234->tl){ Cyc_process_file(*(( struct _tagged_arr*) _temp234->hd));
...
Cyc_libargs);{ struct _tagged_arr _temp236= Cyc_Std_str_sepstr(({ struct Cyc_List_List*
_temp302=( struct Cyc_List_List*) _cycalloc( sizeof( struct Cyc_List_List));
_temp302->hd=( void*) _init_tag_arr(( struct _tagged_arr*) _cycalloc( sizeof(
struct _tagged_arr)),"", sizeof( unsigned char), 1u); _temp302->tl=(( struct Cyc_List_List*(*)(
struct _tagged_arr*(* f)( struct _tagged_arr*), struct Cyc_List_List* x)) Cyc_List_map)(
Cyc_sh_escape_stringptr, Cyc_libargs); _temp302;}), _tag_arr(" ", sizeof(
unsigned char), 2u)); struct Cyc_List_List* stdlib; struct _tagged_arr
stdlib_string; int _temp237=(( Cyc_stop_after_asmfile_r? 1: Cyc_stop_after_objectfile_r)?
...
if( _temp237){ stdlib= 0; stdlib_string= _tag_arr("", sizeof( unsigned char), 1u);}
...
_temp238= Cyc_do_find( Cyc_cyclone_lib_path, libcyc_filename); struct
_tagged_arr _temp239= Cyc_nogc_r? Cyc_do_find( Cyc_cyclone_lib_path,
nogc_filename): Cyc_do_find( Cyc_cyclone_lib_path, gc_filename); stdlib=({
struct _tagged_arr* _temp240[ 1u]; _temp240[ 0u]=({ struct _tagged_arr* _temp241=(
struct _tagged_arr*) _cycalloc( sizeof( struct _tagged_arr)); _temp241[ 0]=
_temp238; _temp241;});(( struct Cyc_List_List*(*)( struct _tagged_arr)) Cyc_List_list)(
_tag_arr( _temp240, sizeof( struct _tagged_arr*), 1u));}); stdlib_string=(
struct _tagged_arr)({ struct Cyc_Std_String_pa_struct _temp244; _temp244.tag=
Cyc_Std_String_pa; _temp244.f1=( struct _tagged_arr) _temp239;{ struct Cyc_Std_String_pa_struct
_temp243; _temp243.tag= Cyc_Std_String_pa; _temp243.f1=( struct _tagged_arr)
_temp238;{ void* _temp242[ 2u]={& _temp243,& _temp244}; Cyc_Std_aprintf(
_tag_arr(" %s %s", sizeof( unsigned char), 7u), _tag_arr( _temp242, sizeof( void*),
2u));}}});}} if( Cyc_ic_r){ struct _handler_cons _temp245; _push_handler(&
_temp245);{ int _temp247= 0; if( setjmp( _temp245.handler)){ _temp247= 1;} if( !
_temp247){ Cyc_ccargs=(( struct Cyc_List_List*(*)( int(* f)( struct _tagged_arr*),
...
_temp248=(( struct Cyc_List_List*(*)( struct Cyc_List_List* x, struct Cyc_List_List*
...
_temp237){ _temp248=({ struct Cyc_List_List* _temp249=( struct Cyc_List_List*)
_cycalloc( sizeof( struct Cyc_List_List)); _temp249->hd=( void*) Cyc_final_strptr;
_temp249->tl= _temp248; _temp249;});}{ struct Cyc_Interface_I* _temp250=((
...
Cyc_read_cycio, _temp248, _temp248); if( _temp250 ==  0){({ void* _temp251[ 0u]={};
Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("Error: interfaces incompatible\n",
sizeof( unsigned char), 32u), _tag_arr( _temp251, sizeof( void*), 0u));}); Cyc_compile_failure=
1; Cyc_remove_cfiles();{ int _temp252= 1; _npop_handler( 0u); return _temp252;}}
if( _temp237){ if( Cyc_output_file !=  0){ struct _tagged_arr _temp253=({ struct
Cyc_Std_String_pa_struct _temp257; _temp257.tag= Cyc_Std_String_pa; _temp257.f1=(
struct _tagged_arr) Cyc_Filename_chop_extension(*(( struct _tagged_arr*)
_check_null( Cyc_output_file)));{ void* _temp256[ 1u]={& _temp257}; Cyc_Std_aprintf(
_tag_arr("%s.cycio", sizeof( unsigned char), 9u), _tag_arr( _temp256, sizeof(
void*), 1u));}}); struct Cyc_Std___sFILE* _temp254= Cyc_try_file_open(( struct
_tagged_arr) _temp253, _tag_arr("w", sizeof( unsigned char), 2u), _tag_arr("interface object file",
sizeof( unsigned char), 22u)); if( _temp254 ==  0){ Cyc_compile_failure= 1; Cyc_remove_cfiles();{
int _temp255= 1; _npop_handler( 0u); return _temp255;}} Cyc_Interface_save((
struct Cyc_Interface_I*) _check_null( _temp250),( struct Cyc_Std___sFILE*)
_check_null( _temp254)); Cyc_Std_file_close(( struct Cyc_Std___sFILE*)
_check_null( _temp254));}} else{ if( ! Cyc_Interface_is_subinterface( Cyc_Interface_empty(),(
struct Cyc_Interface_I*) _check_null( _temp250),({ struct _tuple8* _temp258=(
struct _tuple8*) _cycalloc( sizeof( struct _tuple8)); _temp258->f1= _tag_arr("empty interface",
sizeof( unsigned char), 16u); _temp258->f2= _tag_arr("global interface", sizeof(
unsigned char), 17u); _temp258;}))){({ void* _temp259[ 0u]={}; Cyc_Std_fprintf(
Cyc_Std_stderr, _tag_arr("Error: some objects are still undefined\n", sizeof(
unsigned char), 41u), _tag_arr( _temp259, sizeof( void*), 0u));}); Cyc_compile_failure=
1; Cyc_remove_cfiles();{ int _temp260= 1; _npop_handler( 0u); return _temp260;}}}}};
_pop_handler();} else{ void* _temp246=( void*) _exn_thrown; void* _temp262=
_temp246; struct _tagged_arr _temp276; struct _tagged_arr _temp278; struct
_tagged_arr _temp280; _LL264: if(*(( void**) _temp262) ==  Cyc_Core_Failure){
_LL277: _temp276=(( struct Cyc_Core_Failure_struct*) _temp262)->f1; goto _LL265;}
else{ goto _LL266;} _LL266: if(*(( void**) _temp262) ==  Cyc_Core_Impossible){
_LL279: _temp278=(( struct Cyc_Core_Impossible_struct*) _temp262)->f1; goto
_LL267;} else{ goto _LL268;} _LL268: if( _temp262 ==  Cyc_Dict_Absent){ goto
_LL269;} else{ goto _LL270;} _LL270: if(*(( void**) _temp262) ==  Cyc_Core_Invalid_argument){
_LL281: _temp280=(( struct Cyc_Core_Invalid_argument_struct*) _temp262)->f1;
goto _LL271;} else{ goto _LL272;} _LL272: goto _LL273; _LL274: goto _LL275;
_LL265:({ struct Cyc_Std_String_pa_struct _temp283; _temp283.tag= Cyc_Std_String_pa;
_temp283.f1=( struct _tagged_arr) _temp276;{ void* _temp282[ 1u]={& _temp283};
Cyc_Std_printf( _tag_arr("Exception Core::Failure %s\n", sizeof( unsigned char),
28u), _tag_arr( _temp282, sizeof( void*), 1u));}}); Cyc_compile_failure= 1; Cyc_remove_cfiles();
return 1; _LL267:({ struct Cyc_Std_String_pa_struct _temp285; _temp285.tag= Cyc_Std_String_pa;
_temp285.f1=( struct _tagged_arr) _temp278;{ void* _temp284[ 1u]={& _temp285};
Cyc_Std_printf( _tag_arr("Exception Core::Impossible %s\n", sizeof(
unsigned char), 31u), _tag_arr( _temp284, sizeof( void*), 1u));}}); Cyc_compile_failure=
1; Cyc_remove_cfiles(); return 1; _LL269:({ void* _temp286[ 0u]={}; Cyc_Std_printf(
_tag_arr("Exception Dict::Absent\n", sizeof( unsigned char), 24u), _tag_arr(
_temp286, sizeof( void*), 0u));}); Cyc_compile_failure= 1; Cyc_remove_cfiles();
return 1; _LL271:({ struct Cyc_Std_String_pa_struct _temp288; _temp288.tag= Cyc_Std_String_pa;
_temp288.f1=( struct _tagged_arr) _temp280;{ void* _temp287[ 1u]={& _temp288};
Cyc_Std_printf( _tag_arr("Exception Core::Invalid_argument %s\n", sizeof(
unsigned char), 37u), _tag_arr( _temp287, sizeof( void*), 1u));}}); Cyc_compile_failure=
1; Cyc_remove_cfiles(); return 1; _LL273:({ void* _temp289[ 0u]={}; Cyc_Std_printf(
...
return 1; _LL275:( void) _throw( _temp262); _LL263:;}}}{ struct _tagged_arr
_temp290=({ struct Cyc_Std_String_pa_struct _temp299; _temp299.tag= Cyc_Std_String_pa;
_temp299.f1=( struct _tagged_arr) _temp236;{ struct Cyc_Std_String_pa_struct
_temp298; _temp298.tag= Cyc_Std_String_pa; _temp298.f1=( struct _tagged_arr)
stdlib_string;{ struct Cyc_Std_String_pa_struct _temp297; _temp297.tag= Cyc_Std_String_pa;
_temp297.f1=( struct _tagged_arr) _temp235;{ struct Cyc_Std_String_pa_struct
...
_tagged_arr)({ struct Cyc_Std_String_pa_struct _temp301; _temp301.tag= Cyc_Std_String_pa;
_temp301.f1=( struct _tagged_arr) Cyc_sh_escape_string(*(( struct _tagged_arr*)
_check_null( Cyc_output_file)));{ void* _temp300[ 1u]={& _temp301}; Cyc_Std_aprintf(
_tag_arr(" -o %s", sizeof( unsigned char), 7u), _tag_arr( _temp300, sizeof( void*),
1u));}}));{ struct Cyc_Std_String_pa_struct _temp295; _temp295.tag= Cyc_Std_String_pa;
_temp295.f1=( struct _tagged_arr) comp;{ void* _temp294[ 5u]={& _temp295,&
_temp296,& _temp297,& _temp298,& _temp299}; Cyc_Std_aprintf( _tag_arr("%s %s %s%s%s",
sizeof( unsigned char), 13u), _tag_arr( _temp294, sizeof( void*), 5u));}}}}}});
if( Cyc_v_r){({ struct Cyc_Std_String_pa_struct _temp292; _temp292.tag= Cyc_Std_String_pa;
_temp292.f1=( struct _tagged_arr) _temp290;{ void* _temp291[ 1u]={& _temp292};
Cyc_Std_fprintf( Cyc_Std_stderr, _tag_arr("%s\n", sizeof( unsigned char), 4u),
_tag_arr( _temp291, sizeof( void*), 1u));}});} if( Cyc_Std_system(( struct
_tagged_arr) _temp290) !=  0){({ void* _temp293[ 0u]={}; Cyc_Std_fprintf( Cyc_Std_stderr,
_tag_arr("Error: C compiler failed\n", sizeof( unsigned char), 26u), _tag_arr(
_temp293, sizeof( void*), 0u));}); Cyc_compile_failure= 1; Cyc_remove_cfiles();
