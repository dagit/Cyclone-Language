...
extern unsigned char Cyc_List_Nth[8];struct Cyc_Iter_Iter{void*env;int(*next)(void*
env,void*dest);};int Cyc_Iter_next(struct Cyc_Iter_Iter,void*);struct Cyc_Dict_Dict;
...
struct Cyc_Set_Set*s,void*elt);extern unsigned char Cyc_Set_Absent[11];struct Cyc_SlowDict_Dict;
extern unsigned char Cyc_SlowDict_Present[12];extern unsigned char Cyc_SlowDict_Absent[
11];struct Cyc_SlowDict_Dict*Cyc_SlowDict_empty(int(*cmp)(void*,void*));int Cyc_SlowDict_is_empty(
struct Cyc_SlowDict_Dict*d);struct Cyc_SlowDict_Dict*Cyc_SlowDict_insert(struct Cyc_SlowDict_Dict*
d,void*k,void*v);struct Cyc_Core_Opt*Cyc_SlowDict_lookup_opt(struct Cyc_SlowDict_Dict*
d,void*k);struct Cyc_SlowDict_Dict*Cyc_SlowDict_delete(struct Cyc_SlowDict_Dict*d,
...
struct Cyc_Tcenv_Genv*ge,struct _tagged_arr*v){struct _tuple5*ans=((struct _tuple5*(*)(
...
te,struct Cyc_Position_Segment*loc,struct _tuple1*q){struct _tuple1 _tmp20;void*
_tmp21;struct _tagged_arr*_tmp22;struct _tuple1*_tmp1F=q;_tmp20=*_tmp1F;_tmp21=
...
struct _tuple1*q){struct _tuple1 _tmp6B;void*_tmp6C;struct _tagged_arr*_tmp6D;struct
_tuple1*_tmp6A=q;_tmp6B=*_tmp6A;_tmp6C=_tmp6B.f1;_tmp6D=_tmp6B.f2;{void*_tmp6E=
...
_tuple1 _tmp78;void*_tmp79;struct _tagged_arr*_tmp7A;struct _tuple1*_tmp77=q;_tmp78=*
...
_tag_arr("get_fenv",sizeof(unsigned char),9));return((struct Cyc_Tcenv_Fenv*(*)(
...
sizeof(unsigned char),9));return({struct Cyc_Tcenv_Tenv*_tmpA2=_cycalloc(sizeof(*
_tmpA2));_tmpA2->ns=te->ns;_tmpA2->ae=te->ae;_tmpA2->le=({struct Cyc_Core_Opt*
...
sizeof(unsigned char),32));{struct Cyc_Tcenv_Fenv*_tmpA8=Cyc_Tcenv_copy_fenv_old_ctrl(
Cyc_Tcenv_get_fenv(te));Cyc_Tcutil_add_tvar_identities(tvs);{struct Cyc_List_List*
_tmpA9=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))
Cyc_List_append)(tvs,_tmpA8->type_vars);Cyc_Tcutil_check_unique_tvars(loc,_tmpA9);
_tmpA8->type_vars=_tmpA9;return Cyc_Tcenv_put_fenv(te,_tmpA8);}}}struct Cyc_Tcenv_Tenv*
...
_tmpAA=Cyc_Tcenv_copy_fenv_old_ctrl(Cyc_Tcenv_get_fenv(te));struct _tagged_arr*
_tmpAB=(*vd->name).f2;{void*_tmpAC=(*vd->name).f1;_LL65: if((int)_tmpAC != 0)goto
_LL67;_LL66: goto _LL64;_LL67:;_LL68:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
_tmpAD=_cycalloc(sizeof(*_tmpAD));_tmpAD[0]=({struct Cyc_Core_Impossible_struct
_tmpAE;_tmpAE.tag=Cyc_Core_Impossible;_tmpAE.f1=_tag_arr("add_local_var: called with Rel_n",
sizeof(unsigned char),33);_tmpAE;});_tmpAD;}));_LL64:;}_tmpAA->locals=((struct
Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,void*v))Cyc_Dict_insert)(
_tmpAA->locals,_tmpAB,(void*)({struct Cyc_Absyn_Local_b_struct*_tmpAF=_cycalloc(
sizeof(*_tmpAF));_tmpAF[0]=({struct Cyc_Absyn_Local_b_struct _tmpB0;_tmpB0.tag=3;
_tmpB0.f1=vd;_tmpB0;});_tmpAF;}));return Cyc_Tcenv_put_fenv(te,_tmpAA);}}struct
...
_tmpB1=Cyc_Tcenv_copy_fenv_old_ctrl(Cyc_Tcenv_get_fenv(te));struct _tagged_arr*
_tmpB2=(*vd->name).f2;_tmpB1->locals=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k,void*v))Cyc_Dict_insert)(_tmpB1->locals,_tmpB2,(void*)({
struct Cyc_Absyn_Pat_b_struct*_tmpB3=_cycalloc(sizeof(*_tmpB3));_tmpB3[0]=({
struct Cyc_Absyn_Pat_b_struct _tmpB4;_tmpB4.tag=4;_tmpB4.f1=vd;_tmpB4;});_tmpB3;}));
return Cyc_Tcenv_put_fenv(te,_tmpB1);}}void*Cyc_Tcenv_lookup_ordinary(struct Cyc_Tcenv_Tenv*
te,struct Cyc_Position_Segment*loc,struct _tuple1*q){struct _tuple1 _tmpB6;void*
_tmpB7;struct _tagged_arr*_tmpB8;struct _tuple1*_tmpB5=q;_tmpB6=*_tmpB5;_tmpB7=
_tmpB6.f1;_tmpB8=_tmpB6.f2;{void*_tmpB9=_tmpB7;struct Cyc_List_List*_tmpBA;_LL6A:
if((int)_tmpB9 != 0)goto _LL6C;_LL6B: if(te->le == 0)(int)_throw((void*)Cyc_Dict_Absent);
goto _LL6D;_LL6C: if(_tmpB9 <= (void*)1?1:*((int*)_tmpB9)!= 0)goto _LL6E;_tmpBA=((
struct Cyc_Absyn_Rel_n_struct*)_tmpB9)->f1;if(_tmpBA != 0)goto _LL6E;if(!(te->le != 
0))goto _LL6E;_LL6D: {struct Cyc_Tcenv_Fenv*_tmpBB=Cyc_Tcenv_get_fenv(te);struct
_handler_cons _tmpBC;_push_handler(& _tmpBC);{int _tmpBE=0;if(setjmp(_tmpBC.handler))
_tmpBE=1;if(!_tmpBE){{void*_tmpC1=(void*)({struct Cyc_Tcenv_VarRes_struct*_tmpBF=
_cycalloc(sizeof(*_tmpBF));_tmpBF[0]=({struct Cyc_Tcenv_VarRes_struct _tmpC0;
_tmpC0.tag=0;_tmpC0.f1=(void*)((void*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*
k))Cyc_Dict_lookup)(_tmpBB->locals,_tmpB8);_tmpC0;});_tmpBF;});_npop_handler(0);
return _tmpC1;};_pop_handler();}else{void*_tmpBD=(void*)_exn_thrown;void*_tmpC3=
_tmpBD;_LL71: if(_tmpC3 != Cyc_Dict_Absent)goto _LL73;_LL72: return Cyc_Tcenv_lookup_ordinary_global(
te,loc,q);_LL73:;_LL74:(void)_throw(_tmpC3);_LL70:;}}}_LL6E:;_LL6F: {struct
_handler_cons _tmpC4;_push_handler(& _tmpC4);{int _tmpC6=0;if(setjmp(_tmpC4.handler))
_tmpC6=1;if(!_tmpC6){{void*_tmpC7=Cyc_Tcenv_lookup_ordinary_global(te,loc,q);
_npop_handler(0);return _tmpC7;};_pop_handler();}else{void*_tmpC5=(void*)
...
_tmpCC=(void*)((Cyc_Tcenv_get_fenv(te))->ctrl_env)->continue_stmt;struct Cyc_Absyn_Stmt*
...
_tag_arr("continue not in a loop",sizeof(unsigned char),23),_tag_arr(_tmpCF,
sizeof(void*),0));});return;_LL7F: if((int)_tmpCC != 1)goto _LL81;_LL80: goto _LL82;
_LL81: if((int)_tmpCC != 2)goto _LL7A;_LL82:((int(*)(struct _tagged_arr msg))Cyc_Tcenv_env_err)(
_tag_arr("Tcenv: bad continue destination",sizeof(unsigned char),32));_LL7A:;}}
...
fe=Cyc_Tcenv_get_fenv(te);void*_tmpD0=(void*)(fe->ctrl_env)->break_stmt;struct
Cyc_Absyn_Stmt*_tmpD1;_LL84: if(_tmpD0 <= (void*)3?1:*((int*)_tmpD0)!= 0)goto _LL86;
_tmpD1=((struct Cyc_Tcenv_Stmt_j_struct*)_tmpD0)->f1;_LL85: _tmpD1->non_local_preds=({
struct Cyc_List_List*_tmpD2=_cycalloc(sizeof(*_tmpD2));_tmpD2->hd=s;_tmpD2->tl=
_tmpD1->non_local_preds;_tmpD2;});*sopt=(struct Cyc_Absyn_Stmt*)_tmpD1;return;
_LL86: if((int)_tmpD0 != 0)goto _LL88;_LL87:({void*_tmpD3[0]={};Cyc_Tcutil_terr(s->loc,
_tag_arr("break not in a loop or switch",sizeof(unsigned char),30),_tag_arr(
_tmpD3,sizeof(void*),0));});return;_LL88: if((int)_tmpD0 != 2)goto _LL8A;_LL89: if((
void*)(fe->shared)->return_typ != (void*)0)({void*_tmpD4[0]={};Cyc_Tcutil_terr(s->loc,
_tag_arr("break causes function not to return a value",sizeof(unsigned char),44),
_tag_arr(_tmpD4,sizeof(void*),0));});return;_LL8A: if((int)_tmpD0 != 1)goto _LL83;
_LL8B:({void*_tmpD5[0]={};Cyc_Tcutil_terr(s->loc,_tag_arr("break causes outer switch clause to implicitly fallthru",
sizeof(unsigned char),56),_tag_arr(_tmpD5,sizeof(void*),0));});return;_LL83:;}}
...
struct Cyc_Core_Opt*_tmpD6=((struct Cyc_Core_Opt*(*)(struct Cyc_Dict_Dict*d,struct
_tagged_arr*k))Cyc_Dict_lookup_opt)((fe->shared)->seen_labels,l);if(_tmpD6 == 0){
struct Cyc_SlowDict_Dict*_tmpD7=(fe->shared)->needed_labels;struct Cyc_Core_Opt*
_tmpD8=((struct Cyc_Core_Opt*(*)(struct Cyc_SlowDict_Dict*d,struct _tagged_arr*k))
Cyc_SlowDict_lookup_opt)(_tmpD7,l);if(_tmpD8 == 0)_tmpD8=({struct Cyc_Core_Opt*
_tmpD9=_cycalloc(sizeof(*_tmpD9));_tmpD9->v=0;_tmpD9;});(fe->shared)->needed_labels=((
...
sizeof(unsigned char),35));{struct Cyc_Tcenv_Fenv*_tmpDC=Cyc_Tcenv_get_fenv(te);
struct _tuple4*_tmpDD=(_tmpDC->ctrl_env)->fallthru_clause;if(_tmpDD != 0){(((*
_tmpDD).f1)->body)->non_local_preds=({struct Cyc_List_List*_tmpDE=_cycalloc(
sizeof(*_tmpDE));_tmpDE->hd=s;_tmpDE->tl=(((*_tmpDD).f1)->body)->non_local_preds;
_tmpDE;});*clauseopt=(struct Cyc_Absyn_Switch_clause**)({struct Cyc_Absyn_Switch_clause**
_tmpDF=_cycalloc(sizeof(*_tmpDF));_tmpDF[0]=(*_tmpDD).f1;_tmpDF;});}return _tmpDD;}}
...
sizeof(unsigned char),31));{struct Cyc_List_List*_tmpE0=0;for(0;vds != 0;vds=vds->tl){
_tmpE0=({struct Cyc_List_List*_tmpE1=_cycalloc(sizeof(*_tmpE1));_tmpE1->hd=(void*)((
void*)((struct Cyc_Absyn_Vardecl*)vds->hd)->type);_tmpE1->tl=_tmpE0;_tmpE1;});}
_tmpE0=Cyc_List_imp_rev(_tmpE0);{struct Cyc_Tcenv_Fenv*fe=Cyc_Tcenv_copy_fenv_new_ctrl(
Cyc_Tcenv_get_fenv(te));(fe->ctrl_env)->fallthru_clause=({struct _tuple4*_tmpE2=
_cycalloc(sizeof(*_tmpE2));_tmpE2->f1=clause;_tmpE2->f2=new_tvs;_tmpE2->f3=
_tmpE0;_tmpE2;});return Cyc_Tcenv_put_fenv(te,fe);}}}struct Cyc_Tcenv_Tenv*Cyc_Tcenv_clear_fallthru(
...
struct Cyc_Tcenv_Stmt_j_struct*_tmpE3=_cycalloc(sizeof(*_tmpE3));_tmpE3[0]=({
struct Cyc_Tcenv_Stmt_j_struct _tmpE4;_tmpE4.tag=0;_tmpE4.f1=continue_dest;_tmpE4;});
_tmpE3;})));(void*)((fe->ctrl_env)->break_stmt=(void*)((void*)(fe->ctrl_env)->next_stmt));(
void*)((fe->ctrl_env)->next_stmt=(void*)((void*)({struct Cyc_Tcenv_Stmt_j_struct*
_tmpE5=_cycalloc(sizeof(*_tmpE5));_tmpE5[0]=({struct Cyc_Tcenv_Stmt_j_struct
_tmpE6;_tmpE6.tag=0;_tmpE6.f1=continue_dest;_tmpE6;});_tmpE5;})));return Cyc_Tcenv_put_fenv(
...
unsigned char),28));{struct Cyc_Tcenv_Fenv*_tmpE7=Cyc_Tcenv_get_fenv(te);struct
Cyc_SlowDict_Dict*_tmpE8=(_tmpE7->shared)->needed_labels;struct Cyc_Core_Opt*
_tmpE9=((struct Cyc_Core_Opt*(*)(struct Cyc_SlowDict_Dict*d,struct _tagged_arr*k))
Cyc_SlowDict_lookup_opt)(_tmpE8,v);if(_tmpE9 != 0){(_tmpE7->shared)->needed_labels=((
struct Cyc_SlowDict_Dict*(*)(struct Cyc_SlowDict_Dict*d,struct _tagged_arr*k))Cyc_SlowDict_delete)(
_tmpE8,v);{struct Cyc_List_List*_tmpEA=(struct Cyc_List_List*)_tmpE9->v;s->non_local_preds=
...
sizeof(unsigned char),42));goto _LL8C;_LL8C:;}}}if(((int(*)(struct Cyc_Dict_Dict*d,
struct _tagged_arr*k))Cyc_Dict_member)((_tmpE7->shared)->seen_labels,v))({struct
Cyc_Std_String_pa_struct _tmpEF;_tmpEF.tag=0;_tmpEF.f1=(struct _tagged_arr)*v;{
void*_tmpEE[1]={& _tmpEF};Cyc_Tcutil_terr(s->loc,_tag_arr("Repeated label: %s",
sizeof(unsigned char),19),_tag_arr(_tmpEE,sizeof(void*),1));}});(_tmpE7->shared)->seen_labels=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,struct Cyc_Absyn_Stmt*
v))Cyc_Dict_insert)((_tmpE7->shared)->seen_labels,v,s);return te;}}int Cyc_Tcenv_all_labels_resolved(
...
_tag_arr("Tcenv::add_region: unexpected add_region",sizeof(unsigned char),41));{
struct Cyc_Tcenv_Fenv*fe=Cyc_Tcenv_copy_fenv_old_ctrl(Cyc_Tcenv_get_fenv(te));
struct Cyc_Absyn_Tvar*tv;{void*_tmpF0=Cyc_Tcutil_compress(r);struct Cyc_Absyn_Tvar*
_tmpF1;_LL92: if(_tmpF0 <= (void*)3?1:*((int*)_tmpF0)!= 1)goto _LL94;_tmpF1=((
struct Cyc_Absyn_VarType_struct*)_tmpF0)->f1;_LL93: tv=_tmpF1;goto _LL91;_LL94:;
_LL95: tv=((struct Cyc_Absyn_Tvar*(*)(struct _tagged_arr msg))Cyc_Tcenv_env_err)(
_tag_arr("bad add region",sizeof(unsigned char),15));goto _LL91;_LL91:;}fe->region_order=
Cyc_RgnOrder_add_youngest(fe->region_order,tv,resetable);(void*)(fe->capability=(
void*)((void*)({struct Cyc_Absyn_JoinEff_struct*_tmpF2=_cycalloc(sizeof(*_tmpF2));
_tmpF2[0]=({struct Cyc_Absyn_JoinEff_struct _tmpF3;_tmpF3.tag=20;_tmpF3.f1=({
struct Cyc_List_List*_tmpF4=_cycalloc(sizeof(*_tmpF4));_tmpF4->hd=(void*)((void*)({
struct Cyc_Absyn_AccessEff_struct*_tmpF6=_cycalloc(sizeof(*_tmpF6));_tmpF6[0]=({
struct Cyc_Absyn_AccessEff_struct _tmpF7;_tmpF7.tag=19;_tmpF7.f1=(void*)r;_tmpF7;});
_tmpF6;}));_tmpF4->tl=({struct Cyc_List_List*_tmpF5=_cycalloc(sizeof(*_tmpF5));
_tmpF5->hd=(void*)((void*)fe->capability);_tmpF5->tl=0;_tmpF5;});_tmpF4;});
_tmpF3;});_tmpF2;})));return Cyc_Tcenv_put_fenv(te,fe);}}struct Cyc_Tcenv_Tenv*Cyc_Tcenv_new_named_block(
...
struct Cyc_Absyn_VarType_struct*_tmpFF=_cycalloc(sizeof(*_tmpFF));_tmpFF[0]=({
struct Cyc_Absyn_VarType_struct _tmp100;_tmp100.tag=1;_tmp100.f1=block_rgn;_tmp100;});
_tmpFF;});fe->type_vars=({struct Cyc_List_List*_tmpF8=_cycalloc(sizeof(*_tmpF8));
_tmpF8->hd=block_rgn;_tmpF8->tl=fe->type_vars;_tmpF8;});Cyc_Tcutil_check_unique_tvars(
...
sizeof(unsigned char),43));{struct Cyc_Tcenv_Fenv*fe=Cyc_Tcenv_copy_fenv_old_ctrl(
Cyc_Tcenv_get_fenv(te));struct Cyc_RgnOrder_RgnPO*_tmp103=fe->region_order;for(0;
cs != 0;cs=cs->tl){_tmp103=Cyc_RgnOrder_add_outlives_constraint(_tmp103,(*((
struct _tuple0*)cs->hd)).f1,(*((struct _tuple0*)cs->hd)).f2);}fe->region_order=
_tmp103;return Cyc_Tcenv_put_fenv(te,fe);}}void*Cyc_Tcenv_curr_rgn(struct Cyc_Tcenv_Tenv*
...
_tag_arr("Tcenv: unexpected check_rgn_accessible",sizeof(unsigned char),39));{
struct Cyc_Tcenv_Fenv*_tmp104=Cyc_Tcenv_get_fenv(te);void*_tmp105=(void*)_tmp104->capability;
if(Cyc_Tcutil_region_in_effect(0,rgn,_tmp105)?1: Cyc_Tcutil_region_in_effect(1,
rgn,_tmp105))return;if(Cyc_RgnOrder_eff_outlives_eff(_tmp104->region_order,(void*)({
struct Cyc_Absyn_AccessEff_struct*_tmp106=_cycalloc(sizeof(*_tmp106));_tmp106[0]=({
struct Cyc_Absyn_AccessEff_struct _tmp107;_tmp107.tag=19;_tmp107.f1=(void*)rgn;
_tmp107;});_tmp106;}),_tmp105))return;({struct Cyc_Std_String_pa_struct _tmp109;
_tmp109.tag=0;_tmp109.f1=(struct _tagged_arr)Cyc_Absynpp_typ2string(rgn);{void*
_tmp108[1]={& _tmp109};Cyc_Tcutil_terr(loc,_tag_arr("Expression accesses unavailable region %s",
sizeof(unsigned char),42),_tag_arr(_tmp108,sizeof(void*),1));}});}}void Cyc_Tcenv_check_rgn_resetable(
...
sizeof(unsigned char),38));Cyc_Tcenv_check_rgn_accessible(te,loc,rgn);{void*
_tmp10A=Cyc_Tcutil_compress(rgn);struct Cyc_Absyn_Tvar*_tmp10B;_LL97: if(_tmp10A <= (
void*)3?1:*((int*)_tmp10A)!= 1)goto _LL99;_tmp10B=((struct Cyc_Absyn_VarType_struct*)
_tmp10A)->f1;_LL98: if(!Cyc_RgnOrder_is_region_resetable((Cyc_Tcenv_get_fenv(te))->region_order,
_tmp10B))({struct Cyc_Std_String_pa_struct _tmp10D;_tmp10D.tag=0;_tmp10D.f1=(
struct _tagged_arr)Cyc_Absynpp_typ2string(rgn);{void*_tmp10C[1]={& _tmp10D};Cyc_Tcutil_terr(
loc,_tag_arr("Region %s is not resetable",sizeof(unsigned char),27),_tag_arr(
_tmp10C,sizeof(void*),1));}});return;_LL99:;_LL9A:({void*_tmp10E[0]={};((int(*)(
struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(_tag_arr("check_rgn_resetable",
sizeof(unsigned char),20),_tag_arr(_tmp10E,sizeof(void*),0));});_LL96:;}}int Cyc_Tcenv_region_outlives(
...
sizeof(unsigned char),42));{struct Cyc_Tcenv_Fenv*_tmp111=Cyc_Tcenv_get_fenv(te);
void*_tmp112=(void*)_tmp111->capability;if(Cyc_Tcutil_subset_effect(0,eff,
_tmp112))return;if(Cyc_RgnOrder_eff_outlives_eff(_tmp111->region_order,eff,
_tmp112))return;(_tmp111->shared)->delayed_effect_checks=({struct Cyc_List_List*
_tmp113=_cycalloc(sizeof(*_tmp113));_tmp113->hd=({struct _tuple6*_tmp114=
_cycalloc(sizeof(*_tmp114));_tmp114->f1=_tmp112;_tmp114->f2=eff;_tmp114->f3=
_tmp111->region_order;_tmp114->f4=loc;_tmp114;});_tmp113->tl=(_tmp111->shared)->delayed_effect_checks;
...
sizeof(unsigned char),40));{struct Cyc_List_List*_tmp115=((Cyc_Tcenv_get_fenv(te))->shared)->delayed_effect_checks;
...
sizeof(unsigned char),51),_tag_arr(_tmp11C,sizeof(void*),2));}}});}}}struct
_tuple7{struct Cyc_RgnOrder_RgnPO*f1;struct Cyc_List_List*f2;struct Cyc_Position_Segment*
...
sizeof(unsigned char),51),_tag_arr(_tmp11F,sizeof(void*),0));});}return;}{struct
Cyc_Tcenv_Fenv*_tmp120=Cyc_Tcenv_get_fenv(te);if(!Cyc_RgnOrder_satisfies_constraints(
_tmp120->region_order,po,(void*)2,0))(_tmp120->shared)->delayed_constraint_checks=({
struct Cyc_List_List*_tmp121=_cycalloc(sizeof(*_tmp121));_tmp121->hd=({struct
_tuple7*_tmp122=_cycalloc(sizeof(*_tmp122));_tmp122->f1=_tmp120->region_order;
_tmp122->f2=po;_tmp122->f3=loc;_tmp122;});_tmp121->tl=(_tmp120->shared)->delayed_constraint_checks;
...
sizeof(unsigned char),44));{struct Cyc_List_List*_tmp123=((Cyc_Tcenv_get_fenv(te))->shared)->delayed_constraint_checks;
...
_tag_arr("the required region ordering is not satisfied here",sizeof(
unsigned char),51),_tag_arr(_tmp129,sizeof(void*),0));});}}}struct _tuple8{struct
...
_tmp154=_cycalloc(sizeof(*_tmp154));_tmp154->name=({struct _tagged_arr*_tmp157=
_cycalloc(sizeof(*_tmp157));_tmp157[0]=(struct _tagged_arr)({struct Cyc_Std_String_pa_struct
_tmp159;_tmp159.tag=0;_tmp159.f1=(struct _tagged_arr)*(*fd->name).f2;{void*
_tmp158[1]={& _tmp159};Cyc_Std_aprintf(_tag_arr("`%s",sizeof(unsigned char),4),
_tag_arr(_tmp158,sizeof(void*),1));}});_tmp157;});_tmp154->identity=Cyc_Tcutil_new_tvar_id();
...
_tmp147;_tmp147.v=_tmp12C;_tmp147;});_tmp146;});return({struct Cyc_Tcenv_Fenv*
_tmp148=_cycalloc(sizeof(*_tmp148));_tmp148->shared=({struct Cyc_Tcenv_SharedFenv*
_tmp150=_cycalloc(sizeof(*_tmp150));_tmp150->return_typ=(void*)((void*)fd->ret_type);
_tmp150->seen_labels=((struct Cyc_Dict_Dict*(*)(int(*cmp)(struct _tagged_arr*,
struct _tagged_arr*)))Cyc_Dict_empty)(Cyc_Std_zstrptrcmp);_tmp150->needed_labels=((
struct Cyc_SlowDict_Dict*(*)(int(*cmp)(struct _tagged_arr*,struct _tagged_arr*)))
Cyc_SlowDict_empty)(Cyc_Std_zstrptrcmp);_tmp150->delayed_effect_checks=0;_tmp150->delayed_constraint_checks=
0;_tmp150;});_tmp148->type_vars=_tmp12A;_tmp148->region_order=_tmp12B;_tmp148->locals=
locals;_tmp148->encloser=fd->body;_tmp148->ctrl_env=({struct Cyc_Tcenv_CtrlEnv*
_tmp14F=_cycalloc(sizeof(*_tmp14F));_tmp14F->continue_stmt=(void*)((void*)0);
_tmp14F->break_stmt=(void*)((void*)0);_tmp14F->fallthru_clause=0;_tmp14F->next_stmt=(
void*)((void*)2);_tmp14F->try_depth=0;_tmp14F;});_tmp148->capability=(void*)((
void*)({struct Cyc_Absyn_JoinEff_struct*_tmp149=_cycalloc(sizeof(*_tmp149));
_tmp149[0]=({struct Cyc_Absyn_JoinEff_struct _tmp14A;_tmp14A.tag=20;_tmp14A.f1=({
struct Cyc_List_List*_tmp14B=_cycalloc(sizeof(*_tmp14B));_tmp14B->hd=(void*)((
void*)({struct Cyc_Absyn_AccessEff_struct*_tmp14D=_cycalloc(sizeof(*_tmp14D));
_tmp14D[0]=({struct Cyc_Absyn_AccessEff_struct _tmp14E;_tmp14E.tag=19;_tmp14E.f1=(
void*)param_rgn;_tmp14E;});_tmp14D;}));_tmp14B->tl=({struct Cyc_List_List*_tmp14C=
_cycalloc(sizeof(*_tmp14C));_tmp14C->hd=(void*)((void*)((struct Cyc_Core_Opt*)
_check_null(fd->effect))->v);_tmp14C->tl=0;_tmp14C;});_tmp14B;});_tmp14A;});
_tmp149;}));_tmp148->curr_rgn=(void*)param_rgn;_tmp148;});}}
