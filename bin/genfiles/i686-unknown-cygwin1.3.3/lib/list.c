...
struct _tagged_arr);struct Cyc_List_List*Cyc_List_rlist(struct _RegionHandle*,
struct _tagged_arr);int Cyc_List_length(struct Cyc_List_List*x);void*Cyc_List_hd(
...
extern unsigned char Cyc_List_List_mismatch[18];struct Cyc_List_List*Cyc_List_map2(
void*(*f)(void*,void*),struct Cyc_List_List*x,struct Cyc_List_List*y);struct Cyc_List_List*
Cyc_List_rmap2(struct _RegionHandle*,void*(*f)(void*,void*),struct Cyc_List_List*x,
struct Cyc_List_List*y);void Cyc_List_app(void*(*f)(void*),struct Cyc_List_List*x);
void Cyc_List_app_c(void*(*f)(void*,void*),void*,struct Cyc_List_List*x);void Cyc_List_app2(
void*(*f)(void*,void*),struct Cyc_List_List*x,struct Cyc_List_List*y);void Cyc_List_app2_c(
void*(*f)(void*,void*,void*),void*env,struct Cyc_List_List*x,struct Cyc_List_List*
y);void Cyc_List_iter(void(*f)(void*),struct Cyc_List_List*x);void Cyc_List_iter_c(
void(*f)(void*,void*),void*env,struct Cyc_List_List*x);void Cyc_List_iter2(void(*f)(
void*,void*),struct Cyc_List_List*x,struct Cyc_List_List*y);void Cyc_List_iter2_c(
...
void*Cyc_List_fold_left_c(void*(*f)(void*,void*,void*),void*,void*accum,struct
Cyc_List_List*x);void*Cyc_List_fold_right(void*(*f)(void*,void*),struct Cyc_List_List*
x,void*accum);void*Cyc_List_fold_right_c(void*(*f)(void*,void*,void*),void*,
struct Cyc_List_List*x,void*accum);struct Cyc_List_List*Cyc_List_revappend(struct
...
Cyc_List_rev(struct Cyc_List_List*x);struct Cyc_List_List*Cyc_List_rrev(struct
...
void*),struct Cyc_List_List*x);struct Cyc_List_List*Cyc_List_rmerge_sort(struct
_RegionHandle*,int(*cmp)(void*,void*),struct Cyc_List_List*x);struct Cyc_List_List*
...
unsigned char Cyc_List_Nth[8];void*Cyc_List_nth(struct Cyc_List_List*x,int n);
struct Cyc_List_List*Cyc_List_nth_tail(struct Cyc_List_List*x,int i);int Cyc_List_forall(
...
Cyc_List_List*x);struct _tagged_arr Cyc_List_to_array(struct Cyc_List_List*x);
struct _tagged_arr Cyc_List_rto_array(struct _RegionHandle*r,struct Cyc_List_List*x);
struct Cyc_List_List*Cyc_List_from_array(struct _tagged_arr arr);struct Cyc_List_List*
Cyc_List_rfrom_array(struct _RegionHandle*r2,struct _tagged_arr arr);struct Cyc_List_List*
...
c=({struct Cyc_List_List*_tmp11=_region_malloc(r3,sizeof(*_tmp11));_tmp11->hd=(
...
_throw((void*)Cyc_List_List_mismatch);result=({struct Cyc_List_List*_tmp15=
...
result=({struct Cyc_List_List*_tmp19=_region_malloc(r3,sizeof(*_tmp19));_tmp19->hd=({
struct _tuple3*_tmp1A=_region_malloc(r4,sizeof(*_tmp1A));_tmp1A->f1=(void*)x->hd;
_tmp1A->f2=(void*)y->hd;_tmp1A->f3=(void*)z->hd;_tmp1A;});_tmp19->tl=0;_tmp19;});
prev=result;x=x->tl;y=y->tl;z=z->tl;while((x != 0?y != 0: 0)?z != 0: 0){((struct Cyc_List_List*)
_check_null(prev))->tl=({struct Cyc_List_List*_tmp1B=_region_malloc(r3,sizeof(*
_tmp1B));_tmp1B->hd=({struct _tuple3*_tmp1C=_region_malloc(r4,sizeof(*_tmp1C));
_tmp1C->f1=(void*)x->hd;_tmp1C->f2=(void*)y->hd;_tmp1C->f3=(void*)z->hd;_tmp1C;});
_tmp1B->tl=0;_tmp1B;});prev=((struct Cyc_List_List*)_check_null(prev))->tl;x=x->tl;
...
_tmp1E=_region_malloc(r3,sizeof(*_tmp1E));_tmp1E->hd=(void*)(((struct _tuple2*)x->hd)[
_check_known_subscript_notnull(1,0)]).f1;_tmp1E->tl=0;_tmp1E;}));prev2=(result2=({
struct Cyc_List_List*_tmp1F=_region_malloc(r4,sizeof(*_tmp1F));_tmp1F->hd=(void*)(((
struct _tuple2*)x->hd)[_check_known_subscript_notnull(1,0)]).f2;_tmp1F->tl=0;
_tmp1F;}));for(x=x->tl;x != 0;x=x->tl){((struct Cyc_List_List*)_check_null(prev1))->tl=({
struct Cyc_List_List*_tmp20=_region_malloc(r3,sizeof(*_tmp20));_tmp20->hd=(void*)(((
...
_tmp21=_region_malloc(r4,sizeof(*_tmp21));_tmp21->hd=(void*)(((struct _tuple2*)x->hd)[
...
_tuple2*)l->hd)[_check_known_subscript_notnull(1,0)]).f1,x)== 0)return(((struct
_tuple2*)l->hd)[_check_known_subscript_notnull(1,0)]).f2;l=l->tl;}(int)_throw((
void*)Cyc_Core_Not_found);}struct Cyc_List_List*Cyc_List_delete(struct Cyc_List_List*
l,void*x){struct Cyc_List_List*_tmp2B=l;struct Cyc_List_List*_tmp2C=l;while(_tmp2C
!= 0){if((void*)_tmp2C->hd == x){if(_tmp2B == l)return((struct Cyc_List_List*)
_check_null(l))->tl;else{((struct Cyc_List_List*)_check_null(_tmp2B))->tl=_tmp2C->tl;
return l;}}_tmp2B=_tmp2C;_tmp2C=_tmp2C->tl;}(int)_throw((void*)Cyc_Core_Not_found);}
...
Cyc_List_List*)_check_null(x->tl))->hd)== 0)return({struct Cyc_Core_Opt*_tmp2D=
_cycalloc(sizeof(*_tmp2D));_tmp2D->v=(void*)((void*)x->hd);_tmp2D;});}x=x->tl;}
...
l2->hd);if(_tmp36 != 0)return _tmp36;}}if(l1 != 0)return 1;if(l2 != 0)return - 1;return
0;}int Cyc_List_list_prefix(int(*cmp)(void*,void*),struct Cyc_List_List*l1,struct
Cyc_List_List*l2){for(0;l1 != 0?l2 != 0: 0;(l1=l1->tl,l2=l2->tl)){if((unsigned int)
l1 == (unsigned int)l2)return 1;{int _tmp37=cmp((void*)l1->hd,(void*)l2->hd);if(
_tmp37 != 0)return 0;}}return l1 == 0;}struct Cyc_List_List*Cyc_List_rfilter_c(struct
_RegionHandle*r2,int(*f)(void*,void*),void*env,struct Cyc_List_List*l){if(l == 0)
return 0;{struct Cyc_List_List*result=({struct Cyc_List_List*_tmp39=_region_malloc(
r2,sizeof(*_tmp39));_tmp39->hd=(void*)((void*)l->hd);_tmp39->tl=0;_tmp39;});
struct Cyc_List_List*end=result;for(0;l != 0;l=l->tl){if(f(env,(void*)l->hd)){((
