...
Cyc_List_List* l, void* k); extern int Cyc_List_mem_assoc( struct Cyc_List_List*
...
++ i; x=(( struct Cyc_List_List*) _check_null( x))->tl;} return i;} void* Cyc_List_hd(
struct Cyc_List_List* x){ if( x ==  0){( int) _throw(( void*)({ struct Cyc_Core_Failure_struct*
...
Cyc_List_tl( struct Cyc_List_List* x){ if( x ==  0){( int) _throw(( void*)({
...
_temp3; _temp3.tag= Cyc_Core_Failure; _temp3.f1= _tag_arr("tl", sizeof(
unsigned char), 3u); _temp3;}); _temp2;}));} return(( struct Cyc_List_List*)
_check_null( x))->tl;} struct Cyc_List_List* Cyc_List_rlist( struct
_RegionHandle* r, struct _tagged_arr argv){ struct Cyc_List_List* result= 0;{
int i=( int)( _get_arr_size( argv, sizeof( void*)) -  1); for( 0; i >=  0; i --){
result=({ struct Cyc_List_List* _temp4=( struct Cyc_List_List*) _region_malloc(
r, sizeof( struct Cyc_List_List)); _temp4->hd=( void*)*(( void**)
_check_unknown_subscript( argv, sizeof( void*), i)); _temp4->tl= result; _temp4;});}}
...
void*)) -  1); for( 0; i >=  0; i --){ result=({ struct Cyc_List_List* _temp5=(
struct Cyc_List_List*) _cycalloc( sizeof( struct Cyc_List_List)); _temp5->hd=(
void*)*(( void**) _check_unknown_subscript( argv, sizeof( void*), i)); _temp5->tl=
result; _temp5;});}} return result;} struct Cyc_List_List* Cyc_List_rcopy(
...
_temp6=( struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp6->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( x))->hd);
_temp6->tl= 0; _temp6;}); prev= result; for( x=(( struct Cyc_List_List*)
_check_null( x))->tl; x !=  0; x=(( struct Cyc_List_List*) _check_null( x))->tl){((
struct Cyc_List_List*) _check_null( prev))->tl=({ struct Cyc_List_List* _temp7=(
struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp7->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( x))->hd);
_temp7->tl= 0; _temp7;}); prev=(( struct Cyc_List_List*) _check_null( prev))->tl;}
...
r2, sizeof( struct Cyc_List_List)); _temp8->hd=( void*) f(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd); _temp8->tl= 0; _temp8;}); prev= result; for( x=(( struct
Cyc_List_List*) _check_null( x))->tl; x !=  0; x=(( struct Cyc_List_List*)
_check_null( x))->tl){ struct Cyc_List_List* temp=({ struct Cyc_List_List*
_temp9=( struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp9->hd=( void*) f(( void*)(( struct Cyc_List_List*) _check_null( x))->hd);
_temp9->tl= 0; _temp9;});(( struct Cyc_List_List*) _check_null( prev))->tl= temp;
prev= temp;} return result;} struct Cyc_List_List* Cyc_List_map( void*(* f)(
void*), struct Cyc_List_List* x){ return Cyc_List_rmap( Cyc_Core_heap_region, f,
x);} struct Cyc_List_List* Cyc_List_rmap_c( struct _RegionHandle* r2, void*(* f)(
void*, void*), void* env, struct Cyc_List_List* x){ struct Cyc_List_List* result;
struct Cyc_List_List* prev; if( x ==  0){ return 0;} result=({ struct Cyc_List_List*
_temp10=( struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp10->hd=( void*) f( env,( void*)(( struct Cyc_List_List*) _check_null( x))->hd);
_temp10->tl= 0; _temp10;}); prev= result; for( x=(( struct Cyc_List_List*)
_check_null( x))->tl; x !=  0; x=(( struct Cyc_List_List*) _check_null( x))->tl){((
struct Cyc_List_List*) _check_null( prev))->tl=({ struct Cyc_List_List* _temp11=(
struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp11->hd=( void*) f( env,( void*)(( struct Cyc_List_List*) _check_null( x))->hd);
_temp11->tl= 0; _temp11;}); prev=(( struct Cyc_List_List*) _check_null( prev))->tl;}
return result;} struct Cyc_List_List* Cyc_List_map_c( void*(* f)( void*, void*),
void* env, struct Cyc_List_List* x){ return Cyc_List_rmap_c( Cyc_Core_heap_region,
f, env, x);} unsigned char Cyc_List_List_mismatch[ 18u]="\000\000\000\000List_mismatch";
...
==  0? 1: y ==  0){( int) _throw(( void*) Cyc_List_List_mismatch);} result=({
struct Cyc_List_List* _temp12=( struct Cyc_List_List*) _region_malloc( r3,
sizeof( struct Cyc_List_List)); _temp12->hd=( void*) f(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd,( void*)(( struct Cyc_List_List*) _check_null( y))->hd);
_temp12->tl= 0; _temp12;}); prev= result; x=(( struct Cyc_List_List*)
_check_null( x))->tl; y=(( struct Cyc_List_List*) _check_null( y))->tl; while( x
!=  0? y !=  0: 0) {(( struct Cyc_List_List*) _check_null( prev))->tl=({ struct
Cyc_List_List* _temp13=( struct Cyc_List_List*) _region_malloc( r3, sizeof(
struct Cyc_List_List)); _temp13->hd=( void*) f(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd,( void*)(( struct Cyc_List_List*) _check_null( y))->hd);
_temp13->tl= 0; _temp13;}); prev=(( struct Cyc_List_List*) _check_null( prev))->tl;
...
return result;} struct Cyc_List_List* Cyc_List_map2( void*(* f)( void*, void*),
struct Cyc_List_List* x, struct Cyc_List_List* y){ return Cyc_List_rmap2( Cyc_Core_heap_region,
f, x, y);} void Cyc_List_app( void*(* f)( void*), struct Cyc_List_List* x){
while( x !=  0) { f(( void*)(( struct Cyc_List_List*) _check_null( x))->hd); x=((
struct Cyc_List_List*) _check_null( x))->tl;}} void Cyc_List_app_c( void*(* f)(
...
_check_null( x))->tl;}} void Cyc_List_iter( void(* f)( void*), struct Cyc_List_List*
x){ while( x !=  0) { f(( void*)(( struct Cyc_List_List*) _check_null( x))->hd);
x=(( struct Cyc_List_List*) _check_null( x))->tl;}} void Cyc_List_iter_c( void(*
f)( void*, void*), void* env, struct Cyc_List_List* x){ while( x !=  0) { f( env,(
void*)(( struct Cyc_List_List*) _check_null( x))->hd); x=(( struct Cyc_List_List*)
_check_null( x))->tl;}} void Cyc_List_app2( void*(* f)( void*, void*), struct
Cyc_List_List* x, struct Cyc_List_List* y){ while( x !=  0? y !=  0: 0) { f((
void*)(( struct Cyc_List_List*) _check_null( x))->hd,( void*)(( struct Cyc_List_List*)
_check_null( y))->hd); x=(( struct Cyc_List_List*) _check_null( x))->tl; y=((
struct Cyc_List_List*) _check_null( y))->tl;} if( x !=  0? 1: y !=  0){( int)
_throw(( void*) Cyc_List_List_mismatch);}} void Cyc_List_app2_c( void*(* f)(
...
Cyc_List_fold_right( f,(( struct Cyc_List_List*) _check_null( x))->tl, accum));}}
...
void*)(( struct Cyc_List_List*) _check_null( x))->hd, Cyc_List_fold_right_c( f,
env,(( struct Cyc_List_List*) _check_null( x))->tl, accum));}} struct Cyc_List_List*
Cyc_List_rrevappend( struct _RegionHandle* r2, struct Cyc_List_List* x, struct
Cyc_List_List* y){ while( x !=  0) { y=({ struct Cyc_List_List* _temp14=( struct
Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List)); _temp14->hd=(
void*)(( void*)(( struct Cyc_List_List*) _check_null( x))->hd); _temp14->tl= y;
_temp14;}); x=(( struct Cyc_List_List*) _check_null( x))->tl;} return y;} struct
Cyc_List_List* Cyc_List_revappend( struct Cyc_List_List* x, struct Cyc_List_List*
y){ return Cyc_List_rrevappend( Cyc_Core_heap_region, x, y);} struct Cyc_List_List*
Cyc_List_rrev( struct _RegionHandle* r2, struct Cyc_List_List* x){ if( x ==  0){
return 0;} return Cyc_List_rrevappend( r2, x, 0);} struct Cyc_List_List* Cyc_List_rev(
...
return x;} else{ struct Cyc_List_List* first= x; struct Cyc_List_List* second=((
struct Cyc_List_List*) _check_null( x))->tl;(( struct Cyc_List_List*)
_check_null( x))->tl= 0; while( second !=  0) { struct Cyc_List_List* temp=((
struct Cyc_List_List*) _check_null( second))->tl;(( struct Cyc_List_List*)
...
prev; if( x ==  0){ return y;} if( y ==  0){ return Cyc_List_rcopy( r2, x);}
result=({ struct Cyc_List_List* _temp15=( struct Cyc_List_List*) _region_malloc(
r2, sizeof( struct Cyc_List_List)); _temp15->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd); _temp15->tl= 0; _temp15;}); prev= result; for( x=((
...
sizeof( struct Cyc_List_List)); _temp16->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd); _temp16->tl= 0; _temp16;}); prev=(( struct Cyc_List_List*)
...
struct Cyc_List_List* y){ return Cyc_List_rappend( Cyc_Core_heap_region, x, y);}
struct Cyc_List_List* Cyc_List_imp_append( struct Cyc_List_List* x, struct Cyc_List_List*
y){ struct Cyc_List_List* z; if( x ==  0){ return y;} if( y ==  0){ return x;}
for( z= x;(( struct Cyc_List_List*) _check_null( z))->tl !=  0; z=(( struct Cyc_List_List*)
_check_null( z))->tl){;}(( struct Cyc_List_List*) _check_null( z))->tl= y;
return x;} struct Cyc_List_List* Cyc_List_rflatten( struct _RegionHandle* r3,
...
a ==  0){ return b;} if( b ==  0){ return a;} if( less_eq(( void*)(( struct Cyc_List_List*)
_check_null( a))->hd,( void*)(( struct Cyc_List_List*) _check_null( b))->hd) <= 
0){ c= a; a=(( struct Cyc_List_List*) _check_null( a))->tl;} else{ c= b; b=((
struct Cyc_List_List*) _check_null( b))->tl;} d= c; while( a !=  0? b !=  0: 0) {
if( less_eq(( void*)(( struct Cyc_List_List*) _check_null( a))->hd,( void*)((
struct Cyc_List_List*) _check_null( b))->hd) <=  0){(( struct Cyc_List_List*)
...
struct _RegionHandle* r2, int(* less_eq)( void*, void*), struct Cyc_List_List* x){
return Cyc_List_rimp_merge_sort( less_eq, Cyc_List_rcopy( r2, x));} struct Cyc_List_List*
Cyc_List_rmerge( struct _RegionHandle* r3, int(* less_eq)( void*, void*), struct
Cyc_List_List* a, struct Cyc_List_List* b){ struct Cyc_List_List* c; struct Cyc_List_List*
d; if( a ==  0){ return Cyc_List_rcopy( r3, b);} if( b ==  0){ return Cyc_List_rcopy(
r3, a);} if( less_eq(( void*)(( struct Cyc_List_List*) _check_null( a))->hd,(
void*)(( struct Cyc_List_List*) _check_null( b))->hd) <=  0){ c=({ struct Cyc_List_List*
_temp17=( struct Cyc_List_List*) _region_malloc( r3, sizeof( struct Cyc_List_List));
_temp17->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( a))->hd);
_temp17->tl= 0; _temp17;}); a=(( struct Cyc_List_List*) _check_null( a))->tl;}
else{ c=({ struct Cyc_List_List* _temp18=( struct Cyc_List_List*) _region_malloc(
r3, sizeof( struct Cyc_List_List)); _temp18->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( b))->hd); _temp18->tl= 0; _temp18;}); b=(( struct Cyc_List_List*)
...
struct Cyc_List_List* _temp19=( struct Cyc_List_List*) _region_malloc( r3,
sizeof( struct Cyc_List_List)); _temp19->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( a))->hd); _temp19->tl= 0; _temp19;}); c=(( struct Cyc_List_List*)
_check_null( c))->tl; a=(( struct Cyc_List_List*) _check_null( a))->tl;} else{((
struct Cyc_List_List*) _check_null( c))->tl=({ struct Cyc_List_List* _temp20=(
struct Cyc_List_List*) _region_malloc( r3, sizeof( struct Cyc_List_List));
_temp20->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( b))->hd);
_temp20->tl= 0; _temp20;}); c=(( struct Cyc_List_List*) _check_null( c))->tl; b=((
struct Cyc_List_List*) _check_null( b))->tl;}} if( a ==  0){(( struct Cyc_List_List*)
_check_null( c))->tl= Cyc_List_rcopy( r3, b);} else{(( struct Cyc_List_List*)
_check_null( c))->tl= Cyc_List_rcopy( r3, a);} return d;} struct Cyc_List_List*
Cyc_List_merge_sort( int(* less_eq)( void*, void*), struct Cyc_List_List* x){
return Cyc_List_rmerge_sort( Cyc_Core_heap_region, less_eq, x);} struct Cyc_List_List*
...
int) _throw(( void*) Cyc_List_Nth);} x=(( struct Cyc_List_List*) _check_null( x))->tl;
...
result; struct Cyc_List_List* prev; if( x ==  0? y ==  0: 0){ return 0;} if( x
==  0? 1: y ==  0){( int) _throw(( void*) Cyc_List_List_mismatch);} result=({
struct Cyc_List_List* _temp21=( struct Cyc_List_List*) _region_malloc( r3,
sizeof( struct Cyc_List_List)); _temp21->hd=( void*)({ struct _tuple2* _temp22=(
struct _tuple2*) _region_malloc( r4, sizeof( struct _tuple2)); _temp22->f1=(
void*)(( struct Cyc_List_List*) _check_null( x))->hd; _temp22->f2=( void*)((
struct Cyc_List_List*) _check_null( y))->hd; _temp22;}); _temp21->tl= 0; _temp21;});
prev= result; x=(( struct Cyc_List_List*) _check_null( x))->tl; y=(( struct Cyc_List_List*)
_check_null( y))->tl; while( x !=  0? y !=  0: 0) {(( struct Cyc_List_List*)
_check_null( prev))->tl=({ struct Cyc_List_List* _temp23=( struct Cyc_List_List*)
_region_malloc( r3, sizeof( struct Cyc_List_List)); _temp23->hd=( void*)({
struct _tuple2* _temp24=( struct _tuple2*) _region_malloc( r4, sizeof( struct
_tuple2)); _temp24->f1=( void*)(( struct Cyc_List_List*) _check_null( x))->hd;
_temp24->f2=( void*)(( struct Cyc_List_List*) _check_null( y))->hd; _temp24;});
_temp23->tl= 0; _temp23;}); prev=(( struct Cyc_List_List*) _check_null( prev))->tl;
x=(( struct Cyc_List_List*) _check_null( x))->tl; y=(( struct Cyc_List_List*)
_check_null( y))->tl;} if( x !=  0? 1: y !=  0){( int) _throw(( void*) Cyc_List_List_mismatch);}
...
prev2; if( x ==  0){ return({ struct _tuple0 _temp25; _temp25.f1= 0; _temp25.f2=
0; _temp25;});} prev1=( result1=({ struct Cyc_List_List* _temp26=( struct Cyc_List_List*)
_region_malloc( r3, sizeof( struct Cyc_List_List)); _temp26->hd=( void*)(((
struct _tuple2*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f1; _temp26->tl= 0; _temp26;})); prev2=(
result2=({ struct Cyc_List_List* _temp27=( struct Cyc_List_List*) _region_malloc(
r4, sizeof( struct Cyc_List_List)); _temp27->hd=( void*)((( struct _tuple2*)((
struct Cyc_List_List*) _check_null( x))->hd)[ _check_known_subscript_notnull( 1u,
0)]).f2; _temp27->tl= 0; _temp27;})); for( x=(( struct Cyc_List_List*)
_check_null( x))->tl; x !=  0; x=(( struct Cyc_List_List*) _check_null( x))->tl){((
struct Cyc_List_List*) _check_null( prev1))->tl=({ struct Cyc_List_List* _temp28=(
struct Cyc_List_List*) _region_malloc( r3, sizeof( struct Cyc_List_List));
_temp28->hd=( void*)((( struct _tuple2*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f1; _temp28->tl= 0; _temp28;});((
struct Cyc_List_List*) _check_null( prev2))->tl=({ struct Cyc_List_List* _temp29=(
struct Cyc_List_List*) _region_malloc( r4, sizeof( struct Cyc_List_List));
_temp29->hd=( void*)((( struct _tuple2*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f2; _temp29->tl= 0; _temp29;}); prev1=((
struct Cyc_List_List*) _check_null( prev1))->tl; prev2=(( struct Cyc_List_List*)
_check_null( prev2))->tl;} return({ struct _tuple0 _temp30; _temp30.f1= result1;
_temp30.f2= result2; _temp30;});} struct _tuple0 Cyc_List_split( struct Cyc_List_List*
x){ return Cyc_List_rsplit( Cyc_Core_heap_region, Cyc_Core_heap_region, x);}
struct _tuple3{ void* f1; void* f2; void* f3; } ; struct _tuple1 Cyc_List_rsplit3(
...
_temp31; _temp31.f1= 0; _temp31.f2= 0; _temp31.f3= 0; _temp31;});} prev1=(
result1=({ struct Cyc_List_List* _temp32=( struct Cyc_List_List*) _region_malloc(
r3, sizeof( struct Cyc_List_List)); _temp32->hd=( void*)((( struct _tuple3*)((
struct Cyc_List_List*) _check_null( x))->hd)[ _check_known_subscript_notnull( 1u,
0)]).f1; _temp32->tl= 0; _temp32;})); prev2=( result2=({ struct Cyc_List_List*
...
_check_known_subscript_notnull( 1u, 0)]).f2; _temp33->tl= 0; _temp33;})); prev3=(
result3=({ struct Cyc_List_List* _temp34=( struct Cyc_List_List*) _region_malloc(
r5, sizeof( struct Cyc_List_List)); _temp34->hd=( void*)((( struct _tuple3*)((
struct Cyc_List_List*) _check_null( x))->hd)[ _check_known_subscript_notnull( 1u,
0)]).f3; _temp34->tl= 0; _temp34;})); for( x=(( struct Cyc_List_List*)
_check_null( x))->tl; x !=  0; x=(( struct Cyc_List_List*) _check_null( x))->tl){((
struct Cyc_List_List*) _check_null( prev1))->tl=({ struct Cyc_List_List* _temp35=(
struct Cyc_List_List*) _region_malloc( r3, sizeof( struct Cyc_List_List));
_temp35->hd=( void*)((( struct _tuple3*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f1; _temp35->tl= 0; _temp35;});((
struct Cyc_List_List*) _check_null( prev2))->tl=({ struct Cyc_List_List* _temp36=(
struct Cyc_List_List*) _region_malloc( r4, sizeof( struct Cyc_List_List));
_temp36->hd=( void*)((( struct _tuple3*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f2; _temp36->tl= 0; _temp36;});((
struct Cyc_List_List*) _check_null( prev3))->tl=({ struct Cyc_List_List* _temp37=(
struct Cyc_List_List*) _region_malloc( r5, sizeof( struct Cyc_List_List));
_temp37->hd=( void*)((( struct _tuple3*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f3; _temp37->tl= 0; _temp37;}); prev1=((
struct Cyc_List_List*) _check_null( prev1))->tl; prev2=(( struct Cyc_List_List*)
_check_null( prev2))->tl; prev3=(( struct Cyc_List_List*) _check_null( prev3))->tl;}
return({ struct _tuple1 _temp38; _temp38.f1= result1; _temp38.f2= result2;
_temp38.f3= result3; _temp38;});} struct _tuple1 Cyc_List_split3( struct Cyc_List_List*
x){ return Cyc_List_rsplit3( Cyc_Core_heap_region, Cyc_Core_heap_region, Cyc_Core_heap_region,
x);} int Cyc_List_memq( struct Cyc_List_List* l, void* x){ while( l !=  0) { if((
void*)(( struct Cyc_List_List*) _check_null( l))->hd ==  x){ return 1;} l=((
struct Cyc_List_List*) _check_null( l))->tl;} return 0;} int Cyc_List_mem( int(*
cmp)( void*, void*), struct Cyc_List_List* l, void* x){ while( l !=  0) { if(
cmp(( void*)(( struct Cyc_List_List*) _check_null( l))->hd, x) ==  0){ return 1;}
l=(( struct Cyc_List_List*) _check_null( l))->tl;} return 0;} void* Cyc_List_assoc(
struct Cyc_List_List* l, void* x){ while( l !=  0) { if(((( struct _tuple2*)((
struct Cyc_List_List*) _check_null( l))->hd)[ _check_known_subscript_notnull( 1u,
0)]).f1 ==  x){ return((( struct _tuple2*)(( struct Cyc_List_List*) _check_null(
l))->hd)[ _check_known_subscript_notnull( 1u, 0)]).f2;} l=(( struct Cyc_List_List*)
_check_null( l))->tl;}( int) _throw(( void*) Cyc_Core_Not_found);} void* Cyc_List_assoc_cmp(
int(* cmp)( void*, void*), struct Cyc_List_List* l, void* x){ while( l !=  0) {
if( cmp( x,((( struct _tuple2*)(( struct Cyc_List_List*) _check_null( l))->hd)[
...
while( l !=  0) { if(((( struct _tuple2*)(( struct Cyc_List_List*) _check_null(
l))->hd)[ _check_known_subscript_notnull( 1u, 0)]).f1 ==  x){ return 1;} l=((
struct Cyc_List_List*) _check_null( l))->tl;} return 0;} struct Cyc_Core_Opt*
Cyc_List_check_unique( int(* cmp)( void*, void*), struct Cyc_List_List* x){
while( x !=  0) { if((( struct Cyc_List_List*) _check_null( x))->tl !=  0){ if(
cmp(( void*)(( struct Cyc_List_List*) _check_null( x))->hd,( void*)(( struct Cyc_List_List*)
_check_null((( struct Cyc_List_List*) _check_null( x))->tl))->hd) ==  0){ return({
struct Cyc_Core_Opt* _temp39=( struct Cyc_Core_Opt*) _cycalloc( sizeof( struct
Cyc_Core_Opt)); _temp39->v=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd); _temp39;});}} x=(( struct Cyc_List_List*) _check_null( x))->tl;}
...
arr=({ unsigned int _temp40=( unsigned int) s; void** _temp41=( void**)
_region_malloc( r2, _check_times( sizeof( void*), _temp40)); struct _tagged_arr
_temp43= _tag_arr( _temp41, sizeof( void*),( unsigned int) s);{ unsigned int
_temp42= _temp40; unsigned int i; for( i= 0; i <  _temp42; i ++){ _temp41[ i]=(
void*)(( struct Cyc_List_List*) _check_null( x))->hd;}}; _temp43;});{ int i= 0;
...
_temp44=( struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp44->hd=( void*)*(( void**) _check_unknown_subscript( arr, sizeof( void*), i));
_temp44->tl= ans; _temp44;});}} return ans;} struct Cyc_List_List* Cyc_List_from_array(
...
struct Cyc_List_List* _temp45=( struct Cyc_List_List*) _region_malloc( r,
sizeof( struct Cyc_List_List)); _temp45->hd=( void*) f( i); _temp45->tl= res;
_temp45;});}} return Cyc_List_imp_rev( res);} struct Cyc_List_List* Cyc_List_tabulate(
int n, void*(* f)( int)){ return Cyc_List_rtabulate( Cyc_Core_heap_region, n, f);}
...
<  n; ++ i){ res=({ struct Cyc_List_List* _temp46=( struct Cyc_List_List*)
_region_malloc( r, sizeof( struct Cyc_List_List)); _temp46->hd=( void*) f( env,
i); _temp46->tl= res; _temp46;});}} return Cyc_List_imp_rev( res);} struct Cyc_List_List*
...
void*), struct Cyc_List_List* l1, struct Cyc_List_List* l2){ for( 0; l1 !=  0?
l2 !=  0: 0;( l1=(( struct Cyc_List_List*) _check_null( l1))->tl, l2=(( struct
Cyc_List_List*) _check_null( l2))->tl)){ if(( unsigned int) l1 == ( unsigned int)
l2){ return 0;}{ int _temp47= cmp(( void*)(( struct Cyc_List_List*) _check_null(
l1))->hd,( void*)(( struct Cyc_List_List*) _check_null( l2))->hd); if( _temp47
!=  0){ return _temp47;}}} if( l1 !=  0){ return 1;} if( l2 !=  0){ return - 1;}
...
unsigned int) l1 == ( unsigned int) l2){ return 1;}{ int _temp48= cmp(( void*)((
struct Cyc_List_List*) _check_null( l1))->hd,( void*)(( struct Cyc_List_List*)
_check_null( l2))->hd); if( _temp48 !=  0){ return 0;}}} return l1 ==  0;}
struct Cyc_List_List* Cyc_List_rfilter_c( struct _RegionHandle* r2, int(* f)(
void*, void*), void* env, struct Cyc_List_List* l){ if( l ==  0){ return 0;}{
struct Cyc_List_List* result=({ struct Cyc_List_List* _temp50=( struct Cyc_List_List*)
_region_malloc( r2, sizeof( struct Cyc_List_List)); _temp50->hd=( void*)(( void*)((
struct Cyc_List_List*) _check_null( l))->hd); _temp50->tl= 0; _temp50;}); struct
Cyc_List_List* end= result; for( 0; l !=  0; l=(( struct Cyc_List_List*)
_check_null( l))->tl){ if( f( env,( void*)(( struct Cyc_List_List*) _check_null(
l))->hd)){(( struct Cyc_List_List*) _check_null( end))->tl=({ struct Cyc_List_List*
...
_temp49->tl= 0; _temp49;}); end=(( struct Cyc_List_List*) _check_null( end))->tl;}}
return(( struct Cyc_List_List*) _check_null( result))->tl;}} struct Cyc_List_List*
Cyc_List_filter_c( int(* f)( void*, void*), void* env, struct Cyc_List_List* l){
return Cyc_List_rfilter_c( Cyc_Core_heap_region, f, env, l);} struct Cyc_List_List*
...
_temp52->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( l))->hd);
_temp52->tl= 0; _temp52;}); struct Cyc_List_List* end= result; for( 0; l !=  0;
l=(( struct Cyc_List_List*) _check_null( l))->tl){ if( f(( void*)(( struct Cyc_List_List*)
_check_null( l))->hd)){(( struct Cyc_List_List*) _check_null( end))->tl=({
struct Cyc_List_List* _temp51=( struct Cyc_List_List*) _region_malloc( r2,
sizeof( struct Cyc_List_List)); _temp51->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( l))->hd); _temp51->tl= 0; _temp51;}); end=(( struct Cyc_List_List*)
