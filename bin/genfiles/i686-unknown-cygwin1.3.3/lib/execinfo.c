...
struct _tagged_arr,int);int Cyc_Execinfo_bt();struct Cyc_Std___cycFILE;struct Cyc_Std_Cstdio___abstractFILE;
...
18];struct Cyc_Std_FileOpenError_struct{char*tag;struct _tagged_arr f1;};struct Cyc_Std_timeval{
int tv_sec;int tv_usec;};struct Cyc_Std_rusage{struct Cyc_Std_timeval ru_utime;struct
Cyc_Std_timeval ru_stime;int ru_maxrss;int ru_ixrss;int ru_idrss;int ru_isrss;int
ru_minflt;int ru_majflt;int ru_nswap;int ru_inblock;int ru_oublock;int ru_msgsnd;int
ru_msgrcv;int ru_nsignals;int ru_nvcsw;int ru_nivcsw;};struct Cyc_Std___SIG_BUILTIN_struct{
int tag;void*f1;};struct Cyc_Std___SIG_HANDLER_struct{int tag;void(*f1)(int);};int
...
_tmp2="backtrace: unsupported except under Linux";_tag_arr(_tmp2,sizeof(char),
_get_zero_arr_size(_tmp2,42));});_tmp1;});_tmp0;}));return 0;}int Cyc_Execinfo_bt(){
return 1;}
