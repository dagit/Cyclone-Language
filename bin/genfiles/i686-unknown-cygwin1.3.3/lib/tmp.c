...
wrap_Cstring_as_string(unsigned char*,unsigned int);struct Cyc_Cstdio___sFILE;
struct Cyc_Std___sFILE;extern struct Cyc_Std___sFILE*Cyc_Std_fromCfile(struct Cyc_Cstdio___sFILE*
cf);extern struct Cyc_Std___sFILE*Cyc_Std_tmpfile();extern struct _tagged_arr Cyc_Std_tmpnam(
