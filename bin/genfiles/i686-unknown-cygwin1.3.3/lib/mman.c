...
ntCsl_to_ntsl( unsigned char**); extern struct _tagged_arr Cyc_Std_mmap(
unsigned int length, int prot, int flags, int fd, int offset); extern int Cyc_Std_munmap(
struct _tagged_arr start, unsigned int length); extern unsigned char* mmap(
