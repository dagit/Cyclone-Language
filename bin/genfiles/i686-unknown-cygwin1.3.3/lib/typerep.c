...
ntCsl_to_ntsl( unsigned char**); static const int Cyc_Typerep_Var= 0; struct Cyc_Typerep_Var_struct{
...
tag; void* f1; } ; static const int Cyc_Typerep_Tuple= 4; struct _tuple0{
