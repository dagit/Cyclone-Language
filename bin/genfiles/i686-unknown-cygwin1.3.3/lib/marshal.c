...
Cyc_List_Nth[ 8u]; struct Cyc_Set_Set; extern unsigned char Cyc_Set_Absent[ 11u];
...
void* rep); struct Cyc_Std___sFILE; extern struct Cyc_Std___sFILE* Cyc_Std_stderr;
