...
struct _tagged_arr Cstring_to_string(unsigned char*);struct Cyc_List_List{void*hd;
...
extern unsigned char Cyc_Set_Absent[11];struct Cyc_Typerep_Int_struct{int tag;int f1;
