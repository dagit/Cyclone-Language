...
11];static const int Cyc_Typerep_Var=0;struct Cyc_Typerep_Var_struct{int tag;struct
...
__errno();void Cyc_Marshal_print_type(void*ts,void*val){struct _handler_cons _tmpA8;
_push_handler(& _tmpA8);{int _tmpAA=0;if(setjmp(_tmpA8.handler)){_tmpAA=1;}if(!
_tmpAA){Cyc_Marshal_print_type_base(ts,Cyc_Marshal_empty_addr_set(),val);;
_pop_handler();}else{void*_tmpA9=(void*)_exn_thrown;void*_tmpAC=_tmpA9;struct
_tagged_arr _tmpB2;_LL174: if(*((void**)_tmpAC)== Cyc_Core_Failure){_LL179: _tmpB2=((
struct Cyc_Core_Failure_struct*)_tmpAC)->f1;goto _LL175;}else{goto _LL176;}_LL176:
goto _LL177;_LL175:({struct Cyc_Std_String_pa_struct _tmpB5;_tmpB5.tag=Cyc_Std_String_pa;
