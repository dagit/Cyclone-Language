...
Cyc_Std_stderr;extern int Cyc_Std_fgetc(struct Cyc_Std___cycFILE*__stream);extern
int Cyc_Std_fputc(int __c,struct Cyc_Std___cycFILE*__stream);extern unsigned int Cyc_Std_fread(
