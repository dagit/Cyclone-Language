...
extern struct _tagged_arr ntCsl_to_ntsl(unsigned char**);struct Cyc_Std_group{struct
_tagged_arr gr_name;struct _tagged_arr gr_passwd;unsigned short gr_gid;struct
_tagged_arr gr_mem;};extern struct Cyc_Std_group*Cyc_Std_getgrnam(struct _tagged_arr
name);extern struct Cyc_Std_group*Cyc_Std_getgrgid(unsigned short uid);extern int Cyc_Std_initgroups(
struct _tagged_arr user,unsigned short group);extern int Cyc_Std_setgroups(struct
_tagged_arr groups);struct Cyc_Cgrp_Cgroup{unsigned char*gr_name;unsigned char*
gr_passwd;unsigned short gr_gid;unsigned char**gr_mem;};extern struct Cyc_Cgrp_Cgroup*
getgrnam(unsigned char*name);extern struct Cyc_Cgrp_Cgroup*getgrgid(unsigned short
