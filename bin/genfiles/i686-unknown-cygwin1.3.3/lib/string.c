...
8];int toupper(int);char*strerror(int errnum);unsigned int Cyc_Std_strlen(struct
_tagged_arr s);int Cyc_Std_strcmp(struct _tagged_arr s1,struct _tagged_arr s2);int Cyc_Std_strptrcmp(
struct _tagged_arr*s1,struct _tagged_arr*s2);int Cyc_Std_strncmp(struct _tagged_arr
s1,struct _tagged_arr s2,unsigned int len);int Cyc_Std_zstrcmp(struct _tagged_arr,
struct _tagged_arr);int Cyc_Std_zstrncmp(struct _tagged_arr s1,struct _tagged_arr s2,
unsigned int n);int Cyc_Std_zstrptrcmp(struct _tagged_arr*,struct _tagged_arr*);int
Cyc_Std_strcasecmp(struct _tagged_arr,struct _tagged_arr);int Cyc_Std_strncasecmp(
struct _tagged_arr s1,struct _tagged_arr s2,unsigned int len);struct _tagged_arr Cyc_Std_strcat(
struct _tagged_arr dest,struct _tagged_arr src);struct _tagged_arr Cyc_Std_strconcat(
struct _tagged_arr,struct _tagged_arr);struct _tagged_arr Cyc_Std_rstrconcat(struct
_RegionHandle*,struct _tagged_arr,struct _tagged_arr);struct _tagged_arr Cyc_Std_strconcat_l(
struct Cyc_List_List*);struct _tagged_arr Cyc_Std_rstrconcat_l(struct _RegionHandle*,
struct Cyc_List_List*);struct _tagged_arr Cyc_Std_str_sepstr(struct Cyc_List_List*,
struct _tagged_arr);struct _tagged_arr Cyc_Std_rstr_sepstr(struct _RegionHandle*,
struct Cyc_List_List*,struct _tagged_arr);struct _tagged_arr Cyc_Std_strcpy(struct
_tagged_arr dest,struct _tagged_arr src);struct _tagged_arr Cyc_Std_strncpy(struct
_tagged_arr,struct _tagged_arr,unsigned int);struct _tagged_arr Cyc_Std_zstrncpy(
struct _tagged_arr,struct _tagged_arr,unsigned int);struct _tagged_arr Cyc_Std_realloc(
struct _tagged_arr,unsigned int);struct _tagged_arr Cyc_Std__memcpy(struct
_tagged_arr d,struct _tagged_arr s,unsigned int,unsigned int);struct _tagged_arr Cyc_Std__memmove(
...
_tagged_arr Cyc_Std_implode(struct Cyc_List_List*c);void*Cyc_Std___assert_fail(
struct _tagged_arr assertion,struct _tagged_arr file,unsigned int line);char*strerror(
int errnum);unsigned int Cyc_Std_strlen(struct _tagged_arr s){unsigned int i;
unsigned int sz=_get_arr_size(s,sizeof(char));for(i=0;i < sz;i ++){if(((const char*)
s.curr)[(int)i]== '\000')return i;}return i;}int Cyc_Std_strcmp(struct _tagged_arr s1,
struct _tagged_arr s2){if(s1.curr == s2.curr)return 0;{int i=0;unsigned int sz1=
...
sizeof(char),_get_zero_arr_size(_tmp1,11));}),61);while(i < minsz){char c1=*((
...
_tagged_arr*s2){return Cyc_Std_strcmp((struct _tagged_arr)*((struct _tagged_arr*)s1),(
struct _tagged_arr)*((struct _tagged_arr*)s2));}inline static int Cyc_Std_ncmp(struct
...
_tagged_arr file,unsigned int line))Cyc_Std___assert_fail)(({const char*_tmp2="bound <= s1.size && bound <= s2.size";
_tag_arr(_tmp2,sizeof(char),_get_zero_arr_size(_tmp2,37));}),({const char*_tmp3="string.cyc";
_tag_arr(_tmp3,sizeof(char),_get_zero_arr_size(_tmp3,11));}),97);{int i=0;for(0;i
...
unsigned int len1=Cyc_Std_strlen(s1);unsigned int len2=Cyc_Std_strlen(s2);return
Cyc_Std_ncmp(s1,len1,s2,len2,n);}int Cyc_Std_zstrcmp(struct _tagged_arr a,struct
_tagged_arr b){if(a.curr == b.curr)return 0;{unsigned int as=_get_arr_size(a,sizeof(
char));unsigned int bs=_get_arr_size(b,sizeof(char));unsigned int min_length=as < 
bs?as: bs;int i=- 1;(min_length <= _get_arr_size(a,sizeof(char))?min_length <= 
_get_arr_size(b,sizeof(char)): 0)?0:((int(*)(struct _tagged_arr assertion,struct
_tagged_arr file,unsigned int line))Cyc_Std___assert_fail)(({const char*_tmp4="min_length <= a.size && min_length <= b.size";
_tag_arr(_tmp4,sizeof(char),_get_zero_arr_size(_tmp4,45));}),({const char*_tmp5="string.cyc";
_tag_arr(_tmp5,sizeof(char),_get_zero_arr_size(_tmp5,11));}),129);while((++ i,i < 
...
_get_arr_size(s2,sizeof(char)): 0)?0:((int(*)(struct _tagged_arr assertion,struct
_tagged_arr file,unsigned int line))Cyc_Std___assert_fail)(({const char*_tmp6="bound <= s1.size && bound <= s2.size";
_tag_arr(_tmp6,sizeof(char),_get_zero_arr_size(_tmp6,37));}),({const char*_tmp7="string.cyc";
_tag_arr(_tmp7,sizeof(char),_get_zero_arr_size(_tmp7,11));}),147);{int i=0;for(0;
...
_tagged_arr*)b));}inline static struct _tagged_arr Cyc_Std_int_strcato(struct
_tagged_arr dest,struct _tagged_arr src){int i;unsigned int dsize;unsigned int slen;
unsigned int dlen;dsize=_get_arr_size(dest,sizeof(char));dlen=Cyc_Std_strlen((
struct _tagged_arr)dest);slen=Cyc_Std_strlen(src);if(slen + dlen <= dsize){slen <= 
_get_arr_size(src,sizeof(char))?0:((int(*)(struct _tagged_arr assertion,struct
_tagged_arr file,unsigned int line))Cyc_Std___assert_fail)(({const char*_tmp8="slen <= src.size";
_tag_arr(_tmp8,sizeof(char),_get_zero_arr_size(_tmp8,17));}),({const char*_tmp9="string.cyc";
_tag_arr(_tmp9,sizeof(char),_get_zero_arr_size(_tmp9,11));}),183);for(i=0;i < 
...
dest,src);}struct _tagged_arr Cyc_Std_rstrconcat(struct _RegionHandle*r,struct
_tagged_arr a,struct _tagged_arr b){unsigned int _tmp13=Cyc_Std_strlen(a);
unsigned int _tmp14=Cyc_Std_strlen(b);struct _tagged_arr ans=Cyc_Core_rnew_string(r,(
...
_tagged_arr file,unsigned int line))Cyc_Std___assert_fail)(({const char*_tmp15="alen <= ans.size && alen <= a.size";
...
207);for(i=0;i < _tmp13;++ i){({struct _tagged_arr _tmp17=_tagged_arr_plus(ans,
...
char*_tmp1A="blen <= b.size";_tag_arr(_tmp1A,sizeof(char),_get_zero_arr_size(
_tmp1A,15));}),({const char*_tmp1B="string.cyc";_tag_arr(_tmp1B,sizeof(char),
_get_zero_arr_size(_tmp1B,11));}),209);for(j=0;j < _tmp14;++ j){({struct
...
0;struct _tagged_arr ans;{struct _RegionHandle _tmp1F=_new_region("temp");struct
...
temp);}return ans;}struct _tagged_arr Cyc_Std_strconcat_l(struct Cyc_List_List*strs){
return Cyc_Std_rstrconcat_l(Cyc_Core_heap_region,strs);}struct _tagged_arr Cyc_Std_rstr_sepstr(
struct _RegionHandle*r,struct Cyc_List_List*strs,struct _tagged_arr separator){if(
strs == 0)return Cyc_Core_rnew_string(r,0);if(strs->tl == 0)return Cyc_Std_rstrdup(r,(
...
_tmp23->tl){len=Cyc_Std_strlen((struct _tagged_arr)*((struct _tagged_arr*)((struct
...
struct _tagged_arr*)strs->hd));len=(unsigned int)((struct Cyc_List_List*)
_check_null(lens))->hd;Cyc_Std_strncpy(_tagged_arr_plus(ans,sizeof(char),(int)i),(
struct _tagged_arr)_tmp26,len);i +=len;Cyc_Std_strncpy(_tagged_arr_plus(ans,
sizeof(char),(int)i),separator,seplen);i +=seplen;strs=strs->tl;lens=lens->tl;}
Cyc_Std_strncpy(_tagged_arr_plus(ans,sizeof(char),(int)i),(struct _tagged_arr)*((
struct _tagged_arr*)((struct _tagged_arr*)strs->hd)),(unsigned int)((struct Cyc_List_List*)
_check_null(lens))->hd);{struct _tagged_arr _tmp27=ans;_npop_handler(0);return
_tmp27;}}}};_pop_region(temp);}}struct _tagged_arr Cyc_Std_str_sepstr(struct Cyc_List_List*
strs,struct _tagged_arr separator){return Cyc_Std_rstr_sepstr(Cyc_Core_heap_region,
strs,separator);}struct _tagged_arr Cyc_Std_strncpy(struct _tagged_arr dest,struct
...
_tagged_arr file,unsigned int line))Cyc_Std___assert_fail)(({const char*_tmp29="n <= src.size && n <= dest.size";
...
300);for(i=0;i < n;i ++){char _tmp2B=((const char*)src.curr)[i];if(_tmp2B == '\000')
...
unsigned int line))Cyc_Std___assert_fail)(({const char*_tmp32="n <= dest.size && n <= src.size";
_tag_arr(_tmp32,sizeof(char),_get_zero_arr_size(_tmp32,32));}),({const char*
_tmp33="string.cyc";_tag_arr(_tmp33,sizeof(char),_get_zero_arr_size(_tmp33,11));}),
314);{int i;for(i=0;i < n;i ++){({struct _tagged_arr _tmp34=_tagged_arr_plus(dest,
sizeof(char),i);char _tmp35=*((char*)_check_unknown_subscript(_tmp34,sizeof(char),
0));char _tmp36=((const char*)src.curr)[i];if(_get_arr_size(_tmp34,sizeof(char))== 
1?_tmp35 == '\000'?_tmp36 != '\000': 0: 0)_throw_arraybounds();*((char*)_tmp34.curr)=
_tmp36;});}return dest;}}struct _tagged_arr Cyc_Std_strcpy(struct _tagged_arr dest,
...
for(i=0;i < ssz;i ++){char _tmp37=((const char*)src.curr)[(int)i];({struct
_tagged_arr _tmp38=_tagged_arr_plus(dest,sizeof(char),(int)i);char _tmp39=*((char*)
_check_unknown_subscript(_tmp38,sizeof(char),0));char _tmp3A=_tmp37;if(
_get_arr_size(_tmp38,sizeof(char))== 1?_tmp39 == '\000'?_tmp3A != '\000': 0: 0)
_throw_arraybounds();*((char*)_tmp38.curr)=_tmp3A;});if(_tmp37 == '\000')break;}}
...
_tmp3D;});}return dest;}struct _tagged_arr Cyc_Std_rstrdup(struct _RegionHandle*r,
...
temp,s,slen);if(slen != _get_arr_size(s,sizeof(char)))({struct _tagged_arr _tmp3E=
_tagged_arr_plus(temp,sizeof(char),(int)slen);char _tmp3F=*((char*)
_check_unknown_subscript(_tmp3E,sizeof(char),0));char _tmp40='\000';if(
_get_arr_size(_tmp3E,sizeof(char))== 1?_tmp3F == '\000'?_tmp40 != '\000': 0: 0)
_throw_arraybounds();*((char*)_tmp3E.curr)=_tmp40;});return temp;}struct
...
r,maxsizeP);({struct _tagged_arr _tmp41=_tagged_arr_plus(str,sizeof(char),0);char
_tmp42=*((char*)_check_unknown_subscript(_tmp41,sizeof(char),0));char _tmp43='\000';
if(_get_arr_size(_tmp41,sizeof(char))== 1?_tmp42 == '\000'?_tmp43 != '\000': 0: 0)
...
_tagged_arr assertion,struct _tagged_arr file,unsigned int line))Cyc_Std___assert_fail)(({
const char*_tmp44="amt < ans.size && amt <= s.size";_tag_arr(_tmp44,sizeof(char),
_get_zero_arr_size(_tmp44,32));}),({const char*_tmp45="string.cyc";_tag_arr(
_tmp45,sizeof(char),_get_zero_arr_size(_tmp45,11));}),410);{unsigned int i=0;for(
0;i < amt;++ i){({struct _tagged_arr _tmp46=_tagged_arr_plus(ans,sizeof(char),(int)i);
char _tmp47=*((char*)_check_unknown_subscript(_tmp46,sizeof(char),0));char _tmp48=((
const char*)s.curr)[(int)i];if(_get_arr_size(_tmp46,sizeof(char))== 1?_tmp47 == '\000'?
_tmp48 != '\000': 0: 0)_throw_arraybounds();*((char*)_tmp46.curr)=_tmp48;});}}({
struct _tagged_arr _tmp49=_tagged_arr_plus(ans,sizeof(char),(int)amt);char _tmp4A=*((
char*)_check_unknown_subscript(_tmp49,sizeof(char),0));char _tmp4B='\000';if(
...
const char*_tmp50="Std::replace_suffix";_tag_arr(_tmp50,sizeof(char),
_get_zero_arr_size(_tmp50,20));});if(m < n)(int)_throw((void*)({struct Cyc_Core_Invalid_argument_struct*
...
len=(int)Cyc_Std_strlen((struct _tagged_arr)s);int i=len - 1;
...
s,char c){int len=(int)Cyc_Std_strlen((struct _tagged_arr)s);int i=len - 1;
_tagged_arr_inplace_plus(& s,sizeof(char),i);for(0;i >= 0;(i --,
...
_throw((void*)({struct Cyc_Core_Invalid_argument_struct*_tmp51=_cycalloc(sizeof(*
_tmp51));_tmp51[0]=({struct Cyc_Core_Invalid_argument_struct _tmp52;_tmp52.tag=Cyc_Core_Invalid_argument;
_tmp52.f1=({const char*_tmp53="Std::strstr";_tag_arr(_tmp53,sizeof(char),
_get_zero_arr_size(_tmp53,12));});_tmp52;});_tmp51;}));if(*((const char*)
_check_unknown_subscript(needle,sizeof(char),0))== '\000')return haystack;{int len=(
int)Cyc_Std_strlen((struct _tagged_arr)needle);{struct _tagged_arr start=haystack;
...
needle,sizeof(char),0)))){if(Cyc_Std_strncmp((struct _tagged_arr)start,(struct
...
needle.curr))(int)_throw((void*)({struct Cyc_Core_Invalid_argument_struct*_tmp54=
_cycalloc(sizeof(*_tmp54));_tmp54[0]=({struct Cyc_Core_Invalid_argument_struct
_tmp55;_tmp55.tag=Cyc_Core_Invalid_argument;_tmp55.f1=({const char*_tmp56="Std::mstrstr";
_tag_arr(_tmp56,sizeof(char),_get_zero_arr_size(_tmp56,13));});_tmp55;});_tmp54;}));
if(*((const char*)_check_unknown_subscript(needle,sizeof(char),0))== '\000')
return haystack;{int len=(int)Cyc_Std_strlen((struct _tagged_arr)needle);{struct
...
_tagged_arr)start,(struct _tagged_arr)needle,(unsigned int)len)== 0)return start;}}
return _tag_arr(0,0,0);}}unsigned int Cyc_Std_strspn(struct _tagged_arr s,struct
_tagged_arr accept){unsigned int len=Cyc_Std_strlen((struct _tagged_arr)s);
...
unsigned int line))Cyc_Std___assert_fail)(({const char*_tmp57="len <= s.size";
_tag_arr(_tmp57,sizeof(char),_get_zero_arr_size(_tmp57,14));}),({const char*
_tmp58="string.cyc";_tag_arr(_tmp58,sizeof(char),_get_zero_arr_size(_tmp58,11));}),
558);{unsigned int i=0;for(0;i < len;i ++){int j;for(j=0;j < asize;j ++){if(((const
char*)s.curr)[(int)i]== ((const char*)accept.curr)[j])break;}if(j == asize)return i;}}
return len;}unsigned int Cyc_Std_strcspn(struct _tagged_arr s,struct _tagged_arr
accept){unsigned int len=Cyc_Std_strlen((struct _tagged_arr)s);unsigned int asize=
...
_get_zero_arr_size(_tmp5A,11));}),578);{unsigned int i=0;for(0;i < len;i ++){int j;
...
struct _tagged_arr s,struct _tagged_arr delim){static struct _tagged_arr olds={(void*)0,(
void*)0,(void*)(0 + 0)};struct _tagged_arr token;if(s.curr == (_tag_arr(0,0,0)).curr){
if(olds.curr == (_tag_arr(0,0,0)).curr)return _tag_arr(0,0,0);s=olds;}{
unsigned int inc=Cyc_Std_strspn((struct _tagged_arr)s,delim);if(inc >= 
_get_arr_size(s,sizeof(char))?1:*((char*)_check_unknown_subscript(
_tagged_arr_plus(s,sizeof(char),(int)inc),sizeof(char),0))== '\000'){olds=
_tag_arr(0,0,0);return _tag_arr(0,0,0);}else{_tagged_arr_inplace_plus(& s,sizeof(
char),(int)inc);}token=s;s=Cyc_Std_mstrpbrk(token,(struct _tagged_arr)delim);if(s.curr
== (_tag_arr(0,0,0)).curr)olds=_tag_arr(0,0,0);else{({struct _tagged_arr _tmp5B=s;
char _tmp5C=*((char*)_check_unknown_subscript(_tmp5B,sizeof(char),0));char _tmp5D='\000';
if(_get_arr_size(_tmp5B,sizeof(char))== 1?_tmp5C == '\000'?_tmp5D != '\000': 0: 0)
_throw_arraybounds();*((char*)_tmp5B.curr)=_tmp5D;});olds=_tagged_arr_plus(s,
...
s)- 1);for(0;i >= 0;i --){result=({struct Cyc_List_List*_tmp5E=_region_malloc(r,
sizeof(*_tmp5E));_tmp5E->hd=(void*)((int)*((const char*)_check_unknown_subscript(
s,sizeof(char),i)));_tmp5E->tl=result;_tmp5E;});}}return result;}struct Cyc_List_List*
...
Cyc_List_length)(chars)+ 1));unsigned int i=0;while(chars != 0){({struct
...
sizeof(char)): 0)?0:((int(*)(struct _tagged_arr assertion,struct _tagged_arr file,
unsigned int line))Cyc_Std___assert_fail)(({const char*_tmp62="min_length <= s1.size && min_length <= s2.size";
...
659);{int i=- 1;while((++ i,i < min_length)){int diff=toupper((int)((const char*)s1.curr)[
...
if(s1.curr == s2.curr)return 0;{unsigned int len1=Cyc_Std_strlen(s1);unsigned int
len2=Cyc_Std_strlen(s2);return Cyc_Std_casecmp(s1,len1,s2,len2);}}inline static int
Cyc_Std_caseless_ncmp(struct _tagged_arr s1,unsigned int len1,struct _tagged_arr s2,
...
sizeof(char))?bound <= _get_arr_size(s2,sizeof(char)): 0)?0:((int(*)(struct
_tagged_arr assertion,struct _tagged_arr file,unsigned int line))Cyc_Std___assert_fail)(({
const char*_tmp64="bound <= s1.size && bound <= s2.size";_tag_arr(_tmp64,sizeof(
char),_get_zero_arr_size(_tmp64,37));}),({const char*_tmp65="string.cyc";_tag_arr(
_tmp65,sizeof(char),_get_zero_arr_size(_tmp65,11));}),686);{int i=0;for(0;i < 
...
s2,unsigned int n){unsigned int len1=Cyc_Std_strlen(s1);unsigned int len2=Cyc_Std_strlen(
s2);return Cyc_Std_caseless_ncmp(s1,len1,s2,len2,n);}void*memcpy(void*,const void*,
...
_tagged_arr Cyc_Std_realloc(struct _tagged_arr s,unsigned int n){char*_tmp66=
GC_realloc((char*)_check_null(_untag_arr(s,sizeof(char),1)),n);return
wrap_Cstring_as_string(_tmp66,n);}struct _tagged_arr Cyc_Std__memcpy(struct
...
_tmp68.f1=({const char*_tmp69="Std::memcpy";_tag_arr(_tmp69,sizeof(char),
_get_zero_arr_size(_tmp69,12));});_tmp68;});_tmp67;}));memcpy((void*)_check_null(
...
_tmp6B;_tmp6B.tag=Cyc_Core_Invalid_argument;_tmp6B.f1=({const char*_tmp6C="Std::memove";
_tag_arr(_tmp6C,sizeof(char),_get_zero_arr_size(_tmp6C,12));});_tmp6B;});_tmp6A;}));
...
_tmp6E.f1=({const char*_tmp6F="Std::memcmp";_tag_arr(_tmp6F,sizeof(char),
_get_zero_arr_size(_tmp6F,12));});_tmp6E;});_tmp6D;}));return memcmp((const void*)
_check_null(_untag_arr(s1,sizeof(char),1)),(const void*)_check_null(_untag_arr(s2,
sizeof(char),1)),n);}struct _tagged_arr Cyc_Std_memchr(struct _tagged_arr s,char c,
...
_tmp71;_tmp71.tag=Cyc_Core_Invalid_argument;_tmp71.f1=({const char*_tmp72="Std::memchr";
_tag_arr(_tmp72,sizeof(char),_get_zero_arr_size(_tmp72,12));});_tmp71;});_tmp70;}));{
...
_throw((void*)({struct Cyc_Core_Invalid_argument_struct*_tmp77=_cycalloc(sizeof(*
_tmp77));_tmp77[0]=({struct Cyc_Core_Invalid_argument_struct _tmp78;_tmp78.tag=Cyc_Core_Invalid_argument;
_tmp78.f1=({const char*_tmp79="Std::mmemchr";_tag_arr(_tmp79,sizeof(char),
_get_zero_arr_size(_tmp79,13));});_tmp78;});_tmp77;}));{char*_tmp7A=memchr((
const char*)_check_null(_untag_arr(s,sizeof(char),1)),c,n);if(_tmp7A == 0)return
...
_tmp7D);}}}struct _tagged_arr Cyc_Std_memset(struct _tagged_arr s,char c,unsigned int
...
_tmp7F.f1=({const char*_tmp80="Std::memset";_tag_arr(_tmp80,sizeof(char),
_get_zero_arr_size(_tmp80,12));});_tmp7F;});_tmp7E;}));memset((void*)((char*)
...
_tmp82;_tmp82.tag=Cyc_Core_Invalid_argument;_tmp82.f1=({const char*_tmp83="Std::bzero";
_tag_arr(_tmp83,sizeof(char),_get_zero_arr_size(_tmp83,11));});_tmp82;});_tmp81;}));((
void(*)(char*s,unsigned int n))bzero)((char*)_check_null(_untag_arr(s,sizeof(char),
1)),n);}void Cyc_Std__bcopy(struct _tagged_arr src,struct _tagged_arr dst,
...
_tmp85;_tmp85.tag=Cyc_Core_Invalid_argument;_tmp85.f1=({const char*_tmp86="Std::bcopy";
_tag_arr(_tmp86,sizeof(char),_get_zero_arr_size(_tmp86,11));});_tmp85;});_tmp84;}));
