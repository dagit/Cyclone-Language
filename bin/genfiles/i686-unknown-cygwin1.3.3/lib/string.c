...
_tagged_arr Cyc_Core_new_string(unsigned int);struct _tagged_arr Cyc_Core_rnew_string(
...
unsigned char Cyc_List_List_mismatch[18];extern unsigned char Cyc_List_Nth[8];int
toupper(int);struct _tagged_arr Cyc_Std_strerror(int);unsigned int Cyc_Std_strlen(
...
_tagged_arr s);struct _tagged_arr Cyc_Std_implode(struct Cyc_List_List*c);void*Cyc_Std___assert_fail(
