...
extern int toupper(int);extern int _tolower(int);extern int _toupper(int);extern struct
_tagged_arr Cyc_Std_strerror(int);extern unsigned int Cyc_Std_strlen(struct
_tagged_arr s);extern int Cyc_Std_strcmp(struct _tagged_arr s1,struct _tagged_arr s2);
extern int Cyc_Std_strptrcmp(struct _tagged_arr*s1,struct _tagged_arr*s2);extern int
Cyc_Std_strncmp(struct _tagged_arr s1,struct _tagged_arr s2,unsigned int len);extern
int Cyc_Std_zstrcmp(struct _tagged_arr,struct _tagged_arr);extern int Cyc_Std_zstrncmp(
struct _tagged_arr s1,struct _tagged_arr s2,unsigned int n);extern int Cyc_Std_zstrptrcmp(
struct _tagged_arr*,struct _tagged_arr*);extern int Cyc_Std_strcasecmp(struct
_tagged_arr,struct _tagged_arr);extern int Cyc_Std_strncasecmp(struct _tagged_arr s1,
struct _tagged_arr s2,unsigned int len);extern struct _tagged_arr Cyc_Std_strcat(
...
struct _tagged_arr Cyc_Std_strncpy(struct _tagged_arr,struct _tagged_arr,
unsigned int);extern struct _tagged_arr Cyc_Std_zstrncpy(struct _tagged_arr,struct
_tagged_arr,unsigned int);extern struct _tagged_arr Cyc_Std_realloc(struct
_tagged_arr,unsigned int);extern struct _tagged_arr Cyc_Std__memcpy(struct
