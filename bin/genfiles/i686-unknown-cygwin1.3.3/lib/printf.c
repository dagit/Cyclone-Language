...
int Cyc_Std_putc( int __c, struct Cyc_Std___sFILE* __stream); extern
...
_tagged_arr); extern int Cyc_Std_sprintf( struct _tagged_arr s, struct
_tagged_arr fmt, struct _tagged_arr); extern int Cyc_Std_snprintf( struct
_tagged_arr s, unsigned int n, struct _tagged_arr fmt, struct _tagged_arr ap);
