...
Cyc_Std_stdout;extern int Cyc_Std_putc(int __c,struct Cyc_Std___cycFILE*__stream);
...
struct _tagged_arr);extern int Cyc_Std_sprintf(struct _tagged_arr s,struct _tagged_arr
fmt,struct _tagged_arr);extern int Cyc_Std_snprintf(struct _tagged_arr s,unsigned int
n,struct _tagged_arr fmt,struct _tagged_arr ap);extern struct _tagged_arr Cyc_Std_aprintf(
struct _tagged_arr fmt,struct _tagged_arr);extern struct _tagged_arr Cyc_Std_rprintf(
struct _RegionHandle*,struct _tagged_arr fmt,struct _tagged_arr ap);extern int Cyc_Std_vfprintf(
struct Cyc_Std___cycFILE*,struct _tagged_arr fmt,struct _tagged_arr ap);extern int Cyc_Std_vprintf(
struct _tagged_arr fmt,struct _tagged_arr);extern int Cyc_Std_vsprintf(struct
_tagged_arr s,struct _tagged_arr fmt,struct _tagged_arr);extern int Cyc_Std_vsnprintf(
...
_tagged_arr s);extern unsigned char Cyc_Array_Array_mismatch[19];struct Cyc_Std__Div{
int quot;int rem;};struct Cyc_Std__Ldiv{int quot;int rem;};extern double modf(double,
double*);static struct _tagged_arr Cyc_Std_parg2string(void*x){void*_tmp0=x;_LL1:
if(*((int*)_tmp0)== 0){goto _LL2;}else{goto _LL3;}_LL3: if(*((int*)_tmp0)== 1){goto
_LL4;}else{goto _LL5;}_LL5: if(*((int*)_tmp0)== 2){goto _LL6;}else{goto _LL7;}_LL7:
if(*((int*)_tmp0)== 3){goto _LL8;}else{goto _LL9;}_LL9: if(*((int*)_tmp0)== 4){goto
_LLA;}else{goto _LL0;}_LL2: return _tag_arr("string",sizeof(unsigned char),7);_LL4:
return _tag_arr("int",sizeof(unsigned char),4);_LL6: return _tag_arr("double",
sizeof(unsigned char),7);_LL8: return _tag_arr("short *",sizeof(unsigned char),8);
_LLA: return _tag_arr("unsigned long *",sizeof(unsigned char),16);_LL0:;}static
