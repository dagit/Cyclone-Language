...
fds_bits[ 2u]; } ; struct Cyc_Core_Opt{ void* v; } ; extern struct Cyc_Core_Opt*
Cyc_Core_opt_map( void*(* f)( void*), struct Cyc_Core_Opt* x); extern struct
_tagged_arr Cyc_Core_new_string( unsigned int); extern struct _tagged_arr Cyc_Core_rnew_string(
struct _RegionHandle*, unsigned int); extern int Cyc_Core_true_f( void*); extern
int Cyc_Core_false_f( void*); struct _tuple0{ void* f1; void* f2; } ; extern
void* Cyc_Core_fst( struct _tuple0*); extern void* Cyc_Core_snd( struct _tuple0*);
struct _tuple1{ void* f1; void* f2; void* f3; } ; extern void* Cyc_Core_third(
struct _tuple1*); extern void* Cyc_Core_identity( void*); extern int Cyc_Core_intcmp(
int, int); extern int Cyc_Core_charcmp( unsigned char, unsigned char); extern
int Cyc_Core_ptrcmp( void*, void*); extern unsigned char Cyc_Core_Invalid_argument[
...
ntCsl_to_ntsl( unsigned char**); unsigned char Cyc_Core_Invalid_argument[ 21u]="\000\000\000\000Invalid_argument";
