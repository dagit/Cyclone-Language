...
Cyc_Dict_Present[12];extern unsigned char Cyc_Dict_Absent[11];struct Cyc_Dict_Dict*
...
unsigned char Cyc_Dict_Absent[11]="\000\000\000\000Absent";unsigned char Cyc_Dict_Present[
12]="\000\000\000\000Present";struct Cyc_Dict_T{void*color;struct Cyc_Dict_T*left;
struct Cyc_Dict_T*right;struct _tuple0 key_val;};struct Cyc_Dict_Dict{int(*rel)(void*,
void*);struct _RegionHandle*r;struct Cyc_Dict_T*t;};struct Cyc_Dict_Dict*Cyc_Dict_rempty(
struct _RegionHandle*r,int(*comp)(void*,void*)){return({struct Cyc_Dict_Dict*_tmp0=
_region_malloc(r,sizeof(*_tmp0));_tmp0->rel=comp;_tmp0->r=r;_tmp0->t=0;_tmp0;});}
