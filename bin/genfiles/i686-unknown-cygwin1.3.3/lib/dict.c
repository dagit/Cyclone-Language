...
void*dest);};int Cyc_Iter_next(struct Cyc_Iter_Iter,void*);struct Cyc_Cstdio___abstractFILE;
struct Cyc_Std___cycFILE;unsigned int Cyc_Std_fwrite(struct _tagged_arr __ptr,
unsigned int __size,unsigned int __n,struct Cyc_Std___cycFILE*__s);int Cyc_Std_getw(
struct Cyc_Std___cycFILE*__stream);extern char Cyc_Std_FileCloseError[19];extern
char Cyc_Std_FileOpenError[18];struct Cyc_Std_FileOpenError_struct{char*tag;struct
_tagged_arr f1;};struct Cyc_Std_String_pa_struct{int tag;struct _tagged_arr f1;};
...
struct Cyc_Std___cycFILE*,void*),void*(*write_val)(void*,struct Cyc_Std___cycFILE*,
void*),struct Cyc_Std___cycFILE*fp,struct Cyc_Dict_Dict*dict);struct Cyc_Dict_Dict*
Cyc_Dict_unmarshal(struct _RegionHandle*rgn,void**env,int(*cmp)(void*,void*),void*(*
read_key)(void**,struct Cyc_Std___cycFILE*),void*(*read_val)(void**,struct Cyc_Std___cycFILE*),
struct Cyc_Std___cycFILE*fp);char Cyc_Dict_Absent[11]="\000\000\000\000Absent";
char Cyc_Dict_Present[12]="\000\000\000\000Present";struct Cyc_Dict_T{void*color;
struct Cyc_Dict_T*left;struct Cyc_Dict_T*right;struct _tuple0 key_val;};struct Cyc_Dict_Dict{
int(*rel)(void*,void*);struct _RegionHandle*r;struct Cyc_Dict_T*t;};struct Cyc_Dict_Dict*
Cyc_Dict_rempty(struct _RegionHandle*r,int(*comp)(void*,void*)){return({struct Cyc_Dict_Dict*
_tmp0=_region_malloc(r,sizeof(*_tmp0));_tmp0->rel=comp;_tmp0->r=r;_tmp0->t=0;
_tmp0;});}struct Cyc_Dict_Dict*Cyc_Dict_empty(int(*comp)(void*,void*)){return Cyc_Dict_rempty(
...
_tmp1=_region_malloc(r,sizeof(*_tmp1));_tmp1->rel=comp;_tmp1->r=r;_tmp1->t=({
struct Cyc_Dict_T*_tmp2=_region_malloc(r,sizeof(*_tmp2));_tmp2->color=(void*)((
void*)1);_tmp2->left=0;_tmp2->right=0;_tmp2->key_val=({struct _tuple0 _tmp3;_tmp3.f1=
key;_tmp3.f2=data;_tmp3;});_tmp2;});_tmp1;});}struct Cyc_Dict_Dict*Cyc_Dict_singleton(
...
_tmp6F != 0)accum=Cyc_Dict_fold_tree(f,(struct Cyc_Dict_T*)_check_null(_tmp6F),
accum);accum=f(_tmp72,_tmp73,accum);if(_tmp70 != 0)accum=Cyc_Dict_fold_tree(f,(
struct Cyc_Dict_T*)_check_null(_tmp70),accum);return accum;}void*Cyc_Dict_fold(
...
r,f,(struct Cyc_Dict_T*)_check_null(_tmpB7));void*_tmpBD=f(_tmpBB);struct Cyc_Dict_T*
_tmpBE=_tmpB8 == 0?0: Cyc_Dict_map_tree(r,f,(struct Cyc_Dict_T*)_check_null(_tmpB8));
return({struct Cyc_Dict_T*_tmpBF=_region_malloc(r,sizeof(*_tmpBF));_tmpBF->color=(
void*)_tmpB6;_tmpBF->left=_tmpBC;_tmpBF->right=_tmpBE;_tmpBF->key_val=({struct
_tuple0 _tmpC0;_tmpC0.f1=_tmpBA;_tmpC0.f2=_tmpBD;_tmpC0;});_tmpBF;});}}struct Cyc_Dict_Dict*
Cyc_Dict_rmap(struct _RegionHandle*r,void*(*f)(void*),struct Cyc_Dict_Dict*d){if(d->t
== 0)return({struct Cyc_Dict_Dict*_tmpC1=_region_malloc(r,sizeof(*_tmpC1));_tmpC1->rel=
d->rel;_tmpC1->r=r;_tmpC1->t=0;_tmpC1;});return({struct Cyc_Dict_Dict*_tmpC2=
...
Cyc_Dict_T**)_check_unknown_subscript(queue,sizeof(struct Cyc_Dict_T*),++ ind))=(
struct Cyc_Dict_T*)_check_null(_tmpE6);if(_tmpE7 != 0)*((struct Cyc_Dict_T**)
_check_unknown_subscript(queue,sizeof(struct Cyc_Dict_T*),++ ind))=(struct Cyc_Dict_T*)
_check_null(_tmpE7);if(Cyc_Dict_member(d1,_tmpE9))_tmpE3=Cyc_Dict_ins(d2->r,d2->rel,({
struct _tuple0 _tmpEF;_tmpEF.f1=_tmpE9;_tmpEF.f2=f(env,_tmpE9,Cyc_Dict_lookup(d1,
_tmpE9),_tmpEA);_tmpEF;}),_tmpE3);}return({struct Cyc_Dict_Dict*_tmpF0=
_region_malloc(d2->r,sizeof(*_tmpF0));_tmpF0->rel=d2->rel;_tmpF0->r=d2->r;_tmpF0->t=
_tmpE3;_tmpF0;});}}static void*Cyc_Dict_intersect_f(void*(*f)(void*,void*,void*),
...
f;_tmpFB.f2=r2;_tmpFB;});struct Cyc_Dict_Dict*(*ff)(struct _tuple7*,void*,void*,
struct Cyc_Dict_Dict*)=Cyc_Dict_filter_f;return((struct Cyc_Dict_Dict*(*)(struct
Cyc_Dict_Dict*(*f)(struct _tuple7*,void*,void*,struct Cyc_Dict_Dict*),struct
_tuple7*env,struct Cyc_Dict_Dict*d,struct Cyc_Dict_Dict*accum))Cyc_Dict_fold_c)(ff,&
_tmpFA,d,Cyc_Dict_rempty(r2,d->rel));}struct Cyc_Dict_Dict*Cyc_Dict_filter(int(*f)(
void*,void*),struct Cyc_Dict_Dict*d){return Cyc_Dict_rfilter(Cyc_Core_heap_region,
f,d);}struct _tuple8{int(*f1)(void*,void*,void*);void*f2;struct _RegionHandle*f3;}
...
_tmpFE=_tmpFD.f1;_tmpFF=_tmpFD.f2;_tmp100=_tmpFD.f3;return _tmpFE(_tmpFF,x,y)?Cyc_Dict_insert(
...
struct _tuple9*env,void*x,void*y){struct _tuple9 _tmp104;int(*_tmp105)(void*,void*);
void*_tmp106;struct _tuple9*_tmp103=env;_tmp104=*_tmp103;_tmp105=_tmp104.f1;
_tmp106=_tmp104.f2;return _tmp105(_tmp106,x)!= 0;}struct Cyc_Dict_Dict*Cyc_Dict_rdelete(
struct _RegionHandle*r2,struct Cyc_Dict_Dict*d,void*x){if(!Cyc_Dict_member(d,x))
return Cyc_Dict_rcopy(r2,d);{struct _tuple9 _tmp107=({struct _tuple9 _tmp108;_tmp108.f1=
d->rel;_tmp108.f2=x;_tmp108;});return((struct Cyc_Dict_Dict*(*)(struct
_RegionHandle*r2,int(*f)(struct _tuple9*,void*,void*),struct _tuple9*f_env,struct
Cyc_Dict_Dict*d))Cyc_Dict_rfilter_c)(r2,Cyc_Dict_delete_f,& _tmp107,d);}}struct
Cyc_Dict_Dict*Cyc_Dict_rdelete_same(struct Cyc_Dict_Dict*d,void*x){if(!Cyc_Dict_member(
d,x))return d;{struct _tuple9 _tmp109=({struct _tuple9 _tmp10A;_tmp10A.f1=d->rel;
_tmp10A.f2=x;_tmp10A;});return((struct Cyc_Dict_Dict*(*)(struct _RegionHandle*r2,
...
struct Cyc_Std___cycFILE*),void*(*read_val)(void**,struct Cyc_Std___cycFILE*),
struct Cyc_Std___cycFILE*fp){struct Cyc_Dict_Dict*dict=Cyc_Dict_empty(cmp);int len=
Cyc_Std_getw(fp);if(len == - 1)(int)_throw((void*)({struct Cyc_Core_Failure_struct*
_tmp11C=_cycalloc(sizeof(*_tmp11C));_tmp11C[0]=({struct Cyc_Core_Failure_struct
_tmp11D;_tmp11D.tag=Cyc_Core_Failure;_tmp11D.f1=_tag_arr("Dict::unmarshal: list length is -1",
sizeof(char),35);_tmp11D;});_tmp11C;}));{int i=0;for(0;i < len;i ++){void*key=
