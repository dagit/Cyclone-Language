...
_tmpD));_tmpD->v=(void*)(_tmpB->key_val).f2;_tmpD;});}}}return 0;}void**Cyc_Dict_rlookup_opt(
struct _RegionHandle*r,struct Cyc_Dict_Dict*d,void*key){int(*_tmpE)(void*,void*)=d->rel;
struct Cyc_Dict_T*_tmpF=d->t;while(_tmpF != 0){int _tmp10=_tmpE(key,(_tmpF->key_val).f1);
if(_tmp10 < 0){_tmpF=_tmpF->left;}else{if(_tmp10 > 0){_tmpF=_tmpF->right;}else{
return({void**_tmp11=_region_malloc(r,sizeof(*_tmp11));_tmp11[0]=(_tmpF->key_val).f2;
_tmp11;});}}}return 0;}int Cyc_Dict_lookup_bool(struct Cyc_Dict_Dict*d,void*key,
void**ans_place){int(*_tmp12)(void*,void*)=d->rel;struct Cyc_Dict_T*_tmp13=d->t;
while(_tmp13 != 0){int _tmp14=_tmp12(key,(_tmp13->key_val).f1);if(_tmp14 < 0){
_tmp13=_tmp13->left;}else{if(_tmp14 > 0){_tmp13=_tmp13->right;}else{*ans_place=(
_tmp13->key_val).f2;return 1;}}}return 0;}struct _tuple1{void*f1;struct Cyc_Dict_T*
f2;struct Cyc_Dict_T*f3;struct _tuple0 f4;};static struct Cyc_Dict_T*Cyc_Dict_balance(
struct _RegionHandle*r,struct _tuple1 quad){struct _tuple1 _tmp15=quad;struct _tuple0
_tmp16;struct Cyc_Dict_T*_tmp17;struct Cyc_Dict_T*_tmp18;struct Cyc_Dict_T _tmp19;
struct _tuple0 _tmp1A;struct Cyc_Dict_T*_tmp1B;struct Cyc_Dict_T*_tmp1C;struct Cyc_Dict_T
_tmp1D;struct _tuple0 _tmp1E;struct Cyc_Dict_T*_tmp1F;struct Cyc_Dict_T*_tmp20;void*
_tmp21;void*_tmp22;void*_tmp23;struct _tuple0 _tmp24;struct Cyc_Dict_T*_tmp25;
struct Cyc_Dict_T*_tmp26;struct Cyc_Dict_T _tmp27;struct _tuple0 _tmp28;struct Cyc_Dict_T*
_tmp29;struct Cyc_Dict_T _tmp2A;struct _tuple0 _tmp2B;struct Cyc_Dict_T*_tmp2C;struct
Cyc_Dict_T*_tmp2D;void*_tmp2E;struct Cyc_Dict_T*_tmp2F;void*_tmp30;void*_tmp31;
struct _tuple0 _tmp32;struct Cyc_Dict_T*_tmp33;struct Cyc_Dict_T _tmp34;struct _tuple0
_tmp35;struct Cyc_Dict_T*_tmp36;struct Cyc_Dict_T*_tmp37;struct Cyc_Dict_T _tmp38;
struct _tuple0 _tmp39;struct Cyc_Dict_T*_tmp3A;struct Cyc_Dict_T*_tmp3B;void*_tmp3C;
void*_tmp3D;struct Cyc_Dict_T*_tmp3E;void*_tmp3F;struct _tuple0 _tmp40;struct Cyc_Dict_T*
_tmp41;struct Cyc_Dict_T _tmp42;struct _tuple0 _tmp43;struct Cyc_Dict_T*_tmp44;struct
Cyc_Dict_T _tmp45;struct _tuple0 _tmp46;struct Cyc_Dict_T*_tmp47;struct Cyc_Dict_T*
_tmp48;void*_tmp49;struct Cyc_Dict_T*_tmp4A;void*_tmp4B;struct Cyc_Dict_T*_tmp4C;
void*_tmp4D;struct _tuple0 _tmp4E;struct Cyc_Dict_T*_tmp4F;struct Cyc_Dict_T*_tmp50;
void*_tmp51;_LL1: _LL16: _tmp23=_tmp15.f1;if((int)_tmp23 == 1){goto _LLD;}else{goto
_LL3;}_LLD: _tmp18=_tmp15.f2;if(_tmp18 == 0){goto _LL3;}else{_tmp19=*_tmp18;_LL15:
_tmp22=(void*)_tmp19.color;if((int)_tmp22 == 0){goto _LL10;}else{goto _LL3;}_LL10:
_tmp1C=_tmp19.left;if(_tmp1C == 0){goto _LL3;}else{_tmp1D=*_tmp1C;_LL14: _tmp21=(
void*)_tmp1D.color;if((int)_tmp21 == 0){goto _LL13;}else{goto _LL3;}_LL13: _tmp20=
_tmp1D.left;goto _LL12;_LL12: _tmp1F=_tmp1D.right;goto _LL11;_LL11: _tmp1E=_tmp1D.key_val;
goto _LLF;}_LLF: _tmp1B=_tmp19.right;goto _LLE;_LLE: _tmp1A=_tmp19.key_val;goto _LLC;}
_LLC: _tmp17=_tmp15.f3;goto _LLB;_LLB: _tmp16=_tmp15.f4;goto _LL2;_LL3: _LL22: _tmp31=
_tmp15.f1;if((int)_tmp31 == 1){goto _LL19;}else{goto _LL5;}_LL19: _tmp26=_tmp15.f2;
if(_tmp26 == 0){goto _LL5;}else{_tmp27=*_tmp26;_LL21: _tmp30=(void*)_tmp27.color;
if((int)_tmp30 == 0){goto _LL20;}else{goto _LL5;}_LL20: _tmp2F=_tmp27.left;goto _LL1B;
_LL1B: _tmp29=_tmp27.right;if(_tmp29 == 0){goto _LL5;}else{_tmp2A=*_tmp29;_LL1F:
_tmp2E=(void*)_tmp2A.color;if((int)_tmp2E == 0){goto _LL1E;}else{goto _LL5;}_LL1E:
_tmp2D=_tmp2A.left;goto _LL1D;_LL1D: _tmp2C=_tmp2A.right;goto _LL1C;_LL1C: _tmp2B=
_tmp2A.key_val;goto _LL1A;}_LL1A: _tmp28=_tmp27.key_val;goto _LL18;}_LL18: _tmp25=
_tmp15.f3;goto _LL17;_LL17: _tmp24=_tmp15.f4;goto _LL4;_LL5: _LL2E: _tmp3F=_tmp15.f1;
if((int)_tmp3F == 1){goto _LL2D;}else{goto _LL7;}_LL2D: _tmp3E=_tmp15.f2;goto _LL24;
_LL24: _tmp33=_tmp15.f3;if(_tmp33 == 0){goto _LL7;}else{_tmp34=*_tmp33;_LL2C: _tmp3D=(
void*)_tmp34.color;if((int)_tmp3D == 0){goto _LL27;}else{goto _LL7;}_LL27: _tmp37=
_tmp34.left;if(_tmp37 == 0){goto _LL7;}else{_tmp38=*_tmp37;_LL2B: _tmp3C=(void*)
_tmp38.color;if((int)_tmp3C == 0){goto _LL2A;}else{goto _LL7;}_LL2A: _tmp3B=_tmp38.left;
goto _LL29;_LL29: _tmp3A=_tmp38.right;goto _LL28;_LL28: _tmp39=_tmp38.key_val;goto
_LL26;}_LL26: _tmp36=_tmp34.right;goto _LL25;_LL25: _tmp35=_tmp34.key_val;goto _LL23;}
_LL23: _tmp32=_tmp15.f4;goto _LL6;_LL7: _LL3A: _tmp4D=_tmp15.f1;if((int)_tmp4D == 1){
goto _LL39;}else{goto _LL9;}_LL39: _tmp4C=_tmp15.f2;goto _LL30;_LL30: _tmp41=_tmp15.f3;
if(_tmp41 == 0){goto _LL9;}else{_tmp42=*_tmp41;_LL38: _tmp4B=(void*)_tmp42.color;
if((int)_tmp4B == 0){goto _LL37;}else{goto _LL9;}_LL37: _tmp4A=_tmp42.left;goto _LL32;
_LL32: _tmp44=_tmp42.right;if(_tmp44 == 0){goto _LL9;}else{_tmp45=*_tmp44;_LL36:
_tmp49=(void*)_tmp45.color;if((int)_tmp49 == 0){goto _LL35;}else{goto _LL9;}_LL35:
_tmp48=_tmp45.left;goto _LL34;_LL34: _tmp47=_tmp45.right;goto _LL33;_LL33: _tmp46=
_tmp45.key_val;goto _LL31;}_LL31: _tmp43=_tmp42.key_val;goto _LL2F;}_LL2F: _tmp40=
_tmp15.f4;goto _LL8;_LL9: _LL3E: _tmp51=_tmp15.f1;goto _LL3D;_LL3D: _tmp50=_tmp15.f2;
goto _LL3C;_LL3C: _tmp4F=_tmp15.f3;goto _LL3B;_LL3B: _tmp4E=_tmp15.f4;goto _LLA;_LL2:
return({struct Cyc_Dict_T*_tmp52=_region_malloc(r,sizeof(*_tmp52));_tmp52->color=(
void*)((void*)0);_tmp52->left=({struct Cyc_Dict_T*_tmp54=_region_malloc(r,sizeof(*
_tmp54));_tmp54->color=(void*)((void*)1);_tmp54->left=_tmp20;_tmp54->right=
_tmp1F;_tmp54->key_val=_tmp1E;_tmp54;});_tmp52->right=({struct Cyc_Dict_T*_tmp53=
_region_malloc(r,sizeof(*_tmp53));_tmp53->color=(void*)((void*)1);_tmp53->left=
_tmp1B;_tmp53->right=_tmp17;_tmp53->key_val=_tmp16;_tmp53;});_tmp52->key_val=
_tmp1A;_tmp52;});_LL4: return({struct Cyc_Dict_T*_tmp55=_region_malloc(r,sizeof(*
_tmp55));_tmp55->color=(void*)((void*)0);_tmp55->left=({struct Cyc_Dict_T*_tmp57=
_region_malloc(r,sizeof(*_tmp57));_tmp57->color=(void*)((void*)1);_tmp57->left=
_tmp2F;_tmp57->right=_tmp2D;_tmp57->key_val=_tmp28;_tmp57;});_tmp55->right=({
struct Cyc_Dict_T*_tmp56=_region_malloc(r,sizeof(*_tmp56));_tmp56->color=(void*)((
void*)1);_tmp56->left=_tmp2C;_tmp56->right=_tmp25;_tmp56->key_val=_tmp24;_tmp56;});
_tmp55->key_val=_tmp2B;_tmp55;});_LL6: return({struct Cyc_Dict_T*_tmp58=
_region_malloc(r,sizeof(*_tmp58));_tmp58->color=(void*)((void*)0);_tmp58->left=({
struct Cyc_Dict_T*_tmp5A=_region_malloc(r,sizeof(*_tmp5A));_tmp5A->color=(void*)((
void*)1);_tmp5A->left=_tmp3E;_tmp5A->right=_tmp3B;_tmp5A->key_val=_tmp32;_tmp5A;});
_tmp58->right=({struct Cyc_Dict_T*_tmp59=_region_malloc(r,sizeof(*_tmp59));_tmp59->color=(
void*)((void*)1);_tmp59->left=_tmp3A;_tmp59->right=_tmp36;_tmp59->key_val=_tmp35;
_tmp59;});_tmp58->key_val=_tmp39;_tmp58;});_LL8: return({struct Cyc_Dict_T*_tmp5B=
...
void*)1);_tmp5D->left=_tmp4C;_tmp5D->right=_tmp4A;_tmp5D->key_val=_tmp40;_tmp5D;});
...
_region_malloc(r,sizeof(*_tmp5E));_tmp5E->color=(void*)_tmp51;_tmp5E->left=
...
sizeof(*_tmp65));_tmp65->color=(void*)((void*)0);_tmp65->left=0;_tmp65->right=0;
_tmp65->key_val=key_val;_tmp65;});_LL43: {int _tmp66=rel(key_val.f1,_tmp61.f1);
...
r,sizeof(*_tmp69));_tmp69->color=(void*)_tmp64;_tmp69->left=_tmp63;_tmp69->right=
_tmp62;_tmp69->key_val=key_val;_tmp69;});}}}_LL3F:;}struct Cyc_Dict_Dict*Cyc_Dict_insert(
struct Cyc_Dict_Dict*d,void*key,void*data){struct Cyc_Dict_T*_tmp6A=Cyc_Dict_ins(d->r,
d->rel,({struct _tuple0 _tmp6C;_tmp6C.f1=key;_tmp6C.f2=data;_tmp6C;}),d->t);(void*)(((
struct Cyc_Dict_T*)_check_null(_tmp6A))->color=(void*)((void*)1));return({struct
Cyc_Dict_Dict*_tmp6B=_region_malloc(d->r,sizeof(*_tmp6B));_tmp6B->rel=d->rel;
_tmp6B->r=d->r;_tmp6B->t=_tmp6A;_tmp6B;});}struct Cyc_Dict_Dict*Cyc_Dict_insert_new(
struct Cyc_Dict_Dict*d,void*key,void*data){if(Cyc_Dict_member(d,key)){(int)_throw((
void*)Cyc_Dict_Absent);}return Cyc_Dict_insert(d,key,data);}struct Cyc_Dict_Dict*
Cyc_Dict_inserts(struct Cyc_Dict_Dict*d,struct Cyc_List_List*kds){for(0;kds != 0;
kds=kds->tl){d=Cyc_Dict_insert(d,(((struct _tuple0*)kds->hd)[
...
Cyc_Dict_T*_tmpB2=_region_malloc(r2,sizeof(*_tmpB2));_tmpB2->color=(void*)_tmpAF;
_tmpB2->left=_tmpB0;_tmpB2->right=_tmpB1;_tmpB2->key_val=_tmpAC;_tmpB2;});}}}
struct Cyc_Dict_Dict*Cyc_Dict_rcopy(struct _RegionHandle*r2,struct Cyc_Dict_Dict*d){
return({struct Cyc_Dict_Dict*_tmpB3=_region_malloc(r2,sizeof(*_tmpB3));_tmpB3->rel=
d->rel;_tmpB3->r=r2;_tmpB3->t=Cyc_Dict_copy_tree(r2,d->t);_tmpB3;});}struct Cyc_Dict_Dict*
...
struct Cyc_Dict_T*t){struct Cyc_Dict_T _tmpB5;struct _tuple0 _tmpB6;void*_tmpB7;void*
_tmpB8;struct Cyc_Dict_T*_tmpB9;struct Cyc_Dict_T*_tmpBA;void*_tmpBB;struct Cyc_Dict_T*
_tmpB4=t;_tmpB5=*_tmpB4;_LL82: _tmpBB=(void*)_tmpB5.color;goto _LL81;_LL81: _tmpBA=
_tmpB5.left;goto _LL80;_LL80: _tmpB9=_tmpB5.right;goto _LL7D;_LL7D: _tmpB6=_tmpB5.key_val;
_LL7F: _tmpB8=_tmpB6.f1;goto _LL7E;_LL7E: _tmpB7=_tmpB6.f2;goto _LL7C;_LL7C: {struct
Cyc_Dict_T*_tmpBC=_tmpBA == 0? 0: Cyc_Dict_map_tree(r,f,(struct Cyc_Dict_T*)
_check_null(_tmpBA));void*_tmpBD=f(_tmpB7);struct Cyc_Dict_T*_tmpBE=_tmpB9 == 0? 0:
Cyc_Dict_map_tree(r,f,(struct Cyc_Dict_T*)_check_null(_tmpB9));return({struct Cyc_Dict_T*
_tmpBF=_region_malloc(r,sizeof(*_tmpBF));_tmpBF->color=(void*)_tmpBB;_tmpBF->left=
_tmpBC;_tmpBF->right=_tmpBE;_tmpBF->key_val=({struct _tuple0 _tmpC0;_tmpC0.f1=
_tmpB8;_tmpC0.f2=_tmpBD;_tmpC0;});_tmpBF;});}}struct Cyc_Dict_Dict*Cyc_Dict_rmap(
struct _RegionHandle*r,void*(*f)(void*),struct Cyc_Dict_Dict*d){if(d->t == 0){
return({struct Cyc_Dict_Dict*_tmpC1=_region_malloc(r,sizeof(*_tmpC1));_tmpC1->rel=
...
void*,void*),void*env,struct Cyc_Dict_T*t){struct Cyc_Dict_T _tmpC4;struct _tuple0
_tmpC5;void*_tmpC6;void*_tmpC7;struct Cyc_Dict_T*_tmpC8;struct Cyc_Dict_T*_tmpC9;
void*_tmpCA;struct Cyc_Dict_T*_tmpC3=t;_tmpC4=*_tmpC3;_LL89: _tmpCA=(void*)_tmpC4.color;
goto _LL88;_LL88: _tmpC9=_tmpC4.left;goto _LL87;_LL87: _tmpC8=_tmpC4.right;goto _LL84;
...
_tmpC8));return({struct Cyc_Dict_T*_tmpCE=_region_malloc(r,sizeof(*_tmpCE));
...
_tmpD2=_region_malloc(r,sizeof(*_tmpD2));_tmpD2->f1=(((struct Cyc_Dict_T*)
...
env,struct Cyc_Dict_Dict*d1,struct Cyc_Dict_Dict*d2){if(d1 == d2? 1: d2->t == 0){
