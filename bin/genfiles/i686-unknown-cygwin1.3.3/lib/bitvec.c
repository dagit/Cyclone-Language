...
unsigned char Cyc_Dict_Present[12];extern unsigned char Cyc_Dict_Absent[11];void*
Cyc_Dict_lookup(struct Cyc_Dict_Dict*d,void*k);struct _tuple0{void*f1;void*f2;};
