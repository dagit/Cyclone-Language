...
_tagged_arr assertion,struct _tagged_arr file,unsigned int line);struct Cyc_Cstdio___abstractFILE;
...
};struct Cyc_Std_FloatPtr_sa_struct{int tag;float*f1;};void*Cyc_Std___assert_fail(
