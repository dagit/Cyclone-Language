...
unsigned char*tag;struct _tagged_arr f1;};extern void*Cyc_Std___assert_fail(struct
_tagged_arr assertion,struct _tagged_arr file,unsigned int line);struct Cyc_Cstdio___sFILE;
struct Cyc_Std___sFILE;extern struct Cyc_Std___sFILE*Cyc_Std_stderr;extern int Cyc_Std_fflush(
...
float*f1;};void*Cyc_Std___assert_fail(struct _tagged_arr assertion,struct
_tagged_arr file,unsigned int line){({struct Cyc_Std_String_pa_struct _tmp3;_tmp3.tag=
Cyc_Std_String_pa;_tmp3.f1=(struct _tagged_arr)assertion;{struct Cyc_Std_Int_pa_struct
_tmp2;_tmp2.tag=Cyc_Std_Int_pa;_tmp2.f1=line;{struct Cyc_Std_String_pa_struct
_tmp1;_tmp1.tag=Cyc_Std_String_pa;_tmp1.f1=(struct _tagged_arr)file;{void*_tmp0[3]={&
_tmp1,& _tmp2,& _tmp3};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("%s:%u: Assertion `%s' failed.\n",
sizeof(unsigned char),31),_tag_arr(_tmp0,sizeof(void*),3));}}}});Cyc_Std_fflush((
struct Cyc_Std___sFILE*)Cyc_Std_stderr);exit(- 1);}
