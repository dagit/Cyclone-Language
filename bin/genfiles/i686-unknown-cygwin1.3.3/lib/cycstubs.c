...
Cyc_Std_creat(struct _tagged_arr,int);int fcntl(int fd,int cmd);int fcntl_with_arg(
int fd,int cmd,int arg);int fcntl_with_lock(int fd,int cmd,struct Cyc_Std_flock*lock);
int creat(char*,int);int open_without_mode(char*,int);int open_with_mode(char*,int,
...
_tmp1.f1=_tag_arr("fcntl: too many args",sizeof(char),21);_tmp1;});_tmp0;}));
else{void*_tmp2=*((void**)_check_unknown_subscript(argv,sizeof(void*),0));int
_tmp3;struct Cyc_Std_flock*_tmp4;_LL1: if(*((int*)_tmp2)!= 1)goto _LL3;_tmp3=((
struct Cyc_Std_Long_struct*)_tmp2)->f1;_LL2: return fcntl_with_arg(fd,cmd,_tmp3);
_LL3: if(*((int*)_tmp2)!= 0)goto _LL0;_tmp4=((struct Cyc_Std_Flock_struct*)_tmp2)->f1;
_LL4: return fcntl_with_lock(fd,cmd,(struct Cyc_Std_flock*)_tmp4);_LL0:;}}}int Cyc_Std_creat(
