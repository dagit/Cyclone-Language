...
int Cyc_fgetpos(struct Cyc___cycFILE*,int*);struct _tagged_arr Cyc_fgets(struct
_tagged_arr,int,struct Cyc___cycFILE*);int Cyc_fileno(struct Cyc___cycFILE*);struct
Cyc___cycFILE*Cyc_fopen(const char*,const char*);int Cyc_fputc(int,struct Cyc___cycFILE*);
