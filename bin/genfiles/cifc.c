...
return;}
# 141
{struct _tuple11 _tmp30=({struct _tuple11 _tmp73;_tmp73.f1=cd->impl,_tmp73.f2=ud->impl;_tmp73;});struct _tuple11 _stmttmp2=_tmp30;struct _tuple11 _tmp31=_stmttmp2;int _tmp38;struct Cyc_List_List*_tmp37;struct Cyc_List_List*_tmp36;struct Cyc_List_List*_tmp35;struct Cyc_List_List*_tmp34;struct Cyc_List_List**_tmp33;struct Cyc_List_List**_tmp32;if(_tmp31.f1 != 0){if(_tmp31.f2 != 0){_LL13: _tmp32=(struct Cyc_List_List**)&(_tmp31.f1)->exist_vars;_tmp33=(struct Cyc_List_List**)&(_tmp31.f1)->rgn_po;_tmp34=(_tmp31.f1)->fields;_tmp35=(_tmp31.f2)->exist_vars;_tmp36=(_tmp31.f2)->rgn_po;_tmp37=(_tmp31.f2)->fields;_tmp38=(_tmp31.f2)->tagged;_LL14: {struct Cyc_List_List**tvarsC=_tmp32;struct Cyc_List_List**rgnpoC=_tmp33;struct Cyc_List_List*cfields=_tmp34;struct Cyc_List_List*tvars=_tmp35;struct Cyc_List_List*rgnpo=_tmp36;struct Cyc_List_List*ufields=_tmp37;int tagged=_tmp38;
# 144
if(tagged){
