...
# 95
extern struct Cyc___cycFILE*Cyc_stderr;struct  __abstractFILE;struct Cyc_String_pa_PrintArg_struct{int tag;struct _dyneither_ptr f1;};struct Cyc_Int_pa_PrintArg_struct{int tag;unsigned long f1;};struct Cyc_Double_pa_PrintArg_struct{int tag;double f1;};struct Cyc_LongDouble_pa_PrintArg_struct{int tag;long double f1;};struct Cyc_ShortPtr_pa_PrintArg_struct{int tag;short*f1;};struct Cyc_IntPtr_pa_PrintArg_struct{int tag;unsigned long*f1;};
# 117
...
# 38 "string.h"
unsigned int Cyc_strlen(struct _dyneither_ptr s);
# 49 "string.h"
int Cyc_strcmp(struct _dyneither_ptr s1,struct _dyneither_ptr s2);
int Cyc_strptrcmp(struct _dyneither_ptr*s1,struct _dyneither_ptr*s2);
int Cyc_strncmp(struct _dyneither_ptr s1,struct _dyneither_ptr s2,unsigned int len);
# 62
...
Cyc_Specsfile_btarget=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2;_tmp2.tag=0;_tmp2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s);({void*_tmp0[1]={& _tmp2};Cyc_aprintf(({const char*_tmp1="-b %s";_tag_dyneither(_tmp1,sizeof(char),6);}),_tag_dyneither(_tmp0,sizeof(void*),1));});});}
# 45
struct Cyc_List_List*Cyc_Specsfile_cyclone_exec_path=0;
void Cyc_Specsfile_add_cyclone_exec_path(struct _dyneither_ptr s){
unsigned int _tmp3=Cyc_strlen((struct _dyneither_ptr)s);
if(_tmp3 <= 2)return;{
struct _dyneither_ptr _tmp4=(struct _dyneither_ptr)Cyc_substring((struct _dyneither_ptr)s,2,_tmp3 - 2);
Cyc_Specsfile_cyclone_exec_path=({struct Cyc_List_List*_tmp5=_cycalloc(sizeof(*_tmp5));_tmp5->hd=({struct _dyneither_ptr*_tmp6=_cycalloc(sizeof(*_tmp6));_tmp6[0]=_tmp4;_tmp6;});_tmp5->tl=Cyc_Specsfile_cyclone_exec_path;_tmp5;});};}struct _tuple0{struct _dyneither_ptr*f1;struct _dyneither_ptr*f2;};
# 59
struct Cyc_List_List*Cyc_Specsfile_read_specs(struct _dyneither_ptr file){
...
# 67
if(spec_file == 0){
({struct Cyc_String_pa_PrintArg_struct _tmpA;_tmpA.tag=0;_tmpA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)file);({void*_tmp8[1]={& _tmpA};Cyc_fprintf(Cyc_stderr,({const char*_tmp9="Error opening spec file %s\n";_tag_dyneither(_tmp9,sizeof(char),28);}),_tag_dyneither(_tmp8,sizeof(void*),1));});});
...
c=Cyc_fgetc(spec_file);
if(c == - 1){
({struct Cyc_String_pa_PrintArg_struct _tmp11;_tmp11.tag=0;_tmp11.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)file);({void*_tmpF[1]={& _tmp11};Cyc_fprintf(Cyc_stderr,({const char*_tmp10="Error reading spec file %s: unexpected EOF\n";_tag_dyneither(_tmp10,sizeof(char),44);}),_tag_dyneither(_tmpF,sizeof(void*),1));});});
# 94
Cyc_fflush(Cyc_stderr);
goto CLEANUP_AND_RETURN;}
# 97
...
++ i;
if(i >= 256){
({struct Cyc_String_pa_PrintArg_struct _tmp14;_tmp14.tag=0;_tmp14.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)file);({void*_tmp12[1]={& _tmp14};Cyc_fprintf(Cyc_stderr,({const char*_tmp13="Error reading spec file %s: string name too long\n";_tag_dyneither(_tmp13,sizeof(char),50);}),_tag_dyneither(_tmp12,sizeof(void*),1));});});
# 107
Cyc_fflush(Cyc_stderr);
goto CLEANUP_AND_RETURN;}}
# 111
...
if(c == '*'){
# 118
_tmp7=({struct Cyc_List_List*_tmp15=_cycalloc(sizeof(*_tmp15));_tmp15->hd=({struct _tuple0*_tmp16=_cycalloc(sizeof(*_tmp16));_tmp16->f1=({struct _dyneither_ptr*_tmp19=_cycalloc(sizeof(*_tmp19));_tmp19[0]=(struct _dyneither_ptr)Cyc_strdup(_tag_dyneither(strname,sizeof(char),256));_tmp19;});_tmp16->f2=({struct _dyneither_ptr*_tmp17=_cycalloc(sizeof(*_tmp17));_tmp17[0]=(struct _dyneither_ptr)
Cyc_strdup(({const char*_tmp18="";_tag_dyneither(_tmp18,sizeof(char),1);}));_tmp17;});_tmp16;});_tmp15->tl=_tmp7;_tmp15;});
...
++ i;
if(i >= 4096){
({struct Cyc_String_pa_PrintArg_struct _tmp1D;_tmp1D.tag=0;_tmp1D.f1=(struct _dyneither_ptr)
# 133
_tag_dyneither(strname,sizeof(char),256);({struct Cyc_String_pa_PrintArg_struct _tmp1C;_tmp1C.tag=0;_tmp1C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)file);({void*_tmp1A[2]={& _tmp1C,& _tmp1D};Cyc_fprintf(Cyc_stderr,({const char*_tmp1B="Error reading spec file %s: value of %s too long\n";_tag_dyneither(_tmp1B,sizeof(char),50);}),_tag_dyneither(_tmp1A,sizeof(void*),2));});});});
Cyc_fflush(Cyc_stderr);
goto CLEANUP_AND_RETURN;}}
# 139
_tmp7=({struct Cyc_List_List*_tmp1E=_cycalloc(sizeof(*_tmp1E));_tmp1E->hd=({struct _tuple0*_tmp1F=_cycalloc(sizeof(*_tmp1F));_tmp1F->f1=({struct _dyneither_ptr*_tmp21=_cycalloc(sizeof(*_tmp21));_tmp21[0]=(struct _dyneither_ptr)Cyc_strdup(_tag_dyneither(strname,sizeof(char),256));_tmp21;});_tmp1F->f2=({struct _dyneither_ptr*_tmp20=_cycalloc(sizeof(*_tmp20));_tmp20[0]=(struct _dyneither_ptr)
Cyc_strdup(_tag_dyneither(strvalue,sizeof(char),4096));_tmp20;});_tmp1F;});_tmp1E->tl=_tmp7;_tmp1E;});
...
unsigned int _tmp22=Cyc_strlen((struct _dyneither_ptr)cmdline);
...
# 192
_tmp23=({struct Cyc_List_List*_tmp24=_cycalloc(sizeof(*_tmp24));_tmp24->hd=({struct _dyneither_ptr*_tmp25=_cycalloc(sizeof(*_tmp25));_tmp25[0]=(struct _dyneither_ptr)Cyc_strdup(_tag_dyneither(buf,sizeof(char),4096));_tmp25;});_tmp24->tl=_tmp23;_tmp24;});}
# 194
DONE:
 _tmp23=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp23);
_tmp23=({struct Cyc_List_List*_tmp26=_cycalloc(sizeof(*_tmp26));_tmp26->hd=_init_dyneither_ptr(_cycalloc(sizeof(struct _dyneither_ptr)),"",sizeof(char),1);_tmp26->tl=_tmp23;_tmp26;});{
...
_tmp34=({struct Cyc_List_List*_tmp35=_cycalloc(sizeof(*_tmp35));_tmp35->hd=(struct _dyneither_ptr*)dirs->hd;_tmp35->tl=_tmp34;_tmp35;});
_tmp34=({struct Cyc_List_List*_tmp36=_cycalloc(sizeof(*_tmp36));_tmp36->hd=({struct _dyneither_ptr*_tmp37=_cycalloc(sizeof(*_tmp37));_tmp37[0]=(struct _dyneither_ptr)Cyc_Filename_concat(*((struct _dyneither_ptr*)dirs->hd),subdir);_tmp37;});_tmp36->tl=_tmp34;_tmp36;});}
# 223
...
int i;int j;int k;
for(i=1;i < argc;++ i){
if(Cyc_strncmp(({const char*_tmp3A="-B";_tag_dyneither(_tmp3A,sizeof(char),3);}),(struct _dyneither_ptr)*((struct _dyneither_ptr*)_check_dyneither_subscript(argv,sizeof(struct _dyneither_ptr),i)),2)== 0){
*((int*)_check_dyneither_subscript(_tmp38,sizeof(int),i))=1;
++ _tmp39;}else{
# 255
if(Cyc_strcmp(({const char*_tmp3B="-b";_tag_dyneither(_tmp3B,sizeof(char),3);}),(struct _dyneither_ptr)*((struct _dyneither_ptr*)_check_dyneither_subscript(argv,sizeof(struct _dyneither_ptr),i)))== 0){
*((int*)_check_dyneither_subscript(_tmp38,sizeof(int),i))=1;
++ _tmp39;
++ i;if(i >= argc)break;
*((int*)_check_dyneither_subscript(_tmp38,sizeof(int),i))=1;
++ _tmp39;}}}{
# 267
struct _dyneither_ptr _tmp3C=({unsigned int _tmp4A=(unsigned int)(_tmp39 + 1);struct _dyneither_ptr*_tmp4B=(struct _dyneither_ptr*)_cycalloc(_check_times(sizeof(struct _dyneither_ptr),_tmp4A));struct _dyneither_ptr _tmp4D=_tag_dyneither(_tmp4B,sizeof(struct _dyneither_ptr),_tmp4A);{unsigned int _tmp4C=_tmp4A;unsigned int n;for(n=0;n < _tmp4C;n ++){_tmp4B[n]=(struct _dyneither_ptr)_tag_dyneither(0,0,0);}}_tmp4D;});
struct _dyneither_ptr _tmp3D=({unsigned int _tmp46=(unsigned int)(argc - _tmp39);struct _dyneither_ptr*_tmp47=(struct _dyneither_ptr*)_cycalloc(_check_times(sizeof(struct _dyneither_ptr),_tmp46));struct _dyneither_ptr _tmp49=_tag_dyneither(_tmp47,sizeof(struct _dyneither_ptr),_tmp46);{unsigned int _tmp48=_tmp46;unsigned int n;for(n=0;n < _tmp48;n ++){_tmp47[n]=(struct _dyneither_ptr)_tag_dyneither(0,0,0);}}_tmp49;});
*((struct _dyneither_ptr*)_check_dyneither_subscript(_tmp3C,sizeof(struct _dyneither_ptr),0))=(*((struct _dyneither_ptr*)_check_dyneither_subscript(_tmp3D,sizeof(struct _dyneither_ptr),0))=*((struct _dyneither_ptr*)_check_dyneither_subscript(argv,sizeof(struct _dyneither_ptr),0)));
for(i=(j=(k=1));i < argc;++ i){
if(*((int*)_check_dyneither_subscript(_tmp38,sizeof(int),i)))*((struct _dyneither_ptr*)_check_dyneither_subscript(_tmp3C,sizeof(struct _dyneither_ptr),j ++))=*((struct _dyneither_ptr*)_check_dyneither_subscript(argv,sizeof(struct _dyneither_ptr),i));else{
*((struct _dyneither_ptr*)_check_dyneither_subscript(_tmp3D,sizeof(struct _dyneither_ptr),k ++))=*((struct _dyneither_ptr*)_check_dyneither_subscript(argv,sizeof(struct _dyneither_ptr),i));}}
# 275
Cyc_Arg_current=0;
Cyc_Arg_parse(specs,anonfun,anonflagfun,errmsg,_tmp3C);
# 280
if((char*)Cyc_Specsfile_target_arch.curr == (char*)(_tag_dyneither(0,0,0)).curr)Cyc_Specsfile_target_arch=({char*_tmp3E= Carch;_tag_dyneither(_tmp3E,sizeof(char),_get_zero_arr_size_char((void*)_tmp3E,1));});{
# 289 "specsfile.cyc"
...
Cyc_Specsfile_cyclone_exec_path=({struct Cyc_List_List*_tmp3F=_cycalloc(sizeof(*_tmp3F));_tmp3F->hd=({struct _dyneither_ptr*_tmp40=_cycalloc(sizeof(*_tmp40));_tmp40[0]=cyclone_exec_prefix;_tmp40;});_tmp3F->tl=Cyc_Specsfile_cyclone_exec_path;_tmp3F;});
Cyc_Specsfile_def_lib_path=({char*_tmp41= Cdef_lib_path;_tag_dyneither(_tmp41,sizeof(char),_get_zero_arr_size_char((void*)_tmp41,1));});
if(Cyc_strlen((struct _dyneither_ptr)Cyc_Specsfile_def_lib_path)> 0)
Cyc_Specsfile_cyclone_exec_path=({struct Cyc_List_List*_tmp42=_cycalloc(sizeof(*_tmp42));_tmp42->hd=({struct _dyneither_ptr*_tmp43=_cycalloc(sizeof(*_tmp43));_tmp43[0]=(struct _dyneither_ptr)
Cyc_Filename_concat(Cyc_Specsfile_def_lib_path,({const char*_tmp44="cyc-lib";_tag_dyneither(_tmp44,sizeof(char),8);}));_tmp43;});_tmp42->tl=Cyc_Specsfile_cyclone_exec_path;_tmp42;});
# 297
...
{struct _handler_cons _tmp52;_push_handler(& _tmp52);{int _tmp54=0;if(setjmp(_tmp52.handler))_tmp54=1;if(!_tmp54){f=Cyc_file_open(file,({const char*_tmp55="r";_tag_dyneither(_tmp55,sizeof(char),2);}));;_pop_handler();}else{void*_tmp53=(void*)_exn_thrown;void*_tmp56=_tmp53;_LL6: _LL7: goto _LL5;_LL5:;}};}
...
if((char*)_tmp57.curr == (char*)(_tag_dyneither(0,0,0)).curr  || Cyc_strlen((struct _dyneither_ptr)_tmp57)== 0)continue;{
...
if((char*)_tmp59.curr == (char*)(_tag_dyneither(0,0,0)).curr  || Cyc_strlen((struct _dyneither_ptr)_tmp59)== 0)continue;
_tmp59=(struct _dyneither_ptr)Cyc_strconcat((struct _dyneither_ptr)_tmp59,({const char*_tmp5A=":";_tag_dyneither(_tmp5A,sizeof(char),2);}));
tmp=(struct _dyneither_ptr)Cyc_strconcat((struct _dyneither_ptr)_tmp59,(struct _dyneither_ptr)tmp);}
# 332
return tmp;}
# 335
...
Cyc_Specsfile_sprint_list(dirs));({struct Cyc_String_pa_PrintArg_struct _tmp5F;_tmp5F.tag=0;_tmp5F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)file);({void*_tmp5D[2]={& _tmp5F,& _tmp60};Cyc_fprintf(Cyc_stderr,({const char*_tmp5E="Error: can't find internal compiler file %s in path %s\n";_tag_dyneither(_tmp5E,sizeof(char),56);}),_tag_dyneither(_tmp5D,sizeof(void*),2));});});});
Cyc_fflush(Cyc_stderr);
