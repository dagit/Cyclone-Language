...
struct _fat_ptr ptrarray=({(struct _fat_ptr(*)(struct Cyc_List_List*))Cyc_List_to_array;})(l);
...
# 205
return _tag_fat(0,0,0);else{_Tmp4=_Tmp3;{void*exn=_Tmp4;(int)_rethrow(exn);}};}}}
# 209
...
{struct _handler_cons _Tmp0;_push_handler(& _Tmp0);{int _Tmp1=0;if(setjmp(_Tmp0.handler))_Tmp1=1;if(!_Tmp1){f=Cyc_file_open(file,({const char*_Tmp2="r";_tag_fat(_Tmp2,sizeof(char),2U);}));;_pop_handler();}else{void*_Tmp2=(void*)Cyc_Core_get_exn_thrown();void*_Tmp3=_Tmp2;goto _LL0;_LL0:;}}}
