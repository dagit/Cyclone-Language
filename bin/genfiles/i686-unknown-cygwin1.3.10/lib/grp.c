...
struct _dyneither_ptr gr_name;struct _dyneither_ptr gr_passwd;unsigned short gr_gid;
...
_dyneither_ptr user,unsigned short group);int Cyc_setgroups(struct _dyneither_ptr
...
Cyc_setgroups(struct _dyneither_ptr groups){return setgroups(_get_dyneither_size(
groups,sizeof(unsigned short)),(const unsigned short*)_check_null(
_untag_dyneither_ptr(groups,sizeof(unsigned short),1)));}
