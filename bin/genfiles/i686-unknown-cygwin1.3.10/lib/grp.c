...
_dyneither_ptr gr_name;struct _dyneither_ptr gr_passwd;unsigned short gr_gid;struct
_dyneither_ptr gr_mem;};struct Cyc_group*Cyc_getgrnam(struct _dyneither_ptr name);
struct Cyc_group*Cyc_getgrgid(unsigned short uid);int Cyc_initgroups(struct
