...
h_aliases;int h_addrtype;int h_length;struct Cyc_in_addr**h_addr_list;};enum Cyc___anonymous_enum_32__{
Cyc_IPPROTO_IP  = 0,Cyc_IPPROTO_ICMP  = 1,Cyc_IPPROTO_IGMP  = 2,Cyc_IPPROTO_IPIP  = 
4,Cyc_IPPROTO_TCP  = 6,Cyc_IPPROTO_EGP  = 8,Cyc_IPPROTO_PUP  = 12,Cyc_IPPROTO_UDP
 = 17,Cyc_IPPROTO_IDP  = 22,Cyc_IPPROTO_RAW  = 255,Cyc_IPPROTO_MAX  = 256};struct
Cyc_sockaddr_in{short sin_family;unsigned short sin_port;struct Cyc_in_addr sin_addr;
unsigned char __pad[((16 - sizeof(short))- sizeof(unsigned short))- sizeof(struct
Cyc_in_addr)];};struct Cyc_in6_addr{unsigned char s6_addr[16];};struct Cyc_sockaddr_in6{
unsigned short sin6_family;unsigned short sin6_port;unsigned long sin6_flowinfo;
struct Cyc_in6_addr sin6_addr;};struct Cyc_pollfd{int fd;short events;short revents;};
int Cyc_poll(struct _dynforward_ptr,unsigned int,int);int poll(struct Cyc_pollfd*,
unsigned int b,int c);static char _tmpA[22]="poll called with NULL";static struct Cyc_Core_Failure_struct
Cyc___poll_failure_1={Cyc_Core_Failure,{_tmpA,_tmpA + 22}};static char _tmpC[39]="poll called with out-of-bounds pointer";
static struct Cyc_Core_Failure_struct Cyc___poll_failure_2={Cyc_Core_Failure,{_tmpC,
_tmpC + 39}};int Cyc_poll(struct _dynforward_ptr a,unsigned int b,int c){if(!((
...
_untag_dynforward_ptr(a,sizeof(struct Cyc_pollfd),0),b < (unsigned int)len?b:(
...
a,_tmp20);_LLA:;}}struct Cyc___cycFILE;struct Cyc_Cstdio___abstractFILE;struct Cyc___cycFILE*
...
Cyc_popen(const char*name,const char*type){struct Cyc_Cstdio___abstractFILE*_tmp32=
popen(name,type);return(unsigned int)_tmp32?({struct Cyc___cycFILE*_tmp33=
...
_check_dynforward_subscript(fname,sizeof(char),(int)i));}_tmp3B[_tmp3C]=(char)0;}
...
_tmp3F,_tmp3F + 23}};static char _tmp41[42]="qsort called with insufficient array size";
...
_tuple0 _tmp44;_tmp44.f1=*((void**)_check_dynforward_subscript(ap,sizeof(void*),0));
_tmp44.f2=*((void**)_check_dynforward_subscript(ap,sizeof(void*),1));_tmp44;});
void*_tmp46;struct Cyc_sockaddr_in*_tmp47;void*_tmp48;int*_tmp49;_LL14: _tmp46=
...
_tmp4D;void*_tmp4E;int _tmp4F;_LL19: _tmp4C=_tmp4B.f1;if(*((int*)_tmp4C)!= 0)goto
_LL1B;_tmp4D=((struct Cyc_SA_sockaddr_in_struct*)_tmp4C)->f1;_tmp4E=_tmp4B.f2;if(*((
int*)_tmp4E)!= 2)goto _LL1B;_tmp4F=((struct Cyc_SA_socklen_struct*)_tmp4E)->f1;
_LL1A: return bind_in(fd,(const struct Cyc_sockaddr_in*)_tmp4D,_tmp4F);_LL1B:;_LL1C:(
int)_throw((void*)Cyc_SocketError);_LL18:;}}int connect_in(int,const struct Cyc_sockaddr_in*,
...
struct _tuple0 _tmp50;_tmp50.f1=*((void**)_check_dynforward_subscript(ap,sizeof(
void*),0));_tmp50.f2=*((void**)_check_dynforward_subscript(ap,sizeof(void*),1));
_tmp50;});void*_tmp52;struct Cyc_sockaddr_in*_tmp53;void*_tmp54;int _tmp55;_LL1E:
...
_check_dynforward_subscript(ap,sizeof(void*),0));_tmp56.f2=*((void**)
...
_check_dynforward_subscript(ap,sizeof(void*),0));_tmp5C.f2=*((void**)
_check_dynforward_subscript(ap,sizeof(void*),1));_tmp5C;});void*_tmp5E;struct Cyc_sockaddr_in*
...
struct _tuple0 _tmp62;_tmp62.f1=*((void**)_check_dynforward_subscript(ap,sizeof(
void*),0));_tmp62.f2=*((void**)_check_dynforward_subscript(ap,sizeof(void*),1));
...
void*)Cyc_SocketError);{struct _tuple0 _tmp75=({struct _tuple0 _tmp74;_tmp74.f1=*((
void**)_check_dynforward_subscript(ap,sizeof(void*),0));_tmp74.f2=*((void**)
_check_dynforward_subscript(ap,sizeof(void*),1));_tmp74;});void*_tmp76;struct Cyc_sockaddr_in*
...
void**)_check_dynforward_subscript(ap,sizeof(void*),0));_tmp7A.f2=*((void**)
_check_dynforward_subscript(ap,sizeof(void*),1));_tmp7A;});void*_tmp7C;struct Cyc_sockaddr_in*
...
_check_dynforward_subscript(ap,sizeof(void*),0));_tmp80.f2=*((void**)
_check_dynforward_subscript(ap,sizeof(void*),1));_tmp80;});void*_tmp82;int*
_tmp83;void*_tmp84;int _tmp85;void*_tmp86;struct Cyc_timeval*_tmp87;void*_tmp88;
int _tmp89;_LL42: _tmp82=_tmp81.f1;if(*((int*)_tmp82)!= 0)goto _LL44;_tmp83=((
struct Cyc_SO_int_struct*)_tmp82)->f1;_tmp84=_tmp81.f2;if(*((int*)_tmp84)!= 3)
goto _LL44;_tmp85=((struct Cyc_SO_socklen_struct*)_tmp84)->f1;_LL43: return
...
_tmp8B,_tmp8B + 27}};unsigned int Cyc_strftime(struct _dynforward_ptr s,unsigned int
...
_tmpA2 + 35}};long Cyc_read(int fd,struct _dynforward_ptr buf,unsigned int count){if(
...
count);}long write(int fd,const char*buf,unsigned int count);static char _tmpA4[36]="write: called with count > buf.size";
static struct Cyc_Core_Failure_struct Cyc___write_failure={Cyc_Core_Failure,{_tmpA4,
_tmpA4 + 36}};long Cyc_write(int fd,struct _dynforward_ptr buf,unsigned int count){if(
