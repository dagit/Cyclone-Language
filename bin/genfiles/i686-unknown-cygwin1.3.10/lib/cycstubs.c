...
unsigned int sin6_flowinfo;struct Cyc_in6_addr sin6_addr;};struct Cyc_pollfd{int fd;
short events;short revents;};int Cyc_poll(struct _tagged_arr,unsigned int,int);int
poll(struct Cyc_pollfd*,unsigned int b,int c);static char _tmpA[22]="poll called with NULL";
...
0),b < (unsigned int)len?b:(unsigned int)len,c);}}struct Cyc___SIG_BUILTIN_struct{
int tag;void*f1;};struct Cyc___SIG_HANDLER_struct{int tag;void(*f1)(int);};void*Cyc_Csignal_make_SIG_DFL(){
...
_tmp19.f1=f;_tmp19;});_tmp18;});}struct Cyc___cycFILE;struct Cyc_Cstdio___abstractFILE;
...
int*);struct _tagged_arr Cyc_fgets(struct _tagged_arr,int,struct Cyc___cycFILE*);int
Cyc_fileno(struct Cyc___cycFILE*);struct Cyc___cycFILE*Cyc_fopen(const char*,const
char*);int Cyc_fputc(int,struct Cyc___cycFILE*);int Cyc_fputs(const char*,struct Cyc___cycFILE*);
unsigned int Cyc_fread(struct _tagged_arr,unsigned int,unsigned int,struct Cyc___cycFILE*);
struct Cyc___cycFILE*Cyc_freopen(const char*,const char*,struct Cyc___cycFILE*);
...
const int*);int Cyc_ftell(struct Cyc___cycFILE*);unsigned int Cyc_fwrite(struct
_tagged_arr,unsigned int,unsigned int,struct Cyc___cycFILE*);int Cyc_getc(struct
Cyc___cycFILE*);int Cyc_getchar();int Cyc_pclose(struct Cyc___cycFILE*);struct Cyc___cycFILE*
Cyc_popen(const char*,const char*);int Cyc_putc(int,struct Cyc___cycFILE*);void Cyc_rewind(
struct Cyc___cycFILE*);int Cyc_setvbuf(struct Cyc___cycFILE*,struct _tagged_arr,int,
unsigned int);void Cyc_setbuf(struct Cyc___cycFILE*,struct _tagged_arr);int Cyc_ungetc(
int,struct Cyc___cycFILE*);int Cyc_getw(struct Cyc___cycFILE*);int Cyc_putw(int,
struct Cyc___cycFILE*);extern char Cyc_FileCloseError[19];extern char Cyc_FileOpenError[
18];struct Cyc_FileOpenError_struct{char*tag;struct _tagged_arr f1;};struct Cyc___cycFILE*
Cyc_file_open(struct _tagged_arr,struct _tagged_arr);void Cyc_file_close(struct Cyc___cycFILE*);
...
return(unsigned int)cf?({struct Cyc___cycFILE*_tmp1A=_cycalloc(sizeof(*_tmp1A));
_tmp1A->file=(struct Cyc_Cstdio___abstractFILE*)_check_null(cf);_tmp1A;}): 0;}void
clearerr(struct Cyc_Cstdio___abstractFILE*);void Cyc_clearerr(struct Cyc___cycFILE*
f){return clearerr(f->file);}int fclose(struct Cyc_Cstdio___abstractFILE*);int Cyc_fclose(
...
_check_null(_tmp1B);_tmp1C;}): 0;}int feof(struct Cyc_Cstdio___abstractFILE*);int
...
int*);int Cyc_fgetpos(struct Cyc___cycFILE*f,int*x){return fgetpos(f->file,x);}char*
fgets(char*,int,struct Cyc_Cstdio___abstractFILE*);static char _tmp1E[30]="fgets called with NULL string";
static struct Cyc_Core_Failure_struct Cyc___fgets_failure_1={Cyc_Core_Failure,{
_tmp1E,_tmp1E,_tmp1E + 30}};static char _tmp20[27]="fgets: buffer insufficient";
static struct Cyc_Core_Failure_struct Cyc___fgets_failure_2={Cyc_Core_Failure,{
_tmp20,_tmp20,_tmp20 + 27}};struct _tagged_arr Cyc_fgets(struct _tagged_arr s,int n,
...
return fileno(f->file);}struct Cyc_Cstdio___abstractFILE*fopen(const char*,const
char*);struct Cyc___cycFILE*Cyc_fopen(const char*name,const char*type){struct Cyc_Cstdio___abstractFILE*
_tmp21=fopen(name,type);return(unsigned int)_tmp21?({struct Cyc___cycFILE*_tmp22=
_cycalloc(sizeof(*_tmp22));_tmp22->file=(struct Cyc_Cstdio___abstractFILE*)
_check_null(_tmp21);_tmp22;}): 0;}int fputc(int,struct Cyc_Cstdio___abstractFILE*);
int Cyc_fputc(int x,struct Cyc___cycFILE*f){return fputc(x,f->file);}int fputs(const
char*,struct Cyc_Cstdio___abstractFILE*);int Cyc_fputs(const char*x,struct Cyc___cycFILE*
f){return fputs(x,f->file);}unsigned int fread(char*,unsigned int,unsigned int,
struct Cyc_Cstdio___abstractFILE*);static char _tmp24[27]="fread: buffer insufficient";
static struct Cyc_Core_Failure_struct Cyc___fread_failure={Cyc_Core_Failure,{_tmp24,
_tmp24,_tmp24 + 27}};unsigned int Cyc_fread(struct _tagged_arr ptr,unsigned int size,
unsigned int nmemb,struct Cyc___cycFILE*f){if(size * nmemb > _get_arr_size(ptr,
sizeof(char)))(int)_throw((void*)& Cyc___fread_failure);return fread((char*)
_check_null(_untag_arr(ptr,sizeof(char),1)),size,nmemb,f->file);}struct Cyc_Cstdio___abstractFILE*
freopen(const char*,const char*,struct Cyc_Cstdio___abstractFILE*);struct Cyc___cycFILE*
Cyc_freopen(const char*filename,const char*modes,struct Cyc___cycFILE*f){struct Cyc_Cstdio___abstractFILE*
...
_check_null(_tmp25);_tmp26;}): 0;}int fseek(struct Cyc_Cstdio___abstractFILE*,int,
int);int Cyc_fseek(struct Cyc___cycFILE*a,int b,int c){return fseek(a->file,b,c);}int
fsetpos(struct Cyc_Cstdio___abstractFILE*,const int*);int Cyc_fsetpos(struct Cyc___cycFILE*
f,const int*b){return fsetpos(f->file,b);}int ftell(struct Cyc_Cstdio___abstractFILE*);
int Cyc_ftell(struct Cyc___cycFILE*f){return ftell(f->file);}unsigned int fwrite(
const char*,unsigned int,unsigned int,struct Cyc_Cstdio___abstractFILE*);static
char _tmp28[31]="fwrite called with NULL string";static struct Cyc_Core_Failure_struct
Cyc___fwrite_failure_1={Cyc_Core_Failure,{_tmp28,_tmp28,_tmp28 + 31}};static char
_tmp2A[28]="fwrite: buffer insufficient";static struct Cyc_Core_Failure_struct Cyc___fwrite_failure_2={
Cyc_Core_Failure,{_tmp2A,_tmp2A,_tmp2A + 28}};unsigned int Cyc_fwrite(struct
_tagged_arr ptr,unsigned int size,unsigned int nmemb,struct Cyc___cycFILE*f){if(!((
unsigned int)ptr.curr))(int)_throw((void*)& Cyc___fwrite_failure_1);else{if(size * 
nmemb > _get_arr_size(ptr,sizeof(char)))(int)_throw((void*)& Cyc___fwrite_failure_2);
...
_tmp2B=popen(name,type);return(unsigned int)_tmp2B?({struct Cyc___cycFILE*_tmp2C=
_cycalloc(sizeof(*_tmp2C));_tmp2C->file=(struct Cyc_Cstdio___abstractFILE*)
_check_null(_tmp2B);_tmp2C;}): 0;}int putc(int,struct Cyc_Cstdio___abstractFILE*);
int Cyc_putc(int x,struct Cyc___cycFILE*f){return putc(x,f->file);}void rewind(struct
Cyc_Cstdio___abstractFILE*);void Cyc_rewind(struct Cyc___cycFILE*f){return rewind(f->file);}
int setvbuf(struct Cyc_Cstdio___abstractFILE*,char*,int,unsigned int);static char
_tmp2E[24]="setvbuf: buffer is NULL";static struct Cyc_Core_Failure_struct Cyc___setvbuf_failure_1={
Cyc_Core_Failure,{_tmp2E,_tmp2E,_tmp2E + 24}};static char _tmp30[29]="setvbuf: buffer insufficient";
static struct Cyc_Core_Failure_struct Cyc___setvbuf_failure_2={Cyc_Core_Failure,{
_tmp30,_tmp30,_tmp30 + 29}};int Cyc_setvbuf(struct Cyc___cycFILE*f,struct
...
f,struct _tagged_arr buf){Cyc_setvbuf(f,buf,(unsigned int)buf.curr?0: 2,1024);
...
_tmp3D.f1=*((void**)_check_unknown_subscript(ap,sizeof(void*),0));_tmp3D.f2=*((
void**)_check_unknown_subscript(ap,sizeof(void*),1));_tmp3D;});void*_tmp3F;
struct Cyc_sockaddr_in*_tmp40;void*_tmp41;int*_tmp42;_LLB: _tmp3F=_tmp3E.f1;if(*((
int*)_tmp3F)!= 0)goto _LLD;_tmp40=((struct Cyc_SA_sockaddr_in_struct*)_tmp3F)->f1;
_tmp41=_tmp3E.f2;if(*((int*)_tmp41)!= 1)goto _LLD;_tmp42=((struct Cyc_SA_socklenptr_struct*)
...
_tuple0 _tmp44=({struct _tuple0 _tmp43;_tmp43.f1=*((void**)_check_unknown_subscript(
ap,sizeof(void*),0));_tmp43.f2=*((void**)_check_unknown_subscript(ap,sizeof(void*),
1));_tmp43;});void*_tmp45;struct Cyc_sockaddr_in*_tmp46;void*_tmp47;int _tmp48;
_LL10: _tmp45=_tmp44.f1;if(*((int*)_tmp45)!= 0)goto _LL12;_tmp46=((struct Cyc_SA_sockaddr_in_struct*)
_tmp45)->f1;_tmp47=_tmp44.f2;if(*((int*)_tmp47)!= 2)goto _LL12;_tmp48=((struct Cyc_SA_socklen_struct*)
_tmp47)->f1;_LL11: return bind_in(fd,(const struct Cyc_sockaddr_in*)_tmp46,_tmp48);
_LL12:;_LL13:(int)_throw((void*)Cyc_SocketError);_LLF:;}}int connect_in(int,const
struct Cyc_sockaddr_in*,int);int Cyc_connect(int fd,struct _tagged_arr ap){if(
_get_arr_size(ap,sizeof(void*))!= 2)(int)_throw((void*)Cyc_SocketError);{struct
_tuple0 _tmp4A=({struct _tuple0 _tmp49;_tmp49.f1=*((void**)_check_unknown_subscript(
ap,sizeof(void*),0));_tmp49.f2=*((void**)_check_unknown_subscript(ap,sizeof(void*),
1));_tmp49;});void*_tmp4B;struct Cyc_sockaddr_in*_tmp4C;void*_tmp4D;int _tmp4E;
_LL15: _tmp4B=_tmp4A.f1;if(*((int*)_tmp4B)!= 0)goto _LL17;_tmp4C=((struct Cyc_SA_sockaddr_in_struct*)
...
_check_unknown_subscript(ap,sizeof(void*),0));_tmp4F.f2=*((void**)
_check_unknown_subscript(ap,sizeof(void*),1));_tmp4F;});void*_tmp51;struct Cyc_sockaddr_in*
...
_get_arr_size(ap,sizeof(void*))!= 2)(int)_throw((void*)Cyc_SocketError);{struct
_tuple0 _tmp56=({struct _tuple0 _tmp55;_tmp55.f1=*((void**)_check_unknown_subscript(
ap,sizeof(void*),0));_tmp55.f2=*((void**)_check_unknown_subscript(ap,sizeof(void*),
1));_tmp55;});void*_tmp57;struct Cyc_sockaddr_in*_tmp58;void*_tmp59;int*_tmp5A;
_LL1F: _tmp57=_tmp56.f1;if(*((int*)_tmp57)!= 0)goto _LL21;_tmp58=((struct Cyc_SA_sockaddr_in_struct*)
_tmp57)->f1;_tmp59=_tmp56.f2;if(*((int*)_tmp59)!= 1)goto _LL21;_tmp5A=((struct Cyc_SA_socklenptr_struct*)
_tmp59)->f1;_LL20: return getsockname_in(fd,(const struct Cyc_sockaddr_in*)_tmp58,
_tmp5A);_LL21:;_LL22:(int)_throw((void*)Cyc_SocketError);_LL1E:;}}int
...
struct Cyc_timeval*_tmp66;void*_tmp67;int*_tmp68;void*_tmp69;struct Cyc_timeval*
_tmp6A;void*_tmp6B;int*_tmp6C;_LL24: _tmp5D=_tmp5C.f1;if(*((int*)_tmp5D)!= 0)goto
_LL26;_tmp5E=((struct Cyc_SO_int_struct*)_tmp5D)->f1;_tmp5F=_tmp5C.f2;if(*((int*)
_tmp5F)!= 2)goto _LL26;_tmp60=((struct Cyc_SO_socklenptr_struct*)_tmp5F)->f1;_LL25:
return getsockopt_int(fd,level,optname,_tmp5E,_tmp60);_LL26: _tmp61=_tmp5C.f1;if(*((
int*)_tmp61)!= 0)goto _LL28;_tmp62=((struct Cyc_SO_int_struct*)_tmp61)->f1;_tmp63=
_tmp5C.f2;if(*((int*)_tmp63)!= 0)goto _LL28;_tmp64=((struct Cyc_SO_int_struct*)
...
_LL2C:;_LL2D:(int)_throw((void*)Cyc_SocketError);_LL23:;}}int recv_wrapped(int,
...
_get_arr_size(ap,sizeof(void*))!= 2)(int)_throw((void*)Cyc_SocketError);{struct
_tuple0 _tmp6E=({struct _tuple0 _tmp6D;_tmp6D.f1=*((void**)_check_unknown_subscript(
ap,sizeof(void*),0));_tmp6D.f2=*((void**)_check_unknown_subscript(ap,sizeof(void*),
1));_tmp6D;});void*_tmp6F;struct Cyc_sockaddr_in*_tmp70;void*_tmp71;int*_tmp72;
_LL2F: _tmp6F=_tmp6E.f1;if(*((int*)_tmp6F)!= 0)goto _LL31;_tmp70=((struct Cyc_SA_sockaddr_in_struct*)
_tmp6F)->f1;_tmp71=_tmp6E.f2;if(*((int*)_tmp71)!= 1)goto _LL31;_tmp72=((struct Cyc_SA_socklenptr_struct*)
_tmp71)->f1;_LL30: return recvfrom_in(fd,buf,n,flags,(const struct Cyc_sockaddr_in*)
_tmp70,_tmp72);_LL31:;_LL32:(int)_throw((void*)Cyc_SocketError);_LL2E:;}}int
...
_check_unknown_subscript(ap,sizeof(void*),1));_tmp73;});void*_tmp75;struct Cyc_sockaddr_in*
...
_get_arr_size(ap,sizeof(void*))!= 2)(int)_throw((void*)Cyc_SocketError);{struct
_tuple0 _tmp7A=({struct _tuple0 _tmp79;_tmp79.f1=*((void**)_check_unknown_subscript(
ap,sizeof(void*),0));_tmp79.f2=*((void**)_check_unknown_subscript(ap,sizeof(void*),
1));_tmp79;});void*_tmp7B;int*_tmp7C;void*_tmp7D;int _tmp7E;void*_tmp7F;struct Cyc_timeval*
_tmp80;void*_tmp81;int _tmp82;_LL39: _tmp7B=_tmp7A.f1;if(*((int*)_tmp7B)!= 0)goto
_LL3B;_tmp7C=((struct Cyc_SO_int_struct*)_tmp7B)->f1;_tmp7D=_tmp7A.f2;if(*((int*)
_tmp7D)!= 3)goto _LL3B;_tmp7E=((struct Cyc_SO_socklen_struct*)_tmp7D)->f1;_LL3A:
return setsockopt_int(fd,level,optname,(const int*)_tmp7C,_tmp7E);_LL3B: _tmp7F=
_tmp7A.f1;if(*((int*)_tmp7F)!= 1)goto _LL3D;_tmp80=((struct Cyc_SO_timeval_struct*)
_tmp7F)->f1;_tmp81=_tmp7A.f2;if(*((int*)_tmp81)!= 3)goto _LL3D;_tmp82=((struct Cyc_SO_socklen_struct*)
...
unsigned int _tmp8F=_get_arr_size(argv,sizeof(const char*));const char**_tmp90=(
const char**)_cycalloc(_check_times(sizeof(const char*),_tmp8F + 1));struct
_tagged_arr _tmp92=_tag_arr(_tmp90,sizeof(const char*),_tmp8F + 1);{unsigned int
_tmp91=_tmp8F;unsigned int i;for(i=0;i < _tmp91;i ++){_tmp90[i]=(const char*)0;}
_tmp90[_tmp91]=(const char*)0;}_tmp92;}),sizeof(const char*),1);({struct
_tagged_arr _tmp88=_tagged_arr_plus(({const char**_tmp87=newargs;_tag_arr(_tmp87,
sizeof(const char*),_get_zero_arr_size(_tmp87,1));}),sizeof(const char*),0);const
char*_tmp89=*((const char**)_check_unknown_subscript(_tmp88,sizeof(const char*),0));
const char*_tmp8A=(const char*)arg0;if(_get_arr_size(_tmp88,sizeof(const char*))== 
1?_tmp89 == 0?_tmp8A != 0: 0: 0)_throw_arraybounds();*((const char**)_tmp88.curr)=
_tmp8A;});{int i=0;for(0;i < _get_arr_size(argv,sizeof(const char*))- 1;i ++){({
struct _tagged_arr _tmp8C=_tagged_arr_plus(({const char**_tmp8B=newargs;_tag_arr(
_tmp8B,sizeof(const char*),_get_zero_arr_size(_tmp8B,1));}),sizeof(const char*),i + 
1);const char*_tmp8D=*((const char**)_check_unknown_subscript(_tmp8C,sizeof(const
char*),0));const char*_tmp8E=*((const char**)_check_unknown_subscript(argv,sizeof(
const char*),i));if(_get_arr_size(_tmp8C,sizeof(const char*))== 1?_tmp8D == 0?
_tmp8E != 0: 0: 0)_throw_arraybounds();*((const char**)_tmp8C.curr)=_tmp8E;});}}
return execvp(path,(const char**)newargs);}}char*getcwd(char*buf,unsigned int size);
static char _tmp94[29]="getcwd: invalid buf argument";static struct Cyc_Core_Failure_struct
Cyc___getcwd_failure={Cyc_Core_Failure,{_tmp94,_tmp94,_tmp94 + 29}};struct
_tagged_arr Cyc_getcwd(struct _tagged_arr buf,unsigned int size){if(_get_arr_size(
buf,sizeof(char))< size)(int)_throw((void*)& Cyc___getcwd_failure);{char*_tmp95=
getcwd((char*)_check_null(_untag_arr(buf,sizeof(char),1)),size);return(
unsigned int)_tmp95?buf: _tag_arr(0,0,0);}}int gethostname(char*,unsigned int);
static char _tmp97[34]="gethostname: called with NULL buf";static struct Cyc_Core_Failure_struct
Cyc___gethostname_failure_1={Cyc_Core_Failure,{_tmp97,_tmp97,_tmp97 + 34}};static
char _tmp99[42]="gethostname: called with count > buf.size";static struct Cyc_Core_Failure_struct
Cyc___gethostname_failure_2={Cyc_Core_Failure,{_tmp99,_tmp99,_tmp99 + 42}};int Cyc_gethostname(
...
static char _tmp9B[35]="read: called with count > buf.size";static struct Cyc_Core_Failure_struct
Cyc___read_failure={Cyc_Core_Failure,{_tmp9B,_tmp9B,_tmp9B + 35}};int Cyc_read(int
...
unsigned int count);static char _tmp9D[36]="write: called with count > buf.size";
static struct Cyc_Core_Failure_struct Cyc___write_failure={Cyc_Core_Failure,{_tmp9D,
_tmp9D,_tmp9D + 36}};int Cyc_write(int fd,struct _tagged_arr buf,unsigned int count){
