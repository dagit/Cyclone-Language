...
char*tag;struct _dynforward_ptr f1;};int Cyc_file_string_read(struct Cyc___cycFILE*,
struct _dynforward_ptr dest,int dest_offset,int max_count);extern char Cyc_Lexing_Error[
