...
Cyc_PP_Doc*d,int w,struct Cyc___cycFILE*f);struct _dynforward_ptr Cyc_PP_string_of_doc(
struct Cyc_PP_Doc*d,int w);struct _tuple0{struct _dynforward_ptr f1;struct Cyc_List_List*
...
_dynforward_ptr s);struct Cyc_PP_Doc*Cyc_PP_textptr(struct _dynforward_ptr*p);
struct Cyc_PP_Doc*Cyc_PP_text_width(struct _dynforward_ptr s,int w);struct Cyc_PP_Doc*
Cyc_PP_hyperlink(struct _dynforward_ptr shrt,struct _dynforward_ptr full);struct Cyc_PP_Doc*
Cyc_PP_nest(int k,struct Cyc_PP_Doc*d);struct Cyc_PP_Doc*Cyc_PP_cat(struct
_dynforward_ptr);struct Cyc_PP_Doc*Cyc_PP_cats(struct Cyc_List_List*doclist);
struct Cyc_PP_Doc*Cyc_PP_cats_arr(struct _dynforward_ptr docs);struct Cyc_PP_Doc*Cyc_PP_doc_union(
struct Cyc_PP_Doc*d1,struct Cyc_PP_Doc*d2);struct Cyc_PP_Doc*Cyc_PP_tab(struct Cyc_PP_Doc*
d);struct Cyc_PP_Doc*Cyc_PP_seq(struct _dynforward_ptr sep,struct Cyc_List_List*l);
struct Cyc_PP_Doc*Cyc_PP_ppseq(struct Cyc_PP_Doc*(*pp)(void*),struct
_dynforward_ptr sep,struct Cyc_List_List*l);struct Cyc_PP_Doc*Cyc_PP_seql(struct
_dynforward_ptr sep,struct Cyc_List_List*l0);struct Cyc_PP_Doc*Cyc_PP_ppseql(struct
Cyc_PP_Doc*(*pp)(void*),struct _dynforward_ptr sep,struct Cyc_List_List*l);struct
Cyc_PP_Doc*Cyc_PP_group(struct _dynforward_ptr start,struct _dynforward_ptr stop,
struct _dynforward_ptr sep,struct Cyc_List_List*l);struct Cyc_PP_Doc*Cyc_PP_groupl(
struct _dynforward_ptr start,struct _dynforward_ptr stop,struct _dynforward_ptr sep,
struct Cyc_List_List*l);struct Cyc_PP_Doc*Cyc_PP_egroup(struct _dynforward_ptr start,
struct _dynforward_ptr stop,struct _dynforward_ptr sep,struct Cyc_List_List*l);struct
Cyc_Xarray_Xarray{struct _RegionHandle*r;struct _dynforward_ptr elmts;int num_elmts;
};int Cyc_Xarray_length(struct Cyc_Xarray_Xarray*);void*Cyc_Xarray_get(struct Cyc_Xarray_Xarray*,
int);void Cyc_Xarray_set(struct Cyc_Xarray_Xarray*,int,void*);struct Cyc_Xarray_Xarray*
Cyc_Xarray_create(int,void*);void Cyc_Xarray_add(struct Cyc_Xarray_Xarray*,void*);
struct Cyc_PP_Single_struct{int tag;void*f1;};struct Cyc_PP_Append_struct{int tag;
void*f1;void*f2;};void*Cyc_PP_append(void*a1,void*a2){if(a1 == (void*)((void*)0))
return a2;else{if(a2 == (void*)((void*)0))return a1;else{return(void*)({struct Cyc_PP_Append_struct*
_tmp0=_cycalloc(sizeof(*_tmp0));_tmp0[0]=({struct Cyc_PP_Append_struct _tmp1;_tmp1.tag=
1;_tmp1.f1=(void*)a1;_tmp1.f2=(void*)a2;_tmp1;});_tmp0;});}}}struct Cyc_List_List*
Cyc_PP_list_of_alist_f(void*y,struct Cyc_List_List*l){void*_tmp2=y;void*_tmp3;
void*_tmp4;void*_tmp5;_LL1: if((int)_tmp2 != 0)goto _LL3;_LL2: return l;_LL3: if(_tmp2
<= (void*)1)goto _LL5;if(*((int*)_tmp2)!= 0)goto _LL5;_tmp3=(void*)((struct Cyc_PP_Single_struct*)
_tmp2)->f1;_LL4: return({struct Cyc_List_List*_tmp6=_cycalloc(sizeof(*_tmp6));
_tmp6->hd=(void*)_tmp3;_tmp6->tl=l;_tmp6;});_LL5: if(_tmp2 <= (void*)1)goto _LL0;
if(*((int*)_tmp2)!= 1)goto _LL0;_tmp4=(void*)((struct Cyc_PP_Append_struct*)_tmp2)->f1;
...
_tmp7,last);struct _dynforward_ptr*_tmp9;void*_tmpA;void*_tmpB;_LL8: if((int)_tmp8
!= 0)goto _LLA;_LL9: -- last;goto _LL7;_LLA: if(_tmp8 <= (void*)1)goto _LLC;if(*((int*)
_tmp8)!= 0)goto _LLC;_tmp9=(struct _dynforward_ptr*)((struct Cyc_PP_Single_struct*)
_tmp8)->f1;_LLB: -- last;({struct Cyc_String_pa_struct _tmpE;_tmpE.tag=0;_tmpE.f1=(
struct _dynforward_ptr)((struct _dynforward_ptr)*_tmp9);{void*_tmpC[1]={& _tmpE};
Cyc_fprintf(f,({const char*_tmpD="%s";_tag_dynforward(_tmpD,sizeof(char),
_get_zero_arr_size_char(_tmpD,3));}),_tag_dynforward(_tmpC,sizeof(void*),1));}});
goto _LL7;_LLC: if(_tmp8 <= (void*)1)goto _LL7;if(*((int*)_tmp8)!= 1)goto _LL7;_tmpA=(
void*)((struct Cyc_PP_Append_struct*)_tmp8)->f1;_tmpB=(void*)((struct Cyc_PP_Append_struct*)
...
Cyc___cycFILE*f){struct Cyc_PP_Out*o=((struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*
f,struct Cyc_PP_Ppstate*x))Cyc_Fn_apply)(d->f,({struct Cyc_PP_Ppstate*_tmpF=
_cycalloc_atomic(sizeof(*_tmpF));_tmpF->ci=0;_tmpF->cc=0;_tmpF->cl=1;_tmpF->pw=w;
_tmpF->epw=w;_tmpF;}));Cyc_PP_dump_out(f,(void*)o->ppout);}struct _dynforward_ptr
...
_tmp11->pw=w;_tmp11->epw=w;_tmp11;}));return(struct _dynforward_ptr)Cyc_str_sepstr(((
struct Cyc_List_List*(*)(void*x))Cyc_PP_list_of_alist)((void*)o->ppout),({const
char*_tmp10="";_tag_dynforward(_tmp10,sizeof(char),_get_zero_arr_size_char(
_tmp10,1));}));}struct _tuple0*Cyc_PP_string_and_links(struct Cyc_PP_Doc*d,int w){
struct Cyc_PP_Out*o=((struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*f,struct Cyc_PP_Ppstate*
x))Cyc_Fn_apply)(d->f,({struct Cyc_PP_Ppstate*_tmp14=_cycalloc_atomic(sizeof(*
_tmp14));_tmp14->ci=0;_tmp14->cc=0;_tmp14->cl=1;_tmp14->pw=w;_tmp14->epw=w;
_tmp14;}));return({struct _tuple0*_tmp12=_cycalloc(sizeof(*_tmp12));_tmp12->f1=(
struct _dynforward_ptr)Cyc_str_sepstr(((struct Cyc_List_List*(*)(void*x))Cyc_PP_list_of_alist)((
void*)o->ppout),({const char*_tmp13="";_tag_dynforward(_tmp13,sizeof(char),
_get_zero_arr_size_char(_tmp13,1));}));_tmp12->f2=((struct Cyc_List_List*(*)(void*
x))Cyc_PP_list_of_alist)((void*)o->links);_tmp12;});}static struct Cyc_Core_Opt*
Cyc_PP_bhashtbl=0;int Cyc_PP_tex_output=0;struct _dynforward_ptr Cyc_PP_nlblanks(
int i){if(Cyc_PP_bhashtbl == 0)Cyc_PP_bhashtbl=({struct Cyc_Core_Opt*_tmp15=
_cycalloc(sizeof(*_tmp15));_tmp15->v=((struct Cyc_Hashtable_Table*(*)(int sz,int(*
cmp)(int,int),int(*hash)(int)))Cyc_Hashtable_create)(61,Cyc_Core_intcmp,(int(*)(
int))Cyc_Core_identity);_tmp15;});if(i < 0)(int)_throw((void*)({struct Cyc_Core_Failure_struct*
...
_tag_dynforward(_tmp18,sizeof(char),_get_zero_arr_size_char(_tmp18,9));});_tmp17;});
_tmp16;}));{struct _handler_cons _tmp19;_push_handler(& _tmp19);{int _tmp1B=0;if(
setjmp(_tmp19.handler))_tmp1B=1;if(!_tmp1B){{struct _dynforward_ptr _tmp1C=*((
struct _dynforward_ptr*(*)(struct Cyc_Hashtable_Table*t,int key))Cyc_Hashtable_lookup)((
...
+ _tmp20;struct _dynforward_ptr nlb=Cyc_Core_new_string((unsigned int)_tmp21);({
...
void(*)(struct Cyc_Hashtable_Table*t,int key,struct _dynforward_ptr*val))Cyc_Hashtable_insert)((
struct Cyc_Hashtable_Table*)((struct Cyc_Core_Opt*)_check_null(Cyc_PP_bhashtbl))->v,
i,({struct _dynforward_ptr*_tmp2B=_cycalloc(sizeof(struct _dynforward_ptr)* 1);
_tmp2B[0]=(struct _dynforward_ptr)nlb;_tmp2B;}));return(struct _dynforward_ptr)nlb;}
else{int _tmp2C=3 + i;struct _dynforward_ptr nlb=Cyc_Core_new_string((unsigned int)(
_tmp2C + 1));({struct _dynforward_ptr _tmp2D=_dynforward_ptr_plus(nlb,sizeof(char),
0);char _tmp2E=*((char*)_check_dynforward_subscript(_tmp2D,sizeof(char),0));char
_tmp2F='\\';if(_get_dynforward_size(_tmp2D,sizeof(char))== 1  && (_tmp2E == '\000'
 && _tmp2F != '\000'))_throw_arraybounds();*((char*)_tmp2D.curr)=_tmp2F;});({
struct _dynforward_ptr _tmp30=_dynforward_ptr_plus(nlb,sizeof(char),1);char _tmp31=*((
char*)_check_dynforward_subscript(_tmp30,sizeof(char),0));char _tmp32='\\';if(
_get_dynforward_size(_tmp30,sizeof(char))== 1  && (_tmp31 == '\000'  && _tmp32 != '\000'))
_throw_arraybounds();*((char*)_tmp30.curr)=_tmp32;});({struct _dynforward_ptr
...
_throw_arraybounds();*((char*)_tmp36.curr)=_tmp38;});}}((void(*)(struct Cyc_Hashtable_Table*
t,int key,struct _dynforward_ptr*val))Cyc_Hashtable_insert)((struct Cyc_Hashtable_Table*)((
struct Cyc_Core_Opt*)_check_null(Cyc_PP_bhashtbl))->v,i,({struct _dynforward_ptr*
_tmp39=_cycalloc(sizeof(struct _dynforward_ptr)* 1);_tmp39[0]=(struct
_dynforward_ptr)nlb;_tmp39;}));return(struct _dynforward_ptr)nlb;}_LL11:;_LL12:(
void)_throw(_tmp1E);_LLE:;}}}}static struct Cyc_Core_Opt*Cyc_PP_str_hashtbl=0;int
Cyc_PP_infinity=9999999;struct _tuple1{int f1;struct _dynforward_ptr f2;};static
struct Cyc_PP_Out*Cyc_PP_text_doc_f(struct _tuple1*clo,struct Cyc_PP_Ppstate*st){
struct _tuple1 _tmp3B;int _tmp3C;struct _dynforward_ptr _tmp3D;struct _tuple1*_tmp3A=
clo;_tmp3B=*_tmp3A;_tmp3C=_tmp3B.f1;_tmp3D=_tmp3B.f2;return({struct Cyc_PP_Out*
_tmp3E=_cycalloc(sizeof(*_tmp3E));_tmp3E->newcc=st->cc + _tmp3C;_tmp3E->newcl=st->cl;
_tmp3E->ppout=(void*)((void*)({struct Cyc_PP_Single_struct*_tmp3F=_cycalloc(
sizeof(*_tmp3F));_tmp3F[0]=({struct Cyc_PP_Single_struct _tmp40;_tmp40.tag=0;
_tmp40.f1=(void*)({struct _dynforward_ptr*_tmp41=_cycalloc(sizeof(struct
_dynforward_ptr)* 1);_tmp41[0]=_tmp3D;_tmp41;});_tmp40;});_tmp3F;}));_tmp3E->links=(
void*)((void*)0);_tmp3E;});}static struct Cyc_PP_Doc*Cyc_PP_text_doc(struct
_dynforward_ptr s){int slen=(int)Cyc_strlen((struct _dynforward_ptr)s);return({
...
_tmp43;}));_tmp42;});}struct Cyc_PP_Doc*Cyc_PP_text(struct _dynforward_ptr s){
struct Cyc_Hashtable_Table*t;if(Cyc_PP_str_hashtbl == 0){t=((struct Cyc_Hashtable_Table*(*)(
int sz,int(*cmp)(struct _dynforward_ptr*,struct _dynforward_ptr*),int(*hash)(struct
_dynforward_ptr*)))Cyc_Hashtable_create)(101,Cyc_zstrptrcmp,Cyc_Hashtable_hash_stringptr);
Cyc_PP_str_hashtbl=({struct Cyc_Core_Opt*_tmp44=_cycalloc(sizeof(*_tmp44));_tmp44->v=
t;_tmp44;});}else{t=(struct Cyc_Hashtable_Table*)((struct Cyc_Core_Opt*)
_check_null(Cyc_PP_str_hashtbl))->v;}{struct _handler_cons _tmp45;_push_handler(&
_tmp45);{int _tmp47=0;if(setjmp(_tmp45.handler))_tmp47=1;if(!_tmp47){{struct Cyc_PP_Doc*
_tmp49=((struct Cyc_PP_Doc*(*)(struct Cyc_Hashtable_Table*t,struct _dynforward_ptr*
key))Cyc_Hashtable_lookup)(t,({struct _dynforward_ptr*_tmp48=_cycalloc(sizeof(*
_tmp48));_tmp48[0]=s;_tmp48;}));_npop_handler(0);return _tmp49;};_pop_handler();}
else{void*_tmp46=(void*)_exn_thrown;void*_tmp4B=_tmp46;_LL14: if(_tmp4B != Cyc_Core_Not_found)
goto _LL16;_LL15: {struct Cyc_PP_Doc*d=Cyc_PP_text_doc(s);((void(*)(struct Cyc_Hashtable_Table*
t,struct _dynforward_ptr*key,struct Cyc_PP_Doc*val))Cyc_Hashtable_insert)(t,({
struct _dynforward_ptr*_tmp4C=_cycalloc(sizeof(*_tmp4C));_tmp4C[0]=s;_tmp4C;}),d);
return d;}_LL16:;_LL17:(void)_throw(_tmp4B);_LL13:;}}}}struct Cyc_PP_Doc*Cyc_PP_textptr(
struct _dynforward_ptr*s){return Cyc_PP_text(*s);}static struct Cyc_PP_Doc*Cyc_PP_text_width_doc(
struct _dynforward_ptr s,int slen){return({struct Cyc_PP_Doc*_tmp4D=_cycalloc(
sizeof(*_tmp4D));_tmp4D->mwo=slen;_tmp4D->mw=Cyc_PP_infinity;_tmp4D->f=((struct
Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct _tuple1*,struct Cyc_PP_Ppstate*),
struct _tuple1*x))Cyc_Fn_make_fn)(Cyc_PP_text_doc_f,({struct _tuple1*_tmp4E=
_cycalloc(sizeof(*_tmp4E));_tmp4E->f1=slen;_tmp4E->f2=s;_tmp4E;}));_tmp4D;});}
static struct Cyc_Core_Opt*Cyc_PP_str_hashtbl2=0;struct Cyc_PP_Doc*Cyc_PP_text_width(
struct _dynforward_ptr s,int slen){struct Cyc_Hashtable_Table*t;if(Cyc_PP_str_hashtbl2
== 0){t=((struct Cyc_Hashtable_Table*(*)(int sz,int(*cmp)(struct _dynforward_ptr*,
struct _dynforward_ptr*),int(*hash)(struct _dynforward_ptr*)))Cyc_Hashtable_create)(
101,Cyc_zstrptrcmp,Cyc_Hashtable_hash_stringptr);Cyc_PP_str_hashtbl2=({struct Cyc_Core_Opt*
...
t,struct _dynforward_ptr*key))Cyc_Hashtable_lookup)(t,({struct _dynforward_ptr*
_tmp53=_cycalloc(sizeof(*_tmp53));_tmp53[0]=s;_tmp53;}));_npop_handler(0);return
_tmp54;};_pop_handler();}else{void*_tmp51=(void*)_exn_thrown;void*_tmp56=_tmp51;
_LL19: if(_tmp56 != Cyc_Core_Not_found)goto _LL1B;_LL1A: {struct Cyc_PP_Doc*d=Cyc_PP_text_width_doc(
s,slen);((void(*)(struct Cyc_Hashtable_Table*t,struct _dynforward_ptr*key,struct
Cyc_PP_Doc*val))Cyc_Hashtable_insert)(t,({struct _dynforward_ptr*_tmp57=_cycalloc(
sizeof(*_tmp57));_tmp57[0]=s;_tmp57;}),d);return d;}_LL1B:;_LL1C:(void)_throw(
_tmp56);_LL18:;}}}}struct Cyc_Core_Opt*Cyc_PP_nil_doc_opt=0;struct Cyc_Core_Opt*
Cyc_PP_blank_doc_opt=0;struct Cyc_Core_Opt*Cyc_PP_line_doc_opt=0;struct Cyc_PP_Doc*
Cyc_PP_nil_doc(){if(Cyc_PP_nil_doc_opt == 0)Cyc_PP_nil_doc_opt=({struct Cyc_Core_Opt*
_tmp58=_cycalloc(sizeof(*_tmp58));_tmp58->v=Cyc_PP_text(({const char*_tmp59="";
_tag_dynforward(_tmp59,sizeof(char),_get_zero_arr_size_char(_tmp59,1));}));
_tmp58;});return(struct Cyc_PP_Doc*)((struct Cyc_Core_Opt*)_check_null(Cyc_PP_nil_doc_opt))->v;}
struct Cyc_PP_Doc*Cyc_PP_blank_doc(){if(Cyc_PP_blank_doc_opt == 0)Cyc_PP_blank_doc_opt=({
struct Cyc_Core_Opt*_tmp5A=_cycalloc(sizeof(*_tmp5A));_tmp5A->v=Cyc_PP_text(({
const char*_tmp5B="";_tag_dynforward(_tmp5B,sizeof(char),_get_zero_arr_size_char(
_tmp5B,1));}));_tmp5A;});return(struct Cyc_PP_Doc*)((struct Cyc_Core_Opt*)
_check_null(Cyc_PP_blank_doc_opt))->v;}struct _tuple2{int f1;struct _dynforward_ptr
f2;struct _dynforward_ptr f3;};struct _tuple3{int f1;int f2;int f3;struct
_dynforward_ptr f4;};static struct Cyc_PP_Out*Cyc_PP_hyperlink_f(struct _tuple2*clo,
struct Cyc_PP_Ppstate*st){struct _tuple2 _tmp5D;int _tmp5E;struct _dynforward_ptr
_tmp5F;struct _dynforward_ptr _tmp60;struct _tuple2*_tmp5C=clo;_tmp5D=*_tmp5C;
_tmp5E=_tmp5D.f1;_tmp5F=_tmp5D.f2;_tmp60=_tmp5D.f3;return({struct Cyc_PP_Out*
_tmp61=_cycalloc(sizeof(*_tmp61));_tmp61->newcc=st->cc + _tmp5E;_tmp61->newcl=st->cl;
_tmp61->ppout=(void*)((void*)({struct Cyc_PP_Single_struct*_tmp65=_cycalloc(
sizeof(*_tmp65));_tmp65[0]=({struct Cyc_PP_Single_struct _tmp66;_tmp66.tag=0;
_tmp66.f1=(void*)({struct _dynforward_ptr*_tmp67=_cycalloc(sizeof(struct
_dynforward_ptr)* 1);_tmp67[0]=_tmp5F;_tmp67;});_tmp66;});_tmp65;}));_tmp61->links=(
void*)((void*)({struct Cyc_PP_Single_struct*_tmp62=_cycalloc(sizeof(*_tmp62));
_tmp62[0]=({struct Cyc_PP_Single_struct _tmp63;_tmp63.tag=0;_tmp63.f1=(void*)({
struct _tuple3*_tmp64=_cycalloc(sizeof(*_tmp64));_tmp64->f1=st->cl;_tmp64->f2=st->cc;
_tmp64->f3=_tmp5E;_tmp64->f4=_tmp60;_tmp64;});_tmp63;});_tmp62;}));_tmp61;});}
struct Cyc_PP_Doc*Cyc_PP_hyperlink(struct _dynforward_ptr shrt,struct
_dynforward_ptr full){int slen=(int)Cyc_strlen((struct _dynforward_ptr)shrt);return({
...
_dynforward_ptr*_tmp6D=_cycalloc(sizeof(struct _dynforward_ptr)* 1);_tmp6D[0]=Cyc_PP_nlblanks(
...
struct _dynforward_ptr*docs_ptr,struct Cyc_PP_Ppstate*st){struct Cyc_List_List*os=0;
struct _dynforward_ptr docs=*docs_ptr;int sz=(int)_get_dynforward_size(docs,sizeof(
struct Cyc_PP_Doc*));{int i=0;for(0;i < sz;++ i){struct Cyc_PP_Doc*d=*((struct Cyc_PP_Doc**)
_check_dynforward_subscript(docs,sizeof(struct Cyc_PP_Doc*),i));struct Cyc_PP_Out*
o=((struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*f,struct Cyc_PP_Ppstate*x))Cyc_Fn_apply)(
d->f,st);st=({struct Cyc_PP_Ppstate*_tmp87=_cycalloc_atomic(sizeof(*_tmp87));
_tmp87->ci=st->ci;_tmp87->cc=o->newcc;_tmp87->cl=o->newcl;_tmp87->pw=st->pw;
_tmp87->epw=st->epw - d->mwo;_tmp87;});os=({struct Cyc_List_List*_tmp88=_cycalloc(
sizeof(*_tmp88));_tmp88->hd=o;_tmp88->tl=os;_tmp88;});}}{int newcc=((struct Cyc_PP_Out*)((
...
os->hd)->links,links);}return({struct Cyc_PP_Out*_tmp89=_cycalloc(sizeof(*_tmp89));
_tmp89->newcc=newcc;_tmp89->newcl=newcl;_tmp89->ppout=(void*)s;_tmp89->links=(
void*)links;_tmp89;});}}struct Cyc_PP_Doc*Cyc_PP_cats_arr(struct _dynforward_ptr
docs){int sz=(int)_get_dynforward_size(docs,sizeof(struct Cyc_PP_Doc*));if(sz == 0)(
int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmp8A=_cycalloc(sizeof(*
_tmp8A));_tmp8A[0]=({struct Cyc_Core_Failure_struct _tmp8B;_tmp8B.tag=Cyc_Core_Failure;
_tmp8B.f1=({const char*_tmp8C="cats_arr -- size zero array";_tag_dynforward(
_tmp8C,sizeof(char),_get_zero_arr_size_char(_tmp8C,28));});_tmp8B;});_tmp8A;}));{
struct Cyc_PP_Doc*d=*((struct Cyc_PP_Doc**)_check_dynforward_subscript(docs,
sizeof(struct Cyc_PP_Doc*),0));int mw=d->mw;int mwo=d->mw;{int i=1;for(0;i < sz;++ i){
int mw2=Cyc_PP_min(mw,mwo + (*((struct Cyc_PP_Doc**)_check_dynforward_subscript(
docs,sizeof(struct Cyc_PP_Doc*),i)))->mwo);int mwo2=Cyc_PP_min(mw,mwo + (*((struct
Cyc_PP_Doc**)_check_dynforward_subscript(docs,sizeof(struct Cyc_PP_Doc*),i)))->mw);
mw=mw2;mwo=mwo2;}}return({struct Cyc_PP_Doc*_tmp8D=_cycalloc(sizeof(*_tmp8D));
_tmp8D->mwo=mw;_tmp8D->mw=mwo;_tmp8D->f=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*
f)(struct _dynforward_ptr*,struct Cyc_PP_Ppstate*),struct _dynforward_ptr*x))Cyc_Fn_make_fn)(
Cyc_PP_cats_arr_f,({struct _dynforward_ptr*_tmp8E=_cycalloc(sizeof(struct
_dynforward_ptr)* 1);_tmp8E[0]=docs;_tmp8E;}));_tmp8D;});}}static struct Cyc_PP_Out*
Cyc_PP_doc_union_f(struct _tuple5*clo,struct Cyc_PP_Ppstate*st){struct _tuple5
_tmp90;struct Cyc_PP_Doc*_tmp91;struct Cyc_PP_Doc*_tmp92;struct _tuple5*_tmp8F=clo;
_tmp90=*_tmp8F;_tmp91=_tmp90.f1;_tmp92=_tmp90.f2;{int dfits=st->cc + _tmp91->mwo <= 
st->epw  || st->cc + _tmp91->mw <= st->pw;if(dfits)return((struct Cyc_PP_Out*(*)(
...
void*),struct _dynforward_ptr sep,struct Cyc_List_List*l){if(l == 0)return Cyc_PP_nil_doc();
...
Cyc_PP_text(sep);_tmp97[0]=pp((void*)l->hd);Cyc_PP_cat(_tag_dynforward(_tmp97,
sizeof(struct Cyc_PP_Doc*),4));});}}}struct Cyc_PP_Doc*Cyc_PP_ppseq(struct Cyc_PP_Doc*(*
pp)(void*),struct _dynforward_ptr sep,struct Cyc_List_List*l){return Cyc_PP_tab(Cyc_PP_ppseq_f(
pp,sep,l));}struct Cyc_PP_Doc*Cyc_PP_seq_f(struct _dynforward_ptr sep,struct Cyc_List_List*
...
l);}}}struct Cyc_PP_Doc*Cyc_PP_seq(struct _dynforward_ptr sep,struct Cyc_List_List*l){
return Cyc_PP_tab(Cyc_PP_seq_f(sep,l));}struct Cyc_PP_Doc*Cyc_PP_ppseql_f(struct
Cyc_PP_Doc*(*pp)(void*),struct _dynforward_ptr sep,struct Cyc_List_List*l){if(l == 0)
...
_tmp9C[1]=Cyc_PP_text(sep);_tmp9C[0]=pp((void*)l->hd);Cyc_PP_cat(_tag_dynforward(
_tmp9C,sizeof(struct Cyc_PP_Doc*),4));});}}}struct Cyc_PP_Doc*Cyc_PP_ppseql(struct
Cyc_PP_Doc*(*pp)(void*),struct _dynforward_ptr sep,struct Cyc_List_List*l){return
Cyc_PP_tab(Cyc_PP_ppseql_f(pp,sep,l));}static struct Cyc_PP_Doc*Cyc_PP_seql_f(
struct _dynforward_ptr sep,struct Cyc_List_List*l){if(l == 0)return Cyc_PP_nil_doc();
else{if(l->tl == 0)return(struct Cyc_PP_Doc*)l->hd;else{return({struct Cyc_PP_Doc*
_tmp9D[4];_tmp9D[3]=Cyc_PP_seql_f(sep,l->tl);_tmp9D[2]=Cyc_PP_line_doc();_tmp9D[
1]=Cyc_PP_text(sep);_tmp9D[0]=(struct Cyc_PP_Doc*)l->hd;Cyc_PP_cat(
_tag_dynforward(_tmp9D,sizeof(struct Cyc_PP_Doc*),4));});}}}struct Cyc_PP_Doc*Cyc_PP_seql(
struct _dynforward_ptr sep,struct Cyc_List_List*l0){return Cyc_PP_tab(Cyc_PP_seql_f(
sep,l0));}struct Cyc_PP_Doc*Cyc_PP_group(struct _dynforward_ptr start,struct
_dynforward_ptr stop,struct _dynforward_ptr sep,struct Cyc_List_List*ss){return({
struct Cyc_PP_Doc*_tmp9E[3];_tmp9E[2]=Cyc_PP_text(stop);_tmp9E[1]=Cyc_PP_seq(sep,
ss);_tmp9E[0]=Cyc_PP_text(start);Cyc_PP_cat(_tag_dynforward(_tmp9E,sizeof(struct
Cyc_PP_Doc*),3));});}struct Cyc_PP_Doc*Cyc_PP_egroup(struct _dynforward_ptr start,
struct _dynforward_ptr stop,struct _dynforward_ptr sep,struct Cyc_List_List*ss){if(ss
== 0)return Cyc_PP_nil_doc();else{return({struct Cyc_PP_Doc*_tmp9F[3];_tmp9F[2]=
Cyc_PP_text(stop);_tmp9F[1]=Cyc_PP_seq(sep,ss);_tmp9F[0]=Cyc_PP_text(start);Cyc_PP_cat(
_tag_dynforward(_tmp9F,sizeof(struct Cyc_PP_Doc*),3));});}}struct Cyc_PP_Doc*Cyc_PP_groupl(
struct _dynforward_ptr start,struct _dynforward_ptr stop,struct _dynforward_ptr sep,
...
_tag_dynforward(_tmpA0,sizeof(struct Cyc_PP_Doc*),3));});}
