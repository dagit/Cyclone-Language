...
18];struct Cyc_FileOpenError_struct{char*tag;struct _tagged_arr f1;};struct Cyc_timeval{
...
ru_nsignals;int ru_nvcsw;int ru_nivcsw;};struct Cyc___SIG_BUILTIN_struct{int tag;
void*f1;};struct Cyc___SIG_HANDLER_struct{int tag;void(*f1)(int);};int Cyc_Execinfo_backtrace(
