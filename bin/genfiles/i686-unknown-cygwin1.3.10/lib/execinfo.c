...
extern char Cyc_Core_Open_Region[16];extern char Cyc_Core_Free_Region[16];int Cyc_Execinfo_backtrace(
struct _dynforward_ptr,int);int Cyc_Execinfo_bt();struct Cyc___cycFILE;struct Cyc_Cstdio___abstractFILE;
...
long ru_nsignals;long ru_nvcsw;long ru_nivcsw;};struct Cyc___SIG_BUILTIN_struct{int
tag;void*f1;};struct Cyc___SIG_HANDLER_struct{int tag;void(*f1)(int);};int Cyc_Execinfo_backtrace(
struct _dynforward_ptr array,int size){(int)_throw((void*)({struct Cyc_Core_Failure_struct*
