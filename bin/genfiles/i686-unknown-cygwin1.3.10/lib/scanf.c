...
strtol(char*,char**,int);unsigned long strtoul(char*,char**,int);struct Cyc___cycFILE;
...
struct _dynforward_ptr);int Cyc_ungetc(int,struct Cyc___cycFILE*);int Cyc_vfscanf(
struct Cyc___cycFILE*,struct _dynforward_ptr,struct _dynforward_ptr);int Cyc_vsscanf(
