...
Cyc_getw(struct Cyc___cycFILE*);extern char Cyc_FileCloseError[19];extern char Cyc_FileOpenError[
...
Cyc_Dict_empty(int(*cmp)(void*,void*));struct Cyc_Dict_Dict*Cyc_Dict_rempty(
struct _RegionHandle*,int(*cmp)(void*,void*));int Cyc_Dict_is_empty(struct Cyc_Dict_Dict*
...
Cyc_Dict_T*)_check_null(d->t));}struct _tuple2{void(*f1)(void*,void*);struct Cyc_Dict_Dict*
f2;};static void Cyc_Dict_iter2_f(struct _tuple2*env,void*a,void*b1){struct _tuple2
_tmp98;void(*_tmp99)(void*,void*);struct Cyc_Dict_Dict*_tmp9A;struct _tuple2*
_tmp97=env;_tmp98=*_tmp97;_tmp99=_tmp98.f1;_tmp9A=_tmp98.f2;_tmp99(b1,Cyc_Dict_lookup(
_tmp9A,a));}void Cyc_Dict_iter2(void(*f)(void*,void*),struct Cyc_Dict_Dict*d1,
struct Cyc_Dict_Dict*d2){struct _tuple2 _tmp9B=({struct _tuple2 _tmp9C;_tmp9C.f1=f;
_tmp9C.f2=d2;_tmp9C;});((void(*)(void(*f)(struct _tuple2*,void*,void*),struct
_tuple2*env,struct Cyc_Dict_Dict*d))Cyc_Dict_iter_c)(Cyc_Dict_iter2_f,& _tmp9B,d1);}
...
_tmp9E;void(*_tmp9F)(void*,void*,void*);struct Cyc_Dict_Dict*_tmpA0;void*_tmpA1;
struct _tuple3*_tmp9D=env;_tmp9E=*_tmp9D;_tmp9F=_tmp9E.f1;_tmpA0=_tmp9E.f2;_tmpA1=
_tmp9E.f3;_tmp9F(_tmpA1,b1,Cyc_Dict_lookup(_tmpA0,a));}void Cyc_Dict_iter2_c(void(*
f)(void*,void*,void*),void*inner_env,struct Cyc_Dict_Dict*d1,struct Cyc_Dict_Dict*
...
Cyc_Dict_T*),++ ind))=(struct Cyc_Dict_T*)_tmpE6;if(_tmpE7 != 0)*((struct Cyc_Dict_T**)
...
struct Cyc_Dict_T*_tmp111=*((struct Cyc_Dict_T**)_check_unknown_subscript(_tmp10D,
sizeof(struct Cyc_Dict_T*),_tmp110));*dest=((struct Cyc_Dict_T*)_check_null(
_tmp111))->key_val;-- _tmp110;if((unsigned int)_tmp111->left)*((struct Cyc_Dict_T**)
_check_unknown_subscript(_tmp10D,sizeof(struct Cyc_Dict_T*),++ _tmp110))=_tmp111->left;
if((unsigned int)_tmp111->right)*((struct Cyc_Dict_T**)_check_unknown_subscript(
_tmp10D,sizeof(struct Cyc_Dict_T*),++ _tmp110))=_tmp111->right;*_tmp10F=_tmp110;
return 1;}}}struct Cyc_Iter_Iter Cyc_Dict_make_iter(struct _RegionHandle*rgn,struct
Cyc_Dict_Dict*d){int half_max_size=1;struct Cyc_Dict_T*_tmp112=d->t;while(_tmp112
!= 0){_tmp112=_tmp112->left;++ half_max_size;}_tmp112=d->t;{struct _tagged_arr
_tmp113=({unsigned int _tmp116=(unsigned int)(2 * half_max_size);struct Cyc_Dict_T**
_tmp117=(struct Cyc_Dict_T**)_region_malloc(rgn,_check_times(sizeof(struct Cyc_Dict_T*),
_tmp116));struct _tagged_arr _tmp119=_tag_arr(_tmp117,sizeof(struct Cyc_Dict_T*),
_tmp116);{unsigned int _tmp118=_tmp116;unsigned int i;for(i=0;i < _tmp118;i ++){
_tmp117[i]=_tmp112;}}_tmp119;});return({struct Cyc_Iter_Iter _tmp114;_tmp114.env=(
void*)({struct _tuple10*_tmp115=_region_malloc(rgn,sizeof(*_tmp115));_tmp115->f1=
_tmp113;_tmp115->f2=(unsigned int)_tmp112?0: - 1;_tmp115;});_tmp114.next=(int(*)(
void*env,void*dest))Cyc_Dict_iter_f;_tmp114;});}}void*Cyc_Dict_marshal(struct
...
struct Cyc_Dict_Dict*dict){struct Cyc_List_List*dict_list=Cyc_Dict_rto_list(rgn,
