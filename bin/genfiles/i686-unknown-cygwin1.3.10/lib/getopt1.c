...
static _INLINE void _swap_dyneither(struct _dyneither_ptr *x, 
 ...
 struct Cyc_option{struct _dyneither_ptr name;int has_arg;int*flag;int val;};int Cyc_getopt_long(
int __argc,struct _dyneither_ptr __argv,struct _dyneither_ptr __shortopts,struct
_dyneither_ptr __longopts,int*__longind);int Cyc_getopt_long_only(int __argc,struct
