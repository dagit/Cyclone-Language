...
struct Cyc_Dict_Dict*ae;struct Cyc_Core_Opt*le;};struct Cyc_Tcenv_Genv*Cyc_Tcenv_empty_genv();
...
struct Cyc_Core_Opt*_tmp90=_cycalloc(sizeof(*_tmp90));_tmp90->v=Cyc_Tcenv_new_fenv(
loc,fd);_tmp90;});Cyc_Tcstmt_tcStmt(te,fd->body,0);Cyc_Tcenv_check_delayed_effects(
...
sizeof(void*),0));});goto _LL80;_LL83: if(_tmp93 <= (void*)4  || *((int*)_tmp93)!= 5)
...
_tuple8 _tmp9E;void*_tmp9F;struct _tuple8*_tmp9D=(struct _tuple8*)_tmp9C->hd;_tmp9E=*
_tmp9D;_tmp9F=_tmp9E.f3;{void*_tmpA0=Cyc_Tcutil_compress(_tmp9F);void*_tmpA1;
_LL88: if(_tmpA0 <= (void*)4  || *((int*)_tmpA0)!= 5)goto _LL8A;_tmpA1=(void*)((
...
_tuple8 _tmpA6;void*_tmpA7;struct _tuple8*_tmpA5=(struct _tuple8*)_tmp9C->hd;_tmpA6=*
...
_tmpAB;}),tvs),Cyc_Absyn_empty_tqual(0),((struct Cyc_Absyn_Conref*(*)())Cyc_Absyn_empty_conref)()))
...
_tmpAD));_tmpAD->v=(void*)((void*)3);_tmpAD;}),tvs),Cyc_Absyn_empty_tqual(0),((
...
void*)((void*)3);_tmpAF;}),tvs),Cyc_Absyn_const_tqual(0),((struct Cyc_Absyn_Conref*(*)())
...
_tmpB1;}),tvs),Cyc_Absyn_const_tqual(0),((struct Cyc_Absyn_Conref*(*)())Cyc_Absyn_empty_conref)())))({
...
_tmpD0);Cyc_Tcutil_check_type(loc,te,tvs,(void*)3,0,_tmpD1);if(_tmpD1 == (void*)3)({
void*_tmpD2[0]={};Cyc_Tcutil_terr(loc,({const char*_tmpD3="Currently only allow `U on variables";
_tag_arr(_tmpD3,sizeof(char),_get_zero_arr_size(_tmpD3,37));}),_tag_arr(_tmpD2,
sizeof(void*),0));});}{struct Cyc_List_List*prev_fields=0;struct Cyc_List_List*
_tmpD4=fields;for(0;_tmpD4 != 0;_tmpD4=_tmpD4->tl){struct Cyc_Absyn_Aggrfield
_tmpD6;struct _tagged_arr*_tmpD7;struct Cyc_Absyn_Tqual _tmpD8;void*_tmpD9;struct
Cyc_Absyn_Exp*_tmpDA;struct Cyc_List_List*_tmpDB;struct Cyc_Absyn_Aggrfield*_tmpD5=(
struct Cyc_Absyn_Aggrfield*)_tmpD4->hd;_tmpD6=*_tmpD5;_tmpD7=_tmpD6.name;_tmpD8=
_tmpD6.tq;_tmpD9=(void*)_tmpD6.type;_tmpDA=_tmpD6.width;_tmpDB=_tmpD6.attributes;
if(((int(*)(int(*compare)(struct _tagged_arr*,struct _tagged_arr*),struct Cyc_List_List*
l,struct _tagged_arr*x))Cyc_List_mem)(Cyc_strptrcmp,prev_fields,_tmpD7))({struct
Cyc_String_pa_struct _tmpDE;_tmpDE.tag=0;_tmpDE.f1=(struct _tagged_arr)((struct
_tagged_arr)*_tmpD7);{void*_tmpDC[1]={& _tmpDE};Cyc_Tcutil_terr(loc,({const char*
_tmpDD="duplicate field %s";_tag_arr(_tmpDD,sizeof(char),_get_zero_arr_size(
_tmpDD,19));}),_tag_arr(_tmpDC,sizeof(void*),1));}});if(Cyc_strcmp((struct
_tagged_arr)*_tmpD7,({const char*_tmpDF="";_tag_arr(_tmpDF,sizeof(char),
