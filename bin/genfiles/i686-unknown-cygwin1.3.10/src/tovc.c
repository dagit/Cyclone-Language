...
_tmpA5 == 0)return;_tmpA6=(struct Cyc_Absyn_Exp*)_check_null(_tmpA5);goto _LLE6;
_LLE5: if(_tmpA3 <= (void*)1?1:*((int*)_tmpA3)!= 0)goto _LLE7;_tmpA6=((struct Cyc_Absyn_Exp_s_struct*)
