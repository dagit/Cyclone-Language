...
struct _tuple1*Cyc_Toc_temp_var();struct Cyc_List_List*Cyc_Tovc_tovc(struct Cyc_List_List*
decls);struct Cyc_Tovc_BoxingEnv{struct _RegionHandle*rgn;struct Cyc_List_List*
...
while(1){void*_tmp0=(void*)e->r;struct _tuple1*_tmp1;struct _tuple1 _tmp2;void*
_tmp3;struct _tagged_arr*_tmp4;struct Cyc_Absyn_Exp*_tmp5;struct Cyc_List_List*
...
!= 0;env.all_locals=(env.all_locals)->tl){struct Cyc_Absyn_Vardecl*_tmp1F=(struct
Cyc_Absyn_Vardecl*)(env.all_locals)->hd;if(Cyc_strptrcmp(_tmp4,(*_tmp1F->name).f2)
== 0){{void*_tmp20=(void*)_tmp1F->type;_LL36: if(_tmp20 <= (void*)4  || *((int*)
_tmp20)!= 7)goto _LL38;_LL37: goto _LL35;_LL38:;_LL39:(void*)(e->r=(void*)((void*)(
Cyc_Absyn_deref_exp(Cyc_Absyn_var_exp(_tmp1F->name,0),0))->r));goto _LL35;_LL35:;}*
env.freevars=((struct Cyc_Set_Set*(*)(struct _RegionHandle*r,struct Cyc_Set_Set*s,
struct Cyc_Absyn_Vardecl*elt))Cyc_Set_rinsert)(env.rgn,*env.freevars,_tmp1F);
return;}}(int)_throw((void*)({struct Cyc_Core_Impossible_struct*_tmp21=_cycalloc(
sizeof(*_tmp21));_tmp21[0]=({struct Cyc_Core_Impossible_struct _tmp22;_tmp22.tag=
Cyc_Core_Impossible;_tmp22.f1=(struct _tagged_arr)({struct Cyc_String_pa_struct
_tmp25;_tmp25.tag=0;_tmp25.f1=(struct _tagged_arr)((struct _tagged_arr)*_tmp4);{
void*_tmp23[1]={& _tmp25};Cyc_aprintf(({const char*_tmp24="unbound variable %s found in box_free_vars_exp";
_tag_arr(_tmp24,sizeof(char),_get_zero_arr_size(_tmp24,47));}),_tag_arr(_tmp23,
sizeof(void*),1));}});_tmp22;});_tmp21;}));_LL3: if(*((int*)_tmp0)!= 1)goto _LL5;
_LL4: return;_LL5: if(*((int*)_tmp0)!= 0)goto _LL7;_LL6: return;_LL7: if(*((int*)
_tmp0)!= 11)goto _LL9;_tmp5=((struct Cyc_Absyn_FnCall_e_struct*)_tmp0)->f1;_tmp6=((
...
_tag_arr(_tmp28,sizeof(char),_get_zero_arr_size(_tmp28,40));});_tmp27;});_tmp26;}));
_LL0:;}}static void Cyc_Tovc_box_free_vars_stmt(struct Cyc_Tovc_BoxingEnv env,struct
Cyc_Absyn_Stmt*s){while(1){void*_tmp29=(void*)s->r;struct Cyc_Absyn_Stmt*_tmp2A;
struct Cyc_Absyn_Exp*_tmp2B;struct Cyc_Absyn_Exp*_tmp2C;struct Cyc_Absyn_Stmt*
...
goto _LL3D;_LL3C: goto _LL3E;_LL3D: if(_tmp29 <= (void*)1  || *((int*)_tmp29)!= 5)goto
_LL3F;_LL3E: goto _LL40;_LL3F: if(_tmp29 <= (void*)1  || *((int*)_tmp29)!= 6)goto
_LL41;_LL40: return;_LL41: if(_tmp29 <= (void*)1  || *((int*)_tmp29)!= 7)goto _LL43;
_LL42: return;_LL43: if(_tmp29 <= (void*)1  || *((int*)_tmp29)!= 12)goto _LL45;_tmp2A=((
struct Cyc_Absyn_Label_s_struct*)_tmp29)->f2;_LL44: s=_tmp2A;continue;_LL45: if(
_tmp29 <= (void*)1  || *((int*)_tmp29)!= 2)goto _LL47;_tmp2B=((struct Cyc_Absyn_Return_s_struct*)
_tmp29)->f1;_LL46: if(_tmp2B == 0)return;_tmp2C=(struct Cyc_Absyn_Exp*)_tmp2B;goto
_LL48;_LL47: if(_tmp29 <= (void*)1  || *((int*)_tmp29)!= 0)goto _LL49;_tmp2C=((
struct Cyc_Absyn_Exp_s_struct*)_tmp29)->f1;_LL48: Cyc_Tovc_box_free_vars_exp(env,
_tmp2C);return;_LL49: if(_tmp29 <= (void*)1  || *((int*)_tmp29)!= 1)goto _LL4B;
_tmp2D=((struct Cyc_Absyn_Seq_s_struct*)_tmp29)->f1;_tmp2E=((struct Cyc_Absyn_Seq_s_struct*)
_tmp29)->f2;_LL4A: Cyc_Tovc_box_free_vars_stmt(env,_tmp2D);s=_tmp2E;continue;
_LL4B: if(_tmp29 <= (void*)1  || *((int*)_tmp29)!= 3)goto _LL4D;_tmp2F=((struct Cyc_Absyn_IfThenElse_s_struct*)
_tmp29)->f1;_tmp30=((struct Cyc_Absyn_IfThenElse_s_struct*)_tmp29)->f2;_tmp31=((
struct Cyc_Absyn_IfThenElse_s_struct*)_tmp29)->f3;_LL4C: Cyc_Tovc_box_free_vars_exp(
env,_tmp2F);Cyc_Tovc_box_free_vars_stmt(env,_tmp30);s=_tmp31;continue;_LL4D: if(
_tmp29 <= (void*)1  || *((int*)_tmp29)!= 4)goto _LL4F;_tmp32=((struct Cyc_Absyn_While_s_struct*)
_tmp29)->f1;_tmp33=_tmp32.f1;_tmp34=((struct Cyc_Absyn_While_s_struct*)_tmp29)->f2;
_LL4E: Cyc_Tovc_box_free_vars_exp(env,_tmp33);s=_tmp34;continue;_LL4F: if(_tmp29 <= (
void*)1  || *((int*)_tmp29)!= 8)goto _LL51;_tmp35=((struct Cyc_Absyn_For_s_struct*)
_tmp29)->f1;_tmp36=((struct Cyc_Absyn_For_s_struct*)_tmp29)->f2;_tmp37=_tmp36.f1;
_tmp38=((struct Cyc_Absyn_For_s_struct*)_tmp29)->f3;_tmp39=_tmp38.f1;_tmp3A=((
struct Cyc_Absyn_For_s_struct*)_tmp29)->f4;_LL50: Cyc_Tovc_box_free_vars_exp(env,
_tmp35);Cyc_Tovc_box_free_vars_exp(env,_tmp37);Cyc_Tovc_box_free_vars_exp(env,
_tmp39);s=_tmp3A;continue;_LL51: if(_tmp29 <= (void*)1  || *((int*)_tmp29)!= 13)
goto _LL53;_tmp3B=((struct Cyc_Absyn_Do_s_struct*)_tmp29)->f1;_tmp3C=((struct Cyc_Absyn_Do_s_struct*)
_tmp29)->f2;_tmp3D=_tmp3C.f1;_LL52: Cyc_Tovc_box_free_vars_exp(env,_tmp3D);s=
_tmp3B;continue;_LL53: if(_tmp29 <= (void*)1  || *((int*)_tmp29)!= 9)goto _LL55;
_tmp3E=((struct Cyc_Absyn_Switch_s_struct*)_tmp29)->f1;_tmp3F=((struct Cyc_Absyn_Switch_s_struct*)
_tmp29)->f2;_LL54: Cyc_Tovc_box_free_vars_exp(env,_tmp3E);for(0;_tmp3F != 0;_tmp3F=
_tmp3F->tl){Cyc_Tovc_box_free_vars_stmt(env,((struct Cyc_Absyn_Switch_clause*)
_tmp3F->hd)->body);}return;_LL55: if(_tmp29 <= (void*)1  || *((int*)_tmp29)!= 11)
goto _LL57;_tmp40=((struct Cyc_Absyn_Decl_s_struct*)_tmp29)->f1;_tmp41=((struct Cyc_Absyn_Decl_s_struct*)
_tmp29)->f2;_LL56:{void*_tmp42=(void*)_tmp40->r;struct Cyc_Absyn_Vardecl*_tmp43;
_LL5A: if(_tmp42 <= (void*)2  || *((int*)_tmp42)!= 0)goto _LL5C;_tmp43=((struct Cyc_Absyn_Var_d_struct*)
_tmp42)->f1;_LL5B: env.boundvars=({struct Cyc_List_List*_tmp44=_region_malloc(env.rgn,
sizeof(*_tmp44));_tmp44->hd=_tmp43;_tmp44->tl=env.boundvars;_tmp44;});env.varmap=((
...
const char*_tmp47="bad stmt after xlation to C";_tag_arr(_tmp47,sizeof(char),
_get_zero_arr_size(_tmp47,28));});_tmp46;});_tmp45;}));_LL3A:;}}struct _tuple5{
...
struct Cyc_Tovc_BoxingEnv _tmp48=({struct Cyc_Tovc_BoxingEnv _tmp59;_tmp59.rgn=env.rgn;
_tmp59.all_locals=env.all_locals;_tmp59.varmap=env.varmap;_tmp59.boundvars=0;
_tmp59.freevars=& freevars;_tmp59;});Cyc_Tovc_box_free_vars_stmt(_tmp48,s);{
...
Cyc_Absyn_cstar_typ(_tmp4D,Cyc_Absyn_empty_tqual(0));_tmp4F;});_tmp4E->tl=params;
_tmp4E;});args=({struct Cyc_List_List*_tmp50=_cycalloc(sizeof(*_tmp50));_tmp50->hd=
Cyc_Absyn_var_exp(_tmp4A->name,0);_tmp50->tl=args;_tmp50;});goto _LL5E;_LL61:;
_LL62: params=({struct Cyc_List_List*_tmp51=_cycalloc(sizeof(*_tmp51));_tmp51->hd=({
struct _tuple5*_tmp52=_cycalloc(sizeof(*_tmp52));_tmp52->f1=(*_tmp4A->name).f2;
_tmp52->f2=_tmp4A->tq;_tmp52->f3=Cyc_Absyn_cstar_typ((void*)_tmp4A->type,Cyc_Absyn_empty_tqual(
0));_tmp52;});_tmp51->tl=params;_tmp51;});args=({struct Cyc_List_List*_tmp53=
_cycalloc(sizeof(*_tmp53));_tmp53->hd=Cyc_Absyn_address_exp(Cyc_Absyn_var_exp(
_tmp4A->name,0),0);_tmp53->tl=args;_tmp53;});goto _LL5E;_LL5E:;}{struct _tuple1*
funname=Cyc_Toc_temp_var();*env.gen_ds=({struct Cyc_List_List*_tmp54=_cycalloc(
sizeof(*_tmp54));_tmp54->hd=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Fn_d_struct*
_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55[0]=({struct Cyc_Absyn_Fn_d_struct _tmp56;
_tmp56.tag=1;_tmp56.f1=({struct Cyc_Absyn_Fndecl*_tmp57=_cycalloc(sizeof(*_tmp57));
_tmp57->sc=(void*)((void*)0);_tmp57->is_inline=1;_tmp57->name=funname;_tmp57->tvs=
0;_tmp57->effect=0;_tmp57->ret_type=(void*)rettype;_tmp57->args=params;_tmp57->c_varargs=
0;_tmp57->cyc_varargs=0;_tmp57->rgn_po=0;_tmp57->body=s;_tmp57->cached_typ=0;
_tmp57->param_vardecls=0;_tmp57->attributes=0;_tmp57;});_tmp56;});_tmp55;}),0);
_tmp54->tl=*env.gen_ds;_tmp54;});return Cyc_Absyn_fncall_exp(Cyc_Absyn_var_exp(
funname,0),args,0);}}}static void Cyc_Tovc_apply_varmap(struct Cyc_Dict_Dict*varmap,
struct Cyc_Absyn_Exp*e){void*_tmp5A=(void*)e->r;struct _tuple1*_tmp5B;struct
_tuple1 _tmp5C;void*_tmp5D;struct _tagged_arr*_tmp5E;struct Cyc_Absyn_Exp*_tmp5F;
struct Cyc_List_List*_tmp60;struct Cyc_List_List*_tmp61;struct Cyc_Absyn_Exp*_tmp62;
...
struct Cyc_Absyn_Exp*_tmp6F;struct Cyc_Absyn_Exp*_tmp70;struct Cyc_Absyn_Exp*_tmp71;
struct Cyc_Absyn_Exp*_tmp72;struct Cyc_Absyn_Exp*_tmp73;struct Cyc_Absyn_Exp*_tmp74;
struct Cyc_Absyn_Exp*_tmp75;struct Cyc_Absyn_Exp*_tmp76;struct Cyc_Absyn_Exp*_tmp77;
struct Cyc_List_List*_tmp78;_LL64: if(*((int*)_tmp5A)!= 1)goto _LL66;_tmp5B=((
struct Cyc_Absyn_Var_e_struct*)_tmp5A)->f1;_tmp5C=*_tmp5B;_tmp5D=_tmp5C.f1;if((
int)_tmp5D != 0)goto _LL66;_tmp5E=_tmp5C.f2;_LL65: if(((int(*)(struct Cyc_Dict_Dict*
d,struct _tagged_arr*k))Cyc_Dict_member)(varmap,_tmp5E))(void*)(e->r=(void*)((
void*)(((struct Cyc_Absyn_Exp*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k))Cyc_Dict_lookup)(
varmap,_tmp5E))->r));return;_LL66: if(*((int*)_tmp5A)!= 1)goto _LL68;_LL67: return;
_LL68: if(*((int*)_tmp5A)!= 0)goto _LL6A;_LL69: return;_LL6A: if(*((int*)_tmp5A)!= 
11)goto _LL6C;_tmp5F=((struct Cyc_Absyn_FnCall_e_struct*)_tmp5A)->f1;_tmp60=((
struct Cyc_Absyn_FnCall_e_struct*)_tmp5A)->f2;_LL6B: Cyc_Tovc_apply_varmap(varmap,
_tmp5F);_tmp61=_tmp60;goto _LL6D;_LL6C: if(*((int*)_tmp5A)!= 3)goto _LL6E;_tmp61=((
struct Cyc_Absyn_Primop_e_struct*)_tmp5A)->f2;_LL6D: for(0;_tmp61 != 0;_tmp61=
_tmp61->tl){Cyc_Tovc_apply_varmap(varmap,(struct Cyc_Absyn_Exp*)_tmp61->hd);}
...
_tmp7A.f1=({const char*_tmp7B="bad exp form in Tocv::apply_varmap";_tag_arr(
_tmp7B,sizeof(char),_get_zero_arr_size(_tmp7B,35));});_tmp7A;});_tmp79;}));_LL63:;}
static struct Cyc_Absyn_Exp*Cyc_Tovc_stmt_to_exp(struct Cyc_Tovc_ToExpEnv env,struct
Cyc_Absyn_Stmt*s){void*_tmp7C=(void*)s->r;struct Cyc_Absyn_Exp*_tmp7D;struct Cyc_Absyn_Stmt*
...
_LL9B: if(_tmp7C <= (void*)1  || *((int*)_tmp7C)!= 0)goto _LL9D;_tmp7D=((struct Cyc_Absyn_Exp_s_struct*)
_tmp7C)->f1;_LL9C: Cyc_Tovc_apply_varmap(env.varmap,_tmp7D);return _tmp7D;_LL9D:
if(_tmp7C <= (void*)1  || *((int*)_tmp7C)!= 1)goto _LL9F;_tmp7E=((struct Cyc_Absyn_Seq_s_struct*)
...
_tmp7C <= (void*)1  || *((int*)_tmp7C)!= 3)goto _LLA1;_tmp80=((struct Cyc_Absyn_IfThenElse_s_struct*)
_tmp7C)->f1;_tmp81=((struct Cyc_Absyn_IfThenElse_s_struct*)_tmp7C)->f2;_tmp82=((
struct Cyc_Absyn_IfThenElse_s_struct*)_tmp7C)->f3;_LLA0: Cyc_Tovc_apply_varmap(env.varmap,
_tmp80);return Cyc_Absyn_conditional_exp(_tmp80,Cyc_Tovc_stmt_to_exp(env,_tmp81),
Cyc_Tovc_stmt_to_exp(env,_tmp82),0);_LLA1: if(_tmp7C <= (void*)1  || *((int*)_tmp7C)
!= 11)goto _LLA3;_tmp83=((struct Cyc_Absyn_Decl_s_struct*)_tmp7C)->f1;_tmp84=((
struct Cyc_Absyn_Decl_s_struct*)_tmp7C)->f2;_LLA2: {void*_tmp85=(void*)_tmp83->r;
struct Cyc_Absyn_Vardecl*_tmp86;_LLA6: if(_tmp85 <= (void*)2  || *((int*)_tmp85)!= 0)
goto _LLA8;_tmp86=((struct Cyc_Absyn_Var_d_struct*)_tmp85)->f1;_LLA7: {struct
_tagged_arr*_tmp87=(*_tmp86->name).f2;struct _tuple1*_tmp88=Cyc_Toc_temp_var();
_tmp86->name=_tmp88;env.varmap=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,
struct _tagged_arr*k,struct Cyc_Absyn_Exp*v))Cyc_Dict_insert)(env.varmap,_tmp87,
Cyc_Absyn_var_exp(_tmp88,0));if(_tmp86->initializer != 0){Cyc_Tovc_apply_varmap(
...
_tag_arr(_tmp8F,sizeof(char),_get_zero_arr_size(_tmp8F,36));});_tmp8E;});_tmp8D;}));
_LLA5:;}_LLA3:;_LLA4: return Cyc_Tovc_stmt_to_fun(env,s,(void*)0);_LL98:;}static
...
const char*_tmpAE="bad exp form after xlation to C";_tag_arr(_tmpAE,sizeof(char),
_get_zero_arr_size(_tmpAE,32));});_tmpAD;});_tmpAC;}));_LLAF:;}static void Cyc_Tovc_stmt_to_vc(
struct Cyc_Tovc_ToExpEnv env,struct Cyc_Absyn_Stmt*s){while(1){env.encloser=s;{void*
_tmpAF=(void*)s->r;struct Cyc_Absyn_Stmt*_tmpB0;struct Cyc_Absyn_Exp*_tmpB1;struct
Cyc_Absyn_Exp*_tmpB2;struct Cyc_Absyn_Stmt*_tmpB3;struct Cyc_Absyn_Stmt*_tmpB4;
struct Cyc_Absyn_Exp*_tmpB5;struct Cyc_Absyn_Stmt*_tmpB6;struct Cyc_Absyn_Stmt*
_tmpB7;struct _tuple3 _tmpB8;struct Cyc_Absyn_Exp*_tmpB9;struct Cyc_Absyn_Stmt*
_tmpBA;struct Cyc_Absyn_Exp*_tmpBB;struct _tuple3 _tmpBC;struct Cyc_Absyn_Exp*_tmpBD;
struct _tuple3 _tmpBE;struct Cyc_Absyn_Exp*_tmpBF;struct Cyc_Absyn_Stmt*_tmpC0;
struct Cyc_Absyn_Stmt*_tmpC1;struct _tuple3 _tmpC2;struct Cyc_Absyn_Exp*_tmpC3;
struct Cyc_Absyn_Exp*_tmpC4;struct Cyc_List_List*_tmpC5;struct Cyc_Absyn_Decl*
_tmpC6;struct Cyc_Absyn_Stmt*_tmpC7;_LLE5: if((int)_tmpAF != 0)goto _LLE7;_LLE6: goto
_LLE8;_LLE7: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)!= 5)goto _LLE9;_LLE8: goto
_LLEA;_LLE9: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)!= 6)goto _LLEB;_LLEA: goto
_LLEC;_LLEB: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)!= 7)goto _LLED;_LLEC: return;
_LLED: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)!= 12)goto _LLEF;_tmpB0=((struct Cyc_Absyn_Label_s_struct*)
_tmpAF)->f2;_LLEE: s=_tmpB0;continue;_LLEF: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)
!= 2)goto _LLF1;_tmpB1=((struct Cyc_Absyn_Return_s_struct*)_tmpAF)->f1;_LLF0: if(
_tmpB1 == 0)return;_tmpB2=(struct Cyc_Absyn_Exp*)_tmpB1;goto _LLF2;_LLF1: if(_tmpAF
<= (void*)1  || *((int*)_tmpAF)!= 0)goto _LLF3;_tmpB2=((struct Cyc_Absyn_Exp_s_struct*)
_tmpAF)->f1;_LLF2: Cyc_Tovc_exp_to_vc(env,_tmpB2);return;_LLF3: if(_tmpAF <= (void*)
1  || *((int*)_tmpAF)!= 1)goto _LLF5;_tmpB3=((struct Cyc_Absyn_Seq_s_struct*)_tmpAF)->f1;
_tmpB4=((struct Cyc_Absyn_Seq_s_struct*)_tmpAF)->f2;_LLF4: Cyc_Tovc_stmt_to_vc(env,
_tmpB3);s=_tmpB4;continue;_LLF5: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)!= 3)goto
_LLF7;_tmpB5=((struct Cyc_Absyn_IfThenElse_s_struct*)_tmpAF)->f1;_tmpB6=((struct
Cyc_Absyn_IfThenElse_s_struct*)_tmpAF)->f2;_tmpB7=((struct Cyc_Absyn_IfThenElse_s_struct*)
_tmpAF)->f3;_LLF6: Cyc_Tovc_exp_to_vc(env,_tmpB5);Cyc_Tovc_stmt_to_vc(env,_tmpB6);
s=_tmpB7;continue;_LLF7: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)!= 4)goto _LLF9;
_tmpB8=((struct Cyc_Absyn_While_s_struct*)_tmpAF)->f1;_tmpB9=_tmpB8.f1;_tmpBA=((
struct Cyc_Absyn_While_s_struct*)_tmpAF)->f2;_LLF8: Cyc_Tovc_exp_to_vc(env,_tmpB9);
s=_tmpBA;continue;_LLF9: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)!= 8)goto _LLFB;
_tmpBB=((struct Cyc_Absyn_For_s_struct*)_tmpAF)->f1;_tmpBC=((struct Cyc_Absyn_For_s_struct*)
...
_tmpC0;continue;_LLFB: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)!= 13)goto _LLFD;
_tmpC1=((struct Cyc_Absyn_Do_s_struct*)_tmpAF)->f1;_tmpC2=((struct Cyc_Absyn_Do_s_struct*)
_tmpAF)->f2;_tmpC3=_tmpC2.f1;_LLFC: Cyc_Tovc_exp_to_vc(env,_tmpC3);s=_tmpC1;
continue;_LLFD: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)!= 9)goto _LLFF;_tmpC4=((
struct Cyc_Absyn_Switch_s_struct*)_tmpAF)->f1;_tmpC5=((struct Cyc_Absyn_Switch_s_struct*)
_tmpAF)->f2;_LLFE: Cyc_Tovc_exp_to_vc(env,_tmpC4);for(0;_tmpC5 != 0;_tmpC5=_tmpC5->tl){
Cyc_Tovc_stmt_to_vc(env,((struct Cyc_Absyn_Switch_clause*)_tmpC5->hd)->body);}
return;_LLFF: if(_tmpAF <= (void*)1  || *((int*)_tmpAF)!= 11)goto _LL101;_tmpC6=((
...
struct Cyc_Absyn_Exp*arr=Cyc_Absyn_var_exp(_tmpC9->name,0);struct Cyc_Absyn_Stmt*
s3=Cyc_Absyn_new_stmt((void*)_tmpC7->r,0);{unsigned int i=0;for(0;_tmpCC != 0;(
_tmpCC=_tmpCC->tl,++ i)){s3=Cyc_Absyn_seq_stmt(Cyc_Absyn_exp_stmt(Cyc_Absyn_assign_exp(
Cyc_Absyn_subscript_exp(arr,Cyc_Absyn_uint_exp(i,0),0),(*((struct _tuple4*)_tmpCC->hd)).f2,
0),0),s3,0);}}(void*)(_tmpC7->r=(void*)((void*)s3->r));goto _LL10D;}_LL110:;
_LL111:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*_tmpCD=_cycalloc(
sizeof(*_tmpCD));_tmpCD[0]=({struct Cyc_Core_Impossible_struct _tmpCE;_tmpCE.tag=
Cyc_Core_Impossible;_tmpCE.f1=({const char*_tmpCF="array type bad initializer";
_tag_arr(_tmpCF,sizeof(char),_get_zero_arr_size(_tmpCF,27));});_tmpCE;});_tmpCD;}));
_LL10D:;}goto _LL108;_LL10B:;_LL10C: goto _LL108;_LL108:;}env.all_locals=({struct
Cyc_List_List*_tmpD0=_region_malloc(env.rgn,sizeof(*_tmpD0));_tmpD0->hd=_tmpC9;
_tmpD0->tl=env.all_locals;_tmpD0;});if(_tmpC9->initializer != 0)Cyc_Tovc_exp_to_vc(
...
const char*_tmpD3="bad stmt after xlation to C";_tag_arr(_tmpD3,sizeof(char),
_get_zero_arr_size(_tmpD3,28));});_tmpD2;});_tmpD1;}));_LLE4:;}}}struct Cyc_List_List*
...
_tmpDB;_LL113: if(_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 1)goto _LL115;_tmpD7=((
struct Cyc_Absyn_Fn_d_struct*)_tmpD6)->f1;_LL114:{struct _RegionHandle _tmpDC=
_new_region("rgn");struct _RegionHandle*rgn=& _tmpDC;_push_region(rgn);{struct Cyc_List_List**
_tmpDD=({struct Cyc_List_List**_tmpDF=_region_malloc(rgn,sizeof(*_tmpDF));_tmpDF[
0]=0;_tmpDF;});Cyc_Tovc_stmt_to_vc(({struct Cyc_Tovc_ToExpEnv _tmpDE;_tmpDE.rgn=
rgn;_tmpDE.all_locals=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*
x))Cyc_List_rcopy)(rgn,(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(
_tmpD7->param_vardecls))->v);_tmpDE.varmap=((struct Cyc_Dict_Dict*(*)(struct
_RegionHandle*,int(*cmp)(struct _tagged_arr*,struct _tagged_arr*)))Cyc_Dict_rempty)(
rgn,Cyc_strptrcmp);_tmpDE.encloser=_tmpD7->body;_tmpDE.gen_ds=_tmpDD;_tmpDE;}),
_tmpD7->body);_tmpD4=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*
y))Cyc_List_append)(*_tmpDD,_tmpD4);};_pop_region(rgn);}goto _LL116;_LL115: if(
_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 0)goto _LL117;_LL116: goto _LL118;_LL117: if(
_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 2)goto _LL119;_LL118: goto _LL11A;_LL119: if(
_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 3)goto _LL11B;_LL11A: goto _LL11C;_LL11B: if(
_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 4)goto _LL11D;_LL11C: goto _LL11E;_LL11D: if(
_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 5)goto _LL11F;_LL11E: goto _LL120;_LL11F: if(
_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 6)goto _LL121;_LL120: goto _LL122;_LL121: if(
_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 7)goto _LL123;_LL122: _tmpD4=({struct Cyc_List_List*
_tmpE0=_cycalloc(sizeof(*_tmpE0));_tmpE0->hd=_tmpD5;_tmpE0->tl=_tmpD4;_tmpE0;});
goto _LL112;_LL123: if(_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 8)goto _LL125;_tmpD8=((
struct Cyc_Absyn_Namespace_d_struct*)_tmpD6)->f2;_LL124: _tmpD9=_tmpD8;goto _LL126;
_LL125: if(_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 9)goto _LL127;_tmpD9=((struct Cyc_Absyn_Using_d_struct*)
_tmpD6)->f2;_LL126: _tmpDA=_tmpD9;goto _LL128;_LL127: if(_tmpD6 <= (void*)2  || *((
int*)_tmpD6)!= 10)goto _LL129;_tmpDA=((struct Cyc_Absyn_ExternC_d_struct*)_tmpD6)->f1;
_LL128: _tmpDB=_tmpDA;goto _LL12A;_LL129: if(_tmpD6 <= (void*)2  || *((int*)_tmpD6)!= 
11)goto _LL12B;_tmpDB=((struct Cyc_Absyn_ExternCinclude_d_struct*)_tmpD6)->f1;
_LL12A: goto _LL12C;_LL12B: if((int)_tmpD6 != 0)goto _LL12D;_LL12C: goto _LL12E;_LL12D:
if((int)_tmpD6 != 1)goto _LL112;_LL12E:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tag_arr(_tmpE3,sizeof(char),_get_zero_arr_size(_tmpE3,47));});_tmpE2;});_tmpE1;}));
_LL112:;}return((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(
_tmpD4);}
