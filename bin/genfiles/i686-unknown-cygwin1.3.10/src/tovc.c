...
dest);};int Cyc_Iter_next(struct Cyc_Iter_Iter,void*);struct Cyc___cycFILE;extern
...
_tmp3;struct _dyneither_ptr*_tmp4;struct Cyc_Absyn_Exp*_tmp5;struct Cyc_List_List*
...
Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_member)(env.varmap,_tmp4)){(void*)(
e->r=(void*)((void*)(((struct Cyc_Absyn_Exp*(*)(struct Cyc_Dict_Dict d,struct
_dyneither_ptr*k))Cyc_Dict_lookup)(env.varmap,_tmp4))->r));continue;}{int i=0;
for(0;i < _get_dyneither_size(Cyc_Toc_globals,sizeof(struct _dyneither_ptr*));++ i){
if(Cyc_strptrcmp(_tmp4,*((struct _dyneither_ptr**)_check_dyneither_subscript(Cyc_Toc_globals,
...
Cyc_Core_Impossible;_tmp22.f1=(struct _dyneither_ptr)({struct Cyc_String_pa_struct
_tmp25;_tmp25.tag=0;_tmp25.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
_tmp4);{void*_tmp23[1]={& _tmp25};Cyc_aprintf(({const char*_tmp24="unbound variable %s found in box_free_vars_exp";
_tag_dyneither(_tmp24,sizeof(char),47);}),_tag_dyneither(_tmp23,sizeof(void*),1));}});
_tmp22;});_tmp21;}));}return;_LL3: if(*((int*)_tmp0)!= 1)goto _LL5;_LL4: return;
...
_tag_dyneither(_tmp28,sizeof(char),40);});_tmp27;});_tmp26;}));_LL0:;}}static
...
const char*_tmp47="bad stmt after xlation to C";_tag_dyneither(_tmp47,sizeof(char),
28);});_tmp46;});_tmp45;}));_LL3A:;}}static int Cyc_Tovc_stmt_to_fun_cmp(struct Cyc_Absyn_Vardecl*
x,struct Cyc_Absyn_Vardecl*y){return Cyc_Absyn_qvar_cmp(x->name,y->name);}struct
_tuple5{struct _dyneither_ptr*f1;struct Cyc_Absyn_Tqual f2;void*f3;};static struct
...
Cyc_Set_rempty)(env.rgn,Cyc_Tovc_stmt_to_fun_cmp);struct Cyc_Tovc_BoxingEnv _tmp48=({
struct Cyc_Tovc_BoxingEnv _tmp59;_tmp59.rgn=env.rgn;_tmp59.all_locals=env.all_locals;
_tmp59.varmap=env.varmap;_tmp59.boundvars=0;_tmp59.freevars=& freevars;_tmp59;});
...
struct Cyc_Absyn_Vardecl*_tmp4A=({struct Cyc_Absyn_Vardecl*_tmp58=_cycalloc(
sizeof(*_tmp58));_tmp58->sc=(void*)((void*)2);_tmp58->name=Cyc_Absyn_exn_name;
...
_tmp7A.f1=({const char*_tmp7B="bad exp form in Tocv::apply_varmap";_tag_dyneither(
_tmp7B,sizeof(char),35);});_tmp7A;});_tmp79;}));_LL63:;}static struct Cyc_Absyn_Exp*
Cyc_Tovc_stmt_to_exp(struct Cyc_Tovc_ToExpEnv env,struct Cyc_Absyn_Stmt*s){void*
_tmp7C=(void*)s->r;struct Cyc_Absyn_Exp*_tmp7D;struct Cyc_Absyn_Stmt*_tmp7E;struct
Cyc_Absyn_Stmt*_tmp7F;struct Cyc_Absyn_Exp*_tmp80;struct Cyc_Absyn_Stmt*_tmp81;
struct Cyc_Absyn_Stmt*_tmp82;struct Cyc_Absyn_Decl*_tmp83;struct Cyc_Absyn_Stmt*
...
_tag_dyneither(_tmp92,sizeof(char),36);});_tmp91;});_tmp90;}));_LLA5:;}_LLA3:;
_LLA4: return Cyc_Tovc_stmt_to_fun(env,s,(void*)0);_LL98:;}static void Cyc_Tovc_stmt_to_vc(
...
return;_LLE2:;_LLE3:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*_tmpAF=
_cycalloc(sizeof(*_tmpAF));_tmpAF[0]=({struct Cyc_Core_Impossible_struct _tmpB0;
_tmpB0.tag=Cyc_Core_Impossible;_tmpB0.f1=({const char*_tmpB1="bad exp form after xlation to C";
_tag_dyneither(_tmpB1,sizeof(char),32);});_tmpB0;});_tmpAF;}));_LLAF:;}static
...
_tag_dyneither(_tmpD2,sizeof(char),27);});_tmpD1;});_tmpD0;}));_LL10D:;}goto
_LL108;_LL10B:;_LL10C: goto _LL108;_LL108:;}if(_tmpCC->initializer != 0)Cyc_Tovc_exp_to_vc(
env,(struct Cyc_Absyn_Exp*)_check_null(_tmpCC->initializer));env.all_locals=({
struct Cyc_List_List*_tmpD3=_region_malloc(env.rgn,sizeof(*_tmpD3));_tmpD3->hd=
_tmpCC;_tmpD3->tl=env.all_locals;_tmpD3;});s=_tmpCA;continue;_LL106:;_LL107: goto
_LL103;_LL103:;}goto _LL102;_LL101:;_LL102:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
_tmpD4=_cycalloc(sizeof(*_tmpD4));_tmpD4[0]=({struct Cyc_Core_Impossible_struct
_tmpD5;_tmpD5.tag=Cyc_Core_Impossible;_tmpD5.f1=({const char*_tmpD6="bad stmt after xlation to C";
_tag_dyneither(_tmpD6,sizeof(char),28);});_tmpD5;});_tmpD4;}));_LLE4:;}}}struct
...
_tmpDD;struct Cyc_List_List*_tmpDE;_LL113: if(_tmpD9 <= (void*)2)goto _LL12F;if(*((
...
_tmpEA=_cycalloc(sizeof(*_tmpEA));_tmpEA->sc=(void*)((void*)_tmpDA->sc);_tmpEA->name=
_tmpDA->name;_tmpEA->tq=Cyc_Absyn_const_tqual(0);_tmpEA->type=(void*)Cyc_Tcutil_fndecl2typ(
_tmpDA);_tmpEA->initializer=0;_tmpEA->rgn=0;_tmpEA->attributes=_tmpDA->attributes;
_tmpEA->escapes=0;_tmpEA;});_tmpD7=({struct Cyc_List_List*_tmpDF=_cycalloc(
...
_tmpE1.tag=0;_tmpE1.f1=vd;_tmpE1;});_tmpE0;}),0);_tmpDF->tl=_tmpD7;_tmpDF;});if(
_tmpDA->param_vardecls == 0)_tmpD7=({struct Cyc_List_List*_tmpE2=_cycalloc(sizeof(*
_tmpE2));_tmpE2->hd=_tmpD8;_tmpE2->tl=_tmpD7;_tmpE2;});else{struct _RegionHandle
_tmpE3=_new_region("rgn");struct _RegionHandle*rgn=& _tmpE3;_push_region(rgn);{
struct Cyc_List_List**_tmpE4=({struct Cyc_List_List**_tmpE9=_region_malloc(rgn,
sizeof(*_tmpE9));_tmpE9[0]=0;_tmpE9;});if(_tmpDA->param_vardecls == 0){({struct
Cyc_String_pa_struct _tmpE7;_tmpE7.tag=0;_tmpE7.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*(*_tmpDA->name).f2);{void*_tmpE5[1]={& _tmpE7};Cyc_fprintf(Cyc_stderr,({
const char*_tmpE6="No param vardecls for function %s\n";_tag_dyneither(_tmpE6,
sizeof(char),35);}),_tag_dyneither(_tmpE5,sizeof(void*),1));}});Cyc_fflush((
struct Cyc___cycFILE*)Cyc_stderr);}Cyc_Tovc_stmt_to_vc(({struct Cyc_Tovc_ToExpEnv
_tmpE8;_tmpE8.rgn=rgn;_tmpE8.all_locals=((struct Cyc_List_List*(*)(struct
_RegionHandle*,struct Cyc_List_List*x))Cyc_List_rcopy)(rgn,(struct Cyc_List_List*)((
struct Cyc_Core_Opt*)_check_null(_tmpDA->param_vardecls))->v);_tmpE8.varmap=((
struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _dyneither_ptr*,
struct _dyneither_ptr*)))Cyc_Dict_rempty)(rgn,Cyc_strptrcmp);_tmpE8.encloser=
_tmpDA->body;_tmpE8.gen_ds=_tmpE4;_tmpE8;}),_tmpDA->body);_tmpD7=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(*_tmpE4,_tmpD7);};
...
int*)_tmpD9)!= 7)goto _LL123;_LL122: goto _LL124;_LL123: if(*((int*)_tmpD9)!= 8)goto
_LL125;_LL124: goto _LL126;_LL125: if(*((int*)_tmpD9)!= 9)goto _LL127;_LL126: _tmpD7=({
struct Cyc_List_List*_tmpEB=_cycalloc(sizeof(*_tmpEB));_tmpEB->hd=_tmpD8;_tmpEB->tl=
_tmpD7;_tmpEB;});goto _LL112;_LL127: if(*((int*)_tmpD9)!= 10)goto _LL129;_tmpDB=((
struct Cyc_Absyn_Namespace_d_struct*)_tmpD9)->f2;_LL128: _tmpDC=_tmpDB;goto _LL12A;
_LL129: if(*((int*)_tmpD9)!= 11)goto _LL12B;_tmpDC=((struct Cyc_Absyn_Using_d_struct*)
_tmpD9)->f2;_LL12A: _tmpDD=_tmpDC;goto _LL12C;_LL12B: if(*((int*)_tmpD9)!= 12)goto
_LL12D;_tmpDD=((struct Cyc_Absyn_ExternC_d_struct*)_tmpD9)->f1;_LL12C: _tmpDE=
_tmpDD;goto _LL12E;_LL12D: if(*((int*)_tmpD9)!= 13)goto _LL12F;_tmpDE=((struct Cyc_Absyn_ExternCinclude_d_struct*)
_tmpD9)->f1;_LL12E: goto _LL130;_LL12F: if((int)_tmpD9 != 0)goto _LL131;_LL130: goto
_LL132;_LL131: if((int)_tmpD9 != 1)goto _LL112;_LL132:(int)_throw((void*)({struct
Cyc_Core_Impossible_struct*_tmpEC=_cycalloc(sizeof(*_tmpEC));_tmpEC[0]=({struct
Cyc_Core_Impossible_struct _tmpED;_tmpED.tag=Cyc_Core_Impossible;_tmpED.f1=({
const char*_tmpEE="nested translation unit after translation to C";_tag_dyneither(
_tmpEE,sizeof(char),47);});_tmpED;});_tmpEC;}));_LL112:;}return((struct Cyc_List_List*(*)(
struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmpD7);}
