...
void*env,struct Cyc_List_List*x);struct Cyc_List_List*Cyc_List_append(struct Cyc_List_List*
x,struct Cyc_List_List*y);extern char Cyc_List_Nth[8];int Cyc_List_exists_c(int(*
pred)(void*,void*),void*env,struct Cyc_List_List*x);int Cyc_List_mem(int(*compare)(
void*,void*),struct Cyc_List_List*l,void*x);struct Cyc_List_List*Cyc_List_delete_cmp(
...
Cyc_Dict_Dict*d,void*accum);void Cyc_Dict_iter(void(*f)(void*,void*),struct Cyc_Dict_Dict*
d);void Cyc_Dict_iter_c(void(*f)(void*,void*,void*),void*env,struct Cyc_Dict_Dict*
d);struct Cyc_Dict_Dict*Cyc_Dict_map_c(void*(*f)(void*,void*),void*env,struct Cyc_Dict_Dict*
d);struct Cyc_Dict_Dict*Cyc_Dict_union_two_c(void*(*f)(void*,void*,void*,void*),
void*env,struct Cyc_Dict_Dict*d1,struct Cyc_Dict_Dict*d2);struct Cyc_Dict_Dict*Cyc_Dict_intersect_c(
...
struct _RegionHandle*rgn,struct Cyc_Dict_Dict*d);int Cyc_strptrcmp(struct
...
9];struct Cyc_Position_Segment;int Cyc_Position_segment_equals(struct Cyc_Position_Segment*,
...
void*,void*);int Cyc_Tcutil_bits_only(void*t);struct Cyc_PP_Ppstate;struct Cyc_PP_Out;
...
void Cyc_CfFlowInfo_unique_err(struct Cyc_CfFlowInfo_Place*place,struct _tagged_arr
err_msg1,struct _tagged_arr err_msg2,struct Cyc_Position_Segment*consumed_loc,
struct Cyc_Position_Segment*loc){struct Cyc_CfFlowInfo_Place _tmp8;void*_tmp9;
struct Cyc_CfFlowInfo_Place*_tmp7=place;_tmp8=*_tmp7;_tmp9=(void*)_tmp8.root;{
void*_tmpA=_tmp9;struct Cyc_Absyn_Vardecl*_tmpB;_LL1: if(*((int*)_tmpA)!= 0)goto
_LL3;_tmpB=((struct Cyc_CfFlowInfo_VarRoot_struct*)_tmpA)->f1;_LL2: if(!Cyc_Position_segment_equals(
consumed_loc,loc)){struct _tagged_arr _tmpC=Cyc_Position_string_of_segment(
consumed_loc);({struct Cyc_String_pa_struct _tmpF;_tmpF.tag=0;_tmpF.f1=(struct
_tagged_arr)_tmpC;{struct Cyc_String_pa_struct _tmpE;_tmpE.tag=0;_tmpE.f1=(struct
_tagged_arr)Cyc_Absynpp_qvar2string(_tmpB->name);{void*_tmpD[2]={& _tmpE,& _tmpF};
Cyc_Tcutil_terr(loc,err_msg1,_tag_arr(_tmpD,sizeof(void*),2));}}});}else{({
struct Cyc_String_pa_struct _tmp11;_tmp11.tag=0;_tmp11.f1=(struct _tagged_arr)Cyc_Absynpp_qvar2string(
_tmpB->name);{void*_tmp10[1]={& _tmp11};Cyc_Tcutil_terr(loc,err_msg2,_tag_arr(
_tmp10,sizeof(void*),1));}});}goto _LL0;_LL3:;_LL4:({void*_tmp12[0]={};((int(*)(
struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(({const char*_tmp13="error locations not for VarRoots";
_tag_arr(_tmp13,sizeof(char),_get_zero_arr_size(_tmp13,33));}),_tag_arr(_tmp12,
sizeof(void*),0));});_LL0:;}}static struct Cyc_Position_Segment*Cyc_CfFlowInfo_combine_consume_f(
int isErr,struct Cyc_CfFlowInfo_Place*place,struct Cyc_Position_Segment*loc1,struct
Cyc_Position_Segment*loc2){if(isErr)Cyc_CfFlowInfo_unique_err(place,({const char*
_tmp14="May consume unique pointer %s more than once (cf. %s)";_tag_arr(_tmp14,
sizeof(char),_get_zero_arr_size(_tmp14,54));}),({const char*_tmp15="May consume unique pointer %s more than once";
_tag_arr(_tmp15,sizeof(char),_get_zero_arr_size(_tmp15,45));}),loc1,loc2);return
loc1;}struct Cyc_Dict_Dict*Cyc_CfFlowInfo_union_place_set(struct Cyc_Dict_Dict*s1,
struct Cyc_Dict_Dict*s2,int disjoint){struct Cyc_Dict_Dict*_tmp16=((struct Cyc_Dict_Dict*(*)(
...
Cyc_List_list_cmp)(Cyc_strptrcmp,p1->fields,p2->fields);}}static struct
_tagged_arr*Cyc_CfFlowInfo_place2string(struct Cyc_CfFlowInfo_Place*p){struct Cyc_List_List*
sl=0;{void*_tmp34=(void*)p->root;struct Cyc_Absyn_Vardecl*_tmp35;struct Cyc_Absyn_Exp*
_tmp36;int _tmp37;_LL1A: if(*((int*)_tmp34)!= 0)goto _LL1C;_tmp35=((struct Cyc_CfFlowInfo_VarRoot_struct*)
_tmp34)->f1;_LL1B: sl=({struct Cyc_List_List*_tmp38=_cycalloc(sizeof(*_tmp38));
_tmp38->hd=({struct _tagged_arr*_tmp39=_cycalloc(sizeof(*_tmp39));_tmp39[0]=({
struct Cyc_String_pa_struct _tmp3C;_tmp3C.tag=0;_tmp3C.f1=(struct _tagged_arr)((
struct _tagged_arr)*(*_tmp35->name).f2);{void*_tmp3A[1]={& _tmp3C};Cyc_aprintf(({
const char*_tmp3B="%s";_tag_arr(_tmp3B,sizeof(char),_get_zero_arr_size(_tmp3B,3));}),
_tag_arr(_tmp3A,sizeof(void*),1));}});_tmp39;});_tmp38->tl=sl;_tmp38;});goto
_LL19;_LL1C: if(*((int*)_tmp34)!= 1)goto _LL1E;_tmp36=((struct Cyc_CfFlowInfo_MallocPt_struct*)
_tmp34)->f1;_LL1D: sl=({struct Cyc_List_List*_tmp3D=_cycalloc(sizeof(*_tmp3D));
_tmp3D->hd=({struct _tagged_arr*_tmp3E=_cycalloc(sizeof(*_tmp3E));_tmp3E[0]=({
struct Cyc_Int_pa_struct _tmp41;_tmp41.tag=1;_tmp41.f1=(unsigned int)((int)_tmp36);{
void*_tmp3F[1]={& _tmp41};Cyc_aprintf(({const char*_tmp40="mpt%d";_tag_arr(_tmp40,
sizeof(char),_get_zero_arr_size(_tmp40,6));}),_tag_arr(_tmp3F,sizeof(void*),1));}});
...
_tagged_arr*_tmp43=_cycalloc(sizeof(*_tmp43));_tmp43[0]=({struct Cyc_Int_pa_struct
_tmp46;_tmp46.tag=1;_tmp46.f1=(unsigned int)_tmp37;{void*_tmp44[1]={& _tmp46};Cyc_aprintf(({
const char*_tmp45="param%d";_tag_arr(_tmp45,sizeof(char),_get_zero_arr_size(
_tmp45,8));}),_tag_arr(_tmp44,sizeof(void*),1));}});_tmp43;});_tmp42->tl=sl;
_tmp42;});goto _LL19;_LL19:;}{struct Cyc_List_List*fields=p->fields;for(0;fields != 
0;fields=fields->tl){sl=({struct Cyc_List_List*_tmp47=_cycalloc(sizeof(*_tmp47));
_tmp47->hd=({struct _tagged_arr*_tmp48=_cycalloc(sizeof(*_tmp48));_tmp48[0]=({
struct Cyc_String_pa_struct _tmp4B;_tmp4B.tag=0;_tmp4B.f1=(struct _tagged_arr)((
struct _tagged_arr)*((struct _tagged_arr*)fields->hd));{void*_tmp49[1]={& _tmp4B};
Cyc_aprintf(({const char*_tmp4A="%s";_tag_arr(_tmp4A,sizeof(char),
_get_zero_arr_size(_tmp4A,3));}),_tag_arr(_tmp49,sizeof(void*),1));}});_tmp48;});
_tmp47->tl=sl;_tmp47;});}}{struct _tagged_arr*_tmp4C=({struct _tagged_arr*_tmp51=
_cycalloc(sizeof(*_tmp51));_tmp51[0]=({struct Cyc_String_pa_struct _tmp54;_tmp54.tag=
0;_tmp54.f1=(struct _tagged_arr)({const char*_tmp55="";_tag_arr(_tmp55,sizeof(char),
_get_zero_arr_size(_tmp55,1));});{void*_tmp52[1]={& _tmp54};Cyc_aprintf(({const
char*_tmp53="%s";_tag_arr(_tmp53,sizeof(char),_get_zero_arr_size(_tmp53,3));}),
_tag_arr(_tmp52,sizeof(void*),1));}});_tmp51;});for(0;sl != 0;sl=sl->tl){*_tmp4C=({
struct Cyc_String_pa_struct _tmp50;_tmp50.tag=0;_tmp50.f1=(struct _tagged_arr)((
struct _tagged_arr)*_tmp4C);{struct Cyc_String_pa_struct _tmp4F;_tmp4F.tag=0;_tmp4F.f1=(
struct _tagged_arr)((struct _tagged_arr)*((struct _tagged_arr*)sl->hd));{void*
_tmp4D[2]={& _tmp4F,& _tmp50};Cyc_aprintf(({const char*_tmp4E="%s.%s";_tag_arr(
_tmp4E,sizeof(char),_get_zero_arr_size(_tmp4E,6));}),_tag_arr(_tmp4D,sizeof(void*),
2));}}});}return _tmp4C;}}struct _tuple6{struct Cyc_Absyn_Tqual f1;void*f2;};static
void*Cyc_CfFlowInfo_i_typ_to_absrval(int allow_zeroterm,void*t,void*leafval){if(
Cyc_Absyn_is_union_type(t))return Cyc_CfFlowInfo_unknown_all;{void*_tmp56=Cyc_Tcutil_compress(
t);struct Cyc_Absyn_TunionFieldInfo _tmp57;void*_tmp58;struct Cyc_Absyn_Tunionfield*
_tmp59;struct Cyc_List_List*_tmp5A;struct Cyc_Absyn_AggrInfo _tmp5B;void*_tmp5C;
void*_tmp5D;struct Cyc_List_List*_tmp5E;struct Cyc_Absyn_ArrayInfo _tmp5F;void*
_tmp60;struct Cyc_Absyn_Conref*_tmp61;void*_tmp62;struct Cyc_Absyn_PtrInfo _tmp63;
struct Cyc_Absyn_PtrAtts _tmp64;struct Cyc_Absyn_Conref*_tmp65;_LL21: if(_tmp56 <= (
void*)4  || *((int*)_tmp56)!= 3)goto _LL23;_tmp57=((struct Cyc_Absyn_TunionFieldType_struct*)
...
== 0)return leafval;_tmp5A=_tmp59->typs;goto _LL24;_LL23: if(_tmp56 <= (void*)4  || *((
int*)_tmp56)!= 9)goto _LL25;_tmp5A=((struct Cyc_Absyn_TupleType_struct*)_tmp56)->f1;
_LL24: {struct Cyc_Dict_Dict*d=((struct Cyc_Dict_Dict*(*)(int(*cmp)(struct
_tagged_arr*,struct _tagged_arr*)))Cyc_Dict_empty)(Cyc_strptrcmp);{int i=0;for(0;
_tmp5A != 0;(_tmp5A=_tmp5A->tl,++ i)){d=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
...
_tmp67;_tmp67.tag=4;_tmp67.f1=d;_tmp67;});_tmp66;});}_LL25: if(_tmp56 <= (void*)4
 || *((int*)_tmp56)!= 10)goto _LL27;_tmp5B=((struct Cyc_Absyn_AggrType_struct*)
_tmp56)->f1;_tmp5C=(void*)_tmp5B.aggr_info;_LL26: {struct Cyc_Absyn_Aggrdecl*
_tmp68=Cyc_Absyn_get_known_aggrdecl(_tmp5C);if(_tmp68->impl == 0)goto _LL20;_tmp5E=((
struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp68->impl))->fields;goto _LL28;}
_LL27: if(_tmp56 <= (void*)4  || *((int*)_tmp56)!= 11)goto _LL29;_tmp5D=(void*)((
struct Cyc_Absyn_AnonAggrType_struct*)_tmp56)->f1;if((int)_tmp5D != 0)goto _LL29;
_tmp5E=((struct Cyc_Absyn_AnonAggrType_struct*)_tmp56)->f2;_LL28: {struct Cyc_Dict_Dict*
d=((struct Cyc_Dict_Dict*(*)(int(*cmp)(struct _tagged_arr*,struct _tagged_arr*)))
Cyc_Dict_empty)(Cyc_strptrcmp);for(0;_tmp5E != 0;_tmp5E=_tmp5E->tl){struct Cyc_Absyn_Aggrfield
_tmp6A;struct _tagged_arr*_tmp6B;void*_tmp6C;struct Cyc_Absyn_Aggrfield*_tmp69=(
struct Cyc_Absyn_Aggrfield*)_tmp5E->hd;_tmp6A=*_tmp69;_tmp6B=_tmp6A.name;_tmp6C=(
void*)_tmp6A.type;if(_get_arr_size(*_tmp6B,sizeof(char))!= 1)d=((struct Cyc_Dict_Dict*(*)(
struct Cyc_Dict_Dict*d,struct _tagged_arr*k,void*v))Cyc_Dict_insert)(d,_tmp6B,Cyc_CfFlowInfo_i_typ_to_absrval(
0,_tmp6C,leafval));}return(void*)({struct Cyc_CfFlowInfo_Aggregate_struct*_tmp6D=
_cycalloc(sizeof(*_tmp6D));_tmp6D[0]=({struct Cyc_CfFlowInfo_Aggregate_struct
_tmp6E;_tmp6E.tag=4;_tmp6E.f1=d;_tmp6E;});_tmp6D;});}_LL29: if(_tmp56 <= (void*)4
 || *((int*)_tmp56)!= 7)goto _LL2B;_tmp5F=((struct Cyc_Absyn_ArrayType_struct*)
_tmp56)->f1;_tmp60=(void*)_tmp5F.elt_type;_tmp61=_tmp5F.zero_term;if(!((int(*)(
int,struct Cyc_Absyn_Conref*x))Cyc_Absyn_conref_def)(0,_tmp61))goto _LL2B;_LL2A:
return allow_zeroterm  && Cyc_Tcutil_bits_only(_tmp60)?Cyc_CfFlowInfo_unknown_all:
leafval;_LL2B: if(_tmp56 <= (void*)4  || *((int*)_tmp56)!= 17)goto _LL2D;_tmp62=(
void*)((struct Cyc_Absyn_TagType_struct*)_tmp56)->f1;_LL2C: {void*_tmp6F=leafval;
void*_tmp70;void*_tmp71;_LL32: if(_tmp6F <= (void*)3  || *((int*)_tmp6F)!= 0)goto
_LL34;_tmp70=(void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)_tmp6F)->f1;if((int)
_tmp70 != 2)goto _LL34;_LL33: goto _LL35;_LL34: if(_tmp6F <= (void*)3  || *((int*)
_tmp6F)!= 1)goto _LL36;_tmp71=(void*)((struct Cyc_CfFlowInfo_Esc_struct*)_tmp6F)->f1;
if((int)_tmp71 != 2)goto _LL36;_LL35: goto _LL37;_LL36: if((int)_tmp6F != 0)goto _LL38;
...
struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(_tag_arr(_tmp74,
sizeof(struct Cyc_CfFlowInfo_TagCmp*),1));});_tmp73;});_tmp72;});_LL3A:;_LL3B:
return leafval;_LL31:;}_LL2D: if(_tmp56 <= (void*)4  || *((int*)_tmp56)!= 4)goto
_LL2F;_tmp63=((struct Cyc_Absyn_PointerType_struct*)_tmp56)->f1;_tmp64=_tmp63.ptr_atts;
_tmp65=_tmp64.nullable;if(!(!((int(*)(int,struct Cyc_Absyn_Conref*x))Cyc_Absyn_conref_def)(
0,_tmp65)))goto _LL2F;_LL2E:{void*_tmp76=leafval;void*_tmp77;void*_tmp78;_LL3D:
if(_tmp76 <= (void*)3  || *((int*)_tmp76)!= 0)goto _LL3F;_tmp77=(void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)
_tmp76)->f1;if((int)_tmp77 != 1)goto _LL3F;_LL3E: return(void*)2;_LL3F: if(_tmp76 <= (
void*)3  || *((int*)_tmp76)!= 0)goto _LL41;_tmp78=(void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)
_tmp76)->f1;if((int)_tmp78 != 2)goto _LL41;_LL40: return(void*)1;_LL41:;_LL42: goto
...
struct _RegionHandle*r,struct Cyc_CfFlowInfo_Place*place,struct Cyc_Dict_Dict*set){
struct _tuple5 _tmp79=({struct _tuple5 _tmp7E;_tmp7E.f1=place;_tmp7E.f2=0;_tmp7E;});
struct Cyc_Iter_Iter _tmp7A=((struct Cyc_Iter_Iter(*)(struct _RegionHandle*rgn,
struct Cyc_Dict_Dict*d))Cyc_Dict_make_iter)(r,set);while(((int(*)(struct Cyc_Iter_Iter,
struct _tuple5*))Cyc_Iter_next)(_tmp7A,& _tmp79)){struct Cyc_CfFlowInfo_Place*
_tmp7B=_tmp79.f1;if(Cyc_CfFlowInfo_root_cmp((void*)place->root,(void*)_tmp7B->root)
!= 0)continue;{struct Cyc_List_List*_tmp7C=place->fields;struct Cyc_List_List*
_tmp7D=_tmp7B->fields;for(0;_tmp7C != 0  && _tmp7D != 0;(_tmp7C=_tmp7C->tl,_tmp7D=
_tmp7D->tl)){if(Cyc_strptrcmp((struct _tagged_arr*)_tmp7C->hd,(struct _tagged_arr*)
_tmp7D->hd)!= 0)break;}if(_tmp7C == 0)return 1;}}return 0;}struct Cyc_CfFlowInfo_EscPile{
...
_tmp80 <= (void*)3  || *((int*)_tmp80)!= 2)goto _LL46;_tmp81=((struct Cyc_CfFlowInfo_AddressOf_struct*)
_tmp80)->f1;_LL45: Cyc_CfFlowInfo_add_place(pile,_tmp81);return;_LL46: if(_tmp80 <= (
void*)3  || *((int*)_tmp80)!= 4)goto _LL48;_tmp82=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmp80)->f1;_LL47:((void(*)(void(*f)(struct Cyc_CfFlowInfo_EscPile*,struct
...
if(_tmp83 <= (void*)3  || *((int*)_tmp83)!= 4)goto _LL4D;_tmp84=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmp83)->f1;_LL4C: return(void*)({struct Cyc_CfFlowInfo_Aggregate_struct*_tmp85=
_cycalloc(sizeof(*_tmp85));_tmp85[0]=({struct Cyc_CfFlowInfo_Aggregate_struct
...
_tagged_arr*_tmp8B;struct Cyc_List_List*_tmp8C;void*_tmp8D;struct Cyc_Dict_Dict*
_tmp8E;_LL50: _tmp89=_tmp88.f1;if(_tmp89 == 0)goto _LL52;_tmp8A=*_tmp89;_tmp8B=(
struct _tagged_arr*)_tmp8A.hd;_tmp8C=_tmp8A.tl;_tmp8D=_tmp88.f2;if(_tmp8D <= (void*)
3  || *((int*)_tmp8D)!= 4)goto _LL52;_tmp8E=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmp8D)->f1;_LL51: {void*_tmp8F=Cyc_CfFlowInfo_insert_place_outer(_tmp8C,((void*(*)(
struct Cyc_Dict_Dict*d,struct _tagged_arr*k))Cyc_Dict_lookup)(_tmp8E,_tmp8B),
...
4;_tmp91.f1=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k,
void*v))Cyc_Dict_insert)(_tmp8E,_tmp8B,_tmp8F);_tmp91;});_tmp90;});}_LL52:;_LL53:(
int)_throw((void*)({struct Cyc_Core_Impossible_struct*_tmp92=_cycalloc(sizeof(*
_tmp92));_tmp92[0]=({struct Cyc_Core_Impossible_struct _tmp93;_tmp93.tag=Cyc_Core_Impossible;
_tmp93.f1=({const char*_tmp94="bad insert place";_tag_arr(_tmp94,sizeof(char),
_get_zero_arr_size(_tmp94,17));});_tmp93;});_tmp92;}));_LL4F:;}}static struct Cyc_Dict_Dict*
Cyc_CfFlowInfo_escape_these(struct Cyc_CfFlowInfo_EscPile*pile,struct Cyc_Dict_Dict**
all_changed,struct Cyc_Dict_Dict*d){while(pile->places != 0){struct Cyc_CfFlowInfo_Place*
_tmp95=(struct Cyc_CfFlowInfo_Place*)((struct Cyc_List_List*)_check_null(pile->places))->hd;
pile->places=((struct Cyc_List_List*)_check_null(pile->places))->tl;Cyc_CfFlowInfo_update_place_set(
all_changed,_tmp95,0);{void*oldval;void*newval;{struct _handler_cons _tmp96;
_push_handler(& _tmp96);{int _tmp98=0;if(setjmp(_tmp96.handler))_tmp98=1;if(!
_tmp98){oldval=Cyc_CfFlowInfo_lookup_place(d,_tmp95);;_pop_handler();}else{void*
_tmp97=(void*)_exn_thrown;void*_tmp9A=_tmp97;_LL55: if(_tmp9A != Cyc_Dict_Absent)
goto _LL57;_LL56: continue;_LL57:;_LL58:(void)_throw(_tmp9A);_LL54:;}}}{void*
_tmp9B=Cyc_CfFlowInfo_initlevel(d,oldval);_LL5A: if((int)_tmp9B != 2)goto _LL5C;
_LL5B: newval=Cyc_CfFlowInfo_esc_all;goto _LL59;_LL5C: if((int)_tmp9B != 1)goto _LL5E;
_LL5D: newval=Cyc_CfFlowInfo_esc_this;goto _LL59;_LL5E: if((int)_tmp9B != 0)goto
_LL59;_LL5F: newval=Cyc_CfFlowInfo_esc_none;goto _LL59;_LL59:;}((void(*)(struct Cyc_CfFlowInfo_EscPile*
pile,int a,void*r))Cyc_CfFlowInfo_add_places)(pile,0,oldval);d=Cyc_Dict_insert(d,(
void*)_tmp95->root,Cyc_CfFlowInfo_insert_place_outer(_tmp95->fields,Cyc_Dict_lookup(
d,(void*)_tmp95->root),newval));}}return d;}struct Cyc_CfFlowInfo_InitlevelEnv{
struct Cyc_Dict_Dict*d;struct Cyc_List_List*seen;};static void*Cyc_CfFlowInfo_initlevel_approx(
void*r){void*_tmp9C=r;void*_tmp9D;void*_tmp9E;_LL61: if(_tmp9C <= (void*)3  || *((
int*)_tmp9C)!= 0)goto _LL63;_tmp9D=(void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)
_tmp9C)->f1;_LL62: return _tmp9D;_LL63: if(_tmp9C <= (void*)3  || *((int*)_tmp9C)!= 1)
goto _LL65;_tmp9E=(void*)((struct Cyc_CfFlowInfo_Esc_struct*)_tmp9C)->f1;_LL64:
return _tmp9E;_LL65: if((int)_tmp9C != 0)goto _LL67;_LL66: goto _LL68;_LL67: if((int)
_tmp9C != 1)goto _LL69;_LL68: return(void*)2;_LL69: if((int)_tmp9C != 2)goto _LL6B;
_LL6A: return(void*)1;_LL6B: if(_tmp9C <= (void*)3  || *((int*)_tmp9C)!= 3)goto _LL6D;
_LL6C: return(void*)2;_LL6D:;_LL6E:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
_tmp9F=_cycalloc(sizeof(*_tmp9F));_tmp9F[0]=({struct Cyc_Core_Impossible_struct
_tmpA0;_tmpA0.tag=Cyc_Core_Impossible;_tmpA0.f1=({const char*_tmpA1="initlevel_approx";
_tag_arr(_tmpA1,sizeof(char),_get_zero_arr_size(_tmpA1,17));});_tmpA0;});_tmp9F;}));
_LL60:;}static void*Cyc_CfFlowInfo_initlevel_rec(struct Cyc_CfFlowInfo_InitlevelEnv*
env,void*a,void*r,void*acc){void*this_ans;if(acc == (void*)0)return(void*)0;{void*
_tmpA2=r;struct Cyc_Dict_Dict*_tmpA3;struct Cyc_CfFlowInfo_Place*_tmpA4;_LL70: if(
_tmpA2 <= (void*)3  || *((int*)_tmpA2)!= 4)goto _LL72;_tmpA3=((struct Cyc_CfFlowInfo_Aggregate_struct*)
...
struct _tagged_arr*a,void*r,void*acc))Cyc_CfFlowInfo_initlevel_rec,env,_tmpA3,(
void*)2);goto _LL6F;_LL72: if(_tmpA2 <= (void*)3  || *((int*)_tmpA2)!= 2)goto _LL74;
_tmpA4=((struct Cyc_CfFlowInfo_AddressOf_struct*)_tmpA2)->f1;_LL73: if(((int(*)(
int(*compare)(struct Cyc_CfFlowInfo_Place*,struct Cyc_CfFlowInfo_Place*),struct Cyc_List_List*
...
_tmpAD.f2=(struct _tagged_arr*)_tmpAB->hd;_tmpAD;});void*_tmpAF;struct Cyc_Dict_Dict*
_tmpB0;struct _tagged_arr*_tmpB1;_LL77: _tmpAF=_tmpAE.f1;if(_tmpAF <= (void*)3  || *((
int*)_tmpAF)!= 4)goto _LL79;_tmpB0=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmpAF)->f1;_tmpB1=_tmpAE.f2;_LL78: _tmpAC=((void*(*)(struct Cyc_Dict_Dict*d,
struct _tagged_arr*k))Cyc_Dict_lookup)(_tmpB0,_tmpB1);goto _LL76;_LL79:;_LL7A:(int)
_throw((void*)({struct Cyc_Core_Impossible_struct*_tmpB2=_cycalloc(sizeof(*_tmpB2));
_tmpB2[0]=({struct Cyc_Core_Impossible_struct _tmpB3;_tmpB3.tag=Cyc_Core_Impossible;
_tmpB3.f1=({const char*_tmpB4="bad lookup_place";_tag_arr(_tmpB4,sizeof(char),
_get_zero_arr_size(_tmpB4,17));});_tmpB3;});_tmpB2;}));_LL76:;}return _tmpAC;}}
static int Cyc_CfFlowInfo_is_rval_unescaped(void*a,void*b,void*rval){void*_tmpB5=
rval;struct Cyc_Dict_Dict*_tmpB6;_LL7C: if(_tmpB5 <= (void*)3  || *((int*)_tmpB5)!= 
1)goto _LL7E;_LL7D: return 0;_LL7E: if(_tmpB5 <= (void*)3  || *((int*)_tmpB5)!= 4)goto
_LL80;_tmpB6=((struct Cyc_CfFlowInfo_Aggregate_struct*)_tmpB5)->f1;_LL7F: return((
...
_tmpB6);_LL80:;_LL81: return 1;_LL7B:;}int Cyc_CfFlowInfo_is_unescaped(struct Cyc_Dict_Dict*
...
_tmpC3;void*_tmpC4;void*_tmpC5;_LL83: _tmpBC=_tmpBB.f1;if(_tmpBC <= (void*)3  || *((
int*)_tmpBC)!= 1)goto _LL85;_tmpBD=_tmpBB.f2;if(_tmpBD <= (void*)3  || *((int*)
_tmpBD)!= 2)goto _LL85;_tmpBE=((struct Cyc_CfFlowInfo_AddressOf_struct*)_tmpBD)->f1;
_LL84: Cyc_CfFlowInfo_add_place(env->pile,_tmpBE);goto _LL86;_LL85: _tmpBF=_tmpBB.f1;
if(_tmpBF <= (void*)3  || *((int*)_tmpBF)!= 1)goto _LL87;_LL86: if(Cyc_CfFlowInfo_initlevel(
env->d,newval)!= (void*)2)({void*_tmpC6[0]={};Cyc_Tcutil_terr(env->loc,({const
char*_tmpC7="assignment puts possibly-uninitialized data in an escaped location";
_tag_arr(_tmpC7,sizeof(char),_get_zero_arr_size(_tmpC7,67));}),_tag_arr(_tmpC6,
sizeof(void*),0));});return Cyc_CfFlowInfo_esc_all;_LL87: _tmpC0=_tmpBB.f1;if(
_tmpC0 <= (void*)3  || *((int*)_tmpC0)!= 4)goto _LL89;_tmpC1=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmpC0)->f1;_tmpC2=_tmpBB.f2;if(_tmpC2 <= (void*)3  || *((int*)_tmpC2)!= 4)goto
_LL89;_tmpC3=((struct Cyc_CfFlowInfo_Aggregate_struct*)_tmpC2)->f1;_LL88: {struct
Cyc_Dict_Dict*_tmpC8=((struct Cyc_Dict_Dict*(*)(void*(*f)(struct Cyc_CfFlowInfo_AssignEnv*,
...
env,_tmpC1,_tmpC3);if(_tmpC8 == _tmpC1)return oldval;if(_tmpC8 == _tmpC3)return
newval;return(void*)({struct Cyc_CfFlowInfo_Aggregate_struct*_tmpC9=_cycalloc(
sizeof(*_tmpC9));_tmpC9[0]=({struct Cyc_CfFlowInfo_Aggregate_struct _tmpCA;_tmpCA.tag=
4;_tmpCA.f1=_tmpC8;_tmpCA;});_tmpC9;});}_LL89: _tmpC4=_tmpBB.f2;if(_tmpC4 <= (void*)
3  || *((int*)_tmpC4)!= 1)goto _LL8B;_tmpC5=(void*)((struct Cyc_CfFlowInfo_Esc_struct*)
_tmpC4)->f1;_LL8A: {void*_tmpCB=_tmpC5;_LL8E: if((int)_tmpCB != 0)goto _LL90;_LL8F:
return Cyc_CfFlowInfo_unknown_none;_LL90: if((int)_tmpCB != 1)goto _LL92;_LL91:
return Cyc_CfFlowInfo_unknown_this;_LL92: if((int)_tmpCB != 2)goto _LL8D;_LL93:
return Cyc_CfFlowInfo_unknown_all;_LL8D:;}_LL8B:;_LL8C: return newval;_LL82:;}
...
struct _tagged_arr*_tmpD0;struct Cyc_List_List*_tmpD1;void*_tmpD2;struct Cyc_Dict_Dict*
_tmpD3;_LL95: _tmpCE=_tmpCD.f1;if(_tmpCE == 0)goto _LL97;_tmpCF=*_tmpCE;_tmpD0=(
struct _tagged_arr*)_tmpCF.hd;_tmpD1=_tmpCF.tl;_tmpD2=_tmpCD.f2;if(_tmpD2 <= (void*)
3  || *((int*)_tmpD2)!= 4)goto _LL97;_tmpD3=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmpD2)->f1;_LL96: {void*_tmpD4=Cyc_CfFlowInfo_assign_place_outer(env,_tmpD1,((
void*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k))Cyc_Dict_lookup)(_tmpD3,
...
struct _tagged_arr*k,void*v))Cyc_Dict_insert)(_tmpD3,_tmpD0,_tmpD4);_tmpD6;});
...
_tag_arr(_tmpD9,sizeof(char),_get_zero_arr_size(_tmpD9,17));});_tmpD8;});_tmpD7;}));
_LL94:;}}struct Cyc_Dict_Dict*Cyc_CfFlowInfo_assign_place(struct Cyc_Position_Segment*
...
_tmpF0=_tmpEF.f1;if(_tmpF0 <= (void*)3  || *((int*)_tmpF0)!= 2)goto _LL9C;_tmpF1=((
struct Cyc_CfFlowInfo_AddressOf_struct*)_tmpF0)->f1;_tmpF2=_tmpEF.f2;if(_tmpF2 <= (
void*)3  || *((int*)_tmpF2)!= 2)goto _LL9C;_tmpF3=((struct Cyc_CfFlowInfo_AddressOf_struct*)
...
_tmpF4=_tmpEF.f1;if(_tmpF4 <= (void*)3  || *((int*)_tmpF4)!= 2)goto _LL9E;_tmpF5=((
struct Cyc_CfFlowInfo_AddressOf_struct*)_tmpF4)->f1;_LL9D: Cyc_CfFlowInfo_add_place(
env->pile,_tmpF5);goto _LL99;_LL9E: _tmpF6=_tmpEF.f2;if(_tmpF6 <= (void*)3  || *((
int*)_tmpF6)!= 2)goto _LLA0;_tmpF7=((struct Cyc_CfFlowInfo_AddressOf_struct*)
...
_tmpEF.f1;if(_tmpFC <= (void*)3  || *((int*)_tmpFC)!= 4)goto _LLA6;_tmpFD=((struct
Cyc_CfFlowInfo_Aggregate_struct*)_tmpFC)->f1;_tmpFE=_tmpEF.f2;if(_tmpFE <= (void*)
3  || *((int*)_tmpFE)!= 4)goto _LLA6;_tmpFF=((struct Cyc_CfFlowInfo_Aggregate_struct*)
...
void*)3  || *((int*)_tmp100)!= 3)goto _LLA8;_tmp101=((struct Cyc_CfFlowInfo_TagCmps_struct*)
_tmp100)->f1;_tmp102=_tmpEF.f2;if(_tmp102 <= (void*)3  || *((int*)_tmp102)!= 3)
goto _LLA8;_tmp103=((struct Cyc_CfFlowInfo_TagCmps_struct*)_tmp102)->f1;_LLA7: {
struct Cyc_List_List*_tmp109=Cyc_CfFlowInfo_join_tag_cmps(_tmp101,_tmp103);if(
_tmp109 == _tmp101)return r1;return(void*)({struct Cyc_CfFlowInfo_TagCmps_struct*
...
_tmpEF.f1;if(_tmp104 <= (void*)3  || *((int*)_tmp104)!= 3)goto _LLAA;_LLA9: return r2;
_LLAA: _tmp105=_tmpEF.f2;if(_tmp105 <= (void*)3  || *((int*)_tmp105)!= 3)goto _LLAC;
_LLAB: return r1;_LLAC:;_LLAD: goto _LL99;_LL99:;}{void*il1=Cyc_CfFlowInfo_initlevel(
env->d1,r1);void*il2=Cyc_CfFlowInfo_initlevel(env->d2,r2);struct _tuple0 _tmp10D=({
struct _tuple0 _tmp10C;_tmp10C.f1=r1;_tmp10C.f2=r2;_tmp10C;});void*_tmp10E;void*
_tmp10F;_LLAF: _tmp10E=_tmp10D.f1;if(_tmp10E <= (void*)3  || *((int*)_tmp10E)!= 1)
goto _LLB1;_LLB0: goto _LLB2;_LLB1: _tmp10F=_tmp10D.f2;if(_tmp10F <= (void*)3  || *((
int*)_tmp10F)!= 1)goto _LLB3;_LLB2: {struct _tuple0 _tmp111=({struct _tuple0 _tmp110;
_tmp110.f1=il1;_tmp110.f2=il2;_tmp110;});void*_tmp112;void*_tmp113;void*_tmp114;
void*_tmp115;_LLB6: _tmp112=_tmp111.f2;if((int)_tmp112 != 0)goto _LLB8;_LLB7: goto
_LLB9;_LLB8: _tmp113=_tmp111.f1;if((int)_tmp113 != 0)goto _LLBA;_LLB9: return Cyc_CfFlowInfo_esc_none;
_LLBA: _tmp114=_tmp111.f2;if((int)_tmp114 != 1)goto _LLBC;_LLBB: goto _LLBD;_LLBC:
_tmp115=_tmp111.f1;if((int)_tmp115 != 1)goto _LLBE;_LLBD: return Cyc_CfFlowInfo_esc_this;
_LLBE:;_LLBF: return Cyc_CfFlowInfo_esc_all;_LLB5:;}_LLB3:;_LLB4: {struct _tuple0
_tmp117=({struct _tuple0 _tmp116;_tmp116.f1=il1;_tmp116.f2=il2;_tmp116;});void*
_tmp118;void*_tmp119;void*_tmp11A;void*_tmp11B;_LLC1: _tmp118=_tmp117.f2;if((int)
_tmp118 != 0)goto _LLC3;_LLC2: goto _LLC4;_LLC3: _tmp119=_tmp117.f1;if((int)_tmp119 != 
0)goto _LLC5;_LLC4: return Cyc_CfFlowInfo_unknown_none;_LLC5: _tmp11A=_tmp117.f2;if((
int)_tmp11A != 1)goto _LLC7;_LLC6: goto _LLC8;_LLC7: _tmp11B=_tmp117.f1;if((int)
_tmp11B != 1)goto _LLC9;_LLC8: return Cyc_CfFlowInfo_unknown_this;_LLC9:;_LLCA:
return Cyc_CfFlowInfo_unknown_all;_LLC0:;}_LLAE:;}}static int Cyc_CfFlowInfo_same_relop(
void*r1,void*r2){if(r1 == r2)return 1;{struct _tuple0 _tmp11D=({struct _tuple0 _tmp11C;
_tmp11C.f1=r1;_tmp11C.f2=r2;_tmp11C;});void*_tmp11E;unsigned int _tmp11F;void*
_tmp120;unsigned int _tmp121;void*_tmp122;struct Cyc_Absyn_Vardecl*_tmp123;void*
_tmp124;struct Cyc_Absyn_Vardecl*_tmp125;void*_tmp126;struct Cyc_Absyn_Vardecl*
_tmp127;void*_tmp128;struct Cyc_Absyn_Vardecl*_tmp129;void*_tmp12A;unsigned int
_tmp12B;void*_tmp12C;unsigned int _tmp12D;void*_tmp12E;struct Cyc_Absyn_Vardecl*
_tmp12F;void*_tmp130;struct Cyc_Absyn_Vardecl*_tmp131;_LLCC: _tmp11E=_tmp11D.f1;
if(*((int*)_tmp11E)!= 0)goto _LLCE;_tmp11F=((struct Cyc_CfFlowInfo_EqualConst_struct*)
_tmp11E)->f1;_tmp120=_tmp11D.f2;if(*((int*)_tmp120)!= 0)goto _LLCE;_tmp121=((
struct Cyc_CfFlowInfo_EqualConst_struct*)_tmp120)->f1;_LLCD: return _tmp11F == 
_tmp121;_LLCE: _tmp122=_tmp11D.f1;if(*((int*)_tmp122)!= 1)goto _LLD0;_tmp123=((
struct Cyc_CfFlowInfo_LessVar_struct*)_tmp122)->f1;_tmp124=_tmp11D.f2;if(*((int*)
_tmp124)!= 1)goto _LLD0;_tmp125=((struct Cyc_CfFlowInfo_LessVar_struct*)_tmp124)->f1;
_LLCF: return _tmp123 == _tmp125;_LLD0: _tmp126=_tmp11D.f1;if(*((int*)_tmp126)!= 2)
goto _LLD2;_tmp127=((struct Cyc_CfFlowInfo_LessSize_struct*)_tmp126)->f1;_tmp128=
_tmp11D.f2;if(*((int*)_tmp128)!= 2)goto _LLD2;_tmp129=((struct Cyc_CfFlowInfo_LessSize_struct*)
...
Cyc_stderr,({const char*_tmp13E=", ";_tag_arr(_tmp13E,sizeof(char),
_get_zero_arr_size(_tmp13E,3));}),_tag_arr(_tmp13D,sizeof(void*),0));});_tmp13C=
0;}Cyc_CfFlowInfo_print_place((struct Cyc_CfFlowInfo_Place*)x->hd);x=x->tl;}({
void*_tmp13F[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp140="\n";_tag_arr(
_tmp140,sizeof(char),_get_zero_arr_size(_tmp140,2));}),_tag_arr(_tmp13F,sizeof(
void*),0));});}static struct Cyc_CfFlowInfo_ConsumeInfo Cyc_CfFlowInfo_or_consume(
struct Cyc_CfFlowInfo_ConsumeInfo c1,struct Cyc_CfFlowInfo_ConsumeInfo c2){struct Cyc_List_List*
mc=c2.may_consume;{struct _RegionHandle _tmp141=_new_region("r");struct
_RegionHandle*r=& _tmp141;_push_region(r);{struct Cyc_List_List*_tmp142=((struct
Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x))Cyc_List_rcopy)(r,
c1.may_consume);((void(*)(void(*f)(struct Cyc_List_List**,struct Cyc_CfFlowInfo_Place*),
struct Cyc_List_List**env,struct Cyc_List_List*x))Cyc_List_iter_c)(Cyc_CfFlowInfo_remove_f,&
_tmp142,c2.may_consume);while(_tmp142 != 0){mc=({struct Cyc_List_List*_tmp143=
_cycalloc(sizeof(*_tmp143));_tmp143->hd=(struct Cyc_CfFlowInfo_Place*)((struct Cyc_List_List*)
_check_null(_tmp142))->hd;_tmp143->tl=mc;_tmp143;});_tmp142=((struct Cyc_List_List*)
_check_null(_tmp142))->tl;}};_pop_region(r);}return({struct Cyc_CfFlowInfo_ConsumeInfo
_tmp144;_tmp144.consumed=Cyc_CfFlowInfo_union_place_set(c1.consumed,c2.consumed,
0);_tmp144.may_consume=mc;_tmp144;});}struct Cyc_CfFlowInfo_ConsumeInfo Cyc_CfFlowInfo_and_consume(
struct Cyc_CfFlowInfo_ConsumeInfo c1,struct Cyc_CfFlowInfo_ConsumeInfo c2){struct Cyc_List_List*
_tmp145=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))
Cyc_List_append)(c1.may_consume,c2.may_consume);return({struct Cyc_CfFlowInfo_ConsumeInfo
_tmp146;_tmp146.consumed=Cyc_CfFlowInfo_union_place_set(c1.consumed,c2.consumed,
1);_tmp146.may_consume=_tmp145;_tmp146;});}void*Cyc_CfFlowInfo_join_flow(struct
Cyc_Dict_Dict**all_changed,void*f1,void*f2,int or_consumed){if(f1 == f2)return f1;{
struct _tuple0 _tmp148=({struct _tuple0 _tmp147;_tmp147.f1=f1;_tmp147.f2=f2;_tmp147;});
void*_tmp149;void*_tmp14A;void*_tmp14B;struct Cyc_Dict_Dict*_tmp14C;struct Cyc_List_List*
_tmp14D;struct Cyc_CfFlowInfo_ConsumeInfo _tmp14E;void*_tmp14F;struct Cyc_Dict_Dict*
_tmp150;struct Cyc_List_List*_tmp151;struct Cyc_CfFlowInfo_ConsumeInfo _tmp152;
_LLDE: _tmp149=_tmp148.f1;if((int)_tmp149 != 0)goto _LLE0;_LLDF: return f2;_LLE0:
_tmp14A=_tmp148.f2;if((int)_tmp14A != 0)goto _LLE2;_LLE1: return f1;_LLE2: _tmp14B=
_tmp148.f1;if(_tmp14B <= (void*)1  || *((int*)_tmp14B)!= 0)goto _LLDD;_tmp14C=((
struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp14B)->f1;_tmp14D=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp14B)->f2;_tmp14E=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp14B)->f3;
_tmp14F=_tmp148.f2;if(_tmp14F <= (void*)1  || *((int*)_tmp14F)!= 0)goto _LLDD;
_tmp150=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp14F)->f1;_tmp151=((struct
Cyc_CfFlowInfo_ReachableFL_struct*)_tmp14F)->f2;_tmp152=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp14F)->f3;_LLE3: if(((_tmp14C == _tmp150  && _tmp14D == _tmp151) && _tmp14E.may_consume
== _tmp152.may_consume) && _tmp14E.consumed == _tmp152.consumed)return f1;if(Cyc_CfFlowInfo_flow_lessthan_approx(
...
_tmp170;});_LLE9: _tmp167=_tmp164.f1;if(_tmp167 <= (void*)1  || *((int*)_tmp167)!= 
0)goto _LLEB;_tmp168=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp167)->f1;
_tmp169=_tmp164.f2;if(_tmp169 <= (void*)1  || *((int*)_tmp169)!= 0)goto _LLEB;
_tmp16A=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp169)->f1;_tmp16B=_tmp164.f3;
if(_tmp16B <= (void*)1  || *((int*)_tmp16B)!= 0)goto _LLEB;_tmp16C=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
...
_tmp17D.f1=({const char*_tmp17E="join_flow_and_rval: BottomFL outflow";_tag_arr(
_tmp17E,sizeof(char),_get_zero_arr_size(_tmp17E,37));});_tmp17D;});_tmp17C;}));
...
env->chg1,env->curr_place);int changed2=env->changed == Cyc_CfFlowInfo_Two  || ((
int(*)(struct Cyc_Dict_Dict*d,struct Cyc_CfFlowInfo_Place*k))Cyc_Dict_member)(env->chg2,
...
_tmp184;_LLEE: _tmp181=_tmp180.f1;if(_tmp181 <= (void*)3  || *((int*)_tmp181)!= 4)
goto _LLF0;_tmp182=((struct Cyc_CfFlowInfo_Aggregate_struct*)_tmp181)->f1;_tmp183=
_tmp180.f2;if(_tmp183 <= (void*)3  || *((int*)_tmp183)!= 4)goto _LLF0;_tmp184=((
struct Cyc_CfFlowInfo_Aggregate_struct*)_tmp183)->f1;_LLEF: {struct Cyc_Dict_Dict*
_tmp185=((struct Cyc_Dict_Dict*(*)(void*(*f)(struct Cyc_CfFlowInfo_AfterEnv*,
...
const char*_tmp18A="after_absRval -- non-aggregates!";_tag_arr(_tmp18A,sizeof(
char),_get_zero_arr_size(_tmp18A,33));});_tmp189;});_tmp188;}));_LLED:;}}static
...
_tmp194=_tmp191.f1;if(_tmp194 <= (void*)1  || *((int*)_tmp194)!= 0)goto _LLF2;
_tmp195=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp194)->f1;_tmp196=((struct
Cyc_CfFlowInfo_ReachableFL_struct*)_tmp194)->f2;_tmp197=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp194)->f3;_tmp198=_tmp191.f2;if(_tmp198 <= (void*)1  || *((int*)_tmp198)!= 0)
goto _LLF2;_tmp199=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp198)->f1;
_tmp19A=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp198)->f2;_tmp19B=((struct
Cyc_CfFlowInfo_ReachableFL_struct*)_tmp198)->f3;_LLF8: if(((_tmp195 == _tmp199  && 
_tmp196 == _tmp19A) && _tmp197.may_consume == _tmp19B.may_consume) && _tmp197.consumed
== _tmp19B.consumed)return f1;{struct _RegionHandle _tmp19C=_new_region("rgn");
struct _RegionHandle*rgn=& _tmp19C;_push_region(rgn);{struct Cyc_CfFlowInfo_Place*
...
_tmp1C9;void*_tmp1CA;_LLFA: _tmp1B6=_tmp1B5.f1;if(_tmp1B6 <= (void*)3  || *((int*)
_tmp1B6)!= 2)goto _LLFC;_tmp1B7=((struct Cyc_CfFlowInfo_AddressOf_struct*)_tmp1B6)->f1;
_tmp1B8=_tmp1B5.f2;if(_tmp1B8 <= (void*)3  || *((int*)_tmp1B8)!= 2)goto _LLFC;
_tmp1B9=((struct Cyc_CfFlowInfo_AddressOf_struct*)_tmp1B8)->f1;_LLFB: return Cyc_CfFlowInfo_place_cmp(
_tmp1B7,_tmp1B9)== 0;_LLFC: _tmp1BA=_tmp1B5.f1;if(_tmp1BA <= (void*)3  || *((int*)
_tmp1BA)!= 2)goto _LLFE;_LLFD: goto _LLFF;_LLFE: _tmp1BB=_tmp1B5.f2;if(_tmp1BB <= (
void*)3  || *((int*)_tmp1BB)!= 2)goto _LL100;_LLFF: return 0;_LL100: _tmp1BC=_tmp1B5.f1;
if(_tmp1BC <= (void*)3  || *((int*)_tmp1BC)!= 4)goto _LL102;_tmp1BD=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmp1BC)->f1;_tmp1BE=_tmp1B5.f2;if(_tmp1BE <= (void*)3  || *((int*)_tmp1BE)!= 4)
goto _LL102;_tmp1BF=((struct Cyc_CfFlowInfo_Aggregate_struct*)_tmp1BE)->f1;_LL101:
return _tmp1BD == _tmp1BF  || ((int(*)(int(*f)(struct _tagged_arr*,void*,void*),
...
_LL107: return 0;_LL108: _tmp1C3=_tmp1B5.f1;if(_tmp1C3 <= (void*)3  || *((int*)
_tmp1C3)!= 1)goto _LL10A;_tmp1C4=_tmp1B5.f2;if(_tmp1C4 <= (void*)3  || *((int*)
_tmp1C4)!= 1)goto _LL10A;_LL109: goto _LLF9;_LL10A: _tmp1C5=_tmp1B5.f1;if(_tmp1C5 <= (
void*)3  || *((int*)_tmp1C5)!= 1)goto _LL10C;_LL10B: return 0;_LL10C: _tmp1C6=_tmp1B5.f1;
if(_tmp1C6 <= (void*)3  || *((int*)_tmp1C6)!= 3)goto _LL10E;_tmp1C7=((struct Cyc_CfFlowInfo_TagCmps_struct*)
_tmp1C6)->f1;_tmp1C8=_tmp1B5.f2;if(_tmp1C8 <= (void*)3  || *((int*)_tmp1C8)!= 3)
goto _LL10E;_tmp1C9=((struct Cyc_CfFlowInfo_TagCmps_struct*)_tmp1C8)->f1;_LL10D:
return Cyc_CfFlowInfo_tag_cmps_lessthan_approx(_tmp1C7,_tmp1C9);_LL10E: _tmp1CA=
_tmp1B5.f2;if(_tmp1CA <= (void*)3  || *((int*)_tmp1CA)!= 3)goto _LL110;_LL10F:
...
_tmp1DA.f1;if(_tmp1DD <= (void*)1  || *((int*)_tmp1DD)!= 0)goto _LL11D;_tmp1DE=((
struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp1DD)->f1;_tmp1DF=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp1DD)->f2;_tmp1E0=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp1DD)->f3;
_tmp1E1=_tmp1DA.f2;if(_tmp1E1 <= (void*)1  || *((int*)_tmp1E1)!= 0)goto _LL11D;
_tmp1E2=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp1E1)->f1;_tmp1E3=((struct
Cyc_CfFlowInfo_ReachableFL_struct*)_tmp1E1)->f2;_tmp1E4=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp1E1)->f3;_LL123: if(((_tmp1DE == _tmp1E2  && _tmp1DF == _tmp1E3) && _tmp1E0.may_consume
== _tmp1E4.may_consume) && _tmp1E0.consumed == _tmp1E4.consumed)return 1;return(
Cyc_Dict_forall_intersect(Cyc_CfFlowInfo_absRval_lessthan_approx,_tmp1DE,_tmp1E2)
 && Cyc_CfFlowInfo_relns_approx(_tmp1DF,_tmp1E3)) && Cyc_CfFlowInfo_consume_approx(
_tmp1E0,_tmp1E4);_LL11D:;}}struct Cyc_List_List*Cyc_CfFlowInfo_reln_kill_var(
struct Cyc_List_List*rs,struct Cyc_Absyn_Vardecl*v){struct Cyc_List_List*p;int found=
0;for(p=rs;!found  && p != 0;p=p->tl){struct Cyc_CfFlowInfo_Reln*_tmp1E5=(struct Cyc_CfFlowInfo_Reln*)
p->hd;if(_tmp1E5->vd == v){found=1;break;}{void*_tmp1E6=(void*)_tmp1E5->rop;
struct Cyc_Absyn_Vardecl*_tmp1E7;struct Cyc_Absyn_Vardecl*_tmp1E8;struct Cyc_Absyn_Vardecl*
_tmp1E9;_LL125: if(*((int*)_tmp1E6)!= 1)goto _LL127;_tmp1E7=((struct Cyc_CfFlowInfo_LessVar_struct*)
...
_tmp1F1)->f2;if(_tmp1F2 <= (void*)1  || *((int*)_tmp1F2)!= 0)goto _LL139;_tmp1F3=((
struct Cyc_Absyn_Global_b_struct*)_tmp1F2)->f1;_LL138: _tmp1F5=_tmp1F3;goto _LL13A;
_LL139: if(*((int*)_tmp1F1)!= 1)goto _LL13B;_tmp1F4=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp1F1)->f2;if(_tmp1F4 <= (void*)1  || *((int*)_tmp1F4)!= 2)goto _LL13B;_tmp1F5=((
struct Cyc_Absyn_Param_b_struct*)_tmp1F4)->f1;_LL13A: _tmp1F7=_tmp1F5;goto _LL13C;
_LL13B: if(*((int*)_tmp1F1)!= 1)goto _LL13D;_tmp1F6=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp1F1)->f2;if(_tmp1F6 <= (void*)1  || *((int*)_tmp1F6)!= 3)goto _LL13D;_tmp1F7=((
struct Cyc_Absyn_Local_b_struct*)_tmp1F6)->f1;_LL13C: _tmp1F9=_tmp1F7;goto _LL13E;
_LL13D: if(*((int*)_tmp1F1)!= 1)goto _LL13F;_tmp1F8=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp1F1)->f2;if(_tmp1F8 <= (void*)1  || *((int*)_tmp1F8)!= 4)goto _LL13F;_tmp1F9=((
struct Cyc_Absyn_Pat_b_struct*)_tmp1F8)->f1;_LL13E: if(!_tmp1F9->escapes)return Cyc_CfFlowInfo_reln_kill_var(
r,_tmp1F9);goto _LL136;_LL13F:;_LL140: goto _LL136;_LL136:;}return r;}struct Cyc_List_List*
...
void*_tmp1FA=(void*)e->r;struct Cyc_Absyn_MallocInfo _tmp1FB;struct Cyc_Absyn_Exp*
_tmp1FC;int _tmp1FD;_LL142: if(*((int*)_tmp1FA)!= 35)goto _LL144;_tmp1FB=((struct
Cyc_Absyn_Malloc_e_struct*)_tmp1FA)->f1;_tmp1FC=_tmp1FB.num_elts;_tmp1FD=_tmp1FB.fat_result;
if(_tmp1FD != 1)goto _LL144;_LL143: malloc_loop: {void*_tmp1FE=(void*)_tmp1FC->r;
struct Cyc_Absyn_Exp*_tmp1FF;void*_tmp200;struct Cyc_Absyn_Vardecl*_tmp201;void*
_tmp202;struct Cyc_Absyn_Vardecl*_tmp203;void*_tmp204;struct Cyc_Absyn_Vardecl*
_tmp205;void*_tmp206;struct Cyc_Absyn_Vardecl*_tmp207;_LL147: if(*((int*)_tmp1FE)
!= 15)goto _LL149;_tmp1FF=((struct Cyc_Absyn_Cast_e_struct*)_tmp1FE)->f2;_LL148:
_tmp1FC=_tmp1FF;goto malloc_loop;_LL149: if(*((int*)_tmp1FE)!= 1)goto _LL14B;
_tmp200=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp1FE)->f2;if(_tmp200 <= (void*)
1  || *((int*)_tmp200)!= 4)goto _LL14B;_tmp201=((struct Cyc_Absyn_Pat_b_struct*)
_tmp200)->f1;_LL14A: _tmp203=_tmp201;goto _LL14C;_LL14B: if(*((int*)_tmp1FE)!= 1)
goto _LL14D;_tmp202=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp1FE)->f2;if(
_tmp202 <= (void*)1  || *((int*)_tmp202)!= 3)goto _LL14D;_tmp203=((struct Cyc_Absyn_Local_b_struct*)
_tmp202)->f1;_LL14C: _tmp205=_tmp203;goto _LL14E;_LL14D: if(*((int*)_tmp1FE)!= 1)
goto _LL14F;_tmp204=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp1FE)->f2;if(
_tmp204 <= (void*)1  || *((int*)_tmp204)!= 2)goto _LL14F;_tmp205=((struct Cyc_Absyn_Param_b_struct*)
_tmp204)->f1;_LL14E: _tmp207=_tmp205;goto _LL150;_LL14F: if(*((int*)_tmp1FE)!= 1)
goto _LL151;_tmp206=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp1FE)->f2;if(
_tmp206 <= (void*)1  || *((int*)_tmp206)!= 0)goto _LL151;_tmp207=((struct Cyc_Absyn_Global_b_struct*)
_tmp206)->f1;_LL150: if(_tmp207->escapes)return r;return({struct Cyc_List_List*
_tmp208=_cycalloc(sizeof(*_tmp208));_tmp208->hd=({struct Cyc_CfFlowInfo_Reln*
_tmp209=_cycalloc(sizeof(*_tmp209));_tmp209->vd=_tmp207;_tmp209->rop=(void*)((
void*)({struct Cyc_CfFlowInfo_LessEqSize_struct*_tmp20A=_cycalloc(sizeof(*_tmp20A));
_tmp20A[0]=({struct Cyc_CfFlowInfo_LessEqSize_struct _tmp20B;_tmp20B.tag=4;_tmp20B.f1=
v;_tmp20B;});_tmp20A;}));_tmp209;});_tmp208->tl=r;_tmp208;});_LL151:;_LL152:
return r;_LL146:;}_LL144:;_LL145: goto _LL141;_LL141:;}{void*_tmp20C=Cyc_Tcutil_compress((
void*)v->type);_LL154: if(_tmp20C <= (void*)4  || *((int*)_tmp20C)!= 5)goto _LL156;
_LL155: goto _LL153;_LL156:;_LL157: return r;_LL153:;}loop: {void*_tmp20D=(void*)e->r;
struct Cyc_Absyn_Exp*_tmp20E;void*_tmp20F;int _tmp210;void*_tmp211;struct Cyc_List_List*
_tmp212;struct Cyc_List_List _tmp213;struct Cyc_List_List*_tmp214;struct Cyc_List_List
_tmp215;struct Cyc_Absyn_Exp*_tmp216;void*_tmp217;struct Cyc_List_List*_tmp218;
struct Cyc_List_List _tmp219;struct Cyc_Absyn_Exp*_tmp21A;_LL159: if(*((int*)_tmp20D)
!= 15)goto _LL15B;_tmp20E=((struct Cyc_Absyn_Cast_e_struct*)_tmp20D)->f2;_LL15A: e=
_tmp20E;goto loop;_LL15B: if(*((int*)_tmp20D)!= 0)goto _LL15D;_tmp20F=(void*)((
struct Cyc_Absyn_Const_e_struct*)_tmp20D)->f1;if(_tmp20F <= (void*)1  || *((int*)
_tmp20F)!= 2)goto _LL15D;_tmp210=((struct Cyc_Absyn_Int_c_struct*)_tmp20F)->f2;
_LL15C: return({struct Cyc_List_List*_tmp21B=_cycalloc(sizeof(*_tmp21B));_tmp21B->hd=({
struct Cyc_CfFlowInfo_Reln*_tmp21C=_cycalloc(sizeof(*_tmp21C));_tmp21C->vd=v;
_tmp21C->rop=(void*)((void*)({struct Cyc_CfFlowInfo_EqualConst_struct*_tmp21D=
_cycalloc_atomic(sizeof(*_tmp21D));_tmp21D[0]=({struct Cyc_CfFlowInfo_EqualConst_struct
_tmp21E;_tmp21E.tag=0;_tmp21E.f1=(unsigned int)_tmp210;_tmp21E;});_tmp21D;}));
_tmp21C;});_tmp21B->tl=r;_tmp21B;});_LL15D: if(*((int*)_tmp20D)!= 3)goto _LL15F;
_tmp211=(void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp20D)->f1;if((int)_tmp211 != 
4)goto _LL15F;_tmp212=((struct Cyc_Absyn_Primop_e_struct*)_tmp20D)->f2;if(_tmp212
== 0)goto _LL15F;_tmp213=*_tmp212;_tmp214=_tmp213.tl;if(_tmp214 == 0)goto _LL15F;
_tmp215=*_tmp214;_tmp216=(struct Cyc_Absyn_Exp*)_tmp215.hd;_LL15E:{void*_tmp21F=(
void*)_tmp216->r;void*_tmp220;struct Cyc_List_List*_tmp221;struct Cyc_List_List
_tmp222;struct Cyc_Absyn_Exp*_tmp223;_LL164: if(*((int*)_tmp21F)!= 3)goto _LL166;
_tmp220=(void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp21F)->f1;if((int)_tmp220 != 
19)goto _LL166;_tmp221=((struct Cyc_Absyn_Primop_e_struct*)_tmp21F)->f2;if(_tmp221
== 0)goto _LL166;_tmp222=*_tmp221;_tmp223=(struct Cyc_Absyn_Exp*)_tmp222.hd;_LL165:{
void*_tmp224=(void*)_tmp223->r;void*_tmp225;struct Cyc_Absyn_Vardecl*_tmp226;void*
_tmp227;struct Cyc_Absyn_Vardecl*_tmp228;void*_tmp229;struct Cyc_Absyn_Vardecl*
...
_tmp225 <= (void*)1  || *((int*)_tmp225)!= 0)goto _LL16B;_tmp226=((struct Cyc_Absyn_Global_b_struct*)
_tmp225)->f1;_LL16A: _tmp228=_tmp226;goto _LL16C;_LL16B: if(*((int*)_tmp224)!= 1)
goto _LL16D;_tmp227=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp224)->f2;if(
_tmp227 <= (void*)1  || *((int*)_tmp227)!= 3)goto _LL16D;_tmp228=((struct Cyc_Absyn_Local_b_struct*)
_tmp227)->f1;_LL16C: _tmp22A=_tmp228;goto _LL16E;_LL16D: if(*((int*)_tmp224)!= 1)
goto _LL16F;_tmp229=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp224)->f2;if(
_tmp229 <= (void*)1  || *((int*)_tmp229)!= 2)goto _LL16F;_tmp22A=((struct Cyc_Absyn_Param_b_struct*)
_tmp229)->f1;_LL16E: _tmp22C=_tmp22A;goto _LL170;_LL16F: if(*((int*)_tmp224)!= 1)
goto _LL171;_tmp22B=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp224)->f2;if(
_tmp22B <= (void*)1  || *((int*)_tmp22B)!= 4)goto _LL171;_tmp22C=((struct Cyc_Absyn_Pat_b_struct*)
_tmp22B)->f1;_LL170: if(_tmp22C->escapes)return r;return({struct Cyc_List_List*
_tmp22D=_cycalloc(sizeof(*_tmp22D));_tmp22D->hd=({struct Cyc_CfFlowInfo_Reln*
_tmp22E=_cycalloc(sizeof(*_tmp22E));_tmp22E->vd=v;_tmp22E->rop=(void*)((void*)({
struct Cyc_CfFlowInfo_LessSize_struct*_tmp22F=_cycalloc(sizeof(*_tmp22F));_tmp22F[
0]=({struct Cyc_CfFlowInfo_LessSize_struct _tmp230;_tmp230.tag=2;_tmp230.f1=
_tmp22C;_tmp230;});_tmp22F;}));_tmp22E;});_tmp22D->tl=r;_tmp22D;});_LL171:;
_LL172: goto _LL168;_LL168:;}goto _LL163;_LL166:;_LL167: goto _LL163;_LL163:;}goto
_LL158;_LL15F: if(*((int*)_tmp20D)!= 3)goto _LL161;_tmp217=(void*)((struct Cyc_Absyn_Primop_e_struct*)
_tmp20D)->f1;if((int)_tmp217 != 19)goto _LL161;_tmp218=((struct Cyc_Absyn_Primop_e_struct*)
_tmp20D)->f2;if(_tmp218 == 0)goto _LL161;_tmp219=*_tmp218;_tmp21A=(struct Cyc_Absyn_Exp*)
_tmp219.hd;_LL160:{void*_tmp231=(void*)_tmp21A->r;void*_tmp232;struct Cyc_Absyn_Vardecl*
_tmp233;void*_tmp234;struct Cyc_Absyn_Vardecl*_tmp235;void*_tmp236;struct Cyc_Absyn_Vardecl*
...
_tmp232 <= (void*)1  || *((int*)_tmp232)!= 0)goto _LL176;_tmp233=((struct Cyc_Absyn_Global_b_struct*)
_tmp232)->f1;_LL175: _tmp235=_tmp233;goto _LL177;_LL176: if(*((int*)_tmp231)!= 1)
goto _LL178;_tmp234=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp231)->f2;if(
_tmp234 <= (void*)1  || *((int*)_tmp234)!= 3)goto _LL178;_tmp235=((struct Cyc_Absyn_Local_b_struct*)
_tmp234)->f1;_LL177: _tmp237=_tmp235;goto _LL179;_LL178: if(*((int*)_tmp231)!= 1)
goto _LL17A;_tmp236=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp231)->f2;if(
_tmp236 <= (void*)1  || *((int*)_tmp236)!= 2)goto _LL17A;_tmp237=((struct Cyc_Absyn_Param_b_struct*)
_tmp236)->f1;_LL179: _tmp239=_tmp237;goto _LL17B;_LL17A: if(*((int*)_tmp231)!= 1)
goto _LL17C;_tmp238=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp231)->f2;if(
_tmp238 <= (void*)1  || *((int*)_tmp238)!= 4)goto _LL17C;_tmp239=((struct Cyc_Absyn_Pat_b_struct*)
_tmp238)->f1;_LL17B: if(_tmp239->escapes)return r;return({struct Cyc_List_List*
_tmp23A=_cycalloc(sizeof(*_tmp23A));_tmp23A->hd=({struct Cyc_CfFlowInfo_Reln*
_tmp23B=_cycalloc(sizeof(*_tmp23B));_tmp23B->vd=v;_tmp23B->rop=(void*)((void*)({
struct Cyc_CfFlowInfo_LessEqSize_struct*_tmp23C=_cycalloc(sizeof(*_tmp23C));
_tmp23C[0]=({struct Cyc_CfFlowInfo_LessEqSize_struct _tmp23D;_tmp23D.tag=4;_tmp23D.f1=
_tmp239;_tmp23D;});_tmp23C;}));_tmp23B;});_tmp23A->tl=r;_tmp23A;});_LL17C:;
_LL17D: goto _LL173;_LL173:;}goto _LL158;_LL161:;_LL162: goto _LL158;_LL158:;}return r;}
struct Cyc_List_List*Cyc_CfFlowInfo_reln_assign_exp(struct Cyc_List_List*r,struct
Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2){{void*_tmp23E=(void*)e1->r;void*_tmp23F;
struct Cyc_Absyn_Vardecl*_tmp240;void*_tmp241;struct Cyc_Absyn_Vardecl*_tmp242;
void*_tmp243;struct Cyc_Absyn_Vardecl*_tmp244;void*_tmp245;struct Cyc_Absyn_Vardecl*
_tmp246;_LL17F: if(*((int*)_tmp23E)!= 1)goto _LL181;_tmp23F=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp23E)->f2;if(_tmp23F <= (void*)1  || *((int*)_tmp23F)!= 0)goto _LL181;_tmp240=((
struct Cyc_Absyn_Global_b_struct*)_tmp23F)->f1;_LL180: _tmp242=_tmp240;goto _LL182;
_LL181: if(*((int*)_tmp23E)!= 1)goto _LL183;_tmp241=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp23E)->f2;if(_tmp241 <= (void*)1  || *((int*)_tmp241)!= 2)goto _LL183;_tmp242=((
...
_tmp23E)->f2;if(_tmp243 <= (void*)1  || *((int*)_tmp243)!= 3)goto _LL185;_tmp244=((
struct Cyc_Absyn_Local_b_struct*)_tmp243)->f1;_LL184: _tmp246=_tmp244;goto _LL186;
_LL185: if(*((int*)_tmp23E)!= 1)goto _LL187;_tmp245=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp23E)->f2;if(_tmp245 <= (void*)1  || *((int*)_tmp245)!= 4)goto _LL187;_tmp246=((
struct Cyc_Absyn_Pat_b_struct*)_tmp245)->f1;_LL186: if(!_tmp246->escapes)return Cyc_CfFlowInfo_reln_assign_var(
r,_tmp246,e2);goto _LL17E;_LL187:;_LL188: goto _LL17E;_LL17E:;}return r;}static void
Cyc_CfFlowInfo_print_reln(struct Cyc_CfFlowInfo_Reln*r){({struct Cyc_String_pa_struct
_tmp249;_tmp249.tag=0;_tmp249.f1=(struct _tagged_arr)((struct _tagged_arr)Cyc_Absynpp_qvar2string((
r->vd)->name));{void*_tmp247[1]={& _tmp249};Cyc_fprintf(Cyc_stderr,({const char*
_tmp248="%s";_tag_arr(_tmp248,sizeof(char),_get_zero_arr_size(_tmp248,3));}),
_tag_arr(_tmp247,sizeof(void*),1));}});{void*_tmp24A=(void*)r->rop;unsigned int
_tmp24B;struct Cyc_Absyn_Vardecl*_tmp24C;struct Cyc_Absyn_Vardecl*_tmp24D;
unsigned int _tmp24E;struct Cyc_Absyn_Vardecl*_tmp24F;_LL18A: if(*((int*)_tmp24A)!= 
0)goto _LL18C;_tmp24B=((struct Cyc_CfFlowInfo_EqualConst_struct*)_tmp24A)->f1;
_LL18B:({struct Cyc_Int_pa_struct _tmp252;_tmp252.tag=1;_tmp252.f1=(unsigned int)((
int)_tmp24B);{void*_tmp250[1]={& _tmp252};Cyc_fprintf(Cyc_stderr,({const char*
_tmp251="==%d";_tag_arr(_tmp251,sizeof(char),_get_zero_arr_size(_tmp251,5));}),
_tag_arr(_tmp250,sizeof(void*),1));}});goto _LL189;_LL18C: if(*((int*)_tmp24A)!= 1)
goto _LL18E;_tmp24C=((struct Cyc_CfFlowInfo_LessVar_struct*)_tmp24A)->f1;_LL18D:({
struct Cyc_String_pa_struct _tmp255;_tmp255.tag=0;_tmp255.f1=(struct _tagged_arr)((
struct _tagged_arr)Cyc_Absynpp_qvar2string(_tmp24C->name));{void*_tmp253[1]={&
_tmp255};Cyc_fprintf(Cyc_stderr,({const char*_tmp254="<%s";_tag_arr(_tmp254,
sizeof(char),_get_zero_arr_size(_tmp254,4));}),_tag_arr(_tmp253,sizeof(void*),1));}});
goto _LL189;_LL18E: if(*((int*)_tmp24A)!= 2)goto _LL190;_tmp24D=((struct Cyc_CfFlowInfo_LessSize_struct*)
_tmp24A)->f1;_LL18F:({struct Cyc_String_pa_struct _tmp258;_tmp258.tag=0;_tmp258.f1=(
struct _tagged_arr)((struct _tagged_arr)Cyc_Absynpp_qvar2string(_tmp24D->name));{
void*_tmp256[1]={& _tmp258};Cyc_fprintf(Cyc_stderr,({const char*_tmp257="<%s.size";
_tag_arr(_tmp257,sizeof(char),_get_zero_arr_size(_tmp257,9));}),_tag_arr(_tmp256,
sizeof(void*),1));}});goto _LL189;_LL190: if(*((int*)_tmp24A)!= 3)goto _LL192;
_tmp24E=((struct Cyc_CfFlowInfo_LessConst_struct*)_tmp24A)->f1;_LL191:({struct Cyc_Int_pa_struct
_tmp25B;_tmp25B.tag=1;_tmp25B.f1=(unsigned int)((int)_tmp24E);{void*_tmp259[1]={&
_tmp25B};Cyc_fprintf(Cyc_stderr,({const char*_tmp25A="<%d";_tag_arr(_tmp25A,
sizeof(char),_get_zero_arr_size(_tmp25A,4));}),_tag_arr(_tmp259,sizeof(void*),1));}});
goto _LL189;_LL192: if(*((int*)_tmp24A)!= 4)goto _LL189;_tmp24F=((struct Cyc_CfFlowInfo_LessEqSize_struct*)
_tmp24A)->f1;_LL193:({struct Cyc_String_pa_struct _tmp25E;_tmp25E.tag=0;_tmp25E.f1=(
struct _tagged_arr)((struct _tagged_arr)Cyc_Absynpp_qvar2string(_tmp24F->name));{
void*_tmp25C[1]={& _tmp25E};Cyc_fprintf(Cyc_stderr,({const char*_tmp25D="<=%s.size";
_tag_arr(_tmp25D,sizeof(char),_get_zero_arr_size(_tmp25D,10));}),_tag_arr(
_tmp25C,sizeof(void*),1));}});goto _LL189;_LL189:;}}void Cyc_CfFlowInfo_print_relns(
...
_tag_arr(_tmp25F,sizeof(void*),0));});}}void Cyc_CfFlowInfo_print_initlevel(void*
il){void*_tmp261=il;_LL195: if((int)_tmp261 != 0)goto _LL197;_LL196:({void*_tmp262[
0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp263="uninitialized";_tag_arr(
_tmp263,sizeof(char),_get_zero_arr_size(_tmp263,14));}),_tag_arr(_tmp262,sizeof(
void*),0));});goto _LL194;_LL197: if((int)_tmp261 != 1)goto _LL199;_LL198:({void*
_tmp264[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp265="this-initialized";
_tag_arr(_tmp265,sizeof(char),_get_zero_arr_size(_tmp265,17));}),_tag_arr(
_tmp264,sizeof(void*),0));});goto _LL194;_LL199: if((int)_tmp261 != 2)goto _LL194;
_LL19A:({void*_tmp266[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp267="all-initialized";
_tag_arr(_tmp267,sizeof(char),_get_zero_arr_size(_tmp267,16));}),_tag_arr(
_tmp266,sizeof(void*),0));});goto _LL194;_LL194:;}void Cyc_CfFlowInfo_print_root(
void*root){void*_tmp268=root;struct Cyc_Absyn_Vardecl*_tmp269;_LL19C: if(*((int*)
_tmp268)!= 0)goto _LL19E;_tmp269=((struct Cyc_CfFlowInfo_VarRoot_struct*)_tmp268)->f1;
_LL19D:({struct Cyc_String_pa_struct _tmp26C;_tmp26C.tag=0;_tmp26C.f1=(struct
_tagged_arr)((struct _tagged_arr)Cyc_Absynpp_qvar2string(_tmp269->name));{void*
_tmp26A[1]={& _tmp26C};Cyc_fprintf(Cyc_stderr,({const char*_tmp26B="Root(%s): ";
_tag_arr(_tmp26B,sizeof(char),_get_zero_arr_size(_tmp26B,11));}),_tag_arr(
_tmp26A,sizeof(void*),1));}});goto _LL19B;_LL19E: if(*((int*)_tmp268)!= 1)goto
_LL1A0;_LL19F:({void*_tmp26D[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp26E="MallocPt(_,_)";
_tag_arr(_tmp26E,sizeof(char),_get_zero_arr_size(_tmp26E,14));}),_tag_arr(
_tmp26D,sizeof(void*),0));});goto _LL19B;_LL1A0: if(*((int*)_tmp268)!= 2)goto
_LL19B;_LL1A1:({void*_tmp26F[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp270="InitParam(_,_)";
_tag_arr(_tmp270,sizeof(char),_get_zero_arr_size(_tmp270,15));}),_tag_arr(
_tmp26F,sizeof(void*),0));});goto _LL19B;_LL19B:;}void Cyc_CfFlowInfo_print_place(
...
_tag_arr(_tmp272,sizeof(char),_get_zero_arr_size(_tmp272,7));}),_tag_arr(_tmp271,
sizeof(void*),0));});}void Cyc_CfFlowInfo_print_place_set(struct Cyc_Dict_Dict*p){
struct _RegionHandle _tmp273=_new_region("r");struct _RegionHandle*r=& _tmp273;
_push_region(r);{struct _handler_cons _tmp274;_push_handler(& _tmp274);{int _tmp276=
0;if(setjmp(_tmp274.handler))_tmp276=1;if(!_tmp276){{struct Cyc_Iter_Iter _tmp277=((
struct Cyc_Iter_Iter(*)(struct _RegionHandle*rgn,struct Cyc_Dict_Dict*d))Cyc_Dict_make_iter)(
r,p);struct _tuple5 _tmp278=*((struct _tuple5*(*)(struct _RegionHandle*r,struct Cyc_Dict_Dict*
d))Cyc_Dict_rchoose)(r,p);int first=1;({void*_tmp279[0]={};Cyc_fprintf(Cyc_stderr,({
const char*_tmp27A="{ ";_tag_arr(_tmp27A,sizeof(char),_get_zero_arr_size(_tmp27A,
3));}),_tag_arr(_tmp279,sizeof(void*),0));});while(((int(*)(struct Cyc_Iter_Iter,
...
const char*_tmp27D=", ";_tag_arr(_tmp27D,sizeof(char),_get_zero_arr_size(_tmp27D,
3));}),_tag_arr(_tmp27C,sizeof(void*),0));});first=0;}Cyc_CfFlowInfo_print_place(
_tmp27B);}({void*_tmp27E[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp27F="}\n";
_tag_arr(_tmp27F,sizeof(char),_get_zero_arr_size(_tmp27F,3));}),_tag_arr(_tmp27E,
sizeof(void*),0));});};_pop_handler();}else{void*_tmp275=(void*)_exn_thrown;void*
_tmp281=_tmp275;_LL1A3:;_LL1A4:({void*_tmp282[0]={};Cyc_fprintf(Cyc_stderr,({
const char*_tmp283="{ }\n";_tag_arr(_tmp283,sizeof(char),_get_zero_arr_size(
_tmp283,5));}),_tag_arr(_tmp282,sizeof(void*),0));});_npop_handler(0);return;
_LL1A5:;_LL1A6:(void)_throw(_tmp281);_LL1A2:;}}};_pop_region(r);}void Cyc_CfFlowInfo_print_absrval(
void*rval){void*_tmp284=rval;void*_tmp285;void*_tmp286;struct Cyc_CfFlowInfo_Place*
_tmp287;struct Cyc_Dict_Dict*_tmp288;_LL1A8: if((int)_tmp284 != 0)goto _LL1AA;_LL1A9:({
void*_tmp289[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp28A="Zero";_tag_arr(
_tmp28A,sizeof(char),_get_zero_arr_size(_tmp28A,5));}),_tag_arr(_tmp289,sizeof(
void*),0));});goto _LL1A7;_LL1AA: if((int)_tmp284 != 1)goto _LL1AC;_LL1AB:({void*
_tmp28B[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp28C="NotZeroAll";_tag_arr(
_tmp28C,sizeof(char),_get_zero_arr_size(_tmp28C,11));}),_tag_arr(_tmp28B,sizeof(
void*),0));});goto _LL1A7;_LL1AC: if((int)_tmp284 != 2)goto _LL1AE;_LL1AD:({void*
_tmp28D[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp28E="NotZeroThis";_tag_arr(
_tmp28E,sizeof(char),_get_zero_arr_size(_tmp28E,12));}),_tag_arr(_tmp28D,sizeof(
void*),0));});goto _LL1A7;_LL1AE: if(_tmp284 <= (void*)3  || *((int*)_tmp284)!= 0)
goto _LL1B0;_tmp285=(void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)_tmp284)->f1;
_LL1AF:({void*_tmp28F[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp290="Unknown(";
_tag_arr(_tmp290,sizeof(char),_get_zero_arr_size(_tmp290,9));}),_tag_arr(_tmp28F,
sizeof(void*),0));});Cyc_CfFlowInfo_print_initlevel(_tmp285);({void*_tmp291[0]={};
Cyc_fprintf(Cyc_stderr,({const char*_tmp292=")";_tag_arr(_tmp292,sizeof(char),
_get_zero_arr_size(_tmp292,2));}),_tag_arr(_tmp291,sizeof(void*),0));});goto
_LL1A7;_LL1B0: if(_tmp284 <= (void*)3  || *((int*)_tmp284)!= 1)goto _LL1B2;_tmp286=(
void*)((struct Cyc_CfFlowInfo_Esc_struct*)_tmp284)->f1;_LL1B1:({void*_tmp293[0]={};
Cyc_fprintf(Cyc_stderr,({const char*_tmp294="Esc(";_tag_arr(_tmp294,sizeof(char),
_get_zero_arr_size(_tmp294,5));}),_tag_arr(_tmp293,sizeof(void*),0));});Cyc_CfFlowInfo_print_initlevel(
_tmp286);({void*_tmp295[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp296=")";
_tag_arr(_tmp296,sizeof(char),_get_zero_arr_size(_tmp296,2));}),_tag_arr(_tmp295,
sizeof(void*),0));});goto _LL1A7;_LL1B2: if(_tmp284 <= (void*)3  || *((int*)_tmp284)
!= 2)goto _LL1B4;_tmp287=((struct Cyc_CfFlowInfo_AddressOf_struct*)_tmp284)->f1;
_LL1B3:({void*_tmp297[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp298="AddrOf(";
_tag_arr(_tmp298,sizeof(char),_get_zero_arr_size(_tmp298,8));}),_tag_arr(_tmp297,
sizeof(void*),0));});Cyc_CfFlowInfo_print_place(_tmp287);({void*_tmp299[0]={};
Cyc_fprintf(Cyc_stderr,({const char*_tmp29A=")";_tag_arr(_tmp29A,sizeof(char),
_get_zero_arr_size(_tmp29A,2));}),_tag_arr(_tmp299,sizeof(void*),0));});goto
_LL1A7;_LL1B4: if(_tmp284 <= (void*)3  || *((int*)_tmp284)!= 3)goto _LL1B6;_LL1B5:({
void*_tmp29B[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp29C="TagCmps(?)";
_tag_arr(_tmp29C,sizeof(char),_get_zero_arr_size(_tmp29C,11));}),_tag_arr(
_tmp29B,sizeof(void*),0));});goto _LL1A7;_LL1B6: if(_tmp284 <= (void*)3  || *((int*)
...
_tag_arr(_tmp29E,sizeof(char),_get_zero_arr_size(_tmp29E,13));}),_tag_arr(
_tmp29D,sizeof(void*),0));});goto _LL1A7;_LL1A7:;}static void Cyc_CfFlowInfo_print_flow_mapping(
void*root,void*rval){({void*_tmp29F[0]={};Cyc_fprintf(Cyc_stderr,({const char*
_tmp2A0="    ";_tag_arr(_tmp2A0,sizeof(char),_get_zero_arr_size(_tmp2A0,5));}),
_tag_arr(_tmp29F,sizeof(void*),0));});Cyc_CfFlowInfo_print_root(root);({void*
_tmp2A1[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp2A2=" --> ";_tag_arr(
_tmp2A2,sizeof(char),_get_zero_arr_size(_tmp2A2,6));}),_tag_arr(_tmp2A1,sizeof(
void*),0));});Cyc_CfFlowInfo_print_absrval(rval);({void*_tmp2A3[0]={};Cyc_fprintf(
Cyc_stderr,({const char*_tmp2A4="\n";_tag_arr(_tmp2A4,sizeof(char),
_get_zero_arr_size(_tmp2A4,2));}),_tag_arr(_tmp2A3,sizeof(void*),0));});}void Cyc_CfFlowInfo_print_flowdict(
...
_tag_arr(_tmp2A9,sizeof(char),_get_zero_arr_size(_tmp2A9,12));}),_tag_arr(
_tmp2A8,sizeof(void*),0));});goto _LL1B8;_LL1BB: if(_tmp2A5 <= (void*)1  || *((int*)
_tmp2A5)!= 0)goto _LL1B8;_tmp2A6=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
...
_tag_arr(_tmp2AB,sizeof(char),_get_zero_arr_size(_tmp2AB,16));}),_tag_arr(
_tmp2AA,sizeof(void*),0));});Cyc_Dict_iter(Cyc_CfFlowInfo_print_flow_mapping,
_tmp2A6);({void*_tmp2AC[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp2AD="\n    consumed: ";
_tag_arr(_tmp2AD,sizeof(char),_get_zero_arr_size(_tmp2AD,16));}),_tag_arr(
_tmp2AC,sizeof(void*),0));});Cyc_CfFlowInfo_print_place_set(_tmp2A7.consumed);({
void*_tmp2AE[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp2AF="\n    may_consume: ";
_tag_arr(_tmp2AF,sizeof(char),_get_zero_arr_size(_tmp2AF,19));}),_tag_arr(
_tmp2AE,sizeof(void*),0));});Cyc_CfFlowInfo_print_place_list(_tmp2A7.may_consume);({
void*_tmp2B0[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp2B1="\n";_tag_arr(
_tmp2B1,sizeof(char),_get_zero_arr_size(_tmp2B1,2));}),_tag_arr(_tmp2B0,sizeof(
void*),0));});goto _LL1B8;_LL1B8:;}int Cyc_CfFlowInfo_contains_region(void*rgn,
void*t){void*_tmp2B2=Cyc_Tcutil_compress(t);struct Cyc_Absyn_Tvar*_tmp2B3;struct
Cyc_Absyn_TunionInfo _tmp2B4;struct Cyc_List_List*_tmp2B5;void*_tmp2B6;struct Cyc_List_List*
_tmp2B7;struct Cyc_Absyn_AggrInfo _tmp2B8;struct Cyc_List_List*_tmp2B9;struct Cyc_Absyn_TunionFieldInfo
...
_LL1C0;_LL1BF: goto _LL1C1;_LL1C0: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 5)
goto _LL1C2;_LL1C1: goto _LL1C3;_LL1C2: if((int)_tmp2B2 != 1)goto _LL1C4;_LL1C3: goto
_LL1C5;_LL1C4: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 6)goto _LL1C6;_LL1C5:
goto _LL1C7;_LL1C6: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 12)goto _LL1C8;
_LL1C7: goto _LL1C9;_LL1C8: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 13)goto
_LL1CA;_LL1C9: goto _LL1CB;_LL1CA: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 14)
goto _LL1CC;_LL1CB: goto _LL1CD;_LL1CC: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 
17)goto _LL1CE;_LL1CD: goto _LL1CF;_LL1CE: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)
!= 18)goto _LL1D0;_LL1CF: goto _LL1D1;_LL1D0: if((int)_tmp2B2 != 2)goto _LL1D2;_LL1D1:
goto _LL1D3;_LL1D2: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 0)goto _LL1D4;
_LL1D3: return 0;_LL1D4: if((int)_tmp2B2 != 3)goto _LL1D6;_LL1D5: {void*_tmp2C8=rgn;
_LL1F3: if((int)_tmp2C8 != 0)goto _LL1F5;_LL1F4: return 1;_LL1F5:;_LL1F6: return 0;
_LL1F2:;}_LL1D6: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 1)goto _LL1D8;_tmp2B3=((
struct Cyc_Absyn_VarType_struct*)_tmp2B2)->f1;_LL1D7: {void*_tmp2C9=rgn;struct Cyc_Absyn_Tvar*
_tmp2CA;_LL1F8: if((int)_tmp2C9 != 0)goto _LL1FA;_LL1F9: return 0;_LL1FA: if(_tmp2C9 <= (
void*)1  || *((int*)_tmp2C9)!= 0)goto _LL1F7;_tmp2CA=((struct Cyc_CfFlowInfo_Region_k_struct*)
_tmp2C9)->f1;_LL1FB: return Cyc_Absyn_tvar_cmp(_tmp2B3,_tmp2CA)== 0;_LL1F7:;}
_LL1D8: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 2)goto _LL1DA;_tmp2B4=((struct
Cyc_Absyn_TunionType_struct*)_tmp2B2)->f1;_tmp2B5=_tmp2B4.targs;_tmp2B6=(void*)
_tmp2B4.rgn;_LL1D9: if(Cyc_CfFlowInfo_contains_region(rgn,_tmp2B6))return 1;
_tmp2B7=_tmp2B5;goto _LL1DB;_LL1DA: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 16)
goto _LL1DC;_tmp2B7=((struct Cyc_Absyn_TypedefType_struct*)_tmp2B2)->f2;_LL1DB:
_tmp2B9=_tmp2B7;goto _LL1DD;_LL1DC: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 10)
goto _LL1DE;_tmp2B8=((struct Cyc_Absyn_AggrType_struct*)_tmp2B2)->f1;_tmp2B9=
_tmp2B8.targs;_LL1DD: _tmp2BB=_tmp2B9;goto _LL1DF;_LL1DE: if(_tmp2B2 <= (void*)4  || *((
int*)_tmp2B2)!= 3)goto _LL1E0;_tmp2BA=((struct Cyc_Absyn_TunionFieldType_struct*)
_tmp2B2)->f1;_tmp2BB=_tmp2BA.targs;_LL1DF: _tmp2BC=_tmp2BB;goto _LL1E1;_LL1E0: if(
_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 20)goto _LL1E2;_tmp2BC=((struct Cyc_Absyn_JoinEff_struct*)
_tmp2B2)->f1;_LL1E1: return Cyc_List_exists_c(Cyc_CfFlowInfo_contains_region,rgn,
_tmp2BC);_LL1E2: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 4)goto _LL1E4;_tmp2BD=((
struct Cyc_Absyn_PointerType_struct*)_tmp2B2)->f1;_tmp2BE=(void*)_tmp2BD.elt_typ;
_tmp2BF=_tmp2BD.ptr_atts;_tmp2C0=(void*)_tmp2BF.rgn;_LL1E3: return Cyc_CfFlowInfo_contains_region(
rgn,_tmp2C0) || Cyc_CfFlowInfo_contains_region(rgn,_tmp2BE);_LL1E4: if(_tmp2B2 <= (
void*)4  || *((int*)_tmp2B2)!= 8)goto _LL1E6;_LL1E5: return 0;_LL1E6: if(_tmp2B2 <= (
void*)4  || *((int*)_tmp2B2)!= 9)goto _LL1E8;_tmp2C1=((struct Cyc_Absyn_TupleType_struct*)
_tmp2B2)->f1;_LL1E7: for(0;_tmp2C1 != 0;_tmp2C1=_tmp2C1->tl){if(Cyc_CfFlowInfo_contains_region(
rgn,(*((struct _tuple6*)_tmp2C1->hd)).f2))return 1;}return 0;_LL1E8: if(_tmp2B2 <= (
void*)4  || *((int*)_tmp2B2)!= 11)goto _LL1EA;_tmp2C2=((struct Cyc_Absyn_AnonAggrType_struct*)
...
_LL1EA: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 7)goto _LL1EC;_tmp2C3=((struct
Cyc_Absyn_ArrayType_struct*)_tmp2B2)->f1;_tmp2C4=(void*)_tmp2C3.elt_type;_LL1EB:
_tmp2C5=_tmp2C4;goto _LL1ED;_LL1EC: if(_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 19)
goto _LL1EE;_tmp2C5=(void*)((struct Cyc_Absyn_AccessEff_struct*)_tmp2B2)->f1;
_LL1ED: _tmp2C6=_tmp2C5;goto _LL1EF;_LL1EE: if(_tmp2B2 <= (void*)4  || *((int*)
_tmp2B2)!= 21)goto _LL1F0;_tmp2C6=(void*)((struct Cyc_Absyn_RgnsEff_struct*)
_tmp2B2)->f1;_LL1EF: return Cyc_CfFlowInfo_contains_region(rgn,_tmp2C6);_LL1F0: if(
_tmp2B2 <= (void*)4  || *((int*)_tmp2B2)!= 15)goto _LL1BD;_tmp2C7=(void*)((struct
Cyc_Absyn_RgnHandleType_struct*)_tmp2B2)->f1;_LL1F1: return 0;_LL1BD:;}struct
_tuple9{struct Cyc_Dict_Dict*f1;void*f2;};static void Cyc_CfFlowInfo_kill_root(
...
_tmp2D4;_LL204: if(_tmp2D3 <= (void*)4  || *((int*)_tmp2D3)!= 1)goto _LL206;_tmp2D4=((
struct Cyc_Absyn_VarType_struct*)_tmp2D3)->f1;_LL205: {struct Cyc_CfFlowInfo_Region_k_struct
...
const char*_tmp2DA="kill_flowdict_region";_tag_arr(_tmp2DA,sizeof(char),
...
void*)1  || *((int*)_tmp2DB)!= 0)goto _LL20A;_tmp2DC=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
...
_tag_arr(_tmp2E8,sizeof(char),_get_zero_arr_size(_tmp2E8,54));}),({const char*
_tmp2E9="May consume unique pointer %s more than once";_tag_arr(_tmp2E9,sizeof(
char),_get_zero_arr_size(_tmp2E9,45));}),_tmp2E7,_tmp2E6);}}void*Cyc_CfFlowInfo_consume_unique_rvals(
struct Cyc_Position_Segment*loc,void*f){void*_tmp2EA=f;struct Cyc_Dict_Dict*
_tmp2EB;struct Cyc_List_List*_tmp2EC;struct Cyc_CfFlowInfo_ConsumeInfo _tmp2ED;
_LL210: if((int)_tmp2EA != 0)goto _LL212;_LL211: return f;_LL212: if(_tmp2EA <= (void*)
1  || *((int*)_tmp2EA)!= 0)goto _LL20F;_tmp2EB=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
...
_LL215: if((int)_tmp2F3 != 0)goto _LL217;_LL216: return;_LL217: if(_tmp2F3 <= (void*)1
 || *((int*)_tmp2F3)!= 0)goto _LL214;_tmp2F4=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
...
_tmp2F9="Read through possibly consumed unique pointer %s (cf. %s)";_tag_arr(
_tmp2F9,sizeof(char),_get_zero_arr_size(_tmp2F9,58));}),({const char*_tmp2FA="Read through possibly consumed unique pointer %s";
_tag_arr(_tmp2FA,sizeof(char),_get_zero_arr_size(_tmp2FA,49));}),_tmp2F8,loc);
break;}_tmp2F7=_tmp2F7->tl;}return;}_LL214:;}void*Cyc_CfFlowInfo_drop_unique_rvals(
...
1  || *((int*)_tmp2FB)!= 0)goto _LL219;_tmp2FC=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
...
1  || *((int*)_tmp301)!= 0)goto _LL21E;_tmp302=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
...
f;_tmp30C;});_LL226: if(_tmp307 <= (void*)1  || *((int*)_tmp307)!= 0)goto _LL223;
_tmp308=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp307)->f1;_tmp309=((struct
Cyc_CfFlowInfo_ReachableFL_struct*)_tmp307)->f2;_tmp30A=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp307)->f3;_LL227: if(clear)return({struct _tuple4 _tmp30E;_tmp30E.f1=_tmp30A;
_tmp30E.f2=(void*)({struct Cyc_CfFlowInfo_ReachableFL_struct*_tmp30F=_cycalloc(
sizeof(*_tmp30F));_tmp30F[0]=({struct Cyc_CfFlowInfo_ReachableFL_struct _tmp310;
_tmp310.tag=0;_tmp310.f1=_tmp308;_tmp310.f2=_tmp309;_tmp310.f3=({struct Cyc_CfFlowInfo_ConsumeInfo
_tmp311;_tmp311.consumed=Cyc_CfFlowInfo_mt_place_set();_tmp311.may_consume=0;
_tmp311;});_tmp310;});_tmp30F;});_tmp30E;});else{return({struct _tuple4 _tmp312;
_tmp312.f1=_tmp30A;_tmp312.f2=f;_tmp312;});}_LL223:;}void*Cyc_CfFlowInfo_restore_consume_info(
void*f,struct Cyc_CfFlowInfo_ConsumeInfo c){void*_tmp313=f;struct Cyc_Dict_Dict*
_tmp314;struct Cyc_List_List*_tmp315;_LL229: if((int)_tmp313 != 0)goto _LL22B;_LL22A:
return f;_LL22B: if(_tmp313 <= (void*)1  || *((int*)_tmp313)!= 0)goto _LL228;_tmp314=((
struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp313)->f1;_tmp315=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp313)->f2;_LL22C: return(void*)({struct Cyc_CfFlowInfo_ReachableFL_struct*
_tmp316=_cycalloc(sizeof(*_tmp316));_tmp316[0]=({struct Cyc_CfFlowInfo_ReachableFL_struct
_tmp317;_tmp317.tag=0;_tmp317.f1=_tmp314;_tmp317.f2=_tmp315;_tmp317.f3=c;_tmp317;});
_tmp316;});_LL228:;}
