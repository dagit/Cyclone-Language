...
return _tmp89;}}struct _tuple20{struct _RegionHandle*f1;struct Cyc_Tcenv_Tenv*f2;};
struct Cyc_List_List*Cyc_do_typecheck(struct _tuple20*tcenv,struct Cyc_List_List*
tds){struct _RegionHandle*_tmp8B;struct Cyc_Tcenv_Tenv*_tmp8C;struct _tuple20 _tmp8A=*
...
tds){struct _tuple21 _tmp8E;struct Cyc_Tcenv_Tenv*_tmp8F;struct Cyc___cycFILE*_tmp90;
struct Cyc___cycFILE*_tmp91;struct _tuple21*_tmp8D=params;_tmp8E=*_tmp8D;_tmp8F=
...
_tmp93,_tmp92,({struct _tuple18*_tmp94=_cycalloc(sizeof(*_tmp94));_tmp94->f1=({
...
tc_rgn);if(Cyc_parseonly_r)goto PRINTC;{struct _tuple20 _tmp10A=({struct _tuple20
...
_tmpE3);{struct _tuple21 _tmp10D=({struct _tuple21 _tmp10F;_tmp10F.f1=_tmp109;
...
_tmp16A[64];_tmp16A[63]=({struct _tuple22*_tmp2E5=_region_malloc(r,sizeof(*
...
_tuple22*_tmp2D3=_region_malloc(r,sizeof(*_tmp2D3));_tmp2D3->f1=({const char*
...
sizeof(char),39);});_tmp2D3;});_tmp16A[59]=({struct _tuple22*_tmp2CD=
...
_tuple22*_tmp2C7=_region_malloc(r,sizeof(*_tmp2C7));_tmp2C7->f1=({const char*
...
_tmp2C8,sizeof(char),44);});_tmp2C7;});_tmp16A[57]=({struct _tuple22*_tmp2C1=
...
_tuple22*_tmp2BB=_region_malloc(r,sizeof(*_tmp2BB));_tmp2BB->f1=({const char*
...
sizeof(char),46);});_tmp2BB;});_tmp16A[55]=({struct _tuple22*_tmp2B5=
...
_tuple22*_tmp2AF=_region_malloc(r,sizeof(*_tmp2AF));_tmp2AF->f1=({const char*
...
_tmp2B0,sizeof(char),50);});_tmp2AF;});_tmp16A[53]=({struct _tuple22*_tmp2A9=
...
_tuple22*_tmp29D=_region_malloc(r,sizeof(*_tmp29D));_tmp29D->f1=({const char*
...
sizeof(char),41);});_tmp29D;});_tmp16A[50]=({struct _tuple22*_tmp297=
...
_tuple22*_tmp285=_region_malloc(r,sizeof(*_tmp285));_tmp285->f1=({const char*
...
char),40);});_tmp285;});_tmp16A[46]=({struct _tuple22*_tmp27F=_region_malloc(r,
...
sizeof(char),35);});_tmp27F;});_tmp16A[45]=({struct _tuple22*_tmp279=
...
_tuple22*_tmp273=_region_malloc(r,sizeof(*_tmp273));_tmp273->f1=({const char*
...
_tmp273;});_tmp16A[43]=({struct _tuple22*_tmp26D=_region_malloc(r,sizeof(*_tmp26D));
...
sizeof(char),20);});_tmp26D;});_tmp16A[42]=({struct _tuple22*_tmp267=
...
_tuple22*_tmp261=_region_malloc(r,sizeof(*_tmp261));_tmp261->f1=({const char*
...
36);});_tmp261;});_tmp16A[40]=({struct _tuple22*_tmp25B=_region_malloc(r,sizeof(*
...
sizeof(char),31);});_tmp25B;});_tmp16A[39]=({struct _tuple22*_tmp255=
...
_tuple22*_tmp21F=_region_malloc(r,sizeof(*_tmp21F));_tmp21F->f1=({const char*
...
sizeof(char),42);});_tmp21F;});_tmp16A[29]=({struct _tuple22*_tmp219=
...
_tuple22*_tmp213=_region_malloc(r,sizeof(*_tmp213));_tmp213->f1=({const char*
...
_tmp16A[27]=({struct _tuple22*_tmp20D=_region_malloc(r,sizeof(*_tmp20D));_tmp20D->f1=({
...
_tmp20D;});_tmp16A[26]=({struct _tuple22*_tmp207=_region_malloc(r,sizeof(*_tmp207));
...
sizeof(char),21);});_tmp207;});_tmp16A[25]=({struct _tuple22*_tmp201=
...
_tuple22*_tmp1FB=_region_malloc(r,sizeof(*_tmp1FB));_tmp1FB->f1=({const char*
...
29);});_tmp1FB;});_tmp16A[23]=({struct _tuple22*_tmp1F5=_region_malloc(r,sizeof(*
...
_tuple22*_tmp1CB=_region_malloc(r,sizeof(*_tmp1CB));_tmp1CB->f1=({const char*
...
_tmp1CB;});_tmp16A[15]=({struct _tuple22*_tmp1C5=_region_malloc(r,sizeof(*_tmp1C5));
...
23);});_tmp1C5;});_tmp16A[14]=({struct _tuple22*_tmp1BF=_region_malloc(r,sizeof(*
...
sizeof(char),31);});_tmp1BF;});_tmp16A[13]=({struct _tuple22*_tmp1B9=
...
_tmp1BA,sizeof(char),9);});_tmp1B9;});_tmp16A[12]=({struct _tuple22*_tmp1B3=
...
_tuple22*_tmp1A7=_region_malloc(r,sizeof(*_tmp1A7));_tmp1A7->f1=({const char*
...
_tmp1A8,sizeof(char),49);});_tmp1A7;});_tmp16A[9]=({struct _tuple22*_tmp1A1=
...
_tuple22*_tmp17D=_region_malloc(r,sizeof(*_tmp17D));_tmp17D->f1=({const char*
...
_tmp17D;});_tmp16A[2]=({struct _tuple22*_tmp177=_region_malloc(r,sizeof(*_tmp177));
...
_tuple22*_tmp171=_region_malloc(r,sizeof(*_tmp171));_tmp171->f1=({const char*
...
35);});_tmp171;});_tmp16A[0]=({struct _tuple22*_tmp16B=_region_malloc(r,sizeof(*
...
_tuple22*),64));});struct _dyneither_ptr optstring=({const char*_tmp169="Options:";
...
Cyc_Interface_I*)_tmp31D,({struct _tuple18*_tmp329=_cycalloc(sizeof(*_tmp329));
