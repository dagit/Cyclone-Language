...
Cyc_Position_use_gcc_style_location;extern int Cyc_Position_max_errors;int Cyc_Position_error_p();
...
_tagged_arr*f1;};extern char Cyc_Absyn_EmptyAnnot[15];extern int Cyc_Absyn_porting_c_code;
...
_tuple11{struct _tagged_arr f1;struct _tagged_arr f2;};int Cyc_Interface_is_subinterface(
...
65535;Cyc_save_c_r=1;Cyc_parseonly_r=1;}static struct _tagged_arr*Cyc_output_file=
0;static void Cyc_set_output_file(struct _tagged_arr s){Cyc_output_file=({struct
_tagged_arr*_tmp0=_cycalloc(sizeof(*_tmp0));_tmp0[0]=s;_tmp0;});}extern char*
Cdef_inc_path;extern char*Cdef_lib_path;extern char*Carch;extern char*Ccomp;extern
char*Cversion;static char _tmp1[1]="";static struct _tagged_arr Cyc_cpp={_tmp1,_tmp1,
_tmp1 + 1};static void Cyc_set_cpp(struct _tagged_arr s){Cyc_cpp=s;}static struct Cyc_List_List*
Cyc_cppargs=0;static void Cyc_add_cpparg(struct _tagged_arr s){Cyc_cppargs=({struct
Cyc_List_List*_tmp2=_cycalloc(sizeof(*_tmp2));_tmp2->hd=({struct _tagged_arr*
_tmp3=_cycalloc(sizeof(*_tmp3));_tmp3[0]=s;_tmp3;});_tmp2->tl=Cyc_cppargs;_tmp2;});}
static struct _tagged_arr Cyc_target_arch=(struct _tagged_arr){(void*)0,(void*)0,(
void*)(0 + 0)};static void Cyc_set_target_arch(struct _tagged_arr s){Cyc_toc_r=1;Cyc_target_arch=
s;}static void Cyc_print_version(){({struct Cyc_String_pa_struct _tmp6;_tmp6.tag=0;
...
Cyc_remove_file((struct _tagged_arr)_tmpAF);return;}if(Cyc_Absyn_porting_c_code){
Cyc_Port_port(tds);return;}{struct Cyc_Tcenv_Tenv*_tmpD5=Cyc_Tcenv_tc_init();if(
Cyc_parseonly_r)goto PRINTC;tds=((struct Cyc_List_List*(*)(struct _tagged_arr
stage_name,struct Cyc_List_List*(*f)(struct Cyc_Tcenv_Tenv*,struct Cyc_List_List*),
struct Cyc_Tcenv_Tenv*env,struct Cyc_List_List*tds))Cyc_do_stage)(({const char*
_tmpD6="type checking";_tag_arr(_tmpD6,sizeof(char),_get_zero_arr_size(_tmpD6,14));}),
Cyc_do_typecheck,_tmpD5,tds);if(Cyc_compile_failure){Cyc_remove_file((struct
_tagged_arr)_tmpAF);return;}tds=((struct Cyc_List_List*(*)(struct _tagged_arr
stage_name,struct Cyc_List_List*(*f)(int,struct Cyc_List_List*),int env,struct Cyc_List_List*
tds))Cyc_do_stage)(({const char*_tmpD7="control-flow checking";_tag_arr(_tmpD7,
sizeof(char),_get_zero_arr_size(_tmpD7,22));}),Cyc_do_cfcheck,1,tds);if(Cyc_compile_failure){
Cyc_remove_file((struct _tagged_arr)_tmpAF);return;}if(Cyc_ic_r){struct Cyc___cycFILE*
inter_file=Cyc_fopen((const char*)((char*)_untag_arr(_tmpB0,sizeof(char),1)),(
const char*)"r");struct Cyc___cycFILE*inter_objfile=Cyc_try_file_open((struct
_tagged_arr)_tmpB1,({const char*_tmpDA="w";_tag_arr(_tmpDA,sizeof(char),
_get_zero_arr_size(_tmpDA,2));}),({const char*_tmpDB="interface object file";
...
struct Cyc_List_List*(*f)(struct _tuple12*,struct Cyc_List_List*),struct _tuple12*
...
struct _tuple12*_tmpD9=_cycalloc(sizeof(*_tmpD9));_tmpD9->f1=_tmpD5;_tmpD9->f2=
...
!= '-';}void GC_blacklist_warn_clear();struct _tuple13{struct _tagged_arr f1;int f2;
...
options=({struct _tuple13*_tmp179[58];_tmp179[57]=({struct _tuple13*_tmp2D0=
_cycalloc(sizeof(*_tmp2D0));_tmp2D0->f1=({const char*_tmp2D5="-port";_tag_arr(
_tmp2D5,sizeof(char),_get_zero_arr_size(_tmp2D5,6));});_tmp2D0->f2=0;_tmp2D0->f3=({
const char*_tmp2D4="";_tag_arr(_tmp2D4,sizeof(char),_get_zero_arr_size(_tmp2D4,1));});
_tmp2D0->f4=(void*)({struct Cyc_Arg_Unit_spec_struct*_tmp2D2=_cycalloc(sizeof(*
_tmp2D2));_tmp2D2[0]=({struct Cyc_Arg_Unit_spec_struct _tmp2D3;_tmp2D3.tag=0;
_tmp2D3.f1=Cyc_set_port_c_code;_tmp2D3;});_tmp2D2;});_tmp2D0->f5=({const char*
_tmp2D1="Suggest how to port C code to Cyclone";_tag_arr(_tmp2D1,sizeof(char),
_get_zero_arr_size(_tmp2D1,38));});_tmp2D0;});_tmp179[56]=({struct _tuple13*
...
struct _tuple13*_tmp2AC=_cycalloc(sizeof(*_tmp2AC));_tmp2AC->f1=({const char*
...
char),_get_zero_arr_size(_tmp289,36));});_tmp288;});_tmp179[44]=({struct _tuple13*
...
char),_get_zero_arr_size(_tmp283,33));});_tmp282;});_tmp179[43]=({struct _tuple13*
...
char),_get_zero_arr_size(_tmp259,36));});_tmp258;});_tmp179[36]=({struct _tuple13*
...
_get_zero_arr_size(_tmp253,31));});_tmp252;});_tmp179[35]=({struct _tuple13*
...
_tuple13*_tmp246=_cycalloc(sizeof(*_tmp246));_tmp246->f1=({const char*_tmp24B="-tovc";
...
char),_get_zero_arr_size(_tmp247,33));});_tmp246;});_tmp179[33]=({struct _tuple13*
...
_tmp241,11));});_tmp240;});_tmp179[32]=({struct _tuple13*_tmp23A=_cycalloc(
...
_tmp179[31]=({struct _tuple13*_tmp234=_cycalloc(sizeof(*_tmp234));_tmp234->f1=({
...
_get_zero_arr_size(_tmp235,26));});_tmp234;});_tmp179[30]=({struct _tuple13*
...
_get_zero_arr_size(_tmp22F,28));});_tmp22E;});_tmp179[29]=({struct _tuple13*
...
_tuple13*_tmp216=_cycalloc(sizeof(*_tmp216));_tmp216->f1=({const char*_tmp21B="-Wall";
...
char),_get_zero_arr_size(_tmp217,21));});_tmp216;});_tmp179[25]=({struct _tuple13*
...
_tmp179[23]=({struct _tuple13*_tmp204=_cycalloc(sizeof(*_tmp204));_tmp204->f1=({
...
char),_get_zero_arr_size(_tmp1FF,21));});_tmp1FE;});_tmp179[21]=({struct _tuple13*
...
struct _tuple13*_tmp1F2=_cycalloc(sizeof(*_tmp1F2));_tmp1F2->f1=({const char*
...
char),_get_zero_arr_size(_tmp1F3,33));});_tmp1F2;});_tmp179[19]=({struct _tuple13*
...
char),_get_zero_arr_size(_tmp1ED,33));});_tmp1EC;});_tmp179[18]=({struct _tuple13*
...
_get_zero_arr_size(_tmp1E7,32));});_tmp1E6;});_tmp179[17]=({struct _tuple13*
...
_get_zero_arr_size(_tmp1E1,22));});_tmp1E0;});_tmp179[16]=({struct _tuple13*
...
_get_zero_arr_size(_tmp1DB,19));});_tmp1DA;});_tmp179[15]=({struct _tuple13*
...
_get_zero_arr_size(_tmp1D5,23));});_tmp1D4;});_tmp179[14]=({struct _tuple13*
...
_get_zero_arr_size(_tmp1CF,31));});_tmp1CE;});_tmp179[13]=({struct _tuple13*
...
_tmp1C9,9));});_tmp1C8;});_tmp179[12]=({struct _tuple13*_tmp1C2=_cycalloc(sizeof(*
...
struct _tuple13*_tmp1BC=_cycalloc(sizeof(*_tmp1BC));_tmp1BC->f1=({const char*
...
struct _tuple13*_tmp1A4=_cycalloc(sizeof(*_tmp1A4));_tmp1A4->f1=({const char*
...
_get_zero_arr_size(_tmp1A5,13));});_tmp1A4;});_tmp179[6]=({struct _tuple13*
...
_tuple13*_tmp198=_cycalloc(sizeof(*_tmp198));_tmp198->f1=({const char*_tmp19D="-I";
...
struct _tuple13*_tmp180=_cycalloc(sizeof(*_tmp180));_tmp180->f1=({const char*
...
char),_get_zero_arr_size(_tmp181,35));});_tmp180;});_tmp179[0]=({struct _tuple13*
...
struct _tagged_arr))Cyc_List_list)(_tag_arr(_tmp179,sizeof(struct _tuple13*),58));});
...
Cyc_Interface_I*)_tmp13C,({struct _tuple11*_tmp148=_cycalloc(sizeof(*_tmp148));
...
struct _tagged_arr)((struct _tagged_arr)_tmp151);{void*_tmp154[1]={& _tmp156};Cyc_fprintf(
Cyc_stderr,({const char*_tmp155="Exception Core::Failure %s\n";_tag_arr(_tmp155,
sizeof(char),_get_zero_arr_size(_tmp155,28));}),_tag_arr(_tmp154,sizeof(void*),1));}});
goto _LL3A;_LL3D: if(*((void**)_tmp150)!= Cyc_Core_Impossible)goto _LL3F;_tmp152=((
...
void*_tmp157[1]={& _tmp159};Cyc_fprintf(Cyc_stderr,({const char*_tmp158="Exception Core::Impossible %s\n";
...
_LL41;_LL40:({void*_tmp15A[0]={};Cyc_fprintf(Cyc_stderr,({const char*_tmp15B="Exception Dict::Absent\n";
...
struct _tagged_arr)_tmp153);{void*_tmp15C[1]={& _tmp15E};Cyc_fprintf(Cyc_stderr,({
const char*_tmp15D="Exception Core::Invalid_argument %s\n";_tag_arr(_tmp15D,
sizeof(char),_get_zero_arr_size(_tmp15D,37));}),_tag_arr(_tmp15C,sizeof(void*),1));}});
goto _LL3A;_LL43:;_LL44:({void*_tmp15F[0]={};Cyc_fprintf(Cyc_stderr,({const char*
_tmp160="Uncaught exception\n";_tag_arr(_tmp160,sizeof(char),_get_zero_arr_size(
_tmp160,20));}),_tag_arr(_tmp15F,sizeof(void*),0));});goto _LL3A;_LL3A:;}Cyc_compile_failure=
1;Cyc_remove_cfiles();return 1;_LL38:;_LL39:(void)_throw(_tmp14F);_LL35:;}}}{
struct _tagged_arr outfile_str=({const char*_tmp171="";_tag_arr(_tmp171,sizeof(char),
