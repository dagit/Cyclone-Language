...
struct _tuple10 _tmp1A3=Cyc_Evexp_eval_const_uint_exp(e1);_tmp1A4=_tmp1A3.f1;
_tmp1A5=_tmp1A3.f2;{unsigned int _tmp1A7;int _tmp1A8;struct _tuple10 _tmp1A6=Cyc_Evexp_eval_const_uint_exp(
