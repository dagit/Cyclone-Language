...
static struct _dyneither_ptr Cyc_Port_ctype2string(int deep,void*t){void*_tmp0=t;
struct _dyneither_ptr*_tmp1;void*_tmp2;void*_tmp3;void*_tmp4;void*_tmp5;void*
_tmp6;void*_tmp7;void*_tmp8;void*_tmp9;struct _tuple10*_tmpA;struct _tuple10 _tmpB;
struct Cyc_Absyn_Aggrdecl*_tmpC;struct Cyc_List_List*_tmpD;struct Cyc_List_List*
_tmpE;void**_tmpF;void*_tmp10;struct Cyc_List_List*_tmp11;void*_tmp12;struct Cyc_List_List*
_tmp13;struct Cyc_Port_Cvar*_tmp14;_LL1: if((int)_tmp0 != 0)goto _LL3;_LL2: return({
const char*_tmp15="const";_tag_dyneither(_tmp15,sizeof(char),6);});_LL3: if((int)
_tmp0 != 1)goto _LL5;_LL4: return({const char*_tmp16="notconst";_tag_dyneither(
_tmp16,sizeof(char),9);});_LL5: if((int)_tmp0 != 2)goto _LL7;_LL6: return({const char*
_tmp17="thin";_tag_dyneither(_tmp17,sizeof(char),5);});_LL7: if((int)_tmp0 != 3)
goto _LL9;_LL8: return({const char*_tmp18="fat";_tag_dyneither(_tmp18,sizeof(char),
4);});_LL9: if((int)_tmp0 != 4)goto _LLB;_LLA: return({const char*_tmp19="void";
_tag_dyneither(_tmp19,sizeof(char),5);});_LLB: if((int)_tmp0 != 5)goto _LLD;_LLC:
return({const char*_tmp1A="zero";_tag_dyneither(_tmp1A,sizeof(char),5);});_LLD:
if((int)_tmp0 != 6)goto _LLF;_LLE: return({const char*_tmp1B="arith";_tag_dyneither(
_tmp1B,sizeof(char),6);});_LLF: if((int)_tmp0 != 7)goto _LL11;_LL10: return({const
char*_tmp1C="heap";_tag_dyneither(_tmp1C,sizeof(char),5);});_LL11: if((int)_tmp0
!= 8)goto _LL13;_LL12: return({const char*_tmp1D="ZT";_tag_dyneither(_tmp1D,sizeof(
char),3);});_LL13: if((int)_tmp0 != 9)goto _LL15;_LL14: return({const char*_tmp1E="NZT";
_tag_dyneither(_tmp1E,sizeof(char),4);});_LL15: if(_tmp0 <= (void*)10)goto _LL17;
if(*((int*)_tmp0)!= 0)goto _LL17;_tmp1=((struct Cyc_Port_RgnVar_ct_struct*)_tmp0)->f1;
_LL16: return(struct _dyneither_ptr)({struct Cyc_String_pa_struct _tmp21;_tmp21.tag=
0;_tmp21.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp1);{void*_tmp1F[1]={&
_tmp21};Cyc_aprintf(({const char*_tmp20="%s";_tag_dyneither(_tmp20,sizeof(char),3);}),
_tag_dyneither(_tmp1F,sizeof(void*),1));}});_LL17: if(_tmp0 <= (void*)10)goto _LL19;
if(*((int*)_tmp0)!= 1)goto _LL19;_tmp2=(void*)((struct Cyc_Port_Ptr_ct_struct*)
...
struct _dyneither_ptr)({struct Cyc_String_pa_struct _tmp28;_tmp28.tag=0;_tmp28.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(deep,_tmp6));{
struct Cyc_String_pa_struct _tmp27;_tmp27.tag=0;_tmp27.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Port_ctype2string(deep,_tmp5));{struct Cyc_String_pa_struct
_tmp26;_tmp26.tag=0;_tmp26.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(
deep,_tmp4));{struct Cyc_String_pa_struct _tmp25;_tmp25.tag=0;_tmp25.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(deep,_tmp3));{struct
Cyc_String_pa_struct _tmp24;_tmp24.tag=0;_tmp24.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Port_ctype2string(deep,_tmp2));{void*_tmp22[5]={& _tmp24,&
_tmp25,& _tmp26,& _tmp27,& _tmp28};Cyc_aprintf(({const char*_tmp23="ptr(%s,%s,%s,%s,%s)";
_tag_dyneither(_tmp23,sizeof(char),20);}),_tag_dyneither(_tmp22,sizeof(void*),5));}}}}}});
...
return(struct _dyneither_ptr)({struct Cyc_String_pa_struct _tmp2D;_tmp2D.tag=0;
_tmp2D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(
deep,_tmp9));{struct Cyc_String_pa_struct _tmp2C;_tmp2C.tag=0;_tmp2C.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(deep,_tmp8));{struct
Cyc_String_pa_struct _tmp2B;_tmp2B.tag=0;_tmp2B.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Port_ctype2string(deep,_tmp7));{void*_tmp29[3]={& _tmp2B,&
_tmp2C,& _tmp2D};Cyc_aprintf(({const char*_tmp2A="array(%s,%s,%s)";_tag_dyneither(
_tmp2A,sizeof(char),16);}),_tag_dyneither(_tmp29,sizeof(void*),3));}}}});_LL1B:
if(_tmp0 <= (void*)10)goto _LL1D;if(*((int*)_tmp0)!= 3)goto _LL1D;_tmpA=((struct Cyc_Port_KnownAggr_ct_struct*)
_tmp0)->f1;_tmpB=*_tmpA;_tmpC=_tmpB.f1;_tmpD=_tmpB.f2;_LL1C: {struct
_dyneither_ptr s=_tmpC->kind == (void*)0?({const char*_tmp37="struct";
_tag_dyneither(_tmp37,sizeof(char),7);}):({const char*_tmp38="union";
_tag_dyneither(_tmp38,sizeof(char),6);});if(!deep)return(struct _dyneither_ptr)({
struct Cyc_String_pa_struct _tmp31;_tmp31.tag=0;_tmp31.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpC->name));{struct Cyc_String_pa_struct
_tmp30;_tmp30.tag=0;_tmp30.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s);{
void*_tmp2E[2]={& _tmp30,& _tmp31};Cyc_aprintf(({const char*_tmp2F="%s %s";
_tag_dyneither(_tmp2F,sizeof(char),6);}),_tag_dyneither(_tmp2E,sizeof(void*),2));}}});
else{return(struct _dyneither_ptr)({struct Cyc_String_pa_struct _tmp36;_tmp36.tag=0;
_tmp36.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_cfields2string(0,
_tmpD));{struct Cyc_String_pa_struct _tmp35;_tmp35.tag=0;_tmp35.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpC->name));{
struct Cyc_String_pa_struct _tmp34;_tmp34.tag=0;_tmp34.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)s);{void*_tmp32[3]={& _tmp34,& _tmp35,& _tmp36};Cyc_aprintf(({
const char*_tmp33="%s %s {%s}";_tag_dyneither(_tmp33,sizeof(char),11);}),
_tag_dyneither(_tmp32,sizeof(void*),3));}}}});}}_LL1D: if(_tmp0 <= (void*)10)goto
...
_tmp0)->f1;_LL20: return(struct _dyneither_ptr)({struct Cyc_String_pa_struct _tmp3B;
_tmp3B.tag=0;_tmp3B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_cfields2string(
deep,_tmp11));{void*_tmp39[1]={& _tmp3B};Cyc_aprintf(({const char*_tmp3A="aggr {%s}";
_tag_dyneither(_tmp3A,sizeof(char),10);}),_tag_dyneither(_tmp39,sizeof(void*),1));}});
_LL21: if(_tmp0 <= (void*)10)goto _LL23;if(*((int*)_tmp0)!= 5)goto _LL23;_tmp12=(
void*)((struct Cyc_Port_Fn_ct_struct*)_tmp0)->f1;_tmp13=((struct Cyc_Port_Fn_ct_struct*)
_tmp0)->f2;_LL22: return(struct _dyneither_ptr)({struct Cyc_String_pa_struct _tmp3F;
_tmp3F.tag=0;_tmp3F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(
deep,_tmp12));{struct Cyc_String_pa_struct _tmp3E;_tmp3E.tag=0;_tmp3E.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctypes2string(deep,_tmp13));{void*
_tmp3C[2]={& _tmp3E,& _tmp3F};Cyc_aprintf(({const char*_tmp3D="fn(%s)->%s";
_tag_dyneither(_tmp3D,sizeof(char),11);}),_tag_dyneither(_tmp3C,sizeof(void*),2));}}});
_LL23: if(_tmp0 <= (void*)10)goto _LL0;if(*((int*)_tmp0)!= 6)goto _LL0;_tmp14=((
struct Cyc_Port_Var_ct_struct*)_tmp0)->f1;_LL24: if((unsigned int)_tmp14->eq)
return Cyc_Port_ctype2string(deep,*((void**)_check_null(_tmp14->eq)));else{if(!
deep  || _tmp14->uppers == 0  && _tmp14->lowers == 0)return(struct _dyneither_ptr)({
struct Cyc_Int_pa_struct _tmp42;_tmp42.tag=1;_tmp42.f1=(unsigned long)_tmp14->id;{
void*_tmp40[1]={& _tmp42};Cyc_aprintf(({const char*_tmp41="var(%d)";_tag_dyneither(
_tmp41,sizeof(char),8);}),_tag_dyneither(_tmp40,sizeof(void*),1));}});else{
return(struct _dyneither_ptr)({struct Cyc_String_pa_struct _tmp47;_tmp47.tag=0;
_tmp47.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctypes2string(0,
_tmp14->uppers));{struct Cyc_Int_pa_struct _tmp46;_tmp46.tag=1;_tmp46.f1=(
unsigned long)_tmp14->id;{struct Cyc_String_pa_struct _tmp45;_tmp45.tag=0;_tmp45.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctypes2string(0,_tmp14->lowers));{
void*_tmp43[3]={& _tmp45,& _tmp46,& _tmp47};Cyc_aprintf(({const char*_tmp44="var([%s]<=%d<=[%s])";
_tag_dyneither(_tmp44,sizeof(char),20);}),_tag_dyneither(_tmp43,sizeof(void*),3));}}}});}}
_LL0:;}static struct _dyneither_ptr*Cyc_Port_ctype2stringptr(int deep,void*t){
return({struct _dyneither_ptr*_tmp48=_cycalloc(sizeof(*_tmp48));_tmp48[0]=Cyc_Port_ctype2string(
deep,t);_tmp48;});}struct Cyc_List_List*Cyc_Port_sep(struct _dyneither_ptr s,struct
Cyc_List_List*xs){struct _dyneither_ptr*_tmp49=({struct _dyneither_ptr*_tmp4D=
_cycalloc(sizeof(*_tmp4D));_tmp4D[0]=s;_tmp4D;});if(xs == 0)return xs;{struct Cyc_List_List*
_tmp4A=xs;struct Cyc_List_List*_tmp4B=xs->tl;for(0;_tmp4B != 0;(_tmp4A=_tmp4B,
_tmp4B=_tmp4B->tl)){((struct Cyc_List_List*)_check_null(_tmp4A))->tl=({struct Cyc_List_List*
_tmp4C=_cycalloc(sizeof(*_tmp4C));_tmp4C->hd=_tmp49;_tmp4C->tl=_tmp4B;_tmp4C;});}
...
_tmp53;_tmp53.tag=0;_tmp53.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(
deep,f->type));{struct Cyc_String_pa_struct _tmp52;_tmp52.tag=0;_tmp52.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*f->f);{struct Cyc_String_pa_struct _tmp51;
_tmp51.tag=0;_tmp51.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(
deep,f->qual));{void*_tmp4F[3]={& _tmp51,& _tmp52,& _tmp53};Cyc_aprintf(({const char*
_tmp50="%s %s: %s";_tag_dyneither(_tmp50,sizeof(char),10);}),_tag_dyneither(
_tmp4F,sizeof(void*),3));}}}});return({struct _dyneither_ptr*_tmp4E=_cycalloc(
sizeof(*_tmp4E));_tmp4E[0]=s;_tmp4E;});}static struct _dyneither_ptr Cyc_Port_ctypes2string(
int deep,struct Cyc_List_List*ts){return(struct _dyneither_ptr)Cyc_strconcat_l(Cyc_Port_sep(({
const char*_tmp54=",";_tag_dyneither(_tmp54,sizeof(char),2);}),((struct Cyc_List_List*(*)(
...
const char*_tmp55=";";_tag_dyneither(_tmp55,sizeof(char),2);}),((struct Cyc_List_List*(*)(
...
return(void*)1;}static void*Cyc_Port_const_ct(){return(void*)0;}static void*Cyc_Port_thin_ct(){
return(void*)2;}static void*Cyc_Port_fat_ct(){return(void*)3;}static void*Cyc_Port_void_ct(){
return(void*)4;}static void*Cyc_Port_zero_ct(){return(void*)5;}static void*Cyc_Port_arith_ct(){
return(void*)6;}static void*Cyc_Port_heap_ct(){return(void*)7;}static void*Cyc_Port_zterm_ct(){
return(void*)8;}static void*Cyc_Port_nozterm_ct(){return(void*)9;}static void*Cyc_Port_rgnvar_ct(
struct _dyneither_ptr*n){return(void*)({struct Cyc_Port_RgnVar_ct_struct*_tmp56=
_cycalloc(sizeof(*_tmp56));_tmp56[0]=({struct Cyc_Port_RgnVar_ct_struct _tmp57;
_tmp57.tag=0;_tmp57.f1=n;_tmp57;});_tmp56;});}static void*Cyc_Port_unknown_aggr_ct(
struct Cyc_List_List*fs){return(void*)({struct Cyc_Port_UnknownAggr_ct_struct*
_tmp58=_cycalloc(sizeof(*_tmp58));_tmp58[0]=({struct Cyc_Port_UnknownAggr_ct_struct
_tmp59;_tmp59.tag=4;_tmp59.f1=fs;_tmp59.f2=0;_tmp59;});_tmp58;});}static void*Cyc_Port_known_aggr_ct(
struct _tuple10*p){return(void*)({struct Cyc_Port_KnownAggr_ct_struct*_tmp5A=
_cycalloc(sizeof(*_tmp5A));_tmp5A[0]=({struct Cyc_Port_KnownAggr_ct_struct _tmp5B;
_tmp5B.tag=3;_tmp5B.f1=p;_tmp5B;});_tmp5A;});}static void*Cyc_Port_ptr_ct(void*
elt,void*qual,void*ptr_kind,void*r,void*zt){return(void*)({struct Cyc_Port_Ptr_ct_struct*
_tmp5C=_cycalloc(sizeof(*_tmp5C));_tmp5C[0]=({struct Cyc_Port_Ptr_ct_struct _tmp5D;
_tmp5D.tag=1;_tmp5D.f1=(void*)elt;_tmp5D.f2=(void*)qual;_tmp5D.f3=(void*)
ptr_kind;_tmp5D.f4=(void*)r;_tmp5D.f5=(void*)zt;_tmp5D;});_tmp5C;});}static void*
Cyc_Port_array_ct(void*elt,void*qual,void*zt){return(void*)({struct Cyc_Port_Array_ct_struct*
_tmp5E=_cycalloc(sizeof(*_tmp5E));_tmp5E[0]=({struct Cyc_Port_Array_ct_struct
_tmp5F;_tmp5F.tag=2;_tmp5F.f1=(void*)elt;_tmp5F.f2=(void*)qual;_tmp5F.f3=(void*)
zt;_tmp5F;});_tmp5E;});}static void*Cyc_Port_fn_ct(void*return_type,struct Cyc_List_List*
...
_dyneither_ptr s=(struct _dyneither_ptr)({struct Cyc_Int_pa_struct _tmp68;_tmp68.tag=
1;_tmp68.f1=(unsigned long)counter ++;{void*_tmp66[1]={& _tmp68};Cyc_aprintf(({
const char*_tmp67="`R%d";_tag_dyneither(_tmp67,sizeof(char),5);}),_tag_dyneither(
_tmp66,sizeof(void*),1));}});return({struct _dyneither_ptr*_tmp65=_cycalloc(
sizeof(*_tmp65));_tmp65[0]=s;_tmp65;});}static int Cyc_Port_unifies(void*t1,void*
t2);static void*Cyc_Port_compress_ct(void*t){void*_tmp69=t;struct Cyc_Port_Cvar*
_tmp6A;struct Cyc_Port_Cvar _tmp6B;void**_tmp6C;void***_tmp6D;struct Cyc_List_List*
_tmp6E;struct Cyc_List_List*_tmp6F;void**_tmp70;_LL26: if(_tmp69 <= (void*)10)goto
_LL2A;if(*((int*)_tmp69)!= 6)goto _LL28;_tmp6A=((struct Cyc_Port_Var_ct_struct*)
_tmp69)->f1;_tmp6B=*_tmp6A;_tmp6C=_tmp6B.eq;_tmp6D=(void***)&(*((struct Cyc_Port_Var_ct_struct*)
_tmp69)->f1).eq;_tmp6E=_tmp6B.uppers;_tmp6F=_tmp6B.lowers;_LL27: {void**_tmp71=*
_tmp6D;if((unsigned int)_tmp71){void*r=Cyc_Port_compress_ct(*_tmp71);if(*_tmp71
!= r)*_tmp6D=({void**_tmp72=_cycalloc(sizeof(*_tmp72));_tmp72[0]=r;_tmp72;});
return r;}for(0;_tmp6F != 0;_tmp6F=_tmp6F->tl){void*_tmp73=(void*)_tmp6F->hd;_LL2D:
if((int)_tmp73 != 0)goto _LL2F;_LL2E: goto _LL30;_LL2F: if((int)_tmp73 != 9)goto _LL31;
_LL30: goto _LL32;_LL31: if((int)_tmp73 != 4)goto _LL33;_LL32: goto _LL34;_LL33: if(
_tmp73 <= (void*)10)goto _LL37;if(*((int*)_tmp73)!= 3)goto _LL35;_LL34: goto _LL36;
_LL35: if(*((int*)_tmp73)!= 5)goto _LL37;_LL36:*_tmp6D=({void**_tmp74=_cycalloc(
sizeof(*_tmp74));_tmp74[0]=(void*)_tmp6F->hd;_tmp74;});return(void*)_tmp6F->hd;
_LL37:;_LL38: goto _LL2C;_LL2C:;}for(0;_tmp6E != 0;_tmp6E=_tmp6E->tl){void*_tmp75=(
void*)_tmp6E->hd;_LL3A: if((int)_tmp75 != 1)goto _LL3C;_LL3B: goto _LL3D;_LL3C: if((
int)_tmp75 != 8)goto _LL3E;_LL3D: goto _LL3F;_LL3E: if((int)_tmp75 != 5)goto _LL40;
_LL3F: goto _LL41;_LL40: if(_tmp75 <= (void*)10)goto _LL44;if(*((int*)_tmp75)!= 3)
goto _LL42;_LL41: goto _LL43;_LL42: if(*((int*)_tmp75)!= 5)goto _LL44;_LL43:*_tmp6D=({
void**_tmp76=_cycalloc(sizeof(*_tmp76));_tmp76[0]=(void*)_tmp6E->hd;_tmp76;});
return(void*)_tmp6E->hd;_LL44:;_LL45: goto _LL39;_LL39:;}return t;}_LL28: if(*((int*)
...
instenv,void*t){void*_tmp77=Cyc_Port_compress_ct(t);struct _dyneither_ptr*_tmp78;
...
_tmp77)->f1;_LL62: if(!((int(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_member)(*
instenv,_tmp78))*instenv=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct
_dyneither_ptr*k,void*v))Cyc_Dict_insert)(*instenv,_tmp78,Cyc_Port_var());return((
void*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(*instenv,
_tmp78);_LL63: if(_tmp77 <= (void*)10)goto _LL65;if(*((int*)_tmp77)!= 1)goto _LL65;
_tmp79=(void*)((struct Cyc_Port_Ptr_ct_struct*)_tmp77)->f1;_tmp7A=(void*)((struct
Cyc_Port_Ptr_ct_struct*)_tmp77)->f2;_tmp7B=(void*)((struct Cyc_Port_Ptr_ct_struct*)
...
_tmp86;struct _tuple9 _tmp84=({struct _tuple9 _tmp83;_tmp83.f1=Cyc_Port_inst(instenv,
...
t2)return;{struct _tuple9 _tmpAE=({struct _tuple9 _tmpAD;_tmpAD.f1=t1;_tmpAD.f2=t2;
...
_tmpBF;struct _dyneither_ptr*_tmpC0;struct _dyneither_ptr _tmpC1;void*_tmpC2;struct
_dyneither_ptr*_tmpC3;struct _dyneither_ptr _tmpC4;void*_tmpC5;void*_tmpC6;void*
_tmpC7;void*_tmpC8;void*_tmpC9;void*_tmpCA;void*_tmpCB;void*_tmpCC;void*_tmpCD;
void*_tmpCE;struct Cyc_List_List*_tmpCF;void*_tmpD0;void*_tmpD1;struct Cyc_List_List*
_tmpD2;void*_tmpD3;struct _tuple10*_tmpD4;void*_tmpD5;struct _tuple10*_tmpD6;void*
...
_tmpE0;void**_tmpE1;void***_tmpE2;void*_tmpE3;struct _tuple10*_tmpE4;struct
_tuple10 _tmpE5;struct Cyc_Absyn_Aggrdecl*_tmpE6;struct Cyc_List_List*_tmpE7;void*
_tmpE8;struct _tuple10*_tmpE9;struct _tuple10 _tmpEA;struct Cyc_Absyn_Aggrdecl*
_tmpEB;struct Cyc_List_List*_tmpEC;void*_tmpED;struct Cyc_List_List*_tmpEE;void**
_tmpEF;void***_tmpF0;_LL9A: _tmpAF=_tmpAE.f1;if(_tmpAF <= (void*)10)goto _LL9C;if(*((
int*)_tmpAF)!= 6)goto _LL9C;_tmpB0=((struct Cyc_Port_Var_ct_struct*)_tmpAF)->f1;
_LL9B: if(!Cyc_Port_occurs(t1,t2)){{struct Cyc_List_List*_tmpF1=Cyc_Port_filter_self(
...
_tmpB0->eq=({void**_tmpF3=_cycalloc(sizeof(*_tmpF3));_tmpF3[0]=t2;_tmpF3;});
return;}else{(int)_throw((void*)Cyc_Port_Unify_ct);}_LL9C: _tmpB1=_tmpAE.f2;if(
_tmpB1 <= (void*)10)goto _LL9E;if(*((int*)_tmpB1)!= 6)goto _LL9E;_tmpB2=((struct Cyc_Port_Var_ct_struct*)
...
_tmpFC->tl=common;_tmpFC;});Cyc_Port_unify_ct(_tmpFB->qual,_tmpF9->qual);Cyc_Port_unify_ct(
_tmpFB->type,_tmpF9->type);found=1;break;}}}if(!found){if(allow_f1_subset_f2)
common=({struct Cyc_List_List*_tmpFD=_cycalloc(sizeof(*_tmpFD));_tmpFD->hd=_tmpF9;
_tmpFD->tl=common;_tmpFD;});else{(int)_throw((void*)Cyc_Port_Unify_ct);}}}}{
...
_tmpFF->f,_tmp101->f))found=1;}}if(!found)common=({struct Cyc_List_List*_tmp102=
_cycalloc(sizeof(*_tmp102));_tmp102->hd=_tmpFF;_tmp102->tl=common;_tmp102;});}}
...
_tuple11{void*f1;void*f2;void*f3;void*f4;void*f5;};static struct Cyc_List_List*Cyc_Port_insert_upper(
...
void*)_tmp109->hd);if(t == _tmp10A)return*uppers;{struct _tuple9 _tmp10C=({struct
_tuple9 _tmp10B;_tmp10B.f1=t;_tmp10B.f2=_tmp10A;_tmp10B;});void*_tmp10D;void*
...
_tmp122;void*_tmp123;void*_tmp124;void*_tmp125;struct _tuple11 _tmp120=({struct
_tuple11 _tmp11F;_tmp11F.f1=Cyc_Port_var();_tmp11F.f2=Cyc_Port_var();_tmp11F.f3=
Cyc_Port_var();_tmp11F.f4=Cyc_Port_var();_tmp11F.f5=Cyc_Port_var();_tmp11F;});
_tmp121=_tmp120.f1;_tmp122=_tmp120.f2;_tmp123=_tmp120.f3;_tmp124=_tmp120.f4;
_tmp125=_tmp120.f5;{struct Cyc_Port_Ptr_ct_struct*_tmp126=({struct Cyc_Port_Ptr_ct_struct*
...
return({struct Cyc_List_List*_tmp129=_cycalloc(sizeof(*_tmp129));_tmp129->hd=(
void*)t;_tmp129->tl=*uppers;_tmp129;});}static struct Cyc_List_List*Cyc_Port_insert_lower(
...
lowers;{struct _tuple9 _tmp12E=({struct _tuple9 _tmp12D;_tmp12D.f1=t;_tmp12D.f2=
_tmp12C;_tmp12D;});void*_tmp12F;void*_tmp130;void*_tmp131;void*_tmp132;void*
...
_tmp147;void*_tmp148;void*_tmp149;void*_tmp14A;struct _tuple11 _tmp145=({struct
_tuple11 _tmp144;_tmp144.f1=Cyc_Port_var();_tmp144.f2=Cyc_Port_var();_tmp144.f3=
Cyc_Port_var();_tmp144.f4=Cyc_Port_var();_tmp144.f5=Cyc_Port_var();_tmp144;});
_tmp146=_tmp145.f1;_tmp147=_tmp145.f2;_tmp148=_tmp145.f3;_tmp149=_tmp145.f4;
_tmp14A=_tmp145.f5;{struct Cyc_Port_Ptr_ct_struct*_tmp14B=({struct Cyc_Port_Ptr_ct_struct*
_tmp14C=_cycalloc(sizeof(*_tmp14C));_tmp14C[0]=({struct Cyc_Port_Ptr_ct_struct
_tmp14D;_tmp14D.tag=1;_tmp14D.f1=(void*)_tmp146;_tmp14D.f2=(void*)_tmp147;
_tmp14D.f3=(void*)_tmp148;_tmp14D.f4=(void*)_tmp149;_tmp14D.f5=(void*)_tmp14A;
_tmp14D;});_tmp14C;});Cyc_Port_leq(_tmp139,_tmp146);Cyc_Port_leq(_tmp13F,_tmp146);
Cyc_Port_leq(_tmp13A,_tmp147);Cyc_Port_leq(_tmp140,_tmp147);Cyc_Port_leq(_tmp13B,
_tmp148);Cyc_Port_leq(_tmp140,_tmp148);Cyc_Port_leq(_tmp13C,_tmp149);Cyc_Port_leq(
...
_LLF4:;}}}return({struct Cyc_List_List*_tmp14E=_cycalloc(sizeof(*_tmp14E));
_tmp14E->hd=(void*)t;_tmp14E->tl=*lowers;_tmp14E;});}static int Cyc_Port_leq(void*
t1,void*t2){if(t1 == t2)return 1;t1=Cyc_Port_compress_ct(t1);t2=Cyc_Port_compress_ct(
t2);{struct _tuple9 _tmp150=({struct _tuple9 _tmp14F;_tmp14F.f1=t1;_tmp14F.f2=t2;
_tmp14F;});void*_tmp151;void*_tmp152;struct _dyneither_ptr*_tmp153;struct
_dyneither_ptr _tmp154;void*_tmp155;struct _dyneither_ptr*_tmp156;struct
_dyneither_ptr _tmp157;void*_tmp158;struct _dyneither_ptr*_tmp159;struct
...
0;_tmp19D->edits=0;_tmp19D->porting=0;_tmp19D->return_type=Cyc_Port_void_ct();
_tmp19D;});return({struct Cyc_Port_Cenv*_tmp19C=_cycalloc(sizeof(*_tmp19C));
_tmp19C->gcenv=g;_tmp19C->cpos=(void*)3;_tmp19C->var_dict=((struct Cyc_Dict_Dict(*)(
int(*cmp)(struct _tuple0*,struct _tuple0*)))Cyc_Dict_empty)(Cyc_Absyn_qvar_cmp);
_tmp19C;});}static int Cyc_Port_in_fn_arg(struct Cyc_Port_Cenv*env){return env->cpos
== (void*)1;}static int Cyc_Port_in_fn_res(struct Cyc_Port_Cenv*env){return env->cpos
== (void*)0;}static int Cyc_Port_in_toplevel(struct Cyc_Port_Cenv*env){return env->cpos
== (void*)3;}static void*Cyc_Port_lookup_return_type(struct Cyc_Port_Cenv*env){
return(env->gcenv)->return_type;}static void*Cyc_Port_lookup_typedef(struct Cyc_Port_Cenv*
...
n);if((unsigned int)_tmp1AE)return*_tmp1AE;else{struct Cyc_Absyn_Aggrdecl*_tmp1AF=({
struct Cyc_Absyn_Aggrdecl*_tmp1B1=_cycalloc(sizeof(*_tmp1B1));_tmp1B1->kind=(void*)
0;_tmp1B1->sc=(void*)2;_tmp1B1->name=n;_tmp1B1->tvs=0;_tmp1B1->impl=0;_tmp1B1->attributes=
0;_tmp1B1;});struct _tuple10*p=({struct _tuple10*_tmp1B0=_cycalloc(sizeof(*_tmp1B0));
_tmp1B0->f1=_tmp1AF;_tmp1B0->f2=0;_tmp1B0;});(env->gcenv)->struct_dict=((struct
Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple0*k,struct _tuple10*v))Cyc_Dict_insert)((
env->gcenv)->struct_dict,n,p);return p;}}static struct _tuple10*Cyc_Port_lookup_union_decl(
struct Cyc_Port_Cenv*env,struct _tuple0*n){struct _tuple10**_tmp1B2=((struct
...
1;_tmp1B5->sc=(void*)2;_tmp1B5->name=n;_tmp1B5->tvs=0;_tmp1B5->impl=0;_tmp1B5->attributes=
0;_tmp1B5;});struct _tuple10*p=({struct _tuple10*_tmp1B4=_cycalloc(sizeof(*_tmp1B4));
_tmp1B4->f1=_tmp1B3;_tmp1B4->f2=0;_tmp1B4;});(env->gcenv)->union_dict=((struct
Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple0*k,struct _tuple10*v))Cyc_Dict_insert)((
env->gcenv)->union_dict,n,p);return p;}}struct _tuple12{void*f1;struct _tuple9*f2;}
;static struct _tuple9 Cyc_Port_lookup_var(struct Cyc_Port_Cenv*env,struct _tuple0*x){
struct _handler_cons _tmp1B6;_push_handler(& _tmp1B6);{int _tmp1B8=0;if(setjmp(
_tmp1B6.handler))_tmp1B8=1;if(!_tmp1B8){{struct _tuple9*_tmp1BA;struct _tuple12
_tmp1B9=*((struct _tuple12*(*)(struct Cyc_Dict_Dict d,struct _tuple0*k))Cyc_Dict_lookup)(
env->var_dict,x);_tmp1BA=_tmp1B9.f2;{struct _tuple9 _tmp1BB=*_tmp1BA;_npop_handler(
...
struct _tuple9 _tmp1BE;_tmp1BE.f1=Cyc_Port_var();_tmp1BE.f2=Cyc_Port_var();_tmp1BE;});
_LL141:;_LL142:(void)_throw(_tmp1BD);_LL13E:;}}}static struct _tuple12*Cyc_Port_lookup_full_var(
...
_tmp1C1){{void*_tmp1C3;struct _tuple12 _tmp1C2=*((struct _tuple12*(*)(struct Cyc_Dict_Dict
...
0;if(setjmp(_tmp1CA.handler))_tmp1CC=1;if(!_tmp1CC){{void*_tmp1CE;struct _tuple12
_tmp1CD=*((struct _tuple12*(*)(struct Cyc_Dict_Dict d,struct _tuple0*k))Cyc_Dict_lookup)(
...
_tmp1D5->var_dict=env->var_dict;_tmp1D5->cpos=cpos;_tmp1D5;});}static void Cyc_Port_add_return_type(
struct Cyc_Port_Cenv*env,void*t){(env->gcenv)->return_type=t;}static struct Cyc_Port_Cenv*
Cyc_Port_add_var(struct Cyc_Port_Cenv*env,struct _tuple0*x,void*t,void*qual,void*
ctype){return({struct Cyc_Port_Cenv*_tmp1D6=_cycalloc(sizeof(*_tmp1D6));_tmp1D6->gcenv=
env->gcenv;_tmp1D6->var_dict=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,
struct _tuple0*k,struct _tuple12*v))Cyc_Dict_insert)(env->var_dict,x,({struct
_tuple12*_tmp1D7=_cycalloc(sizeof(*_tmp1D7));_tmp1D7->f1=t;_tmp1D7->f2=({struct
_tuple9*_tmp1D8=_cycalloc(sizeof(*_tmp1D8));_tmp1D8->f1=qual;_tmp1D8->f2=ctype;
_tmp1D8;});_tmp1D7;}));_tmp1D6->cpos=env->cpos;_tmp1D6;});}static void Cyc_Port_add_typedef(
...
env->gcenv)->typedef_dict,n,({struct _tuple9*_tmp1D9=_cycalloc(sizeof(*_tmp1D9));
_tmp1D9->f1=t;_tmp1D9->f2=ct;_tmp1D9;}));}struct _tuple13{void*f1;void*f2;struct
Cyc_Position_Segment*f3;};static void Cyc_Port_register_const_cvar(struct Cyc_Port_Cenv*
env,void*new_qual,void*orig_qual,struct Cyc_Position_Segment*loc){(env->gcenv)->qualifier_edits=({
struct Cyc_List_List*_tmp1DA=_cycalloc(sizeof(*_tmp1DA));_tmp1DA->hd=({struct
_tuple13*_tmp1DB=_cycalloc(sizeof(*_tmp1DB));_tmp1DB->f1=new_qual;_tmp1DB->f2=
...
_tuple13*_tmp1DD=_cycalloc(sizeof(*_tmp1DD));_tmp1DD->f1=new_ptr;_tmp1DD->f2=
...
_tuple13*_tmp1DF=_cycalloc(sizeof(*_tmp1DF));_tmp1DF->f1=new_zt;_tmp1DF->f2=
orig_zt;_tmp1DF->f3=loc;_tmp1DF;});_tmp1DE->tl=(env->gcenv)->zeroterm_edits;
_tmp1DE;});}static void*Cyc_Port_main_type(){struct _tuple7*arg1=({struct _tuple7*
_tmp1E5=_cycalloc(sizeof(*_tmp1E5));_tmp1E5->f1=0;_tmp1E5->f2=Cyc_Absyn_empty_tqual(
0);_tmp1E5->f3=Cyc_Absyn_sint_typ;_tmp1E5;});struct _tuple7*arg2=({struct _tuple7*
_tmp1E4=_cycalloc(sizeof(*_tmp1E4));_tmp1E4->f1=0;_tmp1E4->f2=Cyc_Absyn_empty_tqual(
0);_tmp1E4->f3=Cyc_Absyn_dyneither_typ(Cyc_Absyn_string_typ(Cyc_Absyn_wildtyp(0)),
Cyc_Absyn_wildtyp(0),Cyc_Absyn_empty_tqual(0),((union Cyc_Absyn_Constraint*(*)())
Cyc_Absyn_empty_conref)());_tmp1E4;});return(void*)({struct Cyc_Absyn_FnType_struct*
_tmp1E0=_cycalloc(sizeof(*_tmp1E0));_tmp1E0[0]=({struct Cyc_Absyn_FnType_struct
_tmp1E1;_tmp1E1.tag=8;_tmp1E1.f1=({struct Cyc_Absyn_FnInfo _tmp1E2;_tmp1E2.tvars=0;
_tmp1E2.effect=0;_tmp1E2.ret_typ=Cyc_Absyn_sint_typ;_tmp1E2.args=({struct _tuple7*
_tmp1E3[2];_tmp1E3[1]=arg2;_tmp1E3[0]=arg1;((struct Cyc_List_List*(*)(struct
_dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1E3,sizeof(struct _tuple7*),2));});
_tmp1E2.c_varargs=0;_tmp1E2.cyc_varargs=0;_tmp1E2.rgn_po=0;_tmp1E2.attributes=0;
_tmp1E2;});_tmp1E1;});_tmp1E0;});}static void*Cyc_Port_type_to_ctype(struct Cyc_Port_Cenv*
env,void*t);static struct Cyc_Port_Cenv*Cyc_Port_initial_cenv(){struct Cyc_Port_Cenv*
_tmp1E6=Cyc_Port_empty_cenv();_tmp1E6=Cyc_Port_add_var(_tmp1E6,({struct _tuple0*
_tmp1E7=_cycalloc(sizeof(*_tmp1E7));_tmp1E7->f1=Cyc_Absyn_Loc_n;_tmp1E7->f2=
_init_dyneither_ptr(_cycalloc(sizeof(struct _dyneither_ptr)),"main",sizeof(char),
5);_tmp1E7;}),Cyc_Port_main_type(),Cyc_Port_const_ct(),Cyc_Port_type_to_ctype(
_tmp1E6,Cyc_Port_main_type()));return _tmp1E6;}static void Cyc_Port_region_counts(
struct Cyc_Dict_Dict*cts,void*t){void*_tmp1E9=Cyc_Port_compress_ct(t);struct
_dyneither_ptr*_tmp1EA;void*_tmp1EB;void*_tmp1EC;void*_tmp1ED;void*_tmp1EE;void*
_tmp1EF;void*_tmp1F0;void*_tmp1F1;void*_tmp1F2;void*_tmp1F3;struct Cyc_List_List*
...
_LL16A: if(_tmp1E9 <= (void*)10)goto _LL170;if(*((int*)_tmp1E9)!= 4)goto _LL16C;
_LL16B: goto _LL16D;_LL16C: if(*((int*)_tmp1E9)!= 3)goto _LL16E;_LL16D: goto _LL16F;
_LL16E: if(*((int*)_tmp1E9)!= 6)goto _LL170;_LL16F: goto _LL171;_LL170: if((int)
_tmp1E9 != 8)goto _LL172;_LL171: goto _LL173;_LL172: if((int)_tmp1E9 != 9)goto _LL174;
_LL173: goto _LL175;_LL174: if((int)_tmp1E9 != 7)goto _LL176;_LL175: return;_LL176: if(
_tmp1E9 <= (void*)10)goto _LL178;if(*((int*)_tmp1E9)!= 0)goto _LL178;_tmp1EA=((
struct Cyc_Port_RgnVar_ct_struct*)_tmp1E9)->f1;_LL177: if(!((int(*)(struct Cyc_Dict_Dict
d,struct _dyneither_ptr*k))Cyc_Dict_member)(*cts,_tmp1EA))*cts=((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,int*v))Cyc_Dict_insert)(*cts,_tmp1EA,(
int*)({int*_tmp1F5=_cycalloc_atomic(sizeof(*_tmp1F5));_tmp1F5[0]=0;_tmp1F5;}));{
int*_tmp1F6=((int*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(*
...
_tuple9 _tmp1F8=({struct _tuple9 _tmp1F7;_tmp1F7.f1=t;_tmp1F7.f2=c;_tmp1F7;});void*
_tmp1F9;struct Cyc_Absyn_PtrInfo _tmp1FA;void*_tmp1FB;struct Cyc_Absyn_PtrAtts
...
struct _tuple9 _tmp210=({struct _tuple9 _tmp20F;_tmp20F.f1=_tmp1FD;_tmp20F.f2=
...
_tmp216=_cycalloc(sizeof(*_tmp216));_tmp216->hd=({struct Cyc_Port_Edit*_tmp217=
_cycalloc(sizeof(*_tmp217));_tmp217->loc=_tmp20E;_tmp217->old_string=({const char*
_tmp219="`H ";_tag_dyneither(_tmp219,sizeof(char),4);});_tmp217->new_string=({
const char*_tmp218="";_tag_dyneither(_tmp218,sizeof(char),1);});_tmp217;});
_tmp216->tl=(env->gcenv)->edits;_tmp216;});goto _LL187;_LL18A: _tmp213=_tmp210.f1;
if(_tmp213 <= (void*)4)goto _LL18C;if(*((int*)_tmp213)!= 0)goto _LL18C;_tmp214=
_tmp210.f2;if(_tmp214 <= (void*)10)goto _LL18C;if(*((int*)_tmp214)!= 0)goto _LL18C;
_tmp215=((struct Cyc_Port_RgnVar_ct_struct*)_tmp214)->f1;_LL18B: {int _tmp21A=*((
int*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(counts,
_tmp215);if(_tmp21A > 1)(env->gcenv)->edits=({struct Cyc_List_List*_tmp21B=
_cycalloc(sizeof(*_tmp21B));_tmp21B->hd=({struct Cyc_Port_Edit*_tmp21C=_cycalloc(
sizeof(*_tmp21C));_tmp21C->loc=_tmp20E;_tmp21C->old_string=(struct _dyneither_ptr)({
struct Cyc_String_pa_struct _tmp220;_tmp220.tag=0;_tmp220.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)*_tmp215);{void*_tmp21E[1]={& _tmp220};Cyc_aprintf(({const
char*_tmp21F="%s ";_tag_dyneither(_tmp21F,sizeof(char),4);}),_tag_dyneither(
_tmp21E,sizeof(void*),1));}});_tmp21C->new_string=({const char*_tmp21D="";
_tag_dyneither(_tmp21D,sizeof(char),1);});_tmp21C;});_tmp21B->tl=(env->gcenv)->edits;
...
_tmp224=t;struct _tuple0*_tmp225;void*_tmp226;_LL18F: if(_tmp224 <= (void*)4)goto
_LL193;if(*((int*)_tmp224)!= 16)goto _LL191;_tmp225=((struct Cyc_Absyn_TypedefType_struct*)
_tmp224)->f1;_LL190:(*_tmp225).f1=Cyc_Absyn_Loc_n;return Cyc_Port_is_char(env,Cyc_Port_lookup_typedef(
...
_tmp227=t;struct _tuple0*_tmp228;struct Cyc_Absyn_PtrInfo _tmp229;void*_tmp22A;
struct Cyc_Absyn_Tqual _tmp22B;struct Cyc_Absyn_PtrAtts _tmp22C;void*_tmp22D;union
Cyc_Absyn_Constraint*_tmp22E;union Cyc_Absyn_Constraint*_tmp22F;union Cyc_Absyn_Constraint*
_tmp230;struct Cyc_Absyn_PtrLoc*_tmp231;struct Cyc_Absyn_ArrayInfo _tmp232;void*
_tmp233;struct Cyc_Absyn_Tqual _tmp234;union Cyc_Absyn_Constraint*_tmp235;struct Cyc_Position_Segment*
...
_tmp256.f3;cargs=({struct Cyc_List_List*_tmp259=_cycalloc(sizeof(*_tmp259));
_tmp259->hd=(void*)Cyc_Port_type_to_ctype(_tmp255,_tmp258);_tmp259->tl=cargs;
_tmp259;});}return Cyc_Port_fn_ct(_tmp254,Cyc_List_imp_rev(cargs));}_LL1A6: if(*((
int*)_tmp227)!= 10)goto _LL1A8;_tmp23A=((struct Cyc_Absyn_AggrType_struct*)_tmp227)->f1;
_tmp23B=_tmp23A.aggr_info;_LL1A7: {union Cyc_Absyn_AggrInfoU _tmp25A=_tmp23B;
struct _tuple2 _tmp25B;void*_tmp25C;struct _tuple0*_tmp25D;struct _tuple2 _tmp25E;
void*_tmp25F;struct _tuple0*_tmp260;struct Cyc_Absyn_Aggrdecl**_tmp261;_LL1CC: if((
_tmp25A.UnknownAggr).tag != 1)goto _LL1CE;_tmp25B=(struct _tuple2)(_tmp25A.UnknownAggr).val;
_tmp25C=_tmp25B.f1;if((int)_tmp25C != 0)goto _LL1CE;_tmp25D=_tmp25B.f2;_LL1CD:(*
_tmp25D).f1=Cyc_Absyn_Loc_n;{struct _tuple10*_tmp262=Cyc_Port_lookup_struct_decl(
env,_tmp25D);return Cyc_Port_known_aggr_ct(_tmp262);}_LL1CE: if((_tmp25A.UnknownAggr).tag
!= 1)goto _LL1D0;_tmp25E=(struct _tuple2)(_tmp25A.UnknownAggr).val;_tmp25F=_tmp25E.f1;
if((int)_tmp25F != 1)goto _LL1D0;_tmp260=_tmp25E.f2;_LL1CF:(*_tmp260).f1=Cyc_Absyn_Loc_n;{
struct _tuple10*_tmp263=Cyc_Port_lookup_union_decl(env,_tmp260);return Cyc_Port_known_aggr_ct(
_tmp263);}_LL1D0: if((_tmp25A.KnownAggr).tag != 2)goto _LL1CB;_tmp261=(struct Cyc_Absyn_Aggrdecl**)(
...
return Cyc_Port_arith_ct();_LL1FE:;_LL1FF:({void*_tmp26D=0;((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp26E=".size primop";
_tag_dyneither(_tmp26E,sizeof(char),13);}),_tag_dyneither(_tmp26D,sizeof(void*),
0));});_LL1D7:;}static struct _tuple9 Cyc_Port_gen_lhs(struct Cyc_Port_Cenv*env,
struct Cyc_Absyn_Exp*e){void*_tmp26F=e->r;struct _tuple0*_tmp270;struct _tuple0*
_tmp271;struct Cyc_Absyn_Exp*_tmp272;struct Cyc_Absyn_Exp*_tmp273;struct Cyc_Absyn_Exp*
_tmp274;struct Cyc_Absyn_Exp*_tmp275;struct _dyneither_ptr*_tmp276;struct Cyc_Absyn_Exp*
_tmp277;struct _dyneither_ptr*_tmp278;_LL201: if(*((int*)_tmp26F)!= 1)goto _LL203;
...
_tmp26F)->f1;_LL204:(*_tmp271).f1=Cyc_Absyn_Loc_n;return Cyc_Port_lookup_var(env,
_tmp271);_LL205: if(*((int*)_tmp26F)!= 25)goto _LL207;_tmp272=((struct Cyc_Absyn_Subscript_e_struct*)
...
Cyc_Port_var());Cyc_Port_leq(_tmp27B,_tmp27C);return({struct _tuple9 _tmp27D;
_tmp27D.f1=_tmp27A;_tmp27D.f2=_tmp279;_tmp27D;});}}_LL207: if(*((int*)_tmp26F)!= 
...
env,_tmp274),_tmp280);return({struct _tuple9 _tmp281;_tmp281.f1=_tmp27F;_tmp281.f2=
_tmp27E;_tmp281;});}_LL209: if(*((int*)_tmp26F)!= 23)goto _LL20B;_tmp275=((struct
...
void*_tmp284=Cyc_Port_gen_exp(env,_tmp275);Cyc_Port_leq(Cyc_Port_gen_exp(env,
_tmp275),Cyc_Port_unknown_aggr_ct(({struct Cyc_Port_Cfield*_tmp285[1];_tmp285[0]=({
struct Cyc_Port_Cfield*_tmp286=_cycalloc(sizeof(*_tmp286));_tmp286->qual=_tmp283;
_tmp286->f=_tmp276;_tmp286->type=_tmp282;_tmp286;});((struct Cyc_List_List*(*)(
struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp285,sizeof(struct Cyc_Port_Cfield*),
1));})));return({struct _tuple9 _tmp287;_tmp287.f1=_tmp283;_tmp287.f2=_tmp282;
_tmp287;});}_LL20B: if(*((int*)_tmp26F)!= 24)goto _LL20D;_tmp277=((struct Cyc_Absyn_AggrArrow_e_struct*)
...
struct Cyc_Port_Cfield*_tmp28B[1];_tmp28B[0]=({struct Cyc_Port_Cfield*_tmp28C=
_cycalloc(sizeof(*_tmp28C));_tmp28C->qual=_tmp289;_tmp28C->f=_tmp278;_tmp28C->type=
_tmp288;_tmp28C;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(
_tag_dyneither(_tmp28B,sizeof(struct Cyc_Port_Cfield*),1));})),Cyc_Port_var(),Cyc_Port_var(),
Cyc_Port_var(),Cyc_Port_var()));return({struct _tuple9 _tmp28D;_tmp28D.f1=_tmp289;
_tmp28D.f2=_tmp288;_tmp28D;});}_LL20D:;_LL20E:({void*_tmp28E=0;((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)((struct
_dyneither_ptr)({struct Cyc_String_pa_struct _tmp291;_tmp291.tag=0;_tmp291.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));{void*
_tmp28F[1]={& _tmp291};Cyc_aprintf(({const char*_tmp290="gen_lhs: %s";
_tag_dyneither(_tmp290,sizeof(char),12);}),_tag_dyneither(_tmp28F,sizeof(void*),
1));}}),_tag_dyneither(_tmp28E,sizeof(void*),0));});_LL200:;}static void*Cyc_Port_gen_exp(
struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Exp*e){void*_tmp292=e->r;union Cyc_Absyn_Cnst
_tmp293;struct _tuple3 _tmp294;union Cyc_Absyn_Cnst _tmp295;struct _tuple4 _tmp296;
union Cyc_Absyn_Cnst _tmp297;struct _tuple6 _tmp298;union Cyc_Absyn_Cnst _tmp299;
struct _dyneither_ptr _tmp29A;union Cyc_Absyn_Cnst _tmp29B;struct _tuple5 _tmp29C;int
_tmp29D;union Cyc_Absyn_Cnst _tmp29E;struct _tuple5 _tmp29F;union Cyc_Absyn_Cnst
_tmp2A0;struct _dyneither_ptr _tmp2A1;union Cyc_Absyn_Cnst _tmp2A2;int _tmp2A3;struct
_tuple0*_tmp2A4;struct _tuple0*_tmp2A5;void*_tmp2A6;struct Cyc_List_List*_tmp2A7;
struct Cyc_Absyn_Exp*_tmp2A8;struct Cyc_Core_Opt*_tmp2A9;struct Cyc_Absyn_Exp*
_tmp2AA;struct Cyc_Absyn_Exp*_tmp2AB;void*_tmp2AC;struct Cyc_Absyn_Exp*_tmp2AD;
struct Cyc_Absyn_Exp*_tmp2AE;struct Cyc_Absyn_Exp*_tmp2AF;struct Cyc_Absyn_Exp*
_tmp2B0;struct Cyc_Absyn_Exp*_tmp2B1;struct Cyc_Absyn_Exp*_tmp2B2;struct Cyc_Absyn_Exp*
_tmp2B3;struct Cyc_Absyn_Exp*_tmp2B4;struct Cyc_Absyn_Exp*_tmp2B5;struct Cyc_Absyn_Exp*
_tmp2B6;struct Cyc_List_List*_tmp2B7;struct Cyc_Absyn_Exp*_tmp2B8;struct Cyc_List_List*
_tmp2B9;struct Cyc_Absyn_Exp*_tmp2BA;void*_tmp2BB;struct Cyc_Absyn_Exp*_tmp2BC;
struct Cyc_Absyn_Exp*_tmp2BD;struct Cyc_Absyn_Exp*_tmp2BE;struct Cyc_Absyn_Exp*
_tmp2BF;struct Cyc_Absyn_Exp*_tmp2C0;struct Cyc_Absyn_Exp*_tmp2C1;struct
_dyneither_ptr*_tmp2C2;struct Cyc_Absyn_Exp*_tmp2C3;struct _dyneither_ptr*_tmp2C4;
struct Cyc_Absyn_MallocInfo _tmp2C5;void**_tmp2C6;struct Cyc_Absyn_Exp*_tmp2C7;
struct Cyc_Absyn_Exp*_tmp2C8;struct Cyc_Absyn_Exp*_tmp2C9;struct Cyc_Absyn_Stmt*
_tmp2CA;_LL210: if(*((int*)_tmp292)!= 0)goto _LL212;_tmp293=((struct Cyc_Absyn_Const_e_struct*)
_tmp292)->f1;if((_tmp293.Char_c).tag != 2)goto _LL212;_tmp294=(struct _tuple3)(
_tmp293.Char_c).val;_LL211: goto _LL213;_LL212: if(*((int*)_tmp292)!= 0)goto _LL214;
_tmp295=((struct Cyc_Absyn_Const_e_struct*)_tmp292)->f1;if((_tmp295.Short_c).tag
!= 3)goto _LL214;_tmp296=(struct _tuple4)(_tmp295.Short_c).val;_LL213: goto _LL215;
_LL214: if(*((int*)_tmp292)!= 0)goto _LL216;_tmp297=((struct Cyc_Absyn_Const_e_struct*)
_tmp292)->f1;if((_tmp297.LongLong_c).tag != 5)goto _LL216;_tmp298=(struct _tuple6)(
_tmp297.LongLong_c).val;_LL215: goto _LL217;_LL216: if(*((int*)_tmp292)!= 18)goto
_LL218;_LL217: goto _LL219;_LL218: if(*((int*)_tmp292)!= 19)goto _LL21A;_LL219: goto
_LL21B;_LL21A: if(*((int*)_tmp292)!= 20)goto _LL21C;_LL21B: goto _LL21D;_LL21C: if(*((
int*)_tmp292)!= 33)goto _LL21E;_LL21D: goto _LL21F;_LL21E: if(*((int*)_tmp292)!= 34)
goto _LL220;_LL21F: goto _LL221;_LL220: if(*((int*)_tmp292)!= 0)goto _LL222;_tmp299=((
struct Cyc_Absyn_Const_e_struct*)_tmp292)->f1;if((_tmp299.Float_c).tag != 6)goto
_LL222;_tmp29A=(struct _dyneither_ptr)(_tmp299.Float_c).val;_LL221: return Cyc_Port_arith_ct();
_LL222: if(*((int*)_tmp292)!= 0)goto _LL224;_tmp29B=((struct Cyc_Absyn_Const_e_struct*)
_tmp292)->f1;if((_tmp29B.Int_c).tag != 4)goto _LL224;_tmp29C=(struct _tuple5)(
_tmp29B.Int_c).val;_tmp29D=_tmp29C.f2;if(_tmp29D != 0)goto _LL224;_LL223: return Cyc_Port_zero_ct();
...
x2=({struct Cyc_List_List _tmp2D8;_tmp2D8.hd=(void*)_tmp2D5;_tmp2D8.tl=0;_tmp2D8;});
struct Cyc_List_List x1=({struct Cyc_List_List _tmp2D7;_tmp2D7.hd=(void*)_tmp2D4;
_tmp2D7.tl=(struct Cyc_List_List*)& x2;_tmp2D7;});void*_tmp2D6=Cyc_Port_gen_primop(
...
_LL242;_LL241:({void*_tmp2E1=0;((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp2E2="throw";_tag_dyneither(
_tmp2E2,sizeof(char),6);}),_tag_dyneither(_tmp2E1,sizeof(void*),0));});_LL242:
if(*((int*)_tmp292)!= 13)goto _LL244;_tmp2BA=((struct Cyc_Absyn_NoInstantiate_e_struct*)
_tmp292)->f1;_LL243: return Cyc_Port_gen_exp(env,_tmp2BA);_LL244: if(*((int*)
_tmp292)!= 14)goto _LL246;_LL245:({void*_tmp2E3=0;((int(*)(struct _dyneither_ptr
fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp2E4="instantiate";
_tag_dyneither(_tmp2E4,sizeof(char),12);}),_tag_dyneither(_tmp2E3,sizeof(void*),
0));});_LL246: if(*((int*)_tmp292)!= 15)goto _LL248;_tmp2BB=(void*)((struct Cyc_Absyn_Cast_e_struct*)
_tmp292)->f1;_tmp2BC=((struct Cyc_Absyn_Cast_e_struct*)_tmp292)->f2;_LL247: {void*
_tmp2E5=Cyc_Port_type_to_ctype(env,_tmp2BB);void*_tmp2E6=Cyc_Port_gen_exp(env,
_tmp2BC);Cyc_Port_leq(_tmp2E5,_tmp2E6);return _tmp2E6;}_LL248: if(*((int*)_tmp292)
!= 16)goto _LL24A;_tmp2BD=((struct Cyc_Absyn_Address_e_struct*)_tmp292)->f1;_LL249: {
void*_tmp2E8;void*_tmp2E9;struct _tuple9 _tmp2E7=Cyc_Port_gen_lhs(env,_tmp2BD);
_tmp2E8=_tmp2E7.f1;_tmp2E9=_tmp2E7.f2;return Cyc_Port_ptr_ct(_tmp2E9,_tmp2E8,Cyc_Port_var(),
Cyc_Port_var(),Cyc_Port_var());}_LL24A: if(*((int*)_tmp292)!= 25)goto _LL24C;
_tmp2BE=((struct Cyc_Absyn_Subscript_e_struct*)_tmp292)->f1;_tmp2BF=((struct Cyc_Absyn_Subscript_e_struct*)
_tmp292)->f2;_LL24B: {void*_tmp2EA=Cyc_Port_var();Cyc_Port_leq(Cyc_Port_gen_exp(
env,_tmp2BF),Cyc_Port_arith_ct());{void*_tmp2EB=Cyc_Port_gen_exp(env,_tmp2BE);
Cyc_Port_leq(_tmp2EB,Cyc_Port_ptr_ct(_tmp2EA,Cyc_Port_var(),Cyc_Port_fat_ct(),
Cyc_Port_var(),Cyc_Port_var()));return _tmp2EA;}}_LL24C: if(*((int*)_tmp292)!= 22)
goto _LL24E;_tmp2C0=((struct Cyc_Absyn_Deref_e_struct*)_tmp292)->f1;_LL24D: {void*
_tmp2EC=Cyc_Port_var();Cyc_Port_leq(Cyc_Port_gen_exp(env,_tmp2C0),Cyc_Port_ptr_ct(
_tmp2EC,Cyc_Port_var(),Cyc_Port_var(),Cyc_Port_var(),Cyc_Port_var()));return
_tmp2EC;}_LL24E: if(*((int*)_tmp292)!= 23)goto _LL250;_tmp2C1=((struct Cyc_Absyn_AggrMember_e_struct*)
_tmp292)->f1;_tmp2C2=((struct Cyc_Absyn_AggrMember_e_struct*)_tmp292)->f2;_LL24F: {
void*_tmp2ED=Cyc_Port_var();void*_tmp2EE=Cyc_Port_gen_exp(env,_tmp2C1);Cyc_Port_leq(
Cyc_Port_gen_exp(env,_tmp2C1),Cyc_Port_unknown_aggr_ct(({struct Cyc_Port_Cfield*
_tmp2EF[1];_tmp2EF[0]=({struct Cyc_Port_Cfield*_tmp2F0=_cycalloc(sizeof(*_tmp2F0));
_tmp2F0->qual=Cyc_Port_var();_tmp2F0->f=_tmp2C2;_tmp2F0->type=_tmp2ED;_tmp2F0;});((
struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(
_tmp2EF,sizeof(struct Cyc_Port_Cfield*),1));})));return _tmp2ED;}_LL250: if(*((int*)
_tmp292)!= 24)goto _LL252;_tmp2C3=((struct Cyc_Absyn_AggrArrow_e_struct*)_tmp292)->f1;
_tmp2C4=((struct Cyc_Absyn_AggrArrow_e_struct*)_tmp292)->f2;_LL251: {void*_tmp2F1=
Cyc_Port_var();void*_tmp2F2=Cyc_Port_gen_exp(env,_tmp2C3);Cyc_Port_leq(Cyc_Port_gen_exp(
env,_tmp2C3),Cyc_Port_ptr_ct(Cyc_Port_unknown_aggr_ct(({struct Cyc_Port_Cfield*
_tmp2F3[1];_tmp2F3[0]=({struct Cyc_Port_Cfield*_tmp2F4=_cycalloc(sizeof(*_tmp2F4));
_tmp2F4->qual=Cyc_Port_var();_tmp2F4->f=_tmp2C4;_tmp2F4->type=_tmp2F1;_tmp2F4;});((
struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(
_tmp2F3,sizeof(struct Cyc_Port_Cfield*),1));})),Cyc_Port_var(),Cyc_Port_var(),Cyc_Port_var(),
Cyc_Port_var()));return _tmp2F1;}_LL252: if(*((int*)_tmp292)!= 35)goto _LL254;
_tmp2C5=((struct Cyc_Absyn_Malloc_e_struct*)_tmp292)->f1;_tmp2C6=_tmp2C5.elt_type;
_tmp2C7=_tmp2C5.num_elts;_LL253: Cyc_Port_leq(Cyc_Port_gen_exp(env,_tmp2C7),Cyc_Port_arith_ct());{
void*_tmp2F5=(unsigned int)_tmp2C6?Cyc_Port_type_to_ctype(env,*_tmp2C6): Cyc_Port_var();
return Cyc_Port_ptr_ct(_tmp2F5,Cyc_Port_var(),Cyc_Port_fat_ct(),Cyc_Port_heap_ct(),
Cyc_Port_var());}_LL254: if(*((int*)_tmp292)!= 36)goto _LL256;_tmp2C8=((struct Cyc_Absyn_Swap_e_struct*)
_tmp292)->f1;_tmp2C9=((struct Cyc_Absyn_Swap_e_struct*)_tmp292)->f2;_LL255:({void*
_tmp2F6=0;((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({
const char*_tmp2F7="Swap_e";_tag_dyneither(_tmp2F7,sizeof(char),7);}),
_tag_dyneither(_tmp2F6,sizeof(void*),0));});_LL256: if(*((int*)_tmp292)!= 21)goto
_LL258;_LL257:({void*_tmp2F8=0;((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp2F9="Gen";_tag_dyneither(
_tmp2F9,sizeof(char),4);}),_tag_dyneither(_tmp2F8,sizeof(void*),0));});_LL258:
if(*((int*)_tmp292)!= 17)goto _LL25A;_LL259:({void*_tmp2FA=0;((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp2FB="New_e";
_tag_dyneither(_tmp2FB,sizeof(char),6);}),_tag_dyneither(_tmp2FA,sizeof(void*),0));});
_LL25A: if(*((int*)_tmp292)!= 26)goto _LL25C;_LL25B:({void*_tmp2FC=0;((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*
_tmp2FD="Tuple_e";_tag_dyneither(_tmp2FD,sizeof(char),8);}),_tag_dyneither(
_tmp2FC,sizeof(void*),0));});_LL25C: if(*((int*)_tmp292)!= 27)goto _LL25E;_LL25D:({
void*_tmp2FE=0;((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({
const char*_tmp2FF="CompoundLit_e";_tag_dyneither(_tmp2FF,sizeof(char),14);}),
_tag_dyneither(_tmp2FE,sizeof(void*),0));});_LL25E: if(*((int*)_tmp292)!= 28)goto
_LL260;_LL25F:({void*_tmp300=0;((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp301="Array_e";_tag_dyneither(
_tmp301,sizeof(char),8);}),_tag_dyneither(_tmp300,sizeof(void*),0));});_LL260:
if(*((int*)_tmp292)!= 29)goto _LL262;_LL261:({void*_tmp302=0;((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp303="Comprehension_e";
_tag_dyneither(_tmp303,sizeof(char),16);}),_tag_dyneither(_tmp302,sizeof(void*),
0));});_LL262: if(*((int*)_tmp292)!= 30)goto _LL264;_LL263:({void*_tmp304=0;((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*
_tmp305="Aggregate_e";_tag_dyneither(_tmp305,sizeof(char),12);}),_tag_dyneither(
_tmp304,sizeof(void*),0));});_LL264: if(*((int*)_tmp292)!= 31)goto _LL266;_LL265:({
void*_tmp306=0;((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({
const char*_tmp307="AnonStruct_e";_tag_dyneither(_tmp307,sizeof(char),13);}),
_tag_dyneither(_tmp306,sizeof(void*),0));});_LL266: if(*((int*)_tmp292)!= 32)goto
_LL268;_LL267:({void*_tmp308=0;((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp309="Datatype_e";
_tag_dyneither(_tmp309,sizeof(char),11);}),_tag_dyneither(_tmp308,sizeof(void*),
0));});_LL268: if(*((int*)_tmp292)!= 37)goto _LL26A;_LL269:({void*_tmp30A=0;((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*
_tmp30B="UnresolvedMem_e";_tag_dyneither(_tmp30B,sizeof(char),16);}),
_tag_dyneither(_tmp30A,sizeof(void*),0));});_LL26A: if(*((int*)_tmp292)!= 38)goto
_LL26C;_tmp2CA=((struct Cyc_Absyn_StmtExp_e_struct*)_tmp292)->f1;_LL26B:({void*
_tmp30C=0;((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({
const char*_tmp30D="StmtExp_e";_tag_dyneither(_tmp30D,sizeof(char),10);}),
_tag_dyneither(_tmp30C,sizeof(void*),0));});_LL26C: if(*((int*)_tmp292)!= 40)goto
_LL26E;_LL26D:({void*_tmp30E=0;((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp30F="Valueof_e";
_tag_dyneither(_tmp30F,sizeof(char),10);}),_tag_dyneither(_tmp30E,sizeof(void*),
0));});_LL26E: if(*((int*)_tmp292)!= 39)goto _LL20F;_LL26F:({void*_tmp310=0;((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*
_tmp311="Tagcheck_e";_tag_dyneither(_tmp311,sizeof(char),11);}),_tag_dyneither(
_tmp310,sizeof(void*),0));});_LL20F:;}static void Cyc_Port_gen_stmt(struct Cyc_Port_Cenv*
env,struct Cyc_Absyn_Stmt*s){void*_tmp312=s->r;struct Cyc_Absyn_Exp*_tmp313;struct
Cyc_Absyn_Stmt*_tmp314;struct Cyc_Absyn_Stmt*_tmp315;struct Cyc_Absyn_Exp*_tmp316;
struct Cyc_Absyn_Exp*_tmp317;struct Cyc_Absyn_Stmt*_tmp318;struct Cyc_Absyn_Stmt*
_tmp319;struct _tuple8 _tmp31A;struct Cyc_Absyn_Exp*_tmp31B;struct Cyc_Absyn_Stmt*
_tmp31C;struct Cyc_Absyn_Exp*_tmp31D;struct _tuple8 _tmp31E;struct Cyc_Absyn_Exp*
_tmp31F;struct _tuple8 _tmp320;struct Cyc_Absyn_Exp*_tmp321;struct Cyc_Absyn_Stmt*
_tmp322;struct Cyc_Absyn_Exp*_tmp323;struct Cyc_List_List*_tmp324;struct Cyc_Absyn_Decl*
_tmp325;struct Cyc_Absyn_Stmt*_tmp326;struct Cyc_Absyn_Stmt*_tmp327;struct Cyc_Absyn_Stmt*
_tmp328;struct _tuple8 _tmp329;struct Cyc_Absyn_Exp*_tmp32A;_LL271: if((int)_tmp312
!= 0)goto _LL273;_LL272: return;_LL273: if(_tmp312 <= (void*)1)goto _LL275;if(*((int*)
_tmp312)!= 0)goto _LL275;_tmp313=((struct Cyc_Absyn_Exp_s_struct*)_tmp312)->f1;
_LL274: Cyc_Port_gen_exp(env,_tmp313);return;_LL275: if(_tmp312 <= (void*)1)goto
_LL277;if(*((int*)_tmp312)!= 1)goto _LL277;_tmp314=((struct Cyc_Absyn_Seq_s_struct*)
...
_tmp312)!= 10)goto _LL289;_LL288:({void*_tmp32D=0;((int(*)(struct _dyneither_ptr
fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp32E="fallthru";
_tag_dyneither(_tmp32E,sizeof(char),9);}),_tag_dyneither(_tmp32D,sizeof(void*),0));});
_LL289: if(_tmp312 <= (void*)1)goto _LL28B;if(*((int*)_tmp312)!= 11)goto _LL28B;
_tmp325=((struct Cyc_Absyn_Decl_s_struct*)_tmp312)->f1;_tmp326=((struct Cyc_Absyn_Decl_s_struct*)
_tmp312)->f2;_LL28A: env=Cyc_Port_gen_localdecl(env,_tmp325);Cyc_Port_gen_stmt(
env,_tmp326);return;_LL28B: if(_tmp312 <= (void*)1)goto _LL28D;if(*((int*)_tmp312)
!= 12)goto _LL28D;_tmp327=((struct Cyc_Absyn_Label_s_struct*)_tmp312)->f2;_LL28C:
Cyc_Port_gen_stmt(env,_tmp327);return;_LL28D: if(_tmp312 <= (void*)1)goto _LL28F;
if(*((int*)_tmp312)!= 13)goto _LL28F;_tmp328=((struct Cyc_Absyn_Do_s_struct*)
...
_tmp312)!= 14)goto _LL291;_LL290:({void*_tmp32F=0;((int(*)(struct _dyneither_ptr
fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp330="try/catch";
_tag_dyneither(_tmp330,sizeof(char),10);}),_tag_dyneither(_tmp32F,sizeof(void*),
0));});_LL291: if(_tmp312 <= (void*)1)goto _LL270;if(*((int*)_tmp312)!= 15)goto
_LL270;_LL292:({void*_tmp331=0;((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp332="reset region";
_tag_dyneither(_tmp332,sizeof(char),13);}),_tag_dyneither(_tmp331,sizeof(void*),
0));});_LL270:;}struct _tuple14{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
static void*Cyc_Port_gen_initializer(struct Cyc_Port_Cenv*env,void*t,struct Cyc_Absyn_Exp*
e){void*_tmp333=e->r;struct Cyc_List_List*_tmp334;struct Cyc_List_List*_tmp335;
struct Cyc_List_List*_tmp336;union Cyc_Absyn_Cnst _tmp337;struct _dyneither_ptr
_tmp338;_LL294: if(*((int*)_tmp333)!= 37)goto _LL296;_tmp334=((struct Cyc_Absyn_UnresolvedMem_e_struct*)
_tmp333)->f2;_LL295: _tmp335=_tmp334;goto _LL297;_LL296: if(*((int*)_tmp333)!= 28)
goto _LL298;_tmp335=((struct Cyc_Absyn_Array_e_struct*)_tmp333)->f1;_LL297: _tmp336=
_tmp335;goto _LL299;_LL298: if(*((int*)_tmp333)!= 27)goto _LL29A;_tmp336=((struct
Cyc_Absyn_CompoundLit_e_struct*)_tmp333)->f2;_LL299: LOOP: {void*_tmp339=t;struct
_tuple0*_tmp33A;struct Cyc_Absyn_ArrayInfo _tmp33B;void*_tmp33C;union Cyc_Absyn_Constraint*
_tmp33D;struct Cyc_Position_Segment*_tmp33E;struct Cyc_Absyn_AggrInfo _tmp33F;union
Cyc_Absyn_AggrInfoU _tmp340;struct _tuple2 _tmp341;void*_tmp342;struct _tuple0*
_tmp343;struct Cyc_Absyn_AggrInfo _tmp344;union Cyc_Absyn_AggrInfoU _tmp345;struct
Cyc_Absyn_Aggrdecl**_tmp346;struct Cyc_Absyn_Aggrdecl*_tmp347;_LL29F: if(_tmp339 <= (
void*)4)goto _LL2A7;if(*((int*)_tmp339)!= 16)goto _LL2A1;_tmp33A=((struct Cyc_Absyn_TypedefType_struct*)
_tmp339)->f1;_LL2A0:(*_tmp33A).f1=Cyc_Absyn_Loc_n;t=Cyc_Port_lookup_typedef(env,
_tmp33A);goto LOOP;_LL2A1: if(*((int*)_tmp339)!= 7)goto _LL2A3;_tmp33B=((struct Cyc_Absyn_ArrayType_struct*)
...
_tmp34C.f2;if((unsigned int)_tmp34D)({void*_tmp34F=0;((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp350="designators in initializers";
_tag_dyneither(_tmp350,sizeof(char),28);}),_tag_dyneither(_tmp34F,sizeof(void*),
0));});{void*_tmp351=Cyc_Port_gen_initializer(env,_tmp33C,_tmp34E);Cyc_Port_leq(
_tmp351,_tmp348);}}return Cyc_Port_array_ct(_tmp348,_tmp349,_tmp34A);}_LL2A3: if(*((
int*)_tmp339)!= 10)goto _LL2A5;_tmp33F=((struct Cyc_Absyn_AggrType_struct*)_tmp339)->f1;
_tmp340=_tmp33F.aggr_info;if((_tmp340.UnknownAggr).tag != 1)goto _LL2A5;_tmp341=(
struct _tuple2)(_tmp340.UnknownAggr).val;_tmp342=_tmp341.f1;if((int)_tmp342 != 0)
goto _LL2A5;_tmp343=_tmp341.f2;_LL2A4:(*_tmp343).f1=Cyc_Absyn_Loc_n;{struct Cyc_Absyn_Aggrdecl*
_tmp353;struct _tuple10 _tmp352=*Cyc_Port_lookup_struct_decl(env,_tmp343);_tmp353=
_tmp352.f1;if((struct Cyc_Absyn_Aggrdecl*)_tmp353 == 0)({void*_tmp354=0;((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*
_tmp355="struct is not yet defined";_tag_dyneither(_tmp355,sizeof(char),26);}),
_tag_dyneither(_tmp354,sizeof(void*),0));});_tmp347=_tmp353;goto _LL2A6;}_LL2A5:
if(*((int*)_tmp339)!= 10)goto _LL2A7;_tmp344=((struct Cyc_Absyn_AggrType_struct*)
_tmp339)->f1;_tmp345=_tmp344.aggr_info;if((_tmp345.KnownAggr).tag != 2)goto _LL2A7;
_tmp346=(struct Cyc_Absyn_Aggrdecl**)(_tmp345.KnownAggr).val;_tmp347=*_tmp346;
_LL2A6: {struct Cyc_List_List*_tmp356=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(
_tmp347->impl))->fields;for(0;_tmp336 != 0;_tmp336=_tmp336->tl){struct Cyc_List_List*
_tmp358;struct Cyc_Absyn_Exp*_tmp359;struct _tuple14 _tmp357=*((struct _tuple14*)
_tmp336->hd);_tmp358=_tmp357.f1;_tmp359=_tmp357.f2;if((unsigned int)_tmp358)({
void*_tmp35A=0;((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({
const char*_tmp35B="designators in initializers";_tag_dyneither(_tmp35B,sizeof(
char),28);}),_tag_dyneither(_tmp35A,sizeof(void*),0));});{struct Cyc_Absyn_Aggrfield*
_tmp35C=(struct Cyc_Absyn_Aggrfield*)((struct Cyc_List_List*)_check_null(_tmp356))->hd;
_tmp356=_tmp356->tl;{void*_tmp35D=Cyc_Port_gen_initializer(env,_tmp35C->type,
_tmp359);;}}}return Cyc_Port_type_to_ctype(env,t);}_LL2A7:;_LL2A8:({void*_tmp35E=
0;((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({
const char*_tmp35F="bad type for aggregate initializer";_tag_dyneither(_tmp35F,
sizeof(char),35);}),_tag_dyneither(_tmp35E,sizeof(void*),0));});_LL29E:;}_LL29A:
if(*((int*)_tmp333)!= 0)goto _LL29C;_tmp337=((struct Cyc_Absyn_Const_e_struct*)
...
d){void*_tmp362=d->r;struct Cyc_Absyn_Vardecl*_tmp363;_LL2B1: if(_tmp362 <= (void*)
2)goto _LL2B3;if(*((int*)_tmp362)!= 0)goto _LL2B3;_tmp363=((struct Cyc_Absyn_Var_d_struct*)
_tmp362)->f1;_LL2B2: {void*_tmp364=Cyc_Port_var();void*q;if((env->gcenv)->porting){
q=Cyc_Port_var();Cyc_Port_register_const_cvar(env,q,(_tmp363->tq).print_const?
Cyc_Port_const_ct(): Cyc_Port_notconst_ct(),(_tmp363->tq).loc);}else{q=(_tmp363->tq).print_const?
Cyc_Port_const_ct(): Cyc_Port_notconst_ct();}(*_tmp363->name).f1=Cyc_Absyn_Loc_n;
env=Cyc_Port_add_var(env,_tmp363->name,_tmp363->type,q,_tmp364);Cyc_Port_unifies(
_tmp364,Cyc_Port_type_to_ctype(env,_tmp363->type));if((unsigned int)_tmp363->initializer){
struct Cyc_Absyn_Exp*e=(struct Cyc_Absyn_Exp*)_check_null(_tmp363->initializer);
void*t2=Cyc_Port_gen_initializer(env,_tmp363->type,e);Cyc_Port_leq(t2,_tmp364);}
return env;}_LL2B3:;_LL2B4:({void*_tmp365=0;((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp366="non-local decl that isn't a variable";
_tag_dyneither(_tmp366,sizeof(char),37);}),_tag_dyneither(_tmp365,sizeof(void*),
0));});_LL2B0:;}struct _tuple15{struct _dyneither_ptr*f1;struct Cyc_Absyn_Tqual f2;
void*f3;};static struct _tuple7*Cyc_Port_make_targ(struct _tuple15*arg){struct
_dyneither_ptr*_tmp368;struct Cyc_Absyn_Tqual _tmp369;void*_tmp36A;struct _tuple15
_tmp367=*arg;_tmp368=_tmp367.f1;_tmp369=_tmp367.f2;_tmp36A=_tmp367.f3;return({
struct _tuple7*_tmp36B=_cycalloc(sizeof(*_tmp36B));_tmp36B->f1=0;_tmp36B->f2=
_tmp369;_tmp36B->f3=_tmp36A;_tmp36B;});}static struct Cyc_Port_Cenv*Cyc_Port_gen_topdecls(
struct Cyc_Port_Cenv*env,struct Cyc_List_List*ds);struct _tuple16{struct
_dyneither_ptr*f1;void*f2;void*f3;void*f4;};static struct Cyc_Port_Cenv*Cyc_Port_gen_topdecl(
struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Decl*d){void*_tmp36C=d->r;struct Cyc_Absyn_Vardecl*
_tmp36D;struct Cyc_Absyn_Fndecl*_tmp36E;struct Cyc_Absyn_Typedefdecl*_tmp36F;
struct Cyc_Absyn_Aggrdecl*_tmp370;struct Cyc_Absyn_Enumdecl*_tmp371;_LL2B6: if((int)
_tmp36C != 0)goto _LL2B8;_LL2B7:(env->gcenv)->porting=1;return env;_LL2B8: if((int)
_tmp36C != 1)goto _LL2BA;_LL2B9:(env->gcenv)->porting=0;return env;_LL2BA: if(
_tmp36C <= (void*)2)goto _LL2C4;if(*((int*)_tmp36C)!= 0)goto _LL2BC;_tmp36D=((
struct Cyc_Absyn_Var_d_struct*)_tmp36C)->f1;_LL2BB:(*_tmp36D->name).f1=Cyc_Absyn_Loc_n;
if(Cyc_Port_declared_var(env,_tmp36D->name)){void*_tmp373;void*_tmp374;struct
_tuple9 _tmp372=Cyc_Port_lookup_var(env,_tmp36D->name);_tmp373=_tmp372.f1;_tmp374=
_tmp372.f2;{void*q2;if((env->gcenv)->porting  && !Cyc_Port_isfn(env,_tmp36D->name)){
q2=Cyc_Port_var();Cyc_Port_register_const_cvar(env,q2,(_tmp36D->tq).print_const?
Cyc_Port_const_ct(): Cyc_Port_notconst_ct(),(_tmp36D->tq).loc);}else{q2=(_tmp36D->tq).print_const?
Cyc_Port_const_ct(): Cyc_Port_notconst_ct();}Cyc_Port_unifies(_tmp373,q2);Cyc_Port_unifies(
_tmp374,Cyc_Port_type_to_ctype(env,_tmp36D->type));if((unsigned int)_tmp36D->initializer){
struct Cyc_Absyn_Exp*e=(struct Cyc_Absyn_Exp*)_check_null(_tmp36D->initializer);
Cyc_Port_leq(Cyc_Port_gen_initializer(env,_tmp36D->type,e),_tmp374);}return env;}}
else{return Cyc_Port_gen_localdecl(env,d);}_LL2BC: if(*((int*)_tmp36C)!= 1)goto
_LL2BE;_tmp36E=((struct Cyc_Absyn_Fn_d_struct*)_tmp36C)->f1;_LL2BD:(*_tmp36E->name).f1=
Cyc_Absyn_Loc_n;{struct _tuple12*predeclared=0;if(Cyc_Port_declared_var(env,
_tmp36E->name))predeclared=(struct _tuple12*)Cyc_Port_lookup_full_var(env,_tmp36E->name);{
void*_tmp375=_tmp36E->ret_type;struct Cyc_List_List*_tmp376=_tmp36E->args;struct
Cyc_List_List*_tmp377=((struct Cyc_List_List*(*)(struct _tuple7*(*f)(struct
_tuple15*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Port_make_targ,_tmp376);
struct Cyc_Absyn_FnType_struct*_tmp378=({struct Cyc_Absyn_FnType_struct*_tmp392=
_cycalloc(sizeof(*_tmp392));_tmp392[0]=({struct Cyc_Absyn_FnType_struct _tmp393;
_tmp393.tag=8;_tmp393.f1=({struct Cyc_Absyn_FnInfo _tmp394;_tmp394.tvars=0;_tmp394.effect=
0;_tmp394.ret_typ=_tmp375;_tmp394.args=_tmp377;_tmp394.c_varargs=0;_tmp394.cyc_varargs=
0;_tmp394.rgn_po=0;_tmp394.attributes=0;_tmp394;});_tmp393;});_tmp392;});struct
...
else{tqv=_tmp37E.print_const?Cyc_Port_const_ct(): Cyc_Port_notconst_ct();}c_args=({
struct Cyc_List_List*_tmp381=_cycalloc(sizeof(*_tmp381));_tmp381->hd=({struct
_tuple16*_tmp382=_cycalloc(sizeof(*_tmp382));_tmp382->f1=_tmp37D;_tmp382->f2=
_tmp37F;_tmp382->f3=tqv;_tmp382->f4=_tmp380;_tmp382;});_tmp381->tl=c_args;
_tmp381;});c_arg_types=({struct Cyc_List_List*_tmp383=_cycalloc(sizeof(*_tmp383));
_tmp383->hd=(void*)_tmp380;_tmp383->tl=c_arg_types;_tmp383;});}}}c_args=((struct
Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(c_args);c_arg_types=
Cyc_List_imp_rev(c_arg_types);{void*_tmp384=Cyc_Port_fn_ct(_tmp37A,c_arg_types);(*
_tmp36E->name).f1=Cyc_Absyn_Loc_n;_tmp379=Cyc_Port_add_var(_tmp379,_tmp36E->name,(
void*)_tmp378,Cyc_Port_const_ct(),_tmp384);Cyc_Port_add_return_type(_tmp379,
_tmp37A);{struct Cyc_List_List*_tmp385=c_args;for(0;(unsigned int)_tmp385;_tmp385=
_tmp385->tl){struct _dyneither_ptr*_tmp387;void*_tmp388;void*_tmp389;void*_tmp38A;
struct _tuple16 _tmp386=*((struct _tuple16*)_tmp385->hd);_tmp387=_tmp386.f1;_tmp388=
_tmp386.f2;_tmp389=_tmp386.f3;_tmp38A=_tmp386.f4;_tmp379=Cyc_Port_add_var(
_tmp379,({struct _tuple0*_tmp38B=_cycalloc(sizeof(*_tmp38B));_tmp38B->f1=Cyc_Absyn_Loc_n;
_tmp38B->f2=_tmp387;_tmp38B;}),_tmp388,_tmp389,_tmp38A);}}Cyc_Port_gen_stmt(
_tmp379,_tmp36E->body);Cyc_Port_generalize(0,_tmp384);{struct Cyc_Dict_Dict counts=((
...
Cyc_Port_unifies(_tmp39B,_tmp39E);}curr=({struct Cyc_List_List*_tmp39F=_cycalloc(
sizeof(*_tmp39F));_tmp39F->hd=({struct Cyc_Port_Cfield*_tmp3A0=_cycalloc(sizeof(*
_tmp3A0));_tmp3A0->qual=qv;_tmp3A0->f=_tmp39A->name;_tmp3A0->type=_tmp39B;
_tmp3A0;});_tmp39F->tl=curr;_tmp39F;});}}}curr=((struct Cyc_List_List*(*)(struct
Cyc_List_List*x))Cyc_List_imp_rev)(curr);if((*previous).f2 == 0)(*previous).f2=
curr;}return env;}}_LL2C2: if(*((int*)_tmp36C)!= 8)goto _LL2C4;_tmp371=((struct Cyc_Absyn_Enum_d_struct*)
_tmp36C)->f1;_LL2C3:(*_tmp371->name).f1=Cyc_Absyn_Loc_n;if((unsigned int)_tmp371->fields){
struct Cyc_List_List*_tmp3A1=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)
_check_null(_tmp371->fields))->v;for(0;(unsigned int)_tmp3A1;_tmp3A1=_tmp3A1->tl){(*((
struct Cyc_Absyn_Enumfield*)_tmp3A1->hd)->name).f1=Cyc_Absyn_Loc_n;env=Cyc_Port_add_var(
env,((struct Cyc_Absyn_Enumfield*)_tmp3A1->hd)->name,(void*)({struct Cyc_Absyn_EnumType_struct*
_tmp3A2=_cycalloc(sizeof(*_tmp3A2));_tmp3A2[0]=({struct Cyc_Absyn_EnumType_struct
_tmp3A3;_tmp3A3.tag=12;_tmp3A3.f1=_tmp371->name;_tmp3A3.f2=(struct Cyc_Absyn_Enumdecl*)
_tmp371;_tmp3A3;});_tmp3A2;}),Cyc_Port_const_ct(),Cyc_Port_arith_ct());}}return
env;_LL2C4:;_LL2C5: if((env->gcenv)->porting)({void*_tmp3A4=0;Cyc_fprintf(Cyc_stderr,({
const char*_tmp3A5="Warning: Cyclone declaration found in code to be ported -- skipping.";
_tag_dyneither(_tmp3A5,sizeof(char),69);}),_tag_dyneither(_tmp3A4,sizeof(void*),
0));});return env;_LL2B5:;}static struct Cyc_Port_Cenv*Cyc_Port_gen_topdecls(struct
...
Cyc_Port_gen_topdecls(Cyc_Port_initial_cenv(),ds);struct Cyc_List_List*_tmp3A6=(
env->gcenv)->pointer_edits;struct Cyc_List_List*_tmp3A7=(env->gcenv)->qualifier_edits;
struct Cyc_List_List*_tmp3A8=(env->gcenv)->zeroterm_edits;struct Cyc_List_List*
_tmp3A9=(env->gcenv)->edits;{struct Cyc_List_List*_tmp3AA=_tmp3A6;for(0;(
unsigned int)_tmp3AA;_tmp3AA=_tmp3AA->tl){void*_tmp3AC;void*_tmp3AD;struct Cyc_Position_Segment*
_tmp3AE;struct _tuple13 _tmp3AB=*((struct _tuple13*)_tmp3AA->hd);_tmp3AC=_tmp3AB.f1;
_tmp3AD=_tmp3AB.f2;_tmp3AE=_tmp3AB.f3;Cyc_Port_unifies(_tmp3AC,_tmp3AD);}}{
struct Cyc_List_List*_tmp3AF=_tmp3A7;for(0;(unsigned int)_tmp3AF;_tmp3AF=_tmp3AF->tl){
void*_tmp3B1;void*_tmp3B2;struct Cyc_Position_Segment*_tmp3B3;struct _tuple13
_tmp3B0=*((struct _tuple13*)_tmp3AF->hd);_tmp3B1=_tmp3B0.f1;_tmp3B2=_tmp3B0.f2;
_tmp3B3=_tmp3B0.f3;Cyc_Port_unifies(_tmp3B1,_tmp3B2);}}{struct Cyc_List_List*
_tmp3B4=_tmp3A8;for(0;(unsigned int)_tmp3B4;_tmp3B4=_tmp3B4->tl){void*_tmp3B6;
void*_tmp3B7;struct Cyc_Position_Segment*_tmp3B8;struct _tuple13 _tmp3B5=*((struct
_tuple13*)_tmp3B4->hd);_tmp3B6=_tmp3B5.f1;_tmp3B7=_tmp3B5.f2;_tmp3B8=_tmp3B5.f3;
Cyc_Port_unifies(_tmp3B6,_tmp3B7);}}for(0;(unsigned int)_tmp3A6;_tmp3A6=_tmp3A6->tl){
void*_tmp3BA;void*_tmp3BB;struct Cyc_Position_Segment*_tmp3BC;struct _tuple13
_tmp3B9=*((struct _tuple13*)_tmp3A6->hd);_tmp3BA=_tmp3B9.f1;_tmp3BB=_tmp3B9.f2;
_tmp3BC=_tmp3B9.f3;if(!Cyc_Port_unifies(_tmp3BA,_tmp3BB) && (unsigned int)
_tmp3BC){void*_tmp3BD=Cyc_Port_compress_ct(_tmp3BB);_LL2CC: if((int)_tmp3BD != 2)
goto _LL2CE;_LL2CD: _tmp3A9=({struct Cyc_List_List*_tmp3BE=_cycalloc(sizeof(*
_tmp3BE));_tmp3BE->hd=({struct Cyc_Port_Edit*_tmp3BF=_cycalloc(sizeof(*_tmp3BF));
_tmp3BF->loc=_tmp3BC;_tmp3BF->old_string=({const char*_tmp3C1="?";_tag_dyneither(
_tmp3C1,sizeof(char),2);});_tmp3BF->new_string=({const char*_tmp3C0="*";
_tag_dyneither(_tmp3C0,sizeof(char),2);});_tmp3BF;});_tmp3BE->tl=_tmp3A9;_tmp3BE;});
goto _LL2CB;_LL2CE: if((int)_tmp3BD != 3)goto _LL2D0;_LL2CF: _tmp3A9=({struct Cyc_List_List*
_tmp3C2=_cycalloc(sizeof(*_tmp3C2));_tmp3C2->hd=({struct Cyc_Port_Edit*_tmp3C3=
_cycalloc(sizeof(*_tmp3C3));_tmp3C3->loc=_tmp3BC;_tmp3C3->old_string=({const char*
_tmp3C5="*";_tag_dyneither(_tmp3C5,sizeof(char),2);});_tmp3C3->new_string=({
const char*_tmp3C4="?";_tag_dyneither(_tmp3C4,sizeof(char),2);});_tmp3C3;});
_tmp3C2->tl=_tmp3A9;_tmp3C2;});goto _LL2CB;_LL2D0:;_LL2D1: goto _LL2CB;_LL2CB:;}}
for(0;(unsigned int)_tmp3A7;_tmp3A7=_tmp3A7->tl){void*_tmp3C7;void*_tmp3C8;
struct Cyc_Position_Segment*_tmp3C9;struct _tuple13 _tmp3C6=*((struct _tuple13*)
_tmp3A7->hd);_tmp3C7=_tmp3C6.f1;_tmp3C8=_tmp3C6.f2;_tmp3C9=_tmp3C6.f3;if(!Cyc_Port_unifies(
_tmp3C7,_tmp3C8) && (unsigned int)_tmp3C9){void*_tmp3CA=Cyc_Port_compress_ct(
_tmp3C8);_LL2D3: if((int)_tmp3CA != 1)goto _LL2D5;_LL2D4: _tmp3A9=({struct Cyc_List_List*
_tmp3CB=_cycalloc(sizeof(*_tmp3CB));_tmp3CB->hd=({struct Cyc_Port_Edit*_tmp3CC=
_cycalloc(sizeof(*_tmp3CC));_tmp3CC->loc=_tmp3C9;_tmp3CC->old_string=({const char*
_tmp3CE="const ";_tag_dyneither(_tmp3CE,sizeof(char),7);});_tmp3CC->new_string=({
const char*_tmp3CD="";_tag_dyneither(_tmp3CD,sizeof(char),1);});_tmp3CC;});
_tmp3CB->tl=_tmp3A9;_tmp3CB;});goto _LL2D2;_LL2D5: if((int)_tmp3CA != 0)goto _LL2D7;
_LL2D6: _tmp3A9=({struct Cyc_List_List*_tmp3CF=_cycalloc(sizeof(*_tmp3CF));_tmp3CF->hd=({
struct Cyc_Port_Edit*_tmp3D0=_cycalloc(sizeof(*_tmp3D0));_tmp3D0->loc=_tmp3C9;
_tmp3D0->old_string=({const char*_tmp3D2="";_tag_dyneither(_tmp3D2,sizeof(char),1);});
_tmp3D0->new_string=({const char*_tmp3D1="const ";_tag_dyneither(_tmp3D1,sizeof(
char),7);});_tmp3D0;});_tmp3CF->tl=_tmp3A9;_tmp3CF;});goto _LL2D2;_LL2D7:;_LL2D8:
goto _LL2D2;_LL2D2:;}}for(0;(unsigned int)_tmp3A8;_tmp3A8=_tmp3A8->tl){void*
_tmp3D4;void*_tmp3D5;struct Cyc_Position_Segment*_tmp3D6;struct _tuple13 _tmp3D3=*((
struct _tuple13*)_tmp3A8->hd);_tmp3D4=_tmp3D3.f1;_tmp3D5=_tmp3D3.f2;_tmp3D6=
_tmp3D3.f3;if(!Cyc_Port_unifies(_tmp3D4,_tmp3D5) && (unsigned int)_tmp3D6){void*
_tmp3D7=Cyc_Port_compress_ct(_tmp3D5);_LL2DA: if((int)_tmp3D7 != 8)goto _LL2DC;
_LL2DB: _tmp3A9=({struct Cyc_List_List*_tmp3D8=_cycalloc(sizeof(*_tmp3D8));_tmp3D8->hd=({
struct Cyc_Port_Edit*_tmp3D9=_cycalloc(sizeof(*_tmp3D9));_tmp3D9->loc=_tmp3D6;
_tmp3D9->old_string=({const char*_tmp3DB="NOZEROTERM ";_tag_dyneither(_tmp3DB,
sizeof(char),12);});_tmp3D9->new_string=({const char*_tmp3DA="";_tag_dyneither(
_tmp3DA,sizeof(char),1);});_tmp3D9;});_tmp3D8->tl=_tmp3A9;_tmp3D8;});goto _LL2D9;
_LL2DC: if((int)_tmp3D7 != 9)goto _LL2DE;_LL2DD: _tmp3A9=({struct Cyc_List_List*
_tmp3DC=_cycalloc(sizeof(*_tmp3DC));_tmp3DC->hd=({struct Cyc_Port_Edit*_tmp3DD=
_cycalloc(sizeof(*_tmp3DD));_tmp3DD->loc=_tmp3D6;_tmp3DD->old_string=({const char*
_tmp3DF="ZEROTERM ";_tag_dyneither(_tmp3DF,sizeof(char),10);});_tmp3DD->new_string=({
const char*_tmp3DE="";_tag_dyneither(_tmp3DE,sizeof(char),1);});_tmp3DD;});
_tmp3DC->tl=_tmp3A9;_tmp3DC;});goto _LL2D9;_LL2DE:;_LL2DF: goto _LL2D9;_LL2D9:;}}
_tmp3A9=((struct Cyc_List_List*(*)(int(*cmp)(struct Cyc_Port_Edit*,struct Cyc_Port_Edit*),
...
Cyc_Port_port(struct Cyc_List_List*ds){struct Cyc_List_List*_tmp3E0=Cyc_Port_gen_edits(
ds);struct Cyc_List_List*_tmp3E1=((struct Cyc_List_List*(*)(struct Cyc_Position_Segment*(*
f)(struct Cyc_Port_Edit*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Port_get_seg,
_tmp3E0);Cyc_Position_use_gcc_style_location=0;{struct Cyc_List_List*_tmp3E2=((
...
Cyc_List_List*)_check_null(_tmp3E2))->hd);({struct Cyc_String_pa_struct _tmp3EB;
_tmp3EB.tag=0;_tmp3EB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp3E6);{
struct Cyc_String_pa_struct _tmp3EA;_tmp3EA.tag=0;_tmp3EA.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)_tmp3E5);{struct Cyc_String_pa_struct _tmp3E9;_tmp3E9.tag=0;
_tmp3E9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)sloc);{void*_tmp3E7[3]={&
_tmp3E9,& _tmp3EA,& _tmp3EB};Cyc_printf(({const char*_tmp3E8="%s: insert `%s' for `%s'\n";
_tag_dyneither(_tmp3E8,sizeof(char),26);}),_tag_dyneither(_tmp3E7,sizeof(void*),
3));}}}});}}}}
