...
Cyc_Absyn_Exp*)_check_null(_tmp224));}Cyc_Absyndump_dump_semi();}}void Cyc_Absyndump_dumptypedefname(
...
Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_check_null(_tmp230));}Cyc_Absyndump_dump_semi();}
