...
void Cyc_Tcexp_check_consume(unsigned,struct Cyc_List_List*,void*,struct Cyc_Absyn_Exp*);struct Cyc_Tcpat_TcPatResult{struct _tuple1*tvars_and_bounds_opt;struct Cyc_List_List*patvars;struct Cyc_List_List*aquals_bounds;};
# 55 "tcpat.h"
...
return({struct _tuple2*_Tmp0=_cycalloc(sizeof(struct _tuple2));_Tmp0->f0=Cyc_Absyn_Loc_n,({struct _fat_ptr*_Tmp1=({struct _fat_ptr*_Tmp2=_cycalloc(sizeof(struct _fat_ptr));({struct _fat_ptr _Tmp3=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _Tmp4=({struct Cyc_Int_pa_PrintArg_struct _Tmp5;_Tmp5.tag=1,_Tmp5.f1=(unsigned)counter ++;_Tmp5;});void*_Tmp5[1];_Tmp5[0]=& _Tmp4;Cyc_aprintf(_tag_fat("_tmpS%X",sizeof(char),8U),_tag_fat(_Tmp5,sizeof(void*),1));});*_Tmp2=_Tmp3;});_Tmp2;});_Tmp0->f1=_Tmp1;});_Tmp0;});}
# 56
...
# 78
void*_Tmp0;void*_Tmp1;void*_Tmp2;_Tmp2=pat_res.tvars_and_bounds_opt;_Tmp1=pat_res.patvars;_Tmp0=pat_res.aquals_bounds;{struct _tuple1*p=_Tmp2;struct Cyc_List_List*vse=_Tmp1;struct Cyc_List_List*aqb=_Tmp0;
...
struct Cyc_List_List*tvs=p==0?0:({(struct Cyc_List_List*(*)(struct Cyc_Absyn_Tvar*(*)(struct _tuple15*),struct Cyc_List_List*))Cyc_List_map;})(({(struct Cyc_Absyn_Tvar*(*)(struct _tuple15*))Cyc_Core_fst;}),(*p).f0);
struct Cyc_List_List*bds=p==0?0:(*p).f1;
struct Cyc_List_List*rgns=p==0?0:({(struct Cyc_List_List*(*)(struct Cyc_Absyn_Tvar*(*)(struct _tuple15*),struct Cyc_List_List*))Cyc_List_map;})(({(struct Cyc_Absyn_Tvar*(*)(struct _tuple15*))Cyc_Core_fst;}),({(struct Cyc_List_List*(*)(int(*)(struct _tuple15*),struct Cyc_List_List*))Cyc_List_filter;})(({(int(*)(struct _tuple15*))Cyc_Core_snd;}),(*p).f0));
...
void*_Tmp6=Cyc_Absyn_compress(tv);if(*((int*)_Tmp6)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp6)->f1)==16){
# 97
...
if(!({struct Cyc_RgnOrder_RgnPO*_Tmp7=Cyc_Tcenv_curr_rgnpo(te);struct Cyc_List_List*_Tmp8=Cyc_Tcenv_curr_aquals_bounds(te);struct Cyc_Absyn_Exp*_Tmp9=eopt;Cyc_Tcutil_coerce_arg(_Tmp7,_Tmp8,_Tmp9,t,0);})){
...
int _Tmp7=Cyc_Tcutil_new_tvar_id();tv->identity=_Tmp7;}),({void*_Tmp7=Cyc_Kinds_kind_to_bound(& Cyc_Kinds_rk);tv->kind=_Tmp7;}),tv->aquals_bound=0;
...
if(!({struct Cyc_RgnOrder_RgnPO*_TmpA=Cyc_Tcenv_curr_rgnpo(te);struct Cyc_List_List*_TmpB=Cyc_Tcenv_curr_aquals_bounds(te);struct Cyc_Absyn_Exp*_TmpC=(struct Cyc_Absyn_Exp*)es->hd;Cyc_Tcutil_coerce_arg(_TmpA,_TmpB,_TmpC,(void*)ts->hd,0);})){
...
if(next_pattern->tvars_and_bounds_opt!=0 &&(*next_pattern->tvars_and_bounds_opt).f1!=0)
# 252
...
({(struct Cyc_List_List*(*)(struct Cyc_Absyn_Tvar*(*)(struct _tuple15*),struct Cyc_List_List*))Cyc_List_map;})(({(struct Cyc_Absyn_Tvar*(*)(struct _tuple15*))Cyc_Core_fst;}),(*next_pattern->tvars_and_bounds_opt).f0);
...
if(!({struct Cyc_RgnOrder_RgnPO*_Tmp12=Cyc_Tcenv_curr_rgnpo(te);struct Cyc_List_List*_Tmp13=Cyc_Tcenv_curr_aquals_bounds(te);struct Cyc_Absyn_Exp*_Tmp14=initializer;Cyc_Tcutil_coerce_assign(_Tmp12,_Tmp13,_Tmp14,t);})){
...
if(!Cyc_Unify_unify(pt,et)&& !({struct Cyc_RgnOrder_RgnPO*_TmpD=Cyc_Tcenv_curr_rgnpo(te);struct Cyc_List_List*_TmpE=Cyc_Tcenv_curr_aquals_bounds(te);struct Cyc_Absyn_Exp*_TmpF=e;Cyc_Tcutil_coerce_assign(_TmpD,_TmpE,_TmpF,pt);})){
...
void*outer_rgn=Cyc_Absyn_new_evar(({struct Cyc_Core_Opt*_TmpF=_cycalloc(sizeof(struct Cyc_Core_Opt));_TmpF->v=& Cyc_Kinds_rk;_TmpF;}),0);
...
struct Cyc_RgnOrder_RgnPO*_TmpF=Cyc_Tcenv_curr_rgnpo(te);struct Cyc_List_List*_Tmp10=Cyc_Tcenv_curr_aquals_bounds(te);struct Cyc_Absyn_Exp*_Tmp11=open_exp_opt;Cyc_Tcutil_coerce_assign(_TmpF,_Tmp10,_Tmp11,exp_type);}))
...
void*_TmpD=({void*_TmpE=t;void*_TmpF=curr_bl;void*_Tmp10=Cyc_Absyn_al_qual_type;struct Cyc_Absyn_Tqual _Tmp11=Cyc_Absyn_empty_tqual(0U);void*_Tmp12=Cyc_Absyn_false_type;Cyc_Absyn_at_type(_TmpE,_TmpF,_Tmp10,_Tmp11,_Tmp12,Cyc_Absyn_false_type);});vd->type=_TmpD;}),vd->initializer=0,vd->rgn=curr_bl,vd->attributes=0,vd->escapes=0,vd->is_proto=fd->body!=0;
# 513
fd->fn_vardecl=vd;{
...
# 581
if(fname_ok){
void*_Tmp6=fname->topt;struct Cyc_Absyn_FnInfo _Tmp7;if(_Tmp6!=0){if(*((int*)_Tmp6)==3){if(*((int*)((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp6)->f1.elt_type)==5){_Tmp7=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp6)->f1.elt_type)->f1;{struct Cyc_Absyn_FnInfo fi=_Tmp7;
# 584
...
# 587
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp8=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp9;_Tmp9.tag=0,_Tmp9.f1=_tag_fat("Expected function pointer type",sizeof(char),31U);_Tmp9;});void*_Tmp9[1];_Tmp9[0]=& _Tmp8;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_Tmp9,sizeof(void*),1));});}_LL24:;}
# 589
