...
struct _dyneither_ptr _tmp204=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)atts->hd));_tmp162.f1=_tmp204;});_tmp162;});void*_tmp109[1U];_tmp109[0]=& _tmp10B;({unsigned int _tmp206=_tmp148->loc;struct _dyneither_ptr _tmp205=({const char*_tmp10A="bad attribute %s for function";_tag_dyneither(_tmp10A,sizeof(char),30U);});Cyc_Tcutil_terr(_tmp206,_tmp205,_tag_dyneither(_tmp109,sizeof(void*),1U));});});
