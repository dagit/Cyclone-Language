...
# 440
{void*_tmpA2=Cyc_Tcutil_compress(_tmpCC);void*_tmpA3=_tmpA2;void*_tmpAF;struct Cyc_Absyn_Tqual _tmpAE;void*_tmpAD;unsigned int _tmpAC;switch(*((int*)_tmpA3)){case 5U: _LL57: if(is_local){_LL58:
# 443
 _tmp119->escapes=1;
_tmpD0=3U;
is_local=0;
