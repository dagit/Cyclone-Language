...
({unsigned _tmp1C4=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1C3=te;struct Cyc_List_List*_tmp1C2=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tctyp_check_type(_tmp1C4,_tmp1C3,_tmp1C2,& Cyc_Kinds_tmk,1,0,exp_type);});{
# 470
...
# 484
({unsigned _tmp1D1=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1D0=te;struct Cyc_List_List*_tmp1CF=Cyc_Tcenv_lookup_type_vars(te2);Cyc_Tctyp_check_type(_tmp1D1,_tmp1D0,_tmp1CF,& Cyc_Kinds_bk,1,0,*t);});
