...
te2=({struct Cyc_Tcenv_Tenv*_tmp160=te2;Cyc_Tcenv_add_region(_tmp160,(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp35=_cycalloc(sizeof(*_tmp35));_tmp35->tag=2U,_tmp35->f1=(struct Cyc_Absyn_Tvar*)_tmp34->hd;_tmp35;}),0);});}
...
# 144
if(where_opt != 0){
({struct Cyc_Tcenv_Tenv*_tmp162=te2;struct Cyc_Absyn_Exp*_tmp161=where_opt;Cyc_Tcexp_tcTest(_tmp162,_tmp161,({const char*_tmp38="switch clause guard";_tag_dyneither(_tmp38,sizeof(char),20U);}));});
if(!Cyc_Tcstmt_noassign_exp(where_opt))
({void*_tmp39=0U;({unsigned int _tmp164=where_opt->loc;struct _dyneither_ptr _tmp163=({const char*_tmp3A="cannot show &&-clause in pattern has no effects";_tag_dyneither(_tmp3A,sizeof(char),48U);});Cyc_Tcutil_terr(_tmp164,_tmp163,_tag_dyneither(_tmp39,sizeof(void*),0U));});});}
# 149
...
struct _tuple2*res=({struct _tuple2*_tmp42=_cycalloc(sizeof(*_tmp42));_tmp42->f1=Cyc_Absyn_Loc_n,({struct _dyneither_ptr*_tmp167=({struct _dyneither_ptr*_tmp41=_cycalloc(sizeof(*_tmp41));({struct _dyneither_ptr _tmp166=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp40=({struct Cyc_Int_pa_PrintArg_struct _tmp143;_tmp143.tag=1U,_tmp143.f1=(unsigned int)_tmp3D;_tmp143;});void*_tmp3E[1U];_tmp3E[0]=& _tmp40;({struct _dyneither_ptr _tmp165=({const char*_tmp3F="_stmttmp%X";_tag_dyneither(_tmp3F,sizeof(char),11U);});Cyc_aprintf(_tmp165,_tag_dyneither(_tmp3E,sizeof(void*),1U));});});*_tmp41=_tmp166;});_tmp41;});_tmp42->f2=_tmp167;});_tmp42;});
return res;}
# 166 "tcstmt.cyc"
...
({struct Cyc_String_pa_PrintArg_struct _tmp47=({struct Cyc_String_pa_PrintArg_struct _tmp144;_tmp144.tag=0U,({struct _dyneither_ptr _tmp168=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp144.f1=_tmp168;});_tmp144;});void*_tmp45[1U];_tmp45[0]=& _tmp47;({unsigned int _tmp16A=s0->loc;struct _dyneither_ptr _tmp169=({const char*_tmp46="should return a value of type %s";_tag_dyneither(_tmp46,sizeof(char),33U);});Cyc_Tcutil_warn(_tmp16A,_tmp169,_tag_dyneither(_tmp45,sizeof(void*),1U));});});else{
# 190
({struct Cyc_String_pa_PrintArg_struct _tmp4A=({struct Cyc_String_pa_PrintArg_struct _tmp145;_tmp145.tag=0U,({struct _dyneither_ptr _tmp16B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp145.f1=_tmp16B;});_tmp145;});void*_tmp48[1U];_tmp48[0]=& _tmp4A;({unsigned int _tmp16D=s0->loc;struct _dyneither_ptr _tmp16C=({const char*_tmp49="must return a value of type %s";_tag_dyneither(_tmp49,sizeof(char),31U);});Cyc_Tcutil_terr(_tmp16D,_tmp16C,_tag_dyneither(_tmp48,sizeof(void*),1U));});});}}}else{
# 194
int bogus=0;
...
struct _dyneither_ptr _tmp16E=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(e->topt)));_tmp147.f1=_tmp16E;});_tmp147;});struct Cyc_String_pa_PrintArg_struct _tmp4E=({struct Cyc_String_pa_PrintArg_struct _tmp146;_tmp146.tag=0U,({struct _dyneither_ptr _tmp16F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp146.f1=_tmp16F;});_tmp146;});void*_tmp4B[2U];_tmp4B[0]=& _tmp4D,_tmp4B[1]=& _tmp4E;({unsigned int _tmp171=s0->loc;struct _dyneither_ptr _tmp170=({const char*_tmp4C="returns value of type %s but requires %s";_tag_dyneither(_tmp4C,sizeof(char),41U);});Cyc_Tcutil_terr(_tmp171,_tmp170,_tag_dyneither(_tmp4B,sizeof(void*),2U));});});
Cyc_Tcutil_explain_failure();}
# 202
if(Cyc_Tcutil_is_noalias_pointer_or_aggr(t) && !Cyc_Tcutil_is_noalias_path(e))
({void*_tmp4F=0U;({unsigned int _tmp173=e->loc;struct _dyneither_ptr _tmp172=({const char*_tmp50="Cannot consume non-unique paths; do swap instead";_tag_dyneither(_tmp50,sizeof(char),49U);});Cyc_Tcutil_terr(_tmp173,_tmp172,_tag_dyneither(_tmp4F,sizeof(void*),0U));});});}
# 205
...
# 208
({struct Cyc_Tcenv_Tenv*_tmp175=te;struct Cyc_Absyn_Exp*_tmp174=_tmp12A;Cyc_Tcexp_tcTest(_tmp175,_tmp174,({const char*_tmp51="if statement";_tag_dyneither(_tmp51,sizeof(char),13U);}));});
...
# 214
({struct Cyc_Tcenv_Tenv*_tmp177=te;struct Cyc_Absyn_Exp*_tmp176=_tmp12D;Cyc_Tcexp_tcTest(_tmp177,_tmp176,({const char*_tmp52="while loop";_tag_dyneither(_tmp52,sizeof(char),11U);}));});
...
({struct Cyc_Tcenv_Tenv*_tmp179=te;struct Cyc_Absyn_Exp*_tmp178=_tmp132;Cyc_Tcexp_tcTest(_tmp179,_tmp178,({const char*_tmp53="for loop";_tag_dyneither(_tmp53,sizeof(char),9U);}));});
...
({struct Cyc_Tcenv_Tenv*_tmp17B=te;struct Cyc_Absyn_Exp*_tmp17A=_tmp135;Cyc_Tcexp_tcTest(_tmp17B,_tmp17A,({const char*_tmp54="do loop";_tag_dyneither(_tmp54,sizeof(char),8U);}));});
...
({void*_tmp56=0U;({unsigned int _tmp17D=s0->loc;struct _dyneither_ptr _tmp17C=({const char*_tmp57="fallthru not in a non-last case";_tag_dyneither(_tmp57,sizeof(char),32U);});Cyc_Tcutil_terr(_tmp17D,_tmp17C,_tag_dyneither(_tmp56,sizeof(void*),0U));});});
return;}{
# 241
struct Cyc_List_List*_tmp58=(*_tmp55).f2;
struct Cyc_List_List*_tmp59=(*_tmp55).f3;
struct Cyc_List_List*instantiation=({
struct Cyc_List_List*_tmp17E=Cyc_Tcenv_lookup_type_vars(te);((struct Cyc_List_List*(*)(struct _tuple13*(*f)(struct Cyc_List_List*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcutil_make_inst_var,_tmp17E,_tmp58);});
...
# 253
struct _dyneither_ptr _tmp17F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(((struct Cyc_Absyn_Exp*)_tmp138->hd)->topt)));_tmp149.f1=_tmp17F;});_tmp149;});struct Cyc_String_pa_PrintArg_struct _tmp5E=({struct Cyc_String_pa_PrintArg_struct _tmp148;_tmp148.tag=0U,({struct _dyneither_ptr _tmp180=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_tmp5A->hd));_tmp148.f1=_tmp180;});_tmp148;});void*_tmp5B[2U];_tmp5B[0]=& _tmp5D,_tmp5B[1]=& _tmp5E;({unsigned int _tmp182=s0->loc;struct _dyneither_ptr _tmp181=({const char*_tmp5C="fallthru argument has type %s but pattern variable has type %s";_tag_dyneither(_tmp5C,sizeof(char),63U);});Cyc_Tcutil_terr(_tmp182,_tmp181,_tag_dyneither(_tmp5B,sizeof(void*),2U));});});
Cyc_Tcutil_explain_failure();}
# 257
if(Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_tmp5A->hd) && !Cyc_Tcutil_is_noalias_path((struct Cyc_Absyn_Exp*)_tmp138->hd))
({void*_tmp5F=0U;({unsigned int _tmp184=((struct Cyc_Absyn_Exp*)_tmp138->hd)->loc;struct _dyneither_ptr _tmp183=({const char*_tmp60="Cannot consume non-unique paths; do swap instead";_tag_dyneither(_tmp60,sizeof(char),49U);});Cyc_Tcutil_terr(_tmp184,_tmp183,_tag_dyneither(_tmp5F,sizeof(void*),0U));});});}
# 260
if(_tmp138 != 0)
({void*_tmp61=0U;({unsigned int _tmp186=s0->loc;struct _dyneither_ptr _tmp185=({const char*_tmp62="too many arguments in explicit fallthru";_tag_dyneither(_tmp62,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp186,_tmp185,_tag_dyneither(_tmp61,sizeof(void*),0U));});});
if(_tmp5A != 0)
({void*_tmp63=0U;({unsigned int _tmp188=s0->loc;struct _dyneither_ptr _tmp187=({const char*_tmp64="too few arguments in explicit fallthru";_tag_dyneither(_tmp64,sizeof(char),39U);});Cyc_Tcutil_terr(_tmp188,_tmp187,_tag_dyneither(_tmp63,sizeof(void*),0U));});});
...
# 270
({struct Cyc_Tcenv_Tenv*_tmp190=({unsigned int _tmp18F=s0->loc;struct Cyc_Tcenv_Tenv*_tmp18E=te;Cyc_Tcenv_new_named_block(_tmp18F,_tmp18E,({struct Cyc_Absyn_Tvar*_tmp69=_cycalloc(sizeof(*_tmp69));
({struct _dyneither_ptr*_tmp18D=({struct _dyneither_ptr*_tmp68=_cycalloc(sizeof(*_tmp68));({struct _dyneither_ptr _tmp18C=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp67=({struct Cyc_String_pa_PrintArg_struct _tmp14A;_tmp14A.tag=0U,_tmp14A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp13A);_tmp14A;});void*_tmp65[1U];_tmp65[0]=& _tmp67;({struct _dyneither_ptr _tmp18B=({const char*_tmp66="`%s";_tag_dyneither(_tmp66,sizeof(char),4U);});Cyc_aprintf(_tmp18B,_tag_dyneither(_tmp65,sizeof(void*),1U));});});*_tmp68=_tmp18C;});_tmp68;});_tmp69->name=_tmp18D;}),({
int _tmp18A=Cyc_Tcutil_new_tvar_id();_tmp69->identity=_tmp18A;}),({
void*_tmp189=Cyc_Tcutil_kind_to_bound(& Cyc_Tcutil_rk);_tmp69->kind=_tmp189;});_tmp69;}));});
# 270
Cyc_Tcstmt_tcStmt(_tmp190,_tmp139,0);});
# 274
...
struct Cyc_Absyn_Vardecl*_tmp6B=({struct _tuple2*_tmp191=Cyc_Tcstmt_stmt_temp_var();Cyc_Absyn_new_vardecl(0U,_tmp191,Cyc_Absyn_new_evar(0,0),0);});
struct Cyc_Absyn_Stmt*_tmp6C=Cyc_Absyn_new_stmt(s0->r,s0->loc);
struct Cyc_Absyn_Decl*_tmp6D=({struct Cyc_Absyn_Pat*_tmp195=({void*_tmp193=(void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp70=_cycalloc(sizeof(*_tmp70));_tmp70->tag=1U,_tmp70->f1=_tmp6B,({struct Cyc_Absyn_Pat*_tmp192=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,_tmp6A->loc);_tmp70->f2=_tmp192;});_tmp70;});Cyc_Absyn_new_pat(_tmp193,_tmp6A->loc);});struct Cyc_Absyn_Exp*_tmp194=_tmp6A;Cyc_Absyn_let_decl(_tmp195,_tmp194,s0->loc);});
# 286
struct Cyc_Absyn_Stmt*_tmp6E=Cyc_Absyn_decl_stmt(_tmp6D,_tmp6C,s0->loc);
s0->r=_tmp6E->r;
({struct Cyc_Absyn_Exp*_tmp197=({void*_tmp196=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp6F=_cycalloc(sizeof(*_tmp6F));_tmp6F->tag=4U,_tmp6F->f1=_tmp6B;_tmp6F;});Cyc_Absyn_varb_exp(_tmp196,_tmp6A->loc);});*_tmp13D=_tmp197;});
...
({void*_tmp72=0U;({unsigned int _tmp199=_tmp6A->loc;struct _dyneither_ptr _tmp198=({const char*_tmp73="Cannot consume non-unique paths; do swap instead";_tag_dyneither(_tmp73,sizeof(char),49U);});Cyc_Tcutil_terr(_tmp199,_tmp198,_tag_dyneither(_tmp72,sizeof(void*),0U));});});{
# 300
...
# 310
if(_tmp74->tl != 0){
next_pattern=({struct Cyc_Tcpat_TcPatResult*_tmp75=_cycalloc(sizeof(*_tmp75));({struct Cyc_Tcpat_TcPatResult _tmp19A=Cyc_Tcpat_tcPat(te,((struct Cyc_Absyn_Switch_clause*)((struct Cyc_List_List*)_check_null(_tmp74->tl))->hd)->pattern,& _tmp71,_tmp6A);*_tmp75=_tmp19A;});_tmp75;});
...
struct _dyneither_ptr _tmp19B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp71));_tmp14C.f1=_tmp19B;});_tmp14C;});struct Cyc_String_pa_PrintArg_struct _tmp7C=({struct Cyc_String_pa_PrintArg_struct _tmp14B;_tmp14B.tag=0U,({struct _dyneither_ptr _tmp19C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmp78->topt)));_tmp14B.f1=_tmp19C;});_tmp14B;});void*_tmp79[2U];_tmp79[0]=& _tmp7B,_tmp79[1]=& _tmp7C;({unsigned int _tmp19E=((struct Cyc_Absyn_Switch_clause*)_tmp74->hd)->loc;struct _dyneither_ptr _tmp19D=({const char*_tmp7A="switch on type %s, but case expects type %s";_tag_dyneither(_tmp7A,sizeof(char),44U);});Cyc_Tcutil_terr(_tmp19E,_tmp19D,_tag_dyneither(_tmp79,sizeof(void*),2U));});});
Cyc_Tcutil_explain_failure();}else{
# 331
Cyc_Tcpat_check_pat_regions(te,_tmp78,this_pattern.patvars);}
# 333
({struct Cyc_Core_Opt*_tmp19F=({struct Cyc_Core_Opt*_tmp7D=_cycalloc(sizeof(*_tmp7D));_tmp7D->v=this_pattern.patvars;_tmp7D;});((struct Cyc_Absyn_Switch_clause*)_tmp74->hd)->pat_vars=_tmp19F;});
...
# 345
({void*_tmp1A3=({void*_tmp1A2=(void*)({struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmp7E=_cycalloc(sizeof(*_tmp7E));_tmp7E->tag=2U,({struct Cyc_Absyn_Stmt*_tmp1A1=Cyc_Absyn_new_stmt(_tmp140->r,_tmp140->loc);_tmp7E->f1=_tmp1A1;}),({struct Cyc_Absyn_Stmt*_tmp1A0=Cyc_Absyn_skip_stmt(_tmp140->loc);_tmp7E->f2=_tmp1A0;});_tmp7E;});Cyc_Absyn_new_stmt(_tmp1A2,_tmp140->loc);})->r;_tmp140->r=_tmp1A3;});
# 347
Cyc_Tcstmt_tcStmt(te,_tmp140,1);{
# 350
struct _tuple2*def_v=({struct _tuple2*_tmp95=_cycalloc(sizeof(*_tmp95));_tmp95->f1=Cyc_Absyn_Loc_n,({struct _dyneither_ptr*_tmp1A5=({struct _dyneither_ptr*_tmp94=_cycalloc(sizeof(*_tmp94));({struct _dyneither_ptr _tmp1A4=({const char*_tmp93="exn";_tag_dyneither(_tmp93,sizeof(char),4U);});*_tmp94=_tmp1A4;});_tmp94;});_tmp95->f2=_tmp1A5;});_tmp95;});
struct Cyc_Absyn_Vardecl*_tmp7F=Cyc_Absyn_new_vardecl(0U,def_v,Cyc_Absyn_void_type,0);
struct Cyc_Absyn_Pat*_tmp80=Cyc_Absyn_new_pat((void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp92=_cycalloc(sizeof(*_tmp92));_tmp92->tag=1U,_tmp92->f1=_tmp7F,({struct Cyc_Absyn_Pat*_tmp1A6=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0U);_tmp92->f2=_tmp1A6;});_tmp92;}),0U);
struct Cyc_Absyn_Stmt*_tmp81=
Cyc_Absyn_exp_stmt(Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_tmp91=_cycalloc(sizeof(*_tmp91));_tmp91->tag=11U,({struct Cyc_Absyn_Exp*_tmp1A7=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp90=_cycalloc(sizeof(*_tmp90));_tmp90->tag=4U,_tmp90->f1=_tmp7F;_tmp90;}),0U);_tmp91->f1=_tmp1A7;}),_tmp91->f2=1;_tmp91;}),0U),0U);
...
({struct Cyc_List_List*_tmp1A9=({struct Cyc_List_List*_tmp1A8=*_tmp13F;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp1A8,({struct Cyc_Absyn_Switch_clause*_tmp83[1U];_tmp83[0]=_tmp82;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp83,sizeof(struct Cyc_Absyn_Switch_clause*),1U));}));});*_tmp13F=_tmp1A9;});{
# 362
...
# 373
if(_tmp85->tl != 0){
next_pattern=({struct Cyc_Tcpat_TcPatResult*_tmp86=_cycalloc(sizeof(*_tmp86));({struct Cyc_Tcpat_TcPatResult _tmp1AA=Cyc_Tcpat_tcPat(te,((struct Cyc_Absyn_Switch_clause*)((struct Cyc_List_List*)_check_null(_tmp85->tl))->hd)->pattern,& _tmp84,0);*_tmp86=_tmp1AA;});_tmp86;});
if(next_pattern->tvars_and_bounds_opt != 0  && (*next_pattern->tvars_and_bounds_opt).f2 != 0)
# 377
te=Cyc_Tcenv_clear_fallthru(te);else{
# 379
...
struct _dyneither_ptr _tmp1AB=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp84));_tmp14E.f1=_tmp1AB;});_tmp14E;});struct Cyc_String_pa_PrintArg_struct _tmp8D=({struct Cyc_String_pa_PrintArg_struct _tmp14D;_tmp14D.tag=0U,({struct _dyneither_ptr _tmp1AC=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmp89->topt)));_tmp14D.f1=_tmp1AC;});_tmp14D;});void*_tmp8A[2U];_tmp8A[0]=& _tmp8C,_tmp8A[1]=& _tmp8D;({unsigned int _tmp1AE=((struct Cyc_Absyn_Switch_clause*)_tmp85->hd)->loc;struct _dyneither_ptr _tmp1AD=({const char*_tmp8B="switch on type %s, but case expects type %s";_tag_dyneither(_tmp8B,sizeof(char),44U);});Cyc_Tcutil_terr(_tmp1AE,_tmp1AD,_tag_dyneither(_tmp8A,sizeof(void*),2U));});});
Cyc_Tcutil_explain_failure();}else{
# 394
Cyc_Tcpat_check_pat_regions(te,_tmp89,this_pattern.patvars);}
# 396
({struct Cyc_Core_Opt*_tmp1AF=({struct Cyc_Core_Opt*_tmp8E=_cycalloc(sizeof(*_tmp8E));_tmp8E->v=this_pattern.patvars;_tmp8E;});((struct Cyc_Absyn_Switch_clause*)_tmp85->hd)->pat_vars=_tmp1AF;});
...
# 418
({void*_tmp9C=0U;({unsigned int _tmp1B1=_tmp142->loc;struct _dyneither_ptr _tmp1B0=({const char*_tmp9D="bad abstract scope for local variable";_tag_dyneither(_tmp9D,sizeof(char),38U);});Cyc_Tcutil_terr(_tmp1B1,_tmp1B0,_tag_dyneither(_tmp9C,sizeof(void*),0U));});});
...
# 436
 _tmpC8=({void*_tmp1B6=({void*_tmp1B5=_tmpAB;struct Cyc_Absyn_Tqual _tmp1B4=_tmpAA;struct Cyc_Absyn_Exp*_tmp1B3=Cyc_Absyn_uint_exp(_get_dyneither_size(_tmpA2,sizeof(char)),0U);void*_tmp1B2=_tmpA9;Cyc_Absyn_array_type(_tmp1B5,_tmp1B4,_tmp1B3,_tmp1B2,_tmpA8);});_tmp113->type=_tmp1B6;});
goto _LL57;case 9U: _LL5A: _tmpA3=((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpA1)->f1).Wstring_c).val;_LL5B:
# 439
 _tmpC8=({void*_tmp1BB=({void*_tmp1BA=_tmpAB;struct Cyc_Absyn_Tqual _tmp1B9=_tmpAA;struct Cyc_Absyn_Exp*_tmp1B8=Cyc_Absyn_uint_exp(1U,0U);void*_tmp1B7=_tmpA9;Cyc_Absyn_array_type(_tmp1BA,_tmp1B9,_tmp1B8,_tmp1B7,_tmpA8);});_tmp113->type=_tmp1BB;});
...
# 444
 _tmpC8=({void*_tmp1BC=Cyc_Absyn_array_type(_tmpAB,_tmpAA,_tmpA5,_tmpA9,_tmpA8);_tmp113->type=_tmp1BC;});
...
# 448
 _tmpC8=({void*_tmp1C1=({void*_tmp1C0=_tmpAB;struct Cyc_Absyn_Tqual _tmp1BF=_tmpAA;struct Cyc_Absyn_Exp*_tmp1BE=Cyc_Absyn_uint_exp((unsigned int)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmpA7),0U);void*_tmp1BD=_tmpA9;Cyc_Absyn_array_type(_tmp1C0,_tmp1BF,_tmp1BE,_tmp1BD,_tmpA8);});_tmp113->type=_tmp1C1;});
...
({int _tmp1C2=Cyc_Tcutil_extract_const_from_typedef(s0->loc,(_tmp113->tq).print_const,_tmpC8);(_tmp113->tq).real_const=_tmp1C2;});{
# 464
struct Cyc_Tcenv_Tenv*_tmpAE=_tmp96;
if(_tmpCC == Cyc_Absyn_Extern  || _tmpCC == Cyc_Absyn_ExternC)
({void*_tmpAF=0U;({unsigned int _tmp1C4=_tmp142->loc;struct _dyneither_ptr _tmp1C3=({const char*_tmpB0="extern declarations are not yet supported within functions";_tag_dyneither(_tmpB0,sizeof(char),59U);});Cyc_Tcutil_terr(_tmp1C4,_tmp1C3,_tag_dyneither(_tmpAF,sizeof(void*),0U));});});
if(_tmpC7 != 0){
Cyc_Tcexp_tcExpInitializer(_tmpAE,& _tmpC8,_tmpC7);
# 470
if(!is_local  && !Cyc_Tcutil_is_const_exp(_tmpC7))
({void*_tmpB1=0U;({unsigned int _tmp1C6=_tmp142->loc;struct _dyneither_ptr _tmp1C5=({const char*_tmpB2="initializer for static variable needs to be a constant expression";_tag_dyneither(_tmpB2,sizeof(char),66U);});Cyc_Tcutil_terr(_tmp1C6,_tmp1C5,_tag_dyneither(_tmpB1,sizeof(void*),0U));});});
...
({struct Cyc_String_pa_PrintArg_struct _tmpB8=({struct Cyc_String_pa_PrintArg_struct _tmp151;_tmp151.tag=0U,_tmp151.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpB3);_tmp151;});struct Cyc_String_pa_PrintArg_struct _tmpB9=({struct Cyc_String_pa_PrintArg_struct _tmp150;_tmp150.tag=0U,_tmp150.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpB4);_tmp150;});struct Cyc_String_pa_PrintArg_struct _tmpBA=({struct Cyc_String_pa_PrintArg_struct _tmp14F;_tmp14F.tag=0U,_tmp14F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpB5);_tmp14F;});void*_tmpB6[3U];_tmpB6[0]=& _tmpB8,_tmpB6[1]=& _tmpB9,_tmpB6[2]=& _tmpBA;({unsigned int _tmp1C8=_tmp142->loc;struct _dyneither_ptr _tmp1C7=({const char*_tmpB7="%s was declared with type %s but initialized with type %s.";_tag_dyneither(_tmpB7,sizeof(char),59U);});Cyc_Tcutil_terr(_tmp1C8,_tmp1C7,_tag_dyneither(_tmpB6,sizeof(void*),3U));});});else{
# 479
...
({struct Cyc_String_pa_PrintArg_struct _tmpBD=({struct Cyc_String_pa_PrintArg_struct _tmp154;_tmp154.tag=0U,_tmp154.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpB3);_tmp154;});struct Cyc_String_pa_PrintArg_struct _tmpBE=({struct Cyc_String_pa_PrintArg_struct _tmp153;_tmp153.tag=0U,_tmp153.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpB4);_tmp153;});struct Cyc_String_pa_PrintArg_struct _tmpBF=({struct Cyc_String_pa_PrintArg_struct _tmp152;_tmp152.tag=0U,_tmp152.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpB5);_tmp152;});void*_tmpBB[3U];_tmpBB[0]=& _tmpBD,_tmpBB[1]=& _tmpBE,_tmpBB[2]=& _tmpBF;({unsigned int _tmp1CA=_tmp142->loc;struct _dyneither_ptr _tmp1C9=({const char*_tmpBC="%s was declared with type %s\n but initialized with type %s.";_tag_dyneither(_tmpBC,sizeof(char),60U);});Cyc_Tcutil_terr(_tmp1CA,_tmp1C9,_tag_dyneither(_tmpBB,sizeof(void*),3U));});});else{
# 484
({struct Cyc_String_pa_PrintArg_struct _tmpC2=({struct Cyc_String_pa_PrintArg_struct _tmp157;_tmp157.tag=0U,_tmp157.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpB3);_tmp157;});struct Cyc_String_pa_PrintArg_struct _tmpC3=({struct Cyc_String_pa_PrintArg_struct _tmp156;_tmp156.tag=0U,_tmp156.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpB4);_tmp156;});struct Cyc_String_pa_PrintArg_struct _tmpC4=({struct Cyc_String_pa_PrintArg_struct _tmp155;_tmp155.tag=0U,_tmp155.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpB5);_tmp155;});void*_tmpC0[3U];_tmpC0[0]=& _tmpC2,_tmpC0[1]=& _tmpC3,_tmpC0[2]=& _tmpC4;({unsigned int _tmp1CC=_tmp142->loc;struct _dyneither_ptr _tmp1CB=({const char*_tmpC1="%s declared with type \n%s\n but initialized with type \n%s.";_tag_dyneither(_tmpC1,sizeof(char),58U);});Cyc_Tcutil_terr(_tmp1CC,_tmp1CB,_tag_dyneither(_tmpC0,sizeof(void*),3U));});});}}
# 486
...
struct Cyc_Absyn_Vardecl*_tmpD0=({struct _tuple2*_tmp1CD=Cyc_Tcstmt_stmt_temp_var();Cyc_Absyn_new_vardecl(0U,_tmp1CD,Cyc_Absyn_new_evar(0,0),0);});
struct Cyc_Absyn_Stmt*_tmpD1=Cyc_Absyn_new_stmt(s0->r,s0->loc);
struct Cyc_Absyn_Decl*_tmpD2=({struct Cyc_Absyn_Pat*_tmp1D1=({void*_tmp1CF=(void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmpD5=_cycalloc(sizeof(*_tmpD5));_tmpD5->tag=1U,_tmpD5->f1=_tmpD0,({struct Cyc_Absyn_Pat*_tmp1CE=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,_tmpCD->loc);_tmpD5->f2=_tmp1CE;});_tmpD5;});Cyc_Absyn_new_pat(_tmp1CF,_tmpCD->loc);});struct Cyc_Absyn_Exp*_tmp1D0=_tmpCD;Cyc_Absyn_let_decl(_tmp1D1,_tmp1D0,s0->loc);});
# 510
struct Cyc_Absyn_Stmt*_tmpD3=Cyc_Absyn_decl_stmt(_tmpD2,_tmpD1,s0->loc);
# 512
s0->r=_tmpD3->r;
({struct Cyc_Absyn_Exp*_tmp1D3=({void*_tmp1D2=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmpD4=_cycalloc(sizeof(*_tmpD4));_tmpD4->tag=4U,_tmpD4->f1=_tmpD0;_tmpD4;});Cyc_Absyn_varb_exp(_tmp1D2,_tmpCD->loc);});*_tmp115=_tmp1D3;});
...
({struct Cyc_Core_Opt*_tmp1D4=({struct Cyc_Core_Opt*_tmpD7=_cycalloc(sizeof(*_tmpD7));_tmpD7->v=_tmpD6.patvars;_tmpD7;});*_tmp116=_tmp1D4;});
if(!({void*_tmp1D5=(void*)_check_null(_tmp117->topt);Cyc_Tcutil_unify(_tmp1D5,(void*)_check_null(_tmpCD->topt));}) && !
...
struct _dyneither_ptr _tmp1D6=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmp117->topt)));_tmp159.f1=_tmp1D6;});_tmp159;});struct Cyc_String_pa_PrintArg_struct _tmpDB=({struct Cyc_String_pa_PrintArg_struct _tmp158;_tmp158.tag=0U,({struct _dyneither_ptr _tmp1D7=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmpCD->topt)));_tmp158.f1=_tmp1D7;});_tmp158;});void*_tmpD8[2U];_tmpD8[0]=& _tmpDA,_tmpD8[1]=& _tmpDB;({unsigned int _tmp1D9=_tmp142->loc;struct _dyneither_ptr _tmp1D8=({const char*_tmpD9="pattern type %s does not match definition type %s";_tag_dyneither(_tmpD9,sizeof(char),50U);});Cyc_Tcutil_terr(_tmp1D9,_tmp1D8,_tag_dyneither(_tmpD8,sizeof(void*),2U));});});
({void*_tmp1DA=(void*)_check_null(_tmp117->topt);Cyc_Tcutil_unify(_tmp1DA,(void*)_check_null(_tmpCD->topt));});
Cyc_Tcutil_explain_failure();}else{
# 532
...
*_tmpE0=_tmpDC;
({unsigned int _tmp1DD=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1DC=_tmpDD;struct Cyc_List_List*_tmp1DB=Cyc_Tcenv_lookup_type_vars(_tmpDD);Cyc_Tcutil_check_type(_tmp1DD,_tmp1DC,_tmp1DB,& Cyc_Tcutil_tmk,1,1,_tmpE1);});}
# 546
...
# 552
({void*_tmp1E1=({void*_tmp1E0=(void*)({struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmpE3=_cycalloc(sizeof(*_tmpE3));_tmpE3->tag=2U,({struct Cyc_Absyn_Stmt*_tmp1DF=Cyc_Absyn_new_stmt(_tmp141->r,_tmp141->loc);_tmpE3->f1=_tmp1DF;}),({struct Cyc_Absyn_Stmt*_tmp1DE=Cyc_Absyn_skip_stmt(_tmp141->loc);_tmpE3->f2=_tmp1DE;});_tmpE3;});Cyc_Absyn_new_stmt(_tmp1E0,_tmp141->loc);})->r;_tmp141->r=_tmp1E1;});{
# 554
...
# 562
struct _tuple2*drname=({struct _tuple2*_tmpF9=_cycalloc(sizeof(*_tmpF9));((_tmpF9->f1).Abs_n).tag=2U,({struct Cyc_List_List*_tmp1E6=({struct _dyneither_ptr*_tmpF4[1U];({struct _dyneither_ptr*_tmp1E5=({struct _dyneither_ptr*_tmpF6=_cycalloc(sizeof(*_tmpF6));({struct _dyneither_ptr _tmp1E4=({const char*_tmpF5="Core";_tag_dyneither(_tmpF5,sizeof(char),5U);});*_tmpF6=_tmp1E4;});_tmpF6;});_tmpF4[0]=_tmp1E5;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpF4,sizeof(struct _dyneither_ptr*),1U));});((_tmpF9->f1).Abs_n).val=_tmp1E6;}),({
struct _dyneither_ptr*_tmp1E3=({struct _dyneither_ptr*_tmpF8=_cycalloc(sizeof(*_tmpF8));({struct _dyneither_ptr _tmp1E2=({const char*_tmpF7="DynamicRegion";_tag_dyneither(_tmpF7,sizeof(char),14U);});*_tmpF8=_tmp1E2;});_tmpF8;});_tmpF9->f2=_tmp1E3;});_tmpF9;});
...
void*_tmpE9=({
union Cyc_Absyn_AggrInfo _tmp1E7=Cyc_Absyn_UnknownAggr(Cyc_Absyn_StructA,drname,0);Cyc_Absyn_aggr_type(_tmp1E7,({void*_tmpF2[1U];_tmpF2[0]=rgn_typ;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpF2,sizeof(void*),1U));}));});
void*_tmpEA=({void*_tmp1EA=_tmpE9;void*_tmp1E9=_tmpE7;struct Cyc_Absyn_Tqual _tmp1E8=
Cyc_Absyn_empty_tqual(0U);
# 568
Cyc_Absyn_at_type(_tmp1EA,_tmp1E9,_tmp1E8,Cyc_Absyn_false_type);});
# 570
({unsigned int _tmp1ED=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1EC=_tmp96;struct Cyc_List_List*_tmp1EB=Cyc_Tcenv_lookup_type_vars(_tmp96);Cyc_Tcutil_check_type(_tmp1ED,_tmp1EC,_tmp1EB,& Cyc_Tcutil_tmk,1,0,_tmpEA);});{
...
struct _dyneither_ptr _tmp1EE=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmpEA));_tmp15B.f1=_tmp1EE;});_tmp15B;});struct Cyc_String_pa_PrintArg_struct _tmpEF=({struct Cyc_String_pa_PrintArg_struct _tmp15A;_tmp15A.tag=0U,({struct _dyneither_ptr _tmp1EF=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmpEB));_tmp15A.f1=_tmp1EF;});_tmp15A;});void*_tmpEC[2U];_tmpEC[0]=& _tmpEE,_tmpEC[1]=& _tmpEF;({unsigned int _tmp1F1=s0->loc;struct _dyneither_ptr _tmp1F0=({const char*_tmpED="expected %s but found %s";_tag_dyneither(_tmpED,sizeof(char),25U);});Cyc_Tcutil_terr(_tmp1F1,_tmp1F0,_tag_dyneither(_tmpEC,sizeof(void*),2U));});});
if(!Cyc_Tcutil_unify(_tmpE7,Cyc_Absyn_unique_rgn_type) && !
Cyc_Tcutil_unify(_tmpE7,Cyc_Absyn_refcnt_rgn_type))
({void*_tmpF0=0U;({unsigned int _tmp1F3=s0->loc;struct _dyneither_ptr _tmp1F2=({const char*_tmpF1="open is only allowed on unique or reference-counted keys";_tag_dyneither(_tmpF1,sizeof(char),57U);});Cyc_Tcutil_terr(_tmp1F3,_tmp1F2,_tag_dyneither(_tmpF0,sizeof(void*),0U));});});
({void*_tmp1F4=Cyc_Absyn_rgn_handle_type(rgn_typ);*_tmpFF=_tmp1F4;});
_tmpE4=Cyc_Tcenv_add_region(_tmpE4,rgn_typ,1);};};}else{
# 582
rgn_typ=(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmpFA=_cycalloc(sizeof(*_tmpFA));_tmpFA->tag=2U,_tmpFA->f1=_tmp11B;_tmpFA;});
_tmpE4=({unsigned int _tmp1F6=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1F5=_tmpE4;Cyc_Tcenv_add_type_vars(_tmp1F6,_tmp1F5,({struct Cyc_List_List*_tmpFB=_cycalloc(sizeof(*_tmpFB));_tmpFB->hd=_tmp11B,_tmpFB->tl=0;_tmpFB;}));});
_tmpE4=Cyc_Tcenv_add_region(_tmpE4,rgn_typ,0);}
# 586
({unsigned int _tmp1F9=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1F8=_tmp96;struct Cyc_List_List*_tmp1F7=Cyc_Tcenv_lookup_type_vars(_tmpE4);Cyc_Tcutil_check_type(_tmp1F9,_tmp1F8,_tmp1F7,& Cyc_Tcutil_bk,1,0,*_tmpFF);});
if(!({void*_tmp1FA=*_tmpFF;Cyc_Tcutil_unify(_tmp1FA,Cyc_Absyn_rgn_handle_type(rgn_typ));}))
({void*_tmpFC=0U;({struct _dyneither_ptr _tmp1FB=({const char*_tmpFD="region stmt: type of region handle is wrong!";_tag_dyneither(_tmpFD,sizeof(char),45U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp1FB,_tag_dyneither(_tmpFC,sizeof(void*),0U));});});
# 590
...
({void*_tmp101=0U;({unsigned int _tmp1FD=_tmp142->loc;struct _dyneither_ptr _tmp1FC=({const char*_tmp102="bad storage class for inner function";_tag_dyneither(_tmp102,sizeof(char),37U);});Cyc_Tcutil_terr(_tmp1FD,_tmp1FC,_tag_dyneither(_tmp101,sizeof(void*),0U));});});
Cyc_Tcutil_check_fndecl_valid_type(_tmp142->loc,_tmp96,_tmp11C);{
void*t=Cyc_Tcutil_fndecl2type(_tmp11C);
({struct Cyc_List_List*_tmp1FE=Cyc_Tcutil_transfer_fn_type_atts(t,_tmp11C->attributes);_tmp11C->attributes=_tmp1FE;});
# 602
...
struct _dyneither_ptr _tmp1FF=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)atts->hd));_tmp15C.f1=_tmp1FF;});_tmp15C;});void*_tmp105[1U];_tmp105[0]=& _tmp107;({unsigned int _tmp201=_tmp142->loc;struct _dyneither_ptr _tmp200=({const char*_tmp106="bad attribute %s for function";_tag_dyneither(_tmp106,sizeof(char),30U);});Cyc_Tcutil_terr(_tmp201,_tmp200,_tag_dyneither(_tmp105,sizeof(void*),1U));});});
goto _LL75;default: _LL7A: _LL7B:
 goto _LL75;}_LL75:;}}{
# 610
struct Cyc_Absyn_Vardecl*vd=({struct Cyc_Absyn_Vardecl*_tmp108=_cycalloc(sizeof(*_tmp108));_tmp108->sc=_tmp11C->sc,_tmp108->name=_tmp11C->name,_tmp108->varloc=0U,({struct Cyc_Absyn_Tqual _tmp206=Cyc_Absyn_const_tqual(0U);_tmp108->tq=_tmp206;}),({
void*_tmp205=({void*_tmp204=t;void*_tmp203=_tmp100;struct Cyc_Absyn_Tqual _tmp202=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp204,_tmp203,_tmp202,Cyc_Absyn_false_type);});_tmp108->type=_tmp205;}),_tmp108->initializer=0,_tmp108->rgn=_tmp100,_tmp108->attributes=0,_tmp108->escapes=0;_tmp108;});
# 614
_tmp11C->fn_vardecl=vd;{
struct Cyc_Tcenv_Fenv*old_fenv=(struct Cyc_Tcenv_Fenv*)_check_null(_tmp96->le);
({struct Cyc_Tcenv_Fenv*_tmp207=Cyc_Tcenv_nested_fenv(_tmp142->loc,old_fenv,_tmp11C);_tmp96->le=_tmp207;});
...
return;};};};}case 9U: _LL2C: _tmp11E=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp98)->f1;_tmp11D=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp98)->f2;_LL2D:
 unimp_msg_part=({const char*_tmp109="namespace";_tag_dyneither(_tmp109,sizeof(char),10U);});goto _LL21;case 10U: _LL2E: _tmp120=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp98)->f1;_tmp11F=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp98)->f2;_LL2F:
...
# 631
 ...
 unimp_msg_part=({const char*_tmp111="__cyclone_port_on__";_tag_dyneither(_tmp111,sizeof(char),20U);});goto _LL21;default: _LL3E: _LL3F:
 unimp_msg_part=({const char*_tmp112="__cyclone_port_off__";_tag_dyneither(_tmp112,sizeof(char),21U);});goto _LL21;}_LL21:;}
# 635
(int)_throw(({struct Cyc_String_pa_PrintArg_struct _tmp123=({struct Cyc_String_pa_PrintArg_struct _tmp15D;_tmp15D.tag=0U,_tmp15D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)unimp_msg_part);_tmp15D;});void*_tmp121[1U];_tmp121[0]=& _tmp123;({struct _dyneither_ptr _tmp208=({const char*_tmp122="tcStmt: nested %s declarations unimplemented";_tag_dyneither(_tmp122,sizeof(char),45U);});((void*(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp208,_tag_dyneither(_tmp121,sizeof(void*),1U));});}));}}_LL0:;}
