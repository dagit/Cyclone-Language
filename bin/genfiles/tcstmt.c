...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpF3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp14E;_tmp14E.tag=0U,({struct _fat_ptr _tmp1C8=({const char*_tmpF8="expected ";_tag_fat(_tmpF8,sizeof(char),10U);});_tmp14E.f1=_tmp1C8;});_tmp14E;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpF4=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp14D;_tmp14D.tag=2U,_tmp14D.f1=(void*)exp_type;_tmp14D;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp14C;_tmp14C.tag=0U,({struct _fat_ptr _tmp1C9=({const char*_tmpF7=" but found ";_tag_fat(_tmpF7,sizeof(char),12U);});_tmp14C.f1=_tmp1C9;});_tmp14C;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpF6=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp14B;_tmp14B.tag=2U,_tmp14B.f1=(void*)key_typ;_tmp14B;});void*_tmpF2[4U];_tmpF2[0]=& _tmpF3,_tmpF2[1]=& _tmpF4,_tmpF2[2]=& _tmpF5,_tmpF2[3]=& _tmpF6;({unsigned _tmp1CA=s0->loc;Cyc_Warn_err2(_tmp1CA,_tag_fat(_tmpF2,sizeof(void*),4U));});});
if(!Cyc_Unify_unify(outer_rgn,Cyc_Absyn_unique_rgn_type)&& !
Cyc_Unify_unify(outer_rgn,Cyc_Absyn_refcnt_rgn_type))
({struct Cyc_Warn_String_Warn_Warg_struct _tmpFA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp14F;_tmp14F.tag=0U,({struct _fat_ptr _tmp1CB=({const char*_tmpFB="open is only allowed on unique or reference-counted keys";_tag_fat(_tmpFB,sizeof(char),57U);});_tmp14F.f1=_tmp1CB;});_tmp14F;});void*_tmpF9[1U];_tmpF9[0]=& _tmpFA;({unsigned _tmp1CC=s0->loc;Cyc_Warn_err2(_tmp1CC,_tag_fat(_tmpF9,sizeof(void*),1U));});});
...
({void*_tmp106=0U;({struct _fat_ptr _tmp1D4=({const char*_tmp107="region stmt: type of region handle is wrong!";_tag_fat(_tmp107,sizeof(char),45U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp1D4,_tag_fat(_tmp106,sizeof(void*),0U));});});
# 488
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp109=({struct Cyc_Warn_String_Warn_Warg_struct _tmp150;_tmp150.tag=0U,({struct _fat_ptr _tmp1D5=({const char*_tmp10A="bad storage class for inner function";_tag_fat(_tmp10A,sizeof(char),37U);});_tmp150.f1=_tmp1D5;});_tmp150;});void*_tmp108[1U];_tmp108[0]=& _tmp109;({unsigned _tmp1D6=d->loc;Cyc_Warn_err2(_tmp1D6,_tag_fat(_tmp108,sizeof(void*),1U));});});
