...
# 35 "/tmp/cyclone/src/attributes.h"
...
te2=({struct Cyc_Tcenv_Tenv*_tmp155=te2;Cyc_Tcenv_add_region(_tmp155,(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp11=_cycalloc(sizeof(*_tmp11));_tmp11->tag=2U,_tmp11->f1=(struct Cyc_Absyn_Tvar*)rgns->hd;_tmp11;}),0,0);});}
...
return res;}
# 102 "/tmp/cyclone/src/tcstmt.cyc"
...
{void*_tmpB9=Cyc_Absyn_compress(t);void*_stmttmp5=_tmpB9;void*_tmpBA=_stmttmp5;struct Cyc_Absyn_ArrayInfo _tmpBB;switch(*((int*)_tmpBA)){case 5U: _LL5A: if(is_local){_LL5B:
# 351
 vd->escapes=1;
sc=3U;
is_local=0;
...
({struct Cyc_List_List*_tmp1DF=Cyc_Atts_transfer_fn_type_atts(t,(fd->i).attributes);(fd->i).attributes=_tmp1DF;});{
