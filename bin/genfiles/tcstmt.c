...
void*_Tmp0=c->pattern->r;switch(*((int*)_Tmp0)){case 0:
 return 1;case 1: if(*((int*)((struct Cyc_Absyn_Pat*)((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_Tmp0)->f2)->r)==0)
return 1;else{goto _LL5;}default: _LL5:
 return 0;};}
# 129 "tcstmt.cyc"
