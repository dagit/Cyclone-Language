...
# 111
void Cyc_Tcpat_check_catch_overlap(unsigned,struct Cyc_Tcenv_Tenv*,struct Cyc_List_List*,void**);struct Cyc_Hashtable_Table;struct Cyc_JumpAnalysis_Jump_Anal_Result{struct Cyc_Hashtable_Table*pop_tables;struct Cyc_Hashtable_Table*succ_tables;struct Cyc_Hashtable_Table*pat_pop_tables;};
# 46 "jump_analysis.h"
...
({void*_tmp3D=0U;({unsigned _tmp16A=where_opt->loc;struct _dyneither_ptr _tmp169=({const char*_tmp3E="cannot show &&-clause in pattern has no effects";_tag_dyneither(_tmp3E,sizeof(char),48U);});Cyc_Tcutil_terr(_tmp16A,_tmp169,_tag_dyneither(_tmp3D,sizeof(void*),0U));});});}
# 162
...
({struct Cyc_String_pa_PrintArg_struct _tmp4B=({struct Cyc_String_pa_PrintArg_struct _tmp14A;_tmp14A.tag=0U,({struct _dyneither_ptr _tmp16E=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp14A.f1=_tmp16E;});_tmp14A;});void*_tmp49[1U];_tmp49[0]=& _tmp4B;({unsigned _tmp170=s0->loc;struct _dyneither_ptr _tmp16F=({const char*_tmp4A="should return a value of type %s";_tag_dyneither(_tmp4A,sizeof(char),33U);});Cyc_Tcutil_warn(_tmp170,_tmp16F,_tag_dyneither(_tmp49,sizeof(void*),1U));});});else{
# 203
({struct Cyc_String_pa_PrintArg_struct _tmp4E=({struct Cyc_String_pa_PrintArg_struct _tmp14B;_tmp14B.tag=0U,({struct _dyneither_ptr _tmp171=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp14B.f1=_tmp171;});_tmp14B;});void*_tmp4C[1U];_tmp4C[0]=& _tmp4E;({unsigned _tmp173=s0->loc;struct _dyneither_ptr _tmp172=({const char*_tmp4D="must return a value of type %s";_tag_dyneither(_tmp4D,sizeof(char),31U);});Cyc_Tcutil_terr(_tmp173,_tmp172,_tag_dyneither(_tmp4C,sizeof(void*),1U));});});}}}else{
# 207
int bogus=0;
...
({void*_tmp5A=0U;({unsigned _tmp183=s0->loc;struct _dyneither_ptr _tmp182=({const char*_tmp5B="fallthru not in a non-last case";_tag_dyneither(_tmp5B,sizeof(char),32U);});Cyc_Tcutil_terr(_tmp183,_tmp182,_tag_dyneither(_tmp5A,sizeof(void*),0U));});});
return;}{
# 254
...
# 266
struct _dyneither_ptr _tmp185=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(((struct Cyc_Absyn_Exp*)_tmp13E->hd)->topt)));_tmp14F.f1=_tmp185;});_tmp14F;});struct Cyc_String_pa_PrintArg_struct _tmp62=({struct Cyc_String_pa_PrintArg_struct _tmp14E;_tmp14E.tag=0U,({struct _dyneither_ptr _tmp186=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_tmp5E->hd));_tmp14E.f1=_tmp186;});_tmp14E;});void*_tmp5F[2U];_tmp5F[0]=& _tmp61,_tmp5F[1]=& _tmp62;({unsigned _tmp188=s0->loc;struct _dyneither_ptr _tmp187=({const char*_tmp60="fallthru argument has type %s but pattern variable has type %s";_tag_dyneither(_tmp60,sizeof(char),63U);});Cyc_Tcutil_terr(_tmp188,_tmp187,_tag_dyneither(_tmp5F,sizeof(void*),2U));});});
Cyc_Tcutil_explain_failure();}
# 270
if(Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_tmp5E->hd)&& !Cyc_Tcutil_is_noalias_path((struct Cyc_Absyn_Exp*)_tmp13E->hd))
({void*_tmp63=0U;({unsigned _tmp18A=((struct Cyc_Absyn_Exp*)_tmp13E->hd)->loc;struct _dyneither_ptr _tmp189=({const char*_tmp64="Cannot consume non-unique paths; do swap instead";_tag_dyneither(_tmp64,sizeof(char),49U);});Cyc_Tcutil_terr(_tmp18A,_tmp189,_tag_dyneither(_tmp63,sizeof(void*),0U));});});}
# 273
if(_tmp13E != 0)
({void*_tmp65=0U;({unsigned _tmp18C=s0->loc;struct _dyneither_ptr _tmp18B=({const char*_tmp66="too many arguments in explicit fallthru";_tag_dyneither(_tmp66,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp18C,_tmp18B,_tag_dyneither(_tmp65,sizeof(void*),0U));});});
if(_tmp5E != 0)
({void*_tmp67=0U;({unsigned _tmp18E=s0->loc;struct _dyneither_ptr _tmp18D=({const char*_tmp68="too few arguments in explicit fallthru";_tag_dyneither(_tmp68,sizeof(char),39U);});Cyc_Tcutil_terr(_tmp18E,_tmp18D,_tag_dyneither(_tmp67,sizeof(void*),0U));});});
...
({void*_tmp76=0U;({unsigned _tmp19F=_tmp6E->loc;struct _dyneither_ptr _tmp19E=({const char*_tmp77="Cannot consume non-unique paths; do swap instead";_tag_dyneither(_tmp77,sizeof(char),49U);});Cyc_Tcutil_terr(_tmp19F,_tmp19E,_tag_dyneither(_tmp76,sizeof(void*),0U));});});{
# 313
...
# 431
({void*_tmpA0=0U;({unsigned _tmp1B7=_tmp148->loc;struct _dyneither_ptr _tmp1B6=({const char*_tmpA1="bad abstract scope for local variable";_tag_dyneither(_tmpA1,sizeof(char),38U);});Cyc_Tcutil_terr(_tmp1B7,_tmp1B6,_tag_dyneither(_tmpA0,sizeof(void*),0U));});});
...
({void*_tmpB3=0U;({unsigned _tmp1CA=_tmp148->loc;struct _dyneither_ptr _tmp1C9=({const char*_tmpB4="extern declarations are not yet supported within functions";_tag_dyneither(_tmpB4,sizeof(char),59U);});Cyc_Tcutil_terr(_tmp1CA,_tmp1C9,_tag_dyneither(_tmpB3,sizeof(void*),0U));});});
if(_tmpCB != 0){
Cyc_Tcexp_tcExpInitializer(_tmpB2,& _tmpCC,_tmpCB);
# 484
if(!is_local && !Cyc_Tcutil_is_const_exp(_tmpCB))
({void*_tmpB5=0U;({unsigned _tmp1CC=_tmp148->loc;struct _dyneither_ptr _tmp1CB=({const char*_tmpB6="initializer for static variable needs to be a constant expression";_tag_dyneither(_tmpB6,sizeof(char),66U);});Cyc_Tcutil_terr(_tmp1CC,_tmp1CB,_tag_dyneither(_tmpB5,sizeof(void*),0U));});});
...
*_tmpE4=_tmpE0;
({unsigned _tmp1E3=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1E2=_tmpE1;struct Cyc_List_List*_tmp1E1=Cyc_Tcenv_lookup_type_vars(_tmpE1);Cyc_Tcutil_check_type(_tmp1E3,_tmp1E2,_tmp1E1,& Cyc_Tcutil_tmk,1,1,_tmpE5);});}
# 560
...
# 584
({unsigned _tmp1F3=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1F2=_tmp9A;struct Cyc_List_List*_tmp1F1=Cyc_Tcenv_lookup_type_vars(_tmp9A);Cyc_Tcutil_check_type(_tmp1F3,_tmp1F2,_tmp1F1,& Cyc_Tcutil_tmk,1,0,_tmpEE);});{
...
# 600
({unsigned _tmp1FF=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1FE=_tmp9A;struct Cyc_List_List*_tmp1FD=Cyc_Tcenv_lookup_type_vars(_tmpE8);Cyc_Tcutil_check_type(_tmp1FF,_tmp1FE,_tmp1FD,& Cyc_Tcutil_bk,1,0,*_tmp103);});
...
({void*_tmp105=0U;({unsigned _tmp203=_tmp148->loc;struct _dyneither_ptr _tmp202=({const char*_tmp106="bad storage class for inner function";_tag_dyneither(_tmp106,sizeof(char),37U);});Cyc_Tcutil_terr(_tmp203,_tmp202,_tag_dyneither(_tmp105,sizeof(void*),0U));});});
# 613
...
struct _dyneither_ptr _tmp204=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)atts->hd));_tmp162.f1=_tmp204;});_tmp162;});void*_tmp109[1U];_tmp109[0]=& _tmp10B;({unsigned _tmp206=_tmp148->loc;struct _dyneither_ptr _tmp205=({const char*_tmp10A="bad attribute %s for function";_tag_dyneither(_tmp10A,sizeof(char),30U);});Cyc_Tcutil_terr(_tmp206,_tmp205,_tag_dyneither(_tmp109,sizeof(void*),1U));});});
