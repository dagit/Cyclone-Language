...
Cyc_Tcutil_check_type(s0->loc,_tmpB8,_tmpFD,& Cyc_Tcutil_tmk,_tmpFE,_tmpDD);
...
Cyc_Tcutil_check_type(s0->loc,_tmpB8,Cyc_Tcenv_lookup_type_vars(_tmpB8),& Cyc_Tcutil_tmk,1,_tmp13F);{
...
Cyc_Tcutil_check_type(s0->loc,_tmpB8,Cyc_Tcenv_lookup_type_vars(_tmp137),& Cyc_Tcutil_bk,1,*_tmp139);
