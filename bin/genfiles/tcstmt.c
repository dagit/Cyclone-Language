...
({void*_tmp154=(void*)({struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp4=_cycalloc(sizeof(*_tmp4));_tmp4->tag=5U,_tmp4->f1=e1,_tmp4->f2=Cyc_Absyn_PreInc;_tmp4;});e->r=_tmp154;});goto _LL0;}case Cyc_Absyn_PostDec: _LL3: _tmp2=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp1)->f1;_LL4: {struct Cyc_Absyn_Exp*e1=_tmp2;
({void*_tmp155=(void*)({struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp5=_cycalloc(sizeof(*_tmp5));_tmp5->tag=5U,_tmp5->f1=e1,_tmp5->f2=Cyc_Absyn_PreDec;_tmp5;});e->r=_tmp155;});goto _LL0;}default: goto _LL5;}else{_LL5: _LL6:
 goto _LL0;}_LL0:;}
# 48
static struct _tuple2*Cyc_Tcstmt_stmt_temp_var (void){
static int counter=0;
return({struct _tuple2*_tmpA=_cycalloc(sizeof(*_tmpA));_tmpA->f1=Cyc_Absyn_Loc_n,({struct _fat_ptr*_tmp158=({struct _fat_ptr*_tmp9=_cycalloc(sizeof(*_tmp9));({struct _fat_ptr _tmp157=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp8=({struct Cyc_Int_pa_PrintArg_struct _tmp125;_tmp125.tag=1U,_tmp125.f1=(unsigned)counter ++;_tmp125;});void*_tmp6[1U];_tmp6[0]=& _tmp8;({struct _fat_ptr _tmp156=({const char*_tmp7="_stmttmp%X";_tag_fat(_tmp7,sizeof(char),11U);});Cyc_aprintf(_tmp156,_tag_fat(_tmp6,sizeof(void*),1U));});});*_tmp9=_tmp157;});_tmp9;});_tmpA->f2=_tmp158;});_tmpA;});}
# 55
...
struct Cyc_Absyn_Decl*_tmp12=({struct Cyc_Absyn_Pat*_tmp15D=({void*_tmp15B=(void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp14=_cycalloc(sizeof(*_tmp14));_tmp14->tag=1U,_tmp14->f1=vd,({struct Cyc_Absyn_Pat*_tmp15A=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,e->loc);_tmp14->f2=_tmp15A;});_tmp14;});Cyc_Absyn_new_pat(_tmp15B,e->loc);});struct Cyc_Absyn_Exp*_tmp15C=e;Cyc_Absyn_let_decl(_tmp15D,_tmp15C,s0->loc);});struct Cyc_Absyn_Decl*d=_tmp12;
# 69
...
({struct Cyc_Absyn_Exp*_tmp162=({void*_tmp161=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp13=_cycalloc(sizeof(*_tmp13));_tmp13->tag=4U,_tmp13->f1=vd;_tmp13;});Cyc_Absyn_varb_exp(_tmp161,e->loc);});*eptr=_tmp162;});
...
te=({struct Cyc_Tcenv_Tenv*_tmp163=te;Cyc_Tcenv_add_region(_tmp163,(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp1C=_cycalloc(sizeof(*_tmp1C));_tmp1C->tag=2U,_tmp1C->f1=(struct Cyc_Absyn_Tvar*)rgns->hd;_tmp1C;}),0,0);});}
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp20=({struct Cyc_Warn_String_Warn_Warg_struct _tmp126;_tmp126.tag=0U,({struct _fat_ptr _tmp166=({const char*_tmp21="cannot show &&-clause in pattern has no effects";_tag_fat(_tmp21,sizeof(char),48U);});_tmp126.f1=_tmp166;});_tmp126;});void*_tmp1F[1U];_tmp1F[0]=& _tmp20;({unsigned _tmp167=where_opt->loc;Cyc_Warn_err2(_tmp167,_tag_fat(_tmp1F,sizeof(void*),1U));});});}
# 98
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp46=({struct Cyc_Warn_String_Warn_Warg_struct _tmp128;_tmp128.tag=0U,({struct _fat_ptr _tmp168=({const char*_tmp48="should return a value of type ";_tag_fat(_tmp48,sizeof(char),31U);});_tmp128.f1=_tmp168;});_tmp128;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp47=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp127;_tmp127.tag=2U,_tmp127.f1=(void*)t;_tmp127;});void*_tmp45[2U];_tmp45[0]=& _tmp46,_tmp45[1]=& _tmp47;({unsigned _tmp169=s0->loc;Cyc_Warn_warn2(_tmp169,_tag_fat(_tmp45,sizeof(void*),2U));});});else{
# 140
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp12A;_tmp12A.tag=0U,({struct _fat_ptr _tmp16A=({const char*_tmp4C="must return a value of type ";_tag_fat(_tmp4C,sizeof(char),29U);});_tmp12A.f1=_tmp16A;});_tmp12A;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4B=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp129;_tmp129.tag=2U,_tmp129.f1=(void*)t;_tmp129;});void*_tmp49[2U];_tmp49[0]=& _tmp4A,_tmp49[1]=& _tmp4B;({unsigned _tmp16B=s0->loc;Cyc_Warn_err2(_tmp16B,_tag_fat(_tmp49,sizeof(void*),2U));});});}}
# 142
return;}
# 145
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp12E;_tmp12E.tag=0U,({struct _fat_ptr _tmp16E=({const char*_tmp53="returns value of type ";_tag_fat(_tmp53,sizeof(char),23U);});_tmp12E.f1=_tmp16E;});_tmp12E;});struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp4F=({struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp12D;_tmp12D.tag=3U,_tmp12D.f1=(void*)eopt->topt;_tmp12D;});struct Cyc_Warn_String_Warn_Warg_struct _tmp50=({struct Cyc_Warn_String_Warn_Warg_struct _tmp12C;_tmp12C.tag=0U,({struct _fat_ptr _tmp16F=({const char*_tmp52=" but requires ";_tag_fat(_tmp52,sizeof(char),15U);});_tmp12C.f1=_tmp16F;});_tmp12C;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp51=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp12B;_tmp12B.tag=2U,_tmp12B.f1=(void*)t;_tmp12B;});void*_tmp4D[4U];_tmp4D[0]=& _tmp4E,_tmp4D[1]=& _tmp4F,_tmp4D[2]=& _tmp50,_tmp4D[3]=& _tmp51;({unsigned _tmp170=s0->loc;Cyc_Warn_err2(_tmp170,_tag_fat(_tmp4D,sizeof(void*),4U));});});
...
# 184
struct Cyc_Absyn_Tvar*_tmp58=({struct Cyc_Absyn_Tvar*_tmp5D=_cycalloc(sizeof(*_tmp5D));({struct _fat_ptr*_tmp17D=({struct _fat_ptr*_tmp5C=_cycalloc(sizeof(*_tmp5C));({struct _fat_ptr _tmp17C=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp5B=({struct Cyc_String_pa_PrintArg_struct _tmp12F;_tmp12F.tag=0U,_tmp12F.f1=(struct _fat_ptr)((struct _fat_ptr)*l);_tmp12F;});void*_tmp59[1U];_tmp59[0]=& _tmp5B;({struct _fat_ptr _tmp17B=({const char*_tmp5A="`%s";_tag_fat(_tmp5A,sizeof(char),4U);});Cyc_aprintf(_tmp17B,_tag_fat(_tmp59,sizeof(void*),1U));});});*_tmp5C=_tmp17C;});_tmp5C;});_tmp5D->name=_tmp17D;}),({
int _tmp17A=Cyc_Tcutil_new_tvar_id();_tmp5D->identity=_tmp17A;}),({void*_tmp179=Cyc_Tcutil_kind_to_bound(& Cyc_Tcutil_rk);_tmp5D->kind=_tmp179;});_tmp5D;});
# 184
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp60=({struct Cyc_Warn_String_Warn_Warg_struct _tmp130;_tmp130.tag=0U,({struct _fat_ptr _tmp17F=({const char*_tmp61="fallthru not in a non-last case";_tag_fat(_tmp61,sizeof(char),32U);});_tmp130.f1=_tmp17F;});_tmp130;});void*_tmp5F[1U];_tmp5F[0]=& _tmp60;({unsigned _tmp180=s0->loc;Cyc_Warn_err2(_tmp180,_tag_fat(_tmp5F,sizeof(void*),1U));});});
return;}{
# 195
...
struct Cyc_List_List*_tmp66=({struct Cyc_List_List*_tmp181=Cyc_Tcenv_lookup_type_vars(te);((struct Cyc_List_List*(*)(struct _tuple13*(*f)(struct Cyc_List_List*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcutil_make_inst_var,_tmp181,tvs);});struct Cyc_List_List*instantiation=_tmp66;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp69=({struct Cyc_Warn_String_Warn_Warg_struct _tmp134;_tmp134.tag=0U,({struct _fat_ptr _tmp184=({const char*_tmp6E="fallthru argument has type ";_tag_fat(_tmp6E,sizeof(char),28U);});_tmp134.f1=_tmp184;});_tmp134;});struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp6A=({struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp133;_tmp133.tag=3U,_tmp133.f1=(void*)((struct Cyc_Absyn_Exp*)es->hd)->topt;_tmp133;});struct Cyc_Warn_String_Warn_Warg_struct _tmp6B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp132;_tmp132.tag=0U,({
struct _fat_ptr _tmp185=({const char*_tmp6D="but pattern variable has type ";_tag_fat(_tmp6D,sizeof(char),31U);});_tmp132.f1=_tmp185;});_tmp132;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp6C=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp131;_tmp131.tag=2U,_tmp131.f1=(void*)ts->hd;_tmp131;});void*_tmp68[4U];_tmp68[0]=& _tmp69,_tmp68[1]=& _tmp6A,_tmp68[2]=& _tmp6B,_tmp68[3]=& _tmp6C;({unsigned _tmp186=s0->loc;Cyc_Warn_err2(_tmp186,_tag_fat(_tmp68,sizeof(void*),4U));});});
Cyc_Unify_explain_failure();}
# 207
Cyc_Tcexp_check_consume(((struct Cyc_Absyn_Exp*)es->hd)->loc,(void*)ts->hd,(struct Cyc_Absyn_Exp*)es->hd);}
# 209
if(es != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp70=({struct Cyc_Warn_String_Warn_Warg_struct _tmp135;_tmp135.tag=0U,({struct _fat_ptr _tmp187=({const char*_tmp71="too many arguments in explicit fallthru";_tag_fat(_tmp71,sizeof(char),40U);});_tmp135.f1=_tmp187;});_tmp135;});void*_tmp6F[1U];_tmp6F[0]=& _tmp70;({unsigned _tmp188=s0->loc;Cyc_Warn_err2(_tmp188,_tag_fat(_tmp6F,sizeof(void*),1U));});});
if(ts != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp73=({struct Cyc_Warn_String_Warn_Warg_struct _tmp136;_tmp136.tag=0U,({struct _fat_ptr _tmp189=({const char*_tmp74="too few arguments in explicit fallthru";_tag_fat(_tmp74,sizeof(char),39U);});_tmp136.f1=_tmp189;});_tmp136;});void*_tmp72[1U];_tmp72[0]=& _tmp73;({unsigned _tmp18A=s0->loc;Cyc_Warn_err2(_tmp18A,_tag_fat(_tmp72,sizeof(void*),1U));});});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp7D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp13A;_tmp13A.tag=0U,({
struct _fat_ptr _tmp18C=({const char*_tmp82="switch on type ";_tag_fat(_tmp82,sizeof(char),16U);});_tmp13A.f1=_tmp18C;});_tmp13A;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp7E=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp139;_tmp139.tag=2U,_tmp139.f1=(void*)t;_tmp139;});struct Cyc_Warn_String_Warn_Warg_struct _tmp7F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp138;_tmp138.tag=0U,({struct _fat_ptr _tmp18D=({const char*_tmp81=" but case expects type ";_tag_fat(_tmp81,sizeof(char),24U);});_tmp138.f1=_tmp18D;});_tmp138;});struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp80=({struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp137;_tmp137.tag=3U,_tmp137.f1=(void*)p->topt;_tmp137;});void*_tmp7C[4U];_tmp7C[0]=& _tmp7D,_tmp7C[1]=& _tmp7E,_tmp7C[2]=& _tmp7F,_tmp7C[3]=& _tmp80;({unsigned _tmp18E=((struct Cyc_Absyn_Switch_clause*)scs->hd)->loc;Cyc_Warn_err2(_tmp18E,_tag_fat(_tmp7C,sizeof(void*),4U));});});
...
# 274
({void*_tmp193=({void*_tmp192=(void*)({struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmp84=_cycalloc(sizeof(*_tmp84));_tmp84->tag=2U,({struct Cyc_Absyn_Stmt*_tmp191=Cyc_Absyn_new_stmt(s->r,s->loc);_tmp84->f1=_tmp191;}),({struct Cyc_Absyn_Stmt*_tmp190=Cyc_Absyn_skip_stmt(s->loc);_tmp84->f2=_tmp190;});_tmp84;});Cyc_Absyn_new_stmt(_tmp192,s->loc);})->r;s->r=_tmp193;});
# 276
Cyc_Tcstmt_tcStmt(te,s,1);
# 278
...
struct Cyc_Absyn_Pat*_tmp86=Cyc_Absyn_new_pat((void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp8D=_cycalloc(sizeof(*_tmp8D));_tmp8D->tag=1U,_tmp8D->f1=vd,({struct Cyc_Absyn_Pat*_tmp196=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0U);_tmp8D->f2=_tmp196;});_tmp8D;}),0U);struct Cyc_Absyn_Pat*def_pat=_tmp86;
struct Cyc_Absyn_Stmt*_tmp87=
Cyc_Absyn_exp_stmt(Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_tmp8C=_cycalloc(sizeof(*_tmp8C));_tmp8C->tag=11U,({struct Cyc_Absyn_Exp*_tmp197=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp8B=_cycalloc(sizeof(*_tmp8B));_tmp8B->tag=4U,_tmp8B->f1=vd;_tmp8B;}),0U);_tmp8C->f1=_tmp197;}),_tmp8C->f2=1;_tmp8C;}),0U),0U);
# 283
...
({struct Cyc_List_List*_tmp199=({struct Cyc_List_List*_tmp198=*scs0;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp198,({struct Cyc_Absyn_Switch_clause*_tmp89[1U];_tmp89[0]=def_clause;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp89,sizeof(struct Cyc_Absyn_Switch_clause*),1U));}));});*scs0=_tmp199;});}{
# 292
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp98=({struct Cyc_Warn_String_Warn_Warg_struct _tmp13E;_tmp13E.tag=0U,({struct _fat_ptr _tmp19B=({const char*_tmp9D="switch on type ";_tag_fat(_tmp9D,sizeof(char),16U);});_tmp13E.f1=_tmp19B;});_tmp13E;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp99=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp13D;_tmp13D.tag=2U,_tmp13D.f1=(void*)exception_type;_tmp13D;});struct Cyc_Warn_String_Warn_Warg_struct _tmp9A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp13C;_tmp13C.tag=0U,({
struct _fat_ptr _tmp19C=({const char*_tmp9C=" but case expects type ";_tag_fat(_tmp9C,sizeof(char),24U);});_tmp13C.f1=_tmp19C;});_tmp13C;});struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp9B=({struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp13B;_tmp13B.tag=3U,_tmp13B.f1=(void*)p->topt;_tmp13B;});void*_tmp97[4U];_tmp97[0]=& _tmp98,_tmp97[1]=& _tmp99,_tmp97[2]=& _tmp9A,_tmp97[3]=& _tmp9B;({unsigned _tmp19D=((struct Cyc_Absyn_Switch_clause*)scs->hd)->loc;Cyc_Warn_err2(_tmp19D,_tag_fat(_tmp97,sizeof(void*),4U));});});
Cyc_Unify_explain_failure();}else{
# 324
Cyc_Tcpat_check_pat_regions(te,p,this_pattern.patvars);}
# 326
...
# 346
({struct Cyc_Warn_String_Warn_Warg_struct _tmpB9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp13F;_tmp13F.tag=0U,({struct _fat_ptr _tmp19F=({const char*_tmpBA="bad abstract scope for local variable";_tag_fat(_tmpBA,sizeof(char),38U);});_tmp13F.f1=_tmp19F;});_tmp13F;});void*_tmpB8[1U];_tmpB8[0]=& _tmpB9;({unsigned _tmp1A0=d->loc;Cyc_Warn_err2(_tmp1A0,_tag_fat(_tmpB8,sizeof(void*),1U));});});
...
# 375
ai.num_elts=len;
t=({void*_tmp1A1=(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmpC6=_cycalloc(sizeof(*_tmpC6));_tmpC6->tag=4U,_tmpC6->f1=ai;_tmpC6;});vd->type=_tmp1A1;});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpCA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp140;_tmp140.tag=0U,({struct _fat_ptr _tmp1A3=({const char*_tmpCB="extern declarations are not yet supported within functions";_tag_fat(_tmpCB,sizeof(char),59U);});_tmp140.f1=_tmp1A3;});_tmp140;});void*_tmpC9[1U];_tmpC9[0]=& _tmpCA;({unsigned _tmp1A4=d->loc;Cyc_Warn_err2(_tmp1A4,_tag_fat(_tmpC9,sizeof(void*),1U));});});
if(initializer != 0){
Cyc_Tcexp_tcExpInitializer(te,& t,initializer);
# 393
if(!is_local && !Cyc_Tcutil_is_const_exp(initializer))
({struct Cyc_Warn_String_Warn_Warg_struct _tmpCD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp141;_tmp141.tag=0U,({struct _fat_ptr _tmp1A5=({const char*_tmpCE="initializer for static variable needs to be a constant expression";_tag_fat(_tmpCE,sizeof(char),66U);});_tmp141.f1=_tmp1A5;});_tmp141;});void*_tmpCC[1U];_tmpCC[0]=& _tmpCD;({unsigned _tmp1A6=d->loc;Cyc_Warn_err2(_tmp1A6,_tag_fat(_tmpCC,sizeof(void*),1U));});});
...
({struct Cyc_Warn_Vardecl_Warn_Warg_struct _tmpD0=({struct Cyc_Warn_Vardecl_Warn_Warg_struct _tmp146;_tmp146.tag=11U,_tmp146.f1=vd;_tmp146;});struct Cyc_Warn_String_Warn_Warg_struct _tmpD1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp145;_tmp145.tag=0U,({struct _fat_ptr _tmp1A9=({const char*_tmpD6=" was declared with type ";_tag_fat(_tmpD6,sizeof(char),25U);});_tmp145.f1=_tmp1A9;});_tmp145;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpD2=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp144;_tmp144.tag=2U,_tmp144.f1=(void*)t;_tmp144;});struct Cyc_Warn_String_Warn_Warg_struct _tmpD3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp143;_tmp143.tag=0U,({
struct _fat_ptr _tmp1AA=({const char*_tmpD5=" but initialized with type ";_tag_fat(_tmpD5,sizeof(char),28U);});_tmp143.f1=_tmp1AA;});_tmp143;});struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmpD4=({struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp142;_tmp142.tag=3U,_tmp142.f1=(void*)initializer->topt;_tmp142;});void*_tmpCF[5U];_tmpCF[0]=& _tmpD0,_tmpCF[1]=& _tmpD1,_tmpCF[2]=& _tmpD2,_tmpCF[3]=& _tmpD3,_tmpCF[4]=& _tmpD4;({unsigned _tmp1AB=d->loc;Cyc_Warn_err2(_tmp1AB,_tag_fat(_tmpCF,sizeof(void*),5U));});});
...
# 407
{void*_tmpD7=p->r;void*_stmttmp8=_tmpD7;void*_tmpD8=_stmttmp8;switch(*((int*)_tmpD8)){case 1U: _LL70: _LL71:
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpDF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp14A;_tmp14A.tag=0U,({
struct _fat_ptr _tmp1AF=({const char*_tmpE4="pattern type ";_tag_fat(_tmpE4,sizeof(char),14U);});_tmp14A.f1=_tmp1AF;});_tmp14A;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpE0=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp149;_tmp149.tag=2U,_tmp149.f1=(void*)pt;_tmp149;});struct Cyc_Warn_String_Warn_Warg_struct _tmpE1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp148;_tmp148.tag=0U,({struct _fat_ptr _tmp1B0=({const char*_tmpE3=" does not match definition type ";_tag_fat(_tmpE3,sizeof(char),33U);});_tmp148.f1=_tmp1B0;});_tmp148;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpE2=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp147;_tmp147.tag=2U,_tmp147.f1=(void*)et;_tmp147;});void*_tmpDE[4U];_tmpDE[0]=& _tmpDF,_tmpDE[1]=& _tmpE0,_tmpDE[2]=& _tmpE1,_tmpDE[3]=& _tmpE2;({unsigned _tmp1B1=d->loc;Cyc_Warn_err2(_tmp1B1,_tag_fat(_tmpDE,sizeof(void*),4U));});});
...
({unsigned _tmp1B4=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1B3=te;struct Cyc_List_List*_tmp1B2=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tctyp_check_type(_tmp1B4,_tmp1B3,_tmp1B2,& Cyc_Tcutil_tmk,1,1,((struct Cyc_Absyn_Vardecl*)vds->hd)->type);});}
# 446
Cyc_Tcstmt_tcStmt(te,s,0);
...
# 462
struct _tuple2*_tmpEC=({struct _tuple2*_tmp103=_cycalloc(sizeof(*_tmp103));({union Cyc_Absyn_Nmspace _tmp1BD=Cyc_Absyn_Abs_n(({struct _fat_ptr*_tmpFE[1U];({struct _fat_ptr*_tmp1BC=({struct _fat_ptr*_tmp100=_cycalloc(sizeof(*_tmp100));({struct _fat_ptr _tmp1BB=({const char*_tmpFF="Core";_tag_fat(_tmpFF,sizeof(char),5U);});*_tmp100=_tmp1BB;});_tmp100;});_tmpFE[0]=_tmp1BC;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmpFE,sizeof(struct _fat_ptr*),1U));}),0);_tmp103->f1=_tmp1BD;}),({struct _fat_ptr*_tmp1BA=({struct _fat_ptr*_tmp102=_cycalloc(sizeof(*_tmp102));({struct _fat_ptr _tmp1B9=({const char*_tmp101="DynamicRegion";_tag_fat(_tmp101,sizeof(char),14U);});*_tmp102=_tmp1B9;});_tmp102;});_tmp103->f2=_tmp1BA;});_tmp103;});struct _tuple2*drname=_tmpEC;
void*_tmpED=Cyc_Absyn_new_evar(({struct Cyc_Core_Opt*_tmpFD=_cycalloc(sizeof(*_tmpFD));_tmpFD->v=& Cyc_Tcutil_trk;_tmpFD;}),0);void*outer_rgn=_tmpED;
rgn_typ=Cyc_Absyn_new_evar(({struct Cyc_Core_Opt*_tmpEE=_cycalloc(sizeof(*_tmpEE));_tmpEE->v=& Cyc_Tcutil_rk;_tmpEE;}),0);{
void*_tmpEF=({union Cyc_Absyn_AggrInfo _tmp1BE=Cyc_Absyn_UnknownAggr(Cyc_Absyn_StructA,drname,0);Cyc_Absyn_aggr_type(_tmp1BE,({void*_tmpFC[1U];_tmpFC[0]=rgn_typ;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmpFC,sizeof(void*),1U));}));});void*dr_type=_tmpEF;
void*_tmpF0=({void*_tmp1C1=dr_type;void*_tmp1C0=outer_rgn;struct Cyc_Absyn_Tqual _tmp1BF=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp1C1,_tmp1C0,_tmp1BF,Cyc_Absyn_false_type);});void*exp_type=_tmpF0;
({unsigned _tmp1C4=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1C3=te;struct Cyc_List_List*_tmp1C2=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tctyp_check_type(_tmp1C4,_tmp1C3,_tmp1C2,& Cyc_Tcutil_tmk,1,0,exp_type);});{
# 469
void*_tmpF1=Cyc_Tcexp_tcExp(te,& exp_type,open_exp_opt);void*key_typ=_tmpF1;
if(!Cyc_Unify_unify(exp_type,key_typ)&& !({
struct Cyc_RgnOrder_RgnPO*_tmp1C6=Cyc_Tcenv_curr_rgnpo(te);struct Cyc_Absyn_Exp*_tmp1C5=open_exp_opt;Cyc_Tcutil_coerce_assign(_tmp1C6,_tmp1C5,exp_type);}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmpF3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp14E;_tmp14E.tag=0U,({struct _fat_ptr _tmp1C7=({const char*_tmpF8="expected ";_tag_fat(_tmpF8,sizeof(char),10U);});_tmp14E.f1=_tmp1C7;});_tmp14E;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpF4=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp14D;_tmp14D.tag=2U,_tmp14D.f1=(void*)exp_type;_tmp14D;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp14C;_tmp14C.tag=0U,({struct _fat_ptr _tmp1C8=({const char*_tmpF7=" but found ";_tag_fat(_tmpF7,sizeof(char),12U);});_tmp14C.f1=_tmp1C8;});_tmp14C;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpF6=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp14B;_tmp14B.tag=2U,_tmp14B.f1=(void*)key_typ;_tmp14B;});void*_tmpF2[4U];_tmpF2[0]=& _tmpF3,_tmpF2[1]=& _tmpF4,_tmpF2[2]=& _tmpF5,_tmpF2[3]=& _tmpF6;({unsigned _tmp1C9=s0->loc;Cyc_Warn_err2(_tmp1C9,_tag_fat(_tmpF2,sizeof(void*),4U));});});
if(!Cyc_Unify_unify(outer_rgn,Cyc_Absyn_unique_rgn_type)&& !
Cyc_Unify_unify(outer_rgn,Cyc_Absyn_refcnt_rgn_type))
({struct Cyc_Warn_String_Warn_Warg_struct _tmpFA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp14F;_tmp14F.tag=0U,({struct _fat_ptr _tmp1CA=({const char*_tmpFB="open is only allowed on unique or reference-counted keys";_tag_fat(_tmpFB,sizeof(char),57U);});_tmp14F.f1=_tmp1CA;});_tmp14F;});void*_tmpF9[1U];_tmpF9[0]=& _tmpFA;({unsigned _tmp1CB=s0->loc;Cyc_Warn_err2(_tmp1CB,_tag_fat(_tmpF9,sizeof(void*),1U));});});
({void*_tmp1CC=Cyc_Absyn_rgn_handle_type(rgn_typ);*t=_tmp1CC;});
...
te2=({unsigned _tmp1CE=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1CD=te2;Cyc_Tcenv_add_type_vars(_tmp1CE,_tmp1CD,({struct Cyc_List_List*_tmp105=_cycalloc(sizeof(*_tmp105));_tmp105->hd=tv,_tmp105->tl=0;_tmp105;}));});
te2=Cyc_Tcenv_add_region(te2,rgn_typ,0,1);}
# 483
({unsigned _tmp1D1=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1D0=te;struct Cyc_List_List*_tmp1CF=Cyc_Tcenv_lookup_type_vars(te2);Cyc_Tctyp_check_type(_tmp1D1,_tmp1D0,_tmp1CF,& Cyc_Tcutil_bk,1,0,*t);});
if(!({void*_tmp1D2=*t;Cyc_Unify_unify(_tmp1D2,Cyc_Absyn_rgn_handle_type(rgn_typ));}))
({void*_tmp106=0U;({struct _fat_ptr _tmp1D3=({const char*_tmp107="region stmt: type of region handle is wrong!";_tag_fat(_tmp107,sizeof(char),45U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp1D3,_tag_fat(_tmp106,sizeof(void*),0U));});});
# 487
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp109=({struct Cyc_Warn_String_Warn_Warg_struct _tmp150;_tmp150.tag=0U,({struct _fat_ptr _tmp1D4=({const char*_tmp10A="bad storage class for inner function";_tag_fat(_tmp10A,sizeof(char),37U);});_tmp150.f1=_tmp1D4;});_tmp150;});void*_tmp108[1U];_tmp108[0]=& _tmp109;({unsigned _tmp1D5=d->loc;Cyc_Warn_err2(_tmp1D5,_tag_fat(_tmp108,sizeof(void*),1U));});});
...
({struct Cyc_List_List*_tmp1D6=Cyc_Atts_transfer_fn_type_atts(t,(fd->i).attributes);(fd->i).attributes=_tmp1D6;});{
void*_tmp10B=Cyc_Tcenv_curr_rgn(te);void*curr_bl=_tmp10B;
struct Cyc_Absyn_Vardecl*vd=({struct Cyc_Absyn_Vardecl*_tmp10C=_cycalloc(sizeof(*_tmp10C));_tmp10C->sc=fd->sc,_tmp10C->name=fd->name,_tmp10C->varloc=0U,({struct Cyc_Absyn_Tqual _tmp1DB=Cyc_Absyn_const_tqual(0U);_tmp10C->tq=_tmp1DB;}),({
void*_tmp1DA=({void*_tmp1D9=t;void*_tmp1D8=curr_bl;struct Cyc_Absyn_Tqual _tmp1D7=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp1D9,_tmp1D8,_tmp1D7,Cyc_Absyn_false_type);});_tmp10C->type=_tmp1DA;}),_tmp10C->initializer=0,_tmp10C->rgn=curr_bl,_tmp10C->attributes=0,_tmp10C->escapes=0,_tmp10C->is_proto=fd->body != 0;_tmp10C;});
# 503
fd->fn_vardecl=vd;{
struct Cyc_Tcenv_Fenv*old_fenv=(struct Cyc_Tcenv_Fenv*)_check_null(te->le);
({struct Cyc_Tcenv_Fenv*_tmp1DC=Cyc_Tcenv_nested_fenv(d->loc,old_fenv,fd);te->le=_tmp1DC;});
...
unimp_msg_part=({const char*_tmp10D="namespace";_tag_fat(_tmp10D,sizeof(char),10U);});goto _LL24;}case 10U: _LL31: _tmpA2=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmpA1)->f1;_tmpA3=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmpA1)->f2;_LL32: {struct _tuple2*q=_tmpA2;struct Cyc_List_List*tds=_tmpA3;
unimp_msg_part=({const char*_tmp10E="using";_tag_fat(_tmp10E,sizeof(char),6U);});goto _LL24;}case 5U: _LL33: _LL34:
 unimp_msg_part=({const char*_tmp10F="type";_tag_fat(_tmp10F,sizeof(char),5U);});goto _LL24;case 6U: _LL35: _LL36:
 unimp_msg_part=({const char*_tmp110="datatype";_tag_fat(_tmp110,sizeof(char),9U);});goto _LL24;case 7U: _LL37: _LL38:
 unimp_msg_part=({const char*_tmp111="enum";_tag_fat(_tmp111,sizeof(char),5U);});goto _LL24;case 8U: _LL39: _LL3A:
 unimp_msg_part=({const char*_tmp112="typedef";_tag_fat(_tmp112,sizeof(char),8U);});goto _LL24;case 11U: _LL3B: _LL3C:
 unimp_msg_part=({const char*_tmp113="extern \"C\"";_tag_fat(_tmp113,sizeof(char),11U);});goto _LL24;case 12U: _LL3D: _LL3E:
 unimp_msg_part=({const char*_tmp114="extern \"C include\"";_tag_fat(_tmp114,sizeof(char),19U);});goto _LL24;case 13U: _LL3F: _LL40:
 unimp_msg_part=({const char*_tmp115="__cyclone_port_on__";_tag_fat(_tmp115,sizeof(char),20U);});goto _LL24;case 14U: _LL41: _LL42:
 unimp_msg_part=({const char*_tmp116="__cyclone_port_off__";_tag_fat(_tmp116,sizeof(char),21U);});goto _LL24;case 15U: _LL43: _LL44:
 unimp_msg_part=({const char*_tmp117="__tempest_on__";_tag_fat(_tmp117,sizeof(char),15U);});goto _LL24;default: _LL45: _LL46:
 unimp_msg_part=({const char*_tmp118="__tempest_off__";_tag_fat(_tmp118,sizeof(char),16U);});goto _LL24;}_LL24:;}
# 525
({struct Cyc_Warn_String_Warn_Warg_struct _tmp11A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp153;_tmp153.tag=0U,({struct _fat_ptr _tmp1DD=({const char*_tmp11E="tcStmt: nested ";_tag_fat(_tmp11E,sizeof(char),16U);});_tmp153.f1=_tmp1DD;});_tmp153;});struct Cyc_Warn_String_Warn_Warg_struct _tmp11B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp152;_tmp152.tag=0U,_tmp152.f1=unimp_msg_part;_tmp152;});struct Cyc_Warn_String_Warn_Warg_struct _tmp11C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp151;_tmp151.tag=0U,({struct _fat_ptr _tmp1DE=({const char*_tmp11D=" declarations not allowed";_tag_fat(_tmp11D,sizeof(char),26U);});_tmp151.f1=_tmp1DE;});_tmp151;});void*_tmp119[3U];_tmp119[0]=& _tmp11A,_tmp119[1]=& _tmp11B,_tmp119[2]=& _tmp11C;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp119,sizeof(void*),3U));});}}_LL0:;}
# 532
static int Cyc_Tcstmt_ensures_no_throws_exp(struct Cyc_Absyn_Exp*e){
void*_tmp11F=e->r;void*_stmttmp9=_tmp11F;void*_tmp120=_stmttmp9;struct Cyc_List_List*_tmp121;switch(*((int*)_tmp120)){case 0U: _LL1: _LL2:
 return 1;case 3U: _LL3: _tmp121=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp120)->f2;_LL4: {struct Cyc_List_List*es=_tmp121;
...
void*_tmp122=s->r;void*_stmttmpA=_tmp122;void*_tmp123=_stmttmpA;struct Cyc_Absyn_Exp*_tmp124;if(((struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp123)->tag == 3U){_LL1: _tmp124=((struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp123)->f1;_LL2: {struct Cyc_Absyn_Exp*e=_tmp124;
