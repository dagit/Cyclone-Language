...
({struct Cyc_String_pa_PrintArg_struct _tmp5F;_tmp5F.tag=0;({struct _dyneither_ptr _tmp17C=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string((void*)_check_null(_tmp5B->topt)));_tmp5F.f1=_tmp17C;});({struct Cyc_String_pa_PrintArg_struct _tmp5E;_tmp5E.tag=0;({struct _dyneither_ptr _tmp17D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp54));_tmp5E.f1=_tmp17D;});({void*_tmp5C[2]={& _tmp5E,& _tmp5F};({unsigned int _tmp17F=((struct Cyc_Absyn_Switch_clause*)_tmp57->hd)->loc;struct _dyneither_ptr _tmp17E=({const char*_tmp5D="switch on type %s, but case expects type %s";_tag_dyneither(_tmp5D,sizeof(char),44);});Cyc_Tcutil_terr(_tmp17F,_tmp17E,_tag_dyneither(_tmp5C,sizeof(void*),2));});});});});
...
# 300
({void*_tmp185=({void*_tmp184=(void*)({struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmp61=_cycalloc(sizeof(*_tmp61));({struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct _tmp183=({struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct _tmp62;_tmp62.tag=2;({struct Cyc_Absyn_Stmt*_tmp181=Cyc_Absyn_new_stmt(_tmp130->r,_tmp130->loc);_tmp62.f1=_tmp181;});({struct Cyc_Absyn_Stmt*_tmp182=Cyc_Absyn_skip_stmt(_tmp130->loc);_tmp62.f2=_tmp182;});_tmp62;});_tmp61[0]=_tmp183;});_tmp61;});Cyc_Absyn_new_stmt(_tmp184,_tmp130->loc);})->r;_tmp130->r=_tmp185;});
# 302
Cyc_Tcstmt_tcStmt(te,_tmp130,1);{
# 305
struct _tuple2*def_v=({struct _tuple2*_tmp7A=_cycalloc(sizeof(*_tmp7A));_tmp7A->f1=Cyc_Absyn_Loc_n;({struct _dyneither_ptr*_tmp186=_init_dyneither_ptr(_cycalloc(sizeof(struct _dyneither_ptr)),"exn",sizeof(char),4);_tmp7A->f2=_tmp186;});_tmp7A;});
struct Cyc_Absyn_Vardecl*_tmp63=Cyc_Absyn_new_vardecl(0,def_v,(void*)& Cyc_Absyn_VoidType_val,0);
struct Cyc_Absyn_Pat*_tmp64=Cyc_Absyn_new_pat((void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp78=_cycalloc(sizeof(*_tmp78));({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct _tmp188=({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct _tmp79;_tmp79.tag=1;_tmp79.f1=_tmp63;({struct Cyc_Absyn_Pat*_tmp187=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0);_tmp79.f2=_tmp187;});_tmp79;});_tmp78[0]=_tmp188;});_tmp78;}),0);
struct Cyc_Absyn_Stmt*_tmp65=
Cyc_Absyn_exp_stmt(Cyc_Absyn_new_exp((void*)({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_tmp74=_cycalloc(sizeof(*_tmp74));({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct _tmp18B=({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct _tmp75;_tmp75.tag=11;({struct Cyc_Absyn_Exp*_tmp18A=Cyc_Absyn_varb_exp((void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp76=_cycalloc(sizeof(*_tmp76));({struct Cyc_Absyn_Local_b_Absyn_Binding_struct _tmp189=({struct Cyc_Absyn_Local_b_Absyn_Binding_struct _tmp77;_tmp77.tag=4;_tmp77.f1=_tmp63;_tmp77;});_tmp76[0]=_tmp189;});_tmp76;}),0);_tmp75.f1=_tmp18A;});_tmp75.f2=1;_tmp75;});_tmp74[0]=_tmp18B;});_tmp74;}),0),0);
...
({struct Cyc_List_List*_tmp18D=({struct Cyc_List_List*_tmp18C=*_tmp12F;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp18C,({struct Cyc_Absyn_Switch_clause*_tmp67[1];_tmp67[0]=_tmp66;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp67,sizeof(struct Cyc_Absyn_Switch_clause*),1));}));});*_tmp12F=_tmp18D;});{
# 317
...
({struct Cyc_String_pa_PrintArg_struct _tmp71;_tmp71.tag=0;({struct _dyneither_ptr _tmp194=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string((void*)_check_null(_tmp6D->topt)));_tmp71.f1=_tmp194;});({struct Cyc_String_pa_PrintArg_struct _tmp70;_tmp70.tag=0;({struct _dyneither_ptr _tmp195=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp68));_tmp70.f1=_tmp195;});({void*_tmp6E[2]={& _tmp70,& _tmp71};({unsigned int _tmp197=((struct Cyc_Absyn_Switch_clause*)_tmp69->hd)->loc;struct _dyneither_ptr _tmp196=({const char*_tmp6F="switch on type %s, but case expects type %s";_tag_dyneither(_tmp6F,sizeof(char),44);});Cyc_Tcutil_terr(_tmp197,_tmp196,_tag_dyneither(_tmp6E,sizeof(void*),2));});});});});
Cyc_Tcutil_explain_failure();}else{
# 349
...
# 373
({void*_tmp82=0;({unsigned int _tmp19A=_tmp132->loc;struct _dyneither_ptr _tmp199=({const char*_tmp83="bad abstract scope for local variable";_tag_dyneither(_tmp83,sizeof(char),38);});Cyc_Tcutil_terr(_tmp19A,_tmp199,_tag_dyneither(_tmp82,sizeof(void*),0));});});
...
# 391
({void*_tmp1A0=({void*_tmp19F=({void*_tmp19E=_tmp91;struct Cyc_Absyn_Tqual _tmp19D=_tmp90;struct Cyc_Absyn_Exp*_tmp19C=Cyc_Absyn_uint_exp(_get_dyneither_size(_tmp88,sizeof(char)),0);union Cyc_Absyn_Constraint*_tmp19B=_tmp8F;Cyc_Absyn_array_typ(_tmp19E,_tmp19D,_tmp19C,_tmp19B,_tmp8E);});_tmp103->type=_tmp19F;});_tmpAE=_tmp1A0;});
goto _LL72;case 9: _LL75: _tmp89=((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp87)->f1).Wstring_c).val;_LL76:
# 394
({void*_tmp1A6=({void*_tmp1A5=({void*_tmp1A4=_tmp91;struct Cyc_Absyn_Tqual _tmp1A3=_tmp90;struct Cyc_Absyn_Exp*_tmp1A2=Cyc_Absyn_uint_exp(1,0);union Cyc_Absyn_Constraint*_tmp1A1=_tmp8F;Cyc_Absyn_array_typ(_tmp1A4,_tmp1A3,_tmp1A2,_tmp1A1,_tmp8E);});_tmp103->type=_tmp1A5;});_tmpAE=_tmp1A6;});
goto _LL72;default: goto _LL7F;}case 27: _LL77: _tmp8A=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp87)->f2;_LL78:
 _tmp8B=_tmp8A;goto _LL7A;case 28: _LL79: _tmp8B=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp87)->f1;_LL7A:
# 399
({void*_tmp1A8=({void*_tmp1A7=Cyc_Absyn_array_typ(_tmp91,_tmp90,_tmp8B,_tmp8F,_tmp8E);_tmp103->type=_tmp1A7;});_tmpAE=_tmp1A8;});
goto _LL72;case 36: _LL7B: _tmp8C=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmp87)->f2;_LL7C:
 _tmp8D=_tmp8C;goto _LL7E;case 26: _LL7D: _tmp8D=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp87)->f1;_LL7E:
# 403
({void*_tmp1AE=({void*_tmp1AD=({void*_tmp1AC=_tmp91;struct Cyc_Absyn_Tqual _tmp1AB=_tmp90;struct Cyc_Absyn_Exp*_tmp1AA=Cyc_Absyn_uint_exp((unsigned int)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp8D),0);union Cyc_Absyn_Constraint*_tmp1A9=_tmp8F;Cyc_Absyn_array_typ(_tmp1AC,_tmp1AB,_tmp1AA,_tmp1A9,_tmp8E);});_tmp103->type=_tmp1AD;});_tmpAE=_tmp1AE;});
...
({void*_tmp95=0;({unsigned int _tmp1B1=_tmp132->loc;struct _dyneither_ptr _tmp1B0=({const char*_tmp96="extern declarations are not yet supported within functions";_tag_dyneither(_tmp96,sizeof(char),59);});Cyc_Tcutil_terr(_tmp1B1,_tmp1B0,_tag_dyneither(_tmp95,sizeof(void*),0));});});
if(_tmpAD != 0){
Cyc_Tcexp_tcExpInitializer(_tmp94,& _tmpAE,_tmpAD);
# 425
if(!is_local  && !Cyc_Tcutil_is_const_exp(_tmpAD))
({void*_tmp97=0;({unsigned int _tmp1B3=_tmp132->loc;struct _dyneither_ptr _tmp1B2=({const char*_tmp98="initializer for static variable needs to be a constant expression";_tag_dyneither(_tmp98,sizeof(char),66);});Cyc_Tcutil_terr(_tmp1B3,_tmp1B2,_tag_dyneither(_tmp97,sizeof(void*),0));});});
...
struct Cyc_Absyn_Vardecl*_tmpB6=({struct _tuple2*_tmp1BA=Cyc_Tcstmt_stmt_temp_var();Cyc_Absyn_new_vardecl(0,_tmp1BA,Cyc_Absyn_new_evar(0,0),0);});
struct Cyc_Absyn_Stmt*_tmpB7=Cyc_Absyn_new_stmt(s0->r,s0->loc);
struct Cyc_Absyn_Decl*_tmpB8=({struct Cyc_Absyn_Pat*_tmp1BF=({void*_tmp1BD=(void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmpBC=_cycalloc(sizeof(*_tmpBC));({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct _tmp1BC=({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct _tmpBD;_tmpBD.tag=1;_tmpBD.f1=_tmpB6;({struct Cyc_Absyn_Pat*_tmp1BB=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,_tmpB3->loc);_tmpBD.f2=_tmp1BB;});_tmpBD;});_tmpBC[0]=_tmp1BC;});_tmpBC;});Cyc_Absyn_new_pat(_tmp1BD,_tmpB3->loc);});struct Cyc_Absyn_Exp*_tmp1BE=_tmpB3;Cyc_Absyn_let_decl(_tmp1BF,_tmp1BE,s0->loc);});
# 465
...
({struct Cyc_String_pa_PrintArg_struct _tmpC3;_tmpC3.tag=0;({struct _dyneither_ptr _tmp1C5=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string((void*)_check_null(_tmpB3->topt)));_tmpC3.f1=_tmp1C5;});({struct Cyc_String_pa_PrintArg_struct _tmpC2;_tmpC2.tag=0;({struct _dyneither_ptr _tmp1C6=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmp107->topt)));_tmpC2.f1=_tmp1C6;});({void*_tmpC0[2]={& _tmpC2,& _tmpC3};({unsigned int _tmp1C8=_tmp132->loc;struct _dyneither_ptr _tmp1C7=({const char*_tmpC1="pattern type %s does not match definition type %s";_tag_dyneither(_tmpC1,sizeof(char),50);});Cyc_Tcutil_terr(_tmp1C8,_tmp1C7,_tag_dyneither(_tmpC0,sizeof(void*),2));});});});});
...
# 517
struct _tuple2*drname=({struct _tuple2*_tmpE2=_cycalloc(sizeof(*_tmpE2));({union Cyc_Absyn_Nmspace _tmp1D4=({union Cyc_Absyn_Nmspace _tmpE4;({struct Cyc_List_List*_tmp1D3=({struct _dyneither_ptr*_tmpE5[1];({struct _dyneither_ptr*_tmp1D2=_init_dyneither_ptr(_cycalloc(sizeof(struct _dyneither_ptr)),"Core",sizeof(char),5);_tmpE5[0]=_tmp1D2;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpE5,sizeof(struct _dyneither_ptr*),1));});(_tmpE4.Abs_n).val=_tmp1D3;});(_tmpE4.Abs_n).tag=2;_tmpE4;});_tmpE2->f1=_tmp1D4;});({struct _dyneither_ptr*_tmp1D5=
_init_dyneither_ptr(_cycalloc(sizeof(struct _dyneither_ptr)),"DynamicRegion",sizeof(char),14);_tmpE2->f2=_tmp1D5;});_tmpE2;});
...
Cyc_Absyn_UnknownAggr(Cyc_Absyn_StructA,drname,0);_tmpDF.aggr_info=_tmp1D7;});({struct Cyc_List_List*_tmp1D8=({void*_tmpE0[1];_tmpE0[0]=rgn_typ;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpE0,sizeof(void*),1));});_tmpDF.targs=_tmp1D8;});_tmpDF;});_tmpDE.f1=_tmp1D9;});_tmpDE;});_tmpDD[0]=_tmp1DA;});_tmpDD;});
# 524
...
({struct Cyc_String_pa_PrintArg_struct _tmpD8;_tmpD8.tag=0;({struct _dyneither_ptr _tmp1E1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(_tmpD4));_tmpD8.f1=_tmp1E1;});({struct Cyc_String_pa_PrintArg_struct _tmpD7;_tmpD7.tag=0;({struct _dyneither_ptr _tmp1E2=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmpD3));_tmpD7.f1=_tmp1E2;});({void*_tmpD5[2]={& _tmpD7,& _tmpD8};({unsigned int _tmp1E4=s0->loc;struct _dyneither_ptr _tmp1E3=({const char*_tmpD6="expected %s but found %s";_tag_dyneither(_tmpD6,sizeof(char),25);});Cyc_Tcutil_terr(_tmp1E4,_tmp1E3,_tag_dyneither(_tmpD5,sizeof(void*),2));});});});});
if(!Cyc_Tcutil_unify(_tmpD0,(void*)& Cyc_Absyn_UniqueRgn_val) && !
Cyc_Tcutil_unify(_tmpD0,(void*)& Cyc_Absyn_RefCntRgn_val))
({void*_tmpD9=0;({unsigned int _tmp1E6=s0->loc;struct _dyneither_ptr _tmp1E5=({const char*_tmpDA="open is only allowed on unique or reference-counted keys";_tag_dyneither(_tmpDA,sizeof(char),57);});Cyc_Tcutil_terr(_tmp1E6,_tmp1E5,_tag_dyneither(_tmpD9,sizeof(void*),0));});});
({void*_tmp1E8=(void*)({struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct*_tmpDB=_cycalloc(sizeof(*_tmpDB));({struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct _tmp1E7=({struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct _tmpDC;_tmpDC.tag=15;_tmpDC.f1=rgn_typ;_tmpDC;});_tmpDB[0]=_tmp1E7;});_tmpDB;});*_tmpEF=_tmp1E8;});};};}else{
# 537
({void*_tmp1EA=(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmpE7=_cycalloc(sizeof(*_tmpE7));({struct Cyc_Absyn_VarType_Absyn_Type_struct _tmp1E9=({struct Cyc_Absyn_VarType_Absyn_Type_struct _tmpE8;_tmpE8.tag=2;_tmpE8.f1=_tmp10B;_tmpE8;});_tmpE7[0]=_tmp1E9;});_tmpE7;});rgn_typ=_tmp1EA;});
...
if(!({void*_tmp1F3=*_tmpEF;Cyc_Tcutil_unify(_tmp1F3,(void*)({struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct*_tmpEA=_cycalloc(sizeof(*_tmpEA));({struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct _tmp1F2=({struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct _tmpEB;_tmpEB.tag=15;_tmpEB.f1=rgn_typ;_tmpEB;});_tmpEA[0]=_tmp1F2;});_tmpEA;}));}))
({void*_tmpEC=0;({struct _dyneither_ptr _tmp1F4=({const char*_tmpED="region stmt: type of region handle is wrong!";_tag_dyneither(_tmpED,sizeof(char),45);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp1F4,_tag_dyneither(_tmpEC,sizeof(void*),0));});});
# 545
...
({void*_tmpF1=0;({unsigned int _tmp1F6=_tmp132->loc;struct _dyneither_ptr _tmp1F5=({const char*_tmpF2="bad storage class for inner function";_tag_dyneither(_tmpF2,sizeof(char),37);});Cyc_Tcutil_terr(_tmp1F6,_tmp1F5,_tag_dyneither(_tmpF1,sizeof(void*),0));});});
...
({struct Cyc_String_pa_PrintArg_struct _tmpF7;_tmpF7.tag=0;({struct _dyneither_ptr _tmp1F8=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absyn_attribute2string((void*)atts->hd));_tmpF7.f1=_tmp1F8;});({void*_tmpF5[1]={& _tmpF7};({unsigned int _tmp1FA=_tmp132->loc;struct _dyneither_ptr _tmp1F9=({const char*_tmpF6="bad attribute %s for function";_tag_dyneither(_tmpF6,sizeof(char),30);});Cyc_Tcutil_terr(_tmp1FA,_tmp1F9,_tag_dyneither(_tmpF5,sizeof(void*),1));});});});
goto _LL90;default: _LL95: _LL96:
 goto _LL90;}_LL90:;}}{
# 565
struct Cyc_Absyn_Vardecl*vd=({struct Cyc_Absyn_Vardecl*_tmpF8=_cycalloc(sizeof(*_tmpF8));_tmpF8->sc=_tmp10C->sc;_tmpF8->name=_tmp10C->name;_tmpF8->varloc=0;({struct Cyc_Absyn_Tqual _tmp1FB=Cyc_Absyn_const_tqual(0);_tmpF8->tq=_tmp1FB;});({void*_tmp1FF=({
...
({struct _dyneither_ptr _tmp201=({const char*_tmpF9="namespace";_tag_dyneither(_tmpF9,sizeof(char),10);});unimp_msg_part=_tmp201;});goto _LL3C;case 10: _LL49: _tmp110=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp7E)->f1;_tmp10F=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp7E)->f2;_LL4A:
({struct _dyneither_ptr _tmp202=({const char*_tmpFA="using";_tag_dyneither(_tmpFA,sizeof(char),6);});unimp_msg_part=_tmp202;});goto _LL3C;case 5: _LL4B: _LL4C:
({struct _dyneither_ptr _tmp203=({const char*_tmpFB="type";_tag_dyneither(_tmpFB,sizeof(char),5);});unimp_msg_part=_tmp203;});goto _LL3C;case 6: _LL4D: _LL4E:
({struct _dyneither_ptr _tmp204=({const char*_tmpFC="datatype";_tag_dyneither(_tmpFC,sizeof(char),9);});unimp_msg_part=_tmp204;});goto _LL3C;case 7: _LL4F: _LL50:
