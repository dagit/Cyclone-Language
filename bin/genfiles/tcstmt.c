...
void*_tmpF1=({void*_tmp1C6=dr_type;void*_tmp1C5=outer_rgn;struct Cyc_Absyn_Tqual _tmp1C4=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp1C6,_tmp1C5,_tmp1C4,Cyc_Absyn_false_type);});void*exp_type=_tmpF1;
({unsigned _tmp1C9=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1C8=te;struct Cyc_List_List*_tmp1C7=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tctyp_check_type(_tmp1C9,_tmp1C8,_tmp1C7,& Cyc_Kinds_tmk,1,0,exp_type);});{
# 470
void*_tmpF2=Cyc_Tcexp_tcExp(te,& exp_type,open_exp_opt);void*key_typ=_tmpF2;
if(!Cyc_Unify_unify(exp_type,key_typ)&& !({
struct Cyc_RgnOrder_RgnPO*_tmp1CB=Cyc_Tcenv_curr_rgnpo(te);struct Cyc_Absyn_Exp*_tmp1CA=open_exp_opt;Cyc_Tcutil_coerce_assign(_tmp1CB,_tmp1CA,exp_type);}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmpF4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp153;_tmp153.tag=0U,({struct _fat_ptr _tmp1CC=({const char*_tmpF9="expected ";_tag_fat(_tmpF9,sizeof(char),10U);});_tmp153.f1=_tmp1CC;});_tmp153;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpF5=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp152;_tmp152.tag=2U,_tmp152.f1=(void*)exp_type;_tmp152;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp151;_tmp151.tag=0U,({struct _fat_ptr _tmp1CD=({const char*_tmpF8=" but found ";_tag_fat(_tmpF8,sizeof(char),12U);});_tmp151.f1=_tmp1CD;});_tmp151;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpF7=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp150;_tmp150.tag=2U,_tmp150.f1=(void*)key_typ;_tmp150;});void*_tmpF3[4U];_tmpF3[0]=& _tmpF4,_tmpF3[1]=& _tmpF5,_tmpF3[2]=& _tmpF6,_tmpF3[3]=& _tmpF7;({unsigned _tmp1CE=s0->loc;Cyc_Warn_err2(_tmp1CE,_tag_fat(_tmpF3,sizeof(void*),4U));});});
if(!Cyc_Unify_unify(outer_rgn,Cyc_Absyn_unique_rgn_type)&& !
Cyc_Unify_unify(outer_rgn,Cyc_Absyn_refcnt_rgn_type))
({struct Cyc_Warn_String_Warn_Warg_struct _tmpFB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp154;_tmp154.tag=0U,({struct _fat_ptr _tmp1CF=({const char*_tmpFC="open is only allowed on unique or reference-counted keys";_tag_fat(_tmpFC,sizeof(char),57U);});_tmp154.f1=_tmp1CF;});_tmp154;});void*_tmpFA[1U];_tmpFA[0]=& _tmpFB;({unsigned _tmp1D0=s0->loc;Cyc_Warn_err2(_tmp1D0,_tag_fat(_tmpFA,sizeof(void*),1U));});});
({void*_tmp1D1=Cyc_Absyn_rgn_handle_type(rgn_typ);*t=_tmp1D1;});
...
te2=({unsigned _tmp1D3=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1D2=te2;Cyc_Tcenv_add_type_vars(_tmp1D3,_tmp1D2,({struct Cyc_List_List*_tmp106=_cycalloc(sizeof(*_tmp106));_tmp106->hd=tv,_tmp106->tl=0;_tmp106;}));});
te2=Cyc_Tcenv_add_region(te2,rgn_typ,0,1);}
# 484
({unsigned _tmp1D6=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1D5=te;struct Cyc_List_List*_tmp1D4=Cyc_Tcenv_lookup_type_vars(te2);Cyc_Tctyp_check_type(_tmp1D6,_tmp1D5,_tmp1D4,& Cyc_Kinds_bk,1,0,*t);});
if(!({void*_tmp1D7=*t;Cyc_Unify_unify(_tmp1D7,Cyc_Absyn_rgn_handle_type(rgn_typ));}))
({void*_tmp107=0U;({struct _fat_ptr _tmp1D8=({const char*_tmp108="region stmt: type of region handle is wrong!";_tag_fat(_tmp108,sizeof(char),45U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp1D8,_tag_fat(_tmp107,sizeof(void*),0U));});});
# 488
...
# 494
({void*_tmp1DC=({void*_tmp1DB=(void*)({struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmp109=_cycalloc(sizeof(*_tmp109));_tmp109->tag=2U,({struct Cyc_Absyn_Stmt*_tmp1DA=Cyc_Absyn_new_stmt(s->r,s->loc);_tmp109->f1=_tmp1DA;}),({struct Cyc_Absyn_Stmt*_tmp1D9=Cyc_Absyn_skip_stmt(s->loc);_tmp109->f2=_tmp1D9;});_tmp109;});Cyc_Absyn_new_stmt(_tmp1DB,s->loc);})->r;s->r=_tmp1DC;});{
# 496
...
te2=({unsigned _tmp1DE=s0->loc;struct Cyc_Tcenv_Tenv*_tmp1DD=te2;Cyc_Tcenv_add_type_vars(_tmp1DE,_tmp1DD,({struct Cyc_List_List*_tmp10C=_cycalloc(sizeof(*_tmp10C));_tmp10C->hd=tv,_tmp10C->tl=0;_tmp10C;}));});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp10E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp155;_tmp155.tag=0U,({struct _fat_ptr _tmp1DF=({const char*_tmp10F="bad storage class for inner function";_tag_fat(_tmp10F,sizeof(char),37U);});_tmp155.f1=_tmp1DF;});_tmp155;});void*_tmp10D[1U];_tmp10D[0]=& _tmp10E;({unsigned _tmp1E0=d->loc;Cyc_Warn_err2(_tmp1E0,_tag_fat(_tmp10D,sizeof(void*),1U));});});
...
({struct Cyc_List_List*_tmp1E1=Cyc_Atts_transfer_fn_type_atts(t,(fd->i).attributes);(fd->i).attributes=_tmp1E1;});{
void*_tmp110=Cyc_Tcenv_curr_rgn(te);void*curr_bl=_tmp110;
struct Cyc_Absyn_Vardecl*vd=({struct Cyc_Absyn_Vardecl*_tmp111=_cycalloc(sizeof(*_tmp111));_tmp111->sc=fd->sc,_tmp111->name=fd->name,_tmp111->varloc=0U,({struct Cyc_Absyn_Tqual _tmp1E6=Cyc_Absyn_const_tqual(0U);_tmp111->tq=_tmp1E6;}),({
void*_tmp1E5=({void*_tmp1E4=t;void*_tmp1E3=curr_bl;struct Cyc_Absyn_Tqual _tmp1E2=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp1E4,_tmp1E3,_tmp1E2,Cyc_Absyn_false_type);});_tmp111->type=_tmp1E5;}),_tmp111->initializer=0,_tmp111->rgn=curr_bl,_tmp111->attributes=0,_tmp111->escapes=0,_tmp111->is_proto=fd->body != 0;_tmp111;});
# 517
fd->fn_vardecl=vd;{
struct Cyc_Tcenv_Fenv*old_fenv=(struct Cyc_Tcenv_Fenv*)_check_null(te->le);
({struct Cyc_Tcenv_Fenv*_tmp1E7=Cyc_Tcenv_nested_fenv(d->loc,old_fenv,fd);te->le=_tmp1E7;});
...
# 539
({struct Cyc_Warn_String_Warn_Warg_struct _tmp11F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp158;_tmp158.tag=0U,({struct _fat_ptr _tmp1E8=({const char*_tmp123="tcStmt: nested ";_tag_fat(_tmp123,sizeof(char),16U);});_tmp158.f1=_tmp1E8;});_tmp158;});struct Cyc_Warn_String_Warn_Warg_struct _tmp120=({struct Cyc_Warn_String_Warn_Warg_struct _tmp157;_tmp157.tag=0U,_tmp157.f1=unimp_msg_part;_tmp157;});struct Cyc_Warn_String_Warn_Warg_struct _tmp121=({struct Cyc_Warn_String_Warn_Warg_struct _tmp156;_tmp156.tag=0U,({struct _fat_ptr _tmp1E9=({const char*_tmp122=" declarations not allowed";_tag_fat(_tmp122,sizeof(char),26U);});_tmp156.f1=_tmp1E9;});_tmp156;});void*_tmp11E[3U];_tmp11E[0]=& _tmp11F,_tmp11E[1]=& _tmp120,_tmp11E[2]=& _tmp121;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp11E,sizeof(void*),3U));});}}_LL0:;}
# 546
