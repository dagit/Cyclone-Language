...
# 99
int Cyc_CfFlowInfo_get_field_index(void*t,struct _dyneither_ptr*f){
void*_tmp26=Cyc_Tcutil_compress(t);void*_tmp27=_tmp26;struct Cyc_List_List*_tmp2D;union Cyc_Absyn_AggrInfoU _tmp2C;switch(*((int*)_tmp27)){case 11U: _LL9: _tmp2C=(((struct Cyc_Absyn_AggrType_Absyn_Type_struct*)_tmp27)->f1).aggr_info;_LLA: {
# 102
struct Cyc_List_List*_tmp28=((struct Cyc_Absyn_AggrdeclImpl*)_check_null((Cyc_Absyn_get_known_aggrdecl(_tmp2C))->impl))->fields;
_tmp2D=_tmp28;goto _LLC;}case 12U: _LLB: _tmp2D=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp27)->f2;_LLC:
# 105
 return Cyc_CfFlowInfo_get_field_index_fs(_tmp2D,f);default: _LLD: _LLE:
# 107
({struct Cyc_String_pa_PrintArg_struct _tmp2B;_tmp2B.tag=0U;({struct _dyneither_ptr _tmp293=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp2B.f1=_tmp293;});({void*_tmp29[1U]={& _tmp2B};({struct _dyneither_ptr _tmp294=({const char*_tmp2A="get_field_index failed: %s";_tag_dyneither(_tmp2A,sizeof(char),27U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp294,_tag_dyneither(_tmp29,sizeof(void*),1U));});});});}_LL8:;}struct _tuple13{void*f1;void*f2;};
# 111
int Cyc_CfFlowInfo_root_cmp(void*r1,void*r2){
if((int)r1 == (int)r2)
return 0;{
struct _tuple13 _tmp2E=({struct _tuple13 _tmp36;_tmp36.f1=r1;_tmp36.f2=r2;_tmp36;});struct _tuple13 _tmp2F=_tmp2E;int _tmp35;int _tmp34;struct Cyc_Absyn_Exp*_tmp33;struct Cyc_Absyn_Exp*_tmp32;struct Cyc_Absyn_Vardecl*_tmp31;struct Cyc_Absyn_Vardecl*_tmp30;if(((struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*)_tmp2F.f1)->tag == 0U){if(((struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*)_tmp2F.f2)->tag == 0U){_LL10: _tmp31=((struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*)_tmp2F.f1)->f1;_tmp30=((struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*)_tmp2F.f2)->f1;_LL11:
 return(int)_tmp31 - (int)_tmp30;}else{_LL12: _LL13:
 return - 1;}}else{if(((struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*)_tmp2F.f2)->tag == 0U){_LL14: _LL15:
 return 1;}else{if(((struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_tmp2F.f1)->tag == 1U){if(((struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_tmp2F.f2)->tag == 1U){_LL16: _tmp33=((struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_tmp2F.f1)->f1;_tmp32=((struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_tmp2F.f2)->f1;_LL17:
 return(int)_tmp33 - (int)_tmp32;}else{_LL18: _LL19:
 return - 1;}}else{if(((struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_tmp2F.f2)->tag == 1U){_LL1A: _LL1B:
...
Cyc_CfFlowInfo_aggrfields_to_aggrdict(fenv,_tmp74,_tmp75 == Cyc_Absyn_UnionA,leafval);_tmp6D.f2=_tmp2A0;});_tmp6D;});_tmp6C[0]=_tmp2A1;});_tmp6C;});case 8U: _LL43: _tmp77=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp5F)->f1).elt_type;_tmp76=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp5F)->f1).zero_term;if(
((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp76)){_LL44:
# 272
 return(allow_zeroterm  && !no_init_bits_only) && Cyc_Tcutil_bits_only(_tmp77)?fenv->unknown_all: leafval;}else{goto _LL49;}case 19U: _LL45: _tmp78=(void*)((struct Cyc_Absyn_TagType_Absyn_Type_struct*)_tmp5F)->f1;_LL46:
 return leafval;case 5U: _LL47: _tmp79=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp5F)->f1).ptr_atts).nullable;if(!
((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp79)){_LL48:
{void*_tmp6F=leafval;if(((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp6F)->tag == 2U){if(((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp6F)->f1 == Cyc_CfFlowInfo_AllIL){_LL4C: _LL4D:
...
return 0;}else{
# 310
return Cyc_CfFlowInfo_is_unique_consumed(e,env_iteration,*((void**)_check_dyneither_subscript(_tmp7F,sizeof(void*),_tmp80)),needs_unconsume);}case 8U: _LL55: _tmp82=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp7A)->f2;_LL56:
# 312
...
void*_tmp83=r;struct Cyc_Absyn_Vardecl*_tmp94;void*_tmp93;struct Cyc_CfFlowInfo_UnionRInfo _tmp92;struct _dyneither_ptr _tmp91;struct Cyc_Absyn_Exp*_tmp90;int _tmp8F;void*_tmp8E;switch(*((int*)_tmp83)){case 7U: _LL5A: _tmp90=((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp83)->f1;_tmp8F=((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp83)->f2;_tmp8E=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp83)->f3;_LL5B:
# 322
 return _tmp8E;case 6U: _LL5C: _tmp92=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp83)->f1;_tmp91=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp83)->f2;_LL5D: {
# 324
...
return r;}}case 8U: _LL5E: _tmp94=((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp83)->f1;_tmp93=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp83)->f2;_LL5F: {
# 336
...
return r;}}}else{switch(*((int*)_tmp96.f1)){case 10U: if(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp96.f2)->tag == 6U){_LL65: _tmpB2=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp96.f1)->f1;_tmpB1=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp96.f2)->f1;_tmpB0=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp96.f2)->f2;_LL66: {
# 353
...
_tmpB2=_tmpB2->tl;}}
# 359
return(void*)({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmp9B=_cycalloc(sizeof(*_tmp9B));({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct _tmp2A8=({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct _tmp9C;_tmp9C.tag=6U;_tmp9C.f1=_tmpB1;_tmp9C.f2=d2;_tmp9C;});_tmp9B[0]=_tmp2A8;});_tmp9B;});}}else{goto _LL6B;}case 11U: if(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp96.f2)->tag == 6U){_LL67: _tmpB5=(((struct Cyc_Absyn_AggrType_Absyn_Type_struct*)_tmp96.f1)->f1).aggr_info;_tmpB4=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp96.f2)->f1;_tmpB3=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp96.f2)->f2;_LL68: {
# 361
struct Cyc_Absyn_Aggrdecl*_tmpA1=Cyc_Absyn_get_known_aggrdecl(_tmpB5);
if(_tmpA1->impl == 0)return r;
_tmpB9=_tmpA1->kind;_tmpB8=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmpA1->impl))->fields;_tmpB7=_tmpB4;_tmpB6=_tmpB3;goto _LL6A;}}else{goto _LL6B;}case 12U: if(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp96.f2)->tag == 6U){_LL69: _tmpB9=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp96.f1)->f1;_tmpB8=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp96.f1)->f2;_tmpB7=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp96.f2)->f1;_tmpB6=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp96.f2)->f2;_LL6A: {
# 365
...
# 372
return(void*)({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmpA6=_cycalloc(sizeof(*_tmpA6));({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct _tmp2AA=({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct _tmpA7;_tmpA7.tag=6U;_tmpA7.f1=_tmpB7;_tmpA7.f2=d2;_tmpA7;});_tmpA6[0]=_tmp2AA;});_tmpA6;});}}else{goto _LL6B;}default: _LL6B: _LL6C:
# 374
...
void*_tmpC9=r;struct Cyc_CfFlowInfo_UnionRInfo _tmpCE;struct _dyneither_ptr _tmpCD;struct Cyc_CfFlowInfo_Place*_tmpCC;void*_tmpCB;void*_tmpCA;switch(*((int*)_tmpC9)){case 7U: _LL77: _tmpCA=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmpC9)->f3;_LL78:
 Cyc_CfFlowInfo_add_places(pile,_tmpCA);return;case 8U: _LL79: _tmpCB=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmpC9)->f2;_LL7A:
 Cyc_CfFlowInfo_add_places(pile,_tmpCB);return;case 4U: _LL7B: _tmpCC=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmpC9)->f1;_LL7C:
 Cyc_CfFlowInfo_add_place(pile,_tmpCC);return;case 6U: _LL7D: _tmpCE=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmpC9)->f1;_tmpCD=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmpC9)->f2;_LL7E:
# 418
...
return(void*)({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*_tmpEB=_cycalloc(sizeof(*_tmpEB));({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct _tmp2B5=({struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct _tmpEC;_tmpEC.tag=6U;({struct Cyc_CfFlowInfo_UnionRInfo _tmp2B4=({struct Cyc_CfFlowInfo_UnionRInfo _tmpED;_tmpED.is_union=_tmpF7;_tmpED.fieldnum=- 1;_tmpED;});_tmpEC.f1=_tmp2B4;});_tmpEC.f2=_tmpEA;_tmpEC;});_tmpEB[0]=_tmp2B5;});_tmpEB;});}}case 8U: goto _LL8F;default: goto _LL91;}else{switch(*((int*)_tmpE8.f2)){case 5U: _LL8D: _tmpFB=(_tmpE8.f1)->tl;_tmpFA=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmpE8.f2)->f1;_LL8E: {
# 470
void*_tmpEE=Cyc_CfFlowInfo_insert_place_outer(_tmpFB,_tmpFA,new_val);
if(_tmpEE == _tmpFA)return old_val;else{
return(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmpEF=_cycalloc(sizeof(*_tmpEF));({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct _tmp2B6=({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct _tmpF0;_tmpF0.tag=5U;_tmpF0.f1=_tmpEE;_tmpF0;});_tmpEF[0]=_tmp2B6;});_tmpEF;});}}case 8U: goto _LL8F;default: goto _LL91;}}}else{if(((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmpE8.f2)->tag == 8U){_LL8F: _tmpFD=((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmpE8.f2)->f1;_tmpFC=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmpE8.f2)->f2;_LL90: {
# 474
void*_tmpF1=Cyc_CfFlowInfo_insert_place_outer(path,_tmpFC,new_val);
if(_tmpF1 == _tmpFC)return old_val;else{
return(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmpF2=_cycalloc(sizeof(*_tmpF2));({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp2B7=({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmpF3;_tmpF3.tag=8U;_tmpF3.f1=_tmpFD;_tmpF3.f2=_tmpF1;_tmpF3;});_tmpF2[0]=_tmp2B7;});_tmpF2;});}}}else{_LL91: _LL92:
({void*_tmpF4=0U;({struct _dyneither_ptr _tmp2B8=({const char*_tmpF5="bad insert place";_tag_dyneither(_tmpF5,sizeof(char),17U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp2B8,_tag_dyneither(_tmpF4,sizeof(void*),0U));});});}}_LL8A:;};}
# 484
...
void*_tmp10B=r;void*_tmp110;enum Cyc_CfFlowInfo_InitLevel _tmp10F;enum Cyc_CfFlowInfo_InitLevel _tmp10E;switch(*((int*)_tmp10B)){case 2U: _LLA1: _tmp10E=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp10B)->f1;_LLA2:
 return _tmp10E;case 3U: _LLA3: _tmp10F=((struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*)_tmp10B)->f1;_LLA4:
 return _tmp10F;case 0U: _LLA5: _LLA6:
 goto _LLA8;case 1U: _LLA7: _LLA8:
 return Cyc_CfFlowInfo_AllIL;case 7U: _LLA9: _tmp110=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp10B)->f3;_LLAA:
 return Cyc_CfFlowInfo_NoneIL;default: _LLAB: _LLAC:
({void*_tmp10C=0U;({struct _dyneither_ptr _tmp2BF=({const char*_tmp10D="initlevel_approx";_tag_dyneither(_tmp10D,sizeof(char),17U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp2BF,_tag_dyneither(_tmp10C,sizeof(void*),0U));});});}_LLA0:;}
# 522
...
{void*_tmp111=r;void*_tmp11B;struct Cyc_CfFlowInfo_Place*_tmp11A;struct _dyneither_ptr _tmp119;int _tmp118;int _tmp117;struct _dyneither_ptr _tmp116;void*_tmp115;switch(*((int*)_tmp111)){case 8U: _LLAE: _tmp115=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp111)->f2;_LLAF:
 return Cyc_CfFlowInfo_initlevel_rec(env,_tmp115,acc);case 6U: _LLB0: _tmp118=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp111)->f1).is_union;_tmp117=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp111)->f1).fieldnum;_tmp116=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp111)->f2;if(_tmp118){_LLB1: {
# 532
...
goto _LLAD;}}case 4U: _LLB4: _tmp11A=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp111)->f1;_LLB5:
# 552
...
# 559
goto _LLAD;case 5U: _LLB6: _tmp11B=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp111)->f1;_LLB7:
...
retry: {struct _tuple13 _tmp121=({struct _tuple13 _tmp12B;_tmp12B.f1=_tmp120;_tmp12B.f2=(void*)_tmp12C->hd;_tmp12B;});struct _tuple13 _tmp122=_tmp121;void*_tmp12A;struct Cyc_CfFlowInfo_UnionRInfo _tmp129;struct _dyneither_ptr _tmp128;int _tmp127;void*_tmp126;void*_tmp125;switch(*((int*)_tmp122.f1)){case 8U: _LLBE: _tmp125=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp122.f1)->f2;_LLBF:
# 576
 _tmp120=_tmp125;goto retry;case 7U: _LLC0: _tmp126=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp122.f1)->f3;_LLC1:
# 579
 _tmp120=_tmp126;goto retry;case 6U: if(((struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*)_tmp122.f2)->tag == 0U){_LLC2: _tmp129=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp122.f1)->f1;_tmp128=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp122.f1)->f2;_tmp127=((struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*)_tmp122.f2)->f1;_LLC3:
# 581
 _tmp120=*((void**)_check_dyneither_subscript(_tmp128,sizeof(void*),_tmp127));
goto _LLBD;}else{goto _LLC6;}case 5U: if(((struct Cyc_CfFlowInfo_Star_CfFlowInfo_PathCon_struct*)_tmp122.f2)->tag == 1U){_LLC4: _tmp12A=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp122.f1)->f1;_LLC5:
# 584
 _tmp120=_tmp12A;
goto _LLBD;}else{goto _LLC6;}default: _LLC6: _LLC7:
# 592
({void*_tmp123=0U;({struct _dyneither_ptr _tmp2C6=({const char*_tmp124="bad lookup_place";_tag_dyneither(_tmp124,sizeof(char),17U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp2C6,_tag_dyneither(_tmp123,sizeof(void*),0U));});});}_LLBD:;}}
# 594
return _tmp120;};}
# 597
static int Cyc_CfFlowInfo_is_rval_unescaped(void*rval){
void*_tmp12E=rval;int _tmp133;int _tmp132;struct _dyneither_ptr _tmp131;void*_tmp130;void*_tmp12F;switch(*((int*)_tmp12E)){case 3U: _LLC9: _LLCA:
 return 0;case 7U: _LLCB: _tmp12F=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp12E)->f3;_LLCC:
 return Cyc_CfFlowInfo_is_rval_unescaped(_tmp12F);case 8U: _LLCD: _tmp130=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp12E)->f2;_LLCE:
 return Cyc_CfFlowInfo_is_rval_unescaped(_tmp130);case 6U: _LLCF: _tmp133=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp12E)->f1).is_union;_tmp132=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp12E)->f1).fieldnum;_tmp131=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp12E)->f2;_LLD0:
# 603
...
void*_tmp134=rval;void*_tmp135;switch(*((int*)_tmp134)){case 8U: _LLD4: _tmp135=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp134)->f2;_LLD5:
 return Cyc_CfFlowInfo_is_init_pointer(_tmp135);case 4U: _LLD6: _LLD7:
 goto _LLD9;case 5U: _LLD8: _LLD9:
...
# 646
struct _tuple13 _tmp139=({struct _tuple13 _tmp150;_tmp150.f1=oldval;_tmp150.f2=newval;_tmp150;});struct _tuple13 _tmp13A=_tmp139;enum Cyc_CfFlowInfo_InitLevel _tmp14F;struct Cyc_CfFlowInfo_UnionRInfo _tmp14E;struct _dyneither_ptr _tmp14D;struct Cyc_CfFlowInfo_UnionRInfo _tmp14C;struct _dyneither_ptr _tmp14B;struct Cyc_CfFlowInfo_Place*_tmp14A;struct Cyc_Absyn_Vardecl*_tmp149;void*_tmp148;void*_tmp147;if(((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp13A.f1)->tag == 8U){_LLDD: _tmp147=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp13A.f1)->f2;_LLDE:
# 648
 return Cyc_CfFlowInfo_assign_place_inner(env,_tmp147,newval);}else{if(((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp13A.f2)->tag == 8U){_LLDF: _tmp149=((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp13A.f2)->f1;_tmp148=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp13A.f2)->f2;_LLE0: {
# 650
void*_tmp13B=Cyc_CfFlowInfo_assign_place_inner(env,oldval,_tmp148);
if(_tmp13B == _tmp148)return newval;else{
return(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp13C=_cycalloc(sizeof(*_tmp13C));({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp2C7=({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct _tmp13D;_tmp13D.tag=8U;_tmp13D.f1=_tmp149;_tmp13D.f2=_tmp13B;_tmp13D;});_tmp13C[0]=_tmp2C7;});_tmp13C;});}}}else{switch(*((int*)_tmp13A.f1)){case 3U: if(((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp13A.f2)->tag == 4U){_LLE1: _tmp14A=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp13A.f2)->f1;_LLE2:
...
({void*_tmp16A=0U;({struct _dyneither_ptr _tmp2D5=({const char*_tmp16B="bad assign place";_tag_dyneither(_tmp16B,sizeof(char),17U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp2D5,_tag_dyneither(_tmp16A,sizeof(void*),0U));});});}}_LLF0:;};}
# 759
struct Cyc_Dict_Dict Cyc_CfFlowInfo_assign_place(struct Cyc_CfFlowInfo_FlowEnv*fenv,unsigned int loc,struct Cyc_Dict_Dict d,struct Cyc_CfFlowInfo_Place*place,void*r){
# 767
...
return Cyc_CfFlowInfo_join_absRval(env,a,_tmp19F,_tmp19D);}}else{_LL104: _tmp1A2=((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp17F.f1)->f1;_tmp1A1=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp17F.f1)->f2;_LL105:
 return Cyc_CfFlowInfo_join_absRval(env,a,_tmp1A1,r2);}}else{if(((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->tag == 8U){_LL106: _tmp1A4=((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f1;_tmp1A3=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f2;_LL107:
 return Cyc_CfFlowInfo_join_absRval(env,a,r1,_tmp1A3);}else{if(((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f1)->tag == 7U){if(((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->tag == 7U){_LL108: _tmp1AA=((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f1)->f1;_tmp1A9=((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f1)->f2;_tmp1A8=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f1)->f3;_tmp1A7=((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f1;_tmp1A6=((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f2;_tmp1A5=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f3;_LL109:
# 804
 if(_tmp1AA == _tmp1A7)
...
{void*_tmp184=_tmp1A8;struct Cyc_CfFlowInfo_Place*_tmp185;if(((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp184)->tag == 4U){_LL123: _tmp185=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp184)->f1;_LL124:
 Cyc_CfFlowInfo_add_place(env->pile,_tmp185);goto _LL122;}else{_LL125: _LL126:
 goto _LL122;}_LL122:;}
# 810
{void*_tmp186=_tmp1A5;struct Cyc_CfFlowInfo_Place*_tmp187;if(((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp186)->tag == 4U){_LL128: _tmp187=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp186)->f1;_LL129:
...
# 816
 return(void*)({struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*_tmp188=_cycalloc(sizeof(*_tmp188));({struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct _tmp2E0=({struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct _tmp189;_tmp189.tag=7U;_tmp189.f1=_tmp1AD;_tmp189.f2=_tmp1AC;({void*_tmp2DF=Cyc_CfFlowInfo_join_absRval(env,a,_tmp1AB,r2);_tmp189.f3=_tmp2DF;});_tmp189;});_tmp188[0]=_tmp2E0;});_tmp188;});}}else{if(((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->tag == 7U){_LL10C: _tmp1B0=((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f1;_tmp1AF=((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f2;_tmp1AE=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f3;_LL10D:
# 818
 return(void*)({struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*_tmp18A=_cycalloc(sizeof(*_tmp18A));({struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct _tmp2E2=({struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct _tmp18B;_tmp18B.tag=7U;_tmp18B.f1=_tmp1B0;_tmp18B.f2=_tmp1AF;({void*_tmp2E1=Cyc_CfFlowInfo_join_absRval(env,a,r1,_tmp1AE);_tmp18B.f3=_tmp2E1;});_tmp18B;});_tmp18A[0]=_tmp2E2;});_tmp18A;});}else{switch(*((int*)_tmp17F.f1)){case 4U: switch(*((int*)_tmp17F.f2)){case 4U: _LL10E: _tmp1B2=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp17F.f1)->f1;_tmp1B1=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f1;_LL10F:
# 821
...
goto _LL101;case 1U: _LL110: _tmp1B3=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp17F.f1)->f1;_LL111:
# 827
...
# 853
 Cyc_CfFlowInfo_add_place(env->pile,_tmp1B4);goto _LL101;}case 1U: switch(*((int*)_tmp17F.f2)){case 4U: _LL112: _tmp1B5=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f1;_LL113:
# 833
...
enum Cyc_CfFlowInfo_InitLevel _tmp18E=Cyc_CfFlowInfo_initlevel(env->fenv,env->d2,r2);enum Cyc_CfFlowInfo_InitLevel _tmp18F=_tmp18E;if(_tmp18F == Cyc_CfFlowInfo_AllIL){_LL132: _LL133:
 ...
 return(env->fenv)->unknown_none;}_LL131:;};case 5U: _LL118: _tmp1B6=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f1;_LL119: {
# 848
enum Cyc_CfFlowInfo_InitLevel _tmp194=Cyc_CfFlowInfo_initlevel(env->fenv,env->d2,_tmp1B6);enum Cyc_CfFlowInfo_InitLevel _tmp195=_tmp194;if(_tmp195 == Cyc_CfFlowInfo_AllIL){_LL13C: _LL13D:
 ...
 return(env->fenv)->unknown_none;}_LL13B:;}default: goto _LL120;}case 5U: switch(*((int*)_tmp17F.f2)){case 5U: _LL114: _tmp1B8=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp17F.f1)->f1;_tmp1B7=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp17F.f2)->f1;_LL115:
# 840
 return(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp190=_cycalloc(sizeof(*_tmp190));({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct _tmp2E4=({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct _tmp191;_tmp191.tag=5U;({void*_tmp2E3=Cyc_CfFlowInfo_join_absRval(env,a,_tmp1B8,_tmp1B7);_tmp191.f1=_tmp2E3;});_tmp191;});_tmp190[0]=_tmp2E4;});_tmp190;});case 1U: _LL116: _tmp1B9=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp17F.f1)->f1;_LL117: {
# 843
...
struct _tuple13 _tmp1C2=({struct _tuple13 _tmp1CA;_tmp1CA.f1=r1;_tmp1CA.f2=r2;_tmp1CA;});struct _tuple13 _tmp1C3=_tmp1C2;if(((struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*)_tmp1C3.f1)->tag == 3U){_LL141: _LL142:
 goto _LL144;}else{if(((struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*)_tmp1C3.f2)->tag == 3U){_LL143: _LL144: {
# 891
...
# 905
struct _tuple20 _tmp1CB=({struct _tuple20 _tmp1D6;_tmp1D6.f1=f1;_tmp1D6.f2=f2;_tmp1D6;});struct _tuple20 _tmp1CC=_tmp1CB;struct Cyc_Dict_Dict _tmp1D5;struct Cyc_List_List*_tmp1D4;struct Cyc_Dict_Dict _tmp1D3;struct Cyc_List_List*_tmp1D2;if(((_tmp1CC.f1).BottomFL).tag == 1U){_LL156: _LL157:
 return f2;}else{if(((_tmp1CC.f2).BottomFL).tag == 1U){_LL158: _LL159:
...
struct _tuple21 _tmp1D9=({struct _tuple21 _tmp1EA;_tmp1EA.f1=_tmp1EE;_tmp1EA.f2=_tmp1EC;_tmp1EA.f3=outflow;_tmp1EA;});struct _tuple21 _tmp1DA=_tmp1D9;struct Cyc_Dict_Dict _tmp1E9;struct Cyc_Dict_Dict _tmp1E8;struct Cyc_Dict_Dict _tmp1E7;struct Cyc_List_List*_tmp1E6;if(((_tmp1DA.f1).BottomFL).tag == 1U){_LL163: _LL164:
 return({struct _tuple12 _tmp1DB;_tmp1DB.f1=outflow;_tmp1DB.f2=_tmp1EB;_tmp1DB;});}else{if(((_tmp1DA.f2).BottomFL).tag == 1U){_LL165: _LL166:
 return({struct _tuple12 _tmp1DC;_tmp1DC.f1=outflow;_tmp1DC.f2=_tmp1ED;_tmp1DC;});}else{if(((_tmp1DA.f3).ReachableFL).tag == 2U){_LL167: _tmp1E9=(((_tmp1DA.f1).ReachableFL).val).f1;_tmp1E8=(((_tmp1DA.f2).ReachableFL).val).f1;_tmp1E7=(((_tmp1DA.f3).ReachableFL).val).f1;_tmp1E6=(((_tmp1DA.f3).ReachableFL).val).f2;_LL168:
# 934
...
# 940
({void*_tmp1E4=0U;({struct _dyneither_ptr _tmp2EE=({const char*_tmp1E5="join_flow_and_rval: BottomFL outflow";_tag_dyneither(_tmp1E5,sizeof(char),37U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp2EE,_tag_dyneither(_tmp1E4,sizeof(void*),0U));});});}}}_LL162:;};};}
# 945
static int Cyc_CfFlowInfo_absRval_lessthan_approx(void*ignore,void*r1,void*r2){
if(r1 == r2)return 1;
# 948
{struct _tuple13 _tmp1EF=({struct _tuple13 _tmp1FF;_tmp1FF.f1=r1;_tmp1FF.f2=r2;_tmp1FF;});struct _tuple13 _tmp1F0=_tmp1EF;int _tmp1FE;int _tmp1FD;struct _dyneither_ptr _tmp1FC;int _tmp1FB;int _tmp1FA;struct _dyneither_ptr _tmp1F9;void*_tmp1F8;void*_tmp1F7;struct Cyc_CfFlowInfo_Place*_tmp1F6;struct Cyc_CfFlowInfo_Place*_tmp1F5;struct Cyc_Absyn_Vardecl*_tmp1F4;void*_tmp1F3;struct Cyc_Absyn_Vardecl*_tmp1F2;void*_tmp1F1;if(((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->tag == 8U){if(((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->tag == 8U){_LL16C: _tmp1F4=((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->f1;_tmp1F3=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->f2;_tmp1F2=((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->f1;_tmp1F1=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->f2;_LL16D:
# 950
 return _tmp1F4 == _tmp1F2  && Cyc_CfFlowInfo_absRval_lessthan_approx(ignore,_tmp1F3,_tmp1F1);}else{_LL16E: _LL16F:
 goto _LL171;}}else{if(((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->tag == 8U){_LL170: _LL171:
 return 0;}else{if(((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->tag == 4U){if(((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->tag == 4U){_LL172: _tmp1F6=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->f1;_tmp1F5=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->f1;_LL173:
 return Cyc_CfFlowInfo_place_cmp(_tmp1F6,_tmp1F5)== 0;}else{_LL174: _LL175:
 goto _LL177;}}else{if(((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->tag == 4U){_LL176: _LL177:
 return 0;}else{if(((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->tag == 5U){if(((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->tag == 5U){_LL178: _tmp1F8=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->f1;_tmp1F7=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->f1;_LL179:
 return Cyc_CfFlowInfo_absRval_lessthan_approx(ignore,_tmp1F8,_tmp1F7);}else{_LL17A: _LL17B:
 goto _LL17D;}}else{if(((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->tag == 5U){_LL17C: _LL17D:
 return 0;}else{if(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->tag == 6U)switch(*((int*)_tmp1F0.f2)){case 6U: _LL17E: _tmp1FE=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->f1).is_union;_tmp1FD=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->f1).fieldnum;_tmp1FC=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->f2;_tmp1FB=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->f1).is_union;_tmp1FA=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->f1).fieldnum;_tmp1F9=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->f2;_LL17F:
# 961
...
return 1;case 0U: goto _LL180;case 1U: goto _LL182;default: goto _LL188;}else{switch(*((int*)_tmp1F0.f2)){case 0U: _LL180: _LL181:
 goto _LL183;case 1U: _LL182: _LL183:
 return 0;default: if(((struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f1)->tag == 3U){if(((struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*)_tmp1F0.f2)->tag == 3U){_LL184: _LL185:
...
int Cyc_CfFlowInfo_flow_lessthan_approx(union Cyc_CfFlowInfo_FlowInfo f1,union Cyc_CfFlowInfo_FlowInfo f2){
# 993
struct _tuple20 _tmp203=({struct _tuple20 _tmp209;_tmp209.f1=f1;_tmp209.f2=f2;_tmp209;});struct _tuple20 _tmp204=_tmp203;struct Cyc_Dict_Dict _tmp208;struct Cyc_List_List*_tmp207;struct Cyc_Dict_Dict _tmp206;struct Cyc_List_List*_tmp205;if(((_tmp204.f1).BottomFL).tag == 1U){_LL192: _LL193:
 return 1;}else{if(((_tmp204.f2).BottomFL).tag == 1U){_LL194: _LL195:
...
int done=0;
while(!done){
void*_tmp20A=rv;struct Cyc_Absyn_Vardecl*_tmp20D;void*_tmp20C;if(((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp20A)->tag == 8U){_LL199: _tmp20D=((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp20A)->f1;_tmp20C=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp20A)->f2;_LL19A:
# 1009
...
({void*_tmp210=0U;({struct Cyc___cycFILE*_tmp2F3=Cyc_stderr;struct _dyneither_ptr _tmp2F2=({const char*_tmp211="uninitialized";_tag_dyneither(_tmp211,sizeof(char),14U);});Cyc_fprintf(_tmp2F3,_tmp2F2,_tag_dyneither(_tmp210,sizeof(void*),0U));});});goto _LL19D;}else{_LL1A0: _LL1A1:
({void*_tmp212=0U;({struct Cyc___cycFILE*_tmp2F5=Cyc_stderr;struct _dyneither_ptr _tmp2F4=({const char*_tmp213="all-initialized";_tag_dyneither(_tmp213,sizeof(char),16U);});Cyc_fprintf(_tmp2F5,_tmp2F4,_tag_dyneither(_tmp212,sizeof(void*),0U));});});goto _LL19D;}_LL19D:;}
# 1024
void Cyc_CfFlowInfo_print_root(void*root){
void*_tmp214=root;struct Cyc_Absyn_Exp*_tmp220;void*_tmp21F;struct Cyc_Absyn_Vardecl*_tmp21E;switch(*((int*)_tmp214)){case 0U: _LL1A3: _tmp21E=((struct Cyc_CfFlowInfo_VarRoot_CfFlowInfo_Root_struct*)_tmp214)->f1;_LL1A4:
# 1027
({struct Cyc_String_pa_PrintArg_struct _tmp217;_tmp217.tag=0U;({struct _dyneither_ptr _tmp2F6=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp21E->name));_tmp217.f1=_tmp2F6;});({void*_tmp215[1U]={& _tmp217};({struct Cyc___cycFILE*_tmp2F8=Cyc_stderr;struct _dyneither_ptr _tmp2F7=({const char*_tmp216="Root(%s)";_tag_dyneither(_tmp216,sizeof(char),9U);});Cyc_fprintf(_tmp2F8,_tmp2F7,_tag_dyneither(_tmp215,sizeof(void*),1U));});});});goto _LL1A2;case 1U: _LL1A5: _tmp220=((struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_tmp214)->f1;_tmp21F=(void*)((struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_tmp214)->f2;_LL1A6:
# 1029
...
Cyc_Absynpp_typ2string(_tmp21F));_tmp21B.f1=_tmp2F9;});({struct Cyc_String_pa_PrintArg_struct _tmp21A;_tmp21A.tag=0U;({struct _dyneither_ptr _tmp2FA=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmp220));_tmp21A.f1=_tmp2FA;});({void*_tmp218[2U]={& _tmp21A,& _tmp21B};({struct Cyc___cycFILE*_tmp2FC=Cyc_stderr;struct _dyneither_ptr _tmp2FB=({const char*_tmp219="MallocPt(%s,%s)";_tag_dyneither(_tmp219,sizeof(char),16U);});Cyc_fprintf(_tmp2FC,_tmp2FB,_tag_dyneither(_tmp218,sizeof(void*),2U));});});});});goto _LL1A2;default: _LL1A7: _LL1A8:
# 1032
({void*_tmp21C=0U;({struct Cyc___cycFILE*_tmp2FE=Cyc_stderr;struct _dyneither_ptr _tmp2FD=({const char*_tmp21D="InitParam(_,_)";_tag_dyneither(_tmp21D,sizeof(char),15U);});Cyc_fprintf(_tmp2FE,_tmp2FD,_tag_dyneither(_tmp21C,sizeof(void*),0U));});});goto _LL1A2;}_LL1A2:;}
# 1036
void Cyc_CfFlowInfo_print_path(struct Cyc_List_List*p){
{struct Cyc_List_List*x=p;for(0;x != 0;x=((struct Cyc_List_List*)_check_null(x))->tl){
void*_tmp221=(void*)x->hd;void*_tmp222=_tmp221;int _tmp22E;if(((struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*)_tmp222)->tag == 0U){_LL1AA: _tmp22E=((struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*)_tmp222)->f1;_LL1AB:
# 1040
...
# 1043
 if(x->tl != 0){
void*_tmp226=(void*)((struct Cyc_List_List*)_check_null(x->tl))->hd;void*_tmp227=_tmp226;int _tmp22B;if(((struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*)_tmp227)->tag == 0U){_LL1AF: _tmp22B=((struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*)_tmp227)->f1;_LL1B0:
# 1046
 x=x->tl;
...
continue;}else{_LL1B1: _LL1B2:
 goto _LL1AE;}_LL1AE:;}
# 1052
({void*_tmp22C=0U;({struct Cyc___cycFILE*_tmp304=Cyc_stderr;struct _dyneither_ptr _tmp303=({const char*_tmp22D="*";_tag_dyneither(_tmp22D,sizeof(char),2U);});Cyc_fprintf(_tmp304,_tmp303,_tag_dyneither(_tmp22C,sizeof(void*),0U));});});}_LL1A9:;}}
# 1055
...
# 1073
void Cyc_CfFlowInfo_print_absrval(void*rval){
void*_tmp236=rval;struct Cyc_Absyn_Vardecl*_tmp26C;void*_tmp26B;struct Cyc_Absyn_Exp*_tmp26A;int _tmp269;void*_tmp268;int _tmp267;int _tmp266;struct _dyneither_ptr _tmp265;void*_tmp264;struct Cyc_CfFlowInfo_Place*_tmp263;enum Cyc_CfFlowInfo_InitLevel _tmp262;enum Cyc_CfFlowInfo_InitLevel _tmp261;switch(*((int*)_tmp236)){case 0U: _LL1B4: _LL1B5:
({void*_tmp237=0U;({struct Cyc___cycFILE*_tmp30C=Cyc_stderr;struct _dyneither_ptr _tmp30B=({const char*_tmp238="Zero";_tag_dyneither(_tmp238,sizeof(char),5U);});Cyc_fprintf(_tmp30C,_tmp30B,_tag_dyneither(_tmp237,sizeof(void*),0U));});});goto _LL1B3;case 1U: _LL1B6: _LL1B7:
({void*_tmp239=0U;({struct Cyc___cycFILE*_tmp30E=Cyc_stderr;struct _dyneither_ptr _tmp30D=({const char*_tmp23A="NotZeroAll";_tag_dyneither(_tmp23A,sizeof(char),11U);});Cyc_fprintf(_tmp30E,_tmp30D,_tag_dyneither(_tmp239,sizeof(void*),0U));});});goto _LL1B3;case 2U: _LL1B8: _tmp261=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp236)->f1;_LL1B9:
...
({void*_tmp241=0U;({struct Cyc___cycFILE*_tmp316=Cyc_stderr;struct _dyneither_ptr _tmp315=({const char*_tmp242=")";_tag_dyneither(_tmp242,sizeof(char),2U);});Cyc_fprintf(_tmp316,_tmp315,_tag_dyneither(_tmp241,sizeof(void*),0U));});});goto _LL1B3;case 4U: _LL1BC: _tmp263=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp236)->f1;_LL1BD:
...
({void*_tmp245=0U;({struct Cyc___cycFILE*_tmp31A=Cyc_stderr;struct _dyneither_ptr _tmp319=({const char*_tmp246=")";_tag_dyneither(_tmp246,sizeof(char),2U);});Cyc_fprintf(_tmp31A,_tmp319,_tag_dyneither(_tmp245,sizeof(void*),0U));});});goto _LL1B3;case 5U: _LL1BE: _tmp264=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp236)->f1;_LL1BF:
...
({void*_tmp249=0U;({struct Cyc___cycFILE*_tmp31E=Cyc_stderr;struct _dyneither_ptr _tmp31D=({const char*_tmp24A=")";_tag_dyneither(_tmp24A,sizeof(char),2U);});Cyc_fprintf(_tmp31E,_tmp31D,_tag_dyneither(_tmp249,sizeof(void*),0U));});});goto _LL1B3;case 6U: _LL1C0: _tmp267=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp236)->f1).is_union;_tmp266=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp236)->f1).fieldnum;_tmp265=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp236)->f2;_LL1C1:
# 1086
 if(_tmp267){
...
goto _LL1B3;case 7U: _LL1C2: _tmp26A=((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp236)->f1;_tmp269=((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp236)->f2;_tmp268=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmp236)->f3;_LL1C3:
# 1099
...
# 1121
void Cyc_CfFlowInfo_print_flow(union Cyc_CfFlowInfo_FlowInfo f){
union Cyc_CfFlowInfo_FlowInfo _tmp273=f;struct Cyc_Dict_Dict _tmp27D;struct Cyc_List_List*_tmp27C;if((_tmp273.BottomFL).tag == 1U){_LL1C7: _LL1C8:
({void*_tmp274=0U;({struct Cyc___cycFILE*_tmp33A=Cyc_stderr;struct _dyneither_ptr _tmp339=({const char*_tmp275="  BottomFL\n";_tag_dyneither(_tmp275,sizeof(char),12U);});Cyc_fprintf(_tmp33A,_tmp339,_tag_dyneither(_tmp274,sizeof(void*),0U));});});goto _LL1C6;}else{_LL1C9: _tmp27D=((_tmp273.ReachableFL).val).f1;_tmp27C=((_tmp273.ReachableFL).val).f2;_LL1CA:
# 1125
