...
# 187
struct _tuple12*_tmp3A=env;struct Cyc_List_List*_tmp3C;struct _RegionHandle*_tmp3B;_LL1: _tmp3B=_tmp3A->f1;_tmp3C=_tmp3A->f2;_LL2: {struct _RegionHandle*t=_tmp3B;struct Cyc_List_List*inst=_tmp3C;
...
return({struct Cyc_Absyn_Aggrfield*_tmp40=_region_malloc(t,sizeof(*_tmp40));_tmp40->name=f->name,_tmp40->tq=f->tq,_tmp40->type=new_typ,_tmp40->width=f->width,_tmp40->attributes=f->attributes,_tmp40->requires_clause=new_r;_tmp40;});}}struct _tuple13{struct Cyc_Absyn_Tvar*f1;void*f2;};
# 198
...
{struct Cyc_Absyn_Kind*_tmp44=Cyc_Tcutil_tvar_kind(tv,& Cyc_Tcutil_bk);struct Cyc_Absyn_Kind*_stmttmp7=_tmp44;struct Cyc_Absyn_Kind*_tmp45=_stmttmp7;switch(((struct Cyc_Absyn_Kind*)_tmp45)->kind){case Cyc_Absyn_RgnKind: _LL1: _LL2:
 ...
 goto _LL0;}_LL0:;}
# 217
inst=({struct Cyc_List_List*_tmp47=_region_malloc(temp,sizeof(*_tmp47));({struct _tuple13*_tmp265=({struct _tuple13*_tmp46=_region_malloc(temp,sizeof(*_tmp46));_tmp46->f1=tv,_tmp46->f2=t;_tmp46;});_tmp47->hd=_tmp265;}),_tmp47->tl=inst;_tmp47;});}
# 219
if(inst != 0){
struct _tuple12 _tmp48=({struct _tuple12 _tmp22A;_tmp22A.f1=temp,({struct Cyc_List_List*_tmp266=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(inst);_tmp22A.f2=_tmp266;});_tmp22A;});struct _tuple12 env=_tmp48;
struct Cyc_List_List*subs_fs=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_Absyn_Aggrfield*(*f)(struct _tuple12*,struct Cyc_Absyn_Aggrfield*),struct _tuple12*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(temp,Cyc_CfFlowInfo_substitute_field,& env,fs);
...
({void*_tmp268=Cyc_CfFlowInfo_i_typ_to_absrval(fenv,0,no_init_bits_only,(*((struct _tuple14*)((struct Cyc_List_List*)_check_null(tqts))->hd)).f2,leafval);*((void**)_check_fat_subscript(d,sizeof(void*),i))=_tmp268;});
tqts=tqts->tl;}}
# 248
...
{int i=0;for(0;(unsigned)i < sz;++ i){
({void*_tmp26C=Cyc_CfFlowInfo_make_unique_consumed(fenv,(*((struct _tuple14*)((struct Cyc_List_List*)_check_null(tqts))->hd)).f2,consumer,iteration,((void**)d.curr)[i]);*((void**)_check_fat_subscript(d2,sizeof(void*),i))=_tmp26C;});
tqts=tqts->tl;}}
# 360
...
({void*_tmpC7=0U;({struct _fat_ptr _tmp272=({const char*_tmpC8="bad insert place";_tag_fat(_tmpC8,sizeof(char),17U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp272,_tag_fat(_tmpC7,sizeof(void*),0U));});});}}_LL0:;}}
# 485
...
({void*_tmpD9=0U;({struct _fat_ptr _tmp277=({const char*_tmpDA="initlevel_approx";_tag_fat(_tmpDA,sizeof(char),17U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp277,_tag_fat(_tmpD9,sizeof(void*),0U));});});}_LL0:;}
# 523
...
retry: {struct _tuple11 _tmpEC=({struct _tuple11 _tmp235;_tmp235.f1=ans,_tmp235.f2=(void*)path->hd;_tmp235;});struct _tuple11 _stmttmp11=_tmpEC;struct _tuple11 _tmpED=_stmttmp11;void*_tmpEE;int _tmpF1;struct _fat_ptr _tmpF0;struct Cyc_CfFlowInfo_UnionRInfo _tmpEF;void*_tmpF2;void*_tmpF3;switch(*((int*)_tmpED.f1)){case 8U: _LL4: _tmpF3=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmpED.f1)->f2;_LL5: {void*rval=_tmpF3;
# 577
...
# 593
({void*_tmpF4=0U;({struct _fat_ptr _tmp27A=({const char*_tmpF5="bad lookup_place";_tag_fat(_tmpF5,sizeof(char),17U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp27A,_tag_fat(_tmpF4,sizeof(void*),0U));});});}_LL3:;}}
# 595
return ans;}}
# 598
...
({void*_tmp134=0U;({struct _fat_ptr _tmp282=({const char*_tmp135="bad assign place";_tag_fat(_tmp135,sizeof(char),17U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp282,_tag_fat(_tmp134,sizeof(void*),0U));});});}}_LL0:;}}
# 760
...
struct _tuple11 _tmp174=({struct _tuple11 _tmp23E;_tmp23E.f1=r1,_tmp23E.f2=r2;_tmp23E;});struct _tuple11 _stmttmp1A=_tmp174;struct _tuple11 _tmp175=_stmttmp1A;if(((struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*)_tmp175.f1)->tag == 3U){_LL40: _LL41:
 goto _LL43;}else{if(((struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*)_tmp175.f2)->tag == 3U){_LL42: _LL43: {
# 892
struct _tuple17 _tmp176=({struct _tuple17 _tmp23C;_tmp23C.f1=il1,_tmp23C.f2=il2;_tmp23C;});struct _tuple17 _stmttmp1B=_tmp176;struct _tuple17 _tmp177=_stmttmp1B;if(_tmp177.f2 == Cyc_CfFlowInfo_NoneIL){_LL47: _LL48:
...
# 897
struct _tuple17 _tmp178=({struct _tuple17 _tmp23D;_tmp23D.f1=il1,_tmp23D.f2=il2;_tmp23D;});struct _tuple17 _stmttmp1C=_tmp178;struct _tuple17 _tmp179=_stmttmp1C;if(_tmp179.f2 == Cyc_CfFlowInfo_NoneIL){_LL4E: _LL4F:
...
# 906
struct _tuple18 _tmp17A=({struct _tuple18 _tmp240;_tmp240.f1=f1,_tmp240.f2=f2;_tmp240;});struct _tuple18 _stmttmp1D=_tmp17A;struct _tuple18 _tmp17B=_stmttmp1D;struct Cyc_List_List*_tmp17F;struct Cyc_Dict_Dict _tmp17E;struct Cyc_List_List*_tmp17D;struct Cyc_Dict_Dict _tmp17C;if(((_tmp17B.f1).BottomFL).tag == 1){_LL1: _LL2:
...
return({struct Cyc_Dict_Dict _tmp290=Cyc_CfFlowInfo_escape_these(fenv,env.pile,outdict);Cyc_CfFlowInfo_ReachableFL(_tmp290,r);});}}}}_LL0:;}struct _tuple19{union Cyc_CfFlowInfo_FlowInfo f1;void*f2;};struct _tuple20{union Cyc_CfFlowInfo_FlowInfo f1;union Cyc_CfFlowInfo_FlowInfo f2;union Cyc_CfFlowInfo_FlowInfo f3;};
# 922
...
# 927
struct _tuple19 _tmp184=pr1;void*_tmp186;union Cyc_CfFlowInfo_FlowInfo _tmp185;_LL1: _tmp185=_tmp184.f1;_tmp186=_tmp184.f2;_LL2: {union Cyc_CfFlowInfo_FlowInfo f1=_tmp185;void*r1=_tmp186;
struct _tuple19 _tmp187=pr2;void*_tmp189;union Cyc_CfFlowInfo_FlowInfo _tmp188;_LL4: _tmp188=_tmp187.f1;_tmp189=_tmp187.f2;_LL5: {union Cyc_CfFlowInfo_FlowInfo f2=_tmp188;void*r2=_tmp189;
union Cyc_CfFlowInfo_FlowInfo outflow=Cyc_CfFlowInfo_join_flow(fenv,f1,f2);
struct _tuple20 _tmp18A=({struct _tuple20 _tmp247;_tmp247.f1=f1,_tmp247.f2=f2,_tmp247.f3=outflow;_tmp247;});struct _tuple20 _stmttmp1E=_tmp18A;struct _tuple20 _tmp18B=_stmttmp1E;struct Cyc_List_List*_tmp18F;struct Cyc_Dict_Dict _tmp18E;struct Cyc_Dict_Dict _tmp18D;struct Cyc_Dict_Dict _tmp18C;if(((_tmp18B.f1).BottomFL).tag == 1){_LL7: _LL8:
 return({struct _tuple19 _tmp241;_tmp241.f1=outflow,_tmp241.f2=r2;_tmp241;});}else{if(((_tmp18B.f2).BottomFL).tag == 1){_LL9: _LLA:
 return({struct _tuple19 _tmp242;_tmp242.f1=outflow,_tmp242.f2=r1;_tmp242;});}else{if(((_tmp18B.f3).ReachableFL).tag == 2){_LLB: _tmp18C=(((_tmp18B.f1).ReachableFL).val).f1;_tmp18D=(((_tmp18B.f2).ReachableFL).val).f1;_tmp18E=(((_tmp18B.f3).ReachableFL).val).f1;_tmp18F=(((_tmp18B.f3).ReachableFL).val).f2;_LLC: {struct Cyc_Dict_Dict d1=_tmp18C;struct Cyc_Dict_Dict d2=_tmp18D;struct Cyc_Dict_Dict outd=_tmp18E;struct Cyc_List_List*relns=_tmp18F;
# 935
if(((int(*)(int ignore,void*r1,void*r2))Cyc_CfFlowInfo_absRval_lessthan_approx)(0,r1,r2))return({struct _tuple19 _tmp243;_tmp243.f1=outflow,_tmp243.f2=r2;_tmp243;});
if(((int(*)(int ignore,void*r1,void*r2))Cyc_CfFlowInfo_absRval_lessthan_approx)(0,r2,r1))return({struct _tuple19 _tmp244;_tmp244.f1=outflow,_tmp244.f2=r1;_tmp244;});{
...
# 977
 goto _LL0;}}}}}}}}}_LL0:;}{
# 979
struct _tuple17 _tmp1A5=({struct _tuple17 _tmp249;({enum Cyc_CfFlowInfo_InitLevel _tmp296=Cyc_CfFlowInfo_initlevel_approx(r1);_tmp249.f1=_tmp296;}),({enum Cyc_CfFlowInfo_InitLevel _tmp295=Cyc_CfFlowInfo_initlevel_approx(r2);_tmp249.f2=_tmp295;});_tmp249;});struct _tuple17 _stmttmp20=_tmp1A5;struct _tuple17 _tmp1A6=_stmttmp20;if(_tmp1A6.f1 == Cyc_CfFlowInfo_AllIL){_LL20: _LL21:
...
int Cyc_CfFlowInfo_flow_lessthan_approx(union Cyc_CfFlowInfo_FlowInfo f1,union Cyc_CfFlowInfo_FlowInfo f2){
# 994
struct _tuple18 _tmp1A7=({struct _tuple18 _tmp24A;_tmp24A.f1=f1,_tmp24A.f2=f2;_tmp24A;});struct _tuple18 _stmttmp21=_tmp1A7;struct _tuple18 _tmp1A8=_stmttmp21;struct Cyc_List_List*_tmp1AC;struct Cyc_Dict_Dict _tmp1AB;struct Cyc_List_List*_tmp1AA;struct Cyc_Dict_Dict _tmp1A9;if(((_tmp1A8.f1).BottomFL).tag == 1){_LL1: _LL2:
...
return((int(*)(int(*f)(void*,void*,void*),struct Cyc_Dict_Dict d1,struct Cyc_Dict_Dict d2))Cyc_Dict_forall_intersect)((int(*)(void*ignore,void*r1,void*r2))Cyc_CfFlowInfo_absRval_lessthan_approx,d1,d2)&&
 Cyc_Relations_relns_approx(r1,r2);}}}_LL0:;}struct _tuple21{void*f1;struct Cyc_List_List*f2;};
# 1004
