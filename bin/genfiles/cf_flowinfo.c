...
void*_tmp225=(void*)({struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*_tmp2=_cycalloc(sizeof(*_tmp2));_tmp2->tag=2,_tmp2->f1=Cyc_CfFlowInfo_NoneIL;_tmp2;});_tmp8->unknown_none=_tmp225;}),({
void*_tmp224=(void*)({struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*_tmp3=_cycalloc(sizeof(*_tmp3));_tmp3->tag=2,_tmp3->f1=Cyc_CfFlowInfo_AllIL;_tmp3;});_tmp8->unknown_all=_tmp224;}),({
void*_tmp223=(void*)({struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*_tmp4=_cycalloc(sizeof(*_tmp4));_tmp4->tag=3,_tmp4->f1=Cyc_CfFlowInfo_NoneIL;_tmp4;});_tmp8->esc_none=_tmp223;}),({
void*_tmp222=(void*)({struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*_tmp5=_cycalloc(sizeof(*_tmp5));_tmp5->tag=3,_tmp5->f1=Cyc_CfFlowInfo_AllIL;_tmp5;});_tmp8->esc_all=_tmp222;}),({
...
({void*_tmp12=0U;({struct _fat_ptr _tmp22A=({const char*_tmp13="error locations not for VarRoots";_tag_fat(_tmp13,sizeof(char),33U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp22A,_tag_fat(_tmp12,sizeof(void*),0));});});};}}
# 87
...
n=n + 1;}
# 94
({struct Cyc_String_pa_PrintArg_struct _tmp17=({struct Cyc_String_pa_PrintArg_struct _tmp1EB;_tmp1EB.tag=0,_tmp1EB.f1=(struct _fat_ptr)((struct _fat_ptr)*f);_tmp1EB;});void*_tmp15[1];_tmp15[0]=& _tmp17;({struct _fat_ptr _tmp22B=({const char*_tmp16="get_field_index_fs failed: %s";_tag_fat(_tmp16,sizeof(char),30U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp22B,_tag_fat(_tmp15,sizeof(void*),1));});});}
# 97
...
# 105
({struct Cyc_String_pa_PrintArg_struct _tmp1F=({struct Cyc_String_pa_PrintArg_struct _tmp1EC;_tmp1EC.tag=0,({struct _fat_ptr _tmp22C=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_typ2string(t));_tmp1EC.f1=_tmp22C;});_tmp1EC;});void*_tmp1D[1];_tmp1D[0]=& _tmp1F;({struct _fat_ptr _tmp22D=({const char*_tmp1E="get_field_index failed: %s";_tag_fat(_tmp1E,sizeof(char),27U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp22D,_tag_fat(_tmp1D,sizeof(void*),1));});});};}struct _tuple12{void*f1;void*f2;};
# 109
...
({void*_tmp22E=Cyc_CfFlowInfo_i_typ_to_absrval(fenv,0,no_init_bits_only,t2,leafval);*((void**)_check_fat_subscript(d,sizeof(void*),i))=_tmp22E;});}}}
# 179
...
{struct Cyc_Absyn_Kind*_tmp42=Cyc_Kinds_tvar_kind(tv,& Cyc_Kinds_bk);struct Cyc_Absyn_Kind*_stmttmp7=_tmp42;struct Cyc_Absyn_Kind*_tmp43=_stmttmp7;switch((int)((struct Cyc_Absyn_Kind*)_tmp43)->kind){case Cyc_Absyn_RgnKind:
 ...
 goto _LL0;}_LL0:;}
# 217
inst=({struct Cyc_List_List*_tmp45=_region_malloc(temp,sizeof(*_tmp45));({struct _tuple14*_tmp22F=({struct _tuple14*_tmp44=_region_malloc(temp,sizeof(*_tmp44));_tmp44->f1=tv,_tmp44->f2=t;_tmp44;});_tmp45->hd=_tmp22F;}),_tmp45->tl=inst;_tmp45;});}
# 219
if(inst != 0){
struct _tuple13 _tmp46=({struct _tuple13 _tmp1F0;_tmp1F0.f1=temp,({struct Cyc_List_List*_tmp230=((struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev)(inst);_tmp1F0.f2=_tmp230;});_tmp1F0;});struct _tuple13 env=_tmp46;
...
struct _fat_ptr _tmp231=Cyc_CfFlowInfo_substitute_aggrfields_to_aggrdict(fenv,ad->tvs,targs,fields,(int)ad->kind == (int)Cyc_Absyn_UnionA,leafval);_tmp54->f2=_tmp231;});_tmp54;});}}case 4: if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4A)->f2 != 0){_tmp4B=(void*)(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4A)->f2)->hd;{void*t=_tmp4B;
# 273
...
({void*_tmp232=Cyc_CfFlowInfo_i_typ_to_absrval(fenv,0,no_init_bits_only,(*((struct _tuple15*)((struct Cyc_List_List*)_check_null(tqts))->hd)).f2,leafval);*((void**)_check_fat_subscript(d,sizeof(void*),i))=_tmp232;});
tqts=tqts->tl;}}
# 248
...
struct _fat_ptr _tmp233=Cyc_CfFlowInfo_aggrfields_to_aggrdict(fenv,fs,(int)k == (int)Cyc_Absyn_UnionA,leafval);_tmp55->f2=_tmp233;});_tmp55;});}case 4: _tmp4B=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp4A)->f1).elt_type;_tmp4C=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp4A)->f1).zero_term;{void*et=_tmp4B;void*zeroterm=_tmp4C;
# 268
...
int change=0;
struct _fat_ptr d2=({unsigned _tmp68=sz;void**_tmp67=_cycalloc(_check_times(_tmp68,sizeof(void*)));({{unsigned _tmp1F2=sz;unsigned i;for(i=0;i < _tmp1F2;++ i){_tmp67[i]=*((void**)_check_fat_subscript(d,sizeof(void*),(int)i));}}0;});_tag_fat(_tmp67,sizeof(void*),_tmp68);});
{int i=0;for(0;(unsigned)i < sz;++ i){
({void*_tmp234=Cyc_CfFlowInfo_make_unique_unconsumed(fenv,*((void**)_check_fat_subscript(d,sizeof(void*),i)));*((void**)_check_fat_subscript(d2,sizeof(void*),i))=_tmp234;});
...
{int i=0;for(0;(unsigned)i < sz;++ i){
({void*_tmp23B=({struct Cyc_CfFlowInfo_FlowEnv*_tmp23A=fenv;void*_tmp239=(*((struct _tuple15*)((struct Cyc_List_List*)_check_null(tqts))->hd)).f2;struct Cyc_Absyn_Exp*_tmp238=consumer;int _tmp237=iteration;void*_tmp236=*((void**)_check_fat_subscript(d,sizeof(void*),i));Cyc_CfFlowInfo_make_unique_consumed(_tmp23A,_tmp239,_tmp238,_tmp237,_tmp236,local_alias);});*((void**)_check_fat_subscript(d2,sizeof(void*),i))=_tmp23B;});
tqts=tqts->tl;}}
# 360
...
if(_get_fat_size(*n,sizeof(char))!= (unsigned)1)
({void*_tmp23C=Cyc_CfFlowInfo_make_unique_consumed(fenv,t2,consumer,iteration,*((void**)_check_fat_subscript(d,sizeof(void*),i)),local_alias);*((void**)_check_fat_subscript(d2,sizeof(void*),i))=_tmp23C;});}}}
# 373
...
({struct Cyc_List_List*_tmp23D=({struct Cyc_List_List*_tmp8E=_cycalloc(sizeof(*_tmp8E));_tmp8E->hd=place,_tmp8E->tl=pile->places;_tmp8E;});pile->places=_tmp23D;});}
# 413
...
void*_tmp23E=Cyc_CfFlowInfo_insert_place_inner(new_val,((void**)d.curr)[(int)i]);_tmp9A[i]=_tmp23E;});}}0;});_tag_fat(_tmp9A,sizeof(void*),_tmp9B);});
# 436
...
# 438
return(void*)({struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*_tmp9C=_cycalloc(sizeof(*_tmp9C));_tmp9C->tag=7,_tmp9C->f1=e,_tmp9C->f2=i,({void*_tmp23F=Cyc_CfFlowInfo_insert_place_inner(new_val,rval);_tmp9C->f3=_tmp23F;}),_tmp9C->f4=l;_tmp9C;});}case 8: _tmp94=((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp93)->f1;_tmp95=(void*)((struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*)_tmp93)->f2;{struct Cyc_Absyn_Vardecl*n=_tmp94;void*rval=_tmp95;
# 440
return(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp9D=_cycalloc(sizeof(*_tmp9D));_tmp9D->tag=8,_tmp9D->f1=n,({void*_tmp240=Cyc_CfFlowInfo_insert_place_inner(new_val,rval);_tmp9D->f2=_tmp240;});_tmp9D;});}default:
 return new_val;};}
# 447
static struct _fat_ptr Cyc_CfFlowInfo_aggr_dict_insert(struct _fat_ptr d,int n,void*rval){
void*_tmp9E=*((void**)_check_fat_subscript(d,sizeof(void*),n));void*old_rval=_tmp9E;
...
# 466
void*_tmpA8=Cyc_CfFlowInfo_insert_place_outer(tl,*((void**)_check_fat_subscript(d,sizeof(void*),i)),new_val);void*new_child=_tmpA8;
...
({void*_tmpAF=0U;({struct _fat_ptr _tmp241=({const char*_tmpB0="bad insert place";_tag_fat(_tmpB0,sizeof(char),17U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp241,_tag_fat(_tmpAF,sizeof(void*),0));});});}};}}
# 485
...
d=({struct Cyc_Dict_Dict _tmp245=d;void*_tmp244=root;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,void*))Cyc_Dict_insert)(_tmp245,_tmp244,({
struct Cyc_List_List*_tmp243=path;void*_tmp242=
((void*(*)(struct Cyc_Dict_Dict,void*))Cyc_Dict_lookup)(d,root);
# 499
Cyc_CfFlowInfo_insert_place_outer(_tmp243,_tmp242,newval);}));});}}}}
# 503
...
return il;}case 0:
 ...
 return Cyc_CfFlowInfo_AllIL;case 7: _tmpBE=(void*)((struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*)_tmpBD)->f3;{void*r=_tmpBE;
return Cyc_CfFlowInfo_NoneIL;}default:
({void*_tmpC0=0U;({struct _fat_ptr _tmp246=({const char*_tmpC1="initlevel_approx";_tag_fat(_tmpC1,sizeof(char),17U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp246,_tag_fat(_tmpC0,sizeof(void*),0));});});};}
# 523
...
if(f == -1){
int i=0;for(0;(unsigned)i < sz;++ i){
if((int)Cyc_CfFlowInfo_initlevel_rec(env,*((void**)_check_fat_subscript(d,sizeof(void*),i)),Cyc_CfFlowInfo_AllIL)== (int)Cyc_CfFlowInfo_AllIL){
this_ans=1U;
break;}}}else{
# 543
...
this_ans=1U;else{
# 556
({struct Cyc_List_List*_tmp247=({struct Cyc_List_List*_tmpC9=_cycalloc(sizeof(*_tmpC9));_tmpC9->hd=p,_tmpC9->tl=env->seen;_tmpC9;});env->seen=_tmp247;});
this_ans=({struct Cyc_CfFlowInfo_InitlevelEnv*_tmp248=env;Cyc_CfFlowInfo_initlevel_rec(_tmp248,Cyc_CfFlowInfo_lookup_place(env->d,p),Cyc_CfFlowInfo_AllIL);});
...
struct Cyc_CfFlowInfo_InitlevelEnv _tmpCA=({struct Cyc_CfFlowInfo_InitlevelEnv _tmp1FA;_tmp1FA.d=d,_tmp1FA.seen=0;_tmp1FA;});struct Cyc_CfFlowInfo_InitlevelEnv env=_tmpCA;
...
# 593
({void*_tmpD6=0U;({struct _fat_ptr _tmp249=({const char*_tmpD7="bad lookup_place";_tag_fat(_tmpD7,sizeof(char),17U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp249,_tag_fat(_tmpD6,sizeof(void*),0));});});}_LL3:;}}
# 595
return ans;}}
# 598
...
({void*_tmpED=0U;({unsigned _tmp24B=env->loc;struct _fat_ptr _tmp24A=({const char*_tmpEE="assignment puts possibly-uninitialized data in an escaped location";_tag_fat(_tmpEE,sizeof(char),67U);});Cyc_CfFlowInfo_aerr(_tmp24B,_tmp24A,_tag_fat(_tmpED,sizeof(void*),0));});});
# 659
...
_get_fat_size(d1,sizeof(void*));void**_tmpF0=_cycalloc(_check_times(_tmpF1,sizeof(void*)));({{unsigned _tmp1FC=_get_fat_size(d1,sizeof(void*));unsigned i;for(i=0;i < _tmp1FC;++ i){({void*_tmp24C=Cyc_CfFlowInfo_assign_place_inner(env,((void**)d1.curr)[(int)i],*((void**)_check_fat_subscript(d2,sizeof(void*),(int)i)));_tmpF0[i]=_tmp24C;});}}0;});_tag_fat(_tmpF0,sizeof(void*),_tmpF1);});
# 665
int change=0;
...
change=0;
{int i=0;for(0;(unsigned)i < _get_fat_size(d1,sizeof(void*));++ i){
if(({void*_tmp24D=*((void**)_check_fat_subscript(new_d,sizeof(void*),i));_tmp24D != *((void**)_check_fat_subscript(d2,sizeof(void*),i));})){
change=1;break;}}}
# 680
if(!change){
...
# 727
void*_tmp101=Cyc_CfFlowInfo_assign_place_outer(env,tl,path_prefix + 1,*((void**)_check_fat_subscript(d,sizeof(void*),fnum)),newval);void*new_child=_tmp101;
# 729
...
struct _fat_ptr _tmp24F=d;int _tmp24E=i;Cyc_CfFlowInfo_aggr_dict_insert(_tmp24F,_tmp24E,
...
struct Cyc_List_List*_tmp108=({int*_tmp250=({int*_tmp10B=_cycalloc_atomic(sizeof(*_tmp10B));*_tmp10B=path_prefix;_tmp10B;});((struct Cyc_List_List*(*)(int(*)(int*,void*),int*,struct Cyc_List_List*))Cyc_List_filter_c)((int(*)(int*,void*))Cyc_CfFlowInfo_nprefix,_tmp250,path);});struct Cyc_List_List*new_path=_tmp108;
...
({void*_tmp10D=0U;({struct _fat_ptr _tmp251=({const char*_tmp10E="bad assign place";_tag_fat(_tmp10E,sizeof(char),17U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp251,_tag_fat(_tmp10D,sizeof(void*),0));});});}};}}
# 760
...
struct Cyc_CfFlowInfo_AssignEnv env=({struct Cyc_CfFlowInfo_AssignEnv _tmp1FF;_tmp1FF.fenv=fenv,({struct Cyc_CfFlowInfo_EscPile*_tmp252=({struct Cyc_CfFlowInfo_EscPile*_tmp112=_cycalloc(sizeof(*_tmp112));_tmp112->places=0;_tmp112;});_tmp1FF.pile=_tmp252;}),_tmp1FF.d=d,_tmp1FF.loc=loc,_tmp1FF.root_place=place;_tmp1FF;});
void*newval=({struct Cyc_List_List*_tmp254=path;void*_tmp253=((void*(*)(struct Cyc_Dict_Dict,void*))Cyc_Dict_lookup)(d,root);Cyc_CfFlowInfo_assign_place_outer(& env,_tmp254,0,_tmp253,r);});
return({struct Cyc_CfFlowInfo_FlowEnv*_tmp256=fenv;struct Cyc_CfFlowInfo_EscPile*_tmp255=env.pile;Cyc_CfFlowInfo_escape_these(_tmp256,_tmp255,((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,void*))Cyc_Dict_insert)(d,root,newval));});}}struct Cyc_CfFlowInfo_JoinEnv{struct Cyc_CfFlowInfo_FlowEnv*fenv;struct Cyc_CfFlowInfo_EscPile*pile;struct Cyc_Dict_Dict d1;struct Cyc_Dict_Dict d2;int is_try_flow;};
# 784
...
if(r1 == r2)return r1;{
struct _tuple18 _tmp116=({struct _tuple18 _tmp200;({int _tmp258=Cyc_CfFlowInfo_contains_local_consumed(r1);_tmp200.f1=_tmp258;}),({int _tmp257=Cyc_CfFlowInfo_contains_local_consumed(r2);_tmp200.f2=_tmp257;});_tmp200;});struct _tuple18 _stmttmp15=_tmp116;struct _tuple18 _tmp117=_stmttmp15;switch((int)_tmp117.f1){case 1: if(_tmp117.f2 == 0)
...
# 830
if(n1 == n2)
return(void*)({struct Cyc_CfFlowInfo_NamedLocation_CfFlowInfo_AbsRVal_struct*_tmp124=_cycalloc(sizeof(*_tmp124));_tmp124->tag=8,_tmp124->f1=n1,({void*_tmp259=Cyc_CfFlowInfo_join_absRval(env,a,r1,r2);_tmp124->f2=_tmp259;});_tmp124;});else{
# 833
...
# 838
if(e1 == e2)
return(void*)({struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*_tmp125=_cycalloc(sizeof(*_tmp125));_tmp125->tag=7,_tmp125->f1=e1,i1 > i2?_tmp125->f2=i1:(_tmp125->f2=i2),({void*_tmp25A=Cyc_CfFlowInfo_join_absRval(env,a,r1,r2);_tmp125->f3=_tmp25A;}),_tmp125->f4=l1 && l2;_tmp125;});
...
# 874
return(void*)({struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*_tmp130=_cycalloc(sizeof(*_tmp130));_tmp130->tag=5,({void*_tmp25D=Cyc_CfFlowInfo_join_absRval(env,a,r1,r2);_tmp130->f1=_tmp25D;});_tmp130;});}case 1: _tmp120=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp119.f1)->f1;{void*r1=_tmp120;
# 877
...
_get_fat_size(d1,sizeof(void*));void**_tmp136=_cycalloc(_check_times(_tmp137,sizeof(void*)));({{unsigned _tmp201=_get_fat_size(d1,sizeof(void*));unsigned i;for(i=0;i < _tmp201;++ i){env->is_try_flow?({void*_tmp25F=((void*(*)(struct Cyc_CfFlowInfo_JoinEnv*,int,void*,void*))Cyc_CfFlowInfo_join_absRval_tryflow)(env,0,((void**)d1.curr)[(int)i],*((void**)_check_fat_subscript(d2,sizeof(void*),(int)i)));_tmp136[i]=_tmp25F;}):({
void*_tmp25E=Cyc_CfFlowInfo_join_absRval(env,a,((void**)d1.curr)[(int)i],*((void**)_check_fat_subscript(d2,sizeof(void*),(int)i)));_tmp136[i]=_tmp25E;});}}0;});_tag_fat(_tmp136,sizeof(void*),_tmp137);});
# 897
int change=0;
{int i=0;for(0;(unsigned)i < _get_fat_size(d1,sizeof(void*));++ i){
if(*((void**)_check_fat_subscript(new_d,sizeof(void*),i))!= ((void**)d1.curr)[i]){
...
change=0;
{int i=0;for(0;(unsigned)i < _get_fat_size(d1,sizeof(void*));++ i){
if(({void*_tmp260=*((void**)_check_fat_subscript(new_d,sizeof(void*),i));_tmp260 != *((void**)_check_fat_subscript(d2,sizeof(void*),i));})){
change=1;break;}}}
# 912
if(!change){
...
return({struct Cyc_Dict_Dict _tmp262=Cyc_CfFlowInfo_escape_these(fenv,env.pile,outdict);Cyc_CfFlowInfo_ReachableFL(_tmp262,r);});}}}};}
# 960
...
struct Cyc_CfFlowInfo_JoinEnv _tmp14E=({struct Cyc_CfFlowInfo_JoinEnv _tmp208;_tmp208.fenv=fenv,({struct Cyc_CfFlowInfo_EscPile*_tmp263=({struct Cyc_CfFlowInfo_EscPile*_tmp151=_cycalloc(sizeof(*_tmp151));_tmp151->places=0;_tmp151;});_tmp208.pile=_tmp263;}),_tmp208.d1=d1,_tmp208.d2=d2,_tmp208.is_try_flow=0;_tmp208;});struct Cyc_CfFlowInfo_JoinEnv env=_tmp14E;
...
return({struct Cyc_Dict_Dict _tmp264=Cyc_CfFlowInfo_escape_these(fenv,env.pile,outdict);Cyc_CfFlowInfo_ReachableFL(_tmp264,r);});}}}};}struct _tuple21{union Cyc_CfFlowInfo_FlowInfo f1;void*f2;};struct _tuple22{union Cyc_CfFlowInfo_FlowInfo f1;union Cyc_CfFlowInfo_FlowInfo f2;union Cyc_CfFlowInfo_FlowInfo f3;};
# 978
...
struct Cyc_CfFlowInfo_JoinEnv _tmp15E=({struct Cyc_CfFlowInfo_JoinEnv _tmp20F;_tmp20F.fenv=fenv,({struct Cyc_CfFlowInfo_EscPile*_tmp265=({struct Cyc_CfFlowInfo_EscPile*_tmp160=_cycalloc(sizeof(*_tmp160));_tmp160->places=0;_tmp160;});_tmp20F.pile=_tmp265;}),_tmp20F.d1=d1,_tmp20F.d2=d2,_tmp20F.is_try_flow=0;_tmp20F;});struct Cyc_CfFlowInfo_JoinEnv env=_tmp15E;
void*_tmp15F=((void*(*)(struct Cyc_CfFlowInfo_JoinEnv*,int,void*,void*))Cyc_CfFlowInfo_join_absRval)(& env,0,r1,r2);void*outr=_tmp15F;
return({struct _tuple21 _tmp20E;({union Cyc_CfFlowInfo_FlowInfo _tmp267=({struct Cyc_Dict_Dict _tmp266=Cyc_CfFlowInfo_escape_these(fenv,env.pile,outd);Cyc_CfFlowInfo_ReachableFL(_tmp266,relns);});_tmp20E.f1=_tmp267;}),_tmp20E.f2=outr;_tmp20E;});}}}else{
# 997
({void*_tmp161=0U;({struct _fat_ptr _tmp268=({const char*_tmp162="join_flow_and_rval: BottomFL outflow";_tag_fat(_tmp162,sizeof(char),37U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp268,_tag_fat(_tmp161,sizeof(void*),0));});});}}};}}}
# 1002
...
# 1033
 goto _LL0;}}}}}}}}}_LL0:;}{
# 1035
struct _tuple19 _tmp16F=({struct _tuple19 _tmp212;({enum Cyc_CfFlowInfo_InitLevel _tmp26A=Cyc_CfFlowInfo_initlevel_approx(r1);_tmp212.f1=_tmp26A;}),({enum Cyc_CfFlowInfo_InitLevel _tmp269=Cyc_CfFlowInfo_initlevel_approx(r2);_tmp212.f2=_tmp269;});_tmp212;});struct _tuple19 _stmttmp22=_tmp16F;struct _tuple19 _tmp170=_stmttmp22;if(_tmp170.f1 == Cyc_CfFlowInfo_AllIL)
...
({void*_tmp17C=0U;({struct Cyc___cycFILE*_tmp26C=Cyc_stderr;struct _fat_ptr _tmp26B=({const char*_tmp17D="uninitialized";_tag_fat(_tmp17D,sizeof(char),14U);});Cyc_fprintf(_tmp26C,_tmp26B,_tag_fat(_tmp17C,sizeof(void*),0));});});goto _LL0;}else{
({void*_tmp17E=0U;({struct Cyc___cycFILE*_tmp26E=Cyc_stderr;struct _fat_ptr _tmp26D=({const char*_tmp17F="all-initialized";_tag_fat(_tmp17F,sizeof(char),16U);});Cyc_fprintf(_tmp26E,_tmp26D,_tag_fat(_tmp17E,sizeof(void*),0));});});goto _LL0;}_LL0:;}
# 1081
...
# 1084
({struct Cyc_String_pa_PrintArg_struct _tmp185=({struct Cyc_String_pa_PrintArg_struct _tmp215;_tmp215.tag=0,({struct _fat_ptr _tmp26F=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp215.f1=_tmp26F;});_tmp215;});void*_tmp183[1];_tmp183[0]=& _tmp185;({struct Cyc___cycFILE*_tmp271=Cyc_stderr;struct _fat_ptr _tmp270=({const char*_tmp184="Root(%s)";_tag_fat(_tmp184,sizeof(char),9U);});Cyc_fprintf(_tmp271,_tmp270,_tag_fat(_tmp183,sizeof(void*),1));});});goto _LL0;}case 1: _tmp181=((struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_tmp180)->f1;_tmp182=(void*)((struct Cyc_CfFlowInfo_MallocPt_CfFlowInfo_Root_struct*)_tmp180)->f2;{struct Cyc_Absyn_Exp*e=_tmp181;void*t=_tmp182;
# 1086
({struct Cyc_String_pa_PrintArg_struct _tmp188=({struct Cyc_String_pa_PrintArg_struct _tmp217;_tmp217.tag=0,({
struct _fat_ptr _tmp272=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp217.f1=_tmp272;});_tmp217;});struct Cyc_String_pa_PrintArg_struct _tmp189=({struct Cyc_String_pa_PrintArg_struct _tmp216;_tmp216.tag=0,({struct _fat_ptr _tmp273=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_typ2string(t));_tmp216.f1=_tmp273;});_tmp216;});void*_tmp186[2];_tmp186[0]=& _tmp188,_tmp186[1]=& _tmp189;({struct Cyc___cycFILE*_tmp275=Cyc_stderr;struct _fat_ptr _tmp274=({const char*_tmp187="MallocPt(%s,%s)";_tag_fat(_tmp187,sizeof(char),16U);});Cyc_fprintf(_tmp275,_tmp274,_tag_fat(_tmp186,sizeof(void*),2));});});goto _LL0;}default:
# 1089
({void*_tmp18A=0U;({struct Cyc___cycFILE*_tmp277=Cyc_stderr;struct _fat_ptr _tmp276=({const char*_tmp18B="InitParam(_,_)";_tag_fat(_tmp18B,sizeof(char),15U);});Cyc_fprintf(_tmp277,_tmp276,_tag_fat(_tmp18A,sizeof(void*),0));});});goto _LL0;}_LL0:;}
# 1093
...
# 1097
({struct Cyc_Int_pa_PrintArg_struct _tmp191=({struct Cyc_Int_pa_PrintArg_struct _tmp218;_tmp218.tag=1,_tmp218.f1=(unsigned long)i;_tmp218;});void*_tmp18F[1];_tmp18F[0]=& _tmp191;({struct Cyc___cycFILE*_tmp279=Cyc_stderr;struct _fat_ptr _tmp278=({const char*_tmp190=".%d";_tag_fat(_tmp190,sizeof(char),4U);});Cyc_fprintf(_tmp279,_tmp278,_tag_fat(_tmp18F,sizeof(void*),1));});});
goto _LL0;}}else{
# 1100
if(x->tl != 0){
...
# 1103
x=x->tl;
({struct Cyc_Int_pa_PrintArg_struct _tmp197=({struct Cyc_Int_pa_PrintArg_struct _tmp219;_tmp219.tag=1,_tmp219.f1=(unsigned long)i;_tmp219;});void*_tmp195[1];_tmp195[0]=& _tmp197;({struct Cyc___cycFILE*_tmp27B=Cyc_stderr;struct _fat_ptr _tmp27A=({const char*_tmp196="->%d";_tag_fat(_tmp196,sizeof(char),5U);});Cyc_fprintf(_tmp27B,_tmp27A,_tag_fat(_tmp195,sizeof(void*),1));});});
continue;}}else{
goto _LL5;}_LL5:;}
# 1109
({void*_tmp198=0U;({struct Cyc___cycFILE*_tmp27D=Cyc_stderr;struct _fat_ptr _tmp27C=({const char*_tmp199="*";_tag_fat(_tmp199,sizeof(char),2U);});Cyc_fprintf(_tmp27D,_tmp27C,_tag_fat(_tmp198,sizeof(void*),0));});});}_LL0:;}}
# 1112
({void*_tmp19A=0U;({struct Cyc___cycFILE*_tmp27F=Cyc_stderr;struct _fat_ptr _tmp27E=({const char*_tmp19B=" ";_tag_fat(_tmp19B,sizeof(char),2U);});Cyc_fprintf(_tmp27F,_tmp27E,_tag_fat(_tmp19A,sizeof(void*),0));});});}
# 1115
...
while(x != 0){
if(!first){({void*_tmp19D=0U;({struct Cyc___cycFILE*_tmp281=Cyc_stderr;struct _fat_ptr _tmp280=({const char*_tmp19E=", ";_tag_fat(_tmp19E,sizeof(char),3U);});Cyc_fprintf(_tmp281,_tmp280,_tag_fat(_tmp19D,sizeof(void*),0));});});first=0;}
pr(x->hd);
x=x->tl;}
# 1127
({void*_tmp19F=0U;({struct Cyc___cycFILE*_tmp283=Cyc_stderr;struct _fat_ptr _tmp282=({const char*_tmp1A0="\n";_tag_fat(_tmp1A0,sizeof(char),2U);});Cyc_fprintf(_tmp283,_tmp282,_tag_fat(_tmp19F,sizeof(void*),0));});});}
# 1130
...
({void*_tmp1A8=0U;({struct Cyc___cycFILE*_tmp285=Cyc_stderr;struct _fat_ptr _tmp284=({const char*_tmp1A9="Zero";_tag_fat(_tmp1A9,sizeof(char),5U);});Cyc_fprintf(_tmp285,_tmp284,_tag_fat(_tmp1A8,sizeof(void*),0));});});goto _LL0;case 1:
({void*_tmp1AA=0U;({struct Cyc___cycFILE*_tmp287=Cyc_stderr;struct _fat_ptr _tmp286=({const char*_tmp1AB="NotZeroAll";_tag_fat(_tmp1AB,sizeof(char),11U);});Cyc_fprintf(_tmp287,_tmp286,_tag_fat(_tmp1AA,sizeof(void*),0));});});goto _LL0;case 2: _tmp1A7=((struct Cyc_CfFlowInfo_UnknownR_CfFlowInfo_AbsRVal_struct*)_tmp1A1)->f1;{enum Cyc_CfFlowInfo_InitLevel il=_tmp1A7;
({void*_tmp1AC=0U;({struct Cyc___cycFILE*_tmp289=Cyc_stderr;struct _fat_ptr _tmp288=({const char*_tmp1AD="Unknown(";_tag_fat(_tmp1AD,sizeof(char),9U);});Cyc_fprintf(_tmp289,_tmp288,_tag_fat(_tmp1AC,sizeof(void*),0));});});Cyc_CfFlowInfo_print_initlevel(il);
({void*_tmp1AE=0U;({struct Cyc___cycFILE*_tmp28B=Cyc_stderr;struct _fat_ptr _tmp28A=({const char*_tmp1AF=")";_tag_fat(_tmp1AF,sizeof(char),2U);});Cyc_fprintf(_tmp28B,_tmp28A,_tag_fat(_tmp1AE,sizeof(void*),0));});});goto _LL0;}case 3: _tmp1A7=((struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*)_tmp1A1)->f1;{enum Cyc_CfFlowInfo_InitLevel il=_tmp1A7;
({void*_tmp1B0=0U;({struct Cyc___cycFILE*_tmp28D=Cyc_stderr;struct _fat_ptr _tmp28C=({const char*_tmp1B1="Esc(";_tag_fat(_tmp1B1,sizeof(char),5U);});Cyc_fprintf(_tmp28D,_tmp28C,_tag_fat(_tmp1B0,sizeof(void*),0));});});Cyc_CfFlowInfo_print_initlevel(il);
({void*_tmp1B2=0U;({struct Cyc___cycFILE*_tmp28F=Cyc_stderr;struct _fat_ptr _tmp28E=({const char*_tmp1B3=")";_tag_fat(_tmp1B3,sizeof(char),2U);});Cyc_fprintf(_tmp28F,_tmp28E,_tag_fat(_tmp1B2,sizeof(void*),0));});});goto _LL0;}case 4: _tmp1A2=((struct Cyc_CfFlowInfo_AddressOf_CfFlowInfo_AbsRVal_struct*)_tmp1A1)->f1;{struct Cyc_CfFlowInfo_Place*p=_tmp1A2;
({void*_tmp1B4=0U;({struct Cyc___cycFILE*_tmp291=Cyc_stderr;struct _fat_ptr _tmp290=({const char*_tmp1B5="AddrOf(";_tag_fat(_tmp1B5,sizeof(char),8U);});Cyc_fprintf(_tmp291,_tmp290,_tag_fat(_tmp1B4,sizeof(void*),0));});});Cyc_CfFlowInfo_print_place(p);
({void*_tmp1B6=0U;({struct Cyc___cycFILE*_tmp293=Cyc_stderr;struct _fat_ptr _tmp292=({const char*_tmp1B7=")";_tag_fat(_tmp1B7,sizeof(char),2U);});Cyc_fprintf(_tmp293,_tmp292,_tag_fat(_tmp1B6,sizeof(void*),0));});});goto _LL0;}case 5: _tmp1A2=(void*)((struct Cyc_CfFlowInfo_UniquePtr_CfFlowInfo_AbsRVal_struct*)_tmp1A1)->f1;{void*r=_tmp1A2;
({void*_tmp1B8=0U;({struct Cyc___cycFILE*_tmp295=Cyc_stderr;struct _fat_ptr _tmp294=({const char*_tmp1B9="UniquePtr(";_tag_fat(_tmp1B9,sizeof(char),11U);});Cyc_fprintf(_tmp295,_tmp294,_tag_fat(_tmp1B8,sizeof(void*),0));});});Cyc_CfFlowInfo_print_absrval(r);
({void*_tmp1BA=0U;({struct Cyc___cycFILE*_tmp297=Cyc_stderr;struct _fat_ptr _tmp296=({const char*_tmp1BB=")";_tag_fat(_tmp1BB,sizeof(char),2U);});Cyc_fprintf(_tmp297,_tmp296,_tag_fat(_tmp1BA,sizeof(void*),0));});});goto _LL0;}case 6: _tmp1A4=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp1A1)->f1).is_union;_tmp1A5=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp1A1)->f1).fieldnum;_tmp1A6=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmp1A1)->f2;{int is_union=_tmp1A4;int f=_tmp1A5;struct _fat_ptr d=_tmp1A6;
# 1143
if(is_union){
({void*_tmp1BC=0U;({struct Cyc___cycFILE*_tmp299=Cyc_stderr;struct _fat_ptr _tmp298=({const char*_tmp1BD="AggrUnion{";_tag_fat(_tmp1BD,sizeof(char),11U);});Cyc_fprintf(_tmp299,_tmp298,_tag_fat(_tmp1BC,sizeof(void*),0));});});
if(f != -1)
({struct Cyc_Int_pa_PrintArg_struct _tmp1C0=({struct Cyc_Int_pa_PrintArg_struct _tmp21A;_tmp21A.tag=1,_tmp21A.f1=(unsigned long)f;_tmp21A;});void*_tmp1BE[1];_tmp1BE[0]=& _tmp1C0;({struct Cyc___cycFILE*_tmp29B=Cyc_stderr;struct _fat_ptr _tmp29A=({const char*_tmp1BF="tag == %d;";_tag_fat(_tmp1BF,sizeof(char),11U);});Cyc_fprintf(_tmp29B,_tmp29A,_tag_fat(_tmp1BE,sizeof(void*),1));});});}else{
# 1148
({void*_tmp1C1=0U;({struct Cyc___cycFILE*_tmp29D=Cyc_stderr;struct _fat_ptr _tmp29C=({const char*_tmp1C2="AggrStruct{";_tag_fat(_tmp1C2,sizeof(char),12U);});Cyc_fprintf(_tmp29D,_tmp29C,_tag_fat(_tmp1C1,sizeof(void*),0));});});}
{int i=0;for(0;(unsigned)i < _get_fat_size(d,sizeof(void*));++ i){
Cyc_CfFlowInfo_print_absrval(((void**)d.curr)[i]);
if((unsigned)(i + 1)< _get_fat_size(d,sizeof(void*)))({void*_tmp1C3=0U;({struct Cyc___cycFILE*_tmp29F=Cyc_stderr;struct _fat_ptr _tmp29E=({const char*_tmp1C4=",";_tag_fat(_tmp1C4,sizeof(char),2U);});Cyc_fprintf(_tmp29F,_tmp29E,_tag_fat(_tmp1C3,sizeof(void*),0));});});}}
# 1153
({void*_tmp1C5=0U;({struct Cyc___cycFILE*_tmp2A1=Cyc_stderr;struct _fat_ptr _tmp2A0=({const char*_tmp1C6="}";_tag_fat(_tmp1C6,sizeof(char),2U);});Cyc_fprintf(_tmp2A1,_tmp2A0,_tag_fat(_tmp1C5,sizeof(void*),0));});});
...
# 1156
({struct Cyc_String_pa_PrintArg_struct _tmp1C9=({struct Cyc_String_pa_PrintArg_struct _tmp21C;_tmp21C.tag=0,({struct _fat_ptr _tmp2A2=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp21C.f1=_tmp2A2;});_tmp21C;});struct Cyc_Int_pa_PrintArg_struct _tmp1CA=({struct Cyc_Int_pa_PrintArg_struct _tmp21B;_tmp21B.tag=1,_tmp21B.f1=(unsigned long)i;_tmp21B;});void*_tmp1C7[2];_tmp1C7[0]=& _tmp1C9,_tmp1C7[1]=& _tmp1CA;({struct Cyc___cycFILE*_tmp2A4=Cyc_stderr;struct _fat_ptr _tmp2A3=({const char*_tmp1C8="[Consumed(%s,%d,";_tag_fat(_tmp1C8,sizeof(char),17U);});Cyc_fprintf(_tmp2A4,_tmp2A3,_tag_fat(_tmp1C7,sizeof(void*),2));});});
Cyc_CfFlowInfo_print_absrval(r);({struct Cyc_String_pa_PrintArg_struct _tmp1CD=({struct Cyc_String_pa_PrintArg_struct _tmp21D;_tmp21D.tag=0,({struct _fat_ptr _tmp2A5=(struct _fat_ptr)(l?({const char*_tmp1CE="local";_tag_fat(_tmp1CE,sizeof(char),6U);}):({const char*_tmp1CF="";_tag_fat(_tmp1CF,sizeof(char),1U);}));_tmp21D.f1=_tmp2A5;});_tmp21D;});void*_tmp1CB[1];_tmp1CB[0]=& _tmp1CD;({struct Cyc___cycFILE*_tmp2A7=Cyc_stderr;struct _fat_ptr _tmp2A6=({const char*_tmp1CC=",%s)]";_tag_fat(_tmp1CC,sizeof(char),6U);});Cyc_fprintf(_tmp2A7,_tmp2A6,_tag_fat(_tmp1CB,sizeof(void*),1));});});
...
# 1160
({struct Cyc_String_pa_PrintArg_struct _tmp1D2=({struct Cyc_String_pa_PrintArg_struct _tmp21E;_tmp21E.tag=0,({struct _fat_ptr _tmp2A8=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(n->name));_tmp21E.f1=_tmp2A8;});_tmp21E;});void*_tmp1D0[1];_tmp1D0[0]=& _tmp1D2;({struct Cyc___cycFILE*_tmp2AA=Cyc_stderr;struct _fat_ptr _tmp2A9=({const char*_tmp1D1="[NamedLocation(%s,";_tag_fat(_tmp1D1,sizeof(char),19U);});Cyc_fprintf(_tmp2AA,_tmp2A9,_tag_fat(_tmp1D0,sizeof(void*),1));});});
Cyc_CfFlowInfo_print_absrval(r);({void*_tmp1D3=0U;({struct Cyc___cycFILE*_tmp2AC=Cyc_stderr;struct _fat_ptr _tmp2AB=({const char*_tmp1D4=")]";_tag_fat(_tmp1D4,sizeof(char),3U);});Cyc_fprintf(_tmp2AC,_tmp2AB,_tag_fat(_tmp1D3,sizeof(void*),0));});});
goto _LL0;}}_LL0:;}
# 1166
static void Cyc_CfFlowInfo_print_flow_mapping(void*root,void*rval){
({void*_tmp1D5=0U;({struct Cyc___cycFILE*_tmp2AE=Cyc_stderr;struct _fat_ptr _tmp2AD=({const char*_tmp1D6="    ";_tag_fat(_tmp1D6,sizeof(char),5U);});Cyc_fprintf(_tmp2AE,_tmp2AD,_tag_fat(_tmp1D5,sizeof(void*),0));});});
Cyc_CfFlowInfo_print_root(root);
({void*_tmp1D7=0U;({struct Cyc___cycFILE*_tmp2B0=Cyc_stderr;struct _fat_ptr _tmp2AF=({const char*_tmp1D8=" --> ";_tag_fat(_tmp1D8,sizeof(char),6U);});Cyc_fprintf(_tmp2B0,_tmp2AF,_tag_fat(_tmp1D7,sizeof(void*),0));});});
Cyc_CfFlowInfo_print_absrval(rval);
({void*_tmp1D9=0U;({struct Cyc___cycFILE*_tmp2B2=Cyc_stderr;struct _fat_ptr _tmp2B1=({const char*_tmp1DA="\n";_tag_fat(_tmp1DA,sizeof(char),2U);});Cyc_fprintf(_tmp2B2,_tmp2B1,_tag_fat(_tmp1D9,sizeof(void*),0));});});}
# 1174
...
({void*_tmp1DE=0U;({struct Cyc___cycFILE*_tmp2B4=Cyc_stderr;struct _fat_ptr _tmp2B3=({const char*_tmp1DF="  BottomFL\n";_tag_fat(_tmp1DF,sizeof(char),12U);});Cyc_fprintf(_tmp2B4,_tmp2B3,_tag_fat(_tmp1DE,sizeof(void*),0));});});goto _LL0;}else{_tmp1DC=((_tmp1DB.ReachableFL).val).f1;_tmp1DD=((_tmp1DB.ReachableFL).val).f2;{struct Cyc_Dict_Dict fd=_tmp1DC;struct Cyc_List_List*rlns=_tmp1DD;
# 1182
({void*_tmp1E0=0U;({struct Cyc___cycFILE*_tmp2B6=Cyc_stderr;struct _fat_ptr _tmp2B5=({const char*_tmp1E1="  ReachableFL:\n";_tag_fat(_tmp1E1,sizeof(char),16U);});Cyc_fprintf(_tmp2B6,_tmp2B5,_tag_fat(_tmp1E0,sizeof(void*),0));});});
Cyc_CfFlowInfo_print_flowdict(fd);
({void*_tmp1E2=0U;({struct Cyc___cycFILE*_tmp2B8=Cyc_stderr;struct _fat_ptr _tmp2B7=({const char*_tmp1E3="\n  Relations: ";_tag_fat(_tmp1E3,sizeof(char),15U);});Cyc_fprintf(_tmp2B8,_tmp2B7,_tag_fat(_tmp1E2,sizeof(void*),0));});});
Cyc_Relations_print_relns(Cyc_stderr,rlns);
({void*_tmp1E4=0U;({struct Cyc___cycFILE*_tmp2BA=Cyc_stderr;struct _fat_ptr _tmp2B9=({const char*_tmp1E5="\n";_tag_fat(_tmp1E5,sizeof(char),2U);});Cyc_fprintf(_tmp2BA,_tmp2B9,_tag_fat(_tmp1E4,sizeof(void*),0));});});
goto _LL0;}}_LL0:;}
