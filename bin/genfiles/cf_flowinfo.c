...
# 187
struct _tuple13*_tmp3A=env;struct _RegionHandle*_tmp40;struct Cyc_List_List*_tmp3F;_LL1: _tmp40=_tmp3A->f1;_tmp3F=_tmp3A->f2;_LL2:;{
...
return({struct Cyc_Absyn_Aggrfield*_tmp3E=_region_malloc(_tmp40,sizeof(*_tmp3E));_tmp3E->name=f->name,_tmp3E->tq=f->tq,_tmp3E->type=_tmp3B,_tmp3E->width=f->width,_tmp3E->attributes=f->attributes,_tmp3E->requires_clause=_tmp3D;_tmp3E;});};}struct _tuple14{struct Cyc_Absyn_Tvar*f1;void*f2;};
# 198
...
{struct Cyc_Absyn_Kind*_tmp44=Cyc_Tcutil_tvar_kind(_tmp42,& Cyc_Tcutil_bk);struct Cyc_Absyn_Kind*_tmp45=_tmp44;switch(((struct Cyc_Absyn_Kind*)_tmp45)->kind){case Cyc_Absyn_RgnKind: _LL1: _LL2:
 ...
 goto _LL0;}_LL0:;}
# 217
inst=({struct Cyc_List_List*_tmp47=_region_malloc(temp,sizeof(*_tmp47));({struct _tuple14*_tmp265=({struct _tuple14*_tmp46=_region_malloc(temp,sizeof(*_tmp46));_tmp46->f1=_tmp42,_tmp46->f2=_tmp43;_tmp46;});_tmp47->hd=_tmp265;}),_tmp47->tl=inst;_tmp47;});}
# 219
if(inst != 0){
struct _tuple13 _tmp48=({struct _tuple13 _tmp22A;_tmp22A.f1=temp,({struct Cyc_List_List*_tmp266=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(inst);_tmp22A.f2=_tmp266;});_tmp22A;});
struct Cyc_List_List*subs_fs=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_Absyn_Aggrfield*(*f)(struct _tuple13*,struct Cyc_Absyn_Aggrfield*),struct _tuple13*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(temp,Cyc_CfFlowInfo_substitute_field,& _tmp48,fs);
...
({void*_tmp268=Cyc_CfFlowInfo_i_typ_to_absrval(fenv,0,no_init_bits_only,(*((struct _tuple15*)((struct Cyc_List_List*)_check_null(_tmp59))->hd)).f2,leafval);*((void**)_check_fat_subscript(d,sizeof(void*),i))=_tmp268;});
_tmp59=_tmp59->tl;}}
# 248
...
({void*_tmp26C=Cyc_CfFlowInfo_make_unique_consumed(fenv,(*((struct _tuple15*)((struct Cyc_List_List*)_check_null(_tmp8B))->hd)).f2,consumer,iteration,((void**)_tmp89.curr)[i]);*((void**)_check_fat_subscript(d2,sizeof(void*),i))=_tmp26C;});
_tmp8B=_tmp8B->tl;}}
# 360
...
struct _tuple17 _tmpB6=({struct _tuple17 _tmp233;_tmp233.f1=path,_tmp233.f2=old_val;_tmp233;});struct _tuple17 _tmpB7=_tmpB6;struct Cyc_Absyn_Vardecl*_tmpC8;void*_tmpC7;struct Cyc_List_List*_tmpC6;void*_tmpC5;int _tmpC4;struct Cyc_List_List*_tmpC3;int _tmpC2;struct _fat_ptr _tmpC1;if(_tmpB7.f1 != 0){if(((struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*)((struct Cyc_List_List*)_tmpB7.f1)->hd)->tag == 0U)switch(*((int*)_tmpB7.f2)){case 6U: _LL1: _tmpC4=((struct Cyc_CfFlowInfo_Dot_CfFlowInfo_PathCon_struct*)(_tmpB7.f1)->hd)->f1;_tmpC3=(_tmpB7.f1)->tl;_tmpC2=(((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmpB7.f2)->f1).is_union;_tmpC1=((struct Cyc_CfFlowInfo_Aggregate_CfFlowInfo_AbsRVal_struct*)_tmpB7.f2)->f2;_LL2: {
# 466
...
struct _tuple12 _tmp174=({struct _tuple12 _tmp23E;_tmp23E.f1=r1,_tmp23E.f2=r2;_tmp23E;});struct _tuple12 _tmp175=_tmp174;if(((struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*)_tmp175.f1)->tag == 3U){_LL40: _LL41:
 goto _LL43;}else{if(((struct Cyc_CfFlowInfo_Esc_CfFlowInfo_AbsRVal_struct*)_tmp175.f2)->tag == 3U){_LL42: _LL43: {
# 892
struct _tuple18 _tmp176=({struct _tuple18 _tmp23C;_tmp23C.f1=il1,_tmp23C.f2=il2;_tmp23C;});struct _tuple18 _tmp177=_tmp176;if(_tmp177.f2 == Cyc_CfFlowInfo_NoneIL){_LL47: _LL48:
...
# 897
struct _tuple18 _tmp178=({struct _tuple18 _tmp23D;_tmp23D.f1=il1,_tmp23D.f2=il2;_tmp23D;});struct _tuple18 _tmp179=_tmp178;if(_tmp179.f2 == Cyc_CfFlowInfo_NoneIL){_LL4E: _LL4F:
...
# 906
struct _tuple19 _tmp17A=({struct _tuple19 _tmp240;_tmp240.f1=f1,_tmp240.f2=f2;_tmp240;});struct _tuple19 _tmp17B=_tmp17A;struct Cyc_Dict_Dict _tmp183;struct Cyc_List_List*_tmp182;struct Cyc_Dict_Dict _tmp181;struct Cyc_List_List*_tmp180;if(((_tmp17B.f1).BottomFL).tag == 1){_LL1: _LL2:
...
return({struct Cyc_Dict_Dict _tmp290=Cyc_CfFlowInfo_escape_these(fenv,_tmp17C.pile,_tmp17D);Cyc_CfFlowInfo_ReachableFL(_tmp290,_tmp17E);});};}}_LL0:;}struct _tuple20{union Cyc_CfFlowInfo_FlowInfo f1;void*f2;};struct _tuple21{union Cyc_CfFlowInfo_FlowInfo f1;union Cyc_CfFlowInfo_FlowInfo f2;union Cyc_CfFlowInfo_FlowInfo f3;};
# 922
...
# 927
struct _tuple20 _tmp184=pr1;union Cyc_CfFlowInfo_FlowInfo _tmp194;void*_tmp193;_LL1: _tmp194=_tmp184.f1;_tmp193=_tmp184.f2;_LL2:;{
struct _tuple20 _tmp185=pr2;union Cyc_CfFlowInfo_FlowInfo _tmp192;void*_tmp191;_LL4: _tmp192=_tmp185.f1;_tmp191=_tmp185.f2;_LL5:;{
...
struct _tuple21 _tmp186=({struct _tuple21 _tmp247;_tmp247.f1=_tmp194,_tmp247.f2=_tmp192,_tmp247.f3=outflow;_tmp247;});struct _tuple21 _tmp187=_tmp186;struct Cyc_Dict_Dict _tmp190;struct Cyc_Dict_Dict _tmp18F;struct Cyc_Dict_Dict _tmp18E;struct Cyc_List_List*_tmp18D;if(((_tmp187.f1).BottomFL).tag == 1){_LL7: _LL8:
 return({struct _tuple20 _tmp241;_tmp241.f1=outflow,_tmp241.f2=_tmp191;_tmp241;});}else{if(((_tmp187.f2).BottomFL).tag == 1){_LL9: _LLA:
 return({struct _tuple20 _tmp242;_tmp242.f1=outflow,_tmp242.f2=_tmp193;_tmp242;});}else{if(((_tmp187.f3).ReachableFL).tag == 2){_LLB: _tmp190=(((_tmp187.f1).ReachableFL).val).f1;_tmp18F=(((_tmp187.f2).ReachableFL).val).f1;_tmp18E=(((_tmp187.f3).ReachableFL).val).f1;_tmp18D=(((_tmp187.f3).ReachableFL).val).f2;_LLC:
# 935
 if(((int(*)(int ignore,void*r1,void*r2))Cyc_CfFlowInfo_absRval_lessthan_approx)(0,_tmp193,_tmp191))return({struct _tuple20 _tmp243;_tmp243.f1=outflow,_tmp243.f2=_tmp191;_tmp243;});
if(((int(*)(int ignore,void*r1,void*r2))Cyc_CfFlowInfo_absRval_lessthan_approx)(0,_tmp191,_tmp193))return({struct _tuple20 _tmp244;_tmp244.f1=outflow,_tmp244.f2=_tmp193;_tmp244;});{
...
return({struct _tuple20 _tmp245;({union Cyc_CfFlowInfo_FlowInfo _tmp293=({struct Cyc_Dict_Dict _tmp292=Cyc_CfFlowInfo_escape_these(fenv,_tmp188.pile,_tmp18E);Cyc_CfFlowInfo_ReachableFL(_tmp292,_tmp18D);});_tmp245.f1=_tmp293;}),_tmp245.f2=_tmp189;_tmp245;});};}else{_LLD: _LLE:
# 941
...
int Cyc_CfFlowInfo_flow_lessthan_approx(union Cyc_CfFlowInfo_FlowInfo f1,union Cyc_CfFlowInfo_FlowInfo f2){
# 994
struct _tuple19 _tmp1A7=({struct _tuple19 _tmp24A;_tmp24A.f1=f1,_tmp24A.f2=f2;_tmp24A;});struct _tuple19 _tmp1A8=_tmp1A7;struct Cyc_Dict_Dict _tmp1AC;struct Cyc_List_List*_tmp1AB;struct Cyc_Dict_Dict _tmp1AA;struct Cyc_List_List*_tmp1A9;if(((_tmp1A8.f1).BottomFL).tag == 1){_LL1: _LL2:
...
return((int(*)(int(*f)(void*,void*,void*),struct Cyc_Dict_Dict d1,struct Cyc_Dict_Dict d2))Cyc_Dict_forall_intersect)((int(*)(void*ignore,void*r1,void*r2))Cyc_CfFlowInfo_absRval_lessthan_approx,_tmp1AC,_tmp1AA)&&
 Cyc_Relations_relns_approx(_tmp1AB,_tmp1A9);}}_LL0:;}struct _tuple22{void*f1;struct Cyc_List_List*f2;};
# 1004
