...
# 394
extern struct Cyc_List_List*Cyc_List_filter_c(int(*f)(void*,void*),void*env,struct Cyc_List_List*x);struct Cyc_Iter_Iter{void*env;int(*next)(void*env,void*dest);};
# 37 "iter.h"
...
# 212
extern struct Cyc_Dict_Dict Cyc_Dict_intersect_c(void*(*f)(void*,void*,void*,void*),void*env,struct Cyc_Dict_Dict d1,struct Cyc_Dict_Dict d2);
# 222
extern int Cyc_Dict_forall_intersect(int(*f)(void*,void*,void*),struct Cyc_Dict_Dict d1,struct Cyc_Dict_Dict d2);
# 283
extern struct Cyc_Iter_Iter Cyc_Dict_make_iter(struct _RegionHandle*rgn,struct Cyc_Dict_Dict d);
# 50 "string.h"
...
({void*_tmp12=0U;({struct _fat_ptr _tmp260=({const char*_tmp13="error locations not for VarRoots";_tag_fat(_tmp13,sizeof(char),33U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp260,_tag_fat(_tmp12,sizeof(void*),0U));});});}_LL3:;}}
# 87
int Cyc_CfFlowInfo_get_field_index_fs(struct Cyc_List_List*fs,struct _fat_ptr*f){
int n=0;
...
void*_tmp18=Cyc_Absyn_compress(t);void*_stmttmp1=_tmp18;void*_tmp19=_stmttmp1;struct Cyc_List_List*_tmp1A;union Cyc_Absyn_AggrInfo _tmp1B;switch(*((int*)_tmp19)){case 0U: if(((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp19)->f1)->tag == 20U){_LL1: _tmp1B=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp19)->f1)->f1;_LL2: {union Cyc_Absyn_AggrInfo info=_tmp1B;
# 100
...
return(void*)({struct Cyc_CfFlowInfo_Consumed_CfFlowInfo_AbsRVal_struct*_tmp92=_cycalloc(sizeof(*_tmp92));_tmp92->tag=7U,_tmp92->f1=consumer,_tmp92->f2=iteration,_tmp92->f3=r;_tmp92;});
