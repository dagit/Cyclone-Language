...
++ i; x=(( struct Cyc_List_List*) _check_null( x))->tl;} return i;}
unsigned char Cyc_List_List_empty[ 15u]="\000\000\000\000List_empty"; void* Cyc_List_hd(
...
_temp6->hd=( void*) f( env,( void*)(( struct Cyc_List_List*) _check_null( x))->hd);
...
struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp7->hd=( void*) f( env,( void*)(( struct Cyc_List_List*) _check_null( x))->hd);
...
struct Cyc_List_List* _temp8=( struct Cyc_List_List*) _region_malloc( r3,
sizeof( struct Cyc_List_List)); _temp8->hd=( void*) f(( void*)(( struct Cyc_List_List*)
...
x))->tl; y=(( struct Cyc_List_List*) _check_null( y))->tl; while( x !=  0? y != 
0: 0) {(( struct Cyc_List_List*) _check_null( prev))->tl=({ struct Cyc_List_List*
...
!=  0? 1: y !=  0){( int) _throw(( void*) Cyc_List_List_mismatch);} return
result;} struct Cyc_List_List* Cyc_List_map2( void*(* f)( void*, void*), struct
Cyc_List_List* x, struct Cyc_List_List* y){ return Cyc_List_rmap2( Cyc_Core_heap_region,
...
Cyc_List_List* y){ while( x !=  0) { y=({ struct Cyc_List_List* _temp10=( struct
Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List)); _temp10->hd=(
void*)(( void*)(( struct Cyc_List_List*) _check_null( x))->hd); _temp10->tl= y;
_temp10;}); x=(( struct Cyc_List_List*) _check_null( x))->tl;} return y;} struct
...
sizeof( struct Cyc_List_List)); _temp17->hd=( void*)({ struct _tuple2* _temp18=(
struct _tuple2*) _region_malloc( r4, sizeof( struct _tuple2)); _temp18->f1=(
void*)(( struct Cyc_List_List*) _check_null( x))->hd; _temp18->f2=( void*)((
struct Cyc_List_List*) _check_null( y))->hd; _temp18;}); _temp17->tl= 0; _temp17;});
...
prev2; if( x ==  0){ return({ struct _tuple0 _temp21; _temp21.f1= 0; _temp21.f2=
0; _temp21;});} prev1=( result1=({ struct Cyc_List_List* _temp22=( struct Cyc_List_List*)
...
compare)( void*, void*), struct Cyc_List_List* l, void* x){ while( l !=  0) {
if( compare(( void*)(( struct Cyc_List_List*) _check_null( l))->hd, x) ==  0){
return 1;} l=(( struct Cyc_List_List*) _check_null( l))->tl;} return 0;} void*
Cyc_List_assoc( struct Cyc_List_List* l, void* x){ while( l !=  0) { if((((
struct _tuple2*)(( struct Cyc_List_List*) _check_null( l))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f1 ==  x){ return((( struct _tuple2*)((
...
Cyc_Core_Not_found);} void* Cyc_List_assoc_cmp( int(* compare)( void*, void*),
struct Cyc_List_List* l, void* x){ while( l !=  0) { if( compare( x,((( struct
_tuple2*)(( struct Cyc_List_List*) _check_null( l))->hd)[
...
_temp41;});}} return Cyc_List_imp_rev( res);} struct Cyc_List_List* Cyc_List_tabulate(
...
<  n; ++ i){ res=({ struct Cyc_List_List* _temp42=( struct Cyc_List_List*)
_region_malloc( r, sizeof( struct Cyc_List_List)); _temp42->hd=( void*) f( env,
i); _temp42->tl= res; _temp42;});}} return Cyc_List_imp_rev( res);} struct Cyc_List_List*
...
Cyc_List_List*) _check_null( l2))->tl)){ if( l1 ==  l2){ return 0;}{ int _temp43=
cmp(( void*)(( struct Cyc_List_List*) _check_null( l1))->hd,( void*)(( struct
Cyc_List_List*) _check_null( l2))->hd); if( _temp43 !=  0){ return _temp43;}}}
...
struct Cyc_List_List*) _check_null( l2))->hd); if( _temp44 !=  0){ return 0;}}}
...
return 0;}{ struct Cyc_List_List* result=({ struct Cyc_List_List* _temp46=(
struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp46->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( l))->hd);
_temp46->tl= 0; _temp46;}); struct Cyc_List_List* end= result; for( 0; l !=  0;
l=(( struct Cyc_List_List*) _check_null( l))->tl){ if( f( env,( void*)(( struct
Cyc_List_List*) _check_null( l))->hd)){(( struct Cyc_List_List*) _check_null(
end))->tl=({ struct Cyc_List_List* _temp45=( struct Cyc_List_List*)
...
void*, void*), void* env, struct Cyc_List_List* l){ return Cyc_List_rfilter_c(
...
0){ return 0;}{ struct Cyc_List_List* result=({ struct Cyc_List_List* _temp48=(
struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp48->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( l))->hd);
_temp48->tl= 0; _temp48;}); struct Cyc_List_List* end= result; for( 0; l !=  0;
