...
extern int time( int* t); extern struct _tagged_arr Cyc_std_asctime( const
struct Cyc_std_tm* timeptr); extern struct _tagged_arr Cyc_std_ctime( const int*
timep); extern struct Cyc_std_tm* gmtime( const int* timep); extern struct Cyc_std_tm*
