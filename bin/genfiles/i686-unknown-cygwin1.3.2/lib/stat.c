...
unsigned char*); struct Cyc_std_tm{ int tm_sec; int tm_min; int tm_hour; int
tm_mday; int tm_mon; int tm_year; int tm_wday; int tm_yday; int tm_isdst; } ;
extern int time( int* t); extern struct Cyc_std_tm* gmtime( const int* timep);
extern struct Cyc_std_tm* localtime( const int* timep); extern int timezone;
extern int daylight; struct Cyc_std_stat_t{ short st_dev; unsigned int st_ino;
...
Cyc_std_stat_t* buf); int Cyc_std_open( struct _tagged_arr pathname, int flags,
