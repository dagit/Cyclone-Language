...
_tagged_arr*) *  _temp57); struct _tagged_arr _temp63= _tag_arr( _temp58,
sizeof( struct _tagged_arr*),( unsigned int)( i +  1));{ unsigned int _temp59=
_temp57; unsigned int j; for( j= 0; j <  _temp59; j ++){ _temp58[ j]= j <  fsz?*((
struct _tagged_arr**) _check_unknown_subscript( Cyc_Toc_field_names, sizeof(
struct _tagged_arr*),( int) j)):({ struct _tagged_arr* _temp60=( struct
_tagged_arr*) GC_malloc( sizeof( struct _tagged_arr)); _temp60[ 0]=( struct
_tagged_arr)({ struct Cyc_std_Int_pa_struct _temp62; _temp62.tag= Cyc_std_Int_pa;
_temp62.f1=( int) j;{ void* _temp61[ 1u]={& _temp62}; Cyc_std_aprintf( _tag_arr("f%d",
...
_LL87; _LL87: for( 0; _temp118 !=  0; _temp118=(( struct Cyc_List_List*)
_check_null( _temp118))->tl){ if( ! Cyc_Toc_is_zero((*(( struct _tuple4*)((
struct Cyc_List_List*) _check_null( _temp118))->hd)).f2)){ return 0;}} return 1;
_LL89: return 0; _LL65:;} static int Cyc_Toc_is_nullable( void* t){ void*
_temp120= Cyc_Tcutil_compress( t); struct Cyc_Absyn_PtrInfo _temp126; struct Cyc_Absyn_Conref*
_temp128; _LL122: if(( unsigned int) _temp120 >  4u?*(( int*) _temp120) ==  Cyc_Absyn_PointerType:
...
_temp141= tqs0; for( 0; _temp141 !=  0? _temp137 !=  0: 0;( _temp141=(( struct
Cyc_List_List*) _check_null( _temp141))->tl, _temp137=(( struct Cyc_List_List*)
_check_null( _temp137))->tl)){ if( ! Cyc_Tcutil_unify((*(( struct _tuple3*)((
struct Cyc_List_List*) _check_null( _temp141))->hd)).f2,( void*)(( struct Cyc_List_List*)
_check_null( _temp137))->hd)){ break;}} if( _temp141 ==  0? _temp137 ==  0: 0){
return _temp139;}}}}{ struct _tagged_arr* x=({ struct _tagged_arr* _temp155=(
struct _tagged_arr*) GC_malloc( sizeof( struct _tagged_arr)); _temp155[ 0]=(
struct _tagged_arr)({ struct Cyc_std_Int_pa_struct _temp157; _temp157.tag= Cyc_std_Int_pa;
...
void* _temp322; _LL205: if( _temp203 == ( void*) Cyc_Absyn_VoidType){ goto
_LL206;} else{ goto _LL207;} _LL207: if(( unsigned int) _temp203 >  4u?*(( int*)
_temp203) ==  Cyc_Absyn_Evar: 0){ _LL258: _temp257=(( struct Cyc_Absyn_Evar_struct*)
_temp203)->f2; if( _temp257 ==  0){ goto _LL208;} else{ goto _LL209;}} else{
goto _LL209;} _LL209: if(( unsigned int) _temp203 >  4u?*(( int*) _temp203) == 
Cyc_Absyn_Evar: 0){ _LL260: _temp259=(( struct Cyc_Absyn_Evar_struct*) _temp203)->f2;
if( _temp259 ==  0){ goto _LL211;} else{ _temp261=* _temp259; _LL263: _temp262=(
void*) _temp261.v; goto _LL210;}} else{ goto _LL211;} _LL211: if(( unsigned int)
_temp203 >  4u?*(( int*) _temp203) ==  Cyc_Absyn_VarType: 0){ goto _LL212;}
else{ goto _LL213;} _LL213: if(( unsigned int) _temp203 >  4u?*(( int*) _temp203)
...
if(( unsigned int) _temp203 >  4u?*(( int*) _temp203) ==  Cyc_Absyn_TunionType:
0){ goto _LL216;} else{ goto _LL217;} _LL217: if(( unsigned int) _temp203 >  4u?*((
int*) _temp203) ==  Cyc_Absyn_TunionFieldType: 0){ _LL271: _temp270=(( struct
Cyc_Absyn_TunionFieldType_struct*) _temp203)->f1; _LL273: _temp272=( void*)
_temp270.field_info; if(*(( int*) _temp272) ==  Cyc_Absyn_KnownTunionfield){
_LL277: _temp276=(( struct Cyc_Absyn_KnownTunionfield_struct*) _temp272)->f1;
goto _LL275; _LL275: _temp274=(( struct Cyc_Absyn_KnownTunionfield_struct*)
...
_temp203 >  4u?*(( int*) _temp203) ==  Cyc_Absyn_TypedefType: 0){ _LL321:
_temp320=(( struct Cyc_Absyn_TypedefType_struct*) _temp203)->f1; goto _LL319;
_LL319: _temp318=(( struct Cyc_Absyn_TypedefType_struct*) _temp203)->f2; goto
_LL317; _LL317: _temp316=(( struct Cyc_Absyn_TypedefType_struct*) _temp203)->f3;
goto _LL246;} else{ goto _LL247;} _LL247: if(( unsigned int) _temp203 >  4u?*((
int*) _temp203) ==  Cyc_Absyn_RgnHandleType: 0){ _LL323: _temp322=( void*)((
struct Cyc_Absyn_RgnHandleType_struct*) _temp203)->f1; goto _LL248;} else{ goto
_LL249;} _LL249: if( _temp203 == ( void*) Cyc_Absyn_HeapRgn){ goto _LL250;}
else{ goto _LL251;} _LL251: if(( unsigned int) _temp203 >  4u?*(( int*) _temp203)
==  Cyc_Absyn_AccessEff: 0){ goto _LL252;} else{ goto _LL253;} _LL253: if((
unsigned int) _temp203 >  4u?*(( int*) _temp203) ==  Cyc_Absyn_JoinEff: 0){ goto
_LL254;} else{ goto _LL255;} _LL255: if(( unsigned int) _temp203 >  4u?*(( int*)
_temp203) ==  Cyc_Absyn_RgnsEff: 0){ goto _LL256;} else{ goto _LL204;} _LL206:
return t; _LL208: return Cyc_Absyn_sint_t; _LL210: return Cyc_Toc_typ_to_c(
_temp262); _LL212: return Cyc_Absyn_void_star_typ(); _LL214: return Cyc_Absyn_void_star_typ();
_LL216:( int) _throw(({ void* _temp324[ 0u]={}; Cyc_Tcutil_impos( _tag_arr("unresolved TunionType",
sizeof( unsigned char), 22u), _tag_arr( _temp324, sizeof( void*), 0u));}));
_LL218: if( _temp274->typs ==  0){ if( _temp276->is_xtunion){ return Cyc_Absyn_star_typ(
...
else{ goto _LL343;} _LL343: if(( unsigned int) _temp337 >  16u?*(( int*)
_temp337) ==  Cyc_Absyn_Format_att: 0){ goto _LL344;} else{ goto _LL345;} _LL345:
goto _LL346; _LL340: goto _LL342; _LL342: goto _LL344; _LL344: continue; _LL346:
...
_check_null( _temp421)))->fields))->v; for( 0; _temp437 !=  0; _temp437=((
struct Cyc_List_List*) _check_null( _temp437))->tl){ if( ! Cyc_Toc_atomic_typ((
void*)(( struct Cyc_Absyn_Structfield*)(( struct Cyc_List_List*) _check_null(
_temp437))->hd)->type)){ return 0;}}} return 1; _LL402: _temp425= _temp423; goto
_LL404; _LL404: for( 0; _temp425 !=  0; _temp425=(( struct Cyc_List_List*)
_check_null( _temp425))->tl){ if( ! Cyc_Toc_atomic_typ(( void*)(( struct Cyc_Absyn_Structfield*)((
struct Cyc_List_List*) _check_null( _temp425))->hd)->type)){ return 0;}} return
1; _LL406: _temp435= _temp431->typs; goto _LL408; _LL408: for( 0; _temp435 !=  0;
_temp435=(( struct Cyc_List_List*) _check_null( _temp435))->tl){ if( ! Cyc_Toc_atomic_typ((*((
...
_LL416: return 0; _LL418:({ struct Cyc_std_String_pa_struct _temp439; _temp439.tag=
Cyc_std_String_pa; _temp439.f1=( struct _tagged_arr) Cyc_Absynpp_typ2string( t);{
...
_temp471, f); if( _temp474 ==  0){({ struct Cyc_std_String_pa_struct _temp476;
_temp476.tag= Cyc_std_String_pa; _temp476.f1=( struct _tagged_arr)*(( struct Cyc_Absyn_Structfield*)
_check_null( _temp474))->name;{ void* _temp475[ 1u]={& _temp476};(( int(*)(
struct _tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_toc_impos)( _tag_arr("is_poly_field: bad field %s",
sizeof( unsigned char), 28u), _tag_arr( _temp475, sizeof( void*), 1u));}});}
return Cyc_Toc_is_void_star(( void*)(( struct Cyc_Absyn_Structfield*)
_check_null( _temp474))->type);} _LL463: return 0; _LL465: return 0; _LL467:(
int) _throw(({ struct Cyc_std_String_pa_struct _temp478; _temp478.tag= Cyc_std_String_pa;
_temp478.f1=( struct _tagged_arr) Cyc_Absynpp_typ2string( t);{ void* _temp477[ 1u]={&
_temp478}; Cyc_Toc_toc_impos( _tag_arr("is_poly_field: bad type %s", sizeof(
unsigned char), 27u), _tag_arr( _temp477, sizeof( void*), 1u));}})); _LL457:;}
static int Cyc_Toc_is_poly_project( struct Cyc_Absyn_Exp* e){ void* _temp479=(
void*) e->r; struct _tagged_arr* _temp487; struct Cyc_Absyn_Exp* _temp489;
struct _tagged_arr* _temp491; struct Cyc_Absyn_Exp* _temp493; _LL481: if(*(( int*)
_temp479) ==  Cyc_Absyn_StructMember_e){ _LL490: _temp489=(( struct Cyc_Absyn_StructMember_e_struct*)
_temp479)->f1; goto _LL488; _LL488: _temp487=(( struct Cyc_Absyn_StructMember_e_struct*)
_temp479)->f2; goto _LL482;} else{ goto _LL483;} _LL483: if(*(( int*) _temp479)
==  Cyc_Absyn_StructArrow_e){ _LL494: _temp493=(( struct Cyc_Absyn_StructArrow_e_struct*)
_temp479)->f1; goto _LL492; _LL492: _temp491=(( struct Cyc_Absyn_StructArrow_e_struct*)
_temp479)->f2; goto _LL484;} else{ goto _LL485;} _LL485: goto _LL486; _LL482:
return Cyc_Toc_is_poly_field(( void*)(( struct Cyc_Core_Opt*) _check_null(
_temp489->topt))->v, _temp487); _LL484: { void* _temp495= Cyc_Tcutil_compress((
void*)(( struct Cyc_Core_Opt*) _check_null( _temp493->topt))->v); struct Cyc_Absyn_PtrInfo
_temp501; void* _temp503; _LL497: if(( unsigned int) _temp495 >  4u?*(( int*)
_temp495) ==  Cyc_Absyn_PointerType: 0){ _LL502: _temp501=(( struct Cyc_Absyn_PointerType_struct*)
_temp495)->f1; _LL504: _temp503=( void*) _temp501.elt_typ; goto _LL498;} else{
goto _LL499;} _LL499: goto _LL500; _LL498: return Cyc_Toc_is_poly_field(
_temp503, _temp491); _LL500:({ struct Cyc_std_String_pa_struct _temp506;
_temp506.tag= Cyc_std_String_pa; _temp506.f1=( struct _tagged_arr) Cyc_Absynpp_typ2string((
void*)(( struct Cyc_Core_Opt*) _check_null( _temp493->topt))->v);{ void*
_temp505[ 1u]={& _temp506};(( int(*)( struct _tagged_arr fmt, struct _tagged_arr
ap)) Cyc_Toc_toc_impos)( _tag_arr("is_poly_project:  bad type %s", sizeof(
unsigned char), 30u), _tag_arr( _temp505, sizeof( void*), 1u));}}); return 0;
_LL496:;} _LL486: return 0; _LL480:;} static struct Cyc_Absyn_Exp* Cyc_Toc_malloc_ptr(
...
struct Cyc_std_String_pa_struct _temp537; _temp537.tag= Cyc_std_String_pa;
...
next_case_env){ struct Cyc_List_List* _temp538= 0; for( 0; fallthru_binders != 
...
_LL637: if(*(( int*) _temp635) ==  Cyc_Absyn_Array_e){ _LL646: _temp645=((
struct Cyc_Absyn_Array_e_struct*) _temp635)->f1; goto _LL638;} else{ goto _LL639;}
...
_LL743; _LL751: if( ! Cyc_Absyn_is_lvalue( e1)){({ struct Cyc_std_String_pa_struct
_temp764; _temp764.tag= Cyc_std_String_pa; _temp764.f1=( struct _tagged_arr) Cyc_Absynpp_exp2string(
e1);{ void* _temp763[ 1u]={& _temp764};(( int(*)( struct _tagged_arr fmt, struct
...
_temp781, fs, f, f_env); goto _LL766; _LL774:({ struct Cyc_std_String_pa_struct
_temp784; _temp784.tag= Cyc_std_String_pa; _temp784.f1=( struct _tagged_arr) Cyc_Absynpp_stmt2string(
s);{ void* _temp783[ 1u]={& _temp784};(( int(*)( struct _tagged_arr fmt, struct
_tagged_arr ap)) Cyc_Toc_toc_impos)( _tag_arr("lvalue_assign_stmt: %s", sizeof(
unsigned char), 23u), _tag_arr( _temp783, sizeof( void*), 1u));}}); goto _LL766;
_LL766:;} static struct Cyc_List_List* Cyc_Toc_rmap_2c( struct _RegionHandle* r2,
...
Cyc_List_List* _temp785=( struct Cyc_List_List*) _region_malloc( r2, sizeof(
struct Cyc_List_List)); _temp785->hd=( void*) f(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd, env); _temp785->tl= 0; _temp785;}); prev= result; for( x=((
...
struct Cyc_List_List* _temp786=( struct Cyc_List_List*) _region_malloc( r2,
sizeof( struct Cyc_List_List)); _temp786->hd=( void*) f(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd, env); _temp786->tl= 0; _temp786;}); prev=(( struct Cyc_List_List*)
...
struct Cyc_Absyn_Exp* e){ return({ struct _tuple4* _temp787=( struct _tuple4*)
GC_malloc( sizeof( struct _tuple4)); _temp787->f1= 0; _temp787->f2= e; _temp787;});}
static struct Cyc_Absyn_PtrInfo Cyc_Toc_get_ptr_type( void* t){ void* _temp788=
Cyc_Tcutil_compress( t); struct Cyc_Absyn_PtrInfo _temp794; _LL790: if((
unsigned int) _temp788 >  4u?*(( int*) _temp788) ==  Cyc_Absyn_PointerType: 0){
_LL795: _temp794=(( struct Cyc_Absyn_PointerType_struct*) _temp788)->f1; goto
_LL791;} else{ goto _LL792;} _LL792: goto _LL793; _LL791: return _temp794;
_LL793:( int) _throw(({ void* _temp796[ 0u]={}; Cyc_Tcutil_impos( _tag_arr("get_ptr_typ: not a pointer!",
sizeof( unsigned char), 28u), _tag_arr( _temp796, sizeof( void*), 0u));}));
_LL789:;} struct _tuple8{ void* f1; void* f2; } ; struct _tuple9{ struct _tuple0*
...
nv, struct Cyc_Absyn_Exp* e){ void* _temp797=( void*) e->r; if( e->topt ==  0){({
struct Cyc_std_String_pa_struct _temp799; _temp799.tag= Cyc_std_String_pa;
_temp799.f1=( struct _tagged_arr) Cyc_Absynpp_exp2string( e);{ void* _temp798[ 1u]={&
_temp799};(( int(*)( struct _tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_toc_impos)(
_tag_arr("exp_to_c: no type for %s", sizeof( unsigned char), 25u), _tag_arr(
_temp798, sizeof( void*), 1u));}}); return;}{ void* old_typ=( void*)(( struct
Cyc_Core_Opt*) _check_null( e->topt))->v; void* _temp800= _temp797; void*
_temp880; void* _temp882; struct _tuple0* _temp884; struct _tuple0* _temp886;
struct Cyc_List_List* _temp888; void* _temp890; void* _temp892; struct Cyc_Absyn_Exp*
_temp894; struct Cyc_Absyn_Exp* _temp896; struct Cyc_Core_Opt* _temp898; struct
Cyc_Absyn_Exp* _temp900; struct Cyc_Absyn_Exp* _temp902; struct Cyc_Absyn_Exp*
_temp904; struct Cyc_Absyn_Exp* _temp906; struct Cyc_Absyn_Exp* _temp908; struct
Cyc_Absyn_Exp* _temp910; struct Cyc_List_List* _temp912; struct Cyc_Absyn_Exp*
_temp914; struct Cyc_Absyn_VarargCallInfo* _temp916; struct Cyc_List_List*
_temp918; struct Cyc_Absyn_Exp* _temp920; struct Cyc_Absyn_VarargCallInfo*
_temp922; struct Cyc_Absyn_VarargCallInfo _temp924; struct Cyc_Absyn_VarargInfo*
_temp925; struct Cyc_List_List* _temp927; int _temp929; struct Cyc_List_List*
_temp931; struct Cyc_Absyn_Exp* _temp933; struct Cyc_Absyn_Exp* _temp935; struct
Cyc_Absyn_Exp* _temp937; struct Cyc_List_List* _temp939; struct Cyc_Absyn_Exp*
_temp941; struct Cyc_Absyn_Exp* _temp943; void* _temp945; void** _temp947;
struct Cyc_Absyn_Exp* _temp948; struct Cyc_Absyn_Exp* _temp950; struct Cyc_Absyn_Exp*
_temp952; struct Cyc_Absyn_Exp* _temp954; void* _temp956; struct _tagged_arr*
_temp958; void* _temp960; struct Cyc_Absyn_Exp* _temp962; struct _tagged_arr*
_temp964; struct Cyc_Absyn_Exp* _temp966; struct _tagged_arr* _temp968; struct
Cyc_Absyn_Exp* _temp970; struct Cyc_Absyn_Exp* _temp972; struct Cyc_Absyn_Exp*
_temp974; struct Cyc_List_List* _temp976; struct Cyc_List_List* _temp978; struct
Cyc_Absyn_Exp* _temp980; struct Cyc_Absyn_Exp* _temp982; struct Cyc_Absyn_Vardecl*
_temp984; struct Cyc_Absyn_Structdecl* _temp986; struct Cyc_List_List* _temp988;
struct Cyc_Core_Opt* _temp990; struct _tuple0* _temp992; struct Cyc_List_List*
_temp994; void* _temp996; struct Cyc_Absyn_Tunionfield* _temp998; struct Cyc_Absyn_Tuniondecl*
_temp1000; struct Cyc_List_List* _temp1002; struct Cyc_Absyn_Tunionfield*
_temp1004; struct Cyc_Absyn_Tuniondecl* _temp1006; struct Cyc_List_List*
_temp1008; void* _temp1010; struct Cyc_Absyn_Exp* _temp1012; struct Cyc_Absyn_Stmt*
_temp1014; struct Cyc_Absyn_Fndecl* _temp1016; _LL802: if(*(( int*) _temp800) == 
Cyc_Absyn_Const_e){ _LL881: _temp880=( void*)(( struct Cyc_Absyn_Const_e_struct*)
_temp800)->f1; if( _temp880 == ( void*) Cyc_Absyn_Null_c){ goto _LL803;} else{
goto _LL804;}} else{ goto _LL804;} _LL804: if(*(( int*) _temp800) ==  Cyc_Absyn_Const_e){
goto _LL805;} else{ goto _LL806;} _LL806: if(*(( int*) _temp800) ==  Cyc_Absyn_Var_e){
_LL885: _temp884=(( struct Cyc_Absyn_Var_e_struct*) _temp800)->f1; goto _LL883;
_LL883: _temp882=( void*)(( struct Cyc_Absyn_Var_e_struct*) _temp800)->f2; goto
_LL807;} else{ goto _LL808;} _LL808: if(*(( int*) _temp800) ==  Cyc_Absyn_UnknownId_e){
_LL887: _temp886=(( struct Cyc_Absyn_UnknownId_e_struct*) _temp800)->f1; goto
_LL809;} else{ goto _LL810;} _LL810: if(*(( int*) _temp800) ==  Cyc_Absyn_Primop_e){
_LL891: _temp890=( void*)(( struct Cyc_Absyn_Primop_e_struct*) _temp800)->f1;
goto _LL889; _LL889: _temp888=(( struct Cyc_Absyn_Primop_e_struct*) _temp800)->f2;
goto _LL811;} else{ goto _LL812;} _LL812: if(*(( int*) _temp800) ==  Cyc_Absyn_Increment_e){
_LL895: _temp894=(( struct Cyc_Absyn_Increment_e_struct*) _temp800)->f1; goto
_LL893; _LL893: _temp892=( void*)(( struct Cyc_Absyn_Increment_e_struct*)
...
_temp800)->f3; if( _temp916 ==  0){ goto _LL823;} else{ goto _LL824;}} else{
goto _LL824;} _LL824: if(*(( int*) _temp800) ==  Cyc_Absyn_FnCall_e){ _LL934:
_temp933=(( struct Cyc_Absyn_FnCall_e_struct*) _temp800)->f1; goto _LL932;
_LL932: _temp931=(( struct Cyc_Absyn_FnCall_e_struct*) _temp800)->f2; goto
_LL923; _LL923: _temp922=(( struct Cyc_Absyn_FnCall_e_struct*) _temp800)->f3;
if( _temp922 ==  0){ goto _LL826;} else{ _temp924=* _temp922; _LL930: _temp929=
_temp924.num_varargs; goto _LL928; _LL928: _temp927= _temp924.injectors; goto
_LL926; _LL926: _temp925= _temp924.vai; goto _LL825;}} else{ goto _LL826;}
_LL826: if(*(( int*) _temp800) ==  Cyc_Absyn_Throw_e){ _LL936: _temp935=((
struct Cyc_Absyn_Throw_e_struct*) _temp800)->f1; goto _LL827;} else{ goto _LL828;}
_LL828: if(*(( int*) _temp800) ==  Cyc_Absyn_NoInstantiate_e){ _LL938: _temp937=((
struct Cyc_Absyn_NoInstantiate_e_struct*) _temp800)->f1; goto _LL829;} else{
goto _LL830;} _LL830: if(*(( int*) _temp800) ==  Cyc_Absyn_Instantiate_e){
_LL942: _temp941=(( struct Cyc_Absyn_Instantiate_e_struct*) _temp800)->f1; goto
_LL940; _LL940: _temp939=(( struct Cyc_Absyn_Instantiate_e_struct*) _temp800)->f2;
goto _LL831;} else{ goto _LL832;} _LL832: if(*(( int*) _temp800) ==  Cyc_Absyn_Cast_e){
_LL946: _temp945=( void*)(( struct Cyc_Absyn_Cast_e_struct*) _temp800)->f1;
_temp947=&(( void*)(( struct Cyc_Absyn_Cast_e_struct*) _temp800)->f1); goto
_LL944; _LL944: _temp943=(( struct Cyc_Absyn_Cast_e_struct*) _temp800)->f2; goto
_LL833;} else{ goto _LL834;} _LL834: if(*(( int*) _temp800) ==  Cyc_Absyn_Address_e){
...
else{ goto _LL854;} _LL854: if(*(( int*) _temp800) ==  Cyc_Absyn_Array_e){
_LL979: _temp978=(( struct Cyc_Absyn_Array_e_struct*) _temp800)->f1; goto _LL855;}
else{ goto _LL856;} _LL856: if(*(( int*) _temp800) ==  Cyc_Absyn_Comprehension_e){
...
_LL1027;} else{ goto _LL1028;} _LL1028: goto _LL1029; _LL1027:({ struct Cyc_std_String_pa_struct
...
goto _LL1057; _LL1063:({ struct Cyc_std_String_pa_struct _temp1083; _temp1083.tag=
Cyc_std_String_pa; _temp1083.f1=( struct _tagged_arr) Cyc_Absynpp_typ2string((
...
1: _temp892 == ( void*) Cyc_Absyn_PostInc)? 1: - 1;( void*)( e->r=( void*)((
void*)( Cyc_Absyn_fncall_exp( _temp1086,({ struct Cyc_Absyn_Exp* _temp1088[ 3u];
...
for( i= 0; i <  _temp1116; i ++){ _temp1115[ i]= Cyc_Toc_temp_var();}};
_temp1117;}); struct Cyc_List_List* _temp1105= 0;{ int i= _temp929 -  1; for( 0;
i >=  0; -- i){ _temp1105=({ struct Cyc_List_List* _temp1106=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1106->hd=( void*) Cyc_Toc_make_dle(
Cyc_Absyn_address_exp( Cyc_Absyn_var_exp(*(( struct _tuple0**)
_check_unknown_subscript( vs, sizeof( struct _tuple0*), i)), 0), 0)); _temp1106->tl=
_temp1105; _temp1106;});}} s= Cyc_Absyn_declare_stmt( argv, arr_type,( struct
Cyc_Absyn_Exp*) Cyc_Absyn_unresolvedmem_exp( 0, _temp1105, 0), s, 0);{ int i= 0;
for( 0; _temp931 !=  0;((( _temp931=(( struct Cyc_List_List*) _check_null(
_temp931))->tl, _temp927=(( struct Cyc_List_List*) _check_null( _temp927))->tl)),
++ i)){ struct Cyc_Absyn_Exp* arg=( struct Cyc_Absyn_Exp*)(( struct Cyc_List_List*)
_check_null( _temp931))->hd; void* arg_type=( void*)(( struct Cyc_Core_Opt*)
...
varexp= Cyc_Absyn_var_exp( var, 0); struct Cyc_Absyn_Tunionfield _temp1109;
struct Cyc_List_List* _temp1110; struct _tuple0* _temp1112; struct Cyc_Absyn_Tunionfield*
_temp1107=( struct Cyc_Absyn_Tunionfield*)(( struct Cyc_List_List*) _check_null(
_temp927))->hd; _temp1109=* _temp1107; _LL1113: _temp1112= _temp1109.name; goto
_LL1111; _LL1111: _temp1110= _temp1109.typs; goto _LL1108; _LL1108: { void*
...
_check_null( _temp939))->hd); _LL1122: if(( unsigned int) _temp1120 >  4u?*((
int*) _temp1120) ==  Cyc_Absyn_VarType: 0){ goto _LL1123;} else{ goto _LL1124;}
_LL1124: if(( unsigned int) _temp1120 >  4u?*(( int*) _temp1120) ==  Cyc_Absyn_TunionType:
...
unsigned int) _temp1145 >  4u?*(( int*) _temp1145) ==  Cyc_Absyn_IntType: 0){
goto _LL1134;} else{ goto _LL1135;} _LL1135: goto _LL1136; _LL1132: { int
_temp1151=(( int(*)( int, struct Cyc_Absyn_Conref* x)) Cyc_Absyn_conref_def)( 0,
_temp1143.nullable); int _temp1152=(( int(*)( int, struct Cyc_Absyn_Conref* x))
Cyc_Absyn_conref_def)( 0, _temp1139.nullable); void* _temp1153= Cyc_Absyn_conref_def(
Cyc_Absyn_bounds_one, _temp1143.bounds); void* _temp1154= Cyc_Absyn_conref_def(
Cyc_Absyn_bounds_one, _temp1139.bounds);{ struct _tuple8 _temp1156=({ struct
_tuple8 _temp1155; _temp1155.f1= _temp1153; _temp1155.f2= _temp1154; _temp1155;});
void* _temp1166; void* _temp1168; void* _temp1170; void* _temp1172; struct Cyc_Absyn_Exp*
...
_temp1166) ==  Cyc_Absyn_Upper_b: 0){ goto _LL1159;} else{ goto _LL1160;}
_LL1160: _LL1173: _temp1172= _temp1156.f1; if(( unsigned int) _temp1172 >  1u?*((
int*) _temp1172) ==  Cyc_Absyn_Upper_b: 0){ _LL1175: _temp1174=(( struct Cyc_Absyn_Upper_b_struct*)
...
_LL1198: if( nv->toplevel){({ struct Cyc_std_String_pa_struct _temp1210;
...
_LL1196; _LL1200: if( nv->toplevel){({ struct Cyc_std_String_pa_struct _temp1212;
_temp1212.tag= Cyc_std_String_pa; _temp1212.f1=( struct _tagged_arr) Cyc_Position_string_of_segment(
_temp948->loc);{ void* _temp1211[ 1u]={& _temp1212};(( int(*)( struct
_tagged_arr fmt, struct _tagged_arr ap)) Cyc_Toc_unimp)( _tag_arr("%s: & on non-identifiers at the top-level",
sizeof( unsigned char), 42u), _tag_arr( _temp1211, sizeof( void*), 1u));}});}(
void*)( e->r=( void*)(( void*)( Cyc_Toc_init_tuple( nv, 1, 0, _temp1207))->r));
goto _LL1196; _LL1202: Cyc_Toc_exp_to_c( nv, _temp948); if( ! Cyc_Absyn_is_lvalue(
...
_temp948, 0, Cyc_Toc_address_lvalue, 1);( void*)( e->r=( void*)(( void*)( Cyc_Absyn_cast_exp(
Cyc_Toc_typ_to_c(( void*)(( struct Cyc_Core_Opt*) _check_null( e->topt))->v),
_temp948, 0))->r));} goto _LL1196; _LL1196:;} goto _LL801; _LL837: if( nv->toplevel){({
struct Cyc_std_String_pa_struct _temp1214; _temp1214.tag= Cyc_std_String_pa;
_temp1214.f1=( struct _tagged_arr) Cyc_Position_string_of_segment( _temp950->loc);{
void* _temp1213[ 1u]={& _temp1214};(( int(*)( struct _tagged_arr fmt, struct
_tagged_arr ap)) Cyc_Toc_unimp)( _tag_arr("%s: new at top-level", sizeof(
unsigned char), 21u), _tag_arr( _temp1213, sizeof( void*), 1u));}});}{ void*
_temp1215=( void*) _temp950->r; struct Cyc_List_List* _temp1227; struct Cyc_Absyn_Exp*
_temp1229; struct Cyc_Absyn_Exp* _temp1231; struct Cyc_Absyn_Vardecl* _temp1233;
struct Cyc_List_List* _temp1235; struct _tuple0* _temp1237; struct Cyc_List_List*
_temp1239; _LL1217: if(*(( int*) _temp1215) ==  Cyc_Absyn_Array_e){ _LL1228:
_temp1227=(( struct Cyc_Absyn_Array_e_struct*) _temp1215)->f1; goto _LL1218;}
else{ goto _LL1219;} _LL1219: if(*(( int*) _temp1215) ==  Cyc_Absyn_Comprehension_e){
_LL1234: _temp1233=(( struct Cyc_Absyn_Comprehension_e_struct*) _temp1215)->f1;
goto _LL1232; _LL1232: _temp1231=(( struct Cyc_Absyn_Comprehension_e_struct*)
...
_temp1293->tl= 0; _temp1293;}); struct Cyc_Absyn_Exp* ai; if( _temp952 ==  0){
...
Cyc_Evexp_eval_const_uint_exp( _temp1395) <  1){({ void* _temp1397[ 0u]={};((
...
46u), _tag_arr( _temp1397, sizeof( void*), 0u));});}{ int possibly_null=(( int(*)(
int, struct Cyc_Absyn_Conref* x)) Cyc_Absyn_conref_def)( 0, _temp1383); if( Cyc_Toc_is_nullable((
void*)(( struct Cyc_Core_Opt*) _check_null( _temp970->topt))->v)){( void*)( e->r=(
void*)(( void*)( Cyc_Absyn_structarrow_exp( Cyc_Absyn_cast_exp( Cyc_Toc_typ_to_c((
void*)(( struct Cyc_Core_Opt*) _check_null( _temp970->topt))->v), Cyc_Absyn_fncall_exp(
Cyc_Toc__check_null_e,({ struct Cyc_List_List* _temp1398=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1398->hd=( void*) _temp970;
_temp1398->tl= 0; _temp1398;}), 0), 0), _temp968, 0))->r));} goto _LL1390;}
_LL1394: { void* ta1= Cyc_Toc_typ_to_c_array( _temp1387);( void*)( _temp970->r=(
void*)(( void*)( Cyc_Absyn_cast_exp( Cyc_Absyn_cstar_typ( ta1, _temp1381), Cyc_Absyn_fncall_exp(
Cyc_Toc__check_unknown_subscript_e,({ struct Cyc_Absyn_Exp* _temp1399[ 3u];
_temp1399[ 2u]= Cyc_Absyn_uint_exp( 0, 0); _temp1399[ 1u]= Cyc_Absyn_sizeoftyp_exp(
ta1, 0); _temp1399[ 0u]= Cyc_Absyn_copy_exp( _temp970);(( struct Cyc_List_List*(*)(
struct _tagged_arr)) Cyc_List_list)( _tag_arr( _temp1399, sizeof( struct Cyc_Absyn_Exp*),
3u));}), 0), 0))->r)); goto _LL1390;} _LL1390:;} if( is_poly){( void*)( e->r=(
...
0))->r));} goto _LL801;}} _LL851: { void* _temp1400= Cyc_Tcutil_compress(( void*)((
struct Cyc_Core_Opt*) _check_null( _temp974->topt))->v); Cyc_Toc_exp_to_c( nv,
_temp974); Cyc_Toc_exp_to_c( nv, _temp972);{ void* _temp1401= _temp1400; struct
Cyc_List_List* _temp1409; struct Cyc_Absyn_PtrInfo _temp1411; struct Cyc_Absyn_Conref*
_temp1413; struct Cyc_Absyn_Tqual _temp1415; struct Cyc_Absyn_Conref* _temp1417;
void* _temp1419; void* _temp1421; _LL1403: if(( unsigned int) _temp1401 >  4u?*((
int*) _temp1401) ==  Cyc_Absyn_TupleType: 0){ _LL1410: _temp1409=(( struct Cyc_Absyn_TupleType_struct*)
_temp1401)->f1; goto _LL1404;} else{ goto _LL1405;} _LL1405: if(( unsigned int)
_temp1401 >  4u?*(( int*) _temp1401) ==  Cyc_Absyn_PointerType: 0){ _LL1412:
_temp1411=(( struct Cyc_Absyn_PointerType_struct*) _temp1401)->f1; _LL1422:
_temp1421=( void*) _temp1411.elt_typ; goto _LL1420; _LL1420: _temp1419=( void*)
_temp1411.rgn_typ; goto _LL1418; _LL1418: _temp1417= _temp1411.nullable; goto
_LL1416; _LL1416: _temp1415= _temp1411.tq; goto _LL1414; _LL1414: _temp1413=
_temp1411.bounds; goto _LL1406;} else{ goto _LL1407;} _LL1407: goto _LL1408;
_LL1404: { unsigned int i= Cyc_Evexp_eval_const_uint_exp( _temp972) +  1;( void*)(
e->r=( void*)(( void*)( Cyc_Absyn_structmember_exp( _temp974, Cyc_Toc_fieldname((
int) i), 0))->r)); goto _LL1402;} _LL1406:{ void* _temp1423= Cyc_Absyn_conref_def(
Cyc_Absyn_bounds_one, _temp1413); struct Cyc_Absyn_Exp* _temp1429; _LL1425: if((
unsigned int) _temp1423 >  1u?*(( int*) _temp1423) ==  Cyc_Absyn_Upper_b: 0){
_LL1430: _temp1429=(( struct Cyc_Absyn_Upper_b_struct*) _temp1423)->f1; goto
_LL1426;} else{ goto _LL1427;} _LL1427: if( _temp1423 == ( void*) Cyc_Absyn_Unknown_b){
goto _LL1428;} else{ goto _LL1424;} _LL1426: _temp1429= Cyc_Absyn_uint_exp( Cyc_Evexp_eval_const_uint_exp(
_temp1429), 0);{ int possibly_null=(( int(*)( int, struct Cyc_Absyn_Conref* x))
Cyc_Absyn_conref_def)( 0, _temp1417); void* ta1= Cyc_Toc_typ_to_c( _temp1421);
void* ta2= Cyc_Absyn_cstar_typ( ta1, _temp1415); if( possibly_null){( void*)( e->r=(
void*)(( void*)( Cyc_Absyn_deref_exp( Cyc_Absyn_cast_exp( ta2, Cyc_Absyn_fncall_exp(
Cyc_Toc__check_known_subscript_null_e,({ struct Cyc_Absyn_Exp* _temp1431[ 4u];
_temp1431[ 3u]= _temp972; _temp1431[ 2u]= Cyc_Absyn_sizeoftyp_exp( ta1, 0);
_temp1431[ 1u]= _temp1429; _temp1431[ 0u]= _temp974;(( struct Cyc_List_List*(*)(
struct _tagged_arr)) Cyc_List_list)( _tag_arr( _temp1431, sizeof( struct Cyc_Absyn_Exp*),
4u));}), 0), 0), 0))->r));} else{( void*)( _temp972->r=( void*)(( void*)( Cyc_Absyn_fncall_exp(
Cyc_Toc__check_known_subscript_notnull_e,({ struct Cyc_Absyn_Exp* _temp1432[ 2u];
_temp1432[ 1u]= Cyc_Absyn_copy_exp( _temp972); _temp1432[ 0u]= _temp1429;((
struct Cyc_List_List*(*)( struct _tagged_arr)) Cyc_List_list)( _tag_arr(
_temp1432, sizeof( struct Cyc_Absyn_Exp*), 2u));}), 0))->r));} goto _LL1424;}
_LL1428: { void* ta1= Cyc_Toc_typ_to_c_array( _temp1421);( void*)( e->r=( void*)((
void*)( Cyc_Absyn_deref_exp( Cyc_Absyn_cast_exp( Cyc_Absyn_cstar_typ( ta1,
_temp1415), Cyc_Absyn_fncall_exp( Cyc_Toc__check_unknown_subscript_e,({ struct
Cyc_Absyn_Exp* _temp1433[ 3u]; _temp1433[ 2u]= _temp972; _temp1433[ 1u]= Cyc_Absyn_sizeoftyp_exp(
ta1, 0); _temp1433[ 0u]= _temp974;(( struct Cyc_List_List*(*)( struct
...
_LL1467: fs= _temp1470; goto _LL1465; _LL1469: fs=({ struct Cyc_std_String_pa_struct
_temp1473; _temp1473.tag= Cyc_std_String_pa; _temp1473.f1=( struct _tagged_arr)
...
_LL1513;} _LL1513: if(( unsigned int) _temp1507 >  2u?*(( int*) _temp1507) == 
Cyc_Absyn_Reference_p: 0){ _LL1549: _temp1548=(( struct Cyc_Absyn_Reference_p_struct*)
_temp1507)->f1; goto _LL1514;} else{ goto _LL1515;} _LL1515: if( _temp1507 == (
void*) Cyc_Absyn_Null_p){ goto _LL1516;} else{ goto _LL1517;} _LL1517: if((
unsigned int) _temp1507 >  2u?*(( int*) _temp1507) ==  Cyc_Absyn_Int_p: 0){
_LL1553: _temp1552=( void*)(( struct Cyc_Absyn_Int_p_struct*) _temp1507)->f1;
goto _LL1551; _LL1551: _temp1550=(( struct Cyc_Absyn_Int_p_struct*) _temp1507)->f2;
goto _LL1518;} else{ goto _LL1519;} _LL1519: if(( unsigned int) _temp1507 >  2u?*((
int*) _temp1507) ==  Cyc_Absyn_Char_p: 0){ _LL1555: _temp1554=(( struct Cyc_Absyn_Char_p_struct*)
_temp1507)->f1; goto _LL1520;} else{ goto _LL1521;} _LL1521: if(( unsigned int)
_temp1507 >  2u?*(( int*) _temp1507) ==  Cyc_Absyn_Float_p: 0){ _LL1557:
_temp1556=(( struct Cyc_Absyn_Float_p_struct*) _temp1507)->f1; goto _LL1522;}
else{ goto _LL1523;} _LL1523: if(( unsigned int) _temp1507 >  2u?*(( int*)
_temp1507) ==  Cyc_Absyn_Enum_p: 0){ _LL1561: _temp1560=(( struct Cyc_Absyn_Enum_p_struct*)
_temp1507)->f1; goto _LL1559; _LL1559: _temp1558=(( struct Cyc_Absyn_Enum_p_struct*)
_temp1507)->f2; goto _LL1524;} else{ goto _LL1525;} _LL1525: if(( unsigned int)
_temp1507 >  2u?*(( int*) _temp1507) ==  Cyc_Absyn_Tunion_p: 0){ _LL1569:
_temp1568=(( struct Cyc_Absyn_Tunion_p_struct*) _temp1507)->f1; goto _LL1567;
_LL1567: _temp1566=(( struct Cyc_Absyn_Tunion_p_struct*) _temp1507)->f2; goto
_LL1565; _LL1565: _temp1564=(( struct Cyc_Absyn_Tunion_p_struct*) _temp1507)->f3;
goto _LL1563; _LL1563: _temp1562=(( struct Cyc_Absyn_Tunion_p_struct*) _temp1507)->f4;
if( _temp1562 ==  0){ goto _LL1526;} else{ goto _LL1527;}} else{ goto _LL1527;}
_LL1527: if(( unsigned int) _temp1507 >  2u?*(( int*) _temp1507) ==  Cyc_Absyn_Pointer_p:
0){ _LL1572: _temp1571=(( struct Cyc_Absyn_Pointer_p_struct*) _temp1507)->f1;
_temp1573=* _temp1571; _LL1575: _temp1574=( void*) _temp1573.r; if((
unsigned int) _temp1574 >  2u?*(( int*) _temp1574) ==  Cyc_Absyn_Tunion_p: 0){
...
!=  0){ goto _LL1528;} else{ goto _LL1529;} _LL1529: if(( unsigned int)
_temp1507 >  2u?*(( int*) _temp1507) ==  Cyc_Absyn_Tunion_p: 0){ _LL1585:
_temp1584=(( struct Cyc_Absyn_Tunion_p_struct*) _temp1507)->f4; goto _LL1530;}
else{ goto _LL1531;} _LL1531: if(( unsigned int) _temp1507 >  2u?*(( int*)
_temp1507) ==  Cyc_Absyn_Tuple_p: 0){ _LL1587: _temp1586=(( struct Cyc_Absyn_Tuple_p_struct*)
_temp1507)->f1; goto _LL1532;} else{ goto _LL1533;} _LL1533: if(( unsigned int)
_temp1507 >  2u?*(( int*) _temp1507) ==  Cyc_Absyn_Struct_p: 0){ _LL1595:
_temp1594=(( struct Cyc_Absyn_Struct_p_struct*) _temp1507)->f1; goto _LL1593;
_LL1593: _temp1592=(( struct Cyc_Absyn_Struct_p_struct*) _temp1507)->f2; goto
_LL1591; _LL1591: _temp1590=(( struct Cyc_Absyn_Struct_p_struct*) _temp1507)->f3;
goto _LL1589; _LL1589: _temp1588=(( struct Cyc_Absyn_Struct_p_struct*) _temp1507)->f4;
goto _LL1534;} else{ goto _LL1535;} _LL1535: if(( unsigned int) _temp1507 >  2u?*((
int*) _temp1507) ==  Cyc_Absyn_Pointer_p: 0){ _LL1597: _temp1596=(( struct Cyc_Absyn_Pointer_p_struct*)
_temp1507)->f1; goto _LL1536;} else{ goto _LL1537;} _LL1537: if(( unsigned int)
_temp1507 >  2u?*(( int*) _temp1507) ==  Cyc_Absyn_UnknownId_p: 0){ goto _LL1538;}
else{ goto _LL1539;} _LL1539: if(( unsigned int) _temp1507 >  2u?*(( int*)
_temp1507) ==  Cyc_Absyn_UnknownCall_p: 0){ goto _LL1540;} else{ goto _LL1541;}
_LL1541: if(( unsigned int) _temp1507 >  2u?*(( int*) _temp1507) ==  Cyc_Absyn_UnknownFields_p:
0){ goto _LL1542;} else{ goto _LL1508;} _LL1510: nv= Cyc_Toc_add_varmap( nv,
_temp1546, r); goto _LL1512; _LL1512: s= Cyc_Absyn_goto_stmt( succ_lab, 0); goto
_LL1508; _LL1514: { struct _tuple0* _temp1598= Cyc_Toc_temp_var(); decls=({
struct Cyc_List_List* _temp1599=( struct Cyc_List_List*) _region_malloc( rgn,
sizeof( struct Cyc_List_List)); _temp1599->hd=( void*)({ struct _tuple12*
_temp1600=( struct _tuple12*) _region_malloc( rgn, sizeof( struct _tuple12));
_temp1600->f1= _temp1598; _temp1600->f2= Cyc_Absyn_cstar_typ( Cyc_Toc_typ_to_c(
t), Cyc_Toc_mt_tq); _temp1600;}); _temp1599->tl= decls; _temp1599;}); nv= Cyc_Toc_add_varmap(
nv, _temp1548->name, Cyc_Absyn_var_exp( _temp1598, 0)); s= Cyc_Absyn_seq_stmt(
Cyc_Absyn_assign_stmt( Cyc_Absyn_var_exp( _temp1598, 0), Cyc_Absyn_address_exp(
path, 0), 0), Cyc_Absyn_goto_stmt( succ_lab, 0), 0); goto _LL1508;} _LL1516: s=
Cyc_Toc_if_eq_goto_stmt( r, Cyc_Absyn_signed_int_exp( 0, 0), succ_lab, fail_lab);
goto _LL1508; _LL1518: s= Cyc_Toc_if_eq_goto_stmt( r, Cyc_Absyn_int_exp(
_temp1552, _temp1550, 0), succ_lab, fail_lab); goto _LL1508; _LL1520: s= Cyc_Toc_if_eq_goto_stmt(
r, Cyc_Absyn_char_exp( _temp1554, 0), succ_lab, fail_lab); goto _LL1508; _LL1522:
s= Cyc_Toc_if_eq_goto_stmt( r, Cyc_Absyn_float_exp( _temp1556, 0), succ_lab,
fail_lab); goto _LL1508; _LL1524: s= Cyc_Toc_if_eq_goto_stmt( r, Cyc_Absyn_new_exp((
void*)({ struct Cyc_Absyn_Enum_e_struct* _temp1601=( struct Cyc_Absyn_Enum_e_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Enum_e_struct)); _temp1601[ 0]=({ struct Cyc_Absyn_Enum_e_struct
_temp1602; _temp1602.tag= Cyc_Absyn_Enum_e; _temp1602.f1= _temp1558->name;
_temp1602.f2=( struct Cyc_Absyn_Enumdecl*) _temp1560; _temp1602.f3=( struct Cyc_Absyn_Enumfield*)
_temp1558; _temp1602;}); _temp1601;}), 0), succ_lab, fail_lab); goto _LL1508;
_LL1526: { struct Cyc_Absyn_Exp* cmp_exp= Cyc_Absyn_var_exp( _temp1566->name, 0);
if( ! _temp1568->is_xtunion){ cmp_exp= Cyc_Absyn_cast_exp( Cyc_Absyn_void_star_typ(),
cmp_exp, 0);} s= Cyc_Toc_if_eq_goto_stmt( r, cmp_exp, succ_lab, fail_lab); goto
_LL1508;} _LL1528: { struct Cyc_List_List* ss= 0; int cnt=(( int(*)( struct Cyc_List_List*
x)) Cyc_List_length)( _temp1576); struct _tuple0* tufstrct= Cyc_Toc_collapse_qvar_tag(
_temp1580->name, _tag_arr("_struct", sizeof( unsigned char), 8u)); struct Cyc_Absyn_Exp*
rcast= Cyc_Absyn_cast_exp( Cyc_Absyn_cstar_typ( Cyc_Absyn_strctq( tufstrct), Cyc_Toc_mt_tq),
r, 0); struct Cyc_List_List* _temp1603=(( struct Cyc_List_List*(*)( struct
_RegionHandle*, struct Cyc_List_List* x)) Cyc_List_rrev)( rgn, _temp1580->typs);
struct Cyc_List_List* _temp1604=(( struct Cyc_List_List*(*)( struct
_RegionHandle*, struct Cyc_List_List* x)) Cyc_List_rrev)( rgn, _temp1576); for(
0; _temp1604 !=  0;((( _temp1604=(( struct Cyc_List_List*) _check_null(
_temp1604))->tl, _temp1603=(( struct Cyc_List_List*) _check_null( _temp1603))->tl)),
cnt --)){ struct Cyc_Absyn_Pat* _temp1605=( struct Cyc_Absyn_Pat*)(( struct Cyc_List_List*)
_check_null( _temp1604))->hd; if(( void*) _temp1605->r == ( void*) Cyc_Absyn_Wild_p){
continue;}{ void* _temp1606=(*(( struct _tuple3*)(( struct Cyc_List_List*)
_check_null( _temp1603))->hd)).f2; struct _tuple0* _temp1607= Cyc_Toc_temp_var();
void* _temp1608=( void*)(( struct Cyc_Core_Opt*) _check_null( _temp1605->topt))->v;
void* _temp1609= Cyc_Toc_typ_to_c( _temp1608); struct _tagged_arr* _temp1610=
Cyc_Toc_fresh_label(); struct Cyc_Absyn_Exp* _temp1611= Cyc_Absyn_structarrow_exp(
rcast, Cyc_Toc_fieldname( cnt), 0); if( Cyc_Toc_is_void_star( Cyc_Toc_typ_to_c(
_temp1606))){ _temp1611= Cyc_Absyn_cast_exp( _temp1609, _temp1611, 0);} decls=({
struct Cyc_List_List* _temp1612=( struct Cyc_List_List*) _region_malloc( rgn,
sizeof( struct Cyc_List_List)); _temp1612->hd=( void*)({ struct _tuple12*
_temp1613=( struct _tuple12*) _region_malloc( rgn, sizeof( struct _tuple12));
_temp1613->f1= _temp1607; _temp1613->f2= _temp1609; _temp1613;}); _temp1612->tl=
decls; _temp1612;});{ struct _tuple11 _temp1614= Cyc_Toc_xlate_pat( nv, rgn,
_temp1608, Cyc_Absyn_var_exp( _temp1607, 0), _temp1611, _temp1605, succ_lab,
fail_lab, decls); nv= _temp1614.f1; decls= _temp1614.f2;{ struct Cyc_Absyn_Stmt*
...
_check_null( _temp1582->fields))->v; for( 0; _temp1620 !=  0; _temp1620=((
struct Cyc_List_List*) _check_null( _temp1620))->tl){ struct Cyc_Absyn_Tunionfield*
...
x)) Cyc_List_rrev)( rgn, _temp1588); for( 0; _temp1634 !=  0; _temp1634=((
struct Cyc_List_List*) _check_null( _temp1634))->tl){ struct _tuple13* _temp1635=(
...
_temp1703 >  1u?*(( int*) _temp1703) ==  Cyc_Absyn_While_s: 0){ _LL1762:
_temp1761=(( struct Cyc_Absyn_While_s_struct*) _temp1703)->f1; _LL1764:
_temp1763= _temp1761.f1; goto _LL1760; _LL1760: _temp1759=(( struct Cyc_Absyn_While_s_struct*)
_temp1703)->f2; goto _LL1716;} else{ goto _LL1717;} _LL1717: if(( unsigned int)
_temp1703 >  1u?*(( int*) _temp1703) ==  Cyc_Absyn_Break_s: 0){ _LL1766:
_temp1765=(( struct Cyc_Absyn_Break_s_struct*) _temp1703)->f1; goto _LL1718;}
else{ goto _LL1719;} _LL1719: if(( unsigned int) _temp1703 >  1u?*(( int*)
_temp1703) ==  Cyc_Absyn_Continue_s: 0){ _LL1768: _temp1767=(( struct Cyc_Absyn_Continue_s_struct*)
_temp1703)->f1; goto _LL1720;} else{ goto _LL1721;} _LL1721: if(( unsigned int)
_temp1703 >  1u?*(( int*) _temp1703) ==  Cyc_Absyn_Goto_s: 0){ _LL1770:
_temp1769=(( struct Cyc_Absyn_Goto_s_struct*) _temp1703)->f2; goto _LL1722;}
else{ goto _LL1723;} _LL1723: if(( unsigned int) _temp1703 >  1u?*(( int*)
_temp1703) ==  Cyc_Absyn_For_s: 0){ _LL1782: _temp1781=(( struct Cyc_Absyn_For_s_struct*)
_temp1703)->f1; goto _LL1778; _LL1778: _temp1777=(( struct Cyc_Absyn_For_s_struct*)
_temp1703)->f2; _LL1780: _temp1779= _temp1777.f1; goto _LL1774; _LL1774:
_temp1773=(( struct Cyc_Absyn_For_s_struct*) _temp1703)->f3; _LL1776: _temp1775=
_temp1773.f1; goto _LL1772; _LL1772: _temp1771=(( struct Cyc_Absyn_For_s_struct*)
...
_temp1703 >  1u?*(( int*) _temp1703) ==  Cyc_Absyn_Decl_s: 0){ _LL1794:
_temp1793=(( struct Cyc_Absyn_Decl_s_struct*) _temp1703)->f1; goto _LL1792;
_LL1792: _temp1791=(( struct Cyc_Absyn_Decl_s_struct*) _temp1703)->f2; goto
_LL1730;} else{ goto _LL1731;} _LL1731: if(( unsigned int) _temp1703 >  1u?*((
int*) _temp1703) ==  Cyc_Absyn_Label_s: 0){ _LL1798: _temp1797=(( struct Cyc_Absyn_Label_s_struct*)
...
int dest_depth= _temp1765 ==  0? 0:(( struct Cyc_Absyn_Stmt*) _check_null(
_temp1765))->try_depth; Cyc_Toc_do_npop_before( s->try_depth -  dest_depth, s);
return;} _LL1720: if( nv->continue_lab !=  0){( void*)( s->r=( void*)(( void*)(
Cyc_Absyn_goto_stmt(( struct _tagged_arr*)(( struct Cyc_Core_Opt*) _check_null(
nv->continue_lab))->v, 0))->r));} _temp1769= _temp1767; goto _LL1722; _LL1722:
Cyc_Toc_do_npop_before( s->try_depth - (( struct Cyc_Absyn_Stmt*) _check_null(
_temp1769))->try_depth, s); return; _LL1724: Cyc_Toc_exp_to_c( nv, _temp1781);
Cyc_Toc_exp_to_c( nv, _temp1779); Cyc_Toc_exp_to_c( nv, _temp1775); Cyc_Toc_stmt_to_c(
Cyc_Toc_loop_env( nv), _temp1771); return; _LL1726: Cyc_Toc_xlate_switch( nv, s,
_temp1785, _temp1783); return; _LL1728: if( nv->fallthru_info ==  0){( int)
_throw(({ void* _temp1818[ 0u]={}; Cyc_Toc_toc_impos( _tag_arr("fallthru in unexpected place",
sizeof( unsigned char), 29u), _tag_arr( _temp1818, sizeof( void*), 0u));}));}{
struct _tuple6 _temp1821; struct Cyc_Dict_Dict* _temp1822; struct Cyc_List_List*
_temp1824; struct _tagged_arr* _temp1826; struct _tuple6* _temp1819=( struct
_tuple6*)(( struct Cyc_Core_Opt*) _check_null( nv->fallthru_info))->v; _temp1821=*
_temp1819; _LL1827: _temp1826= _temp1821.f1; goto _LL1825; _LL1825: _temp1824=
_temp1821.f2; goto _LL1823; _LL1823: _temp1822= _temp1821.f3; goto _LL1820;
_LL1820: { struct Cyc_Absyn_Stmt* s2= Cyc_Absyn_goto_stmt( _temp1826, 0); Cyc_Toc_do_npop_before(
s->try_depth - ((*(( struct Cyc_Absyn_Switch_clause**) _check_null( _temp1787)))->body)->try_depth,
s2);{ struct Cyc_List_List* _temp1828=(( struct Cyc_List_List*(*)( struct Cyc_List_List*
x)) Cyc_List_rev)( _temp1824); struct Cyc_List_List* _temp1829=(( struct Cyc_List_List*(*)(
struct Cyc_List_List* x)) Cyc_List_rev)( _temp1789); for( 0; _temp1828 !=  0;(
_temp1828=(( struct Cyc_List_List*) _check_null( _temp1828))->tl, _temp1829=((
struct Cyc_List_List*) _check_null( _temp1829))->tl)){ Cyc_Toc_exp_to_c( nv,(
struct Cyc_Absyn_Exp*)(( struct Cyc_List_List*) _check_null( _temp1829))->hd);
s2= Cyc_Absyn_seq_stmt( Cyc_Absyn_assign_stmt((( struct Cyc_Absyn_Exp*(*)(
struct Cyc_Dict_Dict* d, struct _tuple0* key)) Cyc_Dict_lookup)( _temp1822,(
struct _tuple0*)(( struct Cyc_List_List*) _check_null( _temp1828))->hd),( struct
Cyc_Absyn_Exp*)(( struct Cyc_List_List*) _check_null( _temp1829))->hd, 0), s2, 0);}(
void*)( s->r=( void*)(( void*) s2->r)); return;}}} _LL1730:{ void* _temp1830=(
void*) _temp1793->r; struct Cyc_Absyn_Vardecl* _temp1840; int _temp1842; struct
Cyc_Absyn_Exp* _temp1844; struct Cyc_Core_Opt* _temp1846; struct Cyc_Absyn_Pat*
_temp1848; struct Cyc_List_List* _temp1850; _LL1832: if(*(( int*) _temp1830) == 
Cyc_Absyn_Var_d){ _LL1841: _temp1840=(( struct Cyc_Absyn_Var_d_struct*)
_temp1830)->f1; goto _LL1833;} else{ goto _LL1834;} _LL1834: if(*(( int*)
_temp1830) ==  Cyc_Absyn_Let_d){ _LL1849: _temp1848=(( struct Cyc_Absyn_Let_d_struct*)
_temp1830)->f1; goto _LL1847; _LL1847: _temp1846=(( struct Cyc_Absyn_Let_d_struct*)
_temp1830)->f3; goto _LL1845; _LL1845: _temp1844=(( struct Cyc_Absyn_Let_d_struct*)
_temp1830)->f4; goto _LL1843; _LL1843: _temp1842=(( struct Cyc_Absyn_Let_d_struct*)
_temp1830)->f5; goto _LL1835;} else{ goto _LL1836;} _LL1836: if(*(( int*)
_temp1830) ==  Cyc_Absyn_Letv_d){ _LL1851: _temp1850=(( struct Cyc_Absyn_Letv_d_struct*)
_temp1830)->f1; goto _LL1837;} else{ goto _LL1838;} _LL1838: goto _LL1839;
_LL1833: { struct Cyc_Toc_Env* _temp1852= Cyc_Toc_add_varmap( nv, _temp1840->name,
Cyc_Absyn_varb_exp( _temp1840->name,( void*)({ struct Cyc_Absyn_Local_b_struct*
_temp1853=( struct Cyc_Absyn_Local_b_struct*) GC_malloc( sizeof( struct Cyc_Absyn_Local_b_struct));
...
_check_null( f->param_vardecls))->v; for( 0; _temp1927 !=  0; _temp1927=((
struct Cyc_List_List*) _check_null( _temp1927))->tl){( void*)((( struct Cyc_Absyn_Vardecl*)((
...
0){ Cyc_Toc_structs_so_far=({ struct Cyc_Core_Opt* _temp1937=( struct Cyc_Core_Opt*)
...
Cyc_Core_Opt* _temp1972=( struct Cyc_Core_Opt*) GC_malloc( sizeof( struct Cyc_Core_Opt));
...
_temp1993; _temp1993.tag= Cyc_std_String_pa; _temp1993.f1=( struct _tagged_arr)*
fn;{ struct Cyc_std_Int_pa_struct _temp1992; _temp1992.tag= Cyc_std_Int_pa;
_temp1992.f1=( int)(( unsigned int) 0);{ struct Cyc_std_Int_pa_struct _temp1991;
_temp1991.tag= Cyc_std_Int_pa; _temp1991.f1=( int)(( unsigned int) 0);{ struct
Cyc_std_Int_pa_struct _temp1990; _temp1990.tag= Cyc_std_Int_pa; _temp1990.f1=(
int)(( unsigned int) 0);{ struct Cyc_std_Int_pa_struct _temp1989; _temp1989.tag=
Cyc_std_Int_pa; _temp1989.f1=( int)(( unsigned int) 0);{ void* _temp1988[ 5u]={&
_temp1989,& _temp1990,& _temp1991,& _temp1992,& _temp1993}; Cyc_std_aprintf(
_tag_arr("%c%c%c%c%s", sizeof( unsigned char), 11u), _tag_arr( _temp1988,
sizeof( void*), 5u));}}}}}}), 0);}{ struct Cyc_Absyn_Vardecl* _temp1994= Cyc_Absyn_new_vardecl(
f->name,( void*) _temp1976, initopt);( void*)( _temp1994->sc=( void*)(( void*) f->sc));
Cyc_Toc_result_decls=({ struct Cyc_List_List* _temp1995=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp1995->hd=( void*) Cyc_Absyn_new_decl((
void*)({ struct Cyc_Absyn_Var_d_struct* _temp1996=( struct Cyc_Absyn_Var_d_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Var_d_struct)); _temp1996[ 0]=({ struct Cyc_Absyn_Var_d_struct
_temp1997; _temp1997.tag= Cyc_Absyn_Var_d; _temp1997.f1= _temp1994; _temp1997;});
_temp1996;}), 0); _temp1995->tl= Cyc_Toc_result_decls; _temp1995;});( struct Cyc_Dict_Dict*)(((
...
_temp1998= f->typs; for( 0; _temp1998 !=  0;( _temp1998=(( struct Cyc_List_List*)
_check_null( _temp1998))->tl, i ++)){ struct _tagged_arr* _temp1999=({ struct
_tagged_arr* _temp2003=( struct _tagged_arr*) GC_malloc( sizeof( struct
_tagged_arr)); _temp2003[ 0]=( struct _tagged_arr)({ struct Cyc_std_Int_pa_struct
_temp2005; _temp2005.tag= Cyc_std_Int_pa; _temp2005.f1=( int)(( unsigned int) i);{
void* _temp2004[ 1u]={& _temp2005}; Cyc_std_aprintf( _tag_arr("f%d", sizeof(
unsigned char), 4u), _tag_arr( _temp2004, sizeof( void*), 1u));}}); _temp2003;});
struct Cyc_Absyn_Structfield* _temp2000=({ struct Cyc_Absyn_Structfield*
...
struct Cyc_std_String_pa_struct _temp2025; _temp2025.tag= Cyc_std_String_pa;
_temp2025.f1=( struct _tagged_arr)* fn;{ struct Cyc_std_Int_pa_struct _temp2024;
_temp2024.tag= Cyc_std_Int_pa; _temp2024.f1=( int)(( unsigned int) 0);{ struct
Cyc_std_Int_pa_struct _temp2023; _temp2023.tag= Cyc_std_Int_pa; _temp2023.f1=(
int)(( unsigned int) 0);{ struct Cyc_std_Int_pa_struct _temp2022; _temp2022.tag=
Cyc_std_Int_pa; _temp2022.f1=( int)(( unsigned int) 0);{ struct Cyc_std_Int_pa_struct
_temp2021; _temp2021.tag= Cyc_std_Int_pa; _temp2021.f1=( int)(( unsigned int) 0);{
void* _temp2020[ 5u]={& _temp2021,& _temp2022,& _temp2023,& _temp2024,&
_temp2025}; Cyc_std_aprintf( _tag_arr("%c%c%c%c%s", sizeof( unsigned char), 11u),
_tag_arr( _temp2020, sizeof( void*), 5u));}}}}}}), 0); struct Cyc_Absyn_Vardecl*
_temp2016= Cyc_Absyn_new_vardecl( f->name,( void*) _temp1976,( struct Cyc_Absyn_Exp*)
_temp2015);( void*)( _temp2016->sc=( void*)(( void*) f->sc)); Cyc_Toc_result_decls=({
struct Cyc_List_List* _temp2017=( struct Cyc_List_List*) GC_malloc( sizeof(
struct Cyc_List_List)); _temp2017->hd=( void*) Cyc_Absyn_new_decl(( void*)({
struct Cyc_Absyn_Var_d_struct* _temp2018=( struct Cyc_Absyn_Var_d_struct*)
GC_malloc( sizeof( struct Cyc_Absyn_Var_d_struct)); _temp2018[ 0]=({ struct Cyc_Absyn_Var_d_struct
_temp2019; _temp2019.tag= Cyc_Absyn_Var_d; _temp2019.f1= _temp2016; _temp2019;});
_temp2018;}), 0); _temp2017->tl= Cyc_Toc_result_decls; _temp2017;});( struct Cyc_Dict_Dict*)(((
struct Cyc_Core_Opt*) _check_null( Cyc_Toc_xtunion_fields_so_far))->v=( void*)((
struct Cyc_Dict_Dict*(*)( struct Cyc_Dict_Dict* d, struct _tuple0* key, int data))
Cyc_Dict_insert)(( struct Cyc_Dict_Dict*)(( struct Cyc_Core_Opt*) _check_null(
Cyc_Toc_xtunion_fields_so_far))->v, f->name, 1));} goto _LL1978; _LL1984: goto
_LL1978; _LL1978:;}}} static void Cyc_Toc_enumdecl_to_c( struct Cyc_Toc_Env* nv,
struct Cyc_Absyn_Enumdecl* ed){ struct _tuple0* _temp2028= ed->name;( void*)( ed->sc=(
void*)(( void*) Cyc_Absyn_Public)); if( ed->fields !=  0){ struct Cyc_List_List*
_temp2029=( struct Cyc_List_List*)(( struct Cyc_Core_Opt*) _check_null( ed->fields))->v;
for( 0; _temp2029 !=  0; _temp2029=(( struct Cyc_List_List*) _check_null(
_temp2029))->tl){ if((( struct Cyc_Absyn_Enumfield*)(( struct Cyc_List_List*)
