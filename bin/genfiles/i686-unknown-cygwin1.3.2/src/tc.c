...
_cycalloc( sizeof( struct Cyc_Absyn_Abs_n_struct)); _temp29[ 0]=({ struct Cyc_Absyn_Abs_n_struct
...
_cycalloc( sizeof( struct Cyc_Absyn_ArrayType_struct)); _temp66[ 0]=({ struct
...
_temp68=( struct Cyc_Absyn_ArrayType_struct*) _cycalloc( sizeof( struct Cyc_Absyn_ArrayType_struct));
...
_temp70=( struct Cyc_Absyn_ArrayType_struct*) _cycalloc( sizeof( struct Cyc_Absyn_ArrayType_struct));
...
_LL88: continue; _LL90: continue; _LL92:({ struct Cyc_Std_String_pa_struct
_temp95; _temp95.tag= Cyc_Std_String_pa; _temp95.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
vd->name);{ struct Cyc_Std_String_pa_struct _temp94; _temp94.tag= Cyc_Std_String_pa;
...
t): 0){({ struct Cyc_Std_String_pa_struct _temp98; _temp98.tag= Cyc_Std_String_pa;
_temp98.f1=( struct _tagged_arr) Cyc_Absynpp_typ2string( t);{ struct Cyc_Std_String_pa_struct
_temp97; _temp97.tag= Cyc_Std_String_pa; _temp97.f1=( struct _tagged_arr) Cyc_Absynpp_qvar2string(
...
te, _temp99, t)){({ struct Cyc_Std_String_pa_struct _temp104; _temp104.tag= Cyc_Std_String_pa;
_temp104.f1=( struct _tagged_arr) Cyc_Absynpp_typ2string( _temp100);{ struct Cyc_Std_String_pa_struct
_temp103; _temp103.tag= Cyc_Std_String_pa; _temp103.f1=( struct _tagged_arr) Cyc_Absynpp_typ2string(
...
_LL107; _LL123: goto _LL125; _LL125:({ struct Cyc_Std_String_pa_struct _temp130;
_temp130.tag= Cyc_Std_String_pa; _temp130.f1=( struct _tagged_arr) Cyc_Absyn_attribute2string((
void*)(( struct Cyc_List_List*) _check_null( atts))->hd);{ void* _temp129[ 1u]={&
_temp130}; Cyc_Tcutil_terr( loc, _tag_arr("bad attribute %s in function declaration",
...
_temp152=( struct Cyc_Absyn_Global_b_struct*) _cycalloc( sizeof( struct Cyc_Absyn_Global_b_struct));
...
_tuple3* v)) Cyc_Dict_insert)( ge->ordinaries, v,({ struct _tuple3* _temp149=(
struct _tuple3*) _cycalloc( sizeof( struct _tuple3)); _temp149->f1=( void*)({
struct Cyc_Tcenv_VarRes_struct* _temp150=( struct Cyc_Tcenv_VarRes_struct*)
_cycalloc( sizeof( struct Cyc_Tcenv_VarRes_struct)); _temp150[ 0]=({ struct Cyc_Tcenv_VarRes_struct
...
struct Cyc_Dict_Dict* d, struct _tagged_arr* k, struct _tuple3* v)) Cyc_Dict_insert)(
ge->ordinaries, v,({ struct _tuple3* _temp164=( struct _tuple3*) _cycalloc(
sizeof( struct _tuple3)); _temp164->f1=( void*)({ struct Cyc_Tcenv_VarRes_struct*
_temp165=( struct Cyc_Tcenv_VarRes_struct*) _cycalloc( sizeof( struct Cyc_Tcenv_VarRes_struct));
...
_cycalloc( sizeof( struct Cyc_Core_Impossible_struct)); _temp181[ 0]=({ struct
...
_temp184=( struct Cyc_Absyn_Abs_n_struct*) _cycalloc( sizeof( struct Cyc_Absyn_Abs_n_struct));
...
_LL191:({ struct Cyc_Std_String_pa_struct _temp195; _temp195.tag= Cyc_Std_String_pa;
...
_tagged_arr* k)) Cyc_Dict_lookup)( ge->ordinaries, v); void* _temp200=(*
...
_cycalloc( sizeof( struct Cyc_Absyn_Funname_b_struct)); _temp217[ 0]=({ struct
...
struct Cyc_Dict_Dict*(*)( struct Cyc_Dict_Dict* d, struct _tagged_arr* k, struct
_tuple3* v)) Cyc_Dict_insert)( ge->ordinaries, v,({ struct _tuple3* _temp214=(
struct _tuple3*) _cycalloc( sizeof( struct _tuple3)); _temp214->f1=( void*)({
struct Cyc_Tcenv_VarRes_struct* _temp215=( struct Cyc_Tcenv_VarRes_struct*)
_cycalloc( sizeof( struct Cyc_Tcenv_VarRes_struct)); _temp215[ 0]=({ struct Cyc_Tcenv_VarRes_struct
...
struct Cyc_Dict_Dict* d, struct _tagged_arr* k, struct _tuple3* v)) Cyc_Dict_insert)(
ge->ordinaries, v,({ struct _tuple3* _temp229=( struct _tuple3*) _cycalloc(
sizeof( struct _tuple3)); _temp229->f1=( void*)({ struct Cyc_Tcenv_VarRes_struct*
_temp230=( struct Cyc_Tcenv_VarRes_struct*) _cycalloc( sizeof( struct Cyc_Tcenv_VarRes_struct));
...
struct Cyc_Core_Opt* _temp234=( struct Cyc_Core_Opt*) _cycalloc( sizeof( struct
Cyc_Core_Opt)); _temp234->v=( void*)(( void*)({ struct Cyc_Tcenv_Outermost_struct*
_temp235=( struct Cyc_Tcenv_Outermost_struct*) _cycalloc( sizeof( struct Cyc_Tcenv_Outermost_struct));
...
return; _LL239:;} if((( int(*)( struct Cyc_Dict_Dict* d, struct _tagged_arr* k))
Cyc_Dict_member)( ge->typedefs, v)){({ struct Cyc_Std_String_pa_struct _temp252;
_temp252.tag= Cyc_Std_String_pa; _temp252.f1=( struct _tagged_arr)* v;{ void*
_temp251[ 1u]={& _temp252}; Cyc_Tcutil_terr( loc, _tag_arr("redeclaration of typedef %s",
...
_temp268)){({ struct Cyc_Std_String_pa_struct _temp272; _temp272.tag= Cyc_Std_String_pa;
_temp272.f1=( struct _tagged_arr) obj;{ struct Cyc_Std_String_pa_struct _temp271;
_temp271.tag= Cyc_Std_String_pa; _temp271.f1=( struct _tagged_arr)* _temp268;{
void* _temp270[ 2u]={& _temp271,& _temp272}; Cyc_Tcutil_terr( loc, _tag_arr("duplicate field %s in %s",
sizeof( unsigned char), 25u), _tag_arr( _temp270, sizeof( void*), 2u));}}});}
if( Cyc_Std_strcmp(* _temp268, _tag_arr("", sizeof( unsigned char), 1u)) !=  0){
prev_fields=({ struct Cyc_List_List* _temp273=( struct Cyc_List_List*)
_region_malloc( uprev_rgn, sizeof( struct Cyc_List_List)); _temp273->hd=( void*)
_temp268; _temp273->tl= prev_fields; _temp273;});} Cyc_Tcutil_check_type( loc,
te, tvs,( void*) Cyc_Absyn_MemKind, 0, _temp264); Cyc_Tcutil_check_bitfield( loc,
te, _temp264, _temp262, _temp268);}}; _pop_region( uprev_rgn);} static void Cyc_Tc_tcStructOrUniondecl(
...
_tagged_arr* _temp274=(*(( struct _tuple0*)(( struct Cyc_Core_Opt*) _check_null(
sd->name))->v)).f2; if( sd->name ==  0){({ struct Cyc_Std_String_pa_struct
_temp276; _temp276.tag= Cyc_Std_String_pa; _temp276.f1=( struct _tagged_arr) obj;{
void* _temp275[ 1u]={& _temp276}; Cyc_Tcutil_terr( loc, _tag_arr("anonymous %ss are not allowed at top level",
...
continue; _LL284:({ struct Cyc_Std_String_pa_struct _temp288; _temp288.tag= Cyc_Std_String_pa;
_temp288.f1=( struct _tagged_arr)* _temp274;{ struct Cyc_Std_String_pa_struct
_temp287; _temp287.tag= Cyc_Std_String_pa; _temp287.f1=( struct _tagged_arr) obj;{
struct Cyc_Std_String_pa_struct _temp286; _temp286.tag= Cyc_Std_String_pa;
...
continue; _LL295:({ struct Cyc_Std_String_pa_struct _temp305; _temp305.tag= Cyc_Std_String_pa;
_temp305.f1=( struct _tagged_arr)*(( struct Cyc_Absyn_Tvar*)(( struct Cyc_List_List*)
_check_null( tvs))->hd)->name;{ struct Cyc_Std_String_pa_struct _temp304;
_temp304.tag= Cyc_Std_String_pa; _temp304.f1=( struct _tagged_arr)* _temp274;{
struct Cyc_Std_String_pa_struct _temp303; _temp303.tag= Cyc_Std_String_pa;
...
_cycalloc( sizeof( struct Cyc_Absyn_Abs_n_struct)); _temp319[ 0]=({ struct Cyc_Absyn_Abs_n_struct
...
struct _tagged_arr* k)) Cyc_Dict_lookup_opt)( ge->structdecls, _temp321);
...
struct Cyc_Dict_Dict*(*)( struct Cyc_Dict_Dict* d, struct _tagged_arr* k, struct
Cyc_Absyn_Structdecl** v)) Cyc_Dict_insert)( ge->structdecls, _temp321,({ struct
Cyc_Absyn_Structdecl** _temp363=( struct Cyc_Absyn_Structdecl**) _cycalloc(
sizeof( struct Cyc_Absyn_Structdecl*)); _temp363[ 0]= sd; _temp363;})); goto
_LL326; _LL330: { struct Cyc_Absyn_Structdecl** _temp364=({ struct Cyc_Absyn_Structdecl**
_temp365=( struct Cyc_Absyn_Structdecl**) _cycalloc( sizeof( struct Cyc_Absyn_Structdecl*));
_temp365[ 0]=({ struct Cyc_Absyn_Structdecl* _temp366=( struct Cyc_Absyn_Structdecl*)
_cycalloc( sizeof( struct Cyc_Absyn_Structdecl)); _temp366->sc=( void*)(( void*)
...
v)) Cyc_Dict_insert)( ge->structdecls, _temp321, _temp364); Cyc_Tc_tcStructFields(
...
_cycalloc( sizeof( struct Cyc_Absyn_Structdecl)); _temp368->sc=( void*)(( void*)
...
d, struct _tagged_arr* k, struct _tuple3* v)) Cyc_Dict_insert)( ge->ordinaries,
_temp321,({ struct _tuple3* _temp370=( struct _tuple3*) _cycalloc( sizeof(
struct _tuple3)); _temp370->f1=( void*)({ struct Cyc_Tcenv_StructRes_struct*
_temp371=( struct Cyc_Tcenv_StructRes_struct*) _cycalloc( sizeof( struct Cyc_Tcenv_StructRes_struct));
...
struct Cyc_Dict_Dict*(*)( struct Cyc_Dict_Dict* d, struct _tagged_arr* k, struct
Cyc_Absyn_Uniondecl** v)) Cyc_Dict_insert)( ge->uniondecls, _temp373,({ struct
Cyc_Absyn_Uniondecl** _temp415=( struct Cyc_Absyn_Uniondecl**) _cycalloc(
...
_temp421=( struct Cyc_Absyn_Uniondecl**) _cycalloc( sizeof( struct Cyc_Absyn_Uniondecl*));
_temp421[ 0]=({ struct Cyc_Absyn_Uniondecl* _temp422=( struct Cyc_Absyn_Uniondecl*)
_cycalloc( sizeof( struct Cyc_Absyn_Uniondecl)); _temp422->sc=( void*)(( void*)
...
struct Cyc_Dict_Dict*(*)( struct Cyc_Dict_Dict* d, struct _tagged_arr* k, struct
Cyc_Absyn_Uniondecl** v)) Cyc_Dict_insert)( ge->uniondecls, _temp373, _temp416);
Cyc_Tc_tcStructFields( te, ge, loc, _tag_arr( _temp374, sizeof( unsigned char),
6u), _temp396, _temp375);{ struct Cyc_List_List* f= _temp396; for( 0; f !=  0; f=((
...
struct Cyc_Std_String_pa_struct _temp420; _temp420.tag= Cyc_Std_String_pa;
...
_temp419; _temp419.tag= Cyc_Std_String_pa; _temp419.f1=( struct _tagged_arr)*
_temp373;{ struct Cyc_Std_String_pa_struct _temp418; _temp418.tag= Cyc_Std_String_pa;
...
_cycalloc( sizeof( struct Cyc_Absyn_Uniondecl)); _temp424->sc=( void*)(( void*)
...
goto _LL431; _LL435:({ struct Cyc_Std_String_pa_struct _temp443; _temp443.tag=
Cyc_Std_String_pa; _temp443.f1=( struct _tagged_arr)*(* _temp427->name).f2;{
...
_cycalloc( sizeof( struct Cyc_Absyn_Abs_n_struct)); _temp456[ 0]=({ struct Cyc_Absyn_Abs_n_struct
...
_temp459=( struct Cyc_Core_Impossible_struct*) _cycalloc( sizeof( struct Cyc_Core_Impossible_struct));
...
prev_fields,(* _temp464->name).f2)){({ struct Cyc_Std_String_pa_struct _temp467;
_temp467.tag= Cyc_Std_String_pa; _temp467.f1=( struct _tagged_arr) obj;{ struct
Cyc_Std_String_pa_struct _temp466; _temp466.tag= Cyc_Std_String_pa; _temp466.f1=(
struct _tagged_arr)*(* _temp464->name).f2;{ void* _temp465[ 2u]={& _temp466,&
_temp467}; Cyc_Tcutil_terr( _temp464->loc, _tag_arr("duplicate field name %s in %s",
...
_temp464->sc != ( void*) Cyc_Absyn_Public){({ struct Cyc_Std_String_pa_struct
_temp470; _temp470.tag= Cyc_Std_String_pa; _temp470.f1=( struct _tagged_arr)*(*
...
_tuple3*) _cycalloc( sizeof( struct _tuple3)); _temp473->f1=( void*)({ struct
Cyc_Tcenv_TunionRes_struct* _temp474=( struct Cyc_Tcenv_TunionRes_struct*)
_cycalloc( sizeof( struct Cyc_Tcenv_TunionRes_struct)); _temp474[ 0]=({ struct
...
_temp486=( struct Cyc_Absyn_Eq_constr_struct*) _cycalloc( sizeof( struct Cyc_Absyn_Eq_constr_struct));
...
goto _LL477; _LL481:({ struct Cyc_Std_String_pa_struct _temp491; _temp491.tag=
Cyc_Std_String_pa; _temp491.f1=( struct _tagged_arr)*(( struct Cyc_Absyn_Tvar*)((
struct Cyc_List_List*) _check_null( tvs2))->hd)->name;{ struct Cyc_Std_String_pa_struct
_temp490; _temp490.tag= Cyc_Std_String_pa; _temp490.f1=( struct _tagged_arr)* v;{
struct Cyc_Std_String_pa_struct _temp489; _temp489.tag= Cyc_Std_String_pa;
...
_LL501; _LL499:({ struct Cyc_Std_String_pa_struct _temp503; _temp503.tag= Cyc_Std_String_pa;
...
struct Cyc_List_List**)&(* _temp520.f1).v; goto _LL535;} _LL535: _temp534=
_temp520.f2; if( _temp534 ==  0){ goto _LL525;} else{ goto _LL526;} _LL526:
_LL548: _temp547= _temp520.f1; if( _temp547 ==  0){ goto _LL528;} else{ _temp549=*
_temp547; _LL551: _temp550=( struct Cyc_List_List*) _temp549.v; _temp552=(
struct Cyc_List_List**)&(* _temp520.f1).v; goto _LL543;} _LL543: _temp542=
_temp520.f2; if( _temp542 ==  0){ goto _LL528;} else{ _temp544=* _temp542;
_LL546: _temp545=( struct Cyc_Absyn_Tuniondecl**) _temp544.v; goto _LL527;}
_LL528: _LL559: _temp558= _temp520.f1; if( _temp558 ==  0){ goto _LL554;} else{
goto _LL521;} _LL554: _temp553= _temp520.f2; if( _temp553 ==  0){ goto _LL521;}
else{ _temp555=* _temp553; _LL557: _temp556=( struct Cyc_Absyn_Tuniondecl**)
...
Cyc_Dict_insert)( ge->tuniondecls, v,({ struct Cyc_Absyn_Tuniondecl** _temp560=(
...
_cycalloc( sizeof( struct Cyc_Absyn_Tuniondecl*)); _temp562[ 0]=({ struct Cyc_Absyn_Tuniondecl*
_temp563=( struct Cyc_Absyn_Tuniondecl*) _cycalloc( sizeof( struct Cyc_Absyn_Tuniondecl));
...
ge->tuniondecls, v, _temp561);* _temp541= Cyc_Tc_tcTunionFields( te, ge, loc,
obj, tud->is_xtunion, tud->name,* _temp541, tvs, tud);* _temp561= tud; goto
_LL521;} _LL527: { struct Cyc_Absyn_Tuniondecl* _temp564=* _temp545;* _temp545=({
struct Cyc_Absyn_Tuniondecl* _temp565=( struct Cyc_Absyn_Tuniondecl*) _cycalloc(
sizeof( struct Cyc_Absyn_Tuniondecl)); _temp565->sc=( void*)(( void*) Cyc_Absyn_Extern);
_temp565->name= tud->name; _temp565->tvs= tvs; _temp565->fields= 0; _temp565->is_xtunion=
tud->is_xtunion; _temp565;});* _temp552= Cyc_Tc_tcTunionFields( te, ge, loc, obj,
tud->is_xtunion, tud->name,* _temp552, tvs, tud);* _temp545= _temp564; _temp556=
_temp545; goto _LL529;} _LL529: { struct Cyc_Absyn_Tuniondecl* _temp566= Cyc_Tcdecl_merge_tuniondecl(*
_temp556, tud, loc, Cyc_Tc_tc_msg); if( _temp566 ==  0){ return;} else{*
_temp556=( struct Cyc_Absyn_Tuniondecl*) _check_null( _temp566); goto _LL521;}}
_LL521:;}}}} static void Cyc_Tc_tcEnumdecl( struct Cyc_Tcenv_Tenv* te, struct
Cyc_Tcenv_Genv* ge, struct Cyc_Position_Segment* loc, struct Cyc_Absyn_Enumdecl*
ed){ struct _tagged_arr* v=(* ed->name).f2;{ void* _temp567=(* ed->name).f1;
struct Cyc_List_List* _temp575; struct Cyc_List_List* _temp577; _LL569: if((
unsigned int) _temp567 >  1u?*(( int*) _temp567) ==  Cyc_Absyn_Rel_n: 0){ _LL576:
_temp575=(( struct Cyc_Absyn_Rel_n_struct*) _temp567)->f1; if( _temp575 ==  0){
goto _LL570;} else{ goto _LL571;}} else{ goto _LL571;} _LL571: if(( unsigned int)
_temp567 >  1u?*(( int*) _temp567) ==  Cyc_Absyn_Abs_n: 0){ _LL578: _temp577=((
struct Cyc_Absyn_Abs_n_struct*) _temp567)->f1; if( _temp577 ==  0){ goto _LL572;}
else{ goto _LL573;}} else{ goto _LL573;} _LL573: goto _LL574; _LL570: goto
_LL568; _LL572: goto _LL568; _LL574:({ void* _temp579[ 0u]={}; Cyc_Tcutil_terr(
loc, _tag_arr("qualified declarations are not implemented", sizeof(
unsigned char), 43u), _tag_arr( _temp579, sizeof( void*), 0u));}); return;
_LL568:;}(* ed->name).f1=( void*)({ struct Cyc_Absyn_Abs_n_struct* _temp580=(
struct Cyc_Absyn_Abs_n_struct*) _cycalloc( sizeof( struct Cyc_Absyn_Abs_n_struct));
...
prev_fields,(* _temp583->name).f2)){({ struct Cyc_Std_String_pa_struct _temp585;
_temp585.tag= Cyc_Std_String_pa; _temp585.f1=( struct _tagged_arr)*(* _temp583->name).f2;{
void* _temp584[ 1u]={& _temp585}; Cyc_Tcutil_terr( _temp583->loc, _tag_arr("duplicate field name %s",
sizeof( unsigned char), 24u), _tag_arr( _temp584, sizeof( void*), 1u));}});}
else{ prev_fields=({ struct Cyc_List_List* _temp586=( struct Cyc_List_List*)
_region_malloc( uprev_rgn, sizeof( struct Cyc_List_List)); _temp586->hd=( void*)(*
_temp583->name).f2; _temp586->tl= prev_fields; _temp586;});} if( _temp583->tag
==  0){ _temp583->tag=( struct Cyc_Absyn_Exp*) Cyc_Absyn_uint_exp( tag_count,
_temp583->loc);} else{ if( ! Cyc_Tcutil_is_const_exp( te,( struct Cyc_Absyn_Exp*)
_check_null( _temp583->tag))){({ struct Cyc_Std_String_pa_struct _temp589;
_temp589.tag= Cyc_Std_String_pa; _temp589.f1=( struct _tagged_arr)*(* _temp583->name).f2;{
struct Cyc_Std_String_pa_struct _temp588; _temp588.tag= Cyc_Std_String_pa;
...
_cycalloc( sizeof( struct Cyc_Absyn_Abs_n_struct)); _temp590[ 0]=({ struct Cyc_Absyn_Abs_n_struct
...
struct Cyc_Dict_Dict*(*)( struct Cyc_Dict_Dict* d, struct _tagged_arr* k, struct
Cyc_Absyn_Enumdecl** v)) Cyc_Dict_insert)( ge->enumdecls, v, _temp604); goto
_LL599;} _LL603:( void) _throw( _temp598); _LL599:;}}} if( ed->fields !=  0){
...
_tuple3*) _cycalloc( sizeof( struct _tuple3)); _temp607->f1=( void*)({ struct
Cyc_Tcenv_EnumRes_struct* _temp608=( struct Cyc_Tcenv_EnumRes_struct*) _cycalloc(
...
_cycalloc( sizeof( struct Cyc_List_List)); _temp685->hd=( void*) _temp668;
...
_cycalloc( sizeof( struct Cyc_List_List)); _temp716->hd=( void*) _temp675;
...
struct Cyc_List_List* _temp718=( struct Cyc_List_List*) _cycalloc( sizeof(
...
struct Cyc_List_List**)&(( struct Cyc_Absyn_Using_d_struct*) _temp719)->f2; goto
_LL724;} else{ goto _LL725;} _LL725: if(*(( int*) _temp719) ==  Cyc_Absyn_Namespace_d){
_LL735: _temp734=(( struct Cyc_Absyn_Namespace_d_struct*) _temp719)->f2;
_temp736=( struct Cyc_List_List**)&(( struct Cyc_Absyn_Namespace_d_struct*)
...
_tuple3*(*)( struct Cyc_Dict_Dict* d, struct _tagged_arr* k)) Cyc_Dict_lookup)(
...
Cyc_List_List* _temp763= Cyc_Tc_treeshake_f( _temp762, ds);(( void(*)( void(* f)(
struct Cyc_List_List*, struct _tuple6*), struct Cyc_Dict_Dict* d)) Cyc_Dict_iter)(
Cyc_Tc_treeshake_remove, _temp762); return _temp763;}
