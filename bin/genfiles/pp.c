...
# 144
struct _fat_ptr Cyc_PP_nlblanks(int i){struct Cyc_Core_Opt*_T0;struct Cyc_Hashtable_Table*(*_T1)(int,int(*)(int,int),int(*)(int));struct Cyc_Hashtable_Table*(*_T2)(int,int(*)(void*,void*),int(*)(void*));int(*_T3)(int,int);int(*_T4)(int);void*(*_T5)(void*);struct Cyc_Core_Failure_exn_struct*_T6;void*_T7;struct _handler_cons*_T8;int _T9;struct _fat_ptr*(*_TA)(struct Cyc_Hashtable_Table*,int);void*(*_TB)(struct Cyc_Hashtable_Table*,void*);struct Cyc_Core_Opt*_TC;void*_TD;struct Cyc_Hashtable_Table*_TE;int _TF;struct _fat_ptr*_T10;void*_T11;struct Cyc_Core_Not_found_exn_struct*_T12;char*_T13;char*_T14;int _T15;int _T16;int _T17;int _T18;unsigned _T19;struct _fat_ptr _T1A;unsigned char*_T1B;char*_T1C;unsigned _T1D;unsigned char*_T1E;char*_T1F;struct _fat_ptr _T20;int _T21;unsigned char*_T22;char*_T23;unsigned _T24;unsigned char*_T25;char*_T26;struct _fat_ptr _T27;int _T28;int _T29;int _T2A;unsigned char*_T2B;char*_T2C;unsigned _T2D;unsigned char*_T2E;char*_T2F;void(*_T30)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*);void(*_T31)(struct Cyc_Hashtable_Table*,void*,void*);struct Cyc_Core_Opt*_T32;void*_T33;struct Cyc_Hashtable_Table*_T34;int _T35;struct _fat_ptr*_T36;struct _fat_ptr*_T37;unsigned _T38;struct _fat_ptr _T39;struct _fat_ptr _T3A;int _T3B;unsigned _T3C;struct _fat_ptr _T3D;unsigned char*_T3E;char*_T3F;unsigned _T40;unsigned char*_T41;char*_T42;struct _fat_ptr _T43;unsigned char*_T44;char*_T45;unsigned _T46;unsigned char*_T47;char*_T48;struct _fat_ptr _T49;unsigned char*_T4A;char*_T4B;unsigned _T4C;unsigned char*_T4D;char*_T4E;struct _fat_ptr _T4F;int _T50;unsigned char*_T51;char*_T52;unsigned _T53;unsigned char*_T54;char*_T55;void(*_T56)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*);void(*_T57)(struct Cyc_Hashtable_Table*,void*,void*);struct Cyc_Core_Opt*_T58;void*_T59;struct Cyc_Hashtable_Table*_T5A;int _T5B;struct _fat_ptr*_T5C;struct _fat_ptr*_T5D;unsigned _T5E;struct _fat_ptr _T5F;struct _fat_ptr _T60;
if(Cyc_PP_bhashtbl!=0)goto _TLB;{struct Cyc_Core_Opt*_T61=_cycalloc(sizeof(struct Cyc_Core_Opt));_T2=Cyc_Hashtable_create;{
struct Cyc_Hashtable_Table*(*_T62)(int,int(*)(int,int),int(*)(int))=(struct Cyc_Hashtable_Table*(*)(int,int(*)(int,int),int(*)(int)))_T2;_T1=_T62;}_T3=Cyc_Core_intcmp;_T5=Cyc_Core_identity;{int(*_T62)(int)=(int(*)(int))_T5;_T4=_T62;}_T61->v=_T1(61,_T3,_T4);_T0=(struct Cyc_Core_Opt*)_T61;}Cyc_PP_bhashtbl=_T0;goto _TLC;_TLB: _TLC:
 if(i >= 0)goto _TLD;{struct Cyc_Core_Failure_exn_struct*_T61=_cycalloc(sizeof(struct Cyc_Core_Failure_exn_struct));_T61->tag=Cyc_Core_Failure;_T61->f1=_tag_fat("nlblanks",sizeof(char),9U);_T6=(struct Cyc_Core_Failure_exn_struct*)_T61;}_T7=(void*)_T6;_throw(_T7);goto _TLE;_TLD: _TLE: {struct _handler_cons _T61;_T8=& _T61;_push_handler(_T8);{int _T62=0;_T9=setjmp(_T61.handler);if(!_T9)goto _TLF;_T62=1;goto _TL10;_TLF: _TL10: if(_T62)goto _TL11;else{goto _TL13;}_TL13: _TB=Cyc_Hashtable_lookup;{
# 149
struct _fat_ptr*(*_T63)(struct Cyc_Hashtable_Table*,int)=(struct _fat_ptr*(*)(struct Cyc_Hashtable_Table*,int))_TB;_TA=_T63;}_TC=Cyc_PP_bhashtbl;_TD=_TC->v;_TE=(struct Cyc_Hashtable_Table*)_TD;_TF=i;_T10=_TA(_TE,_TF);{struct _fat_ptr _T63=*_T10;_npop_handler(0);return _T63;}_pop_handler();goto _TL12;_TL11: _T11=Cyc_Core_get_exn_thrown();{void*_T63=(void*)_T11;void*_T64;_T12=(struct Cyc_Core_Not_found_exn_struct*)_T63;_T13=_T12->tag;_T14=Cyc_Core_Not_found;if(_T13!=_T14)goto _TL14;_T15=Cyc_PP_tex_output;
# 152
...
struct _fat_ptr nlb=Cyc_Core_new_string(_T19);_T1A=nlb;{struct _fat_ptr _T65=_fat_ptr_plus(_T1A,sizeof(char),0);_T1B=_check_fat_subscript(_T65,sizeof(char),0U);_T1C=(char*)_T1B;{char _T66=*_T1C;char _T67='\n';_T1D=_get_fat_size(_T65,sizeof(char));if(_T1D!=1U)goto _TL19;if(_T66!=0)goto _TL19;if(_T67==0)goto _TL19;_throw_arraybounds();goto _TL1A;_TL19: _TL1A: _T1E=_T65.curr;_T1F=(char*)_T1E;*_T1F=_T67;}}{
# 158
int j=0;_TL1E: if(j < num_tabs)goto _TL1C;else{goto _TL1D;}
_TL1C: _T20=nlb;_T21=j + 1;{struct _fat_ptr _T65=_fat_ptr_plus(_T20,sizeof(char),_T21);_T22=_check_fat_subscript(_T65,sizeof(char),0U);_T23=(char*)_T22;{char _T66=*_T23;char _T67='\t';_T24=_get_fat_size(_T65,sizeof(char));if(_T24!=1U)goto _TL1F;if(_T66!=0)goto _TL1F;if(_T67==0)goto _TL1F;_throw_arraybounds();goto _TL20;_TL1F: _TL20: _T25=_T65.curr;_T26=(char*)_T25;*_T26=_T67;}}
# 158
j=j + 1;goto _TL1E;_TL1D:;}{
# 160
int j=0;_TL24: if(j < num_spaces)goto _TL22;else{goto _TL23;}
_TL22: _T27=nlb;_T28=j + 1;_T29=num_tabs;_T2A=_T28 + _T29;{struct _fat_ptr _T65=_fat_ptr_plus(_T27,sizeof(char),_T2A);_T2B=_check_fat_subscript(_T65,sizeof(char),0U);_T2C=(char*)_T2B;{char _T66=*_T2C;char _T67=' ';_T2D=_get_fat_size(_T65,sizeof(char));if(_T2D!=1U)goto _TL25;if(_T66!=0)goto _TL25;if(_T67==0)goto _TL25;_throw_arraybounds();goto _TL26;_TL25: _TL26: _T2E=_T65.curr;_T2F=(char*)_T2E;*_T2F=_T67;}}
# 160
j=j + 1;goto _TL24;_TL23:;}_T31=Cyc_Hashtable_insert;{
# 162
void(*_T65)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*)=(void(*)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*))_T31;_T30=_T65;}_T32=_check_null(Cyc_PP_bhashtbl);_T33=_T32->v;_T34=(struct Cyc_Hashtable_Table*)_T33;_T35=i;{unsigned _T65=1;_T38=_check_times(_T65,sizeof(struct _fat_ptr));{struct _fat_ptr*_T66=_cycalloc(_T38);_T39=nlb;_T66[0]=_T39;_T37=(struct _fat_ptr*)_T66;}_T36=_T37;}_T30(_T34,_T35,_T36);_T3A=nlb;
return _T3A;}}}
# 168
_TL16:{int total=3 + i;_T3B=total + 1;_T3C=(unsigned)_T3B;{
struct _fat_ptr nlb=Cyc_Core_new_string(_T3C);_T3D=nlb;{struct _fat_ptr _T65=_fat_ptr_plus(_T3D,sizeof(char),0);_T3E=_T65.curr;_T3F=(char*)_T3E;{char _T66=*_T3F;char _T67='\\';_T40=_get_fat_size(_T65,sizeof(char));if(_T40!=1U)goto _TL27;if(_T66!=0)goto _TL27;if(_T67==0)goto _TL27;_throw_arraybounds();goto _TL28;_TL27: _TL28: _T41=_T65.curr;_T42=(char*)_T41;*_T42=_T67;}}_T43=nlb;{struct _fat_ptr _T65=_fat_ptr_plus(_T43,sizeof(char),1);_T44=_T65.curr;_T45=(char*)_T44;{char _T66=*_T45;char _T67='\\';_T46=_get_fat_size(_T65,sizeof(char));if(_T46!=1U)goto _TL29;if(_T66!=0)goto _TL29;if(_T67==0)goto _TL29;_throw_arraybounds();goto _TL2A;_TL29: _TL2A: _T47=_T65.curr;_T48=(char*)_T47;*_T48=_T67;}}_T49=nlb;{struct _fat_ptr _T65=_fat_ptr_plus(_T49,sizeof(char),2);_T4A=_T65.curr;_T4B=(char*)_T4A;{char _T66=*_T4B;char _T67='\n';_T4C=_get_fat_size(_T65,sizeof(char));if(_T4C!=1U)goto _TL2B;if(_T66!=0)goto _TL2B;if(_T67==0)goto _TL2B;_throw_arraybounds();goto _TL2C;_TL2B: _TL2C: _T4D=_T65.curr;_T4E=(char*)_T4D;*_T4E=_T67;}}{
# 173
int j=3;_TL30: if(j < total)goto _TL2E;else{goto _TL2F;}
_TL2E: _T4F=nlb;_T50=j;{struct _fat_ptr _T65=_fat_ptr_plus(_T4F,sizeof(char),_T50);_T51=_check_fat_subscript(_T65,sizeof(char),0U);_T52=(char*)_T51;{char _T66=*_T52;char _T67='~';_T53=_get_fat_size(_T65,sizeof(char));if(_T53!=1U)goto _TL31;if(_T66!=0)goto _TL31;if(_T67==0)goto _TL31;_throw_arraybounds();goto _TL32;_TL31: _TL32: _T54=_T65.curr;_T55=(char*)_T54;*_T55=_T67;}}
# 173
j=j + 1;goto _TL30;_TL2F:;}_T57=Cyc_Hashtable_insert;{
# 175
void(*_T65)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*)=(void(*)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*))_T57;_T56=_T65;}_T58=_check_null(Cyc_PP_bhashtbl);_T59=_T58->v;_T5A=(struct Cyc_Hashtable_Table*)_T59;_T5B=i;{unsigned _T65=1;_T5E=_check_times(_T65,sizeof(struct _fat_ptr));{struct _fat_ptr*_T66=_cycalloc(_T5E);_T5F=nlb;_T66[0]=_T5F;_T5D=(struct _fat_ptr*)_T66;}_T5C=_T5D;}_T56(_T5A,_T5B,_T5C);_T60=nlb;
return _T60;}}_TL14: _T64=_T63;{void*exn=_T64;_rethrow(exn);};}_TL12:;}}}
# 182
...
# 419
struct Cyc_PP_Doc*Cyc_PP_cats_arr(struct _fat_ptr docs){struct _fat_ptr _T0;unsigned _T1;struct Cyc_Core_Failure_exn_struct*_T2;void*_T3;struct _fat_ptr _T4;unsigned char*_T5;struct Cyc_PP_Doc**_T6;struct Cyc_PP_Doc*_T7;struct Cyc_PP_Doc*_T8;int _T9;int _TA;struct _fat_ptr _TB;int _TC;unsigned char*_TD;struct Cyc_PP_Doc**_TE;struct Cyc_PP_Doc*_TF;int _T10;int _T11;int _T12;int _T13;struct _fat_ptr _T14;unsigned char*_T15;struct Cyc_PP_Doc**_T16;int _T17;struct Cyc_PP_Doc*_T18;int _T19;int _T1A;struct Cyc_PP_Doc*_T1B;struct Cyc_Fn_Function*(*_T1C)(struct Cyc_PP_Out*(*)(struct _fat_ptr*,struct Cyc_PP_Ppstate*),struct _fat_ptr*);struct Cyc_Fn_Function*(*_T1D)(void*(*)(void*,void*),void*);struct _fat_ptr*_T1E;struct _fat_ptr*_T1F;unsigned _T20;_T0=docs;_T1=
