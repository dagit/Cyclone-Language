...
int last=0;
while(last >= 0){
void*_stmttmp1=Cyc_Xarray_get(xarr,last);void*_Tmp0=_stmttmp1;void*_Tmp1;void*_Tmp2;switch(*((int*)_Tmp0)){case 0:
...
struct Cyc_PP_Out*o=({struct Cyc_Fn_Function*_Tmp0=d->f;({(struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*))Cyc_Fn_apply;})(_Tmp0,({struct Cyc_PP_Ppstate*_Tmp1=_cycalloc(sizeof(struct Cyc_PP_Ppstate));_Tmp1->ci=0,_Tmp1->cc=0,_Tmp1->cl=1,_Tmp1->pw=w,_Tmp1->epw=w;_Tmp1;}));});
return({struct Cyc_List_List*_Tmp0=Cyc_PP_list_of_alist(o->ppout);Cyc_str_sepstr(_Tmp0,({const char*_Tmp1="";_tag_fat(_Tmp1,sizeof(char),1U);}));});}struct _tuple1{struct _fat_ptr f1;struct Cyc_List_List*f2;};
# 133
...
struct Cyc_List_List*_Tmp2=Cyc_PP_list_of_alist(o->ppout);Cyc_str_sepstr(_Tmp2,({const char*_Tmp3="";_tag_fat(_Tmp3,sizeof(char),1U);}));});
# 135
_Tmp0->f1=_Tmp1;}),({
# 137
struct Cyc_List_List*_Tmp1=Cyc_PP_list_of_alist(o->links);_Tmp0->f2=_Tmp1;});_Tmp0;});}
# 140
...
if(i < 0)(void*)_throw((void*)({struct Cyc_Core_Failure_exn_struct*_Tmp0=_cycalloc(sizeof(struct Cyc_Core_Failure_exn_struct));_Tmp0->tag=Cyc_Core_Failure,_Tmp0->f1=({const char*_Tmp1="nlblanks";_tag_fat(_Tmp1,sizeof(char),9U);});_Tmp0;}));{
...
({struct Cyc_Hashtable_Table*_Tmp5=(struct Cyc_Hashtable_Table*)(_check_null(Cyc_PP_bhashtbl))->v;int _Tmp6=i;({(void(*)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*))Cyc_Hashtable_insert;})(_Tmp5,_Tmp6,({unsigned _Tmp7=1;({struct _fat_ptr*_Tmp8=_cycalloc(_check_times(_Tmp7,sizeof(struct _fat_ptr)));_Tmp8[0]=nlb;_Tmp8;});}));});
return nlb;}else{
# 168
int total=3 + i;
...
({struct Cyc_Hashtable_Table*_Tmp5=(struct Cyc_Hashtable_Table*)(_check_null(Cyc_PP_bhashtbl))->v;int _Tmp6=i;({(void(*)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*))Cyc_Hashtable_insert;})(_Tmp5,_Tmp6,({unsigned _Tmp7=1;({struct _fat_ptr*_Tmp8=_cycalloc(_check_times(_Tmp7,sizeof(struct _fat_ptr)));_Tmp8[0]=nlb;_Tmp8;});}));});
return nlb;}}else{_Tmp4=_Tmp3;{void*exn=_Tmp4;(void*)_rethrow(exn);}};}}}}
# 182
...
# 200
_Tmp2->f1=slen,_Tmp2->f2=s;_Tmp2;}));
# 198
_Tmp0->f=_Tmp1;});_Tmp0;});}
# 202
...
({struct Cyc_Hashtable_Table*_Tmp5=t;struct _fat_ptr*_Tmp6=({struct _fat_ptr*_Tmp7=_cycalloc(sizeof(struct _fat_ptr));*_Tmp7=s;_Tmp7;});({(void(*)(struct Cyc_Hashtable_Table*,struct _fat_ptr*,struct Cyc_PP_Doc*))Cyc_Hashtable_insert;})(_Tmp5,_Tmp6,d);});
return d;}else{_Tmp4=_Tmp3;{void*exn=_Tmp4;(void*)_rethrow(exn);}};}}}}
# 219
...
# 281
struct Cyc_Fn_Function*_Tmp1=({(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct _tuple3*,struct Cyc_PP_Ppstate*),struct _tuple3*))Cyc_Fn_make_fn;})(Cyc_PP_hyperlink_f,({struct _tuple3*_Tmp2=_cycalloc(sizeof(struct _tuple3));_Tmp2->f1=slen,_Tmp2->f2=shrt,_Tmp2->f3=full;_Tmp2;}));_Tmp0->f=_Tmp1;});_Tmp0;});}
# 285
...
# 334
void*_Tmp3=Cyc_PP_append(o1->ppout,o2->ppout);o3->ppout=_Tmp3;}),({
void*_Tmp3=Cyc_PP_append(o1->links,o2->links);o3->links=_Tmp3;});
return o3;}}}}
# 338
...
struct Cyc_Fn_Function*_Tmp1=({(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct _tuple6*,struct Cyc_PP_Ppstate*),struct _tuple6*))Cyc_Fn_make_fn;})(Cyc_PP_concat_f,({struct _tuple6*_Tmp2=_cycalloc(sizeof(struct _tuple6));_Tmp2->f1=d1,_Tmp2->f2=d2;_Tmp2;}));_Tmp0->f=_Tmp1;});_Tmp0;});}
# 343
...
int sz=(int)_get_fat_size(docs,sizeof(struct Cyc_PP_Doc*));
if(sz == 0)
(void*)_throw((void*)({struct Cyc_Core_Failure_exn_struct*_Tmp0=_cycalloc(sizeof(struct Cyc_Core_Failure_exn_struct));_Tmp0->tag=Cyc_Core_Failure,_Tmp0->f1=({const char*_Tmp1="cats_arr -- size zero array";_tag_fat(_Tmp1,sizeof(char),28U);});_Tmp0;}));{
...
struct Cyc_Fn_Function*_Tmp1=({(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct _tuple6*,struct Cyc_PP_Ppstate*),struct _tuple6*))Cyc_Fn_make_fn;})(Cyc_PP_doc_union_f,({struct _tuple6*_Tmp2=_cycalloc(sizeof(struct _tuple6));_Tmp2->f1=d,_Tmp2->f2=d2;_Tmp2;}));_Tmp0->f=_Tmp1;});_Tmp0;});}
# 449
