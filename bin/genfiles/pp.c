...
void*_tmp3=y;void*_tmp7;void*_tmp6;void*_tmp5;switch(*((int*)_tmp3)){case 0U: _LL1: _LL2:
 ...
 return({void*_tmp9F=_tmp7;Cyc_PP_list_of_alist_f(_tmp9F,Cyc_PP_list_of_alist_f(_tmp6,l));});}_LL0:;}
# 69
...
void*_tmp9=((void*(*)(struct Cyc_Xarray_Xarray*,int))Cyc_Xarray_get)(_tmp8,last);void*_tmpA=_tmp9;void*_tmp10;void*_tmpF;struct _dyneither_ptr*_tmpE;switch(*((int*)_tmpA)){case 0U: _LL1: _LL2:
 ...
 -- last;({struct Cyc_String_pa_PrintArg_struct _tmpD;_tmpD.tag=0U;_tmpD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmpE);({void*_tmpB[1U];_tmpB[0]=& _tmpD;({struct Cyc___cycFILE*_tmpA1=f;struct _dyneither_ptr _tmpA0=({const char*_tmpC="%s";_tag_dyneither(_tmpC,sizeof(char),3U);});Cyc_fprintf(_tmpA1,_tmpA0,_tag_dyneither(_tmpB,sizeof(void*),1U));});});});goto _LL0;default: _LL5: _tmp10=(void*)((struct Cyc_PP_Append_PP_Alist_struct*)_tmpA)->f1;_tmpF=(void*)((struct Cyc_PP_Append_PP_Alist_struct*)_tmpA)->f2;_LL6:
# 107
((void(*)(struct Cyc_Xarray_Xarray*,int,void*))Cyc_Xarray_set)(_tmp8,last,_tmpF);
if(({int _tmpA2=last;_tmpA2 == ((int(*)(struct Cyc_Xarray_Xarray*))Cyc_Xarray_length)(_tmp8)- 1;}))
...
# 120
void Cyc_PP_file_of_doc(struct Cyc_PP_Doc*d,int w,struct Cyc___cycFILE*f){
struct Cyc_PP_Out*o=({struct Cyc_Fn_Function*_tmpA3=d->f;((struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*f,struct Cyc_PP_Ppstate*x))Cyc_Fn_apply)(_tmpA3,({struct Cyc_PP_Ppstate*_tmp11=_cycalloc(sizeof(*_tmp11));((((((((*_tmp11).ci=0,(*_tmp11).cc=0)),(*_tmp11).cl=1)),(*_tmp11).pw=w)),(*_tmp11).epw=w);_tmp11;}));});
Cyc_PP_dump_out(f,o->ppout);}
# 126
struct _dyneither_ptr Cyc_PP_string_of_doc(struct Cyc_PP_Doc*d,int w){
struct Cyc_PP_Out*o=({struct Cyc_Fn_Function*_tmpA4=d->f;((struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*f,struct Cyc_PP_Ppstate*x))Cyc_Fn_apply)(_tmpA4,({struct Cyc_PP_Ppstate*_tmp13=_cycalloc(sizeof(*_tmp13));((((((((*_tmp13).ci=0,(*_tmp13).cc=0)),(*_tmp13).cl=1)),(*_tmp13).pw=w)),(*_tmp13).epw=w);_tmp13;}));});
return(struct _dyneither_ptr)({struct Cyc_List_List*_tmpA5=((struct Cyc_List_List*(*)(void*x))Cyc_PP_list_of_alist)(o->ppout);Cyc_str_sepstr(_tmpA5,({const char*_tmp12="";_tag_dyneither(_tmp12,sizeof(char),1U);}));});}
# 133
struct _tuple0*Cyc_PP_string_and_links(struct Cyc_PP_Doc*d,int w){
struct Cyc_PP_Out*o=({struct Cyc_Fn_Function*_tmpA6=d->f;((struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*f,struct Cyc_PP_Ppstate*x))Cyc_Fn_apply)(_tmpA6,({struct Cyc_PP_Ppstate*_tmp16=_cycalloc(sizeof(*_tmp16));((((((((*_tmp16).ci=0,(*_tmp16).cc=0)),(*_tmp16).cl=1)),(*_tmp16).pw=w)),(*_tmp16).epw=w);_tmp16;}));});
return({struct _tuple0*_tmp15=_cycalloc(sizeof(*_tmp15));(({struct _dyneither_ptr _tmpA9=(struct _dyneither_ptr)({
struct Cyc_List_List*_tmpA8=((struct Cyc_List_List*(*)(void*x))Cyc_PP_list_of_alist)(o->ppout);Cyc_str_sepstr(_tmpA8,({const char*_tmp14="";_tag_dyneither(_tmp14,sizeof(char),1U);}));});
# 135
(*_tmp15).f1=_tmpA9;}),({
# 137
struct Cyc_List_List*_tmpA7=((struct Cyc_List_List*(*)(void*x))Cyc_PP_list_of_alist)(o->links);(*_tmp15).f2=_tmpA7;}));_tmp15;});}
# 140
...
({struct Cyc_Core_Opt*_tmpAB=({struct Cyc_Core_Opt*_tmp17=_cycalloc(sizeof(*_tmp17));({struct Cyc_Hashtable_Table*_tmpAA=((struct Cyc_Hashtable_Table*(*)(int sz,int(*cmp)(int,int),int(*hash)(int)))Cyc_Hashtable_create)(61,Cyc_Core_intcmp,(int(*)(int))Cyc_Core_identity);(*_tmp17).v=_tmpAA;});_tmp17;});Cyc_PP_bhashtbl=_tmpAB;});
if(i < 0)(int)_throw((void*)({struct Cyc_Core_Failure_exn_struct*_tmp19=_cycalloc(sizeof(*_tmp19));((*_tmp19).tag=Cyc_Core_Failure,({struct _dyneither_ptr _tmpAC=({const char*_tmp18="nlblanks";_tag_dyneither(_tmp18,sizeof(char),9U);});(*_tmp19).f1=_tmpAC;}));_tmp19;}));{
...
({struct Cyc_Hashtable_Table*_tmpAE=(struct Cyc_Hashtable_Table*)((struct Cyc_Core_Opt*)_check_null(Cyc_PP_bhashtbl))->v;int _tmpAD=i;((void(*)(struct Cyc_Hashtable_Table*t,int key,struct _dyneither_ptr*val))Cyc_Hashtable_insert)(_tmpAE,_tmpAD,({unsigned int _tmp2C=1;struct _dyneither_ptr*_tmp2B=_cycalloc(_check_times(_tmp2C,sizeof(struct _dyneither_ptr)));_tmp2B[0]=(struct _dyneither_ptr)nlb;_tmp2B;}));});
...
({struct Cyc_Hashtable_Table*_tmpB0=(struct Cyc_Hashtable_Table*)((struct Cyc_Core_Opt*)_check_null(Cyc_PP_bhashtbl))->v;int _tmpAF=i;((void(*)(struct Cyc_Hashtable_Table*t,int key,struct _dyneither_ptr*val))Cyc_Hashtable_insert)(_tmpB0,_tmpAF,({unsigned int _tmp3B=1;struct _dyneither_ptr*_tmp3A=_cycalloc(_check_times(_tmp3B,sizeof(struct _dyneither_ptr)));_tmp3A[0]=(struct _dyneither_ptr)nlb;_tmp3A;}));});
...
# 190
void*_tmpB2=(void*)({struct Cyc_PP_Single_PP_Alist_struct*_tmp40=_cycalloc(sizeof(*_tmp40));((*_tmp40).tag=1U,({struct _dyneither_ptr*_tmpB1=({unsigned int _tmp3F=1;struct _dyneither_ptr*_tmp3E=_cycalloc(_check_times(_tmp3F,sizeof(struct _dyneither_ptr)));_tmp3E[0]=_tmp42;_tmp3E;});(*_tmp40).f1=_tmpB1;}));_tmp40;});(*_tmp41).ppout=_tmpB2;}))),(*_tmp41).links=(void*)& Cyc_PP_Empty_link);_tmp41;});}
# 193
...
({struct Cyc_Hashtable_Table*_tmpB4=((struct Cyc_Hashtable_Table*(*)(int sz,int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*),int(*hash)(struct _dyneither_ptr*)))Cyc_Hashtable_create)(101,Cyc_zstrptrcmp,Cyc_Hashtable_hash_stringptr);t=_tmpB4;});
({struct Cyc_Core_Opt*_tmpB5=({struct Cyc_Core_Opt*_tmp46=_cycalloc(sizeof(*_tmp46));(*_tmp46).v=t;_tmp46;});Cyc_PP_str_hashtbl=_tmpB5;});}else{
# 208
...
{struct Cyc_PP_Doc*_tmp4B=({struct Cyc_Hashtable_Table*_tmpB6=t;((struct Cyc_PP_Doc*(*)(struct Cyc_Hashtable_Table*t,struct _dyneither_ptr*key))Cyc_Hashtable_lookup)(_tmpB6,({struct _dyneither_ptr*_tmp4A=_cycalloc(sizeof(*_tmp4A));*_tmp4A=s;_tmp4A;}));});_npop_handler(0U);return _tmp4B;};_pop_handler();}else{void*_tmp48=(void*)_exn_thrown;void*_tmp4C=_tmp48;void*_tmp4E;if(((struct Cyc_Core_Not_found_exn_struct*)_tmp4C)->tag == Cyc_Core_Not_found){_LL1: _LL2: {
# 214
struct Cyc_PP_Doc*d=Cyc_PP_text_doc(s);
({struct Cyc_Hashtable_Table*_tmpB8=t;struct _dyneither_ptr*_tmpB7=({struct _dyneither_ptr*_tmp4D=_cycalloc(sizeof(*_tmp4D));*_tmp4D=s;_tmp4D;});((void(*)(struct Cyc_Hashtable_Table*t,struct _dyneither_ptr*key,struct Cyc_PP_Doc*val))Cyc_Hashtable_insert)(_tmpB8,_tmpB7,d);});
...
# 228
struct Cyc_Fn_Function*_tmpB9=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct _tuple2*,struct Cyc_PP_Ppstate*),struct _tuple2*x))Cyc_Fn_make_fn)(Cyc_PP_text_doc_f,({struct _tuple2*_tmp4F=_cycalloc(sizeof(*_tmp4F));
# 230
((*_tmp4F).f1=slen,(*_tmp4F).f2=s);_tmp4F;}));
# 228
(*_tmp50).f=_tmpB9;}));_tmp50;});}
# 232
...
({struct Cyc_Core_Opt*_tmpBB=({struct Cyc_Core_Opt*_tmp51=_cycalloc(sizeof(*_tmp51));(*_tmp51).v=t;_tmp51;});Cyc_PP_str_hashtbl2=_tmpBB;});}else{
# 239
...
{struct Cyc_PP_Doc*_tmp56=({struct Cyc_Hashtable_Table*_tmpBC=t;((struct Cyc_PP_Doc*(*)(struct Cyc_Hashtable_Table*t,struct _dyneither_ptr*key))Cyc_Hashtable_lookup)(_tmpBC,({struct _dyneither_ptr*_tmp55=_cycalloc(sizeof(*_tmp55));*_tmp55=s;_tmp55;}));});_npop_handler(0U);return _tmp56;};_pop_handler();}else{void*_tmp53=(void*)_exn_thrown;void*_tmp57=_tmp53;void*_tmp59;if(((struct Cyc_Core_Not_found_exn_struct*)_tmp57)->tag == Cyc_Core_Not_found){_LL1: _LL2: {
# 245
struct Cyc_PP_Doc*d=Cyc_PP_text_width_doc(s,slen);
({struct Cyc_Hashtable_Table*_tmpBE=t;struct _dyneither_ptr*_tmpBD=({struct _dyneither_ptr*_tmp58=_cycalloc(sizeof(*_tmp58));*_tmp58=s;_tmp58;});((void(*)(struct Cyc_Hashtable_Table*t,struct _dyneither_ptr*key,struct Cyc_PP_Doc*val))Cyc_Hashtable_insert)(_tmpBE,_tmpBD,d);});
...
({struct Cyc_Core_Opt*_tmpC0=({struct Cyc_Core_Opt*_tmp5B=_cycalloc(sizeof(*_tmp5B));({struct Cyc_PP_Doc*_tmpBF=Cyc_PP_text(({const char*_tmp5A="";_tag_dyneither(_tmp5A,sizeof(char),1U);}));(*_tmp5B).v=_tmpBF;});_tmp5B;});Cyc_PP_nil_doc_opt=_tmpC0;});
return(struct Cyc_PP_Doc*)((struct Cyc_Core_Opt*)_check_null(Cyc_PP_nil_doc_opt))->v;}
# 264
struct Cyc_PP_Doc*Cyc_PP_blank_doc(){
if(Cyc_PP_blank_doc_opt == 0)
({struct Cyc_Core_Opt*_tmpC2=({struct Cyc_Core_Opt*_tmp5D=_cycalloc(sizeof(*_tmp5D));({struct Cyc_PP_Doc*_tmpC1=Cyc_PP_text(({const char*_tmp5C="";_tag_dyneither(_tmp5C,sizeof(char),1U);}));(*_tmp5D).v=_tmpC1;});_tmp5D;});Cyc_PP_blank_doc_opt=_tmpC2;});
...
# 274
void*_tmpC6=(void*)({struct Cyc_PP_Single_PP_Alist_struct*_tmp61=_cycalloc(sizeof(*_tmp61));((*_tmp61).tag=1U,({struct _dyneither_ptr*_tmpC5=({unsigned int _tmp60=1;struct _dyneither_ptr*_tmp5F=_cycalloc(_check_times(_tmp60,sizeof(struct _dyneither_ptr)));_tmp5F[0]=_tmp66;_tmp5F;});(*_tmp61).f1=_tmpC5;}));_tmp61;});(*_tmp64).ppout=_tmpC6;}))),({
void*_tmpC4=(void*)({struct Cyc_PP_Single_PP_Alist_struct*_tmp63=_cycalloc(sizeof(*_tmp63));((*_tmp63).tag=1U,({struct _tuple4*_tmpC3=({struct _tuple4*_tmp62=_cycalloc(sizeof(*_tmp62));((((((*_tmp62).f1=st->cl,(*_tmp62).f2=st->cc)),(*_tmp62).f3=_tmp67)),(*_tmp62).f4=_tmp65);_tmp62;});(*_tmp63).f1=_tmpC3;}));_tmp63;});(*_tmp64).links=_tmpC4;}));_tmp64;});}
# 277
struct Cyc_PP_Doc*Cyc_PP_hyperlink(struct _dyneither_ptr shrt,struct _dyneither_ptr full){
...
# 281
struct Cyc_Fn_Function*_tmpC7=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct _tuple3*,struct Cyc_PP_Ppstate*),struct _tuple3*x))Cyc_Fn_make_fn)(Cyc_PP_hyperlink_f,({struct _tuple3*_tmp68=_cycalloc(sizeof(*_tmp68));((((*_tmp68).f1=slen,(*_tmp68).f2=shrt)),(*_tmp68).f3=full);_tmp68;}));(*_tmp69).f=_tmpC7;}));_tmp69;});}
# 285
...
# 288
void*_tmpCA=(void*)({struct Cyc_PP_Single_PP_Alist_struct*_tmp6C=_cycalloc(sizeof(*_tmp6C));((*_tmp6C).tag=1U,({struct _dyneither_ptr*_tmpC9=({unsigned int _tmp6B=1;struct _dyneither_ptr*_tmp6A=_cycalloc(_check_times(_tmp6B,sizeof(struct _dyneither_ptr)));({struct _dyneither_ptr _tmpC8=Cyc_PP_nlblanks(st->ci);_tmp6A[0]=_tmpC8;});_tmp6A;});(*_tmp6C).f1=_tmpC9;}));_tmp6C;});(*_tmp6D).ppout=_tmpCA;}))),(*_tmp6D).links=(void*)& Cyc_PP_Empty_link);_tmp6D;});}
# 291
struct Cyc_PP_Doc*Cyc_PP_line_doc(){
if(Cyc_PP_line_doc_opt == 0)
({struct Cyc_Core_Opt*_tmpCD=({struct Cyc_Core_Opt*_tmp6F=_cycalloc(sizeof(*_tmp6F));({struct Cyc_PP_Doc*_tmpCC=({struct Cyc_PP_Doc*_tmp6E=_cycalloc(sizeof(*_tmp6E));((((*_tmp6E).mwo=0,(*_tmp6E).mw=0)),({struct Cyc_Fn_Function*_tmpCB=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct Cyc_PP_Ppstate*)))Cyc_Fn_fp2fn)(Cyc_PP_line_f);(*_tmp6E).f=_tmpCB;}));_tmp6E;});(*_tmp6F).v=_tmpCC;});_tmp6F;});Cyc_PP_line_doc_opt=_tmpCD;});
...
# 310
struct Cyc_Fn_Function*_tmpCE=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct _tuple5*,struct Cyc_PP_Ppstate*),struct _tuple5*x))Cyc_Fn_make_fn)(Cyc_PP_nest_f,({struct _tuple5*_tmp74=_cycalloc(sizeof(*_tmp74));
# 312
((*_tmp74).f1=k,(*_tmp74).f2=d);_tmp74;}));
# 310
(*_tmp75).f=_tmpCE;}));_tmp75;});}
# 315
...
# 334
void*_tmpD0=((void*(*)(void*a1,void*a2))Cyc_PP_append)(o1->ppout,o2->ppout);(*_tmp77).ppout=_tmpD0;}))),({
void*_tmpCF=((void*(*)(void*a1,void*a2))Cyc_PP_append)(o1->links,o2->links);(*_tmp77).links=_tmpCF;}));_tmp77;});
return o3;};}
# 338
static struct Cyc_PP_Doc*Cyc_PP_concat(struct Cyc_PP_Doc*d1,struct Cyc_PP_Doc*d2){
return({struct Cyc_PP_Doc*_tmp7D=_cycalloc(sizeof(*_tmp7D));(((({int _tmpD3=Cyc_PP_min(d1->mw,d1->mwo + d2->mwo);(*_tmp7D).mwo=_tmpD3;}),({
int _tmpD2=Cyc_PP_min(d1->mw,d1->mwo + d2->mw);(*_tmp7D).mw=_tmpD2;}))),({
struct Cyc_Fn_Function*_tmpD1=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct _tuple6*,struct Cyc_PP_Ppstate*),struct _tuple6*x))Cyc_Fn_make_fn)(Cyc_PP_concat_f,({struct _tuple6*_tmp7C=_cycalloc(sizeof(*_tmp7C));((*_tmp7C).f1=d1,(*_tmp7C).f2=d2);_tmp7C;}));(*_tmp7D).f=_tmpD1;}));_tmp7D;});}
# 343
...
({struct Cyc_PP_Doc*_tmpD4=Cyc_PP_concat(*((struct Cyc_PP_Doc**)_check_dyneither_subscript(l,sizeof(struct Cyc_PP_Doc*),i)),_tmp7E);_tmp7E=_tmpD4;});}}
# 348
return _tmp7E;}
# 353
...
({struct Cyc_PP_Ppstate*_tmpD5=({struct Cyc_PP_Ppstate*_tmp80=_cycalloc(sizeof(*_tmp80));((((((((*_tmp80).ci=st->ci,(*_tmp80).cc=o->newcc)),(*_tmp80).cl=o->newcl)),(*_tmp80).pw=st->pw)),(*_tmp80).epw=st->epw - d->mwo);_tmp80;});st=_tmpD5;});
({struct Cyc_List_List*_tmpD6=({struct Cyc_List_List*_tmp81=_cycalloc(sizeof(*_tmp81));((*_tmp81).hd=o,(*_tmp81).tl=os);_tmp81;});os=_tmpD6;});}}{
# 361
...
for(0;os != 0;os=os->tl){
({void*_tmpD7=((void*(*)(void*a1,void*a2))Cyc_PP_append)(((struct Cyc_PP_Out*)os->hd)->ppout,s);s=_tmpD7;});
({void*_tmpD8=((void*(*)(void*a1,void*a2))Cyc_PP_append)(((struct Cyc_PP_Out*)os->hd)->links,links);links=_tmpD8;});}
# 369
...
mwo=mwo2;}}
# 387
return({struct Cyc_PP_Doc*_tmp84=_cycalloc(sizeof(*_tmp84));((((*_tmp84).mwo=mw,(*_tmp84).mw=mwo)),({struct Cyc_Fn_Function*_tmpD9=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct Cyc_List_List*,struct Cyc_PP_Ppstate*),struct Cyc_List_List*x))Cyc_Fn_make_fn)(Cyc_PP_long_cats_f,orig);(*_tmp84).f=_tmpD9;}));_tmp84;});};}
# 390
struct Cyc_PP_Doc*Cyc_PP_cats(struct Cyc_List_List*doclist){
...
struct Cyc_PP_Out*o=((struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*f,struct Cyc_PP_Ppstate*x))Cyc_Fn_apply)(d->f,st);
({struct Cyc_PP_Ppstate*_tmpDB=({struct Cyc_PP_Ppstate*_tmp85=_cycalloc(sizeof(*_tmp85));((((((((*_tmp85).ci=st->ci,(*_tmp85).cc=o->newcc)),(*_tmp85).cl=o->newcl)),(*_tmp85).pw=st->pw)),(*_tmp85).epw=st->epw - d->mwo);_tmp85;});st=_tmpDB;});
({struct Cyc_List_List*_tmpDC=({struct Cyc_List_List*_tmp86=_cycalloc(sizeof(*_tmp86));((*_tmp86).hd=o,(*_tmp86).tl=os);_tmp86;});os=_tmpDC;});}}{
# 408
int newcc=((struct Cyc_PP_Out*)((struct Cyc_List_List*)_check_null(os))->hd)->newcc;
int newcl=((struct Cyc_PP_Out*)os->hd)->newcl;
void*s=(void*)& Cyc_PP_Empty_stringptr;
void*links=(void*)& Cyc_PP_Empty_link;
for(0;os != 0;os=os->tl){
({void*_tmpDD=((void*(*)(void*a1,void*a2))Cyc_PP_append)(((struct Cyc_PP_Out*)os->hd)->ppout,s);s=_tmpDD;});
({void*_tmpDE=((void*(*)(void*a1,void*a2))Cyc_PP_append)(((struct Cyc_PP_Out*)os->hd)->links,links);links=_tmpDE;});}
# 416
...
int sz=(int)_get_dyneither_size(docs,sizeof(struct Cyc_PP_Doc*));
if(sz == 0)
(int)_throw((void*)({struct Cyc_Core_Failure_exn_struct*_tmp89=_cycalloc(sizeof(*_tmp89));((*_tmp89).tag=Cyc_Core_Failure,({struct _dyneither_ptr _tmpDF=({const char*_tmp88="cats_arr -- size zero array";_tag_dyneither(_tmp88,sizeof(char),28U);});(*_tmp89).f1=_tmpDF;}));_tmp89;}));{
...
mwo=mwo2;}}
# 432
return({struct Cyc_PP_Doc*_tmp8C=_cycalloc(sizeof(*_tmp8C));((((*_tmp8C).mwo=mw,(*_tmp8C).mw=mwo)),({struct Cyc_Fn_Function*_tmpE0=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct _dyneither_ptr*,struct Cyc_PP_Ppstate*),struct _dyneither_ptr*x))Cyc_Fn_make_fn)(Cyc_PP_cats_arr_f,({unsigned int _tmp8B=1;struct _dyneither_ptr*_tmp8A=_cycalloc(_check_times(_tmp8B,sizeof(struct _dyneither_ptr)));_tmp8A[0]=docs;_tmp8A;}));(*_tmp8C).f=_tmpE0;}));_tmp8C;});};}
# 435
...
return({struct Cyc_PP_Doc*_tmp91=_cycalloc(sizeof(*_tmp91));(((({int _tmpE3=Cyc_PP_min(d->mwo,d2->mwo);(*_tmp91).mwo=_tmpE3;}),({
int _tmpE2=Cyc_PP_min(d->mw,d2->mw);(*_tmp91).mw=_tmpE2;}))),({
struct Cyc_Fn_Function*_tmpE1=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct _tuple6*,struct Cyc_PP_Ppstate*),struct _tuple6*x))Cyc_Fn_make_fn)(Cyc_PP_doc_union_f,({struct _tuple6*_tmp90=_cycalloc(sizeof(*_tmp90));((*_tmp90).f1=d,(*_tmp90).f2=d2);_tmp90;}));(*_tmp91).f=_tmpE1;}));_tmp91;});}
# 449
struct Cyc_PP_Doc*Cyc_PP_oline_doc(){
return({struct Cyc_PP_Doc*_tmpE4=Cyc_PP_nil_doc();Cyc_PP_doc_union(_tmpE4,Cyc_PP_line_doc());});}
# 453
...
# 461
struct Cyc_Fn_Function*_tmpE5=((struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*f)(struct Cyc_PP_Doc*,struct Cyc_PP_Ppstate*),struct Cyc_PP_Doc*x))Cyc_Fn_make_fn)(Cyc_PP_tab_f,d);(*_tmp93).f=_tmpE5;}));_tmp93;});
return d2;}
# 467
...
return({struct Cyc_PP_Doc*_tmp94[4U];(((((({struct Cyc_PP_Doc*_tmpE9=pp(l->hd);_tmp94[0]=_tmpE9;}),({struct Cyc_PP_Doc*_tmpE8=Cyc_PP_text(sep);_tmp94[1]=_tmpE8;}))),({struct Cyc_PP_Doc*_tmpE7=Cyc_PP_oline_doc();_tmp94[2]=_tmpE7;}))),({struct Cyc_PP_Doc*_tmpE6=Cyc_PP_ppseq_f(pp,sep,l->tl);_tmp94[3]=_tmpE6;}));Cyc_PP_cat(_tag_dyneither(_tmp94,sizeof(struct Cyc_PP_Doc*),4U));});}}}
# 473
struct Cyc_PP_Doc*Cyc_PP_ppseq(struct Cyc_PP_Doc*(*pp)(void*),struct _dyneither_ptr sep,struct Cyc_List_List*l){
...
({struct Cyc_List_List*_tmpEB=({struct Cyc_List_List*_tmp98=_cycalloc(sizeof(*_tmp98));((*_tmp98).hd=sep2,({struct Cyc_List_List*_tmpEA=({struct Cyc_List_List*_tmp97=_cycalloc(sizeof(*_tmp97));((*_tmp97).hd=oline,(*_tmp97).tl=_tmp96);_tmp97;});(*_tmp98).tl=_tmpEA;}));_tmp98;});_tmp95->tl=_tmpEB;});
_tmp95=_tmp96;}
# 489
...
if(l == 0)return Cyc_PP_nil_doc();else{
if(l->tl == 0)return pp(l->hd);else{
return({struct Cyc_PP_Doc*_tmp99[4U];(((((({struct Cyc_PP_Doc*_tmpEF=pp(l->hd);_tmp99[0]=_tmpEF;}),({struct Cyc_PP_Doc*_tmpEE=Cyc_PP_text(sep);_tmp99[1]=_tmpEE;}))),({struct Cyc_PP_Doc*_tmpED=Cyc_PP_line_doc();_tmp99[2]=_tmpED;}))),({struct Cyc_PP_Doc*_tmpEC=Cyc_PP_ppseql_f(pp,sep,l->tl);_tmp99[3]=_tmpEC;}));Cyc_PP_cat(_tag_dyneither(_tmp99,sizeof(struct Cyc_PP_Doc*),4U));});}}}
# 507
struct Cyc_PP_Doc*Cyc_PP_ppseql(struct Cyc_PP_Doc*(*pp)(void*),struct _dyneither_ptr sep,struct Cyc_List_List*l){
...
if(l == 0)return Cyc_PP_nil_doc();else{
if(l->tl == 0)return(struct Cyc_PP_Doc*)l->hd;else{
return({struct Cyc_PP_Doc*_tmp9A[4U];(((((_tmp9A[0]=(struct Cyc_PP_Doc*)l->hd,({struct Cyc_PP_Doc*_tmpF2=Cyc_PP_text(sep);_tmp9A[1]=_tmpF2;}))),({struct Cyc_PP_Doc*_tmpF1=Cyc_PP_line_doc();_tmp9A[2]=_tmpF1;}))),({struct Cyc_PP_Doc*_tmpF0=Cyc_PP_seql_f(sep,l->tl);_tmp9A[3]=_tmpF0;}));Cyc_PP_cat(_tag_dyneither(_tmp9A,sizeof(struct Cyc_PP_Doc*),4U));});}}}
# 516
struct Cyc_PP_Doc*Cyc_PP_seql(struct _dyneither_ptr sep,struct Cyc_List_List*l0){
...
return({struct Cyc_PP_Doc*_tmp9B[3U];(((({struct Cyc_PP_Doc*_tmpF5=Cyc_PP_text(start);_tmp9B[0]=_tmpF5;}),({
struct Cyc_PP_Doc*_tmpF4=Cyc_PP_seq(sep,ss);_tmp9B[1]=_tmpF4;}))),({
struct Cyc_PP_Doc*_tmpF3=Cyc_PP_text(stop);_tmp9B[2]=_tmpF3;}));Cyc_PP_cat(_tag_dyneither(_tmp9B,sizeof(struct Cyc_PP_Doc*),3U));});}
# 528
...
return({struct Cyc_PP_Doc*_tmp9C[3U];(((({struct Cyc_PP_Doc*_tmpF8=Cyc_PP_text(start);_tmp9C[0]=_tmpF8;}),({
struct Cyc_PP_Doc*_tmpF7=Cyc_PP_seq(sep,ss);_tmp9C[1]=_tmpF7;}))),({
struct Cyc_PP_Doc*_tmpF6=Cyc_PP_text(stop);_tmp9C[2]=_tmpF6;}));Cyc_PP_cat(_tag_dyneither(_tmp9C,sizeof(struct Cyc_PP_Doc*),3U));});}}
# 535
...
return({struct Cyc_PP_Doc*_tmp9D[3U];(((({struct Cyc_PP_Doc*_tmpFB=Cyc_PP_text(start);_tmp9D[0]=_tmpFB;}),({
struct Cyc_PP_Doc*_tmpFA=Cyc_PP_seql(sep,ss);_tmp9D[1]=_tmpFA;}))),({
struct Cyc_PP_Doc*_tmpF9=Cyc_PP_text(stop);_tmp9D[2]=_tmpF9;}));Cyc_PP_cat(_tag_dyneither(_tmp9D,sizeof(struct Cyc_PP_Doc*),3U));});}
