...
struct _tuple0 _stmttmp0=({struct _tuple0 _Tmp0;_Tmp0.f1=a1,_Tmp0.f2=a2;_Tmp0;});struct _tuple0 _Tmp0=_stmttmp0;if(*((int*)_Tmp0.f1)== 0)
...
void*_Tmp0=y;void*_Tmp1;void*_Tmp2;switch(*((int*)_Tmp0)){case 0:
 return l;case 1: _Tmp2=(void*)((struct Cyc_PP_Single_PP_Alist_struct*)_Tmp0)->f1;{void*z=_Tmp2;
return({struct Cyc_List_List*_Tmp3=_cycalloc(sizeof(struct Cyc_List_List));_Tmp3->hd=z,_Tmp3->tl=l;_Tmp3;});}default: _Tmp2=(void*)((struct Cyc_PP_Append_PP_Alist_struct*)_Tmp0)->f1;_Tmp1=(void*)((struct Cyc_PP_Append_PP_Alist_struct*)_Tmp0)->f2;{void*a1=_Tmp2;void*a2=_Tmp1;
return({void*_Tmp3=a1;Cyc_PP_list_of_alist_f(_Tmp3,Cyc_PP_list_of_alist_f(a2,l));});}};}
# 69
...
struct Cyc_Xarray_Xarray*xarr=({(struct Cyc_Xarray_Xarray*(*)(int,void*))Cyc_Xarray_create;})(16,al);
({(void(*)(struct Cyc_Xarray_Xarray*,void*))Cyc_Xarray_add;})(xarr,al);{
int last=0;
while(last >= 0){
void*_stmttmp1=({(void*(*)(struct Cyc_Xarray_Xarray*,int))Cyc_Xarray_get;})(xarr,last);void*_Tmp0=_stmttmp1;void*_Tmp1;void*_Tmp2;switch(*((int*)_Tmp0)){case 0:
 -- last;goto _LL0;case 1: _Tmp2=(struct _fat_ptr*)((struct Cyc_PP_Single_PP_Alist_struct*)_Tmp0)->f1;{struct _fat_ptr*s=_Tmp2;
-- last;({struct Cyc_String_pa_PrintArg_struct _Tmp3=({struct Cyc_String_pa_PrintArg_struct _Tmp4;_Tmp4.tag=0,_Tmp4.f1=*s;_Tmp4;});void*_Tmp4[1];_Tmp4[0]=& _Tmp3;Cyc_fprintf(f,({const char*_Tmp5="%s";_tag_fat(_Tmp5,sizeof(char),3U);}),_tag_fat(_Tmp4,sizeof(void*),1));});goto _LL0;}default: _Tmp2=(void*)((struct Cyc_PP_Append_PP_Alist_struct*)_Tmp0)->f1;_Tmp1=(void*)((struct Cyc_PP_Append_PP_Alist_struct*)_Tmp0)->f2;{void*a1=_Tmp2;void*a2=_Tmp1;
# 107
({(void(*)(struct Cyc_Xarray_Xarray*,int,void*))Cyc_Xarray_set;})(xarr,last,a2);
if(({int _Tmp3=last;_Tmp3 == ({(int(*)(struct Cyc_Xarray_Xarray*))Cyc_Xarray_length;})(xarr)- 1;}))
...
struct Cyc_PP_Out*o=({struct Cyc_PP_Out*(*_Tmp0)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*)=({(struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*))Cyc_Fn_apply;});struct Cyc_Fn_Function*_Tmp1=d->f;_Tmp0(_Tmp1,({struct Cyc_PP_Ppstate*_Tmp2=_cycalloc(sizeof(struct Cyc_PP_Ppstate));_Tmp2->ci=0,_Tmp2->cc=0,_Tmp2->cl=1,_Tmp2->pw=w,_Tmp2->epw=w;_Tmp2;}));});
Cyc_PP_dump_out(f,o->ppout);}
# 126
struct _fat_ptr Cyc_PP_string_of_doc(struct Cyc_PP_Doc*d,int w){
struct Cyc_PP_Out*o=({struct Cyc_PP_Out*(*_Tmp0)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*)=({(struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*))Cyc_Fn_apply;});struct Cyc_Fn_Function*_Tmp1=d->f;_Tmp0(_Tmp1,({struct Cyc_PP_Ppstate*_Tmp2=_cycalloc(sizeof(struct Cyc_PP_Ppstate));_Tmp2->ci=0,_Tmp2->cc=0,_Tmp2->cl=1,_Tmp2->pw=w,_Tmp2->epw=w;_Tmp2;}));});
return({struct Cyc_List_List*_Tmp0=({(struct Cyc_List_List*(*)(void*))Cyc_PP_list_of_alist;})(o->ppout);Cyc_str_sepstr(_Tmp0,({const char*_Tmp1="";_tag_fat(_Tmp1,sizeof(char),1U);}));});}struct _tuple1{struct _fat_ptr f1;struct Cyc_List_List*f2;};
# 133
struct _tuple1*Cyc_PP_string_and_links(struct Cyc_PP_Doc*d,int w){
struct Cyc_PP_Out*o=({struct Cyc_PP_Out*(*_Tmp0)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*)=({(struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*))Cyc_Fn_apply;});struct Cyc_Fn_Function*_Tmp1=d->f;_Tmp0(_Tmp1,({struct Cyc_PP_Ppstate*_Tmp2=_cycalloc(sizeof(struct Cyc_PP_Ppstate));_Tmp2->ci=0,_Tmp2->cc=0,_Tmp2->cl=1,_Tmp2->pw=w,_Tmp2->epw=w;_Tmp2;}));});
return({struct _tuple1*_Tmp0=_cycalloc(sizeof(struct _tuple1));({struct _fat_ptr _Tmp1=({
struct Cyc_List_List*_Tmp2=({(struct Cyc_List_List*(*)(void*))Cyc_PP_list_of_alist;})(o->ppout);Cyc_str_sepstr(_Tmp2,({const char*_Tmp3="";_tag_fat(_Tmp3,sizeof(char),1U);}));});
# 135
_Tmp0->f1=_Tmp1;}),({
# 137
struct Cyc_List_List*_Tmp1=({(struct Cyc_List_List*(*)(void*))Cyc_PP_list_of_alist;})(o->links);_Tmp0->f2=_Tmp1;});_Tmp0;});}
# 140
...
if(i < 0)(int)_throw((void*)({struct Cyc_Core_Failure_exn_struct*_Tmp0=_cycalloc(sizeof(struct Cyc_Core_Failure_exn_struct));_Tmp0->tag=Cyc_Core_Failure,_Tmp0->f1=({const char*_Tmp1="nlblanks";_tag_fat(_Tmp1,sizeof(char),9U);});_Tmp0;}));{
...
({struct _fat_ptr _Tmp5=_fat_ptr_plus(nlb,sizeof(char),0);char _Tmp6=*((char*)_check_fat_subscript(_Tmp5,sizeof(char),0U));char _Tmp7='\n';if(_get_fat_size(_Tmp5,sizeof(char))== 1U &&(_Tmp6 == 0 && _Tmp7 != 0))_throw_arraybounds();*((char*)_Tmp5.curr)=_Tmp7;});
{int j=0;for(0;j < num_tabs;++ j){
({struct _fat_ptr _Tmp5=_fat_ptr_plus(nlb,sizeof(char),j + 1);char _Tmp6=*((char*)_check_fat_subscript(_Tmp5,sizeof(char),0U));char _Tmp7='\t';if(_get_fat_size(_Tmp5,sizeof(char))== 1U &&(_Tmp6 == 0 && _Tmp7 != 0))_throw_arraybounds();*((char*)_Tmp5.curr)=_Tmp7;});}}
{int j=0;for(0;j < num_spaces;++ j){
({struct _fat_ptr _Tmp5=_fat_ptr_plus(nlb,sizeof(char),(j + 1)+ num_tabs);char _Tmp6=*((char*)_check_fat_subscript(_Tmp5,sizeof(char),0U));char _Tmp7=' ';if(_get_fat_size(_Tmp5,sizeof(char))== 1U &&(_Tmp6 == 0 && _Tmp7 != 0))_throw_arraybounds();*((char*)_Tmp5.curr)=_Tmp7;});}}
({void(*_Tmp5)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*)=({(void(*)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*))Cyc_Hashtable_insert;});struct Cyc_Hashtable_Table*_Tmp6=(struct Cyc_Hashtable_Table*)(_check_null(Cyc_PP_bhashtbl))->v;int _Tmp7=i;_Tmp5(_Tmp6,_Tmp7,({unsigned _Tmp8=1;({struct _fat_ptr*_Tmp9=_cycalloc(_check_times(_Tmp8,sizeof(struct _fat_ptr)));_Tmp9[0]=nlb;_Tmp9;});}));});
return nlb;}else{
# 168
int total=3 + i;
struct _fat_ptr nlb=Cyc_Core_new_string((unsigned)(total + 1));
({struct _fat_ptr _Tmp5=_fat_ptr_plus(nlb,sizeof(char),0);char _Tmp6=*((char*)_check_fat_subscript(_Tmp5,sizeof(char),0U));char _Tmp7='\\';if(_get_fat_size(_Tmp5,sizeof(char))== 1U &&(_Tmp6 == 0 && _Tmp7 != 0))_throw_arraybounds();*((char*)_Tmp5.curr)=_Tmp7;});
({struct _fat_ptr _Tmp5=_fat_ptr_plus(nlb,sizeof(char),1);char _Tmp6=*((char*)_check_fat_subscript(_Tmp5,sizeof(char),0U));char _Tmp7='\\';if(_get_fat_size(_Tmp5,sizeof(char))== 1U &&(_Tmp6 == 0 && _Tmp7 != 0))_throw_arraybounds();*((char*)_Tmp5.curr)=_Tmp7;});
({struct _fat_ptr _Tmp5=_fat_ptr_plus(nlb,sizeof(char),2);char _Tmp6=*((char*)_check_fat_subscript(_Tmp5,sizeof(char),0U));char _Tmp7='\n';if(_get_fat_size(_Tmp5,sizeof(char))== 1U &&(_Tmp6 == 0 && _Tmp7 != 0))_throw_arraybounds();*((char*)_Tmp5.curr)=_Tmp7;});
{int j=3;for(0;j < total;++ j){
({struct _fat_ptr _Tmp5=_fat_ptr_plus(nlb,sizeof(char),j);char _Tmp6=*((char*)_check_fat_subscript(_Tmp5,sizeof(char),0U));char _Tmp7='~';if(_get_fat_size(_Tmp5,sizeof(char))== 1U &&(_Tmp6 == 0 && _Tmp7 != 0))_throw_arraybounds();*((char*)_Tmp5.curr)=_Tmp7;});}}
({void(*_Tmp5)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*)=({(void(*)(struct Cyc_Hashtable_Table*,int,struct _fat_ptr*))Cyc_Hashtable_insert;});struct Cyc_Hashtable_Table*_Tmp6=(struct Cyc_Hashtable_Table*)(_check_null(Cyc_PP_bhashtbl))->v;int _Tmp7=i;_Tmp5(_Tmp6,_Tmp7,({unsigned _Tmp8=1;({struct _fat_ptr*_Tmp9=_cycalloc(_check_times(_Tmp8,sizeof(struct _fat_ptr)));_Tmp9[0]=nlb;_Tmp9;});}));});
return nlb;}}else{_Tmp4=_Tmp3;{void*exn=_Tmp4;(int)_rethrow(exn);}};}}}}
# 182
...
struct _tuple2*_Tmp0=clo;struct _fat_ptr _Tmp1;int _Tmp2;_Tmp2=_Tmp0->f1;_Tmp1=_Tmp0->f2;{int slen=_Tmp2;struct _fat_ptr s=_Tmp1;
return({struct Cyc_PP_Out*_Tmp3=_cycalloc(sizeof(struct Cyc_PP_Out));_Tmp3->newcc=st->cc + slen,_Tmp3->newcl=st->cl,({
# 190
void*_Tmp4=(void*)({struct Cyc_PP_Single_PP_Alist_struct*_Tmp5=_cycalloc(sizeof(struct Cyc_PP_Single_PP_Alist_struct));_Tmp5->tag=1,({struct _fat_ptr*_Tmp6=({unsigned _Tmp7=1;({struct _fat_ptr*_Tmp8=_cycalloc(_check_times(_Tmp7,sizeof(struct _fat_ptr)));_Tmp8[0]=s;_Tmp8;});});_Tmp5->f1=_Tmp6;});_Tmp5;});_Tmp3->ppout=_Tmp4;}),_Tmp3->links=(void*)& Cyc_PP_Empty_link;_Tmp3;});}}
# 193
...
# 198
struct Cyc_Fn_Function*_Tmp1=({struct Cyc_Fn_Function*(*_Tmp2)(struct Cyc_PP_Out*(*)(struct _tuple2*,struct Cyc_PP_Ppstate*),struct _tuple2*)=({(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct _tuple2*,struct Cyc_PP_Ppstate*),struct _tuple2*))Cyc_Fn_make_fn;});_Tmp2(Cyc_PP_text_doc_f,({struct _tuple2*_Tmp3=_cycalloc(sizeof(struct _tuple2));
# 200
_Tmp3->f1=slen,_Tmp3->f2=s;_Tmp3;}));});
# 198
_Tmp0->f=_Tmp1;});_Tmp0;});}
# 202
...
# 210
struct _handler_cons _Tmp0;_push_handler(& _Tmp0);{int _Tmp1=0;if(setjmp(_Tmp0.handler))_Tmp1=1;if(!_Tmp1){
{struct Cyc_PP_Doc*_Tmp2=({struct Cyc_PP_Doc*(*_Tmp3)(struct Cyc_Hashtable_Table*,struct _fat_ptr*)=({(struct Cyc_PP_Doc*(*)(struct Cyc_Hashtable_Table*,struct _fat_ptr*))Cyc_Hashtable_lookup;});struct Cyc_Hashtable_Table*_Tmp4=t;_Tmp3(_Tmp4,({struct _fat_ptr*_Tmp5=_cycalloc(sizeof(struct _fat_ptr));*_Tmp5=s;_Tmp5;}));});_npop_handler(0);return _Tmp2;};_pop_handler();}else{void*_Tmp2=(void*)Cyc_Core_get_exn_thrown();void*_Tmp3=_Tmp2;void*_Tmp4;if(((struct Cyc_Core_Not_found_exn_struct*)_Tmp3)->tag == Cyc_Core_Not_found){
# 214
struct Cyc_PP_Doc*d=Cyc_PP_text_doc(s);
({void(*_Tmp5)(struct Cyc_Hashtable_Table*,struct _fat_ptr*,struct Cyc_PP_Doc*)=({(void(*)(struct Cyc_Hashtable_Table*,struct _fat_ptr*,struct Cyc_PP_Doc*))Cyc_Hashtable_insert;});struct Cyc_Hashtable_Table*_Tmp6=t;struct _fat_ptr*_Tmp7=({struct _fat_ptr*_Tmp8=_cycalloc(sizeof(struct _fat_ptr));*_Tmp8=s;_Tmp8;});_Tmp5(_Tmp6,_Tmp7,d);});
return d;}else{_Tmp4=_Tmp3;{void*exn=_Tmp4;(int)_rethrow(exn);}};}}}}
# 219
...
Cyc_PP_nil_doc_opt=({struct Cyc_Core_Opt*_Tmp0=_cycalloc(sizeof(struct Cyc_Core_Opt));({struct Cyc_PP_Doc*_Tmp1=Cyc_PP_text(({const char*_Tmp2="";_tag_fat(_Tmp2,sizeof(char),1U);}));_Tmp0->v=_Tmp1;});_Tmp0;});
...
Cyc_PP_blank_doc_opt=({struct Cyc_Core_Opt*_Tmp0=_cycalloc(sizeof(struct Cyc_Core_Opt));({struct Cyc_PP_Doc*_Tmp1=Cyc_PP_text(({const char*_Tmp2="";_tag_fat(_Tmp2,sizeof(char),1U);}));_Tmp0->v=_Tmp1;});_Tmp0;});
return(struct Cyc_PP_Doc*)(_check_null(Cyc_PP_blank_doc_opt))->v;}struct _tuple3{int f1;struct _fat_ptr f2;struct _fat_ptr f3;};struct _tuple4{int f1;int f2;int f3;struct _fat_ptr f4;};
# 270
static struct Cyc_PP_Out*Cyc_PP_hyperlink_f(struct _tuple3*clo,struct Cyc_PP_Ppstate*st){
struct _tuple3*_Tmp0=clo;struct _fat_ptr _Tmp1;struct _fat_ptr _Tmp2;int _Tmp3;_Tmp3=_Tmp0->f1;_Tmp2=_Tmp0->f2;_Tmp1=_Tmp0->f3;{int slen=_Tmp3;struct _fat_ptr shrt=_Tmp2;struct _fat_ptr full=_Tmp1;
return({struct Cyc_PP_Out*_Tmp4=_cycalloc(sizeof(struct Cyc_PP_Out));_Tmp4->newcc=st->cc + slen,_Tmp4->newcl=st->cl,({
# 274
void*_Tmp5=(void*)({struct Cyc_PP_Single_PP_Alist_struct*_Tmp6=_cycalloc(sizeof(struct Cyc_PP_Single_PP_Alist_struct));_Tmp6->tag=1,({struct _fat_ptr*_Tmp7=({unsigned _Tmp8=1;({struct _fat_ptr*_Tmp9=_cycalloc(_check_times(_Tmp8,sizeof(struct _fat_ptr)));_Tmp9[0]=shrt;_Tmp9;});});_Tmp6->f1=_Tmp7;});_Tmp6;});_Tmp4->ppout=_Tmp5;}),({
void*_Tmp5=(void*)({struct Cyc_PP_Single_PP_Alist_struct*_Tmp6=_cycalloc(sizeof(struct Cyc_PP_Single_PP_Alist_struct));_Tmp6->tag=1,({struct _tuple4*_Tmp7=({struct _tuple4*_Tmp8=_cycalloc(sizeof(struct _tuple4));_Tmp8->f1=st->cl,_Tmp8->f2=st->cc,_Tmp8->f3=slen,_Tmp8->f4=full;_Tmp8;});_Tmp6->f1=_Tmp7;});_Tmp6;});_Tmp4->links=_Tmp5;});_Tmp4;});}}
# 277
...
# 281
struct Cyc_Fn_Function*_Tmp1=({struct Cyc_Fn_Function*(*_Tmp2)(struct Cyc_PP_Out*(*)(struct _tuple3*,struct Cyc_PP_Ppstate*),struct _tuple3*)=({(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct _tuple3*,struct Cyc_PP_Ppstate*),struct _tuple3*))Cyc_Fn_make_fn;});_Tmp2(Cyc_PP_hyperlink_f,({struct _tuple3*_Tmp3=_cycalloc(sizeof(struct _tuple3));_Tmp3->f1=slen,_Tmp3->f2=shrt,_Tmp3->f3=full;_Tmp3;}));});_Tmp0->f=_Tmp1;});_Tmp0;});}
# 285
...
return(struct Cyc_PP_Doc*)(_check_null(Cyc_PP_line_doc_opt))->v;}struct _tuple5{int f1;struct Cyc_PP_Doc*f2;};
# 297
static struct Cyc_PP_Out*Cyc_PP_nest_f(struct _tuple5*clo,struct Cyc_PP_Ppstate*st){
struct _tuple5*_Tmp0=clo;void*_Tmp1;int _Tmp2;_Tmp2=_Tmp0->f1;_Tmp1=_Tmp0->f2;{int k=_Tmp2;struct Cyc_PP_Doc*d=_Tmp1;
struct Cyc_PP_Ppstate*st2=({struct Cyc_PP_Ppstate*_Tmp3=_cycalloc(sizeof(struct Cyc_PP_Ppstate));
_Tmp3->ci=st->ci + k,_Tmp3->cc=st->cc,_Tmp3->cl=st->cl,_Tmp3->pw=st->pw,_Tmp3->epw=st->epw;_Tmp3;});
# 305
...
# 310
struct Cyc_Fn_Function*_Tmp1=({struct Cyc_Fn_Function*(*_Tmp2)(struct Cyc_PP_Out*(*)(struct _tuple5*,struct Cyc_PP_Ppstate*),struct _tuple5*)=({(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct _tuple5*,struct Cyc_PP_Ppstate*),struct _tuple5*))Cyc_Fn_make_fn;});_Tmp2(Cyc_PP_nest_f,({struct _tuple5*_Tmp3=_cycalloc(sizeof(struct _tuple5));
# 312
_Tmp3->f1=k,_Tmp3->f2=d;_Tmp3;}));});
# 310
_Tmp0->f=_Tmp1;});_Tmp0;});}
# 315
...
struct _tuple6*_Tmp0=clo;void*_Tmp1;void*_Tmp2;_Tmp2=_Tmp0->f1;_Tmp1=_Tmp0->f2;{struct Cyc_PP_Doc*d1=_Tmp2;struct Cyc_PP_Doc*d2=_Tmp1;
int epw2=Cyc_PP_max(st->pw - d2->mw,st->epw - d1->mwo);
struct Cyc_PP_Ppstate*st2=({struct Cyc_PP_Ppstate*_Tmp3=_cycalloc(sizeof(struct Cyc_PP_Ppstate));_Tmp3->ci=st->ci,_Tmp3->cc=st->cc,_Tmp3->cl=st->cl,_Tmp3->pw=st->pw,_Tmp3->epw=epw2;_Tmp3;});
struct Cyc_PP_Out*o1=({(struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*))Cyc_Fn_apply;})(d1->f,st2);
struct Cyc_PP_Ppstate*st3=({struct Cyc_PP_Ppstate*_Tmp3=_cycalloc(sizeof(struct Cyc_PP_Ppstate));_Tmp3->ci=st->ci,_Tmp3->cc=o1->newcc,_Tmp3->cl=o1->newcl,_Tmp3->pw=st->pw,_Tmp3->epw=epw2;_Tmp3;});
struct Cyc_PP_Out*o2=({(struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*))Cyc_Fn_apply;})(d2->f,st3);
struct Cyc_PP_Out*o3=({struct Cyc_PP_Out*_Tmp3=_cycalloc(sizeof(struct Cyc_PP_Out));_Tmp3->newcc=o2->newcc,_Tmp3->newcl=o2->newcl,({
# 334
void*_Tmp4=({(void*(*)(void*,void*))Cyc_PP_append;})(o1->ppout,o2->ppout);_Tmp3->ppout=_Tmp4;}),({
void*_Tmp4=({(void*(*)(void*,void*))Cyc_PP_append;})(o1->links,o2->links);_Tmp3->links=_Tmp4;});_Tmp3;});
return o3;}}
# 338
...
struct Cyc_Fn_Function*_Tmp1=({struct Cyc_Fn_Function*(*_Tmp2)(struct Cyc_PP_Out*(*)(struct _tuple6*,struct Cyc_PP_Ppstate*),struct _tuple6*)=({(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct _tuple6*,struct Cyc_PP_Ppstate*),struct _tuple6*))Cyc_Fn_make_fn;});_Tmp2(Cyc_PP_concat_f,({struct _tuple6*_Tmp3=_cycalloc(sizeof(struct _tuple6));_Tmp3->f1=d1,_Tmp3->f2=d2;_Tmp3;}));});_Tmp0->f=_Tmp1;});_Tmp0;});}
# 343
...
int sz=(int)_get_fat_size(docs,sizeof(struct Cyc_PP_Doc*));
if(sz == 0)
(int)_throw((void*)({struct Cyc_Core_Failure_exn_struct*_Tmp0=_cycalloc(sizeof(struct Cyc_Core_Failure_exn_struct));_Tmp0->tag=Cyc_Core_Failure,_Tmp0->f1=({const char*_Tmp1="cats_arr -- size zero array";_tag_fat(_Tmp1,sizeof(char),28U);});_Tmp0;}));{
...
mwo=mwo2;}}
# 432
return({struct Cyc_PP_Doc*_Tmp0=_cycalloc(sizeof(struct Cyc_PP_Doc));_Tmp0->mwo=mw,_Tmp0->mw=mwo,({struct Cyc_Fn_Function*_Tmp1=({struct Cyc_Fn_Function*(*_Tmp2)(struct Cyc_PP_Out*(*)(struct _fat_ptr*,struct Cyc_PP_Ppstate*),struct _fat_ptr*)=({(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct _fat_ptr*,struct Cyc_PP_Ppstate*),struct _fat_ptr*))Cyc_Fn_make_fn;});_Tmp2(Cyc_PP_cats_arr_f,({unsigned _Tmp3=1;({struct _fat_ptr*_Tmp4=_cycalloc(_check_times(_Tmp3,sizeof(struct _fat_ptr)));_Tmp4[0]=docs;_Tmp4;});}));});_Tmp0->f=_Tmp1;});_Tmp0;});}}
# 435
static struct Cyc_PP_Out*Cyc_PP_doc_union_f(struct _tuple6*clo,struct Cyc_PP_Ppstate*st){
struct _tuple6*_Tmp0=clo;void*_Tmp1;void*_Tmp2;_Tmp2=_Tmp0->f1;_Tmp1=_Tmp0->f2;{struct Cyc_PP_Doc*d=_Tmp2;struct Cyc_PP_Doc*d2=_Tmp1;
...
struct Cyc_Fn_Function*_Tmp1=({struct Cyc_Fn_Function*(*_Tmp2)(struct Cyc_PP_Out*(*)(struct _tuple6*,struct Cyc_PP_Ppstate*),struct _tuple6*)=({(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct _tuple6*,struct Cyc_PP_Ppstate*),struct _tuple6*))Cyc_Fn_make_fn;});_Tmp2(Cyc_PP_doc_union_f,({struct _tuple6*_Tmp3=_cycalloc(sizeof(struct _tuple6));_Tmp3->f1=d,_Tmp3->f2=d2;_Tmp3;}));});_Tmp0->f=_Tmp1;});_Tmp0;});}
# 449
struct Cyc_PP_Doc*Cyc_PP_oline_doc (void){
...
struct Cyc_PP_Ppstate*st2=({struct Cyc_PP_Ppstate*_Tmp0=_cycalloc(sizeof(struct Cyc_PP_Ppstate));_Tmp0->ci=st->cc,_Tmp0->cc=st->cc,_Tmp0->cl=st->cl,_Tmp0->pw=st->pw,_Tmp0->epw=st->epw;_Tmp0;});
return({(struct Cyc_PP_Out*(*)(struct Cyc_Fn_Function*,struct Cyc_PP_Ppstate*))Cyc_Fn_apply;})(d->f,st2);}
# 457
struct Cyc_PP_Doc*Cyc_PP_tab(struct Cyc_PP_Doc*d){
struct Cyc_PP_Doc*d2=({struct Cyc_PP_Doc*_Tmp0=_cycalloc(sizeof(struct Cyc_PP_Doc));
_Tmp0->mwo=d->mwo,_Tmp0->mw=d->mw,({
# 461
struct Cyc_Fn_Function*_Tmp1=({(struct Cyc_Fn_Function*(*)(struct Cyc_PP_Out*(*)(struct Cyc_PP_Doc*,struct Cyc_PP_Ppstate*),struct Cyc_PP_Doc*))Cyc_Fn_make_fn;})(Cyc_PP_tab_f,d);_Tmp0->f=_Tmp1;});_Tmp0;});
return d2;}
# 467
