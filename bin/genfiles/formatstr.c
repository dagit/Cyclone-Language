...
void Cyc_Tcutil_check_no_qual(struct Cyc_Position_Segment*loc,void*t);struct Cyc_List_List*
Cyc_Formatstr_get_format_typs(struct _RegionHandle*,struct Cyc_Tcenv_Tenv*,struct
_dyneither_ptr,struct Cyc_Position_Segment*);struct Cyc_List_List*Cyc_Formatstr_get_scanf_typs(
...
struct Cyc_Core_Opt*)& Cyc_Tcutil_rko,((_tmp17C=_region_malloc(Cyc_Core_unique_region,
sizeof(*_tmp17C)),((_tmp17C->v=Cyc_Tcenv_lookup_type_vars(te),_tmp17C))))),Cyc_Absyn_const_tqual(
0),Cyc_Absyn_false_conref);{struct Cyc_List_List*_tmp17D;_tmp13=((_tmp17D=
...
0;}{struct _tuple10*_tmp1A6;struct Cyc_Core_Opt*_tmp1A5;return(_tmp1A5=
