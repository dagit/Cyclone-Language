...
if(_tmp18 == 0){
({void*_tmp19=0U;({unsigned int _tmp122=loc;struct _dyneither_ptr _tmp121=({const char*_tmp1A="bad format string";_tag_dyneither(_tmp1A,sizeof(char),18U);});Cyc_Tcutil_terr(_tmp122,_tmp121,_tag_dyneither(_tmp19,sizeof(void*),0U));});});{
...
# 185
({struct Cyc_Int_pa_PrintArg_struct _tmp21=({struct Cyc_Int_pa_PrintArg_struct _tmp101;_tmp101.tag=1U,_tmp101.f1=(unsigned long)_tmp23;_tmp101;});void*_tmp1F[1U];_tmp1F[0]=& _tmp21;({unsigned int _tmp124=loc;struct _dyneither_ptr _tmp123=({const char*_tmp20="length modifier '%c' is not supported";_tag_dyneither(_tmp20,sizeof(char),38U);});Cyc_Tcutil_terr(_tmp124,_tmp123,_tag_dyneither(_tmp1F,sizeof(void*),1U));});});{
...
if((int)f->hd == '#'){
({struct Cyc_Int_pa_PrintArg_struct _tmp2E=({struct Cyc_Int_pa_PrintArg_struct _tmp102;_tmp102.tag=1U,_tmp102.f1=(unsigned long)((int)_tmp90);_tmp102;});void*_tmp2C[1U];_tmp2C[0]=& _tmp2E;({unsigned int _tmp126=loc;struct _dyneither_ptr _tmp125=({const char*_tmp2D="flag '#' is not valid with %%%c";_tag_dyneither(_tmp2D,sizeof(char),32U);});Cyc_Tcutil_terr(_tmp126,_tmp125,_tag_dyneither(_tmp2C,sizeof(void*),1U));});});{
...
struct _dyneither_ptr _tmp127=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp91));_tmp104.f1=_tmp127;});_tmp104;});struct Cyc_Int_pa_PrintArg_struct _tmp34=({struct Cyc_Int_pa_PrintArg_struct _tmp103;_tmp103.tag=1U,_tmp103.f1=(unsigned long)((int)_tmp90);_tmp103;});void*_tmp31[2U];_tmp31[0]=& _tmp33,_tmp31[1]=& _tmp34;({unsigned int _tmp129=loc;struct _dyneither_ptr _tmp128=({const char*_tmp32="length modifier '%s' is not allowed with %%%c";_tag_dyneither(_tmp32,sizeof(char),46U);});Cyc_Tcutil_terr(_tmp129,_tmp128,_tag_dyneither(_tmp31,sizeof(void*),2U));});});{
...
{struct Cyc_List_List*f=_tmp94;for(0;f != 0;f=f->tl){
if((int)f->hd == '#'){
({void*_tmp3B=0U;({unsigned int _tmp12B=loc;struct _dyneither_ptr _tmp12A=({const char*_tmp3C="Flag '#' not valid with %%u";_tag_dyneither(_tmp3C,sizeof(char),28U);});Cyc_Tcutil_terr(_tmp12B,_tmp12A,_tag_dyneither(_tmp3B,sizeof(void*),0U));});});{
...
struct _dyneither_ptr _tmp12C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp91));_tmp106.f1=_tmp12C;});_tmp106;});struct Cyc_Int_pa_PrintArg_struct _tmp42=({struct Cyc_Int_pa_PrintArg_struct _tmp105;_tmp105.tag=1U,_tmp105.f1=(unsigned long)((int)_tmp90);_tmp105;});void*_tmp3F[2U];_tmp3F[0]=& _tmp41,_tmp3F[1]=& _tmp42;({unsigned int _tmp12E=loc;struct _dyneither_ptr _tmp12D=({const char*_tmp40="length modifier '%s' is not allowed with %%%c";_tag_dyneither(_tmp40,sizeof(char),46U);});Cyc_Tcutil_terr(_tmp12E,_tmp12D,_tag_dyneither(_tmp3F,sizeof(void*),2U));});});{
...
({struct Cyc_Int_pa_PrintArg_struct _tmp54=({struct Cyc_Int_pa_PrintArg_struct _tmp109;_tmp109.tag=1U,_tmp109.f1=(unsigned long)((int)f->hd);_tmp109;});void*_tmp52[1U];_tmp52[0]=& _tmp54;({unsigned int _tmp133=loc;struct _dyneither_ptr _tmp132=({const char*_tmp53="flag '%c' not allowed with %%c";_tag_dyneither(_tmp53,sizeof(char),31U);});Cyc_Tcutil_terr(_tmp133,_tmp132,_tag_dyneither(_tmp52,sizeof(void*),1U));});});{
...
struct _dyneither_ptr _tmp134=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp91));_tmp10A.f1=_tmp134;});_tmp10A;});void*_tmp56[1U];_tmp56[0]=& _tmp58;({unsigned int _tmp136=loc;struct _dyneither_ptr _tmp135=({const char*_tmp57="length modifier '%s' not allowed with %%c";_tag_dyneither(_tmp57,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp136,_tmp135,_tag_dyneither(_tmp56,sizeof(void*),1U));});});{
...
struct _dyneither_ptr _tmp137=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp92));_tmp10B.f1=_tmp137;});_tmp10B;});void*_tmp5A[1U];_tmp5A[0]=& _tmp5C;({unsigned int _tmp139=loc;struct _dyneither_ptr _tmp138=({const char*_tmp5B="precision '%s' not allowed with %%c";_tag_dyneither(_tmp5B,sizeof(char),36U);});Cyc_Tcutil_terr(_tmp139,_tmp138,_tag_dyneither(_tmp5A,sizeof(void*),1U));});});{
...
{struct Cyc_List_List*f=_tmp94;for(0;f != 0;f=f->tl){
if((int)f->hd != '-'){
({void*_tmp5F=0U;({unsigned int _tmp13B=loc;struct _dyneither_ptr _tmp13A=({const char*_tmp60="a flag not allowed with %%s";_tag_dyneither(_tmp60,sizeof(char),28U);});Cyc_Tcutil_terr(_tmp13B,_tmp13A,_tag_dyneither(_tmp5F,sizeof(void*),0U));});});{
struct Cyc_List_List*_tmp61=0;_npop_handler(0U);return _tmp61;};}}}
# 299
if(_tmp91 != 0){
({void*_tmp62=0U;({unsigned int _tmp13D=loc;struct _dyneither_ptr _tmp13C=({const char*_tmp63="length modifiers not allowed with %%s";_tag_dyneither(_tmp63,sizeof(char),38U);});Cyc_Tcutil_terr(_tmp13D,_tmp13C,_tag_dyneither(_tmp62,sizeof(void*),0U));});});{
...
{struct Cyc_List_List*f=_tmp94;for(0;f != 0;f=f->tl){
if((int)f->hd == '#'  || (int)f->hd == '0'){
({struct Cyc_Int_pa_PrintArg_struct _tmp6B=({struct Cyc_Int_pa_PrintArg_struct _tmp10C;_tmp10C.tag=1U,_tmp10C.f1=(unsigned long)((int)f->hd);_tmp10C;});void*_tmp69[1U];_tmp69[0]=& _tmp6B;({unsigned int _tmp147=loc;struct _dyneither_ptr _tmp146=({const char*_tmp6A="flag '%c' not allowed with %%n";_tag_dyneither(_tmp6A,sizeof(char),31U);});Cyc_Tcutil_terr(_tmp147,_tmp146,_tag_dyneither(_tmp69,sizeof(void*),1U));});});{
...
struct _dyneither_ptr _tmp148=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp92));_tmp10D.f1=_tmp148;});_tmp10D;});void*_tmp6D[1U];_tmp6D[0]=& _tmp6F;({unsigned int _tmp14A=loc;struct _dyneither_ptr _tmp149=({const char*_tmp6E="precision '%s' not allowed with %%n";_tag_dyneither(_tmp6E,sizeof(char),36U);});Cyc_Tcutil_terr(_tmp14A,_tmp149,_tag_dyneither(_tmp6D,sizeof(void*),1U));});});{
...
struct _dyneither_ptr _tmp14C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp91));_tmp10F.f1=_tmp14C;});_tmp10F;});struct Cyc_Int_pa_PrintArg_struct _tmp76=({struct Cyc_Int_pa_PrintArg_struct _tmp10E;_tmp10E.tag=1U,_tmp10E.f1=(unsigned long)((int)_tmp90);_tmp10E;});void*_tmp73[2U];_tmp73[0]=& _tmp75,_tmp73[1]=& _tmp76;({unsigned int _tmp14E=loc;struct _dyneither_ptr _tmp14D=({const char*_tmp74="length modifier '%s' is not allowed with %%%c";_tag_dyneither(_tmp74,sizeof(char),46U);});Cyc_Tcutil_terr(_tmp14E,_tmp14D,_tag_dyneither(_tmp73,sizeof(void*),2U));});});{
...
# 350
 if(_tmp94 != 0){
({struct Cyc_String_pa_PrintArg_struct _tmp80=({struct Cyc_String_pa_PrintArg_struct _tmp110;_tmp110.tag=0U,({struct _dyneither_ptr _tmp152=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp94));_tmp110.f1=_tmp152;});_tmp110;});void*_tmp7E[1U];_tmp7E[0]=& _tmp80;({unsigned int _tmp154=loc;struct _dyneither_ptr _tmp153=({const char*_tmp7F="flags '%s' not allowed with %%%%";_tag_dyneither(_tmp7F,sizeof(char),33U);});Cyc_Tcutil_terr(_tmp154,_tmp153,_tag_dyneither(_tmp7E,sizeof(void*),1U));});});{
struct Cyc_List_List*_tmp81=0;_npop_handler(0U);return _tmp81;};}
# 354
if(_tmp93 != 0){
({struct Cyc_String_pa_PrintArg_struct _tmp84=({struct Cyc_String_pa_PrintArg_struct _tmp111;_tmp111.tag=0U,({struct _dyneither_ptr _tmp155=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp93));_tmp111.f1=_tmp155;});_tmp111;});void*_tmp82[1U];_tmp82[0]=& _tmp84;({unsigned int _tmp157=loc;struct _dyneither_ptr _tmp156=({const char*_tmp83="width '%s' not allowed with %%%%";_tag_dyneither(_tmp83,sizeof(char),33U);});Cyc_Tcutil_terr(_tmp157,_tmp156,_tag_dyneither(_tmp82,sizeof(void*),1U));});});{
struct Cyc_List_List*_tmp85=0;_npop_handler(0U);return _tmp85;};}
# 358
if(_tmp92 != 0){
({struct Cyc_String_pa_PrintArg_struct _tmp88=({struct Cyc_String_pa_PrintArg_struct _tmp112;_tmp112.tag=0U,({struct _dyneither_ptr _tmp158=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp92));_tmp112.f1=_tmp158;});_tmp112;});void*_tmp86[1U];_tmp86[0]=& _tmp88;({unsigned int _tmp15A=loc;struct _dyneither_ptr _tmp159=({const char*_tmp87="precision '%s' not allowed with %%%%";_tag_dyneither(_tmp87,sizeof(char),37U);});Cyc_Tcutil_terr(_tmp15A,_tmp159,_tag_dyneither(_tmp86,sizeof(void*),1U));});});{
struct Cyc_List_List*_tmp89=0;_npop_handler(0U);return _tmp89;};}
# 362
if(_tmp91 != 0){
({struct Cyc_String_pa_PrintArg_struct _tmp8C=({struct Cyc_String_pa_PrintArg_struct _tmp113;_tmp113.tag=0U,({struct _dyneither_ptr _tmp15B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmp91));_tmp113.f1=_tmp15B;});_tmp113;});void*_tmp8A[1U];_tmp8A[0]=& _tmp8C;({unsigned int _tmp15D=loc;struct _dyneither_ptr _tmp15C=({const char*_tmp8B="length modifier '%s' not allowed with %%%%";_tag_dyneither(_tmp8B,sizeof(char),43U);});Cyc_Tcutil_terr(_tmp15D,_tmp15C,_tag_dyneither(_tmp8A,sizeof(void*),1U));});});{
...
if(i >= _tmp96)return 0;
_tmp98=*((const char*)_check_dyneither_subscript(s,sizeof(char),i));
if(_tmp98 == 'h'){_tmp9B=({struct Cyc_List_List*_tmp9E=_region_malloc(r,sizeof(*_tmp9E));_tmp9E->hd=(void*)((int)_tmp98),_tmp9E->tl=_tmp9B;_tmp9E;});++ i;}
...
if(i >= _tmp96)return 0;
_tmp98=*((const char*)_check_dyneither_subscript(s,sizeof(char),i));
if(_tmp98 == 'l'){_tmp9B=({struct Cyc_List_List*_tmpA0=_region_malloc(r,sizeof(*_tmpA0));_tmpA0->hd=(void*)((int)_tmp98),_tmpA0->tl=_tmp9B;_tmpA0;});++ i;}
...
if(_tmpA8 == 0){
({void*_tmpA9=0U;({unsigned int _tmp160=loc;struct _dyneither_ptr _tmp15F=({const char*_tmpAA="bad format string";_tag_dyneither(_tmpAA,sizeof(char),18U);});Cyc_Tcutil_terr(_tmp160,_tmp15F,_tag_dyneither(_tmpA9,sizeof(void*),0U));});});{
...
# 480
({struct Cyc_Int_pa_PrintArg_struct _tmpB1=({struct Cyc_Int_pa_PrintArg_struct _tmp114;_tmp114.tag=1U,_tmp114.f1=(unsigned long)_tmpB3;_tmp114;});void*_tmpAF[1U];_tmpAF[0]=& _tmpB1;({unsigned int _tmp162=loc;struct _dyneither_ptr _tmp161=({const char*_tmpB0="length modifier '%c' is not supported";_tag_dyneither(_tmpB0,sizeof(char),38U);});Cyc_Tcutil_terr(_tmp162,_tmp161,_tag_dyneither(_tmpAF,sizeof(void*),1U));});});{
...
struct _dyneither_ptr _tmp164=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmpFE));_tmp116.f1=_tmp164;});_tmp116;});struct Cyc_Int_pa_PrintArg_struct _tmpBA=({struct Cyc_Int_pa_PrintArg_struct _tmp115;_tmp115.tag=1U,_tmp115.f1=(unsigned long)((int)_tmpFD);_tmp115;});void*_tmpB7[2U];_tmpB7[0]=& _tmpB9,_tmpB7[1]=& _tmpBA;({unsigned int _tmp166=loc;struct _dyneither_ptr _tmp165=({const char*_tmpB8="length modifier '%s' is not allowed with %%%c";_tag_dyneither(_tmpB8,sizeof(char),46U);});Cyc_Tcutil_terr(_tmp166,_tmp165,_tag_dyneither(_tmpB7,sizeof(void*),2U));});});{
...
struct _dyneither_ptr _tmp16B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmpFE));_tmp118.f1=_tmp16B;});_tmp118;});struct Cyc_Int_pa_PrintArg_struct _tmpC7=({struct Cyc_Int_pa_PrintArg_struct _tmp117;_tmp117.tag=1U,_tmp117.f1=(unsigned long)((int)_tmpFD);_tmp117;});void*_tmpC4[2U];_tmpC4[0]=& _tmpC6,_tmpC4[1]=& _tmpC7;({unsigned int _tmp16D=loc;struct _dyneither_ptr _tmp16C=({const char*_tmpC5="length modifier '%s' is not allowed with %%%c";_tag_dyneither(_tmpC5,sizeof(char),46U);});Cyc_Tcutil_terr(_tmp16D,_tmp16C,_tag_dyneither(_tmpC4,sizeof(void*),2U));});});{
...
struct _dyneither_ptr _tmp172=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmpFE));_tmp11A.f1=_tmp172;});_tmp11A;});struct Cyc_Int_pa_PrintArg_struct _tmpD4=({struct Cyc_Int_pa_PrintArg_struct _tmp119;_tmp119.tag=1U,_tmp119.f1=(unsigned long)((int)_tmpFD);_tmp119;});void*_tmpD1[2U];_tmpD1[0]=& _tmpD3,_tmpD1[1]=& _tmpD4;({unsigned int _tmp174=loc;struct _dyneither_ptr _tmp173=({const char*_tmpD2="length modifier '%s' is not allowed with %%%c";_tag_dyneither(_tmpD2,sizeof(char),46U);});Cyc_Tcutil_terr(_tmp174,_tmp173,_tag_dyneither(_tmpD1,sizeof(void*),2U));});});{
...
# 570
({struct Cyc_Int_pa_PrintArg_struct _tmpE1=({struct Cyc_Int_pa_PrintArg_struct _tmp11B;_tmp11B.tag=1U,_tmp11B.f1=(unsigned long)((int)_tmpFD);_tmp11B;});void*_tmpDF[1U];_tmpDF[0]=& _tmpE1;({unsigned int _tmp187=loc;struct _dyneither_ptr _tmp186=({const char*_tmpE0="%%%c is not supported";_tag_dyneither(_tmpE0,sizeof(char),22U);});Cyc_Tcutil_terr(_tmp187,_tmp186,_tag_dyneither(_tmpDF,sizeof(void*),1U));});});{
...
struct _dyneither_ptr _tmp189=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmpFE));_tmp11D.f1=_tmp189;});_tmp11D;});struct Cyc_Int_pa_PrintArg_struct _tmpE8=({struct Cyc_Int_pa_PrintArg_struct _tmp11C;_tmp11C.tag=1U,_tmp11C.f1=(unsigned long)((int)_tmpFD);_tmp11C;});void*_tmpE5[2U];_tmpE5[0]=& _tmpE7,_tmpE5[1]=& _tmpE8;({unsigned int _tmp18B=loc;struct _dyneither_ptr _tmp18A=({const char*_tmpE6="length modifier '%s' is not allowed with %%%c";_tag_dyneither(_tmpE6,sizeof(char),46U);});Cyc_Tcutil_terr(_tmp18B,_tmp18A,_tag_dyneither(_tmpE5,sizeof(void*),2U));});});{
...
# 588
 if(_tmp100){
({void*_tmpF0=0U;({unsigned int _tmp190=loc;struct _dyneither_ptr _tmp18F=({const char*_tmpF1="Assignment suppression (*) is not allowed with %%%%";_tag_dyneither(_tmpF1,sizeof(char),52U);});Cyc_Tcutil_terr(_tmp190,_tmp18F,_tag_dyneither(_tmpF0,sizeof(void*),0U));});});{
struct Cyc_List_List*_tmpF2=0;_npop_handler(0U);return _tmpF2;};}
# 592
if(_tmpFF != 0){
({struct Cyc_String_pa_PrintArg_struct _tmpF5=({struct Cyc_String_pa_PrintArg_struct _tmp11E;_tmp11E.tag=0U,({struct _dyneither_ptr _tmp191=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmpFF));_tmp11E.f1=_tmp191;});_tmp11E;});void*_tmpF3[1U];_tmpF3[0]=& _tmpF5;({unsigned int _tmp193=loc;struct _dyneither_ptr _tmp192=({const char*_tmpF4="width '%s' not allowed with %%%%";_tag_dyneither(_tmpF4,sizeof(char),33U);});Cyc_Tcutil_terr(_tmp193,_tmp192,_tag_dyneither(_tmpF3,sizeof(void*),1U));});});{
struct Cyc_List_List*_tmpF6=0;_npop_handler(0U);return _tmpF6;};}
# 596
if(_tmpFE != 0){
({struct Cyc_String_pa_PrintArg_struct _tmpF9=({struct Cyc_String_pa_PrintArg_struct _tmp11F;_tmp11F.tag=0U,({struct _dyneither_ptr _tmp194=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_implode(_tmpFE));_tmp11F.f1=_tmp194;});_tmp11F;});void*_tmpF7[1U];_tmpF7[0]=& _tmpF9;({unsigned int _tmp196=loc;struct _dyneither_ptr _tmp195=({const char*_tmpF8="length modifier '%s' not allowed with %%%%";_tag_dyneither(_tmpF8,sizeof(char),43U);});Cyc_Tcutil_terr(_tmp196,_tmp195,_tag_dyneither(_tmpF7,sizeof(void*),1U));});});{
