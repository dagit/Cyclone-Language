...
if(cs == 0){
struct Cyc_List_List*_tmp1B=({void*_tmp19=0U;({unsigned _tmp122=loc;struct _fat_ptr _tmp121=({const char*_tmp1A="bad format string";_tag_fat(_tmp1A,sizeof(char),18U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp122,_tmp121,_tag_fat(_tmp19,sizeof(void*),0U));});});_npop_handler(0U);return _tmp1B;}{
...
# 187
struct Cyc_List_List*_tmp29=({struct Cyc_Int_pa_PrintArg_struct _tmp28=({struct Cyc_Int_pa_PrintArg_struct _tmp101;_tmp101.tag=1U,_tmp101.f1=(unsigned long)x;_tmp101;});void*_tmp26[1U];_tmp26[0]=& _tmp28;({unsigned _tmp124=loc;struct _fat_ptr _tmp123=({const char*_tmp27="length modifier '%c' is not supported";_tag_fat(_tmp27,sizeof(char),38U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp124,_tmp123,_tag_fat(_tmp26,sizeof(void*),1U));});});_npop_handler(0U);return _tmp29;}}else{goto _LL6;}}else{goto _LL6;}}else{_LL6: _LL7:
 goto _LL3;}_LL3:;}
# 190
...
if((int)f->hd == (int)'#'){
struct Cyc_List_List*_tmp35=({struct Cyc_Int_pa_PrintArg_struct _tmp34=({struct Cyc_Int_pa_PrintArg_struct _tmp102;_tmp102.tag=1U,_tmp102.f1=(unsigned long)((int)c);_tmp102;});void*_tmp32[1U];_tmp32[0]=& _tmp34;({unsigned _tmp126=loc;struct _fat_ptr _tmp125=({const char*_tmp33="flag '#' is not valid with %%%c";_tag_fat(_tmp33,sizeof(char),32U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp126,_tmp125,_tag_fat(_tmp32,sizeof(void*),1U));});});_npop_handler(0U);return _tmp35;}}}
...
# 213
struct Cyc_List_List*_tmp3F=({struct Cyc_String_pa_PrintArg_struct _tmp3D=({struct Cyc_String_pa_PrintArg_struct _tmp104;_tmp104.tag=0U,({
struct _fat_ptr _tmp127=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(lenmod));_tmp104.f1=_tmp127;});_tmp104;});struct Cyc_Int_pa_PrintArg_struct _tmp3E=({struct Cyc_Int_pa_PrintArg_struct _tmp103;_tmp103.tag=1U,_tmp103.f1=(unsigned long)((int)c);_tmp103;});void*_tmp3B[2U];_tmp3B[0]=& _tmp3D,_tmp3B[1]=& _tmp3E;({unsigned _tmp129=loc;struct _fat_ptr _tmp128=({const char*_tmp3C="length modifier '%s' is not allowed with %%%c";_tag_fat(_tmp3C,sizeof(char),46U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp129,_tmp128,_tag_fat(_tmp3B,sizeof(void*),2U));});});_npop_handler(0U);return _tmp3F;}}}}_LL3B:;}
# 216
...
{struct Cyc_List_List*f=flags;for(0;f != 0;f=f->tl){
if((int)f->hd == (int)'#'){
struct Cyc_List_List*_tmp43=({void*_tmp41=0U;({unsigned _tmp12B=loc;struct _fat_ptr _tmp12A=({const char*_tmp42="Flag '#' not valid with %%u";_tag_fat(_tmp42,sizeof(char),28U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp12B,_tmp12A,_tag_fat(_tmp41,sizeof(void*),0U));});});_npop_handler(0U);return _tmp43;}}}
...
# 259
struct Cyc_List_List*_tmp57=({struct Cyc_String_pa_PrintArg_struct _tmp55=({struct Cyc_String_pa_PrintArg_struct _tmp108;_tmp108.tag=0U,({
struct _fat_ptr _tmp12F=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(lenmod));_tmp108.f1=_tmp12F;});_tmp108;});struct Cyc_Int_pa_PrintArg_struct _tmp56=({struct Cyc_Int_pa_PrintArg_struct _tmp107;_tmp107.tag=1U,_tmp107.f1=(unsigned long)((int)c);_tmp107;});void*_tmp53[2U];_tmp53[0]=& _tmp55,_tmp53[1]=& _tmp56;({unsigned _tmp131=loc;struct _fat_ptr _tmp130=({const char*_tmp54="length modifier '%s' is not allowed with %%%c";_tag_fat(_tmp54,sizeof(char),46U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp131,_tmp130,_tag_fat(_tmp53,sizeof(void*),2U));});});_npop_handler(0U);return _tmp57;}}}_LL51:;}
# 262
goto _LL12;case 99U: _LL2F: _LL30:
# 264
{struct Cyc_List_List*f=flags;for(0;f != 0;f=f->tl){
if((int)f->hd == (int)'#' ||(int)f->hd == (int)'0'){
struct Cyc_List_List*_tmp5B=({struct Cyc_Int_pa_PrintArg_struct _tmp5A=({struct Cyc_Int_pa_PrintArg_struct _tmp109;_tmp109.tag=1U,_tmp109.f1=(unsigned long)((int)f->hd);_tmp109;});void*_tmp58[1U];_tmp58[0]=& _tmp5A;({unsigned _tmp133=loc;struct _fat_ptr _tmp132=({const char*_tmp59="flag '%c' not allowed with %%c";_tag_fat(_tmp59,sizeof(char),31U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp133,_tmp132,_tag_fat(_tmp58,sizeof(void*),1U));});});_npop_handler(0U);return _tmp5B;}}}
# 269
if(lenmod != 0){
struct Cyc_List_List*_tmp5F=({struct Cyc_String_pa_PrintArg_struct _tmp5E=({struct Cyc_String_pa_PrintArg_struct _tmp10A;_tmp10A.tag=0U,({
struct _fat_ptr _tmp134=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(lenmod));_tmp10A.f1=_tmp134;});_tmp10A;});void*_tmp5C[1U];_tmp5C[0]=& _tmp5E;({unsigned _tmp136=loc;struct _fat_ptr _tmp135=({const char*_tmp5D="length modifier '%s' not allowed with %%c";_tag_fat(_tmp5D,sizeof(char),42U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp136,_tmp135,_tag_fat(_tmp5C,sizeof(void*),1U));});});_npop_handler(0U);return _tmp5F;}
if(precision != 0){
struct Cyc_List_List*_tmp63=({struct Cyc_String_pa_PrintArg_struct _tmp62=({struct Cyc_String_pa_PrintArg_struct _tmp10B;_tmp10B.tag=0U,({
struct _fat_ptr _tmp137=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(precision));_tmp10B.f1=_tmp137;});_tmp10B;});void*_tmp60[1U];_tmp60[0]=& _tmp62;({unsigned _tmp139=loc;struct _fat_ptr _tmp138=({const char*_tmp61="precision '%s' not allowed with %%c";_tag_fat(_tmp61,sizeof(char),36U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp139,_tmp138,_tag_fat(_tmp60,sizeof(void*),1U));});});_npop_handler(0U);return _tmp63;}
...
{struct Cyc_List_List*f=flags;for(0;f != 0;f=f->tl){
if((int)f->hd != (int)'-'){
struct Cyc_List_List*_tmp67=({void*_tmp65=0U;({unsigned _tmp13B=loc;struct _fat_ptr _tmp13A=({const char*_tmp66="a flag not allowed with %%s";_tag_fat(_tmp66,sizeof(char),28U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp13B,_tmp13A,_tag_fat(_tmp65,sizeof(void*),0U));});});_npop_handler(0U);return _tmp67;}}}
# 284
if(lenmod != 0){
struct Cyc_List_List*_tmp6A=({void*_tmp68=0U;({unsigned _tmp13D=loc;struct _fat_ptr _tmp13C=({const char*_tmp69="length modifiers not allowed with %%s";_tag_fat(_tmp69,sizeof(char),38U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp13D,_tmp13C,_tag_fat(_tmp68,sizeof(void*),0U));});});_npop_handler(0U);return _tmp6A;}{
# 288
void*ptr;
if(!isCproto)
ptr=({void*_tmp141=Cyc_Absyn_char_type;void*_tmp140=
Cyc_Absyn_new_evar(& Cyc_Kinds_rko,({struct Cyc_Core_Opt*_tmp6B=_cycalloc(sizeof(*_tmp6B));({
...
Cyc_Absyn_new_evar(& Cyc_Kinds_rko,({struct Cyc_Core_Opt*_tmp6C=_cycalloc(sizeof(*_tmp6C));({
...
{struct Cyc_List_List*f=flags;for(0;f != 0;f=f->tl){
if((int)f->hd == (int)'#' ||(int)f->hd == (int)'0'){
struct Cyc_List_List*_tmp72=({struct Cyc_Int_pa_PrintArg_struct _tmp71=({struct Cyc_Int_pa_PrintArg_struct _tmp10C;_tmp10C.tag=1U,_tmp10C.f1=(unsigned long)((int)f->hd);_tmp10C;});void*_tmp6F[1U];_tmp6F[0]=& _tmp71;({unsigned _tmp147=loc;struct _fat_ptr _tmp146=({const char*_tmp70="flag '%c' not allowed with %%n";_tag_fat(_tmp70,sizeof(char),31U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp147,_tmp146,_tag_fat(_tmp6F,sizeof(void*),1U));});});_npop_handler(0U);return _tmp72;}}}
if(precision != 0){
struct Cyc_List_List*_tmp76=({struct Cyc_String_pa_PrintArg_struct _tmp75=({struct Cyc_String_pa_PrintArg_struct _tmp10D;_tmp10D.tag=0U,({
struct _fat_ptr _tmp148=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(precision));_tmp10D.f1=_tmp148;});_tmp10D;});void*_tmp73[1U];_tmp73[0]=& _tmp75;({unsigned _tmp14A=loc;struct _fat_ptr _tmp149=({const char*_tmp74="precision '%s' not allowed with %%n";_tag_fat(_tmp74,sizeof(char),36U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp14A,_tmp149,_tag_fat(_tmp73,sizeof(void*),1U));});});_npop_handler(0U);return _tmp76;}{
...
# 321
struct Cyc_List_List*_tmp81=({struct Cyc_String_pa_PrintArg_struct _tmp7F=({struct Cyc_String_pa_PrintArg_struct _tmp10F;_tmp10F.tag=0U,({
struct _fat_ptr _tmp14C=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(lenmod));_tmp10F.f1=_tmp14C;});_tmp10F;});struct Cyc_Int_pa_PrintArg_struct _tmp80=({struct Cyc_Int_pa_PrintArg_struct _tmp10E;_tmp10E.tag=1U,_tmp10E.f1=(unsigned long)((int)c);_tmp10E;});void*_tmp7D[2U];_tmp7D[0]=& _tmp7F,_tmp7D[1]=& _tmp80;({unsigned _tmp14E=loc;struct _fat_ptr _tmp14D=({const char*_tmp7E="length modifier '%s' is not allowed with %%%c";_tag_fat(_tmp7E,sizeof(char),46U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp14E,_tmp14D,_tag_fat(_tmp7D,sizeof(void*),2U));});});_npop_handler(0U);return _tmp81;}}}}_LL58:;}
# 324
t=({void*_tmp151=t;void*_tmp150=Cyc_Absyn_new_evar(& Cyc_Kinds_rko,tvs);struct Cyc_Absyn_Tqual _tmp14F=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp151,_tmp150,_tmp14F,Cyc_Absyn_false_type);});
...
# 328
 if(flags != 0){
struct Cyc_List_List*_tmp87=({struct Cyc_String_pa_PrintArg_struct _tmp86=({struct Cyc_String_pa_PrintArg_struct _tmp110;_tmp110.tag=0U,({
struct _fat_ptr _tmp152=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(flags));_tmp110.f1=_tmp152;});_tmp110;});void*_tmp84[1U];_tmp84[0]=& _tmp86;({unsigned _tmp154=loc;struct _fat_ptr _tmp153=({const char*_tmp85="flags '%s' not allowed with %%%%";_tag_fat(_tmp85,sizeof(char),33U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp154,_tmp153,_tag_fat(_tmp84,sizeof(void*),1U));});});_npop_handler(0U);return _tmp87;}
if(width != 0){
struct Cyc_List_List*_tmp8B=({struct Cyc_String_pa_PrintArg_struct _tmp8A=({struct Cyc_String_pa_PrintArg_struct _tmp111;_tmp111.tag=0U,({
struct _fat_ptr _tmp155=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(width));_tmp111.f1=_tmp155;});_tmp111;});void*_tmp88[1U];_tmp88[0]=& _tmp8A;({unsigned _tmp157=loc;struct _fat_ptr _tmp156=({const char*_tmp89="width '%s' not allowed with %%%%";_tag_fat(_tmp89,sizeof(char),33U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp157,_tmp156,_tag_fat(_tmp88,sizeof(void*),1U));});});_npop_handler(0U);return _tmp8B;}
if(precision != 0){
struct Cyc_List_List*_tmp8F=({struct Cyc_String_pa_PrintArg_struct _tmp8E=({struct Cyc_String_pa_PrintArg_struct _tmp112;_tmp112.tag=0U,({
struct _fat_ptr _tmp158=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(precision));_tmp112.f1=_tmp158;});_tmp112;});void*_tmp8C[1U];_tmp8C[0]=& _tmp8E;({unsigned _tmp15A=loc;struct _fat_ptr _tmp159=({const char*_tmp8D="precision '%s' not allowed with %%%%";_tag_fat(_tmp8D,sizeof(char),37U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp15A,_tmp159,_tag_fat(_tmp8C,sizeof(void*),1U));});});_npop_handler(0U);return _tmp8F;}
if(lenmod != 0){
struct Cyc_List_List*_tmp93=({struct Cyc_String_pa_PrintArg_struct _tmp92=({struct Cyc_String_pa_PrintArg_struct _tmp113;_tmp113.tag=0U,({
struct _fat_ptr _tmp15B=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(lenmod));_tmp113.f1=_tmp15B;});_tmp113;});void*_tmp90[1U];_tmp90[0]=& _tmp92;({unsigned _tmp15D=loc;struct _fat_ptr _tmp15C=({const char*_tmp91="length modifier '%s' not allowed with %%%%";_tag_fat(_tmp91,sizeof(char),43U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp15D,_tmp15C,_tag_fat(_tmp90,sizeof(void*),1U));});});_npop_handler(0U);return _tmp93;}
...
if(x == 0){
struct Cyc_List_List*_tmpAB=({void*_tmpA9=0U;({unsigned _tmp160=loc;struct _fat_ptr _tmp15F=({const char*_tmpAA="bad format string";_tag_fat(_tmpAA,sizeof(char),18U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp160,_tmp15F,_tag_fat(_tmpA9,sizeof(void*),0U));});});_npop_handler(0U);return _tmpAB;}{
...
# 451
struct Cyc_List_List*_tmpB8=({struct Cyc_Int_pa_PrintArg_struct _tmpB7=({struct Cyc_Int_pa_PrintArg_struct _tmp114;_tmp114.tag=1U,_tmp114.f1=(unsigned long)x;_tmp114;});void*_tmpB5[1U];_tmpB5[0]=& _tmpB7;({unsigned _tmp162=loc;struct _fat_ptr _tmp161=({const char*_tmpB6="length modifier '%c' is not supported";_tag_fat(_tmpB6,sizeof(char),38U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp162,_tmp161,_tag_fat(_tmpB5,sizeof(void*),1U));});});_npop_handler(0U);return _tmpB8;}}else{goto _LL6;}}else{goto _LL6;}}else{_LL6: _LL7:
 goto _LL3;}_LL3:;}
# 454
...
# 466
struct Cyc_List_List*_tmpC4=({struct Cyc_String_pa_PrintArg_struct _tmpC2=({struct Cyc_String_pa_PrintArg_struct _tmp116;_tmp116.tag=0U,({
struct _fat_ptr _tmp164=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(lenmod));_tmp116.f1=_tmp164;});_tmp116;});struct Cyc_Int_pa_PrintArg_struct _tmpC3=({struct Cyc_Int_pa_PrintArg_struct _tmp115;_tmp115.tag=1U,_tmp115.f1=(unsigned long)((int)c);_tmp115;});void*_tmpC0[2U];_tmpC0[0]=& _tmpC2,_tmpC0[1]=& _tmpC3;({unsigned _tmp166=loc;struct _fat_ptr _tmp165=({const char*_tmpC1="length modifier '%s' is not allowed with %%%c";_tag_fat(_tmpC1,sizeof(char),46U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp166,_tmp165,_tag_fat(_tmpC0,sizeof(void*),2U));});});_npop_handler(0U);return _tmpC4;}}}}_LL33:;}
# 469
t=({void*_tmp169=t;void*_tmp168=Cyc_Absyn_new_evar(& Cyc_Kinds_rko,tvs);struct Cyc_Absyn_Tqual _tmp167=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp169,_tmp168,_tmp167,Cyc_Absyn_false_type);});
...
# 483
struct Cyc_List_List*_tmpD1=({struct Cyc_String_pa_PrintArg_struct _tmpCF=({struct Cyc_String_pa_PrintArg_struct _tmp118;_tmp118.tag=0U,({
struct _fat_ptr _tmp16B=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(lenmod));_tmp118.f1=_tmp16B;});_tmp118;});struct Cyc_Int_pa_PrintArg_struct _tmpD0=({struct Cyc_Int_pa_PrintArg_struct _tmp117;_tmp117.tag=1U,_tmp117.f1=(unsigned long)((int)c);_tmp117;});void*_tmpCD[2U];_tmpCD[0]=& _tmpCF,_tmpCD[1]=& _tmpD0;({unsigned _tmp16D=loc;struct _fat_ptr _tmp16C=({const char*_tmpCE="length modifier '%s' is not allowed with %%%c";_tag_fat(_tmpCE,sizeof(char),46U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp16D,_tmp16C,_tag_fat(_tmpCD,sizeof(void*),2U));});});_npop_handler(0U);return _tmpD1;}}}}_LL3E:;}
# 486
t=({void*_tmp170=t;void*_tmp16F=Cyc_Absyn_new_evar(& Cyc_Kinds_rko,tvs);struct Cyc_Absyn_Tqual _tmp16E=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp170,_tmp16F,_tmp16E,Cyc_Absyn_false_type);});
...
# 503
struct Cyc_List_List*_tmpDB=({struct Cyc_String_pa_PrintArg_struct _tmpD9=({struct Cyc_String_pa_PrintArg_struct _tmp11A;_tmp11A.tag=0U,({
struct _fat_ptr _tmp172=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(lenmod));_tmp11A.f1=_tmp172;});_tmp11A;});struct Cyc_Int_pa_PrintArg_struct _tmpDA=({struct Cyc_Int_pa_PrintArg_struct _tmp119;_tmp119.tag=1U,_tmp119.f1=(unsigned long)((int)c);_tmp119;});void*_tmpD7[2U];_tmpD7[0]=& _tmpD9,_tmpD7[1]=& _tmpDA;({unsigned _tmp174=loc;struct _fat_ptr _tmp173=({const char*_tmpD8="length modifier '%s' is not allowed with %%%c";_tag_fat(_tmpD8,sizeof(char),46U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp174,_tmp173,_tag_fat(_tmpD7,sizeof(void*),2U));});});_npop_handler(0U);return _tmpDB;}}}_LL49:;}
# 506
t=({void*_tmp177=t;void*_tmp176=Cyc_Absyn_new_evar(& Cyc_Kinds_rko,tvs);struct Cyc_Absyn_Tqual _tmp175=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp177,_tmp176,_tmp175,Cyc_Absyn_false_type);});
...
void*ptr;
if(!isCproto)
ptr=({void*_tmp17B=Cyc_Absyn_char_type;void*_tmp17A=Cyc_Absyn_new_evar(& Cyc_Kinds_rko,tvs);struct Cyc_Absyn_Tqual _tmp179=
...
Cyc_Absyn_new_evar(& Cyc_Kinds_rko,tvs);
# 518
...
void*ptr;
if(!isCproto)
ptr=({void*_tmp182=Cyc_Absyn_char_type;void*_tmp181=Cyc_Absyn_new_evar(& Cyc_Kinds_rko,tvs);struct Cyc_Absyn_Tqual _tmp180=
Cyc_Absyn_empty_tqual(0U);
# 528
Cyc_Absyn_fatptr_type(_tmp182,_tmp181,_tmp180,Cyc_Absyn_false_type);});else{
# 531
ptr=({void*_tmp185=Cyc_Absyn_char_type;void*_tmp184=Cyc_Absyn_new_evar(& Cyc_Kinds_rko,tvs);struct Cyc_Absyn_Tqual _tmp183=
Cyc_Absyn_empty_tqual(0U);
# 531
...
# 537
struct Cyc_List_List*_tmpE7=({struct Cyc_Int_pa_PrintArg_struct _tmpE6=({struct Cyc_Int_pa_PrintArg_struct _tmp11B;_tmp11B.tag=1U,_tmp11B.f1=(unsigned long)((int)c);_tmp11B;});void*_tmpE4[1U];_tmpE4[0]=& _tmpE6;({unsigned _tmp187=loc;struct _fat_ptr _tmp186=({const char*_tmpE5="%%%c is not supported";_tag_fat(_tmpE5,sizeof(char),22U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp187,_tmp186,_tag_fat(_tmpE4,sizeof(void*),1U));});});_npop_handler(0U);return _tmpE7;}case 110U: _LL2D: _LL2E: {
# 539
...
# 546
struct Cyc_List_List*_tmpF2=({struct Cyc_String_pa_PrintArg_struct _tmpF0=({struct Cyc_String_pa_PrintArg_struct _tmp11D;_tmp11D.tag=0U,({
struct _fat_ptr _tmp189=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(lenmod));_tmp11D.f1=_tmp189;});_tmp11D;});struct Cyc_Int_pa_PrintArg_struct _tmpF1=({struct Cyc_Int_pa_PrintArg_struct _tmp11C;_tmp11C.tag=1U,_tmp11C.f1=(unsigned long)((int)c);_tmp11C;});void*_tmpEE[2U];_tmpEE[0]=& _tmpF0,_tmpEE[1]=& _tmpF1;({unsigned _tmp18B=loc;struct _fat_ptr _tmp18A=({const char*_tmpEF="length modifier '%s' is not allowed with %%%c";_tag_fat(_tmpEF,sizeof(char),46U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp18B,_tmp18A,_tag_fat(_tmpEE,sizeof(void*),2U));});});_npop_handler(0U);return _tmpF2;}}}}_LL50:;}
# 549
t=({void*_tmp18E=t;void*_tmp18D=Cyc_Absyn_new_evar(& Cyc_Kinds_rko,tvs);struct Cyc_Absyn_Tqual _tmp18C=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp18E,_tmp18D,_tmp18C,Cyc_Absyn_false_type);});
typs=({struct Cyc_List_List*_tmpF3=_cycalloc(sizeof(*_tmpF3));_tmpF3->hd=t,_tmpF3->tl=typs;_tmpF3;});
goto _LL8;}case 37U: _LL2F: _LL30:
# 553
 if(suppress){
struct Cyc_List_List*_tmpF7=({void*_tmpF5=0U;({unsigned _tmp190=loc;struct _fat_ptr _tmp18F=({const char*_tmpF6="Assignment suppression (*) is not allowed with %%%%";_tag_fat(_tmpF6,sizeof(char),52U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp190,_tmp18F,_tag_fat(_tmpF5,sizeof(void*),0U));});});_npop_handler(0U);return _tmpF7;}
if(width != 0){
struct Cyc_List_List*_tmpFB=({struct Cyc_String_pa_PrintArg_struct _tmpFA=({struct Cyc_String_pa_PrintArg_struct _tmp11E;_tmp11E.tag=0U,({struct _fat_ptr _tmp191=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(width));_tmp11E.f1=_tmp191;});_tmp11E;});void*_tmpF8[1U];_tmpF8[0]=& _tmpFA;({unsigned _tmp193=loc;struct _fat_ptr _tmp192=({const char*_tmpF9="width '%s' not allowed with %%%%";_tag_fat(_tmpF9,sizeof(char),33U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp193,_tmp192,_tag_fat(_tmpF8,sizeof(void*),1U));});});_npop_handler(0U);return _tmpFB;}
if(lenmod != 0){
struct Cyc_List_List*_tmpFF=({struct Cyc_String_pa_PrintArg_struct _tmpFE=({struct Cyc_String_pa_PrintArg_struct _tmp11F;_tmp11F.tag=0U,({
struct _fat_ptr _tmp194=(struct _fat_ptr)((struct _fat_ptr)Cyc_implode(lenmod));_tmp11F.f1=_tmp194;});_tmp11F;});void*_tmpFC[1U];_tmpFC[0]=& _tmpFE;({unsigned _tmp196=loc;struct _fat_ptr _tmp195=({const char*_tmpFD="length modifier '%s' not allowed with %%%%";_tag_fat(_tmpFD,sizeof(char),43U);});((struct Cyc_List_List*(*)(unsigned loc,struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Formatstr_err_null)(_tmp196,_tmp195,_tag_fat(_tmpFC,sizeof(void*),1U));});});_npop_handler(0U);return _tmpFF;}
