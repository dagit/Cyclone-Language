...
const char*_tmp3CB;void*_tmp3CA;(_tmp3CA=0,Cyc_fprintf(*Cyc_Absyndump_dump_file,((_tmp3CB="\n",_tag_dyneither(_tmp3CB,sizeof(char),2))),_tag_dyneither(_tmp3CA,sizeof(void*),0)));}else{
if((char*)_tmp2.curr == (char*)last_file.curr){
const char*_tmp3CF;void*_tmp3CE[1];struct Cyc_Int_pa_PrintArg_struct _tmp3CD;(_tmp3CD.tag=1,((_tmp3CD.f1=(unsigned long)((int)_tmp3),((_tmp3CE[0]=& _tmp3CD,Cyc_fprintf(*Cyc_Absyndump_dump_file,((_tmp3CF="\n# %d\n",_tag_dyneither(_tmp3CF,sizeof(char),7))),_tag_dyneither(_tmp3CE,sizeof(void*),1)))))));}else{
# 168
const char*_tmp3D4;void*_tmp3D3[2];struct Cyc_Int_pa_PrintArg_struct _tmp3D2;struct Cyc_String_pa_PrintArg_struct _tmp3D1;(_tmp3D1.tag=0,((_tmp3D1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp2),((_tmp3D2.tag=1,((_tmp3D2.f1=(unsigned long)((int)_tmp3),((_tmp3D3[0]=& _tmp3D2,((_tmp3D3[1]=& _tmp3D1,Cyc_fprintf(*Cyc_Absyndump_dump_file,((_tmp3D4="\n# %d %s\n",_tag_dyneither(_tmp3D4,sizeof(char),10))),_tag_dyneither(_tmp3D3,sizeof(void*),2)))))))))))));}}
# 170
last_file=_tmp2;
last_line=_tmp3;};}
# 176
...
const char*_tmp3D5;Cyc_Absyndump_dump_nospace(((_tmp3D5="::",_tag_dyneither(_tmp3D5,sizeof(char),3))));}}
# 247
if(_tmpE != 0){
...
Cyc_Absyndump_dump_nospace(*((struct _dyneither_ptr*)_tmpE->hd));}
# 256
if(Cyc_Absyndump_qvar_to_Cids){const char*_tmp3D7;Cyc_Absyndump_dump_nospace(((_tmp3D7="_",_tag_dyneither(_tmp3D7,sizeof(char),2))));}else{
...
if(tq.q_restrict){const char*_tmp3D9;Cyc_Absyndump_dump(((_tmp3D9="restrict",_tag_dyneither(_tmp3D9,sizeof(char),9))));}
if(tq.q_volatile){const char*_tmp3DA;Cyc_Absyndump_dump(((_tmp3DA="volatile",_tag_dyneither(_tmp3DA,sizeof(char),9))));}
if(tq.print_const){const char*_tmp3DB;Cyc_Absyndump_dump(((_tmp3DB="const",_tag_dyneither(_tmp3DB,sizeof(char),6))));}}
# 273
void Cyc_Absyndump_dumpscope(enum Cyc_Absyn_Scope sc){
switch(sc){case Cyc_Absyn_Static: _LL19:
{const char*_tmp3DC;Cyc_Absyndump_dump(((_tmp3DC="static",_tag_dyneither(_tmp3DC,sizeof(char),7))));}return;case Cyc_Absyn_Public: _LL1A:
 return;case Cyc_Absyn_Extern: _LL1B:
{const char*_tmp3DD;Cyc_Absyndump_dump(((_tmp3DD="extern",_tag_dyneither(_tmp3DD,sizeof(char),7))));}return;case Cyc_Absyn_ExternC: _LL1C:
{const char*_tmp3DE;Cyc_Absyndump_dump(((_tmp3DE="extern \"C\"",_tag_dyneither(_tmp3DE,sizeof(char),11))));}return;case Cyc_Absyn_Abstract: _LL1D:
{const char*_tmp3DF;Cyc_Absyndump_dump(((_tmp3DF="abstract",_tag_dyneither(_tmp3DF,sizeof(char),9))));}return;case Cyc_Absyn_Register: _LL1E:
{const char*_tmp3E0;Cyc_Absyndump_dump(((_tmp3E0="register",_tag_dyneither(_tmp3E0,sizeof(char),9))));}return;}}
# 284
...
{const char*_tmp3E1;Cyc_Absyndump_dump(((_tmp3E1="A",_tag_dyneither(_tmp3E1,sizeof(char),2))));}return;case Cyc_Absyn_Unique: _LL23:
{const char*_tmp3E2;Cyc_Absyndump_dump(((_tmp3E2="UA",_tag_dyneither(_tmp3E2,sizeof(char),3))));}return;case Cyc_Absyn_Top: _LL24:
{const char*_tmp3E3;Cyc_Absyndump_dump(((_tmp3E3="TA",_tag_dyneither(_tmp3E3,sizeof(char),3))));}return;}case Cyc_Absyn_MemKind: _LL21:
# 294
 switch(_tmp22){case Cyc_Absyn_Aliasable: _LL27:
{const char*_tmp3E4;Cyc_Absyndump_dump(((_tmp3E4="M",_tag_dyneither(_tmp3E4,sizeof(char),2))));}return;case Cyc_Absyn_Unique: _LL28:
{const char*_tmp3E5;Cyc_Absyndump_dump(((_tmp3E5="UM",_tag_dyneither(_tmp3E5,sizeof(char),3))));}return;case Cyc_Absyn_Top: _LL29:
{const char*_tmp3E6;Cyc_Absyndump_dump(((_tmp3E6="TM",_tag_dyneither(_tmp3E6,sizeof(char),3))));}return;}case Cyc_Absyn_BoxKind: _LL26:
# 300
 switch(_tmp22){case Cyc_Absyn_Aliasable: _LL2C:
{const char*_tmp3E7;Cyc_Absyndump_dump(((_tmp3E7="B",_tag_dyneither(_tmp3E7,sizeof(char),2))));}return;case Cyc_Absyn_Unique: _LL2D:
{const char*_tmp3E8;Cyc_Absyndump_dump(((_tmp3E8="UB",_tag_dyneither(_tmp3E8,sizeof(char),3))));}return;case Cyc_Absyn_Top: _LL2E:
{const char*_tmp3E9;Cyc_Absyndump_dump(((_tmp3E9="TB",_tag_dyneither(_tmp3E9,sizeof(char),3))));}return;}case Cyc_Absyn_RgnKind: _LL2B:
# 306
 switch(_tmp22){case Cyc_Absyn_Aliasable: _LL31:
{const char*_tmp3EA;Cyc_Absyndump_dump(((_tmp3EA="R",_tag_dyneither(_tmp3EA,sizeof(char),2))));}return;case Cyc_Absyn_Unique: _LL32:
{const char*_tmp3EB;Cyc_Absyndump_dump(((_tmp3EB="UR",_tag_dyneither(_tmp3EB,sizeof(char),3))));}return;case Cyc_Absyn_Top: _LL33:
{const char*_tmp3EC;Cyc_Absyndump_dump(((_tmp3EC="TR",_tag_dyneither(_tmp3EC,sizeof(char),3))));}return;}case Cyc_Absyn_EffKind: _LL30:
# 311
{const char*_tmp3ED;Cyc_Absyndump_dump(((_tmp3ED="E",_tag_dyneither(_tmp3ED,sizeof(char),2))));}return;case Cyc_Absyn_IntKind: _LL35:
{const char*_tmp3EE;Cyc_Absyndump_dump(((_tmp3EE="I",_tag_dyneither(_tmp3EE,sizeof(char),2))));}return;}}
# 316
void Cyc_Absyndump_dumpaggr_kind(enum Cyc_Absyn_AggrKind k){
switch(k){case Cyc_Absyn_StructA: _LL37:
{const char*_tmp3EF;Cyc_Absyndump_dump(((_tmp3EF="struct ",_tag_dyneither(_tmp3EF,sizeof(char),8))));}return;case Cyc_Absyn_UnionA: _LL38:
{const char*_tmp3F0;Cyc_Absyndump_dump(((_tmp3F0="union ",_tag_dyneither(_tmp3F0,sizeof(char),7))));}return;}}
# 323
void Cyc_Absyndump_dumptps(struct Cyc_List_List*ts){
const char*_tmp3F3;const char*_tmp3F2;const char*_tmp3F1;((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptyp,ts,((_tmp3F1="<",_tag_dyneither(_tmp3F1,sizeof(char),2))),((_tmp3F2=">",_tag_dyneither(_tmp3F2,sizeof(char),2))),((_tmp3F3=",",_tag_dyneither(_tmp3F3,sizeof(char),2))));}
# 326
...
{const char*_tmp3F4;Cyc_Absyndump_dump(((_tmp3F4="`G",_tag_dyneither(_tmp3F4,sizeof(char),3))));}
...
{const char*_tmp3F5;Cyc_Absyndump_dump_nospace(((_tmp3F5="K",_tag_dyneither(_tmp3F5,sizeof(char),2))));}goto _LL3A;_LL3A:;}
# 335
...
{const char*_tmp3F6;Cyc_Absyndump_dump(((_tmp3F6="::",_tag_dyneither(_tmp3F6,sizeof(char),3))));}Cyc_Absyndump_dumpkind(_tmp45);goto _LL41;_LL41:;};}
# 348
...
{const char*_tmp400;Cyc_Absyndump_dump(((_tmp400="_stdcall",_tag_dyneither(_tmp400,sizeof(char),9))));}return;_LL4D: {struct Cyc_Absyn_Cdecl_att_Absyn_Attribute_struct*_tmp53=(struct Cyc_Absyn_Cdecl_att_Absyn_Attribute_struct*)_tmp51;if(_tmp53->tag != 2)goto _LL4F;}_LL4E:
{const char*_tmp401;Cyc_Absyndump_dump(((_tmp401="_cdecl",_tag_dyneither(_tmp401,sizeof(char),7))));}return;_LL4F: {struct Cyc_Absyn_Fastcall_att_Absyn_Attribute_struct*_tmp54=(struct Cyc_Absyn_Fastcall_att_Absyn_Attribute_struct*)_tmp51;if(_tmp54->tag != 3)goto _LL51;}_LL50:
{const char*_tmp402;Cyc_Absyndump_dump(((_tmp402="_fastcall",_tag_dyneither(_tmp402,sizeof(char),10))));}return;_LL51:;_LL52:
 goto _LL4A;_LL4A:;}}
# 372
...
{const char*_tmp407;Cyc_Absyndump_dump(((_tmp407="`H",_tag_dyneither(_tmp407,sizeof(char),3))));}goto _LL6D;_LL70:;_LL71:
...
{struct Cyc_List_List*_tmp408;rgions=((_tmp408=_cycalloc(sizeof(*_tmp408)),((_tmp408->hd=_tmp70,((_tmp408->tl=rgions,_tmp408))))));}goto _LL72;_LL75: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp71=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmp6E;if(_tmp71->tag != 24)goto _LL77;else{_tmp72=_tmp71->f1;}}_LL76:
# 434
...
{struct Cyc_List_List*_tmp409;effects=((_tmp409=_cycalloc(sizeof(*_tmp409)),((_tmp409->hd=t,((_tmp409->tl=effects,_tmp409))))));}goto _LL72;_LL72:;}{
# 442
...
{const char*_tmp40B;Cyc_Absyndump_dump(((_tmp40B="void",_tag_dyneither(_tmp40B,sizeof(char),5))));}return;_LL82: {struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp84=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp7F;if(_tmp84->tag != 2)goto _LL84;else{_tmp85=_tmp84->f1;}}_LL83:
...
# 481
{const char*_tmp40C;Cyc_Absyndump_dump(((_tmp40C="`E",_tag_dyneither(_tmp40C,sizeof(char),3))));}
if(_tmp87 == 0){const char*_tmp40D;Cyc_Absyndump_dump(((_tmp40D="K",_tag_dyneither(_tmp40D,sizeof(char),2))));}else{Cyc_Absyndump_dumpkind((struct Cyc_Absyn_Kind*)_tmp87->v);}
{const char*_tmp411;void*_tmp410[1];struct Cyc_Int_pa_PrintArg_struct _tmp40F;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp40F.tag=1,((_tmp40F.f1=(unsigned long)_tmp88,((_tmp410[0]=& _tmp40F,Cyc_aprintf(((_tmp411="%d",_tag_dyneither(_tmp411,sizeof(char),3))),_tag_dyneither(_tmp410,sizeof(void*),1)))))))));}return;_LL86: {struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmp89=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp7F;if(_tmp89->tag != 1)goto _LL88;else{_tmp8A=_tmp89->f1;_tmp8B=(void*)_tmp89->f2;_tmp8C=_tmp89->f3;}}_LL87:
...
# 489
 if(_tmpD8){const char*_tmp412;Cyc_Absyndump_dump(((_tmp412="@extensible ",_tag_dyneither(_tmp412,sizeof(char),13))));}
...
# 502
 if(_tmpE0){const char*_tmp414;Cyc_Absyndump_dump(((_tmp414="@extensible ",_tag_dyneither(_tmp414,sizeof(char),13))));}
...
{const char*_tmp418;Cyc_Absyndump_dump(((_tmp418="long",_tag_dyneither(_tmp418,sizeof(char),5))));}return;_LL94: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp97=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp7F;if(_tmp97->tag != 6)goto _LL96;else{if(_tmp97->f1 != Cyc_Absyn_None)goto _LL96;if(_tmp97->f2 != Cyc_Absyn_Char_sz)goto _LL96;}}_LL95:
{const char*_tmp419;Cyc_Absyndump_dump(((_tmp419="char",_tag_dyneither(_tmp419,sizeof(char),5))));}return;_LL96: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp98=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp7F;if(_tmp98->tag != 6)goto _LL98;else{if(_tmp98->f1 != Cyc_Absyn_Signed)goto _LL98;if(_tmp98->f2 != Cyc_Absyn_Char_sz)goto _LL98;}}_LL97:
{const char*_tmp41A;Cyc_Absyndump_dump(((_tmp41A="signed char",_tag_dyneither(_tmp41A,sizeof(char),12))));}return;_LL98: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp99=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp7F;if(_tmp99->tag != 6)goto _LL9A;else{if(_tmp99->f1 != Cyc_Absyn_Unsigned)goto _LL9A;if(_tmp99->f2 != Cyc_Absyn_Char_sz)goto _LL9A;}}_LL99:
...
{const char*_tmp41C;Cyc_Absyndump_dump(((_tmp41C="short",_tag_dyneither(_tmp41C,sizeof(char),6))));}return;_LL9E: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp9C=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp7F;if(_tmp9C->tag != 6)goto _LLA0;else{if(_tmp9C->f1 != Cyc_Absyn_Unsigned)goto _LLA0;if(_tmp9C->f2 != Cyc_Absyn_Short_sz)goto _LLA0;}}_LL9F:
{const char*_tmp41D;Cyc_Absyndump_dump(((_tmp41D="unsigned short",_tag_dyneither(_tmp41D,sizeof(char),15))));}return;_LLA0: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp9D=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp7F;if(_tmp9D->tag != 6)goto _LLA2;else{if(_tmp9D->f1 != Cyc_Absyn_Unsigned)goto _LLA2;if(_tmp9D->f2 != Cyc_Absyn_Int_sz)goto _LLA2;}}_LLA1:
{const char*_tmp41E;Cyc_Absyndump_dump(((_tmp41E="unsigned int",_tag_dyneither(_tmp41E,sizeof(char),13))));}return;_LLA2: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp9E=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp7F;if(_tmp9E->tag != 6)goto _LLA4;else{if(_tmp9E->f1 != Cyc_Absyn_Unsigned)goto _LLA4;if(_tmp9E->f2 != Cyc_Absyn_Long_sz)goto _LLA4;}}_LLA3:
...
{const char*_tmp420;Cyc_Absyndump_dump(((_tmp420="long long",_tag_dyneither(_tmp420,sizeof(char),10))));}return;case Cyc_Cyclone_Vc_c: _LLDD:
{const char*_tmp421;Cyc_Absyndump_dump(((_tmp421="__int64",_tag_dyneither(_tmp421,sizeof(char),8))));}return;}_LLA8: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmpA1=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp7F;if(_tmpA1->tag != 6)goto _LLAA;else{if(_tmpA1->f1 != Cyc_Absyn_Unsigned)goto _LLAA;if(_tmpA1->f2 != Cyc_Absyn_LongLong_sz)goto _LLAA;}}_LLA9:
# 530
 switch(Cyc_Cyclone_c_compiler){case Cyc_Cyclone_Vc_c: _LLDF:
{const char*_tmp422;Cyc_Absyndump_dump(((_tmp422="unsigned __int64",_tag_dyneither(_tmp422,sizeof(char),17))));}return;case Cyc_Cyclone_Gcc_c: _LLE0:
{const char*_tmp423;Cyc_Absyndump_dump(((_tmp423="unsigned long long",_tag_dyneither(_tmp423,sizeof(char),19))));}return;}_LLAA: {struct Cyc_Absyn_FloatType_Absyn_Type_struct*_tmpA2=(struct Cyc_Absyn_FloatType_Absyn_Type_struct*)_tmp7F;if(_tmpA2->tag != 7)goto _LLAC;else{_tmpA3=_tmpA2->f1;}}_LLAB:
# 535
 if(_tmpA3 == 0){
...
{const char*_tmp427;Cyc_Absyndump_dump(((_tmp427="enum ",_tag_dyneither(_tmp427,sizeof(char),6))));}Cyc_Absyndump_dumpqvar(_tmpAD);return;_LLB4: {struct Cyc_Absyn_AnonEnumType_Absyn_Type_struct*_tmpAE=(struct Cyc_Absyn_AnonEnumType_Absyn_Type_struct*)_tmp7F;if(_tmpAE->tag != 14)goto _LLB6;else{_tmpAF=_tmpAE->f1;}}_LLB5:
{const char*_tmp428;Cyc_Absyndump_dump(((_tmp428="enum {",_tag_dyneither(_tmp428,sizeof(char),7))));}Cyc_Absyndump_dumpenumfields(_tmpAF);{const char*_tmp429;Cyc_Absyndump_dump(((_tmp429="}",_tag_dyneither(_tmp429,sizeof(char),2))));}return;_LLB6: {struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmpB0=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp7F;if(_tmpB0->tag != 17)goto _LLB8;else{_tmpB1=_tmpB0->f1;_tmpB2=_tmpB0->f2;}}_LLB7:
...
{const char*_tmp42A;Cyc_Absyndump_dump(((_tmp42A="valueof_t(",_tag_dyneither(_tmp42A,sizeof(char),11))));}Cyc_Absyndump_dumpexp(_tmpB4);{const char*_tmp42B;Cyc_Absyndump_dump(((_tmp42B=")",_tag_dyneither(_tmp42B,sizeof(char),2))));}return;_LLBA: {struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct*_tmpB5=(struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct*)_tmp7F;if(_tmpB5->tag != 15)goto _LLBC;else{_tmpB6=(void*)_tmpB5->f1;}}_LLBB:
# 554
{const char*_tmp42C;Cyc_Absyndump_dump(((_tmp42C="region_t<",_tag_dyneither(_tmp42C,sizeof(char),10))));}Cyc_Absyndump_dumprgn(_tmpB6);{const char*_tmp42D;Cyc_Absyndump_dump(((_tmp42D=">",_tag_dyneither(_tmp42D,sizeof(char),2))));}return;_LLBC: {struct Cyc_Absyn_DynRgnType_Absyn_Type_struct*_tmpB7=(struct Cyc_Absyn_DynRgnType_Absyn_Type_struct*)_tmp7F;if(_tmpB7->tag != 16)goto _LLBE;else{_tmpB8=(void*)_tmpB7->f1;_tmpB9=(void*)_tmpB7->f2;}}_LLBD:
{const char*_tmp42E;Cyc_Absyndump_dump(((_tmp42E="dynregion_t<",_tag_dyneither(_tmp42E,sizeof(char),13))));}Cyc_Absyndump_dumprgn(_tmpB8);
{const char*_tmp42F;Cyc_Absyndump_dump(((_tmp42F=",",_tag_dyneither(_tmp42F,sizeof(char),2))));}Cyc_Absyndump_dumprgn(_tmpB9);{const char*_tmp430;Cyc_Absyndump_dump(((_tmp430=">",_tag_dyneither(_tmp430,sizeof(char),2))));}return;_LLBE: {struct Cyc_Absyn_TagType_Absyn_Type_struct*_tmpBA=(struct Cyc_Absyn_TagType_Absyn_Type_struct*)_tmp7F;if(_tmpBA->tag != 19)goto _LLC0;else{_tmpBB=(void*)_tmpBA->f1;}}_LLBF:
{const char*_tmp431;Cyc_Absyndump_dump(((_tmp431="tag_t<",_tag_dyneither(_tmp431,sizeof(char),7))));}Cyc_Absyndump_dumpntyp(_tmpBB);{const char*_tmp432;Cyc_Absyndump_dump(((_tmp432=">",_tag_dyneither(_tmp432,sizeof(char),2))));}return;_LLC0: {struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*_tmpBC=(struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*)_tmp7F;if(_tmpBC->tag != 21)goto _LLC2;}_LLC1:
{const char*_tmp433;Cyc_Absyndump_dump(((_tmp433="`U",_tag_dyneither(_tmp433,sizeof(char),3))));}goto _LL79;_LLC2: {struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*_tmpBD=(struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*)_tmp7F;if(_tmpBD->tag != 22)goto _LLC4;}_LLC3:
{const char*_tmp434;Cyc_Absyndump_dump(((_tmp434="`RC",_tag_dyneither(_tmp434,sizeof(char),4))));}goto _LL79;_LLC4: {struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*_tmpBE=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp7F;if(_tmpBE->tag != 26)goto _LLC6;else{struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*_tmpBF=(struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)(_tmpBE->f1)->r;if(_tmpBF->tag != 0)goto _LLC6;else{_tmpC0=_tmpBF->f1;}}}_LLC5:
# 561
...
{const char*_tmp435;Cyc_Absyndump_dump(((_tmp435="`H",_tag_dyneither(_tmp435,sizeof(char),3))));}goto _LL79;_LLCC: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmpC8=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmp7F;if(_tmpC8->tag != 23)goto _LLCE;else{_tmpC9=(void*)_tmpC8->f1;}}_LLCD:
{const char*_tmp436;Cyc_Absyndump_dump(((_tmp436="{",_tag_dyneither(_tmp436,sizeof(char),2))));}Cyc_Absyndump_dumptyp(_tmpC9);{const char*_tmp437;Cyc_Absyndump_dump(((_tmp437="}",_tag_dyneither(_tmp437,sizeof(char),2))));}goto _LL79;_LLCE: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmpCA=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmp7F;if(_tmpCA->tag != 25)goto _LLD0;else{_tmpCB=(void*)_tmpCA->f1;}}_LLCF:
{const char*_tmp438;Cyc_Absyndump_dump(((_tmp438="regions(",_tag_dyneither(_tmp438,sizeof(char),9))));}Cyc_Absyndump_dumptyp(_tmpCB);{const char*_tmp439;Cyc_Absyndump_dump(((_tmp439=")",_tag_dyneither(_tmp439,sizeof(char),2))));}goto _LL79;_LLD0: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmpCC=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmp7F;if(_tmpCC->tag != 24)goto _LL79;else{_tmpCD=_tmpCC->f1;}}_LLD1:
# 570
 for(0;_tmpCD != 0;_tmpCD=_tmpCD->tl){
Cyc_Absyndump_dumptyp((void*)_tmpCD->hd);
if(_tmpCD->tl != 0){const char*_tmp43A;Cyc_Absyndump_dump(((_tmp43A="+",_tag_dyneither(_tmp43A,sizeof(char),2))));}}_LL79:;}
# 577
...
const char*_tmp43B;((void(*)(void(*f)(struct _tuple16*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dump_rgncmp,rgn_po,((_tmp43B=",",_tag_dyneither(_tmp43B,sizeof(char),2))));}
# 590
...
# 598
if(c_varargs){
const char*_tmp43C;Cyc_Absyndump_dump(((_tmp43C="...",_tag_dyneither(_tmp43C,sizeof(char),4))));}else{
if(cyc_varargs != 0){
struct _tuple8*_tmp43D;struct _tuple8*_tmp112=(_tmp43D=_cycalloc(sizeof(*_tmp43D)),((_tmp43D->f1=cyc_varargs->name,((_tmp43D->f2=cyc_varargs->tq,((_tmp43D->f3=cyc_varargs->type,_tmp43D)))))));
{const char*_tmp43E;Cyc_Absyndump_dump(((_tmp43E="...",_tag_dyneither(_tmp43E,sizeof(char),4))));}
if(cyc_varargs->inject){const char*_tmp43F;Cyc_Absyndump_dump(((_tmp43F=" inject ",_tag_dyneither(_tmp43F,sizeof(char),9))));}
...
{const char*_tmp443;const char*_tmp442;const char*_tmp441;((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,(*de).f1,((_tmp441="",_tag_dyneither(_tmp441,sizeof(char),1))),((_tmp442="=",_tag_dyneither(_tmp442,sizeof(char),2))),((_tmp443="=",_tag_dyneither(_tmp443,sizeof(char),2))));}
Cyc_Absyndump_dumpexp((*de).f2);}
# 633
void Cyc_Absyndump_dumpexps_prec(int inprec,struct Cyc_List_List*es){
const char*_tmp446;const char*_tmp445;const char*_tmp444;((void(*)(void(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group_c)(Cyc_Absyndump_dumpexp_prec,inprec,es,((_tmp444="",_tag_dyneither(_tmp444,sizeof(char),1))),((_tmp445="",_tag_dyneither(_tmp445,sizeof(char),1))),((_tmp446=",",_tag_dyneither(_tmp446,sizeof(char),2))));}
# 637
void Cyc_Absyndump_dumpexp_prec(int inprec,struct Cyc_Absyn_Exp*e){
int myprec=Cyc_Absynpp_exp_prec(e);
if(inprec >= myprec){
const char*_tmp447;Cyc_Absyndump_dump_nospace(((_tmp447="(",_tag_dyneither(_tmp447,sizeof(char),2))));}
...
{const char*_tmp44B;void*_tmp44A[1];struct Cyc_String_pa_PrintArg_struct _tmp449;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp449.tag=0,((_tmp449.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp129),((_tmp44A[0]=& _tmp449,Cyc_aprintf(((_tmp44B="L'%s'",_tag_dyneither(_tmp44B,sizeof(char),6))),_tag_dyneither(_tmp44A,sizeof(void*),1)))))))));}goto _LLE7;_LLEC: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp12A=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp12A->tag != 0)goto _LLEE;else{if(((_tmp12A->f1).Short_c).tag != 4)goto _LLEE;_tmp12B=((struct _tuple4)((_tmp12A->f1).Short_c).val).f1;_tmp12C=((struct _tuple4)((_tmp12A->f1).Short_c).val).f2;}}_LLED:
{const char*_tmp44F;void*_tmp44E[1];struct Cyc_Int_pa_PrintArg_struct _tmp44D;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp44D.tag=1,((_tmp44D.f1=(unsigned long)((int)_tmp12C),((_tmp44E[0]=& _tmp44D,Cyc_aprintf(((_tmp44F="%d",_tag_dyneither(_tmp44F,sizeof(char),3))),_tag_dyneither(_tmp44E,sizeof(void*),1)))))))));}goto _LLE7;_LLEE: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp12D=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp12D->tag != 0)goto _LLF0;else{if(((_tmp12D->f1).Int_c).tag != 5)goto _LLF0;if(((struct _tuple5)((_tmp12D->f1).Int_c).val).f1 != Cyc_Absyn_None)goto _LLF0;_tmp12E=((struct _tuple5)((_tmp12D->f1).Int_c).val).f2;}}_LLEF:
...
{const char*_tmp453;void*_tmp452[1];struct Cyc_Int_pa_PrintArg_struct _tmp451;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp451.tag=1,((_tmp451.f1=(unsigned long)_tmp130,((_tmp452[0]=& _tmp451,Cyc_aprintf(((_tmp453="%d",_tag_dyneither(_tmp453,sizeof(char),3))),_tag_dyneither(_tmp452,sizeof(void*),1)))))))));}goto _LLE7;_LLF2: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp131=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp131->tag != 0)goto _LLF4;else{if(((_tmp131->f1).Int_c).tag != 5)goto _LLF4;if(((struct _tuple5)((_tmp131->f1).Int_c).val).f1 != Cyc_Absyn_Unsigned)goto _LLF4;_tmp132=((struct _tuple5)((_tmp131->f1).Int_c).val).f2;}}_LLF3:
{const char*_tmp457;void*_tmp456[1];struct Cyc_Int_pa_PrintArg_struct _tmp455;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp455.tag=1,((_tmp455.f1=(unsigned int)_tmp132,((_tmp456[0]=& _tmp455,Cyc_aprintf(((_tmp457="%u",_tag_dyneither(_tmp457,sizeof(char),3))),_tag_dyneither(_tmp456,sizeof(void*),1)))))))));}goto _LLE7;_LLF4: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp133=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp133->tag != 0)goto _LLF6;else{if(((_tmp133->f1).LongLong_c).tag != 6)goto _LLF6;_tmp134=((struct _tuple6)((_tmp133->f1).LongLong_c).val).f1;_tmp135=((struct _tuple6)((_tmp133->f1).LongLong_c).val).f2;}}_LLF5:
# 651
{const char*_tmp458;Cyc_Absyndump_dump(((_tmp458="<<FIX LONG LONG CONSTANT>>",_tag_dyneither(_tmp458,sizeof(char),27))));}goto _LLE7;_LLF6: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp136=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp136->tag != 0)goto _LLF8;else{if(((_tmp136->f1).Float_c).tag != 7)goto _LLF8;_tmp137=((struct _tuple7)((_tmp136->f1).Float_c).val).f1;}}_LLF7:
...
# 658
{const char*_tmp45A;Cyc_Absyndump_dump(((_tmp45A="L\"",_tag_dyneither(_tmp45A,sizeof(char),3))));}Cyc_Absyndump_dump_nospace(_tmp13C);Cyc_Absyndump_dump_char((int)'"');
...
{const char*_tmp45B;Cyc_Absyndump_dump(((_tmp45B="numelts(",_tag_dyneither(_tmp45B,sizeof(char),9))));}
Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp141))->hd);{
const char*_tmp45C;Cyc_Absyndump_dump(((_tmp45C=")",_tag_dyneither(_tmp45C,sizeof(char),2))));};}else{
# 672
...
# 683
struct Cyc_Core_Failure_exn_struct _tmp462;const char*_tmp461;struct Cyc_Core_Failure_exn_struct*_tmp460;(int)_throw((void*)((_tmp460=_cycalloc(sizeof(*_tmp460)),((_tmp460[0]=((_tmp462.tag=Cyc_Core_Failure,((_tmp462.f1=((_tmp461="Absyndump -- Bad number of arguments to primop",_tag_dyneither(_tmp461,sizeof(char),47))),_tmp462)))),_tmp460)))));}}}
# 685
...
{const char*_tmp463;Cyc_Absyndump_dump_nospace(((_tmp463="=",_tag_dyneither(_tmp463,sizeof(char),2))));}
...
# 695
{const char*_tmp464;Cyc_Absyndump_dump(((_tmp464="++",_tag_dyneither(_tmp464,sizeof(char),3))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp147);goto _LLE7;_LL106: {struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp148=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp148->tag != 4)goto _LL108;else{_tmp149=_tmp148->f1;if(_tmp148->f2 != Cyc_Absyn_PreDec)goto _LL108;}}_LL107:
{const char*_tmp465;Cyc_Absyndump_dump(((_tmp465="--",_tag_dyneither(_tmp465,sizeof(char),3))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp149);goto _LLE7;_LL108: {struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp14A=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp14A->tag != 4)goto _LL10A;else{_tmp14B=_tmp14A->f1;if(_tmp14A->f2 != Cyc_Absyn_PostInc)goto _LL10A;}}_LL109:
 Cyc_Absyndump_dumpexp_prec(myprec,_tmp14B);{const char*_tmp466;Cyc_Absyndump_dump(((_tmp466="++",_tag_dyneither(_tmp466,sizeof(char),3))));}goto _LLE7;_LL10A: {struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp14C=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp14C->tag != 4)goto _LL10C;else{_tmp14D=_tmp14C->f1;if(_tmp14C->f2 != Cyc_Absyn_PostDec)goto _LL10C;}}_LL10B:
 Cyc_Absyndump_dumpexp_prec(myprec,_tmp14D);{const char*_tmp467;Cyc_Absyndump_dump(((_tmp467="--",_tag_dyneither(_tmp467,sizeof(char),3))));}goto _LLE7;_LL10C: {struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_tmp14E=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp14E->tag != 5)goto _LL10E;else{_tmp14F=_tmp14E->f1;_tmp150=_tmp14E->f2;_tmp151=_tmp14E->f3;}}_LL10D:
# 701
...
# 708
 Cyc_Absyndump_dumploc(e->loc);
Cyc_Absyndump_dumpexp_prec(myprec,_tmp153);{const char*_tmp468;Cyc_Absyndump_dump(((_tmp468=" && ",_tag_dyneither(_tmp468,sizeof(char),5))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp154);goto _LLE7;_LL110: {struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_tmp155=(struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp155->tag != 7)goto _LL112;else{_tmp156=_tmp155->f1;_tmp157=_tmp155->f2;}}_LL111:
# 712
 Cyc_Absyndump_dumploc(e->loc);
Cyc_Absyndump_dumpexp_prec(myprec,_tmp156);{const char*_tmp469;Cyc_Absyndump_dump(((_tmp469=" || ",_tag_dyneither(_tmp469,sizeof(char),5))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp157);goto _LLE7;_LL112: {struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_tmp158=(struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp158->tag != 8)goto _LL114;else{_tmp159=_tmp158->f1;_tmp15A=_tmp158->f2;}}_LL113:
# 718
 Cyc_Absyndump_dumploc(e->loc);
Cyc_Absyndump_dump_char((int)'(');
...
{const char*_tmp46B;Cyc_Absyndump_dump_nospace(((_tmp46B=")",_tag_dyneither(_tmp46B,sizeof(char),2))));}
...
# 754
{const char*_tmp46D;Cyc_Absyndump_dump(((_tmp46D="new ",_tag_dyneither(_tmp46D,sizeof(char),5))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp16B);goto _LLE7;_LL122: {struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*_tmp16C=(struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp16C->tag != 16)goto _LL124;else{_tmp16D=(void*)_tmp16C->f1;}}_LL123:
# 757
{const char*_tmp46E;Cyc_Absyndump_dump(((_tmp46E="sizeof(",_tag_dyneither(_tmp46E,sizeof(char),8))));}Cyc_Absyndump_dumptyp(_tmp16D);Cyc_Absyndump_dump_char((int)')');goto _LLE7;_LL124: {struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*_tmp16E=(struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp16E->tag != 17)goto _LL126;else{_tmp16F=_tmp16E->f1;}}_LL125:
# 760
{const char*_tmp46F;Cyc_Absyndump_dump(((_tmp46F="sizeof(",_tag_dyneither(_tmp46F,sizeof(char),8))));}Cyc_Absyndump_dumpexp(_tmp16F);Cyc_Absyndump_dump_char((int)')');goto _LLE7;_LL126: {struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp170=(struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp170->tag != 38)goto _LL128;else{_tmp171=(void*)_tmp170->f1;}}_LL127:
# 763
{const char*_tmp470;Cyc_Absyndump_dump(((_tmp470="valueof(",_tag_dyneither(_tmp470,sizeof(char),9))));}Cyc_Absyndump_dumptyp(_tmp171);Cyc_Absyndump_dump_char((int)')');goto _LLE7;_LL128: {struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*_tmp172=(struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp172->tag != 39)goto _LL12A;else{_tmp173=_tmp172->f1;_tmp174=_tmp172->f2;}}_LL129:
# 766
{const char*_tmp471;Cyc_Absyndump_dump(((_tmp471="__asm__",_tag_dyneither(_tmp471,sizeof(char),8))));}
if(_tmp173){const char*_tmp472;Cyc_Absyndump_dump(((_tmp472=" volatile ",_tag_dyneither(_tmp472,sizeof(char),11))));}
Cyc_Absyndump_dump_char((int)'(');
...
# 774
{const char*_tmp473;Cyc_Absyndump_dump(((_tmp473="tagcheck(",_tag_dyneither(_tmp473,sizeof(char),10))));}Cyc_Absyndump_dumpexp(_tmp176);Cyc_Absyndump_dump_char((int)'.');Cyc_Absyndump_dump_nospace(*_tmp177);
Cyc_Absyndump_dump_char((int)')');
...
# 779
{const char*_tmp474;Cyc_Absyndump_dump(((_tmp474="offsetof(",_tag_dyneither(_tmp474,sizeof(char),10))));}Cyc_Absyndump_dumptyp(_tmp179);Cyc_Absyndump_dump_char((int)',');
...
# 786
{const char*_tmp478;void*_tmp477[1];struct Cyc_Int_pa_PrintArg_struct _tmp476;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp476.tag=1,((_tmp476.f1=(unsigned long)((int)_tmp1DB),((_tmp477[0]=& _tmp476,Cyc_aprintf(((_tmp478="%d",_tag_dyneither(_tmp478,sizeof(char),3))),_tag_dyneither(_tmp477,sizeof(void*),1)))))))));}
goto _LL156;_LL156:;}
# 789
...
# 802
 Cyc_Absyndump_dumpexp_prec(myprec,_tmp181);{const char*_tmp479;Cyc_Absyndump_dump_nospace(((_tmp479="->",_tag_dyneither(_tmp479,sizeof(char),3))));}Cyc_Absyndump_dump_nospace(*_tmp182);
...
# 810
{const char*_tmp47A;Cyc_Absyndump_dump(((_tmp47A="$(",_tag_dyneither(_tmp47A,sizeof(char),3))));}Cyc_Absyndump_dumpexps_prec(20,_tmp187);Cyc_Absyndump_dump_char((int)')');goto _LLE7;_LL138: {struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*_tmp188=(struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp124;if(_tmp188->tag != 24)goto _LL13A;else{_tmp189=_tmp188->f1;_tmp18A=_tmp188->f2;}}_LL139:
# 813
 Cyc_Absyndump_dump_char((int)'(');
Cyc_Absyndump_dumptyp((*_tmp189).f3);
Cyc_Absyndump_dump_char((int)')');
{const char*_tmp47D;const char*_tmp47C;const char*_tmp47B;((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp18A,((_tmp47B="{",_tag_dyneither(_tmp47B,sizeof(char),2))),((_tmp47C="}",_tag_dyneither(_tmp47C,sizeof(char),2))),((_tmp47D=",",_tag_dyneither(_tmp47D,sizeof(char),2))));}
...
# 820
{const char*_tmp480;const char*_tmp47F;const char*_tmp47E;((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp18C,((_tmp47E="{",_tag_dyneither(_tmp47E,sizeof(char),2))),((_tmp47F="}",_tag_dyneither(_tmp47F,sizeof(char),2))),((_tmp480=",",_tag_dyneither(_tmp480,sizeof(char),2))));}
...
# 824
{const char*_tmp481;Cyc_Absyndump_dump(((_tmp481="{for",_tag_dyneither(_tmp481,sizeof(char),5))));}Cyc_Absyndump_dump_str((*_tmp18E->name).f2);Cyc_Absyndump_dump_char((int)'<');Cyc_Absyndump_dumpexp(_tmp18F);
...
# 829
{const char*_tmp482;Cyc_Absyndump_dump(((_tmp482="{for x ",_tag_dyneither(_tmp482,sizeof(char),8))));}Cyc_Absyndump_dump_char((int)'<');Cyc_Absyndump_dumpexp(_tmp192);
...
{const char*_tmp485;const char*_tmp484;const char*_tmp483;((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp197,((_tmp483="",_tag_dyneither(_tmp483,sizeof(char),1))),((_tmp484="}",_tag_dyneither(_tmp484,sizeof(char),2))),((_tmp485=",",_tag_dyneither(_tmp485,sizeof(char),2))));}
...
# 842
{const char*_tmp488;const char*_tmp487;const char*_tmp486;((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp199,((_tmp486="{",_tag_dyneither(_tmp486,sizeof(char),2))),((_tmp487="}",_tag_dyneither(_tmp487,sizeof(char),2))),((_tmp488=",",_tag_dyneither(_tmp488,sizeof(char),2))));}
...
if(_tmp19B != 0){const char*_tmp48B;const char*_tmp48A;const char*_tmp489;((void(*)(void(*f)(struct Cyc_Absyn_Exp*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpexp,_tmp19B,((_tmp489="(",_tag_dyneither(_tmp489,sizeof(char),2))),((_tmp48A=")",_tag_dyneither(_tmp48A,sizeof(char),2))),((_tmp48B=",",_tag_dyneither(_tmp48B,sizeof(char),2))));}
...
if(_tmp1A2){
if(_tmp1A3 != 0){
{const char*_tmp48C;Cyc_Absyndump_dump(((_tmp48C="rcalloc(",_tag_dyneither(_tmp48C,sizeof(char),9))));}
Cyc_Absyndump_dumpexp(_tmp1A3);{const char*_tmp48D;Cyc_Absyndump_dump(((_tmp48D=",",_tag_dyneither(_tmp48D,sizeof(char),2))));};}else{
# 860
const char*_tmp48E;Cyc_Absyndump_dump(((_tmp48E="calloc",_tag_dyneither(_tmp48E,sizeof(char),7))));}
# 862
Cyc_Absyndump_dumpexp(_tmp1A5);
{const char*_tmp48F;Cyc_Absyndump_dump(((_tmp48F=",",_tag_dyneither(_tmp48F,sizeof(char),2))));}
Cyc_Absyndump_dumpexp(Cyc_Absyn_sizeoftyp_exp(*((void**)_check_null(_tmp1A4)),0));{
const char*_tmp490;Cyc_Absyndump_dump(((_tmp490=")",_tag_dyneither(_tmp490,sizeof(char),2))));};}else{
# 867
if(_tmp1A3 != 0){
{const char*_tmp491;Cyc_Absyndump_dump(((_tmp491="rmalloc(",_tag_dyneither(_tmp491,sizeof(char),9))));}
Cyc_Absyndump_dumpexp(_tmp1A3);{const char*_tmp492;Cyc_Absyndump_dump(((_tmp492=",",_tag_dyneither(_tmp492,sizeof(char),2))));};}else{
# 871
const char*_tmp493;Cyc_Absyndump_dump(((_tmp493="malloc(",_tag_dyneither(_tmp493,sizeof(char),8))));}
# 874
if(_tmp1A4 != 0)
Cyc_Absyndump_dumpexp(Cyc_Absyn_times_exp(Cyc_Absyn_sizeoftyp_exp(*_tmp1A4,0),_tmp1A5,0));else{
# 877
Cyc_Absyndump_dumpexp(_tmp1A5);}{
const char*_tmp494;Cyc_Absyndump_dump(((_tmp494=")",_tag_dyneither(_tmp494,sizeof(char),2))));};}
# 880
...
{const char*_tmp495;Cyc_Absyndump_dump_nospace(((_tmp495=":=:",_tag_dyneither(_tmp495,sizeof(char),4))));}
...
# 890
{const char*_tmp498;const char*_tmp497;const char*_tmp496;((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp1AB,((_tmp496="{",_tag_dyneither(_tmp496,sizeof(char),2))),((_tmp497="}",_tag_dyneither(_tmp497,sizeof(char),2))),((_tmp498=",",_tag_dyneither(_tmp498,sizeof(char),2))));}
...
# 894
{const char*_tmp499;Cyc_Absyndump_dump_nospace(((_tmp499="({",_tag_dyneither(_tmp499,sizeof(char),3))));}
Cyc_Absyndump_dumpstmt(_tmp1AD,1);
{const char*_tmp49A;Cyc_Absyndump_dump_nospace(((_tmp49A="})",_tag_dyneither(_tmp49A,sizeof(char),3))));}
goto _LLE7;_LLE7:;}
# 899
if(inprec >= myprec)
Cyc_Absyndump_dump_char((int)')');}
...
const char*_tmp49B;Cyc_Absyndump_dump(((_tmp49B="default:",_tag_dyneither(_tmp49B,sizeof(char),9))));}else{
# 913
{const char*_tmp49C;Cyc_Absyndump_dump(((_tmp49C="case",_tag_dyneither(_tmp49C,sizeof(char),5))));}
Cyc_Absyndump_dumppat(_tmp201->pattern);
if(_tmp201->where_clause != 0){
{const char*_tmp49D;Cyc_Absyndump_dump(((_tmp49D="&&",_tag_dyneither(_tmp49D,sizeof(char),3))));}
Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_check_null(_tmp201->where_clause));}{
# 919
const char*_tmp49E;Cyc_Absyndump_dump_nospace(((_tmp49E=":",_tag_dyneither(_tmp49E,sizeof(char),2))));};}
# 921
...
{const char*_tmp49F;Cyc_Absyndump_dump(((_tmp49F="return;",_tag_dyneither(_tmp49F,sizeof(char),8))));}goto _LL15B;_LL164: {struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*_tmp20F=(struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp207;if(_tmp20F->tag != 3)goto _LL166;else{_tmp210=_tmp20F->f1;}}_LL165:
{const char*_tmp4A0;Cyc_Absyndump_dump(((_tmp4A0="return",_tag_dyneither(_tmp4A0,sizeof(char),7))));}Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_check_null(_tmp210));Cyc_Absyndump_dump_semi();goto _LL15B;_LL166: {struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*_tmp211=(struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp207;if(_tmp211->tag != 4)goto _LL168;else{_tmp212=_tmp211->f1;_tmp213=_tmp211->f2;_tmp214=_tmp211->f3;}}_LL167:
# 949
{const char*_tmp4A1;Cyc_Absyndump_dump(((_tmp4A1="if(",_tag_dyneither(_tmp4A1,sizeof(char),4))));}Cyc_Absyndump_dumpexp(_tmp212);
...
{const char*_tmp4A2;Cyc_Absyndump_dump_nospace(((_tmp4A2="){",_tag_dyneither(_tmp4A2,sizeof(char),3))));}Cyc_Absyndump_dumpstmt(_tmp213,0);Cyc_Absyndump_dump_char((int)'}');goto _LL182;_LL18B:;_LL18C:
...
{const char*_tmp4A3;Cyc_Absyndump_dump(((_tmp4A3="else{",_tag_dyneither(_tmp4A3,sizeof(char),6))));}Cyc_Absyndump_dumpstmt(_tmp214,0);Cyc_Absyndump_dump_char((int)'}');goto _LL18D;_LL18D:;}
# 961
...
# 963
{const char*_tmp4A4;Cyc_Absyndump_dump(((_tmp4A4="while(",_tag_dyneither(_tmp4A4,sizeof(char),7))));}Cyc_Absyndump_dumpexp(_tmp216);{const char*_tmp4A5;Cyc_Absyndump_dump_nospace(((_tmp4A5="){",_tag_dyneither(_tmp4A5,sizeof(char),3))));}
...
{const char*_tmp4A6;Cyc_Absyndump_dump(((_tmp4A6="break;",_tag_dyneither(_tmp4A6,sizeof(char),7))));}goto _LL15B;_LL16C: {struct Cyc_Absyn_Continue_s_Absyn_Raw_stmt_struct*_tmp219=(struct Cyc_Absyn_Continue_s_Absyn_Raw_stmt_struct*)_tmp207;if(_tmp219->tag != 7)goto _LL16E;}_LL16D:
{const char*_tmp4A7;Cyc_Absyndump_dump(((_tmp4A7="continue;",_tag_dyneither(_tmp4A7,sizeof(char),10))));}goto _LL15B;_LL16E: {struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*_tmp21A=(struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*)_tmp207;if(_tmp21A->tag != 8)goto _LL170;else{_tmp21B=_tmp21A->f1;}}_LL16F:
{const char*_tmp4A8;Cyc_Absyndump_dump(((_tmp4A8="goto",_tag_dyneither(_tmp4A8,sizeof(char),5))));}Cyc_Absyndump_dump_str(_tmp21B);Cyc_Absyndump_dump_semi();goto _LL15B;_LL170: {struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*_tmp21C=(struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp207;if(_tmp21C->tag != 9)goto _LL172;else{_tmp21D=_tmp21C->f1;_tmp21E=(_tmp21C->f2).f1;_tmp21F=(_tmp21C->f3).f1;_tmp220=_tmp21C->f4;}}_LL171:
# 972
{const char*_tmp4A9;Cyc_Absyndump_dump(((_tmp4A9="for(",_tag_dyneither(_tmp4A9,sizeof(char),5))));}Cyc_Absyndump_dumpexp(_tmp21D);Cyc_Absyndump_dump_semi();Cyc_Absyndump_dumpexp(_tmp21E);Cyc_Absyndump_dump_semi();Cyc_Absyndump_dumpexp(_tmp21F);
{const char*_tmp4AA;Cyc_Absyndump_dump_nospace(((_tmp4AA="){",_tag_dyneither(_tmp4AA,sizeof(char),3))));}Cyc_Absyndump_dumpstmt(_tmp220,0);Cyc_Absyndump_dump_char((int)'}');
...
# 976
{const char*_tmp4AB;Cyc_Absyndump_dump(((_tmp4AB="switch(",_tag_dyneither(_tmp4AB,sizeof(char),8))));}Cyc_Absyndump_dumpexp(_tmp222);{const char*_tmp4AC;Cyc_Absyndump_dump_nospace(((_tmp4AC="){",_tag_dyneither(_tmp4AC,sizeof(char),3))));}
...
if(expstmt){const char*_tmp4AD;Cyc_Absyndump_dump_nospace(((_tmp4AD=": ({",_tag_dyneither(_tmp4AD,sizeof(char),5))));}else{const char*_tmp4AE;Cyc_Absyndump_dump_nospace(((_tmp4AE=": {",_tag_dyneither(_tmp4AE,sizeof(char),4))));}
Cyc_Absyndump_dumpstmt(_tmp229,expstmt);
if(expstmt){const char*_tmp4AF;Cyc_Absyndump_dump_nospace(((_tmp4AF="});}",_tag_dyneither(_tmp4AF,sizeof(char),5))));}else{Cyc_Absyndump_dump_char((int)'}');}}else{
# 993
...
# 998
{const char*_tmp4B0;Cyc_Absyndump_dump(((_tmp4B0="do{",_tag_dyneither(_tmp4B0,sizeof(char),4))));}Cyc_Absyndump_dumpstmt(_tmp22B,0);
{const char*_tmp4B1;Cyc_Absyndump_dump_nospace(((_tmp4B1="}while(",_tag_dyneither(_tmp4B1,sizeof(char),8))));}Cyc_Absyndump_dumpexp(_tmp22C);{const char*_tmp4B2;Cyc_Absyndump_dump_nospace(((_tmp4B2=");",_tag_dyneither(_tmp4B2,sizeof(char),3))));}
...
# 1002
{const char*_tmp4B3;Cyc_Absyndump_dump(((_tmp4B3="fallthru;",_tag_dyneither(_tmp4B3,sizeof(char),10))));}goto _LL15B;_LL17C: {struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*_tmp22E=(struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp207;if(_tmp22E->tag != 11)goto _LL17E;else{_tmp22F=_tmp22E->f1;}}_LL17D:
# 1004
{const char*_tmp4B4;Cyc_Absyndump_dump(((_tmp4B4="fallthru(",_tag_dyneither(_tmp4B4,sizeof(char),10))));}Cyc_Absyndump_dumpexps_prec(20,_tmp22F);{const char*_tmp4B5;Cyc_Absyndump_dump_nospace(((_tmp4B5=");",_tag_dyneither(_tmp4B5,sizeof(char),3))));}goto _LL15B;_LL17E: {struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*_tmp230=(struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*)_tmp207;if(_tmp230->tag != 15)goto _LL180;else{_tmp231=_tmp230->f1;_tmp232=_tmp230->f2;}}_LL17F:
# 1007
{const char*_tmp4B6;Cyc_Absyndump_dump(((_tmp4B6="try",_tag_dyneither(_tmp4B6,sizeof(char),4))));}Cyc_Absyndump_dumpstmt(_tmp231,0);
{const char*_tmp4B7;Cyc_Absyndump_dump(((_tmp4B7="catch{",_tag_dyneither(_tmp4B7,sizeof(char),7))));}
...
# 1013
{const char*_tmp4B8;Cyc_Absyndump_dump(((_tmp4B8="reset_region(",_tag_dyneither(_tmp4B8,sizeof(char),14))));}Cyc_Absyndump_dumpexp(_tmp234);{const char*_tmp4B9;Cyc_Absyndump_dump(((_tmp4B9=");",_tag_dyneither(_tmp4B9,sizeof(char),3))));}
...
{const char*_tmp4BC;const char*_tmp4BB;const char*_tmp4BA;((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,(*dp).f1,((_tmp4BA="",_tag_dyneither(_tmp4BA,sizeof(char),1))),((_tmp4BB="=",_tag_dyneither(_tmp4BB,sizeof(char),2))),((_tmp4BC="=",_tag_dyneither(_tmp4BC,sizeof(char),2))));}
...
{const char*_tmp4BD;Cyc_Absyndump_dump(((_tmp4BD="NULL",_tag_dyneither(_tmp4BD,sizeof(char),5))));}goto _LL192;_LL197: {struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmp260=(struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp25D;if(_tmp260->tag != 10)goto _LL199;else{if(_tmp260->f1 != Cyc_Absyn_None)goto _LL199;_tmp261=_tmp260->f2;}}_LL198:
...
{const char*_tmp4C1;void*_tmp4C0[1];struct Cyc_Int_pa_PrintArg_struct _tmp4BF;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp4BF.tag=1,((_tmp4BF.f1=(unsigned long)_tmp263,((_tmp4C0[0]=& _tmp4BF,Cyc_aprintf(((_tmp4C1="%d",_tag_dyneither(_tmp4C1,sizeof(char),3))),_tag_dyneither(_tmp4C0,sizeof(void*),1)))))))));}goto _LL192;_LL19B: {struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmp264=(struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp25D;if(_tmp264->tag != 10)goto _LL19D;else{if(_tmp264->f1 != Cyc_Absyn_Unsigned)goto _LL19D;_tmp265=_tmp264->f2;}}_LL19C:
{const char*_tmp4C5;void*_tmp4C4[1];struct Cyc_Int_pa_PrintArg_struct _tmp4C3;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp4C3.tag=1,((_tmp4C3.f1=(unsigned int)_tmp265,((_tmp4C4[0]=& _tmp4C3,Cyc_aprintf(((_tmp4C5="%u",_tag_dyneither(_tmp4C5,sizeof(char),3))),_tag_dyneither(_tmp4C4,sizeof(void*),1)))))))));}goto _LL192;_LL19D: {struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*_tmp266=(struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp25D;if(_tmp266->tag != 11)goto _LL19F;else{_tmp267=_tmp266->f1;}}_LL19E:
# 1032
{const char*_tmp4C6;Cyc_Absyndump_dump(((_tmp4C6="'",_tag_dyneither(_tmp4C6,sizeof(char),2))));}Cyc_Absyndump_dump_nospace(Cyc_Absynpp_char_escape(_tmp267));{const char*_tmp4C7;Cyc_Absyndump_dump_nospace(((_tmp4C7="'",_tag_dyneither(_tmp4C7,sizeof(char),2))));}goto _LL192;_LL19F: {struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*_tmp268=(struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp25D;if(_tmp268->tag != 12)goto _LL1A1;else{_tmp269=_tmp268->f1;}}_LL1A0:
 ...
 Cyc_Absyndump_dumpqvar(_tmp26E->name);{const char*_tmp4C8;Cyc_Absyndump_dump(((_tmp4C8=" as ",_tag_dyneither(_tmp4C8,sizeof(char),5))));}Cyc_Absyndump_dumppat(_tmp26F);goto _LL192;_LL1A5: {struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*_tmp270=(struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp25D;if(_tmp270->tag != 2)goto _LL1A7;else{_tmp271=_tmp270->f1;_tmp272=_tmp270->f2;}}_LL1A6:
# 1037
{const char*_tmp4C9;Cyc_Absyndump_dump(((_tmp4C9="alias",_tag_dyneither(_tmp4C9,sizeof(char),6))));}
{const char*_tmp4CA;Cyc_Absyndump_dump(((_tmp4CA="<",_tag_dyneither(_tmp4CA,sizeof(char),2))));}Cyc_Absyndump_dumptvar(_tmp271);{const char*_tmp4CB;Cyc_Absyndump_dump(((_tmp4CB=">",_tag_dyneither(_tmp4CB,sizeof(char),2))));}
...
# 1042
const char*_tmp4CD;const char*_tmp4CC;struct _dyneither_ptr term=_tmp275?(_tmp4CD=", ...)",_tag_dyneither(_tmp4CD,sizeof(char),7)):((_tmp4CC=")",_tag_dyneither(_tmp4CC,sizeof(char),2)));
{const char*_tmp4CF;const char*_tmp4CE;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp274,((_tmp4CE="$(",_tag_dyneither(_tmp4CE,sizeof(char),3))),term,((_tmp4CF=",",_tag_dyneither(_tmp4CF,sizeof(char),2))));}goto _LL192;}_LL1A9: {struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*_tmp276=(struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp25D;if(_tmp276->tag != 6)goto _LL1AB;else{_tmp277=_tmp276->f1;}}_LL1AA:
{const char*_tmp4D0;Cyc_Absyndump_dump(((_tmp4D0="&",_tag_dyneither(_tmp4D0,sizeof(char),2))));}Cyc_Absyndump_dumppat(_tmp277);goto _LL192;_LL1AB: {struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*_tmp278=(struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp25D;if(_tmp278->tag != 3)goto _LL1AD;else{_tmp279=_tmp278->f1;{struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*_tmp27A=(struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*)(_tmp278->f2)->r;if(_tmp27A->tag != 0)goto _LL1AD;};}}_LL1AC:
# 1046
{const char*_tmp4D1;Cyc_Absyndump_dump(((_tmp4D1="*",_tag_dyneither(_tmp4D1,sizeof(char),2))));}Cyc_Absyndump_dumpqvar(_tmp279->name);goto _LL192;_LL1AD: {struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*_tmp27B=(struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp25D;if(_tmp27B->tag != 3)goto _LL1AF;else{_tmp27C=_tmp27B->f1;_tmp27D=_tmp27B->f2;}}_LL1AE:
# 1048
{const char*_tmp4D2;Cyc_Absyndump_dump(((_tmp4D2="*",_tag_dyneither(_tmp4D2,sizeof(char),2))));}Cyc_Absyndump_dumpqvar(_tmp27C->name);{const char*_tmp4D3;Cyc_Absyndump_dump(((_tmp4D3=" as ",_tag_dyneither(_tmp4D3,sizeof(char),5))));}Cyc_Absyndump_dumppat(_tmp27D);goto _LL192;_LL1AF: {struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*_tmp27E=(struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp25D;if(_tmp27E->tag != 4)goto _LL1B1;else{_tmp27F=_tmp27E->f1;_tmp280=_tmp27E->f2;}}_LL1B0:
# 1050
...
# 1053
const char*_tmp4D5;const char*_tmp4D4;struct _dyneither_ptr term=_tmp286?(_tmp4D5=", ...)",_tag_dyneither(_tmp4D5,sizeof(char),7)):((_tmp4D4=")",_tag_dyneither(_tmp4D4,sizeof(char),2)));
Cyc_Absyndump_dumpqvar(_tmp284);{const char*_tmp4D7;const char*_tmp4D6;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp285,((_tmp4D6="(",_tag_dyneither(_tmp4D6,sizeof(char),2))),term,((_tmp4D7=",",_tag_dyneither(_tmp4D7,sizeof(char),2))));}goto _LL192;}_LL1B5: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp287=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp25D;if(_tmp287->tag != 7)goto _LL1B7;else{if(_tmp287->f1 == 0)goto _LL1B7;_tmp288=(_tmp287->f1)->aggr_info;_tmp289=_tmp287->f2;_tmp28A=_tmp287->f3;_tmp28B=_tmp287->f4;}}_LL1B6: {
# 1056
...
const char*_tmp4D9;const char*_tmp4D8;struct _dyneither_ptr term=_tmp28B?(_tmp4D9=", ...)",_tag_dyneither(_tmp4D9,sizeof(char),7)):((_tmp4D8=")",_tag_dyneither(_tmp4D8,sizeof(char),2)));
Cyc_Absyndump_dumpqvar(_tmp2B5);Cyc_Absyndump_dump_char((int)'{');
{const char*_tmp4DC;const char*_tmp4DB;const char*_tmp4DA;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp289,((_tmp4DA="[",_tag_dyneither(_tmp4DA,sizeof(char),2))),((_tmp4DB="]",_tag_dyneither(_tmp4DB,sizeof(char),2))),((_tmp4DC=",",_tag_dyneither(_tmp4DC,sizeof(char),2))));}
{const char*_tmp4DE;const char*_tmp4DD;((void(*)(void(*f)(struct _tuple18*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpdp,_tmp28A,((_tmp4DD="",_tag_dyneither(_tmp4DD,sizeof(char),1))),term,((_tmp4DE=",",_tag_dyneither(_tmp4DE,sizeof(char),2))));}
...
# 1069
const char*_tmp4E7;const char*_tmp4E6;struct _dyneither_ptr term=_tmp293?(_tmp4E7=", ...)",_tag_dyneither(_tmp4E7,sizeof(char),7)):((_tmp4E6=")",_tag_dyneither(_tmp4E6,sizeof(char),2)));
Cyc_Absyndump_dumpqvar(_tmp291->name);
if(_tmp292 != 0){const char*_tmp4E9;const char*_tmp4E8;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp292,((_tmp4E8="(",_tag_dyneither(_tmp4E8,sizeof(char),2))),term,((_tmp4E9=",",_tag_dyneither(_tmp4E9,sizeof(char),2))));}
...
const char*_tmp4EA;((void(*)(void(*f)(struct Cyc_Absyn_Datatypefield*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpdatatypefield,fields,((_tmp4EA=",",_tag_dyneither(_tmp4EA,sizeof(char),2))));}
# 1087
void Cyc_Absyndump_dumpenumfield(struct Cyc_Absyn_Enumfield*ef){
Cyc_Absyndump_dumpqvar(ef->name);
if(ef->tag != 0){
{const char*_tmp4EB;Cyc_Absyndump_dump(((_tmp4EB=" = ",_tag_dyneither(_tmp4EB,sizeof(char),4))));}
Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_check_null(ef->tag));}}
# 1094
void Cyc_Absyndump_dumpenumfields(struct Cyc_List_List*fields){
const char*_tmp4EC;((void(*)(void(*f)(struct Cyc_Absyn_Enumfield*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpenumfield,fields,((_tmp4EC=",",_tag_dyneither(_tmp4EC,sizeof(char),2))));}
# 1098
void Cyc_Absyndump_dumpaggrfields(struct Cyc_List_List*fields){
...
{const char*_tmp4ED;Cyc_Absyndump_dump(((_tmp4ED="@requires ",_tag_dyneither(_tmp4ED,sizeof(char),11))));}
...
{const char*_tmp4EE;Cyc_Absyndump_dump(((_tmp4EE="_stdcall",_tag_dyneither(_tmp4EE,sizeof(char),9))));}goto _LL1C4;_LL1C9: {struct Cyc_Absyn_Cdecl_att_Absyn_Attribute_struct*_tmp2D8=(struct Cyc_Absyn_Cdecl_att_Absyn_Attribute_struct*)_tmp2D5;if(_tmp2D8->tag != 2)goto _LL1CB;}_LL1CA:
{const char*_tmp4EF;Cyc_Absyndump_dump(((_tmp4EF="_cdecl",_tag_dyneither(_tmp4EF,sizeof(char),7))));}goto _LL1C4;_LL1CB: {struct Cyc_Absyn_Fastcall_att_Absyn_Attribute_struct*_tmp2D9=(struct Cyc_Absyn_Fastcall_att_Absyn_Attribute_struct*)_tmp2D5;if(_tmp2D9->tag != 3)goto _LL1CD;}_LL1CC:
{const char*_tmp4F0;Cyc_Absyndump_dump(((_tmp4F0="_fastcall",_tag_dyneither(_tmp4F0,sizeof(char),10))));}goto _LL1C4;_LL1CD:;_LL1CE:
 goto _LL1C4;_LL1C4:;}
# 1141
...
struct _tuple19 _tmp4F1;struct _tuple19 _tmp301=(_tmp4F1.f1=call_conv,((_tmp4F1.f2=_tmp2EA,_tmp4F1)));
...
const char*_tmp4F2;Cyc_Absyndump_dump(((_tmp4F2="@tagged ",_tag_dyneither(_tmp4F2,sizeof(char),9))));}
...
{const char*_tmp4F6;Cyc_Absyndump_dump(((_tmp4F6="}",_tag_dyneither(_tmp4F6,sizeof(char),2))));}
...
{const char*_tmp4F7;Cyc_Absyndump_dump(((_tmp4F7="enum ",_tag_dyneither(_tmp4F7,sizeof(char),6))));}
Cyc_Absyndump_dumpqvar(_tmp30A);
if(_tmp30B != 0){
Cyc_Absyndump_dump_char((int)'{');
Cyc_Absyndump_dumpenumfields((struct Cyc_List_List*)_tmp30B->v);{
const char*_tmp4F8;Cyc_Absyndump_dump_nospace(((_tmp4F8="}",_tag_dyneither(_tmp4F8,sizeof(char),2))));};}}
# 1254
...
if(_tmp313){const char*_tmp4F9;Cyc_Absyndump_dump(((_tmp4F9="@extensible ",_tag_dyneither(_tmp4F9,sizeof(char),13))));}
{const char*_tmp4FA;Cyc_Absyndump_dump(((_tmp4FA="datatype ",_tag_dyneither(_tmp4FA,sizeof(char),10))));}
...
const char*_tmp4FB;Cyc_Absyndump_dump_nospace(((_tmp4FB="}",_tag_dyneither(_tmp4FB,sizeof(char),2))));};}}struct _tuple20{unsigned int f1;struct _tuple0*f2;int f3;};
# 1268
void Cyc_Absyndump_dumpdecl(struct Cyc_Absyn_Decl*d){
Cyc_Absyndump_dumploc(d->loc);{
void*_tmp317=d->r;void*_tmp318=_tmp317;struct Cyc_Absyn_Vardecl*_tmp31A;struct Cyc_Absyn_Fndecl*_tmp31C;struct Cyc_Absyn_Aggrdecl*_tmp31E;struct Cyc_Absyn_Datatypedecl*_tmp320;struct Cyc_Absyn_Enumdecl*_tmp322;struct Cyc_Absyn_Pat*_tmp324;struct Cyc_Absyn_Exp*_tmp325;struct Cyc_List_List*_tmp327;struct Cyc_Absyn_Tvar*_tmp329;struct Cyc_Absyn_Vardecl*_tmp32A;int _tmp32B;struct Cyc_Absyn_Typedefdecl*_tmp32D;struct _dyneither_ptr*_tmp32F;struct Cyc_List_List*_tmp330;struct _tuple0*_tmp332;struct Cyc_List_List*_tmp333;struct Cyc_List_List*_tmp335;struct Cyc_List_List*_tmp337;struct Cyc_List_List*_tmp338;_LL1F6: {struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp319=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp318;if(_tmp319->tag != 0)goto _LL1F8;else{_tmp31A=_tmp319->f1;}}_LL1F7:
# 1272
...
enum Cyc_Cyclone_C_Compilers _tmp33B=Cyc_Cyclone_c_compiler;enum Cyc_Cyclone_C_Compilers _tmp33C;_LL218: if(_tmp33B != Cyc_Cyclone_Vc_c)goto _LL21A;_LL219:
{const char*_tmp4FC;Cyc_Absyndump_dump(((_tmp4FC="__inline",_tag_dyneither(_tmp4FC,sizeof(char),9))));}goto _LL217;_LL21A: _tmp33C=_tmp33B;_LL21B:
{const char*_tmp4FD;Cyc_Absyndump_dump(((_tmp4FD="inline",_tag_dyneither(_tmp4FD,sizeof(char),7))));}goto _LL217;_LL217:;}
# 1285
Cyc_Absyndump_dumpscope(_tmp31C->sc);{
struct Cyc_Absyn_FnType_Absyn_Type_struct _tmp503;struct Cyc_Absyn_FnInfo _tmp502;struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp501;void*t=(void*)((_tmp501=_cycalloc(sizeof(*_tmp501)),((_tmp501[0]=((_tmp503.tag=9,((_tmp503.f1=((_tmp502.tvars=_tmp31C->tvs,((_tmp502.effect=_tmp31C->effect,((_tmp502.ret_tqual=_tmp31C->ret_tqual,((_tmp502.ret_typ=_tmp31C->ret_type,((_tmp502.args=
# 1288
((struct Cyc_List_List*(*)(struct _tuple8*(*f)(struct _tuple8*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Absynpp_arg_mk_opt,_tmp31C->args),((_tmp502.c_varargs=_tmp31C->c_varargs,((_tmp502.cyc_varargs=_tmp31C->cyc_varargs,((_tmp502.rgn_po=_tmp31C->rgn_po,((_tmp502.attributes=0,_tmp502)))))))))))))))))),_tmp503)))),_tmp501))));
# 1291
...
# 1313
{const char*_tmp504;Cyc_Absyndump_dump(((_tmp504="let",_tag_dyneither(_tmp504,sizeof(char),4))));}
...
# 1320
{const char*_tmp505;Cyc_Absyndump_dump(((_tmp505="let ",_tag_dyneither(_tmp505,sizeof(char),5))));}
Cyc_Absyndump_dumpids(_tmp327);
Cyc_Absyndump_dump_semi();
goto _LL1F5;_LL204: {struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*_tmp328=(struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp318;if(_tmp328->tag != 4)goto _LL206;else{_tmp329=_tmp328->f1;_tmp32A=_tmp328->f2;_tmp32B=_tmp328->f3;}}_LL205:
# 1325
{const char*_tmp506;Cyc_Absyndump_dump(((_tmp506="region",_tag_dyneither(_tmp506,sizeof(char),7))));}
{const char*_tmp507;Cyc_Absyndump_dump(((_tmp507="<",_tag_dyneither(_tmp507,sizeof(char),2))));}Cyc_Absyndump_dumptvar(_tmp329);{const char*_tmp508;Cyc_Absyndump_dump(((_tmp508="> ",_tag_dyneither(_tmp508,sizeof(char),3))));}Cyc_Absyndump_dumpqvar(_tmp32A->name);
if(_tmp32B){const char*_tmp509;Cyc_Absyndump_dump(((_tmp509="@resetable",_tag_dyneither(_tmp509,sizeof(char),11))));}
Cyc_Absyndump_dump_semi();
goto _LL1F5;_LL206: {struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*_tmp32C=(struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp318;if(_tmp32C->tag != 8)goto _LL208;else{_tmp32D=_tmp32C->f1;}}_LL207:
# 1335
{const char*_tmp50A;Cyc_Absyndump_dump(((_tmp50A="typedef",_tag_dyneither(_tmp50A,sizeof(char),8))));}{
void*t;
if(_tmp32D->defn == 0)
t=Cyc_Absyn_new_evar(_tmp32D->kind,0);else{
# 1340
t=(void*)_check_null(_tmp32D->defn);}
((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct Cyc_Absyn_Typedefdecl*),struct Cyc_Absyn_Typedefdecl*))Cyc_Absyndump_dumptqtd)(_tmp32D->tq,t,Cyc_Absyndump_dumptypedefname,_tmp32D);
Cyc_Absyndump_dumpatts(_tmp32D->atts);
Cyc_Absyndump_dump_semi();
# 1345
goto _LL1F5;};_LL208: {struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*_tmp32E=(struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp318;if(_tmp32E->tag != 9)goto _LL20A;else{_tmp32F=_tmp32E->f1;_tmp330=_tmp32E->f2;}}_LL209:
# 1347
{const char*_tmp50B;Cyc_Absyndump_dump(((_tmp50B="namespace ",_tag_dyneither(_tmp50B,sizeof(char),11))));}
Cyc_Absyndump_dump_str(_tmp32F);
Cyc_Absyndump_dump_char((int)'{');
for(0;_tmp330 != 0;_tmp330=_tmp330->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp330->hd);}
Cyc_Absyndump_dump_char((int)'}');
goto _LL1F5;_LL20A: {struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*_tmp331=(struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp318;if(_tmp331->tag != 10)goto _LL20C;else{_tmp332=_tmp331->f1;_tmp333=_tmp331->f2;}}_LL20B:
# 1355
{const char*_tmp50C;Cyc_Absyndump_dump(((_tmp50C="using ",_tag_dyneither(_tmp50C,sizeof(char),7))));}
Cyc_Absyndump_dumpqvar(_tmp332);
Cyc_Absyndump_dump_char((int)'{');
for(0;_tmp333 != 0;_tmp333=_tmp333->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp333->hd);}
Cyc_Absyndump_dump_char((int)'}');
goto _LL1F5;_LL20C: {struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*_tmp334=(struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp318;if(_tmp334->tag != 11)goto _LL20E;else{_tmp335=_tmp334->f1;}}_LL20D:
# 1363
{const char*_tmp50D;Cyc_Absyndump_dump(((_tmp50D="extern \"C\" {",_tag_dyneither(_tmp50D,sizeof(char),13))));}
for(0;_tmp335 != 0;_tmp335=_tmp335->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp335->hd);}
Cyc_Absyndump_dump_char((int)'}');
goto _LL1F5;_LL20E: {struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*_tmp336=(struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp318;if(_tmp336->tag != 12)goto _LL210;else{_tmp337=_tmp336->f1;_tmp338=_tmp336->f2;}}_LL20F:
# 1369
{const char*_tmp50E;Cyc_Absyndump_dump(((_tmp50E="extern \"C include\" {",_tag_dyneither(_tmp50E,sizeof(char),21))));}
for(0;_tmp337 != 0;_tmp337=_tmp337->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp337->hd);}
Cyc_Absyndump_dump_char((int)'}');
if(_tmp338 != 0){
{const char*_tmp50F;Cyc_Absyndump_dump(((_tmp50F=" export {",_tag_dyneither(_tmp50F,sizeof(char),10))));}
for(0;_tmp338 != 0;_tmp338=_tmp338->tl){
struct _tuple20 _tmp34E=*((struct _tuple20*)_tmp338->hd);struct _tuple0*_tmp350;struct _tuple20 _tmp34F=_tmp34E;_tmp350=_tmp34F.f2;
Cyc_Absyndump_dumpqvar(_tmp350);
if(_tmp338->tl != 0)Cyc_Absyndump_dump_char((int)',');}{
# 1380
const char*_tmp510;Cyc_Absyndump_dump(((_tmp510="}",_tag_dyneither(_tmp510,sizeof(char),2))));};}
# 1382
goto _LL1F5;_LL210: {struct Cyc_Absyn_Porton_d_Absyn_Raw_decl_struct*_tmp339=(struct Cyc_Absyn_Porton_d_Absyn_Raw_decl_struct*)_tmp318;if(_tmp339->tag != 13)goto _LL212;}_LL211:
# 1384
{const char*_tmp511;Cyc_Absyndump_dump(((_tmp511=" __cyclone_port_on__; ",_tag_dyneither(_tmp511,sizeof(char),23))));}
goto _LL1F5;_LL212: {struct Cyc_Absyn_Portoff_d_Absyn_Raw_decl_struct*_tmp33A=(struct Cyc_Absyn_Portoff_d_Absyn_Raw_decl_struct*)_tmp318;if(_tmp33A->tag != 14)goto _LL1F5;}_LL213:
# 1387
{const char*_tmp512;Cyc_Absyndump_dump(((_tmp512=" __cyclone_port_off__; ",_tag_dyneither(_tmp512,sizeof(char),24))));}
goto _LL1F5;_LL1F5:;};}
# 1392
...
return;}{
# 1404
void*_tmp354=(void*)tms->hd;void*_tmp355=_tmp354;void*_tmp357;union Cyc_Absyn_Constraint*_tmp358;union Cyc_Absyn_Constraint*_tmp359;union Cyc_Absyn_Constraint*_tmp35A;struct Cyc_Absyn_Tqual _tmp35B;_LL220: {struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*_tmp356=(struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp355;if(_tmp356->tag != 2)goto _LL222;else{_tmp357=(_tmp356->f1).rgn;_tmp358=(_tmp356->f1).nullable;_tmp359=(_tmp356->f1).bounds;_tmp35A=(_tmp356->f1).zero_term;_tmp35B=_tmp356->f2;}}_LL221:
# 1408
{void*_tmp35C=((void*(*)(void*y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(Cyc_Absyn_bounds_one,_tmp359);void*_tmp35D=_tmp35C;struct Cyc_Absyn_Exp*_tmp360;_LL225: {struct Cyc_Absyn_DynEither_b_Absyn_Bounds_struct*_tmp35E=(struct Cyc_Absyn_DynEither_b_Absyn_Bounds_struct*)_tmp35D;if(_tmp35E->tag != 0)goto _LL227;}_LL226:
 Cyc_Absyndump_dump_char((int)'?');goto _LL224;_LL227: {struct Cyc_Absyn_Upper_b_Absyn_Bounds_struct*_tmp35F=(struct Cyc_Absyn_Upper_b_Absyn_Bounds_struct*)_tmp35D;if(_tmp35F->tag != 1)goto _LL224;else{_tmp360=_tmp35F->f1;}}_LL228:
# 1411
 Cyc_Absyndump_dump_char((int)(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(1,_tmp358)?'*':'@'));
Cyc_Absyndump_dump_upperbound(_tmp360);
goto _LL224;_LL224:;}
# 1415
if((!Cyc_Absyndump_qvar_to_Cids  && !is_char_ptr) && ((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp35A)){const char*_tmp513;Cyc_Absyndump_dump(((_tmp513="@zeroterm",_tag_dyneither(_tmp513,sizeof(char),10))));}
if((!Cyc_Absyndump_qvar_to_Cids  && is_char_ptr) && !((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp35A)){const char*_tmp514;Cyc_Absyndump_dump(((_tmp514="@nozeroterm",_tag_dyneither(_tmp514,sizeof(char),12))));}
{void*_tmp363=Cyc_Tcutil_compress(_tmp357);void*_tmp364=_tmp363;struct Cyc_Absyn_Tvar*_tmp369;_LL22A: {struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*_tmp365=(struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*)_tmp364;if(_tmp365->tag != 20)goto _LL22C;}_LL22B:
 if(!Cyc_Absyndump_qvar_to_Cids){const char*_tmp515;Cyc_Absyndump_dump(((_tmp515="`H",_tag_dyneither(_tmp515,sizeof(char),3))));}goto _LL229;_LL22C: {struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*_tmp366=(struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*)_tmp364;if(_tmp366->tag != 21)goto _LL22E;}_LL22D:
{const char*_tmp516;Cyc_Absyndump_dump(((_tmp516="`U",_tag_dyneither(_tmp516,sizeof(char),3))));}goto _LL229;_LL22E: {struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*_tmp367=(struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*)_tmp364;if(_tmp367->tag != 22)goto _LL230;}_LL22F:
{const char*_tmp517;Cyc_Absyndump_dump(((_tmp517="`RC",_tag_dyneither(_tmp517,sizeof(char),4))));}goto _LL229;_LL230: {struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp368=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp364;if(_tmp368->tag != 2)goto _LL232;else{_tmp369=_tmp368->f1;}}_LL231:
 Cyc_Absyndump_dumptvar(_tmp369);goto _LL229;_LL232: {struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmp36A=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp364;if(_tmp36A->tag != 1)goto _LL234;else{if((void*)_tmp36A->f2 != 0)goto _LL234;}}_LL233:
 Cyc_Absyndump_dumpntyp(Cyc_Tcutil_compress(_tmp357));goto _LL229;_LL234: {struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmp36B=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp364;if(_tmp36B->tag != 17)goto _LL236;}_LL235:
{const char*_tmp518;Cyc_Absyndump_dump(((_tmp518="@region(",_tag_dyneither(_tmp518,sizeof(char),9))));}Cyc_Absyndump_dumptyp(_tmp357);{const char*_tmp519;Cyc_Absyndump_dump(((_tmp519=")",_tag_dyneither(_tmp519,sizeof(char),2))));}goto _LL229;_LL236:;_LL237: {
const char*_tmp51C;void*_tmp51B;(_tmp51B=0,Cyc_Tcutil_impos(((_tmp51C="dumptms: bad rgn type in Pointer_mod",_tag_dyneither(_tmp51C,sizeof(char),37))),_tag_dyneither(_tmp51B,sizeof(void*),0)));}_LL229:;}
# 1426
Cyc_Absyndump_dumptq(_tmp35B);
Cyc_Absyndump_dumptms(0,tms->tl,f,a);
return;_LL222:;_LL223: {
# 1431
int next_is_pointer=0;
if(tms->tl != 0){
void*_tmp373=(void*)((struct Cyc_List_List*)_check_null(tms->tl))->hd;void*_tmp374=_tmp373;_LL239: {struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*_tmp375=(struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp374;if(_tmp375->tag != 2)goto _LL23B;}_LL23A:
...
if(next_is_pointer)
Cyc_Absyndump_dump_char((int)')');
{void*_tmp376=(void*)tms->hd;void*_tmp377=_tmp376;union Cyc_Absyn_Constraint*_tmp379;struct Cyc_Absyn_Exp*_tmp37B;union Cyc_Absyn_Constraint*_tmp37C;struct Cyc_List_List*_tmp37F;int _tmp380;struct Cyc_Absyn_VarargInfo*_tmp381;void*_tmp382;struct Cyc_List_List*_tmp383;struct Cyc_List_List*_tmp386;unsigned int _tmp387;struct Cyc_List_List*_tmp389;unsigned int _tmp38A;int _tmp38B;struct Cyc_List_List*_tmp38D;_LL23E: {struct Cyc_Absyn_Carray_mod_Absyn_Type_modifier_struct*_tmp378=(struct Cyc_Absyn_Carray_mod_Absyn_Type_modifier_struct*)_tmp377;if(_tmp378->tag != 0)goto _LL240;else{_tmp379=_tmp378->f1;}}_LL23F:
# 1444
{const char*_tmp51D;Cyc_Absyndump_dump(((_tmp51D="[]",_tag_dyneither(_tmp51D,sizeof(char),3))));}
if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp379)){const char*_tmp51E;Cyc_Absyndump_dump(((_tmp51E="@zeroterm",_tag_dyneither(_tmp51E,sizeof(char),10))));}
goto _LL23D;_LL240: {struct Cyc_Absyn_ConstArray_mod_Absyn_Type_modifier_struct*_tmp37A=(struct Cyc_Absyn_ConstArray_mod_Absyn_Type_modifier_struct*)_tmp377;if(_tmp37A->tag != 1)goto _LL242;else{_tmp37B=_tmp37A->f1;_tmp37C=_tmp37A->f2;}}_LL241:
# 1448
 Cyc_Absyndump_dump_char((int)'[');Cyc_Absyndump_dumpexp(_tmp37B);Cyc_Absyndump_dump_char((int)']');
if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp37C)){const char*_tmp51F;Cyc_Absyndump_dump(((_tmp51F="@zeroterm",_tag_dyneither(_tmp51F,sizeof(char),10))));}
goto _LL23D;_LL242: {struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*_tmp37D=(struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp377;if(_tmp37D->tag != 3)goto _LL244;else{struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*_tmp37E=(struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((void*)_tmp37D->f1);if(_tmp37E->tag != 1)goto _LL244;else{_tmp37F=_tmp37E->f1;_tmp380=_tmp37E->f2;_tmp381=_tmp37E->f3;_tmp382=(void*)_tmp37E->f4;_tmp383=_tmp37E->f5;}}}_LL243:
# 1452
 Cyc_Absyndump_dumpfunargs(_tmp37F,_tmp380,_tmp381,_tmp382,_tmp383);goto _LL23D;_LL244: {struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*_tmp384=(struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp377;if(_tmp384->tag != 3)goto _LL246;else{struct Cyc_Absyn_NoTypes_Absyn_Funcparams_struct*_tmp385=(struct Cyc_Absyn_NoTypes_Absyn_Funcparams_struct*)((void*)_tmp384->f1);if(_tmp385->tag != 0)goto _LL246;else{_tmp386=_tmp385->f1;_tmp387=_tmp385->f2;}}}_LL245:
# 1454
{const char*_tmp522;const char*_tmp521;const char*_tmp520;((void(*)(void(*f)(struct _dyneither_ptr*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dump_str,_tmp386,((_tmp520="(",_tag_dyneither(_tmp520,sizeof(char),2))),((_tmp521=")",_tag_dyneither(_tmp521,sizeof(char),2))),((_tmp522=",",_tag_dyneither(_tmp522,sizeof(char),2))));}goto _LL23D;_LL246: {struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*_tmp388=(struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp377;if(_tmp388->tag != 4)goto _LL248;else{_tmp389=_tmp388->f1;_tmp38A=_tmp388->f2;_tmp38B=_tmp388->f3;}}_LL247:
# 1456
 if(_tmp38B)Cyc_Absyndump_dumpkindedtvars(_tmp389);else{Cyc_Absyndump_dumptvars(_tmp389);}goto _LL23D;_LL248: {struct Cyc_Absyn_Attributes_mod_Absyn_Type_modifier_struct*_tmp38C=(struct Cyc_Absyn_Attributes_mod_Absyn_Type_modifier_struct*)_tmp377;if(_tmp38C->tag != 5)goto _LL24A;else{_tmp38D=_tmp38C->f2;}}_LL249:
 Cyc_Absyndump_dumpatts(_tmp38D);goto _LL23D;_LL24A: {struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*_tmp38E=(struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp377;if(_tmp38E->tag != 2)goto _LL23D;}_LL24B: {
const char*_tmp525;void*_tmp524;(_tmp524=0,Cyc_Tcutil_impos(((_tmp525="dumptms",_tag_dyneither(_tmp525,sizeof(char),8))),_tag_dyneither(_tmp524,sizeof(void*),0)));}_LL23D:;}
# 1460
return;}_LL21F:;};}
# 1464
void Cyc_Absyndump_dumptqtd(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(void*),void*a){
int _tmp397=Cyc_Absyndump_is_char_ptr(t);
struct _RegionHandle _tmp398=_new_region("temp");struct _RegionHandle*temp=& _tmp398;_push_region(temp);
{struct _tuple11 _tmp399=Cyc_Absynpp_to_tms(temp,tq,t);struct Cyc_Absyn_Tqual _tmp39B;void*_tmp39C;struct Cyc_List_List*_tmp39D;struct _tuple11 _tmp39A=_tmp399;_tmp39B=_tmp39A.f1;_tmp39C=_tmp39A.f2;_tmp39D=_tmp39A.f3;
Cyc_Absyndump_dumptq(_tmp39B);
Cyc_Absyndump_dumpntyp(_tmp39C);
Cyc_Absyndump_dumptms(_tmp397,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp39D),f,a);}
# 1467
;_pop_region(temp);}
# 1474
...
const char*_tmp528;void*_tmp527;(_tmp527=0,Cyc_fprintf(f,((_tmp528="\n",_tag_dyneither(_tmp528,sizeof(char),2))),_tag_dyneither(_tmp527,sizeof(void*),0)));};}
# 1482
static void Cyc_Absyndump_dump_decl_interface(struct Cyc_Absyn_Decl*d){
void*_tmp3A0=d->r;void*_tmp3A1=_tmp3A0;struct Cyc_Absyn_Vardecl*_tmp3A3;struct Cyc_Absyn_Fndecl*_tmp3A5;struct Cyc_Absyn_Aggrdecl*_tmp3A7;struct Cyc_Absyn_Datatypedecl*_tmp3A9;struct Cyc_Absyn_Enumdecl*_tmp3AB;struct Cyc_Absyn_Typedefdecl*_tmp3AD;struct _dyneither_ptr*_tmp3AF;struct Cyc_List_List*_tmp3B0;struct Cyc_List_List*_tmp3B2;struct Cyc_List_List*_tmp3B4;struct Cyc_List_List*_tmp3B6;struct Cyc_List_List*_tmp3B7;_LL24D: {struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp3A2=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp3A1;if(_tmp3A2->tag != 0)goto _LL24F;else{_tmp3A3=_tmp3A2->f1;}}_LL24E:
# 1485
 if(_tmp3A3->sc == Cyc_Absyn_Static)return;{
struct Cyc_Absyn_Exp*init=_tmp3A3->initializer;
_tmp3A3->initializer=0;
if(_tmp3A3->sc == Cyc_Absyn_Public){
const char*_tmp529;Cyc_Absyndump_dump(((_tmp529="extern ",_tag_dyneither(_tmp529,sizeof(char),8))));}
Cyc_Absyndump_dumpvardecl(_tmp3A3,d->loc,1);
{const char*_tmp52A;Cyc_Absyndump_dump(((_tmp52A="\n",_tag_dyneither(_tmp52A,sizeof(char),2))));}
_tmp3A3->initializer=init;
goto _LL24C;};_LL24F: {struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*_tmp3A4=(struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp3A1;if(_tmp3A4->tag != 1)goto _LL251;else{_tmp3A5=_tmp3A4->f1;}}_LL250:
# 1495
 if(_tmp3A5->sc == Cyc_Absyn_Static)return;
Cyc_Absyndump_dumpscope(_tmp3A5->sc);{
struct Cyc_Absyn_FnType_Absyn_Type_struct _tmp530;struct Cyc_Absyn_FnInfo _tmp52F;struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp52E;void*t=(void*)((_tmp52E=_cycalloc(sizeof(*_tmp52E)),((_tmp52E[0]=((_tmp530.tag=9,((_tmp530.f1=((_tmp52F.tvars=_tmp3A5->tvs,((_tmp52F.effect=_tmp3A5->effect,((_tmp52F.ret_tqual=_tmp3A5->ret_tqual,((_tmp52F.ret_typ=_tmp3A5->ret_type,((_tmp52F.args=
# 1499
((struct Cyc_List_List*(*)(struct _tuple8*(*f)(struct _tuple8*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Absynpp_arg_mk_opt,_tmp3A5->args),((_tmp52F.c_varargs=_tmp3A5->c_varargs,((_tmp52F.cyc_varargs=_tmp3A5->cyc_varargs,((_tmp52F.rgn_po=_tmp3A5->rgn_po,((_tmp52F.attributes=0,_tmp52F)))))))))))))))))),_tmp530)))),_tmp52E))));
# 1502
((void(*)(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*a))Cyc_Absyndump_dumptqtd)(Cyc_Absyn_empty_tqual(0),t,Cyc_Absyndump_dump_atts_qvar,_tmp3A5);
{const char*_tmp531;Cyc_Absyndump_dump(((_tmp531=";\n",_tag_dyneither(_tmp531,sizeof(char),3))));}
goto _LL24C;};_LL251: {struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp3A6=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp3A1;if(_tmp3A6->tag != 5)goto _LL253;else{_tmp3A7=_tmp3A6->f1;}}_LL252:
# 1506
 if(_tmp3A7->sc == Cyc_Absyn_Static)return;{
struct Cyc_Absyn_AggrdeclImpl*impl=_tmp3A7->impl;
if(_tmp3A7->sc == Cyc_Absyn_Abstract)_tmp3A7->impl=0;
Cyc_Absyndump_dump_aggrdecl(_tmp3A7);
_tmp3A7->impl=impl;
{const char*_tmp532;Cyc_Absyndump_dump(((_tmp532=";\n",_tag_dyneither(_tmp532,sizeof(char),3))));}
goto _LL24C;};_LL253: {struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp3A8=(struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp3A1;if(_tmp3A8->tag != 6)goto _LL255;else{_tmp3A9=_tmp3A8->f1;}}_LL254:
# 1514
 Cyc_Absyndump_dump_datatypedecl(_tmp3A9);
{const char*_tmp533;Cyc_Absyndump_dump(((_tmp533=";\n",_tag_dyneither(_tmp533,sizeof(char),3))));}
goto _LL24C;_LL255: {struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*_tmp3AA=(struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp3A1;if(_tmp3AA->tag != 7)goto _LL257;else{_tmp3AB=_tmp3AA->f1;}}_LL256:
# 1518
 Cyc_Absyndump_dump_enumdecl(_tmp3AB);
{const char*_tmp534;Cyc_Absyndump_dump(((_tmp534=";\n",_tag_dyneither(_tmp534,sizeof(char),3))));}
goto _LL24C;_LL257: {struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*_tmp3AC=(struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp3A1;if(_tmp3AC->tag != 8)goto _LL259;else{_tmp3AD=_tmp3AC->f1;}}_LL258:
# 1522
 if(_tmp3AD->defn == 0){
Cyc_Absyndump_dumpdecl(d);{
const char*_tmp535;Cyc_Absyndump_dump(((_tmp535="\n",_tag_dyneither(_tmp535,sizeof(char),2))));};}
# 1526
goto _LL24C;_LL259: {struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*_tmp3AE=(struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp3A1;if(_tmp3AE->tag != 9)goto _LL25B;else{_tmp3AF=_tmp3AE->f1;_tmp3B0=_tmp3AE->f2;}}_LL25A:
# 1528
{const char*_tmp536;Cyc_Absyndump_dump(((_tmp536="namespace ",_tag_dyneither(_tmp536,sizeof(char),11))));}
Cyc_Absyndump_dump_str(_tmp3AF);
{const char*_tmp537;Cyc_Absyndump_dump(((_tmp537="{\n",_tag_dyneither(_tmp537,sizeof(char),3))));}
for(0;_tmp3B0 != 0;_tmp3B0=_tmp3B0->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)_tmp3B0->hd);}
{const char*_tmp538;Cyc_Absyndump_dump(((_tmp538="}\n",_tag_dyneither(_tmp538,sizeof(char),3))));}
goto _LL24C;_LL25B: {struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*_tmp3B1=(struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp3A1;if(_tmp3B1->tag != 10)goto _LL25D;else{_tmp3B2=_tmp3B1->f2;}}_LL25C:
# 1536
 for(0;_tmp3B2 != 0;_tmp3B2=_tmp3B2->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)_tmp3B2->hd);}
goto _LL24C;_LL25D: {struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*_tmp3B3=(struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp3A1;if(_tmp3B3->tag != 11)goto _LL25F;else{_tmp3B4=_tmp3B3->f1;}}_LL25E:
# 1540
{const char*_tmp539;Cyc_Absyndump_dump(((_tmp539="extern \"C\" {",_tag_dyneither(_tmp539,sizeof(char),13))));}
for(0;_tmp3B4 != 0;_tmp3B4=_tmp3B4->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)_tmp3B4->hd);}
{const char*_tmp53A;Cyc_Absyndump_dump(((_tmp53A="}\n",_tag_dyneither(_tmp53A,sizeof(char),3))));}
goto _LL24C;_LL25F: {struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*_tmp3B5=(struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp3A1;if(_tmp3B5->tag != 12)goto _LL261;else{_tmp3B6=_tmp3B5->f1;_tmp3B7=_tmp3B5->f2;}}_LL260:
# 1561 "absyndump.cyc"
 goto _LL24C;_LL261:;_LL262: {
const char*_tmp53D;void*_tmp53C;(_tmp53C=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp53D="bad top-level declaration",_tag_dyneither(_tmp53D,sizeof(char),26))),_tag_dyneither(_tmp53C,sizeof(void*),0)));}_LL24C:;}
# 1566
