...
if(({char*_tmp306=(char*)f.curr;_tmp306 == (char*)(_tag_fat(0,0,0)).curr;})||(char*)f.curr == (char*)last_file.curr && d == last_line)return;
if((char*)f.curr == (char*)last_file.curr && d == last_line + (unsigned)1)
({void*_tmp6=0U;({struct Cyc___cycFILE*_tmp308=*Cyc_Absyndump_dump_file;struct _fat_ptr _tmp307=({const char*_tmp7="\n";_tag_fat(_tmp7,sizeof(char),2U);});Cyc_fprintf(_tmp308,_tmp307,_tag_fat(_tmp6,sizeof(void*),0U));});});else{
if((char*)f.curr == (char*)last_file.curr)
({struct Cyc_Int_pa_PrintArg_struct _tmpA=({struct Cyc_Int_pa_PrintArg_struct _tmp2F8;_tmp2F8.tag=1U,_tmp2F8.f1=(unsigned long)((int)d);_tmp2F8;});void*_tmp8[1U];_tmp8[0]=& _tmpA;({struct Cyc___cycFILE*_tmp30A=*Cyc_Absyndump_dump_file;struct _fat_ptr _tmp309=({const char*_tmp9="\n# %d\n";_tag_fat(_tmp9,sizeof(char),7U);});Cyc_fprintf(_tmp30A,_tmp309,_tag_fat(_tmp8,sizeof(void*),1U));});});else{
# 161
({struct Cyc_Int_pa_PrintArg_struct _tmpD=({struct Cyc_Int_pa_PrintArg_struct _tmp2FA;_tmp2FA.tag=1U,_tmp2FA.f1=(unsigned long)((int)d);_tmp2FA;});struct Cyc_String_pa_PrintArg_struct _tmpE=({struct Cyc_String_pa_PrintArg_struct _tmp2F9;_tmp2F9.tag=0U,_tmp2F9.f1=(struct _fat_ptr)((struct _fat_ptr)f);_tmp2F9;});void*_tmpB[2U];_tmpB[0]=& _tmpD,_tmpB[1]=& _tmpE;({struct Cyc___cycFILE*_tmp30C=*Cyc_Absyndump_dump_file;struct _fat_ptr _tmp30B=({const char*_tmpC="\n# %d %s\n";_tag_fat(_tmpC,sizeof(char),10U);});Cyc_fprintf(_tmp30C,_tmp30B,_tag_fat(_tmpB,sizeof(void*),2U));});});}}
# 163
last_file=f;
last_line=d;}}}
# 169
...
({struct Cyc_List_List*_tmp30F=ts;struct _fat_ptr _tmp30E=({const char*_tmp24="<";_tag_fat(_tmp24,sizeof(char),2U);});struct _fat_ptr _tmp30D=({const char*_tmp25=">";_tag_fat(_tmp25,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptyp,_tmp30F,_tmp30E,_tmp30D,({const char*_tmp26=",";_tag_fat(_tmp26,sizeof(char),2U);}));});}
# 277
...
({struct Cyc_List_List*_tmp312=tvs;struct _fat_ptr _tmp311=({const char*_tmp31="<";_tag_fat(_tmp31,sizeof(char),2U);});struct _fat_ptr _tmp310=({const char*_tmp32=">";_tag_fat(_tmp32,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp312,_tmp311,_tmp310,({const char*_tmp33=",";_tag_fat(_tmp33,sizeof(char),2U);}));});}
# 302
static void Cyc_Absyndump_dumpkindedtvars(struct Cyc_List_List*tvs){
({struct Cyc_List_List*_tmp315=tvs;struct _fat_ptr _tmp314=({const char*_tmp34="<";_tag_fat(_tmp34,sizeof(char),2U);});struct _fat_ptr _tmp313=({const char*_tmp35=">";_tag_fat(_tmp35,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,_tmp315,_tmp314,_tmp313,({const char*_tmp36=",";_tag_fat(_tmp36,sizeof(char),2U);}));});}struct _tuple16{struct Cyc_Absyn_Tqual f1;void*f2;};
# 305
...
({struct Cyc_List_List*_tmp318=ts;struct _fat_ptr _tmp317=({const char*_tmp37="(";_tag_fat(_tmp37,sizeof(char),2U);});struct _fat_ptr _tmp316=({const char*_tmp38=")";_tag_fat(_tmp38,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple16*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumparg,_tmp318,_tmp317,_tmp316,({const char*_tmp39=",";_tag_fat(_tmp39,sizeof(char),2U);}));});}
# 312
...
# 380
return({struct _tuple17 _tmp2FB;_tmp2FB.f1=rgions,_tmp2FB.f2=effects;_tmp2FB;});}
# 383
...
if(effects != 0){
({struct Cyc_List_List*_tmp31B=effects;struct _fat_ptr _tmp31A=({const char*_tmp56="";_tag_fat(_tmp56,sizeof(char),1U);});struct _fat_ptr _tmp319=({const char*_tmp57="";_tag_fat(_tmp57,sizeof(char),1U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpntyp,_tmp31B,_tmp31A,_tmp319,({const char*_tmp58="+";_tag_fat(_tmp58,sizeof(char),2U);}));});
if(rgions != 0)Cyc_Absyndump_dump_char((int)'+');}
# 391
if(rgions != 0 || effects == 0)
({struct Cyc_List_List*_tmp31E=rgions;struct _fat_ptr _tmp31D=({const char*_tmp59="{";_tag_fat(_tmp59,sizeof(char),2U);});struct _fat_ptr _tmp31C=({const char*_tmp5A="}";_tag_fat(_tmp5A,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumprgn,_tmp31E,_tmp31D,_tmp31C,({const char*_tmp5B=",";_tag_fat(_tmp5B,sizeof(char),2U);}));});}}
# 396
static void Cyc_Absyndump_dumpntyp(void*t){
...
({struct Cyc_List_List*_tmp321=ts;struct _fat_ptr _tmp320=({const char*_tmpB5="";_tag_fat(_tmpB5,sizeof(char),1U);});struct _fat_ptr _tmp31F=({const char*_tmpB6="";_tag_fat(_tmpB6,sizeof(char),1U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumptyp,_tmp321,_tmp320,_tmp31F,({const char*_tmpB7="+";_tag_fat(_tmpB7,sizeof(char),2U);}));});return;case 11U: _LL5E: _LL5F:
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpBD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FC;_tmp2FC.tag=0U,({struct _fat_ptr _tmp322=({const char*_tmpBE="bad type constructor";_tag_fat(_tmpBE,sizeof(char),21U);});_tmp2FC.f1=_tmp322;});_tmp2FC;});void*_tmpBC[1U];_tmpBC[0]=& _tmpBD;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpBC,sizeof(void*),1U));});}_LL21:;}}case 2U: _LL9: _tmp6C=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp5C)->f1;_LLA: {struct Cyc_Absyn_Tvar*tv=_tmp6C;
# 403
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp74=({struct Cyc_Int_pa_PrintArg_struct _tmp2FD;_tmp2FD.tag=1U,_tmp2FD.f1=(unsigned long)i;_tmp2FD;});void*_tmp72[1U];_tmp72[0]=& _tmp74;({struct _fat_ptr _tmp323=({const char*_tmp73="%d";_tag_fat(_tmp73,sizeof(char),3U);});Cyc_aprintf(_tmp323,_tag_fat(_tmp72,sizeof(void*),1U));});}));return;}}else{_LLD: _tmp67=((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp5C)->f1;_tmp68=(void*)((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp5C)->f2;_tmp69=((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp5C)->f3;_LLE: {struct Cyc_Core_Opt*k=_tmp67;void*t=_tmp68;int i=_tmp69;
...
({struct Cyc_List_List*_tmp324=rgn_po;((void(*)(void(*f)(struct _tuple18*),struct Cyc_List_List*l,struct _fat_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dump_rgncmp,_tmp324,({const char*_tmpBF=",";_tag_fat(_tmpBF,sizeof(char),2U);}));});}
# 502
...
# 511
({struct Cyc_List_List*_tmp327=args;struct _fat_ptr _tmp326=({const char*_tmpC1="(";_tag_fat(_tmpC1,sizeof(char),2U);});struct _fat_ptr _tmp325=({const char*_tmpC2="";_tag_fat(_tmpC2,sizeof(char),1U);});((void(*)(void(*f)(struct _tuple8*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpfunarg,_tmp327,_tmp326,_tmp325,({const char*_tmpC3=",";_tag_fat(_tmpC3,sizeof(char),2U);}));});
...
({struct Cyc_Absyn_Tqual _tmp328=Cyc_Absyn_empty_tqual(0U);((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(int),int))Cyc_Absyndump_dumptqtd)(_tmp328,t,(void(*)(int x))Cyc_Absyndump_ignore,0);});}
# 538
...
({struct Cyc_List_List*_tmp32B=(*de).f1;struct _fat_ptr _tmp32A=({const char*_tmpCD="";_tag_fat(_tmpCD,sizeof(char),1U);});struct _fat_ptr _tmp329=({const char*_tmpCE="=";_tag_fat(_tmpCE,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,_tmp32B,_tmp32A,_tmp329,({const char*_tmpCF="=";_tag_fat(_tmpCF,sizeof(char),2U);}));});
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpD5=({struct Cyc_Int_pa_PrintArg_struct _tmp2FE;_tmp2FE.tag=1U,_tmp2FE.f1=(unsigned long)((int)n);_tmp2FE;});void*_tmpD3[1U];_tmpD3[0]=& _tmpD5;({struct _fat_ptr _tmp32C=({const char*_tmpD4="%d";_tag_fat(_tmpD4,sizeof(char),3U);});Cyc_aprintf(_tmp32C,_tag_fat(_tmpD3,sizeof(void*),1U));});}));return;}}_LL0:;}struct _tuple20{struct _fat_ptr f1;struct Cyc_Absyn_Exp*f2;};
# 556
...
({int _tmp330=inprec;struct Cyc_List_List*_tmp32F=es;struct _fat_ptr _tmp32E=({const char*_tmpDA="";_tag_fat(_tmpDA,sizeof(char),1U);});struct _fat_ptr _tmp32D=({const char*_tmpDB="";_tag_fat(_tmpDB,sizeof(char),1U);});((void(*)(void(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group_c)(Cyc_Absyndump_dumpexp_prec,_tmp330,_tmp32F,_tmp32E,_tmp32D,({const char*_tmpDC=",";_tag_fat(_tmpDC,sizeof(char),2U);}));});}
# 581
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp13D=({struct Cyc_String_pa_PrintArg_struct _tmp2FF;_tmp2FF.tag=0U,_tmp2FF.f1=(struct _fat_ptr)((struct _fat_ptr)s);_tmp2FF;});void*_tmp13B[1U];_tmp13B[0]=& _tmp13D;({struct _fat_ptr _tmp331=({const char*_tmp13C="L'%s'";_tag_fat(_tmp13C,sizeof(char),6U);});Cyc_aprintf(_tmp331,_tag_fat(_tmp13B,sizeof(void*),1U));});}));goto _LL0;}case 4U: _LL5: _tmp136=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).Short_c).val).f1;_tmp137=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).Short_c).val).f2;_LL6: {enum Cyc_Absyn_Sign sg=_tmp136;short s=_tmp137;
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp140=({struct Cyc_Int_pa_PrintArg_struct _tmp300;_tmp300.tag=1U,_tmp300.f1=(unsigned long)((int)s);_tmp300;});void*_tmp13E[1U];_tmp13E[0]=& _tmp140;({struct _fat_ptr _tmp332=({const char*_tmp13F="%d";_tag_fat(_tmp13F,sizeof(char),3U);});Cyc_aprintf(_tmp332,_tag_fat(_tmp13E,sizeof(void*),1U));});}));goto _LL0;}case 5U: switch((((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).Int_c).val).f1){case Cyc_Absyn_None: _LL7: _tmp135=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).Int_c).val).f2;_LL8: {int i=_tmp135;
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp143=({struct Cyc_Int_pa_PrintArg_struct _tmp301;_tmp301.tag=1U,_tmp301.f1=(unsigned long)i;_tmp301;});void*_tmp141[1U];_tmp141[0]=& _tmp143;({struct _fat_ptr _tmp333=({const char*_tmp142="%d";_tag_fat(_tmp142,sizeof(char),3U);});Cyc_aprintf(_tmp333,_tag_fat(_tmp141,sizeof(void*),1U));});}));goto _LL0;}default: _LLB: _tmp133=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).Int_c).val).f2;_LLC: {int i=_tmp133;
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp146=({struct Cyc_Int_pa_PrintArg_struct _tmp302;_tmp302.tag=1U,_tmp302.f1=(unsigned)i;_tmp302;});void*_tmp144[1U];_tmp144[0]=& _tmp146;({struct _fat_ptr _tmp334=({const char*_tmp145="%uU";_tag_fat(_tmp145,sizeof(char),4U);});Cyc_aprintf(_tmp334,_tag_fat(_tmp144,sizeof(void*),1U));});}));goto _LL0;}}case 6U: _LLD: _tmp131=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).LongLong_c).val).f1;_tmp132=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).LongLong_c).val).f2;_LLE: {enum Cyc_Absyn_Sign sg=_tmp131;long long i=_tmp132;
# 596
...
({void*_tmp14F=0U;({struct _fat_ptr _tmp335=({const char*_tmp150="Absyndump -- Bad number of arguments to primop";_tag_fat(_tmp150,sizeof(char),47U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp335,_tag_fat(_tmp14F,sizeof(void*),0U));});});}_LL71:;}
# 631
...
Cyc_Absyndump_dump_char((int)')');
({struct Cyc_List_List*_tmp33B=des;struct _fat_ptr _tmp33A=({const char*_tmp16C="{";_tag_fat(_tmp16C,sizeof(char),2U);});struct _fat_ptr _tmp339=({const char*_tmp16D="}";_tag_fat(_tmp16D,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple19*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp33B,_tmp33A,_tmp339,({const char*_tmp16E=",";_tag_fat(_tmp16E,sizeof(char),2U);}));});
...
# 761
({struct Cyc_List_List*_tmp33E=des;struct _fat_ptr _tmp33D=({const char*_tmp16F="{";_tag_fat(_tmp16F,sizeof(char),2U);});struct _fat_ptr _tmp33C=({const char*_tmp170="}";_tag_fat(_tmp170,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple19*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp33E,_tmp33D,_tmp33C,({const char*_tmp171=",";_tag_fat(_tmp171,sizeof(char),2U);}));});goto _LL0;}case 27U: _LL5B: _tmpF4=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpDF)->f1;_tmpF5=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpDF)->f2;_tmpF6=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpDF)->f3;_LL5C: {struct Cyc_Absyn_Vardecl*vd=_tmpF4;struct Cyc_Absyn_Exp*e1=_tmpF5;struct Cyc_Absyn_Exp*e2=_tmpF6;
# 764
...
if(ts != 0)
Cyc_Absyndump_dumptps(ts);
({struct Cyc_List_List*_tmp341=des;struct _fat_ptr _tmp340=({const char*_tmp174="";_tag_fat(_tmp174,sizeof(char),1U);});struct _fat_ptr _tmp33F=({const char*_tmp175="}";_tag_fat(_tmp175,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple19*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp341,_tmp340,_tmp33F,({const char*_tmp176=",";_tag_fat(_tmp176,sizeof(char),2U);}));});
...
# 781
({struct Cyc_List_List*_tmp344=des;struct _fat_ptr _tmp343=({const char*_tmp177="{";_tag_fat(_tmp177,sizeof(char),2U);});struct _fat_ptr _tmp342=({const char*_tmp178="}";_tag_fat(_tmp178,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple19*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp344,_tmp343,_tmp342,({const char*_tmp179=",";_tag_fat(_tmp179,sizeof(char),2U);}));});goto _LL0;}case 32U: _LL63: _tmpED=((struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmpDF)->f2;_LL64: {struct Cyc_Absyn_Enumfield*ef=_tmpED;
...
if(es != 0)({struct Cyc_List_List*_tmp347=es;struct _fat_ptr _tmp346=({const char*_tmp17A="(";_tag_fat(_tmp17A,sizeof(char),2U);});struct _fat_ptr _tmp345=({const char*_tmp17B=")";_tag_fat(_tmp17B,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Exp*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpexp,_tmp347,_tmp346,_tmp345,({const char*_tmp17C=",";_tag_fat(_tmp17C,sizeof(char),2U);}));});
...
# 807
if(topt != 0)
Cyc_Absyndump_dumpexp(({struct Cyc_Absyn_Exp*_tmp348=Cyc_Absyn_sizeoftype_exp(*topt,0U);Cyc_Absyn_times_exp(_tmp348,e,0U);}));else{
# 810
...
# 819
({struct Cyc_List_List*_tmp34B=des;struct _fat_ptr _tmp34A=({const char*_tmp188="{";_tag_fat(_tmp188,sizeof(char),2U);});struct _fat_ptr _tmp349=({const char*_tmp189="}";_tag_fat(_tmp189,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple19*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp34B,_tmp34A,_tmp349,({const char*_tmp18A=",";_tag_fat(_tmp18A,sizeof(char),2U);}));});goto _LL0;}default: _LL6F: _tmpE0=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmpDF)->f1;_LL70: {struct Cyc_Absyn_Stmt*s=_tmpE0;
# 822
...
({struct Cyc_List_List*_tmp34E=(*dp).f1;struct _fat_ptr _tmp34D=({const char*_tmp1D3="";_tag_fat(_tmp1D3,sizeof(char),1U);});struct _fat_ptr _tmp34C=({const char*_tmp1D4="=";_tag_fat(_tmp1D4,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,_tmp34E,_tmp34D,_tmp34C,({const char*_tmp1D5="=";_tag_fat(_tmp1D5,sizeof(char),2U);}));});
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp200=({struct Cyc_Int_pa_PrintArg_struct _tmp303;_tmp303.tag=1U,_tmp303.f1=(unsigned long)i;_tmp303;});void*_tmp1FE[1U];_tmp1FE[0]=& _tmp200;({struct _fat_ptr _tmp34F=({const char*_tmp1FF="%d";_tag_fat(_tmp1FF,sizeof(char),3U);});Cyc_aprintf(_tmp34F,_tag_fat(_tmp1FE,sizeof(void*),1U));});}));goto _LL0;}default: _LL9: _tmp1FA=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1D9)->f2;_LLA: {int i=_tmp1FA;
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp203=({struct Cyc_Int_pa_PrintArg_struct _tmp304;_tmp304.tag=1U,_tmp304.f1=(unsigned)i;_tmp304;});void*_tmp201[1U];_tmp201[0]=& _tmp203;({struct _fat_ptr _tmp350=({const char*_tmp202="%u";_tag_fat(_tmp202,sizeof(char),3U);});Cyc_aprintf(_tmp350,_tag_fat(_tmp201,sizeof(void*),1U));});}));goto _LL0;}}case 12U: _LLB: _tmp1F9=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp1D9)->f1;_LLC: {struct _fat_ptr x=_tmp1F9;
...
({struct Cyc_List_List*_tmp353=ts;struct _fat_ptr _tmp352=({const char*_tmp20C="$(";_tag_fat(_tmp20C,sizeof(char),3U);});struct _fat_ptr _tmp351=Cyc_Absyndump_pat_term(dots);((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp353,_tmp352,_tmp351,({const char*_tmp20D=",";_tag_fat(_tmp20D,sizeof(char),2U);}));});goto _LL0;}case 6U: _LL1F: _tmp1EB=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp1D9)->f1;_LL20: {struct Cyc_Absyn_Pat*p2=_tmp1EB;
...
# 989
Cyc_Absyndump_dump_char((int)'{');
({struct Cyc_List_List*_tmp359=exists;struct _fat_ptr _tmp358=({const char*_tmp211="<";_tag_fat(_tmp211,sizeof(char),2U);});struct _fat_ptr _tmp357=({const char*_tmp212=">";_tag_fat(_tmp212,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp359,_tmp358,_tmp357,({const char*_tmp213=",";_tag_fat(_tmp213,sizeof(char),2U);}));});
({struct Cyc_List_List*_tmp35C=dps;struct _fat_ptr _tmp35B=({const char*_tmp214="";_tag_fat(_tmp214,sizeof(char),1U);});struct _fat_ptr _tmp35A=Cyc_Absyndump_pat_term(dots);((void(*)(void(*f)(struct _tuple21*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpdp,_tmp35C,_tmp35B,_tmp35A,({const char*_tmp215=",";_tag_fat(_tmp215,sizeof(char),2U);}));});
...
# 994
Cyc_Absyndump_dumpqvar(tuf->name);
if(ps != 0)({struct Cyc_List_List*_tmp35F=ps;struct _fat_ptr _tmp35E=({const char*_tmp216="(";_tag_fat(_tmp216,sizeof(char),2U);});struct _fat_ptr _tmp35D=Cyc_Absyndump_pat_term(dots);((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp35F,_tmp35E,_tmp35D,({const char*_tmp217=",";_tag_fat(_tmp217,sizeof(char),2U);}));});
...
({struct Cyc_List_List*_tmp360=fields;((void(*)(void(*f)(struct Cyc_Absyn_Datatypefield*),struct Cyc_List_List*l,struct _fat_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpdatatypefield,_tmp360,({const char*_tmp218=",";_tag_fat(_tmp218,sizeof(char),2U);}));});}
# 1009
...
# 1015
static void Cyc_Absyndump_dumpenumfields(struct Cyc_List_List*fields){
({struct Cyc_List_List*_tmp361=fields;((void(*)(void(*f)(struct Cyc_Absyn_Enumfield*),struct Cyc_List_List*l,struct _fat_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpenumfield,_tmp361,({const char*_tmp21A=",";_tag_fat(_tmp21A,sizeof(char),2U);}));});}
# 1019
static void Cyc_Absyndump_dumpaggrfields(struct Cyc_List_List*fields){
...
struct _tuple22 _tmp247=({struct _tuple22 _tmp305;_tmp305.f1=call_conv,_tmp305.f2=name;_tmp305;});struct _tuple22 pr=_tmp247;
({int _tmp362=is_cp;((void(*)(int is_char_ptr,struct Cyc_List_List*,void(*f)(struct _tuple22*),struct _tuple22*a))Cyc_Absyndump_dumptms)(_tmp362,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(tms),Cyc_Absyndump_dump_callconv_qvar,& pr);});
...
if(ad->impl != 0){
Cyc_Absyndump_dump_char((int)'{');
({struct Cyc_List_List*_tmp365=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->exist_vars;struct _fat_ptr _tmp364=({const char*_tmp249="<";_tag_fat(_tmp249,sizeof(char),2U);});struct _fat_ptr _tmp363=({const char*_tmp24A=">";_tag_fat(_tmp24A,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,_tmp365,_tmp364,_tmp363,({const char*_tmp24B=",";_tag_fat(_tmp24B,sizeof(char),2U);}));});
...
# 1196
({struct Cyc_List_List*_tmp366=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)((fd->i).attributes,i.attributes);(fd->i).attributes=_tmp366;});goto _LL2F;}}else{_LL32: _LL33:
({void*_tmp278=0U;({struct _fat_ptr _tmp367=({const char*_tmp279="function has non-function type";_tag_fat(_tmp279,sizeof(char),31U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp367,_tag_fat(_tmp278,sizeof(void*),0U));});});}_LL2F:;}
# 1200
{enum Cyc_Flags_C_Compilers _tmp27A=Cyc_Flags_c_compiler;if(_tmp27A == Cyc_Flags_Gcc_c){_LL35: _LL36:
({struct Cyc_Absyn_Tqual _tmp369=Cyc_Absyn_empty_tqual(0U);void*_tmp368=t;((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*))Cyc_Absyndump_dumptqtd)(_tmp369,_tmp368,Cyc_Absyndump_dump_atts_qvar,fd);});goto _LL34;}else{_LL37: _LL38:
({struct Cyc_Absyn_Tqual _tmp36B=Cyc_Absyn_empty_tqual(0U);void*_tmp36A=t;((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*))Cyc_Absyndump_dumptqtd)(_tmp36B,_tmp36A,Cyc_Absyndump_dump_callconv_fdqvar,fd);});goto _LL34;}_LL34:;}
# 1204
Cyc_Absyndump_dump_char((int)'{');
...
({struct Cyc_List_List*_tmp36E=vds;struct _fat_ptr _tmp36D=({const char*_tmp27C=" let ";_tag_fat(_tmp27C,sizeof(char),6U);});struct _fat_ptr _tmp36C=({const char*_tmp27D=";";_tag_fat(_tmp27D,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpid,_tmp36E,_tmp36D,_tmp36C,({const char*_tmp27E=",";_tag_fat(_tmp27E,sizeof(char),2U);}));});goto _LL0;}case 2U: _LLD: _tmp269=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_tmp26A=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp25A)->f3;_LLE: {struct Cyc_Absyn_Pat*p=_tmp269;struct Cyc_Absyn_Exp*e=_tmp26A;
# 1214
...
if((unsigned)hides)
({struct Cyc_List_List*_tmp371=hides;struct _fat_ptr _tmp370=({const char*_tmp291=" cyclone_hide {";_tag_fat(_tmp291,sizeof(char),16U);});struct _fat_ptr _tmp36F=({const char*_tmp292="}";_tag_fat(_tmp292,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple0*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpqvar,_tmp371,_tmp370,_tmp36F,({const char*_tmp293=",";_tag_fat(_tmp293,sizeof(char),2U);}));});}}}else{
# 1256
({struct Cyc_List_List*_tmp374=exs;struct _fat_ptr _tmp373=({const char*_tmp294=" export {";_tag_fat(_tmp294,sizeof(char),10U);});struct _fat_ptr _tmp372=({const char*_tmp295="}";_tag_fat(_tmp295,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple23*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpexport,_tmp374,_tmp373,_tmp372,({const char*_tmp296=",";_tag_fat(_tmp296,sizeof(char),2U);}));});}
# 1258
...
return;}{
# 1279
void*_tmp29B=(void*)tms->hd;void*_stmttmp1B=_tmp29B;void*_tmp29C=_stmttmp1B;struct Cyc_Absyn_Tqual _tmp2A1;void*_tmp2A0;void*_tmp29F;void*_tmp29E;void*_tmp29D;if(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->tag == 2U){_LL1: _tmp29D=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f1).rgn;_tmp29E=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f1).nullable;_tmp29F=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f1).bounds;_tmp2A0=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f1).zero_term;_tmp2A1=((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f2;_LL2: {void*rgn=_tmp29D;void*nullable=_tmp29E;void*bd=_tmp29F;void*zt=_tmp2A0;struct Cyc_Absyn_Tqual tq2=_tmp2A1;
# 1283
{void*_tmp2A2=Cyc_Absyn_compress(bd);void*_stmttmp1C=_tmp2A2;void*_tmp2A3=_stmttmp1C;struct Cyc_Absyn_Exp*_tmp2A4;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A3)->tag == 0U)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A3)->f1)){case 14U: _LL6: _LL7:
 Cyc_Absyndump_dump_char((int)'?');goto _LL5;case 13U: if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A3)->f2 != 0){if(((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)((struct Cyc_List_List*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A3)->f2)->hd)->tag == 9U){_LL8: _tmp2A4=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A3)->f2)->hd)->f1;_LL9: {struct Cyc_Absyn_Exp*e=_tmp2A4;
# 1286
...
# 1290
if((!Cyc_Absyndump_qvar_to_Cids && !is_char_ptr)&& Cyc_Absyn_type2bool(0,zt))Cyc_Absyndump_dump(({const char*_tmp2A5="@zeroterm";_tag_fat(_tmp2A5,sizeof(char),10U);}));
if((!Cyc_Absyndump_qvar_to_Cids && is_char_ptr)&& !Cyc_Absyn_type2bool(0,zt))Cyc_Absyndump_dump(({const char*_tmp2A6="@nozeroterm";_tag_fat(_tmp2A6,sizeof(char),12U);}));
{void*_tmp2A7=Cyc_Absyn_compress(rgn);void*_stmttmp1D=_tmp2A7;void*_tmp2A8=_stmttmp1D;struct Cyc_Absyn_Tvar*_tmp2A9;switch(*((int*)_tmp2A8)){case 0U: switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A8)->f1)){case 5U: _LLD: _LLE:
 if(!Cyc_Absyndump_qvar_to_Cids)Cyc_Absyndump_dump(({const char*_tmp2AA="`H";_tag_fat(_tmp2AA,sizeof(char),3U);}));goto _LLC;case 6U: _LLF: _LL10:
 Cyc_Absyndump_dump(({const char*_tmp2AB="`U";_tag_fat(_tmp2AB,sizeof(char),3U);}));goto _LLC;case 7U: _LL11: _LL12:
 Cyc_Absyndump_dump(({const char*_tmp2AC="`RC";_tag_fat(_tmp2AC,sizeof(char),4U);}));goto _LLC;default: goto _LL19;}case 2U: _LL13: _tmp2A9=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp2A8)->f1;_LL14: {struct Cyc_Absyn_Tvar*tv=_tmp2A9;
Cyc_Absyndump_dumptvar(tv);goto _LLC;}case 1U: if(((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp2A8)->f2 == 0){_LL15: _LL16:
 Cyc_Absyndump_dumpntyp(Cyc_Absyn_compress(rgn));goto _LLC;}else{goto _LL19;}case 8U: _LL17: _LL18:
 Cyc_Absyndump_dump(({const char*_tmp2AD="@region(";_tag_fat(_tmp2AD,sizeof(char),9U);}));Cyc_Absyndump_dumptyp(rgn);Cyc_Absyndump_dump(({const char*_tmp2AE=")";_tag_fat(_tmp2AE,sizeof(char),2U);}));goto _LLC;default: _LL19: _LL1A:
({void*_tmp2AF=0U;({struct _fat_ptr _tmp375=({const char*_tmp2B0="dumptms: bad rgn type in Pointer_mod";_tag_fat(_tmp2B0,sizeof(char),37U);});Cyc_Warn_impos(_tmp375,_tag_fat(_tmp2AF,sizeof(void*),0U));});});}_LLC:;}
# 1301
...
if(tms->tl != 0){
void*_tmp2B1=(void*)((struct Cyc_List_List*)_check_null(tms->tl))->hd;void*_stmttmp1E=_tmp2B1;void*_tmp2B2=_stmttmp1E;if(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp2B2)->tag == 2U){_LL1C: _LL1D:
...
if(next_is_pointer)
Cyc_Absyndump_dump_char((int)')');
{void*_tmp2B3=(void*)tms->hd;void*_stmttmp1F=_tmp2B3;void*_tmp2B4=_stmttmp1F;struct Cyc_List_List*_tmp2B5;int _tmp2B8;unsigned _tmp2B7;struct Cyc_List_List*_tmp2B6;unsigned _tmp2BA;struct Cyc_List_List*_tmp2B9;struct Cyc_Absyn_Exp*_tmp2C1;struct Cyc_Absyn_Exp*_tmp2C0;struct Cyc_List_List*_tmp2BF;void*_tmp2BE;struct Cyc_Absyn_VarargInfo*_tmp2BD;int _tmp2BC;struct Cyc_List_List*_tmp2BB;void*_tmp2C3;struct Cyc_Absyn_Exp*_tmp2C2;void*_tmp2C4;switch(*((int*)_tmp2B4)){case 0U: _LL21: _tmp2C4=(void*)((struct Cyc_Absyn_Carray_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1;_LL22: {void*zeroterm=_tmp2C4;
# 1319
Cyc_Absyndump_dump(({const char*_tmp2C5="[]";_tag_fat(_tmp2C5,sizeof(char),3U);}));
if(Cyc_Absyn_type2bool(0,zeroterm))Cyc_Absyndump_dump(({const char*_tmp2C6="@zeroterm";_tag_fat(_tmp2C6,sizeof(char),10U);}));
goto _LL20;}case 1U: _LL23: _tmp2C2=((struct Cyc_Absyn_ConstArray_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1;_tmp2C3=(void*)((struct Cyc_Absyn_ConstArray_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f2;_LL24: {struct Cyc_Absyn_Exp*e=_tmp2C2;void*zeroterm=_tmp2C3;
# 1323
Cyc_Absyndump_dump_char((int)'[');Cyc_Absyndump_dumpexp(e);Cyc_Absyndump_dump_char((int)']');
if(Cyc_Absyn_type2bool(0,zeroterm))Cyc_Absyndump_dump(({const char*_tmp2C7="@zeroterm";_tag_fat(_tmp2C7,sizeof(char),10U);}));
goto _LL20;}case 3U: if(((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1)->tag == 1U){_LL25: _tmp2BB=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1)->f1;_tmp2BC=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1)->f2;_tmp2BD=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1)->f3;_tmp2BE=(void*)((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1)->f4;_tmp2BF=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1)->f5;_tmp2C0=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1)->f6;_tmp2C1=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1)->f7;_LL26: {struct Cyc_List_List*args=_tmp2BB;int c_varargs=_tmp2BC;struct Cyc_Absyn_VarargInfo*cyc_varargs=_tmp2BD;void*effopt=_tmp2BE;struct Cyc_List_List*rgn_po=_tmp2BF;struct Cyc_Absyn_Exp*req=_tmp2C0;struct Cyc_Absyn_Exp*ens=_tmp2C1;
# 1327
Cyc_Absyndump_dumpfunargs(args,c_varargs,cyc_varargs,effopt,rgn_po,req,ens);goto _LL20;}}else{_LL27: _tmp2B9=((struct Cyc_Absyn_NoTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1)->f1;_tmp2BA=((struct Cyc_Absyn_NoTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1)->f2;_LL28: {struct Cyc_List_List*sl=_tmp2B9;unsigned loc=_tmp2BA;
# 1329
({struct Cyc_List_List*_tmp378=sl;struct _fat_ptr _tmp377=({const char*_tmp2C8="(";_tag_fat(_tmp2C8,sizeof(char),2U);});struct _fat_ptr _tmp376=({const char*_tmp2C9=")";_tag_fat(_tmp2C9,sizeof(char),2U);});((void(*)(void(*f)(struct _fat_ptr*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dump_str,_tmp378,_tmp377,_tmp376,({const char*_tmp2CA=",";_tag_fat(_tmp2CA,sizeof(char),2U);}));});goto _LL20;}}case 4U: _LL29: _tmp2B6=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f1;_tmp2B7=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f2;_tmp2B8=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f3;_LL2A: {struct Cyc_List_List*ts=_tmp2B6;unsigned loc=_tmp2B7;int print_kinds=_tmp2B8;
# 1331
if(print_kinds)Cyc_Absyndump_dumpkindedtvars(ts);else{Cyc_Absyndump_dumptvars(ts);}goto _LL20;}case 5U: _LL2B: _tmp2B5=((struct Cyc_Absyn_Attributes_mod_Absyn_Type_modifier_struct*)_tmp2B4)->f2;_LL2C: {struct Cyc_List_List*atts=_tmp2B5;
Cyc_Absyndump_dumpatts(atts);goto _LL20;}default: _LL2D: _LL2E:
({void*_tmp2CB=0U;({struct _fat_ptr _tmp379=({const char*_tmp2CC="dumptms";_tag_fat(_tmp2CC,sizeof(char),8U);});Cyc_Warn_impos(_tmp379,_tag_fat(_tmp2CB,sizeof(void*),0U));});});}_LL20:;}
# 1335
return;}}_LL0:;}}
# 1339
static void Cyc_Absyndump_dumptqtd(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(void*),void*a){
int _tmp2CD=Cyc_Absyndump_is_char_ptr(t);int cp=_tmp2CD;
struct _RegionHandle _tmp2CE=_new_region("temp");struct _RegionHandle*temp=& _tmp2CE;_push_region(temp);
{struct _tuple12 _tmp2CF=Cyc_Absynpp_to_tms(temp,tq,t);struct _tuple12 _stmttmp20=_tmp2CF;struct _tuple12 _tmp2D0=_stmttmp20;struct Cyc_List_List*_tmp2D3;void*_tmp2D2;struct Cyc_Absyn_Tqual _tmp2D1;_LL1: _tmp2D1=_tmp2D0.f1;_tmp2D2=_tmp2D0.f2;_tmp2D3=_tmp2D0.f3;_LL2: {struct Cyc_Absyn_Tqual tq=_tmp2D1;void*t=_tmp2D2;struct Cyc_List_List*tms=_tmp2D3;
Cyc_Absyndump_dumptq(tq);
Cyc_Absyndump_dumpntyp(t);
({int _tmp37C=cp;struct Cyc_List_List*_tmp37B=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(tms);void(*_tmp37A)(void*)=f;Cyc_Absyndump_dumptms(_tmp37C,_tmp37B,_tmp37A,a);});}}
# 1342
;_pop_region();}
# 1348
...
for(0;tdl != 0;tdl=tdl->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)tdl->hd);}
({void*_tmp2D4=0U;({struct Cyc___cycFILE*_tmp37E=f;struct _fat_ptr _tmp37D=({const char*_tmp2D5="\n";_tag_fat(_tmp2D5,sizeof(char),2U);});Cyc_fprintf(_tmp37E,_tmp37D,_tag_fat(_tmp2D4,sizeof(void*),0U));});});}
# 1356
static void Cyc_Absyndump_dump_decl_interface(struct Cyc_Absyn_Decl*d){
void*_tmp2D6=d->r;void*_stmttmp21=_tmp2D6;void*_tmp2D7=_stmttmp21;struct _tuple10*_tmp2DB;struct Cyc_List_List*_tmp2DA;struct Cyc_List_List*_tmp2D9;struct Cyc_List_List*_tmp2D8;struct Cyc_List_List*_tmp2DC;struct Cyc_List_List*_tmp2DD;struct Cyc_List_List*_tmp2DF;struct _fat_ptr*_tmp2DE;struct Cyc_Absyn_Typedefdecl*_tmp2E0;struct Cyc_Absyn_Enumdecl*_tmp2E1;struct Cyc_Absyn_Datatypedecl*_tmp2E2;struct Cyc_Absyn_Aggrdecl*_tmp2E3;struct Cyc_Absyn_Fndecl*_tmp2E4;struct Cyc_Absyn_Vardecl*_tmp2E5;switch(*((int*)_tmp2D7)){case 0U: _LL1: _tmp2E5=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp2D7)->f1;_LL2: {struct Cyc_Absyn_Vardecl*vd=_tmp2E5;
# 1359
if((int)vd->sc == (int)Cyc_Absyn_Static)return;{
struct Cyc_Absyn_Exp*init=vd->initializer;
vd->initializer=0;
if((int)vd->sc == (int)Cyc_Absyn_Public)
Cyc_Absyndump_dump(({const char*_tmp2E6="extern ";_tag_fat(_tmp2E6,sizeof(char),8U);}));else{
if(!vd->is_proto){
void*_tmp2E7=Cyc_Absyn_compress(vd->type);void*_stmttmp22=_tmp2E7;void*_tmp2E8=_stmttmp22;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp2E8)->tag == 5U){_LL18: _LL19:
 Cyc_Absyndump_dump(({const char*_tmp2E9="extern ";_tag_fat(_tmp2E9,sizeof(char),8U);}));goto _LL17;}else{_LL1A: _LL1B:
 goto _LL17;}_LL17:;}}
# 1369
Cyc_Absyndump_dumpvardecl(vd,d->loc,1);
Cyc_Absyndump_dump(({const char*_tmp2EA="\n";_tag_fat(_tmp2EA,sizeof(char),2U);}));
vd->initializer=init;
goto _LL0;}}case 1U: _LL3: _tmp2E4=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp2D7)->f1;_LL4: {struct Cyc_Absyn_Fndecl*fd=_tmp2E4;
# 1374
if((int)fd->sc == (int)Cyc_Absyn_Static)return;
Cyc_Absyndump_dumpscope(fd->sc);{
struct Cyc_Absyn_FnInfo type_info=fd->i;
type_info.attributes=0;{
void*t=(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp2EC=_cycalloc(sizeof(*_tmp2EC));_tmp2EC->tag=5U,_tmp2EC->f1=type_info;_tmp2EC;});
({struct Cyc_Absyn_Tqual _tmp380=Cyc_Absyn_empty_tqual(0U);void*_tmp37F=t;((void(*)(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*a))Cyc_Absyndump_dumptqtd)(_tmp380,_tmp37F,Cyc_Absyndump_dump_atts_qvar,fd);});
Cyc_Absyndump_dump(({const char*_tmp2EB=";\n";_tag_fat(_tmp2EB,sizeof(char),3U);}));
goto _LL0;}}}case 6U: _LL5: _tmp2E3=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp2D7)->f1;_LL6: {struct Cyc_Absyn_Aggrdecl*ad=_tmp2E3;
# 1383
...
goto _LL0;}}case 7U: _LL7: _tmp2E2=((struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp2D7)->f1;_LL8: {struct Cyc_Absyn_Datatypedecl*dd=_tmp2E2;
Cyc_Absyndump_dump_datatypedecl(dd);Cyc_Absyndump_dump(({const char*_tmp2EE=";\n";_tag_fat(_tmp2EE,sizeof(char),3U);}));goto _LL0;}case 8U: _LL9: _tmp2E1=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp2D7)->f1;_LLA: {struct Cyc_Absyn_Enumdecl*ed=_tmp2E1;
Cyc_Absyndump_dump_enumdecl(ed);Cyc_Absyndump_dump(({const char*_tmp2EF=";\n";_tag_fat(_tmp2EF,sizeof(char),3U);}));goto _LL0;}case 9U: _LLB: _tmp2E0=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp2D7)->f1;_LLC: {struct Cyc_Absyn_Typedefdecl*td=_tmp2E0;
# 1393
if(td->defn == 0){
Cyc_Absyndump_dumpdecl(d);
Cyc_Absyndump_dump(({const char*_tmp2F0="\n";_tag_fat(_tmp2F0,sizeof(char),2U);}));}
# 1397
goto _LL0;}case 10U: _LLD: _tmp2DE=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp2D7)->f1;_tmp2DF=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp2D7)->f2;_LLE: {struct _fat_ptr*v=_tmp2DE;struct Cyc_List_List*ds=_tmp2DF;
# 1399
Cyc_Absyndump_dump(({const char*_tmp2F1="namespace ";_tag_fat(_tmp2F1,sizeof(char),11U);}));
Cyc_Absyndump_dump_str(v);
Cyc_Absyndump_dump(({const char*_tmp2F2="{\n";_tag_fat(_tmp2F2,sizeof(char),3U);}));
for(0;ds != 0;ds=ds->tl){
...
goto _LL0;}case 11U: _LLF: _tmp2DD=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp2D7)->f2;_LL10: {struct Cyc_List_List*ds=_tmp2DD;
# 1407
for(0;ds != 0;ds=ds->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)ds->hd);}
goto _LL0;}case 12U: _LL11: _tmp2DC=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp2D7)->f1;_LL12: {struct Cyc_List_List*ds=_tmp2DC;
# 1411
Cyc_Absyndump_dump(({const char*_tmp2F4="extern \"C\" {";_tag_fat(_tmp2F4,sizeof(char),13U);}));
for(0;ds != 0;ds=ds->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)ds->hd);}
Cyc_Absyndump_dump(({const char*_tmp2F5="}\n";_tag_fat(_tmp2F5,sizeof(char),3U);}));
goto _LL0;}case 13U: _LL13: _tmp2D8=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2D7)->f1;_tmp2D9=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2D7)->f2;_tmp2DA=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2D7)->f3;_tmp2DB=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2D7)->f4;_LL14: {struct Cyc_List_List*ds=_tmp2D8;struct Cyc_List_List*ovrs=_tmp2D9;struct Cyc_List_List*exs=_tmp2DA;struct _tuple10*wc=_tmp2DB;
# 1432 "absyndump.cyc"
goto _LL0;}default: _LL15: _LL16:
({void*_tmp2F6=0U;({struct _fat_ptr _tmp381=({const char*_tmp2F7="bad top-level declaration";_tag_fat(_tmp2F7,sizeof(char),26U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp381,_tag_fat(_tmp2F6,sizeof(void*),0U));});});}_LL0:;}
# 1437
