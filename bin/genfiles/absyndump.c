...
if(({char*_tmp30C=(char*)_tmpD.curr;_tmp30C == (char*)(_tag_dyneither(0,0,0)).curr;}) || (char*)_tmpD.curr == (char*)last_file.curr  && _tmpC == last_line)return;
if((char*)_tmpD.curr == (char*)last_file.curr  && _tmpC == last_line + (unsigned int)1)
({void*_tmp3=0U;({struct Cyc___cycFILE*_tmp30E=*Cyc_Absyndump_dump_file;struct _dyneither_ptr _tmp30D=({const char*_tmp4="\n";_tag_dyneither(_tmp4,sizeof(char),2U);});Cyc_fprintf(_tmp30E,_tmp30D,_tag_dyneither(_tmp3,sizeof(void*),0U));});});else{
if((char*)_tmpD.curr == (char*)last_file.curr)
({struct Cyc_Int_pa_PrintArg_struct _tmp7=({struct Cyc_Int_pa_PrintArg_struct _tmp2FF;_tmp2FF.tag=1U,_tmp2FF.f1=(unsigned long)((int)_tmpC);_tmp2FF;});void*_tmp5[1U];_tmp5[0]=& _tmp7;({struct Cyc___cycFILE*_tmp310=*Cyc_Absyndump_dump_file;struct _dyneither_ptr _tmp30F=({const char*_tmp6="\n# %d\n";_tag_dyneither(_tmp6,sizeof(char),7U);});Cyc_fprintf(_tmp310,_tmp30F,_tag_dyneither(_tmp5,sizeof(void*),1U));});});else{
# 165
({struct Cyc_Int_pa_PrintArg_struct _tmpA=({struct Cyc_Int_pa_PrintArg_struct _tmp301;_tmp301.tag=1U,_tmp301.f1=(unsigned long)((int)_tmpC);_tmp301;});struct Cyc_String_pa_PrintArg_struct _tmpB=({struct Cyc_String_pa_PrintArg_struct _tmp300;_tmp300.tag=0U,_tmp300.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpD);_tmp300;});void*_tmp8[2U];_tmp8[0]=& _tmpA,_tmp8[1]=& _tmpB;({struct Cyc___cycFILE*_tmp312=*Cyc_Absyndump_dump_file;struct _dyneither_ptr _tmp311=({const char*_tmp9="\n# %d %s\n";_tag_dyneither(_tmp9,sizeof(char),10U);});Cyc_fprintf(_tmp312,_tmp311,_tag_dyneither(_tmp8,sizeof(void*),2U));});});}}
# 167
last_file=_tmpD;
last_line=_tmpC;};}
# 173
...
# 286
enum Cyc_Absyn_AliasQual _tmp24=_tmp38;switch(_tmp24){case Cyc_Absyn_Aliasable: _LL17: _LL18:
 Cyc_Absyndump_dump(({const char*_tmp25="A";_tag_dyneither(_tmp25,sizeof(char),2U);}));return;case Cyc_Absyn_Unique: _LL19: _LL1A:
 Cyc_Absyndump_dump(({const char*_tmp26="UA";_tag_dyneither(_tmp26,sizeof(char),3U);}));return;case Cyc_Absyn_Top: _LL1B: _LL1C:
 goto _LL1E;default: _LL1D: _LL1E: Cyc_Absyndump_dump(({const char*_tmp27="TA";_tag_dyneither(_tmp27,sizeof(char),3U);}));return;}_LL16:;}case Cyc_Absyn_MemKind: _LL6: _LL7: {
# 292
enum Cyc_Absyn_AliasQual _tmp28=_tmp38;switch(_tmp28){case Cyc_Absyn_Aliasable: _LL20: _LL21:
 Cyc_Absyndump_dump(({const char*_tmp29="M";_tag_dyneither(_tmp29,sizeof(char),2U);}));return;case Cyc_Absyn_Unique: _LL22: _LL23:
 Cyc_Absyndump_dump(({const char*_tmp2A="UM";_tag_dyneither(_tmp2A,sizeof(char),3U);}));return;case Cyc_Absyn_Top: _LL24: _LL25:
 goto _LL27;default: _LL26: _LL27: Cyc_Absyndump_dump(({const char*_tmp2B="TM";_tag_dyneither(_tmp2B,sizeof(char),3U);}));return;}_LL1F:;}case Cyc_Absyn_BoxKind: _LL8: _LL9: {
# 298
enum Cyc_Absyn_AliasQual _tmp2C=_tmp38;switch(_tmp2C){case Cyc_Absyn_Aliasable: _LL29: _LL2A:
 Cyc_Absyndump_dump(({const char*_tmp2D="B";_tag_dyneither(_tmp2D,sizeof(char),2U);}));return;case Cyc_Absyn_Unique: _LL2B: _LL2C:
 Cyc_Absyndump_dump(({const char*_tmp2E="UB";_tag_dyneither(_tmp2E,sizeof(char),3U);}));return;case Cyc_Absyn_Top: _LL2D: _LL2E:
 goto _LL30;default: _LL2F: _LL30: Cyc_Absyndump_dump(({const char*_tmp2F="TB";_tag_dyneither(_tmp2F,sizeof(char),3U);}));return;}_LL28:;}case Cyc_Absyn_RgnKind: _LLA: _LLB: {
# 304
enum Cyc_Absyn_AliasQual _tmp30=_tmp38;switch(_tmp30){case Cyc_Absyn_Aliasable: _LL32: _LL33:
 Cyc_Absyndump_dump(({const char*_tmp31="R";_tag_dyneither(_tmp31,sizeof(char),2U);}));return;case Cyc_Absyn_Unique: _LL34: _LL35:
 Cyc_Absyndump_dump(({const char*_tmp32="UR";_tag_dyneither(_tmp32,sizeof(char),3U);}));return;case Cyc_Absyn_Top: _LL36: _LL37:
 goto _LL39;default: _LL38: _LL39: Cyc_Absyndump_dump(({const char*_tmp33="TR";_tag_dyneither(_tmp33,sizeof(char),3U);}));return;}_LL31:;}case Cyc_Absyn_EffKind: _LLC: _LLD:
# 309
 ...
 Cyc_Absyndump_dump(({const char*_tmp36="BOOL";_tag_dyneither(_tmp36,sizeof(char),5U);}));return;case Cyc_Absyn_PtrBndKind: _LL12: _LL13:
 goto _LL15;default: _LL14: _LL15: Cyc_Absyndump_dump(({const char*_tmp37="PTRBND";_tag_dyneither(_tmp37,sizeof(char),7U);}));return;}_LL3:;};}
# 316
void Cyc_Absyndump_dumpaggr_kind(enum Cyc_Absyn_AggrKind k){
enum Cyc_Absyn_AggrKind _tmp3A=k;switch(_tmp3A){case Cyc_Absyn_StructA: _LL1: _LL2:
 Cyc_Absyndump_dump(({const char*_tmp3B="struct ";_tag_dyneither(_tmp3B,sizeof(char),8U);}));return;case Cyc_Absyn_UnionA: _LL3: _LL4:
 goto _LL6;default: _LL5: _LL6: Cyc_Absyndump_dump(({const char*_tmp3C="union ";_tag_dyneither(_tmp3C,sizeof(char),7U);}));return;}_LL0:;}
# 323
void Cyc_Absyndump_dumptps(struct Cyc_List_List*ts){
({struct Cyc_List_List*_tmp315=ts;struct _dyneither_ptr _tmp314=({const char*_tmp3D="<";_tag_dyneither(_tmp3D,sizeof(char),2U);});struct _dyneither_ptr _tmp313=({const char*_tmp3E=">";_tag_dyneither(_tmp3E,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptyp,_tmp315,_tmp314,_tmp313,({const char*_tmp3F=",";_tag_dyneither(_tmp3F,sizeof(char),2U);}));});}
# 326
...
({struct Cyc_List_List*_tmp318=tvs;struct _dyneither_ptr _tmp317=({const char*_tmp4B="<";_tag_dyneither(_tmp4B,sizeof(char),2U);});struct _dyneither_ptr _tmp316=({const char*_tmp4C=">";_tag_dyneither(_tmp4C,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp318,_tmp317,_tmp316,({const char*_tmp4D=",";_tag_dyneither(_tmp4D,sizeof(char),2U);}));});}
# 351
void Cyc_Absyndump_dumpkindedtvars(struct Cyc_List_List*tvs){
({struct Cyc_List_List*_tmp31B=tvs;struct _dyneither_ptr _tmp31A=({const char*_tmp4E="<";_tag_dyneither(_tmp4E,sizeof(char),2U);});struct _dyneither_ptr _tmp319=({const char*_tmp4F=">";_tag_dyneither(_tmp4F,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,_tmp31B,_tmp31A,_tmp319,({const char*_tmp50=",";_tag_dyneither(_tmp50,sizeof(char),2U);}));});}struct _tuple14{struct Cyc_Absyn_Tqual f1;void*f2;};
# 355
...
({struct Cyc_List_List*_tmp31E=ts;struct _dyneither_ptr _tmp31D=({const char*_tmp51="(";_tag_dyneither(_tmp51,sizeof(char),2U);});struct _dyneither_ptr _tmp31C=({const char*_tmp52=")";_tag_dyneither(_tmp52,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple14*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumparg,_tmp31E,_tmp31D,_tmp31C,({const char*_tmp53=",";_tag_dyneither(_tmp53,sizeof(char),2U);}));});}
# 362
...
{void*_tmp62=Cyc_Tcutil_compress(t);void*_tmp63=_tmp62;struct Cyc_List_List*_tmp6B;void*_tmp6A;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp63)->tag == 0U)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp63)->f1)){case 8U: if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp63)->f2 != 0){_LL1: _tmp6A=(void*)(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp63)->f2)->hd;_LL2:
 rgions=({struct Cyc_List_List*_tmp64=_cycalloc(sizeof(*_tmp64));_tmp64->hd=_tmp6A,_tmp64->tl=rgions;_tmp64;});goto _LL0;}else{goto _LL5;}case 9U: _LL3: _tmp6B=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp63)->f2;_LL4:
# 423
...
effects=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp67,effects);}
# 428
goto _LL0;default: goto _LL5;}else{_LL5: _LL6:
 effects=({struct Cyc_List_List*_tmp69=_cycalloc(sizeof(*_tmp69));_tmp69->hd=t,_tmp69->tl=effects;_tmp69;});goto _LL0;}_LL0:;}
# 431
return({struct _tuple15 _tmp302;_tmp302.f1=rgions,_tmp302.f2=effects;_tmp302;});}
# 434
...
# 507
 goto _LL24;case Cyc_Absyn_LongLong_sz: _LL2B: _LL2C:
# 513
 goto _LL2E;default: goto _LL63;}case Cyc_Absyn_Signed: switch(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp71)->f1)->f2){case Cyc_Absyn_Int_sz: _LL15: _LL16:
# 501
...
# 508
 Cyc_Absyndump_dump(({const char*_tmp8E="short";_tag_dyneither(_tmp8E,sizeof(char),6U);}));return;case Cyc_Absyn_LongLong_sz: _LL2D: _LL2E: {
# 515
enum Cyc_Cyclone_C_Compilers _tmp92=Cyc_Cyclone_c_compiler;if(_tmp92 == Cyc_Cyclone_Gcc_c){_LL70: _LL71:
 ...
 Cyc_Absyndump_dump(({const char*_tmp94="__int64";_tag_dyneither(_tmp94,sizeof(char),8U);}));return;}_LL6F:;}default: goto _LL63;}case Cyc_Absyn_Unsigned: switch(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp71)->f1)->f2){case Cyc_Absyn_Char_sz: _LL1F: _LL20:
# 506
...
# 510
 ...
 Cyc_Absyndump_dump(({const char*_tmp91="unsigned long";_tag_dyneither(_tmp91,sizeof(char),14U);}));return;case Cyc_Absyn_LongLong_sz: _LL2F: _LL30: {
# 520
enum Cyc_Cyclone_C_Compilers _tmp95=Cyc_Cyclone_c_compiler;if(_tmp95 == Cyc_Cyclone_Vc_c){_LL75: _LL76:
 ...
 Cyc_Absyndump_dump(({const char*_tmp97="unsigned long long";_tag_dyneither(_tmp97,sizeof(char),19U);}));return;}_LL74:;}default: goto _LL63;}default: goto _LL63;}case 2U: _LL31: _tmpBC=((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp71)->f1)->f1;_LL32:
# 525
 if(_tmpBC == 0)
...
# 575
(int)_throw((void*)({struct Cyc_Core_Failure_exn_struct*_tmpB7=_cycalloc(sizeof(*_tmpB7));_tmpB7->tag=Cyc_Core_Failure,({struct _dyneither_ptr _tmp31F=({const char*_tmpB6="bad type constructor";_tag_dyneither(_tmpB6,sizeof(char),21U);});_tmpB7->f1=_tmp31F;});_tmpB7;}));}case 9U: _LL59: _tmpC6=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp71)->f2;_LL5A:
# 565
...
Cyc_Absyndump_dump((struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp77=({struct Cyc_Int_pa_PrintArg_struct _tmp303;_tmp303.tag=1U,_tmp303.f1=(unsigned long)_tmpC8;_tmp303;});void*_tmp75[1U];_tmp75[0]=& _tmp77;({struct _dyneither_ptr _tmp320=({const char*_tmp76="%d";_tag_dyneither(_tmp76,sizeof(char),3U);});Cyc_aprintf(_tmp320,_tag_dyneither(_tmp75,sizeof(void*),1U));});}));return;}else{_LLD: _tmpCC=((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp71)->f1;_tmpCB=(void*)((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp71)->f2;_tmpCA=((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp71)->f3;_LLE:
...
({struct Cyc_List_List*_tmp321=rgn_po;((void(*)(void(*f)(struct _tuple16*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dump_rgncmp,_tmp321,({const char*_tmpDA=",";_tag_dyneither(_tmpDA,sizeof(char),2U);}));});}
# 592
...
({struct Cyc_Absyn_Tqual _tmp322=Cyc_Absyn_empty_tqual(0U);((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(int),int))Cyc_Absyndump_dumptqtd)(_tmp322,t,(void(*)(int x))Cyc_Absyndump_ignore,0);});}
# 634
...
({struct Cyc_List_List*_tmp325=(*de).f1;struct _dyneither_ptr _tmp324=({const char*_tmpE6="";_tag_dyneither(_tmpE6,sizeof(char),1U);});struct _dyneither_ptr _tmp323=({const char*_tmpE7="=";_tag_dyneither(_tmpE7,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,_tmp325,_tmp324,_tmp323,({const char*_tmpE8="=";_tag_dyneither(_tmpE8,sizeof(char),2U);}));});
Cyc_Absyndump_dumpexp((*de).f2);}
# 646
void Cyc_Absyndump_dumpexps_prec(int inprec,struct Cyc_List_List*es){
({int _tmp329=inprec;struct Cyc_List_List*_tmp328=es;struct _dyneither_ptr _tmp327=({const char*_tmpE9="";_tag_dyneither(_tmpE9,sizeof(char),1U);});struct _dyneither_ptr _tmp326=({const char*_tmpEA="";_tag_dyneither(_tmpEA,sizeof(char),1U);});((void(*)(void(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group_c)(Cyc_Absyndump_dumpexp_prec,_tmp329,_tmp328,_tmp327,_tmp326,({const char*_tmpEB=",";_tag_dyneither(_tmpEB,sizeof(char),2U);}));});}
# 650
...
goto _LL0;case 3U: _LL3: _tmp144=((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpEE)->f1).Wchar_c).val;_LL4:
 Cyc_Absyndump_dump((struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpF1=({struct Cyc_String_pa_PrintArg_struct _tmp304;_tmp304.tag=0U,_tmp304.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp144);_tmp304;});void*_tmpEF[1U];_tmpEF[0]=& _tmpF1;({struct _dyneither_ptr _tmp32A=({const char*_tmpF0="L'%s'";_tag_dyneither(_tmpF0,sizeof(char),6U);});Cyc_aprintf(_tmp32A,_tag_dyneither(_tmpEF,sizeof(void*),1U));});}));goto _LL0;case 4U: _LL5: _tmp146=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpEE)->f1).Short_c).val).f1;_tmp145=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpEE)->f1).Short_c).val).f2;_LL6:
 Cyc_Absyndump_dump((struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpF4=({struct Cyc_Int_pa_PrintArg_struct _tmp305;_tmp305.tag=1U,_tmp305.f1=(unsigned long)((int)_tmp145);_tmp305;});void*_tmpF2[1U];_tmpF2[0]=& _tmpF4;({struct _dyneither_ptr _tmp32B=({const char*_tmpF3="%d";_tag_dyneither(_tmpF3,sizeof(char),3U);});Cyc_aprintf(_tmp32B,_tag_dyneither(_tmpF2,sizeof(void*),1U));});}));goto _LL0;case 5U: switch((((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpEE)->f1).Int_c).val).f1){case Cyc_Absyn_None: _LL7: _tmp147=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpEE)->f1).Int_c).val).f2;_LL8:
 ...
 Cyc_Absyndump_dump((struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpF7=({struct Cyc_Int_pa_PrintArg_struct _tmp306;_tmp306.tag=1U,_tmp306.f1=(unsigned long)_tmp148;_tmp306;});void*_tmpF5[1U];_tmpF5[0]=& _tmpF7;({struct _dyneither_ptr _tmp32C=({const char*_tmpF6="%d";_tag_dyneither(_tmpF6,sizeof(char),3U);});Cyc_aprintf(_tmp32C,_tag_dyneither(_tmpF5,sizeof(void*),1U));});}));goto _LL0;default: _LLB: _tmp149=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpEE)->f1).Int_c).val).f2;_LLC:
 Cyc_Absyndump_dump((struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpFA=({struct Cyc_Int_pa_PrintArg_struct _tmp307;_tmp307.tag=1U,_tmp307.f1=(unsigned int)_tmp149;_tmp307;});void*_tmpF8[1U];_tmpF8[0]=& _tmpFA;({struct _dyneither_ptr _tmp32D=({const char*_tmpF9="%uU";_tag_dyneither(_tmpF9,sizeof(char),4U);});Cyc_aprintf(_tmp32D,_tag_dyneither(_tmpF8,sizeof(void*),1U));});}));goto _LL0;}case 6U: _LLD: _tmp14B=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpEE)->f1).LongLong_c).val).f1;_tmp14A=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpEE)->f1).LongLong_c).val).f2;_LLE:
# 665
...
# 699
(int)_throw((void*)({struct Cyc_Core_Failure_exn_struct*_tmp104=_cycalloc(sizeof(*_tmp104));_tmp104->tag=Cyc_Core_Failure,({struct _dyneither_ptr _tmp32E=({const char*_tmp103="Absyndump -- Bad number of arguments to primop";_tag_dyneither(_tmp103,sizeof(char),47U);});_tmp104->f1=_tmp32E;});_tmp104;}));}_LL6F:;}
# 701
...
(old_generate_line_directives  && !(e->loc == (unsigned int)0)) && !(_tmp164->loc == (unsigned int)0);
...
# 805
 Cyc_Absyndump_dump((struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp11C=({struct Cyc_Int_pa_PrintArg_struct _tmp308;_tmp308.tag=1U,_tmp308.f1=(unsigned long)((int)_tmp11E);_tmp308;});void*_tmp11A[1U];_tmp11A[0]=& _tmp11C;({struct _dyneither_ptr _tmp32F=({const char*_tmp11B="%d";_tag_dyneither(_tmp11B,sizeof(char),3U);});Cyc_aprintf(_tmp32F,_tag_dyneither(_tmp11A,sizeof(void*),1U));});}));
goto _LL76;}_LL76:;}
# 808
...
Cyc_Absyndump_dump_char((int)')');
({struct Cyc_List_List*_tmp332=_tmp17F;struct _dyneither_ptr _tmp331=({const char*_tmp121="{";_tag_dyneither(_tmp121,sizeof(char),2U);});struct _dyneither_ptr _tmp330=({const char*_tmp122="}";_tag_dyneither(_tmp122,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp332,_tmp331,_tmp330,({const char*_tmp123=",";_tag_dyneither(_tmp123,sizeof(char),2U);}));});
goto _LL0;case 26U: _LL57: _tmp181=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmpEE)->f1;_LL58:
# 839
({struct Cyc_List_List*_tmp335=_tmp181;struct _dyneither_ptr _tmp334=({const char*_tmp124="{";_tag_dyneither(_tmp124,sizeof(char),2U);});struct _dyneither_ptr _tmp333=({const char*_tmp125="}";_tag_dyneither(_tmp125,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp335,_tmp334,_tmp333,({const char*_tmp126=",";_tag_dyneither(_tmp126,sizeof(char),2U);}));});
...
({struct Cyc_List_List*_tmp338=_tmp187;struct _dyneither_ptr _tmp337=({const char*_tmp129="";_tag_dyneither(_tmp129,sizeof(char),1U);});struct _dyneither_ptr _tmp336=({const char*_tmp12A="}";_tag_dyneither(_tmp12A,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp338,_tmp337,_tmp336,({const char*_tmp12B=",";_tag_dyneither(_tmp12B,sizeof(char),2U);}));});
goto _LL0;case 30U: _LL5F: _tmp18A=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmpEE)->f2;_LL60:
# 861
({struct Cyc_List_List*_tmp33B=_tmp18A;struct _dyneither_ptr _tmp33A=({const char*_tmp12C="{";_tag_dyneither(_tmp12C,sizeof(char),2U);});struct _dyneither_ptr _tmp339=({const char*_tmp12D="}";_tag_dyneither(_tmp12D,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp33B,_tmp33A,_tmp339,({const char*_tmp12E=",";_tag_dyneither(_tmp12E,sizeof(char),2U);}));});
...
if(_tmp18C != 0)({struct Cyc_List_List*_tmp33E=_tmp18C;struct _dyneither_ptr _tmp33D=({const char*_tmp12F="(";_tag_dyneither(_tmp12F,sizeof(char),2U);});struct _dyneither_ptr _tmp33C=({const char*_tmp130=")";_tag_dyneither(_tmp130,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Exp*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpexp,_tmp33E,_tmp33D,_tmp33C,({const char*_tmp131=",";_tag_dyneither(_tmp131,sizeof(char),2U);}));});
...
# 896
if(_tmp191 != 0)
Cyc_Absyndump_dumpexp(({struct Cyc_Absyn_Exp*_tmp33F=Cyc_Absyn_sizeoftype_exp(*_tmp191,0U);Cyc_Absyn_times_exp(_tmp33F,_tmp190,0U);}));else{
# 899
Cyc_Absyndump_dumpexp(_tmp190);}
...
# 912
({struct Cyc_List_List*_tmp342=_tmp196;struct _dyneither_ptr _tmp341=({const char*_tmp13D="{";_tag_dyneither(_tmp13D,sizeof(char),2U);});struct _dyneither_ptr _tmp340=({const char*_tmp13E="}";_tag_dyneither(_tmp13E,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp342,_tmp341,_tmp340,({const char*_tmp13F=",";_tag_dyneither(_tmp13F,sizeof(char),2U);}));});
...
({struct Cyc_List_List*_tmp345=(*dp).f1;struct _dyneither_ptr _tmp344=({const char*_tmp1D6="";_tag_dyneither(_tmp1D6,sizeof(char),1U);});struct _dyneither_ptr _tmp343=({const char*_tmp1D7="=";_tag_dyneither(_tmp1D7,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,_tmp345,_tmp344,_tmp343,({const char*_tmp1D8="=";_tag_dyneither(_tmp1D8,sizeof(char),2U);}));});
...
void*_tmp1D9=p->r;void*_tmp1DA=_tmp1D9;struct Cyc_Absyn_Exp*_tmp22B;struct Cyc_Absyn_Enumfield*_tmp22A;struct Cyc_Absyn_Enumfield*_tmp229;struct Cyc_Absyn_Datatypefield*_tmp228;struct Cyc_List_List*_tmp227;int _tmp226;struct Cyc_List_List*_tmp225;struct Cyc_List_List*_tmp224;int _tmp223;union Cyc_Absyn_AggrInfo _tmp222;struct Cyc_List_List*_tmp221;struct Cyc_List_List*_tmp220;int _tmp21F;struct _tuple0*_tmp21E;struct Cyc_List_List*_tmp21D;int _tmp21C;struct _tuple0*_tmp21B;struct Cyc_Absyn_Tvar*_tmp21A;struct Cyc_Absyn_Vardecl*_tmp219;struct Cyc_Absyn_Vardecl*_tmp218;struct Cyc_Absyn_Pat*_tmp217;struct Cyc_Absyn_Vardecl*_tmp216;struct Cyc_Absyn_Pat*_tmp215;struct Cyc_List_List*_tmp214;int _tmp213;struct Cyc_Absyn_Tvar*_tmp212;struct Cyc_Absyn_Vardecl*_tmp211;struct Cyc_Absyn_Vardecl*_tmp210;struct Cyc_Absyn_Pat*_tmp20F;struct Cyc_Absyn_Vardecl*_tmp20E;struct _dyneither_ptr _tmp20D;char _tmp20C;int _tmp20B;int _tmp20A;int _tmp209;switch(*((int*)_tmp1DA)){case 0U: _LL1: _LL2:
 ...
 Cyc_Absyndump_dump((struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp1DE=({struct Cyc_Int_pa_PrintArg_struct _tmp309;_tmp309.tag=1U,_tmp309.f1=(unsigned long)_tmp20A;_tmp309;});void*_tmp1DC[1U];_tmp1DC[0]=& _tmp1DE;({struct _dyneither_ptr _tmp346=({const char*_tmp1DD="%d";_tag_dyneither(_tmp1DD,sizeof(char),3U);});Cyc_aprintf(_tmp346,_tag_dyneither(_tmp1DC,sizeof(void*),1U));});}));goto _LL0;default: _LL9: _tmp20B=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1DA)->f2;_LLA:
 Cyc_Absyndump_dump((struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp1E1=({struct Cyc_Int_pa_PrintArg_struct _tmp30A;_tmp30A.tag=1U,_tmp30A.f1=(unsigned int)_tmp20B;_tmp30A;});void*_tmp1DF[1U];_tmp1DF[0]=& _tmp1E1;({struct _dyneither_ptr _tmp347=({const char*_tmp1E0="%u";_tag_dyneither(_tmp1E0,sizeof(char),3U);});Cyc_aprintf(_tmp347,_tag_dyneither(_tmp1DF,sizeof(void*),1U));});}));goto _LL0;}case 11U: _LLB: _tmp20C=((struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp1DA)->f1;_LLC:
# 1050
...
({struct Cyc_List_List*_tmp34A=_tmp214;struct _dyneither_ptr _tmp349=({const char*_tmp1E8="$(";_tag_dyneither(_tmp1E8,sizeof(char),3U);});struct _dyneither_ptr _tmp348=term;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp34A,_tmp349,_tmp348,({const char*_tmp1E9=",";_tag_dyneither(_tmp1E9,sizeof(char),2U);}));});goto _LL0;}case 6U: _LL17: _tmp215=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp1DA)->f1;_LL18:
...
Cyc_Absyndump_dumpqvar(_tmp21E);({struct Cyc_List_List*_tmp34D=_tmp21D;struct _dyneither_ptr _tmp34C=({const char*_tmp1F0="(";_tag_dyneither(_tmp1F0,sizeof(char),2U);});struct _dyneither_ptr _tmp34B=term;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp34D,_tmp34C,_tmp34B,({const char*_tmp1F1=",";_tag_dyneither(_tmp1F1,sizeof(char),2U);}));});goto _LL0;}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1DA)->f1 != 0){_LL23: _tmp222=*((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1DA)->f1;_tmp221=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1DA)->f2;_tmp220=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1DA)->f3;_tmp21F=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1DA)->f4;_LL24: {
# 1074
...
({struct Cyc_List_List*_tmp350=_tmp221;struct _dyneither_ptr _tmp34F=({const char*_tmp1F6="[";_tag_dyneither(_tmp1F6,sizeof(char),2U);});struct _dyneither_ptr _tmp34E=({const char*_tmp1F7="]";_tag_dyneither(_tmp1F7,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp350,_tmp34F,_tmp34E,({const char*_tmp1F8=",";_tag_dyneither(_tmp1F8,sizeof(char),2U);}));});
({struct Cyc_List_List*_tmp353=_tmp220;struct _dyneither_ptr _tmp352=({const char*_tmp1F9="";_tag_dyneither(_tmp1F9,sizeof(char),1U);});struct _dyneither_ptr _tmp351=term;((void(*)(void(*f)(struct _tuple18*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpdp,_tmp353,_tmp352,_tmp351,({const char*_tmp1FA=",";_tag_dyneither(_tmp1FA,sizeof(char),2U);}));});
...
Cyc_Absyndump_dump_char((int)'{');
({struct Cyc_List_List*_tmp356=_tmp225;struct _dyneither_ptr _tmp355=({const char*_tmp1FE="[";_tag_dyneither(_tmp1FE,sizeof(char),2U);});struct _dyneither_ptr _tmp354=({const char*_tmp1FF="]";_tag_dyneither(_tmp1FF,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp356,_tmp355,_tmp354,({const char*_tmp200=",";_tag_dyneither(_tmp200,sizeof(char),2U);}));});
({struct Cyc_List_List*_tmp359=_tmp224;struct _dyneither_ptr _tmp358=({const char*_tmp201="";_tag_dyneither(_tmp201,sizeof(char),1U);});struct _dyneither_ptr _tmp357=term;((void(*)(void(*f)(struct _tuple18*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpdp,_tmp359,_tmp358,_tmp357,({const char*_tmp202=",";_tag_dyneither(_tmp202,sizeof(char),2U);}));});
...
if(_tmp227 != 0)({struct Cyc_List_List*_tmp35C=_tmp227;struct _dyneither_ptr _tmp35B=({const char*_tmp205="(";_tag_dyneither(_tmp205,sizeof(char),2U);});struct _dyneither_ptr _tmp35A=term;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp35C,_tmp35B,_tmp35A,({const char*_tmp206=",";_tag_dyneither(_tmp206,sizeof(char),2U);}));});
...
({struct Cyc_List_List*_tmp35D=fields;((void(*)(void(*f)(struct Cyc_Absyn_Datatypefield*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpdatatypefield,_tmp35D,({const char*_tmp22C=",";_tag_dyneither(_tmp22C,sizeof(char),2U);}));});}
# 1105
...
# 1112
void Cyc_Absyndump_dumpenumfields(struct Cyc_List_List*fields){
({struct Cyc_List_List*_tmp35E=fields;((void(*)(void(*f)(struct Cyc_Absyn_Enumfield*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpenumfield,_tmp35E,({const char*_tmp22E=",";_tag_dyneither(_tmp22E,sizeof(char),2U);}));});}
# 1116
void Cyc_Absyndump_dumpaggrfields(struct Cyc_List_List*fields){
...
# 1194
 if((int)_tmp25A == (int)3U  && Cyc_Absyndump_qvar_to_Cids){
...
struct _tuple19 _tmp250=({struct _tuple19 _tmp30B;_tmp30B.f1=call_conv,_tmp30B.f2=_tmp259;_tmp30B;});
({int _tmp35F=is_cp;((void(*)(int is_char_ptr,struct Cyc_List_List*tms,void(*f)(struct _tuple19*),struct _tuple19*a))Cyc_Absyndump_dumptms)(_tmp35F,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp251),Cyc_Absyndump_dump_callconv_qvar,& _tmp250);});};};}
# 1230
...
({struct Cyc_List_List*_tmp362=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->exist_vars;struct _dyneither_ptr _tmp361=({const char*_tmp25C="<";_tag_dyneither(_tmp25C,sizeof(char),2U);});struct _dyneither_ptr _tmp360=({const char*_tmp25D=">";_tag_dyneither(_tmp25D,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,_tmp362,_tmp361,_tmp360,({const char*_tmp25E=",";_tag_dyneither(_tmp25E,sizeof(char),2U);}));});
...
void*_tmp26F=d->r;void*_tmp270=_tmp26F;struct Cyc_List_List*_tmp2A5;struct Cyc_List_List*_tmp2A4;struct Cyc_List_List*_tmp2A3;struct Cyc_List_List*_tmp2A2;struct _tuple0*_tmp2A1;struct Cyc_List_List*_tmp2A0;struct _dyneither_ptr*_tmp29F;struct Cyc_List_List*_tmp29E;struct Cyc_Absyn_Typedefdecl*_tmp29D;struct Cyc_Absyn_Tvar*_tmp29C;struct Cyc_Absyn_Vardecl*_tmp29B;struct Cyc_Absyn_Exp*_tmp29A;struct Cyc_List_List*_tmp299;struct Cyc_Absyn_Pat*_tmp298;struct Cyc_Absyn_Exp*_tmp297;struct Cyc_Absyn_Enumdecl*_tmp296;struct Cyc_Absyn_Datatypedecl*_tmp295;struct Cyc_Absyn_Aggrdecl*_tmp294;struct Cyc_Absyn_Fndecl*_tmp293;struct Cyc_Absyn_Vardecl*_tmp292;switch(*((int*)_tmp270)){case 0U: _LL1: _tmp292=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_LL2:
# 1290
 Cyc_Absyndump_dumpvardecl(_tmp292,d->loc,1);
goto _LL0;case 1U: _LL3: _tmp293=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_LL4:
# 1294
{enum Cyc_Cyclone_C_Compilers _tmp271=Cyc_Cyclone_c_compiler;if(_tmp271 == Cyc_Cyclone_Vc_c){_LL24: _LL25:
 Cyc_Absyndump_dumpatts((_tmp293->i).attributes);goto _LL23;}else{_LL26: _LL27:
 goto _LL23;}_LL23:;}
# 1298
if(_tmp293->is_inline){
enum Cyc_Cyclone_C_Compilers _tmp272=Cyc_Cyclone_c_compiler;if(_tmp272 == Cyc_Cyclone_Vc_c){_LL29: _LL2A:
 Cyc_Absyndump_dump(({const char*_tmp273="__inline";_tag_dyneither(_tmp273,sizeof(char),9U);}));goto _LL28;}else{_LL2B: _LL2C:
 Cyc_Absyndump_dump(({const char*_tmp274="inline";_tag_dyneither(_tmp274,sizeof(char),7U);}));goto _LL28;}_LL28:;}
# 1303
Cyc_Absyndump_dumpscope(_tmp293->sc);{
# 1305
struct Cyc_Absyn_FnInfo type_info=_tmp293->i;
type_info.attributes=0;{
void*t=(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp27B=_cycalloc(sizeof(*_tmp27B));_tmp27B->tag=5U,_tmp27B->f1=type_info;_tmp27B;});
if(_tmp293->cached_type != 0){
void*_tmp275=Cyc_Tcutil_compress((void*)_check_null(_tmp293->cached_type));void*_tmp276=_tmp275;struct Cyc_Absyn_FnInfo _tmp279;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp276)->tag == 5U){_LL2E: _tmp279=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp276)->f1;_LL2F:
# 1311
({struct Cyc_List_List*_tmp363=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)((_tmp293->i).attributes,_tmp279.attributes);(_tmp293->i).attributes=_tmp363;});goto _LL2D;}else{_LL30: _LL31:
({void*_tmp277=0U;({struct _dyneither_ptr _tmp364=({const char*_tmp278="function has non-function type";_tag_dyneither(_tmp278,sizeof(char),31U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp364,_tag_dyneither(_tmp277,sizeof(void*),0U));});});}_LL2D:;}
# 1315
{enum Cyc_Cyclone_C_Compilers _tmp27A=Cyc_Cyclone_c_compiler;if(_tmp27A == Cyc_Cyclone_Gcc_c){_LL33: _LL34:
({struct Cyc_Absyn_Tqual _tmp366=Cyc_Absyn_empty_tqual(0U);void*_tmp365=t;((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*))Cyc_Absyndump_dumptqtd)(_tmp366,_tmp365,Cyc_Absyndump_dump_atts_qvar,_tmp293);});goto _LL32;}else{_LL35: _LL36:
({struct Cyc_Absyn_Tqual _tmp368=Cyc_Absyn_empty_tqual(0U);void*_tmp367=t;((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*))Cyc_Absyndump_dumptqtd)(_tmp368,_tmp367,Cyc_Absyndump_dump_callconv_fdqvar,_tmp293);});goto _LL32;}_LL32:;}
# 1319
Cyc_Absyndump_dump_char((int)'{');
Cyc_Absyndump_dumpstmt(_tmp293->body,0);
Cyc_Absyndump_dump_char((int)'}');
goto _LL0;};};case 5U: _LL5: _tmp294=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_LL6:
# 1324
 Cyc_Absyndump_dump_aggrdecl(_tmp294);Cyc_Absyndump_dump_semi();
goto _LL0;case 6U: _LL7: _tmp295=((struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_LL8:
# 1327
 Cyc_Absyndump_dump_datatypedecl(_tmp295);Cyc_Absyndump_dump_semi();
goto _LL0;case 7U: _LL9: _tmp296=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_LLA:
# 1330
 Cyc_Absyndump_dump_enumdecl(_tmp296);Cyc_Absyndump_dump_semi();
goto _LL0;case 2U: _LLB: _tmp298=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_tmp297=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp270)->f3;_LLC:
# 1333
 Cyc_Absyndump_dump(({const char*_tmp27C="let";_tag_dyneither(_tmp27C,sizeof(char),4U);}));
Cyc_Absyndump_dumppat(_tmp298);
Cyc_Absyndump_dump_char((int)'=');
Cyc_Absyndump_dumpexp(_tmp297);
Cyc_Absyndump_dump_semi();
goto _LL0;case 3U: _LLD: _tmp299=((struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_LLE:
# 1340
 Cyc_Absyndump_dump(({const char*_tmp27D="let ";_tag_dyneither(_tmp27D,sizeof(char),5U);}));
Cyc_Absyndump_dumpids(_tmp299);
Cyc_Absyndump_dump_semi();
goto _LL0;case 4U: _LLF: _tmp29C=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_tmp29B=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp270)->f2;_tmp29A=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp270)->f3;_LL10:
# 1345
 Cyc_Absyndump_dump(({const char*_tmp27E="region";_tag_dyneither(_tmp27E,sizeof(char),7U);}));
Cyc_Absyndump_dump(({const char*_tmp27F="<";_tag_dyneither(_tmp27F,sizeof(char),2U);}));Cyc_Absyndump_dumptvar(_tmp29C);Cyc_Absyndump_dump(({const char*_tmp280="> ";_tag_dyneither(_tmp280,sizeof(char),3U);}));Cyc_Absyndump_dumpqvar(_tmp29B->name);
if((unsigned int)_tmp29A){
Cyc_Absyndump_dump(({const char*_tmp281=" = open(";_tag_dyneither(_tmp281,sizeof(char),9U);}));
Cyc_Absyndump_dumpexp(_tmp29A);
Cyc_Absyndump_dump(({const char*_tmp282=")";_tag_dyneither(_tmp282,sizeof(char),2U);}));}
# 1352
Cyc_Absyndump_dump_semi();
goto _LL0;case 8U: _LL11: _tmp29D=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_LL12:
# 1359
 Cyc_Absyndump_dump(({const char*_tmp283="typedef";_tag_dyneither(_tmp283,sizeof(char),8U);}));{
void*t;
if(_tmp29D->defn == 0)
...
Cyc_Absyndump_dump_semi();
# 1369
goto _LL0;};case 9U: _LL13: _tmp29F=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_tmp29E=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp270)->f2;_LL14:
# 1371
 Cyc_Absyndump_dump(({const char*_tmp284="namespace ";_tag_dyneither(_tmp284,sizeof(char),11U);}));
Cyc_Absyndump_dump_str(_tmp29F);
Cyc_Absyndump_dump_char((int)'{');
for(0;_tmp29E != 0;_tmp29E=_tmp29E->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp29E->hd);}
Cyc_Absyndump_dump_char((int)'}');
goto _LL0;case 10U: _LL15: _tmp2A1=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_tmp2A0=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp270)->f2;_LL16:
# 1379
 Cyc_Absyndump_dump(({const char*_tmp285="using ";_tag_dyneither(_tmp285,sizeof(char),7U);}));
Cyc_Absyndump_dumpqvar(_tmp2A1);
Cyc_Absyndump_dump_char((int)'{');
for(0;_tmp2A0 != 0;_tmp2A0=_tmp2A0->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp2A0->hd);}
Cyc_Absyndump_dump_char((int)'}');
goto _LL0;case 11U: _LL17: _tmp2A2=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_LL18:
# 1387
 Cyc_Absyndump_dump(({const char*_tmp286="extern \"C\" {";_tag_dyneither(_tmp286,sizeof(char),13U);}));
for(0;_tmp2A2 != 0;_tmp2A2=_tmp2A2->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp2A2->hd);}
Cyc_Absyndump_dump_char((int)'}');
goto _LL0;case 12U: _LL19: _tmp2A5=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp270)->f1;_tmp2A4=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp270)->f2;_tmp2A3=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp270)->f3;_LL1A:
# 1393
 Cyc_Absyndump_dump(({const char*_tmp287="extern \"C include\" {";_tag_dyneither(_tmp287,sizeof(char),21U);}));
for(0;_tmp2A5 != 0;_tmp2A5=_tmp2A5->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp2A5->hd);}
Cyc_Absyndump_dump_char((int)'}');
if(_tmp2A4 != 0){
Cyc_Absyndump_dump(({const char*_tmp288=" cyclone_override {";_tag_dyneither(_tmp288,sizeof(char),20U);}));
for(0;_tmp2A4 != 0;_tmp2A4=_tmp2A4->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp2A4->hd);}
Cyc_Absyndump_dump_char((int)'}');}
# 1403
if(_tmp2A3 != 0){
Cyc_Absyndump_dump(({const char*_tmp289=" export {";_tag_dyneither(_tmp289,sizeof(char),10U);}));
for(0;_tmp2A3 != 0;_tmp2A3=_tmp2A3->tl){
struct _tuple20 _tmp28A=*((struct _tuple20*)_tmp2A3->hd);struct _tuple20 _tmp28B=_tmp28A;struct _tuple0*_tmp28C;_LL38: _tmp28C=_tmp28B.f2;_LL39:;
Cyc_Absyndump_dumpqvar(_tmp28C);
if(_tmp2A3->tl != 0)Cyc_Absyndump_dump_char((int)',');}
# 1410
Cyc_Absyndump_dump(({const char*_tmp28D="}";_tag_dyneither(_tmp28D,sizeof(char),2U);}));}
# 1412
goto _LL0;case 13U: _LL1B: _LL1C:
# 1414
 Cyc_Absyndump_dump(({const char*_tmp28E=" __cyclone_port_on__; ";_tag_dyneither(_tmp28E,sizeof(char),23U);}));
goto _LL0;case 14U: _LL1D: _LL1E:
# 1417
 Cyc_Absyndump_dump(({const char*_tmp28F=" __cyclone_port_off__; ";_tag_dyneither(_tmp28F,sizeof(char),24U);}));
goto _LL0;case 15U: _LL1F: _LL20:
# 1420
 Cyc_Absyndump_dump(({const char*_tmp290=" __tempest_on__; ";_tag_dyneither(_tmp290,sizeof(char),18U);}));
goto _LL0;default: _LL21: _LL22:
# 1423
 Cyc_Absyndump_dump(({const char*_tmp291=" __tempest_off__; ";_tag_dyneither(_tmp291,sizeof(char),19U);}));
goto _LL0;}_LL0:;};}
# 1428
...
return;}{
# 1440
void*_tmp2A6=(void*)tms->hd;void*_tmp2A7=_tmp2A6;void*_tmp2D7;void*_tmp2D6;void*_tmp2D5;void*_tmp2D4;struct Cyc_Absyn_Tqual _tmp2D3;if(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp2A7)->tag == 2U){_LL1: _tmp2D7=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp2A7)->f1).rgn;_tmp2D6=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp2A7)->f1).nullable;_tmp2D5=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp2A7)->f1).bounds;_tmp2D4=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp2A7)->f1).zero_term;_tmp2D3=((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp2A7)->f2;_LL2:
# 1444
{void*_tmp2A8=Cyc_Tcutil_compress(_tmp2D5);void*_tmp2A9=_tmp2A8;struct Cyc_Absyn_Exp*_tmp2AA;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A9)->tag == 0U)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A9)->f1)){case 14U: _LL6: _LL7:
 Cyc_Absyndump_dump_char((int)'?');goto _LL5;case 13U: if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A9)->f2 != 0){if(((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)((struct Cyc_List_List*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A9)->f2)->hd)->tag == 9U){_LL8: _tmp2AA=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A9)->f2)->hd)->f1;_LL9:
# 1447
 Cyc_Absyndump_dump_char((int)(Cyc_Absyn_type2bool(1,_tmp2D6)?'*':'@'));
Cyc_Absyndump_dump_upperbound(_tmp2AA);
goto _LL5;}else{goto _LLA;}}else{goto _LLA;}default: goto _LLA;}else{_LLA: _LLB:
# 1451
 Cyc_Absyndump_dump_char((int)(Cyc_Absyn_type2bool(1,_tmp2D6)?'*':'@'));}_LL5:;}
# 1453
if((!Cyc_Absyndump_qvar_to_Cids  && !is_char_ptr) && Cyc_Absyn_type2bool(0,_tmp2D4))Cyc_Absyndump_dump(({const char*_tmp2AB="@zeroterm";_tag_dyneither(_tmp2AB,sizeof(char),10U);}));
if((!Cyc_Absyndump_qvar_to_Cids  && is_char_ptr) && !Cyc_Absyn_type2bool(0,_tmp2D4))Cyc_Absyndump_dump(({const char*_tmp2AC="@nozeroterm";_tag_dyneither(_tmp2AC,sizeof(char),12U);}));
{void*_tmp2AD=Cyc_Tcutil_compress(_tmp2D7);void*_tmp2AE=_tmp2AD;struct Cyc_Absyn_Tvar*_tmp2B6;switch(*((int*)_tmp2AE)){case 0U: switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2AE)->f1)){case 5U: _LLD: _LLE:
 if(!Cyc_Absyndump_qvar_to_Cids)Cyc_Absyndump_dump(({const char*_tmp2AF="`H";_tag_dyneither(_tmp2AF,sizeof(char),3U);}));goto _LLC;case 6U: _LLF: _LL10:
 Cyc_Absyndump_dump(({const char*_tmp2B0="`U";_tag_dyneither(_tmp2B0,sizeof(char),3U);}));goto _LLC;case 7U: _LL11: _LL12:
 Cyc_Absyndump_dump(({const char*_tmp2B1="`RC";_tag_dyneither(_tmp2B1,sizeof(char),4U);}));goto _LLC;default: goto _LL19;}case 2U: _LL13: _tmp2B6=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp2AE)->f1;_LL14:
 Cyc_Absyndump_dumptvar(_tmp2B6);goto _LLC;case 1U: if(((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp2AE)->f2 == 0){_LL15: _LL16:
 Cyc_Absyndump_dumpntyp(Cyc_Tcutil_compress(_tmp2D7));goto _LLC;}else{goto _LL19;}case 8U: _LL17: _LL18:
 Cyc_Absyndump_dump(({const char*_tmp2B2="@region(";_tag_dyneither(_tmp2B2,sizeof(char),9U);}));Cyc_Absyndump_dumptyp(_tmp2D7);Cyc_Absyndump_dump(({const char*_tmp2B3=")";_tag_dyneither(_tmp2B3,sizeof(char),2U);}));goto _LLC;default: _LL19: _LL1A:
({void*_tmp2B4=0U;({struct _dyneither_ptr _tmp369=({const char*_tmp2B5="dumptms: bad rgn type in Pointer_mod";_tag_dyneither(_tmp2B5,sizeof(char),37U);});Cyc_Warn_impos(_tmp369,_tag_dyneither(_tmp2B4,sizeof(void*),0U));});});}_LLC:;}
# 1464
...
if(tms->tl != 0){
void*_tmp2B7=(void*)((struct Cyc_List_List*)_check_null(tms->tl))->hd;void*_tmp2B8=_tmp2B7;if(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp2B8)->tag == 2U){_LL1C: _LL1D:
...
if(next_is_pointer)
Cyc_Absyndump_dump_char((int)')');
{void*_tmp2B9=(void*)tms->hd;void*_tmp2BA=_tmp2B9;struct Cyc_List_List*_tmp2D2;struct Cyc_List_List*_tmp2D1;unsigned int _tmp2D0;int _tmp2CF;struct Cyc_List_List*_tmp2CE;unsigned int _tmp2CD;struct Cyc_List_List*_tmp2CC;int _tmp2CB;struct Cyc_Absyn_VarargInfo*_tmp2CA;void*_tmp2C9;struct Cyc_List_List*_tmp2C8;struct Cyc_Absyn_Exp*_tmp2C7;struct Cyc_Absyn_Exp*_tmp2C6;struct Cyc_Absyn_Exp*_tmp2C5;void*_tmp2C4;void*_tmp2C3;switch(*((int*)_tmp2BA)){case 0U: _LL21: _tmp2C3=(void*)((struct Cyc_Absyn_Carray_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1;_LL22:
# 1482
 Cyc_Absyndump_dump(({const char*_tmp2BB="[]";_tag_dyneither(_tmp2BB,sizeof(char),3U);}));
if(Cyc_Absyn_type2bool(0,_tmp2C3))Cyc_Absyndump_dump(({const char*_tmp2BC="@zeroterm";_tag_dyneither(_tmp2BC,sizeof(char),10U);}));
goto _LL20;case 1U: _LL23: _tmp2C5=((struct Cyc_Absyn_ConstArray_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1;_tmp2C4=(void*)((struct Cyc_Absyn_ConstArray_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f2;_LL24:
# 1486
 Cyc_Absyndump_dump_char((int)'[');Cyc_Absyndump_dumpexp(_tmp2C5);Cyc_Absyndump_dump_char((int)']');
if(Cyc_Absyn_type2bool(0,_tmp2C4))Cyc_Absyndump_dump(({const char*_tmp2BD="@zeroterm";_tag_dyneither(_tmp2BD,sizeof(char),10U);}));
goto _LL20;case 3U: if(((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1)->tag == 1U){_LL25: _tmp2CC=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1)->f1;_tmp2CB=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1)->f2;_tmp2CA=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1)->f3;_tmp2C9=(void*)((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1)->f4;_tmp2C8=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1)->f5;_tmp2C7=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1)->f6;_tmp2C6=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1)->f7;_LL26:
# 1490
 Cyc_Absyndump_dumpfunargs(_tmp2CC,_tmp2CB,_tmp2CA,_tmp2C9,_tmp2C8,_tmp2C7,_tmp2C6);goto _LL20;}else{_LL27: _tmp2CE=((struct Cyc_Absyn_NoTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1)->f1;_tmp2CD=((struct Cyc_Absyn_NoTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1)->f2;_LL28:
# 1492
({struct Cyc_List_List*_tmp36C=_tmp2CE;struct _dyneither_ptr _tmp36B=({const char*_tmp2BE="(";_tag_dyneither(_tmp2BE,sizeof(char),2U);});struct _dyneither_ptr _tmp36A=({const char*_tmp2BF=")";_tag_dyneither(_tmp2BF,sizeof(char),2U);});((void(*)(void(*f)(struct _dyneither_ptr*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dump_str,_tmp36C,_tmp36B,_tmp36A,({const char*_tmp2C0=",";_tag_dyneither(_tmp2C0,sizeof(char),2U);}));});goto _LL20;}case 4U: _LL29: _tmp2D1=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f1;_tmp2D0=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f2;_tmp2CF=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f3;_LL2A:
# 1494
 if(_tmp2CF)Cyc_Absyndump_dumpkindedtvars(_tmp2D1);else{Cyc_Absyndump_dumptvars(_tmp2D1);}goto _LL20;case 5U: _LL2B: _tmp2D2=((struct Cyc_Absyn_Attributes_mod_Absyn_Type_modifier_struct*)_tmp2BA)->f2;_LL2C:
 Cyc_Absyndump_dumpatts(_tmp2D2);goto _LL20;default: _LL2D: _LL2E:
({void*_tmp2C1=0U;({struct _dyneither_ptr _tmp36D=({const char*_tmp2C2="dumptms";_tag_dyneither(_tmp2C2,sizeof(char),8U);});Cyc_Warn_impos(_tmp36D,_tag_dyneither(_tmp2C1,sizeof(void*),0U));});});}_LL20:;}
# 1498
return;}}_LL0:;};}
# 1502
void Cyc_Absyndump_dumptqtd(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(void*),void*a){
int _tmp2D8=Cyc_Absyndump_is_char_ptr(t);
struct _RegionHandle _tmp2D9=_new_region("temp");struct _RegionHandle*temp=& _tmp2D9;_push_region(temp);
{struct _tuple11 _tmp2DA=Cyc_Absynpp_to_tms(temp,tq,t);struct _tuple11 _tmp2DB=_tmp2DA;struct Cyc_Absyn_Tqual _tmp2DE;void*_tmp2DD;struct Cyc_List_List*_tmp2DC;_LL1: _tmp2DE=_tmp2DB.f1;_tmp2DD=_tmp2DB.f2;_tmp2DC=_tmp2DB.f3;_LL2:;
Cyc_Absyndump_dumptq(_tmp2DE);
Cyc_Absyndump_dumpntyp(_tmp2DD);
({int _tmp370=_tmp2D8;struct Cyc_List_List*_tmp36F=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp2DC);void(*_tmp36E)(void*)=f;Cyc_Absyndump_dumptms(_tmp370,_tmp36F,_tmp36E,a);});}
# 1505
;_pop_region(temp);}
# 1512
...
({void*_tmp2DF=0U;({struct Cyc___cycFILE*_tmp372=f;struct _dyneither_ptr _tmp371=({const char*_tmp2E0="\n";_tag_dyneither(_tmp2E0,sizeof(char),2U);});Cyc_fprintf(_tmp372,_tmp371,_tag_dyneither(_tmp2DF,sizeof(void*),0U));});});}
# 1520
static void Cyc_Absyndump_dump_decl_interface(struct Cyc_Absyn_Decl*d){
void*_tmp2E1=d->r;void*_tmp2E2=_tmp2E1;struct Cyc_List_List*_tmp2FE;struct Cyc_List_List*_tmp2FD;struct Cyc_List_List*_tmp2FC;struct Cyc_List_List*_tmp2FB;struct Cyc_List_List*_tmp2FA;struct _dyneither_ptr*_tmp2F9;struct Cyc_List_List*_tmp2F8;struct Cyc_Absyn_Typedefdecl*_tmp2F7;struct Cyc_Absyn_Enumdecl*_tmp2F6;struct Cyc_Absyn_Datatypedecl*_tmp2F5;struct Cyc_Absyn_Aggrdecl*_tmp2F4;struct Cyc_Absyn_Fndecl*_tmp2F3;struct Cyc_Absyn_Vardecl*_tmp2F2;switch(*((int*)_tmp2E2)){case 0U: _LL1: _tmp2F2=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp2E2)->f1;_LL2:
# 1523
 if((int)_tmp2F2->sc == (int)Cyc_Absyn_Static)return;{
struct Cyc_Absyn_Exp*init=_tmp2F2->initializer;
_tmp2F2->initializer=0;
if((int)_tmp2F2->sc == (int)Cyc_Absyn_Public)
Cyc_Absyndump_dump(({const char*_tmp2E3="extern ";_tag_dyneither(_tmp2E3,sizeof(char),8U);}));
Cyc_Absyndump_dumpvardecl(_tmp2F2,d->loc,1);
Cyc_Absyndump_dump(({const char*_tmp2E4="\n";_tag_dyneither(_tmp2E4,sizeof(char),2U);}));
_tmp2F2->initializer=init;
goto _LL0;};case 1U: _LL3: _tmp2F3=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp2E2)->f1;_LL4:
# 1533
 if((int)_tmp2F3->sc == (int)Cyc_Absyn_Static)return;
Cyc_Absyndump_dumpscope(_tmp2F3->sc);{
struct Cyc_Absyn_FnInfo type_info=_tmp2F3->i;
type_info.attributes=0;{
void*t=(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp2E6=_cycalloc(sizeof(*_tmp2E6));_tmp2E6->tag=5U,_tmp2E6->f1=type_info;_tmp2E6;});
({struct Cyc_Absyn_Tqual _tmp374=Cyc_Absyn_empty_tqual(0U);void*_tmp373=t;((void(*)(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*a))Cyc_Absyndump_dumptqtd)(_tmp374,_tmp373,Cyc_Absyndump_dump_atts_qvar,_tmp2F3);});
Cyc_Absyndump_dump(({const char*_tmp2E5=";\n";_tag_dyneither(_tmp2E5,sizeof(char),3U);}));
goto _LL0;};};case 5U: _LL5: _tmp2F4=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp2E2)->f1;_LL6:
# 1542
 if((int)_tmp2F4->sc == (int)Cyc_Absyn_Static)return;{
struct Cyc_Absyn_AggrdeclImpl*impl=_tmp2F4->impl;
if((int)_tmp2F4->sc == (int)Cyc_Absyn_Abstract)_tmp2F4->impl=0;
Cyc_Absyndump_dump_aggrdecl(_tmp2F4);
_tmp2F4->impl=impl;
Cyc_Absyndump_dump(({const char*_tmp2E7=";\n";_tag_dyneither(_tmp2E7,sizeof(char),3U);}));
goto _LL0;};case 6U: _LL7: _tmp2F5=((struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp2E2)->f1;_LL8:
# 1550
 Cyc_Absyndump_dump_datatypedecl(_tmp2F5);
Cyc_Absyndump_dump(({const char*_tmp2E8=";\n";_tag_dyneither(_tmp2E8,sizeof(char),3U);}));
goto _LL0;case 7U: _LL9: _tmp2F6=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp2E2)->f1;_LLA:
# 1554
 Cyc_Absyndump_dump_enumdecl(_tmp2F6);
Cyc_Absyndump_dump(({const char*_tmp2E9=";\n";_tag_dyneither(_tmp2E9,sizeof(char),3U);}));
goto _LL0;case 8U: _LLB: _tmp2F7=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp2E2)->f1;_LLC:
# 1558
 if(_tmp2F7->defn == 0){
Cyc_Absyndump_dumpdecl(d);
Cyc_Absyndump_dump(({const char*_tmp2EA="\n";_tag_dyneither(_tmp2EA,sizeof(char),2U);}));}
# 1562
goto _LL0;case 9U: _LLD: _tmp2F9=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp2E2)->f1;_tmp2F8=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp2E2)->f2;_LLE:
# 1564
 Cyc_Absyndump_dump(({const char*_tmp2EB="namespace ";_tag_dyneither(_tmp2EB,sizeof(char),11U);}));
Cyc_Absyndump_dump_str(_tmp2F9);
Cyc_Absyndump_dump(({const char*_tmp2EC="{\n";_tag_dyneither(_tmp2EC,sizeof(char),3U);}));
for(0;_tmp2F8 != 0;_tmp2F8=_tmp2F8->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)_tmp2F8->hd);}
Cyc_Absyndump_dump(({const char*_tmp2ED="}\n";_tag_dyneither(_tmp2ED,sizeof(char),3U);}));
goto _LL0;case 10U: _LLF: _tmp2FA=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp2E2)->f2;_LL10:
# 1572
 for(0;_tmp2FA != 0;_tmp2FA=_tmp2FA->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)_tmp2FA->hd);}
goto _LL0;case 11U: _LL11: _tmp2FB=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp2E2)->f1;_LL12:
# 1576
 Cyc_Absyndump_dump(({const char*_tmp2EE="extern \"C\" {";_tag_dyneither(_tmp2EE,sizeof(char),13U);}));
for(0;_tmp2FB != 0;_tmp2FB=_tmp2FB->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)_tmp2FB->hd);}
Cyc_Absyndump_dump(({const char*_tmp2EF="}\n";_tag_dyneither(_tmp2EF,sizeof(char),3U);}));
goto _LL0;case 12U: _LL13: _tmp2FE=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2E2)->f1;_tmp2FD=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2E2)->f2;_tmp2FC=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2E2)->f3;_LL14:
# 1597 "absyndump.cyc"
 goto _LL0;default: _LL15: _LL16:
({void*_tmp2F0=0U;({struct _dyneither_ptr _tmp375=({const char*_tmp2F1="bad top-level declaration";_tag_dyneither(_tmp2F1,sizeof(char),26U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp375,_tag_dyneither(_tmp2F0,sizeof(void*),0U));});});}_LL0:;}
# 1602
