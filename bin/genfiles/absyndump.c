...
if(({char*_tmp308=(char*)f.curr;_tmp308 == (char*)(_tag_fat(0,0,0)).curr;})||(char*)f.curr == (char*)last_file.curr && d == last_line)return;
if((char*)f.curr == (char*)last_file.curr && d == last_line + (unsigned)1)
({void*_tmp6=0U;({struct Cyc___cycFILE*_tmp30A=*Cyc_Absyndump_dump_file;struct _fat_ptr _tmp309=({const char*_tmp7="\n";_tag_fat(_tmp7,sizeof(char),2U);});Cyc_fprintf(_tmp30A,_tmp309,_tag_fat(_tmp6,sizeof(void*),0U));});});else{
if((char*)f.curr == (char*)last_file.curr)
({struct Cyc_Int_pa_PrintArg_struct _tmpA=({struct Cyc_Int_pa_PrintArg_struct _tmp2FA;_tmp2FA.tag=1U,_tmp2FA.f1=(unsigned long)((int)d);_tmp2FA;});void*_tmp8[1U];_tmp8[0]=& _tmpA;({struct Cyc___cycFILE*_tmp30C=*Cyc_Absyndump_dump_file;struct _fat_ptr _tmp30B=({const char*_tmp9="\n# %d\n";_tag_fat(_tmp9,sizeof(char),7U);});Cyc_fprintf(_tmp30C,_tmp30B,_tag_fat(_tmp8,sizeof(void*),1U));});});else{
# 161
({struct Cyc_Int_pa_PrintArg_struct _tmpD=({struct Cyc_Int_pa_PrintArg_struct _tmp2FC;_tmp2FC.tag=1U,_tmp2FC.f1=(unsigned long)((int)d);_tmp2FC;});struct Cyc_String_pa_PrintArg_struct _tmpE=({struct Cyc_String_pa_PrintArg_struct _tmp2FB;_tmp2FB.tag=0U,_tmp2FB.f1=(struct _fat_ptr)((struct _fat_ptr)f);_tmp2FB;});void*_tmpB[2U];_tmpB[0]=& _tmpD,_tmpB[1]=& _tmpE;({struct Cyc___cycFILE*_tmp30E=*Cyc_Absyndump_dump_file;struct _fat_ptr _tmp30D=({const char*_tmpC="\n# %d %s\n";_tag_fat(_tmpC,sizeof(char),10U);});Cyc_fprintf(_tmp30E,_tmp30D,_tag_fat(_tmpB,sizeof(void*),2U));});});}}
# 163
last_file=f;
last_line=d;}}}
# 169
...
({struct Cyc_List_List*_tmp311=ts;struct _fat_ptr _tmp310=({const char*_tmp24="<";_tag_fat(_tmp24,sizeof(char),2U);});struct _fat_ptr _tmp30F=({const char*_tmp25=">";_tag_fat(_tmp25,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptyp,_tmp311,_tmp310,_tmp30F,({const char*_tmp26=",";_tag_fat(_tmp26,sizeof(char),2U);}));});}
# 277
...
({struct Cyc_List_List*_tmp314=tvs;struct _fat_ptr _tmp313=({const char*_tmp31="<";_tag_fat(_tmp31,sizeof(char),2U);});struct _fat_ptr _tmp312=({const char*_tmp32=">";_tag_fat(_tmp32,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp314,_tmp313,_tmp312,({const char*_tmp33=",";_tag_fat(_tmp33,sizeof(char),2U);}));});}
# 302
static void Cyc_Absyndump_dumpkindedtvars(struct Cyc_List_List*tvs){
({struct Cyc_List_List*_tmp317=tvs;struct _fat_ptr _tmp316=({const char*_tmp34="<";_tag_fat(_tmp34,sizeof(char),2U);});struct _fat_ptr _tmp315=({const char*_tmp35=">";_tag_fat(_tmp35,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,_tmp317,_tmp316,_tmp315,({const char*_tmp36=",";_tag_fat(_tmp36,sizeof(char),2U);}));});}struct _tuple16{struct Cyc_Absyn_Tqual f1;void*f2;};
# 305
...
({struct Cyc_List_List*_tmp31A=ts;struct _fat_ptr _tmp319=({const char*_tmp37="(";_tag_fat(_tmp37,sizeof(char),2U);});struct _fat_ptr _tmp318=({const char*_tmp38=")";_tag_fat(_tmp38,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple16*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumparg,_tmp31A,_tmp319,_tmp318,({const char*_tmp39=",";_tag_fat(_tmp39,sizeof(char),2U);}));});}
# 312
...
# 380
return({struct _tuple17 _tmp2FD;_tmp2FD.f1=rgions,_tmp2FD.f2=effects;_tmp2FD;});}
# 383
...
if(effects != 0){
({struct Cyc_List_List*_tmp31D=effects;struct _fat_ptr _tmp31C=({const char*_tmp56="";_tag_fat(_tmp56,sizeof(char),1U);});struct _fat_ptr _tmp31B=({const char*_tmp57="";_tag_fat(_tmp57,sizeof(char),1U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpntyp,_tmp31D,_tmp31C,_tmp31B,({const char*_tmp58="+";_tag_fat(_tmp58,sizeof(char),2U);}));});
if(rgions != 0)Cyc_Absyndump_dump_char((int)'+');}
# 391
if(rgions != 0 || effects == 0)
({struct Cyc_List_List*_tmp320=rgions;struct _fat_ptr _tmp31F=({const char*_tmp59="{";_tag_fat(_tmp59,sizeof(char),2U);});struct _fat_ptr _tmp31E=({const char*_tmp5A="}";_tag_fat(_tmp5A,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumprgn,_tmp320,_tmp31F,_tmp31E,({const char*_tmp5B=",";_tag_fat(_tmp5B,sizeof(char),2U);}));});}}
# 396
static void Cyc_Absyndump_dumpntyp(void*t){
...
({struct Cyc_List_List*_tmp323=ts;struct _fat_ptr _tmp322=({const char*_tmpB5="";_tag_fat(_tmpB5,sizeof(char),1U);});struct _fat_ptr _tmp321=({const char*_tmpB6="";_tag_fat(_tmpB6,sizeof(char),1U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumptyp,_tmp323,_tmp322,_tmp321,({const char*_tmpB7="+";_tag_fat(_tmpB7,sizeof(char),2U);}));});return;case 11U: _LL5E: _LL5F:
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpBD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FE;_tmp2FE.tag=0U,({struct _fat_ptr _tmp324=({const char*_tmpBE="bad type constructor";_tag_fat(_tmpBE,sizeof(char),21U);});_tmp2FE.f1=_tmp324;});_tmp2FE;});void*_tmpBC[1U];_tmpBC[0]=& _tmpBD;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpBC,sizeof(void*),1U));});}_LL21:;}}case 2U: _LL9: _tmp6C=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp5C)->f1;_LLA: {struct Cyc_Absyn_Tvar*tv=_tmp6C;
# 403
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp74=({struct Cyc_Int_pa_PrintArg_struct _tmp2FF;_tmp2FF.tag=1U,_tmp2FF.f1=(unsigned long)i;_tmp2FF;});void*_tmp72[1U];_tmp72[0]=& _tmp74;({struct _fat_ptr _tmp325=({const char*_tmp73="%d";_tag_fat(_tmp73,sizeof(char),3U);});Cyc_aprintf(_tmp325,_tag_fat(_tmp72,sizeof(void*),1U));});}));return;}}else{_LLD: _tmp67=((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp5C)->f1;_tmp68=(void*)((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp5C)->f2;_tmp69=((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp5C)->f3;_LLE: {struct Cyc_Core_Opt*k=_tmp67;void*t=_tmp68;int i=_tmp69;
...
({struct Cyc_List_List*_tmp326=rgn_po;((void(*)(void(*f)(struct _tuple18*),struct Cyc_List_List*l,struct _fat_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dump_rgncmp,_tmp326,({const char*_tmpBF=",";_tag_fat(_tmpBF,sizeof(char),2U);}));});}
# 502
...
# 511
({struct Cyc_List_List*_tmp329=args;struct _fat_ptr _tmp328=({const char*_tmpC1="(";_tag_fat(_tmpC1,sizeof(char),2U);});struct _fat_ptr _tmp327=({const char*_tmpC2="";_tag_fat(_tmpC2,sizeof(char),1U);});((void(*)(void(*f)(struct _tuple8*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpfunarg,_tmp329,_tmp328,_tmp327,({const char*_tmpC3=",";_tag_fat(_tmpC3,sizeof(char),2U);}));});
...
({struct Cyc_Absyn_Tqual _tmp32A=Cyc_Absyn_empty_tqual(0U);((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(int),int))Cyc_Absyndump_dumptqtd)(_tmp32A,t,(void(*)(int x))Cyc_Absyndump_ignore,0);});}
# 538
...
({struct Cyc_List_List*_tmp32D=(*de).f1;struct _fat_ptr _tmp32C=({const char*_tmpCD="";_tag_fat(_tmpCD,sizeof(char),1U);});struct _fat_ptr _tmp32B=({const char*_tmpCE="=";_tag_fat(_tmpCE,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,_tmp32D,_tmp32C,_tmp32B,({const char*_tmpCF="=";_tag_fat(_tmpCF,sizeof(char),2U);}));});
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpD5=({struct Cyc_Int_pa_PrintArg_struct _tmp300;_tmp300.tag=1U,_tmp300.f1=(unsigned long)((int)n);_tmp300;});void*_tmpD3[1U];_tmpD3[0]=& _tmpD5;({struct _fat_ptr _tmp32E=({const char*_tmpD4="%d";_tag_fat(_tmpD4,sizeof(char),3U);});Cyc_aprintf(_tmp32E,_tag_fat(_tmpD3,sizeof(void*),1U));});}));return;}}_LL0:;}struct _tuple20{struct _fat_ptr f1;struct Cyc_Absyn_Exp*f2;};
# 556
...
({int _tmp332=inprec;struct Cyc_List_List*_tmp331=es;struct _fat_ptr _tmp330=({const char*_tmpDA="";_tag_fat(_tmpDA,sizeof(char),1U);});struct _fat_ptr _tmp32F=({const char*_tmpDB="";_tag_fat(_tmpDB,sizeof(char),1U);});((void(*)(void(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group_c)(Cyc_Absyndump_dumpexp_prec,_tmp332,_tmp331,_tmp330,_tmp32F,({const char*_tmpDC=",";_tag_fat(_tmpDC,sizeof(char),2U);}));});}
# 581
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp13D=({struct Cyc_String_pa_PrintArg_struct _tmp301;_tmp301.tag=0U,_tmp301.f1=(struct _fat_ptr)((struct _fat_ptr)s);_tmp301;});void*_tmp13B[1U];_tmp13B[0]=& _tmp13D;({struct _fat_ptr _tmp333=({const char*_tmp13C="L'%s'";_tag_fat(_tmp13C,sizeof(char),6U);});Cyc_aprintf(_tmp333,_tag_fat(_tmp13B,sizeof(void*),1U));});}));goto _LL0;}case 4U: _LL5: _tmp136=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).Short_c).val).f1;_tmp137=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).Short_c).val).f2;_LL6: {enum Cyc_Absyn_Sign sg=_tmp136;short s=_tmp137;
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp140=({struct Cyc_Int_pa_PrintArg_struct _tmp302;_tmp302.tag=1U,_tmp302.f1=(unsigned long)((int)s);_tmp302;});void*_tmp13E[1U];_tmp13E[0]=& _tmp140;({struct _fat_ptr _tmp334=({const char*_tmp13F="%d";_tag_fat(_tmp13F,sizeof(char),3U);});Cyc_aprintf(_tmp334,_tag_fat(_tmp13E,sizeof(void*),1U));});}));goto _LL0;}case 5U: switch((((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).Int_c).val).f1){case Cyc_Absyn_None: _LL7: _tmp135=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).Int_c).val).f2;_LL8: {int i=_tmp135;
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp143=({struct Cyc_Int_pa_PrintArg_struct _tmp303;_tmp303.tag=1U,_tmp303.f1=(unsigned long)i;_tmp303;});void*_tmp141[1U];_tmp141[0]=& _tmp143;({struct _fat_ptr _tmp335=({const char*_tmp142="%d";_tag_fat(_tmp142,sizeof(char),3U);});Cyc_aprintf(_tmp335,_tag_fat(_tmp141,sizeof(void*),1U));});}));goto _LL0;}default: _LLB: _tmp133=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).Int_c).val).f2;_LLC: {int i=_tmp133;
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp146=({struct Cyc_Int_pa_PrintArg_struct _tmp304;_tmp304.tag=1U,_tmp304.f1=(unsigned)i;_tmp304;});void*_tmp144[1U];_tmp144[0]=& _tmp146;({struct _fat_ptr _tmp336=({const char*_tmp145="%uU";_tag_fat(_tmp145,sizeof(char),4U);});Cyc_aprintf(_tmp336,_tag_fat(_tmp144,sizeof(void*),1U));});}));goto _LL0;}}case 6U: _LLD: _tmp131=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).LongLong_c).val).f1;_tmp132=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpDF)->f1).LongLong_c).val).f2;_LLE: {enum Cyc_Absyn_Sign sg=_tmp131;long long i=_tmp132;
# 596
...
({void*_tmp14F=0U;({struct _fat_ptr _tmp337=({const char*_tmp150="Absyndump -- Bad number of arguments to primop";_tag_fat(_tmp150,sizeof(char),47U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp337,_tag_fat(_tmp14F,sizeof(void*),0U));});});}_LL71:;}
# 631
...
Cyc_Absyndump_dump_char((int)')');
({struct Cyc_List_List*_tmp33D=des;struct _fat_ptr _tmp33C=({const char*_tmp16C="{";_tag_fat(_tmp16C,sizeof(char),2U);});struct _fat_ptr _tmp33B=({const char*_tmp16D="}";_tag_fat(_tmp16D,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple19*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp33D,_tmp33C,_tmp33B,({const char*_tmp16E=",";_tag_fat(_tmp16E,sizeof(char),2U);}));});
...
# 761
({struct Cyc_List_List*_tmp340=des;struct _fat_ptr _tmp33F=({const char*_tmp16F="{";_tag_fat(_tmp16F,sizeof(char),2U);});struct _fat_ptr _tmp33E=({const char*_tmp170="}";_tag_fat(_tmp170,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple19*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp340,_tmp33F,_tmp33E,({const char*_tmp171=",";_tag_fat(_tmp171,sizeof(char),2U);}));});goto _LL0;}case 27U: _LL5B: _tmpF4=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpDF)->f1;_tmpF5=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpDF)->f2;_tmpF6=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpDF)->f3;_LL5C: {struct Cyc_Absyn_Vardecl*vd=_tmpF4;struct Cyc_Absyn_Exp*e1=_tmpF5;struct Cyc_Absyn_Exp*e2=_tmpF6;
# 764
...
if(ts != 0)
Cyc_Absyndump_dumptps(ts);
({struct Cyc_List_List*_tmp343=des;struct _fat_ptr _tmp342=({const char*_tmp174="";_tag_fat(_tmp174,sizeof(char),1U);});struct _fat_ptr _tmp341=({const char*_tmp175="}";_tag_fat(_tmp175,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple19*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp343,_tmp342,_tmp341,({const char*_tmp176=",";_tag_fat(_tmp176,sizeof(char),2U);}));});
...
# 781
({struct Cyc_List_List*_tmp346=des;struct _fat_ptr _tmp345=({const char*_tmp177="{";_tag_fat(_tmp177,sizeof(char),2U);});struct _fat_ptr _tmp344=({const char*_tmp178="}";_tag_fat(_tmp178,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple19*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp346,_tmp345,_tmp344,({const char*_tmp179=",";_tag_fat(_tmp179,sizeof(char),2U);}));});goto _LL0;}case 32U: _LL63: _tmpED=((struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmpDF)->f2;_LL64: {struct Cyc_Absyn_Enumfield*ef=_tmpED;
...
if(es != 0)({struct Cyc_List_List*_tmp349=es;struct _fat_ptr _tmp348=({const char*_tmp17A="(";_tag_fat(_tmp17A,sizeof(char),2U);});struct _fat_ptr _tmp347=({const char*_tmp17B=")";_tag_fat(_tmp17B,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Exp*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpexp,_tmp349,_tmp348,_tmp347,({const char*_tmp17C=",";_tag_fat(_tmp17C,sizeof(char),2U);}));});
...
# 807
if(topt != 0)
Cyc_Absyndump_dumpexp(({struct Cyc_Absyn_Exp*_tmp34A=Cyc_Absyn_sizeoftype_exp(*topt,0U);Cyc_Absyn_times_exp(_tmp34A,e,0U);}));else{
# 810
...
# 819
({struct Cyc_List_List*_tmp34D=des;struct _fat_ptr _tmp34C=({const char*_tmp188="{";_tag_fat(_tmp188,sizeof(char),2U);});struct _fat_ptr _tmp34B=({const char*_tmp189="}";_tag_fat(_tmp189,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple19*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp34D,_tmp34C,_tmp34B,({const char*_tmp18A=",";_tag_fat(_tmp18A,sizeof(char),2U);}));});goto _LL0;}default: _LL6F: _tmpE0=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmpDF)->f1;_LL70: {struct Cyc_Absyn_Stmt*s=_tmpE0;
# 822
...
({struct Cyc_List_List*_tmp350=(*dp).f1;struct _fat_ptr _tmp34F=({const char*_tmp1D3="";_tag_fat(_tmp1D3,sizeof(char),1U);});struct _fat_ptr _tmp34E=({const char*_tmp1D4="=";_tag_fat(_tmp1D4,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,_tmp350,_tmp34F,_tmp34E,({const char*_tmp1D5="=";_tag_fat(_tmp1D5,sizeof(char),2U);}));});
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp200=({struct Cyc_Int_pa_PrintArg_struct _tmp305;_tmp305.tag=1U,_tmp305.f1=(unsigned long)i;_tmp305;});void*_tmp1FE[1U];_tmp1FE[0]=& _tmp200;({struct _fat_ptr _tmp351=({const char*_tmp1FF="%d";_tag_fat(_tmp1FF,sizeof(char),3U);});Cyc_aprintf(_tmp351,_tag_fat(_tmp1FE,sizeof(void*),1U));});}));goto _LL0;}default: _LL9: _tmp1FA=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1D9)->f2;_LLA: {int i=_tmp1FA;
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp203=({struct Cyc_Int_pa_PrintArg_struct _tmp306;_tmp306.tag=1U,_tmp306.f1=(unsigned)i;_tmp306;});void*_tmp201[1U];_tmp201[0]=& _tmp203;({struct _fat_ptr _tmp352=({const char*_tmp202="%u";_tag_fat(_tmp202,sizeof(char),3U);});Cyc_aprintf(_tmp352,_tag_fat(_tmp201,sizeof(void*),1U));});}));goto _LL0;}}case 12U: _LLB: _tmp1F9=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp1D9)->f1;_LLC: {struct _fat_ptr x=_tmp1F9;
...
({struct Cyc_List_List*_tmp355=ts;struct _fat_ptr _tmp354=({const char*_tmp20C="$(";_tag_fat(_tmp20C,sizeof(char),3U);});struct _fat_ptr _tmp353=Cyc_Absyndump_pat_term(dots);((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp355,_tmp354,_tmp353,({const char*_tmp20D=",";_tag_fat(_tmp20D,sizeof(char),2U);}));});goto _LL0;}case 6U: _LL1F: _tmp1EB=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp1D9)->f1;_LL20: {struct Cyc_Absyn_Pat*p2=_tmp1EB;
...
# 989
Cyc_Absyndump_dump_char((int)'{');
({struct Cyc_List_List*_tmp35B=exists;struct _fat_ptr _tmp35A=({const char*_tmp211="<";_tag_fat(_tmp211,sizeof(char),2U);});struct _fat_ptr _tmp359=({const char*_tmp212=">";_tag_fat(_tmp212,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp35B,_tmp35A,_tmp359,({const char*_tmp213=",";_tag_fat(_tmp213,sizeof(char),2U);}));});
({struct Cyc_List_List*_tmp35E=dps;struct _fat_ptr _tmp35D=({const char*_tmp214="";_tag_fat(_tmp214,sizeof(char),1U);});struct _fat_ptr _tmp35C=Cyc_Absyndump_pat_term(dots);((void(*)(void(*f)(struct _tuple21*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpdp,_tmp35E,_tmp35D,_tmp35C,({const char*_tmp215=",";_tag_fat(_tmp215,sizeof(char),2U);}));});
...
# 994
Cyc_Absyndump_dumpqvar(tuf->name);
if(ps != 0)({struct Cyc_List_List*_tmp361=ps;struct _fat_ptr _tmp360=({const char*_tmp216="(";_tag_fat(_tmp216,sizeof(char),2U);});struct _fat_ptr _tmp35F=Cyc_Absyndump_pat_term(dots);((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp361,_tmp360,_tmp35F,({const char*_tmp217=",";_tag_fat(_tmp217,sizeof(char),2U);}));});
...
({struct Cyc_List_List*_tmp362=fields;((void(*)(void(*f)(struct Cyc_Absyn_Datatypefield*),struct Cyc_List_List*l,struct _fat_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpdatatypefield,_tmp362,({const char*_tmp218=",";_tag_fat(_tmp218,sizeof(char),2U);}));});}
# 1009
...
# 1015
static void Cyc_Absyndump_dumpenumfields(struct Cyc_List_List*fields){
({struct Cyc_List_List*_tmp363=fields;((void(*)(void(*f)(struct Cyc_Absyn_Enumfield*),struct Cyc_List_List*l,struct _fat_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpenumfield,_tmp363,({const char*_tmp21A=",";_tag_fat(_tmp21A,sizeof(char),2U);}));});}
# 1019
static void Cyc_Absyndump_dumpaggrfields(struct Cyc_List_List*fields){
...
struct _tuple22 _tmp247=({struct _tuple22 _tmp307;_tmp307.f1=call_conv,_tmp307.f2=name;_tmp307;});struct _tuple22 pr=_tmp247;
({int _tmp364=is_cp;((void(*)(int is_char_ptr,struct Cyc_List_List*,void(*f)(struct _tuple22*),struct _tuple22*a))Cyc_Absyndump_dumptms)(_tmp364,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(tms),Cyc_Absyndump_dump_callconv_qvar,& pr);});
...
if(ad->impl != 0){
Cyc_Absyndump_dump_char((int)'{');
({struct Cyc_List_List*_tmp367=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->exist_vars;struct _fat_ptr _tmp366=({const char*_tmp249="<";_tag_fat(_tmp249,sizeof(char),2U);});struct _fat_ptr _tmp365=({const char*_tmp24A=">";_tag_fat(_tmp24A,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,_tmp367,_tmp366,_tmp365,({const char*_tmp24B=",";_tag_fat(_tmp24B,sizeof(char),2U);}));});
...
void*_tmp259=d->r;void*_stmttmp19=_tmp259;void*_tmp25A=_stmttmp19;struct _tuple10*_tmp25E;struct Cyc_List_List*_tmp25D;struct Cyc_List_List*_tmp25C;struct Cyc_List_List*_tmp25B;struct Cyc_List_List*_tmp25F;struct Cyc_List_List*_tmp261;struct _tuple0*_tmp260;struct Cyc_List_List*_tmp263;struct _fat_ptr*_tmp262;struct Cyc_Absyn_Typedefdecl*_tmp264;struct Cyc_Absyn_Exp*_tmp267;struct Cyc_Absyn_Vardecl*_tmp266;struct Cyc_Absyn_Tvar*_tmp265;struct Cyc_Absyn_Tvar*_tmp268;struct Cyc_Absyn_Exp*_tmp26A;struct Cyc_Absyn_Pat*_tmp269;struct Cyc_List_List*_tmp26B;struct Cyc_Absyn_Enumdecl*_tmp26C;struct Cyc_Absyn_Datatypedecl*_tmp26D;struct Cyc_Absyn_Aggrdecl*_tmp26E;struct Cyc_Absyn_Vardecl*_tmp26F;struct Cyc_Absyn_Fndecl*_tmp270;switch(*((int*)_tmp25A)){case 1U: _LL1: _tmp270=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_LL2: {struct Cyc_Absyn_Fndecl*fd=_tmp270;
# 1179
{enum Cyc_Flags_C_Compilers _tmp271=Cyc_Flags_c_compiler;if(_tmp271 == Cyc_Flags_Vc_c){_LL26: _LL27:
 Cyc_Absyndump_dumpatts((fd->i).attributes);goto _LL25;}else{_LL28: _LL29:
 goto _LL25;}_LL25:;}
# 1183
if(fd->is_inline){
enum Cyc_Flags_C_Compilers _tmp272=Cyc_Flags_c_compiler;if(_tmp272 == Cyc_Flags_Vc_c){_LL2B: _LL2C:
 Cyc_Absyndump_dump(({const char*_tmp273="__inline";_tag_fat(_tmp273,sizeof(char),9U);}));goto _LL2A;}else{_LL2D: _LL2E:
 Cyc_Absyndump_dump(({const char*_tmp274="inline";_tag_fat(_tmp274,sizeof(char),7U);}));goto _LL2A;}_LL2A:;}
# 1188
...
if(fd->cached_type != 0){
void*_tmp275=Cyc_Absyn_compress((void*)_check_null(fd->cached_type));void*_stmttmp1A=_tmp275;void*_tmp276=_stmttmp1A;struct Cyc_Absyn_FnInfo _tmp277;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp276)->tag == 5U){_LL30: _tmp277=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp276)->f1;_LL31: {struct Cyc_Absyn_FnInfo i=_tmp277;
# 1196
({struct Cyc_List_List*_tmp368=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)((fd->i).attributes,i.attributes);(fd->i).attributes=_tmp368;});goto _LL2F;}}else{_LL32: _LL33:
({void*_tmp278=0U;({struct _fat_ptr _tmp369=({const char*_tmp279="function has non-function type";_tag_fat(_tmp279,sizeof(char),31U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp369,_tag_fat(_tmp278,sizeof(void*),0U));});});}_LL2F:;}
# 1200
{enum Cyc_Flags_C_Compilers _tmp27A=Cyc_Flags_c_compiler;if(_tmp27A == Cyc_Flags_Gcc_c){_LL35: _LL36:
({struct Cyc_Absyn_Tqual _tmp36B=Cyc_Absyn_empty_tqual(0U);void*_tmp36A=t;((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*))Cyc_Absyndump_dumptqtd)(_tmp36B,_tmp36A,Cyc_Absyndump_dump_atts_qvar,fd);});goto _LL34;}else{_LL37: _LL38:
({struct Cyc_Absyn_Tqual _tmp36D=Cyc_Absyn_empty_tqual(0U);void*_tmp36C=t;((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*))Cyc_Absyndump_dumptqtd)(_tmp36D,_tmp36C,Cyc_Absyndump_dump_callconv_fdqvar,fd);});goto _LL34;}_LL34:;}
# 1204
Cyc_Absyndump_dump_char((int)'{');
Cyc_Absyndump_dumpstmt(fd->body,0,0);
Cyc_Absyndump_dump_char((int)'}');
goto _LL0;}}}case 0U: _LL3: _tmp26F=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_LL4: {struct Cyc_Absyn_Vardecl*vd=_tmp26F;
Cyc_Absyndump_dumpvardecl(vd,d->loc,1);goto _LL0;}case 6U: _LL5: _tmp26E=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_LL6: {struct Cyc_Absyn_Aggrdecl*ad=_tmp26E;
Cyc_Absyndump_dump_aggrdecl(ad);Cyc_Absyndump_dump_semi();goto _LL0;}case 7U: _LL7: _tmp26D=((struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_LL8: {struct Cyc_Absyn_Datatypedecl*dd=_tmp26D;
Cyc_Absyndump_dump_datatypedecl(dd);Cyc_Absyndump_dump_semi();goto _LL0;}case 8U: _LL9: _tmp26C=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_LLA: {struct Cyc_Absyn_Enumdecl*ed=_tmp26C;
Cyc_Absyndump_dump_enumdecl(ed);Cyc_Absyndump_dump_semi();goto _LL0;}case 3U: _LLB: _tmp26B=((struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_LLC: {struct Cyc_List_List*vds=_tmp26B;
({struct Cyc_List_List*_tmp370=vds;struct _fat_ptr _tmp36F=({const char*_tmp27C=" let ";_tag_fat(_tmp27C,sizeof(char),6U);});struct _fat_ptr _tmp36E=({const char*_tmp27D=";";_tag_fat(_tmp27D,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpid,_tmp370,_tmp36F,_tmp36E,({const char*_tmp27E=",";_tag_fat(_tmp27E,sizeof(char),2U);}));});goto _LL0;}case 2U: _LLD: _tmp269=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_tmp26A=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp25A)->f3;_LLE: {struct Cyc_Absyn_Pat*p=_tmp269;struct Cyc_Absyn_Exp*e=_tmp26A;
# 1214
Cyc_Absyndump_dump(({const char*_tmp27F="let";_tag_fat(_tmp27F,sizeof(char),4U);}));Cyc_Absyndump_dumppat(p);Cyc_Absyndump_dump_char((int)'=');Cyc_Absyndump_dumpexp(e);Cyc_Absyndump_dump_semi();goto _LL0;}case 5U: _LLF: _tmp268=((struct Cyc_Absyn_Pool_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_LL10: {struct Cyc_Absyn_Tvar*tv=_tmp268;
# 1216
Cyc_Absyndump_dump(({const char*_tmp280="autopool";_tag_fat(_tmp280,sizeof(char),9U);}));Cyc_Absyndump_dump(({const char*_tmp281="<";_tag_fat(_tmp281,sizeof(char),2U);}));Cyc_Absyndump_dumptvar(tv);Cyc_Absyndump_dump(({const char*_tmp282="> ";_tag_fat(_tmp282,sizeof(char),3U);}));Cyc_Absyndump_dump_semi();goto _LL0;}case 4U: _LL11: _tmp265=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_tmp266=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp25A)->f2;_tmp267=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp25A)->f3;_LL12: {struct Cyc_Absyn_Tvar*tv=_tmp265;struct Cyc_Absyn_Vardecl*vd=_tmp266;struct Cyc_Absyn_Exp*open_exp_opt=_tmp267;
# 1218
Cyc_Absyndump_dump(({const char*_tmp283="region";_tag_fat(_tmp283,sizeof(char),7U);}));Cyc_Absyndump_dump(({const char*_tmp284="<";_tag_fat(_tmp284,sizeof(char),2U);}));Cyc_Absyndump_dumptvar(tv);Cyc_Absyndump_dump(({const char*_tmp285="> ";_tag_fat(_tmp285,sizeof(char),3U);}));Cyc_Absyndump_dumpqvar(vd->name);
if((unsigned)open_exp_opt){
Cyc_Absyndump_dump(({const char*_tmp286=" = open(";_tag_fat(_tmp286,sizeof(char),9U);}));Cyc_Absyndump_dumpexp(open_exp_opt);Cyc_Absyndump_dump(({const char*_tmp287=")";_tag_fat(_tmp287,sizeof(char),2U);}));}
# 1222
Cyc_Absyndump_dump_semi();
goto _LL0;}case 9U: _LL13: _tmp264=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_LL14: {struct Cyc_Absyn_Typedefdecl*td=_tmp264;
# 1229
Cyc_Absyndump_dump(({const char*_tmp288="typedef";_tag_fat(_tmp288,sizeof(char),8U);}));{
...
Cyc_Absyndump_dump_semi();
# 1235
goto _LL0;}}case 10U: _LL15: _tmp262=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_tmp263=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp25A)->f2;_LL16: {struct _fat_ptr*v=_tmp262;struct Cyc_List_List*tdl=_tmp263;
# 1237
Cyc_Absyndump_dump(({const char*_tmp289="namespace";_tag_fat(_tmp289,sizeof(char),10U);}));Cyc_Absyndump_dump_str(v);Cyc_Absyndump_dump_braced_decls(tdl);goto _LL0;}case 11U: _LL17: _tmp260=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_tmp261=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp25A)->f2;_LL18: {struct _tuple0*q=_tmp260;struct Cyc_List_List*tdl=_tmp261;
# 1239
Cyc_Absyndump_dump(({const char*_tmp28A="using";_tag_fat(_tmp28A,sizeof(char),6U);}));Cyc_Absyndump_dumpqvar(q);Cyc_Absyndump_dump_braced_decls(tdl);goto _LL0;}case 12U: _LL19: _tmp25F=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_LL1A: {struct Cyc_List_List*tdl=_tmp25F;
# 1241
Cyc_Absyndump_dump(({const char*_tmp28B="extern \"C\" ";_tag_fat(_tmp28B,sizeof(char),12U);}));Cyc_Absyndump_dump_braced_decls(tdl);goto _LL0;}case 13U: _LL1B: _tmp25B=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp25A)->f1;_tmp25C=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp25A)->f2;_tmp25D=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp25A)->f3;_tmp25E=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp25A)->f4;_LL1C: {struct Cyc_List_List*tdl=_tmp25B;struct Cyc_List_List*ovrs=_tmp25C;struct Cyc_List_List*exs=_tmp25D;struct _tuple10*wc=_tmp25E;
# 1243
Cyc_Absyndump_dump(({const char*_tmp28C="extern \"C include\" ";_tag_fat(_tmp28C,sizeof(char),20U);}));Cyc_Absyndump_dump_braced_decls(tdl);
if(ovrs != 0){
Cyc_Absyndump_dump(({const char*_tmp28D=" cyclone_override ";_tag_fat(_tmp28D,sizeof(char),19U);}));
Cyc_Absyndump_dump_braced_decls(ovrs);}
# 1248
if((unsigned)wc){
Cyc_Absyndump_dump(({const char*_tmp28E=" export { * }\n";_tag_fat(_tmp28E,sizeof(char),15U);}));{
struct _tuple10*_tmp28F=wc;struct Cyc_List_List*_tmp290;_LL3A: _tmp290=_tmp28F->f2;_LL3B: {struct Cyc_List_List*hides=_tmp290;
if((unsigned)hides)
({struct Cyc_List_List*_tmp373=hides;struct _fat_ptr _tmp372=({const char*_tmp291=" cyclone_hide {";_tag_fat(_tmp291,sizeof(char),16U);});struct _fat_ptr _tmp371=({const char*_tmp292="}";_tag_fat(_tmp292,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple0*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpqvar,_tmp373,_tmp372,_tmp371,({const char*_tmp293=",";_tag_fat(_tmp293,sizeof(char),2U);}));});}}}else{
# 1256
({struct Cyc_List_List*_tmp376=exs;struct _fat_ptr _tmp375=({const char*_tmp294=" export {";_tag_fat(_tmp294,sizeof(char),10U);});struct _fat_ptr _tmp374=({const char*_tmp295="}";_tag_fat(_tmp295,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple23*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpexport,_tmp376,_tmp375,_tmp374,({const char*_tmp296=",";_tag_fat(_tmp296,sizeof(char),2U);}));});}
# 1258
goto _LL0;}case 14U: _LL1D: _LL1E:
 Cyc_Absyndump_dump(({const char*_tmp297=" __cyclone_port_on__; ";_tag_fat(_tmp297,sizeof(char),23U);}));goto _LL0;case 15U: _LL1F: _LL20:
 Cyc_Absyndump_dump(({const char*_tmp298=" __cyclone_port_off__; ";_tag_fat(_tmp298,sizeof(char),24U);}));goto _LL0;case 16U: _LL21: _LL22:
 Cyc_Absyndump_dump(({const char*_tmp299=" __tempest_on__; ";_tag_fat(_tmp299,sizeof(char),18U);}));goto _LL0;default: _LL23: _LL24:
 Cyc_Absyndump_dump(({const char*_tmp29A=" __tempest_off__; ";_tag_fat(_tmp29A,sizeof(char),19U);}));goto _LL0;}_LL0:;}}
# 1266
...
return;}{
# 1279
void*_tmp29B=(void*)tms->hd;void*_stmttmp1B=_tmp29B;void*_tmp29C=_stmttmp1B;struct Cyc_Absyn_Tqual _tmp2A2;void*_tmp2A1;void*_tmp2A0;void*_tmp29F;void*_tmp29E;void*_tmp29D;if(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->tag == 2U){_LL1: _tmp29D=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f1).rgn;_tmp29E=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f1).nullable;_tmp29F=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f1).bounds;_tmp2A0=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f1).zero_term;_tmp2A1=(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f1).released;_tmp2A2=((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp29C)->f2;_LL2: {void*rgn=_tmp29D;void*nullable=_tmp29E;void*bd=_tmp29F;void*zt=_tmp2A0;void*rel=_tmp2A1;struct Cyc_Absyn_Tqual tq2=_tmp2A2;
# 1283
{void*_tmp2A3=Cyc_Absyn_compress(bd);void*_stmttmp1C=_tmp2A3;void*_tmp2A4=_stmttmp1C;struct Cyc_Absyn_Exp*_tmp2A5;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A4)->tag == 0U)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2A4)->f1)){case 14U: _LL6: _LL7:
...
# 1290
if((!Cyc_Absyndump_qvar_to_Cids && !is_char_ptr)&& Cyc_Absyn_type2bool(0,zt))Cyc_Absyndump_dump(({const char*_tmp2A6="@zeroterm";_tag_fat(_tmp2A6,sizeof(char),10U);}));
if((!Cyc_Absyndump_qvar_to_Cids && is_char_ptr)&& !Cyc_Absyn_type2bool(0,zt))Cyc_Absyndump_dump(({const char*_tmp2A7="@nozeroterm";_tag_fat(_tmp2A7,sizeof(char),12U);}));
if(!Cyc_Absyndump_qvar_to_Cids && Cyc_Absyn_type2bool(0,rel))Cyc_Absyndump_dump(({const char*_tmp2A8="@released";_tag_fat(_tmp2A8,sizeof(char),10U);}));
{void*_tmp2A9=Cyc_Absyn_compress(rgn);void*_stmttmp1D=_tmp2A9;void*_tmp2AA=_stmttmp1D;struct Cyc_Absyn_Tvar*_tmp2AB;switch(*((int*)_tmp2AA)){case 0U: switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp2AA)->f1)){case 5U: _LLD: _LLE:
 if(!Cyc_Absyndump_qvar_to_Cids)Cyc_Absyndump_dump(({const char*_tmp2AC="`H";_tag_fat(_tmp2AC,sizeof(char),3U);}));goto _LLC;case 6U: _LLF: _LL10:
 Cyc_Absyndump_dump(({const char*_tmp2AD="`U";_tag_fat(_tmp2AD,sizeof(char),3U);}));goto _LLC;case 7U: _LL11: _LL12:
 Cyc_Absyndump_dump(({const char*_tmp2AE="`RC";_tag_fat(_tmp2AE,sizeof(char),4U);}));goto _LLC;default: goto _LL19;}case 2U: _LL13: _tmp2AB=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp2AA)->f1;_LL14: {struct Cyc_Absyn_Tvar*tv=_tmp2AB;
Cyc_Absyndump_dumptvar(tv);goto _LLC;}case 1U: if(((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp2AA)->f2 == 0){_LL15: _LL16:
 Cyc_Absyndump_dumpntyp(Cyc_Absyn_compress(rgn));goto _LLC;}else{goto _LL19;}case 8U: _LL17: _LL18:
 Cyc_Absyndump_dump(({const char*_tmp2AF="@region(";_tag_fat(_tmp2AF,sizeof(char),9U);}));Cyc_Absyndump_dumptyp(rgn);Cyc_Absyndump_dump(({const char*_tmp2B0=")";_tag_fat(_tmp2B0,sizeof(char),2U);}));goto _LLC;default: _LL19: _LL1A:
({void*_tmp2B1=0U;({struct _fat_ptr _tmp377=({const char*_tmp2B2="dumptms: bad rgn type in Pointer_mod";_tag_fat(_tmp2B2,sizeof(char),37U);});Cyc_Warn_impos(_tmp377,_tag_fat(_tmp2B1,sizeof(void*),0U));});});}_LLC:;}
# 1302
...
if(tms->tl != 0){
void*_tmp2B3=(void*)((struct Cyc_List_List*)_check_null(tms->tl))->hd;void*_stmttmp1E=_tmp2B3;void*_tmp2B4=_stmttmp1E;if(((struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp2B4)->tag == 2U){_LL1C: _LL1D:
...
if(next_is_pointer)
Cyc_Absyndump_dump_char((int)')');
{void*_tmp2B5=(void*)tms->hd;void*_stmttmp1F=_tmp2B5;void*_tmp2B6=_stmttmp1F;struct Cyc_List_List*_tmp2B7;int _tmp2BA;unsigned _tmp2B9;struct Cyc_List_List*_tmp2B8;unsigned _tmp2BC;struct Cyc_List_List*_tmp2BB;struct Cyc_Absyn_Exp*_tmp2C3;struct Cyc_Absyn_Exp*_tmp2C2;struct Cyc_List_List*_tmp2C1;void*_tmp2C0;struct Cyc_Absyn_VarargInfo*_tmp2BF;int _tmp2BE;struct Cyc_List_List*_tmp2BD;void*_tmp2C5;struct Cyc_Absyn_Exp*_tmp2C4;void*_tmp2C6;switch(*((int*)_tmp2B6)){case 0U: _LL21: _tmp2C6=(void*)((struct Cyc_Absyn_Carray_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1;_LL22: {void*zeroterm=_tmp2C6;
# 1320
Cyc_Absyndump_dump(({const char*_tmp2C7="[]";_tag_fat(_tmp2C7,sizeof(char),3U);}));
if(Cyc_Absyn_type2bool(0,zeroterm))Cyc_Absyndump_dump(({const char*_tmp2C8="@zeroterm";_tag_fat(_tmp2C8,sizeof(char),10U);}));
goto _LL20;}case 1U: _LL23: _tmp2C4=((struct Cyc_Absyn_ConstArray_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1;_tmp2C5=(void*)((struct Cyc_Absyn_ConstArray_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f2;_LL24: {struct Cyc_Absyn_Exp*e=_tmp2C4;void*zeroterm=_tmp2C5;
# 1324
Cyc_Absyndump_dump_char((int)'[');Cyc_Absyndump_dumpexp(e);Cyc_Absyndump_dump_char((int)']');
if(Cyc_Absyn_type2bool(0,zeroterm))Cyc_Absyndump_dump(({const char*_tmp2C9="@zeroterm";_tag_fat(_tmp2C9,sizeof(char),10U);}));
goto _LL20;}case 3U: if(((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1)->tag == 1U){_LL25: _tmp2BD=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1)->f1;_tmp2BE=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1)->f2;_tmp2BF=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1)->f3;_tmp2C0=(void*)((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1)->f4;_tmp2C1=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1)->f5;_tmp2C2=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1)->f6;_tmp2C3=((struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1)->f7;_LL26: {struct Cyc_List_List*args=_tmp2BD;int c_varargs=_tmp2BE;struct Cyc_Absyn_VarargInfo*cyc_varargs=_tmp2BF;void*effopt=_tmp2C0;struct Cyc_List_List*rgn_po=_tmp2C1;struct Cyc_Absyn_Exp*req=_tmp2C2;struct Cyc_Absyn_Exp*ens=_tmp2C3;
# 1328
Cyc_Absyndump_dumpfunargs(args,c_varargs,cyc_varargs,effopt,rgn_po,req,ens);goto _LL20;}}else{_LL27: _tmp2BB=((struct Cyc_Absyn_NoTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1)->f1;_tmp2BC=((struct Cyc_Absyn_NoTypes_Absyn_Funcparams_struct*)((struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1)->f2;_LL28: {struct Cyc_List_List*sl=_tmp2BB;unsigned loc=_tmp2BC;
# 1330
({struct Cyc_List_List*_tmp37A=sl;struct _fat_ptr _tmp379=({const char*_tmp2CA="(";_tag_fat(_tmp2CA,sizeof(char),2U);});struct _fat_ptr _tmp378=({const char*_tmp2CB=")";_tag_fat(_tmp2CB,sizeof(char),2U);});((void(*)(void(*f)(struct _fat_ptr*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dump_str,_tmp37A,_tmp379,_tmp378,({const char*_tmp2CC=",";_tag_fat(_tmp2CC,sizeof(char),2U);}));});goto _LL20;}}case 4U: _LL29: _tmp2B8=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f1;_tmp2B9=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f2;_tmp2BA=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f3;_LL2A: {struct Cyc_List_List*ts=_tmp2B8;unsigned loc=_tmp2B9;int print_kinds=_tmp2BA;
# 1332
if(print_kinds)Cyc_Absyndump_dumpkindedtvars(ts);else{Cyc_Absyndump_dumptvars(ts);}goto _LL20;}case 5U: _LL2B: _tmp2B7=((struct Cyc_Absyn_Attributes_mod_Absyn_Type_modifier_struct*)_tmp2B6)->f2;_LL2C: {struct Cyc_List_List*atts=_tmp2B7;
Cyc_Absyndump_dumpatts(atts);goto _LL20;}default: _LL2D: _LL2E:
({void*_tmp2CD=0U;({struct _fat_ptr _tmp37B=({const char*_tmp2CE="dumptms";_tag_fat(_tmp2CE,sizeof(char),8U);});Cyc_Warn_impos(_tmp37B,_tag_fat(_tmp2CD,sizeof(void*),0U));});});}_LL20:;}
# 1336
return;}}_LL0:;}}
# 1340
static void Cyc_Absyndump_dumptqtd(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(void*),void*a){
int _tmp2CF=Cyc_Absyndump_is_char_ptr(t);int cp=_tmp2CF;
struct _RegionHandle _tmp2D0=_new_region("temp");struct _RegionHandle*temp=& _tmp2D0;_push_region(temp);
{struct _tuple12 _tmp2D1=Cyc_Absynpp_to_tms(temp,tq,t);struct _tuple12 _stmttmp20=_tmp2D1;struct _tuple12 _tmp2D2=_stmttmp20;struct Cyc_List_List*_tmp2D5;void*_tmp2D4;struct Cyc_Absyn_Tqual _tmp2D3;_LL1: _tmp2D3=_tmp2D2.f1;_tmp2D4=_tmp2D2.f2;_tmp2D5=_tmp2D2.f3;_LL2: {struct Cyc_Absyn_Tqual tq=_tmp2D3;void*t=_tmp2D4;struct Cyc_List_List*tms=_tmp2D5;
Cyc_Absyndump_dumptq(tq);
Cyc_Absyndump_dumpntyp(t);
({int _tmp37E=cp;struct Cyc_List_List*_tmp37D=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(tms);void(*_tmp37C)(void*)=f;Cyc_Absyndump_dumptms(_tmp37E,_tmp37D,_tmp37C,a);});}}
# 1343
;_pop_region();}
# 1349
...
for(0;tdl != 0;tdl=tdl->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)tdl->hd);}
({void*_tmp2D6=0U;({struct Cyc___cycFILE*_tmp380=f;struct _fat_ptr _tmp37F=({const char*_tmp2D7="\n";_tag_fat(_tmp2D7,sizeof(char),2U);});Cyc_fprintf(_tmp380,_tmp37F,_tag_fat(_tmp2D6,sizeof(void*),0U));});});}
# 1357
static void Cyc_Absyndump_dump_decl_interface(struct Cyc_Absyn_Decl*d){
void*_tmp2D8=d->r;void*_stmttmp21=_tmp2D8;void*_tmp2D9=_stmttmp21;struct _tuple10*_tmp2DD;struct Cyc_List_List*_tmp2DC;struct Cyc_List_List*_tmp2DB;struct Cyc_List_List*_tmp2DA;struct Cyc_List_List*_tmp2DE;struct Cyc_List_List*_tmp2DF;struct Cyc_List_List*_tmp2E1;struct _fat_ptr*_tmp2E0;struct Cyc_Absyn_Typedefdecl*_tmp2E2;struct Cyc_Absyn_Enumdecl*_tmp2E3;struct Cyc_Absyn_Datatypedecl*_tmp2E4;struct Cyc_Absyn_Aggrdecl*_tmp2E5;struct Cyc_Absyn_Fndecl*_tmp2E6;struct Cyc_Absyn_Vardecl*_tmp2E7;switch(*((int*)_tmp2D9)){case 0U: _LL1: _tmp2E7=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp2D9)->f1;_LL2: {struct Cyc_Absyn_Vardecl*vd=_tmp2E7;
# 1360
if((int)vd->sc == (int)Cyc_Absyn_Static)return;{
struct Cyc_Absyn_Exp*init=vd->initializer;
vd->initializer=0;
if((int)vd->sc == (int)Cyc_Absyn_Public)
Cyc_Absyndump_dump(({const char*_tmp2E8="extern ";_tag_fat(_tmp2E8,sizeof(char),8U);}));else{
if(!vd->is_proto){
void*_tmp2E9=Cyc_Absyn_compress(vd->type);void*_stmttmp22=_tmp2E9;void*_tmp2EA=_stmttmp22;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp2EA)->tag == 5U){_LL18: _LL19:
 Cyc_Absyndump_dump(({const char*_tmp2EB="extern ";_tag_fat(_tmp2EB,sizeof(char),8U);}));goto _LL17;}else{_LL1A: _LL1B:
 goto _LL17;}_LL17:;}}
# 1370
Cyc_Absyndump_dumpvardecl(vd,d->loc,1);
Cyc_Absyndump_dump(({const char*_tmp2EC="\n";_tag_fat(_tmp2EC,sizeof(char),2U);}));
vd->initializer=init;
goto _LL0;}}case 1U: _LL3: _tmp2E6=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp2D9)->f1;_LL4: {struct Cyc_Absyn_Fndecl*fd=_tmp2E6;
# 1375
if((int)fd->sc == (int)Cyc_Absyn_Static)return;
Cyc_Absyndump_dumpscope(fd->sc);{
struct Cyc_Absyn_FnInfo type_info=fd->i;
type_info.attributes=0;{
void*t=(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp2EE=_cycalloc(sizeof(*_tmp2EE));_tmp2EE->tag=5U,_tmp2EE->f1=type_info;_tmp2EE;});
({struct Cyc_Absyn_Tqual _tmp382=Cyc_Absyn_empty_tqual(0U);void*_tmp381=t;((void(*)(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*a))Cyc_Absyndump_dumptqtd)(_tmp382,_tmp381,Cyc_Absyndump_dump_atts_qvar,fd);});
Cyc_Absyndump_dump(({const char*_tmp2ED=";\n";_tag_fat(_tmp2ED,sizeof(char),3U);}));
goto _LL0;}}}case 6U: _LL5: _tmp2E5=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp2D9)->f1;_LL6: {struct Cyc_Absyn_Aggrdecl*ad=_tmp2E5;
# 1384
...
ad->impl=impl;
Cyc_Absyndump_dump(({const char*_tmp2EF=";\n";_tag_fat(_tmp2EF,sizeof(char),3U);}));
goto _LL0;}}case 7U: _LL7: _tmp2E4=((struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp2D9)->f1;_LL8: {struct Cyc_Absyn_Datatypedecl*dd=_tmp2E4;
Cyc_Absyndump_dump_datatypedecl(dd);Cyc_Absyndump_dump(({const char*_tmp2F0=";\n";_tag_fat(_tmp2F0,sizeof(char),3U);}));goto _LL0;}case 8U: _LL9: _tmp2E3=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp2D9)->f1;_LLA: {struct Cyc_Absyn_Enumdecl*ed=_tmp2E3;
Cyc_Absyndump_dump_enumdecl(ed);Cyc_Absyndump_dump(({const char*_tmp2F1=";\n";_tag_fat(_tmp2F1,sizeof(char),3U);}));goto _LL0;}case 9U: _LLB: _tmp2E2=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp2D9)->f1;_LLC: {struct Cyc_Absyn_Typedefdecl*td=_tmp2E2;
# 1394
if(td->defn == 0){
Cyc_Absyndump_dumpdecl(d);
Cyc_Absyndump_dump(({const char*_tmp2F2="\n";_tag_fat(_tmp2F2,sizeof(char),2U);}));}
# 1398
goto _LL0;}case 10U: _LLD: _tmp2E0=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp2D9)->f1;_tmp2E1=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp2D9)->f2;_LLE: {struct _fat_ptr*v=_tmp2E0;struct Cyc_List_List*ds=_tmp2E1;
# 1400
Cyc_Absyndump_dump(({const char*_tmp2F3="namespace ";_tag_fat(_tmp2F3,sizeof(char),11U);}));
Cyc_Absyndump_dump_str(v);
Cyc_Absyndump_dump(({const char*_tmp2F4="{\n";_tag_fat(_tmp2F4,sizeof(char),3U);}));
for(0;ds != 0;ds=ds->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)ds->hd);}
Cyc_Absyndump_dump(({const char*_tmp2F5="}\n";_tag_fat(_tmp2F5,sizeof(char),3U);}));
goto _LL0;}case 11U: _LLF: _tmp2DF=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp2D9)->f2;_LL10: {struct Cyc_List_List*ds=_tmp2DF;
# 1408
for(0;ds != 0;ds=ds->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)ds->hd);}
goto _LL0;}case 12U: _LL11: _tmp2DE=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp2D9)->f1;_LL12: {struct Cyc_List_List*ds=_tmp2DE;
# 1412
Cyc_Absyndump_dump(({const char*_tmp2F6="extern \"C\" {";_tag_fat(_tmp2F6,sizeof(char),13U);}));
for(0;ds != 0;ds=ds->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)ds->hd);}
Cyc_Absyndump_dump(({const char*_tmp2F7="}\n";_tag_fat(_tmp2F7,sizeof(char),3U);}));
goto _LL0;}case 13U: _LL13: _tmp2DA=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2D9)->f1;_tmp2DB=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2D9)->f2;_tmp2DC=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2D9)->f3;_tmp2DD=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2D9)->f4;_LL14: {struct Cyc_List_List*ds=_tmp2DA;struct Cyc_List_List*ovrs=_tmp2DB;struct Cyc_List_List*exs=_tmp2DC;struct _tuple10*wc=_tmp2DD;
# 1433 "absyndump.cyc"
goto _LL0;}default: _LL15: _LL16:
({void*_tmp2F8=0U;({struct _fat_ptr _tmp383=({const char*_tmp2F9="bad top-level declaration";_tag_fat(_tmp2F9,sizeof(char),26U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp383,_tag_fat(_tmp2F8,sizeof(void*),0U));});});}_LL0:;}
# 1438
