...
# 284
int Cyc_Tcutil_is_const_exp(struct Cyc_Absyn_Exp*e);struct _tuple17{struct Cyc_Absyn_Tqual f1;void*f2;};
# 287
void*Cyc_Tcutil_snd_tqt(struct _tuple17*);
# 291
...
# 32
extern enum Cyc_Cyclone_C_Compilers Cyc_Cyclone_c_compiler;struct _tuple18{struct _fat_ptr f1;unsigned f2;};
# 27 "absyndump.cyc"
struct _tuple18 Cyc_Lex_xlate_pos(unsigned);
# 37
...
# 151
struct _tuple18 _tmp1=Cyc_Lex_xlate_pos(loc);struct _tuple18 _tmp2=_tmp1;struct _fat_ptr _tmpD;unsigned _tmpC;_LL1: _tmpD=_tmp2.f1;_tmpC=_tmp2.f2;_LL2:;
if(({char*_tmp2DE=(char*)_tmpD.curr;_tmp2DE == (char*)(_tag_fat(0,0,0)).curr;})||(char*)_tmpD.curr == (char*)last_file.curr && _tmpC == last_line)return;
if((char*)_tmpD.curr == (char*)last_file.curr && _tmpC == last_line + (unsigned)1)
({void*_tmp3=0U;({struct Cyc___cycFILE*_tmp2E0=*Cyc_Absyndump_dump_file;struct _fat_ptr _tmp2DF=({const char*_tmp4="\n";_tag_fat(_tmp4,sizeof(char),2U);});Cyc_fprintf(_tmp2E0,_tmp2DF,_tag_fat(_tmp3,sizeof(void*),0U));});});else{
if((char*)_tmpD.curr == (char*)last_file.curr)
({struct Cyc_Int_pa_PrintArg_struct _tmp7=({struct Cyc_Int_pa_PrintArg_struct _tmp2D1;_tmp2D1.tag=1U,_tmp2D1.f1=(unsigned long)((int)_tmpC);_tmp2D1;});void*_tmp5[1U];_tmp5[0]=& _tmp7;({struct Cyc___cycFILE*_tmp2E2=*Cyc_Absyndump_dump_file;struct _fat_ptr _tmp2E1=({const char*_tmp6="\n# %d\n";_tag_fat(_tmp6,sizeof(char),7U);});Cyc_fprintf(_tmp2E2,_tmp2E1,_tag_fat(_tmp5,sizeof(void*),1U));});});else{
# 158
({struct Cyc_Int_pa_PrintArg_struct _tmpA=({struct Cyc_Int_pa_PrintArg_struct _tmp2D3;_tmp2D3.tag=1U,_tmp2D3.f1=(unsigned long)((int)_tmpC);_tmp2D3;});struct Cyc_String_pa_PrintArg_struct _tmpB=({struct Cyc_String_pa_PrintArg_struct _tmp2D2;_tmp2D2.tag=0U,_tmp2D2.f1=(struct _fat_ptr)((struct _fat_ptr)_tmpD);_tmp2D2;});void*_tmp8[2U];_tmp8[0]=& _tmpA,_tmp8[1]=& _tmpB;({struct Cyc___cycFILE*_tmp2E4=*Cyc_Absyndump_dump_file;struct _fat_ptr _tmp2E3=({const char*_tmp9="\n# %d %s\n";_tag_fat(_tmp9,sizeof(char),10U);});Cyc_fprintf(_tmp2E4,_tmp2E3,_tag_fat(_tmp8,sizeof(void*),2U));});});}}
# 160
last_file=_tmpD;
last_line=_tmpC;};}
# 166
...
({struct Cyc_List_List*_tmp2E7=ts;struct _fat_ptr _tmp2E6=({const char*_tmp23="<";_tag_fat(_tmp23,sizeof(char),2U);});struct _fat_ptr _tmp2E5=({const char*_tmp24=">";_tag_fat(_tmp24,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptyp,_tmp2E7,_tmp2E6,_tmp2E5,({const char*_tmp25=",";_tag_fat(_tmp25,sizeof(char),2U);}));});}
# 270
...
({struct Cyc_List_List*_tmp2EA=tvs;struct _fat_ptr _tmp2E9=({const char*_tmp30="<";_tag_fat(_tmp30,sizeof(char),2U);});struct _fat_ptr _tmp2E8=({const char*_tmp31=">";_tag_fat(_tmp31,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp2EA,_tmp2E9,_tmp2E8,({const char*_tmp32=",";_tag_fat(_tmp32,sizeof(char),2U);}));});}
# 295
static void Cyc_Absyndump_dumpkindedtvars(struct Cyc_List_List*tvs){
({struct Cyc_List_List*_tmp2ED=tvs;struct _fat_ptr _tmp2EC=({const char*_tmp33="<";_tag_fat(_tmp33,sizeof(char),2U);});struct _fat_ptr _tmp2EB=({const char*_tmp34=">";_tag_fat(_tmp34,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,_tmp2ED,_tmp2EC,_tmp2EB,({const char*_tmp35=",";_tag_fat(_tmp35,sizeof(char),2U);}));});}
# 298
...
({struct Cyc_List_List*_tmp2F0=ts;struct _fat_ptr _tmp2EF=({const char*_tmp36="(";_tag_fat(_tmp36,sizeof(char),2U);});struct _fat_ptr _tmp2EE=({const char*_tmp37=")";_tag_fat(_tmp37,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumparg,_tmp2F0,_tmp2EF,_tmp2EE,({const char*_tmp38=",";_tag_fat(_tmp38,sizeof(char),2U);}));});}
# 305
...
Cyc_Absyndump_dumpntyp(t);}struct _tuple19{struct Cyc_List_List*f1;struct Cyc_List_List*f2;};
# 359
...
struct _tuple19 _tmp4A=Cyc_Absyndump_effects_split((void*)_tmp50->hd);struct _tuple19 _tmp4B=_tmp4A;struct Cyc_List_List*_tmp4D;struct Cyc_List_List*_tmp4C;_LL8: _tmp4D=_tmp4B.f1;_tmp4C=_tmp4B.f2;_LL9:;
...
# 373
return({struct _tuple19 _tmp2D4;_tmp2D4.f1=rgions,_tmp2D4.f2=effects;_tmp2D4;});}
# 376
static void Cyc_Absyndump_dumpeff(void*t){
struct _tuple19 _tmp51=Cyc_Absyndump_effects_split(t);struct _tuple19 _tmp52=_tmp51;struct Cyc_List_List*_tmp5A;struct Cyc_List_List*_tmp59;_LL1: _tmp5A=_tmp52.f1;_tmp59=_tmp52.f2;_LL2:;
...
if(_tmp59 != 0){
({struct Cyc_List_List*_tmp2F3=_tmp59;struct _fat_ptr _tmp2F2=({const char*_tmp53="";_tag_fat(_tmp53,sizeof(char),1U);});struct _fat_ptr _tmp2F1=({const char*_tmp54="";_tag_fat(_tmp54,sizeof(char),1U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpntyp,_tmp2F3,_tmp2F2,_tmp2F1,({const char*_tmp55="+";_tag_fat(_tmp55,sizeof(char),2U);}));});
if(_tmp5A != 0)Cyc_Absyndump_dump_char((int)'+');}
# 384
if(_tmp5A != 0 || _tmp59 == 0)
({struct Cyc_List_List*_tmp2F6=_tmp5A;struct _fat_ptr _tmp2F5=({const char*_tmp56="{";_tag_fat(_tmp56,sizeof(char),2U);});struct _fat_ptr _tmp2F4=({const char*_tmp57="}";_tag_fat(_tmp57,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumprgn,_tmp2F6,_tmp2F5,_tmp2F4,({const char*_tmp58=",";_tag_fat(_tmp58,sizeof(char),2U);}));});}
# 389
static void Cyc_Absyndump_dumpntyp(void*t){
...
({void*_tmpA2=0U;({struct _fat_ptr _tmp2FA=({const char*_tmpA3="bad type constructor";_tag_fat(_tmpA3,sizeof(char),21U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp2FA,_tag_fat(_tmpA2,sizeof(void*),0U));});});}_LL21:;}}case 2U: _LL9: _tmpAD=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp5B)->f1;_LLA:
# 396
...
Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp61=({struct Cyc_Int_pa_PrintArg_struct _tmp2D5;_tmp2D5.tag=1U,_tmp2D5.f1=(unsigned long)_tmpAE;_tmp2D5;});void*_tmp5F[1U];_tmp5F[0]=& _tmp61;({struct _fat_ptr _tmp2FB=({const char*_tmp60="%d";_tag_fat(_tmp60,sizeof(char),3U);});Cyc_aprintf(_tmp2FB,_tag_fat(_tmp5F,sizeof(void*),1U));});}));return;}else{_LLD: _tmpB2=((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp5B)->f1;_tmpB1=(void*)((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp5B)->f2;_tmpB0=((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp5B)->f3;_LLE:
...
((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct _fat_ptr*),struct _fat_ptr*))Cyc_Absyndump_dumptqtd)((*t).f2,(*t).f3,Cyc_Absyndump_dumpvaropt,(*t).f1);}struct _tuple20{void*f1;void*f2;};
# 489
static void Cyc_Absyndump_dump_rgncmp(struct _tuple20*cmp){
...
({struct Cyc_List_List*_tmp2FC=rgn_po;((void(*)(void(*f)(struct _tuple20*),struct Cyc_List_List*l,struct _fat_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dump_rgncmp,_tmp2FC,({const char*_tmpBD=",";_tag_fat(_tmpBD,sizeof(char),2U);}));});}
# 495
...
# 499
({struct Cyc_List_List*_tmp2FF=args;struct _fat_ptr _tmp2FE=({const char*_tmpBE="(";_tag_fat(_tmpBE,sizeof(char),2U);});struct _fat_ptr _tmp2FD=({const char*_tmpBF="";_tag_fat(_tmpBF,sizeof(char),1U);});((void(*)(void(*f)(struct _tuple8*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpfunarg,_tmp2FF,_tmp2FE,_tmp2FD,({const char*_tmpC0=",";_tag_fat(_tmpC0,sizeof(char),2U);}));});
...
void*_tmpC6=d;struct _fat_ptr*_tmpC9;struct Cyc_Absyn_Exp*_tmpC8;if(((struct Cyc_Absyn_ArrayElement_Absyn_Designator_struct*)_tmpC6)->tag == 0U){_LL1: _tmpC8=((struct Cyc_Absyn_ArrayElement_Absyn_Designator_struct*)_tmpC6)->f1;_LL2:
 ...
 Cyc_Absyndump_dump_char((int)'.');Cyc_Absyndump_dump_nospace(*_tmpC9);goto _LL0;}_LL0:;}struct _tuple21{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
# 531
static void Cyc_Absyndump_dumpde(struct _tuple21*de){
({struct Cyc_List_List*_tmp303=(*de).f1;struct _fat_ptr _tmp302=({const char*_tmpCA="";_tag_fat(_tmpCA,sizeof(char),1U);});struct _fat_ptr _tmp301=({const char*_tmpCB="=";_tag_fat(_tmpCB,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,_tmp303,_tmp302,_tmp301,({const char*_tmpCC="=";_tag_fat(_tmpCC,sizeof(char),2U);}));});
...
void*_tmpCD=f;unsigned _tmpD2;struct _fat_ptr*_tmpD1;if(((struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*)_tmpCD)->tag == 0U){_LL1: _tmpD1=((struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*)_tmpCD)->f1;_LL2:
 ...
 Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpD0=({struct Cyc_Int_pa_PrintArg_struct _tmp2D6;_tmp2D6.tag=1U,_tmp2D6.f1=(unsigned long)((int)_tmpD2);_tmp2D6;});void*_tmpCE[1U];_tmpCE[0]=& _tmpD0;({struct _fat_ptr _tmp304=({const char*_tmpCF="%d";_tag_fat(_tmpCF,sizeof(char),3U);});Cyc_aprintf(_tmp304,_tag_fat(_tmpCE,sizeof(void*),1U));});}));return;}_LL0:;}
# 543
static void Cyc_Absyndump_dumpexps_prec(int inprec,struct Cyc_List_List*es){
({int _tmp308=inprec;struct Cyc_List_List*_tmp307=es;struct _fat_ptr _tmp306=({const char*_tmpD3="";_tag_fat(_tmpD3,sizeof(char),1U);});struct _fat_ptr _tmp305=({const char*_tmpD4="";_tag_fat(_tmpD4,sizeof(char),1U);});((void(*)(void(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group_c)(Cyc_Absyndump_dumpexp_prec,_tmp308,_tmp307,_tmp306,_tmp305,({const char*_tmpD5=",";_tag_fat(_tmpD5,sizeof(char),2U);}));});}
# 547
...
goto _LL0;case 3U: _LL3: _tmp12A=((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpD8)->f1).Wchar_c).val;_LL4:
 Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpDB=({struct Cyc_String_pa_PrintArg_struct _tmp2D7;_tmp2D7.tag=0U,_tmp2D7.f1=(struct _fat_ptr)((struct _fat_ptr)_tmp12A);_tmp2D7;});void*_tmpD9[1U];_tmpD9[0]=& _tmpDB;({struct _fat_ptr _tmp309=({const char*_tmpDA="L'%s'";_tag_fat(_tmpDA,sizeof(char),6U);});Cyc_aprintf(_tmp309,_tag_fat(_tmpD9,sizeof(void*),1U));});}));goto _LL0;case 4U: _LL5: _tmp12C=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpD8)->f1).Short_c).val).f1;_tmp12B=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpD8)->f1).Short_c).val).f2;_LL6:
 Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpDE=({struct Cyc_Int_pa_PrintArg_struct _tmp2D8;_tmp2D8.tag=1U,_tmp2D8.f1=(unsigned long)((int)_tmp12B);_tmp2D8;});void*_tmpDC[1U];_tmpDC[0]=& _tmpDE;({struct _fat_ptr _tmp30A=({const char*_tmpDD="%d";_tag_fat(_tmpDD,sizeof(char),3U);});Cyc_aprintf(_tmp30A,_tag_fat(_tmpDC,sizeof(void*),1U));});}));goto _LL0;case 5U: switch((((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpD8)->f1).Int_c).val).f1){case Cyc_Absyn_None: _LL7: _tmp12D=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpD8)->f1).Int_c).val).f2;_LL8:
 ...
 Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpE1=({struct Cyc_Int_pa_PrintArg_struct _tmp2D9;_tmp2D9.tag=1U,_tmp2D9.f1=(unsigned long)_tmp12E;_tmp2D9;});void*_tmpDF[1U];_tmpDF[0]=& _tmpE1;({struct _fat_ptr _tmp30B=({const char*_tmpE0="%d";_tag_fat(_tmpE0,sizeof(char),3U);});Cyc_aprintf(_tmp30B,_tag_fat(_tmpDF,sizeof(void*),1U));});}));goto _LL0;default: _LLB: _tmp12F=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpD8)->f1).Int_c).val).f2;_LLC:
 Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpE4=({struct Cyc_Int_pa_PrintArg_struct _tmp2DA;_tmp2DA.tag=1U,_tmp2DA.f1=(unsigned)_tmp12F;_tmp2DA;});void*_tmpE2[1U];_tmpE2[0]=& _tmpE4;({struct _fat_ptr _tmp30C=({const char*_tmpE3="%uU";_tag_fat(_tmpE3,sizeof(char),4U);});Cyc_aprintf(_tmp30C,_tag_fat(_tmpE2,sizeof(void*),1U));});}));goto _LL0;}case 6U: _LLD: _tmp131=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpD8)->f1).LongLong_c).val).f1;_tmp130=(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpD8)->f1).LongLong_c).val).f2;_LLE:
# 562
 ...
 Cyc_Absyndump_dump(({const char*_tmpE5="NULL";_tag_fat(_tmpE5,sizeof(char),5U);}));goto _LL0;case 8U: _LL13: _tmp133=((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmpD8)->f1).String_c).val;_LL14:
# 566
...
# 569
 Cyc_Absyndump_dump(({const char*_tmpE6="L\"";_tag_fat(_tmpE6,sizeof(char),3U);}));Cyc_Absyndump_dump_nospace(_tmp134);Cyc_Absyndump_dump_char((int)'"');goto _LL0;}case 1U: _LL17: _tmp135=(void*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL18:
# 571
...
Cyc_Absyndump_dump(({const char*_tmpEB="numelts(";_tag_fat(_tmpEB,sizeof(char),9U);}));
Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp137))->hd);
Cyc_Absyndump_dump(({const char*_tmpEC=")";_tag_fat(_tmpEC,sizeof(char),2U);}));}else{
# 585
...
({void*_tmpED=0U;({struct _fat_ptr _tmp30D=({const char*_tmpEE="Absyndump -- Bad number of arguments to primop";_tag_fat(_tmpEE,sizeof(char),47U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp30D,_tag_fat(_tmpED,sizeof(void*),0U));});});}_LL6F:;}
# 597
...
# 607
 Cyc_Absyndump_dump(({const char*_tmpF0="++";_tag_fat(_tmpF0,sizeof(char),3U);}));Cyc_Absyndump_dumpexp_prec(myprec,_tmp13C);goto _LL0;case Cyc_Absyn_PreDec: _LL21: _tmp13D=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL22:
 Cyc_Absyndump_dump(({const char*_tmpF1="--";_tag_fat(_tmpF1,sizeof(char),3U);}));Cyc_Absyndump_dumpexp_prec(myprec,_tmp13D);goto _LL0;case Cyc_Absyn_PostInc: _LL23: _tmp13E=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL24:
 Cyc_Absyndump_dumpexp_prec(myprec,_tmp13E);Cyc_Absyndump_dump(({const char*_tmpF2="++";_tag_fat(_tmpF2,sizeof(char),3U);}));goto _LL0;default: _LL25: _tmp13F=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL26:
 Cyc_Absyndump_dumpexp_prec(myprec,_tmp13F);Cyc_Absyndump_dump(({const char*_tmpF3="--";_tag_fat(_tmpF3,sizeof(char),3U);}));goto _LL0;}case 6U: _LL27: _tmp142=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_tmp141=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_tmp140=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpD8)->f3;_LL28:
# 613
...
# 620
 Cyc_Absyndump_dumploc(e->loc);
Cyc_Absyndump_dumpexp_prec(myprec,_tmp144);Cyc_Absyndump_dump(({const char*_tmpF4="&&";_tag_fat(_tmpF4,sizeof(char),3U);}));Cyc_Absyndump_dumpexp_prec(myprec,_tmp143);goto _LL0;case 8U: _LL2B: _tmp146=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_tmp145=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_LL2C:
# 624
 Cyc_Absyndump_dumploc(e->loc);
Cyc_Absyndump_dumpexp_prec(myprec,_tmp146);Cyc_Absyndump_dump(({const char*_tmpF5="||";_tag_fat(_tmpF5,sizeof(char),3U);}));Cyc_Absyndump_dumpexp_prec(myprec,_tmp145);goto _LL0;case 9U: _LL2D: _tmp148=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_tmp147=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_LL2E:
# 630
 Cyc_Absyndump_dumploc(e->loc);
# 633
...
Cyc_Absyndump_dump_nospace(({const char*_tmpF6="(";_tag_fat(_tmpF6,sizeof(char),2U);}));{
# 642
...
Cyc_Absyndump_dump_nospace(({const char*_tmpF7=")";_tag_fat(_tmpF7,sizeof(char),2U);}));
...
# 651
 Cyc_Absyndump_dumploc(e->loc);Cyc_Absyndump_dump(({const char*_tmpF8="throw";_tag_fat(_tmpF8,sizeof(char),6U);}));Cyc_Absyndump_dumpexp_prec(myprec,_tmp14B);goto _LL0;case 12U: _LL33: _tmp14C=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL34:
# 653
...
# 660
 ...
 Cyc_Absyndump_dump(({const char*_tmpF9="new";_tag_fat(_tmpF9,sizeof(char),4U);}));Cyc_Absyndump_dumpexp_prec(myprec,_tmp152);goto _LL0;case 17U: _LL3F: _tmp154=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL40:
 Cyc_Absyndump_dump(({const char*_tmpFA="sizeof(";_tag_fat(_tmpFA,sizeof(char),8U);}));Cyc_Absyndump_dumptyp(_tmp154);Cyc_Absyndump_dump_char((int)')');goto _LL0;case 18U: _LL41: _tmp155=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL42:
 Cyc_Absyndump_dump(({const char*_tmpFB="sizeof(";_tag_fat(_tmpFB,sizeof(char),8U);}));Cyc_Absyndump_dumpexp(_tmp155);Cyc_Absyndump_dump_char((int)')');goto _LL0;case 39U: _LL43: _tmp156=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL44:
 Cyc_Absyndump_dump(({const char*_tmpFC="valueof(";_tag_fat(_tmpFC,sizeof(char),9U);}));Cyc_Absyndump_dumptyp(_tmp156);Cyc_Absyndump_dump_char((int)')');goto _LL0;case 41U: _LL45: _tmp157=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL46:
# 668
 Cyc_Absyndump_dump(({const char*_tmpFD="__extension__(";_tag_fat(_tmpFD,sizeof(char),15U);}));Cyc_Absyndump_dumpexp(_tmp157);Cyc_Absyndump_dump_char((int)')');goto _LL0;case 40U: _LL47: _tmp159=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_tmp158=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_LL48:
# 671
 Cyc_Absyndump_dump(({const char*_tmpFE="__asm__";_tag_fat(_tmpFE,sizeof(char),8U);}));
if(_tmp159)Cyc_Absyndump_dump(({const char*_tmpFF="volatile";_tag_fat(_tmpFF,sizeof(char),9U);}));
...
# 677
 Cyc_Absyndump_dump(({const char*_tmp100="tagcheck(";_tag_fat(_tmp100,sizeof(char),10U);}));Cyc_Absyndump_dumpexp(_tmp15B);Cyc_Absyndump_dump_char((int)'.');Cyc_Absyndump_dump_nospace(*_tmp15A);
Cyc_Absyndump_dump_char((int)')');
...
# 682
 Cyc_Absyndump_dump(({const char*_tmp101="offsetof(";_tag_fat(_tmp101,sizeof(char),10U);}));Cyc_Absyndump_dumptyp(_tmp15D);({struct Cyc_List_List*_tmp310=_tmp15C;struct _fat_ptr _tmp30F=({const char*_tmp102=",";_tag_fat(_tmp102,sizeof(char),2U);});struct _fat_ptr _tmp30E=({const char*_tmp103=")";_tag_fat(_tmp103,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpoffset_field,_tmp310,_tmp30F,_tmp30E,({const char*_tmp104=".";_tag_fat(_tmp104,sizeof(char),2U);}));});goto _LL0;case 21U: _LL4D: _tmp15F=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_tmp15E=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_LL4E:
# 685
...
# 687
 Cyc_Absyndump_dumpexp_prec(myprec,_tmp161);Cyc_Absyndump_dump_nospace(({const char*_tmp105="->";_tag_fat(_tmp105,sizeof(char),3U);}));Cyc_Absyndump_dump_nospace(*_tmp160);goto _LL0;case 23U: _LL51: _tmp163=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_tmp162=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_LL52:
# 690
...
# 692
 Cyc_Absyndump_dump(({const char*_tmp106="$(";_tag_fat(_tmp106,sizeof(char),3U);}));Cyc_Absyndump_dumpexps_prec(20,_tmp164);Cyc_Absyndump_dump_char((int)')');goto _LL0;case 25U: _LL55: _tmp166=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_tmp165=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_LL56:
# 695
 Cyc_Absyndump_dump_char((int)'(');
Cyc_Absyndump_dumptyp((*_tmp166).f3);
Cyc_Absyndump_dump_char((int)')');
({struct Cyc_List_List*_tmp313=_tmp165;struct _fat_ptr _tmp312=({const char*_tmp107="{";_tag_fat(_tmp107,sizeof(char),2U);});struct _fat_ptr _tmp311=({const char*_tmp108="}";_tag_fat(_tmp108,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple21*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp313,_tmp312,_tmp311,({const char*_tmp109=",";_tag_fat(_tmp109,sizeof(char),2U);}));});
goto _LL0;case 26U: _LL57: _tmp167=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL58:
# 701
({struct Cyc_List_List*_tmp316=_tmp167;struct _fat_ptr _tmp315=({const char*_tmp10A="{";_tag_fat(_tmp10A,sizeof(char),2U);});struct _fat_ptr _tmp314=({const char*_tmp10B="}";_tag_fat(_tmp10B,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple21*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp316,_tmp315,_tmp314,({const char*_tmp10C=",";_tag_fat(_tmp10C,sizeof(char),2U);}));});goto _LL0;case 27U: _LL59: _tmp16A=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_tmp169=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_tmp168=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpD8)->f3;_LL5A:
# 704
 Cyc_Absyndump_dump(({const char*_tmp10D="{for";_tag_fat(_tmp10D,sizeof(char),5U);}));Cyc_Absyndump_dump_str((*_tmp16A->name).f2);Cyc_Absyndump_dump_char((int)'<');Cyc_Absyndump_dumpexp(_tmp169);
...
# 709
 Cyc_Absyndump_dump(({const char*_tmp10E="{for x ";_tag_fat(_tmp10E,sizeof(char),8U);}));Cyc_Absyndump_dump_char((int)'<');Cyc_Absyndump_dumpexp(_tmp16C);
...
({struct Cyc_List_List*_tmp319=_tmp16D;struct _fat_ptr _tmp318=({const char*_tmp10F="";_tag_fat(_tmp10F,sizeof(char),1U);});struct _fat_ptr _tmp317=({const char*_tmp110="}";_tag_fat(_tmp110,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple21*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp319,_tmp318,_tmp317,({const char*_tmp111=",";_tag_fat(_tmp111,sizeof(char),2U);}));});
goto _LL0;case 30U: _LL5F: _tmp170=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_LL60:
# 721
({struct Cyc_List_List*_tmp31C=_tmp170;struct _fat_ptr _tmp31B=({const char*_tmp112="{";_tag_fat(_tmp112,sizeof(char),2U);});struct _fat_ptr _tmp31A=({const char*_tmp113="}";_tag_fat(_tmp113,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple21*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp31C,_tmp31B,_tmp31A,({const char*_tmp114=",";_tag_fat(_tmp114,sizeof(char),2U);}));});goto _LL0;case 32U: _LL61: _tmp171=((struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_LL62:
...
if(_tmp174 != 0)({struct Cyc_List_List*_tmp31F=_tmp174;struct _fat_ptr _tmp31E=({const char*_tmp115="(";_tag_fat(_tmp115,sizeof(char),2U);});struct _fat_ptr _tmp31D=({const char*_tmp116=")";_tag_fat(_tmp116,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Exp*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpexp,_tmp31F,_tmp31E,_tmp31D,({const char*_tmp117=",";_tag_fat(_tmp117,sizeof(char),2U);}));});
...
if(_tmp179){
if(_tmp178 != 0){
Cyc_Absyndump_dump(({const char*_tmp118="rcalloc(";_tag_fat(_tmp118,sizeof(char),9U);}));Cyc_Absyndump_dumpexp(_tmp178);Cyc_Absyndump_dump(({const char*_tmp119=",";_tag_fat(_tmp119,sizeof(char),2U);}));}else{
# 736
Cyc_Absyndump_dump(({const char*_tmp11A="calloc(";_tag_fat(_tmp11A,sizeof(char),8U);}));}
# 738
Cyc_Absyndump_dumpexp(_tmp176);Cyc_Absyndump_dump(({const char*_tmp11B=",";_tag_fat(_tmp11B,sizeof(char),2U);}));Cyc_Absyndump_dumpexp(Cyc_Absyn_sizeoftype_exp(*((void**)_check_null(_tmp177)),0U));Cyc_Absyndump_dump(({const char*_tmp11C=")";_tag_fat(_tmp11C,sizeof(char),2U);}));}else{
# 740
if(_tmp178 != 0){
Cyc_Absyndump_dump(_tmp175?({const char*_tmp11D="rmalloc_inline(";_tag_fat(_tmp11D,sizeof(char),16U);}):({const char*_tmp11E="rmalloc(";_tag_fat(_tmp11E,sizeof(char),9U);}));
Cyc_Absyndump_dumpexp(_tmp178);Cyc_Absyndump_dump(({const char*_tmp11F=",";_tag_fat(_tmp11F,sizeof(char),2U);}));}else{
# 744
Cyc_Absyndump_dump(({const char*_tmp120="malloc(";_tag_fat(_tmp120,sizeof(char),8U);}));}
# 747
if(_tmp177 != 0)
...
Cyc_Absyndump_dump(({const char*_tmp121=")";_tag_fat(_tmp121,sizeof(char),2U);}));}
# 753
...
# 756
 Cyc_Absyndump_dumpexp_prec(myprec,_tmp17B);Cyc_Absyndump_dump_nospace(({const char*_tmp122=":=:";_tag_fat(_tmp122,sizeof(char),4U);}));Cyc_Absyndump_dumpexp_prec(myprec,_tmp17A);goto _LL0;case 36U: _LL6B: _tmp17D=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_tmp17C=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmpD8)->f2;_LL6C:
# 759
({struct Cyc_List_List*_tmp323=_tmp17C;struct _fat_ptr _tmp322=({const char*_tmp123="{";_tag_fat(_tmp123,sizeof(char),2U);});struct _fat_ptr _tmp321=({const char*_tmp124="}";_tag_fat(_tmp124,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple21*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp323,_tmp322,_tmp321,({const char*_tmp125=",";_tag_fat(_tmp125,sizeof(char),2U);}));});goto _LL0;default: _LL6D: _tmp17E=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmpD8)->f1;_LL6E:
# 762
 Cyc_Absyndump_dump_nospace(({const char*_tmp126="({";_tag_fat(_tmp126,sizeof(char),3U);}));Cyc_Absyndump_dumpstmt(_tmp17E,1);Cyc_Absyndump_dump_nospace(({const char*_tmp127="})";_tag_fat(_tmp127,sizeof(char),3U);}));goto _LL0;}_LL0:;}
# 764
if(inprec >= myprec)
Cyc_Absyndump_dump_char((int)')');}
# 768
...
goto _LL0;case 3U: if(((struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp185)->f1 == 0){_LL7: _LL8:
 Cyc_Absyndump_dump(({const char*_tmp186="return;";_tag_fat(_tmp186,sizeof(char),8U);}));goto _LL0;}else{_LL9: _tmp1A6=((struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp185)->f1;_LLA:
 Cyc_Absyndump_dump(({const char*_tmp187="return";_tag_fat(_tmp187,sizeof(char),7U);}));Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_check_null(_tmp1A6));Cyc_Absyndump_dump_semi();goto _LL0;}case 4U: _LLB: _tmp1A9=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp185)->f1;_tmp1A8=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp185)->f2;_tmp1A7=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp185)->f3;_LLC:
# 813
 Cyc_Absyndump_dump(({const char*_tmp188="if(";_tag_fat(_tmp188,sizeof(char),4U);}));Cyc_Absyndump_dumpexp(_tmp1A9);
...
# 819
 Cyc_Absyndump_dump_nospace(({const char*_tmp18B="){";_tag_fat(_tmp18B,sizeof(char),3U);}));Cyc_Absyndump_dumpstmt(_tmp1A8,0);Cyc_Absyndump_dump_char((int)'}');goto _LL25;default: _LL2E: _LL2F:
...
{void*_tmp18C=_tmp1A7->r;void*_tmp18D=_tmp18C;if(((struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*)_tmp18D)->tag == 0U){_LL31: _LL32:
 ...
 Cyc_Absyndump_dump(({const char*_tmp18E="else{";_tag_fat(_tmp18E,sizeof(char),6U);}));Cyc_Absyndump_dumpstmt(_tmp1A7,0);Cyc_Absyndump_dump_char((int)'}');goto _LL30;}_LL30:;}
# 826
...
# 829
 Cyc_Absyndump_dump(({const char*_tmp18F="while(";_tag_fat(_tmp18F,sizeof(char),7U);}));Cyc_Absyndump_dumpexp(_tmp1AB);Cyc_Absyndump_dump_nospace(({const char*_tmp190="){";_tag_fat(_tmp190,sizeof(char),3U);}));
...
# 833
 Cyc_Absyndump_dump(({const char*_tmp191="for(";_tag_fat(_tmp191,sizeof(char),5U);}));Cyc_Absyndump_dumpexp(_tmp1AF);Cyc_Absyndump_dump_semi();Cyc_Absyndump_dumpexp(_tmp1AE);Cyc_Absyndump_dump_semi();Cyc_Absyndump_dumpexp(_tmp1AD);
Cyc_Absyndump_dump_nospace(({const char*_tmp192="){";_tag_fat(_tmp192,sizeof(char),3U);}));Cyc_Absyndump_dumpstmt(_tmp1AC,0);Cyc_Absyndump_dump_char((int)'}');
...
# 837
 Cyc_Absyndump_dump(({const char*_tmp193="do{";_tag_fat(_tmp193,sizeof(char),4U);}));Cyc_Absyndump_dumpstmt(_tmp1B1,0);
Cyc_Absyndump_dump_nospace(({const char*_tmp194="}while(";_tag_fat(_tmp194,sizeof(char),8U);}));Cyc_Absyndump_dumpexp(_tmp1B0);Cyc_Absyndump_dump_nospace(({const char*_tmp195=");";_tag_fat(_tmp195,sizeof(char),3U);}));
goto _LL0;case 6U: _LL13: _LL14:
# 841
 Cyc_Absyndump_dump(({const char*_tmp196="break;";_tag_fat(_tmp196,sizeof(char),7U);}));goto _LL0;case 7U: _LL15: _LL16:
 Cyc_Absyndump_dump(({const char*_tmp197="continue;";_tag_fat(_tmp197,sizeof(char),10U);}));goto _LL0;case 8U: _LL17: _tmp1B2=((struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*)_tmp185)->f1;_LL18:
 Cyc_Absyndump_dump(({const char*_tmp198="goto";_tag_fat(_tmp198,sizeof(char),5U);}));Cyc_Absyndump_dump_str(_tmp1B2);Cyc_Absyndump_dump_semi();goto _LL0;case 10U: _LL19: _tmp1B4=((struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp185)->f1;_tmp1B3=((struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp185)->f2;_LL1A:
# 846
 Cyc_Absyndump_dump(({const char*_tmp199="switch(";_tag_fat(_tmp199,sizeof(char),8U);}));Cyc_Absyndump_dumpexp(_tmp1B4);Cyc_Absyndump_dump_nospace(({const char*_tmp19A="){";_tag_fat(_tmp19A,sizeof(char),3U);}));
...
# 851
 Cyc_Absyndump_dump(({const char*_tmp19B="try";_tag_fat(_tmp19B,sizeof(char),4U);}));Cyc_Absyndump_dumpstmt(_tmp1B6,0);
Cyc_Absyndump_dump(({const char*_tmp19C="catch{";_tag_fat(_tmp19C,sizeof(char),7U);}));
...
if(expstmt)Cyc_Absyndump_dump_nospace(({const char*_tmp19D=": ({";_tag_fat(_tmp19D,sizeof(char),5U);}));else{Cyc_Absyndump_dump_nospace(({const char*_tmp19E=": {";_tag_fat(_tmp19E,sizeof(char),4U);}));}
Cyc_Absyndump_dumpstmt(_tmp1B9,expstmt);
if(expstmt)Cyc_Absyndump_dump_nospace(({const char*_tmp19F="});}";_tag_fat(_tmp19F,sizeof(char),5U);}));else{Cyc_Absyndump_dump_char((int)'}');}}else{
# 868
...
# 872
 Cyc_Absyndump_dump(({const char*_tmp1A0="fallthru;";_tag_fat(_tmp1A0,sizeof(char),10U);}));goto _LL0;}else{_LL23: _tmp1BB=((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp185)->f1;_LL24:
# 874
 Cyc_Absyndump_dump(({const char*_tmp1A1="fallthru(";_tag_fat(_tmp1A1,sizeof(char),10U);}));Cyc_Absyndump_dumpexps_prec(20,_tmp1BB);Cyc_Absyndump_dump_nospace(({const char*_tmp1A2=");";_tag_fat(_tmp1A2,sizeof(char),3U);}));goto _LL0;}}_LL0:;};}struct _tuple22{struct Cyc_List_List*f1;struct Cyc_Absyn_Pat*f2;};
# 878
static void Cyc_Absyndump_dumpdp(struct _tuple22*dp){
({struct Cyc_List_List*_tmp326=(*dp).f1;struct _fat_ptr _tmp325=({const char*_tmp1BC="";_tag_fat(_tmp1BC,sizeof(char),1U);});struct _fat_ptr _tmp324=({const char*_tmp1BD="=";_tag_fat(_tmp1BD,sizeof(char),2U);});((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,_tmp326,_tmp325,_tmp324,({const char*_tmp1BE="=";_tag_fat(_tmp1BE,sizeof(char),2U);}));});
Cyc_Absyndump_dumppat((*dp).f2);}
# 882
static struct _fat_ptr Cyc_Absyndump_pat_term(int dots){return dots?({const char*_tmp1BF="...)";_tag_fat(_tmp1BF,sizeof(char),5U);}):({const char*_tmp1C0=")";_tag_fat(_tmp1C0,sizeof(char),2U);});}
# 884
static void Cyc_Absyndump_dumppat(struct Cyc_Absyn_Pat*p){
void*_tmp1C1=p->r;void*_tmp1C2=_tmp1C1;struct Cyc_Absyn_Exp*_tmp200;struct Cyc_Absyn_Datatypefield*_tmp1FF;struct Cyc_List_List*_tmp1FE;int _tmp1FD;struct Cyc_List_List*_tmp1FC;struct Cyc_List_List*_tmp1FB;int _tmp1FA;union Cyc_Absyn_AggrInfo _tmp1F9;struct Cyc_List_List*_tmp1F8;struct Cyc_List_List*_tmp1F7;int _tmp1F6;struct _tuple0*_tmp1F5;struct Cyc_List_List*_tmp1F4;int _tmp1F3;struct _tuple0*_tmp1F2;struct Cyc_Absyn_Tvar*_tmp1F1;struct Cyc_Absyn_Vardecl*_tmp1F0;struct Cyc_Absyn_Pat*_tmp1EF;struct Cyc_List_List*_tmp1EE;int _tmp1ED;struct Cyc_Absyn_Tvar*_tmp1EC;struct Cyc_Absyn_Vardecl*_tmp1EB;struct Cyc_Absyn_Vardecl*_tmp1EA;struct Cyc_Absyn_Pat*_tmp1E9;struct Cyc_Absyn_Vardecl*_tmp1E8;struct Cyc_Absyn_Vardecl*_tmp1E7;struct Cyc_Absyn_Pat*_tmp1E6;struct Cyc_Absyn_Vardecl*_tmp1E5;char _tmp1E4;struct Cyc_Absyn_Enumfield*_tmp1E3;struct Cyc_Absyn_Enumfield*_tmp1E2;struct _fat_ptr _tmp1E1;int _tmp1E0;int _tmp1DF;int _tmp1DE;switch(*((int*)_tmp1C2)){case 0U: _LL1: _LL2:
 Cyc_Absyndump_dump_char((int)'_');goto _LL0;case 9U: _LL3: _LL4:
 Cyc_Absyndump_dump(({const char*_tmp1C3="NULL";_tag_fat(_tmp1C3,sizeof(char),5U);}));goto _LL0;case 10U: switch(((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1C2)->f1){case Cyc_Absyn_None: _LL5: _tmp1DE=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1C2)->f2;_LL6:
 _tmp1DF=_tmp1DE;goto _LL8;case Cyc_Absyn_Signed: _LL7: _tmp1DF=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1C2)->f2;_LL8:
 Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp1C6=({struct Cyc_Int_pa_PrintArg_struct _tmp2DB;_tmp2DB.tag=1U,_tmp2DB.f1=(unsigned long)_tmp1DF;_tmp2DB;});void*_tmp1C4[1U];_tmp1C4[0]=& _tmp1C6;({struct _fat_ptr _tmp327=({const char*_tmp1C5="%d";_tag_fat(_tmp1C5,sizeof(char),3U);});Cyc_aprintf(_tmp327,_tag_fat(_tmp1C4,sizeof(void*),1U));});}));goto _LL0;default: _LL9: _tmp1E0=((struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp1C2)->f2;_LLA:
 Cyc_Absyndump_dump((struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp1C9=({struct Cyc_Int_pa_PrintArg_struct _tmp2DC;_tmp2DC.tag=1U,_tmp2DC.f1=(unsigned)_tmp1E0;_tmp2DC;});void*_tmp1C7[1U];_tmp1C7[0]=& _tmp1C9;({struct _fat_ptr _tmp328=({const char*_tmp1C8="%u";_tag_fat(_tmp1C8,sizeof(char),3U);});Cyc_aprintf(_tmp328,_tag_fat(_tmp1C7,sizeof(void*),1U));});}));goto _LL0;}case 12U: _LLB: _tmp1E1=((struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp1C2)->f1;_LLC:
...
# 895
 Cyc_Absyndump_dump(({const char*_tmp1CA="'";_tag_fat(_tmp1CA,sizeof(char),2U);}));Cyc_Absyndump_dump_nospace(Cyc_Absynpp_char_escape(_tmp1E4));Cyc_Absyndump_dump_nospace(({const char*_tmp1CB="'";_tag_fat(_tmp1CB,sizeof(char),2U);}));goto _LL0;case 3U: if(((struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*)((struct Cyc_Absyn_Pat*)((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1C2)->f2)->r)->tag == 0U){_LL13: _tmp1E5=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1C2)->f1;_LL14:
 Cyc_Absyndump_dump(({const char*_tmp1CC="*";_tag_fat(_tmp1CC,sizeof(char),2U);}));_tmp1E8=_tmp1E5;goto _LL16;}else{_LL17: _tmp1E7=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1C2)->f1;_tmp1E6=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1C2)->f2;_LL18:
# 898
 Cyc_Absyndump_dump(({const char*_tmp1CD="*";_tag_fat(_tmp1CD,sizeof(char),2U);}));_tmp1EA=_tmp1E7;_tmp1E9=_tmp1E6;goto _LL1A;}case 1U: if(((struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*)((struct Cyc_Absyn_Pat*)((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp1C2)->f2)->r)->tag == 0U){_LL15: _tmp1E8=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp1C2)->f1;_LL16:
# 897
...
# 901
 Cyc_Absyndump_dump(({const char*_tmp1CF="alias";_tag_fat(_tmp1CF,sizeof(char),6U);}));Cyc_Absyndump_dump(({const char*_tmp1D0="<";_tag_fat(_tmp1D0,sizeof(char),2U);}));Cyc_Absyndump_dumptvar(_tmp1EC);Cyc_Absyndump_dump(({const char*_tmp1D1=">";_tag_fat(_tmp1D1,sizeof(char),2U);}));
...
({struct Cyc_List_List*_tmp32B=_tmp1EE;struct _fat_ptr _tmp32A=({const char*_tmp1D2="$(";_tag_fat(_tmp1D2,sizeof(char),3U);});struct _fat_ptr _tmp329=Cyc_Absyndump_pat_term(_tmp1ED);((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp32B,_tmp32A,_tmp329,({const char*_tmp1D3=",";_tag_fat(_tmp1D3,sizeof(char),2U);}));});goto _LL0;case 6U: _LL1F: _tmp1EF=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp1C2)->f1;_LL20:
 Cyc_Absyndump_dump(({const char*_tmp1D4="&";_tag_fat(_tmp1D4,sizeof(char),2U);}));Cyc_Absyndump_dumppat(_tmp1EF);goto _LL0;case 4U: _LL21: _tmp1F1=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp1C2)->f1;_tmp1F0=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp1C2)->f2;_LL22:
# 907
...
# 910
 Cyc_Absyndump_dumpqvar(_tmp1F5);({struct Cyc_List_List*_tmp32E=_tmp1F4;struct _fat_ptr _tmp32D=({const char*_tmp1D5="(";_tag_fat(_tmp1D5,sizeof(char),2U);});struct _fat_ptr _tmp32C=Cyc_Absyndump_pat_term(_tmp1F3);((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp32E,_tmp32D,_tmp32C,({const char*_tmp1D6=",";_tag_fat(_tmp1D6,sizeof(char),2U);}));});goto _LL0;case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C2)->f1 != 0){_LL27: _tmp1F9=*((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C2)->f1;_tmp1F8=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C2)->f2;_tmp1F7=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C2)->f3;_tmp1F6=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1C2)->f4;_LL28:
# 912
...
# 915
 Cyc_Absyndump_dump_char((int)'{');
({struct Cyc_List_List*_tmp331=_tmp1FC;struct _fat_ptr _tmp330=({const char*_tmp1D7="<";_tag_fat(_tmp1D7,sizeof(char),2U);});struct _fat_ptr _tmp32F=({const char*_tmp1D8=">";_tag_fat(_tmp1D8,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp331,_tmp330,_tmp32F,({const char*_tmp1D9=",";_tag_fat(_tmp1D9,sizeof(char),2U);}));});
({struct Cyc_List_List*_tmp334=_tmp1FB;struct _fat_ptr _tmp333=({const char*_tmp1DA="";_tag_fat(_tmp1DA,sizeof(char),1U);});struct _fat_ptr _tmp332=Cyc_Absyndump_pat_term(_tmp1FA);((void(*)(void(*f)(struct _tuple22*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpdp,_tmp334,_tmp333,_tmp332,({const char*_tmp1DB=",";_tag_fat(_tmp1DB,sizeof(char),2U);}));});
...
if(_tmp1FE != 0)({struct Cyc_List_List*_tmp337=_tmp1FE;struct _fat_ptr _tmp336=({const char*_tmp1DC="(";_tag_fat(_tmp1DC,sizeof(char),2U);});struct _fat_ptr _tmp335=Cyc_Absyndump_pat_term(_tmp1FD);((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp337,_tmp336,_tmp335,({const char*_tmp1DD=",";_tag_fat(_tmp1DD,sizeof(char),2U);}));});
...
({struct Cyc_List_List*_tmp338=fields;((void(*)(void(*f)(struct Cyc_Absyn_Datatypefield*),struct Cyc_List_List*l,struct _fat_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpdatatypefield,_tmp338,({const char*_tmp201=",";_tag_fat(_tmp201,sizeof(char),2U);}));});}
# 935
static void Cyc_Absyndump_dumpenumfield(struct Cyc_Absyn_Enumfield*ef){
Cyc_Absyndump_dumpqvar(ef->name);
if(ef->tag != 0){
Cyc_Absyndump_dump(({const char*_tmp202="=";_tag_fat(_tmp202,sizeof(char),2U);}));Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_check_null(ef->tag));}}
# 941
static void Cyc_Absyndump_dumpenumfields(struct Cyc_List_List*fields){
({struct Cyc_List_List*_tmp339=fields;((void(*)(void(*f)(struct Cyc_Absyn_Enumfield*),struct Cyc_List_List*l,struct _fat_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpenumfield,_tmp339,({const char*_tmp203=",";_tag_fat(_tmp203,sizeof(char),2U);}));});}
# 945
static void Cyc_Absyndump_dumpaggrfields(struct Cyc_List_List*fields){
for(0;fields != 0;fields=fields->tl){
struct Cyc_Absyn_Aggrfield*_tmp204=(struct Cyc_Absyn_Aggrfield*)fields->hd;struct Cyc_Absyn_Aggrfield*_tmp205=_tmp204;struct _fat_ptr*_tmp20D;struct Cyc_Absyn_Tqual _tmp20C;void*_tmp20B;struct Cyc_Absyn_Exp*_tmp20A;struct Cyc_List_List*_tmp209;struct Cyc_Absyn_Exp*_tmp208;_LL1: _tmp20D=_tmp205->name;_tmp20C=_tmp205->tq;_tmp20B=_tmp205->type;_tmp20A=_tmp205->width;_tmp209=_tmp205->attributes;_tmp208=_tmp205->requires_clause;_LL2:;
{enum Cyc_Cyclone_C_Compilers _tmp206=Cyc_Cyclone_c_compiler;if(_tmp206 == Cyc_Cyclone_Gcc_c){_LL4: _LL5:
((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct _fat_ptr*),struct _fat_ptr*))Cyc_Absyndump_dumptqtd)(_tmp20C,_tmp20B,Cyc_Absyndump_dump_str,_tmp20D);Cyc_Absyndump_dumpatts(_tmp209);goto _LL3;}else{_LL6: _LL7:
 Cyc_Absyndump_dumpatts(_tmp209);((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct _fat_ptr*),struct _fat_ptr*))Cyc_Absyndump_dumptqtd)(_tmp20C,_tmp20B,Cyc_Absyndump_dump_str,_tmp20D);goto _LL3;}_LL3:;}
# 952
if((unsigned)_tmp208){
Cyc_Absyndump_dump(({const char*_tmp207="@requires ";_tag_fat(_tmp207,sizeof(char),11U);}));Cyc_Absyndump_dumpexp(_tmp208);}
# 955
if(_tmp20A != 0){
...
Cyc_Absyndump_dumpqvar(fd->name);}struct _tuple23{void*f1;struct _tuple0*f2;};
# 971
static void Cyc_Absyndump_dump_callconv_qvar(struct _tuple23*pr){
{void*_tmp20E=(*pr).f1;void*_tmp20F=_tmp20E;switch(*((int*)_tmp20F)){case 11U: _LL1: _LL2:
 goto _LL0;case 1U: _LL3: _LL4:
 Cyc_Absyndump_dump(({const char*_tmp210="_stdcall";_tag_fat(_tmp210,sizeof(char),9U);}));goto _LL0;case 2U: _LL5: _LL6:
 Cyc_Absyndump_dump(({const char*_tmp211="_cdecl";_tag_fat(_tmp211,sizeof(char),7U);}));goto _LL0;case 3U: _LL7: _LL8:
 Cyc_Absyndump_dump(({const char*_tmp212="_fastcall";_tag_fat(_tmp212,sizeof(char),10U);}));goto _LL0;default: _LL9: _LLA:
 goto _LL0;}_LL0:;}
# 979
...
struct _tuple23 _tmp225=({struct _tuple23 _tmp2DD;_tmp2DD.f1=call_conv,_tmp2DD.f2=_tmp22E;_tmp2DD;});
({int _tmp33A=is_cp;((void(*)(int is_char_ptr,struct Cyc_List_List*,void(*f)(struct _tuple23*),struct _tuple23*a))Cyc_Absyndump_dumptms)(_tmp33A,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp226),Cyc_Absyndump_dump_callconv_qvar,& _tmp225);});
...
Cyc_Absyndump_dump(({const char*_tmp230="@tagged ";_tag_fat(_tmp230,sizeof(char),9U);}));
Cyc_Absyndump_dumpaggr_kind(ad->kind);Cyc_Absyndump_dumpqvar(ad->name);Cyc_Absyndump_dumpkindedtvars(ad->tvs);
if(ad->impl != 0){
Cyc_Absyndump_dump_char((int)'{');
({struct Cyc_List_List*_tmp33D=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->exist_vars;struct _fat_ptr _tmp33C=({const char*_tmp231="<";_tag_fat(_tmp231,sizeof(char),2U);});struct _fat_ptr _tmp33B=({const char*_tmp232=">";_tag_fat(_tmp232,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,_tmp33D,_tmp33C,_tmp33B,({const char*_tmp233=",";_tag_fat(_tmp233,sizeof(char),2U);}));});
...
Cyc_Absyndump_dumpscope(_tmp238);Cyc_Absyndump_dump(({const char*_tmp235="enum ";_tag_fat(_tmp235,sizeof(char),6U);}));Cyc_Absyndump_dumpqvar(_tmp237);
if(_tmp236 != 0){
...
if(_tmp23C)
Cyc_Absyndump_dump(({const char*_tmp23A="@extensible ";_tag_fat(_tmp23A,sizeof(char),13U);}));
Cyc_Absyndump_dump(({const char*_tmp23B="datatype ";_tag_fat(_tmp23B,sizeof(char),10U);}));Cyc_Absyndump_dumpqvar(_tmp23F);Cyc_Absyndump_dumptvars(_tmp23E);
if(_tmp23D != 0){
Cyc_Absyndump_dump_char((int)'{');Cyc_Absyndump_dumpdatatypefields((struct Cyc_List_List*)_tmp23D->v);Cyc_Absyndump_dump_char((int)'}');}}struct _tuple24{unsigned f1;struct _tuple0*f2;int f3;};
# 1088
static void Cyc_Absyndump_dumpexport(struct _tuple24*tup){
...
enum Cyc_Cyclone_C_Compilers _tmp244=Cyc_Cyclone_c_compiler;if(_tmp244 == Cyc_Cyclone_Vc_c){_LL29: _LL2A:
 Cyc_Absyndump_dump(({const char*_tmp245="__inline";_tag_fat(_tmp245,sizeof(char),9U);}));goto _LL28;}else{_LL2B: _LL2C:
 Cyc_Absyndump_dump(({const char*_tmp246="inline";_tag_fat(_tmp246,sizeof(char),7U);}));goto _LL28;}_LL28:;}
# 1111
...
({void*_tmp249=0U;({struct _fat_ptr _tmp33F=({const char*_tmp24A="function has non-function type";_tag_fat(_tmp24A,sizeof(char),31U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp33F,_tag_fat(_tmp249,sizeof(void*),0U));});});}_LL2D:;}
# 1123
...
({struct Cyc_List_List*_tmp346=_tmp269;struct _fat_ptr _tmp345=({const char*_tmp24E=" let ";_tag_fat(_tmp24E,sizeof(char),6U);});struct _fat_ptr _tmp344=({const char*_tmp24F=";";_tag_fat(_tmp24F,sizeof(char),2U);});((void(*)(void(*f)(struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpid,_tmp346,_tmp345,_tmp344,({const char*_tmp250=",";_tag_fat(_tmp250,sizeof(char),2U);}));});goto _LL0;case 2U: _LLD: _tmp26B=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp242)->f1;_tmp26A=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp242)->f3;_LLE:
# 1137
 Cyc_Absyndump_dump(({const char*_tmp251="let";_tag_fat(_tmp251,sizeof(char),4U);}));Cyc_Absyndump_dumppat(_tmp26B);Cyc_Absyndump_dump_char((int)'=');Cyc_Absyndump_dumpexp(_tmp26A);Cyc_Absyndump_dump_semi();goto _LL0;case 4U: _LLF: _tmp26E=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp242)->f1;_tmp26D=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp242)->f2;_tmp26C=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp242)->f3;_LL10:
# 1139
 Cyc_Absyndump_dump(({const char*_tmp252="region";_tag_fat(_tmp252,sizeof(char),7U);}));Cyc_Absyndump_dump(({const char*_tmp253="<";_tag_fat(_tmp253,sizeof(char),2U);}));Cyc_Absyndump_dumptvar(_tmp26E);Cyc_Absyndump_dump(({const char*_tmp254="> ";_tag_fat(_tmp254,sizeof(char),3U);}));Cyc_Absyndump_dumpqvar(_tmp26D->name);
if((unsigned)_tmp26C){
Cyc_Absyndump_dump(({const char*_tmp255=" = open(";_tag_fat(_tmp255,sizeof(char),9U);}));Cyc_Absyndump_dumpexp(_tmp26C);Cyc_Absyndump_dump(({const char*_tmp256=")";_tag_fat(_tmp256,sizeof(char),2U);}));}
# 1143
Cyc_Absyndump_dump_semi();
goto _LL0;case 8U: _LL11: _tmp26F=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp242)->f1;_LL12:
# 1150
 Cyc_Absyndump_dump(({const char*_tmp257="typedef";_tag_fat(_tmp257,sizeof(char),8U);}));{
...
# 1158
 Cyc_Absyndump_dump(({const char*_tmp258="namespace";_tag_fat(_tmp258,sizeof(char),10U);}));Cyc_Absyndump_dump_str(_tmp271);Cyc_Absyndump_dump_braced_decls(_tmp270);goto _LL0;case 10U: _LL15: _tmp273=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp242)->f1;_tmp272=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp242)->f2;_LL16:
# 1160
 Cyc_Absyndump_dump(({const char*_tmp259="using";_tag_fat(_tmp259,sizeof(char),6U);}));Cyc_Absyndump_dumpqvar(_tmp273);Cyc_Absyndump_dump_braced_decls(_tmp272);goto _LL0;case 11U: _LL17: _tmp274=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp242)->f1;_LL18:
# 1162
 Cyc_Absyndump_dump(({const char*_tmp25A="extern \"C\" ";_tag_fat(_tmp25A,sizeof(char),12U);}));Cyc_Absyndump_dump_braced_decls(_tmp274);goto _LL0;case 12U: _LL19: _tmp277=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp242)->f1;_tmp276=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp242)->f2;_tmp275=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp242)->f3;_LL1A:
# 1164
 Cyc_Absyndump_dump(({const char*_tmp25B="extern \"C include\" ";_tag_fat(_tmp25B,sizeof(char),20U);}));Cyc_Absyndump_dump_braced_decls(_tmp277);
if(_tmp276 != 0){
Cyc_Absyndump_dump(({const char*_tmp25C=" cyclone_override ";_tag_fat(_tmp25C,sizeof(char),19U);}));
Cyc_Absyndump_dump_braced_decls(_tmp276);}
# 1169
({struct Cyc_List_List*_tmp349=_tmp275;struct _fat_ptr _tmp348=({const char*_tmp25D=" export {";_tag_fat(_tmp25D,sizeof(char),10U);});struct _fat_ptr _tmp347=({const char*_tmp25E="}";_tag_fat(_tmp25E,sizeof(char),2U);});((void(*)(void(*f)(struct _tuple24*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpexport,_tmp349,_tmp348,_tmp347,({const char*_tmp25F=",";_tag_fat(_tmp25F,sizeof(char),2U);}));});
goto _LL0;case 13U: _LL1B: _LL1C:
 Cyc_Absyndump_dump(({const char*_tmp260=" __cyclone_port_on__; ";_tag_fat(_tmp260,sizeof(char),23U);}));goto _LL0;case 14U: _LL1D: _LL1E:
 Cyc_Absyndump_dump(({const char*_tmp261=" __cyclone_port_off__; ";_tag_fat(_tmp261,sizeof(char),24U);}));goto _LL0;case 15U: _LL1F: _LL20:
 Cyc_Absyndump_dump(({const char*_tmp262=" __tempest_on__; ";_tag_fat(_tmp262,sizeof(char),18U);}));goto _LL0;default: _LL21: _LL22:
 Cyc_Absyndump_dump(({const char*_tmp263=" __tempest_off__; ";_tag_fat(_tmp263,sizeof(char),19U);}));goto _LL0;}_LL0:;};}
# 1178
...
# 1202
if((!Cyc_Absyndump_qvar_to_Cids && !is_char_ptr)&& Cyc_Absyn_type2bool(0,_tmp2A6))Cyc_Absyndump_dump(({const char*_tmp27D="@zeroterm";_tag_fat(_tmp27D,sizeof(char),10U);}));
if((!Cyc_Absyndump_qvar_to_Cids && is_char_ptr)&& !Cyc_Absyn_type2bool(0,_tmp2A6))Cyc_Absyndump_dump(({const char*_tmp27E="@nozeroterm";_tag_fat(_tmp27E,sizeof(char),12U);}));
{void*_tmp27F=Cyc_Tcutil_compress(_tmp2A9);void*_tmp280=_tmp27F;struct Cyc_Absyn_Tvar*_tmp288;switch(*((int*)_tmp280)){case 0U: switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp280)->f1)){case 5U: _LLD: _LLE:
 if(!Cyc_Absyndump_qvar_to_Cids)Cyc_Absyndump_dump(({const char*_tmp281="`H";_tag_fat(_tmp281,sizeof(char),3U);}));goto _LLC;case 6U: _LLF: _LL10:
 Cyc_Absyndump_dump(({const char*_tmp282="`U";_tag_fat(_tmp282,sizeof(char),3U);}));goto _LLC;case 7U: _LL11: _LL12:
 Cyc_Absyndump_dump(({const char*_tmp283="`RC";_tag_fat(_tmp283,sizeof(char),4U);}));goto _LLC;default: goto _LL19;}case 2U: _LL13: _tmp288=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp280)->f1;_LL14:
 ...
 Cyc_Absyndump_dump(({const char*_tmp284="@region(";_tag_fat(_tmp284,sizeof(char),9U);}));Cyc_Absyndump_dumptyp(_tmp2A9);Cyc_Absyndump_dump(({const char*_tmp285=")";_tag_fat(_tmp285,sizeof(char),2U);}));goto _LLC;default: _LL19: _LL1A:
({void*_tmp286=0U;({struct _fat_ptr _tmp34A=({const char*_tmp287="dumptms: bad rgn type in Pointer_mod";_tag_fat(_tmp287,sizeof(char),37U);});Cyc_Warn_impos(_tmp34A,_tag_fat(_tmp286,sizeof(void*),0U));});});}_LLC:;}
# 1213
...
# 1231
 Cyc_Absyndump_dump(({const char*_tmp28D="[]";_tag_fat(_tmp28D,sizeof(char),3U);}));
if(Cyc_Absyn_type2bool(0,_tmp295))Cyc_Absyndump_dump(({const char*_tmp28E="@zeroterm";_tag_fat(_tmp28E,sizeof(char),10U);}));
...
if(Cyc_Absyn_type2bool(0,_tmp296))Cyc_Absyndump_dump(({const char*_tmp28F="@zeroterm";_tag_fat(_tmp28F,sizeof(char),10U);}));
...
# 1241
({struct Cyc_List_List*_tmp34D=_tmp2A0;struct _fat_ptr _tmp34C=({const char*_tmp290="(";_tag_fat(_tmp290,sizeof(char),2U);});struct _fat_ptr _tmp34B=({const char*_tmp291=")";_tag_fat(_tmp291,sizeof(char),2U);});((void(*)(void(*f)(struct _fat_ptr*),struct Cyc_List_List*l,struct _fat_ptr start,struct _fat_ptr end,struct _fat_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dump_str,_tmp34D,_tmp34C,_tmp34B,({const char*_tmp292=",";_tag_fat(_tmp292,sizeof(char),2U);}));});goto _LL20;}case 4U: _LL29: _tmp2A3=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp28C)->f1;_tmp2A2=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp28C)->f2;_tmp2A1=((struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp28C)->f3;_LL2A:
# 1243
...
({void*_tmp293=0U;({struct _fat_ptr _tmp34E=({const char*_tmp294="dumptms";_tag_fat(_tmp294,sizeof(char),8U);});Cyc_Warn_impos(_tmp34E,_tag_fat(_tmp293,sizeof(void*),0U));});});}_LL20:;}
# 1247
return;}}_LL0:;};}
# 1251
...
for(0;tdl != 0;tdl=tdl->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)tdl->hd);}
({void*_tmp2B1=0U;({struct Cyc___cycFILE*_tmp353=f;struct _fat_ptr _tmp352=({const char*_tmp2B2="\n";_tag_fat(_tmp2B2,sizeof(char),2U);});Cyc_fprintf(_tmp353,_tmp352,_tag_fat(_tmp2B1,sizeof(void*),0U));});});}
# 1268
static void Cyc_Absyndump_dump_decl_interface(struct Cyc_Absyn_Decl*d){
void*_tmp2B3=d->r;void*_tmp2B4=_tmp2B3;struct Cyc_List_List*_tmp2D0;struct Cyc_List_List*_tmp2CF;struct Cyc_List_List*_tmp2CE;struct Cyc_List_List*_tmp2CD;struct Cyc_List_List*_tmp2CC;struct _fat_ptr*_tmp2CB;struct Cyc_List_List*_tmp2CA;struct Cyc_Absyn_Typedefdecl*_tmp2C9;struct Cyc_Absyn_Enumdecl*_tmp2C8;struct Cyc_Absyn_Datatypedecl*_tmp2C7;struct Cyc_Absyn_Aggrdecl*_tmp2C6;struct Cyc_Absyn_Fndecl*_tmp2C5;struct Cyc_Absyn_Vardecl*_tmp2C4;switch(*((int*)_tmp2B4)){case 0U: _LL1: _tmp2C4=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp2B4)->f1;_LL2:
# 1271
...
Cyc_Absyndump_dump(({const char*_tmp2B5="extern ";_tag_fat(_tmp2B5,sizeof(char),8U);}));
Cyc_Absyndump_dumpvardecl(_tmp2C4,d->loc,1);
Cyc_Absyndump_dump(({const char*_tmp2B6="\n";_tag_fat(_tmp2B6,sizeof(char),2U);}));
...
({void*_tmp2C2=0U;({struct _fat_ptr _tmp356=({const char*_tmp2C3="bad top-level declaration";_tag_fat(_tmp2C3,sizeof(char),26U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp356,_tag_fat(_tmp2C2,sizeof(void*),0U));});});}_LL0:;}
# 1344
