...
tag;};struct _dyneither_ptr Cyc_Position_get_line_directive(unsigned int loc);
...
void*t);void Cyc_Tcutil_check_no_qual(unsigned int loc,void*t);enum Cyc_Cyclone_C_Compilers{
...
_LL40:{const char*_tmp3E2;Cyc_Absyndump_dump(((_tmp3E2="::?",_tag_dyneither(
_tmp3E2,sizeof(char),4))));}goto _LL3A;_LL41: {struct Cyc_Absyn_Eq_kb_struct*
_tmp32=(struct Cyc_Absyn_Eq_kb_struct*)_tmp2A;if(_tmp32->tag != 0)goto _LL3A;else{
_tmp33=_tmp32->f1;}}_LL42:{const char*_tmp3E3;Cyc_Absyndump_dump(((_tmp3E3="::",
_tag_dyneither(_tmp3E3,sizeof(char),3))));}Cyc_Absyndump_dumpkind(_tmp33);goto
_LL3A;_LL3A:;};}void Cyc_Absyndump_dumptvars(struct Cyc_List_List*tvs){const char*
_tmp3E6;const char*_tmp3E5;const char*_tmp3E4;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),
struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct
_dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,tvs,((_tmp3E4="<",
_tag_dyneither(_tmp3E4,sizeof(char),2))),((_tmp3E5=">",_tag_dyneither(_tmp3E5,
sizeof(char),2))),((_tmp3E6=",",_tag_dyneither(_tmp3E6,sizeof(char),2))));}void
Cyc_Absyndump_dumpkindedtvars(struct Cyc_List_List*tvs){const char*_tmp3E9;const
char*_tmp3E8;const char*_tmp3E7;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct
...
_tmp3E7="<",_tag_dyneither(_tmp3E7,sizeof(char),2))),((_tmp3E8=">",
...
_LL45:{const char*_tmp3ED;Cyc_Absyndump_dump(((_tmp3ED="_stdcall",_tag_dyneither(
_tmp3ED,sizeof(char),9))));}return;_LL46: {struct Cyc_Absyn_Cdecl_att_struct*
_tmp41=(struct Cyc_Absyn_Cdecl_att_struct*)_tmp3F;if(_tmp41->tag != 2)goto _LL48;}
_LL47:{const char*_tmp3EE;Cyc_Absyndump_dump(((_tmp3EE="_cdecl",_tag_dyneither(
_tmp3EE,sizeof(char),7))));}return;_LL48: {struct Cyc_Absyn_Fastcall_att_struct*
_tmp42=(struct Cyc_Absyn_Fastcall_att_struct*)_tmp3F;if(_tmp42->tag != 3)goto _LL4A;}
_LL49:{const char*_tmp3EF;Cyc_Absyndump_dump(((_tmp3EF="_fastcall",_tag_dyneither(
_tmp3EF,sizeof(char),10))));}return;_LL4A:;_LL4B: goto _LL43;_LL43:;}}void Cyc_Absyndump_dump_noncallconv(
...
_LL4C;_LL4C:;}}if(!hasatt)return;{const char*_tmp3F0;Cyc_Absyndump_dump(((_tmp3F0="__declspec(",
...
_LL68:{const char*_tmp3F4;Cyc_Absyndump_dump(((_tmp3F4="`H",_tag_dyneither(
_tmp3F4,sizeof(char),3))));}goto _LL66;_LL69:;_LL6A: Cyc_Absyndump_dumpntyp(t);
...
else{_tmp59=(void*)_tmp58->f1;}}_LL6D:{struct Cyc_List_List*_tmp3F5;rgions=((
_tmp3F5=_cycalloc(sizeof(*_tmp3F5)),((_tmp3F5->hd=_tmp59,((_tmp3F5->tl=rgions,
_tmp3F5))))));}goto _LL6B;_LL6E: {struct Cyc_Absyn_JoinEff_struct*_tmp5A=(struct
...
_tmpD4;void*_tmpD5;struct Cyc_Absyn_Datatypedecl*_tmpD7;_LL73: {struct Cyc_Absyn_ArrayType_struct*
...
_tmp65;if(_tmp69->tag != 0)goto _LL7B;}_LL7A:{const char*_tmp3F8;Cyc_Absyndump_dump(((
_tmp3F8="void",_tag_dyneither(_tmp3F8,sizeof(char),5))));}return;_LL7B: {struct
...
_tmp3FE;void*_tmp3FD[1];struct Cyc_Int_pa_struct _tmp3FC;Cyc_Absyndump_dump((
...
_tmp70->tag != 1)goto _LL81;else{_tmp71=_tmp70->f1;_tmp72=(void*)_tmp70->f2;_tmp73=
_tmp70->f3;}}_LL80: Cyc_Absyndump_dumpntyp((void*)_check_null(_tmp72));return;
_LL81: {struct Cyc_Absyn_DatatypeType_struct*_tmp74=(struct Cyc_Absyn_DatatypeType_struct*)
...
_LLCB;_LLCB:;}goto _LL72;_LL83: {struct Cyc_Absyn_DatatypeFieldType_struct*_tmp78=(
struct Cyc_Absyn_DatatypeFieldType_struct*)_tmp65;if(_tmp78->tag != 4)goto _LL85;
else{_tmp79=_tmp78->f1;_tmp7A=_tmp79.field_info;_tmp7B=_tmp79.targs;}}_LL84:{
union Cyc_Absyn_DatatypeFieldInfoU _tmpED=_tmp7A;struct Cyc_Absyn_UnknownDatatypeFieldInfo
...
goto _LLD0;_LLD0:;}goto _LL72;_LL85: {struct Cyc_Absyn_IntType_struct*_tmp7C=(
struct Cyc_Absyn_IntType_struct*)_tmp65;if(_tmp7C->tag != 6)goto _LL87;else{_tmp7D=
_tmp7C->f1;if(_tmp7D != Cyc_Absyn_None)goto _LL87;_tmp7E=_tmp7C->f2;if(_tmp7E != 
Cyc_Absyn_Int_sz)goto _LL87;}}_LL86: goto _LL88;_LL87: {struct Cyc_Absyn_IntType_struct*
_tmp7F=(struct Cyc_Absyn_IntType_struct*)_tmp65;if(_tmp7F->tag != 6)goto _LL89;
else{_tmp80=_tmp7F->f1;if(_tmp80 != Cyc_Absyn_Signed)goto _LL89;_tmp81=_tmp7F->f2;
if(_tmp81 != Cyc_Absyn_Int_sz)goto _LL89;}}_LL88:{const char*_tmp404;Cyc_Absyndump_dump(((
_tmp404="int",_tag_dyneither(_tmp404,sizeof(char),4))));}return;_LL89: {struct
Cyc_Absyn_IntType_struct*_tmp82=(struct Cyc_Absyn_IntType_struct*)_tmp65;if(
_tmp82->tag != 6)goto _LL8B;else{_tmp83=_tmp82->f1;if(_tmp83 != Cyc_Absyn_None)goto
_LL8B;_tmp84=_tmp82->f2;if(_tmp84 != Cyc_Absyn_Long_sz)goto _LL8B;}}_LL8A: goto
_LL8C;_LL8B: {struct Cyc_Absyn_IntType_struct*_tmp85=(struct Cyc_Absyn_IntType_struct*)
...
sizeof(char),5))));}return;_LL8D: {struct Cyc_Absyn_IntType_struct*_tmp88=(struct
Cyc_Absyn_IntType_struct*)_tmp65;if(_tmp88->tag != 6)goto _LL8F;else{_tmp89=_tmp88->f1;
if(_tmp89 != Cyc_Absyn_None)goto _LL8F;_tmp8A=_tmp88->f2;if(_tmp8A != Cyc_Absyn_Char_sz)
goto _LL8F;}}_LL8E:{const char*_tmp406;Cyc_Absyndump_dump(((_tmp406="char",
_tag_dyneither(_tmp406,sizeof(char),5))));}return;_LL8F: {struct Cyc_Absyn_IntType_struct*
_tmp8B=(struct Cyc_Absyn_IntType_struct*)_tmp65;if(_tmp8B->tag != 6)goto _LL91;
else{_tmp8C=_tmp8B->f1;if(_tmp8C != Cyc_Absyn_Signed)goto _LL91;_tmp8D=_tmp8B->f2;
if(_tmp8D != Cyc_Absyn_Char_sz)goto _LL91;}}_LL90:{const char*_tmp407;Cyc_Absyndump_dump(((
_tmp407="signed char",_tag_dyneither(_tmp407,sizeof(char),12))));}return;_LL91: {
struct Cyc_Absyn_IntType_struct*_tmp8E=(struct Cyc_Absyn_IntType_struct*)_tmp65;
if(_tmp8E->tag != 6)goto _LL93;else{_tmp8F=_tmp8E->f1;if(_tmp8F != Cyc_Absyn_Unsigned)
goto _LL93;_tmp90=_tmp8E->f2;if(_tmp90 != Cyc_Absyn_Char_sz)goto _LL93;}}_LL92:{
const char*_tmp408;Cyc_Absyndump_dump(((_tmp408="unsigned char",_tag_dyneither(
_tmp408,sizeof(char),14))));}return;_LL93: {struct Cyc_Absyn_IntType_struct*
_tmp91=(struct Cyc_Absyn_IntType_struct*)_tmp65;if(_tmp91->tag != 6)goto _LL95;
else{_tmp92=_tmp91->f1;if(_tmp92 != Cyc_Absyn_None)goto _LL95;_tmp93=_tmp91->f2;
if(_tmp93 != Cyc_Absyn_Short_sz)goto _LL95;}}_LL94: goto _LL96;_LL95: {struct Cyc_Absyn_IntType_struct*
_tmp94=(struct Cyc_Absyn_IntType_struct*)_tmp65;if(_tmp94->tag != 6)goto _LL97;
else{_tmp95=_tmp94->f1;if(_tmp95 != Cyc_Absyn_Signed)goto _LL97;_tmp96=_tmp94->f2;
if(_tmp96 != Cyc_Absyn_Short_sz)goto _LL97;}}_LL96:{const char*_tmp409;Cyc_Absyndump_dump(((
_tmp409="short",_tag_dyneither(_tmp409,sizeof(char),6))));}return;_LL97: {struct
Cyc_Absyn_IntType_struct*_tmp97=(struct Cyc_Absyn_IntType_struct*)_tmp65;if(
_tmp97->tag != 6)goto _LL99;else{_tmp98=_tmp97->f1;if(_tmp98 != Cyc_Absyn_Unsigned)
...
_tmp40A,sizeof(char),15))));}return;_LL99: {struct Cyc_Absyn_IntType_struct*
_tmp9A=(struct Cyc_Absyn_IntType_struct*)_tmp65;if(_tmp9A->tag != 6)goto _LL9B;
else{_tmp9B=_tmp9A->f1;if(_tmp9B != Cyc_Absyn_Unsigned)goto _LL9B;_tmp9C=_tmp9A->f2;
if(_tmp9C != Cyc_Absyn_Int_sz)goto _LL9B;}}_LL9A:{const char*_tmp40B;Cyc_Absyndump_dump(((
_tmp40B="unsigned int",_tag_dyneither(_tmp40B,sizeof(char),13))));}return;_LL9B: {
struct Cyc_Absyn_IntType_struct*_tmp9D=(struct Cyc_Absyn_IntType_struct*)_tmp65;
if(_tmp9D->tag != 6)goto _LL9D;else{_tmp9E=_tmp9D->f1;if(_tmp9E != Cyc_Absyn_Unsigned)
...
_tmp40C,sizeof(char),14))));}return;_LL9D: {struct Cyc_Absyn_IntType_struct*
_tmpA0=(struct Cyc_Absyn_IntType_struct*)_tmp65;if(_tmpA0->tag != 6)goto _LL9F;
else{_tmpA1=_tmpA0->f1;if(_tmpA1 != Cyc_Absyn_None)goto _LL9F;_tmpA2=_tmpA0->f2;
if(_tmpA2 != Cyc_Absyn_LongLong_sz)goto _LL9F;}}_LL9E: goto _LLA0;_LL9F: {struct Cyc_Absyn_IntType_struct*
_tmpA3=(struct Cyc_Absyn_IntType_struct*)_tmp65;if(_tmpA3->tag != 6)goto _LLA1;
else{_tmpA4=_tmpA3->f1;if(_tmpA4 != Cyc_Absyn_Signed)goto _LLA1;_tmpA5=_tmpA3->f2;
if(_tmpA5 != Cyc_Absyn_LongLong_sz)goto _LLA1;}}_LLA0: switch(Cyc_Cyclone_c_compiler){
case Cyc_Cyclone_Gcc_c: _LLD5:{const char*_tmp40D;Cyc_Absyndump_dump(((_tmp40D="long long",
_tag_dyneither(_tmp40D,sizeof(char),10))));}return;case Cyc_Cyclone_Vc_c: _LLD6:{
const char*_tmp40E;Cyc_Absyndump_dump(((_tmp40E="__int64",_tag_dyneither(_tmp40E,
sizeof(char),8))));}return;}_LLA1: {struct Cyc_Absyn_IntType_struct*_tmpA6=(
struct Cyc_Absyn_IntType_struct*)_tmp65;if(_tmpA6->tag != 6)goto _LLA3;else{_tmpA7=
_tmpA6->f1;if(_tmpA7 != Cyc_Absyn_Unsigned)goto _LLA3;_tmpA8=_tmpA6->f2;if(_tmpA8
!= Cyc_Absyn_LongLong_sz)goto _LLA3;}}_LLA2: switch(Cyc_Cyclone_c_compiler){case
Cyc_Cyclone_Vc_c: _LLD8:{const char*_tmp40F;Cyc_Absyndump_dump(((_tmp40F="unsigned __int64",
_tag_dyneither(_tmp40F,sizeof(char),17))));}return;case Cyc_Cyclone_Gcc_c: _LLD9:{
const char*_tmp410;Cyc_Absyndump_dump(((_tmp410="unsigned long long",
_tag_dyneither(_tmp410,sizeof(char),19))));}return;}_LLA3: {struct Cyc_Absyn_FloatType_struct*
_tmpA9=(struct Cyc_Absyn_FloatType_struct*)_tmp65;if(_tmpA9->tag != 7)goto _LLA5;
else{_tmpAA=_tmpA9->f1;}}_LLA4: if(_tmpAA == 0){const char*_tmp411;Cyc_Absyndump_dump(((
...
_tag_dyneither(_tmp413,sizeof(char),12))));}}return;_LLA5: {struct Cyc_Absyn_TupleType_struct*
_tmpAB=(struct Cyc_Absyn_TupleType_struct*)_tmp65;if(_tmpAB->tag != 10)goto _LLA7;
else{_tmpAC=_tmpAB->f1;}}_LLA6: Cyc_Absyndump_dump_char((int)'$');Cyc_Absyndump_dumpargs(
_tmpAC);return;_LLA7: {struct Cyc_Absyn_AggrType_struct*_tmpAD=(struct Cyc_Absyn_AggrType_struct*)
_tmp65;if(_tmpAD->tag != 11)goto _LLA9;else{_tmpAE=_tmpAD->f1;_tmpAF=_tmpAE.aggr_info;
_tmpB0=_tmpAE.targs;}}_LLA8: {enum Cyc_Absyn_AggrKind _tmp10E;struct _tuple0*
_tmp10F;struct _tuple10 _tmp10D=Cyc_Absyn_aggr_kinded_name(_tmpAF);_tmp10E=_tmp10D.f1;
_tmp10F=_tmp10D.f2;Cyc_Absyndump_dumpaggr_kind(_tmp10E);Cyc_Absyndump_dumpqvar(
_tmp10F);Cyc_Absyndump_dumptps(_tmpB0);return;}_LLA9: {struct Cyc_Absyn_AnonAggrType_struct*
_tmpB1=(struct Cyc_Absyn_AnonAggrType_struct*)_tmp65;if(_tmpB1->tag != 12)goto
_LLAB;else{_tmpB2=_tmpB1->f1;_tmpB3=_tmpB1->f2;}}_LLAA: Cyc_Absyndump_dumpaggr_kind(
_tmpB2);Cyc_Absyndump_dump_char((int)'{');Cyc_Absyndump_dumpaggrfields(_tmpB3);
Cyc_Absyndump_dump_char((int)'}');return;_LLAB: {struct Cyc_Absyn_EnumType_struct*
_tmpB4=(struct Cyc_Absyn_EnumType_struct*)_tmp65;if(_tmpB4->tag != 13)goto _LLAD;
else{_tmpB5=_tmpB4->f1;}}_LLAC:{const char*_tmp414;Cyc_Absyndump_dump(((_tmp414="enum ",
_tag_dyneither(_tmp414,sizeof(char),6))));}Cyc_Absyndump_dumpqvar(_tmpB5);
return;_LLAD: {struct Cyc_Absyn_AnonEnumType_struct*_tmpB6=(struct Cyc_Absyn_AnonEnumType_struct*)
_tmp65;if(_tmpB6->tag != 14)goto _LLAF;else{_tmpB7=_tmpB6->f1;}}_LLAE:{const char*
_tmp415;Cyc_Absyndump_dump(((_tmp415="enum {",_tag_dyneither(_tmp415,sizeof(char),
7))));}Cyc_Absyndump_dumpenumfields(_tmpB7);{const char*_tmp416;Cyc_Absyndump_dump(((
_tmp416="}",_tag_dyneither(_tmp416,sizeof(char),2))));}return;_LLAF: {struct Cyc_Absyn_TypedefType_struct*
_tmpB8=(struct Cyc_Absyn_TypedefType_struct*)_tmp65;if(_tmpB8->tag != 17)goto _LLB1;
else{_tmpB9=_tmpB8->f1;_tmpBA=_tmpB8->f2;}}_LLB0:(Cyc_Absyndump_dumpqvar(_tmpB9),
Cyc_Absyndump_dumptps(_tmpBA));return;_LLB1: {struct Cyc_Absyn_ValueofType_struct*
_tmpBB=(struct Cyc_Absyn_ValueofType_struct*)_tmp65;if(_tmpBB->tag != 18)goto _LLB3;
else{_tmpBC=_tmpBB->f1;}}_LLB2:{const char*_tmp417;Cyc_Absyndump_dump(((_tmp417="valueof_t(",
_tag_dyneither(_tmp417,sizeof(char),11))));}Cyc_Absyndump_dumpexp(_tmpBC);{const
char*_tmp418;Cyc_Absyndump_dump(((_tmp418=")",_tag_dyneither(_tmp418,sizeof(char),
2))));}return;_LLB3: {struct Cyc_Absyn_RgnHandleType_struct*_tmpBD=(struct Cyc_Absyn_RgnHandleType_struct*)
_tmp65;if(_tmpBD->tag != 15)goto _LLB5;else{_tmpBE=(void*)_tmpBD->f1;}}_LLB4:{
const char*_tmp419;Cyc_Absyndump_dump(((_tmp419="region_t<",_tag_dyneither(
_tmp419,sizeof(char),10))));}Cyc_Absyndump_dumprgn(_tmpBE);{const char*_tmp41A;
Cyc_Absyndump_dump(((_tmp41A=">",_tag_dyneither(_tmp41A,sizeof(char),2))));}
return;_LLB5: {struct Cyc_Absyn_DynRgnType_struct*_tmpBF=(struct Cyc_Absyn_DynRgnType_struct*)
_tmp65;if(_tmpBF->tag != 16)goto _LLB7;else{_tmpC0=(void*)_tmpBF->f1;_tmpC1=(void*)
_tmpBF->f2;}}_LLB6:{const char*_tmp41B;Cyc_Absyndump_dump(((_tmp41B="dynregion_t<",
_tag_dyneither(_tmp41B,sizeof(char),13))));}Cyc_Absyndump_dumprgn(_tmpC0);{const
char*_tmp41C;Cyc_Absyndump_dump(((_tmp41C=",",_tag_dyneither(_tmp41C,sizeof(char),
2))));}Cyc_Absyndump_dumprgn(_tmpC1);{const char*_tmp41D;Cyc_Absyndump_dump(((
_tmp41D=">",_tag_dyneither(_tmp41D,sizeof(char),2))));}return;_LLB7: {struct Cyc_Absyn_TagType_struct*
_tmpC2=(struct Cyc_Absyn_TagType_struct*)_tmp65;if(_tmpC2->tag != 19)goto _LLB9;
else{_tmpC3=(void*)_tmpC2->f1;}}_LLB8:{const char*_tmp41E;Cyc_Absyndump_dump(((
...
_tmp41F,sizeof(char),2))));}return;_LLB9: {struct Cyc_Absyn_UniqueRgn_struct*
_tmpC4=(struct Cyc_Absyn_UniqueRgn_struct*)_tmp65;if(_tmpC4->tag != 21)goto _LLBB;}
_LLBA:{const char*_tmp420;Cyc_Absyndump_dump(((_tmp420="`U",_tag_dyneither(
_tmp420,sizeof(char),3))));}goto _LL72;_LLBB: {struct Cyc_Absyn_RefCntRgn_struct*
_tmpC5=(struct Cyc_Absyn_RefCntRgn_struct*)_tmp65;if(_tmpC5->tag != 22)goto _LLBD;}
_LLBC:{const char*_tmp421;Cyc_Absyndump_dump(((_tmp421="`RC",_tag_dyneither(
_tmp421,sizeof(char),4))));}goto _LL72;_LLBD: {struct Cyc_Absyn_TypeDeclType_struct*
_tmpC6=(struct Cyc_Absyn_TypeDeclType_struct*)_tmp65;if(_tmpC6->tag != 26)goto
_LLBF;else{_tmpC7=_tmpC6->f1;_tmpC8=*_tmpC7;_tmpC9=_tmpC8.r;{struct Cyc_Absyn_Aggr_td_struct*
_tmpCA=(struct Cyc_Absyn_Aggr_td_struct*)_tmpC9;if(_tmpCA->tag != 0)goto _LLBF;
else{_tmpCB=_tmpCA->f1;}};}}_LLBE: Cyc_Absyndump_dump_aggrdecl(_tmpCB);return;
_LLBF: {struct Cyc_Absyn_TypeDeclType_struct*_tmpCC=(struct Cyc_Absyn_TypeDeclType_struct*)
_tmp65;if(_tmpCC->tag != 26)goto _LLC1;else{_tmpCD=_tmpCC->f1;_tmpCE=*_tmpCD;
_tmpCF=_tmpCE.r;{struct Cyc_Absyn_Enum_td_struct*_tmpD0=(struct Cyc_Absyn_Enum_td_struct*)
_tmpCF;if(_tmpD0->tag != 1)goto _LLC1;else{_tmpD1=_tmpD0->f1;}};}}_LLC0: Cyc_Absyndump_dump_enumdecl(
_tmpD1);return;_LLC1: {struct Cyc_Absyn_TypeDeclType_struct*_tmpD2=(struct Cyc_Absyn_TypeDeclType_struct*)
_tmp65;if(_tmpD2->tag != 26)goto _LLC3;else{_tmpD3=_tmpD2->f1;_tmpD4=*_tmpD3;
_tmpD5=_tmpD4.r;{struct Cyc_Absyn_Datatype_td_struct*_tmpD6=(struct Cyc_Absyn_Datatype_td_struct*)
_tmpD5;if(_tmpD6->tag != 2)goto _LLC3;else{_tmpD7=_tmpD6->f1;}};}}_LLC2: Cyc_Absyndump_dump_datatypedecl(
_tmpD7);return;_LLC3: {struct Cyc_Absyn_HeapRgn_struct*_tmpD8=(struct Cyc_Absyn_HeapRgn_struct*)
_tmp65;if(_tmpD8->tag != 20)goto _LLC5;}_LLC4: goto _LLC6;_LLC5: {struct Cyc_Absyn_AccessEff_struct*
_tmpD9=(struct Cyc_Absyn_AccessEff_struct*)_tmp65;if(_tmpD9->tag != 23)goto _LLC7;}
_LLC6: goto _LLC8;_LLC7: {struct Cyc_Absyn_RgnsEff_struct*_tmpDA=(struct Cyc_Absyn_RgnsEff_struct*)
_tmp65;if(_tmpDA->tag != 25)goto _LLC9;}_LLC8: goto _LLCA;_LLC9: {struct Cyc_Absyn_JoinEff_struct*
_tmpDB=(struct Cyc_Absyn_JoinEff_struct*)_tmp65;if(_tmpDB->tag != 24)goto _LL72;}
_LLCA: return;_LL72:;}void Cyc_Absyndump_dumpvaropt(struct _dyneither_ptr*vo){if(vo
!= 0)Cyc_Absyndump_dump_str((struct _dyneither_ptr*)vo);}void Cyc_Absyndump_dumpfunarg(
struct _tuple8*t){((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct
_dyneither_ptr*),struct _dyneither_ptr*))Cyc_Absyndump_dumptqtd)((*t).f2,(*t).f3,
Cyc_Absyndump_dumpvaropt,(*t).f1);}struct _tuple15{void*f1;void*f2;};void Cyc_Absyndump_dump_rgncmp(
struct _tuple15*cmp){struct _tuple15 _tmp11F;void*_tmp120;void*_tmp121;struct
_tuple15*_tmp11E=cmp;_tmp11F=*_tmp11E;_tmp120=_tmp11F.f1;_tmp121=_tmp11F.f2;Cyc_Absyndump_dumpeff(
_tmp120);Cyc_Absyndump_dump_char((int)'>');Cyc_Absyndump_dumprgn(_tmp121);}void
Cyc_Absyndump_dump_rgnpo(struct Cyc_List_List*rgn_po){const char*_tmp422;((void(*)(
void(*f)(struct _tuple15*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(
Cyc_Absyndump_dump_rgncmp,rgn_po,((_tmp422=",",_tag_dyneither(_tmp422,sizeof(
...
Cyc_Absyndump_dump_char((int)'(');for(0;args != 0;args=args->tl){Cyc_Absyndump_dumpfunarg((
struct _tuple8*)args->hd);if((args->tl != 0  || c_varargs) || cyc_varargs != 0)Cyc_Absyndump_dump_char((
int)',');}if(c_varargs){const char*_tmp423;Cyc_Absyndump_dump(((_tmp423="...",
...
_tmp12A;struct _dyneither_ptr*_tmp12C;_LLDC: {struct Cyc_Absyn_ArrayElement_struct*
_tmp129=(struct Cyc_Absyn_ArrayElement_struct*)_tmp128;if(_tmp129->tag != 0)goto
_LLDE;else{_tmp12A=_tmp129->f1;}}_LLDD:{const char*_tmp427;Cyc_Absyndump_dump(((
_tmp427=".[",_tag_dyneither(_tmp427,sizeof(char),3))));}Cyc_Absyndump_dumpexp(
_tmp12A);Cyc_Absyndump_dump_char((int)']');goto _LLDB;_LLDE: {struct Cyc_Absyn_FieldName_struct*
_tmp12B=(struct Cyc_Absyn_FieldName_struct*)_tmp128;if(_tmp12B->tag != 1)goto _LLDB;
else{_tmp12C=_tmp12B->f1;}}_LLDF: Cyc_Absyndump_dump_char((int)'.');Cyc_Absyndump_dump_nospace(*
_tmp12C);goto _LLDB;_LLDB:;}struct _tuple16{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*
f2;};void Cyc_Absyndump_dumpde(struct _tuple16*de){{const char*_tmp42A;const char*
_tmp429;const char*_tmp428;((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct
_dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(
Cyc_Absyndump_dumpdesignator,(*de).f1,((_tmp428="",_tag_dyneither(_tmp428,
sizeof(char),1))),((_tmp429="=",_tag_dyneither(_tmp429,sizeof(char),2))),((
_tmp42A="=",_tag_dyneither(_tmp42A,sizeof(char),2))));}Cyc_Absyndump_dumpexp((*
de).f2);}void Cyc_Absyndump_dumpexps_prec(int inprec,struct Cyc_List_List*es){const
char*_tmp42D;const char*_tmp42C;const char*_tmp42B;((void(*)(void(*f)(int,struct
...
inprec,es,((_tmp42B="",_tag_dyneither(_tmp42B,sizeof(char),1))),((_tmp42C="",
_tag_dyneither(_tmp42C,sizeof(char),1))),((_tmp42D=",",_tag_dyneither(_tmp42D,
sizeof(char),2))));}void Cyc_Absyndump_dumpexp_prec(int inprec,struct Cyc_Absyn_Exp*
e){int myprec=Cyc_Absynpp_exp_prec(e);if(inprec >= myprec){const char*_tmp42E;Cyc_Absyndump_dump_nospace(((
_tmp42E="(",_tag_dyneither(_tmp42E,sizeof(char),2))));}{void*_tmp135=e->r;union
Cyc_Absyn_Cnst _tmp137;struct _tuple3 _tmp138;enum Cyc_Absyn_Sign _tmp139;char
_tmp13A;union Cyc_Absyn_Cnst _tmp13C;struct _dyneither_ptr _tmp13D;union Cyc_Absyn_Cnst
_tmp13F;struct _tuple4 _tmp140;enum Cyc_Absyn_Sign _tmp141;short _tmp142;union Cyc_Absyn_Cnst
_tmp144;struct _tuple5 _tmp145;enum Cyc_Absyn_Sign _tmp146;int _tmp147;union Cyc_Absyn_Cnst
...
_tmp1DB;struct Cyc_Absyn_Stmt*_tmp1DD;_LLE1: {struct Cyc_Absyn_Const_e_struct*
_tmp136=(struct Cyc_Absyn_Const_e_struct*)_tmp135;if(_tmp136->tag != 0)goto _LLE3;
else{_tmp137=_tmp136->f1;if((_tmp137.Char_c).tag != 2)goto _LLE3;_tmp138=(struct
_tuple3)(_tmp137.Char_c).val;_tmp139=_tmp138.f1;_tmp13A=_tmp138.f2;}}_LLE2: Cyc_Absyndump_dump_char((
int)'\'');Cyc_Absyndump_dump_nospace(Cyc_Absynpp_char_escape(_tmp13A));Cyc_Absyndump_dump_char((
int)'\'');goto _LLE0;_LLE3: {struct Cyc_Absyn_Const_e_struct*_tmp13B=(struct Cyc_Absyn_Const_e_struct*)
_tmp135;if(_tmp13B->tag != 0)goto _LLE5;else{_tmp13C=_tmp13B->f1;if((_tmp13C.Wchar_c).tag
!= 3)goto _LLE5;_tmp13D=(struct _dyneither_ptr)(_tmp13C.Wchar_c).val;}}_LLE4:{
const char*_tmp432;void*_tmp431[1];struct Cyc_String_pa_struct _tmp430;Cyc_Absyndump_dump((
...
goto _LLE0;_LLE5: {struct Cyc_Absyn_Const_e_struct*_tmp13E=(struct Cyc_Absyn_Const_e_struct*)
_tmp135;if(_tmp13E->tag != 0)goto _LLE7;else{_tmp13F=_tmp13E->f1;if((_tmp13F.Short_c).tag
!= 4)goto _LLE7;_tmp140=(struct _tuple4)(_tmp13F.Short_c).val;_tmp141=_tmp140.f1;
_tmp142=_tmp140.f2;}}_LLE6:{const char*_tmp436;void*_tmp435[1];struct Cyc_Int_pa_struct
_tmp434;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp434.tag=1,((_tmp434.f1=(
unsigned long)((int)_tmp142),((_tmp435[0]=& _tmp434,Cyc_aprintf(((_tmp436="%d",
_tag_dyneither(_tmp436,sizeof(char),3))),_tag_dyneither(_tmp435,sizeof(void*),1)))))))));}
goto _LLE0;_LLE7: {struct Cyc_Absyn_Const_e_struct*_tmp143=(struct Cyc_Absyn_Const_e_struct*)
...
_tmp135;if(_tmp148->tag != 0)goto _LLEB;else{_tmp149=_tmp148->f1;if((_tmp149.Int_c).tag
!= 5)goto _LLEB;_tmp14A=(struct _tuple5)(_tmp149.Int_c).val;_tmp14B=_tmp14A.f1;if(
_tmp14B != Cyc_Absyn_Signed)goto _LLEB;_tmp14C=_tmp14A.f2;}}_LLEA:{const char*
_tmp43A;void*_tmp439[1];struct Cyc_Int_pa_struct _tmp438;Cyc_Absyndump_dump((
struct _dyneither_ptr)((_tmp438.tag=1,((_tmp438.f1=(unsigned long)_tmp14C,((
_tmp439[0]=& _tmp438,Cyc_aprintf(((_tmp43A="%d",_tag_dyneither(_tmp43A,sizeof(
char),3))),_tag_dyneither(_tmp439,sizeof(void*),1)))))))));}goto _LLE0;_LLEB: {
struct Cyc_Absyn_Const_e_struct*_tmp14D=(struct Cyc_Absyn_Const_e_struct*)_tmp135;
if(_tmp14D->tag != 0)goto _LLED;else{_tmp14E=_tmp14D->f1;if((_tmp14E.Int_c).tag != 
5)goto _LLED;_tmp14F=(struct _tuple5)(_tmp14E.Int_c).val;_tmp150=_tmp14F.f1;if(
...
struct _dyneither_ptr)((_tmp43C.tag=1,((_tmp43C.f1=(unsigned int)_tmp151,((
_tmp43D[0]=& _tmp43C,Cyc_aprintf(((_tmp43E="%u",_tag_dyneither(_tmp43E,sizeof(
char),3))),_tag_dyneither(_tmp43D,sizeof(void*),1)))))))));}goto _LLE0;_LLED: {
struct Cyc_Absyn_Const_e_struct*_tmp152=(struct Cyc_Absyn_Const_e_struct*)_tmp135;
if(_tmp152->tag != 0)goto _LLEF;else{_tmp153=_tmp152->f1;if((_tmp153.LongLong_c).tag
!= 6)goto _LLEF;_tmp154=(struct _tuple6)(_tmp153.LongLong_c).val;_tmp155=_tmp154.f1;
_tmp156=_tmp154.f2;}}_LLEE:{const char*_tmp43F;Cyc_Absyndump_dump(((_tmp43F="<<FIX LONG LONG CONSTANT>>",
_tag_dyneither(_tmp43F,sizeof(char),27))));}goto _LLE0;_LLEF: {struct Cyc_Absyn_Const_e_struct*
_tmp157=(struct Cyc_Absyn_Const_e_struct*)_tmp135;if(_tmp157->tag != 0)goto _LLF1;
else{_tmp158=_tmp157->f1;if((_tmp158.Float_c).tag != 7)goto _LLF1;_tmp159=(struct
_tuple7)(_tmp158.Float_c).val;_tmp15A=_tmp159.f1;}}_LLF0: Cyc_Absyndump_dump(
_tmp15A);goto _LLE0;_LLF1: {struct Cyc_Absyn_Const_e_struct*_tmp15B=(struct Cyc_Absyn_Const_e_struct*)
_tmp135;if(_tmp15B->tag != 0)goto _LLF3;else{_tmp15C=_tmp15B->f1;if((_tmp15C.Null_c).tag
!= 1)goto _LLF3;_tmp15D=(int)(_tmp15C.Null_c).val;}}_LLF2:{const char*_tmp440;Cyc_Absyndump_dump(((
_tmp440="NULL",_tag_dyneither(_tmp440,sizeof(char),5))));}goto _LLE0;_LLF3: {
struct Cyc_Absyn_Const_e_struct*_tmp15E=(struct Cyc_Absyn_Const_e_struct*)_tmp135;
if(_tmp15E->tag != 0)goto _LLF5;else{_tmp15F=_tmp15E->f1;if((_tmp15F.String_c).tag
!= 8)goto _LLF5;_tmp160=(struct _dyneither_ptr)(_tmp15F.String_c).val;}}_LLF4: Cyc_Absyndump_dump_char((
int)'"');Cyc_Absyndump_dump_nospace(Cyc_Absynpp_string_escape(_tmp160));Cyc_Absyndump_dump_char((
int)'"');goto _LLE0;_LLF5: {struct Cyc_Absyn_Const_e_struct*_tmp161=(struct Cyc_Absyn_Const_e_struct*)
_tmp135;if(_tmp161->tag != 0)goto _LLF7;else{_tmp162=_tmp161->f1;if((_tmp162.Wstring_c).tag
!= 9)goto _LLF7;_tmp163=(struct _dyneither_ptr)(_tmp162.Wstring_c).val;}}_LLF6:{
const char*_tmp441;Cyc_Absyndump_dump(((_tmp441="L\"",_tag_dyneither(_tmp441,
sizeof(char),3))));}Cyc_Absyndump_dump_nospace(_tmp163);Cyc_Absyndump_dump_char((
int)'"');goto _LLE0;_LLF7: {struct Cyc_Absyn_Var_e_struct*_tmp164=(struct Cyc_Absyn_Var_e_struct*)
_tmp135;if(_tmp164->tag != 1)goto _LLF9;else{_tmp165=_tmp164->f1;}}_LLF8: Cyc_Absyndump_dumpqvar(
_tmp165);goto _LLE0;_LLF9: {struct Cyc_Absyn_Primop_e_struct*_tmp166=(struct Cyc_Absyn_Primop_e_struct*)
...
_check_null(_tmp168->tl))->hd);break;default: _LL14D: {struct Cyc_Core_Failure_struct
_tmp449;const char*_tmp448;struct Cyc_Core_Failure_struct*_tmp447;(int)_throw((
...
_LLFB: {struct Cyc_Absyn_AssignOp_e_struct*_tmp169=(struct Cyc_Absyn_AssignOp_e_struct*)
...
_tmp16C);goto _LLE0;_LLFD: {struct Cyc_Absyn_Increment_e_struct*_tmp16D=(struct Cyc_Absyn_Increment_e_struct*)
_tmp135;if(_tmp16D->tag != 4)goto _LLFF;else{_tmp16E=_tmp16D->f1;_tmp16F=_tmp16D->f2;
if(_tmp16F != Cyc_Absyn_PreInc)goto _LLFF;}}_LLFE:{const char*_tmp44B;Cyc_Absyndump_dump(((
_tmp44B="++",_tag_dyneither(_tmp44B,sizeof(char),3))));}Cyc_Absyndump_dumpexp_prec(
myprec,_tmp16E);goto _LLE0;_LLFF: {struct Cyc_Absyn_Increment_e_struct*_tmp170=(
struct Cyc_Absyn_Increment_e_struct*)_tmp135;if(_tmp170->tag != 4)goto _LL101;else{
_tmp171=_tmp170->f1;_tmp172=_tmp170->f2;if(_tmp172 != Cyc_Absyn_PreDec)goto _LL101;}}
_LL100:{const char*_tmp44C;Cyc_Absyndump_dump(((_tmp44C="--",_tag_dyneither(
_tmp44C,sizeof(char),3))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp171);goto _LLE0;
_LL101: {struct Cyc_Absyn_Increment_e_struct*_tmp173=(struct Cyc_Absyn_Increment_e_struct*)
_tmp135;if(_tmp173->tag != 4)goto _LL103;else{_tmp174=_tmp173->f1;_tmp175=_tmp173->f2;
if(_tmp175 != Cyc_Absyn_PostInc)goto _LL103;}}_LL102: Cyc_Absyndump_dumpexp_prec(
myprec,_tmp174);{const char*_tmp44D;Cyc_Absyndump_dump(((_tmp44D="++",
_tag_dyneither(_tmp44D,sizeof(char),3))));}goto _LLE0;_LL103: {struct Cyc_Absyn_Increment_e_struct*
_tmp176=(struct Cyc_Absyn_Increment_e_struct*)_tmp135;if(_tmp176->tag != 4)goto
_LL105;else{_tmp177=_tmp176->f1;_tmp178=_tmp176->f2;if(_tmp178 != Cyc_Absyn_PostDec)
...
goto _LLE0;_LL105: {struct Cyc_Absyn_Conditional_e_struct*_tmp179=(struct Cyc_Absyn_Conditional_e_struct*)
_tmp135;if(_tmp179->tag != 5)goto _LL107;else{_tmp17A=_tmp179->f1;_tmp17B=_tmp179->f2;
_tmp17C=_tmp179->f3;}}_LL106: Cyc_Absyndump_dumpexp_prec(myprec,_tmp17A);Cyc_Absyndump_dump_char((
int)'?');Cyc_Absyndump_dumpexp_prec(0,_tmp17B);Cyc_Absyndump_dump_char((int)':');
Cyc_Absyndump_dumpexp_prec(myprec,_tmp17C);goto _LLE0;_LL107: {struct Cyc_Absyn_And_e_struct*
_tmp17D=(struct Cyc_Absyn_And_e_struct*)_tmp135;if(_tmp17D->tag != 6)goto _LL109;
else{_tmp17E=_tmp17D->f1;_tmp17F=_tmp17D->f2;}}_LL108: Cyc_Absyndump_dumpexp_prec(
...
_tmp17F);goto _LLE0;_LL109: {struct Cyc_Absyn_Or_e_struct*_tmp180=(struct Cyc_Absyn_Or_e_struct*)
_tmp135;if(_tmp180->tag != 7)goto _LL10B;else{_tmp181=_tmp180->f1;_tmp182=_tmp180->f2;}}
_LL10A: Cyc_Absyndump_dumpexp_prec(myprec,_tmp181);{const char*_tmp450;Cyc_Absyndump_dump(((
_tmp450=" || ",_tag_dyneither(_tmp450,sizeof(char),5))));}Cyc_Absyndump_dumpexp_prec(
myprec,_tmp182);goto _LLE0;_LL10B: {struct Cyc_Absyn_SeqExp_e_struct*_tmp183=(
struct Cyc_Absyn_SeqExp_e_struct*)_tmp135;if(_tmp183->tag != 8)goto _LL10D;else{
_tmp184=_tmp183->f1;_tmp185=_tmp183->f2;}}_LL10C: Cyc_Absyndump_dump_char((int)'(');
Cyc_Absyndump_dumpexp_prec(myprec,_tmp184);Cyc_Absyndump_dump_char((int)',');Cyc_Absyndump_dumpexp_prec(
myprec,_tmp185);Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL10D: {struct Cyc_Absyn_FnCall_e_struct*
_tmp186=(struct Cyc_Absyn_FnCall_e_struct*)_tmp135;if(_tmp186->tag != 9)goto _LL10F;
...
_tag_dyneither(_tmp452,sizeof(char),2))));}goto _LLE0;_LL10F: {struct Cyc_Absyn_Throw_e_struct*
_tmp189=(struct Cyc_Absyn_Throw_e_struct*)_tmp135;if(_tmp189->tag != 10)goto _LL111;
else{_tmp18A=_tmp189->f1;}}_LL110:{const char*_tmp453;Cyc_Absyndump_dump(((
_tmp453="throw",_tag_dyneither(_tmp453,sizeof(char),6))));}Cyc_Absyndump_dumpexp_prec(
myprec,_tmp18A);goto _LLE0;_LL111: {struct Cyc_Absyn_NoInstantiate_e_struct*
_tmp18B=(struct Cyc_Absyn_NoInstantiate_e_struct*)_tmp135;if(_tmp18B->tag != 11)
goto _LL113;else{_tmp18C=_tmp18B->f1;}}_LL112: _tmp18E=_tmp18C;goto _LL114;_LL113: {
struct Cyc_Absyn_Instantiate_e_struct*_tmp18D=(struct Cyc_Absyn_Instantiate_e_struct*)
_tmp135;if(_tmp18D->tag != 12)goto _LL115;else{_tmp18E=_tmp18D->f1;}}_LL114: Cyc_Absyndump_dumpexp_prec(
inprec,_tmp18E);goto _LLE0;_LL115: {struct Cyc_Absyn_Cast_e_struct*_tmp18F=(struct
Cyc_Absyn_Cast_e_struct*)_tmp135;if(_tmp18F->tag != 13)goto _LL117;else{_tmp190=(
void*)_tmp18F->f1;_tmp191=_tmp18F->f2;}}_LL116: Cyc_Absyndump_dump_char((int)'(');
Cyc_Absyndump_dumptyp(_tmp190);Cyc_Absyndump_dump_char((int)')');Cyc_Absyndump_dumpexp_prec(
myprec,_tmp191);goto _LLE0;_LL117: {struct Cyc_Absyn_Address_e_struct*_tmp192=(
struct Cyc_Absyn_Address_e_struct*)_tmp135;if(_tmp192->tag != 14)goto _LL119;else{
_tmp193=_tmp192->f1;}}_LL118: Cyc_Absyndump_dump_char((int)'&');Cyc_Absyndump_dumpexp_prec(
myprec,_tmp193);goto _LLE0;_LL119: {struct Cyc_Absyn_New_e_struct*_tmp194=(struct
Cyc_Absyn_New_e_struct*)_tmp135;if(_tmp194->tag != 15)goto _LL11B;else{_tmp195=
_tmp194->f1;_tmp196=_tmp194->f2;}}_LL11A:{const char*_tmp454;Cyc_Absyndump_dump(((
_tmp454="new ",_tag_dyneither(_tmp454,sizeof(char),5))));}Cyc_Absyndump_dumpexp_prec(
myprec,_tmp196);goto _LLE0;_LL11B: {struct Cyc_Absyn_Sizeoftyp_e_struct*_tmp197=(
struct Cyc_Absyn_Sizeoftyp_e_struct*)_tmp135;if(_tmp197->tag != 16)goto _LL11D;
else{_tmp198=(void*)_tmp197->f1;}}_LL11C:{const char*_tmp455;Cyc_Absyndump_dump(((
_tmp455="sizeof(",_tag_dyneither(_tmp455,sizeof(char),8))));}Cyc_Absyndump_dumptyp(
_tmp198);Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL11D: {struct Cyc_Absyn_Sizeofexp_e_struct*
_tmp199=(struct Cyc_Absyn_Sizeofexp_e_struct*)_tmp135;if(_tmp199->tag != 17)goto
_LL11F;else{_tmp19A=_tmp199->f1;}}_LL11E:{const char*_tmp456;Cyc_Absyndump_dump(((
_tmp456="sizeof(",_tag_dyneither(_tmp456,sizeof(char),8))));}Cyc_Absyndump_dumpexp(
_tmp19A);Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL11F: {struct Cyc_Absyn_Valueof_e_struct*
_tmp19B=(struct Cyc_Absyn_Valueof_e_struct*)_tmp135;if(_tmp19B->tag != 37)goto
_LL121;else{_tmp19C=(void*)_tmp19B->f1;}}_LL120:{const char*_tmp457;Cyc_Absyndump_dump(((
_tmp457="valueof(",_tag_dyneither(_tmp457,sizeof(char),9))));}Cyc_Absyndump_dumptyp(
_tmp19C);Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL121: {struct Cyc_Absyn_Asm_e_struct*
_tmp19D=(struct Cyc_Absyn_Asm_e_struct*)_tmp135;if(_tmp19D->tag != 38)goto _LL123;
else{_tmp19E=_tmp19D->f1;_tmp19F=_tmp19D->f2;}}_LL122:{const char*_tmp458;Cyc_Absyndump_dump(((
_tmp458="__asm__",_tag_dyneither(_tmp458,sizeof(char),8))));}if(_tmp19E){const
char*_tmp459;Cyc_Absyndump_dump(((_tmp459=" volatile ",_tag_dyneither(_tmp459,
sizeof(char),11))));}Cyc_Absyndump_dump_char((int)'(');Cyc_Absyndump_dump_nospace(
_tmp19F);Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL123: {struct Cyc_Absyn_Tagcheck_e_struct*
_tmp1A0=(struct Cyc_Absyn_Tagcheck_e_struct*)_tmp135;if(_tmp1A0->tag != 36)goto
_LL125;else{_tmp1A1=_tmp1A0->f1;_tmp1A2=_tmp1A0->f2;}}_LL124:{const char*_tmp45A;
Cyc_Absyndump_dump(((_tmp45A="tagcheck(",_tag_dyneither(_tmp45A,sizeof(char),10))));}
Cyc_Absyndump_dumpexp(_tmp1A1);Cyc_Absyndump_dump_char((int)'.');Cyc_Absyndump_dump_nospace(*
_tmp1A2);Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL125: {struct Cyc_Absyn_Offsetof_e_struct*
_tmp1A3=(struct Cyc_Absyn_Offsetof_e_struct*)_tmp135;if(_tmp1A3->tag != 18)goto
_LL127;else{_tmp1A4=(void*)_tmp1A3->f1;_tmp1A5=(void*)_tmp1A3->f2;{struct Cyc_Absyn_StructField_struct*
_tmp1A6=(struct Cyc_Absyn_StructField_struct*)_tmp1A5;if(_tmp1A6->tag != 0)goto
_LL127;else{_tmp1A7=_tmp1A6->f1;}};}}_LL126:{const char*_tmp45B;Cyc_Absyndump_dump(((
_tmp45B="offsetof(",_tag_dyneither(_tmp45B,sizeof(char),10))));}Cyc_Absyndump_dumptyp(
_tmp1A4);Cyc_Absyndump_dump_char((int)',');Cyc_Absyndump_dump_nospace(*_tmp1A7);
Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL127: {struct Cyc_Absyn_Offsetof_e_struct*
_tmp1A8=(struct Cyc_Absyn_Offsetof_e_struct*)_tmp135;if(_tmp1A8->tag != 18)goto
_LL129;else{_tmp1A9=(void*)_tmp1A8->f1;_tmp1AA=(void*)_tmp1A8->f2;{struct Cyc_Absyn_TupleIndex_struct*
_tmp1AB=(struct Cyc_Absyn_TupleIndex_struct*)_tmp1AA;if(_tmp1AB->tag != 1)goto
_LL129;else{_tmp1AC=_tmp1AB->f1;}};}}_LL128:{const char*_tmp45C;Cyc_Absyndump_dump(((
...
struct Cyc_Int_pa_struct _tmp45E;Cyc_Absyndump_dump((struct _dyneither_ptr)((
...
goto _LLE0;_LL129: {struct Cyc_Absyn_Deref_e_struct*_tmp1AD=(struct Cyc_Absyn_Deref_e_struct*)
_tmp135;if(_tmp1AD->tag != 19)goto _LL12B;else{_tmp1AE=_tmp1AD->f1;}}_LL12A: Cyc_Absyndump_dump_char((
int)'*');Cyc_Absyndump_dumpexp_prec(myprec,_tmp1AE);goto _LLE0;_LL12B: {struct Cyc_Absyn_AggrMember_e_struct*
_tmp1AF=(struct Cyc_Absyn_AggrMember_e_struct*)_tmp135;if(_tmp1AF->tag != 20)goto
_LL12D;else{_tmp1B0=_tmp1AF->f1;_tmp1B1=_tmp1AF->f2;}}_LL12C: Cyc_Absyndump_dumpexp_prec(
myprec,_tmp1B0);Cyc_Absyndump_dump_char((int)'.');Cyc_Absyndump_dump_nospace(*
_tmp1B1);goto _LLE0;_LL12D: {struct Cyc_Absyn_AggrArrow_e_struct*_tmp1B2=(struct
Cyc_Absyn_AggrArrow_e_struct*)_tmp135;if(_tmp1B2->tag != 21)goto _LL12F;else{
_tmp1B3=_tmp1B2->f1;_tmp1B4=_tmp1B2->f2;}}_LL12E: Cyc_Absyndump_dumpexp_prec(
...
goto _LLE0;_LL12F: {struct Cyc_Absyn_Subscript_e_struct*_tmp1B5=(struct Cyc_Absyn_Subscript_e_struct*)
_tmp135;if(_tmp1B5->tag != 22)goto _LL131;else{_tmp1B6=_tmp1B5->f1;_tmp1B7=_tmp1B5->f2;}}
_LL130: Cyc_Absyndump_dumpexp_prec(myprec,_tmp1B6);Cyc_Absyndump_dump_char((int)'[');
Cyc_Absyndump_dumpexp(_tmp1B7);Cyc_Absyndump_dump_char((int)']');goto _LLE0;
_LL131: {struct Cyc_Absyn_Tuple_e_struct*_tmp1B8=(struct Cyc_Absyn_Tuple_e_struct*)
_tmp135;if(_tmp1B8->tag != 23)goto _LL133;else{_tmp1B9=_tmp1B8->f1;}}_LL132:{const
char*_tmp462;Cyc_Absyndump_dump(((_tmp462="$(",_tag_dyneither(_tmp462,sizeof(
char),3))));}Cyc_Absyndump_dumpexps_prec(20,_tmp1B9);Cyc_Absyndump_dump_char((
int)')');goto _LLE0;_LL133: {struct Cyc_Absyn_CompoundLit_e_struct*_tmp1BA=(struct
Cyc_Absyn_CompoundLit_e_struct*)_tmp135;if(_tmp1BA->tag != 24)goto _LL135;else{
_tmp1BB=_tmp1BA->f1;_tmp1BC=_tmp1BA->f2;}}_LL134: Cyc_Absyndump_dump_char((int)'(');
Cyc_Absyndump_dumptyp((*_tmp1BB).f3);Cyc_Absyndump_dump_char((int)')');{const
char*_tmp465;const char*_tmp464;const char*_tmp463;((void(*)(void(*f)(struct
...
sizeof(char),2))));}goto _LLE0;_LL135: {struct Cyc_Absyn_Array_e_struct*_tmp1BD=(
struct Cyc_Absyn_Array_e_struct*)_tmp135;if(_tmp1BD->tag != 25)goto _LL137;else{
_tmp1BE=_tmp1BD->f1;}}_LL136:{const char*_tmp468;const char*_tmp467;const char*
_tmp466;((void(*)(void(*f)(struct _tuple16*),struct Cyc_List_List*l,struct
...
_tag_dyneither(_tmp468,sizeof(char),2))));}goto _LLE0;_LL137: {struct Cyc_Absyn_Comprehension_e_struct*
_tmp1BF=(struct Cyc_Absyn_Comprehension_e_struct*)_tmp135;if(_tmp1BF->tag != 26)
goto _LL139;else{_tmp1C0=_tmp1BF->f1;_tmp1C1=_tmp1BF->f2;_tmp1C2=_tmp1BF->f3;}}
_LL138:{const char*_tmp469;Cyc_Absyndump_dump(((_tmp469="new {for",_tag_dyneither(
_tmp469,sizeof(char),9))));}Cyc_Absyndump_dump_str((*_tmp1C0->name).f2);Cyc_Absyndump_dump_char((
int)'<');Cyc_Absyndump_dumpexp(_tmp1C1);Cyc_Absyndump_dump_char((int)':');Cyc_Absyndump_dumpexp(
_tmp1C2);Cyc_Absyndump_dump_char((int)'}');goto _LLE0;_LL139: {struct Cyc_Absyn_Aggregate_e_struct*
_tmp1C3=(struct Cyc_Absyn_Aggregate_e_struct*)_tmp135;if(_tmp1C3->tag != 27)goto
...
_tag_dyneither(_tmp46C,sizeof(char),2))));}goto _LLE0;_LL13B: {struct Cyc_Absyn_AnonStruct_e_struct*
_tmp1C7=(struct Cyc_Absyn_AnonStruct_e_struct*)_tmp135;if(_tmp1C7->tag != 28)goto
_LL13D;else{_tmp1C8=_tmp1C7->f2;}}_LL13C:{const char*_tmp46F;const char*_tmp46E;
const char*_tmp46D;((void(*)(void(*f)(struct _tuple16*),struct Cyc_List_List*l,
...
_tag_dyneither(_tmp46F,sizeof(char),2))));}goto _LLE0;_LL13D: {struct Cyc_Absyn_Datatype_e_struct*
_tmp1C9=(struct Cyc_Absyn_Datatype_e_struct*)_tmp135;if(_tmp1C9->tag != 29)goto
_LL13F;else{_tmp1CA=_tmp1C9->f1;_tmp1CB=_tmp1C9->f3;}}_LL13E: Cyc_Absyndump_dumpqvar(
...
_tag_dyneither(_tmp472,sizeof(char),2))));}goto _LLE0;_LL13F: {struct Cyc_Absyn_Enum_e_struct*
_tmp1CC=(struct Cyc_Absyn_Enum_e_struct*)_tmp135;if(_tmp1CC->tag != 30)goto _LL141;
else{_tmp1CD=_tmp1CC->f1;}}_LL140: Cyc_Absyndump_dumpqvar(_tmp1CD);goto _LLE0;
_LL141: {struct Cyc_Absyn_AnonEnum_e_struct*_tmp1CE=(struct Cyc_Absyn_AnonEnum_e_struct*)
_tmp135;if(_tmp1CE->tag != 31)goto _LL143;else{_tmp1CF=_tmp1CE->f1;}}_LL142: Cyc_Absyndump_dumpqvar(
_tmp1CF);goto _LLE0;_LL143: {struct Cyc_Absyn_Malloc_e_struct*_tmp1D0=(struct Cyc_Absyn_Malloc_e_struct*)
_tmp135;if(_tmp1D0->tag != 32)goto _LL145;else{_tmp1D1=_tmp1D0->f1;_tmp1D2=_tmp1D1.is_calloc;
_tmp1D3=_tmp1D1.rgn;_tmp1D4=_tmp1D1.elt_type;_tmp1D5=_tmp1D1.num_elts;}}_LL144:
if(_tmp1D2){if(_tmp1D3 != 0){{const char*_tmp473;Cyc_Absyndump_dump(((_tmp473="rcalloc(",
_tag_dyneither(_tmp473,sizeof(char),9))));}Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)
_tmp1D3);{const char*_tmp474;Cyc_Absyndump_dump(((_tmp474=",",_tag_dyneither(
_tmp474,sizeof(char),2))));};}else{const char*_tmp475;Cyc_Absyndump_dump(((
_tmp475="calloc",_tag_dyneither(_tmp475,sizeof(char),7))));}Cyc_Absyndump_dumpexp(
_tmp1D5);{const char*_tmp476;Cyc_Absyndump_dump(((_tmp476=",",_tag_dyneither(
_tmp476,sizeof(char),2))));}Cyc_Absyndump_dumpexp(Cyc_Absyn_sizeoftyp_exp(*((
void**)_check_null(_tmp1D4)),0));{const char*_tmp477;Cyc_Absyndump_dump(((_tmp477=")",
_tag_dyneither(_tmp477,sizeof(char),2))));};}else{if(_tmp1D3 != 0){{const char*
_tmp478;Cyc_Absyndump_dump(((_tmp478="rmalloc(",_tag_dyneither(_tmp478,sizeof(
char),9))));}Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_tmp1D3);{const char*
_tmp479;Cyc_Absyndump_dump(((_tmp479=",",_tag_dyneither(_tmp479,sizeof(char),2))));};}
else{const char*_tmp47A;Cyc_Absyndump_dump(((_tmp47A="malloc(",_tag_dyneither(
_tmp47A,sizeof(char),8))));}if(_tmp1D4 != 0)Cyc_Absyndump_dumpexp(Cyc_Absyn_times_exp(
Cyc_Absyn_sizeoftyp_exp(*_tmp1D4,0),_tmp1D5,0));else{Cyc_Absyndump_dumpexp(
_tmp1D5);}{const char*_tmp47B;Cyc_Absyndump_dump(((_tmp47B=")",_tag_dyneither(
_tmp47B,sizeof(char),2))));};}goto _LLE0;_LL145: {struct Cyc_Absyn_Swap_e_struct*
_tmp1D6=(struct Cyc_Absyn_Swap_e_struct*)_tmp135;if(_tmp1D6->tag != 33)goto _LL147;
else{_tmp1D7=_tmp1D6->f1;_tmp1D8=_tmp1D6->f2;}}_LL146: Cyc_Absyndump_dumpexp_prec(
...
_tmp1D8);goto _LLE0;_LL147: {struct Cyc_Absyn_UnresolvedMem_e_struct*_tmp1D9=(
struct Cyc_Absyn_UnresolvedMem_e_struct*)_tmp135;if(_tmp1D9->tag != 34)goto _LL149;
else{_tmp1DA=_tmp1D9->f1;_tmp1DB=_tmp1D9->f2;}}_LL148:{const char*_tmp47F;const
char*_tmp47E;const char*_tmp47D;((void(*)(void(*f)(struct _tuple16*),struct Cyc_List_List*
l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumpde,_tmp1DB,((_tmp47D="{",_tag_dyneither(_tmp47D,sizeof(char),2))),((
_tmp47E="}",_tag_dyneither(_tmp47E,sizeof(char),2))),((_tmp47F=",",
_tag_dyneither(_tmp47F,sizeof(char),2))));}goto _LLE0;_LL149: {struct Cyc_Absyn_StmtExp_e_struct*
_tmp1DC=(struct Cyc_Absyn_StmtExp_e_struct*)_tmp135;if(_tmp1DC->tag != 35)goto
_LLE0;else{_tmp1DD=_tmp1DC->f1;}}_LL14A:{const char*_tmp480;Cyc_Absyndump_dump_nospace(((
...
Cyc_Absyn_Skip_s_struct*_tmp230=(struct Cyc_Absyn_Skip_s_struct*)_tmp22F;if(
_tmp230->tag != 0)goto _LL152;}_LL151: Cyc_Absyndump_dump_semi();goto _LL14F;_LL152: {
struct Cyc_Absyn_Exp_s_struct*_tmp231=(struct Cyc_Absyn_Exp_s_struct*)_tmp22F;if(
_tmp231->tag != 1)goto _LL154;else{_tmp232=_tmp231->f1;}}_LL153: Cyc_Absyndump_dumploc(
s->loc);Cyc_Absyndump_dumpexp(_tmp232);Cyc_Absyndump_dump_semi();goto _LL14F;
_LL154: {struct Cyc_Absyn_Seq_s_struct*_tmp233=(struct Cyc_Absyn_Seq_s_struct*)
...
goto _LL14F;_LL156: {struct Cyc_Absyn_Return_s_struct*_tmp236=(struct Cyc_Absyn_Return_s_struct*)
_tmp22F;if(_tmp236->tag != 3)goto _LL158;else{_tmp237=_tmp236->f1;if(_tmp237 != 0)
goto _LL158;}}_LL157: Cyc_Absyndump_dumploc(s->loc);{const char*_tmp486;Cyc_Absyndump_dump(((
_tmp486="return;",_tag_dyneither(_tmp486,sizeof(char),8))));}goto _LL14F;_LL158: {
struct Cyc_Absyn_Return_s_struct*_tmp238=(struct Cyc_Absyn_Return_s_struct*)
_tmp22F;if(_tmp238->tag != 3)goto _LL15A;else{_tmp239=_tmp238->f1;}}_LL159: Cyc_Absyndump_dumploc(
s->loc);{const char*_tmp487;Cyc_Absyndump_dump(((_tmp487="return",_tag_dyneither(
_tmp487,sizeof(char),7))));}Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)
_check_null(_tmp239));Cyc_Absyndump_dump_semi();goto _LL14F;_LL15A: {struct Cyc_Absyn_IfThenElse_s_struct*
_tmp23A=(struct Cyc_Absyn_IfThenElse_s_struct*)_tmp22F;if(_tmp23A->tag != 4)goto
_LL15C;else{_tmp23B=_tmp23A->f1;_tmp23C=_tmp23A->f2;_tmp23D=_tmp23A->f3;}}_LL15B:
Cyc_Absyndump_dumploc(s->loc);{const char*_tmp488;Cyc_Absyndump_dump(((_tmp488="if(",
_tag_dyneither(_tmp488,sizeof(char),4))));}Cyc_Absyndump_dumpexp(_tmp23B);{void*
_tmp266=_tmp23C->r;_LL177: {struct Cyc_Absyn_Seq_s_struct*_tmp267=(struct Cyc_Absyn_Seq_s_struct*)
_tmp266;if(_tmp267->tag != 2)goto _LL179;}_LL178: goto _LL17A;_LL179: {struct Cyc_Absyn_Decl_s_struct*
_tmp268=(struct Cyc_Absyn_Decl_s_struct*)_tmp266;if(_tmp268->tag != 12)goto _LL17B;}
_LL17A: goto _LL17C;_LL17B: {struct Cyc_Absyn_IfThenElse_s_struct*_tmp269=(struct
Cyc_Absyn_IfThenElse_s_struct*)_tmp266;if(_tmp269->tag != 4)goto _LL17D;}_LL17C:
goto _LL17E;_LL17D: {struct Cyc_Absyn_Label_s_struct*_tmp26A=(struct Cyc_Absyn_Label_s_struct*)
_tmp266;if(_tmp26A->tag != 13)goto _LL17F;}_LL17E:{const char*_tmp489;Cyc_Absyndump_dump_nospace(((
_tmp489="){",_tag_dyneither(_tmp489,sizeof(char),3))));}Cyc_Absyndump_dumpstmt(
_tmp23C,0);Cyc_Absyndump_dump_char((int)'}');goto _LL176;_LL17F:;_LL180: Cyc_Absyndump_dump_char((
int)')');Cyc_Absyndump_dumpstmt(_tmp23C,0);_LL176:;}{void*_tmp26C=_tmp23D->r;
_LL182: {struct Cyc_Absyn_Skip_s_struct*_tmp26D=(struct Cyc_Absyn_Skip_s_struct*)
_tmp26C;if(_tmp26D->tag != 0)goto _LL184;}_LL183: goto _LL181;_LL184:;_LL185:{const
char*_tmp48A;Cyc_Absyndump_dump(((_tmp48A="else{",_tag_dyneither(_tmp48A,sizeof(
char),6))));}Cyc_Absyndump_dumpstmt(_tmp23D,0);Cyc_Absyndump_dump_char((int)'}');
goto _LL181;_LL181:;}goto _LL14F;_LL15C: {struct Cyc_Absyn_While_s_struct*_tmp23E=(
struct Cyc_Absyn_While_s_struct*)_tmp22F;if(_tmp23E->tag != 5)goto _LL15E;else{
_tmp23F=_tmp23E->f1;_tmp240=_tmp23F.f1;_tmp241=_tmp23E->f2;}}_LL15D: Cyc_Absyndump_dumploc(
s->loc);{const char*_tmp48B;Cyc_Absyndump_dump(((_tmp48B="while(",_tag_dyneither(
_tmp48B,sizeof(char),7))));}Cyc_Absyndump_dumpexp(_tmp240);{const char*_tmp48C;
Cyc_Absyndump_dump_nospace(((_tmp48C="){",_tag_dyneither(_tmp48C,sizeof(char),3))));}
Cyc_Absyndump_dumpstmt(_tmp241,0);Cyc_Absyndump_dump_char((int)'}');goto _LL14F;
_LL15E: {struct Cyc_Absyn_Break_s_struct*_tmp242=(struct Cyc_Absyn_Break_s_struct*)
_tmp22F;if(_tmp242->tag != 6)goto _LL160;}_LL15F: Cyc_Absyndump_dumploc(s->loc);{
const char*_tmp48D;Cyc_Absyndump_dump(((_tmp48D="break;",_tag_dyneither(_tmp48D,
sizeof(char),7))));}goto _LL14F;_LL160: {struct Cyc_Absyn_Continue_s_struct*
_tmp243=(struct Cyc_Absyn_Continue_s_struct*)_tmp22F;if(_tmp243->tag != 7)goto
_LL162;}_LL161: Cyc_Absyndump_dumploc(s->loc);{const char*_tmp48E;Cyc_Absyndump_dump(((
_tmp48E="continue;",_tag_dyneither(_tmp48E,sizeof(char),10))));}goto _LL14F;
_LL162: {struct Cyc_Absyn_Goto_s_struct*_tmp244=(struct Cyc_Absyn_Goto_s_struct*)
_tmp22F;if(_tmp244->tag != 8)goto _LL164;else{_tmp245=_tmp244->f1;}}_LL163: Cyc_Absyndump_dumploc(
s->loc);{const char*_tmp48F;Cyc_Absyndump_dump(((_tmp48F="goto",_tag_dyneither(
_tmp48F,sizeof(char),5))));}Cyc_Absyndump_dump_str(_tmp245);Cyc_Absyndump_dump_semi();
goto _LL14F;_LL164: {struct Cyc_Absyn_For_s_struct*_tmp246=(struct Cyc_Absyn_For_s_struct*)
_tmp22F;if(_tmp246->tag != 9)goto _LL166;else{_tmp247=_tmp246->f1;_tmp248=_tmp246->f2;
_tmp249=_tmp248.f1;_tmp24A=_tmp246->f3;_tmp24B=_tmp24A.f1;_tmp24C=_tmp246->f4;}}
_LL165: Cyc_Absyndump_dumploc(s->loc);{const char*_tmp490;Cyc_Absyndump_dump(((
_tmp490="for(",_tag_dyneither(_tmp490,sizeof(char),5))));}Cyc_Absyndump_dumpexp(
_tmp247);Cyc_Absyndump_dump_semi();Cyc_Absyndump_dumpexp(_tmp249);Cyc_Absyndump_dump_semi();
Cyc_Absyndump_dumpexp(_tmp24B);{const char*_tmp491;Cyc_Absyndump_dump_nospace(((
_tmp491="){",_tag_dyneither(_tmp491,sizeof(char),3))));}Cyc_Absyndump_dumpstmt(
_tmp24C,0);Cyc_Absyndump_dump_char((int)'}');goto _LL14F;_LL166: {struct Cyc_Absyn_Switch_s_struct*
_tmp24D=(struct Cyc_Absyn_Switch_s_struct*)_tmp22F;if(_tmp24D->tag != 10)goto
_LL168;else{_tmp24E=_tmp24D->f1;_tmp24F=_tmp24D->f2;}}_LL167: Cyc_Absyndump_dumploc(
...
_LL14F;_LL168: {struct Cyc_Absyn_Decl_s_struct*_tmp250=(struct Cyc_Absyn_Decl_s_struct*)
...
goto _LL14F;_LL16A: {struct Cyc_Absyn_Label_s_struct*_tmp253=(struct Cyc_Absyn_Label_s_struct*)
_tmp22F;if(_tmp253->tag != 13)goto _LL16C;else{_tmp254=_tmp253->f1;_tmp255=_tmp253->f2;}}
_LL16B: if(Cyc_Absynpp_is_declaration(_tmp255)){Cyc_Absyndump_dump_str(_tmp254);
if(expstmt){const char*_tmp494;Cyc_Absyndump_dump_nospace(((_tmp494=": ({",
_tag_dyneither(_tmp494,sizeof(char),5))));}else{const char*_tmp495;Cyc_Absyndump_dump_nospace(((
_tmp495=": {",_tag_dyneither(_tmp495,sizeof(char),4))));}Cyc_Absyndump_dumpstmt(
_tmp255,expstmt);if(expstmt){const char*_tmp496;Cyc_Absyndump_dump_nospace(((
...
Cyc_Absyndump_dumpstmt(_tmp255,expstmt);}goto _LL14F;_LL16C: {struct Cyc_Absyn_Do_s_struct*
_tmp256=(struct Cyc_Absyn_Do_s_struct*)_tmp22F;if(_tmp256->tag != 14)goto _LL16E;
else{_tmp257=_tmp256->f1;_tmp258=_tmp256->f2;_tmp259=_tmp258.f1;}}_LL16D: Cyc_Absyndump_dumploc(
s->loc);{const char*_tmp497;Cyc_Absyndump_dump(((_tmp497="do{",_tag_dyneither(
_tmp497,sizeof(char),4))));}Cyc_Absyndump_dumpstmt(_tmp257,0);{const char*_tmp498;
Cyc_Absyndump_dump_nospace(((_tmp498="}while(",_tag_dyneither(_tmp498,sizeof(
char),8))));}Cyc_Absyndump_dumpexp(_tmp259);{const char*_tmp499;Cyc_Absyndump_dump_nospace(((
_tmp499=");",_tag_dyneither(_tmp499,sizeof(char),3))));}goto _LL14F;_LL16E: {
struct Cyc_Absyn_Fallthru_s_struct*_tmp25A=(struct Cyc_Absyn_Fallthru_s_struct*)
_tmp22F;if(_tmp25A->tag != 11)goto _LL170;else{_tmp25B=_tmp25A->f1;if(_tmp25B != 0)
goto _LL170;}}_LL16F:{const char*_tmp49A;Cyc_Absyndump_dump(((_tmp49A="fallthru;",
_tag_dyneither(_tmp49A,sizeof(char),10))));}goto _LL14F;_LL170: {struct Cyc_Absyn_Fallthru_s_struct*
_tmp25C=(struct Cyc_Absyn_Fallthru_s_struct*)_tmp22F;if(_tmp25C->tag != 11)goto
_LL172;else{_tmp25D=_tmp25C->f1;}}_LL171:{const char*_tmp49B;Cyc_Absyndump_dump(((
...
_tag_dyneither(_tmp49C,sizeof(char),3))));}goto _LL14F;_LL172: {struct Cyc_Absyn_TryCatch_s_struct*
_tmp25E=(struct Cyc_Absyn_TryCatch_s_struct*)_tmp22F;if(_tmp25E->tag != 15)goto
_LL174;else{_tmp25F=_tmp25E->f1;_tmp260=_tmp25E->f2;}}_LL173: Cyc_Absyndump_dumploc(
...
_LL14F;_LL174: {struct Cyc_Absyn_ResetRegion_s_struct*_tmp261=(struct Cyc_Absyn_ResetRegion_s_struct*)
_tmp22F;if(_tmp261->tag != 16)goto _LL14F;else{_tmp262=_tmp261->f1;}}_LL175: Cyc_Absyndump_dumploc(
s->loc);{const char*_tmp49F;Cyc_Absyndump_dump(((_tmp49F="reset_region(",
_tag_dyneither(_tmp49F,sizeof(char),14))));}Cyc_Absyndump_dumpexp(_tmp262);{
const char*_tmp4A0;Cyc_Absyndump_dump(((_tmp4A0=");",_tag_dyneither(_tmp4A0,
...
_tmp4A3;const char*_tmp4A2;const char*_tmp4A1;((void(*)(void(*f)(void*),struct Cyc_List_List*
...
struct Cyc_Absyn_Enumfield*_tmp2CB;struct Cyc_Absyn_Exp*_tmp2CD;_LL187: {struct Cyc_Absyn_Wild_p_struct*
_tmp289=(struct Cyc_Absyn_Wild_p_struct*)_tmp288;if(_tmp289->tag != 0)goto _LL189;}
_LL188: Cyc_Absyndump_dump_char((int)'_');goto _LL186;_LL189: {struct Cyc_Absyn_Null_p_struct*
_tmp28A=(struct Cyc_Absyn_Null_p_struct*)_tmp288;if(_tmp28A->tag != 8)goto _LL18B;}
_LL18A:{const char*_tmp4A4;Cyc_Absyndump_dump(((_tmp4A4="NULL",_tag_dyneither(
_tmp4A4,sizeof(char),5))));}goto _LL186;_LL18B: {struct Cyc_Absyn_Int_p_struct*
_tmp28B=(struct Cyc_Absyn_Int_p_struct*)_tmp288;if(_tmp28B->tag != 9)goto _LL18D;
else{_tmp28C=_tmp28B->f1;if(_tmp28C != Cyc_Absyn_None)goto _LL18D;_tmp28D=_tmp28B->f2;}}
_LL18C: _tmp290=_tmp28D;goto _LL18E;_LL18D: {struct Cyc_Absyn_Int_p_struct*_tmp28E=(
struct Cyc_Absyn_Int_p_struct*)_tmp288;if(_tmp28E->tag != 9)goto _LL18F;else{
_tmp28F=_tmp28E->f1;if(_tmp28F != Cyc_Absyn_Signed)goto _LL18F;_tmp290=_tmp28E->f2;}}
_LL18E:{const char*_tmp4A8;void*_tmp4A7[1];struct Cyc_Int_pa_struct _tmp4A6;Cyc_Absyndump_dump((
struct _dyneither_ptr)((_tmp4A6.tag=1,((_tmp4A6.f1=(unsigned long)_tmp290,((
_tmp4A7[0]=& _tmp4A6,Cyc_aprintf(((_tmp4A8="%d",_tag_dyneither(_tmp4A8,sizeof(
char),3))),_tag_dyneither(_tmp4A7,sizeof(void*),1)))))))));}goto _LL186;_LL18F: {
struct Cyc_Absyn_Int_p_struct*_tmp291=(struct Cyc_Absyn_Int_p_struct*)_tmp288;if(
_tmp291->tag != 9)goto _LL191;else{_tmp292=_tmp291->f1;if(_tmp292 != Cyc_Absyn_Unsigned)
goto _LL191;_tmp293=_tmp291->f2;}}_LL190:{const char*_tmp4AC;void*_tmp4AB[1];
struct Cyc_Int_pa_struct _tmp4AA;Cyc_Absyndump_dump((struct _dyneither_ptr)((
_tmp4AA.tag=1,((_tmp4AA.f1=(unsigned int)_tmp293,((_tmp4AB[0]=& _tmp4AA,Cyc_aprintf(((
_tmp4AC="%u",_tag_dyneither(_tmp4AC,sizeof(char),3))),_tag_dyneither(_tmp4AB,
sizeof(void*),1)))))))));}goto _LL186;_LL191: {struct Cyc_Absyn_Char_p_struct*
_tmp294=(struct Cyc_Absyn_Char_p_struct*)_tmp288;if(_tmp294->tag != 10)goto _LL193;
...
struct Cyc_Absyn_Float_p_struct*_tmp296=(struct Cyc_Absyn_Float_p_struct*)_tmp288;
if(_tmp296->tag != 11)goto _LL195;else{_tmp297=_tmp296->f1;}}_LL194: Cyc_Absyndump_dump(
_tmp297);goto _LL186;_LL195: {struct Cyc_Absyn_Var_p_struct*_tmp298=(struct Cyc_Absyn_Var_p_struct*)
_tmp288;if(_tmp298->tag != 1)goto _LL197;else{_tmp299=_tmp298->f1;_tmp29A=_tmp298->f2;
_tmp29B=*_tmp29A;_tmp29C=_tmp29B.r;{struct Cyc_Absyn_Wild_p_struct*_tmp29D=(
struct Cyc_Absyn_Wild_p_struct*)_tmp29C;if(_tmp29D->tag != 0)goto _LL197;};}}_LL196:
Cyc_Absyndump_dumpqvar(_tmp299->name);goto _LL186;_LL197: {struct Cyc_Absyn_Var_p_struct*
_tmp29E=(struct Cyc_Absyn_Var_p_struct*)_tmp288;if(_tmp29E->tag != 1)goto _LL199;
...
_LL186;_LL199: {struct Cyc_Absyn_Tuple_p_struct*_tmp2A1=(struct Cyc_Absyn_Tuple_p_struct*)
...
_LL19B: {struct Cyc_Absyn_Pointer_p_struct*_tmp2A4=(struct Cyc_Absyn_Pointer_p_struct*)
...
2))));}Cyc_Absyndump_dumppat(_tmp2A5);goto _LL186;_LL19D: {struct Cyc_Absyn_Reference_p_struct*
_tmp2A6=(struct Cyc_Absyn_Reference_p_struct*)_tmp288;if(_tmp2A6->tag != 2)goto
_LL19F;else{_tmp2A7=_tmp2A6->f1;_tmp2A8=_tmp2A6->f2;_tmp2A9=*_tmp2A8;_tmp2AA=
_tmp2A9.r;{struct Cyc_Absyn_Wild_p_struct*_tmp2AB=(struct Cyc_Absyn_Wild_p_struct*)
_tmp2AA;if(_tmp2AB->tag != 0)goto _LL19F;};}}_LL19E:{const char*_tmp4B5;Cyc_Absyndump_dump(((
_tmp4B5="*",_tag_dyneither(_tmp4B5,sizeof(char),2))));}Cyc_Absyndump_dumpqvar(
_tmp2A7->name);goto _LL186;_LL19F: {struct Cyc_Absyn_Reference_p_struct*_tmp2AC=(
struct Cyc_Absyn_Reference_p_struct*)_tmp288;if(_tmp2AC->tag != 2)goto _LL1A1;else{
_tmp2AD=_tmp2AC->f1;_tmp2AE=_tmp2AC->f2;}}_LL1A0:{const char*_tmp4B6;Cyc_Absyndump_dump(((
_tmp4B6="*",_tag_dyneither(_tmp4B6,sizeof(char),2))));}Cyc_Absyndump_dumpqvar(
_tmp2AD->name);{const char*_tmp4B7;Cyc_Absyndump_dump(((_tmp4B7=" as ",
_tag_dyneither(_tmp4B7,sizeof(char),5))));}Cyc_Absyndump_dumppat(_tmp2AE);goto
_LL186;_LL1A1: {struct Cyc_Absyn_TagInt_p_struct*_tmp2AF=(struct Cyc_Absyn_TagInt_p_struct*)
_tmp288;if(_tmp2AF->tag != 3)goto _LL1A3;else{_tmp2B0=_tmp2AF->f1;_tmp2B1=_tmp2AF->f2;}}
_LL1A2: Cyc_Absyndump_dumpqvar(_tmp2B1->name);Cyc_Absyndump_dump_char((int)'<');
Cyc_Absyndump_dumptvar(_tmp2B0);Cyc_Absyndump_dump_char((int)'>');goto _LL186;
_LL1A3: {struct Cyc_Absyn_UnknownId_p_struct*_tmp2B2=(struct Cyc_Absyn_UnknownId_p_struct*)
_tmp288;if(_tmp2B2->tag != 14)goto _LL1A5;else{_tmp2B3=_tmp2B2->f1;}}_LL1A4: Cyc_Absyndump_dumpqvar(
_tmp2B3);goto _LL186;_LL1A5: {struct Cyc_Absyn_UnknownCall_p_struct*_tmp2B4=(
struct Cyc_Absyn_UnknownCall_p_struct*)_tmp288;if(_tmp2B4->tag != 15)goto _LL1A7;
else{_tmp2B5=_tmp2B4->f1;_tmp2B6=_tmp2B4->f2;_tmp2B7=_tmp2B4->f3;}}_LL1A6: {
const char*_tmp4B9;const char*_tmp4B8;struct _dyneither_ptr term=_tmp2B7?(_tmp4B9=", ...)",
_tag_dyneither(_tmp4B9,sizeof(char),7)):((_tmp4B8=")",_tag_dyneither(_tmp4B8,
sizeof(char),2)));Cyc_Absyndump_dumpqvar(_tmp2B5);{const char*_tmp4BB;const char*
_tmp4BA;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct
_dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumppat,_tmp2B6,((_tmp4BA="(",_tag_dyneither(_tmp4BA,sizeof(char),
2))),term,((_tmp4BB=",",_tag_dyneither(_tmp4BB,sizeof(char),2))));}goto _LL186;}
_LL1A7: {struct Cyc_Absyn_Aggr_p_struct*_tmp2B8=(struct Cyc_Absyn_Aggr_p_struct*)
_tmp288;if(_tmp2B8->tag != 6)goto _LL1A9;else{_tmp2B9=_tmp2B8->f1;if(_tmp2B9 == 0)
goto _LL1A9;_tmp2BA=*_tmp2B9;_tmp2BB=_tmp2BA.aggr_info;_tmp2BC=_tmp2B8->f2;
_tmp2BD=_tmp2B8->f3;_tmp2BE=_tmp2B8->f4;}}_LL1A8: {struct _tuple0*_tmp2E5;struct
_tuple10 _tmp2E4=Cyc_Absyn_aggr_kinded_name(_tmp2BB);_tmp2E5=_tmp2E4.f2;{const
char*_tmp4BD;const char*_tmp4BC;struct _dyneither_ptr term=_tmp2BE?(_tmp4BD=", ...)",
_tag_dyneither(_tmp4BD,sizeof(char),7)):((_tmp4BC=")",_tag_dyneither(_tmp4BC,
sizeof(char),2)));Cyc_Absyndump_dumpqvar(_tmp2E5);Cyc_Absyndump_dump_char((int)'{');{
const char*_tmp4C0;const char*_tmp4BF;const char*_tmp4BE;((void(*)(void(*f)(struct
...
_tmp2BC,((_tmp4BE="[",_tag_dyneither(_tmp4BE,sizeof(char),2))),((_tmp4BF="]",
_tag_dyneither(_tmp4BF,sizeof(char),2))),((_tmp4C0=",",_tag_dyneither(_tmp4C0,
sizeof(char),2))));}{const char*_tmp4C2;const char*_tmp4C1;((void(*)(void(*f)(
...
_tag_dyneither(_tmp4C2,sizeof(char),2))));}goto _LL186;};}_LL1A9: {struct Cyc_Absyn_Aggr_p_struct*
_tmp2BF=(struct Cyc_Absyn_Aggr_p_struct*)_tmp288;if(_tmp2BF->tag != 6)goto _LL1AB;
else{_tmp2C0=_tmp2BF->f1;if(_tmp2C0 != 0)goto _LL1AB;_tmp2C1=_tmp2BF->f2;_tmp2C2=
_tmp2BF->f3;_tmp2C3=_tmp2BF->f4;}}_LL1AA: {const char*_tmp4C4;const char*_tmp4C3;
struct _dyneither_ptr term=_tmp2C3?(_tmp4C4=", ...)",_tag_dyneither(_tmp4C4,
sizeof(char),7)):((_tmp4C3=")",_tag_dyneither(_tmp4C3,sizeof(char),2)));Cyc_Absyndump_dump_char((
int)'{');{const char*_tmp4C7;const char*_tmp4C6;const char*_tmp4C5;((void(*)(void(*
f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct
_dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,
_tmp2C1,((_tmp4C5="[",_tag_dyneither(_tmp4C5,sizeof(char),2))),((_tmp4C6="]",
...
_tag_dyneither(_tmp4C9,sizeof(char),2))));}goto _LL186;}_LL1AB: {struct Cyc_Absyn_Datatype_p_struct*
_tmp2C4=(struct Cyc_Absyn_Datatype_p_struct*)_tmp288;if(_tmp2C4->tag != 7)goto
_LL1AD;else{_tmp2C5=_tmp2C4->f2;_tmp2C6=_tmp2C4->f3;_tmp2C7=_tmp2C4->f4;}}_LL1AC: {
const char*_tmp4CB;const char*_tmp4CA;struct _dyneither_ptr term=_tmp2C7?(_tmp4CB=", ...)",
_tag_dyneither(_tmp4CB,sizeof(char),7)):((_tmp4CA=")",_tag_dyneither(_tmp4CA,
sizeof(char),2)));Cyc_Absyndump_dumpqvar(_tmp2C5->name);if(_tmp2C6 != 0){const
char*_tmp4CD;const char*_tmp4CC;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct
Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct
...
_tmp4CD,sizeof(char),2))));}goto _LL186;}_LL1AD: {struct Cyc_Absyn_Enum_p_struct*
_tmp2C8=(struct Cyc_Absyn_Enum_p_struct*)_tmp288;if(_tmp2C8->tag != 12)goto _LL1AF;
else{_tmp2C9=_tmp2C8->f2;}}_LL1AE: _tmp2CB=_tmp2C9;goto _LL1B0;_LL1AF: {struct Cyc_Absyn_AnonEnum_p_struct*
_tmp2CA=(struct Cyc_Absyn_AnonEnum_p_struct*)_tmp288;if(_tmp2CA->tag != 13)goto
_LL1B1;else{_tmp2CB=_tmp2CA->f2;}}_LL1B0: Cyc_Absyndump_dumpqvar(_tmp2CB->name);
goto _LL186;_LL1B1: {struct Cyc_Absyn_Exp_p_struct*_tmp2CC=(struct Cyc_Absyn_Exp_p_struct*)
_tmp288;if(_tmp2CC->tag != 16)goto _LL186;else{_tmp2CD=_tmp2CC->f1;}}_LL1B2: Cyc_Absyndump_dumpexp(
_tmp2CD);goto _LL186;_LL186:;}void Cyc_Absyndump_dumpdatatypefield(struct Cyc_Absyn_Datatypefield*
...
_tmp302=(*pr).f1;_LL1B7: {struct Cyc_Absyn_Unused_att_struct*_tmp303=(struct Cyc_Absyn_Unused_att_struct*)
_tmp302;if(_tmp303->tag != 11)goto _LL1B9;}_LL1B8: goto _LL1B6;_LL1B9: {struct Cyc_Absyn_Stdcall_att_struct*
_tmp304=(struct Cyc_Absyn_Stdcall_att_struct*)_tmp302;if(_tmp304->tag != 1)goto
_LL1BB;}_LL1BA:{const char*_tmp4D1;Cyc_Absyndump_dump(((_tmp4D1="_stdcall",
_tag_dyneither(_tmp4D1,sizeof(char),9))));}goto _LL1B6;_LL1BB: {struct Cyc_Absyn_Cdecl_att_struct*
_tmp305=(struct Cyc_Absyn_Cdecl_att_struct*)_tmp302;if(_tmp305->tag != 2)goto
_LL1BD;}_LL1BC:{const char*_tmp4D2;Cyc_Absyndump_dump(((_tmp4D2="_cdecl",
_tag_dyneither(_tmp4D2,sizeof(char),7))));}goto _LL1B6;_LL1BD: {struct Cyc_Absyn_Fastcall_att_struct*
_tmp306=(struct Cyc_Absyn_Fastcall_att_struct*)_tmp302;if(_tmp306->tag != 3)goto
_LL1BF;}_LL1BE:{const char*_tmp4D3;Cyc_Absyndump_dump(((_tmp4D3="_fastcall",
...
Cyc_Tcutil_compress(_tmp30F);_LL1C4: {struct Cyc_Absyn_FnType_struct*_tmp313=(
struct Cyc_Absyn_FnType_struct*)_tmp312;if(_tmp313->tag != 9)goto _LL1C6;}_LL1C5:
goto _LL1C3;_LL1C6:;_LL1C7: Cyc_Absyndump_dumpscope(_tmp30C);_LL1C3:;}else{Cyc_Absyndump_dumpscope(
_tmp30C);}((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct _tuple0*),struct
_tuple0*))Cyc_Absyndump_dumptqtd)(_tmp30E,_tmp30F,Cyc_Absyndump_dumpqvar,_tmp30D);
Cyc_Absyndump_dumpatts(_tmp311);break;case Cyc_Cyclone_Vc_c: _LL1C2: Cyc_Absyndump_dumpatts(
_tmp311);Cyc_Absyndump_dumpscope(_tmp30C);{struct _RegionHandle _tmp314=
_new_region("temp");struct _RegionHandle*temp=& _tmp314;_push_region(temp);{struct
Cyc_Absyn_Tqual _tmp316;void*_tmp317;struct Cyc_List_List*_tmp318;struct _tuple11
_tmp315=Cyc_Absynpp_to_tms(temp,_tmp30E,_tmp30F);_tmp316=_tmp315.f1;_tmp317=
_tmp315.f2;_tmp318=_tmp315.f3;{void*call_conv=(void*)& Cyc_Absyn_Unused_att_val;{
struct Cyc_List_List*tms2=_tmp318;for(0;tms2 != 0;tms2=tms2->tl){void*_tmp319=(
void*)tms2->hd;struct Cyc_List_List*_tmp31B;_LL1CA: {struct Cyc_Absyn_Attributes_mod_struct*
_tmp31A=(struct Cyc_Absyn_Attributes_mod_struct*)_tmp319;if(_tmp31A->tag != 5)goto
_LL1CC;else{_tmp31B=_tmp31A->f2;}}_LL1CB: for(0;_tmp31B != 0;_tmp31B=_tmp31B->tl){
void*_tmp31C=(void*)_tmp31B->hd;_LL1CF: {struct Cyc_Absyn_Stdcall_att_struct*
_tmp31D=(struct Cyc_Absyn_Stdcall_att_struct*)_tmp31C;if(_tmp31D->tag != 1)goto
_LL1D1;}_LL1D0: call_conv=(void*)& Cyc_Absyn_Stdcall_att_val;goto _LL1CE;_LL1D1: {
struct Cyc_Absyn_Cdecl_att_struct*_tmp31E=(struct Cyc_Absyn_Cdecl_att_struct*)
_tmp31C;if(_tmp31E->tag != 2)goto _LL1D3;}_LL1D2: call_conv=(void*)& Cyc_Absyn_Cdecl_att_val;
goto _LL1CE;_LL1D3: {struct Cyc_Absyn_Fastcall_att_struct*_tmp31F=(struct Cyc_Absyn_Fastcall_att_struct*)
_tmp31C;if(_tmp31F->tag != 3)goto _LL1D5;}_LL1D4: call_conv=(void*)& Cyc_Absyn_Fastcall_att_val;
goto _LL1CE;_LL1D5:;_LL1D6: goto _LL1CE;_LL1CE:;}goto _LL1C9;_LL1CC:;_LL1CD: goto
_LL1C9;_LL1C9:;}}Cyc_Absyndump_dumptq(_tmp316);Cyc_Absyndump_dumpntyp(_tmp317);{
struct _tuple18 _tmp4D4;struct _tuple18 _tmp320=(_tmp4D4.f1=call_conv,((_tmp4D4.f2=
_tmp30D,_tmp4D4)));((void(*)(struct Cyc_List_List*tms,void(*f)(struct _tuple18*),
struct _tuple18*a))Cyc_Absyndump_dumptms)(((struct Cyc_List_List*(*)(struct Cyc_List_List*
x))Cyc_List_imp_rev)(_tmp318),Cyc_Absyndump_dump_callconv_qvar,& _tmp320);};};}
_npop_handler(0);break;;_pop_region(temp);};}if(_tmp310 != 0){Cyc_Absyndump_dump_char((
...
_tmp35B;struct Cyc_List_List*_tmp35C;_LL1D8: {struct Cyc_Absyn_Var_d_struct*
_tmp338=(struct Cyc_Absyn_Var_d_struct*)_tmp337;if(_tmp338->tag != 0)goto _LL1DA;
else{_tmp339=_tmp338->f1;}}_LL1D9: Cyc_Absyndump_dumpvardecl(_tmp339,d->loc);goto
_LL1D7;_LL1DA: {struct Cyc_Absyn_Fn_d_struct*_tmp33A=(struct Cyc_Absyn_Fn_d_struct*)
_tmp337;if(_tmp33A->tag != 1)goto _LL1DC;else{_tmp33B=_tmp33A->f1;}}_LL1DB: Cyc_Absyndump_dumploc(
...
struct Cyc_Absyn_FnType_struct _tmp4E5;struct Cyc_Absyn_FnInfo _tmp4E4;struct Cyc_Absyn_FnType_struct*
_tmp4E3;void*t=(void*)((_tmp4E3=_cycalloc(sizeof(*_tmp4E3)),((_tmp4E3[0]=((
_tmp4E5.tag=9,((_tmp4E5.f1=((_tmp4E4.tvars=_tmp33B->tvs,((_tmp4E4.effect=_tmp33B->effect,((
_tmp4E4.ret_tqual=_tmp33B->ret_tqual,((_tmp4E4.ret_typ=_tmp33B->ret_type,((
_tmp4E4.args=((struct Cyc_List_List*(*)(struct _tuple8*(*f)(struct _tuple8*),struct
Cyc_List_List*x))Cyc_List_map)(Cyc_Absynpp_arg_mk_opt,_tmp33B->args),((_tmp4E4.c_varargs=
_tmp33B->c_varargs,((_tmp4E4.cyc_varargs=_tmp33B->cyc_varargs,((_tmp4E4.rgn_po=
_tmp33B->rgn_po,((_tmp4E4.attributes=0,_tmp4E4)))))))))))))))))),_tmp4E5)))),
_tmp4E3))));switch(Cyc_Cyclone_c_compiler){case Cyc_Cyclone_Gcc_c: _LL200:((void(*)(
...
_tmp33B);break;case Cyc_Cyclone_Vc_c: _LL201:((void(*)(struct Cyc_Absyn_Tqual,void*,
void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*))Cyc_Absyndump_dumptqtd)(
Cyc_Absyn_empty_tqual(0),t,Cyc_Absyndump_dump_callconv_fdqvar,_tmp33B);break;}
Cyc_Absyndump_dump_char((int)'{');Cyc_Absyndump_dumpstmt(_tmp33B->body,0);Cyc_Absyndump_dump_char((
int)'}');goto _LL1D7;};_LL1DC: {struct Cyc_Absyn_Aggr_d_struct*_tmp33C=(struct Cyc_Absyn_Aggr_d_struct*)
_tmp337;if(_tmp33C->tag != 6)goto _LL1DE;else{_tmp33D=_tmp33C->f1;}}_LL1DD: Cyc_Absyndump_dump_aggrdecl(
_tmp33D);Cyc_Absyndump_dump_semi();goto _LL1D7;_LL1DE: {struct Cyc_Absyn_Datatype_d_struct*
_tmp33E=(struct Cyc_Absyn_Datatype_d_struct*)_tmp337;if(_tmp33E->tag != 7)goto
_LL1E0;else{_tmp33F=_tmp33E->f1;}}_LL1DF: Cyc_Absyndump_dump_datatypedecl(_tmp33F);
Cyc_Absyndump_dump_semi();goto _LL1D7;_LL1E0: {struct Cyc_Absyn_Enum_d_struct*
_tmp340=(struct Cyc_Absyn_Enum_d_struct*)_tmp337;if(_tmp340->tag != 8)goto _LL1E2;
else{_tmp341=_tmp340->f1;}}_LL1E1: Cyc_Absyndump_dump_enumdecl(_tmp341);Cyc_Absyndump_dump_semi();
goto _LL1D7;_LL1E2: {struct Cyc_Absyn_Let_d_struct*_tmp342=(struct Cyc_Absyn_Let_d_struct*)
_tmp337;if(_tmp342->tag != 2)goto _LL1E4;else{_tmp343=_tmp342->f1;_tmp344=_tmp342->f3;}}
_LL1E3:{const char*_tmp4E6;Cyc_Absyndump_dump(((_tmp4E6="let",_tag_dyneither(
_tmp4E6,sizeof(char),4))));}Cyc_Absyndump_dumppat(_tmp343);Cyc_Absyndump_dump_char((
int)'=');Cyc_Absyndump_dumpexp(_tmp344);Cyc_Absyndump_dump_semi();goto _LL1D7;
_LL1E4: {struct Cyc_Absyn_Letv_d_struct*_tmp345=(struct Cyc_Absyn_Letv_d_struct*)
_tmp337;if(_tmp345->tag != 3)goto _LL1E6;else{_tmp346=_tmp345->f1;}}_LL1E5:{const
char*_tmp4E7;Cyc_Absyndump_dump(((_tmp4E7="let ",_tag_dyneither(_tmp4E7,sizeof(
char),5))));}Cyc_Absyndump_dumpids(_tmp346);Cyc_Absyndump_dump_semi();goto _LL1D7;
_LL1E6: {struct Cyc_Absyn_Region_d_struct*_tmp347=(struct Cyc_Absyn_Region_d_struct*)
_tmp337;if(_tmp347->tag != 4)goto _LL1E8;else{_tmp348=_tmp347->f1;_tmp349=_tmp347->f2;
_tmp34A=_tmp347->f3;_tmp34B=_tmp347->f4;}}_LL1E7:{const char*_tmp4E8;Cyc_Absyndump_dump(((
_tmp4E8="region",_tag_dyneither(_tmp4E8,sizeof(char),7))));}{const char*_tmp4E9;
Cyc_Absyndump_dump(((_tmp4E9="<",_tag_dyneither(_tmp4E9,sizeof(char),2))));}Cyc_Absyndump_dumptvar(
...
_LL1D7;_LL1E8: {struct Cyc_Absyn_Alias_d_struct*_tmp34C=(struct Cyc_Absyn_Alias_d_struct*)
...
struct Cyc_Absyn_Typedef_d_struct*_tmp350=(struct Cyc_Absyn_Typedef_d_struct*)
...
_tmp351->atts);Cyc_Absyndump_dump_semi();goto _LL1D7;};_LL1EC: {struct Cyc_Absyn_Namespace_d_struct*
_tmp352=(struct Cyc_Absyn_Namespace_d_struct*)_tmp337;if(_tmp352->tag != 10)goto
_LL1EE;else{_tmp353=_tmp352->f1;_tmp354=_tmp352->f2;}}_LL1ED:{const char*_tmp4F3;
Cyc_Absyndump_dump(((_tmp4F3="namespace",_tag_dyneither(_tmp4F3,sizeof(char),10))));}
Cyc_Absyndump_dump_str(_tmp353);Cyc_Absyndump_dump_char((int)'{');for(0;_tmp354
!= 0;_tmp354=_tmp354->tl){Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp354->hd);}
Cyc_Absyndump_dump_char((int)'}');goto _LL1D7;_LL1EE: {struct Cyc_Absyn_Using_d_struct*
_tmp355=(struct Cyc_Absyn_Using_d_struct*)_tmp337;if(_tmp355->tag != 11)goto _LL1F0;
else{_tmp356=_tmp355->f1;_tmp357=_tmp355->f2;}}_LL1EF:{const char*_tmp4F4;Cyc_Absyndump_dump(((
_tmp4F4="using",_tag_dyneither(_tmp4F4,sizeof(char),6))));}Cyc_Absyndump_dumpqvar(
_tmp356);Cyc_Absyndump_dump_char((int)'{');for(0;_tmp357 != 0;_tmp357=_tmp357->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp357->hd);}Cyc_Absyndump_dump_char((
int)'}');goto _LL1D7;_LL1F0: {struct Cyc_Absyn_ExternC_d_struct*_tmp358=(struct Cyc_Absyn_ExternC_d_struct*)
...
_LL1F2: {struct Cyc_Absyn_ExternCinclude_d_struct*_tmp35A=(struct Cyc_Absyn_ExternCinclude_d_struct*)
_tmp337;if(_tmp35A->tag != 13)goto _LL1F4;else{_tmp35B=_tmp35A->f1;_tmp35C=_tmp35A->f2;}}
_LL1F3:{const char*_tmp4F6;Cyc_Absyndump_dump(((_tmp4F6="extern \"C include\" {",
_tag_dyneither(_tmp4F6,sizeof(char),21))));}for(0;_tmp35B != 0;_tmp35B=_tmp35B->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp35B->hd);}Cyc_Absyndump_dump_char((
int)'}');if(_tmp35C != 0){{const char*_tmp4F7;Cyc_Absyndump_dump(((_tmp4F7=" export {",
_tag_dyneither(_tmp4F7,sizeof(char),10))));}for(0;_tmp35C != 0;_tmp35C=_tmp35C->tl){
struct _tuple0*_tmp378;struct _tuple19 _tmp377=*((struct _tuple19*)_tmp35C->hd);
_tmp378=_tmp377.f2;Cyc_Absyndump_dumpqvar(_tmp378);if(_tmp35C->tl != 0)Cyc_Absyndump_dump_char((
int)',');}{const char*_tmp4F8;Cyc_Absyndump_dump(((_tmp4F8="}",_tag_dyneither(
_tmp4F8,sizeof(char),2))));};}goto _LL1D7;_LL1F4: {struct Cyc_Absyn_Porton_d_struct*
_tmp35D=(struct Cyc_Absyn_Porton_d_struct*)_tmp337;if(_tmp35D->tag != 14)goto
_LL1F6;}_LL1F5:{const char*_tmp4F9;Cyc_Absyndump_dump(((_tmp4F9=" __cyclone_port_on__; ",
_tag_dyneither(_tmp4F9,sizeof(char),23))));}goto _LL1D7;_LL1F6: {struct Cyc_Absyn_Portoff_d_struct*
_tmp35E=(struct Cyc_Absyn_Portoff_d_struct*)_tmp337;if(_tmp35E->tag != 15)goto
_LL1D7;}_LL1F7:{const char*_tmp4FA;Cyc_Absyndump_dump(((_tmp4FA=" __cyclone_port_off__; ",
...
struct Cyc_Absyn_Pointer_mod_struct*_tmp37D=(struct Cyc_Absyn_Pointer_mod_struct*)
...
_tmp387;_LL209: {struct Cyc_Absyn_DynEither_b_struct*_tmp385=(struct Cyc_Absyn_DynEither_b_struct*)
_tmp384;if(_tmp385->tag != 0)goto _LL20B;}_LL20A: Cyc_Absyndump_dump_char((int)'?');
goto _LL208;_LL20B: {struct Cyc_Absyn_Upper_b_struct*_tmp386=(struct Cyc_Absyn_Upper_b_struct*)
_tmp384;if(_tmp386->tag != 1)goto _LL208;else{_tmp387=_tmp386->f1;}}_LL20C: Cyc_Absyndump_dump_char((
int)(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(1,_tmp380)?'*':'@'));
...
_tmp390;_LL20E: {struct Cyc_Absyn_HeapRgn_struct*_tmp38A=(struct Cyc_Absyn_HeapRgn_struct*)
_tmp389;if(_tmp38A->tag != 20)goto _LL210;}_LL20F: goto _LL20D;_LL210: {struct Cyc_Absyn_UniqueRgn_struct*
_tmp38B=(struct Cyc_Absyn_UniqueRgn_struct*)_tmp389;if(_tmp38B->tag != 21)goto
_LL212;}_LL211:{const char*_tmp4FC;Cyc_Absyndump_dump(((_tmp4FC="`U",
_tag_dyneither(_tmp4FC,sizeof(char),3))));}goto _LL20D;_LL212: {struct Cyc_Absyn_RefCntRgn_struct*
_tmp38C=(struct Cyc_Absyn_RefCntRgn_struct*)_tmp389;if(_tmp38C->tag != 22)goto
_LL214;}_LL213:{const char*_tmp4FD;Cyc_Absyndump_dump(((_tmp4FD="`RC",
_tag_dyneither(_tmp4FD,sizeof(char),4))));}goto _LL20D;_LL214: {struct Cyc_Absyn_VarType_struct*
_tmp38D=(struct Cyc_Absyn_VarType_struct*)_tmp389;if(_tmp38D->tag != 2)goto _LL216;
else{_tmp38E=_tmp38D->f1;}}_LL215: Cyc_Absyndump_dump_str(_tmp38E->name);goto
_LL20D;_LL216: {struct Cyc_Absyn_Evar_struct*_tmp38F=(struct Cyc_Absyn_Evar_struct*)
...
_tmp37F));goto _LL20D;_LL218: {struct Cyc_Absyn_TypedefType_struct*_tmp391=(struct
Cyc_Absyn_TypedefType_struct*)_tmp389;if(_tmp391->tag != 17)goto _LL21A;}_LL219:{
const char*_tmp4FE;Cyc_Absyndump_dump(((_tmp4FE="@region(",_tag_dyneither(_tmp4FE,
sizeof(char),9))));}Cyc_Absyndump_dumptyp(_tmp37F);{const char*_tmp4FF;Cyc_Absyndump_dump(((
_tmp4FF=")",_tag_dyneither(_tmp4FF,sizeof(char),2))));}goto _LL20D;_LL21A:;_LL21B: {
const char*_tmp502;void*_tmp501;(_tmp501=0,Cyc_Tcutil_impos(((_tmp502="dumptms: bad rgn type in Pointer_mod",
_tag_dyneither(_tmp502,sizeof(char),37))),_tag_dyneither(_tmp501,sizeof(void*),0)));}
_LL20D:;}Cyc_Absyndump_dumptq(_tmp383);Cyc_Absyndump_dumptms(tms->tl,f,a);
return;_LL206:;_LL207: {int next_is_pointer=0;if(tms->tl != 0){void*_tmp398=(void*)((
struct Cyc_List_List*)_check_null(tms->tl))->hd;_LL21D: {struct Cyc_Absyn_Pointer_mod_struct*
_tmp399=(struct Cyc_Absyn_Pointer_mod_struct*)_tmp398;if(_tmp399->tag != 2)goto
_LL21F;}_LL21E: next_is_pointer=1;goto _LL21C;_LL21F:;_LL220: goto _LL21C;_LL21C:;}
if(next_is_pointer)Cyc_Absyndump_dump_char((int)'(');Cyc_Absyndump_dumptms(tms->tl,
f,a);if(next_is_pointer)Cyc_Absyndump_dump_char((int)')');{void*_tmp39A=(void*)
tms->hd;union Cyc_Absyn_Constraint*_tmp39C;struct Cyc_Absyn_Exp*_tmp39E;union Cyc_Absyn_Constraint*
_tmp39F;void*_tmp3A1;struct Cyc_List_List*_tmp3A3;int _tmp3A4;struct Cyc_Absyn_VarargInfo*
_tmp3A5;void*_tmp3A6;struct Cyc_List_List*_tmp3A7;void*_tmp3A9;struct Cyc_List_List*
_tmp3AB;unsigned int _tmp3AC;struct Cyc_List_List*_tmp3AE;unsigned int _tmp3AF;int
_tmp3B0;struct Cyc_List_List*_tmp3B2;_LL222: {struct Cyc_Absyn_Carray_mod_struct*
_tmp39B=(struct Cyc_Absyn_Carray_mod_struct*)_tmp39A;if(_tmp39B->tag != 0)goto
_LL224;else{_tmp39C=_tmp39B->f1;}}_LL223:{const char*_tmp503;Cyc_Absyndump_dump(((
_tmp503="[]",_tag_dyneither(_tmp503,sizeof(char),3))));}if(((int(*)(int y,union
Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp39C)){const char*_tmp504;Cyc_Absyndump_dump(((
_tmp504="@zeroterm",_tag_dyneither(_tmp504,sizeof(char),10))));}goto _LL221;
_LL224: {struct Cyc_Absyn_ConstArray_mod_struct*_tmp39D=(struct Cyc_Absyn_ConstArray_mod_struct*)
_tmp39A;if(_tmp39D->tag != 1)goto _LL226;else{_tmp39E=_tmp39D->f1;_tmp39F=_tmp39D->f2;}}
...
_tag_dyneither(_tmp505,sizeof(char),10))));}goto _LL221;_LL226: {struct Cyc_Absyn_Function_mod_struct*
_tmp3A0=(struct Cyc_Absyn_Function_mod_struct*)_tmp39A;if(_tmp3A0->tag != 3)goto
_LL228;else{_tmp3A1=(void*)_tmp3A0->f1;{struct Cyc_Absyn_WithTypes_struct*_tmp3A2=(
struct Cyc_Absyn_WithTypes_struct*)_tmp3A1;if(_tmp3A2->tag != 1)goto _LL228;else{
_tmp3A3=_tmp3A2->f1;_tmp3A4=_tmp3A2->f2;_tmp3A5=_tmp3A2->f3;_tmp3A6=(void*)
_tmp3A2->f4;_tmp3A7=_tmp3A2->f5;}};}}_LL227: Cyc_Absyndump_dumpfunargs(_tmp3A3,
_tmp3A4,_tmp3A5,_tmp3A6,_tmp3A7);goto _LL221;_LL228: {struct Cyc_Absyn_Function_mod_struct*
_tmp3A8=(struct Cyc_Absyn_Function_mod_struct*)_tmp39A;if(_tmp3A8->tag != 3)goto
_LL22A;else{_tmp3A9=(void*)_tmp3A8->f1;{struct Cyc_Absyn_NoTypes_struct*_tmp3AA=(
struct Cyc_Absyn_NoTypes_struct*)_tmp3A9;if(_tmp3AA->tag != 0)goto _LL22A;else{
_tmp3AB=_tmp3AA->f1;_tmp3AC=_tmp3AA->f2;}};}}_LL229:{const char*_tmp508;const char*
_tmp507;const char*_tmp506;((void(*)(void(*f)(struct _dyneither_ptr*),struct Cyc_List_List*
l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dump_str,_tmp3AB,((_tmp506="(",_tag_dyneither(_tmp506,sizeof(char),
2))),((_tmp507=")",_tag_dyneither(_tmp507,sizeof(char),2))),((_tmp508=",",
_tag_dyneither(_tmp508,sizeof(char),2))));}goto _LL221;_LL22A: {struct Cyc_Absyn_TypeParams_mod_struct*
_tmp3AD=(struct Cyc_Absyn_TypeParams_mod_struct*)_tmp39A;if(_tmp3AD->tag != 4)goto
_LL22C;else{_tmp3AE=_tmp3AD->f1;_tmp3AF=_tmp3AD->f2;_tmp3B0=_tmp3AD->f3;}}_LL22B:
if(_tmp3B0)Cyc_Absyndump_dumpkindedtvars(_tmp3AE);else{Cyc_Absyndump_dumptvars(
_tmp3AE);}goto _LL221;_LL22C: {struct Cyc_Absyn_Attributes_mod_struct*_tmp3B1=(
struct Cyc_Absyn_Attributes_mod_struct*)_tmp39A;if(_tmp3B1->tag != 5)goto _LL22E;
else{_tmp3B2=_tmp3B1->f2;}}_LL22D: Cyc_Absyndump_dumpatts(_tmp3B2);goto _LL221;
_LL22E: {struct Cyc_Absyn_Pointer_mod_struct*_tmp3B3=(struct Cyc_Absyn_Pointer_mod_struct*)
_tmp39A;if(_tmp3B3->tag != 2)goto _LL221;}_LL22F: {const char*_tmp50B;void*_tmp50A;(
_tmp50A=0,Cyc_Tcutil_impos(((_tmp50B="dumptms",_tag_dyneither(_tmp50B,sizeof(
char),8))),_tag_dyneither(_tmp50A,sizeof(void*),0)));}_LL221:;}return;}_LL203:;};}
void Cyc_Absyndump_dumptqtd(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(void*),void*a){
struct _RegionHandle _tmp3BC=_new_region("temp");struct _RegionHandle*temp=& _tmp3BC;
_push_region(temp);{struct Cyc_Absyn_Tqual _tmp3BE;void*_tmp3BF;struct Cyc_List_List*
_tmp3C0;struct _tuple11 _tmp3BD=Cyc_Absynpp_to_tms(temp,tq,t);_tmp3BE=_tmp3BD.f1;
_tmp3BF=_tmp3BD.f2;_tmp3C0=_tmp3BD.f3;Cyc_Absyndump_dumptq(_tmp3BE);Cyc_Absyndump_dumpntyp(
_tmp3BF);Cyc_Absyndump_dumptms(((struct Cyc_List_List*(*)(struct Cyc_List_List*x))
Cyc_List_imp_rev)(_tmp3C0),f,a);};_pop_region(temp);}void Cyc_Absyndump_dumpdecllist2file(
