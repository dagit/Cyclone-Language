...
const char*_tmp39F;void*_tmp39E;(_tmp39E=0,Cyc_fprintf(*Cyc_Absyndump_dump_file,((_tmp39F="\n",_tag_dyneither(_tmp39F,sizeof(char),2))),_tag_dyneither(_tmp39E,sizeof(void*),0)));}else{
if((char*)_tmp1.curr == (char*)last_file.curr){
const char*_tmp3A3;void*_tmp3A2[1];struct Cyc_Int_pa_PrintArg_struct _tmp3A1;(_tmp3A1.tag=1,((_tmp3A1.f1=(unsigned long)((int)_tmp2),((_tmp3A2[0]=& _tmp3A1,Cyc_fprintf(*Cyc_Absyndump_dump_file,((_tmp3A3="\n# %d\n",_tag_dyneither(_tmp3A3,sizeof(char),7))),_tag_dyneither(_tmp3A2,sizeof(void*),1)))))));}else{
# 168
const char*_tmp3A8;void*_tmp3A7[2];struct Cyc_Int_pa_PrintArg_struct _tmp3A6;struct Cyc_String_pa_PrintArg_struct _tmp3A5;(_tmp3A5.tag=0,((_tmp3A5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp1),((_tmp3A6.tag=1,((_tmp3A6.f1=(unsigned long)((int)_tmp2),((_tmp3A7[0]=& _tmp3A6,((_tmp3A7[1]=& _tmp3A5,Cyc_fprintf(*Cyc_Absyndump_dump_file,((_tmp3A8="\n# %d %s\n",_tag_dyneither(_tmp3A8,sizeof(char),10))),_tag_dyneither(_tmp3A7,sizeof(void*),2)))))))))))));}}
# 170
last_file=_tmp1;
last_line=_tmp2;};}
# 176
...
# 252
if(Cyc_Absyndump_qvar_to_Cids)Cyc_Absyndump_dump_char((int)'_');else{
const char*_tmp3AA;Cyc_Absyndump_dump_nospace(((_tmp3AA="::",_tag_dyneither(_tmp3AA,sizeof(char),3))));}
Cyc_Absyndump_dump_nospace(*((struct _dyneither_ptr*)_tmpD->hd));}
# 256
if(Cyc_Absyndump_qvar_to_Cids){const char*_tmp3AB;Cyc_Absyndump_dump_nospace(((_tmp3AB="_",_tag_dyneither(_tmp3AB,sizeof(char),2))));}else{
...
if(tq.q_restrict){const char*_tmp3AD;Cyc_Absyndump_dump(((_tmp3AD="restrict",_tag_dyneither(_tmp3AD,sizeof(char),9))));}
if(tq.q_volatile){const char*_tmp3AE;Cyc_Absyndump_dump(((_tmp3AE="volatile",_tag_dyneither(_tmp3AE,sizeof(char),9))));}
if(tq.print_const){const char*_tmp3AF;Cyc_Absyndump_dump(((_tmp3AF="const",_tag_dyneither(_tmp3AF,sizeof(char),6))));}}
# 273
void Cyc_Absyndump_dumpscope(enum Cyc_Absyn_Scope sc){
switch(sc){case Cyc_Absyn_Static: _LL19:
{const char*_tmp3B0;Cyc_Absyndump_dump(((_tmp3B0="static",_tag_dyneither(_tmp3B0,sizeof(char),7))));}return;case Cyc_Absyn_Public: _LL1A:
 return;case Cyc_Absyn_Extern: _LL1B:
{const char*_tmp3B1;Cyc_Absyndump_dump(((_tmp3B1="extern",_tag_dyneither(_tmp3B1,sizeof(char),7))));}return;case Cyc_Absyn_ExternC: _LL1C:
{const char*_tmp3B2;Cyc_Absyndump_dump(((_tmp3B2="extern \"C\"",_tag_dyneither(_tmp3B2,sizeof(char),11))));}return;case Cyc_Absyn_Abstract: _LL1D:
{const char*_tmp3B3;Cyc_Absyndump_dump(((_tmp3B3="abstract",_tag_dyneither(_tmp3B3,sizeof(char),9))));}return;case Cyc_Absyn_Register: _LL1E:
{const char*_tmp3B4;Cyc_Absyndump_dump(((_tmp3B4="register",_tag_dyneither(_tmp3B4,sizeof(char),9))));}return;}}
# 284
...
{const char*_tmp3B5;Cyc_Absyndump_dump(((_tmp3B5="A",_tag_dyneither(_tmp3B5,sizeof(char),2))));}return;case Cyc_Absyn_Unique: _LL23:
{const char*_tmp3B6;Cyc_Absyndump_dump(((_tmp3B6="UA",_tag_dyneither(_tmp3B6,sizeof(char),3))));}return;case Cyc_Absyn_Top: _LL24:
{const char*_tmp3B7;Cyc_Absyndump_dump(((_tmp3B7="TA",_tag_dyneither(_tmp3B7,sizeof(char),3))));}return;}case Cyc_Absyn_MemKind: _LL21:
# 294
 switch(_tmp20){case Cyc_Absyn_Aliasable: _LL27:
{const char*_tmp3B8;Cyc_Absyndump_dump(((_tmp3B8="M",_tag_dyneither(_tmp3B8,sizeof(char),2))));}return;case Cyc_Absyn_Unique: _LL28:
{const char*_tmp3B9;Cyc_Absyndump_dump(((_tmp3B9="UM",_tag_dyneither(_tmp3B9,sizeof(char),3))));}return;case Cyc_Absyn_Top: _LL29:
{const char*_tmp3BA;Cyc_Absyndump_dump(((_tmp3BA="TM",_tag_dyneither(_tmp3BA,sizeof(char),3))));}return;}case Cyc_Absyn_BoxKind: _LL26:
# 300
 switch(_tmp20){case Cyc_Absyn_Aliasable: _LL2C:
{const char*_tmp3BB;Cyc_Absyndump_dump(((_tmp3BB="B",_tag_dyneither(_tmp3BB,sizeof(char),2))));}return;case Cyc_Absyn_Unique: _LL2D:
{const char*_tmp3BC;Cyc_Absyndump_dump(((_tmp3BC="UB",_tag_dyneither(_tmp3BC,sizeof(char),3))));}return;case Cyc_Absyn_Top: _LL2E:
{const char*_tmp3BD;Cyc_Absyndump_dump(((_tmp3BD="TB",_tag_dyneither(_tmp3BD,sizeof(char),3))));}return;}case Cyc_Absyn_RgnKind: _LL2B:
# 306
 switch(_tmp20){case Cyc_Absyn_Aliasable: _LL31:
{const char*_tmp3BE;Cyc_Absyndump_dump(((_tmp3BE="R",_tag_dyneither(_tmp3BE,sizeof(char),2))));}return;case Cyc_Absyn_Unique: _LL32:
{const char*_tmp3BF;Cyc_Absyndump_dump(((_tmp3BF="UR",_tag_dyneither(_tmp3BF,sizeof(char),3))));}return;case Cyc_Absyn_Top: _LL33:
{const char*_tmp3C0;Cyc_Absyndump_dump(((_tmp3C0="TR",_tag_dyneither(_tmp3C0,sizeof(char),3))));}return;}case Cyc_Absyn_EffKind: _LL30:
# 311
{const char*_tmp3C1;Cyc_Absyndump_dump(((_tmp3C1="E",_tag_dyneither(_tmp3C1,sizeof(char),2))));}return;case Cyc_Absyn_IntKind: _LL35:
{const char*_tmp3C2;Cyc_Absyndump_dump(((_tmp3C2="I",_tag_dyneither(_tmp3C2,sizeof(char),2))));}return;}}
# 316
void Cyc_Absyndump_dumpaggr_kind(enum Cyc_Absyn_AggrKind k){
switch(k){case Cyc_Absyn_StructA: _LL37:
{const char*_tmp3C3;Cyc_Absyndump_dump(((_tmp3C3="struct ",_tag_dyneither(_tmp3C3,sizeof(char),8))));}return;case Cyc_Absyn_UnionA: _LL38:
{const char*_tmp3C4;Cyc_Absyndump_dump(((_tmp3C4="union ",_tag_dyneither(_tmp3C4,sizeof(char),7))));}return;}}
# 323
void Cyc_Absyndump_dumptps(struct Cyc_List_List*ts){
const char*_tmp3C7;const char*_tmp3C6;const char*_tmp3C5;((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptyp,ts,((_tmp3C5="<",_tag_dyneither(_tmp3C5,sizeof(char),2))),((_tmp3C6=">",_tag_dyneither(_tmp3C6,sizeof(char),2))),((_tmp3C7=",",_tag_dyneither(_tmp3C7,sizeof(char),2))));}
# 326
...
{const char*_tmp3C8;Cyc_Absyndump_dump(((_tmp3C8="`TTT",_tag_dyneither(_tmp3C8,sizeof(char),5))));}
...
{const char*_tmp3C9;Cyc_Absyndump_dump(((_tmp3C9="::",_tag_dyneither(_tmp3C9,sizeof(char),3))));}Cyc_Absyndump_dumpkind(_tmp3B);goto _LL3A;_LL3A:;};}
# 343
void Cyc_Absyndump_dumptvars(struct Cyc_List_List*tvs){
const char*_tmp3CC;const char*_tmp3CB;const char*_tmp3CA;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,tvs,((_tmp3CA="<",_tag_dyneither(_tmp3CA,sizeof(char),2))),((_tmp3CB=">",_tag_dyneither(_tmp3CB,sizeof(char),2))),((_tmp3CC=",",_tag_dyneither(_tmp3CC,sizeof(char),2))));}
# 346
void Cyc_Absyndump_dumpkindedtvars(struct Cyc_List_List*tvs){
const char*_tmp3CF;const char*_tmp3CE;const char*_tmp3CD;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,tvs,((_tmp3CD="<",_tag_dyneither(_tmp3CD,sizeof(char),2))),((_tmp3CE=">",_tag_dyneither(_tmp3CE,sizeof(char),2))),((_tmp3CF=",",_tag_dyneither(_tmp3CF,sizeof(char),2))));}struct _tuple14{struct Cyc_Absyn_Tqual f1;void*f2;};
# 350
...
const char*_tmp3D2;const char*_tmp3D1;const char*_tmp3D0;((void(*)(void(*f)(struct _tuple14*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumparg,ts,((_tmp3D0="(",_tag_dyneither(_tmp3D0,sizeof(char),2))),((_tmp3D1=")",_tag_dyneither(_tmp3D1,sizeof(char),2))),((_tmp3D2=",",_tag_dyneither(_tmp3D2,sizeof(char),2))));}
# 357
...
{const char*_tmp3D3;Cyc_Absyndump_dump(((_tmp3D3="_stdcall",_tag_dyneither(_tmp3D3,sizeof(char),9))));}return;_LL46: {struct Cyc_Absyn_Cdecl_att_Absyn_Attribute_struct*_tmp48=(struct Cyc_Absyn_Cdecl_att_Absyn_Attribute_struct*)_tmp46;if(_tmp48->tag != 2)goto _LL48;}_LL47:
{const char*_tmp3D4;Cyc_Absyndump_dump(((_tmp3D4="_cdecl",_tag_dyneither(_tmp3D4,sizeof(char),7))));}return;_LL48: {struct Cyc_Absyn_Fastcall_att_Absyn_Attribute_struct*_tmp49=(struct Cyc_Absyn_Fastcall_att_Absyn_Attribute_struct*)_tmp46;if(_tmp49->tag != 3)goto _LL4A;}_LL49:
{const char*_tmp3D5;Cyc_Absyndump_dump(((_tmp3D5="_fastcall",_tag_dyneither(_tmp3D5,sizeof(char),10))));}return;_LL4A:;_LL4B:
 goto _LL43;_LL43:;}}
# 367
...
if(!hasatt)
return;
{const char*_tmp3D6;Cyc_Absyndump_dump(((_tmp3D6="__declspec(",_tag_dyneither(_tmp3D6,sizeof(char),12))));}
for(0;atts != 0;atts=atts->tl){
...
# 394
{const char*_tmp3D7;Cyc_Absyndump_dump(((_tmp3D7=" __attribute__((",_tag_dyneither(_tmp3D7,sizeof(char),17))));}
for(0;atts != 0;atts=atts->tl){
Cyc_Absyndump_dump(Cyc_Absyn_attribute2string((void*)atts->hd));
if(atts->tl != 0){const char*_tmp3D8;Cyc_Absyndump_dump(((_tmp3D8=",",_tag_dyneither(_tmp3D8,sizeof(char),2))));}}
# 399
{const char*_tmp3D9;Cyc_Absyndump_dump(((_tmp3D9=")) ",_tag_dyneither(_tmp3D9,sizeof(char),4))));}
...
{const char*_tmp3DA;Cyc_Absyndump_dump(((_tmp3DA="`H",_tag_dyneither(_tmp3DA,sizeof(char),3))));}goto _LL66;_LL69:;_LL6A:
...
{struct Cyc_List_List*_tmp3DB;rgions=((_tmp3DB=_cycalloc(sizeof(*_tmp3DB)),((_tmp3DB->hd=_tmp60,((_tmp3DB->tl=rgions,_tmp3DB))))));}goto _LL6B;_LL6E: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp61=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmp5E;if(_tmp61->tag != 24)goto _LL70;else{_tmp62=_tmp61->f1;}}_LL6F:
# 429
...
{struct Cyc_List_List*_tmp3DC;effects=((_tmp3DC=_cycalloc(sizeof(*_tmp3DC)),((_tmp3DC->hd=t,((_tmp3DC->tl=effects,_tmp3DC))))));}goto _LL6B;_LL6B:;}{
# 437
struct _tuple15 _tmp3DD;return(_tmp3DD.f1=rgions,((_tmp3DD.f2=effects,_tmp3DD)));};}
# 440
...
{const char*_tmp3DE;Cyc_Absyndump_dump(((_tmp3DE="void",_tag_dyneither(_tmp3DE,sizeof(char),5))));}return;_LL7B: {struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp72=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp6D;if(_tmp72->tag != 2)goto _LL7D;else{_tmp73=_tmp72->f1;}}_LL7C:
...
# 476
{const char*_tmp3DF;Cyc_Absyndump_dump(((_tmp3DF="%",_tag_dyneither(_tmp3DF,sizeof(char),2))));}
if(_tmp75 == 0){const char*_tmp3E0;Cyc_Absyndump_dump(((_tmp3E0="?",_tag_dyneither(_tmp3E0,sizeof(char),2))));}else{Cyc_Absyndump_dumpkind((struct Cyc_Absyn_Kind*)_tmp75->v);}
{const char*_tmp3E4;void*_tmp3E3[1];struct Cyc_Int_pa_PrintArg_struct _tmp3E2;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp3E2.tag=1,((_tmp3E2.f1=(unsigned long)_tmp76,((_tmp3E3[0]=& _tmp3E2,Cyc_aprintf(((_tmp3E4="(%d)",_tag_dyneither(_tmp3E4,sizeof(char),5))),_tag_dyneither(_tmp3E3,sizeof(void*),1)))))))));}return;_LL7F: {struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmp77=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp6D;if(_tmp77->tag != 1)goto _LL81;else{_tmp78=_tmp77->f1;_tmp79=(void*)_tmp77->f2;_tmp7A=_tmp77->f3;}}_LL80:
...
# 484
 if(_tmpC6){const char*_tmp3E5;Cyc_Absyndump_dump(((_tmp3E5="@extensible ",_tag_dyneither(_tmp3E5,sizeof(char),13))));}
{const char*_tmp3E6;Cyc_Absyndump_dump(((_tmp3E6="datatype ",_tag_dyneither(_tmp3E6,sizeof(char),10))));}
...
# 497
 if(_tmpCE){const char*_tmp3E7;Cyc_Absyndump_dump(((_tmp3E7="@extensible ",_tag_dyneither(_tmp3E7,sizeof(char),13))));}
...
{const char*_tmp3E9;Cyc_Absyndump_dump(((_tmp3E9=".",_tag_dyneither(_tmp3E9,sizeof(char),2))));}
...
{const char*_tmp3EB;Cyc_Absyndump_dump(((_tmp3EB="long",_tag_dyneither(_tmp3EB,sizeof(char),5))));}return;_LL8D: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp85=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp6D;if(_tmp85->tag != 6)goto _LL8F;else{if(_tmp85->f1 != Cyc_Absyn_None)goto _LL8F;if(_tmp85->f2 != Cyc_Absyn_Char_sz)goto _LL8F;}}_LL8E:
{const char*_tmp3EC;Cyc_Absyndump_dump(((_tmp3EC="char",_tag_dyneither(_tmp3EC,sizeof(char),5))));}return;_LL8F: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp86=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp6D;if(_tmp86->tag != 6)goto _LL91;else{if(_tmp86->f1 != Cyc_Absyn_Signed)goto _LL91;if(_tmp86->f2 != Cyc_Absyn_Char_sz)goto _LL91;}}_LL90:
{const char*_tmp3ED;Cyc_Absyndump_dump(((_tmp3ED="signed char",_tag_dyneither(_tmp3ED,sizeof(char),12))));}return;_LL91: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp87=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp6D;if(_tmp87->tag != 6)goto _LL93;else{if(_tmp87->f1 != Cyc_Absyn_Unsigned)goto _LL93;if(_tmp87->f2 != Cyc_Absyn_Char_sz)goto _LL93;}}_LL92:
{const char*_tmp3EE;Cyc_Absyndump_dump(((_tmp3EE="unsigned char",_tag_dyneither(_tmp3EE,sizeof(char),14))));}return;_LL93: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp88=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp6D;if(_tmp88->tag != 6)goto _LL95;else{if(_tmp88->f1 != Cyc_Absyn_None)goto _LL95;if(_tmp88->f2 != Cyc_Absyn_Short_sz)goto _LL95;}}_LL94:
...
{const char*_tmp3F3;Cyc_Absyndump_dump(((_tmp3F3="long long",_tag_dyneither(_tmp3F3,sizeof(char),10))));}return;case Cyc_Cyclone_Vc_c: _LLD6:
{const char*_tmp3F4;Cyc_Absyndump_dump(((_tmp3F4="__int64",_tag_dyneither(_tmp3F4,sizeof(char),8))));}return;}_LLA1: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp8F=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp6D;if(_tmp8F->tag != 6)goto _LLA3;else{if(_tmp8F->f1 != Cyc_Absyn_Unsigned)goto _LLA3;if(_tmp8F->f2 != Cyc_Absyn_LongLong_sz)goto _LLA3;}}_LLA2:
# 525
 switch(Cyc_Cyclone_c_compiler){case Cyc_Cyclone_Vc_c: _LLD8:
{const char*_tmp3F5;Cyc_Absyndump_dump(((_tmp3F5="unsigned __int64",_tag_dyneither(_tmp3F5,sizeof(char),17))));}return;case Cyc_Cyclone_Gcc_c: _LLD9:
{const char*_tmp3F6;Cyc_Absyndump_dump(((_tmp3F6="unsigned long long",_tag_dyneither(_tmp3F6,sizeof(char),19))));}return;}_LLA3: {struct Cyc_Absyn_FloatType_Absyn_Type_struct*_tmp90=(struct Cyc_Absyn_FloatType_Absyn_Type_struct*)_tmp6D;if(_tmp90->tag != 7)goto _LLA5;else{_tmp91=_tmp90->f1;}}_LLA4:
# 530
 if(_tmp91 == 0){
const char*_tmp3F7;Cyc_Absyndump_dump(((_tmp3F7="float",_tag_dyneither(_tmp3F7,sizeof(char),6))));}else{
if(_tmp91 == 1){
const char*_tmp3F8;Cyc_Absyndump_dump(((_tmp3F8="double",_tag_dyneither(_tmp3F8,sizeof(char),7))));}else{
# 535
const char*_tmp3F9;Cyc_Absyndump_dump(((_tmp3F9="long double",_tag_dyneither(_tmp3F9,sizeof(char),12))));}}
...
{const char*_tmp3FA;Cyc_Absyndump_dump(((_tmp3FA="enum ",_tag_dyneither(_tmp3FA,sizeof(char),6))));}Cyc_Absyndump_dumpqvar(_tmp9B);return;_LLAD: {struct Cyc_Absyn_AnonEnumType_Absyn_Type_struct*_tmp9C=(struct Cyc_Absyn_AnonEnumType_Absyn_Type_struct*)_tmp6D;if(_tmp9C->tag != 14)goto _LLAF;else{_tmp9D=_tmp9C->f1;}}_LLAE:
{const char*_tmp3FB;Cyc_Absyndump_dump(((_tmp3FB="enum {",_tag_dyneither(_tmp3FB,sizeof(char),7))));}Cyc_Absyndump_dumpenumfields(_tmp9D);{const char*_tmp3FC;Cyc_Absyndump_dump(((_tmp3FC="}",_tag_dyneither(_tmp3FC,sizeof(char),2))));}return;_LLAF: {struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmp9E=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp6D;if(_tmp9E->tag != 17)goto _LLB1;else{_tmp9F=_tmp9E->f1;_tmpA0=_tmp9E->f2;}}_LLB0:
...
{const char*_tmp3FD;Cyc_Absyndump_dump(((_tmp3FD="valueof_t(",_tag_dyneither(_tmp3FD,sizeof(char),11))));}Cyc_Absyndump_dumpexp(_tmpA2);{const char*_tmp3FE;Cyc_Absyndump_dump(((_tmp3FE=")",_tag_dyneither(_tmp3FE,sizeof(char),2))));}return;_LLB3: {struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct*_tmpA3=(struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct*)_tmp6D;if(_tmpA3->tag != 15)goto _LLB5;else{_tmpA4=(void*)_tmpA3->f1;}}_LLB4:
# 549
{const char*_tmp3FF;Cyc_Absyndump_dump(((_tmp3FF="region_t<",_tag_dyneither(_tmp3FF,sizeof(char),10))));}Cyc_Absyndump_dumprgn(_tmpA4);{const char*_tmp400;Cyc_Absyndump_dump(((_tmp400=">",_tag_dyneither(_tmp400,sizeof(char),2))));}return;_LLB5: {struct Cyc_Absyn_DynRgnType_Absyn_Type_struct*_tmpA5=(struct Cyc_Absyn_DynRgnType_Absyn_Type_struct*)_tmp6D;if(_tmpA5->tag != 16)goto _LLB7;else{_tmpA6=(void*)_tmpA5->f1;_tmpA7=(void*)_tmpA5->f2;}}_LLB6:
{const char*_tmp401;Cyc_Absyndump_dump(((_tmp401="dynregion_t<",_tag_dyneither(_tmp401,sizeof(char),13))));}Cyc_Absyndump_dumprgn(_tmpA6);
{const char*_tmp402;Cyc_Absyndump_dump(((_tmp402=",",_tag_dyneither(_tmp402,sizeof(char),2))));}Cyc_Absyndump_dumprgn(_tmpA7);{const char*_tmp403;Cyc_Absyndump_dump(((_tmp403=">",_tag_dyneither(_tmp403,sizeof(char),2))));}return;_LLB7: {struct Cyc_Absyn_TagType_Absyn_Type_struct*_tmpA8=(struct Cyc_Absyn_TagType_Absyn_Type_struct*)_tmp6D;if(_tmpA8->tag != 19)goto _LLB9;else{_tmpA9=(void*)_tmpA8->f1;}}_LLB8:
{const char*_tmp404;Cyc_Absyndump_dump(((_tmp404="tag_t<",_tag_dyneither(_tmp404,sizeof(char),7))));}Cyc_Absyndump_dumpntyp(_tmpA9);{const char*_tmp405;Cyc_Absyndump_dump(((_tmp405=">",_tag_dyneither(_tmp405,sizeof(char),2))));}return;_LLB9: {struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*_tmpAA=(struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*)_tmp6D;if(_tmpAA->tag != 21)goto _LLBB;}_LLBA:
{const char*_tmp406;Cyc_Absyndump_dump(((_tmp406="`U",_tag_dyneither(_tmp406,sizeof(char),3))));}goto _LL72;_LLBB: {struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*_tmpAB=(struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*)_tmp6D;if(_tmpAB->tag != 22)goto _LLBD;}_LLBC:
{const char*_tmp407;Cyc_Absyndump_dump(((_tmp407="`RC",_tag_dyneither(_tmp407,sizeof(char),4))));}goto _LL72;_LLBD: {struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*_tmpAC=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp6D;if(_tmpAC->tag != 26)goto _LLBF;else{struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*_tmpAD=(struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)(_tmpAC->f1)->r;if(_tmpAD->tag != 0)goto _LLBF;else{_tmpAE=_tmpAD->f1;}}}_LLBE:
# 556
...
{const char*_tmp408;Cyc_Absyndump_dump(((_tmp408="`H",_tag_dyneither(_tmp408,sizeof(char),3))));}goto _LL72;_LLC5: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmpB6=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmp6D;if(_tmpB6->tag != 23)goto _LLC7;else{_tmpB7=(void*)_tmpB6->f1;}}_LLC6:
{const char*_tmp409;Cyc_Absyndump_dump(((_tmp409="{",_tag_dyneither(_tmp409,sizeof(char),2))));}Cyc_Absyndump_dumptyp(_tmpB7);{const char*_tmp40A;Cyc_Absyndump_dump(((_tmp40A="}",_tag_dyneither(_tmp40A,sizeof(char),2))));}goto _LL72;_LLC7: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmpB8=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmp6D;if(_tmpB8->tag != 25)goto _LLC9;else{_tmpB9=(void*)_tmpB8->f1;}}_LLC8:
{const char*_tmp40B;Cyc_Absyndump_dump(((_tmp40B="regions(",_tag_dyneither(_tmp40B,sizeof(char),9))));}Cyc_Absyndump_dumptyp(_tmpB9);{const char*_tmp40C;Cyc_Absyndump_dump(((_tmp40C=")",_tag_dyneither(_tmp40C,sizeof(char),2))));}goto _LL72;_LLC9: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmpBA=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmp6D;if(_tmpBA->tag != 24)goto _LL72;else{_tmpBB=_tmpBA->f1;}}_LLCA:
# 565
 for(0;_tmpBB != 0;_tmpBB=_tmpBB->tl){
Cyc_Absyndump_dumptyp((void*)_tmpBB->hd);
if(_tmpBB->tl != 0){const char*_tmp40D;Cyc_Absyndump_dump(((_tmp40D="+",_tag_dyneither(_tmp40D,sizeof(char),2))));}}_LL72:;}
# 572
...
const char*_tmp40E;((void(*)(void(*f)(struct _tuple16*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dump_rgncmp,rgn_po,((_tmp40E=",",_tag_dyneither(_tmp40E,sizeof(char),2))));}
# 585
...
# 593
if(c_varargs){
const char*_tmp40F;Cyc_Absyndump_dump(((_tmp40F="...",_tag_dyneither(_tmp40F,sizeof(char),4))));}else{
if(cyc_varargs != 0){
struct _tuple8*_tmp410;struct _tuple8*_tmpFF=(_tmp410=_cycalloc(sizeof(*_tmp410)),((_tmp410->f1=cyc_varargs->name,((_tmp410->f2=cyc_varargs->tq,((_tmp410->f3=cyc_varargs->type,_tmp410)))))));
{const char*_tmp411;Cyc_Absyndump_dump(((_tmp411="...",_tag_dyneither(_tmp411,sizeof(char),4))));}
if(cyc_varargs->inject){const char*_tmp412;Cyc_Absyndump_dump(((_tmp412=" inject ",_tag_dyneither(_tmp412,sizeof(char),9))));}
...
{const char*_tmp413;Cyc_Absyndump_dump(((_tmp413=".[",_tag_dyneither(_tmp413,sizeof(char),3))));}Cyc_Absyndump_dumpexp(_tmp105);Cyc_Absyndump_dump_char((int)']');goto _LLDB;_LLDE: {struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_tmp106=(struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp103;if(_tmp106->tag != 1)goto _LLDB;else{_tmp107=_tmp106->f1;}}_LLDF:
...
{const char*_tmp416;const char*_tmp415;const char*_tmp414;((void(*)(void(*f)(void*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpdesignator,(*de).f1,((_tmp414="",_tag_dyneither(_tmp414,sizeof(char),1))),((_tmp415="=",_tag_dyneither(_tmp415,sizeof(char),2))),((_tmp416="=",_tag_dyneither(_tmp416,sizeof(char),2))));}
Cyc_Absyndump_dumpexp((*de).f2);}
# 628
void Cyc_Absyndump_dumpexps_prec(int inprec,struct Cyc_List_List*es){
const char*_tmp419;const char*_tmp418;const char*_tmp417;((void(*)(void(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group_c)(Cyc_Absyndump_dumpexp_prec,inprec,es,((_tmp417="",_tag_dyneither(_tmp417,sizeof(char),1))),((_tmp418="",_tag_dyneither(_tmp418,sizeof(char),1))),((_tmp419=",",_tag_dyneither(_tmp419,sizeof(char),2))));}
# 632
void Cyc_Absyndump_dumpexp_prec(int inprec,struct Cyc_Absyn_Exp*e){
int myprec=Cyc_Absynpp_exp_prec(e);
if(inprec >= myprec){
const char*_tmp41A;Cyc_Absyndump_dump_nospace(((_tmp41A="(",_tag_dyneither(_tmp41A,sizeof(char),2))));}
...
{const char*_tmp41E;void*_tmp41D[1];struct Cyc_String_pa_PrintArg_struct _tmp41C;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp41C.tag=0,((_tmp41C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp115),((_tmp41D[0]=& _tmp41C,Cyc_aprintf(((_tmp41E="L'%s'",_tag_dyneither(_tmp41E,sizeof(char),6))),_tag_dyneither(_tmp41D,sizeof(void*),1)))))))));}goto _LLE0;_LLE5: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp116=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp116->tag != 0)goto _LLE7;else{if(((_tmp116->f1).Short_c).tag != 4)goto _LLE7;_tmp117=((struct _tuple4)((_tmp116->f1).Short_c).val).f1;_tmp118=((struct _tuple4)((_tmp116->f1).Short_c).val).f2;}}_LLE6:
{const char*_tmp422;void*_tmp421[1];struct Cyc_Int_pa_PrintArg_struct _tmp420;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp420.tag=1,((_tmp420.f1=(unsigned long)((int)_tmp118),((_tmp421[0]=& _tmp420,Cyc_aprintf(((_tmp422="%d",_tag_dyneither(_tmp422,sizeof(char),3))),_tag_dyneither(_tmp421,sizeof(void*),1)))))))));}goto _LLE0;_LLE7: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp119=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp119->tag != 0)goto _LLE9;else{if(((_tmp119->f1).Int_c).tag != 5)goto _LLE9;if(((struct _tuple5)((_tmp119->f1).Int_c).val).f1 != Cyc_Absyn_None)goto _LLE9;_tmp11A=((struct _tuple5)((_tmp119->f1).Int_c).val).f2;}}_LLE8:
...
{const char*_tmp426;void*_tmp425[1];struct Cyc_Int_pa_PrintArg_struct _tmp424;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp424.tag=1,((_tmp424.f1=(unsigned long)_tmp11C,((_tmp425[0]=& _tmp424,Cyc_aprintf(((_tmp426="%d",_tag_dyneither(_tmp426,sizeof(char),3))),_tag_dyneither(_tmp425,sizeof(void*),1)))))))));}goto _LLE0;_LLEB: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp11D=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp11D->tag != 0)goto _LLED;else{if(((_tmp11D->f1).Int_c).tag != 5)goto _LLED;if(((struct _tuple5)((_tmp11D->f1).Int_c).val).f1 != Cyc_Absyn_Unsigned)goto _LLED;_tmp11E=((struct _tuple5)((_tmp11D->f1).Int_c).val).f2;}}_LLEC:
{const char*_tmp42A;void*_tmp429[1];struct Cyc_Int_pa_PrintArg_struct _tmp428;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp428.tag=1,((_tmp428.f1=(unsigned int)_tmp11E,((_tmp429[0]=& _tmp428,Cyc_aprintf(((_tmp42A="%u",_tag_dyneither(_tmp42A,sizeof(char),3))),_tag_dyneither(_tmp429,sizeof(void*),1)))))))));}goto _LLE0;_LLED: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp11F=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp11F->tag != 0)goto _LLEF;else{if(((_tmp11F->f1).LongLong_c).tag != 6)goto _LLEF;_tmp120=((struct _tuple6)((_tmp11F->f1).LongLong_c).val).f1;_tmp121=((struct _tuple6)((_tmp11F->f1).LongLong_c).val).f2;}}_LLEE:
# 646
{const char*_tmp42B;Cyc_Absyndump_dump(((_tmp42B="<<FIX LONG LONG CONSTANT>>",_tag_dyneither(_tmp42B,sizeof(char),27))));}goto _LLE0;_LLEF: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp122=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp122->tag != 0)goto _LLF1;else{if(((_tmp122->f1).Float_c).tag != 7)goto _LLF1;_tmp123=((struct _tuple7)((_tmp122->f1).Float_c).val).f1;}}_LLF0:
...
{const char*_tmp42C;Cyc_Absyndump_dump(((_tmp42C="NULL",_tag_dyneither(_tmp42C,sizeof(char),5))));}goto _LLE0;_LLF3: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp125=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp125->tag != 0)goto _LLF5;else{if(((_tmp125->f1).String_c).tag != 8)goto _LLF5;_tmp126=(struct _dyneither_ptr)((_tmp125->f1).String_c).val;}}_LLF4:
# 650
...
# 653
{const char*_tmp42D;Cyc_Absyndump_dump(((_tmp42D="L\"",_tag_dyneither(_tmp42D,sizeof(char),3))));}Cyc_Absyndump_dump_nospace(_tmp128);Cyc_Absyndump_dump_char((int)'"');
...
{const char*_tmp42E;Cyc_Absyndump_dump(((_tmp42E="numelts(",_tag_dyneither(_tmp42E,sizeof(char),9))));}
Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp12D))->hd);{
const char*_tmp42F;Cyc_Absyndump_dump(((_tmp42F=")",_tag_dyneither(_tmp42F,sizeof(char),2))));};}else{
# 667
...
# 678
struct Cyc_Core_Failure_exn_struct _tmp435;const char*_tmp434;struct Cyc_Core_Failure_exn_struct*_tmp433;(int)_throw((void*)((_tmp433=_cycalloc(sizeof(*_tmp433)),((_tmp433[0]=((_tmp435.tag=Cyc_Core_Failure,((_tmp435.f1=((_tmp434="Absyndump -- Bad number of arguments to primop",_tag_dyneither(_tmp434,sizeof(char),47))),_tmp435)))),_tmp433)))));}}
# 680
...
{const char*_tmp436;Cyc_Absyndump_dump_nospace(((_tmp436="=",_tag_dyneither(_tmp436,sizeof(char),2))));}
...
# 690
{const char*_tmp437;Cyc_Absyndump_dump(((_tmp437="++",_tag_dyneither(_tmp437,sizeof(char),3))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp133);goto _LLE0;_LLFF: {struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp134=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp134->tag != 4)goto _LL101;else{_tmp135=_tmp134->f1;if(_tmp134->f2 != Cyc_Absyn_PreDec)goto _LL101;}}_LL100:
{const char*_tmp438;Cyc_Absyndump_dump(((_tmp438="--",_tag_dyneither(_tmp438,sizeof(char),3))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp135);goto _LLE0;_LL101: {struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp136=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp136->tag != 4)goto _LL103;else{_tmp137=_tmp136->f1;if(_tmp136->f2 != Cyc_Absyn_PostInc)goto _LL103;}}_LL102:
 Cyc_Absyndump_dumpexp_prec(myprec,_tmp137);{const char*_tmp439;Cyc_Absyndump_dump(((_tmp439="++",_tag_dyneither(_tmp439,sizeof(char),3))));}goto _LLE0;_LL103: {struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp138=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp138->tag != 4)goto _LL105;else{_tmp139=_tmp138->f1;if(_tmp138->f2 != Cyc_Absyn_PostDec)goto _LL105;}}_LL104:
 Cyc_Absyndump_dumpexp_prec(myprec,_tmp139);{const char*_tmp43A;Cyc_Absyndump_dump(((_tmp43A="--",_tag_dyneither(_tmp43A,sizeof(char),3))));}goto _LLE0;_LL105: {struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_tmp13A=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp13A->tag != 5)goto _LL107;else{_tmp13B=_tmp13A->f1;_tmp13C=_tmp13A->f2;_tmp13D=_tmp13A->f3;}}_LL106:
# 696
...
# 703
 Cyc_Absyndump_dumploc(e->loc);
Cyc_Absyndump_dumpexp_prec(myprec,_tmp13F);{const char*_tmp43B;Cyc_Absyndump_dump(((_tmp43B=" && ",_tag_dyneither(_tmp43B,sizeof(char),5))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp140);goto _LLE0;_LL109: {struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_tmp141=(struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp141->tag != 7)goto _LL10B;else{_tmp142=_tmp141->f1;_tmp143=_tmp141->f2;}}_LL10A:
# 707
 Cyc_Absyndump_dumploc(e->loc);
Cyc_Absyndump_dumpexp_prec(myprec,_tmp142);{const char*_tmp43C;Cyc_Absyndump_dump(((_tmp43C=" || ",_tag_dyneither(_tmp43C,sizeof(char),5))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp143);goto _LLE0;_LL10B: {struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_tmp144=(struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp144->tag != 8)goto _LL10D;else{_tmp145=_tmp144->f1;_tmp146=_tmp144->f2;}}_LL10C:
# 713
 Cyc_Absyndump_dumploc(e->loc);
Cyc_Absyndump_dump_char((int)'(');
...
{const char*_tmp43E;Cyc_Absyndump_dump_nospace(((_tmp43E=")",_tag_dyneither(_tmp43E,sizeof(char),2))));}
...
# 749
{const char*_tmp440;Cyc_Absyndump_dump(((_tmp440="new ",_tag_dyneither(_tmp440,sizeof(char),5))));}Cyc_Absyndump_dumpexp_prec(myprec,_tmp157);goto _LLE0;_LL11B: {struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*_tmp158=(struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp158->tag != 16)goto _LL11D;else{_tmp159=(void*)_tmp158->f1;}}_LL11C:
# 752
{const char*_tmp441;Cyc_Absyndump_dump(((_tmp441="sizeof(",_tag_dyneither(_tmp441,sizeof(char),8))));}Cyc_Absyndump_dumptyp(_tmp159);Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL11D: {struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*_tmp15A=(struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp15A->tag != 17)goto _LL11F;else{_tmp15B=_tmp15A->f1;}}_LL11E:
# 755
{const char*_tmp442;Cyc_Absyndump_dump(((_tmp442="sizeof(",_tag_dyneither(_tmp442,sizeof(char),8))));}Cyc_Absyndump_dumpexp(_tmp15B);Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL11F: {struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp15C=(struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp15C->tag != 37)goto _LL121;else{_tmp15D=(void*)_tmp15C->f1;}}_LL120:
# 758
{const char*_tmp443;Cyc_Absyndump_dump(((_tmp443="valueof(",_tag_dyneither(_tmp443,sizeof(char),9))));}Cyc_Absyndump_dumptyp(_tmp15D);Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL121: {struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*_tmp15E=(struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp15E->tag != 38)goto _LL123;else{_tmp15F=_tmp15E->f1;_tmp160=_tmp15E->f2;}}_LL122:
# 761
{const char*_tmp444;Cyc_Absyndump_dump(((_tmp444="__asm__",_tag_dyneither(_tmp444,sizeof(char),8))));}
if(_tmp15F){const char*_tmp445;Cyc_Absyndump_dump(((_tmp445=" volatile ",_tag_dyneither(_tmp445,sizeof(char),11))));}
Cyc_Absyndump_dump_char((int)'(');
...
# 769
{const char*_tmp446;Cyc_Absyndump_dump(((_tmp446="tagcheck(",_tag_dyneither(_tmp446,sizeof(char),10))));}Cyc_Absyndump_dumpexp(_tmp162);Cyc_Absyndump_dump_char((int)'.');Cyc_Absyndump_dump_nospace(*_tmp163);
Cyc_Absyndump_dump_char((int)')');
...
# 774
{const char*_tmp447;Cyc_Absyndump_dump(((_tmp447="offsetof(",_tag_dyneither(_tmp447,sizeof(char),10))));}Cyc_Absyndump_dumptyp(_tmp165);Cyc_Absyndump_dump_char((int)',');Cyc_Absyndump_dump_nospace(*_tmp167);
Cyc_Absyndump_dump_char((int)')');
...
# 779
{const char*_tmp448;Cyc_Absyndump_dump(((_tmp448="offsetof(",_tag_dyneither(_tmp448,sizeof(char),10))));}Cyc_Absyndump_dumptyp(_tmp169);Cyc_Absyndump_dump_char((int)',');{const char*_tmp44C;void*_tmp44B[1];struct Cyc_Int_pa_PrintArg_struct _tmp44A;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp44A.tag=1,((_tmp44A.f1=(unsigned long)((int)_tmp16B),((_tmp44B[0]=& _tmp44A,Cyc_aprintf(((_tmp44C="%d",_tag_dyneither(_tmp44C,sizeof(char),3))),_tag_dyneither(_tmp44B,sizeof(void*),1)))))))));}
Cyc_Absyndump_dump_char((int)')');
...
# 791
 Cyc_Absyndump_dumpexp_prec(myprec,_tmp172);{const char*_tmp44D;Cyc_Absyndump_dump_nospace(((_tmp44D="->",_tag_dyneither(_tmp44D,sizeof(char),3))));}Cyc_Absyndump_dump_nospace(*_tmp173);
...
# 799
{const char*_tmp44E;Cyc_Absyndump_dump(((_tmp44E="$(",_tag_dyneither(_tmp44E,sizeof(char),3))));}Cyc_Absyndump_dumpexps_prec(20,_tmp178);Cyc_Absyndump_dump_char((int)')');goto _LLE0;_LL133: {struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*_tmp179=(struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp110;if(_tmp179->tag != 24)goto _LL135;else{_tmp17A=_tmp179->f1;_tmp17B=_tmp179->f2;}}_LL134:
# 802
 Cyc_Absyndump_dump_char((int)'(');
Cyc_Absyndump_dumptyp((*_tmp17A).f3);
Cyc_Absyndump_dump_char((int)')');
{const char*_tmp451;const char*_tmp450;const char*_tmp44F;((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp17B,((_tmp44F="{",_tag_dyneither(_tmp44F,sizeof(char),2))),((_tmp450="}",_tag_dyneither(_tmp450,sizeof(char),2))),((_tmp451=",",_tag_dyneither(_tmp451,sizeof(char),2))));}
...
# 809
{const char*_tmp454;const char*_tmp453;const char*_tmp452;((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp17D,((_tmp452="{",_tag_dyneither(_tmp452,sizeof(char),2))),((_tmp453="}",_tag_dyneither(_tmp453,sizeof(char),2))),((_tmp454=",",_tag_dyneither(_tmp454,sizeof(char),2))));}
...
# 813
{const char*_tmp455;Cyc_Absyndump_dump(((_tmp455="new {for",_tag_dyneither(_tmp455,sizeof(char),9))));}Cyc_Absyndump_dump_str((*_tmp17F->name).f2);Cyc_Absyndump_dump_char((int)'<');Cyc_Absyndump_dumpexp(_tmp180);
...
{const char*_tmp458;const char*_tmp457;const char*_tmp456;((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp185,((_tmp456="",_tag_dyneither(_tmp456,sizeof(char),1))),((_tmp457="}",_tag_dyneither(_tmp457,sizeof(char),2))),((_tmp458=",",_tag_dyneither(_tmp458,sizeof(char),2))));}
...
# 826
{const char*_tmp45B;const char*_tmp45A;const char*_tmp459;((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp187,((_tmp459="{",_tag_dyneither(_tmp459,sizeof(char),2))),((_tmp45A="}",_tag_dyneither(_tmp45A,sizeof(char),2))),((_tmp45B=",",_tag_dyneither(_tmp45B,sizeof(char),2))));}
...
if(_tmp189 != 0){const char*_tmp45E;const char*_tmp45D;const char*_tmp45C;((void(*)(void(*f)(struct Cyc_Absyn_Exp*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpexp,_tmp189,((_tmp45C="(",_tag_dyneither(_tmp45C,sizeof(char),2))),((_tmp45D=")",_tag_dyneither(_tmp45D,sizeof(char),2))),((_tmp45E=",",_tag_dyneither(_tmp45E,sizeof(char),2))));}
...
if(_tmp190){
if(_tmp191 != 0){
{const char*_tmp45F;Cyc_Absyndump_dump(((_tmp45F="rcalloc(",_tag_dyneither(_tmp45F,sizeof(char),9))));}
Cyc_Absyndump_dumpexp(_tmp191);{const char*_tmp460;Cyc_Absyndump_dump(((_tmp460=",",_tag_dyneither(_tmp460,sizeof(char),2))));};}else{
# 844
const char*_tmp461;Cyc_Absyndump_dump(((_tmp461="calloc",_tag_dyneither(_tmp461,sizeof(char),7))));}
# 846
Cyc_Absyndump_dumpexp(_tmp193);
{const char*_tmp462;Cyc_Absyndump_dump(((_tmp462=",",_tag_dyneither(_tmp462,sizeof(char),2))));}
...
# 851
if(_tmp191 != 0){
{const char*_tmp464;Cyc_Absyndump_dump(((_tmp464="rmalloc(",_tag_dyneither(_tmp464,sizeof(char),9))));}
Cyc_Absyndump_dumpexp(_tmp191);{const char*_tmp465;Cyc_Absyndump_dump(((_tmp465=",",_tag_dyneither(_tmp465,sizeof(char),2))));};}else{
# 855
const char*_tmp466;Cyc_Absyndump_dump(((_tmp466="malloc(",_tag_dyneither(_tmp466,sizeof(char),8))));}
# 858
if(_tmp192 != 0)
...
{const char*_tmp468;Cyc_Absyndump_dump_nospace(((_tmp468=":=:",_tag_dyneither(_tmp468,sizeof(char),4))));}
...
# 874
{const char*_tmp46B;const char*_tmp46A;const char*_tmp469;((void(*)(void(*f)(struct _tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp199,((_tmp469="{",_tag_dyneither(_tmp469,sizeof(char),2))),((_tmp46A="}",_tag_dyneither(_tmp46A,sizeof(char),2))),((_tmp46B=",",_tag_dyneither(_tmp46B,sizeof(char),2))));}
...
# 878
{const char*_tmp46C;Cyc_Absyndump_dump_nospace(((_tmp46C="({",_tag_dyneither(_tmp46C,sizeof(char),3))));}
Cyc_Absyndump_dumpstmt(_tmp19B,1);
{const char*_tmp46D;Cyc_Absyndump_dump_nospace(((_tmp46D="})",_tag_dyneither(_tmp46D,sizeof(char),3))));}
goto _LLE0;_LLE0:;}
# 883
if(inprec >= myprec)
Cyc_Absyndump_dump_char((int)')');}
...
const char*_tmp46E;Cyc_Absyndump_dump(((_tmp46E="default:",_tag_dyneither(_tmp46E,sizeof(char),9))));}else{
# 897
{const char*_tmp46F;Cyc_Absyndump_dump(((_tmp46F="case",_tag_dyneither(_tmp46F,sizeof(char),5))));}
Cyc_Absyndump_dumppat(_tmp1E8->pattern);
if(_tmp1E8->where_clause != 0){
{const char*_tmp470;Cyc_Absyndump_dump(((_tmp470="&&",_tag_dyneither(_tmp470,sizeof(char),3))));}
...
{const char*_tmp472;Cyc_Absyndump_dump(((_tmp472="return;",_tag_dyneither(_tmp472,sizeof(char),8))));}goto _LL14F;_LL158: {struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*_tmp1F5=(struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp1ED;if(_tmp1F5->tag != 3)goto _LL15A;else{_tmp1F6=_tmp1F5->f1;}}_LL159:
{const char*_tmp473;Cyc_Absyndump_dump(((_tmp473="return",_tag_dyneither(_tmp473,sizeof(char),7))));}Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_check_null(_tmp1F6));Cyc_Absyndump_dump_semi();goto _LL14F;_LL15A: {struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*_tmp1F7=(struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp1ED;if(_tmp1F7->tag != 4)goto _LL15C;else{_tmp1F8=_tmp1F7->f1;_tmp1F9=_tmp1F7->f2;_tmp1FA=_tmp1F7->f3;}}_LL15B:
# 933
{const char*_tmp474;Cyc_Absyndump_dump(((_tmp474="if(",_tag_dyneither(_tmp474,sizeof(char),4))));}Cyc_Absyndump_dumpexp(_tmp1F8);
...
{const char*_tmp475;Cyc_Absyndump_dump_nospace(((_tmp475="){",_tag_dyneither(_tmp475,sizeof(char),3))));}Cyc_Absyndump_dumpstmt(_tmp1F9,0);Cyc_Absyndump_dump_char((int)'}');goto _LL176;_LL17F:;_LL180:
...
{const char*_tmp476;Cyc_Absyndump_dump(((_tmp476="else{",_tag_dyneither(_tmp476,sizeof(char),6))));}Cyc_Absyndump_dumpstmt(_tmp1FA,0);Cyc_Absyndump_dump_char((int)'}');goto _LL181;_LL181:;}
# 945
...
# 947
{const char*_tmp477;Cyc_Absyndump_dump(((_tmp477="while(",_tag_dyneither(_tmp477,sizeof(char),7))));}Cyc_Absyndump_dumpexp(_tmp1FC);{const char*_tmp478;Cyc_Absyndump_dump_nospace(((_tmp478="){",_tag_dyneither(_tmp478,sizeof(char),3))));}
...
{const char*_tmp479;Cyc_Absyndump_dump(((_tmp479="break;",_tag_dyneither(_tmp479,sizeof(char),7))));}goto _LL14F;_LL160: {struct Cyc_Absyn_Continue_s_Absyn_Raw_stmt_struct*_tmp1FF=(struct Cyc_Absyn_Continue_s_Absyn_Raw_stmt_struct*)_tmp1ED;if(_tmp1FF->tag != 7)goto _LL162;}_LL161:
{const char*_tmp47A;Cyc_Absyndump_dump(((_tmp47A="continue;",_tag_dyneither(_tmp47A,sizeof(char),10))));}goto _LL14F;_LL162: {struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*_tmp200=(struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*)_tmp1ED;if(_tmp200->tag != 8)goto _LL164;else{_tmp201=_tmp200->f1;}}_LL163:
{const char*_tmp47B;Cyc_Absyndump_dump(((_tmp47B="goto",_tag_dyneither(_tmp47B,sizeof(char),5))));}Cyc_Absyndump_dump_str(_tmp201);Cyc_Absyndump_dump_semi();goto _LL14F;_LL164: {struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*_tmp202=(struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp1ED;if(_tmp202->tag != 9)goto _LL166;else{_tmp203=_tmp202->f1;_tmp204=(_tmp202->f2).f1;_tmp205=(_tmp202->f3).f1;_tmp206=_tmp202->f4;}}_LL165:
# 956
{const char*_tmp47C;Cyc_Absyndump_dump(((_tmp47C="for(",_tag_dyneither(_tmp47C,sizeof(char),5))));}Cyc_Absyndump_dumpexp(_tmp203);Cyc_Absyndump_dump_semi();Cyc_Absyndump_dumpexp(_tmp204);Cyc_Absyndump_dump_semi();Cyc_Absyndump_dumpexp(_tmp205);
{const char*_tmp47D;Cyc_Absyndump_dump_nospace(((_tmp47D="){",_tag_dyneither(_tmp47D,sizeof(char),3))));}Cyc_Absyndump_dumpstmt(_tmp206,0);Cyc_Absyndump_dump_char((int)'}');
...
# 960
{const char*_tmp47E;Cyc_Absyndump_dump(((_tmp47E="switch(",_tag_dyneither(_tmp47E,sizeof(char),8))));}Cyc_Absyndump_dumpexp(_tmp208);{const char*_tmp47F;Cyc_Absyndump_dump_nospace(((_tmp47F="){",_tag_dyneither(_tmp47F,sizeof(char),3))));}
...
if(expstmt){const char*_tmp480;Cyc_Absyndump_dump_nospace(((_tmp480=": ({",_tag_dyneither(_tmp480,sizeof(char),5))));}else{const char*_tmp481;Cyc_Absyndump_dump_nospace(((_tmp481=": {",_tag_dyneither(_tmp481,sizeof(char),4))));}
Cyc_Absyndump_dumpstmt(_tmp20F,expstmt);
if(expstmt){const char*_tmp482;Cyc_Absyndump_dump_nospace(((_tmp482="});}",_tag_dyneither(_tmp482,sizeof(char),5))));}else{Cyc_Absyndump_dump_char((int)'}');}}else{
# 977
...
# 982
{const char*_tmp483;Cyc_Absyndump_dump(((_tmp483="do{",_tag_dyneither(_tmp483,sizeof(char),4))));}Cyc_Absyndump_dumpstmt(_tmp211,0);
{const char*_tmp484;Cyc_Absyndump_dump_nospace(((_tmp484="}while(",_tag_dyneither(_tmp484,sizeof(char),8))));}Cyc_Absyndump_dumpexp(_tmp212);{const char*_tmp485;Cyc_Absyndump_dump_nospace(((_tmp485=");",_tag_dyneither(_tmp485,sizeof(char),3))));}
...
# 986
{const char*_tmp486;Cyc_Absyndump_dump(((_tmp486="fallthru;",_tag_dyneither(_tmp486,sizeof(char),10))));}goto _LL14F;_LL170: {struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*_tmp214=(struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp1ED;if(_tmp214->tag != 11)goto _LL172;else{_tmp215=_tmp214->f1;}}_LL171:
# 988
{const char*_tmp487;Cyc_Absyndump_dump(((_tmp487="fallthru(",_tag_dyneither(_tmp487,sizeof(char),10))));}Cyc_Absyndump_dumpexps_prec(20,_tmp215);{const char*_tmp488;Cyc_Absyndump_dump_nospace(((_tmp488=");",_tag_dyneither(_tmp488,sizeof(char),3))));}goto _LL14F;_LL172: {struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*_tmp216=(struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*)_tmp1ED;if(_tmp216->tag != 15)goto _LL174;else{_tmp217=_tmp216->f1;_tmp218=_tmp216->f2;}}_LL173:
# 991
{const char*_tmp489;Cyc_Absyndump_dump(((_tmp489="try",_tag_dyneither(_tmp489,sizeof(char),4))));}Cyc_Absyndump_dumpstmt(_tmp217,0);
{const char*_tmp48A;Cyc_Absyndump_dump(((_tmp48A="catch{",_tag_dyneither(_tmp48A,sizeof(char),7))));}
...
# 997
{const char*_tmp48B;Cyc_Absyndump_dump(((_tmp48B="reset_region(",_tag_dyneither(_tmp48B,sizeof(char),14))));}Cyc_Absyndump_dumpexp(_tmp21A);{const char*_tmp48C;Cyc_Absyndump_dump(((_tmp48C=");",_tag_dyneither(_tmp48C,sizeof(char),3))));}
...
{const char*_tmp490;Cyc_Absyndump_dump(((_tmp490="NULL",_tag_dyneither(_tmp490,sizeof(char),5))));}goto _LL186;_LL18B: {struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmp243=(struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp240;if(_tmp243->tag != 9)goto _LL18D;else{if(_tmp243->f1 != Cyc_Absyn_None)goto _LL18D;_tmp244=_tmp243->f2;}}_LL18C:
...
{const char*_tmp494;void*_tmp493[1];struct Cyc_Int_pa_PrintArg_struct _tmp492;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp492.tag=1,((_tmp492.f1=(unsigned long)_tmp246,((_tmp493[0]=& _tmp492,Cyc_aprintf(((_tmp494="%d",_tag_dyneither(_tmp494,sizeof(char),3))),_tag_dyneither(_tmp493,sizeof(void*),1)))))))));}goto _LL186;_LL18F: {struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*_tmp247=(struct Cyc_Absyn_Int_p_Absyn_Raw_pat_struct*)_tmp240;if(_tmp247->tag != 9)goto _LL191;else{if(_tmp247->f1 != Cyc_Absyn_Unsigned)goto _LL191;_tmp248=_tmp247->f2;}}_LL190:
{const char*_tmp498;void*_tmp497[1];struct Cyc_Int_pa_PrintArg_struct _tmp496;Cyc_Absyndump_dump((struct _dyneither_ptr)((_tmp496.tag=1,((_tmp496.f1=(unsigned int)_tmp248,((_tmp497[0]=& _tmp496,Cyc_aprintf(((_tmp498="%u",_tag_dyneither(_tmp498,sizeof(char),3))),_tag_dyneither(_tmp497,sizeof(void*),1)))))))));}goto _LL186;_LL191: {struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*_tmp249=(struct Cyc_Absyn_Char_p_Absyn_Raw_pat_struct*)_tmp240;if(_tmp249->tag != 10)goto _LL193;else{_tmp24A=_tmp249->f1;}}_LL192:
# 1016
{const char*_tmp499;Cyc_Absyndump_dump(((_tmp499="'",_tag_dyneither(_tmp499,sizeof(char),2))));}Cyc_Absyndump_dump_nospace(Cyc_Absynpp_char_escape(_tmp24A));{const char*_tmp49A;Cyc_Absyndump_dump_nospace(((_tmp49A="'",_tag_dyneither(_tmp49A,sizeof(char),2))));}goto _LL186;_LL193: {struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*_tmp24B=(struct Cyc_Absyn_Float_p_Absyn_Raw_pat_struct*)_tmp240;if(_tmp24B->tag != 11)goto _LL195;else{_tmp24C=_tmp24B->f1;}}_LL194:
 ...
 Cyc_Absyndump_dumpqvar(_tmp251->name);{const char*_tmp49B;Cyc_Absyndump_dump(((_tmp49B=" as ",_tag_dyneither(_tmp49B,sizeof(char),5))));}Cyc_Absyndump_dumppat(_tmp252);goto _LL186;_LL199: {struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*_tmp253=(struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp240;if(_tmp253->tag != 4)goto _LL19B;else{_tmp254=_tmp253->f1;_tmp255=_tmp253->f2;}}_LL19A: {
# 1021
const char*_tmp49D;const char*_tmp49C;struct _dyneither_ptr term=_tmp255?(_tmp49D=", ...)",_tag_dyneither(_tmp49D,sizeof(char),7)):((_tmp49C=")",_tag_dyneither(_tmp49C,sizeof(char),2)));
{const char*_tmp49F;const char*_tmp49E;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp254,((_tmp49E="$(",_tag_dyneither(_tmp49E,sizeof(char),3))),term,((_tmp49F=",",_tag_dyneither(_tmp49F,sizeof(char),2))));}goto _LL186;}_LL19B: {struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*_tmp256=(struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp240;if(_tmp256->tag != 5)goto _LL19D;else{_tmp257=_tmp256->f1;}}_LL19C:
{const char*_tmp4A0;Cyc_Absyndump_dump(((_tmp4A0="&",_tag_dyneither(_tmp4A0,sizeof(char),2))));}Cyc_Absyndump_dumppat(_tmp257);goto _LL186;_LL19D: {struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*_tmp258=(struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp240;if(_tmp258->tag != 2)goto _LL19F;else{_tmp259=_tmp258->f1;{struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*_tmp25A=(struct Cyc_Absyn_Wild_p_Absyn_Raw_pat_struct*)(_tmp258->f2)->r;if(_tmp25A->tag != 0)goto _LL19F;};}}_LL19E:
# 1025
{const char*_tmp4A1;Cyc_Absyndump_dump(((_tmp4A1="*",_tag_dyneither(_tmp4A1,sizeof(char),2))));}Cyc_Absyndump_dumpqvar(_tmp259->name);goto _LL186;_LL19F: {struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*_tmp25B=(struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp240;if(_tmp25B->tag != 2)goto _LL1A1;else{_tmp25C=_tmp25B->f1;_tmp25D=_tmp25B->f2;}}_LL1A0:
# 1027
{const char*_tmp4A2;Cyc_Absyndump_dump(((_tmp4A2="*",_tag_dyneither(_tmp4A2,sizeof(char),2))));}Cyc_Absyndump_dumpqvar(_tmp25C->name);{const char*_tmp4A3;Cyc_Absyndump_dump(((_tmp4A3=" as ",_tag_dyneither(_tmp4A3,sizeof(char),5))));}Cyc_Absyndump_dumppat(_tmp25D);goto _LL186;_LL1A1: {struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*_tmp25E=(struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp240;if(_tmp25E->tag != 3)goto _LL1A3;else{_tmp25F=_tmp25E->f1;_tmp260=_tmp25E->f2;}}_LL1A2:
# 1029
...
# 1032
const char*_tmp4A5;const char*_tmp4A4;struct _dyneither_ptr term=_tmp266?(_tmp4A5=", ...)",_tag_dyneither(_tmp4A5,sizeof(char),7)):((_tmp4A4=")",_tag_dyneither(_tmp4A4,sizeof(char),2)));
Cyc_Absyndump_dumpqvar(_tmp264);{const char*_tmp4A7;const char*_tmp4A6;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp265,((_tmp4A6="(",_tag_dyneither(_tmp4A6,sizeof(char),2))),term,((_tmp4A7=",",_tag_dyneither(_tmp4A7,sizeof(char),2))));}goto _LL186;}_LL1A7: {struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp267=(struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp240;if(_tmp267->tag != 6)goto _LL1A9;else{if(_tmp267->f1 == 0)goto _LL1A9;_tmp268=(_tmp267->f1)->aggr_info;_tmp269=_tmp267->f2;_tmp26A=_tmp267->f3;_tmp26B=_tmp267->f4;}}_LL1A8: {
# 1035
struct _tuple0*_tmp291;struct _tuple10 _tmp290=Cyc_Absyn_aggr_kinded_name(_tmp268);_tmp291=_tmp290.f2;{
const char*_tmp4A9;const char*_tmp4A8;struct _dyneither_ptr term=_tmp26B?(_tmp4A9=", ...)",_tag_dyneither(_tmp4A9,sizeof(char),7)):((_tmp4A8=")",_tag_dyneither(_tmp4A8,sizeof(char),2)));
Cyc_Absyndump_dumpqvar(_tmp291);Cyc_Absyndump_dump_char((int)'{');
{const char*_tmp4AC;const char*_tmp4AB;const char*_tmp4AA;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp269,((_tmp4AA="[",_tag_dyneither(_tmp4AA,sizeof(char),2))),((_tmp4AB="]",_tag_dyneither(_tmp4AB,sizeof(char),2))),((_tmp4AC=",",_tag_dyneither(_tmp4AC,sizeof(char),2))));}
{const char*_tmp4AE;const char*_tmp4AD;((void(*)(void(*f)(struct _tuple18*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpdp,_tmp26A,((_tmp4AD="",_tag_dyneither(_tmp4AD,sizeof(char),1))),term,((_tmp4AE=",",_tag_dyneither(_tmp4AE,sizeof(char),2))));}
...
# 1042
const char*_tmp4B0;const char*_tmp4AF;struct _dyneither_ptr term=_tmp26F?(_tmp4B0=", ...)",_tag_dyneither(_tmp4B0,sizeof(char),7)):((_tmp4AF=")",_tag_dyneither(_tmp4AF,sizeof(char),2)));
Cyc_Absyndump_dump_char((int)'{');
{const char*_tmp4B3;const char*_tmp4B2;const char*_tmp4B1;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,_tmp26D,((_tmp4B1="[",_tag_dyneither(_tmp4B1,sizeof(char),2))),((_tmp4B2="]",_tag_dyneither(_tmp4B2,sizeof(char),2))),((_tmp4B3=",",_tag_dyneither(_tmp4B3,sizeof(char),2))));}
{const char*_tmp4B5;const char*_tmp4B4;((void(*)(void(*f)(struct _tuple18*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpdp,_tmp26E,((_tmp4B4="",_tag_dyneither(_tmp4B4,sizeof(char),1))),term,((_tmp4B5=",",_tag_dyneither(_tmp4B5,sizeof(char),2))));}
...
# 1048
const char*_tmp4B7;const char*_tmp4B6;struct _dyneither_ptr term=_tmp273?(_tmp4B7=", ...)",_tag_dyneither(_tmp4B7,sizeof(char),7)):((_tmp4B6=")",_tag_dyneither(_tmp4B6,sizeof(char),2)));
Cyc_Absyndump_dumpqvar(_tmp271->name);
if(_tmp272 != 0){const char*_tmp4B9;const char*_tmp4B8;((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp272,((_tmp4B8="(",_tag_dyneither(_tmp4B8,sizeof(char),2))),term,((_tmp4B9=",",_tag_dyneither(_tmp4B9,sizeof(char),2))));}
...
const char*_tmp4BA;((void(*)(void(*f)(struct Cyc_Absyn_Datatypefield*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpdatatypefield,fields,((_tmp4BA=",",_tag_dyneither(_tmp4BA,sizeof(char),2))));}
# 1066
void Cyc_Absyndump_dumpenumfield(struct Cyc_Absyn_Enumfield*ef){
Cyc_Absyndump_dumpqvar(ef->name);
if(ef->tag != 0){
{const char*_tmp4BB;Cyc_Absyndump_dump(((_tmp4BB=" = ",_tag_dyneither(_tmp4BB,sizeof(char),4))));}
Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_check_null(ef->tag));}}
# 1073
void Cyc_Absyndump_dumpenumfields(struct Cyc_List_List*fields){
const char*_tmp4BC;((void(*)(void(*f)(struct Cyc_Absyn_Enumfield*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(Cyc_Absyndump_dumpenumfield,fields,((_tmp4BC=",",_tag_dyneither(_tmp4BC,sizeof(char),2))));}
# 1077
void Cyc_Absyndump_dumpaggrfields(struct Cyc_List_List*fields){
...
{const char*_tmp4BD;Cyc_Absyndump_dump(((_tmp4BD="_stdcall",_tag_dyneither(_tmp4BD,sizeof(char),9))));}goto _LL1B6;_LL1BB: {struct Cyc_Absyn_Cdecl_att_Absyn_Attribute_struct*_tmp2B0=(struct Cyc_Absyn_Cdecl_att_Absyn_Attribute_struct*)_tmp2AD;if(_tmp2B0->tag != 2)goto _LL1BD;}_LL1BC:
{const char*_tmp4BE;Cyc_Absyndump_dump(((_tmp4BE="_cdecl",_tag_dyneither(_tmp4BE,sizeof(char),7))));}goto _LL1B6;_LL1BD: {struct Cyc_Absyn_Fastcall_att_Absyn_Attribute_struct*_tmp2B1=(struct Cyc_Absyn_Fastcall_att_Absyn_Attribute_struct*)_tmp2AD;if(_tmp2B1->tag != 3)goto _LL1BF;}_LL1BE:
{const char*_tmp4BF;Cyc_Absyndump_dump(((_tmp4BF="_fastcall",_tag_dyneither(_tmp4BF,sizeof(char),10))));}goto _LL1B6;_LL1BF:;_LL1C0:
 goto _LL1B6;_LL1B6:;}
# 1117
...
void*_tmp2B5=t;void*_tmp2B7;void*_tmp2B9;_LL1C2:{struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmp2B6=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp2B5;if(_tmp2B6->tag != 1)goto _LL1C4;else{_tmp2B7=(void*)_tmp2B6->f2;}}if(!(_tmp2B7 != 0))goto _LL1C4;_LL1C3:
 return Cyc_Absyndump_is_char_ptr(_tmp2B7);_LL1C4: {struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp2B8=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp2B5;if(_tmp2B8->tag != 5)goto _LL1C6;else{_tmp2B9=(_tmp2B8->f1).elt_typ;}}_LL1C5:
# 1136
 L: {
void*_tmp2BA=_tmp2B9;void*_tmp2BC;void*_tmp2BE;_LL1C9:{struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmp2BB=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp2BA;if(_tmp2BB->tag != 1)goto _LL1CB;else{_tmp2BC=(void*)_tmp2BB->f2;}}if(!(_tmp2BC != 0))goto _LL1CB;_LL1CA:
 _tmp2B9=_tmp2BC;goto L;_LL1CB:{struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmp2BD=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp2BA;if(_tmp2BD->tag != 17)goto _LL1CD;else{_tmp2BE=(void*)_tmp2BD->f4;}}if(!(_tmp2BE != 0))goto _LL1CD;_LL1CC:
 _tmp2B9=_tmp2BE;goto L;_LL1CD: {struct Cyc_Absyn_IntType_Absyn_Type_struct*_tmp2BF=(struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp2BA;if(_tmp2BF->tag != 6)goto _LL1CF;else{if(_tmp2BF->f2 != Cyc_Absyn_Char_sz)goto _LL1CF;}}_LL1CE:
...
struct _tuple19 _tmp4C0;struct _tuple19 _tmp2D5=(_tmp4C0.f1=call_conv,((_tmp4C0.f2=_tmp2C2,_tmp4C0)));
...
const char*_tmp4C1;Cyc_Absyndump_dump(((_tmp4C1="@tagged ",_tag_dyneither(_tmp4C1,sizeof(char),9))));}
...
const char*_tmp4C4;const char*_tmp4C3;const char*_tmp4C2;((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->exist_vars,((_tmp4C2="<",_tag_dyneither(_tmp4C2,sizeof(char),2))),((_tmp4C3=">",_tag_dyneither(_tmp4C3,sizeof(char),2))),((_tmp4C4=",",_tag_dyneither(_tmp4C4,sizeof(char),2))));}
...
{const char*_tmp4C5;Cyc_Absyndump_dump(((_tmp4C5="}",_tag_dyneither(_tmp4C5,sizeof(char),2))));}
...
{const char*_tmp4C6;Cyc_Absyndump_dump(((_tmp4C6="enum ",_tag_dyneither(_tmp4C6,sizeof(char),6))));}
Cyc_Absyndump_dumpqvar(_tmp2DE);
if(_tmp2DF != 0){
Cyc_Absyndump_dump_char((int)'{');
Cyc_Absyndump_dumpenumfields((struct Cyc_List_List*)_tmp2DF->v);{
const char*_tmp4C7;Cyc_Absyndump_dump_nospace(((_tmp4C7="}",_tag_dyneither(_tmp4C7,sizeof(char),2))));};}}
# 1230
...
if(_tmp2E7){const char*_tmp4C8;Cyc_Absyndump_dump(((_tmp4C8="@extensible ",_tag_dyneither(_tmp4C8,sizeof(char),13))));}
{const char*_tmp4C9;Cyc_Absyndump_dump(((_tmp4C9="datatype ",_tag_dyneither(_tmp4C9,sizeof(char),10))));}
...
enum Cyc_Cyclone_C_Compilers _tmp312=Cyc_Cyclone_c_compiler;enum Cyc_Cyclone_C_Compilers _tmp313;_LL20C: if(_tmp312 != Cyc_Cyclone_Vc_c)goto _LL20E;_LL20D:
{const char*_tmp4CB;Cyc_Absyndump_dump(((_tmp4CB="__inline",_tag_dyneither(_tmp4CB,sizeof(char),9))));}goto _LL20B;_LL20E: _tmp313=_tmp312;_LL20F:
{const char*_tmp4CC;Cyc_Absyndump_dump(((_tmp4CC="inline",_tag_dyneither(_tmp4CC,sizeof(char),7))));}goto _LL20B;_LL20B:;}
# 1261
Cyc_Absyndump_dumpscope(_tmp2EF->sc);{
struct Cyc_Absyn_FnType_Absyn_Type_struct _tmp4D2;struct Cyc_Absyn_FnInfo _tmp4D1;struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp4D0;void*t=(void*)((_tmp4D0=_cycalloc(sizeof(*_tmp4D0)),((_tmp4D0[0]=((_tmp4D2.tag=9,((_tmp4D2.f1=((_tmp4D1.tvars=_tmp2EF->tvs,((_tmp4D1.effect=_tmp2EF->effect,((_tmp4D1.ret_tqual=_tmp2EF->ret_tqual,((_tmp4D1.ret_typ=_tmp2EF->ret_type,((_tmp4D1.args=
# 1264
((struct Cyc_List_List*(*)(struct _tuple8*(*f)(struct _tuple8*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Absynpp_arg_mk_opt,_tmp2EF->args),((_tmp4D1.c_varargs=_tmp2EF->c_varargs,((_tmp4D1.cyc_varargs=_tmp2EF->cyc_varargs,((_tmp4D1.rgn_po=_tmp2EF->rgn_po,((_tmp4D1.attributes=0,_tmp4D1)))))))))))))))))),_tmp4D2)))),_tmp4D0))));
# 1267
...
# 1289
{const char*_tmp4D3;Cyc_Absyndump_dump(((_tmp4D3="let",_tag_dyneither(_tmp4D3,sizeof(char),4))));}
...
# 1296
{const char*_tmp4D4;Cyc_Absyndump_dump(((_tmp4D4="let ",_tag_dyneither(_tmp4D4,sizeof(char),5))));}
...
# 1301
{const char*_tmp4D5;Cyc_Absyndump_dump(((_tmp4D5="region",_tag_dyneither(_tmp4D5,sizeof(char),7))));}
{const char*_tmp4D6;Cyc_Absyndump_dump(((_tmp4D6="<",_tag_dyneither(_tmp4D6,sizeof(char),2))));}Cyc_Absyndump_dumptvar(_tmp2FC);{const char*_tmp4D7;Cyc_Absyndump_dump(((_tmp4D7="> ",_tag_dyneither(_tmp4D7,sizeof(char),3))));}Cyc_Absyndump_dumpqvar(_tmp2FD->name);
if(_tmp2FE){const char*_tmp4D8;Cyc_Absyndump_dump(((_tmp4D8="@resetable",_tag_dyneither(_tmp4D8,sizeof(char),11))));}
if(_tmp2FF != 0){
{const char*_tmp4D9;Cyc_Absyndump_dump(((_tmp4D9=" = open(",_tag_dyneither(_tmp4D9,sizeof(char),9))));}
Cyc_Absyndump_dumpexp(_tmp2FF);{
const char*_tmp4DA;Cyc_Absyndump_dump(((_tmp4DA=")",_tag_dyneither(_tmp4DA,sizeof(char),2))));};}
# 1309
Cyc_Absyndump_dump_semi();
goto _LL1E7;_LL1F8: {struct Cyc_Absyn_Alias_d_Absyn_Raw_decl_struct*_tmp300=(struct Cyc_Absyn_Alias_d_Absyn_Raw_decl_struct*)_tmp2EB;if(_tmp300->tag != 5)goto _LL1FA;else{_tmp301=_tmp300->f1;_tmp302=_tmp300->f2;}}_LL1F9:
# 1312
{const char*_tmp4DB;Cyc_Absyndump_dump(((_tmp4DB="alias",_tag_dyneither(_tmp4DB,sizeof(char),6))));}
{const char*_tmp4DC;Cyc_Absyndump_dump(((_tmp4DC="<",_tag_dyneither(_tmp4DC,sizeof(char),2))));}Cyc_Absyndump_dumptvar(_tmp301);{const char*_tmp4DD;Cyc_Absyndump_dump(((_tmp4DD=">",_tag_dyneither(_tmp4DD,sizeof(char),2))));}
Cyc_Absyndump_dumpvardecl(_tmp302,d->loc);
goto _LL1E7;_LL1FA: {struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*_tmp303=(struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp2EB;if(_tmp303->tag != 9)goto _LL1FC;else{_tmp304=_tmp303->f1;}}_LL1FB:
# 1321
{const char*_tmp4DE;Cyc_Absyndump_dump(((_tmp4DE="typedef",_tag_dyneither(_tmp4DE,sizeof(char),8))));}{
void*t;
if(_tmp304->defn == 0)
t=Cyc_Absyn_new_evar(_tmp304->kind,0);else{
# 1326
t=(void*)_check_null(_tmp304->defn);}
((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct Cyc_Absyn_Typedefdecl*),struct Cyc_Absyn_Typedefdecl*))Cyc_Absyndump_dumptqtd)(_tmp304->tq,t,Cyc_Absyndump_dumptypedefname,_tmp304);
Cyc_Absyndump_dumpatts(_tmp304->atts);
Cyc_Absyndump_dump_semi();
# 1331
goto _LL1E7;};_LL1FC: {struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*_tmp305=(struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp2EB;if(_tmp305->tag != 10)goto _LL1FE;else{_tmp306=_tmp305->f1;_tmp307=_tmp305->f2;}}_LL1FD:
# 1333
{const char*_tmp4DF;Cyc_Absyndump_dump(((_tmp4DF="namespace ",_tag_dyneither(_tmp4DF,sizeof(char),11))));}
Cyc_Absyndump_dump_str(_tmp306);
Cyc_Absyndump_dump_char((int)'{');
for(0;_tmp307 != 0;_tmp307=_tmp307->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp307->hd);}
Cyc_Absyndump_dump_char((int)'}');
goto _LL1E7;_LL1FE: {struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*_tmp308=(struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp2EB;if(_tmp308->tag != 11)goto _LL200;else{_tmp309=_tmp308->f1;_tmp30A=_tmp308->f2;}}_LL1FF:
# 1341
{const char*_tmp4E0;Cyc_Absyndump_dump(((_tmp4E0="using ",_tag_dyneither(_tmp4E0,sizeof(char),7))));}
Cyc_Absyndump_dumpqvar(_tmp309);
Cyc_Absyndump_dump_char((int)'{');
for(0;_tmp30A != 0;_tmp30A=_tmp30A->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp30A->hd);}
Cyc_Absyndump_dump_char((int)'}');
goto _LL1E7;_LL200: {struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*_tmp30B=(struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp2EB;if(_tmp30B->tag != 12)goto _LL202;else{_tmp30C=_tmp30B->f1;}}_LL201:
# 1349
{const char*_tmp4E1;Cyc_Absyndump_dump(((_tmp4E1="extern \"C\" {",_tag_dyneither(_tmp4E1,sizeof(char),13))));}
for(0;_tmp30C != 0;_tmp30C=_tmp30C->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp30C->hd);}
Cyc_Absyndump_dump_char((int)'}');
goto _LL1E7;_LL202: {struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*_tmp30D=(struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp2EB;if(_tmp30D->tag != 13)goto _LL204;else{_tmp30E=_tmp30D->f1;_tmp30F=_tmp30D->f2;}}_LL203:
# 1355
{const char*_tmp4E2;Cyc_Absyndump_dump(((_tmp4E2="extern \"C include\" {",_tag_dyneither(_tmp4E2,sizeof(char),21))));}
for(0;_tmp30E != 0;_tmp30E=_tmp30E->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp30E->hd);}
Cyc_Absyndump_dump_char((int)'}');
if(_tmp30F != 0){
{const char*_tmp4E3;Cyc_Absyndump_dump(((_tmp4E3=" export {",_tag_dyneither(_tmp4E3,sizeof(char),10))));}
for(0;_tmp30F != 0;_tmp30F=_tmp30F->tl){
struct _tuple0*_tmp32B;struct _tuple20 _tmp32A=*((struct _tuple20*)_tmp30F->hd);_tmp32B=_tmp32A.f2;
Cyc_Absyndump_dumpqvar(_tmp32B);
if(_tmp30F->tl != 0)Cyc_Absyndump_dump_char((int)',');}{
# 1366
const char*_tmp4E4;Cyc_Absyndump_dump(((_tmp4E4="}",_tag_dyneither(_tmp4E4,sizeof(char),2))));};}
# 1368
goto _LL1E7;_LL204: {struct Cyc_Absyn_Porton_d_Absyn_Raw_decl_struct*_tmp310=(struct Cyc_Absyn_Porton_d_Absyn_Raw_decl_struct*)_tmp2EB;if(_tmp310->tag != 14)goto _LL206;}_LL205:
# 1370
{const char*_tmp4E5;Cyc_Absyndump_dump(((_tmp4E5=" __cyclone_port_on__; ",_tag_dyneither(_tmp4E5,sizeof(char),23))));}
goto _LL1E7;_LL206: {struct Cyc_Absyn_Portoff_d_Absyn_Raw_decl_struct*_tmp311=(struct Cyc_Absyn_Portoff_d_Absyn_Raw_decl_struct*)_tmp2EB;if(_tmp311->tag != 15)goto _LL1E7;}_LL207:
# 1373
{const char*_tmp4E6;Cyc_Absyndump_dump(((_tmp4E6=" __cyclone_port_off__; ",_tag_dyneither(_tmp4E6,sizeof(char),24))));}
goto _LL1E7;_LL1E7:;};}
# 1378
...
return;}{
# 1390
void*_tmp32F=(void*)tms->hd;void*_tmp331;union Cyc_Absyn_Constraint*_tmp332;union Cyc_Absyn_Constraint*_tmp333;union Cyc_Absyn_Constraint*_tmp334;struct Cyc_Absyn_Tqual _tmp335;_LL214: {struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*_tmp330=(struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp32F;if(_tmp330->tag != 2)goto _LL216;else{_tmp331=(_tmp330->f1).rgn;_tmp332=(_tmp330->f1).nullable;_tmp333=(_tmp330->f1).bounds;_tmp334=(_tmp330->f1).zero_term;_tmp335=_tmp330->f2;}}_LL215:
# 1394
{void*_tmp336=((void*(*)(void*y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(Cyc_Absyn_bounds_one,_tmp333);struct Cyc_Absyn_Exp*_tmp339;_LL219: {struct Cyc_Absyn_DynEither_b_Absyn_Bounds_struct*_tmp337=(struct Cyc_Absyn_DynEither_b_Absyn_Bounds_struct*)_tmp336;if(_tmp337->tag != 0)goto _LL21B;}_LL21A:
 Cyc_Absyndump_dump_char((int)'?');goto _LL218;_LL21B: {struct Cyc_Absyn_Upper_b_Absyn_Bounds_struct*_tmp338=(struct Cyc_Absyn_Upper_b_Absyn_Bounds_struct*)_tmp336;if(_tmp338->tag != 1)goto _LL218;else{_tmp339=_tmp338->f1;}}_LL21C:
# 1397
 Cyc_Absyndump_dump_char((int)(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(1,_tmp332)?'*':'@'));
Cyc_Absyndump_dump_upperbound(_tmp339);
goto _LL218;_LL218:;}
# 1401
if((!Cyc_Absyndump_qvar_to_Cids  && !is_char_ptr) && ((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp334)){const char*_tmp4E7;Cyc_Absyndump_dump(((_tmp4E7="@zeroterm",_tag_dyneither(_tmp4E7,sizeof(char),10))));}
if((!Cyc_Absyndump_qvar_to_Cids  && is_char_ptr) && !((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp334)){const char*_tmp4E8;Cyc_Absyndump_dump(((_tmp4E8="@nozeroterm",_tag_dyneither(_tmp4E8,sizeof(char),12))));}
{void*_tmp33C=Cyc_Tcutil_compress(_tmp331);struct Cyc_Absyn_Tvar*_tmp341;_LL21E: {struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*_tmp33D=(struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*)_tmp33C;if(_tmp33D->tag != 20)goto _LL220;}_LL21F:
 if(!Cyc_Absyndump_qvar_to_Cids){const char*_tmp4E9;Cyc_Absyndump_dump(((_tmp4E9="`H",_tag_dyneither(_tmp4E9,sizeof(char),3))));}goto _LL21D;_LL220: {struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*_tmp33E=(struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*)_tmp33C;if(_tmp33E->tag != 21)goto _LL222;}_LL221:
{const char*_tmp4EA;Cyc_Absyndump_dump(((_tmp4EA="`U",_tag_dyneither(_tmp4EA,sizeof(char),3))));}goto _LL21D;_LL222: {struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*_tmp33F=(struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*)_tmp33C;if(_tmp33F->tag != 22)goto _LL224;}_LL223:
{const char*_tmp4EB;Cyc_Absyndump_dump(((_tmp4EB="`RC",_tag_dyneither(_tmp4EB,sizeof(char),4))));}goto _LL21D;_LL224: {struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp340=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp33C;if(_tmp340->tag != 2)goto _LL226;else{_tmp341=_tmp340->f1;}}_LL225:
 Cyc_Absyndump_dumptvar(_tmp341);goto _LL21D;_LL226: {struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmp342=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp33C;if(_tmp342->tag != 1)goto _LL228;else{if((void*)_tmp342->f2 != 0)goto _LL228;}}_LL227:
 Cyc_Absyndump_dumpntyp(Cyc_Tcutil_compress(_tmp331));goto _LL21D;_LL228: {struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmp343=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp33C;if(_tmp343->tag != 17)goto _LL22A;}_LL229:
{const char*_tmp4EC;Cyc_Absyndump_dump(((_tmp4EC="@region(",_tag_dyneither(_tmp4EC,sizeof(char),9))));}Cyc_Absyndump_dumptyp(_tmp331);{const char*_tmp4ED;Cyc_Absyndump_dump(((_tmp4ED=")",_tag_dyneither(_tmp4ED,sizeof(char),2))));}goto _LL21D;_LL22A:;_LL22B: {
const char*_tmp4F0;void*_tmp4EF;(_tmp4EF=0,Cyc_Tcutil_impos(((_tmp4F0="dumptms: bad rgn type in Pointer_mod",_tag_dyneither(_tmp4F0,sizeof(char),37))),_tag_dyneither(_tmp4EF,sizeof(void*),0)));}_LL21D:;}
# 1412
Cyc_Absyndump_dumptq(_tmp335);
Cyc_Absyndump_dumptms(0,tms->tl,f,a);
return;_LL216:;_LL217: {
# 1417
int next_is_pointer=0;
if(tms->tl != 0){
void*_tmp34B=(void*)((struct Cyc_List_List*)_check_null(tms->tl))->hd;_LL22D: {struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*_tmp34C=(struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp34B;if(_tmp34C->tag != 2)goto _LL22F;}_LL22E:
...
if(next_is_pointer)
Cyc_Absyndump_dump_char((int)')');
{void*_tmp34D=(void*)tms->hd;union Cyc_Absyn_Constraint*_tmp34F;struct Cyc_Absyn_Exp*_tmp351;union Cyc_Absyn_Constraint*_tmp352;struct Cyc_List_List*_tmp355;int _tmp356;struct Cyc_Absyn_VarargInfo*_tmp357;void*_tmp358;struct Cyc_List_List*_tmp359;struct Cyc_List_List*_tmp35C;unsigned int _tmp35D;struct Cyc_List_List*_tmp35F;unsigned int _tmp360;int _tmp361;struct Cyc_List_List*_tmp363;_LL232: {struct Cyc_Absyn_Carray_mod_Absyn_Type_modifier_struct*_tmp34E=(struct Cyc_Absyn_Carray_mod_Absyn_Type_modifier_struct*)_tmp34D;if(_tmp34E->tag != 0)goto _LL234;else{_tmp34F=_tmp34E->f1;}}_LL233:
# 1430
{const char*_tmp4F1;Cyc_Absyndump_dump(((_tmp4F1="[]",_tag_dyneither(_tmp4F1,sizeof(char),3))));}
if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp34F)){const char*_tmp4F2;Cyc_Absyndump_dump(((_tmp4F2="@zeroterm",_tag_dyneither(_tmp4F2,sizeof(char),10))));}
goto _LL231;_LL234: {struct Cyc_Absyn_ConstArray_mod_Absyn_Type_modifier_struct*_tmp350=(struct Cyc_Absyn_ConstArray_mod_Absyn_Type_modifier_struct*)_tmp34D;if(_tmp350->tag != 1)goto _LL236;else{_tmp351=_tmp350->f1;_tmp352=_tmp350->f2;}}_LL235:
# 1434
 Cyc_Absyndump_dump_char((int)'[');Cyc_Absyndump_dumpexp(_tmp351);Cyc_Absyndump_dump_char((int)']');
if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp352)){const char*_tmp4F3;Cyc_Absyndump_dump(((_tmp4F3="@zeroterm",_tag_dyneither(_tmp4F3,sizeof(char),10))));}
goto _LL231;_LL236: {struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*_tmp353=(struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp34D;if(_tmp353->tag != 3)goto _LL238;else{struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*_tmp354=(struct Cyc_Absyn_WithTypes_Absyn_Funcparams_struct*)((void*)_tmp353->f1);if(_tmp354->tag != 1)goto _LL238;else{_tmp355=_tmp354->f1;_tmp356=_tmp354->f2;_tmp357=_tmp354->f3;_tmp358=(void*)_tmp354->f4;_tmp359=_tmp354->f5;}}}_LL237:
# 1438
 Cyc_Absyndump_dumpfunargs(_tmp355,_tmp356,_tmp357,_tmp358,_tmp359);goto _LL231;_LL238: {struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*_tmp35A=(struct Cyc_Absyn_Function_mod_Absyn_Type_modifier_struct*)_tmp34D;if(_tmp35A->tag != 3)goto _LL23A;else{struct Cyc_Absyn_NoTypes_Absyn_Funcparams_struct*_tmp35B=(struct Cyc_Absyn_NoTypes_Absyn_Funcparams_struct*)((void*)_tmp35A->f1);if(_tmp35B->tag != 0)goto _LL23A;else{_tmp35C=_tmp35B->f1;_tmp35D=_tmp35B->f2;}}}_LL239:
# 1440
{const char*_tmp4F6;const char*_tmp4F5;const char*_tmp4F4;((void(*)(void(*f)(struct _dyneither_ptr*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dump_str,_tmp35C,((_tmp4F4="(",_tag_dyneither(_tmp4F4,sizeof(char),2))),((_tmp4F5=")",_tag_dyneither(_tmp4F5,sizeof(char),2))),((_tmp4F6=",",_tag_dyneither(_tmp4F6,sizeof(char),2))));}goto _LL231;_LL23A: {struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*_tmp35E=(struct Cyc_Absyn_TypeParams_mod_Absyn_Type_modifier_struct*)_tmp34D;if(_tmp35E->tag != 4)goto _LL23C;else{_tmp35F=_tmp35E->f1;_tmp360=_tmp35E->f2;_tmp361=_tmp35E->f3;}}_LL23B:
# 1442
 if(_tmp361)Cyc_Absyndump_dumpkindedtvars(_tmp35F);else{Cyc_Absyndump_dumptvars(_tmp35F);}goto _LL231;_LL23C: {struct Cyc_Absyn_Attributes_mod_Absyn_Type_modifier_struct*_tmp362=(struct Cyc_Absyn_Attributes_mod_Absyn_Type_modifier_struct*)_tmp34D;if(_tmp362->tag != 5)goto _LL23E;else{_tmp363=_tmp362->f2;}}_LL23D:
 Cyc_Absyndump_dumpatts(_tmp363);goto _LL231;_LL23E: {struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*_tmp364=(struct Cyc_Absyn_Pointer_mod_Absyn_Type_modifier_struct*)_tmp34D;if(_tmp364->tag != 2)goto _LL231;}_LL23F: {
const char*_tmp4F9;void*_tmp4F8;(_tmp4F8=0,Cyc_Tcutil_impos(((_tmp4F9="dumptms",_tag_dyneither(_tmp4F9,sizeof(char),8))),_tag_dyneither(_tmp4F8,sizeof(void*),0)));}_LL231:;}
# 1446
return;}_LL213:;};}
# 1450
void Cyc_Absyndump_dumptqtd(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(void*),void*a){
int _tmp36D=Cyc_Absyndump_is_char_ptr(t);
struct _RegionHandle _tmp36E=_new_region("temp");struct _RegionHandle*temp=& _tmp36E;_push_region(temp);
{struct Cyc_Absyn_Tqual _tmp370;void*_tmp371;struct Cyc_List_List*_tmp372;struct _tuple11 _tmp36F=Cyc_Absynpp_to_tms(temp,tq,t);_tmp370=_tmp36F.f1;_tmp371=_tmp36F.f2;_tmp372=_tmp36F.f3;
Cyc_Absyndump_dumptq(_tmp370);
Cyc_Absyndump_dumpntyp(_tmp371);
Cyc_Absyndump_dumptms(_tmp36D,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp372),f,a);}
# 1453
;_pop_region(temp);}
# 1460
...
const char*_tmp4FC;void*_tmp4FB;(_tmp4FB=0,Cyc_fprintf(f,((_tmp4FC="\n",_tag_dyneither(_tmp4FC,sizeof(char),2))),_tag_dyneither(_tmp4FB,sizeof(void*),0)));};}
# 1468
static void Cyc_Absyndump_dump_decl_interface(struct Cyc_Absyn_Decl*d){
void*_tmp375=d->r;struct Cyc_Absyn_Vardecl*_tmp377;struct Cyc_Absyn_Fndecl*_tmp379;struct Cyc_Absyn_Aggrdecl*_tmp37B;struct Cyc_Absyn_Datatypedecl*_tmp37D;struct Cyc_Absyn_Enumdecl*_tmp37F;struct Cyc_Absyn_Typedefdecl*_tmp381;struct _dyneither_ptr*_tmp383;struct Cyc_List_List*_tmp384;struct Cyc_List_List*_tmp386;struct Cyc_List_List*_tmp388;struct Cyc_List_List*_tmp38A;struct Cyc_List_List*_tmp38B;_LL241: {struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp376=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp375;if(_tmp376->tag != 0)goto _LL243;else{_tmp377=_tmp376->f1;}}_LL242:
# 1471
 if(_tmp377->sc == Cyc_Absyn_Static)return;{
struct Cyc_Absyn_Exp*init=_tmp377->initializer;
_tmp377->initializer=0;
if(_tmp377->sc == Cyc_Absyn_Public){
const char*_tmp4FD;Cyc_Absyndump_dump(((_tmp4FD="extern ",_tag_dyneither(_tmp4FD,sizeof(char),8))));}
Cyc_Absyndump_dumpvardecl(_tmp377,d->loc);
{const char*_tmp4FE;Cyc_Absyndump_dump(((_tmp4FE="\n",_tag_dyneither(_tmp4FE,sizeof(char),2))));}
_tmp377->initializer=init;
goto _LL240;};_LL243: {struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*_tmp378=(struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp375;if(_tmp378->tag != 1)goto _LL245;else{_tmp379=_tmp378->f1;}}_LL244:
# 1481
 if(_tmp379->sc == Cyc_Absyn_Static)return;
Cyc_Absyndump_dumpscope(_tmp379->sc);{
struct Cyc_Absyn_FnType_Absyn_Type_struct _tmp504;struct Cyc_Absyn_FnInfo _tmp503;struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp502;void*t=(void*)((_tmp502=_cycalloc(sizeof(*_tmp502)),((_tmp502[0]=((_tmp504.tag=9,((_tmp504.f1=((_tmp503.tvars=_tmp379->tvs,((_tmp503.effect=_tmp379->effect,((_tmp503.ret_tqual=_tmp379->ret_tqual,((_tmp503.ret_typ=_tmp379->ret_type,((_tmp503.args=
# 1485
((struct Cyc_List_List*(*)(struct _tuple8*(*f)(struct _tuple8*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Absynpp_arg_mk_opt,_tmp379->args),((_tmp503.c_varargs=_tmp379->c_varargs,((_tmp503.cyc_varargs=_tmp379->cyc_varargs,((_tmp503.rgn_po=_tmp379->rgn_po,((_tmp503.attributes=0,_tmp503)))))))))))))))))),_tmp504)))),_tmp502))));
# 1488
((void(*)(struct Cyc_Absyn_Tqual tq,void*t,void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*a))Cyc_Absyndump_dumptqtd)(Cyc_Absyn_empty_tqual(0),t,Cyc_Absyndump_dump_atts_qvar,_tmp379);
{const char*_tmp505;Cyc_Absyndump_dump(((_tmp505=";\n",_tag_dyneither(_tmp505,sizeof(char),3))));}
goto _LL240;};_LL245: {struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp37A=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp375;if(_tmp37A->tag != 6)goto _LL247;else{_tmp37B=_tmp37A->f1;}}_LL246:
# 1492
 if(_tmp37B->sc == Cyc_Absyn_Static)return;{
struct Cyc_Absyn_AggrdeclImpl*impl=_tmp37B->impl;
if(_tmp37B->sc == Cyc_Absyn_Abstract)_tmp37B->impl=0;
Cyc_Absyndump_dump_aggrdecl(_tmp37B);
_tmp37B->impl=impl;
{const char*_tmp506;Cyc_Absyndump_dump(((_tmp506=";\n",_tag_dyneither(_tmp506,sizeof(char),3))));}
goto _LL240;};_LL247: {struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp37C=(struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp375;if(_tmp37C->tag != 7)goto _LL249;else{_tmp37D=_tmp37C->f1;}}_LL248:
# 1500
 Cyc_Absyndump_dump_datatypedecl(_tmp37D);
{const char*_tmp507;Cyc_Absyndump_dump(((_tmp507=";\n",_tag_dyneither(_tmp507,sizeof(char),3))));}
goto _LL240;_LL249: {struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*_tmp37E=(struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp375;if(_tmp37E->tag != 8)goto _LL24B;else{_tmp37F=_tmp37E->f1;}}_LL24A:
# 1504
 Cyc_Absyndump_dump_enumdecl(_tmp37F);
{const char*_tmp508;Cyc_Absyndump_dump(((_tmp508=";\n",_tag_dyneither(_tmp508,sizeof(char),3))));}
goto _LL240;_LL24B: {struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*_tmp380=(struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp375;if(_tmp380->tag != 9)goto _LL24D;else{_tmp381=_tmp380->f1;}}_LL24C:
# 1508
 if(_tmp381->defn == 0){
Cyc_Absyndump_dumpdecl(d);{
const char*_tmp509;Cyc_Absyndump_dump(((_tmp509="\n",_tag_dyneither(_tmp509,sizeof(char),2))));};}
# 1512
goto _LL240;_LL24D: {struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*_tmp382=(struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp375;if(_tmp382->tag != 10)goto _LL24F;else{_tmp383=_tmp382->f1;_tmp384=_tmp382->f2;}}_LL24E:
# 1514
{const char*_tmp50A;Cyc_Absyndump_dump(((_tmp50A="namespace ",_tag_dyneither(_tmp50A,sizeof(char),11))));}
Cyc_Absyndump_dump_str(_tmp383);
{const char*_tmp50B;Cyc_Absyndump_dump(((_tmp50B="{\n",_tag_dyneither(_tmp50B,sizeof(char),3))));}
for(0;_tmp384 != 0;_tmp384=_tmp384->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)_tmp384->hd);}
{const char*_tmp50C;Cyc_Absyndump_dump(((_tmp50C="}\n",_tag_dyneither(_tmp50C,sizeof(char),3))));}
goto _LL240;_LL24F: {struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*_tmp385=(struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp375;if(_tmp385->tag != 11)goto _LL251;else{_tmp386=_tmp385->f2;}}_LL250:
# 1522
 for(0;_tmp386 != 0;_tmp386=_tmp386->tl){
Cyc_Absyndump_dump_decl_interface((struct Cyc_Absyn_Decl*)_tmp386->hd);}
goto _LL240;_LL251: {struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*_tmp387=(struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp375;if(_tmp387->tag != 12)goto _LL253;else{_tmp388=_tmp387->f1;}}_LL252:
# 1526
...
goto _LL240;_LL253: {struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*_tmp389=(struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp375;if(_tmp389->tag != 13)goto _LL255;else{_tmp38A=_tmp389->f1;_tmp38B=_tmp389->f2;}}_LL254:
# 1547 "absyndump.cyc"
 goto _LL240;_LL255:;_LL256: {
const char*_tmp511;void*_tmp510;(_tmp510=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp511="bad top-level declaration",_tag_dyneither(_tmp511,sizeof(char),26))),_tag_dyneither(_tmp510,sizeof(void*),0)));}_LL240:;}
# 1552
