...
void*_Tmp3=Cyc_Absyn_compress(t);if(*((int*)_Tmp3)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp3)->f1)==20){if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp3)->f2==0){
