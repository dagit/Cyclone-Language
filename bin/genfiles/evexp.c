...
if(!_tmp8){
struct _tuple10 _tmp197;return(_tmp197.f1=0,((_tmp197.f2=0,_tmp197)));}{
...
struct _tuple10 _tmp198;return(_tmp198.f1=(unsigned int)_tmpC,((_tmp198.f2=1,_tmp198)));}_LLA: if((_tmpB.LongLong_c).tag != 6)goto _LLC;_tmpD=((struct _tuple6)(_tmpB.LongLong_c).val).f2;_LLB: {
# 60
unsigned long long y=(unsigned long long)_tmpD >> 32;
if(y != -1  && y != 0){
struct _tuple10 _tmp199;return(_tmp199.f1=0,((_tmp199.f2=0,_tmp199)));}else{
struct _tuple10 _tmp19A;return(_tmp19A.f1=(unsigned int)_tmpD,((_tmp19A.f2=1,_tmp19A)));}}_LLC:;_LLD:
{const char*_tmp19D;void*_tmp19C;(_tmp19C=0,Cyc_Tcutil_terr(e->loc,((_tmp19D="expecting unsigned int",_tag_dyneither(_tmp19D,sizeof(char),23))),_tag_dyneither(_tmp19C,sizeof(void*),0)));}{struct _tuple10 _tmp19E;return(_tmp19E.f1=0,((_tmp19E.f2=1,_tmp19E)));};_LL7:;};}struct _tuple12{int f1;int f2;};
# 68
...
if(!_tmp17){
struct _tuple12 _tmp19F;return(_tmp19F.f1=0,((_tmp19F.f2=0,_tmp19F)));}{
...
struct _tuple12 _tmp1A0;return(_tmp1A0.f1=_tmp1B != 0,((_tmp1A0.f2=1,_tmp1A0)));}_LL11: if((_tmp1A.LongLong_c).tag != 6)goto _LL13;_tmp1C=((struct _tuple6)(_tmp1A.LongLong_c).val).f2;_LL12: {
struct _tuple12 _tmp1A1;return(_tmp1A1.f1=_tmp1C != 0,((_tmp1A1.f2=1,_tmp1A1)));}_LL13: if((_tmp1A.Null_c).tag != 1)goto _LL15;_LL14: {
struct _tuple12 _tmp1A2;return(_tmp1A2.f1=0,((_tmp1A2.f2=0,_tmp1A2)));}_LL15:;_LL16:
{const char*_tmp1A5;void*_tmp1A4;(_tmp1A4=0,Cyc_Tcutil_terr(e->loc,((_tmp1A5="expecting bool",_tag_dyneither(_tmp1A5,sizeof(char),15))),_tag_dyneither(_tmp1A4,sizeof(void*),0)));}{struct _tuple12 _tmp1A6;return(_tmp1A6.f1=0,((_tmp1A6.f2=0,_tmp1A6)));};_LLE:;};}struct _tuple13{enum Cyc_Absyn_Primop f1;union Cyc_Absyn_Cnst f2;};
# 80
...
if(!_tmp26){
struct _tuple11 _tmp1A7;return(_tmp1A7.f1=_tmp25,((_tmp1A7.f2=0,_tmp1A7)));}
{struct _tuple13 _tmp1A8;struct _tuple13 _tmp28=(_tmp1A8.f1=p,((_tmp1A8.f2=_tmp25,_tmp1A8)));struct _tuple13 _tmp29=_tmp28;enum Cyc_Absyn_Sign _tmp2A;int _tmp2B;enum Cyc_Absyn_Sign _tmp2C;int _tmp2D;int _tmp2E;_LL18: if(_tmp29.f1 != Cyc_Absyn_Plus)goto _LL1A;_LL19:
...
{const char*_tmp1AB;void*_tmp1AA;(_tmp1AA=0,Cyc_Tcutil_terr(e->loc,((_tmp1AB="bad constant expression",_tag_dyneither(_tmp1AB,sizeof(char),24))),_tag_dyneither(_tmp1AA,sizeof(void*),0)));}goto _LL17;_LL17:;}{
# 92
struct _tuple11 _tmp1AC;return(_tmp1AC.f1=_tmp25,((_tmp1AC.f2=1,_tmp1AC)));};}struct _tuple14{enum Cyc_Absyn_Primop f1;int f2;};
# 96
...
if(!_tmp36  || !_tmp3A){
struct _tuple11 _tmp1AD;return(_tmp1AD.f1=_tmp35,((_tmp1AD.f2=0,_tmp1AD)));}
...
{const char*_tmp1B0;void*_tmp1AF;(_tmp1AF=0,Cyc_Tcutil_terr(e1->loc,((_tmp1B0="bad constant expression",_tag_dyneither(_tmp1B0,sizeof(char),24))),_tag_dyneither(_tmp1AF,sizeof(void*),0)));}{struct _tuple11 _tmp1B1;return(_tmp1B1.f1=_tmp35,((_tmp1B1.f2=1,_tmp1B1)));};_LL24:;}
# 109
...
{const char*_tmp1B4;void*_tmp1B3;(_tmp1B3=0,Cyc_Tcutil_terr(e2->loc,((_tmp1B4="bad constant expression",_tag_dyneither(_tmp1B4,sizeof(char),24))),_tag_dyneither(_tmp1B3,sizeof(void*),0)));}{struct _tuple11 _tmp1B5;return(_tmp1B5.f1=_tmp35,((_tmp1B5.f2=1,_tmp1B5)));};_LL29:;}
# 113
switch(p){case Cyc_Absyn_Div: _LL2E:
 goto _LL2F;case Cyc_Absyn_Mod: _LL2F:
# 116
 if(i2 == 0){
{const char*_tmp1B8;void*_tmp1B7;(_tmp1B7=0,Cyc_Tcutil_terr(e2->loc,((_tmp1B8="division by zero in constant expression",_tag_dyneither(_tmp1B8,sizeof(char),40))),_tag_dyneither(_tmp1B7,sizeof(void*),0)));}{
struct _tuple11 _tmp1B9;return(_tmp1B9.f1=_tmp35,((_tmp1B9.f2=1,_tmp1B9)));};}
# 120
break;default: _LL30:
 break;}{
# 123
...
int use_u3=0;
int use_b3=0;
{struct _tuple14 _tmp1BA;struct _tuple14 _tmp4B=(_tmp1BA.f1=p,((_tmp1BA.f2=has_u_arg,_tmp1BA)));struct _tuple14 _tmp4C=_tmp4B;_LL33: if(_tmp4C.f1 != Cyc_Absyn_Plus)goto _LL35;if(_tmp4C.f2 != 0)goto _LL35;_LL34:
...
{const char*_tmp1BD;void*_tmp1BC;(_tmp1BC=0,Cyc_Tcutil_terr(e1->loc,((_tmp1BD=">>> NOT IMPLEMENTED",_tag_dyneither(_tmp1BD,sizeof(char),20))),_tag_dyneither(_tmp1BC,sizeof(void*),0)));}goto _LL68;_LL67:;_LL68:
{const char*_tmp1C0;void*_tmp1BF;(_tmp1BF=0,Cyc_Tcutil_terr(e1->loc,((_tmp1C0="bad constant expression",_tag_dyneither(_tmp1C0,sizeof(char),24))),_tag_dyneither(_tmp1BF,sizeof(void*),0)));}{struct _tuple11 _tmp1C1;return(_tmp1C1.f1=_tmp35,((_tmp1C1.f2=1,_tmp1C1)));};_LL32:;}
# 161
if(use_i3){struct _tuple11 _tmp1C2;return(_tmp1C2.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,i3),((_tmp1C2.f2=1,_tmp1C2)));}
if(use_u3){struct _tuple11 _tmp1C3;return(_tmp1C3.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Unsigned,(int)u3),((_tmp1C3.f2=1,_tmp1C3)));}
if(use_b3){struct _tuple11 _tmp1C4;return(_tmp1C4.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,b3?1: 0),((_tmp1C4.f2=1,_tmp1C4)));}{
const char*_tmp1C7;void*_tmp1C6;(_tmp1C6=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1C7="Evexp::eval_const_binop",_tag_dyneither(_tmp1C7,sizeof(char),24))),_tag_dyneither(_tmp1C6,sizeof(void*),0)));};};};};}struct _tuple15{void*f1;union Cyc_Absyn_Cnst f2;};
# 170
...
# 174
struct _tuple11 _tmp1C8;return(_tmp1C8.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1C8.f2=0,_tmp1C8)));}_LL6C: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp5B=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp59;if(_tmp5B->tag != 0)goto _LL6E;else{_tmp5C=_tmp5B->f1;}}_LL6D: {
struct _tuple11 _tmp1C9;return(_tmp1C9.f1=_tmp5C,((_tmp1C9.f2=1,_tmp1C9)));}_LL6E: {struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_tmp5D=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp59;if(_tmp5D->tag != 5)goto _LL70;else{_tmp5E=_tmp5D->f1;_tmp5F=_tmp5D->f2;_tmp60=_tmp5D->f3;}}_LL6F: {
# 177
...
struct _tuple11 _tmp1CC;ans=((_tmp1CC.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1CC.f2=1,_tmp1CC))));}
...
struct _tuple11 _tmp1CD;return(_tmp1CD.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1CD.f2=0,_tmp1CD)));};}
# 200
if(!_tmp85)ans=Cyc_Evexp_eval_const_exp(_tmp66);else{
struct _tuple11 _tmp1CE;ans=((_tmp1CE.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,1),((_tmp1CE.f2=1,_tmp1CE))));}
...
# 204
 if(_tmp69 == 0){
{const char*_tmp1D1;void*_tmp1D0;(_tmp1D0=0,Cyc_Tcutil_terr(e->loc,((_tmp1D1="bad static expression (no args to primop)",_tag_dyneither(_tmp1D1,sizeof(char),42))),_tag_dyneither(_tmp1D0,sizeof(void*),0)));}{
struct _tuple11 _tmp1D2;return(_tmp1D2.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1D2.f2=1,_tmp1D2)));};}
# 208
if(_tmp69->tl == 0){
...
goto _LL69;}
# 216
{const char*_tmp1D5;void*_tmp1D4;(_tmp1D4=0,Cyc_Tcutil_terr(e->loc,((_tmp1D5="bad static expression (too many args to primop)",_tag_dyneither(_tmp1D5,sizeof(char),48))),_tag_dyneither(_tmp1D4,sizeof(void*),0)));}{
struct _tuple11 _tmp1D6;return(_tmp1D6.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1D6.f2=1,_tmp1D6)));};_LL76: {struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp6A=(struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmp59;if(_tmp6A->tag != 38)goto _LL78;else{_tmp6B=(void*)_tmp6A->f1;}}_LL77:
# 220
...
# 246
 if(_tmpB0 < 0){
const char*_tmp1DB;void*_tmp1DA;(_tmp1DA=0,Cyc_Tcutil_terr(e->loc,((_tmp1DB="cannot cast negative number to a tag type",_tag_dyneither(_tmp1DB,sizeof(char),42))),_tag_dyneither(_tmp1DA,sizeof(void*),0)));}
{struct Cyc_Absyn_ValueofType_Absyn_Type_struct _tmp1DE;struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_tmp1DD;Cyc_Tcutil_unify(_tmpAE,(void*)((_tmp1DD=_cycalloc(sizeof(*_tmp1DD)),((_tmp1DD[0]=((_tmp1DE.tag=18,((_tmp1DE.f1=Cyc_Absyn_const_exp(ans.f1,0),_tmp1DE)))),_tmp1DD)))));}
ans.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Unsigned,_tmpB0);
goto _LL8B;_LL98:;_LL99:
{const char*_tmp1E2;void*_tmp1E1[1];struct Cyc_String_pa_PrintArg_struct _tmp1E0;(_tmp1E0.tag=0,((_tmp1E0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp70)),((_tmp1E1[0]=& _tmp1E0,Cyc_Tcutil_terr(e->loc,((_tmp1E2="cannot cast to %s",_tag_dyneither(_tmp1E2,sizeof(char),18))),_tag_dyneither(_tmp1E1,sizeof(void*),1)))))));}goto _LL8B;_LL8B:;}
# 253
...
# 257
{const char*_tmp1E6;void*_tmp1E5[1];struct Cyc_String_pa_PrintArg_struct _tmp1E4;(_tmp1E4.tag=0,((_tmp1E4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp1E5[0]=& _tmp1E4,Cyc_Tcutil_terr(e->loc,((_tmp1E6="bad static expression %s",_tag_dyneither(_tmp1E6,sizeof(char),25))),_tag_dyneither(_tmp1E5,sizeof(void*),1)))))));}{
struct _tuple11 _tmp1E7;return(_tmp1E7.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1E7.f2=1,_tmp1E7)));};_LL69:;}
# 260
if(ans.f2){
void*c;
...
{struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct _tmp1EA;struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp1E9;c=(void*)((_tmp1E9=_cycalloc(sizeof(*_tmp1E9)),((_tmp1E9[0]=((_tmp1EA.tag=0,((_tmp1EA.f1=_tmpBD,_tmp1EA)))),_tmp1E9))));}goto _LL9A;_LL9A:;}
# 286
e->r=c;}
# 288
return ans;}
...
# 327
{const char*_tmp1EE;void*_tmp1ED[1];struct Cyc_String_pa_PrintArg_struct _tmp1EC;(_tmp1EC.tag=0,((_tmp1EC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp1ED[0]=& _tmp1EC,Cyc_Tcutil_terr(e->loc,((_tmp1EE="bad static expression %s",_tag_dyneither(_tmp1EE,sizeof(char),25))),_tag_dyneither(_tmp1ED,sizeof(void*),1)))))));}return 0;_LLC0:;}struct _tuple16{void*f1;void*f2;};
# 331
int Cyc_Evexp_const_exp_cmp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2){
...
if(_tmp136 == 0){
const char*_tmp1F2;void*_tmp1F1;(_tmp1F1=0,Cyc_Tcutil_terr(e2->loc,((_tmp1F2="cannot handle sizeof(exp) here -- use sizeof(type)",_tag_dyneither(_tmp1F2,sizeof(char),51))),_tag_dyneither(_tmp1F1,sizeof(void*),0)));}
...
if(_tmp139 == 0){
const char*_tmp1F5;void*_tmp1F4;(_tmp1F4=0,Cyc_Tcutil_terr(e1->loc,((_tmp1F5="cannot handle sizeof(exp) here -- use sizeof(type)",_tag_dyneither(_tmp1F5,sizeof(char),51))),_tag_dyneither(_tmp1F4,sizeof(void*),0)));}
...
if(_tmp13C == 0){
const char*_tmp1F8;void*_tmp1F7;(_tmp1F7=0,Cyc_Tcutil_terr(e1->loc,((_tmp1F8="cannot handle sizeof(exp) here -- use sizeof(type)",_tag_dyneither(_tmp1F8,sizeof(char),51))),_tag_dyneither(_tmp1F7,sizeof(void*),0)));}
if(_tmp13D == 0){
const char*_tmp1FB;void*_tmp1FA;(_tmp1FA=0,Cyc_Tcutil_terr(e2->loc,((_tmp1FB="cannot handle sizeof(exp) here -- use sizeof(type)",_tag_dyneither(_tmp1FB,sizeof(char),51))),_tag_dyneither(_tmp1FA,sizeof(void*),0)));}
...
struct _tuple16 _tmp1FC;struct _tuple16 _tmp145=(_tmp1FC.f1=(void*)_tmp124->hd,((_tmp1FC.f2=(void*)_tmp127->hd,_tmp1FC)));struct _tuple16 _tmp146=_tmp145;struct _dyneither_ptr*_tmp14C;struct _dyneither_ptr*_tmp14E;unsigned int _tmp150;unsigned int _tmp152;_LLF1:{struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp147=(struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*)_tmp146.f1;if(_tmp147->tag != 0)goto _LLF3;}{struct Cyc_Absyn_TupleIndex_Absyn_OffsetofField_struct*_tmp148=(struct Cyc_Absyn_TupleIndex_Absyn_OffsetofField_struct*)_tmp146.f2;if(_tmp148->tag != 1)goto _LLF3;};_LLF2:
...
const char*_tmp1FF;void*_tmp1FE;(_tmp1FE=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1FF="Evexp::const_exp_cmp, unexpected case",_tag_dyneither(_tmp1FF,sizeof(char),38))),_tag_dyneither(_tmp1FE,sizeof(void*),0)));}_LLD7:;};};};}
# 412
int Cyc_Evexp_same_const_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2){
...
# 429
enum Cyc_Absyn_KindQual _tmp189=(Cyc_Tcutil_tvar_kind(_tmp164,& Cyc_Tcutil_bk))->kind;switch(_tmp189){case Cyc_Absyn_BoxKind: _LL136:
 return 1;default: _LL137:
...
{union Cyc_Absyn_AggrInfoU _tmp18A=_tmp178;struct Cyc_Absyn_Aggrdecl*_tmp18B;_LL13A: if((_tmp18A.UnknownAggr).tag != 1)goto _LL13C;_LL13B: {
const char*_tmp202;void*_tmp201;(_tmp201=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp202="szof on unchecked StructType",_tag_dyneither(_tmp202,sizeof(char),29))),_tag_dyneither(_tmp201,sizeof(void*),0)));}_LL13C: if((_tmp18A.KnownAggr).tag != 2)goto _LL139;_tmp18B=*((struct Cyc_Absyn_Aggrdecl**)(_tmp18A.KnownAggr).val);_LL13D:
 ad=_tmp18B;_LL139:;}
# 463
if(ad->impl == 0)
return 0;
...
{struct Cyc_List_List*_tmp18F=((struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rzip)(temp,temp,ad->tvs,_tmp179);
{struct Cyc_List_List*_tmp190=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->fields;for(0;_tmp190 != 0;_tmp190=_tmp190->tl){
if(!Cyc_Evexp_okay_szofarg(Cyc_Tcutil_rsubstitute(temp,_tmp18F,((struct Cyc_Absyn_Aggrfield*)_tmp190->hd)->type))){int _tmp191=0;_npop_handler(0);return _tmp191;}}}{
int _tmp192=1;_npop_handler(0);return _tmp192;};}
# 467
;_pop_region(temp);}
# 472
...
return 1;_LL11E: {struct Cyc_Absyn_EnumType_Absyn_Type_struct*_tmp17C=(struct Cyc_Absyn_EnumType_Absyn_Type_struct*)_tmp161;if(_tmp17C->tag != 13)goto _LL120;}_LL11F:
 ...
 goto _LL131;_LL130: {struct Cyc_Absyn_TypeofType_Absyn_Type_struct*_tmp185=(struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_tmp161;if(_tmp185->tag != 27)goto _LL132;}_LL131:
 goto _LL133;_LL132: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmp186=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmp161;if(_tmp186->tag != 25)goto _LL134;}_LL133:
 return 0;_LL134: {struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmp187=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp161;if(_tmp187->tag != 17)goto _LLF9;else{_tmp188=_tmp187->f3;}}_LL135:
# 491
 if(_tmp188 == 0  || _tmp188->kind == 0){
struct Cyc_String_pa_PrintArg_struct _tmp20A;void*_tmp209[1];const char*_tmp208;void*_tmp207;(_tmp207=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)((struct _dyneither_ptr)((_tmp20A.tag=0,((_tmp20A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp209[0]=& _tmp20A,Cyc_aprintf(((_tmp208="szof typedeftype %s",_tag_dyneither(_tmp208,sizeof(char),20))),_tag_dyneither(_tmp209,sizeof(void*),1)))))))),_tag_dyneither(_tmp207,sizeof(void*),0)));}
return((struct Cyc_Absyn_Kind*)((struct Cyc_Core_Opt*)_check_null(_tmp188->kind))->v)->kind == Cyc_Absyn_BoxKind;_LLF9:;}
