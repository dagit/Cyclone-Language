...
int _tmp11E=Cyc_Evexp_const_exp_cmp((struct Cyc_Absyn_Exp*)_tmpF7->hd,(struct Cyc_Absyn_Exp*)_tmpFA->hd);
if(_tmp11E != 0)
return _tmp11E;}
# 353
...
# 366
void*_tmp125=_tmp108->topt;
void*_tmp126=_tmp10A->topt;
if(_tmp125 == 0){
