...
# 641
return(int)(Cyc_Kinds_tvar_kind(tv,& Cyc_Kinds_bk))->kind == (int)Cyc_Absyn_BoxKind;}case 1U: if(((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp16F)->f1 != 0){if(((struct Cyc_Absyn_Kind*)((struct Cyc_Core_Opt*)((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp16F)->f1)->v)->kind == Cyc_Absyn_BoxKind){_LL5: _LL6:
