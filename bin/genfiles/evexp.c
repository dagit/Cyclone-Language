...
# 481 "absyn.h"
enum Cyc_Absyn_Primop{Cyc_Absyn_Plus =0U,Cyc_Absyn_Times =1U,Cyc_Absyn_Minus =2U,Cyc_Absyn_Div =3U,Cyc_Absyn_Mod =4U,Cyc_Absyn_Eq =5U,Cyc_Absyn_Neq =6U,Cyc_Absyn_Gt =7U,Cyc_Absyn_Lt =8U,Cyc_Absyn_Gte =9U,Cyc_Absyn_Lte =10U,Cyc_Absyn_Not =11U,Cyc_Absyn_Bitnot =12U,Cyc_Absyn_Bitand =13U,Cyc_Absyn_Bitor =14U,Cyc_Absyn_Bitxor =15U,Cyc_Absyn_Bitlshift =16U,Cyc_Absyn_Bitlrshift =17U,Cyc_Absyn_Numelts =18U};struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct{int tag;struct _fat_ptr*f1;};
# 506
...
# 83 "kinds.h"
struct Cyc_Absyn_Kind*Cyc_Kinds_tvar_kind(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Kind*);struct Cyc_Warn_String_Warn_Warg_struct{int tag;struct _fat_ptr f1;};struct Cyc_Warn_Typ_Warn_Warg_struct{int tag;void*f1;};struct Cyc_Warn_Exp_Warn_Warg_struct{int tag;struct Cyc_Absyn_Exp*f1;};
# 67 "warn.h"
...
if(!known)
return({struct _tuple11 _Tmp3;_Tmp3.f0=0U,_Tmp3.f1=0;_Tmp3;});{
...
return({struct _tuple11 _Tmp6;_Tmp6.f0=(unsigned)i,_Tmp6.f1=1;_Tmp6;});}case 6: _Tmp4=_Tmp3.LongLong_c.val.f1;{long long x=_Tmp4;
# 52
unsigned long long y=(unsigned long long)x >> 32U;
if(y!=4294967295U && y!=0U)
return({struct _tuple11 _Tmp6;_Tmp6.f0=0U,_Tmp6.f1=0;_Tmp6;});
return({struct _tuple11 _Tmp6;_Tmp6.f0=(unsigned)x,_Tmp6.f1=1;_Tmp6;});}case 7:
 return({struct _tuple11 _Tmp6;_Tmp6.f0=0U,_Tmp6.f1=0;_Tmp6;});case 1:
 return({struct _tuple11 _Tmp6;_Tmp6.f0=0U,_Tmp6.f1=1;_Tmp6;});default:
 return({struct _tuple11 _Tmp6;_Tmp6.f0=0U,_Tmp6.f1=0;_Tmp6;});};}}}struct _tuple13{int f0;int f1;};
# 62
static struct _tuple13 Cyc_Evexp_eval_const_bool_exp(struct Cyc_Absyn_Exp*e){
struct _tuple12 _Tmp0=Cyc_Evexp_eval_const_exp(e);int _Tmp1;union Cyc_Absyn_Cnst _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{union Cyc_Absyn_Cnst cn=_Tmp2;int known=_Tmp1;
if(!known)
return({struct _tuple13 _Tmp3;_Tmp3.f0=0,_Tmp3.f1=0;_Tmp3;});{
...
return({struct _tuple13 _Tmp6;_Tmp6.f0=b!=0,_Tmp6.f1=1;_Tmp6;});}case 6: _Tmp4=_Tmp3.LongLong_c.val.f1;{long long b=_Tmp4;
return({struct _tuple13 _Tmp6;_Tmp6.f0=b!=0,_Tmp6.f1=1;_Tmp6;});}case 1:
 return({struct _tuple13 _Tmp6;_Tmp6.f0=0,_Tmp6.f1=0;_Tmp6;});case 7:
 return({struct _tuple13 _Tmp6;_Tmp6.f0=0,_Tmp6.f1=1;_Tmp6;});default:
 return({struct _tuple13 _Tmp6;_Tmp6.f0=0,_Tmp6.f1=0;_Tmp6;});};}}}struct _tuple14{enum Cyc_Absyn_Primop f0;union Cyc_Absyn_Cnst f1;};
# 75
static struct _tuple12 Cyc_Evexp_eval_const_unprimop(enum Cyc_Absyn_Primop p,struct Cyc_Absyn_Exp*e){
struct _tuple12 _Tmp0=Cyc_Evexp_eval_const_exp(e);int _Tmp1;union Cyc_Absyn_Cnst _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{union Cyc_Absyn_Cnst cn=_Tmp2;int known=_Tmp1;
if(!known)
return({struct _tuple12 _Tmp3;_Tmp3.f0=cn,_Tmp3.f1=0;_Tmp3;});
...
cn=Cyc_Absyn_LongLong_c(0U,(long long)(i==0?1: 0));goto _LL3;}default: goto _LL20;}default: _LL20:
 return({struct _tuple12 _Tmp9;_Tmp9.f0=cn,_Tmp9.f1=0;_Tmp9;});}_LL3:;}
# 97
return({struct _tuple12 _Tmp3;_Tmp3.f0=cn,_Tmp3.f1=1;_Tmp3;});}}struct _tuple15{enum Cyc_Absyn_Primop f0;int f1;};
# 101
...
if(!known1 || !known2)
return({struct _tuple12 _Tmp6;_Tmp6.f0=cn1,_Tmp6.f1=0;_Tmp6;});
...
return({struct _tuple12 _Tmp8;_Tmp8.f0=cn1,_Tmp8.f1=0;_Tmp8;});}_LL6:;}
# 114
...
return({struct _tuple12 _Tmp8;_Tmp8.f0=cn1,_Tmp8.f1=0;_Tmp8;});}_LLB:;}
# 118
...
return({struct _tuple12 _Tmp6;_Tmp6.f0=cn1,_Tmp6.f1=1;_Tmp6;});default:
 goto _LL10;}_LL10:;{
# 127
...
# 142
 u3=u1 + u2;use_u3=1;goto _LL17;default: goto _LL4A;}case Cyc_Absyn_Times: switch((int)_Tmp6.f1){case 0:
# 138
 i3=i1 * i2;use_i3=1;goto _LL17;case 1:
# 143
 u3=u1 * u2;use_u3=1;goto _LL17;default: goto _LL4A;}case Cyc_Absyn_Minus: switch((int)_Tmp6.f1){case 0:
# 139
 i3=i1 - i2;use_i3=1;goto _LL17;case 1:
# 144
 u3=u1 - u2;use_u3=1;goto _LL17;default: goto _LL4A;}case Cyc_Absyn_Div: switch((int)_Tmp6.f1){case 0:
# 140
 i3=i1 / i2;use_i3=1;goto _LL17;case 1:
# 145
 u3=u1 / u2;use_u3=1;goto _LL17;default: goto _LL4A;}case Cyc_Absyn_Mod: switch((int)_Tmp6.f1){case 0:
# 141
 i3=i1 % i2;use_i3=1;goto _LL17;case 1:
# 146
 u3=u1 % u2;use_u3=1;goto _LL17;default: goto _LL4A;}case Cyc_Absyn_Eq:
 b3=i1==i2;use_b3=1;goto _LL17;case Cyc_Absyn_Neq:
 b3=i1!=i2;use_b3=1;goto _LL17;case Cyc_Absyn_Gt: switch((int)_Tmp6.f1){case 0:
 b3=i1 > i2;use_b3=1;goto _LL17;case 1:
# 153
 b3=u1 > u2;use_b3=1;goto _LL17;default: goto _LL4A;}case Cyc_Absyn_Lt: switch((int)_Tmp6.f1){case 0:
# 150
 b3=i1 < i2;use_b3=1;goto _LL17;case 1:
# 154
 b3=u1 < u2;use_b3=1;goto _LL17;default: goto _LL4A;}case Cyc_Absyn_Gte: switch((int)_Tmp6.f1){case 0:
# 151
 b3=i1 >= i2;use_b3=1;goto _LL17;case 1:
# 155
 b3=u1 >= u2;use_b3=1;goto _LL17;default: goto _LL4A;}case Cyc_Absyn_Lte: switch((int)_Tmp6.f1){case 0:
# 152
 b3=i1 <= i2;use_b3=1;goto _LL17;case 1:
# 156
...
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp7=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp8;_Tmp8.tag=0,_Tmp8.f1=_tag_fat("bad constant expression",sizeof(char),24U);_Tmp8;});void*_Tmp8[1];_Tmp8[0]=& _Tmp7;Cyc_Warn_err2(e1->loc,_tag_fat(_Tmp8,sizeof(void*),1));});return({struct _tuple12 _Tmp7;_Tmp7.f0=cn1,_Tmp7.f1=1;_Tmp7;});}_LL17:;}
# 164
if(use_i3)return({struct _tuple12 _Tmp6;({union Cyc_Absyn_Cnst _Tmp7=Cyc_Absyn_Int_c(0U,i3);_Tmp6.f0=_Tmp7;}),_Tmp6.f1=1;_Tmp6;});
if(use_u3)return({struct _tuple12 _Tmp6;({union Cyc_Absyn_Cnst _Tmp7=Cyc_Absyn_Int_c(1U,(int)u3);_Tmp6.f0=_Tmp7;}),_Tmp6.f1=1;_Tmp6;});
if(use_b3)return({struct _tuple12 _Tmp6;({union Cyc_Absyn_Cnst _Tmp7=Cyc_Absyn_Int_c(0U,b3?1: 0);_Tmp6.f0=_Tmp7;}),_Tmp6.f1=1;_Tmp6;});
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp6=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp7;_Tmp7.tag=0,_Tmp7.f1=_tag_fat("Evexp::eval_const_binop",sizeof(char),24U);_Tmp7;});void*_Tmp7[1];_Tmp7[0]=& _Tmp6;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_Tmp7,sizeof(void*),1));});}}}}}struct _tuple16{void*f0;union Cyc_Absyn_Cnst f1;};
# 172
...
# 176
 return({struct _tuple12 _Tmp6;({union Cyc_Absyn_Cnst _Tmp7=Cyc_Absyn_Int_c(0U,0);_Tmp6.f0=_Tmp7;}),_Tmp6.f1=0;_Tmp6;});case 0: _Tmp5=((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{union Cyc_Absyn_Cnst c=_Tmp5;
return({struct _tuple12 _Tmp6;_Tmp6.f0=c,_Tmp6.f1=1;_Tmp6;});}case 2:
 return({struct _tuple12 _Tmp6;({union Cyc_Absyn_Cnst _Tmp7=Cyc_Absyn_Int_c(0U,0);_Tmp6.f0=_Tmp7;}),_Tmp6.f1=1;_Tmp6;});case 6: _Tmp4=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp3=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;_Tmp2=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_Tmp0)->f3;{struct Cyc_Absyn_Exp*e1=_Tmp4;struct Cyc_Absyn_Exp*e2=_Tmp3;struct Cyc_Absyn_Exp*e3=_Tmp2;
# 180
...
return({struct _tuple12 _Tmp9;({union Cyc_Absyn_Cnst _TmpA=Cyc_Absyn_Int_c(0U,0);_Tmp9.f0=_TmpA;}),_Tmp9.f1=0;_Tmp9;});}
# 186
...
return({struct _tuple12 _Tmp6;({union Cyc_Absyn_Cnst _Tmp7=Cyc_Absyn_Int_c(0U,0);_Tmp6.f0=_Tmp7;}),_Tmp6.f1=1;_Tmp6;});}else{
if(es->tl==0)
...
return({struct _tuple12 _Tmp6;({union Cyc_Absyn_Cnst _Tmp7=Cyc_Absyn_Int_c(0U,0);_Tmp6.f0=_Tmp7;}),_Tmp6.f1=1;_Tmp6;});}}}
# 216
goto _LL0;}case 38: _Tmp4=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{void*t=_Tmp4;
# 219
{void*_Tmp6=Cyc_Absyn_compress(t);void*_Tmp7;if(*((int*)_Tmp6)==8){_Tmp7=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_Tmp6)->f1;{struct Cyc_Absyn_Exp*e2=_Tmp7;
# 221
e->r=e2->r;
...
# 249
if(x < 0)
return({struct _tuple12 _TmpE;({union Cyc_Absyn_Cnst _TmpF=Cyc_Absyn_Int_c(0U,0);_TmpE.f0=_TmpF;}),_TmpE.f1=0;_TmpE;});
({void*_TmpE=it;Cyc_Unify_unify(_TmpE,(void*)({struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_TmpF=_cycalloc(sizeof(struct Cyc_Absyn_ValueofType_Absyn_Type_struct));_TmpF->tag=8,({struct Cyc_Absyn_Exp*_Tmp10=Cyc_Absyn_const_exp(ans.f0,0U);_TmpF->f1=_Tmp10;});_TmpF;}));});
...
goto _LL2D;}default: goto _LL3A;}else{goto _LL3A;}default: goto _LL3A;}else{_LL3A:
 return({struct _tuple12 _TmpE;({union Cyc_Absyn_Cnst _TmpF=Cyc_Absyn_Int_c(0U,0);_TmpE.f0=_TmpF;}),_TmpE.f1=0;_TmpE;});}_LL2D:;}
# 256
...
ans=Cyc_Evexp_eval_const_exp(_check_null(ef->tag));goto _LL0;}default:
 return({struct _tuple12 _Tmp6;({union Cyc_Absyn_Cnst _Tmp7=Cyc_Absyn_Int_c(0U,0);_Tmp6.f0=_Tmp7;}),_Tmp6.f1=0;_Tmp6;});}_LL0:;}
# 261
if(ans.f1){
void*c;
...
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp4=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp5;_Tmp5.tag=0,_Tmp5.f1=_tag_fat("Evexp::integral_const_to_long_long",sizeof(char),35U);_Tmp5;});void*_Tmp5[1];_Tmp5[0]=& _Tmp4;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_Tmp5,sizeof(void*),1));});}_LL0:;}
# 324
...
return diff==0?0:(diff < 0?-1: 1);}}}}}}}}}};}struct _tuple18{void*f0;void*f1;};
# 360
...
# 491
return Cyc_Tcutil_typecmp(t1,t2);}case 18: _Tmp12=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_Tmp6.f0)->f1;_Tmp11=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_Tmp6.f1)->f1;{void*t1=_Tmp12;struct Cyc_Absyn_Exp*e2a=_Tmp11;
# 493
...
return 0;}
# 498
return Cyc_Tcutil_typecmp(t1,e2atopt);}default: goto _LL3D;}case 18: switch(*((int*)_Tmp6.f1)){case 17: _Tmp12=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_Tmp6.f0)->f1;_Tmp11=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_Tmp6.f1)->f1;{struct Cyc_Absyn_Exp*e1a=_Tmp12;void*t2=_Tmp11;
# 500
...
return 0;}
# 505
return Cyc_Tcutil_typecmp(e1atopt,t2);}case 18: _Tmp12=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_Tmp6.f0)->f1;_Tmp11=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_Tmp6.f1)->f1;{struct Cyc_Absyn_Exp*e1a=_Tmp12;struct Cyc_Absyn_Exp*e2a=_Tmp11;
# 507
void*e1atopt=e1a->topt;
void*e2atopt=e2a->topt;
if(e1atopt==0){
...
return Cyc_Tcutil_typecmp(t1,t2);}}else{goto _LL3D;}case 40: if(*((int*)_Tmp6.f1)==40){_Tmp12=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_Tmp6.f0)->f1;_Tmp11=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_Tmp6.f1)->f1;{struct Cyc_Absyn_Exp*e1=_Tmp12;struct Cyc_Absyn_Exp*e2=_Tmp11;
...
int c1=Cyc_Evexp_exp_cmp(e1,e2);
if(c1!=0)return c1;
return Cyc_List_list_cmp(Cyc_Tcutil_typecmp,t1,t2);}}else{goto _LL3D;}case 15: if(*((int*)_Tmp6.f1)==15){_Tmp12=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_Tmp6.f0)->f1;_Tmp11=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_Tmp6.f1)->f1;{struct Cyc_Absyn_Exp*e1=_Tmp12;struct Cyc_Absyn_Exp*e2=_Tmp11;
...
# 554
int c1=0;
if(t1!=0 && t2!=0)c1=Cyc_Tcutil_typecmp(t1,t2);else{
if(t1==0)c1=-1;else{
if(t2==0)c1=1;}}
if(c1!=0)return c1;
...
if(c1!=0)return c1;
return({(int(*)(int(*)(struct _tuple19*,struct _tuple19*),struct Cyc_List_List*,struct Cyc_List_List*))Cyc_List_list_cmp;})(Cyc_Evexp_designator_exp_cmp,des1,des1);}}else{goto _LL3D;}case 30: if(*((int*)_Tmp6.f1)==30){_Tmp12=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_Tmp6.f0)->f1;_Tmp11=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_Tmp6.f0)->f2;_TmpE=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_Tmp6.f0)->f3;_TmpD=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_Tmp6.f1)->f1;_TmpC=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_Tmp6.f1)->f2;_TmpB=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_Tmp6.f1)->f3;{struct Cyc_List_List*es1=_Tmp12;struct Cyc_Absyn_Datatypedecl*dd1=_Tmp11;struct Cyc_Absyn_Datatypefield*df1=_TmpE;struct Cyc_List_List*es2=_TmpD;struct Cyc_Absyn_Datatypedecl*dd2=_TmpC;struct Cyc_Absyn_Datatypefield*df2=_TmpB;
# 569
int c1=(int)dd1 - (int)dd2;
if(c1!=0)return c1;
c1=(int)df1 - (int)df2;
if(c1!=0)return c1;
return({(int(*)(int(*)(struct Cyc_Absyn_Exp*,struct Cyc_Absyn_Exp*),struct Cyc_List_List*,struct Cyc_List_List*))Cyc_List_list_cmp;})(Cyc_Evexp_exp_cmp,es1,es2);}}else{goto _LL3D;}case 31: if(*((int*)_Tmp6.f1)==31)
# 575
goto _LL3C;else{goto _LL3D;}case 32: if(*((int*)_Tmp6.f1)==32){_LL3C:
 goto _LL3E;}else{goto _LL3D;}default: _LL3D: _LL3E:
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp15=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp16;_Tmp16.tag=0,_Tmp16.f1=_tag_fat("Evexp::exp_cmp, unexpected case $(",sizeof(char),35U);_Tmp16;});struct Cyc_Warn_Exp_Warn_Warg_struct _Tmp16=({struct Cyc_Warn_Exp_Warn_Warg_struct _Tmp17;_Tmp17.tag=4,_Tmp17.f1=e1;_Tmp17;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp17=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18;_Tmp18.tag=0,_Tmp18.f1=
_tag_fat(",",sizeof(char),2U);_Tmp18;});struct Cyc_Warn_Exp_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_Exp_Warn_Warg_struct _Tmp19;_Tmp19.tag=4,_Tmp19.f1=e2;_Tmp19;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp19=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A;_Tmp1A.tag=0,_Tmp1A.f1=_tag_fat(")",sizeof(char),2U);_Tmp1A;});void*_Tmp1A[5];_Tmp1A[0]=& _Tmp15,_Tmp1A[1]=& _Tmp16,_Tmp1A[2]=& _Tmp17,_Tmp1A[3]=& _Tmp18,_Tmp1A[4]=& _Tmp19;({
# 577
(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_Tmp1A,sizeof(void*),5));});};}}}}}
# 582
...
# 612
void*_Tmp3;switch(*((int*)c)){case 24:
 return 0;case 5:
 goto _LL1F;case 1: _LL1F:
 goto _LL21;case 2: _LL21:
 goto _LL23;case 3: _LL23:
 goto _LL25;case 22: _LL25:
 goto _LL27;case 20: _LL27:
 goto _LL29;case 4: _LL29:
 goto _LL2B;case 19: _LL2B:
 goto _LL2D;case 23: _LL2D:
 goto _LL2F;case 21: _LL2F:
 return 1;case 0:
# 625
 goto _LL33;case 6: _LL33:
 goto _LL35;case 8: _LL35:
 goto _LL37;case 7: _LL37:
...
# 659
return e!=0;}case 5:
 return 0;case 6: _Tmp2=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp0)->f3;{struct Cyc_List_List*fs=_Tmp2;
# 662
for(1;fs!=0;fs=fs->tl){
