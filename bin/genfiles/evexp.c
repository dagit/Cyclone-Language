...
if(!_tmp8){
struct _tuple10 _tmp198;return(_tmp198.f1=0,((_tmp198.f2=0,_tmp198)));}{
...
struct _tuple10 _tmp199;return(_tmp199.f1=(unsigned int)_tmpC,((_tmp199.f2=1,_tmp199)));}_LLA: if((_tmpB.LongLong_c).tag != 6)goto _LLC;_tmpD=((struct _tuple6)(_tmpB.LongLong_c).val).f2;_LLB: {
# 60
unsigned long long y=(unsigned long long)_tmpD >> 32;
if(y != -1  && y != 0){
struct _tuple10 _tmp19A;return(_tmp19A.f1=0,((_tmp19A.f2=0,_tmp19A)));}else{
struct _tuple10 _tmp19B;return(_tmp19B.f1=(unsigned int)_tmpD,((_tmp19B.f2=1,_tmp19B)));}}_LLC:;_LLD:
{const char*_tmp19E;void*_tmp19D;(_tmp19D=0,Cyc_Tcutil_terr(e->loc,((_tmp19E="expecting unsigned int",_tag_dyneither(_tmp19E,sizeof(char),23))),_tag_dyneither(_tmp19D,sizeof(void*),0)));}{struct _tuple10 _tmp19F;return(_tmp19F.f1=0,((_tmp19F.f2=1,_tmp19F)));};_LL7:;};}struct _tuple12{int f1;int f2;};
# 68
...
if(!_tmp17){
struct _tuple12 _tmp1A0;return(_tmp1A0.f1=0,((_tmp1A0.f2=0,_tmp1A0)));}{
...
struct _tuple12 _tmp1A1;return(_tmp1A1.f1=_tmp1B != 0,((_tmp1A1.f2=1,_tmp1A1)));}_LL11: if((_tmp1A.LongLong_c).tag != 6)goto _LL13;_tmp1C=((struct _tuple6)(_tmp1A.LongLong_c).val).f2;_LL12: {
struct _tuple12 _tmp1A2;return(_tmp1A2.f1=_tmp1C != 0,((_tmp1A2.f2=1,_tmp1A2)));}_LL13: if((_tmp1A.Null_c).tag != 1)goto _LL15;_LL14: {
struct _tuple12 _tmp1A3;return(_tmp1A3.f1=0,((_tmp1A3.f2=0,_tmp1A3)));}_LL15:;_LL16:
{const char*_tmp1A6;void*_tmp1A5;(_tmp1A5=0,Cyc_Tcutil_terr(e->loc,((_tmp1A6="expecting bool",_tag_dyneither(_tmp1A6,sizeof(char),15))),_tag_dyneither(_tmp1A5,sizeof(void*),0)));}{struct _tuple12 _tmp1A7;return(_tmp1A7.f1=0,((_tmp1A7.f2=0,_tmp1A7)));};_LLE:;};}struct _tuple13{enum Cyc_Absyn_Primop f1;union Cyc_Absyn_Cnst f2;};
# 80
...
if(!_tmp26){
struct _tuple11 _tmp1A8;return(_tmp1A8.f1=_tmp25,((_tmp1A8.f2=0,_tmp1A8)));}
{struct _tuple13 _tmp1A9;struct _tuple13 _tmp28=(_tmp1A9.f1=p,((_tmp1A9.f2=_tmp25,_tmp1A9)));struct _tuple13 _tmp29=_tmp28;enum Cyc_Absyn_Sign _tmp2A;int _tmp2B;enum Cyc_Absyn_Sign _tmp2C;int _tmp2D;int _tmp2E;_LL18: if(_tmp29.f1 != Cyc_Absyn_Plus)goto _LL1A;_LL19:
...
{const char*_tmp1AC;void*_tmp1AB;(_tmp1AB=0,Cyc_Tcutil_terr(e->loc,((_tmp1AC="bad constant expression",_tag_dyneither(_tmp1AC,sizeof(char),24))),_tag_dyneither(_tmp1AB,sizeof(void*),0)));}goto _LL17;_LL17:;}{
# 92
struct _tuple11 _tmp1AD;return(_tmp1AD.f1=_tmp25,((_tmp1AD.f2=1,_tmp1AD)));};}struct _tuple14{enum Cyc_Absyn_Primop f1;int f2;};
# 96
...
if(!_tmp36  || !_tmp3A){
struct _tuple11 _tmp1AE;return(_tmp1AE.f1=_tmp35,((_tmp1AE.f2=0,_tmp1AE)));}
...
{const char*_tmp1B1;void*_tmp1B0;(_tmp1B0=0,Cyc_Tcutil_terr(e1->loc,((_tmp1B1="bad constant expression",_tag_dyneither(_tmp1B1,sizeof(char),24))),_tag_dyneither(_tmp1B0,sizeof(void*),0)));}{struct _tuple11 _tmp1B2;return(_tmp1B2.f1=_tmp35,((_tmp1B2.f2=1,_tmp1B2)));};_LL24:;}
# 109
...
{const char*_tmp1B5;void*_tmp1B4;(_tmp1B4=0,Cyc_Tcutil_terr(e2->loc,((_tmp1B5="bad constant expression",_tag_dyneither(_tmp1B5,sizeof(char),24))),_tag_dyneither(_tmp1B4,sizeof(void*),0)));}{struct _tuple11 _tmp1B6;return(_tmp1B6.f1=_tmp35,((_tmp1B6.f2=1,_tmp1B6)));};_LL29:;}
# 113
switch(p){case Cyc_Absyn_Div: _LL2E:
 goto _LL2F;case Cyc_Absyn_Mod: _LL2F:
# 116
 if(i2 == 0){
{const char*_tmp1B9;void*_tmp1B8;(_tmp1B8=0,Cyc_Tcutil_terr(e2->loc,((_tmp1B9="division by zero in constant expression",_tag_dyneither(_tmp1B9,sizeof(char),40))),_tag_dyneither(_tmp1B8,sizeof(void*),0)));}{
struct _tuple11 _tmp1BA;return(_tmp1BA.f1=_tmp35,((_tmp1BA.f2=1,_tmp1BA)));};}
# 120
break;default: _LL30:
 break;}{
# 123
...
int use_u3=0;
int use_b3=0;
{struct _tuple14 _tmp1BB;struct _tuple14 _tmp4B=(_tmp1BB.f1=p,((_tmp1BB.f2=has_u_arg,_tmp1BB)));struct _tuple14 _tmp4C=_tmp4B;_LL33: if(_tmp4C.f1 != Cyc_Absyn_Plus)goto _LL35;if(_tmp4C.f2 != 0)goto _LL35;_LL34:
...
{const char*_tmp1BE;void*_tmp1BD;(_tmp1BD=0,Cyc_Tcutil_terr(e1->loc,((_tmp1BE=">>> NOT IMPLEMENTED",_tag_dyneither(_tmp1BE,sizeof(char),20))),_tag_dyneither(_tmp1BD,sizeof(void*),0)));}goto _LL68;_LL67:;_LL68:
{const char*_tmp1C1;void*_tmp1C0;(_tmp1C0=0,Cyc_Tcutil_terr(e1->loc,((_tmp1C1="bad constant expression",_tag_dyneither(_tmp1C1,sizeof(char),24))),_tag_dyneither(_tmp1C0,sizeof(void*),0)));}{struct _tuple11 _tmp1C2;return(_tmp1C2.f1=_tmp35,((_tmp1C2.f2=1,_tmp1C2)));};_LL32:;}
# 161
if(use_i3){struct _tuple11 _tmp1C3;return(_tmp1C3.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,i3),((_tmp1C3.f2=1,_tmp1C3)));}
if(use_u3){struct _tuple11 _tmp1C4;return(_tmp1C4.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Unsigned,(int)u3),((_tmp1C4.f2=1,_tmp1C4)));}
if(use_b3){struct _tuple11 _tmp1C5;return(_tmp1C5.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,b3?1: 0),((_tmp1C5.f2=1,_tmp1C5)));}{
const char*_tmp1C8;void*_tmp1C7;(_tmp1C7=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp1C8="Evexp::eval_const_binop",_tag_dyneither(_tmp1C8,sizeof(char),24))),_tag_dyneither(_tmp1C7,sizeof(void*),0)));};};};};}struct _tuple15{void*f1;union Cyc_Absyn_Cnst f2;};
# 170
...
# 174
struct _tuple11 _tmp1C9;return(_tmp1C9.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1C9.f2=0,_tmp1C9)));}_LL6C: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp5B=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp59;if(_tmp5B->tag != 0)goto _LL6E;else{_tmp5C=_tmp5B->f1;}}_LL6D: {
struct _tuple11 _tmp1CA;return(_tmp1CA.f1=_tmp5C,((_tmp1CA.f2=1,_tmp1CA)));}_LL6E: {struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_tmp5D=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp59;if(_tmp5D->tag != 5)goto _LL70;else{_tmp5E=_tmp5D->f1;_tmp5F=_tmp5D->f2;_tmp60=_tmp5D->f3;}}_LL6F: {
# 177
...
struct _tuple11 _tmp1CB;return(_tmp1CB.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1CB.f2=0,_tmp1CB)));};}
# 183
...
struct _tuple11 _tmp1CD;ans=((_tmp1CD.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1CD.f2=1,_tmp1CD))));}
...
struct _tuple11 _tmp1CE;return(_tmp1CE.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1CE.f2=0,_tmp1CE)));};}
# 200
if(!_tmp85)ans=Cyc_Evexp_eval_const_exp(_tmp66);else{
struct _tuple11 _tmp1CF;ans=((_tmp1CF.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,1),((_tmp1CF.f2=1,_tmp1CF))));}
...
# 204
 if(_tmp69 == 0){
{const char*_tmp1D2;void*_tmp1D1;(_tmp1D1=0,Cyc_Tcutil_terr(e->loc,((_tmp1D2="bad static expression (no args to primop)",_tag_dyneither(_tmp1D2,sizeof(char),42))),_tag_dyneither(_tmp1D1,sizeof(void*),0)));}{
struct _tuple11 _tmp1D3;return(_tmp1D3.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1D3.f2=1,_tmp1D3)));};}
# 208
if(_tmp69->tl == 0){
...
goto _LL69;}
# 216
{const char*_tmp1D6;void*_tmp1D5;(_tmp1D5=0,Cyc_Tcutil_terr(e->loc,((_tmp1D6="bad static expression (too many args to primop)",_tag_dyneither(_tmp1D6,sizeof(char),48))),_tag_dyneither(_tmp1D5,sizeof(void*),0)));}{
struct _tuple11 _tmp1D7;return(_tmp1D7.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1D7.f2=1,_tmp1D7)));};_LL76: {struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp6A=(struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmp59;if(_tmp6A->tag != 38)goto _LL78;else{_tmp6B=(void*)_tmp6A->f1;}}_LL77:
# 220
...
# 246
 if(_tmpB0 < 0){
const char*_tmp1DC;void*_tmp1DB;(_tmp1DB=0,Cyc_Tcutil_terr(e->loc,((_tmp1DC="cannot cast negative number to a tag type",_tag_dyneither(_tmp1DC,sizeof(char),42))),_tag_dyneither(_tmp1DB,sizeof(void*),0)));}
{struct Cyc_Absyn_ValueofType_Absyn_Type_struct _tmp1DF;struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_tmp1DE;Cyc_Tcutil_unify(_tmpAE,(void*)((_tmp1DE=_cycalloc(sizeof(*_tmp1DE)),((_tmp1DE[0]=((_tmp1DF.tag=18,((_tmp1DF.f1=Cyc_Absyn_const_exp(ans.f1,0),_tmp1DF)))),_tmp1DE)))));}
ans.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Unsigned,_tmpB0);
goto _LL8B;_LL98:;_LL99:
{const char*_tmp1E3;void*_tmp1E2[1];struct Cyc_String_pa_PrintArg_struct _tmp1E1;(_tmp1E1.tag=0,((_tmp1E1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp70)),((_tmp1E2[0]=& _tmp1E1,Cyc_Tcutil_terr(e->loc,((_tmp1E3="cannot cast to %s",_tag_dyneither(_tmp1E3,sizeof(char),18))),_tag_dyneither(_tmp1E2,sizeof(void*),1)))))));}goto _LL8B;_LL8B:;}
# 253
...
# 257
{const char*_tmp1E7;void*_tmp1E6[1];struct Cyc_String_pa_PrintArg_struct _tmp1E5;(_tmp1E5.tag=0,((_tmp1E5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp1E6[0]=& _tmp1E5,Cyc_Tcutil_terr(e->loc,((_tmp1E7="bad static expression %s",_tag_dyneither(_tmp1E7,sizeof(char),25))),_tag_dyneither(_tmp1E6,sizeof(void*),1)))))));}{
struct _tuple11 _tmp1E8;return(_tmp1E8.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1E8.f2=1,_tmp1E8)));};_LL69:;}
# 260
if(ans.f2){
void*c;
...
{struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct _tmp1EB;struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp1EA;c=(void*)((_tmp1EA=_cycalloc(sizeof(*_tmp1EA)),((_tmp1EA[0]=((_tmp1EB.tag=0,((_tmp1EB.f1=_tmpBD,_tmp1EB)))),_tmp1EA))));}goto _LL9A;_LL9A:;}
# 286
e->r=c;}
# 288
return ans;}
...
# 327
{const char*_tmp1EF;void*_tmp1EE[1];struct Cyc_String_pa_PrintArg_struct _tmp1ED;(_tmp1ED.tag=0,((_tmp1ED.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((_tmp1EE[0]=& _tmp1ED,Cyc_Tcutil_terr(e->loc,((_tmp1EF="bad static expression %s",_tag_dyneither(_tmp1EF,sizeof(char),25))),_tag_dyneither(_tmp1EE,sizeof(void*),1)))))));}return 0;_LLC0:;}struct _tuple16{void*f1;void*f2;};
# 331
int Cyc_Evexp_const_exp_cmp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2){
...
if(_tmp136 == 0){
const char*_tmp1F3;void*_tmp1F2;(_tmp1F2=0,Cyc_Tcutil_terr(e2->loc,((_tmp1F3="cannot handle sizeof(exp) here -- use sizeof(type)",_tag_dyneither(_tmp1F3,sizeof(char),51))),_tag_dyneither(_tmp1F2,sizeof(void*),0)));}
...
if(_tmp139 == 0){
const char*_tmp1F6;void*_tmp1F5;(_tmp1F5=0,Cyc_Tcutil_terr(e1->loc,((_tmp1F6="cannot handle sizeof(exp) here -- use sizeof(type)",_tag_dyneither(_tmp1F6,sizeof(char),51))),_tag_dyneither(_tmp1F5,sizeof(void*),0)));}
...
if(_tmp13C == 0){
const char*_tmp1F9;void*_tmp1F8;(_tmp1F8=0,Cyc_Tcutil_terr(e1->loc,((_tmp1F9="cannot handle sizeof(exp) here -- use sizeof(type)",_tag_dyneither(_tmp1F9,sizeof(char),51))),_tag_dyneither(_tmp1F8,sizeof(void*),0)));}
if(_tmp13D == 0){
const char*_tmp1FC;void*_tmp1FB;(_tmp1FB=0,Cyc_Tcutil_terr(e2->loc,((_tmp1FC="cannot handle sizeof(exp) here -- use sizeof(type)",_tag_dyneither(_tmp1FC,sizeof(char),51))),_tag_dyneither(_tmp1FB,sizeof(void*),0)));}
...
struct _tuple16 _tmp1FD;struct _tuple16 _tmp145=(_tmp1FD.f1=(void*)_tmp124->hd,((_tmp1FD.f2=(void*)_tmp127->hd,_tmp1FD)));struct _tuple16 _tmp146=_tmp145;struct _dyneither_ptr*_tmp14C;struct _dyneither_ptr*_tmp14E;unsigned int _tmp150;unsigned int _tmp152;_LLF1:{struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*_tmp147=(struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*)_tmp146.f1;if(_tmp147->tag != 0)goto _LLF3;}{struct Cyc_Absyn_TupleIndex_Absyn_OffsetofField_struct*_tmp148=(struct Cyc_Absyn_TupleIndex_Absyn_OffsetofField_struct*)_tmp146.f2;if(_tmp148->tag != 1)goto _LLF3;};_LLF2:
...
const char*_tmp200;void*_tmp1FF;(_tmp1FF=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp200="Evexp::const_exp_cmp, unexpected case",_tag_dyneither(_tmp200,sizeof(char),38))),_tag_dyneither(_tmp1FF,sizeof(void*),0)));}_LLD7:;};};};}
# 412
int Cyc_Evexp_same_const_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2){
...
void*_tmp160=Cyc_Tcutil_compress(t);void*_tmp161=_tmp160;struct Cyc_Absyn_Tvar*_tmp164;struct Cyc_Absyn_Datatypefield*_tmp169;struct Cyc_List_List*_tmp16B;void*_tmp172;struct Cyc_Absyn_Exp*_tmp173;union Cyc_Absyn_AggrInfoU _tmp179;struct Cyc_List_List*_tmp17A;struct Cyc_List_List*_tmp17C;struct Cyc_Absyn_Typedefdecl*_tmp189;_LLFA: {struct Cyc_Absyn_VoidType_Absyn_Type_struct*_tmp162=(struct Cyc_Absyn_VoidType_Absyn_Type_struct*)_tmp161;if(_tmp162->tag != 0)goto _LLFC;}_LLFB:
...
# 429
enum Cyc_Absyn_KindQual _tmp18A=(Cyc_Tcutil_tvar_kind(_tmp164,& Cyc_Tcutil_bk))->kind;switch(_tmp18A){case Cyc_Absyn_BoxKind: _LL138:
 return 1;default: _LL139:
...
# 453
 return _tmp173 != 0;_LL114: {struct Cyc_Absyn_BuiltinType_Absyn_Type_struct*_tmp174=(struct Cyc_Absyn_BuiltinType_Absyn_Type_struct*)_tmp161;if(_tmp174->tag != 28)goto _LL116;}_LL115:
 return 1;_LL116: {struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp175=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp161;if(_tmp175->tag != 9)goto _LL118;}_LL117:
 return 0;_LL118: {struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct*_tmp176=(struct Cyc_Absyn_RgnHandleType_Absyn_Type_struct*)_tmp161;if(_tmp176->tag != 15)goto _LL11A;}_LL119:
 return 1;_LL11A: {struct Cyc_Absyn_DynRgnType_Absyn_Type_struct*_tmp177=(struct Cyc_Absyn_DynRgnType_Absyn_Type_struct*)_tmp161;if(_tmp177->tag != 16)goto _LL11C;}_LL11B:
 return 1;_LL11C: {struct Cyc_Absyn_AggrType_Absyn_Type_struct*_tmp178=(struct Cyc_Absyn_AggrType_Absyn_Type_struct*)_tmp161;if(_tmp178->tag != 11)goto _LL11E;else{_tmp179=(_tmp178->f1).aggr_info;_tmp17A=(_tmp178->f1).targs;}}_LL11D: {
# 459
struct Cyc_Absyn_Aggrdecl*ad;
{union Cyc_Absyn_AggrInfoU _tmp18B=_tmp179;struct Cyc_Absyn_Aggrdecl*_tmp18C;_LL13C: if((_tmp18B.UnknownAggr).tag != 1)goto _LL13E;_LL13D: {
const char*_tmp203;void*_tmp202;(_tmp202=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp203="szof on unchecked StructType",_tag_dyneither(_tmp203,sizeof(char),29))),_tag_dyneither(_tmp202,sizeof(void*),0)));}_LL13E: if((_tmp18B.KnownAggr).tag != 2)goto _LL13B;_tmp18C=*((struct Cyc_Absyn_Aggrdecl**)(_tmp18B.KnownAggr).val);_LL13F:
 ad=_tmp18C;_LL13B:;}
# 464
if(ad->impl == 0)
return 0;
{
struct _RegionHandle _tmp18F=_new_region("temp");struct _RegionHandle*temp=& _tmp18F;_push_region(temp);
{struct Cyc_List_List*_tmp190=((struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rzip)(temp,temp,ad->tvs,_tmp17A);
{struct Cyc_List_List*_tmp191=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->fields;for(0;_tmp191 != 0;_tmp191=_tmp191->tl){
if(!Cyc_Evexp_okay_szofarg(Cyc_Tcutil_rsubstitute(temp,_tmp190,((struct Cyc_Absyn_Aggrfield*)_tmp191->hd)->type))){int _tmp192=0;_npop_handler(0);return _tmp192;}}}{
int _tmp193=1;_npop_handler(0);return _tmp193;};}
# 468
;_pop_region(temp);}
# 473
_tmp17C=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(((struct Cyc_Absyn_Aggrdecl*)_check_null(ad))->impl))->fields;goto _LL11F;}_LL11E: {struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_tmp17B=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp161;if(_tmp17B->tag != 12)goto _LL120;else{_tmp17C=_tmp17B->f2;}}_LL11F:
# 475
 for(0;_tmp17C != 0;_tmp17C=_tmp17C->tl){
if(!Cyc_Evexp_okay_szofarg(((struct Cyc_Absyn_Aggrfield*)_tmp17C->hd)->type))
return 0;}
return 1;_LL120: {struct Cyc_Absyn_EnumType_Absyn_Type_struct*_tmp17D=(struct Cyc_Absyn_EnumType_Absyn_Type_struct*)_tmp161;if(_tmp17D->tag != 13)goto _LL122;}_LL121:
 goto _LL123;_LL122: {struct Cyc_Absyn_AnonEnumType_Absyn_Type_struct*_tmp17E=(struct Cyc_Absyn_AnonEnumType_Absyn_Type_struct*)_tmp161;if(_tmp17E->tag != 14)goto _LL124;}_LL123:
 return 1;_LL124: {struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*_tmp17F=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp161;if(_tmp17F->tag != 26)goto _LL126;}_LL125:
 goto _LL127;_LL126: {struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*_tmp180=(struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*)_tmp161;if(_tmp180->tag != 20)goto _LL128;}_LL127:
 goto _LL129;_LL128: {struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*_tmp181=(struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*)_tmp161;if(_tmp181->tag != 22)goto _LL12A;}_LL129:
 goto _LL12B;_LL12A: {struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*_tmp182=(struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*)_tmp161;if(_tmp182->tag != 21)goto _LL12C;}_LL12B:
 goto _LL12D;_LL12C: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp183=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmp161;if(_tmp183->tag != 24)goto _LL12E;}_LL12D:
 goto _LL12F;_LL12E: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmp184=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmp161;if(_tmp184->tag != 23)goto _LL130;}_LL12F:
 goto _LL131;_LL130: {struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_tmp185=(struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp161;if(_tmp185->tag != 18)goto _LL132;}_LL131:
 goto _LL133;_LL132: {struct Cyc_Absyn_TypeofType_Absyn_Type_struct*_tmp186=(struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_tmp161;if(_tmp186->tag != 27)goto _LL134;}_LL133:
 goto _LL135;_LL134: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmp187=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmp161;if(_tmp187->tag != 25)goto _LL136;}_LL135:
 return 0;_LL136: {struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmp188=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp161;if(_tmp188->tag != 17)goto _LLF9;else{_tmp189=_tmp188->f3;}}_LL137:
# 492
 if(_tmp189 == 0  || _tmp189->kind == 0){
struct Cyc_String_pa_PrintArg_struct _tmp20B;void*_tmp20A[1];const char*_tmp209;void*_tmp208;(_tmp208=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)((struct _dyneither_ptr)((_tmp20B.tag=0,((_tmp20B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp20A[0]=& _tmp20B,Cyc_aprintf(((_tmp209="szof typedeftype %s",_tag_dyneither(_tmp209,sizeof(char),20))),_tag_dyneither(_tmp20A,sizeof(void*),1)))))))),_tag_dyneither(_tmp208,sizeof(void*),0)));}
return((struct Cyc_Absyn_Kind*)((struct Cyc_Core_Opt*)_check_null(_tmp189->kind))->v)->kind == Cyc_Absyn_BoxKind;_LLF9:;}
