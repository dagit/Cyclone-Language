...
# 60
({struct Cyc_String_pa_PrintArg_struct _tmpB=({struct Cyc_String_pa_PrintArg_struct _tmp11C;_tmp11C.tag=0U,({struct _dyneither_ptr _tmp143=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp11C.f1=_tmp143;});_tmp11C;});void*_tmp9[1U];_tmp9[0]=& _tmpB;({unsigned _tmp145=e->loc;struct _dyneither_ptr _tmp144=({const char*_tmpA="expecting unsigned int found %s";_tag_dyneither(_tmpA,sizeof(char),32U);});Cyc_Tcutil_terr(_tmp145,_tmp144,_tag_dyneither(_tmp9,sizeof(void*),1U));});});return({struct _tuple10 _tmp11D;_tmp11D.f1=0U,_tmp11D.f2=1;_tmp11D;});}_LL3:;};}struct _tuple12{int f1;int f2;};
# 64
...
# 122
 if(i2 == 0){
({void*_tmp3F=0U;({unsigned _tmp149=e2->loc;struct _dyneither_ptr _tmp148=({const char*_tmp40="division by zero in constant expression";_tag_dyneither(_tmp40,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp149,_tmp148,_tag_dyneither(_tmp3F,sizeof(void*),0U));});});
...
({void*_tmp43=0U;({unsigned _tmp14B=e1->loc;struct _dyneither_ptr _tmp14A=({const char*_tmp44=">>> NOT IMPLEMENTED";_tag_dyneither(_tmp44,sizeof(char),20U);});Cyc_Tcutil_terr(_tmp14B,_tmp14A,_tag_dyneither(_tmp43,sizeof(void*),0U));});});goto _LL4D;default: _LL4C: _LL4D:
({void*_tmp45=0U;({unsigned _tmp14D=e1->loc;struct _dyneither_ptr _tmp14C=({const char*_tmp46="bad constant expression";_tag_dyneither(_tmp46,sizeof(char),24U);});Cyc_Tcutil_terr(_tmp14D,_tmp14C,_tag_dyneither(_tmp45,sizeof(void*),0U));});});return({struct _tuple11 _tmp12C;_tmp12C.f1=_tmp4C,_tmp12C.f2=1;_tmp12C;});}_LL17:;}
# 167
...
# 211
 if(_tmp87 == 0){
({void*_tmp5B=0U;({unsigned _tmp15A=e->loc;struct _dyneither_ptr _tmp159=({const char*_tmp5C="bad static expression (no args to primop)";_tag_dyneither(_tmp5C,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp15A,_tmp159,_tag_dyneither(_tmp5B,sizeof(void*),0U));});});
...
goto _LL0;}
# 223
({void*_tmp5D=0U;({unsigned _tmp15D=e->loc;struct _dyneither_ptr _tmp15C=({const char*_tmp5E="bad static expression (too many args to primop)";_tag_dyneither(_tmp5E,sizeof(char),48U);});Cyc_Tcutil_terr(_tmp15D,_tmp15C,_tag_dyneither(_tmp5D,sizeof(void*),0U));});});
...
# 257
 if(_tmp7C < 0)
({void*_tmp64=0U;({unsigned _tmp163=e->loc;struct _dyneither_ptr _tmp162=({const char*_tmp65="cannot cast negative number to a tag type";_tag_dyneither(_tmp65,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp163,_tmp162,_tag_dyneither(_tmp64,sizeof(void*),0U));});});
...
# 315
({struct Cyc_String_pa_PrintArg_struct _tmpA0=({struct Cyc_String_pa_PrintArg_struct _tmp13F;_tmp13F.tag=0U,({struct _dyneither_ptr _tmp16C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp13F.f1=_tmp16C;});_tmp13F;});void*_tmp9E[1U];_tmp9E[0]=& _tmpA0;({unsigned _tmp16E=e->loc;struct _dyneither_ptr _tmp16D=({const char*_tmp9F="bad static expression %s";_tag_dyneither(_tmp9F,sizeof(char),25U);});Cyc_Tcutil_terr(_tmp16E,_tmp16D,_tag_dyneither(_tmp9E,sizeof(void*),1U));});});return 0;}_LL0:;}
# 320
...
if(_tmpB3 == 0)
({void*_tmpB4=0U;({unsigned _tmp170=e2->loc;struct _dyneither_ptr _tmp16F=({const char*_tmpB5="cannot handle sizeof(exp) here -- use sizeof(type)";_tag_dyneither(_tmpB5,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp170,_tmp16F,_tag_dyneither(_tmpB4,sizeof(void*),0U));});});
...
if(_tmpB6 == 0)
({void*_tmpB7=0U;({unsigned _tmp172=e1->loc;struct _dyneither_ptr _tmp171=({const char*_tmpB8="cannot handle sizeof(exp) here -- use sizeof(type)";_tag_dyneither(_tmpB8,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp172,_tmp171,_tag_dyneither(_tmpB7,sizeof(void*),0U));});});
...
if(_tmpB9 == 0)
({void*_tmpBB=0U;({unsigned _tmp174=e1->loc;struct _dyneither_ptr _tmp173=({const char*_tmpBC="cannot handle sizeof(exp) here -- use sizeof(type)";_tag_dyneither(_tmpBC,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp174,_tmp173,_tag_dyneither(_tmpBB,sizeof(void*),0U));});});
if(_tmpBA == 0)
({void*_tmpBD=0U;({unsigned _tmp176=e2->loc;struct _dyneither_ptr _tmp175=({const char*_tmpBE="cannot handle sizeof(exp) here -- use sizeof(type)";_tag_dyneither(_tmpBE,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp176,_tmp175,_tag_dyneither(_tmpBD,sizeof(void*),0U));});});
...
struct _tuple16 _tmpC2=({struct _tuple16 _tmp140;_tmp140.f1=(void*)_tmpE7->hd,_tmp140.f2=(void*)_tmpE5->hd;_tmp140;});struct _tuple16 _tmpC3=_tmpC2;unsigned _tmpC7;unsigned _tmpC6;struct _dyneither_ptr*_tmpC5;struct _dyneither_ptr*_tmpC4;if(((struct Cyc_Absyn_StructField_Absyn_OffsetofField_struct*)_tmpC3.f1)->tag == 0U){if(((struct Cyc_Absyn_TupleIndex_Absyn_OffsetofField_struct*)_tmpC3.f2)->tag == 1U){_LL20: _LL21:
