...
struct _tuple11 _tmp1B4;return(_tmp1B4.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Signed,0),((_tmp1B4.f2=1,_tmp1B4)));};_LL72: {struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp5C=(struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmp4C;if(_tmp5C->tag != 37)goto _LL74;else{_tmp5D=(void*)_tmp5C->f1;}}_LL73:
# 213
