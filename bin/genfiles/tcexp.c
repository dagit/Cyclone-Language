...
Cyc_Absyn_Int_c(enum Cyc_Absyn_Sign,int);enum Cyc_Absyn_Primop{Cyc_Absyn_Plus  = 
...
struct Cyc_Absyn_Var_e_struct{int tag;struct _tuple1*f1;void*f2;};struct Cyc_Absyn_Primop_e_struct{
...
_tmp2=e1->r;struct _tuple1*_tmp4;void*_tmp5;void**_tmp6;_LL1: {struct Cyc_Absyn_Var_e_struct*
_tmp3=(struct Cyc_Absyn_Var_e_struct*)_tmp2;if(_tmp3->tag != 1)goto _LL3;else{_tmp4=
_tmp3->f1;_tmp5=(void**)& _tmp3->f2;_tmp6=(void**)((void**)& _tmp3->f2);}}_LL2: {
struct _handler_cons _tmp7;_push_handler(& _tmp7);{int _tmp9=0;if(setjmp(_tmp7.handler))
_tmp9=1;if(!_tmp9){{struct _RegionHandle _tmpA=_new_region("r");struct
_RegionHandle*r=& _tmpA;_push_region(r);{void*_tmpB=Cyc_Tcenv_lookup_ordinary(r,
te,e1->loc,_tmp4);void*_tmpD;struct Cyc_Absyn_Datatypedecl*_tmpF;struct Cyc_Absyn_Datatypefield*
_tmp10;struct Cyc_Absyn_Aggrdecl*_tmp12;_LL6: {struct Cyc_Tcenv_VarRes_struct*
_tmpC=(struct Cyc_Tcenv_VarRes_struct*)_tmpB;if(_tmpC->tag != 0)goto _LL8;else{
_tmpD=(void*)_tmpC->f1;}}_LL7:*_tmp6=_tmpD;_npop_handler(1);return;_LL8: {struct
Cyc_Tcenv_DatatypeRes_struct*_tmpE=(struct Cyc_Tcenv_DatatypeRes_struct*)_tmpB;
if(_tmpE->tag != 2)goto _LLA;else{_tmpF=_tmpE->f1;_tmp10=_tmpE->f2;}}_LL9: if(
_tmp10->typs == 0){const char*_tmp6CF;void*_tmp6CE[1];struct Cyc_String_pa_struct
...
33))),_tag_dyneither(_tmp6CE,sizeof(void*),1)))))));}{struct Cyc_Absyn_Datatype_e_struct
_tmp6D2;struct Cyc_Absyn_Datatype_e_struct*_tmp6D1;e->r=(void*)((_tmp6D1=
_cycalloc(sizeof(*_tmp6D1)),((_tmp6D1[0]=((_tmp6D2.tag=29,((_tmp6D2.f1=es,((
_tmp6D2.f2=_tmpF,((_tmp6D2.f3=_tmp10,_tmp6D2)))))))),_tmp6D1))));}_npop_handler(
1);return;_LLA: {struct Cyc_Tcenv_AggrRes_struct*_tmp11=(struct Cyc_Tcenv_AggrRes_struct*)
_tmpB;if(_tmp11->tag != 1)goto _LLC;else{_tmp12=_tmp11->f1;}}_LLB: {struct Cyc_List_List*
_tmp1A=((struct Cyc_List_List*(*)(struct _tuple18*(*f)(struct Cyc_Absyn_Exp*),
struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcexp_make_struct_arg,es);{struct Cyc_Absyn_Aggregate_e_struct
_tmp6D5;struct Cyc_Absyn_Aggregate_e_struct*_tmp6D4;e->r=(void*)((_tmp6D4=
_cycalloc(sizeof(*_tmp6D4)),((_tmp6D4[0]=((_tmp6D5.tag=27,((_tmp6D5.f1=_tmp12->name,((
_tmp6D5.f2=0,((_tmp6D5.f3=_tmp1A,((_tmp6D5.f4=(struct Cyc_Absyn_Aggrdecl*)_tmp12,
_tmp6D5)))))))))),_tmp6D4))));}_npop_handler(1);return;}_LLC: {struct Cyc_Tcenv_AnonEnumRes_struct*
_tmp13=(struct Cyc_Tcenv_AnonEnumRes_struct*)_tmpB;if(_tmp13->tag != 4)goto _LLE;}
_LLD: goto _LLF;_LLE: {struct Cyc_Tcenv_EnumRes_struct*_tmp14=(struct Cyc_Tcenv_EnumRes_struct*)
_tmpB;if(_tmp14->tag != 3)goto _LL5;}_LLF:{const char*_tmp6D9;void*_tmp6D8[1];
struct Cyc_String_pa_struct _tmp6D7;(_tmp6D7.tag=0,((_tmp6D7.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp4)),((_tmp6D8[
0]=& _tmp6D7,Cyc_Tcutil_terr(e->loc,((_tmp6D9="%s is an enum constructor, not a function",
_tag_dyneither(_tmp6D9,sizeof(char),42))),_tag_dyneither(_tmp6D8,sizeof(void*),1)))))));}
_npop_handler(1);return;_LL5:;};_pop_region(r);};_pop_handler();}else{void*_tmp8=(
void*)_exn_thrown;void*_tmp21=_tmp8;_LL11: {struct Cyc_Dict_Absent_struct*_tmp22=(
struct Cyc_Dict_Absent_struct*)_tmp21;if(_tmp22->tag != Cyc_Dict_Absent)goto _LL13;}
_LL12: return;_LL13:;_LL14:(void)_throw(_tmp21);_LL10:;}};}_LL3:;_LL4: return;_LL0:;}
static void Cyc_Tcexp_resolve_unresolved_mem(struct Cyc_Tcenv_Tenv*te,unsigned int
loc,void**topt,struct Cyc_Absyn_Exp*e,struct Cyc_List_List*des){if(topt == 0){{
struct Cyc_Absyn_Array_e_struct _tmp6DC;struct Cyc_Absyn_Array_e_struct*_tmp6DB;e->r=(
void*)((_tmp6DB=_cycalloc(sizeof(*_tmp6DB)),((_tmp6DB[0]=((_tmp6DC.tag=25,((
_tmp6DC.f1=des,_tmp6DC)))),_tmp6DB))));}return;}{void*t=*topt;void*_tmp25=Cyc_Tcutil_compress(
t);struct Cyc_Absyn_AggrInfo _tmp27;union Cyc_Absyn_AggrInfoU _tmp28;struct Cyc_Absyn_ArrayInfo
_tmp2A;void*_tmp2B;struct Cyc_Absyn_Tqual _tmp2C;_LL16: {struct Cyc_Absyn_AggrType_struct*
_tmp26=(struct Cyc_Absyn_AggrType_struct*)_tmp25;if(_tmp26->tag != 11)goto _LL18;
else{_tmp27=_tmp26->f1;_tmp28=_tmp27.aggr_info;}}_LL17:{union Cyc_Absyn_AggrInfoU
_tmp2E=_tmp28;struct _tuple3 _tmp2F;struct Cyc_Absyn_Aggrdecl**_tmp30;struct Cyc_Absyn_Aggrdecl*
_tmp31;_LL1F: if((_tmp2E.UnknownAggr).tag != 1)goto _LL21;_tmp2F=(struct _tuple3)(
_tmp2E.UnknownAggr).val;_LL20: {const char*_tmp6DF;void*_tmp6DE;(_tmp6DE=0,((int(*)(
struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp6DF="struct type not properly set",
...
_tmp2E.KnownAggr).val;_tmp31=*_tmp30;_LL22: {struct Cyc_Absyn_Aggregate_e_struct
_tmp6E2;struct Cyc_Absyn_Aggregate_e_struct*_tmp6E1;e->r=(void*)((_tmp6E1=
_cycalloc(sizeof(*_tmp6E1)),((_tmp6E1[0]=((_tmp6E2.tag=27,((_tmp6E2.f1=_tmp31->name,((
_tmp6E2.f2=0,((_tmp6E2.f3=des,((_tmp6E2.f4=(struct Cyc_Absyn_Aggrdecl*)_tmp31,
_tmp6E2)))))))))),_tmp6E1))));}_LL1E:;}goto _LL15;_LL18: {struct Cyc_Absyn_ArrayType_struct*
_tmp29=(struct Cyc_Absyn_ArrayType_struct*)_tmp25;if(_tmp29->tag != 8)goto _LL1A;
else{_tmp2A=_tmp29->f1;_tmp2B=_tmp2A.elt_type;_tmp2C=_tmp2A.tq;}}_LL19:{struct
Cyc_Absyn_Array_e_struct _tmp6E5;struct Cyc_Absyn_Array_e_struct*_tmp6E4;e->r=(
void*)((_tmp6E4=_cycalloc(sizeof(*_tmp6E4)),((_tmp6E4[0]=((_tmp6E5.tag=25,((
_tmp6E5.f1=des,_tmp6E5)))),_tmp6E4))));}goto _LL15;_LL1A: {struct Cyc_Absyn_AnonAggrType_struct*
_tmp2D=(struct Cyc_Absyn_AnonAggrType_struct*)_tmp25;if(_tmp2D->tag != 12)goto
_LL1C;}_LL1B:{struct Cyc_Absyn_AnonStruct_e_struct _tmp6E8;struct Cyc_Absyn_AnonStruct_e_struct*
_tmp6E7;e->r=(void*)((_tmp6E7=_cycalloc(sizeof(*_tmp6E7)),((_tmp6E7[0]=((_tmp6E8.tag=
28,((_tmp6E8.f1=(void*)t,((_tmp6E8.f2=des,_tmp6E8)))))),_tmp6E7))));}goto _LL15;
_LL1C:;_LL1D:{struct Cyc_Absyn_Array_e_struct _tmp6EB;struct Cyc_Absyn_Array_e_struct*
_tmp6EA;e->r=(void*)((_tmp6EA=_cycalloc(sizeof(*_tmp6EA)),((_tmp6EA[0]=((_tmp6EB.tag=
25,((_tmp6EB.f1=des,_tmp6EB)))),_tmp6EA))));}goto _LL15;_LL15:;};}static void Cyc_Tcexp_tcExpNoInst(
...
te,e)){const char*_tmp6F0;void*_tmp6EF[2];struct Cyc_String_pa_struct _tmp6EE;
struct Cyc_String_pa_struct _tmp6ED;(_tmp6ED.tag=0,((_tmp6ED.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(
e->topt))),((_tmp6EE.tag=0,((_tmp6EE.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)msg_part),((_tmp6EF[0]=& _tmp6EE,((_tmp6EF[1]=& _tmp6ED,Cyc_Tcutil_terr(
...
struct Cyc_Absyn_Primop_e_struct*_tmp41=(struct Cyc_Absyn_Primop_e_struct*)_tmp40;
if(_tmp41->tag != 2)goto _LL26;else{_tmp42=_tmp41->f1;_tmp43=_tmp41->f2;}}_LL25:
if(_tmp42 == Cyc_Absyn_Eq  || _tmp42 == Cyc_Absyn_Neq){struct _tuple0 _tmp6F1;struct
_tuple0 _tmp45=(_tmp6F1.f1=(void*)_check_null(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)
_check_null(_tmp43))->hd)->topt),((_tmp6F1.f2=(void*)_check_null(((struct Cyc_Absyn_Exp*)((
struct Cyc_List_List*)_check_null(((struct Cyc_List_List*)_check_null(_tmp43))->tl))->hd)->topt),
_tmp6F1)));void*_tmp46;void*_tmp48;void*_tmp49;void*_tmp4B;_LL29: _tmp46=_tmp45.f1;{
struct Cyc_Absyn_RgnHandleType_struct*_tmp47=(struct Cyc_Absyn_RgnHandleType_struct*)
_tmp46;if(_tmp47->tag != 15)goto _LL2B;else{_tmp48=(void*)_tmp47->f1;}};_tmp49=
_tmp45.f2;{struct Cyc_Absyn_RgnHandleType_struct*_tmp4A=(struct Cyc_Absyn_RgnHandleType_struct*)
_tmp49;if(_tmp4A->tag != 15)goto _LL2B;else{_tmp4B=(void*)_tmp4A->f1;}};_LL2A: {
struct _tuple0*_tmp6F4;struct Cyc_Tcexp_TestEnv _tmp6F3;return(_tmp6F3.eq=((_tmp6F4=
_region_malloc(Cyc_Tcenv_get_fnrgn(te),sizeof(*_tmp6F4)),((_tmp6F4->f1=_tmp48,((
_tmp6F4->f2=_tmp4B,_tmp6F4)))))),((_tmp6F3.isTrue=_tmp42 == Cyc_Absyn_Eq,_tmp6F3)));}
_LL2B:;_LL2C: goto _LL28;_LL28:;}goto _LL23;_LL26:;_LL27: goto _LL23;_LL23:;}{struct
Cyc_Tcexp_TestEnv _tmp6F5;return(_tmp6F5.eq=0,((_tmp6F5.isTrue=0,_tmp6F5)));};}
...
0;{union Cyc_Absyn_Cnst _tmp4F=*((union Cyc_Absyn_Cnst*)_check_null(c));struct
_tuple4 _tmp50;enum Cyc_Absyn_Sign _tmp51;struct _tuple4 _tmp52;enum Cyc_Absyn_Sign
_tmp53;struct _tuple4 _tmp54;enum Cyc_Absyn_Sign _tmp55;struct _dyneither_ptr _tmp56;
struct _tuple5 _tmp57;enum Cyc_Absyn_Sign _tmp58;struct _tuple7 _tmp59;enum Cyc_Absyn_Sign
_tmp5A;struct _tuple8 _tmp5B;int _tmp5C;struct _tuple6 _tmp5D;enum Cyc_Absyn_Sign
_tmp5E;int _tmp5F;struct _dyneither_ptr _tmp60;struct _dyneither_ptr _tmp61;int _tmp62;
_LL2E: if((_tmp4F.Char_c).tag != 2)goto _LL30;_tmp50=(struct _tuple4)(_tmp4F.Char_c).val;
_tmp51=_tmp50.f1;if(_tmp51 != Cyc_Absyn_Signed)goto _LL30;_LL2F: t=Cyc_Absyn_schar_typ;
goto _LL2D;_LL30: if((_tmp4F.Char_c).tag != 2)goto _LL32;_tmp52=(struct _tuple4)(
_tmp4F.Char_c).val;_tmp53=_tmp52.f1;if(_tmp53 != Cyc_Absyn_Unsigned)goto _LL32;
_LL31: t=Cyc_Absyn_uchar_typ;goto _LL2D;_LL32: if((_tmp4F.Char_c).tag != 2)goto _LL34;
_tmp54=(struct _tuple4)(_tmp4F.Char_c).val;_tmp55=_tmp54.f1;if(_tmp55 != Cyc_Absyn_None)
goto _LL34;_LL33: t=Cyc_Absyn_char_typ;goto _LL2D;_LL34: if((_tmp4F.Wchar_c).tag != 3)
goto _LL36;_tmp56=(struct _dyneither_ptr)(_tmp4F.Wchar_c).val;_LL35: t=Cyc_Absyn_wchar_typ();
goto _LL2D;_LL36: if((_tmp4F.Short_c).tag != 4)goto _LL38;_tmp57=(struct _tuple5)(
_tmp4F.Short_c).val;_tmp58=_tmp57.f1;_LL37: t=_tmp58 == Cyc_Absyn_Unsigned?Cyc_Absyn_ushort_typ:
Cyc_Absyn_sshort_typ;goto _LL2D;_LL38: if((_tmp4F.LongLong_c).tag != 6)goto _LL3A;
_tmp59=(struct _tuple7)(_tmp4F.LongLong_c).val;_tmp5A=_tmp59.f1;_LL39: t=_tmp5A == 
Cyc_Absyn_Unsigned?Cyc_Absyn_ulonglong_typ: Cyc_Absyn_slonglong_typ;goto _LL2D;
_LL3A: if((_tmp4F.Float_c).tag != 7)goto _LL3C;_tmp5B=(struct _tuple8)(_tmp4F.Float_c).val;
_tmp5C=_tmp5B.f2;_LL3B: t=Cyc_Absyn_float_typ(_tmp5C);goto _LL2D;_LL3C: if((_tmp4F.Int_c).tag
!= 5)goto _LL3E;_tmp5D=(struct _tuple6)(_tmp4F.Int_c).val;_tmp5E=_tmp5D.f1;_tmp5F=
_tmp5D.f2;_LL3D: if(topt == 0)t=_tmp5E == Cyc_Absyn_Unsigned?Cyc_Absyn_uint_typ: Cyc_Absyn_sint_typ;
else{void*_tmp63=Cyc_Tcutil_compress(*topt);enum Cyc_Absyn_Sign _tmp65;enum Cyc_Absyn_Size_of
...
struct Cyc_Absyn_IntType_struct*_tmp64=(struct Cyc_Absyn_IntType_struct*)_tmp63;
if(_tmp64->tag != 6)goto _LL47;else{_tmp65=_tmp64->f1;_tmp66=_tmp64->f2;if(_tmp66
!= Cyc_Absyn_Char_sz)goto _LL47;}}_LL46: switch(_tmp65){case Cyc_Absyn_Unsigned:
...
_tmp65,(char)_tmp5F);goto _LL44;_LL47: {struct Cyc_Absyn_IntType_struct*_tmp67=(
struct Cyc_Absyn_IntType_struct*)_tmp63;if(_tmp67->tag != 6)goto _LL49;else{_tmp68=
_tmp67->f1;_tmp69=_tmp67->f2;if(_tmp69 != Cyc_Absyn_Short_sz)goto _LL49;}}_LL48: t=
_tmp68 == Cyc_Absyn_Unsigned?Cyc_Absyn_ushort_typ: Cyc_Absyn_sshort_typ;*c=Cyc_Absyn_Short_c(
_tmp68,(short)_tmp5F);goto _LL44;_LL49: {struct Cyc_Absyn_IntType_struct*_tmp6A=(
struct Cyc_Absyn_IntType_struct*)_tmp63;if(_tmp6A->tag != 6)goto _LL4B;else{_tmp6B=
_tmp6A->f1;_tmp6C=_tmp6A->f2;if(_tmp6C != Cyc_Absyn_Int_sz)goto _LL4B;}}_LL4A: t=
_tmp6B == Cyc_Absyn_Unsigned?Cyc_Absyn_uint_typ: Cyc_Absyn_sint_typ;goto _LL44;
_LL4B: {struct Cyc_Absyn_IntType_struct*_tmp6D=(struct Cyc_Absyn_IntType_struct*)
...
Cyc_Absyn_sint_typ;goto _LL44;_LL4D:{struct Cyc_Absyn_PointerType_struct*_tmp70=(
struct Cyc_Absyn_PointerType_struct*)_tmp63;if(_tmp70->tag != 5)goto _LL4F;else{
_tmp71=_tmp70->f1;_tmp72=_tmp71.elt_typ;_tmp73=_tmp71.elt_tq;_tmp74=_tmp71.ptr_atts;
_tmp75=_tmp74.rgn;_tmp76=_tmp74.nullable;_tmp77=_tmp74.bounds;_tmp78=_tmp74.zero_term;}}
if(!(_tmp5F == 0))goto _LL4F;_LL4E: {static struct Cyc_Absyn_Const_e_struct nullc={0,{.Null_c={
1,0}}};e->r=(void*)& nullc;if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_constr)(
1,_tmp76))return*topt;{struct Cyc_List_List*_tmp7B=Cyc_Tcenv_lookup_type_vars(te);{
struct Cyc_Absyn_PointerType_struct _tmp6FF;struct Cyc_Absyn_PtrAtts _tmp6FE;struct
Cyc_Absyn_PtrInfo _tmp6FD;struct Cyc_Absyn_PointerType_struct*_tmp6FC;t=(void*)((
_tmp6FC=_cycalloc(sizeof(*_tmp6FC)),((_tmp6FC[0]=((_tmp6FF.tag=5,((_tmp6FF.f1=((
_tmp6FD.elt_typ=_tmp72,((_tmp6FD.elt_tq=_tmp73,((_tmp6FD.ptr_atts=((_tmp6FE.rgn=
_tmp75,((_tmp6FE.nullable=Cyc_Absyn_true_conref,((_tmp6FE.bounds=_tmp77,((
_tmp6FE.zero_term=_tmp78,((_tmp6FE.ptrloc=0,_tmp6FE)))))))))),_tmp6FD)))))),
_tmp6FF)))),_tmp6FC))));}goto _LL44;};}_LL4F: {struct Cyc_Absyn_TagType_struct*
_tmp79=(struct Cyc_Absyn_TagType_struct*)_tmp63;if(_tmp79->tag != 19)goto _LL51;
else{_tmp7A=(void*)_tmp79->f1;}}_LL50: {struct Cyc_Absyn_ValueofType_struct
_tmp702;struct Cyc_Absyn_ValueofType_struct*_tmp701;struct Cyc_Absyn_ValueofType_struct*
...
struct Cyc_String_pa_struct _tmp705;struct Cyc_String_pa_struct _tmp704;(_tmp704.tag=
0,((_tmp704.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((
void*)_tmp81)),((_tmp705.tag=0,((_tmp705.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_typ2string(_tmp7A)),((_tmp706[0]=& _tmp705,((_tmp706[1]=&
_tmp704,Cyc_Tcutil_terr(loc,((_tmp707="expecting %s but found %s",_tag_dyneither(
_tmp707,sizeof(char),26))),_tag_dyneither(_tmp706,sizeof(void*),2)))))))))))));}
Cyc_Tcutil_explain_failure();}{struct Cyc_Absyn_TagType_struct _tmp70A;struct Cyc_Absyn_TagType_struct*
_tmp709;t=(void*)((_tmp709=_cycalloc(sizeof(*_tmp709)),((_tmp709[0]=((_tmp70A.tag=
19,((_tmp70A.f1=(void*)((void*)_tmp81),_tmp70A)))),_tmp709))));}goto _LL44;}_LL51:;
_LL52: t=_tmp5E == Cyc_Absyn_Unsigned?Cyc_Absyn_uint_typ: Cyc_Absyn_sint_typ;goto
_LL44;_LL44:;}goto _LL2D;_LL3E: if((_tmp4F.String_c).tag != 8)goto _LL40;_tmp60=(
struct _dyneither_ptr)(_tmp4F.String_c).val;_LL3F: string_numelts=(int)
_get_dyneither_size(_tmp60,sizeof(char));_tmp61=_tmp60;goto _LL41;_LL40: if((
_tmp4F.Wstring_c).tag != 9)goto _LL42;_tmp61=(struct _dyneither_ptr)(_tmp4F.Wstring_c).val;
_LL41: if(string_numelts == 0){string_numelts=Cyc_Tcexp_wchar_numelts(_tmp61);
string_elt_typ=Cyc_Absyn_wchar_typ();}{struct Cyc_Absyn_Exp*elen=Cyc_Absyn_const_exp(
Cyc_Absyn_Int_c(Cyc_Absyn_Unsigned,string_numelts),loc);elen->topt=(void*)Cyc_Absyn_uint_typ;{
struct Cyc_Absyn_Upper_b_struct _tmp70D;struct Cyc_Absyn_Upper_b_struct*_tmp70C;
struct Cyc_Absyn_Upper_b_struct*_tmp8A=(_tmp70C=_cycalloc(sizeof(*_tmp70C)),((
_tmp70C[0]=((_tmp70D.tag=1,((_tmp70D.f1=elen,_tmp70D)))),_tmp70C)));t=Cyc_Absyn_atb_typ(
string_elt_typ,(void*)& Cyc_Absyn_HeapRgn_val,Cyc_Absyn_const_tqual(0),(void*)
_tmp8A,Cyc_Absyn_true_conref);if(topt != 0){void*_tmp8B=Cyc_Tcutil_compress(*topt);
struct Cyc_Absyn_ArrayInfo _tmp8D;struct Cyc_Absyn_Tqual _tmp8E;_LL58: {struct Cyc_Absyn_ArrayType_struct*
_tmp8C=(struct Cyc_Absyn_ArrayType_struct*)_tmp8B;if(_tmp8C->tag != 8)goto _LL5A;
else{_tmp8D=_tmp8C->f1;_tmp8E=_tmp8D.tq;}}_LL59: return Cyc_Absyn_array_typ(
string_elt_typ,_tmp8E,(struct Cyc_Absyn_Exp*)elen,((union Cyc_Absyn_Constraint*(*)())
Cyc_Absyn_empty_conref)(),0);_LL5A: {struct Cyc_Absyn_PointerType_struct*_tmp8F=(
struct Cyc_Absyn_PointerType_struct*)_tmp8B;if(_tmp8F->tag != 5)goto _LL5C;}_LL5B:
if(!Cyc_Tcutil_unify(*topt,t) && Cyc_Tcutil_silent_castable(te,loc,t,*topt)){e->topt=(
void*)t;Cyc_Tcutil_unchecked_cast(te,e,*topt,Cyc_Absyn_Other_coercion);t=*topt;}
else{t=Cyc_Absyn_atb_typ(string_elt_typ,Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)&
...
struct Cyc_Absyn_PointerType_struct*_tmp93=(struct Cyc_Absyn_PointerType_struct*)
...
x))Cyc_Absyn_conref_constr)(1,_tmp99))return*topt;{struct Cyc_Absyn_PointerType_struct
_tmp717;struct Cyc_Absyn_PtrAtts _tmp716;struct Cyc_Absyn_PtrInfo _tmp715;struct Cyc_Absyn_PointerType_struct*
...
Cyc_List_List*_tmpA0=Cyc_Tcenv_lookup_type_vars(te);{struct Cyc_Absyn_PointerType_struct
_tmp72A;struct Cyc_Absyn_PtrAtts _tmp729;struct Cyc_Core_Opt*_tmp728;struct Cyc_Core_Opt*
_tmp727;struct Cyc_Absyn_PtrInfo _tmp726;struct Cyc_Absyn_PointerType_struct*
...
_tmpB0;struct Cyc_Absyn_Vardecl*_tmpB2;_LL64: {struct Cyc_Absyn_Unresolved_b_struct*
_tmpA8=(struct Cyc_Absyn_Unresolved_b_struct*)_tmpA7;if(_tmpA8->tag != 0)goto _LL66;}
_LL65: {struct _handler_cons _tmpB3;_push_handler(& _tmpB3);{int _tmpB5=0;if(setjmp(
_tmpB3.handler))_tmpB5=1;if(!_tmpB5){{struct _RegionHandle _tmpB6=_new_region("r");
struct _RegionHandle*r=& _tmpB6;_push_region(r);{void*_tmpB7=Cyc_Tcenv_lookup_ordinary(
r,te,e->loc,q);void*_tmpB9;struct Cyc_Absyn_Enumdecl*_tmpBB;struct Cyc_Absyn_Enumfield*
_tmpBC;void*_tmpBE;struct Cyc_Absyn_Enumfield*_tmpBF;struct Cyc_Absyn_Datatypedecl*
_tmpC1;struct Cyc_Absyn_Datatypefield*_tmpC2;_LL71: {struct Cyc_Tcenv_VarRes_struct*
_tmpB8=(struct Cyc_Tcenv_VarRes_struct*)_tmpB7;if(_tmpB8->tag != 0)goto _LL73;else{
_tmpB9=(void*)_tmpB8->f1;}}_LL72:*b=_tmpB9;{void*_tmpC4=Cyc_Tcexp_tcVar(te,loc,
topt,e,q,b);_npop_handler(1);return _tmpC4;};_LL73: {struct Cyc_Tcenv_EnumRes_struct*
_tmpBA=(struct Cyc_Tcenv_EnumRes_struct*)_tmpB7;if(_tmpBA->tag != 3)goto _LL75;
else{_tmpBB=_tmpBA->f1;_tmpBC=_tmpBA->f2;}}_LL74:{struct Cyc_Absyn_Enum_e_struct
_tmp72D;struct Cyc_Absyn_Enum_e_struct*_tmp72C;e->r=(void*)((_tmp72C=_cycalloc(
sizeof(*_tmp72C)),((_tmp72C[0]=((_tmp72D.tag=30,((_tmp72D.f1=_tmpBC->name,((
_tmp72D.f2=(struct Cyc_Absyn_Enumdecl*)_tmpBB,((_tmp72D.f3=(struct Cyc_Absyn_Enumfield*)
_tmpBC,_tmp72D)))))))),_tmp72C))));}{struct Cyc_Absyn_EnumType_struct _tmp730;
struct Cyc_Absyn_EnumType_struct*_tmp72F;void*_tmpC9=(void*)((_tmp72F=_cycalloc(
sizeof(*_tmp72F)),((_tmp72F[0]=((_tmp730.tag=13,((_tmp730.f1=_tmpBB->name,((
_tmp730.f2=(struct Cyc_Absyn_Enumdecl*)_tmpBB,_tmp730)))))),_tmp72F))));
_npop_handler(1);return _tmpC9;};_LL75: {struct Cyc_Tcenv_AnonEnumRes_struct*
_tmpBD=(struct Cyc_Tcenv_AnonEnumRes_struct*)_tmpB7;if(_tmpBD->tag != 4)goto _LL77;
else{_tmpBE=(void*)_tmpBD->f1;_tmpBF=_tmpBD->f2;}}_LL76:{struct Cyc_Absyn_AnonEnum_e_struct
_tmp733;struct Cyc_Absyn_AnonEnum_e_struct*_tmp732;e->r=(void*)((_tmp732=
_cycalloc(sizeof(*_tmp732)),((_tmp732[0]=((_tmp733.tag=31,((_tmp733.f1=_tmpBF->name,((
_tmp733.f2=(void*)_tmpBE,((_tmp733.f3=(struct Cyc_Absyn_Enumfield*)_tmpBF,_tmp733)))))))),
_tmp732))));}{void*_tmpCC=_tmpBE;_npop_handler(1);return _tmpCC;};_LL77: {struct
Cyc_Tcenv_DatatypeRes_struct*_tmpC0=(struct Cyc_Tcenv_DatatypeRes_struct*)_tmpB7;
if(_tmpC0->tag != 2)goto _LL79;else{_tmpC1=_tmpC0->f1;_tmpC2=_tmpC0->f2;}}_LL78:{
struct Cyc_Absyn_Datatype_e_struct _tmp736;struct Cyc_Absyn_Datatype_e_struct*
_tmp735;e->r=(void*)((_tmp735=_cycalloc(sizeof(*_tmp735)),((_tmp735[0]=((_tmp736.tag=
29,((_tmp736.f1=0,((_tmp736.f2=_tmpC1,((_tmp736.f3=_tmpC2,_tmp736)))))))),
_tmp735))));}{void*_tmpCF=Cyc_Tcexp_tcDatatype(te,loc,topt,e,0,_tmpC1,_tmpC2);
_npop_handler(1);return _tmpCF;};_LL79: {struct Cyc_Tcenv_AggrRes_struct*_tmpC3=(
struct Cyc_Tcenv_AggrRes_struct*)_tmpB7;if(_tmpC3->tag != 1)goto _LL70;}_LL7A: {
const char*_tmp73A;void*_tmp739[1];struct Cyc_String_pa_struct _tmp738;void*_tmpD3=(
_tmp738.tag=0,((_tmp738.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
q)),((_tmp739[0]=& _tmp738,Cyc_Tcexp_expr_err(te,loc,0,((_tmp73A="bad occurrence of type name %s",
...
void*_tmpB4=(void*)_exn_thrown;void*_tmpD5=_tmpB4;_LL7C: {struct Cyc_Dict_Absent_struct*
_tmpD6=(struct Cyc_Dict_Absent_struct*)_tmpD5;if(_tmpD6->tag != Cyc_Dict_Absent)
goto _LL7E;}_LL7D: {const char*_tmp73E;void*_tmp73D[1];struct Cyc_String_pa_struct
...
_throw(_tmpD5);_LL7B:;}};}_LL66: {struct Cyc_Absyn_Global_b_struct*_tmpA9=(struct
Cyc_Absyn_Global_b_struct*)_tmpA7;if(_tmpA9->tag != 1)goto _LL68;else{_tmpAA=
_tmpA9->f1;}}_LL67:*q=*_tmpAA->name;return _tmpAA->type;_LL68: {struct Cyc_Absyn_Funname_b_struct*
_tmpAB=(struct Cyc_Absyn_Funname_b_struct*)_tmpA7;if(_tmpAB->tag != 2)goto _LL6A;
else{_tmpAC=_tmpAB->f1;}}_LL69:*q=*_tmpAC->name;return Cyc_Tcutil_fndecl2typ(
_tmpAC);_LL6A: {struct Cyc_Absyn_Pat_b_struct*_tmpAD=(struct Cyc_Absyn_Pat_b_struct*)
_tmpA7;if(_tmpAD->tag != 5)goto _LL6C;else{_tmpAE=_tmpAD->f1;}}_LL6B: _tmpB0=_tmpAE;
goto _LL6D;_LL6C: {struct Cyc_Absyn_Local_b_struct*_tmpAF=(struct Cyc_Absyn_Local_b_struct*)
_tmpA7;if(_tmpAF->tag != 4)goto _LL6E;else{_tmpB0=_tmpAF->f1;}}_LL6D: _tmpB2=_tmpB0;
goto _LL6F;_LL6E: {struct Cyc_Absyn_Param_b_struct*_tmpB1=(struct Cyc_Absyn_Param_b_struct*)
...
_LL81: {struct Cyc_Absyn_TagType_struct*_tmpDC=(struct Cyc_Absyn_TagType_struct*)
_tmpDB;if(_tmpDC->tag != 19)goto _LL83;else{_tmpDD=(void*)_tmpDC->f1;}}_LL82:{
struct Cyc_Absyn_Valueof_e_struct _tmp742;struct Cyc_Absyn_Valueof_e_struct*_tmp741;
e->r=(void*)((_tmp741=_cycalloc(sizeof(*_tmp741)),((_tmp741[0]=((_tmp742.tag=37,((
_tmp742.f1=(void*)_tmpDD,_tmp742)))),_tmp741))));}goto _LL80;_LL83:;_LL84: goto
_LL80;_LL80:;}return _tmpB2->type;_LL63:;}static void Cyc_Tcexp_check_format_args(
...
struct Cyc_Absyn_Const_e_struct*_tmpE1=(struct Cyc_Absyn_Const_e_struct*)_tmpE0;
if(_tmpE1->tag != 0)goto _LL88;else{_tmpE2=_tmpE1->f1;if((_tmpE2.String_c).tag != 8)
goto _LL88;_tmpE3=(struct _dyneither_ptr)(_tmpE2.String_c).val;}}_LL87: _tmpEA=
_tmpE3;goto _LL89;_LL88: {struct Cyc_Absyn_Cast_e_struct*_tmpE4=(struct Cyc_Absyn_Cast_e_struct*)
_tmpE0;if(_tmpE4->tag != 13)goto _LL8A;else{_tmpE5=_tmpE4->f2;_tmpE6=*_tmpE5;
_tmpE7=_tmpE6.r;{struct Cyc_Absyn_Const_e_struct*_tmpE8=(struct Cyc_Absyn_Const_e_struct*)
_tmpE7;if(_tmpE8->tag != 0)goto _LL8A;else{_tmpE9=_tmpE8->f1;if((_tmpE9.String_c).tag
!= 8)goto _LL8A;_tmpEA=(struct _dyneither_ptr)(_tmpE9.String_c).val;}};}}_LL89:
desc_types=type_getter(temp,te,(struct _dyneither_ptr)_tmpEA,fmt->loc);goto _LL85;
_LL8A:;_LL8B: if(opt_args != 0){struct Cyc_List_List*_tmpEB=(struct Cyc_List_List*)
opt_args->v;for(0;_tmpEB != 0;_tmpEB=_tmpEB->tl){Cyc_Tcexp_tcExp(te,0,(struct Cyc_Absyn_Exp*)
_tmpEB->hd);{struct _RegionHandle _tmpEC=_new_region("temp");struct _RegionHandle*
temp=& _tmpEC;_push_region(temp);if(Cyc_Tcutil_is_noalias_pointer_or_aggr(temp,(
void*)_check_null(((struct Cyc_Absyn_Exp*)_tmpEB->hd)->topt)) && !Cyc_Tcutil_is_noalias_path(
...
alias_coercion)){{const char*_tmp74A;void*_tmp749[2];struct Cyc_String_pa_struct
_tmp748;struct Cyc_String_pa_struct _tmp747;(_tmp747.tag=0,((_tmp747.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(
e->topt))),((_tmp748.tag=0,((_tmp748.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp749[0]=& _tmp748,((_tmp749[1]=&
_tmp747,Cyc_Tcutil_terr(e->loc,((_tmp74A="descriptor has type \n%s\n but argument has type \n%s",
...
e)){const char*_tmp758;void*_tmp757[1];struct Cyc_String_pa_struct _tmp756;(_tmp756.tag=
0,((_tmp756.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
...
Cyc_String_pa_struct _tmp75A;(_tmp75A.tag=0,((_tmp75A.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp75B[0]=& _tmp75A,Cyc_Tcutil_terr(
loc,((_tmp75C="expecting integral or * type but found %s",_tag_dyneither(_tmp75C,
sizeof(char),42))),_tag_dyneither(_tmp75B,sizeof(void*),1)))))));}return Cyc_Absyn_sint_typ;
case Cyc_Absyn_Bitnot: _LL8F: if(!Cyc_Tcutil_is_integral(e)){const char*_tmp760;void*
_tmp75F[1];struct Cyc_String_pa_struct _tmp75E;(_tmp75E.tag=0,((_tmp75E.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp75F[0]=&
_tmp75E,Cyc_Tcutil_terr(loc,((_tmp760="expecting integral type but found %s",
...
_tmp10A;_LL93: {struct Cyc_Absyn_ArrayType_struct*_tmp106=(struct Cyc_Absyn_ArrayType_struct*)
_tmp105;if(_tmp106->tag != 8)goto _LL95;}_LL94: goto _LL92;_LL95: {struct Cyc_Absyn_PointerType_struct*
_tmp107=(struct Cyc_Absyn_PointerType_struct*)_tmp105;if(_tmp107->tag != 5)goto
_LL97;else{_tmp108=_tmp107->f1;_tmp109=_tmp108.ptr_atts;_tmp10A=_tmp109.bounds;}}
...
struct Cyc_Absyn_DynEither_b_struct*_tmp10C=(struct Cyc_Absyn_DynEither_b_struct*)
_tmp10B;if(_tmp10C->tag != 0)goto _LL9C;}_LL9B: goto _LL99;_LL9C: {struct Cyc_Absyn_Upper_b_struct*
_tmp10D=(struct Cyc_Absyn_Upper_b_struct*)_tmp10B;if(_tmp10D->tag != 1)goto _LL99;
else{_tmp10E=_tmp10D->f1;}}_LL9D: if(!Cyc_Evexp_c_can_eval(_tmp10E)){const char*
_tmp763;void*_tmp762;(_tmp762=0,Cyc_Tcutil_terr(loc,((_tmp763="cannot apply numelts to a pointer with abstract bounds",
...
struct Cyc_String_pa_struct _tmp765;(_tmp765.tag=0,((_tmp765.f1=(struct
...
1];struct Cyc_String_pa_struct _tmp76C;(_tmp76C.tag=0,((_tmp76C.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(
e1->topt))),((_tmp76D[0]=& _tmp76C,Cyc_Tcutil_terr(e1->loc,((_tmp76E="type %s cannot be used here",
...
const char*_tmp772;void*_tmp771[1];struct Cyc_String_pa_struct _tmp770;(_tmp770.tag=
...
_tmp124;union Cyc_Absyn_Constraint*_tmp125;_LLA0: {struct Cyc_Absyn_PointerType_struct*
_tmp11D=(struct Cyc_Absyn_PointerType_struct*)_tmp11C;if(_tmp11D->tag != 5)goto
_LLA2;else{_tmp11E=_tmp11D->f1;_tmp11F=_tmp11E.elt_typ;_tmp120=_tmp11E.elt_tq;
...
Cyc_String_pa_struct _tmp77A;(_tmp77A.tag=0,((_tmp77A.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string(t2)),((_tmp77B[0]=& _tmp77A,Cyc_Tcutil_terr(
e2->loc,((_tmp77C="expecting int but found %s",_tag_dyneither(_tmp77C,sizeof(
char),27))),_tag_dyneither(_tmp77B,sizeof(void*),1)))))));}{void*_tmp12D=((void*(*)(
void*y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_constr)((void*)& Cyc_Absyn_DynEither_b_val,
_tmp124);struct Cyc_Absyn_Exp*_tmp130;_LLA5: {struct Cyc_Absyn_DynEither_b_struct*
_tmp12E=(struct Cyc_Absyn_DynEither_b_struct*)_tmp12D;if(_tmp12E->tag != 0)goto
_LLA7;}_LLA6: return t1;_LLA7: {struct Cyc_Absyn_Upper_b_struct*_tmp12F=(struct Cyc_Absyn_Upper_b_struct*)
_tmp12D;if(_tmp12F->tag != 1)goto _LLA4;else{_tmp130=_tmp12F->f1;}}_LLA8: if(((int(*)(
int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp125)){const char*
_tmp77F;void*_tmp77E;(_tmp77E=0,Cyc_Tcutil_warn(e1->loc,((_tmp77F="pointer arithmetic on thin, zero-terminated pointer may be expensive.",
_tag_dyneither(_tmp77F,sizeof(char),70))),_tag_dyneither(_tmp77E,sizeof(void*),0)));}{
struct Cyc_Absyn_PointerType_struct _tmp789;struct Cyc_Absyn_PtrAtts _tmp788;struct
Cyc_Absyn_PtrInfo _tmp787;struct Cyc_Absyn_PointerType_struct*_tmp786;struct Cyc_Absyn_PointerType_struct*
_tmp133=(_tmp786=_cycalloc(sizeof(*_tmp786)),((_tmp786[0]=((_tmp789.tag=5,((
_tmp789.f1=((_tmp787.elt_typ=_tmp11F,((_tmp787.elt_tq=_tmp120,((_tmp787.ptr_atts=((
_tmp788.rgn=_tmp122,((_tmp788.nullable=Cyc_Absyn_true_conref,((_tmp788.bounds=
Cyc_Absyn_bounds_dyneither_conref,((_tmp788.zero_term=_tmp125,((_tmp788.ptrloc=0,
_tmp788)))))))))),_tmp787)))))),_tmp789)))),_tmp786)));Cyc_Tcutil_unchecked_cast(
te,e1,(void*)_tmp133,Cyc_Absyn_Other_coercion);return(void*)_tmp133;};_LLA4:;};
_LLA2:;_LLA3: return Cyc_Tcexp_tcArithBinop(te,e1,e2,Cyc_Tcutil_is_numeric);_LL9F:;}
static void*Cyc_Tcexp_tcMinus(struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Exp*e1,
struct Cyc_Absyn_Exp*e2){void*t1=(void*)_check_null(e1->topt);void*t2=(void*)
_check_null(e2->topt);void*t1_elt=(void*)& Cyc_Absyn_VoidType_val;if(Cyc_Tcutil_is_tagged_pointer_typ_elt(
t1,& t1_elt)){if(Cyc_Tcutil_is_tagged_pointer_typ(t2)){if(!Cyc_Tcutil_unify(t1,t2)){{
const char*_tmp78E;void*_tmp78D[2];struct Cyc_String_pa_struct _tmp78C;struct Cyc_String_pa_struct
_tmp78B;(_tmp78B.tag=0,((_tmp78B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(t2)),((_tmp78C.tag=0,((_tmp78C.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string(t1)),((_tmp78D[0]=& _tmp78C,((_tmp78D[
1]=& _tmp78B,Cyc_Tcutil_terr(e1->loc,((_tmp78E="pointer arithmetic on values of different types (%s != %s)",
...
Cyc_String_pa_struct _tmp797;struct Cyc_String_pa_struct _tmp796;(_tmp796.tag=0,((
_tmp796.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
...
_tmp146=_tmp145.f1;{struct Cyc_Absyn_PointerType_struct*_tmp147=(struct Cyc_Absyn_PointerType_struct*)
_tmp146;if(_tmp147->tag != 5)goto _LLAC;else{_tmp148=_tmp147->f1;_tmp149=_tmp148.elt_typ;}};
_tmp14A=_tmp145.f2;{struct Cyc_Absyn_PointerType_struct*_tmp14B=(struct Cyc_Absyn_PointerType_struct*)
...
_LLAC: _tmp14E=_tmp145.f1;{struct Cyc_Absyn_RgnHandleType_struct*_tmp14F=(struct
Cyc_Absyn_RgnHandleType_struct*)_tmp14E;if(_tmp14F->tag != 15)goto _LLAE;};_tmp150=
_tmp145.f2;{struct Cyc_Absyn_RgnHandleType_struct*_tmp151=(struct Cyc_Absyn_RgnHandleType_struct*)
_tmp150;if(_tmp151->tag != 15)goto _LLAE;};_LLAD: return Cyc_Absyn_sint_typ;_LLAE:;
_LLAF: goto _LLA9;_LLA9:;}{const char*_tmp79F;void*_tmp79E[2];struct Cyc_String_pa_struct
...
struct Cyc_Absyn_RgnHandleType_struct*_tmp159=(struct Cyc_Absyn_RgnHandleType_struct*)
_tmp158;if(_tmp159->tag != 15)goto _LLB3;else{_tmp15A=(void*)_tmp159->f1;}};
_tmp15B=_tmp157.f2;{struct Cyc_Absyn_RgnHandleType_struct*_tmp15C=(struct Cyc_Absyn_RgnHandleType_struct*)
_tmp15B;if(_tmp15C->tag != 15)goto _LLB3;else{_tmp15D=(void*)_tmp15C->f1;}};_LLB2:
return Cyc_Absyn_sint_typ;_LLB3:;_LLB4: goto _LLB0;_LLB0:;}{const char*_tmp7A5;void*
_tmp7A4[2];struct Cyc_String_pa_struct _tmp7A3;struct Cyc_String_pa_struct _tmp7A2;(
_tmp7A2.tag=0,((_tmp7A2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t2)),((_tmp7A3.tag=0,((_tmp7A3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(t1)),((_tmp7A4[0]=& _tmp7A3,((_tmp7A4[1]=& _tmp7A2,Cyc_Tcutil_terr(
loc,((_tmp7A5="comparison not allowed between %s and %s",_tag_dyneither(_tmp7A5,
sizeof(char),41))),_tag_dyneither(_tmp7A4,sizeof(void*),2)))))))))))));}Cyc_Tcutil_explain_failure();
return Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te));};}static void*Cyc_Tcexp_tcBinPrimop(
struct Cyc_Tcenv_Tenv*te,unsigned int loc,void**topt,enum Cyc_Absyn_Primop p,struct
Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2){switch(p){case Cyc_Absyn_Plus: _LLB5:
return Cyc_Tcexp_tcPlus(te,e1,e2);case Cyc_Absyn_Minus: _LLB6: return Cyc_Tcexp_tcMinus(
te,e1,e2);case Cyc_Absyn_Times: _LLB7: goto _LLB8;case Cyc_Absyn_Div: _LLB8: return Cyc_Tcexp_tcArithBinop(
te,e1,e2,Cyc_Tcutil_is_numeric);case Cyc_Absyn_Mod: _LLB9: goto _LLBA;case Cyc_Absyn_Bitand:
_LLBA: goto _LLBB;case Cyc_Absyn_Bitor: _LLBB: goto _LLBC;case Cyc_Absyn_Bitxor: _LLBC:
goto _LLBD;case Cyc_Absyn_Bitlshift: _LLBD: goto _LLBE;case Cyc_Absyn_Bitlrshift: _LLBE:
goto _LLBF;case Cyc_Absyn_Bitarshift: _LLBF: return Cyc_Tcexp_tcArithBinop(te,e1,e2,
Cyc_Tcutil_is_integral);case Cyc_Absyn_Eq: _LLC0: goto _LLC1;case Cyc_Absyn_Neq: _LLC1:
return Cyc_Tcexp_tcEqPrimop(te,loc,e1,e2);case Cyc_Absyn_Gt: _LLC2: goto _LLC3;case
Cyc_Absyn_Lt: _LLC3: goto _LLC4;case Cyc_Absyn_Gte: _LLC4: goto _LLC5;case Cyc_Absyn_Lte:
_LLC5: return Cyc_Tcexp_tcAnyBinop(te,loc,e1,e2);default: _LLC6: {const char*_tmp7A8;
void*_tmp7A7;(_tmp7A7=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))
Cyc_Tcutil_impos)(((_tmp7A8="bad binary primop",_tag_dyneither(_tmp7A8,sizeof(
char),18))),_tag_dyneither(_tmp7A7,sizeof(void*),0)));}}}static void*Cyc_Tcexp_tcPrimop(
struct Cyc_Tcenv_Tenv*te,unsigned int loc,void**topt,enum Cyc_Absyn_Primop p,struct
Cyc_List_List*es){if(p == Cyc_Absyn_Minus  && ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
...
Cyc_List_List*x))Cyc_List_length)(es)){case 0: _LLC8: {const char*_tmp7AB;void*
_tmp7AA;return(_tmp7AA=0,Cyc_Tcexp_expr_err(te,loc,topt,((_tmp7AB="primitive operator has 0 arguments",
_tag_dyneither(_tmp7AB,sizeof(char),35))),_tag_dyneither(_tmp7AA,sizeof(void*),0)));}
...
_check_null(es))->tl))->hd);break;default: _LLCB: {const char*_tmp7AE;void*_tmp7AD;
return(_tmp7AD=0,Cyc_Tcexp_expr_err(te,loc,topt,((_tmp7AE="primitive operator has > 2 arguments",
_tag_dyneither(_tmp7AE,sizeof(char),37))),_tag_dyneither(_tmp7AD,sizeof(void*),0)));}}
return t;};}struct _tuple19{struct Cyc_Absyn_Tqual f1;void*f2;};static int Cyc_Tcexp_check_writable_aggr(
...
_tmp179;struct Cyc_List_List*_tmp17B;_LLCE: {struct Cyc_Absyn_AggrType_struct*
_tmp16A=(struct Cyc_Absyn_AggrType_struct*)_tmp169;if(_tmp16A->tag != 11)goto _LLD0;
else{_tmp16B=_tmp16A->f1;_tmp16C=_tmp16B.aggr_info;if((_tmp16C.KnownAggr).tag != 
2)goto _LLD0;_tmp16D=(struct Cyc_Absyn_Aggrdecl**)(_tmp16C.KnownAggr).val;_tmp16E=*
_tmp16D;}}_LLCF: _tmp170=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp16E->impl))->fields;
goto _LLD1;_LLD0: {struct Cyc_Absyn_AnonAggrType_struct*_tmp16F=(struct Cyc_Absyn_AnonAggrType_struct*)
_tmp169;if(_tmp16F->tag != 12)goto _LLD2;else{_tmp170=_tmp16F->f2;}}_LLD1: for(0;
_tmp170 != 0;_tmp170=_tmp170->tl){struct Cyc_Absyn_Aggrfield*_tmp17C=(struct Cyc_Absyn_Aggrfield*)
_tmp170->hd;if((_tmp17C->tq).real_const){{const char*_tmp7B2;void*_tmp7B1[1];
struct Cyc_String_pa_struct _tmp7B0;(_tmp7B0.tag=0,((_tmp7B0.f1=(struct
...
_LLD2: {struct Cyc_Absyn_DatatypeFieldType_struct*_tmp171=(struct Cyc_Absyn_DatatypeFieldType_struct*)
...
_tmp183.real_const){{const char*_tmp7B6;void*_tmp7B5[1];struct Cyc_String_pa_struct
...
return 0;}return Cyc_Tcexp_check_writable_aggr(loc,_tmp178);_LLD6: {struct Cyc_Absyn_TupleType_struct*
_tmp17A=(struct Cyc_Absyn_TupleType_struct*)_tmp169;if(_tmp17A->tag != 10)goto
_LLD8;else{_tmp17B=_tmp17A->f1;}}_LLD7: for(0;_tmp17B != 0;_tmp17B=_tmp17B->tl){
...
Cyc_Absyn_Var_e_struct*_tmp191=(struct Cyc_Absyn_Var_e_struct*)_tmp190;if(_tmp191->tag
!= 1)goto _LLDD;else{_tmp192=(void*)_tmp191->f2;{struct Cyc_Absyn_Param_b_struct*
_tmp193=(struct Cyc_Absyn_Param_b_struct*)_tmp192;if(_tmp193->tag != 3)goto _LLDD;
else{_tmp194=_tmp193->f1;}};}}_LLDC: _tmp198=_tmp194;goto _LLDE;_LLDD: {struct Cyc_Absyn_Var_e_struct*
_tmp195=(struct Cyc_Absyn_Var_e_struct*)_tmp190;if(_tmp195->tag != 1)goto _LLDF;
else{_tmp196=(void*)_tmp195->f2;{struct Cyc_Absyn_Local_b_struct*_tmp197=(struct
Cyc_Absyn_Local_b_struct*)_tmp196;if(_tmp197->tag != 4)goto _LLDF;else{_tmp198=
_tmp197->f1;}};}}_LLDE: _tmp19C=_tmp198;goto _LLE0;_LLDF: {struct Cyc_Absyn_Var_e_struct*
_tmp199=(struct Cyc_Absyn_Var_e_struct*)_tmp190;if(_tmp199->tag != 1)goto _LLE1;
else{_tmp19A=(void*)_tmp199->f2;{struct Cyc_Absyn_Pat_b_struct*_tmp19B=(struct Cyc_Absyn_Pat_b_struct*)
_tmp19A;if(_tmp19B->tag != 5)goto _LLE1;else{_tmp19C=_tmp19B->f1;}};}}_LLE0:
_tmp1A0=_tmp19C;goto _LLE2;_LLE1: {struct Cyc_Absyn_Var_e_struct*_tmp19D=(struct
Cyc_Absyn_Var_e_struct*)_tmp190;if(_tmp19D->tag != 1)goto _LLE3;else{_tmp19E=(void*)
_tmp19D->f2;{struct Cyc_Absyn_Global_b_struct*_tmp19F=(struct Cyc_Absyn_Global_b_struct*)
_tmp19E;if(_tmp19F->tag != 1)goto _LLE3;else{_tmp1A0=_tmp19F->f1;}};}}_LLE2: if(!(
_tmp1A0->tq).real_const)return;goto _LLDA;_LLE3: {struct Cyc_Absyn_Subscript_e_struct*
_tmp1A1=(struct Cyc_Absyn_Subscript_e_struct*)_tmp190;if(_tmp1A1->tag != 22)goto
_LLE5;else{_tmp1A2=_tmp1A1->f1;_tmp1A3=_tmp1A1->f2;}}_LLE4:{void*_tmp1B0=Cyc_Tcutil_compress((
void*)_check_null(_tmp1A2->topt));struct Cyc_Absyn_PtrInfo _tmp1B2;struct Cyc_Absyn_Tqual
_tmp1B3;struct Cyc_Absyn_ArrayInfo _tmp1B5;struct Cyc_Absyn_Tqual _tmp1B6;struct Cyc_List_List*
_tmp1B8;_LLF2: {struct Cyc_Absyn_PointerType_struct*_tmp1B1=(struct Cyc_Absyn_PointerType_struct*)
_tmp1B0;if(_tmp1B1->tag != 5)goto _LLF4;else{_tmp1B2=_tmp1B1->f1;_tmp1B3=_tmp1B2.elt_tq;}}
_LLF3: _tmp1B6=_tmp1B3;goto _LLF5;_LLF4: {struct Cyc_Absyn_ArrayType_struct*_tmp1B4=(
struct Cyc_Absyn_ArrayType_struct*)_tmp1B0;if(_tmp1B4->tag != 8)goto _LLF6;else{
_tmp1B5=_tmp1B4->f1;_tmp1B6=_tmp1B5.tq;}}_LLF5: if(!_tmp1B6.real_const)return;
goto _LLF1;_LLF6: {struct Cyc_Absyn_TupleType_struct*_tmp1B7=(struct Cyc_Absyn_TupleType_struct*)
_tmp1B0;if(_tmp1B7->tag != 10)goto _LLF8;else{_tmp1B8=_tmp1B7->f1;}}_LLF7: {
unsigned int _tmp1BA;int _tmp1BB;struct _tuple15 _tmp1B9=Cyc_Evexp_eval_const_uint_exp(
_tmp1A3);_tmp1BA=_tmp1B9.f1;_tmp1BB=_tmp1B9.f2;if(!_tmp1BB){{const char*_tmp7BF;
void*_tmp7BE;(_tmp7BE=0,Cyc_Tcutil_terr(e->loc,((_tmp7BF="tuple projection cannot use sizeof or offsetof",
_tag_dyneither(_tmp7BF,sizeof(char),47))),_tag_dyneither(_tmp7BE,sizeof(void*),0)));}
return;}{struct _handler_cons _tmp1BE;_push_handler(& _tmp1BE);{int _tmp1C0=0;if(
setjmp(_tmp1BE.handler))_tmp1C0=1;if(!_tmp1C0){{struct _tuple19 _tmp1C2;struct Cyc_Absyn_Tqual
...
void*)_exn_thrown;void*_tmp1C5=_tmp1BF;_LLFB: {struct Cyc_List_Nth_struct*_tmp1C6=(
struct Cyc_List_Nth_struct*)_tmp1C5;if(_tmp1C6->tag != Cyc_List_Nth)goto _LLFD;}
_LLFC: return;_LLFD:;_LLFE:(void)_throw(_tmp1C5);_LLFA:;}};}goto _LLF1;}_LLF8:;
_LLF9: goto _LLF1;_LLF1:;}goto _LLDA;_LLE5: {struct Cyc_Absyn_AggrMember_e_struct*
_tmp1A4=(struct Cyc_Absyn_AggrMember_e_struct*)_tmp190;if(_tmp1A4->tag != 20)goto
_LLE7;else{_tmp1A5=_tmp1A4->f1;_tmp1A6=_tmp1A4->f2;}}_LLE6:{void*_tmp1C7=Cyc_Tcutil_compress((
void*)_check_null(_tmp1A5->topt));struct Cyc_Absyn_AggrInfo _tmp1C9;union Cyc_Absyn_AggrInfoU
_tmp1CA;struct Cyc_Absyn_Aggrdecl**_tmp1CB;struct Cyc_List_List*_tmp1CD;_LL100: {
struct Cyc_Absyn_AggrType_struct*_tmp1C8=(struct Cyc_Absyn_AggrType_struct*)
_tmp1C7;if(_tmp1C8->tag != 11)goto _LL102;else{_tmp1C9=_tmp1C8->f1;_tmp1CA=_tmp1C9.aggr_info;
if((_tmp1CA.KnownAggr).tag != 2)goto _LL102;_tmp1CB=(struct Cyc_Absyn_Aggrdecl**)(
_tmp1CA.KnownAggr).val;}}_LL101: {struct Cyc_Absyn_Aggrfield*sf=(struct Cyc_Absyn_Aggrdecl**)
_tmp1CB == 0?0: Cyc_Absyn_lookup_decl_field(*_tmp1CB,_tmp1A6);if(sf == 0  || !(sf->tq).real_const)
return;goto _LLFF;}_LL102: {struct Cyc_Absyn_AnonAggrType_struct*_tmp1CC=(struct
Cyc_Absyn_AnonAggrType_struct*)_tmp1C7;if(_tmp1CC->tag != 12)goto _LL104;else{
_tmp1CD=_tmp1CC->f2;}}_LL103: {struct Cyc_Absyn_Aggrfield*sf=Cyc_Absyn_lookup_field(
_tmp1CD,_tmp1A6);if(sf == 0  || !(sf->tq).real_const)return;goto _LLFF;}_LL104:;
_LL105: goto _LLFF;_LLFF:;}goto _LLDA;_LLE7: {struct Cyc_Absyn_AggrArrow_e_struct*
_tmp1A7=(struct Cyc_Absyn_AggrArrow_e_struct*)_tmp190;if(_tmp1A7->tag != 21)goto
_LLE9;else{_tmp1A8=_tmp1A7->f1;_tmp1A9=_tmp1A7->f2;}}_LLE8:{void*_tmp1CE=Cyc_Tcutil_compress((
void*)_check_null(_tmp1A8->topt));struct Cyc_Absyn_PtrInfo _tmp1D0;void*_tmp1D1;
_LL107: {struct Cyc_Absyn_PointerType_struct*_tmp1CF=(struct Cyc_Absyn_PointerType_struct*)
_tmp1CE;if(_tmp1CF->tag != 5)goto _LL109;else{_tmp1D0=_tmp1CF->f1;_tmp1D1=_tmp1D0.elt_typ;}}
_LL108:{void*_tmp1D2=Cyc_Tcutil_compress(_tmp1D1);struct Cyc_Absyn_AggrInfo
_tmp1D4;union Cyc_Absyn_AggrInfoU _tmp1D5;struct Cyc_Absyn_Aggrdecl**_tmp1D6;struct
Cyc_List_List*_tmp1D8;_LL10C: {struct Cyc_Absyn_AggrType_struct*_tmp1D3=(struct
Cyc_Absyn_AggrType_struct*)_tmp1D2;if(_tmp1D3->tag != 11)goto _LL10E;else{_tmp1D4=
_tmp1D3->f1;_tmp1D5=_tmp1D4.aggr_info;if((_tmp1D5.KnownAggr).tag != 2)goto _LL10E;
_tmp1D6=(struct Cyc_Absyn_Aggrdecl**)(_tmp1D5.KnownAggr).val;}}_LL10D: {struct Cyc_Absyn_Aggrfield*
sf=(struct Cyc_Absyn_Aggrdecl**)_tmp1D6 == 0?0: Cyc_Absyn_lookup_decl_field(*
_tmp1D6,_tmp1A9);if(sf == 0  || !(sf->tq).real_const)return;goto _LL10B;}_LL10E: {
struct Cyc_Absyn_AnonAggrType_struct*_tmp1D7=(struct Cyc_Absyn_AnonAggrType_struct*)
_tmp1D2;if(_tmp1D7->tag != 12)goto _LL110;else{_tmp1D8=_tmp1D7->f2;}}_LL10F: {
struct Cyc_Absyn_Aggrfield*sf=Cyc_Absyn_lookup_field(_tmp1D8,_tmp1A9);if(sf == 0
 || !(sf->tq).real_const)return;goto _LL10B;}_LL110:;_LL111: goto _LL10B;_LL10B:;}
goto _LL106;_LL109:;_LL10A: goto _LL106;_LL106:;}goto _LLDA;_LLE9: {struct Cyc_Absyn_Deref_e_struct*
_tmp1AA=(struct Cyc_Absyn_Deref_e_struct*)_tmp190;if(_tmp1AA->tag != 19)goto _LLEB;
else{_tmp1AB=_tmp1AA->f1;}}_LLEA:{void*_tmp1D9=Cyc_Tcutil_compress((void*)
_check_null(_tmp1AB->topt));struct Cyc_Absyn_PtrInfo _tmp1DB;struct Cyc_Absyn_Tqual
_tmp1DC;struct Cyc_Absyn_ArrayInfo _tmp1DE;struct Cyc_Absyn_Tqual _tmp1DF;_LL113: {
struct Cyc_Absyn_PointerType_struct*_tmp1DA=(struct Cyc_Absyn_PointerType_struct*)
_tmp1D9;if(_tmp1DA->tag != 5)goto _LL115;else{_tmp1DB=_tmp1DA->f1;_tmp1DC=_tmp1DB.elt_tq;}}
_LL114: _tmp1DF=_tmp1DC;goto _LL116;_LL115: {struct Cyc_Absyn_ArrayType_struct*
_tmp1DD=(struct Cyc_Absyn_ArrayType_struct*)_tmp1D9;if(_tmp1DD->tag != 8)goto
_LL117;else{_tmp1DE=_tmp1DD->f1;_tmp1DF=_tmp1DE.tq;}}_LL116: if(!_tmp1DF.real_const)
return;goto _LL112;_LL117:;_LL118: goto _LL112;_LL112:;}goto _LLDA;_LLEB: {struct Cyc_Absyn_NoInstantiate_e_struct*
_tmp1AC=(struct Cyc_Absyn_NoInstantiate_e_struct*)_tmp190;if(_tmp1AC->tag != 11)
goto _LLED;else{_tmp1AD=_tmp1AC->f1;}}_LLEC: _tmp1AF=_tmp1AD;goto _LLEE;_LLED: {
struct Cyc_Absyn_Instantiate_e_struct*_tmp1AE=(struct Cyc_Absyn_Instantiate_e_struct*)
_tmp190;if(_tmp1AE->tag != 12)goto _LLEF;else{_tmp1AF=_tmp1AE->f1;}}_LLEE: Cyc_Tcexp_check_writable(
te,_tmp1AF);return;_LLEF:;_LLF0: goto _LLDA;_LLDA:;}{const char*_tmp7C3;void*
_tmp7C2[1];struct Cyc_String_pa_struct _tmp7C1;(_tmp7C1.tag=0,((_tmp7C1.f1=(struct
...
else{const char*_tmp7D0;void*_tmp7CF[1];struct Cyc_String_pa_struct _tmp7CE;(
_tmp7CE.tag=0,((_tmp7CE.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t)),((_tmp7CF[0]=& _tmp7CE,Cyc_Tcutil_terr(e->loc,((_tmp7D0="expecting arithmetic or ? type but found %s",
_tag_dyneither(_tmp7D0,sizeof(char),44))),_tag_dyneither(_tmp7CF,sizeof(void*),1)))))));}}{
void*_tmp1EE=t;_npop_handler(0);return _tmp1EE;};};;_pop_region(temp);}static void*
...
_tuple0*_tmp1F1;int _tmp1F2;const char*_tmp7D1;struct Cyc_Tcexp_TestEnv _tmp1F0=Cyc_Tcexp_tcTest(
te,e1,((_tmp7D1="conditional expression",_tag_dyneither(_tmp7D1,sizeof(char),23))));
_tmp1F1=_tmp1F0.eq;_tmp1F2=_tmp1F0.isTrue;Cyc_Tcexp_tcExp(te,topt,e2);Cyc_Tcexp_tcExp(
te,topt,e3);{void*t=Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_tmko,Cyc_Tcenv_lookup_opt_type_vars(
te));struct Cyc_List_List _tmp7D2;struct Cyc_List_List _tmp1F3=(_tmp7D2.hd=e3,((
_tmp7D2.tl=0,_tmp7D2)));struct Cyc_List_List _tmp7D3;struct Cyc_List_List _tmp1F4=(
_tmp7D3.hd=e2,((_tmp7D3.tl=(struct Cyc_List_List*)& _tmp1F3,_tmp7D3)));if(!Cyc_Tcutil_coerce_list(
te,t,(struct Cyc_List_List*)& _tmp1F4)){{const char*_tmp7D8;void*_tmp7D7[2];struct
Cyc_String_pa_struct _tmp7D6;struct Cyc_String_pa_struct _tmp7D5;(_tmp7D5.tag=0,((
_tmp7D5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((
...
_tmp200=Cyc_Tcutil_compress(t1);_LL11A: {struct Cyc_Absyn_ArrayType_struct*
_tmp201=(struct Cyc_Absyn_ArrayType_struct*)_tmp200;if(_tmp201->tag != 8)goto
_LL11C;}_LL11B:{const char*_tmp7DF;void*_tmp7DE;(_tmp7DE=0,Cyc_Tcutil_terr(loc,((
_tmp7DF="cannot assign to an array",_tag_dyneither(_tmp7DF,sizeof(char),26))),
...
te,e2,t1)){const char*_tmp7ED;void*_tmp7EC[2];struct Cyc_String_pa_struct _tmp7EB;
struct Cyc_String_pa_struct _tmp7EA;void*_tmp20C=(_tmp7EA.tag=0,((_tmp7EA.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t2)),((
_tmp7EB.tag=0,((_tmp7EB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t1)),((_tmp7EC[0]=& _tmp7EB,((_tmp7EC[1]=& _tmp7EA,Cyc_Tcexp_expr_err(te,loc,topt,((
_tmp7ED="type mismatch: %s != %s",_tag_dyneither(_tmp7ED,sizeof(char),24))),
_tag_dyneither(_tmp7EC,sizeof(void*),2)))))))))))));Cyc_Tcutil_unify(t1,t2);Cyc_Tcutil_explain_failure();{
void*_tmp20D=_tmp20C;_npop_handler(1);return _tmp20D;};};_pop_region(temp);}else{
enum Cyc_Absyn_Primop _tmp212=(enum Cyc_Absyn_Primop)po->v;void*_tmp213=Cyc_Tcexp_tcBinPrimop(
te,loc,0,_tmp212,e1,e2);if(!(Cyc_Tcutil_unify(_tmp213,t1) || Cyc_Tcutil_coerceable(
_tmp213) && Cyc_Tcutil_coerceable(t1))){const char*_tmp7F2;void*_tmp7F1[2];struct
Cyc_String_pa_struct _tmp7F0;struct Cyc_String_pa_struct _tmp7EF;void*_tmp214=(
_tmp7EF.tag=0,((_tmp7EF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t2)),((_tmp7F0.tag=0,((_tmp7F0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(t1)),((_tmp7F1[0]=& _tmp7F0,((_tmp7F1[1]=& _tmp7EF,Cyc_Tcexp_expr_err(
te,loc,topt,((_tmp7F2="Cannot use this operator in an assignment when the arguments have types %s and %s",
...
struct Cyc_Absyn_FloatType_struct*_tmp21D=(struct Cyc_Absyn_FloatType_struct*)
...
t1=Cyc_Absyn_float_typ(1);goto _LL11E;_LL121: {struct Cyc_Absyn_IntType_struct*
_tmp21F=(struct Cyc_Absyn_IntType_struct*)_tmp21C;if(_tmp21F->tag != 6)goto _LL123;
else{_tmp220=_tmp21F->f2;if(_tmp220 != Cyc_Absyn_Char_sz)goto _LL123;}}_LL122: goto
_LL124;_LL123: {struct Cyc_Absyn_IntType_struct*_tmp221=(struct Cyc_Absyn_IntType_struct*)
_tmp21C;if(_tmp221->tag != 6)goto _LL125;else{_tmp222=_tmp221->f2;if(_tmp222 != Cyc_Absyn_Short_sz)
goto _LL125;}}_LL124: Cyc_Tcutil_unchecked_cast(te,e,Cyc_Absyn_sint_typ,Cyc_Absyn_No_coercion);
...
struct Cyc_String_pa_struct _tmp7F5;struct Cyc_String_pa_struct _tmp7F4;(_tmp7F4.tag=
0,((_tmp7F4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t1)),((_tmp7F5.tag=0,((_tmp7F5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(tu)),((_tmp7F6[0]=& _tmp7F5,((_tmp7F6[1]=& _tmp7F4,Cyc_Tcutil_terr(
e->loc,((_tmp7F7="can't find a field in %s to inject a value of type %s",
...
_tmp23E;_LL128: {struct Cyc_Absyn_PointerType_struct*_tmp236=(struct Cyc_Absyn_PointerType_struct*)
_tmp235;if(_tmp236->tag != 5)goto _LL12A;else{_tmp237=_tmp236->f1;_tmp238=_tmp237.elt_typ;
_tmp239=_tmp237.elt_tq;_tmp23A=_tmp237.ptr_atts;_tmp23B=_tmp23A.rgn;_tmp23C=
_tmp23A.nullable;_tmp23D=_tmp23A.bounds;_tmp23E=_tmp23A.zero_term;}}_LL129: Cyc_Tcenv_check_rgn_accessible(
_tmp234,loc,_tmp23B);Cyc_Tcutil_check_nonzero_bound(loc,_tmp23D);{void*_tmp23F=
Cyc_Tcutil_compress(_tmp238);struct Cyc_Absyn_FnInfo _tmp241;struct Cyc_List_List*
_tmp242;void*_tmp243;struct Cyc_Absyn_Tqual _tmp244;void*_tmp245;struct Cyc_List_List*
_tmp246;int _tmp247;struct Cyc_Absyn_VarargInfo*_tmp248;struct Cyc_List_List*
_tmp249;struct Cyc_List_List*_tmp24A;_LL12D: {struct Cyc_Absyn_FnType_struct*
_tmp240=(struct Cyc_Absyn_FnType_struct*)_tmp23F;if(_tmp240->tag != 9)goto _LL12F;
else{_tmp241=_tmp240->f1;_tmp242=_tmp241.tvars;_tmp243=_tmp241.effect;_tmp244=
_tmp241.ret_tqual;_tmp245=_tmp241.ret_typ;_tmp246=_tmp241.args;_tmp247=_tmp241.c_varargs;
_tmp248=_tmp241.cyc_varargs;_tmp249=_tmp241.rgn_po;_tmp24A=_tmp241.attributes;}}
_LL12E: if(topt != 0)Cyc_Tcutil_unify(_tmp245,*topt);while(_tmp231 != 0  && _tmp246
!= 0){int alias_coercion=0;struct Cyc_Absyn_Exp*e1=(struct Cyc_Absyn_Exp*)_tmp231->hd;
void*t2=(*((struct _tuple9*)_tmp246->hd)).f3;Cyc_Tcexp_tcExp(_tmp234,(void**)& t2,
e1);if(!Cyc_Tcutil_coerce_arg(_tmp234,e1,t2,& alias_coercion)){{const char*_tmp7FC;
void*_tmp7FB[2];struct Cyc_String_pa_struct _tmp7FA;struct Cyc_String_pa_struct
_tmp7F9;(_tmp7F9.tag=0,((_tmp7F9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(t2)),((_tmp7FA.tag=0,((_tmp7FA.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(e1->topt))),((
_tmp7FB[0]=& _tmp7FA,((_tmp7FB[1]=& _tmp7F9,Cyc_Tcutil_terr(e1->loc,((_tmp7FC="actual argument has type \n\t%s\n but formal has type \n\t%s.",
...
enum Cyc_Absyn_Format_Type _tmp254;int _tmp255;int _tmp256;_LL132: {struct Cyc_Absyn_Format_att_struct*
_tmp253=(struct Cyc_Absyn_Format_att_struct*)_tmp252;if(_tmp253->tag != 19)goto
_LL134;else{_tmp254=_tmp253->f1;_tmp255=_tmp253->f2;_tmp256=_tmp253->f3;}}_LL133:{
struct _handler_cons _tmp257;_push_handler(& _tmp257);{int _tmp259=0;if(setjmp(
_tmp257.handler))_tmp259=1;if(!_tmp259){{struct Cyc_Absyn_Exp*_tmp25A=((struct Cyc_Absyn_Exp*(*)(
struct Cyc_List_List*x,int n))Cyc_List_nth)(args,_tmp255 - 1);struct Cyc_Core_Opt*
fmt_args;if(_tmp256 == 0)fmt_args=0;else{struct Cyc_Core_Opt*_tmp801;fmt_args=((
_tmp801=_cycalloc(sizeof(*_tmp801)),((_tmp801->v=((struct Cyc_List_List*(*)(
...
struct Cyc_List_Nth_struct*_tmp25F=(struct Cyc_List_Nth_struct*)_tmp25E;if(_tmp25F->tag
!= Cyc_List_Nth)goto _LL13C;}_LL13B:{const char*_tmp804;void*_tmp803;(_tmp803=0,
Cyc_Tcutil_terr(loc,((_tmp804="bad format arguments",_tag_dyneither(_tmp804,
sizeof(char),21))),_tag_dyneither(_tmp803,sizeof(void*),0)));}goto _LL139;_LL13C:;
_LL13D:(void)_throw(_tmp25E);_LL139:;}};}goto _LL131;_LL134:;_LL135: goto _LL131;
_LL131:;}}if(_tmp246 != 0){const char*_tmp807;void*_tmp806;(_tmp806=0,Cyc_Tcutil_terr(
loc,((_tmp807="too few arguments for function",_tag_dyneither(_tmp807,sizeof(
char),31))),_tag_dyneither(_tmp806,sizeof(void*),0)));}else{if((_tmp231 != 0  || 
_tmp247) || _tmp248 != 0){if(_tmp247)for(0;_tmp231 != 0;_tmp231=_tmp231->tl){Cyc_Tcexp_tcExp(
_tmp234,0,(struct Cyc_Absyn_Exp*)_tmp231->hd);}else{if(_tmp248 == 0){const char*
_tmp80A;void*_tmp809;(_tmp809=0,Cyc_Tcutil_terr(loc,((_tmp80A="too many arguments for function",
_tag_dyneither(_tmp80A,sizeof(char),32))),_tag_dyneither(_tmp809,sizeof(void*),0)));}
else{void*_tmp267;int _tmp268;struct Cyc_Absyn_VarargInfo _tmp266=*_tmp248;_tmp267=
_tmp266.type;_tmp268=_tmp266.inject;{struct Cyc_Absyn_VarargCallInfo*_tmp80B;
struct Cyc_Absyn_VarargCallInfo*_tmp269=(_tmp80B=_cycalloc(sizeof(*_tmp80B)),((
_tmp80B->num_varargs=0,((_tmp80B->injectors=0,((_tmp80B->vai=(struct Cyc_Absyn_VarargInfo*)
_tmp248,_tmp80B)))))));*vararg_call_info=(struct Cyc_Absyn_VarargCallInfo*)
_tmp269;if(!_tmp268)for(0;_tmp231 != 0;(_tmp231=_tmp231->tl,_tmp232 ++)){int
alias_coercion=0;struct Cyc_Absyn_Exp*e1=(struct Cyc_Absyn_Exp*)_tmp231->hd;++
_tmp269->num_varargs;Cyc_Tcexp_tcExp(_tmp234,(void**)& _tmp267,e1);if(!Cyc_Tcutil_coerce_arg(
_tmp234,e1,_tmp267,& alias_coercion)){{const char*_tmp810;void*_tmp80F[2];struct
Cyc_String_pa_struct _tmp80E;struct Cyc_String_pa_struct _tmp80D;(_tmp80D.tag=0,((
_tmp80D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((
void*)_check_null(e1->topt))),((_tmp80E.tag=0,((_tmp80E.f1=(struct _dyneither_ptr)((
...
_tmp277;_LL13F: {struct Cyc_Absyn_DatatypeType_struct*_tmp272=(struct Cyc_Absyn_DatatypeType_struct*)
_tmp271;if(_tmp272->tag != 3)goto _LL141;else{_tmp273=_tmp272->f1;_tmp274=_tmp273.datatype_info;
if((_tmp274.KnownDatatype).tag != 2)goto _LL141;_tmp275=(struct Cyc_Absyn_Datatypedecl**)(
_tmp274.KnownDatatype).val;_tmp276=*_tmp275;_tmp277=_tmp273.targs;}}_LL140: {
struct Cyc_Absyn_Datatypedecl*_tmp278=*Cyc_Tcenv_lookup_datatypedecl(_tmp234,loc,
_tmp276->name);struct Cyc_List_List*fields=0;if(_tmp278->fields == 0){const char*
...
_tmp267)),((_tmp817[0]=& _tmp816,Cyc_Tcutil_terr(loc,((_tmp818="can't inject into abstract datatype %s",
_tag_dyneither(_tmp818,sizeof(char),39))),_tag_dyneither(_tmp817,sizeof(void*),1)))))));}
else{fields=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp278->fields))->v;}
if(!Cyc_Tcutil_unify(Cyc_Tcutil_pointer_region(_tmp267),Cyc_Tcenv_curr_rgn(
_tmp234))){const char*_tmp81D;void*_tmp81C[2];struct Cyc_String_pa_struct _tmp81B;
struct Cyc_String_pa_struct _tmp81A;(_tmp81A.tag=0,((_tmp81A.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(Cyc_Tcenv_curr_rgn(
_tmp234))),((_tmp81B.tag=0,((_tmp81B.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_typ2string(_tmp267)),((_tmp81C[0]=& _tmp81B,((_tmp81C[
1]=& _tmp81A,Cyc_Tcutil_terr(loc,((_tmp81D="can't unify pointer region for %s to curr_rgn %s",
...
struct Cyc_String_pa_struct _tmp82D;struct Cyc_String_pa_struct _tmp82C;(_tmp82C.tag=
0,((_tmp82C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((
void*)_check_null(e->topt))),((_tmp82D.tag=0,((_tmp82D.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp290)),((_tmp82E[0]=& _tmp82D,((
_tmp82E[1]=& _tmp82C,Cyc_Tcutil_terr(loc,((_tmp82F="expected %s but found %s",
...
_tmp29D;union Cyc_Absyn_Constraint*_tmp29E;_LL144: {struct Cyc_Absyn_PointerType_struct*
_tmp296=(struct Cyc_Absyn_PointerType_struct*)_tmp295;if(_tmp296->tag != 5)goto
_LL146;else{_tmp297=_tmp296->f1;_tmp298=_tmp297.elt_typ;_tmp299=_tmp297.elt_tq;
...
_tmp2AA;_LL149: {struct Cyc_Absyn_FnType_struct*_tmp2A0=(struct Cyc_Absyn_FnType_struct*)
...
_npop_handler(0);return _tmp2B0;}{struct Cyc_Absyn_FnType_struct _tmp83B;struct Cyc_Absyn_FnInfo
_tmp83A;struct Cyc_Absyn_FnType_struct*_tmp839;void*new_fn_typ=Cyc_Tcutil_rsubstitute(
temp,instantiation,(void*)((_tmp839=_cycalloc(sizeof(*_tmp839)),((_tmp839[0]=((
_tmp83B.tag=9,((_tmp83B.f1=((_tmp83A.tvars=_tmp2A2,((_tmp83A.effect=_tmp2A3,((
_tmp83A.ret_tqual=_tmp2A4,((_tmp83A.ret_typ=_tmp2A5,((_tmp83A.args=_tmp2A6,((
_tmp83A.c_varargs=_tmp2A7,((_tmp83A.cyc_varargs=_tmp2A8,((_tmp83A.rgn_po=_tmp2A9,((
_tmp83A.attributes=_tmp2AA,_tmp83A)))))))))))))))))),_tmp83B)))),_tmp839)))));
struct Cyc_Absyn_PointerType_struct _tmp845;struct Cyc_Absyn_PtrAtts _tmp844;struct
Cyc_Absyn_PtrInfo _tmp843;struct Cyc_Absyn_PointerType_struct*_tmp842;void*_tmp2B5=(
void*)((_tmp842=_cycalloc(sizeof(*_tmp842)),((_tmp842[0]=((_tmp845.tag=5,((
_tmp845.f1=((_tmp843.elt_typ=new_fn_typ,((_tmp843.elt_tq=_tmp299,((_tmp843.ptr_atts=((
_tmp844.rgn=_tmp29B,((_tmp844.nullable=_tmp29C,((_tmp844.bounds=_tmp29D,((
_tmp844.zero_term=_tmp29E,((_tmp844.ptrloc=0,_tmp844)))))))))),_tmp843)))))),
...
const char*_tmp849;void*_tmp848[1];struct Cyc_String_pa_struct _tmp847;return(
_tmp847.tag=0,((_tmp847.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t1)),((_tmp848[0]=& _tmp847,Cyc_Tcexp_expr_err(te,loc,topt,((_tmp849="expecting polymorphic type but found %s",
_tag_dyneither(_tmp849,sizeof(char),40))),_tag_dyneither(_tmp848,sizeof(void*),1)))))));};};}
...
loc,t);Cyc_Tcexp_tcExp(te,(void**)& t,e);{void*t2=(void*)_check_null(e->topt);if(
...
_tmp84E;void*_tmp84D[2];struct Cyc_String_pa_struct _tmp84C;struct Cyc_String_pa_struct
_tmp84B;void*_tmp2BC=(_tmp84B.tag=0,((_tmp84B.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp84C.tag=0,((_tmp84C.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t2)),((_tmp84D[0]=&
_tmp84C,((_tmp84D[1]=& _tmp84B,Cyc_Tcexp_expr_err(te,loc,(void**)& t,((_tmp84E="cannot cast %s to %s",
_tag_dyneither(_tmp84E,sizeof(char),21))),_tag_dyneither(_tmp84D,sizeof(void*),2)))))))))))));
Cyc_Tcutil_explain_failure();return _tmp2BC;};}}}{struct _tuple0 _tmp84F;struct
_tuple0 _tmp2C2=(_tmp84F.f1=e->r,((_tmp84F.f2=Cyc_Tcutil_compress(t),_tmp84F)));
void*_tmp2C3;struct Cyc_Absyn_MallocInfo _tmp2C5;int _tmp2C6;void*_tmp2C7;struct Cyc_Absyn_PtrInfo
_tmp2C9;struct Cyc_Absyn_PtrAtts _tmp2CA;union Cyc_Absyn_Constraint*_tmp2CB;union
Cyc_Absyn_Constraint*_tmp2CC;union Cyc_Absyn_Constraint*_tmp2CD;_LL14E: _tmp2C3=
_tmp2C2.f1;{struct Cyc_Absyn_Malloc_e_struct*_tmp2C4=(struct Cyc_Absyn_Malloc_e_struct*)
_tmp2C3;if(_tmp2C4->tag != 32)goto _LL150;else{_tmp2C5=_tmp2C4->f1;_tmp2C6=_tmp2C5.fat_result;}};
_tmp2C7=_tmp2C2.f2;{struct Cyc_Absyn_PointerType_struct*_tmp2C8=(struct Cyc_Absyn_PointerType_struct*)
...
Cyc_Absyn_bounds_one,_tmp2CC);struct Cyc_Absyn_Exp*_tmp2D0;_LL153: {struct Cyc_Absyn_Upper_b_struct*
_tmp2CF=(struct Cyc_Absyn_Upper_b_struct*)_tmp2CE;if(_tmp2CF->tag != 1)goto _LL155;
else{_tmp2D0=_tmp2CF->f1;}}_LL154: if((Cyc_Evexp_eval_const_uint_exp(_tmp2D0)).f1
== 1){const char*_tmp852;void*_tmp851;(_tmp851=0,Cyc_Tcutil_warn(loc,((_tmp852="cast from ? pointer to * pointer will lose size information",
...
_tmp2DB;union Cyc_Absyn_Constraint*_tmp2DC;_LL158: {struct Cyc_Absyn_PointerType_struct*
_tmp2D6=(struct Cyc_Absyn_PointerType_struct*)_tmp2D5;if(_tmp2D6->tag != 5)goto
_LL15A;else{_tmp2D7=_tmp2D6->f1;_tmp2D8=_tmp2D7.elt_typ;_tmp2D9=(void**)&(
...
struct Cyc_Absyn_Subscript_e_struct*_tmp2E1=(struct Cyc_Absyn_Subscript_e_struct*)
...
_LL162: {struct Cyc_Absyn_TupleType_struct*_tmp2E5=(struct Cyc_Absyn_TupleType_struct*)
...
struct Cyc_Absyn_AggrMember_e_struct*_tmp2E8=(struct Cyc_Absyn_AggrMember_e_struct*)
_tmp2E7;if(_tmp2E8->tag != 20)goto _LL169;else{_tmp2E9=_tmp2E8->f3;if(_tmp2E9 != 1)
goto _LL169;}}_LL168: goto _LL16A;_LL169: {struct Cyc_Absyn_AggrArrow_e_struct*
_tmp2EA=(struct Cyc_Absyn_AggrArrow_e_struct*)_tmp2E7;if(_tmp2EA->tag != 21)goto
_LL16B;else{_tmp2EB=_tmp2EA->f3;if(_tmp2EB != 1)goto _LL16B;}}_LL16A:{const char*
_tmp858;void*_tmp857;(_tmp857=0,Cyc_Tcutil_terr(e->loc,((_tmp858="cannot take the address of a @tagged union member",
...
t);if(!Cyc_Evexp_okay_szofarg(t)){const char*_tmp85F;void*_tmp85E[1];struct Cyc_String_pa_struct
...
struct Cyc_Absyn_TagType_struct*_tmp2F8=(struct Cyc_Absyn_TagType_struct*)_tmp2F7;
if(_tmp2F8->tag != 19)goto _LL170;else{_tmp2F9=(void*)_tmp2F8->f1;}}_LL16F: {
struct Cyc_Absyn_Exp*_tmp2FA=Cyc_Absyn_sizeoftyp_exp(t,0);struct Cyc_Absyn_ValueofType_struct
_tmp862;struct Cyc_Absyn_ValueofType_struct*_tmp861;struct Cyc_Absyn_ValueofType_struct*
...
_dyneither_ptr*_tmp300;unsigned int _tmp302;_LL173: {struct Cyc_Absyn_StructField_struct*
_tmp2FF=(struct Cyc_Absyn_StructField_struct*)_tmp2FE;if(_tmp2FF->tag != 0)goto
_LL175;else{_tmp300=_tmp2FF->f1;}}_LL174: {int bad_type=1;{void*_tmp303=Cyc_Tcutil_compress(
t);struct Cyc_Absyn_AggrInfo _tmp305;union Cyc_Absyn_AggrInfoU _tmp306;struct Cyc_Absyn_Aggrdecl**
_tmp307;struct Cyc_List_List*_tmp309;_LL178: {struct Cyc_Absyn_AggrType_struct*
_tmp304=(struct Cyc_Absyn_AggrType_struct*)_tmp303;if(_tmp304->tag != 11)goto
_LL17A;else{_tmp305=_tmp304->f1;_tmp306=_tmp305.aggr_info;if((_tmp306.KnownAggr).tag
!= 2)goto _LL17A;_tmp307=(struct Cyc_Absyn_Aggrdecl**)(_tmp306.KnownAggr).val;}}
_LL179: if((*_tmp307)->impl == 0)goto _LL177;if(!((int(*)(int(*pred)(struct
_dyneither_ptr*,struct Cyc_Absyn_Aggrfield*),struct _dyneither_ptr*env,struct Cyc_List_List*
x))Cyc_List_exists_c)(Cyc_Tcexp_structfield_has_name,_tmp300,((struct Cyc_Absyn_AggrdeclImpl*)
_check_null((*_tmp307)->impl))->fields)){const char*_tmp866;void*_tmp865[1];
struct Cyc_String_pa_struct _tmp864;(_tmp864.tag=0,((_tmp864.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*_tmp300),((_tmp865[0]=& _tmp864,Cyc_Tcutil_terr(
loc,((_tmp866="no field of struct/union has name %s",_tag_dyneither(_tmp866,
sizeof(char),37))),_tag_dyneither(_tmp865,sizeof(void*),1)))))));}bad_type=0;
goto _LL177;_LL17A: {struct Cyc_Absyn_AnonAggrType_struct*_tmp308=(struct Cyc_Absyn_AnonAggrType_struct*)
_tmp303;if(_tmp308->tag != 12)goto _LL17C;else{_tmp309=_tmp308->f2;}}_LL17B: if(!((
...
_tmp300,_tmp309)){const char*_tmp86A;void*_tmp869[1];struct Cyc_String_pa_struct
...
_tmp86C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((
_tmp86D[0]=& _tmp86C,Cyc_Tcutil_terr(loc,((_tmp86E="%s is not a known struct/union type",
_tag_dyneither(_tmp86E,sizeof(char),36))),_tag_dyneither(_tmp86D,sizeof(void*),1)))))));}
goto _LL172;}_LL175: {struct Cyc_Absyn_TupleIndex_struct*_tmp301=(struct Cyc_Absyn_TupleIndex_struct*)
_tmp2FE;if(_tmp301->tag != 1)goto _LL172;else{_tmp302=_tmp301->f1;}}_LL176: {int
bad_type=1;{void*_tmp313=Cyc_Tcutil_compress(t);struct Cyc_Absyn_AggrInfo _tmp315;
union Cyc_Absyn_AggrInfoU _tmp316;struct Cyc_Absyn_Aggrdecl**_tmp317;struct Cyc_List_List*
_tmp319;struct Cyc_List_List*_tmp31B;struct Cyc_Absyn_DatatypeFieldInfo _tmp31D;
union Cyc_Absyn_DatatypeFieldInfoU _tmp31E;struct _tuple2 _tmp31F;struct Cyc_Absyn_Datatypefield*
_tmp320;_LL17F: {struct Cyc_Absyn_AggrType_struct*_tmp314=(struct Cyc_Absyn_AggrType_struct*)
...
_LL181: {struct Cyc_Absyn_AnonAggrType_struct*_tmp318=(struct Cyc_Absyn_AnonAggrType_struct*)
...
_tmp873;void*_tmp872[2];struct Cyc_Int_pa_struct _tmp871;struct Cyc_Int_pa_struct
...
0;goto _LL17E;_LL183: {struct Cyc_Absyn_TupleType_struct*_tmp31A=(struct Cyc_Absyn_TupleType_struct*)
_tmp313;if(_tmp31A->tag != 10)goto _LL185;else{_tmp31B=_tmp31A->f1;}}_LL184: if(((
int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp31B)<= _tmp302){const char*
_tmp878;void*_tmp877[2];struct Cyc_Int_pa_struct _tmp876;struct Cyc_Int_pa_struct
_tmp875;(_tmp875.tag=1,((_tmp875.f1=(unsigned long)((int)_tmp302),((_tmp876.tag=
1,((_tmp876.f1=(unsigned long)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmp31B),((_tmp877[0]=& _tmp876,((_tmp877[1]=& _tmp875,Cyc_Tcutil_terr(loc,((
_tmp878="tuple has too few components: %d <= %d",_tag_dyneither(_tmp878,sizeof(
char),39))),_tag_dyneither(_tmp877,sizeof(void*),2)))))))))))));}bad_type=0;goto
_LL17E;_LL185: {struct Cyc_Absyn_DatatypeFieldType_struct*_tmp31C=(struct Cyc_Absyn_DatatypeFieldType_struct*)
_tmp313;if(_tmp31C->tag != 4)goto _LL187;else{_tmp31D=_tmp31C->f1;_tmp31E=_tmp31D.field_info;
if((_tmp31E.KnownDatatypefield).tag != 2)goto _LL187;_tmp31F=(struct _tuple2)(
_tmp31E.KnownDatatypefield).val;_tmp320=_tmp31F.f2;}}_LL186: if(((int(*)(struct
Cyc_List_List*x))Cyc_List_length)(_tmp320->typs)< _tmp302){const char*_tmp87D;
void*_tmp87C[2];struct Cyc_Int_pa_struct _tmp87B;struct Cyc_Int_pa_struct _tmp87A;(
_tmp87A.tag=1,((_tmp87A.f1=(unsigned long)((int)_tmp302),((_tmp87B.tag=1,((
_tmp87B.f1=(unsigned long)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmp320->typs),((_tmp87C[0]=& _tmp87B,((_tmp87C[1]=& _tmp87A,Cyc_Tcutil_terr(loc,((
_tmp87D="datatype field has too few components: %d < %d",_tag_dyneither(_tmp87D,
sizeof(char),47))),_tag_dyneither(_tmp87C,sizeof(void*),2)))))))))))));}bad_type=
0;goto _LL17E;_LL187:;_LL188: goto _LL17E;_LL17E:;}if(bad_type){const char*_tmp881;
void*_tmp880[1];struct Cyc_String_pa_struct _tmp87F;(_tmp87F.tag=0,((_tmp87F.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp880[
0]=& _tmp87F,Cyc_Tcutil_terr(loc,((_tmp881="%s is not a known type",
...
union Cyc_Absyn_Constraint*_tmp33A;_LL18A: {struct Cyc_Absyn_Evar_struct*_tmp333=(
struct Cyc_Absyn_Evar_struct*)_tmp332;if(_tmp333->tag != 1)goto _LL18C;}_LL18B: {
struct Cyc_List_List*_tmp33B=Cyc_Tcenv_lookup_type_vars(_tmp331);struct Cyc_Core_Opt*
_tmp882;void*_tmp33C=Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_mko,((
_tmp882=_cycalloc(sizeof(*_tmp882)),((_tmp882->v=_tmp33B,_tmp882)))));struct Cyc_Core_Opt*
_tmp883;void*_tmp33D=Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_trko,((
_tmp883=_cycalloc(sizeof(*_tmp883)),((_tmp883->v=_tmp33B,_tmp883)))));union Cyc_Absyn_Constraint*
_tmp33E=((union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)();union Cyc_Absyn_Constraint*
_tmp33F=((union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)();struct Cyc_Absyn_PtrAtts
_tmp884;struct Cyc_Absyn_PtrAtts _tmp340=(_tmp884.rgn=_tmp33D,((_tmp884.nullable=((
union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)(),((_tmp884.bounds=
_tmp33E,((_tmp884.zero_term=_tmp33F,((_tmp884.ptrloc=0,_tmp884)))))))));struct
Cyc_Absyn_PointerType_struct _tmp88A;struct Cyc_Absyn_PtrInfo _tmp889;struct Cyc_Absyn_PointerType_struct*
_tmp888;struct Cyc_Absyn_PointerType_struct*_tmp341=(_tmp888=_cycalloc(sizeof(*
_tmp888)),((_tmp888[0]=((_tmp88A.tag=5,((_tmp88A.f1=((_tmp889.elt_typ=_tmp33C,((
_tmp889.elt_tq=Cyc_Absyn_empty_tqual(0),((_tmp889.ptr_atts=_tmp340,_tmp889)))))),
_tmp88A)))),_tmp888)));Cyc_Tcutil_unify(t,(void*)_tmp341);_tmp336=_tmp33C;
_tmp338=_tmp33D;_tmp339=_tmp33E;_tmp33A=_tmp33F;goto _LL18D;}_LL18C: {struct Cyc_Absyn_PointerType_struct*
_tmp334=(struct Cyc_Absyn_PointerType_struct*)_tmp332;if(_tmp334->tag != 5)goto
_LL18E;else{_tmp335=_tmp334->f1;_tmp336=_tmp335.elt_typ;_tmp337=_tmp335.ptr_atts;
_tmp338=_tmp337.rgn;_tmp339=_tmp337.bounds;_tmp33A=_tmp337.zero_term;}}_LL18D:
Cyc_Tcenv_check_rgn_accessible(_tmp331,loc,_tmp338);Cyc_Tcutil_check_nonzero_bound(
loc,_tmp339);if(!Cyc_Tcutil_kind_leq(Cyc_Tcutil_typ_kind(_tmp336),& Cyc_Tcutil_tmk)){
const char*_tmp88D;void*_tmp88C;(_tmp88C=0,Cyc_Tcutil_terr(loc,((_tmp88D="can't dereference abstract pointer type",
_tag_dyneither(_tmp88D,sizeof(char),40))),_tag_dyneither(_tmp88C,sizeof(void*),0)));}{
void*_tmp34A=_tmp336;_npop_handler(0);return _tmp34A;};_LL18E:;_LL18F: {const char*
_tmp891;void*_tmp890[1];struct Cyc_String_pa_struct _tmp88F;void*_tmp34E=(_tmp88F.tag=
...
_tmp359;_LL191: {struct Cyc_Absyn_AggrType_struct*_tmp351=(struct Cyc_Absyn_AggrType_struct*)
...
0){const char*_tmp896;void*_tmp895[2];struct Cyc_String_pa_struct _tmp894;struct Cyc_String_pa_struct
_tmp893;void*_tmp363=(_tmp893.tag=0,((_tmp893.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*f),((_tmp894.tag=0,((_tmp894.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp355->name)),((_tmp895[0]=& _tmp894,((
_tmp895[1]=& _tmp893,Cyc_Tcexp_expr_err(te,loc,topt,((_tmp896="type %s has no %s field",
_tag_dyneither(_tmp896,sizeof(char),24))),_tag_dyneither(_tmp895,sizeof(void*),2)))))))))))));
_npop_handler(0);return _tmp363;}if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(
_tmp355->impl))->tagged)*is_tagged=1;{void*t2=_tmp35E->type;if(_tmp356 != 0){
struct _RegionHandle _tmp364=_new_region("rgn");struct _RegionHandle*rgn=& _tmp364;
_push_region(rgn);{struct Cyc_List_List*_tmp365=((struct Cyc_List_List*(*)(struct
_RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x,struct Cyc_List_List*
y))Cyc_List_rzip)(rgn,rgn,_tmp355->tvs,_tmp356);t2=Cyc_Tcutil_rsubstitute(rgn,
_tmp365,_tmp35E->type);};_pop_region(rgn);}if(((_tmp355->kind == Cyc_Absyn_UnionA
 && !((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp355->impl))->tagged) && !
Cyc_Tcenv_in_notreadctxt(te)) && !Cyc_Tcutil_bits_only(t2)){const char*_tmp89A;
void*_tmp899[1];struct Cyc_String_pa_struct _tmp898;void*_tmp369=(_tmp898.tag=0,((
_tmp898.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f),((_tmp899[0]=&
_tmp898,Cyc_Tcexp_expr_err(te,loc,topt,((_tmp89A="cannot read union member %s since it is not `bits-only'",
_tag_dyneither(_tmp89A,sizeof(char),56))),_tag_dyneither(_tmp899,sizeof(void*),1)))))));
...
te)))){const char*_tmp89E;void*_tmp89D[1];struct Cyc_String_pa_struct _tmp89C;void*
_tmp36D=(_tmp89C.tag=0,((_tmp89C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
f),((_tmp89D[0]=& _tmp89C,Cyc_Tcexp_expr_err(te,loc,topt,((_tmp89E="must use pattern-matching to access field %s\n\tdue to existential type variables.",
...
_LL193: {struct Cyc_Absyn_AnonAggrType_struct*_tmp357=(struct Cyc_Absyn_AnonAggrType_struct*)
...
_tmp36F == 0){const char*_tmp8A2;void*_tmp8A1[1];struct Cyc_String_pa_struct _tmp8A0;
void*_tmp373=(_tmp8A0.tag=0,((_tmp8A0.f1=(struct _dyneither_ptr)((struct
...
_tmp36F->type)){const char*_tmp8A6;void*_tmp8A5[1];struct Cyc_String_pa_struct
...
return _tmp378;};}_LL195:{struct Cyc_Absyn_ArrayType_struct*_tmp35A=(struct Cyc_Absyn_ArrayType_struct*)
_tmp350;if(_tmp35A->tag != 8)goto _LL197;}{const char*_tmp8A7;if(!(Cyc_strcmp((
struct _dyneither_ptr)*f,((_tmp8A7="size",_tag_dyneither(_tmp8A7,sizeof(char),5))))
== 0))goto _LL197;};_LL196: goto _LL198;_LL197:{struct Cyc_Absyn_PointerType_struct*
_tmp35C=(struct Cyc_Absyn_PointerType_struct*)_tmp350;if(_tmp35C->tag != 5)goto
_LL199;}{const char*_tmp8A8;if(!(Cyc_strcmp((struct _dyneither_ptr)*f,((_tmp8A8="size",
_tag_dyneither(_tmp8A8,sizeof(char),5))))== 0))goto _LL199;};_LL198:{const char*
_tmp8AC;void*_tmp8AB[1];struct Cyc_String_pa_struct _tmp8AA;(_tmp8AA.tag=0,((
_tmp8AA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e)),((
_tmp8AB[0]=& _tmp8AA,Cyc_Tcutil_warn(e->loc,((_tmp8AC="deprecated `.size' used here -- change to numelts(%s)",
_tag_dyneither(_tmp8AC,sizeof(char),54))),_tag_dyneither(_tmp8AB,sizeof(void*),1)))))));}{
struct Cyc_Absyn_Primop_e_struct _tmp8B2;struct Cyc_List_List*_tmp8B1;struct Cyc_Absyn_Primop_e_struct*
_tmp8B0;outer_e->r=(void*)((_tmp8B0=_cycalloc(sizeof(*_tmp8B0)),((_tmp8B0[0]=((
_tmp8B2.tag=2,((_tmp8B2.f1=Cyc_Absyn_Numelts,((_tmp8B2.f2=((_tmp8B1=_cycalloc(
sizeof(*_tmp8B1)),((_tmp8B1->hd=e,((_tmp8B1->tl=0,_tmp8B1)))))),_tmp8B2)))))),
_tmp8B0))));}{void*_tmp37F=Cyc_Absyn_uint_typ;_npop_handler(0);return _tmp37F;};
_LL199:;_LL19A: {const char*_tmp8B3;if(Cyc_strcmp((struct _dyneither_ptr)*f,((
_tmp8B3="size",_tag_dyneither(_tmp8B3,sizeof(char),5))))== 0){const char*_tmp8B7;
void*_tmp8B6[1];struct Cyc_String_pa_struct _tmp8B5;void*_tmp384=(_tmp8B5.tag=0,((
_tmp8B5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((
void*)_check_null(e->topt))),((_tmp8B6[0]=& _tmp8B5,Cyc_Tcexp_expr_err(te,loc,
topt,((_tmp8B7="expecting struct, union, or array, found %s",_tag_dyneither(
_tmp8B7,sizeof(char),44))),_tag_dyneither(_tmp8B6,sizeof(void*),1)))))));
_npop_handler(0);return _tmp384;}else{const char*_tmp8BB;void*_tmp8BA[1];struct Cyc_String_pa_struct
...
_tmp390;union Cyc_Absyn_Constraint*_tmp391;_LL19C: {struct Cyc_Absyn_PointerType_struct*
_tmp38B=(struct Cyc_Absyn_PointerType_struct*)_tmp38A;if(_tmp38B->tag != 5)goto
_LL19E;else{_tmp38C=_tmp38B->f1;_tmp38D=_tmp38C.elt_typ;_tmp38E=_tmp38C.ptr_atts;
...
struct Cyc_Absyn_AggrType_struct*_tmp393=(struct Cyc_Absyn_AggrType_struct*)
...
0){const char*_tmp8C0;void*_tmp8BF[2];struct Cyc_String_pa_struct _tmp8BE;struct Cyc_String_pa_struct
_tmp8BD;void*_tmp3A1=(_tmp8BD.tag=0,((_tmp8BD.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*f),((_tmp8BE.tag=0,((_tmp8BE.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp397->name)),((_tmp8BF[0]=& _tmp8BE,((
_tmp8BF[1]=& _tmp8BD,Cyc_Tcexp_expr_err(te,loc,topt,((_tmp8C0="type %s has no %s field",
_tag_dyneither(_tmp8C0,sizeof(char),24))),_tag_dyneither(_tmp8BF,sizeof(void*),2)))))))))))));
_npop_handler(0);return _tmp3A1;}if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(
_tmp397->impl))->tagged)*is_tagged=1;{void*t3=_tmp39C->type;if(_tmp398 != 0){
struct _RegionHandle _tmp3A2=_new_region("rgn");struct _RegionHandle*rgn=& _tmp3A2;
_push_region(rgn);{struct Cyc_List_List*_tmp3A3=((struct Cyc_List_List*(*)(struct
_RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x,struct Cyc_List_List*
y))Cyc_List_rzip)(rgn,rgn,_tmp397->tvs,_tmp398);t3=Cyc_Tcutil_rsubstitute(rgn,
_tmp3A3,_tmp39C->type);};_pop_region(rgn);}{struct Cyc_Absyn_Kind*_tmp3A4=Cyc_Tcutil_typ_kind(
t3);if(Cyc_Tcutil_kind_leq(& Cyc_Tcutil_ak,_tmp3A4)){const char*_tmp8C4;void*
_tmp8C3[1];struct Cyc_String_pa_struct _tmp8C2;void*_tmp3A8=(_tmp8C2.tag=0,((
_tmp8C2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f),((_tmp8C3[0]=&
_tmp8C2,Cyc_Tcexp_expr_err(te,loc,topt,((_tmp8C4="cannot get member %s since its type is abstract",
_tag_dyneither(_tmp8C4,sizeof(char),48))),_tag_dyneither(_tmp8C3,sizeof(void*),1)))))));
_npop_handler(0);return _tmp3A8;}if(((_tmp397->kind == Cyc_Absyn_UnionA  && !((
struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp397->impl))->tagged) && !Cyc_Tcenv_in_notreadctxt(
te)) && !Cyc_Tcutil_bits_only(t3)){const char*_tmp8C8;void*_tmp8C7[1];struct Cyc_String_pa_struct
...
te)))){const char*_tmp8CC;void*_tmp8CB[1];struct Cyc_String_pa_struct _tmp8CA;void*
_tmp3B0=(_tmp8CA.tag=0,((_tmp8CA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
f),((_tmp8CB[0]=& _tmp8CA,Cyc_Tcexp_expr_err(te,loc,topt,((_tmp8CC="must use pattern-matching to access field %s\n\tdue to extistential types",
...
_LL1A3: {struct Cyc_Absyn_AnonAggrType_struct*_tmp399=(struct Cyc_Absyn_AnonAggrType_struct*)
...
_tmp3B2 == 0){const char*_tmp8D0;void*_tmp8CF[1];struct Cyc_String_pa_struct _tmp8CE;
void*_tmp3B6=(_tmp8CE.tag=0,((_tmp8CE.f1=(struct _dyneither_ptr)((struct
...
_tmp3B2->type)){const char*_tmp8D4;void*_tmp8D3[1];struct Cyc_String_pa_struct
...
goto _LL19B;_LL19B:;}{const char*_tmp8D8;void*_tmp8D7[1];struct Cyc_String_pa_struct
...
_tmp3CA=_tmp3C6;_LL1A8: {struct Cyc_List_Nth_struct*_tmp3CB=(struct Cyc_List_Nth_struct*)
_tmp3CA;if(_tmp3CB->tag != Cyc_List_Nth)goto _LL1AA;}_LL1A9: {const char*_tmp8E0;
void*_tmp8DF[2];struct Cyc_Int_pa_struct _tmp8DE;struct Cyc_Int_pa_struct _tmp8DD;
return(_tmp8DD.tag=1,((_tmp8DD.f1=(unsigned long)((int(*)(struct Cyc_List_List*x))
Cyc_List_length)(ts),((_tmp8DE.tag=1,((_tmp8DE.f1=(unsigned long)((int)_tmp3C1),((
_tmp8DF[0]=& _tmp8DE,((_tmp8DF[1]=& _tmp8DD,Cyc_Tcexp_expr_err(te,loc,0,((_tmp8E0="index is %d but tuple has only %d fields",
_tag_dyneither(_tmp8E0,sizeof(char),41))),_tag_dyneither(_tmp8DF,sizeof(void*),2)))))))))))));}
_LL1AA:;_LL1AB:(void)_throw(_tmp3CA);_LL1A7:;}};};}static void*Cyc_Tcexp_tcSubscript(
...
_tmp3D1,e2)){const char*_tmp8E4;void*_tmp8E3[1];struct Cyc_String_pa_struct _tmp8E2;
void*_tmp3D5=(_tmp8E2.tag=0,((_tmp8E2.f1=(struct _dyneither_ptr)((struct
...
struct Cyc_List_List*_tmp3E0;_LL1AD: {struct Cyc_Absyn_PointerType_struct*_tmp3D7=(
struct Cyc_Absyn_PointerType_struct*)_tmp3D6;if(_tmp3D7->tag != 5)goto _LL1AF;else{
_tmp3D8=_tmp3D7->f1;_tmp3D9=_tmp3D8.elt_typ;_tmp3DA=_tmp3D8.elt_tq;_tmp3DB=
_tmp3D8.ptr_atts;_tmp3DC=_tmp3DB.rgn;_tmp3DD=_tmp3DB.bounds;_tmp3DE=_tmp3DB.zero_term;}}
_LL1AE: if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,
_tmp3DE)){int emit_warning=1;{void*_tmp3E1=((void*(*)(void*y,union Cyc_Absyn_Constraint*
x))Cyc_Absyn_conref_def)((void*)& Cyc_Absyn_DynEither_b_val,_tmp3DD);struct Cyc_Absyn_Exp*
_tmp3E3;_LL1B4: {struct Cyc_Absyn_Upper_b_struct*_tmp3E2=(struct Cyc_Absyn_Upper_b_struct*)
...
goto _LL1B3;_LL1B6: {struct Cyc_Absyn_DynEither_b_struct*_tmp3E4=(struct Cyc_Absyn_DynEither_b_struct*)
_tmp3E1;if(_tmp3E4->tag != 0)goto _LL1B3;}_LL1B7: emit_warning=0;goto _LL1B3;_LL1B3:;}
if(emit_warning){const char*_tmp8E7;void*_tmp8E6;(_tmp8E6=0,Cyc_Tcutil_warn(e2->loc,((
_tmp8E7="subscript on thin, zero-terminated pointer could be expensive.",
...
void*_tmp3F4=_tmp3D9;_npop_handler(0);return _tmp3F4;};_LL1AF: {struct Cyc_Absyn_TupleType_struct*
_tmp3DF=(struct Cyc_Absyn_TupleType_struct*)_tmp3D6;if(_tmp3DF->tag != 10)goto
_LL1B1;else{_tmp3E0=_tmp3DF->f1;}}_LL1B0: {void*_tmp3F5=Cyc_Tcexp_ithTupleType(
_tmp3D1,loc,_tmp3E0,e2);_npop_handler(0);return _tmp3F5;}_LL1B1:;_LL1B2: {const
char*_tmp8F1;void*_tmp8F0[1];struct Cyc_String_pa_struct _tmp8EF;void*_tmp3F9=(
_tmp8EF.tag=0,((_tmp8EF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t1)),((_tmp8F0[0]=& _tmp8EF,Cyc_Tcexp_expr_err(_tmp3D1,loc,topt,((_tmp8F1="subscript applied to %s",
_tag_dyneither(_tmp8F1,sizeof(char),24))),_tag_dyneither(_tmp8F0,sizeof(void*),1)))))));
_npop_handler(0);return _tmp3F9;}_LL1AC:;};};};_pop_region(r);}static void*Cyc_Tcexp_tcTuple(
struct Cyc_Tcenv_Tenv*te,unsigned int loc,void**topt,struct Cyc_List_List*es){int
done=0;struct Cyc_List_List*fields=0;if(topt != 0){void*_tmp3FA=Cyc_Tcutil_compress(*
topt);struct Cyc_List_List*_tmp3FC;_LL1B9: {struct Cyc_Absyn_TupleType_struct*
_tmp3FB=(struct Cyc_Absyn_TupleType_struct*)_tmp3FA;if(_tmp3FB->tag != 10)goto
_LL1BB;else{_tmp3FC=_tmp3FB->f1;}}_LL1BA: if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmp3FC)!= ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(es))goto _LL1B8;for(0;
es != 0;(es=es->tl,_tmp3FC=_tmp3FC->tl)){int bogus=0;void*_tmp3FD=(*((struct
_tuple19*)((struct Cyc_List_List*)_check_null(_tmp3FC))->hd)).f2;Cyc_Tcexp_tcExpInitializer(
te,(void**)& _tmp3FD,(struct Cyc_Absyn_Exp*)es->hd);Cyc_Tcutil_coerce_arg(te,(
struct Cyc_Absyn_Exp*)es->hd,(*((struct _tuple19*)_tmp3FC->hd)).f2,& bogus);{struct
_tuple19*_tmp8F4;struct Cyc_List_List*_tmp8F3;fields=((_tmp8F3=_cycalloc(sizeof(*
_tmp8F3)),((_tmp8F3->hd=((_tmp8F4=_cycalloc(sizeof(*_tmp8F4)),((_tmp8F4->f1=(*((
struct _tuple19*)_tmp3FC->hd)).f1,((_tmp8F4->f2=(void*)_check_null(((struct Cyc_Absyn_Exp*)
es->hd)->topt),_tmp8F4)))))),((_tmp8F3->tl=fields,_tmp8F3))))));};}done=1;goto
_LL1B8;_LL1BB:;_LL1BC: goto _LL1B8;_LL1B8:;}if(!done)for(0;es != 0;es=es->tl){Cyc_Tcexp_tcExpInitializer(
te,0,(struct Cyc_Absyn_Exp*)es->hd);{struct _tuple19*_tmp8F7;struct Cyc_List_List*
_tmp8F6;fields=((_tmp8F6=_cycalloc(sizeof(*_tmp8F6)),((_tmp8F6->hd=((_tmp8F7=
_cycalloc(sizeof(*_tmp8F7)),((_tmp8F7->f1=Cyc_Absyn_empty_tqual(0),((_tmp8F7->f2=(
void*)_check_null(((struct Cyc_Absyn_Exp*)es->hd)->topt),_tmp8F7)))))),((_tmp8F6->tl=
fields,_tmp8F6))))));};}{struct Cyc_Absyn_TupleType_struct _tmp8FA;struct Cyc_Absyn_TupleType_struct*
...
Cyc_Absyn_Const_e_struct _tmp900;struct Cyc_Absyn_Const_e_struct*_tmp8FF;struct Cyc_Absyn_Const_e_struct*
_tmp408=(_tmp8FF=_cycalloc(sizeof(*_tmp8FF)),((_tmp8FF[0]=((_tmp900.tag=0,((
_tmp900.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Unsigned,_tmp407),_tmp900)))),_tmp8FF)));
struct Cyc_Absyn_Exp*sz_exp=Cyc_Absyn_new_exp((void*)_tmp408,loc);if(zero_term){
struct Cyc_Absyn_Exp*_tmp409=((struct Cyc_Absyn_Exp*(*)(struct Cyc_List_List*x,int n))
Cyc_List_nth)(es,_tmp407 - 1);if(!Cyc_Tcutil_is_zero(_tmp409)){const char*_tmp903;
void*_tmp902;(_tmp902=0,Cyc_Tcutil_terr(_tmp409->loc,((_tmp903="zero-terminated array doesn't end with zero.",
_tag_dyneither(_tmp903,sizeof(char),45))),_tag_dyneither(_tmp902,sizeof(void*),0)));}}
sz_exp->topt=(void*)Cyc_Absyn_uint_typ;res_t2=Cyc_Absyn_array_typ(res,(
...
_tmp907;void*_tmp906[1];struct Cyc_String_pa_struct _tmp905;(_tmp905.tag=0,((
_tmp905.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
res)),((_tmp906[0]=& _tmp905,Cyc_Tcutil_terr(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)
_check_null(es))->hd)->loc,((_tmp907="elements of array do not all have the same type (%s)",
...
_tmp414;_LL1BE: {struct Cyc_Absyn_FieldName_struct*_tmp412=(struct Cyc_Absyn_FieldName_struct*)
_tmp411;if(_tmp412->tag != 1)goto _LL1C0;}_LL1BF:{const char*_tmp90A;void*_tmp909;(
_tmp909=0,Cyc_Tcutil_terr(loc,((_tmp90A="only array index designators are supported",
_tag_dyneither(_tmp90A,sizeof(char),43))),_tag_dyneither(_tmp909,sizeof(void*),0)));}
goto _LL1BD;_LL1C0: {struct Cyc_Absyn_ArrayElement_struct*_tmp413=(struct Cyc_Absyn_ArrayElement_struct*)
...
else{if(_tmp418 != offset){const char*_tmp912;void*_tmp911[2];struct Cyc_Int_pa_struct
_tmp910;struct Cyc_Int_pa_struct _tmp90F;(_tmp90F.tag=1,((_tmp90F.f1=(
...
_tmp421=Cyc_Tcutil_compress((void*)_check_null(bound->topt));_LL1C3: {struct Cyc_Absyn_TagType_struct*
_tmp422=(struct Cyc_Absyn_TagType_struct*)_tmp421;if(_tmp422->tag != 19)goto _LL1C5;}
_LL1C4: goto _LL1C2;_LL1C5:;_LL1C6: if(!Cyc_Tcutil_coerce_uint_typ(te,bound)){const
char*_tmp916;void*_tmp915[1];struct Cyc_String_pa_struct _tmp914;(_tmp914.tag=0,((
_tmp914.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((
void*)_check_null(bound->topt))),((_tmp915[0]=& _tmp914,Cyc_Tcutil_terr(bound->loc,((
_tmp916="expecting unsigned int, found %s",_tag_dyneither(_tmp916,sizeof(char),
33))),_tag_dyneither(_tmp915,sizeof(void*),1)))))));}_LL1C2:;}if(!(vd->tq).real_const){
const char*_tmp919;void*_tmp918;(_tmp918=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp919="comprehension index variable is not declared const!",
_tag_dyneither(_tmp919,sizeof(char),52))),_tag_dyneither(_tmp918,sizeof(void*),0)));}{
struct _RegionHandle _tmp428=_new_region("r");struct _RegionHandle*r=& _tmp428;
...
_tmp435;_LL1C8: {struct Cyc_Absyn_PointerType_struct*_tmp42E=(struct Cyc_Absyn_PointerType_struct*)
_tmp42D;if(_tmp42E->tag != 5)goto _LL1CA;else{_tmp42F=_tmp42E->f1;}}_LL1C9:{void**
_tmp91A;_tmp42A=((_tmp91A=_region_malloc(r,sizeof(*_tmp91A)),((_tmp91A[0]=
_tmp42F.elt_typ,_tmp91A))));}{struct Cyc_Absyn_Tqual*_tmp91B;_tmp42B=((_tmp91B=
_region_malloc(r,sizeof(*_tmp91B)),((_tmp91B[0]=_tmp42F.elt_tq,_tmp91B))));}{
union Cyc_Absyn_Constraint**_tmp91C;_tmp42C=((_tmp91C=_region_malloc(r,sizeof(*
_tmp91C)),((_tmp91C[0]=(_tmp42F.ptr_atts).zero_term,_tmp91C))));}goto _LL1C7;
_LL1CA: {struct Cyc_Absyn_ArrayType_struct*_tmp430=(struct Cyc_Absyn_ArrayType_struct*)
_tmp42D;if(_tmp430->tag != 8)goto _LL1CC;else{_tmp431=_tmp430->f1;_tmp432=_tmp431.elt_type;
_tmp433=_tmp431.tq;_tmp434=_tmp431.num_elts;_tmp435=_tmp431.zero_term;}}_LL1CB:{
void**_tmp91D;_tmp42A=((_tmp91D=_region_malloc(r,sizeof(*_tmp91D)),((_tmp91D[0]=
_tmp432,_tmp91D))));}{struct Cyc_Absyn_Tqual*_tmp91E;_tmp42B=((_tmp91E=
_region_malloc(r,sizeof(*_tmp91E)),((_tmp91E[0]=_tmp433,_tmp91E))));}{union Cyc_Absyn_Constraint**
...
_tmp445;_LL1CF: {struct Cyc_Dict_Absent_struct*_tmp449=(struct Cyc_Dict_Absent_struct*)
_tmp448;if(_tmp449->tag != Cyc_Dict_Absent)goto _LL1D1;}_LL1D0:{const char*_tmp92A;
void*_tmp929[1];struct Cyc_String_pa_struct _tmp928;(_tmp928.tag=0,((_tmp928.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(*tn)),((
_tmp929[0]=& _tmp928,Cyc_Tcutil_terr(loc,((_tmp92A="unbound struct/union name %s",
...
struct Cyc_String_pa_struct _tmp92E;(_tmp92E.tag=0,((_tmp92E.f1=(struct
...
_tmp45D;struct Cyc_List_List*_tmp45E;_LL1D4: {struct Cyc_Absyn_AggrType_struct*
_tmp45A=(struct Cyc_Absyn_AggrType_struct*)_tmp459;if(_tmp45A->tag != 11)goto
_LL1D6;else{_tmp45B=_tmp45A->f1;_tmp45C=_tmp45B.aggr_info;if((_tmp45C.KnownAggr).tag
...
topt;goto _LL1D3;}goto _LL1D7;_LL1D6:;_LL1D7: {struct Cyc_Absyn_AggrType_struct
_tmp939;struct Cyc_Absyn_AggrInfo _tmp938;struct Cyc_Absyn_AggrType_struct*_tmp937;
res_typ=(void*)((_tmp937=_cycalloc(sizeof(*_tmp937)),((_tmp937[0]=((_tmp939.tag=
11,((_tmp939.f1=((_tmp938.aggr_info=Cyc_Absyn_KnownAggr(adptr),((_tmp938.targs=
_tmp456,_tmp938)))),_tmp939)))),_tmp937))));}_LL1D3:;}else{struct Cyc_Absyn_AggrType_struct
_tmp93F;struct Cyc_Absyn_AggrInfo _tmp93E;struct Cyc_Absyn_AggrType_struct*_tmp93D;
res_typ=(void*)((_tmp93D=_cycalloc(sizeof(*_tmp93D)),((_tmp93D[0]=((_tmp93F.tag=
11,((_tmp93F.f1=((_tmp93E.aggr_info=Cyc_Absyn_KnownAggr(adptr),((_tmp93E.targs=
_tmp456,_tmp93E)))),_tmp93F)))),_tmp93D))));}{struct Cyc_List_List*_tmp466=*ts;
struct Cyc_List_List*_tmp467=_tmp457;while(_tmp466 != 0  && _tmp467 != 0){Cyc_Tcutil_check_type(
loc,te,Cyc_Tcenv_lookup_type_vars(te),& Cyc_Tcutil_ak,1,(void*)_tmp466->hd);Cyc_Tcutil_check_no_qual(
loc,(void*)_tmp466->hd);Cyc_Tcutil_unify((void*)_tmp466->hd,(void*)_tmp467->hd);
_tmp466=_tmp466->tl;_tmp467=_tmp467->tl;}if(_tmp466 != 0){const char*_tmp942;void*
_tmp941;(_tmp941=0,Cyc_Tcutil_terr(loc,((_tmp942="too many explicit witness types",
...
const char*_tmp94E;void*_tmp94D[5];struct Cyc_String_pa_struct _tmp94C;const char*
_tmp94B;const char*_tmp94A;struct Cyc_String_pa_struct _tmp949;struct Cyc_String_pa_struct
_tmp948;struct Cyc_String_pa_struct _tmp947;struct Cyc_String_pa_struct _tmp946;(
_tmp946.tag=0,((_tmp946.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((
void*)_check_null(_tmp46D->topt))),((_tmp947.tag=0,((_tmp947.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp46E)),((_tmp948.tag=
0,((_tmp948.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(*
tn)),((_tmp949.tag=0,((_tmp949.f1=(struct _dyneither_ptr)(ad->kind == Cyc_Absyn_StructA?(
...
_tmp481;struct Cyc_List_List*_tmp482;_LL1D9: {struct Cyc_Absyn_AnonAggrType_struct*
_tmp480=(struct Cyc_Absyn_AnonAggrType_struct*)_tmp47F;if(_tmp480->tag != 12)goto
_LL1DB;else{_tmp481=_tmp480->f1;_tmp482=_tmp480->f2;}}_LL1DA: if(_tmp481 == Cyc_Absyn_UnionA){
const char*_tmp954;void*_tmp953;(_tmp953=0,Cyc_Tcutil_terr(loc,((_tmp954="expecting struct but found union",
_tag_dyneither(_tmp954,sizeof(char),33))),_tag_dyneither(_tmp953,sizeof(void*),0)));}{
...
_tmp482);for(0;fields != 0;fields=fields->tl){int bogus=0;struct _tuple20 _tmp486;
struct Cyc_Absyn_Aggrfield*_tmp487;struct Cyc_Absyn_Exp*_tmp488;struct _tuple20*
_tmp485=(struct _tuple20*)fields->hd;_tmp486=*_tmp485;_tmp487=_tmp486.f1;_tmp488=
_tmp486.f2;Cyc_Tcexp_tcExpInitializer(te,(void**)& _tmp487->type,_tmp488);if(!Cyc_Tcutil_coerce_arg(
te,_tmp488,_tmp487->type,& bogus)){{const char*_tmp95A;void*_tmp959[3];struct Cyc_String_pa_struct
_tmp958;struct Cyc_String_pa_struct _tmp957;struct Cyc_String_pa_struct _tmp956;(
_tmp956.tag=0,((_tmp956.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((
void*)_check_null(_tmp488->topt))),((_tmp957.tag=0,((_tmp957.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp487->type)),((
_tmp958.tag=0,((_tmp958.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp487->name),((
_tmp959[0]=& _tmp958,((_tmp959[1]=& _tmp957,((_tmp959[2]=& _tmp956,Cyc_Tcutil_terr(
_tmp488->loc,((_tmp95A="field %s of struct expects type %s != %s",_tag_dyneither(
_tmp95A,sizeof(char),41))),_tag_dyneither(_tmp959,sizeof(void*),3)))))))))))))))))));}
...
x))Cyc_List_map)((void*(*)(struct _tuple13*))Cyc_Core_snd,_tmp493);struct Cyc_Absyn_DatatypeFieldType_struct
_tmp964;struct Cyc_Absyn_DatatypeFieldInfo _tmp963;struct Cyc_Absyn_DatatypeFieldType_struct*
...
void*_tmp495=Cyc_Tcutil_compress(*topt);_LL1DE: {struct Cyc_Absyn_DatatypeFieldType_struct*
_tmp496=(struct Cyc_Absyn_DatatypeFieldType_struct*)_tmp495;if(_tmp496->tag != 4)
goto _LL1E0;}_LL1DF: Cyc_Tcutil_unify(*topt,res);goto _LL1DD;_LL1E0:;_LL1E1: goto
_LL1DD;_LL1DD:;}{struct Cyc_List_List*ts=tuf->typs;for(0;es != 0  && ts != 0;(es=es->tl,
ts=ts->tl)){int bogus=0;struct Cyc_Absyn_Exp*e=(struct Cyc_Absyn_Exp*)es->hd;void*t=(*((
struct _tuple19*)ts->hd)).f2;if(_tmp493 != 0)t=Cyc_Tcutil_rsubstitute(rgn,_tmp493,
t);Cyc_Tcexp_tcExpInitializer(te,(void**)& t,e);if(!Cyc_Tcutil_coerce_arg(te,e,t,&
bogus)){{const char*_tmp96C;void*_tmp96B[3];struct Cyc_String_pa_struct _tmp96A;
struct Cyc_String_pa_struct _tmp969;const char*_tmp968;struct Cyc_String_pa_struct
...
struct Cyc_String_pa_struct _tmp96E;void*_tmp4A0=(_tmp96E.tag=0,((_tmp96E.f1=(
...
struct Cyc_String_pa_struct _tmp972;void*_tmp4A4=(_tmp972.tag=0,((_tmp972.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(tuf->name)),((
...
Cyc_List_List*_tmp4BF;struct Cyc_List_List*_tmp4C3;_LL1E3: {struct Cyc_Absyn_VoidType_struct*
_tmp4AB=(struct Cyc_Absyn_VoidType_struct*)_tmp4AA;if(_tmp4AB->tag != 0)goto _LL1E5;}
_LL1E4: return 1;_LL1E5: {struct Cyc_Absyn_Evar_struct*_tmp4AC=(struct Cyc_Absyn_Evar_struct*)
_tmp4AA;if(_tmp4AC->tag != 1)goto _LL1E7;}_LL1E6: goto _LL1E8;_LL1E7: {struct Cyc_Absyn_VarType_struct*
_tmp4AD=(struct Cyc_Absyn_VarType_struct*)_tmp4AA;if(_tmp4AD->tag != 2)goto _LL1E9;}
_LL1E8: goto _LL1EA;_LL1E9: {struct Cyc_Absyn_DatatypeType_struct*_tmp4AE=(struct
Cyc_Absyn_DatatypeType_struct*)_tmp4AA;if(_tmp4AE->tag != 3)goto _LL1EB;}_LL1EA:
goto _LL1EC;_LL1EB: {struct Cyc_Absyn_DatatypeFieldType_struct*_tmp4AF=(struct Cyc_Absyn_DatatypeFieldType_struct*)
_tmp4AA;if(_tmp4AF->tag != 4)goto _LL1ED;}_LL1EC: return 0;_LL1ED: {struct Cyc_Absyn_PointerType_struct*
_tmp4B0=(struct Cyc_Absyn_PointerType_struct*)_tmp4AA;if(_tmp4B0->tag != 5)goto
_LL1EF;else{_tmp4B1=_tmp4B0->f1;_tmp4B2=_tmp4B1.ptr_atts;_tmp4B3=_tmp4B2.nullable;}}
_LL1EE: return((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(1,
_tmp4B3);_LL1EF: {struct Cyc_Absyn_IntType_struct*_tmp4B4=(struct Cyc_Absyn_IntType_struct*)
_tmp4AA;if(_tmp4B4->tag != 6)goto _LL1F1;}_LL1F0: goto _LL1F2;_LL1F1: {struct Cyc_Absyn_FloatType_struct*
_tmp4B5=(struct Cyc_Absyn_FloatType_struct*)_tmp4AA;if(_tmp4B5->tag != 7)goto
_LL1F3;}_LL1F2: return 1;_LL1F3: {struct Cyc_Absyn_ArrayType_struct*_tmp4B6=(struct
Cyc_Absyn_ArrayType_struct*)_tmp4AA;if(_tmp4B6->tag != 8)goto _LL1F5;else{_tmp4B7=
_tmp4B6->f1;_tmp4B8=_tmp4B7.elt_type;}}_LL1F4: return Cyc_Tcexp_zeroable_type(
_tmp4B8);_LL1F5: {struct Cyc_Absyn_FnType_struct*_tmp4B9=(struct Cyc_Absyn_FnType_struct*)
_tmp4AA;if(_tmp4B9->tag != 9)goto _LL1F7;}_LL1F6: return 0;_LL1F7: {struct Cyc_Absyn_TupleType_struct*
_tmp4BA=(struct Cyc_Absyn_TupleType_struct*)_tmp4AA;if(_tmp4BA->tag != 10)goto
_LL1F9;else{_tmp4BB=_tmp4BA->f1;}}_LL1F8: for(0;(unsigned int)_tmp4BB;_tmp4BB=
_tmp4BB->tl){if(!Cyc_Tcexp_zeroable_type((*((struct _tuple19*)_tmp4BB->hd)).f2))
return 0;}return 1;_LL1F9: {struct Cyc_Absyn_AggrType_struct*_tmp4BC=(struct Cyc_Absyn_AggrType_struct*)
_tmp4AA;if(_tmp4BC->tag != 11)goto _LL1FB;else{_tmp4BD=_tmp4BC->f1;_tmp4BE=_tmp4BD.aggr_info;
_tmp4BF=_tmp4BD.targs;}}_LL1FA: {struct Cyc_Absyn_Aggrdecl*_tmp4D0=Cyc_Absyn_get_known_aggrdecl(
_tmp4BE);if(_tmp4D0->impl == 0  || ((struct Cyc_Absyn_AggrdeclImpl*)_check_null(
_tmp4D0->impl))->exist_vars != 0)return 0;{struct _RegionHandle _tmp4D1=_new_region("r");
struct _RegionHandle*r=& _tmp4D1;_push_region(r);{struct Cyc_List_List*_tmp4D2=((
struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*
x,struct Cyc_List_List*y))Cyc_List_rzip)(r,r,_tmp4D0->tvs,_tmp4BF);{struct Cyc_List_List*
fs=((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp4D0->impl))->fields;for(0;fs
!= 0;fs=fs->tl){if(!Cyc_Tcexp_zeroable_type(Cyc_Tcutil_rsubstitute(r,_tmp4D2,((
struct Cyc_Absyn_Aggrfield*)fs->hd)->type))){int _tmp4D3=0;_npop_handler(0);return
_tmp4D3;}}}{int _tmp4D4=1;_npop_handler(0);return _tmp4D4;};};_pop_region(r);};}
_LL1FB: {struct Cyc_Absyn_EnumType_struct*_tmp4C0=(struct Cyc_Absyn_EnumType_struct*)
_tmp4AA;if(_tmp4C0->tag != 13)goto _LL1FD;}_LL1FC: return 1;_LL1FD: {struct Cyc_Absyn_TagType_struct*
_tmp4C1=(struct Cyc_Absyn_TagType_struct*)_tmp4AA;if(_tmp4C1->tag != 19)goto _LL1FF;}
_LL1FE: return 1;_LL1FF: {struct Cyc_Absyn_AnonAggrType_struct*_tmp4C2=(struct Cyc_Absyn_AnonAggrType_struct*)
_tmp4AA;if(_tmp4C2->tag != 12)goto _LL201;else{_tmp4C3=_tmp4C2->f2;}}_LL200: for(0;
_tmp4C3 != 0;_tmp4C3=_tmp4C3->tl){if(!Cyc_Tcexp_zeroable_type(((struct Cyc_Absyn_Aggrfield*)
_tmp4C3->hd)->type))return 0;}return 1;_LL201: {struct Cyc_Absyn_AnonEnumType_struct*
_tmp4C4=(struct Cyc_Absyn_AnonEnumType_struct*)_tmp4AA;if(_tmp4C4->tag != 14)goto
_LL203;}_LL202: return 1;_LL203: {struct Cyc_Absyn_TypedefType_struct*_tmp4C5=(
struct Cyc_Absyn_TypedefType_struct*)_tmp4AA;if(_tmp4C5->tag != 17)goto _LL205;}
_LL204: return 0;_LL205: {struct Cyc_Absyn_DynRgnType_struct*_tmp4C6=(struct Cyc_Absyn_DynRgnType_struct*)
_tmp4AA;if(_tmp4C6->tag != 16)goto _LL207;}_LL206: return 0;_LL207: {struct Cyc_Absyn_RgnHandleType_struct*
_tmp4C7=(struct Cyc_Absyn_RgnHandleType_struct*)_tmp4AA;if(_tmp4C7->tag != 15)goto
_LL209;}_LL208: return 0;_LL209: {struct Cyc_Absyn_TypeDeclType_struct*_tmp4C8=(
struct Cyc_Absyn_TypeDeclType_struct*)_tmp4AA;if(_tmp4C8->tag != 26)goto _LL20B;}
_LL20A: goto _LL20C;_LL20B: {struct Cyc_Absyn_ValueofType_struct*_tmp4C9=(struct Cyc_Absyn_ValueofType_struct*)
_tmp4AA;if(_tmp4C9->tag != 18)goto _LL20D;}_LL20C: goto _LL20E;_LL20D: {struct Cyc_Absyn_HeapRgn_struct*
_tmp4CA=(struct Cyc_Absyn_HeapRgn_struct*)_tmp4AA;if(_tmp4CA->tag != 20)goto _LL20F;}
_LL20E: goto _LL210;_LL20F: {struct Cyc_Absyn_UniqueRgn_struct*_tmp4CB=(struct Cyc_Absyn_UniqueRgn_struct*)
_tmp4AA;if(_tmp4CB->tag != 21)goto _LL211;}_LL210: goto _LL212;_LL211: {struct Cyc_Absyn_RefCntRgn_struct*
_tmp4CC=(struct Cyc_Absyn_RefCntRgn_struct*)_tmp4AA;if(_tmp4CC->tag != 22)goto
_LL213;}_LL212: goto _LL214;_LL213: {struct Cyc_Absyn_AccessEff_struct*_tmp4CD=(
struct Cyc_Absyn_AccessEff_struct*)_tmp4AA;if(_tmp4CD->tag != 23)goto _LL215;}
_LL214: goto _LL216;_LL215: {struct Cyc_Absyn_JoinEff_struct*_tmp4CE=(struct Cyc_Absyn_JoinEff_struct*)
_tmp4AA;if(_tmp4CE->tag != 24)goto _LL217;}_LL216: goto _LL218;_LL217: {struct Cyc_Absyn_RgnsEff_struct*
_tmp4CF=(struct Cyc_Absyn_RgnsEff_struct*)_tmp4AA;if(_tmp4CF->tag != 25)goto _LL1E2;}
_LL218: {const char*_tmp978;void*_tmp977[1];struct Cyc_String_pa_struct _tmp976;(
_tmp976.tag=0,((_tmp976.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t)),((_tmp977[0]=& _tmp976,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr
ap))Cyc_Tcutil_impos)(((_tmp978="bad type `%s' in zeroable type",_tag_dyneither(
_tmp978,sizeof(char),31))),_tag_dyneither(_tmp977,sizeof(void*),1)))))));}_LL1E2:;}
...
return;if(topt != 0){void*_tmp4D8=Cyc_Tcutil_compress(*topt);struct Cyc_Absyn_PtrInfo
_tmp4DA;void*_tmp4DB;_LL21A: {struct Cyc_Absyn_PointerType_struct*_tmp4D9=(struct
Cyc_Absyn_PointerType_struct*)_tmp4D8;if(_tmp4D9->tag != 5)goto _LL21C;else{
_tmp4DA=_tmp4D9->f1;_tmp4DB=_tmp4DA.elt_typ;}}_LL21B: Cyc_Tcutil_unify(_tmp4DB,t);
if(Cyc_Tcutil_bits_only(t) || allow_zero  && Cyc_Tcexp_zeroable_type(t))return;
goto _LL219;_LL21C:;_LL21D: goto _LL219;_LL219:;}{const char*_tmp981;void*_tmp980[2];
const char*_tmp97F;const char*_tmp97E;struct Cyc_String_pa_struct _tmp97D;struct Cyc_String_pa_struct
_tmp97C;(_tmp97C.tag=0,((_tmp97C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(t)),((_tmp97D.tag=0,((_tmp97D.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)(allow_zero?(struct _dyneither_ptr)((_tmp97E="calloc",
_tag_dyneither(_tmp97E,sizeof(char),7))):(struct _dyneither_ptr)((_tmp97F="malloc",
_tag_dyneither(_tmp97F,sizeof(char),7))))),((_tmp980[0]=& _tmp97D,((_tmp980[1]=&
_tmp97C,Cyc_Tcutil_terr(loc,((_tmp981="%s cannot be used with type %s\n\t(type needs initialization)",
...
if(*ropt != 0){struct Cyc_Absyn_RgnHandleType_struct _tmp984;struct Cyc_Absyn_RgnHandleType_struct*
...
_LL222: {struct Cyc_Absyn_RgnHandleType_struct*_tmp4E3=(struct Cyc_Absyn_RgnHandleType_struct*)
...
const char*_tmp988;void*_tmp987[1];struct Cyc_String_pa_struct _tmp986;(_tmp986.tag=
0,((_tmp986.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
...
_tmp4F7;_LL227: {struct Cyc_Absyn_Sizeoftyp_e_struct*_tmp4ED=(struct Cyc_Absyn_Sizeoftyp_e_struct*)
_tmp4EC;if(_tmp4ED->tag != 16)goto _LL229;else{_tmp4EE=(void*)_tmp4ED->f1;}}_LL228:
elt_type=_tmp4EE;{void**_tmp98C;*t=(void**)((_tmp98C=_cycalloc(sizeof(*_tmp98C)),((
_tmp98C[0]=elt_type,_tmp98C))));}num_elts=Cyc_Absyn_uint_exp(1,0);Cyc_Tcexp_tcExp(
te,(void**)& Cyc_Absyn_uint_typ,num_elts);one_elt=1;goto _LL226;_LL229: {struct Cyc_Absyn_Primop_e_struct*
_tmp4EF=(struct Cyc_Absyn_Primop_e_struct*)_tmp4EC;if(_tmp4EF->tag != 2)goto _LL22B;
else{_tmp4F0=_tmp4EF->f1;if(_tmp4F0 != Cyc_Absyn_Times)goto _LL22B;_tmp4F1=_tmp4EF->f2;
if(_tmp4F1 == 0)goto _LL22B;_tmp4F2=*_tmp4F1;_tmp4F3=(struct Cyc_Absyn_Exp*)_tmp4F2.hd;
_tmp4F4=_tmp4F2.tl;if(_tmp4F4 == 0)goto _LL22B;_tmp4F5=*_tmp4F4;_tmp4F6=(struct Cyc_Absyn_Exp*)
_tmp4F5.hd;_tmp4F7=_tmp4F5.tl;if(_tmp4F7 != 0)goto _LL22B;}}_LL22A:{struct _tuple0
_tmp98D;struct _tuple0 _tmp4FA=(_tmp98D.f1=_tmp4F3->r,((_tmp98D.f2=_tmp4F6->r,
_tmp98D)));void*_tmp4FB;void*_tmp4FD;void*_tmp4FE;void*_tmp500;_LL22E: _tmp4FB=
_tmp4FA.f1;{struct Cyc_Absyn_Sizeoftyp_e_struct*_tmp4FC=(struct Cyc_Absyn_Sizeoftyp_e_struct*)
_tmp4FB;if(_tmp4FC->tag != 16)goto _LL230;else{_tmp4FD=(void*)_tmp4FC->f1;}};
_LL22F: Cyc_Tcexp_check_malloc_type(0,loc,topt,_tmp4FD);elt_type=_tmp4FD;{void**
_tmp98E;*t=(void**)((_tmp98E=_cycalloc(sizeof(*_tmp98E)),((_tmp98E[0]=elt_type,
_tmp98E))));}num_elts=_tmp4F6;one_elt=0;goto _LL22D;_LL230: _tmp4FE=_tmp4FA.f2;{
struct Cyc_Absyn_Sizeoftyp_e_struct*_tmp4FF=(struct Cyc_Absyn_Sizeoftyp_e_struct*)
_tmp4FE;if(_tmp4FF->tag != 16)goto _LL232;else{_tmp500=(void*)_tmp4FF->f1;}};
_LL231: Cyc_Tcexp_check_malloc_type(0,loc,topt,_tmp500);elt_type=_tmp500;{void**
_tmp98F;*t=(void**)((_tmp98F=_cycalloc(sizeof(*_tmp98F)),((_tmp98F[0]=elt_type,
_tmp98F))));}num_elts=_tmp4F3;one_elt=0;goto _LL22D;_LL232:;_LL233: goto No_sizeof;
_LL22D:;}goto _LL226;_LL22B:;_LL22C: No_sizeof: {struct Cyc_Absyn_Exp*_tmp503=*e;{
void*_tmp504=_tmp503->r;struct Cyc_Absyn_Exp*_tmp506;_LL235: {struct Cyc_Absyn_Cast_e_struct*
_tmp505=(struct Cyc_Absyn_Cast_e_struct*)_tmp504;if(_tmp505->tag != 13)goto _LL237;
else{_tmp506=_tmp505->f2;}}_LL236: _tmp503=_tmp506;goto _LL234;_LL237:;_LL238: goto
_LL234;_LL234:;}{void*_tmp507=Cyc_Tcutil_compress((void*)_check_null(_tmp503->topt));
void*_tmp509;_LL23A: {struct Cyc_Absyn_TagType_struct*_tmp508=(struct Cyc_Absyn_TagType_struct*)
_tmp507;if(_tmp508->tag != 19)goto _LL23C;else{_tmp509=(void*)_tmp508->f1;}}_LL23B:{
void*_tmp50A=Cyc_Tcutil_compress(_tmp509);struct Cyc_Absyn_Exp*_tmp50C;_LL23F: {
struct Cyc_Absyn_ValueofType_struct*_tmp50B=(struct Cyc_Absyn_ValueofType_struct*)
_tmp50A;if(_tmp50B->tag != 18)goto _LL241;else{_tmp50C=_tmp50B->f1;}}_LL240: er=
_tmp50C->r;goto retry_sizeof;_LL241:;_LL242: goto _LL23E;_LL23E:;}goto _LL239;_LL23C:;
_LL23D: goto _LL239;_LL239:;}elt_type=Cyc_Absyn_char_typ;{void**_tmp990;*t=(void**)((
_tmp990=_cycalloc(sizeof(*_tmp990)),((_tmp990[0]=elt_type,_tmp990))));}num_elts=*
e;one_elt=0;}goto _LL226;_LL226:;}}*is_fat=!one_elt;{void*_tmp50E=elt_type;struct
Cyc_Absyn_AggrInfo _tmp510;union Cyc_Absyn_AggrInfoU _tmp511;struct Cyc_Absyn_Aggrdecl**
_tmp512;struct Cyc_Absyn_Aggrdecl*_tmp513;_LL244: {struct Cyc_Absyn_AggrType_struct*
_tmp50F=(struct Cyc_Absyn_AggrType_struct*)_tmp50E;if(_tmp50F->tag != 11)goto
_LL246;else{_tmp510=_tmp50F->f1;_tmp511=_tmp510.aggr_info;if((_tmp511.KnownAggr).tag
...
union Cyc_Absyn_Constraint*_tmp51E;_LL249: {struct Cyc_Absyn_PointerType_struct*
_tmp519=(struct Cyc_Absyn_PointerType_struct*)_tmp518;if(_tmp519->tag != 5)goto
_LL24B;else{_tmp51A=_tmp519->f1;_tmp51B=_tmp51A.ptr_atts;_tmp51C=_tmp51B.nullable;
_tmp51D=_tmp51B.bounds;_tmp51E=_tmp51B.zero_term;}}_LL24A: _tmp517=_tmp51E;if(((
int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp51C))
_tmp516=Cyc_Absyn_star_typ;if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(
0,_tmp51E) && !(*is_calloc)){{const char*_tmp996;void*_tmp995;(_tmp995=0,Cyc_Tcutil_warn(
loc,((_tmp996="converting malloc to calloc to ensure zero-termination",
...
Cyc_Absyn_bounds_one,_tmp51D);struct Cyc_Absyn_Exp*_tmp524;_LL24E: {struct Cyc_Absyn_DynEither_b_struct*
_tmp522=(struct Cyc_Absyn_DynEither_b_struct*)_tmp521;if(_tmp522->tag != 0)goto
_LL250;}_LL24F: goto _LL24D;_LL250:{struct Cyc_Absyn_Upper_b_struct*_tmp523=(struct
Cyc_Absyn_Upper_b_struct*)_tmp521;if(_tmp523->tag != 1)goto _LL252;else{_tmp524=
_tmp523->f1;}}if(!(!one_elt))goto _LL252;_LL251: {int _tmp525=Cyc_Evexp_c_can_eval(
num_elts);if(_tmp525  && Cyc_Evexp_same_const_exp(_tmp524,num_elts)){*is_fat=0;
return Cyc_Absyn_atb_typ(elt_type,rgn,Cyc_Absyn_empty_tqual(0),((void*(*)(union
Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_val)(_tmp51D),_tmp517);}{void*_tmp526=
Cyc_Tcutil_compress((void*)_check_null(num_elts->topt));void*_tmp528;_LL255: {
struct Cyc_Absyn_TagType_struct*_tmp527=(struct Cyc_Absyn_TagType_struct*)_tmp526;
if(_tmp527->tag != 19)goto _LL257;else{_tmp528=(void*)_tmp527->f1;}}_LL256: {
struct Cyc_Absyn_Exp*_tmp529=Cyc_Absyn_cast_exp(Cyc_Absyn_uint_typ,Cyc_Absyn_valueof_exp(
_tmp528,0),0,Cyc_Absyn_No_coercion,0);if(Cyc_Evexp_same_const_exp(_tmp529,
_tmp524)){*is_fat=0;return Cyc_Absyn_atb_typ(elt_type,rgn,Cyc_Absyn_empty_tqual(0),((
void*(*)(union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_val)(_tmp51D),_tmp517);}
goto _LL254;}_LL257:;_LL258: goto _LL254;_LL254:;}goto _LL24D;}_LL252:;_LL253: goto
_LL24D;_LL24D:;}goto _LL248;_LL24B:;_LL24C: goto _LL248;_LL248:;}if(!one_elt)
_tmp516=Cyc_Absyn_dyneither_typ;return _tmp516(elt_type,rgn,Cyc_Absyn_empty_tqual(
0),_tmp517);};};}static void*Cyc_Tcexp_tcSwap(struct Cyc_Tcenv_Tenv*te,
unsigned int loc,void**topt,struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2){struct
_RegionHandle _tmp52A=_new_region("r");struct _RegionHandle*r=& _tmp52A;
_push_region(r);{struct Cyc_Tcenv_Tenv*_tmp52B=Cyc_Tcenv_enter_lhs(r,Cyc_Tcenv_enter_notreadctxt(
r,te));Cyc_Tcexp_tcExp(_tmp52B,0,e1);{void*_tmp52C=(void*)_check_null(e1->topt);
Cyc_Tcexp_tcExp(_tmp52B,(void**)& _tmp52C,e2);};}{void*t1=(void*)_check_null(e1->topt);
void*t2=(void*)_check_null(e2->topt);{void*_tmp52D=Cyc_Tcutil_compress(t1);
_LL25A: {struct Cyc_Absyn_ArrayType_struct*_tmp52E=(struct Cyc_Absyn_ArrayType_struct*)
_tmp52D;if(_tmp52E->tag != 8)goto _LL25C;}_LL25B:{const char*_tmp999;void*_tmp998;(
_tmp998=0,Cyc_Tcutil_terr(loc,((_tmp999="cannot assign to an array",
_tag_dyneither(_tmp999,sizeof(char),26))),_tag_dyneither(_tmp998,sizeof(void*),0)));}
goto _LL259;_LL25C:;_LL25D: goto _LL259;_LL259:;}{int ign_1=0;if(!Cyc_Tcutil_is_pointer_or_boxed(
t1,& ign_1)){const char*_tmp99C;void*_tmp99B;(_tmp99B=0,Cyc_Tcutil_terr(loc,((
_tmp99C="Swap not allowed for non-pointer or non-word-sized types.",
...
_tmp9AD;void*_tmp9AC[2];struct Cyc_String_pa_struct _tmp9AB;struct Cyc_String_pa_struct
...
_tmp54F;_LL25F: {struct Cyc_Absyn_Exp_s_struct*_tmp548=(struct Cyc_Absyn_Exp_s_struct*)
...
Cyc_String_pa_struct _tmp9AF;(_tmp9AF.tag=0,((_tmp9AF.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp550)),((_tmp9B0[0]=& _tmp9AF,Cyc_Tcutil_terr(
loc,((_tmp9B1="statement expression returns type %s",_tag_dyneither(_tmp9B1,
sizeof(char),37))),_tag_dyneither(_tmp9B0,sizeof(void*),1)))))));}Cyc_Tcutil_explain_failure();}{
void*_tmp554=_tmp550;_npop_handler(0);return _tmp554;};}_LL261: {struct Cyc_Absyn_Seq_s_struct*
_tmp54A=(struct Cyc_Absyn_Seq_s_struct*)_tmp547;if(_tmp54A->tag != 2)goto _LL263;
else{_tmp54B=_tmp54A->f1;_tmp54C=_tmp54A->f2;}}_LL262: s=_tmp54C;continue;_LL263: {
struct Cyc_Absyn_Decl_s_struct*_tmp54D=(struct Cyc_Absyn_Decl_s_struct*)_tmp547;
if(_tmp54D->tag != 12)goto _LL265;else{_tmp54E=_tmp54D->f1;_tmp54F=_tmp54D->f2;}}
...
Cyc_Absyn_Aggrdecl**_tmp55C;struct Cyc_Absyn_Aggrdecl*_tmp55D;_LL268: {struct Cyc_Absyn_AggrType_struct*
_tmp559=(struct Cyc_Absyn_AggrType_struct*)_tmp558;if(_tmp559->tag != 11)goto
_LL26A;else{_tmp55A=_tmp559->f1;_tmp55B=_tmp55A.aggr_info;if((_tmp55B.KnownAggr).tag
...
Cyc_String_pa_struct _tmp9B6;(_tmp9B6.tag=0,((_tmp9B6.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string(t)),((_tmp9B7[0]=& _tmp9B6,Cyc_Tcutil_terr(
loc,((_tmp9B8="expecting @tagged union but found %s",_tag_dyneither(_tmp9B8,
sizeof(char),37))),_tag_dyneither(_tmp9B7,sizeof(void*),1)))))));}goto _LL267;
_LL267:;}return Cyc_Absyn_uint_typ;}static void*Cyc_Tcexp_tcNew(struct Cyc_Tcenv_Tenv*
...
!= 0){struct Cyc_Absyn_RgnHandleType_struct _tmp9BB;struct Cyc_Absyn_RgnHandleType_struct*
_tmp9BA;void*expected_type=(void*)((_tmp9BA=_cycalloc(sizeof(*_tmp9BA)),((
_tmp9BA[0]=((_tmp9BB.tag=15,((_tmp9BB.f1=(void*)Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)&
Cyc_Tcutil_trko,Cyc_Tcenv_lookup_opt_type_vars(te)),_tmp9BB)))),_tmp9BA))));void*
handle_type=Cyc_Tcexp_tcExp(te,(void**)& expected_type,(struct Cyc_Absyn_Exp*)
_check_null(*rgn_handle));void*_tmp561=Cyc_Tcutil_compress(handle_type);void*
_tmp563;_LL26D: {struct Cyc_Absyn_RgnHandleType_struct*_tmp562=(struct Cyc_Absyn_RgnHandleType_struct*)
_tmp561;if(_tmp562->tag != 15)goto _LL26F;else{_tmp563=(void*)_tmp562->f1;}}_LL26E:
rgn=_tmp563;Cyc_Tcenv_check_rgn_accessible(te,loc,rgn);goto _LL26C;_LL26F:;_LL270:{
const char*_tmp9BF;void*_tmp9BE[1];struct Cyc_String_pa_struct _tmp9BD;(_tmp9BD.tag=
0,((_tmp9BD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
handle_type)),((_tmp9BE[0]=& _tmp9BD,Cyc_Tcutil_terr(((struct Cyc_Absyn_Exp*)
_check_null(*rgn_handle))->loc,((_tmp9BF="expecting region_t type but found %s",
...
union Cyc_Absyn_Cnst _tmp574;struct _dyneither_ptr _tmp575;_LL272: {struct Cyc_Absyn_Comprehension_e_struct*
_tmp56A=(struct Cyc_Absyn_Comprehension_e_struct*)_tmp569;if(_tmp56A->tag != 26)
goto _LL274;}_LL273: {void*_tmp576=Cyc_Tcexp_tcExpNoPromote(te,topt,e1);void*
_tmp577=Cyc_Tcutil_compress(_tmp576);struct Cyc_Absyn_ArrayInfo _tmp579;void*
_tmp57A;struct Cyc_Absyn_Tqual _tmp57B;struct Cyc_Absyn_Exp*_tmp57C;union Cyc_Absyn_Constraint*
_tmp57D;_LL27F: {struct Cyc_Absyn_ArrayType_struct*_tmp578=(struct Cyc_Absyn_ArrayType_struct*)
_tmp577;if(_tmp578->tag != 8)goto _LL281;else{_tmp579=_tmp578->f1;_tmp57A=_tmp579.elt_type;
_tmp57B=_tmp579.tq;_tmp57C=_tmp579.num_elts;_tmp57D=_tmp579.zero_term;}}_LL280: {
struct Cyc_Absyn_Exp*bnd=(struct Cyc_Absyn_Exp*)_check_null(_tmp57C);void*b;{void*
_tmp57E=Cyc_Tcutil_compress((void*)_check_null(bnd->topt));void*_tmp580;_LL284: {
struct Cyc_Absyn_TagType_struct*_tmp57F=(struct Cyc_Absyn_TagType_struct*)_tmp57E;
if(_tmp57F->tag != 19)goto _LL286;else{_tmp580=(void*)_tmp57F->f1;}}_LL285:{struct
Cyc_Absyn_Upper_b_struct _tmp9C2;struct Cyc_Absyn_Upper_b_struct*_tmp9C1;b=(void*)((
_tmp9C1=_cycalloc(sizeof(*_tmp9C1)),((_tmp9C1[0]=((_tmp9C2.tag=1,((_tmp9C2.f1=
Cyc_Absyn_cast_exp(Cyc_Absyn_uint_typ,Cyc_Absyn_valueof_exp(_tmp580,0),0,Cyc_Absyn_No_coercion,
0),_tmp9C2)))),_tmp9C1))));}goto _LL283;_LL286:;_LL287: if(Cyc_Tcutil_is_const_exp(
te,bnd)){struct Cyc_Absyn_Upper_b_struct _tmp9C5;struct Cyc_Absyn_Upper_b_struct*
...
_LL283:;}{struct Cyc_Absyn_PointerType_struct _tmp9CF;struct Cyc_Absyn_PtrAtts
...
struct Cyc_Absyn_UnresolvedMem_e_struct*_tmp56B=(struct Cyc_Absyn_UnresolvedMem_e_struct*)
_tmp569;if(_tmp56B->tag != 34)goto _LL276;else{_tmp56C=_tmp56B->f1;_tmp56D=_tmp56B->f2;}}
_LL275:{struct Cyc_Absyn_Array_e_struct _tmp9D5;struct Cyc_Absyn_Array_e_struct*
...
goto _LL277;_LL276: {struct Cyc_Absyn_Array_e_struct*_tmp56E=(struct Cyc_Absyn_Array_e_struct*)
_tmp569;if(_tmp56E->tag != 25)goto _LL278;else{_tmp56F=_tmp56E->f1;}}_LL277: {void**
elt_typ_opt=0;int zero_term=0;if(topt != 0){void*_tmp58D=Cyc_Tcutil_compress(*topt);
struct Cyc_Absyn_PtrInfo _tmp58F;void*_tmp590;void**_tmp591;struct Cyc_Absyn_Tqual
_tmp592;struct Cyc_Absyn_PtrAtts _tmp593;union Cyc_Absyn_Constraint*_tmp594;_LL289: {
struct Cyc_Absyn_PointerType_struct*_tmp58E=(struct Cyc_Absyn_PointerType_struct*)
_tmp58D;if(_tmp58E->tag != 5)goto _LL28B;else{_tmp58F=_tmp58E->f1;_tmp590=_tmp58F.elt_typ;
_tmp591=(void**)&(_tmp58E->f1).elt_typ;_tmp592=_tmp58F.elt_tq;_tmp593=_tmp58F.ptr_atts;
_tmp594=_tmp593.zero_term;}}_LL28A: elt_typ_opt=(void**)_tmp591;zero_term=((int(*)(
int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp594);goto _LL288;
_LL28B:;_LL28C: goto _LL288;_LL288:;}{void*_tmp595=Cyc_Tcexp_tcArray(te,e1->loc,
...
_tmp59C;_LL28E: {struct Cyc_Absyn_ArrayType_struct*_tmp597=(struct Cyc_Absyn_ArrayType_struct*)
...
struct Cyc_Absyn_PointerType_struct _tmp9EA;struct Cyc_Absyn_PtrAtts _tmp9E9;struct
Cyc_Absyn_Upper_b_struct _tmp9E8;struct Cyc_Absyn_Upper_b_struct*_tmp9E7;struct Cyc_Absyn_PtrInfo
_tmp9E6;struct Cyc_Absyn_PointerType_struct*_tmp9E5;res_typ=(void*)((_tmp9E5=
_cycalloc(sizeof(*_tmp9E5)),((_tmp9E5[0]=((_tmp9EA.tag=5,((_tmp9EA.f1=((_tmp9E6.elt_typ=
_tmp599,((_tmp9E6.elt_tq=_tmp59A,((_tmp9E6.ptr_atts=((_tmp9E9.rgn=rgn,((_tmp9E9.nullable=((
union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)(),((_tmp9E9.bounds=((
union Cyc_Absyn_Constraint*(*)(void*x))Cyc_Absyn_new_conref)((void*)((_tmp9E7=
_cycalloc(sizeof(*_tmp9E7)),((_tmp9E7[0]=((_tmp9E8.tag=1,((_tmp9E8.f1=(struct Cyc_Absyn_Exp*)
_check_null(_tmp59B),_tmp9E8)))),_tmp9E7))))),((_tmp9E9.zero_term=_tmp59C,((
_tmp9E9.ptrloc=0,_tmp9E9)))))))))),_tmp9E6)))))),_tmp9EA)))),_tmp9E5))));}if(
topt != 0){if(!Cyc_Tcutil_unify(*topt,res_typ) && Cyc_Tcutil_silent_castable(te,
loc,res_typ,*topt)){e->topt=(void*)res_typ;Cyc_Tcutil_unchecked_cast(te,e,*topt,
Cyc_Absyn_Other_coercion);res_typ=*topt;}}goto _LL28D;_LL290:;_LL291: {const char*
_tmp9ED;void*_tmp9EC;(_tmp9EC=0,((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp9ED="tcExpNoPromote on Array_e returned non-array type",
_tag_dyneither(_tmp9ED,sizeof(char),50))),_tag_dyneither(_tmp9EC,sizeof(void*),0)));}
_LL28D:;}return res_typ;};};}_LL278: {struct Cyc_Absyn_Const_e_struct*_tmp570=(
struct Cyc_Absyn_Const_e_struct*)_tmp569;if(_tmp570->tag != 0)goto _LL27A;else{
_tmp571=_tmp570->f1;if((_tmp571.String_c).tag != 8)goto _LL27A;_tmp572=(struct
_dyneither_ptr)(_tmp571.String_c).val;}}_LL279: {void*_tmp5A5=Cyc_Absyn_atb_typ(
...
struct Cyc_Absyn_Upper_b_struct _tmp9F0;struct Cyc_Absyn_Upper_b_struct*_tmp9EF;
return Cyc_Absyn_atb_typ(_tmp5A6,rgn,Cyc_Absyn_empty_tqual(0),(void*)((_tmp9EF=
_cycalloc(sizeof(*_tmp9EF)),((_tmp9EF[0]=((_tmp9F0.tag=1,((_tmp9F0.f1=Cyc_Absyn_uint_exp(
1,0),_tmp9F0)))),_tmp9EF)))),Cyc_Absyn_false_conref);}_LL27A: {struct Cyc_Absyn_Const_e_struct*
_tmp573=(struct Cyc_Absyn_Const_e_struct*)_tmp569;if(_tmp573->tag != 0)goto _LL27C;
else{_tmp574=_tmp573->f1;if((_tmp574.Wstring_c).tag != 9)goto _LL27C;_tmp575=(
struct _dyneither_ptr)(_tmp574.Wstring_c).val;}}_LL27B: {void*_tmp5A9=Cyc_Absyn_atb_typ(
Cyc_Absyn_wchar_typ(),rgn,Cyc_Absyn_const_tqual(0),(void*)& Cyc_Absyn_DynEither_b_val,
Cyc_Absyn_true_conref);void*_tmp5AA=Cyc_Tcexp_tcExp(te,(void**)& _tmp5A9,e1);
struct Cyc_Absyn_Upper_b_struct _tmp9F3;struct Cyc_Absyn_Upper_b_struct*_tmp9F2;
return Cyc_Absyn_atb_typ(_tmp5AA,rgn,Cyc_Absyn_empty_tqual(0),(void*)((_tmp9F2=
_cycalloc(sizeof(*_tmp9F2)),((_tmp9F2[0]=((_tmp9F3.tag=1,((_tmp9F3.f1=Cyc_Absyn_uint_exp(
1,0),_tmp9F3)))),_tmp9F2)))),Cyc_Absyn_false_conref);}_LL27C:;_LL27D: RG: {void*
bogus=(void*)& Cyc_Absyn_VoidType_val;void**topt2=0;if(topt != 0){void*_tmp5AD=Cyc_Tcutil_compress(*
topt);struct Cyc_Absyn_PtrInfo _tmp5AF;void*_tmp5B0;void**_tmp5B1;struct Cyc_Absyn_Tqual
_tmp5B2;_LL293: {struct Cyc_Absyn_PointerType_struct*_tmp5AE=(struct Cyc_Absyn_PointerType_struct*)
...
void**)_tmp5B1;goto _LL292;_LL295: {struct Cyc_Absyn_DatatypeType_struct*_tmp5B3=(
struct Cyc_Absyn_DatatypeType_struct*)_tmp5AD;if(_tmp5B3->tag != 3)goto _LL297;}
_LL296: bogus=*topt;topt2=(void**)& bogus;goto _LL292;_LL297:;_LL298: goto _LL292;
_LL292:;}{void*telt=Cyc_Tcexp_tcExp(te,topt2,e1);struct Cyc_Absyn_PointerType_struct
_tmp9FD;struct Cyc_Absyn_PtrAtts _tmp9FC;struct Cyc_Absyn_PtrInfo _tmp9FB;struct Cyc_Absyn_PointerType_struct*
...
_tmp5BD;union Cyc_Absyn_Constraint*_tmp5BE;_LL29A: {struct Cyc_Absyn_ArrayType_struct*
_tmp5B9=(struct Cyc_Absyn_ArrayType_struct*)_tmp5B8;if(_tmp5B9->tag != 8)goto
_LL29C;else{_tmp5BA=_tmp5B9->f1;_tmp5BB=_tmp5BA.elt_type;_tmp5BC=_tmp5BA.tq;
...
struct Cyc_Absyn_Upper_b_struct _tmpA00;struct Cyc_Absyn_Upper_b_struct*_tmp9FF;
void*_tmp5C1=_tmp5BD == 0?(void*)& Cyc_Absyn_DynEither_b_val:(void*)((_tmp9FF=
_cycalloc(sizeof(*_tmp9FF)),((_tmp9FF[0]=((_tmpA00.tag=1,((_tmpA00.f1=(struct Cyc_Absyn_Exp*)
_tmp5BD,_tmpA00)))),_tmp9FF))));t=Cyc_Absyn_atb_typ(_tmp5BB,_tmp5C0,_tmp5BC,
_tmp5C1,_tmp5BE);e->topt=(void*)t;return t;};}_LL29C:;_LL29D: return t;_LL299:;}
void*Cyc_Tcexp_tcExpInitializer(struct Cyc_Tcenv_Tenv*te,void**topt,struct Cyc_Absyn_Exp*
e){void*t=Cyc_Tcexp_tcExpNoPromote(te,topt,e);struct _RegionHandle _tmp5C4=
_new_region("temp");struct _RegionHandle*temp=& _tmp5C4;_push_region(temp);if(Cyc_Tcutil_is_noalias_pointer_or_aggr(
temp,t) && !Cyc_Tcutil_is_noalias_path(temp,e)){const char*_tmpA03;void*_tmpA02;(
_tmpA02=0,Cyc_Tcutil_terr(e->loc,((_tmpA03="Cannot consume non-unique paths; do swap instead",
_tag_dyneither(_tmpA03,sizeof(char),49))),_tag_dyneither(_tmpA02,sizeof(void*),0)));}{
void*_tmp5C7=e->r;union Cyc_Absyn_Cnst _tmp5CB;struct _dyneither_ptr _tmp5CC;union
Cyc_Absyn_Cnst _tmp5CE;struct _dyneither_ptr _tmp5CF;_LL29F: {struct Cyc_Absyn_Array_e_struct*
_tmp5C8=(struct Cyc_Absyn_Array_e_struct*)_tmp5C7;if(_tmp5C8->tag != 25)goto _LL2A1;}
_LL2A0: goto _LL2A2;_LL2A1: {struct Cyc_Absyn_Comprehension_e_struct*_tmp5C9=(
struct Cyc_Absyn_Comprehension_e_struct*)_tmp5C7;if(_tmp5C9->tag != 26)goto _LL2A3;}
_LL2A2: goto _LL2A4;_LL2A3: {struct Cyc_Absyn_Const_e_struct*_tmp5CA=(struct Cyc_Absyn_Const_e_struct*)
_tmp5C7;if(_tmp5CA->tag != 0)goto _LL2A5;else{_tmp5CB=_tmp5CA->f1;if((_tmp5CB.Wstring_c).tag
!= 9)goto _LL2A5;_tmp5CC=(struct _dyneither_ptr)(_tmp5CB.Wstring_c).val;}}_LL2A4:
goto _LL2A6;_LL2A5: {struct Cyc_Absyn_Const_e_struct*_tmp5CD=(struct Cyc_Absyn_Const_e_struct*)
...
struct Cyc_Absyn_ArrayType_struct*_tmp5D2=(struct Cyc_Absyn_ArrayType_struct*)
...
_tmp5D8.f2;{struct Cyc_Absyn_Upper_b_struct _tmpA06;struct Cyc_Absyn_Upper_b_struct*
...
e){{void*_tmp5DE=e->r;struct Cyc_Absyn_Exp*_tmp5E0;_LL2AF: {struct Cyc_Absyn_NoInstantiate_e_struct*
_tmp5DF=(struct Cyc_Absyn_NoInstantiate_e_struct*)_tmp5DE;if(_tmp5DF->tag != 11)
goto _LL2B1;else{_tmp5E0=_tmp5DF->f1;}}_LL2B0: Cyc_Tcexp_tcExpNoInst(te,topt,
_tmp5E0);_tmp5E0->topt=(void*)Cyc_Absyn_pointer_expand((void*)_check_null(
_tmp5E0->topt),0);e->topt=_tmp5E0->topt;goto _LL2AE;_LL2B1:;_LL2B2: Cyc_Tcexp_tcExpNoInst(
te,topt,e);e->topt=(void*)Cyc_Absyn_pointer_expand((void*)_check_null(e->topt),0);{
void*_tmp5E1=Cyc_Tcutil_compress((void*)_check_null(e->topt));struct Cyc_Absyn_PtrInfo
_tmp5E3;void*_tmp5E4;struct Cyc_Absyn_Tqual _tmp5E5;struct Cyc_Absyn_PtrAtts _tmp5E6;
void*_tmp5E7;union Cyc_Absyn_Constraint*_tmp5E8;union Cyc_Absyn_Constraint*_tmp5E9;
union Cyc_Absyn_Constraint*_tmp5EA;_LL2B4: {struct Cyc_Absyn_PointerType_struct*
_tmp5E2=(struct Cyc_Absyn_PointerType_struct*)_tmp5E1;if(_tmp5E2->tag != 5)goto
_LL2B6;else{_tmp5E3=_tmp5E2->f1;_tmp5E4=_tmp5E3.elt_typ;_tmp5E5=_tmp5E3.elt_tq;
...
_tmp5F6;_LL2B9: {struct Cyc_Absyn_FnType_struct*_tmp5EC=(struct Cyc_Absyn_FnType_struct*)
...
Cyc_Core_snd,inst);struct Cyc_Absyn_FnType_struct _tmpA0D;struct Cyc_Absyn_FnInfo
_tmpA0C;struct Cyc_Absyn_FnType_struct*_tmpA0B;void*ftyp=Cyc_Tcutil_rsubstitute(
...
_tmp5F6,_tmpA0C)))))))))))))))))),_tmpA0D)))),_tmpA0B)))));struct Cyc_Absyn_PointerType_struct
_tmpA17;struct Cyc_Absyn_PtrAtts _tmpA16;struct Cyc_Absyn_PtrInfo _tmpA15;struct Cyc_Absyn_PointerType_struct*
_tmpA14;struct Cyc_Absyn_PointerType_struct*_tmp5F9=(_tmpA14=_cycalloc(sizeof(*
_tmpA14)),((_tmpA14[0]=((_tmpA17.tag=5,((_tmpA17.f1=((_tmpA15.elt_typ=ftyp,((
_tmpA15.elt_tq=_tmp5E5,((_tmpA15.ptr_atts=((_tmpA16.rgn=_tmp5E7,((_tmpA16.nullable=
...
_tmp5FA=Cyc_Absyn_copy_exp(e);{struct Cyc_Absyn_Instantiate_e_struct _tmpA1A;
struct Cyc_Absyn_Instantiate_e_struct*_tmpA19;e->r=(void*)((_tmpA19=_cycalloc(
sizeof(*_tmpA19)),((_tmpA19[0]=((_tmpA1A.tag=12,((_tmpA1A.f1=_tmp5FA,((_tmpA1A.f2=
ts,_tmpA1A)))))),_tmpA19))));}e->topt=(void*)_tmp5F9;};_pop_region(rgn);}goto
_LL2B8;_LL2BB:;_LL2BC: goto _LL2B8;_LL2B8:;}goto _LL2B3;_LL2B6:;_LL2B7: goto _LL2B3;
_LL2B3:;}goto _LL2AE;_LL2AE:;}return(void*)_check_null(e->topt);}static void Cyc_Tcexp_insert_alias_stmts(
struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Exp*e,struct Cyc_Absyn_Exp*fn_exp,struct
Cyc_List_List*alias_arg_exps){struct _RegionHandle _tmp605=_new_region("r");struct
_RegionHandle*r=& _tmp605;_push_region(r);{struct Cyc_List_List*_tmp606=0;{void*
_tmp607=fn_exp->r;struct Cyc_List_List*_tmp609;_LL2BE: {struct Cyc_Absyn_FnCall_e_struct*
_tmp608=(struct Cyc_Absyn_FnCall_e_struct*)_tmp607;if(_tmp608->tag != 9)goto _LL2C0;
else{_tmp609=_tmp608->f2;}}_LL2BF:{void*_tmp60A=e->r;struct Cyc_List_List*_tmp60C;
_LL2C3: {struct Cyc_Absyn_FnCall_e_struct*_tmp60B=(struct Cyc_Absyn_FnCall_e_struct*)
...
while(_tmp60E != (int)_tmp60D->hd){if(_tmp609 == 0){struct Cyc_Int_pa_struct _tmpA24;
struct Cyc_Int_pa_struct _tmpA23;void*_tmpA22[2];const char*_tmpA21;void*_tmpA20;(
_tmpA20=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)((
struct _dyneither_ptr)((_tmpA24.tag=1,((_tmpA24.f1=(unsigned long)((int)_tmp60D->hd),((
_tmpA23.tag=1,((_tmpA23.f1=(unsigned long)_tmp60E,((_tmpA22[0]=& _tmpA23,((
_tmpA22[1]=& _tmpA24,Cyc_aprintf(((_tmpA21="bad count %d/%d for alias coercion!",
_tag_dyneither(_tmpA21,sizeof(char),36))),_tag_dyneither(_tmpA22,sizeof(void*),2)))))))))))))),
_tag_dyneither(_tmpA20,sizeof(void*),0)));}++ _tmp60E;_tmp609=_tmp609->tl;_tmp60C=((
struct Cyc_List_List*)_check_null(_tmp60C))->tl;}{struct Cyc_Absyn_Decl*_tmp615;
struct Cyc_Absyn_Exp*_tmp616;struct _tuple11 _tmp614=Cyc_Tcutil_insert_alias((
struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp609))->hd,Cyc_Tcutil_copy_type((
void*)_check_null(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(
_tmp60C))->hd)->topt)));_tmp615=_tmp614.f1;_tmp616=_tmp614.f2;_tmp609->hd=(void*)
_tmp616;{struct Cyc_List_List*_tmpA25;_tmp606=((_tmpA25=_region_malloc(r,sizeof(*
_tmpA25)),((_tmpA25->hd=_tmp615,((_tmpA25->tl=_tmp606,_tmpA25))))));}_tmp60D=
_tmp60D->tl;};}goto _LL2C2;}_LL2C5:;_LL2C6: {const char*_tmpA28;void*_tmpA27;(
_tmpA27=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpA28="not a function call!",_tag_dyneither(_tmpA28,sizeof(char),21))),
_tag_dyneither(_tmpA27,sizeof(void*),0)));}_LL2C2:;}goto _LL2BD;_LL2C0:;_LL2C1: {
const char*_tmpA2B;void*_tmpA2A;(_tmpA2A=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpA2B="not a function call!",
_tag_dyneither(_tmpA2B,sizeof(char),21))),_tag_dyneither(_tmpA2A,sizeof(void*),0)));}
_LL2BD:;}while(_tmp606 != 0){struct Cyc_Absyn_Decl*_tmp61C=(struct Cyc_Absyn_Decl*)
_tmp606->hd;fn_exp=Cyc_Absyn_stmt_exp(Cyc_Absyn_decl_stmt(_tmp61C,Cyc_Absyn_exp_stmt(
fn_exp,e->loc),e->loc),e->loc);_tmp606=_tmp606->tl;}e->topt=0;e->r=fn_exp->r;};
_pop_region(r);}static void Cyc_Tcexp_tcExpNoInst(struct Cyc_Tcenv_Tenv*te,void**
topt,struct Cyc_Absyn_Exp*e){unsigned int loc=e->loc;void*t;{void*_tmp61D=e->r;
struct Cyc_Absyn_Exp*_tmp61F;struct Cyc_Absyn_Exp*_tmp621;struct Cyc_List_List*
...
_LL2C8: {struct Cyc_Absyn_NoInstantiate_e_struct*_tmp61E=(struct Cyc_Absyn_NoInstantiate_e_struct*)
_tmp61D;if(_tmp61E->tag != 11)goto _LL2CA;else{_tmp61F=_tmp61E->f1;}}_LL2C9: Cyc_Tcexp_tcExpNoInst(
te,0,_tmp61F);return;_LL2CA:{struct Cyc_Absyn_FnCall_e_struct*_tmp620=(struct Cyc_Absyn_FnCall_e_struct*)
_tmp61D;if(_tmp620->tag != 9)goto _LL2CC;else{_tmp621=_tmp620->f1;_tmp622=_tmp620->f2;
_tmp623=_tmp620->f3;_tmp624=(struct Cyc_Absyn_VarargCallInfo**)& _tmp620->f3;
_tmp625=_tmp620->f4;_tmp626=(int*)& _tmp620->f4;}}if(!(!(*_tmp626)))goto _LL2CC;
_LL2CB: Cyc_Tcexp_resolve_unknown_fn(te,e,_tmp621,_tmp622);*_tmp626=1;Cyc_Tcexp_tcExpNoInst(
te,topt,e);return;_LL2CC: {struct Cyc_Absyn_UnresolvedMem_e_struct*_tmp627=(
struct Cyc_Absyn_UnresolvedMem_e_struct*)_tmp61D;if(_tmp627->tag != 34)goto _LL2CE;
else{_tmp628=_tmp627->f1;_tmp629=_tmp627->f2;}}_LL2CD: Cyc_Tcexp_resolve_unresolved_mem(
te,loc,topt,e,_tmp629);Cyc_Tcexp_tcExpNoInst(te,topt,e);return;_LL2CE: {struct
Cyc_Absyn_Const_e_struct*_tmp62A=(struct Cyc_Absyn_Const_e_struct*)_tmp61D;if(
_tmp62A->tag != 0)goto _LL2D0;else{_tmp62B=_tmp62A->f1;_tmp62C=(union Cyc_Absyn_Cnst*)&
_tmp62A->f1;}}_LL2CF: t=Cyc_Tcexp_tcConst(te,loc,topt,(union Cyc_Absyn_Cnst*)
_tmp62C,e);goto _LL2C7;_LL2D0: {struct Cyc_Absyn_Var_e_struct*_tmp62D=(struct Cyc_Absyn_Var_e_struct*)
...
loc,topt,e,_tmp62E,(void**)_tmp630);goto _LL2C7;_LL2D2: {struct Cyc_Absyn_Primop_e_struct*
_tmp631=(struct Cyc_Absyn_Primop_e_struct*)_tmp61D;if(_tmp631->tag != 2)goto _LL2D4;
else{_tmp632=_tmp631->f1;_tmp633=_tmp631->f2;}}_LL2D3: t=Cyc_Tcexp_tcPrimop(te,
loc,topt,_tmp632,_tmp633);goto _LL2C7;_LL2D4: {struct Cyc_Absyn_Increment_e_struct*
_tmp634=(struct Cyc_Absyn_Increment_e_struct*)_tmp61D;if(_tmp634->tag != 4)goto
_LL2D6;else{_tmp635=_tmp634->f1;_tmp636=_tmp634->f2;}}_LL2D5: t=Cyc_Tcexp_tcIncrement(
te,loc,topt,_tmp635,_tmp636);goto _LL2C7;_LL2D6: {struct Cyc_Absyn_AssignOp_e_struct*
_tmp637=(struct Cyc_Absyn_AssignOp_e_struct*)_tmp61D;if(_tmp637->tag != 3)goto
_LL2D8;else{_tmp638=_tmp637->f1;_tmp639=_tmp637->f2;_tmp63A=_tmp637->f3;}}_LL2D7:
t=Cyc_Tcexp_tcAssignOp(te,loc,topt,_tmp638,_tmp639,_tmp63A);goto _LL2C7;_LL2D8: {
struct Cyc_Absyn_Conditional_e_struct*_tmp63B=(struct Cyc_Absyn_Conditional_e_struct*)
...
_tmp63D,_tmp63E);goto _LL2C7;_LL2DA: {struct Cyc_Absyn_And_e_struct*_tmp63F=(
struct Cyc_Absyn_And_e_struct*)_tmp61D;if(_tmp63F->tag != 6)goto _LL2DC;else{
_tmp640=_tmp63F->f1;_tmp641=_tmp63F->f2;}}_LL2DB: t=Cyc_Tcexp_tcAnd(te,loc,
_tmp640,_tmp641);goto _LL2C7;_LL2DC: {struct Cyc_Absyn_Or_e_struct*_tmp642=(struct
Cyc_Absyn_Or_e_struct*)_tmp61D;if(_tmp642->tag != 7)goto _LL2DE;else{_tmp643=
_tmp642->f1;_tmp644=_tmp642->f2;}}_LL2DD: t=Cyc_Tcexp_tcOr(te,loc,_tmp643,_tmp644);
goto _LL2C7;_LL2DE: {struct Cyc_Absyn_SeqExp_e_struct*_tmp645=(struct Cyc_Absyn_SeqExp_e_struct*)
_tmp61D;if(_tmp645->tag != 8)goto _LL2E0;else{_tmp646=_tmp645->f1;_tmp647=_tmp645->f2;}}
_LL2DF: t=Cyc_Tcexp_tcSeqExp(te,loc,topt,_tmp646,_tmp647);goto _LL2C7;_LL2E0: {
struct Cyc_Absyn_FnCall_e_struct*_tmp648=(struct Cyc_Absyn_FnCall_e_struct*)
_tmp61D;if(_tmp648->tag != 9)goto _LL2E2;else{_tmp649=_tmp648->f1;_tmp64A=_tmp648->f2;
_tmp64B=_tmp648->f3;_tmp64C=(struct Cyc_Absyn_VarargCallInfo**)& _tmp648->f3;}}
_LL2E1: {struct Cyc_List_List*alias_arg_exps=0;int ok=1;struct Cyc_Absyn_Exp*fn_exp;{
struct _handler_cons _tmp6B4;_push_handler(& _tmp6B4);{int _tmp6B6=0;if(setjmp(
_tmp6B4.handler))_tmp6B6=1;if(!_tmp6B6){fn_exp=Cyc_Tcutil_deep_copy_exp(e);;
_pop_handler();}else{void*_tmp6B5=(void*)_exn_thrown;void*_tmp6B8=_tmp6B5;struct
_dyneither_ptr _tmp6BA;_LL319: {struct Cyc_Core_Failure_struct*_tmp6B9=(struct Cyc_Core_Failure_struct*)
...
struct Cyc_Absyn_Throw_e_struct*_tmp64D=(struct Cyc_Absyn_Throw_e_struct*)_tmp61D;
if(_tmp64D->tag != 10)goto _LL2E4;else{_tmp64E=_tmp64D->f1;}}_LL2E3: t=Cyc_Tcexp_tcThrow(
te,loc,topt,_tmp64E);goto _LL2C7;_LL2E4: {struct Cyc_Absyn_Instantiate_e_struct*
_tmp64F=(struct Cyc_Absyn_Instantiate_e_struct*)_tmp61D;if(_tmp64F->tag != 12)goto
_LL2E6;else{_tmp650=_tmp64F->f1;_tmp651=_tmp64F->f2;}}_LL2E5: t=Cyc_Tcexp_tcInstantiate(
te,loc,topt,_tmp650,_tmp651);goto _LL2C7;_LL2E6: {struct Cyc_Absyn_Cast_e_struct*
_tmp652=(struct Cyc_Absyn_Cast_e_struct*)_tmp61D;if(_tmp652->tag != 13)goto _LL2E8;
else{_tmp653=(void*)_tmp652->f1;_tmp654=_tmp652->f2;_tmp655=_tmp652->f4;_tmp656=(
enum Cyc_Absyn_Coercion*)& _tmp652->f4;}}_LL2E7: t=Cyc_Tcexp_tcCast(te,loc,topt,
_tmp653,_tmp654,(enum Cyc_Absyn_Coercion*)_tmp656);goto _LL2C7;_LL2E8: {struct Cyc_Absyn_Address_e_struct*
_tmp657=(struct Cyc_Absyn_Address_e_struct*)_tmp61D;if(_tmp657->tag != 14)goto
_LL2EA;else{_tmp658=_tmp657->f1;}}_LL2E9: t=Cyc_Tcexp_tcAddress(te,loc,e,topt,
_tmp658);goto _LL2C7;_LL2EA: {struct Cyc_Absyn_New_e_struct*_tmp659=(struct Cyc_Absyn_New_e_struct*)
_tmp61D;if(_tmp659->tag != 15)goto _LL2EC;else{_tmp65A=_tmp659->f1;_tmp65B=(struct
Cyc_Absyn_Exp**)& _tmp659->f1;_tmp65C=_tmp659->f2;}}_LL2EB: t=Cyc_Tcexp_tcNew(te,
loc,topt,_tmp65B,e,_tmp65C);goto _LL2C7;_LL2EC: {struct Cyc_Absyn_Sizeofexp_e_struct*
_tmp65D=(struct Cyc_Absyn_Sizeofexp_e_struct*)_tmp61D;if(_tmp65D->tag != 17)goto
_LL2EE;else{_tmp65E=_tmp65D->f1;}}_LL2ED: {void*_tmp6BB=Cyc_Tcexp_tcExpNoPromote(
te,0,_tmp65E);t=Cyc_Tcexp_tcSizeof(te,loc,topt,_tmp6BB);goto _LL2C7;}_LL2EE: {
struct Cyc_Absyn_Sizeoftyp_e_struct*_tmp65F=(struct Cyc_Absyn_Sizeoftyp_e_struct*)
_tmp61D;if(_tmp65F->tag != 16)goto _LL2F0;else{_tmp660=(void*)_tmp65F->f1;}}_LL2EF:
t=Cyc_Tcexp_tcSizeof(te,loc,topt,_tmp660);goto _LL2C7;_LL2F0: {struct Cyc_Absyn_Offsetof_e_struct*
_tmp661=(struct Cyc_Absyn_Offsetof_e_struct*)_tmp61D;if(_tmp661->tag != 18)goto
_LL2F2;else{_tmp662=(void*)_tmp661->f1;_tmp663=(void*)_tmp661->f2;}}_LL2F1: t=Cyc_Tcexp_tcOffsetof(
te,loc,topt,_tmp662,_tmp663);goto _LL2C7;_LL2F2: {struct Cyc_Absyn_Deref_e_struct*
_tmp664=(struct Cyc_Absyn_Deref_e_struct*)_tmp61D;if(_tmp664->tag != 19)goto _LL2F4;
else{_tmp665=_tmp664->f1;}}_LL2F3: t=Cyc_Tcexp_tcDeref(te,loc,topt,_tmp665);goto
_LL2C7;_LL2F4: {struct Cyc_Absyn_AggrMember_e_struct*_tmp666=(struct Cyc_Absyn_AggrMember_e_struct*)
_tmp61D;if(_tmp666->tag != 20)goto _LL2F6;else{_tmp667=_tmp666->f1;_tmp668=_tmp666->f2;
_tmp669=_tmp666->f3;_tmp66A=(int*)& _tmp666->f3;_tmp66B=_tmp666->f4;_tmp66C=(int*)&
_tmp666->f4;}}_LL2F5: t=Cyc_Tcexp_tcAggrMember(te,loc,topt,e,_tmp667,_tmp668,
_tmp66A,_tmp66C);goto _LL2C7;_LL2F6: {struct Cyc_Absyn_AggrArrow_e_struct*_tmp66D=(
struct Cyc_Absyn_AggrArrow_e_struct*)_tmp61D;if(_tmp66D->tag != 21)goto _LL2F8;
else{_tmp66E=_tmp66D->f1;_tmp66F=_tmp66D->f2;_tmp670=_tmp66D->f3;_tmp671=(int*)&
_tmp66D->f3;_tmp672=_tmp66D->f4;_tmp673=(int*)& _tmp66D->f4;}}_LL2F7: t=Cyc_Tcexp_tcAggrArrow(
te,loc,topt,_tmp66E,_tmp66F,_tmp671,_tmp673);goto _LL2C7;_LL2F8: {struct Cyc_Absyn_Subscript_e_struct*
_tmp674=(struct Cyc_Absyn_Subscript_e_struct*)_tmp61D;if(_tmp674->tag != 22)goto
_LL2FA;else{_tmp675=_tmp674->f1;_tmp676=_tmp674->f2;}}_LL2F9: t=Cyc_Tcexp_tcSubscript(
te,loc,topt,_tmp675,_tmp676);goto _LL2C7;_LL2FA: {struct Cyc_Absyn_Tuple_e_struct*
_tmp677=(struct Cyc_Absyn_Tuple_e_struct*)_tmp61D;if(_tmp677->tag != 23)goto _LL2FC;
else{_tmp678=_tmp677->f1;}}_LL2FB: t=Cyc_Tcexp_tcTuple(te,loc,topt,_tmp678);goto
_LL2C7;_LL2FC: {struct Cyc_Absyn_CompoundLit_e_struct*_tmp679=(struct Cyc_Absyn_CompoundLit_e_struct*)
_tmp61D;if(_tmp679->tag != 24)goto _LL2FE;else{_tmp67A=_tmp679->f1;_tmp67B=_tmp679->f2;}}
_LL2FD: t=Cyc_Tcexp_tcCompoundLit(te,loc,topt,_tmp67A,_tmp67B);goto _LL2C7;_LL2FE: {
struct Cyc_Absyn_Array_e_struct*_tmp67C=(struct Cyc_Absyn_Array_e_struct*)_tmp61D;
if(_tmp67C->tag != 25)goto _LL300;else{_tmp67D=_tmp67C->f1;}}_LL2FF: {void**
elt_topt=0;struct Cyc_Absyn_Tqual*elt_tqopt=0;int zero_term=0;if(topt != 0){void*
_tmp6BC=Cyc_Tcutil_compress(*topt);struct Cyc_Absyn_ArrayInfo _tmp6BE;void*_tmp6BF;
void**_tmp6C0;struct Cyc_Absyn_Tqual _tmp6C1;struct Cyc_Absyn_Tqual*_tmp6C2;union
Cyc_Absyn_Constraint*_tmp6C3;_LL31E: {struct Cyc_Absyn_ArrayType_struct*_tmp6BD=(
struct Cyc_Absyn_ArrayType_struct*)_tmp6BC;if(_tmp6BD->tag != 8)goto _LL320;else{
_tmp6BE=_tmp6BD->f1;_tmp6BF=_tmp6BE.elt_type;_tmp6C0=(void**)&(_tmp6BD->f1).elt_type;
_tmp6C1=_tmp6BE.tq;_tmp6C2=(struct Cyc_Absyn_Tqual*)&(_tmp6BD->f1).tq;_tmp6C3=
_tmp6BE.zero_term;}}_LL31F: elt_topt=(void**)_tmp6C0;elt_tqopt=(struct Cyc_Absyn_Tqual*)
_tmp6C2;zero_term=((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(
0,_tmp6C3);goto _LL31D;_LL320:;_LL321: goto _LL31D;_LL31D:;}t=Cyc_Tcexp_tcArray(te,
loc,elt_topt,elt_tqopt,zero_term,_tmp67D);goto _LL2C7;}_LL300: {struct Cyc_Absyn_StmtExp_e_struct*
_tmp67E=(struct Cyc_Absyn_StmtExp_e_struct*)_tmp61D;if(_tmp67E->tag != 35)goto
_LL302;else{_tmp67F=_tmp67E->f1;}}_LL301: t=Cyc_Tcexp_tcStmtExp(te,loc,topt,
_tmp67F);goto _LL2C7;_LL302: {struct Cyc_Absyn_Comprehension_e_struct*_tmp680=(
struct Cyc_Absyn_Comprehension_e_struct*)_tmp61D;if(_tmp680->tag != 26)goto _LL304;
else{_tmp681=_tmp680->f1;_tmp682=_tmp680->f2;_tmp683=_tmp680->f3;_tmp684=_tmp680->f4;
_tmp685=(int*)& _tmp680->f4;}}_LL303: t=Cyc_Tcexp_tcComprehension(te,loc,topt,
_tmp681,_tmp682,_tmp683,_tmp685);goto _LL2C7;_LL304: {struct Cyc_Absyn_Aggregate_e_struct*
_tmp686=(struct Cyc_Absyn_Aggregate_e_struct*)_tmp61D;if(_tmp686->tag != 27)goto
...
_LL306: {struct Cyc_Absyn_AnonStruct_e_struct*_tmp68E=(struct Cyc_Absyn_AnonStruct_e_struct*)
...
_LL308: {struct Cyc_Absyn_Datatype_e_struct*_tmp691=(struct Cyc_Absyn_Datatype_e_struct*)
...
_tmp693,_tmp694);goto _LL2C7;_LL30A: {struct Cyc_Absyn_Enum_e_struct*_tmp695=(
struct Cyc_Absyn_Enum_e_struct*)_tmp61D;if(_tmp695->tag != 30)goto _LL30C;else{
_tmp696=_tmp695->f1;_tmp697=(struct _tuple1**)& _tmp695->f1;_tmp698=_tmp695->f2;
_tmp699=_tmp695->f3;}}_LL30B:*_tmp697=((struct Cyc_Absyn_Enumfield*)_check_null(
_tmp699))->name;{struct Cyc_Absyn_EnumType_struct _tmpA2E;struct Cyc_Absyn_EnumType_struct*
_tmpA2D;t=(void*)((_tmpA2D=_cycalloc(sizeof(*_tmpA2D)),((_tmpA2D[0]=((_tmpA2E.tag=
13,((_tmpA2E.f1=((struct Cyc_Absyn_Enumdecl*)_check_null(_tmp698))->name,((
_tmpA2E.f2=_tmp698,_tmpA2E)))))),_tmpA2D))));}goto _LL2C7;_LL30C: {struct Cyc_Absyn_AnonEnum_e_struct*
_tmp69A=(struct Cyc_Absyn_AnonEnum_e_struct*)_tmp61D;if(_tmp69A->tag != 31)goto
...
_check_null(_tmp69E))->name;t=_tmp69D;goto _LL2C7;_LL30E: {struct Cyc_Absyn_Malloc_e_struct*
_tmp69F=(struct Cyc_Absyn_Malloc_e_struct*)_tmp61D;if(_tmp69F->tag != 32)goto
_LL310;else{_tmp6A0=_tmp69F->f1;_tmp6A1=_tmp6A0.is_calloc;_tmp6A2=(int*)&(
...
_LL2C7;_LL310: {struct Cyc_Absyn_Swap_e_struct*_tmp6AB=(struct Cyc_Absyn_Swap_e_struct*)
...
struct Cyc_Absyn_Tagcheck_e_struct*_tmp6AE=(struct Cyc_Absyn_Tagcheck_e_struct*)
...
struct Cyc_Absyn_Valueof_e_struct*_tmp6B1=(struct Cyc_Absyn_Valueof_e_struct*)
...
goto _LL2C7;_LL316: {struct Cyc_Absyn_Asm_e_struct*_tmp6B3=(struct Cyc_Absyn_Asm_e_struct*)
_tmp61D;if(_tmp6B3->tag != 38)goto _LL2C7;}_LL317:{const char*_tmpA34;void*_tmpA33;(
_tmpA33=0,Cyc_Tcutil_terr(e->loc,((_tmpA34="asm expressions cannot occur within Cyclone code.",
_tag_dyneither(_tmpA34,sizeof(char),50))),_tag_dyneither(_tmpA33,sizeof(void*),0)));}
t=Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te));_LL2C7:;}e->topt=(void*)
t;}
