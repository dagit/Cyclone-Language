...
# 365
void*Cyc_Tcutil_any_bounds(struct Cyc_Tcenv_Tenv**te);struct _tuple15{unsigned f1;int f2;};
# 28 "evexp.h"
...
void Cyc_Tcexp_tcTest(struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Exp*e,struct _fat_ptr msg_part);struct Cyc_Hashtable_Table;struct Cyc_JumpAnalysis_Jump_Anal_Result{struct Cyc_Hashtable_Table*pop_tables;struct Cyc_Hashtable_Table*succ_tables;struct Cyc_Hashtable_Table*pat_pop_tables;};
# 46 "jump_analysis.h"
...
({unsigned _tmp676=loc;struct Cyc_Tcenv_Tenv*_tmp675=te;struct Cyc_List_List*_tmp674=Cyc_Tcenv_lookup_type_vars(te);struct Cyc_Absyn_Kind*_tmp673=k;Cyc_Tcutil_check_type(_tmp676,_tmp675,_tmp674,_tmp673,1,1,(void*)ts->hd);});
...
# 1330
({unsigned _tmp69A=loc;struct Cyc_Tcenv_Tenv*_tmp699=te;struct Cyc_List_List*_tmp698=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tcutil_check_type(_tmp69A,_tmp699,_tmp698,& Cyc_Tcutil_tmk,1,0,t);});
Cyc_Tcutil_check_no_qual(loc,t);
...
# 1357
({unsigned _tmp6A0=loc;struct Cyc_Tcenv_Tenv*_tmp69F=te;struct Cyc_List_List*_tmp69E=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tcutil_check_type(_tmp6A0,_tmp69F,_tmp69E,& Cyc_Tcutil_tmk,1,0,t_orig);});
...
# 1704
return({void*_tmp2FE=0U;({struct Cyc_Tcenv_Tenv*_tmp731=te;unsigned _tmp730=loc;void**_tmp72F=topt;struct _fat_ptr _tmp72E=({const char*_tmp2FF="tcCompoundLit";_tag_fat(_tmp2FF,sizeof(char),14U);});Cyc_Tcexp_expr_err(_tmp731,_tmp730,_tmp72F,_tmp72E,_tag_fat(_tmp2FE,sizeof(void*),0U));});});}struct _tuple18{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
# 1714 "tcexp.cyc"
...
# 1882
 goto _LL5;}_LL5:;}
# 1885
({unsigned _tmp757=loc;struct Cyc_Tcenv_Tenv*_tmp756=te;struct Cyc_List_List*_tmp755=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tcutil_check_type(_tmp757,_tmp756,_tmp755,& Cyc_Tcutil_tmk,1,1,t);});
...
# 1989
({unsigned _tmp76A=loc;struct Cyc_Tcenv_Tenv*_tmp769=te2;struct Cyc_List_List*_tmp768=Cyc_Tcenv_lookup_type_vars(te2);Cyc_Tcutil_check_type(_tmp76A,_tmp769,_tmp768,& Cyc_Tcutil_ak,1,0,(void*)_tmp372->hd);});
...
# 2001
struct Cyc_List_List*fields=
((struct Cyc_List_List*(*)(struct _RegionHandle*rgn,unsigned loc,struct Cyc_List_List*des,enum Cyc_Absyn_AggrKind,struct Cyc_List_List*fields))Cyc_Tcutil_resolve_aggregate_designators)(Cyc_Core_heap_region,loc,args,ad->kind,((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->fields);
...
struct Cyc_List_List*fields=
((struct Cyc_List_List*(*)(struct _RegionHandle*rgn,unsigned loc,struct Cyc_List_List*des,enum Cyc_Absyn_AggrKind,struct Cyc_List_List*fields))Cyc_Tcutil_resolve_aggregate_designators)(Cyc_Core_heap_region,loc,args,Cyc_Absyn_StructA,_tmp397);
for(0;fields != 0;fields=fields->tl){
int bogus=0;
...
({unsigned _tmp799=loc;struct Cyc_Tcenv_Tenv*_tmp798=te;struct Cyc_List_List*_tmp797=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tcutil_check_type(_tmp799,_tmp798,_tmp797,& Cyc_Tcutil_tmk,1,0,elt_type);});
