...
# 345
({struct Cyc_List_List*_tmp58D=type_getter(te,(struct _dyneither_ptr)_tmp60,isCproto,fmt->loc);desc_types=_tmp58D;});goto _LL0;}else{goto _LL5;}}else{goto _LL5;}default: _LL5: _LL6:
# 349
 if(opt_args != 0){
...
# 1027
 Cyc_Tcexp_check_format_args(_tmp166,_tmp184,fmt_args,_tmp18B - 1,alias_arg_exps,_tmp1BC,Cyc_Formatstr_get_format_types);
# 1030
goto _LLF;}else{_LL12: _LL13:
# 1032
 Cyc_Tcexp_check_format_args(_tmp166,_tmp184,fmt_args,_tmp18B - 1,alias_arg_exps,_tmp1BC,Cyc_Formatstr_get_scanf_types);
# 1035
goto _LLF;}_LLF:;};}
# 1017
...
# 1289
({void*_tmp210=0U;({unsigned int _tmp6AB=e->loc;struct _dyneither_ptr _tmp6AA=({const char*_tmp211="cannot take the address of a @tagged union member";_tag_dyneither(_tmp211,sizeof(char),50U);});Cyc_Tcutil_terr(_tmp6AB,_tmp6AA,_tag_dyneither(_tmp210,sizeof(void*),0U));});});goto _LLF;}else{goto _LL14;}default: _LL14: _LL15:
 goto _LLF;}_LLF:;}{
# 1294
