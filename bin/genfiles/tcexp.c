...
e){struct _tuple17*_tmp699;return(_tmp699=_cycalloc(sizeof(*_tmp699)),((_tmp699->f1=
...
_tmp85 == 0))goto _LL5F;_LL5E:{struct Cyc_Absyn_Const_e_struct _tmp6CF;struct Cyc_Absyn_Const_e_struct*
...
_tmp9B=Cyc_Tcenv_lookup_type_vars(te);{struct Cyc_Absyn_PointerType_struct _tmp6E2;
...
_tmp6DF=_cycalloc(sizeof(*_tmp6DF)),((_tmp6DF->v=_tmp9B,_tmp6DF))))),((_tmp6DE.elt_tq=
...
_tmp6E0->v=_tmp9B,_tmp6E0))))),((_tmp6E1.nullable=Cyc_Absyn_true_conref,((
...
_tmp6E4;struct Cyc_Absyn_ValueofType_struct*_tmpA2=(_tmp6E4=_cycalloc(sizeof(*
_tmp6E4)),((_tmp6E4[0]=((_tmp6E5.tag=19,((_tmp6E5.f1=Cyc_Absyn_uint_exp((
unsigned int)_tmp85,0),_tmp6E5)))),_tmp6E4)));if(!Cyc_Tcutil_unify(_tmp98,(void*)
_tmpA2)){{const char*_tmp6EA;void*_tmp6E9[2];struct Cyc_String_pa_struct _tmp6E8;
...
_tmp98)),((_tmp6E9[0]=& _tmp6E8,((_tmp6E9[1]=& _tmp6E7,Cyc_Tcutil_terr(loc,((
...
void*)((_tmp6EC=_cycalloc(sizeof(*_tmp6EC)),((_tmp6EC[0]=((_tmp6ED.tag=20,((
_tmp6ED.f1=(void*)((void*)_tmpA2),_tmp6ED)))),_tmp6EC))));}goto _LL54;}_LL61:;
...
sizeof(*_tmp706)),((_tmp706->v=_tmpB7,_tmp706))))),((_tmp705.elt_tq=Cyc_Absyn_empty_tqual(
0),((_tmp705.ptr_atts=((_tmp708.rgn=Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_trko,((
_tmp707=_cycalloc(sizeof(*_tmp707)),((_tmp707->v=_tmpB7,_tmp707))))),((_tmp708.nullable=
...
_tmpBE;if(_tmpBF->tag != 0)goto _LL71;}_LL70: {const char*_tmp70D;void*_tmp70C[1];
...
else{_tmpC9=_tmpC8->f1;}}_LL7A:{union Cyc_Absyn_Nmspace _tmp70E;(*q).f1=(((_tmp70E.Loc_n).val=
0,(((_tmp70E.Loc_n).tag=4,_tmp70E))));}if(te->allow_valueof){void*_tmpCE=Cyc_Tcutil_compress(
...
_tmpCF->f1;}}_LL7D:{struct Cyc_Absyn_Valueof_e_struct _tmp711;struct Cyc_Absyn_Valueof_e_struct*
_tmp710;e->r=(void*)((_tmp710=_cycalloc(sizeof(*_tmp710)),((_tmp710[0]=((_tmp711.tag=
39,((_tmp711.f1=(void*)_tmpD0,_tmp711)))),_tmp710))));}goto _LL7B;_LL7E:;_LL7F:
...
_tmpDE->hd)->loc,((_tmp714="Cannot consume non-unique paths; do swap instead",
...
_tmpE8,t) && !Cyc_Tcutil_is_noalias_path(_tmpE8,e)){const char*_tmp71D;void*
_tmp71C;(_tmp71C=0,Cyc_Tcutil_terr(((struct Cyc_Absyn_Exp*)_tmpE2->hd)->loc,((
...
_tag_dyneither(_tmp71F,sizeof(void*),0)));}if(_tmpE2 != 0){const char*_tmp723;void*
_tmp722;(_tmp722=0,Cyc_Tcutil_terr(((struct Cyc_Absyn_Exp*)_tmpE2->hd)->loc,((
...
char),27))),_tag_dyneither(_tmp74A,sizeof(void*),1)))))));}{void*_tmp120=((void*(*)(
...
_tmp126=(_tmp755=_cycalloc(sizeof(*_tmp755)),((_tmp755[0]=((_tmp758.tag=5,((
_tmp758.f1=((_tmp756.elt_typ=_tmp112,((_tmp756.elt_tq=_tmp113,((_tmp756.ptr_atts=((
_tmp757.rgn=_tmp115,((_tmp757.nullable=Cyc_Absyn_true_conref,((_tmp757.bounds=
Cyc_Absyn_bounds_dyneither_conref,((_tmp757.zero_term=_tmp118,((_tmp757.ptrloc=0,
...
_tmp138=(_tmp769.f1=Cyc_Tcutil_compress(t1),((_tmp769.f2=Cyc_Tcutil_compress(t2),
_tmp769)));void*_tmp139;struct Cyc_Absyn_PtrInfo _tmp13B;void*_tmp13C;void*_tmp13D;
...
struct _tuple0 _tmp14A=(_tmp76F.f1=t1,((_tmp76F.f2=t2,_tmp76F)));void*_tmp14B;void*
...
_tmp16F->tq).real_const){{const char*_tmp781;void*_tmp780[1];struct Cyc_String_pa_struct
_tmp77F;(_tmp77F.tag=0,((_tmp77F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
_tmp16F->name),((_tmp780[0]=& _tmp77F,Cyc_Tcutil_terr(loc,((_tmp781="attempt to over-write an aggregate with const member %s",
...
_tmp176.real_const){{const char*_tmp785;void*_tmp784[1];struct Cyc_String_pa_struct
_tmp783;(_tmp783.tag=0,((_tmp783.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp168->name)),((_tmp784[0]=& _tmp783,Cyc_Tcutil_terr(
...
_tmp16C=_tmp16A.tq;}}_LLD0: if(_tmp16C.real_const){{const char*_tmp788;void*
...
_tmp17E.f2;if(_tmp17F.real_const){{const char*_tmp78B;void*_tmp78A;(_tmp78A=0,Cyc_Tcutil_terr(
...
_tmp1AE=_tmp1AC.f2;if(!_tmp1AE){{const char*_tmp78E;void*_tmp78D;(_tmp78D=0,Cyc_Tcutil_terr(
...
e3){struct _tuple0*_tmp1E2;int _tmp1E3;const char*_tmp7A0;struct Cyc_Tcexp_TestEnv
_tmp1E1=Cyc_Tcexp_tcTest(te,e1,((_tmp7A0="conditional expression",_tag_dyneither(
_tmp7A0,sizeof(char),23))));_tmp1E2=_tmp1E1.eq;_tmp1E3=_tmp1E1.isTrue;Cyc_Tcexp_tcExp(
...
struct Cyc_List_List _tmp1E4=(_tmp7A1.hd=e3,((_tmp7A1.tl=0,_tmp7A1)));struct Cyc_List_List
_tmp7A2;struct Cyc_List_List _tmp1E5=(_tmp7A2.hd=e2,((_tmp7A2.tl=(struct Cyc_List_List*)&
_tmp1E4,_tmp7A2)));if(!Cyc_Tcutil_coerce_list(te,t,(struct Cyc_List_List*)&
_tmp1E5)){{const char*_tmp7A7;void*_tmp7A6[2];struct Cyc_String_pa_struct _tmp7A5;
...
_tmp1F9,t2) && !Cyc_Tcutil_is_noalias_path(_tmp1F9,e2)){const char*_tmp7B7;void*
...
Cyc_String_pa_struct _tmp7BA;struct Cyc_String_pa_struct _tmp7B9;void*_tmp1FC=(
...
_tmp202) && Cyc_Tcutil_coerceable(t1))){const char*_tmp7C1;void*_tmp7C0[2];struct
Cyc_String_pa_struct _tmp7BF;struct Cyc_String_pa_struct _tmp7BE;void*_tmp203=(
...
e1);if(!Cyc_Tcutil_coerce_arg(_tmp220,e1,t2,& alias_coercion)){{const char*_tmp7CB;
...
_tmp7CC=_cycalloc(sizeof(*_tmp7CC)),((_tmp7CC->hd=(void*)_tmp21E,((_tmp7CC->tl=*
alias_arg_exps,_tmp7CC))))));}if(Cyc_Tcutil_is_noalias_pointer_or_aggr(_tmp21F,
t2) && !Cyc_Tcutil_is_noalias_path(_tmp21F,e1)){const char*_tmp7CF;void*_tmp7CE;(
...
fmt_args;if(_tmp242 == 0)fmt_args=0;else{struct Cyc_Core_Opt*_tmp7D0;fmt_args=((
_tmp7D0=_cycalloc(sizeof(*_tmp7D0)),((_tmp7D0->v=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x,int i))Cyc_List_nth_tail)(args,_tmp242 - 1),_tmp7D0))));}
...
_LL12C:;}}if(_tmp232 != 0){const char*_tmp7D6;void*_tmp7D5;(_tmp7D5=0,Cyc_Tcutil_terr(
loc,((_tmp7D6="too few arguments for function",_tag_dyneither(_tmp7D6,sizeof(
char),31))),_tag_dyneither(_tmp7D5,sizeof(void*),0)));}else{if((_tmp21D != 0  || 
...
_tmp252.type;_tmp254=_tmp252.inject;{struct Cyc_Absyn_VarargCallInfo*_tmp7DA;
struct Cyc_Absyn_VarargCallInfo*_tmp255=(_tmp7DA=_cycalloc(sizeof(*_tmp7DA)),((
_tmp7DA->num_varargs=0,((_tmp7DA->injectors=0,((_tmp7DA->vai=(struct Cyc_Absyn_VarargInfo*)
_tmp234,_tmp7DA)))))));*vararg_call_info=(struct Cyc_Absyn_VarargCallInfo*)
...
_tmp220,e1,_tmp253,& alias_coercion)){{const char*_tmp7DF;void*_tmp7DE[2];struct
...
_tmp253)),((_tmp7DE[0]=& _tmp7DD,((_tmp7DE[1]=& _tmp7DC,Cyc_Tcutil_terr(loc,((
...
_tmp7E0->hd=(void*)_tmp21E,((_tmp7E0->tl=*alias_arg_exps,_tmp7E0))))));}if(Cyc_Tcutil_is_noalias_pointer_or_aggr(
_tmp21F,_tmp253) && !Cyc_Tcutil_is_noalias_path(_tmp21F,e1)){const char*_tmp7E3;
...
_tmp253)),((_tmp7E6[0]=& _tmp7E5,Cyc_Tcutil_terr(loc,((_tmp7E7="can't inject into abstract datatype %s",
...
_tmp220))){const char*_tmp7EC;void*_tmp7EB[2];struct Cyc_String_pa_struct _tmp7EA;
...
_tmp220))),((_tmp7EA.tag=0,((_tmp7EA.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_typ2string(_tmp253)),((_tmp7EB[0]=& _tmp7EA,((_tmp7EB[
...
_tmp26C,e1)){const char*_tmp7EF;void*_tmp7EE;(_tmp7EE=0,Cyc_Tcutil_terr(e1->loc,((
...
_tmp253),_tmp26C,_tmp26D,fields);if(_tmp270 != 0){struct Cyc_List_List*_tmp7F0;
_tmp255->injectors=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*
y))Cyc_List_append)(_tmp255->injectors,((_tmp7F0=_cycalloc(sizeof(*_tmp7F0)),((
_tmp7F0->hd=(struct Cyc_Absyn_Datatypefield*)_tmp270,((_tmp7F0->tl=0,_tmp7F0)))))));}};};}}
...
_tmp220,loc,_tmp235);return _tmp231;};_LL12A:;_LL12B: {const char*_tmp7F6;void*
_tmp7F5;return(_tmp7F5=0,Cyc_Tcexp_expr_err(_tmp220,loc,topt,((_tmp7F6="expected pointer to function",
...
_tmp220,loc,topt,((_tmp7F9="expected pointer to function",_tag_dyneither(_tmp7F9,
...
struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp279)),((_tmp7FD[0]=& _tmp7FC,((
...
_tmp294,sizeof(*_tmp800)),((_tmp800->hd=((_tmp801=_region_malloc(_tmp294,sizeof(*
_tmp801)),((_tmp801->f1=(struct Cyc_Absyn_Tvar*)_tmp28B->hd,((_tmp801->f2=(void*)
...
new_fn_typ=Cyc_Tcutil_rsubstitute(_tmp294,instantiation,(void*)((_tmp808=
_cycalloc(sizeof(*_tmp808)),((_tmp808[0]=((_tmp80A.tag=10,((_tmp80A.f1=((_tmp809.tvars=
_tmp28B,((_tmp809.effect=_tmp28C,((_tmp809.ret_tqual=_tmp28D,((_tmp809.ret_typ=
_tmp28E,((_tmp809.args=_tmp28F,((_tmp809.c_varargs=_tmp290,((_tmp809.cyc_varargs=
_tmp291,((_tmp809.rgn_po=_tmp292,((_tmp809.attributes=_tmp293,_tmp809)))))))))))))))))),
...
_tmp814.tag=5,((_tmp814.f1=((_tmp812.elt_typ=new_fn_typ,((_tmp812.elt_tq=_tmp282,((
_tmp812.ptr_atts=((_tmp813.rgn=_tmp284,((_tmp813.nullable=_tmp285,((_tmp813.bounds=
_tmp286,((_tmp813.zero_term=_tmp287,((_tmp813.ptrloc=0,_tmp813)))))))))),_tmp812)))))),
...
_tmp81A;void*_tmp2A3=(_tmp81A.tag=0,((_tmp81A.f1=(struct _dyneither_ptr)((struct
...
Cyc_Tcutil_explain_failure();return _tmp2A3;};}}}{struct _tuple0 _tmp81E;struct
_tuple0 _tmp2A9=(_tmp81E.f1=e->r,((_tmp81E.f2=Cyc_Tcutil_compress(t),_tmp81E)));
...
_tmp2BE.ptr_atts;_tmp2C2=_tmp2C1.zero_term;}}_LL154:{void**_tmp822;_tmp2BA=((
_tmp822=_cycalloc(sizeof(*_tmp822)),((_tmp822[0]=_tmp2BF,_tmp822))));}_tmp2BB=
...
_tmp2D4.f2;if(Cyc_Tcutil_is_noalias_region(_tmp2D6,0)){const char*_tmp82B;void*
...
_tmp2E0=(_tmp831=_cycalloc(sizeof(*_tmp831)),((_tmp831[0]=((_tmp832.tag=19,((
_tmp832.f1=_tmp2DF,_tmp832)))),_tmp831)));if(Cyc_Tcutil_unify(_tmp2DE,(void*)
...
_check_null((*_tmp2EC)->impl))->fields)){const char*_tmp836;void*_tmp835[1];
struct Cyc_String_pa_struct _tmp834;(_tmp834.tag=0,((_tmp834.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*_tmp2E5),((_tmp835[0]=& _tmp834,Cyc_Tcutil_terr(
...
_tmp2E5,_tmp2EE)){const char*_tmp83A;void*_tmp839[1];struct Cyc_String_pa_struct
_tmp838;(_tmp838.tag=0,((_tmp838.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
_tmp2E5),((_tmp839[0]=& _tmp838,Cyc_Tcutil_terr(loc,((_tmp83A="no field of struct/union has name %s",
...
_tmp840;(_tmp840.tag=1,((_tmp840.f1=(unsigned long)((int)_tmp2E7),((_tmp841.tag=
1,((_tmp841.f1=(unsigned long)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmp2FE),((_tmp842[0]=& _tmp841,((_tmp842[1]=& _tmp840,Cyc_Tcutil_terr(loc,((
...
_tmp845;(_tmp845.tag=1,((_tmp845.f1=(unsigned long)((int)_tmp2E7),((_tmp846.tag=
1,((_tmp846.f1=(unsigned long)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmp300),((_tmp847[0]=& _tmp846,((_tmp847[1]=& _tmp845,Cyc_Tcutil_terr(loc,((
...
Cyc_List_List*x))Cyc_List_length)(_tmp305->typs)< _tmp2E7){const char*_tmp84D;
void*_tmp84C[2];struct Cyc_Int_pa_struct _tmp84B;struct Cyc_Int_pa_struct _tmp84A;(
_tmp84A.tag=1,((_tmp84A.f1=(unsigned long)((int)_tmp2E7),((_tmp84B.tag=1,((
_tmp84B.f1=(unsigned long)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmp305->typs),((_tmp84C[0]=& _tmp84B,((_tmp84C[1]=& _tmp84A,Cyc_Tcutil_terr(loc,((
...
Cyc_Core_Opt*_tmp852;void*_tmp321=Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_mko,((
_tmp852=_cycalloc(sizeof(*_tmp852)),((_tmp852->v=_tmp320,_tmp852)))));struct Cyc_Core_Opt*
_tmp853;void*_tmp322=Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Tcutil_trko,((
_tmp853=_cycalloc(sizeof(*_tmp853)),((_tmp853->v=_tmp320,_tmp853)))));union Cyc_Absyn_Constraint*
...
_tmp854;struct Cyc_Absyn_PtrAtts _tmp325=(_tmp854.rgn=_tmp322,((_tmp854.nullable=((
union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)(),((_tmp854.bounds=
_tmp323,((_tmp854.zero_term=_tmp324,((_tmp854.ptrloc=0,_tmp854)))))))));struct
Cyc_Absyn_PointerType_struct _tmp85A;struct Cyc_Absyn_PtrInfo _tmp859;struct Cyc_Absyn_PointerType_struct*
_tmp858;struct Cyc_Absyn_PointerType_struct*_tmp326=(_tmp858=_cycalloc(sizeof(*
_tmp858)),((_tmp858[0]=((_tmp85A.tag=5,((_tmp85A.f1=((_tmp859.elt_typ=_tmp321,((
_tmp859.elt_tq=Cyc_Absyn_empty_tqual(0),((_tmp859.ptr_atts=_tmp325,_tmp859)))))),
_tmp85A)))),_tmp858)));Cyc_Tcutil_unify(t,(void*)_tmp326);_tmp31B=_tmp321;
...
return _tmp31B;_LL189:;_LL18A: {const char*_tmp861;void*_tmp860[1];struct Cyc_String_pa_struct
...
_tmp316,loc,topt,((_tmp861="expecting *, @, or ? type but found %s",
...
_dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp338->name)),((_tmp865[0]=& _tmp864,((
...
_tmp34E == 0){const char*_tmp872;void*_tmp871[1];struct Cyc_String_pa_struct _tmp870;
...
_tmp34E->type)){const char*_tmp876;void*_tmp875[1];struct Cyc_String_pa_struct
...
_tmp333;if(_tmp33D->tag != 9)goto _LL192;}{const char*_tmp877;if(!(Cyc_strcmp((
...
_dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp370->name)),((_tmp88F[0]=& _tmp88E,((
...
Cyc_Tcutil_ak,_tmp37C)){const char*_tmp894;void*_tmp893[1];struct Cyc_String_pa_struct
...
sizeof(char),48))),_tag_dyneither(_tmp893,sizeof(void*),1)))))));}if(((_tmp370->kind
...
_tmp386 == 0){const char*_tmp8A0;void*_tmp89F[1];struct Cyc_String_pa_struct _tmp89E;
...
_tmp386->type)){const char*_tmp8A4;void*_tmp8A3[1];struct Cyc_String_pa_struct
...
_tmp390.f1;_tmp392=_tmp390.f2;if(!_tmp392){const char*_tmp8AB;void*_tmp8AA;return(
...
_tmp39A;if(_tmp39B->tag != Cyc_List_Nth)goto _LL1A5;}_LL1A4: {const char*_tmp8B0;
...
Cyc_List_length)(ts),((_tmp8AE.tag=1,((_tmp8AE.f1=(unsigned long)((int)_tmp391),((
...
void*t2=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)_check_null(e2->topt))->v);
if(!Cyc_Tcutil_coerce_sint_typ(_tmp3A1,e2)){const char*_tmp8B4;void*_tmp8B3[1];
...
_tmp8B2,Cyc_Tcexp_expr_err(_tmp3A1,e2->loc,topt,((_tmp8B4="expecting int subscript, found %s",
...
x))Cyc_Absyn_conref_def)(0,_tmp3AD)){const char*_tmp8BA;void*_tmp8B9;(_tmp8B9=0,
...
t1)),((_tmp8C0[0]=& _tmp8BF,Cyc_Tcexp_expr_err(_tmp3A1,loc,topt,((_tmp8C1="subscript applied to %s",
...
_tmp3C8->hd)).f2,& bogus);{struct _tuple18*_tmp8C4;struct Cyc_List_List*_tmp8C3;
fields=((_tmp8C3=_cycalloc(sizeof(*_tmp8C3)),((_tmp8C3->hd=((_tmp8C4=_cycalloc(
sizeof(*_tmp8C4)),((_tmp8C4->f1=(*((struct _tuple18*)_tmp3C8->hd)).f1,((_tmp8C4->f2=(
...
te,0,(struct Cyc_Absyn_Exp*)es->hd);{struct _tuple18*_tmp8C7;struct Cyc_List_List*
...
_cycalloc(sizeof(*_tmp8C9)),((_tmp8C9[0]=((_tmp8CA.tag=11,((_tmp8CA.f1=((struct
...
int zero_term,struct Cyc_List_List*des){void*res_t2;struct _RegionHandle*_tmp3D2=
Cyc_Tcenv_get_fnrgn(te);{int _tmp3D3=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
des);struct Cyc_List_List*es=((struct Cyc_List_List*(*)(struct _RegionHandle*,
struct Cyc_Absyn_Exp*(*f)(struct _tuple17*),struct Cyc_List_List*x))Cyc_List_rmap)(
_tmp3D2,(struct Cyc_Absyn_Exp*(*)(struct _tuple17*))Cyc_Core_snd,des);void*res=Cyc_Absyn_new_evar((
...
_tmp3D4=(_tmp8CF=_cycalloc(sizeof(*_tmp8CF)),((_tmp8CF[0]=((_tmp8D0.tag=0,((
_tmp8D0.f1=Cyc_Absyn_Int_c(Cyc_Absyn_Unsigned,_tmp3D3),_tmp8D0)))),_tmp8CF)));
...
Cyc_List_nth)(es,_tmp3D3 - 1);if(!Cyc_Tcutil_is_zero(_tmp3D5)){const char*_tmp8D3;
void*_tmp8D2;(_tmp8D2=0,Cyc_Tcutil_terr(_tmp3D5->loc,((_tmp8D3="zero-terminated array doesn't end with zero.",
...
_tmp3DE;if(_tmp3DF->tag != 1)goto _LL1BB;}_LL1BA:{const char*_tmp8DB;void*_tmp8DA;(
...
_tmp3E1);_tmp3E5=_tmp3E4.f1;_tmp3E6=_tmp3E4.f2;if(!_tmp3E6){const char*_tmp8DE;
void*_tmp8DD;(_tmp8DD=0,Cyc_Tcutil_terr(_tmp3E1->loc,((_tmp8DE="index designator cannot use sizeof or offsetof",
_tag_dyneither(_tmp8DE,sizeof(char),47))),_tag_dyneither(_tmp8DD,sizeof(void*),0)));}
else{if(_tmp3E5 != offset){const char*_tmp8E3;void*_tmp8E2[2];struct Cyc_Int_pa_struct
_tmp8E1;struct Cyc_Int_pa_struct _tmp8E0;(_tmp8E0.tag=1,((_tmp8E0.f1=(
unsigned long)((int)_tmp3E5),((_tmp8E1.tag=1,((_tmp8E1.f1=(unsigned long)offset,((
_tmp8E2[0]=& _tmp8E1,((_tmp8E2[1]=& _tmp8E0,Cyc_Tcutil_terr(_tmp3E1->loc,((_tmp8E3="expecting index designator %d but found %d",
...
_tmp8EB;_tmp3F6=((_tmp8EB=_region_malloc(_tmp3F4,sizeof(*_tmp8EB)),((_tmp8EB[0]=
_tmp3FB.elt_typ,_tmp8EB))));}{struct Cyc_Absyn_Tqual*_tmp8EC;_tmp3F7=((_tmp8EC=
_region_malloc(_tmp3F4,sizeof(*_tmp8EC)),((_tmp8EC[0]=_tmp3FB.elt_tq,_tmp8EC))));}{
union Cyc_Absyn_Constraint**_tmp8ED;_tmp3F8=((_tmp8ED=_region_malloc(_tmp3F4,
sizeof(*_tmp8ED)),((_tmp8ED[0]=(_tmp3FB.ptr_atts).zero_term,_tmp8ED))));}goto
...
void**_tmp8EE;_tmp3F6=((_tmp8EE=_region_malloc(_tmp3F4,sizeof(*_tmp8EE)),((
_tmp8EE[0]=_tmp3FE,_tmp8EE))));}{struct Cyc_Absyn_Tqual*_tmp8EF;_tmp3F7=((_tmp8EF=
_region_malloc(_tmp3F4,sizeof(*_tmp8EF)),((_tmp8EF[0]=_tmp3FF,_tmp8EF))));}{
union Cyc_Absyn_Constraint**_tmp8F0;_tmp3F8=((_tmp8F0=_region_malloc(_tmp3F4,
sizeof(*_tmp8F0)),((_tmp8F0[0]=_tmp401,_tmp8F0))));}goto _LL1C2;_LL1C7:;_LL1C8:
goto _LL1C2;_LL1C2:;}{void*t=Cyc_Tcexp_tcExp(_tmp3F5,_tmp3F6,body);if(_tmp3F5->le
== 0){if(!Cyc_Tcutil_is_const_exp(_tmp3F5,bound)){const char*_tmp8F3;void*_tmp8F2;(
...
if(!Cyc_Tcutil_is_const_exp(_tmp3F5,body)){const char*_tmp8F6;void*_tmp8F5;(
...
_tmp8F7;_tmp40C->topt=((_tmp8F7=_cycalloc(sizeof(*_tmp8F7)),((_tmp8F7->v=Cyc_Absyn_uint_typ,
_tmp8F7))));}bound=Cyc_Absyn_add_exp(bound,_tmp40C,0);{struct Cyc_Core_Opt*
_tmp8F8;bound->topt=((_tmp8F8=_cycalloc(sizeof(*_tmp8F8)),((_tmp8F8->v=Cyc_Absyn_uint_typ,
_tmp8F8))));}*is_zero_term=1;}{void*_tmp40F=Cyc_Absyn_array_typ(t,_tmp3F7 == 0?
...
_tmp415->tag != Cyc_Dict_Absent)goto _LL1CC;}_LL1CB:{const char*_tmp8FC;void*
...
_RegionHandle*_tmp41E=Cyc_Tcenv_get_fnrgn(te);struct _tuple11 _tmp905;struct
_tuple11 _tmp41F=(_tmp905.f1=Cyc_Tcenv_lookup_type_vars(te),((_tmp905.f2=_tmp41E,
_tmp905)));struct Cyc_List_List*_tmp420=((struct Cyc_List_List*(*)(struct
...
_tmp41E,_tmp420,_tmp421);struct Cyc_Absyn_AggrType_struct _tmp90F;struct Cyc_Absyn_Aggrdecl**
_tmp90E;struct Cyc_Absyn_AggrInfo _tmp90D;struct Cyc_Absyn_AggrType_struct*_tmp90C;
struct Cyc_Absyn_AggrType_struct*_tmp425=(_tmp90C=_cycalloc(sizeof(*_tmp90C)),((
_tmp90C[0]=((_tmp90F.tag=12,((_tmp90F.f1=((_tmp90D.aggr_info=Cyc_Absyn_KnownAggr(((
_tmp90E=_cycalloc(sizeof(*_tmp90E)),((_tmp90E[0]=ad,_tmp90E))))),((_tmp90D.targs=
_tmp422,_tmp90D)))),_tmp90F)))),_tmp90C)));struct Cyc_List_List*_tmp426=*ts;
...
_tmp426=_tmp426->tl;_tmp427=_tmp427->tl;}if(_tmp426 != 0){const char*_tmp912;void*
...
void*)((struct Cyc_Core_Opt*)_check_null(_tmp42D->topt))->v)),((_tmp917.tag=0,((
_tmp917.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
_tmp42E)),((_tmp918.tag=0,((_tmp918.f1=(struct _dyneither_ptr)((struct
...
_dyneither_ptr)*_tmp42C->name),((_tmp91D[0]=& _tmp91C,((_tmp91D[1]=& _tmp919,((
_tmp91D[2]=& _tmp918,((_tmp91D[3]=& _tmp917,((_tmp91D[4]=& _tmp916,Cyc_Tcutil_terr(
_tmp42D->loc,((_tmp91E="field %s of %s %s expects type %s != %s",_tag_dyneither(
...
_tmp439 != 0;_tmp439=_tmp439->tl){struct _tuple0*_tmp921;struct Cyc_List_List*
_tmp920;_tmp438=((_tmp920=_cycalloc(sizeof(*_tmp920)),((_tmp920->hd=((_tmp921=
_cycalloc(sizeof(*_tmp921)),((_tmp921->f1=Cyc_Tcutil_rsubstitute(_tmp41E,_tmp424,(*((
struct _tuple0*)_tmp439->hd)).f1),((_tmp921->f2=Cyc_Tcutil_rsubstitute(_tmp41E,
_tmp424,(*((struct _tuple0*)_tmp439->hd)).f2),_tmp921)))))),((_tmp920->tl=_tmp438,
_tmp920))))));}}_tmp438=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(
...
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)((struct Cyc_Core_Opt*)
_check_null(_tmp44B->topt))->v)),((_tmp927.tag=0,((_tmp927.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp44A->type)),((
_tmp928.tag=0,((_tmp928.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp44A->name),((
_tmp929[0]=& _tmp928,((_tmp929[1]=& _tmp927,((_tmp929[2]=& _tmp926,Cyc_Tcutil_terr(
_tmp44B->loc,((_tmp92A="field %s of struct expects type %s != %s",_tag_dyneither(
...
te);struct _tuple11 _tmp92E;struct _tuple11 _tmp454=(_tmp92E.f1=Cyc_Tcenv_lookup_type_vars(
te),((_tmp92E.f2=_tmp453,_tmp92E)));struct Cyc_List_List*_tmp455=((struct Cyc_List_List*(*)(
...
Cyc_Core_snd,_tmp455);struct Cyc_Absyn_DatatypeFieldType_struct _tmp934;struct Cyc_Absyn_DatatypeFieldInfo
...
_tmp933.field_info=Cyc_Absyn_KnownDatatypefield(tud,tuf),((_tmp933.targs=_tmp456,
_tmp933)))),_tmp934)))),_tmp932))));if(topt != 0){void*_tmp457=Cyc_Tcutil_compress(*
...
_LL210: {const char*_tmp948;void*_tmp947[1];struct Cyc_String_pa_struct _tmp946;(
...
goto _LL211;_LL214:;_LL215: goto _LL211;_LL211:;}{const char*_tmp951;void*_tmp950[2];
...
_cycalloc(sizeof(*_tmp953)),((_tmp953[0]=((_tmp954.tag=16,((_tmp954.f1=(void*)
...
te,loc,rgn);goto _LL219;_LL21C:;_LL21D:{const char*_tmp958;void*_tmp957[1];struct
...
_tmp95D)));void*_tmp4BB;void*_tmp4BD;void*_tmp4BE;void*_tmp4C0;_LL226: _tmp4BB=
...
_tmp95E))));}num_elts=_tmp4B6;one_elt=0;goto _LL225;_LL228: _tmp4BE=_tmp4BA.f2;{
...
_tmp95F))));}num_elts=_tmp4B3;one_elt=0;goto _LL225;_LL22A:;_LL22B: goto No_sizeof;
...
_LL254;}_LL253:{const char*_tmp969;void*_tmp968;(_tmp968=0,Cyc_Tcutil_terr(loc,((
_tmp969="cannot assign to an array",_tag_dyneither(_tmp969,sizeof(char),26))),
_tag_dyneither(_tmp968,sizeof(void*),0)));}goto _LL251;_LL254:;_LL255: goto _LL251;
...
sizeof(char),46))),_tag_dyneither(_tmp983,sizeof(void*),0)));}_LL256:;}}static
...
goto _LL25F;goto _LL263;_LL262:;_LL263:{const char*_tmp988;void*_tmp987[1];struct
...
sizeof(char),37))),_tag_dyneither(_tmp987,sizeof(void*),1)))))));}goto _LL25F;
...
_tmp98A[0]=((_tmp98B.tag=16,((_tmp98B.f1=(void*)Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)&
...
0,Cyc_Absyn_No_coercion,0),_tmp992)))),_tmp991))));}goto _LL27B;_LL27E:;_LL27F:
...
res_typ=*topt;}}return res_typ;};}_LL279:;_LL27A: {const char*_tmp9A3;void*_tmp9A2;(
...
sizeof(char),45))),_tag_dyneither(_tmp9A2,sizeof(void*),0)));}_LL276:;}_LL26C: {
...
_LL26D:{struct Cyc_Absyn_Array_e_struct _tmp9A6;struct Cyc_Absyn_Array_e_struct*
...
1,0),_tmp9C3)))),_tmp9C2)))),Cyc_Absyn_false_conref);}_LL272: {struct Cyc_Absyn_Const_e_struct*
...
1,0),_tmp9C6)))),_tmp9C5)))),Cyc_Absyn_false_conref);}_LL274:;_LL275: {void**
...
_LL28E:{void**_tmp9C7;topt2=((_tmp9C7=_cycalloc(sizeof(*_tmp9C7)),((_tmp9C7[0]=*
topt,_tmp9C7))));}goto _LL28A;_LL28F:;_LL290: goto _LL28A;_LL28A:;}{void*telt=Cyc_Tcexp_tcExp(
...
struct _tuple11 _tmp9DC;struct _tuple11 _tmp5B1=(_tmp9DC.f1=Cyc_Tcenv_lookup_type_vars(
...
10,((_tmp9E2.f1=((_tmp9E1.tvars=0,((_tmp9E1.effect=_tmp5A8,((_tmp9E1.ret_tqual=
...
_tmp5C0,_tmp9FB))))));}_tmp5C7=_tmp5C7->tl;};}goto _LL2BA;}_LL2BD:;_LL2BE: {const
...
_LL2BA:;}goto _LL2B5;_LL2B8:;_LL2B9: {const char*_tmpA01;void*_tmpA00;(_tmpA00=0,((
int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((
_tmpA01="not a function call!",_tag_dyneither(_tmpA01,sizeof(char),21))),
_tag_dyneither(_tmpA00,sizeof(void*),0)));}_LL2B5:;}while(_tmp5C0 != 0){struct Cyc_Absyn_Decl*
...
Cyc_Absyn_Constraint*_tmp67A;_LL318: {struct Cyc_Absyn_ArrayType_struct*_tmp674=(
struct Cyc_Absyn_ArrayType_struct*)_tmp673;if(_tmp674->tag != 9)goto _LL31A;else{
...
_tmp675.zero_term;}}_LL319: elt_topt=(void**)_tmp677;elt_tqopt=(struct Cyc_Absyn_Tqual*)
_tmp679;zero_term=((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(
0,_tmp67A);goto _LL317;_LL31A:;_LL31B: goto _LL317;_LL317:;}t=Cyc_Tcexp_tcArray(te,
loc,elt_topt,elt_tqopt,zero_term,_tmp634);goto _LL2BF;}_LL2FA: {struct Cyc_Absyn_StmtExp_e_struct*
_tmp635=(struct Cyc_Absyn_StmtExp_e_struct*)_tmp5D7;if(_tmp635->tag != 37)goto
_LL2FC;else{_tmp636=_tmp635->f1;}}_LL2FB: t=Cyc_Tcexp_tcStmtExp(te,loc,topt,
_tmp636);goto _LL2BF;_LL2FC: {struct Cyc_Absyn_Comprehension_e_struct*_tmp637=(
struct Cyc_Absyn_Comprehension_e_struct*)_tmp5D7;if(_tmp637->tag != 28)goto _LL2FE;
else{_tmp638=_tmp637->f1;_tmp639=_tmp637->f2;_tmp63A=_tmp637->f3;_tmp63B=_tmp637->f4;
_tmp63C=(int*)& _tmp637->f4;}}_LL2FD: t=Cyc_Tcexp_tcComprehension(te,loc,topt,
_tmp638,_tmp639,_tmp63A,_tmp63C);goto _LL2BF;_LL2FE: {struct Cyc_Absyn_Aggregate_e_struct*
...
14,((_tmpA04.f1=((struct Cyc_Absyn_Enumdecl*)_check_null(_tmp64F))->name,((
_tmpA04.f2=_tmp64F,_tmpA04)))))),_tmpA03))));}goto _LL2BF;_LL306: {struct Cyc_Absyn_AnonEnum_e_struct*
...
_tmp5D7;if(_tmp66A->tag != 40)goto _LL2BF;}_LL311:{const char*_tmpA0A;void*_tmpA09;(
