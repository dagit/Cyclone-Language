...
({void*_tmp27D=0U;({unsigned int _tmp701=loc;struct _dyneither_ptr _tmp700=({const char*_tmp27E="can't dereference abstract pointer type";_tag_dyneither(_tmp27E,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp701,_tmp700,_tag_dyneither(_tmp27D,sizeof(void*),0U));});});
return _tmp285;default: _LL5: _LL6:
# 1490
 return({struct Cyc_String_pa_PrintArg_struct _tmp281=({struct Cyc_String_pa_PrintArg_struct _tmp540;_tmp540.tag=0U,({struct _dyneither_ptr _tmp702=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp540.f1=_tmp702;});_tmp540;});void*_tmp27F[1U];_tmp27F[0]=& _tmp281;({struct Cyc_Tcenv_Tenv*_tmp706=_tmp271;unsigned int _tmp705=loc;void**_tmp704=topt;struct _dyneither_ptr _tmp703=({const char*_tmp280="expecting *, @, or ? type but found %s";_tag_dyneither(_tmp280,sizeof(char),39U);});Cyc_Tcexp_expr_err(_tmp706,_tmp705,_tmp704,_tmp703,_tag_dyneither(_tmp27F,sizeof(void*),1U));});});}_LL0:;};}
# 1495
...
# 1499
({struct Cyc_Tcenv_Tenv*_tmp707=Cyc_Tcenv_enter_abstract_val_ok(te);Cyc_Tcexp_tcExpNoPromote(_tmp707,0,e);});
# 1501
({int _tmp708=!Cyc_Tcenv_in_notreadctxt(te);*is_read=_tmp708;});{
...
if(_tmp288 == 0)
return({struct Cyc_String_pa_PrintArg_struct _tmp28B=({struct Cyc_String_pa_PrintArg_struct _tmp542;_tmp542.tag=0U,({
struct _dyneither_ptr _tmp709=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp29F->name));_tmp542.f1=_tmp709;});_tmp542;});struct Cyc_String_pa_PrintArg_struct _tmp28C=({struct Cyc_String_pa_PrintArg_struct _tmp541;_tmp541.tag=0U,_tmp541.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp541;});void*_tmp289[2U];_tmp289[0]=& _tmp28B,_tmp289[1]=& _tmp28C;({struct Cyc_Tcenv_Tenv*_tmp70D=te;unsigned int _tmp70C=loc;void**_tmp70B=topt;struct _dyneither_ptr _tmp70A=({const char*_tmp28A="%s has no %s member";_tag_dyneither(_tmp28A,sizeof(char),20U);});Cyc_Tcexp_expr_err(_tmp70D,_tmp70C,_tmp70B,_tmp70A,_tag_dyneither(_tmp289,sizeof(void*),2U));});});
# 1509
...
({void*_tmp70E=Cyc_Tcutil_substitute(_tmp28D,_tmp288->type);t2=_tmp70E;});}
# 1517
...
return({struct Cyc_String_pa_PrintArg_struct _tmp290=({struct Cyc_String_pa_PrintArg_struct _tmp543;_tmp543.tag=0U,_tmp543.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp543;});void*_tmp28E[1U];_tmp28E[0]=& _tmp290;({struct Cyc_Tcenv_Tenv*_tmp712=te;unsigned int _tmp711=loc;void**_tmp710=topt;struct _dyneither_ptr _tmp70F=({const char*_tmp28F="cannot read union member %s since it is not `bits-only'";_tag_dyneither(_tmp28F,sizeof(char),56U);});Cyc_Tcexp_expr_err(_tmp712,_tmp711,_tmp710,_tmp70F,_tag_dyneither(_tmp28E,sizeof(void*),1U));});});
if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp29F->impl))->exist_vars != 0){
# 1522
if(!({void*_tmp713=t2;Cyc_Tcutil_unify(_tmp713,Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te)));}))
return({struct Cyc_String_pa_PrintArg_struct _tmp293=({struct Cyc_String_pa_PrintArg_struct _tmp544;_tmp544.tag=0U,_tmp544.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp544;});void*_tmp291[1U];_tmp291[0]=& _tmp293;({struct Cyc_Tcenv_Tenv*_tmp717=te;unsigned int _tmp716=loc;void**_tmp715=topt;struct _dyneither_ptr _tmp714=({const char*_tmp292="must use pattern-matching to access field %s\n\tdue to existential type variables.";_tag_dyneither(_tmp292,sizeof(char),81U);});Cyc_Tcexp_expr_err(_tmp717,_tmp716,_tmp715,_tmp714,_tag_dyneither(_tmp291,sizeof(void*),1U));});});}
# 1525
...
if(_tmp294 == 0)
return({struct Cyc_String_pa_PrintArg_struct _tmp297=({struct Cyc_String_pa_PrintArg_struct _tmp545;_tmp545.tag=0U,_tmp545.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp545;});void*_tmp295[1U];_tmp295[0]=& _tmp297;({struct Cyc_Tcenv_Tenv*_tmp71B=te;unsigned int _tmp71A=loc;void**_tmp719=topt;struct _dyneither_ptr _tmp718=({const char*_tmp296="type has no %s member";_tag_dyneither(_tmp296,sizeof(char),22U);});Cyc_Tcexp_expr_err(_tmp71B,_tmp71A,_tmp719,_tmp718,_tag_dyneither(_tmp295,sizeof(void*),1U));});});
# 1532
if(((_tmp2A1 == Cyc_Absyn_UnionA  && !Cyc_Tcutil_bits_only(_tmp294->type)) && !Cyc_Tcenv_in_notreadctxt(te)) && _tmp294->requires_clause == 0)
# 1534
return({struct Cyc_String_pa_PrintArg_struct _tmp29A=({struct Cyc_String_pa_PrintArg_struct _tmp546;_tmp546.tag=0U,_tmp546.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp546;});void*_tmp298[1U];_tmp298[0]=& _tmp29A;({struct Cyc_Tcenv_Tenv*_tmp71F=te;unsigned int _tmp71E=loc;void**_tmp71D=topt;struct _dyneither_ptr _tmp71C=({const char*_tmp299="cannot read union member %s since it is not `bits-only'";_tag_dyneither(_tmp299,sizeof(char),56U);});Cyc_Tcexp_expr_err(_tmp71F,_tmp71E,_tmp71D,_tmp71C,_tag_dyneither(_tmp298,sizeof(void*),1U));});});
return _tmp294->type;}default: _LL5: _LL6:
# 1537
 return({struct Cyc_String_pa_PrintArg_struct _tmp29D=({struct Cyc_String_pa_PrintArg_struct _tmp547;_tmp547.tag=0U,({
struct _dyneither_ptr _tmp720=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(e->topt)));_tmp547.f1=_tmp720;});_tmp547;});void*_tmp29B[1U];_tmp29B[0]=& _tmp29D;({struct Cyc_Tcenv_Tenv*_tmp724=te;unsigned int _tmp723=loc;void**_tmp722=topt;struct _dyneither_ptr _tmp721=({const char*_tmp29C="expecting struct or union, found %s";_tag_dyneither(_tmp29C,sizeof(char),36U);});Cyc_Tcexp_expr_err(_tmp724,_tmp723,_tmp722,_tmp721,_tag_dyneither(_tmp29B,sizeof(void*),1U));});});}_LL0:;};}
# 1543
...
# 1546
({struct Cyc_Tcenv_Tenv*_tmp725=Cyc_Tcenv_enter_abstract_val_ok(Cyc_Tcenv_clear_lhs(Cyc_Tcenv_clear_notreadctxt(te)));Cyc_Tcexp_tcExp(_tmp725,0,e);});
# 1548
({int _tmp726=!Cyc_Tcenv_in_notreadctxt(te);*is_read=_tmp726;});
...
if(_tmp2A6 == 0)
return({struct Cyc_String_pa_PrintArg_struct _tmp2A9=({struct Cyc_String_pa_PrintArg_struct _tmp549;_tmp549.tag=0U,({
struct _dyneither_ptr _tmp727=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp2C0->name));_tmp549.f1=_tmp727;});_tmp549;});struct Cyc_String_pa_PrintArg_struct _tmp2AA=({struct Cyc_String_pa_PrintArg_struct _tmp548;_tmp548.tag=0U,_tmp548.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp548;});void*_tmp2A7[2U];_tmp2A7[0]=& _tmp2A9,_tmp2A7[1]=& _tmp2AA;({struct Cyc_Tcenv_Tenv*_tmp72B=te;unsigned int _tmp72A=loc;void**_tmp729=topt;struct _dyneither_ptr _tmp728=({const char*_tmp2A8="type %s has no %s member";_tag_dyneither(_tmp2A8,sizeof(char),25U);});Cyc_Tcexp_expr_err(_tmp72B,_tmp72A,_tmp729,_tmp728,_tag_dyneither(_tmp2A7,sizeof(void*),2U));});});
# 1559
...
({void*_tmp72C=Cyc_Tcutil_substitute(_tmp2AB,_tmp2A6->type);t3=_tmp72C;});}{
# 1565
...
# 1572
 return({struct Cyc_String_pa_PrintArg_struct _tmp2B1=({struct Cyc_String_pa_PrintArg_struct _tmp54A;_tmp54A.tag=0U,_tmp54A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp54A;});void*_tmp2AF[1U];_tmp2AF[0]=& _tmp2B1;({struct Cyc_Tcenv_Tenv*_tmp730=te;unsigned int _tmp72F=loc;void**_tmp72E=topt;struct _dyneither_ptr _tmp72D=({const char*_tmp2B0="cannot get member %s since its type is abstract";_tag_dyneither(_tmp2B0,sizeof(char),48U);});Cyc_Tcexp_expr_err(_tmp730,_tmp72F,_tmp72E,_tmp72D,_tag_dyneither(_tmp2AF,sizeof(void*),1U));});});}_LLC:;}
# 1577
...
# 1580
return({struct Cyc_String_pa_PrintArg_struct _tmp2B4=({struct Cyc_String_pa_PrintArg_struct _tmp54B;_tmp54B.tag=0U,_tmp54B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp54B;});void*_tmp2B2[1U];_tmp2B2[0]=& _tmp2B4;({struct Cyc_Tcenv_Tenv*_tmp734=te;unsigned int _tmp733=loc;void**_tmp732=topt;struct _dyneither_ptr _tmp731=({const char*_tmp2B3="cannot read union member %s since it is not `bits-only'";_tag_dyneither(_tmp2B3,sizeof(char),56U);});Cyc_Tcexp_expr_err(_tmp734,_tmp733,_tmp732,_tmp731,_tag_dyneither(_tmp2B2,sizeof(void*),1U));});});
if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp2C0->impl))->exist_vars != 0){
if(!({void*_tmp735=t3;Cyc_Tcutil_unify(_tmp735,Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te)));}))
return({struct Cyc_String_pa_PrintArg_struct _tmp2B7=({struct Cyc_String_pa_PrintArg_struct _tmp54C;_tmp54C.tag=0U,_tmp54C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp54C;});void*_tmp2B5[1U];_tmp2B5[0]=& _tmp2B7;({struct Cyc_Tcenv_Tenv*_tmp739=te;unsigned int _tmp738=loc;void**_tmp737=topt;struct _dyneither_ptr _tmp736=({const char*_tmp2B6="must use pattern-matching to access field %s\n\tdue to extistential types";_tag_dyneither(_tmp2B6,sizeof(char),72U);});Cyc_Tcexp_expr_err(_tmp739,_tmp738,_tmp737,_tmp736,_tag_dyneither(_tmp2B5,sizeof(void*),1U));});});}
# 1587
...
if(_tmp2B8 == 0)
return({struct Cyc_String_pa_PrintArg_struct _tmp2BB=({struct Cyc_String_pa_PrintArg_struct _tmp54D;_tmp54D.tag=0U,_tmp54D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp54D;});void*_tmp2B9[1U];_tmp2B9[0]=& _tmp2BB;({struct Cyc_Tcenv_Tenv*_tmp73D=te;unsigned int _tmp73C=loc;void**_tmp73B=topt;struct _dyneither_ptr _tmp73A=({const char*_tmp2BA="type has no %s field";_tag_dyneither(_tmp2BA,sizeof(char),21U);});Cyc_Tcexp_expr_err(_tmp73D,_tmp73C,_tmp73B,_tmp73A,_tag_dyneither(_tmp2B9,sizeof(void*),1U));});});
# 1594
if((_tmp2C2 == Cyc_Absyn_UnionA  && !Cyc_Tcutil_bits_only(_tmp2B8->type)) && !Cyc_Tcenv_in_notreadctxt(te))
return({struct Cyc_String_pa_PrintArg_struct _tmp2BE=({struct Cyc_String_pa_PrintArg_struct _tmp54E;_tmp54E.tag=0U,_tmp54E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f);_tmp54E;});void*_tmp2BC[1U];_tmp2BC[0]=& _tmp2BE;({struct Cyc_Tcenv_Tenv*_tmp741=te;unsigned int _tmp740=loc;void**_tmp73F=topt;struct _dyneither_ptr _tmp73E=({const char*_tmp2BD="cannot read union member %s since it is not `bits-only'";_tag_dyneither(_tmp2BD,sizeof(char),56U);});Cyc_Tcexp_expr_err(_tmp741,_tmp740,_tmp73F,_tmp73E,_tag_dyneither(_tmp2BC,sizeof(void*),1U));});});
...
goto _LL0;}else{_LL3: _LL4:
 goto _LL0;}_LL0:;}
# 1602
return({struct Cyc_String_pa_PrintArg_struct _tmp2C9=({struct Cyc_String_pa_PrintArg_struct _tmp54F;_tmp54F.tag=0U,({
struct _dyneither_ptr _tmp742=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(e->topt)));_tmp54F.f1=_tmp742;});_tmp54F;});void*_tmp2C7[1U];_tmp2C7[0]=& _tmp2C9;({struct Cyc_Tcenv_Tenv*_tmp746=te;unsigned int _tmp745=loc;void**_tmp744=topt;struct _dyneither_ptr _tmp743=({const char*_tmp2C8="expecting struct or union pointer, found %s";_tag_dyneither(_tmp2C8,sizeof(char),44U);});Cyc_Tcexp_expr_err(_tmp746,_tmp745,_tmp744,_tmp743,_tag_dyneither(_tmp2C7,sizeof(void*),1U));});});}
# 1607
...
if(!_tmp2D8)
return({void*_tmp2CC=0U;({struct Cyc_Tcenv_Tenv*_tmp749=te;unsigned int _tmp748=loc;struct _dyneither_ptr _tmp747=({const char*_tmp2CD="tuple projection cannot use sizeof or offsetof";_tag_dyneither(_tmp2CD,sizeof(char),47U);});Cyc_Tcexp_expr_err(_tmp749,_tmp748,0,_tmp747,_tag_dyneither(_tmp2CC,sizeof(void*),0U));});});{
# 1613
...
# 1616
 return({struct Cyc_Int_pa_PrintArg_struct _tmp2D5=({struct Cyc_Int_pa_PrintArg_struct _tmp551;_tmp551.tag=1U,_tmp551.f1=(unsigned long)((int)_tmp2D9);_tmp551;});struct Cyc_Int_pa_PrintArg_struct _tmp2D6=({struct Cyc_Int_pa_PrintArg_struct _tmp550;_tmp550.tag=1U,({
unsigned long _tmp74A=(unsigned long)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ts);_tmp550.f1=_tmp74A;});_tmp550;});void*_tmp2D3[2U];_tmp2D3[0]=& _tmp2D5,_tmp2D3[1]=& _tmp2D6;({struct Cyc_Tcenv_Tenv*_tmp74D=te;unsigned int _tmp74C=loc;struct _dyneither_ptr _tmp74B=({const char*_tmp2D4="index is %d but tuple has only %d fields";_tag_dyneither(_tmp2D4,sizeof(char),41U);});Cyc_Tcexp_expr_err(_tmp74D,_tmp74C,0,_tmp74B,_tag_dyneither(_tmp2D3,sizeof(void*),2U));});});}else{_LL6: _tmp2D7=_tmp2D2;_LL7:(int)_rethrow(_tmp2D7);}_LL3:;}};};}
# 1621
...
({struct Cyc_Tcenv_Tenv*_tmp74E=Cyc_Tcenv_clear_abstract_val_ok(_tmp2DA);Cyc_Tcexp_tcExp(_tmp74E,0,e1);});
({struct Cyc_Tcenv_Tenv*_tmp74F=Cyc_Tcenv_clear_abstract_val_ok(_tmp2DA);Cyc_Tcexp_tcExp(_tmp74F,0,e2);});{
void*t1=Cyc_Tcutil_compress((void*)_check_null(e1->topt));
void*t2=Cyc_Tcutil_compress((void*)_check_null(e2->topt));
if(!Cyc_Tcutil_coerce_sint_typ(_tmp2DA,e2))
return({struct Cyc_String_pa_PrintArg_struct _tmp2DD=({struct Cyc_String_pa_PrintArg_struct _tmp552;_tmp552.tag=0U,({
struct _dyneither_ptr _tmp750=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t2));_tmp552.f1=_tmp750;});_tmp552;});void*_tmp2DB[1U];_tmp2DB[0]=& _tmp2DD;({struct Cyc_Tcenv_Tenv*_tmp754=_tmp2DA;unsigned int _tmp753=e2->loc;void**_tmp752=topt;struct _dyneither_ptr _tmp751=({const char*_tmp2DC="expecting int subscript, found %s";_tag_dyneither(_tmp2DC,sizeof(char),34U);});Cyc_Tcexp_expr_err(_tmp754,_tmp753,_tmp752,_tmp751,_tag_dyneither(_tmp2DB,sizeof(void*),1U));});});{
# 1633
...
({void*_tmp2E7=0U;({unsigned int _tmp756=loc;struct _dyneither_ptr _tmp755=({const char*_tmp2E8="subscript will fail at run-time";_tag_dyneither(_tmp2E8,sizeof(char),32U);});Cyc_Tcutil_terr(_tmp756,_tmp755,_tag_dyneither(_tmp2E7,sizeof(void*),0U));});});}}
# 1651
goto _LL7;}}else{_LLA: _LLB:
 emit_warning=0;goto _LL7;}_LL7:;}
# 1654
if(emit_warning)
({void*_tmp2F0=0U;({unsigned int _tmp758=e2->loc;struct _dyneither_ptr _tmp757=({const char*_tmp2F1="subscript on thin, zero-terminated pointer could be expensive.";_tag_dyneither(_tmp2F1,sizeof(char),63U);});Cyc_Tcutil_warn(_tmp758,_tmp757,_tag_dyneither(_tmp2F0,sizeof(void*),0U));});});}else{
# 1658
if(Cyc_Tcutil_is_const_exp(e2)){
...
({void*_tmp2F6=0U;({unsigned int _tmp75A=e1->loc;struct _dyneither_ptr _tmp759=({const char*_tmp2F7="subscript applied to pointer to one object";_tag_dyneither(_tmp2F7,sizeof(char),43U);});Cyc_Tcutil_warn(_tmp75A,_tmp759,_tag_dyneither(_tmp2F6,sizeof(void*),0U));});});
...
({void*_tmp2F8=0U;({unsigned int _tmp75C=e1->loc;struct _dyneither_ptr _tmp75B=({const char*_tmp2F9="can't subscript an abstract pointer";_tag_dyneither(_tmp2F9,sizeof(char),36U);});Cyc_Tcutil_terr(_tmp75C,_tmp75B,_tag_dyneither(_tmp2F8,sizeof(void*),0U));});});
return _tmp301;case 10U: _LL3: _tmp302=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp2DE)->f1;_LL4:
 ...
 return({struct Cyc_String_pa_PrintArg_struct _tmp2FC=({struct Cyc_String_pa_PrintArg_struct _tmp553;_tmp553.tag=0U,({struct _dyneither_ptr _tmp75D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t1));_tmp553.f1=_tmp75D;});_tmp553;});void*_tmp2FA[1U];_tmp2FA[0]=& _tmp2FC;({struct Cyc_Tcenv_Tenv*_tmp761=_tmp2DA;unsigned int _tmp760=loc;void**_tmp75F=topt;struct _dyneither_ptr _tmp75E=({const char*_tmp2FB="subscript applied to %s";_tag_dyneither(_tmp2FB,sizeof(char),24U);});Cyc_Tcexp_expr_err(_tmp761,_tmp760,_tmp75F,_tmp75E,_tag_dyneither(_tmp2FA,sizeof(void*),1U));});});}_LL0:;};};}
# 1679
...
# 1685
 if(({int _tmp762=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp308);_tmp762 != ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(es);}))
# 1688
goto _LL0;
# 1690
...
({struct Cyc_Tcenv_Tenv*_tmp763=Cyc_Tcenv_clear_abstract_val_ok(te);Cyc_Tcexp_tcExpInitializer(_tmp763,& _tmp305,(struct Cyc_Absyn_Exp*)es->hd);});
# 1695
Cyc_Tcutil_coerce_arg(te,(struct Cyc_Absyn_Exp*)es->hd,(*((struct _tuple17*)_tmp308->hd)).f2,& bogus);
({struct Cyc_List_List*_tmp765=({struct Cyc_List_List*_tmp307=_cycalloc(sizeof(*_tmp307));({struct _tuple17*_tmp764=({struct _tuple17*_tmp306=_cycalloc(sizeof(*_tmp306));_tmp306->f1=(*((struct _tuple17*)_tmp308->hd)).f1,_tmp306->f2=(void*)_check_null(((struct Cyc_Absyn_Exp*)es->hd)->topt);_tmp306;});_tmp307->hd=_tmp764;}),_tmp307->tl=fields;_tmp307;});fields=_tmp765;});}
# 1698
done=1;
goto _LL0;}else{_LL3: _LL4:
 goto _LL0;}_LL0:;}
...
if(!done)
for(0;es != 0;es=es->tl){
({struct Cyc_Tcenv_Tenv*_tmp766=Cyc_Tcenv_clear_abstract_val_ok(te);Cyc_Tcexp_tcExpInitializer(_tmp766,0,(struct Cyc_Absyn_Exp*)es->hd);});
({struct Cyc_List_List*_tmp769=({struct Cyc_List_List*_tmp30A=_cycalloc(sizeof(*_tmp30A));({struct _tuple17*_tmp768=({struct _tuple17*_tmp309=_cycalloc(sizeof(*_tmp309));({struct Cyc_Absyn_Tqual _tmp767=Cyc_Absyn_empty_tqual(0U);_tmp309->f1=_tmp767;}),_tmp309->f2=(void*)_check_null(((struct Cyc_Absyn_Exp*)es->hd)->topt);_tmp309;});_tmp30A->hd=_tmp768;}),_tmp30A->tl=fields;_tmp30A;});fields=_tmp769;});}
# 1707
return(void*)({struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmp30B=_cycalloc(sizeof(*_tmp30B));_tmp30B->tag=10U,({struct Cyc_List_List*_tmp76A=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(fields);_tmp30B->f1=_tmp76A;});_tmp30B;});}
# 1711
...
# 1714
return({void*_tmp30C=0U;({struct Cyc_Tcenv_Tenv*_tmp76E=te;unsigned int _tmp76D=loc;void**_tmp76C=topt;struct _dyneither_ptr _tmp76B=({const char*_tmp30D="tcCompoundLit";_tag_dyneither(_tmp30D,sizeof(char),14U);});Cyc_Tcexp_expr_err(_tmp76E,_tmp76D,_tmp76C,_tmp76B,_tag_dyneither(_tmp30C,sizeof(void*),0U));});});}struct _tuple18{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
# 1724 "tcexp.cyc"
...
struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp30F=({struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp325=_cycalloc(sizeof(*_tmp325));_tmp325->tag=0U,({union Cyc_Absyn_Cnst _tmp76F=Cyc_Absyn_Int_c(Cyc_Absyn_Unsigned,_tmp30E);_tmp325->f1=_tmp76F;});_tmp325;});
...
({void*_tmp311=0U;({unsigned int _tmp771=_tmp310->loc;struct _dyneither_ptr _tmp770=({const char*_tmp312="zero-terminated array doesn't end with zero.";_tag_dyneither(_tmp312,sizeof(char),45U);});Cyc_Tcutil_terr(_tmp771,_tmp770,_tag_dyneither(_tmp311,sizeof(void*),0U));});});}
# 1740
sz_exp->topt=Cyc_Absyn_uint_typ;
({void*_tmp775=({void*_tmp774=res;struct Cyc_Absyn_Tqual _tmp773=
(unsigned int)elt_tqopt?*elt_tqopt: Cyc_Absyn_empty_tqual(0U);
# 1741
struct Cyc_Absyn_Exp*_tmp772=sz_exp;Cyc_Absyn_array_typ(_tmp774,_tmp773,_tmp772,
# 1743
...
# 1750
({struct Cyc_String_pa_PrintArg_struct _tmp315=({struct Cyc_String_pa_PrintArg_struct _tmp554;_tmp554.tag=0U,({
struct _dyneither_ptr _tmp776=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(res));_tmp554.f1=_tmp776;});_tmp554;});void*_tmp313[1U];_tmp313[0]=& _tmp315;({unsigned int _tmp778=((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(es))->hd)->loc;struct _dyneither_ptr _tmp777=({const char*_tmp314="elements of array do not all have the same type (%s)";_tag_dyneither(_tmp314,sizeof(char),53U);});Cyc_Tcutil_terr(_tmp778,_tmp777,_tag_dyneither(_tmp313,sizeof(void*),1U));});});
# 1753
...
# 1760
({void*_tmp318=0U;({unsigned int _tmp77A=loc;struct _dyneither_ptr _tmp779=({const char*_tmp319="only array index designators are supported";_tag_dyneither(_tmp319,sizeof(char),43U);});Cyc_Tcutil_terr(_tmp77A,_tmp779,_tag_dyneither(_tmp318,sizeof(void*),0U));});});
...
if(!_tmp322)
({void*_tmp31C=0U;({unsigned int _tmp77C=_tmp324->loc;struct _dyneither_ptr _tmp77B=({const char*_tmp31D="index designator cannot use sizeof or offsetof";_tag_dyneither(_tmp31D,sizeof(char),47U);});Cyc_Tcutil_terr(_tmp77C,_tmp77B,_tag_dyneither(_tmp31C,sizeof(void*),0U));});});else{
if(_tmp323 != offset)
({struct Cyc_Int_pa_PrintArg_struct _tmp320=({struct Cyc_Int_pa_PrintArg_struct _tmp556;_tmp556.tag=1U,_tmp556.f1=(unsigned long)offset;_tmp556;});struct Cyc_Int_pa_PrintArg_struct _tmp321=({struct Cyc_Int_pa_PrintArg_struct _tmp555;_tmp555.tag=1U,_tmp555.f1=(unsigned long)((int)_tmp323);_tmp555;});void*_tmp31E[2U];_tmp31E[0]=& _tmp320,_tmp31E[1]=& _tmp321;({unsigned int _tmp77E=_tmp324->loc;struct _dyneither_ptr _tmp77D=({const char*_tmp31F="expecting index designator %d but found %d";_tag_dyneither(_tmp31F,sizeof(char),43U);});Cyc_Tcutil_terr(_tmp77E,_tmp77D,_tag_dyneither(_tmp31E,sizeof(void*),2U));});});}
# 1770
goto _LL0;};}_LL0:;}}}
# 1774
return res_t2;}
...
struct Cyc_Absyn_Exp*_tmp328=({void*_tmp77F=Cyc_Absyn_uint_typ;Cyc_Absyn_cast_exp(_tmp77F,Cyc_Absyn_valueof_exp(_tmp32C,0U),0,Cyc_Absyn_No_coercion,0U);});
...
({struct Cyc_String_pa_PrintArg_struct _tmp32B=({struct Cyc_String_pa_PrintArg_struct _tmp557;_tmp557.tag=0U,({
struct _dyneither_ptr _tmp780=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(bound->topt)));_tmp557.f1=_tmp780;});_tmp557;});void*_tmp329[1U];_tmp329[0]=& _tmp32B;({unsigned int _tmp782=bound->loc;struct _dyneither_ptr _tmp781=({const char*_tmp32A="expecting unsigned int, found %s";_tag_dyneither(_tmp32A,sizeof(char),33U);});Cyc_Tcutil_terr(_tmp782,_tmp781,_tag_dyneither(_tmp329,sizeof(void*),1U));});});}_LL0:;}
# 1800
if(!(vd->tq).real_const)
({void*_tmp32D=0U;({struct _dyneither_ptr _tmp783=({const char*_tmp32E="comprehension index variable is not declared const!";_tag_dyneither(_tmp32E,sizeof(char),52U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp783,_tag_dyneither(_tmp32D,sizeof(void*),0U));});});
# 1803
if(te->le != 0)
({struct Cyc_Tcenv_Tenv*_tmp784=Cyc_Tcenv_new_block(loc,te);te=_tmp784;});{
void**_tmp32F=0;
...
# 1812
({void**_tmp785=({void**_tmp334=_cycalloc(sizeof(*_tmp334));*_tmp334=_tmp33A.elt_typ;_tmp334;});_tmp32F=_tmp785;});
({struct Cyc_Absyn_Tqual*_tmp786=({struct Cyc_Absyn_Tqual*_tmp335=_cycalloc(sizeof(*_tmp335));*_tmp335=_tmp33A.elt_tq;_tmp335;});_tmp330=_tmp786;});
({union Cyc_Absyn_Constraint**_tmp787=({union Cyc_Absyn_Constraint**_tmp336=_cycalloc(sizeof(*_tmp336));*_tmp336=(_tmp33A.ptr_atts).zero_term;_tmp336;});_tmp331=_tmp787;});
...
# 1817
({void**_tmp788=({void**_tmp337=_cycalloc(sizeof(*_tmp337));*_tmp337=_tmp33E;_tmp337;});_tmp32F=_tmp788;});
({struct Cyc_Absyn_Tqual*_tmp789=({struct Cyc_Absyn_Tqual*_tmp338=_cycalloc(sizeof(*_tmp338));*_tmp338=_tmp33D;_tmp338;});_tmp330=_tmp789;});
({union Cyc_Absyn_Constraint**_tmp78A=({union Cyc_Absyn_Constraint**_tmp339=_cycalloc(sizeof(*_tmp339));*_tmp339=_tmp33B;_tmp339;});_tmp331=_tmp78A;});
goto _LL5;default: _LLA: _LLB:
# 1822
 goto _LL5;}_LL5:;}{
# 1825
...
({void*_tmp33F=0U;({unsigned int _tmp78C=body->loc;struct _dyneither_ptr _tmp78B=({const char*_tmp340="Cannot consume non-unique paths; do swap instead";_tag_dyneither(_tmp340,sizeof(char),49U);});Cyc_Tcutil_terr(_tmp78C,_tmp78B,_tag_dyneither(_tmp33F,sizeof(void*),0U));});});
if(te->le == 0){
# 1831
if(!Cyc_Tcutil_is_const_exp(bound))
({void*_tmp341=0U;({unsigned int _tmp78E=bound->loc;struct _dyneither_ptr _tmp78D=({const char*_tmp342="bound is not constant";_tag_dyneither(_tmp342,sizeof(char),22U);});Cyc_Tcutil_terr(_tmp78E,_tmp78D,_tag_dyneither(_tmp341,sizeof(void*),0U));});});
if(!Cyc_Tcutil_is_const_exp(body))
({void*_tmp343=0U;({unsigned int _tmp790=bound->loc;struct _dyneither_ptr _tmp78F=({const char*_tmp344="body is not constant";_tag_dyneither(_tmp344,sizeof(char),21U);});Cyc_Tcutil_terr(_tmp790,_tmp78F,_tag_dyneither(_tmp343,sizeof(void*),0U));});});}
# 1836
...
({struct Cyc_Absyn_Exp*_tmp791=Cyc_Absyn_add_exp(bound,_tmp345,0U);bound=_tmp791;});bound->topt=Cyc_Absyn_uint_typ;
*is_zero_term=1;}
# 1843
if(Cyc_Tcutil_is_noalias_pointer_or_aggr((void*)_check_null(body->topt)) && !
Cyc_Tcutil_is_noalias_path(body))
({void*_tmp346=0U;({unsigned int _tmp793=body->loc;struct _dyneither_ptr _tmp792=({const char*_tmp347="Cannot consume non-unique paths; do swap instead";_tag_dyneither(_tmp347,sizeof(char),49U);});Cyc_Tcutil_terr(_tmp793,_tmp792,_tag_dyneither(_tmp346,sizeof(void*),0U));});});{
# 1847
void*_tmp348=({void*_tmp796=t;struct Cyc_Absyn_Tqual _tmp795=_tmp330 == 0?Cyc_Absyn_empty_tqual(0U):*_tmp330;struct Cyc_Absyn_Exp*_tmp794=bound;Cyc_Absyn_array_typ(_tmp796,_tmp795,_tmp794,
...
# 1861
 if(Cyc_Tcenv_new_status(te)== Cyc_Tcenv_InNewAggr){
struct Cyc_Absyn_Exp*_tmp34B=({void*_tmp797=Cyc_Absyn_uint_typ;Cyc_Absyn_cast_exp(_tmp797,Cyc_Absyn_valueof_exp(_tmp34F,0U),0,Cyc_Absyn_No_coercion,0U);});
...
# 1870
 if(!Cyc_Tcutil_coerce_uint_typ(te,bound))
({struct Cyc_String_pa_PrintArg_struct _tmp34E=({struct Cyc_String_pa_PrintArg_struct _tmp558;_tmp558.tag=0U,({
struct _dyneither_ptr _tmp798=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(bound->topt)));_tmp558.f1=_tmp798;});_tmp558;});void*_tmp34C[1U];_tmp34C[0]=& _tmp34E;({unsigned int _tmp79A=bound->loc;struct _dyneither_ptr _tmp799=({const char*_tmp34D="expecting unsigned int, found %s";_tag_dyneither(_tmp34D,sizeof(char),33U);});Cyc_Tcutil_terr(_tmp79A,_tmp799,_tag_dyneither(_tmp34C,sizeof(void*),1U));});});}_LL0:;}{
# 1875
void**_tmp350=0;
...
# 1882
({void**_tmp79B=({void**_tmp355=_cycalloc(sizeof(*_tmp355));*_tmp355=_tmp35B.elt_typ;_tmp355;});_tmp350=_tmp79B;});
({struct Cyc_Absyn_Tqual*_tmp79C=({struct Cyc_Absyn_Tqual*_tmp356=_cycalloc(sizeof(*_tmp356));*_tmp356=_tmp35B.elt_tq;_tmp356;});_tmp351=_tmp79C;});
({union Cyc_Absyn_Constraint**_tmp79D=({union Cyc_Absyn_Constraint**_tmp357=_cycalloc(sizeof(*_tmp357));*_tmp357=(_tmp35B.ptr_atts).zero_term;_tmp357;});_tmp352=_tmp79D;});
...
# 1887
({void**_tmp79E=({void**_tmp358=_cycalloc(sizeof(*_tmp358));*_tmp358=_tmp35F;_tmp358;});_tmp350=_tmp79E;});
({struct Cyc_Absyn_Tqual*_tmp79F=({struct Cyc_Absyn_Tqual*_tmp359=_cycalloc(sizeof(*_tmp359));*_tmp359=_tmp35E;_tmp359;});_tmp351=_tmp79F;});
({union Cyc_Absyn_Constraint**_tmp7A0=({union Cyc_Absyn_Constraint**_tmp35A=_cycalloc(sizeof(*_tmp35A));*_tmp35A=_tmp35C;_tmp35A;});_tmp352=_tmp7A0;});
goto _LL5;default: _LLA: _LLB:
# 1892
 goto _LL5;}_LL5:;}
# 1895
({unsigned int _tmp7A3=loc;struct Cyc_Tcenv_Tenv*_tmp7A2=te;struct Cyc_List_List*_tmp7A1=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tcutil_check_type(_tmp7A3,_tmp7A2,_tmp7A1,& Cyc_Tcutil_tmk,1,1,t);});
if(_tmp350 != 0)Cyc_Tcutil_unify(*_tmp350,t);
# 1898
if(te->le == 0){
if(!Cyc_Tcutil_is_const_exp(bound))
({void*_tmp360=0U;({unsigned int _tmp7A5=bound->loc;struct _dyneither_ptr _tmp7A4=({const char*_tmp361="bound is not constant";_tag_dyneither(_tmp361,sizeof(char),22U);});Cyc_Tcutil_terr(_tmp7A5,_tmp7A4,_tag_dyneither(_tmp360,sizeof(void*),0U));});});}
# 1902
...
({struct Cyc_Absyn_Exp*_tmp7A6=Cyc_Absyn_add_exp(bound,_tmp362,0U);bound=_tmp7A6;});bound->topt=Cyc_Absyn_uint_typ;
*is_zero_term=1;
# 1909
({void*_tmp363=0U;({unsigned int _tmp7A8=loc;struct _dyneither_ptr _tmp7A7=({const char*_tmp364="non-initializing comprehensions do not currently support @zeroterm arrays";_tag_dyneither(_tmp364,sizeof(char),74U);});Cyc_Tcutil_terr(_tmp7A8,_tmp7A7,_tag_dyneither(_tmp363,sizeof(void*),0U));});});}{
# 1912
void*_tmp365=({void*_tmp7AB=t;struct Cyc_Absyn_Tqual _tmp7AA=_tmp351 == 0?Cyc_Absyn_empty_tqual(0U):*_tmp351;struct Cyc_Absyn_Exp*_tmp7A9=bound;Cyc_Absyn_array_typ(_tmp7AB,_tmp7AA,_tmp7A9,
...
({struct Cyc_Absyn_Aggrdecl**_tmp7AC=({struct Cyc_Absyn_Aggrdecl**_tmp366=_cycalloc(sizeof(*_tmp366));*_tmp366=ad;_tmp366;});adptr=_tmp7AC;});}else{
# 1937
{struct _handler_cons _tmp367;_push_handler(& _tmp367);{int _tmp369=0;if(setjmp(_tmp367.handler))_tmp369=1;if(!_tmp369){({struct Cyc_Absyn_Aggrdecl**_tmp7AD=Cyc_Tcenv_lookup_aggrdecl(te,loc,*tn);adptr=_tmp7AD;});
ad=*adptr;
# 1937
...
# 1940
({struct Cyc_String_pa_PrintArg_struct _tmp36D=({struct Cyc_String_pa_PrintArg_struct _tmp559;_tmp559.tag=0U,({struct _dyneither_ptr _tmp7AE=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(*tn));_tmp559.f1=_tmp7AE;});_tmp559;});void*_tmp36B[1U];_tmp36B[0]=& _tmp36D;({unsigned int _tmp7B0=loc;struct _dyneither_ptr _tmp7AF=({const char*_tmp36C="unbound struct/union name %s";_tag_dyneither(_tmp36C,sizeof(char),29U);});Cyc_Tcutil_terr(_tmp7B0,_tmp7AF,_tag_dyneither(_tmp36B,sizeof(void*),1U));});});
...
# 1946
if(ad->impl == 0){
({struct Cyc_String_pa_PrintArg_struct _tmp371=({struct Cyc_String_pa_PrintArg_struct _tmp55A;_tmp55A.tag=0U,({struct _dyneither_ptr _tmp7B1=(struct _dyneither_ptr)(ad->kind == Cyc_Absyn_StructA?({const char*_tmp372="struct";_tag_dyneither(_tmp372,sizeof(char),7U);}):({const char*_tmp373="union";_tag_dyneither(_tmp373,sizeof(char),6U);}));_tmp55A.f1=_tmp7B1;});_tmp55A;});void*_tmp36F[1U];_tmp36F[0]=& _tmp371;({unsigned int _tmp7B3=loc;struct _dyneither_ptr _tmp7B2=({const char*_tmp370="can't construct abstract %s";_tag_dyneither(_tmp370,sizeof(char),28U);});Cyc_Tcutil_terr(_tmp7B3,_tmp7B2,_tag_dyneither(_tmp36F,sizeof(void*),1U));});});
return Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te));}{
# 1954
struct Cyc_Tcenv_Tenv*te2;
enum Cyc_Tcenv_NewStatus _tmp374=Cyc_Tcenv_new_status(te);
if(_tmp374 == Cyc_Tcenv_InNew)
({struct Cyc_Tcenv_Tenv*_tmp7B4=Cyc_Tcenv_set_new_status(Cyc_Tcenv_InNewAggr,te);te2=_tmp7B4;});else{
# 1963
({struct Cyc_Tcenv_Tenv*_tmp7B5=Cyc_Tcenv_set_new_status(_tmp374,te);te2=_tmp7B5;});}{
# 1965
struct _tuple12 _tmp375=({struct _tuple12 _tmp560;({struct Cyc_List_List*_tmp7B6=Cyc_Tcenv_lookup_type_vars(te2);_tmp560.f1=_tmp7B6;}),_tmp560.f2=Cyc_Core_heap_region;_tmp560;});
...
# 1989
({void*_tmp7B8=(void*)({struct Cyc_Absyn_AggrType_Absyn_Type_struct*_tmp37E=_cycalloc(sizeof(*_tmp37E));_tmp37E->tag=11U,({union Cyc_Absyn_AggrInfoU _tmp7B7=Cyc_Absyn_KnownAggr(adptr);(_tmp37E->f1).aggr_info=_tmp7B7;}),(_tmp37E->f1).targs=_tmp378;_tmp37E;});res_typ=_tmp7B8;});}_LL5:;}else{
# 1992
({void*_tmp7BA=(void*)({struct Cyc_Absyn_AggrType_Absyn_Type_struct*_tmp381=_cycalloc(sizeof(*_tmp381));_tmp381->tag=11U,({union Cyc_Absyn_AggrInfoU _tmp7B9=Cyc_Absyn_KnownAggr(adptr);(_tmp381->f1).aggr_info=_tmp7B9;}),(_tmp381->f1).targs=_tmp378;_tmp381;});res_typ=_tmp7BA;});}{
# 1995
struct Cyc_List_List*_tmp382=*ts;
struct Cyc_List_List*_tmp383=_tmp379;
while(_tmp382 != 0  && _tmp383 != 0){
# 1999
({unsigned int _tmp7BD=loc;struct Cyc_Tcenv_Tenv*_tmp7BC=te2;struct Cyc_List_List*_tmp7BB=Cyc_Tcenv_lookup_type_vars(te2);Cyc_Tcutil_check_type(_tmp7BD,_tmp7BC,_tmp7BB,& Cyc_Tcutil_ak,1,0,(void*)_tmp382->hd);});
...
# 2005
if(_tmp382 != 0)
({void*_tmp384=0U;({unsigned int _tmp7BF=loc;struct _dyneither_ptr _tmp7BE=({const char*_tmp385="too many explicit witness types";_tag_dyneither(_tmp385,sizeof(char),32U);});Cyc_Tcutil_terr(_tmp7BF,_tmp7BE,_tag_dyneither(_tmp384,sizeof(void*),0U));});});
# 2008
*ts=_tmp379;{
# 2011
struct Cyc_List_List*fields=
...
({struct Cyc_Tcenv_Tenv*_tmp7C0=Cyc_Tcenv_clear_abstract_val_ok(te2);Cyc_Tcexp_tcExpInitializer(_tmp7C0,& _tmp388,_tmp392);});
# 2022
if(!Cyc_Tcutil_coerce_arg(te2,_tmp392,_tmp388,& bogus)){
({struct Cyc_String_pa_PrintArg_struct _tmp38B=({struct Cyc_String_pa_PrintArg_struct _tmp55F;_tmp55F.tag=0U,_tmp55F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp393->name);_tmp55F;});struct Cyc_String_pa_PrintArg_struct _tmp38C=({struct Cyc_String_pa_PrintArg_struct _tmp55E;_tmp55E.tag=0U,({
struct _dyneither_ptr _tmp7C1=(struct _dyneither_ptr)(ad->kind == Cyc_Absyn_StructA?({const char*_tmp390="struct";_tag_dyneither(_tmp390,sizeof(char),7U);}):({const char*_tmp391="union";_tag_dyneither(_tmp391,sizeof(char),6U);}));_tmp55E.f1=_tmp7C1;});_tmp55E;});struct Cyc_String_pa_PrintArg_struct _tmp38D=({struct Cyc_String_pa_PrintArg_struct _tmp55D;_tmp55D.tag=0U,({
struct _dyneither_ptr _tmp7C2=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(*tn));_tmp55D.f1=_tmp7C2;});_tmp55D;});struct Cyc_String_pa_PrintArg_struct _tmp38E=({struct Cyc_String_pa_PrintArg_struct _tmp55C;_tmp55C.tag=0U,({struct _dyneither_ptr _tmp7C3=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp388));_tmp55C.f1=_tmp7C3;});_tmp55C;});struct Cyc_String_pa_PrintArg_struct _tmp38F=({struct Cyc_String_pa_PrintArg_struct _tmp55B;_tmp55B.tag=0U,({
struct _dyneither_ptr _tmp7C4=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmp392->topt)));_tmp55B.f1=_tmp7C4;});_tmp55B;});void*_tmp389[5U];_tmp389[0]=& _tmp38B,_tmp389[1]=& _tmp38C,_tmp389[2]=& _tmp38D,_tmp389[3]=& _tmp38E,_tmp389[4]=& _tmp38F;({unsigned int _tmp7C6=_tmp392->loc;struct _dyneither_ptr _tmp7C5=({const char*_tmp38A="field %s of %s %s expects type %s != %s";_tag_dyneither(_tmp38A,sizeof(char),40U);});Cyc_Tcutil_terr(_tmp7C6,_tmp7C5,_tag_dyneither(_tmp389,sizeof(void*),5U));});});
Cyc_Tcutil_explain_failure();}};}{
# 2031
...
({struct Cyc_List_List*_tmp7CA=({struct Cyc_List_List*_tmp397=_cycalloc(sizeof(*_tmp397));({struct _tuple0*_tmp7C9=({struct _tuple0*_tmp396=_cycalloc(sizeof(*_tmp396));({void*_tmp7C8=Cyc_Tcutil_substitute(_tmp37A,(*((struct _tuple0*)_tmp395->hd)).f1);_tmp396->f1=_tmp7C8;}),({
void*_tmp7C7=Cyc_Tcutil_substitute(_tmp37A,(*((struct _tuple0*)_tmp395->hd)).f2);_tmp396->f2=_tmp7C7;});_tmp396;});
# 2033
_tmp397->hd=_tmp7C9;}),_tmp397->tl=_tmp394;_tmp397;});_tmp394=_tmp7CA;});}}
# 2036
({struct Cyc_List_List*_tmp7CB=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp394);_tmp394=_tmp7CB;});
...
({void*_tmp39A=0U;({unsigned int _tmp7CD=loc;struct _dyneither_ptr _tmp7CC=({const char*_tmp39B="expecting struct but found union";_tag_dyneither(_tmp39B,sizeof(char),33U);});Cyc_Tcutil_terr(_tmp7CD,_tmp7CC,_tag_dyneither(_tmp39A,sizeof(void*),0U));});});{
struct Cyc_List_List*fields=
...
({struct Cyc_Tcenv_Tenv*_tmp7CF=Cyc_Tcenv_clear_abstract_val_ok(te);void**_tmp7CE=& _tmp3A4->type;Cyc_Tcexp_tcExpInitializer(_tmp7CF,_tmp7CE,_tmp3A3);});
# 2055
if(!Cyc_Tcutil_coerce_arg(te,_tmp3A3,_tmp3A4->type,& bogus)){
({struct Cyc_String_pa_PrintArg_struct _tmp3A0=({struct Cyc_String_pa_PrintArg_struct _tmp563;_tmp563.tag=0U,_tmp563.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp3A4->name);_tmp563;});struct Cyc_String_pa_PrintArg_struct _tmp3A1=({struct Cyc_String_pa_PrintArg_struct _tmp562;_tmp562.tag=0U,({
struct _dyneither_ptr _tmp7D0=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp3A4->type));_tmp562.f1=_tmp7D0;});_tmp562;});struct Cyc_String_pa_PrintArg_struct _tmp3A2=({struct Cyc_String_pa_PrintArg_struct _tmp561;_tmp561.tag=0U,({
struct _dyneither_ptr _tmp7D1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmp3A3->topt)));_tmp561.f1=_tmp7D1;});_tmp561;});void*_tmp39E[3U];_tmp39E[0]=& _tmp3A0,_tmp39E[1]=& _tmp3A1,_tmp39E[2]=& _tmp3A2;({unsigned int _tmp7D3=_tmp3A3->loc;struct _dyneither_ptr _tmp7D2=({const char*_tmp39F="field %s of struct expects type %s != %s";_tag_dyneither(_tmp39F,sizeof(char),41U);});Cyc_Tcutil_terr(_tmp7D3,_tmp7D2,_tag_dyneither(_tmp39E,sizeof(void*),3U));});});
Cyc_Tcutil_explain_failure();}}
# 2062
goto _LL0;};}else{_LL3: _LL4:
({void*_tmp3A5=0U;({struct _dyneither_ptr _tmp7D4=({const char*_tmp3A6="tcAnonStruct: wrong type";_tag_dyneither(_tmp3A6,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp7D4,_tag_dyneither(_tmp3A5,sizeof(void*),0U));});});}_LL0:;}
# 2065
return ts;}
# 2069
static void*Cyc_Tcexp_tcDatatype(struct Cyc_Tcenv_Tenv*te,unsigned int loc,void**topt,struct Cyc_Absyn_Exp*e,struct Cyc_List_List*es,struct Cyc_Absyn_Datatypedecl*tud,struct Cyc_Absyn_Datatypefield*tuf){
# 2072
struct _tuple12 _tmp3A9=({struct _tuple12 _tmp569;({struct Cyc_List_List*_tmp7D5=Cyc_Tcenv_lookup_type_vars(te);_tmp569.f1=_tmp7D5;}),_tmp569.f2=Cyc_Core_heap_region;_tmp569;});
...
_tmp3BA->tag=4U,({union Cyc_Absyn_DatatypeFieldInfoU _tmp7D6=Cyc_Absyn_KnownDatatypefield(tud,tuf);(_tmp3BA->f1).field_info=_tmp7D6;}),(_tmp3BA->f1).targs=_tmp3AB;_tmp3BA;});
# 2079
if(topt != 0){
...
if(_tmp3AA != 0)({void*_tmp7D7=Cyc_Tcutil_substitute(_tmp3AA,t);t=_tmp7D7;});
Cyc_Tcexp_tcExpInitializer(te,& t,e);
if(!Cyc_Tcutil_coerce_arg(te,e,t,& bogus)){
({struct Cyc_String_pa_PrintArg_struct _tmp3B0=({struct Cyc_String_pa_PrintArg_struct _tmp566;_tmp566.tag=0U,({
# 2095
struct _dyneither_ptr _tmp7D8=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(tuf->name));_tmp566.f1=_tmp7D8;});_tmp566;});struct Cyc_String_pa_PrintArg_struct _tmp3B1=({struct Cyc_String_pa_PrintArg_struct _tmp565;_tmp565.tag=0U,({struct _dyneither_ptr _tmp7D9=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp565.f1=_tmp7D9;});_tmp565;});struct Cyc_String_pa_PrintArg_struct _tmp3B2=({struct Cyc_String_pa_PrintArg_struct _tmp564;_tmp564.tag=0U,({
struct _dyneither_ptr _tmp7DA=(struct _dyneither_ptr)((struct _dyneither_ptr)(e->topt == 0?(struct _dyneither_ptr)({const char*_tmp3B3="?";_tag_dyneither(_tmp3B3,sizeof(char),2U);}): Cyc_Absynpp_typ2string((void*)_check_null(e->topt))));_tmp564.f1=_tmp7DA;});_tmp564;});void*_tmp3AE[3U];_tmp3AE[0]=& _tmp3B0,_tmp3AE[1]=& _tmp3B1,_tmp3AE[2]=& _tmp3B2;({unsigned int _tmp7DC=e->loc;struct _dyneither_ptr _tmp7DB=({const char*_tmp3AF="datatype constructor %s expects argument of type %s but this argument has type %s";_tag_dyneither(_tmp3AF,sizeof(char),82U);});Cyc_Tcutil_terr(_tmp7DC,_tmp7DB,_tag_dyneither(_tmp3AE,sizeof(void*),3U));});});
Cyc_Tcutil_explain_failure();}}
# 2100
if(es != 0)
return({struct Cyc_String_pa_PrintArg_struct _tmp3B6=({struct Cyc_String_pa_PrintArg_struct _tmp567;_tmp567.tag=0U,({
# 2103
struct _dyneither_ptr _tmp7DD=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(tuf->name));_tmp567.f1=_tmp7DD;});_tmp567;});void*_tmp3B4[1U];_tmp3B4[0]=& _tmp3B6;({struct Cyc_Tcenv_Tenv*_tmp7E1=te;unsigned int _tmp7E0=((struct Cyc_Absyn_Exp*)es->hd)->loc;void**_tmp7DF=topt;struct _dyneither_ptr _tmp7DE=({const char*_tmp3B5="too many arguments for datatype constructor %s";_tag_dyneither(_tmp3B5,sizeof(char),47U);});Cyc_Tcexp_expr_err(_tmp7E1,_tmp7E0,_tmp7DF,_tmp7DE,_tag_dyneither(_tmp3B4,sizeof(void*),1U));});});
if(ts != 0)
return({struct Cyc_String_pa_PrintArg_struct _tmp3B9=({struct Cyc_String_pa_PrintArg_struct _tmp568;_tmp568.tag=0U,({
struct _dyneither_ptr _tmp7E2=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(tuf->name));_tmp568.f1=_tmp7E2;});_tmp568;});void*_tmp3B7[1U];_tmp3B7[0]=& _tmp3B9;({struct Cyc_Tcenv_Tenv*_tmp7E6=te;unsigned int _tmp7E5=loc;void**_tmp7E4=topt;struct _dyneither_ptr _tmp7E3=({const char*_tmp3B8="too few arguments for datatype constructor %s";_tag_dyneither(_tmp3B8,sizeof(char),46U);});Cyc_Tcexp_expr_err(_tmp7E6,_tmp7E5,_tmp7E4,_tmp7E3,_tag_dyneither(_tmp3B7,sizeof(void*),1U));});});
return res;};}
# 2110
...
goto _LL0;}else{_LL3: _LL4:
 goto _LL0;}_LL0:;}
# 2123
({struct Cyc_String_pa_PrintArg_struct _tmp3C0=({struct Cyc_String_pa_PrintArg_struct _tmp56B;_tmp56B.tag=0U,({
struct _dyneither_ptr _tmp7E7=(struct _dyneither_ptr)((struct _dyneither_ptr)(allow_zero?(struct _dyneither_ptr)({const char*_tmp3C2="calloc";_tag_dyneither(_tmp3C2,sizeof(char),7U);}):(struct _dyneither_ptr)({const char*_tmp3C3="malloc";_tag_dyneither(_tmp3C3,sizeof(char),7U);})));_tmp56B.f1=_tmp7E7;});_tmp56B;});struct Cyc_String_pa_PrintArg_struct _tmp3C1=({struct Cyc_String_pa_PrintArg_struct _tmp56A;_tmp56A.tag=0U,({struct _dyneither_ptr _tmp7E8=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp56A.f1=_tmp7E8;});_tmp56A;});void*_tmp3BE[2U];_tmp3BE[0]=& _tmp3C0,_tmp3BE[1]=& _tmp3C1;({unsigned int _tmp7EA=loc;struct _dyneither_ptr _tmp7E9=({const char*_tmp3BF="%s cannot be used with type %s\n\t(type needs initialization)";_tag_dyneither(_tmp3BF,sizeof(char),60U);});Cyc_Tcutil_terr(_tmp7EA,_tmp7E9,_tag_dyneither(_tmp3BE,sizeof(void*),2U));});});}
# 2127
...
_tmp3CC->tag=15U,({void*_tmp7EB=Cyc_Absyn_new_evar(& Cyc_Tcutil_trko,Cyc_Tcenv_lookup_opt_type_vars(te));_tmp3CC->f1=_tmp7EB;});_tmp3CC;});
...
goto _LL0;}else{_LL3: _LL4:
# 2152
({struct Cyc_String_pa_PrintArg_struct _tmp3CA=({struct Cyc_String_pa_PrintArg_struct _tmp56C;_tmp56C.tag=0U,({
struct _dyneither_ptr _tmp7EC=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(handle_type));_tmp56C.f1=_tmp7EC;});_tmp56C;});void*_tmp3C8[1U];_tmp3C8[0]=& _tmp3CA;({unsigned int _tmp7EE=((struct Cyc_Absyn_Exp*)_check_null(*ropt))->loc;struct _dyneither_ptr _tmp7ED=({const char*_tmp3C9="expecting region_t type but found %s";_tag_dyneither(_tmp3C9,sizeof(char),37U);});Cyc_Tcutil_terr(_tmp7EE,_tmp7ED,_tag_dyneither(_tmp3C8,sizeof(void*),1U));});});
goto _LL0;}_LL0:;}else{
# 2159
if(topt != 0){
void*optrgn=(void*)& Cyc_Absyn_VoidType_val;
if(Cyc_Tcutil_rgn_of_pointer(*topt,& optrgn)){
({void*_tmp7EF=Cyc_Tcexp_mallocRgn(optrgn);rgn=_tmp7EF;});
if(rgn == (void*)& Cyc_Absyn_UniqueRgn_val)*ropt=Cyc_Absyn_uniquergn_exp;}}}
# 2166
({struct Cyc_Tcenv_Tenv*_tmp7F0=Cyc_Tcenv_clear_abstract_val_ok(te);Cyc_Tcexp_tcExp(_tmp7F0,& Cyc_Absyn_uint_typ,*e);});{
# 2175 "tcexp.cyc"
void*elt_type;
struct Cyc_Absyn_Exp*num_elts;
int one_elt;
if(*is_calloc){
if(*t == 0)({void*_tmp3CD=0U;({struct _dyneither_ptr _tmp7F1=({const char*_tmp3CE="calloc with empty type";_tag_dyneither(_tmp3CE,sizeof(char),23U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp7F1,_tag_dyneither(_tmp3CD,sizeof(void*),0U));});});
elt_type=*((void**)_check_null(*t));
({unsigned int _tmp7F4=loc;struct Cyc_Tcenv_Tenv*_tmp7F3=te;struct Cyc_List_List*_tmp7F2=Cyc_Tcenv_lookup_type_vars(te);Cyc_Tcutil_check_type(_tmp7F4,_tmp7F3,_tmp7F2,& Cyc_Tcutil_tmk,1,0,elt_type);});
...
# 2191
 elt_type=_tmp3E2;
({void**_tmp7F5=({void**_tmp3D0=_cycalloc(sizeof(*_tmp3D0));*_tmp3D0=elt_type;_tmp3D0;});*t=_tmp7F5;});
({struct Cyc_Absyn_Exp*_tmp7F6=Cyc_Absyn_uint_exp(1U,0U);num_elts=_tmp7F6;});
...
# 2198
{struct _tuple0 _tmp3D1=({struct _tuple0 _tmp56D;_tmp56D.f1=_tmp3E4->r,_tmp56D.f2=_tmp3E3->r;_tmp56D;});struct _tuple0 _tmp3D2=_tmp3D1;void*_tmp3D6;void*_tmp3D5;if(((struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*)_tmp3D2.f1)->tag == 17U){_LLD: _tmp3D5=(void*)((struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*)_tmp3D2.f1)->f1;_LLE:
# 2200
 Cyc_Tcexp_check_malloc_type(0,loc,topt,_tmp3D5);
elt_type=_tmp3D5;
({void**_tmp7F7=({void**_tmp3D3=_cycalloc(sizeof(*_tmp3D3));*_tmp3D3=elt_type;_tmp3D3;});*t=_tmp7F7;});
num_elts=_tmp3E3;
one_elt=0;
...
elt_type=_tmp3D6;
({void**_tmp7F8=({void**_tmp3D4=_cycalloc(sizeof(*_tmp3D4));*_tmp3D4=elt_type;_tmp3D4;});*t=_tmp7F8;});
num_elts=_tmp3E4;
one_elt=0;
...
({void**_tmp7F9=({void**_tmp3E1=_cycalloc(sizeof(*_tmp3E1));*_tmp3E1=elt_type;_tmp3E1;});*t=_tmp7F9;});
num_elts=*e;
one_elt=0;}
# 2240
goto _LL5;}_LL5:;}}
...
({void*_tmp3E6=0U;({unsigned int _tmp7FB=loc;struct _dyneither_ptr _tmp7FA=({const char*_tmp3E7="malloc with existential types not yet implemented";_tag_dyneither(_tmp3E7,sizeof(char),50U);});Cyc_Tcutil_terr(_tmp7FB,_tmp7FA,_tag_dyneither(_tmp3E6,sizeof(void*),0U));});});
...
({void*_tmp3ED=0U;({unsigned int _tmp7FD=loc;struct _dyneither_ptr _tmp7FC=({const char*_tmp3EE="converting malloc to calloc to ensure zero-termination";_tag_dyneither(_tmp3EE,sizeof(char),55U);});Cyc_Tcutil_warn(_tmp7FD,_tmp7FC,_tag_dyneither(_tmp3ED,sizeof(void*),0U));});});
*is_calloc=1;}
# 2272
...
*is_fat=0;
return({void*_tmp801=elt_type;void*_tmp800=rgn;struct Cyc_Absyn_Tqual _tmp7FF=Cyc_Absyn_empty_tqual(0U);void*_tmp7FE=((void*(*)(union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_val)(_tmp3F8);Cyc_Absyn_atb_typ(_tmp801,_tmp800,_tmp7FF,_tmp7FE,_tmp3EA);});}
# 2281
...
# 2283
struct Cyc_Absyn_Exp*_tmp3F4=({void*_tmp802=Cyc_Absyn_uint_typ;Cyc_Absyn_cast_exp(_tmp802,Cyc_Absyn_valueof_exp(_tmp3F5,0U),0,Cyc_Absyn_No_coercion,0U);});
# 2285
if(Cyc_Evexp_same_const_exp(_tmp3F4,_tmp3F6)){
*is_fat=0;
return({void*_tmp806=elt_type;void*_tmp805=rgn;struct Cyc_Absyn_Tqual _tmp804=Cyc_Absyn_empty_tqual(0U);void*_tmp803=((void*(*)(union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_val)(_tmp3F8);Cyc_Absyn_atb_typ(_tmp806,_tmp805,_tmp804,_tmp803,_tmp3EA);});}
# 2290
...
return({void*(*_tmp80A)(void*t,void*rgn,struct Cyc_Absyn_Tqual tq,union Cyc_Absyn_Constraint*zero_term)=_tmp3E9;void*_tmp809=elt_type;void*_tmp808=rgn;struct Cyc_Absyn_Tqual _tmp807=Cyc_Absyn_empty_tqual(0U);_tmp80A(_tmp809,_tmp808,_tmp807,_tmp3EA);});};};}
# 2304
...
({void*_tmp3FE=0U;({unsigned int _tmp80C=loc;struct _dyneither_ptr _tmp80B=({const char*_tmp3FF="cannot assign to an array";_tag_dyneither(_tmp3FF,sizeof(char),26U);});Cyc_Tcutil_terr(_tmp80C,_tmp80B,_tag_dyneither(_tmp3FE,sizeof(void*),0U));});});goto _LL0;}else{_LL3: _LL4:
 goto _LL0;}_LL0:;}
# 2318
if(!Cyc_Tcutil_is_boxed(t1) && !Cyc_Tcutil_is_pointer_type(t1))
({void*_tmp400=0U;({unsigned int _tmp80E=loc;struct _dyneither_ptr _tmp80D=({const char*_tmp401="Swap not allowed for non-pointer or non-word-sized types.";_tag_dyneither(_tmp401,sizeof(char),58U);});Cyc_Tcutil_terr(_tmp80E,_tmp80D,_tag_dyneither(_tmp400,sizeof(void*),0U));});});
# 2322
if(!Cyc_Absyn_is_lvalue(e1))
return({void*_tmp402=0U;({struct Cyc_Tcenv_Tenv*_tmp812=te;unsigned int _tmp811=e1->loc;void**_tmp810=topt;struct _dyneither_ptr _tmp80F=({const char*_tmp403="swap non-lvalue";_tag_dyneither(_tmp403,sizeof(char),16U);});Cyc_Tcexp_expr_err(_tmp812,_tmp811,_tmp810,_tmp80F,_tag_dyneither(_tmp402,sizeof(void*),0U));});});
if(!Cyc_Absyn_is_lvalue(e2))
return({void*_tmp404=0U;({struct Cyc_Tcenv_Tenv*_tmp816=te;unsigned int _tmp815=e2->loc;void**_tmp814=topt;struct _dyneither_ptr _tmp813=({const char*_tmp405="swap non-lvalue";_tag_dyneither(_tmp405,sizeof(char),16U);});Cyc_Tcexp_expr_err(_tmp816,_tmp815,_tmp814,_tmp813,_tag_dyneither(_tmp404,sizeof(void*),0U));});});{
# 2327
...
return({void*_tmp406=0U;({struct Cyc_Tcenv_Tenv*_tmp81A=te;unsigned int _tmp819=e1->loc;void**_tmp818=topt;struct _dyneither_ptr _tmp817=({const char*_tmp407="swap value in zeroterm array";_tag_dyneither(_tmp407,sizeof(char),29U);});Cyc_Tcexp_expr_err(_tmp81A,_tmp819,_tmp818,_tmp817,_tag_dyneither(_tmp406,sizeof(void*),0U));});});
if(Cyc_Tcutil_is_zero_ptr_deref(e2,& t_ign1,& b_ign1,& t_ign2))
return({void*_tmp408=0U;({struct Cyc_Tcenv_Tenv*_tmp81E=te;unsigned int _tmp81D=e2->loc;void**_tmp81C=topt;struct _dyneither_ptr _tmp81B=({const char*_tmp409="swap value in zeroterm array";_tag_dyneither(_tmp409,sizeof(char),29U);});Cyc_Tcexp_expr_err(_tmp81E,_tmp81D,_tmp81C,_tmp81B,_tag_dyneither(_tmp408,sizeof(void*),0U));});});
# 2334
Cyc_Tcexp_check_writable(te,e1);
...
struct _dyneither_ptr _tmp81F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t1));_tmp56F.f1=_tmp81F;});_tmp56F;});struct Cyc_String_pa_PrintArg_struct _tmp40E=({struct Cyc_String_pa_PrintArg_struct _tmp56E;_tmp56E.tag=0U,({struct _dyneither_ptr _tmp820=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t2));_tmp56E.f1=_tmp820;});_tmp56E;});void*_tmp40B[2U];_tmp40B[0]=& _tmp40D,_tmp40B[1]=& _tmp40E;({struct Cyc_Tcenv_Tenv*_tmp824=te;unsigned int _tmp823=loc;void**_tmp822=topt;struct _dyneither_ptr _tmp821=({const char*_tmp40C="type mismatch: %s != %s";_tag_dyneither(_tmp40C,sizeof(char),24U);});Cyc_Tcexp_expr_err(_tmp824,_tmp823,_tmp822,_tmp821,_tag_dyneither(_tmp40B,sizeof(void*),2U));});});
return _tmp40A;}
# 2341
...
({struct Cyc_Tcenv_Tenv*_tmp825=Cyc_Tcenv_enter_stmt_exp(Cyc_Tcenv_clear_abstract_val_ok(te));Cyc_Tcstmt_tcStmt(_tmp825,s,1);});
# 2349
while(1){
...
if(!({void*_tmp826=_tmp411;Cyc_Tcutil_unify(_tmp826,Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te)));})){
({struct Cyc_String_pa_PrintArg_struct _tmp414=({struct Cyc_String_pa_PrintArg_struct _tmp570;_tmp570.tag=0U,({
struct _dyneither_ptr _tmp827=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp411));_tmp570.f1=_tmp827;});_tmp570;});void*_tmp412[1U];_tmp412[0]=& _tmp414;({unsigned int _tmp829=loc;struct _dyneither_ptr _tmp828=({const char*_tmp413="statement expression returns type %s";_tag_dyneither(_tmp413,sizeof(char),37U);});Cyc_Tcutil_terr(_tmp829,_tmp828,_tag_dyneither(_tmp412,sizeof(void*),1U));});});
Cyc_Tcutil_explain_failure();}
# 2359
...
# 2363
 return({void*_tmp415=0U;({struct Cyc_Tcenv_Tenv*_tmp82D=te;unsigned int _tmp82C=loc;void**_tmp82B=topt;struct _dyneither_ptr _tmp82A=({const char*_tmp416="statement expression must end with expression";_tag_dyneither(_tmp416,sizeof(char),46U);});Cyc_Tcexp_expr_err(_tmp82D,_tmp82C,_tmp82B,_tmp82A,_tag_dyneither(_tmp415,sizeof(void*),0U));});});}_LL0:;}}
# 2368
...
void*t=Cyc_Tcutil_compress(({struct Cyc_Tcenv_Tenv*_tmp82E=Cyc_Tcenv_enter_abstract_val_ok(te);Cyc_Tcexp_tcExp(_tmp82E,0,e);}));
...
# 2375
({struct Cyc_String_pa_PrintArg_struct _tmp41F=({struct Cyc_String_pa_PrintArg_struct _tmp571;_tmp571.tag=0U,({struct _dyneither_ptr _tmp82F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp571.f1=_tmp82F;});_tmp571;});void*_tmp41D[1U];_tmp41D[0]=& _tmp41F;({unsigned int _tmp831=loc;struct _dyneither_ptr _tmp830=({const char*_tmp41E="expecting @tagged union but found %s";_tag_dyneither(_tmp41E,sizeof(char),37U);});Cyc_Tcutil_terr(_tmp831,_tmp830,_tag_dyneither(_tmp41D,sizeof(void*),1U));});});
goto _LL0;}_LL0:;}
# 2378
return Cyc_Absyn_uint_typ;}
# 2382
...
_tmp428->tag=15U,({void*_tmp832=Cyc_Absyn_new_evar(& Cyc_Tcutil_trko,Cyc_Tcenv_lookup_opt_type_vars(_tmp421));_tmp428->f1=_tmp832;});_tmp428;});
...
struct _dyneither_ptr _tmp833=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(handle_type));_tmp572.f1=_tmp833;});_tmp572;});void*_tmp424[1U];_tmp424[0]=& _tmp426;({unsigned int _tmp835=((struct Cyc_Absyn_Exp*)_check_null(*rgn_handle))->loc;struct _dyneither_ptr _tmp834=({const char*_tmp425="expecting region_t type but found %s";_tag_dyneither(_tmp425,sizeof(char),37U);});Cyc_Tcutil_terr(_tmp835,_tmp834,_tag_dyneither(_tmp424,sizeof(void*),1U));});});
goto _LL0;}_LL0:;}else{
# 2406
if(topt != 0){
void*optrgn=(void*)& Cyc_Absyn_VoidType_val;
if(Cyc_Tcutil_rgn_of_pointer(*topt,& optrgn)){
({void*_tmp836=Cyc_Tcexp_mallocRgn(optrgn);rgn=_tmp836;});
...
({void*_tmp42B=0U;({struct _dyneither_ptr _tmp837=({const char*_tmp42C="tcNew: comprehension returned non-array type";_tag_dyneither(_tmp42C,sizeof(char),45U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp837,_tag_dyneither(_tmp42B,sizeof(void*),0U));});});
({void*_tmp838=Cyc_Tcutil_promote_array(res_typ,rgn,1);res_typ=_tmp838;});
if(topt != 0){
...
# 2432
({void*_tmp839=(void*)({struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_tmp42D=_cycalloc(sizeof(*_tmp42D));_tmp42D->tag=26U,_tmp42D->f1=_tmp442;_tmp42D;});e1->r=_tmp839;});
...
# 2441
 elt_typ_opt=_tmp432;
({int _tmp83A=((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp430);zero_term=_tmp83A;});
...
e1->topt=res_typ;
if(!Cyc_Tcutil_is_array(res_typ))
({void*_tmp433=0U;({struct _dyneither_ptr _tmp83B=({const char*_tmp434="tcExpNoPromote on Array_e returned non-array type";_tag_dyneither(_tmp434,sizeof(char),50U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp83B,_tag_dyneither(_tmp433,sizeof(void*),0U));});});
({void*_tmp83C=Cyc_Tcutil_promote_array(res_typ,rgn,0);res_typ=_tmp83C;});
if(topt != 0){
# 2456
if(!Cyc_Tcutil_unify(*topt,res_typ) && Cyc_Tcutil_silent_castable(_tmp421,loc,res_typ,*topt)){
e->topt=res_typ;
...
# 2467
void*_tmp435=({void*_tmp83F=Cyc_Absyn_char_typ;void*_tmp83E=rgn;struct Cyc_Absyn_Tqual _tmp83D=Cyc_Absyn_const_tqual(0U);Cyc_Absyn_atb_typ(_tmp83F,_tmp83E,_tmp83D,(void*)& Cyc_Absyn_DynEither_b_val,Cyc_Absyn_true_conref);});
# 2469
void*_tmp436=Cyc_Tcexp_tcExp(_tmp421,& _tmp435,e1);
return({void*_tmp844=_tmp436;void*_tmp843=rgn;struct Cyc_Absyn_Tqual _tmp842=Cyc_Absyn_empty_tqual(0U);void*_tmp841=(void*)({struct Cyc_Absyn_Upper_b_Absyn_Bounds_struct*_tmp437=_cycalloc(sizeof(*_tmp437));_tmp437->tag=1U,({struct Cyc_Absyn_Exp*_tmp840=Cyc_Absyn_uint_exp(1U,0U);_tmp437->f1=_tmp840;});_tmp437;});Cyc_Absyn_atb_typ(_tmp844,_tmp843,_tmp842,_tmp841,Cyc_Absyn_false_conref);});}case 9U: _LL10: _LL11: {
# 2474
void*_tmp438=({void*_tmp847=Cyc_Absyn_wchar_typ();void*_tmp846=rgn;struct Cyc_Absyn_Tqual _tmp845=Cyc_Absyn_const_tqual(0U);Cyc_Absyn_atb_typ(_tmp847,_tmp846,_tmp845,(void*)& Cyc_Absyn_DynEither_b_val,Cyc_Absyn_true_conref);});
# 2476
void*_tmp439=Cyc_Tcexp_tcExp(_tmp421,& _tmp438,e1);
return({void*_tmp84C=_tmp439;void*_tmp84B=rgn;struct Cyc_Absyn_Tqual _tmp84A=Cyc_Absyn_empty_tqual(0U);void*_tmp849=(void*)({struct Cyc_Absyn_Upper_b_Absyn_Bounds_struct*_tmp43A=_cycalloc(sizeof(*_tmp43A));_tmp43A->tag=1U,({struct Cyc_Absyn_Exp*_tmp848=Cyc_Absyn_uint_exp(1U,0U);_tmp43A->f1=_tmp848;});_tmp43A;});Cyc_Absyn_atb_typ(_tmp84C,_tmp84B,_tmp84A,_tmp849,Cyc_Absyn_false_conref);});}default: goto _LL12;}default: _LL12: _LL13:
# 2483
 RG: {
...
({void*_tmp43F=0U;({unsigned int _tmp84E=e1->loc;struct _dyneither_ptr _tmp84D=({const char*_tmp440="Cannot consume non-unique paths; do swap instead";_tag_dyneither(_tmp440,sizeof(char),49U);});Cyc_Tcutil_terr(_tmp84E,_tmp84D,_tag_dyneither(_tmp43F,sizeof(void*),0U));});});{
void*res_typ=(void*)({struct Cyc_Absyn_PointerType_Absyn_Type_struct*_tmp441=_cycalloc(sizeof(*_tmp441));
_tmp441->tag=5U,(_tmp441->f1).elt_typ=telt,({struct Cyc_Absyn_Tqual _tmp850=Cyc_Absyn_empty_tqual(0U);(_tmp441->f1).elt_tq=_tmp850;}),
((_tmp441->f1).ptr_atts).rgn=rgn,({union Cyc_Absyn_Constraint*_tmp84F=((union Cyc_Absyn_Constraint*(*)())Cyc_Absyn_empty_conref)();((_tmp441->f1).ptr_atts).nullable=_tmp84F;}),((_tmp441->f1).ptr_atts).bounds=Cyc_Absyn_bounds_one_conref,((_tmp441->f1).ptr_atts).zero_term=Cyc_Absyn_false_conref,((_tmp441->f1).ptr_atts).ptrloc=0;_tmp441;});
# 2508
if(topt != 0){
if(!Cyc_Tcutil_unify(*topt,res_typ) && Cyc_Tcutil_silent_castable(_tmp421,loc,res_typ,*topt)){
e->topt=res_typ;
...
({void*_tmp853=({void*_tmp852=({void*_tmp851=t;Cyc_Tcutil_promote_array(_tmp851,(Cyc_Tcutil_addressof_props(te,e)).f2,0);});t=_tmp852;});e->topt=_tmp853;});
return t;}
# 2531
...
# 2540
({void*_tmp445=0U;({unsigned int _tmp855=e->loc;struct _dyneither_ptr _tmp854=({const char*_tmp446="Cannot consume non-unique paths; do swap instead";_tag_dyneither(_tmp446,sizeof(char),49U);});Cyc_Tcutil_terr(_tmp855,_tmp854,_tag_dyneither(_tmp445,sizeof(void*),0U));});});{
# 2542
...
# 2549
({void*_tmp856=Cyc_Tcutil_compress(t);t=_tmp856;});
if(Cyc_Tcutil_is_array(t)){
({void*_tmp858=({void*_tmp857=t;Cyc_Tcutil_promote_array(_tmp857,(Cyc_Tcutil_addressof_props(te,e)).f2,0);});t=_tmp858;});
...
({void*_tmp859=Cyc_Absyn_pointer_expand((void*)_check_null(_tmp468->topt),0);_tmp468->topt=_tmp859;});
e->topt=_tmp468->topt;
goto _LL0;}else{_LL3: _LL4:
# 2575
 Cyc_Tcexp_tcExpNoInst(te,topt,e);
({void*_tmp85A=Cyc_Absyn_pointer_expand((void*)_check_null(e->topt),0);e->topt=_tmp85A;});
# 2578
...
# 2582
 if(_tmp461 != 0){
struct _tuple12 _tmp44F=({struct _tuple12 _tmp573;({struct Cyc_List_List*_tmp85B=Cyc_Tcenv_lookup_type_vars(te);_tmp573.f1=_tmp85B;}),_tmp573.f2=Cyc_Core_heap_region;_tmp573;});
...
# 2590
({struct Cyc_List_List*_tmp85C=Cyc_Tcutil_rsubst_rgnpo(Cyc_Core_heap_region,inst,_tmp45A);_tmp45A=_tmp85C;});
Cyc_Tcenv_check_rgn_partial_order(te,e->loc,_tmp45A);{
void*ftyp=({struct Cyc_List_List*_tmp85D=inst;Cyc_Tcutil_substitute(_tmp85D,(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp454=_cycalloc(sizeof(*_tmp454));
...
({void*_tmp85E=(void*)({struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*_tmp452=_cycalloc(sizeof(*_tmp452));_tmp452->tag=13U,_tmp452->f1=_tmp451,_tmp452->f2=ts;_tmp452;});e->r=_tmp85E;});
e->topt=(void*)_tmp450;};}
# 2603
goto _LLA;}else{_LLD: _LLE:
 goto _LLA;}_LLA:;}
...
if(_tmp47F == 0)
({void*_tmp470=0U;({struct _dyneither_ptr _tmp860=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp473=({struct Cyc_Int_pa_PrintArg_struct _tmp575;_tmp575.tag=1U,_tmp575.f1=(unsigned long)_tmp46F;_tmp575;});struct Cyc_Int_pa_PrintArg_struct _tmp474=({struct Cyc_Int_pa_PrintArg_struct _tmp574;_tmp574.tag=1U,_tmp574.f1=(unsigned long)((int)_tmp46E->hd);_tmp574;});void*_tmp471[2U];_tmp471[0]=& _tmp473,_tmp471[1]=& _tmp474;({struct _dyneither_ptr _tmp85F=({const char*_tmp472="bad count %d/%d for alias coercion!";_tag_dyneither(_tmp472,sizeof(char),36U);});Cyc_aprintf(_tmp85F,_tag_dyneither(_tmp471,sizeof(void*),2U));});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp860,_tag_dyneither(_tmp470,sizeof(void*),0U));});});
# 2634
++ _tmp46F;
_tmp47F=_tmp47F->tl;
_tmp47C=((struct Cyc_List_List*)_check_null(_tmp47C))->tl;}{
# 2639
struct _tuple11 _tmp475=({struct Cyc_Absyn_Exp*_tmp861=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp47F))->hd;Cyc_Tcutil_insert_alias(_tmp861,Cyc_Tcutil_copy_type((void*)_check_null(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp47C))->hd)->topt)));});struct _tuple11 _tmp476=_tmp475;struct Cyc_Absyn_Decl*_tmp479;struct Cyc_Absyn_Exp*_tmp478;_LLB: _tmp479=_tmp476.f1;_tmp478=_tmp476.f2;_LLC:;
_tmp47F->hd=(void*)_tmp478;
({struct Cyc_List_List*_tmp862=({struct Cyc_List_List*_tmp477=_cycalloc(sizeof(*_tmp477));_tmp477->hd=_tmp479,_tmp477->tl=_tmp469;_tmp477;});_tmp469=_tmp862;});
_tmp46E=_tmp46E->tl;};}
# 2644
goto _LL5;}}else{_LL8: _LL9:
({void*_tmp47A=0U;({struct _dyneither_ptr _tmp863=({const char*_tmp47B="not a function call!";_tag_dyneither(_tmp47B,sizeof(char),21U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp863,_tag_dyneither(_tmp47A,sizeof(void*),0U));});});}_LL5:;}
# 2647
goto _LL0;}else{_LL3: _LL4:
({void*_tmp47D=0U;({struct _dyneither_ptr _tmp864=({const char*_tmp47E="not a function call!";_tag_dyneither(_tmp47E,sizeof(char),21U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp864,_tag_dyneither(_tmp47D,sizeof(void*),0U));});});}_LL0:;}
# 2652
while(_tmp469 != 0){
struct Cyc_Absyn_Decl*_tmp480=(struct Cyc_Absyn_Decl*)_tmp469->hd;
({struct Cyc_Absyn_Exp*_tmp868=({struct Cyc_Absyn_Stmt*_tmp867=({struct Cyc_Absyn_Decl*_tmp866=_tmp480;struct Cyc_Absyn_Stmt*_tmp865=Cyc_Absyn_exp_stmt(fn_exp,e->loc);Cyc_Absyn_decl_stmt(_tmp866,_tmp865,e->loc);});Cyc_Absyn_stmt_exp(_tmp867,e->loc);});fn_exp=_tmp868;});
_tmp469=_tmp469->tl;}
# 2659
e->topt=0;
e->r=fn_exp->r;}
...
# 2678
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp484=_cycalloc(sizeof(*_tmp484));_tmp484->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp869=({const char*_tmp483="unresolved function in tcExpNoInst";_tag_dyneither(_tmp483,sizeof(char),35U);});_tmp484->f1=_tmp869;});_tmp484;}));}else{_LL1B: _tmp49C=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp49B=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_tmp49A=(struct Cyc_Absyn_VarargCallInfo**)&((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp482)->f3;_LL1C: {
# 2711
...
({struct Cyc_Absyn_Exp*_tmp86A=Cyc_Tcutil_deep_copy_exp(0,e);fn_exp=_tmp86A;});;_pop_handler();}else{void*_tmp486=(void*)_exn_thrown;void*_tmp488=_tmp486;void*_tmp489;if(((struct Cyc_Core_Failure_exn_struct*)_tmp488)->tag == Cyc_Core_Failure){_LL58: _LL59:
# 2718
 ok=0;
fn_exp=e;
goto _LL57;}else{_LL5A: _tmp489=_tmp488;_LL5B:(int)_rethrow(_tmp489);}_LL57:;}};}
# 2722
({void*_tmp86B=Cyc_Tcexp_tcFnCall(te,loc,topt,_tmp49C,_tmp49B,_tmp49A,& alias_arg_exps);t=_tmp86B;});
if(alias_arg_exps != 0  && ok){
({struct Cyc_List_List*_tmp86C=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(alias_arg_exps);alias_arg_exps=_tmp86C;});
...
# 2687
({void*_tmp86D=Cyc_Tcexp_tcConst(te,loc,topt,_tmp49F,e);t=_tmp86D;});goto _LL0;case 1U: _LL9: _tmp4A0=(void**)&((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LLA:
# 2689
({void*_tmp86E=Cyc_Tcexp_tcVar(te,loc,topt,e,_tmp4A0);t=_tmp86E;});goto _LL0;case 2U: _LLB: _LLC:
# 2691
...
# 2693
({void*_tmp86F=Cyc_Tcexp_tcPrimop(te,loc,topt,_tmp4A2,_tmp4A1);t=_tmp86F;});goto _LL0;case 5U: _LLF: _tmp4A4=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4A3=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL10:
# 2695
({void*_tmp870=Cyc_Tcexp_tcIncrement(te,loc,topt,_tmp4A4,_tmp4A3);t=_tmp870;});goto _LL0;case 4U: _LL11: _tmp4A7=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4A6=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_tmp4A5=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp482)->f3;_LL12:
# 2697
({void*_tmp871=Cyc_Tcexp_tcAssignOp(te,loc,topt,_tmp4A7,_tmp4A6,_tmp4A5);t=_tmp871;});goto _LL0;case 6U: _LL13: _tmp4AA=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4A9=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_tmp4A8=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp482)->f3;_LL14:
# 2699
({void*_tmp872=Cyc_Tcexp_tcConditional(te,loc,topt,_tmp4AA,_tmp4A9,_tmp4A8);t=_tmp872;});goto _LL0;case 7U: _LL15: _tmp4AC=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4AB=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL16:
# 2701
({void*_tmp873=Cyc_Tcexp_tcAnd(te,loc,_tmp4AC,_tmp4AB);t=_tmp873;});goto _LL0;case 8U: _LL17: _tmp4AE=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4AD=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL18:
# 2703
({void*_tmp874=Cyc_Tcexp_tcOr(te,loc,_tmp4AE,_tmp4AD);t=_tmp874;});goto _LL0;case 9U: _LL19: _tmp4B0=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4AF=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL1A:
# 2705
({void*_tmp875=Cyc_Tcexp_tcSeqExp(te,loc,topt,_tmp4B0,_tmp4AF);t=_tmp875;});goto _LL0;case 11U: _LL1D: _tmp4B1=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LL1E:
# 2731
({void*_tmp876=Cyc_Tcexp_tcThrow(te,loc,topt,_tmp4B1);t=_tmp876;});goto _LL0;case 13U: _LL1F: _tmp4B3=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4B2=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL20:
# 2733
({void*_tmp877=Cyc_Tcexp_tcInstantiate(te,loc,topt,_tmp4B3,_tmp4B2);t=_tmp877;});goto _LL0;case 14U: _LL21: _tmp4B6=(void*)((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4B5=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_tmp4B4=(enum Cyc_Absyn_Coercion*)&((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp482)->f4;_LL22:
# 2735
({void*_tmp878=Cyc_Tcexp_tcCast(te,loc,topt,_tmp4B6,_tmp4B5,_tmp4B4);t=_tmp878;});goto _LL0;case 15U: _LL23: _tmp4B7=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LL24:
# 2737
({void*_tmp879=Cyc_Tcexp_tcAddress(te,loc,e,topt,_tmp4B7);t=_tmp879;});goto _LL0;case 16U: _LL25: _tmp4B9=(struct Cyc_Absyn_Exp**)&((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4B8=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL26:
# 2739
({void*_tmp87A=Cyc_Tcexp_tcNew(te,loc,topt,_tmp4B9,e,_tmp4B8);t=_tmp87A;});goto _LL0;case 18U: _LL27: _tmp4BA=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LL28: {
# 2741
void*_tmp48A=Cyc_Tcexp_tcExpNoPromote(te,0,_tmp4BA);
({void*_tmp87B=Cyc_Tcexp_tcSizeof(te,loc,topt,_tmp48A);t=_tmp87B;});goto _LL0;}case 17U: _LL29: _tmp4BB=(void*)((struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LL2A:
# 2744
({void*_tmp87C=Cyc_Tcexp_tcSizeof(te,loc,topt,_tmp4BB);t=_tmp87C;});goto _LL0;case 19U: _LL2B: _tmp4BD=(void*)((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4BC=((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL2C:
# 2746
({void*_tmp87D=Cyc_Tcexp_tcOffsetof(te,loc,topt,_tmp4BD,_tmp4BC);t=_tmp87D;});goto _LL0;case 20U: _LL2D: _tmp4BE=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LL2E:
# 2748
({void*_tmp87E=Cyc_Tcexp_tcDeref(te,loc,topt,_tmp4BE);t=_tmp87E;});goto _LL0;case 21U: _LL2F: _tmp4C2=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4C1=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_tmp4C0=(int*)&((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp482)->f3;_tmp4BF=(int*)&((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp482)->f4;_LL30:
# 2750
({void*_tmp87F=Cyc_Tcexp_tcAggrMember(te,loc,topt,e,_tmp4C2,_tmp4C1,_tmp4C0,_tmp4BF);t=_tmp87F;});goto _LL0;case 22U: _LL31: _tmp4C6=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4C5=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_tmp4C4=(int*)&((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp482)->f3;_tmp4C3=(int*)&((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp482)->f4;_LL32:
# 2752
({void*_tmp880=Cyc_Tcexp_tcAggrArrow(te,loc,topt,_tmp4C6,_tmp4C5,_tmp4C4,_tmp4C3);t=_tmp880;});goto _LL0;case 23U: _LL33: _tmp4C8=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4C7=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL34:
# 2754
({void*_tmp881=Cyc_Tcexp_tcSubscript(te,loc,topt,_tmp4C8,_tmp4C7);t=_tmp881;});goto _LL0;case 24U: _LL35: _tmp4C9=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LL36:
# 2756
({void*_tmp882=Cyc_Tcexp_tcTuple(te,loc,topt,_tmp4C9);t=_tmp882;});goto _LL0;case 25U: _LL37: _tmp4CB=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4CA=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL38:
# 2758
({void*_tmp883=Cyc_Tcexp_tcCompoundLit(te,loc,topt,_tmp4CB,_tmp4CA);t=_tmp883;});goto _LL0;case 26U: _LL39: _tmp4CC=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LL3A: {
# 2762
void**elt_topt=0;
...
# 2768
 elt_topt=_tmp48F;
elt_tqopt=_tmp48E;
({int _tmp884=((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp48D);zero_term=_tmp884;});
goto _LL5C;}else{_LL5F: _LL60:
 goto _LL5C;}_LL5C:;}
# 2775
({void*_tmp885=Cyc_Tcexp_tcArray(te,loc,elt_topt,elt_tqopt,zero_term,_tmp4CC);t=_tmp885;});goto _LL0;}case 37U: _LL3B: _tmp4CD=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LL3C:
# 2777
({void*_tmp886=Cyc_Tcexp_tcStmtExp(te,loc,topt,_tmp4CD);t=_tmp886;});goto _LL0;case 27U: _LL3D: _tmp4D1=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4D0=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_tmp4CF=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp482)->f3;_tmp4CE=(int*)&((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp482)->f4;_LL3E:
# 2779
({void*_tmp887=Cyc_Tcexp_tcComprehension(te,loc,topt,_tmp4D1,_tmp4D0,_tmp4CF,_tmp4CE);t=_tmp887;});goto _LL0;case 28U: _LL3F: _tmp4D4=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4D3=(void*)((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_tmp4D2=(int*)&((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp482)->f3;_LL40:
# 2781
({void*_tmp888=Cyc_Tcexp_tcComprehensionNoinit(te,loc,topt,_tmp4D4,_tmp4D3,_tmp4D2);t=_tmp888;});goto _LL0;case 29U: _LL41: _tmp4D8=(struct _tuple1**)&((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4D7=(struct Cyc_List_List**)&((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_tmp4D6=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp482)->f3;_tmp4D5=(struct Cyc_Absyn_Aggrdecl**)&((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp482)->f4;_LL42:
# 2783
({void*_tmp889=Cyc_Tcexp_tcAggregate(te,loc,topt,_tmp4D8,_tmp4D7,_tmp4D6,_tmp4D5);t=_tmp889;});goto _LL0;case 30U: _LL43: _tmp4DA=(void*)((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4D9=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL44:
# 2785
({void*_tmp88A=Cyc_Tcexp_tcAnonStruct(te,loc,_tmp4DA,_tmp4D9);t=_tmp88A;});goto _LL0;case 31U: _LL45: _tmp4DD=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4DC=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_tmp4DB=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp482)->f3;_LL46:
# 2787
({void*_tmp88B=Cyc_Tcexp_tcDatatype(te,loc,topt,e,_tmp4DD,_tmp4DC,_tmp4DB);t=_tmp88B;});goto _LL0;case 32U: _LL47: _tmp4DF=((struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4DE=((struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL48:
# 2789
({void*_tmp88C=(void*)({struct Cyc_Absyn_EnumType_Absyn_Type_struct*_tmp490=_cycalloc(sizeof(*_tmp490));_tmp490->tag=13U,_tmp490->f1=_tmp4DF->name,_tmp490->f2=_tmp4DF;_tmp490;});t=_tmp88C;});goto _LL0;case 33U: _LL49: _tmp4E1=(void*)((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4E0=((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL4A:
# 2791
...
# 2793
({void*_tmp88D=Cyc_Tcexp_tcMalloc(te,loc,topt,_tmp4E5,_tmp4E4,_tmp4E3,_tmp4E6,_tmp4E2);t=_tmp88D;});goto _LL0;case 35U: _LL4D: _tmp4E8=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4E7=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL4E:
# 2795
({void*_tmp88E=Cyc_Tcexp_tcSwap(te,loc,topt,_tmp4E8,_tmp4E7);t=_tmp88E;});goto _LL0;case 38U: _LL4F: _tmp4EA=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_tmp4E9=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp482)->f2;_LL50:
# 2797
({void*_tmp88F=Cyc_Tcexp_tcTagcheck(te,loc,topt,_tmp4EA,_tmp4E9);t=_tmp88F;});goto _LL0;case 41U: _LL51: _tmp4EB=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LL52:
# 2799
({void*_tmp890=Cyc_Tcexp_tcExp(te,topt,_tmp4EB);t=_tmp890;});goto _LL0;case 39U: _LL53: _tmp4EC=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmp482)->f1;_LL54:
# 2801
 if(!te->allow_valueof)
({void*_tmp491=0U;({unsigned int _tmp892=e->loc;struct _dyneither_ptr _tmp891=({const char*_tmp492="valueof(-) can only occur within types";_tag_dyneither(_tmp492,sizeof(char),39U);});Cyc_Tcutil_terr(_tmp892,_tmp891,_tag_dyneither(_tmp491,sizeof(void*),0U));});});
# 2809
t=Cyc_Absyn_sint_typ;
goto _LL0;default: _LL55: _LL56:
# 2812
({void*_tmp493=0U;({unsigned int _tmp894=e->loc;struct _dyneither_ptr _tmp893=({const char*_tmp494="asm expressions cannot occur within Cyclone code.";_tag_dyneither(_tmp494,sizeof(char),50U);});Cyc_Tcutil_terr(_tmp894,_tmp893,_tag_dyneither(_tmp493,sizeof(void*),0U));});});
({void*_tmp895=Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te));t=_tmp895;});}_LL0:;}
# 2815
e->topt=t;}
