...
if(!({void*_tmp5B3=t1_elt;Cyc_Unify_unify(_tmp5B3,Cyc_Tcutil_pointer_elt_type(t2));})){
...
if(Cyc_Tcutil_is_pointer_type(t2)&&({void*_tmp5C7=Cyc_Tcutil_pointer_elt_type(t1);Cyc_Unify_unify(_tmp5C7,
...
void*_tmp5D5=t1;Cyc_Unify_unify(_tmp5D5,Cyc_Absyn_new_evar(& Cyc_Tcutil_bko,Cyc_Tcenv_lookup_opt_type_vars(te)));})){
...
# 1107
({void*_tmp659=Cyc_Tcutil_pointer_region(_tmp1B1);Cyc_Unify_unify(_tmp659,Cyc_Tcenv_curr_rgn(_tmp16A));});{
# 1109
...
# 1511
if(!({void*_tmp6D6=t2;Cyc_Unify_unify(_tmp6D6,Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te)));}))
...
if(!({void*_tmp6F7=t3;Cyc_Unify_unify(_tmp6F7,Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te)));}))
...
fields=({struct Cyc_List_List*_tmp2F9=_cycalloc(sizeof(*_tmp2F9));({struct _tuple16*_tmp729=({struct _tuple16*_tmp2F8=_cycalloc(sizeof(*_tmp2F8));_tmp2F8->f1=(*((struct _tuple16*)_tmp2FA->hd)).f1,_tmp2F8->f2=(void*)_check_null(((struct Cyc_Absyn_Exp*)es->hd)->topt);_tmp2F8;});_tmp2F9->hd=_tmp729;}),_tmp2F9->tl=fields;_tmp2F9;});}
# 1688
done=1;
goto _LL0;}else{_LL3: _LL4:
 goto _LL0;}_LL0:;}
...
fields=({struct Cyc_List_List*_tmp2FC=_cycalloc(sizeof(*_tmp2FC));({struct _tuple16*_tmp72C=({struct _tuple16*_tmp2FB=_cycalloc(sizeof(*_tmp2FB));({struct Cyc_Absyn_Tqual _tmp72B=Cyc_Absyn_empty_tqual(0U);_tmp2FB->f1=_tmp72B;}),_tmp2FB->f2=(void*)_check_null(((struct Cyc_Absyn_Exp*)es->hd)->topt);_tmp2FB;});_tmp2FC->hd=_tmp72C;}),_tmp2FC->tl=fields;_tmp2FC;});}
# 1697
...
struct _tuple15 _tmp30C=Cyc_Evexp_eval_const_uint_exp(_tmp316);struct _tuple15 _tmp30D=_tmp30C;unsigned _tmp315;int _tmp314;_LL6: _tmp315=_tmp30D.f1;_tmp314=_tmp30D.f2;_LL7:;
if(!_tmp314)
...
if(_tmp342 != 0)Cyc_Unify_unify(*_tmp342,t);
# 1888
if(te->le == 0){
if(!Cyc_Tcutil_is_const_exp(bound))
...
Cyc_Unify_unify((void*)_tmp36F->hd,(void*)_tmp370->hd);}}
# 1974
res_typ=*topt;
goto _LL5;}
# 1977
...
Cyc_Unify_unify((void*)_tmp372->hd,(void*)_tmp373->hd);
_tmp372=_tmp372->tl;
_tmp373=_tmp373->tl;}
# 1995
if(_tmp372 != 0)
...
goto _LL22;}else{goto _LL25;}}else{goto _LL25;}}else{_LL25: _LL26:
 goto _LL22;}_LL22:;}{
# 2267
void*(*_tmp3DA)(void*t,void*rgn,struct Cyc_Absyn_Tqual,void*zero_term)=Cyc_Absyn_at_type;
...
return({void*(*_tmp7B8)(void*t,void*rgn,struct Cyc_Absyn_Tqual,void*zero_term)=_tmp3DA;void*_tmp7B7=elt_type;void*_tmp7B6=rgn;struct Cyc_Absyn_Tqual _tmp7B5=Cyc_Absyn_empty_tqual(0U);_tmp7B8(_tmp7B7,_tmp7B6,_tmp7B5,_tmp3DB);});};};}
# 2311
...
if(!({void*_tmp7CC=_tmp3FD;Cyc_Unify_unify(_tmp7CC,Cyc_Absyn_wildtyp(Cyc_Tcenv_lookup_opt_type_vars(te)));})){
...
if(topt != 0){
if(!Cyc_Unify_unify(*topt,res_typ)&& Cyc_Tcutil_silent_castable(_tmp40D,loc,res_typ,*topt)){
e->topt=res_typ;
