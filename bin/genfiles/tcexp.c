...
if((*adp)->impl==0)
goto _LL3;
_Tmp2=_check_null((*adp)->impl)->fields;goto _LL7;}}else{goto _LL8;}}else{goto _LL8;}case 6: _Tmp2=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp1)->f3;_LL7: {struct Cyc_List_List*fields=_Tmp2;
# 1278
...
# 2004
e1=e2;
_Tmp3=t1;goto _LL15;}}else{if(*((int*)_Tmp2.f1)==17){_Tmp3=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_Tmp2.f1)->f1;_LL15: {void*t2=_Tmp3;
# 2008
...
_Tmp2=des;goto _LL21;}case 25: _Tmp2=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_LL21: {struct Cyc_List_List*des=_Tmp2;
# 2263
void**elt_typ_opt=0;
int zero_term=0;
if(topt!=0){
