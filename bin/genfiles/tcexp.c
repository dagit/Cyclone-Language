...
# 365
const char*_tmp73F;void*_tmp73E[1];struct Cyc_String_pa_PrintArg_struct _tmp73D;return(_tmp73D.tag=0,((_tmp73D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(q)),((_tmp73E[0]=& _tmp73D,Cyc_Tcexp_expr_err(te,loc,0,((_tmp73F="undeclared identifier %s",_tag_dyneither(_tmp73F,sizeof(char),25))),_tag_dyneither(_tmp73E,sizeof(void*),1)))))));}_LL82: _tmpD4=_tmpD2;_LL83:(void)_throw(_tmpD4);_LL7F:;}};}_LL68: {struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp9F=(struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)_tmp9D;if(_tmp9F->tag != 1)goto _LL6A;else{_tmpA0=_tmp9F->f1;}}_LL69:
# 368
*q=*_tmpA0->name;
...
# 1118
{const char*_tmp83B;void*_tmp83A;(_tmp83A=0,Cyc_Tcutil_terr(loc,((_tmp83B="bad format arguments",_tag_dyneither(_tmp83B,sizeof(char),21))),_tag_dyneither(_tmp83A,sizeof(void*),0)));}goto _LL13D;_LL140: _tmp272=_tmp270;_LL141:(void)_throw(_tmp272);_LL13D:;}};}
# 1120
...
return topt != 0?*topt:(void*)& Cyc_Absyn_VoidType_val;_LL1E7: _tmp495=_tmp493;_LL1E8:(void)_throw(_tmp495);_LL1E4:;}};}
# 2037
*ad_opt=ad;
*tn=ad->name;}
# 2040
...
# 2904
 ok=0;
fn_exp=e;
goto _LL31B;_LL31E: _tmp6C2=_tmp6BF;_LL31F:(void)_throw(_tmp6C2);_LL31B:;}};}
# 2908
