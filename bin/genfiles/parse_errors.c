...
# 10 "parse_errors.cyc"
int Cyc_ParseErrors_print_state_and_token=0;struct Cyc_ParseErrors_ParseState{int state;int token;struct _dyneither_ptr msg;};static char _tmp0[30]="missing comma in declaration ";static char _tmp1[28]="type has not been declared ";static char _tmp2[13]="missing ']' ";
# 14
static struct Cyc_ParseErrors_ParseState Cyc_ParseErrors_msg_table[3]={{124,361,{_tmp0,_tmp0,_tmp0 + 30}},{55,361,{_tmp1,_tmp1,_tmp1 + 28}},{144,59,{_tmp2,_tmp2,_tmp2 + 13}}};
# 23 "parse_errors.cyc"
void Cyc_yyerror(struct _dyneither_ptr s,int state,int token){
if(Cyc_ParseErrors_print_state_and_token){
{const char*_tmpB;void*_tmpA[2];struct Cyc_Int_pa_PrintArg_struct _tmp9;struct Cyc_Int_pa_PrintArg_struct _tmp8;(_tmp8.tag=1,((_tmp8.f1=(unsigned long)token,((_tmp9.tag=1,((_tmp9.f1=(unsigned long)state,((_tmpA[0]=& _tmp9,((_tmpA[1]=& _tmp8,Cyc_printf(((_tmpB="parse error: state [%d], token [%d]\n",_tag_dyneither(_tmpB,sizeof(char),37))),_tag_dyneither(_tmpA,sizeof(void*),2)))))))))))));}
exit(1);}
# 29
{unsigned int i=0;for(0;i < 3;++ i){
