...
# 18 "parse_errors.cyc"
void Cyc_yyerror(struct _fat_ptr s,int state,int token){int _T0;struct Cyc_Int_pa_PrintArg_struct _T1;int _T2;struct Cyc_Int_pa_PrintArg_struct _T3;int _T4;void**_T5;void**_T6;struct _fat_ptr _T7;struct _fat_ptr _T8;struct Cyc_ParseErrors_ParseState*_T9;unsigned _TA;int _TB;char*_TC;struct Cyc_ParseErrors_ParseState*_TD;struct Cyc_ParseErrors_ParseState _TE;int _TF;int _T10;struct Cyc_ParseErrors_ParseState*_T11;unsigned _T12;int _T13;struct Cyc_ParseErrors_ParseState _T14;int _T15;int _T16;struct Cyc_ParseErrors_ParseState*_T17;unsigned _T18;int _T19;struct Cyc_ParseErrors_ParseState _T1A;struct Cyc_ParseErrors_ParseState*_T1B;unsigned _T1C;int _T1D;struct Cyc_ParseErrors_ParseState _T1E;int _T1F;int _T20;struct Cyc_ParseErrors_ParseState*_T21;unsigned _T22;int _T23;struct Cyc_ParseErrors_ParseState _T24;struct _fat_ptr _T25;unsigned char*_T26;char*_T27;struct Cyc_String_pa_PrintArg_struct _T28;struct Cyc_String_pa_PrintArg_struct _T29;void**_T2A;void**_T2B;struct Cyc_Yyltype _T2C;int _T2D;unsigned _T2E;struct _fat_ptr _T2F;struct _fat_ptr _T30;struct Cyc_String_pa_PrintArg_struct _T31;void**_T32;struct Cyc_Yyltype _T33;int _T34;unsigned _T35;struct _fat_ptr _T36;struct _fat_ptr _T37;_T0=Cyc_Flags_print_parser_state_and_token;
if(!_T0)goto _TL0;{struct Cyc_Int_pa_PrintArg_struct _T38;_T38.tag=1;_T2=state;
_T38.f1=(unsigned long)_T2;_T1=_T38;}{struct Cyc_Int_pa_PrintArg_struct _T38=_T1;{struct Cyc_Int_pa_PrintArg_struct _T39;_T39.tag=1;_T4=token;_T39.f1=(unsigned long)_T4;_T3=_T39;}{struct Cyc_Int_pa_PrintArg_struct _T39=_T3;void*_T3A[2];_T5=_T3A + 0;*_T5=& _T38;_T6=_T3A + 1;*_T6=& _T39;_T7=_tag_fat("parse error: state [%d], token [%d]\n",sizeof(char),37U);_T8=_tag_fat(_T3A,sizeof(void*),2);Cyc_printf(_T7,_T8);}}
exit(1);goto _TL1;_TL0: _TL1:{
# 26
unsigned i=0U;_TL5: if(i < 104U)goto _TL3;else{goto _TL4;}
_TL3: _T9=Cyc_ParseErrors_msg_table;_TA=i;_TB=(int)_TA;_TC=_check_known_subscript_notnull(_T9,104U,sizeof(struct Cyc_ParseErrors_ParseState),_TB);_TD=(struct Cyc_ParseErrors_ParseState*)_TC;_TE=*_TD;_TF=_TE.state;_T10=state;if(_TF!=_T10)goto _TL6;_T11=Cyc_ParseErrors_msg_table;_T12=i;_T13=(int)_T12;_T14=_T11[_T13];_T15=_T14.token;_T16=token;if(_T15!=_T16)goto _TL6;_T17=Cyc_ParseErrors_msg_table;_T18=i;_T19=(int)_T18;_T1A=_T17[_T19];
# 29
s=_T1A.msg;goto _TL4;
# 31
_TL6: _T1B=Cyc_ParseErrors_msg_table;_T1C=i;_T1D=(int)_T1C;_T1E=_T1B[_T1D];_T1F=_T1E.state;_T20=state;if(_T1F!=_T20)goto _TL8;_T21=Cyc_ParseErrors_msg_table;_T22=i;_T23=(int)_T22;_T24=_T21[_T23];
s=_T24.msg;goto _TL9;_TL8: _TL9:
# 26
 i=i + 1;goto _TL5;_TL4:;}{
# 34
struct _fat_ptr ts=Cyc_token2string(token);_T25=ts;_T26=_T25.curr;_T27=(char*)_T26;
if(_T27==0)goto _TLA;{struct Cyc_String_pa_PrintArg_struct _T38;_T38.tag=0;
_T38.f1=s;_T28=_T38;}{struct Cyc_String_pa_PrintArg_struct _T38=_T28;{struct Cyc_String_pa_PrintArg_struct _T39;_T39.tag=0;_T39.f1=Cyc_token2string(token);_T29=_T39;}{struct Cyc_String_pa_PrintArg_struct _T39=_T29;void*_T3A[2];_T2A=_T3A + 0;*_T2A=& _T38;_T2B=_T3A + 1;*_T2B=& _T39;_T2C=Cyc_yylloc;_T2D=_T2C.first_line;_T2E=(unsigned)_T2D;_T2F=_tag_fat("%s (found %s instead)",sizeof(char),22U);_T30=_tag_fat(_T3A,sizeof(void*),2);Cyc_Warn_err(_T2E,_T2F,_T30);}}goto _TLB;
# 38
_TLA:{struct Cyc_String_pa_PrintArg_struct _T38;_T38.tag=0;_T38.f1=s;_T31=_T38;}{struct Cyc_String_pa_PrintArg_struct _T38=_T31;void*_T39[1];_T32=_T39 + 0;*_T32=& _T38;_T33=Cyc_yylloc;_T34=_T33.first_line;_T35=(unsigned)_T34;_T36=_tag_fat("%s ",sizeof(char),4U);_T37=_tag_fat(_T39,sizeof(void*),1);Cyc_Warn_err(_T35,_T36,_T37);}_TLB:;}}
