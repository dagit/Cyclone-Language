...
# 45
void*Cyc_Warn_impos_loc(unsigned loc,struct _dyneither_ptr fmt,struct _dyneither_ptr ap);struct Cyc_Relations_Reln;struct _union_Nmspace_Rel_n{int tag;struct Cyc_List_List*val;};struct _union_Nmspace_Abs_n{int tag;struct Cyc_List_List*val;};struct _union_Nmspace_C_n{int tag;struct Cyc_List_List*val;};struct _union_Nmspace_Loc_n{int tag;int val;};union Cyc_Absyn_Nmspace{struct _union_Nmspace_Rel_n Rel_n;struct _union_Nmspace_Abs_n Abs_n;struct _union_Nmspace_C_n C_n;struct _union_Nmspace_Loc_n Loc_n;};
# 96 "absyn.h"
...
({struct Cyc_String_pa_PrintArg_struct _tmp76=({struct Cyc_String_pa_PrintArg_struct _tmp7E;_tmp7E.tag=0U,_tmp7E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s);_tmp7E;});struct Cyc_String_pa_PrintArg_struct _tmp77=({struct Cyc_String_pa_PrintArg_struct _tmp7D;_tmp7D.tag=0U,({struct _dyneither_ptr _tmp82=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_token2string(token));_tmp7D.f1=_tmp82;});_tmp7D;});void*_tmp74[2U];_tmp74[0]=& _tmp76,_tmp74[1]=& _tmp77;({unsigned _tmp84=(unsigned)Cyc_yylloc.first_line;struct _dyneither_ptr _tmp83=({const char*_tmp75="%s (found %s instead)";_tag_dyneither(_tmp75,sizeof(char),22U);});Cyc_Warn_err(_tmp84,_tmp83,_tag_dyneither(_tmp74,sizeof(void*),2U));});});else{
# 42
({struct Cyc_String_pa_PrintArg_struct _tmp7A=({struct Cyc_String_pa_PrintArg_struct _tmp7F;_tmp7F.tag=0U,_tmp7F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s);_tmp7F;});void*_tmp78[1U];_tmp78[0]=& _tmp7A;({unsigned _tmp86=(unsigned)Cyc_yylloc.first_line;struct _dyneither_ptr _tmp85=({const char*_tmp79="%s ";_tag_dyneither(_tmp79,sizeof(char),4U);});Cyc_Warn_err(_tmp86,_tmp85,_tag_dyneither(_tmp78,sizeof(void*),1U));});});}};}
