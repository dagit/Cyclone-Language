...
# 74
typedef struct Cyc_Lexing_lex_tables*Cyc_Lexing_LexTables;extern char Cyc_Parse_Exit[5U];struct Cyc_Parse_Exit_exn_struct{char*tag;};struct Cyc_FlatList{struct Cyc_FlatList*tl;void*hd[0U] __attribute__((aligned )) ;};
# 33 "parse.h"
