...
union Cyc_Pratt_Node Cyc_Pratt_NReturn (void){return({union Cyc_Pratt_Node _Tmp0;(_Tmp0.NReturn).tag=7U,(_Tmp0.NReturn).val=0;_Tmp0;});}struct _tuple12{union Cyc_Pratt_Node f1;union Cyc_Pratt_Node f2;};
# 93
static int Cyc_Pratt_cmp_node(union Cyc_Pratt_Node n1,union Cyc_Pratt_Node n2){
struct _tuple12 _stmttmp0=({struct _tuple12 _Tmp0;_Tmp0.f1=n1,_Tmp0.f2=n2;_Tmp0;});struct _tuple12 _Tmp0=_stmttmp0;unsigned _Tmp1;unsigned _Tmp2;void*_Tmp3;void*_Tmp4;if(((_Tmp0.f1).NZero).tag == 1){if(((_Tmp0.f2).NZero).tag == 1)
return 0;else{
return -1;}}else{if(((_Tmp0.f2).NZero).tag == 1)
return 1;else{if(((_Tmp0.f1).NReturn).tag == 7){if(((_Tmp0.f2).NReturn).tag == 7)
return 0;else{
return -1;}}else{if(((_Tmp0.f2).NReturn).tag == 7)
return 1;else{if(((_Tmp0.f1).NVar).tag == 2){if(((_Tmp0.f2).NVar).tag == 2){_Tmp4=((_Tmp0.f1).NVar).val;_Tmp3=((_Tmp0.f2).NVar).val;{struct Cyc_Absyn_Vardecl*x=_Tmp4;struct Cyc_Absyn_Vardecl*y=_Tmp3;
return(int)x - (int)y;}}else{
return -1;}}else{if(((_Tmp0.f2).NVar).tag == 2)
return 1;else{if(((_Tmp0.f1).NNumelts).tag == 3){if(((_Tmp0.f2).NNumelts).tag == 3){_Tmp4=((_Tmp0.f1).NNumelts).val;_Tmp3=((_Tmp0.f2).NNumelts).val;{struct Cyc_Absyn_Vardecl*x=_Tmp4;struct Cyc_Absyn_Vardecl*y=_Tmp3;
return(int)x - (int)y;}}else{_Tmp4=((_Tmp0.f1).NNumelts).val;{struct Cyc_Absyn_Vardecl*x=_Tmp4;
return -1;}}}else{if(((_Tmp0.f2).NNumelts).tag == 3){_Tmp4=((_Tmp0.f2).NNumelts).val;{struct Cyc_Absyn_Vardecl*y=_Tmp4;
return 1;}}else{if(((_Tmp0.f1).NType).tag == 4){if(((_Tmp0.f2).NType).tag == 4){_Tmp4=((_Tmp0.f1).NType).val;_Tmp3=((_Tmp0.f2).NType).val;{void*x=_Tmp4;void*y=_Tmp3;
# 108
if(Cyc_Unify_unify(x,y))return 0;
return Cyc_Tcutil_typecmp(x,y);}}else{
return -1;}}else{if(((_Tmp0.f2).NType).tag == 4)
return 1;else{if(((_Tmp0.f1).NParam).tag == 5){if(((_Tmp0.f2).NParam).tag == 5){_Tmp2=((_Tmp0.f1).NParam).val;_Tmp1=((_Tmp0.f2).NParam).val;{unsigned i=_Tmp2;unsigned j=_Tmp1;
return(int)i - (int)j;}}else{_Tmp2=((_Tmp0.f1).NParam).val;{unsigned i=_Tmp2;
return -1;}}}else{if(((_Tmp0.f2).NParam).tag == 5){_Tmp2=((_Tmp0.f2).NParam).val;{unsigned j=_Tmp2;
return 1;}}else{_Tmp2=((_Tmp0.f1).NParamNumelts).val;_Tmp1=((_Tmp0.f2).NParamNumelts).val;{unsigned i=_Tmp2;unsigned j=_Tmp1;
return(int)i - (int)j;}}}}}}}}}}}}};}
# 119
struct _fat_ptr Cyc_Pratt_node2string(union Cyc_Pratt_Node n){
union Cyc_Pratt_Node _Tmp0=n;unsigned _Tmp1;void*_Tmp2;switch((_Tmp0.NParamNumelts).tag){case 1:
 return({const char*_Tmp3="0";_tag_fat(_Tmp3,sizeof(char),2U);});case 2: _Tmp2=(_Tmp0.NVar).val;{struct Cyc_Absyn_Vardecl*x=_Tmp2;
return Cyc_Absynpp_qvar2string(x->name);}case 4: _Tmp2=(_Tmp0.NType).val;{void*x=_Tmp2;
return Cyc_Absynpp_typ2string(x);}case 3: _Tmp2=(_Tmp0.NNumelts).val;{struct Cyc_Absyn_Vardecl*x=_Tmp2;
return({struct Cyc_String_pa_PrintArg_struct _Tmp3=({struct Cyc_String_pa_PrintArg_struct _Tmp4;_Tmp4.tag=0,({struct _fat_ptr _Tmp5=Cyc_Absynpp_qvar2string(x->name);_Tmp4.f1=_Tmp5;});_Tmp4;});void*_Tmp4[1];_Tmp4[0]=& _Tmp3;Cyc_aprintf(({const char*_Tmp5="numelts(%s)";_tag_fat(_Tmp5,sizeof(char),12U);}),_tag_fat(_Tmp4,sizeof(void*),1));});}case 5: _Tmp1=(_Tmp0.NParam).val;{unsigned i=_Tmp1;
return({struct Cyc_Int_pa_PrintArg_struct _Tmp3=({struct Cyc_Int_pa_PrintArg_struct _Tmp4;_Tmp4.tag=1,_Tmp4.f1=(unsigned long)((int)i);_Tmp4;});void*_Tmp4[1];_Tmp4[0]=& _Tmp3;Cyc_aprintf(({const char*_Tmp5="param(%d)";_tag_fat(_Tmp5,sizeof(char),10U);}),_tag_fat(_Tmp4,sizeof(void*),1));});}case 6: _Tmp1=(_Tmp0.NParamNumelts).val;{unsigned i=_Tmp1;
return({struct Cyc_Int_pa_PrintArg_struct _Tmp3=({struct Cyc_Int_pa_PrintArg_struct _Tmp4;_Tmp4.tag=1,_Tmp4.f1=(unsigned long)((int)i);_Tmp4;});void*_Tmp4[1];_Tmp4[0]=& _Tmp3;Cyc_aprintf(({const char*_Tmp5="numelts(param(%d))";_tag_fat(_Tmp5,sizeof(char),19U);}),_tag_fat(_Tmp4,sizeof(void*),1));});}default:
 return Cyc_aprintf(({const char*_Tmp3="return_value";_tag_fat(_Tmp3,sizeof(char),13U);}),_tag_fat(0U,sizeof(void*),0));};}struct Cyc_Pratt_Edge{union Cyc_Pratt_Node x;union Cyc_Pratt_Node y;struct Cyc_AP_T*value;};struct Cyc_Pratt_Graph{struct Cyc_List_List*nodes;struct Cyc_List_List*edges;};
# 149
struct Cyc_Pratt_Graph*Cyc_Pratt_empty_graph (void){
struct Cyc_List_List*nodes=({struct Cyc_List_List*_Tmp0=_cycalloc(sizeof(struct Cyc_List_List));_Tmp0->hd=& Cyc_Pratt_zero_node,_Tmp0->tl=0;_Tmp0;});
...
struct Cyc_Pratt_Graph*_Tmp0=G;void*_Tmp1;void*_Tmp2;_Tmp2=_Tmp0->nodes;_Tmp1=_Tmp0->edges;{struct Cyc_List_List*nodes=_Tmp2;struct Cyc_List_List*edges=_Tmp1;
return({struct Cyc_Pratt_Graph*_Tmp3=_cycalloc(sizeof(struct Cyc_Pratt_Graph));_Tmp3->nodes=nodes,({struct Cyc_List_List*_Tmp4=Cyc_Pratt_copy_edges(edges);_Tmp3->edges=_Tmp4;});_Tmp3;});}}
# 171
...
if(G == 0){
Cyc_fprintf(Cyc_stderr,({const char*_Tmp0="<inconsistent>";_tag_fat(_Tmp0,sizeof(char),15U);}),_tag_fat(0U,sizeof(void*),0));
return;}{
# 199
struct Cyc_Pratt_Graph _stmttmp1=*G;struct Cyc_Pratt_Graph _Tmp0=_stmttmp1;void*_Tmp1;void*_Tmp2;_Tmp2=_Tmp0.nodes;_Tmp1=_Tmp0.edges;{struct Cyc_List_List*nodes=_Tmp2;struct Cyc_List_List*ds=_Tmp1;
for(1;ds != 0;ds=ds->tl){
struct Cyc_Pratt_Edge*e=(struct Cyc_Pratt_Edge*)ds->hd;
({struct Cyc_String_pa_PrintArg_struct _Tmp3=({struct Cyc_String_pa_PrintArg_struct _Tmp4;_Tmp4.tag=0,({
struct _fat_ptr _Tmp5=Cyc_Pratt_node2string(e->x);_Tmp4.f1=_Tmp5;});_Tmp4;});struct Cyc_String_pa_PrintArg_struct _Tmp4=({struct Cyc_String_pa_PrintArg_struct _Tmp5;_Tmp5.tag=0,({struct _fat_ptr _Tmp6=Cyc_Pratt_node2string(e->y);_Tmp5.f1=_Tmp6;});_Tmp5;});struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,({struct _fat_ptr _Tmp7=({char*_Tmp8=Cyc_AP_tostr(e->value,10);_tag_fat(_Tmp8,sizeof(char),_get_zero_arr_size_char((void*)_Tmp8,1U));});_Tmp6.f1=_Tmp7;});_Tmp6;});void*_Tmp6[3];_Tmp6[0]=& _Tmp3,_Tmp6[1]=& _Tmp4,_Tmp6[2]=& _Tmp5;Cyc_fprintf(Cyc_stderr,({const char*_Tmp7="%s - %s <= %s";_tag_fat(_Tmp7,sizeof(char),14U);}),_tag_fat(_Tmp6,sizeof(void*),3));});
if(ds->tl != 0)Cyc_fprintf(Cyc_stderr,({const char*_Tmp3=", ";_tag_fat(_Tmp3,sizeof(char),3U);}),_tag_fat(0U,sizeof(void*),0));}}}}
# 209
