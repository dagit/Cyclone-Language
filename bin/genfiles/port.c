...
return({struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,_Tmp6.f1=(struct _fat_ptr)((struct _fat_ptr)*n);_Tmp6;});void*_Tmp6[1];_Tmp6[0]=& _Tmp5;Cyc_aprintf(_tag_fat("%s",sizeof(char),3U),_tag_fat(_Tmp6,sizeof(void*),1));});}case 11: _Tmp4=(void*)((struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)t)->f1;_Tmp3=(void*)((struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)t)->f2;_Tmp2=(void*)((struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)t)->f3;_Tmp1=(void*)((struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)t)->f4;_Tmp0=(void*)((struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)t)->f5;{void*elt=_Tmp4;void*qual=_Tmp3;void*k=_Tmp2;void*rgn=_Tmp1;void*zt=_Tmp0;
# 184
return({struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,({struct _fat_ptr _Tmp7=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctype2string(deep,elt));_Tmp6.f1=_Tmp7;});_Tmp6;});struct Cyc_String_pa_PrintArg_struct _Tmp6=({struct Cyc_String_pa_PrintArg_struct _Tmp7;_Tmp7.tag=0,({
struct _fat_ptr _Tmp8=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctype2string(deep,qual));_Tmp7.f1=_Tmp8;});_Tmp7;});struct Cyc_String_pa_PrintArg_struct _Tmp7=({struct Cyc_String_pa_PrintArg_struct _Tmp8;_Tmp8.tag=0,({struct _fat_ptr _Tmp9=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctype2string(deep,k));_Tmp8.f1=_Tmp9;});_Tmp8;});struct Cyc_String_pa_PrintArg_struct _Tmp8=({struct Cyc_String_pa_PrintArg_struct _Tmp9;_Tmp9.tag=0,({
struct _fat_ptr _TmpA=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctype2string(deep,rgn));_Tmp9.f1=_TmpA;});_Tmp9;});struct Cyc_String_pa_PrintArg_struct _Tmp9=({struct Cyc_String_pa_PrintArg_struct _TmpA;_TmpA.tag=0,({struct _fat_ptr _TmpB=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctype2string(deep,zt));_TmpA.f1=_TmpB;});_TmpA;});void*_TmpA[5];_TmpA[0]=& _Tmp5,_TmpA[1]=& _Tmp6,_TmpA[2]=& _Tmp7,_TmpA[3]=& _Tmp8,_TmpA[4]=& _Tmp9;Cyc_aprintf(_tag_fat("ptr(%s,%s,%s,%s,%s)",sizeof(char),20U),_tag_fat(_TmpA,sizeof(void*),5));});}case 12: _Tmp4=(void*)((struct Cyc_Port_Array_ct_Port_Ctype_struct*)t)->f1;_Tmp3=(void*)((struct Cyc_Port_Array_ct_Port_Ctype_struct*)t)->f2;_Tmp2=(void*)((struct Cyc_Port_Array_ct_Port_Ctype_struct*)t)->f3;{void*elt=_Tmp4;void*qual=_Tmp3;void*zt=_Tmp2;
# 188
return({struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,({struct _fat_ptr _Tmp7=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctype2string(deep,elt));_Tmp6.f1=_Tmp7;});_Tmp6;});struct Cyc_String_pa_PrintArg_struct _Tmp6=({struct Cyc_String_pa_PrintArg_struct _Tmp7;_Tmp7.tag=0,({
struct _fat_ptr _Tmp8=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctype2string(deep,qual));_Tmp7.f1=_Tmp8;});_Tmp7;});struct Cyc_String_pa_PrintArg_struct _Tmp7=({struct Cyc_String_pa_PrintArg_struct _Tmp8;_Tmp8.tag=0,({struct _fat_ptr _Tmp9=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctype2string(deep,zt));_Tmp8.f1=_Tmp9;});_Tmp8;});void*_Tmp8[3];_Tmp8[0]=& _Tmp5,_Tmp8[1]=& _Tmp6,_Tmp8[2]=& _Tmp7;Cyc_aprintf(_tag_fat("array(%s,%s,%s)",sizeof(char),16U),_tag_fat(_Tmp8,sizeof(void*),3));});}case 13: _Tmp4=((struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*)t)->f1->f0;_Tmp3=((struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*)t)->f1->f1;{struct Cyc_Absyn_Aggrdecl*ad=_Tmp4;struct Cyc_List_List*cfs=_Tmp3;
# 191
struct _fat_ptr s=(int)ad->kind==0?_tag_fat("struct",sizeof(char),7U): _tag_fat("union",sizeof(char),6U);
if(!deep)
return({struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,_Tmp6.f1=(struct _fat_ptr)((struct _fat_ptr)s);_Tmp6;});struct Cyc_String_pa_PrintArg_struct _Tmp6=({struct Cyc_String_pa_PrintArg_struct _Tmp7;_Tmp7.tag=0,({struct _fat_ptr _Tmp8=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(ad->name));_Tmp7.f1=_Tmp8;});_Tmp7;});void*_Tmp7[2];_Tmp7[0]=& _Tmp5,_Tmp7[1]=& _Tmp6;Cyc_aprintf(_tag_fat("%s %s",sizeof(char),6U),_tag_fat(_Tmp7,sizeof(void*),2));});else{
# 195
...
struct _fat_ptr _Tmp9=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_cfields2string(0,cfs));_Tmp8.f1=_Tmp9;});_Tmp8;});void*_Tmp8[3];_Tmp8[0]=& _Tmp5,_Tmp8[1]=& _Tmp6,_Tmp8[2]=& _Tmp7;Cyc_aprintf(_tag_fat("%s %s {%s}",sizeof(char),11U),_tag_fat(_Tmp8,sizeof(void*),3));});}}case 14: if(((struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)t)->f2!=0){_Tmp4=((struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)t)->f1;_Tmp3=*((struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)t)->f2;{struct Cyc_List_List*cfs=_Tmp4;void*eq=_Tmp3;
...
# 199
return({struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,({struct _fat_ptr _Tmp7=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_cfields2string(deep,cfs));_Tmp6.f1=_Tmp7;});_Tmp6;});void*_Tmp6[1];_Tmp6[0]=& _Tmp5;Cyc_aprintf(_tag_fat("aggr {%s}",sizeof(char),10U),_tag_fat(_Tmp6,sizeof(void*),1));});}}case 15: _Tmp4=(void*)((struct Cyc_Port_Fn_ct_Port_Ctype_struct*)t)->f1;_Tmp3=((struct Cyc_Port_Fn_ct_Port_Ctype_struct*)t)->f2;{void*t=_Tmp4;struct Cyc_List_List*ts=_Tmp3;
# 201
...
struct _fat_ptr _Tmp7=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctypes2string(0,cv->lowers));_Tmp6.f1=_Tmp7;});_Tmp6;});struct Cyc_Int_pa_PrintArg_struct _Tmp6=({struct Cyc_Int_pa_PrintArg_struct _Tmp7;_Tmp7.tag=1,_Tmp7.f1=(unsigned long)cv->id;_Tmp7;});struct Cyc_String_pa_PrintArg_struct _Tmp7=({struct Cyc_String_pa_PrintArg_struct _Tmp8;_Tmp8.tag=0,({
# 210
struct _fat_ptr _Tmp9=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctypes2string(0,cv->uppers));_Tmp8.f1=_Tmp9;});_Tmp8;});void*_Tmp8[3];_Tmp8[0]=& _Tmp5,_Tmp8[1]=& _Tmp6,_Tmp8[2]=& _Tmp7;Cyc_aprintf(_tag_fat("var([%s]<=%d<=[%s])",sizeof(char),20U),_tag_fat(_Tmp8,sizeof(void*),3));});}}}};}
# 213
...
struct _fat_ptr _Tmp2=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctype2string(deep,f->qual));_Tmp1.f1=_Tmp2;});_Tmp1;});struct Cyc_String_pa_PrintArg_struct _Tmp1=({struct Cyc_String_pa_PrintArg_struct _Tmp2;_Tmp2.tag=0,_Tmp2.f1=(struct _fat_ptr)((struct _fat_ptr)*f->f);_Tmp2;});struct Cyc_String_pa_PrintArg_struct _Tmp2=({struct Cyc_String_pa_PrintArg_struct _Tmp3;_Tmp3.tag=0,({struct _fat_ptr _Tmp4=(struct _fat_ptr)((struct _fat_ptr)Cyc_Port_ctype2string(deep,f->type));_Tmp3.f1=_Tmp4;});_Tmp3;});void*_Tmp3[3];_Tmp3[0]=& _Tmp0,_Tmp3[1]=& _Tmp1,_Tmp3[2]=& _Tmp2;Cyc_aprintf(_tag_fat("%s %s: %s",sizeof(char),10U),_tag_fat(_Tmp3,sizeof(void*),3));});
...
return Cyc_strconcat_l(({struct _fat_ptr _Tmp0=_tag_fat(",",sizeof(char),2U);Cyc_Port_sep(_Tmp0,({(struct Cyc_List_List*(*)(struct _fat_ptr*(*)(int,void*),int,struct Cyc_List_List*))Cyc_List_map_c;})(Cyc_Port_ctype2stringptr,deep,ts));}));}
# 232
static struct _fat_ptr Cyc_Port_cfields2string(int deep,struct Cyc_List_List*fs){
return Cyc_strconcat_l(({struct _fat_ptr _Tmp0=_tag_fat(";",sizeof(char),2U);Cyc_Port_sep(_Tmp0,({(struct Cyc_List_List*(*)(struct _fat_ptr*(*)(int,struct Cyc_Port_Cfield*),int,struct Cyc_List_List*))Cyc_List_map_c;})(Cyc_Port_cfield2stringptr,deep,fs));}));}
# 238
...
struct _handler_cons _Tmp0;_push_handler(& _Tmp0);{int _Tmp1=0;if(setjmp(_Tmp0.handler))_Tmp1=1;if(!_Tmp1){
{struct _tuple12 _Tmp2=*({(struct _tuple12*(*)(struct Cyc_Dict_Dict,struct _tuple0*))Cyc_Dict_lookup;})(env->gcenv->typedef_dict,n);void*_Tmp3;_Tmp3=_Tmp2.f0;{void*t=_Tmp3;
...
struct _handler_cons _Tmp0;_push_handler(& _Tmp0);{int _Tmp1=0;if(setjmp(_Tmp0.handler))_Tmp1=1;if(!_Tmp1){
{struct _tuple12 _Tmp2=*({(struct _tuple12*(*)(struct Cyc_Dict_Dict,struct _tuple0*))Cyc_Dict_lookup;})(env->gcenv->typedef_dict,n);void*_Tmp3;_Tmp3=_Tmp2.f1;{void*ct=_Tmp3;
...
struct _handler_cons _Tmp0;_push_handler(& _Tmp0);{int _Tmp1=0;if(setjmp(_Tmp0.handler))_Tmp1=1;if(!_Tmp1){
{struct _tuple15 _Tmp2=*({(struct _tuple15*(*)(struct Cyc_Dict_Dict,struct _tuple0*))Cyc_Dict_lookup;})(env->var_dict,x);unsigned _Tmp3;void*_Tmp4;_Tmp4=_Tmp2.f1;_Tmp3=_Tmp2.f2;{struct _tuple12*p=_Tmp4;unsigned loc=_Tmp3;
struct _tuple14 _Tmp5=({struct _tuple14 _Tmp6;_Tmp6.f0=*p,_Tmp6.f1=loc;_Tmp6;});_npop_handler(0);return _Tmp5;}}
# 894
;_pop_handler();}else{void*_Tmp2=(void*)Cyc_Core_get_exn_thrown();void*_Tmp3;if(((struct Cyc_Dict_Absent_exn_struct*)_Tmp2)->tag==Cyc_Dict_Absent)
# 901
return({struct _tuple14 _Tmp4;({void*_Tmp5=Cyc_Port_var();_Tmp4.f0.f0=_Tmp5;}),({void*_Tmp5=Cyc_Port_var();_Tmp4.f0.f1=_Tmp5;}),_Tmp4.f1=0U;_Tmp4;});else{_Tmp3=_Tmp2;{void*exn=_Tmp3;_rethrow(exn);}};}}}
# 904
...
struct _handler_cons _Tmp0;_push_handler(& _Tmp0);{int _Tmp1=0;if(setjmp(_Tmp0.handler))_Tmp1=1;if(!_Tmp1){
{struct _tuple15 _Tmp2=*({(struct _tuple15*(*)(struct Cyc_Dict_Dict,struct _tuple0*))Cyc_Dict_lookup;})(env->var_dict,x);void*_Tmp3;_Tmp3=_Tmp2.f0;{void*t=_Tmp3;
...
struct Cyc_Dict_Dict _Tmp1=({struct Cyc_Dict_Dict _Tmp2=env->var_dict;struct _tuple0*_Tmp3=x;({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _tuple0*,struct _tuple15*))Cyc_Dict_insert;})(_Tmp2,_Tmp3,({struct _tuple15*_Tmp4=_cycalloc(sizeof(struct _tuple15));_Tmp4->f0=t,({struct _tuple12*_Tmp5=({struct _tuple12*_Tmp6=_cycalloc(sizeof(struct _tuple12));_Tmp6->f0=qual,_Tmp6->f1=ctype;_Tmp6;});_Tmp4->f1=_Tmp5;}),_Tmp4->f2=loc;_Tmp4;}));});_Tmp0->var_dict=_Tmp1;}),_Tmp0->cpos=env->cpos;_Tmp0;});}
# 966
...
# 1017
struct Cyc_List_List*_Tmp1=({struct _tuple8*_Tmp2[2];_Tmp2[0]=arg1,_Tmp2[1]=arg2;Cyc_List_list(_tag_fat(_Tmp2,sizeof(struct _tuple8*),2));});_Tmp0->f1.args=_Tmp1;}),_Tmp0->f1.c_varargs=0,_Tmp0->f1.cyc_varargs=0,_Tmp0->f1.rgn_po=0,_Tmp0->f1.qual_bnd=0,_Tmp0->f1.attributes=0,_Tmp0->f1.requires_clause=0,_Tmp0->f1.requires_relns=0,_Tmp0->f1.ensures_clause=0,_Tmp0->f1.arg_vardecls=0,_Tmp0->f1.ensures_relns=0,_Tmp0->f1.return_value=0;_Tmp0;});}}
# 1026
...
# 1221
 ...
 return Cyc_Port_arith_ct();case 25: _Tmp7=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)t)->f1)->f1;{union Cyc_Absyn_AggrInfo ai=_Tmp7;
# 1264
...
return Cyc_Port_known_aggr_ct(p);};}};}case 20:
# 1284
 return Cyc_Port_arith_ct();case 21: _Tmp8=((struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)t)->f1)->f1;{struct Cyc_List_List*fs=_Tmp8;
# 1287
for(1;(unsigned)fs;fs=fs->tl){
...
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Port: unknown primop",sizeof(char),21U),_tag_fat(0U,sizeof(void*),0));};}
# 1356
...
Cyc_Port_leq(t1,p);
return({struct _tuple12 _Tmp3;_Tmp3.f0=q,_Tmp3.f1=v;_Tmp3;});}}case 20: _Tmp2=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{struct Cyc_Absyn_Exp*e1=_Tmp2;
# 1373
void*v=Cyc_Port_var();
void*q=Cyc_Port_var();
...
return({struct _tuple12 _Tmp3;_Tmp3.f0=q,_Tmp3.f1=v;_Tmp3;});}case 21: _Tmp2=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp1=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_Tmp2;struct _fat_ptr*f=_Tmp1;
# 1379
void*v=Cyc_Port_var();
void*q=Cyc_Port_var();
...
return({struct _tuple12 _Tmp3;_Tmp3.f0=q,_Tmp3.f1=v;_Tmp3;});}case 22: _Tmp2=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp1=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_Tmp2;struct _fat_ptr*f=_Tmp1;
# 1385
void*v=Cyc_Port_var();
void*q=Cyc_Port_var();
void*t1=Cyc_Port_gen_exp(0,env,e1);
...
Cyc_Port_var());}));});
return({struct _tuple12 _Tmp3;_Tmp3.f0=q,_Tmp3.f1=v;_Tmp3;});}default:
({struct _fat_ptr _Tmp3=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _Tmp4=({struct Cyc_String_pa_PrintArg_struct _Tmp5;_Tmp5.tag=0,({struct _fat_ptr _Tmp6=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_Tmp5.f1=_Tmp6;});_Tmp5;});void*_Tmp5[1];_Tmp5[0]=& _Tmp4;Cyc_aprintf(_tag_fat("gen_lhs: %s",sizeof(char),12U),_tag_fat(_Tmp5,sizeof(void*),1));});({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_Tmp3,_tag_fat(0U,sizeof(void*),0));});};}
# 1396
...
return({void*_Tmp6=t;void*_Tmp7=Cyc_Port_var();void*_Tmp8=Cyc_Port_fat_ct();void*_Tmp9=Cyc_Port_heap_ct();Cyc_Port_ptr_ct(_Tmp6,_Tmp7,_Tmp8,_Tmp9,Cyc_Port_var());});}}case 41:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("@assert",sizeof(char),8U),_tag_fat(0U,sizeof(void*),0));case 11:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("throw",sizeof(char),6U),_tag_fat(0U,sizeof(void*),0));case 13:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("instantiate",sizeof(char),12U),_tag_fat(0U,sizeof(void*),0));case 2:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Pragma_e",sizeof(char),9U),_tag_fat(0U,sizeof(void*),0));case 34: _Tmp5=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;_Tmp3=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_Tmp0)->f2;{struct Cyc_Absyn_Exp*e1=_Tmp5;struct Cyc_Absyn_Exp*e2=_Tmp3;
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Swap_e",sizeof(char),7U),_tag_fat(0U,sizeof(void*),0));}case 16:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("New_e",sizeof(char),6U),_tag_fat(0U,sizeof(void*),0));case 24:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("CompoundLit_e",sizeof(char),14U),_tag_fat(0U,sizeof(void*),0));case 25:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Array_e",sizeof(char),8U),_tag_fat(0U,sizeof(void*),0));case 26:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Comprehension_e",sizeof(char),16U),_tag_fat(0U,sizeof(void*),0));case 27:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("ComprehensionNoinit_e",sizeof(char),22U),_tag_fat(0U,sizeof(void*),0));case 28:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Aggregate_e",sizeof(char),12U),_tag_fat(0U,sizeof(void*),0));case 29:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("AnonStruct_e",sizeof(char),13U),_tag_fat(0U,sizeof(void*),0));case 30:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Datatype_e",sizeof(char),11U),_tag_fat(0U,sizeof(void*),0));case 35:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("UnresolvedMem_e",sizeof(char),16U),_tag_fat(0U,sizeof(void*),0));case 36: _Tmp5=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{struct Cyc_Absyn_Stmt*s=_Tmp5;
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("StmtExp_e",sizeof(char),10U),_tag_fat(0U,sizeof(void*),0));}case 38:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Valueof_e",sizeof(char),10U),_tag_fat(0U,sizeof(void*),0));case 39:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Asm_e",sizeof(char),6U),_tag_fat(0U,sizeof(void*),0));default:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Tagcheck_e",sizeof(char),11U),_tag_fat(0U,sizeof(void*),0));};}
# 1541
...
({void*_Tmp5=Cyc_Port_gen_exp(0,env,e);Cyc_Port_leq(_Tmp5,Cyc_Port_arith_ct());});
return;}case 11:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("fallthru",sizeof(char),9U),_tag_fat(0U,sizeof(void*),0));default:
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("try/catch",sizeof(char),10U),_tag_fat(0U,sizeof(void*),0));};}struct _tuple18{struct Cyc_List_List*f0;struct Cyc_Absyn_Exp*f1;};
# 1587
...
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("bad type for aggregate initializer",sizeof(char),35U),_tag_fat(0U,sizeof(void*),0));};}}case 0: switch(((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_Tmp0)->f1.Wstring_c.tag){case 8:
# 1626
...
# 1668
return env;}}}else{
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("non-local decl that isn't a variable",sizeof(char),37U),_tag_fat(0U,sizeof(void*),0));};}
# 1673
...
return({struct _tuple8*_Tmp4=_cycalloc(sizeof(struct _tuple8));_Tmp4->f0=0,_Tmp4->f1=q,_Tmp4->f2=t;_Tmp4;});}}struct _tuple19{struct _fat_ptr*f0;void*f1;void*f2;void*f3;};
# 1680
...
fntype=_cycalloc(sizeof(struct Cyc_Absyn_FnType_Absyn_Type_struct)),fntype->tag=5,fntype->f1.tvars=0,fntype->f1.effect=0,({struct Cyc_Absyn_Tqual _Tmp2=Cyc_Absyn_empty_tqual(0U);fntype->f1.ret_tqual=_Tmp2;}),fntype->f1.ret_type=rettype,fntype->f1.args=targs,fntype->f1.c_varargs=0,fntype->f1.cyc_varargs=0,fntype->f1.rgn_po=0,fntype->f1.qual_bnd=0,fntype->f1.attributes=0,fntype->f1.requires_clause=0,fntype->f1.requires_relns=0,fntype->f1.ensures_clause=0,fntype->f1.ensures_relns=0,fntype->f1.return_value=0,fntype->f1.arg_vardecls=0;{
# 1737
...
struct _tuple16 _Tmp0=*((struct _tuple16*)localvars->hd);void*_Tmp1;unsigned _Tmp2;void*_Tmp3;_Tmp3=_Tmp0.f0;_Tmp2=_Tmp0.f1;_Tmp1=_Tmp0.f2;{struct _tuple0*var=_Tmp3;unsigned loc=_Tmp2;void*vartype=_Tmp1;
struct _tuple0 _Tmp4=*var;void*_Tmp5;_Tmp5=_Tmp4.f1;{struct _fat_ptr*x=_Tmp5;
...
# 1912
edits=({struct Cyc_List_List*_Tmp6=_cycalloc(sizeof(struct Cyc_List_List));({struct Cyc_Port_Edit*_Tmp7=({struct Cyc_Port_Edit*_Tmp8=_cycalloc(sizeof(struct Cyc_Port_Edit));_Tmp8->loc=loc,_Tmp8->old_string=_tag_fat("@",sizeof(char),2U),_Tmp8->new_string=_tag_fat("",sizeof(char),1U);_Tmp8;});_Tmp6->hd=_Tmp7;}),_Tmp6->tl=edits;_Tmp6;});
edits=({struct Cyc_List_List*_Tmp6=_cycalloc(sizeof(struct Cyc_List_List));({struct Cyc_Port_Edit*_Tmp7=({struct Cyc_Port_Edit*_Tmp8=_cycalloc(sizeof(struct Cyc_Port_Edit));_Tmp8->loc=_check_null(varusage->init)->loc,_Tmp8->old_string=_tag_fat("new ",sizeof(char),5U),_Tmp8->new_string=_tag_fat("",sizeof(char),1U);_Tmp8;});_Tmp6->hd=_Tmp7;}),_Tmp6->tl=edits;_Tmp6;});}else{
# 1917
edits=({struct Cyc_List_List*_Tmp6=_cycalloc(sizeof(struct Cyc_List_List));({struct Cyc_Port_Edit*_Tmp7=({struct Cyc_Port_Edit*_Tmp8=_cycalloc(sizeof(struct Cyc_Port_Edit));_Tmp8->loc=loc,({struct _fat_ptr _Tmp9=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _TmpA=({struct Cyc_String_pa_PrintArg_struct _TmpB;_TmpB.tag=0,_TmpB.f1=(struct _fat_ptr)((struct _fat_ptr)*x);_TmpB;});struct Cyc_String_pa_PrintArg_struct _TmpB=({struct Cyc_String_pa_PrintArg_struct _TmpC;_TmpC.tag=0,({struct _fat_ptr _TmpD=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_typ2string(vartype));_TmpC.f1=_TmpD;});_TmpC;});void*_TmpC[2];_TmpC[0]=& _TmpA,_TmpC[1]=& _TmpB;Cyc_aprintf(_tag_fat("?%s = malloc(sizeof(%s))",sizeof(char),25U),_tag_fat(_TmpC,sizeof(void*),2));});_Tmp8->old_string=_Tmp9;}),_Tmp8->new_string=*x;_Tmp8;});_Tmp6->hd=_Tmp7;}),_Tmp6->tl=edits;_Tmp6;});}{
# 1919
struct Cyc_List_List*loclist=varusage->usage_locs;
for(1;(unsigned)loclist;loclist=loclist->tl){
edits=({struct Cyc_List_List*_Tmp6=_cycalloc(sizeof(struct Cyc_List_List));({struct Cyc_Port_Edit*_Tmp7=({struct Cyc_Port_Edit*_Tmp8=_cycalloc(sizeof(struct Cyc_Port_Edit));_Tmp8->loc=(unsigned)loclist->hd,({struct _fat_ptr _Tmp9=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _TmpA=({struct Cyc_String_pa_PrintArg_struct _TmpB;_TmpB.tag=0,_TmpB.f1=(struct _fat_ptr)((struct _fat_ptr)*x);_TmpB;});void*_TmpB[1];_TmpB[0]=& _TmpA;Cyc_aprintf(_tag_fat("(*%s)",sizeof(char),6U),_tag_fat(_TmpB,sizeof(void*),1));});_Tmp8->old_string=_Tmp9;}),_Tmp8->new_string=*x;_Tmp8;});_Tmp6->hd=_Tmp7;}),_Tmp6->tl=edits;_Tmp6;});}}}}}}
# 1927
...
({struct Cyc_String_pa_PrintArg_struct _Tmp4=({struct Cyc_String_pa_PrintArg_struct _Tmp5;_Tmp5.tag=0,_Tmp5.f1=(struct _fat_ptr)((struct _fat_ptr)sloc);_Tmp5;});struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,_Tmp6.f1=(struct _fat_ptr)((struct _fat_ptr)s1);_Tmp6;});struct Cyc_String_pa_PrintArg_struct _Tmp6=({struct Cyc_String_pa_PrintArg_struct _Tmp7;_Tmp7.tag=0,_Tmp7.f1=(struct _fat_ptr)((struct _fat_ptr)s2);_Tmp7;});void*_Tmp7[3];_Tmp7[0]=& _Tmp4,_Tmp7[1]=& _Tmp5,_Tmp7[2]=& _Tmp6;Cyc_printf(_tag_fat("%s: insert `%s' for `%s'\n",sizeof(char),26U),_tag_fat(_Tmp7,sizeof(void*),3));});}}}}
