...
void*_tmpA=t;struct Cyc_Port_Cvar*_tmp4E;void*_tmp4D;struct Cyc_List_List*_tmp4C;struct Cyc_List_List*_tmp4B;struct Cyc_List_List*_tmp4A;void*_tmp49;struct Cyc_Absyn_Aggrdecl*_tmp48;struct Cyc_List_List*_tmp47;void*_tmp46;void*_tmp45;void*_tmp44;void*_tmp43;void*_tmp42;void*_tmp41;void*_tmp40;void*_tmp3F;struct _dyneither_ptr*_tmp3E;switch(*((int*)_tmpA)){case 0: _LL1: _LL2:
 ...
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp17;_tmp17.tag=0;_tmp17.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp3E);({void*_tmp15[1]={& _tmp17};({struct _dyneither_ptr _tmp3B1=({const char*_tmp16="%s";_tag_dyneither(_tmp16,sizeof(char),3);});Cyc_aprintf(_tmp3B1,_tag_dyneither(_tmp15,sizeof(void*),1));});});});case 11: _LL17: _tmp43=(void*)((struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_tmpA)->f1;_tmp42=(void*)((struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_tmpA)->f2;_tmp41=(void*)((struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_tmpA)->f3;_tmp40=(void*)((struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_tmpA)->f4;_tmp3F=(void*)((struct Cyc_Port_Ptr_ct_Port_Ctype_struct*)_tmpA)->f5;_LL18:
# 180
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp1E;_tmp1E.tag=0;({struct _dyneither_ptr _tmp3B2=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 182
Cyc_Port_ctype2string(deep,_tmp3F));_tmp1E.f1=_tmp3B2;});({struct Cyc_String_pa_PrintArg_struct _tmp1D;_tmp1D.tag=0;({struct _dyneither_ptr _tmp3B3=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(deep,_tmp40));_tmp1D.f1=_tmp3B3;});({struct Cyc_String_pa_PrintArg_struct _tmp1C;_tmp1C.tag=0;({struct _dyneither_ptr _tmp3B4=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 181
Cyc_Port_ctype2string(deep,_tmp41));_tmp1C.f1=_tmp3B4;});({struct Cyc_String_pa_PrintArg_struct _tmp1B;_tmp1B.tag=0;({struct _dyneither_ptr _tmp3B5=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(deep,_tmp42));_tmp1B.f1=_tmp3B5;});({struct Cyc_String_pa_PrintArg_struct _tmp1A;_tmp1A.tag=0;({struct _dyneither_ptr _tmp3B6=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 180
Cyc_Port_ctype2string(deep,_tmp43));_tmp1A.f1=_tmp3B6;});({void*_tmp18[5]={& _tmp1A,& _tmp1B,& _tmp1C,& _tmp1D,& _tmp1E};({struct _dyneither_ptr _tmp3B7=({const char*_tmp19="ptr(%s,%s,%s,%s,%s)";_tag_dyneither(_tmp19,sizeof(char),20);});Cyc_aprintf(_tmp3B7,_tag_dyneither(_tmp18,sizeof(void*),5));});});});});});});});case 12: _LL19: _tmp46=(void*)((struct Cyc_Port_Array_ct_Port_Ctype_struct*)_tmpA)->f1;_tmp45=(void*)((struct Cyc_Port_Array_ct_Port_Ctype_struct*)_tmpA)->f2;_tmp44=(void*)((struct Cyc_Port_Array_ct_Port_Ctype_struct*)_tmpA)->f3;_LL1A:
# 184
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp23;_tmp23.tag=0;({struct _dyneither_ptr _tmp3B8=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Port_ctype2string(deep,_tmp44));_tmp23.f1=_tmp3B8;});({struct Cyc_String_pa_PrintArg_struct _tmp22;_tmp22.tag=0;({struct _dyneither_ptr _tmp3B9=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(deep,_tmp45));_tmp22.f1=_tmp3B9;});({struct Cyc_String_pa_PrintArg_struct _tmp21;_tmp21.tag=0;({struct _dyneither_ptr _tmp3BA=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 184
Cyc_Port_ctype2string(deep,_tmp46));_tmp21.f1=_tmp3BA;});({void*_tmp1F[3]={& _tmp21,& _tmp22,& _tmp23};({struct _dyneither_ptr _tmp3BB=({const char*_tmp20="array(%s,%s,%s)";_tag_dyneither(_tmp20,sizeof(char),16);});Cyc_aprintf(_tmp3BB,_tag_dyneither(_tmp1F,sizeof(void*),3));});});});});});case 13: _LL1B: _tmp48=(((struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*)_tmpA)->f1)->f1;_tmp47=(((struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*)_tmpA)->f1)->f2;_LL1C: {
# 187
...
if(!deep)
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp27;_tmp27.tag=0;({struct _dyneither_ptr _tmp3BC=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp48->name));_tmp27.f1=_tmp3BC;});({struct Cyc_String_pa_PrintArg_struct _tmp26;_tmp26.tag=0;_tmp26.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s);({void*_tmp24[2]={& _tmp26,& _tmp27};({struct _dyneither_ptr _tmp3BD=({const char*_tmp25="%s %s";_tag_dyneither(_tmp25,sizeof(char),6);});Cyc_aprintf(_tmp3BD,_tag_dyneither(_tmp24,sizeof(void*),2));});});});});else{
# 191
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2C;_tmp2C.tag=0;({struct _dyneither_ptr _tmp3BE=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Port_cfields2string(0,_tmp47));_tmp2C.f1=_tmp3BE;});({struct Cyc_String_pa_PrintArg_struct _tmp2B;_tmp2B.tag=0;({struct _dyneither_ptr _tmp3BF=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 191
Cyc_Absynpp_qvar2string(_tmp48->name));_tmp2B.f1=_tmp3BF;});({struct Cyc_String_pa_PrintArg_struct _tmp2A;_tmp2A.tag=0;_tmp2A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s);({void*_tmp28[3]={& _tmp2A,& _tmp2B,& _tmp2C};({struct _dyneither_ptr _tmp3C0=({const char*_tmp29="%s %s {%s}";_tag_dyneither(_tmp29,sizeof(char),11);});Cyc_aprintf(_tmp3C0,_tag_dyneither(_tmp28,sizeof(void*),3));});});});});});}}case 14: if(((struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)_tmpA)->f2 != 0){_LL1D: _tmp4A=((struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)_tmpA)->f1;_tmp49=*((struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*)_tmpA)->f2;_LL1E:
# 193
...
# 195
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp31;_tmp31.tag=0;({struct _dyneither_ptr _tmp3C1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_cfields2string(deep,_tmp4B));_tmp31.f1=_tmp3C1;});({void*_tmp2F[1]={& _tmp31};({struct _dyneither_ptr _tmp3C2=({const char*_tmp30="aggr {%s}";_tag_dyneither(_tmp30,sizeof(char),10);});Cyc_aprintf(_tmp3C2,_tag_dyneither(_tmp2F,sizeof(void*),1));});});});}case 15: _LL21: _tmp4D=(void*)((struct Cyc_Port_Fn_ct_Port_Ctype_struct*)_tmpA)->f1;_tmp4C=((struct Cyc_Port_Fn_ct_Port_Ctype_struct*)_tmpA)->f2;_LL22:
# 197
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp35;_tmp35.tag=0;({struct _dyneither_ptr _tmp3C3=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(deep,_tmp4D));_tmp35.f1=_tmp3C3;});({struct Cyc_String_pa_PrintArg_struct _tmp34;_tmp34.tag=0;({struct _dyneither_ptr _tmp3C4=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctypes2string(deep,_tmp4C));_tmp34.f1=_tmp3C4;});({void*_tmp32[2]={& _tmp34,& _tmp35};({struct _dyneither_ptr _tmp3C5=({const char*_tmp33="fn(%s)->%s";_tag_dyneither(_tmp33,sizeof(char),11);});Cyc_aprintf(_tmp3C5,_tag_dyneither(_tmp32,sizeof(void*),2));});});});});default: _LL23: _tmp4E=((struct Cyc_Port_Var_ct_Port_Ctype_struct*)_tmpA)->f1;_LL24:
# 199
...
return(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp38;_tmp38.tag=1;_tmp38.f1=(unsigned long)_tmp4E->id;({void*_tmp36[1]={& _tmp38};({struct _dyneither_ptr _tmp3C6=({const char*_tmp37="var(%d)";_tag_dyneither(_tmp37,sizeof(char),8);});Cyc_aprintf(_tmp3C6,_tag_dyneither(_tmp36,sizeof(void*),1));});});});else{
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp3D;_tmp3D.tag=0;({struct _dyneither_ptr _tmp3C7=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 206
Cyc_Port_ctypes2string(0,_tmp4E->uppers));_tmp3D.f1=_tmp3C7;});({struct Cyc_Int_pa_PrintArg_struct _tmp3C;_tmp3C.tag=1;_tmp3C.f1=(unsigned long)_tmp4E->id;({struct Cyc_String_pa_PrintArg_struct _tmp3B;_tmp3B.tag=0;({struct _dyneither_ptr _tmp3C8=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 204
Cyc_Port_ctypes2string(0,_tmp4E->lowers));_tmp3B.f1=_tmp3C8;});({void*_tmp39[3]={& _tmp3B,& _tmp3C,& _tmp3D};({struct _dyneither_ptr _tmp3C9=({const char*_tmp3A="var([%s]<=%d<=[%s])";_tag_dyneither(_tmp3A,sizeof(char),20);});Cyc_aprintf(_tmp3C9,_tag_dyneither(_tmp39,sizeof(void*),3));});});});});});}}}_LL0:;}
# 209
...
struct _dyneither_ptr s=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp5A;_tmp5A.tag=0;({struct _dyneither_ptr _tmp3CC=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Port_ctype2string(deep,f->type));_tmp5A.f1=_tmp3CC;});({struct Cyc_String_pa_PrintArg_struct _tmp59;_tmp59.tag=0;_tmp59.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*f->f);({struct Cyc_String_pa_PrintArg_struct _tmp58;_tmp58.tag=0;({struct _dyneither_ptr _tmp3CD=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Port_ctype2string(deep,f->qual));_tmp58.f1=_tmp3CD;});({void*_tmp56[3]={& _tmp58,& _tmp59,& _tmp5A};({struct _dyneither_ptr _tmp3CE=({const char*_tmp57="%s %s: %s";_tag_dyneither(_tmp57,sizeof(char),10);});Cyc_aprintf(_tmp3CE,_tag_dyneither(_tmp56,sizeof(void*),3));});});});});});
return({struct _dyneither_ptr*_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55[0]=s;_tmp55;});}
# 225
static struct _dyneither_ptr Cyc_Port_ctypes2string(int deep,struct Cyc_List_List*ts){
return(struct _dyneither_ptr)Cyc_strconcat_l(({struct _dyneither_ptr _tmp3CF=({const char*_tmp5B=",";_tag_dyneither(_tmp5B,sizeof(char),2);});Cyc_Port_sep(_tmp3CF,((struct Cyc_List_List*(*)(struct _dyneither_ptr*(*f)(int,void*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Port_ctype2stringptr,deep,ts));}));}struct Cyc_Port_Cfield;
# 228
static struct _dyneither_ptr Cyc_Port_cfields2string(int deep,struct Cyc_List_List*fs){
return(struct _dyneither_ptr)Cyc_strconcat_l(({struct _dyneither_ptr _tmp3D0=({const char*_tmp5C=";";_tag_dyneither(_tmp5C,sizeof(char),2);});Cyc_Port_sep(_tmp3D0,((struct Cyc_List_List*(*)(struct _dyneither_ptr*(*f)(int,struct Cyc_Port_Cfield*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Port_cfield2stringptr,deep,fs));}));}
# 234
...
return(void*)({struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct*_tmp5F=_cycalloc(sizeof(*_tmp5F));({struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct _tmp3D2=({struct Cyc_Port_UnknownAggr_ct_Port_Ctype_struct _tmp60;_tmp60.tag=14;_tmp60.f1=fs;_tmp60.f2=0;_tmp60;});_tmp5F[0]=_tmp3D2;});_tmp5F;});}
# 248
static void*Cyc_Port_known_aggr_ct(struct _tuple11*p){
return(void*)({struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct*_tmp61=_cycalloc(sizeof(*_tmp61));({struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct _tmp3D3=({struct Cyc_Port_KnownAggr_ct_Port_Ctype_struct _tmp62;_tmp62.tag=13;_tmp62.f1=p;_tmp62;});_tmp61[0]=_tmp3D3;});_tmp61;});}
# 251
static void*Cyc_Port_ptr_ct(void*elt,void*qual,void*ptr_kind,void*r,void*zt){
# 253
return(void*)({struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_tmp63=_cycalloc(sizeof(*_tmp63));({struct Cyc_Port_Ptr_ct_Port_Ctype_struct _tmp3D4=({struct Cyc_Port_Ptr_ct_Port_Ctype_struct _tmp64;_tmp64.tag=11;_tmp64.f1=elt;_tmp64.f2=qual;_tmp64.f3=ptr_kind;_tmp64.f4=r;_tmp64.f5=zt;_tmp64;});_tmp63[0]=_tmp3D4;});_tmp63;});}
# 255
static void*Cyc_Port_array_ct(void*elt,void*qual,void*zt){
return(void*)({struct Cyc_Port_Array_ct_Port_Ctype_struct*_tmp65=_cycalloc(sizeof(*_tmp65));({struct Cyc_Port_Array_ct_Port_Ctype_struct _tmp3D5=({struct Cyc_Port_Array_ct_Port_Ctype_struct _tmp66;_tmp66.tag=12;_tmp66.f1=elt;_tmp66.f2=qual;_tmp66.f3=zt;_tmp66;});_tmp65[0]=_tmp3D5;});_tmp65;});}
# 258
static void*Cyc_Port_fn_ct(void*return_type,struct Cyc_List_List*args){
return(void*)({struct Cyc_Port_Fn_ct_Port_Ctype_struct*_tmp67=_cycalloc(sizeof(*_tmp67));({struct Cyc_Port_Fn_ct_Port_Ctype_struct _tmp3D6=({struct Cyc_Port_Fn_ct_Port_Ctype_struct _tmp68;_tmp68.tag=15;_tmp68.f1=return_type;_tmp68.f2=args;_tmp68;});_tmp67[0]=_tmp3D6;});_tmp67;});}struct Cyc_Port_Cvar;struct Cyc_Port_Cvar;
# 261
static void*Cyc_Port_var(){
static int counter=0;
return(void*)({struct Cyc_Port_Var_ct_Port_Ctype_struct*_tmp69=_cycalloc(sizeof(*_tmp69));({struct Cyc_Port_Var_ct_Port_Ctype_struct _tmp3D8=({struct Cyc_Port_Var_ct_Port_Ctype_struct _tmp6A;_tmp6A.tag=16;({struct Cyc_Port_Cvar*_tmp3D7=({struct Cyc_Port_Cvar*_tmp6B=_cycalloc(sizeof(*_tmp6B));_tmp6B->id=counter ++;_tmp6B->eq=0;_tmp6B->uppers=0;_tmp6B->lowers=0;_tmp6B;});_tmp6A.f1=_tmp3D7;});_tmp6A;});_tmp69[0]=_tmp3D8;});_tmp69;});}
# 265
...
static int counter=0;
struct _dyneither_ptr s=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp6F;_tmp6F.tag=1;_tmp6F.f1=(unsigned long)counter ++;({void*_tmp6D[1]={& _tmp6F};({struct _dyneither_ptr _tmp3D9=({const char*_tmp6E="`R%d";_tag_dyneither(_tmp6E,sizeof(char),5);});Cyc_aprintf(_tmp3D9,_tag_dyneither(_tmp6D,sizeof(void*),1));});});});
...
return(void*)({struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_tmp81=_cycalloc(sizeof(*_tmp81));({struct Cyc_Port_Ptr_ct_Port_Ctype_struct _tmp3E2=({struct Cyc_Port_Ptr_ct_Port_Ctype_struct _tmp82;_tmp82.tag=11;_tmp82.f1=_tmp84;_tmp82.f2=_tmp8F;_tmp82.f3=_tmp8E;_tmp82.f4=_tmp83;_tmp82.f5=_tmp8C;_tmp82;});_tmp81[0]=_tmp3E2;});_tmp81;});}case 12: _LL65: _tmp93=(void*)((struct Cyc_Port_Array_ct_Port_Ctype_struct*)_tmp7E)->f1;_tmp92=(void*)((struct Cyc_Port_Array_ct_Port_Ctype_struct*)_tmp7E)->f2;_tmp91=(void*)((struct Cyc_Port_Array_ct_Port_Ctype_struct*)_tmp7E)->f3;_LL66: {
# 355
void*_tmp86=Cyc_Port_inst(instenv,_tmp93);
if(_tmp86 == _tmp93)return t;
return(void*)({struct Cyc_Port_Array_ct_Port_Ctype_struct*_tmp87=_cycalloc(sizeof(*_tmp87));({struct Cyc_Port_Array_ct_Port_Ctype_struct _tmp3E3=({struct Cyc_Port_Array_ct_Port_Ctype_struct _tmp88;_tmp88.tag=12;_tmp88.f1=_tmp86;_tmp88.f2=_tmp92;_tmp88.f3=_tmp91;_tmp88;});_tmp87[0]=_tmp3E3;});_tmp87;});}default: _LL67: _tmp95=(void*)((struct Cyc_Port_Fn_ct_Port_Ctype_struct*)_tmp7E)->f1;_tmp94=((struct Cyc_Port_Fn_ct_Port_Ctype_struct*)_tmp7E)->f2;_LL68:
# 359
 return(void*)({struct Cyc_Port_Fn_ct_Port_Ctype_struct*_tmp89=_cycalloc(sizeof(*_tmp89));({struct Cyc_Port_Fn_ct_Port_Ctype_struct _tmp3E6=({struct Cyc_Port_Fn_ct_Port_Ctype_struct _tmp8A;_tmp8A.tag=15;({void*_tmp3E4=Cyc_Port_inst(instenv,_tmp95);_tmp8A.f1=_tmp3E4;});({struct Cyc_List_List*_tmp3E5=((struct Cyc_List_List*(*)(void*(*f)(struct Cyc_Dict_Dict*,void*),struct Cyc_Dict_Dict*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Port_inst,instenv,_tmp94);_tmp8A.f2=_tmp3E5;});_tmp8A;});_tmp89[0]=_tmp3E6;});_tmp89;});}_LL46:;}
# 363
...
struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_tmp117=({struct Cyc_Port_Ptr_ct_Port_Ctype_struct*_tmp118=_cycalloc(sizeof(*_tmp118));({struct Cyc_Port_Ptr_ct_Port_Ctype_struct _tmp407=({struct Cyc_Port_Ptr_ct_Port_Ctype_struct _tmp119;_tmp119.tag=11;_tmp119.f1=_tmp11E;_tmp119.f2=_tmp11D;_tmp119.f3=_tmp11C;_tmp119.f4=_tmp11B;_tmp119.f5=_tmp11A;_tmp119;});_tmp118[0]=_tmp407;});_tmp118;});
...
# 897
 return({struct _tuple13 _tmp173;({struct _tuple10 _tmp41C=({struct _tuple10 _tmp174;({void*_tmp41A=Cyc_Port_var();_tmp174.f1=_tmp41A;});({void*_tmp41B=Cyc_Port_var();_tmp174.f2=_tmp41B;});_tmp174;});_tmp173.f1=_tmp41C;});_tmp173.f2=0;_tmp173;});}else{_LL153: _tmp175=_tmp172;_LL154:(int)_rethrow(_tmp175);}_LL150:;}};}struct Cyc_Port_Cenv;struct Cyc_Port_Cenv;
# 900
...
({void*_tmp41D=Cyc_Port_lookup_typedef(env,_tmp17E);_tmp17F=_tmp41D;});goto LOOP;case 9: _LL15B: _LL15C: {
...
({void*_tmp41E=Cyc_Port_lookup_typedef(env,_tmp18A);_tmp18B=_tmp41E;});goto LOOP;case 8: _LL16A: _LL16B: {
...
Cyc_Absyn_empty_tqual(0);_tmp1A3->f2=_tmp431;});_tmp1A3->f3=Cyc_Absyn_sint_typ;_tmp1A3;});
struct _tuple8*arg2=({struct _tuple8*_tmp1A2=_cycalloc(sizeof(*_tmp1A2));_tmp1A2->f1=0;({struct Cyc_Absyn_Tqual _tmp432=
Cyc_Absyn_empty_tqual(0);_tmp1A2->f2=_tmp432;});({void*_tmp436=({
...
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp19E=_cycalloc(sizeof(*_tmp19E));({struct Cyc_Absyn_FnType_Absyn_Type_struct _tmp43A=({struct Cyc_Absyn_FnType_Absyn_Type_struct _tmp19F;_tmp19F.tag=9;({struct Cyc_Absyn_FnInfo _tmp439=({struct Cyc_Absyn_FnInfo _tmp1A0;_tmp1A0.tvars=0;_tmp1A0.effect=0;({struct Cyc_Absyn_Tqual _tmp437=
Cyc_Absyn_empty_tqual(0);_tmp1A0.ret_tqual=_tmp437;});_tmp1A0.ret_typ=Cyc_Absyn_sint_typ;({struct Cyc_List_List*_tmp438=({struct _tuple8*_tmp1A1[2];_tmp1A1[1]=arg2;_tmp1A1[0]=arg1;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp1A1,sizeof(struct _tuple8*),2));});_tmp1A0.args=_tmp438;});_tmp1A0.c_varargs=0;_tmp1A0.cyc_varargs=0;_tmp1A0.rgn_po=0;_tmp1A0.attributes=0;_tmp1A0.requires_clause=0;_tmp1A0.requires_relns=0;_tmp1A0.ensures_clause=0;_tmp1A0.ensures_relns=0;_tmp1A0;});_tmp19F.f1=_tmp439;});_tmp19F;});_tmp19E[0]=_tmp43A;});_tmp19E;});}struct Cyc_Port_Cenv;
# 1022
...
# 1028
({struct Cyc_Port_Cenv*_tmp441=({struct Cyc_Port_Cenv*_tmp440=_tmp1A4;struct _tuple0*_tmp43F=({struct _tuple0*_tmp1A5=_cycalloc(sizeof(*_tmp1A5));_tmp1A5->f1=Cyc_Absyn_Loc_n;({struct _dyneither_ptr*_tmp43B=_init_dyneither_ptr(_cycalloc(sizeof(struct _dyneither_ptr)),"main",sizeof(char),5);_tmp1A5->f2=_tmp43B;});_tmp1A5;});void*_tmp43E=Cyc_Port_main_type();void*_tmp43D=Cyc_Port_const_ct();Cyc_Port_add_var(_tmp440,_tmp43F,_tmp43E,_tmp43D,({
struct Cyc_Port_Cenv*_tmp43C=_tmp1A4;Cyc_Port_type_to_ctype(_tmp43C,Cyc_Port_main_type());}),0);});
# 1028
_tmp1A4=_tmp441;});
# 1030
return _tmp1A4;}
...
return({struct Cyc_Port_Cenv*_tmp44B=env;Cyc_Port_is_char(_tmp44B,Cyc_Port_lookup_typedef(env,_tmp1CE));});case 6: _LL1A5: _tmp1CF=((struct Cyc_Absyn_IntType_Absyn_Type_struct*)_tmp1CD)->f2;_LL1A6:
...
# 1153
({void*_tmp44C=Cyc_Port_heap_ct();new_rgn=_tmp44C;});goto _LL1C0;case 2: _LL1C3: _tmp1D6=(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp1D5)->f1)->name;_LL1C4:
# 1155
({void*_tmp44D=Cyc_Port_rgnvar_ct(_tmp1D6);new_rgn=_tmp44D;});goto _LL1C0;case 1: _LL1C5: _LL1C6:
# 1159
...
# 1260
return({void*_tmp471=_tmp1E6;Cyc_Port_fn_ct(_tmp471,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(cargs));});}case 11: _LL1B8: _tmp206=(((struct Cyc_Absyn_AggrType_Absyn_Type_struct*)_tmp1D0)->f1).aggr_info;_LL1B9: {
# 1262
...
({struct Cyc_Port_Cenv*_tmp476=({struct Cyc_Port_Cenv*_tmp475=env;struct _tuple0*_tmp474=((struct Cyc_Absyn_Enumfield*)_tmp207->hd)->name;void*_tmp473=Cyc_Absyn_sint_typ;void*_tmp472=Cyc_Port_const_ct();Cyc_Port_add_var(_tmp475,_tmp474,_tmp473,_tmp472,Cyc_Port_arith_ct(),0);});env=_tmp476;});}
# 1289
...
({void*_tmp20D=0;({struct _dyneither_ptr _tmp496=({const char*_tmp20E=".size primop";_tag_dyneither(_tmp20E,sizeof(char),13);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp496,_tag_dyneither(_tmp20D,sizeof(void*),0));});});}_LL1EC:;}struct Cyc_Port_Cenv;struct Cyc_Port_Cenv;struct Cyc_Port_Cfield;struct Cyc_Port_Cfield;struct Cyc_Port_Cfield;struct Cyc_Port_Cfield;struct Cyc_Port_Cfield;struct Cyc_Port_Cfield;
# 1354
...
return _tmp216;};}case 23: _LL218: _tmp232=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp211)->f1;_tmp231=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp211)->f2;_LL219: {
# 1363
...
return({struct _tuple10 _tmp21B;_tmp21B.f1=_tmp218;_tmp21B.f2=_tmp217;_tmp21B;});};}case 20: _LL21A: _tmp233=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp211)->f1;_LL21B: {
# 1371
...
return({struct _tuple10 _tmp21F;_tmp21F.f1=_tmp21D;_tmp21F.f2=_tmp21C;_tmp21F;});}case 21: _LL21C: _tmp235=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp211)->f1;_tmp234=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp211)->f2;_LL21D: {
# 1377
void*_tmp220=Cyc_Port_var();
void*_tmp221=Cyc_Port_var();
void*_tmp222=Cyc_Port_gen_exp(takeaddress,env,_tmp235);
({void*_tmp4A2=_tmp222;Cyc_Port_leq(_tmp4A2,Cyc_Port_unknown_aggr_ct(({struct Cyc_Port_Cfield*_tmp223[1];({struct Cyc_Port_Cfield*_tmp4A1=({struct Cyc_Port_Cfield*_tmp224=_cycalloc(sizeof(*_tmp224));_tmp224->qual=_tmp221;_tmp224->f=_tmp234;_tmp224->type=_tmp220;_tmp224;});_tmp223[0]=_tmp4A1;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp223,sizeof(struct Cyc_Port_Cfield*),1));})));});
return({struct _tuple10 _tmp225;_tmp225.f1=_tmp221;_tmp225.f2=_tmp220;_tmp225;});}case 22: _LL21E: _tmp237=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp211)->f1;_tmp236=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp211)->f2;_LL21F: {
# 1383
void*_tmp226=Cyc_Port_var();
void*_tmp227=Cyc_Port_var();
void*_tmp228=Cyc_Port_gen_exp(0,env,_tmp237);
({void*_tmp4A8=_tmp228;Cyc_Port_leq(_tmp4A8,({void*_tmp4A7=Cyc_Port_unknown_aggr_ct(({struct Cyc_Port_Cfield*_tmp229[1];({struct Cyc_Port_Cfield*_tmp4A3=({struct Cyc_Port_Cfield*_tmp22A=_cycalloc(sizeof(*_tmp22A));_tmp22A->qual=_tmp227;_tmp22A->f=_tmp236;_tmp22A->type=_tmp226;_tmp22A;});_tmp229[0]=_tmp4A3;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp229,sizeof(struct Cyc_Port_Cfield*),1));}));void*_tmp4A6=
Cyc_Port_var();
# 1386
void*_tmp4A5=
Cyc_Port_var();
...
({void*_tmp22C=0;({struct _dyneither_ptr _tmp4AB=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp22F;_tmp22F.tag=0;({struct _dyneither_ptr _tmp4A9=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp22F.f1=_tmp4A9;});({void*_tmp22D[1]={& _tmp22F};({struct _dyneither_ptr _tmp4AA=({const char*_tmp22E="gen_lhs: %s";_tag_dyneither(_tmp22E,sizeof(char),12);});Cyc_aprintf(_tmp4AA,_tag_dyneither(_tmp22D,sizeof(void*),1));});});});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4AB,_tag_dyneither(_tmp22C,sizeof(void*),0));});});}_LL215:;}struct Cyc_Port_Cenv;struct Cyc_Port_Cenv;
# 1394
...
# 1412
 return({void*_tmp4AF=Cyc_Port_arith_ct();void*_tmp4AE=Cyc_Port_const_ct();void*_tmp4AD=Cyc_Port_fat_ct();void*_tmp4AC=Cyc_Port_heap_ct();Cyc_Port_ptr_ct(_tmp4AF,_tmp4AE,_tmp4AD,_tmp4AC,Cyc_Port_zterm_ct());});case 9: _LL240: _LL241:
# 1414
 ...
 return Cyc_Port_zero_ct();}case 17: _LL22E: _LL22F:
# 1403
 goto _LL231;case 18: _LL230: _LL231:
 goto _LL233;case 19: _LL232: _LL233:
 goto _LL235;case 32: _LL234: _LL235:
 goto _LL237;case 33: _LL236: _LL237:
 goto _LL239;case 1: _LL244: _tmp28D=(void*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_LL245: {
# 1417
...
return _tmp243;}}};};}case 3: _LL246: _tmp28F=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp28E=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_LL247:
# 1437
 return({struct Cyc_Port_Cenv*_tmp4BE=env;enum Cyc_Absyn_Primop _tmp4BD=_tmp28F;Cyc_Port_gen_primop(_tmp4BE,_tmp4BD,((struct Cyc_List_List*(*)(void*(*f)(struct Cyc_Port_Cenv*,struct Cyc_Absyn_Exp*),struct Cyc_Port_Cenv*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Port_gen_exp_false,env,_tmp28E));});case 4: _LL248: _tmp292=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp291=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_tmp290=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp239)->f3;_LL249: {
# 1439
...
return _tmp24C;}};}case 5: _LL24A: _tmp294=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp293=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_LL24B: {
# 1453
...
return _tmp250;}case 6: _LL24C: _tmp297=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp296=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_tmp295=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp239)->f3;_LL24D: {
# 1460
...
return _tmp252;}case 7: _LL24E: _tmp299=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp298=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_LL24F:
 _tmp29B=_tmp299;_tmp29A=_tmp298;goto _LL251;case 8: _LL250: _tmp29B=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp29A=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_LL251:
# 1467
...
return Cyc_Port_arith_ct();case 9: _LL252: _tmp29D=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp29C=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_LL253:
# 1471
 Cyc_Port_gen_exp(0,env,_tmp29D);
return Cyc_Port_gen_exp(0,env,_tmp29C);case 10: _LL254: _tmp29F=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp29E=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_LL255: {
# 1474
...
# 1482
return _tmp253;}case 11: _LL256: _LL257:
({void*_tmp257=0;({struct _dyneither_ptr _tmp4D1=({const char*_tmp258="throw";_tag_dyneither(_tmp258,sizeof(char),6);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4D1,_tag_dyneither(_tmp257,sizeof(void*),0));});});case 12: _LL258: _tmp2A0=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_LL259:
 return Cyc_Port_gen_exp(0,env,_tmp2A0);case 13: _LL25A: _LL25B:
({void*_tmp259=0;({struct _dyneither_ptr _tmp4D2=({const char*_tmp25A="instantiate";_tag_dyneither(_tmp25A,sizeof(char),12);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4D2,_tag_dyneither(_tmp259,sizeof(void*),0));});});case 14: _LL25C: _tmp2A2=(void*)((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp2A1=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_LL25D: {
# 1487
void*_tmp25B=Cyc_Port_type_to_ctype(env,_tmp2A2);
void*_tmp25C=Cyc_Port_gen_exp(0,env,_tmp2A1);
Cyc_Port_leq(_tmp25B,_tmp25C);
return _tmp25C;}case 15: _LL25E: _tmp2A3=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_LL25F: {
# 1492
...
return _tmp261;};}case 20: _LL262: _tmp2A6=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_LL263: {
# 1501
...
return _tmp263;}case 21: _LL264: _tmp2A8=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp2A7=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_LL265: {
# 1505
void*_tmp264=Cyc_Port_var();
void*_tmp265=Cyc_Port_gen_exp(takeaddress,env,_tmp2A8);
({void*_tmp4E4=_tmp265;Cyc_Port_leq(_tmp4E4,Cyc_Port_unknown_aggr_ct(({struct Cyc_Port_Cfield*_tmp266[1];({struct Cyc_Port_Cfield*_tmp4E3=({struct Cyc_Port_Cfield*_tmp267=_cycalloc(sizeof(*_tmp267));({void*_tmp4E2=Cyc_Port_var();_tmp267->qual=_tmp4E2;});_tmp267->f=_tmp2A7;_tmp267->type=_tmp264;_tmp267;});_tmp266[0]=_tmp4E3;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp266,sizeof(struct Cyc_Port_Cfield*),1));})));});
return _tmp264;}case 22: _LL266: _tmp2AA=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp2A9=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_LL267: {
# 1510
void*_tmp268=Cyc_Port_var();
void*_tmp269=Cyc_Port_gen_exp(0,env,_tmp2AA);
({void*_tmp4EB=Cyc_Port_gen_exp(0,env,_tmp2AA);Cyc_Port_leq(_tmp4EB,({void*_tmp4EA=Cyc_Port_unknown_aggr_ct(({struct Cyc_Port_Cfield*_tmp26A[1];({struct Cyc_Port_Cfield*_tmp4E6=({struct Cyc_Port_Cfield*_tmp26B=_cycalloc(sizeof(*_tmp26B));({void*_tmp4E5=Cyc_Port_var();_tmp26B->qual=_tmp4E5;});_tmp26B->f=_tmp2A9;_tmp26B->type=_tmp268;_tmp26B;});_tmp26A[0]=_tmp4E6;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp26A,sizeof(struct Cyc_Port_Cfield*),1));}));void*_tmp4E9=
Cyc_Port_var();
# 1512
void*_tmp4E8=
Cyc_Port_var();
...
Cyc_Port_var());}));});
return _tmp268;}case 34: _LL268: _tmp2AC=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp239)->f1).elt_type;_tmp2AB=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp239)->f1).num_elts;_LL269:
# 1516
...
return({void*_tmp4F0=_tmp26C;void*_tmp4EF=Cyc_Port_var();void*_tmp4EE=Cyc_Port_fat_ct();void*_tmp4ED=Cyc_Port_heap_ct();Cyc_Port_ptr_ct(_tmp4F0,_tmp4EF,_tmp4EE,_tmp4ED,Cyc_Port_var());});};case 2: _LL26A: _LL26B:
({void*_tmp26D=0;({struct _dyneither_ptr _tmp4F1=({const char*_tmp26E="Pragma_e";_tag_dyneither(_tmp26E,sizeof(char),9);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F1,_tag_dyneither(_tmp26D,sizeof(void*),0));});});case 35: _LL26C: _tmp2AE=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_tmp2AD=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp239)->f2;_LL26D:
({void*_tmp26F=0;({struct _dyneither_ptr _tmp4F2=({const char*_tmp270="Swap_e";_tag_dyneither(_tmp270,sizeof(char),7);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F2,_tag_dyneither(_tmp26F,sizeof(void*),0));});});case 16: _LL26E: _LL26F:
({void*_tmp271=0;({struct _dyneither_ptr _tmp4F3=({const char*_tmp272="New_e";_tag_dyneither(_tmp272,sizeof(char),6);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F3,_tag_dyneither(_tmp271,sizeof(void*),0));});});case 24: _LL270: _LL271:
({void*_tmp273=0;({struct _dyneither_ptr _tmp4F4=({const char*_tmp274="Tuple_e";_tag_dyneither(_tmp274,sizeof(char),8);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F4,_tag_dyneither(_tmp273,sizeof(void*),0));});});case 25: _LL272: _LL273:
({void*_tmp275=0;({struct _dyneither_ptr _tmp4F5=({const char*_tmp276="CompoundLit_e";_tag_dyneither(_tmp276,sizeof(char),14);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F5,_tag_dyneither(_tmp275,sizeof(void*),0));});});case 26: _LL274: _LL275:
({void*_tmp277=0;({struct _dyneither_ptr _tmp4F6=({const char*_tmp278="Array_e";_tag_dyneither(_tmp278,sizeof(char),8);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F6,_tag_dyneither(_tmp277,sizeof(void*),0));});});case 27: _LL276: _LL277:
({void*_tmp279=0;({struct _dyneither_ptr _tmp4F7=({const char*_tmp27A="Comprehension_e";_tag_dyneither(_tmp27A,sizeof(char),16);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F7,_tag_dyneither(_tmp279,sizeof(void*),0));});});case 28: _LL278: _LL279:
({void*_tmp27B=0;({struct _dyneither_ptr _tmp4F8=({const char*_tmp27C="ComprehensionNoinit_e";_tag_dyneither(_tmp27C,sizeof(char),22);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F8,_tag_dyneither(_tmp27B,sizeof(void*),0));});});case 29: _LL27A: _LL27B:
({void*_tmp27D=0;({struct _dyneither_ptr _tmp4F9=({const char*_tmp27E="Aggregate_e";_tag_dyneither(_tmp27E,sizeof(char),12);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4F9,_tag_dyneither(_tmp27D,sizeof(void*),0));});});case 30: _LL27C: _LL27D:
({void*_tmp27F=0;({struct _dyneither_ptr _tmp4FA=({const char*_tmp280="AnonStruct_e";_tag_dyneither(_tmp280,sizeof(char),13);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4FA,_tag_dyneither(_tmp27F,sizeof(void*),0));});});case 31: _LL27E: _LL27F:
({void*_tmp281=0;({struct _dyneither_ptr _tmp4FB=({const char*_tmp282="Datatype_e";_tag_dyneither(_tmp282,sizeof(char),11);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4FB,_tag_dyneither(_tmp281,sizeof(void*),0));});});case 36: _LL280: _LL281:
({void*_tmp283=0;({struct _dyneither_ptr _tmp4FC=({const char*_tmp284="UnresolvedMem_e";_tag_dyneither(_tmp284,sizeof(char),16);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4FC,_tag_dyneither(_tmp283,sizeof(void*),0));});});case 37: _LL282: _tmp2AF=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp239)->f1;_LL283:
({void*_tmp285=0;({struct _dyneither_ptr _tmp4FD=({const char*_tmp286="StmtExp_e";_tag_dyneither(_tmp286,sizeof(char),10);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4FD,_tag_dyneither(_tmp285,sizeof(void*),0));});});case 39: _LL284: _LL285:
({void*_tmp287=0;({struct _dyneither_ptr _tmp4FE=({const char*_tmp288="Valueof_e";_tag_dyneither(_tmp288,sizeof(char),10);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4FE,_tag_dyneither(_tmp287,sizeof(void*),0));});});case 40: _LL286: _LL287:
({void*_tmp289=0;({struct _dyneither_ptr _tmp4FF=({const char*_tmp28A="Asm_e";_tag_dyneither(_tmp28A,sizeof(char),6);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp4FF,_tag_dyneither(_tmp289,sizeof(void*),0));});});default: _LL288: _LL289:
({void*_tmp28B=0;({struct _dyneither_ptr _tmp500=({const char*_tmp28C="Tagcheck_e";_tag_dyneither(_tmp28C,sizeof(char),11);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp500,_tag_dyneither(_tmp28B,sizeof(void*),0));});});}_LL225:;}struct Cyc_Port_Cenv;struct Cyc_Port_Cenv;
# 1539
static void Cyc_Port_gen_stmt(struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Stmt*s){
void*_tmp2B0=s->r;void*_tmp2B1=_tmp2B0;struct Cyc_Absyn_Stmt*_tmp2CB;struct Cyc_Absyn_Exp*_tmp2CA;struct Cyc_Absyn_Stmt*_tmp2C9;struct Cyc_Absyn_Decl*_tmp2C8;struct Cyc_Absyn_Stmt*_tmp2C7;struct Cyc_Absyn_Exp*_tmp2C6;struct Cyc_List_List*_tmp2C5;struct Cyc_Absyn_Exp*_tmp2C4;struct Cyc_Absyn_Exp*_tmp2C3;struct Cyc_Absyn_Exp*_tmp2C2;struct Cyc_Absyn_Stmt*_tmp2C1;struct Cyc_Absyn_Exp*_tmp2C0;struct Cyc_Absyn_Stmt*_tmp2BF;struct Cyc_Absyn_Exp*_tmp2BE;struct Cyc_Absyn_Stmt*_tmp2BD;struct Cyc_Absyn_Stmt*_tmp2BC;struct Cyc_Absyn_Exp*_tmp2BB;struct Cyc_Absyn_Stmt*_tmp2BA;struct Cyc_Absyn_Stmt*_tmp2B9;struct Cyc_Absyn_Exp*_tmp2B8;switch(*((int*)_tmp2B1)){case 0: _LL29A: _LL29B:
 return;case 1: _LL29C: _tmp2B8=((struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f1;_LL29D:
 Cyc_Port_gen_exp(0,env,_tmp2B8);return;case 2: _LL29E: _tmp2BA=((struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f1;_tmp2B9=((struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f2;_LL29F:
 Cyc_Port_gen_stmt(env,_tmp2BA);Cyc_Port_gen_stmt(env,_tmp2B9);return;case 3: _LL2A0: _tmp2BB=((struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f1;_LL2A1: {
# 1545
...
return;}case 4: _LL2A2: _tmp2BE=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f1;_tmp2BD=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f2;_tmp2BC=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f3;_LL2A3:
# 1550
...
return;case 5: _LL2A4: _tmp2C0=(((struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f1).f1;_tmp2BF=((struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f2;_LL2A5:
# 1555
({void*_tmp502=Cyc_Port_gen_exp(0,env,_tmp2C0);Cyc_Port_leq(_tmp502,Cyc_Port_arith_ct());});
Cyc_Port_gen_stmt(env,_tmp2BF);
return;case 6: _LL2A6: _LL2A7:
 goto _LL2A9;case 7: _LL2A8: _LL2A9:
 goto _LL2AB;case 8: _LL2AA: _LL2AB:
 return;case 9: _LL2AC: _tmp2C4=((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f1;_tmp2C3=(((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f2).f1;_tmp2C2=(((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f3).f1;_tmp2C1=((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f4;_LL2AD:
# 1562
...
return;case 10: _LL2AE: _tmp2C6=((struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f1;_tmp2C5=((struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f2;_LL2AF:
# 1568
...
# 1573
return;case 11: _LL2B0: _LL2B1:
({void*_tmp2B4=0;({struct _dyneither_ptr _tmp505=({const char*_tmp2B5="fallthru";_tag_dyneither(_tmp2B5,sizeof(char),9);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp505,_tag_dyneither(_tmp2B4,sizeof(void*),0));});});case 12: _LL2B2: _tmp2C8=((struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f1;_tmp2C7=((struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f2;_LL2B3:
# 1576
({struct Cyc_Port_Cenv*_tmp506=Cyc_Port_gen_localdecl(env,_tmp2C8,0);env=_tmp506;});Cyc_Port_gen_stmt(env,_tmp2C7);return;case 13: _LL2B4: _tmp2C9=((struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f2;_LL2B5:
 Cyc_Port_gen_stmt(env,_tmp2C9);return;case 14: _LL2B6: _tmp2CB=((struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f1;_tmp2CA=(((struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp2B1)->f2).f1;_LL2B7:
# 1579
...
({void*_tmp2B6=0;({struct _dyneither_ptr _tmp508=({const char*_tmp2B7="try/catch";_tag_dyneither(_tmp2B7,sizeof(char),10);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp508,_tag_dyneither(_tmp2B6,sizeof(void*),0));});});}_LL299:;}struct Cyc_Port_Cenv;struct Cyc_Port_Cenv;struct _tuple17{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
# 1587
static void*Cyc_Port_gen_initializer(struct Cyc_Port_Cenv*env,void*t,struct Cyc_Absyn_Exp*e){
void*_tmp2CC=e->r;void*_tmp2CD=_tmp2CC;struct Cyc_List_List*_tmp2F4;struct Cyc_List_List*_tmp2F3;struct Cyc_List_List*_tmp2F2;switch(*((int*)_tmp2CD)){case 36: _LL2BB: _tmp2F2=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmp2CD)->f2;_LL2BC:
 _tmp2F3=_tmp2F2;goto _LL2BE;case 26: _LL2BD: _tmp2F3=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp2CD)->f1;_LL2BE:
 _tmp2F4=_tmp2F3;goto _LL2C0;case 25: _LL2BF: _tmp2F4=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp2CD)->f2;_LL2C0:
# 1592
 LOOP: {
void*_tmp2CE=t;struct Cyc_Absyn_Aggrdecl*_tmp2EF;struct _tuple0*_tmp2EE;void*_tmp2ED;union Cyc_Absyn_Constraint*_tmp2EC;unsigned int _tmp2EB;struct _tuple0*_tmp2EA;switch(*((int*)_tmp2CE)){case 17: _LL2C8: _tmp2EA=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp2CE)->f1;_LL2C9:
# 1595
(*_tmp2EA).f1=Cyc_Absyn_Loc_n;
({void*_tmp509=Cyc_Port_lookup_typedef(env,_tmp2EA);t=_tmp509;});goto LOOP;case 8: _LL2CA: _tmp2ED=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp2CE)->f1).elt_type;_tmp2EC=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp2CE)->f1).zero_term;_tmp2EB=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp2CE)->f1).zt_loc;_LL2CB: {
# 1598
...
if((unsigned int)_tmp2D9)({void*_tmp2D5=0;({struct _dyneither_ptr _tmp50A=({const char*_tmp2D6="designators in initializers";_tag_dyneither(_tmp2D6,sizeof(char),28);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp50A,_tag_dyneither(_tmp2D5,sizeof(void*),0));});});{
void*_tmp2D7=Cyc_Port_gen_initializer(env,_tmp2ED,_tmp2D8);
Cyc_Port_leq(_tmp2D7,_tmp2CF);};}
# 1608
return Cyc_Port_array_ct(_tmp2CF,_tmp2D0,_tmp2D1);}case 11: if((((((struct Cyc_Absyn_AggrType_Absyn_Type_struct*)_tmp2CE)->f1).aggr_info).UnknownAggr).tag == 1){if(((((((struct Cyc_Absyn_AggrType_Absyn_Type_struct*)_tmp2CE)->f1).aggr_info).UnknownAggr).val).f1 == Cyc_Absyn_StructA){_LL2CC: _tmp2EE=((((((struct Cyc_Absyn_AggrType_Absyn_Type_struct*)_tmp2CE)->f1).aggr_info).UnknownAggr).val).f2;_LL2CD:
# 1610
...
if(_tmp2DE == 0)({void*_tmp2DC=0;({struct _dyneither_ptr _tmp50B=({const char*_tmp2DD="struct is not yet defined";_tag_dyneither(_tmp2DD,sizeof(char),26);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp50B,_tag_dyneither(_tmp2DC,sizeof(void*),0));});});
...
if((unsigned int)_tmp2E7)({void*_tmp2E2=0;({struct _dyneither_ptr _tmp50C=({const char*_tmp2E3="designators in initializers";_tag_dyneither(_tmp2E3,sizeof(char),28);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp50C,_tag_dyneither(_tmp2E2,sizeof(void*),0));});});{
...
({void*_tmp2E8=0;({struct _dyneither_ptr _tmp50D=({const char*_tmp2E9="bad type for aggregate initializer";_tag_dyneither(_tmp2E9,sizeof(char),35);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp50D,_tag_dyneither(_tmp2E8,sizeof(void*),0));});});}_LL2C7:;}case 0: switch(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp2CD)->f1).Wstring_c).tag){case 8: _LL2C1: _LL2C2:
# 1626
 goto _LL2C4;case 9: _LL2C3: _LL2C4:
# 1628
 LOOP2: {
void*_tmp2F0=t;struct _tuple0*_tmp2F1;switch(*((int*)_tmp2F0)){case 17: _LL2DC: _tmp2F1=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp2F0)->f1;_LL2DD:
# 1631
(*_tmp2F1).f1=Cyc_Absyn_Loc_n;
({void*_tmp50E=Cyc_Port_lookup_typedef(env,_tmp2F1);t=_tmp50E;});goto LOOP2;case 8: _LL2DE: _LL2DF:
...
void*_tmp2F5=d->r;void*_tmp2F6=_tmp2F5;struct Cyc_Absyn_Vardecl*_tmp2FA;if(((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp2F6)->tag == 0){_LL2E3: _tmp2FA=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp2F6)->f1;_LL2E4:
# 1644
...
({void*_tmp2F8=0;({struct _dyneither_ptr _tmp518=({const char*_tmp2F9="non-local decl that isn't a variable";_tag_dyneither(_tmp2F9,sizeof(char),37);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp518,_tag_dyneither(_tmp2F8,sizeof(void*),0));});});}_LL2E2:;}
# 1673
...
void*_tmp301=d->r;void*_tmp302=_tmp301;struct Cyc_Absyn_Enumdecl*_tmp342;struct Cyc_Absyn_Aggrdecl*_tmp341;struct Cyc_Absyn_Typedefdecl*_tmp340;struct Cyc_Absyn_Fndecl*_tmp33F;struct Cyc_Absyn_Vardecl*_tmp33E;switch(*((int*)_tmp302)){case 13: _LL2EB: _LL2EC:
# 1683
(env->gcenv)->porting=1;
return env;case 14: _LL2ED: _LL2EE:
# 1686
(env->gcenv)->porting=0;
return env;case 0: _LL2EF: _tmp33E=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp302)->f1;_LL2F0:
# 1689
...
return env;};};}else{
# 1718
return Cyc_Port_gen_localdecl(env,d,1);}case 1: _LL2F1: _tmp33F=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp302)->f1;_LL2F2:
# 1724
...
struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp30D=({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp328=_cycalloc(sizeof(*_tmp328));({struct Cyc_Absyn_FnType_Absyn_Type_struct _tmp523=({struct Cyc_Absyn_FnType_Absyn_Type_struct _tmp329;_tmp329.tag=9;({struct Cyc_Absyn_FnInfo _tmp522=({struct Cyc_Absyn_FnInfo _tmp32A;_tmp32A.tvars=0;_tmp32A.effect=0;({struct Cyc_Absyn_Tqual _tmp521=
Cyc_Absyn_empty_tqual(0);_tmp32A.ret_tqual=_tmp521;});_tmp32A.ret_typ=_tmp30A;_tmp32A.args=_tmp30C;_tmp32A.c_varargs=0;_tmp32A.cyc_varargs=0;_tmp32A.rgn_po=0;_tmp32A.attributes=0;_tmp32A.requires_clause=0;_tmp32A.requires_relns=0;_tmp32A.ensures_clause=0;_tmp32A.ensures_relns=0;_tmp32A;});_tmp329.f1=_tmp522;});_tmp329;});_tmp328[0]=_tmp523;});_tmp328;});
# 1737
...
# 1768
(*_tmp33F->name).f1=Cyc_Absyn_Loc_n;
({struct Cyc_Port_Cenv*_tmp532=({struct Cyc_Port_Cenv*_tmp531=_tmp30E;struct _tuple0*_tmp530=_tmp33F->name;void*_tmp52F=(void*)_tmp30D;void*_tmp52E=Cyc_Port_const_ct();Cyc_Port_add_var(_tmp531,_tmp530,_tmp52F,_tmp52E,_tmp31A,0);});_tmp30E=_tmp532;});
...
({struct Cyc_Port_Cenv*_tmp537=({struct Cyc_Port_Cenv*_tmp536=_tmp30E;struct _tuple0*_tmp535=({struct _tuple0*_tmp31E=_cycalloc(sizeof(*_tmp31E));_tmp31E->f1=Cyc_Absyn_Loc_n;_tmp31E->f2=_tmp322;_tmp31E;});void*_tmp534=_tmp321;void*_tmp533=_tmp320;Cyc_Port_add_var(_tmp536,_tmp535,_tmp534,_tmp533,_tmp31F,0);});_tmp30E=_tmp537;});}}
# 1775
...
({struct Cyc_Port_Cenv*_tmp53C=({struct Cyc_Port_Cenv*_tmp53B=_tmp30E;struct _tuple0*_tmp53A=_tmp33F->name;void*_tmp539=(void*)_tmp30D;void*_tmp538=Cyc_Port_const_ct();Cyc_Port_add_var(_tmp53B,_tmp53A,_tmp539,_tmp538,_tmp31A,0);});env=_tmp53C;});
...
# 1806
return env;};};};};case 8: _LL2F3: _tmp340=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp302)->f1;_LL2F4: {
# 1812
...
return env;}case 5: _LL2F5: _tmp341=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp302)->f1;_LL2F6: {
# 1822
...
(*previous).f2=curr;}
# 1866
return env;};}case 7: _LL2F7: _tmp342=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp302)->f1;_LL2F8:
# 1871
...
# 1881
 if((env->gcenv)->porting)
({void*_tmp33C=0;({struct Cyc___cycFILE*_tmp550=Cyc_stderr;struct _dyneither_ptr _tmp54F=({const char*_tmp33D="Warning: Cyclone declaration found in code to be ported -- skipping.";_tag_dyneither(_tmp33D,sizeof(char),69);});Cyc_fprintf(_tmp550,_tmp54F,_tag_dyneither(_tmp33C,sizeof(void*),0));});});
...
# 1912
({struct Cyc_List_List*_tmp556=({struct Cyc_List_List*_tmp34D=_cycalloc(sizeof(*_tmp34D));({struct Cyc_Port_Edit*_tmp555=({struct Cyc_Port_Edit*_tmp34E=_cycalloc(sizeof(*_tmp34E));_tmp34E->loc=_tmp363;({struct _dyneither_ptr _tmp553=({const char*_tmp350="@";_tag_dyneither(_tmp350,sizeof(char),2);});_tmp34E->old_string=_tmp553;});({struct _dyneither_ptr _tmp554=({const char*_tmp34F="";_tag_dyneither(_tmp34F,sizeof(char),1);});_tmp34E->new_string=_tmp554;});_tmp34E;});_tmp34D->hd=_tmp555;});_tmp34D->tl=_tmp346;_tmp34D;});_tmp346=_tmp556;});
({struct Cyc_List_List*_tmp55A=({struct Cyc_List_List*_tmp351=_cycalloc(sizeof(*_tmp351));({struct Cyc_Port_Edit*_tmp559=({struct Cyc_Port_Edit*_tmp352=_cycalloc(sizeof(*_tmp352));_tmp352->loc=((struct Cyc_Absyn_Exp*)_check_null(_tmp34C->init))->loc;({struct _dyneither_ptr _tmp557=({const char*_tmp354="new ";_tag_dyneither(_tmp354,sizeof(char),5);});_tmp352->old_string=_tmp557;});({struct _dyneither_ptr _tmp558=({const char*_tmp353="";_tag_dyneither(_tmp353,sizeof(char),1);});_tmp352->new_string=_tmp558;});_tmp352;});_tmp351->hd=_tmp559;});_tmp351->tl=_tmp346;_tmp351;});_tmp346=_tmp55A;});}else{
# 1917
({struct Cyc_List_List*_tmp55F=({struct Cyc_List_List*_tmp355=_cycalloc(sizeof(*_tmp355));({struct Cyc_Port_Edit*_tmp55E=({struct Cyc_Port_Edit*_tmp356=_cycalloc(sizeof(*_tmp356));_tmp356->loc=_tmp363;({struct _dyneither_ptr _tmp55D=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp35A;_tmp35A.tag=0;({struct _dyneither_ptr _tmp55B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp362));_tmp35A.f1=_tmp55B;});({struct Cyc_String_pa_PrintArg_struct _tmp359;_tmp359.tag=0;_tmp359.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp361);({void*_tmp357[2]={& _tmp359,& _tmp35A};({struct _dyneither_ptr _tmp55C=({const char*_tmp358="?%s = malloc(sizeof(%s))";_tag_dyneither(_tmp358,sizeof(char),25);});Cyc_aprintf(_tmp55C,_tag_dyneither(_tmp357,sizeof(void*),2));});});});});_tmp356->old_string=_tmp55D;});_tmp356->new_string=*_tmp361;_tmp356;});_tmp355->hd=_tmp55E;});_tmp355->tl=_tmp346;_tmp355;});_tmp346=_tmp55F;});}{
# 1919
struct Cyc_List_List*_tmp35B=_tmp34C->usage_locs;
for(0;(unsigned int)_tmp35B;_tmp35B=_tmp35B->tl){
({struct Cyc_List_List*_tmp563=({struct Cyc_List_List*_tmp35C=_cycalloc(sizeof(*_tmp35C));({struct Cyc_Port_Edit*_tmp562=({struct Cyc_Port_Edit*_tmp35D=_cycalloc(sizeof(*_tmp35D));_tmp35D->loc=(unsigned int)_tmp35B->hd;({struct _dyneither_ptr _tmp561=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp360;_tmp360.tag=0;_tmp360.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp361);({void*_tmp35E[1]={& _tmp360};({struct _dyneither_ptr _tmp560=({const char*_tmp35F="(*%s)";_tag_dyneither(_tmp35F,sizeof(char),6);});Cyc_aprintf(_tmp560,_tag_dyneither(_tmp35E,sizeof(void*),1));});});});_tmp35D->old_string=_tmp561;});_tmp35D->new_string=*_tmp361;_tmp35D;});_tmp35C->hd=_tmp562;});_tmp35C->tl=_tmp346;_tmp35C;});_tmp346=_tmp563;});}};}};};}
# 1927
...
void*_tmp379=Cyc_Port_compress_ct(_tmp384);void*_tmp37A=_tmp379;switch(*((int*)_tmp37A)){case 2: _LL325: _LL326:
# 1946
({struct Cyc_List_List*_tmp567=({struct Cyc_List_List*_tmp37B=_cycalloc(sizeof(*_tmp37B));({struct Cyc_Port_Edit*_tmp566=({struct Cyc_Port_Edit*_tmp37C=_cycalloc(sizeof(*_tmp37C));_tmp37C->loc=_tmp383;({struct _dyneither_ptr _tmp564=({const char*_tmp37E="?";_tag_dyneither(_tmp37E,sizeof(char),2);});_tmp37C->old_string=_tmp564;});({struct _dyneither_ptr _tmp565=({const char*_tmp37D="*";_tag_dyneither(_tmp37D,sizeof(char),2);});_tmp37C->new_string=_tmp565;});_tmp37C;});_tmp37B->hd=_tmp566;});_tmp37B->tl=_tmp346;_tmp37B;});_tmp346=_tmp567;});
goto _LL324;case 3: _LL327: _LL328:
# 1949
({struct Cyc_List_List*_tmp56B=({struct Cyc_List_List*_tmp37F=_cycalloc(sizeof(*_tmp37F));({struct Cyc_Port_Edit*_tmp56A=({struct Cyc_Port_Edit*_tmp380=_cycalloc(sizeof(*_tmp380));_tmp380->loc=_tmp383;({struct _dyneither_ptr _tmp568=({const char*_tmp382="*";_tag_dyneither(_tmp382,sizeof(char),2);});_tmp380->old_string=_tmp568;});({struct _dyneither_ptr _tmp569=({const char*_tmp381="?";_tag_dyneither(_tmp381,sizeof(char),2);});_tmp380->new_string=_tmp569;});_tmp380;});_tmp37F->hd=_tmp56A;});_tmp37F->tl=_tmp346;_tmp37F;});_tmp346=_tmp56B;});
...
void*_tmp388=Cyc_Port_compress_ct(_tmp393);void*_tmp389=_tmp388;switch(*((int*)_tmp389)){case 1: _LL32F: _LL330:
# 1961
({struct Cyc_List_List*_tmp56F=({struct Cyc_List_List*_tmp38A=_cycalloc(sizeof(*_tmp38A));({struct Cyc_Port_Edit*_tmp56E=({struct Cyc_Port_Edit*_tmp38B=_cycalloc(sizeof(*_tmp38B));_tmp38B->loc=_tmp392;({struct _dyneither_ptr _tmp56C=({const char*_tmp38D="const ";_tag_dyneither(_tmp38D,sizeof(char),7);});_tmp38B->old_string=_tmp56C;});({struct _dyneither_ptr _tmp56D=({const char*_tmp38C="";_tag_dyneither(_tmp38C,sizeof(char),1);});_tmp38B->new_string=_tmp56D;});_tmp38B;});_tmp38A->hd=_tmp56E;});_tmp38A->tl=_tmp346;_tmp38A;});_tmp346=_tmp56F;});goto _LL32E;case 0: _LL331: _LL332:
# 1963
({struct Cyc_List_List*_tmp573=({struct Cyc_List_List*_tmp38E=_cycalloc(sizeof(*_tmp38E));({struct Cyc_Port_Edit*_tmp572=({struct Cyc_Port_Edit*_tmp38F=_cycalloc(sizeof(*_tmp38F));_tmp38F->loc=_tmp392;({struct _dyneither_ptr _tmp570=({const char*_tmp391="";_tag_dyneither(_tmp391,sizeof(char),1);});_tmp38F->old_string=_tmp570;});({struct _dyneither_ptr _tmp571=({const char*_tmp390="const ";_tag_dyneither(_tmp390,sizeof(char),7);});_tmp38F->new_string=_tmp571;});_tmp38F;});_tmp38E->hd=_tmp572;});_tmp38E->tl=_tmp346;_tmp38E;});_tmp346=_tmp573;});goto _LL32E;default: _LL333: _LL334:
 goto _LL32E;}_LL32E:;}}
# 1969
...
void*_tmp397=Cyc_Port_compress_ct(_tmp3A2);void*_tmp398=_tmp397;switch(*((int*)_tmp398)){case 8: _LL339: _LL33A:
# 1974
({struct Cyc_List_List*_tmp577=({struct Cyc_List_List*_tmp399=_cycalloc(sizeof(*_tmp399));({struct Cyc_Port_Edit*_tmp576=({struct Cyc_Port_Edit*_tmp39A=_cycalloc(sizeof(*_tmp39A));_tmp39A->loc=_tmp3A1;({struct _dyneither_ptr _tmp574=({const char*_tmp39C="@nozeroterm ";_tag_dyneither(_tmp39C,sizeof(char),13);});_tmp39A->old_string=_tmp574;});({struct _dyneither_ptr _tmp575=({const char*_tmp39B="";_tag_dyneither(_tmp39B,sizeof(char),1);});_tmp39A->new_string=_tmp575;});_tmp39A;});_tmp399->hd=_tmp576;});_tmp399->tl=_tmp346;_tmp399;});_tmp346=_tmp577;});goto _LL338;case 9: _LL33B: _LL33C:
# 1976
({struct Cyc_List_List*_tmp57B=({struct Cyc_List_List*_tmp39D=_cycalloc(sizeof(*_tmp39D));({struct Cyc_Port_Edit*_tmp57A=({struct Cyc_Port_Edit*_tmp39E=_cycalloc(sizeof(*_tmp39E));_tmp39E->loc=_tmp3A1;({struct _dyneither_ptr _tmp578=({const char*_tmp3A0="@zeroterm ";_tag_dyneither(_tmp3A0,sizeof(char),11);});_tmp39E->old_string=_tmp578;});({struct _dyneither_ptr _tmp579=({const char*_tmp39F="";_tag_dyneither(_tmp39F,sizeof(char),1);});_tmp39E->new_string=_tmp579;});_tmp39E;});_tmp39D->hd=_tmp57A;});_tmp39D->tl=_tmp346;_tmp39D;});_tmp346=_tmp57B;});goto _LL338;default: _LL33D: _LL33E:
 goto _LL338;}_LL338:;}}
# 1983
...
({struct Cyc_String_pa_PrintArg_struct _tmp3AD;_tmp3AD.tag=0;_tmp3AD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp3AE);({struct Cyc_String_pa_PrintArg_struct _tmp3AC;_tmp3AC.tag=0;_tmp3AC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp3AF);({struct Cyc_String_pa_PrintArg_struct _tmp3AB;_tmp3AB.tag=0;_tmp3AB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)sloc);({void*_tmp3A9[3]={& _tmp3AB,& _tmp3AC,& _tmp3AD};({struct _dyneither_ptr _tmp57D=({const char*_tmp3AA="%s: insert `%s' for `%s'\n";_tag_dyneither(_tmp3AA,sizeof(char),26);});Cyc_printf(_tmp57D,_tag_dyneither(_tmp3A9,sizeof(void*),3));});});});});});};}};}
