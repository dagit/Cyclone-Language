...
# 59
int Cyc_Hashtable_try_lookup(struct Cyc_Hashtable_Table*t,void*key,void**data);struct Cyc_Port_Edit{unsigned loc;struct _dyneither_ptr old_string;struct _dyneither_ptr new_string;};
# 88 "port.cyc"
...
# 1013
struct Cyc_List_List*_tmp41F=({struct _tuple8*_tmp17D[2U];_tmp17D[0]=arg1,_tmp17D[1]=arg2;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp17D,sizeof(struct _tuple8*),2U));});(_tmp17E->f1).args=_tmp41F;}),(_tmp17E->f1).c_varargs=0,(_tmp17E->f1).cyc_varargs=0,(_tmp17E->f1).rgn_po=0,(_tmp17E->f1).attributes=0,(_tmp17E->f1).requires_clause=0,(_tmp17E->f1).requires_relns=0,(_tmp17E->f1).ensures_clause=0,(_tmp17E->f1).ensures_relns=0;_tmp17E;});}
# 1022
...
# 1028
_tmp181=({struct Cyc_Port_Cenv*_tmp427=_tmp181;struct _tuple0*_tmp426=({struct _tuple0*_tmp184=_cycalloc(sizeof(*_tmp184));_tmp184->f1=Cyc_Absyn_Loc_n,({struct _dyneither_ptr*_tmp422=({struct _dyneither_ptr*_tmp183=_cycalloc(sizeof(*_tmp183));({struct _dyneither_ptr _tmp421=({const char*_tmp182="main";_tag_dyneither(_tmp182,sizeof(char),5U);});*_tmp183=_tmp421;});_tmp183;});_tmp184->f2=_tmp422;});_tmp184;});void*_tmp425=Cyc_Port_main_type();void*_tmp424=Cyc_Port_const_ct();Cyc_Port_add_var(_tmp427,_tmp426,_tmp425,_tmp424,({
...
({struct Cyc_Dict_Dict _tmp42A=({struct Cyc_Dict_Dict _tmp429=*cts;struct _dyneither_ptr*_tmp428=_tmp189;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,int*v))Cyc_Dict_insert)(_tmp429,_tmp428,({int*_tmp187=_cycalloc_atomic(sizeof(*_tmp187));*_tmp187=0;_tmp187;}));});*cts=_tmp42A;});{
...
({struct Cyc_Port_Edit*_tmp42D=({struct Cyc_Port_Edit*_tmp199=_cycalloc(sizeof(*_tmp199));_tmp199->loc=_tmp196,({struct _dyneither_ptr _tmp42C=({const char*_tmp197="`H ";_tag_dyneither(_tmp197,sizeof(char),4U);});_tmp199->old_string=_tmp42C;}),({struct _dyneither_ptr _tmp42B=({const char*_tmp198="";_tag_dyneither(_tmp198,sizeof(char),1U);});_tmp199->new_string=_tmp42B;});_tmp199;});_tmp19A->hd=_tmp42D;}),_tmp19A->tl=(env->gcenv)->edits;_tmp19A;});
# 1098
...
({void*_tmp1E9=0U;({struct _dyneither_ptr _tmp46F=({const char*_tmp1EA=".size primop";_tag_dyneither(_tmp1EA,sizeof(char),13U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp46F,_tag_dyneither(_tmp1E9,sizeof(void*),0U));});});}_LL0:;}
# 1352
...
({void*_tmp204=0U;({struct _dyneither_ptr _tmp484=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp207=({struct Cyc_String_pa_PrintArg_struct _tmp3AB;_tmp3AB.tag=0U,({struct _dyneither_ptr _tmp482=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp3AB.f1=_tmp482;});_tmp3AB;});void*_tmp205[1U];_tmp205[0]=& _tmp207;({struct _dyneither_ptr _tmp483=({const char*_tmp206="gen_lhs: %s";_tag_dyneither(_tmp206,sizeof(char),12U);});Cyc_aprintf(_tmp483,_tag_dyneither(_tmp205,sizeof(void*),1U));});});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp484,_tag_dyneither(_tmp204,sizeof(void*),0U));});});}_LL0:;}
# 1392
...
({void*_tmp22D=0U;({struct _dyneither_ptr _tmp4A9=({const char*_tmp22E="throw";_tag_dyneither(_tmp22E,sizeof(char),6U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4A9,_tag_dyneither(_tmp22D,sizeof(void*),0U));});});case 41U: _LL33: _tmp276=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmp211)->f1;_LL34:
...
({void*_tmp22F=0U;({struct _dyneither_ptr _tmp4AA=({const char*_tmp230="instantiate";_tag_dyneither(_tmp230,sizeof(char),12U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4AA,_tag_dyneither(_tmp22F,sizeof(void*),0U));});});case 14U: _LL39: _tmp279=(void*)((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp211)->f1;_tmp278=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp211)->f2;_LL3A: {
# 1486
...
({void*_tmp4BC=_tmp23B;Cyc_Port_leq(_tmp4BC,Cyc_Port_unknown_aggr_ct(({struct Cyc_Port_Cfield*_tmp23C[1U];({struct Cyc_Port_Cfield*_tmp4BB=({struct Cyc_Port_Cfield*_tmp23D=_cycalloc(sizeof(*_tmp23D));({void*_tmp4BA=Cyc_Port_var();_tmp23D->qual=_tmp4BA;}),_tmp23D->f=_tmp27E,_tmp23D->type=_tmp23A;_tmp23D;});_tmp23C[0]=_tmp4BB;});((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp23C,sizeof(struct Cyc_Port_Cfield*),1U));})));});
...
({void*_tmp243=0U;({struct _dyneither_ptr _tmp4C9=({const char*_tmp244="Pragma_e";_tag_dyneither(_tmp244,sizeof(char),9U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4C9,_tag_dyneither(_tmp243,sizeof(void*),0U));});});case 35U: _LL49: _tmp285=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp211)->f1;_tmp284=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp211)->f2;_LL4A:
({void*_tmp245=0U;({struct _dyneither_ptr _tmp4CA=({const char*_tmp246="Swap_e";_tag_dyneither(_tmp246,sizeof(char),7U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4CA,_tag_dyneither(_tmp245,sizeof(void*),0U));});});case 16U: _LL4B: _LL4C:
({void*_tmp247=0U;({struct _dyneither_ptr _tmp4CB=({const char*_tmp248="New_e";_tag_dyneither(_tmp248,sizeof(char),6U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4CB,_tag_dyneither(_tmp247,sizeof(void*),0U));});});case 24U: _LL4D: _LL4E:
({void*_tmp249=0U;({struct _dyneither_ptr _tmp4CC=({const char*_tmp24A="Tuple_e";_tag_dyneither(_tmp24A,sizeof(char),8U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4CC,_tag_dyneither(_tmp249,sizeof(void*),0U));});});case 25U: _LL4F: _LL50:
({void*_tmp24B=0U;({struct _dyneither_ptr _tmp4CD=({const char*_tmp24C="CompoundLit_e";_tag_dyneither(_tmp24C,sizeof(char),14U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4CD,_tag_dyneither(_tmp24B,sizeof(void*),0U));});});case 26U: _LL51: _LL52:
({void*_tmp24D=0U;({struct _dyneither_ptr _tmp4CE=({const char*_tmp24E="Array_e";_tag_dyneither(_tmp24E,sizeof(char),8U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4CE,_tag_dyneither(_tmp24D,sizeof(void*),0U));});});case 27U: _LL53: _LL54:
({void*_tmp24F=0U;({struct _dyneither_ptr _tmp4CF=({const char*_tmp250="Comprehension_e";_tag_dyneither(_tmp250,sizeof(char),16U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4CF,_tag_dyneither(_tmp24F,sizeof(void*),0U));});});case 28U: _LL55: _LL56:
({void*_tmp251=0U;({struct _dyneither_ptr _tmp4D0=({const char*_tmp252="ComprehensionNoinit_e";_tag_dyneither(_tmp252,sizeof(char),22U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4D0,_tag_dyneither(_tmp251,sizeof(void*),0U));});});case 29U: _LL57: _LL58:
({void*_tmp253=0U;({struct _dyneither_ptr _tmp4D1=({const char*_tmp254="Aggregate_e";_tag_dyneither(_tmp254,sizeof(char),12U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4D1,_tag_dyneither(_tmp253,sizeof(void*),0U));});});case 30U: _LL59: _LL5A:
({void*_tmp255=0U;({struct _dyneither_ptr _tmp4D2=({const char*_tmp256="AnonStruct_e";_tag_dyneither(_tmp256,sizeof(char),13U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4D2,_tag_dyneither(_tmp255,sizeof(void*),0U));});});case 31U: _LL5B: _LL5C:
({void*_tmp257=0U;({struct _dyneither_ptr _tmp4D3=({const char*_tmp258="Datatype_e";_tag_dyneither(_tmp258,sizeof(char),11U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4D3,_tag_dyneither(_tmp257,sizeof(void*),0U));});});case 36U: _LL5D: _LL5E:
({void*_tmp259=0U;({struct _dyneither_ptr _tmp4D4=({const char*_tmp25A="UnresolvedMem_e";_tag_dyneither(_tmp25A,sizeof(char),16U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4D4,_tag_dyneither(_tmp259,sizeof(void*),0U));});});case 37U: _LL5F: _tmp286=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp211)->f1;_LL60:
({void*_tmp25B=0U;({struct _dyneither_ptr _tmp4D5=({const char*_tmp25C="StmtExp_e";_tag_dyneither(_tmp25C,sizeof(char),10U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4D5,_tag_dyneither(_tmp25B,sizeof(void*),0U));});});case 39U: _LL61: _LL62:
({void*_tmp25D=0U;({struct _dyneither_ptr _tmp4D6=({const char*_tmp25E="Valueof_e";_tag_dyneither(_tmp25E,sizeof(char),10U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4D6,_tag_dyneither(_tmp25D,sizeof(void*),0U));});});case 40U: _LL63: _LL64:
({void*_tmp25F=0U;({struct _dyneither_ptr _tmp4D7=({const char*_tmp260="Asm_e";_tag_dyneither(_tmp260,sizeof(char),6U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4D7,_tag_dyneither(_tmp25F,sizeof(void*),0U));});});default: _LL65: _LL66:
({void*_tmp261=0U;({struct _dyneither_ptr _tmp4D8=({const char*_tmp262="Tagcheck_e";_tag_dyneither(_tmp262,sizeof(char),11U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4D8,_tag_dyneither(_tmp261,sizeof(void*),0U));});});}_LL0:;}
# 1538
static void Cyc_Port_gen_stmt(struct Cyc_Port_Cenv*env,struct Cyc_Absyn_Stmt*s){
...
({void*_tmp28B=0U;({struct _dyneither_ptr _tmp4DD=({const char*_tmp28C="fallthru";_tag_dyneither(_tmp28C,sizeof(char),9U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4DD,_tag_dyneither(_tmp28B,sizeof(void*),0U));});});case 12U: _LL19: _tmp29F=((struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp288)->f1;_tmp29E=((struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp288)->f2;_LL1A:
# 1575
...
({void*_tmp28D=0U;({struct _dyneither_ptr _tmp4DF=({const char*_tmp28E="try/catch";_tag_dyneither(_tmp28E,sizeof(char),10U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4DF,_tag_dyneither(_tmp28D,sizeof(void*),0U));});});}_LL0:;}struct _tuple17{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
# 1586
...
if((unsigned)_tmp2B0)({void*_tmp2AC=0U;({struct _dyneither_ptr _tmp4E0=({const char*_tmp2AD="designators in initializers";_tag_dyneither(_tmp2AD,sizeof(char),28U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4E0,_tag_dyneither(_tmp2AC,sizeof(void*),0U));});});{
...
if(_tmp2B5 == 0)({void*_tmp2B3=0U;({struct _dyneither_ptr _tmp4E1=({const char*_tmp2B4="struct is not yet defined";_tag_dyneither(_tmp2B4,sizeof(char),26U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4E1,_tag_dyneither(_tmp2B3,sizeof(void*),0U));});});
...
if((unsigned)_tmp2BE)({void*_tmp2B9=0U;({struct _dyneither_ptr _tmp4E2=({const char*_tmp2BA="designators in initializers";_tag_dyneither(_tmp2BA,sizeof(char),28U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4E2,_tag_dyneither(_tmp2B9,sizeof(void*),0U));});});{
...
({void*_tmp2BF=0U;({struct _dyneither_ptr _tmp4E3=({const char*_tmp2C0="bad type for aggregate initializer";_tag_dyneither(_tmp2C0,sizeof(char),35U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4E3,_tag_dyneither(_tmp2BF,sizeof(void*),0U));});});}_LLD:;}case 0U: switch(((((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp2A4)->f1).Wstring_c).tag){case 8U: _LL7: _LL8:
# 1625
...
({void*_tmp2CF=0U;({struct _dyneither_ptr _tmp4EA=({const char*_tmp2D0="non-local decl that isn't a variable";_tag_dyneither(_tmp2D0,sizeof(char),37U);});((int(*)(struct _dyneither_ptr,struct _dyneither_ptr))Cyc_Tcutil_impos)(_tmp4EA,_tag_dyneither(_tmp2CF,sizeof(void*),0U));});});}_LL0:;}
# 1672
...
_tmp2E5=({struct Cyc_Port_Cenv*_tmp4FC=_tmp2E5;struct _tuple0*_tmp4FB=({struct _tuple0*_tmp2F5=_cycalloc(sizeof(*_tmp2F5));_tmp2F5->f1=Cyc_Absyn_Loc_n,_tmp2F5->f2=(struct _dyneither_ptr*)_check_null(_tmp2F9);_tmp2F5;});void*_tmp4FA=_tmp2F8;void*_tmp4F9=_tmp2F7;Cyc_Port_add_var(_tmp4FC,_tmp4FB,_tmp4FA,_tmp4F9,_tmp2F6,0U);});}}
# 1774
...
# 1880
 if((env->gcenv)->porting)
({void*_tmp30F=0U;({struct Cyc___cycFILE*_tmp50C=Cyc_stderr;struct _dyneither_ptr _tmp50B=({const char*_tmp310="Warning: Cyclone declaration found in code to be ported -- skipping.";_tag_dyneither(_tmp310,sizeof(char),69U);});Cyc_fprintf(_tmp50C,_tmp50B,_tag_dyneither(_tmp30F,sizeof(void*),0U));});});
return env;}_LL0:;}
# 1887
...
# 1911
_tmp319=({struct Cyc_List_List*_tmp323=_cycalloc(sizeof(*_tmp323));({struct Cyc_Port_Edit*_tmp510=({struct Cyc_Port_Edit*_tmp322=_cycalloc(sizeof(*_tmp322));_tmp322->loc=_tmp336,({struct _dyneither_ptr _tmp50F=({const char*_tmp320="@";_tag_dyneither(_tmp320,sizeof(char),2U);});_tmp322->old_string=_tmp50F;}),({struct _dyneither_ptr _tmp50E=({const char*_tmp321="";_tag_dyneither(_tmp321,sizeof(char),1U);});_tmp322->new_string=_tmp50E;});_tmp322;});_tmp323->hd=_tmp510;}),_tmp323->tl=_tmp319;_tmp323;});
_tmp319=({struct Cyc_List_List*_tmp327=_cycalloc(sizeof(*_tmp327));({struct Cyc_Port_Edit*_tmp513=({struct Cyc_Port_Edit*_tmp326=_cycalloc(sizeof(*_tmp326));_tmp326->loc=((struct Cyc_Absyn_Exp*)_check_null(_tmp31F->init))->loc,({struct _dyneither_ptr _tmp512=({const char*_tmp324="new ";_tag_dyneither(_tmp324,sizeof(char),5U);});_tmp326->old_string=_tmp512;}),({struct _dyneither_ptr _tmp511=({const char*_tmp325="";_tag_dyneither(_tmp325,sizeof(char),1U);});_tmp326->new_string=_tmp511;});_tmp326;});_tmp327->hd=_tmp513;}),_tmp327->tl=_tmp319;_tmp327;});}else{
# 1916
_tmp319=({struct Cyc_List_List*_tmp32D=_cycalloc(sizeof(*_tmp32D));({struct Cyc_Port_Edit*_tmp517=({struct Cyc_Port_Edit*_tmp32C=_cycalloc(sizeof(*_tmp32C));_tmp32C->loc=_tmp336,({struct _dyneither_ptr _tmp516=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp32A=({struct Cyc_String_pa_PrintArg_struct _tmp3AF;_tmp3AF.tag=0U,_tmp3AF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp334);_tmp3AF;});struct Cyc_String_pa_PrintArg_struct _tmp32B=({struct Cyc_String_pa_PrintArg_struct _tmp3AE;_tmp3AE.tag=0U,({struct _dyneither_ptr _tmp514=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp335));_tmp3AE.f1=_tmp514;});_tmp3AE;});void*_tmp328[2U];_tmp328[0]=& _tmp32A,_tmp328[1]=& _tmp32B;({struct _dyneither_ptr _tmp515=({const char*_tmp329="?%s = malloc(sizeof(%s))";_tag_dyneither(_tmp329,sizeof(char),25U);});Cyc_aprintf(_tmp515,_tag_dyneither(_tmp328,sizeof(void*),2U));});});_tmp32C->old_string=_tmp516;}),_tmp32C->new_string=*_tmp334;_tmp32C;});_tmp32D->hd=_tmp517;}),_tmp32D->tl=_tmp319;_tmp32D;});}{
# 1918
struct Cyc_List_List*_tmp32E=_tmp31F->usage_locs;
for(0;(unsigned)_tmp32E;_tmp32E=_tmp32E->tl){
_tmp319=({struct Cyc_List_List*_tmp333=_cycalloc(sizeof(*_tmp333));({struct Cyc_Port_Edit*_tmp51A=({struct Cyc_Port_Edit*_tmp332=_cycalloc(sizeof(*_tmp332));_tmp332->loc=(unsigned)_tmp32E->hd,({struct _dyneither_ptr _tmp519=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp331=({struct Cyc_String_pa_PrintArg_struct _tmp3B0;_tmp3B0.tag=0U,_tmp3B0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp334);_tmp3B0;});void*_tmp32F[1U];_tmp32F[0]=& _tmp331;({struct _dyneither_ptr _tmp518=({const char*_tmp330="(*%s)";_tag_dyneither(_tmp330,sizeof(char),6U);});Cyc_aprintf(_tmp518,_tag_dyneither(_tmp32F,sizeof(void*),1U));});});_tmp332->old_string=_tmp519;}),_tmp332->new_string=*_tmp334;_tmp332;});_tmp333->hd=_tmp51A;}),_tmp333->tl=_tmp319;_tmp333;});}};}};};}
# 1926
...
# 1945
 _tmp319=({struct Cyc_List_List*_tmp351=_cycalloc(sizeof(*_tmp351));({struct Cyc_Port_Edit*_tmp51D=({struct Cyc_Port_Edit*_tmp350=_cycalloc(sizeof(*_tmp350));_tmp350->loc=_tmp356,({struct _dyneither_ptr _tmp51C=({const char*_tmp34E="?";_tag_dyneither(_tmp34E,sizeof(char),2U);});_tmp350->old_string=_tmp51C;}),({struct _dyneither_ptr _tmp51B=({const char*_tmp34F="*";_tag_dyneither(_tmp34F,sizeof(char),2U);});_tmp350->new_string=_tmp51B;});_tmp350;});_tmp351->hd=_tmp51D;}),_tmp351->tl=_tmp319;_tmp351;});
goto _LL12;case 3U: _LL15: _LL16:
# 1948
 _tmp319=({struct Cyc_List_List*_tmp355=_cycalloc(sizeof(*_tmp355));({struct Cyc_Port_Edit*_tmp520=({struct Cyc_Port_Edit*_tmp354=_cycalloc(sizeof(*_tmp354));_tmp354->loc=_tmp356,({struct _dyneither_ptr _tmp51F=({const char*_tmp352="*";_tag_dyneither(_tmp352,sizeof(char),2U);});_tmp354->old_string=_tmp51F;}),({struct _dyneither_ptr _tmp51E=({const char*_tmp353="?";_tag_dyneither(_tmp353,sizeof(char),2U);});_tmp354->new_string=_tmp51E;});_tmp354;});_tmp355->hd=_tmp520;}),_tmp355->tl=_tmp319;_tmp355;});
...
# 1960
 _tmp319=({struct Cyc_List_List*_tmp360=_cycalloc(sizeof(*_tmp360));({struct Cyc_Port_Edit*_tmp523=({struct Cyc_Port_Edit*_tmp35F=_cycalloc(sizeof(*_tmp35F));_tmp35F->loc=_tmp365,({struct _dyneither_ptr _tmp522=({const char*_tmp35D="const ";_tag_dyneither(_tmp35D,sizeof(char),7U);});_tmp35F->old_string=_tmp522;}),({struct _dyneither_ptr _tmp521=({const char*_tmp35E="";_tag_dyneither(_tmp35E,sizeof(char),1U);});_tmp35F->new_string=_tmp521;});_tmp35F;});_tmp360->hd=_tmp523;}),_tmp360->tl=_tmp319;_tmp360;});goto _LL1C;case 0U: _LL1F: _LL20:
# 1962
 _tmp319=({struct Cyc_List_List*_tmp364=_cycalloc(sizeof(*_tmp364));({struct Cyc_Port_Edit*_tmp526=({struct Cyc_Port_Edit*_tmp363=_cycalloc(sizeof(*_tmp363));_tmp363->loc=_tmp365,({struct _dyneither_ptr _tmp525=({const char*_tmp361="";_tag_dyneither(_tmp361,sizeof(char),1U);});_tmp363->old_string=_tmp525;}),({struct _dyneither_ptr _tmp524=({const char*_tmp362="const ";_tag_dyneither(_tmp362,sizeof(char),7U);});_tmp363->new_string=_tmp524;});_tmp363;});_tmp364->hd=_tmp526;}),_tmp364->tl=_tmp319;_tmp364;});goto _LL1C;default: _LL21: _LL22:
 goto _LL1C;}_LL1C:;}}
# 1968
...
# 1973
 _tmp319=({struct Cyc_List_List*_tmp36F=_cycalloc(sizeof(*_tmp36F));({struct Cyc_Port_Edit*_tmp529=({struct Cyc_Port_Edit*_tmp36E=_cycalloc(sizeof(*_tmp36E));_tmp36E->loc=_tmp374,({struct _dyneither_ptr _tmp528=({const char*_tmp36C="@nozeroterm ";_tag_dyneither(_tmp36C,sizeof(char),13U);});_tmp36E->old_string=_tmp528;}),({struct _dyneither_ptr _tmp527=({const char*_tmp36D="";_tag_dyneither(_tmp36D,sizeof(char),1U);});_tmp36E->new_string=_tmp527;});_tmp36E;});_tmp36F->hd=_tmp529;}),_tmp36F->tl=_tmp319;_tmp36F;});goto _LL26;case 9U: _LL29: _LL2A:
# 1975
 _tmp319=({struct Cyc_List_List*_tmp373=_cycalloc(sizeof(*_tmp373));({struct Cyc_Port_Edit*_tmp52C=({struct Cyc_Port_Edit*_tmp372=_cycalloc(sizeof(*_tmp372));_tmp372->loc=_tmp374,({struct _dyneither_ptr _tmp52B=({const char*_tmp370="@zeroterm ";_tag_dyneither(_tmp370,sizeof(char),11U);});_tmp372->old_string=_tmp52B;}),({struct _dyneither_ptr _tmp52A=({const char*_tmp371="";_tag_dyneither(_tmp371,sizeof(char),1U);});_tmp372->new_string=_tmp52A;});_tmp372;});_tmp373->hd=_tmp52C;}),_tmp373->tl=_tmp319;_tmp373;});goto _LL26;default: _LL2B: _LL2C:
 goto _LL26;}_LL26:;}}
# 1982
...
struct Cyc_Port_Edit _tmp37A=*((struct Cyc_Port_Edit*)_tmp377->hd);struct Cyc_Port_Edit _tmp37B=_tmp37A;unsigned _tmp383;struct _dyneither_ptr _tmp382;struct _dyneither_ptr _tmp381;_LL1: _tmp383=_tmp37B.loc;_tmp382=_tmp37B.old_string;_tmp381=_tmp37B.new_string;_LL2:;{
struct _dyneither_ptr sloc=(struct _dyneither_ptr)*((struct _dyneither_ptr*)((struct Cyc_List_List*)_check_null(_tmp379))->hd);
({struct Cyc_String_pa_PrintArg_struct _tmp37E=({struct Cyc_String_pa_PrintArg_struct _tmp3B3;_tmp3B3.tag=0U,_tmp3B3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)sloc);_tmp3B3;});struct Cyc_String_pa_PrintArg_struct _tmp37F=({struct Cyc_String_pa_PrintArg_struct _tmp3B2;_tmp3B2.tag=0U,_tmp3B2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp382);_tmp3B2;});struct Cyc_String_pa_PrintArg_struct _tmp380=({struct Cyc_String_pa_PrintArg_struct _tmp3B1;_tmp3B1.tag=0U,_tmp3B1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp381);_tmp3B1;});void*_tmp37C[3U];_tmp37C[0]=& _tmp37E,_tmp37C[1]=& _tmp37F,_tmp37C[2]=& _tmp380;({struct _dyneither_ptr _tmp52D=({const char*_tmp37D="%s: insert `%s' for `%s'\n";_tag_dyneither(_tmp37D,sizeof(char),26U);});Cyc_printf(_tmp52D,_tag_dyneither(_tmp37C,sizeof(void*),3U));});});};}};}
