...
# 1015
struct Cyc_List_List*_tmp420=({struct _tuple8*_tmp17D[2U];_tmp17D[0]=arg1,_tmp17D[1]=arg2;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp17D,sizeof(struct _tuple8*),2U));});(_tmp17E->f1).args=_tmp420;}),(_tmp17E->f1).c_varargs=0,(_tmp17E->f1).cyc_varargs=0,(_tmp17E->f1).rgn_po=0,(_tmp17E->f1).attributes=0,(_tmp17E->f1).requires_clause=0,(_tmp17E->f1).requires_relns=0,(_tmp17E->f1).ensures_clause=0,(_tmp17E->f1).ensures_relns=0;_tmp17E;});}
# 1024
...
_tmp305->tag=5U,(_tmp305->f1).tvars=0,(_tmp305->f1).effect=0,({struct Cyc_Absyn_Tqual _tmp4F2=Cyc_Absyn_empty_tqual(0U);(_tmp305->f1).ret_tqual=_tmp4F2;}),(_tmp305->f1).ret_type=rettype,(_tmp305->f1).args=targs,(_tmp305->f1).c_varargs=0,(_tmp305->f1).cyc_varargs=0,(_tmp305->f1).rgn_po=0,(_tmp305->f1).attributes=0,(_tmp305->f1).requires_clause=0,(_tmp305->f1).requires_relns=0,(_tmp305->f1).ensures_clause=0,(_tmp305->f1).ensures_relns=0;_tmp305;});
# 1735
