...
nread +=n;}}else{
# 527
struct _fat_ptr _tmp1B=Cyc_va_arg_string_ptr(*((void**)_check_fat_subscript(ap,sizeof(void*),0U)));struct _fat_ptr p2=_tmp1B;_fat_ptr_inplace_plus(& ap,sizeof(void*),1);{
