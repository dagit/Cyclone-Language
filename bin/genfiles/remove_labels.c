...
# 1132 "absyn.h"
void Cyc_Absyn_do_nested_statement(struct Cyc_Absyn_Exp*,void*,void(*)(void*,struct Cyc_Absyn_Stmt*),int);extern char Cyc_FileCloseError[15U];extern char Cyc_FileOpenError[14U];
# 50 "string.h"
