...
# 618
struct _tuple22 _tmp9A=*tcenv;struct _RegionHandle*_tmp9C;struct Cyc_Tcenv_Tenv*_tmp9D;struct _tuple22 _tmp9B=_tmp9A;_tmp9C=_tmp9B.f1;_tmp9D=_tmp9B.f2;
...
struct Cyc_Tcenv_Tenv*_tmp9F;struct Cyc___cycFILE*_tmpA0;struct Cyc___cycFILE*_tmpA1;struct _tuple23*_tmp9E=params;_tmp9F=_tmp9E->f1;_tmpA0=_tmp9E->f2;_tmpA1=_tmp9E->f3;{
...
{struct _handler_cons _tmpBF;_push_handler(& _tmpBF);{int _tmpC1=0;if(setjmp(_tmpBF.handler))_tmpC1=1;if(!_tmpC1){{const char*_tmp44D;f=Cyc_file_open(file,((_tmp44D="r",_tag_dyneither(_tmp44D,sizeof(char),2))));};_pop_handler();}else{void*_tmpC0=(void*)_exn_thrown;void*_tmpC3=_tmpC0;_LL12: _LL13: goto _LL11;_LL11:;}};}
...
char _tmpDB=c;switch(_tmpDB){case 92: _LL17: _LL18:
 goto _LL1A;case 34: _LL19: _LL1A:
 goto _LL1C;case 59: _LL1B: _LL1C:
 goto _LL1E;case 38: _LL1D: _LL1E:
 goto _LL20;case 40: _LL1F: _LL20:
 goto _LL22;case 41: _LL21: _LL22:
 goto _LL24;case 124: _LL23: _LL24:
 goto _LL26;case 94: _LL25: _LL26:
 goto _LL28;case 60: _LL27: _LL28:
 goto _LL2A;case 62: _LL29: _LL2A:
 goto _LL2C;case 10: _LL2B: _LL2C:
# 850
 goto _LL2E;case 9: _LL2D: _LL2E:
 return 1;default: _LL2F: _LL30:
 return 0;}_LL16:;}static struct _dyneither_ptr Cyc_sh_escape_string(struct _dyneither_ptr s);static void _tmp475(unsigned int*_tmp474,unsigned int*_tmp473,char**_tmp471){for(*_tmp474=0;*_tmp474 < *_tmp473;(*_tmp474)++){(*_tmp471)[*_tmp474]=(char)'\000';}}
# 857
...
# 1094
;_pop_handler();}else{void*_tmp131=(void*)_exn_thrown;void*_tmp134=_tmp131;void*_tmp135;_LL37: _tmp135=_tmp134;_LL38:
# 1098
 Cyc_compile_failure=1;
...
Cyc_Core_rethrow(_tmp135);_LL36:;}};}
# 1103
Cyc_file_close(out_file);{
...
basename=(struct _dyneither_ptr)Cyc_Filename_chop_extension(*n);;_pop_handler();}else{void*_tmp154=(void*)_exn_thrown;void*_tmp156=_tmp154;void*_tmp157;if(((struct Cyc_Core_Invalid_argument_exn_struct*)_tmp156)->tag == Cyc_Core_Invalid_argument){_LL3C: _LL3D:
# 1119
 basename=*n;goto _LL3B;}else{_LL3E: _tmp157=_tmp156;_LL3F:(int)_rethrow(_tmp157);}_LL3B:;}};}{
# 1121
...
# 1438
;_pop_handler();}else{void*_tmp171=(void*)_exn_thrown;void*_tmp175=_tmp171;void*_tmp176;if(((struct Cyc_Core_Not_found_exn_struct*)_tmp175)->tag == Cyc_Core_Not_found){_LL41: _LL42:
# 1441
 goto _LL40;}else{_LL43: _tmp176=_tmp175;_LL44:(int)_rethrow(_tmp176);}_LL40:;}};}
# 1443
...
# 1560
;_pop_handler();}else{void*_tmp35E=(void*)_exn_thrown;void*_tmp374=_tmp35E;void*_tmp375;_LL46: _tmp375=_tmp374;_LL47:
# 1597
...
Cyc_compile_failure=1;
Cyc_remove_cfiles();{
int _tmp37D=1;_npop_handler(0);return _tmp37D;};_LL45:;}};}{
# 1603
