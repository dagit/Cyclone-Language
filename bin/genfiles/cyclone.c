...
struct Cyc_Interface_I*_tmp9E=Cyc_Interface_extract(_tmpA5->ae);
if(_tmpA4 == 0)
...
# 1110
;_pop_handler();}else{void*_tmp131=(void*)_exn_thrown;void*_tmp134=_tmp131;void*_tmp137;_LL3D: _tmp137=_tmp134;_LL3E:
# 1114
 Cyc_compile_failure=1;
Cyc_file_close(out_file);
Cyc_cfiles=({struct Cyc_List_List*_tmp135=_cycalloc(sizeof(*_tmp135));_tmp135->hd=({struct _dyneither_ptr*_tmp136=_cycalloc(sizeof(*_tmp136));_tmp136[0]=(struct _dyneither_ptr)_tmpF6;_tmp136;});_tmp135->tl=Cyc_cfiles;_tmp135;});
Cyc_Core_rethrow(_tmp137);_LL3C:;}};}
# 1119
Cyc_file_close(out_file);
...
# 1613
;_pop_handler();}else{void*_tmp2D8=(void*)_exn_thrown;void*_tmp2EE=_tmp2D8;void*_tmp2F7;_LL4C: _tmp2F7=_tmp2EE;_LL4D:
# 1650
({struct Cyc_Int_pa_PrintArg_struct _tmp2F3;_tmp2F3.tag=1;_tmp2F3.f1=(unsigned long)Cyc_Core_get_exn_lineno();({struct Cyc_String_pa_PrintArg_struct _tmp2F2;_tmp2F2.tag=0;_tmp2F2.f1=(struct _dyneither_ptr)({const char*_tmp2F5=Cyc_Core_get_exn_filename();_tag_dyneither(_tmp2F5,sizeof(char),_get_zero_arr_size_char((void*)_tmp2F5,1));});({struct Cyc_String_pa_PrintArg_struct _tmp2F1;_tmp2F1.tag=0;_tmp2F1.f1=(struct _dyneither_ptr)({const char*_tmp2F4=Cyc_Core_get_exn_name(_tmp2F7);_tag_dyneither(_tmp2F4,sizeof(char),_get_zero_arr_size_char((void*)_tmp2F4,1));});({void*_tmp2EF[3]={& _tmp2F1,& _tmp2F2,& _tmp2F3};Cyc_fprintf(Cyc_stderr,({const char*_tmp2F0="INTERNAL COMPILER FAILURE:  exception %s from around %s:%d thrown.\n  Please send bug report to cyclone-bugs-l@lists.cs.cornell.edu";_tag_dyneither(_tmp2F0,sizeof(char),131);}),_tag_dyneither(_tmp2EF,sizeof(void*),3));});});});});
Cyc_compile_failure=1;
Cyc_remove_cfiles();{
int _tmp2F6=1;_npop_handler(0);return _tmp2F6;};_LL4B:;}};}{
# 1656
