...
_dyneither_ptr*_tmp3B5;struct Cyc_List_List*_tmp3B4;Cyc_ccargs=((_tmp3B4=
_cycalloc(sizeof(*_tmp3B4)),((_tmp3B4->hd=((_tmp3B5=_cycalloc(sizeof(*_tmp3B5)),((
_tmp3B5[0]=s,_tmp3B5)))),((_tmp3B4->tl=Cyc_ccargs,_tmp3B4))))));}void Cyc_set_c_compiler(
...
_dyneither_ptr*_tmp3BD;struct Cyc_List_List*_tmp3BC;Cyc_cppargs=((_tmp3BC=
_cycalloc(sizeof(*_tmp3BC)),((_tmp3BC->hd=((_tmp3BD=_cycalloc(sizeof(*_tmp3BD)),((
_tmp3BD[0]=s,_tmp3BD)))),((_tmp3BC->tl=Cyc_cppargs,_tmp3BC))))));}static void Cyc_add_iprefix(
...
_dyneither_ptr s){const char*_tmp3C5;void*_tmp3C4[1];struct Cyc_String_pa_struct
...
_tmp3C5="-iwithprefix %s",_tag_dyneither(_tmp3C5,sizeof(char),16))),
_tag_dyneither(_tmp3C4,sizeof(void*),1)))))))));}static void Cyc_add_iwithprefixbefore(
...
struct _dyneither_ptr s){const char*_tmp3CD;void*_tmp3CC[1];struct Cyc_String_pa_struct
...
_tmp3CD="-isystem %s",_tag_dyneither(_tmp3CD,sizeof(char),12))),_tag_dyneither(
_tmp3CC,sizeof(void*),1)))))))));}static void Cyc_add_idirafter(struct
_dyneither_ptr s){const char*_tmp3D1;void*_tmp3D0[1];struct Cyc_String_pa_struct
...
_tmp3E3;return Cyc_strcmp((struct _dyneither_ptr)_dyneither_ptr_plus(s,sizeof(char),(
int)(_tmp26 - 4)),((_tmp3E3=".cyc",_tag_dyneither(_tmp3E3,sizeof(char),5))))== 0;}}
...
static void Cyc_add_libarg(struct _dyneither_ptr s){const char*_tmp3E7;if(Cyc_strcmp((
struct _dyneither_ptr)s,((_tmp3E7="-lxml",_tag_dyneither(_tmp3E7,sizeof(char),6))))
== 0)Cyc_add_ccarg(s);else{struct _dyneither_ptr*_tmp3EA;struct Cyc_List_List*
_tmp3E9;Cyc_libargs=((_tmp3E9=_cycalloc(sizeof(*_tmp3E9)),((_tmp3E9->hd=((
_tmp3EA=_cycalloc(sizeof(*_tmp3EA)),((_tmp3EA[0]=s,_tmp3EA)))),((_tmp3E9->tl=Cyc_libargs,
_tmp3E9))))));}}static void Cyc_add_marg(struct _dyneither_ptr s){Cyc_add_ccarg(s);}
static void Cyc_set_save_temps(){Cyc_save_temps_r=1;{const char*_tmp3EB;Cyc_add_ccarg(((
_tmp3EB="-save-temps",_tag_dyneither(_tmp3EB,sizeof(char),12))));};}static int Cyc_produce_dependencies=
0;static void Cyc_set_produce_dependencies(){Cyc_stop_after_cpp_r=1;Cyc_produce_dependencies=
1;{const char*_tmp3EC;Cyc_add_cpparg(((_tmp3EC="-M",_tag_dyneither(_tmp3EC,
...
_dyneither_ptr*_tmp3ED;Cyc_dependencies_target=((_tmp3ED=_cycalloc(sizeof(*
_tmp3ED)),((_tmp3ED[0]=s,_tmp3ED))));}static void Cyc_set_stop_after_objectfile(){
Cyc_stop_after_objectfile_r=1;{const char*_tmp3EE;Cyc_add_ccarg(((_tmp3EE="-c",
_tag_dyneither(_tmp3EE,sizeof(char),3))));};}static void Cyc_set_nocppprecomp(){{
const char*_tmp3EF;Cyc_add_cpparg(((_tmp3EF="-no-cpp-precomp",_tag_dyneither(
_tmp3EF,sizeof(char),16))));}{const char*_tmp3F0;Cyc_add_ccarg(((_tmp3F0="-no-cpp-precomp",
_tag_dyneither(_tmp3F0,sizeof(char),16))));};}static void Cyc_set_lineno(){Cyc_generate_line_directives_r=
...
static void Cyc_set_tovc(){Cyc_Cyclone_tovc_r=1;{const char*_tmp3F1;Cyc_add_ccarg(((
_tmp3F1="-DCYC_ANSI_OUTPUT",_tag_dyneither(_tmp3F1,sizeof(char),18))));}Cyc_set_elim_se();}
...
const char*_tmp3F3;Cyc_add_ccarg(((_tmp3F3="-DNO_CYC_NULL_CHECKS",_tag_dyneither(
_tmp3F3,sizeof(char),21))));}static void Cyc_set_nochecks(){Cyc_set_noboundschecks();
Cyc_set_nonullchecks();Cyc_nocheck_r=1;}static void Cyc_set_nocyc(){Cyc_add_cyc_namespace_r=
0;{const char*_tmp3F4;Cyc_add_ccarg(((_tmp3F4="-DNO_CYC_PREFIX",_tag_dyneither(
_tmp3F4,sizeof(char),16))));};}static void Cyc_set_pa(){Cyc_pa_r=1;{const char*
_tmp3F5;Cyc_add_ccarg(((_tmp3F5="-DCYC_REGION_PROFILE",_tag_dyneither(_tmp3F5,
sizeof(char),21))));};}static void Cyc_set_pg(){Cyc_pg_r=1;{const char*_tmp3F6;Cyc_add_ccarg(((
_tmp3F6="-pg",_tag_dyneither(_tmp3F6,sizeof(char),4))));};}static void Cyc_set_stop_after_asmfile(){
Cyc_stop_after_asmfile_r=1;{const char*_tmp3F7;Cyc_add_ccarg(((_tmp3F7="-S",
_tag_dyneither(_tmp3F7,sizeof(char),3))));};}static void Cyc_set_all_warnings(){
Cyc_Toc_warn_bounds_checks=1;Cyc_Toc_warn_all_null_deref=1;Cyc_NewControlFlow_warn_lose_unique=
1;}enum Cyc_inputtype{Cyc_DEFAULTINPUT  = 0,Cyc_CYCLONEFILE  = 1};static enum Cyc_inputtype
Cyc_intype=Cyc_DEFAULTINPUT;static void Cyc_set_inputtype(struct _dyneither_ptr s){
const char*_tmp3F8;if(Cyc_strcmp((struct _dyneither_ptr)s,((_tmp3F8="cyc",
_tag_dyneither(_tmp3F8,sizeof(char),4))))== 0)Cyc_intype=Cyc_CYCLONEFILE;else{
const char*_tmp3F9;if(Cyc_strcmp((struct _dyneither_ptr)s,((_tmp3F9="none",
...
_dyneither_ptr*output_file){struct _dyneither_ptr _tmp41=Cyc_Filename_dirname(
...
struct _dyneither_ptr*_tmp400;struct Cyc_List_List*_tmp3FF;Cyc_cyclone_files=((
_tmp3FF=_cycalloc(sizeof(*_tmp3FF)),((_tmp3FF->hd=((_tmp400=_cycalloc(sizeof(*
_tmp400)),((_tmp400[0]=s,_tmp400)))),((_tmp3FF->tl=Cyc_cyclone_files,_tmp3FF))))));}{
struct _dyneither_ptr _tmp46=Cyc_make_base_filename(s,Cyc_output_file);const char*
_tmp401;struct _dyneither_ptr _tmp47=Cyc_strconcat((struct _dyneither_ptr)_tmp46,((
_tmp401=".c",_tag_dyneither(_tmp401,sizeof(char),3))));Cyc_add_ccarg((struct
_dyneither_ptr)_tmp47);};}else{Cyc_add_ccarg(s);}}static void Cyc_remove_file(
...
_dyneither_ptr file){struct Cyc_List_List*_tmp49=0;int c;int i;char strname[256];char
...
struct _tuple19*_tmp41F;struct _dyneither_ptr*_tmp41E;const char*_tmp41D;struct
...
_tuple19*_tmp42D;struct _dyneither_ptr*_tmp42C;struct _dyneither_ptr*_tmp42B;
...
msg_part){struct _handler_cons _tmp70;_push_handler(& _tmp70);{int _tmp72=0;if(
setjmp(_tmp70.handler))_tmp72=1;if(!_tmp72){{struct Cyc___cycFILE*_tmp73=(struct
Cyc___cycFILE*)Cyc_file_open(filename,mode);_npop_handler(0);return _tmp73;};
_pop_handler();}else{void*_tmp71=(void*)_exn_thrown;void*_tmp75=_tmp71;_LL1:;
_LL2: Cyc_compile_failure=1;{const char*_tmp43C;void*_tmp43B[2];struct Cyc_String_pa_struct
_tmp43A;struct Cyc_String_pa_struct _tmp439;(_tmp439.tag=0,((_tmp439.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)filename),((_tmp43A.tag=0,((_tmp43A.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)msg_part),((_tmp43B[0]=& _tmp43A,((
_tmp43B[1]=& _tmp439,Cyc_fprintf(Cyc_stderr,((_tmp43C="\nError: couldn't open %s %s\n",
_tag_dyneither(_tmp43C,sizeof(char),29))),_tag_dyneither(_tmp43B,sizeof(void*),2)))))))))))));}
Cyc_fflush((struct Cyc___cycFILE*)Cyc_stderr);return 0;_LL3:;_LL4:(void)_throw(
_tmp75);_LL0:;}};}struct Cyc_List_List*Cyc_do_stage(struct _dyneither_ptr
stage_name,struct Cyc_List_List*(*f)(void*,struct Cyc_List_List*),void*env,struct
Cyc_List_List*tds){const char*_tmp43D;struct _dyneither_ptr exn_string=(_tmp43D="",
_tag_dyneither(_tmp43D,sizeof(char),1));const char*_tmp43E;struct _dyneither_ptr
explain_string=(_tmp43E="",_tag_dyneither(_tmp43E,sizeof(char),1));int other_exn=
0;struct Cyc_Core_Impossible_struct _tmp444;const char*_tmp443;struct Cyc_Core_Impossible_struct*
_tmp442;void*ex=(void*)((_tmp442=_cycalloc(sizeof(*_tmp442)),((_tmp442[0]=((
_tmp444.tag=Cyc_Core_Impossible,((_tmp444.f1=((_tmp443="",_tag_dyneither(_tmp443,
sizeof(char),1))),_tmp444)))),_tmp442))));struct Cyc_List_List*_tmp7A=0;{struct
_handler_cons _tmp7B;_push_handler(& _tmp7B);{int _tmp7D=0;if(setjmp(_tmp7B.handler))
_tmp7D=1;if(!_tmp7D){_tmp7A=f(env,tds);;_pop_handler();}else{void*_tmp7C=(void*)
_exn_thrown;void*_tmp7F=_tmp7C;struct _dyneither_ptr _tmp81;struct _dyneither_ptr
_tmp84;struct _dyneither_ptr _tmp86;_LL6: {struct Cyc_Core_Impossible_struct*_tmp80=(
struct Cyc_Core_Impossible_struct*)_tmp7F;if(_tmp80->tag != Cyc_Core_Impossible)
goto _LL8;else{_tmp81=_tmp80->f1;}}_LL7:{const char*_tmp445;exn_string=((_tmp445="Exception Core::Impossible",
...
1);{struct Cyc_List_List*_tmp9C=Cyc_Parse_parse_file(f);Cyc_Lex_lex_init(1);
return _tmp9C;};}struct _tuple20{struct _RegionHandle*f1;struct Cyc_Tcenv_Tenv*f2;};
struct Cyc_List_List*Cyc_do_typecheck(struct _tuple20*tcenv,struct Cyc_List_List*
tds){struct _RegionHandle*_tmp9E;struct Cyc_Tcenv_Tenv*_tmp9F;struct _tuple20 _tmp9D=*
tcenv;_tmp9E=_tmp9D.f1;_tmp9F=_tmp9D.f2;Cyc_Tc_tc(_tmp9E,_tmp9F,1,tds);if(!Cyc_noshake_r)
tds=Cyc_Tc_treeshake(_tmp9F,tds);return tds;}struct Cyc_List_List*Cyc_do_cfcheck(
...
tds){struct _tuple21 _tmpA1;struct Cyc_Tcenv_Tenv*_tmpA2;struct Cyc___cycFILE*_tmpA3;
struct Cyc___cycFILE*_tmpA4;struct _tuple21*_tmpA0=params;_tmpA1=*_tmpA0;_tmpA2=
_tmpA1.f1;_tmpA3=_tmpA1.f2;_tmpA4=_tmpA1.f3;{struct Cyc_Interface_I*_tmpA5=Cyc_Interface_extract(
_tmpA2->ae);if(_tmpA3 == 0)Cyc_Interface_save(_tmpA5,_tmpA4);else{struct Cyc_Interface_I*
_tmpA6=Cyc_Interface_parse((struct Cyc___cycFILE*)_tmpA3);const char*_tmp45C;const
char*_tmp45B;struct _tuple18*_tmp45A;if(!Cyc_Interface_is_subinterface(_tmpA6,
_tmpA5,((_tmp45A=_cycalloc(sizeof(*_tmp45A)),((_tmp45A->f1=((_tmp45B="written interface",
...
if((char*)file.curr == (char*)(_tag_dyneither(0,0,0)).curr){{const char*_tmp45F;
void*_tmp45E;(_tmp45E=0,Cyc_fprintf(Cyc_stderr,((_tmp45F="Internal error: copy_internal_file called with NULL\n",
...
return 0;{struct Cyc_List_List*_tmpBB=0;unsigned long _tmpBC=Cyc_strlen((struct
_dyneither_ptr)s);while(_tmpBC > 0){struct _dyneither_ptr _tmpBD=Cyc_strchr(s,c);
if((char*)_tmpBD.curr == (char*)(_tag_dyneither(0,0,0)).curr){{struct
_dyneither_ptr*_tmp472;struct Cyc_List_List*_tmp471;_tmpBB=((_tmp471=_cycalloc(
sizeof(*_tmp471)),((_tmp471->hd=((_tmp472=_cycalloc(sizeof(*_tmp472)),((_tmp472[
0]=s,_tmp472)))),((_tmp471->tl=_tmpBB,_tmp471))))));}break;}else{{struct
_dyneither_ptr*_tmp475;struct Cyc_List_List*_tmp474;_tmpBB=((_tmp474=_cycalloc(
sizeof(*_tmp474)),((_tmp474->hd=((_tmp475=_cycalloc(sizeof(*_tmp475)),((_tmp475[
0]=(struct _dyneither_ptr)Cyc_substring((struct _dyneither_ptr)s,0,(unsigned long)((((
struct _dyneither_ptr)_tmpBD).curr - s.curr)/ sizeof(char))),_tmp475)))),((_tmp474->tl=
_tmpBB,_tmp474))))));}_tmpBC -=(((struct _dyneither_ptr)_tmpBD).curr - s.curr)/ 
sizeof(char);s=_dyneither_ptr_plus(_tmpBD,sizeof(char),1);}}return((struct Cyc_List_List*(*)(
struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmpBB);};}static int Cyc_file_exists(
struct _dyneither_ptr file){struct Cyc___cycFILE*f=0;{struct _handler_cons _tmpC2;
_push_handler(& _tmpC2);{int _tmpC4=0;if(setjmp(_tmpC2.handler))_tmpC4=1;if(!
_tmpC4){{const char*_tmp476;f=(struct Cyc___cycFILE*)Cyc_file_open(file,((_tmp476="r",
_tag_dyneither(_tmp476,sizeof(char),2))));};_pop_handler();}else{void*_tmpC3=(
void*)_exn_thrown;void*_tmpC7=_tmpC3;_LL13:;_LL14: goto _LL12;_LL15:;_LL16:(void)
_throw(_tmpC7);_LL12:;}};}if(f == 0)return 0;else{Cyc_fclose((struct Cyc___cycFILE*)
f);return 1;}}static struct _dyneither_ptr Cyc_sprint_list(struct Cyc_List_List*dirs){
const char*_tmp477;struct _dyneither_ptr tmp=(_tmp477="",_tag_dyneither(_tmp477,
sizeof(char),1));for(0;dirs != 0;dirs=dirs->tl){struct _dyneither_ptr _tmpC8=*((
struct _dyneither_ptr*)dirs->hd);if((char*)_tmpC8.curr == (char*)(_tag_dyneither(0,
0,0)).curr  || Cyc_strlen((struct _dyneither_ptr)_tmpC8)== 0)continue;{const char*
_tmp478;_tmpC8=(struct _dyneither_ptr)Cyc_strconcat((struct _dyneither_ptr)_tmpC8,((
_tmp478=":",_tag_dyneither(_tmp478,sizeof(char),2))));}tmp=(struct _dyneither_ptr)
Cyc_strconcat((struct _dyneither_ptr)_tmpC8,(struct _dyneither_ptr)tmp);}return tmp;}
...
return 0;for(0;dirs != 0;dirs=dirs->tl){struct _dyneither_ptr _tmpCB=*((struct
_dyneither_ptr*)dirs->hd);if((char*)_tmpCB.curr == (char*)(_tag_dyneither(0,0,0)).curr
 || Cyc_strlen((struct _dyneither_ptr)_tmpCB)== 0)continue;{struct _dyneither_ptr s=(
struct _dyneither_ptr)Cyc_Filename_concat(_tmpCB,file);if(Cyc_file_exists(s)){
struct _dyneither_ptr*_tmp479;return(_tmp479=_cycalloc(sizeof(*_tmp479)),((
...
struct Cyc_List_List*dirs,struct _dyneither_ptr subdir){struct Cyc_List_List*_tmpD8=
0;for(0;dirs != 0;dirs=dirs->tl){struct _dyneither_ptr*_tmp491;struct Cyc_List_List*
...
struct _dyneither_ptr subdir){struct Cyc_List_List*_tmpDB=0;for(0;dirs != 0;dirs=
dirs->tl){{struct Cyc_List_List*_tmp492;_tmpDB=((_tmp492=_cycalloc(sizeof(*
...
return _tmpDB;}static int Cyc_is_other_special(char c){switch(c){case '\\': _LL17: goto
...
_dyneither_ptr Cyc_sh_escape_string(struct _dyneither_ptr s);static void _tmp49E(
unsigned int*_tmp49D,unsigned int*_tmp49C,char**_tmp49A){for(*_tmp49D=0;*_tmp49D
< *_tmp49C;(*_tmp49D)++){(*_tmp49A)[*_tmp49D]='\000';}}static struct
_dyneither_ptr Cyc_sh_escape_string(struct _dyneither_ptr s){unsigned long _tmpDF=
Cyc_strlen((struct _dyneither_ptr)s);int _tmpE0=0;int _tmpE1=0;{int i=0;for(0;i < 
_tmpDF;++ i){char _tmpE2=*((const char*)_check_dyneither_subscript(s,sizeof(char),i));
if(_tmpE2 == '\'')++ _tmpE0;else{if(Cyc_is_other_special(_tmpE2))++ _tmpE1;}}}if(
_tmpE0 == 0  && _tmpE1 == 0)return s;if(_tmpE0 == 0){struct _dyneither_ptr*_tmp498;
struct _dyneither_ptr*_tmp497[3];return(struct _dyneither_ptr)Cyc_strconcat_l(((
_tmp497[2]=_init_dyneither_ptr(_cycalloc(sizeof(struct _dyneither_ptr)),"'",
sizeof(char),2),((_tmp497[1]=((_tmp498=_cycalloc(sizeof(*_tmp498)),((_tmp498[0]=(
struct _dyneither_ptr)s,_tmp498)))),((_tmp497[0]=_init_dyneither_ptr(_cycalloc(
sizeof(struct _dyneither_ptr)),"'",sizeof(char),2),((struct Cyc_List_List*(*)(
struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp497,sizeof(struct
_dyneither_ptr*),3)))))))));}{unsigned long _tmpE7=(_tmpDF + _tmpE0)+ _tmpE1;
unsigned int _tmp49D;unsigned int _tmp49C;struct _dyneither_ptr _tmp49B;char*_tmp49A;
unsigned int _tmp499;struct _dyneither_ptr s2=(_tmp499=_tmpE7 + 1,((_tmp49A=(char*)
_cycalloc_atomic(_check_times(sizeof(char),_tmp499 + 1)),((_tmp49B=_tag_dyneither(
_tmp49A,sizeof(char),_tmp499 + 1),((((_tmp49C=_tmp499,((_tmp49E(& _tmp49D,& _tmp49C,&
_tmp49A),_tmp49A[_tmp49C]=(char)0)))),_tmp49B)))))));int _tmpE8=0;int _tmpE9=0;
for(0;_tmpE8 < _tmpDF;++ _tmpE8){char _tmpEA=*((const char*)
_check_dyneither_subscript(s,sizeof(char),_tmpE8));if(_tmpEA == '\''  || Cyc_is_other_special(
_tmpEA)){char _tmp4A1;char _tmp4A0;struct _dyneither_ptr _tmp49F;(_tmp49F=
_dyneither_ptr_plus(s2,sizeof(char),_tmpE9 ++),((_tmp4A0=*((char*)
...
Cyc_process_file(struct _dyneither_ptr filename){struct _dyneither_ptr _tmpF6=Cyc_make_base_filename(
...
void*)_exn_thrown;void*_tmp11C=_tmp118;_LL26:;_LL27: Cyc_file_close((struct Cyc___cycFILE*)
_check_null(in_file));Cyc_remove_file((struct _dyneither_ptr)_tmpF7);(int)_throw(
_tmp11C);_LL28:;_LL29:(void)_throw(_tmp11C);_LL25:;}};}Cyc_file_close((struct Cyc___cycFILE*)
...
Cyc_parseonly_r)goto PRINTC;{struct _tuple20 _tmp4E5;struct _tuple20 _tmp11F=(_tmp4E5.f1=
...
struct _dyneither_ptr)_tmpF8);{struct _tuple21 _tmp4EA;struct _tuple21 _tmp122=(
...
_exn_thrown;void*_tmp135=_tmp131;_LL2B:;_LL2C: Cyc_compile_failure=1;Cyc_file_close((
...
_tmp4F6->tl=Cyc_cfiles,_tmp4F6))))));}(int)_throw(_tmp135);_LL2D:;_LL2E:(void)
_throw(_tmp135);_LL2A:;}};}Cyc_file_close((struct Cyc___cycFILE*)out_file);{
...
1;if(!_tmp155){basename=(struct _dyneither_ptr)Cyc_Filename_chop_extension(*n);;
_pop_handler();}else{void*_tmp154=(void*)_exn_thrown;void*_tmp157=_tmp154;_LL30: {
struct Cyc_Core_Invalid_argument_struct*_tmp158=(struct Cyc_Core_Invalid_argument_struct*)
_tmp157;if(_tmp158->tag != Cyc_Core_Invalid_argument)goto _LL32;}_LL31: basename=*n;
goto _LL2F;_LL32:;_LL33:(void)_throw(_tmp157);_LL2F:;}};}{const char*_tmp4FB;
struct _dyneither_ptr _tmp159=Cyc_strconcat((struct _dyneither_ptr)basename,((
_tmp4FB=".cycio",_tag_dyneither(_tmp4FB,sizeof(char),7))));const char*_tmp4FD;
const char*_tmp4FC;struct Cyc___cycFILE*_tmp15A=Cyc_try_file_open((struct
_dyneither_ptr)_tmp159,((_tmp4FC="rb",_tag_dyneither(_tmp4FC,sizeof(char),3))),((
_tmp4FD="interface object file",_tag_dyneither(_tmp4FD,sizeof(char),22))));if(
_tmp15A == 0){Cyc_compile_failure=1;Cyc_remove_cfiles();exit(1);}Cyc_Position_reset_position((
...
return _tmp15B;};};};}static int Cyc_is_cfile(struct _dyneither_ptr*n){return*((
...
_dyneither_ptr argv);static void _tmp503(unsigned int*_tmp502,unsigned int*_tmp501,
int**_tmp4FF){for(*_tmp502=0;*_tmp502 < *_tmp501;(*_tmp502)++){(*_tmp4FF)[*
_tmp502]=0;}}static void _tmp50B(unsigned int*_tmp50A,unsigned int*_tmp509,struct
_dyneither_ptr**_tmp507){for(*_tmp50A=0;*_tmp50A < *_tmp509;(*_tmp50A)++){(*
_tmp507)[*_tmp50A]=(struct _dyneither_ptr)_tag_dyneither(0,0,0);}}static void
_tmp511(unsigned int*_tmp510,unsigned int*_tmp50F,struct _dyneither_ptr**_tmp50D){
for(*_tmp510=0;*_tmp510 < *_tmp50F;(*_tmp510)++){(*_tmp50D)[*_tmp510]=(struct
...
Cstring_to_string(Ccomp);struct _RegionHandle _tmp15F=_new_region("r");struct
_RegionHandle*r=& _tmp15F;_push_region(r);{unsigned int _tmp502;unsigned int
_tmp501;struct _dyneither_ptr _tmp500;int*_tmp4FF;unsigned int _tmp4FE;struct
_dyneither_ptr _tmp160=(_tmp4FE=(unsigned int)argc,((_tmp4FF=(int*)
...
_dyneither_ptr),i));}}{struct _tuple22*_tmpA34;const char*_tmpA33;const char*
_tmpA32;struct Cyc_Arg_Set_spec_struct _tmpA31;struct Cyc_Arg_Set_spec_struct*
_tmpA30;const char*_tmpA2F;struct _tuple22*_tmpA2E;const char*_tmpA2D;const char*
_tmpA2C;struct Cyc_Arg_Unit_spec_struct _tmpA2B;struct Cyc_Arg_Unit_spec_struct*
_tmpA2A;const char*_tmpA29;struct _tuple22*_tmpA28;const char*_tmpA27;const char*
_tmpA26;struct Cyc_Arg_String_spec_struct _tmpA25;struct Cyc_Arg_String_spec_struct*
_tmpA24;const char*_tmpA23;struct _tuple22*_tmpA22;const char*_tmpA21;const char*
_tmpA20;struct Cyc_Arg_Flag_spec_struct _tmpA1F;struct Cyc_Arg_Flag_spec_struct*
_tmpA1E;const char*_tmpA1D;struct _tuple22*_tmpA1C;const char*_tmpA1B;const char*
_tmpA1A;struct Cyc_Arg_Flag_spec_struct _tmpA19;struct Cyc_Arg_Flag_spec_struct*
_tmpA18;const char*_tmpA17;struct _tuple22*_tmpA16;const char*_tmpA15;const char*
_tmpA14;struct Cyc_Arg_Flag_spec_struct _tmpA13;struct Cyc_Arg_Flag_spec_struct*
_tmpA12;const char*_tmpA11;struct _tuple22*_tmpA10;const char*_tmpA0F;const char*
_tmpA0E;struct Cyc_Arg_Flag_spec_struct _tmpA0D;struct Cyc_Arg_Flag_spec_struct*
_tmpA0C;const char*_tmpA0B;struct _tuple22*_tmpA0A;const char*_tmpA09;const char*
_tmpA08;struct Cyc_Arg_Flag_spec_struct _tmpA07;struct Cyc_Arg_Flag_spec_struct*
_tmpA06;const char*_tmpA05;struct _tuple22*_tmpA04;const char*_tmpA03;const char*
_tmpA02;struct Cyc_Arg_Flag_spec_struct _tmpA01;struct Cyc_Arg_Flag_spec_struct*
_tmpA00;const char*_tmp9FF;struct _tuple22*_tmp9FE;const char*_tmp9FD;const char*
_tmp9FC;struct Cyc_Arg_Unit_spec_struct _tmp9FB;struct Cyc_Arg_Unit_spec_struct*
_tmp9FA;const char*_tmp9F9;struct _tuple22*_tmp9F8;const char*_tmp9F7;const char*
_tmp9F6;struct Cyc_Arg_String_spec_struct _tmp9F5;struct Cyc_Arg_String_spec_struct*
_tmp9F4;const char*_tmp9F3;struct _tuple22*_tmp9F2;const char*_tmp9F1;const char*
_tmp9F0;struct Cyc_Arg_Flag_spec_struct _tmp9EF;struct Cyc_Arg_Flag_spec_struct*
_tmp9EE;const char*_tmp9ED;struct _tuple22*_tmp9EC;const char*_tmp9EB;const char*
_tmp9EA;struct Cyc_Arg_Flag_spec_struct _tmp9E9;struct Cyc_Arg_Flag_spec_struct*
_tmp9E8;const char*_tmp9E7;struct _tuple22*_tmp9E6;const char*_tmp9E5;const char*
_tmp9E4;struct Cyc_Arg_Flag_spec_struct _tmp9E3;struct Cyc_Arg_Flag_spec_struct*
_tmp9E2;const char*_tmp9E1;struct _tuple22*_tmp9E0;const char*_tmp9DF;const char*
_tmp9DE;struct Cyc_Arg_Flag_spec_struct _tmp9DD;struct Cyc_Arg_Flag_spec_struct*
_tmp9DC;const char*_tmp9DB;struct _tuple22*_tmp9DA;const char*_tmp9D9;const char*
_tmp9D8;struct Cyc_Arg_Flag_spec_struct _tmp9D7;struct Cyc_Arg_Flag_spec_struct*
_tmp9D6;const char*_tmp9D5;struct _tuple22*_tmp9D4;const char*_tmp9D3;const char*
_tmp9D2;struct Cyc_Arg_Flag_spec_struct _tmp9D1;struct Cyc_Arg_Flag_spec_struct*
_tmp9D0;const char*_tmp9CF;struct _tuple22*_tmp9CE;const char*_tmp9CD;const char*
_tmp9CC;struct Cyc_Arg_Flag_spec_struct _tmp9CB;struct Cyc_Arg_Flag_spec_struct*
_tmp9CA;const char*_tmp9C9;struct _tuple22*_tmp9C8;const char*_tmp9C7;const char*
_tmp9C6;struct Cyc_Arg_Flag_spec_struct _tmp9C5;struct Cyc_Arg_Flag_spec_struct*
_tmp9C4;const char*_tmp9C3;struct _tuple22*_tmp9C2;const char*_tmp9C1;const char*
_tmp9C0;struct Cyc_Arg_Unit_spec_struct _tmp9BF;struct Cyc_Arg_Unit_spec_struct*
_tmp9BE;const char*_tmp9BD;struct _tuple22*_tmp9BC;const char*_tmp9BB;const char*
_tmp9BA;struct Cyc_Arg_Unit_spec_struct _tmp9B9;struct Cyc_Arg_Unit_spec_struct*
_tmp9B8;const char*_tmp9B7;struct _tuple22*_tmp9B6;const char*_tmp9B5;const char*
_tmp9B4;struct Cyc_Arg_Unit_spec_struct _tmp9B3;struct Cyc_Arg_Unit_spec_struct*
_tmp9B2;const char*_tmp9B1;struct _tuple22*_tmp9B0;const char*_tmp9AF;const char*
_tmp9AE;struct Cyc_Arg_Unit_spec_struct _tmp9AD;struct Cyc_Arg_Unit_spec_struct*
_tmp9AC;const char*_tmp9AB;struct _tuple22*_tmp9AA;const char*_tmp9A9;const char*
_tmp9A8;struct Cyc_Arg_Flag_spec_struct _tmp9A7;struct Cyc_Arg_Flag_spec_struct*
_tmp9A6;const char*_tmp9A5;struct _tuple22*_tmp9A4;const char*_tmp9A3;const char*
_tmp9A2;struct Cyc_Arg_String_spec_struct _tmp9A1;struct Cyc_Arg_String_spec_struct*
_tmp9A0;const char*_tmp99F;struct _tuple22*_tmp99E;const char*_tmp99D;const char*
_tmp99C;struct Cyc_Arg_String_spec_struct _tmp99B;struct Cyc_Arg_String_spec_struct*
_tmp99A;const char*_tmp999;struct _tuple22*_tmp998;const char*_tmp997;const char*
_tmp996;struct Cyc_Arg_Set_spec_struct _tmp995;struct Cyc_Arg_Set_spec_struct*
_tmp994;const char*_tmp993;struct _tuple22*_tmp992;const char*_tmp991;const char*
_tmp990;struct Cyc_Arg_Unit_spec_struct _tmp98F;struct Cyc_Arg_Unit_spec_struct*
_tmp98E;const char*_tmp98D;struct _tuple22*_tmp98C;const char*_tmp98B;const char*
_tmp98A;struct Cyc_Arg_Set_spec_struct _tmp989;struct Cyc_Arg_Set_spec_struct*
_tmp988;const char*_tmp987;struct _tuple22*_tmp986;const char*_tmp985;const char*
_tmp984;struct Cyc_Arg_Set_spec_struct _tmp983;struct Cyc_Arg_Set_spec_struct*
_tmp982;const char*_tmp981;struct _tuple22*_tmp980;const char*_tmp97F;const char*
_tmp97E;struct Cyc_Arg_Set_spec_struct _tmp97D;struct Cyc_Arg_Set_spec_struct*
_tmp97C;const char*_tmp97B;struct _tuple22*_tmp97A;const char*_tmp979;const char*
_tmp978;struct Cyc_Arg_Set_spec_struct _tmp977;struct Cyc_Arg_Set_spec_struct*
_tmp976;const char*_tmp975;struct _tuple22*_tmp974;const char*_tmp973;const char*
_tmp972;struct Cyc_Arg_Set_spec_struct _tmp971;struct Cyc_Arg_Set_spec_struct*
_tmp970;const char*_tmp96F;struct _tuple22*_tmp96E;const char*_tmp96D;const char*
_tmp96C;struct Cyc_Arg_Set_spec_struct _tmp96B;struct Cyc_Arg_Set_spec_struct*
_tmp96A;const char*_tmp969;struct _tuple22*_tmp968;const char*_tmp967;const char*
_tmp966;struct Cyc_Arg_Set_spec_struct _tmp965;struct Cyc_Arg_Set_spec_struct*
_tmp964;const char*_tmp963;struct _tuple22*_tmp962;const char*_tmp961;const char*
_tmp960;struct Cyc_Arg_Set_spec_struct _tmp95F;struct Cyc_Arg_Set_spec_struct*
_tmp95E;const char*_tmp95D;struct _tuple22*_tmp95C;const char*_tmp95B;const char*
_tmp95A;struct Cyc_Arg_Clear_spec_struct _tmp959;struct Cyc_Arg_Clear_spec_struct*
_tmp958;const char*_tmp957;struct _tuple22*_tmp956;const char*_tmp955;const char*
_tmp954;struct Cyc_Arg_Set_spec_struct _tmp953;struct Cyc_Arg_Set_spec_struct*
_tmp952;const char*_tmp951;struct _tuple22*_tmp950;const char*_tmp94F;const char*
_tmp94E;struct Cyc_Arg_Clear_spec_struct _tmp94D;struct Cyc_Arg_Clear_spec_struct*
_tmp94C;const char*_tmp94B;struct _tuple22*_tmp94A;const char*_tmp949;const char*
_tmp948;struct Cyc_Arg_Unit_spec_struct _tmp947;struct Cyc_Arg_Unit_spec_struct*
_tmp946;const char*_tmp945;struct _tuple22*_tmp944;const char*_tmp943;const char*
_tmp942;struct Cyc_Arg_String_spec_struct _tmp941;struct Cyc_Arg_String_spec_struct*
_tmp940;const char*_tmp93F;struct _tuple22*_tmp93E;const char*_tmp93D;const char*
_tmp93C;struct Cyc_Arg_Unit_spec_struct _tmp93B;struct Cyc_Arg_Unit_spec_struct*
_tmp93A;const char*_tmp939;struct _tuple22*_tmp938;const char*_tmp937;const char*
_tmp936;struct Cyc_Arg_Set_spec_struct _tmp935;struct Cyc_Arg_Set_spec_struct*
_tmp934;const char*_tmp933;struct _tuple22*_tmp932;const char*_tmp931;const char*
_tmp930;struct Cyc_Arg_Unit_spec_struct _tmp92F;struct Cyc_Arg_Unit_spec_struct*
_tmp92E;const char*_tmp92D;struct _tuple22*_tmp92C;const char*_tmp92B;const char*
_tmp92A;struct Cyc_Arg_Unit_spec_struct _tmp929;struct Cyc_Arg_Unit_spec_struct*
_tmp928;const char*_tmp927;struct _tuple22*_tmp926;const char*_tmp925;const char*
_tmp924;struct Cyc_Arg_Unit_spec_struct _tmp923;struct Cyc_Arg_Unit_spec_struct*
_tmp922;const char*_tmp921;struct _tuple22*_tmp920;const char*_tmp91F;const char*
_tmp91E;struct Cyc_Arg_Unit_spec_struct _tmp91D;struct Cyc_Arg_Unit_spec_struct*
_tmp91C;const char*_tmp91B;struct _tuple22*_tmp91A;const char*_tmp919;const char*
_tmp918;struct Cyc_Arg_Unit_spec_struct _tmp917;struct Cyc_Arg_Unit_spec_struct*
_tmp916;const char*_tmp915;struct _tuple22*_tmp914;const char*_tmp913;const char*
_tmp912;struct Cyc_Arg_String_spec_struct _tmp911;struct Cyc_Arg_String_spec_struct*
_tmp910;const char*_tmp90F;struct _tuple22*_tmp90E;const char*_tmp90D;const char*
_tmp90C;struct Cyc_Arg_Unit_spec_struct _tmp90B;struct Cyc_Arg_Unit_spec_struct*
_tmp90A;const char*_tmp909;struct _tuple22*_tmp908;const char*_tmp907;const char*
_tmp906;struct Cyc_Arg_Unit_spec_struct _tmp905;struct Cyc_Arg_Unit_spec_struct*
_tmp904;const char*_tmp903;struct _tuple22*_tmp902;const char*_tmp901;const char*
_tmp900;struct Cyc_Arg_Set_spec_struct _tmp8FF;struct Cyc_Arg_Set_spec_struct*
_tmp8FE;const char*_tmp8FD;struct _tuple22*_tmp8FC;const char*_tmp8FB;const char*
_tmp8FA;struct Cyc_Arg_Set_spec_struct _tmp8F9;struct Cyc_Arg_Set_spec_struct*
_tmp8F8;const char*_tmp8F7;struct _tuple22*_tmp8F6;const char*_tmp8F5;const char*
_tmp8F4;struct Cyc_Arg_Set_spec_struct _tmp8F3;struct Cyc_Arg_Set_spec_struct*
_tmp8F2;const char*_tmp8F1;struct _tuple22*_tmp8F0;const char*_tmp8EF;const char*
_tmp8EE;struct Cyc_Arg_Set_spec_struct _tmp8ED;struct Cyc_Arg_Set_spec_struct*
_tmp8EC;const char*_tmp8EB;struct _tuple22*_tmp8EA;const char*_tmp8E9;const char*
_tmp8E8;struct Cyc_Arg_Set_spec_struct _tmp8E7;struct Cyc_Arg_Set_spec_struct*
_tmp8E6;const char*_tmp8E5;struct _tuple22*_tmp8E4;const char*_tmp8E3;const char*
_tmp8E2;struct Cyc_Arg_Set_spec_struct _tmp8E1;struct Cyc_Arg_Set_spec_struct*
_tmp8E0;const char*_tmp8DF;struct _tuple22*_tmp8DE;const char*_tmp8DD;const char*
_tmp8DC;struct Cyc_Arg_Set_spec_struct _tmp8DB;struct Cyc_Arg_Set_spec_struct*
_tmp8DA;const char*_tmp8D9;struct _tuple22*_tmp8D8;const char*_tmp8D7;const char*
_tmp8D6;struct Cyc_Arg_Set_spec_struct _tmp8D5;struct Cyc_Arg_Set_spec_struct*
_tmp8D4;const char*_tmp8D3;struct _tuple22*_tmp8D2;const char*_tmp8D1;const char*
_tmp8D0;struct Cyc_Arg_Set_spec_struct _tmp8CF;struct Cyc_Arg_Set_spec_struct*
_tmp8CE;const char*_tmp8CD;struct _tuple22*_tmp8CC;const char*_tmp8CB;const char*
_tmp8CA;struct Cyc_Arg_String_spec_struct _tmp8C9;struct Cyc_Arg_String_spec_struct*
_tmp8C8;const char*_tmp8C7;struct _tuple22*_tmp8C6;const char*_tmp8C5;const char*
_tmp8C4;struct Cyc_Arg_Set_spec_struct _tmp8C3;struct Cyc_Arg_Set_spec_struct*
_tmp8C2;const char*_tmp8C1;struct _tuple22*_tmp8C0;const char*_tmp8BF;const char*
_tmp8BE;struct Cyc_Arg_Set_spec_struct _tmp8BD;struct Cyc_Arg_Set_spec_struct*
_tmp8BC;const char*_tmp8BB;struct _tuple22*_tmp8BA;const char*_tmp8B9;const char*
_tmp8B8;struct Cyc_Arg_Set_spec_struct _tmp8B7;struct Cyc_Arg_Set_spec_struct*
_tmp8B6;const char*_tmp8B5;struct _tuple22*_tmp8B4;const char*_tmp8B3;const char*
_tmp8B2;struct Cyc_Arg_Set_spec_struct _tmp8B1;struct Cyc_Arg_Set_spec_struct*
_tmp8B0;const char*_tmp8AF;struct _tuple22*_tmp8AE;const char*_tmp8AD;const char*
_tmp8AC;struct Cyc_Arg_Clear_spec_struct _tmp8AB;struct Cyc_Arg_Clear_spec_struct*
_tmp8AA;const char*_tmp8A9;struct _tuple22*_tmp8A8;const char*_tmp8A7;const char*
_tmp8A6;struct Cyc_Arg_Unit_spec_struct _tmp8A5;struct Cyc_Arg_Unit_spec_struct*
_tmp8A4;const char*_tmp8A3;struct _tuple22*_tmp8A2;const char*_tmp8A1;const char*
_tmp8A0;struct Cyc_Arg_Set_spec_struct _tmp89F;struct Cyc_Arg_Set_spec_struct*
_tmp89E;const char*_tmp89D;struct _tuple22*_tmp89C;const char*_tmp89B;const char*
_tmp89A;struct Cyc_Arg_String_spec_struct _tmp899;struct Cyc_Arg_String_spec_struct*
_tmp898;const char*_tmp897;struct _tuple22*_tmp896;const char*_tmp895;const char*
_tmp894;struct Cyc_Arg_String_spec_struct _tmp893;struct Cyc_Arg_String_spec_struct*
_tmp892;const char*_tmp891;struct _tuple22*_tmp890;const char*_tmp88F;const char*
_tmp88E;struct Cyc_Arg_String_spec_struct _tmp88D;struct Cyc_Arg_String_spec_struct*
_tmp88C;const char*_tmp88B;struct _tuple22*_tmp88A;const char*_tmp889;const char*
_tmp888;struct Cyc_Arg_String_spec_struct _tmp887;struct Cyc_Arg_String_spec_struct*
_tmp886;const char*_tmp885;struct _tuple22*_tmp884;const char*_tmp883;const char*
_tmp882;struct Cyc_Arg_String_spec_struct _tmp881;struct Cyc_Arg_String_spec_struct*
_tmp880;const char*_tmp87F;struct _tuple22*_tmp87E[73];struct Cyc_List_List*options=(
...
_tmp880=_region_malloc(r,sizeof(*_tmp880)),((_tmp880[0]=((_tmp881.tag=5,((
...
_region_malloc(r,sizeof(*_tmp886)),((_tmp886[0]=((_tmp887.tag=5,((_tmp887.f1=Cyc_add_isystem,
...
_tmp88C=_region_malloc(r,sizeof(*_tmp88C)),((_tmp88C[0]=((_tmp88D.tag=5,((
...
_region_malloc(r,sizeof(*_tmp892)),((_tmp892[0]=((_tmp893.tag=5,((_tmp893.f1=Cyc_add_iwithprefix,
...
_region_malloc(r,sizeof(*_tmp898)),((_tmp898[0]=((_tmp899.tag=5,((_tmp899.f1=Cyc_add_iprefix,
...
_tmp87E,sizeof(struct _tuple22*),73)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
...
_tmp172;_LL35: {struct Cyc_Core_Not_found_struct*_tmp178=(struct Cyc_Core_Not_found_struct*)
_tmp177;if(_tmp178->tag != Cyc_Core_Not_found)goto _LL37;}_LL36: goto _LL34;_LL37:;
_LL38:(void)_throw(_tmp177);_LL34:;}};}if((struct _dyneither_ptr*)_tmp170.curr != (
...
_tuple18*_tmpA7C;if(!Cyc_Interface_is_subinterface(Cyc_Interface_empty(),(struct
...
_tmp383=_tmp36C;_LL3A:;_LL3B:{void*_tmp384=_tmp383;struct _dyneither_ptr _tmp386;
struct _dyneither_ptr _tmp388;struct _dyneither_ptr _tmp38B;_LL3F: {struct Cyc_Core_Failure_struct*
_tmp385=(struct Cyc_Core_Failure_struct*)_tmp384;if(_tmp385->tag != Cyc_Core_Failure)
goto _LL41;else{_tmp386=_tmp385->f1;}}_LL40:{const char*_tmpA85;void*_tmpA84[1];
...
sizeof(char),28))),_tag_dyneither(_tmpA84,sizeof(void*),1)))))));}goto _LL3E;
_LL41: {struct Cyc_Core_Impossible_struct*_tmp387=(struct Cyc_Core_Impossible_struct*)
_tmp384;if(_tmp387->tag != Cyc_Core_Impossible)goto _LL43;else{_tmp388=_tmp387->f1;}}
_LL42:{const char*_tmpA89;void*_tmpA88[1];struct Cyc_String_pa_struct _tmpA87;(
...
goto _LL3E;_LL43: {struct Cyc_Dict_Absent_struct*_tmp389=(struct Cyc_Dict_Absent_struct*)
_tmp384;if(_tmp389->tag != Cyc_Dict_Absent)goto _LL45;}_LL44:{const char*_tmpA8C;
...
goto _LL3E;_LL45: {struct Cyc_Core_Invalid_argument_struct*_tmp38A=(struct Cyc_Core_Invalid_argument_struct*)
_tmp384;if(_tmp38A->tag != Cyc_Core_Invalid_argument)goto _LL47;else{_tmp38B=
_tmp38A->f1;}}_LL46:{const char*_tmpA90;void*_tmpA8F[1];struct Cyc_String_pa_struct
...
goto _LL3E;_LL47:;_LL48:{const char*_tmpA93;void*_tmpA92;(_tmpA92=0,Cyc_fprintf(
Cyc_stderr,((_tmpA93="Uncaught exception\n",_tag_dyneither(_tmpA93,sizeof(char),
20))),_tag_dyneither(_tmpA92,sizeof(void*),0)));}goto _LL3E;_LL3E:;}Cyc_compile_failure=
1;Cyc_remove_cfiles();{int _tmp399=1;_npop_handler(0);return _tmp399;};_LL3C:;
_LL3D:(void)_throw(_tmp383);_LL39:;}};}{const char*_tmpA94;struct _dyneither_ptr
