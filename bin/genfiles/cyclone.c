...
# 149
typedef struct Cyc_Dict_Dict Cyc_CfFlowInfo_place_set_t;struct _union_FlowInfo_BottomFL{int tag;int val;};struct _tuple18{struct Cyc_Dict_Dict f1;struct Cyc_List_List*f2;};struct _union_FlowInfo_ReachableFL{int tag;struct _tuple18 val;};union Cyc_CfFlowInfo_FlowInfo{struct _union_FlowInfo_BottomFL BottomFL;struct _union_FlowInfo_ReachableFL ReachableFL;};
# 165 "cf_flowinfo.h"
...
# 53
struct Cyc_Interface_I*Cyc_Interface_extract(struct Cyc_Dict_Dict ae);struct _tuple19{struct _dyneither_ptr f1;struct _dyneither_ptr f2;};
# 61
int Cyc_Interface_is_subinterface(struct Cyc_Interface_I*i1,struct Cyc_Interface_I*i2,struct _tuple19*info);
# 76 "interface.h"
...
remove((const char*)_untag_dyneither_ptr(s,sizeof(char),1));}}struct _tuple20{struct _dyneither_ptr*f1;struct _dyneither_ptr*f2;};
# 356
...
if(c == '*'){
# 415
{struct _tuple20*_tmp443;struct _dyneither_ptr*_tmp442;const char*_tmp441;struct _dyneither_ptr*_tmp440;struct Cyc_List_List*_tmp43F;_tmp4B=((_tmp43F=_cycalloc(sizeof(*_tmp43F)),((_tmp43F->hd=((_tmp443=_cycalloc(sizeof(*_tmp443)),((_tmp443->f1=((_tmp442=_cycalloc(sizeof(*_tmp442)),((_tmp442[0]=(struct _dyneither_ptr)Cyc_strdup(_tag_dyneither(strname,sizeof(char),256)),_tmp442)))),((_tmp443->f2=(
...
Cyc_Lex_lex_init(1);
return _tmpA1;};}struct _tuple21{struct _RegionHandle*f1;struct Cyc_Tcenv_Tenv*f2;};
# 581
struct Cyc_List_List*Cyc_do_typecheck(struct _tuple21*tcenv,struct Cyc_List_List*tds){
# 583
struct _RegionHandle*_tmpA3;struct Cyc_Tcenv_Tenv*_tmpA4;struct _tuple21 _tmpA2=*tcenv;_tmpA3=_tmpA2.f1;_tmpA4=_tmpA2.f2;
...
struct Cyc_Tcenv_Tenv*_tmpA6;struct Cyc___cycFILE*_tmpA7;struct Cyc___cycFILE*_tmpA8;struct _tuple22*_tmpA5=params;_tmpA6=_tmpA5->f1;_tmpA7=_tmpA5->f2;_tmpA8=_tmpA5->f3;{
...
const char*_tmp480;const char*_tmp47F;struct _tuple19*_tmp47E;if(!Cyc_Interface_is_subinterface(_tmpAA,_tmpA9,((_tmp47E=_cycalloc(sizeof(*_tmp47E)),((_tmp47E->f1=((_tmp47F="written interface",_tag_dyneither(_tmp47F,sizeof(char),18))),((_tmp47E->f2=((_tmp480="maximal interface",_tag_dyneither(_tmp480,sizeof(char),18))),_tmp47E))))))))
...
# 978
struct _tuple21 _tmp509;struct _tuple21 _tmp126=(_tmp509.f1=tc_rgn,((_tmp509.f2=_tmp125,_tmp509)));
{const char*_tmp50A;tds=((struct Cyc_List_List*(*)(struct _dyneither_ptr stage_name,struct Cyc_List_List*(*f)(struct _tuple21*,struct Cyc_List_List*),struct _tuple21*env,struct Cyc_List_List*tds))Cyc_do_stage)(((_tmp50A="type checking",_tag_dyneither(_tmp50A,sizeof(char),14))),Cyc_do_typecheck,& _tmp126,tds);}
# 981
if(Cyc_compile_failure){
Cyc_remove_file((struct _dyneither_ptr)_tmpFC);
...
struct _tuple22 _tmp511;struct _tuple22 _tmp12C=(_tmp511.f1=_tmp125,((_tmp511.f2=inter_file,((_tmp511.f3=inter_objfile,_tmp511)))));
{const char*_tmp512;tds=((struct Cyc_List_List*(*)(struct _dyneither_ptr stage_name,struct Cyc_List_List*(*f)(struct _tuple22*,struct Cyc_List_List*),struct _tuple22*env,struct Cyc_List_List*tds))Cyc_do_stage)(((_tmp512="interface checking",_tag_dyneither(_tmp512,sizeof(char),19))),Cyc_do_interface,& _tmp12C,tds);}
if(inter_file != 0)
...
# 1150
struct _tuple23*_tmpA91;const char*_tmpA90;const char*_tmpA8F;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmpA8E;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmpA8D;const char*_tmpA8C;struct _tuple23*_tmpA8B;const char*_tmpA8A;const char*_tmpA89;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmpA88;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmpA87;const char*_tmpA86;struct _tuple23*_tmpA85;const char*_tmpA84;const char*_tmpA83;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmpA82;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmpA81;const char*_tmpA80;struct _tuple23*_tmpA7F;const char*_tmpA7E;const char*_tmpA7D;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA7C;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA7B;const char*_tmpA7A;struct _tuple23*_tmpA79;const char*_tmpA78;const char*_tmpA77;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA76;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA75;const char*_tmpA74;struct _tuple23*_tmpA73;const char*_tmpA72;const char*_tmpA71;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA70;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA6F;const char*_tmpA6E;struct _tuple23*_tmpA6D;const char*_tmpA6C;const char*_tmpA6B;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA6A;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA69;const char*_tmpA68;struct _tuple23*_tmpA67;const char*_tmpA66;const char*_tmpA65;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA64;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA63;const char*_tmpA62;struct _tuple23*_tmpA61;const char*_tmpA60;const char*_tmpA5F;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA5E;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA5D;const char*_tmpA5C;struct _tuple23*_tmpA5B;const char*_tmpA5A;const char*_tmpA59;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmpA58;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmpA57;const char*_tmpA56;struct _tuple23*_tmpA55;const char*_tmpA54;const char*_tmpA53;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmpA52;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmpA51;const char*_tmpA50;struct _tuple23*_tmpA4F;const char*_tmpA4E;const char*_tmpA4D;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA4C;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA4B;const char*_tmpA4A;struct _tuple23*_tmpA49;const char*_tmpA48;const char*_tmpA47;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA46;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA45;const char*_tmpA44;struct _tuple23*_tmpA43;const char*_tmpA42;const char*_tmpA41;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA40;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA3F;const char*_tmpA3E;struct _tuple23*_tmpA3D;const char*_tmpA3C;const char*_tmpA3B;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA3A;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA39;const char*_tmpA38;struct _tuple23*_tmpA37;const char*_tmpA36;const char*_tmpA35;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA34;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA33;const char*_tmpA32;struct _tuple23*_tmpA31;const char*_tmpA30;const char*_tmpA2F;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA2E;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA2D;const char*_tmpA2C;struct _tuple23*_tmpA2B;const char*_tmpA2A;const char*_tmpA29;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA28;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA27;const char*_tmpA26;struct _tuple23*_tmpA25;const char*_tmpA24;const char*_tmpA23;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA22;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA21;const char*_tmpA20;struct _tuple23*_tmpA1F;const char*_tmpA1E;const char*_tmpA1D;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmpA1C;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmpA1B;const char*_tmpA1A;struct _tuple23*_tmpA19;const char*_tmpA18;const char*_tmpA17;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmpA16;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmpA15;const char*_tmpA14;struct _tuple23*_tmpA13;const char*_tmpA12;const char*_tmpA11;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmpA10;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmpA0F;const char*_tmpA0E;struct _tuple23*_tmpA0D;const char*_tmpA0C;const char*_tmpA0B;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmpA0A;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmpA09;const char*_tmpA08;struct _tuple23*_tmpA07;const char*_tmpA06;const char*_tmpA05;struct Cyc_Arg_Flag_spec_Arg_Spec_struct _tmpA04;struct Cyc_Arg_Flag_spec_Arg_Spec_struct*_tmpA03;const char*_tmpA02;struct _tuple23*_tmpA01;const char*_tmpA00;const char*_tmp9FF;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp9FE;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp9FD;const char*_tmp9FC;struct _tuple23*_tmp9FB;const char*_tmp9FA;const char*_tmp9F9;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp9F8;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp9F7;const char*_tmp9F6;struct _tuple23*_tmp9F5;const char*_tmp9F4;const char*_tmp9F3;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp9F2;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp9F1;const char*_tmp9F0;struct _tuple23*_tmp9EF;const char*_tmp9EE;const char*_tmp9ED;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp9EC;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp9EB;const char*_tmp9EA;struct _tuple23*_tmp9E9;const char*_tmp9E8;const char*_tmp9E7;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp9E6;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp9E5;const char*_tmp9E4;struct _tuple23*_tmp9E3;const char*_tmp9E2;const char*_tmp9E1;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp9E0;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp9DF;const char*_tmp9DE;struct _tuple23*_tmp9DD;const char*_tmp9DC;const char*_tmp9DB;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp9DA;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp9D9;const char*_tmp9D8;struct _tuple23*_tmp9D7;const char*_tmp9D6;const char*_tmp9D5;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp9D4;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp9D3;const char*_tmp9D2;struct _tuple23*_tmp9D1;const char*_tmp9D0;const char*_tmp9CF;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp9CE;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp9CD;const char*_tmp9CC;struct _tuple23*_tmp9CB;const char*_tmp9CA;const char*_tmp9C9;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp9C8;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp9C7;const char*_tmp9C6;struct _tuple23*_tmp9C5;const char*_tmp9C4;const char*_tmp9C3;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp9C2;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp9C1;const char*_tmp9C0;struct _tuple23*_tmp9BF;const char*_tmp9BE;const char*_tmp9BD;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp9BC;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp9BB;const char*_tmp9BA;struct _tuple23*_tmp9B9;const char*_tmp9B8;const char*_tmp9B7;struct Cyc_Arg_Clear_spec_Arg_Spec_struct _tmp9B6;struct Cyc_Arg_Clear_spec_Arg_Spec_struct*_tmp9B5;const char*_tmp9B4;struct _tuple23*_tmp9B3;const char*_tmp9B2;const char*_tmp9B1;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp9B0;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp9AF;const char*_tmp9AE;struct _tuple23*_tmp9AD;const char*_tmp9AC;const char*_tmp9AB;struct Cyc_Arg_Clear_spec_Arg_Spec_struct _tmp9AA;struct Cyc_Arg_Clear_spec_Arg_Spec_struct*_tmp9A9;const char*_tmp9A8;struct _tuple23*_tmp9A7;const char*_tmp9A6;const char*_tmp9A5;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp9A4;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp9A3;const char*_tmp9A2;struct _tuple23*_tmp9A1;const char*_tmp9A0;const char*_tmp99F;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp99E;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp99D;const char*_tmp99C;struct _tuple23*_tmp99B;const char*_tmp99A;const char*_tmp999;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp998;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp997;const char*_tmp996;struct _tuple23*_tmp995;const char*_tmp994;const char*_tmp993;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp992;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp991;const char*_tmp990;struct _tuple23*_tmp98F;const char*_tmp98E;const char*_tmp98D;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp98C;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp98B;const char*_tmp98A;struct _tuple23*_tmp989;const char*_tmp988;const char*_tmp987;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp986;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp985;const char*_tmp984;struct _tuple23*_tmp983;const char*_tmp982;const char*_tmp981;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp980;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp97F;const char*_tmp97E;struct _tuple23*_tmp97D;const char*_tmp97C;const char*_tmp97B;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp97A;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp979;const char*_tmp978;struct _tuple23*_tmp977;const char*_tmp976;const char*_tmp975;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp974;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp973;const char*_tmp972;struct _tuple23*_tmp971;const char*_tmp970;const char*_tmp96F;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp96E;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp96D;const char*_tmp96C;struct _tuple23*_tmp96B;const char*_tmp96A;const char*_tmp969;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp968;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp967;const char*_tmp966;struct _tuple23*_tmp965;const char*_tmp964;const char*_tmp963;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp962;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp961;const char*_tmp960;struct _tuple23*_tmp95F;const char*_tmp95E;const char*_tmp95D;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp95C;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp95B;const char*_tmp95A;struct _tuple23*_tmp959;const char*_tmp958;const char*_tmp957;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp956;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp955;const char*_tmp954;struct _tuple23*_tmp953;const char*_tmp952;const char*_tmp951;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp950;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp94F;const char*_tmp94E;struct _tuple23*_tmp94D;const char*_tmp94C;const char*_tmp94B;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp94A;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp949;const char*_tmp948;struct _tuple23*_tmp947;const char*_tmp946;const char*_tmp945;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp944;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp943;const char*_tmp942;struct _tuple23*_tmp941;const char*_tmp940;const char*_tmp93F;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp93E;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp93D;const char*_tmp93C;struct _tuple23*_tmp93B;const char*_tmp93A;const char*_tmp939;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp938;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp937;const char*_tmp936;struct _tuple23*_tmp935;const char*_tmp934;const char*_tmp933;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp932;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp931;const char*_tmp930;struct _tuple23*_tmp92F;const char*_tmp92E;const char*_tmp92D;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp92C;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp92B;const char*_tmp92A;struct _tuple23*_tmp929;const char*_tmp928;const char*_tmp927;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp926;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp925;const char*_tmp924;struct _tuple23*_tmp923;const char*_tmp922;const char*_tmp921;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp920;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp91F;const char*_tmp91E;struct _tuple23*_tmp91D;const char*_tmp91C;const char*_tmp91B;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp91A;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp919;const char*_tmp918;struct _tuple23*_tmp917;const char*_tmp916;const char*_tmp915;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp914;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp913;const char*_tmp912;struct _tuple23*_tmp911;const char*_tmp910;const char*_tmp90F;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp90E;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp90D;const char*_tmp90C;struct _tuple23*_tmp90B;const char*_tmp90A;const char*_tmp909;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp908;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp907;const char*_tmp906;struct _tuple23*_tmp905;const char*_tmp904;const char*_tmp903;struct Cyc_Arg_Clear_spec_Arg_Spec_struct _tmp902;struct Cyc_Arg_Clear_spec_Arg_Spec_struct*_tmp901;const char*_tmp900;struct _tuple23*_tmp8FF;const char*_tmp8FE;const char*_tmp8FD;struct Cyc_Arg_Unit_spec_Arg_Spec_struct _tmp8FC;struct Cyc_Arg_Unit_spec_Arg_Spec_struct*_tmp8FB;const char*_tmp8FA;struct _tuple23*_tmp8F9;const char*_tmp8F8;const char*_tmp8F7;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp8F6;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp8F5;const char*_tmp8F4;struct _tuple23*_tmp8F3;const char*_tmp8F2;const char*_tmp8F1;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp8F0;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp8EF;const char*_tmp8EE;struct _tuple23*_tmp8ED;const char*_tmp8EC;const char*_tmp8EB;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp8EA;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp8E9;const char*_tmp8E8;struct _tuple23*_tmp8E7;const char*_tmp8E6;const char*_tmp8E5;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp8E4;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp8E3;const char*_tmp8E2;struct _tuple23*_tmp8E1;const char*_tmp8E0;const char*_tmp8DF;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp8DE;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp8DD;const char*_tmp8DC;struct _tuple23*_tmp8DB;const char*_tmp8DA;const char*_tmp8D9;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp8D8;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp8D7;const char*_tmp8D6;struct _tuple23*_tmp8D5;const char*_tmp8D4;const char*_tmp8D3;struct Cyc_Arg_Set_spec_Arg_Spec_struct _tmp8D2;struct Cyc_Arg_Set_spec_Arg_Spec_struct*_tmp8D1;const char*_tmp8D0;struct _tuple23*_tmp8CF;const char*_tmp8CE;const char*_tmp8CD;struct Cyc_Arg_String_spec_Arg_Spec_struct _tmp8CC;struct Cyc_Arg_String_spec_Arg_Spec_struct*_tmp8CB;const char*_tmp8CA;struct _tuple23*_tmp8C9[76];struct Cyc_List_List*options=
(_tmp8C9[75]=(
# 1378
...
(_tmpA8C="Print compilation stages verbosely",_tag_dyneither(_tmpA8C,sizeof(char),35))),_tmpA91)))))))))))),((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(r,_tag_dyneither(_tmp8C9,sizeof(struct _tuple23*),76)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
# 1383
...
# 1566
const char*_tmpADB;const char*_tmpADA;struct _tuple19*_tmpAD9;if(!Cyc_Interface_is_subinterface(Cyc_Interface_empty(),_tmp390,(
