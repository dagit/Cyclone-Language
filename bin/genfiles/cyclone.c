...
char*tag;};struct _dyneither_ptr Cstring_to_string(char*);static void* arrcast(
struct _dyneither_ptr dyn,unsigned int bd,unsigned int sz);inline static void* arrcast(
