...
# 1368
struct Cyc_Arg_Unit_spec_Arg_Spec_struct Cyc_opt89_spec={0,Cyc_set_infstats};static char _TmpG112[11U]="--infstats";static char _TmpG113[1U]="";static char _TmpG114[65U]="Dump statistics for the result of inference -- reads .cych/cvars";struct _tuple17 Cyc_opt89_tuple={.f0={_TmpG112,_TmpG112,_TmpG112 + 11U},.f1=0,.f2={_TmpG113,_TmpG113,_TmpG113 + 1U},.f3=(void*)& Cyc_opt89_spec,.f4={_TmpG114,_TmpG114,_TmpG114 + 65U}};struct Cyc_List_List Cyc_opt89={(void*)& Cyc_opt89_tuple,0};
# 1371
...
# 1408
{int i=1;for(0;(unsigned)i < 91U;++ i){
({struct Cyc_List_List*_Tmp0=*((struct Cyc_List_List**)_check_known_subscript_notnull(Cyc_global_options,91U,sizeof(struct Cyc_List_List*),i));(*((struct Cyc_List_List**)_check_known_subscript_notnull(Cyc_global_options,91U,sizeof(struct Cyc_List_List*),i - 1)))->tl=_Tmp0;});}}{
