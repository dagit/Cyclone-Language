...
if(c == '*'){
# 415
{struct _tuple21*_tmp438;struct _dyneither_ptr*_tmp437;const char*_tmp436;struct _dyneither_ptr*_tmp435;struct Cyc_List_List*_tmp434;_tmp4B=((_tmp434=_cycalloc(sizeof(*_tmp434)),((_tmp434->hd=((_tmp438=_cycalloc(sizeof(*_tmp438)),((_tmp438->f1=((_tmp437=_cycalloc(sizeof(*_tmp437)),((_tmp437[0]=(struct _dyneither_ptr)Cyc_strdup(_tag_dyneither(strname,sizeof(char),256)),_tmp437)))),((_tmp438->f2=(
# 416
...
Cyc_Lex_lex_init(1);
# 578
return _tmp9E;};}struct _tuple22{struct _RegionHandle*f1;struct Cyc_Tcenv_Tenv*f2;};
# 581
struct Cyc_List_List*Cyc_do_typecheck(struct _tuple22*tcenv,struct Cyc_List_List*tds){
# 583
struct _RegionHandle*_tmpA0;struct Cyc_Tcenv_Tenv*_tmpA1;struct _tuple22 _tmp9F=*tcenv;_tmpA0=_tmp9F.f1;_tmpA1=_tmp9F.f2;
# 584
...
# 598
struct _tuple23 _tmpA3;struct Cyc_Tcenv_Tenv*_tmpA4;struct Cyc___cycFILE*_tmpA5;struct Cyc___cycFILE*_tmpA6;struct _tuple23*_tmpA2=params;_tmpA3=*_tmpA2;_tmpA4=_tmpA3.f1;_tmpA5=_tmpA3.f2;_tmpA6=_tmpA3.f3;{
# 599
...
# 604
const char*_tmp475;const char*_tmp474;struct _tuple20*_tmp473;if(!Cyc_Interface_is_subinterface(_tmpA8,_tmpA7,((_tmp473=_cycalloc(sizeof(*_tmp473)),((_tmp473->f1=((_tmp474="written interface",_tag_dyneither(_tmp474,sizeof(char),18))),((_tmp473->f2=((_tmp475="maximal interface",_tag_dyneither(_tmp475,sizeof(char),18))),_tmp473))))))))
# 605
...
# 977
struct _tuple22 _tmp4FE;struct _tuple22 _tmp121=(_tmp4FE.f1=tc_rgn,((_tmp4FE.f2=_tmp120,_tmp4FE)));
# 978
{const char*_tmp4FF;tds=((struct Cyc_List_List*(*)(struct _dyneither_ptr stage_name,struct Cyc_List_List*(*f)(struct _tuple22*,struct Cyc_List_List*),struct _tuple22*env,struct Cyc_List_List*tds))Cyc_do_stage)(((_tmp4FF="type checking",_tag_dyneither(_tmp4FF,sizeof(char),14))),Cyc_do_typecheck,& _tmp121,tds);}
# 980
if(Cyc_compile_failure){
# 981
Cyc_remove_file((struct _dyneither_ptr)_tmpF9);
...
# 1012
struct _tuple23 _tmp506;struct _tuple23 _tmp127=(_tmp506.f1=_tmp120,((_tmp506.f2=inter_file,((_tmp506.f3=(struct Cyc___cycFILE*)inter_objfile,_tmp506)))));
# 1013
{const char*_tmp507;tds=((struct Cyc_List_List*(*)(struct _dyneither_ptr stage_name,struct Cyc_List_List*(*f)(struct _tuple23*,struct Cyc_List_List*),struct _tuple23*env,struct Cyc_List_List*tds))Cyc_do_stage)(((_tmp507="interface checking",_tag_dyneither(_tmp507,sizeof(char),19))),Cyc_do_interface,& _tmp127,tds);}
# 1014
if(inter_file != 0)
# 1015
...
# 1152
(_tmpA81="Print compilation stages verbosely",_tag_dyneither(_tmpA81,sizeof(char),35))),_tmpA86)))))))))))),((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _dyneither_ptr))Cyc_List_rlist)(r,_tag_dyneither(_tmp8BE,sizeof(struct _tuple24*),76)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
# 1382
...
# 1565
const char*_tmpAD0;const char*_tmpACF;struct _tuple20*_tmpACE;if(!Cyc_Interface_is_subinterface(Cyc_Interface_empty(),(struct Cyc_Interface_I*)_tmp387,(
# 1566
