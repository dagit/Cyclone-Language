...
_tmp3B5=_cycalloc(sizeof(*_tmp3B5)),((_tmp3B5->hd=((_tmp3B6=_cycalloc(sizeof(*
_tmp3B6)),((_tmp3B6[0]=s,_tmp3B6)))),((_tmp3B5->tl=Cyc_ccargs,_tmp3B5))))));}
void Cyc_set_c_compiler(struct _dyneither_ptr s){const char*_tmp3B7;if(Cyc_strcmp((
struct _dyneither_ptr)s,((_tmp3B7="vc",_tag_dyneither(_tmp3B7,sizeof(char),3))))
== 0){Cyc_Cyclone_c_compiler=Cyc_Cyclone_Vc_c;{const char*_tmp3B8;Cyc_add_ccarg(((
_tmp3B8="-DVC_C",_tag_dyneither(_tmp3B8,sizeof(char),7))));};}else{const char*
_tmp3B9;if(Cyc_strcmp((struct _dyneither_ptr)s,((_tmp3B9="gcc",_tag_dyneither(
_tmp3B9,sizeof(char),4))))== 0){Cyc_Cyclone_c_compiler=Cyc_Cyclone_Gcc_c;{const
char*_tmp3BA;Cyc_add_ccarg(((_tmp3BA="-DGCC_C",_tag_dyneither(_tmp3BA,sizeof(
...
_tmp3BB;Cyc_output_file=((_tmp3BB=_cycalloc(sizeof(*_tmp3BB)),((_tmp3BB[0]=s,
_tmp3BB))));}extern char*Cdef_inc_path;extern char*Cdef_lib_path;extern char*Carch;
...
Cyc_add_cpparg(struct _dyneither_ptr s){struct _dyneither_ptr*_tmp3BE;struct Cyc_List_List*
_tmp3BD;Cyc_cppargs=((_tmp3BD=_cycalloc(sizeof(*_tmp3BD)),((_tmp3BD->hd=((
_tmp3BE=_cycalloc(sizeof(*_tmp3BE)),((_tmp3BE[0]=s,_tmp3BE)))),((_tmp3BD->tl=Cyc_cppargs,
_tmp3BD))))));}static void Cyc_add_iprefix(struct _dyneither_ptr s){const char*
_tmp3C2;void*_tmp3C1[1];struct Cyc_String_pa_struct _tmp3C0;Cyc_add_cpparg((struct
_dyneither_ptr)((_tmp3C0.tag=0,((_tmp3C0.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)s),((_tmp3C1[0]=& _tmp3C0,Cyc_aprintf(((_tmp3C2="-iprefix %s",
_tag_dyneither(_tmp3C2,sizeof(char),12))),_tag_dyneither(_tmp3C1,sizeof(void*),1)))))))));}
static void Cyc_add_iwithprefix(struct _dyneither_ptr s){const char*_tmp3C6;void*
_tmp3C5[1];struct Cyc_String_pa_struct _tmp3C4;Cyc_add_cpparg((struct
_dyneither_ptr)((_tmp3C4.tag=0,((_tmp3C4.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)s),((_tmp3C5[0]=& _tmp3C4,Cyc_aprintf(((_tmp3C6="-iwithprefix %s",
_tag_dyneither(_tmp3C6,sizeof(char),16))),_tag_dyneither(_tmp3C5,sizeof(void*),1)))))))));}
static void Cyc_add_iwithprefixbefore(struct _dyneither_ptr s){const char*_tmp3CA;
void*_tmp3C9[1];struct Cyc_String_pa_struct _tmp3C8;Cyc_add_cpparg((struct
_dyneither_ptr)((_tmp3C8.tag=0,((_tmp3C8.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)s),((_tmp3C9[0]=& _tmp3C8,Cyc_aprintf(((_tmp3CA="-iwithprefixbefore %s",
_tag_dyneither(_tmp3CA,sizeof(char),22))),_tag_dyneither(_tmp3C9,sizeof(void*),1)))))))));}
static void Cyc_add_isystem(struct _dyneither_ptr s){const char*_tmp3CE;void*_tmp3CD[
1];struct Cyc_String_pa_struct _tmp3CC;Cyc_add_cpparg((struct _dyneither_ptr)((
_tmp3CC.tag=0,((_tmp3CC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s),((
_tmp3CD[0]=& _tmp3CC,Cyc_aprintf(((_tmp3CE="-isystem %s",_tag_dyneither(_tmp3CE,
sizeof(char),12))),_tag_dyneither(_tmp3CD,sizeof(void*),1)))))))));}static void
Cyc_add_idirafter(struct _dyneither_ptr s){const char*_tmp3D2;void*_tmp3D1[1];
struct Cyc_String_pa_struct _tmp3D0;Cyc_add_cpparg((struct _dyneither_ptr)((_tmp3D0.tag=
0,((_tmp3D0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s),((_tmp3D1[0]=&
_tmp3D0,Cyc_aprintf(((_tmp3D2="-idirafter %s",_tag_dyneither(_tmp3D2,sizeof(char),
14))),_tag_dyneither(_tmp3D1,sizeof(void*),1)))))))));}static struct
...
s;}static void Cyc_print_version(){{const char*_tmp3D6;void*_tmp3D5[1];struct Cyc_String_pa_struct
_tmp3D4;(_tmp3D4.tag=0,((_tmp3D4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cstring_to_string(Cversion)),((_tmp3D5[0]=& _tmp3D4,Cyc_printf(((_tmp3D6="The Cyclone compiler, version %s\n",
