...
# 100 "cycboot.h"
extern int Cyc_fprintf(struct Cyc___cycFILE*,struct _fat_ptr,struct _fat_ptr);extern char Cyc_FileCloseError[15U];extern char Cyc_FileOpenError[14U];struct Cyc_Set_Set;
# 51 "set.h"
...
# 137
extern void*Cyc_Set_choose(struct Cyc_Set_Set*);struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(void*,void*);struct _RegionHandle*r;const struct Cyc_Dict_T*t;};extern char Cyc_Dict_Present[8U];extern char Cyc_Dict_Absent[7U];
# 62 "dict.h"
...
return({struct Cyc_Dict_Dict(*_tmp98)(struct Cyc_Dict_Dict,void*,struct Cyc_Set_Set*)=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,struct Cyc_Set_Set*))Cyc_Dict_insert;});struct Cyc_Dict_Dict _tmp97=g;void*_tmp96=source;_tmp98(_tmp97,_tmp96,Cyc_Set_empty(g.rel));});}}
# 53
...
return({struct Cyc_Dict_Dict(*_tmp9B)(struct Cyc_Dict_Dict,void*,struct Cyc_Set_Set*)=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,struct Cyc_Set_Set*))Cyc_Dict_insert;});struct Cyc_Dict_Dict _tmp9A=g;void*_tmp99=source;_tmp9B(_tmp9A,_tmp99,Cyc_Set_insert(sourceTargets,target));});}
# 61
...
return({struct Cyc_Dict_Dict(*_tmp9E)(struct Cyc_Dict_Dict,void*,struct Cyc_Set_Set*)=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,struct Cyc_Set_Set*))Cyc_Dict_insert;});struct Cyc_Dict_Dict _tmp9D=g;void*_tmp9C=source;_tmp9E(_tmp9D,_tmp9C,Cyc_Set_union_two(sourceTargets,targets));});}
# 69
...
return({struct Cyc_Dict_Dict(*_tmpA1)(struct Cyc_Dict_Dict,void*,struct Cyc_Set_Set*)=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,struct Cyc_Set_Set*))Cyc_Dict_insert;});struct Cyc_Dict_Dict _tmpA0=g;void*_tmp9F=source;_tmpA1(_tmpA0,_tmp9F,Cyc_Set_delete(sourceTargets,target));});}
# 77
...
return({struct Cyc_Dict_Dict(*_tmpA4)(struct Cyc_Dict_Dict,void*,struct Cyc_Set_Set*)=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,struct Cyc_Set_Set*))Cyc_Dict_insert;});struct Cyc_Dict_Dict _tmpA3=g;void*_tmpA2=source;_tmpA4(_tmpA3,_tmpA2,Cyc_Set_diff(sourceTargets,targets));});}
# 86
...
({void*_tmpD=0U;({struct Cyc___cycFILE*_tmpA6=f;struct _fat_ptr _tmpA5=({const char*_tmpE="digraph {\n";_tag_fat(_tmpE,sizeof(char),11U);});Cyc_fprintf(_tmpA6,_tmpA5,_tag_fat(_tmpD,sizeof(void*),0));});});{
...
nodeprint(f,s);
({void*_tmp15=0U;({struct Cyc___cycFILE*_tmpA8=f;struct _fat_ptr _tmpA7=({const char*_tmp16=" -> ";_tag_fat(_tmp16,sizeof(char),5U);});Cyc_fprintf(_tmpA8,_tmpA7,_tag_fat(_tmp15,sizeof(void*),0));});});
nodeprint(f,tslist->hd);
({void*_tmp17=0U;({struct Cyc___cycFILE*_tmpAA=f;struct _fat_ptr _tmpA9=({const char*_tmp18=";\n";_tag_fat(_tmp18,sizeof(char),3U);});Cyc_fprintf(_tmpAA,_tmpA9,_tag_fat(_tmp17,sizeof(void*),0));});});}else{
# 126
({void*_tmp19=0U;({struct Cyc___cycFILE*_tmpAC=f;struct _fat_ptr _tmpAB=({const char*_tmp1A="node ";_tag_fat(_tmp1A,sizeof(char),6U);});Cyc_fprintf(_tmpAC,_tmpAB,_tag_fat(_tmp19,sizeof(void*),0));});});
nodeprint(f,s);
({void*_tmp1B=0U;({struct Cyc___cycFILE*_tmpAE=f;struct _fat_ptr _tmpAD=({const char*_tmp1C="; // no targets\n";_tag_fat(_tmp1C,sizeof(char),17U);});Cyc_fprintf(_tmpAE,_tmpAD,_tag_fat(_tmp1B,sizeof(void*),0));});});}}}
# 131
({void*_tmp1D=0U;({struct Cyc___cycFILE*_tmpB0=f;struct _fat_ptr _tmpAF=({const char*_tmp1E="}\n";_tag_fat(_tmp1E,sizeof(char),3U);});Cyc_fprintf(_tmpB0,_tmpAF,_tag_fat(_tmp1D,sizeof(void*),0));});});}}
# 141 "graph.cyc"
...
return({struct _tuple1 _tmp94;({struct Cyc_Set_Set*_tmpB1=Cyc_Set_empty(g.rel);_tmp94.f1=_tmpB1;}),_tmp94.f2=g;_tmp94;});else{_tmp28=*_tmp27;{struct Cyc_Set_Set*sourceTargets=_tmp28;
return({struct _tuple1 _tmp95;_tmp95.f1=sourceTargets,({struct Cyc_Dict_Dict _tmpB2=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*))Cyc_Dict_delete;})(g,source);_tmp95.f2=_tmpB2;});_tmp95;});}};}
# 169
...
struct Cyc_Set_Set*_tmp2F=({struct Cyc_Set_Set*_tmpB3=Cyc_Set_union_two(sourceTargets,targetTargets);Cyc_Set_insert(_tmpB3,target);});struct Cyc_Set_Set*newSourceTargets=_tmp2F;
...
({struct Cyc_Set_Set*_tmpB4=Cyc_Set_insert(ts->visited,v);ts->visited=_tmpB4;});{
...
({struct Cyc_Dict_Dict _tmpB5=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,struct Cyc_Graph_nodestate*))Cyc_Dict_insert;})(ts->ns,v,nsv);ts->ns=_tmpB5;});
({struct Cyc_List_List*_tmpB6=({struct Cyc_List_List*_tmp45=_cycalloc(sizeof(*_tmp45));_tmp45->hd=v,_tmp45->tl=ts->nstack;_tmp45;});ts->nstack=_tmpB6;});{
...
# 271
if(!is_forward_edge)
({struct Cyc_List_List*_tmpB7=({struct Cyc_List_List*_tmp4C=_cycalloc(sizeof(*_tmp4C));_tmp4C->hd=(void*)Cw,_tmp4C->tl=ts->cstack;_tmp4C;});ts->cstack=_tmpB7;});}}}}
# 274
if(cmp(nsv->root,v)!= 0)
return;{
# 277
int _tmp4D=ts->Cindex ++;int Cnew=_tmp4D;
struct Cyc_Graph_componentstate*_tmp4E=({struct Cyc_Graph_componentstate*_tmp57=_cycalloc(sizeof(*_tmp57));({struct Cyc_Set_Set*_tmpB9=({(struct Cyc_Set_Set*(*)(int(*)(int,int)))Cyc_Set_empty;})(Cyc_Core_intcmp);_tmp57->Succ=_tmpB9;}),({
struct Cyc_Set_Set*_tmpB8=Cyc_Set_empty(cmp);_tmp57->nodes=_tmpB8;});_tmp57;});
# 278
struct Cyc_Graph_componentstate*csCnew=_tmp4E;
# 280
({struct Cyc_Dict_Dict _tmpBA=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,int,struct Cyc_Graph_componentstate*))Cyc_Dict_insert;})(ts->cs,Cnew,csCnew);ts->cs=_tmpBA;});
...
({struct Cyc_Set_Set*_tmpBB=({(struct Cyc_Set_Set*(*)(struct Cyc_Set_Set*,int))Cyc_Set_insert;})(csCnew->Succ,Cnew);csCnew->Succ=_tmpBB;});
# 288
goto _LL0;}}_LL0:;}
# 290
...
({
struct Cyc_Set_Set*_tmpC1=Cyc_Set_empty(cmp);_tmp68->visited=_tmpC1;}),_tmp68->visitindex=1,({
# 314
struct Cyc_Dict_Dict _tmpC0=({(struct Cyc_Dict_Dict(*)(int(*)(void*,void*)))Cyc_Dict_empty;})(cmp);_tmp68->ns=_tmpC0;}),({
struct Cyc_Dict_Dict _tmpBF=({(struct Cyc_Dict_Dict(*)(int(*)(int,int)))Cyc_Dict_empty;})(Cyc_Core_intcmp);_tmp68->cs=_tmpBF;}),_tmp68->Cindex=1,_tmp68->nstack=0,_tmp68->cstack=0;_tmp68;});
# 310
...
targets=({struct Cyc_Set_Set*_tmpC2=targets;Cyc_Set_union_two(_tmpC2,(
...
# 360
({struct Cyc_List_List*_tmpC3=({struct Cyc_List_List*_tmp69=_cycalloc(sizeof(*_tmp69));_tmp69->hd=x,_tmp69->tl=*S;_tmp69;});*S=_tmpC3;});
({struct Cyc_Dict_Dict _tmpC4=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,unsigned))Cyc_Dict_insert;})(*N,x,k);*N=_tmpC4;});
...
if(({unsigned _tmpC5=Ny;_tmpC5 < ({(unsigned(*)(struct Cyc_Dict_Dict,void*))Cyc_Dict_lookup;})(*N,x);}))
({struct Cyc_Dict_Dict _tmpC6=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,unsigned))Cyc_Dict_insert;})(*N,x,Ny);*N=_tmpC6;});}}}
# 371
if(({unsigned _tmpC7=({(unsigned(*)(struct Cyc_Dict_Dict,void*))Cyc_Dict_lookup;})(*N,x);_tmpC7 == k;})){
...
# 414
({struct Cyc_List_List*_tmpCB=({struct Cyc_List_List*_tmp7E=_cycalloc(sizeof(*_tmp7E));_tmp7E->hd=x,_tmp7E->tl=*S;_tmp7E;});*S=_tmpCB;});
({struct Cyc_Dict_Dict _tmpCC=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,unsigned))Cyc_Dict_insert;})(*N,x,k);*N=_tmpCC;});
...
if(({unsigned _tmpCD=Ny;_tmpCD < ({(unsigned(*)(struct Cyc_Dict_Dict,void*))Cyc_Dict_lookup;})(*N,x);}))
({struct Cyc_Dict_Dict _tmpCE=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,void*,unsigned))Cyc_Dict_insert;})(*N,x,Ny);*N=_tmpCE;});}}}
# 425
if(({unsigned _tmpCF=({(unsigned(*)(struct Cyc_Dict_Dict,void*))Cyc_Dict_lookup;})(*N,x);_tmpCF == k;})){
