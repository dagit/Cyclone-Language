...
struct Cyc_Set_Set**_tmp0=((struct Cyc_Set_Set**(*)(struct Cyc_Dict_Dict,void*))Cyc_Dict_lookup_opt)(g,source);struct Cyc_Set_Set**_stmttmp0=_tmp0;struct Cyc_Set_Set**_tmp1=_stmttmp0;struct Cyc_Set_Set*_tmp2;if(_tmp1 == 0){_LL1: _LL2:
...
struct Cyc_Set_Set**_tmpA=((struct Cyc_Set_Set**(*)(struct Cyc_Dict_Dict,void*))Cyc_Dict_lookup_opt)(g,source);struct Cyc_Set_Set**_stmttmp1=_tmpA;struct Cyc_Set_Set**_tmpB=_stmttmp1;struct Cyc_Set_Set*_tmpC;if(_tmpB == 0){_LL1: _LL2:
# 103
...
# 160
struct Cyc_Set_Set**_tmp26=((struct Cyc_Set_Set**(*)(struct Cyc_Dict_Dict,void*))Cyc_Dict_lookup_opt)(g,source);struct Cyc_Set_Set**_stmttmp4=_tmp26;struct Cyc_Set_Set**_tmp27=_stmttmp4;struct Cyc_Set_Set*_tmp28;if(_tmp27 == 0){_LL1: _LL2:
