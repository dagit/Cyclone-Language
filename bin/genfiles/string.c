...
# 310 "/home/jgm/cyclone/include/cycboot.h"
int toupper(int);
# 89 "core.h"
...
# 35 "/home/jgm/cyclone/include/string.h"
...
# 63
struct _dyneither_ptr Cyc_rstrconcat(struct _RegionHandle*,struct _dyneither_ptr,
struct _dyneither_ptr);
# 64
...
# 67
struct _dyneither_ptr Cyc_rstr_sepstr(struct _RegionHandle*,struct Cyc_List_List*,
struct _dyneither_ptr);
# 71
...
unsigned int sz);
# 98 "/home/jgm/cyclone/include/string.h"
struct _dyneither_ptr Cyc_expand(struct _dyneither_ptr s,unsigned long sz);
# 99
struct _dyneither_ptr Cyc_rexpand(struct _RegionHandle*,struct _dyneither_ptr s,
unsigned long sz);
# 100
struct _dyneither_ptr Cyc_realloc_str(struct _dyneither_ptr str,unsigned long sz);
# 101
struct _dyneither_ptr Cyc_rrealloc_str(struct _RegionHandle*r,struct _dyneither_ptr
str,unsigned long sz);
# 102
...
# 108
struct _dyneither_ptr Cyc_rsubstring(struct _RegionHandle*,struct _dyneither_ptr,
int ofs,unsigned long n);
# 112
struct _dyneither_ptr Cyc_replace_suffix(struct _dyneither_ptr,struct
...
# 122
struct _dyneither_ptr Cyc_mstrstr(struct _dyneither_ptr haystack,struct
_dyneither_ptr needle);
# 123
struct _dyneither_ptr Cyc_strstr(struct _dyneither_ptr haystack,struct
_dyneither_ptr needle);
# 124
struct _dyneither_ptr Cyc_strpbrk(struct _dyneither_ptr s,struct _dyneither_ptr
accept);
# 125
...
# 25 "/home/jgm/cyclone/include/strings.h"
int Cyc_strcasecmp(struct _dyneither_ptr,struct _dyneither_ptr);
# 26
int Cyc_strncasecmp(struct _dyneither_ptr s1,struct _dyneither_ptr s2,unsigned long
len);
# 29 "/home/jgm/cyclone/include/assert.h"
void*Cyc___assert_fail(struct _dyneither_ptr assertion,struct _dyneither_ptr file,
unsigned int line);
# 36 "/home/jgm/cyclone/lib/string.cyc"
char*strerror(int errnum);
# 39
unsigned long Cyc_strlen(struct _dyneither_ptr s){
# 40
...
# 59
{const char*_tmp80;const char*_tmp7F;minsz <= _get_dyneither_size(s1,sizeof(char))
 && minsz <= _get_dyneither_size(s2,sizeof(char))?0:((int(*)(struct _dyneither_ptr
assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(((_tmp7F="minsz <= numelts(s1) && minsz <= numelts(s2)",
_tag_dyneither(_tmp7F,sizeof(char),45))),((_tmp80="string.cyc",_tag_dyneither(
_tmp80,sizeof(char),11))),59);}
# 60
while(i < minsz){
# 61
...
if(minsz < sz2){
# 75
if(*((const char*)_check_dyneither_subscript(s2,sizeof(char),i))== '\000')return
0;else{
# 76
return - 1;}}else{
# 78
if(*((const char*)_check_dyneither_subscript(s1,sizeof(char),i))== '\000')return
0;else{
# 79
return 1;}}};}
# 83
...
# 87
inline static int Cyc_ncmp(struct _dyneither_ptr s1,unsigned long len1,struct
_dyneither_ptr s2,unsigned long len2,unsigned long n){
# 90
if(n <= 0)return 0;{
# 92
...
# 95
{const char*_tmp82;const char*_tmp81;bound <= _get_dyneither_size(s1,sizeof(char))
 && bound <= _get_dyneither_size(s2,sizeof(char))?0:((int(*)(struct _dyneither_ptr
assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(((_tmp81="bound <= numelts(s1) && bound <= numelts(s2)",
_tag_dyneither(_tmp81,sizeof(char),45))),((_tmp82="string.cyc",_tag_dyneither(
_tmp82,sizeof(char),11))),95);}
# 97
...
int i=- 1;
# 127
{const char*_tmp84;const char*_tmp83;min_length <= _get_dyneither_size(a,sizeof(
char)) && min_length <= _get_dyneither_size(b,sizeof(char))?0:((int(*)(struct
...
# 145
{const char*_tmp86;const char*_tmp85;bound <= _get_dyneither_size(s1,sizeof(char))
 && bound <= _get_dyneither_size(s2,sizeof(char))?0:((int(*)(struct _dyneither_ptr
...
# 172
inline static struct _dyneither_ptr Cyc_int_strcato(struct _dyneither_ptr dest,struct
_dyneither_ptr src){
# 173
int i;
# 174
...
if(slen + dlen <= dsize){
# 181
{const char*_tmp88;const char*_tmp87;slen <= _get_dyneither_size(src,sizeof(char))?
0:((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int
line))Cyc___assert_fail)(((_tmp87="slen <= numelts(src)",_tag_dyneither(_tmp87,
sizeof(char),21))),((_tmp88="string.cyc",_tag_dyneither(_tmp88,sizeof(char),11))),
181);}
# 182
for(i=0;i < slen;++ i){
# 183
char _tmp8B;char _tmp8A;struct _dyneither_ptr _tmp89;(_tmp89=_dyneither_ptr_plus(
dest,sizeof(char),(int)(i + dlen)),((_tmp8A=*((char*)_check_dyneither_subscript(
_tmp89,sizeof(char),0)),((_tmp8B=((const char*)src.curr)[i],((_get_dyneither_size(
_tmp89,sizeof(char))== 1  && (_tmp8A == '\000'  && _tmp8B != '\000')?
_throw_arraybounds(): 1,*((char*)_tmp89.curr)=_tmp8B)))))));}
# 185
if(i != dsize){
# 186
char _tmp8E;char _tmp8D;struct _dyneither_ptr _tmp8C;(_tmp8C=_dyneither_ptr_plus(
dest,sizeof(char),(int)(i + dlen)),((_tmp8D=*((char*)_check_dyneither_subscript(
_tmp8C,sizeof(char),0)),((_tmp8E='\000',((_get_dyneither_size(_tmp8C,sizeof(char))
== 1  && (_tmp8D == '\000'  && _tmp8E != '\000')?_throw_arraybounds(): 1,*((char*)
_tmp8C.curr)=_tmp8E)))))));}}else{
# 189
struct Cyc_Core_Invalid_argument_exn_struct _tmp94;const char*_tmp93;struct Cyc_Core_Invalid_argument_exn_struct*
_tmp92;(int)_throw((void*)((_tmp92=_cycalloc(sizeof(*_tmp92)),((_tmp92[0]=((
_tmp94.tag=Cyc_Core_Invalid_argument,((_tmp94.f1=((_tmp93="strcat",
_tag_dyneither(_tmp93,sizeof(char),7))),_tmp94)))),_tmp92)))));}
# 190
return dest;}
# 195
struct _dyneither_ptr Cyc_strcat(struct _dyneither_ptr dest,struct _dyneither_ptr src){
...
_tmp96,sizeof(char),11))),205);}
# 206
for(i=0;i < _tmp13;++ i){char _tmp99;char _tmp98;struct _dyneither_ptr _tmp97;(_tmp97=
_dyneither_ptr_plus(ans,sizeof(char),i),((_tmp98=*((char*)
_check_dyneither_subscript(_tmp97,sizeof(char),0)),((_tmp99=((const char*)a.curr)[
i],((_get_dyneither_size(_tmp97,sizeof(char))== 1  && (_tmp98 == '\000'  && _tmp99
!= '\000')?_throw_arraybounds(): 1,*((char*)_tmp97.curr)=_tmp99)))))));}
# 207
{const char*_tmp9B;const char*_tmp9A;_tmp14 <= _get_dyneither_size(b,sizeof(char))?
0:((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int
line))Cyc___assert_fail)(((_tmp9A="blen <= numelts(b)",_tag_dyneither(_tmp9A,
sizeof(char),19))),((_tmp9B="string.cyc",_tag_dyneither(_tmp9B,sizeof(char),11))),
207);}
# 208
for(j=0;j < _tmp14;++ j){char _tmp9E;char _tmp9D;struct _dyneither_ptr _tmp9C;(_tmp9C=
_dyneither_ptr_plus(ans,sizeof(char),i + j),((_tmp9D=*((char*)
_check_dyneither_subscript(_tmp9C,sizeof(char),0)),((_tmp9E=((const char*)b.curr)[
j],((_get_dyneither_size(_tmp9C,sizeof(char))== 1  && (_tmp9D == '\000'  && _tmp9E
!= '\000')?_throw_arraybounds(): 1,*((char*)_tmp9C.curr)=_tmp9E)))))));}
# 209
return ans;}
# 212
...
# 222
struct _RegionHandle _tmp1F=_new_region("temp");struct _RegionHandle*temp=& _tmp1F;
_push_region(temp);{
# 223
struct Cyc_List_List*_tmp9F;struct Cyc_List_List*lens=
# 224
(_tmp9F=_region_malloc(temp,sizeof(*_tmp9F)),((_tmp9F->hd=(void*)((
unsigned long)0),((_tmp9F->tl=0,_tmp9F)))));
# 226
...
total_len +=len;
# 230
{struct Cyc_List_List*_tmpA0;((struct Cyc_List_List*)_check_null(end))->tl=((
_tmpA0=_region_malloc(temp,sizeof(*_tmpA0)),((_tmpA0->hd=(void*)len,((_tmpA0->tl=
0,_tmpA0))))));}
# 231
end=end->tl;}}
# 233
...
int)i),sizeof(char),1),(struct _dyneither_ptr)_tmp21,len);
# 240
i +=len;
# 241
strs=strs->tl;
...
strs,struct _dyneither_ptr separator){
# 255
if(strs == 0)return Cyc_Core_rnew_string(r,0);
# 256
if(strs->tl == 0)return Cyc_rstrdup(r,(struct _dyneither_ptr)*((struct
_dyneither_ptr*)strs->hd));{
# 257
struct Cyc_List_List*_tmp24=strs;
# 258
struct _RegionHandle _tmp25=_new_region("temp");struct _RegionHandle*temp=& _tmp25;
_push_region(temp);
# 259
{struct Cyc_List_List*_tmpA1;struct Cyc_List_List*lens=(_tmpA1=_region_malloc(
temp,sizeof(*_tmpA1)),((_tmpA1->hd=(void*)((unsigned long)0),((_tmpA1->tl=0,
_tmpA1)))));
# 260
struct Cyc_List_List*end=lens;
# 261
...
total_len +=len;
# 267
{struct Cyc_List_List*_tmpA2;((struct Cyc_List_List*)_check_null(end))->tl=((
_tmpA2=_region_malloc(temp,sizeof(*_tmpA2)),((_tmpA2->hd=(void*)len,((_tmpA2->tl=
0,_tmpA2))))));}
# 268
end=end->tl;
# 269
...
# 279
Cyc_strncpy(_dyneither_ptr_decrease_size(_dyneither_ptr_plus(ans,sizeof(char),(
int)i),sizeof(char),1),(struct _dyneither_ptr)_tmp27,len);
# 280
i +=len;
# 281
Cyc_strncpy(_dyneither_ptr_decrease_size(_dyneither_ptr_plus(ans,sizeof(char),(
int)i),sizeof(char),1),separator,seplen);
# 282
i +=seplen;
# 283
strs=strs->tl;
...
unsigned long)((struct Cyc_List_List*)_check_null(lens))->hd);{
# 287
struct _dyneither_ptr _tmp28=ans;_npop_handler(0);return _tmp28;};};};}
# 259
;_pop_region(temp);};}
# 291
struct _dyneither_ptr Cyc_str_sepstr(struct Cyc_List_List*strs,struct
_dyneither_ptr separator){
# 292
return Cyc_rstr_sepstr(Cyc_Core_heap_region,strs,separator);}
# 296
struct _dyneither_ptr Cyc_strncpy(struct _dyneither_ptr dest,struct _dyneither_ptr
src,unsigned long n){
# 297
int i;
# 298
{const char*_tmpA4;const char*_tmpA3;n <= _get_dyneither_size(src,sizeof(char))
 && n <= _get_dyneither_size(dest,sizeof(char))?0:((int(*)(struct _dyneither_ptr
assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(((_tmpA3="n <= numelts(src) && n <= numelts(dest)",
_tag_dyneither(_tmpA3,sizeof(char),40))),((_tmpA4="string.cyc",_tag_dyneither(
_tmpA4,sizeof(char),11))),298);}
# 299
for(i=0;i < n;++ i){
# 300
...
return dest;}
# 311
struct _dyneither_ptr Cyc_zstrncpy(struct _dyneither_ptr dest,struct _dyneither_ptr
src,unsigned long n){
# 312
...
# 326
{char _tmpA9;char _tmpA8;struct _dyneither_ptr _tmpA7;(_tmpA7=_dyneither_ptr_plus(
...
# 334
char _tmpAC;char _tmpAB;struct _dyneither_ptr _tmpAA;(_tmpAA=_dyneither_ptr_plus(
dest,sizeof(char),(int)len),((_tmpAB=*((char*)_check_dyneither_subscript(_tmpAA,
sizeof(char),0)),((_tmpAC='\000',((_get_dyneither_size(_tmpAA,sizeof(char))== 1
 && (_tmpAB == '\000'  && _tmpAC != '\000')?_throw_arraybounds(): 1,*((char*)_tmpAA.curr)=
_tmpAC)))))));}}
# 336
return dest;}
# 342
...
# 356
struct _dyneither_ptr Cyc_rexpand(struct _RegionHandle*r,struct _dyneither_ptr s,
unsigned long sz){
# 357
struct _dyneither_ptr temp;
# 358
...
# 367
char _tmpAF;char _tmpAE;struct _dyneither_ptr _tmpAD;(_tmpAD=_dyneither_ptr_plus(
temp,sizeof(char),(int)slen),((_tmpAE=*((char*)_check_dyneither_subscript(_tmpAD,
sizeof(char),0)),((_tmpAF='\000',((_get_dyneither_size(_tmpAD,sizeof(char))== 1
 && (_tmpAE == '\000'  && _tmpAF != '\000')?_throw_arraybounds(): 1,*((char*)_tmpAD.curr)=
_tmpAF)))))));}
# 369
return temp;}
# 372
...
# 383
char _tmpB2;char _tmpB1;struct _dyneither_ptr _tmpB0;(_tmpB0=_dyneither_ptr_plus(
str,sizeof(char),0),((_tmpB1=*((char*)_check_dyneither_subscript(_tmpB0,sizeof(
char),0)),((_tmpB2='\000',((_get_dyneither_size(_tmpB0,sizeof(char))== 1  && (
_tmpB1 == '\000'  && _tmpB2 != '\000')?_throw_arraybounds(): 1,*((char*)_tmpB0.curr)=
_tmpB2)))))));};}else{
# 385
if(sz > maxsizeP){
# 386
...
# 402
struct _dyneither_ptr Cyc_rsubstring(struct _RegionHandle*r,struct _dyneither_ptr s,
...
# 408
{const char*_tmpB4;const char*_tmpB3;amt < _get_dyneither_size(ans,sizeof(char))
 && amt <= _get_dyneither_size(s,sizeof(char))?0:((int(*)(struct _dyneither_ptr
assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(((_tmpB3="amt < numelts(ans) && amt <= numelts(s)",
_tag_dyneither(_tmpB3,sizeof(char),40))),((_tmpB4="string.cyc",_tag_dyneither(
_tmpB4,sizeof(char),11))),408);}
# 409
{unsigned long i=0;for(0;i < amt;++ i){
# 410
char _tmpB7;char _tmpB6;struct _dyneither_ptr _tmpB5;(_tmpB5=_dyneither_ptr_plus(
ans,sizeof(char),(int)i),((_tmpB6=*((char*)_check_dyneither_subscript(_tmpB5,
sizeof(char),0)),((_tmpB7=((const char*)s.curr)[(int)i],((_get_dyneither_size(
_tmpB5,sizeof(char))== 1  && (_tmpB6 == '\000'  && _tmpB7 != '\000')?
_throw_arraybounds(): 1,*((char*)_tmpB5.curr)=_tmpB7)))))));}}
# 411
{char _tmpBA;char _tmpB9;struct _dyneither_ptr _tmpB8;(_tmpB8=_dyneither_ptr_plus(
ans,sizeof(char),(int)amt),((_tmpB9=*((char*)_check_dyneither_subscript(_tmpB8,
...
return ans;}
# 415
struct _dyneither_ptr Cyc_substring(struct _dyneither_ptr s,int start,unsigned long
amt){
# 416
...
# 424
const char*_tmpBB;struct _dyneither_ptr err=(_tmpBB="replace_suffix",
_tag_dyneither(_tmpBB,sizeof(char),15));
# 425
if(m < n){
# 426
struct Cyc_Core_Invalid_argument_exn_struct _tmpBE;struct Cyc_Core_Invalid_argument_exn_struct*
...
# 428
if(*((const char*)_check_dyneither_subscript(src,sizeof(char),(int)(m - i)))!= *((
const char*)_check_dyneither_subscript(curr_suffix,sizeof(char),(int)(n - i)))){
# 429
struct Cyc_Core_Invalid_argument_exn_struct _tmpC1;struct Cyc_Core_Invalid_argument_exn_struct*
...
new_suffix,sizeof(char)))+ 1);
# 431
Cyc_strncpy(_dyneither_ptr_decrease_size(ans,sizeof(char),1),src,m - n);
# 432
Cyc_strncpy(_dyneither_ptr_decrease_size(_dyneither_ptr_plus(ans,sizeof(char),(
int)(m - n)),sizeof(char),1),new_suffix,_get_dyneither_size(new_suffix,sizeof(
char)));
# 433
return ans;};}
# 436
struct _dyneither_ptr Cyc_replace_suffix(struct _dyneither_ptr src,struct
_dyneither_ptr curr_suffix,struct _dyneither_ptr new_suffix){
# 437
...
_dyneither_ptr needle){
# 524
if(!((unsigned int)haystack.curr) || !((unsigned int)needle.curr)){struct Cyc_Core_Invalid_argument_exn_struct
...
_tmpC5)))));}
# 525
if(*((const char*)_check_dyneither_subscript(needle,sizeof(char),0))== '\000')
return haystack;{
# 527
...
# 529
Cyc_strchr(start,*((const char*)_check_dyneither_subscript(needle,sizeof(char),0)))).curr
!= (char*)(_tag_dyneither(0,0,0)).curr;start=
# 530
Cyc_strchr(_dyneither_ptr_plus(start,sizeof(char),1),*((const char*)
_check_dyneither_subscript(needle,sizeof(char),0)))){
# 531
if(Cyc_strncmp((struct _dyneither_ptr)start,(struct _dyneither_ptr)needle,(
unsigned long)len)== 0)
# 532
return start;}}
# 534
...
# 538
if(!((unsigned int)haystack.curr) || !((unsigned int)needle.curr)){struct Cyc_Core_Invalid_argument_exn_struct
_tmpCD;const char*_tmpCC;struct Cyc_Core_Invalid_argument_exn_struct*_tmpCB;(int)
_throw((void*)((_tmpCB=_cycalloc(sizeof(*_tmpCB)),((_tmpCB[0]=((_tmpCD.tag=Cyc_Core_Invalid_argument,((
...
{struct _dyneither_ptr start=haystack;for(0;(char*)(start=
# 543
Cyc_mstrchr(start,*((const char*)_check_dyneither_subscript(needle,sizeof(char),
0)))).curr != (char*)(_tag_dyneither(0,0,0)).curr;start=
# 544
Cyc_mstrchr(_dyneither_ptr_plus(start,sizeof(char),1),*((const char*)
_check_dyneither_subscript(needle,sizeof(char),0)))){
# 545
if(Cyc_strncmp((struct _dyneither_ptr)start,(struct _dyneither_ptr)needle,(
unsigned long)len)== 0)
...
char),18))),((_tmpCF="string.cyc",_tag_dyneither(_tmpCF,sizeof(char),11))),558);}
# 559
...
# 608
if(inc >= _get_dyneither_size(s,sizeof(char)) || *((char*)
_check_dyneither_subscript(_dyneither_ptr_plus(s,sizeof(char),(int)inc),sizeof(
char),0))== '\000'){
# 610
...
# 625
{char _tmpD4;char _tmpD3;struct _dyneither_ptr _tmpD2;(_tmpD2=s,((_tmpD3=*((char*)
_check_dyneither_subscript(_tmpD2,sizeof(char),0)),((_tmpD4='\000',((
_get_dyneither_size(_tmpD2,sizeof(char))== 1  && (_tmpD3 == '\000'  && _tmpD4 != '\000')?
_throw_arraybounds(): 1,*((char*)_tmpD2.curr)=_tmpD4)))))));}
# 626
...
# 635
struct Cyc_List_List*_tmpD5;result=((_tmpD5=_region_malloc(r,sizeof(*_tmpD5)),((
_tmpD5->hd=(void*)((int)*((const char*)_check_dyneither_subscript(s,sizeof(char),
i))),((_tmpD5->tl=result,_tmpD5))))));}}
# 636
return result;}
# 639
struct Cyc_List_List*Cyc_explode(struct _dyneither_ptr s){
...
# 644
struct _dyneither_ptr s=Cyc_Core_new_string((unsigned int)(((int(*)(struct Cyc_List_List*
x))Cyc_List_length)(chars)+ 1));
# 645
unsigned long i=0;
# 646
while(chars != 0){
# 647
{char _tmpD8;char _tmpD7;struct _dyneither_ptr _tmpD6;(_tmpD6=_dyneither_ptr_plus(s,
sizeof(char),(int)i ++),((_tmpD7=*((char*)_check_dyneither_subscript(_tmpD6,
sizeof(char),0)),((_tmpD8=(char)((int)chars->hd),((_get_dyneither_size(_tmpD6,
sizeof(char))== 1  && (_tmpD7 == '\000'  && _tmpD8 != '\000')?_throw_arraybounds(): 1,*((
char*)_tmpD6.curr)=_tmpD8)))))));}
# 648
chars=chars->tl;}
# 650
return s;}
...
_dyneither_ptr s2,unsigned long len2){
# 657
...
# 678
inline static int Cyc_caseless_ncmp(struct _dyneither_ptr s1,unsigned long len1,
struct _dyneither_ptr s2,unsigned long len2,unsigned long n){
# 681
if(n <= 0)return 0;{
# 683
unsigned long min_len=len1 > len2?len2: len1;
...
unsigned long bound=min_len > n?n: min_len;
# 686
{const char*_tmpDC;const char*_tmpDB;bound <= _get_dyneither_size(s1,sizeof(char))
 && bound <= _get_dyneither_size(s2,sizeof(char))?0:((int(*)(struct _dyneither_ptr
assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(((_tmpDB="bound <= numelts(s1) && bound <= numelts(s2)",
_tag_dyneither(_tmpDB,sizeof(char),45))),((_tmpDC="string.cyc",_tag_dyneither(
_tmpDC,sizeof(char),11))),686);}
# 688
{int i=0;for(0;i < bound;++ i){
# 689
int retc;
# 690
if((retc=toupper((int)((const char*)s1.curr)[i])- toupper((int)((const char*)s2.curr)[
i]))!= 0)
# 691
return retc;}}
# 693
...
# 719
char*_tmp5E=GC_realloc((char*)_check_null(_untag_dyneither_ptr(s,sizeof(char),1)),
n);
# 720
return wrap_Cbuffer_as_buffer(_tmp5E,n);}
# 723
struct _dyneither_ptr Cyc__memcpy(struct _dyneither_ptr d,struct _dyneither_ptr s,
unsigned long n,unsigned int sz){
# 724
if((((void*)d.curr == (void*)(_tag_dyneither(0,0,0)).curr  || _get_dyneither_size(
d,sizeof(void))< n) || (void*)s.curr == (void*)(_tag_dyneither(0,0,0)).curr) || 
_get_dyneither_size(s,sizeof(void))< n){
# 725
struct Cyc_Core_Invalid_argument_exn_struct _tmpE2;const char*_tmpE1;struct Cyc_Core_Invalid_argument_exn_struct*
...
_tag_dyneither(_tmpE1,sizeof(char),7))),_tmpE2)))),_tmpE0)))));}
# 726
memcpy((void*)_check_null(_untag_dyneither_ptr(d,sizeof(void),1)),(const void*)
_check_null(_untag_dyneither_ptr(s,sizeof(void),1)),n * sz);
# 727
return d;}
# 730
struct _dyneither_ptr Cyc__memmove(struct _dyneither_ptr d,struct _dyneither_ptr s,
...
_get_dyneither_size(s,sizeof(void))< n){
# 732
struct Cyc_Core_Invalid_argument_exn_struct _tmpE8;const char*_tmpE7;struct Cyc_Core_Invalid_argument_exn_struct*
_tmpE6;(int)_throw((void*)((_tmpE6=_cycalloc(sizeof(*_tmpE6)),((_tmpE6[0]=((
_tmpE8.tag=Cyc_Core_Invalid_argument,((_tmpE8.f1=((_tmpE7="memove",
_tag_dyneither(_tmpE7,sizeof(char),7))),_tmpE8)))),_tmpE6)))));}
# 733
memmove((void*)_check_null(_untag_dyneither_ptr(d,sizeof(void),1)),(const void*)
_check_null(_untag_dyneither_ptr(s,sizeof(void),1)),n * sz);
# 734
return d;}
# 737
int Cyc_memcmp(struct _dyneither_ptr s1,struct _dyneither_ptr s2,unsigned long n){
# 738
if((((char*)s1.curr == (char*)(_tag_dyneither(0,0,0)).curr  || (char*)s2.curr == (
char*)(_tag_dyneither(0,0,0)).curr) || _get_dyneither_size(s1,sizeof(char))>= n)
 || _get_dyneither_size(s2,sizeof(char))>= n){
# 739
struct Cyc_Core_Invalid_argument_exn_struct _tmpEE;const char*_tmpED;struct Cyc_Core_Invalid_argument_exn_struct*
...
_tag_dyneither(_tmpED,sizeof(char),7))),_tmpEE)))),_tmpEC)))));}
# 740
return memcmp((const void*)_check_null(_untag_dyneither_ptr(s1,sizeof(char),1)),(
const void*)_check_null(_untag_dyneither_ptr(s2,sizeof(char),1)),n);}
# 743
struct _dyneither_ptr Cyc_memchr(struct _dyneither_ptr s,char c,unsigned long n){
# 744
unsigned int sz=_get_dyneither_size(s,sizeof(char));
...
# 746
struct Cyc_Core_Invalid_argument_exn_struct _tmpF4;const char*_tmpF3;struct Cyc_Core_Invalid_argument_exn_struct*
_tmpF2;(int)_throw((void*)((_tmpF2=_cycalloc(sizeof(*_tmpF2)),((_tmpF2[0]=((
_tmpF4.tag=Cyc_Core_Invalid_argument,((_tmpF4.f1=((_tmpF3="memchr",
_tag_dyneither(_tmpF3,sizeof(char),7))),_tmpF4)))),_tmpF2)))));}{
# 747
char*_tmp6B=memchr((const char*)_check_null(_untag_dyneither_ptr(s,sizeof(char),
1)),c,n);
# 748
if(_tmp6B == 0)return _tag_dyneither(0,0,0);{
# 749
unsigned int _tmp6C=(unsigned int)((const char*)_check_null(_untag_dyneither_ptr(
s,sizeof(char),1)));
# 750
...
if((char*)s.curr == (char*)(_tag_dyneither(0,0,0)).curr  || n > sz){
# 758
struct Cyc_Core_Invalid_argument_exn_struct _tmpFA;const char*_tmpF9;struct Cyc_Core_Invalid_argument_exn_struct*
...
_tag_dyneither(_tmpF9,sizeof(char),8))),_tmpFA)))),_tmpF8)))));}{
# 759
char*_tmp72=memchr((const char*)_check_null(_untag_dyneither_ptr(s,sizeof(char),
1)),c,n);
# 760
if(_tmp72 == 0)return _tag_dyneither(0,0,0);{
# 761
unsigned int _tmp73=(unsigned int)((const char*)_check_null(_untag_dyneither_ptr(
s,sizeof(char),1)));
# 762
...
struct _dyneither_ptr Cyc_memset(struct _dyneither_ptr s,char c,unsigned long n){
# 768
if((char*)s.curr == (char*)(_tag_dyneither(0,0,0)).curr  || n > 
_get_dyneither_size(s,sizeof(char))){
# 769
struct Cyc_Core_Invalid_argument_exn_struct _tmp100;const char*_tmpFF;struct Cyc_Core_Invalid_argument_exn_struct*
_tmpFE;(int)_throw((void*)((_tmpFE=_cycalloc(sizeof(*_tmpFE)),((_tmpFE[0]=((
_tmp100.tag=Cyc_Core_Invalid_argument,((_tmp100.f1=((_tmpFF="memset",
_tag_dyneither(_tmpFF,sizeof(char),7))),_tmp100)))),_tmpFE)))));}
# 770
memset((void*)((char*)_check_null(_untag_dyneither_ptr(s,sizeof(char),1))),(int)
c,n);
# 771
return s;}
# 774
...
sizeof(char))< n){
# 776
struct Cyc_Core_Invalid_argument_exn_struct _tmp106;const char*_tmp105;struct Cyc_Core_Invalid_argument_exn_struct*
_tmp104;(int)_throw((void*)((_tmp104=_cycalloc(sizeof(*_tmp104)),((_tmp104[0]=((
_tmp106.tag=Cyc_Core_Invalid_argument,((_tmp106.f1=((_tmp105="bzero",
_tag_dyneither(_tmp105,sizeof(char),6))),_tmp106)))),_tmp104)))));}
# 777
((void(*)(char*s,unsigned long n))bzero)((char*)_check_null(_untag_dyneither_ptr(
s,sizeof(char),1)),n);}
# 780
void Cyc__bcopy(struct _dyneither_ptr src,struct _dyneither_ptr dst,unsigned long n,
unsigned int sz){
# 781
if((((void*)src.curr == (void*)(_tag_dyneither(0,0,0)).curr  || 
_get_dyneither_size(src,sizeof(void))< n) || (void*)dst.curr == (void*)(
_tag_dyneither(0,0,0)).curr) || _get_dyneither_size(dst,sizeof(void))< n){
# 782
struct Cyc_Core_Invalid_argument_exn_struct _tmp10C;const char*_tmp10B;struct Cyc_Core_Invalid_argument_exn_struct*
_tmp10A;(int)_throw((void*)((_tmp10A=_cycalloc(sizeof(*_tmp10A)),((_tmp10A[0]=((
_tmp10C.tag=Cyc_Core_Invalid_argument,((_tmp10C.f1=((_tmp10B="bcopy",
_tag_dyneither(_tmp10B,sizeof(char),6))),_tmp10C)))),_tmp10A)))));}
# 783
