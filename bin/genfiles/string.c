...
int retc;
if(({int _tmp82=({char _tmp81=*((const char*)_check_dyneither_subscript(s1,sizeof(char),i));_tmp81 - *((const char*)_check_dyneither_subscript(s2,sizeof(char),i));});retc=_tmp82;})!= 0)
return retc;}}
# 102
if(len1 < n  || len2 < n)
...
int i=-1;
# 127
min_length <= _get_dyneither_size(a,sizeof(char)) && min_length <= _get_dyneither_size(b,sizeof(char))?0:({struct _dyneither_ptr _tmp83=({const char*_tmp4="min_length <= numelts(a) && min_length <= numelts(b)";_tag_dyneither(_tmp4,sizeof(char),53U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmp83,({const char*_tmp5="string.cyc";_tag_dyneither(_tmp5,sizeof(char),11U);}),127U);});
# 129
while((++ i,i < min_length)){
int diff=({int _tmp84=(int)*((const char*)_check_dyneither_subscript(a,sizeof(char),i));_tmp84 - (int)*((const char*)_check_dyneither_subscript(b,sizeof(char),i));});
if(diff != 0)
return diff;}
# 134
...
# 145
bound <= _get_dyneither_size(s1,sizeof(char)) && bound <= _get_dyneither_size(s2,sizeof(char))?0:({struct _dyneither_ptr _tmp85=({const char*_tmp6="bound <= numelts(s1) && bound <= numelts(s2)";_tag_dyneither(_tmp6,sizeof(char),45U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmp85,({const char*_tmp7="string.cyc";_tag_dyneither(_tmp7,sizeof(char),11U);}),145U);});
# 147
{int i=0;for(0;i < bound;++ i){
if(({char _tmp86=*((const char*)_check_dyneither_subscript(s1,sizeof(char),i));_tmp86 < *((const char*)_check_dyneither_subscript(s2,sizeof(char),i));}))
return - 1;else{
if(({char _tmp87=*((const char*)_check_dyneither_subscript(s2,sizeof(char),i));_tmp87 < *((const char*)_check_dyneither_subscript(s1,sizeof(char),i));}))
return 1;}}}
# 153
if(min_size <= bound)
return 0;
...
({unsigned long _tmp88=Cyc_strlen((struct _dyneither_ptr)dest);dlen=_tmp88;});
({unsigned long _tmp89=Cyc_strlen(src);slen=_tmp89;});
# 180
if(slen + dlen <= dsize){
slen <= _get_dyneither_size(src,sizeof(char))?0:({struct _dyneither_ptr _tmp8A=({const char*_tmp8="slen <= numelts(src)";_tag_dyneither(_tmp8,sizeof(char),21U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmp8A,({const char*_tmp9="string.cyc";_tag_dyneither(_tmp9,sizeof(char),11U);}),181U);});
for(i=0;i < slen;++ i){
...
# 189
(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp11=_cycalloc(sizeof(*_tmp11));_tmp11->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmp8B=({const char*_tmp10="strcat";_tag_dyneither(_tmp10,sizeof(char),7U);});_tmp11->f1=_tmp8B;});_tmp11;}));}
return dest;}
# 195
struct _dyneither_ptr Cyc_strcat(struct _dyneither_ptr dest,struct _dyneither_ptr src){
...
int i;int j;
_tmp12 <= _get_dyneither_size(ans,sizeof(char)) && _tmp12 <= _get_dyneither_size(a,sizeof(char))?0:({struct _dyneither_ptr _tmp8C=({const char*_tmp14="alen <= numelts(ans) && alen <= numelts(a)";_tag_dyneither(_tmp14,sizeof(char),43U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmp8C,({const char*_tmp15="string.cyc";_tag_dyneither(_tmp15,sizeof(char),11U);}),205U);});
...
_tmp13 <= _get_dyneither_size(b,sizeof(char))?0:({struct _dyneither_ptr _tmp8D=({const char*_tmp19="blen <= numelts(b)";_tag_dyneither(_tmp19,sizeof(char),19U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmp8D,({const char*_tmp1A="string.cyc";_tag_dyneither(_tmp1A,sizeof(char),11U);}),207U);});
...
({unsigned long _tmp8E=Cyc_strlen((struct _dyneither_ptr)*((struct _dyneither_ptr*)p->hd));len=_tmp8E;});
total_len +=len;
({struct Cyc_List_List*_tmp8F=({struct Cyc_List_List*_tmp1F=_region_malloc(temp,sizeof(*_tmp1F));_tmp1F->hd=(void*)len,_tmp1F->tl=0;_tmp1F;});((struct Cyc_List_List*)_check_null(end))->tl=_tmp8F;});
end=end->tl;}}
# 233
lens=lens->tl;
({struct _dyneither_ptr _tmp90=Cyc_Core_rnew_string(r,total_len + 1);ans=_tmp90;});{
unsigned long i=0U;
while(strs != 0){
struct _dyneither_ptr _tmp20=*((struct _dyneither_ptr*)strs->hd);
len=(unsigned long)((struct Cyc_List_List*)_check_null(lens))->hd;
({struct _dyneither_ptr _tmp92=_dyneither_ptr_decrease_size(_dyneither_ptr_plus(ans,sizeof(char),(int)i),sizeof(char),1U);struct _dyneither_ptr _tmp91=(struct _dyneither_ptr)_tmp20;Cyc_strncpy(_tmp92,_tmp91,len);});
i +=len;
strs=strs->tl;
lens=lens->tl;}};}{
# 245
...
({unsigned long _tmp93=Cyc_strlen((struct _dyneither_ptr)*((struct _dyneither_ptr*)_tmp23->hd));len=_tmp93;});
total_len +=len;
({struct Cyc_List_List*_tmp94=({struct Cyc_List_List*_tmp25=_region_malloc(temp,sizeof(*_tmp25));_tmp25->hd=(void*)len,_tmp25->tl=0;_tmp25;});((struct Cyc_List_List*)_check_null(end))->tl=_tmp94;});
end=end->tl;
++ list_len;}
# 271
lens=lens->tl;{
...
len=(unsigned long)((struct Cyc_List_List*)_check_null(lens))->hd;
({struct _dyneither_ptr _tmp96=_dyneither_ptr_decrease_size(_dyneither_ptr_plus(ans,sizeof(char),(int)i),sizeof(char),1U);struct _dyneither_ptr _tmp95=(struct _dyneither_ptr)_tmp26;Cyc_strncpy(_tmp96,_tmp95,len);});
i +=len;
({struct _dyneither_ptr _tmp98=_dyneither_ptr_decrease_size(_dyneither_ptr_plus(ans,sizeof(char),(int)i),sizeof(char),1U);struct _dyneither_ptr _tmp97=separator;Cyc_strncpy(_tmp98,_tmp97,seplen);});
i +=seplen;
strs=strs->tl;
lens=lens->tl;}
# 286
({struct _dyneither_ptr _tmp9A=_dyneither_ptr_decrease_size(_dyneither_ptr_plus(ans,sizeof(char),(int)i),sizeof(char),1U);struct _dyneither_ptr _tmp99=(struct _dyneither_ptr)*((struct _dyneither_ptr*)strs->hd);Cyc_strncpy(_tmp9A,_tmp99,(unsigned long)((struct Cyc_List_List*)_check_null(lens))->hd);});{
...
int i;
n <= _get_dyneither_size(src,sizeof(char)) && n <= _get_dyneither_size(dest,sizeof(char))?0:({struct _dyneither_ptr _tmp9B=({const char*_tmp29="n <= numelts(src) && n <= numelts(dest)";_tag_dyneither(_tmp29,sizeof(char),40U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmp9B,({const char*_tmp2A="string.cyc";_tag_dyneither(_tmp2A,sizeof(char),11U);}),298U);});
for(i=0;i < n;++ i){
...
n <= _get_dyneither_size(dest,sizeof(char)) && n <= _get_dyneither_size(src,sizeof(char))?0:({struct _dyneither_ptr _tmp9C=({const char*_tmp2C="n <= numelts(dest) && n <= numelts(src)";_tag_dyneither(_tmp2C,sizeof(char),40U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmp9C,({const char*_tmp2D="string.cyc";_tag_dyneither(_tmp2D,sizeof(char),11U);}),312U);});{
int i;
for(i=0;i < n;++ i){
({char _tmp9D=*((const char*)_check_dyneither_subscript(src,sizeof(char),i));*((char*)_check_dyneither_subscript(dest,sizeof(char),i))=_tmp9D;});}
return dest;};}
# 319
struct _dyneither_ptr Cyc_strcpy(struct _dyneither_ptr dest,struct _dyneither_ptr src){
...
({struct _dyneither_ptr _tmp9F=_dyneither_ptr_decrease_size(dest,sizeof(char),1U);struct _dyneither_ptr _tmp9E=src;Cyc_strncpy(_tmp9F,_tmp9E,len);});
...
# 346
({unsigned long _tmpA0=Cyc_strlen(src);len=_tmpA0;});
({struct _dyneither_ptr _tmpA1=Cyc_Core_rnew_string(r,len + 1);temp=_tmpA1;});
...
sz=sz > slen?sz: slen;
({struct _dyneither_ptr _tmpA2=({unsigned int _tmp38=sz;char*_tmp39=_region_calloc(r,sizeof(char),_tmp38);_tag_dyneither(_tmp39,sizeof(char),_tmp38);});temp=_tmpA2;});
# 367
...
unsigned long slen;
# 378
({unsigned long _tmpA3=Cyc_strlen(s);slen=_tmpA3;});
sz=sz > slen?sz: slen;
({struct _dyneither_ptr _tmpA4=Cyc_Core_rnew_string(r,sz);temp=_tmpA4;});
# 382
...
({struct _dyneither_ptr _tmpA5=Cyc_Core_rnew_string(r,maxsizeP);str=_tmpA5;});
...
({struct _dyneither_ptr _tmpA6=_dyneither_ptr_decrease_size(Cyc_rexpand(r,(struct _dyneither_ptr)_tmp45,maxsizeP),sizeof(char),1U);_tmp45=_tmpA6;});};}}
# 411
return str;}
# 414
struct _dyneither_ptr Cyc_realloc_str(struct _dyneither_ptr str,unsigned long sz){
...
({struct _dyneither_ptr _tmpA7=_dyneither_ptr_plus(s,sizeof(char),start);s=_tmpA7;});
amt < _get_dyneither_size(ans,sizeof(char)) && amt <= _get_dyneither_size(s,sizeof(char))?0:({struct _dyneither_ptr _tmpA8=({const char*_tmp46="amt < numelts(ans) && amt <= numelts(s)";_tag_dyneither(_tmp46,sizeof(char),40U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmpA8,({const char*_tmp47="string.cyc";_tag_dyneither(_tmp47,sizeof(char),11U);}),429U);});
{unsigned long i=0U;for(0;i < amt;++ i){
({struct _dyneither_ptr _tmp48=_dyneither_ptr_plus(ans,sizeof(char),(int)i);char _tmp49=*((char*)_check_dyneither_subscript(_tmp48,sizeof(char),0U));char _tmp4A=*((const char*)_check_dyneither_subscript(s,sizeof(char),(int)i));if(_get_dyneither_size(_tmp48,sizeof(char))== 1U  && (_tmp49 == '\000'  && _tmp4A != '\000'))_throw_arraybounds();*((char*)_tmp48.curr)=_tmp4A;});}}
...
if(({char _tmpA9=*((const char*)_check_dyneither_subscript(src,sizeof(char),(int)(m - i)));_tmpA9 != *((const char*)_check_dyneither_subscript(curr_suffix,sizeof(char),(int)(n - i)));}))
...
({struct _dyneither_ptr _tmpAB=_dyneither_ptr_decrease_size(ans,sizeof(char),1U);struct _dyneither_ptr _tmpAA=src;Cyc_strncpy(_tmpAB,_tmpAA,m - n);});
({struct _dyneither_ptr _tmpAD=_dyneither_ptr_decrease_size(_dyneither_ptr_plus(ans,sizeof(char),(int)(m - n)),sizeof(char),1U);struct _dyneither_ptr _tmpAC=new_suffix;Cyc_strncpy(_tmpAD,_tmpAC,_get_dyneither_size(new_suffix,sizeof(char)));});
return ans;};}
# 457
...
# 544
struct _dyneither_ptr Cyc_strstr(struct _dyneither_ptr haystack,struct _dyneither_ptr needle){
if(!((unsigned int)haystack.curr) || !((unsigned int)needle.curr))(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp52=_cycalloc(sizeof(*_tmp52));_tmp52->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmpAE=({const char*_tmp51="strstr";_tag_dyneither(_tmp51,sizeof(char),7U);});_tmp52->f1=_tmpAE;});_tmp52;}));
...
char*_tmpB0=(char*)({struct _dyneither_ptr _tmpAF=Cyc_strchr(start,*((const char*)_check_dyneither_subscript(needle,sizeof(char),0U)));start=_tmpAF;}).curr;_tmpB0 != (char*)(_tag_dyneither(0,0,0)).curr;});({
struct _dyneither_ptr _tmpB2=({struct _dyneither_ptr _tmpB1=_dyneither_ptr_plus(start,sizeof(char),1);Cyc_strchr(_tmpB1,*((const char*)_check_dyneither_subscript(needle,sizeof(char),0U)));});start=_tmpB2;})){
...
# 558
struct _dyneither_ptr Cyc_mstrstr(struct _dyneither_ptr haystack,struct _dyneither_ptr needle){
if(!((unsigned int)haystack.curr) || !((unsigned int)needle.curr))(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp54=_cycalloc(sizeof(*_tmp54));_tmp54->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmpB3=({const char*_tmp53="mstrstr";_tag_dyneither(_tmp53,sizeof(char),8U);});_tmp54->f1=_tmpB3;});_tmp54;}));
if(*((const char*)_check_dyneither_subscript(needle,sizeof(char),0U))== '\000')return haystack;{
# 562
int len=(int)Cyc_strlen((struct _dyneither_ptr)needle);
{struct _dyneither_ptr start=haystack;for(0;({
char*_tmpB5=(char*)({struct _dyneither_ptr _tmpB4=Cyc_mstrchr(start,*((const char*)_check_dyneither_subscript(needle,sizeof(char),0U)));start=_tmpB4;}).curr;_tmpB5 != (char*)(_tag_dyneither(0,0,0)).curr;});({
struct _dyneither_ptr _tmpB7=({struct _dyneither_ptr _tmpB6=_dyneither_ptr_plus(start,sizeof(char),1);Cyc_mstrchr(_tmpB6,*((const char*)_check_dyneither_subscript(needle,sizeof(char),0U)));});start=_tmpB7;})){
if(Cyc_strncmp((struct _dyneither_ptr)start,(struct _dyneither_ptr)needle,(unsigned long)len)== 0)
return start;}}
# 569
return _tag_dyneither(0,0,0);};}
...
unsigned int asize=_get_dyneither_size(accept,sizeof(char));
# 579
len <= _get_dyneither_size(s,sizeof(char))?0:({struct _dyneither_ptr _tmpB8=({const char*_tmp55="len <= numelts(s)";_tag_dyneither(_tmp55,sizeof(char),18U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmpB8,({const char*_tmp56="string.cyc";_tag_dyneither(_tmp56,sizeof(char),11U);}),579U);});
{unsigned long i=0U;for(0;i < len;++ i){
int j;
for(j=0;j < asize;++ j){
if(({char _tmpB9=*((const char*)_check_dyneither_subscript(s,sizeof(char),(int)i));_tmpB9 == *((const char*)_check_dyneither_subscript(accept,sizeof(char),j));}))
break;}
if(j == asize)
return i;}}
# 589
...
unsigned int asize=_get_dyneither_size(accept,sizeof(char));
# 599
len <= _get_dyneither_size(s,sizeof(char))?0:({struct _dyneither_ptr _tmpBA=({const char*_tmp57="len <= numelts(s)";_tag_dyneither(_tmp57,sizeof(char),18U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmpBA,({const char*_tmp58="string.cyc";_tag_dyneither(_tmp58,sizeof(char),11U);}),599U);});
{unsigned long i=0U;for(0;i < len;++ i){
int j;
for(j=0;j < asize;++ j){
if(({char _tmpBB=*((const char*)_check_dyneither_subscript(s,sizeof(char),(int)i));_tmpBB == *((const char*)_check_dyneither_subscript(accept,sizeof(char),j));}))return i;}}}
# 605
return len;}
# 612
struct _dyneither_ptr Cyc_strtok(struct _dyneither_ptr s,struct _dyneither_ptr delim){
...
# 617
if(({char*_tmpBC=(char*)s.curr;_tmpBC == (char*)(_tag_dyneither(0,0,0)).curr;})){
if(({char*_tmpBD=(char*)olds.curr;_tmpBD == (char*)(_tag_dyneither(0,0,0)).curr;}))
return _tag_dyneither(0,0,0);
s=olds;}{
# 624
...
# 627
({struct _dyneither_ptr _tmpBE=_tag_dyneither(0,0,0);olds=_tmpBE;});
return _tag_dyneither(0,0,0);}else{
# 631
_dyneither_ptr_inplace_plus(& s,sizeof(char),(int)inc);}
# 634
token=s;
({struct _dyneither_ptr _tmpBF=Cyc_mstrpbrk(token,(struct _dyneither_ptr)delim);s=_tmpBF;});
if(({char*_tmpC0=(char*)s.curr;_tmpC0 == (char*)(_tag_dyneither(0,0,0)).curr;}))
# 638
({struct _dyneither_ptr _tmpC1=_tag_dyneither(0,0,0);olds=_tmpC1;});else{
# 642
...
({struct _dyneither_ptr _tmpC2=_dyneither_ptr_plus(s,sizeof(char),1);olds=_tmpC2;});}
# 645
return token;};}
# 649
...
({struct Cyc_List_List*_tmpC3=({struct Cyc_List_List*_tmp5C=_region_malloc(r,sizeof(*_tmp5C));_tmp5C->hd=(void*)((int)*((const char*)_check_dyneither_subscript(s,sizeof(char),i))),_tmp5C->tl=result;_tmp5C;});result=_tmpC3;});}}
return result;}
# 656
struct Cyc_List_List*Cyc_explode(struct _dyneither_ptr s){
...
# 676
min_length <= _get_dyneither_size(s1,sizeof(char)) && min_length <= _get_dyneither_size(s2,sizeof(char))?0:({struct _dyneither_ptr _tmpC4=({const char*_tmp60="min_length <= numelts(s1) && min_length <= numelts(s2)";_tag_dyneither(_tmp60,sizeof(char),55U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmpC4,({const char*_tmp61="string.cyc";_tag_dyneither(_tmp61,sizeof(char),11U);}),676U);});{
# 678
int i=-1;
while((++ i,i < min_length)){
int diff=({int _tmpC5= toupper((int)*((const char*)_check_dyneither_subscript(s1,sizeof(char),i)));_tmpC5 -  toupper((int)*((const char*)_check_dyneither_subscript(s2,sizeof(char),i)));});
if(diff != 0)
return diff;}
# 684
return(int)len1 - (int)len2;};}
...
unsigned long bound=min_len > n?n: min_len;
# 703
bound <= _get_dyneither_size(s1,sizeof(char)) && bound <= _get_dyneither_size(s2,sizeof(char))?0:({struct _dyneither_ptr _tmpC6=({const char*_tmp62="bound <= numelts(s1) && bound <= numelts(s2)";_tag_dyneither(_tmp62,sizeof(char),45U);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmpC6,({const char*_tmp63="string.cyc";_tag_dyneither(_tmp63,sizeof(char),11U);}),703U);});
# 705
{int i=0;for(0;i < bound;++ i){
int retc;
if(({int _tmpC8=({int _tmpC7= toupper((int)*((const char*)_check_dyneither_subscript(s1,sizeof(char),i)));_tmpC7 -  toupper((int)*((const char*)_check_dyneither_subscript(s2,sizeof(char),i)));});retc=_tmpC8;})!= 0)
return retc;}}
# 710
if(len1 < n  || len2 < n)
return(int)len1 - (int)len2;
...
if(((({void*_tmpCA=(void*)d.curr;_tmpCA == (void*)(_tag_dyneither(0,0,0)).curr;}) || _get_dyneither_size(d,sizeof(void))< n) || ({void*_tmpC9=(void*)s.curr;_tmpC9 == (void*)(_tag_dyneither(0,0,0)).curr;})) || _get_dyneither_size(s,sizeof(void))< n)
(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp68=_cycalloc(sizeof(*_tmp68));_tmp68->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmpCB=({const char*_tmp67="memcpy";_tag_dyneither(_tmp67,sizeof(char),7U);});_tmp68->f1=_tmpCB;});_tmp68;}));
({void*_tmpCD=(void*)_untag_dyneither_ptr(d,sizeof(void),1U);const void*_tmpCC=(const void*)_untag_dyneither_ptr(s,sizeof(void),1U); memcpy(_tmpCD,_tmpCC,n * sz);});
return d;}
# 750
struct _dyneither_ptr Cyc__memmove(struct _dyneither_ptr d,struct _dyneither_ptr s,unsigned long n,unsigned int sz){
if(((({void*_tmpCF=(void*)d.curr;_tmpCF == (void*)(_tag_dyneither(0,0,0)).curr;}) || _get_dyneither_size(d,sizeof(void))< n) || ({void*_tmpCE=(void*)s.curr;_tmpCE == (void*)(_tag_dyneither(0,0,0)).curr;})) || _get_dyneither_size(s,sizeof(void))< n)
(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp6A=_cycalloc(sizeof(*_tmp6A));_tmp6A->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmpD0=({const char*_tmp69="memove";_tag_dyneither(_tmp69,sizeof(char),7U);});_tmp6A->f1=_tmpD0;});_tmp6A;}));
({void*_tmpD2=(void*)_untag_dyneither_ptr(d,sizeof(void),1U);const void*_tmpD1=(const void*)_untag_dyneither_ptr(s,sizeof(void),1U); memmove(_tmpD2,_tmpD1,n * sz);});
return d;}
# 757
int Cyc_memcmp(struct _dyneither_ptr s1,struct _dyneither_ptr s2,unsigned long n){
if(((({char*_tmpD4=(char*)s1.curr;_tmpD4 == (char*)(_tag_dyneither(0,0,0)).curr;}) || ({char*_tmpD3=(char*)s2.curr;_tmpD3 == (char*)(_tag_dyneither(0,0,0)).curr;})) || _get_dyneither_size(s1,sizeof(char))< n) || _get_dyneither_size(s2,sizeof(char))< n)
(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp6C=_cycalloc(sizeof(*_tmp6C));_tmp6C->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmpD5=({const char*_tmp6B="memcmp";_tag_dyneither(_tmp6B,sizeof(char),7U);});_tmp6C->f1=_tmpD5;});_tmp6C;}));
return({const void*_tmpD7=(const void*)_untag_dyneither_ptr(s1,sizeof(char),1U);const void*_tmpD6=(const void*)_untag_dyneither_ptr(s2,sizeof(char),1U); memcmp(_tmpD7,_tmpD6,n);});}
# 763
struct _dyneither_ptr Cyc_memchr(struct _dyneither_ptr s,char c,unsigned long n){
unsigned int sz=_get_dyneither_size(s,sizeof(char));
if(({char*_tmpD8=(char*)s.curr;_tmpD8 == (char*)(_tag_dyneither(0,0,0)).curr;}) || n > sz)
(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp6E=_cycalloc(sizeof(*_tmp6E));_tmp6E->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmpD9=({const char*_tmp6D="memchr";_tag_dyneither(_tmp6D,sizeof(char),7U);});_tmp6E->f1=_tmpD9;});_tmp6E;}));{
...
struct _dyneither_ptr Cyc_mmemchr(struct _dyneither_ptr s,char c,unsigned long n){
unsigned int sz=_get_dyneither_size(s,sizeof(char));
if(({char*_tmpDA=(char*)s.curr;_tmpDA == (char*)(_tag_dyneither(0,0,0)).curr;}) || n > sz)
(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp74=_cycalloc(sizeof(*_tmp74));_tmp74->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmpDB=({const char*_tmp73="mmemchr";_tag_dyneither(_tmp73,sizeof(char),8U);});_tmp74->f1=_tmpDB;});_tmp74;}));{
...
# 787
struct _dyneither_ptr Cyc_memset(struct _dyneither_ptr s,char c,unsigned long n){
if(({char*_tmpDC=(char*)s.curr;_tmpDC == (char*)(_tag_dyneither(0,0,0)).curr;}) || n > _get_dyneither_size(s,sizeof(char)))
(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp7A=_cycalloc(sizeof(*_tmp7A));_tmp7A->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmpDD=({const char*_tmp79="memset";_tag_dyneither(_tmp79,sizeof(char),7U);});_tmp7A->f1=_tmpDD;});_tmp7A;}));
 memset((void*)((char*)_untag_dyneither_ptr(s,sizeof(char),1U)),(int)c,n);
return s;}
# 794
void Cyc_bzero(struct _dyneither_ptr s,unsigned long n){
if(({char*_tmpDE=(char*)s.curr;_tmpDE == (char*)(_tag_dyneither(0,0,0)).curr;}) || _get_dyneither_size(s,sizeof(char))< n)
(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp7C=_cycalloc(sizeof(*_tmp7C));_tmp7C->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmpDF=({const char*_tmp7B="bzero";_tag_dyneither(_tmp7B,sizeof(char),6U);});_tmp7C->f1=_tmpDF;});_tmp7C;}));
((void(*)(char*s,unsigned long n)) bzero)((char*)_untag_dyneither_ptr(s,sizeof(char),1U),n);}
# 800
void Cyc__bcopy(struct _dyneither_ptr src,struct _dyneither_ptr dst,unsigned long n,unsigned int sz){
if(((({void*_tmpE1=(void*)src.curr;_tmpE1 == (void*)(_tag_dyneither(0,0,0)).curr;}) || _get_dyneither_size(src,sizeof(void))< n) || ({void*_tmpE0=(void*)dst.curr;_tmpE0 == (void*)(_tag_dyneither(0,0,0)).curr;})) || _get_dyneither_size(dst,sizeof(void))< n)
(int)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_tmp7E=_cycalloc(sizeof(*_tmp7E));_tmp7E->tag=Cyc_Core_Invalid_argument,({struct _dyneither_ptr _tmpE2=({const char*_tmp7D="bcopy";_tag_dyneither(_tmp7D,sizeof(char),6U);});_tmp7E->f1=_tmpE2;});_tmp7E;}));
({const void*_tmpE4=(const void*)_untag_dyneither_ptr(src,sizeof(void),1U);void*_tmpE3=(void*)_untag_dyneither_ptr(dst,sizeof(void),1U); bcopy(_tmpE4,_tmpE3,n * sz);});}
