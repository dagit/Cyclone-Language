...
char*tag;struct _dyneither_ptr f1;};int toupper(int);typedef unsigned int Cyc_Core_sizeof_t;
struct Cyc_Core_Opt{void*v;};typedef struct Cyc_Core_Opt*Cyc_Core_opt_t;struct
...
typedef struct Cyc_List_List*Cyc_List_List_t;int Cyc_List_length(struct Cyc_List_List*
...
char*strerror(int errnum);unsigned long Cyc_strlen(struct _dyneither_ptr s);int Cyc_strcmp(
...
_throw_arraybounds(): 1,*((char*)_tmp8C.curr)=_tmp8E)))))));}}else{struct Cyc_Core_Invalid_argument_exn_struct
_tmp94;const char*_tmp93;struct Cyc_Core_Invalid_argument_exn_struct*_tmp92;(int)
...
unsigned long _tmp13=Cyc_strlen(a);unsigned long _tmp14=Cyc_strlen(b);struct
_dyneither_ptr ans=Cyc_Core_rnew_string(r,(_tmp13 + _tmp14)+ 1);int i;int j;{const
char*_tmp96;const char*_tmp95;_tmp13 <= _get_dyneither_size(ans,sizeof(char)) && 
...
sizeof(char),15));if(m < n){struct Cyc_Core_Invalid_argument_exn_struct _tmpBE;
struct Cyc_Core_Invalid_argument_exn_struct*_tmpBD;(int)_throw((void*)((_tmpBD=
_cycalloc(sizeof(*_tmpBD)),((_tmpBD[0]=((_tmpBE.tag=Cyc_Core_Invalid_argument,((
_tmpBE.f1=err,_tmpBE)))),_tmpBD)))));}{unsigned long i=1;for(0;i <= n;++ i){if(*((
const char*)_check_dyneither_subscript(src,sizeof(char),(int)(m - i)))!= *((const
char*)_check_dyneither_subscript(curr_suffix,sizeof(char),(int)(n - i)))){struct
Cyc_Core_Invalid_argument_exn_struct _tmpC1;struct Cyc_Core_Invalid_argument_exn_struct*
_tmpC0;(int)_throw((void*)((_tmpC0=_cycalloc(sizeof(*_tmpC0)),((_tmpC0[0]=((
_tmpC1.tag=Cyc_Core_Invalid_argument,((_tmpC1.f1=err,_tmpC1)))),_tmpC0)))));}}}{
...
struct _dyneither_ptr Cyc_mstrpbrk(struct _dyneither_ptr s,struct _dyneither_ptr
accept){int len=(int)_get_dyneither_size(s,sizeof(char));unsigned int asize=
_get_dyneither_size(accept,sizeof(char));char c;unsigned int i;for(i=0;i < len  && (
c=((char*)s.curr)[(int)i])!= 0;++ i){unsigned int j=0;for(0;j < asize;++ j){if(c == ((
const char*)accept.curr)[(int)j])return _dyneither_ptr_plus(s,sizeof(char),(int)i);}}
return _tag_dyneither(0,0,0);}struct _dyneither_ptr Cyc_mstrchr(struct
_dyneither_ptr s,char c){int len=(int)_get_dyneither_size(s,sizeof(char));char c2;
unsigned int i;for(i=0;i < len  && (c2=((char*)s.curr)[(int)i])!= 0;++ i){if(c2 == c)
return _dyneither_ptr_plus(s,sizeof(char),(int)i);}return _tag_dyneither(0,0,0);}
struct _dyneither_ptr Cyc_strchr(struct _dyneither_ptr s,char c){int len=(int)
...
sizeof(char),(int)i);}return _tag_dyneither(0,0,0);}struct _dyneither_ptr Cyc_strrchr(
...
_dyneither_ptr)s;}return _tag_dyneither(0,0,0);}struct _dyneither_ptr Cyc_mstrrchr(
struct _dyneither_ptr s0,char c){int len=(int)Cyc_strlen((struct _dyneither_ptr)s0);
int i=len - 1;struct _dyneither_ptr s=s0;_dyneither_ptr_inplace_plus(& s,sizeof(char),
i);for(0;i >= 0;(i --,_dyneither_ptr_inplace_plus_post(& s,sizeof(char),-1))){if(*((
...
haystack.curr) || !((unsigned int)needle.curr)){struct Cyc_Core_Invalid_argument_exn_struct
_tmpC7;const char*_tmpC6;struct Cyc_Core_Invalid_argument_exn_struct*_tmpC5;(int)
...
struct _dyneither_ptr start=haystack;for(0;(char*)(start=Cyc_strchr(start,*((const
char*)_check_dyneither_subscript(needle,sizeof(char),0)))).curr != (char*)(
...
unsigned long)len)== 0)return start;}}return _tag_dyneither(0,0,0);};}struct
_dyneither_ptr Cyc_mstrstr(struct _dyneither_ptr haystack,struct _dyneither_ptr
needle){if(!((unsigned int)haystack.curr) || !((unsigned int)needle.curr)){
struct Cyc_Core_Invalid_argument_exn_struct _tmpCD;const char*_tmpCC;struct Cyc_Core_Invalid_argument_exn_struct*
_tmpCB;(int)_throw((void*)((_tmpCB=_cycalloc(sizeof(*_tmpCB)),((_tmpCB[0]=((
_tmpCD.tag=Cyc_Core_Invalid_argument,((_tmpCD.f1=((_tmpCC="mstrstr",
_tag_dyneither(_tmpCC,sizeof(char),8))),_tmpCD)))),_tmpCB)))));}if(*((const char*)
...
Cyc_Core_Invalid_argument_exn_struct _tmpE2;const char*_tmpE1;struct Cyc_Core_Invalid_argument_exn_struct*
...
_get_dyneither_size(s,sizeof(void))< n){struct Cyc_Core_Invalid_argument_exn_struct
_tmpE8;const char*_tmpE7;struct Cyc_Core_Invalid_argument_exn_struct*_tmpE6;(int)
...
int Cyc_memcmp(struct _dyneither_ptr s1,struct _dyneither_ptr s2,unsigned long n){if((((
char*)s1.curr == (char*)(_tag_dyneither(0,0,0)).curr  || (char*)s2.curr == (char*)(
_tag_dyneither(0,0,0)).curr) || _get_dyneither_size(s1,sizeof(char))>= n) || 
_get_dyneither_size(s2,sizeof(char))>= n){struct Cyc_Core_Invalid_argument_exn_struct
_tmpEE;const char*_tmpED;struct Cyc_Core_Invalid_argument_exn_struct*_tmpEC;(int)
_throw((void*)((_tmpEC=_cycalloc(sizeof(*_tmpEC)),((_tmpEC[0]=((_tmpEE.tag=Cyc_Core_Invalid_argument,((
_tmpEE.f1=((_tmpED="memcmp",_tag_dyneither(_tmpED,sizeof(char),7))),_tmpEE)))),
_tmpEC)))));}return memcmp((const void*)_check_null(_untag_dyneither_ptr(s1,
...
_tag_dyneither(0,0,0)).curr  || n > sz){struct Cyc_Core_Invalid_argument_exn_struct
_tmpF4;const char*_tmpF3;struct Cyc_Core_Invalid_argument_exn_struct*_tmpF2;(int)
...
sizeof(char),1)),c,n);if(_tmp6B == 0)return _tag_dyneither(0,0,0);{unsigned int
_tmp6C=(unsigned int)((const char*)_check_null(_untag_dyneither_ptr(s,sizeof(char),
1)));unsigned int _tmp6D=(unsigned int)((const char*)_tmp6B);unsigned int _tmp6E=
_tmp6D - _tmp6C;return _dyneither_ptr_plus(s,sizeof(char),(int)_tmp6E);};};}struct
_dyneither_ptr Cyc_mmemchr(struct _dyneither_ptr s,char c,unsigned long n){
unsigned int sz=_get_dyneither_size(s,sizeof(char));if((char*)s.curr == (char*)(
_tag_dyneither(0,0,0)).curr  || n > sz){struct Cyc_Core_Invalid_argument_exn_struct
_tmpFA;const char*_tmpF9;struct Cyc_Core_Invalid_argument_exn_struct*_tmpF8;(int)
...
Cyc_memset(struct _dyneither_ptr s,char c,unsigned long n){if((char*)s.curr == (char*)(
_tag_dyneither(0,0,0)).curr  || n > _get_dyneither_size(s,sizeof(char))){struct Cyc_Core_Invalid_argument_exn_struct
_tmp100;const char*_tmpFF;struct Cyc_Core_Invalid_argument_exn_struct*_tmpFE;(int)
...
if((char*)s.curr == (char*)(_tag_dyneither(0,0,0)).curr  || _get_dyneither_size(s,
sizeof(char))< n){struct Cyc_Core_Invalid_argument_exn_struct _tmp106;const char*
_tmp105;struct Cyc_Core_Invalid_argument_exn_struct*_tmp104;(int)_throw((void*)((
_tmp104=_cycalloc(sizeof(*_tmp104)),((_tmp104[0]=((_tmp106.tag=Cyc_Core_Invalid_argument,((
_tmp106.f1=((_tmp105="bzero",_tag_dyneither(_tmp105,sizeof(char),6))),_tmp106)))),
_tmp104)))));}((void(*)(char*s,unsigned long n))bzero)((char*)_check_null(
_untag_dyneither_ptr(s,sizeof(char),1)),n);}void Cyc__bcopy(struct _dyneither_ptr
src,struct _dyneither_ptr dst,unsigned long n,unsigned int sz){if((((void*)src.curr
== (void*)(_tag_dyneither(0,0,0)).curr  || _get_dyneither_size(src,sizeof(void))< 
n) || (void*)dst.curr == (void*)(_tag_dyneither(0,0,0)).curr) || 
_get_dyneither_size(dst,sizeof(void))< n){struct Cyc_Core_Invalid_argument_exn_struct
_tmp10C;const char*_tmp10B;struct Cyc_Core_Invalid_argument_exn_struct*_tmp10A;(
int)_throw((void*)((_tmp10A=_cycalloc(sizeof(*_tmp10A)),((_tmp10A[0]=((_tmp10C.tag=
