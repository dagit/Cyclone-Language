...
return 1;}
# 167
void Cyc_BansheeIf_add_variable(void*cvar){void*_T0;int*_T1;int _T2;void*_T3;void*_T4;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T5;void**_T6;void**_T7;void*_T8;unsigned _T9;struct Cyc_Warn_String_Warn_Warg_struct _TA;void**_TB;int(*_TC)(struct _fat_ptr);void*(*_TD)(struct _fat_ptr);struct _fat_ptr _TE;struct Cyc_Warn_String_Warn_Warg_struct _TF;void**_T10;int(*_T11)(struct _fat_ptr);void*(*_T12)(struct _fat_ptr);struct _fat_ptr _T13;struct Cyc_Core_Opt*_T14;void*_T15;struct Cyc_Absyn_Kind*_T16;enum Cyc_Absyn_KindQual _T17;int _T18;void**_T19;struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*_T1A;void**_T1B;struct Cyc_BansheeIf_BvarEffect_BansheeIf_BansheeVar_struct*_T1C;struct Cyc_Warn_String_Warn_Warg_struct _T1D;void**_T1E;int(*_T1F)(struct _fat_ptr);void*(*_T20)(struct _fat_ptr);struct _fat_ptr _T21;struct Cyc_Warn_String_Warn_Warg_struct _T22;struct Cyc_Warn_Typ_Warn_Warg_struct _T23;void**_T24;void**_T25;int(*_T26)(struct _fat_ptr);void*(*_T27)(struct _fat_ptr);struct _fat_ptr _T28;const char*_T29;void*_T2A;struct Cyc_Core_Opt*_T2B;_T0=cvar;_T1=(int*)_T0;_T2=*_T1;if(_T2!=3)goto _TL0;_T3=cvar;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T2C=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T3;_T2B=_T2C->f1;_T4=cvar;_T5=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T4;_T6=& _T5->f4;_T2A=(void**)_T6;_T29=_T2C->f5;}{struct Cyc_Core_Opt*ok=_T2B;void**bv=(void**)_T2A;const char*name=_T29;_T7=bv;_T8=*_T7;_T9=(unsigned)_T8;
# 170
if(!_T9)goto _TL2;{struct Cyc_Warn_String_Warn_Warg_struct _T2C;_T2C.tag=0;
_T2C.f1=_tag_fat("add_variable: Multiple add",sizeof(char),27U);_TA=_T2C;}{struct Cyc_Warn_String_Warn_Warg_struct _T2C=_TA;void*_T2D[1];_TB=_T2D + 0;*_TB=& _T2C;_TD=Cyc_Warn_impos2;{int(*_T2E)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_TD;_TC=_T2E;}_TE=_tag_fat(_T2D,sizeof(void*),1);_TC(_TE);}goto _TL3;_TL2: _TL3:
 if(name!=0)goto _TL4;{struct Cyc_Warn_String_Warn_Warg_struct _T2C;_T2C.tag=0;
_T2C.f1=_tag_fat("add_variable: empty name",sizeof(char),25U);_TF=_T2C;}{struct Cyc_Warn_String_Warn_Warg_struct _T2C=_TF;void*_T2D[1];_T10=_T2D + 0;*_T10=& _T2C;_T12=Cyc_Warn_impos2;{int(*_T2E)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T12;_T11=_T2E;}_T13=_tag_fat(_T2D,sizeof(void*),1);_T11(_T13);}goto _TL5;_TL4: _TL5: _T14=
_check_null(ok);_T15=_T14->v;{struct Cyc_Absyn_Kind*_T2C=(struct Cyc_Absyn_Kind*)_T15;_T16=(struct Cyc_Absyn_Kind*)_T2C;_T17=_T16->kind;_T18=(int)_T17;switch(_T18){case Cyc_Absyn_PtrBndKind: _T19=bv;{struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*_T2D=_cycalloc(sizeof(struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct));_T2D->tag=0;
# 176
_T2D->f1=ptrbnd_fresh(name);_T1A=(struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*)_T2D;}*_T19=(void*)_T1A;goto _LL5;case Cyc_Absyn_EffKind: _T1B=bv;{struct Cyc_BansheeIf_BvarEffect_BansheeIf_BansheeVar_struct*_T2D=_cycalloc(sizeof(struct Cyc_BansheeIf_BvarEffect_BansheeIf_BansheeVar_struct));_T2D->tag=1;
# 179
_T2D->f1=effect_fresh(name);_T1C=(struct Cyc_BansheeIf_BvarEffect_BansheeIf_BansheeVar_struct*)_T2D;}*_T1B=(void*)_T1C;goto _LL5;default:{struct Cyc_Warn_String_Warn_Warg_struct _T2D;_T2D.tag=0;
# 185
_T2D.f1=_tag_fat("add_variable: Unsupported or null cvar kind",sizeof(char),44U);_T1D=_T2D;}{struct Cyc_Warn_String_Warn_Warg_struct _T2D=_T1D;void*_T2E[1];_T1E=_T2E + 0;*_T1E=& _T2D;_T20=Cyc_Warn_impos2;{int(*_T2F)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T20;_T1F=_T2F;}_T21=_tag_fat(_T2E,sizeof(void*),1);_T1F(_T21);}}_LL5:;}goto _LL0;}_TL0:{struct Cyc_Warn_String_Warn_Warg_struct _T2C;_T2C.tag=0;
# 189
_T2C.f1=_tag_fat("add_variable: Bad type",sizeof(char),23U);_T22=_T2C;}{struct Cyc_Warn_String_Warn_Warg_struct _T2C=_T22;{struct Cyc_Warn_Typ_Warn_Warg_struct _T2D;_T2D.tag=2;_T2D.f1=cvar;_T23=_T2D;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T2D=_T23;void*_T2E[2];_T24=_T2E + 0;*_T24=& _T2C;_T25=_T2E + 1;*_T25=& _T2D;_T27=Cyc_Warn_impos2;{int(*_T2F)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T27;_T26=_T2F;}_T28=_tag_fat(_T2E,sizeof(void*),2);_T26(_T28);}}_LL0:;}struct _tuple11{void*f0;struct ptrbnd_*f1;};struct _tuple12{void*f0;struct effect_*f1;};
# 193
void Cyc_BansheeIf_add_constant(struct _fat_ptr name,void*cvar){void*_T0;int*_T1;int _T2;void*_T3;void*_T4;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T5;void**_T6;void**_T7;void*_T8;unsigned _T9;struct Cyc_Warn_String_Warn_Warg_struct _TA;void**_TB;int(*_TC)(struct _fat_ptr);void*(*_TD)(struct _fat_ptr);struct _fat_ptr _TE;struct Cyc_Core_Opt*_TF;void*_T10;struct Cyc_Absyn_Kind*_T11;enum Cyc_Absyn_KindQual _T12;int _T13;struct _fat_ptr _T14;char*_T15;const char*_T16;void**_T17;struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*_T18;struct Cyc_List_List*_T19;struct _tuple11*_T1A;struct _fat_ptr _T1B;char*_T1C;const char*_T1D;void**_T1E;struct Cyc_BansheeIf_BvarEffect_BansheeIf_BansheeVar_struct*_T1F;struct Cyc_List_List*_T20;struct _tuple12*_T21;struct Cyc_Warn_String_Warn_Warg_struct _T22;void**_T23;int(*_T24)(struct _fat_ptr);void*(*_T25)(struct _fat_ptr);struct _fat_ptr _T26;struct Cyc_Warn_String_Warn_Warg_struct _T27;struct Cyc_Warn_Typ_Warn_Warg_struct _T28;void**_T29;void**_T2A;int(*_T2B)(struct _fat_ptr);void*(*_T2C)(struct _fat_ptr);struct _fat_ptr _T2D;void*_T2E;struct Cyc_Core_Opt*_T2F;_T0=cvar;_T1=(int*)_T0;_T2=*_T1;if(_T2!=3)goto _TL7;_T3=cvar;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T30=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T3;_T2F=_T30->f1;_T4=cvar;_T5=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T4;_T6=& _T5->f4;_T2E=(void**)_T6;}{struct Cyc_Core_Opt*ok=_T2F;void**bv=(void**)_T2E;_T7=bv;_T8=*_T7;_T9=(unsigned)_T8;
# 196
if(!_T9)goto _TL9;{struct Cyc_Warn_String_Warn_Warg_struct _T30;_T30.tag=0;
_T30.f1=_tag_fat("add_constant: Multiple add",sizeof(char),27U);_TA=_T30;}{struct Cyc_Warn_String_Warn_Warg_struct _T30=_TA;void*_T31[1];_TB=_T31 + 0;*_TB=& _T30;_TD=Cyc_Warn_impos2;{int(*_T32)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_TD;_TC=_T32;}_TE=_tag_fat(_T31,sizeof(void*),1);_TC(_TE);}goto _TLA;_TL9: _TLA: _TF=
_check_null(ok);_T10=_TF->v;{struct Cyc_Absyn_Kind*_T30=(struct Cyc_Absyn_Kind*)_T10;_T11=(struct Cyc_Absyn_Kind*)_T30;_T12=_T11->kind;_T13=(int)_T12;switch(_T13){case Cyc_Absyn_PtrBndKind: _T14=name;_T15=_untag_fat_ptr_check_bound(_T14,sizeof(char),1U);_T16=(const char*)_T15;{
# 200
struct ptrbnd_*pbc=ptrbnd_constant(_T16);_T17=bv;{struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*_T31=_cycalloc(sizeof(struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct));_T31->tag=0;
_T31->f1=pbc;_T18=(struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*)_T31;}*_T17=(void*)_T18;{struct Cyc_List_List*_T31=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple11*_T32=_cycalloc(sizeof(struct _tuple11));
_T32->f0=cvar;_T32->f1=pbc;_T1A=(struct _tuple11*)_T32;}_T31->hd=_T1A;_T31->tl=Cyc_BansheeIf_pbconsts;_T19=(struct Cyc_List_List*)_T31;}Cyc_BansheeIf_pbconsts=_T19;goto _LL5;}case Cyc_Absyn_EffKind: _T1B=name;_T1C=_untag_fat_ptr_check_bound(_T1B,sizeof(char),1U);_T1D=(const char*)_T1C;{
# 205
struct effect_*effc=effect_constant(_T1D);_T1E=bv;{struct Cyc_BansheeIf_BvarEffect_BansheeIf_BansheeVar_struct*_T31=_cycalloc(sizeof(struct Cyc_BansheeIf_BvarEffect_BansheeIf_BansheeVar_struct));_T31->tag=1;
_T31->f1=effc;_T1F=(struct Cyc_BansheeIf_BvarEffect_BansheeIf_BansheeVar_struct*)_T31;}*_T1E=(void*)_T1F;{struct Cyc_List_List*_T31=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple12*_T32=_cycalloc(sizeof(struct _tuple12));
_T32->f0=cvar;_T32->f1=effc;_T21=(struct _tuple12*)_T32;}_T31->hd=_T21;_T31->tl=Cyc_BansheeIf_effconsts;_T20=(struct Cyc_List_List*)_T31;}Cyc_BansheeIf_effconsts=_T20;goto _LL5;}default:{struct Cyc_Warn_String_Warn_Warg_struct _T31;_T31.tag=0;
# 213
_T31.f1=_tag_fat("add_constant: Unsupported or null cvar kind",sizeof(char),44U);_T22=_T31;}{struct Cyc_Warn_String_Warn_Warg_struct _T31=_T22;void*_T32[1];_T23=_T32 + 0;*_T23=& _T31;_T25=Cyc_Warn_impos2;{int(*_T33)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T25;_T24=_T33;}_T26=_tag_fat(_T32,sizeof(void*),1);_T24(_T26);}}_LL5:;}goto _LL0;}_TL7:{struct Cyc_Warn_String_Warn_Warg_struct _T30;_T30.tag=0;
# 217
_T30.f1=_tag_fat("add_constant: Bad type",sizeof(char),23U);_T27=_T30;}{struct Cyc_Warn_String_Warn_Warg_struct _T30=_T27;{struct Cyc_Warn_Typ_Warn_Warg_struct _T31;_T31.tag=2;_T31.f1=cvar;_T28=_T31;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T31=_T28;void*_T32[2];_T29=_T32 + 0;*_T29=& _T30;_T2A=_T32 + 1;*_T2A=& _T31;_T2C=Cyc_Warn_impos2;{int(*_T33)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T2C;_T2B=_T33;}_T2D=_tag_fat(_T32,sizeof(void*),2);_T2B(_T2D);}}_LL0:;}
# 221
...
# 245
void*Cyc_BansheeIf_cmpeq_constraint(void*t1,void*t2){struct _tuple13 _T0;void*_T1;int*_T2;int _T3;void*_T4;int*_T5;int _T6;void*_T7;void*_T8;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T9;void**_TA;void*_TB;void*_TC;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_TD;void**_TE;void**_TF;void*_T10;void**_T11;void*_T12;struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct*_T13;void*_T14;struct Cyc_Warn_String_Warn_Warg_struct _T15;struct Cyc_Warn_Typ_Warn_Warg_struct _T16;struct Cyc_Warn_Typ_Warn_Warg_struct _T17;void**_T18;void**_T19;void**_T1A;int(*_T1B)(struct _fat_ptr);void*(*_T1C)(struct _fat_ptr);struct _fat_ptr _T1D;{struct _tuple13 _T1E;
_T1E.f0=t1;_T1E.f1=t2;_T0=_T1E;}{struct _tuple13 _T1E=_T0;void*_T1F;void*_T20;_T1=_T1E.f0;_T2=(int*)_T1;_T3=*_T2;if(_T3!=3)goto _TLC;_T4=_T1E.f1;_T5=(int*)_T4;_T6=*_T5;if(_T6!=3)goto _TLE;_T7=_T1E.f0;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T21=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T7;_T8=_T1E.f0;_T9=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T8;_TA=& _T9->f4;_T20=(void**)_TA;}_TB=_T1E.f1;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T21=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_TB;_TC=_T1E.f1;_TD=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_TC;_TE=& _TD->f4;_T1F=(void**)_TE;}{void**bv1=(void**)_T20;void**bv2=(void**)_T1F;_TF=bv1;_T10=*_TF;
# 248
if(_T10!=0)goto _TL10;Cyc_BansheeIf_add_variable(t1);goto _TL11;_TL10: _TL11: _T11=bv2;_T12=*_T11;
if(_T12!=0)goto _TL12;Cyc_BansheeIf_add_variable(t2);goto _TL13;_TL12: _TL13:{struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct*_T21=_cycalloc(sizeof(struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct));_T21->tag=1;
_T21->f1=3U;_T21->f2=t1;_T21->f3=t2;_T21->f4=_tag_fat(0,0,0);_T13=(struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct*)_T21;}_T14=(void*)_T13;return _T14;}_TLE: goto _LL3;_TLC: _LL3:{struct Cyc_Warn_String_Warn_Warg_struct _T21;_T21.tag=0;
# 252
_T21.f1=_tag_fat("cmpeq_constraint: Bad types for constraint - ",sizeof(char),46U);_T15=_T21;}{struct Cyc_Warn_String_Warn_Warg_struct _T21=_T15;{struct Cyc_Warn_Typ_Warn_Warg_struct _T22;_T22.tag=2;_T22.f1=t1;_T16=_T22;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T22=_T16;{struct Cyc_Warn_Typ_Warn_Warg_struct _T23;_T23.tag=2;_T23.f1=t2;_T17=_T23;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T23=_T17;void*_T24[3];_T18=_T24 + 0;*_T18=& _T21;_T19=_T24 + 1;*_T19=& _T22;_T1A=_T24 + 2;*_T1A=& _T23;_T1C=Cyc_Warn_impos2;{int(*_T25)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T1C;_T1B=_T25;}_T1D=_tag_fat(_T24,sizeof(void*),3);_T1B(_T1D);}}};}}
# 255
void*Cyc_BansheeIf_cmpsubset_constraint(void*t1,void*t2){struct Cyc_Warn_String_Warn_Warg_struct _T0;void**_T1;int(*_T2)(struct _fat_ptr);void*(*_T3)(struct _fat_ptr);struct _fat_ptr _T4;struct _tuple13 _T5;void*_T6;int*_T7;int _T8;void*_T9;int*_TA;int _TB;void*_TC;void*_TD;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_TE;void**_TF;void*_T10;void*_T11;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T12;void**_T13;void**_T14;void*_T15;void**_T16;void*_T17;struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct*_T18;void*_T19;struct Cyc_Warn_String_Warn_Warg_struct _T1A;struct Cyc_Warn_Typ_Warn_Warg_struct _T1B;struct Cyc_Warn_Typ_Warn_Warg_struct _T1C;void**_T1D;void**_T1E;void**_T1F;int(*_T20)(struct _fat_ptr);void*(*_T21)(struct _fat_ptr);struct _fat_ptr _T22;{struct Cyc_Warn_String_Warn_Warg_struct _T23;_T23.tag=0;
_T23.f1=_tag_fat("cmpsubset_constraint: Not yet supported",sizeof(char),40U);_T0=_T23;}{struct Cyc_Warn_String_Warn_Warg_struct _T23=_T0;void*_T24[1];_T1=_T24 + 0;*_T1=& _T23;_T3=Cyc_Warn_impos2;{int(*_T25)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T3;_T2=_T25;}_T4=_tag_fat(_T24,sizeof(void*),1);_T2(_T4);}{struct _tuple13 _T23;
_T23.f0=t1;_T23.f1=t2;_T5=_T23;}{struct _tuple13 _T23=_T5;void*_T24;void*_T25;_T6=_T23.f0;_T7=(int*)_T6;_T8=*_T7;if(_T8!=3)goto _TL14;_T9=_T23.f1;_TA=(int*)_T9;_TB=*_TA;if(_TB!=3)goto _TL16;_TC=_T23.f0;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T26=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_TC;_TD=_T23.f0;_TE=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_TD;_TF=& _TE->f4;_T25=(void**)_TF;}_T10=_T23.f1;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T26=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T10;_T11=_T23.f1;_T12=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T11;_T13=& _T12->f4;_T24=(void**)_T13;}{void**bv1=(void**)_T25;void**bv2=(void**)_T24;_T14=bv1;_T15=*_T14;
# 259
if(_T15!=0)goto _TL18;Cyc_BansheeIf_add_variable(t1);goto _TL19;_TL18: _TL19: _T16=bv2;_T17=*_T16;
if(_T17!=0)goto _TL1A;Cyc_BansheeIf_add_variable(t2);goto _TL1B;_TL1A: _TL1B:{struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct*_T26=_cycalloc(sizeof(struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct));_T26->tag=1;
_T26->f1=4U;_T26->f2=t1;_T26->f3=t2;_T26->f4=_tag_fat(0,0,0);_T18=(struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct*)_T26;}_T19=(void*)_T18;return _T19;}_TL16: goto _LL3;_TL14: _LL3:{struct Cyc_Warn_String_Warn_Warg_struct _T26;_T26.tag=0;
# 263
_T26.f1=_tag_fat("cmpsubset_constraint: Bad types for constraint - ",sizeof(char),50U);_T1A=_T26;}{struct Cyc_Warn_String_Warn_Warg_struct _T26=_T1A;{struct Cyc_Warn_Typ_Warn_Warg_struct _T27;_T27.tag=2;_T27.f1=t1;_T1B=_T27;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T27=_T1B;{struct Cyc_Warn_Typ_Warn_Warg_struct _T28;_T28.tag=2;_T28.f1=t2;_T1C=_T28;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T28=_T1C;void*_T29[3];_T1D=_T29 + 0;*_T1D=& _T26;_T1E=_T29 + 1;*_T1E=& _T27;_T1F=_T29 + 2;*_T1F=& _T28;_T21=Cyc_Warn_impos2;{int(*_T2A)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T21;_T20=_T2A;}_T22=_tag_fat(_T29,sizeof(void*),3);_T20(_T22);}}};}}
# 267
...
_T1E.f0=t1;_T1E.f1=t2;_T0=_T1E;}{struct _tuple13 _T1E=_T0;void*_T1F;void*_T20;_T1=_T1E.f0;_T2=(int*)_T1;_T3=*_T2;if(_T3!=3)goto _TL1C;_T4=_T1E.f1;_T5=(int*)_T4;_T6=*_T5;if(_T6!=3)goto _TL1E;_T7=_T1E.f0;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T21=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T7;_T8=_T1E.f0;_T9=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T8;_TA=& _T9->f4;_T20=(void**)_TA;}_TB=_T1E.f1;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T21=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_TB;_TC=_T1E.f1;_TD=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_TC;_TE=& _TD->f4;_T1F=(void**)_TE;}{void**bv1=(void**)_T20;void**bv2=(void**)_T1F;_TF=bv1;_T10=*_TF;
# 270
if(_T10!=0)goto _TL20;Cyc_BansheeIf_add_variable(t1);goto _TL21;_TL20: _TL21: _T11=bv2;_T12=*_T11;
if(_T12!=0)goto _TL22;Cyc_BansheeIf_add_variable(t2);goto _TL23;_TL22: _TL23:{struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*_T21=_cycalloc(sizeof(struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct));_T21->tag=2;
_T21->f1=t1;_T21->f2=t2;_T21->f3=c;_T21->f4=_tag_fat(0,0,0);_T13=(struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*)_T21;}_T14=(void*)_T13;return _T14;}_TL1E: goto _LL3;_TL1C: _LL3:{struct Cyc_Warn_String_Warn_Warg_struct _T21;_T21.tag=0;
# 274
_T21.f1=_tag_fat("equality_constraint: Bad types for constraint - ",sizeof(char),49U);_T15=_T21;}{struct Cyc_Warn_String_Warn_Warg_struct _T21=_T15;{struct Cyc_Warn_Typ_Warn_Warg_struct _T22;_T22.tag=2;_T22.f1=t1;_T16=_T22;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T22=_T16;{struct Cyc_Warn_Typ_Warn_Warg_struct _T23;_T23.tag=2;_T23.f1=t2;_T17=_T23;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T23=_T17;void*_T24[3];_T18=_T24 + 0;*_T18=& _T21;_T19=_T24 + 1;*_T19=& _T22;_T1A=_T24 + 2;*_T1A=& _T23;_T1C=Cyc_Warn_impos2;{int(*_T25)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T1C;_T1B=_T25;}_T1D=_tag_fat(_T24,sizeof(void*),3);_T1B(_T1D);}}};}}
# 278
...
# 286
void*Cyc_BansheeIf_inclusion_constraint(void*t1,void*t2){struct _tuple13 _T0;void*_T1;int*_T2;int _T3;void*_T4;int*_T5;int _T6;void*_T7;void*_T8;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T9;void**_TA;void*_TB;void*_TC;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_TD;void**_TE;void**_TF;void*_T10;void**_T11;void*_T12;struct _tuple13 _T13;void**_T14;void**_T15;void*_T16;void*_T17;int*_T18;int _T19;void*_T1A;void*_T1B;int*_T1C;int _T1D;struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*_T1E;void*_T1F;struct Cyc_Warn_String_Warn_Warg_struct _T20;void**_T21;int(*_T22)(struct _fat_ptr);void*(*_T23)(struct _fat_ptr);struct _fat_ptr _T24;struct Cyc_Warn_String_Warn_Warg_struct _T25;struct Cyc_Warn_Typ_Warn_Warg_struct _T26;struct Cyc_Warn_Typ_Warn_Warg_struct _T27;void**_T28;void**_T29;void**_T2A;int(*_T2B)(struct _fat_ptr);void*(*_T2C)(struct _fat_ptr);struct _fat_ptr _T2D;{struct _tuple13 _T2E;
_T2E.f0=t1;_T2E.f1=t2;_T0=_T2E;}{struct _tuple13 _T2E=_T0;void*_T2F;void*_T30;_T1=_T2E.f0;_T2=(int*)_T1;_T3=*_T2;if(_T3!=3)goto _TL24;_T4=_T2E.f1;_T5=(int*)_T4;_T6=*_T5;if(_T6!=3)goto _TL26;_T7=_T2E.f0;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T31=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T7;_T8=_T2E.f0;_T9=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T8;_TA=& _T9->f4;_T30=(void**)_TA;}_TB=_T2E.f1;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T31=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_TB;_TC=_T2E.f1;_TD=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_TC;_TE=& _TD->f4;_T2F=(void**)_TE;}{void**bv1=(void**)_T30;void**bv2=(void**)_T2F;_TF=bv1;_T10=*_TF;
# 289
if(_T10!=0)goto _TL28;Cyc_BansheeIf_add_variable(t1);goto _TL29;_TL28: _TL29: _T11=bv2;_T12=*_T11;
if(_T12!=0)goto _TL2A;Cyc_BansheeIf_add_variable(t2);goto _TL2B;_TL2A: _TL2B:{struct _tuple13 _T31;_T14=bv1;
_T31.f0=*_T14;_T15=bv2;_T31.f1=*_T15;_T13=_T31;}{struct _tuple13 _T31=_T13;_T16=_T31.f0;if(_T16==0)goto _TL2C;_T17=_T31.f0;_T18=(int*)_T17;_T19=*_T18;if(_T19!=1)goto _TL2E;_T1A=_T31.f1;if(_T1A==0)goto _TL30;_T1B=_T31.f1;_T1C=(int*)_T1B;_T1D=*_T1C;if(_T1D!=1)goto _TL32;{struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*_T32=_cycalloc(sizeof(struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct));_T32->tag=2;
# 293
_T32->f1=t1;_T32->f2=t2;_T32->f3=0;_T32->f4=_tag_fat(0,0,0);_T1E=(struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*)_T32;}_T1F=(void*)_T1E;return _T1F;_TL32: goto _LL8;_TL30: goto _LL8;_TL2E: goto _LL8;_TL2C: _LL8:{struct Cyc_Warn_String_Warn_Warg_struct _T32;_T32.tag=0;
# 295
_T32.f1=_tag_fat("inclusion_constraint: Term sort doesn't permit inclusion constraints",sizeof(char),69U);_T20=_T32;}{struct Cyc_Warn_String_Warn_Warg_struct _T32=_T20;void*_T33[1];_T21=_T33 + 0;*_T21=& _T32;_T23=Cyc_Warn_impos2;{int(*_T34)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T23;_T22=_T34;}_T24=_tag_fat(_T33,sizeof(void*),1);_T22(_T24);};}}goto _TL27;_TL26: goto _LL3;_TL27: goto _TL25;_TL24: _LL3:{struct Cyc_Warn_String_Warn_Warg_struct _T31;_T31.tag=0;
# 298
_T31.f1=_tag_fat("inclusion_constraint: Bad types for constraint - ",sizeof(char),50U);_T25=_T31;}{struct Cyc_Warn_String_Warn_Warg_struct _T31=_T25;{struct Cyc_Warn_Typ_Warn_Warg_struct _T32;_T32.tag=2;_T32.f1=t1;_T26=_T32;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T32=_T26;{struct Cyc_Warn_Typ_Warn_Warg_struct _T33;_T33.tag=2;_T33.f1=t2;_T27=_T33;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T33=_T27;void*_T34[3];_T28=_T34 + 0;*_T28=& _T31;_T29=_T34 + 1;*_T29=& _T32;_T2A=_T34 + 2;*_T2A=& _T33;_T2C=Cyc_Warn_impos2;{int(*_T35)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T2C;_T2B=_T35;}_T2D=_tag_fat(_T34,sizeof(void*),3);_T2B(_T2D);}}}_TL25:;}}
# 302
...
# 306
static void*Cyc_BansheeIf_composite_constraint(enum Cyc_BansheeIf_ConstraintOperator op,void*t1,void*t2){enum Cyc_BansheeIf_ConstraintOperator _T0;struct Cyc_Warn_String_Warn_Warg_struct _T1;void**_T2;int(*_T3)(struct _fat_ptr);void*(*_T4)(struct _fat_ptr);struct _fat_ptr _T5;struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*_T6;void*_T7;void*_T8;unsigned _T9;void*_TA;unsigned _TB;struct Cyc_Warn_String_Warn_Warg_struct _TC;void**_TD;int(*_TE)(struct _fat_ptr);void*(*_TF)(struct _fat_ptr);struct _fat_ptr _T10;struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*_T11;void*_T12;_T0=op;if(_T0!=Cyc_BansheeIf_NegOp)goto _TL34;
# 309
if(t2==0)goto _TL36;{struct Cyc_Warn_String_Warn_Warg_struct _T13;_T13.tag=0;
_T13.f1=_tag_fat("composite_constraint: Neg constraint is unary",sizeof(char),46U);_T1=_T13;}{struct Cyc_Warn_String_Warn_Warg_struct _T13=_T1;void*_T14[1];_T2=_T14 + 0;*_T2=& _T13;_T4=Cyc_Warn_impos2;{int(*_T15)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T4;_T3=_T15;}_T5=_tag_fat(_T14,sizeof(void*),1);_T3(_T5);}goto _TL37;_TL36: _TL37:{struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*_T13=_cycalloc(sizeof(struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct));_T13->tag=5;
_T13->f1=op;_T13->f2=t1;_T13->f3=0;_T13->f4=_tag_fat(0,0,0);_T6=(struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*)_T13;}_T7=(void*)_T6;return _T7;_TL34: _T8=t1;_T9=(unsigned)_T8;
# 313
if(_T9)goto _TL3B;else{goto _TL3A;}_TL3B: _TA=t2;_TB=(unsigned)_TA;if(_TB)goto _TL38;else{goto _TL3A;}
_TL3A:{struct Cyc_Warn_String_Warn_Warg_struct _T13;_T13.tag=0;_T13.f1=_tag_fat("composite_constraint: Binary constraint missing argument",sizeof(char),57U);_TC=_T13;}{struct Cyc_Warn_String_Warn_Warg_struct _T13=_TC;void*_T14[1];_TD=_T14 + 0;*_TD=& _T13;_TF=Cyc_Warn_impos2;{int(*_T15)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_TF;_TE=_T15;}_T10=_tag_fat(_T14,sizeof(void*),1);_TE(_T10);}goto _TL39;_TL38: _TL39:{struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*_T13=_cycalloc(sizeof(struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct));_T13->tag=5;
_T13->f1=op;_T13->f2=t1;_T13->f3=t2;_T13->f4=_tag_fat(0,0,0);_T11=(struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*)_T13;}_T12=(void*)_T11;return _T12;;}
# 319
...
# 381 "bansheeif.cyc"
static struct _fat_ptr Cyc_BansheeIf_cvar2string(void*t1,int xc){int _T0;int _T1;int _T2;struct _fat_ptr _T3;struct _fat_ptr _T4;struct Cyc_String_pa_PrintArg_struct _T5;void*_T6;void**_T7;struct _fat_ptr _T8;struct _fat_ptr _T9;_T0=
...
_TL49: _T3=Cyc_Absynpp_typ2string(t1);return _T3;_TL47:{struct Cyc_String_pa_PrintArg_struct _TA;_TA.tag=0;_T6=
Cyc_Absyn_compress(t1);_TA.f1=Cyc_Absynpp_typ2string(_T6);_T5=_TA;}{struct Cyc_String_pa_PrintArg_struct _TA=_T5;void*_TB[1];_T7=_TB + 0;*_T7=& _TA;_T8=_tag_fat("\"%s\"",sizeof(char),5U);_T9=_tag_fat(_TB,sizeof(void*),1);_T4=Cyc_aprintf(_T8,_T9);}return _T4;}
# 387
...
if(!_T5)goto _TL50;_T4="true";goto _TL51;_TL50: _T4="false";_TL51: return _T4;}_TL4E:
 return 0;;}
# 401
static struct _fat_ptr Cyc_BansheeIf__constraint2string(void*c,int xcvar){void*_T0;int*_T1;unsigned _T2;void*_T3;void*_T4;struct _fat_ptr _T5;struct Cyc_String_pa_PrintArg_struct _T6;struct Cyc_String_pa_PrintArg_struct _T7;void**_T8;void**_T9;struct _fat_ptr _TA;struct _fat_ptr _TB;void*_TC;void*_TD;void*_TE;struct _fat_ptr _TF;struct Cyc_String_pa_PrintArg_struct _T10;struct Cyc_String_pa_PrintArg_struct _T11;struct Cyc_String_pa_PrintArg_struct _T12;struct Cyc_String_pa_PrintArg_struct _T13;void**_T14;void**_T15;void**_T16;void**_T17;struct _fat_ptr _T18;struct _fat_ptr _T19;void*_T1A;void*_T1B;void*_T1C;int _T1D;struct _fat_ptr _T1E;struct Cyc_String_pa_PrintArg_struct _T1F;struct Cyc_String_pa_PrintArg_struct _T20;struct Cyc_String_pa_PrintArg_struct _T21;void**_T22;void**_T23;void**_T24;struct _fat_ptr _T25;struct _fat_ptr _T26;struct _fat_ptr _T27;struct Cyc_String_pa_PrintArg_struct _T28;struct Cyc_String_pa_PrintArg_struct _T29;struct Cyc_String_pa_PrintArg_struct _T2A;void**_T2B;void**_T2C;void**_T2D;struct _fat_ptr _T2E;struct _fat_ptr _T2F;void*_T30;void*_T31;void*_T32;struct _fat_ptr _T33;struct Cyc_String_pa_PrintArg_struct _T34;struct Cyc_String_pa_PrintArg_struct _T35;struct Cyc_String_pa_PrintArg_struct _T36;void**_T37;void**_T38;void**_T39;struct _fat_ptr _T3A;struct _fat_ptr _T3B;void*_T3C;void*_T3D;void*_T3E;struct _fat_ptr _T3F;struct Cyc_String_pa_PrintArg_struct _T40;struct Cyc_String_pa_PrintArg_struct _T41;struct Cyc_String_pa_PrintArg_struct _T42;void**_T43;void**_T44;void**_T45;struct _fat_ptr _T46;struct _fat_ptr _T47;void*_T48;void*_T49;void*_T4A;struct _fat_ptr _T4B;struct Cyc_String_pa_PrintArg_struct _T4C;struct Cyc_String_pa_PrintArg_struct _T4D;struct Cyc_String_pa_PrintArg_struct _T4E;struct Cyc_String_pa_PrintArg_struct _T4F;void*_T50;int _T51;void**_T52;void**_T53;void**_T54;void**_T55;struct _fat_ptr _T56;struct _fat_ptr _T57;int _T58;void*_T59;enum Cyc_BansheeIf_ConstraintOperator _T5A;struct _fat_ptr _T5B;void*_T5C;_T0=c;_T1=(int*)_T0;_T2=*_T1;switch(_T2){case 0: _T3=c;{struct Cyc_BansheeIf_CheckConstraint_BansheeIf_Constraint_struct*_T5D=(struct Cyc_BansheeIf_CheckConstraint_BansheeIf_Constraint_struct*)_T3;_T4=_T5D->f1;_T5C=(void*)_T4;_T5B=_T5D->f2;}{void*c1=_T5C;struct _fat_ptr loc=_T5B;{struct Cyc_String_pa_PrintArg_struct _T5D;_T5D.tag=0;
# 403
_T5D.f1=loc;_T6=_T5D;}{struct Cyc_String_pa_PrintArg_struct _T5D=_T6;{struct Cyc_String_pa_PrintArg_struct _T5E;_T5E.tag=0;_T5E.f1=Cyc_BansheeIf__constraint2string(c1,xcvar);_T7=_T5E;}{struct Cyc_String_pa_PrintArg_struct _T5E=_T7;void*_T5F[2];_T8=_T5F + 0;*_T8=& _T5D;_T9=_T5F + 1;*_T9=& _T5E;_TA=_tag_fat("\"%s\"!(%s)",sizeof(char),10U);_TB=_tag_fat(_T5F,sizeof(void*),2);_T5=Cyc_aprintf(_TA,_TB);}}return _T5;}case 1: _TC=c;{struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct*_T5D=(struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct*)_TC;_T5A=_T5D->f1;_TD=_T5D->f2;_T5C=(void*)_TD;_TE=_T5D->f3;_T59=(void*)_TE;_T5B=_T5D->f4;}{enum Cyc_BansheeIf_ConstraintOperator op=_T5A;void*t1=_T5C;void*t2=_T59;struct _fat_ptr loc=_T5B;{struct Cyc_String_pa_PrintArg_struct _T5D;_T5D.tag=0;
_T5D.f1=loc;_T10=_T5D;}{struct Cyc_String_pa_PrintArg_struct _T5D=_T10;{struct Cyc_String_pa_PrintArg_struct _T5E;_T5E.tag=0;_T5E.f1=Cyc_BansheeIf_op2string(op);_T11=_T5E;}{struct Cyc_String_pa_PrintArg_struct _T5E=_T11;{struct Cyc_String_pa_PrintArg_struct _T5F;_T5F.tag=0;_T5F.f1=Cyc_BansheeIf_cvar2string(t1,xcvar);_T12=_T5F;}{struct Cyc_String_pa_PrintArg_struct _T5F=_T12;{struct Cyc_String_pa_PrintArg_struct _T60;_T60.tag=0;_T60.f1=Cyc_BansheeIf_cvar2string(t2,xcvar);_T13=_T60;}{struct Cyc_String_pa_PrintArg_struct _T60=_T13;void*_T61[4];_T14=_T61 + 0;*_T14=& _T5D;_T15=_T61 + 1;*_T15=& _T5E;_T16=_T61 + 2;*_T16=& _T5F;_T17=_T61 + 3;*_T17=& _T60;_T18=_tag_fat("\"%s\"^(%s,%s,%s)",sizeof(char),16U);_T19=_tag_fat(_T61,sizeof(void*),4);_TF=Cyc_aprintf(_T18,_T19);}}}}return _TF;}case 2: _T1A=c;{struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*_T5D=(struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*)_T1A;_T1B=_T5D->f1;_T5C=(void*)_T1B;_T1C=_T5D->f2;_T59=(void*)_T1C;_T58=_T5D->f3;_T5B=_T5D->f4;}{void*t1=_T5C;void*t2=_T59;int b=_T58;struct _fat_ptr loc=_T5B;_T1D=b;
# 406
if(!_T1D)goto _TL53;{struct Cyc_String_pa_PrintArg_struct _T5D;_T5D.tag=0;
_T5D.f1=loc;_T1F=_T5D;}{struct Cyc_String_pa_PrintArg_struct _T5D=_T1F;{struct Cyc_String_pa_PrintArg_struct _T5E;_T5E.tag=0;_T5E.f1=Cyc_BansheeIf_cvar2string(t1,xcvar);_T20=_T5E;}{struct Cyc_String_pa_PrintArg_struct _T5E=_T20;{struct Cyc_String_pa_PrintArg_struct _T5F;_T5F.tag=0;_T5F.f1=Cyc_BansheeIf_cvar2string(t2,xcvar);_T21=_T5F;}{struct Cyc_String_pa_PrintArg_struct _T5F=_T21;void*_T60[3];_T22=_T60 + 0;*_T22=& _T5D;_T23=_T60 + 1;*_T23=& _T5E;_T24=_T60 + 2;*_T24=& _T5F;_T25=_tag_fat("\"%s\"?(%s,%s)",sizeof(char),13U);_T26=_tag_fat(_T60,sizeof(void*),3);_T1E=Cyc_aprintf(_T25,_T26);}}}return _T1E;
# 410
_TL53:{struct Cyc_String_pa_PrintArg_struct _T5D;_T5D.tag=0;_T5D.f1=loc;_T28=_T5D;}{struct Cyc_String_pa_PrintArg_struct _T5D=_T28;{struct Cyc_String_pa_PrintArg_struct _T5E;_T5E.tag=0;_T5E.f1=Cyc_BansheeIf_cvar2string(t1,xcvar);_T29=_T5E;}{struct Cyc_String_pa_PrintArg_struct _T5E=_T29;{struct Cyc_String_pa_PrintArg_struct _T5F;_T5F.tag=0;_T5F.f1=Cyc_BansheeIf_cvar2string(t2,xcvar);_T2A=_T5F;}{struct Cyc_String_pa_PrintArg_struct _T5F=_T2A;void*_T60[3];_T2B=_T60 + 0;*_T2B=& _T5D;_T2C=_T60 + 1;*_T2C=& _T5E;_T2D=_T60 + 2;*_T2D=& _T5F;_T2E=_tag_fat("\"%s\"=(%s,%s)",sizeof(char),13U);_T2F=_tag_fat(_T60,sizeof(void*),3);_T27=Cyc_aprintf(_T2E,_T2F);}}}return _T27;}case 3: _T30=c;{struct Cyc_BansheeIf_InclusionConstraint_BansheeIf_Constraint_struct*_T5D=(struct Cyc_BansheeIf_InclusionConstraint_BansheeIf_Constraint_struct*)_T30;_T31=_T5D->f1;_T5C=(void*)_T31;_T32=_T5D->f2;_T59=(void*)_T32;_T5B=_T5D->f3;}{void*t1=_T5C;void*t2=_T59;struct _fat_ptr loc=_T5B;{struct Cyc_String_pa_PrintArg_struct _T5D;_T5D.tag=0;
_T5D.f1=loc;_T34=_T5D;}{struct Cyc_String_pa_PrintArg_struct _T5D=_T34;{struct Cyc_String_pa_PrintArg_struct _T5E;_T5E.tag=0;
_T5E.f1=Cyc_BansheeIf_cvar2string(t1,xcvar);_T35=_T5E;}{struct Cyc_String_pa_PrintArg_struct _T5E=_T35;{struct Cyc_String_pa_PrintArg_struct _T5F;_T5F.tag=0;_T5F.f1=Cyc_BansheeIf_cvar2string(t2,xcvar);_T36=_T5F;}{struct Cyc_String_pa_PrintArg_struct _T5F=_T36;void*_T60[3];_T37=_T60 + 0;*_T37=& _T5D;_T38=_T60 + 1;*_T38=& _T5E;_T39=_T60 + 2;*_T39=& _T5F;_T3A=
# 411
_tag_fat("\"%s\"<(%s,%s)",sizeof(char),13U);_T3B=_tag_fat(_T60,sizeof(void*),3);_T33=Cyc_aprintf(_T3A,_T3B);}}}return _T33;}case 4: _T3C=c;{struct Cyc_BansheeIf_ImplicationConstraint_BansheeIf_Constraint_struct*_T5D=(struct Cyc_BansheeIf_ImplicationConstraint_BansheeIf_Constraint_struct*)_T3C;_T3D=_T5D->f1;_T5C=(void*)_T3D;_T3E=_T5D->f2;_T59=(void*)_T3E;_T5B=_T5D->f3;}{void*c1=_T5C;void*c2=_T59;struct _fat_ptr loc=_T5B;{struct Cyc_String_pa_PrintArg_struct _T5D;_T5D.tag=0;
# 413
_T5D.f1=loc;_T40=_T5D;}{struct Cyc_String_pa_PrintArg_struct _T5D=_T40;{struct Cyc_String_pa_PrintArg_struct _T5E;_T5E.tag=0;_T5E.f1=Cyc_BansheeIf__constraint2string(c1,xcvar);_T41=_T5E;}{struct Cyc_String_pa_PrintArg_struct _T5E=_T41;{struct Cyc_String_pa_PrintArg_struct _T5F;_T5F.tag=0;_T5F.f1=Cyc_BansheeIf__constraint2string(c2,xcvar);_T42=_T5F;}{struct Cyc_String_pa_PrintArg_struct _T5F=_T42;void*_T60[3];_T43=_T60 + 0;*_T43=& _T5D;_T44=_T60 + 1;*_T44=& _T5E;_T45=_T60 + 2;*_T45=& _T5F;_T46=_tag_fat("\"%s\">(%s,%s)",sizeof(char),13U);_T47=_tag_fat(_T60,sizeof(void*),3);_T3F=Cyc_aprintf(_T46,_T47);}}}return _T3F;}default: _T48=c;{struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*_T5D=(struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*)_T48;_T5A=_T5D->f1;_T49=_T5D->f2;_T5C=(void*)_T49;_T4A=_T5D->f3;_T59=(void*)_T4A;_T5B=_T5D->f4;}{enum Cyc_BansheeIf_ConstraintOperator op=_T5A;void*c1=_T5C;void*c2=_T59;struct _fat_ptr loc=_T5B;{struct Cyc_String_pa_PrintArg_struct _T5D;_T5D.tag=0;
# 415
_T5D.f1=loc;_T4C=_T5D;}{struct Cyc_String_pa_PrintArg_struct _T5D=_T4C;{struct Cyc_String_pa_PrintArg_struct _T5E;_T5E.tag=0;
_T5E.f1=Cyc_BansheeIf__constraint2string(c1,xcvar);_T4D=_T5E;}{struct Cyc_String_pa_PrintArg_struct _T5E=_T4D;{struct Cyc_String_pa_PrintArg_struct _T5F;_T5F.tag=0;
_T5F.f1=Cyc_BansheeIf_op2string(op);_T4E=_T5F;}{struct Cyc_String_pa_PrintArg_struct _T5F=_T4E;{struct Cyc_String_pa_PrintArg_struct _T60;_T60.tag=0;_T50=_check_null(c2);_T51=xcvar;_T60.f1=Cyc_BansheeIf__constraint2string(_T50,_T51);_T4F=_T60;}{struct Cyc_String_pa_PrintArg_struct _T60=_T4F;void*_T61[4];_T52=_T61 + 0;*_T52=& _T5D;_T53=_T61 + 1;*_T53=& _T5E;_T54=_T61 + 2;*_T54=& _T5F;_T55=_T61 + 3;*_T55=& _T60;_T56=
# 415
_tag_fat("\"%s\"+(%s,%s,%s)",sizeof(char),16U);_T57=_tag_fat(_T61,sizeof(void*),4);_T4B=Cyc_aprintf(_T56,_T57);}}}}return _T4B;}};}
# 420
...
# 424
static void Cyc_BansheeIf_print_constraints(struct Cyc_List_List*c){struct Cyc_List_List*_T0;unsigned _T1;struct Cyc_String_pa_PrintArg_struct _T2;struct Cyc_List_List*_T3;void*_T4;void**_T5;struct Cyc___cycFILE*_T6;struct _fat_ptr _T7;struct _fat_ptr _T8;struct Cyc_List_List*_T9;
_TL58: _T0=c;_T1=(unsigned)_T0;if(_T1)goto _TL56;else{goto _TL57;}
_TL56:{struct Cyc_String_pa_PrintArg_struct _TA;_TA.tag=0;_T3=c;_T4=_T3->hd;_TA.f1=Cyc_BansheeIf_constraint2string(_T4);_T2=_TA;}{struct Cyc_String_pa_PrintArg_struct _TA=_T2;void*_TB[1];_T5=_TB + 0;*_T5=& _TA;_T6=Cyc_stderr;_T7=_tag_fat("%s\n",sizeof(char),4U);_T8=_tag_fat(_TB,sizeof(void*),1);Cyc_fprintf(_T6,_T7,_T8);}_T9=c;
# 425
c=_T9->tl;goto _TL58;_TL57:;}
# 435
static int Cyc_BansheeIf_nodelay_add_constraint(void*c){void*_T0;int*_T1;unsigned _T2;void*_T3;struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*_T4;void*_T5;int*_T6;int _T7;void*_T8;struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*_T9;void*_TA;int*_TB;int _TC;void*_TD;void*_TE;void*_TF;void*_T10;void*_T11;struct _tuple13 _T12;void*_T13;void*_T14;int*_T15;int _T16;void*_T17;void*_T18;int*_T19;int _T1A;void*_T1B;void*_T1C;int _T1D;void*_T1E;unsigned _T1F;void*_T20;unsigned _T21;struct Cyc_Warn_String_Warn_Warg_struct _T22;struct Cyc_Warn_String_Warn_Warg_struct _T23;void**_T24;void**_T25;struct _fat_ptr _T26;int _T27;struct Cyc___cycFILE*_T28;struct _fat_ptr _T29;struct _fat_ptr _T2A;int _T2B;int(*_T2C)(struct _fat_ptr,struct _fat_ptr);void*(*_T2D)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T2E;struct _fat_ptr _T2F;void*_T30;void*_T31;void*_T32;enum Cyc_BansheeIf_ConstraintOperator _T33;int _T34;int(*_T35)(struct _fat_ptr,struct _fat_ptr);void*(*_T36)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T37;struct _fat_ptr _T38;int _T39;int _T3A;void*_T3B;void*_T3C;void*_T3D;void*_T3E;int(*_T3F)(struct _fat_ptr,struct _fat_ptr);void*(*_T40)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T41;struct _fat_ptr _T42;int(*_T43)(struct _fat_ptr,struct _fat_ptr);void*(*_T44)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T45;struct _fat_ptr _T46;enum Cyc_BansheeIf_ConstraintOperator _T47;int _T48;void*_T49;void*_T4A;void*_T4B;void*_T4C;_T0=c;_T1=(int*)_T0;_T2=*_T1;switch(_T2){case 2: _T3=c;_T4=(struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*)_T3;_T5=_T4->f1;_T6=(int*)_T5;_T7=*_T6;if(_T7!=3)goto _TL5A;_T8=c;_T9=(struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*)_T8;_TA=_T9->f2;_TB=(int*)_TA;_TC=*_TB;if(_TC!=3)goto _TL5C;_TD=c;{struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*_T4D=(struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*)_TD;_TE=_T4D->f1;_T4C=(void*)_TE;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T4E=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T4C;_TF=_T4E->f4;_T4B=(void*)_TF;}_T10=_T4D->f2;_T4A=(void*)_T10;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T4E=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T4A;_T11=_T4E->f4;_T49=(void*)_T11;}_T48=_T4D->f3;}{void*t1=_T4C;void*bv1=_T4B;void*t2=_T4A;void*bv2=_T49;int b=_T48;{struct _tuple13 _T4D;
# 438
_T4D.f0=bv1;_T4D.f1=bv2;_T12=_T4D;}{struct _tuple13 _T4D=_T12;struct ptrbnd_*_T4E;struct ptrbnd_*_T4F;_T13=_T4D.f0;if(_T13==0)goto _TL5E;_T14=_T4D.f0;_T15=(int*)_T14;_T16=*_T15;if(_T16!=0)goto _TL60;_T17=_T4D.f1;if(_T17==0)goto _TL62;_T18=_T4D.f1;_T19=(int*)_T18;_T1A=*_T19;if(_T1A!=0)goto _TL64;_T1B=_T4D.f0;{struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*_T50=(struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*)_T1B;_T4F=_T50->f1;}_T1C=_T4D.f1;{struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*_T50=(struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*)_T1C;_T4E=_T50->f1;}{struct ptrbnd_*pb1=_T4F;struct ptrbnd_*pb2=_T4E;
# 440
...
Cyc_BansheeIf_resolve(t2);{struct Cyc_Warn_String_Warn_Warg_struct _T50;_T50.tag=0;
# 449
_T50.f1=_tag_fat("Unsatisfiable constraint ",sizeof(char),26U);_T22=_T50;}{struct Cyc_Warn_String_Warn_Warg_struct _T50=_T22;{struct Cyc_Warn_String_Warn_Warg_struct _T51;_T51.tag=0;_T51.f1=Cyc_BansheeIf__constraint2string(c,0);_T23=_T51;}{struct Cyc_Warn_String_Warn_Warg_struct _T51=_T23;void*_T52[2];_T24=_T52 + 0;*_T24=& _T50;_T25=_T52 + 1;*_T25=& _T51;_T26=_tag_fat(_T52,sizeof(void*),2);Cyc_Warn_err2(0U,_T26);}}
# 453
return 0;_TL66: _T27=Cyc_Flags_verbose;
# 455
if(!_T27)goto _TL69;_T28=Cyc_stderr;_T29=
_tag_fat("***Added\n",sizeof(char),10U);_T2A=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T28,_T29,_T2A);goto _TL6A;_TL69: _TL6A: _T2B=b;
if(!_T2B)goto _TL6B;
ptrbnd_cunify(pb1,pb2);goto _TL6C;
# 461
_TL6B: ptrbnd_unify(pb1,pb2);_TL6C:
# 463
 return 1;}_TL64: goto _LLC;_TL62: goto _LLC;_TL60: goto _LLC;_TL5E: _LLC: _T2D=Cyc_Warn_impos;{
# 465
int(*_T50)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T2D;_T2C=_T50;}_T2E=_tag_fat("Kind not yet supported",sizeof(char),23U);_T2F=_tag_fat(0U,sizeof(void*),0);_T2C(_T2E,_T2F);;}goto _LL0;}_TL5C: goto _LL7;_TL5A: goto _LL7;case 5: _T30=c;{struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*_T4D=(struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*)_T30;_T47=_T4D->f1;_T31=_T4D->f2;_T4C=(void*)_T31;_T32=_T4D->f3;_T4B=(void*)_T32;}{enum Cyc_BansheeIf_ConstraintOperator op=_T47;void*c1=_T4C;void*c2=_T4B;_T33=op;_T34=(int)_T33;
# 469
if(_T34==0)goto _TL6D;_T36=Cyc_Warn_impos;{
int(*_T4D)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T36;_T35=_T4D;}_T37=_tag_fat("Disjunctions and negations require a delay",sizeof(char),43U);_T38=_tag_fat(0U,sizeof(void*),0);_T35(_T37,_T38);goto _TL6E;_TL6D: _TL6E: _T3A=
Cyc_BansheeIf_nodelay_add_constraint(c1);if(!_T3A)goto _TL6F;_T3B=
_check_null(c2);_T39=Cyc_BansheeIf_nodelay_add_constraint(_T3B);goto _TL70;_TL6F: _T39=0;_TL70:
# 471
 return _T39;}case 3: _T3C=c;{struct Cyc_BansheeIf_InclusionConstraint_BansheeIf_Constraint_struct*_T4D=(struct Cyc_BansheeIf_InclusionConstraint_BansheeIf_Constraint_struct*)_T3C;_T3D=_T4D->f1;_T4C=(void*)_T3D;_T3E=_T4D->f2;_T4B=(void*)_T3E;}{void*bv1=_T4C;void*bv2=_T4B;_T40=Cyc_Warn_impos;{
# 474
int(*_T4D)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T40;_T3F=_T4D;}_T41=_tag_fat("setIF sort not yet supported",sizeof(char),29U);_T42=_tag_fat(0U,sizeof(void*),0);_T3F(_T41,_T42);}default: _LL7: _T44=Cyc_Warn_impos;{
# 476
int(*_T4D)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T44;_T43=_T4D;}_T45=_tag_fat("No implications allowed",sizeof(char),24U);_T46=_tag_fat(0U,sizeof(void*),0);_T43(_T45,_T46);}_LL0:;}
# 480
...
return _T1C;}
# 519
int Cyc_BansheeIf_add_constraint(unsigned loc,void*c){struct _fat_ptr _T0;void*_T1;int _T2;struct Cyc_String_pa_PrintArg_struct _T3;struct Cyc_String_pa_PrintArg_struct _T4;void**_T5;void**_T6;struct Cyc___cycFILE*_T7;struct _fat_ptr _T8;struct _fat_ptr _T9;int _TA;int _TB;struct Cyc___cycFILE*_TC;struct _fat_ptr _TD;struct _fat_ptr _TE;int _TF;_T0=
...
if(!_T2)goto _TL79;{struct Cyc_String_pa_PrintArg_struct _T10;_T10.tag=0;
_T10.f1=Cyc_Position_string_of_loc(loc);_T3=_T10;}{struct Cyc_String_pa_PrintArg_struct _T10=_T3;{struct Cyc_String_pa_PrintArg_struct _T11;_T11.tag=0;_T11.f1=Cyc_BansheeIf__constraint2string(c,0);_T4=_T11;}{struct Cyc_String_pa_PrintArg_struct _T11=_T4;void*_T12[2];_T5=_T12 + 0;*_T5=& _T10;_T6=_T12 + 1;*_T6=& _T11;_T7=Cyc_stderr;_T8=_tag_fat("-- (%s) Adding constraint : %s \t",sizeof(char),33U);_T9=_tag_fat(_T12,sizeof(void*),2);Cyc_fprintf(_T7,_T8,_T9);}}goto _TL7A;_TL79: _TL7A: _TA=
Cyc_BansheeIf_internal_add_constraint(c);{int ret=_TA!=0;_TB=Cyc_Flags_verbose;
if(!_TB)goto _TL7B;_TC=Cyc_stderr;_TD=
_tag_fat("\n",sizeof(char),2U);_TE=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_TC,_TD,_TE);goto _TL7C;_TL7B: _TL7C: _TF=ret;
return _TF;}}
# 530
...
_TL99: _T2=l;{void*_T2B=_T2->hd;void*_T2C;void*_T2D;_T3=(int*)_T2B;_T4=*_T3;switch(_T4){case 4:{struct Cyc_BansheeIf_ImplicationConstraint_BansheeIf_Constraint_struct*_T2E=(struct Cyc_BansheeIf_ImplicationConstraint_BansheeIf_Constraint_struct*)_T2B;_T5=_T2E->f1;_T2D=(void*)_T5;_T6=_T2E->f2;_T2C=(void*)_T6;}{void*c1=_T2D;void*c2=_T2C;_T7=
# 569
...
_TL9C: prev=l;_T14=l;
l=_T14->tl;
first=0;_TL9D: goto _LL0;}case 0:{struct Cyc_BansheeIf_CheckConstraint_BansheeIf_Constraint_struct*_T2E=(struct Cyc_BansheeIf_CheckConstraint_BansheeIf_Constraint_struct*)_T2B;_T15=_T2E->f1;_T2D=(void*)_T15;}{void*c1=_T2D;
# 596
first=0;
prev=l;_T16=l;
l=_T16->tl;goto _LL0;}default: _T18=Cyc_Warn_impos;{
# 609 "bansheeif.cyc"
int(*_T2E)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T18;_T17=_T2E;}_T19=_tag_fat("Malformed delayed constraint; only implications permitted",sizeof(char),58U);_T1A=_tag_fat(0U,sizeof(void*),0);_T17(_T19,_T1A);}_LL0:;}goto _TL98;_TL9A:;}_T1B=changed;
# 561 "bansheeif.cyc"
...
_TLA9: _T1E=dc;{void*_T2B=_T1E->hd;void*_T2C;_T1F=(int*)_T2B;_T20=*_T1F;if(_T20!=0)goto _TLAC;{struct Cyc_BansheeIf_CheckConstraint_BansheeIf_Constraint_struct*_T2D=(struct Cyc_BansheeIf_CheckConstraint_BansheeIf_Constraint_struct*)_T2B;_T21=_T2D->f1;_T2C=(void*)_T21;}{void*c1=_T2C;_T22=
# 617
Cyc_BansheeIf_eval_guard(c1);if(_T22)goto _TLAE;else{goto _TLB0;}
_TLB0:{struct Cyc_Warn_String_Warn_Warg_struct _T2D;_T2D.tag=0;_T2D.f1=_tag_fat("Constraint could not be proved: ",sizeof(char),33U);_T23=_T2D;}{struct Cyc_Warn_String_Warn_Warg_struct _T2D=_T23;{struct Cyc_Warn_String_Warn_Warg_struct _T2E;_T2E.tag=0;_T25=dc;_T26=_T25->hd;_T2E.f1=Cyc_BansheeIf_constraint2string(_T26);_T24=_T2E;}{struct Cyc_Warn_String_Warn_Warg_struct _T2E=_T24;void*_T2F[2];_T27=_T2F + 0;*_T27=& _T2D;_T28=_T2F + 1;*_T28=& _T2E;_T29=_tag_fat(_T2F,sizeof(void*),2);Cyc_Warn_err2(0U,_T29);}}goto _TLAF;_TLAE: _TLAF: goto _LL7;}_TLAC: goto _LL7;_LL7:;}_T2A=dc;
# 614
dc=_T2A->tl;goto _TLAB;_TLAA:;}
# 625
return 1;}
# 628
int Cyc_BansheeIf_resolve(void*cvar){void*_T0;int*_T1;int _T2;void*_T3;void*_T4;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T5;void**_T6;void*_T7;void**_T8;void*_T9;unsigned _TA;void*_TB;int*_TC;unsigned _TD;void*_TE;void*_TF;unsigned _T10;void**_T11;void*_T12;struct list*_T13;unsigned _T14;struct Cyc_List_List*_T15;unsigned _T16;struct Cyc_List_List*_T17;void*_T18;struct _tuple12*_T19;struct effect_*_T1A;struct effect_*_T1B;int _T1C;struct Cyc_List_List*_T1D;struct Cyc_List_List*_T1E;void*_T1F;struct _tuple12*_T20;struct Cyc_List_List*_T21;struct Cyc_List_List*_T22;unsigned _T23;void**_T24;int(*_T25)(struct _fat_ptr,struct _fat_ptr);void*(*_T26)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T27;struct _fat_ptr _T28;struct Cyc_Warn_String_Warn_Warg_struct _T29;struct Cyc_Warn_Typ_Warn_Warg_struct _T2A;void**_T2B;void**_T2C;int(*_T2D)(struct _fat_ptr);void*(*_T2E)(struct _fat_ptr);struct _fat_ptr _T2F;void*_T30;void*_T31;_T0=cvar;_T1=(int*)_T0;_T2=*_T1;if(_T2!=3)goto _TLB1;_T3=cvar;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T32=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T3;_T4=cvar;_T5=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T4;_T6=& _T5->f2;_T31=(void**)_T6;_T7=_T32->f4;_T30=(void*)_T7;}{void**t=(void**)_T31;void*bv=_T30;_T8=t;_T9=*_T8;_TA=(unsigned)_T9;
# 631
if(!_TA)goto _TLB3;
return 1;_TLB3:{struct effect_*_T32;struct ptrbnd_*_T33;if(bv==0)goto _TLB5;_TB=bv;_TC=(int*)_TB;_TD=*_TC;switch(_TD){case 0: _TE=bv;{struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*_T34=(struct Cyc_BansheeIf_BvarPtrBnd_BansheeIf_BansheeVar_struct*)_TE;_T33=_T34->f1;}{struct ptrbnd_*pb=_T33;
# 635
...
return 1;_TLB8:
# 641
 return 0;}case 1: _T12=bv;{struct Cyc_BansheeIf_BvarEffect_BansheeIf_BansheeVar_struct*_T34=(struct Cyc_BansheeIf_BvarEffect_BansheeIf_BansheeVar_struct*)_T12;_T32=_T34->f1;}{struct effect_*ef=_T32;
# 643
...
_TLBF: _T17=l;_T18=_T17->hd;_T19=(struct _tuple12*)_T18;_T1A=_T19->f1;_T1B=effect_list_head(efl);_T1C=effect_eq(_T1A,_T1B);if(!_T1C)goto _TLC2;{struct Cyc_List_List*_T34=_cycalloc(sizeof(struct Cyc_List_List));_T1E=l;_T1F=_T1E->hd;_T20=(struct _tuple12*)_T1F;
_T34->hd=_T20->f0;_T34->tl=set;_T1D=(struct Cyc_List_List*)_T34;}set=_T1D;goto _TLC3;_TLC2: _TLC3: _T21=l;
# 646
...
# 658
int(*_T34)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T26;_T25=_T34;}_T27=_tag_fat("Attempt to resolve a variable that was never added",sizeof(char),51U);_T28=_tag_fat(0U,sizeof(void*),0);_T25(_T27,_T28);_TLB6:;}goto _LL0;}_TLB1:{struct Cyc_Warn_String_Warn_Warg_struct _T32;_T32.tag=0;
# 662
_T32.f1=_tag_fat("Bad type to resolve; expect Cvar only",sizeof(char),38U);_T29=_T32;}{struct Cyc_Warn_String_Warn_Warg_struct _T32=_T29;{struct Cyc_Warn_Typ_Warn_Warg_struct _T33;_T33.tag=2;_T33.f1=cvar;_T2A=_T33;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T33=_T2A;void*_T34[2];_T2B=_T34 + 0;*_T2B=& _T32;_T2C=_T34 + 1;*_T2C=& _T33;_T2E=Cyc_Warn_impos2;{int(*_T35)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T2E;_T2D=_T35;}_T2F=_tag_fat(_T34,sizeof(void*),2);_T2D(_T2F);}}_LL0:;}
# 671
...
# 724
static struct Cyc_List_List*Cyc_BansheeIf_cvars_in_constraint(void*c){void*_T0;int*_T1;unsigned _T2;void*_T3;void*_T4;void*_T5;void*_T6;void*_T7;void*_T8;void*_T9;void*_TA;void*_TB;int _TC;struct Cyc_List_List*_TD;void**_TE;struct _fat_ptr _TF;int _T10;int _T11;struct Cyc_List_List*_T12;struct Cyc_List_List*_T13;void*_T14;void*_T15;struct Cyc_List_List*_T16;void*_T17;void*_T18;void*_T19;void*_T1A;void*_T1B;void*_T1C;struct Cyc_List_List*_T1D;struct Cyc_List_List*(*_T1E)(int(*)(struct Cyc_List_List*,void*),struct Cyc_List_List*,struct Cyc_List_List*);struct Cyc_List_List*(*_T1F)(int(*)(void*,void*),void*,struct Cyc_List_List*);struct Cyc_List_List*_T20;void*_T21;struct Cyc_List_List*_T22;struct Cyc_List_List*_T23;struct Cyc_List_List*_T24;void*_T25;void*_T26;_T0=c;_T1=(int*)_T0;_T2=*_T1;switch(_T2){case 1: _T3=c;{struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct*_T27=(struct Cyc_BansheeIf_ComparisonConstraint_BansheeIf_Constraint_struct*)_T3;_T4=_T27->f2;_T26=(void*)_T4;_T5=_T27->f3;_T25=(void*)_T5;}{void*cv1=_T26;void*cv2=_T25;_T26=cv1;_T25=cv2;goto _LL4;}case 2: _T6=c;{struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*_T27=(struct Cyc_BansheeIf_EqualityConstraint_BansheeIf_Constraint_struct*)_T6;_T7=_T27->f1;_T26=(void*)_T7;_T8=_T27->f2;_T25=(void*)_T8;}_LL4: {void*cv1=_T26;void*cv2=_T25;_T26=cv1;_T25=cv2;goto _LL6;}case 3: _T9=c;{struct Cyc_BansheeIf_InclusionConstraint_BansheeIf_Constraint_struct*_T27=(struct Cyc_BansheeIf_InclusionConstraint_BansheeIf_Constraint_struct*)_T9;_TA=_T27->f1;_T26=(void*)_TA;_TB=_T27->f2;_T25=(void*)_TB;}_LL6: {void*cv1=_T26;void*cv2=_T25;
# 729
struct Cyc_List_List*ret=0;_TC=
Cyc_BansheeIf_is_constant(cv1);if(_TC)goto _TLDA;else{goto _TLDC;}
_TLDC:{void*_T27[1];_TE=_T27 + 0;*_TE=cv1;_TF=_tag_fat(_T27,sizeof(void*),1);_TD=Cyc_List_list(_TF);}ret=_TD;goto _TLDB;_TLDA: _TLDB: _T10=
Cyc_BansheeIf_cvarcmp(cv1,cv2);if(!_T10)goto _TLDD;_T11=Cyc_BansheeIf_is_constant(cv2);if(_T11)goto _TLDD;else{goto _TLDF;}
_TLDF:{struct Cyc_List_List*_T27=_cycalloc(sizeof(struct Cyc_List_List));_T27->hd=cv2;_T27->tl=ret;_T12=(struct Cyc_List_List*)_T27;}ret=_T12;goto _TLDE;_TLDD: _TLDE: _T13=ret;
return _T13;}case 0: _T14=c;{struct Cyc_BansheeIf_CheckConstraint_BansheeIf_Constraint_struct*_T27=(struct Cyc_BansheeIf_CheckConstraint_BansheeIf_Constraint_struct*)_T14;_T15=_T27->f1;_T26=(void*)_T15;}{void*c1=_T26;_T16=
Cyc_BansheeIf_cvars_in_constraint(c1);return _T16;}case 4: _T17=c;{struct Cyc_BansheeIf_ImplicationConstraint_BansheeIf_Constraint_struct*_T27=(struct Cyc_BansheeIf_ImplicationConstraint_BansheeIf_Constraint_struct*)_T17;_T18=_T27->f1;_T26=(void*)_T18;_T19=_T27->f2;_T25=(void*)_T19;}{void*c1=_T26;void*c2=_T25;_T26=c1;_T25=c2;goto _LLC;}default: _T1A=c;{struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*_T27=(struct Cyc_BansheeIf_CompositeConstraint_BansheeIf_Constraint_struct*)_T1A;_T1B=_T27->f2;_T26=(void*)_T1B;_T1C=_T27->f3;_T25=(void*)_T1C;}_LLC: {void*c1=_T26;void*c2=_T25;
# 738
struct Cyc_List_List*l1=Cyc_BansheeIf_cvars_in_constraint(c1);_T1D=l1;_T1F=Cyc_List_filter_c;{
struct Cyc_List_List*(*_T27)(int(*)(struct Cyc_List_List*,void*),struct Cyc_List_List*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(int(*)(struct Cyc_List_List*,void*),struct Cyc_List_List*,struct Cyc_List_List*))_T1F;_T1E=_T27;}_T20=l1;_T21=_check_null(c2);_T22=Cyc_BansheeIf_cvars_in_constraint(_T21);_T23=_T1E(Cyc_BansheeIf_not_in_list,_T20,_T22);_T24=Cyc_List_append(_T1D,_T23);return _T24;}};}
# 743
...
# 820
 return 0;}
# 824
static void Cyc_BansheeIf_reintroduce_cvar(void*_cvar){struct _handler_cons*_T0;int*_T1;int _T2;struct _tuple14*(*_T3)(struct Cyc_Hashtable_Table*,void*);void*(*_T4)(struct Cyc_Hashtable_Table*,void*);struct Cyc_Hashtable_Table*_T5;void*_T6;void*_T7;struct Cyc_Core_Not_found_exn_struct*_T8;char*_T9;char*_TA;struct Cyc_Warn_String_Warn_Warg_struct _TB;struct Cyc_Warn_Typ_Warn_Warg_struct _TC;void**_TD;void**_TE;int(*_TF)(struct _fat_ptr);void*(*_T10)(struct _fat_ptr);struct _fat_ptr _T11;struct _tuple14*_T12;struct _tuple14*_T13;enum Cyc_BansheeIf_CvarRecordState*_T14;enum Cyc_BansheeIf_CvarRecordState*_T15;enum Cyc_BansheeIf_CvarRecordState _T16;int _T17;enum Cyc_BansheeIf_CvarRecordState*_T18;void*_T19;int*_T1A;int _T1B;void*_T1C;void*_T1D;void*_T1E;struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T1F;void**_T20;void**_T21;void*_T22;unsigned _T23;int(*_T24)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_T25)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _T26;struct _fat_ptr _T27;struct Cyc_List_List*_T28;unsigned _T29;struct Cyc_List_List*_T2A;void*_T2B;int _T2C;int(*_T2D)(struct _fat_ptr,struct _fat_ptr);void*(*_T2E)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T2F;struct _fat_ptr _T30;int _T31;struct Cyc_String_pa_PrintArg_struct _T32;struct Cyc_List_List*_T33;void*_T34;void**_T35;struct Cyc___cycFILE*_T36;struct _fat_ptr _T37;struct _fat_ptr _T38;struct Cyc_List_List*_T39;void*_T3A;struct Cyc_List_List*_T3B;struct Cyc_List_List*_T3C;enum Cyc_BansheeIf_CvarRecordState*_T3D;int(*_T3E)(struct _fat_ptr,struct _fat_ptr);void*(*_T3F)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T40;struct _fat_ptr _T41;
struct _tuple14*val;{struct _handler_cons _T42;_T0=& _T42;_push_handler(_T0);{int _T43=0;_T1=_T42.handler;_T2=setjmp(_T1);if(!_T2)goto _TL11F;_T43=1;goto _TL120;_TL11F: _TL120: if(_T43)goto _TL121;else{goto _TL123;}_TL123: _T4=Cyc_Hashtable_lookup;{
# 827
struct _tuple14*(*_T44)(struct Cyc_Hashtable_Table*,void*)=(struct _tuple14*(*)(struct Cyc_Hashtable_Table*,void*))_T4;_T3=_T44;}_T5=_check_null(Cyc_BansheeIf_cvarmap);_T6=_cvar;val=_T3(_T5,_T6);_pop_handler();goto _TL122;_TL121: _T7=Cyc_Core_get_exn_thrown();{void*_T44=(void*)_T7;void*_T45;_T8=(struct Cyc_Core_Not_found_exn_struct*)_T44;_T9=_T8->tag;_TA=Cyc_Core_Not_found;if(_T9!=_TA)goto _TL124;{struct Cyc_Warn_String_Warn_Warg_struct _T46;_T46.tag=0;
# 830
_T46.f1=_tag_fat("Constraint graph refers to an undefined constraint variable",sizeof(char),60U);_TB=_T46;}{struct Cyc_Warn_String_Warn_Warg_struct _T46=_TB;{struct Cyc_Warn_Typ_Warn_Warg_struct _T47;_T47.tag=2;_T47.f1=_cvar;_TC=_T47;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T47=_TC;void*_T48[2];_TD=_T48 + 0;*_TD=& _T46;_TE=_T48 + 1;*_TE=& _T47;_T10=Cyc_Warn_impos2;{int(*_T49)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T10;_TF=_T49;}_T11=_tag_fat(_T48,sizeof(void*),2);_TF(_T11);}}goto _TL125;_TL124: _T45=_T44;{void*exn=_T45;_rethrow(exn);}_TL125:;}_TL122:;}}{void*_T42;struct Cyc_List_List*_T43;void*_T44;_T12=val;{struct _tuple14 _T45=*_T12;_T44=_T45.f0;_T43=_T45.f1;_T13=val;_T14=& _T13->f2;_T42=(enum Cyc_BansheeIf_CvarRecordState*)_T14;}{void*cv=_T44;struct Cyc_List_List*cnstr=_T43;enum Cyc_BansheeIf_CvarRecordState*state=(enum Cyc_BansheeIf_CvarRecordState*)_T42;_T15=state;_T16=*_T15;_T17=(int)_T16;
# 835
if(_T17==1)goto _TL126;return;_TL126: _T18=state;
*_T18=2U;{const char*_T45;const char*_T46;void*_T47;int _T48;void*_T49;struct Cyc_Core_Opt*_T4A;_T19=cv;_T1A=(int*)_T19;_T1B=*_T1A;if(_T1B!=3)goto _TL128;_T1C=cv;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T4B=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T1C;_T4A=_T4B->f1;_T1D=_T4B->f2;_T49=(void*)_T1D;_T48=_T4B->f3;_T1E=cv;_T1F=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T1E;_T20=& _T1F->f4;_T47=(void**)_T20;_T46=_T4B->f5;_T45=_T4B->f6;}{struct Cyc_Core_Opt*ok=_T4A;void*topt=_T49;int id=_T48;void**bv=(void**)_T47;const char*name=_T46;const char*pos=_T45;_T21=bv;_T22=*_T21;_T23=(unsigned)_T22;
# 839
if(_T23)goto _TL12A;else{goto _TL12C;}
_TL12C: if(cnstr!=0)goto _TL12D;goto _TL12E;_TL12D: _T25=Cyc___assert_fail;{int(*_T4B)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T25;_T24=_T4B;}_T26=_tag_fat("cnstr==0",sizeof(char),9U);_T27=_tag_fat("bansheeif.cyc",sizeof(char),14U);_T24(_T26,_T27,840U);_TL12E:
 Cyc_BansheeIf_add_variable(cv);goto _TL12B;_TL12A: _TL12B:
# 845
 _TL132: _T28=cnstr;_T29=(unsigned)_T28;if(_T29)goto _TL130;else{goto _TL131;}
_TL130: _T2A=cnstr;_T2B=_T2A->hd;_T2C=Cyc_BansheeIf_internal_add_constraint(_T2B);if(_T2C!=0)goto _TL133;_T2E=Cyc_Warn_impos;{
int(*_T4B)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T2E;_T2D=_T4B;}_T2F=_tag_fat("Failed to reintroduce a constraint",sizeof(char),35U);_T30=_tag_fat(0U,sizeof(void*),0);_T2D(_T2F,_T30);goto _TL134;_TL133: _TL134: _T31=Cyc_Flags_verbose;
if(!_T31)goto _TL135;{struct Cyc_String_pa_PrintArg_struct _T4B;_T4B.tag=0;_T33=cnstr;_T34=_T33->hd;
_T4B.f1=Cyc_BansheeIf__constraint2string(_T34,0);_T32=_T4B;}{struct Cyc_String_pa_PrintArg_struct _T4B=_T32;void*_T4C[1];_T35=_T4C + 0;*_T35=& _T4B;_T36=Cyc_stderr;_T37=_tag_fat("-- Reintro'd constraint : %s \n",sizeof(char),31U);_T38=_tag_fat(_T4C,sizeof(void*),1);Cyc_fprintf(_T36,_T37,_T38);}goto _TL136;_TL135: _TL136: _T39=cnstr;_T3A=_T39->hd;{
# 851
struct Cyc_List_List*cvars=Cyc_BansheeIf_cvars_in_constraint(_T3A);_T3B=cvars;
Cyc_List_iter(Cyc_BansheeIf_reintroduce_cvar,_T3B);}_T3C=cnstr;
# 845
cnstr=_T3C->tl;goto _TL132;_TL131: _T3D=state;
# 854
*_T3D=3U;goto _LL8;}_TL128: _T3F=Cyc_Warn_impos;{
# 857
int(*_T4B)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T3F;_T3E=_T4B;}_T40=_tag_fat("Unexpected type",sizeof(char),16U);_T41=_tag_fat(0U,sizeof(void*),0);_T3E(_T40,_T41);_LL8:;}
# 859
return;}}}
# 862
...
# 872
static void Cyc_BansheeIf_persist_cvar_entry(void*ig,struct _tuple14*entry,struct _tuple15*env){struct _tuple15*_T0;struct _tuple15*_T1;int*_T2;struct _tuple14*_T3;struct _tuple14*_T4;enum Cyc_BansheeIf_CvarRecordState*_T5;enum Cyc_BansheeIf_CvarRecordState*_T6;enum Cyc_BansheeIf_CvarRecordState _T7;int _T8;int(*_T9)(struct _fat_ptr,struct _fat_ptr,unsigned);void*(*_TA)(struct _fat_ptr,struct _fat_ptr,unsigned);struct _fat_ptr _TB;struct _fat_ptr _TC;enum Cyc_BansheeIf_CvarRecordState*_TD;enum Cyc_BansheeIf_CvarRecordState _TE;int _TF;enum Cyc_BansheeIf_CvarRecordState*_T10;enum Cyc_BansheeIf_CvarRecordState _T11;int _T12;struct Cyc_String_pa_PrintArg_struct _T13;struct Cyc_String_pa_PrintArg_struct _T14;struct _fat_ptr _T15;void*_T16;void*_T17;unsigned _T18;struct Cyc_String_pa_PrintArg_struct _T19;struct _fat_ptr _T1A;void*_T1B;void*_T1C;unsigned _T1D;void**_T1E;void**_T1F;void**_T20;struct Cyc___cycFILE*_T21;struct _fat_ptr _T22;struct _fat_ptr _T23;struct Cyc_List_List*_T24;unsigned _T25;struct Cyc_String_pa_PrintArg_struct _T26;struct Cyc_List_List*_T27;void*_T28;void**_T29;struct Cyc___cycFILE*_T2A;struct _fat_ptr _T2B;struct _fat_ptr _T2C;struct Cyc_List_List*_T2D;struct Cyc_List_List*_T2E;unsigned _T2F;struct Cyc___cycFILE*_T30;struct _fat_ptr _T31;struct _fat_ptr _T32;struct Cyc_List_List*_T33;void*_T34;struct Cyc_List_List*_T35;unsigned _T36;struct _handler_cons*_T37;int*_T38;int _T39;struct _tuple14*(*_T3A)(struct Cyc_Hashtable_Table*,void*);void*(*_T3B)(struct Cyc_Hashtable_Table*,void*);struct Cyc_Hashtable_Table*_T3C;struct Cyc_List_List*_T3D;void*_T3E;enum Cyc_BansheeIf_CvarRecordState*_T3F;enum Cyc_BansheeIf_CvarRecordState*_T40;enum Cyc_BansheeIf_CvarRecordState _T41;int _T42;enum Cyc_BansheeIf_CvarRecordState*_T43;int*_T44;void*_T45;struct Cyc_Core_Not_found_exn_struct*_T46;char*_T47;char*_T48;int(*_T49)(struct _fat_ptr,struct _fat_ptr);void*(*_T4A)(struct _fat_ptr,struct _fat_ptr);struct _fat_ptr _T4B;struct _fat_ptr _T4C;struct Cyc_List_List*_T4D;struct Cyc_List_List*_T4E;struct Cyc___cycFILE*_T4F;struct _fat_ptr _T50;struct _fat_ptr _T51;enum Cyc_BansheeIf_CvarRecordState*_T52;void*_T53;struct Cyc___cycFILE*_T54;_T0=env;{struct _tuple15 _T55=*_T0;_T54=_T55.f0;_T1=env;_T2=& _T1->f1;_T53=(int*)_T2;}{struct Cyc___cycFILE*f=_T54;int*changed=(int*)_T53;void*_T55;struct Cyc_List_List*_T56;void*_T57;_T3=entry;{struct _tuple14 _T58=*_T3;_T57=_T58.f0;_T56=_T58.f1;_T4=entry;_T5=& _T4->f2;_T55=(enum Cyc_BansheeIf_CvarRecordState*)_T5;}{void*cv=_T57;struct Cyc_List_List*cs=_T56;enum Cyc_BansheeIf_CvarRecordState*state=(enum Cyc_BansheeIf_CvarRecordState*)_T55;_T6=state;_T7=*_T6;_T8=(int)_T7;
# 875
if(_T8==2)goto _TL13B;goto _TL13C;_TL13B: _TA=Cyc___assert_fail;{int(*_T58)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_TA;_T9=_T58;}_TB=_tag_fat("*state != PERSIST_INPROCESS",sizeof(char),28U);_TC=_tag_fat("bansheeif.cyc",sizeof(char),14U);_T9(_TB,_TC,875U);_TL13C: _TD=state;_TE=*_TD;_TF=(int)_TE;
if(_TF==0)goto _TL13F;else{goto _TL140;}_TL140: _T10=state;_T11=*_T10;_T12=(int)_T11;if(_T12==4)goto _TL13F;else{goto _TL13D;}
_TL13F: return;_TL13D:{struct Cyc_String_pa_PrintArg_struct _T58;_T58.tag=0;
# 879
_T58.f1=Cyc_BansheeIf_cvar2string(cv,0);_T13=_T58;}{struct Cyc_String_pa_PrintArg_struct _T58=_T13;{struct Cyc_String_pa_PrintArg_struct _T59;_T59.tag=0;{const char*_T5A=Cyc_BansheeIf_cvarloc(cv);_T16=(void*)_T5A;_T17=(void*)_T5A;_T18=_get_zero_arr_size_char(_T17,1U);_T15=_tag_fat(_T16,sizeof(char),_T18);}_T59.f1=_T15;_T14=_T59;}{struct Cyc_String_pa_PrintArg_struct _T59=_T14;{struct Cyc_String_pa_PrintArg_struct _T5A;_T5A.tag=0;{const char*_T5B=Cyc_BansheeIf_cvarorigfat(cv);_T1B=(void*)_T5B;_T1C=(void*)_T5B;_T1D=_get_zero_arr_size_char(_T1C,1U);_T1A=_tag_fat(_T1B,sizeof(char),_T1D);}_T5A.f1=_T1A;_T19=_T5A;}{struct Cyc_String_pa_PrintArg_struct _T5A=_T19;void*_T5B[3];_T1E=_T5B + 0;*_T1E=& _T58;_T1F=_T5B + 1;*_T1F=& _T59;_T20=_T5B + 2;*_T20=& _T5A;_T21=f;_T22=_tag_fat("%s \"%s\", \"%s\" (",sizeof(char),16U);_T23=_tag_fat(_T5B,sizeof(void*),3);Cyc_fprintf(_T21,_T22,_T23);}}}
# 881
_TL144: _T24=cs;_T25=(unsigned)_T24;if(_T25)goto _TL142;else{goto _TL143;}
# 883
_TL142:{struct Cyc_String_pa_PrintArg_struct _T58;_T58.tag=0;_T27=cs;_T28=_T27->hd;_T58.f1=Cyc_BansheeIf__constraint2string(_T28,0);_T26=_T58;}{struct Cyc_String_pa_PrintArg_struct _T58=_T26;void*_T59[1];_T29=_T59 + 0;*_T29=& _T58;_T2A=f;_T2B=_tag_fat("%s",sizeof(char),3U);_T2C=_tag_fat(_T59,sizeof(void*),1);Cyc_fprintf(_T2A,_T2B,_T2C);}_T2D=cs;_T2E=_T2D->tl;_T2F=(unsigned)_T2E;
if(!_T2F)goto _TL145;_T30=f;_T31=
_tag_fat(";",sizeof(char),2U);_T32=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T30,_T31,_T32);goto _TL146;_TL145: _TL146: _T33=cs;_T34=_T33->hd;{
# 887
struct Cyc_List_List*cvars=Cyc_BansheeIf_cvars_in_constraint(_T34);
_TL14A: _T35=cvars;_T36=(unsigned)_T35;if(_T36)goto _TL148;else{goto _TL149;}
_TL148:{struct _handler_cons _T58;_T37=& _T58;_push_handler(_T37);{int _T59=0;_T38=_T58.handler;_T39=setjmp(_T38);if(!_T39)goto _TL14B;_T59=1;goto _TL14C;_TL14B: _TL14C: if(_T59)goto _TL14D;else{goto _TL14F;}_TL14F: _T3B=Cyc_Hashtable_lookup;{
struct _tuple14*(*_T5A)(struct Cyc_Hashtable_Table*,void*)=(struct _tuple14*(*)(struct Cyc_Hashtable_Table*,void*))_T3B;_T3A=_T5A;}_T3C=_check_null(Cyc_BansheeIf_cvarmap);_T3D=cvars;_T3E=_T3D->hd;{struct _tuple14*_T5A=_T3A(_T3C,_T3E);void*_T5B;struct Cyc_List_List*_T5C;void*_T5D;{struct _tuple14 _T5E=*_T5A;_T5D=_T5E.f0;_T5C=_T5E.f1;_T3F=& _T5A->f2;_T5B=(enum Cyc_BansheeIf_CvarRecordState*)_T3F;}{void*cv=_T5D;struct Cyc_List_List*cs=_T5C;enum Cyc_BansheeIf_CvarRecordState*state=(enum Cyc_BansheeIf_CvarRecordState*)_T5B;_T40=state;_T41=*_T40;_T42=(int)_T41;
if(_T42!=0)goto _TL150;_T43=state;
*_T43=1U;_T44=changed;
*_T44=1;goto _TL151;_TL150: _TL151:;}}_pop_handler();goto _TL14E;_TL14D: _T45=Cyc_Core_get_exn_thrown();{void*_T5A=(void*)_T45;void*_T5B;_T46=(struct Cyc_Core_Not_found_exn_struct*)_T5A;_T47=_T46->tag;_T48=Cyc_Core_Not_found;if(_T47!=_T48)goto _TL152;_T4A=Cyc_Warn_impos;{
# 896
int(*_T5C)(struct _fat_ptr,struct _fat_ptr)=(int(*)(struct _fat_ptr,struct _fat_ptr))_T4A;_T49=_T5C;}_T4B=_tag_fat("Constraint refers to an undeclared Cvar",sizeof(char),40U);_T4C=_tag_fat(0U,sizeof(void*),0);_T49(_T4B,_T4C);goto _TL153;_TL152: _T5B=_T5A;{void*exn=_T5B;_rethrow(exn);}_TL153:;}_TL14E:;}}_T4D=cvars;
# 888
cvars=_T4D->tl;goto _TL14A;_TL149:;}_T4E=cs;
# 881
cs=_T4E->tl;goto _TL144;_TL143: _T4F=f;_T50=
# 911 "bansheeif.cyc"
_tag_fat(")\n",sizeof(char),3U);_T51=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T4F,_T50,_T51);_T52=state;
*_T52=4U;}}}
# 915
...
# 1002
static void Cyc_BansheeIf_default_unconstrained_cvar(void*cv,struct _tuple14*entry,void*def){struct _tuple14*_T0;enum Cyc_BansheeIf_CvarRecordState _T1;int _T2;int _T3;void*_T4;int _T5;struct Cyc_Warn_String_Warn_Warg_struct _T6;struct Cyc_Warn_Typ_Warn_Warg_struct _T7;void**_T8;void**_T9;struct _fat_ptr _TA;_T0=entry;_T1=_T0->f2;_T2=(int)_T1;
if(_T2!=3)goto _TL188;_T3=
Cyc_Tcutil_is_cvar_type(cv);if(!_T3)goto _TL18A;_T4=
Cyc_BansheeIf_equality_constraint(cv,def);_T5=Cyc_BansheeIf_internal_add_constraint(_T4);if(_T5!=0)goto _TL18C;{struct Cyc_Warn_String_Warn_Warg_struct _TB;_TB.tag=0;
_TB.f1=_tag_fat("Resolution failed while applying default to Cvar: ",sizeof(char),51U);_T6=_TB;}{struct Cyc_Warn_String_Warn_Warg_struct _TB=_T6;{struct Cyc_Warn_Typ_Warn_Warg_struct _TC;_TC.tag=2;_TC.f1=cv;_T7=_TC;}{struct Cyc_Warn_Typ_Warn_Warg_struct _TC=_T7;void*_TD[2];_T8=_TD + 0;*_T8=& _TB;_T9=_TD + 1;*_T9=& _TC;_TA=_tag_fat(_TD,sizeof(void*),2);Cyc_Warn_err2(0U,_TA);}}goto _TL18D;_TL18C: _TL18D: goto _TL18B;_TL18A: _TL18B: goto _TL189;_TL188: _TL189:;}
# 1011
...
return -1;_TL19E:
 return 0;}
# 1044
static void Cyc_BansheeIf_print_cvar(void*c){struct Cyc_String_pa_PrintArg_struct _T0;void**_T1;struct Cyc___cycFILE*_T2;struct _fat_ptr _T3;struct _fat_ptr _T4;{struct Cyc_String_pa_PrintArg_struct _T5;_T5.tag=0;
_T5.f1=Cyc_BansheeIf_cvar2string(c,0);_T0=_T5;}{struct Cyc_String_pa_PrintArg_struct _T5=_T0;void*_T6[1];_T1=_T6 + 0;*_T1=& _T5;_T2=Cyc_stderr;_T3=_tag_fat("%s",sizeof(char),3U);_T4=_tag_fat(_T6,sizeof(void*),1);Cyc_fprintf(_T2,_T3,_T4);}}
# 1047
static void Cyc_BansheeIf_print_cvarmapval(struct _tuple14*val){struct _tuple14*_T0;struct Cyc_List_List*_T1;unsigned _T2;struct Cyc_String_pa_PrintArg_struct _T3;struct Cyc_List_List*_T4;void*_T5;void**_T6;struct Cyc___cycFILE*_T7;struct _fat_ptr _T8;struct _fat_ptr _T9;struct Cyc_List_List*_TA;_T0=val;{
struct Cyc_List_List*l=_T0->f1;_TL1A3: _T1=l;_T2=(unsigned)_T1;if(_T2)goto _TL1A1;else{goto _TL1A2;}
_TL1A1:{struct Cyc_String_pa_PrintArg_struct _TB;_TB.tag=0;_T4=l;_T5=_T4->hd;_TB.f1=Cyc_BansheeIf_constraint2string(_T5);_T3=_TB;}{struct Cyc_String_pa_PrintArg_struct _TB=_T3;void*_TC[1];_T6=_TC + 0;*_T6=& _TB;_T7=Cyc_stderr;_T8=_tag_fat("%s, ",sizeof(char),5U);_T9=_tag_fat(_TC,sizeof(void*),1);Cyc_fprintf(_T7,_T8,_T9);}_TA=l;
# 1048
l=_TA->tl;goto _TL1A3;_TL1A2:;}}
# 1053
