...
_tmp6B;struct _tuple0 _tmp68=*(*((struct _tuple0**)_check_unknown_subscript(_tmp26,
...
struct _tuple1**)_check_unknown_subscript(_tmp27,sizeof(struct _tuple1*),i)));
_tmp76=_tmp75.f1;_tmp77=_tmp75.f2;{int x_ofs=(int)(x + _tmp76);env=Cyc_Marshal_fprint_type_base(
...
_tmp80=*(*((struct _tuple1**)_check_unknown_subscript(_tmp2A,sizeof(struct _tuple1*),
i)));_tmp81=_tmp80.f1;_tmp82=_tmp80.f2;{int x_ofs=(int)(x + _tmp81);env=Cyc_Marshal_fprint_type_base(
_tmp82,env,fp,((void*(*)(int x))unsafe_cast)(x_ofs));if(i != _get_arr_size(_tmp2A,
sizeof(struct _tuple1*))- 1)({void*_tmp83[0]={};Cyc_fprintf(fp,({const char*_tmp84=", ";
_tag_arr(_tmp84,sizeof(char),_get_zero_arr_size(_tmp84,3));}),_tag_arr(_tmp83,
sizeof(void*),0));});}}}({void*_tmp85[0]={};Cyc_fprintf(fp,({const char*_tmp86=" )";
_tag_arr(_tmp86,sizeof(char),_get_zero_arr_size(_tmp86,3));}),_tag_arr(_tmp85,
sizeof(void*),0));});goto _LL0;}_LL11: if(_tmp1F <= (void*)2?1:*((int*)_tmp1F)!= 5)
goto _LL13;_tmp2B=((struct Cyc_Typerep_TUnion_struct*)_tmp1F)->f1;_tmp2C=((struct
Cyc_Typerep_TUnion_struct*)_tmp1F)->f2;_tmp2D=((struct Cyc_Typerep_TUnion_struct*)
...
struct _tagged_arr)((struct _tagged_arr)Cyc_Typerep_get_tagname(*tagp,_tmp2C));{
void*_tmp87[1]={& _tmp89};Cyc_fprintf(fp,({const char*_tmp88="%s";_tag_arr(_tmp88,
...
_tag_arr(_tmp8F,sizeof(char),_get_zero_arr_size(_tmp8F,6));}),_tag_arr(_tmp8E,
sizeof(void*),1));}});{unsigned int*x=((unsigned int*(*)(unsigned int x))
unsafe_cast)(*tagp);unsigned int tag=*x;int _tmp92;void*_tmp93;struct _tuple4 _tmp91=
Cyc_Typerep_get_unionbranch(tag,_tmp2D);_tmp92=_tmp91.f1;_tmp93=_tmp91.f2;{void*
xoff=((void*(*)(unsigned int x))unsafe_cast)(*tagp + _tmp92);({struct Cyc_String_pa_struct
_tmp96;_tmp96.tag=0;_tmp96.f1=(struct _tagged_arr)((struct _tagged_arr)Cyc_Typerep_get_tagname2(
...
_tmpB0=*(*((struct _tuple3**)_check_unknown_subscript(_tmp31,sizeof(struct _tuple3*),
i)));_tmpB1=_tmpB0.f1;_tmpB2=_tmpB0.f2;({struct Cyc_String_pa_struct _tmpB5;_tmpB5.tag=
0;_tmpB5.f1=(struct _tagged_arr)((struct _tagged_arr)_tmpB1);{void*_tmpB3[1]={&
_tmpB5};Cyc_fprintf(fp,({const char*_tmpB4="%s=";_tag_arr(_tmpB4,sizeof(char),
_get_zero_arr_size(_tmpB4,4));}),_tag_arr(_tmpB3,sizeof(void*),1));}});Cyc_Marshal_fprint_type_base(
_tmpB2,env,fp,val);if(i < _get_arr_size(_tmp31,sizeof(struct _tuple3*))- 1)({void*
_tmpB6[0]={};Cyc_fprintf(fp,({const char*_tmpB7=" | ";_tag_arr(_tmpB7,sizeof(char),
...
_tmp113;struct _tuple0 _tmp111=*(*((struct _tuple0**)_check_unknown_subscript(
_tmp104,sizeof(struct _tuple0*),i)));_tmp112=_tmp111.f1;_tmp113=_tmp111.f3;{int
x_ofs=(int)(x + _tmp112);env=Cyc_Marshal_write_type_base(_tmp113,env,fp,((void*(*)(
int x))unsafe_cast)(x_ofs));}}}goto _LL23;}_LL30: if(_tmpFF <= (void*)2?1:*((int*)
_tmpFF)!= 4)goto _LL32;_tmp105=((struct Cyc_Typerep_Tuple_struct*)_tmpFF)->f2;
_LL31: {int x=((int(*)(void*x))unsafe_cast)(val);{int i=0;for(0;i < _get_arr_size(
_tmp105,sizeof(struct _tuple1*));i ++){unsigned int _tmp115;void*_tmp116;struct
_tuple1 _tmp114=*(*((struct _tuple1**)_check_unknown_subscript(_tmp105,sizeof(
struct _tuple1*),i)));_tmp115=_tmp114.f1;_tmp116=_tmp114.f2;{int x_ofs=(int)(x + 
_tmp115);env=Cyc_Marshal_write_type_base(_tmp116,env,fp,((void*(*)(int x))
unsafe_cast)(x_ofs));}}}goto _LL23;}_LL32: if(_tmpFF <= (void*)2?1:*((int*)_tmpFF)
!= 6)goto _LL34;_tmp106=((struct Cyc_Typerep_TUnionField_struct*)_tmpFF)->f4;_LL33: {
int x=((int(*)(void*x))unsafe_cast)(val);{int i=0;for(0;i < _get_arr_size(_tmp106,
sizeof(struct _tuple1*));i ++){unsigned int _tmp118;void*_tmp119;struct _tuple1
_tmp117=*(*((struct _tuple1**)_check_unknown_subscript(_tmp106,sizeof(struct
_tuple1*),i)));_tmp118=_tmp117.f1;_tmp119=_tmp117.f2;{int x_ofs=(int)(x + _tmp118);
env=Cyc_Marshal_write_type_base(_tmp119,env,fp,((void*(*)(int x))unsafe_cast)(
x_ofs));}}}goto _LL23;}_LL34: if(_tmpFF <= (void*)2?1:*((int*)_tmpFF)!= 5)goto _LL36;
_tmp107=((struct Cyc_Typerep_TUnion_struct*)_tmpFF)->f2;_tmp108=((struct Cyc_Typerep_TUnion_struct*)
_tmpFF)->f3;_LL35: {unsigned int*tagp=((unsigned int*(*)(void*x))unsafe_cast)(
val);if(*tagp < 1024)Cyc_Marshal_cycputvarint(*tagp,fp);else{unsigned int _tmp11A=
Cyc_Marshal_index_lookup(env,*tagp);Cyc_Marshal_cycputvarint(_tmp11A + 1024,fp);
if(!Cyc_Marshal_index_member(env,_tmp11A)){env=Cyc_Marshal_index_insert(env,*
tagp);{unsigned int*x=((unsigned int*(*)(unsigned int x))unsafe_cast)(*tagp);
unsigned int tag=*x;Cyc_Marshal_cycputvarint(tag,fp);{int _tmp11C;void*_tmp11D;
struct _tuple4 _tmp11B=Cyc_Typerep_get_unionbranch(tag,_tmp108);_tmp11C=_tmp11B.f1;
_tmp11D=_tmp11B.f2;{void*xoff=((void*(*)(unsigned int x))unsafe_cast)(*tagp + 
_tmp11C);env=Cyc_Marshal_write_type_base(_tmp11D,env,fp,xoff);}}}}}goto _LL23;}
_LL36: if(_tmpFF <= (void*)2?1:*((int*)_tmpFF)!= 7)goto _LL38;_tmp109=((struct Cyc_Typerep_XTUnion_struct*)
_tmpFF)->f2;_LL37: {unsigned int*xtunionp=((unsigned int*(*)(void*x))unsafe_cast)(
val);unsigned int _tmp11E=Cyc_Marshal_index_lookup(env,*xtunionp);Cyc_Marshal_cycputvarint(
...
_tmp124=_tmp122.f2;{void*xoff=((void*(*)(unsigned int x))unsafe_cast)(*xtunionp + 
_tmp123);env=Cyc_Marshal_write_type_base(_tmp124,env,fp,xoff);}}}}else{Cyc_Marshal_cycputchar('\000',
fp);{char*xtnamec=((char*(*)(unsigned int x))unsafe_cast)(*xtunionp + 4);struct
_tagged_arr xtname=(struct _tagged_arr)Cstring_to_string(xtnamec);({struct Cyc_String_pa_struct
...
_tmp164;void*_tmp165;struct _tuple0 _tmp163=*(*((struct _tuple0**)
_check_unknown_subscript(_tmp14C,sizeof(struct _tuple0*),i)));_tmp164=_tmp163.f1;
...
_tmp167;void*_tmp168;struct _tuple1 _tmp166=*(*((struct _tuple1**)
_check_unknown_subscript(_tmp14D,sizeof(struct _tuple1*),i)));_tmp167=_tmp166.f1;
_tmp168=_tmp166.f2;{int x_ofs=(int)(x + _tmp167);env=Cyc_Marshal_rread_type_base(r,
_tmp168,env,fp,((void*(*)(int x))unsafe_cast)(x_ofs));}}}goto _LL46;}_LL55: if(
...
_check_unknown_subscript(_tmp14E,sizeof(struct _tuple1*),i)));_tmp16A=_tmp169.f1;
...
_check_unknown_subscript(_tmp1A1,sizeof(struct _tuple0*),i)));_tmp1BD=_tmp1BC.f1;
...
void*(*)(int x))unsafe_cast)(y_ofs));}}}goto _LL69;}_LL7C: if(_tmp199 <= (void*)2?1:*((
int*)_tmp199)!= 4)goto _LL7E;_tmp1A2=((struct Cyc_Typerep_Tuple_struct*)_tmp199)->f2;
_LL7D: {int x=((int(*)(void*x))unsafe_cast)(val);int y=((int(*)(void*x))
unsafe_cast)(result);{int i=0;for(0;i < _get_arr_size(_tmp1A2,sizeof(struct _tuple1*));
i ++){unsigned int _tmp1C0;void*_tmp1C1;struct _tuple1 _tmp1BF=*(*((struct _tuple1**)
_check_unknown_subscript(_tmp1A2,sizeof(struct _tuple1*),i)));_tmp1C0=_tmp1BF.f1;
...
_tuple1*));i ++){unsigned int _tmp1C3;void*_tmp1C4;struct _tuple1 _tmp1C2=*(*((
struct _tuple1**)_check_unknown_subscript(_tmp1A3,sizeof(struct _tuple1*),i)));
_tmp1C3=_tmp1C2.f1;_tmp1C4=_tmp1C2.f2;{int x_ofs=(int)(x + _tmp1C3);int y_ofs=(int)(
y + _tmp1C3);env=Cyc_Marshal_rcopy_type_base(r,_tmp1C4,env,((void*(*)(int x))
unsafe_cast)(x_ofs),((void*(*)(int x))unsafe_cast)(y_ofs));}}}goto _LL69;}_LL80:
if(_tmp199 <= (void*)2?1:*((int*)_tmp199)!= 5)goto _LL82;_tmp1A4=((struct Cyc_Typerep_TUnion_struct*)
...
_tmp1C7=_tmp1C5.f2;{struct _tagged_arr buf=({unsigned int _tmp1C8=_tmp1C6 + Cyc_Typerep_size_type(
_tmp1C7);char*_tmp1C9=(char*)_region_malloc(r,_check_times(sizeof(char),_tmp1C8 + 
1));struct _tagged_arr _tmp1CB=_tag_arr(_tmp1C9,sizeof(char),_tmp1C8 + 1);{
...
_check_null(_untag_arr(buf,sizeof(char),1 + 1)));env=((struct Cyc_Dict_Dict*(*)(
...
unsafe_cast)(bufptr + _tmp1C6));}}}}goto _LL69;}_LL82: if(_tmp199 <= (void*)2?1:*((
int*)_tmp199)!= 7)goto _LL84;_tmp1A6=((struct Cyc_Typerep_XTUnion_struct*)_tmp199)->f2;
_LL83: {unsigned int*val0=((unsigned int*(*)(void*x))unsafe_cast)(val);
unsigned int*result0=((unsigned int*(*)(void*x))unsafe_cast)(result);
unsigned int addr=*val0;if(((int(*)(struct Cyc_Dict_Dict*d,unsigned int k))Cyc_Dict_member)(
env,addr))*result0=((unsigned int(*)(struct Cyc_Dict_Dict*d,unsigned int k))Cyc_Dict_lookup)(
...
struct _tuple1**)_check_unknown_subscript(_tmp20B,sizeof(struct _tuple1*),i)));
_tmp23B=_tmp23A.f1;_tmp23C=_tmp23A.f2;{int x_ofs=(int)(x0 + _tmp23B);int y_ofs=(int)(
y0 + _tmp23B);void*_tmp23E;struct Cyc_Dict_Dict*_tmp23F;struct _tuple11 _tmp23D=Cyc_Marshal_leq_eq_type(
...
_tmp242;void*_tmp243;struct _tuple0 _tmp241=*(*((struct _tuple0**)
_check_unknown_subscript(_tmp20C,sizeof(struct _tuple0*),i)));_tmp242=_tmp241.f1;
_tmp243=_tmp241.f3;{int x_ofs=(int)(x0 + _tmp242);int y_ofs=(int)(y0 + _tmp242);void*
_tmp245;struct Cyc_Dict_Dict*_tmp246;struct _tuple11 _tmp244=Cyc_Marshal_leq_eq_type(
...
env;_tmp247;});}_LLAC: if(_tmp1F7 <= (void*)2?1:*((int*)_tmp1F7)!= 6)goto _LLAE;
_tmp20D=((struct Cyc_Typerep_TUnionField_struct*)_tmp1F7)->f4;_LLAD: {int x0=((int(*)(
void*x))unsafe_cast)(x);int y0=((int(*)(void*x))unsafe_cast)(y);void*ord=(void*)1;{
int i=1;for(0;i < _get_arr_size(_tmp20D,sizeof(struct _tuple1*));i ++){unsigned int
_tmp249;void*_tmp24A;struct _tuple1 _tmp248=*(*((struct _tuple1**)
_check_unknown_subscript(_tmp20D,sizeof(struct _tuple1*),i)));_tmp249=_tmp248.f1;
...
unsigned int*y0=((unsigned int*(*)(void*x))unsafe_cast)(y);if(*x0 < 1024?*y0 < 
1024: 0)return({struct _tuple11 _tmp24F;_tmp24F.f1=*x0 == *y0?(void*)1:(*x0 <= *y0?(
void*)2:(void*)0);_tmp24F.f2=env;_tmp24F;});else{if(*x0 < 1024)return({struct
_tuple11 _tmp250;_tmp250.f1=(void*)2;_tmp250.f2=env;_tmp250;});else{if(*y0 < 1024)
return({struct _tuple11 _tmp251;_tmp251.f1=(void*)0;_tmp251.f2=env;_tmp251;});
else{struct _tuple10*_tmp252=({struct _tuple10*_tmp258=_cycalloc_atomic(sizeof(*
_tmp258));_tmp258->f1=*x0;_tmp258->f2=*y0;_tmp258;});if(((int(*)(struct Cyc_Dict_Dict*
d,struct _tuple10*k))Cyc_Dict_member)(env,_tmp252))return({struct _tuple11 _tmp253;
