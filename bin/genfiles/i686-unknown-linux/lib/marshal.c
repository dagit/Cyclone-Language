...
Cstring_to_string(unsigned char*);struct Cyc_List_List{void*hd;struct Cyc_List_List*
...
unsigned int __size,unsigned int __n,struct Cyc_Std___cycFILE*__s);extern
...
Cyc_Dict_lookup_opt(struct Cyc_Dict_Dict*d,void*k);struct _tuple5{void*f1;void*f2;
};struct _tuple5*Cyc_Dict_rchoose(struct _RegionHandle*r,struct Cyc_Dict_Dict*d);
struct _tuple5*Cyc_Dict_rchoose(struct _RegionHandle*,struct Cyc_Dict_Dict*d);void
Cyc_Marshal_fprint_type(void*rep,struct Cyc_Std___cycFILE*fp,void*val);void Cyc_Marshal_print_type(
void*rep,void*val);void Cyc_Marshal_write_type(void*rep,struct Cyc_Std___cycFILE*
fp,void*val);struct _tuple6{struct Cyc_Dict_Dict*f1;int f2;};struct _tuple7{struct
_tagged_arr f1;int f2;};struct _tuple6 Cyc_Marshal_empty_addr_index();struct _tuple6
Cyc_Marshal_write_type_base(void*rep,struct _tuple6 env,struct Cyc_Std___cycFILE*fp,
...
rep,void*x,void*y);int Cyc_Marshal_cmp_type(void*rep,void*x,void*y);void*
...
Cyc_Marshal_uint_cmp),0,0);_tmp3.f2=1;_tmp3;});}static unsigned int Cyc_Marshal_index_lookup(
struct _tuple6 index,unsigned int val){struct Cyc_Dict_Dict*_tmp5;int _tmp6;struct
_tuple6 _tmp4=index;_tmp5=_tmp4.f1;_tmp6=_tmp4.f2;{struct Cyc_Core_Opt*_tmp7=((
struct Cyc_Core_Opt*(*)(struct Cyc_Dict_Dict*d,unsigned int k))Cyc_Dict_lookup_opt)(
_tmp5,val);if(_tmp7 != 0)return(unsigned int)((int)_tmp7->v);else{return(
unsigned int)_tmp6;}}}static struct _tuple6 Cyc_Marshal_index_insert(struct _tuple6
...
int)j)): 0;}}_tmp18;});*((unsigned int*)_check_unknown_subscript(_tmp13,sizeof(
unsigned int),_tmp14))=i;return({struct _tuple7 _tmp19;_tmp19.f1=_tmp13;_tmp19.f2=
_tmp14 + 1;_tmp19;});}static unsigned int Cyc_Marshal_table_lookup(struct _tuple7 tbl,
int i){return*((unsigned int*)_check_unknown_subscript(tbl.f1,sizeof(unsigned int),
i));}static void Cyc_Marshal_fprint_ref(struct Cyc_Std___cycFILE*fp,unsigned int ref){
if(ref == 0)({void*_tmp1A[0]={};Cyc_Std_fprintf(fp,_tag_arr("NULL",sizeof(
unsigned char),5),_tag_arr(_tmp1A,sizeof(void*),0));});else{({struct Cyc_Std_Int_pa_struct
...
struct _tuple9{unsigned int f1;unsigned int f2;unsigned int f3;};struct Cyc_Set_Set*
Cyc_Marshal_fprint_type_base(void*rep,struct Cyc_Set_Set*env,struct Cyc_Std___cycFILE*
fp,void*val){{void*_tmp1D=rep;int _tmp1E;unsigned int _tmp1F;unsigned int _tmp20;
void*_tmp21;void*_tmp22;struct _tagged_arr*_tmp23;struct _tagged_arr _tmp24;struct
...
_tagged_arr*_tmp2E;struct _tagged_arr _tmp2F;int _tmp30;struct _tagged_arr _tmp31;
_LL1: if(_tmp1D <= (void*)2?1:*((int*)_tmp1D)!= 0)goto _LL3;_tmp1E=((struct Cyc_Typerep_Int_struct*)
_tmp1D)->f1;_tmp1F=((struct Cyc_Typerep_Int_struct*)_tmp1D)->f2;_LL2: switch(
_tmp1F){case 8: _LL19: {unsigned char*x=((unsigned char*(*)(void*x))unsafe_cast)(
val);if(isprint((int)*x))({struct Cyc_Std_Int_pa_struct _tmp33;_tmp33.tag=1;_tmp33.f1=(
int)((unsigned int)((int)*x));{void*_tmp32[1]={& _tmp33};Cyc_Std_fprintf(fp,
_tag_arr("'%c'",sizeof(unsigned char),5),_tag_arr(_tmp32,sizeof(void*),1));}});
else{({struct Cyc_Std_Int_pa_struct _tmp35;_tmp35.tag=1;_tmp35.f1=(int)((
unsigned int)((int)*x));{void*_tmp34[1]={& _tmp35};Cyc_Std_fprintf(fp,_tag_arr("'\\%d'",
sizeof(unsigned char),6),_tag_arr(_tmp34,sizeof(void*),1));}});}break;}case 16:
_LL1A: {short*x=((short*(*)(void*x))unsafe_cast)(val);({struct Cyc_Std_Int_pa_struct
_tmp37;_tmp37.tag=1;_tmp37.f1=(unsigned int)((int)*x);{void*_tmp36[1]={& _tmp37};
Cyc_Std_fprintf(fp,_tmp1E?_tag_arr("%d",sizeof(unsigned char),3): _tag_arr("%u",
sizeof(unsigned char),3),_tag_arr(_tmp36,sizeof(void*),1));}});break;}case 32:
_LL1B: {int*x=((int*(*)(void*x))unsafe_cast)(val);({struct Cyc_Std_Int_pa_struct
_tmp39;_tmp39.tag=1;_tmp39.f1=(unsigned int)*x;{void*_tmp38[1]={& _tmp39};Cyc_Std_fprintf(
fp,_tmp1E?_tag_arr("%d",sizeof(unsigned char),3): _tag_arr("%u",sizeof(
unsigned char),3),_tag_arr(_tmp38,sizeof(void*),1));}});break;}default: _LL1C:({
struct Cyc_Std_Int_pa_struct _tmp3B;_tmp3B.tag=1;_tmp3B.f1=(int)_tmp1F;{void*
...
_LL0;_LL3: if((int)_tmp1D != 0)goto _LL5;_LL4: {float*x=((float*(*)(void*x))
unsafe_cast)(val);({struct Cyc_Std_Double_pa_struct _tmp3D;_tmp3D.tag=2;_tmp3D.f1=(
double)*x;{void*_tmp3C[1]={& _tmp3D};Cyc_Std_fprintf(fp,_tag_arr("%f",sizeof(
unsigned char),3),_tag_arr(_tmp3C,sizeof(void*),1));}});goto _LL0;}_LL5: if((int)
_tmp1D != 1)goto _LL7;_LL6: {double*x=((double*(*)(void*x))unsafe_cast)(val);({
struct Cyc_Std_Double_pa_struct _tmp3F;_tmp3F.tag=2;_tmp3F.f1=*x;{void*_tmp3E[1]={&
_tmp3F};Cyc_Std_fprintf(fp,_tag_arr("%f",sizeof(unsigned char),3),_tag_arr(
_tmp3E,sizeof(void*),1));}});goto _LL0;}_LL7: if(_tmp1D <= (void*)2?1:*((int*)
_tmp1D)!= 1)goto _LL9;_tmp20=((struct Cyc_Typerep_ThinPtr_struct*)_tmp1D)->f1;
_tmp21=(void*)((struct Cyc_Typerep_ThinPtr_struct*)_tmp1D)->f2;_LL8: {int*x=((int*(*)(
void*x))unsafe_cast)(val);int y=*((int*)_check_null(x));struct _tuple8 _tmp41;int
_tmp42;struct Cyc_Set_Set*_tmp43;struct _tuple8*_tmp40=Cyc_Marshal_member_insert(
...
typ_szb=(int)Cyc_Typerep_size_type(_tmp21);int i=0;for(0;i < _tmp20;i ++){env=Cyc_Marshal_fprint_type_base(
_tmp21,env,fp,((void*(*)(int x))unsafe_cast)(y));if(i != _tmp20 - 1)({void*_tmp46[0]={};
Cyc_Std_fprintf(fp,_tag_arr(", ",sizeof(unsigned char),3),_tag_arr(_tmp46,
sizeof(void*),0));});y +=typ_szb;}}else{({void*_tmp47[0]={};Cyc_Std_fprintf(fp,
...
unsigned int)y);}goto _LL0;}_LL9: if(_tmp1D <= (void*)2?1:*((int*)_tmp1D)!= 2)goto
_LLB;_tmp22=(void*)((struct Cyc_Typerep_FatPtr_struct*)_tmp1D)->f1;_LLA: {struct
_tuple9*x=((struct _tuple9*(*)(void*x))unsafe_cast)(val);unsigned int typ_szb=Cyc_Typerep_size_type(
_tmp22);unsigned int base=(*x).f1;unsigned int curr=(*x).f2;unsigned int
last_plus_one=(*x).f3;struct _tuple8 _tmp4A;int _tmp4B;struct Cyc_Set_Set*_tmp4C;
struct _tuple8*_tmp49=Cyc_Marshal_member_insert(env,base);_tmp4A=*_tmp49;_tmp4B=
_tmp4A.f1;_tmp4C=_tmp4A.f2;env=_tmp4C;if(!_tmp4B){({struct Cyc_Std_Int_pa_struct
...
unsigned char),3),_tag_arr(_tmp4F,sizeof(void*),0));});}}({void*_tmp50[0]={};Cyc_Std_fprintf(
fp,_tag_arr(" ]",sizeof(unsigned char),3),_tag_arr(_tmp50,sizeof(void*),0));});}
else{Cyc_Marshal_fprint_ref(fp,base);}goto _LL0;}_LLB: if(_tmp1D <= (void*)2?1:*((
int*)_tmp1D)!= 3)goto _LLD;_tmp23=((struct Cyc_Typerep_Struct_struct*)_tmp1D)->f1;
_tmp24=((struct Cyc_Typerep_Struct_struct*)_tmp1D)->f3;_LLC: if(_tmp23 == 0)({void*
_tmp51[0]={};Cyc_Std_fprintf(fp,_tag_arr("{ ",sizeof(unsigned char),3),_tag_arr(
_tmp51,sizeof(void*),0));});else{({struct Cyc_Std_String_pa_struct _tmp53;_tmp53.tag=
0;_tmp53.f1=(struct _tagged_arr)*_tmp23;{void*_tmp52[1]={& _tmp53};Cyc_Std_fprintf(
fp,_tag_arr("%s{ ",sizeof(unsigned char),5),_tag_arr(_tmp52,sizeof(void*),1));}});}{
int x=((int(*)(void*x))unsafe_cast)(val);{int i=0;for(0;i < _get_arr_size(_tmp24,
sizeof(struct _tuple0*));i ++){unsigned int _tmp55;struct _tagged_arr _tmp56;void*
_tmp57;struct _tuple0 _tmp54=*((struct _tuple0**)_tmp24.curr)[i];_tmp55=_tmp54.f1;
_tmp56=_tmp54.f2;_tmp57=_tmp54.f3;({struct Cyc_Std_String_pa_struct _tmp59;_tmp59.tag=
0;_tmp59.f1=(struct _tagged_arr)_tmp56;{void*_tmp58[1]={& _tmp59};Cyc_Std_fprintf(
fp,_tag_arr("%s=",sizeof(unsigned char),4),_tag_arr(_tmp58,sizeof(void*),1));}});{
int x_ofs=(int)(x + _tmp55);env=Cyc_Marshal_fprint_type_base(_tmp57,env,fp,((void*(*)(
int x))unsafe_cast)(x_ofs));if(i != _get_arr_size(_tmp24,sizeof(struct _tuple0*))- 
1)({void*_tmp5A[0]={};Cyc_Std_fprintf(fp,_tag_arr(", ",sizeof(unsigned char),3),
_tag_arr(_tmp5A,sizeof(void*),0));});}}}({void*_tmp5B[0]={};Cyc_Std_fprintf(fp,
_tag_arr(" }",sizeof(unsigned char),3),_tag_arr(_tmp5B,sizeof(void*),0));});goto
_LL0;}_LLD: if(_tmp1D <= (void*)2?1:*((int*)_tmp1D)!= 4)goto _LLF;_tmp25=((struct
Cyc_Typerep_Tuple_struct*)_tmp1D)->f2;_LLE:({void*_tmp5C[0]={};Cyc_Std_fprintf(
...
sizeof(struct _tuple1*));i ++){unsigned int _tmp5E;void*_tmp5F;struct _tuple1 _tmp5D=*((
struct _tuple1**)_tmp25.curr)[i];_tmp5E=_tmp5D.f1;_tmp5F=_tmp5D.f2;{int x_ofs=(int)(
x + _tmp5E);env=Cyc_Marshal_fprint_type_base(_tmp5F,env,fp,((void*(*)(int x))
unsafe_cast)(x_ofs));if(i != _get_arr_size(_tmp25,sizeof(struct _tuple1*))- 1)({
void*_tmp60[0]={};Cyc_Std_fprintf(fp,_tag_arr(", ",sizeof(unsigned char),3),
_tag_arr(_tmp60,sizeof(void*),0));});}}}({void*_tmp61[0]={};Cyc_Std_fprintf(fp,
_tag_arr(" )",sizeof(unsigned char),3),_tag_arr(_tmp61,sizeof(void*),0));});goto
_LL0;}_LLF: if(_tmp1D <= (void*)2?1:*((int*)_tmp1D)!= 6)goto _LL11;_tmp26=((struct
Cyc_Typerep_TUnionField_struct*)_tmp1D)->f1;_tmp27=((struct Cyc_Typerep_TUnionField_struct*)
_tmp1D)->f2;_tmp28=((struct Cyc_Typerep_TUnionField_struct*)_tmp1D)->f4;_LL10:({
struct Cyc_Std_String_pa_struct _tmp64;_tmp64.tag=0;_tmp64.f1=(struct _tagged_arr)
_tmp27;{struct Cyc_Std_String_pa_struct _tmp63;_tmp63.tag=0;_tmp63.f1=(struct
_tagged_arr)_tmp26;{void*_tmp62[2]={& _tmp63,& _tmp64};Cyc_Std_fprintf(fp,_tag_arr("%s.%s(",
sizeof(unsigned char),7),_tag_arr(_tmp62,sizeof(void*),2));}}});{int x=((int(*)(
void*x))unsafe_cast)(val);{int i=1;for(0;i < _get_arr_size(_tmp28,sizeof(struct
_tuple1*));i ++){unsigned int _tmp66;void*_tmp67;struct _tuple1 _tmp65=*((struct
_tuple1**)_tmp28.curr)[i];_tmp66=_tmp65.f1;_tmp67=_tmp65.f2;{int x_ofs=(int)(x + 
_tmp66);env=Cyc_Marshal_fprint_type_base(_tmp67,env,fp,((void*(*)(int x))
unsafe_cast)(x_ofs));if(i != _get_arr_size(_tmp28,sizeof(struct _tuple1*))- 1)({
void*_tmp68[0]={};Cyc_Std_fprintf(fp,_tag_arr(", ",sizeof(unsigned char),3),
...
_LL0;}_LL11: if(_tmp1D <= (void*)2?1:*((int*)_tmp1D)!= 5)goto _LL13;_tmp29=((struct
Cyc_Typerep_TUnion_struct*)_tmp1D)->f1;_tmp2A=((struct Cyc_Typerep_TUnion_struct*)
_tmp1D)->f2;_tmp2B=((struct Cyc_Typerep_TUnion_struct*)_tmp1D)->f3;_LL12: {
...
Cyc_Typerep_get_tagname(*tagp,_tmp2A);{void*_tmp6A[1]={& _tmp6B};Cyc_Std_fprintf(
fp,_tag_arr("%s",sizeof(unsigned char),3),_tag_arr(_tmp6A,sizeof(void*),1));}});
else{struct _tuple8 _tmp6D;int _tmp6E;struct Cyc_Set_Set*_tmp6F;struct _tuple8*_tmp6C=
Cyc_Marshal_member_insert(env,*tagp);_tmp6D=*_tmp6C;_tmp6E=_tmp6D.f1;_tmp6F=
_tmp6D.f2;env=_tmp6F;if(!_tmp6E){({struct Cyc_Std_Int_pa_struct _tmp71;_tmp71.tag=
1;_tmp71.f1=*tagp;{void*_tmp70[1]={& _tmp71};Cyc_Std_fprintf(fp,_tag_arr("(@%x)",
sizeof(unsigned char),6),_tag_arr(_tmp70,sizeof(void*),1));}});{unsigned int*x=((
unsigned int*(*)(unsigned int x))unsafe_cast)(*tagp);unsigned int tag=*x;int _tmp73;
void*_tmp74;struct _tuple4 _tmp72=Cyc_Typerep_get_unionbranch(tag,_tmp2B);_tmp73=
_tmp72.f1;_tmp74=_tmp72.f2;{void*xoff=((void*(*)(unsigned int x))unsafe_cast)(*
tagp + _tmp73);({struct Cyc_Std_String_pa_struct _tmp76;_tmp76.tag=0;_tmp76.f1=(
struct _tagged_arr)Cyc_Typerep_get_tagname2(tag,_tmp2B);{void*_tmp75[1]={& _tmp76};
Cyc_Std_fprintf(fp,_tag_arr("&%s[",sizeof(unsigned char),5),_tag_arr(_tmp75,
sizeof(void*),1));}});env=Cyc_Marshal_fprint_type_base(_tmp74,env,fp,xoff);({
void*_tmp77[0]={};Cyc_Std_fprintf(fp,_tag_arr("]",sizeof(unsigned char),2),
...
sizeof(unsigned char),6),_tag_arr(_tmp7C,sizeof(void*),1));}});{unsigned int*
xtstructp=((unsigned int*(*)(unsigned int x))unsafe_cast)(*xtunionp);if(*
xtstructp != 0){unsigned char*xtnamec=((unsigned char*(*)(unsigned int x))
unsafe_cast)(*xtstructp + 4);struct _tagged_arr xtname=(struct _tagged_arr)
Cstring_to_string(xtnamec);({struct Cyc_Std_String_pa_struct _tmp7F;_tmp7F.tag=0;
_tmp7F.f1=(struct _tagged_arr)xtname;{void*_tmp7E[1]={& _tmp7F};Cyc_Std_fprintf(fp,
_tag_arr("&%s[( ",sizeof(unsigned char),7),_tag_arr(_tmp7E,sizeof(void*),1));}});{
int _tmp81;void*_tmp82;struct _tuple4 _tmp80=Cyc_Typerep_get_xtunionbranch(xtname,
_tmp2D);_tmp81=_tmp80.f1;_tmp82=_tmp80.f2;{void*xoff=((void*(*)(unsigned int x))
unsafe_cast)(*xtunionp + _tmp81);env=Cyc_Marshal_fprint_type_base(_tmp82,env,fp,
xoff);({void*_tmp83[0]={};Cyc_Std_fprintf(fp,_tag_arr(" )]",sizeof(unsigned char),
4),_tag_arr(_tmp83,sizeof(void*),0));});}}}else{unsigned char*xtnamec=((
...
_tmp85;_tmp85.tag=0;_tmp85.f1=(struct _tagged_arr)xtname;{void*_tmp84[1]={& _tmp85};
Cyc_Std_fprintf(fp,_tag_arr("%s",sizeof(unsigned char),3),_tag_arr(_tmp84,
sizeof(void*),1));}});}}}else{Cyc_Marshal_fprint_ref(fp,*xtunionp);}goto _LL0;}
_LL15: if(_tmp1D <= (void*)2?1:*((int*)_tmp1D)!= 8)goto _LL17;_tmp2E=((struct Cyc_Typerep_Union_struct*)
_tmp1D)->f1;_tmp2F=((struct Cyc_Typerep_Union_struct*)_tmp1D)->f3;_LL16: if(_tmp2E
== 0)({void*_tmp86[0]={};Cyc_Std_fprintf(fp,_tag_arr("{",sizeof(unsigned char),2),
_tag_arr(_tmp86,sizeof(void*),0));});else{({struct Cyc_Std_String_pa_struct _tmp88;
_tmp88.tag=0;_tmp88.f1=(struct _tagged_arr)*_tmp2E;{void*_tmp87[1]={& _tmp88};Cyc_Std_fprintf(
fp,_tag_arr("%s{",sizeof(unsigned char),4),_tag_arr(_tmp87,sizeof(void*),1));}});}{
int i=0;for(0;i < _get_arr_size(_tmp2F,sizeof(struct _tuple3*));i ++){struct
_tagged_arr _tmp8A;void*_tmp8B;struct _tuple3 _tmp89=*((struct _tuple3**)_tmp2F.curr)[
i];_tmp8A=_tmp89.f1;_tmp8B=_tmp89.f2;({struct Cyc_Std_String_pa_struct _tmp8D;
_tmp8D.tag=0;_tmp8D.f1=(struct _tagged_arr)_tmp8A;{void*_tmp8C[1]={& _tmp8D};Cyc_Std_fprintf(
fp,_tag_arr("%s=",sizeof(unsigned char),4),_tag_arr(_tmp8C,sizeof(void*),1));}});
Cyc_Marshal_fprint_type_base(_tmp8B,env,fp,val);if(i < _get_arr_size(_tmp2F,
sizeof(struct _tuple3*))- 1)({void*_tmp8E[0]={};Cyc_Std_fprintf(fp,_tag_arr(" | ",
sizeof(unsigned char),4),_tag_arr(_tmp8E,sizeof(void*),0));});}}({void*_tmp8F[0]={};
Cyc_Std_fprintf(fp,_tag_arr("}",sizeof(unsigned char),2),_tag_arr(_tmp8F,sizeof(
void*),0));});goto _LL0;_LL17: if(_tmp1D <= (void*)2?1:*((int*)_tmp1D)!= 9)goto _LL0;
_tmp30=((struct Cyc_Typerep_Enum_struct*)_tmp1D)->f2;_tmp31=((struct Cyc_Typerep_Enum_struct*)
_tmp1D)->f3;_LL18: {unsigned int*tagp=((unsigned int*(*)(void*x))unsafe_cast)(
val);({struct Cyc_Std_String_pa_struct _tmp91;_tmp91.tag=0;_tmp91.f1=(struct
_tagged_arr)Cyc_Typerep_get_tagname(*tagp,_tmp31);{void*_tmp90[1]={& _tmp91};Cyc_Std_fprintf(
fp,_tag_arr("%s",sizeof(unsigned char),3),_tag_arr(_tmp90,sizeof(void*),1));}});
goto _LL0;}_LL0:;}return env;}void Cyc_Marshal_fprint_type(void*ts,struct Cyc_Std___cycFILE*
fp,void*val){struct _handler_cons _tmp92;_push_handler(& _tmp92);{int _tmp94=0;if(
setjmp(_tmp92.handler))_tmp94=1;if(!_tmp94){Cyc_Marshal_fprint_type_base(ts,Cyc_Marshal_empty_addr_set(),
fp,val);;_pop_handler();}else{void*_tmp93=(void*)_exn_thrown;void*_tmp96=_tmp93;
struct _tagged_arr _tmp97;_LL1F: if(*((void**)_tmp96)!= Cyc_Core_Failure)goto _LL21;
_tmp97=((struct Cyc_Core_Failure_struct*)_tmp96)->f1;_LL20:({struct Cyc_Std_String_pa_struct
...
unsigned char),19),_tag_arr(_tmp98,sizeof(void*),1));}});(int)_throw((void*)({
struct Cyc_Core_Failure_struct*_tmp9A=_cycalloc(sizeof(*_tmp9A));_tmp9A[0]=({
struct Cyc_Core_Failure_struct _tmp9B;_tmp9B.tag=Cyc_Core_Failure;_tmp9B.f1=_tmp97;
_tmp9B;});_tmp9A;}));_LL21:;_LL22:(void)_throw(_tmp96);_LL1E:;}}}void Cyc_Marshal_print_type(
void*ts,void*val){Cyc_Marshal_fprint_type(ts,Cyc_Std_stdout,val);}void Cyc_Marshal_cycputchar(
unsigned char x,struct Cyc_Std___cycFILE*fp){if(Cyc_Std_fwrite((struct _tagged_arr)((
struct _tagged_arr)_tag_arr(& x,sizeof(unsigned char),1)),sizeof(unsigned char),1,
fp)< 1)(int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmp9C=_cycalloc(
sizeof(*_tmp9C));_tmp9C[0]=({struct Cyc_Core_Failure_struct _tmp9D;_tmp9D.tag=Cyc_Core_Failure;
_tmp9D.f1=_tag_arr("Write failure",sizeof(unsigned char),14);_tmp9D;});_tmp9C;}));}
void Cyc_Marshal_cycputshort(short x,struct Cyc_Std___cycFILE*fp){if(Cyc_Std_fwrite((
struct _tagged_arr)((struct _tagged_arr)_tag_arr(& x,sizeof(short),1)),sizeof(short),
1,fp)< 1)(int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmp9E=_cycalloc(
sizeof(*_tmp9E));_tmp9E[0]=({struct Cyc_Core_Failure_struct _tmp9F;_tmp9F.tag=Cyc_Core_Failure;
_tmp9F.f1=_tag_arr("Write failure",sizeof(unsigned char),14);_tmp9F;});_tmp9E;}));}
void Cyc_Marshal_cycputint(int x,struct Cyc_Std___cycFILE*fp){if(Cyc_Std_fwrite((
struct _tagged_arr)((struct _tagged_arr)_tag_arr(& x,sizeof(int),1)),sizeof(int),1,
fp)< 1)(int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmpA0=_cycalloc(
sizeof(*_tmpA0));_tmpA0[0]=({struct Cyc_Core_Failure_struct _tmpA1;_tmpA1.tag=Cyc_Core_Failure;
...
6 | i & 63),fp);i >>=6;{int j=0;for(0;j < width;j ++){Cyc_Std_fputc((int)(i & 255),fp);
i >>=8;}}}unsigned char Cyc_Marshal_cycgetchar(struct Cyc_Std___cycFILE*fp){struct
_RegionHandle _tmpA6=_new_region("r");struct _RegionHandle*r=& _tmpA6;_push_region(
r);{struct _tagged_arr x=_tag_arr(({unsigned int _tmpAA=sizeof(unsigned char);
unsigned char*_tmpAB=(unsigned char*)_region_malloc(r,_check_times(sizeof(
unsigned char),_tmpAA));{unsigned int _tmpAC=_tmpAA;unsigned int i;for(i=0;i < 
_tmpAC;i ++){_tmpAB[i]='\000';}}_tmpAB;}),sizeof(unsigned char),sizeof(
unsigned char));if(Cyc_Std_fread(x,sizeof(unsigned char),1,fp)< 1)(int)_throw((
void*)({struct Cyc_Core_Failure_struct*_tmpA7=_cycalloc(sizeof(*_tmpA7));_tmpA7[0]=({
struct Cyc_Core_Failure_struct _tmpA8;_tmpA8.tag=Cyc_Core_Failure;_tmpA8.f1=
_tag_arr("Read failure",sizeof(unsigned char),13);_tmpA8;});_tmpA7;}));{
...
_tmpB1;unsigned int i;for(i=0;i < _tmpB3;i ++){_tmpB2[i]='\000';}}_tmpB2;}),sizeof(
unsigned char),sizeof(short));if(Cyc_Std_fread(x,sizeof(short),1,fp)< 1)(int)
_throw((void*)({struct Cyc_Core_Failure_struct*_tmpAE=_cycalloc(sizeof(*_tmpAE));
_tmpAE[0]=({struct Cyc_Core_Failure_struct _tmpAF;_tmpAF.tag=Cyc_Core_Failure;
...
_tmpBF;unsigned int i;for(i=0;i < _tmpC1;i ++){_tmpC0[i]='\000';}}_tmpC0;}),sizeof(
unsigned char),sizeof(float));if(Cyc_Std_fread(x,sizeof(float),1,fp)< 1)(int)
_throw((void*)({struct Cyc_Core_Failure_struct*_tmpBC=_cycalloc(sizeof(*_tmpBC));
_tmpBC[0]=({struct Cyc_Core_Failure_struct _tmpBD;_tmpBD.tag=Cyc_Core_Failure;
...
_tuple6 Cyc_Marshal_write_type_base(void*rep,struct _tuple6 env,struct Cyc_Std___cycFILE*
fp,void*val){{void*_tmpC9=rep;unsigned int _tmpCA;unsigned int _tmpCB;void*_tmpCC;
...
int _tmpD4;int _tmpD5;_LL24: if(_tmpC9 <= (void*)2?1:*((int*)_tmpC9)!= 0)goto _LL26;
_tmpCA=((struct Cyc_Typerep_Int_struct*)_tmpC9)->f2;_LL25: switch(_tmpCA){case 8:
_LL3C: {unsigned char*x=((unsigned char*(*)(void*x))unsafe_cast)(val);Cyc_Marshal_cycputchar(*
...
x,fp);break;}default: _LL3F:({struct Cyc_Std_Int_pa_struct _tmpD7;_tmpD7.tag=1;
...
_tag_arr(_tmpD6,sizeof(void*),1));}});exit(1);}goto _LL23;_LL26: if((int)_tmpC9 != 
0)goto _LL28;_LL27: {float*x=((float*(*)(void*x))unsafe_cast)(val);Cyc_Marshal_cycputfloat(*
x,fp);goto _LL23;}_LL28: if((int)_tmpC9 != 1)goto _LL2A;_LL29: {double*x=((double*(*)(
void*x))unsafe_cast)(val);Cyc_Marshal_cycputdouble(*x,fp);goto _LL23;}_LL2A: if(
_tmpC9 <= (void*)2?1:*((int*)_tmpC9)!= 1)goto _LL2C;_tmpCB=((struct Cyc_Typerep_ThinPtr_struct*)
_tmpC9)->f1;_tmpCC=(void*)((struct Cyc_Typerep_ThinPtr_struct*)_tmpC9)->f2;_LL2B: {
int*x=((int*(*)(void*x))unsafe_cast)(val);int y=*((int*)_check_null(x));
unsigned int _tmpD8=Cyc_Marshal_index_lookup(env,(unsigned int)y);Cyc_Marshal_cycputvarint(
_tmpD8,fp);if(!Cyc_Marshal_index_member(env,_tmpD8)){env=Cyc_Marshal_index_insert(
env,(unsigned int)y);{int typ_szb=(int)Cyc_Typerep_size_type(_tmpCC);int i=0;for(0;
i < _tmpCB;i ++){env=Cyc_Marshal_write_type_base(_tmpCC,env,fp,((void*(*)(int x))
unsafe_cast)(y));y +=typ_szb;}}}goto _LL23;}_LL2C: if(_tmpC9 <= (void*)2?1:*((int*)
_tmpC9)!= 2)goto _LL2E;_tmpCD=(void*)((struct Cyc_Typerep_FatPtr_struct*)_tmpC9)->f1;
...
xtname;{void*_tmpE8[1]={& _tmpE9};Cyc_Std_fprintf(fp,_tag_arr("%s",sizeof(
unsigned char),3),_tag_arr(_tmpE8,sizeof(void*),1));}});Cyc_Marshal_cycputchar('\000',
...
_tmpEC,env,fp,xoff);}}}}else{Cyc_Marshal_cycputchar('\000',fp);{unsigned char*
...
Cyc_Std_fprintf(fp,_tag_arr("%s",sizeof(unsigned char),3),_tag_arr(_tmpED,
sizeof(void*),1));}});Cyc_Marshal_cycputchar('\000',fp);}}}}goto _LL23;}_LL38: if(
_tmpC9 <= (void*)2?1:*((int*)_tmpC9)!= 8)goto _LL3A;_tmpD4=((struct Cyc_Typerep_Union_struct*)
_tmpC9)->f2;_LL39: env=Cyc_Marshal_write_type_base((void*)({struct Cyc_Typerep_Tuple_struct*
...
_tag_arr("Core::Failure(%s)\n",sizeof(unsigned char),19),_tag_arr(_tmp100,
sizeof(void*),1));}});(int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmp102=
_cycalloc(sizeof(*_tmp102));_tmp102[0]=({struct Cyc_Core_Failure_struct _tmp103;
_tmp103.tag=Cyc_Core_Failure;_tmp103.f1=_tmpFF;_tmp103;});_tmp102;}));_LL44:;
_LL45:(void)_throw(_tmpFE);_LL41:;}}}void Cyc_Marshal_fscanntstring(struct Cyc_Std___cycFILE*
fp,struct _tagged_arr s){int c;int i=0;while((c=Cyc_Std_fgetc(fp))!= '\000'){if(c == 
- 1)(int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmp104=_cycalloc(sizeof(*
_tmp104));_tmp104[0]=({struct Cyc_Core_Failure_struct _tmp105;_tmp105.tag=Cyc_Core_Failure;
...
unsigned char)c;i ++;}*((unsigned char*)_check_unknown_subscript(s,sizeof(
unsigned char),i))='\000';}struct _tuple7 Cyc_Marshal_rread_type_base(struct
_RegionHandle*r,void*rep,struct _tuple7 env,struct Cyc_Std___cycFILE*fp,void*result){{
void*_tmp106=rep;unsigned int _tmp107;unsigned int _tmp108;void*_tmp109;void*
_tmp10A;struct _tagged_arr _tmp10B;struct _tagged_arr _tmp10C;struct _tagged_arr
...
_tmp107){case 8: _LL5F: {unsigned char*x=((unsigned char*(*)(void*x))unsafe_cast)(
result);*x=Cyc_Marshal_cycgetchar(fp);break;}case 16: _LL60: {short*x=((short*(*)(
void*x))unsafe_cast)(result);*x=Cyc_Marshal_cycgetshort(fp);break;}case 32: _LL61: {
int*x=((int*(*)(void*x))unsafe_cast)(result);*x=Cyc_Marshal_cycgetint(fp);break;}
default: _LL62:(int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmp113=
...
sizeof(unsigned char),38);_tmp114;});_tmp113;}));}goto _LL46;_LL49: if((int)
_tmp106 != 0)goto _LL4B;_LL4A: {float*y=((float*(*)(void*x))unsafe_cast)(result);*
y=Cyc_Marshal_cycgetfloat(fp);goto _LL46;}_LL4B: if((int)_tmp106 != 1)goto _LL4D;
_LL4C: {double*y=((double*(*)(void*x))unsafe_cast)(result);*y=Cyc_Marshal_cycgetdouble(
fp);goto _LL46;}_LL4D: if(_tmp106 <= (void*)2?1:*((int*)_tmp106)!= 1)goto _LL4F;
_tmp108=((struct Cyc_Typerep_ThinPtr_struct*)_tmp106)->f1;_tmp109=(void*)((struct
Cyc_Typerep_ThinPtr_struct*)_tmp106)->f2;_LL4E: {int mem=(int)Cyc_Marshal_cycgetvarint(
fp);if(!Cyc_Marshal_table_member(env,(unsigned int)mem)){int typ_szb=(int)Cyc_Typerep_size_type(
_tmp109);struct _tagged_arr buf=({unsigned int _tmp115=_tmp108 * typ_szb;
unsigned char*_tmp116=(unsigned char*)_cycalloc_atomic(_check_times(sizeof(
unsigned char),_tmp115));struct _tagged_arr _tmp118=_tag_arr(_tmp116,sizeof(
unsigned char),_tmp108 * typ_szb);{unsigned int _tmp117=_tmp115;unsigned int i;for(
i=0;i < _tmp117;i ++){_tmp116[i]='\000';}}_tmp118;});unsigned int bufptr=(
unsigned int)((unsigned char*)_check_null(_untag_arr(buf,sizeof(unsigned char),1)));
unsigned int*x=((unsigned int*(*)(void*x))unsafe_cast)(result);*x=bufptr;env=Cyc_Marshal_table_insert(
env,bufptr);{int y=(int)bufptr;int i=0;for(0;i < _tmp108;i ++){env=Cyc_Marshal_rread_type_base(
r,_tmp109,env,fp,((void*(*)(int x))unsafe_cast)(y));y +=typ_szb;}}}else{
unsigned int*x=((unsigned int*(*)(void*x))unsafe_cast)(result);*x=Cyc_Marshal_table_lookup(
env,mem);}goto _LL46;}_LL4F: if(_tmp106 <= (void*)2?1:*((int*)_tmp106)!= 2)goto
_LL51;_tmp10A=(void*)((struct Cyc_Typerep_FatPtr_struct*)_tmp106)->f1;_LL50: {int
...
buf=({unsigned int _tmp119=(unsigned int)(sz * typ_szb);unsigned char*_tmp11A=(
unsigned char*)_cycalloc_atomic(_check_times(sizeof(unsigned char),_tmp119));
struct _tagged_arr _tmp11C=_tag_arr(_tmp11A,sizeof(unsigned char),(unsigned int)(
sz * typ_szb));{unsigned int _tmp11B=_tmp119;unsigned int i;for(i=0;i < _tmp11B;i ++){
_tmp11A[i]='\000';}}_tmp11C;});unsigned int bufptr=(unsigned int)((unsigned char*)
_check_null(_untag_arr(buf,sizeof(unsigned char),1)));struct _tuple9*x=((struct
_tuple9*(*)(void*x))unsafe_cast)(result);(*x).f1=bufptr;(*x).f2=bufptr + pos * 
typ_szb;(*x).f3=bufptr + sz * typ_szb;env=Cyc_Marshal_table_insert(env,bufptr);{
int y=(int)bufptr;int i=0;for(0;i < sz;i ++){env=Cyc_Marshal_rread_type_base(r,
_tmp10A,env,fp,((void*(*)(int x))unsafe_cast)(y));y +=typ_szb;}}}else{struct
...
_tmp128);unsigned char*_tmp12A=(unsigned char*)_cycalloc_atomic(_check_times(
sizeof(unsigned char),_tmp129));struct _tagged_arr _tmp12C=_tag_arr(_tmp12A,
sizeof(unsigned char),_tmp127 + Cyc_Typerep_size_type(_tmp128));{unsigned int
...
mem)){unsigned char nonnull=(unsigned char)Cyc_Marshal_cycgetchar(fp);struct
_tagged_arr s=_tag_arr(({unsigned int _tmp134=(unsigned int)100;unsigned char*
_tmp135=(unsigned char*)_cycalloc_atomic(_check_times(sizeof(unsigned char),
_tmp134));{unsigned int _tmp136=_tmp134;unsigned int i;for(i=0;i < _tmp136;i ++){
_tmp135[i]='\000';}}_tmp135;}),sizeof(unsigned char),(unsigned int)100);struct
_tagged_arr xtname=_tagged_arr_plus(s,sizeof(unsigned char),4);Cyc_Marshal_fscanntstring(
...
unsigned char*_tmp131=(unsigned char*)_cycalloc_atomic(_check_times(sizeof(
unsigned char),_tmp130));struct _tagged_arr _tmp133=_tag_arr(_tmp131,sizeof(
unsigned char),_tmp12E + Cyc_Typerep_size_type(_tmp12F));{unsigned int _tmp132=
_tmp130;unsigned int i;for(i=0;i < _tmp132;i ++){_tmp131[i]='\000';}}_tmp133;});
...
tagptr=(unsigned int)((unsigned char*)_check_null(_untag_arr(s,sizeof(
unsigned char),1)));env=Cyc_Marshal_rread_type_base(r,_tmp12F,env,fp,((void*(*)(
unsigned int x))unsafe_cast)(bufptr + _tmp12E));}}}}else{unsigned int*x=((
...
Cyc_Marshal_table_lookup(env,mem);}goto _LL46;}_LL5B: if(_tmp106 <= (void*)2?1:*((
int*)_tmp106)!= 8)goto _LL5D;_tmp111=((struct Cyc_Typerep_Union_struct*)_tmp106)->f2;
_LL5C: env=Cyc_Marshal_rread_type_base(r,(void*)({struct Cyc_Typerep_Tuple_struct*
_tmp137=_cycalloc(sizeof(*_tmp137));_tmp137[0]=({struct Cyc_Typerep_Tuple_struct
_tmp138;_tmp138.tag=4;_tmp138.f1=(unsigned int)_tmp111;_tmp138.f2=({unsigned int
_tmp139=(unsigned int)_tmp111;struct _tuple1**_tmp13A=(struct _tuple1**)_cycalloc(
_check_times(sizeof(struct _tuple1*),_tmp139));struct _tagged_arr _tmp13F=_tag_arr(
_tmp13A,sizeof(struct _tuple1*),(unsigned int)_tmp111);{unsigned int _tmp13B=
_tmp139;unsigned int i;for(i=0;i < _tmp13B;i ++){_tmp13A[i]=({struct _tuple1*_tmp13C=
_cycalloc(sizeof(*_tmp13C));_tmp13C->f1=i;_tmp13C->f2=(void*)({struct Cyc_Typerep_Int_struct*
_tmp13D=_cycalloc_atomic(sizeof(*_tmp13D));_tmp13D[0]=({struct Cyc_Typerep_Int_struct
...
ts);unsigned char*_tmp147=(unsigned char*)_region_malloc(r,_check_times(sizeof(
unsigned char),_tmp146));struct _tagged_arr _tmp149=_tag_arr(_tmp147,sizeof(
unsigned char),Cyc_Typerep_size_type(ts));{unsigned int _tmp148=_tmp146;
unsigned int i;for(i=0;i < _tmp148;i ++){_tmp147[i]='\000';}}_tmp149;});void*result=((
void*(*)(unsigned char*x))unsafe_cast)((unsigned char*)_check_null(_untag_arr(
buf,sizeof(unsigned char),1)));Cyc_Marshal_rread_type_base(r,ts,Cyc_Marshal_empty_addr_table(),
...
unsigned char),19),_tag_arr(_tmp14D,sizeof(void*),1));}});(int)_throw((void*)({
struct Cyc_Core_Failure_struct*_tmp14F=_cycalloc(sizeof(*_tmp14F));_tmp14F[0]=({
struct Cyc_Core_Failure_struct _tmp150;_tmp150.tag=Cyc_Core_Failure;_tmp150.f1=
_tmp14C;_tmp150;});_tmp14F;}));_LL67:;_LL68:(void)_throw(_tmp14B);_LL64:;}}}void*
...
env,void*val,void*result){{void*_tmp151=rep;unsigned int _tmp152;unsigned int
_tmp153;unsigned int _tmp154;unsigned int _tmp155;unsigned int _tmp156;void*_tmp157;
void*_tmp158;struct _tagged_arr _tmp159;struct _tagged_arr _tmp15A;struct _tagged_arr
_tmp15B;struct _tagged_arr _tmp15C;struct _tagged_arr _tmp15D;struct _tagged_arr
_tmp15E;int _tmp15F;int _tmp160;_LL6A: if(_tmp151 <= (void*)2?1:*((int*)_tmp151)!= 0)
goto _LL6C;_tmp152=((struct Cyc_Typerep_Int_struct*)_tmp151)->f2;if(_tmp152 != 8)
goto _LL6C;_LL6B: {unsigned char*val0=((unsigned char*(*)(void*x))unsafe_cast)(
val);unsigned char*result0=((unsigned char*(*)(void*x))unsafe_cast)(result);*
result0=*val0;goto _LL69;}_LL6C: if(_tmp151 <= (void*)2?1:*((int*)_tmp151)!= 0)goto
_LL6E;_tmp153=((struct Cyc_Typerep_Int_struct*)_tmp151)->f2;if(_tmp153 != 16)goto
_LL6E;_LL6D: {short*val0=((short*(*)(void*x))unsafe_cast)(val);short*result0=((
short*(*)(void*x))unsafe_cast)(result);*result0=*val0;goto _LL69;}_LL6E: if(
_tmp151 <= (void*)2?1:*((int*)_tmp151)!= 0)goto _LL70;_tmp154=((struct Cyc_Typerep_Int_struct*)
...
struct _tagged_arr buf=({unsigned int _tmp161=_tmp156 * typ_szb;unsigned char*
_tmp162=(unsigned char*)_region_malloc(r,_check_times(sizeof(unsigned char),
_tmp161));struct _tagged_arr _tmp164=_tag_arr(_tmp162,sizeof(unsigned char),
_tmp156 * typ_szb);{unsigned int _tmp163=_tmp161;unsigned int i;for(i=0;i < _tmp163;
i ++){_tmp162[i]='\000';}}_tmp164;});unsigned int bufptr=(unsigned int)((
unsigned char*)_check_null(_untag_arr(buf,sizeof(unsigned char),1)));*result0=
bufptr;env=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,unsigned int k,
unsigned int v))Cyc_Dict_insert)(env,(unsigned int)addr,bufptr);{int x=addr;int y=(
int)bufptr;int i=0;for(0;i < _tmp156;i ++){env=Cyc_Marshal_rcopy_type_base(r,
_tmp157,env,((void*(*)(int x))unsafe_cast)(x),((void*(*)(int x))unsafe_cast)(y));x
+=typ_szb;y +=typ_szb;}}}goto _LL69;}_LL78: if(_tmp151 <= (void*)2?1:*((int*)_tmp151)
!= 2)goto _LL7A;_tmp158=(void*)((struct Cyc_Typerep_FatPtr_struct*)_tmp151)->f1;
...
_tmp166;unsigned char*_tmp16D=(unsigned char*)_region_malloc(r,_check_times(
sizeof(unsigned char),_tmp16C));struct _tagged_arr _tmp16F=_tag_arr(_tmp16D,
sizeof(unsigned char),_tmp168 - _tmp166);{unsigned int _tmp16E=_tmp16C;
unsigned int i;for(i=0;i < _tmp16E;i ++){_tmp16D[i]='\000';}}_tmp16F;});
unsigned int bufptr=(unsigned int)((unsigned char*)_check_null(_untag_arr(buf,
sizeof(unsigned char),1)));*result0=({struct _tuple9 _tmp16B;_tmp16B.f1=bufptr;
_tmp16B.f2=bufptr + pos * typ_szb;_tmp16B.f3=bufptr + size * typ_szb;_tmp16B;});env=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,unsigned int k,unsigned int v))Cyc_Dict_insert)(
env,_tmp166,bufptr);{int y=(int)_tmp166;int z=(int)bufptr;int i=0;for(0;i < size;i ++){
env=Cyc_Marshal_rcopy_type_base(r,_tmp158,env,((void*(*)(int x))unsafe_cast)(y),((
void*(*)(int x))unsafe_cast)(z));y +=typ_szb;z +=typ_szb;}}}goto _LL69;}}_LL7A: if(
_tmp151 <= (void*)2?1:*((int*)_tmp151)!= 3)goto _LL7C;_tmp159=((struct Cyc_Typerep_Struct_struct*)
_tmp151)->f3;_LL7B: {int x=((int(*)(void*x))unsafe_cast)(val);int y=((int(*)(void*
x))unsafe_cast)(result);{int i=0;for(0;i < _get_arr_size(_tmp159,sizeof(struct
_tuple0*));i ++){unsigned int _tmp171;void*_tmp172;struct _tuple0 _tmp170=*((struct
_tuple0**)_tmp159.curr)[i];_tmp171=_tmp170.f1;_tmp172=_tmp170.f3;{int x_ofs=(int)(
x + _tmp171);int y_ofs=(int)(y + _tmp171);env=Cyc_Marshal_rcopy_type_base(r,_tmp172,
...
unsigned int _tmp17C=_tmp17A + Cyc_Typerep_size_type(_tmp17B);unsigned char*
_tmp17D=(unsigned char*)_region_malloc(r,_check_times(sizeof(unsigned char),
_tmp17C));struct _tagged_arr _tmp17F=_tag_arr(_tmp17D,sizeof(unsigned char),
_tmp17A + Cyc_Typerep_size_type(_tmp17B));{unsigned int _tmp17E=_tmp17C;
unsigned int i;for(i=0;i < _tmp17E;i ++){_tmp17D[i]='\000';}}_tmp17F;});
unsigned int bufptr=(unsigned int)((unsigned char*)_check_null(_untag_arr(buf,
sizeof(unsigned char),1)));env=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,
...
unsafe_cast)(*val0);if(*xtstructp != 0){unsigned int xtnamep=*xtstructp;
unsigned char*xtnamec=((unsigned char*(*)(unsigned int x))unsafe_cast)(xtnamep + 4);
struct _tagged_arr xtname=(struct _tagged_arr)Cstring_to_string(xtnamec);int _tmp181;
void*_tmp182;struct _tuple4 _tmp180=Cyc_Typerep_get_xtunionbranch(xtname,_tmp15E);
_tmp181=_tmp180.f1;_tmp182=_tmp180.f2;{struct _tagged_arr buf=({unsigned int
_tmp183=_tmp181 + Cyc_Typerep_size_type(_tmp182);unsigned char*_tmp184=(
unsigned char*)_region_malloc(r,_check_times(sizeof(unsigned char),_tmp183));
struct _tagged_arr _tmp186=_tag_arr(_tmp184,sizeof(unsigned char),_tmp181 + Cyc_Typerep_size_type(
_tmp182));{unsigned int _tmp185=_tmp183;unsigned int i;for(i=0;i < _tmp185;i ++){
_tmp184[i]='\000';}}_tmp186;});unsigned int bufptr=(unsigned int)((unsigned char*)
_check_null(_untag_arr(buf,sizeof(unsigned char),1)));*result0=bufptr;{
unsigned int*tagptr=((unsigned int*(*)(unsigned int x))unsafe_cast)(bufptr);*
tagptr=xtnamep;{void*xoff=((void*(*)(unsigned int x))unsafe_cast)(*val0 + _tmp181);
env=Cyc_Marshal_rcopy_type_base(r,_tmp182,env,xoff,((void*(*)(unsigned int x))
unsafe_cast)(bufptr + _tmp181));env=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
d,unsigned int k,unsigned int v))Cyc_Dict_insert)(env,addr,bufptr);}}}}else{*
result0=*val0;}}goto _LL69;}_LL84: if(_tmp151 <= (void*)2?1:*((int*)_tmp151)!= 8)
goto _LL86;_tmp15F=((struct Cyc_Typerep_Union_struct*)_tmp151)->f2;_LL85: env=Cyc_Marshal_rcopy_type_base(
r,(void*)({struct Cyc_Typerep_Tuple_struct*_tmp187=_cycalloc(sizeof(*_tmp187));
_tmp187[0]=({struct Cyc_Typerep_Tuple_struct _tmp188;_tmp188.tag=4;_tmp188.f1=(
unsigned int)_tmp15F;_tmp188.f2=({unsigned int _tmp189=(unsigned int)_tmp15F;
struct _tuple1**_tmp18A=(struct _tuple1**)_cycalloc(_check_times(sizeof(struct
_tuple1*),_tmp189));struct _tagged_arr _tmp18F=_tag_arr(_tmp18A,sizeof(struct
_tuple1*),(unsigned int)_tmp15F);{unsigned int _tmp18B=_tmp189;unsigned int i;for(
i=0;i < _tmp18B;i ++){_tmp18A[i]=({struct _tuple1*_tmp18C=_cycalloc(sizeof(*_tmp18C));
_tmp18C->f1=i;_tmp18C->f2=(void*)({struct Cyc_Typerep_Int_struct*_tmp18D=
_cycalloc_atomic(sizeof(*_tmp18D));_tmp18D[0]=({struct Cyc_Typerep_Int_struct
...
_tag_arr("Unhandled case in copy_type_base",sizeof(unsigned char),33);_tmp193;});
_tmp192;}));_LL69:;}return env;}void*Cyc_Marshal_rcopy_type(struct _RegionHandle*r,
void*ts,void*val){struct _handler_cons _tmp194;_push_handler(& _tmp194);{int _tmp196=
0;if(setjmp(_tmp194.handler))_tmp196=1;if(!_tmp196){{struct _tagged_arr buf=({
unsigned int _tmp198=Cyc_Typerep_size_type(ts);unsigned char*_tmp199=(
unsigned char*)_region_malloc(r,_check_times(sizeof(unsigned char),_tmp198));
struct _tagged_arr _tmp19B=_tag_arr(_tmp199,sizeof(unsigned char),Cyc_Typerep_size_type(
ts));{unsigned int _tmp19A=_tmp198;unsigned int i;for(i=0;i < _tmp19A;i ++){_tmp199[
i]='\000';}}_tmp19B;});void*result=((void*(*)(unsigned char*x))unsafe_cast)((
unsigned char*)_check_null(_untag_arr(buf,sizeof(unsigned char),1)));Cyc_Marshal_rcopy_type_base(
r,ts,Cyc_Marshal_empty_addr_map(),val,result);{void*_tmp197=result;_npop_handler(
0);return _tmp197;}};_pop_handler();}else{void*_tmp195=(void*)_exn_thrown;void*
_tmp19D=_tmp195;struct _tagged_arr _tmp19E;_LL8B: if(*((void**)_tmp19D)!= Cyc_Core_Failure)
goto _LL8D;_tmp19E=((struct Cyc_Core_Failure_struct*)_tmp19D)->f1;_LL8C:({struct
Cyc_Std_String_pa_struct _tmp1A0;_tmp1A0.tag=0;_tmp1A0.f1=(struct _tagged_arr)
_tmp19E;{void*_tmp19F[1]={& _tmp1A0};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("Core::Failure(%s)\n",
sizeof(unsigned char),19),_tag_arr(_tmp19F,sizeof(void*),1));}});(int)_throw((
void*)({struct Cyc_Core_Failure_struct*_tmp1A1=_cycalloc(sizeof(*_tmp1A1));
...
_tmp1A9)->f2;if(_tmp1AB != 8)goto _LL92;_LL91: {unsigned char*x0=((unsigned char*(*)(
void*x))unsafe_cast)(x);unsigned char*y0=((unsigned char*(*)(void*x))unsafe_cast)(
y);return({struct _tuple11 _tmp1C6;_tmp1C6.f1=*x0 == *y0?(void*)1:(*x0 <= *y0?(void*)
2:(void*)0);_tmp1C6.f2=env;_tmp1C6;});}_LL92: if(_tmp1A9 <= (void*)2?1:*((int*)
_tmp1A9)!= 0)goto _LL94;_tmp1AC=((struct Cyc_Typerep_Int_struct*)_tmp1A9)->f1;if(
_tmp1AC != 1)goto _LL94;_tmp1AD=((struct Cyc_Typerep_Int_struct*)_tmp1A9)->f2;if(
_tmp1AD != 8)goto _LL94;_LL93: {signed char*x0=((signed char*(*)(void*x))
unsafe_cast)(x);signed char*y0=((signed char*(*)(void*x))unsafe_cast)(y);return({
struct _tuple11 _tmp1C7;_tmp1C7.f1=*x0 == *y0?(void*)1:(*x0 <= *y0?(void*)2:(void*)0);
_tmp1C7.f2=env;_tmp1C7;});}_LL94: if(_tmp1A9 <= (void*)2?1:*((int*)_tmp1A9)!= 0)
goto _LL96;_tmp1AE=((struct Cyc_Typerep_Int_struct*)_tmp1A9)->f1;if(_tmp1AE != 1)
goto _LL96;_tmp1AF=((struct Cyc_Typerep_Int_struct*)_tmp1A9)->f2;if(_tmp1AF != 16)
goto _LL96;_LL95: {short*x0=((short*(*)(void*x))unsafe_cast)(x);short*y0=((short*(*)(
void*x))unsafe_cast)(y);return({struct _tuple11 _tmp1C8;_tmp1C8.f1=*x0 == *y0?(void*)
1:(*x0 <= *y0?(void*)2:(void*)0);_tmp1C8.f2=env;_tmp1C8;});}_LL96: if(_tmp1A9 <= (
void*)2?1:*((int*)_tmp1A9)!= 0)goto _LL98;_tmp1B0=((struct Cyc_Typerep_Int_struct*)
_tmp1A9)->f1;if(_tmp1B0 != 0)goto _LL98;_tmp1B1=((struct Cyc_Typerep_Int_struct*)
_tmp1A9)->f2;if(_tmp1B1 != 16)goto _LL98;_LL97: {unsigned short*x0=((
unsigned short*(*)(void*x))unsafe_cast)(x);unsigned short*y0=((unsigned short*(*)(
void*x))unsafe_cast)(y);return({struct _tuple11 _tmp1C9;_tmp1C9.f1=*x0 == *y0?(void*)
1:(*x0 <= *y0?(void*)2:(void*)0);_tmp1C9.f2=env;_tmp1C9;});}_LL98: if(_tmp1A9 <= (
void*)2?1:*((int*)_tmp1A9)!= 0)goto _LL9A;_tmp1B2=((struct Cyc_Typerep_Int_struct*)
_tmp1A9)->f1;if(_tmp1B2 != 1)goto _LL9A;_tmp1B3=((struct Cyc_Typerep_Int_struct*)
_tmp1A9)->f2;if(_tmp1B3 != 32)goto _LL9A;_LL99: {int*x0=((int*(*)(void*x))
unsafe_cast)(x);int*y0=((int*(*)(void*x))unsafe_cast)(y);return({struct _tuple11
_tmp1CA;_tmp1CA.f1=*x0 == *y0?(void*)1:(*x0 <= *y0?(void*)2:(void*)0);_tmp1CA.f2=
env;_tmp1CA;});}_LL9A: if(_tmp1A9 <= (void*)2?1:*((int*)_tmp1A9)!= 0)goto _LL9C;
_tmp1B4=((struct Cyc_Typerep_Int_struct*)_tmp1A9)->f1;if(_tmp1B4 != 0)goto _LL9C;
_tmp1B5=((struct Cyc_Typerep_Int_struct*)_tmp1A9)->f2;if(_tmp1B5 != 32)goto _LL9C;
_LL9B: {unsigned int*x0=((unsigned int*(*)(void*x))unsafe_cast)(x);unsigned int*
y0=((unsigned int*(*)(void*x))unsafe_cast)(y);return({struct _tuple11 _tmp1CB;
_tmp1CB.f1=*x0 == *y0?(void*)1:(*x0 <= *y0?(void*)2:(void*)0);_tmp1CB.f2=env;
_tmp1CB;});}_LL9C: if(_tmp1A9 <= (void*)2?1:*((int*)_tmp1A9)!= 0)goto _LL9E;_tmp1B6=((
struct Cyc_Typerep_Int_struct*)_tmp1A9)->f1;if(_tmp1B6 != 1)goto _LL9E;_tmp1B7=((
struct Cyc_Typerep_Int_struct*)_tmp1A9)->f2;if(_tmp1B7 != 64)goto _LL9E;_LL9D: {
long long*x0=((long long*(*)(void*x))unsafe_cast)(x);long long*y0=((long long*(*)(
void*x))unsafe_cast)(y);return({struct _tuple11 _tmp1CC;_tmp1CC.f1=*x0 == *y0?(void*)
1:(*x0 <= *y0?(void*)2:(void*)0);_tmp1CC.f2=env;_tmp1CC;});}_LL9E: if(_tmp1A9 <= (
void*)2?1:*((int*)_tmp1A9)!= 0)goto _LLA0;_tmp1B8=((struct Cyc_Typerep_Int_struct*)
_tmp1A9)->f1;if(_tmp1B8 != 0)goto _LLA0;_tmp1B9=((struct Cyc_Typerep_Int_struct*)
_tmp1A9)->f2;if(_tmp1B9 != 64)goto _LLA0;_LL9F: {unsigned long long*x0=((
unsigned long long*(*)(void*x))unsafe_cast)(x);unsigned long long*y0=((
unsigned long long*(*)(void*x))unsafe_cast)(y);return({struct _tuple11 _tmp1CD;
_tmp1CD.f1=*x0 == *y0?(void*)1:(*x0 <= *y0?(void*)2:(void*)0);_tmp1CD.f2=env;
_tmp1CD;});}_LLA0: if((int)_tmp1A9 != 0)goto _LLA2;_LLA1: {float*x0=((float*(*)(
void*x))unsafe_cast)(x);float*y0=((float*(*)(void*x))unsafe_cast)(y);return({
struct _tuple11 _tmp1CE;_tmp1CE.f1=*x0 == *y0?(void*)1:(*x0 <= *y0?(void*)2:(void*)0);
_tmp1CE.f2=env;_tmp1CE;});}_LLA2: if((int)_tmp1A9 != 1)goto _LLA4;_LLA3: {double*x0=((
double*(*)(void*x))unsafe_cast)(x);double*y0=((double*(*)(void*x))unsafe_cast)(y);
return({struct _tuple11 _tmp1CF;_tmp1CF.f1=*x0 == *y0?(void*)1:(*x0 <= *y0?(void*)2:(
void*)0);_tmp1CF.f2=env;_tmp1CF;});}_LLA4: if(_tmp1A9 <= (void*)2?1:*((int*)
_tmp1A9)!= 1)goto _LLA6;_tmp1BA=((struct Cyc_Typerep_ThinPtr_struct*)_tmp1A9)->f1;
_tmp1BB=(void*)((struct Cyc_Typerep_ThinPtr_struct*)_tmp1A9)->f2;_LLA5: {
...
y0;struct _tuple10*_tmp1D0=({struct _tuple10*_tmp1D8=_cycalloc_atomic(sizeof(*
_tmp1D8));_tmp1D8->f1=addrx;_tmp1D8->f2=addry;_tmp1D8;});if(((int(*)(struct Cyc_Dict_Dict*
d,struct _tuple10*k))Cyc_Dict_member)(env,_tmp1D0))return({struct _tuple11 _tmp1D1;
_tmp1D1.f1=((void*(*)(struct Cyc_Dict_Dict*d,struct _tuple10*k))Cyc_Dict_lookup)(
env,_tmp1D0);_tmp1D1.f2=env;_tmp1D1;});else{if(addrx == 0)return({struct _tuple11
_tmp1D2;_tmp1D2.f1=(void*)2;_tmp1D2.f2=env;_tmp1D2;});else{if(addry == 0)return({
struct _tuple11 _tmp1D3;_tmp1D3.f1=(void*)0;_tmp1D3.f2=env;_tmp1D3;});else{env=((
struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,struct _tuple10*k,void*v))Cyc_Dict_insert)(
env,_tmp1D0,(void*)1);{int typ_szb=(int)Cyc_Typerep_size_type(_tmp1BB);int xa=(int)
addrx;int ya=(int)addry;void*ord=(void*)1;{int i=0;for(0;i < _tmp1BA;i ++){void*
_tmp1D5;struct Cyc_Dict_Dict*_tmp1D6;struct _tuple11 _tmp1D4=Cyc_Marshal_leq_eq_type(
...
unsigned int x))unsafe_cast)(*y0);if(*xp == 0?*yp == 0: 0){unsigned char*xnamec=((
unsigned char*(*)(unsigned int x))unsafe_cast)(*x0 + 4);unsigned char*ynamec=((
unsigned char*(*)(unsigned int x))unsafe_cast)(*y0 + 4);struct _tagged_arr xname=(
struct _tagged_arr)Cstring_to_string(xnamec);struct _tagged_arr yname=(struct
_tagged_arr)Cstring_to_string(ynamec);int cmp=Cyc_Std_strcmp(xname,yname);if(cmp < 
0)return Cyc_Marshal_return_update(_tmp20B,({struct _tuple11 _tmp20E;_tmp20E.f1=(
void*)0;_tmp20E.f2=env;_tmp20E;}));else{if(cmp == 0)return Cyc_Marshal_return_update(
_tmp20B,({struct _tuple11 _tmp20F;_tmp20F.f1=(void*)1;_tmp20F.f2=env;_tmp20F;}));
else{return Cyc_Marshal_return_update(_tmp20B,({struct _tuple11 _tmp210;_tmp210.f1=(
void*)2;_tmp210.f2=env;_tmp210;}));}}}else{if(*xp == 0)return Cyc_Marshal_return_update(
_tmp20B,({struct _tuple11 _tmp211;_tmp211.f1=(void*)2;_tmp211.f2=env;_tmp211;}));
else{if(*yp == 0)return Cyc_Marshal_return_update(_tmp20B,({struct _tuple11 _tmp212;
_tmp212.f1=(void*)0;_tmp212.f2=env;_tmp212;}));else{unsigned char*xnamec=((
unsigned char*(*)(unsigned int x))unsafe_cast)(*xp + 4);unsigned char*ynamec=((
unsigned char*(*)(unsigned int x))unsafe_cast)(*yp + 4);struct _tagged_arr xname=(
struct _tagged_arr)Cstring_to_string(xnamec);struct _tagged_arr yname=(struct
_tagged_arr)Cstring_to_string(ynamec);int cmp=Cyc_Std_strcmp(xname,yname);if(cmp < 
0)return Cyc_Marshal_return_update(_tmp20B,({struct _tuple11 _tmp213;_tmp213.f1=(
void*)0;_tmp213.f2=env;_tmp213;}));else{if(cmp == 0){int _tmp215;void*_tmp216;
struct _tuple4 _tmp214=Cyc_Typerep_get_xtunionbranch(xname,_tmp1C2);_tmp215=
_tmp214.f1;_tmp216=_tmp214.f2;{void*xoff=((void*(*)(unsigned int x))unsafe_cast)(*
x0 + _tmp215);void*yoff=((void*(*)(unsigned int x))unsafe_cast)(*y0 + _tmp215);
return Cyc_Marshal_return_update(_tmp20B,Cyc_Marshal_leq_eq_type(_tmp216,env,xoff,
yoff));}}else{return Cyc_Marshal_return_update(_tmp20B,({struct _tuple11 _tmp217;
_tmp217.f1=(void*)2;_tmp217.f2=env;_tmp217;}));}}}}}}}}_LLB2: if(_tmp1A9 <= (void*)
2?1:*((int*)_tmp1A9)!= 8)goto _LLB4;_tmp1C3=((struct Cyc_Typerep_Union_struct*)
...
sizeof(unsigned char),27);_tmp225;});_tmp224;}));_LL8F:;}}int Cyc_Marshal_eq_type(
void*ts,void*x,void*y){struct _handler_cons _tmp226;_push_handler(& _tmp226);{int
_tmp228=0;if(setjmp(_tmp226.handler))_tmp228=1;if(!_tmp228){{void*_tmp22A;struct
_tuple11 _tmp229=Cyc_Marshal_leq_eq_type(ts,Cyc_Marshal_empty_eq_dict(),x,y);
_tmp22A=_tmp229.f1;{int _tmp22B=_tmp22A == (void*)1;_npop_handler(0);return _tmp22B;}};
...
unsigned char),19),_tag_arr(_tmp22F,sizeof(void*),1));}});(int)_throw((void*)({
struct Cyc_Core_Failure_struct*_tmp231=_cycalloc(sizeof(*_tmp231));_tmp231[0]=({
struct Cyc_Core_Failure_struct _tmp232;_tmp232.tag=Cyc_Core_Failure;_tmp232.f1=
_tmp22E;_tmp232;});_tmp231;}));_LLBB:;_LLBC:(void)_throw(_tmp22D);_LLB8:;}}}int
Cyc_Marshal_leq_type(void*ts,void*x,void*y){struct _handler_cons _tmp233;
_push_handler(& _tmp233);{int _tmp235=0;if(setjmp(_tmp233.handler))_tmp235=1;if(!
_tmp235){{void*_tmp237;struct _tuple11 _tmp236=Cyc_Marshal_leq_eq_type(ts,Cyc_Marshal_empty_eq_dict(),
x,y);_tmp237=_tmp236.f1;{int _tmp238=_tmp237 != (void*)0;_npop_handler(0);return
_tmp238;}};_pop_handler();}else{void*_tmp234=(void*)_exn_thrown;void*_tmp23A=
_tmp234;struct _tagged_arr _tmp23B;_LLBE: if(*((void**)_tmp23A)!= Cyc_Core_Failure)
goto _LLC0;_tmp23B=((struct Cyc_Core_Failure_struct*)_tmp23A)->f1;_LLBF:({struct
Cyc_Std_String_pa_struct _tmp23D;_tmp23D.tag=0;_tmp23D.f1=(struct _tagged_arr)
_tmp23B;{void*_tmp23C[1]={& _tmp23D};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("Core::Failure(%s)\n",
sizeof(unsigned char),19),_tag_arr(_tmp23C,sizeof(void*),1));}});(int)_throw((
void*)({struct Cyc_Core_Failure_struct*_tmp23E=_cycalloc(sizeof(*_tmp23E));
_tmp23E[0]=({struct Cyc_Core_Failure_struct _tmp23F;_tmp23F.tag=Cyc_Core_Failure;
_tmp23F.f1=_tmp23B;_tmp23F;});_tmp23E;}));_LLC0:;_LLC1:(void)_throw(_tmp23A);
_LLBD:;}}}int Cyc_Marshal_cmp_type(void*ts,void*x,void*y){struct _handler_cons
_tmp240;_push_handler(& _tmp240);{int _tmp242=0;if(setjmp(_tmp240.handler))_tmp242=
1;if(!_tmp242){{void*_tmp244;struct _tuple11 _tmp243=Cyc_Marshal_leq_eq_type(ts,
Cyc_Marshal_empty_eq_dict(),x,y);_tmp244=_tmp243.f1;{void*_tmp245=_tmp244;_LLC3:
if((int)_tmp245 != 0)goto _LLC5;_LLC4: {int _tmp246=- 1;_npop_handler(0);return
_tmp246;}_LLC5: if((int)_tmp245 != 1)goto _LLC7;_LLC6: {int _tmp247=0;_npop_handler(
0);return _tmp247;}_LLC7: if((int)_tmp245 != 2)goto _LLC2;_LLC8: {int _tmp248=1;
_npop_handler(0);return _tmp248;}_LLC2:;}};_pop_handler();}else{void*_tmp241=(
void*)_exn_thrown;void*_tmp24A=_tmp241;struct _tagged_arr _tmp24B;_LLCA: if(*((void**)
_tmp24A)!= Cyc_Core_Failure)goto _LLCC;_tmp24B=((struct Cyc_Core_Failure_struct*)
_tmp24A)->f1;_LLCB:({struct Cyc_Std_String_pa_struct _tmp24D;_tmp24D.tag=0;_tmp24D.f1=(
struct _tagged_arr)_tmp24B;{void*_tmp24C[1]={& _tmp24D};Cyc_Std_fprintf(Cyc_Std_stderr,
_tag_arr("Core::Failure(%s)\n",sizeof(unsigned char),19),_tag_arr(_tmp24C,
sizeof(void*),1));}});(int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmp24E=
_cycalloc(sizeof(*_tmp24E));_tmp24E[0]=({struct Cyc_Core_Failure_struct _tmp24F;
_tmp24F.tag=Cyc_Core_Failure;_tmp24F.f1=_tmp24B;_tmp24F;});_tmp24E;}));_LLCC:;
_LLCD:(void)_throw(_tmp24A);_LLC9:;}}}
