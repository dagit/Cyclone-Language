...
void*elt);int Cyc_Set_member(struct Cyc_Set_Set*s,void*elt);extern unsigned char Cyc_Set_Absent[
...
struct Cyc_Dict_Dict*d,void*k);void*unsafe_cast(void*x);struct _tuple5{struct Cyc_Dict_Dict*
f1;int f2;};struct _tuple6{struct _tagged_arr f1;int f2;};static int Cyc_Marshal_uint_cmp(
...
struct _tuple5 idx,unsigned int m){int _tmp2;struct _tuple5 _tmp1=idx;_tmp2=_tmp1.f2;
return m < _tmp2;}static struct _tuple5 Cyc_Marshal_empty_addr_index(){return({struct
_tuple5 _tmp3;_tmp3.f1=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,
...
struct Cyc_Dict_Dict*_tmp5;int _tmp6;struct _tuple5 _tmp4=index;_tmp5=_tmp4.f1;_tmp6=
...
else{return _tmp6;}}}static struct _tuple5 Cyc_Marshal_index_insert(struct _tuple5
index,unsigned int val){struct Cyc_Dict_Dict*_tmp9;int _tmpA;struct _tuple5 _tmp8=
index;_tmp9=_tmp8.f1;_tmpA=_tmp8.f2;return({struct _tuple5 _tmpB;_tmpB.f1=((struct
...
inline static int Cyc_Marshal_table_member(struct _tuple6 table,unsigned int m){int
_tmp11;struct _tuple6 _tmp10=table;_tmp11=_tmp10.f2;return m < _tmp11;}static struct
_tuple6 Cyc_Marshal_table_insert(struct _tuple6 tbl,unsigned int i){struct
_tagged_arr _tmp13;int _tmp14;struct _tuple6 _tmp12=tbl;_tmp13=_tmp12.f1;_tmp14=
...
fp,_tag_arr("NULL",sizeof(unsigned char),5),_tag_arr(_tmp1A,sizeof(void*),0));});
else{({struct Cyc_Std_Int_pa_struct _tmp1C;_tmp1C.tag=1;_tmp1C.f1=ref;{void*_tmp1B[
1]={& _tmp1C};Cyc_Std_fprintf(fp,_tag_arr("(#%x)",sizeof(unsigned char),6),
_tag_arr(_tmp1B,sizeof(void*),1));}});}}struct _tuple8{unsigned int f1;
...
_LL19: {unsigned char*x=((unsigned char*(*)(void*x))unsafe_cast)(val);if(isprint((
int)*x))({struct Cyc_Std_Int_pa_struct _tmp33;_tmp33.tag=1;_tmp33.f1=(int)((
unsigned int)((int)*x));{void*_tmp32[1]={& _tmp33};Cyc_Std_fprintf(fp,_tag_arr("'%c'",
sizeof(unsigned char),5),_tag_arr(_tmp32,sizeof(void*),1));}});else{({struct Cyc_Std_Int_pa_struct
_tmp35;_tmp35.tag=1;_tmp35.f1=(int)((unsigned int)((int)*x));{void*_tmp34[1]={&
_tmp35};Cyc_Std_fprintf(fp,_tag_arr("'\\%d'",sizeof(unsigned char),6),_tag_arr(
_tmp34,sizeof(void*),1));}});}break;}case 16: _LL1A: {short*x=((short*(*)(void*x))
unsafe_cast)(val);({struct Cyc_Std_Int_pa_struct _tmp37;_tmp37.tag=1;_tmp37.f1=(
unsigned int)((int)*x);{void*_tmp36[1]={& _tmp37};Cyc_Std_fprintf(fp,_tmp1E?
_tag_arr("%d",sizeof(unsigned char),3): _tag_arr("%u",sizeof(unsigned char),3),
_tag_arr(_tmp36,sizeof(void*),1));}});break;}case 32: _LL1B: {int*x=((int*(*)(void*
x))unsafe_cast)(val);({struct Cyc_Std_Int_pa_struct _tmp39;_tmp39.tag=1;_tmp39.f1=(
unsigned int)*x;{void*_tmp38[1]={& _tmp39};Cyc_Std_fprintf(fp,_tmp1E?_tag_arr("%d",
sizeof(unsigned char),3): _tag_arr("%u",sizeof(unsigned char),3),_tag_arr(_tmp38,
sizeof(void*),1));}});break;}default: _LL1C:({struct Cyc_Std_Int_pa_struct _tmp3B;
_tmp3B.tag=1;_tmp3B.f1=(int)_tmp1F;{void*_tmp3A[1]={& _tmp3B};Cyc_Std_fprintf(Cyc_Std_stderr,
_tag_arr("fprint_type_base: illegal int size %d bits\n",sizeof(unsigned char),44),
_tag_arr(_tmp3A,sizeof(void*),1));}});exit(1);}goto _LL0;_LL3: if((int)_tmp1D != 0)
goto _LL5;_LL4: {float*x=((float*(*)(void*x))unsafe_cast)(val);({struct Cyc_Std_Double_pa_struct
...
goto _LL0;}_LL5: if((int)_tmp1D != 1)goto _LL7;_LL6: {double*x=((double*(*)(void*x))
unsafe_cast)(val);({struct Cyc_Std_Double_pa_struct _tmp3F;_tmp3F.tag=2;_tmp3F.f1=*
x;{void*_tmp3E[1]={& _tmp3F};Cyc_Std_printf(_tag_arr("%f",sizeof(unsigned char),3),
_tag_arr(_tmp3E,sizeof(void*),1));}});goto _LL0;}_LL7: if(_tmp1D <= (void*)2?1:*((
int*)_tmp1D)!= 1)goto _LL9;_tmp20=((struct Cyc_Typerep_ThinPtr_struct*)_tmp1D)->f1;
_tmp21=(void*)((struct Cyc_Typerep_ThinPtr_struct*)_tmp1D)->f2;_LL8: {int*x=((int*(*)(
void*x))unsafe_cast)(val);int y=*((int*)_check_null(x));struct _tuple7 _tmp41;int
_tmp42;struct Cyc_Set_Set*_tmp43;struct _tuple7*_tmp40=Cyc_Marshal_member_insert(
...
_tuple8*x=((struct _tuple8*(*)(void*x))unsafe_cast)(val);unsigned int typ_szb=Cyc_Typerep_size_type(
_tmp22);unsigned int base=(*x).f1;unsigned int curr=(*x).f2;unsigned int
last_plus_one=(*x).f3;struct _tuple7 _tmp4A;int _tmp4B;struct Cyc_Set_Set*_tmp4C;
struct _tuple7*_tmp49=Cyc_Marshal_member_insert(env,base);_tmp4A=*_tmp49;_tmp4B=
...
void*(*)(int x))unsafe_cast)(x_ofs));if(i != _get_arr_size(_tmp24,sizeof(struct
_tuple0*))- 1)({void*_tmp5A[0]={};Cyc_Std_fprintf(fp,_tag_arr(", ",sizeof(
unsigned char),3),_tag_arr(_tmp5A,sizeof(void*),0));});}}}({void*_tmp5B[0]={};
Cyc_Std_fprintf(fp,_tag_arr(" }",sizeof(unsigned char),3),_tag_arr(_tmp5B,
sizeof(void*),0));});goto _LL0;}_LLD: if(_tmp1D <= (void*)2?1:*((int*)_tmp1D)!= 4)
goto _LLF;_tmp25=((struct Cyc_Typerep_Tuple_struct*)_tmp1D)->f2;_LLE:({void*_tmp5C[
0]={};Cyc_Std_fprintf(fp,_tag_arr("$( ",sizeof(unsigned char),4),_tag_arr(_tmp5C,
sizeof(void*),0));});{int x=((int(*)(void*x))unsafe_cast)(val);{int i=0;for(0;i < 
_get_arr_size(_tmp25,sizeof(struct _tuple1*));i ++){unsigned int _tmp5E;void*_tmp5F;
struct _tuple1 _tmp5D=*((struct _tuple1**)_tmp25.curr)[i];_tmp5E=_tmp5D.f1;_tmp5F=
_tmp5D.f2;{int x_ofs=(int)(x + _tmp5E);env=Cyc_Marshal_fprint_type_base(_tmp5F,env,
fp,(void*)((void*(*)(int x))unsafe_cast)(x_ofs));if(i != _get_arr_size(_tmp25,
sizeof(struct _tuple1*))- 1)({void*_tmp60[0]={};Cyc_Std_fprintf(fp,_tag_arr(", ",
sizeof(unsigned char),3),_tag_arr(_tmp60,sizeof(void*),0));});}}}({void*_tmp61[0]={};
Cyc_Std_fprintf(fp,_tag_arr(" )",sizeof(unsigned char),3),_tag_arr(_tmp61,
...
fp,_tag_arr("%s.%s(",sizeof(unsigned char),7),_tag_arr(_tmp62,sizeof(void*),2));}}});{
int x=((int(*)(void*x))unsafe_cast)(val);{int i=0;for(0;i < _get_arr_size(_tmp28,
...
else{struct _tuple7 _tmp6D;int _tmp6E;struct Cyc_Set_Set*_tmp6F;struct _tuple7*_tmp6C=
...
val);struct _tuple7 _tmp79;int _tmp7A;struct Cyc_Set_Set*_tmp7B;struct _tuple7*_tmp78=
...
int*x=((int*(*)(void*x))unsafe_cast)(val);int y=*((int*)_check_null(x));int _tmpD8=
Cyc_Marshal_index_lookup(env,(unsigned int)y);Cyc_Marshal_cycputvarint((
...
_tmpC9)->f1;_LL2D: {struct _tuple8*x=((struct _tuple8*(*)(void*x))unsafe_cast)(val);
...
if(*xtstructp != 0){Cyc_Marshal_cycputchar('\001',fp);{unsigned char*xtnamec=((
...
Cyc_Std_fprintf(fp,_tag_arr("%s",sizeof(unsigned char),3),_tag_arr(_tmpE8,
sizeof(void*),1));}});Cyc_Marshal_cycputchar('\000',fp);{int _tmpEB;void*_tmpEC;
struct _tuple4 _tmpEA=Cyc_Typerep_get_xtunionbranch(xtname,_tmpD3);_tmpEB=_tmpEA.f1;
_tmpEC=_tmpEA.f2;{void*xoff=((void*(*)(unsigned int x))unsafe_cast)(*xtunionp + 
_tmpEB);env=Cyc_Marshal_write_type_base(_tmpEC,env,fp,xoff);}}}}else{Cyc_Marshal_cycputchar('\000',
...
fp);}}}}goto _LL23;}_LL38: if(_tmpC9 <= (void*)2?1:*((int*)_tmpC9)!= 8)goto _LL3A;
_tmpD4=((struct Cyc_Typerep_Union_struct*)_tmpC9)->f2;_LL39: env=Cyc_Marshal_write_type_base((
void*)({struct Cyc_Typerep_Tuple_struct*_tmpEF=_cycalloc(sizeof(*_tmpEF));_tmpEF[
0]=({struct Cyc_Typerep_Tuple_struct _tmpF0;_tmpF0.tag=4;_tmpF0.f1=(unsigned int)
_tmpD4;_tmpF0.f2=({unsigned int _tmpF1=(unsigned int)_tmpD4;struct _tuple1**_tmpF2=(
struct _tuple1**)_cycalloc(_check_times(sizeof(struct _tuple1*),_tmpF1));struct
_tagged_arr _tmpF7=_tag_arr(_tmpF2,sizeof(struct _tuple1*),(unsigned int)_tmpD4);{
unsigned int _tmpF3=_tmpF1;unsigned int i;for(i=0;i < _tmpF3;i ++){_tmpF2[i]=({
struct _tuple1*_tmpF4=_cycalloc(sizeof(*_tmpF4));_tmpF4->f1=i;_tmpF4->f2=(void*)({
struct Cyc_Typerep_Int_struct*_tmpF5=_cycalloc_atomic(sizeof(*_tmpF5));_tmpF5[0]=({
struct Cyc_Typerep_Int_struct _tmpF6;_tmpF6.tag=0;_tmpF6.f1=0;_tmpF6.f2=8;_tmpF6;});
_tmpF5;});_tmpF4;});}}_tmpF7;});_tmpF0;});_tmpEF;}),env,fp,val);goto _LL23;_LL3A:
if(_tmpC9 <= (void*)2?1:*((int*)_tmpC9)!= 9)goto _LL23;_tmpD5=((struct Cyc_Typerep_Enum_struct*)
_tmpC9)->f2;_LL3B: env=Cyc_Marshal_write_type_base((void*)({struct Cyc_Typerep_Int_struct*
...
fp,void*result){{void*_tmp106=rep;unsigned int _tmp107;unsigned int _tmp108;void*
...
_tagged_arr _tmp110;int _tmp111;int _tmp112;_LL47: if(_tmp106 <= (void*)2?1:*((int*)
_tmp106)!= 0)goto _LL49;_tmp107=((struct Cyc_Typerep_Int_struct*)_tmp106)->f2;
_LL48: switch(_tmp107){case 8: _LL5F: {unsigned char*x=((unsigned char*(*)(void*x))
...
env,bufptr);{int y=(int)bufptr;int i=0;for(0;i < _tmp108;i ++){env=Cyc_Marshal_read_type_base(
_tmp109,env,fp,(void*)((void*(*)(int x))unsafe_cast)(y));y +=typ_szb;}}}else{
...
_check_null(_untag_arr(buf,sizeof(unsigned char),1)));struct _tuple8*x=((struct
_tuple8*(*)(void*x))unsafe_cast)(result);(*x).f1=bufptr;(*x).f2=bufptr + pos * 
typ_szb;(*x).f3=bufptr + sz * typ_szb;env=Cyc_Marshal_table_insert(env,bufptr);{
int y=(int)bufptr;int i=0;for(0;i < sz;i ++){env=Cyc_Marshal_read_type_base(_tmp10A,
env,fp,(void*)((void*(*)(int x))unsafe_cast)(y));y +=typ_szb;}}}else{struct _tuple8*
x=((struct _tuple8*(*)(void*x))unsafe_cast)(result);(*x).f1=Cyc_Marshal_table_lookup(
...
unsigned char),1)));env=Cyc_Marshal_read_type_base(_tmp12F,env,fp,(void*)((void*(*)(
...
_LL5C: env=Cyc_Marshal_read_type_base((void*)({struct Cyc_Typerep_Tuple_struct*
...
_tagged_arr buf=({unsigned int _tmp146=Cyc_Typerep_size_type(ts);unsigned char*
_tmp147=(unsigned char*)_cycalloc_atomic(_check_times(sizeof(unsigned char),
_tmp146));struct _tagged_arr _tmp149=_tag_arr(_tmp147,sizeof(unsigned char),Cyc_Typerep_size_type(
ts));{unsigned int _tmp148=_tmp146;unsigned int i;for(i=0;i < _tmp148;i ++){_tmp147[
i]='\000';}}_tmp149;});void*result=((void*(*)(unsigned char*x))unsafe_cast)((
...
_tmp14B=_tmp143;struct _tagged_arr _tmp14C;_LL65: if(*((void**)_tmp14B)!= Cyc_Core_Failure)
goto _LL67;_tmp14C=((struct Cyc_Core_Failure_struct*)_tmp14B)->f1;_LL66:({struct
Cyc_Std_String_pa_struct _tmp14E;_tmp14E.tag=0;_tmp14E.f1=(struct _tagged_arr)
_tmp14C;{void*_tmp14D[1]={& _tmp14E};Cyc_Std_fprintf(Cyc_Std_stderr,_tag_arr("Core::Failure(%s)\n",
sizeof(unsigned char),19),_tag_arr(_tmp14D,sizeof(void*),1));}});(int)_throw((
void*)({struct Cyc_Core_Failure_struct*_tmp14F=_cycalloc(sizeof(*_tmp14F));
_tmp14F[0]=({struct Cyc_Core_Failure_struct _tmp150;_tmp150.tag=Cyc_Core_Failure;
_tmp150.f1=_tmp14C;_tmp150;});_tmp14F;}));_LL67:;_LL68:(void)_throw(_tmp14B);
_LL64:;}}}
