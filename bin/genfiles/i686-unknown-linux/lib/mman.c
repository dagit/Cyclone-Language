...
unsigned char*); extern struct _tagged_arr Cyc_std_mmap( unsigned int length,
int prot, int flags, int fd, int offset); extern int Cyc_std_munmap( struct
...
length);} int Cyc_std_munmap( struct _tagged_arr start, unsigned int length){
