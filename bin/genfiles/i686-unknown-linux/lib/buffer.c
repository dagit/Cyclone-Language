...
_tagged_arr Cyc_String_strncpy( struct _tagged_arr, struct _tagged_arr,
unsigned int); extern struct _tagged_arr Cyc_String_zstrncpy( struct _tagged_arr,
struct _tagged_arr, unsigned int); extern struct _tagged_arr Cyc_String_substring(
...
unsigned int) len);} Cyc_String_strncpy( _tagged_arr_plus( b->buffer, sizeof(
