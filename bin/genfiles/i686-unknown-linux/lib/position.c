...
return s2 != 0  && (s1->start == s2->start  && s1->end == s2->end);}struct _tagged_arr
...
Cyc_Int_pa_struct _tmp6;_tmp6.tag=1;_tmp6.f1=(unsigned int)pos->line_no;{struct
Cyc_String_pa_struct _tmp5;_tmp5.tag=0;_tmp5.f1=(struct _tagged_arr)((struct
_tagged_arr)pos->logical_file);{void*_tmp3[2]={& _tmp5,& _tmp6};Cyc_aprintf(({
const char*_tmp4="%s:%d";_tag_arr(_tmp4,sizeof(char),_get_zero_arr_size(_tmp4,6));}),
_tag_arr(_tmp3,sizeof(void*),2));}}});else{return({struct Cyc_Int_pa_struct _tmpB;
_tmpB.tag=1;_tmpB.f1=(unsigned int)pos->col;{struct Cyc_Int_pa_struct _tmpA;_tmpA.tag=
1;_tmpA.f1=(unsigned int)pos->line_no;{struct Cyc_String_pa_struct _tmp9;_tmp9.tag=
0;_tmp9.f1=(struct _tagged_arr)((struct _tagged_arr)pos->logical_file);{void*_tmp7[
3]={& _tmp9,& _tmpA,& _tmpB};Cyc_aprintf(({const char*_tmp8="%s:(%d:%d)";_tag_arr(
_tmp8,sizeof(char),_get_zero_arr_size(_tmp8,11));}),_tag_arr(_tmp7,sizeof(void*),
...
Cyc_Core_new_string((unsigned int)(n + 1));Cyc_strncpy(_tagged_ptr_decrease_size(
ans,sizeof(char),1),(struct _tagged_arr)s,(unsigned int)len_one);Cyc_strncpy(
_tagged_ptr_decrease_size(_tagged_arr_plus(ans,sizeof(char),len_one),sizeof(char),
1),({const char*_tmp33="...";_tag_arr(_tmp33,sizeof(char),_get_zero_arr_size(
_tmp33,4));}),3);Cyc_strncpy(_tagged_ptr_decrease_size(_tagged_arr_plus(
_tagged_arr_plus(ans,sizeof(char),len_one),sizeof(char),3),sizeof(char),1),(
...
_tagged_arr _tmp3B;int _tmp3C;int _tmp3D;struct Cyc_Lineno_Pos*_tmp39=pos_s;_tmp3A=*
_tmp39;_tmp3B=_tmp3A.line;_tmp3C=_tmp3A.line_no;_tmp3D=_tmp3A.col;{struct Cyc_Lineno_Pos
_tmp3F;struct _tagged_arr _tmp40;int _tmp41;int _tmp42;struct Cyc_Lineno_Pos*_tmp3E=
pos_e;_tmp3F=*_tmp3E;_tmp40=_tmp3F.line;_tmp41=_tmp3F.line_no;_tmp42=_tmp3F.col;
if(_tmp3C == _tmp41){int n=Cyc_Position_line_length / 3;struct _tagged_arr sec_one=
Cyc_Position_trunc(n,Cyc_substring((struct _tagged_arr)_tmp3B,0,(unsigned int)
_tmp3D));struct _tagged_arr sec_two=Cyc_Position_trunc(n,Cyc_substring((struct
_tagged_arr)_tmp3B,_tmp3D,(unsigned int)(_tmp42 - _tmp3D)));struct _tagged_arr
sec_three=Cyc_Position_trunc(n,Cyc_substring((struct _tagged_arr)_tmp3B,_tmp3D,
Cyc_strlen((struct _tagged_arr)_tmp3B)- _tmp42));return({struct _tuple5*_tmp43=
_cycalloc(sizeof(*_tmp43));_tmp43->f1=({struct Cyc_String_pa_struct _tmp48;_tmp48.tag=
0;_tmp48.f1=(struct _tagged_arr)((struct _tagged_arr)sec_three);{struct Cyc_String_pa_struct
_tmp47;_tmp47.tag=0;_tmp47.f1=(struct _tagged_arr)((struct _tagged_arr)sec_two);{
struct Cyc_String_pa_struct _tmp46;_tmp46.tag=0;_tmp46.f1=(struct _tagged_arr)((
struct _tagged_arr)sec_one);{void*_tmp44[3]={& _tmp46,& _tmp47,& _tmp48};Cyc_aprintf(({
const char*_tmp45="%s%s%s";_tag_arr(_tmp45,sizeof(char),_get_zero_arr_size(_tmp45,
7));}),_tag_arr(_tmp44,sizeof(void*),3));}}}});_tmp43->f2=(int)Cyc_strlen((
struct _tagged_arr)sec_one);_tmp43->f3=(int)(Cyc_strlen((struct _tagged_arr)
sec_one)+ Cyc_strlen((struct _tagged_arr)sec_two));_tmp43;});}else{int n=(Cyc_Position_line_length
- 3)/ 4;struct _tagged_arr sec_one=Cyc_Position_trunc(n,Cyc_substring((struct
_tagged_arr)_tmp3B,0,(unsigned int)_tmp3D));struct _tagged_arr sec_two=Cyc_Position_trunc(
...
0));char _tmp5B=' ';if(_get_arr_size(_tmp59,sizeof(char))== 1  && (_tmp5A == '\000'
 && _tmp5B != '\000'))_throw_arraybounds();*((char*)_tmp59.curr)=_tmp5B;});}
while(++ i < (*x).f3){({struct _tagged_arr _tmp5C=_tagged_arr_plus(marker_str,
sizeof(char),i);char _tmp5D=*((char*)_check_unknown_subscript(_tmp5C,sizeof(char),
0));char _tmp5E='^';if(_get_arr_size(_tmp5C,sizeof(char))== 1  && (_tmp5D == '\000'
 && _tmp5E != '\000'))_throw_arraybounds();*((char*)_tmp5C.curr)=_tmp5E;});}({
struct Cyc_String_pa_struct _tmp62;_tmp62.tag=0;_tmp62.f1=(struct _tagged_arr)((
struct _tagged_arr)marker_str);{struct Cyc_String_pa_struct _tmp61;_tmp61.tag=0;
_tmp61.f1=(struct _tagged_arr)((struct _tagged_arr)(*x).f1);{void*_tmp5F[2]={&
_tmp61,& _tmp62};Cyc_fprintf(Cyc_stderr,({const char*_tmp60="  %s\n  %s\n";
_tag_arr(_tmp60,sizeof(char),_get_zero_arr_size(_tmp60,11));}),_tag_arr(_tmp5F,
...
_tag_arr(_tmp6A,sizeof(char),_get_zero_arr_size(_tmp6A,26));}),_tag_arr(_tmp69,
...
_tmp6E;_tmp6E.tag=0;_tmp6E.f1=(struct _tagged_arr)((struct _tagged_arr)pos_s->logical_file);{
struct Cyc_Int_pa_struct _tmp6D;_tmp6D.tag=1;_tmp6D.f1=(unsigned int)pos_s->line_no;{
void*_tmp6B[2]={& _tmp6D,& _tmp6E};Cyc_aprintf(({const char*_tmp6C="\n#line %d \"%s\"\n";
_tag_arr(_tmp6C,sizeof(char),_get_zero_arr_size(_tmp6C,16));}),_tag_arr(_tmp6B,
sizeof(void*),2));}}});else{return(struct _tagged_arr)_tag_arr(0,0,0);}}extern
struct Cyc_Typerep_Struct_struct Cyc_struct_Position_Segment_rep;static struct Cyc_Typerep_Int_struct
Cyc__genrep_0={0,1,32};static char _tmp70[8]="Segment";static struct _tagged_arr Cyc__genname_4=(
