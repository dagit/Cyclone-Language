...
const char*_tmp4="%s:%d";_tag_dynforward(_tmp4,sizeof(char),
_get_zero_arr_size_char(_tmp4,6));}),_tag_dynforward(_tmp3,sizeof(void*),2));}}});
else{return({struct Cyc_Int_pa_struct _tmpB;_tmpB.tag=1;_tmpB.f1=(unsigned long)
pos->col;{struct Cyc_Int_pa_struct _tmpA;_tmpA.tag=1;_tmpA.f1=(unsigned long)pos->line_no;{
struct Cyc_String_pa_struct _tmp9;_tmp9.tag=0;_tmp9.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)pos->logical_file);{void*_tmp7[3]={& _tmp9,& _tmpA,& _tmpB};
Cyc_aprintf(({const char*_tmp8="%s:(%d:%d)";_tag_dynforward(_tmp8,sizeof(char),
_get_zero_arr_size_char(_tmp8,11));}),_tag_dynforward(_tmp7,sizeof(void*),3));}}}});}}
static struct _dynforward_ptr Cyc_Position_string_of_pos_pr(struct Cyc_Lineno_Pos*
...
const char*_tmpD="%s:%d";_tag_dynforward(_tmpD,sizeof(char),
_get_zero_arr_size_char(_tmpD,6));}),_tag_dynforward(_tmpC,sizeof(void*),2));}}});
else{if(Cyc_strcmp((struct _dynforward_ptr)pos_s->logical_file,(struct
_dynforward_ptr)pos_e->logical_file)== 0)return({struct Cyc_Int_pa_struct _tmp16;
_tmp16.tag=1;_tmp16.f1=(unsigned long)pos_e->col;{struct Cyc_Int_pa_struct _tmp15;
_tmp15.tag=1;_tmp15.f1=(unsigned long)pos_e->line_no;{struct Cyc_Int_pa_struct
...
_tmp12;_tmp12.tag=0;_tmp12.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)
pos_s->logical_file);{void*_tmp10[5]={& _tmp12,& _tmp13,& _tmp14,& _tmp15,& _tmp16};
Cyc_aprintf(({const char*_tmp11="%s(%d:%d-%d:%d)";_tag_dynforward(_tmp11,sizeof(
char),_get_zero_arr_size_char(_tmp11,16));}),_tag_dynforward(_tmp10,sizeof(void*),
5));}}}}}});else{return({struct Cyc_Int_pa_struct _tmp1E;_tmp1E.tag=1;_tmp1E.f1=(
unsigned long)pos_e->col;{struct Cyc_Int_pa_struct _tmp1D;_tmp1D.tag=1;_tmp1D.f1=(
unsigned long)pos_e->line_no;{struct Cyc_String_pa_struct _tmp1C;_tmp1C.tag=0;
_tmp1C.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)pos_e->logical_file);{
...
struct Cyc_String_pa_struct _tmp19;_tmp19.tag=0;_tmp19.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)pos_s->logical_file);{void*_tmp17[6]={& _tmp19,& _tmp1A,&
_tmp1B,& _tmp1C,& _tmp1D,& _tmp1E};Cyc_aprintf(({const char*_tmp18="%s(%d:%d)-%s(%d:%d)";
_tag_dynforward(_tmp18,sizeof(char),_get_zero_arr_size_char(_tmp18,20));}),
_tag_dynforward(_tmp17,sizeof(void*),6));}}}}}}});}}}struct _dynforward_ptr Cyc_Position_string_of_segment(
struct Cyc_Position_Segment*s){if(s == 0)return({struct Cyc_String_pa_struct _tmp21;
_tmp21.tag=0;_tmp21.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Position_source);{
void*_tmp1F[1]={& _tmp21};Cyc_aprintf(({const char*_tmp20="%s";_tag_dynforward(
_tmp20,sizeof(char),_get_zero_arr_size_char(_tmp20,3));}),_tag_dynforward(_tmp1F,
sizeof(void*),1));}});{struct Cyc_Lineno_Pos*pos_s=Cyc_Lineno_pos_of_abs(Cyc_Position_source,
s->start);struct Cyc_Lineno_Pos*pos_e=Cyc_Lineno_pos_of_abs(Cyc_Position_source,s->end);
...
sizeof(char),_get_zero_arr_size_char(_tmp23,1));});_tmp22->line=Cyc_Core_new_string(
0);_tmp22->line_no=0;_tmp22->col=0;_tmp22;});}struct _tuple4{int f1;struct Cyc_Lineno_Pos*
...
_tag_dynforward(_tmp2C,sizeof(char),_get_zero_arr_size_char(_tmp2C,12));}),
...
_tag_dynforward(_tmp33,sizeof(char),_get_zero_arr_size_char(_tmp33,4));}),3);Cyc_strncpy(
...
_tmp45="%s%s%s";_tag_dynforward(_tmp45,sizeof(char),_get_zero_arr_size_char(
_tmp45,7));}),_tag_dynforward(_tmp44,sizeof(void*),3));}}}});_tmp43->f2=(int)Cyc_strlen((
...
_get_zero_arr_size_char(_tmp4B,12));}),_tag_dynforward(_tmp4A,sizeof(void*),4));}}}}});
...
const char*_tmp51="\n";_tag_dynforward(_tmp51,sizeof(char),
_get_zero_arr_size_char(_tmp51,2));}),_tag_dynforward(_tmp50,sizeof(void*),0));});
Cyc_Position_first_error=0;}if(Cyc_Position_num_errors <= Cyc_Position_max_errors){({
struct Cyc_String_pa_struct _tmp55;_tmp55.tag=0;_tmp55.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)e->desc);{struct Cyc_String_pa_struct _tmp54;_tmp54.tag=0;
_tmp54.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Position_string_of_segment(
e->seg));{void*_tmp52[2]={& _tmp54,& _tmp55};Cyc_fprintf(Cyc_stderr,({const char*
_tmp53="%s: %s\n";_tag_dynforward(_tmp53,sizeof(char),_get_zero_arr_size_char(
_tmp53,8));}),_tag_dynforward(_tmp52,sizeof(void*),2));}}});if(Cyc_Position_print_context){
...
_tmp60,sizeof(char),_get_zero_arr_size_char(_tmp60,11));}),_tag_dynforward(
_tmp5F,sizeof(void*),2));}}});};_pop_handler();}else{void*_tmp57=(void*)
...
_tmp6A="Too many error messages!\n";_tag_dynforward(_tmp6A,sizeof(char),
_get_zero_arr_size_char(_tmp6A,26));}),_tag_dynforward(_tmp69,sizeof(void*),0));});
...
_tag_dynforward(_tmp6C,sizeof(char),_get_zero_arr_size_char(_tmp6C,16));}),
