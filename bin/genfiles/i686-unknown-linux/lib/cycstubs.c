...
struct _tagged_arr,int,struct _tagged_arr);int Cyc_Std_creat(struct _tagged_arr,
unsigned int);int fcntl(int fd,int cmd);int fcntl_with_arg(int fd,int cmd,int arg);int
fcntl_with_lock(int fd,int cmd,struct Cyc_Std_flock*lock);int creat(char*,
unsigned int);int open_without_mode(char*,int);int open_with_mode(char*,int,
...
argv,sizeof(void*))!= 1)(int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmp0=
_cycalloc(sizeof(*_tmp0));_tmp0[0]=({struct Cyc_Core_Failure_struct _tmp1;_tmp1.tag=
Cyc_Core_Failure;_tmp1.f1=_tag_arr("fcntl: too many args",sizeof(char),21);_tmp1;});
_tmp0;}));else{void*_tmp2=*((void**)_check_unknown_subscript(argv,sizeof(void*),
0));int _tmp3;struct Cyc_Std_flock*_tmp4;_LL1: if(*((int*)_tmp2)!= 1)goto _LL3;_tmp3=((
