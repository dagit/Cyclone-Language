...
mode);}struct Cyc_Cstdio___abstractFILE;struct Cyc_Std___cycFILE;extern struct Cyc_Std___cycFILE*
Cyc_Std_fromCfile(struct Cyc_Cstdio___abstractFILE*cf);extern int Cyc_Std_remove(
struct _tagged_arr);extern int Cyc_Std_rename(struct _tagged_arr,struct _tagged_arr);
...
_tagged_arr __filename,struct _tagged_arr __modes);extern struct Cyc_Std___cycFILE*
