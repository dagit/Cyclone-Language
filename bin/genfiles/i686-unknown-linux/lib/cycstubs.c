...
_check_dyneither_subscript(argv,sizeof(void*),0));long _tmp7;struct Cyc_flock*
...
_dyneither_ptr ms){if(_get_dyneither_size(ms,sizeof(unsigned int))>= 1)return
open_with_mode(s,i,*((unsigned int*)_check_dyneither_subscript(ms,sizeof(
...
_tmpC,_tmpC + 39}};int Cyc_poll(struct _dyneither_ptr a,unsigned long b,int c){if(!((
...
_untag_dyneither_ptr(a,sizeof(struct Cyc_pollfd),0),b < (unsigned long)len?b:(
...
int,struct _dyneither_ptr);void*Cyc_Csignal_make_SIG_DFL(){return(void*)({struct
...
int munmap(const char*start,unsigned int length);static char _tmp43[42]="mmap called with illegal start/prot/flags";
...
struct _dyneither_ptr);extern char Cyc_SocketError[16];int Cyc_bind(int fd,struct
_dyneither_ptr);int Cyc_connect(int fd,struct _dyneither_ptr);int Cyc_getpeername(
int fd,struct _dyneither_ptr);int Cyc_getsockname(int fd,struct _dyneither_ptr);int
Cyc_getsockopt(int fd,int level,int optname,struct _dyneither_ptr);int Cyc_recv(int fd,
struct _dyneither_ptr buf,unsigned int n,int flags);int Cyc_recvfrom(int fd,struct
_dyneither_ptr buf,unsigned int n,int flags,struct _dyneither_ptr);int Cyc_send(int fd,
struct _dyneither_ptr buf,unsigned int n,int flags);int Cyc_sendto(int fd,struct
_dyneither_ptr buf,unsigned int n,int flags,struct _dyneither_ptr);int Cyc_setsockopt(
int fd,int level,int optname,struct _dyneither_ptr);char Cyc_SocketError[16]="\000\000\000\000SocketError\000";
int accept_in(int,const struct Cyc_sockaddr_in*,unsigned int*);struct _tuple0{void*
f1;void*f2;};int Cyc_accept(int fd,struct _dyneither_ptr ap){if(_get_dyneither_size(
ap,sizeof(void*))!= 2)(int)_throw((void*)Cyc_SocketError);{struct _tuple0 _tmp45=({
struct _tuple0 _tmp44;_tmp44.f1=*((void**)_check_dyneither_subscript(ap,sizeof(
void*),0));_tmp44.f2=*((void**)_check_dyneither_subscript(ap,sizeof(void*),1));
_tmp44;});void*_tmp46;struct Cyc_sockaddr_in*_tmp47;void*_tmp48;unsigned int*
_tmp49;_LL14: _tmp46=_tmp45.f1;if(*((int*)_tmp46)!= 0)goto _LL16;_tmp47=((struct
Cyc_SA_sockaddr_in_struct*)_tmp46)->f1;_tmp48=_tmp45.f2;if(*((int*)_tmp48)!= 1)
goto _LL16;_tmp49=((struct Cyc_SA_socklenptr_struct*)_tmp48)->f1;_LL15: return
accept_in(fd,(const struct Cyc_sockaddr_in*)_tmp47,_tmp49);_LL16:;_LL17:(int)
_throw((void*)Cyc_SocketError);_LL13:;}}int bind_in(int,const struct Cyc_sockaddr_in*,
unsigned int);int Cyc_bind(int fd,struct _dyneither_ptr ap){if(_get_dyneither_size(
ap,sizeof(void*))!= 2)(int)_throw((void*)Cyc_SocketError);{struct _tuple0 _tmp4B=({
struct _tuple0 _tmp4A;_tmp4A.f1=*((void**)_check_dyneither_subscript(ap,sizeof(
void*),0));_tmp4A.f2=*((void**)_check_dyneither_subscript(ap,sizeof(void*),1));
_tmp4A;});void*_tmp4C;struct Cyc_sockaddr_in*_tmp4D;void*_tmp4E;unsigned int
...
unsigned int);int Cyc_connect(int fd,struct _dyneither_ptr ap){if(
...
Cyc_SocketError);{struct _tuple0 _tmp57=({struct _tuple0 _tmp56;_tmp56.f1=*((void**)
...
_throw((void*)Cyc_SocketError);{struct _tuple0 _tmp5D=({struct _tuple0 _tmp5C;_tmp5C.f1=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));_tmp5C.f2=*((void**)
...
void*)Cyc_SocketError);{struct _tuple0 _tmp63=({struct _tuple0 _tmp62;_tmp62.f1=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));_tmp62.f2=*((void**)
_check_dyneither_subscript(ap,sizeof(void*),1));_tmp62;});void*_tmp64;int*_tmp65;
...
recv_wrapped(int,struct _dyneither_ptr,unsigned int,int);int Cyc_recv(int fd,struct
_dyneither_ptr buf,unsigned int n,int flags){return recv_wrapped(fd,buf,n,flags);}
int recvfrom_in(int,struct _dyneither_ptr,unsigned int,int,const struct Cyc_sockaddr_in*,
unsigned int*);int Cyc_recvfrom(int fd,struct _dyneither_ptr buf,unsigned int n,int
flags,struct _dyneither_ptr ap){if(_get_dyneither_size(ap,sizeof(void*))!= 2)(int)
_throw((void*)Cyc_SocketError);{struct _tuple0 _tmp75=({struct _tuple0 _tmp74;_tmp74.f1=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));_tmp74.f2=*((void**)
...
send_wrapped(int,struct _dyneither_ptr,unsigned int,int);int Cyc_send(int fd,struct
_dyneither_ptr buf,unsigned int n,int flags){return send_wrapped(fd,buf,n,flags);}
int sendto_in(int,struct _dyneither_ptr,unsigned int,int,const struct Cyc_sockaddr_in*,
unsigned int);int Cyc_sendto(int fd,struct _dyneither_ptr buf,unsigned int n,int flags,
struct _dyneither_ptr ap){if(_get_dyneither_size(ap,sizeof(void*))!= 2)(int)_throw((
void*)Cyc_SocketError);{struct _tuple0 _tmp7B=({struct _tuple0 _tmp7A;_tmp7A.f1=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),0));_tmp7A.f2=*((void**)
...
_tmp80.f1=*((void**)_check_dyneither_subscript(ap,sizeof(void*),0));_tmp80.f2=*((
void**)_check_dyneither_subscript(ap,sizeof(void*),1));_tmp80;});void*_tmp82;int*
_tmp83;void*_tmp84;unsigned int _tmp85;void*_tmp86;struct Cyc_timeval*_tmp87;void*
_tmp88;unsigned int _tmp89;_LL42: _tmp82=_tmp81.f1;if(*((int*)_tmp82)!= 0)goto
_LL44;_tmp83=((struct Cyc_SO_int_struct*)_tmp82)->f1;_tmp84=_tmp81.f2;if(*((int*)
_tmp84)!= 3)goto _LL44;_tmp85=((struct Cyc_SO_socklen_struct*)_tmp84)->f1;_LL43:
return setsockopt_int(fd,level,optname,(const int*)_tmp83,_tmp85);_LL44: _tmp86=
_tmp81.f1;if(*((int*)_tmp86)!= 1)goto _LL46;_tmp87=((struct Cyc_SO_timeval_struct*)
...
struct _dyneither_ptr,unsigned int,struct _dyneither_ptr,const struct Cyc_tm*);
...
_tmpA2,_tmpA2 + 39}};int Cyc_read(int fd,struct _dyneither_ptr buf,unsigned int count){
...
int write(int fd,const char*buf,unsigned int count);static char _tmpA4[40]="write: called with count > numelts(buf)";
static struct Cyc_Core_Failure_struct Cyc___write_failure={Cyc_Core_Failure,{_tmpA4,
_tmpA4,_tmpA4 + 40}};int Cyc_write(int fd,struct _dyneither_ptr buf,unsigned int count){
