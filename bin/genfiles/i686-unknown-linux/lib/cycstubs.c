...
extern unsigned char*string_to_Cstring(struct _tagged_arr);extern unsigned char*
underlying_Cstring(struct _tagged_arr);extern struct _tagged_arr Cstring_to_string(
unsigned char*);extern struct _tagged_arr wrap_Cstring_as_string(unsigned char*,
unsigned int);extern struct _tagged_arr ntCsl_to_ntsl(unsigned char**);struct Cyc_Std_dirent{
int d_ino;int d_off;unsigned short d_reclen;unsigned char d_type;unsigned char d_name[
256];};void*Cyc_Std_opendir(struct _tagged_arr name);extern void*opendir(
unsigned char*name);void*Cyc_Std_opendir(struct _tagged_arr name){return opendir(
...
f1;};struct Cyc_Std_Long_struct{int tag;int f1;};extern int Cyc_Std_fcntl(int fd,int
cmd,struct _tagged_arr);extern int Cyc_Std_open(struct _tagged_arr,int,struct
_tagged_arr);extern int Cyc_Std_creat(struct _tagged_arr,unsigned int);extern int
fcntl(int fd,int cmd);extern int fcntl_with_arg(int fd,int cmd,int arg);extern int
...
extern int open_with_mode(unsigned char*,int,unsigned int);int Cyc_Std_fcntl(int fd,
...
_tag_arr("fcntl: too many args",sizeof(unsigned char),21);_tmp1;});_tmp0;}));}
else{void*_tmp2=*((void**)_check_unknown_subscript(argv,sizeof(void*),0));int
_tmp3;struct Cyc_Std_flock*_tmp4;_LL1: if(*((int*)_tmp2)== 1){_LL5: _tmp3=((struct
Cyc_Std_Long_struct*)_tmp2)->f1;goto _LL2;}else{goto _LL3;}_LL3: if(*((int*)_tmp2)
== 0){_LL6: _tmp4=((struct Cyc_Std_Flock_struct*)_tmp2)->f1;goto _LL4;}else{goto
_LL0;}_LL2: return fcntl_with_arg(fd,cmd,_tmp3);_LL4: return fcntl_with_lock(fd,cmd,(
struct Cyc_Std_flock*)_tmp4);_LL0:;}}}int Cyc_Std_creat(struct _tagged_arr s,
unsigned int m){return creat(string_to_Cstring(s),m);}int Cyc_Std_open(struct
_tagged_arr s,int i,struct _tagged_arr ms){if(_get_arr_size(ms,sizeof(unsigned int))
>= 1){return open_with_mode(string_to_Cstring(s),i,*((unsigned int*)
...
extern struct Cyc_Cnetdb_Cservent*getservbyname(unsigned char*name,unsigned char*
proto);extern struct Cyc_Cnetdb_Chostent*gethostbyname(unsigned char*name);extern
struct Cyc_Cnetdb_Cprotoent*getprotobyname(unsigned char*name);extern void herror(
unsigned char*);extern struct _tagged_arr pntlp_toCyc(struct Cyc_Std_in_addr**);
...
_tmp5=_cycalloc(sizeof(struct Cyc_Std_servent));_tmp5->s_name=Cstring_to_string(
src->s_name);_tmp5->s_aliases=ntCsl_to_ntsl(src->s_aliases);_tmp5->s_port=src->s_port;
_tmp5->s_proto=Cstring_to_string(src->s_proto);_tmp5;}): 0;}struct Cyc_Std_hostent*
Cyc_Std_gethostbyname(struct _tagged_arr name){struct Cyc_Cnetdb_Chostent*src=
gethostbyname(string_to_Cstring(name));return(unsigned int)src?({struct Cyc_Std_hostent*
_tmp6=_cycalloc(sizeof(struct Cyc_Std_hostent));_tmp6->h_name=Cstring_to_string(
src->h_name);_tmp6->h_aliases=ntCsl_to_ntsl(src->h_aliases);_tmp6->h_addrtype=
src->h_addrtype;_tmp6->h_length=src->h_length;_tmp6->h_addr_list=pntlp_toCyc(src->h_addr_list);
...
unsigned int)src?({struct Cyc_Std_protoent*_tmp7=_cycalloc(sizeof(struct Cyc_Std_protoent));
_tmp7->p_name=Cstring_to_string(src->p_name);_tmp7->p_aliases=ntCsl_to_ntsl(src->p_aliases);
...
;extern int Cyc_Std_inet_aton(struct _tagged_arr cp,struct Cyc_Std_in_addr*inp);
extern struct _tagged_arr Cyc_Std_inet_ntoa(struct Cyc_Std_in_addr);extern
unsigned int Cyc_Std_inet_addr(struct _tagged_arr addr);extern int inet_aton(
unsigned char*cp,struct Cyc_Std_in_addr*inp);extern unsigned char*inet_ntoa(struct
Cyc_Std_in_addr);extern unsigned int inet_addr(unsigned char*);int Cyc_Std_inet_aton(
...
int sig,void(*func)(int)))(int);extern void Cyc_Std__SIG_DFL(int);extern void Cyc_Std__SIG_IGN(
int);extern void Cyc_Std__SIG_ERR(int);extern void(*signal_func(int sig,void(*func)(
int)))(int);void Cyc_Std__SIG_DFL(int n){;}void Cyc_Std__SIG_IGN(int n){;}void Cyc_Std__SIG_ERR(
...
int tm_year;int tm_wday;int tm_yday;int tm_isdst;};extern struct _tagged_arr Cyc_Std_asctime(
const struct Cyc_Std_tm*timeptr);extern struct _tagged_arr Cyc_Std_ctime(const int*
timep);extern unsigned int Cyc_Std_strftime(struct _tagged_arr s,unsigned int maxsize,
struct _tagged_arr fmt,const struct Cyc_Std_tm*t);extern struct _tagged_arr Cyc_Std_asctime_r(
const struct Cyc_Std_tm*,struct _tagged_arr);extern struct _tagged_arr Cyc_Std_ctime_r(
const int*,struct _tagged_arr);extern int timezone;struct Cyc_Std_stat_t{
unsigned long long st_dev;unsigned short __pad1;unsigned int st_ino;unsigned int
...
extern int Cyc_Std_stat(struct _tagged_arr filename,struct Cyc_Std_stat_t*buf);extern
int Cyc_Std_lstat(struct _tagged_arr filename,struct Cyc_Std_stat_t*buf);extern int
Cyc_Std_mkdir(struct _tagged_arr pathname,unsigned int mode);extern int Cyc_Std_chmod(
struct _tagged_arr path,unsigned int mode);extern int stat(unsigned char*filename,
struct Cyc_Std_stat_t*buf);extern int lstat(unsigned char*filename,struct Cyc_Std_stat_t*
buf);extern int mkdir(unsigned char*pathname,unsigned int mode);extern int chmod(
unsigned char*pathname,unsigned int mode);int Cyc_Std_stat(struct _tagged_arr
...
string_to_Cstring(filename),buf);}int Cyc_Std_mkdir(struct _tagged_arr pathname,
unsigned int mode){return mkdir(string_to_Cstring(pathname),mode);}int Cyc_Std_chmod(
struct _tagged_arr pathname,unsigned int mode){return chmod(string_to_Cstring(
pathname),mode);}struct Cyc_Cstdio___sFILE;struct Cyc_Std___sFILE;extern struct Cyc_Std___sFILE*
Cyc_Std_fromCfile(struct Cyc_Cstdio___sFILE*cf);extern int Cyc_Std_remove(struct
_tagged_arr);extern int Cyc_Std_rename(struct _tagged_arr,struct _tagged_arr);extern
int Cyc_Std_fclose(struct Cyc_Std___sFILE*);extern int Cyc_Std_fflush(struct Cyc_Std___sFILE*);
extern struct Cyc_Std___sFILE*Cyc_Std_fopen(struct _tagged_arr __filename,struct
...
extern struct _tagged_arr Cyc_Std_strcpy(struct _tagged_arr dest,struct _tagged_arr src);
struct Cyc_Cstdio___sFILE;extern int remove(unsigned char*);extern int rename(
unsigned char*,unsigned char*);extern int fclose(struct Cyc_Cstdio___sFILE*);extern
int fflush(struct Cyc_Cstdio___sFILE*);extern struct Cyc_Cstdio___sFILE*fopen(
...
__stream);extern struct Cyc_Cstdio___sFILE*fdopen(int __fd,unsigned char*__modes);
extern int setvbuf(struct Cyc_Cstdio___sFILE*__stream,unsigned char*__buf,int
__modes,unsigned int __n);extern int fgetc(struct Cyc_Cstdio___sFILE*__stream);
extern int getc(struct Cyc_Cstdio___sFILE*__stream);extern int fputc(int __c,struct Cyc_Cstdio___sFILE*
__stream);extern int putc(int __c,struct Cyc_Cstdio___sFILE*__stream);extern int getw(
struct Cyc_Cstdio___sFILE*__stream);extern int putw(int __w,struct Cyc_Cstdio___sFILE*
__stream);extern unsigned char*fgets(unsigned char*__s,int __n,struct Cyc_Cstdio___sFILE*
__stream);extern int fputs(unsigned char*__s,struct Cyc_Cstdio___sFILE*__stream);
extern int puts(unsigned char*__s);extern int ungetc(int __c,struct Cyc_Cstdio___sFILE*
...
return(unsigned int)cf?({struct Cyc_Std___sFILE*_tmp8=_cycalloc(sizeof(struct Cyc_Std___sFILE));
_tmp8->file=cf;_tmp8;}): 0;}int Cyc_Std_remove(struct _tagged_arr filename){return
...
_check_null(f->file));return(unsigned int)cf?({struct Cyc_Std___sFILE*_tmp9=
_cycalloc(sizeof(struct Cyc_Std___sFILE));_tmp9->file=cf;_tmp9;}): 0;}void Cyc_Std_setbuf(
...
_cycalloc(sizeof(struct Cyc_Core_Failure_struct));_tmpA[0]=({struct Cyc_Core_Failure_struct
_tmpB;_tmpB.tag=Cyc_Core_Failure;_tmpB.f1=_tag_arr("setvbuf: buffer insufficient",
sizeof(unsigned char),29);_tmpB;});_tmpA;}));}return setvbuf((struct Cyc_Cstdio___sFILE*)
...
struct Cyc_Core_Failure_struct*_tmpC=_cycalloc(sizeof(struct Cyc_Core_Failure_struct));
_tmpC[0]=({struct Cyc_Core_Failure_struct _tmpD;_tmpD.tag=Cyc_Core_Failure;_tmpD.f1=
_tag_arr("fread: buffer insufficient",sizeof(unsigned char),27);_tmpD;});_tmpC;}));}
return fread(underlying_Cstring((struct _tagged_arr)ptr),size,nmemb,(struct Cyc_Cstdio___sFILE*)
_check_null(f->file));}unsigned int Cyc_Std_fwrite(struct _tagged_arr ptr,
unsigned int size,unsigned int nmemb,struct Cyc_Std___sFILE*f){if(size * nmemb > 
_get_arr_size(ptr,sizeof(unsigned char))){(int)_throw((void*)({struct Cyc_Core_Failure_struct*
_tmpE=_cycalloc(sizeof(struct Cyc_Core_Failure_struct));_tmpE[0]=({struct Cyc_Core_Failure_struct
_tmpF;_tmpF.tag=Cyc_Core_Failure;_tmpF.f1=_tag_arr("fwrite: buffer insufficient",
sizeof(unsigned char),28);_tmpF;});_tmpE;}));}return fwrite(underlying_Cstring(
ptr),size,nmemb,(struct Cyc_Cstdio___sFILE*)_check_null(f->file));}int Cyc_Std_fgetpos(
struct Cyc_Std___sFILE*f,int*x){return fgetpos((struct Cyc_Cstdio___sFILE*)
_check_null(f->file),x);}int Cyc_Std_fseek(struct Cyc_Std___sFILE*f,int offset,int
whence){return fseek((struct Cyc_Cstdio___sFILE*)_check_null(f->file),offset,
whence);}int Cyc_Std_fsetpos(struct Cyc_Std___sFILE*f,int*x){return fsetpos((struct
Cyc_Cstdio___sFILE*)_check_null(f->file),x);}int Cyc_Std_ftell(struct Cyc_Std___sFILE*
f){return ftell((struct Cyc_Cstdio___sFILE*)_check_null(f->file));}void Cyc_Std_rewind(
struct Cyc_Std___sFILE*f){rewind((struct Cyc_Cstdio___sFILE*)_check_null(f->file));}
void Cyc_Std_clearerr(struct Cyc_Std___sFILE*f){clearerr((struct Cyc_Cstdio___sFILE*)
_check_null(f->file));}int Cyc_Std_feof(struct Cyc_Std___sFILE*f){return feof((
struct Cyc_Cstdio___sFILE*)_check_null(f->file));}int Cyc_Std_ferror(struct Cyc_Std___sFILE*
f){return ferror((struct Cyc_Cstdio___sFILE*)_check_null(f->file));}void Cyc_Std_perror(
struct _tagged_arr s){perror(string_to_Cstring(s));}struct Cyc_Std___sFILE*Cyc_Std_fopen(
struct _tagged_arr name,struct _tagged_arr type){struct Cyc_Cstdio___sFILE*cf=fopen(
string_to_Cstring(name),string_to_Cstring(type));return(unsigned int)cf?({struct
Cyc_Std___sFILE*_tmp10=_cycalloc(sizeof(struct Cyc_Std___sFILE));_tmp10->file=cf;
_tmp10;}): 0;}struct Cyc_Std___sFILE*Cyc_Std_fdopen(int i,struct _tagged_arr s){
struct Cyc_Cstdio___sFILE*cf=fdopen(i,string_to_Cstring(s));return(unsigned int)
cf?({struct Cyc_Std___sFILE*_tmp11=_cycalloc(sizeof(struct Cyc_Std___sFILE));
_tmp11->file=cf;_tmp11;}): 0;}int Cyc_Std_fileno(struct Cyc_Std___sFILE*f){return
...
string_to_Cstring(m));return(unsigned int)cf?({struct Cyc_Std___sFILE*_tmp12=
_cycalloc(sizeof(struct Cyc_Std___sFILE));_tmp12->file=cf;_tmp12;}): 0;}int Cyc_Std_putw(
...
void*)({struct Cyc_Std_FileOpenError_struct*_tmp13=_cycalloc(sizeof(struct Cyc_Std_FileOpenError_struct));
_tmp13[0]=({struct Cyc_Std_FileOpenError_struct _tmp14;_tmp14.tag=Cyc_Std_FileOpenError;
_tmp14.f1=fn;_tmp14;});_tmp13;}));}return(struct Cyc_Std___sFILE*)_check_null(f);}
...
struct Cyc_Core_Invalid_argument_struct));_tmp19[0]=({struct Cyc_Core_Invalid_argument_struct
_tmp1A;_tmp1A.tag=Cyc_Core_Invalid_argument;_tmp1A.f1=_tag_arr("strtox NULL pointer",
sizeof(unsigned char),20);_tmp1A;});_tmp19;}));}{int found_zero=0;{int i=(int)(
_get_arr_size(s,sizeof(unsigned char))- 1);for(0;i >= 0;i --){if(((const
unsigned char*)s.curr)[i]== '\000'){found_zero=1;break;}}}if(! found_zero){(int)
...
_tmp1E.f1=_tag_arr("Std::qsort",sizeof(unsigned char),11);_tmp1E;});_tmp1D;}));}
...
struct Cyc_Std_SocketError_struct*_tmp21=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));
_tmp21[0]=({struct Cyc_Std_SocketError_struct _tmp22;_tmp22.tag=Cyc_Std_SocketError;
_tmp22.f1=_tag_arr("accept---need 2 args",sizeof(unsigned char),21);_tmp22;});
_tmp21;}));}{struct _tuple0 _tmp24=({struct _tuple0 _tmp23;_tmp23.f1=*((void**)
...
_tmp2D=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));_tmp2D[0]=({struct Cyc_Std_SocketError_struct
...
struct _tagged_arr ap){if(_get_arr_size(ap,sizeof(void*))!= 2){(int)_throw((void*)({
struct Cyc_Std_SocketError_struct*_tmp2F=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));
_tmp2F[0]=({struct Cyc_Std_SocketError_struct _tmp30;_tmp30.tag=Cyc_Std_SocketError;
_tmp30.f1=_tag_arr("bind---need 2 args",sizeof(unsigned char),19);_tmp30;});
_tmp2F;}));}{struct _tuple0 _tmp32=({struct _tuple0 _tmp31;_tmp31.f1=*((void**)
...
_tmp3B=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));_tmp3B[0]=({struct Cyc_Std_SocketError_struct
...
struct _tagged_arr ap){if(_get_arr_size(ap,sizeof(void*))!= 2){(int)_throw((void*)({
struct Cyc_Std_SocketError_struct*_tmp3D=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));
_tmp3D[0]=({struct Cyc_Std_SocketError_struct _tmp3E;_tmp3E.tag=Cyc_Std_SocketError;
_tmp3E.f1=_tag_arr("connect---need 2 args",sizeof(unsigned char),22);_tmp3E;});
_tmp3D;}));}{struct _tuple0 _tmp40=({struct _tuple0 _tmp3F;_tmp3F.f1=*((void**)
...
_tmp49=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));_tmp49[0]=({struct Cyc_Std_SocketError_struct
...
void*)({struct Cyc_Std_SocketError_struct*_tmp4B=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));
...
void*)({struct Cyc_Std_SocketError_struct*_tmp57=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));
...
_tmp59=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));_tmp59[0]=({struct Cyc_Std_SocketError_struct
...
void*)({struct Cyc_Std_SocketError_struct*_tmp65=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));
...
_throw((void*)({struct Cyc_Std_SocketError_struct*_tmp67=_cycalloc(sizeof(struct
Cyc_Std_SocketError_struct));_tmp67[0]=({struct Cyc_Std_SocketError_struct _tmp68;
_tmp68.tag=Cyc_Std_SocketError;_tmp68.f1=_tag_arr("recvfrom---need 2 args",
sizeof(unsigned char),23);_tmp68;});_tmp67;}));}{struct _tuple0 _tmp6A=({struct
_tuple0 _tmp69;_tmp69.f1=*((void**)_check_unknown_subscript(ap,sizeof(void*),0));
_tmp69.f2=*((void**)_check_unknown_subscript(ap,sizeof(void*),1));_tmp69;});void*
_tmp6B;unsigned int*_tmp6C;void*_tmp6D;struct Cyc_Std_sockaddr_in*_tmp6E;void*
_tmp6F;unsigned int*_tmp70;void*_tmp71;struct Cyc_Std_sockaddr*_tmp72;_LL5C: _LL64:
_tmp6D=_tmp6A.f1;if(*((int*)_tmp6D)== 0){_LL65: _tmp6E=((struct Cyc_Std_SA_sockaddr_in_struct*)
...
_throw((void*)({struct Cyc_Std_SocketError_struct*_tmp73=_cycalloc(sizeof(struct
Cyc_Std_SocketError_struct));_tmp73[0]=({struct Cyc_Std_SocketError_struct _tmp74;
_tmp74.tag=Cyc_Std_SocketError;_tmp74.f1=_tag_arr("recvfrom---bad args",sizeof(
unsigned char),20);_tmp74;});_tmp73;}));_LL5B:;}}int Cyc_Std_sendto(int fd,struct
...
_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));_tmp75[0]=({struct Cyc_Std_SocketError_struct
_tmp76;_tmp76.tag=Cyc_Std_SocketError;_tmp76.f1=_tag_arr("sendto---need 2 args",
sizeof(unsigned char),21);_tmp76;});_tmp75;}));}{struct _tuple0 _tmp78=({struct
_tuple0 _tmp77;_tmp77.f1=*((void**)_check_unknown_subscript(ap,sizeof(void*),0));
_tmp77.f2=*((void**)_check_unknown_subscript(ap,sizeof(void*),1));_tmp77;});void*
_tmp79;unsigned int _tmp7A;void*_tmp7B;struct Cyc_Std_sockaddr_in*_tmp7C;void*
_tmp7D;unsigned int _tmp7E;void*_tmp7F;struct Cyc_Std_sockaddr*_tmp80;_LL6B: _LL73:
_tmp7B=_tmp78.f1;if(*((int*)_tmp7B)== 0){_LL74: _tmp7C=((struct Cyc_Std_SA_sockaddr_in_struct*)
...
void*)({struct Cyc_Std_SocketError_struct*_tmp81=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));
...
_get_arr_size(ap,sizeof(void*))!= 2){(int)_throw((void*)({struct Cyc_Std_SocketError_struct*
_tmp83=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));_tmp83[0]=({struct Cyc_Std_SocketError_struct
...
_tmp97=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));_tmp97[0]=({struct Cyc_Std_SocketError_struct
...
_tmp9B=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));_tmp9B[0]=({struct Cyc_Std_SocketError_struct
...
_tmpA7=_cycalloc(sizeof(struct Cyc_Std_SocketError_struct));_tmpA7[0]=({struct Cyc_Std_SocketError_struct
...
_tmpAC=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_struct));_tmpAC[0]=({
struct Cyc_Core_Invalid_argument_struct _tmpAD;_tmpAD.tag=Cyc_Core_Invalid_argument;
_tmpAD.f1=_tag_arr("Time::asctime_r: string too small",sizeof(unsigned char),34);
_tmpAD;});_tmpAC;}));}else{Cyc_Std_strcpy(s,(struct _tagged_arr)_tmpAB);return s;}}
struct _tagged_arr Cyc_Std_ctime_r(const int*t,struct _tagged_arr s){struct
_tagged_arr _tmpAE=wrap_Cstring_as_string(ctime(t),- 1);if(Cyc_Std_strlen((struct
_tagged_arr)_tmpAE)+ 1 > _get_arr_size(s,sizeof(unsigned char))){(int)_throw((
void*)({struct Cyc_Core_Invalid_argument_struct*_tmpAF=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_struct));
...
unsigned char*);extern int chown(unsigned char*,unsigned int,unsigned int);extern
unsigned char*getcwd(unsigned char*buf,unsigned int size);extern int execv(
...
unsigned int owner,unsigned int group){return chown(string_to_Cstring(path),owner,
group);}struct _tagged_arr Cyc_Std_getcwd(struct _tagged_arr buf,unsigned int size){
if(!((unsigned int)buf.curr)? 1: _get_arr_size(buf,sizeof(unsigned char))< size){(
int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmpB1=_cycalloc(sizeof(struct
Cyc_Core_Failure_struct));_tmpB1[0]=({struct Cyc_Core_Failure_struct _tmpB2;_tmpB2.tag=
Cyc_Core_Failure;_tmpB2.f1=_tag_arr("getcwd: invalid buf argument",sizeof(
unsigned char),29);_tmpB2;});_tmpB1;}));}{unsigned char*response=getcwd((
...
int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmpB3=_cycalloc(sizeof(struct
Cyc_Core_Failure_struct));_tmpB3[0]=({struct Cyc_Core_Failure_struct _tmpB4;_tmpB4.tag=
Cyc_Core_Failure;_tmpB4.f1=_tag_arr("execl: arg list must be NULL-terminated",
...
_check_unknown_subscript(argv,sizeof(struct _tagged_arr),(int)(_get_arr_size(argv,
sizeof(struct _tagged_arr))- 1)))).curr != ((struct _tagged_arr)_tag_arr(0,0,0)).curr){(
int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmpB9=_cycalloc(sizeof(struct
Cyc_Core_Failure_struct));_tmpB9[0]=({struct Cyc_Core_Failure_struct _tmpBA;_tmpBA.tag=
Cyc_Core_Failure;_tmpBA.f1=_tag_arr("execl: arg list must be NULL-terminated",
...
void*)({struct Cyc_Core_Failure_struct*_tmpBF=_cycalloc(sizeof(struct Cyc_Core_Failure_struct));
_tmpBF[0]=({struct Cyc_Core_Failure_struct _tmpC0;_tmpC0.tag=Cyc_Core_Failure;
_tmpC0.f1=_tag_arr("execve: arg list must be NULL-terminated",sizeof(
unsigned char),41);_tmpC0;});_tmpBF;}));}{struct _tagged_arr newargs=({
unsigned int _tmpC5=_get_arr_size(argv,sizeof(struct _tagged_arr));unsigned char**
_tmpC6=(unsigned char**)_cycalloc(_check_times(sizeof(unsigned char*),_tmpC5));
struct _tagged_arr _tmpC8=_tag_arr(_tmpC6,sizeof(unsigned char*),_get_arr_size(
argv,sizeof(struct _tagged_arr)));{unsigned int _tmpC7=_tmpC5;unsigned int i;for(i=
0;i < _tmpC7;i ++){_tmpC6[i]=0;}};_tmpC8;});{int i=0;for(0;i < _get_arr_size(argv,
sizeof(struct _tagged_arr));i ++){((unsigned char**)newargs.curr)[i]=
string_to_Cstring((struct _tagged_arr)((struct _tagged_arr*)argv.curr)[i]);}}{
struct _tagged_arr newenvp=({unsigned int _tmpC1=_get_arr_size(envp,sizeof(struct
_tagged_arr));unsigned char**_tmpC2=(unsigned char**)_cycalloc(_check_times(
sizeof(unsigned char*),_tmpC1));struct _tagged_arr _tmpC4=_tag_arr(_tmpC2,sizeof(
...
_throw((void*)({struct Cyc_Core_Failure_struct*_tmpC9=_cycalloc(sizeof(struct Cyc_Core_Failure_struct));
...
_tmpCB=_cycalloc(sizeof(struct Cyc_Core_Failure_struct));_tmpCB[0]=({struct Cyc_Core_Failure_struct
...
_cycalloc(sizeof(struct Cyc_Core_Failure_struct));_tmpCD[0]=({struct Cyc_Core_Failure_struct
_tmpCE;_tmpCE.tag=Cyc_Core_Failure;_tmpCE.f1=_tag_arr("gethostname: called with count > buf.size",
