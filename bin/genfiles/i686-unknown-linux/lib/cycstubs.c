...
struct Cyc___cycDIR*,int);int Cyc_telldir(struct Cyc___cycDIR*);struct Cyc_Cdirent___abstractDIR;
...
const void*,const void*));static char _tmp3F[23]="qsort called with NULL";static
struct Cyc_Core_Failure_struct Cyc___qsort_failure_1={Cyc_Core_Failure,{_tmp3F,
