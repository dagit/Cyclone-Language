...
unsigned char*string_to_Cstring(struct _tagged_arr);unsigned char*
underlying_Cstring(struct _tagged_arr);struct _tagged_arr Cstring_to_string(
unsigned char*);struct _tagged_arr wrap_Cstring_as_string(unsigned char*,
unsigned int);struct _tagged_arr ntCsl_to_ntsl(unsigned char**);struct Cyc_Std_dirent{
int d_ino;int d_off;unsigned short d_reclen;unsigned char d_type;unsigned char d_name[
256];};void*Cyc_Std_opendir(struct _tagged_arr name);void*opendir(unsigned char*
name);void*Cyc_Std_opendir(struct _tagged_arr name){return opendir(
string_to_Cstring(name));}struct Cyc_Std_flock{short l_type;int l_start;short
...
lock);int creat(unsigned char*,unsigned int);int open_without_mode(unsigned char*,
int);int open_with_mode(unsigned char*,int,unsigned int);int Cyc_Std_fcntl(int fd,
int cmd,struct _tagged_arr argv){if(_get_arr_size(argv,sizeof(void*))== 0)return
...
Cyc_Core_Failure_struct _tmp1;_tmp1.tag=Cyc_Core_Failure;_tmp1.f1=_tag_arr("fcntl: too many args",
sizeof(unsigned char),21);_tmp1;});_tmp0;}));else{void*_tmp2=*((void**)
_check_unknown_subscript(argv,sizeof(void*),0));int _tmp3;struct Cyc_Std_flock*
_tmp4;_LL1: if(*((int*)_tmp2)!= 1)goto _LL3;_tmp3=((struct Cyc_Std_Long_struct*)
_tmp2)->f1;_LL2: return fcntl_with_arg(fd,cmd,_tmp3);_LL3: if(*((int*)_tmp2)!= 0)
goto _LL0;_tmp4=((struct Cyc_Std_Flock_struct*)_tmp2)->f1;_LL4: return
fcntl_with_lock(fd,cmd,(struct Cyc_Std_flock*)_tmp4);_LL0:;}}}int Cyc_Std_creat(
...
Cyc_Std_in_addr sin_addr;unsigned char sin_zero[8];};struct Cyc_Std_servent{struct
...
name);void Cyc_Std_herror(struct _tagged_arr);struct Cyc_Cnetdb_Cservent{
...
h_aliases;int h_addrtype;int h_length;struct Cyc_Std_in_addr**h_addr_list;};struct
Cyc_Cnetdb_Cprotoent{unsigned char*p_name;unsigned char**p_aliases;int p_proto;};
struct Cyc_Cnetdb_Cservent*getservbyname(unsigned char*name,unsigned char*proto);
struct Cyc_Cnetdb_Chostent*gethostbyname(unsigned char*name);struct Cyc_Cnetdb_Cprotoent*
getprotobyname(unsigned char*name);void herror(unsigned char*);struct _tagged_arr
pntlp_toCyc(struct Cyc_Std_in_addr**);struct Cyc_Std_servent*Cyc_Std_getservbyname(
...
unsigned int)src?({struct Cyc_Std_servent*_tmp5=_cycalloc(sizeof(*_tmp5));_tmp5->s_name=
Cstring_to_string(src->s_name);_tmp5->s_aliases=ntCsl_to_ntsl(src->s_aliases);
_tmp5->s_port=src->s_port;_tmp5->s_proto=Cstring_to_string(src->s_proto);_tmp5;}):
...
_tmp6=_cycalloc(sizeof(*_tmp6));_tmp6->h_name=Cstring_to_string(src->h_name);
_tmp6->h_aliases=ntCsl_to_ntsl(src->h_aliases);_tmp6->h_addrtype=src->h_addrtype;
_tmp6->h_length=src->h_length;_tmp6->h_addr_list=pntlp_toCyc(src->h_addr_list);
_tmp6;}): 0;}struct Cyc_Std_protoent*Cyc_Std_getprotobyname(struct _tagged_arr name){
struct Cyc_Cnetdb_Cprotoent*src=getprotobyname(string_to_Cstring(name));return(
unsigned int)src?({struct Cyc_Std_protoent*_tmp7=_cycalloc(sizeof(*_tmp7));_tmp7->p_name=
Cstring_to_string(src->p_name);_tmp7->p_aliases=ntCsl_to_ntsl(src->p_aliases);
_tmp7->p_proto=src->p_proto;_tmp7;}): 0;}void Cyc_Std_herror(struct _tagged_arr s){
herror(string_to_Cstring(s));}unsigned char Cyc_Std_sockaddr_in[16]="\000\000\000\000sockaddr_in";
struct Cyc_Std_sockaddr_in_struct{unsigned char*tag;struct Cyc_Std_sockaddr_in f1;}
;int Cyc_Std_inet_aton(struct _tagged_arr cp,struct Cyc_Std_in_addr*inp);struct
_tagged_arr Cyc_Std_inet_ntoa(struct Cyc_Std_in_addr);unsigned int Cyc_Std_inet_addr(
struct _tagged_arr addr);int inet_aton(unsigned char*cp,struct Cyc_Std_in_addr*inp);
unsigned char*inet_ntoa(struct Cyc_Std_in_addr);unsigned int inet_addr(
...
void Cyc_Std__SIG_DFL(int);void Cyc_Std__SIG_IGN(int);void Cyc_Std__SIG_ERR(int);
void(*signal_func(int sig,void(*func)(int)))(int);void Cyc_Std__SIG_DFL(int n){;}
void Cyc_Std__SIG_IGN(int n){;}void Cyc_Std__SIG_ERR(int n){;}void(*Cyc_Std_signal(
...
tm_yday;int tm_isdst;};struct _tagged_arr Cyc_Std_asctime(const struct Cyc_Std_tm*
timeptr);struct _tagged_arr Cyc_Std_ctime(const int*timep);unsigned int Cyc_Std_strftime(
struct _tagged_arr s,unsigned int maxsize,struct _tagged_arr fmt,const struct Cyc_Std_tm*
t);struct _tagged_arr Cyc_Std_asctime_r(const struct Cyc_Std_tm*,struct _tagged_arr);
struct _tagged_arr Cyc_Std_ctime_r(const int*,struct _tagged_arr);extern int timezone;
...
int Cyc_Std_stat(struct _tagged_arr filename,struct Cyc_Std_stat_t*buf);int Cyc_Std_lstat(
struct _tagged_arr filename,struct Cyc_Std_stat_t*buf);int Cyc_Std_mkdir(struct
_tagged_arr pathname,unsigned int mode);int Cyc_Std_chmod(struct _tagged_arr path,
unsigned int mode);int stat(unsigned char*filename,struct Cyc_Std_stat_t*buf);int
lstat(unsigned char*filename,struct Cyc_Std_stat_t*buf);int mkdir(unsigned char*
pathname,unsigned int mode);int chmod(unsigned char*pathname,unsigned int mode);int
Cyc_Std_stat(struct _tagged_arr filename,struct Cyc_Std_stat_t*buf){return stat(
...
struct _tagged_arr pathname,unsigned int mode){return mkdir(string_to_Cstring(
pathname),mode);}int Cyc_Std_chmod(struct _tagged_arr pathname,unsigned int mode){
return chmod(string_to_Cstring(pathname),mode);}struct Cyc_Cstdio___abstractFILE;
struct Cyc_Std___cycFILE;struct Cyc_Std___cycFILE*Cyc_Std_fromCfile(struct Cyc_Cstdio___abstractFILE*
cf);int Cyc_Std_remove(struct _tagged_arr);int Cyc_Std_rename(struct _tagged_arr,
...
_tagged_arr __filename,struct _tagged_arr __modes);struct Cyc_Std___cycFILE*Cyc_Std_freopen(
struct _tagged_arr,struct _tagged_arr,struct Cyc_Std___cycFILE*);void Cyc_Std_setbuf(
struct Cyc_Std___cycFILE*__stream,struct _tagged_arr __buf);int Cyc_Std_setvbuf(
struct Cyc_Std___cycFILE*__stream,struct _tagged_arr __buf,int __modes,unsigned int
__n);int Cyc_Std_fgetc(struct Cyc_Std___cycFILE*__stream);int Cyc_Std_getc(struct
Cyc_Std___cycFILE*__stream);struct _tagged_arr Cyc_Std_fgets(struct _tagged_arr __s,
int __n,struct Cyc_Std___cycFILE*__stream);int Cyc_Std_fputc(int __c,struct Cyc_Std___cycFILE*
__stream);int Cyc_Std_putc(int __c,struct Cyc_Std___cycFILE*__stream);int Cyc_Std_fputs(
struct _tagged_arr __s,struct Cyc_Std___cycFILE*__stream);int Cyc_Std_puts(struct
_tagged_arr __s);int Cyc_Std_ungetc(int __c,struct Cyc_Std___cycFILE*__stream);
unsigned int Cyc_Std_fread(struct _tagged_arr __ptr,unsigned int __size,unsigned int
__n,struct Cyc_Std___cycFILE*__stream);unsigned int Cyc_Std_fwrite(struct
_tagged_arr __ptr,unsigned int __size,unsigned int __n,struct Cyc_Std___cycFILE*__s);
int Cyc_Std_fseek(struct Cyc_Std___cycFILE*__stream,int __off,int __whence);int Cyc_Std_ftell(
struct Cyc_Std___cycFILE*__stream);void Cyc_Std_rewind(struct Cyc_Std___cycFILE*
...
stream);extern unsigned char Cyc_Std_FileCloseError[19];extern unsigned char Cyc_Std_FileOpenError[
...
unsigned int Cyc_Std_strlen(struct _tagged_arr s);struct _tagged_arr Cyc_Std_strconcat(
...
unsigned char*);int rename(unsigned char*,unsigned char*);int fclose(struct Cyc_Cstdio___abstractFILE*);
int fflush(struct Cyc_Cstdio___abstractFILE*);struct Cyc_Cstdio___abstractFILE*
fopen(unsigned char*__filename,unsigned char*__modes);struct Cyc_Cstdio___abstractFILE*
freopen(unsigned char*__filename,unsigned char*__modes,struct Cyc_Cstdio___abstractFILE*
__stream);struct Cyc_Cstdio___abstractFILE*fdopen(int __fd,unsigned char*__modes);
int setvbuf(struct Cyc_Cstdio___abstractFILE*__stream,unsigned char*__buf,int
__modes,unsigned int __n);int fgetc(struct Cyc_Cstdio___abstractFILE*__stream);int
getc(struct Cyc_Cstdio___abstractFILE*__stream);int fputc(int __c,struct Cyc_Cstdio___abstractFILE*
__stream);int putc(int __c,struct Cyc_Cstdio___abstractFILE*__stream);int getw(
struct Cyc_Cstdio___abstractFILE*__stream);int putw(int __w,struct Cyc_Cstdio___abstractFILE*
__stream);unsigned char*fgets(unsigned char*__s,int __n,struct Cyc_Cstdio___abstractFILE*
__stream);int fputs(unsigned char*__s,struct Cyc_Cstdio___abstractFILE*__stream);
int puts(unsigned char*__s);int ungetc(int __c,struct Cyc_Cstdio___abstractFILE*
__stream);unsigned int fread(unsigned char*__ptr,unsigned int __size,unsigned int
__n,struct Cyc_Cstdio___abstractFILE*__stream);unsigned int fwrite(unsigned char*
__ptr,unsigned int __size,unsigned int __n,struct Cyc_Cstdio___abstractFILE*__s);
int fseek(struct Cyc_Cstdio___abstractFILE*__stream,int __off,int __whence);int ftell(
struct Cyc_Cstdio___abstractFILE*__stream);void rewind(struct Cyc_Cstdio___abstractFILE*
__stream);int fgetpos(struct Cyc_Cstdio___abstractFILE*__stream,int*__pos);int
fsetpos(struct Cyc_Cstdio___abstractFILE*__stream,int*__pos);void clearerr(struct
Cyc_Cstdio___abstractFILE*__stream);int feof(struct Cyc_Cstdio___abstractFILE*
__stream);int ferror(struct Cyc_Cstdio___abstractFILE*__stream);void perror(
unsigned char*__s);int fileno(struct Cyc_Cstdio___abstractFILE*__stream);struct Cyc_Cstdio___abstractFILE*
popen(unsigned char*,unsigned char*);int pclose(struct Cyc_Cstdio___abstractFILE*
__stream);struct Cyc_Std___cycFILE{struct Cyc_Cstdio___abstractFILE*file;};struct
Cyc_Std___cycFILE*Cyc_Std_fromCfile(struct Cyc_Cstdio___abstractFILE*cf){return(
unsigned int)cf?({struct Cyc_Std___cycFILE*_tmp8=_cycalloc(sizeof(*_tmp8));_tmp8->file=
cf;_tmp8;}): 0;}int Cyc_Std_remove(struct _tagged_arr filename){return remove(
string_to_Cstring(filename));}int Cyc_Std_rename(struct _tagged_arr old_filename,
struct _tagged_arr new_filename){return rename(string_to_Cstring(old_filename),
string_to_Cstring(new_filename));}int Cyc_Std_fclose(struct Cyc_Std___cycFILE*f){
int r=fclose((struct Cyc_Cstdio___abstractFILE*)_check_null(f->file));if(r == 0)f->file=
0;return r;}int Cyc_Std_fflush(struct Cyc_Std___cycFILE*f){return(unsigned int)f?
fflush(f->file): fflush(0);}struct Cyc_Std___cycFILE*Cyc_Std_freopen(struct
_tagged_arr x,struct _tagged_arr y,struct Cyc_Std___cycFILE*f){struct Cyc_Cstdio___abstractFILE*
...
struct _tagged_arr);struct _tagged_arr Cyc_Std_getenv(struct _tagged_arr);double Cyc_Std_strtod(
struct _tagged_arr n,struct _tagged_arr*end);int Cyc_Std_strtol(struct _tagged_arr n,
struct _tagged_arr*end,int base);unsigned int Cyc_Std_strtoul(struct _tagged_arr n,
struct _tagged_arr*end,int base);unsigned int Cyc_Std_mstrtoul(struct _tagged_arr n,
struct _tagged_arr*endptr,int base);void Cyc_Std_qsort(struct _tagged_arr tab,
unsigned int nmemb,unsigned int szmemb,int(*compar)(const void*,const void*));int Cyc_Std_system(
struct _tagged_arr);void Cyc_Std_free(struct _tagged_arr);double atof(unsigned char*);
int atoi(unsigned char*);int atol(unsigned char*);unsigned char*getenv(
unsigned char*);int putenv(unsigned char*);double strtod(unsigned char*,
unsigned char**);int strtol(unsigned char*,unsigned char**,int);unsigned int
strtoul(unsigned char*,unsigned char**,int);void qsort(void*base,unsigned int
nmemb,unsigned int size,int(*compar)(const void*,const void*));int system(
...
1);for(0;i >= 0;i --){if(*((const unsigned char*)_check_unknown_subscript(s,sizeof(
unsigned char),i))== '\000'){found_zero=1;break;}}}if(!found_zero)(int)_throw((
void*)({struct Cyc_Core_Invalid_argument_struct*_tmp1B=_cycalloc(sizeof(*_tmp1B));
_tmp1B[0]=({struct Cyc_Core_Invalid_argument_struct _tmp1C;_tmp1C.tag=Cyc_Core_Invalid_argument;
_tmp1C.f1=_tag_arr("strtox: not a C string",sizeof(unsigned char),23);_tmp1C;});
_tmp1B;}));}}double Cyc_Std_strtod(struct _tagged_arr nptr,struct _tagged_arr*endptr){
Cyc_Std_check_valid_cstring(nptr);{unsigned char*c=underlying_Cstring(nptr);
unsigned char*e=endptr == 0?0: c;double d=strtod(c,(unsigned char**)& e);if(endptr != 
0){int n=(int)((unsigned int)e - (unsigned int)c);*endptr=_tagged_arr_plus(nptr,
sizeof(unsigned char),n);}return d;}}int Cyc_Std_strtol(struct _tagged_arr n,struct
_tagged_arr*endptr,int base){Cyc_Std_check_valid_cstring(n);{unsigned char*c=
...
void))< nmemb)(int)_throw((void*)({struct Cyc_Core_Invalid_argument_struct*_tmp1D=
_cycalloc(sizeof(*_tmp1D));_tmp1D[0]=({struct Cyc_Core_Invalid_argument_struct
...
string_to_Cstring(cmd));}void Cyc_Std_free(struct _tagged_arr ptr){;}int accept(int,
const struct Cyc_Std_sockaddr*,unsigned int*);int accept_in(int,const struct Cyc_Std_sockaddr_in*,
unsigned int*);int bind(int,const struct Cyc_Std_sockaddr*,unsigned int);int bind_in(
int,const struct Cyc_Std_sockaddr_in*,unsigned int);int connect(int,const struct Cyc_Std_sockaddr*,
...
const struct Cyc_Std_timeval*,unsigned int);unsigned char Cyc_Std_SocketError[16]="\000\000\000\000SocketError";
...
_get_arr_size(args,sizeof(void*));i ++){void*_tmp1F=((void**)args.curr)[i];_LL6:
if(*((int*)_tmp1F)!= 0)goto _LL8;_LL7: res=Cyc_Std_strconcat((struct _tagged_arr)
res,_tag_arr("|SO_int",sizeof(unsigned char),8));goto _LL5;_LL8: if(*((int*)_tmp1F)
!= 1)goto _LLA;_LL9: res=Cyc_Std_strconcat((struct _tagged_arr)res,_tag_arr("|SO_timeval",
sizeof(unsigned char),12));goto _LL5;_LLA: if(*((int*)_tmp1F)!= 2)goto _LLC;_LLB:
res=Cyc_Std_strconcat((struct _tagged_arr)res,_tag_arr("|SO_socklenptr",sizeof(
unsigned char),15));goto _LL5;_LLC: if(*((int*)_tmp1F)!= 3)goto _LL5;_LLD: res=Cyc_Std_strconcat((
struct _tagged_arr)res,_tag_arr("|SO_socklen",sizeof(unsigned char),12));goto _LL5;
_LL5:;}}return res;}struct _tuple0{void*f1;void*f2;};int Cyc_Std_accept(int fd,
...
_check_unknown_subscript(ap,sizeof(void*),1));_tmp23;});void*_tmp25;struct Cyc_Std_sockaddr_in*
_tmp26;void*_tmp27;unsigned int*_tmp28;void*_tmp29;struct Cyc_Std_sockaddr*_tmp2A;
void*_tmp2B;unsigned int*_tmp2C;_LLF: _tmp25=_tmp24.f1;if(*((int*)_tmp25)!= 0)
goto _LL11;_tmp26=((struct Cyc_Std_SA_sockaddr_in_struct*)_tmp25)->f1;_tmp27=
_tmp24.f2;if(*((int*)_tmp27)!= 2)goto _LL11;_tmp28=((struct Cyc_Std_SA_socklenptr_struct*)
_tmp27)->f1;_LL10: return accept_in(fd,(const struct Cyc_Std_sockaddr_in*)_tmp26,
_tmp28);_LL11: _tmp29=_tmp24.f1;if(*((int*)_tmp29)!= 1)goto _LL13;_tmp2A=((struct
Cyc_Std_SA_sockaddr_struct*)_tmp29)->f1;_tmp2B=_tmp24.f2;if(*((int*)_tmp2B)!= 2)
goto _LL13;_tmp2C=((struct Cyc_Std_SA_socklenptr_struct*)_tmp2B)->f1;_LL12: return
accept(fd,(const struct Cyc_Std_sockaddr*)_tmp2A,_tmp2C);_LL13:;_LL14:(int)_throw((
void*)({struct Cyc_Std_SocketError_struct*_tmp2D=_cycalloc(sizeof(*_tmp2D));
_tmp2D[0]=({struct Cyc_Std_SocketError_struct _tmp2E;_tmp2E.tag=Cyc_Std_SocketError;
_tmp2E.f1=_tag_arr("accept---bad args",sizeof(unsigned char),18);_tmp2E;});
_tmp2D;}));_LLE:;}}int Cyc_Std_bind(int fd,struct _tagged_arr ap){if(_get_arr_size(
...
sizeof(unsigned char),19);_tmp30;});_tmp2F;}));{struct _tuple0 _tmp32=({struct
_tuple0 _tmp31;_tmp31.f1=*((void**)_check_unknown_subscript(ap,sizeof(void*),0));
_tmp31.f2=*((void**)_check_unknown_subscript(ap,sizeof(void*),1));_tmp31;});void*
_tmp33;struct Cyc_Std_sockaddr_in*_tmp34;void*_tmp35;unsigned int _tmp36;void*
_tmp37;struct Cyc_Std_sockaddr*_tmp38;void*_tmp39;unsigned int _tmp3A;_LL16: _tmp33=
_tmp32.f1;if(*((int*)_tmp33)!= 0)goto _LL18;_tmp34=((struct Cyc_Std_SA_sockaddr_in_struct*)
...
_tag_arr("bind---bad args",sizeof(unsigned char),16);_tmp3C;});_tmp3B;}));_LL15:;}}
int Cyc_Std_connect(int fd,struct _tagged_arr ap){if(_get_arr_size(ap,sizeof(void*))
!= 2)(int)_throw((void*)({struct Cyc_Std_SocketError_struct*_tmp3D=_cycalloc(
sizeof(*_tmp3D));_tmp3D[0]=({struct Cyc_Std_SocketError_struct _tmp3E;_tmp3E.tag=
Cyc_Std_SocketError;_tmp3E.f1=_tag_arr("connect---need 2 args",sizeof(
unsigned char),22);_tmp3E;});_tmp3D;}));{struct _tuple0 _tmp40=({struct _tuple0
_tmp3F;_tmp3F.f1=*((void**)_check_unknown_subscript(ap,sizeof(void*),0));_tmp3F.f2=*((
void**)_check_unknown_subscript(ap,sizeof(void*),1));_tmp3F;});void*_tmp41;
struct Cyc_Std_sockaddr_in*_tmp42;void*_tmp43;unsigned int _tmp44;void*_tmp45;
struct Cyc_Std_sockaddr*_tmp46;void*_tmp47;unsigned int _tmp48;_LL1D: _tmp41=_tmp40.f1;
if(*((int*)_tmp41)!= 0)goto _LL1F;_tmp42=((struct Cyc_Std_SA_sockaddr_in_struct*)
_tmp41)->f1;_tmp43=_tmp40.f2;if(*((int*)_tmp43)!= 3)goto _LL1F;_tmp44=((struct Cyc_Std_SA_socklen_struct*)
...
_tmp4A.f1=_tag_arr("connect---bad args",sizeof(unsigned char),19);_tmp4A;});
_tmp49;}));_LL1C:;}}int Cyc_Std_getpeername(int fd,struct _tagged_arr ap){if(
_get_arr_size(ap,sizeof(void*))!= 2)(int)_throw((void*)({struct Cyc_Std_SocketError_struct*
_tmp4B=_cycalloc(sizeof(*_tmp4B));_tmp4B[0]=({struct Cyc_Std_SocketError_struct
_tmp4C;_tmp4C.tag=Cyc_Std_SocketError;_tmp4C.f1=_tag_arr("getpeername---need 2 args",
sizeof(unsigned char),26);_tmp4C;});_tmp4B;}));{struct _tuple0 _tmp4E=({struct
_tuple0 _tmp4D;_tmp4D.f1=*((void**)_check_unknown_subscript(ap,sizeof(void*),0));
_tmp4D.f2=*((void**)_check_unknown_subscript(ap,sizeof(void*),1));_tmp4D;});void*
_tmp4F;struct Cyc_Std_sockaddr_in*_tmp50;void*_tmp51;unsigned int*_tmp52;void*
_tmp53;struct Cyc_Std_sockaddr*_tmp54;void*_tmp55;unsigned int*_tmp56;_LL24:
_tmp4F=_tmp4E.f1;if(*((int*)_tmp4F)!= 0)goto _LL26;_tmp50=((struct Cyc_Std_SA_sockaddr_in_struct*)
...
_tmp57;}));_LL23:;}}int Cyc_Std_getsockname(int fd,struct _tagged_arr ap){if(
_get_arr_size(ap,sizeof(void*))!= 2)(int)_throw((void*)({struct Cyc_Std_SocketError_struct*
...
_tmp5D;struct Cyc_Std_sockaddr_in*_tmp5E;void*_tmp5F;unsigned int*_tmp60;void*
_tmp61;struct Cyc_Std_sockaddr*_tmp62;void*_tmp63;unsigned int*_tmp64;_LL2B:
_tmp5D=_tmp5C.f1;if(*((int*)_tmp5D)!= 0)goto _LL2D;_tmp5E=((struct Cyc_Std_SA_sockaddr_in_struct*)
...
_tmp65;}));_LL2A:;}}int Cyc_Std_recvfrom(int fd,struct _tagged_arr buf,unsigned int n,
int flags,struct _tagged_arr ap){if(_get_arr_size(ap,sizeof(void*))!= 2)(int)_throw((
void*)({struct Cyc_Std_SocketError_struct*_tmp67=_cycalloc(sizeof(*_tmp67));
...
_check_unknown_subscript(ap,sizeof(void*),1));_tmp69;});void*_tmp6B;struct Cyc_Std_sockaddr_in*
_tmp6C;void*_tmp6D;unsigned int*_tmp6E;void*_tmp6F;struct Cyc_Std_sockaddr*_tmp70;
void*_tmp71;unsigned int*_tmp72;_LL32: _tmp6B=_tmp6A.f1;if(*((int*)_tmp6B)!= 0)
goto _LL34;_tmp6C=((struct Cyc_Std_SA_sockaddr_in_struct*)_tmp6B)->f1;_tmp6D=
_tmp6A.f2;if(*((int*)_tmp6D)!= 2)goto _LL34;_tmp6E=((struct Cyc_Std_SA_socklenptr_struct*)
_tmp6D)->f1;_LL33: return recvfrom_in(fd,buf,n,flags,(const struct Cyc_Std_sockaddr_in*)
_tmp6C,_tmp6E);_LL34: _tmp6F=_tmp6A.f1;if(*((int*)_tmp6F)!= 1)goto _LL36;_tmp70=((
struct Cyc_Std_SA_sockaddr_struct*)_tmp6F)->f1;_tmp71=_tmp6A.f2;if(*((int*)_tmp71)
!= 2)goto _LL36;_tmp72=((struct Cyc_Std_SA_socklenptr_struct*)_tmp71)->f1;_LL35:
return recvfrom(fd,buf,n,flags,(const struct Cyc_Std_sockaddr*)_tmp70,_tmp72);_LL36:;
...
Cyc_Std_SocketError;_tmp74.f1=_tag_arr("recvfrom---bad args",sizeof(
unsigned char),20);_tmp74;});_tmp73;}));_LL31:;}}int Cyc_Std_sendto(int fd,struct
_tagged_arr buf,unsigned int n,int flags,struct _tagged_arr ap){if(_get_arr_size(ap,
sizeof(void*))!= 2)(int)_throw((void*)({struct Cyc_Std_SocketError_struct*_tmp75=
_cycalloc(sizeof(*_tmp75));_tmp75[0]=({struct Cyc_Std_SocketError_struct _tmp76;
_tmp76.tag=Cyc_Std_SocketError;_tmp76.f1=_tag_arr("sendto---need 2 args",sizeof(
unsigned char),21);_tmp76;});_tmp75;}));{struct _tuple0 _tmp78=({struct _tuple0
_tmp77;_tmp77.f1=*((void**)_check_unknown_subscript(ap,sizeof(void*),0));_tmp77.f2=*((
void**)_check_unknown_subscript(ap,sizeof(void*),1));_tmp77;});void*_tmp79;
struct Cyc_Std_sockaddr_in*_tmp7A;void*_tmp7B;unsigned int _tmp7C;void*_tmp7D;
struct Cyc_Std_sockaddr*_tmp7E;void*_tmp7F;unsigned int _tmp80;_LL39: _tmp79=_tmp78.f1;
if(*((int*)_tmp79)!= 0)goto _LL3B;_tmp7A=((struct Cyc_Std_SA_sockaddr_in_struct*)
_tmp79)->f1;_tmp7B=_tmp78.f2;if(*((int*)_tmp7B)!= 3)goto _LL3B;_tmp7C=((struct Cyc_Std_SA_socklen_struct*)
...
Cyc_Std_SocketError;_tmp82.f1=_tag_arr("sendto---bad args",sizeof(unsigned char),
18);_tmp82;});_tmp81;}));_LL38:;}}int Cyc_Std_send(int fd,struct _tagged_arr buf,
...
_tmp87;int*_tmp88;void*_tmp89;unsigned int*_tmp8A;void*_tmp8B;int*_tmp8C;void*
_tmp8D;int*_tmp8E;void*_tmp8F;struct Cyc_Std_timeval*_tmp90;void*_tmp91;
unsigned int*_tmp92;void*_tmp93;struct Cyc_Std_timeval*_tmp94;void*_tmp95;int*
_tmp96;_LL40: _tmp87=_tmp86.f1;if(*((int*)_tmp87)!= 0)goto _LL42;_tmp88=((struct
Cyc_Std_SO_int_struct*)_tmp87)->f1;_tmp89=_tmp86.f2;if(*((int*)_tmp89)!= 2)goto
_LL42;_tmp8A=((struct Cyc_Std_SO_socklenptr_struct*)_tmp89)->f1;_LL41: return
getsockopt_int(fd,level,optname,_tmp88,_tmp8A);_LL42: _tmp8B=_tmp86.f1;if(*((int*)
_tmp8B)!= 0)goto _LL44;_tmp8C=((struct Cyc_Std_SO_int_struct*)_tmp8B)->f1;_tmp8D=
_tmp86.f2;if(*((int*)_tmp8D)!= 0)goto _LL44;_tmp8E=((struct Cyc_Std_SO_int_struct*)
...
_LL3F:;}}int Cyc_Std_setsockopt(int fd,int level,int optname,struct _tagged_arr ap){
...
_tmp9F;int*_tmpA0;void*_tmpA1;unsigned int _tmpA2;void*_tmpA3;struct Cyc_Std_timeval*
_tmpA4;void*_tmpA5;unsigned int _tmpA6;_LL4B: _tmp9F=_tmp9E.f1;if(*((int*)_tmp9F)
!= 0)goto _LL4D;_tmpA0=((struct Cyc_Std_SO_int_struct*)_tmp9F)->f1;_tmpA1=_tmp9E.f2;
if(*((int*)_tmpA1)!= 3)goto _LL4D;_tmpA2=((struct Cyc_Std_SO_socklen_struct*)
_tmpA1)->f1;_LL4C: return setsockopt_int(fd,level,optname,(const int*)_tmpA0,_tmpA2);
_LL4D: _tmpA3=_tmp9E.f1;if(*((int*)_tmpA3)!= 1)goto _LL4F;_tmpA4=((struct Cyc_Std_SO_timeval_struct*)
...
_LL4A:;}}unsigned char*asctime(const struct Cyc_Std_tm*timeptr);unsigned char*
ctime(const int*timep);unsigned int strftime(unsigned char*s,unsigned int maxsize,
unsigned char*fmt,const struct Cyc_Std_tm*t);struct _tagged_arr Cyc_Std_asctime(
const struct Cyc_Std_tm*timeptr){return wrap_Cstring_as_string(asctime(timeptr),- 1);}
struct _tagged_arr Cyc_Std_ctime(const int*timep){return wrap_Cstring_as_string(
ctime(timep),- 1);}unsigned int Cyc_Std_strftime(struct _tagged_arr s,unsigned int
maxsize,struct _tagged_arr fmt,const struct Cyc_Std_tm*t){unsigned int m=
...
struct _tagged_arr)_tmpAE)+ 1 > _get_arr_size(s,sizeof(unsigned char)))(int)_throw((
void*)({struct Cyc_Core_Invalid_argument_struct*_tmpAF=_cycalloc(sizeof(*_tmpAF));
_tmpAF[0]=({struct Cyc_Core_Invalid_argument_struct _tmpB0;_tmpB0.tag=Cyc_Core_Invalid_argument;
...
_tagged_arr prompt);int access(unsigned char*,int);int chdir(unsigned char*);int
chown(unsigned char*,unsigned int,unsigned int);unsigned char*getcwd(
unsigned char*buf,unsigned int size);int execv(unsigned char*path,unsigned char**
argv);int execvp(unsigned char*file,unsigned char**argv);int execve(unsigned char*
path,unsigned char**argv,unsigned char**envp);int link(unsigned char*path1,
unsigned char*path2);int read(int fd,unsigned char*buf,unsigned int count);int rmdir(
unsigned char*);int symlink(unsigned char*path1,unsigned char*path2);int truncate(
unsigned char*,int);int write(int fd,unsigned char*buf,unsigned int count);int
unlink(unsigned char*pathname);int gethostname(unsigned char*,unsigned int);int
chroot(unsigned char*);unsigned char*getpass(unsigned char*);int Cyc_Std_access(
...
Cyc_Std_chown(struct _tagged_arr path,unsigned int owner,unsigned int group){return
chown(string_to_Cstring(path),owner,group);}struct _tagged_arr Cyc_Std_getcwd(
struct _tagged_arr buf,unsigned int size){if(!((unsigned int)buf.curr)?1:
_get_arr_size(buf,sizeof(unsigned char))< size)(int)_throw((void*)({struct Cyc_Core_Failure_struct*
...
sizeof(unsigned char),29);_tmpB2;});_tmpB1;}));{unsigned char*response=getcwd((
...
int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmpB3=_cycalloc(sizeof(*
_tmpB3));_tmpB3[0]=({struct Cyc_Core_Failure_struct _tmpB4;_tmpB4.tag=Cyc_Core_Failure;
_tmpB4.f1=_tag_arr("execl: arg list must be NULL-terminated",sizeof(
unsigned char),40);_tmpB4;});_tmpB3;}));{struct _tagged_arr newargs=({unsigned int
_tmpB5=1 + _get_arr_size(argv,sizeof(struct _tagged_arr));unsigned char**_tmpB6=(
unsigned char**)_cycalloc(_check_times(sizeof(unsigned char*),_tmpB5));struct
_tagged_arr _tmpB8=_tag_arr(_tmpB6,sizeof(unsigned char*),1 + _get_arr_size(argv,
sizeof(struct _tagged_arr)));{unsigned int _tmpB7=_tmpB5;unsigned int i;for(i=0;i < 
_tmpB7;i ++){_tmpB6[i]=0;}}_tmpB8;});*((unsigned char**)_check_unknown_subscript(
newargs,sizeof(unsigned char*),0))=string_to_Cstring(arg0);{int i=0;for(0;i < 
_get_arr_size(argv,sizeof(struct _tagged_arr));i ++){*((unsigned char**)
_check_unknown_subscript(newargs,sizeof(unsigned char*),i + 1))=string_to_Cstring(((
struct _tagged_arr*)argv.curr)[i]);}}return execv(string_to_Cstring(path),(
unsigned char**)_check_null(_untag_arr(newargs,sizeof(unsigned char*),1)));}}int
...
sizeof(unsigned char),40);_tmpBA;});_tmpB9;}));{struct _tagged_arr newargs=({
...
struct _tagged_arr));i ++){*((unsigned char**)_check_unknown_subscript(newargs,
sizeof(unsigned char*),i))=string_to_Cstring((struct _tagged_arr)((struct
_tagged_arr*)argv.curr)[i]);}}{struct _tagged_arr newenvp=({unsigned int _tmpC1=
_get_arr_size(envp,sizeof(struct _tagged_arr));unsigned char**_tmpC2=(
unsigned char**)_cycalloc(_check_times(sizeof(unsigned char*),_tmpC1));struct
_tagged_arr _tmpC4=_tag_arr(_tmpC2,sizeof(unsigned char*),_get_arr_size(envp,
sizeof(struct _tagged_arr)));{unsigned int _tmpC3=_tmpC1;unsigned int i;for(i=0;i < 
_tmpC3;i ++){_tmpC2[i]=0;}}_tmpC4;});{int i=0;for(0;i < _get_arr_size(envp,sizeof(
struct _tagged_arr));i ++){*((unsigned char**)_check_unknown_subscript(newenvp,
sizeof(unsigned char*),i))=string_to_Cstring((struct _tagged_arr)((struct
...
unsigned char)))(int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmpC9=
_cycalloc(sizeof(*_tmpC9));_tmpC9[0]=({struct Cyc_Core_Failure_struct _tmpCA;
_tmpCA.tag=Cyc_Core_Failure;_tmpCA.f1=_tag_arr("read: called with count > buf.size",
sizeof(unsigned char),35);_tmpCA;});_tmpC9;}));return read(fd,underlying_Cstring((
struct _tagged_arr)buf),count);}int Cyc_Std_rmdir(struct _tagged_arr path){return
rmdir(string_to_Cstring(path));}int Cyc_Std_symlink(struct _tagged_arr path1,struct
_tagged_arr path2){return symlink(string_to_Cstring(path1),string_to_Cstring(path2));}
int Cyc_Std_truncate(struct _tagged_arr path,int length){return truncate(
string_to_Cstring(path),length);}int Cyc_Std_write(int fd,struct _tagged_arr buf,
unsigned int count){if(count > _get_arr_size(buf,sizeof(unsigned char)))(int)
_throw((void*)({struct Cyc_Core_Failure_struct*_tmpCB=_cycalloc(sizeof(*_tmpCB));
_tmpCB[0]=({struct Cyc_Core_Failure_struct _tmpCC;_tmpCC.tag=Cyc_Core_Failure;
_tmpCC.f1=_tag_arr("write: called with count > buf.size",sizeof(unsigned char),
36);_tmpCC;});_tmpCB;}));return write(fd,underlying_Cstring(buf),count);}int Cyc_Std_unlink(
struct _tagged_arr pathname){return unlink(string_to_Cstring(pathname));}int Cyc_Std_gethostname(
struct _tagged_arr buf,unsigned int count){if(count > _get_arr_size(buf,sizeof(
...
getpass(string_to_Cstring(prompt)),- 1);}struct Cyc_Std_utimbuf{int actime;int
modtime;};int Cyc_Std_utime(struct _tagged_arr file,struct Cyc_Std_utimbuf*
file_times);int utime(unsigned char*filename,struct Cyc_Std_utimbuf*buf);int Cyc_Std_utime(
struct _tagged_arr filename,struct Cyc_Std_utimbuf*buf){return utime(
string_to_Cstring(filename),buf);}
