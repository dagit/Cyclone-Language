...
_cycalloc( sizeof( struct Cyc_Fn_Fun_struct)); _temp0[ 0]=({ struct Cyc_Fn_Fun_struct
...
void*(*)( void*), void*), void*(* x)( void*))) Cyc_Fn_make_fn)( Cyc_Fn_fp_apply,
f);} void* Cyc_Fn_apply( void* f, void* x){ void* _temp4; void*(* _temp6)( void*,
...
_LL9: return Cyc_Fn_apply( _temp13, Cyc_Fn_apply( _temp11, arg));} void* Cyc_Fn_compose(
void* g, void* f){ return(( void*(*)( void*(* f)( struct _tuple0*, void*),
struct _tuple0* x)) Cyc_Fn_make_fn)( Cyc_Fn_fn_compose,({ struct _tuple0*
_temp15=( struct _tuple0*) _cycalloc( sizeof( struct _tuple0)); _temp15->f1= f;
_temp15->f2= g; _temp15;}));} static void* Cyc_Fn_inner( struct _tuple0* env,
void* second){ return(( void*(*)( void* f, struct _tuple0* x)) Cyc_Fn_apply)((*
env).f1,({ struct _tuple0* _temp16=( struct _tuple0*) _cycalloc( sizeof( struct
_tuple0)); _temp16->f1=(* env).f2; _temp16->f2= second; _temp16;}));} static
void* Cyc_Fn_outer( void* f, void* first){ return(( void*(*)( void*(* f)( struct
_tuple0*, void*), struct _tuple0* x)) Cyc_Fn_make_fn)( Cyc_Fn_inner,({ struct
_tuple0* _temp17=( struct _tuple0*) _cycalloc( sizeof( struct _tuple0)); _temp17->f1=
f; _temp17->f2= first; _temp17;}));} void* Cyc_Fn_curry( void* f){ return Cyc_Fn_make_fn(
Cyc_Fn_outer, f);} static void* Cyc_Fn_lambda( void* f, struct _tuple0* arg){
