...
void*Cyc_Std___assert_fail(struct _tagged_arr assertion,struct _tagged_arr file,
unsigned int line);struct Cyc_Cstdio___abstractFILE;struct Cyc_Std___cycFILE;extern
