...
typedef struct _dynforward_ptr string_t;
typedef struct _dynforward_ptr mstring_t;
typedef string_t *stringptr_t;
typedef mstring_t *mstringptr_t;
typedef char *Cbuffer_t;
typedef char *CbufferNN_t;
typedef struct _dynforward_ptr buffer_t;
typedef struct _dynforward_ptr mbuffer_t;
typedef int bool;
