...
};struct _tagged_arr Cyc_Std_aprintf(struct _tagged_arr,struct _tagged_arr);int Cyc_Std_fprintf(
...
int Cyc_Std_printf(struct _tagged_arr,struct _tagged_arr);int Cyc_Std_putc(int,
struct Cyc_Std___cycFILE*);struct _tagged_arr Cyc_Std_rprintf(struct _RegionHandle*,
struct _tagged_arr,struct _tagged_arr);int Cyc_Std_snprintf(struct _tagged_arr,
unsigned int,struct _tagged_arr,struct _tagged_arr);int Cyc_Std_sprintf(struct
_tagged_arr,struct _tagged_arr,struct _tagged_arr);int Cyc_Std_vfprintf(struct Cyc_Std___cycFILE*,
...
sizeof(char),_get_zero_arr_size(_tmp4,8));});_LL9: if(*((int*)_tmp0)!= 4)goto _LLB;
_LLA: return({const char*_tmp5="buffer";_tag_arr(_tmp5,sizeof(char),
_get_zero_arr_size(_tmp5,7));});_LLB: if(*((int*)_tmp0)!= 5)goto _LL0;_LLC: return({
const char*_tmp6="unsigned long *";_tag_arr(_tmp6,sizeof(char),_get_zero_arr_size(
_tmp6,16));});_LL0:;}static void*Cyc_Std_badarg(struct _tagged_arr s){return(void*)
...
_tmp8.f1=s;_tmp8;});_tmp7;}));}static int Cyc_Std_va_arg_int(struct _tagged_arr ap){
void*_tmp9=*((void**)_check_unknown_subscript(ap,sizeof(void*),0));unsigned int
_tmpA;_LLE: if(*((int*)_tmp9)!= 1)goto _LL10;_tmpA=((struct Cyc_Std_Int_pa_struct*)
_tmp9)->f1;_LLF: return(int)_tmpA;_LL10:;_LL11: return((int(*)(struct _tagged_arr s))
Cyc_Std_badarg)(({const char*_tmpB="printf expected int";_tag_arr(_tmpB,sizeof(
char),_get_zero_arr_size(_tmpB,20));}));_LLD:;}static int Cyc_Std_va_arg_long(
...
struct Cyc_Std_Int_pa_struct*)_tmpC)->f1;_LL14: return(int)_tmpD;_LL15:;_LL16:
return((int(*)(struct _tagged_arr s))Cyc_Std_badarg)(({const char*_tmpE="printf expected int";
_tag_arr(_tmpE,sizeof(char),_get_zero_arr_size(_tmpE,20));}));_LL12:;}static
unsigned int Cyc_Std_va_arg_ulong(struct _tagged_arr ap){void*_tmpF=*((void**)
_check_unknown_subscript(ap,sizeof(void*),0));unsigned int _tmp10;_LL18: if(*((int*)
_tmpF)!= 1)goto _LL1A;_tmp10=((struct Cyc_Std_Int_pa_struct*)_tmpF)->f1;_LL19:
return(unsigned int)_tmp10;_LL1A:;_LL1B: return((unsigned int(*)(struct
_tagged_arr s))Cyc_Std_badarg)(({const char*_tmp11="printf expected int";_tag_arr(
_tmp11,sizeof(char),_get_zero_arr_size(_tmp11,20));}));_LL17:;}static
unsigned int Cyc_Std_va_arg_uint(struct _tagged_arr ap){void*_tmp12=*((void**)
_check_unknown_subscript(ap,sizeof(void*),0));unsigned int _tmp13;_LL1D: if(*((int*)
_tmp12)!= 1)goto _LL1F;_tmp13=((struct Cyc_Std_Int_pa_struct*)_tmp12)->f1;_LL1E:
return(unsigned int)_tmp13;_LL1F:;_LL20: return((unsigned int(*)(struct
_tagged_arr s))Cyc_Std_badarg)(({const char*_tmp14="printf expected int";_tag_arr(
_tmp14,sizeof(char),_get_zero_arr_size(_tmp14,20));}));_LL1C:;}static double Cyc_Std_va_arg_double(
struct _tagged_arr ap){void*_tmp15=*((void**)_check_unknown_subscript(ap,sizeof(
void*),0));double _tmp16;_LL22: if(*((int*)_tmp15)!= 2)goto _LL24;_tmp16=((struct
Cyc_Std_Double_pa_struct*)_tmp15)->f1;_LL23: return _tmp16;_LL24:;_LL25:(int)
_throw(Cyc_Std_badarg((struct _tagged_arr)({struct Cyc_Std_String_pa_struct _tmp19;
_tmp19.tag=0;_tmp19.f1=(struct _tagged_arr)Cyc_Std_parg2string(*((void**)
_check_unknown_subscript(ap,sizeof(void*),0)));{void*_tmp17[1]={& _tmp19};Cyc_Std_aprintf(({
...
_LL21:;}static short*Cyc_Std_va_arg_short_ptr(struct _tagged_arr ap){void*_tmp1A=*((
void**)_check_unknown_subscript(ap,sizeof(void*),0));short*_tmp1B;_LL27: if(*((
int*)_tmp1A)!= 3)goto _LL29;_tmp1B=((struct Cyc_Std_ShortPtr_pa_struct*)_tmp1A)->f1;
_LL28: return _tmp1B;_LL29:;_LL2A:(int)_throw(Cyc_Std_badarg(({const char*_tmp1C="printf expected short pointer";
_tag_arr(_tmp1C,sizeof(char),_get_zero_arr_size(_tmp1C,30));})));_LL26:;}static
unsigned int*Cyc_Std_va_arg_int_ptr(struct _tagged_arr ap){void*_tmp1D=*((void**)
_check_unknown_subscript(ap,sizeof(void*),0));unsigned int*_tmp1E;_LL2C: if(*((
int*)_tmp1D)!= 5)goto _LL2E;_tmp1E=((struct Cyc_Std_IntPtr_pa_struct*)_tmp1D)->f1;
_LL2D: return _tmp1E;_LL2E:;_LL2F:(int)_throw(Cyc_Std_badarg(({const char*_tmp1F="printf expected int pointer";
_tag_arr(_tmp1F,sizeof(char),_get_zero_arr_size(_tmp1F,28));})));_LL2B:;}static
struct _tagged_arr Cyc_Std_va_arg_string(struct _tagged_arr ap){void*_tmp20=*((void**)
_check_unknown_subscript(ap,sizeof(void*),0));struct _tagged_arr _tmp21;_LL31: if(*((
int*)_tmp20)!= 0)goto _LL33;_tmp21=((struct Cyc_Std_String_pa_struct*)_tmp20)->f1;
_LL32: return _tmp21;_LL33:;_LL34:(int)_throw(Cyc_Std_badarg(({const char*_tmp22="printf expected string";
_tag_arr(_tmp22,sizeof(char),_get_zero_arr_size(_tmp22,23));})));_LL30:;}int Cyc_Std___cvt_double(
...
return i;}static int Cyc_Std__IO_nzsputn(int(*ioputc)(int,void*),void*ioputc_env,
struct _tagged_arr s,int howmany){int i=0;while(i < howmany){char c;if((_get_arr_size(
s,sizeof(char))== 0?1:(c=*((const char*)_check_unknown_subscript(s,sizeof(char),0)))
== 0)?1: ioputc((int)c,ioputc_env)== - 1)return i;_tagged_arr_inplace_plus_post(& s,
sizeof(char),1);i ++;}return i;}static int Cyc_Std__IO_padn(int(*ioputc)(int,void*),
void*ioputc_env,char c,int howmany){int i=0;while(i < howmany){if(ioputc((int)c,
ioputc_env)== - 1)return i;i ++;}return i;}static struct _tagged_arr Cyc_Std_my_memchr(
struct _tagged_arr s,char c,int n){int sz=(int)_get_arr_size(s,sizeof(char));n=n < sz?
n: sz;for(0;n != 0;(n --,_tagged_arr_inplace_plus_post(& s,sizeof(char),1))){if(*((
const char*)_check_unknown_subscript(s,sizeof(char),0))== c)return s;}return(
struct _tagged_arr)_tag_arr(0,0,0);}static struct _tagged_arr Cyc_Std_my_nzmemchr(
struct _tagged_arr s,char c,int n){int sz=(int)_get_arr_size(s,sizeof(char));n=n < sz?
n: sz;for(0;n != 0;(n --,_tagged_arr_inplace_plus_post(& s,sizeof(char),1))){if(*((
const char*)_check_unknown_subscript(s,sizeof(char),0))== c)return s;}return(
struct _tagged_arr)_tag_arr(0,0,0);}static unsigned int Cyc_Std_my_strlen(struct
_tagged_arr s){unsigned int sz=_get_arr_size(s,sizeof(char));unsigned int i=0;
while(i < sz?((const char*)s.curr)[(int)i]!= 0: 0){i ++;}return i;}int Cyc_Std__IO_vfprintf(
int(*ioputc)(int,void*),void*ioputc_env,struct _tagged_arr fmt0,struct _tagged_arr
ap){struct _tagged_arr fmt;register int ch;register int n;struct _tagged_arr cp=_tag_arr(
0,0,0);struct _tagged_arr cp2=(struct _tagged_arr)_tag_arr(0,0,0);struct _tagged_arr
cp3=(struct _tagged_arr)_tag_arr(0,0,0);int which_cp;struct _tagged_arr fmark;
...
_LL36: flags |=8;goto rflag;case '*': _LL37: width=Cyc_Std_va_arg_int(ap);
...
_check_unknown_subscript(_tmp24,sizeof(char),0));char _tmp26=(char)Cyc_Std_va_arg_int(
...
goto _LL50;case 'g': _LL50: goto _LL51;case 'G': _LL51: _double=Cyc_Std_va_arg_double(ap);
...
_tmp2A;});size=Cyc_Std___cvt_double(_double,prec,flags,& softsign,ch,cp,
...
continue;case 'O': _LL53: flags |=1;goto _LL54;case 'o': _LL54: _ulong=flags & 1?Cyc_Std_va_arg_ulong(
...
void*),1);base=Cyc_Std_OCT;goto nosign;case 'p': _LL55: _ulong=(unsigned int)Cyc_Std_va_arg_long(
ap);_tagged_arr_inplace_plus_post(& ap,sizeof(void*),1);base=Cyc_Std_HEX;flags |=
64;ch=(int)'x';goto nosign;case 's': _LL56:{void*_tmp2C=*((void**)
_check_unknown_subscript(ap,sizeof(void*),0));struct _tagged_arr _tmp2D;struct
_tagged_arr _tmp2E;_LL59: if(*((int*)_tmp2C)!= 0)goto _LL5B;_tmp2D=((struct Cyc_Std_String_pa_struct*)
_tmp2C)->f1;_LL5A: which_cp=2;cp2=_tmp2D;if(cp2.curr == ((struct _tagged_arr)
_tag_arr(0,0,0)).curr)cp2=({const char*_tmp2F="(NULL)";_tag_arr(_tmp2F,sizeof(
char),_get_zero_arr_size(_tmp2F,7));});if(prec >= 0){struct _tagged_arr p=Cyc_Std_my_memchr(
cp2,'\000',prec);if(p.curr != ((struct _tagged_arr)_tag_arr(0,0,0)).curr){size=(p.curr
- cp2.curr)/ sizeof(char);if(size > prec)size=prec;}else{size=prec;}}else{size=(
int)Cyc_Std_strlen((struct _tagged_arr)cp2);}goto _LL58;_LL5B: if(*((int*)_tmp2C)!= 
4)goto _LL5D;_tmp2E=((struct Cyc_Std_Buffer_pa_struct*)_tmp2C)->f1;_LL5C: which_cp=
3;cp3=_tmp2E;if(prec >= 0){struct _tagged_arr p=Cyc_Std_my_nzmemchr(cp3,'\000',prec);
if(p.curr != ((struct _tagged_arr)_tag_arr(0,0,0)).curr){size=(p.curr - cp3.curr)/ 
sizeof(char);if(size > prec)size=prec;}else{size=prec;}}else{size=(int)Cyc_Std_my_strlen(
cp3);}goto _LL58;_LL5D:;_LL5E:(int)_throw(Cyc_Std_badarg(({const char*_tmp30="printf expected string";
...
_LL57: flags |=1;goto _LL5F;case 'u': _LL5F: _ulong=flags & 1?Cyc_Std_va_arg_ulong(ap):(
flags & 4?(unsigned int)((unsigned short)Cyc_Std_va_arg_int(ap)):(unsigned int)
Cyc_Std_va_arg_uint(ap));_tagged_arr_inplace_plus_post(& ap,sizeof(void*),1);base=
Cyc_Std_DEC;goto nosign;case 'X': _LL60: goto _LL61;case 'x': _LL61: _ulong=flags & 1?Cyc_Std_va_arg_ulong(
ap):(flags & 4?(unsigned int)((unsigned short)Cyc_Std_va_arg_int(ap)):(
unsigned int)Cyc_Std_va_arg_uint(ap));_tagged_arr_inplace_plus_post(& ap,sizeof(
void*),1);base=Cyc_Std_HEX;if(flags & 8?_ulong != 0: 0)flags |=64;nosign: sign='\000';
number: if((dprec=prec)>= 0)flags &=~ 32;cp=_tagged_arr_plus(({char*_tmp31=buf;
_tag_arr(_tmp31,sizeof(char),_get_zero_arr_size(_tmp31,349));}),sizeof(char),(
308 + 39)+ 1);if(_ulong != 0?1: prec != 0){struct _tagged_arr xdigs;switch(base){case
Cyc_Std_OCT: _LL63: do{({struct _tagged_arr _tmp32=_tagged_arr_inplace_plus(& cp,
sizeof(char),-1);char _tmp33=*((char*)_check_unknown_subscript(_tmp32,sizeof(char),
0));char _tmp34=(char)((_ulong & 7)+ '0');if(_get_arr_size(_tmp32,sizeof(char))== 
1?_tmp33 == '\000'?_tmp34 != '\000': 0: 0)_throw_arraybounds();*((char*)_tmp32.curr)=
_tmp34;});_ulong >>=3;}while((int)_ulong);if(flags & 8?*((char*)
_check_unknown_subscript(cp,sizeof(char),0))!= '0': 0)({struct _tagged_arr _tmp35=
_tagged_arr_inplace_plus(& cp,sizeof(char),-1);char _tmp36=*((char*)
_check_unknown_subscript(_tmp35,sizeof(char),0));char _tmp37='0';if(_get_arr_size(
_tmp35,sizeof(char))== 1?_tmp36 == '\000'?_tmp37 != '\000': 0: 0)_throw_arraybounds();*((
char*)_tmp35.curr)=_tmp37;});break;case Cyc_Std_DEC: _LL64: while(_ulong >= 10){({
struct _tagged_arr _tmp38=_tagged_arr_inplace_plus(& cp,sizeof(char),-1);char _tmp39=*((
char*)_check_unknown_subscript(_tmp38,sizeof(char),0));char _tmp3A=(char)(_ulong % 
10 + '0');if(_get_arr_size(_tmp38,sizeof(char))== 1?_tmp39 == '\000'?_tmp3A != '\000':
0: 0)_throw_arraybounds();*((char*)_tmp38.curr)=_tmp3A;});_ulong /=10;}({struct
_tagged_arr _tmp3B=_tagged_arr_inplace_plus(& cp,sizeof(char),-1);char _tmp3C=*((
char*)_check_unknown_subscript(_tmp3B,sizeof(char),0));char _tmp3D=(char)(_ulong + '0');
if(_get_arr_size(_tmp3B,sizeof(char))== 1?_tmp3C == '\000'?_tmp3D != '\000': 0: 0)
_throw_arraybounds();*((char*)_tmp3B.curr)=_tmp3D;});break;case Cyc_Std_HEX: _LL65:
if(ch == 'X')xdigs=({const char*_tmp3E="0123456789ABCDEF";_tag_arr(_tmp3E,sizeof(
char),_get_zero_arr_size(_tmp3E,17));});else{xdigs=({const char*_tmp3F="0123456789abcdef";
_tag_arr(_tmp3F,sizeof(char),_get_zero_arr_size(_tmp3F,17));});}do{({struct
_tagged_arr _tmp40=_tagged_arr_inplace_plus(& cp,sizeof(char),-1);char _tmp41=*((
char*)_check_unknown_subscript(_tmp40,sizeof(char),0));char _tmp42=*((const char*)
...
_throw_arraybounds();*((char*)_tmp49.curr)=_tmp4B;});do{if(Cyc_Std__IO_sputn(
ioputc,ioputc_env,(struct _tagged_arr)({char*_tmp4C=sign_string;_tag_arr(_tmp4C,
sizeof(char),_get_zero_arr_size(_tmp4C,2));}),1)!= 1)goto error;}while(0);}else{
if(flags & 64){({struct _tagged_arr _tmp4E=_tagged_arr_plus(({char*_tmp4D=ox;
_tag_arr(_tmp4D,sizeof(char),_get_zero_arr_size(_tmp4D,2));}),sizeof(char),0);
char _tmp4F=*((char*)_check_unknown_subscript(_tmp4E,sizeof(char),0));char _tmp50='0';
...
_throw_arraybounds();*((char*)_tmp52.curr)=_tmp54;});do{if(Cyc_Std__IO_sputn(
ioputc,ioputc_env,({char*_tmp55=ox;_tag_arr(_tmp55,sizeof(char),
_get_zero_arr_size(_tmp55,2));}),2)!= 2)goto error;}while(0);}}if((flags & (16 | 32))
...
which_cp == 0)do{if(Cyc_Std__IO_sputn(ioputc,ioputc_env,(struct _tagged_arr)cp,
size)!= size)goto error;}while(0);else{if(which_cp == 2)do{if(Cyc_Std__IO_sputn(
ioputc,ioputc_env,cp2,size)!= size)goto error;}while(0);else{if(which_cp == 3)do{
if(Cyc_Std__IO_nzsputn(ioputc,ioputc_env,cp3,size)!= size)goto error;}while(0);}}
if(Cyc_Std__IO_padn(ioputc,ioputc_env,'0',fpprec)< fpprec)goto error;if(flags & 16){
if(Cyc_Std__IO_padn(ioputc,ioputc_env,' ',width - fieldsz)< width - fieldsz)goto
error;}ret +=width > fieldsz?width: fieldsz;}}done: return ret;error: return - 1;}}
static struct _tagged_arr Cyc_Std_exponent(struct _tagged_arr p,int exp,int fmtch){
struct _tagged_arr t;char expbuf[309];{unsigned int _tmp71=308;unsigned int i;for(i=0;
i < _tmp71;i ++){expbuf[i]='0';}expbuf[_tmp71]=(char)0;}({struct _tagged_arr _tmp57=
_tagged_arr_inplace_plus_post(& p,sizeof(char),1);char _tmp58=*((char*)
_check_unknown_subscript(_tmp57,sizeof(char),0));char _tmp59=(char)fmtch;if(
_get_arr_size(_tmp57,sizeof(char))== 1?_tmp58 == '\000'?_tmp59 != '\000': 0: 0)
...
char),- 1),(char)0,signp);}for(0;prec --;({struct _tagged_arr _tmp8D=
...
t,expcnt,fmtch);break;case 'g': _LL6C: goto _LL6D;case 'G': _LL6D: if(!prec)++ prec;if(
...
_tmpB9;});}}if(fract != 0.0)startp=Cyc_Std_round(fract,0,startp,_tagged_arr_plus(
...
_tmpBE.f1=({const char*_tmpBF="Std::__cvt_double";_tag_arr(_tmpBF,sizeof(char),
_get_zero_arr_size(_tmpBF,18));});_tmpBE;});_tmpBD;}));}return(t.curr - startp.curr)
...
_tuple0*sptr_n){struct _tuple0 _tmpC1;struct _tagged_arr*_tmpC2;unsigned int*_tmpC3;
struct _tuple0*_tmpC0=sptr_n;_tmpC1=*_tmpC0;_tmpC2=_tmpC1.f1;_tmpC3=_tmpC1.f2;{
struct _tagged_arr s=*((struct _tagged_arr*)_tmpC2);unsigned int n=*((unsigned int*)
_tmpC3);if(_get_arr_size(s,sizeof(char))== 0?1: n == 0)return - 1;({struct
_tagged_arr _tmpC4=s;char _tmpC5=*((char*)_check_unknown_subscript(_tmpC4,sizeof(
char),0));char _tmpC6=(char)c;if(_get_arr_size(_tmpC4,sizeof(char))== 1?_tmpC5 == '\000'?
_tmpC6 != '\000': 0: 0)_throw_arraybounds();*((char*)_tmpC4.curr)=_tmpC6;});*((
struct _tagged_arr*)_tmpC2)=_tagged_arr_plus(s,sizeof(char),1);*((unsigned int*)
_tmpC3)=n - 1;return 1;}}int Cyc_Std_vsnprintf(struct _tagged_arr s,unsigned int n,
struct _tagged_arr fmt,struct _tagged_arr ap){int ans;struct _tagged_arr _tmpC7=s;
unsigned int _tmpC8=n;struct _tuple0 _tmpC9=({struct _tuple0 _tmpCD;_tmpCD.f1=& _tmpC7;
_tmpCD.f2=& _tmpC8;_tmpCD;});ans=((int(*)(int(*ioputc)(int,struct _tuple0*),struct
_tuple0*ioputc_env,struct _tagged_arr fmt0,struct _tagged_arr ap))Cyc_Std__IO_vfprintf)(
Cyc_Std_putc_string,& _tmpC9,fmt,ap);if(0 <= ans)({struct _tagged_arr _tmpCA=
_tagged_arr_plus(s,sizeof(char),ans);char _tmpCB=*((char*)
_check_unknown_subscript(_tmpCA,sizeof(char),0));char _tmpCC='\000';if(
_get_arr_size(_tmpCA,sizeof(char))== 1?_tmpCB == '\000'?_tmpCC != '\000': 0: 0)
_throw_arraybounds();*((char*)_tmpCA.curr)=_tmpCC;});return ans;}int Cyc_Std_snprintf(
...
0,fmt,ap)+ 1;struct _tagged_arr s=({unsigned int _tmpCE=(unsigned int)size;char*
_tmpCF=(char*)_region_malloc(r1,_check_times(sizeof(char),_tmpCE + 1));struct
_tagged_arr _tmpD1=_tag_arr(_tmpCF,sizeof(char),_tmpCE + 1);{unsigned int _tmpD0=
_tmpCE;unsigned int i;for(i=0;i < _tmpD0;i ++){_tmpCF[i]='\000';}_tmpCF[_tmpD0]=(
char)0;}_tmpD1;});Cyc_Std_vsprintf(s,fmt,ap);return s;}struct _tagged_arr Cyc_Std_rprintf(
