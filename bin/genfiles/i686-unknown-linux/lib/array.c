...
18];extern unsigned char Cyc_List_Nth[8];extern struct _tagged_arr Cyc_List_to_array(
struct Cyc_List_List*x);extern struct Cyc_List_List*Cyc_List_from_array(struct
_tagged_arr arr);extern void Cyc_Array_qsort(int(*)(void**,void**),struct
_tagged_arr x,int len);extern void Cyc_Array_msort(int(*)(void**,void**),struct
_tagged_arr x,int len);extern struct _tagged_arr Cyc_Array_from_list(struct Cyc_List_List*
l);extern struct Cyc_List_List*Cyc_Array_to_list(struct _tagged_arr x);extern struct
_tagged_arr Cyc_Array_copy(struct _tagged_arr x);extern struct _tagged_arr Cyc_Array_map(
void*(*f)(void*),struct _tagged_arr x);extern struct _tagged_arr Cyc_Array_map_c(void*(*
f)(void*,void*),void*env,struct _tagged_arr x);extern void Cyc_Array_imp_map(void*(*
f)(void*),struct _tagged_arr x);extern void Cyc_Array_imp_map_c(void*(*f)(void*,void*),
void*env,struct _tagged_arr x);extern unsigned char Cyc_Array_Array_mismatch[19];
extern struct _tagged_arr Cyc_Array_map2(void*(*f)(void*,void*),struct _tagged_arr x,
struct _tagged_arr y);extern void Cyc_Array_app(void*(*f)(void*),struct _tagged_arr x);
extern void Cyc_Array_app_c(void*(*f)(void*,void*),void*env,struct _tagged_arr x);
extern void Cyc_Array_iter(void(*f)(void*),struct _tagged_arr x);extern void Cyc_Array_iter_c(
void(*f)(void*,void*),void*env,struct _tagged_arr x);extern void Cyc_Array_app2(void*(*
f)(void*,void*),struct _tagged_arr x,struct _tagged_arr y);extern void Cyc_Array_app2_c(
void*(*f)(void*,void*,void*),void*env,struct _tagged_arr x,struct _tagged_arr y);
extern void Cyc_Array_iter2(void(*f)(void*,void*),struct _tagged_arr x,struct
_tagged_arr y);extern void Cyc_Array_iter2_c(void(*f)(void*,void*,void*),void*env,
struct _tagged_arr x,struct _tagged_arr y);extern void*Cyc_Array_fold_left(void*(*f)(
void*,void*),void*accum,struct _tagged_arr x);extern void*Cyc_Array_fold_left_c(
void*(*f)(void*,void*,void*),void*env,void*accum,struct _tagged_arr x);extern void*
Cyc_Array_fold_right(void*(*f)(void*,void*),struct _tagged_arr x,void*accum);
extern void*Cyc_Array_fold_right_c(void*(*f)(void*,void*,void*),void*env,struct
_tagged_arr x,void*accum);extern struct _tagged_arr Cyc_Array_rev_copy(struct
_tagged_arr x);extern void Cyc_Array_imp_rev(struct _tagged_arr x);extern int Cyc_Array_forall(
