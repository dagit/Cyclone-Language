...
base_ofs),sizeof(void*),1))> 0);if(i > j)break;temp=((void**)arr.curr)[i];((void**)
arr.curr)[i]=((void**)arr.curr)[j];((void**)arr.curr)[j]=temp;}temp=((void**)arr.curr)[
base_ofs];((void**)arr.curr)[base_ofs]=((void**)arr.curr)[j];((void**)arr.curr)[
...
Cyc_Core_Invalid_argument;_tmp2B.f1=_tag_arr("Array::extract",sizeof(
unsigned char),15);_tmp2B;});_tmp2A;}));return({unsigned int _tmp2C=(unsigned int)
n;void**_tmp2D=(void**)_cycalloc(_check_times(sizeof(void*),_tmp2C));struct
_tagged_arr _tmp2F=_tag_arr(_tmp2D,sizeof(void*),(unsigned int)n);{unsigned int
_tmp2E=_tmp2C;unsigned int i;for(i=0;i < _tmp2E;i ++){_tmp2D[i]=*((void**)
