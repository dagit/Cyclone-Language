...
_tagged_arr Cyc_Stdlib_getenv( struct _tagged_arr); struct Cyc_timeval{ int
tv_sec; int tv_usec; } ; extern struct _tagged_arr Cyc_Getopt_optarg; extern int
Cyc_Getopt_optind; extern int Cyc_Getopt_opterr; extern int Cyc_Getopt_optopt;
struct Cyc_Getopt_option{ struct _tagged_arr name; int has_arg; int* flag; int
val; } ; extern int Cyc_Getopt_getopt( int __argc, struct _tagged_arr __argv,
struct _tagged_arr __shortopts); extern int Cyc_Getopt__getopt_internal( int
__argc, struct _tagged_arr __argv, struct _tagged_arr __shortopts, struct
_tagged_arr __longopts, int* __longind, int __long_only); extern unsigned int
alarm( unsigned int seconds); extern int close( int); extern int getpid();
extern int getppid(); extern int fork(); extern int fchdir( int); extern int dup(
int); extern int dup2( int, int); extern unsigned int getuid(); extern int
setuid( unsigned int uid); extern unsigned int geteuid(); extern int seteuid(
...
struct _tagged_arr s, unsigned char c); struct _tagged_arr Cyc_Getopt_optarg;
int Cyc_Getopt_optind= 1; int Cyc_Getopt___getopt_initialized; static struct
...
static int Cyc_Getopt_first_nonopt; static int Cyc_Getopt_last_nonopt; static
int Cyc_Getopt_nonoption_flags_max_len; static int Cyc_Getopt_nonoption_flags_len;
static int Cyc_Getopt_original_argc; static int Cyc_Getopt_original_argv; static
void  __attribute__(( unused ))  Cyc_Getopt_store_args_and_env( int argc, struct
_tagged_arr argv){ Cyc_Getopt_original_argc= argc; Cyc_Getopt_original_argv=(
int) argv.curr;} static void Cyc_Getopt_exchange( struct _tagged_arr argv){ int
bottom= Cyc_Getopt_first_nonopt; int middle= Cyc_Getopt_last_nonopt; int top=
...
static struct _tagged_arr Cyc_Getopt__getopt_initialize( int argc, struct
_tagged_arr argv, struct _tagged_arr optstring){ Cyc_Getopt_first_nonopt=( Cyc_Getopt_last_nonopt=
Cyc_Getopt_optind); Cyc_Getopt_nextchar= _tag_arr( 0u, 0u, 0u); Cyc_Getopt_posixly_correct=
...
else{ Cyc_Getopt_ordering= Cyc_Getopt_PERMUTE;}}} return optstring;} int Cyc_Getopt__getopt_internal(
int argc, struct _tagged_arr argv, struct _tagged_arr optstring, struct
_tagged_arr longopts, int* longind, int long_only){ int print_errors= Cyc_Getopt_opterr;
if(*(( const unsigned char*) _check_unknown_subscript( optstring, sizeof(
unsigned char), 0)) == ':'){ print_errors= 0;} if( argc <  1){ return - 1;} Cyc_Getopt_optarg=
_tag_arr( 0u, 0u, 0u); if( Cyc_Getopt_optind ==  0? 1: ! Cyc_Getopt___getopt_initialized){
if( Cyc_Getopt_optind ==  0){ Cyc_Getopt_optind= 1;} optstring= Cyc_Getopt__getopt_initialize(
argc, argv, optstring); Cyc_Getopt___getopt_initialized= 1;} if( Cyc_Getopt_nextchar.curr
== ( _tag_arr( 0u, 0u, 0u)).curr? 1:*(( unsigned char*) _check_unknown_subscript(
Cyc_Getopt_nextchar, sizeof( unsigned char), 0u)) == '\000'){ if( Cyc_Getopt_last_nonopt
>  Cyc_Getopt_optind){ Cyc_Getopt_last_nonopt= Cyc_Getopt_optind;} if( Cyc_Getopt_first_nonopt
>  Cyc_Getopt_optind){ Cyc_Getopt_first_nonopt= Cyc_Getopt_optind;} if( Cyc_Getopt_ordering
==  Cyc_Getopt_PERMUTE){ if( Cyc_Getopt_first_nonopt !=  Cyc_Getopt_last_nonopt?
Cyc_Getopt_last_nonopt !=  Cyc_Getopt_optind: 0){ Cyc_Getopt_exchange( argv);}
...
sizeof( unsigned char), 1)) == '\000': 0) { Cyc_Getopt_optind ++;} Cyc_Getopt_last_nonopt=
...
Cyc_Getopt_last_nonopt !=  Cyc_Getopt_optind: 0){ Cyc_Getopt_exchange( argv);}
else{ if( Cyc_Getopt_first_nonopt ==  Cyc_Getopt_last_nonopt){ Cyc_Getopt_first_nonopt=
Cyc_Getopt_optind;}} Cyc_Getopt_last_nonopt= argc; Cyc_Getopt_optind= argc;} if(
Cyc_Getopt_optind ==  argc){ if( Cyc_Getopt_first_nonopt !=  Cyc_Getopt_last_nonopt){
Cyc_Getopt_optind= Cyc_Getopt_first_nonopt;} return - 1;} if(*(( unsigned char*)
_check_unknown_subscript(*(( struct _tagged_arr*) _check_unknown_subscript( argv,
sizeof( struct _tagged_arr), Cyc_Getopt_optind)), sizeof( unsigned char), 0)) != '-'?
1:*(( unsigned char*) _check_unknown_subscript(*(( struct _tagged_arr*)
_check_unknown_subscript( argv, sizeof( struct _tagged_arr), Cyc_Getopt_optind)),
sizeof( unsigned char), 1)) == '\000'){ if( Cyc_Getopt_ordering ==  Cyc_Getopt_REQUIRE_ORDER){
...
int indfound= - 1; int option_index; for( nameend= Cyc_Getopt_nextchar;( int)*((
...
struct _tagged_arr) Cyc_Getopt_nextchar,( unsigned int)(( nameend.curr -  Cyc_Getopt_nextchar.curr)
/  sizeof( unsigned char)))){ if(( unsigned int)(( nameend.curr -  Cyc_Getopt_nextchar.curr)
/  sizeof( unsigned char)) == ( unsigned int) Cyc_String_strlen((( const struct
...
indfound= option_index;} else{ if((( long_only? 1:(( const struct Cyc_Getopt_option*)
_check_unknown_subscript( pfound, sizeof( struct Cyc_Getopt_option), 0u))->has_arg
!= (( const struct Cyc_Getopt_option*) _check_unknown_subscript( p, sizeof(
struct Cyc_Getopt_option), 0u))->has_arg)? 1:(( const struct Cyc_Getopt_option*)
_check_unknown_subscript( pfound, sizeof( struct Cyc_Getopt_option), 0u))->flag
!= (( const struct Cyc_Getopt_option*) _check_unknown_subscript( p, sizeof(
struct Cyc_Getopt_option), 0u))->flag)? 1:(( const struct Cyc_Getopt_option*)
_check_unknown_subscript( pfound, sizeof( struct Cyc_Getopt_option), 0u))->val
!= (( const struct Cyc_Getopt_option*) _check_unknown_subscript( p, sizeof(
struct Cyc_Getopt_option), 0u))->val){ ambig= 1;}}}}} if( ambig? ! exact: 0){
if( print_errors){({ struct Cyc_Stdio_String_pa_struct _temp2; _temp2.tag= Cyc_Stdio_String_pa;
_temp2.f1=( struct _tagged_arr)*(( struct _tagged_arr*) _check_unknown_subscript(
argv, sizeof( struct _tagged_arr), Cyc_Getopt_optind));{ struct Cyc_Stdio_String_pa_struct
_temp1; _temp1.tag= Cyc_Stdio_String_pa; _temp1.f1=( struct _tagged_arr)*((
struct _tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr),
0));{ void* _temp0[ 2u]={& _temp1,& _temp2}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr,
_tag_arr("%s: option `%s' is ambiguous\n", sizeof( unsigned char), 30u),
_tag_arr( _temp0, sizeof( void*), 2u));}}});} _tagged_arr_inplace_plus(& Cyc_Getopt_nextchar,
sizeof( unsigned char),( int) Cyc_String_strlen(( struct _tagged_arr) Cyc_Getopt_nextchar));
...
-  1)), sizeof( unsigned char), 1)) == '-'){({ struct Cyc_Stdio_String_pa_struct
_temp5; _temp5.tag= Cyc_Stdio_String_pa; _temp5.f1=( struct _tagged_arr)(( const
struct Cyc_Getopt_option*) _check_unknown_subscript( pfound, sizeof( struct Cyc_Getopt_option),
0u))->name;{ struct Cyc_Stdio_String_pa_struct _temp4; _temp4.tag= Cyc_Stdio_String_pa;
...
else{({ struct Cyc_Stdio_String_pa_struct _temp9; _temp9.tag= Cyc_Stdio_String_pa;
_temp9.f1=( struct _tagged_arr)(( const struct Cyc_Getopt_option*)
_check_unknown_subscript( pfound, sizeof( struct Cyc_Getopt_option), 0u))->name;{
struct Cyc_Stdio_Int_pa_struct _temp8; _temp8.tag= Cyc_Stdio_Int_pa; _temp8.f1=(
...
_temp7; _temp7.tag= Cyc_Stdio_String_pa; _temp7.f1=( struct _tagged_arr)*((
struct _tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr),
0));{ void* _temp6[ 3u]={& _temp7,& _temp8,& _temp9}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr,
_tag_arr("%s: option `%c%s' doesn't allow an argument\n", sizeof( unsigned char),
45u), _tag_arr( _temp6, sizeof( void*), 3u));}}}});}} _tagged_arr_inplace_plus(&
Cyc_Getopt_nextchar, sizeof( unsigned char),( int) Cyc_String_strlen(( struct
...
_check_unknown_subscript( argv, sizeof( struct _tagged_arr), Cyc_Getopt_optind
++));} else{ if( print_errors){({ struct Cyc_Stdio_String_pa_struct _temp12;
_temp12.tag= Cyc_Stdio_String_pa; _temp12.f1=( struct _tagged_arr)*(( struct
_tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr), Cyc_Getopt_optind
-  1));{ struct Cyc_Stdio_String_pa_struct _temp11; _temp11.tag= Cyc_Stdio_String_pa;
_temp11.f1=( struct _tagged_arr)*(( struct _tagged_arr*)
_check_unknown_subscript( argv, sizeof( struct _tagged_arr), 0));{ void* _temp10[
2u]={& _temp11,& _temp12}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr, _tag_arr("%s: option `%s' requires an argument\n",
sizeof( unsigned char), 38u), _tag_arr( _temp10, sizeof( void*), 2u));}}});}
_tagged_arr_inplace_plus(& Cyc_Getopt_nextchar, sizeof( unsigned char),( int)
Cyc_String_strlen(( struct _tagged_arr) Cyc_Getopt_nextchar)); Cyc_Getopt_optopt=((
const struct Cyc_Getopt_option*) _check_unknown_subscript( pfound, sizeof(
struct Cyc_Getopt_option), 0u))->val; return( int)(*(( const unsigned char*)
_check_unknown_subscript( optstring, sizeof( unsigned char), 0)) == ':'?':':'?');}}}
_tagged_arr_inplace_plus(& Cyc_Getopt_nextchar, sizeof( unsigned char),( int)
Cyc_String_strlen(( struct _tagged_arr) Cyc_Getopt_nextchar)); if( longind !=  0){*((
int*) _check_null( longind))= option_index;} if(( unsigned int)(( const struct
Cyc_Getopt_option*) _check_unknown_subscript( pfound, sizeof( struct Cyc_Getopt_option),
0u))->flag){*(( int*) _check_null((( const struct Cyc_Getopt_option*)
_check_unknown_subscript( pfound, sizeof( struct Cyc_Getopt_option), 0u))->flag))=((
const struct Cyc_Getopt_option*) _check_unknown_subscript( pfound, sizeof(
struct Cyc_Getopt_option), 0u))->val; return 0;} return(( const struct Cyc_Getopt_option*)
_check_unknown_subscript( pfound, sizeof( struct Cyc_Getopt_option), 0u))->val;}
...
if( print_errors){ if(*(( unsigned char*) _check_unknown_subscript(*(( struct
_tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr), Cyc_Getopt_optind)),
sizeof( unsigned char), 1)) == '-'){({ struct Cyc_Stdio_String_pa_struct _temp15;
_temp15.tag= Cyc_Stdio_String_pa; _temp15.f1=( struct _tagged_arr) Cyc_Getopt_nextchar;{
struct Cyc_Stdio_String_pa_struct _temp14; _temp14.tag= Cyc_Stdio_String_pa;
_temp14.f1=( struct _tagged_arr)*(( struct _tagged_arr*)
_check_unknown_subscript( argv, sizeof( struct _tagged_arr), 0));{ void* _temp13[
2u]={& _temp14,& _temp15}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr, _tag_arr("%s: unrecognized option `--%s'\n",
sizeof( unsigned char), 32u), _tag_arr( _temp13, sizeof( void*), 2u));}}});}
else{({ struct Cyc_Stdio_String_pa_struct _temp19; _temp19.tag= Cyc_Stdio_String_pa;
_temp19.f1=( struct _tagged_arr) Cyc_Getopt_nextchar;{ struct Cyc_Stdio_Int_pa_struct
_temp18; _temp18.tag= Cyc_Stdio_Int_pa; _temp18.f1=( int)(( unsigned int)(( int)*((
unsigned char*) _check_unknown_subscript(*(( struct _tagged_arr*)
_check_unknown_subscript( argv, sizeof( struct _tagged_arr), Cyc_Getopt_optind)),
sizeof( unsigned char), 0))));{ struct Cyc_Stdio_String_pa_struct _temp17;
_temp17.tag= Cyc_Stdio_String_pa; _temp17.f1=( struct _tagged_arr)*(( struct
_tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr), 0));{
void* _temp16[ 3u]={& _temp17,& _temp18,& _temp19}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr,
_tag_arr("%s: unrecognized option `%c%s'\n", sizeof( unsigned char), 32u),
_tag_arr( _temp16, sizeof( void*), 3u));}}}});}} Cyc_Getopt_nextchar= _tag_arr(({
unsigned int _temp20=( unsigned int) 1; unsigned char* _temp21=( unsigned char*)
GC_malloc_atomic( sizeof( unsigned char) *  _temp20);{ unsigned int _temp22=
_temp20; unsigned int i; for( i= 0; i <  _temp22; i ++){ _temp21[ i]='\000';}};
_temp21;}), sizeof( unsigned char),( unsigned int) 1); Cyc_Getopt_optind ++; Cyc_Getopt_optopt=
...
0u)).curr? 1: c == ':'){ if( print_errors){ if(( unsigned int) Cyc_Getopt_posixly_correct.curr){({
...
_check_unknown_subscript( temp, sizeof( unsigned char), 0)) == 'W'?*(( const
unsigned char*) _check_unknown_subscript( temp, sizeof( unsigned char), 1)) == ';':
0){ struct _tagged_arr nameend; struct _tagged_arr p; struct _tagged_arr pfound=(
struct _tagged_arr) _tag_arr( 0u, 0u, 0u); int exact= 0; int ambig= 0; int
indfound= 0; int option_index; if(*(( unsigned char*) _check_unknown_subscript(
...
if( print_errors){({ struct Cyc_Stdio_Int_pa_struct _temp31; _temp31.tag= Cyc_Stdio_Int_pa;
_temp31.f1=( int)(( unsigned int)(( int) c));{ struct Cyc_Stdio_String_pa_struct
...
const unsigned char*) _check_unknown_subscript( optstring, sizeof( unsigned char),
0)) == ':'){ c=':';} else{ c='?';} return( int) c;} else{ Cyc_Getopt_optarg=*((
struct _tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr),
Cyc_Getopt_optind ++));}} for( Cyc_Getopt_nextchar=( nameend= Cyc_Getopt_optarg);(
int)*(( unsigned char*) _check_unknown_subscript( nameend, sizeof( unsigned char),
0u))?*(( unsigned char*) _check_unknown_subscript( nameend, sizeof(
unsigned char), 0u)) != '=': 0; _tagged_arr_inplace_plus_post(& nameend, sizeof(
unsigned char), 1)){;} for(( p= longopts, option_index= 0);( unsigned int)(((
const struct Cyc_Getopt_option*) _check_unknown_subscript( p, sizeof( struct Cyc_Getopt_option),
0u))->name).curr;( _tagged_arr_inplace_plus_post(& p, sizeof( struct Cyc_Getopt_option),
1), option_index ++)){ if( ! Cyc_String_strncmp((( const struct Cyc_Getopt_option*)
_check_unknown_subscript( p, sizeof( struct Cyc_Getopt_option), 0u))->name,(
struct _tagged_arr) Cyc_Getopt_nextchar,( unsigned int)(( nameend.curr -  Cyc_Getopt_nextchar.curr)
/  sizeof( unsigned char)))){ if(( unsigned int)(( nameend.curr -  Cyc_Getopt_nextchar.curr)
/  sizeof( unsigned char)) ==  Cyc_String_strlen((( const struct Cyc_Getopt_option*)
_check_unknown_subscript( p, sizeof( struct Cyc_Getopt_option), 0u))->name)){
pfound= _tag_arr(( const struct Cyc_Getopt_option*) _check_null( _untag_arr( p,
sizeof( struct Cyc_Getopt_option), 1u)), sizeof( struct Cyc_Getopt_option), 1u);
indfound= option_index; exact= 1; break;} else{ if( pfound.curr == (( struct
_tagged_arr) _tag_arr( 0u, 0u, 0u)).curr){ pfound= _tag_arr(( const struct Cyc_Getopt_option*)
_check_null( _untag_arr( p, sizeof( struct Cyc_Getopt_option), 1u)), sizeof(
struct Cyc_Getopt_option), 1u); indfound= option_index;} else{ ambig= 1;}}}} if(
ambig? ! exact: 0){ if( print_errors){({ struct Cyc_Stdio_String_pa_struct
_temp34; _temp34.tag= Cyc_Stdio_String_pa; _temp34.f1=( struct _tagged_arr)*((
struct _tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr),
Cyc_Getopt_optind));{ struct Cyc_Stdio_String_pa_struct _temp33; _temp33.tag=
Cyc_Stdio_String_pa; _temp33.f1=( struct _tagged_arr)*(( struct _tagged_arr*)
_check_unknown_subscript( argv, sizeof( struct _tagged_arr), 0));{ void* _temp32[
2u]={& _temp33,& _temp34}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr, _tag_arr("%s: option `-W %s' is ambiguous\n",
sizeof( unsigned char), 33u), _tag_arr( _temp32, sizeof( void*), 2u));}}});}
_tagged_arr_inplace_plus(& Cyc_Getopt_nextchar, sizeof( unsigned char),( int)
Cyc_String_strlen(( struct _tagged_arr) Cyc_Getopt_nextchar)); Cyc_Getopt_optind
++; return( int)'?';} if( pfound.curr != (( struct _tagged_arr) _tag_arr( 0u, 0u,
0u)).curr){ option_index= indfound; if(( int)*(( unsigned char*)
_check_unknown_subscript( nameend, sizeof( unsigned char), 0u))){ if((( const
struct Cyc_Getopt_option*) _check_unknown_subscript( pfound, sizeof( struct Cyc_Getopt_option),
0u))->has_arg){ Cyc_Getopt_optarg= _tagged_arr_plus( nameend, sizeof(
unsigned char), 1);} else{ if( print_errors){({ struct Cyc_Stdio_String_pa_struct
_temp37; _temp37.tag= Cyc_Stdio_String_pa; _temp37.f1=( struct _tagged_arr)((
const struct Cyc_Getopt_option*) _check_unknown_subscript( pfound, sizeof(
struct Cyc_Getopt_option), 0u))->name;{ struct Cyc_Stdio_String_pa_struct
_temp36; _temp36.tag= Cyc_Stdio_String_pa; _temp36.f1=( struct _tagged_arr)*((
struct _tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr),
0));{ void* _temp35[ 2u]={& _temp36,& _temp37}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr,
_tag_arr("%s: option `-W %s' doesn't allow an argument\n", sizeof( unsigned char),
46u), _tag_arr( _temp35, sizeof( void*), 2u));}}});} _tagged_arr_inplace_plus(&
Cyc_Getopt_nextchar, sizeof( unsigned char),( int) Cyc_String_strlen(( struct
_tagged_arr) Cyc_Getopt_nextchar)); return( int)'?';}} else{ if((( const struct
Cyc_Getopt_option*) _check_unknown_subscript( pfound, sizeof( struct Cyc_Getopt_option),
0u))->has_arg ==  1){ if( Cyc_Getopt_optind <  argc){ Cyc_Getopt_optarg=*((
struct _tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr),
Cyc_Getopt_optind ++));} else{ if( print_errors){({ struct Cyc_Stdio_String_pa_struct
_temp40; _temp40.tag= Cyc_Stdio_String_pa; _temp40.f1=( struct _tagged_arr)*((
struct _tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr),
Cyc_Getopt_optind -  1));{ struct Cyc_Stdio_String_pa_struct _temp39; _temp39.tag=
Cyc_Stdio_String_pa; _temp39.f1=( struct _tagged_arr)*(( struct _tagged_arr*)
_check_unknown_subscript( argv, sizeof( struct _tagged_arr), 0));{ void* _temp38[
2u]={& _temp39,& _temp40}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr, _tag_arr("%s: option `%s' requires an argument\n",
sizeof( unsigned char), 38u), _tag_arr( _temp38, sizeof( void*), 2u));}}});}
_tagged_arr_inplace_plus(& Cyc_Getopt_nextchar, sizeof( unsigned char),( int)
Cyc_String_strlen(( struct _tagged_arr) Cyc_Getopt_nextchar)); return( int)(*((
const unsigned char*) _check_unknown_subscript( optstring, sizeof( unsigned char),
0)) == ':'?':':'?');}}} _tagged_arr_inplace_plus(& Cyc_Getopt_nextchar, sizeof(
unsigned char),( int) Cyc_String_strlen(( struct _tagged_arr) Cyc_Getopt_nextchar));
...
pfound, sizeof( struct Cyc_Getopt_option), 0u))->val;} Cyc_Getopt_nextchar=
_tag_arr( 0u, 0u, 0u); return( int)'W';} if(*(( const unsigned char*)
...
Cyc_Getopt_nextchar, sizeof( unsigned char), 0u)) != '\000'){ Cyc_Getopt_optarg=
Cyc_Getopt_nextchar; Cyc_Getopt_optind ++;} else{ if( Cyc_Getopt_optind ==  argc){
if( print_errors){({ struct Cyc_Stdio_Int_pa_struct _temp43; _temp43.tag= Cyc_Stdio_Int_pa;
_temp43.f1=( int)(( unsigned int)(( int) c));{ struct Cyc_Stdio_String_pa_struct
_temp42; _temp42.tag= Cyc_Stdio_String_pa; _temp42.f1=( struct _tagged_arr)*((
struct _tagged_arr*) _check_unknown_subscript( argv, sizeof( struct _tagged_arr),
0));{ void* _temp41[ 2u]={& _temp42,& _temp43}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr,
_tag_arr("%s: option requires an argument -- %c\n", sizeof( unsigned char), 39u),
_tag_arr( _temp41, sizeof( void*), 2u));}}});} Cyc_Getopt_optopt=( int) c; if(*((
const unsigned char*) _check_unknown_subscript( optstring, sizeof( unsigned char),
