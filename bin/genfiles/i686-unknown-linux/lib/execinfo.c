...
Cyc_Std_rlimit{ unsigned int rlim_cur; unsigned int rlim_max; } ; struct Cyc_Std_rusage{
struct Cyc_Std_timeval ru_utime; struct Cyc_Std_timeval ru_stime; int ru_maxrss;
int ru_ixrss; int ru_idrss; int ru_isrss; int ru_minflt; int ru_majflt; int
ru_nswap; int ru_inblock; int ru_oublock; int ru_msgsnd; int ru_msgrcv; int
ru_nsignals; int ru_nvcsw; int ru_nivcsw; } ; extern int getrlimit( int resource,
struct Cyc_Std_rlimit* rlim); extern int setrlimit( int resource, const struct
Cyc_Std_rlimit* rlim); extern int getrusage( int who, struct Cyc_Std_rusage*
rusage); extern int wait( int* status); extern int waitpid( int pid, int* status,
int options); extern int wait3( int* status, int options, struct Cyc_Std_rusage*
rusage); void(* Cyc_Std_signal( int sig, void(* func)( int)))( int); extern int
raise( int sig); extern int kill( int, int); struct Cyc_Std_option{ struct
...
int); int Cyc_Std_access( struct _tagged_arr, int); int Cyc_Std_chdir( struct
...
struct _tagged_arr, struct _tagged_arr); int Cyc_Std_read( int fd, struct
_tagged_arr buf, unsigned int count); int Cyc_Std_rmdir( struct _tagged_arr);
int Cyc_Std_symlink( struct _tagged_arr, struct _tagged_arr); int Cyc_Std_truncate(
struct _tagged_arr, int); int Cyc_Std_write( int fd, struct _tagged_arr buf,
unsigned int count); int Cyc_Std_unlink( struct _tagged_arr pathname); int Cyc_Std_gethostname(
struct _tagged_arr, unsigned int); int Cyc_Std_chroot( struct _tagged_arr);
struct _tagged_arr Cyc_Std_getpass( struct _tagged_arr prompt); extern int
backtrace( int*, int); int Cyc_Execinfo_backtrace( struct _tagged_arr array, int
size){ if( size >  _get_arr_size( array, sizeof( int))){( int) _throw(( void*)({
