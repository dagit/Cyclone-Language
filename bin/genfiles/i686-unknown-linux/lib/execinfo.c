...
sizeof(void*),1));}});_tmp2[1]=_tag_arr("-e",sizeof(unsigned char),3);_tmp2[0]=
_tag_arr("--functions",sizeof(unsigned char),12);Cyc_Std_execlp(_tag_arr("addr2line",
...
_tmp6;_tmp6.tag=1;_tmp6.f1=(unsigned int)bt[_check_known_subscript_notnull(20,c)];{
void*_tmp5[1]={& _tmp6};Cyc_Std_fprintf(w,_tag_arr("%#x\n",sizeof(unsigned char),
5),_tag_arr(_tmp5,sizeof(void*),1));}});}}Cyc_Std_fflush((struct Cyc_Std___cycFILE*)
