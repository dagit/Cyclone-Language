...
f1;};struct Cyc_IntPtr_pa_struct{int tag;unsigned int*f1;};struct Cyc_ShortPtr_sa_struct{
...
struct Cyc___cycFILE*Cyc_tmpfile();struct _tagged_arr Cyc_tmpnam(struct _tagged_arr);
...
_tagged_arr Cyc_strcpy(struct _tagged_arr dest,struct _tagged_arr src);struct Cyc_Cstdio___abstractFILE*
tmpfile();char*tmpnam(char*);struct Cyc___cycFILE*Cyc_tmpfile(){struct Cyc_Cstdio___abstractFILE*
cf=tmpfile();return Cyc_fromCfile(cf);}struct _tagged_arr Cyc_tmpnam(struct
_tagged_arr s){char*name=tmpnam(0);return(unsigned int)s.curr?Cyc_strcpy(s,(
