...
Cyc_Std_fromCfile(struct Cyc_Cstdio___abstractFILE*cf);extern struct Cyc_Std___cycFILE*
Cyc_Std_tmpfile();extern struct _tagged_arr Cyc_Std_tmpnam(struct _tagged_arr);
...
extern unsigned char Cyc_List_Nth[8];extern struct _tagged_arr Cyc_Std_strcpy(struct
_tagged_arr dest,struct _tagged_arr src);extern struct Cyc_Cstdio___abstractFILE*
tmpfile();extern unsigned char*tmpnam(unsigned char*);struct Cyc_Std___cycFILE*Cyc_Std_tmpfile(){
