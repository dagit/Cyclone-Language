...
struct Cyc_Xarray_Xarray{struct _tagged_arr elmts;int num_elmts;};int Cyc_Xarray_length(
...
int,void*);struct Cyc_Xarray_Xarray*Cyc_Xarray_create_empty();struct Cyc_Xarray_Xarray*
Cyc_Xarray_singleton(int,void*);void Cyc_Xarray_add(struct Cyc_Xarray_Xarray*,void*);
int Cyc_Xarray_add_ind(struct Cyc_Xarray_Xarray*,void*);struct _tagged_arr Cyc_Xarray_to_array(
struct Cyc_Xarray_Xarray*);struct Cyc_Xarray_Xarray*Cyc_Xarray_from_array(struct
_tagged_arr arr);struct Cyc_Xarray_Xarray*Cyc_Xarray_append(struct Cyc_Xarray_Xarray*,
struct Cyc_Xarray_Xarray*);void Cyc_Xarray_app(void*(*f)(void*),struct Cyc_Xarray_Xarray*);
void Cyc_Xarray_app_c(void*(*f)(void*,void*),void*,struct Cyc_Xarray_Xarray*);void
Cyc_Xarray_iter(void(*f)(void*),struct Cyc_Xarray_Xarray*);void Cyc_Xarray_iter_c(
void(*f)(void*,void*),void*,struct Cyc_Xarray_Xarray*);struct Cyc_Xarray_Xarray*
Cyc_Xarray_map(void*(*f)(void*),struct Cyc_Xarray_Xarray*);struct Cyc_Xarray_Xarray*
Cyc_Xarray_map_c(void*(*f)(void*,void*),void*,struct Cyc_Xarray_Xarray*);void Cyc_Xarray_reuse(
struct Cyc_Xarray_Xarray*xarr);int Cyc_Xarray_length(struct Cyc_Xarray_Xarray*xarr){
return xarr->num_elmts;}void*Cyc_Xarray_get(struct Cyc_Xarray_Xarray*xarr,int i){
...
_tmp15;});{int i=1;for(0;i < xarr->num_elmts;++ i){*((void**)
