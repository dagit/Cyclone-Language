...
_temp21;});{ int i= 1; for( 0; i <  xarr->num_elmts; ++ i){(( void**) newarr.curr)[
i]=*(( void**) _check_unknown_subscript( xarr->elmts, sizeof( void*), i));}}
xarr->elmts= newarr;}}*(( void**) _check_unknown_subscript( xarr->elmts, sizeof(
...
_tagged_arr Cyc_Xarray_to_array( struct Cyc_Xarray_Xarray* xarr){ if( xarr->num_elmts
==  0){ return _tag_arr(({ void** _temp22=( void**) _cycalloc( sizeof( void*) * 
0); _temp22;}), sizeof( void*), 0u);}{ struct _tagged_arr ans=({ unsigned int
_temp23=( unsigned int) xarr->num_elmts; void** _temp24=( void**) _cycalloc(
_check_times( sizeof( void*), _temp23)); struct _tagged_arr _temp26= _tag_arr(
_temp24, sizeof( void*),( unsigned int) xarr->num_elmts);{ unsigned int _temp25=
_temp23; unsigned int i; for( i= 0; i <  _temp25; i ++){ _temp24[ i]=*(( void**)
_check_unknown_subscript( xarr->elmts, sizeof( void*),( int) i));}}; _temp26;});
return ans;}} struct Cyc_Xarray_Xarray* Cyc_Xarray_from_array( struct
_tagged_arr arr){ if( _get_arr_size( arr, sizeof( void*)) ==  0){ return Cyc_Xarray_create_empty();}{
struct Cyc_Xarray_Xarray* ans=({ struct Cyc_Xarray_Xarray* _temp27=( struct Cyc_Xarray_Xarray*)
_cycalloc( sizeof( struct Cyc_Xarray_Xarray)); _temp27->elmts=({ unsigned int
_temp28= _get_arr_size( arr, sizeof( void*)); void** _temp29=( void**) _cycalloc(
...
void**) arr.curr)[( int) i];}}; _temp31;}); _temp27->num_elmts=( int)
_get_arr_size( arr, sizeof( void*)); _temp27;}); return ans;}} struct Cyc_Xarray_Xarray*
...
ans=({ struct Cyc_Xarray_Xarray* _temp32=( struct Cyc_Xarray_Xarray*) _cycalloc(
sizeof( struct Cyc_Xarray_Xarray)); _temp32->elmts=({ unsigned int _temp33=(
unsigned int) newsz; void** _temp34=( void**) _cycalloc( _check_times( sizeof(
void*), _temp33)); struct _tagged_arr _temp36= _tag_arr( _temp34, sizeof( void*),(
