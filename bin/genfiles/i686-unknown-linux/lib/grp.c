...
struct Cyc_std_group* Cyc_std_getgrgid( unsigned int uid); extern int Cyc_std_initgroups(
...
extern int initgroups( unsigned char* user, unsigned int group); struct Cyc_std_group*
Cyc_std_getgrnam( struct _tagged_arr name){ struct Cyc_Cgrp_Cgroup* src=
getgrnam( string_to_Cstring( name)); return( unsigned int) src?({ struct Cyc_std_group*
_temp0=( struct Cyc_std_group*) GC_malloc( sizeof( struct Cyc_std_group));
...
0;} struct Cyc_std_group* Cyc_std_getgrgid( unsigned int gid){ struct Cyc_Cgrp_Cgroup*
...
0;} int Cyc_std_initgroups( struct _tagged_arr user, unsigned int group){ return
