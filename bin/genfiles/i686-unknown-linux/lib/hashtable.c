...
_tmp1E=0;Cyc_printf(({const char*_tmp1F="(";_tag_dynforward(_tmp1F,sizeof(char),
_get_zero_arr_size_char(_tmp1F,2));}),_tag_dynforward(_tmp1E,sizeof(void*),0));});
prn_key((((struct _tuple0*)iter->hd)[_check_known_subscript_notnull(1,0)]).f1);({
void*_tmp20=0;Cyc_printf(({const char*_tmp21=",";_tag_dynforward(_tmp21,sizeof(
char),_get_zero_arr_size_char(_tmp21,2));}),_tag_dynforward(_tmp20,sizeof(void*),
0));});prn_val((((struct _tuple0*)iter->hd)[_check_known_subscript_notnull(1,0)]).f2);({
void*_tmp22=0;Cyc_printf(({const char*_tmp23=") ";_tag_dynforward(_tmp23,sizeof(
char),_get_zero_arr_size_char(_tmp23,3));}),_tag_dynforward(_tmp22,sizeof(void*),
0));});}}({void*_tmp24=0;Cyc_printf(({const char*_tmp25="\n";_tag_dynforward(
_tmp25,sizeof(char),_get_zero_arr_size_char(_tmp25,2));}),_tag_dynforward(_tmp24,
sizeof(void*),0));});}}
