...
_check_dynforward_subscript(tab,sizeof(struct Cyc_List_List*),bucket));_tmp5;});
if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(*((struct Cyc_List_List**)
_check_dynforward_subscript(tab,sizeof(struct Cyc_List_List*),bucket)))> t->max_len)
Cyc_Hashtable_resize(t);}void*Cyc_Hashtable_lookup(struct Cyc_Hashtable_Table*t,
void*key){struct _dynforward_ptr tab=t->tab;struct Cyc_List_List*l=((struct Cyc_List_List**)
...
t,void*key){struct _dynforward_ptr _tmp7=t->tab;struct Cyc_List_List*_tmp8=((struct
Cyc_List_List**)_tmp7.curr)[(int)((*t->hash)(key)% _get_dynforward_size(_tmp7,
...
struct _dynforward_ptr _tmpF=t->tab;struct Cyc_List_List*_tmp10=((struct Cyc_List_List**)
_tmpF.curr)[(int)((*t->hash)(key)% _get_dynforward_size(_tmpF,sizeof(struct Cyc_List_List*)))];
...
_dynforward_ptr ndata=({unsigned int _tmp17=(unsigned int)nsize;struct Cyc_List_List**
