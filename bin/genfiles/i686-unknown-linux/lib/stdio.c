...
struct Cyc_Std___sFILE; extern struct Cyc_Std___sFILE* Cyc_Std_fromCfile( struct
Cyc_Cstdio___sFILE* cf); extern int Cyc_Std_remove( struct _tagged_arr); extern
...
unsigned int) cf?({ struct Cyc_Std___sFILE* _temp0=( struct Cyc_Std___sFILE*)
_cycalloc( sizeof( struct Cyc_Std___sFILE)); _temp0->file= cf; _temp0;}): 0;}
