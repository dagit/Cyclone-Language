...
struct Cyc_Core_Invalid_argument_struct*_tmp4C=_cycalloc(sizeof(*_tmp4C));_tmp4C[
0]=({struct Cyc_Core_Invalid_argument_struct _tmp4D;_tmp4D.tag=Cyc_Core_Invalid_argument;
