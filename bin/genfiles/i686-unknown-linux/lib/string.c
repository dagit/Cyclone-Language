...
Cyc_List_List*c);extern int Cyc_Std_strcasecmp(struct _tagged_arr,struct _tagged_arr);
extern int Cyc_Std_strncasecmp(struct _tagged_arr s1,struct _tagged_arr s2,
unsigned int len);extern void*Cyc_Std___assert_fail(struct _tagged_arr assertion,
