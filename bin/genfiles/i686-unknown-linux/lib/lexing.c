...
unsigned char* tag; struct _tagged_arr f1; } ; extern int Cyc_Std_file_string_read(
struct Cyc_Std___sFILE* fd, struct _tagged_arr dest, int dest_offset, int
...
unsigned int) len);(( unsigned char*) s.curr)[ len]='\000'; return s;}
