...
unsigned char*); struct Cyc_std_passwd{ struct _tagged_arr pw_name; struct
...
; extern struct Cyc_std_passwd* Cyc_std_getpwnam( struct _tagged_arr name);
extern struct Cyc_std_passwd* Cyc_std_getpwuid( unsigned int uid); struct Cyc_Cpwd_Cpasswd{
...
Cyc_std_passwd* _temp0=( struct Cyc_std_passwd*) GC_malloc( sizeof( struct Cyc_std_passwd));
