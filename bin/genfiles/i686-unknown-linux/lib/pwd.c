...
_tagged_arr pw_gecos;struct _tagged_arr pw_dir;struct _tagged_arr pw_shell;};extern
struct Cyc_Std_passwd*Cyc_Std_getpwnam(struct _tagged_arr name);extern struct Cyc_Std_passwd*
Cyc_Std_getpwuid(unsigned int uid);struct Cyc_Cpwd_Cpasswd{unsigned char*pw_name;
unsigned char*pw_passwd;unsigned int pw_uid;unsigned int pw_gid;unsigned char*
pw_gecos;unsigned char*pw_dir;unsigned char*pw_shell;};extern struct Cyc_Cpwd_Cpasswd*
getpwnam(unsigned char*name);extern struct Cyc_Cpwd_Cpasswd*getpwuid(unsigned int
uid);extern void free(void*);struct Cyc_Std_passwd*Cyc_Std_getpwnam(struct
_tagged_arr name){struct Cyc_Cpwd_Cpasswd*src=getpwnam(string_to_Cstring(name));
struct Cyc_Std_passwd*_tmp0=(unsigned int)src?({struct Cyc_Std_passwd*_tmp1=
...
Cyc_Std_getpwuid(unsigned int uid){struct Cyc_Cpwd_Cpasswd*src=getpwuid(uid);
