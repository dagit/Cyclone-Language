...
Cyc_Cpwd_Cpasswd* getpwuid( unsigned int uid); extern void free( void*); struct
Cyc_Std_passwd* Cyc_Std_getpwnam( struct _tagged_arr name){ struct Cyc_Cpwd_Cpasswd*
...
_temp0;} struct Cyc_Std_passwd* Cyc_Std_getpwuid( unsigned int uid){ struct Cyc_Cpwd_Cpasswd*
src= getpwuid( uid); struct Cyc_Std_passwd* _temp2=( unsigned int) src?({ struct
Cyc_Std_passwd* _temp3=( struct Cyc_Std_passwd*) _cycalloc( sizeof( struct Cyc_Std_passwd));
_temp3->pw_name=( struct _tagged_arr) Cstring_to_string( src->pw_name); _temp3->pw_passwd=(
struct _tagged_arr) Cstring_to_string( src->pw_passwd); _temp3->pw_uid= src->pw_uid;
_temp3->pw_gid= src->pw_gid; _temp3->pw_gecos=( struct _tagged_arr)
Cstring_to_string( src->pw_gecos); _temp3->pw_dir=( struct _tagged_arr)
Cstring_to_string( src->pw_dir); _temp3->pw_shell=( struct _tagged_arr)
Cstring_to_string( src->pw_shell); _temp3;}): 0; return _temp2;}
