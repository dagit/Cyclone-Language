...
struct _tagged_arr optval, unsigned int optlen); extern int listen( int fd, int
n); struct _tuple0{ int f1; void* f2; } ; extern struct _tuple0 Cyc_Socket_accept(
...
struct Cyc_Inet_sockaddr_in*, unsigned int); struct _tuple1{ struct Cyc_Inet_sockaddr_in*
f1; unsigned int f2; } ; struct _tuple1 Cyc_Csocket_sa2Csa( void* addr){ struct
Cyc_Inet_sockaddr_in* ptr= sockaddr_to_Csockaddr( addr); void* _temp0= addr;
struct Cyc_Inet_sockaddr_in _temp6; _LL2: if(*(( void**) _temp0) ==  Cyc_Inet_sockaddr_in){
_LL7: _temp6=(( struct Cyc_Inet_sockaddr_in_struct*) _temp0)->f1; goto _LL3;}
else{ goto _LL4;} _LL4: goto _LL5; _LL3: return({ struct _tuple1 _temp8; _temp8.f1=
ptr; _temp8.f2=( unsigned int) sizeof( struct Cyc_Inet_sockaddr_in); _temp8;});
...
34u); _temp10;}); _temp9;})); _LL1:;} void* Cyc_Csocket_Csa2sa( const struct Cyc_Inet_sockaddr_in*
addr, unsigned int len){ return Csockaddr_to_sockaddr( addr, len);} int Cyc_Socket_bind(
int fd, void* addr){ unsigned int _temp13; struct Cyc_Inet_sockaddr_in* _temp15;
...
const struct Cyc_Inet_sockaddr_in*) _temp15, _temp13);} int Cyc_Socket_connect(
int fd, void* addr){ unsigned int _temp19; struct Cyc_Inet_sockaddr_in* _temp21;
