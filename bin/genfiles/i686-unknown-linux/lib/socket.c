...
int Cyc_std_bind( int fd, void* addr); extern int Cyc_std_connect( int fd, void*
addr); extern int Cyc_std_setsockopt( int fd, int level, int optname, struct
_tagged_arr optval, unsigned int optlen); extern int listen( int fd, int n);
struct _tuple0{ int f1; void* f2; } ; extern struct _tuple0 Cyc_std_accept( int
fd); extern int shutdown( int fd, int how); struct Cyc_std_in_addr{ unsigned int
s_addr; } ; struct Cyc_std_sockaddr_in{ unsigned short sin_family;
unsigned short sin_port; struct Cyc_std_in_addr sin_addr; unsigned char sin_zero[
8u]; } ; extern unsigned char Cyc_std_sockaddr_in[ 16u]; struct Cyc_std_sockaddr_in_struct{
...
__errno_location(); extern int bind( int fd, const struct Cyc_std_sockaddr_in*
addr, unsigned int len); extern int connect( int fd, const struct Cyc_std_sockaddr_in*
addr, unsigned int len); extern int accept( int fd, struct Cyc_std_sockaddr_in*
addr, unsigned int* len); extern struct Cyc_std_sockaddr_in*
