...
#endif
 struct Cyc_Std_timeval{ int tv_sec; int tv_usec; } ; struct Cyc_Std_sockaddr_in;
static const int Cyc_Std_SA_sockaddr_in= 0; struct Cyc_Std_SA_sockaddr_in_struct{
int tag; struct Cyc_Std_sockaddr_in* f1; } ; static const int Cyc_Std_SA_socklenptr=
1; struct Cyc_Std_SA_socklenptr_struct{ int tag; unsigned int* f1; } ; static
const int Cyc_Std_SA_socklen= 2; struct Cyc_Std_SA_socklen_struct{ int tag;
