...
struct _tuple0*)l->hd)).f1;unsigned int _tmp1=Cyc_strlen((struct _tagged_arr)_tmp0);
if(_tmp1 > 0  && (*((struct _tuple0*)l->hd)).f2){if(Cyc_strncmp((struct _tagged_arr)
x,(struct _tagged_arr)(*((struct _tuple0*)l->hd)).f1,_tmp1)== 0)return(*((struct
_tuple0*)l->hd)).f4;}else{if(Cyc_strcmp((struct _tagged_arr)x,(struct _tagged_arr)(*((
...
howmuch < 0)howmuch=0;{unsigned int _tmp2=Cyc_strlen((struct _tagged_arr)s);_tmp2 <= 
_get_arr_size(s,sizeof(char))?0:((int(*)(struct _tagged_arr assertion,struct
_tagged_arr file,unsigned int line))Cyc___assert_fail)(({const char*_tmp3="len <= s.size";
...
i;for(i=howmuch - 1;i >= 0  && !isspace((int)*((const char*)_check_unknown_subscript(
s,sizeof(char),i)));i --){;}if(i < 0)for(i=howmuch?howmuch - 1: 0;(i < _tmp2  && (int)((
const char*)s.curr)[i]) && !isspace((int)((const char*)s.curr)[i]);i ++){;}Cyc_Buffer_add_substring(
b,s,0,i);{struct _tagged_arr whatsleft=(struct _tagged_arr)_tag_arr(0,0,0);for(0;(i
< _tmp2  && (int)((const char*)s.curr)[i]) && isspace((int)((const char*)s.curr)[i]);
i ++){;}if(i < _tmp2  && (int)((const char*)s.curr)[i])whatsleft=_tagged_arr_plus(s,
...
_tmp9,sizeof(char))== 1  && (_tmpA == '\000'  && _tmpB != '\000'))_throw_arraybounds();*((
...
struct _tagged_arr)(*((struct _tuple0*)speclist->hd)).f1,(struct _tagged_arr)(*((
struct _tuple0*)speclist->hd)).f3),(*((struct _tuple0*)speclist->hd)).f5);speclist=
speclist->tl;}({struct Cyc_String_pa_struct _tmp1B;_tmp1B.tag=0;_tmp1B.f1=(struct
_tagged_arr)((struct _tagged_arr)Cyc_Buffer_contents(_tmp18));{void*_tmp19[1]={&
_tmp1B};Cyc_fprintf(Cyc_stderr,({const char*_tmp1A="%s";_tag_arr(_tmp1A,sizeof(
char),_get_zero_arr_size(_tmp1A,3));}),_tag_arr(_tmp19,sizeof(void*),1));}});}}
...
_tmp27;_tmp27.tag=0;_tmp27.f1=(struct _tagged_arr)((struct _tagged_arr)_tmp1D);{
struct Cyc_String_pa_struct _tmp26;_tmp26.tag=0;_tmp26.f1=(struct _tagged_arr)((
struct _tagged_arr)progname);{void*_tmp24[2]={& _tmp26,& _tmp27};Cyc_fprintf(Cyc_stderr,({
const char*_tmp25="%s: unknown option `%s'.\n";_tag_arr(_tmp25,sizeof(char),
_get_zero_arr_size(_tmp25,26));}),_tag_arr(_tmp24,sizeof(void*),2));}}});goto
_LL0;_LL3: if(*((int*)_tmp1C)!= 1)goto _LL5;_tmp1E=((struct Cyc_Arg_Missing_struct*)
_tmp1C)->f1;_LL4:({struct Cyc_String_pa_struct _tmp2B;_tmp2B.tag=0;_tmp2B.f1=(
struct _tagged_arr)((struct _tagged_arr)_tmp1E);{struct Cyc_String_pa_struct _tmp2A;
_tmp2A.tag=0;_tmp2A.f1=(struct _tagged_arr)((struct _tagged_arr)progname);{void*
_tmp28[2]={& _tmp2A,& _tmp2B};Cyc_fprintf(Cyc_stderr,({const char*_tmp29="%s: option `%s' needs an argument.\n";
...
_tmp31;_tmp31.tag=0;_tmp31.f1=(struct _tagged_arr)((struct _tagged_arr)_tmp21);{
struct Cyc_String_pa_struct _tmp30;_tmp30.tag=0;_tmp30.f1=(struct _tagged_arr)((
struct _tagged_arr)_tmp1F);{struct Cyc_String_pa_struct _tmp2F;_tmp2F.tag=0;_tmp2F.f1=(
struct _tagged_arr)((struct _tagged_arr)_tmp20);{struct Cyc_String_pa_struct _tmp2E;
_tmp2E.tag=0;_tmp2E.f1=(struct _tagged_arr)((struct _tagged_arr)progname);{void*
_tmp2C[4]={& _tmp2E,& _tmp2F,& _tmp30,& _tmp31};Cyc_fprintf(Cyc_stderr,({const char*
...
struct _tagged_arr)((struct _tagged_arr)_tmp22);{struct Cyc_String_pa_struct _tmp34;
_tmp34.tag=0;_tmp34.f1=(struct _tagged_arr)((struct _tagged_arr)progname);{void*
_tmp32[2]={& _tmp34,& _tmp35};Cyc_fprintf(Cyc_stderr,({const char*_tmp33="%s: %s.\n";
_tag_arr(_tmp33,sizeof(char),_get_zero_arr_size(_tmp33,9));}),_tag_arr(_tmp32,
...
unsigned int l=_get_arr_size(Cyc_Arg_args,sizeof(struct _tagged_arr));if((*((
struct _tagged_arr*)_check_unknown_subscript(Cyc_Arg_args,sizeof(struct
_tagged_arr),(int)(l - 1)))).curr == ((struct _tagged_arr)_tag_arr(0,0,0)).curr)l=l
- 1;++ Cyc_Arg_current;while(Cyc_Arg_current < l){struct _tagged_arr s=*((struct
_tagged_arr*)_check_unknown_subscript(Cyc_Arg_args,sizeof(struct _tagged_arr),Cyc_Arg_current));
if((s.curr != ((struct _tagged_arr)_tag_arr(0,0,0)).curr  && _get_arr_size(s,
sizeof(char))>= 1) && *((const char*)_check_unknown_subscript(s,sizeof(char),0))
