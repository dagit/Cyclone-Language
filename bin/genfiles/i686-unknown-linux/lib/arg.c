...
0; i ++){;} if( i <  _temp2?( int)*(( const unsigned char*)
_check_unknown_subscript( s, sizeof( unsigned char), i)): 0){ whatsleft=
...
1u));}});{ struct Cyc_Buffer_t* _temp14= Cyc_Buffer_create( 1024); while(
speclist !=  0) { Cyc_Arg_Justify_justify_b( _temp14, 12, 72,( struct
_tagged_arr) Cyc_String_strconcat((*(( struct _tuple0*)(( struct Cyc_List_List*)
_check_null( speclist))->hd)).f1,(*(( struct _tuple0*)(( struct Cyc_List_List*)
_check_null( speclist))->hd)).f3),(*(( struct _tuple0*)(( struct Cyc_List_List*)
_check_null( speclist))->hd)).f5); speclist=(( struct Cyc_List_List*)
_check_null( speclist))->tl;}({ struct Cyc_Stdio_String_pa_struct _temp16;
_temp16.tag= Cyc_Stdio_String_pa; _temp16.f1=( struct _tagged_arr) Cyc_Buffer_contents(
_temp14);{ void* _temp15[ 1u]={& _temp16}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr,
...
goto _LL26;} else{ goto _LL18;} _LL20: if( Cyc_String_strcmp( _temp27, _tag_arr("-help",
sizeof( unsigned char), 6u)) !=  0){({ struct Cyc_Stdio_String_pa_struct _temp41;
_temp41.tag= Cyc_Stdio_String_pa; _temp41.f1=( struct _tagged_arr) _temp27;{
struct Cyc_Stdio_String_pa_struct _temp40; _temp40.tag= Cyc_Stdio_String_pa;
_temp40.f1=( struct _tagged_arr) progname;{ void* _temp39[ 2u]={& _temp40,&
_temp41}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr, _tag_arr("%s: unknown option `%s'.\n",
sizeof( unsigned char), 26u), _tag_arr( _temp39, sizeof( void*), 2u));}}});}
goto _LL18; _LL22:({ struct Cyc_Stdio_String_pa_struct _temp44; _temp44.tag= Cyc_Stdio_String_pa;
_temp44.f1=( struct _tagged_arr) _temp29;{ struct Cyc_Stdio_String_pa_struct
_temp43; _temp43.tag= Cyc_Stdio_String_pa; _temp43.f1=( struct _tagged_arr)
progname;{ void* _temp42[ 2u]={& _temp43,& _temp44}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr,
_tag_arr("%s: option `%s' needs an argument.\n", sizeof( unsigned char), 36u),
_tag_arr( _temp42, sizeof( void*), 2u));}}}); goto _LL18; _LL24:({ struct Cyc_Stdio_String_pa_struct
_temp49; _temp49.tag= Cyc_Stdio_String_pa; _temp49.f1=( struct _tagged_arr)
_temp31;{ struct Cyc_Stdio_String_pa_struct _temp48; _temp48.tag= Cyc_Stdio_String_pa;
_temp48.f1=( struct _tagged_arr) _temp35;{ struct Cyc_Stdio_String_pa_struct
_temp47; _temp47.tag= Cyc_Stdio_String_pa; _temp47.f1=( struct _tagged_arr)
_temp33;{ struct Cyc_Stdio_String_pa_struct _temp46; _temp46.tag= Cyc_Stdio_String_pa;
_temp46.f1=( struct _tagged_arr) progname;{ void* _temp45[ 4u]={& _temp46,&
_temp47,& _temp48,& _temp49}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr, _tag_arr("%s: wrong argument `%s'; option `%s' expects %s.\n",
sizeof( unsigned char), 50u), _tag_arr( _temp45, sizeof( void*), 4u));}}}}});
goto _LL18; _LL26:({ struct Cyc_Stdio_String_pa_struct _temp52; _temp52.tag= Cyc_Stdio_String_pa;
_temp52.f1=( struct _tagged_arr) _temp37;{ struct Cyc_Stdio_String_pa_struct
_temp51; _temp51.tag= Cyc_Stdio_String_pa; _temp51.f1=( struct _tagged_arr)
progname;{ void* _temp50[ 2u]={& _temp51,& _temp52}; Cyc_Stdio_fprintf( Cyc_Stdio_stderr,
