...
unsigned int);extern void*Cyc_Core_identity(void*);extern int Cyc_Core_intcmp(int,
...
Cyc_List_length(struct Cyc_List_List*x);extern unsigned char Cyc_List_List_mismatch[
...
struct _tagged_arr*p);static const int Cyc_Fn_Fun=0;struct Cyc_Fn_Fun_struct{int tag;
void*(*f1)(void*,void*);void*f2;};extern void*Cyc_Fn_make_fn(void*(*f)(void*,void*),
void*x);extern void*Cyc_Fn_fp2fn(void*(*f)(void*));extern void*Cyc_Fn_apply(void*f,
void*x);struct Cyc_PP_Ppstate;struct Cyc_PP_Out;struct Cyc_PP_Doc;extern void Cyc_PP_file_of_doc(
struct Cyc_PP_Doc*d,int w,struct Cyc_Std___sFILE*f);extern struct _tagged_arr Cyc_PP_string_of_doc(
