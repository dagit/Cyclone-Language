...
0;x=x->tl){struct Cyc_List_List*temp=({struct Cyc_List_List*_tmp9=_region_malloc(
r2,sizeof(*_tmp9));_tmp9->hd=(void*)((void*)x->hd);_tmp9->tl=0;_tmp9;});prev->tl=(
struct Cyc_List_List*)temp;prev=temp;}return(struct Cyc_List_List*)result;}struct
Cyc_List_List*Cyc_List_copy(struct Cyc_List_List*x){return Cyc_List_rcopy(Cyc_Core_heap_region,
x);}struct Cyc_List_List*Cyc_List_rmap(struct _RegionHandle*r2,void*(*f)(void*),
struct Cyc_List_List*x){struct Cyc_List_List*result;struct Cyc_List_List*prev;if(x
== 0)return 0;result=({struct Cyc_List_List*_tmpA=_region_malloc(r2,sizeof(*_tmpA));
_tmpA->hd=(void*)f((void*)x->hd);_tmpA->tl=0;_tmpA;});prev=result;for(x=x->tl;x
!= 0;x=x->tl){struct Cyc_List_List*temp=({struct Cyc_List_List*_tmpB=
_region_malloc(r2,sizeof(*_tmpB));_tmpB->hd=(void*)f((void*)x->hd);_tmpB->tl=0;
_tmpB;});prev->tl=(struct Cyc_List_List*)temp;prev=temp;}return(struct Cyc_List_List*)
...
struct Cyc_List_List*e=({struct Cyc_List_List*_tmpD=_region_malloc(r2,sizeof(*
_tmpD));_tmpD->hd=(void*)f(env,(void*)x->hd);_tmpD->tl=0;_tmpD;});prev->tl=(
struct Cyc_List_List*)e;prev=e;}return(struct Cyc_List_List*)result;}struct Cyc_List_List*
Cyc_List_map_c(void*(*f)(void*,void*),void*env,struct Cyc_List_List*x){return Cyc_List_rmap_c(
Cyc_Core_heap_region,f,env,x);}char Cyc_List_List_mismatch[18]="\000\000\000\000List_mismatch\000";
...
Cyc_List_List*prev;if(x == 0?y == 0: 0)return 0;if(x == 0?1: y == 0)(int)_throw((void*)
Cyc_List_List_mismatch);result=({struct Cyc_List_List*_tmpE=_region_malloc(r3,
sizeof(*_tmpE));_tmpE->hd=(void*)f((void*)x->hd,(void*)y->hd);_tmpE->tl=0;_tmpE;});
prev=result;x=x->tl;y=y->tl;while(x != 0?y != 0: 0){struct Cyc_List_List*temp=({
struct Cyc_List_List*_tmpF=_region_malloc(r3,sizeof(*_tmpF));_tmpF->hd=(void*)f((
void*)x->hd,(void*)y->hd);_tmpF->tl=0;_tmpF;});prev->tl=(struct Cyc_List_List*)
temp;prev=temp;x=x->tl;y=y->tl;}if(x != 0?1: y != 0)(int)_throw((void*)Cyc_List_List_mismatch);
return(struct Cyc_List_List*)result;}struct Cyc_List_List*Cyc_List_map2(void*(*f)(
void*,void*),struct Cyc_List_List*x,struct Cyc_List_List*y){return Cyc_List_rmap2(
Cyc_Core_heap_region,f,x,y);}void Cyc_List_app(void*(*f)(void*),struct Cyc_List_List*
...
void Cyc_List_iter(void(*f)(void*),struct Cyc_List_List*x){while(x != 0){f((void*)x->hd);
x=x->tl;}}void Cyc_List_iter_c(void(*f)(void*,void*),void*env,struct Cyc_List_List*
x){while(x != 0){f(env,(void*)x->hd);x=x->tl;}}void Cyc_List_app2(void*(*f)(void*,
...
y=y->tl;}if(x != 0?1: y != 0)(int)_throw((void*)Cyc_List_List_mismatch);}void Cyc_List_iter2(
void(*f)(void*,void*),struct Cyc_List_List*x,struct Cyc_List_List*y){while(x != 0?y
!= 0: 0){f((void*)x->hd,(void*)y->hd);x=x->tl;y=y->tl;}if(x != 0?1: y != 0)(int)
...
void*)Cyc_List_List_mismatch);}void*Cyc_List_fold_left(void*(*f)(void*,void*),
void*accum,struct Cyc_List_List*x){while(x != 0){accum=f(accum,(void*)x->hd);x=x->tl;}
...
y=({struct Cyc_List_List*_tmp10=_region_malloc(r2,sizeof(*_tmp10));_tmp10->hd=(
void*)((void*)x->hd);_tmp10->tl=y;_tmp10;});x=x->tl;}return y;}struct Cyc_List_List*
...
x);}struct Cyc_List_List*Cyc_List_imp_rev(struct Cyc_List_List*x){if(x == 0)return x;
else{struct Cyc_List_List*first=x;struct Cyc_List_List*second=x->tl;x->tl=0;while(
second != 0){struct Cyc_List_List*temp=second->tl;second->tl=first;first=second;
second=temp;}return first;}}struct Cyc_List_List*Cyc_List_rappend(struct
...
r2,x);result=({struct Cyc_List_List*_tmp11=_region_malloc(r2,sizeof(*_tmp11));
_tmp11->hd=(void*)((void*)x->hd);_tmp11->tl=0;_tmp11;});prev=result;for(x=x->tl;
x != 0;x=x->tl){struct Cyc_List_List*temp=({struct Cyc_List_List*_tmp12=
_region_malloc(r2,sizeof(*_tmp12));_tmp12->hd=(void*)((void*)x->hd);_tmp12->tl=0;
_tmp12;});prev->tl=(struct Cyc_List_List*)temp;prev=temp;}prev->tl=y;return(
...
struct Cyc_List_List*x){return((struct Cyc_List_List*(*)(struct Cyc_List_List*(*f)(
struct _RegionHandle*,struct Cyc_List_List*,struct Cyc_List_List*),struct
...
_tmp14->tl=0;_tmp14;});b=b->tl;}d=c;while(a != 0?b != 0: 0){struct Cyc_List_List*
...
result;struct Cyc_List_List*prev;struct Cyc_List_List*temp;if(x == 0?y == 0: 0)return
0;if(x == 0?1: y == 0)(int)_throw((void*)Cyc_List_List_mismatch);result=({struct Cyc_List_List*
_tmp17=_region_malloc(r3,sizeof(*_tmp17));_tmp17->hd=({struct _tuple2*_tmp18=
...
temp=({struct Cyc_List_List*_tmp19=_region_malloc(r3,sizeof(*_tmp19));_tmp19->hd=({
struct _tuple2*_tmp1A=_region_malloc(r4,sizeof(*_tmp1A));_tmp1A->f1=(void*)x->hd;
_tmp1A->f2=(void*)y->hd;_tmp1A;});_tmp19->tl=0;_tmp19;});prev->tl=(struct Cyc_List_List*)
temp;prev=temp;x=x->tl;y=y->tl;}if(x != 0?1: y != 0)(int)_throw((void*)Cyc_List_List_mismatch);
...
struct Cyc_List_List*temp;if((x == 0?y == 0: 0)?z == 0: 0)return 0;if((x == 0?1: y == 0)?1:
...
z=z->tl;while((x != 0?y != 0: 0)?z != 0: 0){temp=({struct Cyc_List_List*_tmp1D=
...
temp;prev=temp;x=x->tl;y=y->tl;z=z->tl;}if((x != 0?1: y != 0)?1: z != 0)(int)_throw((
...
l,void*x){if(l == 0)(int)_throw((void*)Cyc_Core_Not_found);{struct Cyc_List_List*
prev=(struct Cyc_List_List*)l;struct Cyc_List_List*_tmp2D=l;while(_tmp2D != 0){if((
void*)_tmp2D->hd == x){if((struct Cyc_List_List*)prev == l)return l->tl;else{prev->tl=
_tmp2D->tl;return l;}}prev=(struct Cyc_List_List*)_tmp2D;_tmp2D=_tmp2D->tl;}(int)
_throw((void*)Cyc_Core_Not_found);}}int Cyc_List_mem_assoc(struct Cyc_List_List*l,
void*x){while(l != 0){if((((struct _tuple2*)l->hd)[_check_known_subscript_notnull(
1,0)]).f1 == x)return 1;l=l->tl;}return 0;}struct Cyc_Core_Opt*Cyc_List_check_unique(
int(*cmp)(void*,void*),struct Cyc_List_List*x){while(x != 0){struct Cyc_List_List*
_tmp2E=x->tl;if(_tmp2E != 0){if(cmp((void*)x->hd,(void*)_tmp2E->hd)== 0)return({
struct Cyc_Core_Opt*_tmp2F=_cycalloc(sizeof(*_tmp2F));_tmp2F->v=(void*)((void*)x->hd);
_tmp2F;});}x=_tmp2E;}return 0;}struct _tagged_arr Cyc_List_rto_array(struct
_RegionHandle*r2,struct Cyc_List_List*x){int s;struct _tagged_arr arr;s=Cyc_List_length(
x);arr=({unsigned int _tmp30=(unsigned int)s;void**_tmp31=(void**)_region_malloc(
r2,_check_times(sizeof(void*),_tmp30));struct _tagged_arr _tmp34=_tag_arr(_tmp31,
sizeof(void*),_tmp30);{unsigned int _tmp32=_tmp30;unsigned int i;for(i=0;i < _tmp32;
i ++){_tmp31[i]=({void*_tmp33=(void*)((struct Cyc_List_List*)_check_null(x))->hd;x=
x->tl;_tmp33;});}}_tmp34;});return arr;}struct _tagged_arr Cyc_List_to_array(struct
Cyc_List_List*x){return Cyc_List_rto_array(Cyc_Core_heap_region,x);}struct Cyc_List_List*
Cyc_List_rfrom_array(struct _RegionHandle*r2,struct _tagged_arr arr){struct Cyc_List_List*
ans=0;{int i=(int)(_get_arr_size(arr,sizeof(void*))- 1);for(0;i >= 0;-- i){ans=({
struct Cyc_List_List*_tmp35=_region_malloc(r2,sizeof(*_tmp35));_tmp35->hd=(void*)*((
void**)_check_unknown_subscript(arr,sizeof(void*),i));_tmp35->tl=ans;_tmp35;});}}
return ans;}struct Cyc_List_List*Cyc_List_from_array(struct _tagged_arr arr){return
Cyc_List_rfrom_array(Cyc_Core_heap_region,arr);}struct Cyc_List_List*Cyc_List_rtabulate(
struct _RegionHandle*r,int n,void*(*f)(int)){struct Cyc_List_List*res=0;{int i=0;
for(0;i < n;++ i){res=({struct Cyc_List_List*_tmp36=_region_malloc(r,sizeof(*_tmp36));
_tmp36->hd=(void*)f(i);_tmp36->tl=res;_tmp36;});}}return Cyc_List_imp_rev(res);}
...
int i=0;for(0;i < n;++ i){res=({struct Cyc_List_List*_tmp37=_region_malloc(r,sizeof(*
_tmp37));_tmp37->hd=(void*)f(env,i);_tmp37->tl=res;_tmp37;});}}return Cyc_List_imp_rev(
...
0?l2 != 0: 0;(l1=l1->tl,l2=l2->tl)){if((unsigned int)l1 == (unsigned int)l2)return 0;{
int _tmp38=cmp((void*)l1->hd,(void*)l2->hd);if(_tmp38 != 0)return _tmp38;}}if(l1 != 
0)return 1;if(l2 != 0)return - 1;return 0;}int Cyc_List_list_prefix(int(*cmp)(void*,
void*),struct Cyc_List_List*l1,struct Cyc_List_List*l2){for(0;l1 != 0?l2 != 0: 0;(l1=
l1->tl,l2=l2->tl)){if((unsigned int)l1 == (unsigned int)l2)return 1;{int _tmp39=cmp((
void*)l1->hd,(void*)l2->hd);if(_tmp39 != 0)return 0;}}return l1 == 0;}struct Cyc_List_List*
Cyc_List_rfilter_c(struct _RegionHandle*r,int(*f)(void*,void*),void*env,struct Cyc_List_List*
l){if(l == 0)return 0;{struct Cyc_List_List*result=({struct Cyc_List_List*_tmp3B=
_region_malloc(r,sizeof(*_tmp3B));_tmp3B->hd=(void*)((void*)l->hd);_tmp3B->tl=0;
_tmp3B;});struct Cyc_List_List*end=result;struct Cyc_List_List*temp;for(0;l != 0;l=
l->tl){if(f(env,(void*)l->hd)){temp=({struct Cyc_List_List*_tmp3A=_region_malloc(
r,sizeof(*_tmp3A));_tmp3A->hd=(void*)((void*)l->hd);_tmp3A->tl=0;_tmp3A;});end->tl=(
