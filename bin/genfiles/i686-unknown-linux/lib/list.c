...
struct Cyc_List_List*Cyc_List_rlist(struct _RegionHandle*,struct _tagged_arr);int
Cyc_List_length(struct Cyc_List_List*x);void*Cyc_List_hd(struct Cyc_List_List*x);
