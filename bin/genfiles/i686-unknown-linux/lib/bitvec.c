...
void*env,void*dest);};int Cyc_Iter_next(struct Cyc_Iter_Iter,void*);typedef struct{
...
_dyneither_ptr bvec,int sz);void Cyc_Bitvec_print_bvec(struct _dyneither_ptr bvec);
int Cyc_Bitvec_get(struct _dyneither_ptr,int);void Cyc_Bitvec_set(struct
