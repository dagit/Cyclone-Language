...
Cyc_Dict_Present[12];extern unsigned char Cyc_Dict_Absent[11];extern void*Cyc_Dict_lookup(
struct Cyc_Dict_Dict*d,void*k);extern struct _tagged_arr Cyc_Bitvec_new_empty(int);
extern struct _tagged_arr Cyc_Bitvec_new_full(int);extern struct _tagged_arr Cyc_Bitvec_new_copy(
...
void*_tmpE[1]={& _tmpF};Cyc_Std_printf(_tag_arr("%d",sizeof(unsigned char),3),
_tag_arr(_tmpE,sizeof(void*),1));}});}}({void*_tmp10[0]={};Cyc_Std_printf(
