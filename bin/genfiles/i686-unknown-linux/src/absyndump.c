...
const char*_tmp2D=",";_tag_dyneither(_tmp2D,sizeof(char),2);}));}struct _tuple13{
struct Cyc_Absyn_Tqual f1;void*f2;};void Cyc_Absyndump_dumparg(struct _tuple13*pr){((
...
struct Cyc_List_List*ts){((void(*)(void(*f)(struct _tuple13*),struct Cyc_List_List*
...
t);goto _LL56;_LL56:;}struct _tuple14{struct Cyc_List_List*f1;struct Cyc_List_List*
...
struct _tuple14 _tmp4F=Cyc_Absyndump_effects_split((void*)_tmp4D->hd);_tmp50=
...
struct _tuple14 _tmp53;_tmp53.f1=rgions;_tmp53.f2=effects;_tmp53;});}static void Cyc_Absyndump_dumpeff(
void*t){struct Cyc_List_List*_tmp55;struct Cyc_List_List*_tmp56;struct _tuple14
...
_tuple15*cmp){struct _tuple15 _tmp100;void*_tmp101;void*_tmp102;struct _tuple15*
_tmpFF=cmp;_tmp100=*_tmpFF;_tmp101=_tmp100.f1;_tmp102=_tmp100.f2;Cyc_Absyndump_dumpeff(
_tmp101);Cyc_Absyndump_dump_char((int)'>');Cyc_Absyndump_dumprgn(_tmp102);}void
Cyc_Absyndump_dump_rgnpo(struct Cyc_List_List*rgn_po){((void(*)(void(*f)(struct
_tuple15*),struct Cyc_List_List*l,struct _dyneither_ptr sep))Cyc_Absyndump_dump_sep)(
Cyc_Absyndump_dump_rgncmp,rgn_po,({const char*_tmp103=",";_tag_dyneither(_tmp103,
sizeof(char),2);}));}void Cyc_Absyndump_dumpfunargs(struct Cyc_List_List*args,int
c_varargs,struct Cyc_Absyn_VarargInfo*cyc_varargs,struct Cyc_Core_Opt*effopt,
struct Cyc_List_List*rgn_po){Cyc_Absyndump_dump_char((int)'(');for(0;args != 0;
args=args->tl){Cyc_Absyndump_dumpfunarg((struct _tuple7*)args->hd);if((args->tl != 
0  || c_varargs) || cyc_varargs != 0)Cyc_Absyndump_dump_char((int)',');}if(
c_varargs)Cyc_Absyndump_dump(({const char*_tmp104="...";_tag_dyneither(_tmp104,
sizeof(char),4);}));else{if(cyc_varargs != 0){struct _tuple7*_tmp105=({struct
_tuple7*_tmp108=_cycalloc(sizeof(*_tmp108));_tmp108->f1=cyc_varargs->name;
_tmp108->f2=cyc_varargs->tq;_tmp108->f3=cyc_varargs->type;_tmp108;});Cyc_Absyndump_dump(({
const char*_tmp106="...";_tag_dyneither(_tmp106,sizeof(char),4);}));if(
cyc_varargs->inject)Cyc_Absyndump_dump(({const char*_tmp107=" inject ";
_tag_dyneither(_tmp107,sizeof(char),9);}));Cyc_Absyndump_dumpfunarg(_tmp105);}}
...
unsigned int _tmp188;struct Cyc_Absyn_Exp*_tmp18A;struct Cyc_Absyn_Exp*_tmp18C;
struct _dyneither_ptr*_tmp18D;struct Cyc_Absyn_Exp*_tmp18F;struct _dyneither_ptr*
_tmp190;struct Cyc_Absyn_Exp*_tmp192;struct Cyc_Absyn_Exp*_tmp193;struct Cyc_List_List*
_tmp195;struct _tuple7*_tmp197;struct Cyc_List_List*_tmp198;struct Cyc_List_List*
_tmp19A;struct Cyc_Absyn_Vardecl*_tmp19C;struct Cyc_Absyn_Exp*_tmp19D;struct Cyc_Absyn_Exp*
_tmp19E;struct _tuple0*_tmp1A0;struct Cyc_List_List*_tmp1A1;struct Cyc_List_List*
_tmp1A2;struct Cyc_List_List*_tmp1A4;struct Cyc_List_List*_tmp1A6;struct Cyc_Absyn_Datatypefield*
_tmp1A7;struct _tuple0*_tmp1A9;struct _tuple0*_tmp1AB;struct Cyc_Absyn_MallocInfo
_tmp1AD;int _tmp1AE;struct Cyc_Absyn_Exp*_tmp1AF;void**_tmp1B0;struct Cyc_Absyn_Exp*
_tmp1B1;struct Cyc_Absyn_Exp*_tmp1B3;struct Cyc_Absyn_Exp*_tmp1B4;struct Cyc_Core_Opt*
_tmp1B6;struct Cyc_List_List*_tmp1B7;struct Cyc_Absyn_Stmt*_tmp1B9;_LLCB: {struct
...
_tmp1BC;_tmp1BC.tag=1;_tmp1BC.f1=(unsigned long)((int)_tmp120);({void*_tmp1BA[1]={&
_tmp1BC};Cyc_aprintf(({const char*_tmp1BB="%d";_tag_dyneither(_tmp1BB,sizeof(char),
3);}),_tag_dyneither(_tmp1BA,sizeof(void*),1));});}));goto _LLCA;_LLCF: {struct
...
struct _dyneither_ptr)({struct Cyc_Int_pa_struct _tmp1BF;_tmp1BF.tag=1;_tmp1BF.f1=(
unsigned long)_tmp12A;({void*_tmp1BD[1]={& _tmp1BF};Cyc_aprintf(({const char*
_tmp1BE="%d";_tag_dyneither(_tmp1BE,sizeof(char),3);}),_tag_dyneither(_tmp1BD,
...
struct Cyc_Int_pa_struct _tmp1C2;_tmp1C2.tag=1;_tmp1C2.f1=(unsigned int)_tmp12F;({
void*_tmp1C0[1]={& _tmp1C2};Cyc_aprintf(({const char*_tmp1C1="%u";_tag_dyneither(
_tmp1C1,sizeof(char),3);}),_tag_dyneither(_tmp1C0,sizeof(void*),1));});}));goto
...
_tmp134=_tmp132.f2;}}_LLD6: Cyc_Absyndump_dump(({const char*_tmp1C3="<<FIX LONG LONG CONSTANT>>";
_tag_dyneither(_tmp1C3,sizeof(char),27);}));goto _LLCA;_LLD7: {struct Cyc_Absyn_Const_e_struct*
...
const char*_tmp1C4="NULL";_tag_dyneither(_tmp1C4,sizeof(char),5);}));goto _LLCA;
...
enum Cyc_Absyn_Primop)Cyc_Absyn_Numelts){Cyc_Absyndump_dump(({const char*_tmp1C6="numelts(";
_tag_dyneither(_tmp1C6,sizeof(char),9);}));Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)((
struct Cyc_List_List*)_check_null(_tmp144))->hd);Cyc_Absyndump_dump(({const char*
_tmp1C7=")";_tag_dyneither(_tmp1C7,sizeof(char),2);}));}else{Cyc_Absyndump_dump(
_tmp1C5);Cyc_Absyndump_dumpexp_prec(myprec,(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)
_check_null(_tmp144))->hd);}break;case 2: _LL134: Cyc_Absyndump_dumpexp_prec(myprec,(
struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp144))->hd);Cyc_Absyndump_dump(
_tmp1C5);Cyc_Absyndump_dump_char((int)' ');Cyc_Absyndump_dumpexp_prec(myprec,(
struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp144->tl))->hd);
break;default: _LL135:(int)_throw((void*)({struct Cyc_Core_Failure_struct*_tmp1C8=
_cycalloc(sizeof(*_tmp1C8));_tmp1C8[0]=({struct Cyc_Core_Failure_struct _tmp1C9;
_tmp1C9.tag=Cyc_Core_Failure;_tmp1C9.f1=({const char*_tmp1CA="Absyndump -- Bad number of arguments to primop";
_tag_dyneither(_tmp1CA,sizeof(char),47);});_tmp1C9;});_tmp1C8;}));}goto _LLCA;}
...
_tmp147->v));Cyc_Absyndump_dump_nospace(({const char*_tmp1CB="=";_tag_dyneither(
_tmp1CB,sizeof(char),2);}));Cyc_Absyndump_dumpexp_prec(myprec,_tmp148);goto _LLCA;
...
_tmp1CC="++";_tag_dyneither(_tmp1CC,sizeof(char),3);}));Cyc_Absyndump_dumpexp_prec(
...
_LLE8: Cyc_Absyndump_dump(({const char*_tmp1CD="--";_tag_dyneither(_tmp1CD,sizeof(
...
myprec,_tmp150);Cyc_Absyndump_dump(({const char*_tmp1CE="++";_tag_dyneither(
_tmp1CE,sizeof(char),3);}));goto _LLCA;_LLEB: {struct Cyc_Absyn_Increment_e_struct*
...
const char*_tmp1CF="--";_tag_dyneither(_tmp1CF,sizeof(char),3);}));goto _LLCA;
...
myprec,_tmp15A);Cyc_Absyndump_dump(({const char*_tmp1D0=" && ";_tag_dyneither(
_tmp1D0,sizeof(char),5);}));Cyc_Absyndump_dumpexp_prec(myprec,_tmp15B);goto _LLCA;
...
_tmp1D1=" || ";_tag_dyneither(_tmp1D1,sizeof(char),5);}));Cyc_Absyndump_dumpexp_prec(
...
myprec,_tmp166);Cyc_Absyndump_dump_nospace(({const char*_tmp1D2="(";
_tag_dyneither(_tmp1D2,sizeof(char),2);}));Cyc_Absyndump_dumpexps_prec(20,
_tmp167);Cyc_Absyndump_dump_nospace(({const char*_tmp1D3=")";_tag_dyneither(
_tmp1D3,sizeof(char),2);}));goto _LLCA;_LLF9: {struct Cyc_Absyn_Throw_e_struct*
_tmp168=(struct Cyc_Absyn_Throw_e_struct*)_tmp116;if(_tmp168->tag != 12)goto _LLFB;
else{_tmp169=_tmp168->f1;}}_LLFA: Cyc_Absyndump_dump(({const char*_tmp1D4="throw";
_tag_dyneither(_tmp1D4,sizeof(char),6);}));Cyc_Absyndump_dumpexp_prec(myprec,
...
char*_tmp1D5="new ";_tag_dyneither(_tmp1D5,sizeof(char),5);}));Cyc_Absyndump_dumpexp_prec(
...
else{_tmp177=(void*)_tmp176->f1;}}_LL106: Cyc_Absyndump_dump(({const char*_tmp1D6="sizeof(";
_tag_dyneither(_tmp1D6,sizeof(char),8);}));Cyc_Absyndump_dumptyp(_tmp177);Cyc_Absyndump_dump_char((
...
_tmp179=_tmp178->f1;}}_LL108: Cyc_Absyndump_dump(({const char*_tmp1D7="sizeof(";
_tag_dyneither(_tmp1D7,sizeof(char),8);}));Cyc_Absyndump_dumpexp(_tmp179);Cyc_Absyndump_dump_char((
int)')');goto _LLCA;_LL109: {struct Cyc_Absyn_Valueof_e_struct*_tmp17A=(struct Cyc_Absyn_Valueof_e_struct*)
_tmp116;if(_tmp17A->tag != 39)goto _LL10B;else{_tmp17B=(void*)_tmp17A->f1;}}_LL10A:
Cyc_Absyndump_dump(({const char*_tmp1D8="valueof(";_tag_dyneither(_tmp1D8,sizeof(
...
_tmp116;if(_tmp17C->tag != 38)goto _LL10D;else{_tmp17D=_tmp17C->f1;_tmp17E=_tmp17C->f2;}}
_LL10C: Cyc_Absyndump_dump(({const char*_tmp1D9="tagcheck(";_tag_dyneither(_tmp1D9,
...
const char*_tmp1DA="offsetof(";_tag_dyneither(_tmp1DA,sizeof(char),10);}));Cyc_Absyndump_dumptyp(
...
_tmp1DB="offsetof(";_tag_dyneither(_tmp1DB,sizeof(char),10);}));Cyc_Absyndump_dumptyp(
_tmp185);Cyc_Absyndump_dump_char((int)',');Cyc_Absyndump_dump((struct
_dyneither_ptr)({struct Cyc_Int_pa_struct _tmp1DE;_tmp1DE.tag=1;_tmp1DE.f1=(
unsigned long)((int)_tmp188);({void*_tmp1DC[1]={& _tmp1DE};Cyc_aprintf(({const
char*_tmp1DD="%d";_tag_dyneither(_tmp1DD,sizeof(char),3);}),_tag_dyneither(
_tmp1DC,sizeof(void*),1));});}));Cyc_Absyndump_dump_char((int)')');goto _LLCA;
_LL111: {struct Cyc_Absyn_Deref_e_struct*_tmp189=(struct Cyc_Absyn_Deref_e_struct*)
...
myprec,_tmp18F);Cyc_Absyndump_dump_nospace(({const char*_tmp1DF="->";
_tag_dyneither(_tmp1DF,sizeof(char),3);}));Cyc_Absyndump_dump_nospace(*_tmp190);
...
_tmp116;if(_tmp194->tag != 25)goto _LL11B;else{_tmp195=_tmp194->f1;}}_LL11A: Cyc_Absyndump_dump(({
const char*_tmp1E0="$(";_tag_dyneither(_tmp1E0,sizeof(char),3);}));Cyc_Absyndump_dumpexps_prec(
20,_tmp195);Cyc_Absyndump_dump_char((int)')');goto _LLCA;_LL11B: {struct Cyc_Absyn_CompoundLit_e_struct*
_tmp196=(struct Cyc_Absyn_CompoundLit_e_struct*)_tmp116;if(_tmp196->tag != 26)goto
_LL11D;else{_tmp197=_tmp196->f1;_tmp198=_tmp196->f2;}}_LL11C: Cyc_Absyndump_dump_char((
int)'(');Cyc_Absyndump_dumptyp((*_tmp197).f3);Cyc_Absyndump_dump_char((int)')');((
...
_tmp198,({const char*_tmp1E1="{";_tag_dyneither(_tmp1E1,sizeof(char),2);}),({
const char*_tmp1E2="}";_tag_dyneither(_tmp1E2,sizeof(char),2);}),({const char*
_tmp1E3=",";_tag_dyneither(_tmp1E3,sizeof(char),2);}));goto _LLCA;_LL11D: {struct
Cyc_Absyn_Array_e_struct*_tmp199=(struct Cyc_Absyn_Array_e_struct*)_tmp116;if(
_tmp199->tag != 27)goto _LL11F;else{_tmp19A=_tmp199->f1;}}_LL11E:((void(*)(void(*f)(
...
_tmp19A,({const char*_tmp1E4="{";_tag_dyneither(_tmp1E4,sizeof(char),2);}),({
const char*_tmp1E5="}";_tag_dyneither(_tmp1E5,sizeof(char),2);}),({const char*
_tmp1E6=",";_tag_dyneither(_tmp1E6,sizeof(char),2);}));goto _LLCA;_LL11F: {struct
Cyc_Absyn_Comprehension_e_struct*_tmp19B=(struct Cyc_Absyn_Comprehension_e_struct*)
_tmp116;if(_tmp19B->tag != 28)goto _LL121;else{_tmp19C=_tmp19B->f1;_tmp19D=_tmp19B->f2;
_tmp19E=_tmp19B->f3;}}_LL120: Cyc_Absyndump_dump(({const char*_tmp1E7="new {for";
_tag_dyneither(_tmp1E7,sizeof(char),9);}));Cyc_Absyndump_dump_str((*_tmp19C->name).f2);
Cyc_Absyndump_dump_char((int)'<');Cyc_Absyndump_dumpexp(_tmp19D);Cyc_Absyndump_dump_char((
int)':');Cyc_Absyndump_dumpexp(_tmp19E);Cyc_Absyndump_dump_char((int)'}');goto
_LLCA;_LL121: {struct Cyc_Absyn_Aggregate_e_struct*_tmp19F=(struct Cyc_Absyn_Aggregate_e_struct*)
_tmp116;if(_tmp19F->tag != 29)goto _LL123;else{_tmp1A0=_tmp19F->f1;_tmp1A1=_tmp19F->f2;
_tmp1A2=_tmp19F->f3;}}_LL122: Cyc_Absyndump_dumpqvar(_tmp1A0);Cyc_Absyndump_dump_char((
int)'{');if(_tmp1A1 != 0)Cyc_Absyndump_dumptps(_tmp1A1);((void(*)(void(*f)(struct
...
const char*_tmp1E8="";_tag_dyneither(_tmp1E8,sizeof(char),1);}),({const char*
_tmp1E9="}";_tag_dyneither(_tmp1E9,sizeof(char),2);}),({const char*_tmp1EA=",";
_tag_dyneither(_tmp1EA,sizeof(char),2);}));goto _LLCA;_LL123: {struct Cyc_Absyn_AnonStruct_e_struct*
_tmp1A3=(struct Cyc_Absyn_AnonStruct_e_struct*)_tmp116;if(_tmp1A3->tag != 30)goto
_LL125;else{_tmp1A4=_tmp1A3->f2;}}_LL124:((void(*)(void(*f)(struct _tuple16*),
struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct
_dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,_tmp1A4,({const char*
_tmp1EB="{";_tag_dyneither(_tmp1EB,sizeof(char),2);}),({const char*_tmp1EC="}";
_tag_dyneither(_tmp1EC,sizeof(char),2);}),({const char*_tmp1ED=",";_tag_dyneither(
_tmp1ED,sizeof(char),2);}));goto _LLCA;_LL125: {struct Cyc_Absyn_Datatype_e_struct*
...
_tmp1A7->name);if(_tmp1A6 != 0)((void(*)(void(*f)(struct Cyc_Absyn_Exp*),struct Cyc_List_List*
l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumpexp,_tmp1A6,({const char*_tmp1EE="(";_tag_dyneither(_tmp1EE,
sizeof(char),2);}),({const char*_tmp1EF=")";_tag_dyneither(_tmp1EF,sizeof(char),2);}),({
const char*_tmp1F0=",";_tag_dyneither(_tmp1F0,sizeof(char),2);}));goto _LLCA;
_LL127: {struct Cyc_Absyn_Enum_e_struct*_tmp1A8=(struct Cyc_Absyn_Enum_e_struct*)
_tmp116;if(_tmp1A8->tag != 32)goto _LL129;else{_tmp1A9=_tmp1A8->f1;}}_LL128: Cyc_Absyndump_dumpqvar(
_tmp1A9);goto _LLCA;_LL129: {struct Cyc_Absyn_AnonEnum_e_struct*_tmp1AA=(struct Cyc_Absyn_AnonEnum_e_struct*)
...
if(_tmp1AE){if(_tmp1AF != 0){Cyc_Absyndump_dump(({const char*_tmp1F1="rcalloc(";
_tag_dyneither(_tmp1F1,sizeof(char),9);}));Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)
_tmp1AF);Cyc_Absyndump_dump(({const char*_tmp1F2=",";_tag_dyneither(_tmp1F2,
sizeof(char),2);}));}else{Cyc_Absyndump_dump(({const char*_tmp1F3="calloc";
_tag_dyneither(_tmp1F3,sizeof(char),7);}));}Cyc_Absyndump_dumpexp(_tmp1B1);Cyc_Absyndump_dump(({
const char*_tmp1F4=",";_tag_dyneither(_tmp1F4,sizeof(char),2);}));Cyc_Absyndump_dumpexp(
Cyc_Absyn_sizeoftyp_exp(*((void**)_check_null(_tmp1B0)),0));Cyc_Absyndump_dump(({
const char*_tmp1F5=")";_tag_dyneither(_tmp1F5,sizeof(char),2);}));}else{if(
_tmp1AF != 0){Cyc_Absyndump_dump(({const char*_tmp1F6="rmalloc(";_tag_dyneither(
_tmp1F6,sizeof(char),9);}));Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_tmp1AF);
Cyc_Absyndump_dump(({const char*_tmp1F7=",";_tag_dyneither(_tmp1F7,sizeof(char),2);}));}
else{Cyc_Absyndump_dump(({const char*_tmp1F8="malloc(";_tag_dyneither(_tmp1F8,
sizeof(char),8);}));}if(_tmp1B0 != 0)Cyc_Absyndump_dumpexp(Cyc_Absyn_times_exp(
Cyc_Absyn_sizeoftyp_exp(*_tmp1B0,0),_tmp1B1,0));else{Cyc_Absyndump_dumpexp(
_tmp1B1);}Cyc_Absyndump_dump(({const char*_tmp1F9=")";_tag_dyneither(_tmp1F9,
sizeof(char),2);}));}goto _LLCA;_LL12D: {struct Cyc_Absyn_Swap_e_struct*_tmp1B2=(
struct Cyc_Absyn_Swap_e_struct*)_tmp116;if(_tmp1B2->tag != 35)goto _LL12F;else{
_tmp1B3=_tmp1B2->f1;_tmp1B4=_tmp1B2->f2;}}_LL12E: Cyc_Absyndump_dump(({const char*
_tmp1FA="cycswap(";_tag_dyneither(_tmp1FA,sizeof(char),9);}));Cyc_Absyndump_dumpexp_prec(
...
goto _LL131;else{_tmp1B6=_tmp1B5->f1;_tmp1B7=_tmp1B5->f2;}}_LL130:((void(*)(void(*
f)(struct _tuple16*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct
_dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpde,
_tmp1B7,({const char*_tmp1FB="{";_tag_dyneither(_tmp1FB,sizeof(char),2);}),({
const char*_tmp1FC="}";_tag_dyneither(_tmp1FC,sizeof(char),2);}),({const char*
_tmp1FD=",";_tag_dyneither(_tmp1FD,sizeof(char),2);}));goto _LLCA;_LL131: {struct
Cyc_Absyn_StmtExp_e_struct*_tmp1B8=(struct Cyc_Absyn_StmtExp_e_struct*)_tmp116;
if(_tmp1B8->tag != 37)goto _LLCA;else{_tmp1B9=_tmp1B8->f1;}}_LL132: Cyc_Absyndump_dump_nospace(({
const char*_tmp1FE="({";_tag_dyneither(_tmp1FE,sizeof(char),3);}));Cyc_Absyndump_dumpstmt(
_tmp1B9,1);Cyc_Absyndump_dump_nospace(({const char*_tmp1FF="})";_tag_dyneither(
_tmp1FF,sizeof(char),3);}));goto _LLCA;_LLCA:;}if(inprec >= myprec)Cyc_Absyndump_dump_char((
...
scs=scs->tl){struct Cyc_Absyn_Switch_clause*_tmp200=(struct Cyc_Absyn_Switch_clause*)
scs->hd;if(_tmp200->where_clause == 0  && (_tmp200->pattern)->r == (void*)& Cyc_Absyn_Wild_p_val)
Cyc_Absyndump_dump(({const char*_tmp201="default:";_tag_dyneither(_tmp201,sizeof(
char),9);}));else{Cyc_Absyndump_dump(({const char*_tmp202="case";_tag_dyneither(
_tmp202,sizeof(char),5);}));Cyc_Absyndump_dumppat(_tmp200->pattern);if(_tmp200->where_clause
!= 0){Cyc_Absyndump_dump(({const char*_tmp203="&&";_tag_dyneither(_tmp203,sizeof(
char),3);}));Cyc_Absyndump_dumpexp((struct Cyc_Absyn_Exp*)_check_null(_tmp200->where_clause));}
Cyc_Absyndump_dump_nospace(({const char*_tmp204=":";_tag_dyneither(_tmp204,
sizeof(char),2);}));}Cyc_Absyndump_dumpstmt(_tmp200->body,0);}}void Cyc_Absyndump_dumpstmt(
...
s->loc);Cyc_Absyndump_dump(({const char*_tmp239="return;";_tag_dyneither(_tmp239,
sizeof(char),8);}));goto _LL137;_LL140: {struct Cyc_Absyn_Return_s_struct*_tmp20E=(
struct Cyc_Absyn_Return_s_struct*)_tmp205;if(_tmp20E->tag != 3)goto _LL142;else{
_tmp20F=_tmp20E->f1;}}_LL141: Cyc_Absyndump_dumploc(s->loc);Cyc_Absyndump_dump(({
const char*_tmp23A="return";_tag_dyneither(_tmp23A,sizeof(char),7);}));Cyc_Absyndump_dumpexp((
struct Cyc_Absyn_Exp*)_check_null(_tmp20F));Cyc_Absyndump_dump_semi();goto _LL137;
_LL142: {struct Cyc_Absyn_IfThenElse_s_struct*_tmp210=(struct Cyc_Absyn_IfThenElse_s_struct*)
_tmp205;if(_tmp210->tag != 4)goto _LL144;else{_tmp211=_tmp210->f1;_tmp212=_tmp210->f2;
_tmp213=_tmp210->f3;}}_LL143: Cyc_Absyndump_dumploc(s->loc);Cyc_Absyndump_dump(({
const char*_tmp23B="if(";_tag_dyneither(_tmp23B,sizeof(char),4);}));Cyc_Absyndump_dumpexp(
_tmp211);{void*_tmp23C=_tmp212->r;_LL15F: {struct Cyc_Absyn_Seq_s_struct*_tmp23D=(
struct Cyc_Absyn_Seq_s_struct*)_tmp23C;if(_tmp23D->tag != 2)goto _LL161;}_LL160:
goto _LL162;_LL161: {struct Cyc_Absyn_Decl_s_struct*_tmp23E=(struct Cyc_Absyn_Decl_s_struct*)
...
Cyc_Absyndump_dump_nospace(({const char*_tmp241="){";_tag_dyneither(_tmp241,
sizeof(char),3);}));Cyc_Absyndump_dumpstmt(_tmp212,0);Cyc_Absyndump_dump_char((
...
_LL16B: goto _LL169;_LL16C:;_LL16D: Cyc_Absyndump_dump(({const char*_tmp244="else{";
_tag_dyneither(_tmp244,sizeof(char),6);}));Cyc_Absyndump_dumpstmt(_tmp213,0);Cyc_Absyndump_dump_char((
...
s->loc);Cyc_Absyndump_dump(({const char*_tmp245="while(";_tag_dyneither(_tmp245,
sizeof(char),7);}));Cyc_Absyndump_dumpexp(_tmp216);Cyc_Absyndump_dump_nospace(({
const char*_tmp246="){";_tag_dyneither(_tmp246,sizeof(char),3);}));Cyc_Absyndump_dumpstmt(
_tmp217,0);Cyc_Absyndump_dump_char((int)'}');goto _LL137;_LL146: {struct Cyc_Absyn_Break_s_struct*
_tmp218=(struct Cyc_Absyn_Break_s_struct*)_tmp205;if(_tmp218->tag != 6)goto _LL148;}
_LL147: Cyc_Absyndump_dumploc(s->loc);Cyc_Absyndump_dump(({const char*_tmp247="break;";
_tag_dyneither(_tmp247,sizeof(char),7);}));goto _LL137;_LL148: {struct Cyc_Absyn_Continue_s_struct*
_tmp219=(struct Cyc_Absyn_Continue_s_struct*)_tmp205;if(_tmp219->tag != 7)goto
_LL14A;}_LL149: Cyc_Absyndump_dumploc(s->loc);Cyc_Absyndump_dump(({const char*
_tmp248="continue;";_tag_dyneither(_tmp248,sizeof(char),10);}));goto _LL137;
...
s->loc);Cyc_Absyndump_dump(({const char*_tmp249="goto";_tag_dyneither(_tmp249,
sizeof(char),5);}));Cyc_Absyndump_dump_str(_tmp21B);Cyc_Absyndump_dump_semi();
...
_LL14D: Cyc_Absyndump_dumploc(s->loc);Cyc_Absyndump_dump(({const char*_tmp24A="for(";
_tag_dyneither(_tmp24A,sizeof(char),5);}));Cyc_Absyndump_dumpexp(_tmp21D);Cyc_Absyndump_dump_semi();
Cyc_Absyndump_dumpexp(_tmp21F);Cyc_Absyndump_dump_semi();Cyc_Absyndump_dumpexp(
_tmp221);Cyc_Absyndump_dump_nospace(({const char*_tmp24B="){";_tag_dyneither(
_tmp24B,sizeof(char),3);}));Cyc_Absyndump_dumpstmt(_tmp222,0);Cyc_Absyndump_dump_char((
int)'}');goto _LL137;_LL14E: {struct Cyc_Absyn_Switch_s_struct*_tmp223=(struct Cyc_Absyn_Switch_s_struct*)
_tmp205;if(_tmp223->tag != 10)goto _LL150;else{_tmp224=_tmp223->f1;_tmp225=_tmp223->f2;}}
_LL14F: Cyc_Absyndump_dumploc(s->loc);Cyc_Absyndump_dump(({const char*_tmp24C="switch(";
_tag_dyneither(_tmp24C,sizeof(char),8);}));Cyc_Absyndump_dumpexp(_tmp224);Cyc_Absyndump_dump_nospace(({
const char*_tmp24D="){";_tag_dyneither(_tmp24D,sizeof(char),3);}));Cyc_Absyndump_dumpswitchclauses(
_tmp225);Cyc_Absyndump_dump_char((int)'}');goto _LL137;_LL150: {struct Cyc_Absyn_Decl_s_struct*
_tmp226=(struct Cyc_Absyn_Decl_s_struct*)_tmp205;if(_tmp226->tag != 12)goto _LL152;
else{_tmp227=_tmp226->f1;_tmp228=_tmp226->f2;}}_LL151: Cyc_Absyndump_dumpdecl(
_tmp227);Cyc_Absyndump_dumpstmt(_tmp228,expstmt);goto _LL137;_LL152: {struct Cyc_Absyn_Label_s_struct*
_tmp229=(struct Cyc_Absyn_Label_s_struct*)_tmp205;if(_tmp229->tag != 13)goto _LL154;
else{_tmp22A=_tmp229->f1;_tmp22B=_tmp229->f2;}}_LL153: if(Cyc_Absynpp_is_declaration(
_tmp22B)){Cyc_Absyndump_dump_str(_tmp22A);if(expstmt)Cyc_Absyndump_dump_nospace(({
const char*_tmp24E=": ({";_tag_dyneither(_tmp24E,sizeof(char),5);}));else{Cyc_Absyndump_dump_nospace(({
const char*_tmp24F=": {";_tag_dyneither(_tmp24F,sizeof(char),4);}));}Cyc_Absyndump_dumpstmt(
_tmp22B,expstmt);if(expstmt)Cyc_Absyndump_dump_nospace(({const char*_tmp250="});}";
_tag_dyneither(_tmp250,sizeof(char),5);}));else{Cyc_Absyndump_dump_char((int)'}');}}
else{Cyc_Absyndump_dump_str(_tmp22A);Cyc_Absyndump_dump_char((int)':');Cyc_Absyndump_dumpstmt(
_tmp22B,expstmt);}goto _LL137;_LL154: {struct Cyc_Absyn_Do_s_struct*_tmp22C=(
struct Cyc_Absyn_Do_s_struct*)_tmp205;if(_tmp22C->tag != 14)goto _LL156;else{
_tmp22D=_tmp22C->f1;_tmp22E=_tmp22C->f2;_tmp22F=_tmp22E.f1;}}_LL155: Cyc_Absyndump_dumploc(
s->loc);Cyc_Absyndump_dump(({const char*_tmp251="do{";_tag_dyneither(_tmp251,
sizeof(char),4);}));Cyc_Absyndump_dumpstmt(_tmp22D,0);Cyc_Absyndump_dump_nospace(({
const char*_tmp252="}while(";_tag_dyneither(_tmp252,sizeof(char),8);}));Cyc_Absyndump_dumpexp(
_tmp22F);Cyc_Absyndump_dump_nospace(({const char*_tmp253=");";_tag_dyneither(
_tmp253,sizeof(char),3);}));goto _LL137;_LL156: {struct Cyc_Absyn_Fallthru_s_struct*
_tmp230=(struct Cyc_Absyn_Fallthru_s_struct*)_tmp205;if(_tmp230->tag != 11)goto
_LL158;else{_tmp231=_tmp230->f1;if(_tmp231 != 0)goto _LL158;}}_LL157: Cyc_Absyndump_dump(({
const char*_tmp254="fallthru;";_tag_dyneither(_tmp254,sizeof(char),10);}));goto
_LL137;_LL158: {struct Cyc_Absyn_Fallthru_s_struct*_tmp232=(struct Cyc_Absyn_Fallthru_s_struct*)
_tmp205;if(_tmp232->tag != 11)goto _LL15A;else{_tmp233=_tmp232->f1;}}_LL159: Cyc_Absyndump_dump(({
const char*_tmp255="fallthru(";_tag_dyneither(_tmp255,sizeof(char),10);}));Cyc_Absyndump_dumpexps_prec(
20,_tmp233);Cyc_Absyndump_dump_nospace(({const char*_tmp256=");";_tag_dyneither(
_tmp256,sizeof(char),3);}));goto _LL137;_LL15A: {struct Cyc_Absyn_TryCatch_s_struct*
...
s->loc);Cyc_Absyndump_dump(({const char*_tmp257="try";_tag_dyneither(_tmp257,
sizeof(char),4);}));Cyc_Absyndump_dumpstmt(_tmp235,0);Cyc_Absyndump_dump(({const
char*_tmp258="catch{";_tag_dyneither(_tmp258,sizeof(char),7);}));Cyc_Absyndump_dumpswitchclauses(
_tmp236);Cyc_Absyndump_dump_char((int)'}');goto _LL137;_LL15C: {struct Cyc_Absyn_ResetRegion_s_struct*
_tmp237=(struct Cyc_Absyn_ResetRegion_s_struct*)_tmp205;if(_tmp237->tag != 16)goto
_LL137;else{_tmp238=_tmp237->f1;}}_LL15D: Cyc_Absyndump_dumploc(s->loc);Cyc_Absyndump_dump(({
const char*_tmp259="reset_region(";_tag_dyneither(_tmp259,sizeof(char),14);}));
Cyc_Absyndump_dumpexp(_tmp238);Cyc_Absyndump_dump(({const char*_tmp25A=");";
_tag_dyneither(_tmp25A,sizeof(char),3);}));goto _LL137;_LL137:;}struct _tuple17{
...
_dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(
Cyc_Absyndump_dumpdesignator,(*dp).f1,({const char*_tmp25B="";_tag_dyneither(
_tmp25B,sizeof(char),1);}),({const char*_tmp25C="=";_tag_dyneither(_tmp25C,
sizeof(char),2);}),({const char*_tmp25D="=";_tag_dyneither(_tmp25D,sizeof(char),2);}));
Cyc_Absyndump_dumppat((*dp).f2);}void Cyc_Absyndump_dumppat(struct Cyc_Absyn_Pat*p){
void*_tmp25E=p->r;enum Cyc_Absyn_Sign _tmp262;int _tmp263;enum Cyc_Absyn_Sign
_tmp265;int _tmp266;enum Cyc_Absyn_Sign _tmp268;int _tmp269;char _tmp26B;struct
...
_tmp25E;if(_tmp260->tag != 8)goto _LL173;}_LL172: Cyc_Absyndump_dump(({const char*
_tmp2A4="NULL";_tag_dyneither(_tmp2A4,sizeof(char),5);}));goto _LL16E;_LL173: {
...
goto _LL177;_tmp266=_tmp264->f2;}}_LL176: Cyc_Absyndump_dump((struct _dyneither_ptr)({
struct Cyc_Int_pa_struct _tmp2A7;_tmp2A7.tag=1;_tmp2A7.f1=(unsigned long)_tmp266;({
void*_tmp2A5[1]={& _tmp2A7};Cyc_aprintf(({const char*_tmp2A6="%d";_tag_dyneither(
_tmp2A6,sizeof(char),3);}),_tag_dyneither(_tmp2A5,sizeof(void*),1));});}));goto
_LL16E;_LL177: {struct Cyc_Absyn_Int_p_struct*_tmp267=(struct Cyc_Absyn_Int_p_struct*)
_tmp25E;if(_tmp267->tag != 9)goto _LL179;else{_tmp268=_tmp267->f1;if(_tmp268 != Cyc_Absyn_Unsigned)
goto _LL179;_tmp269=_tmp267->f2;}}_LL178: Cyc_Absyndump_dump((struct _dyneither_ptr)({
struct Cyc_Int_pa_struct _tmp2AA;_tmp2AA.tag=1;_tmp2AA.f1=(unsigned int)_tmp269;({
void*_tmp2A8[1]={& _tmp2AA};Cyc_aprintf(({const char*_tmp2A9="%u";_tag_dyneither(
_tmp2A9,sizeof(char),3);}),_tag_dyneither(_tmp2A8,sizeof(void*),1));});}));goto
_LL16E;_LL179: {struct Cyc_Absyn_Char_p_struct*_tmp26A=(struct Cyc_Absyn_Char_p_struct*)
_tmp25E;if(_tmp26A->tag != 10)goto _LL17B;else{_tmp26B=_tmp26A->f1;}}_LL17A: Cyc_Absyndump_dump(({
const char*_tmp2AB="'";_tag_dyneither(_tmp2AB,sizeof(char),2);}));Cyc_Absyndump_dump_nospace(
Cyc_Absynpp_char_escape(_tmp26B));Cyc_Absyndump_dump_nospace(({const char*_tmp2AC="'";
_tag_dyneither(_tmp2AC,sizeof(char),2);}));goto _LL16E;_LL17B: {struct Cyc_Absyn_Float_p_struct*
_tmp26C=(struct Cyc_Absyn_Float_p_struct*)_tmp25E;if(_tmp26C->tag != 11)goto _LL17D;
else{_tmp26D=_tmp26C->f1;}}_LL17C: Cyc_Absyndump_dump(_tmp26D);goto _LL16E;_LL17D: {
struct Cyc_Absyn_Var_p_struct*_tmp26E=(struct Cyc_Absyn_Var_p_struct*)_tmp25E;if(
_tmp26E->tag != 1)goto _LL17F;else{_tmp26F=_tmp26E->f1;_tmp270=_tmp26E->f2;_tmp271=*
_tmp270;_tmp272=_tmp271.r;{struct Cyc_Absyn_Wild_p_struct*_tmp273=(struct Cyc_Absyn_Wild_p_struct*)
_tmp272;if(_tmp273->tag != 0)goto _LL17F;};}}_LL17E: Cyc_Absyndump_dumpqvar(_tmp26F->name);
...
_LL180: Cyc_Absyndump_dumpqvar(_tmp275->name);Cyc_Absyndump_dump(({const char*
_tmp2AD=" as ";_tag_dyneither(_tmp2AD,sizeof(char),5);}));Cyc_Absyndump_dumppat(
...
_LL182: {struct _dyneither_ptr term=_tmp279?({const char*_tmp2B0=", ...)";
_tag_dyneither(_tmp2B0,sizeof(char),7);}):({const char*_tmp2B1=")";_tag_dyneither(
_tmp2B1,sizeof(char),2);});((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*
l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumppat,_tmp278,({const char*_tmp2AE="$(";_tag_dyneither(_tmp2AE,
sizeof(char),3);}),term,({const char*_tmp2AF=",";_tag_dyneither(_tmp2AF,sizeof(
char),2);}));goto _LL16E;}_LL183: {struct Cyc_Absyn_Pointer_p_struct*_tmp27A=(
struct Cyc_Absyn_Pointer_p_struct*)_tmp25E;if(_tmp27A->tag != 5)goto _LL185;else{
_tmp27B=_tmp27A->f1;}}_LL184: Cyc_Absyndump_dump(({const char*_tmp2B2="&";
_tag_dyneither(_tmp2B2,sizeof(char),2);}));Cyc_Absyndump_dumppat(_tmp27B);goto
_LL16E;_LL185: {struct Cyc_Absyn_Reference_p_struct*_tmp27C=(struct Cyc_Absyn_Reference_p_struct*)
_tmp25E;if(_tmp27C->tag != 2)goto _LL187;else{_tmp27D=_tmp27C->f1;_tmp27E=_tmp27C->f2;
_tmp27F=*_tmp27E;_tmp280=_tmp27F.r;{struct Cyc_Absyn_Wild_p_struct*_tmp281=(
struct Cyc_Absyn_Wild_p_struct*)_tmp280;if(_tmp281->tag != 0)goto _LL187;};}}_LL186:
Cyc_Absyndump_dump(({const char*_tmp2B3="*";_tag_dyneither(_tmp2B3,sizeof(char),2);}));
Cyc_Absyndump_dumpqvar(_tmp27D->name);goto _LL16E;_LL187: {struct Cyc_Absyn_Reference_p_struct*
_tmp282=(struct Cyc_Absyn_Reference_p_struct*)_tmp25E;if(_tmp282->tag != 2)goto
_LL189;else{_tmp283=_tmp282->f1;_tmp284=_tmp282->f2;}}_LL188: Cyc_Absyndump_dump(({
const char*_tmp2B4="*";_tag_dyneither(_tmp2B4,sizeof(char),2);}));Cyc_Absyndump_dumpqvar(
_tmp283->name);Cyc_Absyndump_dump(({const char*_tmp2B5=" as ";_tag_dyneither(
_tmp2B5,sizeof(char),5);}));Cyc_Absyndump_dumppat(_tmp284);goto _LL16E;_LL189: {
struct Cyc_Absyn_TagInt_p_struct*_tmp285=(struct Cyc_Absyn_TagInt_p_struct*)
...
struct _dyneither_ptr term=_tmp28D?({const char*_tmp2B8=", ...)";_tag_dyneither(
_tmp2B8,sizeof(char),7);}):({const char*_tmp2B9=")";_tag_dyneither(_tmp2B9,
sizeof(char),2);});Cyc_Absyndump_dumpqvar(_tmp28B);((void(*)(void(*f)(struct Cyc_Absyn_Pat*),
struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct
_dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumppat,_tmp28C,({const
char*_tmp2B6="(";_tag_dyneither(_tmp2B6,sizeof(char),2);}),term,({const char*
_tmp2B7=",";_tag_dyneither(_tmp2B7,sizeof(char),2);}));goto _LL16E;}_LL18F: {
struct Cyc_Absyn_Aggr_p_struct*_tmp28E=(struct Cyc_Absyn_Aggr_p_struct*)_tmp25E;
if(_tmp28E->tag != 6)goto _LL191;else{_tmp28F=_tmp28E->f1;if(_tmp28F == 0)goto
_LL191;_tmp290=*_tmp28F;_tmp291=_tmp290.aggr_info;_tmp292=_tmp28E->f2;_tmp293=
_tmp28E->f3;_tmp294=_tmp28E->f4;}}_LL190: {struct _tuple0*_tmp2BB;struct _tuple9
_tmp2BA=Cyc_Absyn_aggr_kinded_name(_tmp291);_tmp2BB=_tmp2BA.f2;{struct
_dyneither_ptr term=_tmp294?({const char*_tmp2C1=", ...)";_tag_dyneither(_tmp2C1,
sizeof(char),7);}):({const char*_tmp2C2=")";_tag_dyneither(_tmp2C2,sizeof(char),2);});
Cyc_Absyndump_dumpqvar(_tmp2BB);Cyc_Absyndump_dump_char((int)'{');((void(*)(void(*
...
_tmp292,({const char*_tmp2BC="[";_tag_dyneither(_tmp2BC,sizeof(char),2);}),({
const char*_tmp2BD="]";_tag_dyneither(_tmp2BD,sizeof(char),2);}),({const char*
_tmp2BE=",";_tag_dyneither(_tmp2BE,sizeof(char),2);}));((void(*)(void(*f)(struct
_tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr
end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpdp,_tmp293,({
const char*_tmp2BF="";_tag_dyneither(_tmp2BF,sizeof(char),1);}),term,({const char*
_tmp2C0=",";_tag_dyneither(_tmp2C0,sizeof(char),2);}));goto _LL16E;};}_LL191: {
struct Cyc_Absyn_Aggr_p_struct*_tmp295=(struct Cyc_Absyn_Aggr_p_struct*)_tmp25E;
if(_tmp295->tag != 6)goto _LL193;else{_tmp296=_tmp295->f1;if(_tmp296 != 0)goto
_LL193;_tmp297=_tmp295->f2;_tmp298=_tmp295->f3;_tmp299=_tmp295->f4;}}_LL192: {
struct _dyneither_ptr term=_tmp299?({const char*_tmp2C8=", ...)";_tag_dyneither(
_tmp2C8,sizeof(char),7);}):({const char*_tmp2C9=")";_tag_dyneither(_tmp2C9,
...
_dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumptvar,
_tmp297,({const char*_tmp2C3="[";_tag_dyneither(_tmp2C3,sizeof(char),2);}),({
const char*_tmp2C4="]";_tag_dyneither(_tmp2C4,sizeof(char),2);}),({const char*
_tmp2C5=",";_tag_dyneither(_tmp2C5,sizeof(char),2);}));((void(*)(void(*f)(struct
_tuple17*),struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr
end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(Cyc_Absyndump_dumpdp,_tmp298,({
const char*_tmp2C6="";_tag_dyneither(_tmp2C6,sizeof(char),1);}),term,({const char*
_tmp2C7=",";_tag_dyneither(_tmp2C7,sizeof(char),2);}));goto _LL16E;}_LL193: {
struct Cyc_Absyn_Datatype_p_struct*_tmp29A=(struct Cyc_Absyn_Datatype_p_struct*)
_tmp25E;if(_tmp29A->tag != 7)goto _LL195;else{_tmp29B=_tmp29A->f2;_tmp29C=_tmp29A->f3;
_tmp29D=_tmp29A->f4;}}_LL194: {struct _dyneither_ptr term=_tmp29D?({const char*
_tmp2CC=", ...)";_tag_dyneither(_tmp2CC,sizeof(char),7);}):({const char*_tmp2CD=")";
_tag_dyneither(_tmp2CD,sizeof(char),2);});Cyc_Absyndump_dumpqvar(_tmp29B->name);
if(_tmp29C != 0)((void(*)(void(*f)(struct Cyc_Absyn_Pat*),struct Cyc_List_List*l,
struct _dyneither_ptr start,struct _dyneither_ptr end,struct _dyneither_ptr sep))Cyc_Absyndump_group)(
Cyc_Absyndump_dumppat,_tmp29C,({const char*_tmp2CA="(";_tag_dyneither(_tmp2CA,
sizeof(char),2);}),term,({const char*_tmp2CB=",";_tag_dyneither(_tmp2CB,sizeof(
char),2);}));goto _LL16E;}_LL195: {struct Cyc_Absyn_Enum_p_struct*_tmp29E=(struct
Cyc_Absyn_Enum_p_struct*)_tmp25E;if(_tmp29E->tag != 12)goto _LL197;else{_tmp29F=
_tmp29E->f2;}}_LL196: _tmp2A1=_tmp29F;goto _LL198;_LL197: {struct Cyc_Absyn_AnonEnum_p_struct*
...
_tmp2CE=",";_tag_dyneither(_tmp2CE,sizeof(char),2);}));}void Cyc_Absyndump_dumpenumfield(
struct Cyc_Absyn_Enumfield*ef){Cyc_Absyndump_dumpqvar(ef->name);if(ef->tag != 0){
Cyc_Absyndump_dump(({const char*_tmp2CF=" = ";_tag_dyneither(_tmp2CF,sizeof(char),
...
Cyc_Absyndump_dumpenumfield,fields,({const char*_tmp2D0=",";_tag_dyneither(
_tmp2D0,sizeof(char),2);}));}void Cyc_Absyndump_dumpaggrfields(struct Cyc_List_List*
...
struct _tuple18*pr){{void*_tmp2D8=(*pr).f1;_LL19F: {struct Cyc_Absyn_Unused_att_struct*
_tmp2D9=(struct Cyc_Absyn_Unused_att_struct*)_tmp2D8;if(_tmp2D9->tag != 11)goto
_LL1A1;}_LL1A0: goto _LL19E;_LL1A1: {struct Cyc_Absyn_Stdcall_att_struct*_tmp2DA=(
struct Cyc_Absyn_Stdcall_att_struct*)_tmp2D8;if(_tmp2DA->tag != 1)goto _LL1A3;}
_LL1A2: Cyc_Absyndump_dump(({const char*_tmp2DD="_stdcall";_tag_dyneither(_tmp2DD,
sizeof(char),9);}));goto _LL19E;_LL1A3: {struct Cyc_Absyn_Cdecl_att_struct*_tmp2DB=(
struct Cyc_Absyn_Cdecl_att_struct*)_tmp2D8;if(_tmp2DB->tag != 2)goto _LL1A5;}_LL1A4:
Cyc_Absyndump_dump(({const char*_tmp2DE="_cdecl";_tag_dyneither(_tmp2DE,sizeof(
char),7);}));goto _LL19E;_LL1A5: {struct Cyc_Absyn_Fastcall_att_struct*_tmp2DC=(
struct Cyc_Absyn_Fastcall_att_struct*)_tmp2D8;if(_tmp2DC->tag != 3)goto _LL1A7;}
_LL1A6: Cyc_Absyndump_dump(({const char*_tmp2DF="_fastcall";_tag_dyneither(_tmp2DF,
sizeof(char),10);}));goto _LL19E;_LL1A7:;_LL1A8: goto _LL19E;_LL19E:;}Cyc_Absyndump_dumpqvar((*
...
vd,struct Cyc_Position_Segment*loc){struct Cyc_Absyn_Vardecl _tmp2E1;enum Cyc_Absyn_Scope
_tmp2E2;struct _tuple0*_tmp2E3;struct Cyc_Absyn_Tqual _tmp2E4;void*_tmp2E5;struct
Cyc_Absyn_Exp*_tmp2E6;struct Cyc_List_List*_tmp2E7;struct Cyc_Absyn_Vardecl*
_tmp2E0=vd;_tmp2E1=*_tmp2E0;_tmp2E2=_tmp2E1.sc;_tmp2E3=_tmp2E1.name;_tmp2E4=
_tmp2E1.tq;_tmp2E5=_tmp2E1.type;_tmp2E6=_tmp2E1.initializer;_tmp2E7=_tmp2E1.attributes;
Cyc_Absyndump_dumploc(loc);switch(Cyc_Cyclone_c_compiler){case Cyc_Cyclone_Gcc_c:
_LL1A9: if(_tmp2E2 == Cyc_Absyn_Extern  && Cyc_Absyndump_qvar_to_Cids){void*_tmp2E8=
Cyc_Tcutil_compress(_tmp2E5);_LL1AC: {struct Cyc_Absyn_FnType_struct*_tmp2E9=(
struct Cyc_Absyn_FnType_struct*)_tmp2E8;if(_tmp2E9->tag != 10)goto _LL1AE;}_LL1AD:
goto _LL1AB;_LL1AE:;_LL1AF: Cyc_Absyndump_dumpscope(_tmp2E2);_LL1AB:;}else{Cyc_Absyndump_dumpscope(
_tmp2E2);}((void(*)(struct Cyc_Absyn_Tqual,void*,void(*f)(struct _tuple0*),struct
_tuple0*))Cyc_Absyndump_dumptqtd)(_tmp2E4,_tmp2E5,Cyc_Absyndump_dumpqvar,_tmp2E3);
Cyc_Absyndump_dumpatts(_tmp2E7);break;case Cyc_Cyclone_Vc_c: _LL1AA: Cyc_Absyndump_dumpatts(
_tmp2E7);Cyc_Absyndump_dumpscope(_tmp2E2);{struct _RegionHandle _tmp2EA=
_new_region("temp");struct _RegionHandle*temp=& _tmp2EA;_push_region(temp);{struct
Cyc_Absyn_Tqual _tmp2EC;void*_tmp2ED;struct Cyc_List_List*_tmp2EE;struct _tuple11
_tmp2EB=Cyc_Absynpp_to_tms(temp,_tmp2E4,_tmp2E5);_tmp2EC=_tmp2EB.f1;_tmp2ED=
_tmp2EB.f2;_tmp2EE=_tmp2EB.f3;{void*call_conv=(void*)& Cyc_Absyn_Unused_att_val;{
struct Cyc_List_List*tms2=_tmp2EE;for(0;tms2 != 0;tms2=tms2->tl){void*_tmp2EF=(
void*)tms2->hd;struct Cyc_List_List*_tmp2F1;_LL1B2: {struct Cyc_Absyn_Attributes_mod_struct*
_tmp2F0=(struct Cyc_Absyn_Attributes_mod_struct*)_tmp2EF;if(_tmp2F0->tag != 5)goto
_LL1B4;else{_tmp2F1=_tmp2F0->f2;}}_LL1B3: for(0;_tmp2F1 != 0;_tmp2F1=_tmp2F1->tl){
void*_tmp2F2=(void*)_tmp2F1->hd;_LL1B7: {struct Cyc_Absyn_Stdcall_att_struct*
_tmp2F3=(struct Cyc_Absyn_Stdcall_att_struct*)_tmp2F2;if(_tmp2F3->tag != 1)goto
_LL1B9;}_LL1B8: call_conv=(void*)& Cyc_Absyn_Stdcall_att_val;goto _LL1B6;_LL1B9: {
struct Cyc_Absyn_Cdecl_att_struct*_tmp2F4=(struct Cyc_Absyn_Cdecl_att_struct*)
...
struct _tuple18 _tmp2F6=({struct _tuple18 _tmp2F7;_tmp2F7.f1=call_conv;_tmp2F7.f2=
_tmp2E3;_tmp2F7;});((void(*)(struct Cyc_List_List*tms,void(*f)(struct _tuple18*),
...
struct Cyc_Absyn_Decl*d){void*_tmp2F8=d->r;struct Cyc_Absyn_Vardecl*_tmp2FA;struct
Cyc_Absyn_Fndecl*_tmp2FC;struct Cyc_Absyn_Aggrdecl*_tmp2FE;struct Cyc_Absyn_Datatypedecl*
_tmp300;struct Cyc_Absyn_Datatypedecl _tmp301;enum Cyc_Absyn_Scope _tmp302;struct
_tuple0*_tmp303;struct Cyc_List_List*_tmp304;struct Cyc_Core_Opt*_tmp305;int
_tmp306;struct Cyc_Absyn_Enumdecl*_tmp308;struct Cyc_Absyn_Enumdecl _tmp309;enum 
Cyc_Absyn_Scope _tmp30A;struct _tuple0*_tmp30B;struct Cyc_Core_Opt*_tmp30C;struct
Cyc_Absyn_Pat*_tmp30E;struct Cyc_Absyn_Exp*_tmp30F;struct Cyc_List_List*_tmp311;
struct Cyc_Absyn_Tvar*_tmp313;struct Cyc_Absyn_Vardecl*_tmp314;int _tmp315;struct
Cyc_Absyn_Exp*_tmp316;struct Cyc_Absyn_Exp*_tmp318;struct Cyc_Absyn_Tvar*_tmp319;
struct Cyc_Absyn_Vardecl*_tmp31A;struct Cyc_Absyn_Typedefdecl*_tmp31C;struct
_dyneither_ptr*_tmp31E;struct Cyc_List_List*_tmp31F;struct _tuple0*_tmp321;struct
Cyc_List_List*_tmp322;struct Cyc_List_List*_tmp324;struct Cyc_List_List*_tmp326;
struct Cyc_List_List*_tmp327;_LL1C0: {struct Cyc_Absyn_Var_d_struct*_tmp2F9=(
struct Cyc_Absyn_Var_d_struct*)_tmp2F8;if(_tmp2F9->tag != 0)goto _LL1C2;else{
_tmp2FA=_tmp2F9->f1;}}_LL1C1: Cyc_Absyndump_dumpvardecl(_tmp2FA,d->loc);goto
...
Cyc_Cyclone_Vc_c)goto _LL1E6;_LL1E5: Cyc_Absyndump_dump(({const char*_tmp32B="__inline";
_tag_dyneither(_tmp32B,sizeof(char),9);}));goto _LL1E3;_LL1E6:;_LL1E7: Cyc_Absyndump_dump(({
const char*_tmp32C="inline";_tag_dyneither(_tmp32C,sizeof(char),7);}));goto _LL1E3;
_LL1E3:;}Cyc_Absyndump_dumpscope(_tmp2FC->sc);{void*t=(void*)({struct Cyc_Absyn_FnType_struct*
_tmp32D=_cycalloc(sizeof(*_tmp32D));_tmp32D[0]=({struct Cyc_Absyn_FnType_struct
_tmp32E;_tmp32E.tag=10;_tmp32E.f1=({struct Cyc_Absyn_FnInfo _tmp32F;_tmp32F.tvars=
_tmp2FC->tvs;_tmp32F.effect=_tmp2FC->effect;_tmp32F.ret_typ=_tmp2FC->ret_type;
_tmp32F.args=((struct Cyc_List_List*(*)(struct _tuple7*(*f)(struct _tuple10*),
struct Cyc_List_List*x))Cyc_List_map)(Cyc_Absynpp_arg_mk_opt,_tmp2FC->args);
_tmp32F.c_varargs=_tmp2FC->c_varargs;_tmp32F.cyc_varargs=_tmp2FC->cyc_varargs;
_tmp32F.rgn_po=_tmp2FC->rgn_po;_tmp32F.attributes=0;_tmp32F;});_tmp32E;});
_tmp32D;});switch(Cyc_Cyclone_c_compiler){case Cyc_Cyclone_Gcc_c: _LL1E8:((void(*)(
...
_tmp2FC);break;case Cyc_Cyclone_Vc_c: _LL1E9:((void(*)(struct Cyc_Absyn_Tqual,void*,
void(*f)(struct Cyc_Absyn_Fndecl*),struct Cyc_Absyn_Fndecl*))Cyc_Absyndump_dumptqtd)(
Cyc_Absyn_empty_tqual(0),t,Cyc_Absyndump_dump_callconv_fdqvar,_tmp2FC);break;}
Cyc_Absyndump_dump_char((int)'{');Cyc_Absyndump_dumpstmt(_tmp2FC->body,0);Cyc_Absyndump_dump_char((
int)'}');goto _LL1BF;};_LL1C4: {struct Cyc_Absyn_Aggr_d_struct*_tmp2FD=(struct Cyc_Absyn_Aggr_d_struct*)
_tmp2F8;if(_tmp2FD->tag != 6)goto _LL1C6;else{_tmp2FE=_tmp2FD->f1;}}_LL1C5: Cyc_Absyndump_dumpscope(
_tmp2FE->sc);Cyc_Absyndump_dumpaggr_kind(_tmp2FE->kind);Cyc_Absyndump_dumpqvar(
_tmp2FE->name);Cyc_Absyndump_dumptvars(_tmp2FE->tvs);if(_tmp2FE->impl == 0)Cyc_Absyndump_dump_semi();
else{Cyc_Absyndump_dump_char((int)'{');if(((struct Cyc_Absyn_AggrdeclImpl*)
_check_null(_tmp2FE->impl))->exist_vars != 0)((void(*)(void(*f)(struct Cyc_Absyn_Tvar*),
struct Cyc_List_List*l,struct _dyneither_ptr start,struct _dyneither_ptr end,struct
_dyneither_ptr sep))Cyc_Absyndump_egroup)(Cyc_Absyndump_dumpkindedtvar,((struct
Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp2FE->impl))->exist_vars,({const char*
_tmp330="<";_tag_dyneither(_tmp330,sizeof(char),2);}),({const char*_tmp331=">";
_tag_dyneither(_tmp331,sizeof(char),2);}),({const char*_tmp332=",";_tag_dyneither(
_tmp332,sizeof(char),2);}));if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(
_tmp2FE->impl))->rgn_po != 0){Cyc_Absyndump_dump_char((int)':');Cyc_Absyndump_dump_rgnpo(((
struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp2FE->impl))->rgn_po);}Cyc_Absyndump_dumpaggrfields(((
struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp2FE->impl))->fields);Cyc_Absyndump_dump(({
const char*_tmp333="}";_tag_dyneither(_tmp333,sizeof(char),2);}));Cyc_Absyndump_dumpatts(
_tmp2FE->attributes);Cyc_Absyndump_dump(({const char*_tmp334=";";_tag_dyneither(
_tmp334,sizeof(char),2);}));}goto _LL1BF;_LL1C6: {struct Cyc_Absyn_Datatype_d_struct*
...
_LL1C7: Cyc_Absyndump_dumpscope(_tmp302);if(_tmp306)Cyc_Absyndump_dump(({const
char*_tmp335="@extensible ";_tag_dyneither(_tmp335,sizeof(char),13);}));Cyc_Absyndump_dump(({
const char*_tmp336="datatype ";_tag_dyneither(_tmp336,sizeof(char),10);}));Cyc_Absyndump_dumpqvar(
_tmp303);Cyc_Absyndump_dumptvars(_tmp304);if(_tmp305 == 0)Cyc_Absyndump_dump_semi();
else{Cyc_Absyndump_dump_char((int)'{');Cyc_Absyndump_dumpdatatypefields((struct
Cyc_List_List*)_tmp305->v);Cyc_Absyndump_dump_nospace(({const char*_tmp337="};";
_tag_dyneither(_tmp337,sizeof(char),3);}));}goto _LL1BF;_LL1C8: {struct Cyc_Absyn_Enum_d_struct*
_tmp307=(struct Cyc_Absyn_Enum_d_struct*)_tmp2F8;if(_tmp307->tag != 8)goto _LL1CA;
else{_tmp308=_tmp307->f1;_tmp309=*_tmp308;_tmp30A=_tmp309.sc;_tmp30B=_tmp309.name;
_tmp30C=_tmp309.fields;}}_LL1C9: Cyc_Absyndump_dumpscope(_tmp30A);Cyc_Absyndump_dump(({
const char*_tmp338="enum ";_tag_dyneither(_tmp338,sizeof(char),6);}));Cyc_Absyndump_dumpqvar(
_tmp30B);if(_tmp30C == 0)Cyc_Absyndump_dump_semi();else{Cyc_Absyndump_dump_char((
int)'{');Cyc_Absyndump_dumpenumfields((struct Cyc_List_List*)_tmp30C->v);Cyc_Absyndump_dump_nospace(({
const char*_tmp339="};";_tag_dyneither(_tmp339,sizeof(char),3);}));}return;_LL1CA: {
struct Cyc_Absyn_Let_d_struct*_tmp30D=(struct Cyc_Absyn_Let_d_struct*)_tmp2F8;if(
_tmp30D->tag != 2)goto _LL1CC;else{_tmp30E=_tmp30D->f1;_tmp30F=_tmp30D->f3;}}
_LL1CB: Cyc_Absyndump_dump(({const char*_tmp33A="let";_tag_dyneither(_tmp33A,
sizeof(char),4);}));Cyc_Absyndump_dumppat(_tmp30E);Cyc_Absyndump_dump_char((int)'=');
Cyc_Absyndump_dumpexp(_tmp30F);Cyc_Absyndump_dump_semi();goto _LL1BF;_LL1CC: {
struct Cyc_Absyn_Letv_d_struct*_tmp310=(struct Cyc_Absyn_Letv_d_struct*)_tmp2F8;
if(_tmp310->tag != 3)goto _LL1CE;else{_tmp311=_tmp310->f1;}}_LL1CD: Cyc_Absyndump_dump(({
const char*_tmp33B="let ";_tag_dyneither(_tmp33B,sizeof(char),5);}));Cyc_Absyndump_dumpids(
_tmp311);Cyc_Absyndump_dump_semi();goto _LL1BF;_LL1CE: {struct Cyc_Absyn_Region_d_struct*
_tmp312=(struct Cyc_Absyn_Region_d_struct*)_tmp2F8;if(_tmp312->tag != 4)goto _LL1D0;
else{_tmp313=_tmp312->f1;_tmp314=_tmp312->f2;_tmp315=_tmp312->f3;_tmp316=_tmp312->f4;}}
_LL1CF: Cyc_Absyndump_dump(({const char*_tmp33C="region";_tag_dyneither(_tmp33C,
sizeof(char),7);}));Cyc_Absyndump_dump(({const char*_tmp33D="<";_tag_dyneither(
_tmp33D,sizeof(char),2);}));Cyc_Absyndump_dumptvar(_tmp313);Cyc_Absyndump_dump(({
const char*_tmp33E="> ";_tag_dyneither(_tmp33E,sizeof(char),3);}));Cyc_Absyndump_dumpqvar(
_tmp314->name);if(_tmp315)Cyc_Absyndump_dump(({const char*_tmp33F="@resetable";
_tag_dyneither(_tmp33F,sizeof(char),11);}));if(_tmp316 != 0){Cyc_Absyndump_dump(({
const char*_tmp340=" = open(";_tag_dyneither(_tmp340,sizeof(char),9);}));Cyc_Absyndump_dumpexp((
struct Cyc_Absyn_Exp*)_tmp316);Cyc_Absyndump_dump(({const char*_tmp341=")";
_tag_dyneither(_tmp341,sizeof(char),2);}));}Cyc_Absyndump_dump_semi();goto _LL1BF;
_LL1D0: {struct Cyc_Absyn_Alias_d_struct*_tmp317=(struct Cyc_Absyn_Alias_d_struct*)
_tmp2F8;if(_tmp317->tag != 5)goto _LL1D2;else{_tmp318=_tmp317->f1;_tmp319=_tmp317->f2;
_tmp31A=_tmp317->f3;}}_LL1D1: Cyc_Absyndump_dump(({const char*_tmp342="alias ";
_tag_dyneither(_tmp342,sizeof(char),7);}));Cyc_Absyndump_dump(({const char*
_tmp343="<";_tag_dyneither(_tmp343,sizeof(char),2);}));Cyc_Absyndump_dumptvar(
_tmp319);Cyc_Absyndump_dump(({const char*_tmp344=">";_tag_dyneither(_tmp344,
sizeof(char),2);}));Cyc_Absyndump_dumpqvar(_tmp31A->name);Cyc_Absyndump_dump(({
const char*_tmp345=" = ";_tag_dyneither(_tmp345,sizeof(char),4);}));Cyc_Absyndump_dumpexp(
_tmp318);Cyc_Absyndump_dump_semi();goto _LL1BF;_LL1D2: {struct Cyc_Absyn_Typedef_d_struct*
_tmp31B=(struct Cyc_Absyn_Typedef_d_struct*)_tmp2F8;if(_tmp31B->tag != 9)goto
_LL1D4;else{_tmp31C=_tmp31B->f1;}}_LL1D3: if(!Cyc_Absyndump_expand_typedefs  || 
_tmp31C->defn != 0  && Cyc_Absynpp_is_anon_aggrtype((void*)((struct Cyc_Core_Opt*)
_check_null(_tmp31C->defn))->v)){Cyc_Absyndump_dump(({const char*_tmp346="typedef";
_tag_dyneither(_tmp346,sizeof(char),8);}));{void*t;if(_tmp31C->defn == 0)t=Cyc_Absyn_new_evar(
...
_LL1D5: Cyc_Absyndump_dump(({const char*_tmp347="namespace";_tag_dyneither(_tmp347,
sizeof(char),10);}));Cyc_Absyndump_dump_str(_tmp31E);Cyc_Absyndump_dump_char((
...
_LL1D7: Cyc_Absyndump_dump(({const char*_tmp348="using";_tag_dyneither(_tmp348,
sizeof(char),6);}));Cyc_Absyndump_dumpqvar(_tmp321);Cyc_Absyndump_dump_char((int)'{');
for(0;_tmp322 != 0;_tmp322=_tmp322->tl){Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)
_tmp322->hd);}Cyc_Absyndump_dump_char((int)'}');goto _LL1BF;_LL1D8: {struct Cyc_Absyn_ExternC_d_struct*
_tmp323=(struct Cyc_Absyn_ExternC_d_struct*)_tmp2F8;if(_tmp323->tag != 12)goto
_LL1DA;else{_tmp324=_tmp323->f1;}}_LL1D9: Cyc_Absyndump_dump(({const char*_tmp349="extern \"C\" {";
_tag_dyneither(_tmp349,sizeof(char),13);}));for(0;_tmp324 != 0;_tmp324=_tmp324->tl){
Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)_tmp324->hd);}Cyc_Absyndump_dump_char((
int)'}');goto _LL1BF;_LL1DA: {struct Cyc_Absyn_ExternCinclude_d_struct*_tmp325=(
struct Cyc_Absyn_ExternCinclude_d_struct*)_tmp2F8;if(_tmp325->tag != 13)goto _LL1DC;
else{_tmp326=_tmp325->f1;_tmp327=_tmp325->f2;}}_LL1DB: Cyc_Absyndump_dump(({const
char*_tmp34A="extern \"C include\" {";_tag_dyneither(_tmp34A,sizeof(char),21);}));
for(0;_tmp326 != 0;_tmp326=_tmp326->tl){Cyc_Absyndump_dumpdecl((struct Cyc_Absyn_Decl*)
_tmp326->hd);}Cyc_Absyndump_dump_char((int)'}');if(_tmp327 != 0){Cyc_Absyndump_dump(({
const char*_tmp34B=" export {";_tag_dyneither(_tmp34B,sizeof(char),10);}));for(0;
_tmp327 != 0;_tmp327=_tmp327->tl){struct _tuple0*_tmp34D;struct _tuple19 _tmp34C=*((
struct _tuple19*)_tmp327->hd);_tmp34D=_tmp34C.f2;Cyc_Absyndump_dumpqvar(_tmp34D);
if(_tmp327->tl != 0)Cyc_Absyndump_dump_char((int)',');}Cyc_Absyndump_dump(({const
char*_tmp34E="}";_tag_dyneither(_tmp34E,sizeof(char),2);}));}goto _LL1BF;_LL1DC: {
struct Cyc_Absyn_Porton_d_struct*_tmp328=(struct Cyc_Absyn_Porton_d_struct*)
_tmp2F8;if(_tmp328->tag != 14)goto _LL1DE;}_LL1DD: Cyc_Absyndump_dump(({const char*
_tmp34F=" __cyclone_port_on__; ";_tag_dyneither(_tmp34F,sizeof(char),23);}));
goto _LL1BF;_LL1DE: {struct Cyc_Absyn_Portoff_d_struct*_tmp329=(struct Cyc_Absyn_Portoff_d_struct*)
_tmp2F8;if(_tmp329->tag != 15)goto _LL1BF;}_LL1DF: Cyc_Absyndump_dump(({const char*
_tmp350=" __cyclone_port_off__; ";_tag_dyneither(_tmp350,sizeof(char),24);}));
goto _LL1BF;_LL1BF:;}static void Cyc_Absyndump_dump_upperbound(struct Cyc_Absyn_Exp*
...
_tmp351=(void*)tms->hd;struct Cyc_Absyn_PtrAtts _tmp353;void*_tmp354;union Cyc_Absyn_Constraint*
...
0,_tmp357))Cyc_Absyndump_dump(({const char*_tmp35D="@zeroterm";_tag_dyneither(
_tmp35D,sizeof(char),10);}));{void*_tmp35E=Cyc_Tcutil_compress(_tmp354);struct
Cyc_Absyn_Tvar*_tmp362;struct Cyc_Core_Opt*_tmp364;_LL1F6: {struct Cyc_Absyn_HeapRgn_struct*
_tmp35F=(struct Cyc_Absyn_HeapRgn_struct*)_tmp35E;if(_tmp35F->tag != 21)goto _LL1F8;}
_LL1F7: goto _LL1F5;_LL1F8: {struct Cyc_Absyn_UniqueRgn_struct*_tmp360=(struct Cyc_Absyn_UniqueRgn_struct*)
_tmp35E;if(_tmp360->tag != 22)goto _LL1FA;}_LL1F9: Cyc_Absyndump_dump(({const char*
_tmp365="`U";_tag_dyneither(_tmp365,sizeof(char),3);}));goto _LL1F5;_LL1FA: {
struct Cyc_Absyn_VarType_struct*_tmp361=(struct Cyc_Absyn_VarType_struct*)_tmp35E;
if(_tmp361->tag != 2)goto _LL1FC;else{_tmp362=_tmp361->f1;}}_LL1FB: Cyc_Absyndump_dump_str(
_tmp362->name);goto _LL1F5;_LL1FC: {struct Cyc_Absyn_Evar_struct*_tmp363=(struct
Cyc_Absyn_Evar_struct*)_tmp35E;if(_tmp363->tag != 1)goto _LL1FE;else{_tmp364=
_tmp363->f2;if(_tmp364 != 0)goto _LL1FE;}}_LL1FD: Cyc_Absyndump_dumpntyp(Cyc_Tcutil_compress(
_tmp354));goto _LL1F5;_LL1FE:;_LL1FF:({void*_tmp366=0;Cyc_Tcutil_impos(({const
char*_tmp367="dumptms: bad rgn type in Pointer_mod";_tag_dyneither(_tmp367,
sizeof(char),37);}),_tag_dyneither(_tmp366,sizeof(void*),0));});_LL1F5:;}Cyc_Absyndump_dumptq(
...
_tmp36A;if(_tmp36B->tag != 0)goto _LL208;else{_tmp36C=_tmp36B->f1;}}_LL207: Cyc_Absyndump_dump(({
const char*_tmp384="[]";_tag_dyneither(_tmp384,sizeof(char),3);}));if(((int(*)(
int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,_tmp36C))Cyc_Absyndump_dump(({
const char*_tmp385="@zeroterm";_tag_dyneither(_tmp385,sizeof(char),10);}));goto
_LL205;_LL208: {struct Cyc_Absyn_ConstArray_mod_struct*_tmp36D=(struct Cyc_Absyn_ConstArray_mod_struct*)
_tmp36A;if(_tmp36D->tag != 1)goto _LL20A;else{_tmp36E=_tmp36D->f1;_tmp36F=_tmp36D->f2;}}
_LL209: Cyc_Absyndump_dump_char((int)'[');Cyc_Absyndump_dumpexp(_tmp36E);Cyc_Absyndump_dump_char((
int)']');if(((int(*)(int y,union Cyc_Absyn_Constraint*x))Cyc_Absyn_conref_def)(0,
_tmp36F))Cyc_Absyndump_dump(({const char*_tmp386="@zeroterm";_tag_dyneither(
_tmp386,sizeof(char),10);}));goto _LL205;_LL20A: {struct Cyc_Absyn_Function_mod_struct*
...
_tmp37B=_tmp37A->f1;_tmp37C=_tmp37A->f2;}};}}_LL20D:((void(*)(void(*f)(struct
...
_tmp37B,({const char*_tmp387="(";_tag_dyneither(_tmp387,sizeof(char),2);}),({
const char*_tmp388=")";_tag_dyneither(_tmp388,sizeof(char),2);}),({const char*
_tmp389=",";_tag_dyneither(_tmp389,sizeof(char),2);}));goto _LL205;_LL20E: {
struct Cyc_Absyn_TypeParams_mod_struct*_tmp37D=(struct Cyc_Absyn_TypeParams_mod_struct*)
_tmp36A;if(_tmp37D->tag != 4)goto _LL210;else{_tmp37E=_tmp37D->f1;_tmp37F=_tmp37D->f2;
_tmp380=_tmp37D->f3;}}_LL20F: if(_tmp380)Cyc_Absyndump_dumpkindedtvars(_tmp37E);
else{Cyc_Absyndump_dumptvars(_tmp37E);}goto _LL205;_LL210: {struct Cyc_Absyn_Attributes_mod_struct*
_tmp381=(struct Cyc_Absyn_Attributes_mod_struct*)_tmp36A;if(_tmp381->tag != 5)goto
_LL212;else{_tmp382=_tmp381->f2;}}_LL211: Cyc_Absyndump_dumpatts(_tmp382);goto
_LL205;_LL212: {struct Cyc_Absyn_Pointer_mod_struct*_tmp383=(struct Cyc_Absyn_Pointer_mod_struct*)
_tmp36A;if(_tmp383->tag != 2)goto _LL205;}_LL213:({void*_tmp38A=0;Cyc_Tcutil_impos(({
const char*_tmp38B="dumptms";_tag_dyneither(_tmp38B,sizeof(char),8);}),
_tag_dyneither(_tmp38A,sizeof(void*),0));});_LL205:;}return;}_LL1EB:;};}void Cyc_Absyndump_dumptqtd(
...
struct Cyc_Absyn_Tqual _tmp38E;void*_tmp38F;struct Cyc_List_List*_tmp390;struct
_tuple11 _tmp38D=Cyc_Absynpp_to_tms(temp,tq,t);_tmp38E=_tmp38D.f1;_tmp38F=_tmp38D.f2;
_tmp390=_tmp38D.f3;Cyc_Absyndump_dumptq(_tmp38E);Cyc_Absyndump_dumpntyp(_tmp38F);
Cyc_Absyndump_dumptms(((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(
_tmp390),f,a);};_pop_region(temp);}void Cyc_Absyndump_dumpdecllist2file(struct Cyc_List_List*
...
void*_tmp391=0;Cyc_fprintf(f,({const char*_tmp392="\n";_tag_dyneither(_tmp392,
sizeof(char),2);}),_tag_dyneither(_tmp391,sizeof(void*),0));});}
