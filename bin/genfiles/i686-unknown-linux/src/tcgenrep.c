...
extern void*Cyc_Absyn_uchar_typ;extern void*Cyc_Absyn_uint_typ;void*Cyc_Absyn_const_string_typ(
...
_tmpA8));_tmpA8->f1=Cyc_Tcgenrep_tq_none;_tmpA8->f2=Cyc_Absyn_star_typ(Cyc_Absyn_uchar_typ,(
