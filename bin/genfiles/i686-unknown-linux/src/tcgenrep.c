...
x);extern void*Cyc_Absyn_uchar_typ;extern void*Cyc_Absyn_uint_typ;void*Cyc_Absyn_const_string_typ(
...
_tmp9E->f2=Cyc_Absyn_uint_typ;_tmp9E;});((struct Cyc_List_List*(*)(struct
...
_tmpA3->f2=Cyc_Absyn_uint_typ;_tmpA3;});((struct Cyc_List_List*(*)(struct
...
_tmpA8->f2=Cyc_Absyn_star_typ(Cyc_Absyn_uchar_typ,(void*)2,Cyc_Tcgenrep_tq_none);
...
sizeof(unsigned char),60),_tag_arr(_tmpCA,sizeof(void*),2));}}});{struct Cyc_List_List*
...
struct _tagged_arr)s);i ++){if(*((unsigned char*)_check_unknown_subscript(s,
sizeof(unsigned char),i))== ' ')*((unsigned char*)_check_unknown_subscript(s,
sizeof(unsigned char),i))='_';else{if(!isalnum((int)*((unsigned char*)
_check_unknown_subscript(s,sizeof(unsigned char),i)))?*((unsigned char*)
_check_unknown_subscript(s,sizeof(unsigned char),i))!= '_': 0)*((unsigned char*)
...
sizeof(unsigned char),5));}struct _tuple18{struct Cyc_Dict_Dict*f1;struct Cyc_Tcgenrep_RepInfo*
f2;};static struct _tuple18*Cyc_Tcgenrep_lookupRep(struct Cyc_Tcenv_Tenv*te,struct
Cyc_Dict_Dict*dict,struct Cyc_Position_Segment*loc,void*type);struct _tuple19{
struct Cyc_Dict_Dict*f1;struct Cyc_List_List*f2;};struct _tuple20{struct Cyc_Tcenv_Tenv*
f1;struct Cyc_Position_Segment*f2;};static struct _tuple19*Cyc_Tcgenrep_lookupRepsCls(
struct _tuple20*env,void*type,struct _tuple19*carry){struct _tuple18 _tmpDA;struct
Cyc_Dict_Dict*_tmpDB;struct Cyc_Tcgenrep_RepInfo*_tmpDC;struct _tuple18*_tmpD9=Cyc_Tcgenrep_lookupRep((*
env).f1,(*carry).f1,(*env).f2,type);_tmpDA=*_tmpD9;_tmpDB=_tmpDA.f1;_tmpDC=
_tmpDA.f2;return({struct _tuple19*_tmpDD=_cycalloc(sizeof(*_tmpDD));_tmpDD->f1=
_tmpDB;_tmpDD->f2=({struct Cyc_List_List*_tmpDE=_cycalloc(sizeof(*_tmpDE));_tmpDE->hd=
_tmpDC;_tmpDE->tl=(*carry).f2;_tmpDE;});_tmpDD;});}static struct Cyc_Dict_Dict*Cyc_Tcgenrep_buildRepTuple(
...
_tag_arr("name",sizeof(unsigned char),5));struct Cyc_Absyn_Decl*_tmp123=Cyc_Tcgenrep_gen_decl(
...
sizeof(unsigned char),5));struct Cyc_Absyn_Decl*_tmp155=Cyc_Tcgenrep_gen_decl(
_tmp154,Cyc_Absyn_const_string_typ((void*)2),(struct Cyc_Absyn_Exp*)Cyc_Tcgenrep_cnst_string(*(*(*
ename)).f2,loc),loc);_tmp152=({struct Cyc_List_List*_tmp156=_cycalloc(sizeof(*
_tmp156));_tmp156->hd=_tmp155;_tmp156->tl=_tmp152;_tmp156;});name=Cyc_Absyn_address_exp(
Cyc_Absyn_unknownid_exp(Cyc_Tcgenrep_toplevel_name(_tmp154),loc),loc);}{struct
Cyc_Absyn_Decl*_tmp157=Cyc_Tcgenrep_tunion_constructor_decl(Cyc_Tcgenrep_typerep_name(&
Cyc_Tcgenrep_typestruct_str),Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_enum_str),
varname,({struct Cyc_Absyn_Exp*_tmp159[3];_tmp159[2]=_tmp153;_tmp159[1]=_tmp148;
_tmp159[0]=name;((struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(
_tag_arr(_tmp159,sizeof(struct Cyc_Absyn_Exp*),3));}),sc,loc);return Cyc_Tcgenrep_update_info(
dict,type,((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))
Cyc_List_imp_append)(_tmp152,({struct Cyc_Absyn_Decl*_tmp158[1];_tmp158[0]=
_tmp157;((struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(_tag_arr(
_tmp158,sizeof(struct Cyc_Absyn_Decl*),1));})),(struct Cyc_Absyn_Exp*)Cyc_Absyn_address_exp(
...
struct _tuple11*),struct Cyc_Position_Segment*env,struct Cyc_List_List*x))Cyc_List_map_c)(
Cyc_Tcgenrep_tuple2_exp_cls,loc,_tmp18B);void*name_type=Cyc_Absyn_tagged_typ(Cyc_Absyn_uchar_typ,(
...
sizeof(unsigned char),4)));struct Cyc_Absyn_Decl*_tmp1BB=Cyc_Tcgenrep_tunion_constructor_decl(
Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_typestruct_str),Cyc_Tcgenrep_typerep_name(&
...
_tag_arr("rep",sizeof(unsigned char),4)));struct Cyc_Core_Opt*_tmp1C1=({struct Cyc_Core_Opt*
...
_tag_arr("rep",sizeof(unsigned char),4)));struct Cyc_Core_Opt*_tmp1CC=({struct Cyc_Core_Opt*
...
sizeof(unsigned char),55),_tag_arr(_tmp1D6,sizeof(void*),0));});{struct _tuple18
_tmp1D8;struct Cyc_Dict_Dict*_tmp1D9;struct Cyc_Tcgenrep_RepInfo*_tmp1DA;struct
_tuple18*_tmp1D7=Cyc_Tcgenrep_lookupRep(te,dict,loc,_tmp1A0);_tmp1D8=*_tmp1D7;
_tmp1D9=_tmp1D8.f1;_tmp1DA=_tmp1D8.f2;dict=_tmp1D9;{unsigned int bound=Cyc_Evexp_eval_const_uint_exp((
...
_tag_arr("rep",sizeof(unsigned char),4)));struct Cyc_Core_Opt*_tmp1E1=({struct Cyc_Core_Opt*
...
sizeof(unsigned char),38),_tag_arr(_tmp1E4,sizeof(void*),0));});{struct _tuple18
_tmp1E6;struct Cyc_Dict_Dict*_tmp1E7;struct Cyc_Tcgenrep_RepInfo*_tmp1E8;struct
_tuple18*_tmp1E5=Cyc_Tcgenrep_lookupRep(te,dict,loc,(void*)_tmp1A7->v);_tmp1E6=*
_tmp1E5;_tmp1E7=_tmp1E6.f1;_tmp1E8=_tmp1E6.f2;dict=((struct Cyc_Dict_Dict*(*)(
struct Cyc_Dict_Dict*d,void*k,struct Cyc_Tcgenrep_RepInfo*v))Cyc_Dict_insert)(
_tmp1E7,type,_tmp1E8);goto _LL15;}_LL24: if((int)_tmp19B != 0)goto _LL26;_LL25:({
void*_tmp1E9[0]={};Cyc_Tcutil_terr(loc,_tag_arr("found void in gen() expression",
sizeof(unsigned char),31),_tag_arr(_tmp1E9,sizeof(void*),0));});goto _LL15;_LL26:
if(_tmp19B <= (void*)3?1:*((int*)_tmp19B)!= 0)goto _LL28;_LL27:({void*_tmp1EA[0]={};
Cyc_Tcutil_terr(loc,_tag_arr("found evar in gen() expression",sizeof(
unsigned char),31),_tag_arr(_tmp1EA,sizeof(void*),0));});goto _LL15;_LL28: if(
...
sizeof(unsigned char),32),_tag_arr(_tmp1EB,sizeof(void*),0));});goto _LL15;({void*
_tmp1EC[0]={};Cyc_Tcutil_terr(loc,_tag_arr("found variable type in gen() expression",
sizeof(unsigned char),40),_tag_arr(_tmp1EC,sizeof(void*),0));});goto _LL15;_LL2A:
if(_tmp19B <= (void*)3?1:*((int*)_tmp19B)!= 8)goto _LL2C;_tmp1A9=((struct Cyc_Absyn_FnType_struct*)
_tmp19B)->f1;_LL2B:({void*_tmp1ED[0]={};Cyc_Tcutil_terr(loc,_tag_arr("found function type in gen() expression",
sizeof(unsigned char),40),_tag_arr(_tmp1ED,sizeof(void*),0));});goto _LL15;_LL2C:
if(_tmp19B <= (void*)3?1:*((int*)_tmp19B)!= 15)goto _LL2E;_LL2D: goto _LL2F;_LL2E:
if((int)_tmp19B != 2)goto _LL30;_LL2F: goto _LL31;_LL30: if(_tmp19B <= (void*)3?1:*((
int*)_tmp19B)!= 19)goto _LL32;_LL31: goto _LL33;_LL32: if(_tmp19B <= (void*)3?1:*((
int*)_tmp19B)!= 20)goto _LL34;_LL33: goto _LL35;_LL34: if(_tmp19B <= (void*)3?1:*((
int*)_tmp19B)!= 21)goto _LL36;_LL35:({void*_tmp1EE[0]={};Cyc_Tcutil_terr(loc,
_tag_arr("gen(): unhandled region, handle or effect type",sizeof(unsigned char),
47),_tag_arr(_tmp1EE,sizeof(void*),0));});goto _LL15;_LL36: if(_tmp19B <= (void*)3?
1:*((int*)_tmp19B)!= 2)goto _LL38;_tmp1AA=((struct Cyc_Absyn_TunionType_struct*)
...
sizeof(unsigned char),38),_tag_arr(_tmp204,sizeof(void*),0));});_LL3A: if(_tmp19B
<= (void*)3?1:*((int*)_tmp19B)!= 3)goto _LL3C;_tmp1B0=((struct Cyc_Absyn_TunionFieldType_struct*)
...
void*)_tmp1B0.field_info;struct Cyc_Absyn_Tuniondecl*_tmp207;struct Cyc_Absyn_Tunionfield*
...
_tmp207->name,_tmp208->name,te,dict,loc,_tmp20B,(void*)0,type,_tmp20A);goto _LL51;}
_LL54:;_LL55:({void*_tmp20D[0]={};((int(*)(struct _tagged_arr fmt,struct
_tagged_arr ap))Cyc_Tcutil_impos)(_tag_arr("gen(): tunionfield must be known at this point",
sizeof(unsigned char),47),_tag_arr(_tmp20D,sizeof(void*),0));});_LL51:;}goto
_LL15;_LL3C: if(_tmp19B <= (void*)3?1:*((int*)_tmp19B)!= 10)goto _LL3E;_tmp1B1=((
struct Cyc_Absyn_AggrType_struct*)_tmp19B)->f1;_tmp1B2=(void*)_tmp1B1.aggr_info;
_tmp1B3=_tmp1B1.targs;_LL3D: {struct Cyc_Absyn_Aggrdecl*_tmp20E=Cyc_Absyn_get_known_aggrdecl(
_tmp1B2);if(_tmp20E->impl != 0?((struct Cyc_Absyn_AggrdeclImpl*)_check_null(
_tmp20E->impl))->exist_vars != 0: 0)({void*_tmp20F[0]={};((int(*)(struct
_tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(_tag_arr("gen(): existential type variables not yet supported",
sizeof(unsigned char),52),_tag_arr(_tmp20F,sizeof(void*),0));});if((void*)
_tmp20E->kind == (void*)0){struct Cyc_Absyn_Aggrdecl*_tmp210=_tmp20E;if(_tmp210->impl
== 0){struct _tuple6*_tmp211=Cyc_Tcgenrep_toplevel_name(({struct _tagged_arr*
_tmp214=_cycalloc(sizeof(*_tmp214));_tmp214[0]=Cyc_Tcgenrep_make_type_cstring(
type);_tmp214;}));struct Cyc_Core_Opt*_tmp212=({struct Cyc_Core_Opt*_tmp213=
_cycalloc(sizeof(*_tmp213));_tmp213->v=Cyc_Tcgenrep_gen_vardecl(_tmp211,Cyc_Tcgenrep_tunionfield_typ(
Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_typestruct_str),Cyc_Tcgenrep_typerep_name(&
...
_tmp218->f1=Cyc_Tcgenrep_tq_none;_tmp218->f2=Cyc_Absyn_uchar_typ;_tmp218;});
...
sizeof(unsigned char),46),_tag_arr(_tmp226,sizeof(void*),0));});if(_tmp225->impl
== 0){struct _tuple6*_tmp227=Cyc_Tcgenrep_toplevel_name(({struct _tagged_arr*
_tmp22A=_cycalloc(sizeof(*_tmp22A));_tmp22A[0]=Cyc_Tcgenrep_make_type_cstring(
...
_tmp236;_tmp236.tag=7;_tmp236.f1=(void*)Cyc_Absyn_uchar_typ;_tmp236.f2=Cyc_Tcgenrep_tq_none;
...
sizeof(unsigned char),47),_tag_arr(_tmp23B,sizeof(void*),0));});{struct Cyc_Absyn_Enumdecl
...
sizeof(unsigned char),40),_tag_arr(_tmp246,sizeof(void*),0));});_LL48: if(_tmp19B
<= (void*)3?1:*((int*)_tmp19B)!= 18)goto _LL4A;_LL49:({void*_tmp247[0]={};((int(*)(
struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(_tag_arr("gen() for `i not yet supported",
sizeof(unsigned char),31),_tag_arr(_tmp247,sizeof(void*),0));});_LL4A: if(_tmp19B
<= (void*)3?1:*((int*)_tmp19B)!= 17)goto _LL15;_LL4B:({void*_tmp248[0]={};((int(*)(
struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(_tag_arr("gen() for tag_t<-> not yet supported",
sizeof(unsigned char),37),_tag_arr(_tmp248,sizeof(void*),0));});_LL15:;}return({
struct _tuple18*_tmp249=_cycalloc(sizeof(*_tmp249));_tmp249->f1=dict;_tmp249->f2=((
