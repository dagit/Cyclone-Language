...
4];}__value;}Cyc___mbstate_t;typedef struct{int __pos;Cyc___mbstate_t __state;}Cyc__G_fpos_t;
...
void*);unsigned int Cyc_strlen(struct _tagged_arr s);int Cyc_strcmp(struct
_tagged_arr s1,struct _tagged_arr s2);struct _tagged_arr Cyc_strconcat(struct
_tagged_arr,struct _tagged_arr);struct _tagged_arr Cyc_strdup(struct _tagged_arr src);
...
key);struct Cyc_Lineno_Pos{struct _tagged_arr logical_file;struct _tagged_arr line;
...
void*rep);struct Cyc_timespec{int tv_sec;int tv_nsec;};struct Cyc_tm{int tm_sec;int
tm_min;int tm_hour;int tm_mday;int tm_mon;int tm_year;int tm_wday;int tm_yday;int
tm_isdst;int tm_gmtoff;const char*tm_zone;};struct Cyc_itimerspec{struct Cyc_timespec
...
tag;struct _tuple6*f1;struct Cyc_List_List*f2;};struct Cyc_Absyn_ExternC_d_struct{
...
1;_tmp4.f1=(unsigned int)info->emitted;{struct Cyc_Int_pa_struct _tmp3;_tmp3.tag=1;
_tmp3.f1=(unsigned int)info;{struct Cyc_String_pa_struct _tmp2;_tmp2.tag=0;_tmp2.f1=(
struct _tagged_arr)((struct _tagged_arr)Cyc_Absynpp_typ2string(type));{void*_tmp0[
3]={& _tmp2,& _tmp3,& _tmp4};Cyc_printf(({const char*_tmp1="(%s,%x:%d,";_tag_arr(
_tmp1,sizeof(char),_get_zero_arr_size(_tmp1,11));}),_tag_arr(_tmp0,sizeof(void*),
3));}}}});{struct Cyc_List_List*p=info->dependencies;for(0;p != 0;p=p->tl){({
struct Cyc_Int_pa_struct _tmp7;_tmp7.tag=1;_tmp7.f1=(unsigned int)((struct Cyc_Tcgenrep_RepInfo*)
p->hd);{void*_tmp5[1]={& _tmp7};Cyc_printf(({const char*_tmp6="%x";_tag_arr(_tmp6,
sizeof(char),_get_zero_arr_size(_tmp6,3));}),_tag_arr(_tmp5,sizeof(void*),1));}});
if(p->tl != 0)({void*_tmp8[0]={};Cyc_printf(({const char*_tmp9=",";_tag_arr(_tmp9,
sizeof(char),_get_zero_arr_size(_tmp9,2));}),_tag_arr(_tmp8,sizeof(void*),0));});}}({
void*_tmpA[0]={};Cyc_printf(({const char*_tmpB=")\n";_tag_arr(_tmpB,sizeof(char),
_get_zero_arr_size(_tmpB,3));}),_tag_arr(_tmpA,sizeof(void*),0));});}void Cyc_Tcgenrep_print_typerep_dict(
...
td->fields == 0)({void*_tmpC[0]={};((int(*)(struct _tagged_arr fmt,struct
_tagged_arr ap))Cyc_Tcutil_impos)(({const char*_tmpD="Could not find field in tuniondecl";
_tag_arr(_tmpD,sizeof(char),_get_zero_arr_size(_tmpD,35));}),_tag_arr(_tmpC,
sizeof(void*),0));});else{struct Cyc_List_List*l=(struct Cyc_List_List*)((struct
Cyc_Core_Opt*)_check_null(td->fields))->v;for(0;l != 0;l=l->tl){if(!Cyc_Absyn_qvar_cmp(((
struct Cyc_Absyn_Tunionfield*)l->hd)->name,fieldname))return(struct Cyc_Absyn_Tunionfield*)
l->hd;}}({void*_tmpE[0]={};((int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))
Cyc_Tcutil_impos)(({const char*_tmpF="Could not find field in tuniondecl";
...
struct Cyc_Int_pa_struct _tmp32;_tmp32.tag=1;_tmp32.f1=(unsigned int)Cyc_Tcgenrep_gen_id_counter
++;{struct Cyc_String_pa_struct _tmp31;_tmp31.tag=0;_tmp31.f1=(struct _tagged_arr)((
struct _tagged_arr)name);{void*_tmp2F[2]={& _tmp31,& _tmp32};Cyc_aprintf(({const
char*_tmp30="_gen%s_%d";_tag_arr(_tmp30,sizeof(char),_get_zero_arr_size(_tmp30,
10));}),_tag_arr(_tmp2F,sizeof(void*),2));}}});_tmp2E;});}static void Cyc_Tcgenrep_print_params(
struct Cyc_List_List*l){({void*_tmp33[0]={};Cyc_printf(({const char*_tmp34="<";
_tag_arr(_tmp34,sizeof(char),_get_zero_arr_size(_tmp34,2));}),_tag_arr(_tmp33,
sizeof(void*),0));});{struct Cyc_List_List*p=l;for(0;p != 0;p=p->tl){({struct Cyc_Int_pa_struct
_tmp38;_tmp38.tag=1;_tmp38.f1=(unsigned int)((int)(p->tl != 0?',':' '));{struct
Cyc_String_pa_struct _tmp37;_tmp37.tag=0;_tmp37.f1=(struct _tagged_arr)((struct
_tagged_arr)Cyc_Absynpp_typ2string((void*)p->hd));{void*_tmp35[2]={& _tmp37,&
_tmp38};Cyc_printf(({const char*_tmp36="%s%c";_tag_arr(_tmp36,sizeof(char),
_get_zero_arr_size(_tmp36,5));}),_tag_arr(_tmp35,sizeof(void*),2));}}});}}({void*
_tmp39[0]={};Cyc_printf(({const char*_tmp3A=">\n";_tag_arr(_tmp3A,sizeof(char),
_get_zero_arr_size(_tmp3A,3));}),_tag_arr(_tmp39,sizeof(void*),0));});}static
void Cyc_Tcgenrep_print_tvars(struct Cyc_List_List*l){({void*_tmp3B[0]={};Cyc_printf(({
const char*_tmp3C="<";_tag_arr(_tmp3C,sizeof(char),_get_zero_arr_size(_tmp3C,2));}),
_tag_arr(_tmp3B,sizeof(void*),0));});{struct Cyc_List_List*p=l;for(0;p != 0;p=p->tl){({
struct Cyc_Int_pa_struct _tmp40;_tmp40.tag=1;_tmp40.f1=(unsigned int)((int)(p->tl
!= 0?',':' '));{struct Cyc_String_pa_struct _tmp3F;_tmp3F.tag=0;_tmp3F.f1=(struct
_tagged_arr)((struct _tagged_arr)*((struct Cyc_Absyn_Tvar*)p->hd)->name);{void*
_tmp3D[2]={& _tmp3F,& _tmp40};Cyc_printf(({const char*_tmp3E="%s%c";_tag_arr(_tmp3E,
sizeof(char),_get_zero_arr_size(_tmp3E,5));}),_tag_arr(_tmp3D,sizeof(void*),2));}}});}}({
void*_tmp41[0]={};Cyc_printf(({const char*_tmp42=">\n";_tag_arr(_tmp42,sizeof(
char),_get_zero_arr_size(_tmp42,3));}),_tag_arr(_tmp41,sizeof(void*),0));});}
...
int)_tmp56 != 2)goto _LLC;_LLB: return 32;_LLC: if((int)_tmp56 != 3)goto _LL5;_LLD:
return 64;_LL5:;}static void*Cyc_Tcgenrep_tunion_typ(struct _tuple6*name){return(
void*)({struct Cyc_Absyn_TunionType_struct*_tmp57=_cycalloc(sizeof(*_tmp57));
_tmp57[0]=({struct Cyc_Absyn_TunionType_struct _tmp58;_tmp58.tag=2;_tmp58.f1=({
struct Cyc_Absyn_TunionInfo _tmp59;_tmp59.tunion_info=(void*)((void*)({struct Cyc_Absyn_UnknownTunion_struct*
_tmp5A=_cycalloc(sizeof(*_tmp5A));_tmp5A[0]=({struct Cyc_Absyn_UnknownTunion_struct
_tmp5B;_tmp5B.tag=0;_tmp5B.f1=({struct Cyc_Absyn_UnknownTunionInfo _tmp5C;_tmp5C.name=
name;_tmp5C.is_xtunion=0;_tmp5C;});_tmp5B;});_tmp5A;}));_tmp59.targs=0;_tmp59.rgn=(
void*)((void*)2);_tmp59;});_tmp58;});_tmp57;});}static void*Cyc_Tcgenrep_tunionfield_typ(
...
static char _tmp66[5]="list";static struct _tagged_arr Cyc_Tcgenrep_list_str={_tmp66,
_tmp66,_tmp66 + 5};static char _tmp67[5]="List";static struct _tagged_arr Cyc_Tcgenrep_List_str={
...
e){return({struct _tuple11*_tmp7A=_cycalloc(sizeof(*_tmp7A));_tmp7A->f1=Cyc_Tcgenrep_new_gen_id(({
...
struct Cyc_Absyn_Aggrfield*sf){if(Cyc_strcmp((struct _tagged_arr)*sf->name,({const
char*_tmp8B="";_tag_arr(_tmp8B,sizeof(char),_get_zero_arr_size(_tmp8B,1));}))== 
...
sf){if(Cyc_strcmp((struct _tagged_arr)*sf->name,({const char*_tmp90="";_tag_arr(
_tmp90,sizeof(char),_get_zero_arr_size(_tmp90,1));}))== 0)({void*_tmp91[0]={};((
int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(({const char*
_tmp92="gen(): anonymous (padding) structfield not handled yet";_tag_arr(_tmp92,
sizeof(char),_get_zero_arr_size(_tmp92,55));}),_tag_arr(_tmp91,sizeof(void*),0));});
if(Cyc_Tcgenrep_has_bitfield(sf))({void*_tmp93[0]={};((int(*)(struct _tagged_arr
fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(({const char*_tmp94="gen(): mixed struct bitfields and union bitfields not handled";
...
if(_tmp9D != 0){({struct Cyc_String_pa_struct _tmpA0;_tmpA0.tag=0;_tmpA0.f1=(struct
_tagged_arr)((struct _tagged_arr)Cyc_Absynpp_typ2string(type));{void*_tmp9E[1]={&
_tmpA0};((int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(({
const char*_tmp9F="Repinfo for fwd declaration of %s already exists";_tag_arr(
_tmp9F,sizeof(char),_get_zero_arr_size(_tmp9F,49));}),_tag_arr(_tmp9E,sizeof(
void*),1));}});return dict;}else{return((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*
...
_tuple10*_tmpA2=_cycalloc(sizeof(*_tmpA2));_tmpA2->f1=*((struct Cyc_Absyn_Tqual*)
_check_null(tq));_tmpA2->f2=type;_tmpA2;});}static void*Cyc_Tcgenrep_tuple_typ(
struct Cyc_List_List*types){struct Cyc_List_List*_tmpA3=((struct Cyc_List_List*(*)(
...
struct Cyc_Absyn_TupleType_struct*_tmpA4=_cycalloc(sizeof(*_tmpA4));_tmpA4[0]=({
struct Cyc_Absyn_TupleType_struct _tmpA5;_tmpA5.tag=9;_tmpA5.f1=_tmpA3;_tmpA5;});
_tmpA4;});void*tuple_type=(void*)tuple_type_base;return tuple_type;}static struct
_tuple15*Cyc_Tcgenrep_array_decls(void*type,struct Cyc_List_List*exps,struct Cyc_Position_Segment*
loc){struct Cyc_List_List*_tmpA6=((struct Cyc_List_List*(*)(struct _tuple11*(*f)(
struct Cyc_Absyn_Exp*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcgenrep_gen_id_for_exp,
exps);struct Cyc_List_List*_tmpA7=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Decl*(*
f)(struct _tuple14*,struct _tuple11*),struct _tuple14*env,struct Cyc_List_List*x))
Cyc_List_map_c)(Cyc_Tcgenrep_gen_decl_cls,({struct _tuple14*_tmpB5=_cycalloc(
sizeof(*_tmpB5));_tmpB5->f1=type;_tmpB5->f2=loc;_tmpB5;}),_tmpA6);struct Cyc_List_List*
_tmpA8=((struct Cyc_List_List*(*)(struct _tagged_arr*(*f)(struct _tuple11*),struct
Cyc_List_List*x))Cyc_List_map)(Cyc_Tcgenrep_get_first,_tmpA6);struct Cyc_List_List*
_tmpA9=((struct Cyc_List_List*(*)(struct _tuple6*(*f)(struct _tagged_arr*),struct
Cyc_List_List*x))Cyc_List_map)(Cyc_Tcgenrep_toplevel_name,_tmpA8);struct Cyc_List_List*
_tmpAA=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*f)(struct Cyc_Position_Segment*,
struct _tuple6*),struct Cyc_Position_Segment*env,struct Cyc_List_List*x))Cyc_List_map_c)(
Cyc_Tcgenrep_unknownid_exp_cls,loc,_tmpA9);struct Cyc_List_List*_tmpAB=((struct
Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*f)(struct Cyc_Position_Segment*,struct Cyc_Absyn_Exp*),
struct Cyc_Position_Segment*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcgenrep_address_exp_cls,
loc,_tmpAA);struct Cyc_Absyn_Exp*_tmpAC=Cyc_Tcgenrep_arr_init_exp(_tmpAB,loc);
struct _tagged_arr*_tmpAD=Cyc_Tcgenrep_new_gen_id(({const char*_tmpB4="arr";
_tag_arr(_tmpB4,sizeof(char),_get_zero_arr_size(_tmpB4,4));}));void*_tmpAE=Cyc_Absyn_at_typ(
type,(void*)2,Cyc_Tcgenrep_tq_none,Cyc_Absyn_false_conref);void*_tmpAF=Cyc_Absyn_array_typ(
_tmpAE,Cyc_Tcgenrep_tq_none,0,Cyc_Absyn_false_conref,0);struct Cyc_Absyn_Decl*
...
Cyc_Absyn_true_conref);_tmpC3;});((struct Cyc_List_List*(*)(struct _tagged_arr))
Cyc_List_list)(_tag_arr(_tmpC2,sizeof(struct _tuple10*),1));}),tuf->typs);_tmpC1;});
_tmpC0;});_tmpBF;});}static int Cyc_Tcgenrep_filter_empty_tunionfield(struct Cyc_Absyn_Tunionfield*
tuf){return tuf->typs != 0;}static int Cyc_Tcgenrep_filter_nonempty_tunionfield(
...
subst,struct Cyc_Absyn_Aggrfield*sf){return({struct Cyc_Absyn_Aggrfield*_tmpC4=
_cycalloc(sizeof(*_tmpC4));_tmpC4->name=sf->name;_tmpC4->tq=sf->tq;_tmpC4->type=(
...
_tmpD3;void*_tmpD4;_LLF: if(_tmpCB <= (void*)4  || *((int*)_tmpCB)!= 10)goto _LL11;
...
_tmpDA;_tmpDA.tag=1;_tmpDA.f1=(unsigned int)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmpD6);{struct Cyc_Int_pa_struct _tmpD9;_tmpD9.tag=1;_tmpD9.f1=(unsigned int)Cyc_List_length(
_tmpCE);{void*_tmpD7[2]={& _tmpD9,& _tmpDA};((int(*)(struct _tagged_arr fmt,struct
_tagged_arr ap))Cyc_Tcutil_impos)(({const char*_tmpD8="gen(): number of params %d differs from number of tyvars %d";
_tag_arr(_tmpD8,sizeof(char),_get_zero_arr_size(_tmpD8,60));}),_tag_arr(_tmpD7,
sizeof(void*),2));}}});{struct Cyc_List_List*_tmpDB=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_zip)(_tmpD6,_tmpCE);struct
Cyc_List_List*fields=0;if(_tmpD5->impl != 0)fields=((struct Cyc_List_List*(*)(
struct Cyc_Absyn_Aggrfield*(*f)(struct Cyc_List_List*,struct Cyc_Absyn_Aggrfield*),
...
_tmpCB <= (void*)4  || *((int*)_tmpCB)!= 2)goto _LL13;_tmpCF=((struct Cyc_Absyn_TunionType_struct*)
...
_tmpE5))({struct Cyc_Int_pa_struct _tmpE9;_tmpE9.tag=1;_tmpE9.f1=(unsigned int)((
int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmpE5);{struct Cyc_Int_pa_struct
_tmpE8;_tmpE8.tag=1;_tmpE8.f1=(unsigned int)Cyc_List_length(_tmpD3);{void*_tmpE6[
2]={& _tmpE8,& _tmpE9};((int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(({
const char*_tmpE7="gen(): number of params %d differs from number of tyvars %d";
...
void*t){struct _tagged_arr s=Cyc_strdup((struct _tagged_arr)Cyc_Absynpp_typ2cstring(
t));{int i=0;for(0;i < Cyc_strlen((struct _tagged_arr)s);i ++){if(*((char*)
...
_tmpF6,sizeof(char),0));char _tmpF8='_';if(_get_arr_size(_tmpF6,sizeof(char))== 1
 && (_tmpF7 == '\000'  && _tmpF8 != '\000'))_throw_arraybounds();*((char*)_tmpF6.curr)=
_tmpF8;});else{if(!isalnum((int)*((char*)_check_unknown_subscript(s,sizeof(char),
i))) && *((char*)_check_unknown_subscript(s,sizeof(char),i))!= '_')({struct
...
char))== 1  && (_tmpFA == '\000'  && _tmpFB != '\000'))_throw_arraybounds();*((char*)
_tmpF9.curr)=_tmpFB;});}}}return(struct _tagged_arr)Cyc_strconcat((struct
...
Cyc_Tcgenrep_lookupRep((*env).f1,(*carry).f1,(*env).f2,type);_tmpFE=*_tmpFD;
_tmpFF=_tmpFE.f1;_tmp100=_tmpFE.f2;return({struct _tuple20*_tmp101=_cycalloc(
sizeof(*_tmp101));_tmp101->f1=_tmpFF;_tmp101->f2=({struct Cyc_List_List*_tmp102=
_cycalloc(sizeof(*_tmp102));_tmp102->hd=_tmp100;_tmp102->tl=(*carry).f2;_tmp102;});
_tmp101;});}static struct Cyc_Dict_Dict*Cyc_Tcgenrep_buildRepTuple(struct Cyc_Tcenv_Tenv*
te,struct Cyc_Dict_Dict*dict,struct Cyc_Position_Segment*loc,struct _tuple6*varname,
void*sc,void*type,struct Cyc_List_List*types){struct Cyc_Absyn_Exp*_tmp103=Cyc_Absyn_sizeoftyp_exp(
...
struct Cyc_Absyn_Exp*_tmp125=Cyc_Tcgenrep_cnst_string(*(*tname).f2,loc);struct Cyc_Absyn_Exp*
_tmp126=Cyc_Tcgenrep_cnst_string(*(*fname).f2,loc);struct _tuple15 _tmp128;struct
Cyc_List_List*_tmp129;struct Cyc_Absyn_Exp*_tmp12A;struct _tuple15*_tmp127=Cyc_Tcgenrep_array_decls(
tuple_type,_tmp124,loc);_tmp128=*_tmp127;_tmp129=_tmp128.f1;_tmp12A=_tmp128.f2;{
struct Cyc_Absyn_Decl*_tmp12B=Cyc_Tcgenrep_tunion_constructor_decl(Cyc_Tcgenrep_typerep_name(&
Cyc_Tcgenrep_typestruct_str),Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_tunionfield_str),
varname,({struct Cyc_Absyn_Exp*_tmp12E[4];_tmp12E[3]=_tmp12A;_tmp12E[2]=_tmp11A;
_tmp12E[1]=_tmp126;_tmp12E[0]=_tmp125;((struct Cyc_List_List*(*)(struct
_tagged_arr))Cyc_List_list)(_tag_arr(_tmp12E,sizeof(struct Cyc_Absyn_Exp*),4));}),
sc,loc);struct Cyc_List_List*_tmp12C=((struct Cyc_List_List*(*)(struct Cyc_List_List*
...
_tmp14D[0]=name;((struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(
_tag_arr(_tmp14D,sizeof(struct Cyc_Absyn_Exp*),3));}),sc,loc);struct Cyc_List_List*
...
_tmp14A;((struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(_tag_arr(
_tmp14C,sizeof(struct Cyc_Absyn_Decl*),1));}));return Cyc_Tcgenrep_update_info(
...
struct _tuple6*)uname->v)).f2,loc),loc);_tmp162=({struct Cyc_List_List*_tmp166=
_cycalloc(sizeof(*_tmp166));_tmp166->hd=_tmp165;_tmp166->tl=_tmp162;_tmp166;});
name=Cyc_Absyn_address_exp(Cyc_Absyn_unknownid_exp(Cyc_Tcgenrep_toplevel_name(
_tmp164),loc),loc);}{struct Cyc_Absyn_Decl*_tmp168=Cyc_Tcgenrep_tunion_constructor_decl(
Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_typestruct_str),Cyc_Tcgenrep_typerep_name(&
...
struct Cyc_Absyn_Exp*)Cyc_Tcgenrep_cnst_string(*(*(*ename)).f2,loc),loc);_tmp178=({
struct Cyc_List_List*_tmp17C=_cycalloc(sizeof(*_tmp17C));_tmp17C->hd=_tmp17B;
_tmp17C->tl=_tmp178;_tmp17C;});name=Cyc_Absyn_address_exp(Cyc_Absyn_unknownid_exp(
...
_tmp19F=Cyc_Tcgenrep_cnst_string(*(*tname).f2,loc);struct Cyc_Absyn_Decl*_tmp1A0=
...
struct _tagged_arr))Cyc_List_list)(_tag_arr(_tmp1A2,sizeof(struct Cyc_Absyn_Exp*),
...
struct _tagged_arr))Cyc_List_list)(_tag_arr(_tmp1A1,sizeof(struct Cyc_Absyn_Decl*),
1));}))),(struct Cyc_Absyn_Exp*)Cyc_Absyn_address_exp(Cyc_Absyn_unknownid_exp(
...
void*)2,({struct Cyc_Absyn_Tqual _tmp1BD;_tmp1BD.print_const=1;_tmp1BD.q_volatile=
0;_tmp1BD.q_restrict=0;_tmp1BD.real_const=1;_tmp1BD.loc=0;_tmp1BD;}),Cyc_Absyn_true_conref);
void*tuple_type=Cyc_Tcgenrep_tuple_typ(({void*_tmp1BC[2];_tmp1BC[1]=Cyc_Tcgenrep_tunion_typ(
Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_typestruct_str));_tmp1BC[0]=name_type;
Cyc_List_list(_tag_arr(_tmp1BC,sizeof(void*),2));}));struct _tuple15 _tmp1B5;
struct Cyc_List_List*_tmp1B6;struct Cyc_Absyn_Exp*_tmp1B7;struct _tuple15*_tmp1B4=
Cyc_Tcgenrep_array_decls(tuple_type,_tmp1B3,loc);_tmp1B5=*_tmp1B4;_tmp1B6=
_tmp1B5.f1;_tmp1B7=_tmp1B5.f2;{struct Cyc_Absyn_Exp*_tmp1B8=Cyc_Tcgenrep_cnst_string(*(*
...
struct Cyc_List_List*_tmp1CE;struct Cyc_Absyn_Typedefdecl*_tmp1CF;void**_tmp1D0;
struct Cyc_Absyn_Tvar*_tmp1D1;struct Cyc_Absyn_FnInfo _tmp1D2;struct Cyc_Absyn_TunionInfo
...
_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 5)goto _LL18;_tmp1C3=(void*)((struct Cyc_Absyn_IntType_struct*)
...
_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 6)goto _LL1C;_tmp1C5=((struct Cyc_Absyn_DoubleType_struct*)
...
0,0);goto _LL15;_LL1C: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 4)goto _LL1E;
_tmp1C6=((struct Cyc_Absyn_PointerType_struct*)_tmp1C2)->f1;_LL1D:{void*_tmp1E8=
Cyc_Absyn_conref_val((_tmp1C6.ptr_atts).bounds);struct Cyc_Absyn_Exp*_tmp1E9;
_LL4F: if(_tmp1E8 <= (void*)1  || *((int*)_tmp1E8)!= 0)goto _LL51;_tmp1E9=((struct
Cyc_Absyn_Upper_b_struct*)_tmp1E8)->f1;_LL50: {struct _tuple6*_tmp1EA=Cyc_Tcgenrep_toplevel_name(
Cyc_Tcgenrep_new_gen_id(({const char*_tmp1F5="rep";_tag_arr(_tmp1F5,sizeof(char),
_get_zero_arr_size(_tmp1F5,4));})));struct Cyc_Core_Opt*_tmp1EB=({struct Cyc_Core_Opt*
_tmp1F4=_cycalloc(sizeof(*_tmp1F4));_tmp1F4->v=Cyc_Tcgenrep_gen_vardecl(_tmp1EA,
Cyc_Tcgenrep_tunionfield_typ(Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_typestruct_str),
Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_thinptr_str)),0,(void*)3,loc);_tmp1F4;});
dict=Cyc_Tcgenrep_make_fwd_decl_info(dict,type,(struct Cyc_Absyn_Exp*)Cyc_Absyn_address_exp(
Cyc_Absyn_unknownid_exp(_tmp1EA,loc),loc),_tmp1EB,0);{struct _tuple19 _tmp1ED;
struct Cyc_Dict_Dict*_tmp1EE;struct Cyc_Tcgenrep_RepInfo*_tmp1EF;struct _tuple19*
_tmp1EC=Cyc_Tcgenrep_lookupRep(te,dict,loc,(void*)_tmp1C6.elt_typ);_tmp1ED=*
_tmp1EC;_tmp1EE=_tmp1ED.f1;_tmp1EF=_tmp1ED.f2;dict=_tmp1EE;{struct Cyc_Absyn_Decl*
_tmp1F0=Cyc_Tcgenrep_tunion_constructor_decl(Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_typestruct_str),
Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_thinptr_str),_tmp1EA,({struct Cyc_Absyn_Exp*
_tmp1F3[2];_tmp1F3[1]=(struct Cyc_Absyn_Exp*)_check_null(_tmp1EF->exp);_tmp1F3[0]=
_tmp1E9;((struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(_tag_arr(
_tmp1F3,sizeof(struct Cyc_Absyn_Exp*),2));}),(void*)0,loc);dict=Cyc_Tcgenrep_update_info(
dict,type,({struct Cyc_Absyn_Decl*_tmp1F1[1];_tmp1F1[0]=_tmp1F0;((struct Cyc_List_List*(*)(
struct _tagged_arr))Cyc_List_list)(_tag_arr(_tmp1F1,sizeof(struct Cyc_Absyn_Decl*),
1));}),(struct Cyc_Absyn_Exp*)Cyc_Absyn_address_exp(Cyc_Absyn_unknownid_exp(
_tmp1EA,loc),loc),({struct Cyc_Tcgenrep_RepInfo*_tmp1F2[1];_tmp1F2[0]=_tmp1EF;((
struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(_tag_arr(_tmp1F2,
sizeof(struct Cyc_Tcgenrep_RepInfo*),1));}),0);goto _LL4E;}}}_LL51: if((int)_tmp1E8
!= 0)goto _LL53;_LL52: {struct _tuple6*_tmp1F6=Cyc_Tcgenrep_toplevel_name(Cyc_Tcgenrep_new_gen_id(({
const char*_tmp201="rep";_tag_arr(_tmp201,sizeof(char),_get_zero_arr_size(_tmp201,
4));})));struct Cyc_Core_Opt*_tmp1F7=({struct Cyc_Core_Opt*_tmp200=_cycalloc(
sizeof(*_tmp200));_tmp200->v=Cyc_Tcgenrep_gen_vardecl(_tmp1F6,Cyc_Tcgenrep_tunionfield_typ(
Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_typestruct_str),Cyc_Tcgenrep_typerep_name(&
Cyc_Tcgenrep_fatptr_str)),0,(void*)3,loc);_tmp200;});dict=Cyc_Tcgenrep_make_fwd_decl_info(
dict,type,(struct Cyc_Absyn_Exp*)Cyc_Absyn_address_exp(Cyc_Absyn_unknownid_exp(
_tmp1F6,loc),loc),_tmp1F7,0);{struct _tuple19 _tmp1F9;struct Cyc_Dict_Dict*_tmp1FA;
struct Cyc_Tcgenrep_RepInfo*_tmp1FB;struct _tuple19*_tmp1F8=Cyc_Tcgenrep_lookupRep(
te,dict,loc,(void*)_tmp1C6.elt_typ);_tmp1F9=*_tmp1F8;_tmp1FA=_tmp1F9.f1;_tmp1FB=
_tmp1F9.f2;dict=_tmp1FA;{struct Cyc_Absyn_Decl*_tmp1FC=Cyc_Tcgenrep_tunion_constructor_decl(
Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_typestruct_str),Cyc_Tcgenrep_typerep_name(&
Cyc_Tcgenrep_fatptr_str),_tmp1F6,({struct Cyc_Absyn_Exp*_tmp1FF[1];_tmp1FF[0]=(
struct Cyc_Absyn_Exp*)_check_null(_tmp1FB->exp);((struct Cyc_List_List*(*)(struct
_tagged_arr))Cyc_List_list)(_tag_arr(_tmp1FF,sizeof(struct Cyc_Absyn_Exp*),1));}),(
void*)0,loc);dict=Cyc_Tcgenrep_update_info(dict,type,({struct Cyc_Absyn_Decl*
_tmp1FD[1];_tmp1FD[0]=_tmp1FC;((struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(
_tag_arr(_tmp1FD,sizeof(struct Cyc_Absyn_Decl*),1));}),(struct Cyc_Absyn_Exp*)Cyc_Absyn_address_exp(
Cyc_Absyn_unknownid_exp(_tmp1F6,loc),loc),({struct Cyc_Tcgenrep_RepInfo*_tmp1FE[1];
_tmp1FE[0]=_tmp1FB;((struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(
_tag_arr(_tmp1FE,sizeof(struct Cyc_Tcgenrep_RepInfo*),1));}),0);goto _LL4E;}}}
_LL53: if(_tmp1E8 <= (void*)1  || *((int*)_tmp1E8)!= 1)goto _LL4E;_LL54:({void*
_tmp202[0]={};((int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(({
const char*_tmp203="tcgenregp: no support for abstract array bounds";_tag_arr(
_tmp203,sizeof(char),_get_zero_arr_size(_tmp203,48));}),_tag_arr(_tmp202,sizeof(
void*),0));});_LL4E:;}goto _LL15;_LL1E: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)
!= 7)goto _LL20;_tmp1C7=((struct Cyc_Absyn_ArrayType_struct*)_tmp1C2)->f1;_tmp1C8=(
void*)_tmp1C7.elt_type;_tmp1C9=_tmp1C7.tq;_tmp1CA=_tmp1C7.num_elts;_tmp1CB=
_tmp1C7.zero_term;_LL1F: if(_tmp1CA == 0)({void*_tmp204[0]={};((int(*)(struct
_tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(({const char*_tmp205="tcgenrep:At this point, array bounds must be constants";
_tag_arr(_tmp205,sizeof(char),_get_zero_arr_size(_tmp205,55));}),_tag_arr(
_tmp204,sizeof(void*),0));});{struct _tuple19 _tmp207;struct Cyc_Dict_Dict*_tmp208;
struct Cyc_Tcgenrep_RepInfo*_tmp209;struct _tuple19*_tmp206=Cyc_Tcgenrep_lookupRep(
te,dict,loc,_tmp1C8);_tmp207=*_tmp206;_tmp208=_tmp207.f1;_tmp209=_tmp207.f2;dict=
_tmp208;{struct _tuple6*_tmp20A=Cyc_Tcgenrep_toplevel_name(Cyc_Tcgenrep_new_gen_id(({
const char*_tmp20F="rep";_tag_arr(_tmp20F,sizeof(char),_get_zero_arr_size(_tmp20F,
4));})));struct Cyc_Absyn_Decl*_tmp20B=Cyc_Tcgenrep_tunion_constructor_decl(Cyc_Tcgenrep_typerep_name(&
Cyc_Tcgenrep_typestruct_str),Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_thinptr_str),
_tmp20A,({struct Cyc_Absyn_Exp*_tmp20E[2];_tmp20E[1]=(struct Cyc_Absyn_Exp*)
_check_null(_tmp209->exp);_tmp20E[0]=(struct Cyc_Absyn_Exp*)_tmp1CA;((struct Cyc_List_List*(*)(
struct _tagged_arr))Cyc_List_list)(_tag_arr(_tmp20E,sizeof(struct Cyc_Absyn_Exp*),
2));}),(void*)0,loc);dict=Cyc_Tcgenrep_update_info(dict,type,({struct Cyc_Absyn_Decl*
_tmp20C[1];_tmp20C[0]=_tmp20B;((struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(
_tag_arr(_tmp20C,sizeof(struct Cyc_Absyn_Decl*),1));}),(struct Cyc_Absyn_Exp*)Cyc_Absyn_address_exp(
Cyc_Absyn_unknownid_exp(_tmp20A,loc),loc),({struct Cyc_Tcgenrep_RepInfo*_tmp20D[1];
_tmp20D[0]=_tmp209;((struct Cyc_List_List*(*)(struct _tagged_arr))Cyc_List_list)(
_tag_arr(_tmp20D,sizeof(struct Cyc_Tcgenrep_RepInfo*),1));}),0);goto _LL15;}}_LL20:
if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 9)goto _LL22;_tmp1CC=((struct Cyc_Absyn_TupleType_struct*)
_tmp1C2)->f1;_LL21: {struct _tuple6*_tmp210=Cyc_Tcgenrep_toplevel_name(Cyc_Tcgenrep_new_gen_id(({
const char*_tmp214="rep";_tag_arr(_tmp214,sizeof(char),_get_zero_arr_size(_tmp214,
4));})));struct Cyc_Core_Opt*_tmp211=({struct Cyc_Core_Opt*_tmp213=_cycalloc(
sizeof(*_tmp213));_tmp213->v=Cyc_Tcgenrep_gen_vardecl(_tmp210,Cyc_Tcgenrep_tunionfield_typ(
Cyc_Tcgenrep_typerep_name(& Cyc_Tcgenrep_typestruct_str),Cyc_Tcgenrep_typerep_name(&
...
_tmp212);goto _LL15;}}_LL22: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 16)goto
...
if(_tmp1D0 == 0)({void*_tmp215[0]={};((int(*)(struct _tagged_arr fmt,struct
_tagged_arr ap))Cyc_Tcutil_impos)(({const char*_tmp216="gen(): can't gen for abstract typedef";
_tag_arr(_tmp216,sizeof(char),_get_zero_arr_size(_tmp216,38));}),_tag_arr(
_tmp215,sizeof(void*),0));});{struct _tuple19 _tmp218;struct Cyc_Dict_Dict*_tmp219;
struct Cyc_Tcgenrep_RepInfo*_tmp21A;struct _tuple19*_tmp217=Cyc_Tcgenrep_lookupRep(
te,dict,loc,*_tmp1D0);_tmp218=*_tmp217;_tmp219=_tmp218.f1;_tmp21A=_tmp218.f2;
dict=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,void*k,struct Cyc_Tcgenrep_RepInfo*
v))Cyc_Dict_insert)(_tmp219,type,_tmp21A);goto _LL15;}_LL24: if((int)_tmp1C2 != 0)
goto _LL26;_LL25:({void*_tmp21B[0]={};Cyc_Tcutil_terr(loc,({const char*_tmp21C="found void in gen() expression";
_tag_arr(_tmp21C,sizeof(char),_get_zero_arr_size(_tmp21C,31));}),_tag_arr(
_tmp21B,sizeof(void*),0));});goto _LL15;_LL26: if(_tmp1C2 <= (void*)4  || *((int*)
_tmp1C2)!= 0)goto _LL28;_LL27:({void*_tmp21D[0]={};Cyc_Tcutil_terr(loc,({const
char*_tmp21E="found evar in gen() expression";_tag_arr(_tmp21E,sizeof(char),
_get_zero_arr_size(_tmp21E,31));}),_tag_arr(_tmp21D,sizeof(void*),0));});goto
_LL15;_LL28: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 1)goto _LL2A;_tmp1D1=((
struct Cyc_Absyn_VarType_struct*)_tmp1C2)->f1;_LL29:({void*_tmp21F[0]={};Cyc_Tcutil_terr(
loc,({const char*_tmp220="found tyvar in gen() expression";_tag_arr(_tmp220,
sizeof(char),_get_zero_arr_size(_tmp220,32));}),_tag_arr(_tmp21F,sizeof(void*),0));});
goto _LL15;_LL2A: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 8)goto _LL2C;_tmp1D2=((
struct Cyc_Absyn_FnType_struct*)_tmp1C2)->f1;_LL2B:({void*_tmp221[0]={};Cyc_Tcutil_terr(
loc,({const char*_tmp222="found function type in gen() expression";_tag_arr(
_tmp222,sizeof(char),_get_zero_arr_size(_tmp222,40));}),_tag_arr(_tmp221,sizeof(
void*),0));});goto _LL15;_LL2C: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 15)
goto _LL2E;_LL2D: goto _LL2F;_LL2E: if((int)_tmp1C2 != 3)goto _LL30;_LL2F: goto _LL31;
_LL30: if((int)_tmp1C2 != 2)goto _LL32;_LL31: goto _LL33;_LL32: if(_tmp1C2 <= (void*)4
 || *((int*)_tmp1C2)!= 19)goto _LL34;_LL33: goto _LL35;_LL34: if(_tmp1C2 <= (void*)4
 || *((int*)_tmp1C2)!= 20)goto _LL36;_LL35: goto _LL37;_LL36: if(_tmp1C2 <= (void*)4
 || *((int*)_tmp1C2)!= 21)goto _LL38;_LL37:({void*_tmp223[0]={};Cyc_Tcutil_terr(
loc,({const char*_tmp224="gen(): unhandled region, handle or effect type";
_tag_arr(_tmp224,sizeof(char),_get_zero_arr_size(_tmp224,47));}),_tag_arr(
_tmp223,sizeof(void*),0));});goto _LL15;_LL38: if(_tmp1C2 <= (void*)4  || *((int*)
_tmp1C2)!= 2)goto _LL3A;_tmp1D3=((struct Cyc_Absyn_TunionType_struct*)_tmp1C2)->f1;
_tmp1D4=(void*)_tmp1D3.tunion_info;if(*((int*)_tmp1D4)!= 1)goto _LL3A;_tmp1D5=((
struct Cyc_Absyn_KnownTunion_struct*)_tmp1D4)->f1;_tmp1D6=*_tmp1D5;_tmp1D7=
_tmp1D3.targs;_tmp1D8=(void*)_tmp1D3.rgn;_LL39: if(_tmp1D6->tvs != 0)({void*
...
void*)2,type,_tmp238);}}goto _LL15;_LL3A: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)
!= 2)goto _LL3C;_LL3B:({void*_tmp23B[0]={};((int(*)(struct _tagged_arr fmt,struct
...
_tmp23B,sizeof(void*),0));});_LL3C: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 3)
goto _LL3E;_tmp1D9=((struct Cyc_Absyn_TunionFieldType_struct*)_tmp1C2)->f1;_LL3D:
...
_tmp240;struct Cyc_Absyn_Tunionfield*_tmp241;_LL56: if(*((int*)_tmp23F)!= 1)goto
_LL58;_tmp240=((struct Cyc_Absyn_KnownTunionfield_struct*)_tmp23F)->f1;_tmp241=((
struct Cyc_Absyn_KnownTunionfield_struct*)_tmp23F)->f2;_LL57: {struct Cyc_List_List*
...
_tmp240->name,_tmp241->name,te,dict,loc,_tmp244,(void*)0,type,_tmp243);goto _LL55;}
_LL58:;_LL59:({void*_tmp247[0]={};((int(*)(struct _tagged_arr fmt,struct
...
_tmp247,sizeof(void*),0));});_LL55:;}goto _LL15;_LL3E: if(_tmp1C2 <= (void*)4  || *((
int*)_tmp1C2)!= 10)goto _LL40;_tmp1DA=((struct Cyc_Absyn_AggrType_struct*)_tmp1C2)->f1;
_tmp1DB=(void*)_tmp1DA.aggr_info;_tmp1DC=_tmp1DA.targs;_LL3F: {struct Cyc_Absyn_Aggrdecl*
_tmp249=Cyc_Absyn_get_known_aggrdecl(_tmp1DB);if(_tmp249->impl != 0  && ((struct
Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp249->impl))->exist_vars != 0)({void*
_tmp24A[0]={};((int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(({
const char*_tmp24B="gen(): existential type variables not yet supported";_tag_arr(
_tmp24B,sizeof(char),_get_zero_arr_size(_tmp24B,52));}),_tag_arr(_tmp24A,sizeof(
void*),0));});if((void*)_tmp249->kind == (void*)0){struct Cyc_Absyn_Aggrdecl*
...
_tmp269,(void*)2,type,_tmp268);}}goto _LL15;}_LL40: if(_tmp1C2 <= (void*)4  || *((
int*)_tmp1C2)!= 11)goto _LL42;_tmp1DD=(void*)((struct Cyc_Absyn_AnonAggrType_struct*)
_tmp1C2)->f1;if((int)_tmp1DD != 0)goto _LL42;_tmp1DE=((struct Cyc_Absyn_AnonAggrType_struct*)
_tmp1C2)->f2;_LL41: if(_tmp1DE != 0  && ((int(*)(int(*pred)(struct Cyc_Absyn_Aggrfield*),
...
goto _LL15;_LL42: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 11)goto _LL44;_tmp1DF=(
void*)((struct Cyc_Absyn_AnonAggrType_struct*)_tmp1C2)->f1;if((int)_tmp1DF != 1)
goto _LL44;_tmp1E0=((struct Cyc_Absyn_AnonAggrType_struct*)_tmp1C2)->f2;_LL43: {
...
_tmp275);goto _LL15;}_LL44: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 12)goto
_LL46;_tmp1E1=((struct Cyc_Absyn_EnumType_struct*)_tmp1C2)->f2;_LL45: if(_tmp1E1 == 
...
struct _tuple6*_tmp27B=Cyc_Tcgenrep_toplevel_name(({struct _tagged_arr*_tmp27E=
...
dict,loc,_tmp280,(void*)2,type,_tmp27F);goto _LL15;}}_LL46: if(_tmp1C2 <= (void*)4
 || *((int*)_tmp1C2)!= 13)goto _LL48;_tmp1E2=((struct Cyc_Absyn_AnonEnumType_struct*)
_tmp1C2)->f1;_LL47: {struct Cyc_List_List*_tmp282=((struct Cyc_List_List*(*)(
struct _tuple17*(*f)(struct Cyc_Absyn_Enumfield*),struct Cyc_List_List*x))Cyc_List_map)(
...
_tmp283,(void*)0,type,_tmp282);goto _LL15;}_LL48: if(_tmp1C2 <= (void*)4  || *((int*)
_tmp1C2)!= 14)goto _LL4A;_LL49:({void*_tmp285[0]={};((int(*)(struct _tagged_arr fmt,
...
_tmp285,sizeof(void*),0));});_LL4A: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 
18)goto _LL4C;_LL4B:({void*_tmp287[0]={};((int(*)(struct _tagged_arr fmt,struct
...
_tmp287,sizeof(void*),0));});_LL4C: if(_tmp1C2 <= (void*)4  || *((int*)_tmp1C2)!= 
17)goto _LL15;_LL4D:({void*_tmp289[0]={};((int(*)(struct _tagged_arr fmt,struct
...
loc,te,type,0);Cyc_Tcutil_check_valid_toplevel_type(loc,te,type,0);{struct
_tuple19 _tmp28D;struct Cyc_Dict_Dict*_tmp28E;struct Cyc_Tcgenrep_RepInfo*_tmp28F;
struct _tuple19*_tmp28C=Cyc_Tcgenrep_lookupRep(te,dict,loc,type);_tmp28D=*_tmp28C;
