...
void*,void*),struct Cyc_Dict_Dict d);struct _tuple1{void*f1;void*f2;};struct _tuple1*
Cyc_Dict_rchoose(struct _RegionHandle*r,struct Cyc_Dict_Dict d);struct _tuple1*Cyc_Dict_rchoose(
struct _RegionHandle*,struct Cyc_Dict_Dict d);struct Cyc_Dict_Dict Cyc_Dict_delete(
struct Cyc_Dict_Dict,void*);unsigned int Cyc_strlen(struct _dyneither_ptr s);int Cyc_strcmp(
...
;struct _tuple2{unsigned int f1;struct _dyneither_ptr f2;void*f3;};struct Cyc_Typerep_Struct_struct{
...
Cyc_Absyn_UnknownDatatypeInfo{struct _tuple6*name;int is_extensible;};struct
...
struct _tuple6*datatype_name;struct _tuple6*field_name;int is_extensible;};struct
...
Cyc_List_List*targs;};struct _tuple8{enum Cyc_Absyn_AggrKind f1;struct _tuple6*f2;
struct Cyc_Core_Opt*f3;};struct _union_AggrInfoU_UnknownAggr{int tag;struct _tuple8
...
Cyc_List_List*f2;};struct Cyc_Absyn_EnumType_struct{int tag;struct _tuple6*f1;
...
_union_Cnst_Null_c{int tag;int val;};struct _tuple9{enum Cyc_Absyn_Sign f1;char f2;};
struct _union_Cnst_Char_c{int tag;struct _tuple9 val;};struct _tuple10{enum Cyc_Absyn_Sign
f1;short f2;};struct _union_Cnst_Short_c{int tag;struct _tuple10 val;};struct _tuple11{
enum Cyc_Absyn_Sign f1;int f2;};struct _union_Cnst_Int_c{int tag;struct _tuple11 val;}
;struct _tuple12{enum Cyc_Absyn_Sign f1;long long f2;};struct _union_Cnst_LongLong_c{
...
struct Cyc_Absyn_Var_e_struct{int tag;struct _tuple6*f1;void*f2;};struct Cyc_Absyn_UnknownId_e_struct{
int tag;struct _tuple6*f1;};struct Cyc_Absyn_Primop_e_struct{int tag;enum Cyc_Absyn_Primop
...
f2;struct Cyc_Absyn_Stmt*f3;};struct _tuple14{struct Cyc_Absyn_Exp*f1;struct Cyc_Absyn_Stmt*
f2;};struct Cyc_Absyn_While_s_struct{int tag;struct _tuple14 f1;struct Cyc_Absyn_Stmt*
f2;};struct Cyc_Absyn_Break_s_struct{int tag;struct Cyc_Absyn_Stmt*f1;};struct Cyc_Absyn_Continue_s_struct{
int tag;struct Cyc_Absyn_Stmt*f1;};struct Cyc_Absyn_Goto_s_struct{int tag;struct
_dyneither_ptr*f1;struct Cyc_Absyn_Stmt*f2;};struct Cyc_Absyn_For_s_struct{int tag;
struct Cyc_Absyn_Exp*f1;struct _tuple14 f2;struct _tuple14 f3;struct Cyc_Absyn_Stmt*f4;
};struct Cyc_Absyn_Switch_s_struct{int tag;struct Cyc_Absyn_Exp*f1;struct Cyc_List_List*
f2;};struct Cyc_Absyn_Fallthru_s_struct{int tag;struct Cyc_List_List*f1;struct Cyc_Absyn_Switch_clause**
f2;};struct Cyc_Absyn_Decl_s_struct{int tag;struct Cyc_Absyn_Decl*f1;struct Cyc_Absyn_Stmt*
f2;};struct Cyc_Absyn_Label_s_struct{int tag;struct _dyneither_ptr*f1;struct Cyc_Absyn_Stmt*
f2;};struct Cyc_Absyn_Do_s_struct{int tag;struct Cyc_Absyn_Stmt*f1;struct _tuple14 f2;
...
int tag;struct _tuple6*f1;};struct Cyc_Absyn_UnknownCall_p_struct{int tag;struct
_tuple6*f1;struct Cyc_List_List*f2;int f3;};struct Cyc_Absyn_Exp_p_struct{int tag;
...
enum Cyc_Absyn_Scope sc;struct _tuple6*name;struct Cyc_Absyn_Tqual tq;void*type;
struct Cyc_Absyn_Exp*initializer;struct Cyc_Core_Opt*rgn;struct Cyc_List_List*
attributes;int escapes;};struct Cyc_Absyn_Fndecl{enum Cyc_Absyn_Scope sc;int
is_inline;struct _tuple6*name;struct Cyc_List_List*tvs;struct Cyc_Core_Opt*effect;
...
enum Cyc_Absyn_AggrKind kind;enum Cyc_Absyn_Scope sc;struct _tuple6*name;struct Cyc_List_List*
tvs;struct Cyc_Absyn_AggrdeclImpl*impl;struct Cyc_List_List*attributes;};struct Cyc_Absyn_Datatypefield{
struct _tuple6*name;struct Cyc_List_List*typs;struct Cyc_Position_Segment*loc;enum 
Cyc_Absyn_Scope sc;};struct Cyc_Absyn_Datatypedecl{enum Cyc_Absyn_Scope sc;struct
_tuple6*name;struct Cyc_List_List*tvs;struct Cyc_Core_Opt*fields;int is_extensible;
};struct Cyc_Absyn_Enumfield{struct _tuple6*name;struct Cyc_Absyn_Exp*tag;struct Cyc_Position_Segment*
loc;};struct Cyc_Absyn_Enumdecl{enum Cyc_Absyn_Scope sc;struct _tuple6*name;struct
Cyc_Core_Opt*fields;};struct Cyc_Absyn_Typedefdecl{struct _tuple6*name;struct Cyc_Absyn_Tqual
...
char*tag;};int Cyc_Absyn_qvar_cmp(struct _tuple6*,struct _tuple6*);void*Cyc_Absyn_conref_val(
...
Cyc_List_imp_append)(ds,_tmp1A);}}else{return ds;}}_LL3:;_LL4:(void)_throw(_tmp16);
...
_tmp2A,_tmp2A + 7};static struct _tuple6*Cyc_Tcgenrep_typerep_name(struct
_dyneither_ptr*name){return({struct _tuple6*_tmp2B=_cycalloc(sizeof(*_tmp2B));
...
struct _tuple6*_tmp41=_cycalloc(sizeof(*_tmp41));_tmp41->f1=Cyc_Absyn_Rel_n(0);
_tmp41->f2=(struct _dyneither_ptr*)name;_tmp41;});}static struct _tuple6*Cyc_Tcgenrep_relative_name(
struct Cyc_List_List*pathl,struct _dyneither_ptr*name){return({struct _tuple6*
_tmp42=_cycalloc(sizeof(*_tmp42));_tmp42->f1=Cyc_Absyn_Rel_n(pathl);_tmp42->f2=(
struct _dyneither_ptr*)name;_tmp42;});}static struct Cyc_Absyn_Decl*Cyc_Tcgenrep_gen_decl(
...
r1=({struct Cyc_Absyn_Var_d_struct*_tmp43=_cycalloc(sizeof(*_tmp43));_tmp43[0]=({
...
enum Cyc_Absyn_Scope sc,struct Cyc_Position_Segment*seg){struct _tuple6*topname=Cyc_Tcgenrep_toplevel_name((*
...
return 64;}}static void*Cyc_Tcgenrep_datatype_typ(struct _tuple6*name){return(void*)({
...
_tmp48;});_tmp47;});}static void*Cyc_Tcgenrep_datatypefield_typ(struct _tuple6*
...
_tmp4F,(struct Cyc_Absyn_Exp*)_tmp50,sc,loc);return _tmp51;}struct _tuple16{struct
...
Cyc_Tcgenrep_List_str={_tmp53,_tmp53,_tmp53 + 5};struct _tuple18{struct Cyc_Absyn_Exp*
f1;struct Cyc_Absyn_Exp*f2;};static struct Cyc_Absyn_Exp*Cyc_Tcgenrep_tuple2_exp_cls(
struct Cyc_Position_Segment*loc,struct _tuple18*es){struct _tuple18 _tmp55;struct Cyc_Absyn_Exp*
_tmp56;struct Cyc_Absyn_Exp*_tmp57;struct _tuple18*_tmp54=es;_tmp55=*_tmp54;_tmp56=
...
Cyc_Position_Segment*loc,struct _tuple19*es){struct _tuple19 _tmp5A;struct Cyc_Absyn_Exp*
_tmp5B;struct Cyc_Absyn_Exp*_tmp5C;struct Cyc_Absyn_Exp*_tmp5D;struct _tuple19*
...
_tmp61;void*_tmp62;struct Cyc_Position_Segment*_tmp63;struct _tuple20*_tmp60=
...
loc);}static struct _tuple17*Cyc_Tcgenrep_gen_id_for_exp(struct Cyc_Absyn_Exp*e){
return({struct _tuple17*_tmp66=_cycalloc(sizeof(*_tmp66));_tmp66->f1=Cyc_Tcgenrep_new_gen_id(({
const char*_tmp67="tuple";_tag_dyneither(_tmp67,sizeof(char),6);}));_tmp66->f2=e;
_tmp66;});}static struct Cyc_Absyn_Decl*Cyc_Tcgenrep_gen_decl_cls(struct _tuple20*
env,struct _tuple17*name_exp){struct _tuple20 _tmp69;void*_tmp6A;struct Cyc_Position_Segment*
_tmp6B;struct _tuple20*_tmp68=env;_tmp69=*_tmp68;_tmp6A=_tmp69.f1;_tmp6B=_tmp69.f2;{
struct _tuple17 _tmp6D;struct _dyneither_ptr*_tmp6E;struct Cyc_Absyn_Exp*_tmp6F;
struct _tuple17*_tmp6C=name_exp;_tmp6D=*_tmp6C;_tmp6E=_tmp6D.f1;_tmp6F=_tmp6D.f2;
...
_tuple21*_tmp70=_cycalloc(sizeof(*_tmp70));_tmp70->f1=0;_tmp70->f2=e;_tmp70;});}
...
_tuple15 _tmp72=Cyc_Evexp_eval_const_uint_exp((struct Cyc_Absyn_Exp*)_check_null(
...
return({struct _tuple22*_tmp81=_cycalloc(sizeof(*_tmp81));_tmp81->f1=sf->name;
_tmp81->f2=sf->type;_tmp81;});}struct _tuple23{int f1;struct _tuple6*f2;};struct
...
return({struct _tuple23*_tmp84=_cycalloc(sizeof(*_tmp84));_tmp84->f1=(int)(Cyc_Evexp_eval_const_uint_exp((
...
_tuple16*_tmp8E=_cycalloc(sizeof(*_tmp8E));_tmp8E->f1=*((struct Cyc_Absyn_Tqual*)
...
loc){struct Cyc_List_List*_tmp92=((struct Cyc_List_List*(*)(struct _tuple17*(*f)(
...
Cyc_List_map_c)(Cyc_Tcgenrep_gen_decl_cls,({struct _tuple20*_tmpA1=_cycalloc(
sizeof(*_tmpA1));_tmpA1->f1=type;_tmpA1->f2=loc;_tmpA1;}),_tmp92);struct Cyc_List_List*
_tmp94=((struct Cyc_List_List*(*)(struct _dyneither_ptr*(*f)(struct _tuple17*),
struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcgenrep_get_first,_tmp92);struct Cyc_List_List*
_tmp95=((struct Cyc_List_List*(*)(struct _tuple6*(*f)(struct _dyneither_ptr*),
...
_tmp99),loc);return({struct _tuple21*_tmp9E=_cycalloc(sizeof(*_tmp9E));_tmp9E->f1=((
...
struct Cyc_List_List*y))Cyc_List_imp_append)(({struct _tuple16*_tmpA4[1];_tmpA4[0]=({
struct _tuple16*_tmpA5=_cycalloc(sizeof(*_tmpA5));_tmpA5->f1=Cyc_Tcgenrep_tq_none;
_tmpA5->f2=Cyc_Absyn_uint_typ;_tmpA5;});((struct Cyc_List_List*(*)(struct
_dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpA4,sizeof(struct _tuple16*),1));}),
tuf->typs);_tmpA3;});_tmpA2;});}static struct _tuple6*Cyc_Tcgenrep_check_datatypefield_and_get_name(
...
struct Cyc_Absyn_Datatypefield*tuf){return({struct _tuple24*_tmpA6=_cycalloc(
...
struct Cyc_List_List*y))Cyc_List_imp_append)(({struct _tuple16*_tmpA9[1];_tmpA9[0]=({
struct _tuple16*_tmpAA=_cycalloc(sizeof(*_tmpAA));_tmpAA->f1=Cyc_Tcgenrep_tq_none;
_tmpAA->f2=Cyc_Absyn_uint_typ;_tmpAA;});((struct Cyc_List_List*(*)(struct
_dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpA9,sizeof(struct _tuple16*),1));}),
tuf->typs);_tmpA8;});_tmpA7;});_tmpA6;});}static struct _tuple22*Cyc_Tcgenrep_check_xdatatypefield_and_get_name_type(
struct Cyc_Absyn_Datatypefield*tuf){return({struct _tuple22*_tmpAB=_cycalloc(
...
struct Cyc_List_List*y))Cyc_List_imp_append)(({struct _tuple16*_tmpAE[1];_tmpAE[0]=({
struct _tuple16*_tmpAF=_cycalloc(sizeof(*_tmpAF));_tmpAF->f1=Cyc_Tcgenrep_tq_none;
...
struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmpAE,sizeof(struct _tuple16*),
...
sf->attributes;_tmpB0;});}struct _tuple16*Cyc_Tcgenrep_substitute_tqual_type(
struct Cyc_List_List*subst,struct _tuple16*pair){struct _tuple16 _tmpB2;struct Cyc_Absyn_Tqual
_tmpB3;void*_tmpB4;struct _tuple16*_tmpB1=pair;_tmpB2=*_tmpB1;_tmpB3=_tmpB2.f1;
_tmpB4=_tmpB2.f2;return({struct _tuple16*_tmpB5=_cycalloc(sizeof(*_tmpB5));_tmpB5->f1=
...
_tmpB6->name=tf->name;_tmpB6->typs=((struct Cyc_List_List*(*)(struct _tuple16*(*f)(
...
_tuple6*varname,enum Cyc_Absyn_Scope sc,void*type,struct Cyc_List_List*types){
struct Cyc_Absyn_Exp*_tmpEC=Cyc_Absyn_sizeoftyp_exp(type,loc);struct _tuple27*
_tmpED=({struct _tuple27*_tmp102=_cycalloc(sizeof(*_tmp102));_tmp102->f1=te;
_tmp102->f2=loc;_tmp102;});struct _tuple26*_tmpEE=({struct _tuple26*_tmp101=
_cycalloc(sizeof(*_tmp101));_tmp101->f1=dict;_tmp101->f2=0;_tmp101;});struct
_tuple26 _tmpF0;struct Cyc_Dict_Dict _tmpF1;struct Cyc_List_List*_tmpF2;struct
_tuple26*_tmpEF=((struct _tuple26*(*)(struct _tuple26*(*f)(struct _tuple27*,void*,
...
x))Cyc_List_map_c)(Cyc_Tcgenrep_make_offsetof_exp,({struct _tuple20*_tmp100=
...
_tag_dyneither(_tmpFF,sizeof(void*),2));}));struct _tuple21 _tmpF8;struct Cyc_List_List*
...
static struct Cyc_Dict_Dict Cyc_Tcgenrep_buildRepDatatypefield(struct _tuple6*tname,
struct _tuple6*fname,struct Cyc_Tcenv_Tenv*te,struct Cyc_Dict_Dict dict,struct Cyc_Position_Segment*
loc,struct _tuple6*varname,enum Cyc_Absyn_Scope sc,void*type,struct Cyc_List_List*
types){struct Cyc_Absyn_Exp*_tmp103=Cyc_Absyn_sizeoftyp_exp(type,loc);struct
_tuple27*_tmp104=({struct _tuple27*_tmp11B=_cycalloc(sizeof(*_tmp11B));_tmp11B->f1=
te;_tmp11B->f2=loc;_tmp11B;});struct _tuple26*_tmp105=({struct _tuple26*_tmp11A=
_cycalloc(sizeof(*_tmp11A));_tmp11A->f1=dict;_tmp11A->f2=0;_tmp11A;});struct
_tuple26 _tmp107;struct Cyc_Dict_Dict _tmp108;struct Cyc_List_List*_tmp109;struct
_tuple26*_tmp106=((struct _tuple26*(*)(struct _tuple26*(*f)(struct _tuple27*,void*,
struct _tuple26*),struct _tuple27*,struct Cyc_List_List*x,struct _tuple26*accum))Cyc_List_fold_right_c)(
...
Cyc_Tcgenrep_cnst_string(*(*fname).f2,loc);struct _tuple21 _tmp111;struct Cyc_List_List*
_tmp112;struct Cyc_Absyn_Exp*_tmp113;struct _tuple21*_tmp110=Cyc_Tcgenrep_array_decls(
...
_tmp11C=Cyc_Absyn_sizeoftyp_exp(type,loc);struct _tuple27*_tmp11D=({struct
_tuple27*_tmp13A=_cycalloc(sizeof(*_tmp13A));_tmp13A->f1=te;_tmp13A->f2=loc;
_tmp13A;});struct _tuple26*_tmp11E=({struct _tuple26*_tmp139=_cycalloc(sizeof(*
...
_tuple26 _tmp123;struct Cyc_Dict_Dict _tmp124;struct Cyc_List_List*_tmp125;struct
_tuple26*_tmp122=((struct _tuple26*(*)(struct _tuple26*(*f)(struct _tuple27*,void*,
struct _tuple26*),struct _tuple27*,struct Cyc_List_List*x,struct _tuple26*accum))Cyc_List_fold_right_c)(
...
_tmp127=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*f)(struct _tuple20*,int),
struct _tuple20*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcgenrep_make_offsetof_exp,({
struct _tuple20*_tmp138=_cycalloc(sizeof(*_tmp138));_tmp138->f1=type;_tmp138->f2=
...
Cyc_List_list)(_tag_dyneither(_tmp137,sizeof(void*),3));}));struct _tuple21
...
Cyc_Position_Segment*loc,struct _tuple6*varname,enum Cyc_Absyn_Scope sc,void*type,
struct Cyc_List_List*nmtypes){struct Cyc_Absyn_Exp*_tmp13B=Cyc_Absyn_sizeoftyp_exp(
type,loc);struct _tuple27*_tmp13C=({struct _tuple27*_tmp156=_cycalloc(sizeof(*
_tmp156));_tmp156->f1=te;_tmp156->f2=loc;_tmp156;});struct _tuple26*_tmp13D=({
struct _tuple26*_tmp155=_cycalloc(sizeof(*_tmp155));_tmp155->f1=dict;_tmp155->f2=
...
_tmp13F=_tmp13E.f1;_tmp140=_tmp13E.f2;{struct _tuple26 _tmp142;struct Cyc_Dict_Dict
_tmp143;struct Cyc_List_List*_tmp144;struct _tuple26*_tmp141=((struct _tuple26*(*)(
...
struct _tuple21 _tmp14A;struct Cyc_List_List*_tmp14B;struct Cyc_Absyn_Exp*_tmp14C;
struct _tuple21*_tmp149=Cyc_Tcgenrep_array_decls(_tmp148,_tmp147,loc);_tmp14A=*
...
Cyc_Tcenv_Tenv*te,struct Cyc_Dict_Dict dict,struct Cyc_Position_Segment*loc,struct
_tuple6*varname,enum Cyc_Absyn_Scope sc,void*type,struct Cyc_List_List*tagnms){
...
Cyc_List_list)(_tag_dyneither(_tmp16A,sizeof(void*),2));}));struct _tuple21
_tmp160;struct Cyc_List_List*_tmp161;struct Cyc_Absyn_Exp*_tmp162;struct _tuple21*
...
Cyc_List_list)(_tag_dyneither(_tmp18F,sizeof(void*),2));}));struct _tuple21
...
_tmp172.f1;_tmp174=_tmp172.f2;{struct _tuple27*_tmp175=({struct _tuple27*_tmp18E=
_cycalloc(sizeof(*_tmp18E));_tmp18E->f1=te;_tmp18E->f2=loc;_tmp18E;});struct
_tuple26*_tmp176=({struct _tuple26*_tmp18D=_cycalloc(sizeof(*_tmp18D));_tmp18D->f1=
...
struct _tuple21 _tmp185;struct Cyc_List_List*_tmp186;struct Cyc_Absyn_Exp*_tmp187;
struct _tuple21*_tmp184=Cyc_Tcgenrep_array_decls(tuple_type2,_tmp183,loc);_tmp185=*
...
_tmp191=_tmp190.f1;_tmp192=_tmp190.f2;{struct _tuple27*_tmp193=({struct _tuple27*
_tmp1A8=_cycalloc(sizeof(*_tmp1A8));_tmp1A8->f1=te;_tmp1A8->f2=loc;_tmp1A8;});
struct _tuple26*_tmp194=({struct _tuple26*_tmp1A7=_cycalloc(sizeof(*_tmp1A7));
_tmp1A7->f1=dict;_tmp1A7->f2=0;_tmp1A7;});struct _tuple26 _tmp196;struct Cyc_Dict_Dict
...
union Cyc_Absyn_Constraint*_tmp1B9;struct Cyc_List_List*_tmp1BB;struct _tuple6*
...
else{_tmp1AD=_tmp1AC->f1;_tmp1AE=_tmp1AC->f2;}}_LL14: {struct _tuple6*_tmp1E7=Cyc_Tcgenrep_toplevel_name(
...
else{_tmp1EE=_tmp1ED->f1;}}_LL4D: {struct _tuple6*_tmp1F0=Cyc_Tcgenrep_toplevel_name(
...
_tmp1F0,loc),loc),_tmp1F1,0);{struct _tuple25 _tmp1F3;struct Cyc_Dict_Dict _tmp1F4;
struct Cyc_Tcgenrep_RepInfo*_tmp1F5;struct _tuple25*_tmp1F2=Cyc_Tcgenrep_lookupRep(
...
struct _tuple6*_tmp1FC=Cyc_Tcgenrep_toplevel_name(Cyc_Tcgenrep_new_gen_id(({const
...
_tmp201;struct _tuple25*_tmp1FE=Cyc_Tcgenrep_lookupRep(te,dict,loc,_tmp1B3.elt_typ);
...
struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(
_tmp204,sizeof(struct Cyc_Tcgenrep_RepInfo*),1));}),0);goto _LL4B;}}}_LL4B:;}goto
_LL12;_LL1B: {struct Cyc_Absyn_ArrayType_struct*_tmp1B4=(struct Cyc_Absyn_ArrayType_struct*)
...
0));});{struct _tuple25 _tmp20B;struct Cyc_Dict_Dict _tmp20C;struct Cyc_Tcgenrep_RepInfo*
_tmp20D;struct _tuple25*_tmp20A=Cyc_Tcgenrep_lookupRep(te,dict,loc,_tmp1B6);
_tmp20B=*_tmp20A;_tmp20C=_tmp20B.f1;_tmp20D=_tmp20B.f2;dict=_tmp20C;{struct
_tuple6*_tmp20E=Cyc_Tcgenrep_toplevel_name(Cyc_Tcgenrep_new_gen_id(({const char*
...
_tuple6*_tmp214=Cyc_Tcgenrep_toplevel_name(Cyc_Tcgenrep_new_gen_id(({const char*
...
struct Cyc_List_List*_tmp216=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple16*),
struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcgenrep_get_second,_tmp1BB);dict=Cyc_Tcgenrep_buildRepTuple(
te,dict,loc,_tmp214,Cyc_Absyn_Static,type,_tmp216);goto _LL12;}}_LL1F: {struct Cyc_Absyn_TypedefType_struct*
_tmp1BC=(struct Cyc_Absyn_TypedefType_struct*)_tmp1AB;if(_tmp1BC->tag != 18)goto
_LL21;else{_tmp1BD=_tmp1BC->f1;_tmp1BE=_tmp1BC->f2;_tmp1BF=_tmp1BC->f3;_tmp1C0=
_tmp1BC->f4;}}_LL20: if(_tmp1C0 == 0)({void*_tmp219=0;((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp21A="gen(): can't gen for abstract typedef";
_tag_dyneither(_tmp21A,sizeof(char),38);}),_tag_dyneither(_tmp219,sizeof(void*),
0));});{struct _tuple25 _tmp21C;struct Cyc_Dict_Dict _tmp21D;struct Cyc_Tcgenrep_RepInfo*
_tmp21E;struct _tuple25*_tmp21B=Cyc_Tcgenrep_lookupRep(te,dict,loc,*_tmp1C0);
...
_tmp21D,type,_tmp21E);goto _LL12;}_LL21: {struct Cyc_Absyn_VoidType_struct*_tmp1C1=(
struct Cyc_Absyn_VoidType_struct*)_tmp1AB;if(_tmp1C1->tag != 0)goto _LL23;}_LL22:({
void*_tmp21F=0;Cyc_Tcutil_terr(loc,({const char*_tmp220="found void in gen() expression";
_tag_dyneither(_tmp220,sizeof(char),31);}),_tag_dyneither(_tmp21F,sizeof(void*),
0));});goto _LL12;_LL23: {struct Cyc_Absyn_Evar_struct*_tmp1C2=(struct Cyc_Absyn_Evar_struct*)
_tmp1AB;if(_tmp1C2->tag != 1)goto _LL25;}_LL24:({void*_tmp221=0;Cyc_Tcutil_terr(
loc,({const char*_tmp222="found evar in gen() expression";_tag_dyneither(_tmp222,
sizeof(char),31);}),_tag_dyneither(_tmp221,sizeof(void*),0));});goto _LL12;_LL25: {
struct Cyc_Absyn_VarType_struct*_tmp1C3=(struct Cyc_Absyn_VarType_struct*)_tmp1AB;
if(_tmp1C3->tag != 2)goto _LL27;else{_tmp1C4=_tmp1C3->f1;}}_LL26:({void*_tmp223=0;
Cyc_Tcutil_terr(loc,({const char*_tmp224="found tyvar in gen() expression";
_tag_dyneither(_tmp224,sizeof(char),32);}),_tag_dyneither(_tmp223,sizeof(void*),
0));});goto _LL12;_LL27: {struct Cyc_Absyn_FnType_struct*_tmp1C5=(struct Cyc_Absyn_FnType_struct*)
_tmp1AB;if(_tmp1C5->tag != 10)goto _LL29;else{_tmp1C6=_tmp1C5->f1;}}_LL28:({void*
_tmp225=0;Cyc_Tcutil_terr(loc,({const char*_tmp226="found function type in gen() expression";
...
0));});if(_tmp1D2->fields == 0){struct _tuple6*_tmp22B=Cyc_Tcgenrep_toplevel_name(({
...
_tuple6*_tmp22F=Cyc_Tcgenrep_toplevel_name(({struct _dyneither_ptr*_tmp237=
...
_tmp231);struct Cyc_List_List*_tmp234=((struct Cyc_List_List*(*)(struct _tuple24*(*
f)(struct Cyc_Absyn_Datatypefield*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcgenrep_check_datatypefield_and_get_nmtype,
_tmp232);struct Cyc_List_List*_tmp235=((struct Cyc_List_List*(*)(struct _tuple6*(*f)(
...
Cyc_Absyn_Public,type,_tmp235,_tmp234);}}else{struct _tuple6*_tmp238=Cyc_Tcgenrep_toplevel_name(({
...
_tmp23C=((struct Cyc_List_List*(*)(struct _tuple22*(*f)(struct Cyc_Absyn_Datatypefield*),
...
_tuple7 _tmp244;struct Cyc_Absyn_Datatypedecl*_tmp245;struct Cyc_Absyn_Datatypefield*
_tmp246;_LL51: if((_tmp243.KnownDatatypefield).tag != 2)goto _LL53;_tmp244=(struct
_tuple7)(_tmp243.KnownDatatypefield).val;_tmp245=_tmp244.f1;_tmp246=_tmp244.f2;
_LL52: {struct Cyc_List_List*_tmp247=((struct Cyc_List_List*(*)(void*(*f)(struct
_tuple16*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcgenrep_get_second,_tmp246->typs);
...
_tuple6*_tmp249=Cyc_Tcgenrep_toplevel_name(Cyc_Tcgenrep_new_gen_id(({const char*
...
_tmp24E;if(_tmp251->impl == 0){struct _tuple6*_tmp252=Cyc_Tcgenrep_toplevel_name(({
...
_tmp258));_tmp258->hd=({struct _tuple16*_tmp259=_cycalloc(sizeof(*_tmp259));
...
_tmp25F;_tmp25F.tag=11;_tmp25F.f1=chars;_tmp25F;});_tmp25E;});struct _tuple25
_tmp25B;struct Cyc_Dict_Dict _tmp25C;struct Cyc_Tcgenrep_RepInfo*_tmp25D;struct
_tuple25*_tmp25A=Cyc_Tcgenrep_lookupRep(te,dict,loc,base_type);_tmp25B=*_tmp25A;
...
else{struct _tuple6*_tmp260=Cyc_Tcgenrep_toplevel_name(({struct _dyneither_ptr*
...
0));});if(_tmp266->impl == 0){struct _tuple6*_tmp269=Cyc_Tcgenrep_toplevel_name(({
...
struct _tuple22*(*f)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*x))Cyc_List_map)(
Cyc_Tcgenrep_select_structfield_nmtype,((struct Cyc_Absyn_AggrdeclImpl*)
_check_null(_tmp266->impl))->fields);struct _tuple6*_tmp26E=Cyc_Tcgenrep_toplevel_name(({
...
Cyc_Absyn_true_conref,0);struct _tuple25 _tmp274;struct Cyc_Dict_Dict _tmp275;struct
Cyc_Tcgenrep_RepInfo*_tmp276;struct _tuple25*_tmp273=Cyc_Tcgenrep_lookupRep(te,
...
struct _tuple6*_tmp278=Cyc_Tcgenrep_toplevel_name(Cyc_Tcgenrep_new_gen_id(({const
...
struct _tuple22*(*f)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*x))Cyc_List_map)(
Cyc_Tcgenrep_select_structfield_nmtype,_tmp1E0);struct _tuple6*_tmp27B=Cyc_Tcgenrep_toplevel_name(
...
_tuple6*_tmp280=Cyc_Tcgenrep_toplevel_name(({struct _dyneither_ptr*_tmp283=
...
struct _tuple6*_tmp285=Cyc_Tcgenrep_toplevel_name(({struct _dyneither_ptr*_tmp286=
_cycalloc(sizeof(*_tmp286));_tmp286[0]=Cyc_Tcgenrep_make_type_cstring(type);
_tmp286;}));dict=Cyc_Tcgenrep_buildRepEnum((struct _tuple6**)& _tmp27F.name,te,
...
struct _tuple23*(*f)(struct Cyc_Absyn_Enumfield*),struct Cyc_List_List*x))Cyc_List_map)(
Cyc_Tcgenrep_select_enumfield_tagnm,_tmp1E4);struct _tuple6*_tmp288=Cyc_Tcgenrep_toplevel_name(
...
0));});_LL12:;}return({struct _tuple25*_tmp28E=_cycalloc(sizeof(*_tmp28E));
...
type);Cyc_Tcutil_check_valid_toplevel_type(loc,te,type);{struct _tuple25 _tmp290;
struct Cyc_Dict_Dict _tmp291;struct Cyc_Tcgenrep_RepInfo*_tmp292;struct _tuple25*
...
_tmp292);return({struct _tuple28 _tmp294;_tmp294.f1=_tmp291;_tmp294.f2=_tmp293;
