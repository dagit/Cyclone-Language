...
struct Cyc_Dict_Dict ae;struct Cyc_Tcenv_Fenv*le;};struct Cyc_Tcenv_Genv*Cyc_Tcenv_empty_genv(
struct _RegionHandle*);struct Cyc_Tcenv_Fenv*Cyc_Tcenv_new_fenv(struct
_RegionHandle*,struct Cyc_Position_Segment*,struct Cyc_Absyn_Fndecl*);struct Cyc_List_List*
...
_tag_dynforward(_tmp10,sizeof(char),_get_zero_arr_size_char(_tmp10,57));}),
...
_tag_dynforward(_tmp22,sizeof(char),_get_zero_arr_size_char(_tmp22,47));}),
...
_tag_dynforward(_tmp25,sizeof(char),_get_zero_arr_size_char(_tmp25,33));}),
...
sizeof(char),_get_zero_arr_size_char(_tmp29,48));}),_tag_dynforward(_tmp28,
sizeof(void*),2));}}});}else{struct Cyc_Absyn_Exp*_tmp2C=(struct Cyc_Absyn_Exp*)
_tmpA;void*_tmp2D=Cyc_Tcexp_tcExpInitializer(te,(void**)& _tmp9,_tmp2C);if(!Cyc_Tcutil_coerce_assign(
...
_tag_dynforward(_tmp2F,sizeof(char),_get_zero_arr_size_char(_tmp2F,57));}),
_tag_dynforward(_tmp2E,sizeof(void*),3));}}}});Cyc_Tcutil_explain_failure();}if(
!Cyc_Tcutil_is_const_exp(te,_tmp2C))({void*_tmp33=0;Cyc_Tcutil_terr(loc,({const
char*_tmp34="initializer is not a constant expression";_tag_dynforward(_tmp34,
sizeof(char),_get_zero_arr_size_char(_tmp34,41));}),_tag_dynforward(_tmp33,
...
_LL3F: goto _LL41;_LL40: if((int)_tmp35 != 4)goto _LL42;_LL41:({void*_tmp36=0;((int(*)(
struct _dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(({const char*
_tmp37="tcVardecl: fn type atts in function var decl";_tag_dynforward(_tmp37,
sizeof(char),_get_zero_arr_size_char(_tmp37,45));}),_tag_dynforward(_tmp36,
...
char),_get_zero_arr_size_char(_tmp39,41));}),_tag_dynforward(_tmp38,sizeof(void*),
1));}});goto _LL2F;_LL46:;_LL47: continue;_LL2F:;}}}{struct _handler_cons _tmp3B;
...
_tag_dynforward(_tmp49,sizeof(char),_get_zero_arr_size_char(_tmp49,57));}),
...
_tag_dynforward(_tmp4B,sizeof(char),_get_zero_arr_size_char(_tmp4B,60));}),
...
_tag_dynforward(_tmp4D,sizeof(char),_get_zero_arr_size_char(_tmp4D,47));}),
...
const char*_tmp5B="main";_tag_dynforward(_tmp5B,sizeof(char),
_get_zero_arr_size_char(_tmp5B,5));}))== 0;_LL5B:;_LL5C: return 0;_LL58:;}}struct
...
_tag_dynforward(_tmp5D,sizeof(char),_get_zero_arr_size_char(_tmp5D,54));}),
...
_LL61:({void*_tmp61=0;((int(*)(struct _dynforward_ptr fmt,struct _dynforward_ptr ap))
Cyc_Tcutil_impos)(({const char*_tmp62="tc: Abs_n in tcFndecl";_tag_dynforward(
_tmp62,sizeof(char),_get_zero_arr_size_char(_tmp62,22));}),_tag_dynforward(
_tmp61,sizeof(void*),0));});_LL62:;_LL63:({struct Cyc_String_pa_struct _tmp65;
_tmp65.tag=0;_tmp65.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Absynpp_qvar2string(
fd->name));{void*_tmp63[1]={& _tmp65};Cyc_Tcutil_terr(loc,({const char*_tmp64="qualified function declarations are not implemented (%s)";
_tag_dynforward(_tmp64,sizeof(char),_get_zero_arr_size_char(_tmp64,57));}),
...
_tag_dynforward(_tmp69,sizeof(char),_get_zero_arr_size_char(_tmp69,30));}),
...
_tag_dynforward(_tmp79,sizeof(char),_get_zero_arr_size_char(_tmp79,55));}),
...
_tag_dynforward(_tmp7B,sizeof(char),_get_zero_arr_size_char(_tmp7B,60));}),
...
_tag_dynforward(_tmp7D,sizeof(char),_get_zero_arr_size_char(_tmp7D,47));}),
...
_tag_dynforward(_tmp89,sizeof(char),_get_zero_arr_size_char(_tmp89,49));}),
...
sizeof(char),_get_zero_arr_size_char(_tmp8E,36));}),_tag_dynforward(_tmp8D,
sizeof(void*),0));});goto _LL7B;_LL7E: if(_tmp8B <= (void*)4)goto _LL80;if(*((int*)
_tmp8B)!= 5)goto _LL80;_tmp8C=(void*)((struct Cyc_Absyn_IntType_struct*)_tmp8B)->f2;
_LL7F: goto _LL7B;_LL80:;_LL81:({struct Cyc_String_pa_struct _tmp91;_tmp91.tag=0;
_tmp91.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Absynpp_typ2string((
...
_tag_dynforward(_tmp90,sizeof(char),_get_zero_arr_size_char(_tmp90,57));}),
_tag_dynforward(_tmp8F,sizeof(void*),1));}});goto _LL7B;_LL7B:;}if(fd->c_varargs
 || fd->cyc_varargs != 0)({void*_tmp92=0;Cyc_Tcutil_terr(loc,({const char*_tmp93="main declared with varargs";
_tag_dynforward(_tmp93,sizeof(char),_get_zero_arr_size_char(_tmp93,27));}),
_tag_dynforward(_tmp92,sizeof(void*),0));});{struct Cyc_List_List*_tmp94=fd->args;
if(_tmp94 != 0){struct _tuple8 _tmp96;void*_tmp97;struct _tuple8*_tmp95=(struct
_tuple8*)_tmp94->hd;_tmp96=*_tmp95;_tmp97=_tmp96.f3;{void*_tmp98=Cyc_Tcutil_compress(
_tmp97);void*_tmp99;_LL83: if(_tmp98 <= (void*)4)goto _LL85;if(*((int*)_tmp98)!= 5)
goto _LL85;_tmp99=(void*)((struct Cyc_Absyn_IntType_struct*)_tmp98)->f2;_LL84: goto
_LL82;_LL85:;_LL86:({struct Cyc_String_pa_struct _tmp9C;_tmp9C.tag=0;_tmp9C.f1=(
struct _dynforward_ptr)((struct _dynforward_ptr)Cyc_Absynpp_typ2string(_tmp97));{
void*_tmp9A[1]={& _tmp9C};Cyc_Tcutil_terr(loc,({const char*_tmp9B="main declared with first argument of type %s instead of int";
_tag_dynforward(_tmp9B,sizeof(char),_get_zero_arr_size_char(_tmp9B,60));}),
...
_tag_dynforward(_tmpA1,sizeof(char),_get_zero_arr_size_char(_tmpA1,38));}),
...
_tag_dynforward(_tmpAB,sizeof(char),_get_zero_arr_size_char(_tmpAB,54));}),
...
_tag_dynforward(_tmpB2,sizeof(char),_get_zero_arr_size_char(_tmpB2,56));}),
...
_get_zero_arr_size_char(_tmpB5,28));}),_tag_dynforward(_tmpB4,sizeof(void*),1));}});
...
_tag_dynforward(_tmpBF,sizeof(char),_get_zero_arr_size_char(_tmpBF,51));}),
...
_tag_dynforward(_tmpD1,sizeof(char),_get_zero_arr_size_char(_tmpD1,19));}),
...
_get_zero_arr_size_char(_tmpD3,1));}))!= 0)prev_fields=({struct Cyc_List_List*
_tmpD4=_region_malloc(uprev_rgn,sizeof(*_tmpD4));_tmpD4->hd=_tmpCB;_tmpD4->tl=
...
_tag_dynforward(_tmpD8,sizeof(char),_get_zero_arr_size_char(_tmpD8,35));}),
...
_tag_dynforward(_tmpE8,sizeof(char),_get_zero_arr_size_char(_tmpE8,56));}),
...
_tag_dynforward(_tmpEF,sizeof(char),_get_zero_arr_size_char(_tmpEF,55));}),
...
_tag_dynforward(_tmp109,sizeof(char),_get_zero_arr_size_char(_tmp109,98));}),
...
_tag_dynforward(_tmp110,sizeof(char),_get_zero_arr_size_char(_tmp110,52));}),
...
_tag_dynforward(_tmp11A,sizeof(char),_get_zero_arr_size_char(_tmp11A,58));}),
...
_tag_dynforward(_tmp120,sizeof(char),_get_zero_arr_size_char(_tmp120,56));}),
...
void*_tmp122=0;((int(*)(struct _dynforward_ptr fmt,struct _dynforward_ptr ap))Cyc_Tcutil_impos)(({
const char*_tmp123="tcTunionFields: Loc_n";_tag_dynforward(_tmp123,sizeof(char),
_get_zero_arr_size_char(_tmp123,22));}),_tag_dynforward(_tmp122,sizeof(void*),0));});
_LLB7:;}}}{struct Cyc_List_List*fields2;if(is_xtunion){int _tmp124=1;struct Cyc_List_List*
_tmp125=Cyc_Tcdecl_sort_xtunion_fields(fields,& _tmp124,(*name).f2,loc,Cyc_Tc_tc_msg);
if(_tmp124)fields2=_tmp125;else{fields2=0;}}else{struct _RegionHandle _tmp126=
_new_region("uprev_rgn");struct _RegionHandle*uprev_rgn=& _tmp126;_push_region(
uprev_rgn);{struct Cyc_List_List*prev_fields=0;{struct Cyc_List_List*fs=fields;
for(0;fs != 0;fs=fs->tl){struct Cyc_Absyn_Tunionfield*_tmp127=(struct Cyc_Absyn_Tunionfield*)
...
prev_fields,(*_tmp127->name).f2))({struct Cyc_String_pa_struct _tmp12B;_tmp12B.tag=
0;_tmp12B.f1=(struct _dynforward_ptr)((struct _dynforward_ptr)obj);{struct Cyc_String_pa_struct
...
sizeof(char),_get_zero_arr_size_char(_tmp129,30));}),_tag_dynforward(_tmp128,
sizeof(void*),2));}}});else{prev_fields=({struct Cyc_List_List*_tmp12C=
_region_malloc(uprev_rgn,sizeof(*_tmp12C));_tmp12C->hd=(*_tmp127->name).f2;
_tmp12C->tl=prev_fields;_tmp12C;});}if((void*)_tmp127->sc != (void*)2){({struct
Cyc_String_pa_struct _tmp12F;_tmp12F.tag=0;_tmp12F.f1=(struct _dynforward_ptr)((
struct _dynforward_ptr)*(*_tmp127->name).f2);{void*_tmp12D[1]={& _tmp12F};Cyc_Tcutil_warn(
loc,({const char*_tmp12E="ignoring scope of field %s";_tag_dynforward(_tmp12E,
sizeof(char),_get_zero_arr_size_char(_tmp12E,27));}),_tag_dynforward(_tmp12D,
sizeof(void*),1));}});(void*)(_tmp127->sc=(void*)((void*)2));}}}fields2=fields;};
_pop_region(uprev_rgn);}{struct Cyc_List_List*_tmp130=fields;for(0;_tmp130 != 0;
_tmp130=_tmp130->tl){struct Cyc_Absyn_Tunionfield*_tmp131=(struct Cyc_Absyn_Tunionfield*)
_tmp130->hd;ge->ordinaries=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct
_dynforward_ptr*k,struct _tuple7*v))Cyc_Dict_insert)(ge->ordinaries,(*_tmp131->name).f2,(
struct _tuple7*)({struct _tuple7*_tmp132=_cycalloc(sizeof(*_tmp132));_tmp132->f1=(
void*)({struct Cyc_Tcenv_TunionRes_struct*_tmp133=_cycalloc(sizeof(*_tmp133));
_tmp133[0]=({struct Cyc_Tcenv_TunionRes_struct _tmp134;_tmp134.tag=2;_tmp134.f1=
tudres;_tmp134.f2=_tmp131;_tmp134;});_tmp133;});_tmp132->f2=1;_tmp132;}));}}
return fields2;}}struct _tuple11{struct Cyc_Core_Opt*f1;struct Cyc_Absyn_Tuniondecl***
...
_dynforward_ptr*v=(*tud->name).f2;struct _dynforward_ptr obj=tud->is_xtunion?({
const char*_tmp183="xtunion";_tag_dynforward(_tmp183,sizeof(char),
_get_zero_arr_size_char(_tmp183,8));}):({const char*_tmp184="tunion";
_tag_dynforward(_tmp184,sizeof(char),_get_zero_arr_size_char(_tmp184,7));});
...
_tag_dynforward(_tmp14A,sizeof(char),_get_zero_arr_size_char(_tmp14A,55));}),
...
_tag_dynforward(_tmp14F,sizeof(char),_get_zero_arr_size_char(_tmp14F,55));}),
...
_tag_dynforward(_tmp154,sizeof(char),_get_zero_arr_size_char(_tmp154,54));}),
...
_tag_dynforward(_tmp15F,sizeof(char),_get_zero_arr_size_char(_tmp15F,60));}),
...
_tag_dynforward(_tmp166,sizeof(char),_get_zero_arr_size_char(_tmp166,55));}),
...
_tag_dynforward(_tmp189,sizeof(char),_get_zero_arr_size_char(_tmp189,53));}),
...
_tag_dynforward(_tmp18F,sizeof(char),_get_zero_arr_size_char(_tmp18F,24));}),
...
_tag_dynforward(_tmp193,sizeof(char),_get_zero_arr_size_char(_tmp193,46));}),
...
_tag_dynforward(_tmp19A,sizeof(char),_get_zero_arr_size_char(_tmp19A,48));}),
...
_tag_dynforward(_tmp1AB,sizeof(char),_get_zero_arr_size_char(_tmp1AB,44));}),
...
_tag_dynforward(_tmp1AD,sizeof(char),_get_zero_arr_size_char(_tmp1AD,46));}),
...
_tag_dynforward(_tmp1AF,sizeof(char),_get_zero_arr_size_char(_tmp1AF,30));}),
...
_tag_dynforward(_tmp1BB,sizeof(char),_get_zero_arr_size_char(_tmp1BB,52));}),
...
_tag_dynforward(_tmp1D1,sizeof(char),_get_zero_arr_size_char(_tmp1D1,47));}),
...
_tag_dynforward(_tmp1DA,sizeof(char),_get_zero_arr_size_char(_tmp1DA,29));}),
...
char),_get_zero_arr_size_char(_tmp1EE,31));}),_tag_dynforward(_tmp1ED,sizeof(
void*),1));}});}goto _LL108;}_LL108:;}}void Cyc_Tc_tc(struct _RegionHandle*g,struct
Cyc_Tcenv_Tenv*te,int check_var_init,struct Cyc_List_List*ds){Cyc_Absynpp_set_params(&
...
struct Cyc_List_List*ds){return((struct Cyc_List_List*(*)(int(*f)(struct Cyc_Tc_TreeshakeEnv*,
