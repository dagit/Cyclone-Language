...
unsigned char Cyc_List_Nth[8];int isdigit(int);unsigned int Cyc_Std_strlen(struct
_tagged_arr s);struct _tagged_arr Cyc_Std_implode(struct Cyc_List_List*c);struct Cyc_Lineno_Pos{
...
_tagged_arr desc;};extern unsigned char Cyc_Position_Nocontext[14];struct Cyc_Cstdio___abstractFILE;
...
15];struct Cyc_Absyn_Tqual Cyc_Absyn_empty_tqual();void*Cyc_Absyn_new_evar(struct
Cyc_Core_Opt*k,struct Cyc_Core_Opt*tenv);extern void*Cyc_Absyn_uchar_t;extern void*
...
extern void*Cyc_Absyn_slong_t;extern void*Cyc_Absyn_float_typ;void*Cyc_Absyn_double_typ(
int);void*Cyc_Absyn_string_typ(void*rgn);void*Cyc_Absyn_const_string_typ(void*
rgn);void*Cyc_Absyn_at_typ(void*t,void*rgn,struct Cyc_Absyn_Tqual tq);struct Cyc_Iter_Iter{
...
_tagged_arr ap);struct Cyc_List_List*Cyc_Formatstr_get_format_typs(struct Cyc_Tcenv_Tenv*,
struct _tagged_arr,struct Cyc_Position_Segment*);struct Cyc_List_List*Cyc_Formatstr_get_scanf_typs(
struct Cyc_Tcenv_Tenv*,struct _tagged_arr,struct Cyc_Position_Segment*);struct Cyc_Core_Opt*
Cyc_Formatstr_parse_conversionspecification(struct _tagged_arr s,int i);static
struct Cyc_Core_Opt Cyc_Formatstr_rk={(void*)((void*)3)};struct _tuple4{struct Cyc_List_List*
f1;struct Cyc_List_List*f2;struct Cyc_List_List*f3;struct Cyc_List_List*f4;
unsigned char f5;int f6;};struct Cyc_Core_Opt*Cyc_Formatstr_parse_conversionspecification(
...
_tuple4 _tmp17;struct Cyc_List_List*_tmp18;struct Cyc_List_List*_tmp19;struct Cyc_List_List*
_tmp1A;struct Cyc_List_List*_tmp1B;unsigned char _tmp1C;int _tmp1D;struct _tuple4*
_tmp16=(struct _tuple4*)_tmp14->v;_tmp17=*_tmp16;_tmp18=_tmp17.f1;_tmp19=_tmp17.f2;
_tmp1A=_tmp17.f3;_tmp1B=_tmp17.f4;_tmp1C=_tmp17.f5;_tmp1D=_tmp17.f6;i=_tmp1D - 1;{
struct Cyc_List_List*_tmp1E=_tmp1B;struct Cyc_List_List _tmp1F;int _tmp20;struct Cyc_List_List*
...
sizeof(unsigned char),38),_tag_arr(_tmp22,sizeof(void*),1));}});return 0;_LL27:;
_LL28: goto _LL24;_LL24:;}{struct Cyc_List_List*_tmp24=_tmp19;struct Cyc_List_List
_tmp25;int _tmp26;struct Cyc_List_List*_tmp27;_LL2A: if(_tmp24 == 0)goto _LL2C;_tmp25=*
_tmp24;_tmp26=(int)_tmp25.hd;_tmp27=_tmp25.tl;if(_tmp27 != 0)goto _LL2C;if(!(
_tmp26 == '*'))goto _LL2C;_LL2B: _tmp13=({struct Cyc_List_List*_tmp28=_cycalloc(
sizeof(*_tmp28));_tmp28->hd=(void*)Cyc_Absyn_sint_t;_tmp28->tl=_tmp13;_tmp28;});
goto _LL29;_LL2C:;_LL2D: goto _LL29;_LL29:;}{struct Cyc_List_List*_tmp29=_tmp1A;
struct Cyc_List_List _tmp2A;int _tmp2B;struct Cyc_List_List*_tmp2C;struct Cyc_List_List
_tmp2D;int _tmp2E;struct Cyc_List_List*_tmp2F;_LL2F: if(_tmp29 == 0)goto _LL31;_tmp2A=*
_tmp29;_tmp2B=(int)_tmp2A.hd;_tmp2C=_tmp2A.tl;if(_tmp2C == 0)goto _LL31;_tmp2D=*
_tmp2C;_tmp2E=(int)_tmp2D.hd;_tmp2F=_tmp2D.tl;if(_tmp2F != 0)goto _LL31;if(!(
_tmp2B == '.'?_tmp2E == '*': 0))goto _LL31;_LL30: _tmp13=({struct Cyc_List_List*_tmp30=
_cycalloc(sizeof(*_tmp30));_tmp30->hd=(void*)Cyc_Absyn_sint_t;_tmp30->tl=_tmp13;
_tmp30;});goto _LL2E;_LL31:;_LL32: goto _LL2E;_LL2E:;}{void*t;switch(_tmp1C){case 'd':
_LL33: goto _LL34;case 'i': _LL34:{struct Cyc_List_List*f=_tmp18;for(0;f != 0;f=f->tl){
if((int)f->hd == '#'){({struct Cyc_Std_Int_pa_struct _tmp32;_tmp32.tag=1;_tmp32.f1=(
int)((unsigned int)((int)_tmp1C));{void*_tmp31[1]={& _tmp32};Cyc_Tcutil_terr(loc,
_tag_arr("flag '#' is not valid with %%%c",sizeof(unsigned char),32),_tag_arr(
_tmp31,sizeof(void*),1));}});return 0;}}}{struct Cyc_List_List*_tmp33=_tmp1B;
struct Cyc_List_List _tmp34;int _tmp35;struct Cyc_List_List*_tmp36;struct Cyc_List_List
...
_tmp3F;_LL37: if(_tmp33 != 0)goto _LL39;_LL38: t=Cyc_Absyn_sint_t;goto _LL36;_LL39:
if(_tmp33 == 0)goto _LL3B;_tmp34=*_tmp33;_tmp35=(int)_tmp34.hd;_tmp36=_tmp34.tl;
if(_tmp36 != 0)goto _LL3B;if(!(_tmp35 == 'l'))goto _LL3B;_LL3A: t=Cyc_Absyn_slong_t;
goto _LL36;_LL3B: if(_tmp33 == 0)goto _LL3D;_tmp37=*_tmp33;_tmp38=(int)_tmp37.hd;
_tmp39=_tmp37.tl;if(_tmp39 != 0)goto _LL3D;if(!(_tmp38 == 'h'))goto _LL3D;_LL3C: t=
Cyc_Absyn_sshort_t;goto _LL36;_LL3D: if(_tmp33 == 0)goto _LL3F;_tmp3A=*_tmp33;_tmp3B=(
int)_tmp3A.hd;_tmp3C=_tmp3A.tl;if(_tmp3C == 0)goto _LL3F;_tmp3D=*_tmp3C;_tmp3E=(
int)_tmp3D.hd;_tmp3F=_tmp3D.tl;if(_tmp3F != 0)goto _LL3F;if(!(_tmp3B == 'h'?_tmp3E
== 'h': 0))goto _LL3F;_LL3E: t=Cyc_Absyn_schar_t;goto _LL36;_LL3F:;_LL40:({struct Cyc_Std_Int_pa_struct
...
sizeof(unsigned char),46),_tag_arr(_tmp40,sizeof(void*),2));}}});return 0;_LL36:;}
_tmp13=({struct Cyc_List_List*_tmp43=_cycalloc(sizeof(*_tmp43));_tmp43->hd=(void*)
t;_tmp43->tl=_tmp13;_tmp43;});break;case 'u': _LL35:{struct Cyc_List_List*f=_tmp18;
for(0;f != 0;f=f->tl){if((int)f->hd == '#'){({void*_tmp44[0]={};Cyc_Tcutil_terr(
loc,_tag_arr("Flag '#' not valid with %%u",sizeof(unsigned char),28),_tag_arr(
_tmp44,sizeof(void*),0));});return 0;}}}goto _LL41;case 'o': _LL41: goto _LL42;case 'x':
_LL42: goto _LL43;case 'X': _LL43:{struct Cyc_List_List*_tmp45=_tmp1B;struct Cyc_List_List
_tmp46;int _tmp47;struct Cyc_List_List*_tmp48;struct Cyc_List_List _tmp49;int _tmp4A;
struct Cyc_List_List*_tmp4B;struct Cyc_List_List _tmp4C;int _tmp4D;struct Cyc_List_List*
_tmp4E;struct Cyc_List_List _tmp4F;int _tmp50;struct Cyc_List_List*_tmp51;_LL46: if(
_tmp45 != 0)goto _LL48;_LL47: t=Cyc_Absyn_uint_t;goto _LL45;_LL48: if(_tmp45 == 0)goto
_LL4A;_tmp46=*_tmp45;_tmp47=(int)_tmp46.hd;_tmp48=_tmp46.tl;if(_tmp48 != 0)goto
_LL4A;if(!(_tmp47 == 'l'))goto _LL4A;_LL49: t=Cyc_Absyn_ulong_t;goto _LL45;_LL4A: if(
_tmp45 == 0)goto _LL4C;_tmp49=*_tmp45;_tmp4A=(int)_tmp49.hd;_tmp4B=_tmp49.tl;if(
_tmp4B != 0)goto _LL4C;if(!(_tmp4A == 'h'))goto _LL4C;_LL4B: t=Cyc_Absyn_ushort_t;
goto _LL45;_LL4C: if(_tmp45 == 0)goto _LL4E;_tmp4C=*_tmp45;_tmp4D=(int)_tmp4C.hd;
_tmp4E=_tmp4C.tl;if(_tmp4E == 0)goto _LL4E;_tmp4F=*_tmp4E;_tmp50=(int)_tmp4F.hd;
_tmp51=_tmp4F.tl;if(_tmp51 != 0)goto _LL4E;if(!(_tmp4D == 'h'?_tmp50 == 'h': 0))goto
_LL4E;_LL4D: t=Cyc_Absyn_uchar_t;goto _LL45;_LL4E:;_LL4F:({struct Cyc_Std_Int_pa_struct
_tmp54;_tmp54.tag=1;_tmp54.f1=(int)((unsigned int)((int)_tmp1C));{struct Cyc_Std_String_pa_struct
_tmp53;_tmp53.tag=0;_tmp53.f1=(struct _tagged_arr)Cyc_Std_implode(_tmp1B);{void*
_tmp52[2]={& _tmp53,& _tmp54};Cyc_Tcutil_terr(loc,_tag_arr("length modifier '%s' is not allowed with %%%c",
sizeof(unsigned char),46),_tag_arr(_tmp52,sizeof(void*),2));}}});return 0;_LL45:;}
_tmp13=({struct Cyc_List_List*_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55->hd=(void*)
t;_tmp55->tl=_tmp13;_tmp55;});break;case 'f': _LL44: goto _LL50;case 'F': _LL50: goto
_LL51;case 'e': _LL51: goto _LL52;case 'E': _LL52: goto _LL53;case 'g': _LL53: goto _LL54;
case 'G': _LL54: goto _LL55;case 'a': _LL55: goto _LL56;case 'A': _LL56: if(_tmp1B != 0){({
struct Cyc_Std_Int_pa_struct _tmp57;_tmp57.tag=1;_tmp57.f1=(int)((unsigned int)((
int)_tmp1C));{void*_tmp56[1]={& _tmp57};Cyc_Tcutil_terr(loc,_tag_arr("length modifiers are not allowed with %%%c",
...
unsigned char),31),_tag_arr(_tmp59,sizeof(void*),1));}});return 0;}}}if(_tmp1B != 
0){({struct Cyc_Std_String_pa_struct _tmp5C;_tmp5C.tag=0;_tmp5C.f1=(struct
_tagged_arr)Cyc_Std_implode(_tmp1B);{void*_tmp5B[1]={& _tmp5C};Cyc_Tcutil_terr(
loc,_tag_arr("length modifier '%s' not allowed with %%c",sizeof(unsigned char),
42),_tag_arr(_tmp5B,sizeof(void*),1));}});return 0;}if(_tmp1A != 0){({struct Cyc_Std_String_pa_struct
_tmp5E;_tmp5E.tag=0;_tmp5E.f1=(struct _tagged_arr)Cyc_Std_implode(_tmp1A);{void*
...
_tmp60,sizeof(void*),0));});return 0;}}}if(_tmp1B != 0){({void*_tmp61[0]={};Cyc_Tcutil_terr(
...
_tmp63;})));_tmp62->tl=_tmp13;_tmp62;});break;case 'p': _LL59: _tmp13=({struct Cyc_List_List*
...
unsigned char),31),_tag_arr(_tmp65,sizeof(void*),1));}});return 0;}}}if(_tmp1A != 
0){({struct Cyc_Std_String_pa_struct _tmp68;_tmp68.tag=0;_tmp68.f1=(struct
_tagged_arr)Cyc_Std_implode(_tmp1A);{void*_tmp67[1]={& _tmp68};Cyc_Tcutil_terr(
...
t=Cyc_Absyn_sint_t;goto _LL5C;_LL5F: if(_tmp6A == 0)goto _LL61;_tmp6B=*_tmp6A;_tmp6C=(
int)_tmp6B.hd;_tmp6D=_tmp6B.tl;if(_tmp6D != 0)goto _LL61;if(!(_tmp6C == 'l'))goto
_LL61;_LL60: t=Cyc_Absyn_ulong_t;goto _LL5C;_LL61: if(_tmp6A == 0)goto _LL63;_tmp6E=*
_tmp6A;_tmp6F=(int)_tmp6E.hd;_tmp70=_tmp6E.tl;if(_tmp70 != 0)goto _LL63;if(!(
_tmp6F == 'h'))goto _LL63;_LL62: t=Cyc_Absyn_sshort_t;goto _LL5C;_LL63: if(_tmp6A == 0)
goto _LL65;_tmp71=*_tmp6A;_tmp72=(int)_tmp71.hd;_tmp73=_tmp71.tl;if(_tmp73 == 0)
goto _LL65;_tmp74=*_tmp73;_tmp75=(int)_tmp74.hd;_tmp76=_tmp74.tl;if(_tmp76 != 0)
goto _LL65;if(!(_tmp72 == 'h'?_tmp75 == 'h': 0))goto _LL65;_LL64: t=Cyc_Absyn_schar_t;
...
sizeof(unsigned char),46),_tag_arr(_tmp77,sizeof(void*),2));}}});return 0;_LL5C:;}
...
_LL5B: if(_tmp18 != 0){({struct Cyc_Std_String_pa_struct _tmp7D;_tmp7D.tag=0;_tmp7D.f1=(
struct _tagged_arr)Cyc_Std_implode(_tmp18);{void*_tmp7C[1]={& _tmp7D};Cyc_Tcutil_terr(
loc,_tag_arr("flags '%s' not allowed with %%%%",sizeof(unsigned char),33),
_tag_arr(_tmp7C,sizeof(void*),1));}});return 0;}if(_tmp19 != 0){({struct Cyc_Std_String_pa_struct
_tmp7F;_tmp7F.tag=0;_tmp7F.f1=(struct _tagged_arr)Cyc_Std_implode(_tmp19);{void*
...
_tmp1A != 0){({struct Cyc_Std_String_pa_struct _tmp81;_tmp81.tag=0;_tmp81.f1=(
struct _tagged_arr)Cyc_Std_implode(_tmp1A);{void*_tmp80[1]={& _tmp81};Cyc_Tcutil_terr(
loc,_tag_arr("precision '%s' not allowed with %%%%",sizeof(unsigned char),37),
_tag_arr(_tmp80,sizeof(void*),1));}});return 0;}if(_tmp1B != 0){({struct Cyc_Std_String_pa_struct
_tmp83;_tmp83.tag=0;_tmp83.f1=(struct _tagged_arr)Cyc_Std_implode(_tmp1B);{void*
...
default: _LL67: return 0;}}}}}return Cyc_List_imp_rev(_tmp13);}struct _tuple5{int f1;
...
i];if(isdigit((int)_tmp86))_tmp87=({struct Cyc_List_List*_tmp88=_cycalloc(sizeof(*
_tmp88));_tmp88->hd=(void*)((int)_tmp86);_tmp88->tl=_tmp87;_tmp88;});else{break;}}
if(i >= _tmp84)return 0;_tmp87=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))
Cyc_List_imp_rev)(_tmp87);{struct Cyc_List_List*_tmp89=0;_tmp86=((const
unsigned char*)s.curr)[i];switch(_tmp86){case 'h': _LL69: _tmp89=({struct Cyc_List_List*
...
const unsigned char*)s.curr)[i];if(_tmp86 == 'l'){_tmp89=({struct Cyc_List_List*
_tmp8D=_cycalloc(sizeof(*_tmp8D));_tmp8D->hd=(void*)((int)_tmp86);_tmp8D->tl=
_tmp89;_tmp8D;});i ++;}break;case 'j': _LL6B: goto _LL6C;case 'z': _LL6C: goto _LL6D;case
't': _LL6D: goto _LL6E;case 'L': _LL6E: _tmp89=({struct Cyc_List_List*_tmp8E=_cycalloc(
sizeof(*_tmp8E));_tmp8E->hd=(void*)((int)_tmp86);_tmp8E->tl=_tmp89;_tmp8E;});i ++;
break;default: _LL6F: break;}if(i >= _tmp84)return 0;_tmp89=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp89);_tmp86=((const unsigned char*)s.curr)[
i];switch(_tmp86){case 'd': _LL71: goto _LL72;case 'i': _LL72: goto _LL73;case 'o': _LL73:
goto _LL74;case 'u': _LL74: goto _LL75;case 'x': _LL75: goto _LL76;case 'X': _LL76: goto
_LL77;case 'f': _LL77: goto _LL78;case 'F': _LL78: goto _LL79;case 'e': _LL79: goto _LL7A;
case 'E': _LL7A: goto _LL7B;case 'g': _LL7B: goto _LL7C;case 'G': _LL7C: goto _LL7D;case 'a':
_LL7D: goto _LL7E;case 'A': _LL7E: goto _LL7F;case 'c': _LL7F: goto _LL80;case 's': _LL80:
goto _LL81;case 'p': _LL81: goto _LL82;case 'n': _LL82: goto _LL83;case '%': _LL83: break;
default: _LL84: return 0;}return({struct Cyc_Core_Opt*_tmp8F=_cycalloc(sizeof(*
_tmp8F));_tmp8F->v=({struct _tuple5*_tmp90=_cycalloc(sizeof(*_tmp90));_tmp90->f1=
...
_tag_arr(_tmp94,sizeof(void*),0));});return 0;}{struct _tuple5 _tmp96;int _tmp97;
struct Cyc_List_List*_tmp98;struct Cyc_List_List*_tmp99;unsigned char _tmp9A;int
_tmp9B;struct _tuple5*_tmp95=(struct _tuple5*)_tmp93->v;_tmp96=*_tmp95;_tmp97=
_tmp96.f1;_tmp98=_tmp96.f2;_tmp99=_tmp96.f3;_tmp9A=_tmp96.f4;_tmp9B=_tmp96.f5;i=
_tmp9B - 1;{struct Cyc_List_List*_tmp9C=_tmp99;struct Cyc_List_List _tmp9D;int _tmp9E;
struct Cyc_List_List*_tmp9F;_LL87: if(_tmp9C == 0)goto _LL89;_tmp9D=*_tmp9C;_tmp9E=(
int)_tmp9D.hd;_tmp9F=_tmp9D.tl;if(_tmp9F != 0)goto _LL89;if(!((_tmp9E == 'j'?1:
_tmp9E == 'z')?1: _tmp9E == 't'))goto _LL89;_LL88:({struct Cyc_Std_Int_pa_struct
_tmpA1;_tmpA1.tag=1;_tmpA1.f1=(int)((unsigned int)_tmp9E);{void*_tmpA0[1]={&
_tmpA1};Cyc_Tcutil_terr(loc,_tag_arr("length modifier '%c' is not supported",
sizeof(unsigned char),38),_tag_arr(_tmpA0,sizeof(void*),1));}});return 0;_LL89:;
_LL8A: goto _LL86;_LL86:;}if(_tmp97)continue;{void*t;switch(_tmp9A){case 'd': _LL8B:
goto _LL8C;case 'i': _LL8C: {struct Cyc_Core_Opt*_tmpA2=({struct Cyc_Core_Opt*_tmpB4=
_cycalloc(sizeof(*_tmpB4));_tmpB4->v=Cyc_Tcenv_lookup_type_vars(te);_tmpB4;});{
struct Cyc_List_List*_tmpA3=_tmp99;struct Cyc_List_List _tmpA4;int _tmpA5;struct Cyc_List_List*
_tmpA6;struct Cyc_List_List _tmpA7;int _tmpA8;struct Cyc_List_List*_tmpA9;struct Cyc_List_List
_tmpAA;int _tmpAB;struct Cyc_List_List*_tmpAC;struct Cyc_List_List _tmpAD;int _tmpAE;
struct Cyc_List_List*_tmpAF;_LL8F: if(_tmpA3 != 0)goto _LL91;_LL90: t=Cyc_Absyn_sint_t;
...
Cyc_Absyn_slong_t;goto _LL8E;_LL93: if(_tmpA3 == 0)goto _LL95;_tmpA7=*_tmpA3;_tmpA8=(
int)_tmpA7.hd;_tmpA9=_tmpA7.tl;if(_tmpA9 != 0)goto _LL95;if(!(_tmpA8 == 'h'))goto
_LL95;_LL94: t=Cyc_Absyn_sshort_t;goto _LL8E;_LL95: if(_tmpA3 == 0)goto _LL97;_tmpAA=*
_tmpA3;_tmpAB=(int)_tmpAA.hd;_tmpAC=_tmpAA.tl;if(_tmpAC == 0)goto _LL97;_tmpAD=*
_tmpAC;_tmpAE=(int)_tmpAD.hd;_tmpAF=_tmpAD.tl;if(_tmpAF != 0)goto _LL97;if(!(
_tmpAB == 'h'?_tmpAE == 'h': 0))goto _LL97;_LL96: t=Cyc_Absyn_schar_t;goto _LL8E;_LL97:;
_LL98:({struct Cyc_Std_Int_pa_struct _tmpB2;_tmpB2.tag=1;_tmpB2.f1=(int)((
unsigned int)((int)_tmp9A));{struct Cyc_Std_String_pa_struct _tmpB1;_tmpB1.tag=0;
_tmpB1.f1=(struct _tagged_arr)Cyc_Std_implode(_tmp99);{void*_tmpB0[2]={& _tmpB1,&
_tmpB2};Cyc_Tcutil_terr(loc,_tag_arr("length modifier '%s' is not allowed with %%%c",
sizeof(unsigned char),46),_tag_arr(_tmpB0,sizeof(void*),2));}}});return 0;_LL8E:;}
t=Cyc_Absyn_at_typ(t,Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Formatstr_rk,
...
_LL8D: goto _LL99;case 'o': _LL99: goto _LL9A;case 'x': _LL9A: goto _LL9B;case 'X': _LL9B: {
...
_tmp99;struct Cyc_List_List _tmpB7;int _tmpB8;struct Cyc_List_List*_tmpB9;struct Cyc_List_List
_tmpBA;int _tmpBB;struct Cyc_List_List*_tmpBC;struct Cyc_List_List _tmpBD;int _tmpBE;
struct Cyc_List_List*_tmpBF;struct Cyc_List_List _tmpC0;int _tmpC1;struct Cyc_List_List*
_tmpC2;_LL9E: if(_tmpB6 != 0)goto _LLA0;_LL9F: t=Cyc_Absyn_uint_t;goto _LL9D;_LLA0:
if(_tmpB6 == 0)goto _LLA2;_tmpB7=*_tmpB6;_tmpB8=(int)_tmpB7.hd;_tmpB9=_tmpB7.tl;
if(_tmpB9 != 0)goto _LLA2;if(!(_tmpB8 == 'l'))goto _LLA2;_LLA1: t=Cyc_Absyn_ulong_t;
goto _LL9D;_LLA2: if(_tmpB6 == 0)goto _LLA4;_tmpBA=*_tmpB6;_tmpBB=(int)_tmpBA.hd;
_tmpBC=_tmpBA.tl;if(_tmpBC != 0)goto _LLA4;if(!(_tmpBB == 'h'))goto _LLA4;_LLA3: t=
Cyc_Absyn_ushort_t;goto _LL9D;_LLA4: if(_tmpB6 == 0)goto _LLA6;_tmpBD=*_tmpB6;_tmpBE=(
int)_tmpBD.hd;_tmpBF=_tmpBD.tl;if(_tmpBF == 0)goto _LLA6;_tmpC0=*_tmpBF;_tmpC1=(
int)_tmpC0.hd;_tmpC2=_tmpC0.tl;if(_tmpC2 != 0)goto _LLA6;if(!(_tmpBE == 'h'?_tmpC1
== 'h': 0))goto _LLA6;_LLA5: t=Cyc_Absyn_uchar_t;goto _LL9D;_LLA6:;_LLA7:({struct Cyc_Std_Int_pa_struct
_tmpC5;_tmpC5.tag=1;_tmpC5.f1=(int)((unsigned int)((int)_tmp9A));{struct Cyc_Std_String_pa_struct
_tmpC4;_tmpC4.tag=0;_tmpC4.f1=(struct _tagged_arr)Cyc_Std_implode(_tmp99);{void*
_tmpC3[2]={& _tmpC4,& _tmpC5};Cyc_Tcutil_terr(loc,_tag_arr("length modifier '%s' is not allowed with %%%c",
sizeof(unsigned char),46),_tag_arr(_tmpC3,sizeof(void*),2));}}});return 0;_LL9D:;}
t=Cyc_Absyn_at_typ(t,Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Formatstr_rk,
_tmpB5),Cyc_Absyn_empty_tqual());_tmp92=({struct Cyc_List_List*_tmpC6=_cycalloc(
sizeof(*_tmpC6));_tmpC6->hd=(void*)t;_tmpC6->tl=_tmp92;_tmpC6;});break;}case 'f':
_LL9C: goto _LLA8;case 'F': _LLA8: goto _LLA9;case 'e': _LLA9: goto _LLAA;case 'E': _LLAA:
goto _LLAB;case 'g': _LLAB: goto _LLAC;case 'G': _LLAC: goto _LLAD;case 'a': _LLAD: goto
_LLAE;case 'A': _LLAE: {struct Cyc_Core_Opt*_tmpC8=({struct Cyc_Core_Opt*_tmpD1=
_cycalloc(sizeof(*_tmpD1));_tmpD1->v=Cyc_Tcenv_lookup_type_vars(te);_tmpD1;});{
struct Cyc_List_List*_tmpC9=_tmp99;struct Cyc_List_List _tmpCA;int _tmpCB;struct Cyc_List_List*
_tmpCC;_LLB1: if(_tmpC9 != 0)goto _LLB3;_LLB2: t=Cyc_Absyn_float_typ;goto _LLB0;_LLB3:
if(_tmpC9 == 0)goto _LLB5;_tmpCA=*_tmpC9;_tmpCB=(int)_tmpCA.hd;_tmpCC=_tmpCA.tl;
if(_tmpCC != 0)goto _LLB5;if(!(_tmpCB == 'l'))goto _LLB5;_LLB4: t=Cyc_Absyn_double_typ(
0);goto _LLB0;_LLB5:;_LLB6:({struct Cyc_Std_Int_pa_struct _tmpCF;_tmpCF.tag=1;
_tmpCF.f1=(int)((unsigned int)((int)_tmp9A));{struct Cyc_Std_String_pa_struct
...
sizeof(unsigned char),46),_tag_arr(_tmpCD,sizeof(void*),2));}}});return 0;_LLB0:;}
t=Cyc_Absyn_at_typ(t,Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Formatstr_rk,
...
_LLAF: goto _LLB7;case 's': _LLB7: {struct Cyc_Core_Opt*_tmpD2=({struct Cyc_Core_Opt*
...
_tmpD2));_tmpD3->tl=_tmp92;_tmpD3;});break;}case '[': _LLB8: goto _LLB9;case 'p':
_LLB9:({struct Cyc_Std_Int_pa_struct _tmpD6;_tmpD6.tag=1;_tmpD6.f1=(int)((
unsigned int)((int)_tmp9A));{void*_tmpD5[1]={& _tmpD6};Cyc_Tcutil_terr(loc,
_tag_arr("%%%c is not supported",sizeof(unsigned char),22),_tag_arr(_tmpD5,
sizeof(void*),1));}});return 0;case 'n': _LLBA: {struct Cyc_Core_Opt*_tmpD7=({struct
Cyc_Core_Opt*_tmpE9=_cycalloc(sizeof(*_tmpE9));_tmpE9->v=Cyc_Tcenv_lookup_type_vars(
...
t=Cyc_Absyn_sint_t;goto _LLBC;_LLBF: if(_tmpD8 == 0)goto _LLC1;_tmpD9=*_tmpD8;_tmpDA=(
int)_tmpD9.hd;_tmpDB=_tmpD9.tl;if(_tmpDB != 0)goto _LLC1;if(!(_tmpDA == 'l'))goto
_LLC1;_LLC0: t=Cyc_Absyn_ulong_t;goto _LLBC;_LLC1: if(_tmpD8 == 0)goto _LLC3;_tmpDC=*
_tmpD8;_tmpDD=(int)_tmpDC.hd;_tmpDE=_tmpDC.tl;if(_tmpDE != 0)goto _LLC3;if(!(
_tmpDD == 'h'))goto _LLC3;_LLC2: t=Cyc_Absyn_sshort_t;goto _LLBC;_LLC3: if(_tmpD8 == 0)
goto _LLC5;_tmpDF=*_tmpD8;_tmpE0=(int)_tmpDF.hd;_tmpE1=_tmpDF.tl;if(_tmpE1 == 0)
goto _LLC5;_tmpE2=*_tmpE1;_tmpE3=(int)_tmpE2.hd;_tmpE4=_tmpE2.tl;if(_tmpE4 != 0)
goto _LLC5;if(!(_tmpE0 == 'h'?_tmpE3 == 'h': 0))goto _LLC5;_LLC4: t=Cyc_Absyn_schar_t;
...
sizeof(unsigned char),46),_tag_arr(_tmpE5,sizeof(void*),2));}}});return 0;_LLBC:;}
t=Cyc_Absyn_at_typ(t,Cyc_Absyn_new_evar((struct Cyc_Core_Opt*)& Cyc_Formatstr_rk,
...
_LLBB: if(_tmp97){({void*_tmpEA[0]={};Cyc_Tcutil_terr(loc,_tag_arr("Assignment suppression (*) is not allowed with %%%%",
sizeof(unsigned char),52),_tag_arr(_tmpEA,sizeof(void*),0));});return 0;}if(
_tmp98 != 0){({struct Cyc_Std_String_pa_struct _tmpEC;_tmpEC.tag=0;_tmpEC.f1=(
struct _tagged_arr)Cyc_Std_implode(_tmp98);{void*_tmpEB[1]={& _tmpEC};Cyc_Tcutil_terr(
...
default: _LLC7: return 0;}}}}}return Cyc_List_imp_rev(_tmp92);}
