...
18];struct Cyc_FileOpenError_struct{char*tag;struct _dynforward_ptr f1;};struct Cyc_Absyn_Rel_n_struct{
...
struct Cyc_Dict_Dict*ae;struct Cyc_List_List*le;};struct Cyc_List_List*Cyc_Tcenv_lookup_type_vars(
struct Cyc_Tcenv_Tenv*);void Cyc_Tcutil_terr(struct Cyc_Position_Segment*,struct
_dynforward_ptr fmt,struct _dynforward_ptr ap);struct Cyc_List_List*Cyc_Formatstr_get_format_typs(
...
_dynforward_ptr,struct Cyc_Position_Segment*);struct Cyc_Core_Opt*Cyc_Formatstr_parse_conversionspecification(
struct _dynforward_ptr s,int i);static struct Cyc_Core_Opt Cyc_Formatstr_rk={(void*)((
void*)3)};struct _tuple4{struct Cyc_List_List*f1;struct Cyc_List_List*f2;struct Cyc_List_List*
