...
Cyc_Absyn_empty_tqual();void*Cyc_Absyn_new_evar(struct Cyc_Core_Opt*k,struct Cyc_Core_Opt*
tenv);extern void*Cyc_Absyn_uchar_typ;extern void*Cyc_Absyn_ushort_typ;extern void*
Cyc_Absyn_uint_typ;extern void*Cyc_Absyn_ulong_typ;extern void*Cyc_Absyn_schar_typ;
...
void*rgn);void*Cyc_Absyn_const_string_typ(void*rgn);void*Cyc_Absyn_at_typ(void*t,
void*rgn,struct Cyc_Absyn_Tqual tq);struct Cyc_Iter_Iter{void*env;int(*next)(void*
...
12];extern unsigned char Cyc_Dict_Absent[11];struct _tuple3{void*f1;void*f2;};
...
const unsigned char*)_check_unknown_subscript(s,sizeof(unsigned char),i));switch(
c){case '+': _LL0: goto _LL1;case '-': _LL1: goto _LL2;case ' ': _LL2: goto _LL3;case '#':
_LL3: goto _LL4;case '0': _LL4: _tmp1=({struct Cyc_List_List*_tmp2=_cycalloc(sizeof(*
_tmp2));_tmp2->hd=(void*)((int)c);_tmp2->tl=_tmp1;_tmp2;});continue;default: _LL5:
break;}break;}if(i >= _tmp0)return 0;_tmp1=((struct Cyc_List_List*(*)(struct Cyc_List_List*
x))Cyc_List_imp_rev)(_tmp1);{struct Cyc_List_List*_tmp3=0;c=*((const unsigned char*)
_check_unknown_subscript(s,sizeof(unsigned char),i));if(c == '*'){_tmp3=({struct
Cyc_List_List*_tmp4=_cycalloc(sizeof(*_tmp4));_tmp4->hd=(void*)((int)c);_tmp4->tl=
_tmp3;_tmp4;});i ++;}else{for(0;i < _tmp0;i ++){c=*((const unsigned char*)
_check_unknown_subscript(s,sizeof(unsigned char),i));if(isdigit((int)c))_tmp3=({
struct Cyc_List_List*_tmp5=_cycalloc(sizeof(*_tmp5));_tmp5->hd=(void*)((int)c);
...
_tmp6=({struct Cyc_List_List*_tmp7=_cycalloc(sizeof(*_tmp7));_tmp7->hd=(void*)((
int)c);_tmp7->tl=_tmp6;_tmp7;});i ++;if(i >= _tmp0)return 0;c=*((const unsigned char*)
_check_unknown_subscript(s,sizeof(unsigned char),i));if(c == '*'){_tmp6=({struct
Cyc_List_List*_tmp8=_cycalloc(sizeof(*_tmp8));_tmp8->hd=(void*)((int)c);_tmp8->tl=
_tmp6;_tmp8;});i ++;}else{for(0;i < _tmp0;i ++){c=*((const unsigned char*)
_check_unknown_subscript(s,sizeof(unsigned char),i));if(isdigit((int)c))_tmp6=({
struct Cyc_List_List*_tmp9=_cycalloc(sizeof(*_tmp9));_tmp9->hd=(void*)((int)c);
...
const unsigned char*)_check_unknown_subscript(s,sizeof(unsigned char),i));switch(
c){case 'h': _LL7: _tmpA=({struct Cyc_List_List*_tmpB=_cycalloc(sizeof(*_tmpB));
_tmpB->hd=(void*)((int)c);_tmpB->tl=_tmpA;_tmpB;});i ++;if(i >= _tmp0)return 0;c=*((
const unsigned char*)_check_unknown_subscript(s,sizeof(unsigned char),i));if(c == 'h'){
_tmpA=({struct Cyc_List_List*_tmpC=_cycalloc(sizeof(*_tmpC));_tmpC->hd=(void*)((
int)c);_tmpC->tl=_tmpA;_tmpC;});i ++;}break;case 'l': _LL8: _tmpA=({struct Cyc_List_List*
_tmpD=_cycalloc(sizeof(*_tmpD));_tmpD->hd=(void*)((int)c);_tmpD->tl=_tmpA;_tmpD;});
i ++;if(i >= _tmp0)return 0;c=*((const unsigned char*)_check_unknown_subscript(s,
sizeof(unsigned char),i));if(c == 'l'){_tmpA=({struct Cyc_List_List*_tmpE=
_cycalloc(sizeof(*_tmpE));_tmpE->hd=(void*)((int)c);_tmpE->tl=_tmpA;_tmpE;});i ++;}
break;case 'j': _LL9: goto _LLA;case 'z': _LLA: goto _LLB;case 't': _LLB: goto _LLC;case 'L':
_LLC: _tmpA=({struct Cyc_List_List*_tmpF=_cycalloc(sizeof(*_tmpF));_tmpF->hd=(void*)((
...
_tmpA);c=*((const unsigned char*)_check_unknown_subscript(s,sizeof(unsigned char),
i));switch(c){case 'd': _LLF: goto _LL10;case 'i': _LL10: goto _LL11;case 'o': _LL11: goto
_LL12;case 'u': _LL12: goto _LL13;case 'x': _LL13: goto _LL14;case 'X': _LL14: goto _LL15;
case 'f': _LL15: goto _LL16;case 'F': _LL16: goto _LL17;case 'e': _LL17: goto _LL18;case 'E':
_LL18: goto _LL19;case 'g': _LL19: goto _LL1A;case 'G': _LL1A: goto _LL1B;case 'a': _LL1B:
goto _LL1C;case 'A': _LL1C: goto _LL1D;case 'c': _LL1D: goto _LL1E;case 's': _LL1E: goto
_LL1F;case 'p': _LL1F: goto _LL20;case 'n': _LL20: goto _LL21;case '%': _LL21: break;
default: _LL22: return 0;}return({struct Cyc_Core_Opt*_tmp10=_cycalloc(sizeof(*
_tmp10));_tmp10->v=({struct _tuple4*_tmp11=_cycalloc(sizeof(*_tmp11));_tmp11->f1=
...
< _tmp12;i ++){if(*((const unsigned char*)_check_unknown_subscript(s,sizeof(
unsigned char),i))!= '%')continue;{struct Cyc_Core_Opt*_tmp14=Cyc_Formatstr_parse_conversionspecification(
...
sizeof(*_tmp28));_tmp28->hd=(void*)Cyc_Absyn_sint_typ;_tmp28->tl=_tmp13;_tmp28;});
...
_cycalloc(sizeof(*_tmp30));_tmp30->hd=(void*)Cyc_Absyn_sint_typ;_tmp30->tl=
_tmp13;_tmp30;});goto _LL2E;_LL31:;_LL32: goto _LL2E;_LL2E:;}{void*t;switch(_tmp1C){
case 'd': _LL33: goto _LL34;case 'i': _LL34:{struct Cyc_List_List*f=_tmp18;for(0;f != 0;
f=f->tl){if((int)f->hd == '#'){({struct Cyc_Std_Int_pa_struct _tmp32;_tmp32.tag=1;
_tmp32.f1=(int)((unsigned int)((int)_tmp1C));{void*_tmp31[1]={& _tmp32};Cyc_Tcutil_terr(
...
_tmp1B;struct Cyc_List_List _tmp34;int _tmp35;struct Cyc_List_List*_tmp36;struct Cyc_List_List
...
_tmp3F;_LL37: if(_tmp33 != 0)goto _LL39;_LL38: t=Cyc_Absyn_sint_typ;goto _LL36;_LL39:
if(_tmp33 == 0)goto _LL3B;_tmp34=*_tmp33;_tmp35=(int)_tmp34.hd;_tmp36=_tmp34.tl;
if(_tmp36 != 0)goto _LL3B;if(!(_tmp35 == 'l'))goto _LL3B;_LL3A: t=Cyc_Absyn_slong_typ;
...
Cyc_Absyn_sshort_typ;goto _LL36;_LL3D: if(_tmp33 == 0)goto _LL3F;_tmp3A=*_tmp33;
_tmp3B=(int)_tmp3A.hd;_tmp3C=_tmp3A.tl;if(_tmp3C == 0)goto _LL3F;_tmp3D=*_tmp3C;
_tmp3E=(int)_tmp3D.hd;_tmp3F=_tmp3D.tl;if(_tmp3F != 0)goto _LL3F;if(!(_tmp3B == 'h'?
_tmp3E == 'h': 0))goto _LL3F;_LL3E: t=Cyc_Absyn_schar_typ;goto _LL36;_LL3F:;_LL40:({
struct Cyc_Std_Int_pa_struct _tmp42;_tmp42.tag=1;_tmp42.f1=(int)((unsigned int)((
int)_tmp1C));{struct Cyc_Std_String_pa_struct _tmp41;_tmp41.tag=0;_tmp41.f1=(
struct _tagged_arr)Cyc_Std_implode(_tmp1B);{void*_tmp40[2]={& _tmp41,& _tmp42};Cyc_Tcutil_terr(
loc,_tag_arr("length modifier '%s' is not allowed with %%%c",sizeof(
unsigned char),46),_tag_arr(_tmp40,sizeof(void*),2));}}});return 0;_LL36:;}_tmp13=({
...
_LL41;case 'o': _LL41: goto _LL42;case 'x': _LL42: goto _LL43;case 'X': _LL43:{struct Cyc_List_List*
...
struct Cyc_List_List*_tmp5F=_cycalloc(sizeof(*_tmp5F));_tmp5F->hd=(void*)Cyc_Absyn_sint_typ;
...
_tmp64=_cycalloc(sizeof(*_tmp64));_tmp64->hd=(void*)Cyc_Absyn_uint_typ;_tmp64->tl=
...
unsigned char*)_check_unknown_subscript(s,sizeof(unsigned char),i));if(_tmp86 == '*'){
_tmp85=1;i ++;if(i >= _tmp84)return 0;}{struct Cyc_List_List*_tmp87=0;for(0;i < 
_tmp84;i ++){_tmp86=*((const unsigned char*)_check_unknown_subscript(s,sizeof(
unsigned char),i));if(isdigit((int)_tmp86))_tmp87=({struct Cyc_List_List*_tmp88=
...
_tmp86=*((const unsigned char*)_check_unknown_subscript(s,sizeof(unsigned char),i));
switch(_tmp86){case 'h': _LL69: _tmp89=({struct Cyc_List_List*_tmp8A=_cycalloc(
sizeof(*_tmp8A));_tmp8A->hd=(void*)((int)_tmp86);_tmp8A->tl=_tmp89;_tmp8A;});i ++;
if(i >= _tmp84)return 0;_tmp86=*((const unsigned char*)_check_unknown_subscript(s,
sizeof(unsigned char),i));if(_tmp86 == 'h'){_tmp89=({struct Cyc_List_List*_tmp8B=
_cycalloc(sizeof(*_tmp8B));_tmp8B->hd=(void*)((int)_tmp86);_tmp8B->tl=_tmp89;
_tmp8B;});i ++;}break;case 'l': _LL6A: _tmp89=({struct Cyc_List_List*_tmp8C=_cycalloc(
sizeof(*_tmp8C));_tmp8C->hd=(void*)((int)_tmp86);_tmp8C->tl=_tmp89;_tmp8C;});i ++;
if(i >= _tmp84)return 0;_tmp86=*((const unsigned char*)_check_unknown_subscript(s,
sizeof(unsigned char),i));if(_tmp86 == 'l'){_tmp89=({struct Cyc_List_List*_tmp8D=
_cycalloc(sizeof(*_tmp8D));_tmp8D->hd=(void*)((int)_tmp86);_tmp8D->tl=_tmp89;
_tmp8D;});i ++;}break;case 'j': _LL6B: goto _LL6C;case 'z': _LL6C: goto _LL6D;case 't':
_LL6D: goto _LL6E;case 'L': _LL6E: _tmp89=({struct Cyc_List_List*_tmp8E=_cycalloc(
...
struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp89);_tmp86=*((const unsigned char*)
_check_unknown_subscript(s,sizeof(unsigned char),i));switch(_tmp86){case 'd':
...
struct Cyc_List_List*_tmp92=0;int i;for(i=0;i < _tmp91;i ++){if(*((const
unsigned char*)_check_unknown_subscript(s,sizeof(unsigned char),i))!= '%')
continue;{struct Cyc_Core_Opt*_tmp93=Cyc_Formatstr_parse_inputformat(s,i + 1);if(
_tmp93 == 0){({void*_tmp94[0]={};Cyc_Tcutil_terr(loc,_tag_arr("bad format string",
sizeof(unsigned char),18),_tag_arr(_tmp94,sizeof(void*),0));});return 0;}{struct
_tuple5 _tmp96;int _tmp97;struct Cyc_List_List*_tmp98;struct Cyc_List_List*_tmp99;
unsigned char _tmp9A;int _tmp9B;struct _tuple5*_tmp95=(struct _tuple5*)_tmp93->v;
_tmp96=*_tmp95;_tmp97=_tmp96.f1;_tmp98=_tmp96.f2;_tmp99=_tmp96.f3;_tmp9A=_tmp96.f4;
_tmp9B=_tmp96.f5;i=_tmp9B - 1;{struct Cyc_List_List*_tmp9C=_tmp99;struct Cyc_List_List
_tmp9D;int _tmp9E;struct Cyc_List_List*_tmp9F;_LL87: if(_tmp9C == 0)goto _LL89;_tmp9D=*
_tmp9C;_tmp9E=(int)_tmp9D.hd;_tmp9F=_tmp9D.tl;if(_tmp9F != 0)goto _LL89;if(!((
_tmp9E == 'j'?1: _tmp9E == 'z')?1: _tmp9E == 't'))goto _LL89;_LL88:({struct Cyc_Std_Int_pa_struct
...
_tmpC2;_LL9E: if(_tmpB6 != 0)goto _LLA0;_LL9F: t=Cyc_Absyn_uint_typ;goto _LL9D;_LLA0:
if(_tmpB6 == 0)goto _LLA2;_tmpB7=*_tmpB6;_tmpB8=(int)_tmpB7.hd;_tmpB9=_tmpB7.tl;
if(_tmpB9 != 0)goto _LLA2;if(!(_tmpB8 == 'l'))goto _LLA2;_LLA1: t=Cyc_Absyn_ulong_typ;
...
Cyc_Absyn_ushort_typ;goto _LL9D;_LLA4: if(_tmpB6 == 0)goto _LLA6;_tmpBD=*_tmpB6;
_tmpBE=(int)_tmpBD.hd;_tmpBF=_tmpBD.tl;if(_tmpBF == 0)goto _LLA6;_tmpC0=*_tmpBF;
_tmpC1=(int)_tmpC0.hd;_tmpC2=_tmpC0.tl;if(_tmpC2 != 0)goto _LLA6;if(!(_tmpBE == 'h'?
_tmpC1 == 'h': 0))goto _LLA6;_LLA5: t=Cyc_Absyn_uchar_typ;goto _LL9D;_LLA6:;_LLA7:({
struct Cyc_Std_Int_pa_struct _tmpC5;_tmpC5.tag=1;_tmpC5.f1=(int)((unsigned int)((
int)_tmp9A));{struct Cyc_Std_String_pa_struct _tmpC4;_tmpC4.tag=0;_tmpC4.f1=(
struct _tagged_arr)Cyc_Std_implode(_tmp99);{void*_tmpC3[2]={& _tmpC4,& _tmpC5};Cyc_Tcutil_terr(
loc,_tag_arr("length modifier '%s' is not allowed with %%%c",sizeof(
unsigned char),46),_tag_arr(_tmpC3,sizeof(void*),2));}}});return 0;_LL9D:;}t=Cyc_Absyn_at_typ(
