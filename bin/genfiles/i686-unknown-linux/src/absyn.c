...
po;_tmp125->fields=fs;_tmp125;});}struct Cyc_Absyn_Decl*Cyc_Absyn_aggr_decl(void*
...
void*)({struct Cyc_Absyn_Aggr_d_struct*_tmp126=_cycalloc(sizeof(*_tmp126));
_tmp126[0]=({struct Cyc_Absyn_Aggr_d_struct _tmp127;_tmp127.tag=6;_tmp127.f1=({
struct Cyc_Absyn_Aggrdecl*_tmp128=_cycalloc(sizeof(*_tmp128));_tmp128->kind=(void*)
k;_tmp128->sc=(void*)s;_tmp128->name=n;_tmp128->tvs=ts;_tmp128->impl=i;_tmp128->attributes=
atts;_tmp128;});_tmp127;});_tmp126;}),loc);}struct Cyc_Absyn_Decl*Cyc_Absyn_struct_decl(
...
loc){return Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Tunion_d_struct*_tmp129=
_cycalloc(sizeof(*_tmp129));_tmp129[0]=({struct Cyc_Absyn_Tunion_d_struct _tmp12A;
_tmp12A.tag=7;_tmp12A.f1=({struct Cyc_Absyn_Tuniondecl*_tmp12B=_cycalloc(sizeof(*
_tmp12B));_tmp12B->sc=(void*)s;_tmp12B->name=n;_tmp12B->tvs=ts;_tmp12B->fields=
fs;_tmp12B->is_xtunion=is_xtunion;_tmp12B->is_flat=is_flat;_tmp12B;});_tmp12A;});
_tmp129;}),loc);}static struct _tuple1*Cyc_Absyn_expand_arg(struct _tuple1*a){
return({struct _tuple1*_tmp12C=_cycalloc(sizeof(*_tmp12C));_tmp12C->f1=(*a).f1;
_tmp12C->f2=(*a).f2;_tmp12C->f3=Cyc_Absyn_pointer_expand((*a).f3,1);_tmp12C;});}
void*Cyc_Absyn_function_typ(struct Cyc_List_List*tvs,struct Cyc_Core_Opt*eff_typ,
void*ret_typ,struct Cyc_List_List*args,int c_varargs,struct Cyc_Absyn_VarargInfo*
