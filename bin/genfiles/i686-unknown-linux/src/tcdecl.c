...
Cyc_Tcdecl_Incompatible);{struct _dyneither_ptr fmt2=(struct _dyneither_ptr)Cyc_strconcat(({
const char*_tmp6="%s ";_tag_dyneither(_tmp6,sizeof(char),4);}),(struct
_dyneither_ptr)fmt);struct _dyneither_ptr ap2=({unsigned int _tmp0=
_get_dyneither_size(ap,sizeof(void*))+ 1;void**_tmp1=(void**)_cycalloc(
_check_times(sizeof(void*),_tmp0));struct _dyneither_ptr _tmp5=_tag_dyneither(
...
struct _dyneither_ptr)((struct _dyneither_ptr)*msg1);_tmp4;});_tmp3;}):*((void**)
_check_dyneither_subscript(ap,sizeof(void*),(int)(i - 1)));}}_tmp5;});Cyc_Position_post_error(
...
_tag_dyneither(_tmp57,sizeof(char),5);}),_tmp41,loc,msg))return 0;{struct Cyc_List_List*
...
_tmp5A;struct _dyneither_ptr*_tmp5B;struct Cyc_Absyn_Tqual _tmp5C;void*_tmp5D;
...
struct Cyc_Absyn_Aggrfield _tmp61;struct _dyneither_ptr*_tmp62;struct Cyc_Absyn_Tqual
...
_tmp66=_tmp61.attributes;if(Cyc_strptrcmp(_tmp5B,_tmp62)!= 0){({struct Cyc_String_pa_struct
_tmp6C;_tmp6C.tag=0;_tmp6C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
_tmp62);{struct Cyc_String_pa_struct _tmp6B;_tmp6B.tag=0;_tmp6B.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*_tmp5B);{struct Cyc_String_pa_struct _tmp6A;
_tmp6A.tag=0;_tmp6A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp41);{
struct Cyc_String_pa_struct _tmp69;_tmp69.tag=0;_tmp69.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)({const char*_tmp6D="type";_tag_dyneither(_tmp6D,sizeof(char),
5);}));{void*_tmp67[4]={& _tmp69,& _tmp6A,& _tmp6B,& _tmp6C};Cyc_Tcdecl_merr(loc,msg,({
const char*_tmp68="%s %s : field name mismatch %s != %s";_tag_dyneither(_tmp68,
sizeof(char),37);}),_tag_dyneither(_tmp67,sizeof(void*),4));}}}}});return 0;}if(!
Cyc_Tcutil_same_atts(_tmp5F,_tmp66)){({struct Cyc_String_pa_struct _tmp72;_tmp72.tag=
0;_tmp72.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp5B);{struct Cyc_String_pa_struct
_tmp71;_tmp71.tag=0;_tmp71.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
_tmp41);{struct Cyc_String_pa_struct _tmp70;_tmp70.tag=0;_tmp70.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)({const char*_tmp73="type";_tag_dyneither(
_tmp73,sizeof(char),5);}));{void*_tmp6E[3]={& _tmp70,& _tmp71,& _tmp72};Cyc_Tcdecl_merr(
loc,msg,({const char*_tmp6F="%s %s : attribute mismatch on field %s";
_tag_dyneither(_tmp6F,sizeof(char),39);}),_tag_dyneither(_tmp6E,sizeof(void*),3));}}}});
_tmp42=0;}if(!Cyc_Tcutil_equal_tqual(_tmp5C,_tmp63)){({struct Cyc_String_pa_struct
_tmp78;_tmp78.tag=0;_tmp78.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
_tmp5B);{struct Cyc_String_pa_struct _tmp77;_tmp77.tag=0;_tmp77.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)_tmp41);{struct Cyc_String_pa_struct _tmp76;
_tmp76.tag=0;_tmp76.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)({const char*
_tmp79="type";_tag_dyneither(_tmp79,sizeof(char),5);}));{void*_tmp74[3]={& _tmp76,&
_tmp77,& _tmp78};Cyc_Tcdecl_merr(loc,msg,({const char*_tmp75="%s %s : qualifier mismatch on field %s";
_tag_dyneither(_tmp75,sizeof(char),39);}),_tag_dyneither(_tmp74,sizeof(void*),3));}}}});
...
_tmp5B);{struct Cyc_String_pa_struct _tmp7D;_tmp7D.tag=0;_tmp7D.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)_tmp41);{struct Cyc_String_pa_struct _tmp7C;
_tmp7C.tag=0;_tmp7C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)({const char*
_tmp7F="type";_tag_dyneither(_tmp7F,sizeof(char),5);}));{void*_tmp7A[3]={& _tmp7C,&
_tmp7D,& _tmp7E};Cyc_Tcdecl_merr(loc,msg,({const char*_tmp7B="%s %s : bitfield mismatch on field %s";
_tag_dyneither(_tmp7B,sizeof(char),38);}),_tag_dyneither(_tmp7A,sizeof(void*),3));}}}});
_tmp42=0;}{void*subst_t1=Cyc_Tcutil_substitute(_tmp58,_tmp64);if(!Cyc_Tcdecl_check_type(
_tmp5D,subst_t1)){({struct Cyc_String_pa_struct _tmp85;_tmp85.tag=0;_tmp85.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(subst_t1));{
struct Cyc_String_pa_struct _tmp84;_tmp84.tag=0;_tmp84.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp5D));{struct Cyc_String_pa_struct
_tmp83;_tmp83.tag=0;_tmp83.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*
_tmp5B);{struct Cyc_String_pa_struct _tmp82;_tmp82.tag=0;_tmp82.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)_tmp41);{void*_tmp80[4]={& _tmp82,& _tmp83,&
_tmp84,& _tmp85};Cyc_Tcdecl_merr(loc,msg,({const char*_tmp81="type %s : type mismatch on field %s: %s != %s";
_tag_dyneither(_tmp81,sizeof(char),46);}),_tag_dyneither(_tmp80,sizeof(void*),4));}}}}});
...
struct Cyc_Absyn_Aggrfield*)_tmp51->hd)->name);{struct Cyc_String_pa_struct _tmp88;
_tmp88.tag=0;_tmp88.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp41);{
void*_tmp86[2]={& _tmp88,& _tmp89};Cyc_Tcdecl_merr(loc,msg,({const char*_tmp87="type %s is missing field %s";
_tag_dyneither(_tmp87,sizeof(char),28);}),_tag_dyneither(_tmp86,sizeof(void*),2));}}});
_tmp42=0;}if(_tmp56 != 0){({struct Cyc_String_pa_struct _tmp8D;_tmp8D.tag=0;_tmp8D.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)_tmp56->hd)->name);{
struct Cyc_String_pa_struct _tmp8C;_tmp8C.tag=0;_tmp8C.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)_tmp41);{void*_tmp8A[2]={& _tmp8C,& _tmp8D};Cyc_Tcdecl_merr(
loc,msg,({const char*_tmp8B="type %s has extra field %s";_tag_dyneither(_tmp8B,
sizeof(char),27);}),_tag_dyneither(_tmp8A,sizeof(void*),2));}}});_tmp42=0;}d2=d0;
goto _LL1E;}_LL1E:;}if(!_tmp42)return 0;if(_tmp46 == (void*)d2->sc)return(struct Cyc_Absyn_Aggrdecl*)
d2;else{d2=({struct Cyc_Absyn_Aggrdecl*_tmp8E=_cycalloc(sizeof(*_tmp8E));_tmp8E[0]=*
d2;_tmp8E;});(void*)(d2->sc=(void*)_tmp46);return(struct Cyc_Absyn_Aggrdecl*)d2;}}}}
inline static struct _dyneither_ptr Cyc_Tcdecl_is_x2string(int is_x){return is_x?({
const char*_tmp8F="xtunion";_tag_dyneither(_tmp8F,sizeof(char),8);}):({const char*
_tmp90="tunion";_tag_dyneither(_tmp90,sizeof(char),7);});}struct _tuple7{struct
...
inst,struct _dyneither_ptr t,struct _dyneither_ptr v,struct _dyneither_ptr*msg){
struct Cyc_Position_Segment*loc=f1->loc;if(Cyc_strptrcmp((*f0->name).f2,(*f1->name).f2)
!= 0){({struct Cyc_String_pa_struct _tmp96;_tmp96.tag=0;_tmp96.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*(*f0->name).f2);{struct Cyc_String_pa_struct
_tmp95;_tmp95.tag=0;_tmp95.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*f1->name).f2);{
struct Cyc_String_pa_struct _tmp94;_tmp94.tag=0;_tmp94.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)v);{struct Cyc_String_pa_struct _tmp93;_tmp93.tag=0;_tmp93.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)t);{void*_tmp91[4]={& _tmp93,& _tmp94,&
_tmp95,& _tmp96};Cyc_Tcdecl_merr(loc,msg,({const char*_tmp92="%s %s: field name mismatch %s != %s";
_tag_dyneither(_tmp92,sizeof(char),36);}),_tag_dyneither(_tmp91,sizeof(void*),4));}}}}});
return 0;}{struct _dyneither_ptr _tmp97=*(*f0->name).f2;void*_tmp9D;int _tmp9E;
struct _tuple3 _tmp9C=Cyc_Tcdecl_merge_scope((void*)f0->sc,(void*)f1->sc,(struct
_dyneither_ptr)({struct Cyc_String_pa_struct _tmp9B;_tmp9B.tag=0;_tmp9B.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)v);{struct Cyc_String_pa_struct _tmp9A;
_tmp9A.tag=0;_tmp9A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t);{void*
_tmp98[2]={& _tmp9A,& _tmp9B};Cyc_aprintf(({const char*_tmp99="in %s %s, field";
_tag_dyneither(_tmp99,sizeof(char),16);}),_tag_dyneither(_tmp98,sizeof(void*),2));}}}),
...
_dyneither_ptr)((struct _dyneither_ptr)_tmp97);{struct Cyc_String_pa_struct _tmpA4;
_tmpA4.tag=0;_tmpA4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)v);{struct
Cyc_String_pa_struct _tmpA3;_tmpA3.tag=0;_tmpA3.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)t);{void*_tmpA1[3]={& _tmpA3,& _tmpA4,& _tmpA5};Cyc_Tcdecl_merr(loc,
msg,({const char*_tmpA2="%s %s, field %s: parameter number mismatch";
_tag_dyneither(_tmpA2,sizeof(char),43);}),_tag_dyneither(_tmpA1,sizeof(void*),3));}}}});
...
_check_null(_tmpA0))->hd)).f1)){({struct Cyc_String_pa_struct _tmpAA;_tmpAA.tag=0;
_tmpAA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp97);{struct Cyc_String_pa_struct
_tmpA9;_tmpA9.tag=0;_tmpA9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)v);{
struct Cyc_String_pa_struct _tmpA8;_tmpA8.tag=0;_tmpA8.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)t);{void*_tmpA6[3]={& _tmpA8,& _tmpA9,& _tmpAA};Cyc_Tcdecl_merr(
loc,msg,({const char*_tmpA7="%s %s, field %s: parameter qualifier";_tag_dyneither(
_tmpA7,sizeof(char),37);}),_tag_dyneither(_tmpA6,sizeof(void*),3));}}}});_tmp9E=
0;}{void*subst_t1=Cyc_Tcutil_substitute(inst,(*((struct _tuple7*)_tmpA0->hd)).f2);
if(!Cyc_Tcdecl_check_type((*((struct _tuple7*)_tmp9F->hd)).f2,subst_t1)){({struct
Cyc_String_pa_struct _tmpB1;_tmpB1.tag=0;_tmpB1.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_typ2string(subst_t1));{struct Cyc_String_pa_struct
_tmpB0;_tmpB0.tag=0;_tmpB0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((*((
struct _tuple7*)_tmp9F->hd)).f2));{struct Cyc_String_pa_struct _tmpAF;_tmpAF.tag=0;
_tmpAF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp97);{struct Cyc_String_pa_struct
...
struct _dyneither_ptr)t);{void*_tmpAB[5]={& _tmpAD,& _tmpAE,& _tmpAF,& _tmpB0,& _tmpB1};
Cyc_Tcdecl_merr(loc,msg,({const char*_tmpAC="%s %s, field %s: parameter type mismatch %s != %s";
_tag_dyneither(_tmpAC,sizeof(char),50);}),_tag_dyneither(_tmpAB,sizeof(void*),5));}}}}}});
...
_dyneither_ptr t,struct _dyneither_ptr v,struct Cyc_Position_Segment*loc,struct
_dyneither_ptr*msg){struct Cyc_List_List**f2sp=({struct Cyc_List_List**_tmpC3=
...
char*_tmpD0="xtunion";_tag_dyneither(_tmpD0,sizeof(char),8);}),*v,loc,msg);}
struct _tuple9{struct Cyc_Core_Opt*f1;struct Cyc_Core_Opt*f2;};struct Cyc_Absyn_Tuniondecl*
Cyc_Tcdecl_merge_tuniondecl(struct Cyc_Absyn_Tuniondecl*d0,struct Cyc_Absyn_Tuniondecl*
d1,struct Cyc_Position_Segment*loc,struct _dyneither_ptr*msg){struct _dyneither_ptr
_tmpD1=Cyc_Absynpp_qvar2string(d0->name);struct _dyneither_ptr t=({const char*
_tmpF9="[x]tunion";_tag_dyneither(_tmpF9,sizeof(char),10);});int _tmpD2=1;if(d0->is_xtunion
!= d1->is_xtunion){({struct Cyc_String_pa_struct _tmpD7;_tmpD7.tag=0;_tmpD7.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcdecl_is_x2string(d1->is_xtunion));{
struct Cyc_String_pa_struct _tmpD6;_tmpD6.tag=0;_tmpD6.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Tcdecl_is_x2string(d0->is_xtunion));{struct Cyc_String_pa_struct
...
const char*_tmpD4="expected %s to be a %s instead of a %s";_tag_dyneither(_tmpD4,
sizeof(char),39);}),_tag_dyneither(_tmpD3,sizeof(void*),3));}}}});_tmpD2=0;}
else{t=Cyc_Tcdecl_is_x2string(d0->is_xtunion);}if(d0->is_flat != d1->is_flat){if(
d0->is_flat)({void*_tmpD8=0;Cyc_Tcdecl_merr(loc,msg,({const char*_tmpD9="expected __attribute__((flat))";
_tag_dyneither(_tmpD9,sizeof(char),31);}),_tag_dyneither(_tmpD8,sizeof(void*),0));});
else{({void*_tmpDA=0;Cyc_Tcdecl_merr(loc,msg,({const char*_tmpDB="did not expect __attribute__((flat))";
_tag_dyneither(_tmpDB,sizeof(char),37);}),_tag_dyneither(_tmpDA,sizeof(void*),0));});}}
...
struct Cyc_Absyn_Tuniondecl*d2;{struct _tuple9 _tmpE0=({struct _tuple9 _tmpDF;_tmpDF.f1=
d0->fields;_tmpDF.f2=d1->fields;_tmpDF;});struct Cyc_Core_Opt*_tmpE1;struct Cyc_Core_Opt*
_tmpE2;struct Cyc_Core_Opt*_tmpE3;struct Cyc_Core_Opt _tmpE4;struct Cyc_List_List*
...
d2=d0;else{d2=({struct Cyc_Absyn_Tuniondecl*_tmpEC=_cycalloc(sizeof(*_tmpEC));
_tmpEC[0]=*d0;_tmpEC;});(void*)(d2->sc=(void*)_tmpDD);d2->fields=({struct Cyc_Core_Opt*
_tmpED=_cycalloc(sizeof(*_tmpED));_tmpED->v=_tmpEB;_tmpED;});}}else{for(0;_tmpE5
!= 0  && _tmpE8 != 0;(_tmpE5=_tmpE5->tl,_tmpE8=_tmpE8->tl)){Cyc_Tcdecl_merge_tunionfield((
struct Cyc_Absyn_Tunionfield*)_tmpE5->hd,(struct Cyc_Absyn_Tunionfield*)_tmpE8->hd,
_tmpE9,t,_tmpD1,msg);}if(_tmpE5 != 0){({struct Cyc_String_pa_struct _tmpF2;_tmpF2.tag=
0;_tmpF2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*((struct Cyc_Absyn_Tunionfield*)((
struct Cyc_List_List*)_check_null(_tmpE8))->hd)->name).f2);{struct Cyc_String_pa_struct
_tmpF1;_tmpF1.tag=0;_tmpF1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
_tmpD1);{struct Cyc_String_pa_struct _tmpF0;_tmpF0.tag=0;_tmpF0.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)t);{void*_tmpEE[3]={& _tmpF0,& _tmpF1,&
_tmpF2};Cyc_Tcdecl_merr(loc,msg,({const char*_tmpEF="%s %s has extra field %s";
_tag_dyneither(_tmpEF,sizeof(char),25);}),_tag_dyneither(_tmpEE,sizeof(void*),3));}}}});
_tmpD2=0;}if(_tmpE8 != 0){({struct Cyc_String_pa_struct _tmpF7;_tmpF7.tag=0;_tmpF7.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)*(*((struct Cyc_Absyn_Tunionfield*)
_tmpE8->hd)->name).f2);{struct Cyc_String_pa_struct _tmpF6;_tmpF6.tag=0;_tmpF6.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)_tmpD1);{struct Cyc_String_pa_struct
_tmpF5;_tmpF5.tag=0;_tmpF5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t);{
void*_tmpF3[3]={& _tmpF5,& _tmpF6,& _tmpF7};Cyc_Tcdecl_merr(loc,msg,({const char*
_tmpF4="%s %s is missing field %s";_tag_dyneither(_tmpF4,sizeof(char),26);}),
_tag_dyneither(_tmpF3,sizeof(void*),3));}}}});_tmpD2=0;}d2=d0;}goto _LL25;}_LL25:;}
if(!_tmpD2)return 0;if(_tmpDD == (void*)d2->sc)return(struct Cyc_Absyn_Tuniondecl*)
d2;else{d2=({struct Cyc_Absyn_Tuniondecl*_tmpF8=_cycalloc(sizeof(*_tmpF8));_tmpF8[
0]=*d2;_tmpF8;});(void*)(d2->sc=(void*)_tmpDD);return(struct Cyc_Absyn_Tuniondecl*)
...
_dyneither_ptr*msg){struct _dyneither_ptr _tmpFA=Cyc_Absynpp_qvar2string(d0->name);
int _tmpFB=1;void*_tmpFE;int _tmpFF;struct _tuple3 _tmpFD=Cyc_Tcdecl_merge_scope((
void*)d0->sc,(void*)d1->sc,({const char*_tmpFC="enum";_tag_dyneither(_tmpFC,
sizeof(char),5);}),_tmpFA,loc,msg,1);_tmpFE=_tmpFD.f1;_tmpFF=_tmpFD.f2;if(!
_tmpFF)_tmpFB=0;{struct Cyc_Absyn_Enumdecl*d2;{struct _tuple9 _tmp101=({struct
_tuple9 _tmp100;_tmp100.f1=d0->fields;_tmp100.f2=d1->fields;_tmp100;});struct Cyc_Core_Opt*
_tmp102;struct Cyc_Core_Opt*_tmp103;struct Cyc_Core_Opt*_tmp104;struct Cyc_Core_Opt
_tmp105;struct Cyc_List_List*_tmp106;struct Cyc_Core_Opt*_tmp107;struct Cyc_Core_Opt
_tmp108;struct Cyc_List_List*_tmp109;_LL2D: _tmp102=_tmp101.f2;if(_tmp102 != 0)goto
_LL2F;_LL2E: d2=d0;goto _LL2C;_LL2F: _tmp103=_tmp101.f1;if(_tmp103 != 0)goto _LL31;
_LL30: d2=d1;goto _LL2C;_LL31: _tmp104=_tmp101.f1;if(_tmp104 == 0)goto _LL2C;_tmp105=*
_tmp104;_tmp106=(struct Cyc_List_List*)_tmp105.v;_tmp107=_tmp101.f2;if(_tmp107 == 
0)goto _LL2C;_tmp108=*_tmp107;_tmp109=(struct Cyc_List_List*)_tmp108.v;_LL32: for(0;
_tmp106 != 0  && _tmp109 != 0;(_tmp106=_tmp106->tl,_tmp109=_tmp109->tl)){struct Cyc_Absyn_Enumfield
_tmp10B;struct _tuple0*_tmp10C;struct _tuple0 _tmp10D;struct _dyneither_ptr*_tmp10E;
struct Cyc_Absyn_Exp*_tmp10F;struct Cyc_Position_Segment*_tmp110;struct Cyc_Absyn_Enumfield*
_tmp10A=(struct Cyc_Absyn_Enumfield*)_tmp106->hd;_tmp10B=*_tmp10A;_tmp10C=_tmp10B.name;
...
struct _dyneither_ptr*_tmp115;struct Cyc_Absyn_Exp*_tmp116;struct Cyc_Position_Segment*
...
struct _dyneither_ptr)*_tmp115);{struct Cyc_String_pa_struct _tmp11B;_tmp11B.tag=0;
_tmp11B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp10E);{struct Cyc_String_pa_struct
_tmp11A;_tmp11A.tag=0;_tmp11A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
_tmpFA);{void*_tmp118[3]={& _tmp11A,& _tmp11B,& _tmp11C};Cyc_Tcdecl_merr(loc,msg,({
const char*_tmp119="enum %s: field name mismatch %s != %s";_tag_dyneither(_tmp119,
sizeof(char),38);}),_tag_dyneither(_tmp118,sizeof(void*),3));}}}});_tmpFB=0;}if(
Cyc_Tcdecl_get_uint_const_value((struct Cyc_Absyn_Exp*)_check_null(_tmp10F))!= 
Cyc_Tcdecl_get_uint_const_value((struct Cyc_Absyn_Exp*)_check_null(_tmp116))){({
struct Cyc_String_pa_struct _tmp120;_tmp120.tag=0;_tmp120.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)*_tmp115);{struct Cyc_String_pa_struct _tmp11F;_tmp11F.tag=0;
_tmp11F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpFA);{void*_tmp11D[2]={&
_tmp11F,& _tmp120};Cyc_Tcdecl_merr(loc,msg,({const char*_tmp11E="enum %s, field %s, value mismatch";
_tag_dyneither(_tmp11E,sizeof(char),34);}),_tag_dyneither(_tmp11D,sizeof(void*),
2));}}});_tmpFB=0;}}}d2=d0;goto _LL2C;_LL2C:;}if(!_tmpFB)return 0;if((void*)d2->sc
== _tmpFE)return(struct Cyc_Absyn_Enumdecl*)d2;else{d2=({struct Cyc_Absyn_Enumdecl*
_tmp121=_cycalloc(sizeof(*_tmp121));_tmp121[0]=*d2;_tmp121;});(void*)(d2->sc=(
...
int _tmp122=1;void*_tmp124;int _tmp125;struct _tuple3 _tmp123=Cyc_Tcdecl_merge_scope(
sc0,sc1,t,v,loc,msg,0);_tmp124=_tmp123.f1;_tmp125=_tmp123.f2;if(!_tmp125)_tmp122=
0;if(!Cyc_Tcdecl_check_type(t0,t1)){({struct Cyc_String_pa_struct _tmp12B;_tmp12B.tag=
0;_tmp12B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t0));{struct Cyc_String_pa_struct _tmp12A;_tmp12A.tag=0;_tmp12A.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t1));{struct Cyc_String_pa_struct
_tmp129;_tmp129.tag=0;_tmp129.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)v);{
struct Cyc_String_pa_struct _tmp128;_tmp128.tag=0;_tmp128.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)t);{void*_tmp126[4]={& _tmp128,& _tmp129,& _tmp12A,& _tmp12B};
Cyc_Tcdecl_merr(loc,msg,({const char*_tmp127="%s %s has type \n%s\n instead of \n%s\n";
_tag_dyneither(_tmp127,sizeof(char),36);}),_tag_dyneither(_tmp126,sizeof(void*),
4));}}}}});Cyc_Tcutil_explain_failure();_tmp122=0;}if(!Cyc_Tcutil_equal_tqual(
tq0,tq1)){({struct Cyc_String_pa_struct _tmp12F;_tmp12F.tag=0;_tmp12F.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)v);{struct Cyc_String_pa_struct _tmp12E;
_tmp12E.tag=0;_tmp12E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t);{void*
_tmp12C[2]={& _tmp12E,& _tmp12F};Cyc_Tcdecl_merr(loc,msg,({const char*_tmp12D="%s %s has different type qualifiers";
_tag_dyneither(_tmp12D,sizeof(char),36);}),_tag_dyneither(_tmp12C,sizeof(void*),
2));}}});_tmp122=0;}if(!Cyc_Tcutil_same_atts(atts0,atts1)){({struct Cyc_String_pa_struct
_tmp133;_tmp133.tag=0;_tmp133.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)v);{
struct Cyc_String_pa_struct _tmp132;_tmp132.tag=0;_tmp132.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)t);{void*_tmp130[2]={& _tmp132,& _tmp133};Cyc_Tcdecl_merr(loc,
msg,({const char*_tmp131="%s %s has different attributes";_tag_dyneither(_tmp131,
sizeof(char),31);}),_tag_dyneither(_tmp130,sizeof(void*),2));}}});({void*_tmp134=
0;Cyc_fprintf(Cyc_stderr,({const char*_tmp135="previous attributes: ";
_tag_dyneither(_tmp135,sizeof(char),22);}),_tag_dyneither(_tmp134,sizeof(void*),
0));});for(0;atts0 != 0;atts0=atts0->tl){({struct Cyc_String_pa_struct _tmp138;
_tmp138.tag=0;_tmp138.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((
void*)atts0->hd));{void*_tmp136[1]={& _tmp138};Cyc_fprintf(Cyc_stderr,({const char*
_tmp137="%s ";_tag_dyneither(_tmp137,sizeof(char),4);}),_tag_dyneither(_tmp136,
sizeof(void*),1));}});}({void*_tmp139=0;Cyc_fprintf(Cyc_stderr,({const char*
_tmp13A="\ncurrent attributes: ";_tag_dyneither(_tmp13A,sizeof(char),22);}),
_tag_dyneither(_tmp139,sizeof(void*),0));});for(0;atts1 != 0;atts1=atts1->tl){({
struct Cyc_String_pa_struct _tmp13D;_tmp13D.tag=0;_tmp13D.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)atts1->hd));{void*_tmp13B[
1]={& _tmp13D};Cyc_fprintf(Cyc_stderr,({const char*_tmp13C="%s ";_tag_dyneither(
_tmp13C,sizeof(char),4);}),_tag_dyneither(_tmp13B,sizeof(void*),1));}});}({void*
_tmp13E=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp13F="\n";_tag_dyneither(_tmp13F,
sizeof(char),2);}),_tag_dyneither(_tmp13E,sizeof(void*),0));});_tmp122=0;}return({
struct _tuple3 _tmp140;_tmp140.f1=_tmp124;_tmp140.f2=_tmp122;_tmp140;});}struct Cyc_Absyn_Vardecl*
Cyc_Tcdecl_merge_vardecl(struct Cyc_Absyn_Vardecl*d0,struct Cyc_Absyn_Vardecl*d1,
...
_tag_dyneither(_tmp142,sizeof(char),9);}),_tmp141,loc,msg);_tmp144=_tmp143.f1;
_tmp145=_tmp143.f2;if(!_tmp145)return 0;if((void*)d0->sc == _tmp144)return(struct
Cyc_Absyn_Vardecl*)d0;else{struct Cyc_Absyn_Vardecl*_tmp146=({struct Cyc_Absyn_Vardecl*
_tmp147=_cycalloc(sizeof(*_tmp147));_tmp147[0]=*d0;_tmp147;});(void*)(((struct
Cyc_Absyn_Vardecl*)_check_null(_tmp146))->sc=(void*)_tmp144);return _tmp146;}}
...
_dyneither_ptr*msg){struct _dyneither_ptr _tmp148=Cyc_Absynpp_qvar2string(d0->name);
if(!Cyc_Tcdecl_check_tvs(d0->tvs,d1->tvs,({const char*_tmp149="typedef";
_tag_dyneither(_tmp149,sizeof(char),8);}),_tmp148,loc,msg))return 0;{struct Cyc_List_List*
...
_check_null(d0->defn))->v,subst_defn1)){({struct Cyc_String_pa_struct _tmp14F;
_tmp14F.tag=0;_tmp14F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((
...
Cyc_Absynpp_typ2string(subst_defn1));{struct Cyc_String_pa_struct _tmp14D;_tmp14D.tag=
0;_tmp14D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp148);{void*_tmp14B[
3]={& _tmp14D,& _tmp14E,& _tmp14F};Cyc_Tcdecl_merr(loc,msg,({const char*_tmp14C="typedef %s does not refer to the same type: %s != %s";
_tag_dyneither(_tmp14C,sizeof(char),53);}),_tag_dyneither(_tmp14B,sizeof(void*),
...
_tuple4 _tmp151=({struct _tuple4 _tmp150;_tmp150.f1=b0;_tmp150.f2=b1;_tmp150;});
...
struct Cyc_Absyn_Vardecl*)_tmp157)return b1;return(void*)({struct Cyc_Absyn_Global_b_struct*
_tmp164=_cycalloc(sizeof(*_tmp164));_tmp164[0]=({struct Cyc_Absyn_Global_b_struct
_tmp165;_tmp165.tag=0;_tmp165.f1=(struct Cyc_Absyn_Vardecl*)_tmp163;_tmp165;});
_tmp164;});}_LL38: _tmp158=_tmp151.f1;if(_tmp158 <= (void*)1)goto _LL3A;if(*((int*)
_tmp158)!= 0)goto _LL3A;_tmp159=((struct Cyc_Absyn_Global_b_struct*)_tmp158)->f1;
_tmp15A=_tmp151.f2;if(_tmp15A <= (void*)1)goto _LL3A;if(*((int*)_tmp15A)!= 1)goto
_LL3A;_tmp15B=((struct Cyc_Absyn_Funname_b_struct*)_tmp15A)->f1;_LL39: {int
_tmp168;struct _tuple3 _tmp167=Cyc_Tcdecl_check_var_or_fn_decl((void*)_tmp159->sc,(
void*)_tmp159->type,_tmp159->tq,_tmp159->attributes,(void*)_tmp15B->sc,(void*)((
struct Cyc_Core_Opt*)_check_null(_tmp15B->cached_typ))->v,Cyc_Absyn_empty_tqual(0),
_tmp15B->attributes,({const char*_tmp166="function";_tag_dyneither(_tmp166,
sizeof(char),9);}),Cyc_Absynpp_qvar2string(_tmp159->name),loc,msg);_tmp168=
_tmp167.f2;return _tmp168?b1:(void*)0;}_LL3A: _tmp15C=_tmp151.f1;if(_tmp15C <= (
void*)1)goto _LL3C;if(*((int*)_tmp15C)!= 1)goto _LL3C;_tmp15D=_tmp151.f2;if(
_tmp15D <= (void*)1)goto _LL3C;if(*((int*)_tmp15D)!= 1)goto _LL3C;_tmp15E=((struct
Cyc_Absyn_Funname_b_struct*)_tmp15D)->f1;_LL3B:({struct Cyc_String_pa_struct
_tmp16B;_tmp16B.tag=0;_tmp16B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp15E->name));{void*_tmp169[1]={& _tmp16B};Cyc_Tcdecl_merr(
loc,msg,({const char*_tmp16A="redefinition of function %s";_tag_dyneither(_tmp16A,
sizeof(char),28);}),_tag_dyneither(_tmp169,sizeof(void*),1));}});return(void*)0;
_LL3C: _tmp15F=_tmp151.f1;if(_tmp15F <= (void*)1)goto _LL3E;if(*((int*)_tmp15F)!= 1)
goto _LL3E;_tmp160=((struct Cyc_Absyn_Funname_b_struct*)_tmp15F)->f1;_tmp161=
_tmp151.f2;if(_tmp161 <= (void*)1)goto _LL3E;if(*((int*)_tmp161)!= 0)goto _LL3E;
_tmp162=((struct Cyc_Absyn_Global_b_struct*)_tmp161)->f1;_LL3D: {int _tmp16E;
...
const char*_tmp16C="variable";_tag_dyneither(_tmp16C,sizeof(char),9);}),Cyc_Absynpp_qvar2string(
_tmp160->name),loc,msg);_tmp16E=_tmp16D.f2;return _tmp16E?b0:(void*)0;}_LL3E:;
_LL3F:(int)_throw((void*)({struct Cyc_Core_Invalid_argument_struct*_tmp16F=
_cycalloc(sizeof(*_tmp16F));_tmp16F[0]=({struct Cyc_Core_Invalid_argument_struct
_tmp170;_tmp170.tag=Cyc_Core_Invalid_argument;_tmp170.f1=({const char*_tmp171="Tcdecl::merge_binding";
_tag_dyneither(_tmp171,sizeof(char),22);});_tmp170;});_tmp16F;}));_LL33:;}struct
Cyc_Tcdecl_Xtunionfielddecl*Cyc_Tcdecl_merge_xtunionfielddecl(struct Cyc_Tcdecl_Xtunionfielddecl*
d0,struct Cyc_Tcdecl_Xtunionfielddecl*d1,struct Cyc_Position_Segment*loc,struct
_dyneither_ptr*msg){struct Cyc_Tcdecl_Xtunionfielddecl _tmp173;struct Cyc_Absyn_Tuniondecl*
_tmp174;struct Cyc_Absyn_Tunionfield*_tmp175;struct Cyc_Tcdecl_Xtunionfielddecl*
_tmp172=d0;_tmp173=*_tmp172;_tmp174=_tmp173.base;_tmp175=_tmp173.field;{struct
Cyc_Tcdecl_Xtunionfielddecl _tmp177;struct Cyc_Absyn_Tuniondecl*_tmp178;struct Cyc_Absyn_Tunionfield*
_tmp179;struct Cyc_Tcdecl_Xtunionfielddecl*_tmp176=d1;_tmp177=*_tmp176;_tmp178=
_tmp177.base;_tmp179=_tmp177.field;{struct _dyneither_ptr _tmp17A=Cyc_Absynpp_qvar2string(
_tmp175->name);if(Cyc_Absyn_qvar_cmp(_tmp174->name,_tmp178->name)!= 0){({struct
Cyc_String_pa_struct _tmp17F;_tmp17F.tag=0;_tmp17F.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)_tmp17A);{struct Cyc_String_pa_struct _tmp17E;_tmp17E.tag=0;
_tmp17E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp178->name));{struct Cyc_String_pa_struct _tmp17D;_tmp17D.tag=0;_tmp17D.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp174->name));{
void*_tmp17B[3]={& _tmp17D,& _tmp17E,& _tmp17F};Cyc_Tcdecl_merr(loc,msg,({const char*
_tmp17C="xtunions %s and %s have both a field named %s";_tag_dyneither(_tmp17C,
sizeof(char),46);}),_tag_dyneither(_tmp17B,sizeof(void*),3));}}}});return 0;}if(!
Cyc_Tcdecl_check_tvs(_tmp174->tvs,_tmp178->tvs,({const char*_tmp180="xtunion";
_tag_dyneither(_tmp180,sizeof(char),8);}),Cyc_Absynpp_qvar2string(_tmp174->name),
...
_tmp175,_tmp179,_tmp181,({const char*_tmp184="xtunionfield";_tag_dyneither(
_tmp184,sizeof(char),13);}),_tmp17A,msg);if(_tmp182 == 0)return 0;if(_tmp182 == (
struct Cyc_Absyn_Tunionfield*)_tmp175)return(struct Cyc_Tcdecl_Xtunionfielddecl*)
