...
struct _RegionHandle _tmpF9=_new_region("env_rgn");struct _RegionHandle*env_rgn=&
_tmpF9;_push_region(env_rgn);{struct Cyc_CfFlowInfo_InitlevelEnv _tmpFA=({struct
Cyc_CfFlowInfo_InitlevelEnv _tmpFC;_tmpFC.e=env_rgn;_tmpFC.d=d;_tmpFC.seen=0;
_tmpFC;});void*_tmpFB=Cyc_CfFlowInfo_initlevel_rec(& _tmpFA,r,(void*)2);
_npop_handler(0);return _tmpFB;};_pop_region(env_rgn);}struct _tuple14{void*f1;int
f2;};void*Cyc_CfFlowInfo_lookup_place(struct Cyc_Dict_Dict d,struct Cyc_CfFlowInfo_Place*
place){void*_tmpFE;struct Cyc_List_List*_tmpFF;struct Cyc_CfFlowInfo_Place _tmpFD=*
place;_tmpFE=(void*)_tmpFD.root;_tmpFF=_tmpFD.fields;{void*_tmp100=Cyc_Dict_lookup(
d,_tmpFE);for(0;_tmpFF != 0;_tmpFF=_tmpFF->tl){struct _tuple14 _tmp102=({struct
_tuple14 _tmp101;_tmp101.f1=_tmp100;_tmp101.f2=(int)_tmpFF->hd;_tmp101;});void*
_tmp103;struct _dyneither_ptr _tmp104;int _tmp105;_LL7E: _tmp103=_tmp102.f1;if(
_tmp103 <= (void*)3)goto _LL80;if(*((int*)_tmp103)!= 4)goto _LL80;_tmp104=((struct
Cyc_CfFlowInfo_Aggregate_struct*)_tmp103)->f1;_tmp105=_tmp102.f2;_LL7F: _tmp100=*((
void**)_check_dyneither_subscript(_tmp104,sizeof(void*),_tmp105));goto _LL7D;
_LL80:;_LL81:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*_tmp106=
_cycalloc(sizeof(*_tmp106));_tmp106[0]=({struct Cyc_Core_Impossible_struct _tmp107;
_tmp107.tag=Cyc_Core_Impossible;_tmp107.f1=({const char*_tmp108="bad lookup_place";
_tag_dyneither(_tmp108,sizeof(char),17);});_tmp107;});_tmp106;}));_LL7D:;}return
_tmp100;}}static int Cyc_CfFlowInfo_is_rval_unescaped(void*rval){void*_tmp109=rval;
struct _dyneither_ptr _tmp10A;_LL83: if(_tmp109 <= (void*)3)goto _LL87;if(*((int*)
...
_RegionHandle _tmp10B=_new_region("rgn");struct _RegionHandle*rgn=& _tmp10B;
_push_region(rgn);{struct Cyc_CfFlowInfo_EscPile*pile=({struct Cyc_CfFlowInfo_EscPile*
_tmp10D=_region_malloc(rgn,sizeof(*_tmp10D));_tmp10D->rgn=rgn;_tmp10D->places=0;
_tmp10D;});Cyc_CfFlowInfo_add_places(pile,r);{struct Cyc_Dict_Dict _tmp10C=Cyc_CfFlowInfo_escape_these(
fenv,pile,all_changed,d);_npop_handler(0);return _tmp10C;}};_pop_region(rgn);}
...
struct Cyc_CfFlowInfo_AssignEnv*env,void*oldval,void*newval){struct _tuple0 _tmp10F=({
struct _tuple0 _tmp10E;_tmp10E.f1=oldval;_tmp10E.f2=newval;_tmp10E;});void*_tmp110;
void*_tmp111;struct Cyc_CfFlowInfo_Place*_tmp112;void*_tmp113;void*_tmp114;struct
_dyneither_ptr _tmp115;void*_tmp116;struct _dyneither_ptr _tmp117;void*_tmp118;void*
_tmp119;_LL8A: _tmp110=_tmp10F.f1;if(_tmp110 <= (void*)3)goto _LL8C;if(*((int*)
_tmp110)!= 1)goto _LL8C;_tmp111=_tmp10F.f2;if(_tmp111 <= (void*)3)goto _LL8C;if(*((
int*)_tmp111)!= 2)goto _LL8C;_tmp112=((struct Cyc_CfFlowInfo_AddressOf_struct*)
_tmp111)->f1;_LL8B: Cyc_CfFlowInfo_add_place(env->pile,_tmp112);goto _LL8D;_LL8C:
_tmp113=_tmp10F.f1;if(_tmp113 <= (void*)3)goto _LL8E;if(*((int*)_tmp113)!= 1)goto
_LL8E;_LL8D: if(Cyc_CfFlowInfo_initlevel(env->d,newval)!= (void*)2)({void*_tmp11A=
0;Cyc_Tcutil_terr(env->loc,({const char*_tmp11B="assignment puts possibly-uninitialized data in an escaped location";
_tag_dyneither(_tmp11B,sizeof(char),67);}),_tag_dyneither(_tmp11A,sizeof(void*),
0));});return(void*)(env->fenv)->esc_all;_LL8E: _tmp114=_tmp10F.f1;if(_tmp114 <= (
void*)3)goto _LL90;if(*((int*)_tmp114)!= 4)goto _LL90;_tmp115=((struct Cyc_CfFlowInfo_Aggregate_struct*)
...
_LL8F: {struct _dyneither_ptr new_d=({unsigned int _tmp11E=_get_dyneither_size(
_tmp115,sizeof(void*));void**_tmp11F=(void**)_region_malloc((env->fenv)->r,
_check_times(sizeof(void*),_tmp11E));struct _dyneither_ptr _tmp121=_tag_dyneither(
_tmp11F,sizeof(void*),_tmp11E);{unsigned int _tmp120=_tmp11E;unsigned int i;for(i=
0;i < _tmp120;i ++){_tmp11F[i]=Cyc_CfFlowInfo_assign_place_inner(env,((void**)
_tmp115.curr)[(int)i],*((void**)_check_dyneither_subscript(_tmp117,sizeof(void*),(
int)i)));}}_tmp121;});int change=0;{int i=0;for(0;i < _get_dyneither_size(_tmp115,
sizeof(void*));++ i){if(*((void**)_check_dyneither_subscript(new_d,sizeof(void*),
i))!= ((void**)_tmp115.curr)[i]){change=1;break;}}}if(!change)return oldval;
change=0;{int i=0;for(0;i < _get_dyneither_size(_tmp115,sizeof(void*));++ i){if(*((
...
change)return newval;return(void*)({struct Cyc_CfFlowInfo_Aggregate_struct*_tmp11C=
_region_malloc((env->fenv)->r,sizeof(*_tmp11C));_tmp11C[0]=({struct Cyc_CfFlowInfo_Aggregate_struct
_tmp11D;_tmp11D.tag=4;_tmp11D.f1=new_d;_tmp11D;});_tmp11C;});}_LL90: _tmp118=
_tmp10F.f2;if(_tmp118 <= (void*)3)goto _LL92;if(*((int*)_tmp118)!= 1)goto _LL92;
_tmp119=(void*)((struct Cyc_CfFlowInfo_Esc_struct*)_tmp118)->f1;_LL91: {void*
_tmp122=_tmp119;_LL95: if((int)_tmp122 != 0)goto _LL97;_LL96: return(void*)(env->fenv)->unknown_none;
...
struct _tuple13 _tmp124=({struct _tuple13 _tmp123;_tmp123.f1=fs;_tmp123.f2=oldval;
_tmp123;});struct Cyc_List_List*_tmp125;struct Cyc_List_List _tmp126;int _tmp127;
struct Cyc_List_List*_tmp128;void*_tmp129;struct _dyneither_ptr _tmp12A;_LL9C:
_tmp125=_tmp124.f1;if(_tmp125 == 0)goto _LL9E;_tmp126=*_tmp125;_tmp127=(int)
_tmp126.hd;_tmp128=_tmp126.tl;_tmp129=_tmp124.f2;if(_tmp129 <= (void*)3)goto _LL9E;
if(*((int*)_tmp129)!= 4)goto _LL9E;_tmp12A=((struct Cyc_CfFlowInfo_Aggregate_struct*)
...
_tmp127,_tmp12B);if(_tmp12C.curr == _tmp12A.curr)return oldval;else{return(void*)({
struct Cyc_CfFlowInfo_Aggregate_struct*_tmp12D=_region_malloc((env->fenv)->r,
sizeof(*_tmp12D));_tmp12D[0]=({struct Cyc_CfFlowInfo_Aggregate_struct _tmp12E;
_tmp12E.tag=4;_tmp12E.f1=_tmp12C;_tmp12E;});_tmp12D;});}}_LL9E:;_LL9F:(int)
_throw((void*)({struct Cyc_Core_Impossible_struct*_tmp12F=_cycalloc(sizeof(*
_tmp12F));_tmp12F[0]=({struct Cyc_Core_Impossible_struct _tmp130;_tmp130.tag=Cyc_Core_Impossible;
_tmp130.f1=({const char*_tmp131="bad assign place";_tag_dyneither(_tmp131,sizeof(
char),17);});_tmp130;});_tmp12F;}));_LL9B:;}}struct Cyc_Dict_Dict Cyc_CfFlowInfo_assign_place(
...
_tmp132=_new_region("rgn");struct _RegionHandle*rgn=& _tmp132;_push_region(rgn);{
struct Cyc_CfFlowInfo_Place _tmp134;void*_tmp135;struct Cyc_List_List*_tmp136;
struct Cyc_CfFlowInfo_Place*_tmp133=place;_tmp134=*_tmp133;_tmp135=(void*)_tmp134.root;
_tmp136=_tmp134.fields;{struct Cyc_CfFlowInfo_AssignEnv env=({struct Cyc_CfFlowInfo_AssignEnv
_tmp138;_tmp138.fenv=fenv;_tmp138.pile=({struct Cyc_CfFlowInfo_EscPile*_tmp139=
_region_malloc(rgn,sizeof(*_tmp139));_tmp139->rgn=rgn;_tmp139->places=0;_tmp139;});
_tmp138.d=d;_tmp138.loc=loc;_tmp138;});void*newval=Cyc_CfFlowInfo_assign_place_outer(&
...
l1;{struct Cyc_List_List*_tmp13A=0;for(0;l2 != 0;l2=l2->tl){struct Cyc_CfFlowInfo_TagCmp
_tmp13C;void*_tmp13D;void*_tmp13E;struct Cyc_CfFlowInfo_TagCmp*_tmp13B=(struct Cyc_CfFlowInfo_TagCmp*)
l2->hd;_tmp13C=*_tmp13B;_tmp13D=(void*)_tmp13C.cmp;_tmp13E=(void*)_tmp13C.bd;{
int found=0;void*joined_cmp=(void*)10;{struct Cyc_List_List*_tmp13F=l1;for(0;
_tmp13F != 0;_tmp13F=_tmp13F->tl){struct Cyc_CfFlowInfo_TagCmp _tmp141;void*_tmp142;
void*_tmp143;struct Cyc_CfFlowInfo_TagCmp*_tmp140=(struct Cyc_CfFlowInfo_TagCmp*)
_tmp13F->hd;_tmp141=*_tmp140;_tmp142=(void*)_tmp141.cmp;_tmp143=(void*)_tmp141.bd;
if(Cyc_Tcutil_typecmp(_tmp13E,_tmp143)== 0){found=1;if(_tmp142 == _tmp13D){
joined_cmp=_tmp142;break;}}}}if(found)_tmp13A=({struct Cyc_List_List*_tmp144=
_region_malloc(r,sizeof(*_tmp144));_tmp144->hd=({struct Cyc_CfFlowInfo_TagCmp*
_tmp145=_region_malloc(r,sizeof(*_tmp145));_tmp145->cmp=(void*)joined_cmp;
_tmp145->bd=(void*)_tmp13E;_tmp145;});_tmp144->tl=_tmp13A;_tmp144;});}}return
_tmp13A;}}static void*Cyc_CfFlowInfo_join_absRval(struct Cyc_CfFlowInfo_JoinEnv*
env,void*a,void*r1,void*r2){if(r1 == r2)return r1;{struct _RegionHandle*_tmp146=(
env->fenv)->r;{struct _tuple0 _tmp148=({struct _tuple0 _tmp147;_tmp147.f1=r1;_tmp147.f2=
r2;_tmp147;});void*_tmp149;struct Cyc_CfFlowInfo_Place*_tmp14A;void*_tmp14B;
struct Cyc_CfFlowInfo_Place*_tmp14C;void*_tmp14D;struct Cyc_CfFlowInfo_Place*
...
_LLAC: {struct _dyneither_ptr new_d=({unsigned int _tmp161=_get_dyneither_size(
_tmp156,sizeof(void*));void**_tmp162=(void**)_region_malloc(_tmp146,_check_times(
sizeof(void*),_tmp161));struct _dyneither_ptr _tmp164=_tag_dyneither(_tmp162,
sizeof(void*),_tmp161);{unsigned int _tmp163=_tmp161;unsigned int i;for(i=0;i < 
_tmp163;i ++){_tmp162[i]=((void*(*)(struct Cyc_CfFlowInfo_JoinEnv*env,int a,void*r1,
void*r2))Cyc_CfFlowInfo_join_absRval)(env,0,((void**)_tmp156.curr)[(int)i],*((
void**)_check_dyneither_subscript(_tmp158,sizeof(void*),(int)i)));}}_tmp164;});
int change=0;{int i=0;for(0;i < _get_dyneither_size(_tmp156,sizeof(void*));++ i){if(*((
void**)_check_dyneither_subscript(new_d,sizeof(void*),i))!= ((void**)_tmp156.curr)[
...
change)return r2;return(void*)({struct Cyc_CfFlowInfo_Aggregate_struct*_tmp15F=
_region_malloc(_tmp146,sizeof(*_tmp15F));_tmp15F[0]=({struct Cyc_CfFlowInfo_Aggregate_struct
_tmp160;_tmp160.tag=4;_tmp160.f1=new_d;_tmp160;});_tmp15F;});}_LLAD: _tmp159=
_tmp148.f1;if(_tmp159 <= (void*)3)goto _LLAF;if(*((int*)_tmp159)!= 3)goto _LLAF;
_tmp15A=((struct Cyc_CfFlowInfo_TagCmps_struct*)_tmp159)->f1;_tmp15B=_tmp148.f2;
if(_tmp15B <= (void*)3)goto _LLAF;if(*((int*)_tmp15B)!= 3)goto _LLAF;_tmp15C=((
struct Cyc_CfFlowInfo_TagCmps_struct*)_tmp15B)->f1;_LLAE: {struct Cyc_List_List*
_tmp165=Cyc_CfFlowInfo_join_tag_cmps(_tmp146,_tmp15A,_tmp15C);if(_tmp165 == 
_tmp15A)return r1;return(void*)({struct Cyc_CfFlowInfo_TagCmps_struct*_tmp166=
_region_malloc(_tmp146,sizeof(*_tmp166));_tmp166[0]=({struct Cyc_CfFlowInfo_TagCmps_struct
_tmp167;_tmp167.tag=3;_tmp167.f1=_tmp165;_tmp167;});_tmp166;});}_LLAF: _tmp15D=
_tmp148.f1;if(_tmp15D <= (void*)3)goto _LLB1;if(*((int*)_tmp15D)!= 3)goto _LLB1;
_LLB0: return r2;_LLB1: _tmp15E=_tmp148.f2;if(_tmp15E <= (void*)3)goto _LLB3;if(*((
int*)_tmp15E)!= 3)goto _LLB3;_LLB2: return r1;_LLB3:;_LLB4: goto _LLA0;_LLA0:;}{void*
il1=Cyc_CfFlowInfo_initlevel(env->d1,r1);void*il2=Cyc_CfFlowInfo_initlevel(env->d2,
r2);struct _tuple0 _tmp169=({struct _tuple0 _tmp168;_tmp168.f1=r1;_tmp168.f2=r2;
_tmp168;});void*_tmp16A;void*_tmp16B;_LLB6: _tmp16A=_tmp169.f1;if(_tmp16A <= (void*)
3)goto _LLB8;if(*((int*)_tmp16A)!= 1)goto _LLB8;_LLB7: goto _LLB9;_LLB8: _tmp16B=
_tmp169.f2;if(_tmp16B <= (void*)3)goto _LLBA;if(*((int*)_tmp16B)!= 1)goto _LLBA;
_LLB9: {struct _tuple0 _tmp16D=({struct _tuple0 _tmp16C;_tmp16C.f1=il1;_tmp16C.f2=
il2;_tmp16C;});void*_tmp16E;void*_tmp16F;void*_tmp170;void*_tmp171;_LLBD: _tmp16E=
_tmp16D.f2;if((int)_tmp16E != 0)goto _LLBF;_LLBE: goto _LLC0;_LLBF: _tmp16F=_tmp16D.f1;
if((int)_tmp16F != 0)goto _LLC1;_LLC0: return(void*)(env->fenv)->esc_none;_LLC1:
_tmp170=_tmp16D.f2;if((int)_tmp170 != 1)goto _LLC3;_LLC2: goto _LLC4;_LLC3: _tmp171=
_tmp16D.f1;if((int)_tmp171 != 1)goto _LLC5;_LLC4: return(void*)(env->fenv)->esc_this;
_LLC5:;_LLC6: return(void*)(env->fenv)->esc_all;_LLBC:;}_LLBA:;_LLBB: {struct
_tuple0 _tmp173=({struct _tuple0 _tmp172;_tmp172.f1=il1;_tmp172.f2=il2;_tmp172;});
...
r2){struct _tuple15 _tmp179=({struct _tuple15 _tmp178;_tmp178.f1=r1;_tmp178.f2=r2;
_tmp178;});union Cyc_CfFlowInfo_RelnOp_union _tmp17A;unsigned int _tmp17B;union Cyc_CfFlowInfo_RelnOp_union
_tmp17C;unsigned int _tmp17D;union Cyc_CfFlowInfo_RelnOp_union _tmp17E;struct Cyc_Absyn_Vardecl*
_tmp17F;union Cyc_CfFlowInfo_RelnOp_union _tmp180;struct Cyc_Absyn_Vardecl*_tmp181;
union Cyc_CfFlowInfo_RelnOp_union _tmp182;struct Cyc_Absyn_Vardecl*_tmp183;union Cyc_CfFlowInfo_RelnOp_union
_tmp184;struct Cyc_Absyn_Vardecl*_tmp185;union Cyc_CfFlowInfo_RelnOp_union _tmp186;
unsigned int _tmp187;union Cyc_CfFlowInfo_RelnOp_union _tmp188;unsigned int _tmp189;
union Cyc_CfFlowInfo_RelnOp_union _tmp18A;struct Cyc_Absyn_Vardecl*_tmp18B;union Cyc_CfFlowInfo_RelnOp_union
_tmp18C;struct Cyc_Absyn_Vardecl*_tmp18D;_LLD3: _tmp17A=_tmp179.f1;if(((_tmp179.f1).EqualConst).tag
...
struct Cyc_List_List*res=0;int diff=0;{struct Cyc_List_List*_tmp18E=r1s;for(0;
_tmp18E != 0;_tmp18E=_tmp18E->tl){struct Cyc_CfFlowInfo_Reln*_tmp18F=(struct Cyc_CfFlowInfo_Reln*)
_tmp18E->hd;int found=0;{struct Cyc_List_List*_tmp190=r2s;for(0;_tmp190 != 0;
_tmp190=_tmp190->tl){struct Cyc_CfFlowInfo_Reln*_tmp191=(struct Cyc_CfFlowInfo_Reln*)
_tmp190->hd;if(_tmp18F == _tmp191  || _tmp18F->vd == _tmp191->vd  && Cyc_CfFlowInfo_same_relop(
_tmp18F->rop,_tmp191->rop)){res=({struct Cyc_List_List*_tmp192=_region_malloc(r,
sizeof(*_tmp192));_tmp192->hd=_tmp18F;_tmp192->tl=res;_tmp192;});found=1;break;}}}
...
_tmp193;_push_handler(& _tmp193);{int _tmp195=0;if(setjmp(_tmp193.handler))_tmp195=
1;if(!_tmp195){*l=((struct Cyc_List_List*(*)(int(*cmp)(struct Cyc_CfFlowInfo_Place*,
struct Cyc_CfFlowInfo_Place*),struct Cyc_List_List*l,struct Cyc_CfFlowInfo_Place*x))
Cyc_List_delete_cmp)(Cyc_CfFlowInfo_place_cmp,*l,place);;_pop_handler();}else{
void*_tmp194=(void*)_exn_thrown;void*_tmp197=_tmp194;_LLE0: if(_tmp197 != Cyc_Core_Not_found)
goto _LLE2;_LLE1: goto _LLDF;_LLE2:;_LLE3:(void)_throw(_tmp197);_LLDF:;}}}static
...
mc=c2.may_consume;{struct _RegionHandle _tmp198=_new_region("temp");struct
_RegionHandle*temp=& _tmp198;_push_region(temp);{struct Cyc_List_List*_tmp199=((
struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x))Cyc_List_rcopy)(
temp,c1.may_consume);((void(*)(void(*f)(struct Cyc_List_List**,struct Cyc_CfFlowInfo_Place*),
struct Cyc_List_List**env,struct Cyc_List_List*x))Cyc_List_iter_c)(Cyc_CfFlowInfo_remove_f,&
_tmp199,c2.may_consume);while(_tmp199 != 0){mc=({struct Cyc_List_List*_tmp19A=
_region_malloc(r,sizeof(*_tmp19A));_tmp19A->hd=(struct Cyc_CfFlowInfo_Place*)((
struct Cyc_List_List*)_check_null(_tmp199))->hd;_tmp19A->tl=mc;_tmp19A;});_tmp199=((
struct Cyc_List_List*)_check_null(_tmp199))->tl;}};_pop_region(temp);}return({
struct Cyc_CfFlowInfo_ConsumeInfo _tmp19B;_tmp19B.consumed=Cyc_CfFlowInfo_union_place_set(
c1.consumed,c2.consumed,0);_tmp19B.may_consume=mc;_tmp19B;});}struct Cyc_CfFlowInfo_ConsumeInfo
Cyc_CfFlowInfo_and_consume(struct _RegionHandle*r,struct Cyc_CfFlowInfo_ConsumeInfo
c1,struct Cyc_CfFlowInfo_ConsumeInfo c2){struct Cyc_List_List*_tmp19C=((struct Cyc_List_List*(*)(
struct _RegionHandle*,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rappend)(
r,c1.may_consume,c2.may_consume);return({struct Cyc_CfFlowInfo_ConsumeInfo _tmp19D;
_tmp19D.consumed=Cyc_CfFlowInfo_union_place_set(c1.consumed,c2.consumed,1);
_tmp19D.may_consume=_tmp19C;_tmp19D;});}struct _tuple16{union Cyc_CfFlowInfo_FlowInfo_union
...
f1,union Cyc_CfFlowInfo_FlowInfo_union f2,int or_consumed){struct _tuple16 _tmp19F=({
struct _tuple16 _tmp19E;_tmp19E.f1=f1;_tmp19E.f2=f2;_tmp19E;});union Cyc_CfFlowInfo_FlowInfo_union
_tmp1A0;union Cyc_CfFlowInfo_FlowInfo_union _tmp1A1;union Cyc_CfFlowInfo_FlowInfo_union
_tmp1A2;struct Cyc_Dict_Dict _tmp1A3;struct Cyc_List_List*_tmp1A4;struct Cyc_CfFlowInfo_ConsumeInfo
_tmp1A5;union Cyc_CfFlowInfo_FlowInfo_union _tmp1A6;struct Cyc_Dict_Dict _tmp1A7;
struct Cyc_List_List*_tmp1A8;struct Cyc_CfFlowInfo_ConsumeInfo _tmp1A9;_LLE5:
_tmp1A0=_tmp19F.f1;if(((_tmp19F.f1).BottomFL).tag != 0)goto _LLE7;_LLE6: return f2;
_LLE7: _tmp1A1=_tmp19F.f2;if(((_tmp19F.f2).BottomFL).tag != 0)goto _LLE9;_LLE8:
return f1;_LLE9: _tmp1A2=_tmp19F.f1;if(((_tmp19F.f1).ReachableFL).tag != 1)goto
_LLE4;_tmp1A3=(_tmp1A2.ReachableFL).f1;_tmp1A4=(_tmp1A2.ReachableFL).f2;_tmp1A5=(
_tmp1A2.ReachableFL).f3;_tmp1A6=_tmp19F.f2;if(((_tmp19F.f2).ReachableFL).tag != 1)
goto _LLE4;_tmp1A7=(_tmp1A6.ReachableFL).f1;_tmp1A8=(_tmp1A6.ReachableFL).f2;
...
_push_region(rgn);{struct Cyc_CfFlowInfo_JoinEnv _tmp1AB=({struct Cyc_CfFlowInfo_JoinEnv
_tmp1B1;_tmp1B1.fenv=fenv;_tmp1B1.pile=({struct Cyc_CfFlowInfo_EscPile*_tmp1B2=
_region_malloc(rgn,sizeof(*_tmp1B2));_tmp1B2->rgn=rgn;_tmp1B2->places=0;_tmp1B2;});
_tmp1B1.d1=_tmp1A3;_tmp1B1.d2=_tmp1A7;_tmp1B1;});struct Cyc_Dict_Dict _tmp1AC=((
...
Cyc_Dict_intersect_c)(Cyc_CfFlowInfo_join_absRval,& _tmp1AB,_tmp1A3,_tmp1A7);
struct Cyc_List_List*_tmp1AD=Cyc_CfFlowInfo_join_relns(fenv->r,_tmp1A4,_tmp1A8);
struct Cyc_CfFlowInfo_ConsumeInfo _tmp1AE=or_consumed?Cyc_CfFlowInfo_or_consume(
fenv->r,_tmp1A5,_tmp1A9): Cyc_CfFlowInfo_and_consume(fenv->r,_tmp1A5,_tmp1A9);
union Cyc_CfFlowInfo_FlowInfo_union _tmp1B0=(union Cyc_CfFlowInfo_FlowInfo_union)({
union Cyc_CfFlowInfo_FlowInfo_union _tmp1AF;(_tmp1AF.ReachableFL).tag=1;(_tmp1AF.ReachableFL).f1=
Cyc_CfFlowInfo_escape_these(fenv,_tmp1AB.pile,all_changed,_tmp1AC);(_tmp1AF.ReachableFL).f2=
_tmp1AD;(_tmp1AF.ReachableFL).f3=_tmp1AE;_tmp1AF;});_npop_handler(0);return
_tmp1B0;};_pop_region(rgn);}_LLE4:;}struct _tuple17{union Cyc_CfFlowInfo_FlowInfo_union
...
union Cyc_CfFlowInfo_FlowInfo_union _tmp1B4;void*_tmp1B5;struct _tuple5 _tmp1B3=pr1;
_tmp1B4=_tmp1B3.f1;_tmp1B5=_tmp1B3.f2;{union Cyc_CfFlowInfo_FlowInfo_union _tmp1B7;
void*_tmp1B8;struct _tuple5 _tmp1B6=pr2;_tmp1B7=_tmp1B6.f1;_tmp1B8=_tmp1B6.f2;{
union Cyc_CfFlowInfo_FlowInfo_union outflow=Cyc_CfFlowInfo_join_flow(fenv,
all_changed,_tmp1B4,_tmp1B7,or_consumed);struct _tuple17 _tmp1BA=({struct _tuple17
_tmp1B9;_tmp1B9.f1=_tmp1B4;_tmp1B9.f2=_tmp1B7;_tmp1B9.f3=outflow;_tmp1B9;});
union Cyc_CfFlowInfo_FlowInfo_union _tmp1BB;union Cyc_CfFlowInfo_FlowInfo_union
_tmp1BC;union Cyc_CfFlowInfo_FlowInfo_union _tmp1BD;struct Cyc_Dict_Dict _tmp1BE;
union Cyc_CfFlowInfo_FlowInfo_union _tmp1BF;struct Cyc_Dict_Dict _tmp1C0;union Cyc_CfFlowInfo_FlowInfo_union
_tmp1C1;struct Cyc_Dict_Dict _tmp1C2;struct Cyc_List_List*_tmp1C3;struct Cyc_CfFlowInfo_ConsumeInfo
_tmp1C4;_LLEC: _tmp1BB=_tmp1BA.f1;if(((_tmp1BA.f1).BottomFL).tag != 0)goto _LLEE;
_LLED: return({struct _tuple5 _tmp1C5;_tmp1C5.f1=outflow;_tmp1C5.f2=_tmp1B8;_tmp1C5;});
_LLEE: _tmp1BC=_tmp1BA.f2;if(((_tmp1BA.f2).BottomFL).tag != 0)goto _LLF0;_LLEF:
return({struct _tuple5 _tmp1C6;_tmp1C6.f1=outflow;_tmp1C6.f2=_tmp1B5;_tmp1C6;});
_LLF0: _tmp1BD=_tmp1BA.f1;if(((_tmp1BA.f1).ReachableFL).tag != 1)goto _LLF2;_tmp1BE=(
...
Cyc_CfFlowInfo_absRval_lessthan_approx)(0,_tmp1B5,_tmp1B8))return({struct _tuple5
_tmp1C7;_tmp1C7.f1=outflow;_tmp1C7.f2=_tmp1B8;_tmp1C7;});if(((int(*)(int ignore,
void*r1,void*r2))Cyc_CfFlowInfo_absRval_lessthan_approx)(0,_tmp1B8,_tmp1B5))
return({struct _tuple5 _tmp1C8;_tmp1C8.f1=outflow;_tmp1C8.f2=_tmp1B5;_tmp1C8;});{
struct _RegionHandle _tmp1C9=_new_region("rgn");struct _RegionHandle*rgn=& _tmp1C9;
_push_region(rgn);{struct Cyc_CfFlowInfo_JoinEnv _tmp1CA=({struct Cyc_CfFlowInfo_JoinEnv
_tmp1CF;_tmp1CF.fenv=fenv;_tmp1CF.pile=({struct Cyc_CfFlowInfo_EscPile*_tmp1D0=
_region_malloc(rgn,sizeof(*_tmp1D0));_tmp1D0->rgn=rgn;_tmp1D0->places=0;_tmp1D0;});
_tmp1CF.d1=_tmp1BE;_tmp1CF.d2=_tmp1C0;_tmp1CF;});void*_tmp1CB=((void*(*)(struct
Cyc_CfFlowInfo_JoinEnv*env,int a,void*r1,void*r2))Cyc_CfFlowInfo_join_absRval)(&
_tmp1CA,0,_tmp1B5,_tmp1B8);struct _tuple5 _tmp1CE=({struct _tuple5 _tmp1CC;_tmp1CC.f1=(
union Cyc_CfFlowInfo_FlowInfo_union)({union Cyc_CfFlowInfo_FlowInfo_union _tmp1CD;(
_tmp1CD.ReachableFL).tag=1;(_tmp1CD.ReachableFL).f1=Cyc_CfFlowInfo_escape_these(
fenv,_tmp1CA.pile,all_changed,_tmp1C2);(_tmp1CD.ReachableFL).f2=_tmp1C3;(_tmp1CD.ReachableFL).f3=
_tmp1C4;_tmp1CD;});_tmp1CC.f2=_tmp1CB;_tmp1CC;});_npop_handler(0);return _tmp1CE;};
_pop_region(rgn);}_LLF2:;_LLF3:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
_tmp1D1=_cycalloc(sizeof(*_tmp1D1));_tmp1D1[0]=({struct Cyc_Core_Impossible_struct
_tmp1D2;_tmp1D2.tag=Cyc_Core_Impossible;_tmp1D2.f1=({const char*_tmp1D3="join_flow_and_rval: BottomFL outflow";
_tag_dyneither(_tmp1D3,sizeof(char),37);});_tmp1D2;});_tmp1D1;}));_LLEB:;}}}
...
_tuple0 _tmp1D5=({struct _tuple0 _tmp1D4;_tmp1D4.f1=r1;_tmp1D4.f2=r2;_tmp1D4;});
void*_tmp1D6;struct _dyneither_ptr _tmp1D7;void*_tmp1D8;struct _dyneither_ptr
_tmp1D9;_LLF5: _tmp1D6=_tmp1D5.f1;if(_tmp1D6 <= (void*)3)goto _LLF7;if(*((int*)
_tmp1D6)!= 4)goto _LLF7;_tmp1D7=((struct Cyc_CfFlowInfo_Aggregate_struct*)_tmp1D6)->f1;
_tmp1D8=_tmp1D5.f2;if(_tmp1D8 <= (void*)3)goto _LLF7;if(*((int*)_tmp1D8)!= 4)goto
_LLF7;_tmp1D9=((struct Cyc_CfFlowInfo_Aggregate_struct*)_tmp1D8)->f1;_LLF6: {
struct _dyneither_ptr new_d=({unsigned int _tmp1DC=_get_dyneither_size(_tmp1D7,
sizeof(void*));void**_tmp1DD=(void**)_region_malloc(((env->joinenv).fenv)->r,
_check_times(sizeof(void*),_tmp1DC));struct _dyneither_ptr _tmp1DF=_tag_dyneither(
_tmp1DD,sizeof(void*),_tmp1DC);{unsigned int _tmp1DE=_tmp1DC;unsigned int i;for(i=
0;i < _tmp1DE;i ++){_tmp1DD[i]=Cyc_CfFlowInfo_after_absRval_d(env,(int)i,((void**)
_tmp1D7.curr)[(int)i],*((void**)_check_dyneither_subscript(_tmp1D9,sizeof(void*),(
int)i)));}}_tmp1DF;});int change=0;{int i=0;for(0;i < _get_dyneither_size(_tmp1D7,
sizeof(void*));++ i){if(*((void**)_check_dyneither_subscript(new_d,sizeof(void*),
i))!= ((void**)_tmp1D7.curr)[i]){change=1;break;}}}if(!change)return r1;change=0;{
int i=0;for(0;i < _get_dyneither_size(_tmp1D7,sizeof(void*));++ i){if(*((void**)
_check_dyneither_subscript(new_d,sizeof(void*),i))!= *((void**)
_check_dyneither_subscript(_tmp1D9,sizeof(void*),i))){change=1;break;}}}if(!
change)return r2;return(void*)({struct Cyc_CfFlowInfo_Aggregate_struct*_tmp1DA=
_region_malloc(((env->joinenv).fenv)->r,sizeof(*_tmp1DA));_tmp1DA[0]=({struct Cyc_CfFlowInfo_Aggregate_struct
_tmp1DB;_tmp1DB.tag=4;_tmp1DB.f1=new_d;_tmp1DB;});_tmp1DA;});}_LLF7:;_LLF8:(int)
_throw((void*)({struct Cyc_Core_Impossible_struct*_tmp1E0=_cycalloc(sizeof(*
_tmp1E0));_tmp1E0[0]=({struct Cyc_Core_Impossible_struct _tmp1E1;_tmp1E1.tag=Cyc_Core_Impossible;
_tmp1E1.f1=({const char*_tmp1E2="after_absRval -- non-aggregates!";_tag_dyneither(
_tmp1E2,sizeof(char),33);});_tmp1E1;});_tmp1E0;}));_LLF4:;}}static void*Cyc_CfFlowInfo_after_absRval_d(
...
_tmp1E4=env->changed;*env->last_field_cell=({struct Cyc_List_List*_tmp1E5=
_region_malloc(((env->joinenv).fenv)->r,sizeof(*_tmp1E5));_tmp1E5->hd=(void*)key;
_tmp1E5->tl=0;_tmp1E5;});env->last_field_cell=(struct Cyc_List_List**)&((struct
Cyc_List_List*)_check_null(*env->last_field_cell))->tl;{void*_tmp1E6=Cyc_CfFlowInfo_after_absRval(
...
env->curr_place=({struct Cyc_CfFlowInfo_Place _tmp1E7;_tmp1E7.root=(void*)root;
_tmp1E7.fields=0;_tmp1E7;});env->last_field_cell=(struct Cyc_List_List**)&(env->curr_place)->fields;
...
struct _tuple16 _tmp1E9=({struct _tuple16 _tmp1E8;_tmp1E8.f1=f1;_tmp1E8.f2=f2;
_tmp1E8;});union Cyc_CfFlowInfo_FlowInfo_union _tmp1EA;union Cyc_CfFlowInfo_FlowInfo_union
...
_tmp1F4;(_tmp1F4.BottomFL).tag=0;_tmp1F4;});_LLFE: _tmp1EC=_tmp1E9.f1;if(((
_tmp1E9.f1).ReachableFL).tag != 1)goto _LLF9;_tmp1ED=(_tmp1EC.ReachableFL).f1;
_tmp1EE=(_tmp1EC.ReachableFL).f2;_tmp1EF=(_tmp1EC.ReachableFL).f3;_tmp1F0=
_tmp1E9.f2;if(((_tmp1E9.f2).ReachableFL).tag != 1)goto _LLF9;_tmp1F1=(_tmp1F0.ReachableFL).f1;
_tmp1F2=(_tmp1F0.ReachableFL).f2;_tmp1F3=(_tmp1F0.ReachableFL).f3;_LLFF: if(((
_tmp1ED.t == _tmp1F1.t  && _tmp1EE == _tmp1F2) && _tmp1EF.may_consume == _tmp1F3.may_consume)
 && (_tmp1EF.consumed).t == (_tmp1F3.consumed).t)return f1;{struct _RegionHandle
_tmp1F5=_new_region("rgn");struct _RegionHandle*rgn=& _tmp1F5;_push_region(rgn);{
struct Cyc_CfFlowInfo_Place*_tmp1F6=fenv->dummy_place;struct Cyc_CfFlowInfo_AfterEnv
_tmp1F7=({struct Cyc_CfFlowInfo_AfterEnv _tmp1FD;_tmp1FD.joinenv=({struct Cyc_CfFlowInfo_JoinEnv
_tmp1FE;_tmp1FE.fenv=fenv;_tmp1FE.pile=({struct Cyc_CfFlowInfo_EscPile*_tmp1FF=
_region_malloc(rgn,sizeof(*_tmp1FF));_tmp1FF->rgn=rgn;_tmp1FF->places=0;_tmp1FF;});
_tmp1FE.d1=_tmp1ED;_tmp1FE.d2=_tmp1F1;_tmp1FE;});_tmp1FD.chg1=chg1;_tmp1FD.chg2=
chg2;_tmp1FD.curr_place=_tmp1F6;_tmp1FD.last_field_cell=(struct Cyc_List_List**)&
_tmp1F6->fields;_tmp1FD.changed=Cyc_CfFlowInfo_Neither;_tmp1FD;});struct Cyc_Dict_Dict
_tmp1F8=((struct Cyc_Dict_Dict(*)(void*(*f)(struct Cyc_CfFlowInfo_AfterEnv*,void*,
void*,void*),struct Cyc_CfFlowInfo_AfterEnv*env,struct Cyc_Dict_Dict d1,struct Cyc_Dict_Dict
d2))Cyc_Dict_union_two_c)(Cyc_CfFlowInfo_after_root,& _tmp1F7,_tmp1ED,_tmp1F1);
struct Cyc_List_List*_tmp1F9=Cyc_CfFlowInfo_join_relns(fenv->r,_tmp1EE,_tmp1F2);
struct Cyc_CfFlowInfo_ConsumeInfo _tmp1FA=Cyc_CfFlowInfo_and_consume(fenv->r,
_tmp1EF,_tmp1F3);union Cyc_CfFlowInfo_FlowInfo_union _tmp1FC=(union Cyc_CfFlowInfo_FlowInfo_union)({
union Cyc_CfFlowInfo_FlowInfo_union _tmp1FB;(_tmp1FB.ReachableFL).tag=1;(_tmp1FB.ReachableFL).f1=
Cyc_CfFlowInfo_escape_these(fenv,(_tmp1F7.joinenv).pile,all_changed,_tmp1F8);(
_tmp1FB.ReachableFL).f2=_tmp1F9;(_tmp1FB.ReachableFL).f3=_tmp1FA;_tmp1FB;});
_npop_handler(0);return _tmp1FC;};_pop_region(rgn);}_LLF9:;}static int Cyc_CfFlowInfo_tag_cmps_lessthan_approx(
...
void*ignore,void*r1,void*r2){if(r1 == r2)return 1;{struct _tuple0 _tmp20A=({struct
_tuple0 _tmp209;_tmp209.f1=r1;_tmp209.f2=r2;_tmp209;});void*_tmp20B;struct Cyc_CfFlowInfo_Place*
...
struct _tuple0 _tmp221=({struct _tuple0 _tmp220;_tmp220.f1=Cyc_CfFlowInfo_initlevel_approx(
r1);_tmp220.f2=Cyc_CfFlowInfo_initlevel_approx(r2);_tmp220;});void*_tmp222;void*
_tmp223;void*_tmp224;void*_tmp225;void*_tmp226;void*_tmp227;_LL11A: _tmp222=
...
struct Cyc_List_List*_tmp22B=c1.may_consume;struct Cyc_List_List*_tmp22C=c2.may_consume;
for(0;_tmp22C != 0  && _tmp22B != 0;_tmp22C=_tmp22C->tl){if((unsigned int)_tmp22B == (
unsigned int)_tmp22C)goto compare_consumed_set;{int _tmp22D=Cyc_CfFlowInfo_place_cmp((
struct Cyc_CfFlowInfo_Place*)_tmp22B->hd,(struct Cyc_CfFlowInfo_Place*)_tmp22C->hd);
if(_tmp22D == 0)_tmp22B=_tmp22B->tl;}}if(_tmp22B != 0)return 0;}
...
struct _tuple16 _tmp22F=({struct _tuple16 _tmp22E;_tmp22E.f1=f1;_tmp22E.f2=f2;
_tmp22E;});union Cyc_CfFlowInfo_FlowInfo_union _tmp230;union Cyc_CfFlowInfo_FlowInfo_union
...
_tmp23A=(struct Cyc_CfFlowInfo_Reln*)p->hd;if(_tmp23A->vd == v){found=1;break;}{
union Cyc_CfFlowInfo_RelnOp_union _tmp23B=_tmp23A->rop;struct Cyc_Absyn_Vardecl*
_tmp23C;struct Cyc_Absyn_Vardecl*_tmp23D;struct Cyc_Absyn_Vardecl*_tmp23E;_LL12C:
if((_tmp23B.LessVar).tag != 1)goto _LL12E;_tmp23C=(_tmp23B.LessVar).f1;_LL12D:
_tmp23D=_tmp23C;goto _LL12F;_LL12E: if((_tmp23B.LessNumelts).tag != 2)goto _LL130;
_tmp23D=(_tmp23B.LessNumelts).f1;_LL12F: _tmp23E=_tmp23D;goto _LL131;_LL130: if((
_tmp23B.LessEqNumelts).tag != 4)goto _LL132;_tmp23E=(_tmp23B.LessEqNumelts).f1;
_LL131: if(v == _tmp23E)found=1;goto _LL12B;_LL132:;_LL133: goto _LL12B;_LL12B:;}}if(
!found)return rs;{struct Cyc_List_List*_tmp23F=0;for(p=rs;p != 0;p=p->tl){struct Cyc_CfFlowInfo_Reln*
_tmp240=(struct Cyc_CfFlowInfo_Reln*)p->hd;if(_tmp240->vd != v){{union Cyc_CfFlowInfo_RelnOp_union
_tmp241=_tmp240->rop;struct Cyc_Absyn_Vardecl*_tmp242;struct Cyc_Absyn_Vardecl*
_tmp243;struct Cyc_Absyn_Vardecl*_tmp244;_LL135: if((_tmp241.LessVar).tag != 1)goto
_LL137;_tmp242=(_tmp241.LessVar).f1;_LL136: _tmp243=_tmp242;goto _LL138;_LL137: if((
_tmp241.LessNumelts).tag != 2)goto _LL139;_tmp243=(_tmp241.LessNumelts).f1;_LL138:
_tmp244=_tmp243;goto _LL13A;_LL139: if((_tmp241.LessEqNumelts).tag != 4)goto _LL13B;
_tmp244=(_tmp241.LessEqNumelts).f1;_LL13A: if(v == _tmp244)continue;goto _LL134;
_LL13B:;_LL13C: goto _LL134;_LL134:;}_tmp23F=({struct Cyc_List_List*_tmp245=
_region_malloc(rgn,sizeof(*_tmp245));_tmp245->hd=_tmp240;_tmp245->tl=_tmp23F;
_tmp245;});}}return _tmp23F;}}struct Cyc_List_List*Cyc_CfFlowInfo_reln_kill_exp(
...
_tmp24F=_region_malloc(r2,sizeof(*_tmp24F));_tmp24F[0]=*t;_tmp24F;});}struct Cyc_List_List*
...
Cyc_CfFlowInfo_Reln*r){return({struct Cyc_CfFlowInfo_Reln*_tmp250=_region_malloc(
r2,sizeof(*_tmp250));_tmp250[0]=*r;_tmp250;});}struct Cyc_List_List*Cyc_CfFlowInfo_copy_relns(
...
Cyc_CfFlowInfo_Reln*_tmp251=(struct Cyc_CfFlowInfo_Reln*)r1->hd;struct Cyc_CfFlowInfo_Reln*
_tmp252=(struct Cyc_CfFlowInfo_Reln*)r2->hd;if(_tmp251->vd != _tmp252->vd  || !Cyc_CfFlowInfo_same_relop(
...
return r;r=Cyc_CfFlowInfo_reln_kill_var(rgn,r,v);{void*_tmp253=(void*)e->r;struct
Cyc_Absyn_MallocInfo _tmp254;struct Cyc_Absyn_Exp*_tmp255;int _tmp256;_LL149: if(*((
int*)_tmp253)!= 35)goto _LL14B;_tmp254=((struct Cyc_Absyn_Malloc_e_struct*)_tmp253)->f1;
_tmp255=_tmp254.num_elts;_tmp256=_tmp254.fat_result;if(_tmp256 != 1)goto _LL14B;
_LL14A: malloc_loop: {void*_tmp257=(void*)_tmp255->r;struct Cyc_Absyn_Exp*_tmp258;
void*_tmp259;struct Cyc_Absyn_Vardecl*_tmp25A;void*_tmp25B;struct Cyc_Absyn_Vardecl*
_tmp25C;void*_tmp25D;struct Cyc_Absyn_Vardecl*_tmp25E;void*_tmp25F;struct Cyc_Absyn_Vardecl*
_tmp260;_LL14E: if(*((int*)_tmp257)!= 15)goto _LL150;_tmp258=((struct Cyc_Absyn_Cast_e_struct*)
_tmp257)->f2;_LL14F: _tmp255=_tmp258;goto malloc_loop;_LL150: if(*((int*)_tmp257)!= 
1)goto _LL152;_tmp259=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp257)->f2;if(
_tmp259 <= (void*)1)goto _LL152;if(*((int*)_tmp259)!= 4)goto _LL152;_tmp25A=((
struct Cyc_Absyn_Pat_b_struct*)_tmp259)->f1;_LL151: _tmp25C=_tmp25A;goto _LL153;
_LL152: if(*((int*)_tmp257)!= 1)goto _LL154;_tmp25B=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp257)->f2;if(_tmp25B <= (void*)1)goto _LL154;if(*((int*)_tmp25B)!= 3)goto _LL154;
_tmp25C=((struct Cyc_Absyn_Local_b_struct*)_tmp25B)->f1;_LL153: _tmp25E=_tmp25C;
goto _LL155;_LL154: if(*((int*)_tmp257)!= 1)goto _LL156;_tmp25D=(void*)((struct Cyc_Absyn_Var_e_struct*)
...
return r;return({struct Cyc_List_List*_tmp261=_region_malloc(rgn,sizeof(*_tmp261));
_tmp261->hd=({struct Cyc_CfFlowInfo_Reln*_tmp262=_region_malloc(rgn,sizeof(*
_tmp262));_tmp262->vd=_tmp260;_tmp262->rop=(union Cyc_CfFlowInfo_RelnOp_union)({
union Cyc_CfFlowInfo_RelnOp_union _tmp263;(_tmp263.LessEqNumelts).tag=4;(_tmp263.LessEqNumelts).f1=
v;_tmp263;});_tmp262;});_tmp261->tl=r;_tmp261;});_LL158:;_LL159: return r;_LL14D:;}
_LL14B:;_LL14C: goto _LL148;_LL148:;}{void*_tmp264=Cyc_Tcutil_compress((void*)v->type);
_LL15B: if(_tmp264 <= (void*)4)goto _LL15D;if(*((int*)_tmp264)!= 5)goto _LL15D;
_LL15C: goto _LL15A;_LL15D:;_LL15E: return r;_LL15A:;}loop: {void*_tmp265=(void*)e->r;
struct Cyc_Absyn_Exp*_tmp266;union Cyc_Absyn_Cnst_union _tmp267;int _tmp268;void*
_tmp269;struct Cyc_List_List*_tmp26A;struct Cyc_List_List _tmp26B;struct Cyc_List_List*
_tmp26C;struct Cyc_List_List _tmp26D;struct Cyc_Absyn_Exp*_tmp26E;void*_tmp26F;
struct Cyc_List_List*_tmp270;struct Cyc_List_List _tmp271;struct Cyc_Absyn_Exp*
_tmp272;_LL160: if(*((int*)_tmp265)!= 15)goto _LL162;_tmp266=((struct Cyc_Absyn_Cast_e_struct*)
_tmp265)->f2;_LL161: e=_tmp266;goto loop;_LL162: if(*((int*)_tmp265)!= 0)goto _LL164;
_tmp267=((struct Cyc_Absyn_Const_e_struct*)_tmp265)->f1;if(((((struct Cyc_Absyn_Const_e_struct*)
_tmp265)->f1).Int_c).tag != 2)goto _LL164;_tmp268=(_tmp267.Int_c).f2;_LL163: return({
struct Cyc_List_List*_tmp273=_region_malloc(rgn,sizeof(*_tmp273));_tmp273->hd=({
struct Cyc_CfFlowInfo_Reln*_tmp274=_region_malloc(rgn,sizeof(*_tmp274));_tmp274->vd=
v;_tmp274->rop=(union Cyc_CfFlowInfo_RelnOp_union)({union Cyc_CfFlowInfo_RelnOp_union
_tmp275;(_tmp275.EqualConst).tag=0;(_tmp275.EqualConst).f1=(unsigned int)_tmp268;
_tmp275;});_tmp274;});_tmp273->tl=r;_tmp273;});_LL164: if(*((int*)_tmp265)!= 3)
goto _LL166;_tmp269=(void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp265)->f1;if((
int)_tmp269 != 4)goto _LL166;_tmp26A=((struct Cyc_Absyn_Primop_e_struct*)_tmp265)->f2;
if(_tmp26A == 0)goto _LL166;_tmp26B=*_tmp26A;_tmp26C=_tmp26B.tl;if(_tmp26C == 0)
goto _LL166;_tmp26D=*_tmp26C;_tmp26E=(struct Cyc_Absyn_Exp*)_tmp26D.hd;_LL165:{
void*_tmp276=(void*)_tmp26E->r;void*_tmp277;struct Cyc_List_List*_tmp278;struct
Cyc_List_List _tmp279;struct Cyc_Absyn_Exp*_tmp27A;_LL16B: if(*((int*)_tmp276)!= 3)
goto _LL16D;_tmp277=(void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp276)->f1;
...
return r;return({struct Cyc_List_List*_tmp284=_region_malloc(rgn,sizeof(*_tmp284));
_tmp284->hd=({struct Cyc_CfFlowInfo_Reln*_tmp285=_region_malloc(rgn,sizeof(*
_tmp285));_tmp285->vd=v;_tmp285->rop=(union Cyc_CfFlowInfo_RelnOp_union)({union
Cyc_CfFlowInfo_RelnOp_union _tmp286;(_tmp286.LessNumelts).tag=2;(_tmp286.LessNumelts).f1=
_tmp283;_tmp286;});_tmp285;});_tmp284->tl=r;_tmp284;});_LL178:;_LL179: goto _LL16F;
_LL16F:;}goto _LL16A;_LL16D:;_LL16E: goto _LL16A;_LL16A:;}goto _LL15F;_LL166: if(*((
int*)_tmp265)!= 3)goto _LL168;_tmp26F=(void*)((struct Cyc_Absyn_Primop_e_struct*)
_tmp265)->f1;_tmp270=((struct Cyc_Absyn_Primop_e_struct*)_tmp265)->f2;if(_tmp270
== 0)goto _LL168;_tmp271=*_tmp270;_tmp272=(struct Cyc_Absyn_Exp*)_tmp271.hd;_LL167:{
void*_tmp287=(void*)_tmp272->r;void*_tmp288;struct Cyc_Absyn_Vardecl*_tmp289;void*
...
Cyc_CfFlowInfo_RelnOp_union _tmp292;(_tmp292.LessEqNumelts).tag=4;(_tmp292.LessEqNumelts).f1=
_tmp28F;_tmp292;});_tmp291;});_tmp290->tl=r;_tmp290;});_LL183:;_LL184: goto _LL17A;
...
struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2){{void*_tmp293=(void*)e1->r;void*
_tmp294;struct Cyc_Absyn_Vardecl*_tmp295;void*_tmp296;struct Cyc_Absyn_Vardecl*
_tmp297;void*_tmp298;struct Cyc_Absyn_Vardecl*_tmp299;void*_tmp29A;struct Cyc_Absyn_Vardecl*
_tmp29B;_LL186: if(*((int*)_tmp293)!= 1)goto _LL188;_tmp294=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp293)->f2;if(_tmp294 <= (void*)1)goto _LL188;if(*((int*)_tmp294)!= 0)goto _LL188;
_tmp295=((struct Cyc_Absyn_Global_b_struct*)_tmp294)->f1;_LL187: _tmp297=_tmp295;
goto _LL189;_LL188: if(*((int*)_tmp293)!= 1)goto _LL18A;_tmp296=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp293)->f2;if(_tmp296 <= (void*)1)goto _LL18A;if(*((int*)_tmp296)!= 2)goto _LL18A;
_tmp297=((struct Cyc_Absyn_Param_b_struct*)_tmp296)->f1;_LL189: _tmp299=_tmp297;
goto _LL18B;_LL18A: if(*((int*)_tmp293)!= 1)goto _LL18C;_tmp298=(void*)((struct Cyc_Absyn_Var_e_struct*)
...
r){({struct Cyc_String_pa_struct _tmp29E;_tmp29E.tag=0;_tmp29E.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string((r->vd)->name));{
void*_tmp29C[1]={& _tmp29E};Cyc_fprintf(Cyc_stderr,({const char*_tmp29D="%s";
_tag_dyneither(_tmp29D,sizeof(char),3);}),_tag_dyneither(_tmp29C,sizeof(void*),1));}});{
...
_LL192:({struct Cyc_Int_pa_struct _tmp2A7;_tmp2A7.tag=1;_tmp2A7.f1=(unsigned long)((
int)_tmp2A0);{void*_tmp2A5[1]={& _tmp2A7};Cyc_fprintf(Cyc_stderr,({const char*
_tmp2A6="==%d";_tag_dyneither(_tmp2A6,sizeof(char),5);}),_tag_dyneither(_tmp2A5,
sizeof(void*),1));}});goto _LL190;_LL193: if((_tmp29F.LessVar).tag != 1)goto _LL195;
_tmp2A1=(_tmp29F.LessVar).f1;_LL194:({struct Cyc_String_pa_struct _tmp2AA;_tmp2AA.tag=
0;_tmp2AA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp2A1->name));{void*_tmp2A8[1]={& _tmp2AA};Cyc_fprintf(Cyc_stderr,({const char*
_tmp2A9="<%s";_tag_dyneither(_tmp2A9,sizeof(char),4);}),_tag_dyneither(_tmp2A8,
sizeof(void*),1));}});goto _LL190;_LL195: if((_tmp29F.LessNumelts).tag != 2)goto
_LL197;_tmp2A2=(_tmp29F.LessNumelts).f1;_LL196:({struct Cyc_String_pa_struct
_tmp2AD;_tmp2AD.tag=0;_tmp2AD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_qvar2string(_tmp2A2->name));{void*_tmp2AB[1]={& _tmp2AD};Cyc_fprintf(
Cyc_stderr,({const char*_tmp2AC="<numelts(%s)";_tag_dyneither(_tmp2AC,sizeof(char),
13);}),_tag_dyneither(_tmp2AB,sizeof(void*),1));}});goto _LL190;_LL197: if((
_tmp29F.LessConst).tag != 3)goto _LL199;_tmp2A3=(_tmp29F.LessConst).f1;_LL198:({
struct Cyc_Int_pa_struct _tmp2B0;_tmp2B0.tag=1;_tmp2B0.f1=(unsigned long)((int)
_tmp2A3);{void*_tmp2AE[1]={& _tmp2B0};Cyc_fprintf(Cyc_stderr,({const char*_tmp2AF="<%d";
_tag_dyneither(_tmp2AF,sizeof(char),4);}),_tag_dyneither(_tmp2AE,sizeof(void*),1));}});
goto _LL190;_LL199: if((_tmp29F.LessEqNumelts).tag != 4)goto _LL190;_tmp2A4=(_tmp29F.LessEqNumelts).f1;
_LL19A:({struct Cyc_String_pa_struct _tmp2B3;_tmp2B3.tag=0;_tmp2B3.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp2A4->name));{
void*_tmp2B1[1]={& _tmp2B3};Cyc_fprintf(Cyc_stderr,({const char*_tmp2B2="<=numelts(%s)";
_tag_dyneither(_tmp2B2,sizeof(char),14);}),_tag_dyneither(_tmp2B1,sizeof(void*),
...
if(r->tl != 0)({void*_tmp2B4=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp2B5=",";
_tag_dyneither(_tmp2B5,sizeof(char),2);}),_tag_dyneither(_tmp2B4,sizeof(void*),0));});}}
void Cyc_CfFlowInfo_print_initlevel(void*il){void*_tmp2B6=il;_LL19C: if((int)
_tmp2B6 != 0)goto _LL19E;_LL19D:({void*_tmp2B7=0;Cyc_fprintf(Cyc_stderr,({const
char*_tmp2B8="uninitialized";_tag_dyneither(_tmp2B8,sizeof(char),14);}),
_tag_dyneither(_tmp2B7,sizeof(void*),0));});goto _LL19B;_LL19E: if((int)_tmp2B6 != 
1)goto _LL1A0;_LL19F:({void*_tmp2B9=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp2BA="this-initialized";
_tag_dyneither(_tmp2BA,sizeof(char),17);}),_tag_dyneither(_tmp2B9,sizeof(void*),
0));});goto _LL19B;_LL1A0: if((int)_tmp2B6 != 2)goto _LL19B;_LL1A1:({void*_tmp2BB=0;
Cyc_fprintf(Cyc_stderr,({const char*_tmp2BC="all-initialized";_tag_dyneither(
_tmp2BC,sizeof(char),16);}),_tag_dyneither(_tmp2BB,sizeof(void*),0));});goto
_LL19B;_LL19B:;}void Cyc_CfFlowInfo_print_root(void*root){void*_tmp2BD=root;
struct Cyc_Absyn_Vardecl*_tmp2BE;struct Cyc_Absyn_Exp*_tmp2BF;void*_tmp2C0;_LL1A3:
if(*((int*)_tmp2BD)!= 0)goto _LL1A5;_tmp2BE=((struct Cyc_CfFlowInfo_VarRoot_struct*)
_tmp2BD)->f1;_LL1A4:({struct Cyc_String_pa_struct _tmp2C3;_tmp2C3.tag=0;_tmp2C3.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp2BE->name));{
void*_tmp2C1[1]={& _tmp2C3};Cyc_fprintf(Cyc_stderr,({const char*_tmp2C2="Root(%s)";
_tag_dyneither(_tmp2C2,sizeof(char),9);}),_tag_dyneither(_tmp2C1,sizeof(void*),1));}});
...
_LL1A6:({struct Cyc_String_pa_struct _tmp2C7;_tmp2C7.tag=0;_tmp2C7.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp2C0));{struct
Cyc_String_pa_struct _tmp2C6;_tmp2C6.tag=0;_tmp2C6.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmp2BF));{void*_tmp2C4[2]={& _tmp2C6,&
_tmp2C7};Cyc_fprintf(Cyc_stderr,({const char*_tmp2C5="MallocPt(%s,%s)";
_tag_dyneither(_tmp2C5,sizeof(char),16);}),_tag_dyneither(_tmp2C4,sizeof(void*),
2));}}});goto _LL1A2;_LL1A7: if(*((int*)_tmp2BD)!= 2)goto _LL1A2;_LL1A8:({void*
_tmp2C8=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp2C9="InitParam(_,_)";
_tag_dyneither(_tmp2C9,sizeof(char),15);}),_tag_dyneither(_tmp2C8,sizeof(void*),
...
while(_tmp2CA != 0){({struct Cyc_Int_pa_struct _tmp2CD;_tmp2CD.tag=1;_tmp2CD.f1=(
unsigned long)((int)_tmp2CA->hd);{void*_tmp2CB[1]={& _tmp2CD};Cyc_fprintf(Cyc_stderr,({
const char*_tmp2CC=".%d";_tag_dyneither(_tmp2CC,sizeof(char),4);}),_tag_dyneither(
_tmp2CB,sizeof(void*),1));}});_tmp2CA=_tmp2CA->tl;}({void*_tmp2CE=0;Cyc_fprintf(
Cyc_stderr,({const char*_tmp2CF=" ";_tag_dyneither(_tmp2CF,sizeof(char),2);}),
_tag_dyneither(_tmp2CE,sizeof(void*),0));});}}void Cyc_CfFlowInfo_print_list(
struct Cyc_List_List*x,void(*pr)(void*)){int _tmp2D0=1;while(x != 0){if(!_tmp2D0){({
void*_tmp2D1=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp2D2=", ";_tag_dyneither(
_tmp2D2,sizeof(char),3);}),_tag_dyneither(_tmp2D1,sizeof(void*),0));});_tmp2D0=0;}
pr((void*)x->hd);x=x->tl;}({void*_tmp2D3=0;Cyc_fprintf(Cyc_stderr,({const char*
_tmp2D4="\n";_tag_dyneither(_tmp2D4,sizeof(char),2);}),_tag_dyneither(_tmp2D3,
sizeof(void*),0));});}void Cyc_CfFlowInfo_print_dict_set(struct Cyc_Dict_Dict p,
void(*pr)(void*)){struct _RegionHandle _tmp2D5=_new_region("r");struct
_RegionHandle*r=& _tmp2D5;_push_region(r);{struct _handler_cons _tmp2D6;
...
r,p);int first=1;({void*_tmp2DB=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp2DC="{ ";
_tag_dyneither(_tmp2DC,sizeof(char),3);}),_tag_dyneither(_tmp2DB,sizeof(void*),0));});
while(((int(*)(struct Cyc_Iter_Iter,struct _tuple10*))Cyc_Iter_next)(_tmp2D9,&
_tmp2DA)){void*_tmp2DD=_tmp2DA.f1;if(!first){({void*_tmp2DE=0;Cyc_fprintf(Cyc_stderr,({
const char*_tmp2DF=", ";_tag_dyneither(_tmp2DF,sizeof(char),3);}),_tag_dyneither(
_tmp2DE,sizeof(void*),0));});first=0;}pr(_tmp2DD);}({void*_tmp2E0=0;Cyc_fprintf(
Cyc_stderr,({const char*_tmp2E1="}\n";_tag_dyneither(_tmp2E1,sizeof(char),3);}),
_tag_dyneither(_tmp2E0,sizeof(void*),0));});};_pop_handler();}else{void*_tmp2D7=(
void*)_exn_thrown;void*_tmp2E3=_tmp2D7;_LL1AA:;_LL1AB:({void*_tmp2E4=0;Cyc_fprintf(
Cyc_stderr,({const char*_tmp2E5="{ }\n";_tag_dyneither(_tmp2E5,sizeof(char),5);}),
_tag_dyneither(_tmp2E4,sizeof(void*),0));});_npop_handler(0);return;_LL1AC:;
_LL1AD:(void)_throw(_tmp2E3);_LL1A9:;}}};_pop_region(r);}void Cyc_CfFlowInfo_print_absrval(
...
void*_tmp2EB=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp2EC="Zero";_tag_dyneither(
_tmp2EC,sizeof(char),5);}),_tag_dyneither(_tmp2EB,sizeof(void*),0));});goto
_LL1AE;_LL1B1: if((int)_tmp2E6 != 1)goto _LL1B3;_LL1B2:({void*_tmp2ED=0;Cyc_fprintf(
Cyc_stderr,({const char*_tmp2EE="NotZeroAll";_tag_dyneither(_tmp2EE,sizeof(char),
11);}),_tag_dyneither(_tmp2ED,sizeof(void*),0));});goto _LL1AE;_LL1B3: if((int)
_tmp2E6 != 2)goto _LL1B5;_LL1B4:({void*_tmp2EF=0;Cyc_fprintf(Cyc_stderr,({const
char*_tmp2F0="NotZeroThis";_tag_dyneither(_tmp2F0,sizeof(char),12);}),
_tag_dyneither(_tmp2EF,sizeof(void*),0));});goto _LL1AE;_LL1B5: if(_tmp2E6 <= (void*)
3)goto _LL1B7;if(*((int*)_tmp2E6)!= 0)goto _LL1B7;_tmp2E7=(void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)
_tmp2E6)->f1;_LL1B6:({void*_tmp2F1=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp2F2="Unknown(";
_tag_dyneither(_tmp2F2,sizeof(char),9);}),_tag_dyneither(_tmp2F1,sizeof(void*),0));});
Cyc_CfFlowInfo_print_initlevel(_tmp2E7);({void*_tmp2F3=0;Cyc_fprintf(Cyc_stderr,({
const char*_tmp2F4=")";_tag_dyneither(_tmp2F4,sizeof(char),2);}),_tag_dyneither(
_tmp2F3,sizeof(void*),0));});goto _LL1AE;_LL1B7: if(_tmp2E6 <= (void*)3)goto _LL1B9;
if(*((int*)_tmp2E6)!= 1)goto _LL1B9;_tmp2E8=(void*)((struct Cyc_CfFlowInfo_Esc_struct*)
_tmp2E6)->f1;_LL1B8:({void*_tmp2F5=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp2F6="Esc(";
_tag_dyneither(_tmp2F6,sizeof(char),5);}),_tag_dyneither(_tmp2F5,sizeof(void*),0));});
Cyc_CfFlowInfo_print_initlevel(_tmp2E8);({void*_tmp2F7=0;Cyc_fprintf(Cyc_stderr,({
const char*_tmp2F8=")";_tag_dyneither(_tmp2F8,sizeof(char),2);}),_tag_dyneither(
_tmp2F7,sizeof(void*),0));});goto _LL1AE;_LL1B9: if(_tmp2E6 <= (void*)3)goto _LL1BB;
if(*((int*)_tmp2E6)!= 2)goto _LL1BB;_tmp2E9=((struct Cyc_CfFlowInfo_AddressOf_struct*)
_tmp2E6)->f1;_LL1BA:({void*_tmp2F9=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp2FA="AddrOf(";
_tag_dyneither(_tmp2FA,sizeof(char),8);}),_tag_dyneither(_tmp2F9,sizeof(void*),0));});
Cyc_CfFlowInfo_print_place(_tmp2E9);({void*_tmp2FB=0;Cyc_fprintf(Cyc_stderr,({
const char*_tmp2FC=")";_tag_dyneither(_tmp2FC,sizeof(char),2);}),_tag_dyneither(
_tmp2FB,sizeof(void*),0));});goto _LL1AE;_LL1BB: if(_tmp2E6 <= (void*)3)goto _LL1BD;
if(*((int*)_tmp2E6)!= 3)goto _LL1BD;_LL1BC:({void*_tmp2FD=0;Cyc_fprintf(Cyc_stderr,({
const char*_tmp2FE="TagCmps(?)";_tag_dyneither(_tmp2FE,sizeof(char),11);}),
_tag_dyneither(_tmp2FD,sizeof(void*),0));});goto _LL1AE;_LL1BD: if(_tmp2E6 <= (void*)
3)goto _LL1AE;if(*((int*)_tmp2E6)!= 4)goto _LL1AE;_tmp2EA=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmp2E6)->f1;_LL1BE:({void*_tmp2FF=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp300="Aggregate{";
_tag_dyneither(_tmp300,sizeof(char),11);}),_tag_dyneither(_tmp2FF,sizeof(void*),
0));});{int i=0;for(0;i < _get_dyneither_size(_tmp2EA,sizeof(void*));++ i){Cyc_CfFlowInfo_print_absrval(((
void**)_tmp2EA.curr)[i]);if(i + 1 < _get_dyneither_size(_tmp2EA,sizeof(void*)))({
void*_tmp301=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp302=",";_tag_dyneither(
_tmp302,sizeof(char),2);}),_tag_dyneither(_tmp301,sizeof(void*),0));});}}({void*
_tmp303=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp304="}";_tag_dyneither(_tmp304,
sizeof(char),2);}),_tag_dyneither(_tmp303,sizeof(void*),0));});goto _LL1AE;_LL1AE:;}
static void Cyc_CfFlowInfo_print_flow_mapping(void*root,void*rval){({void*_tmp305=
0;Cyc_fprintf(Cyc_stderr,({const char*_tmp306="    ";_tag_dyneither(_tmp306,
sizeof(char),5);}),_tag_dyneither(_tmp305,sizeof(void*),0));});Cyc_CfFlowInfo_print_root(
root);({void*_tmp307=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp308=" --> ";
_tag_dyneither(_tmp308,sizeof(char),6);}),_tag_dyneither(_tmp307,sizeof(void*),0));});
Cyc_CfFlowInfo_print_absrval(rval);({void*_tmp309=0;Cyc_fprintf(Cyc_stderr,({
const char*_tmp30A="\n";_tag_dyneither(_tmp30A,sizeof(char),2);}),_tag_dyneither(
_tmp309,sizeof(void*),0));});}void Cyc_CfFlowInfo_print_flowdict(struct Cyc_Dict_Dict
...
_tmp30B.BottomFL).tag != 0)goto _LL1C2;_LL1C1:({void*_tmp30E=0;Cyc_fprintf(Cyc_stderr,({
const char*_tmp30F="  BottomFL\n";_tag_dyneither(_tmp30F,sizeof(char),12);}),
_tag_dyneither(_tmp30E,sizeof(void*),0));});goto _LL1BF;_LL1C2: if((_tmp30B.ReachableFL).tag
!= 1)goto _LL1BF;_tmp30C=(_tmp30B.ReachableFL).f1;_tmp30D=(_tmp30B.ReachableFL).f3;
_LL1C3:({void*_tmp310=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp311="  ReachableFL:\n";
_tag_dyneither(_tmp311,sizeof(char),16);}),_tag_dyneither(_tmp310,sizeof(void*),
0));});Cyc_Dict_iter(Cyc_CfFlowInfo_print_flow_mapping,_tmp30C);({void*_tmp312=0;
Cyc_fprintf(Cyc_stderr,({const char*_tmp313="\n    consumed: ";_tag_dyneither(
_tmp313,sizeof(char),16);}),_tag_dyneither(_tmp312,sizeof(void*),0));});((void(*)(
struct Cyc_Dict_Dict p,void(*pr)(struct Cyc_CfFlowInfo_Place*)))Cyc_CfFlowInfo_print_dict_set)(
_tmp30D.consumed,Cyc_CfFlowInfo_print_place);({void*_tmp314=0;Cyc_fprintf(Cyc_stderr,({
const char*_tmp315="\n    may_consume: ";_tag_dyneither(_tmp315,sizeof(char),19);}),
_tag_dyneither(_tmp314,sizeof(void*),0));});((void(*)(struct Cyc_List_List*x,void(*
pr)(struct Cyc_CfFlowInfo_Place*)))Cyc_CfFlowInfo_print_list)(_tmp30D.may_consume,
Cyc_CfFlowInfo_print_place);({void*_tmp316=0;Cyc_fprintf(Cyc_stderr,({const char*
_tmp317="\n";_tag_dyneither(_tmp317,sizeof(char),2);}),_tag_dyneither(_tmp316,
sizeof(void*),0));});goto _LL1BF;_LL1BF:;}int Cyc_CfFlowInfo_contains_region(void*
rgn,void*t){void*_tmp318=Cyc_Tcutil_compress(t);struct Cyc_Absyn_Tvar*_tmp319;
struct Cyc_Absyn_TunionInfo _tmp31A;struct Cyc_List_List*_tmp31B;struct Cyc_Core_Opt*
_tmp31C;struct Cyc_List_List*_tmp31D;struct Cyc_Absyn_AggrInfo _tmp31E;struct Cyc_List_List*
_tmp31F;struct Cyc_Absyn_TunionFieldInfo _tmp320;struct Cyc_List_List*_tmp321;
struct Cyc_List_List*_tmp322;struct Cyc_Absyn_PtrInfo _tmp323;void*_tmp324;struct
Cyc_Absyn_PtrAtts _tmp325;void*_tmp326;struct Cyc_List_List*_tmp327;struct Cyc_List_List*
_tmp328;struct Cyc_Absyn_ArrayInfo _tmp329;void*_tmp32A;void*_tmp32B;void*_tmp32C;
void*_tmp32D;void*_tmp32E;void*_tmp32F;_LL1C5: if((int)_tmp318 != 0)goto _LL1C7;
_LL1C6: goto _LL1C8;_LL1C7: if(_tmp318 <= (void*)4)goto _LL1C9;if(*((int*)_tmp318)!= 
5)goto _LL1C9;_LL1C8: goto _LL1CA;_LL1C9: if((int)_tmp318 != 1)goto _LL1CB;_LL1CA: goto
_LL1CC;_LL1CB: if(_tmp318 <= (void*)4)goto _LL1D3;if(*((int*)_tmp318)!= 6)goto
_LL1CD;_LL1CC: goto _LL1CE;_LL1CD: if(*((int*)_tmp318)!= 12)goto _LL1CF;_LL1CE: goto
_LL1D0;_LL1CF: if(*((int*)_tmp318)!= 13)goto _LL1D1;_LL1D0: goto _LL1D2;_LL1D1: if(*((
int*)_tmp318)!= 18)goto _LL1D3;_LL1D2: goto _LL1D4;_LL1D3: if((int)_tmp318 != 2)goto
_LL1D5;_LL1D4: goto _LL1D6;_LL1D5: if(_tmp318 <= (void*)4)goto _LL1D7;if(*((int*)
_tmp318)!= 0)goto _LL1D7;_LL1D6: return 0;_LL1D7: if((int)_tmp318 != 3)goto _LL1D9;
_LL1D8: {void*_tmp330=rgn;_LL1FA: if((int)_tmp330 != 0)goto _LL1FC;_LL1FB: return 1;
_LL1FC:;_LL1FD: return 0;_LL1F9:;}_LL1D9: if(_tmp318 <= (void*)4)goto _LL1DB;if(*((
int*)_tmp318)!= 1)goto _LL1DB;_tmp319=((struct Cyc_Absyn_VarType_struct*)_tmp318)->f1;
_LL1DA: {void*_tmp331=rgn;struct Cyc_Absyn_Tvar*_tmp332;_LL1FF: if((int)_tmp331 != 
0)goto _LL201;_LL200: return 0;_LL201: if(_tmp331 <= (void*)1)goto _LL1FE;if(*((int*)
_tmp331)!= 0)goto _LL1FE;_tmp332=((struct Cyc_CfFlowInfo_Region_k_struct*)_tmp331)->f1;
_LL202: return Cyc_Absyn_tvar_cmp(_tmp319,_tmp332)== 0;_LL1FE:;}_LL1DB: if(_tmp318
<= (void*)4)goto _LL1DD;if(*((int*)_tmp318)!= 2)goto _LL1DD;_tmp31A=((struct Cyc_Absyn_TunionType_struct*)
_tmp318)->f1;_tmp31B=_tmp31A.targs;_tmp31C=_tmp31A.rgn;_LL1DC: if((unsigned int)
_tmp31C  && Cyc_CfFlowInfo_contains_region(rgn,(void*)_tmp31C->v))return 1;_tmp31D=
_tmp31B;goto _LL1DE;_LL1DD: if(_tmp318 <= (void*)4)goto _LL1DF;if(*((int*)_tmp318)!= 
16)goto _LL1DF;_tmp31D=((struct Cyc_Absyn_TypedefType_struct*)_tmp318)->f2;_LL1DE:
_tmp31F=_tmp31D;goto _LL1E0;_LL1DF: if(_tmp318 <= (void*)4)goto _LL1E1;if(*((int*)
_tmp318)!= 10)goto _LL1E1;_tmp31E=((struct Cyc_Absyn_AggrType_struct*)_tmp318)->f1;
_tmp31F=_tmp31E.targs;_LL1E0: _tmp321=_tmp31F;goto _LL1E2;_LL1E1: if(_tmp318 <= (
void*)4)goto _LL1E3;if(*((int*)_tmp318)!= 3)goto _LL1E3;_tmp320=((struct Cyc_Absyn_TunionFieldType_struct*)
_tmp318)->f1;_tmp321=_tmp320.targs;_LL1E2: _tmp322=_tmp321;goto _LL1E4;_LL1E3: if(
_tmp318 <= (void*)4)goto _LL1E5;if(*((int*)_tmp318)!= 20)goto _LL1E5;_tmp322=((
struct Cyc_Absyn_JoinEff_struct*)_tmp318)->f1;_LL1E4: return Cyc_List_exists_c(Cyc_CfFlowInfo_contains_region,
rgn,_tmp322);_LL1E5: if(_tmp318 <= (void*)4)goto _LL1E7;if(*((int*)_tmp318)!= 4)
goto _LL1E7;_tmp323=((struct Cyc_Absyn_PointerType_struct*)_tmp318)->f1;_tmp324=(
void*)_tmp323.elt_typ;_tmp325=_tmp323.ptr_atts;_tmp326=(void*)_tmp325.rgn;_LL1E6:
...
fd,void*rgn){void*_tmp33C=Cyc_Tcutil_compress(rgn);struct Cyc_Absyn_Tvar*_tmp33D;
_LL20B: if(_tmp33C <= (void*)4)goto _LL20D;if(*((int*)_tmp33C)!= 1)goto _LL20D;
_tmp33D=((struct Cyc_Absyn_VarType_struct*)_tmp33C)->f1;_LL20C: {struct Cyc_CfFlowInfo_Region_k_struct
v=({struct Cyc_CfFlowInfo_Region_k_struct _tmp33F;_tmp33F.tag=0;_tmp33F.f1=_tmp33D;
_tmp33F;});void*v2=(void*)& v;struct _tuple18 env=({struct _tuple18 _tmp33E;_tmp33E.f1=
fenv;_tmp33E.f2=fenv->mt_flowdict;_tmp33E.f3=v2;_tmp33E;});((void(*)(void(*f)(
struct _tuple18*,void*,void*),struct _tuple18*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(
Cyc_CfFlowInfo_kill_root,& env,fd);return env.f2;}_LL20D: if((int)_tmp33C != 3)goto
_LL20F;_LL20E: {struct _tuple18 env=({struct _tuple18 _tmp340;_tmp340.f1=fenv;
_tmp340.f2=fenv->mt_flowdict;_tmp340.f3=(void*)0;_tmp340;});((void(*)(void(*f)(
struct _tuple18*,void*,void*),struct _tuple18*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(
Cyc_CfFlowInfo_kill_root,& env,fd);return env.f2;}_LL20F:;_LL210:(int)_throw((void*)({
struct Cyc_Core_Impossible_struct*_tmp341=_cycalloc(sizeof(*_tmp341));_tmp341[0]=({
struct Cyc_Core_Impossible_struct _tmp342;_tmp342.tag=Cyc_Core_Impossible;_tmp342.f1=({
const char*_tmp343="kill_flowdict_region";_tag_dyneither(_tmp343,sizeof(char),21);});
_tmp342;});_tmp341;}));_LL20A:;}static struct Cyc_List_List*Cyc_CfFlowInfo_kill_relns_region(
...
f,void*rgn){union Cyc_CfFlowInfo_FlowInfo_union _tmp344=f;struct Cyc_Dict_Dict
_tmp345;struct Cyc_List_List*_tmp346;struct Cyc_CfFlowInfo_ConsumeInfo _tmp347;
_LL212: if((_tmp344.BottomFL).tag != 0)goto _LL214;_LL213: return f;_LL214: if((
_tmp344.ReachableFL).tag != 1)goto _LL211;_tmp345=(_tmp344.ReachableFL).f1;_tmp346=(
_tmp344.ReachableFL).f2;_tmp347=(_tmp344.ReachableFL).f3;_LL215: {struct Cyc_Dict_Dict
_tmp348=Cyc_CfFlowInfo_kill_flowdict_region(fenv,_tmp345,rgn);struct Cyc_List_List*
_tmp349=Cyc_CfFlowInfo_kill_relns_region(_tmp346,rgn);return(union Cyc_CfFlowInfo_FlowInfo_union)({
union Cyc_CfFlowInfo_FlowInfo_union _tmp34A;(_tmp34A.ReachableFL).tag=1;(_tmp34A.ReachableFL).f1=
_tmp348;(_tmp34A.ReachableFL).f2=_tmp349;(_tmp34A.ReachableFL).f3=_tmp347;
_tmp34A;});}_LL211:;}static struct Cyc_CfFlowInfo_UniquePlace*Cyc_CfFlowInfo_unique_place_of_rec(
...
_tmp354=((struct Cyc_Absyn_Pat_b_struct*)_tmp353)->f1;_LL222: return({struct Cyc_CfFlowInfo_UniquePlace*
_tmp35E=_region_malloc(r,sizeof(*_tmp35E));_tmp35E->place=({struct Cyc_CfFlowInfo_Place
_tmp35F;_tmp35F.root=(void*)((void*)({struct Cyc_CfFlowInfo_VarRoot_struct*
_tmp360=_region_malloc(r,sizeof(*_tmp360));_tmp360[0]=({struct Cyc_CfFlowInfo_VarRoot_struct
_tmp361;_tmp361.tag=0;_tmp361.f1=_tmp354;_tmp361;});_tmp360;}));_tmp35F.fields=
flds;_tmp35F;});_tmp35E->path=path;_tmp35E;});_LL223: if(*((int*)_tmp34B)!= 1)
goto _LL225;_tmp355=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp34B)->f2;if(
_tmp355 <= (void*)1)goto _LL225;if(*((int*)_tmp355)!= 0)goto _LL225;_tmp356=((
struct Cyc_Absyn_Global_b_struct*)_tmp355)->f1;_LL224:(int)_throw((void*)({struct
Cyc_Core_Impossible_struct*_tmp362=_cycalloc(sizeof(*_tmp362));_tmp362[0]=({
struct Cyc_Core_Impossible_struct _tmp363;_tmp363.tag=Cyc_Core_Impossible;_tmp363.f1=({
const char*_tmp364="non-unique path";_tag_dyneither(_tmp364,sizeof(char),16);});
_tmp363;});_tmp362;}));_LL225: if(*((int*)_tmp34B)!= 24)goto _LL227;_tmp357=((
struct Cyc_Absyn_AggrArrow_e_struct*)_tmp34B)->f1;_tmp358=((struct Cyc_Absyn_AggrArrow_e_struct*)
_tmp34B)->f2;_LL226:{void*_tmp365=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
_check_null(_tmp357->topt))->v);struct Cyc_Absyn_PtrInfo _tmp366;void*_tmp367;
_LL230: if(_tmp365 <= (void*)4)goto _LL232;if(*((int*)_tmp365)!= 4)goto _LL232;
_tmp366=((struct Cyc_Absyn_PointerType_struct*)_tmp365)->f1;_tmp367=(void*)
_tmp366.elt_typ;_LL231: if(!Cyc_Absyn_is_union_type(_tmp367))flds=({struct Cyc_List_List*
_tmp368=_region_malloc(r,sizeof(*_tmp368));_tmp368->hd=(void*)Cyc_CfFlowInfo_get_field_index(
_tmp367,_tmp358);_tmp368->tl=flds;_tmp368;});goto _LL22F;_LL232:;_LL233:(int)
_throw((void*)({struct Cyc_Core_Impossible_struct*_tmp369=_cycalloc(sizeof(*
_tmp369));_tmp369[0]=({struct Cyc_Core_Impossible_struct _tmp36A;_tmp36A.tag=Cyc_Core_Impossible;
_tmp36A.f1=({const char*_tmp36B="anal_Rexp: AggrArrow ptr";_tag_dyneither(_tmp36B,
sizeof(char),25);});_tmp36A;});_tmp369;}));_LL22F:;}_tmp359=_tmp357;goto _LL228;
_LL227: if(*((int*)_tmp34B)!= 22)goto _LL229;_tmp359=((struct Cyc_Absyn_Deref_e_struct*)
_tmp34B)->f1;_LL228: return Cyc_CfFlowInfo_unique_place_of_rec(r,_tmp359,0,({
struct Cyc_List_List*_tmp36C=_region_malloc(r,sizeof(*_tmp36C));_tmp36C->hd=flds;
_tmp36C->tl=path;_tmp36C;}));_LL229: if(*((int*)_tmp34B)!= 25)goto _LL22B;_tmp35A=((
struct Cyc_Absyn_Subscript_e_struct*)_tmp34B)->f1;_tmp35B=((struct Cyc_Absyn_Subscript_e_struct*)
_tmp34B)->f2;_LL22A: {void*_tmp36D=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
_check_null(_tmp35A->topt))->v);struct Cyc_Absyn_PtrInfo _tmp36E;void*_tmp36F;
struct Cyc_Absyn_PtrAtts _tmp370;struct Cyc_Absyn_Conref*_tmp371;_LL235: if(_tmp36D
<= (void*)4)goto _LL239;if(*((int*)_tmp36D)!= 9)goto _LL237;_LL236: {unsigned int
_tmp372=(Cyc_Evexp_eval_const_uint_exp(_tmp35B)).f1;return Cyc_CfFlowInfo_unique_place_of_rec(
r,_tmp35A,({struct Cyc_List_List*_tmp373=_region_malloc(r,sizeof(*_tmp373));
_tmp373->hd=(void*)((int)_tmp372);_tmp373->tl=flds;_tmp373;}),path);}_LL237: if(*((
int*)_tmp36D)!= 4)goto _LL239;_tmp36E=((struct Cyc_Absyn_PointerType_struct*)
_tmp36D)->f1;_tmp36F=(void*)_tmp36E.elt_typ;_tmp370=_tmp36E.ptr_atts;_tmp371=
_tmp370.bounds;_LL238:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
_tmp374=_cycalloc(sizeof(*_tmp374));_tmp374[0]=({struct Cyc_Core_Impossible_struct
_tmp375;_tmp375.tag=Cyc_Core_Impossible;_tmp375.f1=({const char*_tmp376="subscripts unsupported for unique places";
_tag_dyneither(_tmp376,sizeof(char),41);});_tmp375;});_tmp374;}));_LL239:;_LL23A:(
int)_throw((void*)({struct Cyc_Core_Impossible_struct*_tmp377=_cycalloc(sizeof(*
_tmp377));_tmp377[0]=({struct Cyc_Core_Impossible_struct _tmp378;_tmp378.tag=Cyc_Core_Impossible;
_tmp378.f1=({const char*_tmp379="unique place subscript -- bad type";
_tag_dyneither(_tmp379,sizeof(char),35);});_tmp378;});_tmp377;}));_LL234:;}
...
int)_throw((void*)({struct Cyc_Core_Impossible_struct*_tmp37A=_cycalloc(sizeof(*
_tmp37A));_tmp37A[0]=({struct Cyc_Core_Impossible_struct _tmp37B;_tmp37B.tag=Cyc_Core_Impossible;
_tmp37B.f1=({const char*_tmp37C="unions can't contain unique places";
_tag_dyneither(_tmp37C,sizeof(char),35);});_tmp37B;});_tmp37A;}));{int _tmp37D=
Cyc_CfFlowInfo_get_field_index((void*)((struct Cyc_Core_Opt*)_check_null(_tmp35C->topt))->v,
_tmp35D);return Cyc_CfFlowInfo_unique_place_of_rec(r,_tmp35C,({struct Cyc_List_List*
_tmp37E=_region_malloc(r,sizeof(*_tmp37E));_tmp37E->hd=(void*)_tmp37D;_tmp37E->tl=
flds;_tmp37E;}),path);}_LL22D:;_LL22E:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
_tmp37F=_cycalloc(sizeof(*_tmp37F));_tmp37F[0]=({struct Cyc_Core_Impossible_struct
_tmp380;_tmp380.tag=Cyc_Core_Impossible;_tmp380.f1=({const char*_tmp381="bad unique path";
_tag_dyneither(_tmp381,sizeof(char),16);});_tmp380;});_tmp37F;}));_LL216:;}
...
place){struct _tuple19 _tmp383;struct Cyc_Dict_Dict*_tmp384;struct Cyc_Dict_Dict
_tmp385;struct Cyc_Position_Segment*_tmp386;struct _tuple19*_tmp382=env;_tmp383=*
_tmp382;_tmp384=_tmp383.f1;_tmp385=_tmp383.f2;_tmp386=_tmp383.f3;{void*rval=(
void*)0;if(Cyc_Dict_lookup_bool(_tmp385,(void*)place->root,& rval) && rval == (
...
Cyc_Dict_Dict*)_tmp384,place,_tmp386)){struct Cyc_Position_Segment*_tmp387=((
struct Cyc_Position_Segment*(*)(struct Cyc_Dict_Dict d,struct Cyc_CfFlowInfo_Place*k))
Cyc_Dict_lookup)(*_tmp384,place);((void(*)(struct Cyc_CfFlowInfo_Place*place,
...
Cyc_CfFlowInfo_place_err_string,({const char*_tmp388="May consume non-aliased pointer %s more than once (cf. %s)";
_tag_dyneither(_tmp388,sizeof(char),59);}),({const char*_tmp389="May consume non-aliased pointer %s more than once";
_tag_dyneither(_tmp389,sizeof(char),50);}),_tmp387,_tmp386);}}}union Cyc_CfFlowInfo_FlowInfo_union
Cyc_CfFlowInfo_consume_unique_rvals(struct Cyc_Position_Segment*loc,union Cyc_CfFlowInfo_FlowInfo_union
f){union Cyc_CfFlowInfo_FlowInfo_union _tmp38A=f;struct Cyc_Dict_Dict _tmp38B;struct
Cyc_List_List*_tmp38C;struct Cyc_CfFlowInfo_ConsumeInfo _tmp38D;_LL23C: if((_tmp38A.BottomFL).tag
!= 0)goto _LL23E;_LL23D: return f;_LL23E: if((_tmp38A.ReachableFL).tag != 1)goto
_LL23B;_tmp38B=(_tmp38A.ReachableFL).f1;_tmp38C=(_tmp38A.ReachableFL).f2;_tmp38D=(
_tmp38A.ReachableFL).f3;_LL23F: if(_tmp38D.may_consume == 0)return f;{struct Cyc_Dict_Dict
_tmp38E=_tmp38D.consumed;struct _tuple19 _tmp38F=({struct _tuple19 _tmp392;_tmp392.f1=&
_tmp38E;_tmp392.f2=_tmp38B;_tmp392.f3=loc;_tmp392;});((void(*)(void(*f)(struct
_tuple19*,struct Cyc_CfFlowInfo_Place*),struct _tuple19*env,struct Cyc_List_List*x))
Cyc_List_iter_c)(Cyc_CfFlowInfo_consume_f,& _tmp38F,_tmp38D.may_consume);return(
union Cyc_CfFlowInfo_FlowInfo_union)({union Cyc_CfFlowInfo_FlowInfo_union _tmp390;(
_tmp390.ReachableFL).tag=1;(_tmp390.ReachableFL).f1=_tmp38B;(_tmp390.ReachableFL).f2=
_tmp38C;(_tmp390.ReachableFL).f3=({struct Cyc_CfFlowInfo_ConsumeInfo _tmp391;
_tmp391.consumed=_tmp38E;_tmp391.may_consume=0;_tmp391;});_tmp390;});}_LL23B:;}
void Cyc_CfFlowInfo_check_unique_rvals(struct Cyc_Position_Segment*loc,union Cyc_CfFlowInfo_FlowInfo_union
f){union Cyc_CfFlowInfo_FlowInfo_union _tmp393=f;struct Cyc_Dict_Dict _tmp394;struct
Cyc_List_List*_tmp395;struct Cyc_CfFlowInfo_ConsumeInfo _tmp396;_LL241: if((_tmp393.BottomFL).tag
!= 0)goto _LL243;_LL242: return;_LL243: if((_tmp393.ReachableFL).tag != 1)goto _LL240;
_tmp394=(_tmp393.ReachableFL).f1;_tmp395=(_tmp393.ReachableFL).f2;_tmp396=(
_tmp393.ReachableFL).f3;_LL244: {struct Cyc_List_List*_tmp397=_tmp396.may_consume;
while(_tmp397 != 0){if(((int(*)(struct Cyc_Dict_Dict d,struct Cyc_CfFlowInfo_Place*k))
Cyc_Dict_member)(_tmp396.consumed,(struct Cyc_CfFlowInfo_Place*)_tmp397->hd)){
struct Cyc_Position_Segment*_tmp398=((struct Cyc_Position_Segment*(*)(struct Cyc_Dict_Dict
d,struct Cyc_CfFlowInfo_Place*k))Cyc_Dict_lookup)(_tmp396.consumed,(struct Cyc_CfFlowInfo_Place*)
_tmp397->hd);((void(*)(struct Cyc_CfFlowInfo_Place*place,struct _dyneither_ptr(*
...
loc))Cyc_CfFlowInfo_unique_err)((struct Cyc_CfFlowInfo_Place*)_tmp397->hd,Cyc_CfFlowInfo_place_err_string,({
const char*_tmp399="Read through possibly consumed unique pointer %s (cf. %s)";
_tag_dyneither(_tmp399,sizeof(char),58);}),({const char*_tmp39A="Read through possibly consumed unique pointer %s";
_tag_dyneither(_tmp39A,sizeof(char),49);}),_tmp398,loc);break;}_tmp397=_tmp397->tl;}
return;}_LL240:;}union Cyc_CfFlowInfo_FlowInfo_union Cyc_CfFlowInfo_drop_unique_rvals(
struct Cyc_Position_Segment*loc,union Cyc_CfFlowInfo_FlowInfo_union f){union Cyc_CfFlowInfo_FlowInfo_union
_tmp39B=f;struct Cyc_Dict_Dict _tmp39C;struct Cyc_List_List*_tmp39D;struct Cyc_CfFlowInfo_ConsumeInfo
_tmp39E;_LL246: if((_tmp39B.BottomFL).tag != 0)goto _LL248;_LL247: return f;_LL248:
if((_tmp39B.ReachableFL).tag != 1)goto _LL245;_tmp39C=(_tmp39B.ReachableFL).f1;
_tmp39D=(_tmp39B.ReachableFL).f2;_tmp39E=(_tmp39B.ReachableFL).f3;_LL249: _tmp39E.may_consume=
0;return(union Cyc_CfFlowInfo_FlowInfo_union)({union Cyc_CfFlowInfo_FlowInfo_union
_tmp39F;(_tmp39F.ReachableFL).tag=1;(_tmp39F.ReachableFL).f1=_tmp39C;(_tmp39F.ReachableFL).f2=
_tmp39D;(_tmp39F.ReachableFL).f3=_tmp39E;_tmp39F;});_LL245:;}union Cyc_CfFlowInfo_FlowInfo_union
Cyc_CfFlowInfo_readthrough_unique_rvals(struct Cyc_Position_Segment*loc,union Cyc_CfFlowInfo_FlowInfo_union
...
0;return(union Cyc_CfFlowInfo_FlowInfo_union)({union Cyc_CfFlowInfo_FlowInfo_union
_tmp3A4;(_tmp3A4.ReachableFL).tag=1;(_tmp3A4.ReachableFL).f1=_tmp3A1;(_tmp3A4.ReachableFL).f2=
_tmp3A2;(_tmp3A4.ReachableFL).f3=_tmp3A3;_tmp3A4;});_LL24A:;}}struct _tuple6 Cyc_CfFlowInfo_save_consume_info(
...
!= 0)goto _LL252;_LL251: return({struct _tuple6 _tmp3A9;_tmp3A9.f1=({struct Cyc_CfFlowInfo_ConsumeInfo
_tmp3AA;_tmp3AA.consumed=fenv->mt_place_set;_tmp3AA.may_consume=0;_tmp3AA;});
_tmp3A9.f2=f;_tmp3A9;});_LL252: if((_tmp3A5.ReachableFL).tag != 1)goto _LL24F;
_tmp3A6=(_tmp3A5.ReachableFL).f1;_tmp3A7=(_tmp3A5.ReachableFL).f2;_tmp3A8=(
_tmp3A5.ReachableFL).f3;_LL253: if(clear)return({struct _tuple6 _tmp3AB;_tmp3AB.f1=
_tmp3A8;_tmp3AB.f2=(union Cyc_CfFlowInfo_FlowInfo_union)({union Cyc_CfFlowInfo_FlowInfo_union
_tmp3AC;(_tmp3AC.ReachableFL).tag=1;(_tmp3AC.ReachableFL).f1=_tmp3A6;(_tmp3AC.ReachableFL).f2=
_tmp3A7;(_tmp3AC.ReachableFL).f3=({struct Cyc_CfFlowInfo_ConsumeInfo _tmp3AD;
_tmp3AD.consumed=fenv->mt_place_set;_tmp3AD.may_consume=0;_tmp3AD;});_tmp3AC;});
_tmp3AB;});else{return({struct _tuple6 _tmp3AE;_tmp3AE.f1=_tmp3A8;_tmp3AE.f2=f;
_tmp3AE;});}_LL24F:;}union Cyc_CfFlowInfo_FlowInfo_union Cyc_CfFlowInfo_restore_consume_info(
union Cyc_CfFlowInfo_FlowInfo_union f,struct Cyc_CfFlowInfo_ConsumeInfo c,int
may_consume_only){union Cyc_CfFlowInfo_FlowInfo_union _tmp3AF=f;struct Cyc_Dict_Dict
_tmp3B0;struct Cyc_List_List*_tmp3B1;struct Cyc_CfFlowInfo_ConsumeInfo _tmp3B2;
_LL255: if((_tmp3AF.BottomFL).tag != 0)goto _LL257;_LL256: return f;_LL257: if((
_tmp3AF.ReachableFL).tag != 1)goto _LL254;_tmp3B0=(_tmp3AF.ReachableFL).f1;_tmp3B1=(
_tmp3AF.ReachableFL).f2;_tmp3B2=(_tmp3AF.ReachableFL).f3;_LL258: if(
...
_tmp3B1;(_tmp3B3.ReachableFL).f3=({struct Cyc_CfFlowInfo_ConsumeInfo _tmp3B4;
_tmp3B4.consumed=_tmp3B2.consumed;_tmp3B4.may_consume=c.may_consume;_tmp3B4;});
_tmp3B3;});return(union Cyc_CfFlowInfo_FlowInfo_union)({union Cyc_CfFlowInfo_FlowInfo_union
_tmp3B5;(_tmp3B5.ReachableFL).tag=1;(_tmp3B5.ReachableFL).f1=_tmp3B0;(_tmp3B5.ReachableFL).f2=
_tmp3B1;(_tmp3B5.ReachableFL).f3=c;_tmp3B5;});_LL254:;}
