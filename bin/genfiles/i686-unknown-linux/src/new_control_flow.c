...
_tmpF7;void*_tmpF8;struct Cyc_Dict_Dict*_tmpF9;struct Cyc_List_List*_tmpFA;_LLED:
_tmpF6=_tmpF5.f1;if(_tmpF6 <= (void*)1  || *((int*)_tmpF6)!= 0)goto _LLEF;_tmpF7=((
struct Cyc_CfFlowInfo_PlaceL_struct*)_tmpF6)->f1;_tmpF8=_tmpF5.f2;if(_tmpF8 <= (
void*)1  || *((int*)_tmpF8)!= 0)goto _LLEF;_tmpF9=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmpF8)->f1;_tmpFA=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmpF8)->f2;_LLEE:
...
_LLEC;_LLEF:;_LLF0: goto _LLEC;_LLEC:;}return({struct _tuple0 _tmpFD;_tmpFD.f1=
...
_LLF2: _tmp105=_tmp104.f1;if(_tmp105 <= (void*)1  || *((int*)_tmp105)!= 0)goto _LLF4;
_tmp106=((struct Cyc_CfFlowInfo_PlaceL_struct*)_tmp105)->f1;_tmp107=_tmp104.f2;
if(_tmp107 <= (void*)1  || *((int*)_tmp107)!= 0)goto _LLF4;_tmp108=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp107)->f1;_tmp109=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp107)->f2;
_LLF3: _tmp109=Cyc_CfFlowInfo_reln_kill_exp(_tmp109,_tmpB3);_tmp100=(void*)({
...
goto _LLF1;_LLF4:;_LLF5: goto _LLF1;_LLF1:;}return({struct _tuple0 _tmp10C;_tmp10C.f1=
...
_tmp11C;_LLF7: if((int)_tmp11A != 0)goto _LLF9;_LLF8: return({struct _tuple0 _tmp11D;
_tmp11D.f1=(void*)0;_tmp11D.f2=_tmp116;_tmp11D;});_LLF9: if(_tmp11A <= (void*)1
 || *((int*)_tmp11A)!= 0)goto _LLF6;_tmp11B=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp11A)->f1;_tmp11C=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp11A)->f2;
_LLFA: {void*_tmp11E=_tmp111;struct Cyc_CfFlowInfo_Place*_tmp11F;_LLFC: if(_tmp11E
<= (void*)1  || *((int*)_tmp11E)!= 0)goto _LLFE;_tmp11F=((struct Cyc_CfFlowInfo_PlaceL_struct*)
_tmp11E)->f1;_LLFD: _tmp11B=Cyc_CfFlowInfo_assign_place(e->loc,_tmp11B,env->all_changed,
...
_tmp122;});_LLFE: if((int)_tmp11E != 0)goto _LLFB;_LLFF: return({struct _tuple0
_tmp123;_tmp123.f1=Cyc_NewControlFlow_use_Rval(env,_tmpB9->loc,_tmp118,_tmp116);
_tmp123.f2=_tmp116;_tmp123;});_LLFB:;}_LLF6:;}}inflow=_tmp119;}}}}}}_LLBA: if(*((
...
_LL101: if(_tmp12D <= (void*)3  || *((int*)_tmp12D)!= 4)goto _LL103;_tmp12E=((struct
Cyc_Absyn_PointerType_struct*)_tmp12D)->f1;_tmp12F=(void*)_tmp12E.elt_typ;_LL102:{
void*_tmp130=Cyc_Tcutil_compress(_tmp12F);struct Cyc_Absyn_FnInfo _tmp131;struct
Cyc_List_List*_tmp132;_LL106: if(_tmp130 <= (void*)3  || *((int*)_tmp130)!= 8)goto
_LL108;_tmp131=((struct Cyc_Absyn_FnType_struct*)_tmp130)->f1;_tmp132=_tmp131.attributes;
_LL107: for(0;_tmp132 != 0;_tmp132=_tmp132->tl){void*_tmp133=(void*)_tmp132->hd;
int _tmp134;_LL10B: if(_tmp133 <= (void*)17  || *((int*)_tmp133)!= 4)goto _LL10D;
_tmp134=((struct Cyc_Absyn_Initializes_att_struct*)_tmp133)->f1;_LL10C:
init_params=({struct Cyc_List_List*_tmp135=_cycalloc(sizeof(*_tmp135));_tmp135->hd=(
void*)_tmp134;_tmp135->tl=init_params;_tmp135;});goto _LL10A;_LL10D:;_LL10E: goto
_LL10A;_LL10A:;}goto _LL105;_LL108:;_LL109:({void*_tmp136[0]={};((int(*)(struct
...
_tmp136,sizeof(void*),0));});_LL105:;}goto _LL100;_LL103:;_LL104:({void*_tmp138[0]={};((
...
_get_zero_arr_size(_tmp139,29));}),_tag_arr(_tmp138,sizeof(void*),0));});_LL100:;}{
...
continue;}{void*_tmp13A=_tmp12A;struct Cyc_Dict_Dict*_tmp13B;_LL110: if((int)
_tmp13A != 0)goto _LL112;_LL111: goto _LL10F;_LL112: if(_tmp13A <= (void*)1  || *((int*)
_tmp13A)!= 0)goto _LL10F;_tmp13B=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp13A)->f1;_LL113: if(Cyc_CfFlowInfo_initlevel(_tmp13B,(void*)_tmp12B->hd)== (
...
struct Cyc_List_List*_tmp140;_LL115: if((int)_tmp13E != 0)goto _LL117;_LL116: goto
_LL114;_LL117: if(_tmp13E <= (void*)1  || *((int*)_tmp13E)!= 0)goto _LL114;_tmp13F=((
struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp13E)->f1;_tmp140=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp13E)->f2;_LL118: {struct Cyc_Dict_Dict*_tmp141=Cyc_CfFlowInfo_escape_deref(
_tmp13F,env->all_changed,(void*)_tmp12B->hd);{void*_tmp142=(void*)_tmp12B->hd;
struct Cyc_CfFlowInfo_Place*_tmp143;_LL11A: if(_tmp142 <= (void*)3  || *((int*)
_tmp142)!= 2)goto _LL11C;_tmp143=((struct Cyc_CfFlowInfo_AddressOf_struct*)_tmp142)->f1;
_LL11B:{void*_tmp144=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
_check_null(((struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmpBE))->hd)->topt))->v);
struct Cyc_Absyn_PtrInfo _tmp145;void*_tmp146;_LL11F: if(_tmp144 <= (void*)3  || *((
int*)_tmp144)!= 4)goto _LL121;_tmp145=((struct Cyc_Absyn_PointerType_struct*)
_tmp144)->f1;_tmp146=(void*)_tmp145.elt_typ;_LL120: _tmp141=Cyc_CfFlowInfo_assign_place(((
struct Cyc_Absyn_Exp*)_tmpBE->hd)->loc,_tmp141,env->all_changed,_tmp143,Cyc_CfFlowInfo_typ_to_absrval(
_tmp146,Cyc_CfFlowInfo_esc_all));goto _LL11E;_LL121:;_LL122:({void*_tmp147[0]={};((
int(*)(struct _tagged_arr fmt,struct _tagged_arr ap))Cyc_Tcutil_impos)(({const char*
_tmp148="anal_Rexp: bad type for initialized arg";_tag_arr(_tmp148,sizeof(char),
_get_zero_arr_size(_tmp148,40));}),_tag_arr(_tmp147,sizeof(void*),0));});_LL11E:;}
goto _LL119;_LL11C:;_LL11D: goto _LL119;_LL119:;}_tmp12C=(void*)({struct Cyc_CfFlowInfo_ReachableFL_struct*
...
struct Cyc_Dict_Dict*_tmp154;struct Cyc_List_List*_tmp155;_LL124: if((int)_tmp153 != 
0)goto _LL126;_LL125: return({struct _tuple0 _tmp156;_tmp156.f1=outflow;_tmp156.f2=
rval;_tmp156;});_LL126: if(_tmp153 <= (void*)1  || *((int*)_tmp153)!= 0)goto _LL123;
_tmp154=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp153)->f1;_tmp155=((struct
Cyc_CfFlowInfo_ReachableFL_struct*)_tmp153)->f2;_LL127: return({struct _tuple0
...
_tmp155;_tmp159;});_tmp158;});_tmp157.f2=rval;_tmp157;});_LL123:;}}_LLC2: if(*((
...
_tmp166=outflow;struct Cyc_Dict_Dict*_tmp167;struct Cyc_List_List*_tmp168;_LL129:
if((int)_tmp166 != 0)goto _LL12B;_LL12A: return({struct _tuple0 _tmp169;_tmp169.f1=
outflow;_tmp169.f2=rval;_tmp169;});_LL12B: if(_tmp166 <= (void*)1  || *((int*)
_tmp166)!= 0)goto _LL128;_tmp167=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp166)->f1;_tmp168=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp166)->f2;
_LL12C: return({struct _tuple0 _tmp16A;_tmp16A.f1=(void*)({struct Cyc_CfFlowInfo_ReachableFL_struct*
...
_tmp168;_tmp16C;});_tmp16B;});_tmp16A.f2=rval;_tmp16A;});_LL128:;}}}_LLC4: if(*((
...
struct Cyc_CfFlowInfo_Place*_tmp176;_LL12E: if((int)_tmp175 != 0)goto _LL130;_LL12F:
return({struct _tuple0 _tmp177;_tmp177.f1=_tmp173;_tmp177.f2=(void*)1;_tmp177;});
_LL130: if(_tmp175 <= (void*)1  || *((int*)_tmp175)!= 0)goto _LL12D;_tmp176=((struct
Cyc_CfFlowInfo_PlaceL_struct*)_tmp175)->f1;_LL131: return({struct _tuple0 _tmp178;
...
_tmp17A;_tmp17A.tag=2;_tmp17A.f1=_tmp176;_tmp17A;});_tmp179;});_tmp178;});_LL12D:;}}
...
void*_tmp182=_tmp180;struct Cyc_Dict_Dict*_tmp183;_LL133: if(_tmp182 <= (void*)3
 || *((int*)_tmp182)!= 4)goto _LL135;_tmp183=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmp182)->f1;_LL134: return({struct _tuple0 _tmp184;_tmp184.f1=_tmp17F;_tmp184.f2=((
void*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k))Cyc_Dict_lookup)(_tmp183,
_tmpCA);_tmp184;});_LL135:;_LL136:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tmp185;}));_LL132:;}}_LLCA: if(*((int*)_tmp9E)!= 24)goto _LLCC;_tmpCB=((struct Cyc_Absyn_AggrArrow_e_struct*)
...
_tmp18F;void*_tmp190;_LL138: if(_tmp18E <= (void*)3  || *((int*)_tmp18E)!= 4)goto
_LL13A;_tmp18F=((struct Cyc_Absyn_PointerType_struct*)_tmp18E)->f1;_tmp190=(void*)
_tmp18F.elt_typ;_LL139: if(Cyc_Absyn_is_union_type(_tmp190))return({struct _tuple0
...
_tmp192;}));_LL137:;}{void*_tmp195=_tmp18D;struct Cyc_Dict_Dict*_tmp196;_LL13D:
if(_tmp195 <= (void*)3  || *((int*)_tmp195)!= 4)goto _LL13F;_tmp196=((struct Cyc_CfFlowInfo_Aggregate_struct*)
_tmp195)->f1;_LL13E: return({struct _tuple0 _tmp197;_tmp197.f1=_tmp18C;_tmp197.f2=((
void*(*)(struct Cyc_Dict_Dict*d,struct _tagged_arr*k))Cyc_Dict_lookup)(_tmp196,
_tmpCC);_tmp197;});_LL13F:;_LL140:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tmp198;}));_LL13C:;}}}_LLCC: if(*((int*)_tmp9E)!= 6)goto _LLCE;_tmpCD=((struct Cyc_Absyn_Conditional_e_struct*)
...
_tmp1B3;_LL142: if(_tmp1B1 <= (void*)1  || *((int*)_tmp1B1)!= 0)goto _LL144;_tmp1B2=((
struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp1B1)->f1;_tmp1B3=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp1B1)->f2;_LL143: if(Cyc_CfFlowInfo_initlevel(_tmp1B2,(void*)((struct Cyc_List_List*)
...
goto _LL141;}_LL144:;_LL145: goto _LL141;_LL141:;}{void*_tmp1B9=Cyc_Tcutil_compress((
void*)((struct Cyc_Core_Opt*)_check_null(_tmpD4->topt))->v);struct Cyc_Absyn_PtrInfo
_tmp1BA;struct Cyc_Absyn_PtrAtts _tmp1BB;struct Cyc_Absyn_Conref*_tmp1BC;_LL147: if(
_tmp1B9 <= (void*)3  || *((int*)_tmp1B9)!= 9)goto _LL149;_LL148: {void*_tmp1BD=(
void*)((struct Cyc_List_List*)_check_null(_tmp1AF))->hd;struct Cyc_Dict_Dict*
_tmp1BE;_LL14E: if(_tmp1BD <= (void*)3  || *((int*)_tmp1BD)!= 4)goto _LL150;_tmp1BE=((
struct Cyc_CfFlowInfo_Aggregate_struct*)_tmp1BD)->f1;_LL14F: return({struct _tuple0
...
_tmpD5)).f1));_tmp1BF;});_LL150:;_LL151:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tmp1C0;}));_LL14D:;}_LL149: if(_tmp1B9 <= (void*)3  || *((int*)_tmp1B9)!= 4)goto
_LL14B;_tmp1BA=((struct Cyc_Absyn_PointerType_struct*)_tmp1B9)->f1;_tmp1BB=
_tmp1BA.ptr_atts;_tmp1BC=_tmp1BB.bounds;_LL14A:{void*_tmp1C3=(void*)(Cyc_Absyn_compress_conref(
_tmp1BC))->v;void*_tmp1C4;_LL153: if(_tmp1C3 <= (void*)1  || *((int*)_tmp1C3)!= 0)
goto _LL155;_tmp1C4=(void*)((struct Cyc_Absyn_Eq_constr_struct*)_tmp1C3)->f1;if(
_tmp1C4 <= (void*)1  || *((int*)_tmp1C4)!= 1)goto _LL155;_LL154:{void*_tmp1C5=(void*)((
struct Cyc_List_List*)_check_null(((struct Cyc_List_List*)_check_null(_tmp1AF))->tl))->hd;
struct Cyc_List_List*_tmp1C6;_LL158: if(_tmp1C5 <= (void*)3  || *((int*)_tmp1C5)!= 3)
goto _LL15A;_tmp1C6=((struct Cyc_CfFlowInfo_TagCmps_struct*)_tmp1C5)->f1;_LL159:(
...
_tmp1C7;})));goto _LL157;_LL15A:;_LL15B: goto _LL157;_LL157:;}goto _LL152;_LL155:;
_LL156: goto _LL152;_LL152:;}{void*_tmp1CA;void*_tmp1CB;struct _tuple0 _tmp1C9=Cyc_NewControlFlow_anal_derefR(
...
_tmp1CD.f1=_tmp1B0;_tmp1CD.f2=_tmp1CB;_tmp1CD;});}_LL14B:;_LL14C:(int)_throw((
...
_LL146:;}}}_LLD4: if(*((int*)_tmp9E)!= 32)goto _LLD6;_tmpD6=((struct Cyc_Absyn_Tunion_e_struct*)
...
ds != 0;ds=ds->tl){void*_tmp1DA=(void*)ds->hd;struct _tagged_arr*_tmp1DB;_LL15D:
if(*((int*)_tmp1DA)!= 0)goto _LL15F;_LL15E:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tmp1DC;}));_LL15F: if(*((int*)_tmp1DA)!= 1)goto _LL15C;_tmp1DB=((struct Cyc_Absyn_FieldName_struct*)
_tmp1DA)->f1;_LL160: aggrdict=((struct Cyc_Dict_Dict*(*)(struct Cyc_Dict_Dict*d,
struct _tagged_arr*k,void*v))Cyc_Dict_insert)(aggrdict,_tmp1DB,(void*)_tmp1D9->hd);
_LL15C:;}}}return({struct _tuple0 _tmp1DF;_tmp1DF.f1=_tmp1D8;_tmp1DF.f2=(void*)({
...
struct Cyc_Dict_Dict*_tmp1EB;struct Cyc_List_List*_tmp1EC;_LL162: if((int)_tmp1EA != 
0)goto _LL164;_LL163: return({struct _tuple0 _tmp1ED;_tmp1ED.f1=_tmp1E8;_tmp1ED.f2=
Cyc_CfFlowInfo_unknown_all;_tmp1ED;});_LL164: if(_tmp1EA <= (void*)1  || *((int*)
_tmp1EA)!= 0)goto _LL161;_tmp1EB=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp1EA)->f1;_tmp1EC=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp1EA)->f2;
_LL165: if(Cyc_CfFlowInfo_initlevel(_tmp1EB,_tmp1E9)== (void*)0)({void*_tmp1EE[0]={};
...
_tmp1FF;_LL167: if(*((int*)_tmp1F0)!= 15)goto _LL169;_tmp1F1=((struct Cyc_Absyn_Cast_e_struct*)
_tmp1F0)->f2;_LL168: _tmpDC=_tmp1F1;goto comp_loop;_LL169: if(*((int*)_tmp1F0)!= 1)
goto _LL16B;_tmp1F2=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp1F0)->f2;if(
_tmp1F2 <= (void*)1  || *((int*)_tmp1F2)!= 0)goto _LL16B;_tmp1F3=((struct Cyc_Absyn_Global_b_struct*)
_tmp1F2)->f1;if(!(!_tmp1F3->escapes))goto _LL16B;_LL16A: _tmp1F5=_tmp1F3;goto
_LL16C;_LL16B: if(*((int*)_tmp1F0)!= 1)goto _LL16D;_tmp1F4=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp1F0)->f2;if(_tmp1F4 <= (void*)1  || *((int*)_tmp1F4)!= 3)goto _LL16D;_tmp1F5=((
struct Cyc_Absyn_Local_b_struct*)_tmp1F4)->f1;if(!(!_tmp1F5->escapes))goto _LL16D;
_LL16C: _tmp1F7=_tmp1F5;goto _LL16E;_LL16D: if(*((int*)_tmp1F0)!= 1)goto _LL16F;
_tmp1F6=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp1F0)->f2;if(_tmp1F6 <= (void*)
1  || *((int*)_tmp1F6)!= 4)goto _LL16F;_tmp1F7=((struct Cyc_Absyn_Pat_b_struct*)
_tmp1F6)->f1;if(!(!_tmp1F7->escapes))goto _LL16F;_LL16E: _tmp1F9=_tmp1F7;goto
_LL170;_LL16F: if(*((int*)_tmp1F0)!= 1)goto _LL171;_tmp1F8=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp1F0)->f2;if(_tmp1F8 <= (void*)1  || *((int*)_tmp1F8)!= 2)goto _LL171;_tmp1F9=((
struct Cyc_Absyn_Param_b_struct*)_tmp1F8)->f1;if(!(!_tmp1F9->escapes))goto _LL171;
_LL170: new_relns=({struct Cyc_List_List*_tmp200=_cycalloc(sizeof(*_tmp200));
...
_tmp200->tl=_tmp1EC;_tmp200;});goto _LL166;_LL171: if(*((int*)_tmp1F0)!= 0)goto
_LL173;_tmp1FA=(void*)((struct Cyc_Absyn_Const_e_struct*)_tmp1F0)->f1;if(_tmp1FA
<= (void*)1  || *((int*)_tmp1FA)!= 2)goto _LL173;_tmp1FB=((struct Cyc_Absyn_Int_c_struct*)
_tmp1FA)->f2;_LL172: new_relns=({struct Cyc_List_List*_tmp204=_cycalloc(sizeof(*
...
_tmp205;});_tmp204->tl=_tmp1EC;_tmp204;});goto _LL166;_LL173: if(*((int*)_tmp1F0)
!= 3)goto _LL175;_tmp1FC=(void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp1F0)->f1;
if((int)_tmp1FC != 19)goto _LL175;_tmp1FD=((struct Cyc_Absyn_Primop_e_struct*)
_tmp1F0)->f2;if(_tmp1FD == 0)goto _LL175;_tmp1FE=*_tmp1FD;_tmp1FF=(struct Cyc_Absyn_Exp*)
_tmp1FE.hd;_LL174:{void*_tmp208=(void*)_tmp1FF->r;void*_tmp209;struct Cyc_Absyn_Vardecl*
_tmp20A;void*_tmp20B;struct Cyc_Absyn_Vardecl*_tmp20C;void*_tmp20D;struct Cyc_Absyn_Vardecl*
_tmp20E;void*_tmp20F;struct Cyc_Absyn_Vardecl*_tmp210;_LL178: if(*((int*)_tmp208)
!= 1)goto _LL17A;_tmp209=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp208)->f2;if(
_tmp209 <= (void*)1  || *((int*)_tmp209)!= 0)goto _LL17A;_tmp20A=((struct Cyc_Absyn_Global_b_struct*)
_tmp209)->f1;if(!(!_tmp20A->escapes))goto _LL17A;_LL179: _tmp20C=_tmp20A;goto
_LL17B;_LL17A: if(*((int*)_tmp208)!= 1)goto _LL17C;_tmp20B=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp208)->f2;if(_tmp20B <= (void*)1  || *((int*)_tmp20B)!= 3)goto _LL17C;_tmp20C=((
struct Cyc_Absyn_Local_b_struct*)_tmp20B)->f1;if(!(!_tmp20C->escapes))goto _LL17C;
_LL17B: _tmp20E=_tmp20C;goto _LL17D;_LL17C: if(*((int*)_tmp208)!= 1)goto _LL17E;
_tmp20D=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp208)->f2;if(_tmp20D <= (void*)
1  || *((int*)_tmp20D)!= 4)goto _LL17E;_tmp20E=((struct Cyc_Absyn_Pat_b_struct*)
_tmp20D)->f1;if(!(!_tmp20E->escapes))goto _LL17E;_LL17D: _tmp210=_tmp20E;goto
_LL17F;_LL17E: if(*((int*)_tmp208)!= 1)goto _LL180;_tmp20F=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp208)->f2;if(_tmp20F <= (void*)1  || *((int*)_tmp20F)!= 2)goto _LL180;_tmp210=((
struct Cyc_Absyn_Param_b_struct*)_tmp20F)->f1;if(!(!_tmp210->escapes))goto _LL180;
_LL17F: new_relns=({struct Cyc_List_List*_tmp211=_cycalloc(sizeof(*_tmp211));
...
_tmp211->tl=_tmp1EC;_tmp211;});goto _LL177;_LL180:;_LL181: goto _LL177;_LL177:;}
goto _LL166;_LL175:;_LL176: goto _LL166;_LL166:;}if(_tmp1EC != new_relns)_tmp1E8=(
...
_tmp1E9;_LL183: if((int)_tmp217 != 0)goto _LL185;_LL184: return({struct _tuple0
_tmp218;_tmp218.f1=_tmp1E8;_tmp218.f2=Cyc_CfFlowInfo_unknown_all;_tmp218;});
_LL185: if((int)_tmp217 != 2)goto _LL187;_LL186: goto _LL188;_LL187: if((int)_tmp217 != 
1)goto _LL189;_LL188: goto _LL18A;_LL189: if(_tmp217 <= (void*)3  || *((int*)_tmp217)
!= 2)goto _LL18B;_LL18A: {struct Cyc_List_List _tmp219=({struct Cyc_List_List _tmp223;
...
_tmp21E;_LL18E: if((int)_tmp21D != 0)goto _LL190;_LL18F: return({struct _tuple0
_tmp21F;_tmp21F.f1=_tmp21B;_tmp21F.f2=Cyc_CfFlowInfo_unknown_all;_tmp21F;});
_LL190: if(_tmp21D <= (void*)1  || *((int*)_tmp21D)!= 0)goto _LL18D;_tmp21E=((struct
Cyc_CfFlowInfo_ReachableFL_struct*)_tmp21D)->f1;_LL191: if(Cyc_CfFlowInfo_initlevel(
...
_tmp222;});}_LL18D:;}_tmp1E8=_tmp21B;goto _LL18C;}}_LL18B:;_LL18C: while(1){struct
...
_tmp227=_tmp225.f2;{void*_tmp228=_tmp226;struct Cyc_Dict_Dict*_tmp229;_LL193: if((
int)_tmp228 != 0)goto _LL195;_LL194: goto _LL192;_LL195: if(_tmp228 <= (void*)1  || *((
int*)_tmp228)!= 0)goto _LL192;_tmp229=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp228)->f1;_LL196: if(Cyc_CfFlowInfo_initlevel(_tmp229,_tmp227)!= (void*)2){({
...
_tmp22C.f2=Cyc_CfFlowInfo_unknown_all;_tmp22C;});}_LL192:;}{void*_tmp22D=Cyc_CfFlowInfo_join_flow(
...
_tmp1E8;_tmp22F.f2=Cyc_CfFlowInfo_unknown_all;_tmp22F;});_LL182:;}}_LL161:;}}
...
_tmp234;struct Cyc_Absyn_Exp*_tmp235;_LL198: if(_tmp230 <= (void*)1  || *((int*)
_tmp230)!= 1)goto _LL19A;_tmp231=((struct Cyc_Absyn_Seq_s_struct*)_tmp230)->f1;
_tmp232=((struct Cyc_Absyn_Seq_s_struct*)_tmp230)->f2;_LL199: inflow=Cyc_NewControlFlow_anal_stmt(
env,inflow,_tmp231);_tmpDF=_tmp232;goto _LL197;_LL19A: if(_tmp230 <= (void*)1  || *((
int*)_tmp230)!= 11)goto _LL19C;_tmp233=((struct Cyc_Absyn_Decl_s_struct*)_tmp230)->f1;
_tmp234=((struct Cyc_Absyn_Decl_s_struct*)_tmp230)->f2;_LL19B: inflow=Cyc_NewControlFlow_anal_decl(
env,inflow,_tmp233);_tmpDF=_tmp234;goto _LL197;_LL19C: if(_tmp230 <= (void*)1  || *((
int*)_tmp230)!= 0)goto _LL19E;_tmp235=((struct Cyc_Absyn_Exp_s_struct*)_tmp230)->f1;
_LL19D: return Cyc_NewControlFlow_anal_Rexp(env,inflow,_tmp235);_LL19E:;_LL19F:(
...
_LL197:;}}_LLE2: if(*((int*)_tmp9E)!= 1)goto _LLE4;_tmpE0=(void*)((struct Cyc_Absyn_Var_e_struct*)
...
int*)_tmp9E)!= 27)goto _LL89;_LLEB:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
_tmp239=_cycalloc(sizeof(*_tmp239));_tmp239[0]=({struct Cyc_Core_Impossible_struct
_tmp23A;_tmp23A.tag=Cyc_Core_Impossible;_tmp23A.f1=({const char*_tmp23B="anal_Rexp, unexpected exp form";
_tag_arr(_tmp23B,sizeof(char),_get_zero_arr_size(_tmp23B,31));});_tmp23A;});
_tmp239;}));_LL89:;}}static struct _tuple0 Cyc_NewControlFlow_anal_derefL(struct Cyc_NewControlFlow_AnalEnv*
...
struct Cyc_Absyn_Conref*_tmp240;struct Cyc_Absyn_Conref*_tmp241;_LL1A1: if(_tmp23C
<= (void*)3  || *((int*)_tmp23C)!= 4)goto _LL1A3;_tmp23D=((struct Cyc_Absyn_PointerType_struct*)
_tmp23C)->f1;_tmp23E=(void*)_tmp23D.elt_typ;_tmp23F=_tmp23D.ptr_atts;_tmp240=
_tmp23F.bounds;_tmp241=_tmp23F.zero_term;_LL1A2: {void*_tmp242=f;struct Cyc_Dict_Dict*
_tmp243;struct Cyc_List_List*_tmp244;_LL1A6: if((int)_tmp242 != 0)goto _LL1A8;_LL1A7:
return({struct _tuple0 _tmp245;_tmp245.f1=f;_tmp245.f2=(void*)0;_tmp245;});_LL1A8:
if(_tmp242 <= (void*)1  || *((int*)_tmp242)!= 0)goto _LL1A5;_tmp243=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp242)->f1;_tmp244=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp242)->f2;
_LL1A9: if(Cyc_Tcutil_is_bound_one(_tmp240)){void*_tmp246=r;struct Cyc_CfFlowInfo_Place*
_tmp247;struct Cyc_CfFlowInfo_Place _tmp248;void*_tmp249;struct Cyc_List_List*
_tmp24A;void*_tmp24B;_LL1AB: if((int)_tmp246 != 1)goto _LL1AD;_LL1AC: goto _LL1AE;
_LL1AD: if((int)_tmp246 != 2)goto _LL1AF;_LL1AE:(void*)(e->annot=(void*)((void*)({
...
_tmp24D.f1=_tmp244;_tmp24D;});_tmp24C;})));goto _LL1AA;_LL1AF: if(_tmp246 <= (void*)
3  || *((int*)_tmp246)!= 2)goto _LL1B1;_tmp247=((struct Cyc_CfFlowInfo_AddressOf_struct*)
...
_tmp253;});_tmp252;});_tmp251;});_tmp250;});_LL1B1: if((int)_tmp246 != 0)goto
_LL1B3;_LL1B2:(void*)(e->annot=(void*)((void*)Cyc_CfFlowInfo_IsZero));return({
struct _tuple0 _tmp254;_tmp254.f1=(void*)0;_tmp254.f2=(void*)0;_tmp254;});_LL1B3:
if(_tmp246 <= (void*)3  || *((int*)_tmp246)!= 0)goto _LL1B5;_tmp24B=(void*)((struct
Cyc_CfFlowInfo_UnknownR_struct*)_tmp246)->f1;_LL1B4: f=Cyc_NewControlFlow_notzero(
env,inflow,f,e,_tmp24B);goto _LL1B6;_LL1B5:;_LL1B6:(void*)(e->annot=(void*)((void*)({
...
_tmp256.f1=_tmp244;_tmp256;});_tmp255;})));_LL1AA:;}else{(void*)(e->annot=(void*)((
...
void*)0;_tmp25B;});_LL1A5:;}_LL1A3:;_LL1A4:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tmp25C;}));_LL1A0:;}static struct _tuple0 Cyc_NewControlFlow_anal_Lexp_rec(struct
...
struct Cyc_List_List*_tmp261;_LL1B8: if((int)_tmp25F != 0)goto _LL1BA;_LL1B9: return({
struct _tuple0 _tmp262;_tmp262.f1=(void*)0;_tmp262.f2=(void*)0;_tmp262;});_LL1BA:
if(_tmp25F <= (void*)1  || *((int*)_tmp25F)!= 0)goto _LL1B7;_tmp260=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp25F)->f1;_tmp261=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp25F)->f2;
_LL1BB: d=_tmp260;_LL1B7:;}{void*_tmp263=(void*)e->r;struct Cyc_Absyn_Exp*_tmp264;
...
_tagged_arr*_tmp275;_LL1BD: if(*((int*)_tmp263)!= 15)goto _LL1BF;_tmp264=((struct
Cyc_Absyn_Cast_e_struct*)_tmp263)->f2;_LL1BE: _tmp265=_tmp264;goto _LL1C0;_LL1BF:
if(*((int*)_tmp263)!= 13)goto _LL1C1;_tmp265=((struct Cyc_Absyn_NoInstantiate_e_struct*)
_tmp263)->f1;_LL1C0: _tmp266=_tmp265;goto _LL1C2;_LL1C1: if(*((int*)_tmp263)!= 14)
goto _LL1C3;_tmp266=((struct Cyc_Absyn_Instantiate_e_struct*)_tmp263)->f1;_LL1C2:
return Cyc_NewControlFlow_anal_Lexp_rec(env,inflow,_tmp266,flds);_LL1C3: if(*((int*)
_tmp263)!= 1)goto _LL1C5;_tmp267=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp263)->f2;
if(_tmp267 <= (void*)1  || *((int*)_tmp267)!= 2)goto _LL1C5;_tmp268=((struct Cyc_Absyn_Param_b_struct*)
_tmp267)->f1;_LL1C4: _tmp26A=_tmp268;goto _LL1C6;_LL1C5: if(*((int*)_tmp263)!= 1)
goto _LL1C7;_tmp269=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp263)->f2;if(
_tmp269 <= (void*)1  || *((int*)_tmp269)!= 3)goto _LL1C7;_tmp26A=((struct Cyc_Absyn_Local_b_struct*)
_tmp269)->f1;_LL1C6: _tmp26C=_tmp26A;goto _LL1C8;_LL1C7: if(*((int*)_tmp263)!= 1)
goto _LL1C9;_tmp26B=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp263)->f2;if(
_tmp26B <= (void*)1  || *((int*)_tmp26B)!= 4)goto _LL1C9;_tmp26C=((struct Cyc_Absyn_Pat_b_struct*)
_tmp26B)->f1;_LL1C8: return({struct _tuple0 _tmp276;_tmp276.f1=inflow;_tmp276.f2=(
...
_tmp278;});_tmp277;});_tmp276;});_LL1C9: if(*((int*)_tmp263)!= 1)goto _LL1CB;
_tmp26D=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp263)->f2;if(_tmp26D <= (void*)
1  || *((int*)_tmp26D)!= 0)goto _LL1CB;_tmp26E=((struct Cyc_Absyn_Global_b_struct*)
_tmp26D)->f1;_LL1CA: return({struct _tuple0 _tmp27C;_tmp27C.f1=inflow;_tmp27C.f2=(
void*)0;_tmp27C;});_LL1CB: if(*((int*)_tmp263)!= 24)goto _LL1CD;_tmp26F=((struct
Cyc_Absyn_AggrArrow_e_struct*)_tmp263)->f1;_tmp270=((struct Cyc_Absyn_AggrArrow_e_struct*)
_tmp263)->f2;_LL1CC:{void*_tmp27D=Cyc_Tcutil_compress((void*)((struct Cyc_Core_Opt*)
_check_null(_tmp26F->topt))->v);struct Cyc_Absyn_PtrInfo _tmp27E;void*_tmp27F;
_LL1D6: if(_tmp27D <= (void*)3  || *((int*)_tmp27D)!= 4)goto _LL1D8;_tmp27E=((struct
Cyc_Absyn_PointerType_struct*)_tmp27D)->f1;_tmp27F=(void*)_tmp27E.elt_typ;_LL1D7:
...
_tmp281;}));_LL1D5:;}_tmp271=_tmp26F;goto _LL1CE;_LL1CD: if(*((int*)_tmp263)!= 22)
goto _LL1CF;_tmp271=((struct Cyc_Absyn_Deref_e_struct*)_tmp263)->f1;_LL1CE: {void*
...
env,inflow,_tmp285,_tmp271,_tmp286,flds);}_LL1CF: if(*((int*)_tmp263)!= 25)goto
_LL1D1;_tmp272=((struct Cyc_Absyn_Subscript_e_struct*)_tmp263)->f1;_tmp273=((
struct Cyc_Absyn_Subscript_e_struct*)_tmp263)->f2;_LL1D0: {void*_tmp287=Cyc_Tcutil_compress((
void*)((struct Cyc_Core_Opt*)_check_null(_tmp272->topt))->v);struct Cyc_Absyn_PtrInfo
_tmp288;struct Cyc_Absyn_PtrAtts _tmp289;struct Cyc_Absyn_Conref*_tmp28A;_LL1DB: if(
_tmp287 <= (void*)3  || *((int*)_tmp287)!= 9)goto _LL1DD;_LL1DC: {struct _tagged_arr*
...
_LL1DD: if(_tmp287 <= (void*)3  || *((int*)_tmp287)!= 4)goto _LL1DF;_tmp288=((struct
Cyc_Absyn_PointerType_struct*)_tmp287)->f1;_tmp289=_tmp288.ptr_atts;_tmp28A=
_tmp289.bounds;_LL1DE: {void*_tmp28F;struct Cyc_List_List*_tmp290;struct _tuple5
...
_tmp292=_tmp28F;struct Cyc_Dict_Dict*_tmp293;struct Cyc_List_List*_tmp294;_LL1E2:
if(_tmp292 <= (void*)1  || *((int*)_tmp292)!= 0)goto _LL1E4;_tmp293=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp292)->f1;_tmp294=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp292)->f2;
_LL1E3: if(Cyc_CfFlowInfo_initlevel(_tmp293,(void*)((struct Cyc_List_List*)
...
goto _LL1E1;}_LL1E4:;_LL1E5: goto _LL1E1;_LL1E1:;}{void*_tmp29A=(void*)(Cyc_Absyn_compress_conref(
_tmp28A))->v;void*_tmp29B;_LL1E7: if(_tmp29A <= (void*)1  || *((int*)_tmp29A)!= 0)
goto _LL1E9;_tmp29B=(void*)((struct Cyc_Absyn_Eq_constr_struct*)_tmp29A)->f1;if(
_tmp29B <= (void*)1  || *((int*)_tmp29B)!= 1)goto _LL1E9;_LL1E8:{void*_tmp29C=(void*)((
struct Cyc_List_List*)_check_null(((struct Cyc_List_List*)_check_null(_tmp290))->tl))->hd;
struct Cyc_List_List*_tmp29D;_LL1EC: if(_tmp29C <= (void*)3  || *((int*)_tmp29C)!= 3)
goto _LL1EE;_tmp29D=((struct Cyc_CfFlowInfo_TagCmps_struct*)_tmp29C)->f1;_LL1ED:(
...
_tmp29E;})));goto _LL1EB;_LL1EE:;_LL1EF: goto _LL1EB;_LL1EB:;}goto _LL1E6;_LL1E9:;
_LL1EA: goto _LL1E6;_LL1E6:;}{void*_tmp2A1;void*_tmp2A2;struct _tuple0 _tmp2A0=Cyc_NewControlFlow_anal_derefL(
...
_tmp2A4;_tmp2A4.f1=_tmp291;_tmp2A4.f2=_tmp2A2;_tmp2A4;});}}}_LL1DF:;_LL1E0:(int)
...
_LL1DA:;}_LL1D1: if(*((int*)_tmp263)!= 23)goto _LL1D3;_tmp274=((struct Cyc_Absyn_AggrMember_e_struct*)
_tmp263)->f1;_tmp275=((struct Cyc_Absyn_AggrMember_e_struct*)_tmp263)->f2;_LL1D2:
...
_LL1D3:;_LL1D4: return({struct _tuple0 _tmp2AA;_tmp2AA.f1=(void*)0;_tmp2AA.f2=(void*)
0;_tmp2AA;});_LL1BC:;}}static struct _tuple0 Cyc_NewControlFlow_anal_Lexp(struct Cyc_NewControlFlow_AnalEnv*
...
_LL1F1: if(*((int*)_tmp2AB)!= 6)goto _LL1F3;_tmp2AC=((struct Cyc_Absyn_Conditional_e_struct*)
_tmp2AB)->f1;_tmp2AD=((struct Cyc_Absyn_Conditional_e_struct*)_tmp2AB)->f2;
_tmp2AE=((struct Cyc_Absyn_Conditional_e_struct*)_tmp2AB)->f3;_LL1F2: {void*
...
_tmp2C4);_tmp2C5;});}}}_LL1F3: if(*((int*)_tmp2AB)!= 7)goto _LL1F5;_tmp2AF=((
struct Cyc_Absyn_And_e_struct*)_tmp2AB)->f1;_tmp2B0=((struct Cyc_Absyn_And_e_struct*)
_tmp2AB)->f2;_LL1F4: {void*_tmp2C7;void*_tmp2C8;struct _tuple0 _tmp2C6=Cyc_NewControlFlow_anal_test(
...
_tmp2CC;});}}_LL1F5: if(*((int*)_tmp2AB)!= 8)goto _LL1F7;_tmp2B1=((struct Cyc_Absyn_Or_e_struct*)
_tmp2AB)->f1;_tmp2B2=((struct Cyc_Absyn_Or_e_struct*)_tmp2AB)->f2;_LL1F6: {void*
...
env->all_changed,_tmp2CE,_tmp2D1);_tmp2D3.f2=_tmp2D2;_tmp2D3;});}}_LL1F7: if(*((
int*)_tmp2AB)!= 9)goto _LL1F9;_tmp2B3=((struct Cyc_Absyn_SeqExp_e_struct*)_tmp2AB)->f1;
_tmp2B4=((struct Cyc_Absyn_SeqExp_e_struct*)_tmp2AB)->f2;_LL1F8: return Cyc_NewControlFlow_anal_test(
env,(Cyc_NewControlFlow_anal_Rexp(env,inflow,_tmp2B3)).f1,_tmp2B4);_LL1F9: if(*((
int*)_tmp2AB)!= 3)goto _LL1FB;_tmp2B5=(void*)((struct Cyc_Absyn_Primop_e_struct*)
_tmp2AB)->f1;if((int)_tmp2B5 != 11)goto _LL1FB;_tmp2B6=((struct Cyc_Absyn_Primop_e_struct*)
_tmp2AB)->f2;if(_tmp2B6 == 0)goto _LL1FB;_tmp2B7=*_tmp2B6;_tmp2B8=(struct Cyc_Absyn_Exp*)
_tmp2B7.hd;_tmp2B9=_tmp2B7.tl;if(_tmp2B9 != 0)goto _LL1FB;_LL1FA: {void*_tmp2D5;
...
_tmp2D7.f1=_tmp2D6;_tmp2D7.f2=_tmp2D5;_tmp2D7;});}_LL1FB: if(*((int*)_tmp2AB)!= 3)
goto _LL1FD;_tmp2BA=(void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp2AB)->f1;
_tmp2BB=((struct Cyc_Absyn_Primop_e_struct*)_tmp2AB)->f2;_LL1FC: {void*_tmp2D9;
...
struct Cyc_Dict_Dict*_tmp2DC;struct Cyc_List_List*_tmp2DD;_LL200: if((int)_tmp2DB != 
0)goto _LL202;_LL201: return({struct _tuple0 _tmp2DE;_tmp2DE.f1=_tmp2D9;_tmp2DE.f2=
_tmp2D9;_tmp2DE;});_LL202: if(_tmp2DB <= (void*)1  || *((int*)_tmp2DB)!= 0)goto
_LL1FF;_tmp2DC=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp2DB)->f1;_tmp2DD=((
struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp2DB)->f2;_LL203: {struct Cyc_Absyn_Exp*
...
_tmp2FA;void*_tmp2FB;void*_tmp2FC;_LL205: _tmp2E9=_tmp2E8.f1;if(_tmp2E9 <= (void*)
3  || *((int*)_tmp2E9)!= 0)goto _LL207;_tmp2EA=(void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)
_tmp2E9)->f1;_tmp2EB=_tmp2E8.f2;if((int)_tmp2EB != 0)goto _LL207;_LL206: {void*
...
_tmp300=_tmp2BA;_LL21A: if((int)_tmp300 != 5)goto _LL21C;_LL21B: return({struct
_tuple0 _tmp301;_tmp301.f1=_tmp2FF;_tmp301.f2=_tmp2FE;_tmp301;});_LL21C: if((int)
_tmp300 != 6)goto _LL21E;_LL21D: return({struct _tuple0 _tmp302;_tmp302.f1=_tmp2FE;
_tmp302.f2=_tmp2FF;_tmp302;});_LL21E:;_LL21F:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tmp303;}));_LL219:;}}_LL207: _tmp2EC=_tmp2E8.f1;if((int)_tmp2EC != 0)goto _LL209;
_tmp2ED=_tmp2E8.f2;if(_tmp2ED <= (void*)3  || *((int*)_tmp2ED)!= 0)goto _LL209;
_tmp2EE=(void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)_tmp2ED)->f1;_LL208: {
...
_tmp309=_tmp2BA;_LL221: if((int)_tmp309 != 5)goto _LL223;_LL222: return({struct
_tuple0 _tmp30A;_tmp30A.f1=_tmp308;_tmp30A.f2=_tmp307;_tmp30A;});_LL223: if((int)
_tmp309 != 6)goto _LL225;_LL224: return({struct _tuple0 _tmp30B;_tmp30B.f1=_tmp307;
_tmp30B.f2=_tmp308;_tmp30B;});_LL225:;_LL226:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tmp30C;}));_LL220:;}}_LL209: _tmp2EF=_tmp2E8.f1;if((int)_tmp2EF != 0)goto _LL20B;
_tmp2F0=_tmp2E8.f2;if((int)_tmp2F0 != 0)goto _LL20B;_LL20A: if(_tmp2BA == (void*)5)
...
_LL20B: _tmp2F1=_tmp2E8.f1;if((int)_tmp2F1 != 0)goto _LL20D;_tmp2F2=_tmp2E8.f2;if((
int)_tmp2F2 != 1)goto _LL20D;_LL20C: goto _LL20E;_LL20D: _tmp2F3=_tmp2E8.f1;if((int)
_tmp2F3 != 0)goto _LL20F;_tmp2F4=_tmp2E8.f2;if((int)_tmp2F4 != 2)goto _LL20F;_LL20E:
goto _LL210;_LL20F: _tmp2F5=_tmp2E8.f1;if((int)_tmp2F5 != 0)goto _LL211;_tmp2F6=
_tmp2E8.f2;if(_tmp2F6 <= (void*)3  || *((int*)_tmp2F6)!= 2)goto _LL211;_LL210: goto
_LL212;_LL211: _tmp2F7=_tmp2E8.f1;if((int)_tmp2F7 != 1)goto _LL213;_tmp2F8=_tmp2E8.f2;
if((int)_tmp2F8 != 0)goto _LL213;_LL212: goto _LL214;_LL213: _tmp2F9=_tmp2E8.f1;if((
int)_tmp2F9 != 2)goto _LL215;_tmp2FA=_tmp2E8.f2;if((int)_tmp2FA != 0)goto _LL215;
_LL214: goto _LL216;_LL215: _tmp2FB=_tmp2E8.f1;if(_tmp2FB <= (void*)3  || *((int*)
_tmp2FB)!= 2)goto _LL217;_tmp2FC=_tmp2E8.f2;if((int)_tmp2FC != 0)goto _LL217;_LL216:
...
_tmp2D9;_tmp312;});}_LL217:;_LL218: goto _LL204;_LL204:;}{struct _tuple0 _tmp314=({
...
_tmp316;void*_tmp317;void*_tmp318;void*_tmp319;void*_tmp31A;_LL228: _tmp315=
_tmp314.f1;if(_tmp315 <= (void*)3  || *((int*)_tmp315)!= 5)goto _LL22A;_tmp316=(
void*)((struct Cyc_Absyn_IntType_struct*)_tmp315)->f1;if((int)_tmp316 != 1)goto
_LL22A;_LL229: goto _LL22B;_LL22A: _tmp317=_tmp314.f2;if(_tmp317 <= (void*)3  || *((
int*)_tmp317)!= 5)goto _LL22C;_tmp318=(void*)((struct Cyc_Absyn_IntType_struct*)
_tmp317)->f1;if((int)_tmp318 != 1)goto _LL22C;_LL22B: goto _LL22D;_LL22C: _tmp319=
_tmp314.f1;if(_tmp319 <= (void*)3  || *((int*)_tmp319)!= 17)goto _LL22E;_LL22D: goto
_LL22F;_LL22E: _tmp31A=_tmp314.f2;if(_tmp31A <= (void*)3  || *((int*)_tmp31A)!= 17)
goto _LL230;_LL22F: goto _LL227;_LL230:;_LL231: return({struct _tuple0 _tmp31B;_tmp31B.f1=
_tmp2D9;_tmp31B.f2=_tmp2D9;_tmp31B;});_LL227:;}{void*_tmp31C=_tmp2BA;_LL233: if((
int)_tmp31C != 5)goto _LL235;_LL234: {void*_tmp31D=Cyc_NewControlFlow_if_tagcmp(
...
_tmp31E.f1=_tmp31D;_tmp31E.f2=_tmp2D9;_tmp31E;});}_LL235: if((int)_tmp31C != 6)
goto _LL237;_LL236: {void*_tmp31F=Cyc_NewControlFlow_if_tagcmp(env,_tmp2D9,
...
_tmp2D9;_tmp320.f2=_tmp31F;_tmp320;});}_LL237: if((int)_tmp31C != 7)goto _LL239;
_LL238: {void*_tmp321=Cyc_NewControlFlow_if_tagcmp(env,_tmp2D9,_tmp2E0,_tmp2E2,(
...
_tmp323.f2=_tmp322;_tmp323;});}_LL239: if((int)_tmp31C != 9)goto _LL23B;_LL23A: {
...
_tmp325;_tmp326;});}_LL23B: if((int)_tmp31C != 8)goto _LL23D;_LL23C: {void*_tmp327=
...
_tmp2E1);{void*_tmp329=_tmp327;struct Cyc_Dict_Dict*_tmp32A;_LL242: if((int)
_tmp329 != 0)goto _LL244;_LL243:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tmp32B;}));_LL244: if(_tmp329 <= (void*)1  || *((int*)_tmp329)!= 0)goto _LL241;
_tmp32A=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp329)->f1;_LL245: _tmp2DC=
_tmp32A;_LL241:;}{void*_tmp32E=(void*)_tmp2DF->r;void*_tmp32F;struct Cyc_Absyn_Vardecl*
_tmp330;void*_tmp331;struct Cyc_Absyn_Vardecl*_tmp332;void*_tmp333;struct Cyc_Absyn_Vardecl*
_tmp334;void*_tmp335;struct Cyc_Absyn_Vardecl*_tmp336;_LL247: if(*((int*)_tmp32E)
!= 1)goto _LL249;_tmp32F=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp32E)->f2;if(
_tmp32F <= (void*)1  || *((int*)_tmp32F)!= 0)goto _LL249;_tmp330=((struct Cyc_Absyn_Global_b_struct*)
_tmp32F)->f1;if(!(!_tmp330->escapes))goto _LL249;_LL248: _tmp332=_tmp330;goto
_LL24A;_LL249: if(*((int*)_tmp32E)!= 1)goto _LL24B;_tmp331=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp32E)->f2;if(_tmp331 <= (void*)1  || *((int*)_tmp331)!= 3)goto _LL24B;_tmp332=((
struct Cyc_Absyn_Local_b_struct*)_tmp331)->f1;if(!(!_tmp332->escapes))goto _LL24B;
_LL24A: _tmp334=_tmp332;goto _LL24C;_LL24B: if(*((int*)_tmp32E)!= 1)goto _LL24D;
_tmp333=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp32E)->f2;if(_tmp333 <= (void*)
1  || *((int*)_tmp333)!= 4)goto _LL24D;_tmp334=((struct Cyc_Absyn_Pat_b_struct*)
_tmp333)->f1;if(!(!_tmp334->escapes))goto _LL24D;_LL24C: _tmp336=_tmp334;goto
_LL24E;_LL24D: if(*((int*)_tmp32E)!= 1)goto _LL24F;_tmp335=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp32E)->f2;if(_tmp335 <= (void*)1  || *((int*)_tmp335)!= 2)goto _LL24F;_tmp336=((
struct Cyc_Absyn_Param_b_struct*)_tmp335)->f1;if(!(!_tmp336->escapes))goto _LL24F;
_LL24E: {void*_tmp337=(void*)_tmp2E0->r;void*_tmp338;struct Cyc_Absyn_Vardecl*
...
_tmp345;_LL252: if(*((int*)_tmp337)!= 1)goto _LL254;_tmp338=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp337)->f2;if(_tmp338 <= (void*)1  || *((int*)_tmp338)!= 0)goto _LL254;_tmp339=((
struct Cyc_Absyn_Global_b_struct*)_tmp338)->f1;if(!(!_tmp339->escapes))goto _LL254;
_LL253: _tmp33B=_tmp339;goto _LL255;_LL254: if(*((int*)_tmp337)!= 1)goto _LL256;
_tmp33A=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp337)->f2;if(_tmp33A <= (void*)
1  || *((int*)_tmp33A)!= 3)goto _LL256;_tmp33B=((struct Cyc_Absyn_Local_b_struct*)
_tmp33A)->f1;if(!(!_tmp33B->escapes))goto _LL256;_LL255: _tmp33D=_tmp33B;goto
_LL257;_LL256: if(*((int*)_tmp337)!= 1)goto _LL258;_tmp33C=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp337)->f2;if(_tmp33C <= (void*)1  || *((int*)_tmp33C)!= 4)goto _LL258;_tmp33D=((
struct Cyc_Absyn_Pat_b_struct*)_tmp33C)->f1;if(!(!_tmp33D->escapes))goto _LL258;
_LL257: _tmp33F=_tmp33D;goto _LL259;_LL258: if(*((int*)_tmp337)!= 1)goto _LL25A;
_tmp33E=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp337)->f2;if(_tmp33E <= (void*)
1  || *((int*)_tmp33E)!= 2)goto _LL25A;_tmp33F=((struct Cyc_Absyn_Param_b_struct*)
_tmp33E)->f1;if(!(!_tmp33F->escapes))goto _LL25A;_LL259: {struct Cyc_List_List*
...
_tmp347;});}_LL25A: if(*((int*)_tmp337)!= 0)goto _LL25C;_tmp340=(void*)((struct Cyc_Absyn_Const_e_struct*)
_tmp337)->f1;if(_tmp340 <= (void*)1  || *((int*)_tmp340)!= 2)goto _LL25C;_tmp341=((
struct Cyc_Absyn_Int_c_struct*)_tmp340)->f2;_LL25B: {struct Cyc_List_List*_tmp34E=({
...
_tmp34F.f2=_tmp328;_tmp34F;});}_LL25C: if(*((int*)_tmp337)!= 3)goto _LL25E;_tmp342=(
void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp337)->f1;if((int)_tmp342 != 19)goto
_LL25E;_tmp343=((struct Cyc_Absyn_Primop_e_struct*)_tmp337)->f2;if(_tmp343 == 0)
goto _LL25E;_tmp344=*_tmp343;_tmp345=(struct Cyc_Absyn_Exp*)_tmp344.hd;_LL25D: {
...
_tmp35C;void*_tmp35D;struct Cyc_Absyn_Vardecl*_tmp35E;_LL261: if(*((int*)_tmp356)
!= 1)goto _LL263;_tmp357=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp356)->f2;if(
_tmp357 <= (void*)1  || *((int*)_tmp357)!= 0)goto _LL263;_tmp358=((struct Cyc_Absyn_Global_b_struct*)
_tmp357)->f1;if(!(!_tmp358->escapes))goto _LL263;_LL262: _tmp35A=_tmp358;goto
_LL264;_LL263: if(*((int*)_tmp356)!= 1)goto _LL265;_tmp359=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp356)->f2;if(_tmp359 <= (void*)1  || *((int*)_tmp359)!= 3)goto _LL265;_tmp35A=((
struct Cyc_Absyn_Local_b_struct*)_tmp359)->f1;if(!(!_tmp35A->escapes))goto _LL265;
_LL264: _tmp35C=_tmp35A;goto _LL266;_LL265: if(*((int*)_tmp356)!= 1)goto _LL267;
_tmp35B=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp356)->f2;if(_tmp35B <= (void*)
1  || *((int*)_tmp35B)!= 4)goto _LL267;_tmp35C=((struct Cyc_Absyn_Pat_b_struct*)
_tmp35B)->f1;if(!(!_tmp35C->escapes))goto _LL267;_LL266: _tmp35E=_tmp35C;goto
_LL268;_LL267: if(*((int*)_tmp356)!= 1)goto _LL269;_tmp35D=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp356)->f2;if(_tmp35D <= (void*)1  || *((int*)_tmp35D)!= 2)goto _LL269;_tmp35E=((
struct Cyc_Absyn_Param_b_struct*)_tmp35D)->f1;if(!(!_tmp35E->escapes))goto _LL269;
_LL268: {struct Cyc_List_List*_tmp35F=({struct Cyc_List_List*_tmp363=_cycalloc(
...
_tmp360;});}_LL269:;_LL26A: return({struct _tuple0 _tmp367;_tmp367.f1=_tmp327;
_tmp367.f2=_tmp328;_tmp367;});_LL260:;}_LL25E:;_LL25F: return({struct _tuple0
_tmp368;_tmp368.f1=_tmp327;_tmp368.f2=_tmp328;_tmp368;});_LL251:;}_LL24F:;_LL250:
return({struct _tuple0 _tmp369;_tmp369.f1=_tmp327;_tmp369.f2=_tmp328;_tmp369;});
_LL246:;}}_LL23D: if((int)_tmp31C != 10)goto _LL23F;_LL23E: {void*_tmp36A=Cyc_NewControlFlow_if_tagcmp(
...
_tmp36D;_LL26C: if((int)_tmp36C != 0)goto _LL26E;_LL26D:(int)_throw((void*)({struct
...
_get_zero_arr_size(_tmp370,15));});_tmp36F;});_tmp36E;}));_LL26E: if(_tmp36C <= (
void*)1  || *((int*)_tmp36C)!= 0)goto _LL26B;_tmp36D=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp36C)->f1;_LL26F: _tmp2DC=_tmp36D;_LL26B:;}{void*_tmp371=(void*)_tmp2DF->r;
...
_tmp379;_LL271: if(*((int*)_tmp371)!= 1)goto _LL273;_tmp372=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp371)->f2;if(_tmp372 <= (void*)1  || *((int*)_tmp372)!= 0)goto _LL273;_tmp373=((
struct Cyc_Absyn_Global_b_struct*)_tmp372)->f1;if(!(!_tmp373->escapes))goto _LL273;
_LL272: _tmp375=_tmp373;goto _LL274;_LL273: if(*((int*)_tmp371)!= 1)goto _LL275;
_tmp374=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp371)->f2;if(_tmp374 <= (void*)
1  || *((int*)_tmp374)!= 3)goto _LL275;_tmp375=((struct Cyc_Absyn_Local_b_struct*)
_tmp374)->f1;if(!(!_tmp375->escapes))goto _LL275;_LL274: _tmp377=_tmp375;goto
_LL276;_LL275: if(*((int*)_tmp371)!= 1)goto _LL277;_tmp376=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp371)->f2;if(_tmp376 <= (void*)1  || *((int*)_tmp376)!= 4)goto _LL277;_tmp377=((
struct Cyc_Absyn_Pat_b_struct*)_tmp376)->f1;if(!(!_tmp377->escapes))goto _LL277;
_LL276: _tmp379=_tmp377;goto _LL278;_LL277: if(*((int*)_tmp371)!= 1)goto _LL279;
_tmp378=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp371)->f2;if(_tmp378 <= (void*)
1  || *((int*)_tmp378)!= 2)goto _LL279;_tmp379=((struct Cyc_Absyn_Param_b_struct*)
_tmp378)->f1;if(!(!_tmp379->escapes))goto _LL279;_LL278: {void*_tmp37A=(void*)
_tmp2E0->r;void*_tmp37B;struct Cyc_List_List*_tmp37C;struct Cyc_List_List _tmp37D;
struct Cyc_Absyn_Exp*_tmp37E;_LL27C: if(*((int*)_tmp37A)!= 3)goto _LL27E;_tmp37B=(
void*)((struct Cyc_Absyn_Primop_e_struct*)_tmp37A)->f1;if((int)_tmp37B != 19)goto
_LL27E;_tmp37C=((struct Cyc_Absyn_Primop_e_struct*)_tmp37A)->f2;if(_tmp37C == 0)
goto _LL27E;_tmp37D=*_tmp37C;_tmp37E=(struct Cyc_Absyn_Exp*)_tmp37D.hd;_LL27D: {
...
_tmp385;void*_tmp386;struct Cyc_Absyn_Vardecl*_tmp387;_LL281: if(*((int*)_tmp37F)
!= 1)goto _LL283;_tmp380=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp37F)->f2;if(
_tmp380 <= (void*)1  || *((int*)_tmp380)!= 0)goto _LL283;_tmp381=((struct Cyc_Absyn_Global_b_struct*)
_tmp380)->f1;if(!(!_tmp381->escapes))goto _LL283;_LL282: _tmp383=_tmp381;goto
_LL284;_LL283: if(*((int*)_tmp37F)!= 1)goto _LL285;_tmp382=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp37F)->f2;if(_tmp382 <= (void*)1  || *((int*)_tmp382)!= 3)goto _LL285;_tmp383=((
struct Cyc_Absyn_Local_b_struct*)_tmp382)->f1;if(!(!_tmp383->escapes))goto _LL285;
_LL284: _tmp385=_tmp383;goto _LL286;_LL285: if(*((int*)_tmp37F)!= 1)goto _LL287;
_tmp384=(void*)((struct Cyc_Absyn_Var_e_struct*)_tmp37F)->f2;if(_tmp384 <= (void*)
1  || *((int*)_tmp384)!= 4)goto _LL287;_tmp385=((struct Cyc_Absyn_Pat_b_struct*)
_tmp384)->f1;if(!(!_tmp385->escapes))goto _LL287;_LL286: _tmp387=_tmp385;goto
_LL288;_LL287: if(*((int*)_tmp37F)!= 1)goto _LL289;_tmp386=(void*)((struct Cyc_Absyn_Var_e_struct*)
_tmp37F)->f2;if(_tmp386 <= (void*)1  || *((int*)_tmp386)!= 2)goto _LL289;_tmp387=((
struct Cyc_Absyn_Param_b_struct*)_tmp386)->f1;if(!(!_tmp387->escapes))goto _LL289;
_LL288: {struct Cyc_List_List*_tmp388=({struct Cyc_List_List*_tmp38C=_cycalloc(
...
_tmp389;});}_LL289:;_LL28A: return({struct _tuple0 _tmp390;_tmp390.f1=_tmp36A;
_tmp390.f2=_tmp36B;_tmp390;});_LL280:;}_LL27E:;_LL27F: return({struct _tuple0
_tmp391;_tmp391.f1=_tmp36A;_tmp391.f2=_tmp36B;_tmp391;});_LL27B:;}_LL279:;_LL27A:
return({struct _tuple0 _tmp392;_tmp392.f1=_tmp36A;_tmp392.f2=_tmp36B;_tmp392;});
_LL270:;}}_LL23F:;_LL240: return({struct _tuple0 _tmp393;_tmp393.f1=_tmp2D9;_tmp393.f2=
_tmp2D9;_tmp393;});_LL232:;}}_LL1FF:;}}_LL1FD:;_LL1FE: goto _LL1F0;_LL1F0:;}{void*
...
_tmp398;struct Cyc_List_List*_tmp399;_LL28C: if((int)_tmp397 != 0)goto _LL28E;_LL28D:
return({struct _tuple0 _tmp39A;_tmp39A.f1=_tmp395;_tmp39A.f2=_tmp395;_tmp39A;});
_LL28E: if(_tmp397 <= (void*)1  || *((int*)_tmp397)!= 0)goto _LL28B;_tmp398=((struct
Cyc_CfFlowInfo_ReachableFL_struct*)_tmp397)->f1;_tmp399=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp397)->f2;_LL28F: {void*_tmp39B=_tmp396;void*_tmp39C;void*_tmp39D;void*
_tmp39E;_LL291: if((int)_tmp39B != 0)goto _LL293;_LL292: return({struct _tuple0
_tmp39F;_tmp39F.f1=(void*)0;_tmp39F.f2=_tmp395;_tmp39F;});_LL293: if((int)_tmp39B
!= 2)goto _LL295;_LL294: goto _LL296;_LL295: if((int)_tmp39B != 1)goto _LL297;_LL296:
goto _LL298;_LL297: if(_tmp39B <= (void*)3  || *((int*)_tmp39B)!= 2)goto _LL299;
_LL298: return({struct _tuple0 _tmp3A0;_tmp3A0.f1=_tmp395;_tmp3A0.f2=(void*)0;
_tmp3A0;});_LL299: if(_tmp39B <= (void*)3  || *((int*)_tmp39B)!= 0)goto _LL29B;
_tmp39C=(void*)((struct Cyc_CfFlowInfo_UnknownR_struct*)_tmp39B)->f1;if((int)
_tmp39C != 0)goto _LL29B;_LL29A: goto _LL29C;_LL29B: if(_tmp39B <= (void*)3  || *((int*)
_tmp39B)!= 1)goto _LL29D;_tmp39D=(void*)((struct Cyc_CfFlowInfo_Esc_struct*)
_tmp39B)->f1;if((int)_tmp39D != 0)goto _LL29D;_LL29C:({void*_tmp3A1[0]={};Cyc_Tcutil_terr(
...
_LL29D: if(_tmp39B <= (void*)3  || *((int*)_tmp39B)!= 0)goto _LL29F;_tmp39E=(void*)((
struct Cyc_CfFlowInfo_UnknownR_struct*)_tmp39B)->f1;_LL29E: return Cyc_NewControlFlow_splitzero(
env,inflow,_tmp395,e,_tmp39E);_LL29F: if(_tmp39B <= (void*)3  || *((int*)_tmp39B)!= 
1)goto _LL2A1;_LL2A0: return({struct _tuple0 _tmp3A4;_tmp3A4.f1=_tmp395;_tmp3A4.f2=
_tmp395;_tmp3A4;});_LL2A1: if(_tmp39B <= (void*)3  || *((int*)_tmp39B)!= 3)goto
_LL2A3;_LL2A2: return({struct _tuple0 _tmp3A5;_tmp3A5.f1=_tmp395;_tmp3A5.f2=_tmp395;
_tmp3A5;});_LL2A3: if(_tmp39B <= (void*)3  || *((int*)_tmp39B)!= 4)goto _LL290;
_LL2A4:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*_tmp3A6=_cycalloc(
...
sizeof(char),_get_zero_arr_size(_tmp3A8,10));});_tmp3A7;});_tmp3A6;}));_LL290:;}
_LL28B:;}}}static void Cyc_NewControlFlow_check_init_params(struct Cyc_Position_Segment*
loc,struct Cyc_NewControlFlow_AnalEnv*env,void*flow){void*_tmp3A9=flow;struct Cyc_Dict_Dict*
_tmp3AA;_LL2A6: if((int)_tmp3A9 != 0)goto _LL2A8;_LL2A7: return;_LL2A8: if(_tmp3A9 <= (
void*)1  || *((int*)_tmp3A9)!= 0)goto _LL2A5;_tmp3AA=((struct Cyc_CfFlowInfo_ReachableFL_struct*)
_tmp3A9)->f1;_LL2A9:{struct Cyc_List_List*_tmp3AB=env->param_roots;for(0;_tmp3AB
...
_tmp3AC,sizeof(void*),0));});}}return;_LL2A5:;}static void*Cyc_NewControlFlow_anal_scs(
...
clause_inflow,_tmp3B2);}{void*_tmp3B6=clause_outflow;_LL2AB: if((int)_tmp3B6 != 0)
goto _LL2AD;_LL2AC: goto _LL2AA;_LL2AD:;_LL2AE: if(scs->tl == 0)return clause_outflow;
...
_check_null(scs->tl))->hd)->body,clause_outflow);}goto _LL2AA;_LL2AA:;}}}return(
...
_LL2B0: if((int)_tmp3BC != 0)goto _LL2B2;_LL2B1: return inflow;_LL2B2: if(_tmp3BC <= (
void*)1  || *((int*)_tmp3BC)!= 2)goto _LL2B4;_tmp3BD=((struct Cyc_Absyn_Return_s_struct*)
_tmp3BC)->f1;if(_tmp3BD != 0)goto _LL2B4;_LL2B3: if(env->noreturn)({void*_tmp3E8[0]={};
...
inflow);return(void*)0;_LL2B4: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 2)goto
_LL2B6;_tmp3BE=((struct Cyc_Absyn_Return_s_struct*)_tmp3BC)->f1;_LL2B5: if(env->noreturn)({
...
_LL2B6: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 0)goto _LL2B8;_tmp3BF=((struct
Cyc_Absyn_Exp_s_struct*)_tmp3BC)->f1;_LL2B7: return(Cyc_NewControlFlow_anal_Rexp(
env,inflow,_tmp3BF)).f1;_LL2B8: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 1)
goto _LL2BA;_tmp3C0=((struct Cyc_Absyn_Seq_s_struct*)_tmp3BC)->f1;_tmp3C1=((struct
Cyc_Absyn_Seq_s_struct*)_tmp3BC)->f2;_LL2B9: return Cyc_NewControlFlow_anal_stmt(
env,Cyc_NewControlFlow_anal_stmt(env,inflow,_tmp3C0),_tmp3C1);_LL2BA: if(_tmp3BC
<= (void*)1  || *((int*)_tmp3BC)!= 3)goto _LL2BC;_tmp3C2=((struct Cyc_Absyn_IfThenElse_s_struct*)
_tmp3BC)->f1;_tmp3C3=((struct Cyc_Absyn_IfThenElse_s_struct*)_tmp3BC)->f2;_tmp3C4=((
struct Cyc_Absyn_IfThenElse_s_struct*)_tmp3BC)->f3;_LL2BB: {void*_tmp3F0;void*
...
env,_tmp3F1,_tmp3C4));}_LL2BC: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 4)goto
_LL2BE;_tmp3C5=((struct Cyc_Absyn_While_s_struct*)_tmp3BC)->f1;_tmp3C6=_tmp3C5.f1;
_tmp3C7=_tmp3C5.f2;_tmp3C8=((struct Cyc_Absyn_While_s_struct*)_tmp3BC)->f2;_LL2BD: {
...
_tmp3F5;}}_LL2BE: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 13)goto _LL2C0;
_tmp3C9=((struct Cyc_Absyn_Do_s_struct*)_tmp3BC)->f1;_tmp3CA=((struct Cyc_Absyn_Do_s_struct*)
_tmp3BC)->f2;_tmp3CB=_tmp3CA.f1;_tmp3CC=_tmp3CA.f2;_LL2BF: {void*_tmp3F7=Cyc_NewControlFlow_anal_stmt(
...
env,_tmp3C9,_tmp3FA);return _tmp3FB;}_LL2C0: if(_tmp3BC <= (void*)1  || *((int*)
_tmp3BC)!= 8)goto _LL2C2;_tmp3CD=((struct Cyc_Absyn_For_s_struct*)_tmp3BC)->f1;
...
_tmp3D3=_tmp3D1.f2;_tmp3D4=((struct Cyc_Absyn_For_s_struct*)_tmp3BC)->f4;_LL2C1: {
...
_LL2C2: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 5)goto _LL2C4;_tmp3D5=((struct
Cyc_Absyn_Break_s_struct*)_tmp3BC)->f1;if(_tmp3D5 != 0)goto _LL2C4;_LL2C3: return(
void*)0;_LL2C4: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 10)goto _LL2C6;_tmp3D6=((
struct Cyc_Absyn_Fallthru_s_struct*)_tmp3BC)->f1;_tmp3D7=((struct Cyc_Absyn_Fallthru_s_struct*)
_tmp3BC)->f2;if(_tmp3D7 == 0)goto _LL2C6;_tmp3D8=*_tmp3D7;_LL2C5: {void*_tmp405;
...
return(void*)0;}_LL2C6: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 5)goto _LL2C8;
_tmp3D9=((struct Cyc_Absyn_Break_s_struct*)_tmp3BC)->f1;_LL2C7: _tmp3DA=_tmp3D9;
goto _LL2C9;_LL2C8: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 6)goto _LL2CA;
_tmp3DA=((struct Cyc_Absyn_Continue_s_struct*)_tmp3BC)->f1;_LL2C9: _tmp3DB=_tmp3DA;
goto _LL2CB;_LL2CA: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 7)goto _LL2CC;
_tmp3DB=((struct Cyc_Absyn_Goto_s_struct*)_tmp3BC)->f2;_LL2CB: if(env->iteration_num
...
struct Cyc_Absyn_Stmt*)_check_null(_tmp3DB),inflow);return(void*)0;_LL2CC: if(
_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 9)goto _LL2CE;_tmp3DC=((struct Cyc_Absyn_Switch_s_struct*)
_tmp3BC)->f1;_tmp3DD=((struct Cyc_Absyn_Switch_s_struct*)_tmp3BC)->f2;_LL2CD: {
...
_tmp3DD);}_LL2CE: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 14)goto _LL2D0;
_tmp3DE=((struct Cyc_Absyn_TryCatch_s_struct*)_tmp3BC)->f1;_tmp3DF=((struct Cyc_Absyn_TryCatch_s_struct*)
_tmp3BC)->f2;_LL2CF: {int old_in_try=env->in_try;void*old_tryflow=(void*)env->tryflow;
...
void*_tmp40F=scs_outflow;_LL2DB: if((int)_tmp40F != 0)goto _LL2DD;_LL2DC: goto _LL2DA;
_LL2DD:;_LL2DE:({void*_tmp410[0]={};Cyc_Tcutil_terr(s->loc,({const char*_tmp411="last catch clause may implicitly fallthru";
_tag_arr(_tmp411,sizeof(char),_get_zero_arr_size(_tmp411,42));}),_tag_arr(
_tmp410,sizeof(void*),0));});_LL2DA:;}return s1_outflow;}}}_LL2D0: if(_tmp3BC <= (
void*)1  || *((int*)_tmp3BC)!= 11)goto _LL2D2;_tmp3E0=((struct Cyc_Absyn_Decl_s_struct*)
_tmp3BC)->f1;_tmp3E1=((struct Cyc_Absyn_Decl_s_struct*)_tmp3BC)->f2;_LL2D1: return
Cyc_NewControlFlow_anal_stmt(env,Cyc_NewControlFlow_anal_decl(env,inflow,_tmp3E0),
_tmp3E1);_LL2D2: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 12)goto _LL2D4;
_tmp3E2=((struct Cyc_Absyn_Label_s_struct*)_tmp3BC)->f2;_LL2D3: return Cyc_NewControlFlow_anal_stmt(
env,inflow,_tmp3E2);_LL2D4: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 15)goto
_LL2D6;_tmp3E3=((struct Cyc_Absyn_Region_s_struct*)_tmp3BC)->f1;_tmp3E4=((struct
Cyc_Absyn_Region_s_struct*)_tmp3BC)->f2;_tmp3E5=((struct Cyc_Absyn_Region_s_struct*)
_tmp3BC)->f3;_tmp3E6=((struct Cyc_Absyn_Region_s_struct*)_tmp3BC)->f4;_LL2D5: {
...
inflow,_tmp3E6);}_LL2D6: if(_tmp3BC <= (void*)1  || *((int*)_tmp3BC)!= 16)goto
_LL2D8;_tmp3E7=((struct Cyc_Absyn_ResetRegion_s_struct*)_tmp3BC)->f1;_LL2D7: {
...
struct Cyc_Core_Opt*)_check_null(_tmp3E7->topt))->v);void*_tmp419;_LL2E0: if(
_tmp418 <= (void*)3  || *((int*)_tmp418)!= 15)goto _LL2E2;_tmp419=(void*)((struct
Cyc_Absyn_RgnHandleType_struct*)_tmp418)->f1;_LL2E1: return Cyc_CfFlowInfo_kill_flow_region(
_tmp415,_tmp419);_LL2E2:;_LL2E3:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tmp41A;}));_LL2DF:;}}_LL2D8:;_LL2D9:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*
...
_tmp41D;}));_LL2AF:;}}static void*Cyc_NewControlFlow_anal_decl(struct Cyc_NewControlFlow_AnalEnv*
...
_tmp424;struct Cyc_Absyn_Exp*_tmp425;struct Cyc_List_List*_tmp426;_LL2E5: if(
_tmp420 <= (void*)2  || *((int*)_tmp420)!= 0)goto _LL2E7;_tmp421=((struct Cyc_Absyn_Var_d_struct*)
_tmp420)->f1;_LL2E6: {struct Cyc_List_List _tmp427=({struct Cyc_List_List _tmp435;
_tmp435.hd=_tmp421;_tmp435.tl=0;_tmp435;});inflow=Cyc_NewControlFlow_add_vars(
inflow,(struct Cyc_List_List*)& _tmp427,Cyc_CfFlowInfo_unknown_none);{struct Cyc_Absyn_Exp*
...
_tmp42D;struct Cyc_List_List*_tmp42E;_LL2EE: if((int)_tmp42C != 0)goto _LL2F0;_LL2EF:
return(void*)0;_LL2F0: if(_tmp42C <= (void*)1  || *((int*)_tmp42C)!= 0)goto _LL2ED;
_tmp42D=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp42C)->f1;_tmp42E=((struct
Cyc_CfFlowInfo_ReachableFL_struct*)_tmp42C)->f2;_LL2F1: _tmp42D=Cyc_CfFlowInfo_assign_place(
...
env,(void*)_tmp432);return(void*)_tmp432;}_LL2ED:;}}}}_LL2E7: if(_tmp420 <= (void*)
2  || *((int*)_tmp420)!= 2)goto _LL2E9;_tmp422=((struct Cyc_Absyn_Let_d_struct*)
_tmp420)->f2;if(_tmp422 == 0)goto _LL2E9;_tmp423=*_tmp422;_tmp424=(struct Cyc_List_List*)
_tmp423.v;_tmp425=((struct Cyc_Absyn_Let_d_struct*)_tmp420)->f3;_LL2E8: {void*
_tmp437;void*_tmp438;struct _tuple0 _tmp436=Cyc_NewControlFlow_anal_Rexp(env,
inflow,_tmp425);_tmp437=_tmp436.f1;_tmp438=_tmp436.f2;_tmp437=Cyc_NewControlFlow_use_Rval(
env,_tmp425->loc,_tmp437,_tmp438);return Cyc_NewControlFlow_add_vars(_tmp437,
_tmp424,Cyc_CfFlowInfo_unknown_all);}_LL2E9: if(_tmp420 <= (void*)2  || *((int*)
_tmp420)!= 3)goto _LL2EB;_tmp426=((struct Cyc_Absyn_Letv_d_struct*)_tmp420)->f1;
_LL2EA: return Cyc_NewControlFlow_add_vars(inflow,_tmp426,Cyc_CfFlowInfo_unknown_none);
_LL2EB:;_LL2EC:(int)_throw((void*)({struct Cyc_Core_Impossible_struct*_tmp439=
...
_tmp439;}));_LL2E4:;}static void Cyc_NewControlFlow_postpass(struct Cyc_Absyn_Stmt*
...
_tmp44F;struct Cyc_List_List*_tmp450;struct Cyc_List_List*_tmp451;_LL2F3: if(
_tmp43C <= (void*)1  || *((int*)_tmp43C)!= 8)goto _LL2F5;_tmp43D=((struct Cyc_Absyn_For_s_struct*)
_tmp43C)->f2;_tmp43E=_tmp43D.f2;_tmp43F=((struct Cyc_Absyn_For_s_struct*)_tmp43C)->f3;
_tmp440=_tmp43F.f2;_tmp441=((struct Cyc_Absyn_For_s_struct*)_tmp43C)->f4;_LL2F4:
Cyc_NewControlFlow_postpass(_tmp440);_tmp442=_tmp441;_tmp443=_tmp43E;goto _LL2F6;
_LL2F5: if(_tmp43C <= (void*)1  || *((int*)_tmp43C)!= 1)goto _LL2F7;_tmp442=((struct
Cyc_Absyn_Seq_s_struct*)_tmp43C)->f1;_tmp443=((struct Cyc_Absyn_Seq_s_struct*)
_tmp43C)->f2;_LL2F6: _tmp445=_tmp442;_tmp446=_tmp443;goto _LL2F8;_LL2F7: if(_tmp43C
<= (void*)1  || *((int*)_tmp43C)!= 4)goto _LL2F9;_tmp444=((struct Cyc_Absyn_While_s_struct*)
_tmp43C)->f1;_tmp445=_tmp444.f2;_tmp446=((struct Cyc_Absyn_While_s_struct*)
_tmp43C)->f2;_LL2F8: _tmp447=_tmp446;_tmp449=_tmp445;goto _LL2FA;_LL2F9: if(_tmp43C
<= (void*)1  || *((int*)_tmp43C)!= 13)goto _LL2FB;_tmp447=((struct Cyc_Absyn_Do_s_struct*)
_tmp43C)->f1;_tmp448=((struct Cyc_Absyn_Do_s_struct*)_tmp43C)->f2;_tmp449=_tmp448.f2;
_LL2FA: _tmp44A=_tmp447;_tmp44B=_tmp449;goto _LL2FC;_LL2FB: if(_tmp43C <= (void*)1
 || *((int*)_tmp43C)!= 3)goto _LL2FD;_tmp44A=((struct Cyc_Absyn_IfThenElse_s_struct*)
_tmp43C)->f2;_tmp44B=((struct Cyc_Absyn_IfThenElse_s_struct*)_tmp43C)->f3;_LL2FC:
Cyc_NewControlFlow_postpass(_tmp44A);_tmp44C=_tmp44B;goto _LL2FE;_LL2FD: if(
_tmp43C <= (void*)1  || *((int*)_tmp43C)!= 15)goto _LL2FF;_tmp44C=((struct Cyc_Absyn_Region_s_struct*)
_tmp43C)->f4;_LL2FE: _tmp44D=_tmp44C;goto _LL300;_LL2FF: if(_tmp43C <= (void*)1  || *((
int*)_tmp43C)!= 12)goto _LL301;_tmp44D=((struct Cyc_Absyn_Label_s_struct*)_tmp43C)->f2;
_LL300: _tmp44E=_tmp44D;goto _LL302;_LL301: if(_tmp43C <= (void*)1  || *((int*)
_tmp43C)!= 11)goto _LL303;_tmp44E=((struct Cyc_Absyn_Decl_s_struct*)_tmp43C)->f2;
_LL302: Cyc_NewControlFlow_postpass(_tmp44E);return;_LL303: if(_tmp43C <= (void*)1
 || *((int*)_tmp43C)!= 14)goto _LL305;_tmp44F=((struct Cyc_Absyn_TryCatch_s_struct*)
_tmp43C)->f1;_tmp450=((struct Cyc_Absyn_TryCatch_s_struct*)_tmp43C)->f2;_LL304:
Cyc_NewControlFlow_postpass(_tmp44F);_tmp451=_tmp450;goto _LL306;_LL305: if(
_tmp43C <= (void*)1  || *((int*)_tmp43C)!= 9)goto _LL307;_tmp451=((struct Cyc_Absyn_Switch_s_struct*)
_tmp43C)->f2;_LL306: for(0;_tmp451 != 0;_tmp451=_tmp451->tl){Cyc_NewControlFlow_postpass(((
struct Cyc_Absyn_Switch_clause*)_tmp451->hd)->body);}return;_LL307:;_LL308:
return;_LL2F2:;}}static void Cyc_NewControlFlow_check_fun(struct Cyc_Absyn_Fndecl*
...
struct Cyc_Dict_Dict*_tmp455;struct Cyc_List_List*_tmp456;_LL30A: if((int)_tmp454 != 
0)goto _LL30C;_LL30B:({void*_tmp457[0]={};((int(*)(struct _tagged_arr fmt,struct
...
void*),0));});_LL30C: if(_tmp454 <= (void*)1  || *((int*)_tmp454)!= 0)goto _LL309;
_tmp455=((struct Cyc_CfFlowInfo_ReachableFL_struct*)_tmp454)->f1;_tmp456=((struct
Cyc_CfFlowInfo_ReachableFL_struct*)_tmp454)->f2;_LL30D: {struct Cyc_List_List*
...
_LL30F: if(_tmp459 <= (void*)3  || *((int*)_tmp459)!= 8)goto _LL311;_tmp45A=((struct
Cyc_Absyn_FnType_struct*)_tmp459)->f1;_tmp45B=_tmp45A.attributes;_LL310: atts=
_tmp45B;goto _LL30E;_LL311:;_LL312:({void*_tmp45C[0]={};((int(*)(struct
...
_tmp45C,sizeof(void*),0));});_LL30E:;}for(0;atts != 0;atts=atts->tl){void*_tmp45E=(
void*)atts->hd;int _tmp45F;_LL314: if(_tmp45E <= (void*)17  || *((int*)_tmp45E)!= 4)
goto _LL316;_tmp45F=((struct Cyc_Absyn_Initializes_att_struct*)_tmp45E)->f1;_LL315: {
...
struct Cyc_Absyn_Conref*_tmp468;struct Cyc_Absyn_Conref*_tmp469;_LL319: if(_tmp463
<= (void*)3  || *((int*)_tmp463)!= 4)goto _LL31B;_tmp464=((struct Cyc_Absyn_PointerType_struct*)
_tmp463)->f1;_tmp465=(void*)_tmp464.elt_typ;_tmp466=_tmp464.ptr_atts;_tmp467=
_tmp466.nullable;_tmp468=_tmp466.bounds;_tmp469=_tmp466.zero_term;_LL31A: if(((
int(*)(int,struct Cyc_Absyn_Conref*x))Cyc_Absyn_conref_def)(0,_tmp467))({void*
_tmp46A[0]={};Cyc_Tcutil_terr(_tmp452,({const char*_tmp46B="initializes attribute not allowed on nullable pointers";
...
_tmp476));_tmp476->hd=_tmp471;_tmp476->tl=_tmp453;_tmp476;});goto _LL318;}_LL31B:;
_LL31C:({void*_tmp47A[0]={};Cyc_Tcutil_terr(_tmp452,({const char*_tmp47B="initializes attribute on non-pointer";
_tag_arr(_tmp47B,sizeof(char),_get_zero_arr_size(_tmp47B,37));}),_tag_arr(
_tmp47A,sizeof(void*),0));});_LL318:;}goto _LL313;}}_LL316:;_LL317: goto _LL313;
_LL313:;}inflow=(void*)({struct Cyc_CfFlowInfo_ReachableFL_struct*_tmp47C=
...
_LL309:;}{int noreturn=Cyc_Tcutil_is_noreturn(Cyc_Tcutil_fndecl2typ(fd));struct
...
env,inflow,fd->body);}{void*_tmp47E=outflow;_LL31E: if((int)_tmp47E != 0)goto
_LL320;_LL31F: goto _LL31D;_LL320:;_LL321: Cyc_NewControlFlow_check_init_params(
...
void*),0));});else{void*_tmp481=Cyc_Tcutil_compress((void*)fd->ret_type);_LL323:
if((int)_tmp481 != 0)goto _LL325;_LL324: goto _LL322;_LL325: if(_tmp481 <= (void*)3
 || *((int*)_tmp481)!= 6)goto _LL327;_LL326: goto _LL328;_LL327: if((int)_tmp481 != 1)
goto _LL329;_LL328: goto _LL32A;_LL329: if(_tmp481 <= (void*)3  || *((int*)_tmp481)!= 
5)goto _LL32B;_LL32A:({void*_tmp482[0]={};Cyc_Tcutil_warn(_tmp452,({const char*
...
_LL322;_LL32B:;_LL32C:({void*_tmp484[0]={};Cyc_Tcutil_terr(_tmp452,({const char*
...
_LL322;_LL322:;}goto _LL31D;_LL31D:;}Cyc_NewControlFlow_postpass(fd->body);}}void
...
_tmp48D;_LL32E: if(_tmp489 <= (void*)2  || *((int*)_tmp489)!= 1)goto _LL330;_tmp48A=((
struct Cyc_Absyn_Fn_d_struct*)_tmp489)->f1;_LL32F: Cyc_NewControlFlow_check_fun(
_tmp48A);goto _LL32D;_LL330: if(_tmp489 <= (void*)2  || *((int*)_tmp489)!= 10)goto
_LL332;_tmp48B=((struct Cyc_Absyn_ExternC_d_struct*)_tmp489)->f1;_LL331: _tmp48C=
_tmp48B;goto _LL333;_LL332: if(_tmp489 <= (void*)2  || *((int*)_tmp489)!= 9)goto
_LL334;_tmp48C=((struct Cyc_Absyn_Using_d_struct*)_tmp489)->f2;_LL333: _tmp48D=
_tmp48C;goto _LL335;_LL334: if(_tmp489 <= (void*)2  || *((int*)_tmp489)!= 8)goto
_LL336;_tmp48D=((struct Cyc_Absyn_Namespace_d_struct*)_tmp489)->f2;_LL335: Cyc_NewControlFlow_cf_check(
_tmp48D);goto _LL32D;_LL336: if(_tmp489 <= (void*)2  || *((int*)_tmp489)!= 11)goto
_LL338;_LL337: goto _LL32D;_LL338:;_LL339: goto _LL32D;_LL32D:;}}
