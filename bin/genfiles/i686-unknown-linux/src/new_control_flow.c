...
int);int Cyc_Absyn_is_union_type(void*);struct Cyc_Cstdio___abstractFILE;struct Cyc_Std___cycFILE;
...
};struct Cyc_Std_FloatPtr_sa_struct{int tag;float*f1;};struct Cyc_Tcenv_VarRes_struct{
