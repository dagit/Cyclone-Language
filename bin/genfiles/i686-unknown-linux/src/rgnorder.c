...
d,struct Cyc_Absyn_Tvar*k))Cyc_Dict_lookup)(_tmp17,_tmp16))->these_outlive;_tmp17=((
...
_region_malloc(r,sizeof(*_tmp19));_tmp19->these_outlive=(void*)((void*)({struct
Cyc_Absyn_JoinEff_struct*_tmp1A=_cycalloc(sizeof(*_tmp1A));_tmp1A[0]=({struct Cyc_Absyn_JoinEff_struct
...
_tmp1D->these_outlive=(void*)eff;_tmp1D->resetable=0;_tmp1D;}));}_tmp12->d=
_tmp17;return _tmp12;}_LL1B: if(*((int*)_tmp15)!= 0)goto _LL1D;_LL1C: Cyc_Tcutil_unify(
rgn,(void*)2);goto _LL1E;_LL1D: if((int)_tmp15 != 2)goto _LL1F;_LL1E:(void*)(_tmp12->these_outlive_heap=(
void*)((void*)({struct Cyc_Absyn_JoinEff_struct*_tmp1E=_cycalloc(sizeof(*_tmp1E));
_tmp1E[0]=({struct Cyc_Absyn_JoinEff_struct _tmp1F;_tmp1F.tag=20;_tmp1F.f1=({void*
_tmp20[2];_tmp20[1]=(void*)po->these_outlive_heap;_tmp20[0]=eff;Cyc_List_list(
_tag_dyneither(_tmp20,sizeof(void*),2));});_tmp1F;});_tmp1E;})));return _tmp12;
_LL1F: if((int)_tmp15 != 3)goto _LL21;_LL20:(void*)(_tmp12->these_outlive_unique=(
void*)((void*)({struct Cyc_Absyn_JoinEff_struct*_tmp21=_cycalloc(sizeof(*_tmp21));
_tmp21[0]=({struct Cyc_Absyn_JoinEff_struct _tmp22;_tmp22.tag=20;_tmp22.f1=({void*
_tmp23[2];_tmp23[1]=(void*)po->these_outlive_unique;_tmp23[0]=eff;Cyc_List_list(
_tag_dyneither(_tmp23,sizeof(void*),2));});_tmp22;});_tmp21;})));return _tmp12;
_LL21:;_LL22:({void*_tmp24=0;((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp25="RgnOrder::add_outlives_constraint passed a bad region";
...
_tmp39)!= 21)goto _LL2F;_tmp3A=(void*)((struct Cyc_Absyn_RgnsEff_struct*)_tmp39)->f1;
...
20)goto _LL31;_tmp3B=((struct Cyc_Absyn_JoinEff_struct*)_tmp39)->f1;_LL30: for(0;
...
19)goto _LL3B;_tmp3F=(void*)((struct Cyc_Absyn_AccessEff_struct*)_tmp3E)->f1;if(
...
_tmp44;});return;_LL3B: if(*((int*)_tmp3E)!= 20)goto _LL3D;_tmp41=((struct Cyc_Absyn_JoinEff_struct*)
...
_LL46:;_LL47:({void*_tmp47=0;((int(*)(struct _dyneither_ptr fmt,struct
_dyneither_ptr ap))Cyc_Tcutil_impos)(({const char*_tmp48="RgnOrder: rgn not of correct kind";
_tag_dyneither(_tmp48,sizeof(char),34);}),_tag_dyneither(_tmp47,sizeof(void*),0));});
...
_tmp49)->f1;_LL4A: _tmp45.seen=({struct Cyc_List_List*_tmp4B=_region_malloc(
listrgn,sizeof(*_tmp4B));_tmp4B->hd=_tmp4A;_tmp4B->tl=_tmp45.seen;_tmp4B;});
_tmp45.todo=({struct Cyc_List_List*_tmp4C=_region_malloc(listrgn,sizeof(*_tmp4C));
_tmp4C->hd=_tmp4A;_tmp4C->tl=_tmp45.todo;_tmp4C;});goto _LL4C;_LL4B:;_LL4C: return
_tmp45;_LL48:;}}static int Cyc_RgnOrder_atomic_effect_outlives(struct Cyc_RgnOrder_RgnPO*
po,void*eff,void*rgn){struct _RegionHandle _tmp4E=_new_region("listrgn");struct
...
return _tmp69;}Cyc_RgnOrder_add_to_search(& _tmp63,_tmp68);}else{({void*_tmp6A=0;((
int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(({const
char*_tmp6B="RgnOrder: type variable not in dict";_tag_dyneither(_tmp6B,sizeof(
char),36);}),_tag_dyneither(_tmp6A,sizeof(void*),0));});}}{int _tmp6C=0;
_npop_handler(0);return _tmp6C;}}_LL67:;_LL68: {int _tmp6D=0;_npop_handler(0);
...
struct Cyc_String_pa_struct _tmp97;_tmp97.tag=0;_tmp97.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)(_tmp91.f2)->these_outlive));{
...
void*)po->these_outlive_unique));{void*_tmp9B[1]={& _tmp9D};Cyc_fprintf(Cyc_stderr,({
