...
_TL11: _T6=filename;_T7=i;i=_T7 + -1;_T8=_T7;_T9=_check_fat_subscript(_T6,sizeof(char),_T8);_TA=(const char*)_T9;_TB=*_TA;_TC=(int)_TB;_TD=suffix;_TE=j;j=_TE + -1;_TF=_TE;_T10=_check_fat_subscript(_TD,sizeof(char),_TF);_T11=(const char*)_T10;_T12=*_T11;_T13=(int)_T12;if(_TC==_T13)goto _TL14;return 0;_TL14: goto _TL10;_TL12:
 ...
 return 1;}}}
# 75
struct _fat_ptr Cyc_Filename_gnuify(struct _fat_ptr filename){int _T0;struct _fat_ptr _T1;unsigned _T2;struct _fat_ptr _T3;unsigned char*_T4;const char*_T5;char _T6;int _T7;int _T8;struct _fat_ptr _T9;unsigned _TA;unsigned _TB;struct _fat_ptr _TC;int _TD;unsigned _TE;char*_TF;unsigned _T10;unsigned _T11;struct _fat_ptr _T12;unsigned char*_T13;char*_T14;char _T15;struct _fat_ptr _T16;unsigned char*_T17;char*_T18;unsigned _T19;unsigned char*_T1A;char*_T1B;unsigned _T1C;unsigned char*_T1D;char*_T1E;struct _fat_ptr _T1F;unsigned char*_T20;char*_T21;struct _fat_ptr _T22;unsigned char*_T23;const char*_T24;unsigned _T25;unsigned char*_T26;char*_T27;struct _fat_ptr _T28;unsigned _T29;struct _fat_ptr _T2A;int _T2B;unsigned _T2C;char*_T2D;unsigned _T2E;unsigned _T2F;struct _fat_ptr _T30;int _T31;int _T32;unsigned char*_T33;const char*_T34;struct _fat_ptr _T35;int _T36;int _T37;unsigned char*_T38;char*_T39;char _T3A;char _T3B;int _T3C;unsigned _T3D;unsigned char*_T3E;char*_T3F;struct _fat_ptr _T40;_T1=filename;_T2=
...
_get_fat_size(_T9,sizeof(char));_TB=_TA + 1U;ans_sz=(int)_TB;_TD=ans_sz;_TE=(unsigned)_TD;{unsigned _T41=_TE + 1U;_T10=_check_times(_T41,sizeof(char));{char*_T42=_cycalloc_atomic(_T10);{unsigned _T43=_T41;unsigned k;k=0;_TL1F: if(k < _T43)goto _TL1D;else{goto _TL1E;}_TL1D: _T11=k;
_T42[_T11]='\000';k=k + 1;goto _TL1F;_TL1E: _T42[_T43]=0;}_TF=(char*)_T42;}_TC=_tag_fat(_TF,sizeof(char),_T41);}ans=_TC;_T12=ans;{struct _fat_ptr _T41=_fat_ptr_plus(_T12,sizeof(char),0);_T13=_T41.curr;_T14=(char*)_T13;{char _T42=*_T14;_T16=ans;{struct _fat_ptr _T43=_fat_ptr_plus(_T16,sizeof(char),1);_T17=_check_fat_subscript(_T43,sizeof(char),0U);_T18=(char*)_T17;{char _T44=*_T18;char _T45='/';_T19=_get_fat_size(_T43,sizeof(char));if(_T19!=1U)goto _TL20;if(_T44!=0)goto _TL20;if(_T45==0)goto _TL20;_throw_arraybounds();goto _TL21;_TL20: _TL21: _T1A=_T43.curr;_T1B=(char*)_T1A;*_T1B=_T45;_T15=*_T1B;}}{char _T43=_T15;_T1C=_get_fat_size(_T41,sizeof(char));if(_T1C!=1U)goto _TL22;if(_T42!=0)goto _TL22;if(_T43==0)goto _TL22;_throw_arraybounds();goto _TL23;_TL22: _TL23: _T1D=_T41.curr;_T1E=(char*)_T1D;*_T1E=_T43;}}}_T1F=ans;{struct _fat_ptr _T41=_fat_ptr_plus(_T1F,sizeof(char),2);_T20=_check_fat_subscript(_T41,sizeof(char),0U);_T21=(char*)_T20;{char _T42=*_T21;_T22=filename;_T23=_T22.curr;_T24=(const char*)_T23;{char _T43=_T24[0];_T25=_get_fat_size(_T41,sizeof(char));if(_T25!=1U)goto _TL24;if(_T42!=0)goto _TL24;if(_T43==0)goto _TL24;_throw_arraybounds();goto _TL25;_TL24: _TL25: _T26=_T41.curr;_T27=(char*)_T26;*_T27=_T43;}}}
# 85
i=3;
j=2;goto _TL1B;
# 88
_TL1A: _T28=filename;_T29=_get_fat_size(_T28,sizeof(char));ans_sz=(int)_T29;_T2B=ans_sz;_T2C=(unsigned)_T2B;{unsigned _T41=_T2C + 1U;_T2E=_check_times(_T41,sizeof(char));{char*_T42=_cycalloc_atomic(_T2E);{unsigned _T43=_T41;unsigned k;k=0;_TL29: if(k < _T43)goto _TL27;else{goto _TL28;}_TL27: _T2F=k;
_T42[_T2F]='\000';k=k + 1;goto _TL29;_TL28: _T42[_T43]=0;}_T2D=(char*)_T42;}_T2A=_tag_fat(_T2D,sizeof(char),_T41);}ans=_T2A;
i=0;
j=0;_TL1B:
# 93
 _TL2A: if(i < ans_sz)goto _TL2B;else{goto _TL2C;}
_TL2B: _T30=filename;_T31=j;j=_T31 + 1;_T32=_T31;_T33=_check_fat_subscript(_T30,sizeof(char),_T32);_T34=(const char*)_T33;{char c=*_T34;_T35=ans;_T36=i;
i=_T36 + 1;_T37=_T36;{struct _fat_ptr _T41=_fat_ptr_plus(_T35,sizeof(char),_T37);_T38=_check_fat_subscript(_T41,sizeof(char),0U);_T39=(char*)_T38;{char _T42=*_T39;_T3B=c;_T3C=(int)_T3B;if(_T3C!=92)goto _TL2D;_T3A='/';goto _TL2E;_TL2D: _T3A=c;_TL2E: {char _T43=_T3A;_T3D=_get_fat_size(_T41,sizeof(char));if(_T3D!=1U)goto _TL2F;if(_T42!=0)goto _TL2F;if(_T43==0)goto _TL2F;_throw_arraybounds();goto _TL30;_TL2F: _TL30: _T3E=_T41.curr;_T3F=(char*)_T3E;*_T3F=_T43;}}}}goto _TL2A;_TL2C: _T40=ans;
# 97
return _T40;}}
