...
char*tag;struct _dyneither_ptr f1;};typedef char*Cyc_Cstring;typedef char*Cyc_CstringNN;
typedef struct _dyneither_ptr Cyc_string_t;typedef struct _dyneither_ptr Cyc_mstring_t;
typedef struct _dyneither_ptr*Cyc_stringptr_t;typedef struct _dyneither_ptr*Cyc_mstringptr_t;
typedef char*Cyc_Cbuffer_t;typedef char*Cyc_CbufferNN_t;typedef struct
_dyneither_ptr Cyc_buffer_t;typedef struct _dyneither_ptr Cyc_mbuffer_t;typedef int
Cyc_bool;struct Cyc_Core_NewRegion{struct _DynRegionHandle*dynregion;};typedef
...
struct Cyc_List_List*x);extern char Cyc_List_Nth[4];struct Cyc_List_Nth_exn_struct{
...
Cyc_Absyn_HeapRgn_val;extern struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct Cyc_Absyn_RefCntRgn_val;
...
struct Cyc_Set_Set;typedef struct Cyc_Set_Set*Cyc_Set_set_t;extern char Cyc_Set_Absent[
7];struct Cyc_Set_Absent_exn_struct{char*tag;};struct Cyc_Tcenv_CList{void*hd;
const struct Cyc_Tcenv_CList*tl;};typedef const struct Cyc_Tcenv_CList*Cyc_Tcenv_mclist_t;
...
void*Cyc_Tcutil_compress(void*t);extern struct Cyc_Absyn_Kind Cyc_Tcutil_rk;extern
struct Cyc_Absyn_Kind Cyc_Tcutil_bk;int Cyc_Tcutil_unify(void*,void*);void*Cyc_Tcutil_normalize_effect(
void*e);void Cyc_Tcutil_check_no_qual(unsigned int loc,void*t);struct Cyc_PP_Ppstate;
...
void*_tmpE9[1];struct Cyc_String_pa_PrintArg_struct _tmpE8;(_tmpE8.tag=0,((_tmpE8.f1=(
...
_LL1: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp8=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)
...
_tmp7;if(_tmpA->tag != 1)goto _LL5;}_LL4: goto _LL6;_LL5: {struct Cyc_Absyn_VarType_Absyn_Type_struct*
_tmpB=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp7;if(_tmpB->tag != 2)goto
_LL7;}_LL6: return 1;_LL7: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmpC=(
struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmp7;if(_tmpC->tag != 25)goto _LL9;
else{_tmpD=(void*)_tmpC->f1;}}_LL8: {struct Cyc_Absyn_Kind _tmp11;enum Cyc_Absyn_KindQual
_tmp12;enum Cyc_Absyn_AliasQual _tmp13;struct Cyc_Absyn_Kind*_tmp10=Cyc_Tcutil_typ_kind(
_tmpD);_tmp11=*_tmp10;_tmp12=_tmp11.kind;_tmp13=_tmp11.aliasqual;return _tmp3 == 
Cyc_Absyn_Aliasable  || _tmp13 == _tmp3;}_LL9: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*
_tmpE=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmp7;if(_tmpE->tag != 23)
goto _LLB;else{_tmpF=(void*)_tmpE->f1;}}_LLA: {struct Cyc_Absyn_Kind _tmp15;enum 
Cyc_Absyn_KindQual _tmp16;enum Cyc_Absyn_AliasQual _tmp17;struct Cyc_Absyn_Kind*
...
_tmp15.aliasqual;return _tmp2 == Cyc_Absyn_RgnKind  && (_tmp3 == Cyc_Absyn_Aliasable
 || _tmp17 == _tmp3);}_LLB:;_LLC: {const char*_tmpEE;void*_tmpED[1];struct Cyc_String_pa_PrintArg_struct
...
_tmp1E;void*_tmp22;_LLE: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp1D=(
struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmp1C;if(_tmp1D->tag != 24)goto _LL10;
else{_tmp1E=_tmp1D->f1;}}_LLF: {struct Cyc_List_List*effs=0;for(0;_tmp1E != 0;
_tmp1E=_tmp1E->tl){void*_tmp23=Cyc_RgnOrder_filter_effect((void*)_tmp1E->hd,k);
...
_LL12;}_LL11: goto _LL13;_LL12: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmp20=(
struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmp1C;if(_tmp20->tag != 25)goto _LL14;}
_LL13: return _tmp1B;_LL14: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmp21=(
struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmp1C;if(_tmp21->tag != 23)goto
_LL16;else{_tmp22=(void*)_tmp21->f1;}}_LL15: if(Cyc_Tcutil_typ_kind(_tmp22)!= k)
return _tmp1B;else{return(void*)& Cyc_Absyn_VoidType_val;}_LL16:;_LL17: {const char*
...
eff=Cyc_Tcutil_normalize_effect(eff);{struct Cyc_RgnOrder_RgnPO*_tmpF6;struct Cyc_RgnOrder_RgnPO*
_tmp29=(_tmpF6=_region_malloc(r,sizeof(*_tmpF6)),((_tmpF6[0]=*po,_tmpF6)));if(!
Cyc_RgnOrder_valid_constraint(eff,rgn)){{const char*_tmpF9;void*_tmpF8;(_tmpF8=0,
Cyc_Tcutil_terr(loc,((_tmpF9="Invalid region ordering constraint; kind mismatch",
...
_LL19: {struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp2D=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)
...
Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp103;void*_tmp102[2];struct Cyc_Absyn_JoinEff_Absyn_Type_struct
...
_tmp101)))),_tmp103)))),((_tmp100->resetable=0,_tmp100)))))));}else{struct Cyc_RgnOrder_RgnInfo*
_tmp104;_tmp33=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*
k,struct Cyc_RgnOrder_RgnInfo*v))Cyc_Dict_insert)(_tmp33,_tmp2E,((_tmp104=
_region_malloc(r,sizeof(*_tmp104)),((_tmp104->these_outlive=eff,((_tmp104->resetable=
0,_tmp104)))))));}_tmp29->d=_tmp33;return _tmp29;}_LL1B: {struct Cyc_Absyn_Evar_Absyn_Type_struct*
_tmp2F=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp2C;if(_tmp2F->tag != 1)goto
_LL1D;}_LL1C: Cyc_Tcutil_unify(rgn,(void*)& Cyc_Absyn_HeapRgn_val);goto _LL1E;_LL1D: {
struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*_tmp30=(struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*)
_tmp2C;if(_tmp30->tag != 20)goto _LL1F;}_LL1E:{struct Cyc_Absyn_JoinEff_Absyn_Type_struct
_tmp10A;void*_tmp109[2];struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp108;_tmp29->these_outlive_heap=(
void*)((_tmp108=_cycalloc(sizeof(*_tmp108)),((_tmp108[0]=((_tmp10A.tag=24,((
_tmp10A.f1=((_tmp109[1]=po->these_outlive_heap,((_tmp109[0]=eff,((struct Cyc_List_List*(*)(
struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp109,sizeof(void*),2)))))),
_tmp10A)))),_tmp108))));}return _tmp29;_LL1F: {struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*
_tmp31=(struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*)_tmp2C;if(_tmp31->tag != 21)
goto _LL21;}_LL20:{struct Cyc_Absyn_JoinEff_Absyn_Type_struct _tmp110;void*_tmp10F[
2];struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp10E;_tmp29->these_outlive_unique=(
void*)((_tmp10E=_cycalloc(sizeof(*_tmp10E)),((_tmp10E[0]=((_tmp110.tag=24,((
_tmp110.f1=((_tmp10F[1]=po->these_outlive_unique,((_tmp10F[0]=eff,((struct Cyc_List_List*(*)(
struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp10F,sizeof(void*),2)))))),
_tmp110)))),_tmp10E))));}return _tmp29;_LL21: {struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*
_tmp32=(struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*)_tmp2C;if(_tmp32->tag != 22)
goto _LL23;}_LL22: {const char*_tmp113;void*_tmp112;(_tmp112=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp113="RgnOrder::add_outlives_constraint can't outlive RC for now",
...
_region_malloc(r,sizeof(*_tmp11A)),((_tmp11A[0]=*po,_tmp11A)));struct Cyc_Absyn_AccessEff_Absyn_Type_struct
_tmp124;struct Cyc_Absyn_VarType_Absyn_Type_struct _tmp123;struct Cyc_Absyn_VarType_Absyn_Type_struct*
_tmp122;struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmp121;struct Cyc_Absyn_AccessEff_Absyn_Type_struct*
_tmp48=(_tmp121=_cycalloc(sizeof(*_tmp121)),((_tmp121[0]=((_tmp124.tag=23,((
_tmp124.f1=(void*)((void*)((_tmp122=_cycalloc(sizeof(*_tmp122)),((_tmp122[0]=((
_tmp123.tag=2,((_tmp123.f1=po->youngest_unresettable,_tmp123)))),_tmp122))))),
_tmp124)))),_tmp121)));{struct Cyc_RgnOrder_RgnInfo*_tmp125;_tmp47->d=((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*k,struct Cyc_RgnOrder_RgnInfo*v))Cyc_Dict_insert)(
po->d,rgn,((_tmp125=_region_malloc(r,sizeof(*_tmp125)),((_tmp125->these_outlive=(
void*)_tmp48,((_tmp125->resetable=resettable,_tmp125)))))));}if(!resettable);
_tmp47->youngest_unresettable=rgn;return _tmp47;};}struct Cyc_RgnOrder_RgnPO*Cyc_RgnOrder_initial_fn_po(
struct _RegionHandle*r,struct Cyc_List_List*tvs,struct Cyc_List_List*po,void*effect,
struct Cyc_Absyn_Tvar*fst_rgn,unsigned int loc){struct Cyc_Dict_Dict d=((struct Cyc_Dict_Dict(*)(
struct _RegionHandle*,int(*cmp)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*)))Cyc_Dict_rempty)(
r,Cyc_Absyn_tvar_cmp);{struct Cyc_List_List*_tmp4F=tvs;for(0;_tmp4F != 0;_tmp4F=
_tmp4F->tl){if((Cyc_Tcutil_tvar_kind((struct Cyc_Absyn_Tvar*)_tmp4F->hd,& Cyc_Tcutil_bk))->kind
== Cyc_Absyn_RgnKind){struct Cyc_RgnOrder_RgnInfo*_tmp126;d=((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*k,struct Cyc_RgnOrder_RgnInfo*v))Cyc_Dict_insert)(
d,(struct Cyc_Absyn_Tvar*)_tmp4F->hd,((_tmp126=_region_malloc(r,sizeof(*_tmp126)),((
...
_tmp128)))))){{const char*_tmp12C;void*_tmp12B;(_tmp12B=0,Cyc_Tcutil_terr(loc,((
_tmp12C="Invalid region ordering constraint; kind mismatch",_tag_dyneither(
_tmp12C,sizeof(char),50))),_tag_dyneither(_tmp12B,sizeof(void*),0)));}{struct Cyc_RgnOrder_RgnPO*
_tmp12D;return(_tmp12D=_region_malloc(r,sizeof(*_tmp12D)),((_tmp12D->d=d,((
_tmp12D->these_outlive_heap=Cyc_Absyn_empty_effect,((_tmp12D->these_outlive_unique=
...
Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmp5A=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)
_tmp59;if(_tmp5A->tag != 25)goto _LL28;else{_tmp5B=(void*)_tmp5A->f1;}}_LL27: {
...
_tmp5E;if(_tmp5F->tag != 2)goto _LL2F;else{_tmp60=_tmp5F->f1;}}_LL2E: return Cyc_Absyn_tvar_cmp(
_tmp60,rgns_of_var)== 0;_LL2F:;_LL30: return 0;_LL2C:;}_LL28: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*
_tmp5C=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmp59;if(_tmp5C->tag != 24)
goto _LL2A;else{_tmp5D=_tmp5C->f1;}}_LL29: for(0;_tmp5D != 0;_tmp5D=_tmp5D->tl){if(
Cyc_RgnOrder_contains_rgnseff(rgns_of_var,(void*)_tmp5D->hd))return 1;}return 0;
_LL2A:;_LL2B: return 0;_LL25:;}struct Cyc_RgnOrder_OutlivesEnv{struct _RegionHandle*
r;struct Cyc_List_List*seen;struct Cyc_List_List*todo;};static void Cyc_RgnOrder_add_to_search(
struct Cyc_RgnOrder_OutlivesEnv*env,void*eff){void*_tmp61=Cyc_Tcutil_compress(eff);
void*_tmp63;struct Cyc_Absyn_Tvar*_tmp65;struct Cyc_List_List*_tmp67;_LL32: {
struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmp62=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)
_tmp61;if(_tmp62->tag != 23)goto _LL34;else{_tmp63=(void*)_tmp62->f1;{struct Cyc_Absyn_VarType_Absyn_Type_struct*
_tmp64=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp63;if(_tmp64->tag != 2)
goto _LL34;else{_tmp65=_tmp64->f1;}};}}_LL33:{struct Cyc_List_List*_tmp68=env->seen;
for(0;_tmp68 != 0;_tmp68=_tmp68->tl){if(Cyc_Absyn_tvar_cmp(_tmp65,(struct Cyc_Absyn_Tvar*)
_tmp68->hd)== 0)return;}}{struct Cyc_List_List*_tmp130;env->seen=((_tmp130=
_region_malloc(env->r,sizeof(*_tmp130)),((_tmp130->hd=_tmp65,((_tmp130->tl=env->seen,
_tmp130))))));}{struct Cyc_List_List*_tmp131;env->todo=((_tmp131=_region_malloc(
env->r,sizeof(*_tmp131)),((_tmp131->hd=_tmp65,((_tmp131->tl=env->todo,_tmp131))))));}
return;_LL34: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp66=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)
_tmp61;if(_tmp66->tag != 24)goto _LL36;else{_tmp67=_tmp66->f1;}}_LL35: for(0;_tmp67
!= 0;_tmp67=_tmp67->tl){Cyc_RgnOrder_add_to_search(env,(void*)_tmp67->hd);}
return;_LL36:;_LL37: return;_LL31:;}static struct Cyc_RgnOrder_OutlivesEnv Cyc_RgnOrder_initial_env(
struct _RegionHandle*listrgn,struct Cyc_RgnOrder_RgnPO*po,void*rgn){struct Cyc_RgnOrder_OutlivesEnv
_tmp132;struct Cyc_RgnOrder_OutlivesEnv _tmp6B=(_tmp132.r=listrgn,((_tmp132.seen=0,((
_tmp132.todo=0,_tmp132)))));void*r=Cyc_Tcutil_compress(rgn);struct Cyc_Absyn_Kind
_tmp6D;enum Cyc_Absyn_KindQual _tmp6E;enum Cyc_Absyn_AliasQual _tmp6F;struct Cyc_Absyn_Kind*
_tmp6C=Cyc_Tcutil_typ_kind(r);_tmp6D=*_tmp6C;_tmp6E=_tmp6D.kind;_tmp6F=_tmp6D.aliasqual;
if(_tmp6E == Cyc_Absyn_RgnKind)switch(_tmp6F){case Cyc_Absyn_Aliasable: _LL38: Cyc_RgnOrder_add_to_search(&
_tmp6B,po->these_outlive_unique);Cyc_RgnOrder_add_to_search(& _tmp6B,po->these_outlive_heap);
...
_tmp74;_LL3D: {struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp73=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)
...
eff);void*_tmp7B;void*_tmp7D;_LL42: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*
_tmp7A=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmp79;if(_tmp7A->tag != 23)
goto _LL44;else{_tmp7B=(void*)_tmp7A->f1;}}_LL43: {void*_tmp7E=Cyc_Tcutil_compress(
_tmp7B);struct Cyc_Absyn_Tvar*_tmp83;_LL49: {struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*
_tmp7F=(struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*)_tmp7E;if(_tmp7F->tag != 21)
goto _LL4B;}_LL4A: {struct Cyc_Absyn_Kind _tmp85;enum Cyc_Absyn_KindQual _tmp86;
enum Cyc_Absyn_AliasQual _tmp87;struct Cyc_Absyn_Kind*_tmp84=Cyc_Tcutil_typ_kind(
Cyc_Tcutil_compress(rgn));_tmp85=*_tmp84;_tmp86=_tmp85.kind;_tmp87=_tmp85.aliasqual;{
...
_LL4D;}_LL4C: if(Cyc_Tcutil_compress(rgn)== (void*)& Cyc_Absyn_RefCntRgn_val){int
_tmp89=1;_npop_handler(0);return _tmp89;}goto _LL4E;_LL4D: {struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*
_tmp81=(struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*)_tmp7E;if(_tmp81->tag != 20)
goto _LL4F;}_LL4E: {struct Cyc_Absyn_Kind _tmp8B;enum Cyc_Absyn_KindQual _tmp8C;
enum Cyc_Absyn_AliasQual _tmp8D;struct Cyc_Absyn_Kind*_tmp8A=Cyc_Tcutil_typ_kind(
Cyc_Tcutil_compress(rgn));_tmp8B=*_tmp8A;_tmp8C=_tmp8B.kind;_tmp8D=_tmp8B.aliasqual;{
...
goto _LL51;else{_tmp83=_tmp82->f1;}}_LL50: {struct Cyc_RgnOrder_OutlivesEnv _tmp8F=
Cyc_RgnOrder_initial_env(listrgn,po,rgn);while(_tmp8F.todo != 0){struct Cyc_Absyn_Tvar*
_tmp90=(struct Cyc_Absyn_Tvar*)((struct Cyc_List_List*)_check_null(_tmp8F.todo))->hd;
_tmp8F.todo=((struct Cyc_List_List*)_check_null(_tmp8F.todo))->tl;if(Cyc_Absyn_tvar_cmp(
_tmp90,_tmp83)== 0){int _tmp91=1;_npop_handler(0);return _tmp91;}if(((int(*)(
struct Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*k))Cyc_Dict_member)(po->d,_tmp90))Cyc_RgnOrder_add_to_search(&
_tmp8F,(((struct Cyc_RgnOrder_RgnInfo*(*)(struct Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*
k))Cyc_Dict_lookup)(po->d,_tmp90))->these_outlive);else{struct Cyc_String_pa_PrintArg_struct
...
_LL44: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmp7C=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)
_tmp79;if(_tmp7C->tag != 25)goto _LL46;else{_tmp7D=(void*)_tmp7C->f1;}}_LL45: {
...
_tmp98;if(_tmp99->tag != 2)goto _LL56;else{_tmp9A=_tmp99->f1;}}_LL55: {struct Cyc_RgnOrder_OutlivesEnv
...
struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmpAB=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)
_tmpAA;if(_tmpAB->tag != 24)goto _LL5B;else{_tmpAC=_tmpAB->f1;}}_LL5A: for(0;_tmpAC
!= 0;_tmpAC=_tmpAC->tl){if(!Cyc_RgnOrder_effect_outlives(po,(void*)_tmpAC->hd,
rgn))return 0;}return 1;_LL5B:;_LL5C: return Cyc_RgnOrder_atomic_effect_outlives(po,
eff,rgn);_LL58:;};}static void Cyc_RgnOrder_pin_effect(void*eff,void*bd){eff=Cyc_Tcutil_normalize_effect(
eff);{void*_tmpAD=Cyc_Tcutil_compress(eff);struct Cyc_List_List*_tmpAF;void*
_tmpB1;void*_tmpB3;_LL5E: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmpAE=(
struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmpAD;if(_tmpAE->tag != 24)goto _LL60;
else{_tmpAF=_tmpAE->f1;}}_LL5F: for(0;_tmpAF != 0;_tmpAF=_tmpAF->tl){Cyc_RgnOrder_pin_effect((
void*)_tmpAF->hd,bd);}return;_LL60: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*
_tmpB0=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmpAD;if(_tmpB0->tag != 25)
goto _LL62;else{_tmpB1=(void*)_tmpB0->f1;}}_LL61: {void*_tmpB5=Cyc_Tcutil_compress(
_tmpB1);_LL69: {struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmpB6=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)
_tmpB5;if(_tmpB6->tag != 1)goto _LL6B;}_LL6A: Cyc_Tcutil_unify(_tmpB1,Cyc_Absyn_uint_typ);
return;_LL6B:;_LL6C: return;_LL68:;}_LL62: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*
_tmpB2=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmpAD;if(_tmpB2->tag != 23)
goto _LL64;else{_tmpB3=(void*)_tmpB2->f1;}}_LL63: {void*_tmpB7=Cyc_Tcutil_compress(
_tmpB3);_LL6E: {struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmpB8=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)
_tmpB7;if(_tmpB8->tag != 1)goto _LL70;}_LL6F: Cyc_Tcutil_unify(_tmpB3,bd);return;
_LL70:;_LL71: return;_LL6D:;}_LL64: {struct Cyc_Absyn_Evar_Absyn_Type_struct*
_tmpB4=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmpAD;if(_tmpB4->tag != 1)goto
_LL66;}_LL65: Cyc_Tcutil_unify(eff,Cyc_Absyn_empty_effect);return;_LL66:;_LL67:
return;_LL5D:;};}int Cyc_RgnOrder_satisfies_constraints(struct Cyc_RgnOrder_RgnPO*
po,struct Cyc_List_List*constraints,void*default_bound,int do_pin){{struct Cyc_List_List*
_tmpB9=constraints;for(0;_tmpB9 != 0;_tmpB9=_tmpB9->tl){struct _tuple0 _tmpBB;void*
_tmpBC;struct _tuple0*_tmpBA=(struct _tuple0*)_tmpB9->hd;_tmpBB=*_tmpBA;_tmpBC=
_tmpBB.f2;{void*_tmpBD=Cyc_Tcutil_compress(_tmpBC);_LL73: {struct Cyc_Absyn_Evar_Absyn_Type_struct*
_tmpBE=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmpBD;if(_tmpBE->tag != 1)goto
_LL75;}_LL74: if(do_pin)Cyc_Tcutil_unify(_tmpBC,default_bound);goto _LL72;_LL75:;
_LL76: goto _LL72;_LL72:;};}}{struct Cyc_List_List*_tmpBF=constraints;for(0;_tmpBF
!= 0;_tmpBF=_tmpBF->tl){struct _tuple0 _tmpC1;void*_tmpC2;void*_tmpC3;struct
_tuple0*_tmpC0=(struct _tuple0*)_tmpBF->hd;_tmpC1=*_tmpC0;_tmpC2=_tmpC1.f1;_tmpC3=
_tmpC1.f2;if(do_pin)Cyc_RgnOrder_pin_effect(_tmpC2,_tmpC3);if(!Cyc_RgnOrder_effect_outlives(
...
_LL78: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmpC5=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)
_tmpC4;if(_tmpC5->tag != 24)goto _LL7A;else{_tmpC6=_tmpC5->f1;}}_LL79: for(0;_tmpC6
!= 0;_tmpC6=_tmpC6->tl){if(Cyc_RgnOrder_eff_outlives_atomic_eff(po,eff1,(void*)
_tmpC6->hd))return 1;}return 0;_LL7A: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*
_tmpC7=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmpC4;if(_tmpC7->tag != 23)
goto _LL7C;else{_tmpC8=(void*)_tmpC7->f1;}}_LL7B: return Cyc_RgnOrder_effect_outlives(
po,eff1,_tmpC8);_LL7C: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmpC9=(struct
Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmpC4;if(_tmpC9->tag != 25)goto _LL7E;else{
_tmpCA=(void*)_tmpC9->f1;}}_LL7D: {void*_tmpCB=eff1;void*_tmpCD;_LL81: {struct
Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmpCC=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)
_tmpCB;if(_tmpCC->tag != 25)goto _LL83;else{_tmpCD=(void*)_tmpCC->f1;}}_LL82:{
struct _tuple0 _tmp143;struct _tuple0 _tmpCF=(_tmp143.f1=Cyc_Tcutil_compress(_tmpCA),((
_tmp143.f2=Cyc_Tcutil_compress(_tmpCD),_tmp143)));void*_tmpD0;struct Cyc_Absyn_Tvar*
_tmpD2;void*_tmpD3;struct Cyc_Absyn_Tvar*_tmpD5;_LL86: _tmpD0=_tmpCF.f1;{struct Cyc_Absyn_VarType_Absyn_Type_struct*
_tmpD1=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpD0;if(_tmpD1->tag != 2)
goto _LL88;else{_tmpD2=_tmpD1->f1;}};_tmpD3=_tmpCF.f2;{struct Cyc_Absyn_VarType_Absyn_Type_struct*
_tmpD4=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpD3;if(_tmpD4->tag != 2)
goto _LL88;else{_tmpD5=_tmpD4->f1;}};_LL87: return Cyc_Absyn_tvar_cmp(_tmpD2,_tmpD5)
== 0;_LL88:;_LL89: goto _LL85;_LL85:;}goto _LL84;_LL83:;_LL84: return eff1 == (void*)&
Cyc_Absyn_HeapRgn_val;_LL80:;}_LL7E:;_LL7F: return eff1 == (void*)& Cyc_Absyn_HeapRgn_val;
_LL77:;};}int Cyc_RgnOrder_eff_outlives_eff(struct Cyc_RgnOrder_RgnPO*po,void*eff1,
void*eff2){eff1=Cyc_Tcutil_compress(Cyc_Tcutil_normalize_effect(eff1));{void*
_tmpD6=eff1;struct Cyc_List_List*_tmpD8;_LL8B: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*
_tmpD7=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmpD6;if(_tmpD7->tag != 24)
goto _LL8D;else{_tmpD8=_tmpD7->f1;}}_LL8C: for(0;_tmpD8 != 0;_tmpD8=_tmpD8->tl){if(
!Cyc_RgnOrder_eff_outlives_eff(po,(void*)_tmpD8->hd,eff2))return 0;}return 1;_LL8D:;
_LL8E: return Cyc_RgnOrder_eff_outlives_atomic_eff(po,eff1,eff2);_LL8A:;};}struct
_tuple11{struct Cyc_Absyn_Tvar*f1;struct Cyc_RgnOrder_RgnInfo*f2;};void Cyc_RgnOrder_print_region_po(
struct Cyc_RgnOrder_RgnPO*po){struct _RegionHandle _tmpD9=_new_region("r");struct
_RegionHandle*r=& _tmpD9;_push_region(r);{struct Cyc_Iter_Iter iter=((struct Cyc_Iter_Iter(*)(
...
d))Cyc_Dict_rchoose)(r,po->d);{const char*_tmp146;void*_tmp145;(_tmp145=0,Cyc_fprintf(
Cyc_stderr,((_tmp146="region po:\n",_tag_dyneither(_tmp146,sizeof(char),12))),
_tag_dyneither(_tmp145,sizeof(void*),0)));}while(((int(*)(struct Cyc_Iter_Iter,
struct _tuple11*))Cyc_Iter_next)(iter,& _tmpDA)){const char*_tmp14B;void*_tmp14A[2];
struct Cyc_String_pa_PrintArg_struct _tmp149;struct Cyc_String_pa_PrintArg_struct
_tmp148;(_tmp148.tag=0,((_tmp148.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
...
_tmp14D.tag=0,((_tmp14D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
...
_tmp151.tag=0,((_tmp151.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
