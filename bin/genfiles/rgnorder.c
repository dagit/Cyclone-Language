...
# 88
({struct Cyc_Warn_String_Warn_Warg_struct _tmp16=({struct Cyc_Warn_String_Warn_Warg_struct _tmpB6;_tmpB6.tag=0,({struct _fat_ptr _tmpC2=({const char*_tmp1A="bad effect |";_tag_fat(_tmp1A,sizeof(char),13U);});_tmpB6.f1=_tmpC2;});_tmpB6;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp17=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmpB5;_tmpB5.tag=2,_tmpB5.f1=(void*)eff;_tmpB5;});struct Cyc_Warn_String_Warn_Warg_struct _tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _tmpB4;_tmpB4.tag=0,({struct _fat_ptr _tmpC3=({const char*_tmp19="| passed to add_outlives_constraint";_tag_fat(_tmp19,sizeof(char),36U);});_tmpB4.f1=_tmpC3;});_tmpB4;});void*_tmp15[3];_tmp15[0]=& _tmp16,_tmp15[1]=& _tmp17,_tmp15[2]=& _tmp18;({int(*_tmpC4)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmpC4(_tag_fat(_tmp15,sizeof(void*),3));});});};}}}
# 95
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _tmpB7;_tmpB7.tag=0,({struct _fat_ptr _tmpC5=({const char*_tmp1E="Invalid region ordering constraint; kind mismatch";_tag_fat(_tmp1E,sizeof(char),50U);});_tmpB7.f1=_tmpC5;});_tmpB7;});void*_tmp1C[1];_tmp1C[0]=& _tmp1D;({unsigned _tmpC6=loc;Cyc_Warn_err2(_tmpC6,_tag_fat(_tmp1C,sizeof(void*),1));});});
return ans;}{
# 105
...
void*_tmp23=
({(int(*)(struct Cyc_Dict_Dict,struct Cyc_Absyn_Tvar*))Cyc_Dict_member;})(d,tv)?Cyc_Absyn_join_eff(({void*_tmp24[2];_tmp24[0]=eff,({void*_tmpC7=({(void*(*)(struct Cyc_Dict_Dict,struct Cyc_Absyn_Tvar*))Cyc_Dict_lookup;})(d,tv);_tmp24[1]=_tmpC7;});({struct Cyc_List_List*(*_tmpC8)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmpC8(_tag_fat(_tmp24,sizeof(void*),2));});})): eff;
# 108
void*new_eff=_tmp23;
# 110
...
# 117
({void*_tmpCA=Cyc_Absyn_join_eff(({void*_tmp25[2];_tmp25[0]=eff,_tmp25[1]=po->these_outlive_heap;({struct Cyc_List_List*(*_tmpC9)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmpC9(_tag_fat(_tmp25,sizeof(void*),2));});}));ans->these_outlive_heap=_tmpCA;});
return ans;case 6:
# 120
({void*_tmpCC=Cyc_Absyn_join_eff(({void*_tmp26[2];_tmp26[0]=eff,_tmp26[1]=po->these_outlive_unique;({struct Cyc_List_List*(*_tmpCB)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmpCB(_tag_fat(_tmp26,sizeof(void*),2));});}));ans->these_outlive_unique=_tmpCC;});
return ans;case 7:
# 123
({void*_tmp27=0U;({int(*_tmpCE)(struct _fat_ptr,struct _fat_ptr)=({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;});struct _fat_ptr _tmpCD=({const char*_tmp28="RgnOrder::add_outlives_constraint can't outlive RC for now";_tag_fat(_tmp28,sizeof(char),59U);});_tmpCE(_tmpCD,_tag_fat(_tmp27,sizeof(void*),0));});});default: goto _LLB;}default: _LLB:
({void*_tmp29=0U;({int(*_tmpD0)(struct _fat_ptr,struct _fat_ptr)=({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;});struct _fat_ptr _tmpCF=({const char*_tmp2A="RgnOrder::add_outlives_constraint passed a bad region";_tag_fat(_tmp2A,sizeof(char),54U);});_tmpD0(_tmpCF,_tag_fat(_tmp29,sizeof(void*),0));});});};}}}
# 128
...
({void*_tmp2C=0U;({int(*_tmpD2)(struct _fat_ptr,struct _fat_ptr)=({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;});struct _fat_ptr _tmpD1=({const char*_tmp2D="RgnOrder::add_youngest: repeated region";_tag_fat(_tmp2D,sizeof(char),40U);});_tmpD2(_tmpD1,_tag_fat(_tmp2C,sizeof(void*),0));});});{
...
if(opened){
({struct Cyc_Dict_Dict _tmpD3=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct Cyc_Absyn_Tvar*,void*))Cyc_Dict_insert;})(po->d,rgn,Cyc_Absyn_empty_effect);ans->d=_tmpD3;});
({void*_tmpD6=Cyc_Absyn_join_eff(({void*_tmp2F[2];({void*_tmpD4=Cyc_Absyn_access_eff(Cyc_Absyn_var_type(rgn));_tmp2F[0]=_tmpD4;}),_tmp2F[1]=ans->opened_regions;({struct Cyc_List_List*(*_tmpD5)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmpD5(_tag_fat(_tmp2F,sizeof(void*),2));});}));ans->opened_regions=_tmpD6;});}else{
# 137
void*_tmp30=Cyc_Absyn_join_eff(({void*_tmp31[2];({void*_tmpD7=Cyc_Absyn_access_eff(Cyc_Absyn_var_type(po->youngest));_tmp31[0]=_tmpD7;}),_tmp31[1]=ans->opened_regions;({struct Cyc_List_List*(*_tmpD8)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmpD8(_tag_fat(_tmp31,sizeof(void*),2));});}));void*eff=_tmp30;
# 139
({struct Cyc_Dict_Dict _tmpD9=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct Cyc_Absyn_Tvar*,void*))Cyc_Dict_insert;})(po->d,rgn,eff);ans->d=_tmpD9;});
ans->youngest=rgn;}
# 142
return ans;}}
# 144
...
({void*_tmp33=0U;({int(*_tmpDB)(struct _fat_ptr,struct _fat_ptr)=({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;});struct _fat_ptr _tmpDA=({const char*_tmp34="RgnOrder::add_unordered: repeated region";_tag_fat(_tmp34,sizeof(char),41U);});_tmpDB(_tmpDA,_tag_fat(_tmp33,sizeof(void*),0));});});{
...
({struct Cyc_Dict_Dict _tmpDC=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct Cyc_Absyn_Tvar*,void*))Cyc_Dict_insert;})(ans->d,rgn,Cyc_Absyn_empty_effect);ans->d=_tmpDC;});
return ans;}}
# 152
...
# 160
if(!({void*_tmpDD=effect;Cyc_RgnOrder_valid_constraint(_tmpDD,Cyc_Absyn_var_type(fst_rgn));})){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3A=({struct Cyc_Warn_String_Warn_Warg_struct _tmpB8;_tmpB8.tag=0,({struct _fat_ptr _tmpDE=({const char*_tmp3B="Invalid region ordering constraint; kind mismatch";_tag_fat(_tmp3B,sizeof(char),50U);});_tmpB8.f1=_tmpDE;});_tmpB8;});void*_tmp39[1];_tmp39[0]=& _tmp3A;({unsigned _tmpDF=loc;Cyc_Warn_err2(_tmpDF,_tag_fat(_tmp39,sizeof(void*),1));});});
...
return;}}
({struct Cyc_List_List*_tmpE0=({struct Cyc_List_List*_tmp49=_region_malloc(env->r,sizeof(*_tmp49));_tmp49->hd=tv,_tmp49->tl=env->seen;_tmp49;});env->seen=_tmpE0;});
({struct Cyc_List_List*_tmpE1=({struct Cyc_List_List*_tmp4A=_region_malloc(env->r,sizeof(*_tmp4A));_tmp4A->hd=tv,_tmp4A->tl=env->todo;_tmp4A;});env->todo=_tmpE1;});
...
if((int)k != 3)
({void*_tmp50=0U;({int(*_tmpE3)(struct _fat_ptr,struct _fat_ptr)=({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;});struct _fat_ptr _tmpE2=({const char*_tmp51="RgnOrder: rgn not of correct kind";_tag_fat(_tmp51,sizeof(char),34U);});_tmpE3(_tmpE2,_tag_fat(_tmp50,sizeof(void*),0));});});
...
# 254
({struct Cyc_List_List*_tmpE4=({struct Cyc_List_List*_tmp55=_region_malloc(listrgn,sizeof(*_tmp55));_tmp55->hd=tv,_tmp55->tl=ans.seen;_tmp55;});ans.seen=_tmpE4;});
({struct Cyc_List_List*_tmpE5=({struct Cyc_List_List*_tmp56=_region_malloc(listrgn,sizeof(*_tmp56));_tmp56->hd=tv,_tmp56->tl=ans.todo;_tmp56;});ans.todo=_tmpE5;});
...
# 276
 if(({void*_tmpE6=Cyc_Absyn_compress(rgn);_tmpE6 == Cyc_Absyn_refcnt_rgn_type;})){int _tmp63=1;_npop_handler(0);return _tmp63;}
...
# 283
if(po == 0)
({void*_tmp69=0U;({int(*_tmpE8)(struct _fat_ptr,struct _fat_ptr)=({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;});struct _fat_ptr _tmpE7=({const char*_tmp6A="RgnOrder: tvar without a partial-order";_tag_fat(_tmp6A,sizeof(char),39U);});_tmpE8(_tmpE7,_tag_fat(_tmp69,sizeof(void*),0));});});{
# 295 "rgnorder.cyc"
...
# 318
if(po == 0)
({void*_tmp74=0U;({int(*_tmpEA)(struct _fat_ptr,struct _fat_ptr)=({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;});struct _fat_ptr _tmpE9=({const char*_tmp75="RgnOrder: tvar without a partial-order";_tag_fat(_tmp75,sizeof(char),39U);});_tmpEA(_tmpE9,_tag_fat(_tmp74,sizeof(void*),0));});});{
# 323
...
env.todo=((struct Cyc_List_List*)_check_null(env.todo))->tl;
if(!({(int(*)(struct Cyc_Dict_Dict,struct Cyc_Absyn_Tvar*))Cyc_Dict_member;})(po->d,next))
({void*_tmp7E=0U;({int(*_tmpEC)(struct _fat_ptr,struct _fat_ptr)=({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;});struct _fat_ptr _tmpEB=({const char*_tmp7F="RgnOrder: type variable not in dict";_tag_fat(_tmp7F,sizeof(char),36U);});_tmpEC(_tmpEB,_tag_fat(_tmp7E,sizeof(void*),0));});});{
...
return({struct Cyc_RgnOrder_RgnPO*_tmpEE=po;void*_tmpED=Cyc_Absyn_access_eff(rgn1);Cyc_RgnOrder_effect_outlives(_tmpEE,_tmpED,rgn2);});}
# 395
...
# 408
{struct _tuple0 _tmp93=({struct _tuple0 _tmpBA;({void*_tmpF0=Cyc_Absyn_compress(vt1);_tmpBA.f1=_tmpF0;}),({void*_tmpEF=Cyc_Absyn_compress(vt2);_tmpBA.f2=_tmpEF;});_tmpBA;});struct _tuple0 _stmttmp13=_tmp93;struct _tuple0 _tmp94=_stmttmp13;void*_tmp96;void*_tmp95;if(*((int*)_tmp94.f1)== 2){if(*((int*)_tmp94.f2)== 2){_tmp95=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp94.f1)->f1;_tmp96=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp94.f2)->f1;{struct Cyc_Absyn_Tvar*tv1=_tmp95;struct Cyc_Absyn_Tvar*tv2=_tmp96;
...
({void*_tmpA5=0U;({struct Cyc___cycFILE*_tmpF2=Cyc_stderr;struct _fat_ptr _tmpF1=({const char*_tmpA6="region po:\n";_tag_fat(_tmpA6,sizeof(char),12U);});Cyc_fprintf(_tmpF2,_tmpF1,_tag_fat(_tmpA5,sizeof(void*),0));});});
...
struct _fat_ptr _tmpF3=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_typ2string(elem.f2));_tmpBB.f1=_tmpF3;});_tmpBB;});void*_tmpA7[2];_tmpA7[0]=& _tmpA9,_tmpA7[1]=& _tmpAA;({struct Cyc___cycFILE*_tmpF5=Cyc_stderr;struct _fat_ptr _tmpF4=({const char*_tmpA8="  %s outlived by %s\n";_tag_fat(_tmpA8,sizeof(char),21U);});Cyc_fprintf(_tmpF5,_tmpF4,_tag_fat(_tmpA7,sizeof(void*),2));});});}
({struct Cyc_String_pa_PrintArg_struct _tmpAD=({struct Cyc_String_pa_PrintArg_struct _tmpBD;_tmpBD.tag=0,({
struct _fat_ptr _tmpF6=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_typ2string(po->these_outlive_heap));_tmpBD.f1=_tmpF6;});_tmpBD;});void*_tmpAB[1];_tmpAB[0]=& _tmpAD;({struct Cyc___cycFILE*_tmpF8=Cyc_stderr;struct _fat_ptr _tmpF7=({const char*_tmpAC="  these outlive heap: %s\n";_tag_fat(_tmpAC,sizeof(char),26U);});Cyc_fprintf(_tmpF8,_tmpF7,_tag_fat(_tmpAB,sizeof(void*),1));});});
({struct Cyc_String_pa_PrintArg_struct _tmpB0=({struct Cyc_String_pa_PrintArg_struct _tmpBE;_tmpBE.tag=0,({
struct _fat_ptr _tmpF9=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_typ2string(po->these_outlive_unique));_tmpBE.f1=_tmpF9;});_tmpBE;});void*_tmpAE[1];_tmpAE[0]=& _tmpB0;({struct Cyc___cycFILE*_tmpFB=Cyc_stderr;struct _fat_ptr _tmpFA=({const char*_tmpAF="  these outlive unique: %s\n";_tag_fat(_tmpAF,sizeof(char),28U);});Cyc_fprintf(_tmpFB,_tmpFA,_tag_fat(_tmpAE,sizeof(void*),1));});});}
