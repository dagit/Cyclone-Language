...
({void*_tmp18=0U;({unsigned _tmpBB=loc;struct _dyneither_ptr _tmpBA=({const char*_tmp19="Invalid region ordering constraint; kind mismatch";_tag_dyneither(_tmp19,sizeof(char),50U);});Cyc_Tcutil_terr(_tmpBB,_tmpBA,_tag_dyneither(_tmp18,sizeof(void*),0U));});});
return _tmp17;}{
# 108
...
# 128
({void*_tmp21=0U;({struct _dyneither_ptr _tmpC0=({const char*_tmp22="RgnOrder::add_outlives_constraint can't outlive RC for now";_tag_dyneither(_tmp22,sizeof(char),59U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmpC0,_tag_dyneither(_tmp21,sizeof(void*),0U));});});default: goto _LLB;}default: _LLB: _LLC:
({void*_tmp23=0U;({struct _dyneither_ptr _tmpC1=({const char*_tmp24="RgnOrder::add_outlives_constraint passed a bad region";_tag_dyneither(_tmp24,sizeof(char),54U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmpC1,_tag_dyneither(_tmp23,sizeof(void*),0U));});});}_LL0:;};};}
# 133
...
({void*_tmp27=0U;({struct _dyneither_ptr _tmpC2=({const char*_tmp28="RgnOrder::add_youngest: repeated region";_tag_dyneither(_tmp28,sizeof(char),40U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmpC2,_tag_dyneither(_tmp27,sizeof(void*),0U));});});{
...
({void*_tmp2E=0U;({struct _dyneither_ptr _tmpC8=({const char*_tmp2F="RgnOrder::add_unordered: repeated region";_tag_dyneither(_tmp2F,sizeof(char),41U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmpC8,_tag_dyneither(_tmp2E,sizeof(void*),0U));});});{
...
# 170
({void*_tmp34=0U;({unsigned _tmpCC=loc;struct _dyneither_ptr _tmpCB=({const char*_tmp35="Invalid region ordering constraint; kind mismatch";_tag_dyneither(_tmp35,sizeof(char),50U);});Cyc_Tcutil_terr(_tmpCC,_tmpCB,_tag_dyneither(_tmp34,sizeof(void*),0U));});});
...
({void*_tmp74=0U;({struct _dyneither_ptr _tmpD3=({const char*_tmp75="RgnOrder: type variable not in dict";_tag_dyneither(_tmp75,sizeof(char),36U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmpD3,_tag_dyneither(_tmp74,sizeof(void*),0U));});});}}{
# 366
