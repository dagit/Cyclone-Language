...
14];struct Cyc_List_List_mismatch_exn_struct{char*tag;};
# 166
struct Cyc_List_List*Cyc_List_imp_rev(struct Cyc_List_List*x);extern char Cyc_List_Nth[
4];struct Cyc_List_Nth_exn_struct{char*tag;};struct Cyc_Iter_Iter{void*env;int(*
...
char*tag;};
# 906 "/home/jgm/cyclone/src/absyn.h"
...
char*tag;};struct Cyc_Tcenv_CList{void*hd;const struct Cyc_Tcenv_CList*tl;};
...
# 287 "/home/jgm/cyclone/src/tcutil.h"
...
# 38 "/home/jgm/cyclone/src/rgnorder.cyc"
...
# 42
static void*Cyc_RgnOrder_filter_effect(void*eff,struct Cyc_Absyn_Kind*k);struct
...
youngest_unresettable;};
# 74 "/home/jgm/cyclone/src/rgnorder.cyc"
static int Cyc_RgnOrder_valid_constraint(void*eff,void*rgn){
# 75
...
_tmp1.kind;_tmp3=_tmp1.aliasqual;
# 76
if(_tmp2 != Cyc_Absyn_RgnKind){
# 77
const char*_tmpEA;void*_tmpE9[1];struct Cyc_String_pa_PrintArg_struct _tmpE8;(
_tmpE8.tag=0,((_tmpE8.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 78
Cyc_Absynpp_typ2string(rgn)),((_tmpE9[0]=& _tmpE8,((int(*)(struct _dyneither_ptr
fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmpEA="bad region type |%s| passed to add_outlives_constraint",
_tag_dyneither(_tmpEA,sizeof(char),55))),_tag_dyneither(_tmpE9,sizeof(void*),1)))))));}{
# 79
void*_tmp7=Cyc_Tcutil_compress(eff);struct Cyc_List_List*_tmp9;void*_tmpD;void*
_tmpF;_LL1: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp8=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)
_tmp7;if(_tmp8->tag != 24)goto _LL3;else{_tmp9=_tmp8->f1;}}_LL2:
# 81
 for(0;_tmp9 != 0;_tmp9=_tmp9->tl){
# 82
if(!Cyc_RgnOrder_valid_constraint((void*)_tmp9->hd,rgn))return 0;}
# 83
return 1;_LL3: {struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmpA=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)
_tmp7;if(_tmpA->tag != 1)goto _LL5;}_LL4:
# 85
 goto _LL6;_LL5: {struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmpB=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)
_tmp7;if(_tmpB->tag != 2)goto _LL7;}_LL6:
# 86
 return 1;_LL7: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmpC=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)
_tmp7;if(_tmpC->tag != 25)goto _LL9;else{_tmpD=(void*)_tmpC->f1;}}_LL8: {
# 90
struct Cyc_Absyn_Kind _tmp11;enum Cyc_Absyn_KindQual _tmp12;enum Cyc_Absyn_AliasQual
_tmp13;struct Cyc_Absyn_Kind*_tmp10=Cyc_Tcutil_typ_kind(_tmpD);_tmp11=*_tmp10;
_tmp12=_tmp11.kind;_tmp13=_tmp11.aliasqual;
# 91
return _tmp3 == Cyc_Absyn_Aliasable  || _tmp13 == _tmp3;}_LL9: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*
_tmpE=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmp7;if(_tmpE->tag != 23)
goto _LLB;else{_tmpF=(void*)_tmpE->f1;}}_LLA: {
# 95
struct Cyc_Absyn_Kind _tmp15;enum Cyc_Absyn_KindQual _tmp16;enum Cyc_Absyn_AliasQual
_tmp17;struct Cyc_Absyn_Kind*_tmp14=Cyc_Tcutil_typ_kind(_tmpF);_tmp15=*_tmp14;
_tmp16=_tmp15.kind;_tmp17=_tmp15.aliasqual;
# 96
return _tmp2 == Cyc_Absyn_RgnKind  && (_tmp3 == Cyc_Absyn_Aliasable  || _tmp17 == 
_tmp3);}_LLB:;_LLC: {
# 98
const char*_tmpEE;void*_tmpED[1];struct Cyc_String_pa_PrintArg_struct _tmpEC;(
_tmpEC.tag=0,((_tmpEC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 99
...
# 106
void*_tmp1C=_tmp1B;struct Cyc_List_List*_tmp1E;void*_tmp22;_LLE: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*
_tmp1D=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmp1C;if(_tmp1D->tag != 24)
goto _LL10;else{_tmp1E=_tmp1D->f1;}}_LLF: {
# 108
...
# 111
if(_tmp23 != (void*)& Cyc_Absyn_VoidType_val){struct Cyc_List_List*_tmpEF;effs=((
_tmpEF=_cycalloc(sizeof(*_tmpEF)),((_tmpEF->hd=_tmp23,((_tmpEF->tl=effs,_tmpEF))))));}}{
# 113
struct Cyc_Absyn_JoinEff_Absyn_Type_struct _tmpF2;struct Cyc_Absyn_JoinEff_Absyn_Type_struct*
_tmpF1;return(void*)((_tmpF1=_cycalloc(sizeof(*_tmpF1)),((_tmpF1[0]=((_tmpF2.tag=
24,((_tmpF2.f1=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(
effs),_tmpF2)))),_tmpF1))));};}_LL10: {struct Cyc_Absyn_Evar_Absyn_Type_struct*
_tmp1F=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp1C;if(_tmp1F->tag != 1)goto
_LL12;}_LL11:
# 114
 goto _LL13;_LL12: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmp20=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)
_tmp1C;if(_tmp20->tag != 25)goto _LL14;}_LL13:
# 115
 return _tmp1B;_LL14: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmp21=(struct
Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmp1C;if(_tmp21->tag != 23)goto _LL16;
else{_tmp22=(void*)_tmp21->f1;}}_LL15:
# 116
 if(Cyc_Tcutil_typ_kind(_tmp22)!= k)return _tmp1B;else{return(void*)& Cyc_Absyn_VoidType_val;}
_LL16:;_LL17: {
# 117
const char*_tmpF5;void*_tmpF4;(_tmpF4=0,((int(*)(struct _dyneither_ptr fmt,struct
...
# 124
struct Cyc_RgnOrder_RgnPO*Cyc_RgnOrder_add_outlives_constraint(struct
_RegionHandle*r,struct Cyc_RgnOrder_RgnPO*po,void*eff,void*rgn,unsigned int loc){
# 127
eff=Cyc_Tcutil_normalize_effect(eff);{
# 128
struct Cyc_RgnOrder_RgnPO*_tmpF6;struct Cyc_RgnOrder_RgnPO*_tmp29=(_tmpF6=
_region_malloc(r,sizeof(*_tmpF6)),((_tmpF6[0]=*po,_tmpF6)));
# 130
if(!Cyc_RgnOrder_valid_constraint(eff,rgn)){
# 131
{const char*_tmpF9;void*_tmpF8;(_tmpF8=0,Cyc_Tcutil_terr(loc,((_tmpF9="Invalid region ordering constraint; kind mismatch",
_tag_dyneither(_tmpF9,sizeof(char),50))),_tag_dyneither(_tmpF8,sizeof(void*),0)));}
# 132
return _tmp29;}{
# 135
void*_tmp2C=Cyc_Tcutil_compress(rgn);struct Cyc_Absyn_Tvar*_tmp2E;_LL19: {struct
Cyc_Absyn_VarType_Absyn_Type_struct*_tmp2D=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)
_tmp2C;if(_tmp2D->tag != 2)goto _LL1B;else{_tmp2E=_tmp2D->f1;}}_LL1A: {
# 137
struct Cyc_Dict_Dict _tmp33=po->d;
# 138
if(((int(*)(struct Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*k))Cyc_Dict_member)(
_tmp33,_tmp2E)){
# 139
void*_tmp34=(((struct Cyc_RgnOrder_RgnInfo*(*)(struct Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*
k))Cyc_Dict_lookup)(_tmp33,_tmp2E))->these_outlive;
# 140
struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp103;void*_tmp102[2];struct Cyc_Absyn_JoinEff_Absyn_Type_struct
...
void*)((_tmp103=_cycalloc(sizeof(*_tmp103)),((_tmp103[0]=((_tmp101.tag=24,((
_tmp101.f1=((_tmp102[1]=_tmp34,((_tmp102[0]=eff,((struct Cyc_List_List*(*)(struct
_dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp102,sizeof(void*),2)))))),
_tmp101)))),_tmp103)))),((_tmp100->resetable=0,_tmp100)))))));}else{
# 142
struct Cyc_RgnOrder_RgnInfo*_tmp104;_tmp33=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct Cyc_Absyn_Tvar*k,struct Cyc_RgnOrder_RgnInfo*v))Cyc_Dict_insert)(_tmp33,
_tmp2E,((_tmp104=_region_malloc(r,sizeof(*_tmp104)),((_tmp104->these_outlive=eff,((
_tmp104->resetable=0,_tmp104)))))));}
# 143
_tmp29->d=_tmp33;
# 144
return _tmp29;}_LL1B: {struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmp2F=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)
_tmp2C;if(_tmp2F->tag != 1)goto _LL1D;}_LL1C:
# 146
 Cyc_Tcutil_unify(rgn,(void*)& Cyc_Absyn_HeapRgn_val);
# 147
goto _LL1E;_LL1D: {struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*_tmp30=(struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*)
_tmp2C;if(_tmp30->tag != 20)goto _LL1F;}_LL1E:
# 149
{struct Cyc_Absyn_JoinEff_Absyn_Type_struct _tmp10A;void*_tmp109[2];struct Cyc_Absyn_JoinEff_Absyn_Type_struct*
_tmp108;_tmp29->these_outlive_heap=(void*)((_tmp108=_cycalloc(sizeof(*_tmp108)),((
_tmp108[0]=((_tmp10A.tag=24,((_tmp10A.f1=((_tmp109[1]=po->these_outlive_heap,((
_tmp109[0]=eff,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(
_tag_dyneither(_tmp109,sizeof(void*),2)))))),_tmp10A)))),_tmp108))));}
# 150
return _tmp29;_LL1F: {struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*_tmp31=(struct
Cyc_Absyn_UniqueRgn_Absyn_Type_struct*)_tmp2C;if(_tmp31->tag != 21)goto _LL21;}
_LL20:
# 152
{struct Cyc_Absyn_JoinEff_Absyn_Type_struct _tmp110;void*_tmp10F[2];struct Cyc_Absyn_JoinEff_Absyn_Type_struct*
_tmp10E;_tmp29->these_outlive_unique=(void*)((_tmp10E=_cycalloc(sizeof(*_tmp10E)),((
_tmp10E[0]=((_tmp110.tag=24,((_tmp110.f1=((_tmp10F[1]=po->these_outlive_unique,((
_tmp10F[0]=eff,((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(
_tag_dyneither(_tmp10F,sizeof(void*),2)))))),_tmp110)))),_tmp10E))));}
# 153
return _tmp29;_LL21: {struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*_tmp32=(struct
Cyc_Absyn_RefCntRgn_Absyn_Type_struct*)_tmp2C;if(_tmp32->tag != 22)goto _LL23;}
_LL22: {
# 155
const char*_tmp113;void*_tmp112;(_tmp112=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp113="RgnOrder::add_outlives_constraint can't outlive RC for now",
_tag_dyneither(_tmp113,sizeof(char),59))),_tag_dyneither(_tmp112,sizeof(void*),0)));}
_LL23:;_LL24: {
# 156
const char*_tmp116;void*_tmp115;(_tmp115=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp116="RgnOrder::add_outlives_constraint passed a bad region",
_tag_dyneither(_tmp116,sizeof(char),54))),_tag_dyneither(_tmp115,sizeof(void*),0)));}
_LL18:;};};}
# 160
struct Cyc_RgnOrder_RgnPO*Cyc_RgnOrder_add_youngest(struct _RegionHandle*r,struct
Cyc_RgnOrder_RgnPO*po,struct Cyc_Absyn_Tvar*rgn,int resettable,int opened){
# 162
if(!opened  && ((int(*)(struct Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*k))Cyc_Dict_member)(
po->d,rgn)){
# 163
const char*_tmp119;void*_tmp118;(_tmp118=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp119="RgnOrder::add_youngest: repeated region",
...
_region_malloc(r,sizeof(*_tmp11A)),((_tmp11A[0]=*po,_tmp11A)));
# 165
struct Cyc_Absyn_AccessEff_Absyn_Type_struct _tmp124;struct Cyc_Absyn_VarType_Absyn_Type_struct
_tmp123;struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp122;struct Cyc_Absyn_AccessEff_Absyn_Type_struct*
_tmp121;struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmp48=(_tmp121=_cycalloc(
sizeof(*_tmp121)),((_tmp121[0]=((_tmp124.tag=23,((_tmp124.f1=(void*)((void*)((
_tmp122=_cycalloc(sizeof(*_tmp122)),((_tmp122[0]=((_tmp123.tag=2,((_tmp123.f1=po->youngest_unresettable,
_tmp123)))),_tmp122))))),_tmp124)))),_tmp121)));
# 166
{struct Cyc_RgnOrder_RgnInfo*_tmp125;_tmp47->d=((struct Cyc_Dict_Dict(*)(struct
Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*k,struct Cyc_RgnOrder_RgnInfo*v))Cyc_Dict_insert)(
po->d,rgn,((_tmp125=_region_malloc(r,sizeof(*_tmp125)),((_tmp125->these_outlive=(
void*)_tmp48,((_tmp125->resetable=resettable,_tmp125)))))));}
# 167
if(!resettable);
# 168
...
return _tmp47;};}
# 172
struct Cyc_RgnOrder_RgnPO*Cyc_RgnOrder_initial_fn_po(struct _RegionHandle*r,
struct Cyc_List_List*tvs,struct Cyc_List_List*po,void*effect,struct Cyc_Absyn_Tvar*
fst_rgn,unsigned int loc){
# 176
struct Cyc_Dict_Dict d=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(
...
# 178
if((Cyc_Tcutil_tvar_kind((struct Cyc_Absyn_Tvar*)_tmp4F->hd,& Cyc_Tcutil_bk))->kind
== Cyc_Absyn_RgnKind){
# 181
struct Cyc_RgnOrder_RgnInfo*_tmp126;d=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict
d,struct Cyc_Absyn_Tvar*k,struct Cyc_RgnOrder_RgnInfo*v))Cyc_Dict_insert)(d,(
struct Cyc_Absyn_Tvar*)_tmp4F->hd,((_tmp126=_region_malloc(r,sizeof(*_tmp126)),((
_tmp126->these_outlive=Cyc_Absyn_empty_effect,((_tmp126->resetable=0,_tmp126)))))));}}}
# 185
{struct Cyc_Absyn_VarType_Absyn_Type_struct _tmp129;struct Cyc_Absyn_VarType_Absyn_Type_struct*
_tmp128;if(!Cyc_RgnOrder_valid_constraint(effect,(void*)((_tmp128=_cycalloc(
sizeof(*_tmp128)),((_tmp128[0]=((_tmp129.tag=2,((_tmp129.f1=fst_rgn,_tmp129)))),
_tmp128)))))){
# 187
{const char*_tmp12C;void*_tmp12B;(_tmp12B=0,Cyc_Tcutil_terr(loc,((_tmp12C="Invalid region ordering constraint; kind mismatch",
_tag_dyneither(_tmp12C,sizeof(char),50))),_tag_dyneither(_tmp12B,sizeof(void*),0)));}{
# 188
struct Cyc_RgnOrder_RgnPO*_tmp12D;return(_tmp12D=_region_malloc(r,sizeof(*
_tmp12D)),((_tmp12D->d=d,((_tmp12D->these_outlive_heap=Cyc_Absyn_empty_effect,((
_tmp12D->these_outlive_unique=Cyc_Absyn_empty_effect,((_tmp12D->youngest_unresettable=
fst_rgn,_tmp12D)))))))));};}}
# 193
...
effect,((_tmp12E->resetable=0,_tmp12E)))))));}{
# 195
struct Cyc_RgnOrder_RgnPO*_tmp12F;struct Cyc_RgnOrder_RgnPO*_tmp57=(_tmp12F=
_region_malloc(r,sizeof(*_tmp12F)),((_tmp12F->d=d,((_tmp12F->these_outlive_heap=
Cyc_Absyn_empty_effect,((_tmp12F->these_outlive_unique=Cyc_Absyn_empty_effect,((
_tmp12F->youngest_unresettable=fst_rgn,_tmp12F)))))))));
# 196
for(0;po != 0;po=po->tl){
# 197
_tmp57=Cyc_RgnOrder_add_outlives_constraint(r,_tmp57,(*((struct _tuple0*)po->hd)).f1,(*((
struct _tuple0*)po->hd)).f2,loc);}
# 199
return _tmp57;};}
# 224 "/home/jgm/cyclone/src/rgnorder.cyc"
int Cyc_RgnOrder_is_region_resetable(struct Cyc_RgnOrder_RgnPO*po,struct Cyc_Absyn_Tvar*
r){
# 225
return(((struct Cyc_RgnOrder_RgnInfo*(*)(struct Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*
k))Cyc_Dict_lookup)(po->d,r))->resetable;}
# 229
static int Cyc_RgnOrder_contains_rgnseff(struct Cyc_Absyn_Tvar*rgns_of_var,void*
eff){
# 230
void*_tmp59=Cyc_Tcutil_normalize_effect(Cyc_Tcutil_compress(eff));void*_tmp5B;
struct Cyc_List_List*_tmp5D;_LL26: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*
_tmp5A=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmp59;if(_tmp5A->tag != 25)
goto _LL28;else{_tmp5B=(void*)_tmp5A->f1;}}_LL27: {
# 232
void*_tmp5E=Cyc_Tcutil_compress(_tmp5B);struct Cyc_Absyn_Tvar*_tmp60;_LL2D: {
struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp5F=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)
_tmp5E;if(_tmp5F->tag != 2)goto _LL2F;else{_tmp60=_tmp5F->f1;}}_LL2E:
# 233
 return Cyc_Absyn_tvar_cmp(_tmp60,rgns_of_var)== 0;_LL2F:;_LL30:
# 234
 return 0;_LL2C:;}_LL28: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp5C=(
struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmp59;if(_tmp5C->tag != 24)goto _LL2A;
else{_tmp5D=_tmp5C->f1;}}_LL29:
# 237
...
# 241
 return 0;_LL25:;}struct Cyc_RgnOrder_OutlivesEnv{struct _RegionHandle*r;struct Cyc_List_List*
seen;struct Cyc_List_List*todo;};
# 251
static void Cyc_RgnOrder_add_to_search(struct Cyc_RgnOrder_OutlivesEnv*env,void*
eff){
# 252
void*_tmp61=Cyc_Tcutil_compress(eff);void*_tmp63;struct Cyc_Absyn_Tvar*_tmp65;
struct Cyc_List_List*_tmp67;_LL32: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*
_tmp62=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmp61;if(_tmp62->tag != 23)
goto _LL34;else{_tmp63=(void*)_tmp62->f1;{struct Cyc_Absyn_VarType_Absyn_Type_struct*
_tmp64=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp63;if(_tmp64->tag != 2)
goto _LL34;else{_tmp65=_tmp64->f1;}};}}_LL33:
# 254
...
return;}}
# 257
{struct Cyc_List_List*_tmp130;env->seen=((_tmp130=_region_malloc(env->r,sizeof(*
_tmp130)),((_tmp130->hd=_tmp65,((_tmp130->tl=env->seen,_tmp130))))));}
# 258
{struct Cyc_List_List*_tmp131;env->todo=((_tmp131=_region_malloc(env->r,sizeof(*
_tmp131)),((_tmp131->hd=_tmp65,((_tmp131->tl=env->todo,_tmp131))))));}
# 259
return;_LL34: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp66=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)
_tmp61;if(_tmp66->tag != 24)goto _LL36;else{_tmp67=_tmp66->f1;}}_LL35:
# 261
...
# 264
 return;_LL31:;}
# 268
static struct Cyc_RgnOrder_OutlivesEnv Cyc_RgnOrder_initial_env(struct
_RegionHandle*listrgn,struct Cyc_RgnOrder_RgnPO*po,void*rgn){
# 270
struct Cyc_RgnOrder_OutlivesEnv _tmp132;struct Cyc_RgnOrder_OutlivesEnv _tmp6B=(
_tmp132.r=listrgn,((_tmp132.seen=0,((_tmp132.todo=0,_tmp132)))));
# 271
void*r=Cyc_Tcutil_compress(rgn);
# 272
struct Cyc_Absyn_Kind _tmp6D;enum Cyc_Absyn_KindQual _tmp6E;enum Cyc_Absyn_AliasQual
_tmp6F;struct Cyc_Absyn_Kind*_tmp6C=Cyc_Tcutil_typ_kind(r);_tmp6D=*_tmp6C;_tmp6E=
_tmp6D.kind;_tmp6F=_tmp6D.aliasqual;
# 273
...
# 281
 Cyc_RgnOrder_add_to_search(& _tmp6B,po->these_outlive_unique);break;case Cyc_Absyn_Top:
_LL3A:
# 286
 break;}else{
# 290
const char*_tmp135;void*_tmp134;(_tmp134=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp135="RgnOrder: rgn not of correct kind",
_tag_dyneither(_tmp135,sizeof(char),34))),_tag_dyneither(_tmp134,sizeof(void*),0)));}{
# 292
void*_tmp72=r;struct Cyc_Absyn_Tvar*_tmp74;_LL3D: {struct Cyc_Absyn_VarType_Absyn_Type_struct*
_tmp73=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp72;if(_tmp73->tag != 2)
goto _LL3F;else{_tmp74=_tmp73->f1;}}_LL3E:
# 294
{struct Cyc_List_List*_tmp136;_tmp6B.seen=((_tmp136=_region_malloc(listrgn,
sizeof(*_tmp136)),((_tmp136->hd=_tmp74,((_tmp136->tl=_tmp6B.seen,_tmp136))))));}
# 295
{struct Cyc_List_List*_tmp137;_tmp6B.todo=((_tmp137=_region_malloc(listrgn,
sizeof(*_tmp137)),((_tmp137->hd=_tmp74,((_tmp137->tl=_tmp6B.todo,_tmp137))))));}
# 296
goto _LL40;_LL3F:;_LL40:
# 297
 return _tmp6B;_LL3C:;};}
# 303
static int Cyc_RgnOrder_atomic_effect_outlives(struct Cyc_RgnOrder_RgnPO*po,void*
eff,void*rgn){
# 304
struct _RegionHandle _tmp78=_new_region("listrgn");struct _RegionHandle*listrgn=&
_tmp78;_push_region(listrgn);
# 305
{void*_tmp79=Cyc_Tcutil_compress(eff);void*_tmp7B;void*_tmp7D;_LL42: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*
_tmp7A=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmp79;if(_tmp7A->tag != 23)
goto _LL44;else{_tmp7B=(void*)_tmp7A->f1;}}_LL43: {
# 308
void*_tmp7E=Cyc_Tcutil_compress(_tmp7B);struct Cyc_Absyn_Tvar*_tmp83;_LL49: {
struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*_tmp7F=(struct Cyc_Absyn_UniqueRgn_Absyn_Type_struct*)
_tmp7E;if(_tmp7F->tag != 21)goto _LL4B;}_LL4A: {
# 311
...
_tmp85=*_tmp84;_tmp86=_tmp85.kind;_tmp87=_tmp85.aliasqual;{
# 312
int _tmp88=_tmp86 == Cyc_Absyn_RgnKind  && _tmp87 != Cyc_Absyn_Top;_npop_handler(0);
return _tmp88;};}_LL4B: {struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*_tmp80=(
struct Cyc_Absyn_RefCntRgn_Absyn_Type_struct*)_tmp7E;if(_tmp80->tag != 22)goto
_LL4D;}_LL4C:
# 316
 if(Cyc_Tcutil_compress(rgn)== (void*)& Cyc_Absyn_RefCntRgn_val){int _tmp89=1;
_npop_handler(0);return _tmp89;}
# 317
goto _LL4E;_LL4D: {struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*_tmp81=(struct Cyc_Absyn_HeapRgn_Absyn_Type_struct*)
_tmp7E;if(_tmp81->tag != 20)goto _LL4F;}_LL4E: {
# 320
struct Cyc_Absyn_Kind _tmp8B;enum Cyc_Absyn_KindQual _tmp8C;enum Cyc_Absyn_AliasQual
_tmp8D;struct Cyc_Absyn_Kind*_tmp8A=Cyc_Tcutil_typ_kind(Cyc_Tcutil_compress(rgn));
_tmp8B=*_tmp8A;_tmp8C=_tmp8B.kind;_tmp8D=_tmp8B.aliasqual;{
# 321
int _tmp8E=_tmp8C == Cyc_Absyn_RgnKind  && _tmp8D == Cyc_Absyn_Aliasable;
_npop_handler(0);return _tmp8E;};}_LL4F: {struct Cyc_Absyn_VarType_Absyn_Type_struct*
_tmp82=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp7E;if(_tmp82->tag != 2)
goto _LL51;else{_tmp83=_tmp82->f1;}}_LL50: {
# 330
struct Cyc_RgnOrder_OutlivesEnv _tmp8F=Cyc_RgnOrder_initial_env(listrgn,po,rgn);
# 331
while(_tmp8F.todo != 0){
# 332
struct Cyc_Absyn_Tvar*_tmp90=(struct Cyc_Absyn_Tvar*)((struct Cyc_List_List*)
_check_null(_tmp8F.todo))->hd;
# 333
...
# 344
if(((int(*)(struct Cyc_Dict_Dict d,struct Cyc_Absyn_Tvar*k))Cyc_Dict_member)(po->d,
_tmp90))
# 348
Cyc_RgnOrder_add_to_search(& _tmp8F,(((struct Cyc_RgnOrder_RgnInfo*(*)(struct Cyc_Dict_Dict
d,struct Cyc_Absyn_Tvar*k))Cyc_Dict_lookup)(po->d,_tmp90))->these_outlive);else{
# 350
struct Cyc_String_pa_PrintArg_struct _tmp13F;void*_tmp13E[1];const char*_tmp13D;
void*_tmp13C;(_tmp13C=0,((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))
Cyc_Tcutil_impos)((struct _dyneither_ptr)((_tmp13F.tag=0,((_tmp13F.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*_tmp83->name),((_tmp13E[0]=& _tmp13F,Cyc_aprintf(((
_tmp13D="RgnOrder: type variable %s not in dict",_tag_dyneither(_tmp13D,sizeof(
char),39))),_tag_dyneither(_tmp13E,sizeof(void*),1)))))))),_tag_dyneither(
_tmp13C,sizeof(void*),0)));}}{
# 352
int _tmp96=0;_npop_handler(0);return _tmp96;};}_LL51:;_LL52: {
# 353
int _tmp97=0;_npop_handler(0);return _tmp97;}_LL48:;}_LL44: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*
_tmp7C=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmp79;if(_tmp7C->tag != 25)
goto _LL46;else{_tmp7D=(void*)_tmp7C->f1;}}_LL45: {
# 356
void*_tmp98=Cyc_Tcutil_compress(_tmp7D);struct Cyc_Absyn_Tvar*_tmp9A;_LL54: {
struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp99=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)
_tmp98;if(_tmp99->tag != 2)goto _LL56;else{_tmp9A=_tmp99->f1;}}_LL55: {
# 362
struct Cyc_RgnOrder_OutlivesEnv _tmp9B=Cyc_RgnOrder_initial_env(listrgn,po,rgn);
# 363
struct Cyc_Absyn_Kind _tmp9D;enum Cyc_Absyn_KindQual _tmp9E;enum Cyc_Absyn_AliasQual
_tmp9F;struct Cyc_Absyn_Kind*_tmp9C=Cyc_Tcutil_typ_kind(rgn);_tmp9D=*_tmp9C;
_tmp9E=_tmp9D.kind;_tmp9F=_tmp9D.aliasqual;
# 365
...
while(_tmp9B.todo != 0){
# 377
struct Cyc_Absyn_Tvar*_tmpA2=(struct Cyc_Absyn_Tvar*)((struct Cyc_List_List*)
_check_null(_tmp9B.todo))->hd;
# 378
...
k))Cyc_Dict_lookup)(po->d,_tmpA2))->these_outlive;
# 381
...
# 384
const char*_tmp142;void*_tmp141;(_tmp141=0,((int(*)(struct _dyneither_ptr fmt,
struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp142="RgnOrder: type variable not in dict",
...
eff=Cyc_Tcutil_normalize_effect(eff);{
# 398
void*_tmpAA=Cyc_Tcutil_compress(eff);struct Cyc_List_List*_tmpAC;_LL59: {struct
Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmpAB=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)
_tmpAA;if(_tmpAB->tag != 24)goto _LL5B;else{_tmpAC=_tmpAB->f1;}}_LL5A:
# 400
...
eff=Cyc_Tcutil_normalize_effect(eff);{
# 411
void*_tmpAD=Cyc_Tcutil_compress(eff);struct Cyc_List_List*_tmpAF;void*_tmpB1;
void*_tmpB3;_LL5E: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmpAE=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)
_tmpAD;if(_tmpAE->tag != 24)goto _LL60;else{_tmpAF=_tmpAE->f1;}}_LL5F:
# 413
 for(0;_tmpAF != 0;_tmpAF=_tmpAF->tl){
# 414
Cyc_RgnOrder_pin_effect((void*)_tmpAF->hd,bd);}
# 415
return;_LL60: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*_tmpB0=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)
_tmpAD;if(_tmpB0->tag != 25)goto _LL62;else{_tmpB1=(void*)_tmpB0->f1;}}_LL61: {
# 417
void*_tmpB5=Cyc_Tcutil_compress(_tmpB1);_LL69: {struct Cyc_Absyn_Evar_Absyn_Type_struct*
_tmpB6=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmpB5;if(_tmpB6->tag != 1)goto
_LL6B;}_LL6A:
# 418
 Cyc_Tcutil_unify(_tmpB1,Cyc_Absyn_uint_typ);return;_LL6B:;_LL6C:
# 419
 return;_LL68:;}_LL62: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmpB2=(
struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)_tmpAD;if(_tmpB2->tag != 23)goto
_LL64;else{_tmpB3=(void*)_tmpB2->f1;}}_LL63: {
# 422
void*_tmpB7=Cyc_Tcutil_compress(_tmpB3);_LL6E: {struct Cyc_Absyn_Evar_Absyn_Type_struct*
_tmpB8=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmpB7;if(_tmpB8->tag != 1)goto
_LL70;}_LL6F:
# 423
 Cyc_Tcutil_unify(_tmpB3,bd);return;_LL70:;_LL71:
# 424
 return;_LL6D:;}_LL64: {struct Cyc_Absyn_Evar_Absyn_Type_struct*_tmpB4=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)
_tmpAD;if(_tmpB4->tag != 1)goto _LL66;}_LL65:
# 426
 Cyc_Tcutil_unify(eff,Cyc_Absyn_empty_effect);return;_LL66:;_LL67:
# 427
 return;_LL5D:;};}
# 441 "/home/jgm/cyclone/src/rgnorder.cyc"
int Cyc_RgnOrder_satisfies_constraints(struct Cyc_RgnOrder_RgnPO*po,struct Cyc_List_List*
constraints,void*default_bound,int do_pin){
# 444
{struct Cyc_List_List*_tmpB9=constraints;for(0;_tmpB9 != 0;_tmpB9=_tmpB9->tl){
# 445
struct _tuple0 _tmpBB;void*_tmpBC;struct _tuple0*_tmpBA=(struct _tuple0*)_tmpB9->hd;
_tmpBB=*_tmpBA;_tmpBC=_tmpBB.f2;{
# 446
void*_tmpBD=Cyc_Tcutil_compress(_tmpBC);_LL73: {struct Cyc_Absyn_Evar_Absyn_Type_struct*
_tmpBE=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmpBD;if(_tmpBE->tag != 1)goto
_LL75;}_LL74:
# 448
 if(do_pin)
# 449
...
# 455
struct _tuple0 _tmpC1;void*_tmpC2;void*_tmpC3;struct _tuple0*_tmpC0=(struct _tuple0*)
_tmpBF->hd;_tmpC1=*_tmpC0;_tmpC2=_tmpC1.f1;_tmpC3=_tmpC1.f2;
# 456
if(do_pin)
# 457
...
# 467
void*_tmpC4=eff2;struct Cyc_List_List*_tmpC6;void*_tmpC8;void*_tmpCA;_LL78: {
struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmpC5=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)
_tmpC4;if(_tmpC5->tag != 24)goto _LL7A;else{_tmpC6=_tmpC5->f1;}}_LL79:
# 469
...
return 1;}
# 472
return 0;_LL7A: {struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmpC7=(struct Cyc_Absyn_AccessEff_Absyn_Type_struct*)
_tmpC4;if(_tmpC7->tag != 23)goto _LL7C;else{_tmpC8=(void*)_tmpC7->f1;}}_LL7B:
# 473
 return Cyc_RgnOrder_effect_outlives(po,eff1,_tmpC8);_LL7C: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*
_tmpC9=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmpC4;if(_tmpC9->tag != 25)
goto _LL7E;else{_tmpCA=(void*)_tmpC9->f1;}}_LL7D: {
# 475
void*_tmpCB=eff1;void*_tmpCD;_LL81: {struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*
_tmpCC=(struct Cyc_Absyn_RgnsEff_Absyn_Type_struct*)_tmpCB;if(_tmpCC->tag != 25)
goto _LL83;else{_tmpCD=(void*)_tmpCC->f1;}}_LL82:
# 477
{struct _tuple0 _tmp143;struct _tuple0 _tmpCF=(_tmp143.f1=Cyc_Tcutil_compress(
_tmpCA),((_tmp143.f2=Cyc_Tcutil_compress(_tmpCD),_tmp143)));void*_tmpD0;struct
Cyc_Absyn_Tvar*_tmpD2;void*_tmpD3;struct Cyc_Absyn_Tvar*_tmpD5;_LL86: _tmpD0=
_tmpCF.f1;{struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmpD1=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)
_tmpD0;if(_tmpD1->tag != 2)goto _LL88;else{_tmpD2=_tmpD1->f1;}};_tmpD3=_tmpCF.f2;{
struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmpD4=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)
_tmpD3;if(_tmpD4->tag != 2)goto _LL88;else{_tmpD5=_tmpD4->f1;}};_LL87:
# 478
...
# 490
void*_tmpD6=eff1;struct Cyc_List_List*_tmpD8;_LL8B: {struct Cyc_Absyn_JoinEff_Absyn_Type_struct*
_tmpD7=(struct Cyc_Absyn_JoinEff_Absyn_Type_struct*)_tmpD6;if(_tmpD7->tag != 24)
goto _LL8D;else{_tmpD8=_tmpD7->f1;}}_LL8C:
# 492
...
# 496
 return Cyc_RgnOrder_eff_outlives_atomic_eff(po,eff1,eff2);_LL8A:;};}struct
_tuple11{struct Cyc_Absyn_Tvar*f1;struct Cyc_RgnOrder_RgnInfo*f2;};
# 501
void Cyc_RgnOrder_print_region_po(struct Cyc_RgnOrder_RgnPO*po){
# 502
struct _RegionHandle _tmpD9=_new_region("r");struct _RegionHandle*r=& _tmpD9;
_push_region(r);
# 503
{struct Cyc_Iter_Iter iter=((struct Cyc_Iter_Iter(*)(struct _RegionHandle*rgn,
struct Cyc_Dict_Dict d))Cyc_Dict_make_iter)(r,po->d);
# 504
struct _tuple11 _tmpDA=*((struct _tuple11*(*)(struct _RegionHandle*,struct Cyc_Dict_Dict
d))Cyc_Dict_rchoose)(r,po->d);
# 505
...
# 507
const char*_tmp14B;void*_tmp14A[2];struct Cyc_String_pa_PrintArg_struct _tmp149;
struct Cyc_String_pa_PrintArg_struct _tmp148;(_tmp148.tag=0,((_tmp148.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)
# 508
Cyc_Absynpp_typ2string((_tmpDA.f2)->these_outlive)),((_tmp149.tag=0,((_tmp149.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)*(_tmpDA.f1)->name),((_tmp14A[0]=&
_tmp149,((_tmp14A[1]=& _tmp148,Cyc_fprintf(Cyc_stderr,((_tmp14B="  %s outlived by %s\n",
_tag_dyneither(_tmp14B,sizeof(char),21))),_tag_dyneither(_tmp14A,sizeof(void*),2)))))))))))));}
# 510
{const char*_tmp14F;void*_tmp14E[1];struct Cyc_String_pa_PrintArg_struct _tmp14D;(
_tmp14D.tag=0,((_tmp14D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 511
Cyc_Absynpp_typ2string(po->these_outlive_heap)),((_tmp14E[0]=& _tmp14D,Cyc_fprintf(
Cyc_stderr,((_tmp14F="  these outlive heap: %s\n",_tag_dyneither(_tmp14F,sizeof(
char),26))),_tag_dyneither(_tmp14E,sizeof(void*),1)))))));}{
# 512
const char*_tmp153;void*_tmp152[1];struct Cyc_String_pa_PrintArg_struct _tmp151;(
_tmp151.tag=0,((_tmp151.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
# 513
Cyc_Absynpp_typ2string(po->these_outlive_unique)),((_tmp152[0]=& _tmp151,Cyc_fprintf(
Cyc_stderr,((_tmp153="  these outlive unique: %s\n",_tag_dyneither(_tmp153,
sizeof(char),28))),_tag_dyneither(_tmp152,sizeof(void*),1)))))));};}
# 503
;_pop_region(r);}
