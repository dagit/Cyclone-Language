...
if(ns == 0)return tds;{
struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*_tmp359;struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct _tmp358;struct Cyc_List_List*_tmp357;return(_tmp357=_cycalloc(sizeof(*_tmp357)),((_tmp357->hd=Cyc_Absyn_new_decl((void*)((_tmp359=_cycalloc(sizeof(*_tmp359)),((_tmp359[0]=((_tmp358.tag=10,((_tmp358.f1=(struct _dyneither_ptr*)ns->hd,((_tmp358.f2=Cyc_Interface_add_namespace(tds,ns->tl),_tmp358)))))),_tmp359)))),0),((_tmp357->tl=0,_tmp357)))));};}
# 1047
...
struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp35F;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct _tmp35E;struct Cyc_List_List*_tmp35D;return(_tmp35D=_cycalloc(sizeof(*_tmp35D)),((_tmp35D->hd=Cyc_Absyn_new_decl((void*)((_tmp35F=_cycalloc(sizeof(*_tmp35F)),((_tmp35F[0]=((_tmp35E.tag=6,((_tmp35E.f1=d,_tmp35E)))),_tmp35F)))),0),((_tmp35D->tl=tds,_tmp35D)))));}
# 1051
...
struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp366;struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct _tmp365;struct Cyc_List_List*_tmp364;return(_tmp364=_cycalloc(sizeof(*_tmp364)),((_tmp364->hd=Cyc_Absyn_new_decl((void*)((_tmp366=_cycalloc(sizeof(*_tmp366)),((_tmp366[0]=((_tmp365.tag=6,((_tmp365.f1=d,_tmp365)))),_tmp366)))),0),((_tmp364->tl=tds,_tmp364)))));};}
# 1059
...
# 1100
struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*_tmp392;struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct _tmp391;struct Cyc_List_List*_tmp390;return(_tmp390=_cycalloc(sizeof(*_tmp390)),((_tmp390->hd=Cyc_Absyn_new_decl((void*)((_tmp392=_cycalloc(sizeof(*_tmp392)),((_tmp392[0]=((_tmp391.tag=9,((_tmp391.f1=d,_tmp391)))),_tmp392)))),0),((_tmp390->tl=tds,_tmp390)))));}
# 1103
...
struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp3A2;struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct _tmp3A1;struct Cyc_List_List*_tmp3A0;return(_tmp3A0=_cycalloc(sizeof(*_tmp3A0)),((_tmp3A0->hd=Cyc_Absyn_new_decl((void*)((_tmp3A2=_cycalloc(sizeof(*_tmp3A2)),((_tmp3A2[0]=((_tmp3A1.tag=7,((_tmp3A1.f1=_tmp22A,_tmp3A1)))),_tmp3A2)))),0),((_tmp3A0->tl=tds,_tmp3A0)))));};}
# 1116
...
struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp3AC;struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct _tmp3AB;struct Cyc_List_List*_tmp3AA;return(_tmp3AA=_cycalloc(sizeof(*_tmp3AA)),((_tmp3AA->hd=Cyc_Absyn_new_decl((void*)((_tmp3AC=_cycalloc(sizeof(*_tmp3AC)),((_tmp3AC[0]=((_tmp3AB.tag=7,((_tmp3AB.f1=_tmp233,_tmp3AB)))),_tmp3AC)))),0),((_tmp3AA->tl=tds,_tmp3AA)))));};}
# 1127
