...
Cyc_Dict_Dict skel){struct Cyc_Interface_I*_tmp25F;return(_tmp25F=_cycalloc(
...
struct Cyc_Interface_I*_tmp260;return(_tmp260=_cycalloc(sizeof(*_tmp260)),((
...
_tmp268)))));struct Cyc_List_List*_tmp273;struct _tuple7*_tmp272;struct _tuple7*
_tmp271;struct Cyc_List_List*_tmp270;struct Cyc_Absyn_Vardecl*_tmpC=Cyc_Absyn_new_vardecl(
qmain,Cyc_Absyn_function_typ(0,0,Cyc_Absyn_sint_typ,((_tmp270=_cycalloc(sizeof(*
_tmp270)),((_tmp270->hd=((_tmp271=_cycalloc(sizeof(*_tmp271)),((_tmp271->f1=0,((
_tmp271->f2=Cyc_Absyn_empty_tqual(0),((_tmp271->f3=Cyc_Absyn_uint_typ,_tmp271)))))))),((
_tmp270->tl=((_tmp273=_cycalloc(sizeof(*_tmp273)),((_tmp273->hd=((_tmp272=
_cycalloc(sizeof(*_tmp272)),((_tmp272->f1=0,((_tmp272->f2=Cyc_Absyn_empty_tqual(
0),((_tmp272->f3=Cyc_Absyn_dyneither_typ(Cyc_Absyn_dyneither_typ(Cyc_Absyn_char_typ,(
...
static void Cyc_Interface_err(struct _dyneither_ptr msg){void*_tmp274;(_tmp274=0,Cyc_Tcutil_terr(
0,msg,_tag_dyneither(_tmp274,sizeof(void*),0)));}static void*Cyc_Interface_invalid_arg(
struct _dyneither_ptr s);static void*Cyc_Interface_invalid_arg(struct _dyneither_ptr
s){struct Cyc_Core_Invalid_argument_struct _tmp277;struct Cyc_Core_Invalid_argument_struct*
_tmp276;(int)_throw((void*)((_tmp276=_cycalloc(sizeof(*_tmp276)),((_tmp276[0]=((
...
struct _dyneither_ptr t,struct _tuple0*n){const char*_tmp27D;void*_tmp27C[3];struct
Cyc_String_pa_struct _tmp27B;struct Cyc_String_pa_struct _tmp27A;struct Cyc_String_pa_struct
_tmp279;Cyc_Interface_err((struct _dyneither_ptr)((_tmp279.tag=0,((_tmp279.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(n)),((
_tmp27A.tag=0,((_tmp27A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t),((
...
_tmp282;void*_tmp281[2];struct Cyc_String_pa_struct _tmp280;struct Cyc_String_pa_struct
...
char*_tmp289;void*_tmp288[4];struct Cyc_String_pa_struct _tmp287;struct Cyc_String_pa_struct
_tmp286;struct Cyc_String_pa_struct _tmp285;struct Cyc_String_pa_struct _tmp284;Cyc_Interface_err((
struct _dyneither_ptr)((_tmp284.tag=0,((_tmp284.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_qvar2string(name2)),((_tmp285.tag=0,((_tmp285.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)obj2),((_tmp286.tag=0,((_tmp286.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(name1)),((
_tmp287.tag=0,((_tmp287.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)obj1),((
_tmp288[0]=& _tmp287,((_tmp288[1]=& _tmp286,((_tmp288[2]=& _tmp285,((_tmp288[3]=&
_tmp284,Cyc_aprintf(((_tmp289="declaration of %s %s relies on static %s %s",
_tag_dyneither(_tmp289,sizeof(char),44))),_tag_dyneither(_tmp288,sizeof(void*),4)))))))))))))))))))))))))));}}
...
struct _dyneither_ptr obj1,struct _tuple0*name1,struct _dyneither_ptr obj2,struct
_tuple0*name2){if((char*)obj1.curr != (char*)(_tag_dyneither(0,0,0)).curr){const
char*_tmp290;void*_tmp28F[4];struct Cyc_String_pa_struct _tmp28E;struct Cyc_String_pa_struct
_tmp28D;struct Cyc_String_pa_struct _tmp28C;struct Cyc_String_pa_struct _tmp28B;Cyc_Interface_err((
struct _dyneither_ptr)((_tmp28B.tag=0,((_tmp28B.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_qvar2string(name2)),((_tmp28C.tag=0,((_tmp28C.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)obj2),((_tmp28D.tag=0,((_tmp28D.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(name1)),((
_tmp28E.tag=0,((_tmp28E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)obj1),((
_tmp28F[0]=& _tmp28E,((_tmp28F[1]=& _tmp28D,((_tmp28F[2]=& _tmp28C,((_tmp28F[3]=&
_tmp28B,Cyc_aprintf(((_tmp290="declaration of %s %s relies on fields of abstract %s %s",
_tag_dyneither(_tmp290,sizeof(char),56))),_tag_dyneither(_tmp28F,sizeof(void*),4)))))))))))))))))))))))))));}}
...
Cyc_Absyn_qvar_cmp),_tmp291)))));}static int Cyc_Interface_check_public_type(
...
seen,struct Cyc_Absyn_Vardecl*d){const char*_tmp294;return Cyc_Interface_check_public_type(
ae,seen,((_tmp294="variable",_tag_dyneither(_tmp294,sizeof(char),9))),d->name,d->type);}
...
_tmp45.Abs_n).val;_LLC: return _tmp46;_LLD: if((_tmp45.C_n).tag != 3)goto _LLF;_tmp47=(
struct Cyc_List_List*)(_tmp45.C_n).val;_LLE: return _tmp47;_LLF:;_LL10: {const char*
_tmp295;((int(*)(struct _dyneither_ptr s))Cyc_Interface_invalid_arg)(((_tmp295="get_abs_ns",
_tag_dyneither(_tmp295,sizeof(char),11))));}_LLA:;}static int Cyc_Interface_check_public_type(
struct Cyc_Dict_Dict ae,struct Cyc_Interface_Seen*seen,struct _dyneither_ptr obj,
struct _tuple0*name,void*t);static int Cyc_Interface_check_public_type(struct Cyc_Dict_Dict
...
_LL25: return 1;_LL11:;}struct _tuple17{struct Cyc_Interface_Ienv*f1;struct Cyc_Interface_Ienv*
...
_tuple17 _tmpAD;struct Cyc_Interface_Ienv*_tmpAE;struct Cyc_Interface_Ienv*_tmpAF;
int _tmpB0;struct Cyc_Dict_Dict _tmpB1;struct Cyc_Interface_Seen*_tmpB2;struct
_tuple17*_tmpAC=env;_tmpAD=*_tmpAC;_tmpAE=_tmpAD.f1;_tmpAF=_tmpAD.f2;_tmpB0=
_tmpAD.f3;_tmpB1=_tmpAD.f4;_tmpB2=_tmpAD.f5;{struct Cyc_Absyn_Aggrdecl*_tmpB3=*dp;
switch(_tmpB3->sc){case Cyc_Absyn_Static: _LL35: if(_tmpB0  && _tmpB3->impl == 0){
const char*_tmp2B4;const char*_tmp2B3;Cyc_Interface_fields_err(((_tmp2B3="static",
_tag_dyneither(_tmp2B3,sizeof(char),7))),((_tmp2B4="struct/union",_tag_dyneither(
_tmp2B4,sizeof(char),13))),_tmpB3->name);}break;case Cyc_Absyn_Abstract: _LL36: if(
_tmpB3->impl == 0){if(_tmpB0){const char*_tmp2B6;const char*_tmp2B5;Cyc_Interface_fields_err(((
...
_tmpBE;struct Cyc_Interface_Ienv*_tmpBF;struct Cyc_Interface_Ienv*_tmpC0;int _tmpC1;
struct Cyc_Dict_Dict _tmpC2;struct Cyc_Interface_Seen*_tmpC3;struct _tuple17*_tmpBD=
env;_tmpBE=*_tmpBD;_tmpBF=_tmpBE.f1;_tmpC0=_tmpBE.f2;_tmpC1=_tmpBE.f3;_tmpC2=
_tmpBE.f4;_tmpC3=_tmpBE.f5;{struct Cyc_Absyn_Enumdecl*_tmpC4=*dp;switch(_tmpC4->sc){
case Cyc_Absyn_Static: _LL3C: if(_tmpC1  && _tmpC4->fields == 0){const char*_tmp2BD;
const char*_tmp2BC;Cyc_Interface_fields_err(((_tmp2BC="static",_tag_dyneither(
_tmp2BC,sizeof(char),7))),((_tmp2BD="enum",_tag_dyneither(_tmp2BD,sizeof(char),5))),
_tmpC4->name);}break;case Cyc_Absyn_Abstract: _LL3D: if(_tmpC4->fields == 0){if(
_tmpC1){const char*_tmp2BF;const char*_tmp2BE;Cyc_Interface_fields_err(((_tmp2BE="abstract",
_tag_dyneither(_tmp2BE,sizeof(char),9))),((_tmp2BF="enum",_tag_dyneither(_tmp2BF,
sizeof(char),5))),_tmpC4->name);}}else{{struct Cyc_Absyn_Enumdecl*_tmp2C0;_tmpC4=((
_tmp2C0=_cycalloc(sizeof(*_tmp2C0)),((_tmp2C0[0]=*_tmpC4,_tmp2C0))));}_tmpC4->fields=
0;}if(Cyc_Interface_check_public_enumdecl(_tmpC2,_tmpC3,_tmpC4))_tmpC0->enumdecls=((
struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Enumdecl*
v))Cyc_Dict_insert)(_tmpC0->enumdecls,x,_tmpC4);break;case Cyc_Absyn_Public: _LL3E:
if(_tmpC4->fields == 0){{const char*_tmp2C2;const char*_tmp2C1;Cyc_Interface_fields_err(((
_tmp2C1="public",_tag_dyneither(_tmp2C1,sizeof(char),7))),((_tmp2C2="enum",
_tag_dyneither(_tmp2C2,sizeof(char),5))),_tmpC4->name);}{struct Cyc_Absyn_Enumdecl*
_tmp2C3;_tmpC4=((_tmp2C3=_cycalloc(sizeof(*_tmp2C3)),((_tmp2C3[0]=*_tmpC4,
_tmp2C3))));}_tmpC4->sc=Cyc_Absyn_Abstract;}if(Cyc_Interface_check_public_enumdecl(
...
f){struct Cyc_List_List*_tmpCE=0;{union Cyc_Absyn_Nmspace _tmpCF=(*f->name).f1;
struct Cyc_List_List*_tmpD0;struct Cyc_List_List*_tmpD1;struct Cyc_List_List*_tmpD2;
_LL44: if((_tmpCF.Rel_n).tag != 1)goto _LL46;_tmpD0=(struct Cyc_List_List*)(_tmpCF.Rel_n).val;
_LL45: _tmpD1=_tmpD0;goto _LL47;_LL46: if((_tmpCF.Abs_n).tag != 2)goto _LL48;_tmpD1=(
struct Cyc_List_List*)(_tmpCF.Abs_n).val;_LL47: _tmpCE=_tmpD1;goto _LL43;_LL48: if((
_tmpCF.C_n).tag != 3)goto _LL4A;_tmpD2=(struct Cyc_List_List*)(_tmpCF.C_n).val;
_LL49: _tmpCE=_tmpD2;goto _LL43;_LL4A:;_LL4B: goto _LL43;_LL43:;}{struct Cyc_Dict_Dict*
dict;switch(f->sc){case Cyc_Absyn_Static: _LL4C: return;case Cyc_Absyn_Extern: _LL4D:
dict=& i->imports;break;case Cyc_Absyn_Public: _LL4E: dict=& i->exports;break;
default: _LL4F: {const char*_tmp2C5;((int(*)(struct _dyneither_ptr s))Cyc_Interface_invalid_arg)(((
...
struct _tuple17 _tmpDC;struct Cyc_Interface_Ienv*_tmpDD;struct Cyc_Interface_Ienv*
_tmpDE;int _tmpDF;struct Cyc_Dict_Dict _tmpE0;struct Cyc_Interface_Seen*_tmpE1;
struct Cyc_Interface_I*_tmpE2;struct _tuple17*_tmpDB=env;_tmpDC=*_tmpDB;_tmpDD=
...
_tmp2CB=_cycalloc(sizeof(*_tmp2CB)),((_tmp2CB[0]=*_tmpE3,_tmp2CB))));}_tmpE3->fields=
0;}if(Cyc_Interface_check_public_datatypedecl(_tmpE0,_tmpE1,_tmpE3))_tmpDE->datatypedecls=((
struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Datatypedecl*
v))Cyc_Dict_insert)(_tmpDE->datatypedecls,x,_tmpE3);break;case Cyc_Absyn_Public:
_LL58:{struct Cyc_Absyn_Datatypedecl*_tmp2CC;_tmpE3=((_tmp2CC=_cycalloc(sizeof(*
_tmp2CC)),((_tmp2CC[0]=*_tmpE3,_tmp2CC))));}if(!_tmpE3->is_extensible  && _tmpE3->fields
== 0){{const char*_tmp2CE;const char*_tmp2CD;Cyc_Interface_fields_err(((_tmp2CD="public",
...
_tuple17 _tmpF4;struct Cyc_Interface_Ienv*_tmpF5;struct Cyc_Dict_Dict _tmpF6;struct
Cyc_Interface_Seen*_tmpF7;struct _tuple17*_tmpF3=env;_tmpF4=*_tmpF3;_tmpF5=_tmpF4.f2;
...
struct _tuple17*env,struct _dyneither_ptr*x,struct _tuple18*v){struct _tuple17 _tmpF9;
struct Cyc_Interface_Ienv*_tmpFA;struct Cyc_Interface_Ienv*_tmpFB;int _tmpFC;struct
Cyc_Dict_Dict _tmpFD;struct Cyc_Interface_Seen*_tmpFE;struct _tuple17*_tmpF8=env;
...
goto _LL62;_LL62:;}goto _LL5D;_LL60:;_LL61: goto _LL5D;_LL5D:;};}struct _tuple19{
...
struct Cyc_List_List*ns,struct Cyc_Tcenv_Genv*ge){struct _tuple19 _tmp10F;struct Cyc_Interface_I*
_tmp110;int _tmp111;struct Cyc_Dict_Dict _tmp112;struct Cyc_Interface_Seen*_tmp113;
struct _tuple19*_tmp10E=env_f;_tmp10F=*_tmp10E;_tmp110=_tmp10F.f1;_tmp111=_tmp10F.f2;
_tmp112=_tmp10F.f3;_tmp113=_tmp10F.f4;{struct _tuple17 _tmp2D7;struct _tuple17
...
_tmp110,_tmp2D7)))))))))));((void(*)(void(*f)(struct _tuple17*,struct
...
_tmp114,ge->datatypedecls);((void(*)(void(*f)(struct _tuple17*,struct
...
_tmp114,ge->typedefs);((void(*)(void(*f)(struct _tuple17*,struct _dyneither_ptr*,
...
struct Cyc_Dict_Dict ae,int check_complete_defs){struct _tuple19 _tmp2D8;struct
_tuple19 env=(_tmp2D8.f1=((struct Cyc_Interface_I*(*)(struct Cyc_Dict_Dict skel))Cyc_Interface_skel2i)(
ae),((_tmp2D8.f2=check_complete_defs,((_tmp2D8.f3=ae,((_tmp2D8.f4=Cyc_Interface_new_seen(),
_tmp2D8)))))));((void(*)(void(*f)(struct _tuple19*,struct Cyc_List_List*,struct Cyc_Tcenv_Genv*),
...
msg1,struct _dyneither_ptr msg2){const char*_tmp2DC;void*_tmp2DB[1];struct Cyc_String_pa_struct
_tmp2DA;(_tmp2DA.tag=0,((_tmp2DA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
msg2),((_tmp2DB[0]=& _tmp2DA,Cyc_Tcdecl_merr(0,msg1,((_tmp2DC="%s",_tag_dyneither(
_tmp2DC,sizeof(char),3))),_tag_dyneither(_tmp2DB,sizeof(void*),1)))))));}struct
...
struct _tuple20*env,struct _dyneither_ptr*x,void*y1){struct _tuple20 _tmp11B;int
_tmp11C;int*_tmp11D;struct Cyc_Dict_Dict _tmp11E;int(*_tmp11F)(void*,void*,struct
_dyneither_ptr*);struct _dyneither_ptr _tmp120;struct _dyneither_ptr*_tmp121;struct
_tuple20*_tmp11A=env;_tmp11B=*_tmp11A;_tmp11C=_tmp11B.f1;_tmp11D=(int*)&(*
_tmp11A).f1;_tmp11E=_tmp11B.f2;_tmp11F=_tmp11B.f3;_tmp120=_tmp11B.f4;_tmp121=
_tmp11B.f5;{struct _handler_cons _tmp122;_push_handler(& _tmp122);{int _tmp124=0;if(
setjmp(_tmp122.handler))_tmp124=1;if(!_tmp124){{void*_tmp125=((void*(*)(struct
Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp11E,x);if(!_tmp11F(
y1,_tmp125,_tmp121))*_tmp11D=0;};_pop_handler();}else{void*_tmp123=(void*)
_exn_thrown;void*_tmp127=_tmp123;_LL71: {struct Cyc_Dict_Absent_struct*_tmp128=(
struct Cyc_Dict_Absent_struct*)_tmp127;if(_tmp128->tag != Cyc_Dict_Absent)goto
_LL73;}_LL72:{const char*_tmp2E1;void*_tmp2E0[2];struct Cyc_String_pa_struct
_tmp2DF;struct Cyc_String_pa_struct _tmp2DE;Cyc_Interface_check_err(_tmp121,(
struct _dyneither_ptr)((_tmp2DE.tag=0,((_tmp2DE.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*x),((_tmp2DF.tag=0,((_tmp2DF.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)_tmp120),((_tmp2E0[0]=& _tmp2DF,((_tmp2E0[1]=& _tmp2DE,Cyc_aprintf(((
_tmp2E1="%s %s is missing",_tag_dyneither(_tmp2E1,sizeof(char),17))),
_tag_dyneither(_tmp2E0,sizeof(void*),2)))))))))))))));}*_tmp11D=0;goto _LL70;
_LL73:;_LL74:(void)_throw(_tmp127);_LL70:;}};};}static int Cyc_Interface_incl_dict(
...
_tmp2E2;struct _tuple20 _tmp12D=(_tmp2E2.f1=1,((_tmp2E2.f2=dic2,((_tmp2E2.f3=
...
_tmp12F=Cyc_Tcdecl_merge_aggrdecl(d0,d1,0,msg);if(_tmp12F == 0)return 0;if((struct
Cyc_Absyn_Aggrdecl*)d0 != _tmp12F){{const char*_tmp2E6;void*_tmp2E5[1];struct Cyc_String_pa_struct
_tmp2E4;Cyc_Interface_check_err(msg,(struct _dyneither_ptr)((_tmp2E4.tag=0,((
_tmp2E4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
d1->name)),((_tmp2E5[0]=& _tmp2E4,Cyc_aprintf(((_tmp2E6="declaration of type %s discloses too much information",
...
_dyneither_ptr*msg){struct Cyc_Absyn_Datatypedecl*_tmp133=Cyc_Tcdecl_merge_datatypedecl(
d0,d1,0,msg);if(_tmp133 == 0)return 0;if((struct Cyc_Absyn_Datatypedecl*)d0 != 
_tmp133){{const char*_tmp2EA;void*_tmp2E9[1];struct Cyc_String_pa_struct _tmp2E8;
Cyc_Interface_check_err(msg,(struct _dyneither_ptr)((_tmp2E8.tag=0,((_tmp2E8.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(d1->name)),((
_tmp2E9[0]=& _tmp2E8,Cyc_aprintf(((_tmp2EA="declaration of datatype %s discloses too much information",
...
struct Cyc_Absyn_Enumdecl*_tmp137=Cyc_Tcdecl_merge_enumdecl(d0,d1,0,msg);if(
_tmp137 == 0)return 0;if((struct Cyc_Absyn_Enumdecl*)d0 != _tmp137){{const char*
_tmp2EE;void*_tmp2ED[1];struct Cyc_String_pa_struct _tmp2EC;Cyc_Interface_check_err(
msg,(struct _dyneither_ptr)((_tmp2EC.tag=0,((_tmp2EC.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_qvar2string(d1->name)),((_tmp2ED[0]=& _tmp2EC,
Cyc_aprintf(((_tmp2EE="declaration of enum %s discloses too much information",
...
struct Cyc_Absyn_Vardecl*_tmp13B=Cyc_Tcdecl_merge_vardecl(d0,d1,0,msg);if(_tmp13B
== 0)return 0;if((struct Cyc_Absyn_Vardecl*)d0 != _tmp13B){{const char*_tmp2F2;void*
_tmp2F1[1];struct Cyc_String_pa_struct _tmp2F0;Cyc_Interface_check_err(msg,(struct
_dyneither_ptr)((_tmp2F0.tag=0,((_tmp2F0.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_qvar2string(d1->name)),((_tmp2F1[0]=& _tmp2F0,Cyc_aprintf(((
_tmp2F2="declaration of variable %s discloses too much information",
...
_dyneither_ptr*msg){struct Cyc_Absyn_Typedefdecl*_tmp13F=Cyc_Tcdecl_merge_typedefdecl(
d0,d1,0,msg);if(_tmp13F == 0)return 0;if((struct Cyc_Absyn_Typedefdecl*)d0 != 
_tmp13F){{const char*_tmp2F6;void*_tmp2F5[1];struct Cyc_String_pa_struct _tmp2F4;
Cyc_Interface_check_err(msg,(struct _dyneither_ptr)((_tmp2F4.tag=0,((_tmp2F4.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(d1->name)),((
_tmp2F5[0]=& _tmp2F4,Cyc_aprintf(((_tmp2F6="declaration of typedef %s discloses too much information",
...
struct Cyc_Tcdecl_Xdatatypefielddecl*d0,struct Cyc_Tcdecl_Xdatatypefielddecl*d1,
struct _dyneither_ptr*msg){struct Cyc_Tcdecl_Xdatatypefielddecl*_tmp143=Cyc_Tcdecl_merge_xdatatypefielddecl(
d0,d1,0,msg);if(_tmp143 == 0)return 0;if((struct Cyc_Tcdecl_Xdatatypefielddecl*)d0
!= _tmp143){{const char*_tmp2FA;void*_tmp2F9[1];struct Cyc_String_pa_struct _tmp2F8;
Cyc_Interface_check_err(msg,(struct _dyneither_ptr)((_tmp2F8.tag=0,((_tmp2F8.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string((d1->field)->name)),((
_tmp2F9[0]=& _tmp2F8,Cyc_aprintf(((_tmp2FA="declaration of xdatatypefield %s discloses too much information",
...
msg){const char*_tmp2FB;int _tmp147=((int(*)(struct Cyc_Dict_Dict dic1,struct Cyc_Dict_Dict
...
ie1->aggrdecls,ie2->aggrdecls,Cyc_Interface_incl_aggrdecl,((_tmp2FB="type",
_tag_dyneither(_tmp2FB,sizeof(char),5))),msg);const char*_tmp2FC;int _tmp148=((int(*)(
...
_tmp149) && _tmp14A) && _tmp14B) && _tmp14C;}struct _tuple21{int f1;struct Cyc_Dict_Dict
...
_tuple21 _tmp154;int _tmp155;int*_tmp156;struct Cyc_Dict_Dict _tmp157;struct
_dyneither_ptr*_tmp158;struct _tuple21*_tmp153=env;_tmp154=*_tmp153;_tmp155=
_tmp154.f1;_tmp156=(int*)&(*_tmp153).f1;_tmp157=_tmp154.f2;_tmp158=_tmp154.f3;{
struct Cyc_Interface_Ienv*ie2;{struct _handler_cons _tmp159;_push_handler(& _tmp159);{
int _tmp15B=0;if(setjmp(_tmp159.handler))_tmp15B=1;if(!_tmp15B){ie2=((struct Cyc_Interface_Ienv*(*)(
...
_tuple21 _tmp301;struct _tuple21 _tmp15F=(_tmp301.f1=1,((_tmp301.f2=dic2,((_tmp301.f3=
msg,_tmp301)))));((void(*)(void(*f)(struct _tuple21*,struct Cyc_List_List*,struct
Cyc_Interface_Ienv*),struct _tuple21*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(
Cyc_Interface_incl_ns_f,& _tmp15F,dic1);return _tmp15F.f1;}int Cyc_Interface_is_subinterface(
...
_handler_cons _tmp161;_push_handler(& _tmp161);{int _tmp163=0;if(setjmp(_tmp161.handler))
_tmp163=1;if(!_tmp163){{int _tmp164=1;struct _dyneither_ptr*msg=0;if(info != 0){
struct Cyc_String_pa_struct _tmp30B;struct Cyc_String_pa_struct _tmp30A;void*_tmp309[
2];const char*_tmp308;struct _dyneither_ptr*_tmp307;msg=((_tmp307=_cycalloc(
...
struct _tuple22*env,struct _dyneither_ptr*x,void*y2){struct _tuple22 _tmp174;int
...
struct _dyneither_ptr*_tmp17D;struct _tuple22*_tmp173=env;_tmp174=*_tmp173;_tmp175=
...
_tuple22 _tmp31B;struct _tuple22 _tmp192=(_tmp31B.f1=1,((_tmp31B.f2=dic1,((_tmp31B.f3=
dic1,((_tmp31B.f4=excl,((_tmp31B.f5=merge_f,((_tmp31B.f6=t,((_tmp31B.f7=msg,
_tmp31B)))))))))))));((void(*)(void(*f)(struct _tuple22*,struct _dyneither_ptr*,
...
_dyneither_ptr*msg){const char*_tmp31D;struct Cyc_Dict_Dict*_tmp195=((struct Cyc_Dict_Dict*(*)(
...
_tuple23 _tmp1A3;int _tmp1A4;int*_tmp1A5;struct Cyc_Dict_Dict _tmp1A6;struct Cyc_Dict_Dict*
_tmp1A7;struct Cyc_Dict_Dict _tmp1A8;struct Cyc_Dict_Dict _tmp1A9;struct
_dyneither_ptr*_tmp1AA;struct _tuple23*_tmp1A2=env;_tmp1A3=*_tmp1A2;_tmp1A4=
_tmp1A3.f1;_tmp1A5=(int*)&(*_tmp1A2).f1;_tmp1A6=_tmp1A3.f2;_tmp1A7=(struct Cyc_Dict_Dict*)&(*
_tmp1A2).f2;_tmp1A8=_tmp1A3.f3;_tmp1A9=_tmp1A3.f4;_tmp1AA=_tmp1A3.f5;{struct Cyc_Interface_Ienv*
...
struct _tuple23 _tmp324;struct _tuple23 _tmp1B9=(_tmp324.f1=1,((_tmp324.f2=d,((
_tmp324.f3=dic1,((_tmp324.f4=excl,((_tmp324.f5=msg,_tmp324)))))))));((void(*)(
...
_tuple24*env,struct _dyneither_ptr*x,void*y){struct _tuple24 _tmp1BD;int _tmp1BE;int*
_tmp1BF;struct Cyc_Dict_Dict _tmp1C0;struct Cyc_Dict_Dict*_tmp1C1;struct Cyc_Dict_Dict
_tmp1C2;struct _dyneither_ptr _tmp1C3;struct _dyneither_ptr*_tmp1C4;struct _tuple24*
...
_dyneither_ptr*msg){struct _tuple24 _tmp32B;struct _tuple24 _tmp1C9=(_tmp32B.f1=1,((
_tmp32B.f2=dic1,((_tmp32B.f3=dic1,((_tmp32B.f4=t,((_tmp32B.f5=msg,_tmp32B)))))))));((
void(*)(void(*f)(struct _tuple24*,struct _dyneither_ptr*,void*),struct _tuple24*env,
struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Interface_disj_merge_dict_f,& _tmp1C9,
dic2);if(_tmp1C9.f1){struct Cyc_Dict_Dict*_tmp32C;return(_tmp32C=_cycalloc(
sizeof(*_tmp32C)),((_tmp32C[0]=_tmp1C9.f2,_tmp32C)));}return 0;}struct Cyc_Interface_Ienv*
...
env,struct Cyc_List_List*ns,struct Cyc_Interface_Ienv*ie2){struct _tuple25 _tmp1DA;
int _tmp1DB;int*_tmp1DC;struct Cyc_Dict_Dict _tmp1DD;struct Cyc_Dict_Dict*_tmp1DE;
struct Cyc_Dict_Dict _tmp1DF;struct _dyneither_ptr*_tmp1E0;struct _tuple25*_tmp1D9=
env;_tmp1DA=*_tmp1D9;_tmp1DB=_tmp1DA.f1;_tmp1DC=(int*)&(*_tmp1D9).f1;_tmp1DD=
_tmp1DA.f2;_tmp1DE=(struct Cyc_Dict_Dict*)&(*_tmp1D9).f2;_tmp1DF=_tmp1DA.f3;
_tmp1E0=_tmp1DA.f4;{struct Cyc_Interface_Ienv*ie1;{struct _handler_cons _tmp1E1;
_push_handler(& _tmp1E1);{int _tmp1E3=0;if(setjmp(_tmp1E1.handler))_tmp1E3=1;if(!
_tmp1E3){ie1=((struct Cyc_Interface_Ienv*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*
k))Cyc_Dict_lookup)(_tmp1DF,ns);;_pop_handler();}else{void*_tmp1E2=(void*)
_exn_thrown;void*_tmp1E5=_tmp1E2;_LL94: {struct Cyc_Dict_Absent_struct*_tmp1E6=(
struct Cyc_Dict_Absent_struct*)_tmp1E5;if(_tmp1E6->tag != Cyc_Dict_Absent)goto
_LL96;}_LL95: ie1=Cyc_Interface_lazy_new_ienv();goto _LL93;_LL96:;_LL97:(void)
_throw(_tmp1E5);_LL93:;}};}{struct Cyc_Interface_Ienv*_tmp1E7=Cyc_Interface_disj_merge_ienv(
ie1,ie2,_tmp1E0);if(_tmp1E7 == 0)*_tmp1DC=0;else{if(*_tmp1DC)*_tmp1DE=((struct Cyc_Dict_Dict(*)(
struct Cyc_Dict_Dict d,struct Cyc_List_List*k,struct Cyc_Interface_Ienv*v))Cyc_Dict_insert)(*
_tmp1DE,ns,(struct Cyc_Interface_Ienv*)_tmp1E7);}};};}struct Cyc_Dict_Dict*Cyc_Interface_disj_merge_ns(
struct Cyc_Dict_Dict dic1,struct Cyc_Dict_Dict dic2,struct _dyneither_ptr*msg);struct
Cyc_Dict_Dict*Cyc_Interface_disj_merge_ns(struct Cyc_Dict_Dict dic1,struct Cyc_Dict_Dict
dic2,struct _dyneither_ptr*msg){struct _tuple25 _tmp334;struct _tuple25 _tmp1E8=(
_tmp334.f1=1,((_tmp334.f2=dic1,((_tmp334.f3=dic1,((_tmp334.f4=msg,_tmp334)))))));((
...
_tmp1E8,dic2);if(_tmp1E8.f1){struct Cyc_Dict_Dict*_tmp335;return(_tmp335=
_cycalloc(sizeof(*_tmp335)),((_tmp335[0]=_tmp1E8.f2,_tmp335)));}return 0;}struct
...
i1,struct Cyc_Interface_I*i2,struct _tuple9*info){struct _handler_cons _tmp1EB;
_push_handler(& _tmp1EB);{int _tmp1ED=0;if(setjmp(_tmp1EB.handler))_tmp1ED=1;if(!
_tmp1ED){{struct _dyneither_ptr*msg=0;if(info != 0){struct Cyc_String_pa_struct
...
li=li->tl){struct _tuple9*_tmp34B;struct Cyc_Interface_I*_tmp201=Cyc_Interface_merge(
...
curr_info != 0  && linfo != 0?(_tmp356=_cycalloc(sizeof(*_tmp356)),((_tmp356->f1=*
curr_info,((_tmp356->f2=*((struct _dyneither_ptr*)linfo->hd),_tmp356))))): 0);if(
_tmp208 == 0)return 0;curr_i=(struct Cyc_Interface_I*)_tmp208;if(curr_info != 0){
struct Cyc_String_pa_struct _tmp360;struct Cyc_String_pa_struct _tmp35F;void*_tmp35E[
2];const char*_tmp35D;struct _dyneither_ptr*_tmp35C;curr_info=linfo != 0?(_tmp35C=
_cycalloc(sizeof(*_tmp35C)),((_tmp35C[0]=(struct _dyneither_ptr)((_tmp360.tag=0,((
_tmp360.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct _dyneither_ptr*)
linfo->hd)),((_tmp35F.tag=0,((_tmp35F.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*curr_info),((_tmp35E[0]=& _tmp35F,((_tmp35E[1]=& _tmp360,Cyc_aprintf(((
_tmp35D="%s+%s",_tag_dyneither(_tmp35D,sizeof(char),6))),_tag_dyneither(_tmp35E,
sizeof(void*),2)))))))))))))),_tmp35C))): 0;}if(linfo != 0)linfo=linfo->tl;}return(
...
struct Cyc_Absyn_Aggr_d_struct*_tmp36C;struct Cyc_Absyn_Aggr_d_struct _tmp36B;
struct Cyc_List_List*_tmp36A;return(_tmp36A=_cycalloc(sizeof(*_tmp36A)),((_tmp36A->hd=
Cyc_Absyn_new_decl((void*)((_tmp36C=_cycalloc(sizeof(*_tmp36C)),((_tmp36C[0]=((
_tmp36B.tag=6,((_tmp36B.f1=d,_tmp36B)))),_tmp36C)))),0),((_tmp36A->tl=tds,
_tmp36A)))));}static struct Cyc_List_List*Cyc_Interface_add_aggrdecl_header(struct
...
_tmp36D;d=((_tmp36D=_cycalloc(sizeof(*_tmp36D)),((_tmp36D[0]=*d,_tmp36D))));}d->impl=
0;if(d->sc != Cyc_Absyn_ExternC)d->sc=Cyc_Absyn_Extern;{struct Cyc_Absyn_Aggr_d_struct*
_tmp373;struct Cyc_Absyn_Aggr_d_struct _tmp372;struct Cyc_List_List*_tmp371;return(
_tmp371=_cycalloc(sizeof(*_tmp371)),((_tmp371->hd=Cyc_Absyn_new_decl((void*)((
_tmp373=_cycalloc(sizeof(*_tmp373)),((_tmp373[0]=((_tmp372.tag=6,((_tmp372.f1=d,
_tmp372)))),_tmp373)))),0),((_tmp371->tl=tds,_tmp371)))));};}static struct Cyc_List_List*
...
struct Cyc_Absyn_Datatype_d_struct*_tmp379;struct Cyc_Absyn_Datatype_d_struct
_tmp378;struct Cyc_List_List*_tmp377;return(_tmp377=_cycalloc(sizeof(*_tmp377)),((
_tmp377->hd=Cyc_Absyn_new_decl((void*)((_tmp379=_cycalloc(sizeof(*_tmp379)),((
_tmp379[0]=((_tmp378.tag=7,((_tmp378.f1=d,_tmp378)))),_tmp379)))),0),((_tmp377->tl=
tds,_tmp377)))));}static char _tmp21C[2]="_";static struct _dyneither_ptr Cyc_Interface_us={
...
_tmp381;struct _tuple16*_tmp380;return(_tmp380=_cycalloc(sizeof(*_tmp380)),((
...
_tmp385;d=((_tmp385=_cycalloc(sizeof(*_tmp385)),((_tmp385[0]=*d,_tmp385))));}if(
d->fields != 0){struct Cyc_Core_Opt*_tmp386;d->fields=((_tmp386=_cycalloc(sizeof(*
...
tds,_tmp38A)))));};}static struct Cyc_List_List*Cyc_Interface_add_enumdecl(struct
...
_tmp393;d=((_tmp393=_cycalloc(sizeof(*_tmp393)),((_tmp393[0]=*d,_tmp393))));}d->fields=
0;if(d->sc != Cyc_Absyn_ExternC)d->sc=Cyc_Absyn_Extern;{struct Cyc_Absyn_Enum_d_struct*
_tmp399;struct Cyc_Absyn_Enum_d_struct _tmp398;struct Cyc_List_List*_tmp397;return(
_tmp397=_cycalloc(sizeof(*_tmp397)),((_tmp397->hd=Cyc_Absyn_new_decl((void*)((
_tmp399=_cycalloc(sizeof(*_tmp399)),((_tmp399[0]=((_tmp398.tag=8,((_tmp398.f1=d,
_tmp398)))),_tmp399)))),0),((_tmp397->tl=tds,_tmp397)))));};}static struct Cyc_List_List*
...
struct Cyc_Absyn_Typedef_d_struct*_tmp39F;struct Cyc_Absyn_Typedef_d_struct _tmp39E;
...
d,struct Cyc_List_List*tds){struct Cyc_Absyn_Var_d_struct*_tmp3A5;struct Cyc_Absyn_Var_d_struct
_tmp3A4;struct Cyc_List_List*_tmp3A3;return(_tmp3A3=_cycalloc(sizeof(*_tmp3A3)),((
_tmp3A3->hd=Cyc_Absyn_new_decl((void*)((_tmp3A5=_cycalloc(sizeof(*_tmp3A5)),((
_tmp3A5[0]=((_tmp3A4.tag=0,((_tmp3A4.f1=d,_tmp3A4)))),_tmp3A5)))),0),((_tmp3A3->tl=
tds,_tmp3A3)))));}static struct Cyc_List_List*Cyc_Interface_add_xdatatypefielddecl(
...
struct Cyc_Tcdecl_Xdatatypefielddecl _tmp235;struct Cyc_Absyn_Datatypedecl*_tmp236;
struct Cyc_Absyn_Datatypefield*_tmp237;struct Cyc_Tcdecl_Xdatatypefielddecl*
...
struct Cyc_Interface_Ienv*ie){struct Cyc_List_List*_tmp248=0;_tmp248=((struct Cyc_List_List*(*)(
...
Cyc_Interface_add_aggrdecl_header,ie->aggrdecls,_tmp248);_tmp248=((struct Cyc_List_List*(*)(
...
Cyc_Interface_add_datatypedecl_header,ie->datatypedecls,_tmp248);_tmp248=((
struct Cyc_List_List*(*)(struct Cyc_List_List*(*f)(struct _dyneither_ptr*,struct Cyc_Absyn_Enumdecl*,
struct Cyc_List_List*),struct Cyc_Dict_Dict d,struct Cyc_List_List*accum))Cyc_Dict_fold)(
Cyc_Interface_add_enumdecl_header,ie->enumdecls,_tmp248);if(_tmp248 != 0){_tmp248=((
struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp248);
_tmp248=Cyc_Interface_add_namespace(_tmp248,ns);Cyc_Absynpp_decllist2file(
_tmp248,f);}}static void Cyc_Interface_print_ns_xdatatypefielddecl_headers(struct
...
Cyc_List_List*ns,struct Cyc_Interface_Ienv*ie){struct Cyc_List_List*_tmp249=((
...
_tmp249 != 0){_tmp249=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(
_tmp249);_tmp249=Cyc_Interface_add_namespace(_tmp249,ns);Cyc_Absynpp_decllist2file(
_tmp249,f);}}static void Cyc_Interface_print_ns_typedefs(struct Cyc___cycFILE*f,
...
struct Cyc___cycFILE*f,struct Cyc_List_List*ns,struct Cyc_Interface_Ienv*ie){struct
Cyc_List_List*_tmp24B=0;_tmp24B=((struct Cyc_List_List*(*)(struct Cyc_List_List*(*
...
ie->aggrdecls,_tmp24B);_tmp24B=((struct Cyc_List_List*(*)(struct Cyc_List_List*(*f)(
...
ie->datatypedecls,_tmp24B);_tmp24B=((struct Cyc_List_List*(*)(struct Cyc_List_List*(*
...
ie->enumdecls,_tmp24B);_tmp24B=((struct Cyc_List_List*(*)(struct Cyc_List_List*(*f)(
...
_tmp24B);_tmp24B=((struct Cyc_List_List*(*)(struct Cyc_List_List*(*f)(struct
...
ie->xdatatypefielddecls,_tmp24B);if(_tmp24B != 0){_tmp24B=((struct Cyc_List_List*(*)(
struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp24B);_tmp24B=Cyc_Interface_add_namespace(
_tmp24B,ns);Cyc_Absynpp_decllist2file(_tmp24B,f);}}void Cyc_Interface_print(
...
const char*_tmp3BC;void*_tmp3BB;(_tmp3BB=0,Cyc_fprintf(f,((_tmp3BC="/****** needed (headers) ******/\n",
...
struct Cyc_List_List*_tmp25A=Cyc_Parse_parse_file(f);struct _RegionHandle _tmp25B=
_new_region("r");struct _RegionHandle*r=& _tmp25B;_push_region(r);{struct Cyc_Tcenv_Tenv*
_tmp25C=Cyc_Tcenv_tc_init(r);Cyc_Tc_tc(r,_tmp25C,0,_tmp25A);{struct Cyc_Interface_I*
_tmp25D=Cyc_Interface_gen_extract(_tmp25C->ae,0);_npop_handler(0);return _tmp25D;};};
