...
# 522
struct Cyc_Absyn_Tqual _tmp2AD=Cyc_Absyn_empty_tqual(0U);_tmpBB->tq=_tmp2AD;}),_tmpBB->type=(void*)_check_null(_tmpC2->cached_type),_tmpBB->initializer=0,_tmpBB->rgn=0,_tmpBB->attributes=0,_tmpBB->escapes=0;_tmpBB;});
# 529
_tmpC6=0;
