...
_tmp380->kind=Cyc_Tcutil_kind_to_bound(Cyc_Absyn_BoxKind),_tmp380)))))))),
_tmp37F)))),_tmp381)))),_tmp37E)))));}static struct Cyc_Absyn_Datatypefield*Cyc_Interface_rewrite_datatypefield(
