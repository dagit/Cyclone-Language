...
return res;}}struct _tuple20{struct Cyc_Absyn_Tqual f1;void*f2;};
# 213
...
if(!({struct Cyc_Tcenv_Genv*_tmp25C=ae;struct Cyc_Interface_Seen*_tmp25B=seen;struct _fat_ptr _tmp25A=({const char*_tmp34="datatype";_tag_fat(_tmp34,sizeof(char),9U);});struct _tuple0*_tmp259=d->name;((int(*)(struct Cyc_Tcenv_Genv*ae,struct Cyc_Interface_Seen*seen,struct _fat_ptr obj,struct _tuple0*name,void*(*f)(struct _tuple20*),struct Cyc_List_List*l))Cyc_Interface_check_public_type_list)(_tmp25C,_tmp25B,_tmp25A,_tmp259,Cyc_Interface_get_type1,((struct Cyc_Absyn_Datatypefield*)fs->hd)->typs);}))
# 229
res=0;}}
# 231
...
# 268
return((int(*)(struct Cyc_Tcenv_Genv*ae,struct Cyc_Interface_Seen*seen,struct _fat_ptr obj,struct _tuple0*name,void*(*f)(struct _tuple20*),struct Cyc_List_List*l))Cyc_Interface_check_public_type_list)(ae,seen,obj,name,Cyc_Interface_get_type1,lt);}case 0U: switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp37)->f1)){case 20U: _LLB: _tmp3E=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp37)->f1)->f1;_tmp3F=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp37)->f2;_LLC: {union Cyc_Absyn_AggrInfo info=_tmp3E;struct Cyc_List_List*targs=_tmp3F;
# 271
...
# 353
struct _tuple21*_tmp72=env;struct Cyc_Interface_Seen*_tmp77;struct Cyc_Tcenv_Genv*_tmp76;int _tmp75;struct Cyc_Interface_Ienv*_tmp74;struct Cyc_Interface_Ienv*_tmp73;_LL1: _tmp73=_tmp72->f1;_tmp74=_tmp72->f2;_tmp75=_tmp72->f3;_tmp76=_tmp72->f4;_tmp77=_tmp72->f5;_LL2: {struct Cyc_Interface_Ienv*imp=_tmp73;struct Cyc_Interface_Ienv*exp=_tmp74;int check_complete_defs=_tmp75;struct Cyc_Tcenv_Genv*ae=_tmp76;struct Cyc_Interface_Seen*seen=_tmp77;
...
# 393
struct _tuple21*_tmp84=env;struct Cyc_Interface_Seen*_tmp89;struct Cyc_Tcenv_Genv*_tmp88;int _tmp87;struct Cyc_Interface_Ienv*_tmp86;struct Cyc_Interface_Ienv*_tmp85;_LL1: _tmp85=_tmp84->f1;_tmp86=_tmp84->f2;_tmp87=_tmp84->f3;_tmp88=_tmp84->f4;_tmp89=_tmp84->f5;_LL2: {struct Cyc_Interface_Ienv*imp=_tmp85;struct Cyc_Interface_Ienv*exp=_tmp86;int check_complete_defs=_tmp87;struct Cyc_Tcenv_Genv*ae=_tmp88;struct Cyc_Interface_Seen*seen=_tmp89;
...
# 510
struct _tuple21*_tmpB3=env;struct Cyc_Interface_Seen*_tmpB6;struct Cyc_Tcenv_Genv*_tmpB5;struct Cyc_Interface_Ienv*_tmpB4;_LL1: _tmpB4=_tmpB3->f2;_tmpB5=_tmpB3->f4;_tmpB6=_tmpB3->f5;_LL2: {struct Cyc_Interface_Ienv*exp=_tmpB4;struct Cyc_Tcenv_Genv*ae=_tmpB5;struct Cyc_Interface_Seen*seen=_tmpB6;
if(Cyc_Interface_check_public_typedefdecl(ae,seen,d))
({struct Cyc_Dict_Dict _tmp2A2=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple0*k,struct Cyc_Absyn_Typedefdecl*v))Cyc_Dict_insert)(exp->typedefdecls,x,d);exp->typedefdecls=_tmp2A2;});}}struct _tuple22{void*f1;int f2;};
# 515
static void Cyc_Interface_extract_ordinarie(struct _tuple21*env,struct _tuple0*x,struct _tuple22*v){
# 517
struct _tuple21*_tmpB7=env;struct Cyc_Interface_Seen*_tmpBC;struct Cyc_Tcenv_Genv*_tmpBB;int _tmpBA;struct Cyc_Interface_Ienv*_tmpB9;struct Cyc_Interface_Ienv*_tmpB8;_LL1: _tmpB8=_tmpB7->f1;_tmpB9=_tmpB7->f2;_tmpBA=_tmpB7->f3;_tmpBB=_tmpB7->f4;_tmpBC=_tmpB7->f5;_LL2: {struct Cyc_Interface_Ienv*imp=_tmpB8;struct Cyc_Interface_Ienv*exp=_tmpB9;int check_complete_defs=_tmpBA;struct Cyc_Tcenv_Genv*ae=_tmpBB;struct Cyc_Interface_Seen*seen=_tmpBC;
# 519
...
struct _tuple24*_tmpFA=env_f;struct Cyc_Interface_Seen*_tmpFE;struct Cyc_Tcenv_Genv*_tmpFD;int _tmpFC;struct Cyc_Interface_I*_tmpFB;_LL1: _tmpFB=_tmpFA->f1;_tmpFC=_tmpFA->f2;_tmpFD=_tmpFA->f3;_tmpFE=_tmpFA->f4;_LL2: {struct Cyc_Interface_I*i=_tmpFB;int check_complete_defs=_tmpFC;struct Cyc_Tcenv_Genv*ae=_tmpFD;struct Cyc_Interface_Seen*seen=_tmpFE;
struct _tuple21 _tmpFF=({struct _tuple21 _tmp216;_tmp216.f1=i->imports,_tmp216.f2=i->exports,_tmp216.f3=check_complete_defs,_tmp216.f4=ae,_tmp216.f5=seen,_tmp216.f6=i;_tmp216;});struct _tuple21 env=_tmpFF;
((void(*)(void(*f)(struct _tuple21*,struct _tuple0*,struct Cyc_Absyn_Aggrdecl**),struct _tuple21*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Interface_extract_aggrdecl,& env,ae->aggrdecls);
((void(*)(void(*f)(struct _tuple21*,struct _tuple0*,struct Cyc_Absyn_Datatypedecl**),struct _tuple21*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Interface_extract_datatypedecl,& env,ae->datatypedecls);
((void(*)(void(*f)(struct _tuple21*,struct _tuple0*,struct Cyc_Absyn_Enumdecl**),struct _tuple21*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Interface_extract_enumdecl,& env,ae->enumdecls);
((void(*)(void(*f)(struct _tuple21*,struct _tuple0*,struct Cyc_Absyn_Typedefdecl*),struct _tuple21*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Interface_extract_typedef,& env,ae->typedefs);
((void(*)(void(*f)(struct _tuple21*,struct _tuple0*,struct _tuple22*),struct _tuple21*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Interface_extract_ordinarie,& env,ae->ordinaries);}}
# 675
...
# 719
struct _tuple25 _tmp114=({struct _tuple25 _tmp21B;_tmp21B.f1=1,_tmp21B.f2=dic2,_tmp21B.f3=incl_f,_tmp21B.f4=t,_tmp21B.f5=msg;_tmp21B;});struct _tuple25 env=_tmp114;
((void(*)(void(*f)(struct _tuple25*,struct _tuple0*,void*),struct _tuple25*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Interface_incl_dict_f,& env,dic1);
return env.f1;}
# 736 "interface.cyc"
...
struct Cyc_Dict_Dict*Cyc_Interface_compat_merge_dict(struct Cyc_Dict_Dict dic1,struct Cyc_Dict_Dict dic2,struct Cyc_Dict_Dict excl,void*(*merge_f)(void*,void*,unsigned,struct _fat_ptr*),struct _fat_ptr t,struct _fat_ptr*msg){
# 849
struct _tuple26 _tmp164=({struct _tuple26 _tmp228;_tmp228.f1=1,_tmp228.f2=dic1,_tmp228.f3=dic1,_tmp228.f4=excl,_tmp228.f5=merge_f,_tmp228.f6=t,_tmp228.f7=msg;_tmp228;});struct _tuple26 env=_tmp164;
# 851
((void(*)(void(*f)(struct _tuple26*,struct _tuple0*,void*),struct _tuple26*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Interface_compat_merge_dict_f,& env,dic2);
# 853
if(env.f1)
...
return 0;
return({struct Cyc_Interface_Ienv*_tmp16C=_cycalloc(sizeof(*_tmp16C));_tmp16C->aggrdecls=*r1,_tmp16C->datatypedecls=*r2,_tmp16C->enumdecls=*r3,_tmp16C->typedefdecls=*r4,_tmp16C->vardecls=*r5,_tmp16C->xdatatypefielddecls=*r6;_tmp16C;});}struct _tuple27{int f1;struct Cyc_Dict_Dict f2;struct Cyc_Dict_Dict f3;struct _fat_ptr f4;struct _fat_ptr*f5;};
# 876
void Cyc_Interface_disj_merge_dict_f(struct _tuple27*env,struct _tuple0*x,void*y){
# 879
struct _tuple27*_tmp173=env;struct _fat_ptr*_tmp178;struct _fat_ptr _tmp177;struct Cyc_Dict_Dict _tmp176;struct Cyc_Dict_Dict*_tmp175;int*_tmp174;_LL1: _tmp174=(int*)& _tmp173->f1;_tmp175=(struct Cyc_Dict_Dict*)& _tmp173->f2;_tmp176=_tmp173->f3;_tmp177=_tmp173->f4;_tmp178=_tmp173->f5;_LL2: {int*res=_tmp174;struct Cyc_Dict_Dict*res_dic=_tmp175;struct Cyc_Dict_Dict dic1=_tmp176;struct _fat_ptr t=_tmp177;struct _fat_ptr*msg=_tmp178;
...
# 893
struct _tuple27 _tmp17D=({struct _tuple27 _tmp22B;_tmp22B.f1=1,_tmp22B.f2=dic1,_tmp22B.f3=dic1,_tmp22B.f4=t,_tmp22B.f5=msg;_tmp22B;});struct _tuple27 env=_tmp17D;
((void(*)(void(*f)(struct _tuple27*,struct _tuple0*,void*),struct _tuple27*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Interface_disj_merge_dict_f,& env,dic2);
if(env.f1)
