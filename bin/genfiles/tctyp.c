...
# 92 "tctyp.cyc"
static struct Cyc_Tctyp_CVTEnv Cyc_Tctyp_i_check_type(struct Cyc_Tctyp_CVTEnv,struct Cyc_Absyn_Kind*,void*,int,int);struct _tuple17{void*f0;int f1;};
# 98
...
struct _tuple17*_Tmp2=(struct _tuple17*)es2->hd;void*_Tmp3;void*_Tmp4;_Tmp4=_Tmp2->f0;_Tmp3=(int*)& _Tmp2->f1;{void*t=_Tmp4;int*b2=(int*)_Tmp3;
...
goto _LL8;}_LL8:;}}}{
# 113
struct Cyc_List_List*_Tmp2=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple17*_Tmp3=({struct _tuple17*_Tmp4=_cycalloc(sizeof(struct _tuple17));_Tmp4->f0=e,_Tmp4->f1=b;_Tmp4;});_Tmp2->hd=_Tmp3;}),_Tmp2->tl=es;return _Tmp2;}}}else{
return es;};}
# 119
...
void*e=(*((struct _tuple17*)free_evars->hd)).f0;
...
struct Cyc_List_List*_Tmp0=_cycalloc(sizeof(struct Cyc_List_List));_Tmp0->hd=tv,_Tmp0->tl=tvs;return _Tmp0;}}
# 199
static int Cyc_Tctyp_cmp_fqv(struct _tuple17*te1,struct _tuple17*te2){
void*t1=(*te1).f0;
void*t2=(*te2).f0;
...
return env;}}struct _tuple18{struct Cyc_Tctyp_CVTEnv f0;struct Cyc_AssnDef_AssnMap f1;};
# 345
static struct _tuple18 Cyc_Tctyp_check_clause(struct Cyc_Tctyp_CVTEnv env,struct _fat_ptr clause_name,struct Cyc_Absyn_Exp*clause){
# 348
if(clause==0){
struct _tuple18 _Tmp0;_Tmp0.f0=env,({struct Cyc_AssnDef_AssnMap _Tmp1=Cyc_AssnDef_true_assnmap();_Tmp0.f1=_Tmp1;});return _Tmp0;}
...
struct _tuple18 _Tmp0;_Tmp0.f0=env,_Tmp0.f1=assnmap;return _Tmp0;}}
# 360
...
# 452
{struct Cyc_List_List*fs=(struct Cyc_List_List*)tud->fields->v;for(0;1;fs=fs->tl){
...
return Cyc_Tctyp_i_check_type(env,k,(void*)ts->hd,put_in_effect,1);}
# 474
...
env=Cyc_Tctyp_i_check_type(env,& Cyc_Kinds_aqk,(void*)ts->hd,0,0);{
...
if((unsigned)ctx_bnd)
ts->tl->hd=(void*)ctx_bnd;else{
# 507
env=Cyc_Tctyp_i_check_type(env,& Cyc_Kinds_aqk,(void*)ts->tl->hd,0,0);}
# 509
({struct Cyc_List_List*_Tmp4=({struct Cyc_List_List*_Tmp5=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple17*_Tmp6=({struct _tuple17*_Tmp7=_cycalloc(sizeof(struct _tuple17));_Tmp7->f0=apptype,_Tmp7->f1=0;_Tmp7;});_Tmp5->hd=_Tmp6;}),_Tmp5->tl=env.free_qualvars;_Tmp5;});env.free_qualvars=_Tmp4;});
return env;}case 3:
# 512
 for(1;ts!=0;ts=ts->tl){
...
tag_count=1U + Cyc_Evexp_eval_const_uint_exp(f->tag).f0;}
# 549
return env;}}case 10:
...
# 586
static int Cyc_Tctyp_aqualvar_unconstrained(struct _tuple17*t){
...
struct _tuple17*_Tmp0=(struct _tuple17*)vars->hd;int _Tmp1;void*_Tmp2;_Tmp2=_Tmp0->f0;_Tmp1=_Tmp0->f1;{void*v=_Tmp2;int existential=_Tmp1;
...
goto _LL3;}_LL3:;}}}}
# 704
static struct _tuple17*Cyc_Tctyp_tvar2type(struct _tuple12*in){
int _Tmp0;void*_Tmp1;_Tmp1=in->f0;_Tmp0=in->f1;{struct Cyc_Absyn_Tvar*tv=_Tmp1;int b=_Tmp0;
void*t=Cyc_Absyn_var_type(tv);
struct _tuple17*_Tmp2=_cycalloc(sizeof(struct _tuple17));_Tmp2->f0=t,_Tmp2->f1=b;return _Tmp2;}}
# 710
static int Cyc_Tctyp_evar_unconstrained(struct _tuple17*evb){
...
({unsigned _Tmp0=loc;struct Cyc_Tctyp_CVTEnv _Tmp1=env;struct Cyc_List_List*_Tmp2=({struct Cyc_List_List*(*_Tmp3)(struct _tuple17*(*)(struct _tuple12*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple17*(*)(struct _tuple12*),struct Cyc_List_List*))Cyc_List_map;_Tmp3;})(Cyc_Tctyp_tvar2type,flagged_tvars);struct Cyc_List_List**_Tmp3=qb;Cyc_Tctyp_constrain_vars(_Tmp0,_Tmp1,_Tmp2,_Tmp3,def,1);});
({unsigned _Tmp0=loc;struct Cyc_Tctyp_CVTEnv _Tmp1=env;struct Cyc_List_List*_Tmp2=({struct Cyc_List_List*(*_Tmp3)(struct _tuple17*(*)(struct _tuple12*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple17*(*)(struct _tuple12*),struct Cyc_List_List*))Cyc_List_map;_Tmp3;})(Cyc_Tctyp_tvar2type,env.free_vars);struct Cyc_List_List**_Tmp3=qb;Cyc_Tctyp_constrain_vars(_Tmp0,_Tmp1,_Tmp2,_Tmp3,def,0);});
({unsigned _Tmp0=loc;struct Cyc_Tctyp_CVTEnv _Tmp1=env;struct Cyc_List_List*_Tmp2=({struct Cyc_List_List*(*_Tmp3)(int(*)(struct _tuple17*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(int(*)(struct _tuple17*),struct Cyc_List_List*))Cyc_List_filter;_Tmp3;})(Cyc_Tctyp_evar_unconstrained,freeevs);struct Cyc_List_List**_Tmp3=qb;Cyc_Tctyp_constrain_vars(_Tmp0,_Tmp1,_Tmp2,_Tmp3,def,0);});
({unsigned _Tmp0=loc;struct Cyc_Tctyp_CVTEnv _Tmp1=env;struct Cyc_List_List*_Tmp2=({struct Cyc_List_List*(*_Tmp3)(int(*)(struct _tuple17*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(int(*)(struct _tuple17*),struct Cyc_List_List*))Cyc_List_filter;_Tmp3;})(Cyc_Tctyp_aqualvar_unconstrained,freeqvs);struct Cyc_List_List**_Tmp3=qb;Cyc_Tctyp_constrain_vars(_Tmp0,_Tmp1,_Tmp2,_Tmp3,def,0);});}struct _tuple19{enum Cyc_Absyn_Format_Type f0;void*f1;};struct _tuple20{struct Cyc_Absyn_Tvar*f0;void*f1;};
# 729
...
# 731
void*_Tmp0;unsigned _Tmp1;_Tmp1=env.loc;_Tmp0=env.te;{unsigned loc=_Tmp1;struct Cyc_Tcenv_Tenv*te=_Tmp0;
{void*_Tmp2=Cyc_Absyn_compress(t);enum Cyc_Absyn_AggrKind _Tmp3;void*_Tmp4;void*_Tmp5;void*_Tmp6;void*_Tmp7;void*_Tmp8;void*_Tmp9;void*_TmpA;void*_TmpB;void*_TmpC;int _TmpD;unsigned _TmpE;void*_TmpF;void*_Tmp10;void*_Tmp11;void*_Tmp12;void*_Tmp13;void*_Tmp14;const char*_Tmp15;void*_Tmp16;void*_Tmp17;switch(*((int*)_Tmp2)){case 0: _Tmp17=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp2)->f1;_Tmp16=(struct Cyc_List_List**)&((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp2)->f2;{void*c=_Tmp17;struct Cyc_List_List**targsp=_Tmp16;
# 734
env=Cyc_Tctyp_i_check_type_app(env,expected_kind,c,targsp,put_in_effect,allow_abs_aggr,t);
# 736
goto _LL3;}case 3: _Tmp17=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_Tmp2)->f1;_Tmp15=((struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_Tmp2)->f5;{struct Cyc_Core_Opt**k=_Tmp17;const char*name=_Tmp15;
# 738
if(name==(const char*)0)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("Unnamed Cvar ",sizeof(char),14U);_Tmp19;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp19=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp1A;_Tmp1A.tag=2,_Tmp1A.f1=(void*)t;_Tmp1A;});void*_Tmp1A[2];_Tmp1A[0]=& _Tmp18,_Tmp1A[1]=& _Tmp19;Cyc_Warn_err2(loc,_tag_fat(_Tmp1A,sizeof(void*),2));});
# 741
if(*k==0 ||
 Cyc_Kinds_kind_leq(expected_kind,(struct Cyc_Absyn_Kind*)(*k)->v)&& !
Cyc_Kinds_kind_leq((struct Cyc_Absyn_Kind*)(*k)->v,expected_kind))
({struct Cyc_Core_Opt*_Tmp18=Cyc_Kinds_kind_to_opt(expected_kind);*k=_Tmp18;});
goto _LL3;}case 1: _Tmp17=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_Tmp2)->f1;_Tmp16=(void**)&((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_Tmp2)->f2;{struct Cyc_Core_Opt**k=_Tmp17;void**ref=_Tmp16;
# 748
if(*k==0 ||
 Cyc_Kinds_kind_leq(expected_kind,(struct Cyc_Absyn_Kind*)(*k)->v)&& !
Cyc_Kinds_kind_leq((struct Cyc_Absyn_Kind*)(*k)->v,expected_kind))
...
# 774
struct Cyc_Absyn_Tvar*v=Cyc_Tcutil_new_tvar((void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp18=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp18->tag=2,_Tmp18->f1=0,_Tmp18->f2=expected_kind;_Tmp18;}));
({void*_Tmp18=Cyc_Absyn_var_type(v);*ref=_Tmp18;});
_Tmp17=v;goto _LLB;}
# 778
({struct Cyc_List_List*_Tmp18=Cyc_Tctyp_add_free_evar(env.free_evars,t,put_in_effect);env.free_evars=_Tmp18;});
goto _LL3;}case 2: _Tmp17=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_Tmp2)->f1;_LLB: {struct Cyc_Absyn_Tvar*v=_Tmp17;
# 781
{void*_Tmp18=Cyc_Kinds_compress_kb(v->kind);void*_Tmp19;if(*((int*)_Tmp18)==1){_Tmp19=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_Tmp18)->f1;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp19;
({struct Cyc_Core_Opt*_Tmp1A=({struct Cyc_Core_Opt*_Tmp1B=_cycalloc(sizeof(struct Cyc_Core_Opt));({void*_Tmp1C=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp1D=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp1D->tag=2,_Tmp1D->f1=0,_Tmp1D->f2=expected_kind;_Tmp1D;});_Tmp1B->v=_Tmp1C;});_Tmp1B;});*f=_Tmp1A;});goto _LL1C;}}else{
goto _LL1C;}_LL1C:;}
# 787
({struct Cyc_List_List*_Tmp18=Cyc_Tctyp_add_free_tvar(loc,env.kind_env,v,env.allow_aqual_bounds);env.kind_env=_Tmp18;});
# 790
({struct Cyc_List_List*_Tmp18=Cyc_Tctyp_fast_add_free_tvar_bool(env.free_vars,v,put_in_effect);env.free_vars=_Tmp18;});
# 792
{void*_Tmp18=Cyc_Kinds_compress_kb(v->kind);void*_Tmp19;void*_Tmp1A;if(*((int*)_Tmp18)==2){_Tmp1A=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp18)->f1;_Tmp19=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp18)->f2;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp1A;struct Cyc_Absyn_Kind*k=_Tmp19;
# 794
if(Cyc_Kinds_kind_leq(expected_kind,k))
({struct Cyc_Core_Opt*_Tmp1B=({struct Cyc_Core_Opt*_Tmp1C=_cycalloc(sizeof(struct Cyc_Core_Opt));({void*_Tmp1D=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp1E=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp1E->tag=2,_Tmp1E->f1=0,_Tmp1E->f2=expected_kind;_Tmp1E;});_Tmp1C->v=_Tmp1D;});_Tmp1C;});*f=_Tmp1B;});
goto _LL21;}}else{
goto _LL21;}_LL21:;}
# 799
goto _LL3;}case 10: _Tmp17=((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_Tmp2)->f1->r;_Tmp16=(void***)&((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_Tmp2)->f2;{void*td=_Tmp17;void***topt=_Tmp16;
# 804
void*new_typ=Cyc_Tcutil_copy_type(Cyc_Absyn_compress(t));
{void*_Tmp18;switch(*((int*)td)){case 0: _Tmp18=((struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)td)->f1;{struct Cyc_Absyn_Aggrdecl*ad=_Tmp18;
# 807
if(env.te->in_extern_c_include)
ad->sc=4U;
Cyc_Tc_tcAggrdecl(te,loc,ad);goto _LL26;}case 1: _Tmp18=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)td)->f1;{struct Cyc_Absyn_Enumdecl*ed=_Tmp18;
# 811
if(env.te->in_extern_c_include)
ed->sc=4U;
Cyc_Tc_tcEnumdecl(te,loc,ed);goto _LL26;}default: _Tmp18=((struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)td)->f1;{struct Cyc_Absyn_Datatypedecl*dd=_Tmp18;
# 815
Cyc_Tc_tcDatatypedecl(te,loc,dd);goto _LL26;}}_LL26:;}
# 817
({void**_Tmp18=({void**_Tmp19=_cycalloc(sizeof(void*));*_Tmp19=new_typ;_Tmp19;});*topt=_Tmp18;});
return Cyc_Tctyp_i_check_type(env,expected_kind,new_typ,put_in_effect,allow_abs_aggr);}case 4: _Tmp17=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.elt_type;_Tmp16=(struct Cyc_Absyn_Tqual*)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.elt_tq;_Tmp14=(void**)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.eff;_Tmp13=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.nullable;_Tmp12=(void**)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.bounds;_Tmp11=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.zero_term;_Tmp10=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.autoreleased;_TmpF=(void**)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.aqual;{void*t1=_Tmp17;struct Cyc_Absyn_Tqual*tqp=_Tmp16;void**eff_type=_Tmp14;void*nullable=_Tmp13;void**b=_Tmp12;void*zt=_Tmp11;void*rel=_Tmp10;void**aq=_TmpF;
# 822
void*override_aq=*aq;
{void*_Tmp18=*eff_type;if(*((int*)_Tmp18)==0)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp18)->f1)){case 7:
# 825
...
# 835
if(override_aq!=*aq){
{void*_Tmp18=*aq;void*_Tmp19;if(*((int*)_Tmp18)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp18)->f1)==17){if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp18)->f2!=0){if(*((int*)((struct Cyc_List_List*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp18)->f2)->hd)==1){_Tmp19=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp18)->f2->tl;{struct Cyc_List_List*bnd=_Tmp19;
# 838
goto _LL34;}}else{goto _LL37;}}else{goto _LL37;}}else{goto _LL37;}}else{_LL37:
# 840
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("`U and `RC shorthands override explicit aqual",sizeof(char),46U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});}_LL34:;}
# 842
*aq=override_aq;}
# 844
if((int)expected_kind->kind==2 && Cyc_Tcutil_is_cvar_type(*b))
({void*_Tmp18=Cyc_Absyn_bounds_one();*b=_Tmp18;});
# 847
...
({int _Tmp18=Cyc_Tcutil_extract_const_from_typedef(env.loc,tqp->print_const,t1);tqp->real_const=_Tmp18;});
# 869
({void*_Tmp18=zt;Cyc_Unify_unify(_Tmp18,Cyc_Tcutil_is_char_type(t1)?Cyc_Absyn_true_type: Cyc_Absyn_false_type);});{
int is_zero_terminated=Cyc_Absyn_type2bool(0,zt);
if(is_zero_terminated && !Cyc_Tcutil_admits_zero(t1))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("cannot have a pointer to zero-terminated ",sizeof(char),42U);_Tmp19;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp19=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp1A;_Tmp1A.tag=2,_Tmp1A.f1=(void*)t1;_Tmp1A;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat(" elements",sizeof(char),10U);_Tmp1B;});void*_Tmp1B[3];_Tmp1B[0]=& _Tmp18,_Tmp1B[1]=& _Tmp19,_Tmp1B[2]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),3));});
# 875
if(!Cyc_Tcutil_is_cvar_type(*b)){
struct Cyc_Absyn_Exp*e=({void*_Tmp18=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_Tmp18,*b);});
if(e!=0){
struct _tuple13 _Tmp18=Cyc_Evexp_eval_const_uint_exp(e);int _Tmp19;unsigned _Tmp1A;_Tmp1A=_Tmp18.f0;_Tmp19=_Tmp18.f1;{unsigned sz=_Tmp1A;int known=_Tmp19;
if(is_zero_terminated &&(!known || sz < 1U))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=_tag_fat("zero-terminated pointer cannot point to empty sequence",sizeof(char),55U);_Tmp1C;});void*_Tmp1C[1];_Tmp1C[0]=& _Tmp1B;Cyc_Warn_err2(loc,_tag_fat(_Tmp1C,sizeof(void*),1));});}}}
# 883
goto _LL3;}}case 9: _Tmp17=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_Tmp2)->f1;{struct Cyc_Absyn_Exp*e=_Tmp17;
# 888
({struct Cyc_Tcenv_Tenv*_Tmp18=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp18,0,e);});
if(!Cyc_Tcutil_coerce_uint_type(e))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("valueof_t requires an int expression",sizeof(char),37U);_Tmp19;});void*_Tmp19[1];_Tmp19[0]=& _Tmp18;Cyc_Warn_err2(loc,_tag_fat(_Tmp19,sizeof(void*),1));});
env=Cyc_Tctyp_i_check_type_level_exp(e,env);
goto _LL3;}case 11: _Tmp17=((struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_Tmp2)->f1;{struct Cyc_Absyn_Exp*e=_Tmp17;
# 897
({struct Cyc_Tcenv_Tenv*_Tmp18=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp18,0,e);});
goto _LL3;}case 5: _Tmp17=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.elt_type;_Tmp16=(struct Cyc_Absyn_Tqual*)&((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.tq;_Tmp14=(struct Cyc_Absyn_Exp**)&((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.num_elts;_Tmp13=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.zero_term;_TmpE=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.zt_loc;{void*t1=_Tmp17;struct Cyc_Absyn_Tqual*tqp=_Tmp16;struct Cyc_Absyn_Exp**eptr=_Tmp14;void*zt=_Tmp13;unsigned ztl=_TmpE;
# 902
struct Cyc_Absyn_Exp*e=*eptr;
env=Cyc_Tctyp_i_check_type(env,& Cyc_Kinds_mk,t1,1,allow_abs_aggr);
({int _Tmp18=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t1);tqp->real_const=_Tmp18;});{
# 906
int is_zero_terminated=Cyc_Tcutil_force_type2bool(0,zt);
if(is_zero_terminated){
# 909
if(!Cyc_Tcutil_admits_zero(t1))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("cannot have a zero-terminated array of ",sizeof(char),40U);_Tmp19;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp19=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp1A;_Tmp1A.tag=2,_Tmp1A.f1=(void*)t1;_Tmp1A;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat(" elements",sizeof(char),10U);_Tmp1B;});void*_Tmp1B[3];_Tmp1B[0]=& _Tmp18,_Tmp1B[1]=& _Tmp19,_Tmp1B[2]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),3));});}
# 914
if(e==0){
# 917
if(!is_zero_terminated)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("array bound defaults to 1 here",sizeof(char),31U);_Tmp19;});void*_Tmp19[1];_Tmp19[0]=& _Tmp18;Cyc_Warn_warn2(loc,_tag_fat(_Tmp19,sizeof(void*),1));});
({struct Cyc_Absyn_Exp*_Tmp18=e=Cyc_Absyn_uint_exp(1U,0U);*eptr=_Tmp18;});}
# 921
({struct Cyc_Tcenv_Tenv*_Tmp18=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp18,0,e);});
if(!Cyc_Tcutil_coerce_uint_type(e))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("array bounds expression is not an unsigned int",sizeof(char),47U);_Tmp19;});void*_Tmp19[1];_Tmp19[0]=& _Tmp18;Cyc_Warn_err2(loc,_tag_fat(_Tmp19,sizeof(void*),1));});
env=Cyc_Tctyp_i_check_type_level_exp(e,env);{
struct _tuple13 _Tmp18=Cyc_Evexp_eval_const_uint_exp(e);int _Tmp19;unsigned _Tmp1A;_Tmp1A=_Tmp18.f0;_Tmp19=_Tmp18.f1;{unsigned sz=_Tmp1A;int known=_Tmp19;
# 927
if((is_zero_terminated && known)&& sz < 1U)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=_tag_fat("zero terminated array cannot have zero elements",sizeof(char),48U);_Tmp1C;});void*_Tmp1C[1];_Tmp1C[0]=& _Tmp1B;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1C,sizeof(void*),1));});
# 930
if((known && sz < 1U)&& Cyc_Flags_tovc_r){
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=_tag_fat("0-element arrays are supported only with gcc, changing to 1",sizeof(char),60U);_Tmp1C;});void*_Tmp1C[1];_Tmp1C[0]=& _Tmp1B;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1C,sizeof(void*),1));});
({struct Cyc_Absyn_Exp*_Tmp1B=Cyc_Absyn_uint_exp(1U,0U);*eptr=_Tmp1B;});}
# 934
goto _LL3;}}}}case 6: _Tmp17=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.tvars;_Tmp16=(void**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.effect;_Tmp14=(struct Cyc_Absyn_Tqual*)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ret_tqual;_Tmp13=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ret_type;_Tmp12=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.args;_TmpD=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.c_varargs;_Tmp11=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.cyc_varargs;_Tmp10=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.qual_bnd;_TmpF=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.attributes;_TmpC=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.requires_clause;_TmpB=(struct Cyc_AssnDef_ExistAssnFn**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.requires_assn;_TmpA=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ensures_clause;_Tmp9=(struct Cyc_AssnDef_ExistAssnFn**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ensures_assn;_Tmp8=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.throws_clause;_Tmp7=(struct Cyc_AssnDef_ExistAssnFn**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.throws_assn;_Tmp6=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.return_value;_Tmp5=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.arg_vardecls;_Tmp4=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.effconstr;{struct Cyc_List_List**btvs=_Tmp17;void**eff=_Tmp16;struct Cyc_Absyn_Tqual*rtq=_Tmp14;void*tr=_Tmp13;struct Cyc_List_List*args=_Tmp12;int c_vararg=_TmpD;struct Cyc_Absyn_VarargInfo*cyc_vararg=_Tmp11;struct Cyc_List_List**qb=(struct Cyc_List_List**)_Tmp10;struct Cyc_List_List*atts=_TmpF;struct Cyc_Absyn_Exp*req=_TmpC;struct Cyc_AssnDef_ExistAssnFn**req_relns=(struct Cyc_AssnDef_ExistAssnFn**)_TmpB;struct Cyc_Absyn_Exp*ens=_TmpA;struct Cyc_AssnDef_ExistAssnFn**ens_relns=(struct Cyc_AssnDef_ExistAssnFn**)_Tmp9;struct Cyc_Absyn_Exp*thrws=_Tmp8;struct Cyc_AssnDef_ExistAssnFn**thrws_relns=(struct Cyc_AssnDef_ExistAssnFn**)_Tmp7;struct Cyc_Absyn_Vardecl*return_vd=_Tmp6;struct Cyc_List_List*arg_vds=_Tmp5;struct Cyc_List_List*effc=_Tmp4;
# 943
int num_formats=0;
int is_cdecl=0;
int is_stdcall=0;
...
void*_Tmp18=(void*)atts->hd;int _Tmp19;int _Tmp1A;enum Cyc_Absyn_Format_Type _Tmp1B;switch(*((int*)_Tmp18)){case 1:
 is_stdcall=1;goto _LL44;case 2:
 is_cdecl=1;goto _LL44;case 3:
 is_fastcall=1;goto _LL44;case 19: _Tmp1B=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_Tmp18)->f1;_Tmp1A=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_Tmp18)->f2;_Tmp19=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_Tmp18)->f3;{enum Cyc_Absyn_Format_Type fmttype=_Tmp1B;int i=_Tmp1A;int j=_Tmp19;
# 956
++ num_formats;
ft=fmttype;
fmt_desc_arg=i;
...
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat("bad function type attribute ",sizeof(char),29U);_Tmp1D;});struct Cyc_Warn_Attribute_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_Attribute_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=10,_Tmp1E.f1=(void*)atts->hd;_Tmp1E;});void*_Tmp1E[2];_Tmp1E[0]=& _Tmp1C,_Tmp1E[1]=& _Tmp1D;Cyc_Warn_err2(loc,_tag_fat(_Tmp1E,sizeof(void*),2));});}_LL44:;}
# 965
if((is_stdcall + is_cdecl)+ is_fastcall > 1)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("function can't have multiple calling conventions",sizeof(char),49U);_Tmp19;});void*_Tmp19[1];_Tmp19[0]=& _Tmp18;Cyc_Warn_err2(loc,_tag_fat(_Tmp19,sizeof(void*),1));});
if(num_formats > 1)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("function can't have multiple format attributes",sizeof(char),47U);_Tmp19;});void*_Tmp19[1];_Tmp19[0]=& _Tmp18;Cyc_Warn_err2(loc,_tag_fat(_Tmp19,sizeof(void*),1));});
# 972
Cyc_Tcutil_check_unique_tvars(loc,*btvs);
{struct Cyc_List_List*b=*btvs;for(0;b!=0;b=b->tl){
({int _Tmp18=Cyc_Tcutil_new_tvar_id();((struct Cyc_Absyn_Tvar*)b->hd)->identity=_Tmp18;});
({struct Cyc_List_List*_Tmp18=Cyc_Tctyp_add_bound_tvar(env.kind_env,(struct Cyc_Absyn_Tvar*)b->hd);env.kind_env=_Tmp18;});{
void*_Tmp18=Cyc_Kinds_compress_kb(((struct Cyc_Absyn_Tvar*)b->hd)->kind);if(*((int*)_Tmp18)==0){if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_Tmp18)->f1)->kind==Cyc_Absyn_MemKind){
# 978
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A;_Tmp1A.tag=0,_Tmp1A.f1=_tag_fat("function abstracts Mem type variable ",sizeof(char),38U);_Tmp1A;});struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=7,_Tmp1B.f1=(struct Cyc_Absyn_Tvar*)b->hd;_Tmp1B;});void*_Tmp1B[2];_Tmp1B[0]=& _Tmp19,_Tmp1B[1]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),2));});goto _LL4F;}else{goto _LL52;}}else{_LL52:
 goto _LL4F;}_LL4F:;}}}{
# 984
struct Cyc_Tctyp_CVTEnv new_env=({struct Cyc_Tctyp_CVTEnv _Tmp18;_Tmp18.loc=loc,_Tmp18.te=te,_Tmp18.kind_env=env.kind_env,_Tmp18.fn_result=1,_Tmp18.def_aliasable=1,_Tmp18.inst_type_evar=0,_Tmp18.generalize_evars=env.generalize_evars,_Tmp18.allow_aqual_bounds=1,_Tmp18.free_vars=0,_Tmp18.free_evars=0,_Tmp18.free_qualvars=0;_Tmp18;});
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_mk,tr,1,1);
({int _Tmp18=Cyc_Tcutil_extract_const_from_typedef(loc,rtq->print_const,tr);rtq->real_const=_Tmp18;});
new_env.fn_result=0;
# 992
...
void*aqt=({void*_Tmp18=Cyc_Absyn_new_evar(& Cyc_Kinds_aqko,0);Cyc_Absyn_aqual_var_type(_Tmp18,Cyc_Absyn_al_qual_type);});
# 1006
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_aqk,aqt,1,1);
({void*_Tmp18=Cyc_Tcutil_promote_array(t,ptr_rgn,aqt,0);(*trip).f2=_Tmp18;});}}}}}
# 1011
if(cyc_vararg!=0){
if(c_vararg)({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("both c_vararg and cyc_vararg",sizeof(char),29U);_Tmp19;});void*_Tmp19[1];_Tmp19[0]=& _Tmp18;({int(*_Tmp1A)(struct _fat_ptr)=(int(*)(struct _fat_ptr))Cyc_Warn_impos2;_Tmp1A;})(_tag_fat(_Tmp19,sizeof(void*),1));});{
struct Cyc_Absyn_VarargInfo _Tmp18=*cyc_vararg;int _Tmp19;void*_Tmp1A;_Tmp1A=_Tmp18.type;_Tmp19=_Tmp18.inject;{void*vt=_Tmp1A;int vi=_Tmp19;
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_mk,vt,1,1);
({int _Tmp1B=Cyc_Tcutil_extract_const_from_typedef(loc,cyc_vararg->tq.print_const,vt);cyc_vararg->tq.real_const=_Tmp1B;});
# 1017
if(vi){
void*_Tmp1B=Cyc_Absyn_compress(vt);void*_Tmp1C;void*_Tmp1D;void*_Tmp1E;if(*((int*)_Tmp1B)==4){_Tmp1E=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1B)->f1.elt_type;_Tmp1D=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1B)->f1.ptr_atts.bounds;_Tmp1C=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1B)->f1.ptr_atts.zero_term;{void*et=_Tmp1E;void*bs=_Tmp1D;void*zt=_Tmp1C;
# 1020
{void*_Tmp1F=Cyc_Absyn_compress(et);if(*((int*)_Tmp1F)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1F)->f1)==22){
# 1022
if(Cyc_Tcutil_force_type2bool(0,zt))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp21;_Tmp21.tag=0,_Tmp21.f1=_tag_fat("can't inject into a zeroterm pointer",sizeof(char),37U);_Tmp21;});void*_Tmp21[1];_Tmp21[0]=& _Tmp20;Cyc_Warn_err2(loc,_tag_fat(_Tmp21,sizeof(void*),1));});
if(!({void*_Tmp20=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_Tmp20,bs);}))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp21;_Tmp21.tag=0,_Tmp21.f1=_tag_fat("can't inject into a fat pointer to datatype",sizeof(char),44U);_Tmp21;});void*_Tmp21[1];_Tmp21[0]=& _Tmp20;Cyc_Warn_err2(loc,_tag_fat(_Tmp21,sizeof(void*),1));});
goto _LL5C;}else{goto _LL5F;}}else{_LL5F:
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp21;_Tmp21.tag=0,_Tmp21.f1=_tag_fat("can't inject a non-datatype type",sizeof(char),33U);_Tmp21;});void*_Tmp21[1];_Tmp21[0]=& _Tmp20;Cyc_Warn_err2(loc,_tag_fat(_Tmp21,sizeof(void*),1));});goto _LL5C;}_LL5C:;}
# 1029
goto _LL57;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("expecting a datatype pointer type",sizeof(char),34U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});goto _LL57;}_LL57:;}}}}
# 1034
if(num_formats > 0){
...
# 1041
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("bad format descriptor",sizeof(char),22U);_Tmp19;});void*_Tmp19[1];_Tmp19[0]=& _Tmp18;Cyc_Warn_err2(loc,_tag_fat(_Tmp19,sizeof(void*),1));});else{
# 1044
struct _tuple9 _Tmp18=*({struct _tuple9*(*_Tmp19)(struct Cyc_List_List*,int)=(struct _tuple9*(*)(struct Cyc_List_List*,int))Cyc_List_nth;_Tmp19;})(args,fmt_desc_arg - 1);void*_Tmp19;_Tmp19=_Tmp18.f2;{void*t=_Tmp19;
# 1046
{void*_Tmp1A=Cyc_Absyn_compress(t);void*_Tmp1B;void*_Tmp1C;if(*((int*)_Tmp1A)==4){_Tmp1C=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1A)->f1.elt_type;_Tmp1B=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1A)->f1.ptr_atts.bounds;{void*et=_Tmp1C;void*b=_Tmp1B;
# 1049
if(!Cyc_Tcutil_is_char_type(et))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("format descriptor is not a string",sizeof(char),34U);_Tmp1E;});void*_Tmp1E[1];_Tmp1E[0]=& _Tmp1D;Cyc_Warn_err2(loc,_tag_fat(_Tmp1E,sizeof(void*),1));});else{
# 1052
if(!Cyc_Tcutil_is_cvar_type(b)){
struct Cyc_Absyn_Exp*e=({void*_Tmp1D=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_Tmp1D,b);});
if(e==0 && c_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("format descriptor is not a char * type",sizeof(char),39U);_Tmp1E;});void*_Tmp1E[1];_Tmp1E[0]=& _Tmp1D;Cyc_Warn_err2(loc,_tag_fat(_Tmp1E,sizeof(void*),1));});else{
if(e!=0 && !c_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("format descriptor is not a char ? type",sizeof(char),39U);_Tmp1E;});void*_Tmp1E[1];_Tmp1E[0]=& _Tmp1D;Cyc_Warn_err2(loc,_tag_fat(_Tmp1E,sizeof(void*),1));});}}else{
# 1060
if(c_vararg){
if(!({unsigned _Tmp1D=loc;Cyc_BansheeIf_add_constraint(_Tmp1D,({void*_Tmp1E=Cyc_Tcutil_ptrbnd_cvar_equivalent(b);Cyc_BansheeIf_equality_constraint(_Tmp1E,
Cyc_Absyn_thinconst());}));}))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("format descriptor is not a char ? type",sizeof(char),39U);_Tmp1E;});void*_Tmp1E[1];_Tmp1E[0]=& _Tmp1D;Cyc_Warn_err2(loc,_tag_fat(_Tmp1E,sizeof(void*),1));});}else{
# 1067
if(!({unsigned _Tmp1D=loc;Cyc_BansheeIf_add_constraint(_Tmp1D,({void*_Tmp1E=Cyc_Tcutil_ptrbnd_cvar_equivalent(b);Cyc_BansheeIf_equality_constraint(_Tmp1E,
Cyc_Absyn_fatconst());}));}))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("format descriptor is not a char * type",sizeof(char),39U);_Tmp1E;});void*_Tmp1E[1];_Tmp1E[0]=& _Tmp1D;Cyc_Warn_err2(loc,_tag_fat(_Tmp1E,sizeof(void*),1));});}}}
# 1074
goto _LL64;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("format descriptor is not a string type",sizeof(char),39U);_Tmp1E;});void*_Tmp1E[1];_Tmp1E[0]=& _Tmp1D;Cyc_Warn_err2(loc,_tag_fat(_Tmp1E,sizeof(void*),1));});goto _LL64;}_LL64:;}
# 1077
if(fmt_arg_start!=0 && !c_vararg){
# 1081
int problem;
{struct _tuple19 _Tmp1A=({struct _tuple19 _Tmp1B;_Tmp1B.f0=ft,({void*_Tmp1C=Cyc_Absyn_compress(Cyc_Tcutil_pointer_elt_type(cyc_vararg->type));_Tmp1B.f1=_Tmp1C;});_Tmp1B;});void*_Tmp1B;switch((int)_Tmp1A.f0){case Cyc_Absyn_Printf_ft: if(*((int*)_Tmp1A.f1)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A.f1)->f1)==22){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A.f1)->f1)->f1.KnownDatatype.tag==2){_Tmp1B=*((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A.f1)->f1)->f1.KnownDatatype.val;{struct Cyc_Absyn_Datatypedecl*tud=_Tmp1B;
# 1084
problem=({struct _tuple1*_Tmp1C=tud->name;Cyc_Absyn_qvar_cmp(_Tmp1C,Cyc_Absyn_datatype_print_arg_qvar());})!=0;
goto _LL69;}}else{goto _LL6E;}}else{goto _LL6E;}}else{goto _LL6E;}case Cyc_Absyn_Scanf_ft: if(*((int*)_Tmp1A.f1)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A.f1)->f1)==22){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A.f1)->f1)->f1.KnownDatatype.tag==2){_Tmp1B=*((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A.f1)->f1)->f1.KnownDatatype.val;{struct Cyc_Absyn_Datatypedecl*tud=_Tmp1B;
# 1087
problem=({struct _tuple1*_Tmp1C=tud->name;Cyc_Absyn_qvar_cmp(_Tmp1C,Cyc_Absyn_datatype_scanf_arg_qvar());})!=0;
...
# 1093
if(problem)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("format attribute and vararg types don't match",sizeof(char),46U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});}}}}
# 1099
{struct Cyc_List_List*qbit=*qb;for(0;qbit!=0;qbit=qbit->tl){
struct _tuple0*_Tmp18=(struct _tuple0*)qbit->hd;void*_Tmp19;void*_Tmp1A;_Tmp1A=_Tmp18->f0;_Tmp19=_Tmp18->f1;{void*tv=_Tmp1A;void*bnd=_Tmp19;
...
void*_Tmp18=(void*)ec->hd;void*_Tmp19;void*_Tmp1A;switch(*((int*)_Tmp18)){case 0: _Tmp1A=(void*)((struct Cyc_Absyn_SingleConstraint_Absyn_EffConstraint_struct*)_Tmp18)->f1;{void*t=_Tmp1A;
# 1108
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_ek,t,1,1);
goto _LL73;}case 1: _Tmp1A=(void*)((struct Cyc_Absyn_DisjointConstraint_Absyn_EffConstraint_struct*)_Tmp18)->f1;_Tmp19=(void*)((struct Cyc_Absyn_DisjointConstraint_Absyn_EffConstraint_struct*)_Tmp18)->f2;{void*t1=_Tmp1A;void*t2=_Tmp19;
_Tmp1A=t1;_Tmp19=t2;goto _LL79;}default: _Tmp1A=(void*)((struct Cyc_Absyn_SubsetConstraint_Absyn_EffConstraint_struct*)_Tmp18)->f1;_Tmp19=(void*)((struct Cyc_Absyn_SubsetConstraint_Absyn_EffConstraint_struct*)_Tmp18)->f2;_LL79: {void*t1=_Tmp1A;void*t2=_Tmp19;
# 1112
...
({struct Cyc_Tcenv_Tenv*_Tmp18=({struct Cyc_Tcenv_Tenv*_Tmp19=_cycalloc(sizeof(struct Cyc_Tcenv_Tenv));_Tmp19->ns=te->ns,_Tmp19->ae=te->ae,_Tmp19->le=fenv,_Tmp19->allow_valueof=1,_Tmp19->in_extern_c_include=te->in_extern_c_include,_Tmp19->in_tempest=te->in_tempest,_Tmp19->tempest_generalize=te->tempest_generalize,_Tmp19->in_extern_c_inc_repeat=te->in_extern_c_inc_repeat;_Tmp19;});new_env.te=_Tmp18;});{
# 1127
struct Cyc_List_List*vds;vds=_cycalloc(sizeof(struct Cyc_List_List)),vds->hd=Cyc_AssnDef_memory,vds->tl=arg_vds;
if(req!=0){
struct _tuple18 _Tmp18=Cyc_Tctyp_check_clause(new_env,_tag_fat("@requires",sizeof(char),10U),req);struct Cyc_AssnDef_AssnMap _Tmp19;struct Cyc_Tctyp_CVTEnv _Tmp1A;_Tmp1A=_Tmp18.f0;_Tmp19=_Tmp18.f1;{struct Cyc_Tctyp_CVTEnv nenv=_Tmp1A;struct Cyc_AssnDef_AssnMap req_assn=_Tmp19;
new_env=nenv;
({struct Cyc_AssnDef_ExistAssnFn*_Tmp1B=Cyc_AssnDef_assnmap2existassnfn(req_assn,vds);*req_relns=_Tmp1B;});}}
# 1133
if(ens!=0){
struct _tuple18 _Tmp18=Cyc_Tctyp_check_clause(new_env,_tag_fat("@ensures",sizeof(char),9U),ens);struct Cyc_AssnDef_AssnMap _Tmp19;struct Cyc_Tctyp_CVTEnv _Tmp1A;_Tmp1A=_Tmp18.f0;_Tmp19=_Tmp18.f1;{struct Cyc_Tctyp_CVTEnv nenv=_Tmp1A;struct Cyc_AssnDef_AssnMap ens_assn=_Tmp19;
new_env=nenv;
({struct Cyc_AssnDef_ExistAssnFn*_Tmp1B=({struct Cyc_AssnDef_AssnMap _Tmp1C=ens_assn;Cyc_AssnDef_assnmap2existassnfn(_Tmp1C,({struct Cyc_List_List*_Tmp1D=_cycalloc(sizeof(struct Cyc_List_List));_Tmp1D->hd=return_vd,_Tmp1D->tl=vds;_Tmp1D;}));});*ens_relns=_Tmp1B;});}}
# 1138
if(thrws!=0){
struct _tuple18 _Tmp18=Cyc_Tctyp_check_clause(new_env,_tag_fat("@throws",sizeof(char),8U),thrws);struct Cyc_AssnDef_AssnMap _Tmp19;struct Cyc_Tctyp_CVTEnv _Tmp1A;_Tmp1A=_Tmp18.f0;_Tmp19=_Tmp18.f1;{struct Cyc_Tctyp_CVTEnv nenv=_Tmp1A;struct Cyc_AssnDef_AssnMap thrws_assn=_Tmp19;
new_env=nenv;
({struct Cyc_AssnDef_ExistAssnFn*_Tmp1B=Cyc_AssnDef_assnmap2existassnfn(thrws_assn,vds);*thrws_relns=_Tmp1B;});}}
# 1143
new_env.te=old_te;
# 1145
if(*eff!=0){
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_ek,*eff,1,1);
if(!Cyc_Tcutil_type_in_effect(0,Cyc_Absyn_heap_rgn_type,*eff))
({void*_Tmp18=Cyc_Tcutil_normalize_effect(Cyc_Absyn_join_eff(({void*_Tmp19[2];_Tmp19[0]=Cyc_Absyn_heap_rgn_type,_Tmp19[1]=*eff;Cyc_List_list(_tag_fat(_Tmp19,sizeof(void*),2));})));*eff=_Tmp18;});}else{
# 1152
...
struct _tuple12 _Tmp18=*((struct _tuple12*)tvs->hd);int _Tmp19;void*_Tmp1A;_Tmp1A=_Tmp18.f0;_Tmp19=_Tmp18.f1;{struct Cyc_Absyn_Tvar*tv=_Tmp1A;int put_in_eff=_Tmp19;
if(!put_in_eff)continue;{
void*_Tmp1B=Cyc_Kinds_compress_kb(tv->kind);void*_Tmp1C;switch(*((int*)_Tmp1B)){case 2: switch((int)((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp1B)->f2)->kind){case Cyc_Absyn_BoolKind:
 goto _LL8A;case Cyc_Absyn_PtrBndKind: _LL8A:
 goto _LL8C;case Cyc_Absyn_IntKind: _LL8C:
 goto _LL8E;case Cyc_Absyn_EffKind: _Tmp1C=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp1B)->f1;{struct Cyc_Core_Opt**f=_Tmp1C;
# 1168
({struct Cyc_Core_Opt*_Tmp1D=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_ek);*f=_Tmp1D;});goto _LL96;}default: goto _LL99;}case 0: switch((int)((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_Tmp1B)->f1)->kind){case Cyc_Absyn_BoolKind: _LL8E:
# 1164
 goto _LL90;case Cyc_Absyn_PtrBndKind: _LL90:
 goto _LL92;case Cyc_Absyn_IntKind: _LL92:
 goto _LL86;case Cyc_Absyn_EffKind: _LL96:
# 1170
 effect=({struct Cyc_List_List*_Tmp1D=_cycalloc(sizeof(struct Cyc_List_List));({void*_Tmp1E=Cyc_Absyn_var_type(tv);_Tmp1D->hd=_Tmp1E;}),_Tmp1D->tl=effect;_Tmp1D;});goto _LL86;default: _LL99: _LL9A:
# 1175
 effect=({struct Cyc_List_List*_Tmp1D=_cycalloc(sizeof(struct Cyc_List_List));({void*_Tmp1E=Cyc_Absyn_regionsof_eff(Cyc_Absyn_var_type(tv));_Tmp1D->hd=_Tmp1E;}),_Tmp1D->tl=effect;_Tmp1D;});goto _LL86;}default: _Tmp1C=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_Tmp1B)->f1;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp1C;
# 1172
({struct Cyc_Core_Opt*_Tmp1D=({struct Cyc_Core_Opt*_Tmp1E=_cycalloc(sizeof(struct Cyc_Core_Opt));({void*_Tmp1F=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp20=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp20->tag=2,_Tmp20->f1=0,_Tmp20->f2=& Cyc_Kinds_ak;_Tmp20;});_Tmp1E->v=_Tmp1F;});_Tmp1E;});*f=_Tmp1D;});goto _LL9A;}}_LL86:;}}}}
# 1179
{struct Cyc_List_List*ts=new_env.free_evars;for(0;ts!=0;ts=ts->tl){
struct _tuple17 _Tmp18=*((struct _tuple17*)ts->hd);int _Tmp19;void*_Tmp1A;_Tmp1A=_Tmp18.f0;_Tmp19=_Tmp18.f1;{void*tv=_Tmp1A;int put_in_eff=_Tmp19;
if(!put_in_eff)continue;{
struct Cyc_Absyn_Kind*_Tmp1B=Cyc_Tcutil_type_kind(tv);switch((int)((struct Cyc_Absyn_Kind*)_Tmp1B)->kind){case Cyc_Absyn_EffKind:
# 1184
 effect=({struct Cyc_List_List*_Tmp1C=_cycalloc(sizeof(struct Cyc_List_List));_Tmp1C->hd=tv,_Tmp1C->tl=effect;_Tmp1C;});goto _LL9E;case Cyc_Absyn_IntKind:
 goto _LL9E;default:
 effect=({struct Cyc_List_List*_Tmp1C=_cycalloc(sizeof(struct Cyc_List_List));({void*_Tmp1D=Cyc_Absyn_regionsof_eff(tv);_Tmp1C->hd=_Tmp1D;}),_Tmp1C->tl=effect;_Tmp1C;});goto _LL9E;}_LL9E:;}}}}
# 1189
...
goto _LLA5;}case 2: _Tmp1A=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp18)->f1;_Tmp19=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp18)->f2;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp1A;struct Cyc_Absyn_Kind*k=_Tmp19;
# 1203
switch((int)((struct Cyc_Absyn_Kind*)k)->kind){case Cyc_Absyn_BoxKind:
 goto _LLB2;case Cyc_Absyn_MemKind: _LLB2:
 goto _LLB4;case Cyc_Absyn_AnyKind: _LLB4:
# 1207
({struct Cyc_Core_Opt*_Tmp1B=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_bk);*f=_Tmp1B;});goto _LLAE;case Cyc_Absyn_EffKind:
# 1209
({struct Cyc_Core_Opt*_Tmp1B=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_ek);*f=_Tmp1B;});goto _LLAE;default:
# 1211
({struct Cyc_Core_Opt*_Tmp1B=Cyc_Kinds_kind_to_bound_opt(k);*f=_Tmp1B;});goto _LLAE;}_LLAE:;
# 1213
goto _LLA5;}default: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_Tmp18)->f1)->kind==Cyc_Absyn_MemKind){
# 1215
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=_tag_fat("functions can't abstract M types",sizeof(char),33U);_Tmp1C;});void*_Tmp1C[1];_Tmp1C[0]=& _Tmp1B;Cyc_Warn_err2(loc,_tag_fat(_Tmp1C,sizeof(void*),1));});goto _LLA5;}else{
goto _LLA5;}}_LLA5:;}}
# 1219
({struct Cyc_List_List*_Tmp18=({struct Cyc_List_List*(*_Tmp19)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*))=(struct Cyc_List_List*(*)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*)))Cyc_Tctyp_remove_bound_tvars;_Tmp19;})(new_env.kind_env,*btvs,({struct Cyc_Absyn_Tvar*(*_Tmp19)(struct Cyc_Absyn_Tvar*)=(struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*))Cyc_Core_identity;_Tmp19;}));env.kind_env=_Tmp18;});
({struct Cyc_List_List*_Tmp18=({struct Cyc_List_List*(*_Tmp19)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct _tuple12*))=(struct Cyc_List_List*(*)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct _tuple12*)))Cyc_Tctyp_remove_bound_tvars;_Tmp19;})(new_env.free_vars,*btvs,({struct Cyc_Absyn_Tvar*(*_Tmp19)(struct _tuple12*)=(struct Cyc_Absyn_Tvar*(*)(struct _tuple12*))Cyc_Core_fst;_Tmp19;}));new_env.free_vars=_Tmp18;});
# 1222
{struct Cyc_List_List*tvs=new_env.free_vars;for(0;tvs!=0;tvs=tvs->tl){
struct _tuple12 _Tmp18=*((struct _tuple12*)tvs->hd);int _Tmp19;void*_Tmp1A;_Tmp1A=_Tmp18.f0;_Tmp19=_Tmp18.f1;{struct Cyc_Absyn_Tvar*t=_Tmp1A;int b=_Tmp19;
...
struct _tuple17 _Tmp18=*((struct _tuple17*)evs->hd);int _Tmp19;void*_Tmp1A;_Tmp1A=_Tmp18.f0;_Tmp19=_Tmp18.f1;{void*e=_Tmp1A;int b=_Tmp19;
...
if(!({int(*_Tmp18)(int(*)(struct _tuple17*,struct _tuple17*),struct _tuple17*,struct Cyc_List_List*)=(int(*)(int(*)(struct _tuple17*,struct _tuple17*),struct _tuple17*,struct Cyc_List_List*))Cyc_List_exists_c;_Tmp18;})(Cyc_Tctyp_cmp_fqv,(struct _tuple17*)it->hd,env.free_qualvars))
({struct Cyc_List_List*_Tmp18=({struct Cyc_List_List*_Tmp19=_cycalloc(sizeof(struct Cyc_List_List));_Tmp19->hd=(struct _tuple17*)it->hd,_Tmp19->tl=env.free_qualvars;_Tmp19;});env.free_qualvars=_Tmp18;});}}else{
# 1239
env.free_qualvars=new_env.free_qualvars;}
goto _LL3;}}}}case 7: _Tmp3=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp2)->f1;_TmpD=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp2)->f2;_Tmp17=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp2)->f3;{enum Cyc_Absyn_AggrKind k=_Tmp3;int is_tuple=_TmpD;struct Cyc_List_List*fs=_Tmp17;
# 1244
struct Cyc_List_List*prev_fields=0;
for(1;fs!=0;fs=fs->tl){
struct Cyc_Absyn_Aggrfield*_Tmp18=(struct Cyc_Absyn_Aggrfield*)fs->hd;void*_Tmp19;void*_Tmp1A;void*_Tmp1B;void*_Tmp1C;void*_Tmp1D;void*_Tmp1E;_Tmp1E=_Tmp18->name;_Tmp1D=(struct Cyc_Absyn_Tqual*)& _Tmp18->tq;_Tmp1C=_Tmp18->type;_Tmp1B=_Tmp18->width;_Tmp1A=_Tmp18->attributes;_Tmp19=_Tmp18->requires_clause;{struct _fat_ptr*fn=_Tmp1E;struct Cyc_Absyn_Tqual*tqp=(struct Cyc_Absyn_Tqual*)_Tmp1D;void*t=_Tmp1C;struct Cyc_Absyn_Exp*width=_Tmp1B;struct Cyc_List_List*atts=_Tmp1A;struct Cyc_Absyn_Exp*requires_clause=_Tmp19;
if(({int(*_Tmp1F)(int(*)(struct _fat_ptr*,struct _fat_ptr*),struct Cyc_List_List*,struct _fat_ptr*)=(int(*)(int(*)(struct _fat_ptr*,struct _fat_ptr*),struct Cyc_List_List*,struct _fat_ptr*))Cyc_List_mem;_Tmp1F;})(Cyc_strptrcmp,prev_fields,fn))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("duplicate field ",sizeof(char),17U);_Tmp20;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp20=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp21;_Tmp21.tag=0,_Tmp21.f1=*fn;_Tmp21;});void*_Tmp21[2];_Tmp21[0]=& _Tmp1F,_Tmp21[1]=& _Tmp20;Cyc_Warn_err2(loc,_tag_fat(_Tmp21,sizeof(void*),2));});
if(Cyc_strcmp(*fn,_tag_fat("",sizeof(char),1U))!=0)
prev_fields=({struct Cyc_List_List*_Tmp1F=_cycalloc(sizeof(struct Cyc_List_List));_Tmp1F->hd=fn,_Tmp1F->tl=prev_fields;_Tmp1F;});
env=Cyc_Tctyp_i_check_type(env,& Cyc_Kinds_mk,t,1,0);
({int _Tmp1F=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t);tqp->real_const=_Tmp1F;});
Cyc_Tcutil_check_bitfield(loc,t,width,fn);
Cyc_Atts_check_field_atts(loc,fn,atts);
if(requires_clause!=0){
# 1257
if((int)k!=1)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("@requires clause is only allowed on union members",sizeof(char),50U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});
({struct Cyc_Tcenv_Tenv*_Tmp1F=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp1F,0,requires_clause);});
if(!Cyc_Tcutil_is_integral(requires_clause))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("@requires clause has type ",sizeof(char),27U);_Tmp20;});struct Cyc_Warn_TypOpt_Warn_Warg_struct _Tmp20=({struct Cyc_Warn_TypOpt_Warn_Warg_struct _Tmp21;_Tmp21.tag=3,_Tmp21.f1=(void*)requires_clause->topt;_Tmp21;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp21=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp22;_Tmp22.tag=0,_Tmp22.f1=
_tag_fat(" instead of integral type",sizeof(char),26U);_Tmp22;});void*_Tmp22[3];_Tmp22[0]=& _Tmp1F,_Tmp22[1]=& _Tmp20,_Tmp22[2]=& _Tmp21;Cyc_Warn_err2(loc,_tag_fat(_Tmp22,sizeof(void*),3));});
env=Cyc_Tctyp_i_check_type_level_exp(requires_clause,env);}}}
# 1266
goto _LL3;}default: _Tmp17=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f1;_Tmp16=(struct Cyc_List_List**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f2;_Tmp14=(struct Cyc_Absyn_Typedefdecl**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f3;_Tmp13=(void**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f4;{struct _tuple1*tdn=_Tmp17;struct Cyc_List_List**targs_ref=(struct Cyc_List_List**)_Tmp16;struct Cyc_Absyn_Typedefdecl**tdopt=(struct Cyc_Absyn_Typedefdecl**)_Tmp14;void**toptp=(void**)_Tmp13;
# 1270
struct Cyc_Absyn_Typedefdecl*td;
{struct _handler_cons _Tmp18;_push_handler(& _Tmp18);{int _Tmp19=0;if(setjmp(_Tmp18.handler))_Tmp19=1;if(!_Tmp19){td=Cyc_Tcenv_lookup_typedefdecl(te,loc,tdn);;_pop_handler();}else{void*_Tmp1A=(void*)Cyc_Core_get_exn_thrown();void*_Tmp1B;if(((struct Cyc_Dict_Absent_exn_struct*)_Tmp1A)->tag==Cyc_Dict_Absent){
# 1274
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat("unbound typedef name ",sizeof(char),22U);_Tmp1D;});struct Cyc_Warn_Qvar_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_Qvar_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=1,_Tmp1E.f1=tdn;_Tmp1E;});void*_Tmp1E[2];_Tmp1E[0]=& _Tmp1C,_Tmp1E[1]=& _Tmp1D;Cyc_Warn_err2(loc,_tag_fat(_Tmp1E,sizeof(void*),2));});
return env;}else{_Tmp1B=_Tmp1A;{void*exn=_Tmp1B;_rethrow(exn);}};}}}
# 1277
*tdopt=td;
...
inst=({struct Cyc_List_List*_Tmp18=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple20*_Tmp19=({struct _tuple20*_Tmp1A=_cycalloc(sizeof(struct _tuple20));_Tmp1A->f0=(struct Cyc_Absyn_Tvar*)tvs->hd,_Tmp1A->f1=(void*)ts->hd;_Tmp1A;});_Tmp18->hd=_Tmp19;}),_Tmp18->tl=inst;_Tmp18;});}
({void*_Tmp18=Cyc_Tcutil_substitute(inst,td->defn);*toptp=_Tmp18;});}
# 1288
goto _LL3;}}_LL3:;}
# 1290
...
struct _tuple17 _Tmp0=*((struct _tuple17*)evs->hd);void*_Tmp1;_Tmp1=_Tmp0.f0;{void*e=_Tmp1;
