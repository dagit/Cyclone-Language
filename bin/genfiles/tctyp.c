...
# 145
 if(!Cyc_Unify_unify(e,Cyc_Absyn_heap_rgn_type))({void*_tmp1C=0U;({struct _fat_ptr _tmp284=({const char*_tmp1D="can't unify evar with heap!";_tag_fat(_tmp1D,sizeof(char),28U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp284,_tag_fat(_tmp1C,sizeof(void*),0U));});});
goto _LL5;default: goto _LL12;}case Cyc_Absyn_EffKind: _LLC: _LLD:
# 148
 if(!Cyc_Unify_unify(e,Cyc_Absyn_empty_effect))({void*_tmp1E=0U;({struct _fat_ptr _tmp285=({const char*_tmp1F="can't unify evar with {}!";_tag_fat(_tmp1F,sizeof(char),26U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp285,_tag_fat(_tmp1E,sizeof(void*),0U));});});
goto _LL5;case Cyc_Absyn_BoolKind: _LLE: _LLF:
# 151
 if(!Cyc_Unify_unify(e,Cyc_Absyn_false_type))({struct Cyc_String_pa_PrintArg_struct _tmp22=({struct Cyc_String_pa_PrintArg_struct _tmp249;_tmp249.tag=0U,({
...
# 155
 if(!({void*_tmp288=e;Cyc_Unify_unify(_tmp288,Cyc_Absyn_bounds_one());}))
({void*_tmp23=0U;({struct _fat_ptr _tmp289=({const char*_tmp24="can't unify evar with bounds_one!";_tag_fat(_tmp24,sizeof(char),34U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp289,_tag_fat(_tmp23,sizeof(void*),0U));});});
...
({void*_tmp2F5=_tmp1CF;Cyc_Unify_unify(_tmp2F5,Cyc_Tcutil_is_char_type(_tmp1D4)?Cyc_Absyn_true_type: Cyc_Absyn_false_type);});
...
if(!({void*_tmp321=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp321,_tmp143);}))
