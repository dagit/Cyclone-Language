...
struct _tuple13*_tmp2=(struct _tuple13*)es2->hd;struct _tuple13*_tmp3=_tmp2;void*_tmp8;int*_tmp7;_LL6: _tmp8=_tmp3->f1;_tmp7=(int*)& _tmp3->f2;_LL7:;{
...
goto _LL8;}else{_LLB: _LLC:
 goto _LL8;}_LL8:;};}}
# 78
return({struct Cyc_List_List*_tmpA=_region_malloc(r,sizeof(*_tmpA));({struct _tuple13*_tmp27B=({struct _tuple13*_tmp9=_region_malloc(r,sizeof(*_tmp9));_tmp9->f1=e,_tmp9->f2=b;_tmp9;});_tmpA->hd=_tmp27B;}),_tmpA->tl=es;_tmpA;});}else{_LL3: _LL4:
 return es;}_LL0:;}
# 84
...
for(0;tvs != 0;tvs=tvs->tl){
struct _tuple14 _tmp11=*((struct _tuple14*)tvs->hd);struct _tuple14 _tmp12=_tmp11;struct Cyc_Absyn_Tvar*_tmp15;int _tmp14;_LL1: _tmp15=_tmp12.f1;_tmp14=_tmp12.f2;_LL2:;{
int present=0;
{struct Cyc_List_List*b=btvs;for(0;b != 0;b=b->tl){
...
# 118
if(!present)
res=({struct Cyc_List_List*_tmp13=_region_malloc(r,sizeof(*_tmp13));_tmp13->hd=(struct _tuple14*)tvs->hd,_tmp13->tl=res;_tmp13;});};}
# 121
...
{struct Cyc_List_List*tvs2=tvs;for(0;tvs2 != 0;tvs2=tvs2->tl){
struct _tuple14*_tmp4F=(struct _tuple14*)tvs2->hd;struct _tuple14*_tmp50=_tmp4F;struct Cyc_Absyn_Tvar*_tmp54;int*_tmp53;_LL1: _tmp54=_tmp50->f1;_tmp53=(int*)& _tmp50->f2;_LL2:;
...
return tvs;}}}
# 252
return({struct Cyc_List_List*_tmp56=_region_malloc(r,sizeof(*_tmp56));({struct _tuple14*_tmp299=({struct _tuple14*_tmp55=_region_malloc(r,sizeof(*_tmp55));_tmp55->f1=tv,_tmp55->f2=b;_tmp55;});_tmp56->hd=_tmp299;}),_tmp56->tl=tvs;_tmp56;});}
# 255
...
# 329
return({struct _tuple15 _tmp251;_tmp251.f1=cvtenv,_tmp251.f2=relns;_tmp251;});}
# 359 "tctyp.cyc"
...
if(_tmp103 != 0){
struct _tuple12 _tmp104=Cyc_Evexp_eval_const_uint_exp(_tmp103);struct _tuple12 _tmp105=_tmp104;unsigned _tmp109;int _tmp108;_LL34: _tmp109=_tmp105.f1;_tmp108=_tmp105.f2;_LL35:;
...
# 823
struct _tuple12 _tmp114=Cyc_Evexp_eval_const_uint_exp(_tmp10C);struct _tuple12 _tmp115=_tmp114;unsigned _tmp11B;int _tmp11A;_LL37: _tmp11B=_tmp115.f1;_tmp11A=_tmp115.f2;_LL38:;
# 825
...
struct _tuple15 _tmp167=({unsigned _tmp336=loc;struct Cyc_Tcenv_Tenv*_tmp335=_tmp166;struct Cyc_Tctyp_CVTEnv _tmp334=_tmp12D;struct _fat_ptr _tmp333=({const char*_tmp1A3="@requires";_tag_fat(_tmp1A3,sizeof(char),10U);});Cyc_Tctyp_check_clause(_tmp336,_tmp335,_tmp334,_tmp333,_tmp1DF);});struct _tuple15 _tmp168=_tmp167;struct Cyc_Tctyp_CVTEnv _tmp1A2;struct Cyc_List_List*_tmp1A1;_LL69: _tmp1A2=_tmp168.f1;_tmp1A1=_tmp168.f2;_LL6A:;
_tmp12D=_tmp1A2;
*_tmp1DE=_tmp1A1;
...
struct _tuple15 _tmp169=({unsigned _tmp33A=loc;struct Cyc_Tcenv_Tenv*_tmp339=_tmp166;struct Cyc_Tctyp_CVTEnv _tmp338=_tmp12D;struct _fat_ptr _tmp337=({const char*_tmp1A0="@ensures";_tag_fat(_tmp1A0,sizeof(char),9U);});Cyc_Tctyp_check_clause(_tmp33A,_tmp339,_tmp338,_tmp337,_tmp1DD);});struct _tuple15 _tmp16A=_tmp169;struct Cyc_Tctyp_CVTEnv _tmp19F;struct Cyc_List_List*_tmp19E;_LL6C: _tmp19F=_tmp16A.f1;_tmp19E=_tmp16A.f2;_LL6D:;
_tmp12D=_tmp19F;
*_tmp1DC=_tmp19E;
...
struct _tuple14 _tmp16B=*((struct _tuple14*)tvs->hd);struct _tuple14 _tmp16C=_tmp16B;struct Cyc_Absyn_Tvar*_tmp17A;int _tmp179;_LL6F: _tmp17A=_tmp16C.f1;_tmp179=_tmp16C.f2;_LL70:;
if(!_tmp179)continue;{
...
struct _tuple13 _tmp17B=*((struct _tuple13*)ts->hd);struct _tuple13 _tmp17C=_tmp17B;void*_tmp183;int _tmp182;_LL8B: _tmp183=_tmp17C.f1;_tmp182=_tmp17C.f2;_LL8C:;
if(!_tmp182)continue;{
...
# 1092
{struct Cyc_List_List*tvs=_tmp12D.free_vars;for(0;tvs != 0;tvs=tvs->tl){
struct _tuple14 _tmp196=*((struct _tuple14*)tvs->hd);struct _tuple14 _tmp197=_tmp196;struct Cyc_Absyn_Tvar*_tmp199;int _tmp198;_LLB0: _tmp199=_tmp197.f1;_tmp198=_tmp197.f2;_LLB1:;
...
struct _tuple13 _tmp19A=*((struct _tuple13*)evs->hd);struct _tuple13 _tmp19B=_tmp19A;void*_tmp19D;int _tmp19C;_LLB3: _tmp19D=_tmp19B.f1;_tmp19C=_tmp19B.f2;_LLB4:;
...
struct _tuple17*_tmp1A5=(struct _tuple17*)_tmp1E9->hd;
...
cvtenv=Cyc_Tctyp_i_check_valid_type(loc,te,cvtenv,k,(void*)ts->hd,1,allow_abs_aggr);
Cyc_Tcutil_check_no_qual(loc,(void*)ts->hd);
inst=({struct Cyc_List_List*_tmp1C1=_cycalloc(sizeof(*_tmp1C1));({struct _tuple18*_tmp360=({struct _tuple18*_tmp1C0=_cycalloc(sizeof(*_tmp1C0));_tmp1C0->f1=(struct Cyc_Absyn_Tvar*)tvs->hd,_tmp1C0->f2=(void*)ts->hd;_tmp1C0;});_tmp1C1->hd=_tmp360;}),_tmp1C1->tl=inst;_tmp1C1;});}
# 1161
if(ts != 0)
...
cvtenv=Cyc_Tctyp_i_check_valid_type(loc,te,cvtenv,k,e,1,allow_abs_aggr);
inst=({struct Cyc_List_List*_tmp1C7=_cycalloc(sizeof(*_tmp1C7));({struct _tuple18*_tmp364=({struct _tuple18*_tmp1C6=_cycalloc(sizeof(*_tmp1C6));_tmp1C6->f1=(struct Cyc_Absyn_Tvar*)tvs->hd,_tmp1C6->f2=e;_tmp1C6;});_tmp1C7->hd=_tmp364;}),_tmp1C7->tl=inst;_tmp1C7;});}
# 1174
...
({struct Cyc_List_List*_tmp36E=Cyc_Tctyp_fast_add_free_tvar(_tmp20A,(*((struct _tuple14*)vs->hd)).f1);cvt.kind_env=_tmp36E;});}}
# 1256
{struct Cyc_List_List*evs=cvt.free_evars;for(0;evs != 0;evs=evs->tl){
struct _tuple13 _tmp20B=*((struct _tuple13*)evs->hd);struct _tuple13 _tmp20C=_tmp20B;void*_tmp215;_LL1: _tmp215=_tmp20C.f1;_LL2:;{
...
# 1291
struct Cyc_List_List*_tmp218=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Tvar*(*f)(struct _tuple14*),struct Cyc_List_List*x))Cyc_List_map)((struct Cyc_Absyn_Tvar*(*)(struct _tuple14*))Cyc_Core_fst,_tmp217.free_vars);
struct Cyc_List_List*_tmp219=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple13*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple13*))Cyc_Core_fst,_tmp217.free_evars);
# 1295
if(_tmp216 != 0){
...
# 1383
struct Cyc_List_List*_tmp23D=({struct _RegionHandle*_tmp38A=Cyc_Core_heap_region;struct Cyc_List_List*_tmp389=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Tvar*(*f)(struct _tuple14*),struct Cyc_List_List*x))Cyc_List_map)((struct Cyc_Absyn_Tvar*(*)(struct _tuple14*))Cyc_Core_fst,_tmp23C.free_vars);Cyc_Tctyp_remove_bound_tvars(_tmp38A,_tmp389,bound_tvars);});
# 1385
struct Cyc_List_List*_tmp23E=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple13*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple13*))Cyc_Core_fst,_tmp23C.free_evars);
