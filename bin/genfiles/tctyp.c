...
# 72
void Cyc_Atts_check_field_atts(unsigned,struct _fat_ptr*,struct Cyc_List_List*);struct _tuple12{unsigned f0;int f1;};
# 28 "evexp.h"
...
# 88 "tctyp.cyc"
static struct Cyc_Tctyp_CVTEnv Cyc_Tctyp_i_check_type(struct Cyc_Tctyp_CVTEnv,struct Cyc_Absyn_Kind*,void*,int,int);struct _tuple13{void*f0;int f1;};
# 94
...
struct _tuple13*_Tmp2=(struct _tuple13*)es2->hd;void*_Tmp3;void*_Tmp4;_Tmp4=_Tmp2->f0;_Tmp3=(int*)& _Tmp2->f1;{void*t=_Tmp4;int*b2=(int*)_Tmp3;
...
goto _LL8;}_LL8:;}}}
# 109
return({struct Cyc_List_List*_Tmp2=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple13*_Tmp3=({struct _tuple13*_Tmp4=_cycalloc(sizeof(struct _tuple13));_Tmp4->f0=e,_Tmp4->f1=b;_Tmp4;});_Tmp2->hd=_Tmp3;}),_Tmp2->tl=es;_Tmp2;});}}else{
return es;};}
# 115
...
void*e=(*((struct _tuple13*)free_evars->hd)).f0;
...
return tvs;}}
# 204
return({struct Cyc_List_List*_Tmp0=_cycalloc(sizeof(struct Cyc_List_List));_Tmp0->hd=tv,_Tmp0->tl=tvs;_Tmp0;});}struct _tuple14{struct Cyc_Absyn_Tvar*f0;int f1;};
# 210
...
{struct Cyc_List_List*tvs2=tvs;for(0;tvs2!=0;tvs2=tvs2->tl){
struct _tuple14*_Tmp0=(struct _tuple14*)tvs2->hd;void*_Tmp1;void*_Tmp2;_Tmp2=_Tmp0->f0;_Tmp1=(int*)& _Tmp0->f1;{struct Cyc_Absyn_Tvar*tv2=_Tmp2;int*b2=(int*)_Tmp1;
if(tv2->identity==-1)
...
return tvs;}}}}
# 222
return({struct Cyc_List_List*_Tmp0=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple14*_Tmp1=({struct _tuple14*_Tmp2=_cycalloc(sizeof(struct _tuple14));_Tmp2->f0=tv,_Tmp2->f1=b;_Tmp2;});_Tmp0->hd=_Tmp1;}),_Tmp0->tl=tvs;_Tmp0;});}
# 229
...
({struct Cyc_List_List*_Tmp4=({struct Cyc_List_List*_Tmp5=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple13*_Tmp6=({struct _tuple13*_Tmp7=_cycalloc(sizeof(struct _tuple13));_Tmp7->f0=apptype,_Tmp7->f1=0;_Tmp7;});_Tmp5->hd=_Tmp6;}),_Tmp5->tl=env.free_qualvars;_Tmp5;});env.free_qualvars=_Tmp4;});
return env;case 3:
# 503
 for(1;ts!=0;ts=ts->tl){
...
void*_Tmp0;_Tmp0=bnd->f0;{void*v=_Tmp0;
...
struct _tuple13*_Tmp0=(struct _tuple13*)vars->hd;void*_Tmp1;_Tmp1=_Tmp0->f0;{void*v=_Tmp1;
...
# 617
({struct Cyc_List_List*_Tmp4=({struct Cyc_List_List*_Tmp5=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple0*_Tmp6=({struct _tuple0*_Tmp7=_cycalloc(sizeof(struct _tuple0));_Tmp7->f0=aqt,_Tmp7->f1=Cyc_Absyn_rtd_qual_type;_Tmp7;});_Tmp5->hd=_Tmp6;}),_Tmp5->tl=*qb;_Tmp5;});*qb=_Tmp4;});
goto _LLA;case Cyc_Absyn_UniqueHint:
# 620
({struct Cyc_List_List*_Tmp4=({struct Cyc_List_List*_Tmp5=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple0*_Tmp6=({struct _tuple0*_Tmp7=_cycalloc(sizeof(struct _tuple0));_Tmp7->f0=aqt,_Tmp7->f1=Cyc_Absyn_un_qual_type;_Tmp7;});_Tmp5->hd=_Tmp6;}),_Tmp5->tl=*qb;_Tmp5;});*qb=_Tmp4;});
goto _LLA;case Cyc_Absyn_RefcntHint:
# 623
({struct Cyc_List_List*_Tmp4=({struct Cyc_List_List*_Tmp5=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple0*_Tmp6=({struct _tuple0*_Tmp7=_cycalloc(sizeof(struct _tuple0));_Tmp7->f0=aqt,_Tmp7->f1=Cyc_Absyn_rc_qual_type;_Tmp7;});_Tmp5->hd=_Tmp6;}),_Tmp5->tl=*qb;_Tmp5;});*qb=_Tmp4;});
goto _LLA;default:
# 626
({struct Cyc_List_List*_Tmp4=({struct Cyc_List_List*_Tmp5=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple0*_Tmp6=({struct _tuple0*_Tmp7=_cycalloc(sizeof(struct _tuple0));_Tmp7->f0=aqt,_Tmp7->f1=def;_Tmp7;});_Tmp5->hd=_Tmp6;}),_Tmp5->tl=*qb;_Tmp5;});*qb=_Tmp4;});
goto _LLA;}_LLA:;}}
# 631
...
return({struct _tuple13*_Tmp2=_cycalloc(sizeof(struct _tuple13));_Tmp2->f0=t,_Tmp2->f1=b;_Tmp2;});}}
# 645
...
struct _tuple13*_Tmp0=(struct _tuple13*)fq->hd;int _Tmp1;void*_Tmp2;_Tmp2=_Tmp0->f0;_Tmp1=_Tmp0->f1;{void*t=_Tmp2;int b=_Tmp1;
...
if(b)
({struct Cyc_List_List*_Tmp4=({struct Cyc_List_List*_Tmp5=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple0*_Tmp6=({struct _tuple0*_Tmp7=_cycalloc(sizeof(struct _tuple0));_Tmp7->f0=tv,_Tmp7->f1=(void*)_check_null(tv_bnd->tl)->hd;_Tmp7;});_Tmp5->hd=_Tmp6;}),_Tmp5->tl=*qb;_Tmp5;});*qb=_Tmp4;});else{
# 663
...
# 672
({struct Cyc_List_List*_Tmp9=({struct Cyc_List_List*_TmpA=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple0*_TmpB=({struct _tuple0*_TmpC=_cycalloc(sizeof(struct _tuple0));_TmpC->f0=tv,_TmpC->f1=def;_TmpC;});_TmpA->hd=_TmpB;}),_TmpA->tl=*qb;_TmpA;});*qb=_Tmp9;});
...
# 686
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;})(_tag_fat("Only AqualVars are added to the list",sizeof(char),37U),_tag_fat(0U,sizeof(void*),0));}_LL3:;}}}}struct _tuple16{enum Cyc_Absyn_Format_Type f0;void*f1;};struct _tuple17{struct Cyc_Absyn_Tvar*f0;void*f1;};
# 691
...
if(e!=0){
struct _tuple12 _Tmp13=Cyc_Evexp_eval_const_uint_exp(e);int _Tmp14;unsigned _Tmp15;_Tmp15=_Tmp13.f0;_Tmp14=_Tmp13.f1;{unsigned sz=_Tmp15;int known=_Tmp14;
...
struct _tuple14 _Tmp19=*((struct _tuple14*)tvs->hd);int _Tmp1A;void*_Tmp1B;_Tmp1B=_Tmp19.f0;_Tmp1A=_Tmp19.f1;{struct Cyc_Absyn_Tvar*tv=_Tmp1B;int put_in_eff=_Tmp1A;
...
struct _tuple13 _Tmp19=*((struct _tuple13*)ts->hd);int _Tmp1A;void*_Tmp1B;_Tmp1B=_Tmp19.f0;_Tmp1A=_Tmp19.f1;{void*tv=_Tmp1B;int put_in_eff=_Tmp1A;
if(!put_in_eff)continue;{
...
# 1150
{struct Cyc_List_List*tvs=new_env.free_vars;for(0;tvs!=0;tvs=tvs->tl){
struct _tuple14 _Tmp19=*((struct _tuple14*)tvs->hd);int _Tmp1A;void*_Tmp1B;_Tmp1B=_Tmp19.f0;_Tmp1A=_Tmp19.f1;{struct Cyc_Absyn_Tvar*t=_Tmp1B;int b=_Tmp1A;
...
struct _tuple13 _Tmp19=*((struct _tuple13*)evs->hd);int _Tmp1A;void*_Tmp1B;_Tmp1B=_Tmp19.f0;_Tmp1A=_Tmp19.f1;{void*e=_Tmp1B;int b=_Tmp1A;
...
({struct Cyc_List_List*_Tmp0=Cyc_Tctyp_fast_add_free_tvar(kind_env,(*((struct _tuple14*)vs->hd)).f0);cvt.kind_env=_Tmp0;});}}
# 1234
{struct Cyc_List_List*evs=cvt.free_evars;for(0;evs!=0;evs=evs->tl){
struct _tuple13 _Tmp0=*((struct _tuple13*)evs->hd);void*_Tmp1;_Tmp1=_Tmp0.f0;{void*e=_Tmp1;
...
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp0=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1;_Tmp1.tag=0,_Tmp1.f1=_tag_fat("unbound type variable ",sizeof(char),23U);_Tmp1;});struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp1=({struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp2;_Tmp2.tag=7,_Tmp2.f1=(*((struct _tuple14*)free_tvs->hd)).f0;_Tmp2;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp2=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp3;_Tmp3.tag=0,_Tmp3.f1=_tag_fat(" in type ",sizeof(char),10U);_Tmp3;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp3=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp4;_Tmp4.tag=2,_Tmp4.f1=(void*)t;_Tmp4;});void*_Tmp4[4];_Tmp4[0]=& _Tmp0,_Tmp4[1]=& _Tmp1,_Tmp4[2]=& _Tmp2,_Tmp4[3]=& _Tmp3;Cyc_Warn_err2(loc,_tag_fat(_Tmp4,sizeof(void*),4));});}
if(!allow_evars)
