...
# 729
void*_Tmp0;unsigned _Tmp1;_Tmp1=env.loc;_Tmp0=env.te;{unsigned loc=_Tmp1;struct Cyc_Tcenv_Tenv*te=_Tmp0;
{void*_Tmp2=Cyc_Absyn_compress(t);enum Cyc_Absyn_AggrKind _Tmp3;void*_Tmp4;void*_Tmp5;void*_Tmp6;void*_Tmp7;void*_Tmp8;void*_Tmp9;void*_TmpA;void*_TmpB;void*_TmpC;int _TmpD;unsigned _TmpE;void*_TmpF;void*_Tmp10;void*_Tmp11;void*_Tmp12;void*_Tmp13;void*_Tmp14;void*_Tmp15;void*_Tmp16;switch(*((int*)_Tmp2)){case 0: _Tmp16=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp2)->f1;_Tmp15=(struct Cyc_List_List**)&((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp2)->f2;{void*c=_Tmp16;struct Cyc_List_List**targsp=_Tmp15;
# 732
env=Cyc_Tctyp_i_check_type_app(env,expected_kind,c,targsp,put_in_effect,allow_abs_aggr,t);
# 734
goto _LL3;}case 1: _Tmp16=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_Tmp2)->f1;_Tmp15=(void**)&((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_Tmp2)->f2;{struct Cyc_Core_Opt**k=_Tmp16;void**ref=_Tmp15;
# 737
if(*k==0 ||
 Cyc_Kinds_kind_leq(expected_kind,(struct Cyc_Absyn_Kind*)(*k)->v)&& !
Cyc_Kinds_kind_leq((struct Cyc_Absyn_Kind*)(*k)->v,expected_kind))
({struct Cyc_Core_Opt*_Tmp17=Cyc_Kinds_kind_to_opt(expected_kind);*k=_Tmp17;});
# 742
...
# 763
struct Cyc_Absyn_Tvar*v=Cyc_Tcutil_new_tvar((void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp17=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp17->tag=2,_Tmp17->f1=0,_Tmp17->f2=expected_kind;_Tmp17;}));
({void*_Tmp17=Cyc_Absyn_var_type(v);*ref=_Tmp17;});
_Tmp16=v;goto _LL9;}
# 767
({struct Cyc_List_List*_Tmp17=Cyc_Tctyp_add_free_evar(env.free_evars,t,put_in_effect);env.free_evars=_Tmp17;});
goto _LL3;}case 2: _Tmp16=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_Tmp2)->f1;_LL9: {struct Cyc_Absyn_Tvar*v=_Tmp16;
# 770
{void*_Tmp17=Cyc_Kinds_compress_kb(v->kind);void*_Tmp18;if(*((int*)_Tmp17)==1){_Tmp18=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_Tmp17)->f1;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp18;
({struct Cyc_Core_Opt*_Tmp19=({struct Cyc_Core_Opt*_Tmp1A=_cycalloc(sizeof(struct Cyc_Core_Opt));({void*_Tmp1B=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp1C=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp1C->tag=2,_Tmp1C->f1=0,_Tmp1C->f2=expected_kind;_Tmp1C;});_Tmp1A->v=_Tmp1B;});_Tmp1A;});*f=_Tmp19;});goto _LL1A;}}else{
goto _LL1A;}_LL1A:;}
# 776
({struct Cyc_List_List*_Tmp17=Cyc_Tctyp_add_free_tvar(loc,env.kind_env,v,env.allow_aqual_bounds);env.kind_env=_Tmp17;});
# 779
({struct Cyc_List_List*_Tmp17=Cyc_Tctyp_fast_add_free_tvar_bool(env.free_vars,v,put_in_effect);env.free_vars=_Tmp17;});
# 781
{void*_Tmp17=Cyc_Kinds_compress_kb(v->kind);void*_Tmp18;void*_Tmp19;if(*((int*)_Tmp17)==2){_Tmp19=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp17)->f1;_Tmp18=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp17)->f2;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp19;struct Cyc_Absyn_Kind*k=_Tmp18;
# 783
...
goto _LL1F;}_LL1F:;}
# 788
goto _LL3;}case 9: _Tmp16=((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_Tmp2)->f1->r;_Tmp15=(void***)&((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_Tmp2)->f2;{void*td=_Tmp16;void***topt=_Tmp15;
# 793
void*new_typ=Cyc_Tcutil_copy_type(Cyc_Absyn_compress(t));
{void*_Tmp17;switch(*((int*)td)){case 0: _Tmp17=((struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)td)->f1;{struct Cyc_Absyn_Aggrdecl*ad=_Tmp17;
# 796
if(env.te->in_extern_c_include)
ad->sc=4U;
Cyc_Tc_tcAggrdecl(te,loc,ad);goto _LL24;}case 1: _Tmp17=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)td)->f1;{struct Cyc_Absyn_Enumdecl*ed=_Tmp17;
# 800
if(env.te->in_extern_c_include)
ed->sc=4U;
Cyc_Tc_tcEnumdecl(te,loc,ed);goto _LL24;}default: _Tmp17=((struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)td)->f1;{struct Cyc_Absyn_Datatypedecl*dd=_Tmp17;
# 804
Cyc_Tc_tcDatatypedecl(te,loc,dd);goto _LL24;}}_LL24:;}
# 806
({void**_Tmp17=({void**_Tmp18=_cycalloc(sizeof(void*));*_Tmp18=new_typ;_Tmp18;});*topt=_Tmp17;});
return Cyc_Tctyp_i_check_type(env,expected_kind,new_typ,put_in_effect,allow_abs_aggr);}case 3: _Tmp16=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.elt_type;_Tmp15=(struct Cyc_Absyn_Tqual*)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.elt_tq;_Tmp14=(void**)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.eff;_Tmp13=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.nullable;_Tmp12=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.bounds;_Tmp11=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.zero_term;_Tmp10=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.autoreleased;_TmpF=(void**)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.aqual;{void*t1=_Tmp16;struct Cyc_Absyn_Tqual*tqp=_Tmp15;void**eff_type=_Tmp14;void*nullable=_Tmp13;void*b=_Tmp12;void*zt=_Tmp11;void*rel=_Tmp10;void**aq=_TmpF;
# 817
void*override_aq=*aq;
{void*_Tmp17=*eff_type;if(*((int*)_Tmp17)==0)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp17)->f1)){case 7:
# 820
...
# 843 "tctyp.cyc"
if(override_aq!=*aq){
{void*_Tmp17=*aq;void*_Tmp18;if(*((int*)_Tmp17)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp17)->f1)==17){if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp17)->f2!=0){if(*((int*)((struct Cyc_List_List*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp17)->f2)->hd)==1){_Tmp18=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp17)->f2->tl;{struct Cyc_List_List*bnd=_Tmp18;
# 846
goto _LL32;}}else{goto _LL35;}}else{goto _LL35;}}else{goto _LL35;}}else{_LL35:
# 848
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A;_Tmp1A.tag=0,_Tmp1A.f1=_tag_fat("`U and `RC shorthands override explicit aqual",sizeof(char),46U);_Tmp1A;});void*_Tmp1A[1];_Tmp1A[0]=& _Tmp19;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1A,sizeof(void*),1));});}_LL32:;}
# 850
*aq=override_aq;}
# 852
...
({int _Tmp17=Cyc_Tcutil_extract_const_from_typedef(env.loc,tqp->print_const,t1);tqp->real_const=_Tmp17;});
# 874
({void*_Tmp17=zt;Cyc_Unify_unify(_Tmp17,Cyc_Tcutil_is_char_type(t1)?Cyc_Absyn_true_type: Cyc_Absyn_false_type);});{
int is_zero_terminated=Cyc_Absyn_type2bool(0,zt);
if(is_zero_terminated && !Cyc_Tcutil_admits_zero(t1))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp17=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18;_Tmp18.tag=0,_Tmp18.f1=_tag_fat("cannot have a pointer to zero-terminated ",sizeof(char),42U);_Tmp18;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp19;_Tmp19.tag=2,_Tmp19.f1=(void*)t1;_Tmp19;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp19=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A;_Tmp1A.tag=0,_Tmp1A.f1=_tag_fat(" elements",sizeof(char),10U);_Tmp1A;});void*_Tmp1A[3];_Tmp1A[0]=& _Tmp17,_Tmp1A[1]=& _Tmp18,_Tmp1A[2]=& _Tmp19;Cyc_Warn_err2(loc,_tag_fat(_Tmp1A,sizeof(void*),3));});{
# 880
struct Cyc_Absyn_Exp*e=({void*_Tmp17=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_Tmp17,b);});
if(e!=0){
struct _tuple13 _Tmp17=Cyc_Evexp_eval_const_uint_exp(e);int _Tmp18;unsigned _Tmp19;_Tmp19=_Tmp17.f0;_Tmp18=_Tmp17.f1;{unsigned sz=_Tmp19;int known=_Tmp18;
if(is_zero_terminated &&(!known || sz < 1U))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("zero-terminated pointer cannot point to empty sequence",sizeof(char),55U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});}}
# 886
goto _LL3;}}}case 8: _Tmp16=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_Tmp2)->f1;{struct Cyc_Absyn_Exp*e=_Tmp16;
# 891
({struct Cyc_Tcenv_Tenv*_Tmp17=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp17,0,e);});
if(!Cyc_Tcutil_coerce_uint_type(e))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp17=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18;_Tmp18.tag=0,_Tmp18.f1=_tag_fat("valueof_t requires an int expression",sizeof(char),37U);_Tmp18;});void*_Tmp18[1];_Tmp18[0]=& _Tmp17;Cyc_Warn_err2(loc,_tag_fat(_Tmp18,sizeof(void*),1));});
env=Cyc_Tctyp_i_check_type_level_exp(e,env);
goto _LL3;}case 10: _Tmp16=((struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_Tmp2)->f1;{struct Cyc_Absyn_Exp*e=_Tmp16;
# 900
({struct Cyc_Tcenv_Tenv*_Tmp17=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp17,0,e);});
goto _LL3;}case 4: _Tmp16=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.elt_type;_Tmp15=(struct Cyc_Absyn_Tqual*)&((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.tq;_Tmp14=(struct Cyc_Absyn_Exp**)&((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.num_elts;_Tmp13=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.zero_term;_TmpE=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.zt_loc;{void*t1=_Tmp16;struct Cyc_Absyn_Tqual*tqp=_Tmp15;struct Cyc_Absyn_Exp**eptr=_Tmp14;void*zt=_Tmp13;unsigned ztl=_TmpE;
# 905
struct Cyc_Absyn_Exp*e=*eptr;
env=Cyc_Tctyp_i_check_type(env,& Cyc_Kinds_mk,t1,1,allow_abs_aggr);
({int _Tmp17=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t1);tqp->real_const=_Tmp17;});{
# 909
int is_zero_terminated=Cyc_Tcutil_force_type2bool(0,zt);
if(is_zero_terminated){
# 912
if(!Cyc_Tcutil_admits_zero(t1))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp17=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18;_Tmp18.tag=0,_Tmp18.f1=_tag_fat("cannot have a zero-terminated array of ",sizeof(char),40U);_Tmp18;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp19;_Tmp19.tag=2,_Tmp19.f1=(void*)t1;_Tmp19;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp19=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A;_Tmp1A.tag=0,_Tmp1A.f1=_tag_fat(" elements",sizeof(char),10U);_Tmp1A;});void*_Tmp1A[3];_Tmp1A[0]=& _Tmp17,_Tmp1A[1]=& _Tmp18,_Tmp1A[2]=& _Tmp19;Cyc_Warn_err2(loc,_tag_fat(_Tmp1A,sizeof(void*),3));});}
# 917
if(e==0){
# 920
if(!is_zero_terminated)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp17=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18;_Tmp18.tag=0,_Tmp18.f1=_tag_fat("array bound defaults to 1 here",sizeof(char),31U);_Tmp18;});void*_Tmp18[1];_Tmp18[0]=& _Tmp17;Cyc_Warn_warn2(loc,_tag_fat(_Tmp18,sizeof(void*),1));});
({struct Cyc_Absyn_Exp*_Tmp17=e=Cyc_Absyn_uint_exp(1U,0U);*eptr=_Tmp17;});}
# 924
({struct Cyc_Tcenv_Tenv*_Tmp17=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp17,0,e);});
if(!Cyc_Tcutil_coerce_uint_type(e))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp17=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18;_Tmp18.tag=0,_Tmp18.f1=_tag_fat("array bounds expression is not an unsigned int",sizeof(char),47U);_Tmp18;});void*_Tmp18[1];_Tmp18[0]=& _Tmp17;Cyc_Warn_err2(loc,_tag_fat(_Tmp18,sizeof(void*),1));});
env=Cyc_Tctyp_i_check_type_level_exp(e,env);{
struct _tuple13 _Tmp17=Cyc_Evexp_eval_const_uint_exp(e);int _Tmp18;unsigned _Tmp19;_Tmp19=_Tmp17.f0;_Tmp18=_Tmp17.f1;{unsigned sz=_Tmp19;int known=_Tmp18;
# 930
if((is_zero_terminated && known)&& sz < 1U)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("zero terminated array cannot have zero elements",sizeof(char),48U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});
# 933
if((known && sz < 1U)&& Cyc_Flags_tovc_r){
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("0-element arrays are supported only with gcc, changing to 1",sizeof(char),60U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});
({struct Cyc_Absyn_Exp*_Tmp1A=Cyc_Absyn_uint_exp(1U,0U);*eptr=_Tmp1A;});}
# 937
goto _LL3;}}}}case 5: _Tmp16=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.tvars;_Tmp15=(void**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.effect;_Tmp14=(struct Cyc_Absyn_Tqual*)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ret_tqual;_Tmp13=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ret_type;_Tmp12=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.args;_TmpD=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.c_varargs;_Tmp11=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.cyc_varargs;_Tmp10=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.qual_bnd;_TmpF=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.attributes;_TmpC=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.requires_clause;_TmpB=(struct Cyc_AssnDef_ExistAssnFn**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.requires_assn;_TmpA=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ensures_clause;_Tmp9=(struct Cyc_AssnDef_ExistAssnFn**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ensures_assn;_Tmp8=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.throws_clause;_Tmp7=(struct Cyc_AssnDef_ExistAssnFn**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.throws_assn;_Tmp6=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.return_value;_Tmp5=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.arg_vardecls;_Tmp4=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.effconstr;{struct Cyc_List_List**btvs=_Tmp16;void**eff=_Tmp15;struct Cyc_Absyn_Tqual*rtq=_Tmp14;void*tr=_Tmp13;struct Cyc_List_List*args=_Tmp12;int c_vararg=_TmpD;struct Cyc_Absyn_VarargInfo*cyc_vararg=_Tmp11;struct Cyc_List_List**qb=(struct Cyc_List_List**)_Tmp10;struct Cyc_List_List*atts=_TmpF;struct Cyc_Absyn_Exp*req=_TmpC;struct Cyc_AssnDef_ExistAssnFn**req_relns=(struct Cyc_AssnDef_ExistAssnFn**)_TmpB;struct Cyc_Absyn_Exp*ens=_TmpA;struct Cyc_AssnDef_ExistAssnFn**ens_relns=(struct Cyc_AssnDef_ExistAssnFn**)_Tmp9;struct Cyc_Absyn_Exp*thrws=_Tmp8;struct Cyc_AssnDef_ExistAssnFn**thrws_relns=(struct Cyc_AssnDef_ExistAssnFn**)_Tmp7;struct Cyc_Absyn_Vardecl*return_vd=_Tmp6;struct Cyc_List_List*arg_vds=_Tmp5;struct Cyc_List_List*effc=_Tmp4;
# 946
int num_formats=0;
int is_cdecl=0;
int is_stdcall=0;
...
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=_tag_fat("bad function type attribute ",sizeof(char),29U);_Tmp1C;});struct Cyc_Warn_Attribute_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_Attribute_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=10,_Tmp1D.f1=(void*)atts->hd;_Tmp1D;});void*_Tmp1D[2];_Tmp1D[0]=& _Tmp1B,_Tmp1D[1]=& _Tmp1C;Cyc_Warn_err2(loc,_tag_fat(_Tmp1D,sizeof(void*),2));});}_LL42:;}
# 968
if((is_stdcall + is_cdecl)+ is_fastcall > 1)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp17=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18;_Tmp18.tag=0,_Tmp18.f1=_tag_fat("function can't have multiple calling conventions",sizeof(char),49U);_Tmp18;});void*_Tmp18[1];_Tmp18[0]=& _Tmp17;Cyc_Warn_err2(loc,_tag_fat(_Tmp18,sizeof(void*),1));});
if(num_formats > 1)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp17=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18;_Tmp18.tag=0,_Tmp18.f1=_tag_fat("function can't have multiple format attributes",sizeof(char),47U);_Tmp18;});void*_Tmp18[1];_Tmp18[0]=& _Tmp17;Cyc_Warn_err2(loc,_tag_fat(_Tmp18,sizeof(void*),1));});
# 975
Cyc_Tcutil_check_unique_tvars(loc,*btvs);
{struct Cyc_List_List*b=*btvs;for(0;b!=0;b=b->tl){
({int _Tmp17=Cyc_Tcutil_new_tvar_id();((struct Cyc_Absyn_Tvar*)b->hd)->identity=_Tmp17;});
({struct Cyc_List_List*_Tmp17=Cyc_Tctyp_add_bound_tvar(env.kind_env,(struct Cyc_Absyn_Tvar*)b->hd);env.kind_env=_Tmp17;});{
void*_Tmp17=Cyc_Kinds_compress_kb(((struct Cyc_Absyn_Tvar*)b->hd)->kind);if(*((int*)_Tmp17)==0){if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_Tmp17)->f1)->kind==Cyc_Absyn_MemKind){
# 981
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19;_Tmp19.tag=0,_Tmp19.f1=_tag_fat("function abstracts Mem type variable ",sizeof(char),38U);_Tmp19;});struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp19=({struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp1A;_Tmp1A.tag=7,_Tmp1A.f1=(struct Cyc_Absyn_Tvar*)b->hd;_Tmp1A;});void*_Tmp1A[2];_Tmp1A[0]=& _Tmp18,_Tmp1A[1]=& _Tmp19;Cyc_Warn_err2(loc,_tag_fat(_Tmp1A,sizeof(void*),2));});goto _LL4D;}else{goto _LL50;}}else{_LL50:
 goto _LL4D;}_LL4D:;}}}{
# 987
struct Cyc_Tctyp_CVTEnv new_env=({struct Cyc_Tctyp_CVTEnv _Tmp17;_Tmp17.loc=loc,_Tmp17.te=te,_Tmp17.kind_env=env.kind_env,_Tmp17.fn_result=1,_Tmp17.def_aliasable=1,_Tmp17.inst_type_evar=0,_Tmp17.generalize_evars=env.generalize_evars,_Tmp17.allow_aqual_bounds=1,_Tmp17.free_vars=0,_Tmp17.free_evars=0,_Tmp17.free_qualvars=0;_Tmp17;});
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_mk,tr,1,1);
({int _Tmp17=Cyc_Tcutil_extract_const_from_typedef(loc,rtq->print_const,tr);rtq->real_const=_Tmp17;});
new_env.fn_result=0;
# 995
...
void*aqt=({void*_Tmp17=Cyc_Absyn_new_evar(& Cyc_Kinds_aqko,0);Cyc_Absyn_aqual_var_type(_Tmp17,Cyc_Absyn_al_qual_type);});
# 1009
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_aqk,aqt,1,1);
({void*_Tmp17=Cyc_Tcutil_promote_array(t,ptr_rgn,aqt,0);(*trip).f2=_Tmp17;});}}}}}
# 1014
if(cyc_vararg!=0){
if(c_vararg)({struct Cyc_Warn_String_Warn_Warg_struct _Tmp17=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18;_Tmp18.tag=0,_Tmp18.f1=_tag_fat("both c_vararg and cyc_vararg",sizeof(char),29U);_Tmp18;});void*_Tmp18[1];_Tmp18[0]=& _Tmp17;({int(*_Tmp19)(struct _fat_ptr)=(int(*)(struct _fat_ptr))Cyc_Warn_impos2;_Tmp19;})(_tag_fat(_Tmp18,sizeof(void*),1));});{
struct Cyc_Absyn_VarargInfo _Tmp17=*cyc_vararg;int _Tmp18;void*_Tmp19;_Tmp19=_Tmp17.type;_Tmp18=_Tmp17.inject;{void*vt=_Tmp19;int vi=_Tmp18;
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_mk,vt,1,1);
({int _Tmp1A=Cyc_Tcutil_extract_const_from_typedef(loc,cyc_vararg->tq.print_const,vt);cyc_vararg->tq.real_const=_Tmp1A;});
# 1020
if(vi){
void*_Tmp1A=Cyc_Absyn_compress(vt);void*_Tmp1B;void*_Tmp1C;void*_Tmp1D;if(*((int*)_Tmp1A)==3){_Tmp1D=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1A)->f1.elt_type;_Tmp1C=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1A)->f1.ptr_atts.bounds;_Tmp1B=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1A)->f1.ptr_atts.zero_term;{void*et=_Tmp1D;void*bs=_Tmp1C;void*zt=_Tmp1B;
# 1023
{void*_Tmp1E=Cyc_Absyn_compress(et);if(*((int*)_Tmp1E)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1E)->f1)==22){
# 1025
if(Cyc_Tcutil_force_type2bool(0,zt))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("can't inject into a zeroterm pointer",sizeof(char),37U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});
if(!({void*_Tmp1F=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_Tmp1F,bs);}))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("can't inject into a fat pointer to datatype",sizeof(char),44U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});
goto _LL5A;}else{goto _LL5D;}}else{_LL5D:
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("can't inject a non-datatype type",sizeof(char),33U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});goto _LL5A;}_LL5A:;}
# 1032
goto _LL55;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F;_Tmp1F.tag=0,_Tmp1F.f1=_tag_fat("expecting a datatype pointer type",sizeof(char),34U);_Tmp1F;});void*_Tmp1F[1];_Tmp1F[0]=& _Tmp1E;Cyc_Warn_err2(loc,_tag_fat(_Tmp1F,sizeof(void*),1));});goto _LL55;}_LL55:;}}}}
# 1037
if(num_formats > 0){
...
# 1044
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp17=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp18;_Tmp18.tag=0,_Tmp18.f1=_tag_fat("bad format descriptor",sizeof(char),22U);_Tmp18;});void*_Tmp18[1];_Tmp18[0]=& _Tmp17;Cyc_Warn_err2(loc,_tag_fat(_Tmp18,sizeof(void*),1));});else{
# 1047
struct _tuple9 _Tmp17=*({struct _tuple9*(*_Tmp18)(struct Cyc_List_List*,int)=(struct _tuple9*(*)(struct Cyc_List_List*,int))Cyc_List_nth;_Tmp18;})(args,fmt_desc_arg - 1);void*_Tmp18;_Tmp18=_Tmp17.f2;{void*t=_Tmp18;
# 1049
{void*_Tmp19=Cyc_Absyn_compress(t);void*_Tmp1A;void*_Tmp1B;if(*((int*)_Tmp19)==3){_Tmp1B=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp19)->f1.elt_type;_Tmp1A=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp19)->f1.ptr_atts.bounds;{void*et=_Tmp1B;void*b=_Tmp1A;
# 1052
if(!Cyc_Tcutil_is_char_type(et))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat("format descriptor is not a string",sizeof(char),34U);_Tmp1D;});void*_Tmp1D[1];_Tmp1D[0]=& _Tmp1C;Cyc_Warn_err2(loc,_tag_fat(_Tmp1D,sizeof(void*),1));});else{
# 1055
struct Cyc_Absyn_Exp*e=({void*_Tmp1C=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_Tmp1C,b);});
if(e==0 && c_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat("format descriptor is not a char * type",sizeof(char),39U);_Tmp1D;});void*_Tmp1D[1];_Tmp1D[0]=& _Tmp1C;Cyc_Warn_err2(loc,_tag_fat(_Tmp1D,sizeof(void*),1));});else{
if(e!=0 && !c_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat("format descriptor is not a char ? type",sizeof(char),39U);_Tmp1D;});void*_Tmp1D[1];_Tmp1D[0]=& _Tmp1C;Cyc_Warn_err2(loc,_tag_fat(_Tmp1D,sizeof(void*),1));});}}
# 1061
goto _LL62;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat("format descriptor is not a string type",sizeof(char),39U);_Tmp1D;});void*_Tmp1D[1];_Tmp1D[0]=& _Tmp1C;Cyc_Warn_err2(loc,_tag_fat(_Tmp1D,sizeof(void*),1));});goto _LL62;}_LL62:;}
# 1064
if(fmt_arg_start!=0 && !c_vararg){
# 1068
int problem;
{struct _tuple16 _Tmp19=({struct _tuple16 _Tmp1A;_Tmp1A.f0=ft,({void*_Tmp1B=Cyc_Absyn_compress(Cyc_Tcutil_pointer_elt_type(cyc_vararg->type));_Tmp1A.f1=_Tmp1B;});_Tmp1A;});void*_Tmp1A;switch((int)_Tmp19.f0){case Cyc_Absyn_Printf_ft: if(*((int*)_Tmp19.f1)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp19.f1)->f1)==22){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp19.f1)->f1)->f1.KnownDatatype.tag==2){_Tmp1A=*((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp19.f1)->f1)->f1.KnownDatatype.val;{struct Cyc_Absyn_Datatypedecl*tud=_Tmp1A;
# 1071
problem=({struct _tuple1*_Tmp1B=tud->name;Cyc_Absyn_qvar_cmp(_Tmp1B,Cyc_Absyn_datatype_print_arg_qvar());})!=0;
goto _LL67;}}else{goto _LL6C;}}else{goto _LL6C;}}else{goto _LL6C;}case Cyc_Absyn_Scanf_ft: if(*((int*)_Tmp19.f1)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp19.f1)->f1)==22){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp19.f1)->f1)->f1.KnownDatatype.tag==2){_Tmp1A=*((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp19.f1)->f1)->f1.KnownDatatype.val;{struct Cyc_Absyn_Datatypedecl*tud=_Tmp1A;
# 1074
problem=({struct _tuple1*_Tmp1B=tud->name;Cyc_Absyn_qvar_cmp(_Tmp1B,Cyc_Absyn_datatype_scanf_arg_qvar());})!=0;
...
# 1080
if(problem)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp19=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A;_Tmp1A.tag=0,_Tmp1A.f1=_tag_fat("format attribute and vararg types don't match",sizeof(char),46U);_Tmp1A;});void*_Tmp1A[1];_Tmp1A[0]=& _Tmp19;Cyc_Warn_err2(loc,_tag_fat(_Tmp1A,sizeof(void*),1));});}}}}
# 1086
{struct Cyc_List_List*qbit=*qb;for(0;qbit!=0;qbit=qbit->tl){
struct _tuple0*_Tmp17=(struct _tuple0*)qbit->hd;void*_Tmp18;void*_Tmp19;_Tmp19=_Tmp17->f0;_Tmp18=_Tmp17->f1;{void*tv=_Tmp19;void*bnd=_Tmp18;
...
void*_Tmp17=(void*)ec->hd;void*_Tmp18;void*_Tmp19;switch(*((int*)_Tmp17)){case 0: _Tmp19=(void*)((struct Cyc_Absyn_SingleConstraint_Absyn_EffConstraint_struct*)_Tmp17)->f1;{void*t=_Tmp19;
# 1095
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_ek,t,1,1);
goto _LL71;}case 1: _Tmp19=(void*)((struct Cyc_Absyn_DisjointConstraint_Absyn_EffConstraint_struct*)_Tmp17)->f1;_Tmp18=(void*)((struct Cyc_Absyn_DisjointConstraint_Absyn_EffConstraint_struct*)_Tmp17)->f2;{void*t1=_Tmp19;void*t2=_Tmp18;
_Tmp19=t1;_Tmp18=t2;goto _LL77;}default: _Tmp19=(void*)((struct Cyc_Absyn_SubsetConstraint_Absyn_EffConstraint_struct*)_Tmp17)->f1;_Tmp18=(void*)((struct Cyc_Absyn_SubsetConstraint_Absyn_EffConstraint_struct*)_Tmp17)->f2;_LL77: {void*t1=_Tmp19;void*t2=_Tmp18;
# 1099
...
({struct Cyc_Tcenv_Tenv*_Tmp17=({struct Cyc_Tcenv_Tenv*_Tmp18=_cycalloc(sizeof(struct Cyc_Tcenv_Tenv));_Tmp18->ns=te->ns,_Tmp18->ae=te->ae,_Tmp18->le=fenv,_Tmp18->allow_valueof=1,_Tmp18->in_extern_c_include=te->in_extern_c_include,_Tmp18->in_tempest=te->in_tempest,_Tmp18->tempest_generalize=te->tempest_generalize,_Tmp18->in_extern_c_inc_repeat=te->in_extern_c_inc_repeat;_Tmp18;});new_env.te=_Tmp17;});{
# 1114
struct Cyc_List_List*vds;vds=_cycalloc(sizeof(struct Cyc_List_List)),vds->hd=Cyc_AssnDef_memory,vds->tl=arg_vds;
if(req!=0){
struct _tuple15 _Tmp17=Cyc_Tctyp_check_clause(new_env,_tag_fat("@requires",sizeof(char),10U),req);struct Cyc_AssnDef_AssnMap _Tmp18;struct Cyc_Tctyp_CVTEnv _Tmp19;_Tmp19=_Tmp17.f0;_Tmp18=_Tmp17.f1;{struct Cyc_Tctyp_CVTEnv nenv=_Tmp19;struct Cyc_AssnDef_AssnMap req_assn=_Tmp18;
new_env=nenv;
({struct Cyc_AssnDef_ExistAssnFn*_Tmp1A=Cyc_AssnDef_assnmap2existassnfn(req_assn,vds);*req_relns=_Tmp1A;});}}
# 1120
if(ens!=0){
struct _tuple15 _Tmp17=Cyc_Tctyp_check_clause(new_env,_tag_fat("@ensures",sizeof(char),9U),ens);struct Cyc_AssnDef_AssnMap _Tmp18;struct Cyc_Tctyp_CVTEnv _Tmp19;_Tmp19=_Tmp17.f0;_Tmp18=_Tmp17.f1;{struct Cyc_Tctyp_CVTEnv nenv=_Tmp19;struct Cyc_AssnDef_AssnMap ens_assn=_Tmp18;
new_env=nenv;
({struct Cyc_AssnDef_ExistAssnFn*_Tmp1A=({struct Cyc_AssnDef_AssnMap _Tmp1B=ens_assn;Cyc_AssnDef_assnmap2existassnfn(_Tmp1B,({struct Cyc_List_List*_Tmp1C=_cycalloc(sizeof(struct Cyc_List_List));_Tmp1C->hd=return_vd,_Tmp1C->tl=vds;_Tmp1C;}));});*ens_relns=_Tmp1A;});}}
# 1125
if(thrws!=0){
struct _tuple15 _Tmp17=Cyc_Tctyp_check_clause(new_env,_tag_fat("@throws",sizeof(char),8U),thrws);struct Cyc_AssnDef_AssnMap _Tmp18;struct Cyc_Tctyp_CVTEnv _Tmp19;_Tmp19=_Tmp17.f0;_Tmp18=_Tmp17.f1;{struct Cyc_Tctyp_CVTEnv nenv=_Tmp19;struct Cyc_AssnDef_AssnMap thrws_assn=_Tmp18;
new_env=nenv;
({struct Cyc_AssnDef_ExistAssnFn*_Tmp1A=Cyc_AssnDef_assnmap2existassnfn(thrws_assn,vds);*thrws_relns=_Tmp1A;});}}
# 1130
new_env.te=old_te;
# 1132
if(*eff!=0){
...
({void*_Tmp17=Cyc_Tcutil_normalize_effect(Cyc_Absyn_join_eff(({void*_Tmp18[2];_Tmp18[0]=Cyc_Absyn_heap_rgn_type,_Tmp18[1]=*eff;Cyc_List_list(_tag_fat(_Tmp18,sizeof(void*),2));})));*eff=_Tmp17;});}else{
# 1139
...
struct _tuple12 _Tmp17=*((struct _tuple12*)tvs->hd);int _Tmp18;void*_Tmp19;_Tmp19=_Tmp17.f0;_Tmp18=_Tmp17.f1;{struct Cyc_Absyn_Tvar*tv=_Tmp19;int put_in_eff=_Tmp18;
if(!put_in_eff)continue;{
void*_Tmp1A=Cyc_Kinds_compress_kb(tv->kind);void*_Tmp1B;switch(*((int*)_Tmp1A)){case 2: switch((int)((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp1A)->f2)->kind){case Cyc_Absyn_BoolKind:
 goto _LL88;case Cyc_Absyn_PtrBndKind: _LL88:
 goto _LL8A;case Cyc_Absyn_IntKind: _LL8A:
 goto _LL8C;case Cyc_Absyn_EffKind: _Tmp1B=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp1A)->f1;{struct Cyc_Core_Opt**f=_Tmp1B;
# 1155
({struct Cyc_Core_Opt*_Tmp1C=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_ek);*f=_Tmp1C;});goto _LL94;}default: goto _LL97;}case 0: switch((int)((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_Tmp1A)->f1)->kind){case Cyc_Absyn_BoolKind: _LL8C:
# 1151
 goto _LL8E;case Cyc_Absyn_PtrBndKind: _LL8E:
 goto _LL90;case Cyc_Absyn_IntKind: _LL90:
 goto _LL84;case Cyc_Absyn_EffKind: _LL94:
# 1157
 effect=({struct Cyc_List_List*_Tmp1C=_cycalloc(sizeof(struct Cyc_List_List));({void*_Tmp1D=Cyc_Absyn_var_type(tv);_Tmp1C->hd=_Tmp1D;}),_Tmp1C->tl=effect;_Tmp1C;});goto _LL84;default: _LL97: _LL98:
# 1162
 effect=({struct Cyc_List_List*_Tmp1C=_cycalloc(sizeof(struct Cyc_List_List));({void*_Tmp1D=Cyc_Absyn_regionsof_eff(Cyc_Absyn_var_type(tv));_Tmp1C->hd=_Tmp1D;}),_Tmp1C->tl=effect;_Tmp1C;});goto _LL84;}default: _Tmp1B=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_Tmp1A)->f1;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp1B;
# 1159
({struct Cyc_Core_Opt*_Tmp1C=({struct Cyc_Core_Opt*_Tmp1D=_cycalloc(sizeof(struct Cyc_Core_Opt));({void*_Tmp1E=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp1F=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp1F->tag=2,_Tmp1F->f1=0,_Tmp1F->f2=& Cyc_Kinds_ak;_Tmp1F;});_Tmp1D->v=_Tmp1E;});_Tmp1D;});*f=_Tmp1C;});goto _LL98;}}_LL84:;}}}}
# 1166
{struct Cyc_List_List*ts=new_env.free_evars;for(0;ts!=0;ts=ts->tl){
struct _tuple14 _Tmp17=*((struct _tuple14*)ts->hd);int _Tmp18;void*_Tmp19;_Tmp19=_Tmp17.f0;_Tmp18=_Tmp17.f1;{void*tv=_Tmp19;int put_in_eff=_Tmp18;
if(!put_in_eff)continue;{
struct Cyc_Absyn_Kind*_Tmp1A=Cyc_Tcutil_type_kind(tv);switch((int)((struct Cyc_Absyn_Kind*)_Tmp1A)->kind){case Cyc_Absyn_EffKind:
# 1171
 effect=({struct Cyc_List_List*_Tmp1B=_cycalloc(sizeof(struct Cyc_List_List));_Tmp1B->hd=tv,_Tmp1B->tl=effect;_Tmp1B;});goto _LL9C;case Cyc_Absyn_IntKind:
 goto _LL9C;default:
 effect=({struct Cyc_List_List*_Tmp1B=_cycalloc(sizeof(struct Cyc_List_List));({void*_Tmp1C=Cyc_Absyn_regionsof_eff(tv);_Tmp1B->hd=_Tmp1C;}),_Tmp1B->tl=effect;_Tmp1B;});goto _LL9C;}_LL9C:;}}}}
# 1176
({void*_Tmp17=Cyc_Absyn_join_eff(effect);*eff=_Tmp17;});}
# 1182
if(*btvs!=0){
struct Cyc_List_List*bs=*btvs;for(0;bs!=0;bs=bs->tl){
void*_Tmp17=Cyc_Kinds_compress_kb(((struct Cyc_Absyn_Tvar*)bs->hd)->kind);void*_Tmp18;void*_Tmp19;switch(*((int*)_Tmp17)){case 1: _Tmp19=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_Tmp17)->f1;{struct Cyc_Core_Opt**f=_Tmp19;
# 1186
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("type variable ",sizeof(char),15U);_Tmp1B;});struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=7,_Tmp1C.f1=(struct Cyc_Absyn_Tvar*)bs->hd;_Tmp1C;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat(" unconstrained, assuming boxed",sizeof(char),31U);_Tmp1D;});void*_Tmp1D[3];_Tmp1D[0]=& _Tmp1A,_Tmp1D[1]=& _Tmp1B,_Tmp1D[2]=& _Tmp1C;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1D,sizeof(void*),3));});
({struct Cyc_Core_Opt*_Tmp1A=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_bk);*f=_Tmp1A;});
goto _LLA3;}case 2: _Tmp19=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp17)->f1;_Tmp18=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp17)->f2;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp19;struct Cyc_Absyn_Kind*k=_Tmp18;
# 1190
...
# 1194
({struct Cyc_Core_Opt*_Tmp1A=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_bk);*f=_Tmp1A;});goto _LLAC;case Cyc_Absyn_EffKind:
# 1196
({struct Cyc_Core_Opt*_Tmp1A=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_ek);*f=_Tmp1A;});goto _LLAC;default:
# 1198
({struct Cyc_Core_Opt*_Tmp1A=Cyc_Kinds_kind_to_bound_opt(k);*f=_Tmp1A;});goto _LLAC;}_LLAC:;
# 1200
goto _LLA3;}default: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_Tmp17)->f1)->kind==Cyc_Absyn_MemKind){
# 1202
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("functions can't abstract M types",sizeof(char),33U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});goto _LLA3;}else{
goto _LLA3;}}_LLA3:;}}
# 1206
({struct Cyc_List_List*_Tmp17=({struct Cyc_List_List*(*_Tmp18)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*))=(struct Cyc_List_List*(*)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*)))Cyc_Tctyp_remove_bound_tvars;_Tmp18;})(new_env.kind_env,*btvs,({struct Cyc_Absyn_Tvar*(*_Tmp18)(struct Cyc_Absyn_Tvar*)=(struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*))Cyc_Core_identity;_Tmp18;}));env.kind_env=_Tmp17;});
({struct Cyc_List_List*_Tmp17=({struct Cyc_List_List*(*_Tmp18)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct _tuple12*))=(struct Cyc_List_List*(*)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct _tuple12*)))Cyc_Tctyp_remove_bound_tvars;_Tmp18;})(new_env.free_vars,*btvs,({struct Cyc_Absyn_Tvar*(*_Tmp18)(struct _tuple12*)=(struct Cyc_Absyn_Tvar*(*)(struct _tuple12*))Cyc_Core_fst;_Tmp18;}));new_env.free_vars=_Tmp17;});
# 1209
{struct Cyc_List_List*tvs=new_env.free_vars;for(0;tvs!=0;tvs=tvs->tl){
struct _tuple12 _Tmp17=*((struct _tuple12*)tvs->hd);int _Tmp18;void*_Tmp19;_Tmp19=_Tmp17.f0;_Tmp18=_Tmp17.f1;{struct Cyc_Absyn_Tvar*t=_Tmp19;int b=_Tmp18;
({struct Cyc_List_List*_Tmp1A=Cyc_Tctyp_fast_add_free_tvar_bool(env.free_vars,t,b);env.free_vars=_Tmp1A;});}}}
# 1214
{struct Cyc_List_List*evs=new_env.free_evars;for(0;evs!=0;evs=evs->tl){
struct _tuple14 _Tmp17=*((struct _tuple14*)evs->hd);int _Tmp18;void*_Tmp19;_Tmp19=_Tmp17.f0;_Tmp18=_Tmp17.f1;{void*e=_Tmp19;int b=_Tmp18;
({struct Cyc_List_List*_Tmp1A=Cyc_Tctyp_add_free_evar(env.free_evars,e,b);env.free_evars=_Tmp1A;});}}}
# 1218
if((unsigned)env.free_qualvars){
# 1220
struct Cyc_List_List*it=new_env.free_qualvars;for(0;it!=0;it=it->tl){
if(!({int(*_Tmp17)(int(*)(struct _tuple14*,struct _tuple14*),struct _tuple14*,struct Cyc_List_List*)=(int(*)(int(*)(struct _tuple14*,struct _tuple14*),struct _tuple14*,struct Cyc_List_List*))Cyc_List_exists_c;_Tmp17;})(Cyc_Tctyp_cmp_fqv,(struct _tuple14*)it->hd,env.free_qualvars))
({struct Cyc_List_List*_Tmp17=({struct Cyc_List_List*_Tmp18=_cycalloc(sizeof(struct Cyc_List_List));_Tmp18->hd=(struct _tuple14*)it->hd,_Tmp18->tl=env.free_qualvars;_Tmp18;});env.free_qualvars=_Tmp17;});}}else{
# 1226
env.free_qualvars=new_env.free_qualvars;}
goto _LL3;}}}}case 6: _Tmp3=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp2)->f1;_TmpD=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp2)->f2;_Tmp16=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp2)->f3;{enum Cyc_Absyn_AggrKind k=_Tmp3;int is_tuple=_TmpD;struct Cyc_List_List*fs=_Tmp16;
# 1231
struct Cyc_List_List*prev_fields=0;
for(1;fs!=0;fs=fs->tl){
struct Cyc_Absyn_Aggrfield*_Tmp17=(struct Cyc_Absyn_Aggrfield*)fs->hd;void*_Tmp18;void*_Tmp19;void*_Tmp1A;void*_Tmp1B;void*_Tmp1C;void*_Tmp1D;_Tmp1D=_Tmp17->name;_Tmp1C=(struct Cyc_Absyn_Tqual*)& _Tmp17->tq;_Tmp1B=_Tmp17->type;_Tmp1A=_Tmp17->width;_Tmp19=_Tmp17->attributes;_Tmp18=_Tmp17->requires_clause;{struct _fat_ptr*fn=_Tmp1D;struct Cyc_Absyn_Tqual*tqp=(struct Cyc_Absyn_Tqual*)_Tmp1C;void*t=_Tmp1B;struct Cyc_Absyn_Exp*width=_Tmp1A;struct Cyc_List_List*atts=_Tmp19;struct Cyc_Absyn_Exp*requires_clause=_Tmp18;
if(({int(*_Tmp1E)(int(*)(struct _fat_ptr*,struct _fat_ptr*),struct Cyc_List_List*,struct _fat_ptr*)=(int(*)(int(*)(struct _fat_ptr*,struct _fat_ptr*),struct Cyc_List_List*,struct _fat_ptr*))Cyc_List_mem;_Tmp1E;})(Cyc_strptrcmp,prev_fields,fn))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F;_Tmp1F.tag=0,_Tmp1F.f1=_tag_fat("duplicate field ",sizeof(char),17U);_Tmp1F;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=*fn;_Tmp20;});void*_Tmp20[2];_Tmp20[0]=& _Tmp1E,_Tmp20[1]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),2));});
if(Cyc_strcmp(*fn,_tag_fat("",sizeof(char),1U))!=0)
prev_fields=({struct Cyc_List_List*_Tmp1E=_cycalloc(sizeof(struct Cyc_List_List));_Tmp1E->hd=fn,_Tmp1E->tl=prev_fields;_Tmp1E;});
env=Cyc_Tctyp_i_check_type(env,& Cyc_Kinds_mk,t,1,0);
({int _Tmp1E=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t);tqp->real_const=_Tmp1E;});
Cyc_Tcutil_check_bitfield(loc,t,width,fn);
Cyc_Atts_check_field_atts(loc,fn,atts);
if(requires_clause!=0){
# 1244
if((int)k!=1)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F;_Tmp1F.tag=0,_Tmp1F.f1=_tag_fat("@requires clause is only allowed on union members",sizeof(char),50U);_Tmp1F;});void*_Tmp1F[1];_Tmp1F[0]=& _Tmp1E;Cyc_Warn_err2(loc,_tag_fat(_Tmp1F,sizeof(void*),1));});
({struct Cyc_Tcenv_Tenv*_Tmp1E=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp1E,0,requires_clause);});
if(!Cyc_Tcutil_is_integral(requires_clause))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F;_Tmp1F.tag=0,_Tmp1F.f1=_tag_fat("@requires clause has type ",sizeof(char),27U);_Tmp1F;});struct Cyc_Warn_TypOpt_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_TypOpt_Warn_Warg_struct _Tmp20;_Tmp20.tag=3,_Tmp20.f1=(void*)requires_clause->topt;_Tmp20;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp20=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp21;_Tmp21.tag=0,_Tmp21.f1=
_tag_fat(" instead of integral type",sizeof(char),26U);_Tmp21;});void*_Tmp21[3];_Tmp21[0]=& _Tmp1E,_Tmp21[1]=& _Tmp1F,_Tmp21[2]=& _Tmp20;Cyc_Warn_err2(loc,_tag_fat(_Tmp21,sizeof(void*),3));});
env=Cyc_Tctyp_i_check_type_level_exp(requires_clause,env);}}}
# 1253
goto _LL3;}default: _Tmp16=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f1;_Tmp15=(struct Cyc_List_List**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f2;_Tmp14=(struct Cyc_Absyn_Typedefdecl**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f3;_Tmp13=(void**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f4;{struct _tuple1*tdn=_Tmp16;struct Cyc_List_List**targs_ref=(struct Cyc_List_List**)_Tmp15;struct Cyc_Absyn_Typedefdecl**tdopt=(struct Cyc_Absyn_Typedefdecl**)_Tmp14;void**toptp=(void**)_Tmp13;
# 1257
struct Cyc_Absyn_Typedefdecl*td;
{struct _handler_cons _Tmp17;_push_handler(& _Tmp17);{int _Tmp18=0;if(setjmp(_Tmp17.handler))_Tmp18=1;if(!_Tmp18){td=Cyc_Tcenv_lookup_typedefdecl(te,loc,tdn);;_pop_handler();}else{void*_Tmp19=(void*)Cyc_Core_get_exn_thrown();void*_Tmp1A;if(((struct Cyc_Dict_Absent_exn_struct*)_Tmp19)->tag==Cyc_Dict_Absent){
# 1261
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=_tag_fat("unbound typedef name ",sizeof(char),22U);_Tmp1C;});struct Cyc_Warn_Qvar_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_Qvar_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=1,_Tmp1D.f1=tdn;_Tmp1D;});void*_Tmp1D[2];_Tmp1D[0]=& _Tmp1B,_Tmp1D[1]=& _Tmp1C;Cyc_Warn_err2(loc,_tag_fat(_Tmp1D,sizeof(void*),2));});
return env;}else{_Tmp1A=_Tmp19;{void*exn=_Tmp1A;_rethrow(exn);}};}}}
# 1264
*tdopt=td;
...
inst=({struct Cyc_List_List*_Tmp17=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple17*_Tmp18=({struct _tuple17*_Tmp19=_cycalloc(sizeof(struct _tuple17));_Tmp19->f0=(struct Cyc_Absyn_Tvar*)tvs->hd,_Tmp19->f1=(void*)ts->hd;_Tmp19;});_Tmp17->hd=_Tmp18;}),_Tmp17->tl=inst;_Tmp17;});}
({void*_Tmp17=Cyc_Tcutil_substitute(inst,td->defn);*toptp=_Tmp17;});}
# 1275
goto _LL3;}}_LL3:;}
# 1277
