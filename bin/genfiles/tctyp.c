...
# 764
_TL134: _T1C=k;*_T1C=Cyc_Kinds_kind_to_opt(expected_kind);goto _TL133;_TL132: _TL133: goto _LL3;}case 1:{struct Cyc_Absyn_Evar_Absyn_Type_struct*_T3C2=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_T3A9;_T1D=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_T3A9;_T1E=& _T1D->f1;_T3C1=(struct Cyc_Core_Opt**)_T1E;_T1F=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_T3A9;_T20=& _T1F->f2;_T3C0=(void**)_T20;}{struct Cyc_Core_Opt**k=_T3C1;void**ref=_T3C0;_T21=k;_T22=*_T21;
# 768
...
# 791
if(!_T4A)goto _TL147;_T4B=expected_kind;_T4C=_T4B->kind;_T4D=(int)_T4C;if(_T4D==5)goto _TL147;_T4E=expected_kind;_T4F=_T4E->kind;_T50=(int)_T4F;if(_T50==6)goto _TL147;{struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T3C2=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_T3C2->tag=2;
# 794
_T3C2->f1=0;_T3C2->f2=expected_kind;_T51=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C2;}_T52=(void*)_T51;{struct Cyc_Absyn_Tvar*v=Cyc_Tcutil_new_tvar(_T52);_T53=ref;
*_T53=Cyc_Absyn_var_type(v);_T3C1=v;goto _LLB;}_TL147: _T54=env;_T55=_T54.free_evars;_T56=t;_T57=put_in_effect;
# 798
env.free_evars=Cyc_Tctyp_add_free_evar(_T55,_T56,_T57);goto _LL3;}case 2:{struct Cyc_Absyn_VarType_Absyn_Type_struct*_T3C2=(struct Cyc_Absyn_VarType_Absyn_Type_struct*)_T3A9;_T3C1=_T3C2->f1;}_LLB: {struct Cyc_Absyn_Tvar*v=_T3C1;_T58=v;_T59=_T58->kind;{
# 801
void*_T3C2=Cyc_Kinds_compress_kb(_T59);void*_T3C3;_T5A=(int*)_T3C2;_T5B=*_T5A;if(_T5B!=1)goto _TL149;{struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*_T3C4=(struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_T3C2;_T5C=(struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_T3C2;_T5D=& _T5C->f1;_T3C3=(struct Cyc_Core_Opt**)_T5D;}{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_T3C3;_T5E=f;{struct Cyc_Core_Opt*_T3C4=_cycalloc(sizeof(struct Cyc_Core_Opt));{struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T3C5=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_T3C5->tag=2;
_T3C5->f1=0;_T3C5->f2=expected_kind;_T60=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C5;}_T3C4->v=(void*)_T60;_T5F=(struct Cyc_Core_Opt*)_T3C4;}*_T5E=_T5F;goto _LL1C;}_TL149: goto _LL1C;_LL1C:;}_T61=loc;_T62=env;_T63=_T62.kind_env;_T64=v;_T65=env;_T66=_T65.allow_aqual_bounds;
# 807
...
# 812
void*_T3C2=Cyc_Kinds_compress_kb(_T6C);struct Cyc_Absyn_Kind*_T3C3;void*_T3C4;_T6D=(int*)_T3C2;_T6E=*_T6D;if(_T6E!=2)goto _TL14B;{struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T3C5=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C2;_T6F=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C2;_T70=& _T6F->f1;_T3C4=(struct Cyc_Core_Opt**)_T70;_T3C3=_T3C5->f2;}{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_T3C4;struct Cyc_Absyn_Kind*k=_T3C3;_T71=
# 814
Cyc_Kinds_kind_leq(expected_kind,k);if(!_T71)goto _TL14D;_T72=f;{struct Cyc_Core_Opt*_T3C5=_cycalloc(sizeof(struct Cyc_Core_Opt));{struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T3C6=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_T3C6->tag=2;
_T3C6->f1=0;_T3C6->f2=expected_kind;_T74=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C6;}_T3C5->v=(void*)_T74;_T73=(struct Cyc_Core_Opt*)_T3C5;}*_T72=_T73;goto _TL14E;_TL14D: _TL14E: goto _LL21;}_TL14B: goto _LL21;_LL21:;}goto _LL3;}case 10:{struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*_T3C2=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_T3A9;_T75=_T3C2->f1;{struct Cyc_Absyn_TypeDecl _T3C3=*_T75;_T3C1=_T3C3.r;}_T76=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_T3A9;_T77=& _T76->f2;_T3C0=(void***)_T77;}{void*td=_T3C1;void***topt=_T3C0;_T78=
# 824
Cyc_Absyn_compress(t);{void*new_typ=Cyc_Tcutil_copy_type(_T78);{struct Cyc_Absyn_Datatypedecl*_T3C2;struct Cyc_Absyn_Enumdecl*_T3C3;struct Cyc_Absyn_Aggrdecl*_T3C4;_T79=td;_T7A=(int*)_T79;_T7B=*_T7A;switch(_T7B){case 0: _T7C=td;{struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*_T3C5=(struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)_T7C;_T3C4=_T3C5->f1;}{struct Cyc_Absyn_Aggrdecl*ad=_T3C4;_T7D=env;_T7E=_T7D.te;_T7F=_T7E->in_extern_c_include;
# 827
if(!_T7F)goto _TL150;_T80=ad;
_T80->sc=4U;goto _TL151;_TL150: _TL151:
 Cyc_Tc_tcAggrdecl(te,loc,ad);goto _LL26;}case 1: _T81=td;{struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*_T3C5=(struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)_T81;_T3C3=_T3C5->f1;}{struct Cyc_Absyn_Enumdecl*ed=_T3C3;_T82=env;_T83=_T82.te;_T84=_T83->in_extern_c_include;
# 831
if(!_T84)goto _TL152;_T85=ed;
_T85->sc=4U;goto _TL153;_TL152: _TL153:
 Cyc_Tc_tcEnumdecl(te,loc,ed);goto _LL26;}default: _T86=td;{struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*_T3C5=(struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)_T86;_T3C2=_T3C5->f1;}{struct Cyc_Absyn_Datatypedecl*dd=_T3C2;
# 835
Cyc_Tc_tcDatatypedecl(te,loc,dd);goto _LL26;}}_LL26:;}_T87=topt;{void**_T3C2=_cycalloc(sizeof(void*));
# 837
*_T3C2=new_typ;_T88=(void**)_T3C2;}*_T87=_T88;_T89=
Cyc_Tctyp_i_check_type(env,expected_kind,new_typ,put_in_effect,allow_abs_aggr);return _T89;}}case 4:{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T3C2=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T3A9;_T8A=_T3C2->f1;_T3C1=_T8A.elt_type;_T8B=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T3A9;_T8C=& _T8B->f1.elt_tq;_T3C0=(struct Cyc_Absyn_Tqual*)_T8C;_T8D=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T3A9;_T8E=& _T8D->f1.ptr_atts.eff;_T3BE=(void**)_T8E;_T8F=_T3C2->f1;_T90=_T8F.ptr_atts;_T3BD=_T90.nullable;_T91=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T3A9;_T92=& _T91->f1.ptr_atts.bounds;_T3BC=(void**)_T92;_T93=_T3C2->f1;_T94=_T93.ptr_atts;_T3BB=_T94.zero_term;_T95=_T3C2->f1;_T96=_T95.ptr_atts;_T3BA=_T96.autoreleased;_T97=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T3A9;_T98=& _T97->f1.ptr_atts.aqual;_T3B9=(void**)_T98;}{void*t1=_T3C1;struct Cyc_Absyn_Tqual*tqp=_T3C0;void**eff_type=_T3BE;void*nullable=_T3BD;void**b=_T3BC;void*zt=_T3BB;void*rel=_T3BA;void**aq=_T3B9;_T99=aq;{
# 842
void*override_aq=*_T99;_T9A=eff_type;{
void*_T3C2=*_T9A;_T9B=(int*)_T3C2;_T9C=*_T9B;if(_T9C!=0)goto _TL154;_T9D=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T3C2;_T9E=_T9D->f1;_T9F=(int*)_T9E;_TA0=*_T9F;switch(_TA0){case 7: _TA1=eff_type;
# 845
...
void*_T3C2=*_TA6;struct Cyc_List_List*_T3C3;_TA7=(int*)_T3C2;_TA8=*_TA7;if(_TA8!=0)goto _TL159;_TA9=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T3C2;_TAA=_TA9->f1;_TAB=(int*)_TAA;_TAC=*_TAB;if(_TAC!=17)goto _TL15B;_TAD=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T3C2;_TAE=_TAD->f2;if(_TAE==0)goto _TL15D;_TAF=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T3C2;_TB0=_TAF->f2;_TB1=(struct Cyc_List_List*)_TB0;_TB2=_TB1->hd;_TB3=(int*)_TB2;_TB4=*_TB3;if(_TB4!=1)goto _TL15F;{struct Cyc_Absyn_AppType_Absyn_Type_struct*_T3C4=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T3C2;_TB5=_T3C4->f2;{struct Cyc_List_List _T3C5=*_TB5;_T3C3=_T3C5.tl;}}{struct Cyc_List_List*bnd=_T3C3;goto _LL34;}_TL15F: goto _LL37;_TL15D: goto _LL37;_TL15B: goto _LL37;_TL159: _LL37:{struct Cyc_Warn_String_Warn_Warg_struct _T3C4;_T3C4.tag=0;
# 860
_T3C4.f1=_tag_fat("`U and `RC shorthands override explicit aqual",sizeof(char),46U);_TB6=_T3C4;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C4=_TB6;void*_T3C5[1];_T3C5[0]=& _T3C4;_TB7=loc;_TB8=_tag_fat(_T3C5,sizeof(void*),1);Cyc_Warn_warn2(_TB7,_TB8);}_LL34:;}_TB9=aq;
# 862
...
void*_T3C2=*_TD5;struct Cyc_List_List*_T3C3;_TD6=(int*)_T3C2;_TD7=*_TD6;if(_TD7!=0)goto _TL161;_TD8=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T3C2;_TD9=_TD8->f1;_TDA=(int*)_TD9;_TDB=*_TDA;if(_TDB!=17)goto _TL163;_TDC=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T3C2;_TDD=_TDC->f2;if(_TDD==0)goto _TL165;_TDE=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T3C2;_TDF=_TDE->f2;_TE0=(struct Cyc_List_List*)_TDF;_TE1=_TE0->hd;_TE2=(int*)_TE1;_TE3=*_TE2;if(_TE3!=1)goto _TL167;{struct Cyc_Absyn_AppType_Absyn_Type_struct*_T3C4=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T3C2;_TE4=_T3C4->f2;{struct Cyc_List_List _T3C5=*_TE4;_T3C3=_T3C5.tl;}}{struct Cyc_List_List*bnd=_T3C3;_TE5=env;_TE6=_TE5.def_aliasable;
# 873
...
_TL16F:{struct Cyc_Warn_String_Warn_Warg_struct _T3C2;_T3C2.tag=0;_T3C2.f1=_tag_fat("cannot have a pointer to zero-terminated ",sizeof(char),42U);_TFA=_T3C2;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C2=_TFA;{struct Cyc_Warn_Typ_Warn_Warg_struct _T3C3;_T3C3.tag=2;_T3C3.f1=t1;_TFB=_T3C3;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T3C3=_TFB;{struct Cyc_Warn_String_Warn_Warg_struct _T3C4;_T3C4.tag=0;_T3C4.f1=_tag_fat(" elements",sizeof(char),10U);_TFC=_T3C4;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C4=_TFC;void*_T3C5[3];_T3C5[0]=& _T3C2;_T3C5[1]=& _T3C3;_T3C5[2]=& _T3C4;_TFD=loc;_TFE=_tag_fat(_T3C5,sizeof(void*),3);Cyc_Warn_err2(_TFD,_TFE);}}}goto _TL16E;_TL16D: _TL16E: _TFF=b;_T100=*_TFF;_T101=
# 893
...
if(e==0)goto _TL173;{
struct _tuple13 _T3C2=Cyc_Evexp_eval_const_uint_exp(e);int _T3C3;unsigned _T3C4;_T3C4=_T3C2.f0;_T3C3=_T3C2.f1;{unsigned sz=_T3C4;int known=_T3C3;_T105=is_zero_terminated;
if(!_T105)goto _TL175;_T106=known;if(_T106)goto _TL178;else{goto _TL177;}_TL178: if(sz < 1U)goto _TL177;else{goto _TL175;}
_TL177:{struct Cyc_Warn_String_Warn_Warg_struct _T3C5;_T3C5.tag=0;_T3C5.f1=_tag_fat("zero-terminated pointer cannot point to empty sequence",sizeof(char),55U);_T107=_T3C5;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C5=_T107;void*_T3C6[1];_T3C6[0]=& _T3C5;_T108=loc;_T109=_tag_fat(_T3C6,sizeof(void*),1);Cyc_Warn_err2(_T108,_T109);}goto _TL176;_TL175: _TL176:;}}goto _TL174;_TL173: _TL174:;}goto _TL171;_TL170: _TL171: goto _LL3;}}}case 9:{struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_T3C2=(struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_T3A9;_T3C1=_T3C2->f1;}{struct Cyc_Absyn_Exp*e=_T3C1;_T10A=
# 906
...
_TL17B:{struct Cyc_Warn_String_Warn_Warg_struct _T3C2;_T3C2.tag=0;_T3C2.f1=_tag_fat("valueof_t requires an int expression",sizeof(char),37U);_T10D=_T3C2;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C2=_T10D;void*_T3C3[1];_T3C3[0]=& _T3C2;_T10E=loc;_T10F=_tag_fat(_T3C3,sizeof(void*),1);Cyc_Warn_err2(_T10E,_T10F);}goto _TL17A;_TL179: _TL17A:
 env=Cyc_Tctyp_i_check_type_level_exp(e,env);goto _LL3;}case 11:{struct Cyc_Absyn_TypeofType_Absyn_Type_struct*_T3C2=(struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_T3A9;_T3C1=_T3C2->f1;}{struct Cyc_Absyn_Exp*e=_T3C1;_T110=
# 915
Cyc_Tcenv_allow_valueof(te);_T111=e;Cyc_Tcexp_tcExp(_T110,0,_T111);goto _LL3;}case 5:{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_T3C2=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T3A9;_T112=_T3C2->f1;_T3C1=_T112.elt_type;_T113=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T3A9;_T114=& _T113->f1.tq;_T3C0=(struct Cyc_Absyn_Tqual*)_T114;_T115=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T3A9;_T116=& _T115->f1.num_elts;_T3BE=(struct Cyc_Absyn_Exp**)_T116;_T117=_T3C2->f1;_T3BD=_T117.zero_term;_T118=_T3C2->f1;_T3B8=_T118.zt_loc;}{void*t1=_T3C1;struct Cyc_Absyn_Tqual*tqp=_T3C0;struct Cyc_Absyn_Exp**eptr=_T3BE;void*zt=_T3BD;unsigned ztl=_T3B8;_T119=eptr;{
# 920
...
_TL180:{struct Cyc_Warn_String_Warn_Warg_struct _T3C2;_T3C2.tag=0;_T3C2.f1=_tag_fat("cannot have a zero-terminated array of ",sizeof(char),40U);_T126=_T3C2;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C2=_T126;{struct Cyc_Warn_Typ_Warn_Warg_struct _T3C3;_T3C3.tag=2;_T3C3.f1=t1;_T127=_T3C3;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T3C3=_T127;{struct Cyc_Warn_String_Warn_Warg_struct _T3C4;_T3C4.tag=0;_T3C4.f1=_tag_fat(" elements",sizeof(char),10U);_T128=_T3C4;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C4=_T128;void*_T3C5[3];_T3C5[0]=& _T3C2;_T3C5[1]=& _T3C3;_T3C5[2]=& _T3C4;_T129=loc;_T12A=_tag_fat(_T3C5,sizeof(void*),3);Cyc_Warn_err2(_T129,_T12A);}}}goto _TL17F;_TL17E: _TL17F: goto _TL17D;_TL17C: _TL17D:
# 932
 if(e!=0)goto _TL181;_T12B=is_zero_terminated;
# 935
if(_T12B)goto _TL183;else{goto _TL185;}
_TL185:{struct Cyc_Warn_String_Warn_Warg_struct _T3C2;_T3C2.tag=0;_T3C2.f1=_tag_fat("array bound defaults to 1 here",sizeof(char),31U);_T12C=_T3C2;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C2=_T12C;void*_T3C3[1];_T3C3[0]=& _T3C2;_T12D=loc;_T12E=_tag_fat(_T3C3,sizeof(void*),1);Cyc_Warn_warn2(_T12D,_T12E);}goto _TL184;_TL183: _TL184: _T12F=eptr;
...
_TL188:{struct Cyc_Warn_String_Warn_Warg_struct _T3C2;_T3C2.tag=0;_T3C2.f1=_tag_fat("array bounds expression is not an unsigned int",sizeof(char),47U);_T133=_T3C2;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C2=_T133;void*_T3C3[1];_T3C3[0]=& _T3C2;_T134=loc;_T135=_tag_fat(_T3C3,sizeof(void*),1);Cyc_Warn_err2(_T134,_T135);}goto _TL187;_TL186: _TL187:
 env=Cyc_Tctyp_i_check_type_level_exp(e,env);{
struct _tuple13 _T3C2=Cyc_Evexp_eval_const_uint_exp(e);int _T3C3;unsigned _T3C4;_T3C4=_T3C2.f0;_T3C3=_T3C2.f1;{unsigned sz=_T3C4;int known=_T3C3;_T136=is_zero_terminated;
# 945
if(!_T136)goto _TL189;_T137=known;if(!_T137)goto _TL189;if(sz >= 1U)goto _TL189;{struct Cyc_Warn_String_Warn_Warg_struct _T3C5;_T3C5.tag=0;
_T3C5.f1=_tag_fat("zero terminated array cannot have zero elements",sizeof(char),48U);_T138=_T3C5;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C5=_T138;void*_T3C6[1];_T3C6[0]=& _T3C5;_T139=loc;_T13A=_tag_fat(_T3C6,sizeof(void*),1);Cyc_Warn_warn2(_T139,_T13A);}goto _TL18A;_TL189: _TL18A: _T13B=known;
# 948
if(!_T13B)goto _TL18B;if(sz >= 1U)goto _TL18B;_T13C=Cyc_Flags_tovc_r;if(!_T13C)goto _TL18B;{struct Cyc_Warn_String_Warn_Warg_struct _T3C5;_T3C5.tag=0;
_T3C5.f1=_tag_fat("0-element arrays are supported only with gcc, changing to 1",sizeof(char),60U);_T13D=_T3C5;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C5=_T13D;void*_T3C6[1];_T3C6[0]=& _T3C5;_T13E=loc;_T13F=_tag_fat(_T3C6,sizeof(void*),1);Cyc_Warn_warn2(_T13E,_T13F);}_T140=eptr;
*_T140=Cyc_Absyn_uint_exp(1U,0U);goto _TL18C;_TL18B: _TL18C: goto _LL3;}}}}}case 6:{struct Cyc_Absyn_FnType_Absyn_Type_struct*_T3C2=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T3A9;_T141=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T3A9;_T142=& _T141->f1.tvars;_T3C1=(struct Cyc_List_List**)_T142;_T143=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T3A9;_T144=& _T143->f1.effect;_T3C0=(void**)_T144;_T145=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T3A9;_T146=& _T145->f1.ret_tqual;_T3BE=(struct Cyc_Absyn_Tqual*)_T146;_T147=_T3C2->f1;_T3BD=_T147.ret_type;_T148=_T3C2->f1;_T3B7=_T148.args;_T149=_T3C2->f1;_T3B6=_T149.c_varargs;_T14A=_T3C2->f1;_T3B5=_T14A.cyc_varargs;_T14B=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T3A9;_T14C=& _T14B->f1.qual_bnd;_T3BC=(struct Cyc_List_List**)_T14C;_T14D=_T3C2->f1;_T3B4=_T14D.attributes;_T14E=_T3C2->f1;_T3B3=_T14E.checks_clause;_T14F=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T3A9;_T150=& _T14F->f1.checks_assn;_T3BB=(struct Cyc_AssnDef_ExistAssnFn**)_T150;_T151=_T3C2->f1;_T3B2=_T151.requires_clause;_T152=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T3A9;_T153=& _T152->f1.requires_assn;_T3BA=(struct Cyc_AssnDef_ExistAssnFn**)_T153;_T154=_T3C2->f1;_T3B1=_T154.ensures_clause;_T155=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T3A9;_T156=& _T155->f1.ensures_assn;_T3B9=(struct Cyc_AssnDef_ExistAssnFn**)_T156;_T157=_T3C2->f1;_T3B0=_T157.throws_clause;_T158=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T3A9;_T159=& _T158->f1.throws_assn;_T3AF=(struct Cyc_AssnDef_ExistAssnFn**)_T159;_T15A=_T3C2->f1;_T3AE=_T15A.return_value;_T15B=_T3C2->f1;_T3AD=_T15B.arg_vardecls;_T15C=_T3C2->f1;_T3AC=_T15C.effconstr;}{struct Cyc_List_List**btvs=_T3C1;void**eff=_T3C0;struct Cyc_Absyn_Tqual*rtq=_T3BE;void*tr=_T3BD;struct Cyc_List_List*args=_T3B7;int c_vararg=_T3B6;struct Cyc_Absyn_VarargInfo*cyc_vararg=_T3B5;struct Cyc_List_List**qb=(struct Cyc_List_List**)_T3BC;struct Cyc_List_List*atts=_T3B4;struct Cyc_Absyn_Exp*chk=_T3B3;struct Cyc_AssnDef_ExistAssnFn**chk_relns=(struct Cyc_AssnDef_ExistAssnFn**)_T3BB;struct Cyc_Absyn_Exp*req=_T3B2;struct Cyc_AssnDef_ExistAssnFn**req_relns=(struct Cyc_AssnDef_ExistAssnFn**)_T3BA;struct Cyc_Absyn_Exp*ens=_T3B1;struct Cyc_AssnDef_ExistAssnFn**ens_relns=(struct Cyc_AssnDef_ExistAssnFn**)_T3B9;struct Cyc_Absyn_Exp*thrws=_T3B0;struct Cyc_AssnDef_ExistAssnFn**thrws_relns=(struct Cyc_AssnDef_ExistAssnFn**)_T3AF;struct Cyc_Absyn_Vardecl*return_vd=_T3AE;struct Cyc_List_List*arg_vds=_T3AD;struct Cyc_List_List*effc=_T3AC;
# 961
int num_formats=0;
int is_cdecl=0;
int is_stdcall=0;
...
_TL18E: _T15D=atts;{void*_T3C2=_T15D->hd;int _T3C3;int _T3C4;enum Cyc_Absyn_Format_Type _T3C5;_T15E=(int*)_T3C2;_T15F=*_T15E;switch(_T15F){case 1:
 is_stdcall=1;goto _LL44;case 2:
 is_cdecl=1;goto _LL44;case 3:
 is_fastcall=1;goto _LL44;case 19:{struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*_T3C6=(struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_T3C2;_T3C5=_T3C6->f1;_T3C4=_T3C6->f2;_T3C3=_T3C6->f3;}{enum Cyc_Absyn_Format_Type fmttype=_T3C5;int i=_T3C4;int j=_T3C3;
# 974
...
_TL194:{struct Cyc_Warn_String_Warn_Warg_struct _T3C6;_T3C6.tag=0;_T3C6.f1=_tag_fat("bad function type attribute ",sizeof(char),29U);_T163=_T3C6;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C6=_T163;{struct Cyc_Warn_Attribute_Warn_Warg_struct _T3C7;_T3C7.tag=10;_T165=atts;_T3C7.f1=_T165->hd;_T164=_T3C7;}{struct Cyc_Warn_Attribute_Warn_Warg_struct _T3C7=_T164;void*_T3C8[2];_T3C8[0]=& _T3C6;_T3C8[1]=& _T3C7;_T166=loc;_T167=_tag_fat(_T3C8,sizeof(void*),2);Cyc_Warn_err2(_T166,_T167);}}goto _TL193;_TL192: _TL193:;}_LL44:;}_T168=atts;
# 968
atts=_T168->tl;goto _TL190;_TL18F: _T169=is_stdcall + is_cdecl;_T16A=is_fastcall;_T16B=_T169 + _T16A;
# 983
if(_T16B <= 1)goto _TL195;{struct Cyc_Warn_String_Warn_Warg_struct _T3C2;_T3C2.tag=0;
_T3C2.f1=_tag_fat("function can't have multiple calling conventions",sizeof(char),49U);_T16C=_T3C2;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C2=_T16C;void*_T3C3[1];_T3C3[0]=& _T3C2;_T16D=loc;_T16E=_tag_fat(_T3C3,sizeof(void*),1);Cyc_Warn_err2(_T16D,_T16E);}goto _TL196;_TL195: _TL196:
 if(num_formats <= 1)goto _TL197;{struct Cyc_Warn_String_Warn_Warg_struct _T3C2;_T3C2.tag=0;
_T3C2.f1=_tag_fat("function can't have multiple format attributes",sizeof(char),47U);_T16F=_T3C2;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C2=_T16F;void*_T3C3[1];_T3C3[0]=& _T3C2;_T170=loc;_T171=_tag_fat(_T3C3,sizeof(void*),1);Cyc_Warn_err2(_T170,_T171);}goto _TL198;_TL197: _TL198: _T172=loc;_T173=btvs;_T174=*_T173;
# 990
...
void*_T3C2=Cyc_Kinds_compress_kb(_T181);_T182=(int*)_T3C2;_T183=*_T182;if(_T183!=0)goto _TL19D;_T184=(struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_T3C2;_T185=_T184->f1;_T186=(struct Cyc_Absyn_Kind*)_T185;_T187=_T186->kind;if(_T187!=Cyc_Absyn_MemKind)goto _TL19F;{struct Cyc_Warn_String_Warn_Warg_struct _T3C3;_T3C3.tag=0;
# 996
_T3C3.f1=_tag_fat("function abstracts Mem type variable ",sizeof(char),38U);_T188=_T3C3;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C3=_T188;{struct Cyc_Warn_Tvar_Warn_Warg_struct _T3C4;_T3C4.tag=7;_T18A=b;_T18B=_T18A->hd;_T3C4.f1=(struct Cyc_Absyn_Tvar*)_T18B;_T189=_T3C4;}{struct Cyc_Warn_Tvar_Warn_Warg_struct _T3C4=_T189;void*_T3C5[2];_T3C5[0]=& _T3C3;_T3C5[1]=& _T3C4;_T18C=loc;_T18D=_tag_fat(_T3C5,sizeof(void*),2);Cyc_Warn_err2(_T18C,_T18D);}}goto _LL4F;_TL19F: goto _LL52;_TL19D: _LL52: goto _LL4F;_LL4F:;}_T18E=b;
# 991
b=_T18E->tl;goto _TL19C;_TL19B:;}{struct Cyc_Tctyp_CVTEnv _T3C2;
# 1002
_T3C2.loc=loc;_T3C2.te=te;_T190=env;_T3C2.kind_env=_T190.kind_env;_T3C2.fn_result=1;_T3C2.def_aliasable=1;_T3C2.inst_type_evar=0;_T191=env;_T3C2.generalize_evars=_T191.generalize_evars;_T3C2.allow_aqual_bounds=1;_T3C2.free_vars=0;_T3C2.free_evars=0;_T3C2.free_qualvars=0;_T18F=_T3C2;}{struct Cyc_Tctyp_CVTEnv new_env=_T18F;_T192=new_env;_T193=& Cyc_Kinds_mk;_T194=(struct Cyc_Absyn_Kind*)_T193;_T195=tr;
...
if(!_T1B9)goto _TL1A9;{struct Cyc_Warn_String_Warn_Warg_struct _T3C2;_T3C2.tag=0;_T3C2.f1=_tag_fat("both c_vararg and cyc_vararg",sizeof(char),29U);_T1BA=_T3C2;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C2=_T1BA;void*_T3C3[1];_T3C3[0]=& _T3C2;_T1BC=Cyc_Warn_impos2;{int(*_T3C4)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T1BC;_T1BB=_T3C4;}_T1BD=_tag_fat(_T3C3,sizeof(void*),1);_T1BB(_T1BD);}goto _TL1AA;_TL1A9: _TL1AA: _T1BE=cyc_vararg;{
struct Cyc_Absyn_VarargInfo _T3C2=*_T1BE;int _T3C3;void*_T3C4;_T3C4=_T3C2.type;_T3C3=_T3C2.inject;{void*vt=_T3C4;int vi=_T3C3;_T1BF=new_env;_T1C0=& Cyc_Kinds_mk;_T1C1=(struct Cyc_Absyn_Kind*)_T1C0;_T1C2=vt;
...
void*_T3C5=Cyc_Absyn_compress(vt);void*_T3C6;void*_T3C7;void*_T3C8;_T1CA=(int*)_T3C5;_T1CB=*_T1CA;if(_T1CB!=4)goto _TL1AD;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T3C9=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T3C5;_T1CC=_T3C9->f1;_T3C8=_T1CC.elt_type;_T1CD=_T3C9->f1;_T1CE=_T1CD.ptr_atts;_T3C7=_T1CE.bounds;_T1CF=_T3C9->f1;_T1D0=_T1CF.ptr_atts;_T3C6=_T1D0.zero_term;}{void*et=_T3C8;void*bs=_T3C7;void*zt=_T3C6;{
# 1038
void*_T3C9=Cyc_Absyn_compress(et);_T1D1=(int*)_T3C9;_T1D2=*_T1D1;if(_T1D2!=0)goto _TL1AF;_T1D3=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T3C9;_T1D4=_T1D3->f1;_T1D5=(int*)_T1D4;_T1D6=*_T1D5;if(_T1D6!=22)goto _TL1B1;_T1D7=
# 1040
Cyc_Tcutil_force_type2bool(0,zt);if(!_T1D7)goto _TL1B3;{struct Cyc_Warn_String_Warn_Warg_struct _T3CA;_T3CA.tag=0;
_T3CA.f1=_tag_fat("can't inject into a zeroterm pointer",sizeof(char),37U);_T1D8=_T3CA;}{struct Cyc_Warn_String_Warn_Warg_struct _T3CA=_T1D8;void*_T3CB[1];_T3CB[0]=& _T3CA;_T1D9=loc;_T1DA=_tag_fat(_T3CB,sizeof(void*),1);Cyc_Warn_err2(_T1D9,_T1DA);}goto _TL1B4;_TL1B3: _TL1B4: _T1DB=
...
# 1045
_TL1BA:{struct Cyc_Warn_String_Warn_Warg_struct _T3CA;_T3CA.tag=0;_T3CA.f1=_tag_fat("can't inject into a fat pointer to datatype",sizeof(char),44U);_T1E4=_T3CA;}{struct Cyc_Warn_String_Warn_Warg_struct _T3CA=_T1E4;void*_T3CB[1];_T3CB[0]=& _T3CA;_T1E5=loc;_T1E6=_tag_fat(_T3CB,sizeof(void*),1);Cyc_Warn_err2(_T1E5,_T1E6);}goto _TL1B9;_TL1B8: _TL1B9: goto _TL1B6;_TL1B5: _TL1B6: goto _LL5C;_TL1B1: goto _LL5F;_TL1AF: _LL5F:{struct Cyc_Warn_String_Warn_Warg_struct _T3CA;_T3CA.tag=0;
# 1049
_T3CA.f1=_tag_fat("can't inject a non-datatype type",sizeof(char),33U);_T1E7=_T3CA;}{struct Cyc_Warn_String_Warn_Warg_struct _T3CA=_T1E7;void*_T3CB[1];_T3CB[0]=& _T3CA;_T1E8=loc;_T1E9=_tag_fat(_T3CB,sizeof(void*),1);Cyc_Warn_err2(_T1E8,_T1E9);}goto _LL5C;_LL5C:;}goto _LL57;}_TL1AD:{struct Cyc_Warn_String_Warn_Warg_struct _T3C9;_T3C9.tag=0;
# 1052
_T3C9.f1=_tag_fat("expecting a datatype pointer type",sizeof(char),34U);_T1EA=_T3C9;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C9=_T1EA;void*_T3CA[1];_T3CA[0]=& _T3C9;_T1EB=loc;_T1EC=_tag_fat(_T3CA,sizeof(void*),1);Cyc_Warn_err2(_T1EB,_T1EC);}goto _LL57;_LL57:;}goto _TL1AC;_TL1AB: _TL1AC:;}}goto _TL1A8;_TL1A7: _TL1A8:
# 1056
...
# 1063
_TL1C0:{struct Cyc_Warn_String_Warn_Warg_struct _T3C2;_T3C2.tag=0;_T3C2.f1=_tag_fat("bad format descriptor",sizeof(char),22U);_T1F1=_T3C2;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C2=_T1F1;void*_T3C3[1];_T3C3[0]=& _T3C2;_T1F2=loc;_T1F3=_tag_fat(_T3C3,sizeof(void*),1);Cyc_Warn_err2(_T1F2,_T1F3);}goto _TL1BF;
# 1066
_TL1BE: _T1F5=Cyc_List_nth;{struct _tuple9*(*_T3C2)(struct Cyc_List_List*,int)=(struct _tuple9*(*)(struct Cyc_List_List*,int))_T1F5;_T1F4=_T3C2;}_T1F6=args;_T1F7=fmt_desc_arg - 1;_T1F8=_T1F4(_T1F6,_T1F7);{struct _tuple9 _T3C2=*_T1F8;void*_T3C3;_T3C3=_T3C2.f2;{void*t=_T3C3;{
# 1068
void*_T3C4=Cyc_Absyn_compress(t);void*_T3C5;void*_T3C6;_T1F9=(int*)_T3C4;_T1FA=*_T1F9;if(_T1FA!=4)goto _TL1C9;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T3C7=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T3C4;_T1FB=_T3C7->f1;_T3C6=_T1FB.elt_type;_T1FC=_T3C7->f1;_T1FD=_T1FC.ptr_atts;_T3C5=_T1FD.bounds;}{void*et=_T3C6;void*b=_T3C5;_T1FE=
# 1071
Cyc_Tcutil_is_char_type(et);if(_T1FE)goto _TL1CB;else{goto _TL1CD;}
_TL1CD:{struct Cyc_Warn_String_Warn_Warg_struct _T3C7;_T3C7.tag=0;_T3C7.f1=_tag_fat("format descriptor is not a string",sizeof(char),34U);_T1FF=_T3C7;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C7=_T1FF;void*_T3C8[1];_T3C8[0]=& _T3C7;_T200=loc;_T201=_tag_fat(_T3C8,sizeof(void*),1);Cyc_Warn_err2(_T200,_T201);}goto _TL1CC;
# 1074
...
if(e!=0)goto _TL1D1;_T205=c_vararg;if(!_T205)goto _TL1D1;{struct Cyc_Warn_String_Warn_Warg_struct _T3C7;_T3C7.tag=0;
_T3C7.f1=_tag_fat("format descriptor is not a char * type",sizeof(char),39U);_T206=_T3C7;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C7=_T206;void*_T3C8[1];_T3C8[0]=& _T3C7;_T207=loc;_T208=_tag_fat(_T3C8,sizeof(void*),1);Cyc_Warn_err2(_T207,_T208);}goto _TL1D2;
_TL1D1: if(e==0)goto _TL1D3;_T209=c_vararg;if(_T209)goto _TL1D3;else{goto _TL1D5;}
_TL1D5:{struct Cyc_Warn_String_Warn_Warg_struct _T3C7;_T3C7.tag=0;_T3C7.f1=_tag_fat("format descriptor is not a char ? type",sizeof(char),39U);_T20A=_T3C7;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C7=_T20A;void*_T3C8[1];_T3C8[0]=& _T3C7;_T20B=loc;_T20C=_tag_fat(_T3C8,sizeof(void*),1);Cyc_Warn_err2(_T20B,_T20C);}goto _TL1D4;_TL1D3: _TL1D4: _TL1D2:;}goto _TL1CF;
# 1082
...
# 1085
_TL1DA:{struct Cyc_Warn_String_Warn_Warg_struct _T3C7;_T3C7.tag=0;_T3C7.f1=_tag_fat("format descriptor is not a char ? type",sizeof(char),39U);_T214=_T3C7;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C7=_T214;void*_T3C8[1];_T3C8[0]=& _T3C7;_T215=loc;_T216=_tag_fat(_T3C8,sizeof(void*),1);Cyc_Warn_err2(_T215,_T216);}goto _TL1D9;_TL1D8: _TL1D9: goto _TL1D7;
# 1089
...
# 1091
_TL1DD:{struct Cyc_Warn_String_Warn_Warg_struct _T3C7;_T3C7.tag=0;_T3C7.f1=_tag_fat("format descriptor is not a char * type",sizeof(char),39U);_T21D=_T3C7;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C7=_T21D;void*_T3C8[1];_T3C8[0]=& _T3C7;_T21E=loc;_T21F=_tag_fat(_T3C8,sizeof(void*),1);Cyc_Warn_err2(_T21E,_T21F);}goto _TL1DC;_TL1DB: _TL1DC: _TL1D7: _TL1CF: _TL1CC: goto _LL64;}_TL1C9:{struct Cyc_Warn_String_Warn_Warg_struct _T3C7;_T3C7.tag=0;
# 1097
_T3C7.f1=_tag_fat("format descriptor is not a string type",sizeof(char),39U);_T220=_T3C7;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C7=_T220;void*_T3C8[1];_T3C8[0]=& _T3C7;_T221=loc;_T222=_tag_fat(_T3C8,sizeof(void*),1);Cyc_Warn_err2(_T221,_T222);}goto _LL64;_LL64:;}
# 1099
if(fmt_arg_start==0)goto _TL1DE;_T223=c_vararg;if(_T223)goto _TL1DE;else{goto _TL1E0;}
# 1103
_TL1E0:{int problem;{struct _tuple16 _T3C4;
_T3C4.f0=ft;_T225=_check_null(cyc_vararg);_T226=_T225->type;_T227=Cyc_Tcutil_pointer_elt_type(_T226);_T3C4.f1=Cyc_Absyn_compress(_T227);_T224=_T3C4;}{struct _tuple16 _T3C4=_T224;struct Cyc_Absyn_Datatypedecl*_T3C5;_T228=_T3C4.f0;_T229=(int)_T228;switch(_T229){case Cyc_Absyn_Printf_ft: _T22A=_T3C4.f1;_T22B=(int*)_T22A;_T22C=*_T22B;if(_T22C!=0)goto _TL1E2;_T22D=_T3C4.f1;_T22E=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T22D;_T22F=_T22E->f1;_T230=(int*)_T22F;_T231=*_T230;if(_T231!=22)goto _TL1E4;_T232=_T3C4.f1;_T233=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T232;_T234=_T233->f1;_T235=(struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)_T234;_T236=_T235->f1;_T237=_T236.KnownDatatype;_T238=_T237.tag;if(_T238!=2)goto _TL1E6;_T239=_T3C4.f1;{struct Cyc_Absyn_AppType_Absyn_Type_struct*_T3C6=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T239;_T23A=_T3C6->f1;{struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*_T3C7=(struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)_T23A;_T23B=_T3C7->f1;_T23C=_T23B.KnownDatatype;_T23D=_T23C.val;{struct Cyc_Absyn_Datatypedecl*_T3C8=*_T23D;_T3C5=_T3C8;}}}{struct Cyc_Absyn_Datatypedecl*tud=_T3C5;_T23E=tud;_T23F=_T23E->name;_T240=
# 1106
Cyc_Absyn_datatype_print_arg_qvar();_T241=Cyc_Absyn_qvar_cmp(_T23F,_T240);problem=_T241!=0;goto _LL69;}_TL1E6: goto _LL6E;_TL1E4: goto _LL6E;_TL1E2: goto _LL6E;case Cyc_Absyn_Scanf_ft: _T242=_T3C4.f1;_T243=(int*)_T242;_T244=*_T243;if(_T244!=0)goto _TL1E8;_T245=_T3C4.f1;_T246=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T245;_T247=_T246->f1;_T248=(int*)_T247;_T249=*_T248;if(_T249!=22)goto _TL1EA;_T24A=_T3C4.f1;_T24B=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T24A;_T24C=_T24B->f1;_T24D=(struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)_T24C;_T24E=_T24D->f1;_T24F=_T24E.KnownDatatype;_T250=_T24F.tag;if(_T250!=2)goto _TL1EC;_T251=_T3C4.f1;{struct Cyc_Absyn_AppType_Absyn_Type_struct*_T3C6=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T251;_T252=_T3C6->f1;{struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*_T3C7=(struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)_T252;_T253=_T3C7->f1;_T254=_T253.KnownDatatype;_T255=_T254.val;{struct Cyc_Absyn_Datatypedecl*_T3C8=*_T255;_T3C5=_T3C8;}}}{struct Cyc_Absyn_Datatypedecl*tud=_T3C5;_T256=tud;_T257=_T256->name;_T258=
# 1109
...
# 1115
if(!_T25A)goto _TL1EE;{struct Cyc_Warn_String_Warn_Warg_struct _T3C4;_T3C4.tag=0;
_T3C4.f1=_tag_fat("format attribute and vararg types don't match",sizeof(char),46U);_T25B=_T3C4;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C4=_T25B;void*_T3C5[1];_T3C5[0]=& _T3C4;_T25C=loc;_T25D=_tag_fat(_T3C5,sizeof(void*),1);Cyc_Warn_err2(_T25C,_T25D);}goto _TL1EF;_TL1EE: _TL1EF:;}goto _TL1DF;_TL1DE: _TL1DF:;}}_TL1BF:;}goto _TL1BD;_TL1BC: _TL1BD: _T25E=qb;{
# 1121
struct Cyc_List_List*qbit=*_T25E;_TL1F3: if(qbit!=0)goto _TL1F1;else{goto _TL1F2;}
_TL1F1: _T25F=qbit;_T260=_T25F->hd;{struct _tuple0*_T3C2=(struct _tuple0*)_T260;void*_T3C3;void*_T3C4;{struct _tuple0 _T3C5=*_T3C2;_T3C4=_T3C5.f0;_T3C3=_T3C5.f1;}{void*tv=_T3C4;void*bnd=_T3C3;_T261=new_env;_T262=& Cyc_Kinds_aqk;_T263=(struct Cyc_Absyn_Kind*)_T262;_T264=bnd;
...
_TL1F5: _T26A=ec;{void*_T3C2=_T26A->hd;void*_T3C3;void*_T3C4;_T26B=(int*)_T3C2;_T26C=*_T26B;switch(_T26C){case 0:{struct Cyc_Absyn_SingleConstraint_Absyn_EffConstraint_struct*_T3C5=(struct Cyc_Absyn_SingleConstraint_Absyn_EffConstraint_struct*)_T3C2;_T26D=_T3C5->f1;_T3C4=(void*)_T26D;}{void*t=_T3C4;_T26E=new_env;_T26F=& Cyc_Kinds_ek;_T270=(struct Cyc_Absyn_Kind*)_T26F;_T271=t;
# 1130
new_env=Cyc_Tctyp_i_check_type(_T26E,_T270,_T271,1,1);goto _LL73;}case 1:{struct Cyc_Absyn_DisjointConstraint_Absyn_EffConstraint_struct*_T3C5=(struct Cyc_Absyn_DisjointConstraint_Absyn_EffConstraint_struct*)_T3C2;_T272=_T3C5->f1;_T3C4=(void*)_T272;_T273=_T3C5->f2;_T3C3=(void*)_T273;}{void*t1=_T3C4;void*t2=_T3C3;_T3C4=t1;_T3C3=t2;goto _LL79;}default:{struct Cyc_Absyn_SubsetConstraint_Absyn_EffConstraint_struct*_T3C5=(struct Cyc_Absyn_SubsetConstraint_Absyn_EffConstraint_struct*)_T3C2;_T274=_T3C5->f1;_T3C4=(void*)_T274;_T275=_T3C5->f2;_T3C3=(void*)_T275;}_LL79: {void*t1=_T3C4;void*t2=_T3C3;_T276=new_env;_T277=& Cyc_Kinds_ek;_T278=(struct Cyc_Absyn_Kind*)_T277;_T279=t1;
# 1134
...
struct Cyc_Tcenv_Tenv*old_te=_T27F.te;{struct Cyc_Tcenv_Tenv*_T3C2=_cycalloc(sizeof(struct Cyc_Tcenv_Tenv));_T281=te;
_T3C2->ns=_T281->ns;_T282=te;_T3C2->ae=_T282->ae;_T3C2->le=fenv;_T3C2->allow_valueof=1;_T283=te;
_T3C2->in_extern_c_include=_T283->in_extern_c_include;_T284=te;
_T3C2->in_tempest=_T284->in_tempest;_T285=te;_T3C2->tempest_generalize=_T285->tempest_generalize;_T286=te;
_T3C2->in_extern_c_inc_repeat=_T286->in_extern_c_inc_repeat;_T280=(struct Cyc_Tcenv_Tenv*)_T3C2;}
# 1145
new_env.te=_T280;{
# 1149
...
_TL1FD:{struct Cyc_Warn_String_Warn_Warg_struct _T3C2;_T3C2.tag=0;_T3C2.f1=_tag_fat("we do not yet support @checks on vararg functions",sizeof(char),50U);_T28C=_T3C2;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C2=_T28C;void*_T3C3[1];_T3C3[0]=& _T3C2;_T28D=loc;_T28E=_tag_fat(_T3C3,sizeof(void*),1);Cyc_Warn_err2(_T28D,_T28E);}goto _TL1FC;_TL1FB: _TL1FC: _T28F=new_env;_T290=
_tag_fat("@checks",sizeof(char),8U);_T291=chk;{struct _tuple15 _T3C2=Cyc_Tctyp_check_clause(_T28F,_T290,_T291);struct Cyc_AssnDef_AssnMap _T3C3;struct Cyc_Tctyp_CVTEnv _T3C4;_T3C4=_T3C2.f0;_T3C3=_T3C2.f1;{struct Cyc_Tctyp_CVTEnv nenv=_T3C4;struct Cyc_AssnDef_AssnMap chk_assn=_T3C3;
...
_tag_fat("@requires",sizeof(char),10U);_T295=req;{struct _tuple15 _T3C2=Cyc_Tctyp_check_clause(_T293,_T294,_T295);struct Cyc_AssnDef_AssnMap _T3C3;struct Cyc_Tctyp_CVTEnv _T3C4;_T3C4=_T3C2.f0;_T3C3=_T3C2.f1;{struct Cyc_Tctyp_CVTEnv nenv=_T3C4;struct Cyc_AssnDef_AssnMap req_assn=_T3C3;
new_env=nenv;_T296=req_relns;
*_T296=Cyc_AssnDef_assnmap2existassnfn(req_assn,vds);}}goto _TL200;_TL1FF: _TL200: {
# 1163
struct Cyc_List_List*vds;vds=_cycalloc(sizeof(struct Cyc_List_List));_T297=vds;_T297->hd=Cyc_AssnDef_memory;_T298=vds;{struct Cyc_List_List*_T3C2=_cycalloc(sizeof(struct Cyc_List_List));_T3C2->hd=Cyc_AssnDef_pre_memory;_T3C2->tl=arg_vds;_T299=(struct Cyc_List_List*)_T3C2;}_T298->tl=_T299;
if(ens==0)goto _TL201;_T29A=new_env;_T29B=
_tag_fat("@ensures",sizeof(char),9U);_T29C=ens;{struct _tuple15 _T3C2=Cyc_Tctyp_check_clause(_T29A,_T29B,_T29C);struct Cyc_AssnDef_AssnMap _T3C3;struct Cyc_Tctyp_CVTEnv _T3C4;_T3C4=_T3C2.f0;_T3C3=_T3C2.f1;{struct Cyc_Tctyp_CVTEnv nenv=_T3C4;struct Cyc_AssnDef_AssnMap ens_assn=_T3C3;
new_env=nenv;_T29D=ens_relns;_T29E=ens_assn;{struct Cyc_List_List*_T3C5=_cycalloc(sizeof(struct Cyc_List_List));
_T3C5->hd=return_vd;_T3C5->tl=vds;_T29F=(struct Cyc_List_List*)_T3C5;}*_T29D=Cyc_AssnDef_assnmap2existassnfn(_T29E,_T29F);}}goto _TL202;_TL201: _TL202:
# 1169
 if(thrws==0)goto _TL203;_T2A0=new_env;_T2A1=
_tag_fat("@throws",sizeof(char),8U);_T2A2=thrws;{struct _tuple15 _T3C2=Cyc_Tctyp_check_clause(_T2A0,_T2A1,_T2A2);struct Cyc_AssnDef_AssnMap _T3C3;struct Cyc_Tctyp_CVTEnv _T3C4;_T3C4=_T3C2.f0;_T3C3=_T3C2.f1;{struct Cyc_Tctyp_CVTEnv nenv=_T3C4;struct Cyc_AssnDef_AssnMap thrws_assn=_T3C3;
...
_TL209: _T2B0=eff;{void*_T3C2[2];_T3C2[0]=Cyc_Absyn_heap_rgn_type;_T2B2=eff;_T2B3=*_T2B2;_T3C2[1]=_check_null(_T2B3);_T2B4=_tag_fat(_T3C2,sizeof(void*),2);_T2B1=Cyc_List_list(_T2B4);}_T2B5=Cyc_Absyn_join_eff(_T2B1);*_T2B0=Cyc_Tcutil_normalize_effect(_T2B5);goto _TL208;_TL207: _TL208: goto _TL206;
# 1183
...
_TL20B: _T2B9=tvs;_T2BA=_T2B9->hd;_T2BB=(struct _tuple12*)_T2BA;{struct _tuple12 _T3C2=*_T2BB;int _T3C3;struct Cyc_Absyn_Tvar*_T3C4;_T3C4=_T3C2.f0;_T3C3=_T3C2.f1;{struct Cyc_Absyn_Tvar*tv=_T3C4;int put_in_eff=_T3C3;_T2BC=put_in_eff;
if(_T2BC)goto _TL20E;else{goto _TL210;}_TL210: goto _TL20A;_TL20E: _T2BD=tv;_T2BE=_T2BD->kind;{
void*_T3C5=Cyc_Kinds_compress_kb(_T2BE);void*_T3C6;_T2BF=(int*)_T3C5;_T2C0=*_T2BF;switch(_T2C0){case 2: _T2C1=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C5;_T2C2=_T2C1->f2;_T2C3=(struct Cyc_Absyn_Kind*)_T2C2;_T2C4=_T2C3->kind;_T2C5=(int)_T2C4;switch(_T2C5){case Cyc_Absyn_BoolKind: goto _LL8D;case Cyc_Absyn_PtrBndKind: _LL8D: goto _LL8F;case Cyc_Absyn_IntKind: _LL8F: goto _LL91;case Cyc_Absyn_AqualKind: _LL91: goto _LL93;case Cyc_Absyn_EffKind:{struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T3C7=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C5;_T2C6=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C5;_T2C7=& _T2C6->f1;_T3C6=(struct Cyc_Core_Opt**)_T2C7;}{struct Cyc_Core_Opt**f=_T3C6;_T2C8=f;_T2C9=& Cyc_Kinds_ek;_T2CA=(struct Cyc_Absyn_Kind*)_T2C9;
# 1201
*_T2C8=Cyc_Kinds_kind_to_bound_opt(_T2CA);goto _LL9D;}default: goto _LLA0;};case 0: _T2CB=(struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_T3C5;_T2CC=_T2CB->f1;_T2CD=(struct Cyc_Absyn_Kind*)_T2CC;_T2CE=_T2CD->kind;_T2CF=(int)_T2CE;switch(_T2CF){case Cyc_Absyn_BoolKind: _LL93: goto _LL95;case Cyc_Absyn_PtrBndKind: _LL95: goto _LL97;case Cyc_Absyn_IntKind: _LL97: goto _LL99;case Cyc_Absyn_AqualKind: _LL99: goto _LL89;case Cyc_Absyn_EffKind: _LL9D:{struct Cyc_List_List*_T3C7=_cycalloc(sizeof(struct Cyc_List_List));
# 1203
_T3C7->hd=Cyc_Absyn_var_type(tv);_T3C7->tl=effect;_T2D0=(struct Cyc_List_List*)_T3C7;}effect=_T2D0;goto _LL89;default: _LLA0: _LLA1:{struct Cyc_List_List*_T3C7=_cycalloc(sizeof(struct Cyc_List_List));_T2D2=
# 1208
Cyc_Absyn_var_type(tv);_T3C7->hd=Cyc_Absyn_regionsof_eff(_T2D2);_T3C7->tl=effect;_T2D1=(struct Cyc_List_List*)_T3C7;}effect=_T2D1;goto _LL89;};default:{struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*_T3C7=(struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_T3C5;_T2D3=(struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_T3C5;_T2D4=& _T2D3->f1;_T3C6=(struct Cyc_Core_Opt**)_T2D4;}{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_T3C6;_T2D5=f;{struct Cyc_Core_Opt*_T3C7=_cycalloc(sizeof(struct Cyc_Core_Opt));{struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T3C8=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_T3C8->tag=2;
# 1205
_T3C8->f1=0;_T2D8=& Cyc_Kinds_ak;_T3C8->f2=(struct Cyc_Absyn_Kind*)_T2D8;_T2D7=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C8;}_T3C7->v=(void*)_T2D7;_T2D6=(struct Cyc_Core_Opt*)_T3C7;}*_T2D5=_T2D6;goto _LLA1;}}_LL89:;}}}_TL20A: _T2D9=tvs;
# 1188
...
_TL215: _T2DB=ts;_T2DC=_T2DB->hd;_T2DD=(struct _tuple14*)_T2DC;{struct _tuple14 _T3C2=*_T2DD;int _T3C3;void*_T3C4;_T3C4=_T3C2.f0;_T3C3=_T3C2.f1;{void*tv=_T3C4;int put_in_eff=_T3C3;_T2DE=put_in_eff;
if(_T2DE)goto _TL218;else{goto _TL21A;}_TL21A: goto _TL214;_TL218: {
struct Cyc_Absyn_Kind*_T3C5=Cyc_Tcutil_type_kind(tv);_T2DF=(struct Cyc_Absyn_Kind*)_T3C5;_T2E0=_T2DF->kind;_T2E1=(int)_T2E0;switch(_T2E1){case Cyc_Absyn_IntKind: goto _LLA9;case Cyc_Absyn_BoolKind: _LLA9: goto _LLAB;case Cyc_Absyn_PtrBndKind: _LLAB: goto _LLAD;case Cyc_Absyn_AqualKind: _LLAD: goto _LLA5;case Cyc_Absyn_EffKind:{struct Cyc_List_List*_T3C6=_cycalloc(sizeof(struct Cyc_List_List));
# 1222
_T3C6->hd=tv;_T3C6->tl=effect;_T2E2=(struct Cyc_List_List*)_T3C6;}effect=_T2E2;goto _LLA5;default:{struct Cyc_List_List*_T3C6=_cycalloc(sizeof(struct Cyc_List_List));
_T3C6->hd=Cyc_Absyn_regionsof_eff(tv);_T3C6->tl=effect;_T2E3=(struct Cyc_List_List*)_T3C6;}effect=_T2E3;goto _LLA5;}_LLA5:;}}}_TL214: _T2E4=ts;
# 1212
...
_TL21F: _T2E9=bs;_T2EA=_T2E9->hd;_T2EB=(struct Cyc_Absyn_Tvar*)_T2EA;_T2EC=_T2EB->kind;{void*_T3C2=Cyc_Kinds_compress_kb(_T2EC);struct Cyc_Absyn_Kind*_T3C3;void*_T3C4;_T2ED=(int*)_T3C2;_T2EE=*_T2ED;switch(_T2EE){case 1:{struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*_T3C5=(struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_T3C2;_T2EF=(struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_T3C2;_T2F0=& _T2EF->f1;_T3C4=(struct Cyc_Core_Opt**)_T2F0;}{struct Cyc_Core_Opt**f=_T3C4;{struct Cyc_Warn_String_Warn_Warg_struct _T3C5;_T3C5.tag=0;
# 1236
_T3C5.f1=_tag_fat("type variable ",sizeof(char),15U);_T2F1=_T3C5;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C5=_T2F1;{struct Cyc_Warn_Tvar_Warn_Warg_struct _T3C6;_T3C6.tag=7;_T2F3=bs;_T2F4=_T2F3->hd;_T3C6.f1=(struct Cyc_Absyn_Tvar*)_T2F4;_T2F2=_T3C6;}{struct Cyc_Warn_Tvar_Warn_Warg_struct _T3C6=_T2F2;{struct Cyc_Warn_String_Warn_Warg_struct _T3C7;_T3C7.tag=0;_T3C7.f1=_tag_fat(" unconstrained, assuming boxed",sizeof(char),31U);_T2F5=_T3C7;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C7=_T2F5;void*_T3C8[3];_T3C8[0]=& _T3C5;_T3C8[1]=& _T3C6;_T3C8[2]=& _T3C7;_T2F6=loc;_T2F7=_tag_fat(_T3C8,sizeof(void*),3);Cyc_Warn_warn2(_T2F6,_T2F7);}}}_T2F8=f;_T2F9=& Cyc_Kinds_bk;_T2FA=(struct Cyc_Absyn_Kind*)_T2F9;
*_T2F8=Cyc_Kinds_kind_to_bound_opt(_T2FA);goto _LLB2;}case 2:{struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_T3C5=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C2;_T2FB=(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_T3C2;_T2FC=& _T2FB->f1;_T3C4=(struct Cyc_Core_Opt**)_T2FC;_T3C3=_T3C5->f2;}{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_T3C4;struct Cyc_Absyn_Kind*k=_T3C3;_T2FD=k;_T2FE=(struct Cyc_Absyn_Kind*)_T2FD;_T2FF=_T2FE->kind;_T300=(int)_T2FF;switch(_T300){case Cyc_Absyn_BoxKind: goto _LLBF;case Cyc_Absyn_MemKind: _LLBF: goto _LLC1;case Cyc_Absyn_AnyKind: _LLC1: _T301=f;_T302=& Cyc_Kinds_bk;_T303=(struct Cyc_Absyn_Kind*)_T302;
# 1244
...
# 1248
*_T307=Cyc_Kinds_kind_to_bound_opt(k);goto _LLBB;}_LLBB: goto _LLB2;}default: _T308=(struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_T3C2;_T309=_T308->f1;_T30A=(struct Cyc_Absyn_Kind*)_T309;_T30B=_T30A->kind;if(_T30B!=Cyc_Absyn_MemKind)goto _TL224;{struct Cyc_Warn_String_Warn_Warg_struct _T3C5;_T3C5.tag=0;
# 1252
_T3C5.f1=_tag_fat("functions can't abstract M types",sizeof(char),33U);_T30C=_T3C5;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C5=_T30C;void*_T3C6[1];_T3C6[0]=& _T3C5;_T30D=loc;_T30E=_tag_fat(_T3C6,sizeof(void*),1);Cyc_Warn_err2(_T30D,_T30E);}goto _LLB2;_TL224: goto _LLB2;}_LLB2:;}_T30F=bs;
# 1233
bs=_T30F->tl;goto _TL221;_TL220:;}goto _TL21D;_TL21C: _TL21D:{
# 1256
struct Cyc_List_List*(*_T3C2)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*))=(struct Cyc_List_List*(*)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*)))Cyc_Tctyp_remove_bound_tvars;_T310=_T3C2;}_T311=new_env;_T312=_T311.kind_env;_T313=btvs;_T314=*_T313;_T316=Cyc_Core_identity;{struct Cyc_Absyn_Tvar*(*_T3C2)(struct Cyc_Absyn_Tvar*)=(struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*))_T316;_T315=_T3C2;}env.kind_env=_T310(_T312,_T314,_T315);{
struct Cyc_List_List*(*_T3C2)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct _tuple12*))=(struct Cyc_List_List*(*)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct _tuple12*)))Cyc_Tctyp_remove_bound_tvars;_T317=_T3C2;}_T318=new_env;_T319=_T318.free_vars;_T31A=btvs;_T31B=*_T31A;_T31D=Cyc_Core_fst;{struct Cyc_Absyn_Tvar*(*_T3C2)(struct _tuple12*)=(struct Cyc_Absyn_Tvar*(*)(struct _tuple12*))_T31D;_T31C=_T3C2;}new_env.free_vars=_T317(_T319,_T31B,_T31C);_T31E=new_env;{
# 1259
struct Cyc_List_List*tvs=_T31E.free_vars;_TL229: if(tvs!=0)goto _TL227;else{goto _TL228;}
_TL227: _T31F=tvs;_T320=_T31F->hd;_T321=(struct _tuple12*)_T320;{struct _tuple12 _T3C2=*_T321;int _T3C3;struct Cyc_Absyn_Tvar*_T3C4;_T3C4=_T3C2.f0;_T3C3=_T3C2.f1;{struct Cyc_Absyn_Tvar*t=_T3C4;int b=_T3C3;_T322=env;_T323=_T322.free_vars;_T324=t;_T325=b;
...
_TL22B: _T328=evs;_T329=_T328->hd;_T32A=(struct _tuple14*)_T329;{struct _tuple14 _T3C2=*_T32A;int _T3C3;void*_T3C4;_T3C4=_T3C2.f0;_T3C3=_T3C2.f1;{void*e=_T3C4;int b=_T3C3;_T32B=env;_T32C=_T32B.free_evars;_T32D=e;_T32E=b;
...
_TL231: _T335=Cyc_List_exists_c;{int(*_T3C2)(int(*)(struct _tuple14*,struct _tuple14*),struct _tuple14*,struct Cyc_List_List*)=(int(*)(int(*)(struct _tuple14*,struct _tuple14*),struct _tuple14*,struct Cyc_List_List*))_T335;_T334=_T3C2;}_T336=it;_T337=_T336->hd;_T338=(struct _tuple14*)_T337;_T339=env;_T33A=_T339.free_qualvars;_T33B=_T334(Cyc_Tctyp_cmp_fqv,_T338,_T33A);if(_T33B)goto _TL234;else{goto _TL236;}
_TL236:{struct Cyc_List_List*_T3C2=_cycalloc(sizeof(struct Cyc_List_List));_T33D=it;_T33E=_T33D->hd;_T3C2->hd=(struct _tuple14*)_T33E;_T33F=env;_T3C2->tl=_T33F.free_qualvars;_T33C=(struct Cyc_List_List*)_T3C2;}env.free_qualvars=_T33C;goto _TL235;_TL234: _TL235: _T340=it;
# 1270
it=_T340->tl;goto _TL233;_TL232:;}goto _TL22F;
# 1276
_TL22E: _T341=new_env;env.free_qualvars=_T341.free_qualvars;_TL22F: goto _LL3;}}}}}}case 7:{struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_T3C2=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_T3A9;_T3AB=_T3C2->f1;_T3B6=_T3C2->f2;_T3C1=_T3C2->f3;}{enum Cyc_Absyn_AggrKind k=_T3AB;int is_tuple=_T3B6;struct Cyc_List_List*fs=_T3C1;
# 1281
struct Cyc_List_List*prev_fields=0;
_TL23A: if(fs!=0)goto _TL238;else{goto _TL239;}
_TL238: _T342=fs;_T343=_T342->hd;{struct Cyc_Absyn_Aggrfield*_T3C2=(struct Cyc_Absyn_Aggrfield*)_T343;struct Cyc_Absyn_Exp*_T3C3;struct Cyc_List_List*_T3C4;struct Cyc_Absyn_Exp*_T3C5;void*_T3C6;void*_T3C7;struct _fat_ptr*_T3C8;{struct Cyc_Absyn_Aggrfield _T3C9=*_T3C2;_T3C8=_T3C9.name;_T344=& _T3C2->tq;_T3C7=(struct Cyc_Absyn_Tqual*)_T344;_T3C6=_T3C9.type;_T3C5=_T3C9.width;_T3C4=_T3C9.attributes;_T3C3=_T3C9.requires_clause;}{struct _fat_ptr*fn=_T3C8;struct Cyc_Absyn_Tqual*tqp=(struct Cyc_Absyn_Tqual*)_T3C7;void*t=_T3C6;struct Cyc_Absyn_Exp*width=_T3C5;struct Cyc_List_List*atts=_T3C4;struct Cyc_Absyn_Exp*requires_clause=_T3C3;_T346=Cyc_List_mem;{
int(*_T3C9)(int(*)(struct _fat_ptr*,struct _fat_ptr*),struct Cyc_List_List*,struct _fat_ptr*)=(int(*)(int(*)(struct _fat_ptr*,struct _fat_ptr*),struct Cyc_List_List*,struct _fat_ptr*))_T346;_T345=_T3C9;}_T347=Cyc_strptrcmp;_T348=prev_fields;_T349=fn;_T34A=_T345(_T347,_T348,_T349);if(!_T34A)goto _TL23B;{struct Cyc_Warn_String_Warn_Warg_struct _T3C9;_T3C9.tag=0;
_T3C9.f1=_tag_fat("duplicate field ",sizeof(char),17U);_T34B=_T3C9;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C9=_T34B;{struct Cyc_Warn_String_Warn_Warg_struct _T3CA;_T3CA.tag=0;_T34D=fn;_T3CA.f1=*_T34D;_T34C=_T3CA;}{struct Cyc_Warn_String_Warn_Warg_struct _T3CA=_T34C;void*_T3CB[2];_T3CB[0]=& _T3C9;_T3CB[1]=& _T3CA;_T34E=loc;_T34F=_tag_fat(_T3CB,sizeof(void*),2);Cyc_Warn_err2(_T34E,_T34F);}}goto _TL23C;_TL23B: _TL23C: _T350=fn;_T351=*_T350;_T352=
_tag_fat("",sizeof(char),1U);_T353=Cyc_strcmp(_T351,_T352);if(_T353==0)goto _TL23D;{struct Cyc_List_List*_T3C9=_cycalloc(sizeof(struct Cyc_List_List));
_T3C9->hd=fn;_T3C9->tl=prev_fields;_T354=(struct Cyc_List_List*)_T3C9;}prev_fields=_T354;goto _TL23E;_TL23D: _TL23E: _T355=env;_T356=& Cyc_Kinds_mk;_T357=(struct Cyc_Absyn_Kind*)_T356;_T358=t;
...
# 1294
if(_T35F==1)goto _TL241;{struct Cyc_Warn_String_Warn_Warg_struct _T3C9;_T3C9.tag=0;
_T3C9.f1=_tag_fat("@requires clause is only allowed on union members",sizeof(char),50U);_T360=_T3C9;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C9=_T360;void*_T3CA[1];_T3CA[0]=& _T3C9;_T361=loc;_T362=_tag_fat(_T3CA,sizeof(void*),1);Cyc_Warn_err2(_T361,_T362);}goto _TL242;_TL241: _TL242: _T363=
...
_TL245:{struct Cyc_Warn_String_Warn_Warg_struct _T3C9;_T3C9.tag=0;_T3C9.f1=_tag_fat("@requires clause has type ",sizeof(char),27U);_T366=_T3C9;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C9=_T366;{struct Cyc_Warn_TypOpt_Warn_Warg_struct _T3CA;_T3CA.tag=3;_T368=requires_clause;_T3CA.f1=_T368->topt;_T367=_T3CA;}{struct Cyc_Warn_TypOpt_Warn_Warg_struct _T3CA=_T367;{struct Cyc_Warn_String_Warn_Warg_struct _T3CB;_T3CB.tag=0;
_T3CB.f1=_tag_fat(" instead of integral type",sizeof(char),26U);_T369=_T3CB;}{struct Cyc_Warn_String_Warn_Warg_struct _T3CB=_T369;void*_T3CC[3];_T3CC[0]=& _T3C9;_T3CC[1]=& _T3CA;_T3CC[2]=& _T3CB;_T36A=loc;_T36B=_tag_fat(_T3CC,sizeof(void*),3);Cyc_Warn_err2(_T36A,_T36B);}}}goto _TL244;_TL243: _TL244:
 env=Cyc_Tctyp_i_check_type_level_exp(requires_clause,env);goto _TL240;_TL23F: _TL240:;}}_T36C=fs;
# 1282
fs=_T36C->tl;goto _TL23A;_TL239: goto _LL3;}default:{struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_T3C2=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_T3A9;_T3AA=_T3C2->f1;_T36D=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_T3A9;_T36E=& _T36D->f2;_T3C1=(struct Cyc_List_List**)_T36E;_T36F=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_T3A9;_T370=& _T36F->f3;_T3C0=(struct Cyc_Absyn_Typedefdecl**)_T370;_T371=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_T3A9;_T372=& _T371->f4;_T3BE=(void**)_T372;}{struct _tuple1*tdn=_T3AA;struct Cyc_List_List**targs_ref=(struct Cyc_List_List**)_T3C1;struct Cyc_Absyn_Typedefdecl**tdopt=(struct Cyc_Absyn_Typedefdecl**)_T3C0;void**toptp=(void**)_T3BE;
# 1307
struct Cyc_Absyn_Typedefdecl*td;{struct _handler_cons _T3C2;_T373=& _T3C2;_push_handler(_T373);{int _T3C3=0;_T374=setjmp(_T3C2.handler);if(!_T374)goto _TL246;_T3C3=1;goto _TL247;_TL246: _TL247: if(_T3C3)goto _TL248;else{goto _TL24A;}_TL24A:
 td=Cyc_Tcenv_lookup_typedefdecl(te,loc,tdn);_pop_handler();goto _TL249;_TL248: _T375=Cyc_Core_get_exn_thrown();{void*_T3C4=(void*)_T375;void*_T3C5;_T376=(struct Cyc_Dict_Absent_exn_struct*)_T3C4;_T377=_T376->tag;_T378=Cyc_Dict_Absent;if(_T377!=_T378)goto _TL24B;{struct Cyc_Warn_String_Warn_Warg_struct _T3C6;_T3C6.tag=0;
# 1311
_T3C6.f1=_tag_fat("unbound typedef name ",sizeof(char),22U);_T379=_T3C6;}{struct Cyc_Warn_String_Warn_Warg_struct _T3C6=_T379;{struct Cyc_Warn_Qvar_Warn_Warg_struct _T3C7;_T3C7.tag=1;_T3C7.f1=tdn;_T37A=_T3C7;}{struct Cyc_Warn_Qvar_Warn_Warg_struct _T3C7=_T37A;void*_T3C8[2];_T3C8[0]=& _T3C6;_T3C8[1]=& _T3C7;_T37B=loc;_T37C=_tag_fat(_T3C8,sizeof(void*),2);Cyc_Warn_err2(_T37B,_T37C);}}_T37D=env;
return _T37D;_TL24B: _T3C5=_T3C4;{void*exn=_T3C5;_rethrow(exn);};}_TL249:;}}_T37E=tdopt;
# 1314
*_T37E=td;_T37F=env;_T380=targs_ref;_T381=td;_T382=_T381->tvs;_T383=expected_kind;_T384=allow_abs_aggr;_T385=tdn;_T386=td;
env=Cyc_Tctyp_check_type_inst(_T37F,_T380,_T382,_T383,_T384,_T385,_T386);_T387=td;_T388=_T387->defn;
# 1317
if(_T388==0)goto _TL24D;_T389=loc;_T38A=td;_T38B=_T38A->defn;_T38C=expected_kind;
Cyc_Tctyp_check_constrain_ptrbnd(_T389,_T38B,_T38C);{
struct Cyc_List_List*inst=0;_T38D=td;{
struct Cyc_List_List*tvs=_T38D->tvs;_T38E=targs_ref;{
struct Cyc_List_List*ts=*_T38E;
_TL252: if(tvs!=0)goto _TL250;else{goto _TL251;}
_TL250:{struct Cyc_List_List*_T3C2=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple17*_T3C3=_cycalloc(sizeof(struct _tuple17));_T391=tvs;_T392=_T391->hd;_T3C3->f0=(struct Cyc_Absyn_Tvar*)_T392;_T393=_check_null(ts);_T3C3->f1=_T393->hd;_T390=(struct _tuple17*)_T3C3;}_T3C2->hd=_T390;_T3C2->tl=inst;_T38F=(struct Cyc_List_List*)_T3C2;}inst=_T38F;_T394=tvs;
# 1322
tvs=_T394->tl;_T395=ts;ts=_T395->tl;goto _TL252;_TL251: _T396=toptp;_T397=inst;_T398=td;_T399=_T398->defn;_T39A=
# 1324
_check_null(_T399);*_T396=Cyc_Tcutil_substitute(_T397,_T39A);}}}goto _TL24E;_TL24D: _TL24E: goto _LL3;}}_LL3:;}_T39B=
# 1328
Cyc_Tcutil_type_kind(t);_T39C=expected_kind;_T39D=Cyc_Kinds_kind_leq(_T39B,_T39C);if(_T39D)goto _TL253;else{goto _TL255;}
_TL255:{struct Cyc_Warn_String_Warn_Warg_struct _T3A9;_T3A9.tag=0;_T3A9.f1=_tag_fat("type ",sizeof(char),6U);_T39E=_T3A9;}{struct Cyc_Warn_String_Warn_Warg_struct _T3A9=_T39E;{struct Cyc_Warn_Typ_Warn_Warg_struct _T3AA;_T3AA.tag=2;_T3AA.f1=t;_T39F=_T3AA;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T3AA=_T39F;{struct Cyc_Warn_String_Warn_Warg_struct _T3AB;_T3AB.tag=0;_T3AB.f1=_tag_fat(" has kind ",sizeof(char),11U);_T3A0=_T3AB;}{struct Cyc_Warn_String_Warn_Warg_struct _T3AB=_T3A0;{struct Cyc_Warn_Kind_Warn_Warg_struct _T3AC;_T3AC.tag=9;_T3AC.f1=Cyc_Tcutil_type_kind(t);_T3A1=_T3AC;}{struct Cyc_Warn_Kind_Warn_Warg_struct _T3AC=_T3A1;{struct Cyc_Warn_String_Warn_Warg_struct _T3AD;_T3AD.tag=0;
_T3AD.f1=_tag_fat(" but as used here needs kind ",sizeof(char),30U);_T3A2=_T3AD;}{struct Cyc_Warn_String_Warn_Warg_struct _T3AD=_T3A2;{struct Cyc_Warn_Kind_Warn_Warg_struct _T3AE;_T3AE.tag=9;_T3AE.f1=expected_kind;_T3A3=_T3AE;}{struct Cyc_Warn_Kind_Warn_Warg_struct _T3AE=_T3A3;void*_T3AF[6];_T3AF[0]=& _T3A9;_T3AF[1]=& _T3AA;_T3AF[2]=& _T3AB;_T3AF[3]=& _T3AC;_T3AF[4]=& _T3AD;_T3AF[5]=& _T3AE;_T3A4=loc;_T3A5=_tag_fat(_T3AF,sizeof(void*),6);Cyc_Warn_err2(_T3A4,_T3A5);}}}}}}goto _TL254;_TL253: _TL254: _T3A6=env;
# 1332
return _T3A6;}}
# 1335
