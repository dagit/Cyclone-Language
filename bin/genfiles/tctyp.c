...
goto _LL8;}}else{_LLB: _LLC:
 goto _LL8;}_LL8:;}}}
# 78
return({struct Cyc_List_List*_tmpB=_region_malloc(r,sizeof(*_tmpB));({struct _tuple13*_tmp355=({struct _tuple13*_tmpA=_region_malloc(r,sizeof(*_tmpA));_tmpA->f1=e,_tmpA->f2=b;_tmpA;});_tmpB->hd=_tmp355;}),_tmpB->tl=es;_tmpB;});}}else{_LL3: _LL4:
 return es;}_LL0:;}
# 84
static struct Cyc_List_List*Cyc_Tctyp_add_bound_tvar(struct Cyc_List_List*tvs,struct Cyc_Absyn_Tvar*tv){
if(tv->identity == - 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2BE;_tmp2BE.tag=0U,({struct _fat_ptr _tmp356=({const char*_tmp11="bound tvar id for ";_tag_fat(_tmp11,sizeof(char),19U);});_tmp2BE.f1=_tmp356;});_tmp2BE;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmpE=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp2BD;_tmp2BD.tag=6U,_tmp2BD.f1=tv;_tmp2BD;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2BC;_tmp2BC.tag=0U,({struct _fat_ptr _tmp357=({const char*_tmp10=" is NULL";_tag_fat(_tmp10,sizeof(char),9U);});_tmp2BC.f1=_tmp357;});_tmp2BC;});void*_tmpC[3U];_tmpC[0]=& _tmpD,_tmpC[1]=& _tmpE,_tmpC[2]=& _tmpF;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpC,sizeof(void*),3U));});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2BF;_tmp2BF.tag=0U,({struct _fat_ptr _tmp358=({const char*_tmp1F="can't unify evar with unique region!";_tag_fat(_tmp1F,sizeof(char),37U);});_tmp2BF.f1=_tmp358;});_tmp2BF;});void*_tmp1D[1U];_tmp1D[0]=& _tmp1E;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1D,sizeof(void*),1U));});
goto _LL5;case Cyc_Absyn_Aliasable: _LL8: _LL9:
 goto _LLB;case Cyc_Absyn_Top: _LLA: _LLB:
# 144
 if(!Cyc_Unify_unify(e,Cyc_Absyn_heap_rgn_type))({struct Cyc_Warn_String_Warn_Warg_struct _tmp21=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C0;_tmp2C0.tag=0U,({struct _fat_ptr _tmp359=({const char*_tmp22="can't unify evar with heap!";_tag_fat(_tmp22,sizeof(char),28U);});_tmp2C0.f1=_tmp359;});_tmp2C0;});void*_tmp20[1U];_tmp20[0]=& _tmp21;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp20,sizeof(void*),1U));});
goto _LL5;default: goto _LL12;}case Cyc_Absyn_EffKind: _LLC: _LLD:
# 147
 if(!Cyc_Unify_unify(e,Cyc_Absyn_empty_effect))({struct Cyc_Warn_String_Warn_Warg_struct _tmp24=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C1;_tmp2C1.tag=0U,({struct _fat_ptr _tmp35A=({const char*_tmp25="can't unify evar with {}!";_tag_fat(_tmp25,sizeof(char),26U);});_tmp2C1.f1=_tmp35A;});_tmp2C1;});void*_tmp23[1U];_tmp23[0]=& _tmp24;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp23,sizeof(void*),1U));});
goto _LL5;case Cyc_Absyn_BoolKind: _LLE: _LLF:
# 150
 if(!Cyc_Unify_unify(e,Cyc_Absyn_false_type))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp27=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C4;_tmp2C4.tag=0U,({struct _fat_ptr _tmp35B=({const char*_tmp2B="can't unify evar ";_tag_fat(_tmp2B,sizeof(char),18U);});_tmp2C4.f1=_tmp35B;});_tmp2C4;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp28=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2C3;_tmp2C3.tag=2U,_tmp2C3.f1=(void*)e;_tmp2C3;});struct Cyc_Warn_String_Warn_Warg_struct _tmp29=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C2;_tmp2C2.tag=0U,({struct _fat_ptr _tmp35C=({const char*_tmp2A=" with @false!";_tag_fat(_tmp2A,sizeof(char),14U);});_tmp2C2.f1=_tmp35C;});_tmp2C2;});void*_tmp26[3U];_tmp26[0]=& _tmp27,_tmp26[1]=& _tmp28,_tmp26[2]=& _tmp29;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp26,sizeof(void*),3U));});
goto _LL5;case Cyc_Absyn_PtrBndKind: _LL10: _LL11:
# 154
 if(!({void*_tmp35D=e;Cyc_Unify_unify(_tmp35D,Cyc_Absyn_bounds_one());}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C5;_tmp2C5.tag=0U,({struct _fat_ptr _tmp35E=({const char*_tmp2E="can't unify evar with bounds_one!";_tag_fat(_tmp2E,sizeof(char),34U);});_tmp2C5.f1=_tmp35E;});_tmp2C5;});void*_tmp2C[1U];_tmp2C[0]=& _tmp2D;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp2C,sizeof(void*),1U));});
goto _LL5;default: _LL12: _LL13:
# 158
({struct Cyc_Warn_String_Warn_Warg_struct _tmp30=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C9;_tmp2C9.tag=0U,({struct _fat_ptr _tmp35F=({const char*_tmp35="hidden type variable ";_tag_fat(_tmp35,sizeof(char),22U);});_tmp2C9.f1=_tmp35F;});_tmp2C9;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp31=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2C8;_tmp2C8.tag=2U,_tmp2C8.f1=(void*)e;_tmp2C8;});struct Cyc_Warn_String_Warn_Warg_struct _tmp32=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C7;_tmp2C7.tag=0U,({struct _fat_ptr _tmp360=({const char*_tmp34=" isn't abstracted in type ";_tag_fat(_tmp34,sizeof(char),27U);});_tmp2C7.f1=_tmp360;});_tmp2C7;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp33=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2C6;_tmp2C6.tag=2U,_tmp2C6.f1=(void*)in_typ;_tmp2C6;});void*_tmp2F[4U];_tmp2F[0]=& _tmp30,_tmp2F[1]=& _tmp31,_tmp2F[2]=& _tmp32,_tmp2F[3]=& _tmp33;({unsigned _tmp361=loc;Cyc_Warn_err2(_tmp361,_tag_fat(_tmp2F,sizeof(void*),4U));});});
goto _LL5;}_LL5:;}}}
# 168
...
if(c1 == c2)return 1;{
struct _tuple0 _tmp36=({struct _tuple0 _tmp2CA;_tmp2CA.f1=c1,_tmp2CA.f2=c2;_tmp2CA;});struct _tuple0 _stmttmp6=_tmp36;struct _tuple0 _tmp37=_stmttmp6;struct Cyc_Absyn_Kind*_tmp3B;struct Cyc_Core_Opt**_tmp3A;struct Cyc_Absyn_Kind*_tmp39;struct Cyc_Core_Opt**_tmp38;struct Cyc_Absyn_Kind*_tmp3E;struct Cyc_Absyn_Kind*_tmp3D;struct Cyc_Core_Opt**_tmp3C;struct Cyc_Core_Opt**_tmp3F;struct Cyc_Core_Opt**_tmp40;struct Cyc_Absyn_Kind*_tmp43;struct Cyc_Core_Opt**_tmp42;struct Cyc_Absyn_Kind*_tmp41;struct Cyc_Absyn_Kind*_tmp45;struct Cyc_Absyn_Kind*_tmp44;if(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp37.f1)->tag == 0U)switch(*((int*)_tmp37.f2)){case 0U: _LL1: _tmp44=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp37.f1)->f1;_tmp45=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp37.f2)->f1;_LL2: {struct Cyc_Absyn_Kind*k1=_tmp44;struct Cyc_Absyn_Kind*k2=_tmp45;
...
({struct Cyc_Core_Opt*_tmp362=({struct Cyc_Core_Opt*_tmp49=_cycalloc(sizeof(*_tmp49));_tmp49->v=c1;_tmp49;});*f=_tmp362;});return 1;}else{
...
# 174
({struct Cyc_Core_Opt*_tmp363=({struct Cyc_Core_Opt*_tmp46=_cycalloc(sizeof(*_tmp46));_tmp46->v=c1;_tmp46;});*f=_tmp363;});return 1;}}else{if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp37.f1)->tag == 1U){_LL5: _tmp3F=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp37.f1)->f1;_LL6: {struct Cyc_Core_Opt**f=_tmp3F;
({struct Cyc_Core_Opt*_tmp364=({struct Cyc_Core_Opt*_tmp47=_cycalloc(sizeof(*_tmp47));_tmp47->v=c2;_tmp47;});*f=_tmp364;});return 1;}}else{if(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp37.f2)->tag == 0U){_LL7: _tmp3C=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp37.f1)->f1;_tmp3D=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp37.f1)->f2;_tmp3E=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp37.f2)->f1;_LL8: {struct Cyc_Core_Opt**f=_tmp3C;struct Cyc_Absyn_Kind*k1=_tmp3D;struct Cyc_Absyn_Kind*k2=_tmp3E;
# 177
if(Cyc_Tcutil_kind_leq(k2,k1)){
({struct Cyc_Core_Opt*_tmp365=({struct Cyc_Core_Opt*_tmp48=_cycalloc(sizeof(*_tmp48));_tmp48->v=c2;_tmp48;});*f=_tmp365;});return 1;}else{
...
# 185
if(Cyc_Tcutil_kind_leq(k1,k2)){
({struct Cyc_Core_Opt*_tmp366=({struct Cyc_Core_Opt*_tmp4A=_cycalloc(sizeof(*_tmp4A));_tmp4A->v=c1;_tmp4A;});*f2=_tmp366;});return 1;}else{
if(Cyc_Tcutil_kind_leq(k2,k1)){
({struct Cyc_Core_Opt*_tmp367=({struct Cyc_Core_Opt*_tmp4B=_cycalloc(sizeof(*_tmp4B));_tmp4B->v=c2;_tmp4B;});*f1=_tmp367;});return 1;}else{
return 0;}}}}}}}_LL0:;}}
# 198
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D0;_tmp2D0.tag=0U,({struct _fat_ptr _tmp368=({const char*_tmp55="type variable ";_tag_fat(_tmp55,sizeof(char),15U);});_tmp2D0.f1=_tmp368;});_tmp2D0;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp4E=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp2CF;_tmp2CF.tag=6U,_tmp2CF.f1=tv;_tmp2CF;});struct Cyc_Warn_String_Warn_Warg_struct _tmp4F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2CE;_tmp2CE.tag=0U,({struct _fat_ptr _tmp369=({const char*_tmp54=" is used with inconsistent kinds ";_tag_fat(_tmp54,sizeof(char),34U);});_tmp2CE.f1=_tmp369;});_tmp2CE;});struct Cyc_Warn_KindBound_Warn_Warg_struct _tmp50=({struct Cyc_Warn_KindBound_Warn_Warg_struct _tmp2CD;_tmp2CD.tag=7U,_tmp2CD.f1=(void*)k1;_tmp2CD;});struct Cyc_Warn_String_Warn_Warg_struct _tmp51=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2CC;_tmp2CC.tag=0U,({
struct _fat_ptr _tmp36A=({const char*_tmp53=" and ";_tag_fat(_tmp53,sizeof(char),6U);});_tmp2CC.f1=_tmp36A;});_tmp2CC;});struct Cyc_Warn_KindBound_Warn_Warg_struct _tmp52=({struct Cyc_Warn_KindBound_Warn_Warg_struct _tmp2CB;_tmp2CB.tag=7U,_tmp2CB.f1=(void*)k2;_tmp2CB;});void*_tmp4C[6U];_tmp4C[0]=& _tmp4D,_tmp4C[1]=& _tmp4E,_tmp4C[2]=& _tmp4F,_tmp4C[3]=& _tmp50,_tmp4C[4]=& _tmp51,_tmp4C[5]=& _tmp52;({unsigned _tmp36B=loc;Cyc_Warn_err2(_tmp36B,_tag_fat(_tmp4C,sizeof(void*),6U));});});
if(tv->identity == - 1)
tv->identity=((struct Cyc_Absyn_Tvar*)tvs2->hd)->identity;else{
if(tv->identity != ((struct Cyc_Absyn_Tvar*)tvs2->hd)->identity)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp57=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D1;_tmp2D1.tag=0U,({struct _fat_ptr _tmp36C=({const char*_tmp58="same type variable has different identity!";_tag_fat(_tmp58,sizeof(char),43U);});_tmp2D1.f1=_tmp36C;});_tmp2D1;});void*_tmp56[1U];_tmp56[0]=& _tmp57;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp56,sizeof(void*),1U));});}
return tvs;}}}
# 215
({int _tmp36D=Cyc_Tcutil_new_tvar_id();tv->identity=_tmp36D;});
...
if(tv->identity == - 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D2;_tmp2D2.tag=0U,({struct _fat_ptr _tmp36E=({const char*_tmp5C="fast_add_free_tvar: bad identity in tv";_tag_fat(_tmp5C,sizeof(char),39U);});_tmp2D2.f1=_tmp36E;});_tmp2D2;});void*_tmp5A[1U];_tmp5A[0]=& _tmp5B;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp5A,sizeof(void*),1U));});
{struct Cyc_List_List*tvs2=tvs;for(0;tvs2 != 0;tvs2=tvs2->tl){
struct Cyc_Absyn_Tvar*_tmp5D=(struct Cyc_Absyn_Tvar*)tvs2->hd;struct Cyc_Absyn_Tvar*tv2=_tmp5D;
if(tv2->identity == - 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D3;_tmp2D3.tag=0U,({struct _fat_ptr _tmp36F=({const char*_tmp60="fast_add_free_tvar: bad identity in tvs2";_tag_fat(_tmp60,sizeof(char),41U);});_tmp2D3.f1=_tmp36F;});_tmp2D3;});void*_tmp5E[1U];_tmp5E[0]=& _tmp5F;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp5E,sizeof(void*),1U));});
...
# 240
if(tv->identity == - 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp63=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D4;_tmp2D4.tag=0U,({struct _fat_ptr _tmp370=({const char*_tmp64="fast_add_free_tvar_bool: bad identity in tv";_tag_fat(_tmp64,sizeof(char),44U);});_tmp2D4.f1=_tmp370;});_tmp2D4;});void*_tmp62[1U];_tmp62[0]=& _tmp63;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp62,sizeof(void*),1U));});
{struct Cyc_List_List*tvs2=tvs;for(0;tvs2 != 0;tvs2=tvs2->tl){
...
if(tv2->identity == - 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp6A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D5;_tmp2D5.tag=0U,({struct _fat_ptr _tmp371=({const char*_tmp6B="fast_add_free_tvar_bool: bad identity in tvs2";_tag_fat(_tmp6B,sizeof(char),46U);});_tmp2D5.f1=_tmp371;});_tmp2D5;});void*_tmp69[1U];_tmp69[0]=& _tmp6A;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp69,sizeof(void*),1U));});
if(tv2->identity == tv->identity){
*b2=*b2 || b;
return tvs;}}}}
# 251
return({struct Cyc_List_List*_tmp6D=_region_malloc(r,sizeof(*_tmp6D));({struct _tuple14*_tmp372=({struct _tuple14*_tmp6C=_region_malloc(r,sizeof(*_tmp6C));_tmp6C->f1=tv,_tmp6C->f2=b;_tmp6C;});_tmp6D->hd=_tmp372;}),_tmp6D->tl=tvs;_tmp6D;});}
# 254
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp79=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D9;_tmp2D9.tag=0U,({struct _fat_ptr _tmp373=({const char*_tmp7E="bad attribute ";_tag_fat(_tmp7E,sizeof(char),15U);});_tmp2D9.f1=_tmp373;});_tmp2D9;});struct Cyc_Warn_Attribute_Warn_Warg_struct _tmp7A=({struct Cyc_Warn_Attribute_Warn_Warg_struct _tmp2D8;_tmp2D8.tag=9U,_tmp2D8.f1=(void*)atts->hd;_tmp2D8;});struct Cyc_Warn_String_Warn_Warg_struct _tmp7B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D7;_tmp2D7.tag=0U,({struct _fat_ptr _tmp374=({const char*_tmp7D=" on member ";_tag_fat(_tmp7D,sizeof(char),12U);});_tmp2D7.f1=_tmp374;});_tmp2D7;});struct Cyc_Warn_String_Warn_Warg_struct _tmp7C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D6;_tmp2D6.tag=0U,_tmp2D6.f1=*fn;_tmp2D6;});void*_tmp78[4U];_tmp78[0]=& _tmp79,_tmp78[1]=& _tmp7A,_tmp78[2]=& _tmp7B,_tmp78[3]=& _tmp7C;({unsigned _tmp375=loc;Cyc_Warn_err2(_tmp375,_tag_fat(_tmp78,sizeof(void*),4U));});});}_LL0:;}}
# 309
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp80=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2DD;_tmp2DD.tag=0U,_tmp2DD.f1=clause_name;_tmp2DD;});struct Cyc_Warn_String_Warn_Warg_struct _tmp81=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2DC;_tmp2DC.tag=0U,({struct _fat_ptr _tmp376=({const char*_tmp85=" clause has type ";_tag_fat(_tmp85,sizeof(char),18U);});_tmp2DC.f1=_tmp376;});_tmp2DC;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp82=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2DB;_tmp2DB.tag=2U,_tmp2DB.f1=(void*)_check_null(clause->topt);_tmp2DB;});struct Cyc_Warn_String_Warn_Warg_struct _tmp83=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2DA;_tmp2DA.tag=0U,({
struct _fat_ptr _tmp377=({const char*_tmp84=" instead of integral type";_tag_fat(_tmp84,sizeof(char),26U);});_tmp2DA.f1=_tmp377;});_tmp2DA;});void*_tmp7F[4U];_tmp7F[0]=& _tmp80,_tmp7F[1]=& _tmp81,_tmp7F[2]=& _tmp82,_tmp7F[3]=& _tmp83;({unsigned _tmp378=loc;Cyc_Warn_err2(_tmp378,_tag_fat(_tmp7F,sizeof(void*),4U));});});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp87=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E1;_tmp2E1.tag=0U,_tmp2E1.f1=clause_name;_tmp2E1;});struct Cyc_Warn_String_Warn_Warg_struct _tmp88=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E0;_tmp2E0.tag=0U,({
struct _fat_ptr _tmp379=({const char*_tmp8C=" clause '";_tag_fat(_tmp8C,sizeof(char),10U);});_tmp2E0.f1=_tmp379;});_tmp2E0;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp89=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp2DF;_tmp2DF.tag=3U,_tmp2DF.f1=clause;_tmp2DF;});struct Cyc_Warn_String_Warn_Warg_struct _tmp8A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2DE;_tmp2DE.tag=0U,({struct _fat_ptr _tmp37A=({const char*_tmp8B="' may be unsatisfiable";_tag_fat(_tmp8B,sizeof(char),23U);});_tmp2DE.f1=_tmp37A;});_tmp2DE;});void*_tmp86[4U];_tmp86[0]=& _tmp87,_tmp86[1]=& _tmp88,_tmp86[2]=& _tmp89,_tmp86[3]=& _tmp8A;({unsigned _tmp37B=clause->loc;Cyc_Warn_err2(_tmp37B,_tag_fat(_tmp86,sizeof(void*),4U));});});}
# 327
return({struct _tuple15 _tmp2E2;_tmp2E2.f1=cvtenv,_tmp2E2.f2=relns;_tmp2E2;});}
# 357 "tctyp.cyc"
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp98=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E6;_tmp2E6.tag=0U,({struct _fat_ptr _tmp37C=({const char*_tmp9D="expecting struct ";_tag_fat(_tmp9D,sizeof(char),18U);});_tmp2E6.f1=_tmp37C;});_tmp2E6;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp99=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2E5;_tmp2E5.tag=1U,_tmp2E5.f1=n;_tmp2E5;});struct Cyc_Warn_String_Warn_Warg_struct _tmp9A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E4;_tmp2E4.tag=0U,({struct _fat_ptr _tmp37D=({const char*_tmp9C="instead of union ";_tag_fat(_tmp9C,sizeof(char),18U);});_tmp2E4.f1=_tmp37D;});_tmp2E4;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp9B=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2E3;_tmp2E3.tag=1U,_tmp2E3.f1=n;_tmp2E3;});void*_tmp97[4U];_tmp97[0]=& _tmp98,_tmp97[1]=& _tmp99,_tmp97[2]=& _tmp9A,_tmp97[3]=& _tmp9B;({unsigned _tmp37E=loc;Cyc_Warn_err2(_tmp37E,_tag_fat(_tmp97,sizeof(void*),4U));});});else{
# 378
({struct Cyc_Warn_String_Warn_Warg_struct _tmp9F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EA;_tmp2EA.tag=0U,({struct _fat_ptr _tmp37F=({const char*_tmpA4="expecting union ";_tag_fat(_tmpA4,sizeof(char),17U);});_tmp2EA.f1=_tmp37F;});_tmp2EA;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpA0=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2E9;_tmp2E9.tag=1U,_tmp2E9.f1=n;_tmp2E9;});struct Cyc_Warn_String_Warn_Warg_struct _tmpA1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E8;_tmp2E8.tag=0U,({struct _fat_ptr _tmp380=({const char*_tmpA3="instead of struct ";_tag_fat(_tmpA3,sizeof(char),19U);});_tmp2E8.f1=_tmp380;});_tmp2E8;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpA2=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2E7;_tmp2E7.tag=1U,_tmp2E7.f1=n;_tmp2E7;});void*_tmp9E[4U];_tmp9E[0]=& _tmp9F,_tmp9E[1]=& _tmpA0,_tmp9E[2]=& _tmpA1,_tmp9E[3]=& _tmpA2;({unsigned _tmp381=loc;Cyc_Warn_err2(_tmp381,_tag_fat(_tmp9E,sizeof(void*),4U));});});}}
# 380
if((unsigned)tgd &&(int)tgd->v){
if(!((unsigned)ad->impl)|| !((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->tagged)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpA6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EC;_tmp2EC.tag=0U,({struct _fat_ptr _tmp382=({const char*_tmpA8="@tagged qualfiers don't agree on union ";_tag_fat(_tmpA8,sizeof(char),40U);});_tmp2EC.f1=_tmp382;});_tmp2EC;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpA7=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2EB;_tmp2EB.tag=1U,_tmp2EB.f1=n;_tmp2EB;});void*_tmpA5[2U];_tmpA5[0]=& _tmpA6,_tmpA5[1]=& _tmpA7;({unsigned _tmp383=loc;Cyc_Warn_err2(_tmp383,_tag_fat(_tmpA5,sizeof(void*),2U));});});}
# 385
({union Cyc_Absyn_AggrInfo _tmp384=Cyc_Absyn_KnownAggr(adp);*info=_tmp384;});}
# 372
...
adp=Cyc_Tcenv_lookup_aggrdecl(te,loc,n);
({union Cyc_Absyn_AggrInfo _tmp385=Cyc_Absyn_KnownAggr(adp);*info=_tmp385;});
# 394
if(*targs != 0){
({struct Cyc_Warn_String_Warn_Warg_struct _tmpAD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EF;_tmp2EF.tag=0U,({struct _fat_ptr _tmp386=({const char*_tmpB1="declare parameterized type ";_tag_fat(_tmpB1,sizeof(char),28U);});_tmp2EF.f1=_tmp386;});_tmp2EF;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpAE=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2EE;_tmp2EE.tag=1U,_tmp2EE.f1=n;_tmp2EE;});struct Cyc_Warn_String_Warn_Warg_struct _tmpAF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2ED;_tmp2ED.tag=0U,({struct _fat_ptr _tmp387=({const char*_tmpB0=" before using";_tag_fat(_tmpB0,sizeof(char),14U);});_tmp2ED.f1=_tmp387;});_tmp2ED;});void*_tmpAC[3U];_tmpAC[0]=& _tmpAD,_tmpAC[1]=& _tmpAE,_tmpAC[2]=& _tmpAF;({unsigned _tmp388=loc;Cyc_Warn_err2(_tmp388,_tag_fat(_tmpAC,sizeof(void*),3U));});});
return cvtenv;}
# 398
...
# 410
{struct _tuple0 _tmpB5=({struct _tuple0 _tmp2F0;({void*_tmp389=Cyc_Absyn_compress_kb(tv->kind);_tmp2F0.f1=_tmp389;}),_tmp2F0.f2=t;_tmp2F0;});struct _tuple0 _stmttmpD=_tmpB5;struct _tuple0 _tmpB6=_stmttmpD;struct Cyc_Absyn_Tvar*_tmpB7;if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmpB6.f1)->tag == 1U){if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpB6.f2)->tag == 2U){_LLB: _tmpB7=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpB6.f2)->f1;_LLC: {struct Cyc_Absyn_Tvar*tv2=_tmpB7;
# 412
({struct Cyc_List_List*_tmp38A=Cyc_Tctyp_add_free_tvar(loc,cvtenv.kind_env,tv2);cvtenv.kind_env=_tmp38A;});
({struct Cyc_List_List*_tmp38B=Cyc_Tctyp_fast_add_free_tvar_bool(cvtenv.r,cvtenv.free_vars,tv2,1);cvtenv.free_vars=_tmp38B;});
...
# 421
if(ts != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpB9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F2;_tmp2F2.tag=0U,({struct _fat_ptr _tmp38C=({const char*_tmpBB="too many parameters for ";_tag_fat(_tmpBB,sizeof(char),25U);});_tmp2F2.f1=_tmp38C;});_tmp2F2;});struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmpBA=({struct Cyc_Warn_Aggrdecl_Warn_Warg_struct _tmp2F1;_tmp2F1.tag=5U,_tmp2F1.f1=ad;_tmp2F1;});void*_tmpB8[2U];_tmpB8[0]=& _tmpB9,_tmpB8[1]=& _tmpBA;({unsigned _tmp38D=loc;Cyc_Warn_err2(_tmp38D,_tag_fat(_tmpB8,sizeof(void*),2U));});});
if(tvs != 0){
# 425
...
# 432
({struct Cyc_List_List*_tmp38F=({struct Cyc_List_List*_tmp38E=*targs;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp38E,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(hidden_ts));});*targs=_tmp38F;});}
# 434
...
# 463
if(targs != 0){
({struct Cyc_Warn_String_Warn_Warg_struct _tmpCA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F5;_tmp2F5.tag=0U,({struct _fat_ptr _tmp390=({const char*_tmpCE="declare parameterized datatype ";_tag_fat(_tmpCE,sizeof(char),32U);});_tmp2F5.f1=_tmp390;});_tmp2F5;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpCB=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F4;_tmp2F4.tag=1U,_tmp2F4.f1=n;_tmp2F4;});struct Cyc_Warn_String_Warn_Warg_struct _tmpCC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F3;_tmp2F3.tag=0U,({struct _fat_ptr _tmp391=({const char*_tmpCD=" before using";_tag_fat(_tmpCD,sizeof(char),14U);});_tmp2F3.f1=_tmp391;});_tmp2F3;});void*_tmpC9[3U];_tmpC9[0]=& _tmpCA,_tmpC9[1]=& _tmpCB,_tmpC9[2]=& _tmpCC;({unsigned _tmp392=loc;Cyc_Warn_err2(_tmp392,_tag_fat(_tmpC9,sizeof(void*),3U));});});
return cvtenv;}
# 467
goto _LL5;}}else{_LL8: _tmpC7=_tmpC6;_LL9: {void*exn=_tmpC7;(int)_rethrow(exn);}}_LL5:;}}}
# 471
if(is_x && !(*tudp)->is_extensible)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpD1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F8;_tmp2F8.tag=0U,({struct _fat_ptr _tmp393=({const char*_tmpD5="datatype ";_tag_fat(_tmpD5,sizeof(char),10U);});_tmp2F8.f1=_tmp393;});_tmp2F8;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpD2=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F7;_tmp2F7.tag=1U,_tmp2F7.f1=n;_tmp2F7;});struct Cyc_Warn_String_Warn_Warg_struct _tmpD3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F6;_tmp2F6.tag=0U,({struct _fat_ptr _tmp394=({const char*_tmpD4=" was not declared @extensible";_tag_fat(_tmpD4,sizeof(char),30U);});_tmp2F6.f1=_tmp394;});_tmp2F6;});void*_tmpD0[3U];_tmpD0[0]=& _tmpD1,_tmpD0[1]=& _tmpD2,_tmpD0[2]=& _tmpD3;({unsigned _tmp395=loc;Cyc_Warn_err2(_tmp395,_tag_fat(_tmpD0,sizeof(void*),3U));});});
({union Cyc_Absyn_DatatypeInfo _tmp396=Cyc_Absyn_KnownDatatype(tudp);*info=_tmp396;});
...
# 483
{struct _tuple0 _tmpD6=({struct _tuple0 _tmp2F9;({void*_tmp397=Cyc_Absyn_compress_kb(tv->kind);_tmp2F9.f1=_tmp397;}),_tmp2F9.f2=t;_tmp2F9;});struct _tuple0 _stmttmpF=_tmpD6;struct _tuple0 _tmpD7=_stmttmpF;struct Cyc_Absyn_Tvar*_tmpD8;if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmpD7.f1)->tag == 1U){if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpD7.f2)->tag == 2U){_LLB: _tmpD8=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpD7.f2)->f1;_LLC: {struct Cyc_Absyn_Tvar*tv2=_tmpD8;
# 485
({struct Cyc_List_List*_tmp398=Cyc_Tctyp_add_free_tvar(loc,cvtenv.kind_env,tv2);cvtenv.kind_env=_tmp398;});
({struct Cyc_List_List*_tmp399=Cyc_Tctyp_fast_add_free_tvar_bool(cvtenv.r,cvtenv.free_vars,tv2,1);cvtenv.free_vars=_tmp399;});
continue;}}else{goto _LLD;}}else{_LLD: _LLE:
 goto _LLA;}_LLA:;}{
# 490
...
# 494
if(targs != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpDA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FB;_tmp2FB.tag=0U,({struct _fat_ptr _tmp39A=({const char*_tmpDC="too many type arguments for datatype ";_tag_fat(_tmpDC,sizeof(char),38U);});_tmp2FB.f1=_tmp39A;});_tmp2FB;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpDB=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2FA;_tmp2FA.tag=1U,_tmp2FA.f1=tud->name;_tmp2FA;});void*_tmpD9[2U];_tmpD9[0]=& _tmpDA,_tmpD9[1]=& _tmpDB;({unsigned _tmp39B=loc;Cyc_Warn_err2(_tmp39B,_tag_fat(_tmpD9,sizeof(void*),2U));});});
if(tvs != 0){
# 498
struct Cyc_List_List*hidden_ts=0;
for(0;tvs != 0;tvs=tvs->tl){
...
# 505
({struct Cyc_List_List*_tmp39D=({struct Cyc_List_List*_tmp39C=*targsp;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp39C,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(hidden_ts));});*targsp=_tmp39D;});}
# 507
goto _LL0;}}_LL0:;}
# 509
return cvtenv;}
...
if(fs == 0)({struct Cyc_Warn_String_Warn_Warg_struct _tmpE7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FC;_tmp2FC.tag=0U,({struct _fat_ptr _tmp39E=({const char*_tmpE8="Tcutil found a bad datatypefield";_tag_fat(_tmpE8,sizeof(char),33U);});_tmp2FC.f1=_tmp39E;});_tmp2FC;});void*_tmpE6[1U];_tmpE6[0]=& _tmpE7;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpE6,sizeof(void*),1U));});
if(Cyc_Absyn_qvar_cmp(((struct Cyc_Absyn_Datatypefield*)fs->hd)->name,fname)== 0){
tuf=(struct Cyc_Absyn_Datatypefield*)fs->hd;
break;}}}
# 534
({union Cyc_Absyn_DatatypeFieldInfo _tmp39F=Cyc_Absyn_KnownDatatypefield(tud,tuf);*info=_tmp39F;});
...
struct Cyc_Absyn_Tvar*tv=(struct Cyc_Absyn_Tvar*)tvs->hd;
# 544
{struct _tuple0 _tmpE9=({struct _tuple0 _tmp2FD;({void*_tmp3A0=Cyc_Absyn_compress_kb(tv->kind);_tmp2FD.f1=_tmp3A0;}),_tmp2FD.f2=t;_tmp2FD;});struct _tuple0 _stmttmp11=_tmpE9;struct _tuple0 _tmpEA=_stmttmp11;struct Cyc_Absyn_Tvar*_tmpEB;if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmpEA.f1)->tag == 1U){if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpEA.f2)->tag == 2U){_LL6: _tmpEB=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpEA.f2)->f1;_LL7: {struct Cyc_Absyn_Tvar*tv2=_tmpEB;
# 546
({struct Cyc_List_List*_tmp3A1=Cyc_Tctyp_add_free_tvar(loc,cvtenv.kind_env,tv2);cvtenv.kind_env=_tmp3A1;});
({struct Cyc_List_List*_tmp3A2=Cyc_Tctyp_fast_add_free_tvar_bool(cvtenv.r,cvtenv.free_vars,tv2,1);cvtenv.free_vars=_tmp3A2;});
...
# 555
if(targs != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpED=({struct Cyc_Warn_String_Warn_Warg_struct _tmp301;_tmp301.tag=0U,({struct _fat_ptr _tmp3A3=({const char*_tmpF2="too many type arguments for datatype ";_tag_fat(_tmpF2,sizeof(char),38U);});_tmp301.f1=_tmp3A3;});_tmp301;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpEE=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp300;_tmp300.tag=1U,_tmp300.f1=tud->name;_tmp300;});struct Cyc_Warn_String_Warn_Warg_struct _tmpEF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FF;_tmp2FF.tag=0U,({struct _fat_ptr _tmp3A4=({const char*_tmpF1=".";_tag_fat(_tmpF1,sizeof(char),2U);});_tmp2FF.f1=_tmp3A4;});_tmp2FF;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpF0=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2FE;_tmp2FE.tag=1U,_tmp2FE.f1=tuf->name;_tmp2FE;});void*_tmpEC[4U];_tmpEC[0]=& _tmpED,_tmpEC[1]=& _tmpEE,_tmpEC[2]=& _tmpEF,_tmpEC[3]=& _tmpF0;({unsigned _tmp3A5=loc;Cyc_Warn_err2(_tmp3A5,_tag_fat(_tmpEC,sizeof(void*),4U));});});
if(tvs != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpF4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp305;_tmp305.tag=0U,({struct _fat_ptr _tmp3A6=({const char*_tmpF9="too few type arguments for datatype ";_tag_fat(_tmpF9,sizeof(char),37U);});_tmp305.f1=_tmp3A6;});_tmp305;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpF5=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp304;_tmp304.tag=1U,_tmp304.f1=tud->name;_tmp304;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp303;_tmp303.tag=0U,({struct _fat_ptr _tmp3A7=({const char*_tmpF8=".";_tag_fat(_tmpF8,sizeof(char),2U);});_tmp303.f1=_tmp3A7;});_tmp303;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpF7=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp302;_tmp302.tag=1U,_tmp302.f1=tuf->name;_tmp302;});void*_tmpF3[4U];_tmpF3[0]=& _tmpF4,_tmpF3[1]=& _tmpF5,_tmpF3[2]=& _tmpF6,_tmpF3[3]=& _tmpF7;({unsigned _tmp3A8=loc;Cyc_Warn_err2(_tmp3A8,_tag_fat(_tmpF3,sizeof(void*),4U));});});
goto _LL0;}}_LL0:;}
# 561
return cvtenv;}
# 564
...
# 576
 if(ts != 0)
({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp103=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp307;_tmp307.tag=2U,({typeof((void*)((void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp106=_cycalloc(sizeof(*_tmp106));_tmp106->tag=0U,_tmp106->f1=c,_tmp106->f2=ts;_tmp106;})))_tmp3A9=(void*)((void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp106=_cycalloc(sizeof(*_tmp106));_tmp106->tag=0U,_tmp106->f1=c,_tmp106->f2=ts;_tmp106;}));_tmp307.f1=_tmp3A9;});_tmp307;});struct Cyc_Warn_String_Warn_Warg_struct _tmp104=({struct Cyc_Warn_String_Warn_Warg_struct _tmp306;_tmp306.tag=0U,({struct _fat_ptr _tmp3AA=({const char*_tmp105=" applied to argument(s)";_tag_fat(_tmp105,sizeof(char),24U);});_tmp306.f1=_tmp3AA;});_tmp306;});void*_tmp102[2U];_tmp102[0]=& _tmp103,_tmp102[1]=& _tmp104;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp102,sizeof(void*),2U));});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp108=({struct Cyc_Warn_String_Warn_Warg_struct _tmp308;_tmp308.tag=0U,({struct _fat_ptr _tmp3AB=({const char*_tmp109="tag_t applied to wrong number of arguments";_tag_fat(_tmp109,sizeof(char),43U);});_tmp308.f1=_tmp3AB;});_tmp308;});void*_tmp107[1U];_tmp107[0]=& _tmp108;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp107,sizeof(void*),1U));});
...
# 589
if(ts != 0)({struct Cyc_Warn_String_Warn_Warg_struct _tmp10B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp309;_tmp309.tag=0U,({struct _fat_ptr _tmp3AC=({const char*_tmp10C="enum applied to argument(s)";_tag_fat(_tmp10C,sizeof(char),28U);});_tmp309.f1=_tmp3AC;});_tmp309;});void*_tmp10A[1U];_tmp10A[0]=& _tmp10B;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp10A,sizeof(void*),1U));});
...
# 604
if(ts != 0)({struct Cyc_Warn_String_Warn_Warg_struct _tmp115=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30A;_tmp30A.tag=0U,({struct _fat_ptr _tmp3AD=({const char*_tmp116="enum applied to argument(s)";_tag_fat(_tmp116,sizeof(char),28U);});_tmp30A.f1=_tmp3AD;});_tmp30A;});void*_tmp114[1U];_tmp114[0]=& _tmp115;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp114,sizeof(void*),1U));});{
# 606
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp119=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30C;_tmp30C.tag=0U,({struct _fat_ptr _tmp3AE=({const char*_tmp11B="duplicate enum field name ";_tag_fat(_tmp11B,sizeof(char),27U);});_tmp30C.f1=_tmp3AE;});_tmp30C;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp11A=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp30B;_tmp30B.tag=1U,_tmp30B.f1=f->name;_tmp30B;});void*_tmp118[2U];_tmp118[0]=& _tmp119,_tmp118[1]=& _tmp11A;({unsigned _tmp3AF=f->loc;Cyc_Warn_err2(_tmp3AF,_tag_fat(_tmp118,sizeof(void*),2U));});});else{
# 613
prev_fields=({struct Cyc_List_List*_tmp11C=_cycalloc(sizeof(*_tmp11C));_tmp11C->hd=(*f->name).f2,_tmp11C->tl=prev_fields;_tmp11C;});}
if(f->tag == 0)
({struct Cyc_Absyn_Exp*_tmp3B0=Cyc_Absyn_uint_exp(tag_count,f->loc);f->tag=_tmp3B0;});else{
if(!Cyc_Tcutil_is_const_exp((struct Cyc_Absyn_Exp*)_check_null(f->tag)))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp11E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30F;_tmp30F.tag=0U,({struct _fat_ptr _tmp3B1=({const char*_tmp122="enum field ";_tag_fat(_tmp122,sizeof(char),12U);});_tmp30F.f1=_tmp3B1;});_tmp30F;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp11F=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp30E;_tmp30E.tag=1U,_tmp30E.f1=f->name;_tmp30E;});struct Cyc_Warn_String_Warn_Warg_struct _tmp120=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30D;_tmp30D.tag=0U,({struct _fat_ptr _tmp3B2=({const char*_tmp121=": expression is not constant";_tag_fat(_tmp121,sizeof(char),29U);});_tmp30D.f1=_tmp3B2;});_tmp30D;});void*_tmp11D[3U];_tmp11D[0]=& _tmp11E,_tmp11D[1]=& _tmp11F,_tmp11D[2]=& _tmp120;({unsigned _tmp3B3=loc;Cyc_Warn_err2(_tmp3B3,_tag_fat(_tmp11D,sizeof(void*),3U));});});}{
...
# 623
 if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ts)!= 1)({struct Cyc_Warn_String_Warn_Warg_struct _tmp124=({struct Cyc_Warn_String_Warn_Warg_struct _tmp310;_tmp310.tag=0U,({struct _fat_ptr _tmp3B4=({const char*_tmp125="regions has wrong number of arguments";_tag_fat(_tmp125,sizeof(char),38U);});_tmp310.f1=_tmp3B4;});_tmp310;});void*_tmp123[1U];_tmp123[0]=& _tmp124;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp123,sizeof(void*),1U));});
...
# 626
 if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ts)!= 1)({struct Cyc_Warn_String_Warn_Warg_struct _tmp127=({struct Cyc_Warn_String_Warn_Warg_struct _tmp311;_tmp311.tag=0U,({struct _fat_ptr _tmp3B5=({const char*_tmp128="region_t has wrong number of arguments";_tag_fat(_tmp128,sizeof(char),39U);});_tmp311.f1=_tmp3B5;});_tmp311;});void*_tmp126[1U];_tmp126[0]=& _tmp127;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp126,sizeof(void*),1U));});
...
# 630
 if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ts)!= 1)({struct Cyc_Warn_String_Warn_Warg_struct _tmp12A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp312;_tmp312.tag=0U,({struct _fat_ptr _tmp3B6=({const char*_tmp12B="@thin has wrong number of arguments";_tag_fat(_tmp12B,sizeof(char),36U);});_tmp312.f1=_tmp3B6;});_tmp312;});void*_tmp129[1U];_tmp129[0]=& _tmp12A;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp129,sizeof(void*),1U));});
cvtenv=Cyc_Tctyp_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_ik,(void*)((struct Cyc_List_List*)_check_null(ts))->hd,0,1);
goto _LL0;case 8U: _LL23: _LL24:
# 634
 if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ts)!= 1)({struct Cyc_Warn_String_Warn_Warg_struct _tmp12D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp313;_tmp313.tag=0U,({struct _fat_ptr _tmp3B7=({const char*_tmp12E="access has wrong number of arguments";_tag_fat(_tmp12E,sizeof(char),37U);});_tmp313.f1=_tmp3B7;});_tmp313;});void*_tmp12C[1U];_tmp12C[0]=& _tmp12D;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp12C,sizeof(void*),1U));});
...
({struct Cyc_Core_Opt*_tmp3B8=Cyc_Tcutil_kind_to_opt(expected_kind);*k=_tmp3B8;});
...
({void*_tmp3B9=Cyc_Absyn_var_type(v);*ref=_tmp3B9;});
_tmp154=v;goto _LL6;}else{
# 681
({struct Cyc_List_List*_tmp3BA=Cyc_Tctyp_add_free_evar(cvtenv.r,cvtenv.free_evars,t,put_in_effect);cvtenv.free_evars=_tmp3BA;});}}
# 683
...
({struct Cyc_Core_Opt*_tmp3BC=({struct Cyc_Core_Opt*_tmp15F=_cycalloc(sizeof(*_tmp15F));({void*_tmp3BB=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp15E=_cycalloc(sizeof(*_tmp15E));_tmp15E->tag=2U,_tmp15E->f1=0,_tmp15E->f2=expected_kind;_tmp15E;});_tmp15F->v=_tmp3BB;});_tmp15F;});*f=_tmp3BC;});goto _LL19;}}else{_LL1C: _LL1D:
 goto _LL19;}_LL19:;}
# 691
({struct Cyc_List_List*_tmp3BD=Cyc_Tctyp_add_free_tvar(loc,cvtenv.kind_env,v);cvtenv.kind_env=_tmp3BD;});
# 694
({struct Cyc_List_List*_tmp3BE=Cyc_Tctyp_fast_add_free_tvar_bool(cvtenv.r,cvtenv.free_vars,v,put_in_effect);cvtenv.free_vars=_tmp3BE;});
# 696
...
({struct Cyc_Core_Opt*_tmp3C0=({struct Cyc_Core_Opt*_tmp165=_cycalloc(sizeof(*_tmp165));({void*_tmp3BF=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp164=_cycalloc(sizeof(*_tmp164));_tmp164->tag=2U,_tmp164->f1=0,_tmp164->f2=expected_kind;_tmp164;});_tmp165->v=_tmp3BF;});_tmp165;});*f=_tmp3C0;});
...
# 722
({void**_tmp3C1=({void**_tmp16A=_cycalloc(sizeof(*_tmp16A));*_tmp16A=new_typ;_tmp16A;});*topt=_tmp3C1;});
...
({int _tmp3C2=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t1);tqp->real_const=_tmp3C2;});{
...
({void*_tmp3C3=zt;Cyc_Unify_unify(_tmp3C3,Cyc_Tcutil_is_char_type(t1)?Cyc_Absyn_true_type: Cyc_Absyn_false_type);});
is_zero_terminated=Cyc_Absyn_type2bool(0,zt);
if(is_zero_terminated){
# 748
if(!Cyc_Tcutil_admits_zero(t1))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp16E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp316;_tmp316.tag=0U,({struct _fat_ptr _tmp3C4=({const char*_tmp172="cannot have a pointer to zero-terminated ";_tag_fat(_tmp172,sizeof(char),42U);});_tmp316.f1=_tmp3C4;});_tmp316;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp16F=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp315;_tmp315.tag=2U,_tmp315.f1=(void*)t1;_tmp315;});struct Cyc_Warn_String_Warn_Warg_struct _tmp170=({struct Cyc_Warn_String_Warn_Warg_struct _tmp314;_tmp314.tag=0U,({struct _fat_ptr _tmp3C5=({const char*_tmp171=" elements";_tag_fat(_tmp171,sizeof(char),10U);});_tmp314.f1=_tmp3C5;});_tmp314;});void*_tmp16D[3U];_tmp16D[0]=& _tmp16E,_tmp16D[1]=& _tmp16F,_tmp16D[2]=& _tmp170;({unsigned _tmp3C6=loc;Cyc_Warn_err2(_tmp3C6,_tag_fat(_tmp16D,sizeof(void*),3U));});});}
# 752
cvtenv=Cyc_Tctyp_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_ptrbk,b,0,allow_abs_aggr);{
struct Cyc_Absyn_Exp*_tmp173=({void*_tmp3C7=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp3C7,b);});struct Cyc_Absyn_Exp*e=_tmp173;
if(e != 0){
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp179=({struct Cyc_Warn_String_Warn_Warg_struct _tmp317;_tmp317.tag=0U,({struct _fat_ptr _tmp3C8=({const char*_tmp17A="zero-terminated pointer cannot point to empty sequence";_tag_fat(_tmp17A,sizeof(char),55U);});_tmp317.f1=_tmp3C8;});_tmp317;});void*_tmp178[1U];_tmp178[0]=& _tmp179;({unsigned _tmp3C9=loc;Cyc_Warn_err2(_tmp3C9,_tag_fat(_tmp178,sizeof(void*),1U));});});}}
# 759
...
# 764
({struct Cyc_Tcenv_Tenv*_tmp3CA=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmp3CA,0,e);});
if(!Cyc_Tcutil_coerce_uint_type(e))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp17C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp318;_tmp318.tag=0U,({struct _fat_ptr _tmp3CB=({const char*_tmp17D="valueof_t requires an int expression";_tag_fat(_tmp17D,sizeof(char),37U);});_tmp318.f1=_tmp3CB;});_tmp318;});void*_tmp17B[1U];_tmp17B[0]=& _tmp17C;({unsigned _tmp3CC=loc;Cyc_Warn_err2(_tmp3CC,_tag_fat(_tmp17B,sizeof(void*),1U));});});
...
# 773
({struct Cyc_Tcenv_Tenv*_tmp3CD=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmp3CD,0,e);});
...
({int _tmp3CE=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t1);tqp->real_const=_tmp3CE;});{
# 782
int is_zero_terminated=Cyc_Tcutil_force_type2bool(0,zt);
if(is_zero_terminated){
# 785
if(!Cyc_Tcutil_admits_zero(t1))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp180=({struct Cyc_Warn_String_Warn_Warg_struct _tmp31B;_tmp31B.tag=0U,({struct _fat_ptr _tmp3CF=({const char*_tmp184="cannot have a zero-terminated array of ";_tag_fat(_tmp184,sizeof(char),40U);});_tmp31B.f1=_tmp3CF;});_tmp31B;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp181=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp31A;_tmp31A.tag=2U,_tmp31A.f1=(void*)t1;_tmp31A;});struct Cyc_Warn_String_Warn_Warg_struct _tmp182=({struct Cyc_Warn_String_Warn_Warg_struct _tmp319;_tmp319.tag=0U,({struct _fat_ptr _tmp3D0=({const char*_tmp183=" elements";_tag_fat(_tmp183,sizeof(char),10U);});_tmp319.f1=_tmp3D0;});_tmp319;});void*_tmp17F[3U];_tmp17F[0]=& _tmp180,_tmp17F[1]=& _tmp181,_tmp17F[2]=& _tmp182;({unsigned _tmp3D1=loc;Cyc_Warn_err2(_tmp3D1,_tag_fat(_tmp17F,sizeof(void*),3U));});});}
# 790
if(e == 0){
# 792
if(is_zero_terminated)
# 794
({struct Cyc_Absyn_Exp*_tmp3D2=e=Cyc_Absyn_uint_exp(1U,0U);*eptr=_tmp3D2;});else{
# 797
({struct Cyc_Warn_String_Warn_Warg_struct _tmp186=({struct Cyc_Warn_String_Warn_Warg_struct _tmp31C;_tmp31C.tag=0U,({struct _fat_ptr _tmp3D3=({const char*_tmp187="array bound defaults to 1 here";_tag_fat(_tmp187,sizeof(char),31U);});_tmp31C.f1=_tmp3D3;});_tmp31C;});void*_tmp185[1U];_tmp185[0]=& _tmp186;({unsigned _tmp3D4=loc;Cyc_Warn_warn2(_tmp3D4,_tag_fat(_tmp185,sizeof(void*),1U));});});
({struct Cyc_Absyn_Exp*_tmp3D5=e=Cyc_Absyn_uint_exp(1U,0U);*eptr=_tmp3D5;});}}
# 801
({struct Cyc_Tcenv_Tenv*_tmp3D6=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmp3D6,0,e);});
if(!Cyc_Tcutil_coerce_uint_type(e))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp189=({struct Cyc_Warn_String_Warn_Warg_struct _tmp31D;_tmp31D.tag=0U,({struct _fat_ptr _tmp3D7=({const char*_tmp18A="array bounds expression is not an unsigned int";_tag_fat(_tmp18A,sizeof(char),47U);});_tmp31D.f1=_tmp3D7;});_tmp31D;});void*_tmp188[1U];_tmp188[0]=& _tmp189;({unsigned _tmp3D8=loc;Cyc_Warn_err2(_tmp3D8,_tag_fat(_tmp188,sizeof(void*),1U));});});
cvtenv=Cyc_Tctyp_i_check_valid_type_level_exp(e,te,cvtenv);{
...
# 807
if((is_zero_terminated && known)&& sz < (unsigned)1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp190=({struct Cyc_Warn_String_Warn_Warg_struct _tmp31E;_tmp31E.tag=0U,({struct _fat_ptr _tmp3D9=({const char*_tmp191="zero terminated array cannot have zero elements";_tag_fat(_tmp191,sizeof(char),48U);});_tmp31E.f1=_tmp3D9;});_tmp31E;});void*_tmp18F[1U];_tmp18F[0]=& _tmp190;({unsigned _tmp3DA=loc;Cyc_Warn_warn2(_tmp3DA,_tag_fat(_tmp18F,sizeof(void*),1U));});});
# 810
if((known && sz < (unsigned)1)&& Cyc_Cyclone_tovc_r){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp193=({struct Cyc_Warn_String_Warn_Warg_struct _tmp31F;_tmp31F.tag=0U,({struct _fat_ptr _tmp3DB=({const char*_tmp194="arrays with 0 elements are not supported except with gcc -- changing to 1.";_tag_fat(_tmp194,sizeof(char),75U);});_tmp31F.f1=_tmp3DB;});_tmp31F;});void*_tmp192[1U];_tmp192[0]=& _tmp193;({unsigned _tmp3DC=loc;Cyc_Warn_warn2(_tmp3DC,_tag_fat(_tmp192,sizeof(void*),1U));});});
({struct Cyc_Absyn_Exp*_tmp3DD=Cyc_Absyn_uint_exp(1U,0U);*eptr=_tmp3DD;});}
# 814
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp196=({struct Cyc_Warn_String_Warn_Warg_struct _tmp321;_tmp321.tag=0U,({struct _fat_ptr _tmp3DE=({const char*_tmp198="bad function type attribute ";_tag_fat(_tmp198,sizeof(char),29U);});_tmp321.f1=_tmp3DE;});_tmp321;});struct Cyc_Warn_Attribute_Warn_Warg_struct _tmp197=({struct Cyc_Warn_Attribute_Warn_Warg_struct _tmp320;_tmp320.tag=9U,_tmp320.f1=(void*)atts->hd;_tmp320;});void*_tmp195[2U];_tmp195[0]=& _tmp196,_tmp195[1]=& _tmp197;({unsigned _tmp3DF=loc;Cyc_Warn_err2(_tmp3DF,_tag_fat(_tmp195,sizeof(void*),2U));});});{
...
# 846
({struct Cyc_Warn_String_Warn_Warg_struct _tmp19F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp322;_tmp322.tag=0U,({struct _fat_ptr _tmp3E0=({const char*_tmp1A0="function can't have multiple format attributes";_tag_fat(_tmp1A0,sizeof(char),47U);});_tmp322.f1=_tmp3E0;});_tmp322;});void*_tmp19E[1U];_tmp19E[0]=& _tmp19F;({unsigned _tmp3E1=loc;Cyc_Warn_err2(_tmp3E1,_tag_fat(_tmp19E,sizeof(void*),1U));});});}
goto _LL39;}default: _LL42: _LL43:
 goto _LL39;}_LL39:;}}
# 851
if(num_convs > 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1A2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp323;_tmp323.tag=0U,({struct _fat_ptr _tmp3E2=({const char*_tmp1A3="function can't have multiple calling conventions";_tag_fat(_tmp1A3,sizeof(char),49U);});_tmp323.f1=_tmp3E2;});_tmp323;});void*_tmp1A1[1U];_tmp1A1[0]=& _tmp1A2;({unsigned _tmp3E3=loc;Cyc_Warn_err2(_tmp3E3,_tag_fat(_tmp1A1,sizeof(void*),1U));});});
# 856
Cyc_Tcutil_check_unique_tvars(loc,*btvs);
{struct Cyc_List_List*b=*btvs;for(0;b != 0;b=b->tl){
({int _tmp3E4=Cyc_Tcutil_new_tvar_id();((struct Cyc_Absyn_Tvar*)b->hd)->identity=_tmp3E4;});
({struct Cyc_List_List*_tmp3E5=Cyc_Tctyp_add_bound_tvar(cvtenv.kind_env,(struct Cyc_Absyn_Tvar*)b->hd);cvtenv.kind_env=_tmp3E5;});{
...
# 862
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1A7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp325;_tmp325.tag=0U,({struct _fat_ptr _tmp3E6=({const char*_tmp1A9="function abstracts Mem type variable ";_tag_fat(_tmp1A9,sizeof(char),38U);});_tmp325.f1=_tmp3E6;});_tmp325;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1A8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp324;_tmp324.tag=0U,_tmp324.f1=*((struct Cyc_Absyn_Tvar*)b->hd)->name;_tmp324;});void*_tmp1A6[2U];_tmp1A6[0]=& _tmp1A7,_tmp1A6[1]=& _tmp1A8;({unsigned _tmp3E7=loc;Cyc_Warn_err2(_tmp3E7,_tag_fat(_tmp1A6,sizeof(void*),2U));});});goto _LL44;}else{goto _LL47;}}else{_LL47: _LL48:
 goto _LL44;}_LL44:;}}}{
# 869
struct Cyc_Tctyp_CVTEnv _tmp1AA=({struct Cyc_Tctyp_CVTEnv _tmp336;_tmp336.r=Cyc_Core_heap_region,_tmp336.kind_env=cvtenv.kind_env,_tmp336.fn_result=1,_tmp336.generalize_evars=cvtenv.generalize_evars,_tmp336.free_vars=0,_tmp336.free_evars=0;_tmp336;});struct Cyc_Tctyp_CVTEnv new_cvtenv=_tmp1AA;
# 871
new_cvtenv=Cyc_Tctyp_i_check_valid_type(loc,te,new_cvtenv,& Cyc_Tcutil_tmk,tr,1,1);
({int _tmp3E8=Cyc_Tcutil_extract_const_from_typedef(loc,rtq->print_const,tr);rtq->real_const=_tmp3E8;});
...
({void*_tmp3E9=Cyc_Tcutil_promote_array(t,ptr_rgn,0);(*trip).f3=_tmp3E9;});}}}}
# 894
if(cyc_vararg != 0){
if(c_vararg)({struct Cyc_Warn_String_Warn_Warg_struct _tmp1B0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp326;_tmp326.tag=0U,({struct _fat_ptr _tmp3EA=({const char*_tmp1B1="both c_vararg and cyc_vararg";_tag_fat(_tmp1B1,sizeof(char),29U);});_tmp326.f1=_tmp3EA;});_tmp326;});void*_tmp1AF[1U];_tmp1AF[0]=& _tmp1B0;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1AF,sizeof(void*),1U));});{
...
({int _tmp3EB=Cyc_Tcutil_extract_const_from_typedef(loc,(cyc_vararg->tq).print_const,vt);(cyc_vararg->tq).real_const=_tmp3EB;});
# 900
if(vi){
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1BE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp327;_tmp327.tag=0U,({struct _fat_ptr _tmp3EC=({const char*_tmp1BF="can't inject into a zeroterm pointer";_tag_fat(_tmp1BF,sizeof(char),37U);});_tmp327.f1=_tmp3EC;});_tmp327;});void*_tmp1BD[1U];_tmp1BD[0]=& _tmp1BE;({unsigned _tmp3ED=loc;Cyc_Warn_err2(_tmp3ED,_tag_fat(_tmp1BD,sizeof(void*),1U));});});
if(!({void*_tmp3EE=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp3EE,bs);}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp328;_tmp328.tag=0U,({struct _fat_ptr _tmp3EF=({const char*_tmp1C2="can't inject into a fat pointer to datatype";_tag_fat(_tmp1C2,sizeof(char),44U);});_tmp328.f1=_tmp3EF;});_tmp328;});void*_tmp1C0[1U];_tmp1C0[0]=& _tmp1C1;({unsigned _tmp3F0=loc;Cyc_Warn_err2(_tmp3F0,_tag_fat(_tmp1C0,sizeof(void*),1U));});});
goto _LL51;}else{goto _LL54;}}else{_LL54: _LL55:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp329;_tmp329.tag=0U,({struct _fat_ptr _tmp3F1=({const char*_tmp1C5="can't inject a non-datatype type";_tag_fat(_tmp1C5,sizeof(char),33U);});_tmp329.f1=_tmp3F1;});_tmp329;});void*_tmp1C3[1U];_tmp1C3[0]=& _tmp1C4;({unsigned _tmp3F2=loc;Cyc_Warn_err2(_tmp3F2,_tag_fat(_tmp1C3,sizeof(void*),1U));});});goto _LL51;}_LL51:;}
# 912
goto _LL4C;}}else{_LL4F: _LL50:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp32A;_tmp32A.tag=0U,({struct _fat_ptr _tmp3F3=({const char*_tmp1C8="expecting a datatype pointer type";_tag_fat(_tmp1C8,sizeof(char),34U);});_tmp32A.f1=_tmp3F3;});_tmp32A;});void*_tmp1C6[1U];_tmp1C6[0]=& _tmp1C7;({unsigned _tmp3F4=loc;Cyc_Warn_err2(_tmp3F4,_tag_fat(_tmp1C6,sizeof(void*),1U));});});goto _LL4C;}_LL4C:;}}}}
# 918
if(seen_format){
...
# 925
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1CB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp32B;_tmp32B.tag=0U,({struct _fat_ptr _tmp3F5=({const char*_tmp1CC="bad format descriptor";_tag_fat(_tmp1CC,sizeof(char),22U);});_tmp32B.f1=_tmp3F5;});_tmp32B;});void*_tmp1CA[1U];_tmp1CA[0]=& _tmp1CB;({unsigned _tmp3F6=loc;Cyc_Warn_err2(_tmp3F6,_tag_fat(_tmp1CA,sizeof(void*),1U));});});else{
# 928
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1D6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp32C;_tmp32C.tag=0U,({struct _fat_ptr _tmp3F7=({const char*_tmp1D7="format descriptor is not a string";_tag_fat(_tmp1D7,sizeof(char),34U);});_tmp32C.f1=_tmp3F7;});_tmp32C;});void*_tmp1D5[1U];_tmp1D5[0]=& _tmp1D6;({unsigned _tmp3F8=loc;Cyc_Warn_err2(_tmp3F8,_tag_fat(_tmp1D5,sizeof(void*),1U));});});else{
# 936
struct Cyc_Absyn_Exp*_tmp1D8=({void*_tmp3F9=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp3F9,b);});struct Cyc_Absyn_Exp*e=_tmp1D8;
if(e == 0 && c_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1DA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp32D;_tmp32D.tag=0U,({struct _fat_ptr _tmp3FA=({const char*_tmp1DB="format descriptor is not a char * type";_tag_fat(_tmp1DB,sizeof(char),39U);});_tmp32D.f1=_tmp3FA;});_tmp32D;});void*_tmp1D9[1U];_tmp1D9[0]=& _tmp1DA;({unsigned _tmp3FB=loc;Cyc_Warn_err2(_tmp3FB,_tag_fat(_tmp1D9,sizeof(void*),1U));});});else{
if(e != 0 && !c_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1DD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp32E;_tmp32E.tag=0U,({struct _fat_ptr _tmp3FC=({const char*_tmp1DE="format descriptor is not a char ? type";_tag_fat(_tmp1DE,sizeof(char),39U);});_tmp32E.f1=_tmp3FC;});_tmp32E;});void*_tmp1DC[1U];_tmp1DC[0]=& _tmp1DD;({unsigned _tmp3FD=loc;Cyc_Warn_err2(_tmp3FD,_tag_fat(_tmp1DC,sizeof(void*),1U));});});}}
# 942
goto _LL59;}}else{_LL5C: _LL5D:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1E0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp32F;_tmp32F.tag=0U,({struct _fat_ptr _tmp3FE=({const char*_tmp1E1="format descriptor is not a string type";_tag_fat(_tmp1E1,sizeof(char),39U);});_tmp32F.f1=_tmp3FE;});_tmp32F;});void*_tmp1DF[1U];_tmp1DF[0]=& _tmp1E0;({unsigned _tmp3FF=loc;Cyc_Warn_err2(_tmp3FF,_tag_fat(_tmp1DF,sizeof(void*),1U));});});goto _LL59;}_LL59:;}
# 945
if(fmt_arg_start != 0 && !c_vararg){
# 949
int problem;
{struct _tuple16 _tmp1E2=({struct _tuple16 _tmp330;_tmp330.f1=ft,({void*_tmp400=Cyc_Tcutil_compress(Cyc_Tcutil_pointer_elt_type(((struct Cyc_Absyn_VarargInfo*)_check_null(cyc_vararg))->type));_tmp330.f2=_tmp400;});_tmp330;});struct _tuple16 _stmttmp1F=_tmp1E2;struct _tuple16 _tmp1E3=_stmttmp1F;struct Cyc_Absyn_Datatypedecl*_tmp1E4;struct Cyc_Absyn_Datatypedecl*_tmp1E5;switch(_tmp1E3.f1){case Cyc_Absyn_Printf_ft: if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1E3.f2)->tag == 0U){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1E3.f2)->f1)->tag == 18U){if(((((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1E3.f2)->f1)->f1).KnownDatatype).tag == 2){_LL5F: _tmp1E5=*((((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1E3.f2)->f1)->f1).KnownDatatype).val;_LL60: {struct Cyc_Absyn_Datatypedecl*tud=_tmp1E5;
# 952
problem=({struct _tuple1*_tmp401=tud->name;Cyc_Absyn_qvar_cmp(_tmp401,Cyc_Absyn_datatype_print_arg_qvar());})!= 0;
...
# 955
problem=({struct _tuple1*_tmp402=tud->name;Cyc_Absyn_qvar_cmp(_tmp402,Cyc_Absyn_datatype_scanf_arg_qvar());})!= 0;
...
# 961
if(problem)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1E7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp331;_tmp331.tag=0U,({struct _fat_ptr _tmp403=({const char*_tmp1E8="format attribute and vararg types don't match";_tag_fat(_tmp1E8,sizeof(char),46U);});_tmp331.f1=_tmp403;});_tmp331;});void*_tmp1E6[1U];_tmp1E6[0]=& _tmp1E7;({unsigned _tmp404=loc;Cyc_Warn_err2(_tmp404,_tag_fat(_tmp1E6,sizeof(void*),1U));});});}}}}
# 969
...
struct Cyc_Tcenv_Tenv*_tmp1EE=({struct Cyc_Tcenv_Tenv*_tmp230=_cycalloc(sizeof(*_tmp230));_tmp230->ns=te->ns,_tmp230->ae=te->ae,_tmp230->le=fenv,_tmp230->allow_valueof=1,_tmp230->in_extern_c_include=te->in_extern_c_include,_tmp230->in_tempest=te->in_tempest,_tmp230->tempest_generalize=te->tempest_generalize;_tmp230;});struct Cyc_Tcenv_Tenv*ftenv=_tmp1EE;
struct _tuple15 _tmp1EF=({unsigned _tmp408=loc;struct Cyc_Tcenv_Tenv*_tmp407=ftenv;struct Cyc_Tctyp_CVTEnv _tmp406=new_cvtenv;struct _fat_ptr _tmp405=({const char*_tmp22F="@requires";_tag_fat(_tmp22F,sizeof(char),10U);});Cyc_Tctyp_check_clause(_tmp408,_tmp407,_tmp406,_tmp405,req);});struct _tuple15 _stmttmp21=_tmp1EF;struct _tuple15 _tmp1F0=_stmttmp21;struct Cyc_List_List*_tmp1F2;struct Cyc_Tctyp_CVTEnv _tmp1F1;_LL69: _tmp1F1=_tmp1F0.f1;_tmp1F2=_tmp1F0.f2;_LL6A: {struct Cyc_Tctyp_CVTEnv nenv=_tmp1F1;struct Cyc_List_List*req_rs=_tmp1F2;
new_cvtenv=nenv;
*req_relns=req_rs;
...
struct _tuple15 _tmp1F3=({unsigned _tmp40C=loc;struct Cyc_Tcenv_Tenv*_tmp40B=ftenv;struct Cyc_Tctyp_CVTEnv _tmp40A=new_cvtenv;struct _fat_ptr _tmp409=({const char*_tmp22E="@ensures";_tag_fat(_tmp22E,sizeof(char),9U);});Cyc_Tctyp_check_clause(_tmp40C,_tmp40B,_tmp40A,_tmp409,ens);});struct _tuple15 _stmttmp22=_tmp1F3;struct _tuple15 _tmp1F4=_stmttmp22;struct Cyc_List_List*_tmp1F6;struct Cyc_Tctyp_CVTEnv _tmp1F5;_LL6C: _tmp1F5=_tmp1F4.f1;_tmp1F6=_tmp1F4.f2;_LL6D: {struct Cyc_Tctyp_CVTEnv nenv=_tmp1F5;struct Cyc_List_List*ens_rs=_tmp1F6;
new_cvtenv=nenv;
*ens_relns=ens_rs;
...
({struct Cyc_Core_Opt*_tmp40D=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_rk);*f=_tmp40D;});_tmp1FE=r;goto _LL75;}
# 1005
({struct Cyc_Core_Opt*_tmp40E=Cyc_Tcutil_kind_to_bound_opt(r);*f=_tmp40E;});_tmp1FE=r;goto _LL75;}}else{switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp1FC)->f2)->kind){case Cyc_Absyn_BoolKind: _LL76: _LL77:
# 1008
...
# 1015
({struct Cyc_Core_Opt*_tmp40F=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_ek);*f=_tmp40F;});goto _LL85;}default: goto _LL88;}}case 0U: _LL74: _tmp1FE=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp1FC)->f1;if((int)_tmp1FE->kind == (int)Cyc_Absyn_RgnKind){_LL75: {struct Cyc_Absyn_Kind*r=_tmp1FE;
# 1007
effect=({struct Cyc_List_List*_tmp202=_cycalloc(sizeof(*_tmp202));({void*_tmp410=Cyc_Absyn_access_eff(Cyc_Absyn_var_type(tv));_tmp202->hd=_tmp410;}),_tmp202->tl=effect;_tmp202;});goto _LL71;}}else{switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp1FC)->f1)->kind){case Cyc_Absyn_BoolKind: _LL7C: _LL7D:
# 1011
...
# 1017
 effect=({struct Cyc_List_List*_tmp203=_cycalloc(sizeof(*_tmp203));({void*_tmp411=Cyc_Absyn_var_type(tv);_tmp203->hd=_tmp411;}),_tmp203->tl=effect;_tmp203;});goto _LL71;default: _LL88: _LL89:
# 1022
 effect=({struct Cyc_List_List*_tmp206=_cycalloc(sizeof(*_tmp206));({void*_tmp412=Cyc_Absyn_regionsof_eff(Cyc_Absyn_var_type(tv));_tmp206->hd=_tmp412;}),_tmp206->tl=effect;_tmp206;});goto _LL71;}}default: _LL86: _tmp1FD=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp1FC)->f1;_LL87: {struct Cyc_Core_Opt**f=_tmp1FD;
# 1019
({struct Cyc_Core_Opt*_tmp414=({struct Cyc_Core_Opt*_tmp205=_cycalloc(sizeof(*_tmp205));({void*_tmp413=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp204=_cycalloc(sizeof(*_tmp204));_tmp204->tag=2U,_tmp204->f1=0,_tmp204->f2=& Cyc_Tcutil_ak;_tmp204;});_tmp205->v=_tmp413;});_tmp205;});*f=_tmp414;});goto _LL89;}}_LL71:;}}}}
# 1026
...
# 1031
 effect=({struct Cyc_List_List*_tmp20D=_cycalloc(sizeof(*_tmp20D));({void*_tmp415=Cyc_Absyn_access_eff(tv);_tmp20D->hd=_tmp415;}),_tmp20D->tl=effect;_tmp20D;});goto _LL8D;case Cyc_Absyn_EffKind: _LL90: _LL91:
# 1033
 ...
 effect=({struct Cyc_List_List*_tmp20F=_cycalloc(sizeof(*_tmp20F));({void*_tmp416=Cyc_Absyn_regionsof_eff(tv);_tmp20F->hd=_tmp416;}),_tmp20F->tl=effect;_tmp20F;});goto _LL8D;}_LL8D:;}}}}
# 1038
({void*_tmp417=Cyc_Absyn_join_eff(effect);*eff=_tmp417;});}
# 1044
if(*btvs != 0){
...
# 1048
({struct Cyc_Warn_String_Warn_Warg_struct _tmp21E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp334;_tmp334.tag=0U,({struct _fat_ptr _tmp418=({const char*_tmp222="Type variable ";_tag_fat(_tmp222,sizeof(char),15U);});_tmp334.f1=_tmp418;});_tmp334;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp21F=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp333;_tmp333.tag=6U,_tmp333.f1=(struct Cyc_Absyn_Tvar*)bs->hd;_tmp333;});struct Cyc_Warn_String_Warn_Warg_struct _tmp220=({struct Cyc_Warn_String_Warn_Warg_struct _tmp332;_tmp332.tag=0U,({struct _fat_ptr _tmp419=({const char*_tmp221=" unconstrained, assuming boxed";_tag_fat(_tmp221,sizeof(char),31U);});_tmp332.f1=_tmp419;});_tmp332;});void*_tmp21D[3U];_tmp21D[0]=& _tmp21E,_tmp21D[1]=& _tmp21F,_tmp21D[2]=& _tmp220;({unsigned _tmp41A=loc;Cyc_Warn_warn2(_tmp41A,_tag_fat(_tmp21D,sizeof(void*),3U));});});
...
# 1055
({struct Cyc_Core_Opt*_tmp41B=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_bk);*f=_tmp41B;});goto _LL96;}case Cyc_Absyn_Unique: _LLA5: _tmp215=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp211)->f1;_LLA6: {struct Cyc_Core_Opt**f=_tmp215;
# 1058
({struct Cyc_Core_Opt*_tmp41C=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_ubk);*f=_tmp41C;});goto _LL96;}default: goto _LLA9;}case Cyc_Absyn_RgnKind: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp211)->f2)->aliasqual == Cyc_Absyn_Top){_LLA7: _tmp214=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp211)->f1;_LLA8: {struct Cyc_Core_Opt**f=_tmp214;
# 1060
({struct Cyc_Core_Opt*_tmp41D=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_rk);*f=_tmp41D;});goto _LL96;}}else{goto _LLA9;}default: _LLA9: _tmp212=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp211)->f1;_tmp213=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp211)->f2;_LLAA: {struct Cyc_Core_Opt**f=_tmp212;struct Cyc_Absyn_Kind*k=_tmp213;
# 1062
({struct Cyc_Core_Opt*_tmp41E=Cyc_Tcutil_kind_to_bound_opt(k);*f=_tmp41E;});goto _LL96;}}default: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp211)->f1)->kind == Cyc_Absyn_MemKind){_LLAB: _LLAC:
# 1064
({struct Cyc_Warn_String_Warn_Warg_struct _tmp224=({struct Cyc_Warn_String_Warn_Warg_struct _tmp335;_tmp335.tag=0U,({struct _fat_ptr _tmp41F=({const char*_tmp225="functions can't abstract M types";_tag_fat(_tmp225,sizeof(char),33U);});_tmp335.f1=_tmp41F;});_tmp335;});void*_tmp223[1U];_tmp223[0]=& _tmp224;({unsigned _tmp420=loc;Cyc_Warn_err2(_tmp420,_tag_fat(_tmp223,sizeof(void*),1U));});});goto _LL96;}else{_LLAD: _LLAE:
 goto _LL96;}}_LL96:;}}
# 1069
({struct Cyc_List_List*_tmp421=Cyc_Tctyp_remove_bound_tvars(Cyc_Core_heap_region,new_cvtenv.kind_env,*btvs);cvtenv.kind_env=_tmp421;});
({struct Cyc_List_List*_tmp422=Cyc_Tctyp_remove_bound_tvars_bool(new_cvtenv.r,new_cvtenv.free_vars,*btvs);new_cvtenv.free_vars=_tmp422;});
# 1072
{struct Cyc_List_List*tvs=new_cvtenv.free_vars;for(0;tvs != 0;tvs=tvs->tl){
...
({struct Cyc_List_List*_tmp423=Cyc_Tctyp_fast_add_free_tvar_bool(cvtenv.r,cvtenv.free_vars,t,b);cvtenv.free_vars=_tmp423;});}}}
# 1077
...
({struct Cyc_List_List*_tmp424=Cyc_Tctyp_add_free_evar(cvtenv.r,cvtenv.free_evars,e,b);cvtenv.free_evars=_tmp424;});}}}
# 1081
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp23B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp338;_tmp338.tag=0U,({struct _fat_ptr _tmp426=({const char*_tmp23D="duplicate field ";_tag_fat(_tmp23D,sizeof(char),17U);});_tmp338.f1=_tmp426;});_tmp338;});struct Cyc_Warn_String_Warn_Warg_struct _tmp23C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp337;_tmp337.tag=0U,_tmp337.f1=*fn;_tmp337;});void*_tmp23A[2U];_tmp23A[0]=& _tmp23B,_tmp23A[1]=& _tmp23C;({unsigned _tmp427=loc;Cyc_Warn_err2(_tmp427,_tag_fat(_tmp23A,sizeof(void*),2U));});});
if(({struct _fat_ptr _tmp428=(struct _fat_ptr)*fn;Cyc_strcmp(_tmp428,({const char*_tmp23E="";_tag_fat(_tmp23E,sizeof(char),1U);}));})!= 0)
...
({int _tmp429=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t);tqp->real_const=_tmp429;});
Cyc_Tcutil_check_bitfield(loc,t,width,fn);
Cyc_Tctyp_check_field_atts(loc,fn,atts);
if(requires_clause != 0){
# 1107
if((int)k != (int)1U)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp241=({struct Cyc_Warn_String_Warn_Warg_struct _tmp339;_tmp339.tag=0U,({struct _fat_ptr _tmp42A=({const char*_tmp242="@requires clause is only allowed on union members";_tag_fat(_tmp242,sizeof(char),50U);});_tmp339.f1=_tmp42A;});_tmp339;});void*_tmp240[1U];_tmp240[0]=& _tmp241;({unsigned _tmp42B=loc;Cyc_Warn_err2(_tmp42B,_tag_fat(_tmp240,sizeof(void*),1U));});});
({struct Cyc_Tcenv_Tenv*_tmp42C=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmp42C,0,requires_clause);});
if(!Cyc_Tcutil_is_integral(requires_clause))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp244=({struct Cyc_Warn_String_Warn_Warg_struct _tmp33C;_tmp33C.tag=0U,({struct _fat_ptr _tmp42D=({const char*_tmp248="@requires clause has type ";_tag_fat(_tmp248,sizeof(char),27U);});_tmp33C.f1=_tmp42D;});_tmp33C;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp245=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp33B;_tmp33B.tag=2U,_tmp33B.f1=(void*)_check_null(requires_clause->topt);_tmp33B;});struct Cyc_Warn_String_Warn_Warg_struct _tmp246=({struct Cyc_Warn_String_Warn_Warg_struct _tmp33A;_tmp33A.tag=0U,({
struct _fat_ptr _tmp42E=({const char*_tmp247=" instead of integral type";_tag_fat(_tmp247,sizeof(char),26U);});_tmp33A.f1=_tmp42E;});_tmp33A;});void*_tmp243[3U];_tmp243[0]=& _tmp244,_tmp243[1]=& _tmp245,_tmp243[2]=& _tmp246;({unsigned _tmp42F=loc;Cyc_Warn_err2(_tmp42F,_tag_fat(_tmp243,sizeof(void*),3U));});});
...
# 1124
({struct Cyc_Warn_String_Warn_Warg_struct _tmp24F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp33E;_tmp33E.tag=0U,({struct _fat_ptr _tmp430=({const char*_tmp251="unbound typedef name ";_tag_fat(_tmp251,sizeof(char),22U);});_tmp33E.f1=_tmp430;});_tmp33E;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp250=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp33D;_tmp33D.tag=1U,_tmp33D.f1=tdn;_tmp33D;});void*_tmp24E[2U];_tmp24E[0]=& _tmp24F,_tmp24E[1]=& _tmp250;({unsigned _tmp431=loc;Cyc_Warn_err2(_tmp431,_tag_fat(_tmp24E,sizeof(void*),2U));});});
...
cvtenv=Cyc_Tctyp_i_check_valid_type(loc,te,cvtenv,k,(void*)ts->hd,1,allow_abs_aggr);
Cyc_Tcutil_check_no_qual(loc,(void*)ts->hd);
inst=({struct Cyc_List_List*_tmp253=_cycalloc(sizeof(*_tmp253));({struct _tuple18*_tmp432=({struct _tuple18*_tmp252=_cycalloc(sizeof(*_tmp252));_tmp252->f1=(struct Cyc_Absyn_Tvar*)tvs->hd,_tmp252->f2=(void*)ts->hd;_tmp252;});_tmp253->hd=_tmp432;}),_tmp253->tl=inst;_tmp253;});}
# 1138
if(ts != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp255=({struct Cyc_Warn_String_Warn_Warg_struct _tmp340;_tmp340.tag=0U,({struct _fat_ptr _tmp433=({const char*_tmp257="too many parameters for typedef ";_tag_fat(_tmp257,sizeof(char),33U);});_tmp340.f1=_tmp433;});_tmp340;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp256=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp33F;_tmp33F.tag=1U,_tmp33F.f1=tdn;_tmp33F;});void*_tmp254[2U];_tmp254[0]=& _tmp255,_tmp254[1]=& _tmp256;({unsigned _tmp434=loc;Cyc_Warn_err2(_tmp434,_tag_fat(_tmp254,sizeof(void*),2U));});});
if(tvs != 0){
struct Cyc_List_List*hidden_ts=0;
# 1143
for(0;tvs != 0;tvs=tvs->tl){
...
cvtenv=Cyc_Tctyp_i_check_valid_type(loc,te,cvtenv,k,e,1,allow_abs_aggr);
inst=({struct Cyc_List_List*_tmp25A=_cycalloc(sizeof(*_tmp25A));({struct _tuple18*_tmp435=({struct _tuple18*_tmp259=_cycalloc(sizeof(*_tmp259));_tmp259->f1=(struct Cyc_Absyn_Tvar*)tvs->hd,_tmp259->f2=e;_tmp259;});_tmp25A->hd=_tmp435;}),_tmp25A->tl=inst;_tmp25A;});}
# 1151
({struct Cyc_List_List*_tmp437=({struct Cyc_List_List*_tmp436=targs;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp436,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(hidden_ts));});*targs_ref=_tmp437;});}
# 1153
if(td->defn != 0){
void*new_typ=
...
goto _LL0;}}}_LL0:;}
# 1161
if(!({struct Cyc_Absyn_Kind*_tmp438=Cyc_Tcutil_type_kind(t);Cyc_Tcutil_kind_leq(_tmp438,expected_kind);}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp25C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp346;_tmp346.tag=0U,({struct _fat_ptr _tmp439=({const char*_tmp264="type ";_tag_fat(_tmp264,sizeof(char),6U);});_tmp346.f1=_tmp439;});_tmp346;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp25D=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp345;_tmp345.tag=2U,_tmp345.f1=(void*)t;_tmp345;});struct Cyc_Warn_String_Warn_Warg_struct _tmp25E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp344;_tmp344.tag=0U,({struct _fat_ptr _tmp43A=({const char*_tmp263=" has kind ";_tag_fat(_tmp263,sizeof(char),11U);});_tmp344.f1=_tmp43A;});_tmp344;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmp25F=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp343;_tmp343.tag=8U,({struct Cyc_Absyn_Kind*_tmp43B=Cyc_Tcutil_type_kind(t);_tmp343.f1=_tmp43B;});_tmp343;});struct Cyc_Warn_String_Warn_Warg_struct _tmp260=({struct Cyc_Warn_String_Warn_Warg_struct _tmp342;_tmp342.tag=0U,({
struct _fat_ptr _tmp43C=({const char*_tmp262=" but as used here needs kind ";_tag_fat(_tmp262,sizeof(char),30U);});_tmp342.f1=_tmp43C;});_tmp342;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmp261=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp341;_tmp341.tag=8U,_tmp341.f1=expected_kind;_tmp341;});void*_tmp25B[6U];_tmp25B[0]=& _tmp25C,_tmp25B[1]=& _tmp25D,_tmp25B[2]=& _tmp25E,_tmp25B[3]=& _tmp25F,_tmp25B[4]=& _tmp260,_tmp25B[5]=& _tmp261;({unsigned _tmp43D=loc;Cyc_Warn_err2(_tmp43D,_tag_fat(_tmp25B,sizeof(void*),6U));});});
# 1165
return cvtenv;}
# 1173
...
# 1214
({struct Cyc_Warn_String_Warn_Warg_struct _tmp279=({struct Cyc_Warn_String_Warn_Warg_struct _tmp347;_tmp347.tag=0U,({struct _fat_ptr _tmp43E=({const char*_tmp27A="non-type-level-expression in Tctyp::i_check_valid_type_level_exp";_tag_fat(_tmp27A,sizeof(char),65U);});_tmp347.f1=_tmp43E;});_tmp347;});void*_tmp278[1U];_tmp278[0]=& _tmp279;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp278,sizeof(void*),1U));});}_LL0:;}
# 1216
return cvtenv;}
# 1219
...
({struct Cyc_List_List*_tmp43F=Cyc_Tctyp_fast_add_free_tvar(kind_env,(*((struct _tuple14*)vs->hd)).f1);cvt.kind_env=_tmp43F;});}}
# 1233
...
# 1237
if(*s == 0)
({struct Cyc_Core_Opt*_tmp440=({struct Cyc_Core_Opt*_tmp282=_cycalloc(sizeof(*_tmp282));_tmp282->v=kind_env;_tmp282;});*s=_tmp440;});else{
# 1241
...
({struct Cyc_Core_Opt*_tmp441=({struct Cyc_Core_Opt*_tmp286=_cycalloc(sizeof(*_tmp286));_tmp286->v=result;_tmp286;});*s=_tmp441;});}
# 1248
...
struct Cyc_Tctyp_CVTEnv _tmp288=({unsigned _tmp445=loc;struct Cyc_Tcenv_Tenv*_tmp444=te;struct Cyc_Tctyp_CVTEnv _tmp443=({struct Cyc_Tctyp_CVTEnv _tmp34E;_tmp34E.r=Cyc_Core_heap_region,_tmp34E.kind_env=te_vars,_tmp34E.fn_result=0,_tmp34E.generalize_evars=generalize_evars,_tmp34E.free_vars=0,_tmp34E.free_evars=0;_tmp34E;});struct Cyc_Absyn_Kind*_tmp442=expected_kind;Cyc_Tctyp_check_valid_type(_tmp445,_tmp444,_tmp443,_tmp442,1,t);});struct Cyc_Tctyp_CVTEnv cvt=_tmp288;
# 1268
...
# 1294
({struct Cyc_Core_Opt*_tmp446=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_bk);*f=_tmp446;});goto _LL0;}case Cyc_Absyn_Unique: _LL9: _tmp296=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp291)->f1;_LLA: {struct Cyc_Core_Opt**f=_tmp296;
# 1296
({struct Cyc_Core_Opt*_tmp447=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_ubk);*f=_tmp447;});goto _LL0;}default: goto _LLD;}case Cyc_Absyn_RgnKind: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp291)->f2)->aliasqual == Cyc_Absyn_Top){_LLB: _tmp295=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp291)->f1;_LLC: {struct Cyc_Core_Opt**f=_tmp295;
# 1298
({struct Cyc_Core_Opt*_tmp448=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_rk);*f=_tmp448;});goto _LL0;}}else{goto _LLD;}default: _LLD: _tmp293=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp291)->f1;_tmp294=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp291)->f2;_LLE: {struct Cyc_Core_Opt**f=_tmp293;struct Cyc_Absyn_Kind*k=_tmp294;
# 1300
({struct Cyc_Core_Opt*_tmp449=Cyc_Tcutil_kind_to_bound_opt(k);*f=_tmp449;});goto _LL0;}}default: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp291)->f1)->kind == Cyc_Absyn_MemKind){_LLF: _tmp292=(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp291)->f1)->aliasqual;_LL10: {enum Cyc_Absyn_AliasQual a=_tmp292;
# 1302
({struct Cyc_Warn_String_Warn_Warg_struct _tmp29C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp34B;_tmp34B.tag=0U,({struct _fat_ptr _tmp44A=({const char*_tmp2A2="type variable ";_tag_fat(_tmp2A2,sizeof(char),15U);});_tmp34B.f1=_tmp44A;});_tmp34B;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp29D=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp34A;_tmp34A.tag=6U,_tmp34A.f1=(struct Cyc_Absyn_Tvar*)x->hd;_tmp34A;});struct Cyc_Warn_String_Warn_Warg_struct _tmp29E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp349;_tmp349.tag=0U,({struct _fat_ptr _tmp44B=({const char*_tmp2A1=" cannot have kind ";_tag_fat(_tmp2A1,sizeof(char),19U);});_tmp349.f1=_tmp44B;});_tmp349;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmp29F=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp348;_tmp348.tag=8U,({struct Cyc_Absyn_Kind*_tmp44C=({struct Cyc_Absyn_Kind*_tmp2A0=_cycalloc(sizeof(*_tmp2A0));_tmp2A0->kind=Cyc_Absyn_MemKind,_tmp2A0->aliasqual=a;_tmp2A0;});_tmp348.f1=_tmp44C;});_tmp348;});void*_tmp29B[4U];_tmp29B[0]=& _tmp29C,_tmp29B[1]=& _tmp29D,_tmp29B[2]=& _tmp29E,_tmp29B[3]=& _tmp29F;({unsigned _tmp44D=loc;Cyc_Warn_err2(_tmp44D,_tag_fat(_tmp29B,sizeof(void*),4U));});});
...
if(*btvs == 0){
# 1313
({struct Cyc_List_List*_tmp44E=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_copy)(free_tvars);*btvs=_tmp44E;});
free_tvars=0;}
# 1316
...
# 1319
if(free_tvars != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2A7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp34D;_tmp34D.tag=0U,({struct _fat_ptr _tmp44F=({const char*_tmp2A9="unbound type variable ";_tag_fat(_tmp2A9,sizeof(char),23U);});_tmp34D.f1=_tmp44F;});_tmp34D;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp2A8=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp34C;_tmp34C.tag=6U,_tmp34C.f1=(struct Cyc_Absyn_Tvar*)free_tvars->hd;_tmp34C;});void*_tmp2A6[2U];_tmp2A6[0]=& _tmp2A7,_tmp2A6[1]=& _tmp2A8;({unsigned _tmp450=loc;Cyc_Warn_err2(_tmp450,_tag_fat(_tmp2A6,sizeof(void*),2U));});});
...
{void*_tmp2AA=Cyc_Tcutil_compress(t);void*_stmttmp30=_tmp2AA;void*_tmp2AB=_stmttmp30;struct Cyc_Absyn_FnInfo _tmp2AC;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp2AB)->tag == 5U){_LL1: _tmp2AC=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp2AB)->f1;_LL2: {struct Cyc_Absyn_FnInfo i=_tmp2AC;
# 1336
struct Cyc_List_List*_tmp2AD=(fd->i).attributes;struct Cyc_List_List*atts=_tmp2AD;
fd->i=i;
(fd->i).attributes=atts;
({int _tmp451=
Cyc_Tcutil_extract_const_from_typedef(loc,(i.ret_tqual).print_const,i.ret_type);
# 1339
((fd->i).ret_tqual).real_const=_tmp451;});
# 1341
goto _LL0;}}else{_LL3: _LL4:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2AF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp34F;_tmp34F.tag=0U,({struct _fat_ptr _tmp452=({const char*_tmp2B0="check_fndecl_valid_type: not a FnType";_tag_fat(_tmp2B0,sizeof(char),38U);});_tmp34F.f1=_tmp452;});_tmp34F;});void*_tmp2AE[1U];_tmp2AE[0]=& _tmp2AF;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp2AE,sizeof(void*),1U));});}_LL0:;}
# 1344
({struct Cyc_List_List*_tmp454=((struct Cyc_List_List*(*)(struct _fat_ptr*(*f)(struct _tuple9*),struct Cyc_List_List*x))Cyc_List_map)((struct _fat_ptr*(*)(struct _tuple9*t))Cyc_Tctyp_fst_fdarg,(fd->i).args);unsigned _tmp453=loc;Cyc_Tcutil_check_unique_vars(_tmp454,_tmp453,({const char*_tmp2B1="function declaration has repeated parameter";_tag_fat(_tmp2B1,sizeof(char),44U);}));});
# 1347
fd->cached_type=t;}
# 1352
...
# 1355
struct Cyc_Tctyp_CVTEnv _tmp2B2=({unsigned _tmp459=loc;struct Cyc_Tcenv_Tenv*_tmp458=te;struct Cyc_Tctyp_CVTEnv _tmp457=({struct Cyc_Tctyp_CVTEnv _tmp354;_tmp354.r=Cyc_Core_heap_region,_tmp354.kind_env=bound_tvars,_tmp354.fn_result=0,_tmp354.generalize_evars=0,_tmp354.free_vars=0,_tmp354.free_evars=0;_tmp354;});struct Cyc_Absyn_Kind*_tmp456=expected_kind;int _tmp455=allow_abs_aggr;Cyc_Tctyp_check_valid_type(_tmp459,_tmp458,_tmp457,_tmp456,_tmp455,t);});struct Cyc_Tctyp_CVTEnv cvt=_tmp2B2;
# 1359
struct Cyc_List_List*_tmp2B3=({struct _RegionHandle*_tmp45B=Cyc_Core_heap_region;struct Cyc_List_List*_tmp45A=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Tvar*(*f)(struct _tuple14*),struct Cyc_List_List*x))Cyc_List_map)((struct Cyc_Absyn_Tvar*(*)(struct _tuple14*))Cyc_Core_fst,cvt.free_vars);Cyc_Tctyp_remove_bound_tvars(_tmp45B,_tmp45A,bound_tvars);});struct Cyc_List_List*free_tvars=_tmp2B3;
# 1361
struct Cyc_List_List*_tmp2B4=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple13*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple13*))Cyc_Core_fst,cvt.free_evars);struct Cyc_List_List*free_evars=_tmp2B4;
{struct Cyc_List_List*fs=free_tvars;for(0;fs != 0;fs=fs->tl){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2B6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp353;_tmp353.tag=0U,({struct _fat_ptr _tmp45C=({const char*_tmp2BB="unbound type variable ";_tag_fat(_tmp2BB,sizeof(char),23U);});_tmp353.f1=_tmp45C;});_tmp353;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp2B7=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp352;_tmp352.tag=6U,_tmp352.f1=(struct Cyc_Absyn_Tvar*)fs->hd;_tmp352;});struct Cyc_Warn_String_Warn_Warg_struct _tmp2B8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp351;_tmp351.tag=0U,({struct _fat_ptr _tmp45D=({const char*_tmp2BA=" in type ";_tag_fat(_tmp2BA,sizeof(char),10U);});_tmp351.f1=_tmp45D;});_tmp351;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2B9=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp350;_tmp350.tag=2U,_tmp350.f1=(void*)t;_tmp350;});void*_tmp2B5[4U];_tmp2B5[0]=& _tmp2B6,_tmp2B5[1]=& _tmp2B7,_tmp2B5[2]=& _tmp2B8,_tmp2B5[3]=& _tmp2B9;({unsigned _tmp45E=loc;Cyc_Warn_err2(_tmp45E,_tag_fat(_tmp2B5,sizeof(void*),4U));});});}}
if(!allow_evars)
Cyc_Tctyp_check_free_evars(free_evars,t,loc);}
