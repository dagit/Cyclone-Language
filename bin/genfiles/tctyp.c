...
# 34 "tctyp.h"
void Cyc_Tctyp_check_valid_toplevel_type(unsigned,struct Cyc_Tcenv_Tenv*,void*);struct Cyc_PP_Ppstate;struct Cyc_PP_Out;struct Cyc_PP_Doc;struct Cyc_Absynpp_Params{int expand_typedefs;int qvar_to_Cids;int add_cyc_prefix;int to_VC;int decls_first;int rewrite_temp_tvars;int print_all_tvars;int print_all_kinds;int print_all_effects;int print_using_stmts;int print_externC_stmts;int print_full_evars;int print_zeroterm;int generate_line_directives;int use_curr_namespace;struct Cyc_List_List*curr_namespace;};struct Cyc_Tctyp_CVTEnv{unsigned loc;struct Cyc_Tcenv_Tenv*te;struct Cyc_List_List*kind_env;int fn_result;int generalize_evars;struct Cyc_List_List*free_vars;struct Cyc_List_List*free_evars;};
# 84 "tctyp.cyc"
...
# 785
if(vi){
void*_tmp1A4=Cyc_Tcutil_compress(vt);void*_stmttmp18=_tmp1A4;void*_tmp1A5=_stmttmp18;void*_tmp1A8;void*_tmp1A7;void*_tmp1A6;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1A5)->tag == 3U){_LL50: _tmp1A6=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1A5)->f1).elt_type;_tmp1A7=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1A5)->f1).ptr_atts).bounds;_tmp1A8=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1A5)->f1).ptr_atts).zero_term;_LL51: {void*et=_tmp1A6;void*bs=_tmp1A7;void*zt=_tmp1A8;
# 788
{void*_tmp1A9=Cyc_Tcutil_compress(et);void*_stmttmp19=_tmp1A9;void*_tmp1AA=_stmttmp19;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1AA)->tag == 0U){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1AA)->f1)->tag == 18U){_LL55: _LL56:
# 790
...
void*_tmp24A=Cyc_Tcutil_compress(e);void*_stmttmp29=_tmp24A;void*_tmp24B=_stmttmp29;struct Cyc_Core_Opt**_tmp24C;if(((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp24B)->tag == 1U){_LL4: _tmp24C=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp24B)->f4;_LL5: {struct Cyc_Core_Opt**s=_tmp24C;
# 1048
if(*s == 0)
...
{void*_tmp269=Cyc_Tcutil_compress(t);void*_stmttmp2B=_tmp269;void*_tmp26A=_stmttmp2B;struct Cyc_List_List**_tmp26B;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp26A)->tag == 5U){_LL17: _tmp26B=(struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp26A)->f1).tvars;_LL18: {struct Cyc_List_List**btvs=_tmp26B;
# 1118
if(*btvs == 0){
# 1120
...
{void*_tmp273=Cyc_Tcutil_compress(t);void*_stmttmp2C=_tmp273;void*_tmp274=_stmttmp2C;struct Cyc_Absyn_FnInfo _tmp275;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp274)->tag == 5U){_LL1: _tmp275=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp274)->f1;_LL2: {struct Cyc_Absyn_FnInfo i=_tmp275;
# 1143
