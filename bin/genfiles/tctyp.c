...
void*ctx_bnd=({struct Cyc_List_List*_Tmp4=Cyc_Tcenv_curr_aquals_bounds(env.te);Cyc_Tcutil_lookup_aquals_opt(_Tmp4,(void*)ts->hd);});
if((unsigned)ctx_bnd)
...
# 729
static void Cyc_Tctyp_check_constrain_ptrbnd(unsigned loc,void*t,struct Cyc_Absyn_Kind*expected_kind){
if((int)expected_kind->kind==2){
void*_Tmp0=Cyc_Absyn_compress(t);void*_Tmp1;if(*((int*)_Tmp0)==4){_Tmp1=(void**)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp0)->f1.ptr_atts.bounds;{void**b=(void**)_Tmp1;
# 733
if(Cyc_Tcutil_is_cvar_type(*b)){
if(!({unsigned _Tmp2=loc;Cyc_BansheeIf_add_constraint(_Tmp2,({void*_Tmp3=*b;Cyc_BansheeIf_equality_constraint(_Tmp3,Cyc_Absyn_thinconst());}));}))
...
_tag_fat(" but as used here needs kind ",sizeof(char),30U);_Tmp7;});struct Cyc_Warn_Kind_Warn_Warg_struct _Tmp7=({struct Cyc_Warn_Kind_Warn_Warg_struct _Tmp8;_Tmp8.tag=9,_Tmp8.f1=expected_kind;_Tmp8;});void*_Tmp8[6];_Tmp8[0]=& _Tmp2,_Tmp8[1]=& _Tmp3,_Tmp8[2]=& _Tmp4,_Tmp8[3]=& _Tmp5,_Tmp8[4]=& _Tmp6,_Tmp8[5]=& _Tmp7;Cyc_Warn_err2(loc,_tag_fat(_Tmp8,sizeof(void*),6));});else{
# 739
({void*_Tmp2=Cyc_Absyn_compress(*b);_Tmp2==Cyc_Absyn_bounds_one();})?1:(int)_throw_assert();}}
# 742
goto _LL0;}}else{
# 744
goto _LL0;}_LL0:;}}struct _tuple16{enum Cyc_Absyn_Format_Type f0;void*f1;};struct _tuple17{struct Cyc_Absyn_Tvar*f0;void*f1;};
# 749
...
# 751
void*_Tmp0;unsigned _Tmp1;_Tmp1=env.loc;_Tmp0=env.te;{unsigned loc=_Tmp1;struct Cyc_Tcenv_Tenv*te=_Tmp0;
{void*_Tmp2=Cyc_Absyn_compress(t);enum Cyc_Absyn_AggrKind _Tmp3;void*_Tmp4;void*_Tmp5;void*_Tmp6;void*_Tmp7;void*_Tmp8;void*_Tmp9;void*_TmpA;void*_TmpB;void*_TmpC;void*_TmpD;void*_TmpE;int _TmpF;unsigned _Tmp10;void*_Tmp11;void*_Tmp12;void*_Tmp13;void*_Tmp14;void*_Tmp15;void*_Tmp16;const char*_Tmp17;void*_Tmp18;void*_Tmp19;switch(*((int*)_Tmp2)){case 0: _Tmp19=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp2)->f1;_Tmp18=(struct Cyc_List_List**)&((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp2)->f2;{void*c=_Tmp19;struct Cyc_List_List**targsp=_Tmp18;
# 754
env=Cyc_Tctyp_i_check_type_app(env,expected_kind,c,targsp,put_in_effect,allow_abs_aggr,t);
# 756
goto _LL3;}case 3: _Tmp19=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_Tmp2)->f1;_Tmp17=((struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_Tmp2)->f5;{struct Cyc_Core_Opt**k=_Tmp19;const char*name=_Tmp17;
# 758
if(name==0)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("Unnamed Cvar ",sizeof(char),14U);_Tmp1B;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=2,_Tmp1C.f1=(void*)t;_Tmp1C;});void*_Tmp1C[2];_Tmp1C[0]=& _Tmp1A,_Tmp1C[1]=& _Tmp1B;Cyc_Warn_err2(loc,_tag_fat(_Tmp1C,sizeof(void*),2));});
# 761
if(*k==0 ||
...
({struct Cyc_Core_Opt*_Tmp1A=Cyc_Kinds_kind_to_opt(expected_kind);*k=_Tmp1A;});
goto _LL3;}case 1: _Tmp19=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_Tmp2)->f1;_Tmp18=(void**)&((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_Tmp2)->f2;{struct Cyc_Core_Opt**k=_Tmp19;void**ref=_Tmp18;
# 768
if(*k==0 ||
 Cyc_Kinds_kind_leq(expected_kind,(struct Cyc_Absyn_Kind*)(*k)->v)&& !
Cyc_Kinds_kind_leq((struct Cyc_Absyn_Kind*)_check_null(*k)->v,expected_kind))
...
# 794
struct Cyc_Absyn_Tvar*v=Cyc_Tcutil_new_tvar((void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp1A=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp1A->tag=2,_Tmp1A->f1=0,_Tmp1A->f2=expected_kind;_Tmp1A;}));
({void*_Tmp1A=Cyc_Absyn_var_type(v);*ref=_Tmp1A;});
_Tmp19=v;goto _LLB;}
# 798
({struct Cyc_List_List*_Tmp1A=Cyc_Tctyp_add_free_evar(env.free_evars,t,put_in_effect);env.free_evars=_Tmp1A;});
goto _LL3;}case 2: _Tmp19=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_Tmp2)->f1;_LLB: {struct Cyc_Absyn_Tvar*v=_Tmp19;
# 801
{void*_Tmp1A=Cyc_Kinds_compress_kb(v->kind);void*_Tmp1B;if(*((int*)_Tmp1A)==1){_Tmp1B=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_Tmp1A)->f1;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp1B;
({struct Cyc_Core_Opt*_Tmp1C=({struct Cyc_Core_Opt*_Tmp1D=_cycalloc(sizeof(struct Cyc_Core_Opt));({void*_Tmp1E=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp1F=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp1F->tag=2,_Tmp1F->f1=0,_Tmp1F->f2=expected_kind;_Tmp1F;});_Tmp1D->v=_Tmp1E;});_Tmp1D;});*f=_Tmp1C;});goto _LL1C;}}else{
goto _LL1C;}_LL1C:;}
# 807
({struct Cyc_List_List*_Tmp1A=Cyc_Tctyp_add_free_tvar(loc,env.kind_env,v,env.allow_aqual_bounds);env.kind_env=_Tmp1A;});
# 810
({struct Cyc_List_List*_Tmp1A=Cyc_Tctyp_fast_add_free_tvar_bool(env.free_vars,v,put_in_effect);env.free_vars=_Tmp1A;});
# 812
{void*_Tmp1A=Cyc_Kinds_compress_kb(v->kind);void*_Tmp1B;void*_Tmp1C;if(*((int*)_Tmp1A)==2){_Tmp1C=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp1A)->f1;_Tmp1B=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp1A)->f2;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp1C;struct Cyc_Absyn_Kind*k=_Tmp1B;
# 814
if(Cyc_Kinds_kind_leq(expected_kind,k))
({struct Cyc_Core_Opt*_Tmp1D=({struct Cyc_Core_Opt*_Tmp1E=_cycalloc(sizeof(struct Cyc_Core_Opt));({void*_Tmp1F=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp20=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp20->tag=2,_Tmp20->f1=0,_Tmp20->f2=expected_kind;_Tmp20;});_Tmp1E->v=_Tmp1F;});_Tmp1E;});*f=_Tmp1D;});
goto _LL21;}}else{
goto _LL21;}_LL21:;}
# 819
goto _LL3;}case 10: _Tmp19=((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_Tmp2)->f1->r;_Tmp18=(void***)&((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_Tmp2)->f2;{void*td=_Tmp19;void***topt=_Tmp18;
# 824
void*new_typ=Cyc_Tcutil_copy_type(Cyc_Absyn_compress(t));
{void*_Tmp1A;switch(*((int*)td)){case 0: _Tmp1A=((struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)td)->f1;{struct Cyc_Absyn_Aggrdecl*ad=_Tmp1A;
# 827
if(env.te->in_extern_c_include)
ad->sc=4U;
Cyc_Tc_tcAggrdecl(te,loc,ad);goto _LL26;}case 1: _Tmp1A=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)td)->f1;{struct Cyc_Absyn_Enumdecl*ed=_Tmp1A;
# 831
if(env.te->in_extern_c_include)
ed->sc=4U;
Cyc_Tc_tcEnumdecl(te,loc,ed);goto _LL26;}default: _Tmp1A=((struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)td)->f1;{struct Cyc_Absyn_Datatypedecl*dd=_Tmp1A;
# 835
Cyc_Tc_tcDatatypedecl(te,loc,dd);goto _LL26;}}_LL26:;}
# 837
({void**_Tmp1A=({void**_Tmp1B=_cycalloc(sizeof(void*));*_Tmp1B=new_typ;_Tmp1B;});*topt=_Tmp1A;});
return Cyc_Tctyp_i_check_type(env,expected_kind,new_typ,put_in_effect,allow_abs_aggr);}case 4: _Tmp19=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.elt_type;_Tmp18=(struct Cyc_Absyn_Tqual*)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.elt_tq;_Tmp16=(void**)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.eff;_Tmp15=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.nullable;_Tmp14=(void**)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.bounds;_Tmp13=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.zero_term;_Tmp12=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.autoreleased;_Tmp11=(void**)&((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp2)->f1.ptr_atts.aqual;{void*t1=_Tmp19;struct Cyc_Absyn_Tqual*tqp=_Tmp18;void**eff_type=_Tmp16;void*nullable=_Tmp15;void**b=_Tmp14;void*zt=_Tmp13;void*rel=_Tmp12;void**aq=_Tmp11;
# 842
void*override_aq=*aq;
{void*_Tmp1A=*eff_type;if(*((int*)_Tmp1A)==0)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A)->f1)){case 7:
# 845
...
goto _LL2D;default: goto _LL32;}else{_LL32:
# 853
 goto _LL2D;}_LL2D:;}
# 855
if(override_aq!=*aq){
{void*_Tmp1A=*aq;void*_Tmp1B;if(*((int*)_Tmp1A)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A)->f1)==17){if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A)->f2!=0){if(*((int*)((struct Cyc_List_List*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A)->f2)->hd)==1){_Tmp1B=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1A)->f2->tl;{struct Cyc_List_List*bnd=_Tmp1B;
# 858
goto _LL34;}}else{goto _LL37;}}else{goto _LL37;}}else{goto _LL37;}}else{_LL37:
# 860
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat("`U and `RC shorthands override explicit aqual",sizeof(char),46U);_Tmp1D;});void*_Tmp1D[1];_Tmp1D[0]=& _Tmp1C;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1D,sizeof(void*),1));});}_LL34:;}
# 862
*aq=override_aq;}
# 864
Cyc_Tctyp_check_constrain_ptrbnd(loc,t,expected_kind);
...
goto _LL39;}}else{goto _LL3C;}}else{goto _LL3C;}}else{goto _LL3C;}}else{_LL3C:
# 879
 goto _LL39;}_LL39:;}
# 882
env=Cyc_Tctyp_i_check_type(env,& Cyc_Kinds_aqk,*aq,0,1);
({int _Tmp1A=Cyc_Tcutil_extract_const_from_typedef(env.loc,tqp->print_const,t1);tqp->real_const=_Tmp1A;});
# 887
({void*_Tmp1A=zt;Cyc_Unify_unify(_Tmp1A,Cyc_Tcutil_is_char_type(t1)?Cyc_Absyn_true_type: Cyc_Absyn_false_type);});{
int is_zero_terminated=Cyc_Absyn_type2bool(0,zt);
if(is_zero_terminated && !Cyc_Tcutil_admits_zero(t1))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("cannot have a pointer to zero-terminated ",sizeof(char),42U);_Tmp1B;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=2,_Tmp1C.f1=(void*)t1;_Tmp1C;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat(" elements",sizeof(char),10U);_Tmp1D;});void*_Tmp1D[3];_Tmp1D[0]=& _Tmp1A,_Tmp1D[1]=& _Tmp1B,_Tmp1D[2]=& _Tmp1C;Cyc_Warn_err2(loc,_tag_fat(_Tmp1D,sizeof(void*),3));});
# 893
if(!Cyc_Tcutil_is_cvar_type(*b)){
struct Cyc_Absyn_Exp*e=({void*_Tmp1A=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_Tmp1A,*b);});
if(e!=0){
struct _tuple13 _Tmp1A=Cyc_Evexp_eval_const_uint_exp(e);int _Tmp1B;unsigned _Tmp1C;_Tmp1C=_Tmp1A.f0;_Tmp1B=_Tmp1A.f1;{unsigned sz=_Tmp1C;int known=_Tmp1B;
if(is_zero_terminated &&(!known || sz < 1U))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("zero-terminated pointer cannot point to empty sequence",sizeof(char),55U);_Tmp1E;});void*_Tmp1E[1];_Tmp1E[0]=& _Tmp1D;Cyc_Warn_err2(loc,_tag_fat(_Tmp1E,sizeof(void*),1));});}}}
# 901
goto _LL3;}}case 9: _Tmp19=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_Tmp2)->f1;{struct Cyc_Absyn_Exp*e=_Tmp19;
# 906
({struct Cyc_Tcenv_Tenv*_Tmp1A=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp1A,0,e);});
if(!Cyc_Tcutil_coerce_uint_type(e))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("valueof_t requires an int expression",sizeof(char),37U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});
env=Cyc_Tctyp_i_check_type_level_exp(e,env);
goto _LL3;}case 11: _Tmp19=((struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_Tmp2)->f1;{struct Cyc_Absyn_Exp*e=_Tmp19;
# 915
({struct Cyc_Tcenv_Tenv*_Tmp1A=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp1A,0,e);});
goto _LL3;}case 5: _Tmp19=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.elt_type;_Tmp18=(struct Cyc_Absyn_Tqual*)&((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.tq;_Tmp16=(struct Cyc_Absyn_Exp**)&((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.num_elts;_Tmp15=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.zero_term;_Tmp10=((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_Tmp2)->f1.zt_loc;{void*t1=_Tmp19;struct Cyc_Absyn_Tqual*tqp=_Tmp18;struct Cyc_Absyn_Exp**eptr=_Tmp16;void*zt=_Tmp15;unsigned ztl=_Tmp10;
# 920
struct Cyc_Absyn_Exp*e=*eptr;
env=Cyc_Tctyp_i_check_type(env,& Cyc_Kinds_mk,t1,1,allow_abs_aggr);
({int _Tmp1A=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t1);tqp->real_const=_Tmp1A;});{
# 924
int is_zero_terminated=Cyc_Tcutil_force_type2bool(0,zt);
if(is_zero_terminated){
# 927
if(!Cyc_Tcutil_admits_zero(t1))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("cannot have a zero-terminated array of ",sizeof(char),40U);_Tmp1B;});struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_Typ_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=2,_Tmp1C.f1=(void*)t1;_Tmp1C;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat(" elements",sizeof(char),10U);_Tmp1D;});void*_Tmp1D[3];_Tmp1D[0]=& _Tmp1A,_Tmp1D[1]=& _Tmp1B,_Tmp1D[2]=& _Tmp1C;Cyc_Warn_err2(loc,_tag_fat(_Tmp1D,sizeof(void*),3));});}
# 932
if(e==0){
# 935
if(!is_zero_terminated)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("array bound defaults to 1 here",sizeof(char),31U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});
({struct Cyc_Absyn_Exp*_Tmp1A=e=Cyc_Absyn_uint_exp(1U,0U);*eptr=_Tmp1A;});}
# 939
({struct Cyc_Tcenv_Tenv*_Tmp1A=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp1A,0,e);});
if(!Cyc_Tcutil_coerce_uint_type(e))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("array bounds expression is not an unsigned int",sizeof(char),47U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});
env=Cyc_Tctyp_i_check_type_level_exp(e,env);{
struct _tuple13 _Tmp1A=Cyc_Evexp_eval_const_uint_exp(e);int _Tmp1B;unsigned _Tmp1C;_Tmp1C=_Tmp1A.f0;_Tmp1B=_Tmp1A.f1;{unsigned sz=_Tmp1C;int known=_Tmp1B;
# 945
if((is_zero_terminated && known)&& sz < 1U)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("zero terminated array cannot have zero elements",sizeof(char),48U);_Tmp1E;});void*_Tmp1E[1];_Tmp1E[0]=& _Tmp1D;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1E,sizeof(void*),1));});
# 948
if((known && sz < 1U)&& Cyc_Flags_tovc_r){
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("0-element arrays are supported only with gcc, changing to 1",sizeof(char),60U);_Tmp1E;});void*_Tmp1E[1];_Tmp1E[0]=& _Tmp1D;Cyc_Warn_warn2(loc,_tag_fat(_Tmp1E,sizeof(void*),1));});
({struct Cyc_Absyn_Exp*_Tmp1D=Cyc_Absyn_uint_exp(1U,0U);*eptr=_Tmp1D;});}
# 952
goto _LL3;}}}}case 6: _Tmp19=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.tvars;_Tmp18=(void**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.effect;_Tmp16=(struct Cyc_Absyn_Tqual*)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ret_tqual;_Tmp15=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ret_type;_Tmp14=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.args;_TmpF=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.c_varargs;_Tmp13=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.cyc_varargs;_Tmp12=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.qual_bnd;_Tmp11=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.attributes;_TmpE=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.checks_clause;_TmpD=(struct Cyc_AssnDef_ExistAssnFn**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.checks_assn;_TmpC=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.requires_clause;_TmpB=(struct Cyc_AssnDef_ExistAssnFn**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.requires_assn;_TmpA=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ensures_clause;_Tmp9=(struct Cyc_AssnDef_ExistAssnFn**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.ensures_assn;_Tmp8=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.throws_clause;_Tmp7=(struct Cyc_AssnDef_ExistAssnFn**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.throws_assn;_Tmp6=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.return_value;_Tmp5=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.arg_vardecls;_Tmp4=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp2)->f1.effconstr;{struct Cyc_List_List**btvs=_Tmp19;void**eff=_Tmp18;struct Cyc_Absyn_Tqual*rtq=_Tmp16;void*tr=_Tmp15;struct Cyc_List_List*args=_Tmp14;int c_vararg=_TmpF;struct Cyc_Absyn_VarargInfo*cyc_vararg=_Tmp13;struct Cyc_List_List**qb=(struct Cyc_List_List**)_Tmp12;struct Cyc_List_List*atts=_Tmp11;struct Cyc_Absyn_Exp*chk=_TmpE;struct Cyc_AssnDef_ExistAssnFn**chk_relns=(struct Cyc_AssnDef_ExistAssnFn**)_TmpD;struct Cyc_Absyn_Exp*req=_TmpC;struct Cyc_AssnDef_ExistAssnFn**req_relns=(struct Cyc_AssnDef_ExistAssnFn**)_TmpB;struct Cyc_Absyn_Exp*ens=_TmpA;struct Cyc_AssnDef_ExistAssnFn**ens_relns=(struct Cyc_AssnDef_ExistAssnFn**)_Tmp9;struct Cyc_Absyn_Exp*thrws=_Tmp8;struct Cyc_AssnDef_ExistAssnFn**thrws_relns=(struct Cyc_AssnDef_ExistAssnFn**)_Tmp7;struct Cyc_Absyn_Vardecl*return_vd=_Tmp6;struct Cyc_List_List*arg_vds=_Tmp5;struct Cyc_List_List*effc=_Tmp4;
# 961
int num_formats=0;
int is_cdecl=0;
int is_stdcall=0;
...
void*_Tmp1A=(void*)atts->hd;int _Tmp1B;int _Tmp1C;enum Cyc_Absyn_Format_Type _Tmp1D;switch(*((int*)_Tmp1A)){case 1:
 is_stdcall=1;goto _LL44;case 2:
 is_cdecl=1;goto _LL44;case 3:
 is_fastcall=1;goto _LL44;case 19: _Tmp1D=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_Tmp1A)->f1;_Tmp1C=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_Tmp1A)->f2;_Tmp1B=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_Tmp1A)->f3;{enum Cyc_Absyn_Format_Type fmttype=_Tmp1D;int i=_Tmp1C;int j=_Tmp1B;
# 974
++ num_formats;
ft=fmttype;
fmt_desc_arg=i;
...
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F;_Tmp1F.tag=0,_Tmp1F.f1=_tag_fat("bad function type attribute ",sizeof(char),29U);_Tmp1F;});struct Cyc_Warn_Attribute_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_Attribute_Warn_Warg_struct _Tmp20;_Tmp20.tag=10,_Tmp20.f1=(void*)atts->hd;_Tmp20;});void*_Tmp20[2];_Tmp20[0]=& _Tmp1E,_Tmp20[1]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),2));});}_LL44:;}
# 983
if((is_stdcall + is_cdecl)+ is_fastcall > 1)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("function can't have multiple calling conventions",sizeof(char),49U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});
if(num_formats > 1)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("function can't have multiple format attributes",sizeof(char),47U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});
# 990
Cyc_Tcutil_check_unique_tvars(loc,*btvs);
{struct Cyc_List_List*b=*btvs;for(0;b!=0;b=b->tl){
({int _Tmp1A=Cyc_Tcutil_new_tvar_id();((struct Cyc_Absyn_Tvar*)b->hd)->identity=_Tmp1A;});
({struct Cyc_List_List*_Tmp1A=Cyc_Tctyp_add_bound_tvar(env.kind_env,(struct Cyc_Absyn_Tvar*)b->hd);env.kind_env=_Tmp1A;});{
void*_Tmp1A=Cyc_Kinds_compress_kb(((struct Cyc_Absyn_Tvar*)b->hd)->kind);if(*((int*)_Tmp1A)==0){if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_Tmp1A)->f1)->kind==Cyc_Absyn_MemKind){
# 996
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=_tag_fat("function abstracts Mem type variable ",sizeof(char),38U);_Tmp1C;});struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=7,_Tmp1D.f1=(struct Cyc_Absyn_Tvar*)b->hd;_Tmp1D;});void*_Tmp1D[2];_Tmp1D[0]=& _Tmp1B,_Tmp1D[1]=& _Tmp1C;Cyc_Warn_err2(loc,_tag_fat(_Tmp1D,sizeof(void*),2));});goto _LL4F;}else{goto _LL52;}}else{_LL52:
 goto _LL4F;}_LL4F:;}}}{
# 1002
struct Cyc_Tctyp_CVTEnv new_env=({struct Cyc_Tctyp_CVTEnv _Tmp1A;_Tmp1A.loc=loc,_Tmp1A.te=te,_Tmp1A.kind_env=env.kind_env,_Tmp1A.fn_result=1,_Tmp1A.def_aliasable=1,_Tmp1A.inst_type_evar=0,_Tmp1A.generalize_evars=env.generalize_evars,_Tmp1A.allow_aqual_bounds=1,_Tmp1A.free_vars=0,_Tmp1A.free_evars=0,_Tmp1A.free_qualvars=0;_Tmp1A;});
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_mk,tr,1,1);
({int _Tmp1A=Cyc_Tcutil_extract_const_from_typedef(loc,rtq->print_const,tr);rtq->real_const=_Tmp1A;});
new_env.fn_result=0;
# 1010
...
void*aqt=({void*_Tmp1A=Cyc_Absyn_new_evar(& Cyc_Kinds_aqko,0);Cyc_Absyn_aqual_var_type(_Tmp1A,Cyc_Absyn_al_qual_type);});
# 1024
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_aqk,aqt,1,1);
({void*_Tmp1A=Cyc_Tcutil_promote_array(t,ptr_rgn,aqt,0);(*trip).f2=_Tmp1A;});}}}}}
# 1029
if(cyc_vararg!=0){
if(c_vararg)({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("both c_vararg and cyc_vararg",sizeof(char),29U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;({int(*_Tmp1C)(struct _fat_ptr)=(int(*)(struct _fat_ptr))Cyc_Warn_impos2;_Tmp1C;})(_tag_fat(_Tmp1B,sizeof(void*),1));});{
struct Cyc_Absyn_VarargInfo _Tmp1A=*cyc_vararg;int _Tmp1B;void*_Tmp1C;_Tmp1C=_Tmp1A.type;_Tmp1B=_Tmp1A.inject;{void*vt=_Tmp1C;int vi=_Tmp1B;
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_mk,vt,1,1);
({int _Tmp1D=Cyc_Tcutil_extract_const_from_typedef(loc,cyc_vararg->tq.print_const,vt);cyc_vararg->tq.real_const=_Tmp1D;});
# 1035
if(vi){
void*_Tmp1D=Cyc_Absyn_compress(vt);void*_Tmp1E;void*_Tmp1F;void*_Tmp20;if(*((int*)_Tmp1D)==4){_Tmp20=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1D)->f1.elt_type;_Tmp1F=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1D)->f1.ptr_atts.bounds;_Tmp1E=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1D)->f1.ptr_atts.zero_term;{void*et=_Tmp20;void*bs=_Tmp1F;void*zt=_Tmp1E;
# 1038
{void*_Tmp21=Cyc_Absyn_compress(et);if(*((int*)_Tmp21)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp21)->f1)==22){
# 1040
if(Cyc_Tcutil_force_type2bool(0,zt))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp22=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp23;_Tmp23.tag=0,_Tmp23.f1=_tag_fat("can't inject into a zeroterm pointer",sizeof(char),37U);_Tmp23;});void*_Tmp23[1];_Tmp23[0]=& _Tmp22;Cyc_Warn_err2(loc,_tag_fat(_Tmp23,sizeof(void*),1));});
if(!({void*_Tmp22=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_Tmp22,bs);})){
if(!Cyc_Tcutil_is_cvar_type(bs)|| !({
unsigned _Tmp22=loc;Cyc_BansheeIf_add_constraint(_Tmp22,({void*_Tmp23=bs;Cyc_BansheeIf_equality_constraint(_Tmp23,Cyc_Absyn_thinconst());}));}))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp22=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp23;_Tmp23.tag=0,_Tmp23.f1=_tag_fat("can't inject into a fat pointer to datatype",sizeof(char),44U);_Tmp23;});void*_Tmp23[1];_Tmp23[0]=& _Tmp22;Cyc_Warn_err2(loc,_tag_fat(_Tmp23,sizeof(void*),1));});}
# 1048
goto _LL5C;}else{goto _LL5F;}}else{_LL5F:
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp22=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp23;_Tmp23.tag=0,_Tmp23.f1=_tag_fat("can't inject a non-datatype type",sizeof(char),33U);_Tmp23;});void*_Tmp23[1];_Tmp23[0]=& _Tmp22;Cyc_Warn_err2(loc,_tag_fat(_Tmp23,sizeof(void*),1));});goto _LL5C;}_LL5C:;}
# 1051
goto _LL57;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp21=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp22;_Tmp22.tag=0,_Tmp22.f1=_tag_fat("expecting a datatype pointer type",sizeof(char),34U);_Tmp22;});void*_Tmp22[1];_Tmp22[0]=& _Tmp21;Cyc_Warn_err2(loc,_tag_fat(_Tmp22,sizeof(void*),1));});goto _LL57;}_LL57:;}}}}
# 1056
if(num_formats > 0){
...
# 1063
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("bad format descriptor",sizeof(char),22U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});else{
# 1066
struct _tuple9 _Tmp1A=*({struct _tuple9*(*_Tmp1B)(struct Cyc_List_List*,int)=(struct _tuple9*(*)(struct Cyc_List_List*,int))Cyc_List_nth;_Tmp1B;})(args,fmt_desc_arg - 1);void*_Tmp1B;_Tmp1B=_Tmp1A.f2;{void*t=_Tmp1B;
# 1068
{void*_Tmp1C=Cyc_Absyn_compress(t);void*_Tmp1D;void*_Tmp1E;if(*((int*)_Tmp1C)==4){_Tmp1E=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1C)->f1.elt_type;_Tmp1D=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1C)->f1.ptr_atts.bounds;{void*et=_Tmp1E;void*b=_Tmp1D;
# 1071
if(!Cyc_Tcutil_is_char_type(et))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("format descriptor is not a string",sizeof(char),34U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});else{
# 1074
if(!Cyc_Tcutil_is_cvar_type(b)){
struct Cyc_Absyn_Exp*e=({void*_Tmp1F=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_Tmp1F,b);});
if(e==0 && c_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("format descriptor is not a char * type",sizeof(char),39U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});else{
if(e!=0 && !c_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("format descriptor is not a char ? type",sizeof(char),39U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});}}else{
# 1082
if(c_vararg){
if(!({unsigned _Tmp1F=loc;Cyc_BansheeIf_add_constraint(_Tmp1F,({void*_Tmp20=_check_null(Cyc_Tcutil_ptrbnd_cvar_equivalent(b));Cyc_BansheeIf_equality_constraint(_Tmp20,
Cyc_Absyn_thinconst());}));}))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("format descriptor is not a char ? type",sizeof(char),39U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});}else{
# 1089
if(!({unsigned _Tmp1F=loc;Cyc_BansheeIf_add_constraint(_Tmp1F,({void*_Tmp20=_check_null(Cyc_Tcutil_ptrbnd_cvar_equivalent(b));Cyc_BansheeIf_equality_constraint(_Tmp20,
Cyc_Absyn_fatconst());}));}))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("format descriptor is not a char * type",sizeof(char),39U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});}}}
# 1096
goto _LL64;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat("format descriptor is not a string type",sizeof(char),39U);_Tmp20;});void*_Tmp20[1];_Tmp20[0]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),1));});goto _LL64;}_LL64:;}
# 1099
if(fmt_arg_start!=0 && !c_vararg){
# 1103
int problem;
{struct _tuple16 _Tmp1C=({struct _tuple16 _Tmp1D;_Tmp1D.f0=ft,({void*_Tmp1E=Cyc_Absyn_compress(Cyc_Tcutil_pointer_elt_type(_check_null(cyc_vararg)->type));_Tmp1D.f1=_Tmp1E;});_Tmp1D;});void*_Tmp1D;switch((int)_Tmp1C.f0){case Cyc_Absyn_Printf_ft: if(*((int*)_Tmp1C.f1)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1C.f1)->f1)==22){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1C.f1)->f1)->f1.KnownDatatype.tag==2){_Tmp1D=*((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1C.f1)->f1)->f1.KnownDatatype.val;{struct Cyc_Absyn_Datatypedecl*tud=_Tmp1D;
# 1106
problem=({struct _tuple1*_Tmp1E=tud->name;Cyc_Absyn_qvar_cmp(_Tmp1E,Cyc_Absyn_datatype_print_arg_qvar());})!=0;
goto _LL69;}}else{goto _LL6E;}}else{goto _LL6E;}}else{goto _LL6E;}case Cyc_Absyn_Scanf_ft: if(*((int*)_Tmp1C.f1)==0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1C.f1)->f1)==22){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1C.f1)->f1)->f1.KnownDatatype.tag==2){_Tmp1D=*((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp1C.f1)->f1)->f1.KnownDatatype.val;{struct Cyc_Absyn_Datatypedecl*tud=_Tmp1D;
# 1109
problem=({struct _tuple1*_Tmp1E=tud->name;Cyc_Absyn_qvar_cmp(_Tmp1E,Cyc_Absyn_datatype_scanf_arg_qvar());})!=0;
goto _LL69;}}else{goto _LL6E;}}else{goto _LL6E;}}else{goto _LL6E;}default: _LL6E:
# 1112
 problem=1;
goto _LL69;}_LL69:;}
# 1115
if(problem)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1C=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=_tag_fat("format attribute and vararg types don't match",sizeof(char),46U);_Tmp1D;});void*_Tmp1D[1];_Tmp1D[0]=& _Tmp1C;Cyc_Warn_err2(loc,_tag_fat(_Tmp1D,sizeof(void*),1));});}}}}
# 1121
{struct Cyc_List_List*qbit=*qb;for(0;qbit!=0;qbit=qbit->tl){
struct _tuple0*_Tmp1A=(struct _tuple0*)qbit->hd;void*_Tmp1B;void*_Tmp1C;_Tmp1C=_Tmp1A->f0;_Tmp1B=_Tmp1A->f1;{void*tv=_Tmp1C;void*bnd=_Tmp1B;
...
void*_Tmp1A=(void*)ec->hd;void*_Tmp1B;void*_Tmp1C;switch(*((int*)_Tmp1A)){case 0: _Tmp1C=(void*)((struct Cyc_Absyn_SingleConstraint_Absyn_EffConstraint_struct*)_Tmp1A)->f1;{void*t=_Tmp1C;
# 1130
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Kinds_ek,t,1,1);
goto _LL73;}case 1: _Tmp1C=(void*)((struct Cyc_Absyn_DisjointConstraint_Absyn_EffConstraint_struct*)_Tmp1A)->f1;_Tmp1B=(void*)((struct Cyc_Absyn_DisjointConstraint_Absyn_EffConstraint_struct*)_Tmp1A)->f2;{void*t1=_Tmp1C;void*t2=_Tmp1B;
_Tmp1C=t1;_Tmp1B=t2;goto _LL79;}default: _Tmp1C=(void*)((struct Cyc_Absyn_SubsetConstraint_Absyn_EffConstraint_struct*)_Tmp1A)->f1;_Tmp1B=(void*)((struct Cyc_Absyn_SubsetConstraint_Absyn_EffConstraint_struct*)_Tmp1A)->f2;_LL79: {void*t1=_Tmp1C;void*t2=_Tmp1B;
# 1134
...
({struct Cyc_Tcenv_Tenv*_Tmp1A=({struct Cyc_Tcenv_Tenv*_Tmp1B=_cycalloc(sizeof(struct Cyc_Tcenv_Tenv));_Tmp1B->ns=te->ns,_Tmp1B->ae=te->ae,_Tmp1B->le=fenv,_Tmp1B->allow_valueof=1,_Tmp1B->in_extern_c_include=te->in_extern_c_include,_Tmp1B->in_tempest=te->in_tempest,_Tmp1B->tempest_generalize=te->tempest_generalize,_Tmp1B->in_extern_c_inc_repeat=te->in_extern_c_inc_repeat;_Tmp1B;});new_env.te=_Tmp1A;});{
# 1149
struct Cyc_List_List*vds;vds=_cycalloc(sizeof(struct Cyc_List_List)),vds->hd=Cyc_AssnDef_memory,vds->tl=arg_vds;
if(chk!=0){
if(c_vararg ||(unsigned)cyc_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1A=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=_tag_fat("we do not yet support @checks on vararg functions",sizeof(char),50U);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Warn_err2(loc,_tag_fat(_Tmp1B,sizeof(void*),1));});{
struct _tuple15 _Tmp1A=Cyc_Tctyp_check_clause(new_env,_tag_fat("@checks",sizeof(char),8U),chk);struct Cyc_AssnDef_AssnMap _Tmp1B;struct Cyc_Tctyp_CVTEnv _Tmp1C;_Tmp1C=_Tmp1A.f0;_Tmp1B=_Tmp1A.f1;{struct Cyc_Tctyp_CVTEnv nenv=_Tmp1C;struct Cyc_AssnDef_AssnMap chk_assn=_Tmp1B;
new_env=nenv;
({struct Cyc_AssnDef_ExistAssnFn*_Tmp1D=Cyc_AssnDef_assnmap2existassnfn(chk_assn,vds);*chk_relns=_Tmp1D;});}}}
# 1157
if(req!=0){
struct _tuple15 _Tmp1A=Cyc_Tctyp_check_clause(new_env,_tag_fat("@requires",sizeof(char),10U),req);struct Cyc_AssnDef_AssnMap _Tmp1B;struct Cyc_Tctyp_CVTEnv _Tmp1C;_Tmp1C=_Tmp1A.f0;_Tmp1B=_Tmp1A.f1;{struct Cyc_Tctyp_CVTEnv nenv=_Tmp1C;struct Cyc_AssnDef_AssnMap req_assn=_Tmp1B;
new_env=nenv;
({struct Cyc_AssnDef_ExistAssnFn*_Tmp1D=Cyc_AssnDef_assnmap2existassnfn(req_assn,vds);*req_relns=_Tmp1D;});}}{
# 1163
struct Cyc_List_List*vds;vds=_cycalloc(sizeof(struct Cyc_List_List)),vds->hd=Cyc_AssnDef_memory,({struct Cyc_List_List*_Tmp1A=({struct Cyc_List_List*_Tmp1B=_cycalloc(sizeof(struct Cyc_List_List));_Tmp1B->hd=Cyc_AssnDef_pre_memory,_Tmp1B->tl=arg_vds;_Tmp1B;});vds->tl=_Tmp1A;});
if(ens!=0){
struct _tuple15 _Tmp1A=Cyc_Tctyp_check_clause(new_env,_tag_fat("@ensures",sizeof(char),9U),ens);struct Cyc_AssnDef_AssnMap _Tmp1B;struct Cyc_Tctyp_CVTEnv _Tmp1C;_Tmp1C=_Tmp1A.f0;_Tmp1B=_Tmp1A.f1;{struct Cyc_Tctyp_CVTEnv nenv=_Tmp1C;struct Cyc_AssnDef_AssnMap ens_assn=_Tmp1B;
new_env=nenv;
({struct Cyc_AssnDef_ExistAssnFn*_Tmp1D=({struct Cyc_AssnDef_AssnMap _Tmp1E=ens_assn;Cyc_AssnDef_assnmap2existassnfn(_Tmp1E,({struct Cyc_List_List*_Tmp1F=_cycalloc(sizeof(struct Cyc_List_List));_Tmp1F->hd=return_vd,_Tmp1F->tl=vds;_Tmp1F;}));});*ens_relns=_Tmp1D;});}}
# 1169
if(thrws!=0){
struct _tuple15 _Tmp1A=Cyc_Tctyp_check_clause(new_env,_tag_fat("@throws",sizeof(char),8U),thrws);struct Cyc_AssnDef_AssnMap _Tmp1B;struct Cyc_Tctyp_CVTEnv _Tmp1C;_Tmp1C=_Tmp1A.f0;_Tmp1B=_Tmp1A.f1;{struct Cyc_Tctyp_CVTEnv nenv=_Tmp1C;struct Cyc_AssnDef_AssnMap thrws_assn=_Tmp1B;
new_env=nenv;
({struct Cyc_AssnDef_ExistAssnFn*_Tmp1D=Cyc_AssnDef_assnmap2existassnfn(thrws_assn,vds);*thrws_relns=_Tmp1D;});}}
# 1174
new_env.te=old_te;
# 1176
if(*eff!=0){
...
({void*_Tmp1A=Cyc_Tcutil_normalize_effect(Cyc_Absyn_join_eff(({void*_Tmp1B[2];_Tmp1B[0]=Cyc_Absyn_heap_rgn_type,_Tmp1B[1]=_check_null(*eff);Cyc_List_list(_tag_fat(_Tmp1B,sizeof(void*),2));})));*eff=_Tmp1A;});}else{
# 1183
...
struct _tuple12 _Tmp1A=*((struct _tuple12*)tvs->hd);int _Tmp1B;void*_Tmp1C;_Tmp1C=_Tmp1A.f0;_Tmp1B=_Tmp1A.f1;{struct Cyc_Absyn_Tvar*tv=_Tmp1C;int put_in_eff=_Tmp1B;
if(!put_in_eff)continue;{
void*_Tmp1D=Cyc_Kinds_compress_kb(tv->kind);void*_Tmp1E;switch(*((int*)_Tmp1D)){case 2: switch((int)((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp1D)->f2)->kind){case Cyc_Absyn_BoolKind:
 goto _LL8D;case Cyc_Absyn_PtrBndKind: _LL8D:
 goto _LL8F;case Cyc_Absyn_IntKind: _LL8F:
 goto _LL91;case Cyc_Absyn_AqualKind: _LL91:
 goto _LL93;case Cyc_Absyn_EffKind: _Tmp1E=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp1D)->f1;{struct Cyc_Core_Opt**f=_Tmp1E;
# 1201
({struct Cyc_Core_Opt*_Tmp1F=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_ek);*f=_Tmp1F;});goto _LL9D;}default: goto _LLA0;}case 0: switch((int)((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_Tmp1D)->f1)->kind){case Cyc_Absyn_BoolKind: _LL93:
# 1196
 goto _LL95;case Cyc_Absyn_PtrBndKind: _LL95:
 goto _LL97;case Cyc_Absyn_IntKind: _LL97:
 goto _LL99;case Cyc_Absyn_AqualKind: _LL99:
 goto _LL89;case Cyc_Absyn_EffKind: _LL9D:
# 1203
 effect=({struct Cyc_List_List*_Tmp1F=_cycalloc(sizeof(struct Cyc_List_List));({void*_Tmp20=Cyc_Absyn_var_type(tv);_Tmp1F->hd=_Tmp20;}),_Tmp1F->tl=effect;_Tmp1F;});goto _LL89;default: _LLA0: _LLA1:
# 1208
 effect=({struct Cyc_List_List*_Tmp1F=_cycalloc(sizeof(struct Cyc_List_List));({void*_Tmp20=Cyc_Absyn_regionsof_eff(Cyc_Absyn_var_type(tv));_Tmp1F->hd=_Tmp20;}),_Tmp1F->tl=effect;_Tmp1F;});goto _LL89;}default: _Tmp1E=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_Tmp1D)->f1;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp1E;
# 1205
({struct Cyc_Core_Opt*_Tmp1F=({struct Cyc_Core_Opt*_Tmp20=_cycalloc(sizeof(struct Cyc_Core_Opt));({void*_Tmp21=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_Tmp22=_cycalloc(sizeof(struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct));_Tmp22->tag=2,_Tmp22->f1=0,_Tmp22->f2=& Cyc_Kinds_ak;_Tmp22;});_Tmp20->v=_Tmp21;});_Tmp20;});*f=_Tmp1F;});goto _LLA1;}}_LL89:;}}}}
# 1212
{struct Cyc_List_List*ts=new_env.free_evars;for(0;ts!=0;ts=ts->tl){
struct _tuple14 _Tmp1A=*((struct _tuple14*)ts->hd);int _Tmp1B;void*_Tmp1C;_Tmp1C=_Tmp1A.f0;_Tmp1B=_Tmp1A.f1;{void*tv=_Tmp1C;int put_in_eff=_Tmp1B;
if(!put_in_eff)continue;{
struct Cyc_Absyn_Kind*_Tmp1D=Cyc_Tcutil_type_kind(tv);switch((int)((struct Cyc_Absyn_Kind*)_Tmp1D)->kind){case Cyc_Absyn_IntKind:
# 1217
 goto _LLA9;case Cyc_Absyn_BoolKind: _LLA9:
 goto _LLAB;case Cyc_Absyn_PtrBndKind: _LLAB:
 goto _LLAD;case Cyc_Absyn_AqualKind: _LLAD:
# 1221
 goto _LLA5;case Cyc_Absyn_EffKind:
 effect=({struct Cyc_List_List*_Tmp1E=_cycalloc(sizeof(struct Cyc_List_List));_Tmp1E->hd=tv,_Tmp1E->tl=effect;_Tmp1E;});goto _LLA5;default:
 effect=({struct Cyc_List_List*_Tmp1E=_cycalloc(sizeof(struct Cyc_List_List));({void*_Tmp1F=Cyc_Absyn_regionsof_eff(tv);_Tmp1E->hd=_Tmp1F;}),_Tmp1E->tl=effect;_Tmp1E;});goto _LLA5;}_LLA5:;}}}}
# 1226
({void*_Tmp1A=Cyc_Absyn_join_eff(effect);*eff=_Tmp1A;});}
# 1232
if(*btvs!=0){
struct Cyc_List_List*bs=*btvs;for(0;bs!=0;bs=bs->tl){
void*_Tmp1A=Cyc_Kinds_compress_kb(((struct Cyc_Absyn_Tvar*)bs->hd)->kind);void*_Tmp1B;void*_Tmp1C;switch(*((int*)_Tmp1A)){case 1: _Tmp1C=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_Tmp1A)->f1;{struct Cyc_Core_Opt**f=_Tmp1C;
# 1236
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("type variable ",sizeof(char),15U);_Tmp1E;});struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp1E=({struct Cyc_Warn_Tvar_Warn_Warg_struct _Tmp1F;_Tmp1F.tag=7,_Tmp1F.f1=(struct Cyc_Absyn_Tvar*)bs->hd;_Tmp1F;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp20;_Tmp20.tag=0,_Tmp20.f1=_tag_fat(" unconstrained, assuming boxed",sizeof(char),31U);_Tmp20;});void*_Tmp20[3];_Tmp20[0]=& _Tmp1D,_Tmp20[1]=& _Tmp1E,_Tmp20[2]=& _Tmp1F;Cyc_Warn_warn2(loc,_tag_fat(_Tmp20,sizeof(void*),3));});
({struct Cyc_Core_Opt*_Tmp1D=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_bk);*f=_Tmp1D;});
goto _LLB2;}case 2: _Tmp1C=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp1A)->f1;_Tmp1B=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_Tmp1A)->f2;{struct Cyc_Core_Opt**f=(struct Cyc_Core_Opt**)_Tmp1C;struct Cyc_Absyn_Kind*k=_Tmp1B;
# 1240
switch((int)((struct Cyc_Absyn_Kind*)k)->kind){case Cyc_Absyn_BoxKind:
 goto _LLBF;case Cyc_Absyn_MemKind: _LLBF:
 goto _LLC1;case Cyc_Absyn_AnyKind: _LLC1:
# 1244
({struct Cyc_Core_Opt*_Tmp1D=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_bk);*f=_Tmp1D;});goto _LLBB;case Cyc_Absyn_EffKind:
# 1246
({struct Cyc_Core_Opt*_Tmp1D=Cyc_Kinds_kind_to_bound_opt(& Cyc_Kinds_ek);*f=_Tmp1D;});goto _LLBB;default:
# 1248
({struct Cyc_Core_Opt*_Tmp1D=Cyc_Kinds_kind_to_bound_opt(k);*f=_Tmp1D;});goto _LLBB;}_LLBB:;
# 1250
goto _LLB2;}default: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_Tmp1A)->f1)->kind==Cyc_Absyn_MemKind){
# 1252
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1D=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=_tag_fat("functions can't abstract M types",sizeof(char),33U);_Tmp1E;});void*_Tmp1E[1];_Tmp1E[0]=& _Tmp1D;Cyc_Warn_err2(loc,_tag_fat(_Tmp1E,sizeof(void*),1));});goto _LLB2;}else{
goto _LLB2;}}_LLB2:;}}
# 1256
({struct Cyc_List_List*_Tmp1A=({struct Cyc_List_List*(*_Tmp1B)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*))=(struct Cyc_List_List*(*)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*)))Cyc_Tctyp_remove_bound_tvars;_Tmp1B;})(new_env.kind_env,*btvs,({struct Cyc_Absyn_Tvar*(*_Tmp1B)(struct Cyc_Absyn_Tvar*)=(struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*))Cyc_Core_identity;_Tmp1B;}));env.kind_env=_Tmp1A;});
({struct Cyc_List_List*_Tmp1A=({struct Cyc_List_List*(*_Tmp1B)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct _tuple12*))=(struct Cyc_List_List*(*)(struct Cyc_List_List*,struct Cyc_List_List*,struct Cyc_Absyn_Tvar*(*)(struct _tuple12*)))Cyc_Tctyp_remove_bound_tvars;_Tmp1B;})(new_env.free_vars,*btvs,({struct Cyc_Absyn_Tvar*(*_Tmp1B)(struct _tuple12*)=(struct Cyc_Absyn_Tvar*(*)(struct _tuple12*))Cyc_Core_fst;_Tmp1B;}));new_env.free_vars=_Tmp1A;});
# 1259
{struct Cyc_List_List*tvs=new_env.free_vars;for(0;tvs!=0;tvs=tvs->tl){
struct _tuple12 _Tmp1A=*((struct _tuple12*)tvs->hd);int _Tmp1B;void*_Tmp1C;_Tmp1C=_Tmp1A.f0;_Tmp1B=_Tmp1A.f1;{struct Cyc_Absyn_Tvar*t=_Tmp1C;int b=_Tmp1B;
({struct Cyc_List_List*_Tmp1D=Cyc_Tctyp_fast_add_free_tvar_bool(env.free_vars,t,b);env.free_vars=_Tmp1D;});}}}
# 1264
{struct Cyc_List_List*evs=new_env.free_evars;for(0;evs!=0;evs=evs->tl){
struct _tuple14 _Tmp1A=*((struct _tuple14*)evs->hd);int _Tmp1B;void*_Tmp1C;_Tmp1C=_Tmp1A.f0;_Tmp1B=_Tmp1A.f1;{void*e=_Tmp1C;int b=_Tmp1B;
({struct Cyc_List_List*_Tmp1D=Cyc_Tctyp_add_free_evar(env.free_evars,e,b);env.free_evars=_Tmp1D;});}}}
# 1268
if((unsigned)env.free_qualvars){
# 1270
struct Cyc_List_List*it=new_env.free_qualvars;for(0;it!=0;it=it->tl){
if(!({int(*_Tmp1A)(int(*)(struct _tuple14*,struct _tuple14*),struct _tuple14*,struct Cyc_List_List*)=(int(*)(int(*)(struct _tuple14*,struct _tuple14*),struct _tuple14*,struct Cyc_List_List*))Cyc_List_exists_c;_Tmp1A;})(Cyc_Tctyp_cmp_fqv,(struct _tuple14*)it->hd,env.free_qualvars))
({struct Cyc_List_List*_Tmp1A=({struct Cyc_List_List*_Tmp1B=_cycalloc(sizeof(struct Cyc_List_List));_Tmp1B->hd=(struct _tuple14*)it->hd,_Tmp1B->tl=env.free_qualvars;_Tmp1B;});env.free_qualvars=_Tmp1A;});}}else{
# 1276
env.free_qualvars=new_env.free_qualvars;}
goto _LL3;}}}}}case 7: _Tmp3=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp2)->f1;_TmpF=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp2)->f2;_Tmp19=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_Tmp2)->f3;{enum Cyc_Absyn_AggrKind k=_Tmp3;int is_tuple=_TmpF;struct Cyc_List_List*fs=_Tmp19;
# 1281
struct Cyc_List_List*prev_fields=0;
for(1;fs!=0;fs=fs->tl){
struct Cyc_Absyn_Aggrfield*_Tmp1A=(struct Cyc_Absyn_Aggrfield*)fs->hd;void*_Tmp1B;void*_Tmp1C;void*_Tmp1D;void*_Tmp1E;void*_Tmp1F;void*_Tmp20;_Tmp20=_Tmp1A->name;_Tmp1F=(struct Cyc_Absyn_Tqual*)& _Tmp1A->tq;_Tmp1E=_Tmp1A->type;_Tmp1D=_Tmp1A->width;_Tmp1C=_Tmp1A->attributes;_Tmp1B=_Tmp1A->requires_clause;{struct _fat_ptr*fn=_Tmp20;struct Cyc_Absyn_Tqual*tqp=(struct Cyc_Absyn_Tqual*)_Tmp1F;void*t=_Tmp1E;struct Cyc_Absyn_Exp*width=_Tmp1D;struct Cyc_List_List*atts=_Tmp1C;struct Cyc_Absyn_Exp*requires_clause=_Tmp1B;
if(({int(*_Tmp21)(int(*)(struct _fat_ptr*,struct _fat_ptr*),struct Cyc_List_List*,struct _fat_ptr*)=(int(*)(int(*)(struct _fat_ptr*,struct _fat_ptr*),struct Cyc_List_List*,struct _fat_ptr*))Cyc_List_mem;_Tmp21;})(Cyc_strptrcmp,prev_fields,fn))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp21=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp22;_Tmp22.tag=0,_Tmp22.f1=_tag_fat("duplicate field ",sizeof(char),17U);_Tmp22;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp22=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp23;_Tmp23.tag=0,_Tmp23.f1=*fn;_Tmp23;});void*_Tmp23[2];_Tmp23[0]=& _Tmp21,_Tmp23[1]=& _Tmp22;Cyc_Warn_err2(loc,_tag_fat(_Tmp23,sizeof(void*),2));});
if(Cyc_strcmp(*fn,_tag_fat("",sizeof(char),1U))!=0)
prev_fields=({struct Cyc_List_List*_Tmp21=_cycalloc(sizeof(struct Cyc_List_List));_Tmp21->hd=fn,_Tmp21->tl=prev_fields;_Tmp21;});
env=Cyc_Tctyp_i_check_type(env,& Cyc_Kinds_mk,t,1,0);
({int _Tmp21=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t);tqp->real_const=_Tmp21;});
Cyc_Tcutil_check_bitfield(loc,t,width,fn);
Cyc_Atts_check_field_atts(loc,fn,atts);
if(requires_clause!=0){
# 1294
if((int)k!=1)
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp21=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp22;_Tmp22.tag=0,_Tmp22.f1=_tag_fat("@requires clause is only allowed on union members",sizeof(char),50U);_Tmp22;});void*_Tmp22[1];_Tmp22[0]=& _Tmp21;Cyc_Warn_err2(loc,_tag_fat(_Tmp22,sizeof(void*),1));});
({struct Cyc_Tcenv_Tenv*_Tmp21=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_Tmp21,0,requires_clause);});
if(!Cyc_Tcutil_is_integral(requires_clause))
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp21=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp22;_Tmp22.tag=0,_Tmp22.f1=_tag_fat("@requires clause has type ",sizeof(char),27U);_Tmp22;});struct Cyc_Warn_TypOpt_Warn_Warg_struct _Tmp22=({struct Cyc_Warn_TypOpt_Warn_Warg_struct _Tmp23;_Tmp23.tag=3,_Tmp23.f1=(void*)requires_clause->topt;_Tmp23;});struct Cyc_Warn_String_Warn_Warg_struct _Tmp23=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp24;_Tmp24.tag=0,_Tmp24.f1=
_tag_fat(" instead of integral type",sizeof(char),26U);_Tmp24;});void*_Tmp24[3];_Tmp24[0]=& _Tmp21,_Tmp24[1]=& _Tmp22,_Tmp24[2]=& _Tmp23;Cyc_Warn_err2(loc,_tag_fat(_Tmp24,sizeof(void*),3));});
env=Cyc_Tctyp_i_check_type_level_exp(requires_clause,env);}}}
# 1303
goto _LL3;}default: _Tmp19=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f1;_Tmp18=(struct Cyc_List_List**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f2;_Tmp16=(struct Cyc_Absyn_Typedefdecl**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f3;_Tmp15=(void**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_Tmp2)->f4;{struct _tuple1*tdn=_Tmp19;struct Cyc_List_List**targs_ref=(struct Cyc_List_List**)_Tmp18;struct Cyc_Absyn_Typedefdecl**tdopt=(struct Cyc_Absyn_Typedefdecl**)_Tmp16;void**toptp=(void**)_Tmp15;
# 1307
struct Cyc_Absyn_Typedefdecl*td;
{struct _handler_cons _Tmp1A;_push_handler(& _Tmp1A);{int _Tmp1B=0;if(setjmp(_Tmp1A.handler))_Tmp1B=1;if(!_Tmp1B){td=Cyc_Tcenv_lookup_typedefdecl(te,loc,tdn);;_pop_handler();}else{void*_Tmp1C=(void*)Cyc_Core_get_exn_thrown();void*_Tmp1D;if(((struct Cyc_Dict_Absent_exn_struct*)_Tmp1C)->tag==Cyc_Dict_Absent){
# 1311
({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1E=({struct Cyc_Warn_String_Warn_Warg_struct _Tmp1F;_Tmp1F.tag=0,_Tmp1F.f1=_tag_fat("unbound typedef name ",sizeof(char),22U);_Tmp1F;});struct Cyc_Warn_Qvar_Warn_Warg_struct _Tmp1F=({struct Cyc_Warn_Qvar_Warn_Warg_struct _Tmp20;_Tmp20.tag=1,_Tmp20.f1=tdn;_Tmp20;});void*_Tmp20[2];_Tmp20[0]=& _Tmp1E,_Tmp20[1]=& _Tmp1F;Cyc_Warn_err2(loc,_tag_fat(_Tmp20,sizeof(void*),2));});
return env;}else{_Tmp1D=_Tmp1C;{void*exn=_Tmp1D;_rethrow(exn);}};}}}
# 1314
*tdopt=td;
env=Cyc_Tctyp_check_type_inst(env,targs_ref,td->tvs,expected_kind,allow_abs_aggr,tdn,td);
# 1317
if(td->defn!=0){
Cyc_Tctyp_check_constrain_ptrbnd(loc,td->defn,expected_kind);{
struct Cyc_List_List*inst=0;
struct Cyc_List_List*tvs=td->tvs;
struct Cyc_List_List*ts=*targs_ref;
for(1;tvs!=0;(tvs=tvs->tl,ts=ts->tl)){
inst=({struct Cyc_List_List*_Tmp1A=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple17*_Tmp1B=({struct _tuple17*_Tmp1C=_cycalloc(sizeof(struct _tuple17));_Tmp1C->f0=(struct Cyc_Absyn_Tvar*)tvs->hd,_Tmp1C->f1=(void*)_check_null(ts)->hd;_Tmp1C;});_Tmp1A->hd=_Tmp1B;}),_Tmp1A->tl=inst;_Tmp1A;});}
({void*_Tmp1A=Cyc_Tcutil_substitute(inst,_check_null(td->defn));*toptp=_Tmp1A;});}}
# 1326
goto _LL3;}}_LL3:;}
# 1328
...
{void*_Tmp0=Cyc_Absyn_compress(t);void*_Tmp1;void*_Tmp2;if(*((int*)_Tmp0)==6){_Tmp2=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp0)->f1.tvars;_Tmp1=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp0)->f1.qual_bnd;{struct Cyc_List_List**btvs=(struct Cyc_List_List**)_Tmp2;struct Cyc_List_List**qb=(struct Cyc_List_List**)_Tmp1;
# 1421
...
# 1437
void*_Tmp0=Cyc_Absyn_compress(t);void*_Tmp1;if(*((int*)_Tmp0)==6){_Tmp1=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp0)->f1.tvars;{struct Cyc_List_List*btvs=_Tmp1;
# 1439
...
{void*_Tmp0=Cyc_Absyn_compress(t);struct Cyc_Absyn_FnInfo _Tmp1;if(*((int*)_Tmp0)==6){_Tmp1=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp0)->f1;{struct Cyc_Absyn_FnInfo i=_Tmp1;
# 1457
