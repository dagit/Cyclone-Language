...
goto _LL8;}}else{_LLB: _LLC:
 goto _LL8;}_LL8:;}}}
# 104
return({struct Cyc_List_List*_tmpB=_cycalloc(sizeof(*_tmpB));({struct _tuple13*_tmp31A=({struct _tuple13*_tmpA=_cycalloc(sizeof(*_tmpA));_tmpA->f1=e,_tmpA->f2=b;_tmpA;});_tmpB->hd=_tmp31A;}),_tmpB->tl=es;_tmpB;});}}else{_LL3: _LL4:
 return es;}_LL0:;}
# 110
static struct Cyc_List_List*Cyc_Tctyp_add_bound_tvar(struct Cyc_List_List*tvs,struct Cyc_Absyn_Tvar*tv){
if(tv->identity == - 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp293;_tmp293.tag=0U,({struct _fat_ptr _tmp31B=({const char*_tmp11="bound tvar id for ";_tag_fat(_tmp11,sizeof(char),19U);});_tmp293.f1=_tmp31B;});_tmp293;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmpE=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp292;_tmp292.tag=7U,_tmp292.f1=tv;_tmp292;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp291;_tmp291.tag=0U,({struct _fat_ptr _tmp31C=({const char*_tmp10=" is NULL";_tag_fat(_tmp10,sizeof(char),9U);});_tmp291.f1=_tmp31C;});_tmp291;});void*_tmpC[3U];_tmpC[0]=& _tmpD,_tmpC[1]=& _tmpE,_tmpC[2]=& _tmpF;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpC,sizeof(void*),3U));});
...
for(0;b != 0;b=b->tl){
if(({int _tmp31D=(get(tvs->hd))->identity;_tmp31D == ((struct Cyc_Absyn_Tvar*)b->hd)->identity;}))
break;}
if(b == 0)
...
# 151
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp297;_tmp297.tag=0U,({struct _fat_ptr _tmp31E=({const char*_tmp23="hidden type variable ";_tag_fat(_tmp23,sizeof(char),22U);});_tmp297.f1=_tmp31E;});_tmp297;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1F=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp296;_tmp296.tag=2U,_tmp296.f1=(void*)e;_tmp296;});struct Cyc_Warn_String_Warn_Warg_struct _tmp20=({struct Cyc_Warn_String_Warn_Warg_struct _tmp295;_tmp295.tag=0U,({struct _fat_ptr _tmp31F=({const char*_tmp22=" isn't abstracted in type ";_tag_fat(_tmp22,sizeof(char),27U);});_tmp295.f1=_tmp31F;});_tmp295;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp21=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp294;_tmp294.tag=2U,_tmp294.f1=(void*)in_typ;_tmp294;});void*_tmp1D[4U];_tmp1D[0]=& _tmp1E,_tmp1D[1]=& _tmp1F,_tmp1D[2]=& _tmp20,_tmp1D[3]=& _tmp21;({unsigned _tmp320=loc;Cyc_Warn_err2(_tmp320,_tag_fat(_tmp1D,sizeof(void*),4U));});});
return;}_LL5:;}
# 154
if(!Cyc_Unify_unify(e,t))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp25=({struct Cyc_Warn_String_Warn_Warg_struct _tmp29C;_tmp29C.tag=0U,({struct _fat_ptr _tmp321=({const char*_tmp2C="can't unify evar ";_tag_fat(_tmp2C,sizeof(char),18U);});_tmp29C.f1=_tmp321;});_tmp29C;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp26=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp29B;_tmp29B.tag=2U,_tmp29B.f1=(void*)e;_tmp29B;});struct Cyc_Warn_String_Warn_Warg_struct _tmp27=({struct Cyc_Warn_String_Warn_Warg_struct _tmp29A;_tmp29A.tag=0U,({struct _fat_ptr _tmp322=({const char*_tmp2B=" with ";_tag_fat(_tmp2B,sizeof(char),7U);});_tmp29A.f1=_tmp322;});_tmp29A;});struct Cyc_Warn_String_Warn_Warg_struct _tmp28=({struct Cyc_Warn_String_Warn_Warg_struct _tmp299;_tmp299.tag=0U,_tmp299.f1=s;_tmp299;});struct Cyc_Warn_String_Warn_Warg_struct _tmp29=({struct Cyc_Warn_String_Warn_Warg_struct _tmp298;_tmp298.tag=0U,({struct _fat_ptr _tmp323=({const char*_tmp2A="!";_tag_fat(_tmp2A,sizeof(char),2U);});_tmp298.f1=_tmp323;});_tmp298;});void*_tmp24[5U];_tmp24[0]=& _tmp25,_tmp24[1]=& _tmp26,_tmp24[2]=& _tmp27,_tmp24[3]=& _tmp28,_tmp24[4]=& _tmp29;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp24,sizeof(void*),5U));});}}}
# 163
static int Cyc_Tctyp_constrain_kinds(void*c1,void*c2){
c1=Cyc_Absyn_compress_kb(c1);
c2=Cyc_Absyn_compress_kb(c2);
if(c1 == c2)return 1;{
struct _tuple0 _tmp2D=({struct _tuple0 _tmp29D;_tmp29D.f1=c1,_tmp29D.f2=c2;_tmp29D;});struct _tuple0 _stmttmp5=_tmp2D;struct _tuple0 _tmp2E=_stmttmp5;struct Cyc_Absyn_Kind*_tmp32;struct Cyc_Core_Opt**_tmp31;struct Cyc_Absyn_Kind*_tmp30;struct Cyc_Core_Opt**_tmp2F;struct Cyc_Absyn_Kind*_tmp35;struct Cyc_Absyn_Kind*_tmp34;struct Cyc_Core_Opt**_tmp33;struct Cyc_Core_Opt**_tmp36;struct Cyc_Core_Opt**_tmp37;struct Cyc_Absyn_Kind*_tmp3A;struct Cyc_Core_Opt**_tmp39;struct Cyc_Absyn_Kind*_tmp38;struct Cyc_Absyn_Kind*_tmp3C;struct Cyc_Absyn_Kind*_tmp3B;if(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp2E.f1)->tag == 0U)switch(*((int*)_tmp2E.f2)){case 0U: _LL1: _tmp3B=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp2E.f1)->f1;_tmp3C=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp2E.f2)->f1;_LL2: {struct Cyc_Absyn_Kind*k1=_tmp3B;struct Cyc_Absyn_Kind*k2=_tmp3C;
...
return 0;
({struct Cyc_Core_Opt*_tmp324=({struct Cyc_Core_Opt*_tmp40=_cycalloc(sizeof(*_tmp40));_tmp40->v=c1;_tmp40;});*f=_tmp324;});
...
# 169
({struct Cyc_Core_Opt*_tmp325=({struct Cyc_Core_Opt*_tmp3D=_cycalloc(sizeof(*_tmp3D));_tmp3D->v=c1;_tmp3D;});*f=_tmp325;});return 1;}}else{if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp2E.f1)->tag == 1U){_LL5: _tmp36=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp2E.f1)->f1;_LL6: {struct Cyc_Core_Opt**f=_tmp36;
({struct Cyc_Core_Opt*_tmp326=({struct Cyc_Core_Opt*_tmp3E=_cycalloc(sizeof(*_tmp3E));_tmp3E->v=c2;_tmp3E;});*f=_tmp326;});return 1;}}else{if(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp2E.f2)->tag == 0U){_LL7: _tmp33=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp2E.f1)->f1;_tmp34=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp2E.f1)->f2;_tmp35=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp2E.f2)->f1;_LL8: {struct Cyc_Core_Opt**f=_tmp33;struct Cyc_Absyn_Kind*k1=_tmp34;struct Cyc_Absyn_Kind*k2=_tmp35;
# 172
if(!Cyc_Tcutil_kind_leq(k2,k1))
return 0;
({struct Cyc_Core_Opt*_tmp327=({struct Cyc_Core_Opt*_tmp3F=_cycalloc(sizeof(*_tmp3F));_tmp3F->v=c2;_tmp3F;});*f=_tmp327;});
...
# 182
if(Cyc_Tcutil_kind_leq(k1,k2)){
({struct Cyc_Core_Opt*_tmp328=({struct Cyc_Core_Opt*_tmp41=_cycalloc(sizeof(*_tmp41));_tmp41->v=c1;_tmp41;});*f2=_tmp328;});
return 1;}
# 186
if(Cyc_Tcutil_kind_leq(k2,k1)){
({struct Cyc_Core_Opt*_tmp329=({struct Cyc_Core_Opt*_tmp42=_cycalloc(sizeof(*_tmp42));_tmp42->v=c2;_tmp42;});*f1=_tmp329;});
return 1;}
# 190
return 0;}}}}}_LL0:;}}
# 199
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp44=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2A3;_tmp2A3.tag=0U,({struct _fat_ptr _tmp32A=({const char*_tmp4C="type variable ";_tag_fat(_tmp4C,sizeof(char),15U);});_tmp2A3.f1=_tmp32A;});_tmp2A3;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp45=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp2A2;_tmp2A2.tag=7U,_tmp2A2.f1=tv;_tmp2A2;});struct Cyc_Warn_String_Warn_Warg_struct _tmp46=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2A1;_tmp2A1.tag=0U,({struct _fat_ptr _tmp32B=({const char*_tmp4B=" used with inconsistent kinds ";_tag_fat(_tmp4B,sizeof(char),31U);});_tmp2A1.f1=_tmp32B;});_tmp2A1;});struct Cyc_Warn_KindBound_Warn_Warg_struct _tmp47=({struct Cyc_Warn_KindBound_Warn_Warg_struct _tmp2A0;_tmp2A0.tag=8U,_tmp2A0.f1=(void*)k1;_tmp2A0;});struct Cyc_Warn_String_Warn_Warg_struct _tmp48=({struct Cyc_Warn_String_Warn_Warg_struct _tmp29F;_tmp29F.tag=0U,({
struct _fat_ptr _tmp32C=({const char*_tmp4A=" and ";_tag_fat(_tmp4A,sizeof(char),6U);});_tmp29F.f1=_tmp32C;});_tmp29F;});struct Cyc_Warn_KindBound_Warn_Warg_struct _tmp49=({struct Cyc_Warn_KindBound_Warn_Warg_struct _tmp29E;_tmp29E.tag=8U,_tmp29E.f1=(void*)k2;_tmp29E;});void*_tmp43[6U];_tmp43[0]=& _tmp44,_tmp43[1]=& _tmp45,_tmp43[2]=& _tmp46,_tmp43[3]=& _tmp47,_tmp43[4]=& _tmp48,_tmp43[5]=& _tmp49;({unsigned _tmp32D=loc;Cyc_Warn_err2(_tmp32D,_tag_fat(_tmp43,sizeof(void*),6U));});});
if(tv->identity == - 1)
tv->identity=((struct Cyc_Absyn_Tvar*)tvs2->hd)->identity;else{
if(tv->identity != ((struct Cyc_Absyn_Tvar*)tvs2->hd)->identity)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2A4;_tmp2A4.tag=0U,({struct _fat_ptr _tmp32E=({const char*_tmp4F="same type variable has different identity!";_tag_fat(_tmp4F,sizeof(char),43U);});_tmp2A4.f1=_tmp32E;});_tmp2A4;});void*_tmp4D[1U];_tmp4D[0]=& _tmp4E;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp4D,sizeof(void*),1U));});}
return tvs;}}}
# 213
({int _tmp32F=Cyc_Tcutil_new_tvar_id();tv->identity=_tmp32F;});
...
if(tv->identity == - 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp52=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2A5;_tmp2A5.tag=0U,({struct _fat_ptr _tmp330=({const char*_tmp53="fast_add_free_tvar: bad identity in tv";_tag_fat(_tmp53,sizeof(char),39U);});_tmp2A5.f1=_tmp330;});_tmp2A5;});void*_tmp51[1U];_tmp51[0]=& _tmp52;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp51,sizeof(void*),1U));});
{struct Cyc_List_List*tvs2=tvs;for(0;tvs2 != 0;tvs2=tvs2->tl){
struct Cyc_Absyn_Tvar*_tmp54=(struct Cyc_Absyn_Tvar*)tvs2->hd;struct Cyc_Absyn_Tvar*tv2=_tmp54;
if(tv2->identity == - 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp56=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2A6;_tmp2A6.tag=0U,({struct _fat_ptr _tmp331=({const char*_tmp57="fast_add_free_tvar: bad identity in tvs2";_tag_fat(_tmp57,sizeof(char),41U);});_tmp2A6.f1=_tmp331;});_tmp2A6;});void*_tmp55[1U];_tmp55[0]=& _tmp56;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp55,sizeof(void*),1U));});
...
if(tv->identity == - 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2A7;_tmp2A7.tag=0U,({struct _fat_ptr _tmp332=({const char*_tmp5B="fast_add_free_tvar_bool: bad identity in tv";_tag_fat(_tmp5B,sizeof(char),44U);});_tmp2A7.f1=_tmp332;});_tmp2A7;});void*_tmp59[1U];_tmp59[0]=& _tmp5A;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp59,sizeof(void*),1U));});
{struct Cyc_List_List*tvs2=tvs;for(0;tvs2 != 0;tvs2=tvs2->tl){
...
if(tv2->identity == - 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp61=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2A8;_tmp2A8.tag=0U,({struct _fat_ptr _tmp333=({const char*_tmp62="fast_add_free_tvar_bool: bad identity in tvs2";_tag_fat(_tmp62,sizeof(char),46U);});_tmp2A8.f1=_tmp333;});_tmp2A8;});void*_tmp60[1U];_tmp60[0]=& _tmp61;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp60,sizeof(void*),1U));});
if(tv2->identity == tv->identity){
*b2=*b2 || b;
return tvs;}}}}
# 247
return({struct Cyc_List_List*_tmp64=_cycalloc(sizeof(*_tmp64));({struct _tuple14*_tmp334=({struct _tuple14*_tmp63=_cycalloc(sizeof(*_tmp63));_tmp63->f1=tv,_tmp63->f2=b;_tmp63;});_tmp64->hd=_tmp334;}),_tmp64->tl=tvs;_tmp64;});}
# 254
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp79=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2A9;_tmp2A9.tag=0U,({struct _fat_ptr _tmp335=({const char*_tmp7A="bad expression in Tctyp::i_check_type_level_exp";_tag_fat(_tmp7A,sizeof(char),48U);});_tmp2A9.f1=_tmp335;});_tmp2A9;});void*_tmp78[1U];_tmp78[0]=& _tmp79;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp78,sizeof(void*),1U));});}_LL0:;}
# 286
return env;}
# 289
...
# 338
{struct _tuple0 _tmp85=({struct _tuple0 _tmp2AA;({void*_tmp336=Cyc_Absyn_compress_kb(tv->kind);_tmp2AA.f1=_tmp336;}),_tmp2AA.f2=t;_tmp2AA;});struct _tuple0 _stmttmpB=_tmp85;struct _tuple0 _tmp86=_stmttmpB;struct Cyc_Absyn_Tvar*_tmp87;if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp86.f1)->tag == 1U){if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp86.f2)->tag == 2U){_LL1: _tmp87=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp86.f2)->f1;_LL2: {struct Cyc_Absyn_Tvar*tv2=_tmp87;
# 340
({struct Cyc_List_List*_tmp337=Cyc_Tctyp_add_free_tvar(env.loc,env.kind_env,tv2);env.kind_env=_tmp337;});
({struct Cyc_List_List*_tmp338=Cyc_Tctyp_fast_add_free_tvar_bool(env.free_vars,tv2,1);env.free_vars=_tmp338;});
...
# 349
if(targs != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp89=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2AC;_tmp2AC.tag=0U,({struct _fat_ptr _tmp339=({const char*_tmp8B="too many type arguments for ";_tag_fat(_tmp8B,sizeof(char),29U);});_tmp2AC.f1=_tmp339;});_tmp2AC;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp8A=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2AB;_tmp2AB.tag=1U,_tmp2AB.f1=typname;_tmp2AB;});void*_tmp88[2U];_tmp88[0]=& _tmp89,_tmp88[1]=& _tmp8A;({unsigned _tmp33A=env.loc;Cyc_Warn_err2(_tmp33A,_tag_fat(_tmp88,sizeof(void*),2U));});});{
# 352
...
# 359
({struct Cyc_List_List*_tmp33C=({struct Cyc_List_List*_tmp33B=*targsp;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmp33B,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(hidden_ts));});*targsp=_tmp33C;});
...
# 367
if(clause == 0)
return({struct _tuple15 _tmp2AD;_tmp2AD.f1=env,_tmp2AD.f2=0;_tmp2AD;});
Cyc_Tcexp_tcExp(env.te,0,clause);
if(!Cyc_Tcutil_is_integral(clause))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp8E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2B1;_tmp2B1.tag=0U,_tmp2B1.f1=clause_name;_tmp2B1;});struct Cyc_Warn_String_Warn_Warg_struct _tmp8F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2B0;_tmp2B0.tag=0U,({struct _fat_ptr _tmp33D=({const char*_tmp93=" clause has type ";_tag_fat(_tmp93,sizeof(char),18U);});_tmp2B0.f1=_tmp33D;});_tmp2B0;});struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp90=({struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp2AF;_tmp2AF.tag=3U,_tmp2AF.f1=(void*)clause->topt;_tmp2AF;});struct Cyc_Warn_String_Warn_Warg_struct _tmp91=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2AE;_tmp2AE.tag=0U,({
struct _fat_ptr _tmp33E=({const char*_tmp92=" instead of integral type";_tag_fat(_tmp92,sizeof(char),26U);});_tmp2AE.f1=_tmp33E;});_tmp2AE;});void*_tmp8D[4U];_tmp8D[0]=& _tmp8E,_tmp8D[1]=& _tmp8F,_tmp8D[2]=& _tmp90,_tmp8D[3]=& _tmp91;({unsigned _tmp33F=env.loc;Cyc_Warn_err2(_tmp33F,_tag_fat(_tmp8D,sizeof(void*),4U));});});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp96=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2B5;_tmp2B5.tag=0U,_tmp2B5.f1=clause_name;_tmp2B5;});struct Cyc_Warn_String_Warn_Warg_struct _tmp97=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2B4;_tmp2B4.tag=0U,({struct _fat_ptr _tmp340=({const char*_tmp9B=" clause '";_tag_fat(_tmp9B,sizeof(char),10U);});_tmp2B4.f1=_tmp340;});_tmp2B4;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp98=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp2B3;_tmp2B3.tag=4U,_tmp2B3.f1=clause;_tmp2B3;});struct Cyc_Warn_String_Warn_Warg_struct _tmp99=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2B2;_tmp2B2.tag=0U,({struct _fat_ptr _tmp341=({const char*_tmp9A="' may be unsatisfiable";_tag_fat(_tmp9A,sizeof(char),23U);});_tmp2B2.f1=_tmp341;});_tmp2B2;});void*_tmp95[4U];_tmp95[0]=& _tmp96,_tmp95[1]=& _tmp97,_tmp95[2]=& _tmp98,_tmp95[3]=& _tmp99;({unsigned _tmp342=clause->loc;Cyc_Warn_err2(_tmp342,_tag_fat(_tmp95,sizeof(void*),4U));});});
return({struct _tuple15 _tmp2B6;_tmp2B6.f1=env,_tmp2B6.f2=relns;_tmp2B6;});}}
# 381
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpAA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2BA;_tmp2BA.tag=0U,({struct _fat_ptr _tmp343=({const char*_tmpAF="expecting struct ";_tag_fat(_tmpAF,sizeof(char),18U);});_tmp2BA.f1=_tmp343;});_tmp2BA;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpAB=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2B9;_tmp2B9.tag=1U,_tmp2B9.f1=n;_tmp2B9;});struct Cyc_Warn_String_Warn_Warg_struct _tmpAC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2B8;_tmp2B8.tag=0U,({struct _fat_ptr _tmp344=({const char*_tmpAE="instead of union ";_tag_fat(_tmpAE,sizeof(char),18U);});_tmp2B8.f1=_tmp344;});_tmp2B8;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpAD=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2B7;_tmp2B7.tag=1U,_tmp2B7.f1=n;_tmp2B7;});void*_tmpA9[4U];_tmpA9[0]=& _tmpAA,_tmpA9[1]=& _tmpAB,_tmpA9[2]=& _tmpAC,_tmpA9[3]=& _tmpAD;({unsigned _tmp345=loc;Cyc_Warn_err2(_tmp345,_tag_fat(_tmpA9,sizeof(void*),4U));});});else{
# 395
({struct Cyc_Warn_String_Warn_Warg_struct _tmpB1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2BE;_tmp2BE.tag=0U,({struct _fat_ptr _tmp346=({const char*_tmpB6="expecting union ";_tag_fat(_tmpB6,sizeof(char),17U);});_tmp2BE.f1=_tmp346;});_tmp2BE;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpB2=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2BD;_tmp2BD.tag=1U,_tmp2BD.f1=n;_tmp2BD;});struct Cyc_Warn_String_Warn_Warg_struct _tmpB3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2BC;_tmp2BC.tag=0U,({struct _fat_ptr _tmp347=({const char*_tmpB5="instead of struct ";_tag_fat(_tmpB5,sizeof(char),19U);});_tmp2BC.f1=_tmp347;});_tmp2BC;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpB4=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2BB;_tmp2BB.tag=1U,_tmp2BB.f1=n;_tmp2BB;});void*_tmpB0[4U];_tmpB0[0]=& _tmpB1,_tmpB0[1]=& _tmpB2,_tmpB0[2]=& _tmpB3,_tmpB0[3]=& _tmpB4;({unsigned _tmp348=loc;Cyc_Warn_err2(_tmp348,_tag_fat(_tmpB0,sizeof(void*),4U));});});}}
# 397
if(((unsigned)tgd &&(int)tgd->v)&&(!((unsigned)ad->impl)|| !((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->tagged))
({struct Cyc_Warn_String_Warn_Warg_struct _tmpB8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C0;_tmp2C0.tag=0U,({struct _fat_ptr _tmp349=({const char*_tmpBA="@tagged qualfiers don't agree on union ";_tag_fat(_tmpBA,sizeof(char),40U);});_tmp2C0.f1=_tmp349;});_tmp2C0;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpB9=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2BF;_tmp2BF.tag=1U,_tmp2BF.f1=n;_tmp2BF;});void*_tmpB7[2U];_tmpB7[0]=& _tmpB8,_tmpB7[1]=& _tmpB9;({unsigned _tmp34A=loc;Cyc_Warn_err2(_tmp34A,_tag_fat(_tmpB7,sizeof(void*),2U));});});
# 400
({union Cyc_Absyn_AggrInfo _tmp34B=Cyc_Absyn_KnownAggr(adp);*info=_tmp34B;});}
# 389
...
# 404
({struct Cyc_Tcenv_Tenv*_tmp34D=te;unsigned _tmp34C=loc;Cyc_Tc_tcAggrdecl(_tmp34D,_tmp34C,({struct Cyc_Absyn_Aggrdecl*_tmpBD=_cycalloc(sizeof(*_tmpBD));_tmpBD->kind=k,_tmpBD->sc=Cyc_Absyn_Extern,_tmpBD->name=n,_tmpBD->tvs=0,_tmpBD->impl=0,_tmpBD->attributes=0,_tmpBD->expected_mem_kind=0;_tmpBD;}));});
adp=Cyc_Tcenv_lookup_aggrdecl(te,loc,n);
({union Cyc_Absyn_AggrInfo _tmp34E=Cyc_Absyn_KnownAggr(adp);*info=_tmp34E;});
# 408
if(*targs != 0){
({struct Cyc_Warn_String_Warn_Warg_struct _tmpBF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C3;_tmp2C3.tag=0U,({struct _fat_ptr _tmp34F=({const char*_tmpC3="declare parameterized type ";_tag_fat(_tmpC3,sizeof(char),28U);});_tmp2C3.f1=_tmp34F;});_tmp2C3;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpC0=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2C2;_tmp2C2.tag=1U,_tmp2C2.f1=n;_tmp2C2;});struct Cyc_Warn_String_Warn_Warg_struct _tmpC1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C1;_tmp2C1.tag=0U,({struct _fat_ptr _tmp350=({const char*_tmpC2=" before using";_tag_fat(_tmpC2,sizeof(char),14U);});_tmp2C1.f1=_tmp350;});_tmp2C1;});void*_tmpBE[3U];_tmpBE[0]=& _tmpBF,_tmpBE[1]=& _tmpC0,_tmpBE[2]=& _tmpC1;({unsigned _tmp351=loc;Cyc_Warn_err2(_tmp351,_tag_fat(_tmpBE,sizeof(void*),3U));});});
return env;}
# 412
...
# 439
({struct Cyc_Tcenv_Tenv*_tmp353=te;unsigned _tmp352=loc;Cyc_Tc_tcDatatypedecl(_tmp353,_tmp352,({struct Cyc_Absyn_Datatypedecl*_tmpD2=_cycalloc(sizeof(*_tmpD2));_tmpD2->sc=Cyc_Absyn_Extern,_tmpD2->name=n,_tmpD2->tvs=0,_tmpD2->fields=0,_tmpD2->is_extensible=is_x;_tmpD2;}));});
tudp=Cyc_Tcenv_lookup_datatypedecl(te,loc,n);
# 442
if(targs != 0){
({struct Cyc_Warn_String_Warn_Warg_struct _tmpD4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C6;_tmp2C6.tag=0U,({struct _fat_ptr _tmp354=({const char*_tmpD8="declare parameterized datatype ";_tag_fat(_tmpD8,sizeof(char),32U);});_tmp2C6.f1=_tmp354;});_tmp2C6;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpD5=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2C5;_tmp2C5.tag=1U,_tmp2C5.f1=n;_tmp2C5;});struct Cyc_Warn_String_Warn_Warg_struct _tmpD6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C4;_tmp2C4.tag=0U,({struct _fat_ptr _tmp355=({const char*_tmpD7=" before using";_tag_fat(_tmpD7,sizeof(char),14U);});_tmp2C4.f1=_tmp355;});_tmp2C4;});void*_tmpD3[3U];_tmpD3[0]=& _tmpD4,_tmpD3[1]=& _tmpD5,_tmpD3[2]=& _tmpD6;({unsigned _tmp356=loc;Cyc_Warn_err2(_tmp356,_tag_fat(_tmpD3,sizeof(void*),3U));});});
return env;}
# 446
goto _LL8;}else{_LLB: _tmpD1=_tmpD0;_LLC: {void*exn=_tmpD1;(int)_rethrow(exn);}}_LL8:;}}}
# 450
if(is_x && !(*tudp)->is_extensible)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpDA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C9;_tmp2C9.tag=0U,({struct _fat_ptr _tmp357=({const char*_tmpDE="datatype ";_tag_fat(_tmpDE,sizeof(char),10U);});_tmp2C9.f1=_tmp357;});_tmp2C9;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpDB=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2C8;_tmp2C8.tag=1U,_tmp2C8.f1=n;_tmp2C8;});struct Cyc_Warn_String_Warn_Warg_struct _tmpDC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C7;_tmp2C7.tag=0U,({struct _fat_ptr _tmp358=({const char*_tmpDD=" was not declared @extensible";_tag_fat(_tmpDD,sizeof(char),30U);});_tmp2C7.f1=_tmp358;});_tmp2C7;});void*_tmpD9[3U];_tmpD9[0]=& _tmpDA,_tmpD9[1]=& _tmpDB,_tmpD9[2]=& _tmpDC;({unsigned _tmp359=loc;Cyc_Warn_err2(_tmp359,_tag_fat(_tmpD9,sizeof(void*),3U));});});
({union Cyc_Absyn_DatatypeInfo _tmp35A=Cyc_Absyn_KnownDatatype(tudp);*info=_tmp35A;});
...
if(fs == 0)({struct Cyc_Warn_String_Warn_Warg_struct _tmpE8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2CA;_tmp2CA.tag=0U,({struct _fat_ptr _tmp35B=({const char*_tmpE9="Tcutil found a bad datatypefield";_tag_fat(_tmpE9,sizeof(char),33U);});_tmp2CA.f1=_tmp35B;});_tmp2CA;});void*_tmpE7[1U];_tmpE7[0]=& _tmpE8;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpE7,sizeof(void*),1U));});
if(Cyc_Absyn_qvar_cmp(((struct Cyc_Absyn_Datatypefield*)fs->hd)->name,fname)== 0){
tuf=(struct Cyc_Absyn_Datatypefield*)fs->hd;
break;}}}
# 479
({union Cyc_Absyn_DatatypeFieldInfo _tmp35C=Cyc_Absyn_KnownDatatypefield(tud,tuf);*info=_tmp35C;});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpEB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2CC;_tmp2CC.tag=0U,_tmp2CC.f1=s;_tmp2CC;});struct Cyc_Warn_String_Warn_Warg_struct _tmpEC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2CB;_tmp2CB.tag=0U,({struct _fat_ptr _tmp35D=({const char*_tmpED=" has wrong number of arguments";_tag_fat(_tmpED,sizeof(char),31U);});_tmp2CB.f1=_tmp35D;});_tmp2CB;});void*_tmpEA[2U];_tmpEA[0]=& _tmpEB,_tmpEA[1]=& _tmpEC;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpEA,sizeof(void*),2U));});
...
# 505
 if(ts != 0)
({struct Cyc_Warn_Typ_Warn_Warg_struct _tmpFA=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2CE;_tmp2CE.tag=2U,({typeof((void*)((void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmpFD=_cycalloc(sizeof(*_tmpFD));_tmpFD->tag=0U,_tmpFD->f1=c,_tmpFD->f2=ts;_tmpFD;})))_tmp35E=(void*)((void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmpFD=_cycalloc(sizeof(*_tmpFD));_tmpFD->tag=0U,_tmpFD->f1=c,_tmpFD->f2=ts;_tmpFD;}));_tmp2CE.f1=_tmp35E;});_tmp2CE;});struct Cyc_Warn_String_Warn_Warg_struct _tmpFB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2CD;_tmp2CD.tag=0U,({struct _fat_ptr _tmp35F=({const char*_tmpFC=" applied to argument(s)";_tag_fat(_tmpFC,sizeof(char),24U);});_tmp2CD.f1=_tmp35F;});_tmp2CD;});void*_tmpF9[2U];_tmpF9[0]=& _tmpFA,_tmpF9[1]=& _tmpFB;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpF9,sizeof(void*),2U));});
...
# 513
if(ts != 0)({struct Cyc_Warn_String_Warn_Warg_struct _tmpFF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2CF;_tmp2CF.tag=0U,({struct _fat_ptr _tmp360=({const char*_tmp100="enum applied to argument(s)";_tag_fat(_tmp100,sizeof(char),28U);});_tmp2CF.f1=_tmp360;});_tmp2CF;});void*_tmpFE[1U];_tmpFE[0]=& _tmpFF;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmpFE,sizeof(void*),1U));});
if(*edp == 0 ||((struct Cyc_Absyn_Enumdecl*)_check_null(*edp))->fields == 0){
struct _handler_cons _tmp101;_push_handler(& _tmp101);{int _tmp103=0;if(setjmp(_tmp101.handler))_tmp103=1;if(!_tmp103){({struct Cyc_Absyn_Enumdecl*_tmp361=*Cyc_Tcenv_lookup_enumdecl(te,loc,n);*edp=_tmp361;});;_pop_handler();}else{void*_tmp102=(void*)Cyc_Core_get_exn_thrown();void*_tmp104=_tmp102;void*_tmp105;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp104)->tag == Cyc_Dict_Absent){_LL2F: _LL30:
# 517
({struct Cyc_Tcenv_Tenv*_tmp363=te;unsigned _tmp362=loc;Cyc_Tc_tcEnumdecl(_tmp363,_tmp362,({struct Cyc_Absyn_Enumdecl*_tmp106=_cycalloc(sizeof(*_tmp106));_tmp106->sc=Cyc_Absyn_Extern,_tmp106->name=n,_tmp106->fields=0;_tmp106;}));});
({struct Cyc_Absyn_Enumdecl*_tmp364=*Cyc_Tcenv_lookup_enumdecl(te,loc,n);*edp=_tmp364;});
...
# 524
if(ts != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp108=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D0;_tmp2D0.tag=0U,({struct _fat_ptr _tmp365=({const char*_tmp109="enum applied to argument(s)";_tag_fat(_tmp109,sizeof(char),28U);});_tmp2D0.f1=_tmp365;});_tmp2D0;});void*_tmp107[1U];_tmp107[0]=& _tmp108;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp107,sizeof(void*),1U));});{
# 527
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp10C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D2;_tmp2D2.tag=0U,({struct _fat_ptr _tmp366=({const char*_tmp10E="duplicate enum field name ";_tag_fat(_tmp10E,sizeof(char),27U);});_tmp2D2.f1=_tmp366;});_tmp2D2;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp10D=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2D1;_tmp2D1.tag=1U,_tmp2D1.f1=f->name;_tmp2D1;});void*_tmp10B[2U];_tmp10B[0]=& _tmp10C,_tmp10B[1]=& _tmp10D;({unsigned _tmp367=f->loc;Cyc_Warn_err2(_tmp367,_tag_fat(_tmp10B,sizeof(void*),2U));});});else{
# 534
prev_fields=({struct Cyc_List_List*_tmp10F=_cycalloc(sizeof(*_tmp10F));_tmp10F->hd=(*f->name).f2,_tmp10F->tl=prev_fields;_tmp10F;});}
if(f->tag == 0)
({struct Cyc_Absyn_Exp*_tmp368=Cyc_Absyn_uint_exp(tag_count,f->loc);f->tag=_tmp368;});else{
if(!Cyc_Tcutil_is_const_exp((struct Cyc_Absyn_Exp*)_check_null(f->tag)))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp111=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D5;_tmp2D5.tag=0U,({struct _fat_ptr _tmp369=({const char*_tmp115="enum field ";_tag_fat(_tmp115,sizeof(char),12U);});_tmp2D5.f1=_tmp369;});_tmp2D5;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp112=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2D4;_tmp2D4.tag=1U,_tmp2D4.f1=f->name;_tmp2D4;});struct Cyc_Warn_String_Warn_Warg_struct _tmp113=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D3;_tmp2D3.tag=0U,({struct _fat_ptr _tmp36A=({const char*_tmp114=": expression is not constant";_tag_fat(_tmp114,sizeof(char),29U);});_tmp2D3.f1=_tmp36A;});_tmp2D3;});void*_tmp110[3U];_tmp110[0]=& _tmp111,_tmp110[1]=& _tmp112,_tmp110[2]=& _tmp113;({unsigned _tmp36B=loc;Cyc_Warn_err2(_tmp36B,_tag_fat(_tmp110,sizeof(void*),3U));});});}
...
return env;}}case 10U: _LL1E: _LL1F:
 return({struct Cyc_Tctyp_CVTEnv _tmp36D=env;struct Cyc_List_List*_tmp36C=ts;Cyc_Tctyp_i_check_unary_app(_tmp36D,& Cyc_Tcutil_tak,_tmp36C,1,({const char*_tmp116="regions";_tag_fat(_tmp116,sizeof(char),8U);}));});case 3U: _LL20: _LL21:
 return({struct Cyc_Tctyp_CVTEnv _tmp36F=env;struct Cyc_List_List*_tmp36E=ts;Cyc_Tctyp_i_check_unary_app(_tmp36F,& Cyc_Tcutil_trk,_tmp36E,1,({const char*_tmp117="region_t";_tag_fat(_tmp117,sizeof(char),9U);}));});case 8U: _LL22: _LL23:
 return({struct Cyc_Tctyp_CVTEnv _tmp371=env;struct Cyc_List_List*_tmp370=ts;Cyc_Tctyp_i_check_unary_app(_tmp371,& Cyc_Tcutil_trk,_tmp370,1,({const char*_tmp118="access";_tag_fat(_tmp118,sizeof(char),7U);}));});case 4U: _LL24: _LL25:
 return({struct Cyc_Tctyp_CVTEnv _tmp373=env;struct Cyc_List_List*_tmp372=ts;Cyc_Tctyp_i_check_unary_app(_tmp373,& Cyc_Tcutil_ik,_tmp372,0,({const char*_tmp119="tag_t";_tag_fat(_tmp119,sizeof(char),6U);}));});case 13U: _LL26: _LL27:
 return({struct Cyc_Tctyp_CVTEnv _tmp375=env;struct Cyc_List_List*_tmp374=ts;Cyc_Tctyp_i_check_unary_app(_tmp375,& Cyc_Tcutil_ik,_tmp374,0,({const char*_tmp11A="@thin";_tag_fat(_tmp11A,sizeof(char),6U);}));});case 20U: _LL28: _tmpF5=(union Cyc_Absyn_AggrInfo*)&((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_tmpF2)->f1;_LL29: {union Cyc_Absyn_AggrInfo*info=_tmpF5;
# 548
...
({struct Cyc_Core_Opt*_tmp376=Cyc_Tcutil_kind_to_opt(expected_kind);*k=_tmp376;});
...
({void*_tmp377=Cyc_Absyn_var_type(v);*ref=_tmp377;});
_tmp143=v;goto _LL9;}else{
# 583
({struct Cyc_List_List*_tmp378=Cyc_Tctyp_add_free_evar(env.free_evars,t,put_in_effect);env.free_evars=_tmp378;});}}
# 585
...
({struct Cyc_Core_Opt*_tmp37A=({struct Cyc_Core_Opt*_tmp14E=_cycalloc(sizeof(*_tmp14E));({void*_tmp379=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp14D=_cycalloc(sizeof(*_tmp14D));_tmp14D->tag=2U,_tmp14D->f1=0,_tmp14D->f2=expected_kind;_tmp14D;});_tmp14E->v=_tmp379;});_tmp14E;});*f=_tmp37A;});goto _LL1C;}}else{_LL1F: _LL20:
 goto _LL1C;}_LL1C:;}
# 593
({struct Cyc_List_List*_tmp37B=Cyc_Tctyp_add_free_tvar(loc,env.kind_env,v);env.kind_env=_tmp37B;});
# 596
({struct Cyc_List_List*_tmp37C=Cyc_Tctyp_fast_add_free_tvar_bool(env.free_vars,v,put_in_effect);env.free_vars=_tmp37C;});
# 598
...
({struct Cyc_Core_Opt*_tmp37E=({struct Cyc_Core_Opt*_tmp154=_cycalloc(sizeof(*_tmp154));({void*_tmp37D=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp153=_cycalloc(sizeof(*_tmp153));_tmp153->tag=2U,_tmp153->f1=0,_tmp153->f2=expected_kind;_tmp153;});_tmp154->v=_tmp37D;});_tmp154;});*f=_tmp37E;});
...
# 623
({void**_tmp37F=({void**_tmp159=_cycalloc(sizeof(*_tmp159));*_tmp159=new_typ;_tmp159;});*topt=_tmp37F;});
...
# 640
({int _tmp380=Cyc_Tcutil_extract_const_from_typedef(env.loc,tqp->print_const,t1);tqp->real_const=_tmp380;});
# 644
({void*_tmp381=zt;Cyc_Unify_unify(_tmp381,Cyc_Tcutil_is_char_type(t1)?Cyc_Absyn_true_type: Cyc_Absyn_false_type);});{
int is_zero_terminated=Cyc_Absyn_type2bool(0,zt);
if(is_zero_terminated && !Cyc_Tcutil_admits_zero(t1))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp15D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D8;_tmp2D8.tag=0U,({struct _fat_ptr _tmp382=({const char*_tmp161="cannot have a pointer to zero-terminated ";_tag_fat(_tmp161,sizeof(char),42U);});_tmp2D8.f1=_tmp382;});_tmp2D8;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp15E=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2D7;_tmp2D7.tag=2U,_tmp2D7.f1=(void*)t1;_tmp2D7;});struct Cyc_Warn_String_Warn_Warg_struct _tmp15F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D6;_tmp2D6.tag=0U,({struct _fat_ptr _tmp383=({const char*_tmp160=" elements";_tag_fat(_tmp160,sizeof(char),10U);});_tmp2D6.f1=_tmp383;});_tmp2D6;});void*_tmp15C[3U];_tmp15C[0]=& _tmp15D,_tmp15C[1]=& _tmp15E,_tmp15C[2]=& _tmp15F;({unsigned _tmp384=loc;Cyc_Warn_err2(_tmp384,_tag_fat(_tmp15C,sizeof(void*),3U));});});{
# 650
struct Cyc_Absyn_Exp*_tmp162=({void*_tmp385=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp385,b);});struct Cyc_Absyn_Exp*e=_tmp162;
if(e != 0){
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp168=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D9;_tmp2D9.tag=0U,({struct _fat_ptr _tmp386=({const char*_tmp169="zero-terminated pointer cannot point to empty sequence";_tag_fat(_tmp169,sizeof(char),55U);});_tmp2D9.f1=_tmp386;});_tmp2D9;});void*_tmp167[1U];_tmp167[0]=& _tmp168;({unsigned _tmp387=loc;Cyc_Warn_err2(_tmp387,_tag_fat(_tmp167,sizeof(void*),1U));});});}}
# 656
...
# 661
({struct Cyc_Tcenv_Tenv*_tmp388=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmp388,0,e);});
if(!Cyc_Tcutil_coerce_uint_type(e))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp16B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2DA;_tmp2DA.tag=0U,({struct _fat_ptr _tmp389=({const char*_tmp16C="valueof_t requires an int expression";_tag_fat(_tmp16C,sizeof(char),37U);});_tmp2DA.f1=_tmp389;});_tmp2DA;});void*_tmp16A[1U];_tmp16A[0]=& _tmp16B;({unsigned _tmp38A=loc;Cyc_Warn_err2(_tmp38A,_tag_fat(_tmp16A,sizeof(void*),1U));});});
...
# 670
({struct Cyc_Tcenv_Tenv*_tmp38B=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmp38B,0,e);});
...
({int _tmp38C=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t1);tqp->real_const=_tmp38C;});{
# 679
int is_zero_terminated=Cyc_Tcutil_force_type2bool(0,zt);
if(is_zero_terminated){
# 682
if(!Cyc_Tcutil_admits_zero(t1))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp16F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2DD;_tmp2DD.tag=0U,({struct _fat_ptr _tmp38D=({const char*_tmp173="cannot have a zero-terminated array of ";_tag_fat(_tmp173,sizeof(char),40U);});_tmp2DD.f1=_tmp38D;});_tmp2DD;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp170=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2DC;_tmp2DC.tag=2U,_tmp2DC.f1=(void*)t1;_tmp2DC;});struct Cyc_Warn_String_Warn_Warg_struct _tmp171=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2DB;_tmp2DB.tag=0U,({struct _fat_ptr _tmp38E=({const char*_tmp172=" elements";_tag_fat(_tmp172,sizeof(char),10U);});_tmp2DB.f1=_tmp38E;});_tmp2DB;});void*_tmp16E[3U];_tmp16E[0]=& _tmp16F,_tmp16E[1]=& _tmp170,_tmp16E[2]=& _tmp171;({unsigned _tmp38F=loc;Cyc_Warn_err2(_tmp38F,_tag_fat(_tmp16E,sizeof(void*),3U));});});}
# 687
if(e == 0){
# 690
if(!is_zero_terminated)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp175=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2DE;_tmp2DE.tag=0U,({struct _fat_ptr _tmp390=({const char*_tmp176="array bound defaults to 1 here";_tag_fat(_tmp176,sizeof(char),31U);});_tmp2DE.f1=_tmp390;});_tmp2DE;});void*_tmp174[1U];_tmp174[0]=& _tmp175;({unsigned _tmp391=loc;Cyc_Warn_warn2(_tmp391,_tag_fat(_tmp174,sizeof(void*),1U));});});
({struct Cyc_Absyn_Exp*_tmp392=e=Cyc_Absyn_uint_exp(1U,0U);*eptr=_tmp392;});}
# 694
({struct Cyc_Tcenv_Tenv*_tmp393=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmp393,0,e);});
if(!Cyc_Tcutil_coerce_uint_type(e))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp178=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2DF;_tmp2DF.tag=0U,({struct _fat_ptr _tmp394=({const char*_tmp179="array bounds expression is not an unsigned int";_tag_fat(_tmp179,sizeof(char),47U);});_tmp2DF.f1=_tmp394;});_tmp2DF;});void*_tmp177[1U];_tmp177[0]=& _tmp178;({unsigned _tmp395=loc;Cyc_Warn_err2(_tmp395,_tag_fat(_tmp177,sizeof(void*),1U));});});
env=Cyc_Tctyp_i_check_type_level_exp(e,env);{
...
# 700
if((is_zero_terminated && known)&& sz < (unsigned)1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp17F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E0;_tmp2E0.tag=0U,({struct _fat_ptr _tmp396=({const char*_tmp180="zero terminated array cannot have zero elements";_tag_fat(_tmp180,sizeof(char),48U);});_tmp2E0.f1=_tmp396;});_tmp2E0;});void*_tmp17E[1U];_tmp17E[0]=& _tmp17F;({unsigned _tmp397=loc;Cyc_Warn_warn2(_tmp397,_tag_fat(_tmp17E,sizeof(void*),1U));});});
# 703
if((known && sz < (unsigned)1)&& Cyc_Flags_tovc_r){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp182=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E1;_tmp2E1.tag=0U,({struct _fat_ptr _tmp398=({const char*_tmp183="0-element arrays are supported only with gcc, changing to 1";_tag_fat(_tmp183,sizeof(char),60U);});_tmp2E1.f1=_tmp398;});_tmp2E1;});void*_tmp181[1U];_tmp181[0]=& _tmp182;({unsigned _tmp399=loc;Cyc_Warn_warn2(_tmp399,_tag_fat(_tmp181,sizeof(void*),1U));});});
({struct Cyc_Absyn_Exp*_tmp39A=Cyc_Absyn_uint_exp(1U,0U);*eptr=_tmp39A;});}
# 707
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp18A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E3;_tmp2E3.tag=0U,({struct _fat_ptr _tmp39B=({const char*_tmp18C="bad function type attribute ";_tag_fat(_tmp18C,sizeof(char),29U);});_tmp2E3.f1=_tmp39B;});_tmp2E3;});struct Cyc_Warn_Attribute_Warn_Warg_struct _tmp18B=({struct Cyc_Warn_Attribute_Warn_Warg_struct _tmp2E2;_tmp2E2.tag=10U,_tmp2E2.f1=(void*)atts->hd;_tmp2E2;});void*_tmp189[2U];_tmp189[0]=& _tmp18A,_tmp189[1]=& _tmp18B;({unsigned _tmp39C=loc;Cyc_Warn_err2(_tmp39C,_tag_fat(_tmp189,sizeof(void*),2U));});});}_LL3C:;}
# 737
if((is_stdcall + is_cdecl)+ is_fastcall > 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp18E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E4;_tmp2E4.tag=0U,({struct _fat_ptr _tmp39D=({const char*_tmp18F="function can't have multiple calling conventions";_tag_fat(_tmp18F,sizeof(char),49U);});_tmp2E4.f1=_tmp39D;});_tmp2E4;});void*_tmp18D[1U];_tmp18D[0]=& _tmp18E;({unsigned _tmp39E=loc;Cyc_Warn_err2(_tmp39E,_tag_fat(_tmp18D,sizeof(void*),1U));});});
if(num_formats > 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp191=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E5;_tmp2E5.tag=0U,({struct _fat_ptr _tmp39F=({const char*_tmp192="function can't have multiple format attributes";_tag_fat(_tmp192,sizeof(char),47U);});_tmp2E5.f1=_tmp39F;});_tmp2E5;});void*_tmp190[1U];_tmp190[0]=& _tmp191;({unsigned _tmp3A0=loc;Cyc_Warn_err2(_tmp3A0,_tag_fat(_tmp190,sizeof(void*),1U));});});
# 744
Cyc_Tcutil_check_unique_tvars(loc,*btvs);
{struct Cyc_List_List*b=*btvs;for(0;b != 0;b=b->tl){
({int _tmp3A1=Cyc_Tcutil_new_tvar_id();((struct Cyc_Absyn_Tvar*)b->hd)->identity=_tmp3A1;});
({struct Cyc_List_List*_tmp3A2=Cyc_Tctyp_add_bound_tvar(env.kind_env,(struct Cyc_Absyn_Tvar*)b->hd);env.kind_env=_tmp3A2;});{
...
# 750
({struct Cyc_Warn_String_Warn_Warg_struct _tmp196=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E7;_tmp2E7.tag=0U,({struct _fat_ptr _tmp3A3=({const char*_tmp198="function abstracts Mem type variable ";_tag_fat(_tmp198,sizeof(char),38U);});_tmp2E7.f1=_tmp3A3;});_tmp2E7;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp197=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp2E6;_tmp2E6.tag=7U,_tmp2E6.f1=(struct Cyc_Absyn_Tvar*)b->hd;_tmp2E6;});void*_tmp195[2U];_tmp195[0]=& _tmp196,_tmp195[1]=& _tmp197;({unsigned _tmp3A4=loc;Cyc_Warn_err2(_tmp3A4,_tag_fat(_tmp195,sizeof(void*),2U));});});goto _LL47;}else{goto _LL4A;}}else{_LL4A: _LL4B:
 goto _LL47;}_LL47:;}}}{
# 756
struct Cyc_Tctyp_CVTEnv new_env=({struct Cyc_Tctyp_CVTEnv _tmp2F8;_tmp2F8.loc=loc,_tmp2F8.te=te,_tmp2F8.kind_env=env.kind_env,_tmp2F8.fn_result=1,_tmp2F8.generalize_evars=env.generalize_evars,_tmp2F8.free_vars=0,_tmp2F8.free_evars=0;_tmp2F8;});
new_env=Cyc_Tctyp_i_check_type(new_env,& Cyc_Tcutil_tmk,tr,1,1);
({int _tmp3A5=Cyc_Tcutil_extract_const_from_typedef(loc,rtq->print_const,tr);rtq->real_const=_tmp3A5;});
new_env.fn_result=0;
# 762
...
({void*_tmp3A6=Cyc_Tcutil_promote_array(t,ptr_rgn,0);(*trip).f3=_tmp3A6;});}}}}
# 778
if(cyc_vararg != 0){
if(c_vararg)({struct Cyc_Warn_String_Warn_Warg_struct _tmp19E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E8;_tmp2E8.tag=0U,({struct _fat_ptr _tmp3A7=({const char*_tmp19F="both c_vararg and cyc_vararg";_tag_fat(_tmp19F,sizeof(char),29U);});_tmp2E8.f1=_tmp3A7;});_tmp2E8;});void*_tmp19D[1U];_tmp19D[0]=& _tmp19E;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp19D,sizeof(void*),1U));});{
...
({int _tmp3A8=Cyc_Tcutil_extract_const_from_typedef(loc,(cyc_vararg->tq).print_const,vt);(cyc_vararg->tq).real_const=_tmp3A8;});
# 784
if(vi){
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1AC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E9;_tmp2E9.tag=0U,({struct _fat_ptr _tmp3A9=({const char*_tmp1AD="can't inject into a zeroterm pointer";_tag_fat(_tmp1AD,sizeof(char),37U);});_tmp2E9.f1=_tmp3A9;});_tmp2E9;});void*_tmp1AB[1U];_tmp1AB[0]=& _tmp1AC;({unsigned _tmp3AA=loc;Cyc_Warn_err2(_tmp3AA,_tag_fat(_tmp1AB,sizeof(void*),1U));});});
if(!({void*_tmp3AB=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp3AB,bs);}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1AF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EA;_tmp2EA.tag=0U,({struct _fat_ptr _tmp3AC=({const char*_tmp1B0="can't inject into a fat pointer to datatype";_tag_fat(_tmp1B0,sizeof(char),44U);});_tmp2EA.f1=_tmp3AC;});_tmp2EA;});void*_tmp1AE[1U];_tmp1AE[0]=& _tmp1AF;({unsigned _tmp3AD=loc;Cyc_Warn_err2(_tmp3AD,_tag_fat(_tmp1AE,sizeof(void*),1U));});});
goto _LL54;}else{goto _LL57;}}else{_LL57: _LL58:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1B2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EB;_tmp2EB.tag=0U,({struct _fat_ptr _tmp3AE=({const char*_tmp1B3="can't inject a non-datatype type";_tag_fat(_tmp1B3,sizeof(char),33U);});_tmp2EB.f1=_tmp3AE;});_tmp2EB;});void*_tmp1B1[1U];_tmp1B1[0]=& _tmp1B2;({unsigned _tmp3AF=loc;Cyc_Warn_err2(_tmp3AF,_tag_fat(_tmp1B1,sizeof(void*),1U));});});goto _LL54;}_LL54:;}
# 796
goto _LL4F;}}else{_LL52: _LL53:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1B5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EC;_tmp2EC.tag=0U,({struct _fat_ptr _tmp3B0=({const char*_tmp1B6="expecting a datatype pointer type";_tag_fat(_tmp1B6,sizeof(char),34U);});_tmp2EC.f1=_tmp3B0;});_tmp2EC;});void*_tmp1B4[1U];_tmp1B4[0]=& _tmp1B5;({unsigned _tmp3B1=loc;Cyc_Warn_err2(_tmp3B1,_tag_fat(_tmp1B4,sizeof(void*),1U));});});goto _LL4F;}_LL4F:;}}}}
# 801
if(num_formats > 0){
...
# 808
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1B9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2ED;_tmp2ED.tag=0U,({struct _fat_ptr _tmp3B2=({const char*_tmp1BA="bad format descriptor";_tag_fat(_tmp1BA,sizeof(char),22U);});_tmp2ED.f1=_tmp3B2;});_tmp2ED;});void*_tmp1B8[1U];_tmp1B8[0]=& _tmp1B9;({unsigned _tmp3B3=loc;Cyc_Warn_err2(_tmp3B3,_tag_fat(_tmp1B8,sizeof(void*),1U));});});else{
# 811
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EE;_tmp2EE.tag=0U,({struct _fat_ptr _tmp3B4=({const char*_tmp1C4="format descriptor is not a string";_tag_fat(_tmp1C4,sizeof(char),34U);});_tmp2EE.f1=_tmp3B4;});_tmp2EE;});void*_tmp1C2[1U];_tmp1C2[0]=& _tmp1C3;({unsigned _tmp3B5=loc;Cyc_Warn_err2(_tmp3B5,_tag_fat(_tmp1C2,sizeof(void*),1U));});});else{
# 819
struct Cyc_Absyn_Exp*_tmp1C5=({void*_tmp3B6=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp3B6,b);});struct Cyc_Absyn_Exp*e=_tmp1C5;
if(e == 0 && c_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EF;_tmp2EF.tag=0U,({struct _fat_ptr _tmp3B7=({const char*_tmp1C8="format descriptor is not a char * type";_tag_fat(_tmp1C8,sizeof(char),39U);});_tmp2EF.f1=_tmp3B7;});_tmp2EF;});void*_tmp1C6[1U];_tmp1C6[0]=& _tmp1C7;({unsigned _tmp3B8=loc;Cyc_Warn_err2(_tmp3B8,_tag_fat(_tmp1C6,sizeof(void*),1U));});});else{
if(e != 0 && !c_vararg)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1CA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F0;_tmp2F0.tag=0U,({struct _fat_ptr _tmp3B9=({const char*_tmp1CB="format descriptor is not a char ? type";_tag_fat(_tmp1CB,sizeof(char),39U);});_tmp2F0.f1=_tmp3B9;});_tmp2F0;});void*_tmp1C9[1U];_tmp1C9[0]=& _tmp1CA;({unsigned _tmp3BA=loc;Cyc_Warn_err2(_tmp3BA,_tag_fat(_tmp1C9,sizeof(void*),1U));});});}}
# 825
goto _LL5C;}}else{_LL5F: _LL60:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1CD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F1;_tmp2F1.tag=0U,({struct _fat_ptr _tmp3BB=({const char*_tmp1CE="format descriptor is not a string type";_tag_fat(_tmp1CE,sizeof(char),39U);});_tmp2F1.f1=_tmp3BB;});_tmp2F1;});void*_tmp1CC[1U];_tmp1CC[0]=& _tmp1CD;({unsigned _tmp3BC=loc;Cyc_Warn_err2(_tmp3BC,_tag_fat(_tmp1CC,sizeof(void*),1U));});});goto _LL5C;}_LL5C:;}
# 828
if(fmt_arg_start != 0 && !c_vararg){
# 832
int problem;
{struct _tuple16 _tmp1CF=({struct _tuple16 _tmp2F2;_tmp2F2.f1=ft,({void*_tmp3BD=Cyc_Absyn_compress(Cyc_Tcutil_pointer_elt_type(((struct Cyc_Absyn_VarargInfo*)_check_null(cyc_vararg))->type));_tmp2F2.f2=_tmp3BD;});_tmp2F2;});struct _tuple16 _stmttmp1C=_tmp1CF;struct _tuple16 _tmp1D0=_stmttmp1C;struct Cyc_Absyn_Datatypedecl*_tmp1D1;struct Cyc_Absyn_Datatypedecl*_tmp1D2;switch(_tmp1D0.f1){case Cyc_Absyn_Printf_ft: if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1D0.f2)->tag == 0U){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1D0.f2)->f1)->tag == 18U){if(((((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1D0.f2)->f1)->f1).KnownDatatype).tag == 2){_LL62: _tmp1D2=*((((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1D0.f2)->f1)->f1).KnownDatatype).val;_LL63: {struct Cyc_Absyn_Datatypedecl*tud=_tmp1D2;
# 835
problem=({struct _tuple1*_tmp3BE=tud->name;Cyc_Absyn_qvar_cmp(_tmp3BE,Cyc_Absyn_datatype_print_arg_qvar());})!= 0;
...
# 838
problem=({struct _tuple1*_tmp3BF=tud->name;Cyc_Absyn_qvar_cmp(_tmp3BF,Cyc_Absyn_datatype_scanf_arg_qvar());})!= 0;
...
# 844
if(problem)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1D4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F3;_tmp2F3.tag=0U,({struct _fat_ptr _tmp3C0=({const char*_tmp1D5="format attribute and vararg types don't match";_tag_fat(_tmp1D5,sizeof(char),46U);});_tmp2F3.f1=_tmp3C0;});_tmp2F3;});void*_tmp1D3[1U];_tmp1D3[0]=& _tmp1D4;({unsigned _tmp3C1=loc;Cyc_Warn_err2(_tmp3C1,_tag_fat(_tmp1D3,sizeof(void*),1U));});});}}}}
# 852
...
({struct Cyc_Tcenv_Tenv*_tmp3C2=({struct Cyc_Tcenv_Tenv*_tmp1DC=_cycalloc(sizeof(*_tmp1DC));_tmp1DC->ns=te->ns,_tmp1DC->ae=te->ae,_tmp1DC->le=fenv,_tmp1DC->allow_valueof=1,_tmp1DC->in_extern_c_include=te->in_extern_c_include,_tmp1DC->in_tempest=te->in_tempest,_tmp1DC->tempest_generalize=te->tempest_generalize,_tmp1DC->in_extern_c_inc_repeat=te->in_extern_c_inc_repeat;_tmp1DC;});new_env.te=_tmp3C2;});{
# 866
struct _tuple15 _tmp1DD=({struct Cyc_Tctyp_CVTEnv _tmp3C4=new_env;struct _fat_ptr _tmp3C3=({const char*_tmp216="@requires";_tag_fat(_tmp216,sizeof(char),10U);});Cyc_Tctyp_check_clause(_tmp3C4,_tmp3C3,req);});struct _tuple15 _stmttmp1E=_tmp1DD;struct _tuple15 _tmp1DE=_stmttmp1E;struct Cyc_List_List*_tmp1E0;struct Cyc_Tctyp_CVTEnv _tmp1DF;_LL6C: _tmp1DF=_tmp1DE.f1;_tmp1E0=_tmp1DE.f2;_LL6D: {struct Cyc_Tctyp_CVTEnv nenv=_tmp1DF;struct Cyc_List_List*req_rs=_tmp1E0;
new_env=nenv;
*req_relns=req_rs;
...
struct _tuple15 _tmp1E1=({struct Cyc_Tctyp_CVTEnv _tmp3C6=new_env;struct _fat_ptr _tmp3C5=({const char*_tmp215="@ensures";_tag_fat(_tmp215,sizeof(char),9U);});Cyc_Tctyp_check_clause(_tmp3C6,_tmp3C5,ens);});struct _tuple15 _stmttmp1F=_tmp1E1;struct _tuple15 _tmp1E2=_stmttmp1F;struct Cyc_List_List*_tmp1E4;struct Cyc_Tctyp_CVTEnv _tmp1E3;_LL6F: _tmp1E3=_tmp1E2.f1;_tmp1E4=_tmp1E2.f2;_LL70: {struct Cyc_Tctyp_CVTEnv nenv=_tmp1E3;struct Cyc_List_List*ens_rs=_tmp1E4;
new_env=nenv;
*ens_relns=ens_rs;
...
({struct Cyc_Core_Opt*_tmp3C7=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_rk);*f=_tmp3C7;});_tmp1EC=r;goto _LL78;}
# 893
({struct Cyc_Core_Opt*_tmp3C8=Cyc_Tcutil_kind_to_bound_opt(r);*f=_tmp3C8;});_tmp1EC=r;goto _LL78;}}else{switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp1EA)->f2)->kind){case Cyc_Absyn_BoolKind: _LL79: _LL7A:
# 896
...
# 903
({struct Cyc_Core_Opt*_tmp3C9=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_ek);*f=_tmp3C9;});goto _LL88;}default: goto _LL8B;}}case 0U: _LL77: _tmp1EC=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp1EA)->f1;if((int)_tmp1EC->kind == (int)Cyc_Absyn_RgnKind){_LL78: {struct Cyc_Absyn_Kind*r=_tmp1EC;
# 895
effect=({struct Cyc_List_List*_tmp1F0=_cycalloc(sizeof(*_tmp1F0));({void*_tmp3CA=Cyc_Absyn_access_eff(Cyc_Absyn_var_type(tv));_tmp1F0->hd=_tmp3CA;}),_tmp1F0->tl=effect;_tmp1F0;});goto _LL74;}}else{switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp1EA)->f1)->kind){case Cyc_Absyn_BoolKind: _LL7F: _LL80:
# 899
...
# 905
 effect=({struct Cyc_List_List*_tmp1F1=_cycalloc(sizeof(*_tmp1F1));({void*_tmp3CB=Cyc_Absyn_var_type(tv);_tmp1F1->hd=_tmp3CB;}),_tmp1F1->tl=effect;_tmp1F1;});goto _LL74;default: _LL8B: _LL8C:
# 910
 effect=({struct Cyc_List_List*_tmp1F4=_cycalloc(sizeof(*_tmp1F4));({void*_tmp3CC=Cyc_Absyn_regionsof_eff(Cyc_Absyn_var_type(tv));_tmp1F4->hd=_tmp3CC;}),_tmp1F4->tl=effect;_tmp1F4;});goto _LL74;}}default: _LL89: _tmp1EB=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp1EA)->f1;_LL8A: {struct Cyc_Core_Opt**f=_tmp1EB;
# 907
({struct Cyc_Core_Opt*_tmp3CE=({struct Cyc_Core_Opt*_tmp1F3=_cycalloc(sizeof(*_tmp1F3));({void*_tmp3CD=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp1F2=_cycalloc(sizeof(*_tmp1F2));_tmp1F2->tag=2U,_tmp1F2->f1=0,_tmp1F2->f2=& Cyc_Tcutil_ak;_tmp1F2;});_tmp1F3->v=_tmp3CD;});_tmp1F3;});*f=_tmp3CE;});goto _LL8C;}}_LL74:;}}}}
# 914
...
struct Cyc_Absyn_Kind*_tmp1F9=Cyc_Tcutil_type_kind(tv);struct Cyc_Absyn_Kind*_stmttmp23=_tmp1F9;struct Cyc_Absyn_Kind*_tmp1FA=_stmttmp23;switch(((struct Cyc_Absyn_Kind*)_tmp1FA)->kind){case Cyc_Absyn_RgnKind: _LL91: _LL92:
 effect=({struct Cyc_List_List*_tmp1FB=_cycalloc(sizeof(*_tmp1FB));({void*_tmp3CF=Cyc_Absyn_access_eff(tv);_tmp1FB->hd=_tmp3CF;}),_tmp1FB->tl=effect;_tmp1FB;});goto _LL90;case Cyc_Absyn_EffKind: _LL93: _LL94:
 ...
 effect=({struct Cyc_List_List*_tmp1FD=_cycalloc(sizeof(*_tmp1FD));({void*_tmp3D0=Cyc_Absyn_regionsof_eff(tv);_tmp1FD->hd=_tmp3D0;}),_tmp1FD->tl=effect;_tmp1FD;});goto _LL90;}_LL90:;}}}}
# 924
({void*_tmp3D1=Cyc_Absyn_join_eff(effect);*eff=_tmp3D1;});}
# 930
if(*btvs != 0){
...
# 934
({struct Cyc_Warn_String_Warn_Warg_struct _tmp204=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F6;_tmp2F6.tag=0U,({struct _fat_ptr _tmp3D2=({const char*_tmp208="type variable ";_tag_fat(_tmp208,sizeof(char),15U);});_tmp2F6.f1=_tmp3D2;});_tmp2F6;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp205=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp2F5;_tmp2F5.tag=7U,_tmp2F5.f1=(struct Cyc_Absyn_Tvar*)bs->hd;_tmp2F5;});struct Cyc_Warn_String_Warn_Warg_struct _tmp206=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F4;_tmp2F4.tag=0U,({struct _fat_ptr _tmp3D3=({const char*_tmp207=" unconstrained, assuming boxed";_tag_fat(_tmp207,sizeof(char),31U);});_tmp2F4.f1=_tmp3D3;});_tmp2F4;});void*_tmp203[3U];_tmp203[0]=& _tmp204,_tmp203[1]=& _tmp205,_tmp203[2]=& _tmp206;({unsigned _tmp3D4=loc;Cyc_Warn_warn2(_tmp3D4,_tag_fat(_tmp203,sizeof(void*),3U));});});
({struct Cyc_Core_Opt*_tmp3D5=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_bk);*f=_tmp3D5;});
...
({struct Cyc_Core_Opt*_tmp3D6=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_bk);*f=_tmp3D6;});goto _LLA2;case Cyc_Absyn_Unique: _LLAF: _LLB0:
# 945
({struct Cyc_Core_Opt*_tmp3D7=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_ubk);*f=_tmp3D7;});goto _LLA2;default: goto _LLB3;}case Cyc_Absyn_RgnKind: if(((struct Cyc_Absyn_Kind*)_tmp209)->aliasqual == Cyc_Absyn_Top){_LLB1: _LLB2:
({struct Cyc_Core_Opt*_tmp3D8=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_rk);*f=_tmp3D8;});goto _LLA2;}else{goto _LLB3;}default: _LLB3: _LLB4:
({struct Cyc_Core_Opt*_tmp3D9=Cyc_Tcutil_kind_to_bound_opt(k);*f=_tmp3D9;});goto _LLA2;}_LLA2:;}
# 949
...
# 951
({struct Cyc_Warn_String_Warn_Warg_struct _tmp20B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F7;_tmp2F7.tag=0U,({struct _fat_ptr _tmp3DA=({const char*_tmp20C="functions can't abstract M types";_tag_fat(_tmp20C,sizeof(char),33U);});_tmp2F7.f1=_tmp3DA;});_tmp2F7;});void*_tmp20A[1U];_tmp20A[0]=& _tmp20B;({unsigned _tmp3DB=loc;Cyc_Warn_err2(_tmp3DB,_tag_fat(_tmp20A,sizeof(void*),1U));});});goto _LL99;}else{_LLA0: _LLA1:
 goto _LL99;}}_LL99:;}}
# 956
({struct Cyc_List_List*_tmp3DC=((struct Cyc_List_List*(*)(struct Cyc_List_List*tvs,struct Cyc_List_List*btvs,struct Cyc_Absyn_Tvar*(*get)(struct Cyc_Absyn_Tvar*)))Cyc_Tctyp_remove_bound_tvars)(new_env.kind_env,*btvs,(struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*))Cyc_Core_identity);env.kind_env=_tmp3DC;});
({struct Cyc_List_List*_tmp3DD=((struct Cyc_List_List*(*)(struct Cyc_List_List*tvs,struct Cyc_List_List*btvs,struct Cyc_Absyn_Tvar*(*get)(struct _tuple14*)))Cyc_Tctyp_remove_bound_tvars)(new_env.free_vars,*btvs,(struct Cyc_Absyn_Tvar*(*)(struct _tuple14*))Cyc_Core_fst);new_env.free_vars=_tmp3DD;});
# 959
{struct Cyc_List_List*tvs=new_env.free_vars;for(0;tvs != 0;tvs=tvs->tl){
...
({struct Cyc_List_List*_tmp3DE=Cyc_Tctyp_fast_add_free_tvar_bool(env.free_vars,t,b);env.free_vars=_tmp3DE;});}}}
# 964
...
({struct Cyc_List_List*_tmp3DF=Cyc_Tctyp_add_free_evar(env.free_evars,e,b);env.free_evars=_tmp3DF;});}}}
# 968
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp221=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FA;_tmp2FA.tag=0U,({struct _fat_ptr _tmp3E1=({const char*_tmp223="duplicate field ";_tag_fat(_tmp223,sizeof(char),17U);});_tmp2FA.f1=_tmp3E1;});_tmp2FA;});struct Cyc_Warn_String_Warn_Warg_struct _tmp222=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F9;_tmp2F9.tag=0U,_tmp2F9.f1=*fn;_tmp2F9;});void*_tmp220[2U];_tmp220[0]=& _tmp221,_tmp220[1]=& _tmp222;({unsigned _tmp3E2=loc;Cyc_Warn_err2(_tmp3E2,_tag_fat(_tmp220,sizeof(void*),2U));});});
if(({struct _fat_ptr _tmp3E3=(struct _fat_ptr)*fn;Cyc_strcmp(_tmp3E3,({const char*_tmp224="";_tag_fat(_tmp224,sizeof(char),1U);}));})!= 0)
...
({int _tmp3E4=Cyc_Tcutil_extract_const_from_typedef(loc,tqp->print_const,t);tqp->real_const=_tmp3E4;});
Cyc_Tcutil_check_bitfield(loc,t,width,fn);
Cyc_Atts_check_field_atts(loc,fn,atts);
if(requires_clause != 0){
# 994
if((int)k != (int)1U)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp227=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FB;_tmp2FB.tag=0U,({struct _fat_ptr _tmp3E5=({const char*_tmp228="@requires clause is only allowed on union members";_tag_fat(_tmp228,sizeof(char),50U);});_tmp2FB.f1=_tmp3E5;});_tmp2FB;});void*_tmp226[1U];_tmp226[0]=& _tmp227;({unsigned _tmp3E6=loc;Cyc_Warn_err2(_tmp3E6,_tag_fat(_tmp226,sizeof(void*),1U));});});
({struct Cyc_Tcenv_Tenv*_tmp3E7=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmp3E7,0,requires_clause);});
if(!Cyc_Tcutil_is_integral(requires_clause))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp22A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FE;_tmp2FE.tag=0U,({struct _fat_ptr _tmp3E8=({const char*_tmp22E="@requires clause has type ";_tag_fat(_tmp22E,sizeof(char),27U);});_tmp2FE.f1=_tmp3E8;});_tmp2FE;});struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp22B=({struct Cyc_Warn_TypOpt_Warn_Warg_struct _tmp2FD;_tmp2FD.tag=3U,_tmp2FD.f1=(void*)requires_clause->topt;_tmp2FD;});struct Cyc_Warn_String_Warn_Warg_struct _tmp22C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FC;_tmp2FC.tag=0U,({
struct _fat_ptr _tmp3E9=({const char*_tmp22D=" instead of integral type";_tag_fat(_tmp22D,sizeof(char),26U);});_tmp2FC.f1=_tmp3E9;});_tmp2FC;});void*_tmp229[3U];_tmp229[0]=& _tmp22A,_tmp229[1]=& _tmp22B,_tmp229[2]=& _tmp22C;({unsigned _tmp3EA=loc;Cyc_Warn_err2(_tmp3EA,_tag_fat(_tmp229,sizeof(void*),3U));});});
...
# 1010
({struct Cyc_Warn_String_Warn_Warg_struct _tmp235=({struct Cyc_Warn_String_Warn_Warg_struct _tmp300;_tmp300.tag=0U,({struct _fat_ptr _tmp3EB=({const char*_tmp237="unbound typedef name ";_tag_fat(_tmp237,sizeof(char),22U);});_tmp300.f1=_tmp3EB;});_tmp300;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp236=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2FF;_tmp2FF.tag=1U,_tmp2FF.f1=tdn;_tmp2FF;});void*_tmp234[2U];_tmp234[0]=& _tmp235,_tmp234[1]=& _tmp236;({unsigned _tmp3EC=loc;Cyc_Warn_err2(_tmp3EC,_tag_fat(_tmp234,sizeof(void*),2U));});});
...
inst=({struct Cyc_List_List*_tmp23B=_cycalloc(sizeof(*_tmp23B));({struct _tuple18*_tmp3ED=({struct _tuple18*_tmp23A=_cycalloc(sizeof(*_tmp23A));_tmp23A->f1=(struct Cyc_Absyn_Tvar*)tvs->hd,_tmp23A->f2=(void*)((struct Cyc_List_List*)_check_null(ts))->hd;_tmp23A;});_tmp23B->hd=_tmp3ED;}),_tmp23B->tl=inst;_tmp23B;});}
({void*_tmp3EE=Cyc_Tcutil_substitute(inst,(void*)_check_null(td->defn));*toptp=_tmp3EE;});}
# 1024
goto _LL3;}}_LL3:;}
# 1026
if(!({struct Cyc_Absyn_Kind*_tmp3EF=Cyc_Tcutil_type_kind(t);Cyc_Tcutil_kind_leq(_tmp3EF,expected_kind);}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp23D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp306;_tmp306.tag=0U,({struct _fat_ptr _tmp3F0=({const char*_tmp245="type ";_tag_fat(_tmp245,sizeof(char),6U);});_tmp306.f1=_tmp3F0;});_tmp306;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp23E=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp305;_tmp305.tag=2U,_tmp305.f1=(void*)t;_tmp305;});struct Cyc_Warn_String_Warn_Warg_struct _tmp23F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp304;_tmp304.tag=0U,({struct _fat_ptr _tmp3F1=({const char*_tmp244=" has kind ";_tag_fat(_tmp244,sizeof(char),11U);});_tmp304.f1=_tmp3F1;});_tmp304;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmp240=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp303;_tmp303.tag=9U,({struct Cyc_Absyn_Kind*_tmp3F2=Cyc_Tcutil_type_kind(t);_tmp303.f1=_tmp3F2;});_tmp303;});struct Cyc_Warn_String_Warn_Warg_struct _tmp241=({struct Cyc_Warn_String_Warn_Warg_struct _tmp302;_tmp302.tag=0U,({
struct _fat_ptr _tmp3F3=({const char*_tmp243=" but as used here needs kind ";_tag_fat(_tmp243,sizeof(char),30U);});_tmp302.f1=_tmp3F3;});_tmp302;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmp242=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp301;_tmp301.tag=9U,_tmp301.f1=expected_kind;_tmp301;});void*_tmp23C[6U];_tmp23C[0]=& _tmp23D,_tmp23C[1]=& _tmp23E,_tmp23C[2]=& _tmp23F,_tmp23C[3]=& _tmp240,_tmp23C[4]=& _tmp241,_tmp23C[5]=& _tmp242;({unsigned _tmp3F4=loc;Cyc_Warn_err2(_tmp3F4,_tag_fat(_tmp23C,sizeof(void*),6U));});});
return env;}}
# 1032
...
({struct Cyc_List_List*_tmp3F5=Cyc_Tctyp_fast_add_free_tvar(kind_env,(*((struct _tuple14*)vs->hd)).f1);cvt.kind_env=_tmp3F5;});}}
# 1043
...
# 1047
if(*s == 0)
({struct Cyc_Core_Opt*_tmp3F6=({struct Cyc_Core_Opt*_tmp24D=_cycalloc(sizeof(*_tmp24D));_tmp24D->v=kind_env;_tmp24D;});*s=_tmp3F6;});else{
# 1051
...
({struct Cyc_Core_Opt*_tmp3F7=({struct Cyc_Core_Opt*_tmp251=_cycalloc(sizeof(*_tmp251));_tmp251->v=result;_tmp251;});*s=_tmp3F7;});}
# 1057
...
struct Cyc_Tctyp_CVTEnv _tmp253=({struct Cyc_Tctyp_CVTEnv _tmp3F9=({struct Cyc_Tctyp_CVTEnv _tmp313;_tmp313.loc=loc,_tmp313.te=te,_tmp313.kind_env=te_vars,_tmp313.fn_result=0,_tmp313.generalize_evars=generalize_evars,_tmp313.free_vars=0,_tmp313.free_evars=0;_tmp313;});struct Cyc_Absyn_Kind*_tmp3F8=expected_kind;Cyc_Tctyp_check_valid_type(_tmp3F9,_tmp3F8,1,t);});struct Cyc_Tctyp_CVTEnv cvt=_tmp253;
# 1076
...
({struct Cyc_Core_Opt*_tmp3FA=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_bk);*f=_tmp3FA;});goto _LL0;}case 2U: _LL3: _tmp25D=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp25B)->f1;_tmp25E=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp25B)->f2;_LL4: {struct Cyc_Core_Opt**f=_tmp25D;struct Cyc_Absyn_Kind*k=_tmp25E;
# 1098
...
({struct Cyc_Core_Opt*_tmp3FB=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_bk);*f=_tmp3FB;});goto _LL9;case Cyc_Absyn_Unique: _LL10: _LL11:
({struct Cyc_Core_Opt*_tmp3FC=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_ubk);*f=_tmp3FC;});goto _LL9;default: goto _LL14;}case Cyc_Absyn_RgnKind: if(((struct Cyc_Absyn_Kind*)_tmp260)->aliasqual == Cyc_Absyn_Top){_LL12: _LL13:
({struct Cyc_Core_Opt*_tmp3FD=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_rk);*f=_tmp3FD;});goto _LL9;}else{goto _LL14;}default: _LL14: _LL15:
({struct Cyc_Core_Opt*_tmp3FE=Cyc_Tcutil_kind_to_bound_opt(k);*f=_tmp3FE;});goto _LL9;}_LL9:;}
# 1106
...
# 1108
({struct Cyc_Warn_String_Warn_Warg_struct _tmp262=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30A;_tmp30A.tag=0U,({struct _fat_ptr _tmp3FF=({const char*_tmp268="type variable ";_tag_fat(_tmp268,sizeof(char),15U);});_tmp30A.f1=_tmp3FF;});_tmp30A;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp263=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp309;_tmp309.tag=7U,_tmp309.f1=(struct Cyc_Absyn_Tvar*)x->hd;_tmp309;});struct Cyc_Warn_String_Warn_Warg_struct _tmp264=({struct Cyc_Warn_String_Warn_Warg_struct _tmp308;_tmp308.tag=0U,({struct _fat_ptr _tmp400=({const char*_tmp267=" cannot have kind ";_tag_fat(_tmp267,sizeof(char),19U);});_tmp308.f1=_tmp400;});_tmp308;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmp265=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp307;_tmp307.tag=9U,({struct Cyc_Absyn_Kind*_tmp401=({struct Cyc_Absyn_Kind*_tmp266=_cycalloc(sizeof(*_tmp266));_tmp266->kind=Cyc_Absyn_MemKind,_tmp266->aliasqual=a;_tmp266;});_tmp307.f1=_tmp401;});_tmp307;});void*_tmp261[4U];_tmp261[0]=& _tmp262,_tmp261[1]=& _tmp263,_tmp261[2]=& _tmp264,_tmp261[3]=& _tmp265;({unsigned _tmp402=loc;Cyc_Warn_err2(_tmp402,_tag_fat(_tmp261,sizeof(void*),4U));});});
...
if(*btvs == 0){
# 1119
({struct Cyc_List_List*_tmp403=((struct Cyc_List_List*(*)(int(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*x))Cyc_List_filter)(Cyc_CurRgn_is_not_curr_rgn,free_tvars);*btvs=_tmp403;});
free_tvars=0;}
# 1122
...
# 1125
if(free_tvars != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp26D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30E;_tmp30E.tag=0U,({struct _fat_ptr _tmp404=({const char*_tmp272="unbound type variable ";_tag_fat(_tmp272,sizeof(char),23U);});_tmp30E.f1=_tmp404;});_tmp30E;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp26E=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp30D;_tmp30D.tag=7U,_tmp30D.f1=(struct Cyc_Absyn_Tvar*)free_tvars->hd;_tmp30D;});struct Cyc_Warn_String_Warn_Warg_struct _tmp26F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30C;_tmp30C.tag=0U,({struct _fat_ptr _tmp405=({const char*_tmp271=" when checking ";_tag_fat(_tmp271,sizeof(char),16U);});_tmp30C.f1=_tmp405;});_tmp30C;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp270=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp30B;_tmp30B.tag=2U,_tmp30B.f1=(void*)t;_tmp30B;});void*_tmp26C[4U];_tmp26C[0]=& _tmp26D,_tmp26C[1]=& _tmp26E,_tmp26C[2]=& _tmp26F,_tmp26C[3]=& _tmp270;({unsigned _tmp406=loc;Cyc_Warn_err2(_tmp406,_tag_fat(_tmp26C,sizeof(void*),4U));});});
if(!Cyc_Tcutil_is_function_type(t)|| !te->in_tempest)
Cyc_Tctyp_check_free_evars(free_evars,t,loc);}{
# 1131
void*_tmp273=Cyc_Absyn_compress(t);void*_stmttmp2C=_tmp273;void*_tmp274=_stmttmp2C;struct Cyc_List_List*_tmp275;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp274)->tag == 5U){_LL1C: _tmp275=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp274)->f1).tvars;_LL1D: {struct Cyc_List_List*btvs=_tmp275;
# 1133
if(((int(*)(int(*pred)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*x))Cyc_List_exists)(Cyc_CurRgn_is_curr_rgn,btvs))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp277=({struct Cyc_Warn_String_Warn_Warg_struct _tmp312;_tmp312.tag=0U,({struct _fat_ptr _tmp407=({const char*_tmp27C="cannot abstract current region ";_tag_fat(_tmp27C,sizeof(char),32U);});_tmp312.f1=_tmp407;});_tmp312;});struct Cyc_Warn_String_Warn_Warg_struct _tmp278=({struct Cyc_Warn_String_Warn_Warg_struct _tmp311;_tmp311.tag=0U,_tmp311.f1=Cyc_CurRgn_curr_rgn_name;_tmp311;});struct Cyc_Warn_String_Warn_Warg_struct _tmp279=({struct Cyc_Warn_String_Warn_Warg_struct _tmp310;_tmp310.tag=0U,({struct _fat_ptr _tmp408=({const char*_tmp27B=" in ";_tag_fat(_tmp27B,sizeof(char),5U);});_tmp310.f1=_tmp408;});_tmp310;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp27A=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp30F;_tmp30F.tag=2U,_tmp30F.f1=(void*)t;_tmp30F;});void*_tmp276[4U];_tmp276[0]=& _tmp277,_tmp276[1]=& _tmp278,_tmp276[2]=& _tmp279,_tmp276[3]=& _tmp27A;({unsigned _tmp409=loc;Cyc_Warn_err2(_tmp409,_tag_fat(_tmp276,sizeof(void*),4U));});});
...
{void*_tmp27D=Cyc_Absyn_compress(t);void*_stmttmp2D=_tmp27D;void*_tmp27E=_stmttmp2D;struct Cyc_Absyn_FnInfo _tmp27F;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp27E)->tag == 5U){_LL1: _tmp27F=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp27E)->f1;_LL2: {struct Cyc_Absyn_FnInfo i=_tmp27F;
# 1150
struct Cyc_List_List*_tmp280=(fd->i).attributes;struct Cyc_List_List*atts=_tmp280;
fd->i=i;
(fd->i).attributes=atts;
({int _tmp40A=
Cyc_Tcutil_extract_const_from_typedef(loc,(i.ret_tqual).print_const,i.ret_type);
# 1153
((fd->i).ret_tqual).real_const=_tmp40A;});
# 1155
goto _LL0;}}else{_LL3: _LL4:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp282=({struct Cyc_Warn_String_Warn_Warg_struct _tmp314;_tmp314.tag=0U,({struct _fat_ptr _tmp40B=({const char*_tmp283="check_fndecl_valid_type: not a FnType";_tag_fat(_tmp283,sizeof(char),38U);});_tmp314.f1=_tmp40B;});_tmp314;});void*_tmp281[1U];_tmp281[0]=& _tmp282;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp281,sizeof(void*),1U));});}_LL0:;}{
# 1158
struct Cyc_List_List*_tmp284=0;struct Cyc_List_List*argnames=_tmp284;
{struct Cyc_List_List*_tmp285=(fd->i).args;struct Cyc_List_List*args=_tmp285;for(0;args != 0;args=args->tl){
argnames=({struct Cyc_List_List*_tmp286=_cycalloc(sizeof(*_tmp286));_tmp286->hd=(struct _fat_ptr*)_check_null((*((struct _tuple9*)args->hd)).f1),_tmp286->tl=argnames;_tmp286;});}}
({struct Cyc_List_List*_tmp40D=argnames;unsigned _tmp40C=loc;Cyc_Tcutil_check_unique_vars(_tmp40D,_tmp40C,({const char*_tmp287="function declaration has repeated parameter";_tag_fat(_tmp287,sizeof(char),44U);}));});
# 1163
fd->cached_type=t;}}
# 1168
...
# 1171
struct Cyc_Tctyp_CVTEnv _tmp288=({struct Cyc_Tctyp_CVTEnv _tmp410=({struct Cyc_Tctyp_CVTEnv _tmp319;_tmp319.loc=loc,_tmp319.te=te,_tmp319.kind_env=bound_tvars,_tmp319.fn_result=0,_tmp319.generalize_evars=0,_tmp319.free_vars=0,_tmp319.free_evars=0;_tmp319;});struct Cyc_Absyn_Kind*_tmp40F=expected_kind;int _tmp40E=allow_abs_aggr;Cyc_Tctyp_check_valid_type(_tmp410,_tmp40F,_tmp40E,t);});struct Cyc_Tctyp_CVTEnv cvt=_tmp288;
# 1173
struct Cyc_List_List*_tmp289=((struct Cyc_List_List*(*)(struct Cyc_List_List*tvs,struct Cyc_List_List*btvs,struct Cyc_Absyn_Tvar*(*get)(struct _tuple14*)))Cyc_Tctyp_remove_bound_tvars)(cvt.free_vars,bound_tvars,(struct Cyc_Absyn_Tvar*(*)(struct _tuple14*))Cyc_Core_fst);struct Cyc_List_List*free_tvs=_tmp289;
for(0;free_tvs != 0;free_tvs=free_tvs->tl){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp28B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp318;_tmp318.tag=0U,({struct _fat_ptr _tmp411=({const char*_tmp290="unbound type variable ";_tag_fat(_tmp290,sizeof(char),23U);});_tmp318.f1=_tmp411;});_tmp318;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp28C=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp317;_tmp317.tag=7U,_tmp317.f1=(*((struct _tuple14*)free_tvs->hd)).f1;_tmp317;});struct Cyc_Warn_String_Warn_Warg_struct _tmp28D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp316;_tmp316.tag=0U,({struct _fat_ptr _tmp412=({const char*_tmp28F=" in type ";_tag_fat(_tmp28F,sizeof(char),10U);});_tmp316.f1=_tmp412;});_tmp316;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp28E=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp315;_tmp315.tag=2U,_tmp315.f1=(void*)t;_tmp315;});void*_tmp28A[4U];_tmp28A[0]=& _tmp28B,_tmp28A[1]=& _tmp28C,_tmp28A[2]=& _tmp28D,_tmp28A[3]=& _tmp28E;({unsigned _tmp413=loc;Cyc_Warn_err2(_tmp413,_tag_fat(_tmp28A,sizeof(void*),4U));});});}
if(!allow_evars)
