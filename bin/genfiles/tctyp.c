...
# 52 "/tmp/cyclone/src/flags.h"
extern int Cyc_Flags_tovc_r;
enum Cyc_Flags_C_Compilers{Cyc_Flags_Gcc_c =0U,Cyc_Flags_Vc_c =1U};
# 34 "/tmp/cyclone/src/tctyp.h"
