...
accum);
# 145
void*Cyc_List_fold_right_c(void*(*f)(void*,void*,void*),void*,struct Cyc_List_List*
x,void*accum);
# 149
...
x);
# 202
struct Cyc_List_List*Cyc_List_rmerge_sort(struct _RegionHandle*,int(*cmp)(void*,
void*),struct Cyc_List_List*x);
# 208
struct Cyc_List_List*Cyc_List_rimp_merge_sort(int(*cmp)(void*,void*),struct Cyc_List_List*
x);
# 215
struct Cyc_List_List*Cyc_List_merge(int(*cmp)(void*,void*),struct Cyc_List_List*x,
struct Cyc_List_List*y);
# 218
struct Cyc_List_List*Cyc_List_rmerge(struct _RegionHandle*,int(*cmp)(void*,void*),
...
a,struct Cyc_List_List*b);extern char Cyc_List_Nth[4];struct Cyc_List_Nth_exn_struct{
char*tag;};
# 230
...
# 271
struct Cyc_List_List*Cyc_List_rzip3(struct _RegionHandle*r1,struct _RegionHandle*
r2,struct Cyc_List_List*x,struct Cyc_List_List*y,struct Cyc_List_List*z);struct
_tuple0{struct Cyc_List_List*f1;struct Cyc_List_List*f2;};
# 277
struct _tuple0 Cyc_List_split(struct Cyc_List_List*x);struct _tuple1{struct Cyc_List_List*
f1;struct Cyc_List_List*f2;struct Cyc_List_List*f3;};
# 281
...
void*Cyc_List_hd(struct Cyc_List_List*x){
# 44
if((struct Cyc_List_List*)x == 0){struct Cyc_Core_Failure_exn_struct _tmp45;const
char*_tmp44;struct Cyc_Core_Failure_exn_struct*_tmp43;(int)_throw((void*)((_tmp43=
_cycalloc(sizeof(*_tmp43)),((_tmp43[0]=((_tmp45.tag=Cyc_Core_Failure,((_tmp45.f1=((
_tmp44="hd",_tag_dyneither(_tmp44,sizeof(char),3))),_tmp45)))),_tmp43)))));}
# 45
return(void*)x->hd;}
# 49
struct Cyc_List_List*Cyc_List_tl(struct Cyc_List_List*x){
# 50
if((struct Cyc_List_List*)x == 0){struct Cyc_Core_Failure_exn_struct _tmp4B;const
char*_tmp4A;struct Cyc_Core_Failure_exn_struct*_tmp49;(int)_throw((void*)((_tmp49=
...
return x->tl;}
# 56
struct Cyc_List_List*Cyc_List_rlist(struct _RegionHandle*r,struct _dyneither_ptr
argv){
# 57
...
# 59
struct Cyc_List_List*_tmp4C;result=((_tmp4C=_region_malloc(r,sizeof(*_tmp4C)),((
_tmp4C->hd=(void*)*((void**)_check_dyneither_subscript(argv,sizeof(void*),i)),((
_tmp4C->tl=result,_tmp4C))))));}}
# 60
return result;}
# 65
...
{int i=(int)(_get_dyneither_size(argv,sizeof(void*))- 1);for(0;i >= 0;-- i){
# 68
struct Cyc_List_List*_tmp4D;result=((_tmp4D=_cycalloc(sizeof(*_tmp4D)),((_tmp4D->hd=(
void*)*((void**)_check_dyneither_subscript(argv,sizeof(void*),i)),((_tmp4D->tl=
result,_tmp4D))))));}}
# 69
return result;}
# 73
...
if(x == 0)return 0;
# 77
{struct Cyc_List_List*_tmp4E;result=((_tmp4E=_region_malloc(r2,sizeof(*_tmp4E)),((
_tmp4E->hd=(void*)((void*)x->hd),((_tmp4E->tl=0,_tmp4E))))));}
# 78
prev=result;
# 79
...
sizeof(*_tmp4F)),((_tmp4F->hd=(void*)((void*)x->hd),((_tmp4F->tl=0,_tmp4F)))));
# 81
...
if(x == 0)return 0;
# 96
{struct Cyc_List_List*_tmp50;result=((_tmp50=_region_malloc(r2,sizeof(*_tmp50)),((
_tmp50->hd=(void*)f((void*)x->hd),((_tmp50->tl=0,_tmp50))))));}
# 97
prev=result;
# 98
for(x=x->tl;x != 0;x=x->tl){
...
if(x == 0)return 0;
# 115
{struct Cyc_List_List*_tmp52;result=((_tmp52=_region_malloc(r2,sizeof(*_tmp52)),((
_tmp52->hd=(void*)f(env,(void*)x->hd),((_tmp52->tl=0,_tmp52))))));}
# 116
prev=result;
# 117
for(x=x->tl;x != 0;x=x->tl){
...
x){
# 126
return Cyc_List_rmap_c(Cyc_Core_heap_region,f,env,x);}char Cyc_List_List_mismatch[
14]="List_mismatch";
# 131
...
# 143
{struct Cyc_List_List*_tmp54;result=((_tmp54=_region_malloc(r3,sizeof(*_tmp54)),((
_tmp54->hd=(void*)f((void*)x->hd,(void*)y->hd),((_tmp54->tl=0,_tmp54))))));}
# 144
prev=result;
# 146
x=x->tl;
...
# 263
void*Cyc_List_fold_right_c(void*(*f)(void*,void*,void*),void*env,struct Cyc_List_List*
x,void*accum){
# 264
if(x == 0)return accum;else{
# 265
...
# 270
struct Cyc_List_List*Cyc_List_rrevappend(struct _RegionHandle*r2,struct Cyc_List_List*
x,struct Cyc_List_List*y){
# 272
while(x != 0){
# 273
{struct Cyc_List_List*_tmp56;y=((_tmp56=_region_malloc(r2,sizeof(*_tmp56)),((
_tmp56->hd=(void*)((void*)x->hd),((_tmp56->tl=y,_tmp56))))));}
# 274
x=x->tl;}
# 276
return y;}
...
_tmp57->hd=(void*)((void*)x->hd),((_tmp57->tl=0,_tmp57))))));}
# 319
prev=result;
# 320
for(x=x->tl;x != 0;x=x->tl){
# 321
struct Cyc_List_List*_tmp58;struct Cyc_List_List*temp=(_tmp58=_region_malloc(r2,
sizeof(*_tmp58)),((_tmp58->hd=(void*)((void*)x->hd),((_tmp58->tl=0,_tmp58)))));
# 322
prev->tl=(struct Cyc_List_List*)temp;
# 323
prev=temp;}
...
# 358
struct Cyc_List_List*Cyc_List_imp_merge(int(*less_eq)(void*,void*),struct Cyc_List_List*
a,struct Cyc_List_List*b){
# 359
...
# 420
Cyc_List_rimp_merge_sort(less_eq,(struct Cyc_List_List*)a),Cyc_List_rimp_merge_sort(
less_eq,(struct Cyc_List_List*)b));};};}
# 427
struct Cyc_List_List*Cyc_List_rmerge_sort(struct _RegionHandle*r2,int(*less_eq)(
void*,void*),struct Cyc_List_List*x){
# 428
...
void*),struct Cyc_List_List*a,struct Cyc_List_List*b){
# 436
struct Cyc_List_List*c;struct Cyc_List_List*d;
# 439
...
_tmp59->hd=(void*)((void*)a->hd),((_tmp59->tl=0,_tmp59))))));}
# 448
a=a->tl;}else{
# 450
{struct Cyc_List_List*_tmp5A;c=((_tmp5A=_region_malloc(r3,sizeof(*_tmp5A)),((
_tmp5A->hd=(void*)((void*)b->hd),((_tmp5A->tl=0,_tmp5A))))));}
# 451
b=b->tl;}
# 453
d=c;
...
if(less_eq((void*)a->hd,(void*)b->hd)<= 0){
# 459
{struct Cyc_List_List*_tmp5B;temp=((_tmp5B=_region_malloc(r3,sizeof(*_tmp5B)),((
_tmp5B->hd=(void*)((void*)a->hd),((_tmp5B->tl=0,_tmp5B))))));}
# 460
...
a=a->tl;}else{
# 464
{struct Cyc_List_List*_tmp5C;temp=((_tmp5C=_region_malloc(r3,sizeof(*_tmp5C)),((
_tmp5C->hd=(void*)((void*)b->hd),((_tmp5C->tl=0,_tmp5C))))));}
# 465
c->tl=(struct Cyc_List_List*)temp;
# 466
c=temp;
...
# 478
struct Cyc_List_List*Cyc_List_merge_sort(int(*less_eq)(void*,void*),struct Cyc_List_List*
x){
# 479
return Cyc_List_rmerge_sort(Cyc_Core_heap_region,less_eq,x);}
# 482
struct Cyc_List_List*Cyc_List_merge(int(*less_eq)(void*,void*),struct Cyc_List_List*
a,struct Cyc_List_List*b){
# 483
...
if(x == 0  || y == 0)(int)_throw((void*)& Cyc_List_List_mismatch_val);
# 546
{struct _tuple2*_tmp5F;struct Cyc_List_List*_tmp5E;result=((_tmp5E=_region_malloc(
r3,sizeof(*_tmp5E)),((_tmp5E->hd=((_tmp5F=_region_malloc(r4,sizeof(*_tmp5F)),((
_tmp5F->f1=(void*)x->hd,((_tmp5F->f2=(void*)y->hd,_tmp5F)))))),((_tmp5E->tl=0,
_tmp5E))))));}
# 547
prev=result;
# 549
...
while(x != 0  && y != 0){
# 553
{struct _tuple2*_tmp62;struct Cyc_List_List*_tmp61;temp=((_tmp61=_region_malloc(
r3,sizeof(*_tmp61)),((_tmp61->hd=((_tmp62=_region_malloc(r4,sizeof(*_tmp62)),((
_tmp62->f1=(void*)x->hd,((_tmp62->f2=(void*)y->hd,_tmp62)))))),((_tmp61->tl=0,
_tmp61))))));}
# 554
prev->tl=(struct Cyc_List_List*)temp;
# 555
...
struct Cyc_List_List*Cyc_List_zip(struct Cyc_List_List*x,struct Cyc_List_List*y){
# 564
return Cyc_List_rzip(Cyc_Core_heap_region,Cyc_Core_heap_region,x,y);}struct
_tuple3{void*f1;void*f2;void*f3;};
# 567
struct Cyc_List_List*Cyc_List_rzip3(struct _RegionHandle*r3,struct _RegionHandle*
r4,struct Cyc_List_List*x,struct Cyc_List_List*y,struct Cyc_List_List*z){
# 569
struct Cyc_List_List*result;struct Cyc_List_List*prev;struct Cyc_List_List*temp;
# 571
...
# 574
{struct _tuple3*_tmp65;struct Cyc_List_List*_tmp64;result=((_tmp64=_region_malloc(
r3,sizeof(*_tmp64)),((_tmp64->hd=((_tmp65=_region_malloc(r4,sizeof(*_tmp65)),((
_tmp65->f1=(void*)x->hd,((_tmp65->f2=(void*)y->hd,((_tmp65->f3=(void*)z->hd,
_tmp65)))))))),((_tmp64->tl=0,_tmp64))))));}
# 575
prev=result;
# 577
x=x->tl;
...
while((x != 0  && y != 0) && z != 0){
# 582
{struct _tuple3*_tmp68;struct Cyc_List_List*_tmp67;temp=((_tmp67=_region_malloc(
...
_tmp6A)))))));}
# 607
{struct Cyc_List_List*_tmp6B;prev2=(result2=((_tmp6B=_region_malloc(r4,sizeof(*
_tmp6B)),((_tmp6B->hd=(void*)(((struct _tuple2*)x->hd)[0]).f2,((_tmp6B->tl=0,
_tmp6B)))))));}
# 609
for(x=x->tl;x != 0;x=x->tl){
# 610
{struct Cyc_List_List*_tmp6C;temp1=((_tmp6C=_region_malloc(r3,sizeof(*_tmp6C)),((
_tmp6C->hd=(void*)(((struct _tuple2*)x->hd)[0]).f1,((_tmp6C->tl=0,_tmp6C))))));}
# 611
{struct Cyc_List_List*_tmp6D;temp2=((_tmp6D=_region_malloc(r4,sizeof(*_tmp6D)),((
_tmp6D->hd=(void*)(((struct _tuple2*)x->hd)[0]).f2,((_tmp6D->tl=0,_tmp6D))))));}
# 612
...
prev2=temp2;}{
# 617
struct _tuple0 _tmp6E;return(_tmp6E.f1=(struct Cyc_List_List*)result1,((_tmp6E.f2=(
struct Cyc_List_List*)result2,_tmp6E)));};}
# 620
...
# 633
if(x == 0){struct _tuple1 _tmp6F;return(_tmp6F.f1=0,((_tmp6F.f2=0,((_tmp6F.f3=0,
_tmp6F)))));}
# 635
{struct Cyc_List_List*_tmp70;prev1=(result1=((_tmp70=_region_malloc(r3,sizeof(*
_tmp70)),((_tmp70->hd=(void*)(((struct _tuple3*)x->hd)[0]).f1,((_tmp70->tl=0,
_tmp70)))))));}
# 636
{struct Cyc_List_List*_tmp71;prev2=(result2=((_tmp71=_region_malloc(r4,sizeof(*
_tmp71)),((_tmp71->hd=(void*)(((struct _tuple3*)x->hd)[0]).f2,((_tmp71->tl=0,
_tmp71)))))));}
# 637
{struct Cyc_List_List*_tmp72;prev3=(result3=((_tmp72=_region_malloc(r5,sizeof(*
_tmp72)),((_tmp72->hd=(void*)(((struct _tuple3*)x->hd)[0]).f3,((_tmp72->tl=0,
_tmp72)))))));}
# 639
for(x=x->tl;x != 0;x=x->tl){
# 640
{struct Cyc_List_List*_tmp73;temp1=((_tmp73=_region_malloc(r3,sizeof(*_tmp73)),((
_tmp73->hd=(void*)(((struct _tuple3*)x->hd)[0]).f1,((_tmp73->tl=0,_tmp73))))));}
# 641
{struct Cyc_List_List*_tmp74;temp2=((_tmp74=_region_malloc(r4,sizeof(*_tmp74)),((
_tmp74->hd=(void*)(((struct _tuple3*)x->hd)[0]).f2,((_tmp74->tl=0,_tmp74))))));}
# 642
{struct Cyc_List_List*_tmp75;temp3=((_tmp75=_region_malloc(r5,sizeof(*_tmp75)),((
_tmp75->hd=(void*)(((struct _tuple3*)x->hd)[0]).f3,((_tmp75->tl=0,_tmp75))))));}
# 643
prev1->tl=(struct Cyc_List_List*)temp1;
# 644
prev2->tl=(struct Cyc_List_List*)temp2;
...
struct _tuple1 Cyc_List_split3(struct Cyc_List_List*x){
# 654
return Cyc_List_rsplit3(Cyc_Core_heap_region,Cyc_Core_heap_region,Cyc_Core_heap_region,
x);}
# 660
int Cyc_List_memq(struct Cyc_List_List*l,void*x){
# 661
...
x=_tmp30;}
# 761
return 0;}struct _dyneither_ptr Cyc_List_rto_array(struct _RegionHandle*r2,struct
Cyc_List_List*x);static void _tmp7E(struct Cyc_List_List**x,unsigned int*_tmp7D,
unsigned int*_tmp7C,void***_tmp7A){for(*_tmp7D=0;*_tmp7D < *_tmp7C;(*_tmp7D)++){
# 770
void*_tmp78;(*_tmp7A)[*_tmp7D]=((_tmp78=(void*)((struct Cyc_List_List*)
_check_null(*x))->hd,((*x=(*x)->tl,_tmp78))));}}
# 765
struct _dyneither_ptr Cyc_List_rto_array(struct _RegionHandle*r2,struct Cyc_List_List*
x){
# 766
int s;
# 767
...
s=Cyc_List_length(x);
# 770
{unsigned int _tmp7D;unsigned int _tmp7C;struct _dyneither_ptr _tmp7B;void**_tmp7A;
unsigned int _tmp79;arr=((_tmp79=(unsigned int)s,((_tmp7A=(void**)_region_malloc(
r2,_check_times(sizeof(void*),_tmp79)),((_tmp7B=_tag_dyneither(_tmp7A,sizeof(
void*),_tmp79),((((_tmp7C=_tmp79,_tmp7E(& x,& _tmp7D,& _tmp7C,& _tmp7A))),_tmp7B))))))));}
# 773
return arr;}
# 776
struct _dyneither_ptr Cyc_List_to_array(struct Cyc_List_List*x){
...
# 784
struct Cyc_List_List*_tmp7F;ans=((_tmp7F=_region_malloc(r2,sizeof(*_tmp7F)),((
_tmp7F->hd=(void*)*((void**)_check_dyneither_subscript(arr,sizeof(void*),i)),((
_tmp7F->tl=ans,_tmp7F))))));}}
# 785
return ans;}
# 788
struct Cyc_List_List*Cyc_List_from_array(struct _dyneither_ptr arr){
...
{int i=0;for(0;i < n;++ i){
# 795
struct Cyc_List_List*_tmp80;res=((_tmp80=_region_malloc(r,sizeof(*_tmp80)),((
_tmp80->hd=(void*)f(i),((_tmp80->tl=res,_tmp80))))));}}
# 797
...
{int i=0;for(0;i < n;++ i){
# 807
struct Cyc_List_List*_tmp81;res=((_tmp81=_region_malloc(r,sizeof(*_tmp81)),((
_tmp81->hd=(void*)f(env,i),((_tmp81->tl=res,_tmp81))))));}}
# 809
return Cyc_List_imp_rev(res);}
# 812
struct Cyc_List_List*Cyc_List_tabulate_c(int n,void*(*f)(void*,int),void*env){
...
return 0;{
# 850
struct Cyc_List_List*_tmp82;struct Cyc_List_List*result=(_tmp82=_region_malloc(r,
sizeof(*_tmp82)),((_tmp82->hd=(void*)((void*)l->hd),((_tmp82->tl=0,_tmp82)))));
# 851
...
_tmp83->hd=(void*)((void*)l->hd),((_tmp83->tl=0,_tmp83))))));}
# 856
...
return 0;{
# 871
struct Cyc_List_List*_tmp84;struct Cyc_List_List*result=(_tmp84=_region_malloc(r,
sizeof(*_tmp84)),((_tmp84->hd=(void*)((void*)l->hd),((_tmp84->tl=0,_tmp84)))));
# 872
struct Cyc_List_List*end=result;
# 873
struct Cyc_List_List*temp;
...
if(f((void*)l->hd)){
# 876
{struct Cyc_List_List*_tmp85;temp=((_tmp85=_region_malloc(r,sizeof(*_tmp85)),((
_tmp85->hd=(void*)((void*)l->hd),((_tmp85->tl=0,_tmp85))))));}
# 877
end->tl=(struct Cyc_List_List*)temp;
# 878
end=temp;}}
