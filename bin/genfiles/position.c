...
return({struct Cyc_String_pa_PrintArg_struct _tmp3=({struct Cyc_String_pa_PrintArg_struct _tmp26;_tmp26.tag=0,_tmp26.f1=(struct _fat_ptr)((struct _fat_ptr)pos->logical_file);_tmp26;});struct Cyc_Int_pa_PrintArg_struct _tmp4=({struct Cyc_Int_pa_PrintArg_struct _tmp25;_tmp25.tag=1,_tmp25.f1=(unsigned long)pos->line_no;_tmp25;});void*_tmp1[2];_tmp1[0]=& _tmp3,_tmp1[1]=& _tmp4;({struct _fat_ptr _tmp33=({const char*_tmp2="%s:%d";_tag_fat(_tmp2,sizeof(char),6U);});Cyc_aprintf(_tmp33,_tag_fat(_tmp1,sizeof(void*),2));});});else{
# 51
return({struct Cyc_String_pa_PrintArg_struct _tmp7=({struct Cyc_String_pa_PrintArg_struct _tmp29;_tmp29.tag=0,_tmp29.f1=(struct _fat_ptr)((struct _fat_ptr)pos->logical_file);_tmp29;});struct Cyc_Int_pa_PrintArg_struct _tmp8=({struct Cyc_Int_pa_PrintArg_struct _tmp28;_tmp28.tag=1,_tmp28.f1=(unsigned long)pos->line_no;_tmp28;});struct Cyc_Int_pa_PrintArg_struct _tmp9=({struct Cyc_Int_pa_PrintArg_struct _tmp27;_tmp27.tag=1,_tmp27.f1=(unsigned long)pos->col;_tmp27;});void*_tmp5[3];_tmp5[0]=& _tmp7,_tmp5[1]=& _tmp8,_tmp5[2]=& _tmp9;({struct _fat_ptr _tmp34=({const char*_tmp6="%s:(%d:%d)";_tag_fat(_tmp6,sizeof(char),11U);});Cyc_aprintf(_tmp34,_tag_fat(_tmp5,sizeof(void*),3));});});}}
# 54
static struct _fat_ptr Cyc_Position_string_of_pos_pr(struct Cyc_Lineno_Pos*pos){
if(Cyc_Position_use_gcc_style_location)
return({struct Cyc_String_pa_PrintArg_struct _tmpC=({struct Cyc_String_pa_PrintArg_struct _tmp2B;_tmp2B.tag=0,_tmp2B.f1=(struct _fat_ptr)((struct _fat_ptr)pos->logical_file);_tmp2B;});struct Cyc_Int_pa_PrintArg_struct _tmpD=({struct Cyc_Int_pa_PrintArg_struct _tmp2A;_tmp2A.tag=1,_tmp2A.f1=(unsigned long)pos->line_no;_tmp2A;});void*_tmpA[2];_tmpA[0]=& _tmpC,_tmpA[1]=& _tmpD;({struct _fat_ptr _tmp35=({const char*_tmpB="%s:%d";_tag_fat(_tmpB,sizeof(char),6U);});Cyc_aprintf(_tmp35,_tag_fat(_tmpA,sizeof(void*),2));});});else{
# 58
return({struct Cyc_String_pa_PrintArg_struct _tmp10=({struct Cyc_String_pa_PrintArg_struct _tmp2E;_tmp2E.tag=0,_tmp2E.f1=(struct _fat_ptr)((struct _fat_ptr)pos->logical_file);_tmp2E;});struct Cyc_Int_pa_PrintArg_struct _tmp11=({struct Cyc_Int_pa_PrintArg_struct _tmp2D;_tmp2D.tag=1,_tmp2D.f1=(unsigned long)pos->line_no;_tmp2D;});struct Cyc_Int_pa_PrintArg_struct _tmp12=({struct Cyc_Int_pa_PrintArg_struct _tmp2C;_tmp2C.tag=1,_tmp2C.f1=(unsigned long)pos->col;_tmp2C;});void*_tmpE[3];_tmpE[0]=& _tmp10,_tmpE[1]=& _tmp11,_tmpE[2]=& _tmp12;({struct _fat_ptr _tmp36=({const char*_tmpF="%s:(%d:%d)";_tag_fat(_tmpF,sizeof(char),11U);});Cyc_aprintf(_tmp36,_tag_fat(_tmpE,sizeof(void*),3));});});}}
# 61
...
({void*_tmp19=0U;({struct Cyc___cycFILE*_tmp3F=Cyc_stderr;struct _fat_ptr _tmp3E=({const char*_tmp1A="\n";_tag_fat(_tmp1A,sizeof(char),2U);});Cyc_fprintf(_tmp3F,_tmp3E,_tag_fat(_tmp19,sizeof(void*),0));});});
Cyc_Position_first_error=0;}
# 136
if(Cyc_Position_num_errors <= Cyc_Position_max_errors)
# 138
({struct Cyc_String_pa_PrintArg_struct _tmp1D=({struct Cyc_String_pa_PrintArg_struct _tmp30;_tmp30.tag=0,({struct _fat_ptr _tmp40=(struct _fat_ptr)((struct _fat_ptr)Cyc_Position_string_of_segment(e->seg));_tmp30.f1=_tmp40;});_tmp30;});struct Cyc_String_pa_PrintArg_struct _tmp1E=({struct Cyc_String_pa_PrintArg_struct _tmp2F;_tmp2F.tag=0,_tmp2F.f1=(struct _fat_ptr)((struct _fat_ptr)e->desc);_tmp2F;});void*_tmp1B[2];_tmp1B[0]=& _tmp1D,_tmp1B[1]=& _tmp1E;({struct Cyc___cycFILE*_tmp42=Cyc_stderr;struct _fat_ptr _tmp41=({const char*_tmp1C="%s: %s\n";_tag_fat(_tmp1C,sizeof(char),8U);});Cyc_fprintf(_tmp42,_tmp41,_tag_fat(_tmp1B,sizeof(void*),2));});});
# 140
if(Cyc_Position_num_errors == Cyc_Position_max_errors)
({void*_tmp1F=0U;({struct Cyc___cycFILE*_tmp44=Cyc_stderr;struct _fat_ptr _tmp43=({const char*_tmp20="Too many error messages!\n";_tag_fat(_tmp20,sizeof(char),26U);});Cyc_fprintf(_tmp44,_tmp43,_tag_fat(_tmp1F,sizeof(void*),0));});});
# 143
...
if(pos_s != 0)
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp23=({struct Cyc_Int_pa_PrintArg_struct _tmp32;_tmp32.tag=1,_tmp32.f1=(unsigned long)pos_s->line_no;_tmp32;});struct Cyc_String_pa_PrintArg_struct _tmp24=({struct Cyc_String_pa_PrintArg_struct _tmp31;_tmp31.tag=0,_tmp31.f1=(struct _fat_ptr)((struct _fat_ptr)pos_s->logical_file);_tmp31;});void*_tmp21[2];_tmp21[0]=& _tmp23,_tmp21[1]=& _tmp24;({struct _fat_ptr _tmp45=({const char*_tmp22="\n#line %d \"%s\"\n";_tag_fat(_tmp22,sizeof(char),16U);});Cyc_aprintf(_tmp45,_tag_fat(_tmp21,sizeof(void*),2));});});else{
# 157
