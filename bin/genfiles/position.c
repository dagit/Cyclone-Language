...
# 34 "position.cyc"
int Cyc_Position_use_gcc_style_location=1;static char _tmp0[1]="";
# 37
...
Cyc_strncpy(_dyneither_ptr_plus(ans,sizeof(char),len_one),({const char*_tmp18="...";_tag_dyneither(_tmp18,sizeof(char),4);}),3);
...
# 140
({struct Cyc_String_pa_PrintArg_struct _tmp1E;_tmp1E.tag=0;_tmp1E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)e->desc);({struct Cyc_String_pa_PrintArg_struct _tmp1D;_tmp1D.tag=0;_tmp1D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Position_string_of_segment(e->seg));({void*_tmp1B[2]={& _tmp1D,& _tmp1E};Cyc_fprintf(Cyc_stderr,({const char*_tmp1C="%s: %s\n";_tag_dyneither(_tmp1C,sizeof(char),8);}),_tag_dyneither(_tmp1B,sizeof(void*),2));});});});
# 142
if(Cyc_Position_num_errors == Cyc_Position_max_errors)
({void*_tmp1F=0;Cyc_fprintf(Cyc_stderr,({const char*_tmp20="Too many error messages!\n";_tag_dyneither(_tmp20,sizeof(char),26);}),_tag_dyneither(_tmp1F,sizeof(void*),0));});
# 145
...
if(pos_s != 0)
return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp24;_tmp24.tag=0;_tmp24.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)pos_s->logical_file);({struct Cyc_Int_pa_PrintArg_struct _tmp23;_tmp23.tag=1;_tmp23.f1=(unsigned long)pos_s->line_no;({void*_tmp21[2]={& _tmp23,& _tmp24};Cyc_aprintf(({const char*_tmp22="\n#line %d \"%s\"\n";_tag_dyneither(_tmp22,sizeof(char),16);}),_tag_dyneither(_tmp21,sizeof(void*),2));});});});else{
# 160
