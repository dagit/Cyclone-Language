...
int nsize=2 * osize + 1;
struct _fat_ptr ndata=({unsigned _Tmp0=nsize;_tag_fat(_region_calloc(t->r,0U,sizeof(struct Cyc_List_List*),_Tmp0),sizeof(struct Cyc_List_List*),_Tmp0);});
