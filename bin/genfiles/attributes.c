...
void*_tmp0=Cyc_Tcutil_compress(t);void*_stmttmp0=_tmp0;void*_tmp1=_stmttmp0;struct Cyc_List_List*_tmp2;void*_tmp3;switch(*((int*)_tmp1)){case 3U: _LL1: _tmp3=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp1)->f1).elt_type;_LL2: {void*elt=_tmp3;
...
void*_tmp7=Cyc_Tcutil_compress(t);void*_stmttmp2=_tmp7;void*_tmp8=_stmttmp2;struct Cyc_List_List**_tmp9;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp8)->tag == 5U){_LL1: _tmp9=(struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp8)->f1).attributes;_LL2: {struct Cyc_List_List**fnatts=_tmp9;
# 76
...
void*_tmp19=Cyc_Tcutil_compress(t);void*_stmttmp3=_tmp19;void*_tmp1A=_stmttmp3;struct Cyc_List_List*_tmp1C;struct Cyc_List_List*_tmp1B;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp1A)->tag == 5U){_LL1: _tmp1B=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp1A)->f1).attributes;_tmp1C=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp1A)->f1).args;_LL2: {struct Cyc_List_List*atts=_tmp1B;struct Cyc_List_List*args=_tmp1C;
# 107
