...
void*_tmp43=Cyc_Absyn_compress(t);void*_stmttmp2=_tmp43;void*_tmp44=_stmttmp2;struct Cyc_List_List*_tmp45;void*_tmp46;switch(*((int*)_tmp44)){case 3: _tmp46=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp44)->f1).elt_type;{void*elt=_tmp46;
...
void*_tmp47=(void*)atts->hd;void*_stmttmp3=_tmp47;void*_tmp48=_stmttmp3;if(*((int*)_tmp48)== 4)
return 1;else{
continue;};}
# 153
return 0;}default:
...
void*_tmp49=a;if(*((int*)_tmp49)== 0){if(((struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmp49)->f1 == 0)
...
void*_tmp4A=Cyc_Absyn_compress(t);void*_stmttmp4=_tmp4A;void*_tmp4B=_stmttmp4;struct Cyc_List_List**_tmp4C;if(*((int*)_tmp4B)== 5){_tmp4C=(struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp4B)->f1).attributes;{struct Cyc_List_List**fnatts=_tmp4C;
# 190
...
void*_tmp5C=Cyc_Absyn_compress(t);void*_stmttmp5=_tmp5C;void*_tmp5D=_stmttmp5;struct Cyc_List_List*_tmp5F;struct Cyc_List_List*_tmp5E;if(*((int*)_tmp5D)== 5){_tmp5E=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp5D)->f1).attributes;_tmp5F=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp5D)->f1).args;{struct Cyc_List_List*atts=_tmp5E;struct Cyc_List_List*args=_tmp5F;
# 221
int nargs=((int(*)(struct Cyc_List_List*))Cyc_List_length)(args);
for(1;atts != 0;atts=atts->tl){
void*_tmp60=(void*)atts->hd;void*_stmttmp6=_tmp60;void*_tmp61=_stmttmp6;int _tmp62;int _tmp63;int _tmp64;switch(*((int*)_tmp61)){case 20: _tmp64=((struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_tmp61)->f1;{int i=_tmp64;
# 225
...
goto _LL5;}}case 21: _tmp63=((struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*)_tmp61)->f1;{int i=_tmp63;
# 245
...
# 248
struct _tuple8*_tmp7C=((struct _tuple8*(*)(struct Cyc_List_List*,int))Cyc_List_nth)(args,i - 1);struct _tuple8*_stmttmp8=_tmp7C;struct _tuple8*_tmp7D=_stmttmp8;void*_tmp7E;_tmp7E=_tmp7D->f3;{void*t=_tmp7E;
...
goto _LL5;}}}case 22: _tmp62=((struct Cyc_Absyn_Consume_att_Absyn_Attribute_struct*)_tmp61)->f1;{int i=_tmp62;
# 254
if(!Cyc_Atts_fnTypeAttsRangeOK(loc,i,nargs,(void*)atts->hd))goto _LL5;
Cyc_Atts_fnTypeAttsOverlap(loc,i,consume_params,init_params);{
# 257
struct _tuple8*_tmp83=((struct _tuple8*(*)(struct Cyc_List_List*,int))Cyc_List_nth)(args,i - 1);struct _tuple8*_stmttmp9=_tmp83;struct _tuple8*_tmp84=_stmttmp9;void*_tmp85;_tmp85=_tmp84->f3;{void*t=_tmp85;
if(!Cyc_Tcutil_is_noalias_pointer(t,0))
...
void*_tmp90=(void*)t->hd;void*_stmttmpA=_tmp90;void*_tmp91=_stmttmpA;switch(*((int*)_tmp91)){case 23:
...
void*_tmp92=att;switch(*((int*)_tmp92)){case 0:
 return 0;case 1:
 return 1;case 2:
 return 2;case 3:
 return 3;case 4:
...
struct _tuple13 _tmp93=({struct _tuple13 _tmpDD;_tmpDD.f1=att1,_tmpDD.f2=att2;_tmpDD;});struct _tuple13 _stmttmpB=_tmp93;struct _tuple13 _tmp94=_stmttmpB;int _tmp9A;int _tmp99;enum Cyc_Absyn_Format_Type _tmp98;int _tmp97;int _tmp96;enum Cyc_Absyn_Format_Type _tmp95;struct _fat_ptr _tmp9C;struct _fat_ptr _tmp9B;struct Cyc_Absyn_Exp*_tmp9E;struct Cyc_Absyn_Exp*_tmp9D;int _tmpA0;int _tmp9F;int _tmpA2;int _tmpA1;switch(*((int*)_tmp94.f1)){case 0: if(*((int*)_tmp94.f2)== 0){_tmpA1=((struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmp94.f1)->f1;_tmpA2=((struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmp94.f2)->f1;{int i1=_tmpA1;int i2=_tmpA2;
_tmp9F=i1;_tmpA0=i2;goto _LL4;}}else{goto _LLB;}case 20: if(*((int*)_tmp94.f2)== 20){_tmp9F=((struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_tmp94.f1)->f1;_tmpA0=((struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_tmp94.f2)->f1;_LL4: {int i1=_tmp9F;int i2=_tmpA0;
return Cyc_Core_intcmp(i1,i2);}}else{goto _LLB;}case 6: if(*((int*)_tmp94.f2)== 6){_tmp9D=((struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)_tmp94.f1)->f1;_tmp9E=((struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)_tmp94.f2)->f1;{struct Cyc_Absyn_Exp*e1=_tmp9D;struct Cyc_Absyn_Exp*e2=_tmp9E;
# 322
if(e1 == e2)return 0;
if(e1 == 0)return - 1;
if(e2 == 0)return 1;
return Cyc_Evexp_exp_cmp(e1,e2);}}else{goto _LLB;}case 8: if(*((int*)_tmp94.f2)== 8){_tmp9B=((struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*)_tmp94.f1)->f1;_tmp9C=((struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*)_tmp94.f2)->f1;{struct _fat_ptr s1=_tmp9B;struct _fat_ptr s2=_tmp9C;
return Cyc_strcmp((struct _fat_ptr)s1,(struct _fat_ptr)s2);}}else{goto _LLB;}case 19: if(*((int*)_tmp94.f2)== 19){_tmp95=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmp94.f1)->f1;_tmp96=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmp94.f1)->f2;_tmp97=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmp94.f1)->f3;_tmp98=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmp94.f2)->f1;_tmp99=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmp94.f2)->f2;_tmp9A=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmp94.f2)->f3;{enum Cyc_Absyn_Format_Type ft1=_tmp95;int i1=_tmp96;int j1=_tmp97;enum Cyc_Absyn_Format_Type ft2=_tmp98;int i2=_tmp99;int j2=_tmp9A;
# 328
...
void*_tmpA5=a;int _tmpA6;switch(*((int*)_tmpA5)){case 0: _tmpA6=((struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmpA5)->f1;{int i=_tmpA6;
...
for(1;atts != 0;atts=atts->tl){
void*_tmpA7=(void*)atts->hd;void*_stmttmpC=_tmpA7;void*_tmpA8=_stmttmpC;switch(*((int*)_tmpA8)){case 6:
...
for(1;atts != 0;atts=atts->tl){
void*_tmpB2=(void*)atts->hd;void*_stmttmpD=_tmpB2;void*_tmpB3=_stmttmpD;switch(*((int*)_tmpB3)){case 6:
...
for(1;atts != 0;atts=atts->tl){
void*_tmpC6=(void*)atts->hd;void*_stmttmpF=_tmpC6;void*_tmpC7=_stmttmpF;switch(*((int*)_tmpC7)){case 4:
