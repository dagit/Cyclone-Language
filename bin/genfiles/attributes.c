...
static struct _tuple11 att_map[20U]={{.f0={_TmpG0,_TmpG0,_TmpG0 + 8U},.f1=(void*)& Cyc_Atts_Stdcall_att_val},{.f0={_TmpG1,_TmpG1,_TmpG1 + 6U},.f1=(void*)& Cyc_Atts_Cdecl_att_val},{.f0={_TmpG2,_TmpG2,_TmpG2 + 9U},.f1=(void*)& Cyc_Atts_Fastcall_att_val},{.f0={_TmpG3,_TmpG3,_TmpG3 + 9U},.f1=(void*)& Cyc_Atts_Noreturn_att_val},{.f0={_TmpG4,_TmpG4,_TmpG4 + 6U},.f1=(void*)& Cyc_Atts_Const_att_val},{.f0={_TmpG5,_TmpG5,_TmpG5 + 8U},.f1=(void*)& att_aligned},{.f0={_TmpG6,_TmpG6,_TmpG6 + 7U},.f1=(void*)& Cyc_Atts_Packed_att_val},{.f0={_TmpG7,_TmpG7,_TmpG7 + 7U},.f1=(void*)& Cyc_Atts_Shared_att_val},{.f0={_TmpG8,_TmpG8,_TmpG8 + 7U},.f1=(void*)& Cyc_Atts_Unused_att_val},{.f0={_TmpG9,_TmpG9,_TmpG9 + 5U},.f1=(void*)& Cyc_Atts_Weak_att_val},{.f0={_TmpGA,_TmpGA,_TmpGA + 10U},.f1=(void*)& Cyc_Atts_Dllimport_att_val},{.f0={_TmpGB,_TmpGB,_TmpGB + 10U},.f1=(void*)& Cyc_Atts_Dllexport_att_val},{.f0={_TmpGC,_TmpGC,_TmpGC + 23U},.f1=(void*)& Cyc_Atts_No_instrument_function_att_val},{.f0={_TmpGD,_TmpGD,_TmpGD + 12U},.f1=(void*)& Cyc_Atts_Constructor_att_val},{.f0={_TmpGE,_TmpGE,_TmpGE + 11U},.f1=(void*)& Cyc_Atts_Destructor_att_val},{.f0={_TmpGF,_TmpGF,_TmpGF + 22U},.f1=(void*)& Cyc_Atts_No_check_memory_usage_att_val},{.f0={_TmpG10,_TmpG10,_TmpG10 + 5U},.f1=(void*)& Cyc_Atts_Pure_att_val},{.f0={_TmpG11,_TmpG11,_TmpG11 + 14U},.f1=(void*)& Cyc_Atts_Always_inline_att_val},{.f0={_TmpG12,_TmpG12,_TmpG12 + 9U},.f1=(void*)& Cyc_Atts_No_throw_att_val},{.f0={_TmpG13,_TmpG13,_TmpG13 + 8U},.f1=(void*)& Cyc_Atts_No_throw_att_val}};
# 78
...
int i=0;
for(1;(unsigned)i < 20U;++ i){
if(Cyc_strcmp(s,(*((struct _tuple11*)_check_known_subscript_notnull(att_map,20U,sizeof(struct _tuple11),i))).f0)==0)
return att_map[i].f1;}
...
void*_Tmp0=Cyc_Absyn_compress(t);void*_Tmp1;switch(*((int*)_Tmp0)){case 4: _Tmp1=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp0)->f1.elt_type;{void*elt=_Tmp1;
return Cyc_Atts_is_noreturn_fn_type(elt);}case 6: _Tmp1=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp0)->f1.attributes;{struct Cyc_List_List*atts=_Tmp1;
# 149
...
void*_Tmp0=Cyc_Absyn_compress(t);void*_Tmp1;if(*((int*)_Tmp0)==6){_Tmp1=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp0)->f1.attributes;{struct Cyc_List_List**fnatts=(struct Cyc_List_List**)_Tmp1;
# 191
...
({struct Cyc_String_pa_PrintArg_struct _Tmp0=({struct Cyc_String_pa_PrintArg_struct _Tmp1;_Tmp1.tag=0,_Tmp1.f1=lst1.f1;_Tmp1;});struct Cyc_String_pa_PrintArg_struct _Tmp1=({struct Cyc_String_pa_PrintArg_struct _Tmp2;_Tmp2.tag=0,_Tmp2.f1=lst2.f1;_Tmp2;});struct Cyc_Int_pa_PrintArg_struct _Tmp2=({struct Cyc_Int_pa_PrintArg_struct _Tmp3;_Tmp3.tag=1,_Tmp3.f1=(unsigned long)i;_Tmp3;});void*_Tmp3[3];_Tmp3[0]=& _Tmp0,_Tmp3[1]=& _Tmp1,_Tmp3[2]=& _Tmp2;Cyc_Warn_err(loc,_tag_fat("incompatible %s() and %s() attributes on parameter %d",sizeof(char),54U),_tag_fat(_Tmp3,sizeof(void*),3));});}
# 216
...
void*_Tmp0=Cyc_Absyn_compress(t);void*_Tmp1;void*_Tmp2;void*_Tmp3;if(*((int*)_Tmp0)==6){_Tmp3=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp0)->f1.attributes;_Tmp2=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp0)->f1.args;_Tmp1=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_Tmp0)->f1.qual_bnd;{struct Cyc_List_List*atts=_Tmp3;struct Cyc_List_List*args=_Tmp2;struct Cyc_List_List*aqb=_Tmp1;
# 222
...
{void*_Tmp6=Cyc_Absyn_compress((*({struct _tuple8*(*_Tmp7)(struct Cyc_List_List*,int)=(struct _tuple8*(*)(struct Cyc_List_List*,int))Cyc_List_nth;_Tmp7;})(args,i - 1)).f2);void*_Tmp7;void*_Tmp8;void*_Tmp9;if(*((int*)_Tmp6)==4){_Tmp9=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp6)->f1.ptr_atts.nullable;_Tmp8=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp6)->f1.ptr_atts.bounds;_Tmp7=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp6)->f1.ptr_atts.zero_term;{void*nullable=_Tmp9;void*bd=_Tmp8;void*zt=_Tmp7;
# 233
...
if(!Cyc_Tcutil_is_bound_one(bd,1))
...
# 342
int _TmpB=Cyc_Atts_attribute_case_number(att1);return Cyc_Core_intcmp(_TmpB,
...
struct Cyc_List_List*_Tmp0=x;return Cyc_List_append(_Tmp0,Cyc_List_copy(a2));}}
# 418
