...
# 53
void*Cyc_Atts_parse_nullary_att(unsigned loc,struct _fat_ptr s){struct _fat_ptr _T0;unsigned _T1;struct _fat_ptr _T2;unsigned char*_T3;const char*_T4;char _T5;int _T6;struct _fat_ptr _T7;unsigned char*_T8;const char*_T9;char _TA;int _TB;struct _fat_ptr _TC;unsigned char*_TD;const char*_TE;struct _fat_ptr _TF;unsigned _T10;unsigned _T11;int _T12;char _T13;int _T14;struct _fat_ptr _T15;unsigned char*_T16;const char*_T17;struct _fat_ptr _T18;unsigned _T19;unsigned _T1A;int _T1B;char _T1C;int _T1D;struct _fat_ptr _T1E;struct _fat_ptr _T1F;unsigned _T20;unsigned _T21;int _T22;unsigned _T23;struct _fat_ptr _T24;struct _tuple11*_T25;int _T26;char*_T27;struct _tuple11*_T28;struct _tuple11 _T29;struct _fat_ptr _T2A;int _T2B;struct _tuple11*_T2C;int _T2D;struct _tuple11 _T2E;void*_T2F;void*_T30;
static struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct att_aligned={6,0};
static struct _tuple11 att_map[20U]={{.f0={_TmpG0,_TmpG0,_TmpG0 + 8U},.f1=(void*)((struct Cyc_Absyn_Stdcall_att_Absyn_Attribute_struct*)& Cyc_Atts_Stdcall_att_val)},{.f0={_TmpG1,_TmpG1,_TmpG1 + 6U},.f1=(void*)((struct Cyc_Absyn_Cdecl_att_Absyn_Attribute_struct*)& Cyc_Atts_Cdecl_att_val)},{.f0={_TmpG2,_TmpG2,_TmpG2 + 9U},.f1=(void*)((struct Cyc_Absyn_Fastcall_att_Absyn_Attribute_struct*)& Cyc_Atts_Fastcall_att_val)},{.f0={_TmpG3,_TmpG3,_TmpG3 + 9U},.f1=(void*)((struct Cyc_Absyn_Noreturn_att_Absyn_Attribute_struct*)& Cyc_Atts_Noreturn_att_val)},{.f0={_TmpG4,_TmpG4,_TmpG4 + 6U},.f1=(void*)((struct Cyc_Absyn_Const_att_Absyn_Attribute_struct*)& Cyc_Atts_Const_att_val)},{.f0={_TmpG5,_TmpG5,_TmpG5 + 8U},.f1=(void*)((struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)& att_aligned)},{.f0={_TmpG6,_TmpG6,_TmpG6 + 7U},.f1=(void*)((struct Cyc_Absyn_Packed_att_Absyn_Attribute_struct*)& Cyc_Atts_Packed_att_val)},{.f0={_TmpG7,_TmpG7,_TmpG7 + 7U},.f1=(void*)((struct Cyc_Absyn_Shared_att_Absyn_Attribute_struct*)& Cyc_Atts_Shared_att_val)},{.f0={_TmpG8,_TmpG8,_TmpG8 + 7U},.f1=(void*)((struct Cyc_Absyn_Unused_att_Absyn_Attribute_struct*)& Cyc_Atts_Unused_att_val)},{.f0={_TmpG9,_TmpG9,_TmpG9 + 5U},.f1=(void*)((struct Cyc_Absyn_Weak_att_Absyn_Attribute_struct*)& Cyc_Atts_Weak_att_val)},{.f0={_TmpGA,_TmpGA,_TmpGA + 10U},.f1=(void*)((struct Cyc_Absyn_Dllimport_att_Absyn_Attribute_struct*)& Cyc_Atts_Dllimport_att_val)},{.f0={_TmpGB,_TmpGB,_TmpGB + 10U},.f1=(void*)((struct Cyc_Absyn_Dllexport_att_Absyn_Attribute_struct*)& Cyc_Atts_Dllexport_att_val)},{.f0={_TmpGC,_TmpGC,_TmpGC + 23U},.f1=(void*)((struct Cyc_Absyn_No_instrument_function_att_Absyn_Attribute_struct*)& Cyc_Atts_No_instrument_function_att_val)},{.f0={_TmpGD,_TmpGD,_TmpGD + 12U},.f1=(void*)((struct Cyc_Absyn_Constructor_att_Absyn_Attribute_struct*)& Cyc_Atts_Constructor_att_val)},{.f0={_TmpGE,_TmpGE,_TmpGE + 11U},.f1=(void*)((struct Cyc_Absyn_Destructor_att_Absyn_Attribute_struct*)& Cyc_Atts_Destructor_att_val)},{.f0={_TmpGF,_TmpGF,_TmpGF + 22U},.f1=(void*)((struct Cyc_Absyn_No_check_memory_usage_att_Absyn_Attribute_struct*)& Cyc_Atts_No_check_memory_usage_att_val)},{.f0={_TmpG10,_TmpG10,_TmpG10 + 5U},.f1=(void*)((struct Cyc_Absyn_Pure_att_Absyn_Attribute_struct*)& Cyc_Atts_Pure_att_val)},{.f0={_TmpG11,_TmpG11,_TmpG11 + 14U},.f1=(void*)((struct Cyc_Absyn_Always_inline_att_Absyn_Attribute_struct*)& Cyc_Atts_Always_inline_att_val)},{.f0={_TmpG12,_TmpG12,_TmpG12 + 9U},.f1=(void*)((struct Cyc_Absyn_No_throw_att_Absyn_Attribute_struct*)& Cyc_Atts_No_throw_att_val)},{.f0={_TmpG13,_TmpG13,_TmpG13 + 8U},.f1=(void*)((struct Cyc_Absyn_No_throw_att_Absyn_Attribute_struct*)& Cyc_Atts_No_throw_att_val)}};_T0=s;_T1=
# 78
...
_TL3: _T24=s;_T25=att_map;_T26=i;_T27=_check_known_subscript_notnull(_T25,20U,sizeof(struct _tuple11),_T26);_T28=(struct _tuple11*)_T27;_T29=*_T28;_T2A=_T29.f0;_T2B=Cyc_strcmp(_T24,_T2A);if(_T2B!=0)goto _TL6;_T2C=att_map;_T2D=i;_T2E=_T2C[_T2D];_T2F=_T2E.f1;
return _T2F;_TL6:
# 82
 i=i + 1;goto _TL5;_TL4: _T30=
# 85
Cyc_Atts_bad_attribute(loc);return _T30;}}
# 88
...
return 1;}
# 188
struct Cyc_List_List*Cyc_Atts_transfer_fn_type_atts(void*t,struct Cyc_List_List*atts){int*_T0;int _T1;struct Cyc_Absyn_FnType_Absyn_Type_struct*_T2;struct Cyc_List_List**_T3;struct Cyc_List_List*_T4;void*_T5;int _T6;struct Cyc_List_List*_T7;struct Cyc_List_List*_T8;int(*_T9)(void*,void*);struct Cyc_List_List**_TA;struct Cyc_List_List*_TB;struct Cyc_List_List*_TC;void*_TD;int _TE;struct Cyc_List_List**_TF;struct Cyc_List_List*_T10;struct Cyc_List_List*_T11;struct Cyc_List_List**_T12;struct Cyc_List_List*_T13;struct Cyc_List_List*_T14;struct Cyc_Warn_String_Warn_Warg_struct _T15;void**_T16;int(*_T17)(struct _fat_ptr);void*(*_T18)(struct _fat_ptr);struct _fat_ptr _T19;
void*_T1A=Cyc_Absyn_compress(t);void*_T1B;_T0=(int*)_T1A;_T1=*_T0;if(_T1!=6)goto _TL65;{struct Cyc_Absyn_FnType_Absyn_Type_struct*_T1C=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T1A;_T2=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T1A;_T3=& _T2->f1.attributes;_T1B=(struct Cyc_List_List**)_T3;}{struct Cyc_List_List**fnatts=(struct Cyc_List_List**)_T1B;
# 191
...
_TL6D:{struct Cyc_List_List*_T1C=_cycalloc(sizeof(struct Cyc_List_List));_T8=atts;_T1C->hd=_T8->hd;_T1C->tl=res_atts;_T7=(struct Cyc_List_List*)_T1C;}res_atts=_T7;goto _TL6C;
...
_TL70: _TF=fnatts;{struct Cyc_List_List*_T1C=_cycalloc(sizeof(struct Cyc_List_List));_T11=atts;_T1C->hd=_T11->hd;_T12=fnatts;_T1C->tl=*_T12;_T10=(struct Cyc_List_List*)_T1C;}*_TF=_T10;goto _TL6F;_TL6E: _TL6F: _TL6C: _T13=atts;
# 192
atts=_T13->tl;goto _TL6A;_TL69: _T14=res_atts;
# 197
return _T14;}_TL65:{struct Cyc_Warn_String_Warn_Warg_struct _T1C;_T1C.tag=0;
_T1C.f1=_tag_fat("transfer_fn_type_atts",sizeof(char),22U);_T15=_T1C;}{struct Cyc_Warn_String_Warn_Warg_struct _T1C=_T15;void*_T1D[1];_T16=_T1D + 0;*_T16=& _T1C;_T18=Cyc_Warn_impos2;{int(*_T1E)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T18;_T17=_T1E;}_T19=_tag_fat(_T1D,sizeof(void*),1);_T17(_T19);};}
# 202
static int Cyc_Atts_fnTypeAttsRangeOK(unsigned loc,int i,int nargs,void*att){struct Cyc_Warn_Attribute_Warn_Warg_struct _T0;struct Cyc_Warn_String_Warn_Warg_struct _T1;void**_T2;void**_T3;unsigned _T4;struct _fat_ptr _T5;
if(i < 1)goto _TL73;else{goto _TL74;}_TL74: if(i > nargs)goto _TL73;else{goto _TL71;}
_TL73:{struct Cyc_Warn_Attribute_Warn_Warg_struct _T6;_T6.tag=10;_T6.f1=att;_T0=_T6;}{struct Cyc_Warn_Attribute_Warn_Warg_struct _T6=_T0;{struct Cyc_Warn_String_Warn_Warg_struct _T7;_T7.tag=0;_T7.f1=_tag_fat(" has an out-of-range index",sizeof(char),27U);_T1=_T7;}{struct Cyc_Warn_String_Warn_Warg_struct _T7=_T1;void*_T8[2];_T2=_T8 + 0;*_T2=& _T6;_T3=_T8 + 1;*_T3=& _T7;_T4=loc;_T5=_tag_fat(_T8,sizeof(void*),2);Cyc_Warn_err2(_T4,_T5);}}
return 0;_TL71:
# 207
 return 1;}struct _tuple12{struct Cyc_List_List*f0;struct _fat_ptr f1;};
# 209
static void Cyc_Atts_fnTypeAttsOverlap(unsigned loc,int i,struct _tuple12 lst1,struct _tuple12 lst2){int(*_T0)(struct Cyc_List_List*,int);int(*_T1)(struct Cyc_List_List*,void*);struct _tuple12 _T2;struct Cyc_List_List*_T3;int _T4;int _T5;struct Cyc_String_pa_PrintArg_struct _T6;struct _tuple12 _T7;struct Cyc_String_pa_PrintArg_struct _T8;struct _tuple12 _T9;struct Cyc_Int_pa_PrintArg_struct _TA;int _TB;void**_TC;void**_TD;void**_TE;unsigned _TF;struct _fat_ptr _T10;struct _fat_ptr _T11;_T1=Cyc_List_memq;{
# 212
int(*_T12)(struct Cyc_List_List*,int)=(int(*)(struct Cyc_List_List*,int))_T1;_T0=_T12;}_T2=lst2;_T3=_T2.f0;_T4=i;_T5=_T0(_T3,_T4);if(!_T5)goto _TL75;{struct Cyc_String_pa_PrintArg_struct _T12;_T12.tag=0;_T7=lst1;
# 214
_T12.f1=_T7.f1;_T6=_T12;}{struct Cyc_String_pa_PrintArg_struct _T12=_T6;{struct Cyc_String_pa_PrintArg_struct _T13;_T13.tag=0;_T9=lst2;_T13.f1=_T9.f1;_T8=_T13;}{struct Cyc_String_pa_PrintArg_struct _T13=_T8;{struct Cyc_Int_pa_PrintArg_struct _T14;_T14.tag=1;_TB=i;_T14.f1=(unsigned long)_TB;_TA=_T14;}{struct Cyc_Int_pa_PrintArg_struct _T14=_TA;void*_T15[3];_TC=_T15 + 0;*_TC=& _T12;_TD=_T15 + 1;*_TD=& _T13;_TE=_T15 + 2;*_TE=& _T14;_TF=loc;_T10=
# 213
_tag_fat("incompatible %s() and %s() attributes on parameter %d",sizeof(char),54U);_T11=_tag_fat(_T15,sizeof(void*),3);Cyc_Warn_err(_TF,_T10,_T11);}}}goto _TL76;_TL75: _TL76:;}
# 216
void Cyc_Atts_fnTypeAttsOK(unsigned loc,void*t){struct _tuple12 _T0;struct _tuple12 _T1;struct _tuple12 _T2;int*_T3;int _T4;struct Cyc_Absyn_FnInfo _T5;struct Cyc_Absyn_FnInfo _T6;struct Cyc_Absyn_FnInfo _T7;struct Cyc_List_List*_T8;int*_T9;unsigned _TA;unsigned _TB;int _TC;int _TD;struct Cyc_List_List*_TE;void*_TF;int _T10;struct _tuple8*(*_T11)(struct Cyc_List_List*,int);void*(*_T12)(struct Cyc_List_List*,int);struct Cyc_List_List*_T13;int _T14;struct _tuple8*_T15;struct _tuple8 _T16;void*_T17;int*_T18;int _T19;struct Cyc_Absyn_PtrInfo _T1A;struct Cyc_Absyn_PtrAtts _T1B;struct Cyc_Absyn_PtrInfo _T1C;struct Cyc_Absyn_PtrAtts _T1D;struct Cyc_Absyn_PtrInfo _T1E;struct Cyc_Absyn_PtrAtts _T1F;int _T20;struct Cyc_Warn_String_Warn_Warg_struct _T21;struct Cyc_Warn_String_Warn_Warg_struct _T22;void**_T23;void**_T24;unsigned _T25;struct _fat_ptr _T26;int _T27;struct Cyc_Warn_String_Warn_Warg_struct _T28;struct Cyc_Warn_String_Warn_Warg_struct _T29;void**_T2A;void**_T2B;unsigned _T2C;struct _fat_ptr _T2D;int _T2E;struct Cyc_Warn_String_Warn_Warg_struct _T2F;struct Cyc_Warn_String_Warn_Warg_struct _T30;void**_T31;void**_T32;unsigned _T33;struct _fat_ptr _T34;struct Cyc_Warn_String_Warn_Warg_struct _T35;struct Cyc_Warn_String_Warn_Warg_struct _T36;void**_T37;void**_T38;unsigned _T39;struct _fat_ptr _T3A;struct Cyc_List_List*_T3B;int _T3C;struct _tuple12 _T3D;unsigned _T3E;int _T3F;int _T40;struct Cyc_List_List*_T41;void*_T42;int _T43;struct _tuple8*(*_T44)(struct Cyc_List_List*,int);void*(*_T45)(struct Cyc_List_List*,int);struct Cyc_List_List*_T46;int _T47;int _T48;struct Cyc_Warn_String_Warn_Warg_struct _T49;void**_T4A;unsigned _T4B;struct _fat_ptr _T4C;struct Cyc_List_List*_T4D;int _T4E;struct _tuple12 _T4F;unsigned _T50;int _T51;int _T52;struct Cyc_List_List*_T53;void*_T54;int _T55;struct _tuple8*(*_T56)(struct Cyc_List_List*,int);void*(*_T57)(struct Cyc_List_List*,int);struct Cyc_List_List*_T58;int _T59;int _T5A;struct Cyc_Warn_String_Warn_Warg_struct _T5B;void**_T5C;unsigned _T5D;struct _fat_ptr _T5E;struct Cyc_List_List*_T5F;int _T60;struct _tuple12 _T61;struct Cyc_List_List*_T62;struct Cyc_Warn_String_Warn_Warg_struct _T63;void**_T64;int(*_T65)(struct _fat_ptr);void*(*_T66)(struct _fat_ptr);struct _fat_ptr _T67;{struct _tuple12 _T68;
_T68.f0=0;_T68.f1=_tag_fat("initializes",sizeof(char),12U);_T0=_T68;}{struct _tuple12 init_params=_T0;{struct _tuple12 _T68;
_T68.f0=0;_T68.f1=_tag_fat("noliveunique",sizeof(char),13U);_T1=_T68;}{struct _tuple12 nolive_unique_params=_T1;{struct _tuple12 _T68;
_T68.f0=0;_T68.f1=_tag_fat("consume",sizeof(char),8U);_T2=_T68;}{struct _tuple12 consume_params=_T2;
void*_T68=Cyc_Absyn_compress(t);struct Cyc_List_List*_T69;struct Cyc_List_List*_T6A;struct Cyc_List_List*_T6B;_T3=(int*)_T68;_T4=*_T3;if(_T4!=6)goto _TL77;{struct Cyc_Absyn_FnType_Absyn_Type_struct*_T6C=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T68;_T5=_T6C->f1;_T6B=_T5.attributes;_T6=_T6C->f1;_T6A=_T6.args;_T7=_T6C->f1;_T69=_T7.qual_bnd;}{struct Cyc_List_List*atts=_T6B;struct Cyc_List_List*args=_T6A;struct Cyc_List_List*aqb=_T69;
# 222
int nargs=Cyc_List_length(args);
_TL7C: if(atts!=0)goto _TL7A;else{goto _TL7B;}
_TL7A: _T8=atts;{void*_T6C=_T8->hd;int _T6D;_T9=(int*)_T6C;_TA=*_T9;switch(_TA){case 20:{struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*_T6E=(struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_T6C;_T6D=_T6E->f1;}{int i=_T6D;_TB=loc;_TC=i;_TD=nargs;_TE=atts;_TF=_TE->hd;_T10=
# 226
...
struct _tuple8*(*_T6E)(struct Cyc_List_List*,int)=(struct _tuple8*(*)(struct Cyc_List_List*,int))_T12;_T11=_T6E;}_T13=args;_T14=i - 1;_T15=_T11(_T13,_T14);_T16=*_T15;_T17=_T16.f2;{void*_T6E=Cyc_Absyn_compress(_T17);void*_T6F;void*_T70;void*_T71;_T18=(int*)_T6E;_T19=*_T18;if(_T19!=4)goto _TL81;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_T72=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T6E;_T1A=_T72->f1;_T1B=_T1A.ptr_atts;_T71=_T1B.nullable;_T1C=_T72->f1;_T1D=_T1C.ptr_atts;_T70=_T1D.bounds;_T1E=_T72->f1;_T1F=_T1E.ptr_atts;_T6F=_T1F.zero_term;}{void*nullable=_T71;void*bd=_T70;void*zt=_T6F;_T20=
# 233
Cyc_Tcutil_force_type2bool(0,nullable);if(!_T20)goto _TL83;{struct Cyc_Warn_String_Warn_Warg_struct _T72;_T72.tag=0;
_T72.f1=s;_T21=_T72;}{struct Cyc_Warn_String_Warn_Warg_struct _T72=_T21;{struct Cyc_Warn_String_Warn_Warg_struct _T73;_T73.tag=0;_T73.f1=_tag_fat(" non-null pointers",sizeof(char),19U);_T22=_T73;}{struct Cyc_Warn_String_Warn_Warg_struct _T73=_T22;void*_T74[2];_T23=_T74 + 0;*_T23=& _T72;_T24=_T74 + 1;*_T24=& _T73;_T25=loc;_T26=_tag_fat(_T74,sizeof(void*),2);Cyc_Warn_err2(_T25,_T26);}}goto _TL84;_TL83: _TL84: _T27=
Cyc_Tcutil_is_bound_one(bd,1);if(_T27)goto _TL85;else{goto _TL87;}
_TL87:{struct Cyc_Warn_String_Warn_Warg_struct _T72;_T72.tag=0;_T72.f1=s;_T28=_T72;}{struct Cyc_Warn_String_Warn_Warg_struct _T72=_T28;{struct Cyc_Warn_String_Warn_Warg_struct _T73;_T73.tag=0;_T73.f1=_tag_fat(" pointers of size 1",sizeof(char),20U);_T29=_T73;}{struct Cyc_Warn_String_Warn_Warg_struct _T73=_T29;void*_T74[2];_T2A=_T74 + 0;*_T2A=& _T72;_T2B=_T74 + 1;*_T2B=& _T73;_T2C=loc;_T2D=_tag_fat(_T74,sizeof(void*),2);Cyc_Warn_err2(_T2C,_T2D);}}goto _TL86;_TL85: _TL86: _T2E=
Cyc_Tcutil_force_type2bool(0,zt);if(!_T2E)goto _TL88;{struct Cyc_Warn_String_Warn_Warg_struct _T72;_T72.tag=0;
_T72.f1=s;_T2F=_T72;}{struct Cyc_Warn_String_Warn_Warg_struct _T72=_T2F;{struct Cyc_Warn_String_Warn_Warg_struct _T73;_T73.tag=0;_T73.f1=_tag_fat(" pointers to non-zero-terminated arrays",sizeof(char),40U);_T30=_T73;}{struct Cyc_Warn_String_Warn_Warg_struct _T73=_T30;void*_T74[2];_T31=_T74 + 0;*_T31=& _T72;_T32=_T74 + 1;*_T32=& _T73;_T33=loc;_T34=_tag_fat(_T74,sizeof(void*),2);Cyc_Warn_err2(_T33,_T34);}}goto _TL89;_TL88: _TL89: goto _LLE;}_TL81:{struct Cyc_Warn_String_Warn_Warg_struct _T72;_T72.tag=0;
# 241
_T72.f1=s;_T35=_T72;}{struct Cyc_Warn_String_Warn_Warg_struct _T72=_T35;{struct Cyc_Warn_String_Warn_Warg_struct _T73;_T73.tag=0;_T73.f1=_tag_fat(" pointers",sizeof(char),10U);_T36=_T73;}{struct Cyc_Warn_String_Warn_Warg_struct _T73=_T36;void*_T74[2];_T37=_T74 + 0;*_T37=& _T72;_T38=_T74 + 1;*_T38=& _T73;_T39=loc;_T3A=_tag_fat(_T74,sizeof(void*),2);Cyc_Warn_err2(_T39,_T3A);}}_LLE:;}{struct Cyc_List_List*_T6E=_cycalloc(sizeof(struct Cyc_List_List));_T3C=i;
# 243
_T6E->hd=(void*)_T3C;_T3D=init_params;_T6E->tl=_T3D.f0;_T3B=(struct Cyc_List_List*)_T6E;}init_params.f0=_T3B;goto _LL5;}}case 21:{struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*_T6E=(struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*)_T6C;_T6D=_T6E->f1;}{int i=_T6D;_T3E=loc;_T3F=i;_T40=nargs;_T41=atts;_T42=_T41->hd;_T43=
# 246
Cyc_Atts_fnTypeAttsRangeOK(_T3E,_T3F,_T40,_T42);if(_T43)goto _TL8A;else{goto _TL8C;}_TL8C: goto _LL5;_TL8A:
 Cyc_Atts_fnTypeAttsOverlap(loc,i,nolive_unique_params,init_params);_T45=Cyc_List_nth;{
# 249
struct _tuple8*(*_T6E)(struct Cyc_List_List*,int)=(struct _tuple8*(*)(struct Cyc_List_List*,int))_T45;_T44=_T6E;}_T46=args;_T47=i - 1;{struct _tuple8*_T6E=_T44(_T46,_T47);void*_T6F;{struct _tuple8 _T70=*_T6E;_T6F=_T70.f2;}{void*t=_T6F;_T48=
Cyc_Tcutil_is_noalias_pointer(aqb,t,0);if(_T48)goto _TL8D;else{goto _TL8F;}
_TL8F:{struct Cyc_Warn_String_Warn_Warg_struct _T70;_T70.tag=0;_T70.f1=_tag_fat("noliveunique allowed only on unique pointers",sizeof(char),45U);_T49=_T70;}{struct Cyc_Warn_String_Warn_Warg_struct _T70=_T49;void*_T71[1];_T4A=_T71 + 0;*_T4A=& _T70;_T4B=loc;_T4C=_tag_fat(_T71,sizeof(void*),1);Cyc_Warn_err2(_T4B,_T4C);}goto _TL8E;_TL8D: _TL8E:{struct Cyc_List_List*_T70=_cycalloc(sizeof(struct Cyc_List_List));_T4E=i;
_T70->hd=(void*)_T4E;_T4F=nolive_unique_params;_T70->tl=_T4F.f0;_T4D=(struct Cyc_List_List*)_T70;}nolive_unique_params.f0=_T4D;goto _LL5;}}}case 22:{struct Cyc_Absyn_Consume_att_Absyn_Attribute_struct*_T6E=(struct Cyc_Absyn_Consume_att_Absyn_Attribute_struct*)_T6C;_T6D=_T6E->f1;}{int i=_T6D;_T50=loc;_T51=i;_T52=nargs;_T53=atts;_T54=_T53->hd;_T55=
# 255
Cyc_Atts_fnTypeAttsRangeOK(_T50,_T51,_T52,_T54);if(_T55)goto _TL90;else{goto _TL92;}_TL92: goto _LL5;_TL90:
 Cyc_Atts_fnTypeAttsOverlap(loc,i,consume_params,init_params);_T57=Cyc_List_nth;{
# 258
struct _tuple8*(*_T6E)(struct Cyc_List_List*,int)=(struct _tuple8*(*)(struct Cyc_List_List*,int))_T57;_T56=_T6E;}_T58=args;_T59=i - 1;{struct _tuple8*_T6E=_T56(_T58,_T59);void*_T6F;{struct _tuple8 _T70=*_T6E;_T6F=_T70.f2;}{void*t=_T6F;_T5A=
Cyc_Tcutil_is_noalias_pointer(aqb,t,0);if(_T5A)goto _TL93;else{goto _TL95;}
_TL95:{struct Cyc_Warn_String_Warn_Warg_struct _T70;_T70.tag=0;_T70.f1=_tag_fat("consume allowed only on unique pointers",sizeof(char),40U);_T5B=_T70;}{struct Cyc_Warn_String_Warn_Warg_struct _T70=_T5B;void*_T71[1];_T5C=_T71 + 0;*_T5C=& _T70;_T5D=loc;_T5E=_tag_fat(_T71,sizeof(void*),1);Cyc_Warn_err2(_T5D,_T5E);}goto _TL94;_TL93: _TL94:{struct Cyc_List_List*_T70=_cycalloc(sizeof(struct Cyc_List_List));_T60=i;
_T70->hd=(void*)_T60;_T61=consume_params;_T70->tl=_T61.f0;_T5F=(struct Cyc_List_List*)_T70;}consume_params.f0=_T5F;goto _LL5;}}}default: goto _LL5;}_LL5:;}_T62=atts;
# 223
atts=_T62->tl;goto _TL7C;_TL7B: goto _LL0;}_TL77:{struct Cyc_Warn_String_Warn_Warg_struct _T6C;_T6C.tag=0;
# 267
_T6C.f1=_tag_fat("fnTypeAttsOK: not a function type",sizeof(char),34U);_T63=_T6C;}{struct Cyc_Warn_String_Warn_Warg_struct _T6C=_T63;void*_T6D[1];_T64=_T6D + 0;*_T64=& _T6C;_T66=Cyc_Warn_impos2;{int(*_T6E)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T66;_T65=_T6E;}_T67=_tag_fat(_T6D,sizeof(void*),1);_T65(_T67);}_LL0:;}}}}
# 272
...
# 325
int Cyc_Atts_attribute_cmp(void*att1,void*att2){struct _tuple13 _T0;void*_T1;int*_T2;unsigned _T3;void*_T4;int*_T5;int _T6;void*_T7;void*_T8;void*_T9;int*_TA;int _TB;void*_TC;void*_TD;int _TE;void*_TF;int*_T10;int _T11;void*_T12;void*_T13;int _T14;void*_T15;int*_T16;int _T17;void*_T18;void*_T19;int _T1A;void*_T1B;int*_T1C;int _T1D;void*_T1E;void*_T1F;enum Cyc_Absyn_Format_Type _T20;unsigned _T21;int _T22;enum Cyc_Absyn_Format_Type _T23;unsigned _T24;int _T25;int _T26;int _T27;int _T28;int _T29;int _T2A;int _T2B;{struct _tuple13 _T2C;
_T2C.f0=att1;_T2C.f1=att2;_T0=_T2C;}{struct _tuple13 _T2C=_T0;int _T2D;int _T2E;enum Cyc_Absyn_Format_Type _T2F;enum Cyc_Absyn_Format_Type _T30;struct _fat_ptr _T31;struct _fat_ptr _T32;struct Cyc_Absyn_Exp*_T33;struct Cyc_Absyn_Exp*_T34;int _T35;int _T36;_T1=_T2C.f0;_T2=(int*)_T1;_T3=*_T2;switch(_T3){case 0: _T4=_T2C.f1;_T5=(int*)_T4;_T6=*_T5;if(_T6!=0)goto _TLA9;_T7=_T2C.f0;{struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*_T37=(struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_T7;_T36=_T37->f1;}_T8=_T2C.f1;{struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*_T37=(struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_T8;_T35=_T37->f1;}{int i1=_T36;int i2=_T35;_T36=i1;_T35=i2;goto _LL4;}_TLA9: goto _LLB;case 20: _T9=_T2C.f1;_TA=(int*)_T9;_TB=*_TA;if(_TB!=20)goto _TLAB;_TC=_T2C.f0;{struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*_T37=(struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_TC;_T36=_T37->f1;}_TD=_T2C.f1;{struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*_T37=(struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_TD;_T35=_T37->f1;}_LL4:{int i1=_T36;int i2=_T35;_TE=
# 328
Cyc_Core_intcmp(i1,i2);return _TE;}_TLAB: goto _LLB;case 6: _TF=_T2C.f1;_T10=(int*)_TF;_T11=*_T10;if(_T11!=6)goto _TLAD;_T12=_T2C.f0;{struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_T37=(struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)_T12;_T34=_T37->f1;}_T13=_T2C.f1;{struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_T37=(struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)_T13;_T33=_T37->f1;}{struct Cyc_Absyn_Exp*e1=_T34;struct Cyc_Absyn_Exp*e2=_T33;
# 330
if(e1!=e2)goto _TLAF;return 0;_TLAF:
 if(e1!=0)goto _TLB1;return -1;_TLB1:
 if(e2!=0)goto _TLB3;return 1;_TLB3: _T14=
Cyc_Evexp_exp_cmp(e1,e2);return _T14;}_TLAD: goto _LLB;case 8: _T15=_T2C.f1;_T16=(int*)_T15;_T17=*_T16;if(_T17!=8)goto _TLB5;_T18=_T2C.f0;{struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*_T37=(struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*)_T18;_T32=_T37->f1;}_T19=_T2C.f1;{struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*_T37=(struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*)_T19;_T31=_T37->f1;}{struct _fat_ptr s1=_T32;struct _fat_ptr s2=_T31;_T1A=
Cyc_strcmp(s1,s2);return _T1A;}_TLB5: goto _LLB;case 19: _T1B=_T2C.f1;_T1C=(int*)_T1B;_T1D=*_T1C;if(_T1D!=19)goto _TLB7;_T1E=_T2C.f0;{struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*_T37=(struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_T1E;_T30=_T37->f1;_T36=_T37->f2;_T35=_T37->f3;}_T1F=_T2C.f1;{struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*_T37=(struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_T1F;_T2F=_T37->f1;_T2E=_T37->f2;_T2D=_T37->f3;}{enum Cyc_Absyn_Format_Type ft1=_T30;int i1=_T36;int j1=_T35;enum Cyc_Absyn_Format_Type ft2=_T2F;int i2=_T2E;int j2=_T2D;_T20=ft1;_T21=(unsigned)_T20;_T22=(int)_T21;_T23=ft2;_T24=(unsigned)_T23;_T25=(int)_T24;{
# 336
int ftc=Cyc_Core_intcmp(_T22,_T25);
if(ftc==0)goto _TLB9;_T26=ftc;return _T26;_TLB9: {
int ic=Cyc_Core_intcmp(i1,i2);
if(ic==0)goto _TLBB;_T27=ic;return _T27;_TLBB: _T28=
Cyc_Core_intcmp(j1,j2);return _T28;}}}_TLB7: goto _LLB;default: _LLB: _T29=
# 342
Cyc_Atts_attribute_case_number(att1);_T2A=
Cyc_Atts_attribute_case_number(att2);_T2B=
# 342
Cyc_Core_intcmp(_T29,_T2A);return _T2B;};}}
# 346
...
# 365
 ...
 return 0;};}
# 370
void Cyc_Atts_check_fndecl_atts(unsigned loc,struct Cyc_List_List*atts,int is_defn){struct Cyc_List_List*_T0;int*_T1;unsigned _T2;struct Cyc_Warn_String_Warn_Warg_struct _T3;struct Cyc_Warn_Attribute_Warn_Warg_struct _T4;struct Cyc_List_List*_T5;struct Cyc_Warn_String_Warn_Warg_struct _T6;void**_T7;void**_T8;void**_T9;unsigned _TA;struct _fat_ptr _TB;int _TC;struct Cyc_List_List*_TD;void*_TE;int _TF;struct Cyc_Warn_String_Warn_Warg_struct _T10;void**_T11;int(*_T12)(struct _fat_ptr);void*(*_T13)(struct _fat_ptr);struct _fat_ptr _T14;struct Cyc_List_List*_T15;
_TLC1: if(atts!=0)goto _TLBF;else{goto _TLC0;}
_TLBF: _T0=atts;{void*_T16=_T0->hd;_T1=(int*)_T16;_T2=*_T1;switch(_T2){case 6: goto _LL4;case 7: _LL4:{struct Cyc_Warn_String_Warn_Warg_struct _T17;_T17.tag=0;
# 375
_T17.f1=_tag_fat("bad attribute ",sizeof(char),15U);_T3=_T17;}{struct Cyc_Warn_String_Warn_Warg_struct _T17=_T3;{struct Cyc_Warn_Attribute_Warn_Warg_struct _T18;_T18.tag=10;_T5=atts;_T18.f1=_T5->hd;_T4=_T18;}{struct Cyc_Warn_Attribute_Warn_Warg_struct _T18=_T4;{struct Cyc_Warn_String_Warn_Warg_struct _T19;_T19.tag=0;_T19.f1=_tag_fat(" in function declaration",sizeof(char),25U);_T6=_T19;}{struct Cyc_Warn_String_Warn_Warg_struct _T19=_T6;void*_T1A[3];_T7=_T1A + 0;*_T7=& _T17;_T8=_T1A + 1;*_T8=& _T18;_T9=_T1A + 2;*_T9=& _T19;_TA=loc;_TB=_tag_fat(_T1A,sizeof(void*),3);Cyc_Warn_err2(_TA,_TB);}}}
return;default: _TC=is_defn;
# 378
if(_TC)goto _TLC3;else{goto _TLC5;}_TLC5: _TD=atts;_TE=_TD->hd;_TF=Cyc_Atts_fntype_att(_TE);if(!_TF)goto _TLC3;{struct Cyc_Warn_String_Warn_Warg_struct _T17;_T17.tag=0;
_T17.f1=_tag_fat("function-type att in function variable declaration",sizeof(char),51U);_T10=_T17;}{struct Cyc_Warn_String_Warn_Warg_struct _T17=_T10;void*_T18[1];_T11=_T18 + 0;*_T11=& _T17;_T13=Cyc_Warn_impos2;{int(*_T19)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T13;_T12=_T19;}_T14=_tag_fat(_T18,sizeof(void*),1);_T12(_T14);}goto _TLC4;_TLC3: _TLC4:;};}_T15=atts;
# 371
atts=_T15->tl;goto _TLC1;_TLC0:;}
# 383
void Cyc_Atts_check_variable_atts(unsigned loc,struct Cyc_Absyn_Vardecl*vd,struct Cyc_List_List*atts){struct Cyc_List_List*_T0;int*_T1;unsigned _T2;struct Cyc_Warn_String_Warn_Warg_struct _T3;struct Cyc_Warn_Attribute_Warn_Warg_struct _T4;struct Cyc_List_List*_T5;struct Cyc_Warn_String_Warn_Warg_struct _T6;struct Cyc_Warn_Vardecl_Warn_Warg_struct _T7;void**_T8;void**_T9;void**_TA;void**_TB;unsigned _TC;struct _fat_ptr _TD;struct Cyc_List_List*_TE;
_TLC9: if(atts!=0)goto _TLC7;else{goto _TLC8;}
_TLC7: _T0=atts;{void*_TF=_T0->hd;_T1=(int*)_TF;_T2=*_T1;switch(_T2){case 6: goto _LL4;case 8: _LL4: goto _LL6;case 9: _LL6: goto _LL8;case 10: _LL8: goto _LLA;case 11: _LLA: goto _LLC;case 12: _LLC: goto _LLE;case 13: _LLE: goto _LL10;case 14: _LL10: goto _TLC6;default:{struct Cyc_Warn_String_Warn_Warg_struct _T10;_T10.tag=0;
# 396
_T10.f1=_tag_fat("bad attribute ",sizeof(char),15U);_T3=_T10;}{struct Cyc_Warn_String_Warn_Warg_struct _T10=_T3;{struct Cyc_Warn_Attribute_Warn_Warg_struct _T11;_T11.tag=10;_T5=atts;_T11.f1=_T5->hd;_T4=_T11;}{struct Cyc_Warn_Attribute_Warn_Warg_struct _T11=_T4;{struct Cyc_Warn_String_Warn_Warg_struct _T12;_T12.tag=0;_T12.f1=_tag_fat(" for variable ",sizeof(char),15U);_T6=_T12;}{struct Cyc_Warn_String_Warn_Warg_struct _T12=_T6;{struct Cyc_Warn_Vardecl_Warn_Warg_struct _T13;_T13.tag=11;_T13.f1=vd;_T7=_T13;}{struct Cyc_Warn_Vardecl_Warn_Warg_struct _T13=_T7;void*_T14[4];_T8=_T14 + 0;*_T8=& _T10;_T9=_T14 + 1;*_T9=& _T11;_TA=_T14 + 2;*_TA=& _T12;_TB=_T14 + 3;*_TB=& _T13;_TC=loc;_TD=_tag_fat(_T14,sizeof(void*),4);Cyc_Warn_err2(_TC,_TD);}}}}};}_TLC6: _TE=atts;
# 384
atts=_TE->tl;goto _TLC9;_TLC8:;}
# 400
void Cyc_Atts_check_field_atts(unsigned loc,struct _fat_ptr*fn,struct Cyc_List_List*atts){struct Cyc_List_List*_T0;int*_T1;unsigned _T2;struct Cyc_Warn_String_Warn_Warg_struct _T3;struct Cyc_Warn_Attribute_Warn_Warg_struct _T4;struct Cyc_List_List*_T5;struct Cyc_Warn_String_Warn_Warg_struct _T6;struct Cyc_Warn_String_Warn_Warg_struct _T7;struct _fat_ptr*_T8;void**_T9;void**_TA;void**_TB;void**_TC;unsigned _TD;struct _fat_ptr _TE;struct Cyc_List_List*_TF;
_TLCE: if(atts!=0)goto _TLCC;else{goto _TLCD;}
_TLCC: _T0=atts;{void*_T10=_T0->hd;_T1=(int*)_T10;_T2=*_T1;switch(_T2){case 7: goto _LL4;case 6: _LL4: goto _TLCB;default:{struct Cyc_Warn_String_Warn_Warg_struct _T11;_T11.tag=0;
# 405
_T11.f1=_tag_fat("bad attribute ",sizeof(char),15U);_T3=_T11;}{struct Cyc_Warn_String_Warn_Warg_struct _T11=_T3;{struct Cyc_Warn_Attribute_Warn_Warg_struct _T12;_T12.tag=10;_T5=atts;_T12.f1=_T5->hd;_T4=_T12;}{struct Cyc_Warn_Attribute_Warn_Warg_struct _T12=_T4;{struct Cyc_Warn_String_Warn_Warg_struct _T13;_T13.tag=0;_T13.f1=_tag_fat(" on ",sizeof(char),5U);_T6=_T13;}{struct Cyc_Warn_String_Warn_Warg_struct _T13=_T6;{struct Cyc_Warn_String_Warn_Warg_struct _T14;_T14.tag=0;_T8=fn;_T14.f1=*_T8;_T7=_T14;}{struct Cyc_Warn_String_Warn_Warg_struct _T14=_T7;void*_T15[4];_T9=_T15 + 0;*_T9=& _T11;_TA=_T15 + 1;*_TA=& _T12;_TB=_T15 + 2;*_TB=& _T13;_TC=_T15 + 3;*_TC=& _T14;_TD=loc;_TE=_tag_fat(_T15,sizeof(void*),4);Cyc_Warn_err2(_TD,_TE);}}}}};}_TLCB: _TF=atts;
# 401
atts=_TF->tl;goto _TLCE;_TLCD:;}
# 410
