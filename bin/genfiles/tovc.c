...
continue;}
# 112
{int i=0;for(0;(unsigned int)i < _get_dyneither_size(Cyc_Toc_globals,sizeof(struct _dyneither_ptr*));++ i){
...
({struct Cyc_List_List*_tmp153=({struct Cyc_List_List*_tmp7F=_cycalloc(sizeof(*_tmp7F));({struct Cyc_Absyn_Decl*_tmp152=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*_tmp7E=_cycalloc(sizeof(*_tmp7E));_tmp7E->tag=1U,({struct Cyc_Absyn_Fndecl*_tmp151=({struct Cyc_Absyn_Fndecl*_tmp7D=_cycalloc(sizeof(*_tmp7D));_tmp7D->sc=Cyc_Absyn_Static,_tmp7D->is_inline=0,_tmp7D->name=funname,_tmp7D->tvs=0,_tmp7D->effect=0,({
struct Cyc_Absyn_Tqual _tmp150=Cyc_Absyn_empty_tqual(0U);_tmp7D->ret_tqual=_tmp150;}),_tmp7D->ret_type=rettype,_tmp7D->args=params,_tmp7D->c_varargs=0,_tmp7D->cyc_varargs=0,_tmp7D->rgn_po=0,_tmp7D->body=s,_tmp7D->cached_type=0,_tmp7D->param_vardecls=0,_tmp7D->fn_vardecl=0,_tmp7D->attributes=0,_tmp7D->requires_clause=0,_tmp7D->requires_relns=0,_tmp7D->ensures_clause=0,_tmp7D->ensures_relns=0;_tmp7D;});
# 374
_tmp7E->f1=_tmp151;});_tmp7E;}),0U);_tmp7F->hd=_tmp152;}),_tmp7F->tl=*env.gen_ds;_tmp7F;});*env.gen_ds=_tmp153;});
# 380
...
void*_tmp173=Cyc_Tcutil_fndecl2type(_tmp129);_tmp124->type=_tmp173;}),_tmp124->initializer=0,_tmp124->rgn=0,_tmp124->attributes=_tmp129->attributes,_tmp124->escapes=0;_tmp124;});
