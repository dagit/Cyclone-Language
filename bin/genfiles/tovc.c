...
char*tag;};struct Cyc_Iter_Iter{void*env;int(*next)(void*env,void*dest);};typedef
struct Cyc_Iter_Iter Cyc_Iter_iter_t;int Cyc_Iter_next(struct Cyc_Iter_Iter,void*);
...
tag;};struct Cyc_Dict_Dict Cyc_Dict_rempty(struct _RegionHandle*,int(*cmp)(void*,
void*));int Cyc_Dict_member(struct Cyc_Dict_Dict d,void*k);struct Cyc_Dict_Dict Cyc_Dict_insert(
struct Cyc_Dict_Dict d,void*k,void*v);void*Cyc_Dict_lookup(struct Cyc_Dict_Dict d,
void*k);struct Cyc_Dict_Dict Cyc_Dict_rdelete_same(struct Cyc_Dict_Dict,void*);int
Cyc_strptrcmp(struct _dyneither_ptr*s1,struct _dyneither_ptr*s2);struct Cyc_Lineno_Pos{
...
unsigned int);extern struct _tuple0*Cyc_Absyn_exn_name;void*Cyc_Absyn_cstar_typ(
void*t,struct Cyc_Absyn_Tqual tq);struct Cyc_Absyn_Exp*Cyc_Absyn_true_exp(
unsigned int);struct Cyc_Absyn_Exp*Cyc_Absyn_uint_exp(unsigned int,unsigned int);
struct Cyc_Absyn_Exp*Cyc_Absyn_var_exp(struct _tuple0*,unsigned int);struct Cyc_Absyn_Exp*
Cyc_Absyn_assign_exp(struct Cyc_Absyn_Exp*,struct Cyc_Absyn_Exp*,unsigned int);
...
Cyc_Absyn_Exp*,struct Cyc_Absyn_Exp*,unsigned int);struct Cyc_Absyn_Exp*Cyc_Absyn_fncall_exp(
struct Cyc_Absyn_Exp*,struct Cyc_List_List*,unsigned int);struct Cyc_Absyn_Exp*Cyc_Absyn_address_exp(
struct Cyc_Absyn_Exp*,unsigned int);struct Cyc_Absyn_Exp*Cyc_Absyn_deref_exp(
struct Cyc_Absyn_Exp*,unsigned int);struct Cyc_Absyn_Exp*Cyc_Absyn_subscript_exp(
struct Cyc_Absyn_Exp*,struct Cyc_Absyn_Exp*,unsigned int);struct Cyc_Absyn_Stmt*Cyc_Absyn_new_stmt(
void*s,unsigned int loc);struct Cyc_Absyn_Stmt*Cyc_Absyn_exp_stmt(struct Cyc_Absyn_Exp*
e,unsigned int loc);struct Cyc_Absyn_Stmt*Cyc_Absyn_seq_stmt(struct Cyc_Absyn_Stmt*
s1,struct Cyc_Absyn_Stmt*s2,unsigned int loc);struct Cyc_Absyn_Stmt*Cyc_Absyn_decl_stmt(
struct Cyc_Absyn_Decl*d,struct Cyc_Absyn_Stmt*s,unsigned int loc);struct Cyc_Absyn_Decl*
Cyc_Absyn_new_decl(void*r,unsigned int loc);struct Cyc_PP_Ppstate;typedef struct Cyc_PP_Ppstate*
...
struct _RegionHandle*r,struct Cyc_Set_Set*s,void*elt);extern char Cyc_Set_Absent[7];
struct Cyc_Set_Absent_exn_struct{char*tag;};struct Cyc_Iter_Iter Cyc_Set_make_iter(
struct _RegionHandle*rgn,struct Cyc_Set_Set*s);struct Cyc_RgnOrder_RgnPO;typedef
...
Cyc_Tcenv_Tenv*Cyc_Tcenv_tenv_t;void*Cyc_Tcutil_compress(void*t);void*Cyc_Tcutil_fndecl2typ(
struct Cyc_Absyn_Fndecl*);void Cyc_Tcutil_check_no_qual(unsigned int loc,void*t);
struct _tuple0*Cyc_Toc_temp_var();extern struct _dyneither_ptr Cyc_Toc_globals;
extern int Cyc_Tovc_elim_array_initializers;struct Cyc_List_List*Cyc_Tovc_tovc(
struct Cyc_List_List*decls);int Cyc_Tovc_elim_array_initializers=1;struct Cyc_Tovc_BoxingEnv{
struct _RegionHandle*rgn;struct Cyc_List_List*all_locals;struct Cyc_Dict_Dict varmap;
struct Cyc_List_List*boundvars;struct Cyc_Set_Set**freevars;};typedef struct Cyc_Tovc_BoxingEnv
Cyc_Tovc_boxingenv_t;struct Cyc_Tovc_ToExpEnv{struct _RegionHandle*rgn;struct Cyc_List_List*
all_locals;struct Cyc_Dict_Dict varmap;struct Cyc_Absyn_Stmt*encloser;struct Cyc_List_List**
gen_ds;};typedef struct Cyc_Tovc_ToExpEnv Cyc_Tovc_toexpenv_t;struct _tuple10{struct
Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};static void Cyc_Tovc_box_free_vars_exp(
struct Cyc_Tovc_BoxingEnv env,struct Cyc_Absyn_Exp*e){while(1){void*_tmp0=e->r;
struct _tuple0*_tmp2;struct _tuple0 _tmp3;union Cyc_Absyn_Nmspace _tmp4;int _tmp5;
struct _dyneither_ptr*_tmp6;struct Cyc_Absyn_Exp*_tmpA;struct Cyc_List_List*_tmpB;
struct Cyc_List_List*_tmpD;struct Cyc_Absyn_Exp*_tmpF;struct Cyc_Absyn_Exp*_tmp10;
struct Cyc_Absyn_Exp*_tmp11;struct Cyc_Absyn_Exp*_tmp13;struct Cyc_Absyn_Exp*_tmp14;
struct Cyc_Absyn_Exp*_tmp16;struct Cyc_Absyn_Exp*_tmp17;struct Cyc_Absyn_Exp*_tmp19;
struct Cyc_Absyn_Exp*_tmp1A;struct Cyc_Absyn_Exp*_tmp1C;struct Cyc_Absyn_Exp*_tmp1D;
struct Cyc_Absyn_Exp*_tmp1F;struct Cyc_Absyn_Exp*_tmp20;struct Cyc_Absyn_Exp*_tmp22;
struct Cyc_Absyn_Exp*_tmp24;struct Cyc_Absyn_Exp*_tmp26;struct Cyc_Absyn_Exp*_tmp28;
struct Cyc_Absyn_Exp*_tmp2A;struct Cyc_Absyn_Exp*_tmp2C;struct Cyc_Absyn_Exp*_tmp2E;
struct Cyc_Absyn_Exp*_tmp30;struct Cyc_Absyn_Exp*_tmp32;struct Cyc_List_List*_tmp37;
_LL1: {struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp1=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)
...
struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp3A=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)
_tmp39;if(_tmp3A->tag != 8)goto _LL36;}_LL35: goto _LL33;_LL36:;_LL37: e->r=(Cyc_Absyn_deref_exp(
...
env.all_locals)->hd)->name).f2)== 0){struct Cyc_Core_Impossible_exn_struct _tmp184;
const char*_tmp183;void*_tmp182[1];struct Cyc_String_pa_PrintArg_struct _tmp181;
struct Cyc_Core_Impossible_exn_struct*_tmp180;(int)_throw((void*)((_tmp180=
_cycalloc(sizeof(*_tmp180)),((_tmp180[0]=((_tmp184.tag=Cyc_Core_Impossible,((
_tmp184.f1=(struct _dyneither_ptr)((_tmp181.tag=0,((_tmp181.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)*_tmp6),((_tmp182[0]=& _tmp181,Cyc_aprintf(((
_tmp183="unbound variable %s found in box_free_vars_exp",_tag_dyneither(_tmp183,
sizeof(char),47))),_tag_dyneither(_tmp182,sizeof(void*),1)))))))),_tmp184)))),
_tmp180)))));}}return;_LL3: {struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp7=(
struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp7->tag != 1)goto _LL5;}
_LL4: return;_LL5: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp8=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)
_tmp0;if(_tmp8->tag != 0)goto _LL7;}_LL6: return;_LL7: {struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*
_tmp9=(struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp9->tag != 9)
goto _LL9;else{_tmpA=_tmp9->f1;_tmpB=_tmp9->f2;}}_LL8: Cyc_Tovc_box_free_vars_exp(
env,_tmpA);_tmpD=_tmpB;goto _LLA;_LL9: {struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*
_tmpC=(struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmpC->tag != 2)
goto _LLB;else{_tmpD=_tmpC->f2;}}_LLA: for(0;_tmpD != 0;_tmpD=_tmpD->tl){Cyc_Tovc_box_free_vars_exp(
env,(struct Cyc_Absyn_Exp*)_tmpD->hd);}return;_LLB: {struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*
_tmpE=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmpE->tag != 
5)goto _LLD;else{_tmpF=_tmpE->f1;_tmp10=_tmpE->f2;_tmp11=_tmpE->f3;}}_LLC: Cyc_Tovc_box_free_vars_exp(
env,_tmp11);_tmp13=_tmpF;_tmp14=_tmp10;goto _LLE;_LLD: {struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*
_tmp12=(struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp12->tag != 6)
goto _LLF;else{_tmp13=_tmp12->f1;_tmp14=_tmp12->f2;}}_LLE: _tmp16=_tmp13;_tmp17=
_tmp14;goto _LL10;_LLF: {struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_tmp15=(struct
Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp15->tag != 7)goto _LL11;else{
_tmp16=_tmp15->f1;_tmp17=_tmp15->f2;}}_LL10: _tmp19=_tmp16;_tmp1A=_tmp17;goto
_LL12;_LL11: {struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*_tmp18=(struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)
_tmp0;if(_tmp18->tag != 22)goto _LL13;else{_tmp19=_tmp18->f1;_tmp1A=_tmp18->f2;}}
_LL12: _tmp1C=_tmp19;_tmp1D=_tmp1A;goto _LL14;_LL13: {struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*
_tmp1B=(struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp1B->tag != 8)
goto _LL15;else{_tmp1C=_tmp1B->f1;_tmp1D=_tmp1B->f2;}}_LL14: _tmp1F=_tmp1C;_tmp20=
_tmp1D;goto _LL16;_LL15: {struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmp1E=(
struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp1E->tag != 3)goto
_LL17;else{_tmp1F=_tmp1E->f1;_tmp20=_tmp1E->f3;}}_LL16: Cyc_Tovc_box_free_vars_exp(
env,_tmp20);_tmp22=_tmp1F;goto _LL18;_LL17: {struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*
_tmp21=(struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp21->tag
!= 11)goto _LL19;else{_tmp22=_tmp21->f1;}}_LL18: _tmp24=_tmp22;goto _LL1A;_LL19: {
struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*_tmp23=(struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)
_tmp0;if(_tmp23->tag != 12)goto _LL1B;else{_tmp24=_tmp23->f1;}}_LL1A: _tmp26=_tmp24;
goto _LL1C;_LL1B: {struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp25=(struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)
_tmp0;if(_tmp25->tag != 13)goto _LL1D;else{_tmp26=_tmp25->f2;}}_LL1C: _tmp28=_tmp26;
goto _LL1E;_LL1D: {struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*_tmp27=(struct
Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp27->tag != 14)goto _LL1F;
else{_tmp28=_tmp27->f1;}}_LL1E: _tmp2A=_tmp28;goto _LL20;_LL1F: {struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*
_tmp29=(struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp29->tag != 
17)goto _LL21;else{_tmp2A=_tmp29->f1;}}_LL20: _tmp2C=_tmp2A;goto _LL22;_LL21: {
struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_tmp2B=(struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)
_tmp0;if(_tmp2B->tag != 19)goto _LL23;else{_tmp2C=_tmp2B->f1;}}_LL22: _tmp2E=_tmp2C;
goto _LL24;_LL23: {struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_tmp2D=(
struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp2D->tag != 20)
goto _LL25;else{_tmp2E=_tmp2D->f1;}}_LL24: _tmp30=_tmp2E;goto _LL26;_LL25: {struct
Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp2F=(struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)
_tmp0;if(_tmp2F->tag != 21)goto _LL27;else{_tmp30=_tmp2F->f1;}}_LL26: _tmp32=_tmp30;
goto _LL28;_LL27: {struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp31=(
struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp31->tag != 4)goto
_LL29;else{_tmp32=_tmp31->f1;}}_LL28: Cyc_Tovc_box_free_vars_exp(env,_tmp32);
return;_LL29: {struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*_tmp33=(struct
Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp33->tag != 16)goto _LL2B;}
_LL2A: goto _LL2C;_LL2B: {struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmp34=(
struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp34->tag != 18)goto
_LL2D;}_LL2C: goto _LL2E;_LL2D: {struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*
_tmp35=(struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp35->tag != 30)
goto _LL2F;}_LL2E: return;_LL2F: {struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*
_tmp36=(struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp36->tag
!= 34)goto _LL31;else{_tmp37=_tmp36->f2;}}_LL30: for(0;_tmp37 != 0;_tmp37=_tmp37->tl){
Cyc_Tovc_box_free_vars_exp(env,(*((struct _tuple10*)_tmp37->hd)).f2);}return;
_LL31:;_LL32: {struct Cyc_Core_Impossible_exn_struct _tmp18A;const char*_tmp189;
struct Cyc_Core_Impossible_exn_struct*_tmp188;(int)_throw((void*)((_tmp188=
_cycalloc(sizeof(*_tmp188)),((_tmp188[0]=((_tmp18A.tag=Cyc_Core_Impossible,((
_tmp18A.f1=((_tmp189="bad exp form in Tocv::box_free_vars_exp",_tag_dyneither(
_tmp189,sizeof(char),40))),_tmp18A)))),_tmp188)))));}_LL0:;}}static void Cyc_Tovc_box_free_vars_stmt(
...
_tmp52;struct Cyc_Absyn_Stmt*_tmp53;struct Cyc_Absyn_Stmt*_tmp54;struct _tuple9
_tmp56;struct Cyc_Absyn_Exp*_tmp57;struct Cyc_Absyn_Stmt*_tmp58;struct Cyc_Absyn_Exp*
_tmp5A;struct _tuple9 _tmp5B;struct Cyc_Absyn_Exp*_tmp5C;struct _tuple9 _tmp5D;struct
Cyc_Absyn_Exp*_tmp5E;struct Cyc_Absyn_Stmt*_tmp5F;struct Cyc_Absyn_Stmt*_tmp61;
struct _tuple9 _tmp62;struct Cyc_Absyn_Exp*_tmp63;struct Cyc_Absyn_Exp*_tmp65;struct
Cyc_List_List*_tmp66;struct Cyc_Absyn_Decl*_tmp68;struct Cyc_Absyn_Stmt*_tmp69;
_LL39: {struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*_tmp44=(struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*)
_tmp43;if(_tmp44->tag != 0)goto _LL3B;}_LL3A: goto _LL3C;_LL3B: {struct Cyc_Absyn_Break_s_Absyn_Raw_stmt_struct*
_tmp45=(struct Cyc_Absyn_Break_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp45->tag != 6)
goto _LL3D;}_LL3C: goto _LL3E;_LL3D: {struct Cyc_Absyn_Continue_s_Absyn_Raw_stmt_struct*
_tmp46=(struct Cyc_Absyn_Continue_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp46->tag
!= 7)goto _LL3F;}_LL3E: return;_LL3F: {struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*
_tmp47=(struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp47->tag != 8)
goto _LL41;}_LL40: return;_LL41: {struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*
_tmp48=(struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp48->tag != 
13)goto _LL43;else{_tmp49=_tmp48->f2;}}_LL42: s=_tmp49;continue;_LL43: {struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*
_tmp4A=(struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp4A->tag != 
3)goto _LL45;else{_tmp4B=_tmp4A->f1;}}_LL44: if(_tmp4B == 0)return;_tmp4D=(struct
Cyc_Absyn_Exp*)_tmp4B;goto _LL46;_LL45: {struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*
_tmp4C=(struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp4C->tag != 1)
goto _LL47;else{_tmp4D=_tmp4C->f1;}}_LL46: Cyc_Tovc_box_free_vars_exp(env,_tmp4D);
return;_LL47: {struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmp4E=(struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)
...
Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*_tmp51=(struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)
...
env,_tmp53);s=_tmp54;continue;_LL4B: {struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*
_tmp55=(struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp55->tag != 5)
goto _LL4D;else{_tmp56=_tmp55->f1;_tmp57=_tmp56.f1;_tmp58=_tmp55->f2;}}_LL4C: Cyc_Tovc_box_free_vars_exp(
env,_tmp57);s=_tmp58;continue;_LL4D: {struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*
_tmp59=(struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp59->tag != 9)
goto _LL4F;else{_tmp5A=_tmp59->f1;_tmp5B=_tmp59->f2;_tmp5C=_tmp5B.f1;_tmp5D=
_tmp59->f3;_tmp5E=_tmp5D.f1;_tmp5F=_tmp59->f4;}}_LL4E: Cyc_Tovc_box_free_vars_exp(
env,_tmp5A);Cyc_Tovc_box_free_vars_exp(env,_tmp5C);Cyc_Tovc_box_free_vars_exp(
env,_tmp5E);s=_tmp5F;continue;_LL4F: {struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*
_tmp60=(struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp60->tag != 14)
goto _LL51;else{_tmp61=_tmp60->f1;_tmp62=_tmp60->f2;_tmp63=_tmp62.f1;}}_LL50: Cyc_Tovc_box_free_vars_exp(
env,_tmp63);s=_tmp61;continue;_LL51: {struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*
_tmp64=(struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp64->tag != 
10)goto _LL53;else{_tmp65=_tmp64->f1;_tmp66=_tmp64->f2;}}_LL52: Cyc_Tovc_box_free_vars_exp(
env,_tmp65);for(0;_tmp66 != 0;_tmp66=_tmp66->tl){Cyc_Tovc_box_free_vars_stmt(env,((
struct Cyc_Absyn_Switch_clause*)_tmp66->hd)->body);}return;_LL53: {struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*
_tmp67=(struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp43;if(_tmp67->tag != 12)
goto _LL55;else{_tmp68=_tmp67->f1;_tmp69=_tmp67->f2;}}_LL54:{void*_tmp6A=_tmp68->r;
struct Cyc_Absyn_Vardecl*_tmp6C;_LL58: {struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*
_tmp6B=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp6A;if(_tmp6B->tag != 0)
goto _LL5A;else{_tmp6C=_tmp6B->f1;}}_LL59:{struct Cyc_List_List*_tmp18B;env.boundvars=((
_tmp18B=_region_malloc(env.rgn,sizeof(*_tmp18B)),((_tmp18B->hd=_tmp6C,((_tmp18B->tl=
env.boundvars,_tmp18B))))));}env.varmap=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,
struct _dyneither_ptr*))Cyc_Dict_rdelete_same)(env.varmap,(*_tmp6C->name).f2);if(
_tmp6C->initializer != 0)Cyc_Tovc_box_free_vars_exp(env,(struct Cyc_Absyn_Exp*)
_check_null(_tmp6C->initializer));s=_tmp69;continue;_LL5A:;_LL5B: goto _LL57;_LL57:;}
goto _LL56;_LL55:;_LL56: {struct Cyc_Core_Impossible_exn_struct _tmp191;const char*
_tmp190;struct Cyc_Core_Impossible_exn_struct*_tmp18F;(int)_throw((void*)((
_tmp18F=_cycalloc(sizeof(*_tmp18F)),((_tmp18F[0]=((_tmp191.tag=Cyc_Core_Impossible,((
_tmp191.f1=((_tmp190="bad stmt after xlation to C",_tag_dyneither(_tmp190,
sizeof(char),28))),_tmp191)))),_tmp18F)))));}_LL38:;}}static int Cyc_Tovc_stmt_to_fun_cmp(
struct Cyc_Absyn_Vardecl*x,struct Cyc_Absyn_Vardecl*y){return Cyc_Absyn_qvar_cmp(x->name,
y->name);}static struct Cyc_Absyn_Exp*Cyc_Tovc_stmt_to_fun(struct Cyc_Tovc_ToExpEnv
...
struct Cyc_Absyn_ArrayInfo _tmp75;void*_tmp76;_LL5D: {struct Cyc_Absyn_ArrayType_Absyn_Type_struct*
_tmp74=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp73;if(_tmp74->tag != 8)
goto _LL5F;else{_tmp75=_tmp74->f1;_tmp76=_tmp75.elt_type;}}_LL5E:{struct _tuple8*
_tmp196;struct Cyc_List_List*_tmp195;params=((_tmp195=_cycalloc(sizeof(*_tmp195)),((
_tmp195->hd=((_tmp196=_cycalloc(sizeof(*_tmp196)),((_tmp196->f1=(*_tmp72->name).f2,((
_tmp196->f2=_tmp72->tq,((_tmp196->f3=Cyc_Absyn_cstar_typ(_tmp76,Cyc_Absyn_empty_tqual(
0)),_tmp196)))))))),((_tmp195->tl=params,_tmp195))))));}{struct Cyc_List_List*
_tmp197;args=((_tmp197=_cycalloc(sizeof(*_tmp197)),((_tmp197->hd=Cyc_Absyn_var_exp(
_tmp72->name,0),((_tmp197->tl=args,_tmp197))))));}goto _LL5C;_LL5F:;_LL60:{struct
_tuple8*_tmp19A;struct Cyc_List_List*_tmp199;params=((_tmp199=_cycalloc(sizeof(*
_tmp199)),((_tmp199->hd=((_tmp19A=_cycalloc(sizeof(*_tmp19A)),((_tmp19A->f1=(*
_tmp72->name).f2,((_tmp19A->f2=_tmp72->tq,((_tmp19A->f3=Cyc_Absyn_cstar_typ(
_tmp72->type,Cyc_Absyn_empty_tqual(0)),_tmp19A)))))))),((_tmp199->tl=params,
_tmp199))))));}{struct Cyc_List_List*_tmp19B;args=((_tmp19B=_cycalloc(sizeof(*
_tmp19B)),((_tmp19B->hd=Cyc_Absyn_address_exp(Cyc_Absyn_var_exp(_tmp72->name,0),
0),((_tmp19B->tl=args,_tmp19B))))));}goto _LL5C;_LL5C:;}{struct _tuple0*funname=
Cyc_Toc_temp_var();{struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*_tmp1A5;struct Cyc_Absyn_Fndecl*
_tmp1A4;struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct _tmp1A3;struct Cyc_List_List*
_tmp1A2;*env.gen_ds=((_tmp1A2=_cycalloc(sizeof(*_tmp1A2)),((_tmp1A2->hd=Cyc_Absyn_new_decl((
void*)((_tmp1A5=_cycalloc(sizeof(*_tmp1A5)),((_tmp1A5[0]=((_tmp1A3.tag=1,((
_tmp1A3.f1=((_tmp1A4=_cycalloc(sizeof(*_tmp1A4)),((_tmp1A4->sc=Cyc_Absyn_Static,((
_tmp1A4->is_inline=0,((_tmp1A4->name=funname,((_tmp1A4->tvs=0,((_tmp1A4->effect=
0,((_tmp1A4->ret_tqual=Cyc_Absyn_empty_tqual(0),((_tmp1A4->ret_type=rettype,((
_tmp1A4->args=params,((_tmp1A4->c_varargs=0,((_tmp1A4->cyc_varargs=0,((_tmp1A4->rgn_po=
0,((_tmp1A4->body=s,((_tmp1A4->cached_typ=0,((_tmp1A4->param_vardecls=0,((
_tmp1A4->fn_vardecl=0,((_tmp1A4->attributes=0,_tmp1A4)))))))))))))))))))))))))))))))))),
_tmp1A3)))),_tmp1A5)))),0),((_tmp1A2->tl=*env.gen_ds,_tmp1A2))))));}return Cyc_Absyn_fncall_exp(
...
_tmpB3;struct Cyc_Absyn_Exp*_tmpB5;struct Cyc_List_List*_tmpBA;_LL62: {struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*
_tmp84=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmp84->tag != 1)
goto _LL64;else{_tmp85=_tmp84->f1;_tmp86=*_tmp85;_tmp87=_tmp86.f1;if((_tmp87.Loc_n).tag
!= 4)goto _LL64;_tmp88=(int)(_tmp87.Loc_n).val;_tmp89=_tmp86.f2;}}_LL63: if(((int(*)(
struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_member)(varmap,_tmp89))e->r=(((
struct Cyc_Absyn_Exp*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(
varmap,_tmp89))->r;return;_LL64: {struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*
_tmp8A=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmp8A->tag != 1)
goto _LL66;}_LL65: return;_LL66: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*
_tmp8B=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmp8B->tag != 0)
goto _LL68;}_LL67: return;_LL68: {struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*
_tmp8C=(struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmp8C->tag != 9)
goto _LL6A;else{_tmp8D=_tmp8C->f1;_tmp8E=_tmp8C->f2;}}_LL69: Cyc_Tovc_apply_varmap(
varmap,_tmp8D);_tmp90=_tmp8E;goto _LL6B;_LL6A: {struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*
_tmp8F=(struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmp8F->tag != 2)
goto _LL6C;else{_tmp90=_tmp8F->f2;}}_LL6B: for(0;_tmp90 != 0;_tmp90=_tmp90->tl){Cyc_Tovc_apply_varmap(
varmap,(struct Cyc_Absyn_Exp*)_tmp90->hd);}return;_LL6C: {struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*
_tmp91=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmp91->tag
!= 5)goto _LL6E;else{_tmp92=_tmp91->f1;_tmp93=_tmp91->f2;_tmp94=_tmp91->f3;}}
_LL6D: Cyc_Tovc_apply_varmap(varmap,_tmp94);_tmp96=_tmp92;_tmp97=_tmp93;goto _LL6F;
_LL6E: {struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_tmp95=(struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)
_tmp83;if(_tmp95->tag != 6)goto _LL70;else{_tmp96=_tmp95->f1;_tmp97=_tmp95->f2;}}
_LL6F: _tmp99=_tmp96;_tmp9A=_tmp97;goto _LL71;_LL70: {struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*
_tmp98=(struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmp98->tag != 7)
goto _LL72;else{_tmp99=_tmp98->f1;_tmp9A=_tmp98->f2;}}_LL71: _tmp9C=_tmp99;_tmp9D=
_tmp9A;goto _LL73;_LL72: {struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*_tmp9B=(
struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmp9B->tag != 22)
goto _LL74;else{_tmp9C=_tmp9B->f1;_tmp9D=_tmp9B->f2;}}_LL73: _tmp9F=_tmp9C;_tmpA0=
_tmp9D;goto _LL75;_LL74: {struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_tmp9E=(
struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmp9E->tag != 8)goto
_LL76;else{_tmp9F=_tmp9E->f1;_tmpA0=_tmp9E->f2;}}_LL75: _tmpA2=_tmp9F;_tmpA3=
_tmpA0;goto _LL77;_LL76: {struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmpA1=(
struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpA1->tag != 3)goto
_LL78;else{_tmpA2=_tmpA1->f1;_tmpA3=_tmpA1->f3;}}_LL77: Cyc_Tovc_apply_varmap(
varmap,_tmpA3);_tmpA5=_tmpA2;goto _LL79;_LL78: {struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*
_tmpA4=(struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpA4->tag
!= 11)goto _LL7A;else{_tmpA5=_tmpA4->f1;}}_LL79: _tmpA7=_tmpA5;goto _LL7B;_LL7A: {
struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*_tmpA6=(struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)
_tmp83;if(_tmpA6->tag != 12)goto _LL7C;else{_tmpA7=_tmpA6->f1;}}_LL7B: _tmpA9=
_tmpA7;goto _LL7D;_LL7C: {struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmpA8=(
struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpA8->tag != 13)goto
_LL7E;else{_tmpA9=_tmpA8->f2;}}_LL7D: _tmpAB=_tmpA9;goto _LL7F;_LL7E: {struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*
_tmpAA=(struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpAA->tag != 
14)goto _LL80;else{_tmpAB=_tmpAA->f1;}}_LL7F: _tmpAD=_tmpAB;goto _LL81;_LL80: {
struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*_tmpAC=(struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)
_tmp83;if(_tmpAC->tag != 17)goto _LL82;else{_tmpAD=_tmpAC->f1;}}_LL81: _tmpAF=
_tmpAD;goto _LL83;_LL82: {struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_tmpAE=(
struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpAE->tag != 19)goto
_LL84;else{_tmpAF=_tmpAE->f1;}}_LL83: _tmpB1=_tmpAF;goto _LL85;_LL84: {struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*
_tmpB0=(struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpB0->tag
!= 20)goto _LL86;else{_tmpB1=_tmpB0->f1;}}_LL85: _tmpB3=_tmpB1;goto _LL87;_LL86: {
struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmpB2=(struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)
_tmp83;if(_tmpB2->tag != 21)goto _LL88;else{_tmpB3=_tmpB2->f1;}}_LL87: _tmpB5=
_tmpB3;goto _LL89;_LL88: {struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmpB4=(
struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpB4->tag != 4)goto
_LL8A;else{_tmpB5=_tmpB4->f1;}}_LL89: Cyc_Tovc_apply_varmap(varmap,_tmpB5);
return;_LL8A: {struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*_tmpB6=(struct
Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpB6->tag != 16)goto _LL8C;}
_LL8B: goto _LL8D;_LL8C: {struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmpB7=(
struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpB7->tag != 18)goto
_LL8E;}_LL8D: goto _LL8F;_LL8E: {struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*
_tmpB8=(struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpB8->tag != 30)
goto _LL90;}_LL8F: return;_LL90: {struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*
_tmpB9=(struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmp83;if(_tmpB9->tag
!= 34)goto _LL92;else{_tmpBA=_tmpB9->f2;}}_LL91: for(0;_tmpBA != 0;_tmpBA=_tmpBA->tl){
Cyc_Tovc_apply_varmap(varmap,(*((struct _tuple10*)_tmpBA->hd)).f2);}return;_LL92:;
_LL93: {struct Cyc_Core_Impossible_exn_struct _tmp1AB;const char*_tmp1AA;struct Cyc_Core_Impossible_exn_struct*
_tmp1A9;(int)_throw((void*)((_tmp1A9=_cycalloc(sizeof(*_tmp1A9)),((_tmp1A9[0]=((
_tmp1AB.tag=Cyc_Core_Impossible,((_tmp1AB.f1=((_tmp1AA="bad exp form in Tocv::apply_varmap",
...
_tmpCB;_LL95: {struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*_tmpBF=(struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*)
_tmpBE;if(_tmpBF->tag != 0)goto _LL97;}_LL96: return Cyc_Absyn_true_exp(0);_LL97: {
struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*_tmpC0=(struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*)
_tmpBE;if(_tmpC0->tag != 1)goto _LL99;else{_tmpC1=_tmpC0->f1;}}_LL98: Cyc_Tovc_apply_varmap(
env.varmap,_tmpC1);return _tmpC1;_LL99: {struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*
_tmpC2=(struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmpBE;if(_tmpC2->tag != 2)
goto _LL9B;else{_tmpC3=_tmpC2->f1;_tmpC4=_tmpC2->f2;}}_LL9A: {struct Cyc_Absyn_Exp*
_tmpCC=Cyc_Tovc_stmt_to_exp(env,_tmpC3);struct Cyc_Absyn_Exp*_tmpCD=Cyc_Tovc_stmt_to_exp(
env,_tmpC4);return Cyc_Absyn_seq_exp(_tmpCC,_tmpCD,0);}_LL9B: {struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*
_tmpC5=(struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmpBE;if(_tmpC5->tag
!= 4)goto _LL9D;else{_tmpC6=_tmpC5->f1;_tmpC7=_tmpC5->f2;_tmpC8=_tmpC5->f3;}}
_LL9C: Cyc_Tovc_apply_varmap(env.varmap,_tmpC6);{struct Cyc_Absyn_Exp*_tmpCE=Cyc_Tovc_stmt_to_exp(
env,_tmpC7);struct Cyc_Absyn_Exp*_tmpCF=Cyc_Tovc_stmt_to_exp(env,_tmpC8);return
Cyc_Absyn_conditional_exp(_tmpC6,_tmpCE,_tmpCF,0);};_LL9D: {struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*
_tmpC9=(struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmpBE;if(_tmpC9->tag != 12)
goto _LL9F;else{_tmpCA=_tmpC9->f1;_tmpCB=_tmpC9->f2;}}_LL9E: {void*_tmpD0=_tmpCA->r;
struct Cyc_Absyn_Vardecl*_tmpD2;_LLA2: {struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*
_tmpD1=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmpD0;if(_tmpD1->tag != 0)
goto _LLA4;else{_tmpD2=_tmpD1->f1;}}_LLA3: {struct _dyneither_ptr*_tmpD3=(*_tmpD2->name).f2;
struct _tuple0*_tmpD4=Cyc_Toc_temp_var();_tmpD2->name=_tmpD4;env.varmap=((struct
Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Exp*
v))Cyc_Dict_insert)(env.varmap,_tmpD3,Cyc_Absyn_var_exp(_tmpD4,0));{struct Cyc_List_List*
_tmpD5=0;if(_tmpD2->initializer != 0){Cyc_Tovc_apply_varmap(env.varmap,(struct Cyc_Absyn_Exp*)
_check_null(_tmpD2->initializer));{void*_tmpD6=((struct Cyc_Absyn_Exp*)
_check_null(_tmpD2->initializer))->r;struct Cyc_List_List*_tmpD8;_LLA7: {struct
Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmpD7=(struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)
_tmpD6;if(_tmpD7->tag != 34)goto _LLA9;else{_tmpD8=_tmpD7->f2;}}_LLA8: {struct Cyc_Absyn_Exp*
_tmpD9=Cyc_Absyn_var_exp(_tmpD2->name,0);{unsigned int i=0;for(0;_tmpD8 != 0;(
_tmpD8=_tmpD8->tl,++ i)){struct Cyc_List_List*_tmp1AC;_tmpD5=((_tmp1AC=_cycalloc(
sizeof(*_tmp1AC)),((_tmp1AC->hd=Cyc_Absyn_assign_exp(Cyc_Absyn_subscript_exp(
_tmpD9,Cyc_Absyn_uint_exp(i,0),0),(*((struct _tuple10*)_tmpD8->hd)).f2,0),((
...
_LLA4:;_LLA5: {struct Cyc_Core_Impossible_exn_struct _tmp1B3;const char*_tmp1B2;
struct Cyc_Core_Impossible_exn_struct*_tmp1B1;(int)_throw((void*)((_tmp1B1=
_cycalloc(sizeof(*_tmp1B1)),((_tmp1B1[0]=((_tmp1B3.tag=Cyc_Core_Impossible,((
...
Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmpE1=(struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)
_tmpE0;if(_tmpE1->tag != 0)goto _LLAE;}_LLAD: return;_LLAE: {struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*
_tmpE2=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmpE2->tag != 1)
goto _LLB0;}_LLAF: return;_LLB0: {struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*
_tmpE3=(struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmpE3->tag != 9)
goto _LLB2;else{_tmpE4=_tmpE3->f1;_tmpE5=_tmpE3->f2;}}_LLB1: Cyc_Tovc_exp_to_vc(
env,_tmpE4);_tmpE7=_tmpE5;goto _LLB3;_LLB2: {struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*
_tmpE6=(struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmpE6->tag != 2)
goto _LLB4;else{_tmpE7=_tmpE6->f2;}}_LLB3: for(0;_tmpE7 != 0;_tmpE7=_tmpE7->tl){Cyc_Tovc_exp_to_vc(
env,(struct Cyc_Absyn_Exp*)_tmpE7->hd);}return;_LLB4: {struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*
_tmpE8=(struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmpE8->tag
!= 5)goto _LLB6;else{_tmpE9=_tmpE8->f1;_tmpEA=_tmpE8->f2;_tmpEB=_tmpE8->f3;}}
_LLB5: Cyc_Tovc_exp_to_vc(env,_tmpEB);_tmpED=_tmpE9;_tmpEE=_tmpEA;goto _LLB7;_LLB6: {
struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_tmpEC=(struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)
_tmpE0;if(_tmpEC->tag != 6)goto _LLB8;else{_tmpED=_tmpEC->f1;_tmpEE=_tmpEC->f2;}}
_LLB7: _tmpF0=_tmpED;_tmpF1=_tmpEE;goto _LLB9;_LLB8: {struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*
_tmpEF=(struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmpEF->tag != 7)
goto _LLBA;else{_tmpF0=_tmpEF->f1;_tmpF1=_tmpEF->f2;}}_LLB9: _tmpF3=_tmpF0;_tmpF4=
_tmpF1;goto _LLBB;_LLBA: {struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*_tmpF2=(
struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmpF2->tag != 22)
goto _LLBC;else{_tmpF3=_tmpF2->f1;_tmpF4=_tmpF2->f2;}}_LLBB: _tmpF6=_tmpF3;_tmpF7=
_tmpF4;goto _LLBD;_LLBC: {struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_tmpF5=(
struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmpF5->tag != 8)goto
_LLBE;else{_tmpF6=_tmpF5->f1;_tmpF7=_tmpF5->f2;}}_LLBD: _tmpF9=_tmpF6;_tmpFA=
_tmpF7;goto _LLBF;_LLBE: {struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmpF8=(
struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmpF8->tag != 3)goto
_LLC0;else{_tmpF9=_tmpF8->f1;_tmpFA=_tmpF8->f3;}}_LLBF: Cyc_Tovc_exp_to_vc(env,
_tmpFA);_tmpFC=_tmpF9;goto _LLC1;_LLC0: {struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*
_tmpFB=(struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmpFB->tag
!= 11)goto _LLC2;else{_tmpFC=_tmpFB->f1;}}_LLC1: _tmpFE=_tmpFC;goto _LLC3;_LLC2: {
struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*_tmpFD=(struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)
_tmpE0;if(_tmpFD->tag != 12)goto _LLC4;else{_tmpFE=_tmpFD->f1;}}_LLC3: _tmp100=
_tmpFE;goto _LLC5;_LLC4: {struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmpFF=(
struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmpFF->tag != 13)goto
_LLC6;else{_tmp100=_tmpFF->f2;}}_LLC5: _tmp102=_tmp100;goto _LLC7;_LLC6: {struct
Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*_tmp101=(struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)
_tmpE0;if(_tmp101->tag != 14)goto _LLC8;else{_tmp102=_tmp101->f1;}}_LLC7: _tmp104=
_tmp102;goto _LLC9;_LLC8: {struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*
_tmp103=(struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmp103->tag
!= 17)goto _LLCA;else{_tmp104=_tmp103->f1;}}_LLC9: _tmp106=_tmp104;goto _LLCB;_LLCA: {
struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_tmp105=(struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)
_tmpE0;if(_tmp105->tag != 19)goto _LLCC;else{_tmp106=_tmp105->f1;}}_LLCB: _tmp108=
_tmp106;goto _LLCD;_LLCC: {struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*
_tmp107=(struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmp107->tag
!= 20)goto _LLCE;else{_tmp108=_tmp107->f1;}}_LLCD: _tmp10A=_tmp108;goto _LLCF;_LLCE: {
struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp109=(struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)
_tmpE0;if(_tmp109->tag != 21)goto _LLD0;else{_tmp10A=_tmp109->f1;}}_LLCF: _tmp10C=
_tmp10A;goto _LLD1;_LLD0: {struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*
_tmp10B=(struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmp10B->tag
!= 4)goto _LLD2;else{_tmp10C=_tmp10B->f1;}}_LLD1: Cyc_Tovc_exp_to_vc(env,_tmp10C);
return;_LLD2: {struct Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*_tmp10D=(struct
Cyc_Absyn_Sizeoftyp_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmp10D->tag != 16)goto
_LLD4;}_LLD3: goto _LLD5;_LLD4: {struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*
_tmp10E=(struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmp10E->tag
!= 18)goto _LLD6;}_LLD5: goto _LLD7;_LLD6: {struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*
_tmp10F=(struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmp10F->tag != 
30)goto _LLD8;}_LLD7: return;_LLD8: {struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*
_tmp110=(struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmpE0;if(_tmp110->tag
!= 34)goto _LLDA;else{_tmp111=_tmp110->f2;}}_LLD9: for(0;_tmp111 != 0;_tmp111=
_tmp111->tl){Cyc_Tovc_exp_to_vc(env,(*((struct _tuple10*)_tmp111->hd)).f2);}
return;_LLDA: {struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_tmp112=(struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)
_tmpE0;if(_tmp112->tag != 35)goto _LLDC;else{_tmp113=_tmp112->f1;}}_LLDB: Cyc_Tovc_stmt_to_vc(
env,_tmp113);e->r=(Cyc_Tovc_stmt_to_exp(env,_tmp113))->r;return;_LLDC: {struct
Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*_tmp114=(struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)
_tmpE0;if(_tmp114->tag != 38)goto _LLDE;}_LLDD: return;_LLDE:;_LLDF: {struct Cyc_Core_Impossible_exn_struct
_tmp1B9;const char*_tmp1B8;struct Cyc_Core_Impossible_exn_struct*_tmp1B7;(int)
_throw((void*)((_tmp1B7=_cycalloc(sizeof(*_tmp1B7)),((_tmp1B7[0]=((_tmp1B9.tag=
Cyc_Core_Impossible,((_tmp1B9.f1=((_tmp1B8="bad exp form after xlation to C",
...
_tmp128;struct Cyc_Absyn_Stmt*_tmp129;struct _tuple9 _tmp12B;struct Cyc_Absyn_Exp*
_tmp12C;struct Cyc_Absyn_Stmt*_tmp12D;struct Cyc_Absyn_Exp*_tmp12F;struct _tuple9
_tmp130;struct Cyc_Absyn_Exp*_tmp131;struct _tuple9 _tmp132;struct Cyc_Absyn_Exp*
_tmp133;struct Cyc_Absyn_Stmt*_tmp134;struct Cyc_Absyn_Stmt*_tmp136;struct _tuple9
...
Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*_tmp119=(struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*)
_tmp118;if(_tmp119->tag != 0)goto _LLE3;}_LLE2: goto _LLE4;_LLE3: {struct Cyc_Absyn_Break_s_Absyn_Raw_stmt_struct*
_tmp11A=(struct Cyc_Absyn_Break_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp11A->tag
!= 6)goto _LLE5;}_LLE4: goto _LLE6;_LLE5: {struct Cyc_Absyn_Continue_s_Absyn_Raw_stmt_struct*
_tmp11B=(struct Cyc_Absyn_Continue_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp11B->tag
!= 7)goto _LLE7;}_LLE6: goto _LLE8;_LLE7: {struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*
_tmp11C=(struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp11C->tag != 
8)goto _LLE9;}_LLE8: return;_LLE9: {struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*
_tmp11D=(struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp11D->tag
!= 13)goto _LLEB;else{_tmp11E=_tmp11D->f2;}}_LLEA: s=_tmp11E;continue;_LLEB: {
struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*_tmp11F=(struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)
...
struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*_tmp121=(struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*)
_tmp118;if(_tmp121->tag != 1)goto _LLEF;else{_tmp122=_tmp121->f1;}}_LLEE: Cyc_Tovc_exp_to_vc(
env,_tmp122);return;_LLEF: {struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmp123=(
struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp123->tag != 2)goto
_LLF1;else{_tmp124=_tmp123->f1;_tmp125=_tmp123->f2;}}_LLF0: Cyc_Tovc_stmt_to_vc(
env,_tmp124);s=_tmp125;continue;_LLF1: {struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*
_tmp126=(struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp126->tag
!= 4)goto _LLF3;else{_tmp127=_tmp126->f1;_tmp128=_tmp126->f2;_tmp129=_tmp126->f3;}}
_LLF2: Cyc_Tovc_exp_to_vc(env,_tmp127);Cyc_Tovc_stmt_to_vc(env,_tmp128);s=_tmp129;
continue;_LLF3: {struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*_tmp12A=(struct
Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp12A->tag != 5)goto _LLF5;
else{_tmp12B=_tmp12A->f1;_tmp12C=_tmp12B.f1;_tmp12D=_tmp12A->f2;}}_LLF4: Cyc_Tovc_exp_to_vc(
env,_tmp12C);s=_tmp12D;continue;_LLF5: {struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*
_tmp12E=(struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp12E->tag != 
9)goto _LLF7;else{_tmp12F=_tmp12E->f1;_tmp130=_tmp12E->f2;_tmp131=_tmp130.f1;
_tmp132=_tmp12E->f3;_tmp133=_tmp132.f1;_tmp134=_tmp12E->f4;}}_LLF6: Cyc_Tovc_exp_to_vc(
env,_tmp12F);Cyc_Tovc_exp_to_vc(env,_tmp131);Cyc_Tovc_exp_to_vc(env,_tmp133);s=
_tmp134;continue;_LLF7: {struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*_tmp135=(
struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp135->tag != 14)goto
_LLF9;else{_tmp136=_tmp135->f1;_tmp137=_tmp135->f2;_tmp138=_tmp137.f1;}}_LLF8:
Cyc_Tovc_exp_to_vc(env,_tmp138);s=_tmp136;continue;_LLF9: {struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*
_tmp139=(struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp139->tag
!= 10)goto _LLFB;else{_tmp13A=_tmp139->f1;_tmp13B=_tmp139->f2;}}_LLFA: Cyc_Tovc_exp_to_vc(
env,_tmp13A);for(0;_tmp13B != 0;_tmp13B=_tmp13B->tl){Cyc_Tovc_stmt_to_vc(env,((
struct Cyc_Absyn_Switch_clause*)_tmp13B->hd)->body);}return;_LLFB: {struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*
_tmp13C=(struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp118;if(_tmp13C->tag != 
12)goto _LLFD;else{_tmp13D=_tmp13C->f1;_tmp13E=_tmp13C->f2;}}_LLFC:{void*_tmp13F=
_tmp13D->r;struct Cyc_Absyn_Vardecl*_tmp141;_LL100: {struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*
_tmp140=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp13F;if(_tmp140->tag != 
0)goto _LL102;else{_tmp141=_tmp140->f1;}}_LL101: if(Cyc_Tovc_elim_array_initializers){
void*_tmp142=Cyc_Tcutil_compress(_tmp141->type);_LL105: {struct Cyc_Absyn_ArrayType_Absyn_Type_struct*
_tmp143=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp142;if(_tmp143->tag != 
8)goto _LL107;}_LL106: if(_tmp141->initializer != 0){void*_tmp144=((struct Cyc_Absyn_Exp*)
_check_null(_tmp141->initializer))->r;struct Cyc_List_List*_tmp146;_LL10A: {
struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmp145=(struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)
_tmp144;if(_tmp145->tag != 34)goto _LL10C;else{_tmp146=_tmp145->f2;}}_LL10B:
...
struct _tuple10*)_tmp146->hd)).f2,0),0),s3,0);}}_tmp13E->r=s3->r;goto _LL109;};
_LL10C:;_LL10D: {const char*_tmp1BD;void*_tmp1BC[1];struct Cyc_String_pa_PrintArg_struct
...
Cyc_Core_Impossible_exn_struct _tmp1C0;struct Cyc_Core_Impossible_exn_struct*
_tmp1BF;(int)_throw((void*)((_tmp1BF=_cycalloc(sizeof(*_tmp1BF)),((_tmp1BF[0]=((
_tmp1C0.tag=Cyc_Core_Impossible,((_tmp1C0.f1=(struct _dyneither_ptr)_tmp147,
_tmp1C0)))),_tmp1BF)))));}_LL109:;}goto _LL104;_LL107:;_LL108: goto _LL104;_LL104:;}
if(_tmp141->initializer != 0)Cyc_Tovc_exp_to_vc(env,(struct Cyc_Absyn_Exp*)
...
goto _LLFE;_LLFD:;_LLFE: {struct Cyc_Core_Impossible_exn_struct _tmp1C7;const char*
_tmp1C6;struct Cyc_Core_Impossible_exn_struct*_tmp1C5;(int)_throw((void*)((
_tmp1C5=_cycalloc(sizeof(*_tmp1C5)),((_tmp1C5[0]=((_tmp1C7.tag=Cyc_Core_Impossible,((
_tmp1C7.f1=((_tmp1C6="bad stmt after xlation to C",_tag_dyneither(_tmp1C6,
sizeof(char),28))),_tmp1C7)))),_tmp1C5)))));}_LLE0:;};}}struct Cyc_List_List*Cyc_Tovc_tovc(
struct Cyc_List_List*old_ds){struct Cyc_List_List*_tmp151=0;for(0;old_ds != 0;
old_ds=old_ds->tl){struct Cyc_Absyn_Decl*_tmp152=(struct Cyc_Absyn_Decl*)old_ds->hd;
void*_tmp153=_tmp152->r;struct Cyc_Absyn_Fndecl*_tmp155;struct Cyc_List_List*
_tmp160;struct Cyc_List_List*_tmp162;struct Cyc_List_List*_tmp164;struct Cyc_List_List*
_tmp166;_LL10F: {struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*_tmp154=(struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)
_tmp153;if(_tmp154->tag != 1)goto _LL111;else{_tmp155=_tmp154->f1;}}_LL110: _tmp155->cached_typ=
0;if(_tmp155->param_vardecls != 0){struct _RegionHandle _tmp169=_new_region("rgn");
struct _RegionHandle*rgn=& _tmp169;_push_region(rgn);{struct Cyc_List_List**_tmp1C8;
struct Cyc_List_List**_tmp16A=(_tmp1C8=_region_malloc(rgn,sizeof(*_tmp1C8)),((
_tmp1C8[0]=0,_tmp1C8)));if(_tmp155->param_vardecls == 0){{const char*_tmp1CC;void*
_tmp1CB[1];struct Cyc_String_pa_PrintArg_struct _tmp1CA;(_tmp1CA.tag=0,((_tmp1CA.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp155->name).f2),((_tmp1CB[0]=&
_tmp1CA,Cyc_fprintf(Cyc_stderr,((_tmp1CC="No param vardecls for function %s\n",
...
_cycalloc(sizeof(*_tmp1CE)),((_tmp1CE->sc=_tmp155->sc,((_tmp1CE->name=_tmp155->name,((
_tmp1CE->tq=Cyc_Absyn_const_tqual(0),((_tmp1CE->type=Cyc_Tcutil_fndecl2typ(
_tmp155),((_tmp1CE->initializer=0,((_tmp1CE->rgn=0,((_tmp1CE->attributes=_tmp155->attributes,((
_tmp1CE->escapes=0,_tmp1CE)))))))))))))))));{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*
_tmp1D4;struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct _tmp1D3;struct Cyc_List_List*
_tmp1D2;_tmp151=((_tmp1D2=_cycalloc(sizeof(*_tmp1D2)),((_tmp1D2->hd=Cyc_Absyn_new_decl((
void*)((_tmp1D4=_cycalloc(sizeof(*_tmp1D4)),((_tmp1D4[0]=((_tmp1D3.tag=0,((
_tmp1D3.f1=vd,_tmp1D3)))),_tmp1D4)))),0),((_tmp1D2->tl=_tmp151,_tmp1D2))))));}
...
struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp156=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)
_tmp153;if(_tmp156->tag != 0)goto _LL113;}_LL112: goto _LL114;_LL113: {struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*
_tmp157=(struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp157->tag != 
2)goto _LL115;}_LL114: goto _LL116;_LL115: {struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*
_tmp158=(struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp158->tag != 
3)goto _LL117;}_LL116: goto _LL118;_LL117: {struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*
_tmp159=(struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp159->tag
!= 4)goto _LL119;}_LL118: goto _LL11A;_LL119: {struct Cyc_Absyn_Alias_d_Absyn_Raw_decl_struct*
_tmp15A=(struct Cyc_Absyn_Alias_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp15A->tag
!= 5)goto _LL11B;}_LL11A: goto _LL11C;_LL11B: {struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*
_tmp15B=(struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp15B->tag != 
6)goto _LL11D;}_LL11C: goto _LL11E;_LL11D: {struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*
_tmp15C=(struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp15C->tag
!= 7)goto _LL11F;}_LL11E: goto _LL120;_LL11F: {struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*
_tmp15D=(struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp15D->tag != 
8)goto _LL121;}_LL120: goto _LL122;_LL121: {struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*
_tmp15E=(struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp15E->tag
!= 9)goto _LL123;}_LL122:{struct Cyc_List_List*_tmp1D5;_tmp151=((_tmp1D5=_cycalloc(
sizeof(*_tmp1D5)),((_tmp1D5->hd=_tmp152,((_tmp1D5->tl=_tmp151,_tmp1D5))))));}
goto _LL10E;_LL123: {struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*_tmp15F=(
struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp15F->tag != 10)
goto _LL125;else{_tmp160=_tmp15F->f2;}}_LL124: _tmp162=_tmp160;goto _LL126;_LL125: {
struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*_tmp161=(struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)
_tmp153;if(_tmp161->tag != 11)goto _LL127;else{_tmp162=_tmp161->f2;}}_LL126:
_tmp164=_tmp162;goto _LL128;_LL127: {struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*
_tmp163=(struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp163->tag
!= 12)goto _LL129;else{_tmp164=_tmp163->f1;}}_LL128: _tmp166=_tmp164;goto _LL12A;
_LL129: {struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*_tmp165=(struct
Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp165->tag != 13)
goto _LL12B;else{_tmp166=_tmp165->f1;}}_LL12A: goto _LL12C;_LL12B: {struct Cyc_Absyn_Porton_d_Absyn_Raw_decl_struct*
_tmp167=(struct Cyc_Absyn_Porton_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp167->tag
!= 14)goto _LL12D;}_LL12C: goto _LL12E;_LL12D: {struct Cyc_Absyn_Portoff_d_Absyn_Raw_decl_struct*
_tmp168=(struct Cyc_Absyn_Portoff_d_Absyn_Raw_decl_struct*)_tmp153;if(_tmp168->tag
!= 15)goto _LL10E;}_LL12E: {struct Cyc_Core_Impossible_exn_struct _tmp1DB;const char*
_tmp1DA;struct Cyc_Core_Impossible_exn_struct*_tmp1D9;(int)_throw((void*)((
_tmp1D9=_cycalloc(sizeof(*_tmp1D9)),((_tmp1D9[0]=((_tmp1DB.tag=Cyc_Core_Impossible,((
_tmp1DB.f1=((_tmp1DA="nested translation unit after translation to C",
