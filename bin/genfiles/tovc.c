...
# 37 "/tmp/cyclone/include/iter.h"
int Cyc_Iter_next(struct Cyc_Iter_Iter,void*);struct Cyc_Set_Set;
# 54 "/tmp/cyclone/include/set.h"
...
# 277 "/tmp/cyclone/include/dict.h"
...
# 196 "/tmp/cyclone/src/tcutil.h"
void*Cyc_Tcutil_fndecl2type(struct Cyc_Absyn_Fndecl*);
# 29 "/tmp/cyclone/src/warn.h"
void Cyc_Warn_warn(unsigned,struct _fat_ptr fmt,struct _fat_ptr);struct Cyc_Warn_String_Warn_Warg_struct{int tag;struct _fat_ptr f1;};struct Cyc_Warn_Qvar_Warn_Warg_struct{int tag;struct _tuple0*f1;};struct Cyc_Warn_Typ_Warn_Warg_struct{int tag;void*f1;};struct Cyc_Warn_TypOpt_Warn_Warg_struct{int tag;void*f1;};struct Cyc_Warn_Exp_Warn_Warg_struct{int tag;struct Cyc_Absyn_Exp*f1;};struct Cyc_Warn_Stmt_Warn_Warg_struct{int tag;struct Cyc_Absyn_Stmt*f1;};struct Cyc_Warn_Aggrdecl_Warn_Warg_struct{int tag;struct Cyc_Absyn_Aggrdecl*f1;};struct Cyc_Warn_Tvar_Warn_Warg_struct{int tag;struct Cyc_Absyn_Tvar*f1;};struct Cyc_Warn_KindBound_Warn_Warg_struct{int tag;void*f1;};struct Cyc_Warn_Kind_Warn_Warg_struct{int tag;struct Cyc_Absyn_Kind*f1;};struct Cyc_Warn_Attribute_Warn_Warg_struct{int tag;void*f1;};struct Cyc_Warn_Vardecl_Warn_Warg_struct{int tag;struct Cyc_Absyn_Vardecl*f1;};struct Cyc_Warn_Int_Warn_Warg_struct{int tag;int f1;};
# 71
...
({void*_tmp13A=(((struct Cyc_Absyn_Exp*(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_lookup)(env.varmap,v))->r;e->r=_tmp13A;});
continue;}
# 114
...
({struct Cyc_Set_Set*_tmp13B=((struct Cyc_Set_Set*(*)(struct _RegionHandle*r,struct Cyc_Set_Set*s,struct Cyc_Absyn_Vardecl*elt))Cyc_Set_rinsert)(env.rgn,*env.freevars,vd);*env.freevars=_tmp13B;});{
# 127
...
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp2C=_cycalloc(sizeof(*_tmp2C));_tmp2C->tag=Cyc_Core_Impossible,({struct _fat_ptr _tmp13D=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2B=({struct Cyc_String_pa_PrintArg_struct _tmp131;_tmp131.tag=0U,_tmp131.f1=(struct _fat_ptr)((struct _fat_ptr)*v);_tmp131;});void*_tmp29[1U];_tmp29[0]=& _tmp2B;({struct _fat_ptr _tmp13C=({const char*_tmp2A="unbound variable %s found in box_free_vars_exp";_tag_fat(_tmp2A,sizeof(char),47U);});Cyc_aprintf(_tmp13C,_tag_fat(_tmp29,sizeof(void*),1U));});});_tmp2C->f1=_tmp13D;});_tmp2C;}));}
# 143
...
if(e1b != 0){
struct Cyc_Absyn_Exp*_tmp37=({void*_tmp13E=(void*)({struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_tmp38=_cycalloc(sizeof(*_tmp38));_tmp38->tag=21U,_tmp38->f1=e1b,_tmp38->f2=fn,_tmp38->f3=ist,_tmp38->f4=isr;_tmp38;});Cyc_Absyn_new_exp(_tmp13E,e->loc);});struct Cyc_Absyn_Exp*eb=_tmp37;
eb->topt=e->topt;
eb->annot=e->annot;
return eb;}
# 202
...
if(e1b != 0){
struct Cyc_Absyn_Exp*_tmp3A=({void*_tmp13F=(void*)({struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp3B=_cycalloc(sizeof(*_tmp3B));_tmp3B->tag=22U,_tmp3B->f1=e1b,_tmp3B->f2=fn,_tmp3B->f3=ist,_tmp3B->f4=isr;_tmp3B;});Cyc_Absyn_new_exp(_tmp13F,e->loc);});struct Cyc_Absyn_Exp*eb=_tmp3A;
eb->topt=e->topt;
eb->annot=e->annot;
return eb;}
# 212
...
# 265
({void*_tmp5A=0U;({unsigned _tmp142=s->loc;struct _fat_ptr _tmp141=({const char*_tmp5B="break in eliminated statement expression";_tag_fat(_tmp5B,sizeof(char),41U);});Cyc_Warn_warn(_tmp142,_tmp141,_tag_fat(_tmp5A,sizeof(void*),0U));});});
return;case 7U: _LL5: _LL6:
# 268
({void*_tmp5C=0U;({unsigned _tmp144=s->loc;struct _fat_ptr _tmp143=({const char*_tmp5D="continue in eliminated statement expression";_tag_fat(_tmp5D,sizeof(char),44U);});Cyc_Warn_warn(_tmp144,_tmp143,_tag_fat(_tmp5C,sizeof(void*),0U));});});
# 271
return;case 8U: _LL7: _LL8:
# 273
({void*_tmp5E=0U;({unsigned _tmp146=s->loc;struct _fat_ptr _tmp145=({const char*_tmp5F="goto in eliminated statement expression";_tag_fat(_tmp5F,sizeof(char),40U);});Cyc_Warn_warn(_tmp146,_tmp145,_tag_fat(_tmp5E,sizeof(void*),0U));});});
...
# 279
({void*_tmp60=0U;({unsigned _tmp148=s->loc;struct _fat_ptr _tmp147=({const char*_tmp61="return in eliminated statement expression";_tag_fat(_tmp61,sizeof(char),42U);});Cyc_Warn_warn(_tmp148,_tmp147,_tag_fat(_tmp60,sizeof(void*),0U));});});
# 281
if(*eopt != 0){
...
({struct Cyc_Absyn_Decl*_tmp157=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*_tmp7E=_cycalloc(sizeof(*_tmp7E));_tmp7E->tag=1U,({struct Cyc_Absyn_Fndecl*_tmp156=({struct Cyc_Absyn_Fndecl*_tmp7D=_cycalloc(sizeof(*_tmp7D));_tmp7D->sc=Cyc_Absyn_Static,_tmp7D->is_inline=0,_tmp7D->name=funname,_tmp7D->body=s,
...
({void*_tmp15A=(((struct Cyc_Absyn_Exp*(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_lookup)(varmap,v))->r;e->r=_tmp15A;});
...
vd->name=newqvar;
({struct Cyc_Dict_Dict _tmp15E=({struct Cyc_Dict_Dict _tmp15D=env.varmap;struct _fat_ptr*_tmp15C=oldname;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_Absyn_Exp*v))Cyc_Dict_insert)(_tmp15D,_tmp15C,Cyc_Absyn_var_exp(newqvar,0U));});env.varmap=_tmp15E;});{
...
# 590
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmpF2=_cycalloc(sizeof(*_tmpF2));_tmpF2->tag=Cyc_Core_Impossible,({struct _fat_ptr _tmp16B=(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpF0=({struct Cyc_String_pa_PrintArg_struct _tmp134;_tmp134.tag=0U,_tmp134.f1=(struct _fat_ptr)((struct _fat_ptr)bad_form);_tmp134;});struct Cyc_String_pa_PrintArg_struct _tmpF1=({struct Cyc_String_pa_PrintArg_struct _tmp133;_tmp133.tag=0U,({struct _fat_ptr _tmp169=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp133.f1=_tmp169;});_tmp133;});void*_tmpEE[2U];_tmpEE[0]=& _tmpF0,_tmpEE[1]=& _tmpF1;({struct _fat_ptr _tmp16A=({const char*_tmpEF="bad exp form %s (exp=|%s|) after xlation to C";_tag_fat(_tmpEF,sizeof(char),46U);});Cyc_aprintf(_tmp16A,_tag_fat(_tmpEE,sizeof(void*),2U));});});_tmpF2->f1=_tmp16B;});_tmpF2;}));}
# 594
static void Cyc_Tovc_stmt_to_vc(struct Cyc_Tovc_ToExpEnv env,struct Cyc_Absyn_Stmt*s){
# 596
while(1){
...
# 651
void*_tmp10D=Cyc_Absyn_compress(vd->type);void*_stmttmpE=_tmp10D;void*_tmp10E=_stmttmpE;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp10E)->tag == 4U){_LL25: _LL26:
# 653
 if(vd->initializer != 0){
...
# 669
struct _fat_ptr _tmp112=({struct Cyc_String_pa_PrintArg_struct _tmp116=({struct Cyc_String_pa_PrintArg_struct _tmp135;_tmp135.tag=0U,({
struct _fat_ptr _tmp16F=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_stmt2string(s));_tmp135.f1=_tmp16F;});_tmp135;});void*_tmp114[1U];_tmp114[0]=& _tmp116;({struct _fat_ptr _tmp170=({const char*_tmp115="|%s|: array type bad initializer";_tag_fat(_tmp115,sizeof(char),33U);});Cyc_aprintf(_tmp170,_tag_fat(_tmp114,sizeof(void*),1U));});});
# 669
...
# 684
goto _LL1E;}default: _LL1D: _LL1E:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp119=({struct Cyc_Warn_String_Warn_Warg_struct _tmp136;_tmp136.tag=0U,({struct _fat_ptr _tmp172=({const char*_tmp11A="bad stmt after xlation to C";_tag_fat(_tmp11A,sizeof(char),28U);});_tmp136.f1=_tmp172;});_tmp136;});void*_tmp118[1U];_tmp118[0]=& _tmp119;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp118,sizeof(void*),1U));});}_LL0:;}}}
# 690
...
if(fd->param_vardecls == 0){
({struct Cyc_String_pa_PrintArg_struct _tmp128=({struct Cyc_String_pa_PrintArg_struct _tmp137;_tmp137.tag=0U,_tmp137.f1=(struct _fat_ptr)((struct _fat_ptr)*(*fd->name).f2);_tmp137;});void*_tmp126[1U];_tmp126[0]=& _tmp128;({struct Cyc___cycFILE*_tmp174=Cyc_stderr;struct _fat_ptr _tmp173=({const char*_tmp127="No param vardecls for function %s\n";_tag_fat(_tmp127,sizeof(char),35U);});Cyc_fprintf(_tmp174,_tmp173,_tag_fat(_tmp126,sizeof(void*),1U));});});
Cyc_fflush(Cyc_stderr);}
# 713
({struct Cyc_Tovc_ToExpEnv _tmp177=({struct Cyc_Tovc_ToExpEnv _tmp138;_tmp138.rgn=rgn,({
struct Cyc_List_List*_tmp176=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x))Cyc_List_rcopy)(rgn,(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v);_tmp138.all_locals=_tmp176;}),({
struct Cyc_Dict_Dict _tmp175=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_rempty)(rgn,Cyc_strptrcmp);_tmp138.varmap=_tmp175;}),_tmp138.encloser=fd->body,_tmp138.gen_ds=gen_ds;_tmp138;});
# 713
...
# 723
new_ds=({struct Cyc_List_List*_tmp12A=_cycalloc(sizeof(*_tmp12A));({struct Cyc_Absyn_Decl*_tmp17A=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp129=_cycalloc(sizeof(*_tmp129));_tmp129->tag=0U,_tmp129->f1=vd;_tmp129;}),0U);_tmp12A->hd=_tmp17A;}),_tmp12A->tl=new_ds;_tmp12A;});
...
goto _LL4;}case 0U: _LL3: _LL4:
 ...
 new_ds=({struct Cyc_List_List*_tmp12D=_cycalloc(sizeof(*_tmp12D));_tmp12D->hd=next_d,_tmp12D->tl=new_ds;_tmp12D;});goto _LL0;case 9U: _LL13: _tmp122=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp11E)->f2;_LL14: {struct Cyc_List_List*ds2=_tmp122;
_tmp121=ds2;goto _LL16;}case 10U: _LL15: _tmp121=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp11E)->f2;_LL16: {struct Cyc_List_List*ds2=_tmp121;
_tmp120=ds2;goto _LL18;}case 11U: _LL17: _tmp120=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp11E)->f1;_LL18: {struct Cyc_List_List*ds2=_tmp120;
_tmp11F=ds2;goto _LL1A;}case 12U: _LL19: _tmp11F=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp11E)->f1;_LL1A: {struct Cyc_List_List*ds2=_tmp11F;
...
# 745
({struct Cyc_Warn_String_Warn_Warg_struct _tmp12F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp139;_tmp139.tag=0U,({struct _fat_ptr _tmp17B=({const char*_tmp130="nested translation unit after translation to C";_tag_fat(_tmp130,sizeof(char),47U);});_tmp139.f1=_tmp17B;});_tmp139;});void*_tmp12E[1U];_tmp12E[0]=& _tmp12F;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp12E,sizeof(void*),1U));});}_LL0:;}
# 748
