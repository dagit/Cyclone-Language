...
# 209
 if(_tmp47 == 0)
return;
_tmp49=(struct Cyc_Absyn_Exp*)_tmp47;goto _LL46;_LL45: {struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*_tmp48=(struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*)_tmp3F;if(_tmp48->tag != 1)goto _LL47;else{_tmp49=_tmp48->f1;}}_LL46:
# 213
...
# 508
 if(_tmp113 == 0)
return;
_tmp115=(struct Cyc_Absyn_Exp*)_tmp113;goto _LLEE;_LLED: {struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*_tmp114=(struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*)_tmp10B;if(_tmp114->tag != 1)goto _LLEF;else{_tmp115=_tmp114->f1;}}_LLEE:
# 512
