...
if(({int(*_tmp138)(struct _dyneither_ptr*s1,struct _dyneither_ptr*s2)=(int(*)(struct _dyneither_ptr*s1,struct _dyneither_ptr*s2))_check_null(Cyc_strptrcmp);struct _dyneither_ptr*_tmp137=_tmpB;_tmp138(_tmp137,(*((struct _tuple0*)_check_null(((struct Cyc_Absyn_Vardecl*)_check_null((struct Cyc_Absyn_Vardecl*)((struct Cyc_List_List*)_check_null(env.all_locals))->hd))->name))).f2);})== 0)
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmpA=_cycalloc(sizeof(*_tmpA));_tmpA->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp13B=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp9=({struct Cyc_String_pa_PrintArg_struct _tmp12E;_tmp12E.tag=0U,_tmp12E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct _dyneither_ptr*)_check_null(_tmpB)));_tmp12E;});void*_tmp7[1U];_tmp7[0]=& _tmp9;({struct _dyneither_ptr(*_tmp13A)(struct _dyneither_ptr,struct _dyneither_ptr)=(struct _dyneither_ptr(*)(struct _dyneither_ptr,struct _dyneither_ptr))_check_null(Cyc_aprintf);struct _dyneither_ptr _tmp139=({const char*_tmp8="unbound variable %s found in box_free_vars_exp";_tag_dyneither(_tmp8,sizeof(char),47U);});_tmp13A(_tmp139,_tag_dyneither(_tmp7,sizeof(void*),1U));});});_tmpA->f1=_tmp13B;});_tmpA;}));}
# 141
...
if(_tmp15 != 0){
struct Cyc_Absyn_Exp*_tmp16=({void*_tmp13C=(void*)({struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_tmp17=_cycalloc(sizeof(*_tmp17));_tmp17->tag=21U,_tmp17->f1=_tmp15,_tmp17->f2=_tmp2A,_tmp17->f3=_tmp29,_tmp17->f4=_tmp28;_tmp17;});Cyc_Absyn_new_exp(_tmp13C,e->loc);});
_tmp16->topt=e->topt;
...
if(_tmp18 != 0){
struct Cyc_Absyn_Exp*_tmp19=({void*_tmp13D=(void*)({struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp1A=_cycalloc(sizeof(*_tmp1A));_tmp1A->tag=22U,_tmp1A->f1=_tmp18,_tmp1A->f2=_tmp2E,_tmp1A->f3=_tmp2D,_tmp1A->f4=_tmp2C;_tmp1A;});Cyc_Absyn_new_exp(_tmp13D,e->loc);});
_tmp19->topt=e->topt;
...
# 251
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp22=_cycalloc(sizeof(*_tmp22));_tmp22->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp13E=({const char*_tmp21="bad exp form in Tocv::box_free_vars_exp";_tag_dyneither(_tmp21,sizeof(char),40U);});_tmp22->f1=_tmp13E;});_tmp22;}));}_LL0:;}}
# 255
...
# 263
({void*_tmp46=0U;({unsigned int _tmp140=s->loc;struct _dyneither_ptr _tmp13F=({const char*_tmp47="break in eliminated statement expression";_tag_dyneither(_tmp47,sizeof(char),41U);});Cyc_Tcutil_warn(_tmp140,_tmp13F,_tag_dyneither(_tmp46,sizeof(void*),0U));});});
return;case 7U: _LL5: _LL6:
# 266
({void*_tmp48=0U;({unsigned int _tmp142=s->loc;struct _dyneither_ptr _tmp141=({const char*_tmp49="continue in eliminated statement expression";_tag_dyneither(_tmp49,sizeof(char),44U);});Cyc_Tcutil_warn(_tmp142,_tmp141,_tag_dyneither(_tmp48,sizeof(void*),0U));});});
# 269
return;case 8U: _LL7: _LL8:
# 271
({void*_tmp4A=0U;({unsigned int _tmp144=s->loc;struct _dyneither_ptr _tmp143=({const char*_tmp4B="goto in eliminated statement expression";_tag_dyneither(_tmp4B,sizeof(char),40U);});Cyc_Tcutil_warn(_tmp144,_tmp143,_tag_dyneither(_tmp4A,sizeof(void*),0U));});});
...
# 277
({void*_tmp4C=0U;({unsigned int _tmp146=s->loc;struct _dyneither_ptr _tmp145=({const char*_tmp4D="return in eliminated statement expression";_tag_dyneither(_tmp4D,sizeof(char),42U);});Cyc_Tcutil_warn(_tmp146,_tmp145,_tag_dyneither(_tmp4C,sizeof(void*),0U));});});
# 279
if(*_tmp5F != 0){
...
# 319
({struct Cyc_List_List*_tmp147=({struct Cyc_List_List*_tmp59=_region_malloc(env.rgn,sizeof(*_tmp59));_tmp59->hd=_tmp5B,_tmp59->tl=env.boundvars;_tmp59;});env.boundvars=_tmp147;});
({struct Cyc_Dict_Dict _tmp148=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct _dyneither_ptr*))Cyc_Dict_rdelete_same)(env.varmap,(*_tmp5B->name).f2);env.varmap=_tmp148;});
...
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp5D=_cycalloc(sizeof(*_tmp5D));_tmp5D->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp149=({const char*_tmp5C="bad stmt after xlation to C";_tag_dyneither(_tmp5C,sizeof(char),28U);});_tmp5D->f1=_tmp149;});_tmp5D;}));}_LL0:;}}
# 340
...
# 361
({struct Cyc_List_List*_tmp14E=({struct Cyc_List_List*_tmp77=_cycalloc(sizeof(*_tmp77));({struct _tuple8*_tmp14D=({struct _tuple8*_tmp76=_cycalloc(sizeof(*_tmp76));_tmp76->f1=(*_tmp73->name).f2,_tmp76->f2=_tmp73->tq,({
void*_tmp14C=({void*_tmp14B=_tmp7C;Cyc_Absyn_cstar_type(_tmp14B,Cyc_Absyn_empty_tqual(0U));});_tmp76->f3=_tmp14C;});_tmp76;});
# 361
_tmp77->hd=_tmp14D;}),_tmp77->tl=params;_tmp77;});params=_tmp14E;});
# 364
({struct Cyc_List_List*_tmp150=({struct Cyc_List_List*_tmp78=_cycalloc(sizeof(*_tmp78));({struct Cyc_Absyn_Exp*_tmp14F=Cyc_Absyn_var_exp(_tmp73->name,0U);_tmp78->hd=_tmp14F;}),_tmp78->tl=args;_tmp78;});args=_tmp150;});
goto _LL0;}else{_LL3: _LL4:
# 367
({struct Cyc_List_List*_tmp154=({struct Cyc_List_List*_tmp7A=_cycalloc(sizeof(*_tmp7A));({struct _tuple8*_tmp153=({struct _tuple8*_tmp79=_cycalloc(sizeof(*_tmp79));_tmp79->f1=(*_tmp73->name).f2,_tmp79->f2=_tmp73->tq,({
void*_tmp152=({void*_tmp151=_tmp73->type;Cyc_Absyn_cstar_type(_tmp151,Cyc_Absyn_empty_tqual(0U));});_tmp79->f3=_tmp152;});_tmp79;});
# 367
_tmp7A->hd=_tmp153;}),_tmp7A->tl=params;_tmp7A;});params=_tmp154;});
# 370
({struct Cyc_List_List*_tmp156=({struct Cyc_List_List*_tmp7B=_cycalloc(sizeof(*_tmp7B));({struct Cyc_Absyn_Exp*_tmp155=Cyc_Absyn_address_exp(Cyc_Absyn_var_exp(_tmp73->name,0U),0U);_tmp7B->hd=_tmp155;}),_tmp7B->tl=args;_tmp7B;});args=_tmp156;});
goto _LL0;}_LL0:;}{
# 373
struct _tuple0*funname=Cyc_Toc_temp_var();
({struct Cyc_List_List*_tmp15A=({struct Cyc_List_List*_tmp7F=_cycalloc(sizeof(*_tmp7F));({struct Cyc_Absyn_Decl*_tmp159=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*_tmp7E=_cycalloc(sizeof(*_tmp7E));_tmp7E->tag=1U,({struct Cyc_Absyn_Fndecl*_tmp158=({struct Cyc_Absyn_Fndecl*_tmp7D=_cycalloc(sizeof(*_tmp7D));_tmp7D->sc=Cyc_Absyn_Static,_tmp7D->is_inline=0,_tmp7D->name=funname,_tmp7D->tvs=0,_tmp7D->effect=0,({
struct Cyc_Absyn_Tqual _tmp157=Cyc_Absyn_empty_tqual(0U);_tmp7D->ret_tqual=_tmp157;}),_tmp7D->ret_type=rettype,_tmp7D->args=params,_tmp7D->c_varargs=0,_tmp7D->cyc_varargs=0,_tmp7D->rgn_po=0,_tmp7D->body=s,_tmp7D->cached_type=0,_tmp7D->param_vardecls=0,_tmp7D->fn_vardecl=0,_tmp7D->attributes=0,_tmp7D->requires_clause=0,_tmp7D->requires_relns=0,_tmp7D->ensures_clause=0,_tmp7D->ensures_relns=0;_tmp7D;});
# 374
_tmp7E->f1=_tmp158;});_tmp7E;}),0U);_tmp7F->hd=_tmp159;}),_tmp7F->tl=*env.gen_ds;_tmp7F;});*env.gen_ds=_tmp15A;});
# 380
return({struct Cyc_Absyn_Exp*_tmp15B=Cyc_Absyn_var_exp(funname,0U);Cyc_Absyn_fncall_exp(_tmp15B,args,0U);});};};}
# 383
...
({void*_tmp15C=(((struct Cyc_Absyn_Exp*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(varmap,_tmp85))->r;e->r=_tmp15C;});
...
# 433
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp87=_cycalloc(sizeof(*_tmp87));_tmp87->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp15D=({const char*_tmp86="bad exp form in Tocv::apply_varmap";_tag_dyneither(_tmp86,sizeof(char),35U);});_tmp87->f1=_tmp15D;});_tmp87;}));}_LL0:;}
# 437
...
_tmpB7->name=_tmpAC;
({struct Cyc_Dict_Dict _tmp160=({struct Cyc_Dict_Dict _tmp15F=env.varmap;struct _dyneither_ptr*_tmp15E=_tmpAB;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Exp*v))Cyc_Dict_insert)(_tmp15F,_tmp15E,Cyc_Absyn_var_exp(_tmpAC,0U));});env.varmap=_tmp160;});{
...
({struct Cyc_List_List*_tmp164=({struct Cyc_List_List*_tmpB1=_cycalloc(sizeof(*_tmpB1));({struct Cyc_Absyn_Exp*_tmp163=({struct Cyc_Absyn_Exp*_tmp162=({struct Cyc_Absyn_Exp*_tmp161=_tmpB0;Cyc_Absyn_subscript_exp(_tmp161,Cyc_Absyn_uint_exp(i,0U),0U);});Cyc_Absyn_assign_exp(_tmp162,(*((struct _tuple10*)_tmpB2->hd)).f2,0U);});_tmpB1->hd=_tmp163;}),_tmpB1->tl=_tmpAD;_tmpB1;});_tmpAD=_tmp164;});}}
# 483
_tmpB7->initializer=0;
goto _LL12;}}else{_LL15: _LL16:
 goto _LL12;}_LL12:;};}
# 488
({struct Cyc_List_List*_tmp165=({struct Cyc_List_List*_tmpB3=_region_malloc(env.rgn,sizeof(*_tmpB3));_tmpB3->hd=_tmpB7,_tmpB3->tl=env.all_locals;_tmpB3;});env.all_locals=_tmp165;});
# 490
({void*_tmp167=({struct Cyc_Absyn_Decl*_tmp166=_tmpBF;Cyc_Absyn_decl_stmt(_tmp166,Cyc_Absyn_new_stmt((env.encloser)->r,0U),0U);})->r;(env.encloser)->r=_tmp167;});{
struct Cyc_Absyn_Exp*_tmpB4=Cyc_Tovc_stmt_to_exp(env,_tmpBE);
if(_tmpB7->initializer != 0){
({struct Cyc_Absyn_Exp*_tmp16A=({struct Cyc_Absyn_Exp*_tmp169=({struct Cyc_Absyn_Exp*_tmp168=Cyc_Absyn_var_exp(_tmpB7->name,0U);Cyc_Absyn_assign_exp(_tmp168,(struct Cyc_Absyn_Exp*)_check_null(_tmpB7->initializer),0U);});Cyc_Absyn_seq_exp(_tmp169,_tmpB4,0U);});_tmpB4=_tmp16A;});
# 495
_tmpB7->initializer=0;}
# 497
for(0;_tmpAD != 0;_tmpAD=_tmpAD->tl){
({struct Cyc_Absyn_Exp*_tmp16B=Cyc_Absyn_seq_exp((struct Cyc_Absyn_Exp*)_tmpAD->hd,_tmpB4,0U);_tmpB4=_tmp16B;});}
return _tmpB4;};};}}else{_LL10: _LL11:
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmpB6=_cycalloc(sizeof(*_tmpB6));_tmpB6->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp16C=({const char*_tmpB5="bad local decl in Tovc::stmt_to_exp";_tag_dyneither(_tmpB5,sizeof(char),36U);});_tmpB6->f1=_tmp16C;});_tmpB6;}));}_LLD:;}default: _LLB: _LLC:
# 503
...
# 563
({void*_tmp16D=(Cyc_Tovc_stmt_to_exp(env,_tmpEC))->r;e->r=_tmp16D;});
return;case 40U: _LL35: _LL36:
# 566
 return;case 2U: _LL37: _LL38:
# 568
({struct _dyneither_ptr _tmp16E=({const char*_tmpC2="Pragma_e";_tag_dyneither(_tmpC2,sizeof(char),9U);});bad_form=_tmp16E;});goto _LL0;case 11U: _LL39: _LL3A:
({struct _dyneither_ptr _tmp16F=({const char*_tmpC3="Throw_e";_tag_dyneither(_tmpC3,sizeof(char),8U);});bad_form=_tmp16F;});goto _LL0;case 16U: _LL3B: _LL3C:
({struct _dyneither_ptr _tmp170=({const char*_tmpC4="New_e";_tag_dyneither(_tmpC4,sizeof(char),6U);});bad_form=_tmp170;});goto _LL0;case 24U: _LL3D: _LL3E:
({struct _dyneither_ptr _tmp171=({const char*_tmpC5="Tuple_e";_tag_dyneither(_tmpC5,sizeof(char),8U);});bad_form=_tmp171;});goto _LL0;case 25U: _LL3F: _LL40:
({struct _dyneither_ptr _tmp172=({const char*_tmpC6="CompoundLit_e";_tag_dyneither(_tmpC6,sizeof(char),14U);});bad_form=_tmp172;});goto _LL0;case 26U: _LL41: _LL42:
({struct _dyneither_ptr _tmp173=({const char*_tmpC7="Array_e";_tag_dyneither(_tmpC7,sizeof(char),8U);});bad_form=_tmp173;});goto _LL0;case 27U: _LL43: _LL44:
({struct _dyneither_ptr _tmp174=({const char*_tmpC8="Comprehension_e";_tag_dyneither(_tmpC8,sizeof(char),16U);});bad_form=_tmp174;});goto _LL0;case 28U: _LL45: _LL46:
({struct _dyneither_ptr _tmp175=({const char*_tmpC9="ComprehensionNoinit_e";_tag_dyneither(_tmpC9,sizeof(char),22U);});bad_form=_tmp175;});goto _LL0;case 29U: _LL47: _LL48:
({struct _dyneither_ptr _tmp176=({const char*_tmpCA="Aggregate_e";_tag_dyneither(_tmpCA,sizeof(char),12U);});bad_form=_tmp176;});goto _LL0;case 30U: _LL49: _LL4A:
({struct _dyneither_ptr _tmp177=({const char*_tmpCB="AnonStruct_e";_tag_dyneither(_tmpCB,sizeof(char),13U);});bad_form=_tmp177;});goto _LL0;case 31U: _LL4B: _LL4C:
# 579
({struct _dyneither_ptr _tmp178=({const char*_tmpCC="Datatype_e";_tag_dyneither(_tmpCC,sizeof(char),11U);});bad_form=_tmp178;});goto _LL0;case 34U: _LL4D: _LL4E:
({struct _dyneither_ptr _tmp179=({const char*_tmpCD="Malloc_e";_tag_dyneither(_tmpCD,sizeof(char),9U);});bad_form=_tmp179;});goto _LL0;case 35U: _LL4F: _LL50:
({struct _dyneither_ptr _tmp17A=({const char*_tmpCE="Swap_e";_tag_dyneither(_tmpCE,sizeof(char),7U);});bad_form=_tmp17A;});goto _LL0;case 38U: _LL51: _LL52:
({struct _dyneither_ptr _tmp17B=({const char*_tmpCF="Tagcheck_e";_tag_dyneither(_tmpCF,sizeof(char),11U);});bad_form=_tmp17B;});goto _LL0;default: _LL53: _LL54:
({struct _dyneither_ptr _tmp17C=({const char*_tmpD0="Valueof_e";_tag_dyneither(_tmpD0,sizeof(char),10U);});bad_form=_tmp17C;});goto _LL0;}_LL0:;}
# 585
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmpF1=_cycalloc(sizeof(*_tmpF1));_tmpF1->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp17F=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpEF=({struct Cyc_String_pa_PrintArg_struct _tmp131;_tmp131.tag=0U,_tmp131.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)bad_form);_tmp131;});struct Cyc_String_pa_PrintArg_struct _tmpF0=({struct Cyc_String_pa_PrintArg_struct _tmp130;_tmp130.tag=0U,({struct _dyneither_ptr _tmp17D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp130.f1=_tmp17D;});_tmp130;});void*_tmpED[2U];_tmpED[0]=& _tmpEF,_tmpED[1]=& _tmpF0;({struct _dyneither_ptr _tmp17E=({const char*_tmpEE="bad exp form %s (exp=|%s|) after xlation to C";_tag_dyneither(_tmpEE,sizeof(char),46U);});Cyc_aprintf(_tmp17E,_tag_dyneither(_tmpED,sizeof(void*),2U));});});_tmpF1->f1=_tmp17F;});_tmpF1;}));}
# 589
static void Cyc_Tovc_stmt_to_vc(struct Cyc_Tovc_ToExpEnv env,struct Cyc_Absyn_Stmt*s){
# 591
while(1){
...
({struct Cyc_Absyn_Stmt*_tmp183=({struct Cyc_Absyn_Stmt*_tmp182=Cyc_Absyn_exp_stmt(({struct Cyc_Absyn_Exp*_tmp181=({struct Cyc_Absyn_Exp*_tmp180=arr;Cyc_Absyn_subscript_exp(_tmp180,
Cyc_Absyn_uint_exp(i,0U),0U);});
# 656
Cyc_Absyn_assign_exp(_tmp181,(*((struct _tuple10*)_tmp100->hd)).f2,0U);}),0U);Cyc_Absyn_seq_stmt(_tmp182,s3,0U);});s3=_tmp183;});}}
# 661
_tmp117->r=s3->r;
...
struct _dyneither_ptr _tmp184=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_stmt2string(s));_tmp132.f1=_tmp184;});_tmp132;});void*_tmpFD[1U];_tmpFD[0]=& _tmpFF;({struct _dyneither_ptr _tmp185=({const char*_tmpFE="|%s|: array type bad initializer";_tag_dyneither(_tmpFE,sizeof(char),33U);});Cyc_aprintf(_tmp185,_tag_dyneither(_tmpFD,sizeof(void*),1U));});});
...
({struct Cyc_List_List*_tmp186=({struct Cyc_List_List*_tmp101=_region_malloc(env.rgn,sizeof(*_tmp101));_tmp101->hd=_tmp102,_tmp101->tl=env.all_locals;_tmp101;});env.all_locals=_tmp186;});
s=_tmp117;
continue;}else{_LL22: _LL23:
 goto _LL1F;}_LL1F:;}
# 679
goto _LL1E;default: _LL1D: _LL1E:
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp104=_cycalloc(sizeof(*_tmp104));_tmp104->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp187=({const char*_tmp103="bad stmt after xlation to C";_tag_dyneither(_tmp103,sizeof(char),28U);});_tmp104->f1=_tmp187;});_tmp104;}));}_LL0:;};}}
# 685
...
if(_tmp129->param_vardecls == 0){
({struct Cyc_String_pa_PrintArg_struct _tmp121=({struct Cyc_String_pa_PrintArg_struct _tmp133;_tmp133.tag=0U,_tmp133.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp129->name).f2);_tmp133;});void*_tmp11F[1U];_tmp11F[0]=& _tmp121;({struct Cyc___cycFILE*_tmp189=Cyc_stderr;struct _dyneither_ptr _tmp188=({const char*_tmp120="No param vardecls for function %s\n";_tag_dyneither(_tmp120,sizeof(char),35U);});Cyc_fprintf(_tmp189,_tmp188,_tag_dyneither(_tmp11F,sizeof(void*),1U));});});
Cyc_fflush(Cyc_stderr);}
# 708
({struct Cyc_Tovc_ToExpEnv _tmp18C=({struct Cyc_Tovc_ToExpEnv _tmp134;_tmp134.rgn=rgn,({
struct Cyc_List_List*_tmp18B=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x))Cyc_List_rcopy)(rgn,(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp129->param_vardecls))->v);_tmp134.all_locals=_tmp18B;}),({
struct Cyc_Dict_Dict _tmp18A=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_rempty)(rgn,Cyc_strptrcmp);_tmp134.varmap=_tmp18A;}),_tmp134.encloser=_tmp129->body,_tmp134.gen_ds=_tmp11E;_tmp134;});
# 708
Cyc_Tovc_stmt_to_vc(_tmp18C,_tmp129->body);});
# 714
if(*_tmp11E != 0){
struct Cyc_Absyn_Vardecl*vd=({struct Cyc_Absyn_Vardecl*_tmp124=_cycalloc(sizeof(*_tmp124));_tmp124->sc=_tmp129->sc,_tmp124->name=_tmp129->name,_tmp124->varloc=0U,({struct Cyc_Absyn_Tqual _tmp18E=Cyc_Absyn_const_tqual(0U);_tmp124->tq=_tmp18E;}),({
void*_tmp18D=Cyc_Tcutil_fndecl2type(_tmp129);_tmp124->type=_tmp18D;}),_tmp124->initializer=0,_tmp124->rgn=0,_tmp124->attributes=_tmp129->attributes,_tmp124->escapes=0;_tmp124;});
({struct Cyc_List_List*_tmp190=({struct Cyc_List_List*_tmp123=_cycalloc(sizeof(*_tmp123));({struct Cyc_Absyn_Decl*_tmp18F=Cyc_Absyn_new_decl((void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp122=_cycalloc(sizeof(*_tmp122));_tmp122->tag=0U,_tmp122->f1=vd;_tmp122;}),0U);_tmp123->hd=_tmp18F;}),_tmp123->tl=_tmp119;_tmp123;});_tmp119=_tmp190;});
# 719
({struct Cyc_List_List*_tmp191=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(*_tmp11E,_tmp119);_tmp119=_tmp191;});}}
# 703
;_pop_region(rgn);}
# 723
...
# 732
({struct Cyc_List_List*_tmp192=({struct Cyc_List_List*_tmp126=_cycalloc(sizeof(*_tmp126));_tmp126->hd=_tmp11A,_tmp126->tl=_tmp119;_tmp126;});_tmp119=_tmp192;});
goto _LL0;case 9U: _LL13: _tmp12A=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp11C)->f2;_LL14:
 ...
 goto _LL1E;default: _LL1D: _LL1E:
# 740
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp128=_cycalloc(sizeof(*_tmp128));_tmp128->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp193=({const char*_tmp127="nested translation unit after translation to C";_tag_dyneither(_tmp127,sizeof(char),47U);});_tmp128->f1=_tmp193;});_tmp128;}));}_LL0:;}
# 743
