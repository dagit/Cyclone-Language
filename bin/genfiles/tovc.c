...
continue;}
# 112
{int i=0;for(0;(unsigned)i < _get_dyneither_size(Cyc_Toc_globals,sizeof(struct _dyneither_ptr*));++ i){
...
# 263
({void*_tmp46=0U;({unsigned _tmp13D=s->loc;struct _dyneither_ptr _tmp13C=({const char*_tmp47="break in eliminated statement expression";_tag_dyneither(_tmp47,sizeof(char),41U);});Cyc_Tcutil_warn(_tmp13D,_tmp13C,_tag_dyneither(_tmp46,sizeof(void*),0U));});});
return;case 7U: _LL5: _LL6:
# 266
({void*_tmp48=0U;({unsigned _tmp13F=s->loc;struct _dyneither_ptr _tmp13E=({const char*_tmp49="continue in eliminated statement expression";_tag_dyneither(_tmp49,sizeof(char),44U);});Cyc_Tcutil_warn(_tmp13F,_tmp13E,_tag_dyneither(_tmp48,sizeof(void*),0U));});});
# 269
return;case 8U: _LL7: _LL8:
# 271
({void*_tmp4A=0U;({unsigned _tmp141=s->loc;struct _dyneither_ptr _tmp140=({const char*_tmp4B="goto in eliminated statement expression";_tag_dyneither(_tmp4B,sizeof(char),40U);});Cyc_Tcutil_warn(_tmp141,_tmp140,_tag_dyneither(_tmp4A,sizeof(void*),0U));});});
...
# 277
({void*_tmp4C=0U;({unsigned _tmp143=s->loc;struct _dyneither_ptr _tmp142=({const char*_tmp4D="return in eliminated statement expression";_tag_dyneither(_tmp4D,sizeof(char),42U);});Cyc_Tcutil_warn(_tmp143,_tmp142,_tag_dyneither(_tmp4C,sizeof(void*),0U));});});
# 279
if(*_tmp5F != 0){
...
({void*_tmp155=(((struct Cyc_Absyn_Exp*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(varmap,_tmp85))->r;e->r=_tmp155;});
...
# 435
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp87=_cycalloc(sizeof(*_tmp87));_tmp87->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp156=({const char*_tmp86="bad exp form in Tocv::apply_varmap";_tag_dyneither(_tmp86,sizeof(char),35U);});_tmp87->f1=_tmp156;});_tmp87;}));}_LL0:;}
# 439
...
_tmpB7->name=_tmpAC;
({struct Cyc_Dict_Dict _tmp159=({struct Cyc_Dict_Dict _tmp158=env.varmap;struct _dyneither_ptr*_tmp157=_tmpAB;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Exp*v))Cyc_Dict_insert)(_tmp158,_tmp157,Cyc_Absyn_var_exp(_tmpAC,0U));});env.varmap=_tmp159;});{
...
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmpB6=_cycalloc(sizeof(*_tmpB6));_tmpB6->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp162=({const char*_tmpB5="bad local decl in Tovc::stmt_to_exp";_tag_dyneither(_tmpB5,sizeof(char),36U);});_tmpB6->f1=_tmp162;});_tmpB6;}));}_LLD:;}default: _LLB: _LLC:
# 505
...
# 570
 bad_form=({const char*_tmpC2="Pragma_e";_tag_dyneither(_tmpC2,sizeof(char),9U);});goto _LL0;case 11U: _LL39: _LL3A:
 bad_form=({const char*_tmpC3="Throw_e";_tag_dyneither(_tmpC3,sizeof(char),8U);});goto _LL0;case 16U: _LL3B: _LL3C:
 bad_form=({const char*_tmpC4="New_e";_tag_dyneither(_tmpC4,sizeof(char),6U);});goto _LL0;case 24U: _LL3D: _LL3E:
 bad_form=({const char*_tmpC5="Tuple_e";_tag_dyneither(_tmpC5,sizeof(char),8U);});goto _LL0;case 25U: _LL3F: _LL40:
 bad_form=({const char*_tmpC6="CompoundLit_e";_tag_dyneither(_tmpC6,sizeof(char),14U);});goto _LL0;case 26U: _LL41: _LL42:
 bad_form=({const char*_tmpC7="Array_e";_tag_dyneither(_tmpC7,sizeof(char),8U);});goto _LL0;case 27U: _LL43: _LL44:
 bad_form=({const char*_tmpC8="Comprehension_e";_tag_dyneither(_tmpC8,sizeof(char),16U);});goto _LL0;case 28U: _LL45: _LL46:
 bad_form=({const char*_tmpC9="ComprehensionNoinit_e";_tag_dyneither(_tmpC9,sizeof(char),22U);});goto _LL0;case 29U: _LL47: _LL48:
 bad_form=({const char*_tmpCA="Aggregate_e";_tag_dyneither(_tmpCA,sizeof(char),12U);});goto _LL0;case 30U: _LL49: _LL4A:
 bad_form=({const char*_tmpCB="AnonStruct_e";_tag_dyneither(_tmpCB,sizeof(char),13U);});goto _LL0;case 31U: _LL4B: _LL4C:
# 581
 bad_form=({const char*_tmpCC="Datatype_e";_tag_dyneither(_tmpCC,sizeof(char),11U);});goto _LL0;case 34U: _LL4D: _LL4E:
 bad_form=({const char*_tmpCD="Malloc_e";_tag_dyneither(_tmpCD,sizeof(char),9U);});goto _LL0;case 35U: _LL4F: _LL50:
 bad_form=({const char*_tmpCE="Swap_e";_tag_dyneither(_tmpCE,sizeof(char),7U);});goto _LL0;case 38U: _LL51: _LL52:
 bad_form=({const char*_tmpCF="Tagcheck_e";_tag_dyneither(_tmpCF,sizeof(char),11U);});goto _LL0;default: _LL53: _LL54:
 bad_form=({const char*_tmpD0="Valueof_e";_tag_dyneither(_tmpD0,sizeof(char),10U);});goto _LL0;}_LL0:;}
# 587
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmpF1=_cycalloc(sizeof(*_tmpF1));_tmpF1->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp166=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpEF=({struct Cyc_String_pa_PrintArg_struct _tmp131;_tmp131.tag=0U,_tmp131.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)bad_form);_tmp131;});struct Cyc_String_pa_PrintArg_struct _tmpF0=({struct Cyc_String_pa_PrintArg_struct _tmp130;_tmp130.tag=0U,({struct _dyneither_ptr _tmp164=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp130.f1=_tmp164;});_tmp130;});void*_tmpED[2U];_tmpED[0]=& _tmpEF,_tmpED[1]=& _tmpF0;({struct _dyneither_ptr _tmp165=({const char*_tmpEE="bad exp form %s (exp=|%s|) after xlation to C";_tag_dyneither(_tmpEE,sizeof(char),46U);});Cyc_aprintf(_tmp165,_tag_dyneither(_tmpED,sizeof(void*),2U));});});_tmpF1->f1=_tmp166;});_tmpF1;}));}
# 591
static void Cyc_Tovc_stmt_to_vc(struct Cyc_Tovc_ToExpEnv env,struct Cyc_Absyn_Stmt*s){
# 593
while(1){
...
struct _dyneither_ptr _tmp16A=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_stmt2string(s));_tmp132.f1=_tmp16A;});_tmp132;});void*_tmpFD[1U];_tmpFD[0]=& _tmpFF;({struct _dyneither_ptr _tmp16B=({const char*_tmpFE="|%s|: array type bad initializer";_tag_dyneither(_tmpFE,sizeof(char),33U);});Cyc_aprintf(_tmp16B,_tag_dyneither(_tmpFD,sizeof(void*),1U));});});
...
# 681
goto _LL1E;default: _LL1D: _LL1E:
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp104=_cycalloc(sizeof(*_tmp104));_tmp104->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp16D=({const char*_tmp103="bad stmt after xlation to C";_tag_dyneither(_tmp103,sizeof(char),28U);});_tmp104->f1=_tmp16D;});_tmp104;}));}_LL0:;};}}
# 687
...
struct Cyc_Dict_Dict _tmp170=((struct Cyc_Dict_Dict(*)(struct _RegionHandle*,int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_rempty)(rgn,Cyc_strptrcmp);_tmp134.varmap=_tmp170;}),_tmp134.encloser=_tmp129->body,_tmp134.gen_ds=_tmp11E;_tmp134;});
# 710
...
# 745
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_tmp128=_cycalloc(sizeof(*_tmp128));_tmp128->tag=Cyc_Core_Impossible,({struct _dyneither_ptr _tmp176=({const char*_tmp127="nested translation unit after translation to C";_tag_dyneither(_tmp127,sizeof(char),47U);});_tmp128->f1=_tmp176;});_tmp128;}));}_LL0:;}
# 748
