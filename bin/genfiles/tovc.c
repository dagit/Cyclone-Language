...
void*_tmp14F=({void*_tmp14E=_tmp73->type;Cyc_Absyn_cstar_type(_tmp14E,Cyc_Absyn_empty_tqual(0U));});_tmp79->f3=_tmp14F;});_tmp79;});
# 367
...
struct Cyc_Absyn_Tqual _tmp154=Cyc_Absyn_empty_tqual(0U);_tmp7D->ret_tqual=_tmp154;}),_tmp7D->ret_type=rettype,_tmp7D->args=params,_tmp7D->c_varargs=0,_tmp7D->cyc_varargs=0,_tmp7D->rgn_po=0,_tmp7D->body=s,_tmp7D->cached_type=0,_tmp7D->param_vardecls=0,_tmp7D->fn_vardecl=0,_tmp7D->attributes=0,_tmp7D->requires_clause=0,_tmp7D->requires_relns=0,_tmp7D->ensures_clause=0,_tmp7D->ensures_relns=0;_tmp7D;});
# 374
...
void*_tmp18A=Cyc_Tcutil_fndecl2type(_tmp129);_tmp124->type=_tmp18A;}),_tmp124->initializer=0,_tmp124->rgn=0,_tmp124->attributes=_tmp129->attributes,_tmp124->escapes=0;_tmp124;});
