...
# 248
 ...
 goto _LL2E;_LL2D: {struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmp37=(struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp37->tag != 30)goto _LL2F;}_LL2E:
 return 0;_LL2F: {struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmp38=(struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmp0;if(_tmp38->tag != 34)goto _LL31;else{_tmp39=_tmp38->f2;}}_LL30:
# 253
...
# 423
 ...
 goto _LL8F;_LL8E: {struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmpD2=(struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmpA1;if(_tmpD2->tag != 30)goto _LL90;}_LL8F:
 return;_LL90: {struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmpD3=(struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmpA1;if(_tmpD3->tag != 34)goto _LL92;else{_tmpD4=_tmpD3->f2;}}_LL91:
# 428
...
void*_tmpF0=((struct Cyc_Absyn_Exp*)_check_null(_tmpEC->initializer))->r;struct Cyc_List_List*_tmpF2;_LLA7: {struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmpF1=(struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmpF0;if(_tmpF1->tag != 34)goto _LLA9;else{_tmpF2=_tmpF1->f2;}}_LLA8: {
# 476 "tovc.cyc"
...
# 541
 ...
 goto _LLD7;_LLD6: {struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmp129=(struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmpFA;if(_tmp129->tag != 30)goto _LLD8;}_LLD7:
 return;_LLD8: {struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmp12A=(struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmpFA;if(_tmp12A->tag != 34)goto _LLDA;else{_tmp12B=_tmp12A->f2;}}_LLD9:
# 549
 for(0;_tmp12B != 0;_tmp12B=_tmp12B->tl){
Cyc_Tovc_exp_to_vc(env,(*((struct _tuple10*)_tmp12B->hd)).f2);}
return;_LLDA: {struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_tmp12C=(struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmpFA;if(_tmp12C->tag != 35)goto _LLDC;else{_tmp12D=_tmp12C->f1;}}_LLDB:
# 557
 Cyc_Tovc_stmt_to_vc(env,_tmp12D);
# 559
e->r=(Cyc_Tovc_stmt_to_exp(env,_tmp12D))->r;
return;_LLDC: {struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*_tmp12E=(struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpFA;if(_tmp12E->tag != 38)goto _LLDE;}_LLDD:
# 562
 return;_LLDE:;_LLDF: {
# 564
...
void*_tmp15A=((struct Cyc_Absyn_Exp*)_check_null(_tmp157->initializer))->r;struct Cyc_List_List*_tmp15C;_LL10A: {struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmp15B=(struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmp15A;if(_tmp15B->tag != 34)goto _LL10C;else{_tmp15C=_tmp15B->f2;}}_LL10B:
# 630
