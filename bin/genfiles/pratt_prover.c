...
{void*_Tmp0;if(*((int*)t)==4)switch((int)((struct Cyc_AssnDef_Primop_AssnDef_Term_struct*)t)->f1){case Cyc_Absyn_Plus: _Tmp0=((struct Cyc_AssnDef_Primop_AssnDef_Term_struct*)t)->f2;{struct Cyc_List_List*ts=_Tmp0;
# 477
p=0U;
if(ts==0)
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos;})(({const char*_Tmp1="no argument for primop";_tag_fat(_Tmp1,sizeof(char),23U);}),_tag_fat(0U,sizeof(void*),0));else{
if(ts->tl==0)
# 482
return({struct _tuple13 _Tmp1;_Tmp1.f1=(void*)ts->hd,_Tmp1.f2=0;_Tmp1;});else{
if(_check_null(ts->tl)->tl==0){
struct _tuple11 _Tmp1=Cyc_PrattProver_eval_term((void*)ts->hd);int _Tmp2;unsigned _Tmp3;_Tmp3=_Tmp1.f1;_Tmp2=_Tmp1.f2;{unsigned c1=_Tmp3;int okay1=_Tmp2;
struct _tuple11 _Tmp4=Cyc_PrattProver_eval_term((void*)_check_null(ts->tl)->hd);int _Tmp5;unsigned _Tmp6;_Tmp6=_Tmp4.f1;_Tmp5=_Tmp4.f2;{unsigned c2=_Tmp6;int okay2=_Tmp5;
if(okay1){
...
c=(int)c2;
cu=c2;}else{
return({struct _tuple13 _Tmp7;_Tmp7.f1=t,_Tmp7.f2=0;_Tmp7;});}}}}}else{
# 497
return({struct _tuple13 _Tmp1;_Tmp1.f1=t,_Tmp1.f2=0;_Tmp1;});}}}
goto _LL0;}case Cyc_Absyn_Minus: _Tmp0=((struct Cyc_AssnDef_Primop_AssnDef_Term_struct*)t)->f2;{struct Cyc_List_List*ts=_Tmp0;
# 500
p=2U;
if(ts==0)
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos;})(({const char*_Tmp1="no argument for primop";_tag_fat(_Tmp1,sizeof(char),23U);}),_tag_fat(0U,sizeof(void*),0));else{
if(ts->tl==0)
# 505
return({struct _tuple13 _Tmp1;_Tmp1.f1=t,_Tmp1.f2=0;_Tmp1;});else{
if(_check_null(ts->tl)->tl==0){
struct _tuple11 _Tmp1=Cyc_PrattProver_eval_term((void*)_check_null(ts->tl)->hd);int _Tmp2;unsigned _Tmp3;_Tmp3=_Tmp1.f1;_Tmp2=_Tmp1.f2;{unsigned c2=_Tmp3;int okay2=_Tmp2;
if(okay2){
res=(void*)ts->hd;
c=-(int)c2;
cu=c2;}else{
# 513
return({struct _tuple13 _Tmp4;_Tmp4.f1=t,_Tmp4.f2=0;_Tmp4;});}}}else{
return({struct _tuple13 _Tmp1;_Tmp1.f1=t,_Tmp1.f2=0;_Tmp1;});}}}
goto _LL0;}default: goto _LL5;}else{_LL5:
# 517
 return({struct _tuple13 _Tmp1;_Tmp1.f1=t,_Tmp1.f2=0;_Tmp1;});}_LL0:;}
# 521
if(is_signed){
