...
# 137
void*Cyc_AssnDef_reduce(void*);struct Cyc_PrattProver_Node;struct Cyc_PrattProver_Distance{struct Cyc_PrattProver_Distance*next;struct Cyc_PrattProver_Node*target;int dist;};struct Cyc_PrattProver_Node{struct Cyc_PrattProver_Node*next;void*rep;int broken_as_signed;int broken_as_unsigned;struct Cyc_PrattProver_Distance*unsigned_distances;struct Cyc_PrattProver_Distance*signed_distances;};struct Cyc_PrattProver_Graph{struct Cyc_PrattProver_Graph*next;struct Cyc_PrattProver_Node*rows;};
# 67 "pratt_prover.cyc"
...
static int Cyc_PrattProver_add_eq(struct Cyc_PrattProver_Graph*,void*,void*);struct _tuple11{int f1;unsigned f2;};
# 111
...
# 121
if(!({struct Cyc_PrattProver_Graph*_Tmp0=g;void*_Tmp1=term;Cyc_PrattProver_set_distance(_Tmp0,_Tmp1,Cyc_AssnDef_zero(),2147483647,1);})|| !({
struct Cyc_PrattProver_Graph*_Tmp0=g;void*_Tmp1=Cyc_AssnDef_zero();Cyc_PrattProver_set_distance(_Tmp0,_Tmp1,term,0,0);}))return 0;
...
# 364
if(!Cyc_PrattProver_set_dist(g,i,j,dist,is_signed))return 0;
return 1;}}
# 369
...
return newg;}}}
# 418
static unsigned Cyc_PrattProver_eval_binop(enum Cyc_Absyn_Primop p,unsigned i1,unsigned i2){
switch((int)p){case Cyc_Absyn_Plus:
 return i1 + i2;case Cyc_Absyn_Times:
 return i1 * i2;case Cyc_Absyn_Minus:
 return i1 - i2;case Cyc_Absyn_Div:
 return i1 / i2;case Cyc_Absyn_Mod:
 return i1 % i2;case Cyc_Absyn_Bitand:
 return i1 & i2;case Cyc_Absyn_Bitor:
 return i1 | i2;case Cyc_Absyn_Bitlshift:
 return i1 << i2;case Cyc_Absyn_Bitlrshift:
 return i1 >> i2;default:
# 430
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos;})(({const char*_Tmp0="Vcgen: found bad primop in eval_binop";_tag_fat(_Tmp0,sizeof(char),38U);}),_tag_fat(0U,sizeof(void*),0));};}
# 434
static unsigned Cyc_PrattProver_eval_unop(enum Cyc_Absyn_Primop p,unsigned i){
switch((int)p){case Cyc_Absyn_Not:
 return(unsigned)!((int)i);case Cyc_Absyn_Bitnot:
 return ~ i;case Cyc_Absyn_Minus:
 return - i;default:
# 440
({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos;})(({const char*_Tmp0="Vcgen: found bad primop in add_constraint";_tag_fat(_Tmp0,sizeof(char),42U);}),_tag_fat(0U,sizeof(void*),0));};}
# 444
...
goto _LL0;}}}}}else{goto _LL5;}default: _LL5:
 goto _LL0;}_LL0:;}{
# 455
struct Cyc_PrattProver_Node*n=Cyc_PrattProver_term2node_opt(g,t);
if(n!=0){
...
prev=g;}}}
# 520
return gs;}struct _tuple14{int f1;void*f2;int f3;};
# 525
...
# 556
static int Cyc_PrattProver_break_term_in_graph(struct Cyc_PrattProver_Graph*g){
{struct Cyc_PrattProver_Node*rs=g->rows;for(0;rs!=0;rs=rs->next){
...
if(!Cyc_PrattProver_set_distance(g,rs->rep,t1,c1,1))return 0;
if((unsigned)c1!=2147483648U){
if(!Cyc_PrattProver_set_distance(g,t1,rs->rep,- c1,1))return 0;}}}}
# 567
...
if(!Cyc_PrattProver_set_distance(g,rs->rep,t1,c1,0))return 0;
if((unsigned)c1!=2147483648U){
if(!Cyc_PrattProver_set_distance(g,t1,rs->rep,- c1,0))return 0;}}}}{
# 576
...
rs->broken_as_signed=1;
rs->broken_as_unsigned=1;
if(!({struct Cyc_PrattProver_Graph*_Tmp6=g;void*_Tmp7=t1;Cyc_PrattProver_add_eq(_Tmp6,_Tmp7,Cyc_AssnDef_uint(c1 - c2));}))return 0;
...
struct Cyc_PrattProver_Graph*prev=0;
{struct Cyc_PrattProver_Graph*g=gs;for(0;g!=0;g=g->next){
if(!Cyc_PrattProver_break_term_in_graph(g)){
if(prev==0)
gs=g->next;else{
# 600
prev->next=g->next;}}else{
...
# 657
 if(c1 > 2147483647U)
# 660
return({struct Cyc_PrattProver_Graph*_Tmp3=g;void*_Tmp4=Cyc_AssnDef_zero();Cyc_PrattProver_set_distance(_Tmp3,_Tmp4,t2,-2147483647,0);});else{
# 665
return({struct Cyc_PrattProver_Graph*_Tmp3=g;void*_Tmp4=Cyc_AssnDef_zero();void*_Tmp5=t2;Cyc_PrattProver_set_distance(_Tmp3,_Tmp4,_Tmp5,-(int)c1,0);});}
# 667
...
# 644
 return({struct Cyc_PrattProver_Graph*_Tmp3=g;void*_Tmp4=t1;void*_Tmp5=Cyc_AssnDef_zero();Cyc_PrattProver_set_distance(_Tmp3,_Tmp4,_Tmp5,(int)c2,1);});default:
