...
# 401
if(({unsigned _Tmp0=Cyc_AssnDef_term_size(t);_Tmp0 > Cyc_Flags_max_vc_term_size;}))
t=Cyc_AssnDef_fresh_var(0,Cyc_AssnDef_get_term_type(t));{
...
# 510
inline static struct _tuple13 Cyc_PrattProver_is_signed_int_overflow(int c1,int c2){
int sum=c1 + c2;
if((~(c1 ^ c2)& (sum ^ c1))>> 31){
# 514
...
# 525
inline static struct _tuple13 Cyc_PrattProver_is_signed_int_plusminus_overflow(int c1,int c2,int c3){
# 527
if(c2 >= 0 && c3 >= 0 || c2 <= 0 && c3 <= 0)return Cyc_PrattProver_is_signed_int_overflow(c1,c2 - c3);
# 529
if(c1 >= 0 && c3 >= 0 || c1 <= 0 && c3 <= 0)return Cyc_PrattProver_is_signed_int_overflow(c2,c1 - c3);
# 533
if(c3==Cyc_PrattProver_MININT){struct _tuple13 _Tmp0;_Tmp0.f0=1,_Tmp0.f1=1;return _Tmp0;}{
# 535
struct _tuple13 _Tmp0=Cyc_PrattProver_is_signed_int_overflow(c1,c2);int _Tmp1;int _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{int flag=_Tmp2;int sum=_Tmp1;
if(flag){struct _tuple13 _Tmp3;_Tmp3.f0=1,_Tmp3.f1=sum;return _Tmp3;}else{
return Cyc_PrattProver_is_signed_int_overflow(sum,- c3);}}}}struct _tuple14{int f0;long long f1;};
# 544
inline static struct _tuple14 Cyc_PrattProver_is_signed_longlong_overflow(long long c1,long long c2){
long long sum=c1 + c2;
if((~(c1 ^ c2)& (sum ^ c1))>> 63!=0){
# 548
if(sum > 0){struct _tuple14 _Tmp0;_Tmp0.f0=1,_Tmp0.f1=-1;return _Tmp0;}else{
struct _tuple14 _Tmp0;_Tmp0.f0=1,_Tmp0.f1=1;return _Tmp0;}}else{
# 551
struct _tuple14 _Tmp0;_Tmp0.f0=0,_Tmp0.f1=sum;return _Tmp0;}}
# 559
inline static struct _tuple14 Cyc_PrattProver_is_signed_longlong_plusminus_overflow(long long c1,long long c2,long long c3){
# 563
if(c2 >= 0 && c3 >= 0 || c2 <= 0 && c3 <= 0)return Cyc_PrattProver_is_signed_longlong_overflow(c1,c2 - c3);
# 565
if(c1 >= 0 && c3 >= 0 || c1 <= 0 && c3 <= 0)return Cyc_PrattProver_is_signed_longlong_overflow(c2,c1 - c3);
# 569
if(c3==9223372036854775808ULL){struct _tuple14 _Tmp0;_Tmp0.f0=1,_Tmp0.f1=1;return _Tmp0;}{
# 571
struct _tuple14 _Tmp0=Cyc_PrattProver_is_signed_longlong_overflow(c1,c2);long long _Tmp1;int _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{int flag=_Tmp2;long long sum=_Tmp1;
if(flag){struct _tuple14 _Tmp3;_Tmp3.f0=1,_Tmp3.f1=sum;return _Tmp3;}else{
return Cyc_PrattProver_is_signed_longlong_overflow(sum,- c3);}}}}
# 577
...
# 595
if(i==j){
if(dist < 0)_throw(& Cyc_PrattProver_inconsistent);else{
return;}}{
# 599
...
if(ji_dist!=0){
struct _tuple13 _Tmp0=Cyc_PrattProver_is_signed_int_overflow(*ji_dist,dist);int _Tmp1;int _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{int overflow=_Tmp2;int sum=_Tmp1;
if(sum < 0)
# 622
...
# 667
if(dv_unsigned==Cyc_PrattProver_MININT)continue;{
struct _tuple13 _Tmp0=Cyc_PrattProver_is_signed_int_overflow(du_unsigned,uv_unsigned);int _Tmp1;int _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{int overflow=_Tmp2;int sum=_Tmp1;
# 670
if(!overflow && sum < dv_unsigned)dists->target->unsigneddistFromS=sum;
# 672
if(overflow && sum < 0)dists->target->unsigneddistFromS=Cyc_PrattProver_MININT;}}}}{
# 674
...
# 680
if(dv_signed==Cyc_PrattProver_MININT)continue;{
struct _tuple13 _Tmp0=Cyc_PrattProver_is_signed_int_overflow(du_signed,uv_signed);int _Tmp1;int _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{int overflow=_Tmp2;int sum=_Tmp1;
# 683
if(!overflow && sum < dv_signed)dists->target->signeddistFromS=sum;
# 685
if(overflow && sum < 0)dists->target->signeddistFromS=Cyc_PrattProver_MININT;}}}}}}}
# 693
{struct Cyc_PrattProver_Node*node=g->rows;for(0;node!=0;node=node->next){
int du_unsigned=node->unsigneddistFromS;
{struct Cyc_PrattProver_Distance*dists=node->unsigned_distances;for(0;dists!=0;dists=dists->next){
...
# 784
int uv=dists->dist;
struct _tuple13 _Tmp2=Cyc_PrattProver_is_signed_int_overflow(su,uv);int _Tmp3;int _Tmp4;_Tmp4=_Tmp2.f0;_Tmp3=_Tmp2.f1;{int overflow=_Tmp4;int sum=_Tmp3;
...
int dv_unsigned=dists->target->unsigneddistFromS;
# 898
struct _tuple13 _Tmp0=Cyc_PrattProver_is_signed_int_plusminus_overflow(uv_unsigned,du_unsigned,dv_unsigned);int _Tmp1;int _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{int overflow=_Tmp2;int sum=_Tmp1;
if(!overflow)dists->dist=sum;else{
# 903
if(pre_dists==0)
...
int dv_signed=dists->target->signeddistFromS;
# 915
struct _tuple13 _Tmp0=Cyc_PrattProver_is_signed_int_plusminus_overflow(uv_signed,du_signed,dv_signed);int _Tmp1;int _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{int overflow=_Tmp2;int sum=_Tmp1;
if(!overflow)dists->dist=sum;else{
# 918
dists->dist=0;
if(pre_dists==0)
...
int uv_unsigned=dists->dist;
int dv_unsigned=dists->target->unsigneddistFromS;
struct _tuple13 _Tmp0=Cyc_PrattProver_is_signed_int_plusminus_overflow(uv_unsigned,dv_unsigned,du_unsigned);int _Tmp1;int _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{int overflow=_Tmp2;int sum=_Tmp1;
if(!overflow)dists->dist=sum;else{
if(sum > 0){
# 955
if(pre_dists==0)
node->unsigned_distances=dists->next;else{
# 958
pre_dists->next=dists->next;}}else{
# 961
dists->dist=Cyc_PrattProver_MININT;}}}}{
# 964
int du_signed=node->signeddistFromS;
for((pre_dists=0,dists=node->signed_distances);dists!=0;(
pre_dists=dists,dists=dists->next)){
...
int dv_signed=dists->target->signeddistFromS;
# 970
struct _tuple13 _Tmp0=Cyc_PrattProver_is_signed_int_plusminus_overflow(uv_signed,dv_signed,du_signed);int _Tmp1;int _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{int overflow=_Tmp2;int sum=_Tmp1;
if(!overflow)dists->dist=sum;else{
if(sum > 0){
# 975
if(pre_dists==0)
...
switch((int)p){case Cyc_Absyn_Gt:
 ...
 goto _LLA;case Cyc_Absyn_UGt: _LLA:
 goto _LLC;case Cyc_Absyn_ULt: _LLC:
 goto _LLE;case Cyc_Absyn_UGte: _LLE:
 goto _LL10;case Cyc_Absyn_ULte: _LL10:
 return 1;default:
 return 0;};}
# 1094
...
switch((int)p){case Cyc_Absyn_Plus:
 ...
 return c1 - c2;case Cyc_Absyn_UDiv:
 return c1 / c2;case Cyc_Absyn_UMod:
 return c1 % c2;case Cyc_Absyn_Div:
 return(unsigned)((int)c1 / (int)c2);case Cyc_Absyn_Mod:
 return(unsigned)((int)c1 % (int)c2);case Cyc_Absyn_Eq:
...
# 1136
if((n2z!=0 && z2n!=0)&& -*z2n==*n2z){struct _tuple15 _Tmp0;_Tmp0.f0=1,_Tmp0.f1=(unsigned)*n2z;return _Tmp0;}{
struct _tuple15 _Tmp0;_Tmp0.f0=0,_Tmp0.f1=2989U;return _Tmp0;}}
# 1142
...
struct _tuple15 _Tmp3;_Tmp3.f0=ok,_Tmp3.f1=c;return _Tmp3;}}}
# 1149
...
loop: {
struct _tuple12 _Tmp0=({struct _tuple12 _Tmp1;_Tmp1.f0=t1,_Tmp1.f1=t2;_Tmp1;});void*_Tmp1;void*_Tmp2;void*_Tmp3;void*_Tmp4;int _Tmp5;int _Tmp6;if(*((int*)_Tmp0.f0)==2){if(*((int*)_Tmp0.f1)==2){_Tmp6=((struct Cyc_AssnDef_LogicVar_AssnDef_Term_struct*)_Tmp0.f0)->f2;_Tmp5=((struct Cyc_AssnDef_LogicVar_AssnDef_Term_struct*)_Tmp0.f1)->f2;{int i=_Tmp6;int j=_Tmp5;
# 1208
return i < j;}}else{
# 1210
return 0;}}else{if(*((int*)_Tmp0.f1)==2)
# 1209
return 1;else{if(*((int*)_Tmp0.f0)==0){if(*((int*)_Tmp0.f1)==0)
# 1212
return 0;else{
return 1;}}else{if(*((int*)_Tmp0.f1)==0)
return 0;else{if(*((int*)_Tmp0.f0)==11){if(*((int*)_Tmp0.f1)==11)
# 1216
return 0;else{
return 1;}}else{if(*((int*)_Tmp0.f1)==11)
return 0;else{if(*((int*)_Tmp0.f0)==12){if(*((int*)_Tmp0.f1)==12)
# 1220
return 0;else{
...
# 1241
if(Cyc_PrattProver_occurs_i(t1,s1,seen))return 1;t2=s2;goto loop;}case 5: _Tmp2=(void*)((struct Cyc_AssnDef_Cast_AssnDef_Term_struct*)t2)->f2;{void*s=_Tmp2;
...
# 1244
if(Cyc_PrattProver_occurs_i(t1,s1,seen))return 1;t2=s2;goto loop;}case 7: _Tmp2=(void*)((struct Cyc_AssnDef_Update_AssnDef_Term_struct*)t2)->f1;_Tmp1=(void*)((struct Cyc_AssnDef_Update_AssnDef_Term_struct*)t2)->f2;_Tmp0=(void*)((struct Cyc_AssnDef_Update_AssnDef_Term_struct*)t2)->f3;{void*s1=_Tmp2;void*s2=_Tmp1;void*s3=_Tmp0;
# 1246
if(Cyc_PrattProver_occurs_i(t1,s1,seen)|| Cyc_PrattProver_occurs_i(t2,s2,seen))return 1;
t2=s3;goto loop;}case 8: _Tmp2=((struct Cyc_AssnDef_Aggr_AssnDef_Term_struct*)t2)->f3;{struct Cyc_List_List*ss=_Tmp2;
# 1249
for(1;ss!=0;ss=ss->tl){if(Cyc_PrattProver_occurs_i(t1,(void*)ss->hd,seen))return 1;}
...
# 1253
if(Cyc_PrattProver_occurs_i(t1,s1,seen))return 1;t2=s2;goto loop;}case 11: _Tmp2=(void*)((struct Cyc_AssnDef_Addr_AssnDef_Term_struct*)t2)->f2;{void*s=_Tmp2;
...
# 1256
if(Cyc_PrattProver_occurs_i(t1,s1,seen))return 1;t2=s2;goto loop;}case 13: _Tmp2=(void*)((struct Cyc_AssnDef_Offsetf_AssnDef_Term_struct*)t2)->f1;{void*s=_Tmp2;
...
# 1259
if(Cyc_PrattProver_occurs_i(t1,s1,seen))return 1;t2=s2;goto loop;}case 15: _Tmp2=(void*)((struct Cyc_AssnDef_Tagof_AssnDef_Term_struct*)t2)->f1;{void*s=_Tmp2;
t2=s;goto loop;}default:
 return 0;};}}
# 1265
static int Cyc_PrattProver_occurs(void*t1,void*t2){
struct Cyc_Set_Set*seen=Cyc_Set_empty(Cyc_AssnDef_termcmp);
return Cyc_PrattProver_occurs_i(t1,t2,& seen);}
# 1270
inline static int Cyc_PrattProver_is_var_term(void*t){
if(*((int*)t)==2)
return 1;else{
return 0;};}
# 1281
static void Cyc_PrattProver_subst_close_graph(int vars_only,struct Cyc_PrattProver_Graph*g){
# 1288
struct Cyc_PrattProver_Node*z_node=({struct Cyc_PrattProver_Graph*_Tmp0=g;Cyc_PrattProver_term2node(_Tmp0,Cyc_AssnDef_zero());});
...
{struct Cyc_PrattProver_Node*rs=g->rows;for(0;rs!=0;rs=rs->next){
void*t1=rs->rep;
if(vars_only && !Cyc_PrattProver_is_var_term(t1))continue;{
void*best=t1;
# 1296
int*dzero=Cyc_PrattProver_lookup_dist(rs,z_node,0);
int*zerod=Cyc_PrattProver_lookup_dist(z_node,rs,0);
if((dzero!=0 && zerod!=0)&&*dzero==-*zerod)
best=Cyc_AssnDef_uint((unsigned)*dzero);else{
# 1301
dzero=Cyc_PrattProver_lookup_dist(rs,z_node,1);
zerod=Cyc_PrattProver_lookup_dist(z_node,rs,1);
if((dzero!=0 && zerod!=0)&&*dzero==-*zerod)
best=Cyc_AssnDef_uint((unsigned)*dzero);}
# 1308
{struct Cyc_PrattProver_Node*ts=g->rows;for(0;ts!=0;ts=ts->next){
void*t2=ts->rep;
if((Cyc_PrattProver_better_term(t2,best)&& Cyc_PrattProver_eq_nodes(rs,ts,0))&& !Cyc_PrattProver_occurs(best,t2))
best=t2;}}
# 1314
if(t1!=best){
# 1316
...
if(!changed)return;{
# 1334
struct Cyc_PrattProver_Node*rs2=g->rows;for(0;rs2!=0;rs2=rs2->next){
void*t=rs2->rep;
...
if((i!=(unsigned)Cyc_PrattProver_MININT && nzud!=0)&&*nzud < (int)i - 1)return 1;{
int*nzsd=Cyc_PrattProver_lookup_dist(n,z,1);
if((i!=(unsigned)Cyc_PrattProver_MININT && nzsd!=0)&&*nzsd < (int)i - 1)return 1;{
...
# 1504
if(dist!=0 &&*dist <= (int)(2147483647U - c2)){
...
if(dist!=0 &&*dist <= (int)(c2 - (unsigned)Cyc_PrattProver_MININT)){
struct _tuple16 _Tmp2;_Tmp2.f0=1,_Tmp2.f1=t1,_Tmp2.f2=(int)c2;return _Tmp2;}}else{
# 1525
...
if(dist!=0 &&*dist <= Cyc_PrattProver_MININT)
return -1;{
# 1594
...
# 1714
 if(c1 > 2147483647U)
({struct Cyc_PrattProver_Graph*_Tmp3=g;void*_Tmp4=Cyc_AssnDef_zero();void*_Tmp5=t2;Cyc_PrattProver_set_distance(_Tmp3,_Tmp4,_Tmp5,Cyc_PrattProver_MININT,0);});else{
# 1717
...
# 1732
 if(c1==(unsigned)Cyc_PrattProver_MININT)return;{
struct Cyc_PrattProver_Graph*_Tmp3=g;void*_Tmp4=Cyc_AssnDef_zero();void*_Tmp5=t2;return Cyc_PrattProver_set_distance(_Tmp3,_Tmp4,_Tmp5,-(int)c1,1);}default:
...
return;case Cyc_AssnDef_SLt:
# 1682
 if(c2==(unsigned)Cyc_PrattProver_MININT)
# 1686
_throw(& Cyc_PrattProver_inconsistent);
# 1688
c2=c2 - 1U;
...
return({struct Cyc_PrattProver_Graph*(*_Tmp0)(void(*)(int,struct Cyc_PrattProver_Graph*),int,struct Cyc_PrattProver_Graph*)=(struct Cyc_PrattProver_Graph*(*)(void(*)(int,struct Cyc_PrattProver_Graph*),int,struct Cyc_PrattProver_Graph*))Cyc_PrattProver_app_graphs;_Tmp0;})(Cyc_PrattProver_add_numelts_info,0,gs);}struct _tuple19{struct Cyc_PrattProver_Graph*f0;struct Cyc_List_List*f1;};
# 1875
...
ors=({struct Cyc_List_List*_Tmp5=_cycalloc(sizeof(struct Cyc_List_List));({struct _tuple19*_Tmp6=({struct _tuple19*_Tmp7=_cycalloc(sizeof(struct _tuple19));_Tmp7->f0=g2,({struct Cyc_List_List*_Tmp8=({struct Cyc_List_List*_Tmp9=_cycalloc(sizeof(struct Cyc_List_List));_Tmp9->hd=a2,_Tmp9->tl=ands;_Tmp9;});_Tmp7->f1=_Tmp8;});_Tmp7;});_Tmp5->hd=_Tmp6;}),_Tmp5->tl=ors;_Tmp5;});
a=a1;
...
int _Tmp5=0;_npop_handler(0);return _Tmp5;}default:
 _throw(& Cyc_PrattProver_inconsistent);};}
# 1893 "pratt_prover.cyc"
1U;}
# 1892
;_pop_handler();}else{void*_Tmp2=(void*)Cyc_Core_get_exn_thrown();void*_Tmp3;if(((struct Cyc_PrattProver_Inconsistent_exn_struct*)_Tmp2)->tag==Cyc_PrattProver_Inconsistent){
# 2026 "pratt_prover.cyc"
if(ors==0)
# 2028
return 1;{
# 2031
struct _tuple19*_Tmp4=(struct _tuple19*)ors->hd;void*_Tmp5;void*_Tmp6;_Tmp6=_Tmp4->f0;_Tmp5=_Tmp4->f1;{struct Cyc_PrattProver_Graph*g2=_Tmp6;struct Cyc_List_List*ands2=_Tmp5;
g=g2;
ands=ands2;
a=(void*)& Cyc_AssnDef_true_assn;
ors=ors->tl;
goto _LL11;}}}else{_Tmp3=_Tmp2;{void*exn=_Tmp3;_rethrow(exn);}}_LL11:;}}}
# 1891 "pratt_prover.cyc"
1U;}}
# 2041 "pratt_prover.cyc"
