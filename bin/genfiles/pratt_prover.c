...
Cyc_PrattProver_add_constraint(g,t2,3U,t1);}}{
# 189
void*_stmttmp2=Cyc_Absyn_compress(t);void*_Tmp0=_stmttmp2;void*_Tmp1;if(*((int*)_Tmp0)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp0)->f1)== 4){if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp0)->f2 != 0){_Tmp1=(void*)(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_Tmp0)->f2)->hd;{void*v=_Tmp1;
# 191
...
({struct Cyc_PrattProver_Graph*_Tmp4=g;void*_Tmp5=n;Cyc_PrattProver_add_eq(_Tmp4,_Tmp5,Cyc_AssnDef_cnst(e));});goto _LLF;}}else{_Tmp3=_Tmp2;{void*v2=_Tmp3;
({struct Cyc_PrattProver_Graph*_Tmp4=g;void*_Tmp5=n;Cyc_PrattProver_add_eq(_Tmp4,_Tmp5,Cyc_AssnDef_cnst(Cyc_Absyn_valueof_exp(v2,0U)));});goto _LLF;}}_LLF:;}
# 195
...
# 210
({struct Cyc_PrattProver_Graph*_Tmp2=g;void*_Tmp3=n;Cyc_PrattProver_add_edge(_Tmp2,0,_Tmp3,Cyc_AssnDef_zero(),2147483646,0);});
...
struct _tuple11 _stmttmp9=Cyc_PrattProver_eval_term((void*)ts->hd);struct _tuple11 _Tmp2=_stmttmp9;int _Tmp3;unsigned _Tmp4;_Tmp4=_Tmp2.f1;_Tmp3=_Tmp2.f2;{unsigned c1=_Tmp4;int okay1=_Tmp3;
struct _tuple11 _stmttmpA=Cyc_PrattProver_eval_term((void*)(_check_null(ts->tl))->hd);struct _tuple11 _Tmp5=_stmttmpA;int _Tmp6;unsigned _Tmp7;_Tmp7=_Tmp5.f1;_Tmp6=_Tmp5.f2;{unsigned c2=_Tmp7;int okay2=_Tmp6;
if(okay1){
...
if((_check_null(ts->tl))->tl == 0){
struct _tuple11 _stmttmpB=Cyc_PrattProver_eval_term((void*)(_check_null(ts->tl))->hd);struct _tuple11 _Tmp2=_stmttmpB;int _Tmp3;unsigned _Tmp4;_Tmp4=_Tmp2.f1;_Tmp3=_Tmp2.f2;{unsigned c2=_Tmp4;int okay2=_Tmp3;
if(okay2){
res=(void*)ts->hd;
c=-(int)c2;
cu=c2;}else{
...
# 517
struct _tuple11 _stmttmpC=Cyc_PrattProver_eval_term(t1);struct _tuple11 _Tmp0=_stmttmpC;int _Tmp1;unsigned _Tmp2;_Tmp2=_Tmp0.f1;_Tmp1=_Tmp0.f2;{unsigned c1=_Tmp2;int okay1=_Tmp1;
struct _tuple11 _stmttmpD=Cyc_PrattProver_eval_term(t2);struct _tuple11 _Tmp3=_stmttmpD;int _Tmp4;unsigned _Tmp5;_Tmp5=_Tmp3.f1;_Tmp4=_Tmp3.f2;{unsigned c2=_Tmp5;int okay2=_Tmp4;
...
enum Cyc_AssnDef_Primreln _Tmp6=p;switch((int)_Tmp6){case Cyc_AssnDef_ULt:  {
# 621
struct _tuple13 _stmttmpE=Cyc_PrattProver_break_term(g,0,t1);struct _tuple13 _Tmp7=_stmttmpE;int _Tmp8;void*_Tmp9;_Tmp9=_Tmp7.f1;_Tmp8=_Tmp7.f2;{void*tt1=_Tmp9;int c1=_Tmp8;
struct _tuple13 _stmttmpF=Cyc_PrattProver_break_term(g,0,t2);struct _tuple13 _TmpA=_stmttmpF;int _TmpB;void*_TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{void*tt2=_TmpC;int c2=_TmpB;
struct _tuple12 _stmttmp10=Cyc_PrattProver_is_unsigned_overflow((unsigned)c2,1U,(unsigned)c1);struct _tuple12 _TmpD=_stmttmp10;int _TmpE;int _TmpF;_TmpF=_TmpD.f1;_TmpE=_TmpD.f2;{int of=_TmpF;int dist=_TmpE;
if(!of){
struct _tuple12 _stmttmp11=Cyc_PrattProver_is_unsigned_overflow((unsigned)dist,1U,1U);struct _tuple12 _Tmp10=_stmttmp11;int _Tmp11;int _Tmp12;_Tmp12=_Tmp10.f1;_Tmp11=_Tmp10.f2;{int of=_Tmp12;int dist=_Tmp11;
if(!of){
...
# 634
struct _tuple13 _stmttmp12=Cyc_PrattProver_break_term(g,0,t1);struct _tuple13 _Tmp7=_stmttmp12;int _Tmp8;void*_Tmp9;_Tmp9=_Tmp7.f1;_Tmp8=_Tmp7.f2;{void*tt1=_Tmp9;int c1=_Tmp8;
struct _tuple13 _stmttmp13=Cyc_PrattProver_break_term(g,0,t2);struct _tuple13 _TmpA=_stmttmp13;int _TmpB;void*_TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{void*tt2=_TmpC;int c2=_TmpB;
struct _tuple12 _stmttmp14=Cyc_PrattProver_is_unsigned_overflow((unsigned)c2,1U,(unsigned)c1);struct _tuple12 _TmpD=_stmttmp14;int _TmpE;int _TmpF;_TmpF=_TmpD.f1;_TmpE=_TmpD.f2;{int of=_TmpF;int dist=_TmpE;
if(!of){
# 640
if(!Cyc_PrattProver_add_edge(g,0,tt1,tt2,dist,origin))
return 0;}
...
# 645
struct _tuple13 _stmttmp15=Cyc_PrattProver_break_term(g,1,t1);struct _tuple13 _Tmp7=_stmttmp15;int _Tmp8;void*_Tmp9;_Tmp9=_Tmp7.f1;_Tmp8=_Tmp7.f2;{void*tt1=_Tmp9;int c1=_Tmp8;
struct _tuple13 _stmttmp16=Cyc_PrattProver_break_term(g,1,t2);struct _tuple13 _TmpA=_stmttmp16;int _TmpB;void*_TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{void*tt2=_TmpC;int c2=_TmpB;
struct _tuple12 _stmttmp17=Cyc_PrattProver_is_signed_overflow(c2,1U,c1);struct _tuple12 _TmpD=_stmttmp17;int _TmpE;int _TmpF;_TmpF=_TmpD.f1;_TmpE=_TmpD.f2;{int of=_TmpF;int dist=_TmpE;
if(!of){
struct _tuple12 _stmttmp18=Cyc_PrattProver_is_signed_overflow(dist,1U,1);struct _tuple12 _Tmp10=_stmttmp18;int _Tmp11;int _Tmp12;_Tmp12=_Tmp10.f1;_Tmp11=_Tmp10.f2;{int of=_Tmp12;int dist=_Tmp11;
if(!of){
...
# 658
struct _tuple13 _stmttmp19=Cyc_PrattProver_break_term(g,1,t1);struct _tuple13 _Tmp7=_stmttmp19;int _Tmp8;void*_Tmp9;_Tmp9=_Tmp7.f1;_Tmp8=_Tmp7.f2;{void*tt1=_Tmp9;int c1=_Tmp8;
struct _tuple13 _stmttmp1A=Cyc_PrattProver_break_term(g,1,t2);struct _tuple13 _TmpA=_stmttmp1A;int _TmpB;void*_TmpC;_TmpC=_TmpA.f1;_TmpB=_TmpA.f2;{void*tt2=_TmpC;int c2=_TmpB;
struct _tuple12 _stmttmp1B=Cyc_PrattProver_is_signed_overflow(c2,1U,c1);struct _tuple12 _TmpD=_stmttmp1B;int _TmpE;int _TmpF;_TmpF=_TmpD.f1;_TmpE=_TmpD.f2;{int of=_TmpF;int dist=_TmpE;
if(!of){
if(!Cyc_PrattProver_add_edge(g,1,tt1,tt2,dist,origin))
return 0;}
# 665
...
# 750
{struct _fat_ptr gs=_tag_fat(({struct Cyc_PrattProver_Graph*_Tmp2=Cyc_PrattProver_true_graph();Cyc_PrattProver_cgraph(_Tmp2,a);}),sizeof(struct Cyc_PrattProver_Graph),1U);
# 753
int _Tmp2=(struct Cyc_PrattProver_Graph*)gs.curr != (struct Cyc_PrattProver_Graph*)(_tag_fat(0,0,0)).curr;_npop_handler(0);return _Tmp2;}
# 750
