...
void*_Tmp0;void*_Tmp1;struct Cyc_Absyn_Tqual _Tmp2;void*_Tmp3;void*_Tmp4;if(*((int*)fntype)==5){_Tmp4=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)fntype)->f1.tvars;_Tmp3=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)fntype)->f1.effect;_Tmp2=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)fntype)->f1.ret_tqual;_Tmp1=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)fntype)->f1.ret_type;_Tmp0=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)fntype)->f1.args;{struct Cyc_List_List*tvars=_Tmp4;void*eff=_Tmp3;struct Cyc_Absyn_Tqual res_tq=_Tmp2;void*res_typ=_Tmp1;struct Cyc_List_List**args_info=(struct Cyc_List_List**)_Tmp0;
# 99
...
# 106
{void*_Tmp5;void*_Tmp6;if(*((int*)fntype2)==5){_Tmp6=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)fntype2)->f1.tvars;_Tmp5=(struct Cyc_List_List**)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)fntype2)->f1.args;{struct Cyc_List_List*tvars=_Tmp6;struct Cyc_List_List**args_info2=(struct Cyc_List_List**)_Tmp5;
# 108
...
# 186
topt==0?0:({int(*_Tmp6)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp6;})(_tag_fat("topt == NULL",sizeof(char),13U),_tag_fat("currgn.cyc",sizeof(char),11U),186U);
...
# 320
!env.toplevel?0:({int(*_Tmp6)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp6;})(_tag_fat("!env.toplevel",sizeof(char),14U),_tag_fat("currgn.cyc",sizeof(char),11U),320U);
...
!env.toplevel?0:({int(*_Tmp0)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp0;})(_tag_fat("!env.toplevel",sizeof(char),14U),_tag_fat("currgn.cyc",sizeof(char),11U),351U);{
