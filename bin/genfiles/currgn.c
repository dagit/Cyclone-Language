...
# 212
void*_tmp68=Cyc_Tcutil_compress(new_typ);void*_stmttmp3=_tmp68;void*_tmp69=_stmttmp3;struct Cyc_Absyn_Exp*_tmp6A;if(((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp69)->tag == 9U){_LL58: _tmp6A=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp69)->f1;_LL59: {struct Cyc_Absyn_Exp*e1=_tmp6A;
# 214
e->r=e1->r;
e->topt=e1->topt;
e->annot=e1->annot;
