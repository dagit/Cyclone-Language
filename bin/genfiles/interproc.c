...
# 59
static struct Cyc___cycFILE*Cyc_Interproc_try_file_open(struct _fat_ptr filename,struct _fat_ptr mode,struct _fat_ptr msg_part){struct _handler_cons*_T0;int*_T1;int _T2;struct _fat_ptr _T3;char*_T4;char*_T5;const char*_T6;struct _fat_ptr _T7;char*_T8;char*_T9;const char*_TA;void*_TB;struct Cyc_String_pa_PrintArg_struct _TC;struct Cyc_String_pa_PrintArg_struct _TD;struct _fat_ptr _TE;struct _fat_ptr _TF;struct _handler_cons _T10;_T0=& _T10;_push_handler(_T0);{int _T11=0;_T1=_T10.handler;_T2=setjmp(_T1);if(!_T2)goto _TL6;_T11=1;goto _TL7;_TL6: _TL7: if(_T11)goto _TL8;else{goto _TLA;}_TLA: _T3=filename;_T4=_untag_fat_ptr_check_bound(_T3,sizeof(char),1U);_T5=_check_null(_T4);_T6=(const char*)_T5;_T7=mode;_T8=_untag_fat_ptr_check_bound(_T7,sizeof(char),1U);_T9=_check_null(_T8);_TA=(const char*)_T9;{struct Cyc___cycFILE*_T12=
Cyc_fopen(_T6,_TA);_npop_handler(0);return _T12;}_pop_handler();goto _TL9;_TL8: _TB=Cyc_Core_get_exn_thrown();{void*_T12=(void*)_TB;{struct Cyc_String_pa_PrintArg_struct _T13;_T13.tag=0;
# 63
_T13.f1=msg_part;_TC=_T13;}{struct Cyc_String_pa_PrintArg_struct _T13=_TC;{struct Cyc_String_pa_PrintArg_struct _T14;_T14.tag=0;_T14.f1=filename;_TD=_T14;}{struct Cyc_String_pa_PrintArg_struct _T14=_TD;void*_T15[2];_T15[0]=& _T13;_T15[1]=& _T14;_TE=_tag_fat("Couldn't open %s %s",sizeof(char),20U);_TF=_tag_fat(_T15,sizeof(void*),2);Cyc_Warn_err(0U,_TE,_TF);}}
return 0;;}_TL9:;}}
# 68
...
# 181
 return 1;}
# 185
static int Cyc_Interproc_init_tagmap(struct Cyc_List_List*ftds){struct Cyc_Hashtable_Table*_T0;unsigned _T1;struct _fat_ptr _T2;struct _fat_ptr _T3;struct _fat_ptr _T4;struct Cyc___cycFILE*_T5;unsigned _T6;struct Cyc_List_List*_T7;unsigned _T8;struct Cyc_Hashtable_Table*(*_T9)(int,int(*)(struct _fat_ptr*,struct _fat_ptr*),int(*)(struct _fat_ptr*));struct Cyc_Hashtable_Table*(*_TA)(int,int(*)(void*,void*),int(*)(void*));struct _fat_ptr*_TB;struct _fat_ptr _TC;struct Cyc_String_pa_PrintArg_struct _TD;struct Cyc_List_List*_TE;void*_TF;struct _tuple11*_T10;struct _fat_ptr _T11;struct _fat_ptr _T12;struct Cyc_List_List*_T13;void*_T14;struct _tuple11*_T15;struct Cyc_List_List*_T16;int _T17;struct Cyc_Hashtable_Table*(*_T18)(int,int(*)(struct _fat_ptr*,struct _fat_ptr*),int(*)(struct _fat_ptr*));struct Cyc_Hashtable_Table*(*_T19)(int,int(*)(void*,void*),int(*)(void*));struct _fat_ptr _T1A;char*_T1B;unsigned _T1C;struct _fat_ptr _T1D;char*_T1E;char*_T1F;char _T20;int _T21;struct _fat_ptr*_T22;struct _fat_ptr _T23;struct Cyc_String_pa_PrintArg_struct _T24;struct _fat_ptr _T25;struct _fat_ptr _T26;struct _fat_ptr _T27;struct _fat_ptr _T28;struct _fat_ptr*_T29;struct _fat_ptr _T2A;struct Cyc_String_pa_PrintArg_struct _T2B;struct _fat_ptr _T2C;struct _fat_ptr _T2D;struct _fat_ptr _T2E;struct _fat_ptr _T2F;struct _fat_ptr _T30;struct _fat_ptr _T31;struct _fat_ptr _T32;struct _fat_ptr _T33;int _T34;void(*_T35)(struct Cyc_Hashtable_Table*,struct _fat_ptr*,struct _fat_ptr*);void(*_T36)(struct Cyc_Hashtable_Table*,void*,void*);struct Cyc_Hashtable_Table*_T37;struct _fat_ptr*_T38;struct _fat_ptr*_T39;_T0=Cyc_Interproc_tagmap;_T1=(unsigned)_T0;
if(!_T1)goto _TL33;
return 1;_TL33: _T2=
...
void*_T53=_T2->r;void*_T54;_T3=(int*)_T53;_T4=*_T3;if(_T4!=1)goto _TL50;{struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_T55=(struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_T53;_T5=_T55->f1;_T54=(void*)_T5;}{void*b=_T54;{struct Cyc_Absyn_Vardecl*_T55;struct _tuple0*_T56;_T6=b;_T7=(int*)_T6;_T8=*_T7;switch(_T8){case 0: _T9=b;{struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*_T57=(struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*)_T9;_T56=_T57->f1;}{struct _tuple0*q=_T56;_TA=Cyc_Flags_no_merge;
# 265
if(!_TA)goto _TL53;{struct Cyc_Interproc_Unresolved_sym_exn_struct*_T57=_cycalloc(sizeof(struct Cyc_Interproc_Unresolved_sym_exn_struct));_T57->tag=Cyc_Interproc_Unresolved_sym;_TC=es;_TD=_TC->hd;
_T57->f1=(struct Cyc_Absyn_Exp*)_TD;_TB=(struct Cyc_Interproc_Unresolved_sym_exn_struct*)_T57;}_TE=(void*)_TB;_throw(_TE);goto _TL54;_TL53: _TL54:{struct _handler_cons _T57;_TF=& _T57;_push_handler(_TF);{int _T58=0;_T10=_T57.handler;_T11=setjmp(_T10);if(!_T11)goto _TL55;_T58=1;goto _TL56;_TL55: _TL56: if(_T58)goto _TL57;else{goto _TL59;}_TL59:
# 268
 filename=Cyc_Interproc_locate_qvar(q,ftds);{struct Cyc_List_List*_T59=_cycalloc(sizeof(struct Cyc_List_List));_T13=es;_T14=_T13->hd;
_T59->hd=(struct Cyc_Absyn_Exp*)_T14;_T59->tl=located;_T12=(struct Cyc_List_List*)_T59;}located=_T12;_pop_handler();goto _TL58;_TL57: _T15=Cyc_Core_get_exn_thrown();{void*_T59=(void*)_T15;void*_T5A;_T16=(struct Cyc_Core_Not_found_exn_struct*)_T59;_T17=_T16->tag;_T18=Cyc_Core_Not_found;if(_T17!=_T18)goto _TL5A;{struct Cyc_Interproc_Unresolved_sym_exn_struct*_T5B=_cycalloc(sizeof(struct Cyc_Interproc_Unresolved_sym_exn_struct));_T5B->tag=Cyc_Interproc_Unresolved_sym;_T1A=es;_T1B=_T1A->hd;
# 271
_T5B->f1=(struct Cyc_Absyn_Exp*)_T1B;_T19=(struct Cyc_Interproc_Unresolved_sym_exn_struct*)_T5B;}_T1C=(void*)_T19;_throw(_T1C);goto _TL5B;_TL5A: _T5A=_T59;{void*exn=_T5A;_rethrow(exn);}_TL5B:;}_TL58:;}}goto _LL5;}case 1: _T1D=b;{struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_T57=(struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)_T1D;_T55=_T57->f1;}{struct Cyc_Absyn_Vardecl*vd=_T55;{struct _handler_cons _T57;_T1E=& _T57;_push_handler(_T1E);{int _T58=0;_T1F=_T57.handler;_T20=setjmp(_T1F);if(!_T20)goto _TL5C;_T58=1;goto _TL5D;_TL5C: _TL5D: if(_T58)goto _TL5E;else{goto _TL60;}_TL60: _T21=vd;_T22=_T21->name;_T23=ftds;
# 276
...
# 280
_TL65:{struct Cyc_List_List*_T59=_cycalloc(sizeof(struct Cyc_List_List));_T2C=es;_T2D=_T2C->hd;_T59->hd=(struct Cyc_Absyn_Exp*)_T2D;_T59->tl=located;_T2B=(struct Cyc_List_List*)_T59;}located=_T2B;_npop_handler(0);goto _TL4C;
# 287
_TL63: _T2E=vd;_T2F=_T2E->type;Cyc_Tcutil_introduce_cvars(_T2F);
filename=_tag_fat(0,0,0);_npop_handler(0);goto _TL4C;
# 293
_TL61:{struct Cyc_List_List*_T59=_cycalloc(sizeof(struct Cyc_List_List));_T31=es;_T32=_T31->hd;_T59->hd=(struct Cyc_Absyn_Exp*)_T32;_T59->tl=located;_T30=(struct Cyc_List_List*)_T59;}located=_T30;_pop_handler();goto _TL5F;_TL5E: _T33=Cyc_Core_get_exn_thrown();{void*_T59=(void*)_T33;void*_T5A;_T34=(struct Cyc_Core_Not_found_exn_struct*)_T59;_T35=_T34->tag;_T36=Cyc_Core_Not_found;if(_T35!=_T36)goto _TL66;goto _TL4C;_TL66: _T5A=_T59;{void*exn=_T5A;_rethrow(exn);};}_TL5F:;}}goto _LL5;}default:{struct Cyc_Warn_String_Warn_Warg_struct _T57;_T57.tag=0;
# 303
_T57.f1=_tag_fat("locate_externs: Unexpected expression",sizeof(char),38U);_T37=_T57;}{struct Cyc_Warn_String_Warn_Warg_struct _T57=_T37;{struct Cyc_Warn_Exp_Warn_Warg_struct _T58;_T58.tag=4;_T39=es;_T3A=_T39->hd;_T58.f1=(struct Cyc_Absyn_Exp*)_T3A;_T38=_T58;}{struct Cyc_Warn_Exp_Warn_Warg_struct _T58=_T38;void*_T59[2];_T59[0]=& _T57;_T59[1]=& _T58;_T3C=Cyc_Warn_impos2;{int(*_T5A)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T3C;_T3B=_T5A;}_T3D=_tag_fat(_T59,sizeof(void*),2);_T3B(_T3D);}}goto _LL5;}_LL5:;}goto _LL0;}_TL50:{struct Cyc_Warn_String_Warn_Warg_struct _T55;_T55.tag=0;
# 308
_T55.f1=_tag_fat("locate_externs: Unexpected expression",sizeof(char),38U);_T3E=_T55;}{struct Cyc_Warn_String_Warn_Warg_struct _T55=_T3E;{struct Cyc_Warn_Exp_Warn_Warg_struct _T56;_T56.tag=4;_T40=es;_T41=_T40->hd;_T56.f1=(struct Cyc_Absyn_Exp*)_T41;_T3F=_T56;}{struct Cyc_Warn_Exp_Warn_Warg_struct _T56=_T3F;void*_T57[2];_T57[0]=& _T55;_T57[1]=& _T56;_T43=Cyc_Warn_impos2;{int(*_T58)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T43;_T42=_T58;}_T44=_tag_fat(_T57,sizeof(void*),2);_T42(_T44);}}goto _LL0;_LL0:;}_T45=filename;_T46=_T45.curr;_T47=(unsigned)_T46;
# 312
if(!_T47)goto _TL68;_T48=Cyc_Flags_no_merge;if(_T48)goto _TL68;else{goto _TL6A;}_TL6A: goto _TL69;_TL68: _T4A=Cyc___assert_fail;{int(*_T53)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))_T4A;_T49=_T53;}_T4B=_tag_fat("filename && !Flags::no_merge",sizeof(char),29U);_T4C=_tag_fat("interproc.cyc",sizeof(char),14U);_T49(_T4B,_T4C,312U);_TL69: {
struct _tuple13 _T53=Cyc_Interproc_add_filedecls(filename,ftds);struct Cyc_List_List*_T54;int _T55;_T55=_T53.f0;_T54=_T53.f1;{int b=_T55;struct Cyc_List_List*newl=_T54;_T4D=b;
if(_T4D)goto _TL6B;else{goto _TL6D;}
_TL6D:{struct _tuple14 _T56;_T56.f0=0;_T56.f1=0;_T56.f2=0;_T4E=_T56;}return _T4E;_TL6B: _T4F=newdecls;_T50=(unsigned)_T4F;
if(_T50)goto _TL6E;else{goto _TL70;}
_TL70: newdecls=newl;goto _TL6F;_TL6E: _TL6F:;}}}_TL4C: _T51=es;
# 259
es=_T51->tl;goto _TL4F;_TL4E:{struct _tuple14 _T53;
# 319
_T53.f0=1;_T53.f1=newdecls;_T53.f2=located;_T52=_T53;}return _T52;}
# 330 "interproc.cyc"
...
# 415
 return;};}}
# 421
static void Cyc_Interproc_imp_update_prototypes(struct Cyc_List_List*decls,struct Cyc_Hashtable_Table*fndecl_tab){struct Cyc_List_List*_T0;unsigned _T1;struct Cyc_List_List*_T2;void*_T3;struct Cyc_Absyn_Decl*_T4;int*_T5;unsigned _T6;struct _handler_cons*_T7;int*_T8;int _T9;struct Cyc_Absyn_Fndecl*(*_TA)(struct Cyc_Hashtable_Table*,struct _tuple0*);void*(*_TB)(struct Cyc_Hashtable_Table*,void*);struct Cyc_Hashtable_Table*_TC;struct Cyc_Absyn_Vardecl*_TD;struct _tuple0*_TE;void*_TF;struct Cyc_Core_Not_found_exn_struct*_T10;char*_T11;char*_T12;struct _handler_cons*_T13;int*_T14;int _T15;struct Cyc_List_List*_T16;void*_T17;struct Cyc_Absyn_Decl*_T18;unsigned _T19;struct Cyc_Absyn_Vardecl*_T1A;void*_T1B;struct Cyc_Absyn_FnType_Absyn_Type_struct*_T1C;struct Cyc_Absyn_Fndecl*_T1D;void*_T1E;void*_T1F;struct Cyc_Interproc_Rebinding_exn_struct*_T20;char*_T21;char*_T22;struct Cyc_Warn_String_Warn_Warg_struct _T23;struct Cyc_Warn_Typ_Warn_Warg_struct _T24;struct Cyc_Absyn_Vardecl*_T25;struct Cyc_Warn_Typ_Warn_Warg_struct _T26;struct Cyc_Absyn_FnType_Absyn_Type_struct*_T27;struct Cyc_Absyn_Fndecl*_T28;struct Cyc_List_List*_T29;void*_T2A;struct Cyc_Absyn_Decl*_T2B;unsigned _T2C;struct _fat_ptr _T2D;struct Cyc_List_List*_T2E;
# 423
_TLB6: _T0=decls;_T1=(unsigned)_T0;if(_T1)goto _TLB4;else{goto _TLB5;}
_TLB4: _T2=decls;_T3=_T2->hd;_T4=(struct Cyc_Absyn_Decl*)_T3;{void*_T2F=_T4->r;struct Cyc_List_List*_T30;struct Cyc_Absyn_Vardecl*_T31;_T5=(int*)_T2F;_T6=*_T5;switch(_T6){case 0:{struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_T32=(struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_T2F;_T31=_T32->f1;}{struct Cyc_Absyn_Vardecl*vd=_T31;
# 426
struct Cyc_Absyn_Fndecl*fd;{struct _handler_cons _T32;_T7=& _T32;_push_handler(_T7);{int _T33=0;_T8=_T32.handler;_T9=setjmp(_T8);if(!_T9)goto _TLB8;_T33=1;goto _TLB9;_TLB8: _TLB9: if(_T33)goto _TLBA;else{goto _TLBC;}_TLBC: _TB=Cyc_Hashtable_lookup;{
# 428
struct Cyc_Absyn_Fndecl*(*_T34)(struct Cyc_Hashtable_Table*,struct _tuple0*)=(struct Cyc_Absyn_Fndecl*(*)(struct Cyc_Hashtable_Table*,struct _tuple0*))_TB;_TA=_T34;}_TC=fndecl_tab;_TD=vd;_TE=_TD->name;fd=_TA(_TC,_TE);_pop_handler();goto _TLBB;_TLBA: _TF=Cyc_Core_get_exn_thrown();{void*_T34=(void*)_TF;void*_T35;_T10=(struct Cyc_Core_Not_found_exn_struct*)_T34;_T11=_T10->tag;_T12=Cyc_Core_Not_found;if(_T11!=_T12)goto _TLBD;goto _TLB3;_TLBD: _T35=_T34;{void*exn=_T35;_rethrow(exn);};}_TLBB:;}}{struct _handler_cons _T32;_T13=& _T32;_push_handler(_T13);{int _T33=0;_T14=_T32.handler;_T15=setjmp(_T14);if(!_T15)goto _TLBF;_T33=1;goto _TLC0;_TLBF: _TLC0: if(_T33)goto _TLC1;else{goto _TLC3;}_TLC3: _T16=decls;_T17=_T16->hd;_T18=(struct Cyc_Absyn_Decl*)_T17;_T19=_T18->loc;_T1A=vd;_T1B=_T1A->type;{struct Cyc_Absyn_FnType_Absyn_Type_struct*_T34=_cycalloc(sizeof(struct Cyc_Absyn_FnType_Absyn_Type_struct));_T34->tag=6;_T1D=fd;
# 434
_T34->f1=_T1D->i;_T1C=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T34;}_T1E=(void*)_T1C;Cyc_Interproc_ensure_cvar_identity(_T19,_T1B,_T1E);_pop_handler();goto _TLC2;_TLC1: _T1F=Cyc_Core_get_exn_thrown();{void*_T34=(void*)_T1F;void*_T35;_T20=(struct Cyc_Interproc_Rebinding_exn_struct*)_T34;_T21=_T20->tag;_T22=Cyc_Interproc_Rebinding;if(_T21!=_T22)goto _TLC4;{struct Cyc_Warn_String_Warn_Warg_struct _T36;_T36.tag=0;
# 437
_T36.f1=_tag_fat("Incompatible types in declarations: ",sizeof(char),37U);_T23=_T36;}{struct Cyc_Warn_String_Warn_Warg_struct _T36=_T23;{struct Cyc_Warn_Typ_Warn_Warg_struct _T37;_T37.tag=2;_T25=vd;_T37.f1=_T25->type;_T24=_T37;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T37=_T24;{struct Cyc_Warn_Typ_Warn_Warg_struct _T38;_T38.tag=2;{struct Cyc_Absyn_FnType_Absyn_Type_struct*_T39=_cycalloc(sizeof(struct Cyc_Absyn_FnType_Absyn_Type_struct));_T39->tag=6;_T28=fd;_T39->f1=_T28->i;_T27=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T39;}_T38.f1=(void*)_T27;_T26=_T38;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T38=_T26;void*_T39[3];_T39[0]=& _T36;_T39[1]=& _T37;_T39[2]=& _T38;_T29=decls;_T2A=_T29->hd;_T2B=(struct Cyc_Absyn_Decl*)_T2A;_T2C=_T2B->loc;_T2D=_tag_fat(_T39,sizeof(void*),3);Cyc_Warn_err2(_T2C,_T2D);}}}goto _LLE;_TLC4: _T35=_T34;{void*exn=_T35;_rethrow(exn);}_LLE:;}_TLC2:;}}goto _LL0;}case 9:{struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*_T32=(struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_T2F;_T30=_T32->f2;}{struct Cyc_List_List*l=_T30;_T30=l;goto _LL6;}case 10:{struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*_T32=(struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_T2F;_T30=_T32->f2;}_LL6: {struct Cyc_List_List*l=_T30;
# 443
Cyc_Interproc_imp_update_prototypes(l,fndecl_tab);goto _LL0;}default: goto _LL0;}_LL0:;}_TLB3: _T2E=decls;
# 423
decls=_T2E->tl;goto _TLB6;_TLB5:;}
# 450
...
# 858
struct Cyc_List_List*Cyc_Interproc_resolve_all(struct _fat_ptr filename,struct Cyc_List_List*tds){struct Cyc_List_List*_T0;struct _tuple11*_T1;struct Cyc_List_List*_T2;unsigned _T3;struct Cyc_List_List*_T4;void*_T5;struct _tuple11*_T6;struct Cyc_List_List*_T7;struct Cyc_List_List*_T8;unsigned _T9;struct _handler_cons*_TA;int*_TB;int _TC;int _TD;struct Cyc_List_List*_TE;unsigned _TF;void*_T10;struct Cyc_Interproc_Unresolved_sym_exn_struct*_T11;char*_T12;char*_T13;struct Cyc_Warn_String_Warn_Warg_struct _T14;struct Cyc_Warn_Exp_Warn_Warg_struct _T15;struct Cyc_Absyn_Exp*_T16;unsigned _T17;struct _fat_ptr _T18;struct Cyc_List_List*_T19;unsigned _T1A;struct Cyc_List_List*_T1B;void*_T1C;struct _tuple11*_T1D;struct Cyc_List_List*_T1E;struct Cyc_List_List*_T1F;unsigned _T20;struct Cyc_List_List*_T21;struct Cyc_List_List*_T22;void*_T23;struct _tuple11*_T24;struct Cyc_List_List*_T25;struct Cyc_List_List*_T26;struct Cyc_List_List*_T27;
struct Cyc_List_List*orig=tds;
struct Cyc_List_List*first=0;struct Cyc_List_List*worklist=0;{struct Cyc_List_List*_T28=_cycalloc(sizeof(struct Cyc_List_List));{struct _tuple11*_T29=_cycalloc(sizeof(struct _tuple11));
_T29->f0=filename;_T29->f1=tds;_T1=(struct _tuple11*)_T29;}_T28->hd=_T1;_T28->tl=0;_T0=(struct Cyc_List_List*)_T28;}first=_T0;{
...
if(!_T9)goto _TL15B;{struct _handler_cons _T28;_TA=& _T28;_push_handler(_TA);{int _T29=0;_TB=_T28.handler;_TC=setjmp(_TB);if(!_TC)goto _TL15D;_T29=1;goto _TL15E;_TL15D: _TL15E: if(_T29)goto _TL15F;else{goto _TL161;}_TL161:{
# 871
struct _tuple14 _T2A=Cyc_Interproc_locate_externs(externs,first);struct Cyc_List_List*_T2B;struct Cyc_List_List*_T2C;int _T2D;_T2D=_T2A.f0;_T2C=_T2A.f1;_T2B=_T2A.f2;{int b=_T2D;struct Cyc_List_List*nd=_T2C;struct Cyc_List_List*rext=_T2B;_TD=b;
if(_TD)goto _TL162;else{goto _TL164;}
_TL164:{struct Cyc_List_List*_T2E=tds;_npop_handler(0);return _T2E;}_TL162: _TE=worklist;_TF=(unsigned)_TE;
if(_TF)goto _TL165;else{goto _TL167;}
_TL167: worklist=nd;goto _TL166;_TL165: _TL166:
# 877
 all_located_fnsyms=Cyc_List_imp_append(rext,all_located_fnsyms);}}_pop_handler();goto _TL160;_TL15F: _T10=Cyc_Core_get_exn_thrown();{void*_T2A=(void*)_T10;void*_T2B;_T11=(struct Cyc_Interproc_Unresolved_sym_exn_struct*)_T2A;_T12=_T11->tag;_T13=Cyc_Interproc_Unresolved_sym;if(_T12!=_T13)goto _TL168;{struct Cyc_Interproc_Unresolved_sym_exn_struct*_T2C=(struct Cyc_Interproc_Unresolved_sym_exn_struct*)_T2A;_T2B=_T2C->f1;}{struct Cyc_Absyn_Exp*e=_T2B;{struct Cyc_Warn_String_Warn_Warg_struct _T2C;_T2C.tag=0;
# 880
_T2C.f1=_tag_fat("Undefined symbol",sizeof(char),17U);_T14=_T2C;}{struct Cyc_Warn_String_Warn_Warg_struct _T2C=_T14;{struct Cyc_Warn_Exp_Warn_Warg_struct _T2D;_T2D.tag=4;_T2D.f1=e;_T15=_T2D;}{struct Cyc_Warn_Exp_Warn_Warg_struct _T2D=_T15;void*_T2E[2];_T2E[0]=& _T2C;_T2E[1]=& _T2D;_T16=e;_T17=_T16->loc;_T18=_tag_fat(_T2E,sizeof(void*),2);Cyc_Warn_err2(_T17,_T18);}}
return 0;}_TL168: _T2B=_T2A;{void*exn=_T2B;_rethrow(exn);};}_TL160:;}}goto _TL15C;_TL15B: _TL15C:;}_T19=worklist;_T1A=(unsigned)_T19;
# 863
if(_T1A)goto _TL157;else{goto _TL158;}_TL158: _T1B=first;_T1C=_T1B->hd;_T1D=(struct _tuple11*)_T1C;{
# 885
struct Cyc_List_List*prev=_T1D->f1;
struct Cyc_List_List*all_decls=orig;_T1E=first;{
struct Cyc_List_List*it=_T1E->tl;_TL16D: _T1F=it;_T20=(unsigned)_T1F;if(_T20)goto _TL16B;else{goto _TL16C;}
_TL16B: _T21=all_decls;_T22=it;_T23=_T22->hd;_T24=(struct _tuple11*)_T23;_T25=_T24->f1;all_decls=Cyc_List_imp_append(_T21,_T25);_T26=it;
# 887
it=_T26->tl;goto _TL16D;_TL16C:;}
# 893
Cyc_Interproc_bind_cvars(all_decls);_T27=all_decls;
return _T27;}}}struct _tuple20{void*f0;struct Cyc_List_List*f1;};struct _tuple21{const char*f0;const char*f1;int f2;int f3;};
# 897
