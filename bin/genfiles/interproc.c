...
goto _LL0;}_LL0:;}
# 301
(unsigned)filename.curr && !Cyc_Flags_no_merge?0:({int(*_Tmp0)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp0;})(_tag_fat("filename && !Flags::no_merge",sizeof(char),29U),_tag_fat("interproc.cyc",sizeof(char),14U),301U);{
...
# 490
pfxpos < 1000?0:({int(*_Tmp8)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp8;})(_tag_fat("pfxpos < 1000",sizeof(char),14U),_tag_fat("interproc.cyc",sizeof(char),14U),490U);
...
# 519
pfxpos < 980?0:({int(*_Tmp7)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp7;})(_tag_fat("pfxpos < 980",sizeof(char),13U),_tag_fat("interproc.cyc",sizeof(char),14U),519U);
...
pfxpos < 900?0:({int(*_Tmp5)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp5;})(_tag_fat("pfxpos < 900",sizeof(char),13U),_tag_fat("interproc.cyc",sizeof(char),14U),532U);
...
int findex=0;
if((unsigned)ad->impl){
pfxpos < 900?0:({int(*_Tmp5)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp5;})(_tag_fat("pfxpos < 900",sizeof(char),13U),_tag_fat("interproc.cyc",sizeof(char),14U),551U);
...
# 562
pfxpos < 900?0:({int(*_Tmp5)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp5;})(_tag_fat("pfxpos < 900",sizeof(char),13U),_tag_fat("interproc.cyc",sizeof(char),14U),562U);
...
pfxpos < 900?0:({int(*_Tmp5)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp5;})(_tag_fat("pfxpos < 900",sizeof(char),13U),_tag_fat("interproc.cyc",sizeof(char),14U),576U);{
# 578
...
# 757
*topt==0?0:({int(*_Tmp6)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp6;})(_tag_fat("*topt==0",sizeof(char),9U),_tag_fat("interproc.cyc",sizeof(char),14U),757U);
id > 0?0:({int(*_Tmp6)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp6;})(_tag_fat("id>0",sizeof(char),5U),_tag_fat("interproc.cyc",sizeof(char),14U),758U);
*bv==0?0:({int(*_Tmp6)(struct _fat_ptr,struct _fat_ptr,unsigned)=(int(*)(struct _fat_ptr,struct _fat_ptr,unsigned))Cyc___assert_fail;_Tmp6;})(_tag_fat("*bv==0",sizeof(char),7U),_tag_fat("interproc.cyc",sizeof(char),14U),759U);
# 763
