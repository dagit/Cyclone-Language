...
void*accum);static void*Cyc_Dict_fold_tree(void*(*f)(void*,void*,void*),struct Cyc_Dict_T*
t,void*accum){struct Cyc_Dict_T _tmp6D;struct Cyc_Dict_T*_tmp6E;struct Cyc_Dict_T*
