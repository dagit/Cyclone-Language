...
struct _fat_ptr Cyc_Relations_relation2string(enum Cyc_Relations_Relation r);struct Cyc_Iter_Iter{void*env;int(*next)(void*env,void*dest);};
# 37 "iter.h"
...
# 121
int Cyc_Tcutil_subtype(struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List*assume,void*t1,void*t2);struct _tuple11{struct Cyc_Absyn_Decl*f1;struct Cyc_Absyn_Exp*f2;};
# 125
...
int Cyc_Tcutil_unify_kindbound(void*,void*);struct _tuple12{struct Cyc_Absyn_Tvar*f1;void*f2;};
# 176
...
# 215
struct _tuple12*Cyc_Tcutil_make_inst_var(struct Cyc_List_List*,struct Cyc_Absyn_Tvar*);struct _tuple13{struct Cyc_List_List*f1;struct _RegionHandle*f2;};
struct _tuple12*Cyc_Tcutil_r_make_inst_var(struct _tuple13*,struct Cyc_Absyn_Tvar*);
# 221
...
# 284
int Cyc_Tcutil_is_const_exp(struct Cyc_Absyn_Exp*e);struct _tuple15{struct Cyc_Absyn_Tqual f1;void*f2;};
# 287
void*Cyc_Tcutil_snd_tqt(struct _tuple15*);
# 291
...
# 69
struct _fat_ptr Cyc_Absynpp_qvar2string(struct _tuple0*);struct _tuple16{unsigned f1;int f2;};
# 28 "evexp.h"
...
return({union Cyc_Relations_RelnOp _tmpE7;(_tmpE7.RReturn).tag=7U,(_tmpE7.RReturn).val=0U;_tmpE7;});}struct _tuple17{union Cyc_Relations_RelnOp f1;union Cyc_Relations_RelnOp f2;};
# 54
static int Cyc_Relations_same_relop(union Cyc_Relations_RelnOp r1,union Cyc_Relations_RelnOp r2){
struct _tuple17 _tmp0=({struct _tuple17 _tmpE8;_tmpE8.f1=r1,_tmpE8.f2=r2;_tmpE8;});struct _tuple17 _tmp1=_tmp0;unsigned _tmpD;unsigned _tmpC;unsigned _tmpB;unsigned _tmpA;void*_tmp9;void*_tmp8;struct Cyc_Absyn_Vardecl*_tmp7;struct Cyc_Absyn_Vardecl*_tmp6;struct Cyc_Absyn_Vardecl*_tmp5;struct Cyc_Absyn_Vardecl*_tmp4;unsigned _tmp3;unsigned _tmp2;switch(((_tmp1.f1).RParamNumelts).tag){case 1U: if(((_tmp1.f2).RConst).tag == 1){_LL1: _tmp3=((_tmp1.f1).RConst).val;_tmp2=((_tmp1.f2).RConst).val;_LL2:
...
({void*_tmp12=0U;({unsigned _tmpFC=e_new->loc;struct _fat_ptr _tmpFB=({const char*_tmp13="Could not construct relation";_tag_fat(_tmp13,sizeof(char),29U);});Cyc_Tcutil_warn(_tmpFC,_tmpFB,_tag_fat(_tmp12,sizeof(void*),0U));});});
return relns;}
# 89
...
struct _tuple16 _tmp40=Cyc_Evexp_eval_const_uint_exp(e);struct _tuple16 _tmp41=_tmp40;unsigned _tmp43;int _tmp42;_LL1A: _tmp43=_tmp41.f1;_tmp42=_tmp41.f2;_LL1B:;
if(_tmp42){
...
({void*_tmp58=0U;({struct _fat_ptr _tmp10D=({const char*_tmp59="rop2node";_tag_fat(_tmp59,sizeof(char),9U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp10D,_tag_fat(_tmp58,sizeof(void*),0U));});});}_LL0:;}
# 361
...
union Cyc_Relations_RelnOp _tmp64=r;unsigned _tmp7B;unsigned _tmp7A;struct Cyc_Absyn_Vardecl*_tmp79;void*_tmp78;struct Cyc_Absyn_Vardecl*_tmp77;unsigned _tmp76;switch((_tmp64.RParamNumelts).tag){case 1U: _LL1: _tmp76=(_tmp64.RConst).val;_LL2:
 return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp67=({struct Cyc_Int_pa_PrintArg_struct _tmpE9;_tmpE9.tag=1U,_tmpE9.f1=(unsigned long)((int)_tmp76);_tmpE9;});void*_tmp65[1U];_tmp65[0]=& _tmp67;({struct _fat_ptr _tmp10E=({const char*_tmp66="%d";_tag_fat(_tmp66,sizeof(char),3U);});Cyc_aprintf(_tmp10E,_tag_fat(_tmp65,sizeof(void*),1U));});});case 2U: _LL3: _tmp77=(_tmp64.RVar).val;_LL4:
 return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp6A=({struct Cyc_String_pa_PrintArg_struct _tmpEA;_tmpEA.tag=0U,({struct _fat_ptr _tmp10F=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(_tmp77->name));_tmpEA.f1=_tmp10F;});_tmpEA;});void*_tmp68[1U];_tmp68[0]=& _tmp6A;({struct _fat_ptr _tmp110=({const char*_tmp69="%s";_tag_fat(_tmp69,sizeof(char),3U);});Cyc_aprintf(_tmp110,_tag_fat(_tmp68,sizeof(void*),1U));});});case 4U: _LL5: _tmp78=(_tmp64.RType).val;_LL6:
 return Cyc_Absynpp_typ2string(_tmp78);case 3U: _LL7: _tmp79=(_tmp64.RNumelts).val;_LL8:
 return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp6D=({struct Cyc_String_pa_PrintArg_struct _tmpEB;_tmpEB.tag=0U,({struct _fat_ptr _tmp111=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_qvar2string(_tmp79->name));_tmpEB.f1=_tmp111;});_tmpEB;});void*_tmp6B[1U];_tmp6B[0]=& _tmp6D;({struct _fat_ptr _tmp112=({const char*_tmp6C="numelts(%s)";_tag_fat(_tmp6C,sizeof(char),12U);});Cyc_aprintf(_tmp112,_tag_fat(_tmp6B,sizeof(void*),1U));});});case 5U: _LL9: _tmp7A=(_tmp64.RParam).val;_LLA:
 return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp70=({struct Cyc_Int_pa_PrintArg_struct _tmpEC;_tmpEC.tag=1U,_tmpEC.f1=(unsigned long)((int)_tmp7A);_tmpEC;});void*_tmp6E[1U];_tmp6E[0]=& _tmp70;({struct _fat_ptr _tmp113=({const char*_tmp6F="param(%d)";_tag_fat(_tmp6F,sizeof(char),10U);});Cyc_aprintf(_tmp113,_tag_fat(_tmp6E,sizeof(void*),1U));});});case 6U: _LLB: _tmp7B=(_tmp64.RParamNumelts).val;_LLC:
 return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp73=({struct Cyc_Int_pa_PrintArg_struct _tmpED;_tmpED.tag=1U,_tmpED.f1=(unsigned long)((int)_tmp7B);_tmpED;});void*_tmp71[1U];_tmp71[0]=& _tmp73;({struct _fat_ptr _tmp114=({const char*_tmp72="numelts(param(%d))";_tag_fat(_tmp72,sizeof(char),19U);});Cyc_aprintf(_tmp114,_tag_fat(_tmp71,sizeof(void*),1U));});});default: _LLD: _LLE:
 return(struct _fat_ptr)({void*_tmp74=0U;({struct _fat_ptr _tmp115=({const char*_tmp75="return_value";_tag_fat(_tmp75,sizeof(char),13U);});Cyc_aprintf(_tmp115,_tag_fat(_tmp74,sizeof(void*),0U));});});}_LL0:;}
# 382
struct _fat_ptr Cyc_Relations_reln2string(struct Cyc_Relations_Reln*r){
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp7E=({struct Cyc_String_pa_PrintArg_struct _tmpF0;_tmpF0.tag=0U,({struct _fat_ptr _tmp116=(struct _fat_ptr)((struct _fat_ptr)Cyc_Relations_rop2string(r->rop1));_tmpF0.f1=_tmp116;});_tmpF0;});struct Cyc_String_pa_PrintArg_struct _tmp7F=({struct Cyc_String_pa_PrintArg_struct _tmpEF;_tmpEF.tag=0U,({struct _fat_ptr _tmp117=(struct _fat_ptr)((struct _fat_ptr)Cyc_Relations_relation2string(r->relation));_tmpEF.f1=_tmp117;});_tmpEF;});struct Cyc_String_pa_PrintArg_struct _tmp80=({struct Cyc_String_pa_PrintArg_struct _tmpEE;_tmpEE.tag=0U,({
struct _fat_ptr _tmp118=(struct _fat_ptr)((struct _fat_ptr)Cyc_Relations_rop2string(r->rop2));_tmpEE.f1=_tmp118;});_tmpEE;});void*_tmp7C[3U];_tmp7C[0]=& _tmp7E,_tmp7C[1]=& _tmp7F,_tmp7C[2]=& _tmp80;({struct _fat_ptr _tmp119=({const char*_tmp7D="%s %s %s";_tag_fat(_tmp7D,sizeof(char),9U);});Cyc_aprintf(_tmp119,_tag_fat(_tmp7C,sizeof(void*),3U));});});}
# 387
...
for(0;rs != 0;rs=rs->tl){
ss=({struct Cyc_List_List*_tmp83=_cycalloc(sizeof(*_tmp83));({struct _fat_ptr*_tmp11B=({struct _fat_ptr*_tmp82=_cycalloc(sizeof(*_tmp82));({struct _fat_ptr _tmp11A=Cyc_Relations_reln2string((struct Cyc_Relations_Reln*)rs->hd);*_tmp82=_tmp11A;});_tmp82;});_tmp83->hd=_tmp11B;}),_tmp83->tl=ss;_tmp83;});
if(rs->tl != 0)ss=({struct Cyc_List_List*_tmp86=_cycalloc(sizeof(*_tmp86));({struct _fat_ptr*_tmp11D=({struct _fat_ptr*_tmp85=_cycalloc(sizeof(*_tmp85));({struct _fat_ptr _tmp11C=({const char*_tmp84=" && ";_tag_fat(_tmp84,sizeof(char),5U);});*_tmp85=_tmp11C;});_tmp85;});_tmp86->hd=_tmp11D;}),_tmp86->tl=ss;_tmp86;});}
# 394
return(struct _fat_ptr)Cyc_strconcat_l(ss);};}
# 397
void Cyc_Relations_print_relns(struct Cyc___cycFILE*f,struct Cyc_List_List*r){
for(0;r != 0;r=r->tl){
({struct Cyc_String_pa_PrintArg_struct _tmp89=({struct Cyc_String_pa_PrintArg_struct _tmpF1;_tmpF1.tag=0U,({struct _fat_ptr _tmp11E=(struct _fat_ptr)((struct _fat_ptr)Cyc_Relations_reln2string((struct Cyc_Relations_Reln*)r->hd));_tmpF1.f1=_tmp11E;});_tmpF1;});void*_tmp87[1U];_tmp87[0]=& _tmp89;({struct Cyc___cycFILE*_tmp120=f;struct _fat_ptr _tmp11F=({const char*_tmp88="%s";_tag_fat(_tmp88,sizeof(char),3U);});Cyc_fprintf(_tmp120,_tmp11F,_tag_fat(_tmp87,sizeof(void*),1U));});});
if(r->tl != 0)({void*_tmp8A=0U;({struct Cyc___cycFILE*_tmp122=f;struct _fat_ptr _tmp121=({const char*_tmp8B=",";_tag_fat(_tmp8B,sizeof(char),2U);});Cyc_fprintf(_tmp122,_tmp121,_tag_fat(_tmp8A,sizeof(void*),0U));});});}}
# 404
...
({void*_tmpB4=0U;({struct _fat_ptr _tmp146=({const char*_tmpB5="primop2relation";_tag_fat(_tmpB5,sizeof(char),16U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp146,_tag_fat(_tmpB4,sizeof(void*),0U));});});}_LL0:;}
# 575
enum Cyc_Relations_Relation Cyc_Relations_flip_relation(enum Cyc_Relations_Relation r){
...
# 633
if(Cyc_Tcutil_is_const_exp(e)){
struct _tuple16 _tmpD6=Cyc_Evexp_eval_const_uint_exp(e);struct _tuple16 _tmpD7=_tmpD6;unsigned _tmpDE;int _tmpDD;_LL35: _tmpDE=_tmpD7.f1;_tmpDD=_tmpD7.f2;_LL36:;
if(_tmpDD){
...
struct _fat_ptr _tmp150=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmpF8.f1=_tmp150;});_tmpF8;});void*_tmpDA[1U];_tmpDA[0]=& _tmpDC;({unsigned _tmp152=e->loc;struct _fat_ptr _tmp151=({const char*_tmpDB="unable to convert `%s' to static relation";_tag_fat(_tmpDB,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp152,_tmp151,_tag_fat(_tmpDA,sizeof(void*),1U));});});}
# 644
