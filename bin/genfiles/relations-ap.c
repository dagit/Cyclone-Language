...
# 71
struct _fat_ptr Cyc_Absynpp_qvar2string(struct _tuple0*);struct _tuple12{unsigned f0;int f1;};
# 28 "evexp.h"
...
# 35 "relations-ap.cyc"
union Cyc_Relations_RelnOp Cyc_Relations_RConst(unsigned i){union Cyc_Relations_RelnOp _Tmp0;_Tmp0.RConst.tag=1U,_Tmp0.RConst.val=i;return _Tmp0;}
union Cyc_Relations_RelnOp Cyc_Relations_RVar(struct Cyc_Absyn_Vardecl*v){union Cyc_Relations_RelnOp _Tmp0;_Tmp0.RVar.tag=2U,_Tmp0.RVar.val=v;return _Tmp0;}
union Cyc_Relations_RelnOp Cyc_Relations_RNumelts(struct Cyc_Absyn_Vardecl*v){union Cyc_Relations_RelnOp _Tmp0;_Tmp0.RNumelts.tag=3U,_Tmp0.RNumelts.val=v;return _Tmp0;}
union Cyc_Relations_RelnOp Cyc_Relations_RType(void*t){union Cyc_Relations_RelnOp _Tmp0;_Tmp0.RType.tag=4U,({void*_Tmp1=Cyc_Absyn_compress(t);_Tmp0.RType.val=_Tmp1;});return _Tmp0;}
union Cyc_Relations_RelnOp Cyc_Relations_RParam(unsigned i){union Cyc_Relations_RelnOp _Tmp0;_Tmp0.RParam.tag=5U,_Tmp0.RParam.val=i;return _Tmp0;}
union Cyc_Relations_RelnOp Cyc_Relations_RParamNumelts(unsigned i){union Cyc_Relations_RelnOp _Tmp0;_Tmp0.RParamNumelts.tag=6U,_Tmp0.RParamNumelts.val=i;return _Tmp0;}
union Cyc_Relations_RelnOp Cyc_Relations_RReturn (void){union Cyc_Relations_RelnOp _Tmp0;_Tmp0.RReturn.tag=7U,_Tmp0.RReturn.val=0U;return _Tmp0;}struct _tuple13{union Cyc_Relations_RelnOp f0;union Cyc_Relations_RelnOp f1;};
# 43
static int Cyc_Relations_same_relop(union Cyc_Relations_RelnOp r1,union Cyc_Relations_RelnOp r2){
struct _tuple13 _Tmp0=({struct _tuple13 _Tmp1;_Tmp1.f0=r1,_Tmp1.f1=r2;_Tmp1;});void*_Tmp1;void*_Tmp2;unsigned _Tmp3;unsigned _Tmp4;switch(_Tmp0.f0.RParamNumelts.tag){case 1: if(_Tmp0.f1.RConst.tag==1){_Tmp4=_Tmp0.f0.RConst.val;_Tmp3=_Tmp0.f1.RConst.val;{unsigned c1=_Tmp4;unsigned c2=_Tmp3;
return c1==c2;}}else{goto _LLF;}case 2: if(_Tmp0.f1.RVar.tag==2){_Tmp2=_Tmp0.f0.RVar.val;_Tmp1=_Tmp0.f1.RVar.val;{struct Cyc_Absyn_Vardecl*x1=_Tmp2;struct Cyc_Absyn_Vardecl*x2=_Tmp1;
return x1==x2;}}else{goto _LLF;}case 3: if(_Tmp0.f1.RNumelts.tag==3){_Tmp2=_Tmp0.f0.RNumelts.val;_Tmp1=_Tmp0.f1.RNumelts.val;{struct Cyc_Absyn_Vardecl*x1=_Tmp2;struct Cyc_Absyn_Vardecl*x2=_Tmp1;
return x1==x2;}}else{goto _LLF;}case 4: if(_Tmp0.f1.RType.tag==4){_Tmp2=_Tmp0.f0.RType.val;_Tmp1=_Tmp0.f1.RType.val;{void*t1=_Tmp2;void*t2=_Tmp1;
return Cyc_Unify_unify(t1,t2);}}else{goto _LLF;}case 5: if(_Tmp0.f1.RParam.tag==5){_Tmp4=_Tmp0.f0.RParam.val;_Tmp3=_Tmp0.f1.RParam.val;{unsigned i=_Tmp4;unsigned j=_Tmp3;
return i==j;}}else{goto _LLF;}case 6: if(_Tmp0.f1.RParamNumelts.tag==6){_Tmp4=_Tmp0.f0.RParamNumelts.val;_Tmp3=_Tmp0.f1.RParamNumelts.val;{unsigned i=_Tmp4;unsigned j=_Tmp3;
return i==j;}}else{goto _LLF;}default: if(_Tmp0.f1.RReturn.tag==7)
return 1;else{_LLF:
 return 0;}};}
# 56
...
# 65
struct Cyc_List_List*_Tmp0=_region_malloc(rgn,0U,sizeof(struct Cyc_List_List));({struct Cyc_Relations_Reln*_Tmp1=({struct Cyc_Relations_Reln*_Tmp2=_region_malloc(rgn,0U,sizeof(struct Cyc_Relations_Reln));_Tmp2->rop1=rop1,_Tmp2->relation=relation,_Tmp2->rop2=rop2;_Tmp2;});_Tmp0->hd=_Tmp1;}),_Tmp0->tl=relns;return _Tmp0;}}
# 68
...
Cyc_Warn_warn(e_new->loc,_tag_fat("Could not construct relation",sizeof(char),29U),_tag_fat(0U,sizeof(void*),0));
return relns;}
# 78
{struct Cyc_List_List*rs=relns;for(0;rs!=0;rs=rs->tl){
struct Cyc_Relations_Reln*r=(struct Cyc_Relations_Reln*)rs->hd;
...
# 91
if(addIt)
relns=({struct Cyc_List_List*_Tmp0=_region_malloc(rgn,0U,sizeof(struct Cyc_List_List));({struct Cyc_Relations_Reln*_Tmp1=({struct Cyc_Relations_Reln*_Tmp2=_region_malloc(rgn,0U,sizeof(struct Cyc_Relations_Reln));_Tmp2->rop1=rop1,_Tmp2->relation=r->relation,_Tmp2->rop2=rop2;_Tmp2;});_Tmp0->hd=_Tmp1;}),_Tmp0->tl=relns;_Tmp0;});}}
# 94
return relns;}
# 97
...
# 130
 Cyc_Relations_same_relop(r1->rop2,r2->rop2)){
res=({struct Cyc_List_List*_Tmp2=_region_malloc(r,0U,sizeof(struct Cyc_List_List));_Tmp2->hd=r1,_Tmp2->tl=res;_Tmp2;});
found=1;
break;}}}
# 136
if(!found)diff=1;}}
...
void*_Tmp0;switch(r.RReturn.tag){case 2: _Tmp0=r.RVar.val;{struct Cyc_Absyn_Vardecl*v2=_Tmp0;
if(v==v2)return new_rop;else{return r;}}case 3: _Tmp0=r.RNumelts.val;{struct Cyc_Absyn_Vardecl*v2=_Tmp0;
if(v==v2)return new_rop;else{return r;}}case 4:
 goto _LL8;case 5: _LL8:
 goto _LLA;case 6: _LLA:
 goto _LLC;case 7: _LLC:
 goto _LLE;default: _LLE:
...
# 168
struct Cyc_Relations_Reln*_Tmp0=_region_malloc(rgn,0U,sizeof(struct Cyc_Relations_Reln));({union Cyc_Relations_RelnOp _Tmp1=Cyc_Relations_subst_rop_var(reln->rop1,v,new_rop);_Tmp0->rop1=_Tmp1;}),_Tmp0->relation=reln->relation,({
union Cyc_Relations_RelnOp _Tmp1=Cyc_Relations_subst_rop_var(reln->rop2,v,new_rop);_Tmp0->rop2=_Tmp1;});return _Tmp0;}
# 171
...
struct Cyc_Relations_Reln*r=(struct Cyc_Relations_Reln*)p->hd;
if(Cyc_Relations_rop_contains_var(r->rop1,v)|| Cyc_Relations_rop_contains_var(r->rop2,v))
new_rs=({struct Cyc_List_List*_Tmp0=_region_malloc(rgn,0U,sizeof(struct Cyc_List_List));({struct Cyc_Relations_Reln*_Tmp1=Cyc_Relations_substitute_rop_var(rgn,r,v,new_rop);_Tmp0->hd=_Tmp1;}),_Tmp0->tl=new_rs;_Tmp0;});else{
# 191
new_rs=({struct Cyc_List_List*_Tmp0=_region_malloc(rgn,0U,sizeof(struct Cyc_List_List));_Tmp0->hd=r,_Tmp0->tl=new_rs;_Tmp0;});}}
# 194
return new_rs;}}
# 200
...
return 1;}
# 223
goto _LL7;}case 0: if(((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_Tmp0)->f1.Int_c.tag==5){_Tmp1=((struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_Tmp0)->f1.Int_c.val.f1;{int i=_Tmp1;
# 225
...
return 1;}
# 233
goto _LL7;}}else{goto _LL12;}}else{goto _LL12;}}else{goto _LL12;}case 38: _Tmp2=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{void*t=_Tmp2;
# 235
...
struct _tuple12 _Tmp0=Cyc_Evexp_eval_const_uint_exp(e);int _Tmp1;unsigned _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{unsigned t1=_Tmp2;int known=_Tmp1;
if(known){
...
struct Cyc_Relations_Reln*_Tmp0=_region_malloc(r2,0U,sizeof(struct Cyc_Relations_Reln));*_Tmp0=*r;return _Tmp0;}
# 272
...
# 300
{void*_Tmp0=e->r;void*_Tmp1;if(*((int*)_Tmp0)==33){if(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_Tmp0)->f1.fat_result==1){_Tmp1=((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_Tmp0)->f1.num_elts;{struct Cyc_Absyn_Exp*e2=_Tmp1;
# 303
malloc_loop: {
...
if(vd!=0){
struct _RegionHandle*_Tmp4=rgn;union Cyc_Relations_RelnOp _Tmp5=Cyc_Relations_RVar(vd);union Cyc_Relations_RelnOp _Tmp6=Cyc_Relations_RNumelts(v);return Cyc_Relations_add_relation(_Tmp4,_Tmp5,0U,_Tmp6,r);}else{
return r;}}default:
...
struct _RegionHandle*_Tmp0=rgn;union Cyc_Relations_RelnOp _Tmp1=Cyc_Relations_RVar(v);union Cyc_Relations_RelnOp _Tmp2=eop;return Cyc_Relations_add_relation(_Tmp0,_Tmp1,0U,_Tmp2,r);}
# 323
return r;}}
# 326
...
switch((int)r){case Cyc_Relations_Req:
 return _tag_fat("==",sizeof(char),3U);case Cyc_Relations_Rneq:
 return _tag_fat("!=",sizeof(char),3U);case Cyc_Relations_Rlt:
 return _tag_fat("<",sizeof(char),2U);case Cyc_Relations_Rlte:
 goto _LLA;default: _LLA: return _tag_fat("<=",sizeof(char),3U);};}
# 359
...
struct Cyc_Int_pa_PrintArg_struct _Tmp2=({struct Cyc_Int_pa_PrintArg_struct _Tmp3;_Tmp3.tag=1,_Tmp3.f1=(unsigned long)((int)c);_Tmp3;});void*_Tmp3[1];_Tmp3[0]=& _Tmp2;return Cyc_aprintf(_tag_fat("%d",sizeof(char),3U),_tag_fat(_Tmp3,sizeof(void*),1));}case 2: _Tmp0=r.RVar.val;{struct Cyc_Absyn_Vardecl*vd=_Tmp0;
struct Cyc_String_pa_PrintArg_struct _Tmp2=({struct Cyc_String_pa_PrintArg_struct _Tmp3;_Tmp3.tag=0,({struct _fat_ptr _Tmp4=Cyc_Absynpp_qvar2string(vd->name);_Tmp3.f1=_Tmp4;});_Tmp3;});void*_Tmp3[1];_Tmp3[0]=& _Tmp2;return Cyc_aprintf(_tag_fat("%s",sizeof(char),3U),_tag_fat(_Tmp3,sizeof(void*),1));}case 4: _Tmp0=r.RType.val;{void*t=_Tmp0;
return Cyc_Absynpp_typ2string(t);}case 3: _Tmp0=r.RNumelts.val;{struct Cyc_Absyn_Vardecl*vd=_Tmp0;
struct Cyc_String_pa_PrintArg_struct _Tmp2=({struct Cyc_String_pa_PrintArg_struct _Tmp3;_Tmp3.tag=0,({struct _fat_ptr _Tmp4=Cyc_Absynpp_qvar2string(vd->name);_Tmp3.f1=_Tmp4;});_Tmp3;});void*_Tmp3[1];_Tmp3[0]=& _Tmp2;return Cyc_aprintf(_tag_fat("numelts(%s)",sizeof(char),12U),_tag_fat(_Tmp3,sizeof(void*),1));}case 5: _Tmp1=r.RParam.val;{unsigned i=_Tmp1;
struct Cyc_Int_pa_PrintArg_struct _Tmp2=({struct Cyc_Int_pa_PrintArg_struct _Tmp3;_Tmp3.tag=1,_Tmp3.f1=(unsigned long)((int)i);_Tmp3;});void*_Tmp3[1];_Tmp3[0]=& _Tmp2;return Cyc_aprintf(_tag_fat("param(%d)",sizeof(char),10U),_tag_fat(_Tmp3,sizeof(void*),1));}case 6: _Tmp1=r.RParamNumelts.val;{unsigned i=_Tmp1;
struct Cyc_Int_pa_PrintArg_struct _Tmp2=({struct Cyc_Int_pa_PrintArg_struct _Tmp3;_Tmp3.tag=1,_Tmp3.f1=(unsigned long)((int)i);_Tmp3;});void*_Tmp3[1];_Tmp3[0]=& _Tmp2;return Cyc_aprintf(_tag_fat("numelts(param(%d))",sizeof(char),19U),_tag_fat(_Tmp3,sizeof(void*),1));}default:
 return Cyc_aprintf(_tag_fat("return_value",sizeof(char),13U),_tag_fat(0U,sizeof(void*),0));};}
# 371
struct _fat_ptr Cyc_Relations_reln2string(struct Cyc_Relations_Reln*r){
struct Cyc_String_pa_PrintArg_struct _Tmp0=({struct Cyc_String_pa_PrintArg_struct _Tmp1;_Tmp1.tag=0,({struct _fat_ptr _Tmp2=Cyc_Relations_rop2string(r->rop1);_Tmp1.f1=_Tmp2;});_Tmp1;});struct Cyc_String_pa_PrintArg_struct _Tmp1=({struct Cyc_String_pa_PrintArg_struct _Tmp2;_Tmp2.tag=0,({struct _fat_ptr _Tmp3=Cyc_Relations_relation2string(r->relation);_Tmp2.f1=_Tmp3;});_Tmp2;});struct Cyc_String_pa_PrintArg_struct _Tmp2=({struct Cyc_String_pa_PrintArg_struct _Tmp3;_Tmp3.tag=0,({
struct _fat_ptr _Tmp4=Cyc_Relations_rop2string(r->rop2);_Tmp3.f1=_Tmp4;});_Tmp3;});void*_Tmp3[3];_Tmp3[0]=& _Tmp0,_Tmp3[1]=& _Tmp1,_Tmp3[2]=& _Tmp2;return Cyc_aprintf(_tag_fat("%s %s %s",sizeof(char),9U),_tag_fat(_Tmp3,sizeof(void*),3));}
# 376
struct _fat_ptr Cyc_Relations_relns2string(struct Cyc_List_List*rs){
if(rs==0)return _tag_fat("true",sizeof(char),5U);{
...
if(rs->tl!=0)ss=({struct Cyc_List_List*_Tmp0=_cycalloc(sizeof(struct Cyc_List_List));({struct _fat_ptr*_Tmp1=({struct _fat_ptr*_Tmp2=_cycalloc(sizeof(struct _fat_ptr));*_Tmp2=_tag_fat(" && ",sizeof(char),5U);_Tmp2;});_Tmp0->hd=_Tmp1;}),_Tmp0->tl=ss;_Tmp0;});}
# 383
return Cyc_strconcat_l(ss);}}
# 386
void Cyc_Relations_print_relns(struct Cyc___cycFILE*f,struct Cyc_List_List*r){
for(1;r!=0;r=r->tl){
({struct Cyc_String_pa_PrintArg_struct _Tmp0=({struct Cyc_String_pa_PrintArg_struct _Tmp1;_Tmp1.tag=0,({struct _fat_ptr _Tmp2=Cyc_Relations_reln2string((struct Cyc_Relations_Reln*)r->hd);_Tmp1.f1=_Tmp2;});_Tmp1;});void*_Tmp1[1];_Tmp1[0]=& _Tmp0;Cyc_fprintf(f,_tag_fat("%s",sizeof(char),3U),_tag_fat(_Tmp1,sizeof(void*),1));});
if(r->tl!=0)Cyc_fprintf(f,_tag_fat(",",sizeof(char),2U),_tag_fat(0U,sizeof(void*),0));}}
# 393
...
# 405
{void*_Tmp1=Cyc_Absyn_compress(v->type);void*_Tmp2;if(*((int*)_Tmp1)==4){_Tmp2=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_Tmp1)->f1.ptr_atts.bounds;{void*b=_Tmp2;
# 409
if(({void*_Tmp3=b;_Tmp3==Cyc_Absyn_bounds_one();}))goto _LLC;{
struct Cyc_Absyn_Exp*eopt=Cyc_Tcutil_get_bounds_exp_constrain(Cyc_Absyn_fat_bound_type,b,1);
if(eopt!=0){
...
struct _tuple11 _Tmp0;_Tmp0.f0=e1,_Tmp0.f1=0U,_Tmp0.f2=e2;return _Tmp0;}case Cyc_Absyn_Neq:  {
struct _tuple11 _Tmp0;_Tmp0.f0=e1,_Tmp0.f1=1U,_Tmp0.f2=e2;return _Tmp0;}case Cyc_Absyn_Lt:  {
struct _tuple11 _Tmp0;_Tmp0.f0=e1,_Tmp0.f1=3U,_Tmp0.f2=e2;return _Tmp0;}case Cyc_Absyn_Lte:  {
struct _tuple11 _Tmp0;_Tmp0.f0=e1,_Tmp0.f1=2U,_Tmp0.f2=e2;return _Tmp0;}case Cyc_Absyn_Gt:  {
struct _tuple11 _Tmp0;_Tmp0.f0=e2,_Tmp0.f1=3U,_Tmp0.f2=e1;return _Tmp0;}case Cyc_Absyn_Gte:  {
struct _tuple11 _Tmp0;_Tmp0.f0=e2,_Tmp0.f1=2U,_Tmp0.f2=e1;return _Tmp0;}case Cyc_Absyn_ULt:  {
struct _tuple11 _Tmp0;_Tmp0.f0=e1,_Tmp0.f1=3U,_Tmp0.f2=e2;return _Tmp0;}case Cyc_Absyn_ULte:  {
struct _tuple11 _Tmp0;_Tmp0.f0=e1,_Tmp0.f1=2U,_Tmp0.f2=e2;return _Tmp0;}case Cyc_Absyn_UGt:  {
struct _tuple11 _Tmp0;_Tmp0.f0=e2,_Tmp0.f1=3U,_Tmp0.f2=e1;return _Tmp0;}case Cyc_Absyn_UGte:  {
struct _tuple11 _Tmp0;_Tmp0.f0=e2,_Tmp0.f1=2U,_Tmp0.f2=e1;return _Tmp0;}default:
...
struct Cyc_Relations_Reln*_Tmp0=_region_malloc(r,0U,sizeof(struct Cyc_Relations_Reln));_Tmp0->rop1=rln->rop2,({enum Cyc_Relations_Relation _Tmp1=Cyc_Relations_flip_relation(rln->relation);_Tmp0->relation=_Tmp1;}),_Tmp0->rop2=rln->rop1;return _Tmp0;}
# 598
...
struct _tuple11 _Tmp4=Cyc_Relations_primop2relation(e1,p,e2);void*_Tmp5;enum Cyc_Relations_Relation _Tmp6;void*_Tmp7;_Tmp7=_Tmp4.f0;_Tmp6=_Tmp4.f1;_Tmp5=_Tmp4.f2;{struct Cyc_Absyn_Exp*e1=_Tmp7;enum Cyc_Relations_Relation rln=_Tmp6;struct Cyc_Absyn_Exp*e2=_Tmp5;
...
struct Cyc_List_List*_Tmp8=_region_malloc(r,0U,sizeof(struct Cyc_List_List));({struct Cyc_Relations_Reln*_Tmp9=({struct Cyc_Relations_Reln*_TmpA=_region_malloc(r,0U,sizeof(struct Cyc_Relations_Reln));_TmpA->rop1=rop2,({enum Cyc_Relations_Relation _TmpB=Cyc_Relations_flip_relation(rln);_TmpA->relation=_TmpB;}),_TmpA->rop2=rop1;_TmpA;});_Tmp8->hd=_Tmp9;}),_Tmp8->tl=0;return _Tmp8;}
goto _LL10;}}default:
 goto _LL10;}_LL10:;
# 620
...
union Cyc_Relations_RelnOp rop2=Cyc_Relations_RConst(0U);
if(Cyc_Relations_exp2relnop(e1,& rop1)&& Cyc_Relations_exp2relnop(e2,& rop2)){
struct Cyc_List_List*_Tmp8=_region_malloc(r,0U,sizeof(struct Cyc_List_List));({struct Cyc_Relations_Reln*_Tmp9=({struct Cyc_Relations_Reln*_TmpA=_region_malloc(r,0U,sizeof(struct Cyc_Relations_Reln));_TmpA->rop1=rop1,_TmpA->relation=rln,_TmpA->rop2=rop2;_TmpA;});_Tmp8->hd=_Tmp9;}),_Tmp8->tl=0;return _Tmp8;}
goto _LL22;}}default:
 goto _LL22;}_LL22:;
# 632
...
# 636
if(Cyc_Tcutil_is_const_exp(e)){
struct _tuple12 _Tmp0=Cyc_Evexp_eval_const_uint_exp(e);int _Tmp1;unsigned _Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{unsigned i=_Tmp2;int known=_Tmp1;
if(known){
if((int)i)return 0;else{
# 641
struct Cyc_List_List*_Tmp3=_region_malloc(r,0U,sizeof(struct Cyc_List_List));({struct Cyc_Relations_Reln*_Tmp4=({struct Cyc_Relations_Reln*_Tmp5=_region_malloc(r,0U,sizeof(struct Cyc_Relations_Reln));({union Cyc_Relations_RelnOp _Tmp6=Cyc_Relations_RConst(0U);_Tmp5->rop1=_Tmp6;}),_Tmp5->relation=3U,({union Cyc_Relations_RelnOp _Tmp6=Cyc_Relations_RConst(0U);_Tmp5->rop2=_Tmp6;});_Tmp5;});_Tmp3->hd=_Tmp4;}),_Tmp3->tl=0;return _Tmp3;}}
# 643
({struct Cyc_String_pa_PrintArg_struct _Tmp3=({struct Cyc_String_pa_PrintArg_struct _Tmp4;_Tmp4.tag=0,({
struct _fat_ptr _Tmp5=Cyc_Absynpp_exp2string(e);_Tmp4.f1=_Tmp5;});_Tmp4;});void*_Tmp4[1];_Tmp4[0]=& _Tmp3;Cyc_Warn_err(e->loc,_tag_fat("unable to convert `%s' to static relation",sizeof(char),42U),_tag_fat(_Tmp4,sizeof(void*),1));});}}{
# 647
struct Cyc_List_List*_Tmp0=_region_malloc(r,0U,sizeof(struct Cyc_List_List));({struct Cyc_Relations_Reln*_Tmp1=({struct Cyc_Relations_Reln*_Tmp2=_region_malloc(r,0U,sizeof(struct Cyc_Relations_Reln));({union Cyc_Relations_RelnOp _Tmp3=Cyc_Relations_RConst(0U);_Tmp2->rop1=_Tmp3;}),_Tmp2->relation=3U,({union Cyc_Relations_RelnOp _Tmp3=Cyc_Relations_RConst(0U);_Tmp2->rop2=_Tmp3;});_Tmp2;});_Tmp0->hd=_Tmp1;}),_Tmp0->tl=0;return _Tmp0;}}
