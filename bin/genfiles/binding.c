...
({struct Cyc_Binding_Env*_tmp38A=_tmp29A;Cyc_Binding_resolve_decl(_tmp38A,({struct Cyc_Absyn_Decl*_tmp29C=_cycalloc(sizeof(*_tmp29C));({void*_tmp389=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp29B=_cycalloc(sizeof(*_tmp29B));_tmp29B->tag=6U,_tmp29B->f1=Cyc_Absyn_exn_tud;_tmp29B;});_tmp29C->r=_tmp389;}),_tmp29C->loc=0U;_tmp29C;}));});
