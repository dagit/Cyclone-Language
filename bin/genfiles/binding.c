...
({void*_tmp269=0U;({struct _dyneither_ptr _tmp375=({const char*_tmp26A="datatype field Loc_n or C_n";_tag_dyneither(_tmp26A,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp375,_tag_dyneither(_tmp269,sizeof(void*),0U));});});}_LL3C:;}{
# 1110
