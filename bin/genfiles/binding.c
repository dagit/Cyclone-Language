...
struct Cyc_List_List*_tmp314=({struct Cyc_List_List*_tmp2=_cycalloc(sizeof(*_tmp2));({void*_tmp313=(void*)({struct Cyc_Binding_Namespace_Binding_NSDirective_struct*_tmp1=_cycalloc(sizeof(*_tmp1));_tmp1->tag=0U,_tmp1->f1=0;_tmp1;});_tmp2->hd=_tmp313;}),_tmp2->tl=0;_tmp2;});_tmp3->availables=_tmp314;}),({
struct Cyc_Dict_Dict _tmp312=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct Cyc_List_List*,struct Cyc_List_List*),struct Cyc_List_List*k,void*v))Cyc_Dict_singleton)(Cyc_Absyn_varlist_cmp,0,data);_tmp3->ns_data=_tmp312;});_tmp3;});}
# 65
...
({void*_tmp7=0U;({struct _fat_ptr _tmp315=({const char*_tmp8="Binding:get_ns_data: relative ns";_tag_fat(_tmp8,sizeof(char),33U);});Cyc_Warn_impos(_tmp315,_tag_fat(_tmp7,sizeof(void*),0U));});});}_LL0:;}
# 83 "binding.cyc"
...
goto _LL0;}}_LL0:;}}
# 98
({struct Cyc_Warn_String_Warn_Warg_struct _tmp11=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E4;_tmp2E4.tag=0U,({struct _fat_ptr _tmp316=({const char*_tmp16="namespace ";_tag_fat(_tmp16,sizeof(char),11U);});_tmp2E4.f1=_tmp316;});_tmp2E4;});struct Cyc_Warn_String_Warn_Warg_struct _tmp12=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E3;_tmp2E3.tag=0U,({struct _fat_ptr _tmp318=(struct _fat_ptr)({struct Cyc_List_List*_tmp317=rel_ns;Cyc_str_sepstr(_tmp317,({const char*_tmp15="::";_tag_fat(_tmp15,sizeof(char),3U);}));});_tmp2E3.f1=_tmp318;});_tmp2E3;});struct Cyc_Warn_String_Warn_Warg_struct _tmp13=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E2;_tmp2E2.tag=0U,({struct _fat_ptr _tmp319=({const char*_tmp14=" not found";_tag_fat(_tmp14,sizeof(char),11U);});_tmp2E2.f1=_tmp319;});_tmp2E2;});void*_tmp10[3U];_tmp10[0]=& _tmp11,_tmp10[1]=& _tmp12,_tmp10[2]=& _tmp13;({unsigned _tmp31A=loc;Cyc_Warn_err2(_tmp31A,_tag_fat(_tmp10,sizeof(void*),3U));});});
...
# 113
{struct _handler_cons _tmp2A;_push_handler(& _tmp2A);{int _tmp2C=0;if(setjmp(_tmp2A.handler))_tmp2C=1;if(!_tmp2C){{void*_tmp2D=({void*(*_tmp31E)(void*,struct _fat_ptr*)=lookup;void*_tmp31D=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,ns);_tmp31E(_tmp31D,v);});_npop_handler(0U);return _tmp2D;};_pop_handler();}else{void*_tmp2B=(void*)Cyc_Core_get_exn_thrown();void*_tmp2E=_tmp2B;void*_tmp2F;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp2E)->tag == Cyc_Dict_Absent){_LL19: _LL1A:
...
void*_tmp35=({void*(*_tmp320)(void*,struct _fat_ptr*)=lookup;void*_tmp31F=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,abs_ns);_tmp320(_tmp31F,v);});_npop_handler(0U);return _tmp35;}
# 120
...
# 125
struct _handler_cons _tmp39;_push_handler(& _tmp39);{int _tmp3B=0;if(setjmp(_tmp39.handler))_tmp3B=1;if(!_tmp3B){{void*_tmp3C=({void*(*_tmp322)(void*,struct _fat_ptr*)=lookup;void*_tmp321=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,ns);_tmp322(_tmp321,v);});_npop_handler(0U);return _tmp3C;};_pop_handler();}else{void*_tmp3A=(void*)Cyc_Core_get_exn_thrown();void*_tmp3D=_tmp3A;void*_tmp3E;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp3D)->tag == Cyc_Dict_Absent){_LL23: _LL24:
...
({void*_tmp40=0U;({struct _fat_ptr _tmp323=({const char*_tmp41="lookup local in global";_tag_fat(_tmp41,sizeof(char),23U);});Cyc_Warn_impos(_tmp323,_tag_fat(_tmp40,sizeof(void*),0U));});});}_LL3:;}}
# 131
...
struct Cyc_List_List*_tmp43=({struct Cyc_List_List*_tmp324=ns;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp324,({struct Cyc_List_List*_tmp46=_cycalloc(sizeof(*_tmp46));_tmp46->hd=subname,_tmp46->tl=0;_tmp46;}));});struct Cyc_List_List*ns2=_tmp43;
if(!((int(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_member)(ctxt->ns_data,ns2))
({struct Cyc_Dict_Dict _tmp327=({struct Cyc_Dict_Dict _tmp326=ctxt->ns_data;struct Cyc_List_List*_tmp325=ns2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k,void*v))Cyc_Dict_insert)(_tmp326,_tmp325,mkdata(env));});ctxt->ns_data=_tmp327;});
ctxt->curr_ns=ns2;
({struct Cyc_List_List*_tmp329=({struct Cyc_List_List*_tmp45=_cycalloc(sizeof(*_tmp45));({void*_tmp328=(void*)({struct Cyc_Binding_Namespace_Binding_NSDirective_struct*_tmp44=_cycalloc(sizeof(*_tmp44));_tmp44->tag=0U,_tmp44->f1=ns2;_tmp44;});_tmp45->hd=_tmp328;}),_tmp45->tl=ctxt->availables;_tmp45;});ctxt->availables=_tmp329;});}
# 139
void Cyc_Binding_leave_ns(struct Cyc_Binding_NSCtxt*ctxt){
if(ctxt->availables == 0)
({void*_tmp47=0U;({struct _fat_ptr _tmp32A=({const char*_tmp48="leaving topmost namespace";_tag_fat(_tmp48,sizeof(char),26U);});Cyc_Warn_impos(_tmp32A,_tag_fat(_tmp47,sizeof(void*),0U));});});{
...
({struct Cyc_List_List*_tmp32B=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(((struct Cyc_List_List*)_check_null(((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(ctxt->curr_ns)))->tl);ctxt->curr_ns=_tmp32B;});
goto _LL0;}else{_LL3: _LL4:
# 148
({void*_tmp4B=0U;({struct _fat_ptr _tmp32C=({const char*_tmp4C="leaving using as namespace";_tag_fat(_tmp4C,sizeof(char),27U);});Cyc_Warn_impos(_tmp32C,_tag_fat(_tmp4B,sizeof(void*),0U));});});}_LL0:;}}
# 151
struct Cyc_List_List*Cyc_Binding_enter_using(unsigned loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*usename){
...
# 156
ns=({unsigned _tmp32F=loc;struct Cyc_Binding_NSCtxt*_tmp32E=ctxt;Cyc_Binding_resolve_rel_ns(_tmp32F,_tmp32E,({struct Cyc_List_List*_tmp32D=vs;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp32D,({struct Cyc_List_List*_tmp53=_cycalloc(sizeof(*_tmp53));_tmp53->hd=v,_tmp53->tl=0;_tmp53;}));}));});{
...
({union Cyc_Absyn_Nmspace _tmp330=Cyc_Absyn_Abs_n(abs_vs,0);(*usename).f1=_tmp330;});
goto _LL3;}}case 2U: _LL6: _tmp51=(_tmp50.Abs_n).val;_LL7: {struct Cyc_List_List*vs=_tmp51;
# 161
ns=({struct Cyc_List_List*_tmp331=vs;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp331,({struct Cyc_List_List*_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55->hd=v,_tmp55->tl=0;_tmp55;}));});
goto _LL3;}case 4U: _LL8: _LL9:
({void*_tmp56=0U;({struct _fat_ptr _tmp332=({const char*_tmp57="enter_using, Loc_n";_tag_fat(_tmp57,sizeof(char),19U);});Cyc_Warn_impos(_tmp332,_tag_fat(_tmp56,sizeof(void*),0U));});});default: _LLA: _LLB:
({void*_tmp58=0U;({struct _fat_ptr _tmp333=({const char*_tmp59="enter_using, C_n";_tag_fat(_tmp59,sizeof(char),17U);});Cyc_Warn_impos(_tmp333,_tag_fat(_tmp58,sizeof(void*),0U));});});}_LL3:;}
# 166
({struct Cyc_List_List*_tmp335=({struct Cyc_List_List*_tmp5B=_cycalloc(sizeof(*_tmp5B));({void*_tmp334=(void*)({struct Cyc_Binding_Using_Binding_NSDirective_struct*_tmp5A=_cycalloc(sizeof(*_tmp5A));_tmp5A->tag=1U,_tmp5A->f1=ns;_tmp5A;});_tmp5B->hd=_tmp334;}),_tmp5B->tl=ctxt->availables;_tmp5B;});ctxt->availables=_tmp335;});
return ns;}}
# 169
void Cyc_Binding_leave_using(struct Cyc_Binding_NSCtxt*ctxt){
if(ctxt->availables == 0)
({void*_tmp5C=0U;({struct _fat_ptr _tmp336=({const char*_tmp5D="leaving topmost namespace as a using";_tag_fat(_tmp5D,sizeof(char),37U);});Cyc_Warn_impos(_tmp336,_tag_fat(_tmp5C,sizeof(void*),0U));});});{
...
return({struct Cyc_Binding_ResolveNSEnv*_tmp62=_cycalloc(sizeof(*_tmp62));({struct Cyc_Dict_Dict _tmp33C=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp62->aggrdecls=_tmp33C;}),({
struct Cyc_Dict_Dict _tmp33B=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp62->datatypedecls=_tmp33B;}),({
struct Cyc_Dict_Dict _tmp33A=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp62->enumdecls=_tmp33A;}),({
struct Cyc_Dict_Dict _tmp339=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp62->typedefs=_tmp339;}),({
struct Cyc_Dict_Dict _tmp338=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp62->ordinaries=_tmp338;});_tmp62;});}
# 228
...
({union Cyc_Absyn_Nmspace _tmp33E=({struct Cyc_List_List*_tmp33D=(env->ns)->curr_ns;Cyc_Absyn_Abs_n(_tmp33D,Cyc_Binding_in_cinclude(env)||(int)sc == (int)Cyc_Absyn_ExternC);});(*qv).f1=_tmp33E;});else{
# 281
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp6B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E7;_tmp2E7.tag=0U,({struct _fat_ptr _tmp33F=({const char*_tmp6F="qualified names in declarations unimplemented (";_tag_fat(_tmp6F,sizeof(char),48U);});_tmp2E7.f1=_tmp33F;});_tmp2E7;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp6C=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2E6;_tmp2E6.tag=1U,_tmp2E6.f1=qv;_tmp2E6;});struct Cyc_Warn_String_Warn_Warg_struct _tmp6D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E5;_tmp2E5.tag=0U,({struct _fat_ptr _tmp340=({const char*_tmp6E=")";_tag_fat(_tmp6E,sizeof(char),2U);});_tmp2E5.f1=_tmp340;});_tmp2E5;});void*_tmp6A[3U];_tmp6A[0]=& _tmp6B,_tmp6A[1]=& _tmp6C,_tmp6A[2]=& _tmp6D;({unsigned _tmp341=loc;Cyc_Warn_err2(_tmp341,_tag_fat(_tmp6A,sizeof(void*),3U));});});}_LL0:;}
# 294
...
({void*_tmp7D=0U;({struct _fat_ptr _tmp342=({const char*_tmp7E="shadowing free variable!";_tag_fat(_tmp7E,sizeof(char),25U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp342,_tag_fat(_tmp7D,sizeof(void*),0U));});});}_LLB:;}
# 316
...
# 322
({struct Cyc_Warn_String_Warn_Warg_struct _tmp83=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E9;_tmp2E9.tag=0U,({struct _fat_ptr _tmp343=({const char*_tmp85="declaration hides ";_tag_fat(_tmp85,sizeof(char),19U);});_tmp2E9.f1=_tmp343;});_tmp2E9;});struct Cyc_Warn_String_Warn_Warg_struct _tmp84=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E8;_tmp2E8.tag=0U,_tmp2E8.f1=hides_what;_tmp2E8;});void*_tmp82[2U];_tmp82[0]=& _tmp83,_tmp82[1]=& _tmp84;({unsigned _tmp344=loc;Cyc_Warn_warn2(_tmp344,_tag_fat(_tmp82,sizeof(void*),2U));});});
_npop_handler(0U);return;
# 304
...
if(!Cyc_Binding_at_toplevel(env))
({struct Cyc_Dict_Dict _tmp348=({struct Cyc_Dict_Dict _tmp347=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _fat_ptr*_tmp346=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp347,_tmp346,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp8D=_cycalloc(sizeof(*_tmp8D));
_tmp8D->tag=0U,({void*_tmp345=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp8C=_cycalloc(sizeof(*_tmp8C));_tmp8C->tag=4U,_tmp8C->f1=vd;_tmp8C;});_tmp8D->f1=_tmp345;});_tmp8D;}));});
# 334
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp348;});else{
# 336
...
({struct Cyc_Dict_Dict _tmp34C=({struct Cyc_Dict_Dict _tmp34B=decl_ns_data->ordinaries;struct _fat_ptr*_tmp34A=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp34B,_tmp34A,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp90=_cycalloc(sizeof(*_tmp90));
# 340
_tmp90->tag=0U,({void*_tmp349=(void*)({struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp8F=_cycalloc(sizeof(*_tmp8F));_tmp8F->tag=1U,_tmp8F->f1=vd;_tmp8F;});_tmp90->f1=_tmp349;});_tmp90;}));});
# 338
decl_ns_data->ordinaries=_tmp34C;});}}}}}
# 344
...
({void*_tmp34D=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmp104=_cycalloc(sizeof(*_tmp104));_tmp104->tag=31U,_tmp104->f1=0,_tmp104->f2=tud,_tmp104->f3=tuf;_tmp104;});e->r=_tmp34D;});_npop_handler(0U);return;}case 3U: _LL5F: _tmpFF=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmpFB)->f1;_tmp100=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmpFB)->f2;_LL60: {struct Cyc_Absyn_Enumdecl*ed=_tmpFF;struct Cyc_Absyn_Enumfield*ef=_tmp100;
({void*_tmp34E=(void*)({struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmp105=_cycalloc(sizeof(*_tmp105));_tmp105->tag=32U,_tmp105->f1=ed,_tmp105->f2=ef;_tmp105;});e->r=_tmp34E;});_npop_handler(0U);return;}case 4U: _LL61: _tmpFD=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmpFB)->f1;_tmpFE=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmpFB)->f2;_LL62: {void*t=_tmpFD;struct Cyc_Absyn_Enumfield*ef=_tmpFE;
({void*_tmp34F=(void*)({struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmp106=_cycalloc(sizeof(*_tmp106));_tmp106->tag=33U,_tmp106->f1=t,_tmp106->f2=ef;_tmp106;});e->r=_tmp34F;});_npop_handler(0U);return;}default: _LL63: _tmpFC=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmpFB)->f1;_LL64: {struct Cyc_Absyn_Aggrdecl*ad=_tmpFC;
({struct Cyc_Warn_String_Warn_Warg_struct _tmp108=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EB;_tmp2EB.tag=0U,({struct _fat_ptr _tmp350=({const char*_tmp10A="bad occurrence of type name ";_tag_fat(_tmp10A,sizeof(char),29U);});_tmp2EB.f1=_tmp350;});_tmp2EB;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp109=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2EA;_tmp2EA.tag=1U,_tmp2EA.f1=q;_tmp2EA;});void*_tmp107[2U];_tmp107[0]=& _tmp108,_tmp107[1]=& _tmp109;({unsigned _tmp351=e->loc;Cyc_Warn_err2(_tmp351,_tag_fat(_tmp107,sizeof(void*),2U));});});_npop_handler(0U);return;}}_LL5A:;}
# 381
...
# 389
({struct Cyc_Warn_String_Warn_Warg_struct _tmp10E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2ED;_tmp2ED.tag=0U,({struct _fat_ptr _tmp352=({const char*_tmp110="undeclared identifier ";_tag_fat(_tmp110,sizeof(char),23U);});_tmp2ED.f1=_tmp352;});_tmp2ED;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp10F=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2EC;_tmp2EC.tag=1U,_tmp2EC.f1=q;_tmp2EC;});void*_tmp10D[2U];_tmp10D[0]=& _tmp10E,_tmp10D[1]=& _tmp10F;({unsigned _tmp353=e->loc;Cyc_Warn_err2(_tmp353,_tag_fat(_tmp10D,sizeof(void*),2U));});});return;}else{_LL68: _tmp10C=_tmp10B;_LL69: {void*exn=_tmp10C;(int)_rethrow(exn);}}_LL65:;}}}}else{_LL58: _LL59:
# 391
...
for(0;es != 0;es=es->tl){
dles=({struct Cyc_List_List*_tmp123=_cycalloc(sizeof(*_tmp123));({struct _tuple11*_tmp354=({struct _tuple11*_tmp122=_cycalloc(sizeof(*_tmp122));_tmp122->f1=0,_tmp122->f2=(struct Cyc_Absyn_Exp*)es->hd;_tmp122;});_tmp123->hd=_tmp354;}),_tmp123->tl=dles;_tmp123;});}
({void*_tmp356=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp124=_cycalloc(sizeof(*_tmp124));_tmp124->tag=29U,_tmp124->f1=ad->name,_tmp124->f2=0,({struct Cyc_List_List*_tmp355=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);_tmp124->f3=_tmp355;}),_tmp124->f4=ad;_tmp124;});e->r=_tmp356;});
...
if(tuf->typs == 0)
# 414
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp126=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2EF;_tmp2EF.tag=1U,_tmp2EF.f1=tuf->name;_tmp2EF;});struct Cyc_Warn_String_Warn_Warg_struct _tmp127=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EE;_tmp2EE.tag=0U,({struct _fat_ptr _tmp357=({const char*_tmp128=" is a constant, not a function";_tag_fat(_tmp128,sizeof(char),31U);});_tmp2EE.f1=_tmp357;});_tmp2EE;});void*_tmp125[2U];_tmp125[0]=& _tmp126,_tmp125[1]=& _tmp127;({unsigned _tmp358=e->loc;Cyc_Warn_err2(_tmp358,_tag_fat(_tmp125,sizeof(void*),2U));});});
({void*_tmp359=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmp129=_cycalloc(sizeof(*_tmp129));_tmp129->tag=31U,_tmp129->f1=es,_tmp129->f2=tud,_tmp129->f3=tuf;_tmp129;});e->r=_tmp359;});
_npop_handler(0U);return;}case 4U: _LL7B: _LL7C:
 goto _LL7E;default: _LL7D: _LL7E:
# 419
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp12B=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F1;_tmp2F1.tag=1U,_tmp2F1.f1=q;_tmp2F1;});struct Cyc_Warn_String_Warn_Warg_struct _tmp12C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F0;_tmp2F0.tag=0U,({struct _fat_ptr _tmp35A=({const char*_tmp12D=" is an enum constructor, not a function";_tag_fat(_tmp12D,sizeof(char),40U);});_tmp2F0.f1=_tmp35A;});_tmp2F0;});void*_tmp12A[2U];_tmp12A[0]=& _tmp12B,_tmp12A[1]=& _tmp12C;({unsigned _tmp35B=e->loc;Cyc_Warn_err2(_tmp35B,_tag_fat(_tmp12A,sizeof(void*),2U));});});_npop_handler(0U);return;}_LL74:;}
# 402
...
# 421
({struct Cyc_Warn_String_Warn_Warg_struct _tmp131=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F3;_tmp2F3.tag=0U,({struct _fat_ptr _tmp35C=({const char*_tmp133="undeclared identifier ";_tag_fat(_tmp133,sizeof(char),23U);});_tmp2F3.f1=_tmp35C;});_tmp2F3;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp132=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F2;_tmp2F2.tag=1U,_tmp2F2.f1=q;_tmp2F2;});void*_tmp130[2U];_tmp130[0]=& _tmp131,_tmp130[1]=& _tmp132;({unsigned _tmp35D=e->loc;Cyc_Warn_err2(_tmp35D,_tag_fat(_tmp130,sizeof(void*),2U));});});return;}else{_LL82: _tmp12F=_tmp12E;_LL83: {void*exn=_tmp12F;(int)_rethrow(exn);}}_LL7F:;}}}}else{_LL72: _LL73:
# 423
...
({struct Cyc_Absyn_Aggrdecl*_tmp35E=((struct Cyc_Absyn_Aggrdecl*(*)(unsigned loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_Absyn_Aggrdecl*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _fat_ptr*)))Cyc_Binding_resolve_lookup)(e->loc,env->ns,*tn,Cyc_Binding_lookup_aggrdecl);*adopt=_tmp35E;});
...
# 436
({struct Cyc_Warn_String_Warn_Warg_struct _tmp13A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F5;_tmp2F5.tag=0U,({struct _fat_ptr _tmp35F=({const char*_tmp13C="unbound struct/union name ";_tag_fat(_tmp13C,sizeof(char),27U);});_tmp2F5.f1=_tmp35F;});_tmp2F5;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp13B=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F4;_tmp2F4.tag=1U,_tmp2F4.f1=*tn;_tmp2F4;});void*_tmp139[2U];_tmp139[0]=& _tmp13A,_tmp139[1]=& _tmp13B;({unsigned _tmp360=e->loc;Cyc_Warn_err2(_tmp360,_tag_fat(_tmp139,sizeof(void*),2U));});});
...
if(Cyc_Binding_at_toplevel(env)){
({struct Cyc_Dict_Dict*_tmp362=({struct Cyc_Dict_Dict*_tmp13D=_cycalloc(sizeof(*_tmp13D));({struct Cyc_Dict_Dict _tmp361=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp13D=_tmp361;});_tmp13D;});env->local_vars=_tmp362;});
...
if(a == 0)
continue;{
struct Cyc_Absyn_Vardecl*_tmp156=({struct _tuple0*_tmp363=({struct _tuple0*_tmp158=_cycalloc(sizeof(*_tmp158));_tmp158->f1=Cyc_Absyn_Loc_n,_tmp158->f2=a;_tmp158;});Cyc_Absyn_new_vardecl(0U,_tmp363,t,0);});struct Cyc_Absyn_Vardecl*vd=_tmp156;
vd->tq=tq;
...
if(v == 0){
if(need_va_name)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp160=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F6;_tmp2F6.tag=0U,({struct _fat_ptr _tmp364=({const char*_tmp161="missing name for vararg";_tag_fat(_tmp161,sizeof(char),24U);});_tmp2F6.f1=_tmp364;});_tmp2F6;});void*_tmp15F[1U];_tmp15F[0]=& _tmp160;({unsigned _tmp365=loc;Cyc_Warn_err2(_tmp365,_tag_fat(_tmp15F,sizeof(void*),1U));});});}else{
# 606
void*_tmp162=Cyc_Absyn_fatptr_type(t,Cyc_Absyn_heap_rgn_type,tq,Cyc_Absyn_false_type);void*typ=_tmp162;
struct Cyc_Absyn_Vardecl*_tmp163=({struct _tuple0*_tmp366=({struct _tuple0*_tmp165=_cycalloc(sizeof(*_tmp165));_tmp165->f1=Cyc_Absyn_Loc_n,_tmp165->f2=v;_tmp165;});Cyc_Absyn_new_vardecl(0U,_tmp366,typ,0);});struct Cyc_Absyn_Vardecl*vd=_tmp163;
...
struct _fat_ptr*_tmp168=({struct _fat_ptr*_tmp16E=_cycalloc(sizeof(*_tmp16E));({struct _fat_ptr _tmp367=({const char*_tmp16D="return_value";_tag_fat(_tmp16D,sizeof(char),13U);});*_tmp16E=_tmp367;});_tmp16E;});struct _fat_ptr*v=_tmp168;
struct Cyc_Absyn_Vardecl*_tmp169=({struct _tuple0*_tmp368=({struct _tuple0*_tmp16C=_cycalloc(sizeof(*_tmp16C));_tmp16C->f1=Cyc_Absyn_Loc_n,_tmp16C->f2=v;_tmp16C;});Cyc_Absyn_new_vardecl(0U,_tmp368,i.ret_type,0);});struct Cyc_Absyn_Vardecl*vd=_tmp169;
({struct Cyc_Dict_Dict _tmp36C=({struct Cyc_Dict_Dict _tmp36B=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _fat_ptr*_tmp36A=v;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp36B,_tmp36A,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp16B=_cycalloc(sizeof(*_tmp16B));
_tmp16B->tag=0U,({void*_tmp369=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp16A=_cycalloc(sizeof(*_tmp16A));_tmp16A->tag=4U,_tmp16A->f1=vd;_tmp16A;});_tmp16B->f1=_tmp369;});_tmp16B;}));});
# 631
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp36C;});
# 633
...
({union Cyc_Absyn_DatatypeInfo _tmp36D=Cyc_Absyn_UnknownDatatype(({struct Cyc_Absyn_UnknownDatatypeInfo _tmp2F7;_tmp2F7.name=tud->name,_tmp2F7.is_extensible=b;_tmp2F7;}));*info=_tmp36D;});
_npop_handler(0U);return;}
# 651
...
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1A3=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2FD;_tmp2FD.tag=1U,_tmp2FD.f1=tuf->name;_tmp2FD;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1A4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FC;_tmp2FC.tag=0U,({struct _fat_ptr _tmp36E=({const char*_tmp1AB=" is a variant of ";_tag_fat(_tmp1AB,sizeof(char),18U);});_tmp2FC.f1=_tmp36E;});_tmp2FC;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1A5=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2FB;_tmp2FB.tag=1U,_tmp2FB.f1=tud2->name;_tmp2FB;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1A6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FA;_tmp2FA.tag=0U,({struct _fat_ptr _tmp36F=({const char*_tmp1AA=" not ";_tag_fat(_tmp1AA,sizeof(char),6U);});_tmp2FA.f1=_tmp36F;});_tmp2FA;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1A7=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F9;_tmp2F9.tag=1U,_tmp2F9.f1=tud->name;_tmp2F9;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1A8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F8;_tmp2F8.tag=0U,({
struct _fat_ptr _tmp370=({const char*_tmp1A9=" (shadowing not yet implemented properly)";_tag_fat(_tmp1A9,sizeof(char),42U);});_tmp2F8.f1=_tmp370;});_tmp2F8;});void*_tmp1A2[6U];_tmp1A2[0]=& _tmp1A3,_tmp1A2[1]=& _tmp1A4,_tmp1A2[2]=& _tmp1A5,_tmp1A2[3]=& _tmp1A6,_tmp1A2[4]=& _tmp1A7,_tmp1A2[5]=& _tmp1A8;({unsigned _tmp371=loc;Cyc_Warn_err2(_tmp371,_tag_fat(_tmp1A2,sizeof(void*),6U));});});
_npop_handler(0U);return;}
# 674
({union Cyc_Absyn_DatatypeFieldInfo _tmp372=Cyc_Absyn_UnknownDatatypefield(({struct Cyc_Absyn_UnknownDatatypeFieldInfo _tmp2FE;_tmp2FE.datatype_name=tud->name,_tmp2FE.field_name=tuf->name,_tmp2FE.is_extensible=b;_tmp2FE;}));*info=_tmp372;});
# 676
...
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1AF=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp300;_tmp300.tag=1U,_tmp300.f1=qvf;_tmp300;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1B0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FF;_tmp2FF.tag=0U,({struct _fat_ptr _tmp373=({const char*_tmp1B1=" is not a datatype field";_tag_fat(_tmp1B1,sizeof(char),25U);});_tmp2FF.f1=_tmp373;});_tmp2FF;});void*_tmp1AE[2U];_tmp1AE[0]=& _tmp1AF,_tmp1AE[1]=& _tmp1B0;({unsigned _tmp374=loc;Cyc_Warn_err2(_tmp374,_tag_fat(_tmp1AE,sizeof(void*),2U));});});return;}}else{_LL32: _LL33:
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1BC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp301;_tmp301.tag=0U,({struct _fat_ptr _tmp375=({const char*_tmp1BD="struct vs. union mismatch with earlier declaration";_tag_fat(_tmp1BD,sizeof(char),51U);});_tmp301.f1=_tmp375;});_tmp301;});void*_tmp1BB[1U];_tmp1BB[0]=& _tmp1BC;({unsigned _tmp376=loc;Cyc_Warn_err2(_tmp376,_tag_fat(_tmp1BB,sizeof(void*),1U));});});
if((((int)ak == (int)1U && bo != 0)&& ad->impl != 0)&&((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->tagged != (int)bo->v)
# 695
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1BF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp302;_tmp302.tag=0U,({struct _fat_ptr _tmp377=({const char*_tmp1C0="@tagged mismatch with earlier declaration";_tag_fat(_tmp1C0,sizeof(char),42U);});_tmp302.f1=_tmp377;});_tmp302;});void*_tmp1BE[1U];_tmp1BE[0]=& _tmp1BF;({unsigned _tmp378=loc;Cyc_Warn_err2(_tmp378,_tag_fat(_tmp1BE,sizeof(void*),1U));});});
({union Cyc_Absyn_AggrInfo _tmp379=Cyc_Absyn_UnknownAggr(ak,ad->name,bo);*info=_tmp379;});
_npop_handler(0U);return;}
# 690
...
# 748
struct Cyc_Binding_ResolveNSEnv*_tmp1DF=({struct Cyc_Binding_NSCtxt*_tmp37B=env->ns;((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(_tmp37B,({struct Cyc_List_List*_tmp37A=(env->ns)->curr_ns;Cyc_Absyn_Abs_n(_tmp37A,
...
({struct Cyc_Dict_Dict _tmp37E=({struct Cyc_Dict_Dict _tmp37D=decl_ns_data->ordinaries;struct _fat_ptr*_tmp37C=(*f->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp37D,_tmp37C,(void*)({struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*_tmp1E1=_cycalloc(sizeof(*_tmp1E1));_tmp1E1->tag=4U,_tmp1E1->f1=t,_tmp1E1->f2=f;_tmp1E1;}));});decl_ns_data->ordinaries=_tmp37E;});}
# 756
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1D0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp304;_tmp304.tag=0U,({struct _fat_ptr _tmp37F=({const char*_tmp1D2="unbound typdef name ";_tag_fat(_tmp1D2,sizeof(char),21U);});_tmp304.f1=_tmp37F;});_tmp304;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1D1=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp303;_tmp303.tag=1U,_tmp303.f1=*tdn;_tmp303;});void*_tmp1CF[2U];_tmp1CF[0]=& _tmp1D0,_tmp1CF[1]=& _tmp1D1;({unsigned _tmp380=loc;Cyc_Warn_err2(_tmp380,_tag_fat(_tmp1CF,sizeof(void*),2U));});});
...
# 730
({struct Cyc_Binding_Env*_tmp382=env;Cyc_Binding_resolve_decl(_tmp382,({struct Cyc_Absyn_Decl*_tmp1DA=_cycalloc(sizeof(*_tmp1DA));({void*_tmp381=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp1D9=_cycalloc(sizeof(*_tmp1D9));_tmp1D9->tag=5U,_tmp1D9->f1=ad;_tmp1D9;});_tmp1DA->r=_tmp381;}),_tmp1DA->loc=td->loc;_tmp1DA;}));});goto _LL52;}case 1U: _LL55: _tmp1D7=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)_tmp1D5)->f1;_LL56: {struct Cyc_Absyn_Enumdecl*ed=_tmp1D7;
# 732
({struct Cyc_Binding_Env*_tmp384=env;Cyc_Binding_resolve_decl(_tmp384,({struct Cyc_Absyn_Decl*_tmp1DC=_cycalloc(sizeof(*_tmp1DC));({void*_tmp383=(void*)({struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*_tmp1DB=_cycalloc(sizeof(*_tmp1DB));_tmp1DB->tag=7U,_tmp1DB->f1=ed;_tmp1DB;});_tmp1DC->r=_tmp383;}),_tmp1DC->loc=td->loc;_tmp1DC;}));});goto _LL52;}default: _LL57: _tmp1D6=((struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)_tmp1D5)->f1;_LL58: {struct Cyc_Absyn_Datatypedecl*tud=_tmp1D6;
# 734
({struct Cyc_Binding_Env*_tmp386=env;Cyc_Binding_resolve_decl(_tmp386,({struct Cyc_Absyn_Decl*_tmp1DE=_cycalloc(sizeof(*_tmp1DE));({void*_tmp385=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp1DD=_cycalloc(sizeof(*_tmp1DD));_tmp1DD->tag=6U,_tmp1DD->f1=tud;_tmp1DD;});_tmp1DE->r=_tmp385;}),_tmp1DE->loc=td->loc;_tmp1DE;}));});goto _LL52;}}_LL52:;}
# 736
env->local_vars=old_locals;
...
if(old_locals != 0)
({struct Cyc_Dict_Dict*_tmp387=({struct Cyc_Dict_Dict*_tmp1E4=_cycalloc(sizeof(*_tmp1E4));*_tmp1E4=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));_tmp1E4;});env->local_vars=_tmp387;});else{
# 790
({struct Cyc_Dict_Dict*_tmp389=({struct Cyc_Dict_Dict*_tmp1E5=_cycalloc(sizeof(*_tmp1E5));({struct Cyc_Dict_Dict _tmp388=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp1E5=_tmp388;});_tmp1E5;});env->local_vars=_tmp389;});}
{struct Cyc_List_List*_tmp1E6=vds;struct Cyc_List_List*vds1=_tmp1E6;for(0;vds1 != 0;vds1=vds1->tl){
({struct Cyc_Dict_Dict _tmp38D=({struct Cyc_Dict_Dict _tmp38C=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _fat_ptr*_tmp38B=(*((struct Cyc_Absyn_Vardecl*)vds1->hd)->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp38C,_tmp38B,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp1E8=_cycalloc(sizeof(*_tmp1E8));
_tmp1E8->tag=0U,({void*_tmp38A=(void*)({struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp1E7=_cycalloc(sizeof(*_tmp1E7));_tmp1E7->tag=3U,_tmp1E7->f1=(struct Cyc_Absyn_Vardecl*)vds1->hd;_tmp1E7;});_tmp1E8->f1=_tmp38A;});_tmp1E8;}));});
# 792
...
# 811
({struct Cyc_Warn_String_Warn_Warg_struct _tmp20D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp305;_tmp305.tag=0U,({struct _fat_ptr _tmp38E=({const char*_tmp20E="struct tag used without arguments in pattern";_tag_fat(_tmp20E,sizeof(char),45U);});_tmp305.f1=_tmp38E;});_tmp305;});void*_tmp20C[1U];_tmp20C[0]=& _tmp20D;({unsigned _tmp38F=loc;Cyc_Warn_err2(_tmp38F,_tag_fat(_tmp20C,sizeof(void*),1U));});});_npop_handler(0U);return;case 2U: _LL31: _tmp20A=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp205)->f1;_tmp20B=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp205)->f2;_LL32: {struct Cyc_Absyn_Datatypedecl*tud=_tmp20A;struct Cyc_Absyn_Datatypefield*tuf=_tmp20B;
# 813
({void*_tmp390=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp20F=_cycalloc(sizeof(*_tmp20F));_tmp20F->tag=8U,_tmp20F->f1=tud,_tmp20F->f2=tuf,_tmp20F->f3=0,_tmp20F->f4=0;_tmp20F;});p->r=_tmp390;});_npop_handler(0U);return;}case 3U: _LL33: _tmp208=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp205)->f1;_tmp209=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp205)->f2;_LL34: {struct Cyc_Absyn_Enumdecl*ed=_tmp208;struct Cyc_Absyn_Enumfield*ef=_tmp209;
# 815
({void*_tmp391=(void*)({struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*_tmp210=_cycalloc(sizeof(*_tmp210));_tmp210->tag=13U,_tmp210->f1=ed,_tmp210->f2=ef;_tmp210;});p->r=_tmp391;});_npop_handler(0U);return;}default: _LL35: _tmp206=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp205)->f1;_tmp207=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp205)->f2;_LL36: {void*t=_tmp206;struct Cyc_Absyn_Enumfield*ef=_tmp207;
# 817
({void*_tmp392=(void*)({struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*_tmp211=_cycalloc(sizeof(*_tmp211));_tmp211->tag=14U,_tmp211->f1=t,_tmp211->f2=ef;_tmp211;});p->r=_tmp392;});_npop_handler(0U);return;}}_LL2C:;}
# 808
...
({void*_tmp394=(void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp215=_cycalloc(sizeof(*_tmp215));_tmp215->tag=1U,_tmp215->f1=vd,({struct Cyc_Absyn_Pat*_tmp393=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0U);_tmp215->f2=_tmp393;});_tmp215;});p->r=_tmp394;});
...
for(0;ps != 0;ps=ps->tl){
new_ps=({struct Cyc_List_List*_tmp221=_cycalloc(sizeof(*_tmp221));({struct _tuple14*_tmp395=({struct _tuple14*_tmp220=_cycalloc(sizeof(*_tmp220));_tmp220->f1=0,_tmp220->f2=(struct Cyc_Absyn_Pat*)ps->hd;_tmp220;});_tmp221->hd=_tmp395;}),_tmp221->tl=new_ps;_tmp221;});}
({void*_tmp399=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp224=_cycalloc(sizeof(*_tmp224));_tmp224->tag=7U,({union Cyc_Absyn_AggrInfo*_tmp398=({union Cyc_Absyn_AggrInfo*_tmp223=_cycalloc(sizeof(*_tmp223));({union Cyc_Absyn_AggrInfo _tmp397=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp222=_cycalloc(sizeof(*_tmp222));*_tmp222=ad;_tmp222;}));*_tmp223=_tmp397;});_tmp223;});_tmp224->f1=_tmp398;}),_tmp224->f2=0,({struct Cyc_List_List*_tmp396=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(new_ps);_tmp224->f3=_tmp396;}),_tmp224->f4=dots;_tmp224;});p->r=_tmp399;});
...
# 836
({void*_tmp39A=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp225=_cycalloc(sizeof(*_tmp225));_tmp225->tag=8U,_tmp225->f1=tud,_tmp225->f2=tuf,_tmp225->f3=ps,_tmp225->f4=dots;_tmp225;});p->r=_tmp39A;});_npop_handler(0U);return;}case 3U: _LL43: _LL44:
 goto _LL46;default: _LL45: _LL46:
# 839
({struct Cyc_Warn_String_Warn_Warg_struct _tmp227=({struct Cyc_Warn_String_Warn_Warg_struct _tmp306;_tmp306.tag=0U,({struct _fat_ptr _tmp39B=({const char*_tmp228="enum tag used with arguments in pattern";_tag_fat(_tmp228,sizeof(char),40U);});_tmp306.f1=_tmp39B;});_tmp306;});void*_tmp226[1U];_tmp226[0]=& _tmp227;({unsigned _tmp39C=loc;Cyc_Warn_err2(_tmp39C,_tag_fat(_tmp226,sizeof(void*),1U));});});_npop_handler(0U);return;}_LL3C:;}
# 827
...
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp22C=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp308;_tmp308.tag=1U,_tmp308.f1=qv;_tmp308;});struct Cyc_Warn_String_Warn_Warg_struct _tmp22D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp307;_tmp307.tag=0U,({struct _fat_ptr _tmp39D=({const char*_tmp22E=" is not a constructor in pattern";_tag_fat(_tmp22E,sizeof(char),33U);});_tmp307.f1=_tmp39D;});_tmp307;});void*_tmp22B[2U];_tmp22B[0]=& _tmp22C,_tmp22B[1]=& _tmp22D;({unsigned _tmp39E=loc;Cyc_Warn_err2(_tmp39E,_tag_fat(_tmp22B,sizeof(void*),2U));});});return;}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1EC)->f1 != 0){if((((union Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1EC)->f1)->UnknownAggr).tag == 1){_LL8: _tmp1F9=(((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1EC)->f1)->UnknownAggr).val).f2;_tmp1FA=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1EC)->f2;_tmp1FB=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1EC)->f3;_tmp1FC=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1EC)->f4;_LL9: {struct _tuple0*n=_tmp1F9;struct Cyc_List_List*exist_ts=_tmp1FA;struct Cyc_List_List*dps=_tmp1FB;int dots=_tmp1FC;
# 844
...
({void*_tmp3A1=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp236=_cycalloc(sizeof(*_tmp236));_tmp236->tag=7U,({union Cyc_Absyn_AggrInfo*_tmp3A0=({union Cyc_Absyn_AggrInfo*_tmp235=_cycalloc(sizeof(*_tmp235));({union Cyc_Absyn_AggrInfo _tmp39F=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp234=_cycalloc(sizeof(*_tmp234));*_tmp234=ad;_tmp234;}));*_tmp235=_tmp39F;});_tmp235;});_tmp236->f1=_tmp3A0;}),_tmp236->f2=exist_ts,_tmp236->f3=dps,_tmp236->f4=dots;_tmp236;});p->r=_tmp3A1;});}
# 847
...
# 850
({struct Cyc_Warn_String_Warn_Warg_struct _tmp23A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp309;_tmp309.tag=0U,({struct _fat_ptr _tmp3A2=({const char*_tmp23B="non-aggregate name has designator patterns";_tag_fat(_tmp23B,sizeof(char),43U);});_tmp309.f1=_tmp3A2;});_tmp309;});void*_tmp239[1U];_tmp239[0]=& _tmp23A;({unsigned _tmp3A3=loc;Cyc_Warn_err2(_tmp3A3,_tag_fat(_tmp239,sizeof(void*),1U));});});return;}else{_LL4F: _tmp238=_tmp237;_LL50: {void*exn=_tmp238;(int)_rethrow(exn);}}_LL4C:;}}}
# 852
...
# 907
struct _tuple0*qv=({struct _tuple0*_tmp24E=_cycalloc(sizeof(*_tmp24E));({union Cyc_Absyn_Nmspace _tmp3A4=Cyc_Absyn_Rel_n(0);_tmp24E->f1=_tmp3A4;}),_tmp24E->f2=name;_tmp24E;});
...
({struct Cyc_List_List*_tmp3A5=({struct Cyc_List_List*_tmp24C=_cycalloc(sizeof(*_tmp24C));_tmp24C->hd=ex_sym,_tmp24C->tl=*exlist_ptr;_tmp24C;});*exlist_ptr=_tmp3A5;});
({struct Cyc_Dict_Dict _tmp3A6=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(*out_dict,name,res);*out_dict=_tmp3A6;});
...
goto _LL3;}case 1U: _LL8: _tmp247=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmp242)->f1;_LL9: {struct Cyc_Absyn_Aggrdecl*ad=_tmp247;
# 922
...
# 927
({void*_tmp24F=0U;({unsigned _tmp3AA=wcloc;struct _fat_ptr _tmp3A9=({const char*_tmp250="Unexpected binding from extern C Include";_tag_fat(_tmp250,sizeof(char),41U);});Cyc_Warn_err(_tmp3AA,_tmp3A9,_tag_fat(_tmp24F,sizeof(void*),0U));});});
goto _LL3;}}_LL3:;}}
# 940 "binding.cyc"
...
# 957
if(env->in_cyc_override)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp269=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30A;_tmp30A.tag=0U,({struct _fat_ptr _tmp3AB=({const char*_tmp26A="Function declaration not permitted within cyclone_override block";_tag_fat(_tmp26A,sizeof(char),65U);});_tmp30A.f1=_tmp3AB;});_tmp30A;});void*_tmp268[1U];_tmp268[0]=& _tmp269;({unsigned _tmp3AC=loc;Cyc_Warn_err2(_tmp3AC,_tag_fat(_tmp268,sizeof(void*),1U));});});
Cyc_Binding_absolutize_decl(loc,env,fd->name,fd->sc);{
struct _tuple0*_tmp26B=fd->name;struct _tuple0*_stmttmp1B=_tmp26B;struct _tuple0*_tmp26C=_stmttmp1B;struct _fat_ptr*_tmp26E;union Cyc_Absyn_Nmspace _tmp26D;_LL24: _tmp26D=_tmp26C->f1;_tmp26E=_tmp26C->f2;_LL25: {union Cyc_Absyn_Nmspace decl_ns=_tmp26D;struct _fat_ptr*decl_name=_tmp26E;
struct Cyc_List_List*_tmp26F=(fd->i).args;struct Cyc_List_List*argit=_tmp26F;
struct Cyc_List_List*_tmp270=Cyc_Binding_get_fun_vardecls(1,loc,env,(fd->i).args,(fd->i).cyc_varargs);struct Cyc_List_List*vds=_tmp270;
({struct Cyc_Core_Opt*_tmp3AD=({struct Cyc_Core_Opt*_tmp271=_cycalloc(sizeof(*_tmp271));_tmp271->v=vds;_tmp271;});fd->param_vardecls=_tmp3AD;});
# 965
if(Cyc_Binding_warn_override)
Cyc_Binding_check_warn_override(loc,env,fd->name);{
# 968
struct Cyc_Dict_Dict*_tmp272=env->local_vars;struct Cyc_Dict_Dict*old_locals=_tmp272;
if(old_locals != 0)
({struct Cyc_Dict_Dict*_tmp3AE=({struct Cyc_Dict_Dict*_tmp273=_cycalloc(sizeof(*_tmp273));*_tmp273=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));_tmp273;});env->local_vars=_tmp3AE;});else{
# 972
({struct Cyc_Dict_Dict*_tmp3B0=({struct Cyc_Dict_Dict*_tmp274=_cycalloc(sizeof(*_tmp274));({struct Cyc_Dict_Dict _tmp3AF=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp274=_tmp3AF;});_tmp274;});env->local_vars=_tmp3B0;});}
{struct Cyc_List_List*_tmp275=vds;struct Cyc_List_List*vds1=_tmp275;for(0;vds1 != 0;vds1=vds1->tl){
({struct Cyc_Dict_Dict _tmp3B4=({struct Cyc_Dict_Dict _tmp3B3=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _fat_ptr*_tmp3B2=(*((struct Cyc_Absyn_Vardecl*)vds1->hd)->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3B3,_tmp3B2,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp277=_cycalloc(sizeof(*_tmp277));
_tmp277->tag=0U,({void*_tmp3B1=(void*)({struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp276=_cycalloc(sizeof(*_tmp276));_tmp276->tag=3U,_tmp276->f1=(struct Cyc_Absyn_Vardecl*)vds1->hd;_tmp276;});_tmp277->f1=_tmp3B1;});_tmp277;}));});
# 974
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp3B4;});}}
# 977
Cyc_Binding_resolve_function_stuff(loc,env,fd->i);
# 979
if(old_locals != 0){
# 981
({struct Cyc_Dict_Dict _tmp3B8=({struct Cyc_Dict_Dict _tmp3B7=*old_locals;struct _fat_ptr*_tmp3B6=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3B7,_tmp3B6,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp279=_cycalloc(sizeof(*_tmp279));
_tmp279->tag=0U,({void*_tmp3B5=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp278=_cycalloc(sizeof(*_tmp278));_tmp278->tag=2U,_tmp278->f1=fd;_tmp278;});_tmp279->f1=_tmp3B5;});_tmp279;}));});
# 981
*old_locals=_tmp3B8;});
# 983
({struct Cyc_Dict_Dict _tmp3BC=({struct Cyc_Dict_Dict _tmp3BB=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _fat_ptr*_tmp3BA=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3BB,_tmp3BA,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp27B=_cycalloc(sizeof(*_tmp27B));
_tmp27B->tag=0U,({void*_tmp3B9=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp27A=_cycalloc(sizeof(*_tmp27A));_tmp27A->tag=2U,_tmp27A->f1=fd;_tmp27A;});_tmp27B->f1=_tmp3B9;});_tmp27B;}));});
# 983
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp3BC;});}else{
# 986
struct Cyc_Binding_ResolveNSEnv*_tmp27C=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp27C;
({struct Cyc_Dict_Dict _tmp3C0=({struct Cyc_Dict_Dict _tmp3BF=decl_ns_data->ordinaries;struct _fat_ptr*_tmp3BE=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3BF,_tmp3BE,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp27E=_cycalloc(sizeof(*_tmp27E));
# 989
_tmp27E->tag=0U,({void*_tmp3BD=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp27D=_cycalloc(sizeof(*_tmp27D));_tmp27D->tag=2U,_tmp27D->f1=fd;_tmp27D;});_tmp27E->f1=_tmp3BD;});_tmp27E;}));});
# 987
decl_ns_data->ordinaries=_tmp3C0;});}
# 992
...
# 999
if(Cyc_Binding_at_toplevel(env)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp280=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30B;_tmp30B.tag=0U,({struct _fat_ptr _tmp3C1=({const char*_tmp281="let not allowed at top-level";_tag_fat(_tmp281,sizeof(char),29U);});_tmp30B.f1=_tmp3C1;});_tmp30B;});void*_tmp27F[1U];_tmp27F[0]=& _tmp280;({unsigned _tmp3C2=loc;Cyc_Warn_err2(_tmp3C2,_tag_fat(_tmp27F,sizeof(void*),1U));});});
goto _LL0;}
# 1003
...
# 1019
if(!Cyc_Binding_at_toplevel(env)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp283=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30C;_tmp30C.tag=0U,({struct _fat_ptr _tmp3C3=({const char*_tmp284="nested type definitions are not yet supported";_tag_fat(_tmp284,sizeof(char),46U);});_tmp30C.f1=_tmp3C3;});_tmp30C;});void*_tmp282[1U];_tmp282[0]=& _tmp283;({unsigned _tmp3C4=loc;Cyc_Warn_err2(_tmp3C4,_tag_fat(_tmp282,sizeof(void*),1U));});});
goto _LL0;}
# 1023
Cyc_Binding_absolutize_decl(loc,env,td->name,td->extern_c?Cyc_Absyn_ExternC: Cyc_Absyn_Public);{
struct _tuple0*_tmp285=td->name;struct _tuple0*_stmttmp1C=_tmp285;struct _tuple0*_tmp286=_stmttmp1C;struct _fat_ptr*_tmp288;union Cyc_Absyn_Nmspace _tmp287;_LL27: _tmp287=_tmp286->f1;_tmp288=_tmp286->f2;_LL28: {union Cyc_Absyn_Nmspace decl_ns=_tmp287;struct _fat_ptr*decl_name=_tmp288;
# 1026
struct Cyc_Binding_ResolveNSEnv*_tmp289=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp289;
if(td->defn != 0)
Cyc_Binding_resolve_type(loc,env,(void*)_check_null(td->defn));
# 1030
if(!env->in_cyc_override)
({struct Cyc_Dict_Dict _tmp3C5=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_Absyn_Typedefdecl*v))Cyc_Dict_insert)(decl_ns_data->typedefs,decl_name,td);decl_ns_data->typedefs=_tmp3C5;});
# 1034
...
# 1037
if(!Cyc_Binding_at_toplevel(env)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp28B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30D;_tmp30D.tag=0U,({struct _fat_ptr _tmp3C6=({const char*_tmp28C="nested type definitions are not yet supported";_tag_fat(_tmp28C,sizeof(char),46U);});_tmp30D.f1=_tmp3C6;});_tmp30D;});void*_tmp28A[1U];_tmp28A[0]=& _tmp28B;({unsigned _tmp3C7=loc;Cyc_Warn_err2(_tmp3C7,_tag_fat(_tmp28A,sizeof(void*),1U));});});
goto _LL0;}
# 1041
Cyc_Binding_absolutize_decl(loc,env,ad->name,ad->sc);{
struct _tuple0*_tmp28D=ad->name;struct _tuple0*_stmttmp1D=_tmp28D;struct _tuple0*_tmp28E=_stmttmp1D;struct _fat_ptr*_tmp290;union Cyc_Absyn_Nmspace _tmp28F;_LL2A: _tmp28F=_tmp28E->f1;_tmp290=_tmp28E->f2;_LL2B: {union Cyc_Absyn_Nmspace decl_ns=_tmp28F;struct _fat_ptr*decl_name=_tmp290;
# 1044
struct Cyc_Binding_ResolveNSEnv*_tmp291=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp291;
# 1046
if(((int(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_member)(decl_ns_data->aggrdecls,decl_name)&& ad->impl == 0)
goto _LL0;
# 1049
if(!env->in_cyc_override){
({struct Cyc_Dict_Dict _tmp3C8=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_Absyn_Aggrdecl*v))Cyc_Dict_insert)(decl_ns_data->aggrdecls,decl_name,ad);decl_ns_data->aggrdecls=_tmp3C8;});
# 1052
({struct Cyc_Dict_Dict _tmp3CB=({struct Cyc_Dict_Dict _tmp3CA=decl_ns_data->ordinaries;struct _fat_ptr*_tmp3C9=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3CA,_tmp3C9,(void*)({struct Cyc_Binding_AggrRes_Binding_Resolved_struct*_tmp292=_cycalloc(sizeof(*_tmp292));
_tmp292->tag=1U,_tmp292->f1=ad;_tmp292;}));});
# 1052
decl_ns_data->ordinaries=_tmp3CB;});}
# 1055
if(ad->impl != 0){
struct Cyc_Absyn_AggrdeclImpl*_tmp293=(struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl);struct Cyc_Absyn_AggrdeclImpl*_stmttmp1E=_tmp293;struct Cyc_Absyn_AggrdeclImpl*_tmp294=_stmttmp1E;struct Cyc_List_List*_tmp296;struct Cyc_List_List*_tmp295;_LL2D: _tmp295=_tmp294->rgn_po;_tmp296=_tmp294->fields;_LL2E: {struct Cyc_List_List*rpo=_tmp295;struct Cyc_List_List*fs=_tmp296;
...
# 1063
if(!Cyc_Binding_at_toplevel(env)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp298=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30E;_tmp30E.tag=0U,({struct _fat_ptr _tmp3CC=({const char*_tmp299="nested type definitions are not yet supported";_tag_fat(_tmp299,sizeof(char),46U);});_tmp30E.f1=_tmp3CC;});_tmp30E;});void*_tmp297[1U];_tmp297[0]=& _tmp298;({unsigned _tmp3CD=loc;Cyc_Warn_err2(_tmp3CD,_tag_fat(_tmp297,sizeof(void*),1U));});});
goto _LL0;}
# 1067
Cyc_Binding_absolutize_decl(loc,env,ed->name,ed->sc);{
struct _tuple0*_tmp29A=ed->name;struct _tuple0*_stmttmp1F=_tmp29A;struct _tuple0*_tmp29B=_stmttmp1F;struct _fat_ptr*_tmp29D;union Cyc_Absyn_Nmspace _tmp29C;_LL30: _tmp29C=_tmp29B->f1;_tmp29D=_tmp29B->f2;_LL31: {union Cyc_Absyn_Nmspace decl_ns=_tmp29C;struct _fat_ptr*decl_name=_tmp29D;
# 1070
struct Cyc_Binding_ResolveNSEnv*_tmp29E=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp29E;
# 1072
if(((int(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_member)(decl_ns_data->enumdecls,decl_name)&& ed->fields == 0)
goto _LL0;
# 1076
if(!env->in_cyc_override)
({struct Cyc_Dict_Dict _tmp3CE=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_Absyn_Enumdecl*v))Cyc_Dict_insert)(decl_ns_data->enumdecls,decl_name,ed);decl_ns_data->enumdecls=_tmp3CE;});
# 1079
if(ed->fields != 0){
# 1081
struct Cyc_List_List*fs=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(ed->fields))->v;for(0;fs != 0;fs=fs->tl){
struct Cyc_Absyn_Enumfield*_tmp29F=(struct Cyc_Absyn_Enumfield*)fs->hd;struct Cyc_Absyn_Enumfield*f=_tmp29F;
Cyc_Binding_absolutize_decl(f->loc,env,f->name,ed->sc);
if(f->tag != 0)
Cyc_Binding_resolve_exp(env,(struct Cyc_Absyn_Exp*)_check_null(f->tag));
if(!env->in_cyc_override)
({struct Cyc_Dict_Dict _tmp3D1=({struct Cyc_Dict_Dict _tmp3D0=decl_ns_data->ordinaries;struct _fat_ptr*_tmp3CF=(*f->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3D0,_tmp3CF,(void*)({struct Cyc_Binding_EnumRes_Binding_Resolved_struct*_tmp2A0=_cycalloc(sizeof(*_tmp2A0));
# 1089
_tmp2A0->tag=3U,_tmp2A0->f1=ed,_tmp2A0->f2=f;_tmp2A0;}));});
# 1087
decl_ns_data->ordinaries=_tmp3D1;});}}
# 1091
...
{struct Cyc_List_List*_tmp2A4=((struct Cyc_List_List*(*)(unsigned loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_List_List*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _fat_ptr*)))Cyc_Binding_resolve_lookup)(loc,env->ns,tud->name,Cyc_Binding_lookup_datatypedecl);struct Cyc_List_List*decls=_tmp2A4;
struct Cyc_Absyn_Datatypedecl*_tmp2A5=(struct Cyc_Absyn_Datatypedecl*)decls->hd;struct Cyc_Absyn_Datatypedecl*last_decl=_tmp2A5;
if(!last_decl->is_extensible)
(int)_throw((void*)({struct Cyc_Binding_BindingError_exn_struct*_tmp2A6=_cycalloc(sizeof(*_tmp2A6));_tmp2A6->tag=Cyc_Binding_BindingError;_tmp2A6;}));
tud->name=last_decl->name;
tud->is_extensible=1;{
struct _tuple0*_tmp2A7=tud->name;struct _tuple0*_stmttmp20=_tmp2A7;struct _tuple0*_tmp2A8=_stmttmp20;struct _fat_ptr*_tmp2AA;union Cyc_Absyn_Nmspace _tmp2A9;_LL33: _tmp2A9=_tmp2A8->f1;_tmp2AA=_tmp2A8->f2;_LL34: {union Cyc_Absyn_Nmspace decl_ns=_tmp2A9;struct _fat_ptr*decl_name=_tmp2AA;
struct Cyc_Binding_ResolveNSEnv*_tmp2AB=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp2AB;
({struct Cyc_Dict_Dict _tmp3D4=({struct Cyc_Dict_Dict _tmp3D3=decl_ns_data->datatypedecls;struct _fat_ptr*_tmp3D2=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_List_List*v))Cyc_Dict_insert)(_tmp3D3,_tmp3D2,({struct Cyc_List_List*_tmp2AC=_cycalloc(sizeof(*_tmp2AC));
_tmp2AC->hd=tud,_tmp2AC->tl=decls;_tmp2AC;}));});
# 1104
decl_ns_data->datatypedecls=_tmp3D4;});}}}
# 1096
;_pop_handler();}else{void*_tmp2A2=(void*)Cyc_Core_get_exn_thrown();void*_tmp2AD=_tmp2A2;void*_tmp2AE;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp2AD)->tag == Cyc_Binding_BindingError){_LL36: _LL37:
# 1108
 Cyc_Binding_absolutize_topdecl(loc,env,tud->name,tud->sc);{
struct _tuple0*_tmp2AF=tud->name;struct _tuple0*_stmttmp21=_tmp2AF;struct _tuple0*_tmp2B0=_stmttmp21;struct _fat_ptr*_tmp2B2;union Cyc_Absyn_Nmspace _tmp2B1;_LL3B: _tmp2B1=_tmp2B0->f1;_tmp2B2=_tmp2B0->f2;_LL3C: {union Cyc_Absyn_Nmspace decl_ns=_tmp2B1;struct _fat_ptr*decl_name=_tmp2B2;
struct Cyc_Binding_ResolveNSEnv*_tmp2B3=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp2B3;
# 1112
if(((int(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_member)(decl_ns_data->datatypedecls,decl_name)&& tud->fields == 0)
# 1114
goto _LL35;
({struct Cyc_Dict_Dict _tmp3D7=({struct Cyc_Dict_Dict _tmp3D6=decl_ns_data->datatypedecls;struct _fat_ptr*_tmp3D5=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_List_List*v))Cyc_Dict_insert)(_tmp3D6,_tmp3D5,({struct Cyc_List_List*_tmp2B4=_cycalloc(sizeof(*_tmp2B4));
_tmp2B4->hd=tud,_tmp2B4->tl=0;_tmp2B4;}));});
# 1115
decl_ns_data->datatypedecls=_tmp3D7;});
# 1117
goto _LL35;}}}else{_LL38: _tmp2AE=_tmp2AD;_LL39: {void*exn=_tmp2AE;(int)_rethrow(exn);}}_LL35:;}}}{
# 1120
struct _tuple0*_tmp2B5=tud->name;struct _tuple0*_stmttmp22=_tmp2B5;struct _tuple0*_tmp2B6=_stmttmp22;struct _fat_ptr*_tmp2B8;union Cyc_Absyn_Nmspace _tmp2B7;_LL3E: _tmp2B7=_tmp2B6->f1;_tmp2B8=_tmp2B6->f2;_LL3F: {union Cyc_Absyn_Nmspace decl_ns=_tmp2B7;struct _fat_ptr*decl_name=_tmp2B8;
if(tud->fields != 0){
struct Cyc_List_List*_tmp2B9=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(tud->fields))->v;struct Cyc_List_List*fs=_tmp2B9;for(0;fs != 0;fs=fs->tl){
struct Cyc_Absyn_Datatypefield*_tmp2BA=(struct Cyc_Absyn_Datatypefield*)fs->hd;struct Cyc_Absyn_Datatypefield*f=_tmp2BA;
{struct Cyc_List_List*_tmp2BB=f->typs;struct Cyc_List_List*tqts=_tmp2BB;for(0;tqts != 0;tqts=tqts->tl){
Cyc_Binding_resolve_type(loc,env,(*((struct _tuple13*)tqts->hd)).f2);}}
{union Cyc_Absyn_Nmspace _tmp2BC=(*f->name).f1;union Cyc_Absyn_Nmspace _stmttmp23=_tmp2BC;union Cyc_Absyn_Nmspace _tmp2BD=_stmttmp23;switch((_tmp2BD.Abs_n).tag){case 1U: if((_tmp2BD.Rel_n).val == 0){_LL41: _LL42:
# 1128
 if(tud->is_extensible)
({union Cyc_Absyn_Nmspace _tmp3D8=Cyc_Absyn_Abs_n((env->ns)->curr_ns,0);(*f->name).f1=_tmp3D8;});else{
# 1131
(*f->name).f1=(*tud->name).f1;}
goto _LL40;}else{_LL43: _LL44:
# 1134
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2BF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30F;_tmp30F.tag=0U,({struct _fat_ptr _tmp3D9=({const char*_tmp2C0="qualified datatype field declaratations not allowed";_tag_fat(_tmp2C0,sizeof(char),52U);});_tmp30F.f1=_tmp3D9;});_tmp30F;});void*_tmp2BE[1U];_tmp2BE[0]=& _tmp2BF;({unsigned _tmp3DA=f->loc;Cyc_Warn_err2(_tmp3DA,_tag_fat(_tmp2BE,sizeof(void*),1U));});});
return;}case 2U: _LL45: _LL46:
 goto _LL40;default: _LL47: _LL48:
({void*_tmp2C1=0U;({struct _fat_ptr _tmp3DB=({const char*_tmp2C2="datatype field Loc_n or C_n";_tag_fat(_tmp2C2,sizeof(char),28U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp3DB,_tag_fat(_tmp2C1,sizeof(void*),0U));});});}_LL40:;}{
# 1139
struct Cyc_Binding_ResolveNSEnv*_tmp2C3=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,(*f->name).f1);struct Cyc_Binding_ResolveNSEnv*ns_data=_tmp2C3;
({struct Cyc_Dict_Dict _tmp3DE=({struct Cyc_Dict_Dict _tmp3DD=ns_data->ordinaries;struct _fat_ptr*_tmp3DC=(*f->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3DD,_tmp3DC,(void*)({struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*_tmp2C4=_cycalloc(sizeof(*_tmp2C4));
# 1142
_tmp2C4->tag=2U,_tmp2C4->f1=tud,_tmp2C4->f2=f;_tmp2C4;}));});
# 1140
ns_data->ordinaries=_tmp3DE;});}}}
# 1144
...
# 1158
int _tmp2C5=env->in_cinclude;int old=_tmp2C5;
env->in_cinclude=1;
Cyc_Binding_resolve_decls(env,ds2);
env->in_cinclude=old;
...
# 1169
{struct Cyc_List_List*_tmp2C6=*exports;struct Cyc_List_List*exs=_tmp2C6;for(0;exs != 0;exs=exs->tl){
struct _tuple17*_tmp2C7=(struct _tuple17*)exs->hd;struct _tuple17*_stmttmp24=_tmp2C7;struct _tuple17*_tmp2C8=_stmttmp24;struct _tuple0*_tmp2CA;unsigned _tmp2C9;_LL4A: _tmp2C9=_tmp2C8->f1;_tmp2CA=_tmp2C8->f2;_LL4B: {unsigned loc=_tmp2C9;struct _tuple0*qv=_tmp2CA;
Cyc_Binding_absolutize_decl(loc,env,qv,Cyc_Absyn_ExternC);}}}
# 1177
if(!Cyc_Binding_at_toplevel(env)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2CC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp310;_tmp310.tag=0U,({struct _fat_ptr _tmp3DF=({const char*_tmp2CD="extern \"C include\" not at toplevel";_tag_fat(_tmp2CD,sizeof(char),35U);});_tmp310.f1=_tmp3DF;});_tmp310;});void*_tmp2CB[1U];_tmp2CB[0]=& _tmp2CC;({unsigned _tmp3E0=loc;Cyc_Warn_err2(_tmp3E0,_tag_fat(_tmp2CB,sizeof(void*),1U));});});
goto _LL0;}{
# 1181
struct Cyc_Binding_ResolveNSEnv*_tmp2CE=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)((env->ns)->ns_data,(env->ns)->curr_ns);struct Cyc_Binding_ResolveNSEnv*data=_tmp2CE;
struct Cyc_Dict_Dict _tmp2CF=data->ordinaries;struct Cyc_Dict_Dict old_dict=_tmp2CF;
int _tmp2D0=env->in_cinclude;int old=_tmp2D0;
env->in_cinclude=1;
Cyc_Binding_resolve_decls(env,ds2);
env->in_cyc_override=1;
Cyc_Binding_resolve_decls(env,ovrs);
env->in_cyc_override=0;{
struct Cyc_Dict_Dict _tmp2D1=data->ordinaries;struct Cyc_Dict_Dict new_dict=_tmp2D1;
struct Cyc_Dict_Dict _tmp2D2=old_dict;struct Cyc_Dict_Dict out_dict=_tmp2D2;
if((*hides).f1 > (unsigned)0){
if((unsigned)*exports)
({void*_tmp2D3=0U;({unsigned _tmp3E2=(*hides).f1;struct _fat_ptr _tmp3E1=({const char*_tmp2D4="export wildcard expects empty export list";_tag_fat(_tmp2D4,sizeof(char),42U);});Cyc_Warn_err(_tmp3E2,_tmp3E1,_tag_fat(_tmp2D3,sizeof(void*),0U));});});
env->in_cinclude=old;
({struct _tuple16*_tmp3E3=({struct _tuple16*_tmp2D5=_cycalloc(sizeof(*_tmp2D5));_tmp2D5->f1=exports,_tmp2D5->f2=& out_dict,_tmp2D5->f3=env,_tmp2D5->f4=hides;_tmp2D5;});((void(*)(void(*f)(struct _tuple16*,struct _fat_ptr*,void*),struct _tuple16*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Binding_export_all_symbols,_tmp3E3,
((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d1,struct Cyc_Dict_Dict d2))Cyc_Dict_difference)(new_dict,old_dict));});}else{
# 1199
struct Cyc_List_List*_tmp2D6=*exports;struct Cyc_List_List*exs=_tmp2D6;for(0;exs != 0;exs=exs->tl){
struct _tuple17*_tmp2D7=(struct _tuple17*)exs->hd;struct _tuple17*_stmttmp25=_tmp2D7;struct _tuple17*_tmp2D8=_stmttmp25;struct _fat_ptr*_tmp2DA;unsigned _tmp2D9;_LL4D: _tmp2D9=_tmp2D8->f1;_tmp2DA=(_tmp2D8->f2)->f2;_LL4E: {unsigned loc=_tmp2D9;struct _fat_ptr*v=_tmp2DA;
...
void*_tmp3E4=((void*(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_lookup)(old_dict,v);_tmp3E4 == ((void*(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_lookup)(new_dict,v);}))
({struct Cyc_String_pa_PrintArg_struct _tmp2DD=({struct Cyc_String_pa_PrintArg_struct _tmp311;_tmp311.tag=0U,_tmp311.f1=(struct _fat_ptr)((struct _fat_ptr)*v);_tmp311;});void*_tmp2DB[1U];_tmp2DB[0]=& _tmp2DD;({unsigned _tmp3E6=loc;struct _fat_ptr _tmp3E5=({const char*_tmp2DC="%s is exported but not defined";_tag_fat(_tmp2DC,sizeof(char),31U);});Cyc_Warn_err(_tmp3E6,_tmp3E5,_tag_fat(_tmp2DB,sizeof(void*),1U));});});
out_dict=({struct Cyc_Dict_Dict _tmp3E8=out_dict;struct _fat_ptr*_tmp3E7=v;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3E8,_tmp3E7,((void*(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_lookup)(new_dict,v));});}}}
# 1208
...
struct Cyc_Binding_Env*_tmp2DE=({struct Cyc_Binding_Env*_tmp2E1=_cycalloc(sizeof(*_tmp2E1));_tmp2E1->in_cinclude=0,_tmp2E1->in_cyc_override=0,({struct Cyc_Binding_NSCtxt*_tmp3E9=((struct Cyc_Binding_NSCtxt*(*)(int env,struct Cyc_Binding_ResolveNSEnv*(*mkdata)(int)))Cyc_Binding_mt_nsctxt)(1,Cyc_Binding_mt_renv);_tmp2E1->ns=_tmp3E9;}),_tmp2E1->local_vars=0;_tmp2E1;});struct Cyc_Binding_Env*env=_tmp2DE;
({struct Cyc_Binding_Env*_tmp3EC=env;Cyc_Binding_resolve_decl(_tmp3EC,({struct Cyc_Absyn_Decl*_tmp2E0=_cycalloc(sizeof(*_tmp2E0));({void*_tmp3EB=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp2DF=_cycalloc(sizeof(*_tmp2DF));_tmp2DF->tag=6U,({struct Cyc_Absyn_Datatypedecl*_tmp3EA=Cyc_Absyn_exn_tud();_tmp2DF->f1=_tmp3EA;});_tmp2DF;});_tmp2E0->r=_tmp3EB;}),_tmp2E0->loc=0U;_tmp2E0;}));});
