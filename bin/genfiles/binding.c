...
struct Cyc_List_List*_tmp2B3=({struct Cyc_List_List*_tmp2=_cycalloc(sizeof(*_tmp2));({void*_tmp2B2=(void*)({struct Cyc_Binding_Namespace_Binding_NSDirective_struct*_tmp1=_cycalloc(sizeof(*_tmp1));_tmp1->tag=0U,_tmp1->f1=0;_tmp1;});_tmp2->hd=_tmp2B2;}),_tmp2->tl=0;_tmp2;});_tmp3->availables=_tmp2B3;}),({
struct Cyc_Dict_Dict _tmp2B1=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct Cyc_List_List*,struct Cyc_List_List*),struct Cyc_List_List*k,void*v))Cyc_Dict_singleton)(Cyc_Absyn_varlist_cmp,0,_tmp0);_tmp3->ns_data=_tmp2B1;});_tmp3;});}
# 64
...
({void*_tmp5=0U;({struct _dyneither_ptr _tmp2B4=({const char*_tmp6="Binding:get_ns_data: relative ns";_tag_dyneither(_tmp6,sizeof(char),33U);});Cyc_Warn_impos(_tmp2B4,_tag_dyneither(_tmp5,sizeof(void*),0U));});});}_LL0:;}
# 82 "binding.cyc"
...
goto _LL0;}}_LL0:;}}
# 97
({struct Cyc_String_pa_PrintArg_struct _tmp12=({struct Cyc_String_pa_PrintArg_struct _tmp29F;_tmp29F.tag=0U,({struct _dyneither_ptr _tmp2B6=(struct _dyneither_ptr)((struct _dyneither_ptr)({struct Cyc_List_List*_tmp2B5=rel_ns;Cyc_str_sepstr(_tmp2B5,({const char*_tmp13="::";_tag_dyneither(_tmp13,sizeof(char),3U);}));}));_tmp29F.f1=_tmp2B6;});_tmp29F;});void*_tmp10[1U];_tmp10[0]=& _tmp12;({unsigned int _tmp2B8=loc;struct _dyneither_ptr _tmp2B7=({const char*_tmp11="namespace %s not found";_tag_dyneither(_tmp11,sizeof(char),23U);});Cyc_Warn_err(_tmp2B8,_tmp2B7,_tag_dyneither(_tmp10,sizeof(void*),1U));});});
...
# 106
{struct _handler_cons _tmp17;_push_handler(& _tmp17);{int _tmp19=0;if(setjmp(_tmp17.handler))_tmp19=1;if(!_tmp19){{void*_tmp1A=({void*(*_tmp2BA)(void*,struct _dyneither_ptr*)=lookup;void*_tmp2B9=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,ctxt->curr_ns);_tmp2BA(_tmp2B9,_tmp3D);});_npop_handler(0U);return _tmp1A;};_pop_handler();}else{void*_tmp18=(void*)_exn_thrown;void*_tmp1B=_tmp18;void*_tmp1C;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp1B)->tag == Cyc_Dict_Absent){_LLF: _LL10:
...
# 112
{struct _handler_cons _tmp20;_push_handler(& _tmp20);{int _tmp22=0;if(setjmp(_tmp20.handler))_tmp22=1;if(!_tmp22){{void*_tmp23=({void*(*_tmp2BC)(void*,struct _dyneither_ptr*)=lookup;void*_tmp2BB=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,_tmp27);_tmp2BC(_tmp2BB,_tmp3D);});_npop_handler(0U);return _tmp23;};_pop_handler();}else{void*_tmp21=(void*)_exn_thrown;void*_tmp24=_tmp21;void*_tmp25;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp24)->tag == Cyc_Dict_Absent){_LL19: _LL1A:
...
void*_tmp2D=({void*(*_tmp2BE)(void*,struct _dyneither_ptr*)=lookup;void*_tmp2BD=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,_tmp2C);_tmp2BE(_tmp2BD,_tmp3D);});_npop_handler(0U);return _tmp2D;}
# 119
...
# 124
struct _handler_cons _tmp31;_push_handler(& _tmp31);{int _tmp33=0;if(setjmp(_tmp31.handler))_tmp33=1;if(!_tmp33){{void*_tmp34=({void*(*_tmp2C0)(void*,struct _dyneither_ptr*)=lookup;void*_tmp2BF=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,_tmp3C);_tmp2C0(_tmp2BF,_tmp3D);});_npop_handler(0U);return _tmp34;};_pop_handler();}else{void*_tmp32=(void*)_exn_thrown;void*_tmp35=_tmp32;void*_tmp37;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp35)->tag == Cyc_Dict_Absent){_LL23: _LL24:
...
({void*_tmp38=0U;({struct _dyneither_ptr _tmp2C1=({const char*_tmp39="lookup local in global";_tag_dyneither(_tmp39,sizeof(char),23U);});Cyc_Warn_impos(_tmp2C1,_tag_dyneither(_tmp38,sizeof(void*),0U));});});}_LL3:;};}
# 130
...
struct Cyc_List_List*_tmp40=({struct Cyc_List_List*_tmp2C2=_tmp3F;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp2C2,({struct Cyc_List_List*_tmp43=_cycalloc(sizeof(*_tmp43));_tmp43->hd=subname,_tmp43->tl=0;_tmp43;}));});
if(!((int(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_member)(ctxt->ns_data,_tmp40))
({struct Cyc_Dict_Dict _tmp2C5=({struct Cyc_Dict_Dict _tmp2C4=ctxt->ns_data;struct Cyc_List_List*_tmp2C3=_tmp40;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k,void*v))Cyc_Dict_insert)(_tmp2C4,_tmp2C3,mkdata(env));});ctxt->ns_data=_tmp2C5;});
ctxt->curr_ns=_tmp40;
({struct Cyc_List_List*_tmp2C7=({struct Cyc_List_List*_tmp42=_cycalloc(sizeof(*_tmp42));({void*_tmp2C6=(void*)({struct Cyc_Binding_Namespace_Binding_NSDirective_struct*_tmp41=_cycalloc(sizeof(*_tmp41));_tmp41->tag=0U,_tmp41->f1=_tmp40;_tmp41;});_tmp42->hd=_tmp2C6;}),_tmp42->tl=ctxt->availables;_tmp42;});ctxt->availables=_tmp2C7;});}
# 138
void Cyc_Binding_leave_ns(struct Cyc_Binding_NSCtxt*ctxt){
if(ctxt->availables == 0)
({void*_tmp44=0U;({struct _dyneither_ptr _tmp2C8=({const char*_tmp45="leaving topmost namespace";_tag_dyneither(_tmp45,sizeof(char),26U);});Cyc_Warn_impos(_tmp2C8,_tag_dyneither(_tmp44,sizeof(void*),0U));});});{
...
({struct Cyc_List_List*_tmp2C9=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(((struct Cyc_List_List*)_check_null(((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(ctxt->curr_ns)))->tl);ctxt->curr_ns=_tmp2C9;});
goto _LL0;}else{_LL3: _LL4:
# 147
({void*_tmp48=0U;({struct _dyneither_ptr _tmp2CA=({const char*_tmp49="leaving using as namespace";_tag_dyneither(_tmp49,sizeof(char),27U);});Cyc_Warn_impos(_tmp2CA,_tag_dyneither(_tmp48,sizeof(void*),0U));});});}_LL0:;};}
# 150
struct Cyc_List_List*Cyc_Binding_enter_using(unsigned int loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*usename){
...
# 155
({struct Cyc_List_List*_tmp2CE=({unsigned int _tmp2CD=loc;struct Cyc_Binding_NSCtxt*_tmp2CC=ctxt;Cyc_Binding_resolve_rel_ns(_tmp2CD,_tmp2CC,({struct Cyc_List_List*_tmp2CB=_tmp53;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp2CB,({struct Cyc_List_List*_tmp4C=_cycalloc(sizeof(*_tmp4C));_tmp4C->hd=_tmp57,_tmp4C->tl=0;_tmp4C;}));}));});ns=_tmp2CE;});{
...
({union Cyc_Absyn_Nmspace _tmp2CF=Cyc_Absyn_Abs_n(_tmp4D,0);(*usename).f1=_tmp2CF;});
goto _LL3;};case 2U: _LL6: _tmp54=(_tmp4B.Abs_n).val;_LL7:
# 160
({struct Cyc_List_List*_tmp2D1=({struct Cyc_List_List*_tmp2D0=_tmp54;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp2D0,({struct Cyc_List_List*_tmp4E=_cycalloc(sizeof(*_tmp4E));_tmp4E->hd=_tmp57,_tmp4E->tl=0;_tmp4E;}));});ns=_tmp2D1;});
goto _LL3;case 4U: _LL8: _LL9:
({void*_tmp4F=0U;({struct _dyneither_ptr _tmp2D2=({const char*_tmp50="enter_using, Loc_n";_tag_dyneither(_tmp50,sizeof(char),19U);});Cyc_Warn_impos(_tmp2D2,_tag_dyneither(_tmp4F,sizeof(void*),0U));});});default: _LLA: _LLB:
({void*_tmp51=0U;({struct _dyneither_ptr _tmp2D3=({const char*_tmp52="enter_using, C_n";_tag_dyneither(_tmp52,sizeof(char),17U);});Cyc_Warn_impos(_tmp2D3,_tag_dyneither(_tmp51,sizeof(void*),0U));});});}_LL3:;}
# 165
({struct Cyc_List_List*_tmp2D5=({struct Cyc_List_List*_tmp56=_cycalloc(sizeof(*_tmp56));({void*_tmp2D4=(void*)({struct Cyc_Binding_Using_Binding_NSDirective_struct*_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55->tag=1U,_tmp55->f1=ns;_tmp55;});_tmp56->hd=_tmp2D4;}),_tmp56->tl=ctxt->availables;_tmp56;});ctxt->availables=_tmp2D5;});
return ns;};}
# 168
void Cyc_Binding_leave_using(struct Cyc_Binding_NSCtxt*ctxt){
if(ctxt->availables == 0)
({void*_tmp59=0U;({struct _dyneither_ptr _tmp2D6=({const char*_tmp5A="leaving topmost namespace as a using";_tag_dyneither(_tmp5A,sizeof(char),37U);});Cyc_Warn_impos(_tmp2D6,_tag_dyneither(_tmp59,sizeof(void*),0U));});});{
...
return({struct Cyc_Binding_ResolveNSEnv*_tmp5F=_cycalloc(sizeof(*_tmp5F));({struct Cyc_Dict_Dict _tmp2DC=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->aggrdecls=_tmp2DC;}),({
struct Cyc_Dict_Dict _tmp2DB=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->datatypedecls=_tmp2DB;}),({
struct Cyc_Dict_Dict _tmp2DA=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->enumdecls=_tmp2DA;}),({
struct Cyc_Dict_Dict _tmp2D9=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->typedefs=_tmp2D9;}),({
struct Cyc_Dict_Dict _tmp2D8=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->ordinaries=_tmp2D8;});_tmp5F;});}
# 226
...
({union Cyc_Absyn_Nmspace _tmp2DE=({struct Cyc_List_List*_tmp2DD=(env->ns)->curr_ns;Cyc_Absyn_Abs_n(_tmp2DD,Cyc_Binding_in_cinclude(env) || sc == Cyc_Absyn_ExternC);});(*qv).f1=_tmp2DE;});else{
# 280
...
# 288
({struct Cyc_String_pa_PrintArg_struct _tmp69=({struct Cyc_String_pa_PrintArg_struct _tmp2A0;_tmp2A0.tag=0U,({
struct _dyneither_ptr _tmp2DF=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(qv));_tmp2A0.f1=_tmp2DF;});_tmp2A0;});void*_tmp67[1U];_tmp67[0]=& _tmp69;({unsigned int _tmp2E1=loc;struct _dyneither_ptr _tmp2E0=({const char*_tmp68="qualified names in declarations unimplemented (%s)";_tag_dyneither(_tmp68,sizeof(char),51U);});Cyc_Warn_err(_tmp2E1,_tmp2E0,_tag_dyneither(_tmp67,sizeof(void*),1U));});});}_LL0:;}
# 295
...
({struct _dyneither_ptr _tmp2E2=({const char*_tmp71="global variable";_tag_dyneither(_tmp71,sizeof(char),16U);});hides_what=_tmp2E2;});goto _LLB;case 4U: _LLE: _LLF:
({struct _dyneither_ptr _tmp2E3=({const char*_tmp72="local variable";_tag_dyneither(_tmp72,sizeof(char),15U);});hides_what=_tmp2E3;});goto _LLB;case 3U: _LL10: _LL11:
({struct _dyneither_ptr _tmp2E4=({const char*_tmp73="parameter";_tag_dyneither(_tmp73,sizeof(char),10U);});hides_what=_tmp2E4;});goto _LLB;case 5U: _LL12: _LL13:
({struct _dyneither_ptr _tmp2E5=({const char*_tmp74="pattern variable";_tag_dyneither(_tmp74,sizeof(char),17U);});hides_what=_tmp2E5;});goto _LLB;case 2U: _LL14: _LL15:
({struct _dyneither_ptr _tmp2E6=({const char*_tmp75="function";_tag_dyneither(_tmp75,sizeof(char),9U);});hides_what=_tmp2E6;});goto _LLB;default: _LL16: _LL17:
({void*_tmp76=0U;({struct _dyneither_ptr _tmp2E7=({const char*_tmp77="shadowing free variable!";_tag_dyneither(_tmp77,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp2E7,_tag_dyneither(_tmp76,sizeof(void*),0U));});});}_LLB:;}
# 317
goto _LL0;case 1U: _LL3: _LL4:
({struct _dyneither_ptr _tmp2E8=({const char*_tmp78="struct constructor";_tag_dyneither(_tmp78,sizeof(char),19U);});hides_what=_tmp2E8;});goto _LL0;case 2U: _LL5: _LL6:
({struct _dyneither_ptr _tmp2E9=({const char*_tmp79="datatype constructor";_tag_dyneither(_tmp79,sizeof(char),21U);});hides_what=_tmp2E9;});goto _LL0;case 3U: _LL7: _LL8:
 goto _LLA;default: _LL9: _LLA:
({struct _dyneither_ptr _tmp2EA=({const char*_tmp7A="enum tag";_tag_dyneither(_tmp7A,sizeof(char),9U);});hides_what=_tmp2EA;});goto _LL0;}_LL0:;}
# 323
({struct Cyc_String_pa_PrintArg_struct _tmp7E=({struct Cyc_String_pa_PrintArg_struct _tmp2A1;_tmp2A1.tag=0U,_tmp2A1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)hides_what);_tmp2A1;});void*_tmp7C[1U];_tmp7C[0]=& _tmp7E;({unsigned int _tmp2EC=loc;struct _dyneither_ptr _tmp2EB=({const char*_tmp7D="declaration hides %s";_tag_dyneither(_tmp7D,sizeof(char),21U);});Cyc_Warn_warn(_tmp2EC,_tmp2EB,_tag_dyneither(_tmp7C,sizeof(void*),1U));});});
_npop_handler(0U);return;
# 305
...
if(!Cyc_Binding_at_toplevel(env))
({struct Cyc_Dict_Dict _tmp2F0=({struct Cyc_Dict_Dict _tmp2EF=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp2EE=_tmp88;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp2EF,_tmp2EE,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp84=_cycalloc(sizeof(*_tmp84));
_tmp84->tag=0U,({void*_tmp2ED=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp83=_cycalloc(sizeof(*_tmp83));_tmp83->tag=4U,_tmp83->f1=vd;_tmp83;});_tmp84->f1=_tmp2ED;});_tmp84;}));});
# 335
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp2F0;});else{
# 338
...
({struct Cyc_Dict_Dict _tmp2F4=({struct Cyc_Dict_Dict _tmp2F3=_tmp85->ordinaries;struct _dyneither_ptr*_tmp2F2=_tmp88;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp2F3,_tmp2F2,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp87=_cycalloc(sizeof(*_tmp87));
# 341
_tmp87->tag=0U,({void*_tmp2F1=(void*)({struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp86=_cycalloc(sizeof(*_tmp86));_tmp86->tag=1U,_tmp86->f1=vd;_tmp86;});_tmp87->f1=_tmp2F1;});_tmp87;}));});
# 339
_tmp85->ordinaries=_tmp2F4;});}};}
# 345
...
({void*_tmp2F5=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmpAD=_cycalloc(sizeof(*_tmpAD));_tmpAD->tag=31U,_tmpAD->f1=0,_tmpAD->f2=_tmpB5,_tmpAD->f3=_tmpB4;_tmpAD;});e->r=_tmp2F5;});_npop_handler(0U);return;case 3U: _LL5D: _tmpB7=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmpAC)->f1;_tmpB6=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmpAC)->f2;_LL5E:
({void*_tmp2F6=(void*)({struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmpAE=_cycalloc(sizeof(*_tmpAE));_tmpAE->tag=32U,_tmpAE->f1=_tmpB7,_tmpAE->f2=_tmpB6;_tmpAE;});e->r=_tmp2F6;});_npop_handler(0U);return;case 4U: _LL5F: _tmpB9=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmpAC)->f1;_tmpB8=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmpAC)->f2;_LL60:
({void*_tmp2F7=(void*)({struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmpAF=_cycalloc(sizeof(*_tmpAF));_tmpAF->tag=33U,_tmpAF->f1=_tmpB9,_tmpAF->f2=_tmpB8;_tmpAF;});e->r=_tmp2F7;});_npop_handler(0U);return;default: _LL61: _tmpBA=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmpAC)->f1;_LL62:
# 388
({struct Cyc_String_pa_PrintArg_struct _tmpB2=({struct Cyc_String_pa_PrintArg_struct _tmp2A2;_tmp2A2.tag=0U,({struct _dyneither_ptr _tmp2F8=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpC0));_tmp2A2.f1=_tmp2F8;});_tmp2A2;});void*_tmpB0[1U];_tmpB0[0]=& _tmpB2;({unsigned int _tmp2FA=e->loc;struct _dyneither_ptr _tmp2F9=({const char*_tmpB1="bad occurrence of type name %s";_tag_dyneither(_tmpB1,sizeof(char),31U);});Cyc_Warn_err(_tmp2FA,_tmp2F9,_tag_dyneither(_tmpB0,sizeof(void*),1U));});});
...
# 392
({struct Cyc_String_pa_PrintArg_struct _tmpBE=({struct Cyc_String_pa_PrintArg_struct _tmp2A3;_tmp2A3.tag=0U,({struct _dyneither_ptr _tmp2FB=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpC0));_tmp2A3.f1=_tmp2FB;});_tmp2A3;});void*_tmpBC[1U];_tmpBC[0]=& _tmpBE;({unsigned int _tmp2FD=e->loc;struct _dyneither_ptr _tmp2FC=({const char*_tmpBD="undeclared identifier %s";_tag_dyneither(_tmpBD,sizeof(char),25U);});Cyc_Warn_err(_tmp2FD,_tmp2FC,_tag_dyneither(_tmpBC,sizeof(void*),1U));});});
...
({struct Cyc_List_List*_tmp2FF=({struct Cyc_List_List*_tmpCD=_cycalloc(sizeof(*_tmpCD));({struct _tuple10*_tmp2FE=({struct _tuple10*_tmpCC=_cycalloc(sizeof(*_tmpCC));_tmpCC->f1=0,_tmpCC->f2=(struct Cyc_Absyn_Exp*)_tmpF1->hd;_tmpCC;});_tmpCD->hd=_tmp2FE;}),_tmpCD->tl=_tmpCB;_tmpCD;});_tmpCB=_tmp2FF;});}
({void*_tmp301=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmpCE=_cycalloc(sizeof(*_tmpCE));_tmpCE->tag=29U,_tmpCE->f1=_tmpD7->name,_tmpCE->f2=0,({struct Cyc_List_List*_tmp300=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmpCB);_tmpCE->f3=_tmp300;}),_tmpCE->f4=_tmpD7;_tmpCE;});e->r=_tmp301;});
...
# 416
 if(_tmpD8->typs == 0)
# 418
({struct Cyc_String_pa_PrintArg_struct _tmpD1=({struct Cyc_String_pa_PrintArg_struct _tmp2A4;_tmp2A4.tag=0U,({
struct _dyneither_ptr _tmp302=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpD8->name));_tmp2A4.f1=_tmp302;});_tmp2A4;});void*_tmpCF[1U];_tmpCF[0]=& _tmpD1;({unsigned int _tmp304=e->loc;struct _dyneither_ptr _tmp303=({const char*_tmpD0="%s is a constant, not a function";_tag_dyneither(_tmpD0,sizeof(char),33U);});Cyc_Warn_err(_tmp304,_tmp303,_tag_dyneither(_tmpCF,sizeof(void*),1U));});});
({void*_tmp305=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmpD2=_cycalloc(sizeof(*_tmpD2));_tmpD2->tag=31U,_tmpD2->f1=_tmpF1,_tmpD2->f2=_tmpD9,_tmpD2->f3=_tmpD8;_tmpD2;});e->r=_tmp305;});
_npop_handler(0U);return;case 4U: _LL79: _LL7A:
 goto _LL7C;default: _LL7B: _LL7C:
# 424
({struct Cyc_String_pa_PrintArg_struct _tmpD5=({struct Cyc_String_pa_PrintArg_struct _tmp2A5;_tmp2A5.tag=0U,({
struct _dyneither_ptr _tmp306=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpDF));_tmp2A5.f1=_tmp306;});_tmp2A5;});void*_tmpD3[1U];_tmpD3[0]=& _tmpD5;({unsigned int _tmp308=e->loc;struct _dyneither_ptr _tmp307=({const char*_tmpD4="%s is an enum constructor, not a function";_tag_dyneither(_tmpD4,sizeof(char),42U);});Cyc_Warn_err(_tmp308,_tmp307,_tag_dyneither(_tmpD3,sizeof(void*),1U));});});
...
# 428
({struct Cyc_String_pa_PrintArg_struct _tmpDD=({struct Cyc_String_pa_PrintArg_struct _tmp2A6;_tmp2A6.tag=0U,({struct _dyneither_ptr _tmp309=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpDF));_tmp2A6.f1=_tmp309;});_tmp2A6;});void*_tmpDB[1U];_tmpDB[0]=& _tmpDD;({unsigned int _tmp30B=e->loc;struct _dyneither_ptr _tmp30A=({const char*_tmpDC="undeclared identifier %s";_tag_dyneither(_tmpDC,sizeof(char),25U);});Cyc_Warn_err(_tmp30B,_tmp30A,_tag_dyneither(_tmpDB,sizeof(void*),1U));});});
...
({struct Cyc_Absyn_Aggrdecl*_tmp30C=((struct Cyc_Absyn_Aggrdecl*(*)(unsigned int loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_Absyn_Aggrdecl*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _dyneither_ptr*)))Cyc_Binding_resolve_lookup)(e->loc,env->ns,*_tmpF6,Cyc_Binding_lookup_aggrdecl);*_tmpF3=_tmp30C;});
...
# 444
({struct Cyc_String_pa_PrintArg_struct _tmpE7=({struct Cyc_String_pa_PrintArg_struct _tmp2A7;_tmp2A7.tag=0U,({struct _dyneither_ptr _tmp30D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(*_tmpF6));_tmp2A7.f1=_tmp30D;});_tmp2A7;});void*_tmpE5[1U];_tmpE5[0]=& _tmpE7;({unsigned int _tmp30F=e->loc;struct _dyneither_ptr _tmp30E=({const char*_tmpE6="unbound struct/union name %s";_tag_dyneither(_tmpE6,sizeof(char),29U);});Cyc_Warn_err(_tmp30F,_tmp30E,_tag_dyneither(_tmpE5,sizeof(void*),1U));});});
...
if(Cyc_Binding_at_toplevel(env)){
({struct Cyc_Dict_Dict*_tmp311=({struct Cyc_Dict_Dict*_tmpE9=_cycalloc(sizeof(*_tmpE9));({struct Cyc_Dict_Dict _tmp310=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmpE9=_tmp310;});_tmpE9;});env->local_vars=_tmp311;});
...
# 536
({void*_tmpEB=0U;({unsigned int _tmp313=e->loc;struct _dyneither_ptr _tmp312=({const char*_tmpEC="binding: compound literals unimplemented";_tag_dyneither(_tmpEC,sizeof(char),41U);});Cyc_Warn_err(_tmp313,_tmp312,_tag_dyneither(_tmpEB,sizeof(void*),0U));});});return;case 33U: _LL49: _tmp126=(void*)((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmpA5)->f1;_tmp125=((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmpA5)->f2;_LL4A:
# 539
...
# 552
({void*_tmpED=0U;({unsigned int _tmp315=e->loc;struct _dyneither_ptr _tmp314=({const char*_tmpEE="asm expressions cannot occur within Cyclone code";_tag_dyneither(_tmpEE,sizeof(char),49U);});Cyc_Warn_err(_tmp315,_tmp314,_tag_dyneither(_tmpED,sizeof(void*),0U));});});}_LL0:;}
# 556
...
struct Cyc_Absyn_Vardecl*_tmp140=({struct _tuple0*_tmp316=({struct _tuple0*_tmp142=_cycalloc(sizeof(*_tmp142));_tmp142->f1=Cyc_Absyn_Loc_n,_tmp142->f2=_tmp13F;_tmp142;});Cyc_Absyn_new_vardecl(0U,_tmp316,_tmp143,0);});
_tmp140->tq=_tmp144;
({struct Cyc_List_List*_tmp317=({struct Cyc_List_List*_tmp141=_cycalloc(sizeof(*_tmp141));_tmp141->hd=_tmp140,_tmp141->tl=_tmp13C;_tmp141;});_tmp13C=_tmp317;});};};}
# 595
if(vai != 0){
...
if(_tmp151 == 0){
if(need_va_name)
({void*_tmp148=0U;({unsigned int _tmp319=loc;struct _dyneither_ptr _tmp318=({const char*_tmp149="missing name for vararg";_tag_dyneither(_tmp149,sizeof(char),24U);});Cyc_Warn_err(_tmp319,_tmp318,_tag_dyneither(_tmp148,sizeof(void*),0U));});});}else{
# 602
void*_tmp14A=Cyc_Absyn_dyneither_typ(_tmp14F,(void*)& Cyc_Absyn_HeapRgn_val,_tmp150,Cyc_Absyn_false_conref);
struct Cyc_Absyn_Vardecl*_tmp14B=({struct _tuple0*_tmp31A=({struct _tuple0*_tmp14D=_cycalloc(sizeof(*_tmp14D));_tmp14D->f1=Cyc_Absyn_Loc_n,_tmp14D->f2=_tmp151;_tmp14D;});Cyc_Absyn_new_vardecl(0U,_tmp31A,_tmp14A,0);});
({struct Cyc_List_List*_tmp31B=({struct Cyc_List_List*_tmp14C=_cycalloc(sizeof(*_tmp14C));_tmp14C->hd=_tmp14B,_tmp14C->tl=_tmp13C;_tmp14C;});_tmp13C=_tmp31B;});}}
# 607
({struct Cyc_List_List*_tmp31C=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp13C);_tmp13C=_tmp31C;});
return _tmp13C;}
# 610
...
struct _dyneither_ptr*_tmp153=({struct _dyneither_ptr*_tmp159=_cycalloc(sizeof(*_tmp159));({struct _dyneither_ptr _tmp31D=({const char*_tmp158="return_value";_tag_dyneither(_tmp158,sizeof(char),13U);});*_tmp159=_tmp31D;});_tmp159;});
struct Cyc_Absyn_Vardecl*_tmp154=({struct _tuple0*_tmp31E=({struct _tuple0*_tmp157=_cycalloc(sizeof(*_tmp157));_tmp157->f1=Cyc_Absyn_Loc_n,_tmp157->f2=_tmp153;_tmp157;});Cyc_Absyn_new_vardecl(0U,_tmp31E,rettyp,0);});
({struct Cyc_Dict_Dict _tmp322=({struct Cyc_Dict_Dict _tmp321=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp320=_tmp153;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp321,_tmp320,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp156=_cycalloc(sizeof(*_tmp156));
_tmp156->tag=0U,({void*_tmp31F=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp155=_cycalloc(sizeof(*_tmp155));_tmp155->tag=4U,_tmp155->f1=_tmp154;_tmp155;});_tmp156->f1=_tmp31F;});_tmp156;}));});
# 632
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp322;});
# 634
...
({union Cyc_Absyn_DatatypeInfoU _tmp323=Cyc_Absyn_UnknownDatatype(({struct Cyc_Absyn_UnknownDatatypeInfo _tmp2A8;_tmp2A8.name=_tmp160->name,_tmp2A8.is_extensible=_tmp163;_tmp2A8;}));*_tmp1B4=_tmp323;});
_npop_handler(0U);return;}
# 652
...
({struct Cyc_String_pa_PrintArg_struct _tmp16F=({struct Cyc_String_pa_PrintArg_struct _tmp2AB;_tmp2AB.tag=0U,({
struct _dyneither_ptr _tmp324=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp172->name));_tmp2AB.f1=_tmp324;});_tmp2AB;});struct Cyc_String_pa_PrintArg_struct _tmp170=({struct Cyc_String_pa_PrintArg_struct _tmp2AA;_tmp2AA.tag=0U,({
struct _dyneither_ptr _tmp325=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp16C->name));_tmp2AA.f1=_tmp325;});_tmp2AA;});struct Cyc_String_pa_PrintArg_struct _tmp171=({struct Cyc_String_pa_PrintArg_struct _tmp2A9;_tmp2A9.tag=0U,({
struct _dyneither_ptr _tmp326=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp173->name));_tmp2A9.f1=_tmp326;});_tmp2A9;});void*_tmp16D[3U];_tmp16D[0]=& _tmp16F,_tmp16D[1]=& _tmp170,_tmp16D[2]=& _tmp171;({unsigned int _tmp328=loc;struct _dyneither_ptr _tmp327=({const char*_tmp16E="%s is a variant of %s, not %s (shadowing not yet implemented properly)";_tag_dyneither(_tmp16E,sizeof(char),71U);});Cyc_Warn_err(_tmp328,_tmp327,_tag_dyneither(_tmp16D,sizeof(void*),3U));});});
_npop_handler(0U);return;}
# 677
({union Cyc_Absyn_DatatypeFieldInfoU _tmp329=Cyc_Absyn_UnknownDatatypefield(({struct Cyc_Absyn_UnknownDatatypeFieldInfo _tmp2AC;_tmp2AC.datatype_name=_tmp173->name,_tmp2AC.field_name=_tmp172->name,_tmp2AC.is_extensible=_tmp179;_tmp2AC;}));*_tmp1B6=_tmp329;});
# 679
...
({struct Cyc_String_pa_PrintArg_struct _tmp178=({struct Cyc_String_pa_PrintArg_struct _tmp2AD;_tmp2AD.tag=0U,({struct _dyneither_ptr _tmp32A=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp17A));_tmp2AD.f1=_tmp32A;});_tmp2AD;});void*_tmp176[1U];_tmp176[0]=& _tmp178;({unsigned int _tmp32C=loc;struct _dyneither_ptr _tmp32B=({const char*_tmp177="%s is not a datatype field";_tag_dyneither(_tmp177,sizeof(char),27U);});Cyc_Warn_err(_tmp32C,_tmp32B,_tag_dyneither(_tmp176,sizeof(void*),1U));});});
...
({void*_tmp182=0U;({unsigned int _tmp32E=loc;struct _dyneither_ptr _tmp32D=({const char*_tmp183="struct vs. union mismatch with earlier declaration";_tag_dyneither(_tmp183,sizeof(char),51U);});Cyc_Warn_err(_tmp32E,_tmp32D,_tag_dyneither(_tmp182,sizeof(void*),0U));});});
...
# 699
({void*_tmp184=0U;({unsigned int _tmp330=loc;struct _dyneither_ptr _tmp32F=({const char*_tmp185="@tagged mismatch with earlier declaration";_tag_dyneither(_tmp185,sizeof(char),42U);});Cyc_Warn_err(_tmp330,_tmp32F,_tag_dyneither(_tmp184,sizeof(void*),0U));});});
({union Cyc_Absyn_AggrInfoU _tmp331=Cyc_Absyn_UnknownAggr(_tmp18A,_tmp181->name,_tmp188);*_tmp1B8=_tmp331;});
_npop_handler(0U);return;}
# 694
...
({struct Cyc_String_pa_PrintArg_struct _tmp199=({struct Cyc_String_pa_PrintArg_struct _tmp2AE;_tmp2AE.tag=0U,({struct _dyneither_ptr _tmp332=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(*_tmp1BD));_tmp2AE.f1=_tmp332;});_tmp2AE;});void*_tmp197[1U];_tmp197[0]=& _tmp199;({unsigned int _tmp334=loc;struct _dyneither_ptr _tmp333=({const char*_tmp198="unbound typdef name %s";_tag_dyneither(_tmp198,sizeof(char),23U);});Cyc_Warn_err(_tmp334,_tmp333,_tag_dyneither(_tmp197,sizeof(void*),1U));});});
...
# 734
({struct Cyc_Binding_Env*_tmp336=env;Cyc_Binding_resolve_decl(_tmp336,({struct Cyc_Absyn_Decl*_tmp19E=_cycalloc(sizeof(*_tmp19E));({void*_tmp335=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp19D=_cycalloc(sizeof(*_tmp19D));_tmp19D->tag=5U,_tmp19D->f1=_tmp1A3;_tmp19D;});_tmp19E->r=_tmp335;}),_tmp19E->loc=_tmp1BF->loc;_tmp19E;}));});goto _LL68;case 1U: _LL6B: _tmp1A4=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)_tmp19C)->f1;_LL6C:
# 736
({struct Cyc_Binding_Env*_tmp338=env;Cyc_Binding_resolve_decl(_tmp338,({struct Cyc_Absyn_Decl*_tmp1A0=_cycalloc(sizeof(*_tmp1A0));({void*_tmp337=(void*)({struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*_tmp19F=_cycalloc(sizeof(*_tmp19F));_tmp19F->tag=7U,_tmp19F->f1=_tmp1A4;_tmp19F;});_tmp1A0->r=_tmp337;}),_tmp1A0->loc=_tmp1BF->loc;_tmp1A0;}));});goto _LL68;default: _LL6D: _tmp1A5=((struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)_tmp19C)->f1;_LL6E:
# 738
({struct Cyc_Binding_Env*_tmp33A=env;Cyc_Binding_resolve_decl(_tmp33A,({struct Cyc_Absyn_Decl*_tmp1A2=_cycalloc(sizeof(*_tmp1A2));({void*_tmp339=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp1A1=_cycalloc(sizeof(*_tmp1A1));_tmp1A1->tag=6U,_tmp1A1->f1=_tmp1A5;_tmp1A1;});_tmp1A2->r=_tmp339;}),_tmp1A2->loc=_tmp1BF->loc;_tmp1A2;}));});goto _LL68;}_LL68:;}
# 740
...
if(_tmp1AD != 0)
({struct Cyc_Dict_Dict*_tmp33B=({struct Cyc_Dict_Dict*_tmp1AE=_cycalloc(sizeof(*_tmp1AE));*_tmp1AE=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));_tmp1AE;});env->local_vars=_tmp33B;});else{
# 801
({struct Cyc_Dict_Dict*_tmp33D=({struct Cyc_Dict_Dict*_tmp1AF=_cycalloc(sizeof(*_tmp1AF));({struct Cyc_Dict_Dict _tmp33C=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp1AF=_tmp33C;});_tmp1AF;});env->local_vars=_tmp33D;});}
{struct Cyc_List_List*_tmp1B0=_tmp1AC;for(0;_tmp1B0 != 0;_tmp1B0=_tmp1B0->tl){
({struct Cyc_Dict_Dict _tmp341=({struct Cyc_Dict_Dict _tmp340=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp33F=(*((struct Cyc_Absyn_Vardecl*)_tmp1B0->hd)->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp340,_tmp33F,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp1B2=_cycalloc(sizeof(*_tmp1B2));
_tmp1B2->tag=0U,({void*_tmp33E=(void*)({struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp1B1=_cycalloc(sizeof(*_tmp1B1));_tmp1B1->tag=3U,_tmp1B1->f1=(struct Cyc_Absyn_Vardecl*)_tmp1B0->hd;_tmp1B1;});_tmp1B2->f1=_tmp33E;});_tmp1B2;}));});
# 803
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp341;});}}
# 806
...
# 838
({void*_tmp1DA=0U;({unsigned int _tmp343=_tmp221;struct _dyneither_ptr _tmp342=({const char*_tmp1DB="struct tag used without arguments in pattern";_tag_dyneither(_tmp1DB,sizeof(char),45U);});Cyc_Warn_err(_tmp343,_tmp342,_tag_dyneither(_tmp1DA,sizeof(void*),0U));});});
...
# 841
({void*_tmp344=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp1DC=_cycalloc(sizeof(*_tmp1DC));_tmp1DC->tag=8U,_tmp1DC->f1=_tmp1E0,_tmp1DC->f2=_tmp1DF,_tmp1DC->f3=0,_tmp1DC->f4=0;_tmp1DC;});p->r=_tmp344;});_npop_handler(0U);return;case 3U: _LL33: _tmp1E2=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp1D9)->f1;_tmp1E1=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp1D9)->f2;_LL34:
# 843
({void*_tmp345=(void*)({struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*_tmp1DD=_cycalloc(sizeof(*_tmp1DD));_tmp1DD->tag=13U,_tmp1DD->f1=_tmp1E2,_tmp1DD->f2=_tmp1E1;_tmp1DD;});p->r=_tmp345;});_npop_handler(0U);return;default: _LL35: _tmp1E4=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp1D9)->f1;_tmp1E3=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp1D9)->f2;_LL36:
# 845
({void*_tmp346=(void*)({struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*_tmp1DE=_cycalloc(sizeof(*_tmp1DE));_tmp1DE->tag=14U,_tmp1DE->f1=_tmp1E4,_tmp1DE->f2=_tmp1E3;_tmp1DE;});p->r=_tmp346;});_npop_handler(0U);return;}_LL2C:;}
# 835
...
({void*_tmp348=(void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp1E8=_cycalloc(sizeof(*_tmp1E8));_tmp1E8->tag=1U,_tmp1E8->f1=_tmp1E7,({struct Cyc_Absyn_Pat*_tmp347=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0U);_tmp1E8->f2=_tmp347;});_tmp1E8;});p->r=_tmp348;});
...
({struct Cyc_List_List*_tmp34A=({struct Cyc_List_List*_tmp1F1=_cycalloc(sizeof(*_tmp1F1));({struct _tuple13*_tmp349=({struct _tuple13*_tmp1F0=_cycalloc(sizeof(*_tmp1F0));_tmp1F0->f1=0,_tmp1F0->f2=(struct Cyc_Absyn_Pat*)_tmp20E->hd;_tmp1F0;});_tmp1F1->hd=_tmp349;}),_tmp1F1->tl=_tmp1EF;_tmp1F1;});_tmp1EF=_tmp34A;});}
({void*_tmp34E=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp1F4=_cycalloc(sizeof(*_tmp1F4));_tmp1F4->tag=7U,({struct Cyc_Absyn_AggrInfo*_tmp34D=({struct Cyc_Absyn_AggrInfo*_tmp1F3=_cycalloc(sizeof(*_tmp1F3));({union Cyc_Absyn_AggrInfoU _tmp34C=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp1F2=_cycalloc(sizeof(*_tmp1F2));*_tmp1F2=_tmp1F8;_tmp1F2;}));_tmp1F3->aggr_info=_tmp34C;}),_tmp1F3->targs=0;_tmp1F3;});_tmp1F4->f1=_tmp34D;}),_tmp1F4->f2=0,({
struct Cyc_List_List*_tmp34B=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp1EF);_tmp1F4->f3=_tmp34B;}),_tmp1F4->f4=_tmp20D;_tmp1F4;});
# 861
p->r=_tmp34E;});
# 863
...
# 865
({void*_tmp34F=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp1F5=_cycalloc(sizeof(*_tmp1F5));_tmp1F5->tag=8U,_tmp1F5->f1=_tmp1FA,_tmp1F5->f2=_tmp1F9,_tmp1F5->f3=_tmp20E,_tmp1F5->f4=_tmp20D;_tmp1F5;});p->r=_tmp34F;});_npop_handler(0U);return;case 3U: _LL43: _LL44:
 goto _LL46;default: _LL45: _LL46:
# 868
({void*_tmp1F6=0U;({unsigned int _tmp351=_tmp221;struct _dyneither_ptr _tmp350=({const char*_tmp1F7="enum tag used with arguments in pattern";_tag_dyneither(_tmp1F7,sizeof(char),40U);});Cyc_Warn_err(_tmp351,_tmp350,_tag_dyneither(_tmp1F6,sizeof(void*),0U));});});_npop_handler(0U);return;}_LL3C:;}
# 855
...
({struct Cyc_String_pa_PrintArg_struct _tmp1FF=({struct Cyc_String_pa_PrintArg_struct _tmp2AF;_tmp2AF.tag=0U,({struct _dyneither_ptr _tmp352=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp20F));_tmp2AF.f1=_tmp352;});_tmp2AF;});void*_tmp1FD[1U];_tmp1FD[0]=& _tmp1FF;({unsigned int _tmp354=_tmp221;struct _dyneither_ptr _tmp353=({const char*_tmp1FE="%s is not a constructor in pattern";_tag_dyneither(_tmp1FE,sizeof(char),35U);});Cyc_Warn_err(_tmp354,_tmp353,_tag_dyneither(_tmp1FD,sizeof(void*),1U));});});
...
({void*_tmp357=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp207=_cycalloc(sizeof(*_tmp207));_tmp207->tag=7U,({struct Cyc_Absyn_AggrInfo*_tmp356=({struct Cyc_Absyn_AggrInfo*_tmp206=_cycalloc(sizeof(*_tmp206));({union Cyc_Absyn_AggrInfoU _tmp355=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp205=_cycalloc(sizeof(*_tmp205));*_tmp205=_tmp204;_tmp205;}));_tmp206->aggr_info=_tmp355;}),_tmp206->targs=_tmp213;_tmp206;});_tmp207->f1=_tmp356;}),_tmp207->f2=_tmp212,_tmp207->f3=_tmp211,_tmp207->f4=_tmp210;_tmp207;});p->r=_tmp357;});}
# 877
...
# 881
({void*_tmp209=0U;({unsigned int _tmp359=_tmp221;struct _dyneither_ptr _tmp358=({const char*_tmp20A="non-aggregate name has designator patterns";_tag_dyneither(_tmp20A,sizeof(char),43U);});Cyc_Warn_err(_tmp359,_tmp358,_tag_dyneither(_tmp209,sizeof(void*),0U));});});
...
# 961
({struct Cyc_Core_Opt*_tmp35A=({struct Cyc_Core_Opt*_tmp228=_cycalloc(sizeof(*_tmp228));_tmp228->v=_tmp227;_tmp228;});_tmp289->param_vardecls=_tmp35A;});
# 963
if(Cyc_Binding_warn_override)
...
if(_tmp229 != 0)
({struct Cyc_Dict_Dict*_tmp35B=({struct Cyc_Dict_Dict*_tmp22A=_cycalloc(sizeof(*_tmp22A));*_tmp22A=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));_tmp22A;});env->local_vars=_tmp35B;});else{
# 970
({struct Cyc_Dict_Dict*_tmp35D=({struct Cyc_Dict_Dict*_tmp22B=_cycalloc(sizeof(*_tmp22B));({struct Cyc_Dict_Dict _tmp35C=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp22B=_tmp35C;});_tmp22B;});env->local_vars=_tmp35D;});}
{struct Cyc_List_List*_tmp22C=_tmp227;for(0;_tmp22C != 0;_tmp22C=_tmp22C->tl){
({struct Cyc_Dict_Dict _tmp361=({struct Cyc_Dict_Dict _tmp360=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp35F=(*((struct Cyc_Absyn_Vardecl*)_tmp22C->hd)->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp360,_tmp35F,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp22E=_cycalloc(sizeof(*_tmp22E));
_tmp22E->tag=0U,({void*_tmp35E=(void*)({struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp22D=_cycalloc(sizeof(*_tmp22D));_tmp22D->tag=3U,_tmp22D->f1=(struct Cyc_Absyn_Vardecl*)_tmp22C->hd;_tmp22D;});_tmp22E->f1=_tmp35E;});_tmp22E;}));});
# 972
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp361;});}}
# 975
...
if(_tmp229 != 0){
# 981
({struct Cyc_Dict_Dict _tmp365=({struct Cyc_Dict_Dict _tmp364=*_tmp229;struct _dyneither_ptr*_tmp363=_tmp236;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp364,_tmp363,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp230=_cycalloc(sizeof(*_tmp230));
_tmp230->tag=0U,({void*_tmp362=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp22F=_cycalloc(sizeof(*_tmp22F));_tmp22F->tag=2U,_tmp22F->f1=_tmp289;_tmp22F;});_tmp230->f1=_tmp362;});_tmp230;}));});
# 981
*_tmp229=_tmp365;});
# 983
({struct Cyc_Dict_Dict _tmp369=({struct Cyc_Dict_Dict _tmp368=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp367=_tmp236;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp368,_tmp367,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp232=_cycalloc(sizeof(*_tmp232));
_tmp232->tag=0U,({void*_tmp366=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp231=_cycalloc(sizeof(*_tmp231));_tmp231->tag=2U,_tmp231->f1=_tmp289;_tmp231;});_tmp232->f1=_tmp366;});_tmp232;}));});
# 983
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp369;});}else{
# 986
...
({struct Cyc_Dict_Dict _tmp36D=({struct Cyc_Dict_Dict _tmp36C=_tmp233->ordinaries;struct _dyneither_ptr*_tmp36B=_tmp236;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp36C,_tmp36B,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp235=_cycalloc(sizeof(*_tmp235));
# 989
_tmp235->tag=0U,({void*_tmp36A=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp234=_cycalloc(sizeof(*_tmp234));_tmp234->tag=2U,_tmp234->f1=_tmp289;_tmp234;});_tmp235->f1=_tmp36A;});_tmp235;}));});
# 987
_tmp233->ordinaries=_tmp36D;});}
# 992
...
# 999
 if(Cyc_Binding_at_toplevel(env)){
({void*_tmp238=0U;({unsigned int _tmp36F=loc;struct _dyneither_ptr _tmp36E=({const char*_tmp239="let not allowed at top-level";_tag_dyneither(_tmp239,sizeof(char),29U);});Cyc_Warn_err(_tmp36F,_tmp36E,_tag_dyneither(_tmp238,sizeof(void*),0U));});});
goto _LL0;}
# 1003
...
# 1026
({struct Cyc_Dict_Dict _tmp370=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Typedefdecl*v))Cyc_Dict_insert)(_tmp23C->typedefs,_tmp23D,_tmp290);_tmp23C->typedefs=_tmp370;});
# 1028
...
goto _LL0;
# 1039
({struct Cyc_Dict_Dict _tmp371=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Aggrdecl*v))Cyc_Dict_insert)(_tmp241->aggrdecls,_tmp247,_tmp291);_tmp241->aggrdecls=_tmp371;});
# 1041
({struct Cyc_Dict_Dict _tmp374=({struct Cyc_Dict_Dict _tmp373=_tmp241->ordinaries;struct _dyneither_ptr*_tmp372=_tmp247;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp373,_tmp372,(void*)({struct Cyc_Binding_AggrRes_Binding_Resolved_struct*_tmp242=_cycalloc(sizeof(*_tmp242));
_tmp242->tag=1U,_tmp242->f1=_tmp291;_tmp242;}));});
# 1041
_tmp241->ordinaries=_tmp374;});
# 1043
if(_tmp291->impl != 0){
...
goto _LL0;
# 1060
({struct Cyc_Dict_Dict _tmp375=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Enumdecl*v))Cyc_Dict_insert)(_tmp24B->enumdecls,_tmp24E,_tmp292);_tmp24B->enumdecls=_tmp375;});
# 1062
if(_tmp292->fields != 0){
# 1064
...
({struct Cyc_Dict_Dict _tmp378=({struct Cyc_Dict_Dict _tmp377=_tmp24B->ordinaries;struct _dyneither_ptr*_tmp376=(*_tmp24C->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp377,_tmp376,(void*)({struct Cyc_Binding_EnumRes_Binding_Resolved_struct*_tmp24D=_cycalloc(sizeof(*_tmp24D));
# 1071
_tmp24D->tag=3U,_tmp24D->f1=_tmp292,_tmp24D->f2=_tmp24C;_tmp24D;}));});
# 1069
_tmp24B->ordinaries=_tmp378;});}}
# 1073
...
({struct Cyc_Dict_Dict _tmp37B=({struct Cyc_Dict_Dict _tmp37A=_tmp258->datatypedecls;struct _dyneither_ptr*_tmp379=_tmp25A;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_List_List*v))Cyc_Dict_insert)(_tmp37A,_tmp379,({struct Cyc_List_List*_tmp259=_cycalloc(sizeof(*_tmp259));
_tmp259->hd=_tmp293,_tmp259->tl=_tmp253;_tmp259;}));});
# 1086
_tmp258->datatypedecls=_tmp37B;});};};}
# 1078
...
# 1096
goto _LL31;
({struct Cyc_Dict_Dict _tmp37E=({struct Cyc_Dict_Dict _tmp37D=_tmp25F->datatypedecls;struct _dyneither_ptr*_tmp37C=_tmp261;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_List_List*v))Cyc_Dict_insert)(_tmp37D,_tmp37C,({struct Cyc_List_List*_tmp260=_cycalloc(sizeof(*_tmp260));
_tmp260->hd=_tmp293,_tmp260->tl=0;_tmp260;}));});
# 1097
_tmp25F->datatypedecls=_tmp37E;});
# 1099
...
({union Cyc_Absyn_Nmspace _tmp37F=Cyc_Absyn_Abs_n((env->ns)->curr_ns,0);(*_tmp267->name).f1=_tmp37F;});else{
# 1113
(*_tmp267->name).f1=(*_tmp293->name).f1;}
goto _LL3C;}else{_LL3F: _LL40:
# 1116
({void*_tmp26B=0U;({unsigned int _tmp381=_tmp267->loc;struct _dyneither_ptr _tmp380=({const char*_tmp26C="qualified datatype field declaratations are not allowed";_tag_dyneither(_tmp26C,sizeof(char),56U);});Cyc_Warn_err(_tmp381,_tmp380,_tag_dyneither(_tmp26B,sizeof(void*),0U));});});
return;}case 2U: _LL41: _LL42:
 goto _LL3C;default: _LL43: _LL44:
({void*_tmp26D=0U;({struct _dyneither_ptr _tmp382=({const char*_tmp26E="datatype field Loc_n or C_n";_tag_dyneither(_tmp26E,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp382,_tag_dyneither(_tmp26D,sizeof(void*),0U));});});}_LL3C:;}{
# 1121
...
({struct Cyc_Dict_Dict _tmp385=({struct Cyc_Dict_Dict _tmp384=_tmp26F->ordinaries;struct _dyneither_ptr*_tmp383=(*_tmp267->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp384,_tmp383,(void*)({struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*_tmp270=_cycalloc(sizeof(*_tmp270));
# 1124
_tmp270->tag=2U,_tmp270->f1=_tmp293,_tmp270->f2=_tmp267;_tmp270;}));});
# 1122
_tmp26F->ordinaries=_tmp385;});};}}
# 1126
...
# 1159
if(!Cyc_Binding_at_toplevel(env)){
({void*_tmp279=0U;({unsigned int _tmp387=loc;struct _dyneither_ptr _tmp386=({const char*_tmp27A="extern \"C include\" not at toplevel";_tag_dyneither(_tmp27A,sizeof(char),35U);});Cyc_Warn_err(_tmp387,_tmp386,_tag_dyneither(_tmp279,sizeof(void*),0U));});});
goto _LL0;}{
# 1164
...
void*_tmp388=((void*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp27C,_tmp286);_tmp388 == ((void*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp27E,_tmp286);}))
({struct Cyc_String_pa_PrintArg_struct _tmp285=({struct Cyc_String_pa_PrintArg_struct _tmp2B0;_tmp2B0.tag=0U,_tmp2B0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp286);_tmp2B0;});void*_tmp283[1U];_tmp283[0]=& _tmp285;({unsigned int _tmp38A=_tmp287;struct _dyneither_ptr _tmp389=({const char*_tmp284="%s is exported but not defined";_tag_dyneither(_tmp284,sizeof(char),31U);});Cyc_Warn_err(_tmp38A,_tmp389,_tag_dyneither(_tmp283,sizeof(void*),1U));});});
({struct Cyc_Dict_Dict _tmp38D=({struct Cyc_Dict_Dict _tmp38C=_tmp27F;struct _dyneither_ptr*_tmp38B=_tmp286;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp38C,_tmp38B,((void*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp27E,_tmp286));});_tmp27F=_tmp38D;});}}
# 1179
...
struct Cyc_Binding_Env*_tmp29B=({struct Cyc_Binding_Env*_tmp29E=_cycalloc(sizeof(*_tmp29E));_tmp29E->in_cinclude=0,({struct Cyc_Binding_NSCtxt*_tmp38E=((struct Cyc_Binding_NSCtxt*(*)(int env,struct Cyc_Binding_ResolveNSEnv*(*mkdata)(int)))Cyc_Binding_mt_nsctxt)(1,Cyc_Binding_mt_renv);_tmp29E->ns=_tmp38E;}),_tmp29E->local_vars=0;_tmp29E;});
({struct Cyc_Binding_Env*_tmp390=_tmp29B;Cyc_Binding_resolve_decl(_tmp390,({struct Cyc_Absyn_Decl*_tmp29D=_cycalloc(sizeof(*_tmp29D));({void*_tmp38F=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp29C=_cycalloc(sizeof(*_tmp29C));_tmp29C->tag=6U,_tmp29C->f1=Cyc_Absyn_exn_tud;_tmp29C;});_tmp29D->r=_tmp38F;}),_tmp29D->loc=0U;_tmp29D;}));});
