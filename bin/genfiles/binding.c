...
struct Cyc_List_List*_tmp2A9=({struct Cyc_List_List*_tmp2=_cycalloc(sizeof(*_tmp2));({void*_tmp2A8=(void*)({struct Cyc_Binding_Namespace_Binding_NSDirective_struct*_tmp1=_cycalloc(sizeof(*_tmp1));_tmp1->tag=0U,_tmp1->f1=0;_tmp1;});_tmp2->hd=_tmp2A8;}),_tmp2->tl=0;_tmp2;});_tmp3->availables=_tmp2A9;}),({
struct Cyc_Dict_Dict _tmp2A7=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct Cyc_List_List*,struct Cyc_List_List*),struct Cyc_List_List*k,void*v))Cyc_Dict_singleton)(Cyc_Absyn_varlist_cmp,0,_tmp0);_tmp3->ns_data=_tmp2A7;});_tmp3;});}
# 64
...
({void*_tmp5=0U;({struct _dyneither_ptr _tmp2AA=({const char*_tmp6="Binding:get_ns_data: relative ns";_tag_dyneither(_tmp6,sizeof(char),33U);});Cyc_Warn_impos(_tmp2AA,_tag_dyneither(_tmp5,sizeof(void*),0U));});});}_LL0:;}
# 82 "binding.cyc"
...
goto _LL0;}}_LL0:;}}
# 97
({struct Cyc_String_pa_PrintArg_struct _tmp12=({struct Cyc_String_pa_PrintArg_struct _tmp295;_tmp295.tag=0U,({struct _dyneither_ptr _tmp2AC=(struct _dyneither_ptr)((struct _dyneither_ptr)({struct Cyc_List_List*_tmp2AB=rel_ns;Cyc_str_sepstr(_tmp2AB,({const char*_tmp13="::";_tag_dyneither(_tmp13,sizeof(char),3U);}));}));_tmp295.f1=_tmp2AC;});_tmp295;});void*_tmp10[1U];_tmp10[0]=& _tmp12;({unsigned int _tmp2AE=loc;struct _dyneither_ptr _tmp2AD=({const char*_tmp11="namespace %s not found";_tag_dyneither(_tmp11,sizeof(char),23U);});Cyc_Warn_err(_tmp2AE,_tmp2AD,_tag_dyneither(_tmp10,sizeof(void*),1U));});});
...
# 106
{struct _handler_cons _tmp17;_push_handler(& _tmp17);{int _tmp19=0;if(setjmp(_tmp17.handler))_tmp19=1;if(!_tmp19){{void*_tmp1A=({void*(*_tmp2B0)(void*,struct _dyneither_ptr*)=lookup;void*_tmp2AF=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,ctxt->curr_ns);_tmp2B0(_tmp2AF,_tmp3D);});_npop_handler(0U);return _tmp1A;};_pop_handler();}else{void*_tmp18=(void*)_exn_thrown;void*_tmp1B=_tmp18;void*_tmp1C;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp1B)->tag == Cyc_Dict_Absent){_LLF: _LL10:
...
# 112
{struct _handler_cons _tmp20;_push_handler(& _tmp20);{int _tmp22=0;if(setjmp(_tmp20.handler))_tmp22=1;if(!_tmp22){{void*_tmp23=({void*(*_tmp2B2)(void*,struct _dyneither_ptr*)=lookup;void*_tmp2B1=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,_tmp27);_tmp2B2(_tmp2B1,_tmp3D);});_npop_handler(0U);return _tmp23;};_pop_handler();}else{void*_tmp21=(void*)_exn_thrown;void*_tmp24=_tmp21;void*_tmp25;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp24)->tag == Cyc_Dict_Absent){_LL19: _LL1A:
...
void*_tmp2D=({void*(*_tmp2B4)(void*,struct _dyneither_ptr*)=lookup;void*_tmp2B3=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,_tmp2C);_tmp2B4(_tmp2B3,_tmp3D);});_npop_handler(0U);return _tmp2D;}
# 119
...
# 124
struct _handler_cons _tmp31;_push_handler(& _tmp31);{int _tmp33=0;if(setjmp(_tmp31.handler))_tmp33=1;if(!_tmp33){{void*_tmp34=({void*(*_tmp2B6)(void*,struct _dyneither_ptr*)=lookup;void*_tmp2B5=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,_tmp3C);_tmp2B6(_tmp2B5,_tmp3D);});_npop_handler(0U);return _tmp34;};_pop_handler();}else{void*_tmp32=(void*)_exn_thrown;void*_tmp35=_tmp32;void*_tmp37;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp35)->tag == Cyc_Dict_Absent){_LL23: _LL24:
...
({void*_tmp38=0U;({struct _dyneither_ptr _tmp2B7=({const char*_tmp39="lookup local in global";_tag_dyneither(_tmp39,sizeof(char),23U);});Cyc_Warn_impos(_tmp2B7,_tag_dyneither(_tmp38,sizeof(void*),0U));});});}_LL3:;};}
# 130
...
struct Cyc_List_List*_tmp40=({struct Cyc_List_List*_tmp2B8=_tmp3F;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp2B8,({struct Cyc_List_List*_tmp43=_cycalloc(sizeof(*_tmp43));_tmp43->hd=subname,_tmp43->tl=0;_tmp43;}));});
if(!((int(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_member)(ctxt->ns_data,_tmp40))
({struct Cyc_Dict_Dict _tmp2BB=({struct Cyc_Dict_Dict _tmp2BA=ctxt->ns_data;struct Cyc_List_List*_tmp2B9=_tmp40;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k,void*v))Cyc_Dict_insert)(_tmp2BA,_tmp2B9,mkdata(env));});ctxt->ns_data=_tmp2BB;});
ctxt->curr_ns=_tmp40;
({struct Cyc_List_List*_tmp2BD=({struct Cyc_List_List*_tmp42=_cycalloc(sizeof(*_tmp42));({void*_tmp2BC=(void*)({struct Cyc_Binding_Namespace_Binding_NSDirective_struct*_tmp41=_cycalloc(sizeof(*_tmp41));_tmp41->tag=0U,_tmp41->f1=_tmp40;_tmp41;});_tmp42->hd=_tmp2BC;}),_tmp42->tl=ctxt->availables;_tmp42;});ctxt->availables=_tmp2BD;});}
# 138
void Cyc_Binding_leave_ns(struct Cyc_Binding_NSCtxt*ctxt){
if(ctxt->availables == 0)
({void*_tmp44=0U;({struct _dyneither_ptr _tmp2BE=({const char*_tmp45="leaving topmost namespace";_tag_dyneither(_tmp45,sizeof(char),26U);});Cyc_Warn_impos(_tmp2BE,_tag_dyneither(_tmp44,sizeof(void*),0U));});});{
...
({struct Cyc_List_List*_tmp2BF=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(((struct Cyc_List_List*)_check_null(((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(ctxt->curr_ns)))->tl);ctxt->curr_ns=_tmp2BF;});
goto _LL0;}else{_LL3: _LL4:
# 147
({void*_tmp48=0U;({struct _dyneither_ptr _tmp2C0=({const char*_tmp49="leaving using as namespace";_tag_dyneither(_tmp49,sizeof(char),27U);});Cyc_Warn_impos(_tmp2C0,_tag_dyneither(_tmp48,sizeof(void*),0U));});});}_LL0:;};}
# 150
struct Cyc_List_List*Cyc_Binding_enter_using(unsigned int loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*usename){
...
# 155
({struct Cyc_List_List*_tmp2C4=({unsigned int _tmp2C3=loc;struct Cyc_Binding_NSCtxt*_tmp2C2=ctxt;Cyc_Binding_resolve_rel_ns(_tmp2C3,_tmp2C2,({struct Cyc_List_List*_tmp2C1=_tmp53;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp2C1,({struct Cyc_List_List*_tmp4C=_cycalloc(sizeof(*_tmp4C));_tmp4C->hd=_tmp57,_tmp4C->tl=0;_tmp4C;}));}));});ns=_tmp2C4;});{
...
({union Cyc_Absyn_Nmspace _tmp2C5=Cyc_Absyn_Abs_n(_tmp4D,0);(*usename).f1=_tmp2C5;});
goto _LL3;};case 2U: _LL6: _tmp54=(_tmp4B.Abs_n).val;_LL7:
# 160
({struct Cyc_List_List*_tmp2C7=({struct Cyc_List_List*_tmp2C6=_tmp54;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp2C6,({struct Cyc_List_List*_tmp4E=_cycalloc(sizeof(*_tmp4E));_tmp4E->hd=_tmp57,_tmp4E->tl=0;_tmp4E;}));});ns=_tmp2C7;});
goto _LL3;case 4U: _LL8: _LL9:
({void*_tmp4F=0U;({struct _dyneither_ptr _tmp2C8=({const char*_tmp50="enter_using, Loc_n";_tag_dyneither(_tmp50,sizeof(char),19U);});Cyc_Warn_impos(_tmp2C8,_tag_dyneither(_tmp4F,sizeof(void*),0U));});});default: _LLA: _LLB:
({void*_tmp51=0U;({struct _dyneither_ptr _tmp2C9=({const char*_tmp52="enter_using, C_n";_tag_dyneither(_tmp52,sizeof(char),17U);});Cyc_Warn_impos(_tmp2C9,_tag_dyneither(_tmp51,sizeof(void*),0U));});});}_LL3:;}
# 165
({struct Cyc_List_List*_tmp2CB=({struct Cyc_List_List*_tmp56=_cycalloc(sizeof(*_tmp56));({void*_tmp2CA=(void*)({struct Cyc_Binding_Using_Binding_NSDirective_struct*_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55->tag=1U,_tmp55->f1=ns;_tmp55;});_tmp56->hd=_tmp2CA;}),_tmp56->tl=ctxt->availables;_tmp56;});ctxt->availables=_tmp2CB;});
return ns;};}
# 168
void Cyc_Binding_leave_using(struct Cyc_Binding_NSCtxt*ctxt){
if(ctxt->availables == 0)
({void*_tmp59=0U;({struct _dyneither_ptr _tmp2CC=({const char*_tmp5A="leaving topmost namespace as a using";_tag_dyneither(_tmp5A,sizeof(char),37U);});Cyc_Warn_impos(_tmp2CC,_tag_dyneither(_tmp59,sizeof(void*),0U));});});{
...
return({struct Cyc_Binding_ResolveNSEnv*_tmp5F=_cycalloc(sizeof(*_tmp5F));({struct Cyc_Dict_Dict _tmp2D2=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->aggrdecls=_tmp2D2;}),({
struct Cyc_Dict_Dict _tmp2D1=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->datatypedecls=_tmp2D1;}),({
struct Cyc_Dict_Dict _tmp2D0=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->enumdecls=_tmp2D0;}),({
struct Cyc_Dict_Dict _tmp2CF=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->typedefs=_tmp2CF;}),({
struct Cyc_Dict_Dict _tmp2CE=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->ordinaries=_tmp2CE;});_tmp5F;});}
# 226
...
({union Cyc_Absyn_Nmspace _tmp2D4=({struct Cyc_List_List*_tmp2D3=(env->ns)->curr_ns;Cyc_Absyn_Abs_n(_tmp2D3,Cyc_Binding_in_cinclude(env) || sc == Cyc_Absyn_ExternC);});(*qv).f1=_tmp2D4;});else{
# 280
...
# 288
({struct Cyc_String_pa_PrintArg_struct _tmp69=({struct Cyc_String_pa_PrintArg_struct _tmp296;_tmp296.tag=0U,({
struct _dyneither_ptr _tmp2D5=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(qv));_tmp296.f1=_tmp2D5;});_tmp296;});void*_tmp67[1U];_tmp67[0]=& _tmp69;({unsigned int _tmp2D7=loc;struct _dyneither_ptr _tmp2D6=({const char*_tmp68="qualified names in declarations unimplemented (%s)";_tag_dyneither(_tmp68,sizeof(char),51U);});Cyc_Warn_err(_tmp2D7,_tmp2D6,_tag_dyneither(_tmp67,sizeof(void*),1U));});});}_LL0:;}
# 295
...
({struct _dyneither_ptr _tmp2D8=({const char*_tmp71="global variable";_tag_dyneither(_tmp71,sizeof(char),16U);});hides_what=_tmp2D8;});goto _LLB;case 4U: _LLE: _LLF:
({struct _dyneither_ptr _tmp2D9=({const char*_tmp72="local variable";_tag_dyneither(_tmp72,sizeof(char),15U);});hides_what=_tmp2D9;});goto _LLB;case 3U: _LL10: _LL11:
({struct _dyneither_ptr _tmp2DA=({const char*_tmp73="parameter";_tag_dyneither(_tmp73,sizeof(char),10U);});hides_what=_tmp2DA;});goto _LLB;case 5U: _LL12: _LL13:
({struct _dyneither_ptr _tmp2DB=({const char*_tmp74="pattern variable";_tag_dyneither(_tmp74,sizeof(char),17U);});hides_what=_tmp2DB;});goto _LLB;case 2U: _LL14: _LL15:
({struct _dyneither_ptr _tmp2DC=({const char*_tmp75="function";_tag_dyneither(_tmp75,sizeof(char),9U);});hides_what=_tmp2DC;});goto _LLB;default: _LL16: _LL17:
({void*_tmp76=0U;({struct _dyneither_ptr _tmp2DD=({const char*_tmp77="shadowing free variable!";_tag_dyneither(_tmp77,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp2DD,_tag_dyneither(_tmp76,sizeof(void*),0U));});});}_LLB:;}
# 317
goto _LL0;case 1U: _LL3: _LL4:
({struct _dyneither_ptr _tmp2DE=({const char*_tmp78="struct constructor";_tag_dyneither(_tmp78,sizeof(char),19U);});hides_what=_tmp2DE;});goto _LL0;case 2U: _LL5: _LL6:
({struct _dyneither_ptr _tmp2DF=({const char*_tmp79="datatype constructor";_tag_dyneither(_tmp79,sizeof(char),21U);});hides_what=_tmp2DF;});goto _LL0;case 3U: _LL7: _LL8:
 goto _LLA;default: _LL9: _LLA:
({struct _dyneither_ptr _tmp2E0=({const char*_tmp7A="enum tag";_tag_dyneither(_tmp7A,sizeof(char),9U);});hides_what=_tmp2E0;});goto _LL0;}_LL0:;}
# 323
({struct Cyc_String_pa_PrintArg_struct _tmp7E=({struct Cyc_String_pa_PrintArg_struct _tmp297;_tmp297.tag=0U,_tmp297.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)hides_what);_tmp297;});void*_tmp7C[1U];_tmp7C[0]=& _tmp7E;({unsigned int _tmp2E2=loc;struct _dyneither_ptr _tmp2E1=({const char*_tmp7D="declaration hides %s";_tag_dyneither(_tmp7D,sizeof(char),21U);});Cyc_Warn_warn(_tmp2E2,_tmp2E1,_tag_dyneither(_tmp7C,sizeof(void*),1U));});});
_npop_handler(0U);return;
# 305
...
if(!Cyc_Binding_at_toplevel(env))
({struct Cyc_Dict_Dict _tmp2E6=({struct Cyc_Dict_Dict _tmp2E5=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp2E4=_tmp88;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp2E5,_tmp2E4,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp84=_cycalloc(sizeof(*_tmp84));
_tmp84->tag=0U,({void*_tmp2E3=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp83=_cycalloc(sizeof(*_tmp83));_tmp83->tag=4U,_tmp83->f1=vd;_tmp83;});_tmp84->f1=_tmp2E3;});_tmp84;}));});
# 335
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp2E6;});else{
# 338
...
({struct Cyc_Dict_Dict _tmp2EA=({struct Cyc_Dict_Dict _tmp2E9=_tmp85->ordinaries;struct _dyneither_ptr*_tmp2E8=_tmp88;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp2E9,_tmp2E8,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp87=_cycalloc(sizeof(*_tmp87));
# 341
_tmp87->tag=0U,({void*_tmp2E7=(void*)({struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp86=_cycalloc(sizeof(*_tmp86));_tmp86->tag=1U,_tmp86->f1=vd;_tmp86;});_tmp87->f1=_tmp2E7;});_tmp87;}));});
# 339
_tmp85->ordinaries=_tmp2EA;});}};}
# 345
...
({void*_tmp2EB=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmpAD=_cycalloc(sizeof(*_tmpAD));_tmpAD->tag=31U,_tmpAD->f1=0,_tmpAD->f2=_tmpB5,_tmpAD->f3=_tmpB4;_tmpAD;});e->r=_tmp2EB;});_npop_handler(0U);return;case 3U: _LL5F: _tmpB7=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmpAC)->f1;_tmpB6=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmpAC)->f2;_LL60:
({void*_tmp2EC=(void*)({struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmpAE=_cycalloc(sizeof(*_tmpAE));_tmpAE->tag=32U,_tmpAE->f1=_tmpB7,_tmpAE->f2=_tmpB6;_tmpAE;});e->r=_tmp2EC;});_npop_handler(0U);return;case 4U: _LL61: _tmpB9=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmpAC)->f1;_tmpB8=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmpAC)->f2;_LL62:
({void*_tmp2ED=(void*)({struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmpAF=_cycalloc(sizeof(*_tmpAF));_tmpAF->tag=33U,_tmpAF->f1=_tmpB9,_tmpAF->f2=_tmpB8;_tmpAF;});e->r=_tmp2ED;});_npop_handler(0U);return;default: _LL63: _tmpBA=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmpAC)->f1;_LL64:
# 388
({struct Cyc_String_pa_PrintArg_struct _tmpB2=({struct Cyc_String_pa_PrintArg_struct _tmp298;_tmp298.tag=0U,({struct _dyneither_ptr _tmp2EE=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpC0));_tmp298.f1=_tmp2EE;});_tmp298;});void*_tmpB0[1U];_tmpB0[0]=& _tmpB2;({unsigned int _tmp2F0=e->loc;struct _dyneither_ptr _tmp2EF=({const char*_tmpB1="bad occurrence of type name %s";_tag_dyneither(_tmpB1,sizeof(char),31U);});Cyc_Warn_err(_tmp2F0,_tmp2EF,_tag_dyneither(_tmpB0,sizeof(void*),1U));});});
...
# 392
({struct Cyc_String_pa_PrintArg_struct _tmpBE=({struct Cyc_String_pa_PrintArg_struct _tmp299;_tmp299.tag=0U,({struct _dyneither_ptr _tmp2F1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpC0));_tmp299.f1=_tmp2F1;});_tmp299;});void*_tmpBC[1U];_tmpBC[0]=& _tmpBE;({unsigned int _tmp2F3=e->loc;struct _dyneither_ptr _tmp2F2=({const char*_tmpBD="undeclared identifier %s";_tag_dyneither(_tmpBD,sizeof(char),25U);});Cyc_Warn_err(_tmp2F3,_tmp2F2,_tag_dyneither(_tmpBC,sizeof(void*),1U));});});
...
({struct Cyc_List_List*_tmp2F5=({struct Cyc_List_List*_tmpCD=_cycalloc(sizeof(*_tmpCD));({struct _tuple10*_tmp2F4=({struct _tuple10*_tmpCC=_cycalloc(sizeof(*_tmpCC));_tmpCC->f1=0,_tmpCC->f2=(struct Cyc_Absyn_Exp*)_tmpF1->hd;_tmpCC;});_tmpCD->hd=_tmp2F4;}),_tmpCD->tl=_tmpCB;_tmpCD;});_tmpCB=_tmp2F5;});}
({void*_tmp2F7=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmpCE=_cycalloc(sizeof(*_tmpCE));_tmpCE->tag=29U,_tmpCE->f1=_tmpD7->name,_tmpCE->f2=0,({struct Cyc_List_List*_tmp2F6=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmpCB);_tmpCE->f3=_tmp2F6;}),_tmpCE->f4=_tmpD7;_tmpCE;});e->r=_tmp2F7;});
...
# 416
 if(_tmpD8->typs == 0)
# 418
({struct Cyc_String_pa_PrintArg_struct _tmpD1=({struct Cyc_String_pa_PrintArg_struct _tmp29A;_tmp29A.tag=0U,({
struct _dyneither_ptr _tmp2F8=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpD8->name));_tmp29A.f1=_tmp2F8;});_tmp29A;});void*_tmpCF[1U];_tmpCF[0]=& _tmpD1;({unsigned int _tmp2FA=e->loc;struct _dyneither_ptr _tmp2F9=({const char*_tmpD0="%s is a constant, not a function";_tag_dyneither(_tmpD0,sizeof(char),33U);});Cyc_Warn_err(_tmp2FA,_tmp2F9,_tag_dyneither(_tmpCF,sizeof(void*),1U));});});
({void*_tmp2FB=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmpD2=_cycalloc(sizeof(*_tmpD2));_tmpD2->tag=31U,_tmpD2->f1=_tmpF1,_tmpD2->f2=_tmpD9,_tmpD2->f3=_tmpD8;_tmpD2;});e->r=_tmp2FB;});
_npop_handler(0U);return;case 4U: _LL7B: _LL7C:
 goto _LL7E;default: _LL7D: _LL7E:
# 424
({struct Cyc_String_pa_PrintArg_struct _tmpD5=({struct Cyc_String_pa_PrintArg_struct _tmp29B;_tmp29B.tag=0U,({
struct _dyneither_ptr _tmp2FC=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpDF));_tmp29B.f1=_tmp2FC;});_tmp29B;});void*_tmpD3[1U];_tmpD3[0]=& _tmpD5;({unsigned int _tmp2FE=e->loc;struct _dyneither_ptr _tmp2FD=({const char*_tmpD4="%s is an enum constructor, not a function";_tag_dyneither(_tmpD4,sizeof(char),42U);});Cyc_Warn_err(_tmp2FE,_tmp2FD,_tag_dyneither(_tmpD3,sizeof(void*),1U));});});
...
# 428
({struct Cyc_String_pa_PrintArg_struct _tmpDD=({struct Cyc_String_pa_PrintArg_struct _tmp29C;_tmp29C.tag=0U,({struct _dyneither_ptr _tmp2FF=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpDF));_tmp29C.f1=_tmp2FF;});_tmp29C;});void*_tmpDB[1U];_tmpDB[0]=& _tmpDD;({unsigned int _tmp301=e->loc;struct _dyneither_ptr _tmp300=({const char*_tmpDC="undeclared identifier %s";_tag_dyneither(_tmpDC,sizeof(char),25U);});Cyc_Warn_err(_tmp301,_tmp300,_tag_dyneither(_tmpDB,sizeof(void*),1U));});});
...
({struct Cyc_Absyn_Aggrdecl*_tmp302=((struct Cyc_Absyn_Aggrdecl*(*)(unsigned int loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_Absyn_Aggrdecl*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _dyneither_ptr*)))Cyc_Binding_resolve_lookup)(e->loc,env->ns,*_tmpF6,Cyc_Binding_lookup_aggrdecl);*_tmpF3=_tmp302;});
...
# 444
({struct Cyc_String_pa_PrintArg_struct _tmpE7=({struct Cyc_String_pa_PrintArg_struct _tmp29D;_tmp29D.tag=0U,({struct _dyneither_ptr _tmp303=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(*_tmpF6));_tmp29D.f1=_tmp303;});_tmp29D;});void*_tmpE5[1U];_tmpE5[0]=& _tmpE7;({unsigned int _tmp305=e->loc;struct _dyneither_ptr _tmp304=({const char*_tmpE6="unbound struct/union name %s";_tag_dyneither(_tmpE6,sizeof(char),29U);});Cyc_Warn_err(_tmp305,_tmp304,_tag_dyneither(_tmpE5,sizeof(void*),1U));});});
...
if(Cyc_Binding_at_toplevel(env)){
({struct Cyc_Dict_Dict*_tmp307=({struct Cyc_Dict_Dict*_tmpE9=_cycalloc(sizeof(*_tmpE9));({struct Cyc_Dict_Dict _tmp306=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmpE9=_tmp306;});_tmpE9;});env->local_vars=_tmp307;});
...
# 537
({void*_tmpEB=0U;({unsigned int _tmp309=e->loc;struct _dyneither_ptr _tmp308=({const char*_tmpEC="binding: compound literals unimplemented";_tag_dyneither(_tmpEC,sizeof(char),41U);});Cyc_Warn_err(_tmp309,_tmp308,_tag_dyneither(_tmpEB,sizeof(void*),0U));});});return;case 33U: _LL4B: _tmp127=(void*)((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmpA5)->f1;_tmp126=((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmpA5)->f2;_LL4C:
# 540
...
# 553
({void*_tmpED=0U;({unsigned int _tmp30B=e->loc;struct _dyneither_ptr _tmp30A=({const char*_tmpEE="asm expressions cannot occur within Cyclone code";_tag_dyneither(_tmpEE,sizeof(char),49U);});Cyc_Warn_err(_tmp30B,_tmp30A,_tag_dyneither(_tmpED,sizeof(void*),0U));});});}_LL0:;}
# 557
...
struct Cyc_Absyn_Vardecl*_tmp141=({struct _tuple0*_tmp30C=({struct _tuple0*_tmp143=_cycalloc(sizeof(*_tmp143));_tmp143->f1=Cyc_Absyn_Loc_n,_tmp143->f2=_tmp140;_tmp143;});Cyc_Absyn_new_vardecl(0U,_tmp30C,_tmp144,0);});
_tmp141->tq=_tmp145;
({struct Cyc_List_List*_tmp30D=({struct Cyc_List_List*_tmp142=_cycalloc(sizeof(*_tmp142));_tmp142->hd=_tmp141,_tmp142->tl=_tmp13D;_tmp142;});_tmp13D=_tmp30D;});};};}
# 596
if(vai != 0){
...
if(_tmp152 == 0){
if(need_va_name)
({void*_tmp149=0U;({unsigned int _tmp30F=loc;struct _dyneither_ptr _tmp30E=({const char*_tmp14A="missing name for vararg";_tag_dyneither(_tmp14A,sizeof(char),24U);});Cyc_Warn_err(_tmp30F,_tmp30E,_tag_dyneither(_tmp149,sizeof(void*),0U));});});}else{
# 603
void*_tmp14B=Cyc_Absyn_fatptr_type(_tmp150,Cyc_Absyn_heap_rgn_type,_tmp151,Cyc_Absyn_false_type);
struct Cyc_Absyn_Vardecl*_tmp14C=({struct _tuple0*_tmp310=({struct _tuple0*_tmp14E=_cycalloc(sizeof(*_tmp14E));_tmp14E->f1=Cyc_Absyn_Loc_n,_tmp14E->f2=_tmp152;_tmp14E;});Cyc_Absyn_new_vardecl(0U,_tmp310,_tmp14B,0);});
({struct Cyc_List_List*_tmp311=({struct Cyc_List_List*_tmp14D=_cycalloc(sizeof(*_tmp14D));_tmp14D->hd=_tmp14C,_tmp14D->tl=_tmp13D;_tmp14D;});_tmp13D=_tmp311;});}}
# 608
({struct Cyc_List_List*_tmp312=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp13D);_tmp13D=_tmp312;});
return _tmp13D;}
# 611
...
struct _dyneither_ptr*_tmp154=({struct _dyneither_ptr*_tmp15A=_cycalloc(sizeof(*_tmp15A));({struct _dyneither_ptr _tmp313=({const char*_tmp159="return_value";_tag_dyneither(_tmp159,sizeof(char),13U);});*_tmp15A=_tmp313;});_tmp15A;});
struct Cyc_Absyn_Vardecl*_tmp155=({struct _tuple0*_tmp314=({struct _tuple0*_tmp158=_cycalloc(sizeof(*_tmp158));_tmp158->f1=Cyc_Absyn_Loc_n,_tmp158->f2=_tmp154;_tmp158;});Cyc_Absyn_new_vardecl(0U,_tmp314,rettyp,0);});
({struct Cyc_Dict_Dict _tmp318=({struct Cyc_Dict_Dict _tmp317=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp316=_tmp154;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp317,_tmp316,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp157=_cycalloc(sizeof(*_tmp157));
_tmp157->tag=0U,({void*_tmp315=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp156=_cycalloc(sizeof(*_tmp156));_tmp156->tag=4U,_tmp156->f1=_tmp155;_tmp156;});_tmp157->f1=_tmp315;});_tmp157;}));});
# 633
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp318;});
# 635
...
({union Cyc_Absyn_DatatypeInfo _tmp319=Cyc_Absyn_UnknownDatatype(({struct Cyc_Absyn_UnknownDatatypeInfo _tmp29E;_tmp29E.name=_tmp161->name,_tmp29E.is_extensible=_tmp164;_tmp29E;}));*_tmp1B0=_tmp319;});
_npop_handler(0U);return;}
# 653
...
({struct Cyc_String_pa_PrintArg_struct _tmp170=({struct Cyc_String_pa_PrintArg_struct _tmp2A1;_tmp2A1.tag=0U,({
struct _dyneither_ptr _tmp31A=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp173->name));_tmp2A1.f1=_tmp31A;});_tmp2A1;});struct Cyc_String_pa_PrintArg_struct _tmp171=({struct Cyc_String_pa_PrintArg_struct _tmp2A0;_tmp2A0.tag=0U,({
struct _dyneither_ptr _tmp31B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp16D->name));_tmp2A0.f1=_tmp31B;});_tmp2A0;});struct Cyc_String_pa_PrintArg_struct _tmp172=({struct Cyc_String_pa_PrintArg_struct _tmp29F;_tmp29F.tag=0U,({
struct _dyneither_ptr _tmp31C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp174->name));_tmp29F.f1=_tmp31C;});_tmp29F;});void*_tmp16E[3U];_tmp16E[0]=& _tmp170,_tmp16E[1]=& _tmp171,_tmp16E[2]=& _tmp172;({unsigned int _tmp31E=loc;struct _dyneither_ptr _tmp31D=({const char*_tmp16F="%s is a variant of %s, not %s (shadowing not yet implemented properly)";_tag_dyneither(_tmp16F,sizeof(char),71U);});Cyc_Warn_err(_tmp31E,_tmp31D,_tag_dyneither(_tmp16E,sizeof(void*),3U));});});
_npop_handler(0U);return;}
# 678
({union Cyc_Absyn_DatatypeFieldInfo _tmp31F=Cyc_Absyn_UnknownDatatypefield(({struct Cyc_Absyn_UnknownDatatypeFieldInfo _tmp2A2;_tmp2A2.datatype_name=_tmp174->name,_tmp2A2.field_name=_tmp173->name,_tmp2A2.is_extensible=_tmp17A;_tmp2A2;}));*_tmp1B2=_tmp31F;});
# 680
...
({struct Cyc_String_pa_PrintArg_struct _tmp179=({struct Cyc_String_pa_PrintArg_struct _tmp2A3;_tmp2A3.tag=0U,({struct _dyneither_ptr _tmp320=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp17B));_tmp2A3.f1=_tmp320;});_tmp2A3;});void*_tmp177[1U];_tmp177[0]=& _tmp179;({unsigned int _tmp322=loc;struct _dyneither_ptr _tmp321=({const char*_tmp178="%s is not a datatype field";_tag_dyneither(_tmp178,sizeof(char),27U);});Cyc_Warn_err(_tmp322,_tmp321,_tag_dyneither(_tmp177,sizeof(void*),1U));});});
...
({void*_tmp183=0U;({unsigned int _tmp324=loc;struct _dyneither_ptr _tmp323=({const char*_tmp184="struct vs. union mismatch with earlier declaration";_tag_dyneither(_tmp184,sizeof(char),51U);});Cyc_Warn_err(_tmp324,_tmp323,_tag_dyneither(_tmp183,sizeof(void*),0U));});});
...
# 700
({void*_tmp185=0U;({unsigned int _tmp326=loc;struct _dyneither_ptr _tmp325=({const char*_tmp186="@tagged mismatch with earlier declaration";_tag_dyneither(_tmp186,sizeof(char),42U);});Cyc_Warn_err(_tmp326,_tmp325,_tag_dyneither(_tmp185,sizeof(void*),0U));});});
({union Cyc_Absyn_AggrInfo _tmp327=Cyc_Absyn_UnknownAggr(_tmp18B,_tmp182->name,_tmp189);*_tmp1B4=_tmp327;});
_npop_handler(0U);return;}
# 695
...
({struct Cyc_String_pa_PrintArg_struct _tmp19A=({struct Cyc_String_pa_PrintArg_struct _tmp2A4;_tmp2A4.tag=0U,({struct _dyneither_ptr _tmp328=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(*_tmp1BC));_tmp2A4.f1=_tmp328;});_tmp2A4;});void*_tmp198[1U];_tmp198[0]=& _tmp19A;({unsigned int _tmp32A=loc;struct _dyneither_ptr _tmp329=({const char*_tmp199="unbound typdef name %s";_tag_dyneither(_tmp199,sizeof(char),23U);});Cyc_Warn_err(_tmp32A,_tmp329,_tag_dyneither(_tmp198,sizeof(void*),1U));});});
...
if(_tmp1A9 != 0)
({struct Cyc_Dict_Dict*_tmp331=({struct Cyc_Dict_Dict*_tmp1AA=_cycalloc(sizeof(*_tmp1AA));*_tmp1AA=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));_tmp1AA;});env->local_vars=_tmp331;});else{
# 793
({struct Cyc_Dict_Dict*_tmp333=({struct Cyc_Dict_Dict*_tmp1AB=_cycalloc(sizeof(*_tmp1AB));({struct Cyc_Dict_Dict _tmp332=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp1AB=_tmp332;});_tmp1AB;});env->local_vars=_tmp333;});}
{struct Cyc_List_List*_tmp1AC=_tmp1A8;for(0;_tmp1AC != 0;_tmp1AC=_tmp1AC->tl){
({struct Cyc_Dict_Dict _tmp337=({struct Cyc_Dict_Dict _tmp336=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp335=(*((struct Cyc_Absyn_Vardecl*)_tmp1AC->hd)->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp336,_tmp335,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp1AE=_cycalloc(sizeof(*_tmp1AE));
_tmp1AE->tag=0U,({void*_tmp334=(void*)({struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp1AD=_cycalloc(sizeof(*_tmp1AD));_tmp1AD->tag=3U,_tmp1AD->f1=(struct Cyc_Absyn_Vardecl*)_tmp1AC->hd;_tmp1AD;});_tmp1AE->f1=_tmp334;});_tmp1AE;}));});
# 795
...
# 817
({void*_tmp1D1=0U;({unsigned int _tmp339=_tmp217;struct _dyneither_ptr _tmp338=({const char*_tmp1D2="struct tag used without arguments in pattern";_tag_dyneither(_tmp1D2,sizeof(char),45U);});Cyc_Warn_err(_tmp339,_tmp338,_tag_dyneither(_tmp1D1,sizeof(void*),0U));});});
...
# 820
({void*_tmp33A=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp1D3=_cycalloc(sizeof(*_tmp1D3));_tmp1D3->tag=8U,_tmp1D3->f1=_tmp1D7,_tmp1D3->f2=_tmp1D6,_tmp1D3->f3=0,_tmp1D3->f4=0;_tmp1D3;});p->r=_tmp33A;});_npop_handler(0U);return;case 3U: _LL33: _tmp1D9=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp1D0)->f1;_tmp1D8=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp1D0)->f2;_LL34:
# 822
({void*_tmp33B=(void*)({struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*_tmp1D4=_cycalloc(sizeof(*_tmp1D4));_tmp1D4->tag=13U,_tmp1D4->f1=_tmp1D9,_tmp1D4->f2=_tmp1D8;_tmp1D4;});p->r=_tmp33B;});_npop_handler(0U);return;default: _LL35: _tmp1DB=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp1D0)->f1;_tmp1DA=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp1D0)->f2;_LL36:
# 824
({void*_tmp33C=(void*)({struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*_tmp1D5=_cycalloc(sizeof(*_tmp1D5));_tmp1D5->tag=14U,_tmp1D5->f1=_tmp1DB,_tmp1D5->f2=_tmp1DA;_tmp1D5;});p->r=_tmp33C;});_npop_handler(0U);return;}_LL2C:;}
# 814
...
({void*_tmp33E=(void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp1DF=_cycalloc(sizeof(*_tmp1DF));_tmp1DF->tag=1U,_tmp1DF->f1=_tmp1DE,({struct Cyc_Absyn_Pat*_tmp33D=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0U);_tmp1DF->f2=_tmp33D;});_tmp1DF;});p->r=_tmp33E;});
...
({struct Cyc_List_List*_tmp340=({struct Cyc_List_List*_tmp1E8=_cycalloc(sizeof(*_tmp1E8));({struct _tuple13*_tmp33F=({struct _tuple13*_tmp1E7=_cycalloc(sizeof(*_tmp1E7));_tmp1E7->f1=0,_tmp1E7->f2=(struct Cyc_Absyn_Pat*)_tmp205->hd;_tmp1E7;});_tmp1E8->hd=_tmp33F;}),_tmp1E8->tl=_tmp1E6;_tmp1E8;});_tmp1E6=_tmp340;});}
({void*_tmp344=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp1EB=_cycalloc(sizeof(*_tmp1EB));_tmp1EB->tag=7U,({union Cyc_Absyn_AggrInfo*_tmp343=({union Cyc_Absyn_AggrInfo*_tmp1EA=_cycalloc(sizeof(*_tmp1EA));({union Cyc_Absyn_AggrInfo _tmp342=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp1E9=_cycalloc(sizeof(*_tmp1E9));*_tmp1E9=_tmp1EF;_tmp1E9;}));*_tmp1EA=_tmp342;});_tmp1EA;});_tmp1EB->f1=_tmp343;}),_tmp1EB->f2=0,({struct Cyc_List_List*_tmp341=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp1E6);_tmp1EB->f3=_tmp341;}),_tmp1EB->f4=_tmp204;_tmp1EB;});p->r=_tmp344;});
...
# 843
({void*_tmp345=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp1EC=_cycalloc(sizeof(*_tmp1EC));_tmp1EC->tag=8U,_tmp1EC->f1=_tmp1F1,_tmp1EC->f2=_tmp1F0,_tmp1EC->f3=_tmp205,_tmp1EC->f4=_tmp204;_tmp1EC;});p->r=_tmp345;});_npop_handler(0U);return;case 3U: _LL43: _LL44:
 goto _LL46;default: _LL45: _LL46:
# 846
({void*_tmp1ED=0U;({unsigned int _tmp347=_tmp217;struct _dyneither_ptr _tmp346=({const char*_tmp1EE="enum tag used with arguments in pattern";_tag_dyneither(_tmp1EE,sizeof(char),40U);});Cyc_Warn_err(_tmp347,_tmp346,_tag_dyneither(_tmp1ED,sizeof(void*),0U));});});_npop_handler(0U);return;}_LL3C:;}
# 834
...
({struct Cyc_String_pa_PrintArg_struct _tmp1F6=({struct Cyc_String_pa_PrintArg_struct _tmp2A5;_tmp2A5.tag=0U,({struct _dyneither_ptr _tmp348=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp206));_tmp2A5.f1=_tmp348;});_tmp2A5;});void*_tmp1F4[1U];_tmp1F4[0]=& _tmp1F6;({unsigned int _tmp34A=_tmp217;struct _dyneither_ptr _tmp349=({const char*_tmp1F5="%s is not a constructor in pattern";_tag_dyneither(_tmp1F5,sizeof(char),35U);});Cyc_Warn_err(_tmp34A,_tmp349,_tag_dyneither(_tmp1F4,sizeof(void*),1U));});});
...
({void*_tmp34D=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp1FE=_cycalloc(sizeof(*_tmp1FE));_tmp1FE->tag=7U,({union Cyc_Absyn_AggrInfo*_tmp34C=({union Cyc_Absyn_AggrInfo*_tmp1FD=_cycalloc(sizeof(*_tmp1FD));({union Cyc_Absyn_AggrInfo _tmp34B=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp1FC=_cycalloc(sizeof(*_tmp1FC));*_tmp1FC=_tmp1FB;_tmp1FC;}));*_tmp1FD=_tmp34B;});_tmp1FD;});_tmp1FE->f1=_tmp34C;}),_tmp1FE->f2=_tmp209,_tmp1FE->f3=_tmp208,_tmp1FE->f4=_tmp207;_tmp1FE;});p->r=_tmp34D;});}
# 855
...
# 858
({void*_tmp200=0U;({unsigned int _tmp34F=_tmp217;struct _dyneither_ptr _tmp34E=({const char*_tmp201="non-aggregate name has designator patterns";_tag_dyneither(_tmp201,sizeof(char),43U);});Cyc_Warn_err(_tmp34F,_tmp34E,_tag_dyneither(_tmp200,sizeof(void*),0U));});});
...
void*_tmp219=d->r;void*_tmp21A=_tmp219;struct Cyc_List_List*_tmp290;struct Cyc_List_List*_tmp28F;struct Cyc_List_List*_tmp28E;struct _tuple0*_tmp28D;struct Cyc_List_List*_tmp28C;struct _dyneither_ptr*_tmp28B;struct Cyc_List_List*_tmp28A;struct Cyc_Absyn_Datatypedecl*_tmp289;struct Cyc_Absyn_Enumdecl*_tmp288;struct Cyc_Absyn_Aggrdecl*_tmp287;struct Cyc_Absyn_Typedefdecl*_tmp286;struct Cyc_Absyn_Tvar*_tmp285;struct Cyc_Absyn_Vardecl*_tmp284;struct Cyc_Absyn_Exp*_tmp283;struct Cyc_List_List*_tmp282;struct Cyc_Absyn_Pat*_tmp281;struct Cyc_Absyn_Exp*_tmp280;struct Cyc_Absyn_Fndecl*_tmp27F;struct Cyc_Absyn_Vardecl*_tmp27E;switch(*((int*)_tmp21A)){case 0U: _LL1: _tmp27E=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_LL2:
# 923
 Cyc_Binding_resolve_and_add_vardecl(loc,env,_tmp27E);
# 928
if(_tmp27E->initializer != 0  && !Cyc_Binding_in_cinclude(env))
Cyc_Binding_resolve_exp(env,(struct Cyc_Absyn_Exp*)_check_null(_tmp27E->initializer));
goto _LL0;case 1U: _LL3: _tmp27F=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_LL4:
# 933
 Cyc_Binding_absolutize_decl(loc,env,_tmp27F->name,_tmp27F->sc);{
struct _tuple0*_tmp21B=_tmp27F->name;struct _tuple0*_tmp21C=_tmp21B;union Cyc_Absyn_Nmspace _tmp22D;struct _dyneither_ptr*_tmp22C;_LL20: _tmp22D=_tmp21C->f1;_tmp22C=_tmp21C->f2;_LL21:;{
# 936
struct Cyc_List_List*_tmp21D=((struct Cyc_List_List*(*)(struct _dyneither_ptr*(*f)(struct _dyneither_ptr*),int need_va_name,unsigned int loc,struct Cyc_Binding_Env*env,struct Cyc_List_List*args,struct Cyc_Absyn_VarargInfo*vai))Cyc_Binding_get_fun_vardecls)(Cyc_Binding_get_vds_fndecl,1,loc,env,_tmp27F->args,_tmp27F->cyc_varargs);
# 938
({struct Cyc_Core_Opt*_tmp350=({struct Cyc_Core_Opt*_tmp21E=_cycalloc(sizeof(*_tmp21E));_tmp21E->v=_tmp21D;_tmp21E;});_tmp27F->param_vardecls=_tmp350;});
# 940
if(Cyc_Binding_warn_override)
Cyc_Binding_check_warn_override(loc,env,_tmp27F->name);{
# 943
struct Cyc_Dict_Dict*_tmp21F=env->local_vars;
if(_tmp21F != 0)
({struct Cyc_Dict_Dict*_tmp351=({struct Cyc_Dict_Dict*_tmp220=_cycalloc(sizeof(*_tmp220));*_tmp220=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));_tmp220;});env->local_vars=_tmp351;});else{
# 947
({struct Cyc_Dict_Dict*_tmp353=({struct Cyc_Dict_Dict*_tmp221=_cycalloc(sizeof(*_tmp221));({struct Cyc_Dict_Dict _tmp352=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp221=_tmp352;});_tmp221;});env->local_vars=_tmp353;});}
{struct Cyc_List_List*_tmp222=_tmp21D;for(0;_tmp222 != 0;_tmp222=_tmp222->tl){
({struct Cyc_Dict_Dict _tmp357=({struct Cyc_Dict_Dict _tmp356=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp355=(*((struct Cyc_Absyn_Vardecl*)_tmp222->hd)->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp356,_tmp355,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp224=_cycalloc(sizeof(*_tmp224));
_tmp224->tag=0U,({void*_tmp354=(void*)({struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp223=_cycalloc(sizeof(*_tmp223));_tmp223->tag=3U,_tmp223->f1=(struct Cyc_Absyn_Vardecl*)_tmp222->hd;_tmp223;});_tmp224->f1=_tmp354;});_tmp224;}));});
# 949
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp357;});}}
# 952
((void(*)(unsigned int loc,struct Cyc_Binding_Env*env,void*eff,void*rettyp,struct Cyc_List_List*args,struct Cyc_Absyn_VarargInfo*vai,struct Cyc_List_List*rpo,struct Cyc_Absyn_Exp*req_clause,struct Cyc_Absyn_Exp*ens_clause))Cyc_Binding_resolve_function_stuff)(loc,env,_tmp27F->effect,_tmp27F->ret_type,_tmp27F->args,_tmp27F->cyc_varargs,_tmp27F->rgn_po,_tmp27F->requires_clause,_tmp27F->ensures_clause);
# 956
if(_tmp21F != 0){
# 958
({struct Cyc_Dict_Dict _tmp35B=({struct Cyc_Dict_Dict _tmp35A=*_tmp21F;struct _dyneither_ptr*_tmp359=_tmp22C;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp35A,_tmp359,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp226=_cycalloc(sizeof(*_tmp226));
_tmp226->tag=0U,({void*_tmp358=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp225=_cycalloc(sizeof(*_tmp225));_tmp225->tag=2U,_tmp225->f1=_tmp27F;_tmp225;});_tmp226->f1=_tmp358;});_tmp226;}));});
# 958
*_tmp21F=_tmp35B;});
# 960
({struct Cyc_Dict_Dict _tmp35F=({struct Cyc_Dict_Dict _tmp35E=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp35D=_tmp22C;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp35E,_tmp35D,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp228=_cycalloc(sizeof(*_tmp228));
_tmp228->tag=0U,({void*_tmp35C=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp227=_cycalloc(sizeof(*_tmp227));_tmp227->tag=2U,_tmp227->f1=_tmp27F;_tmp227;});_tmp228->f1=_tmp35C;});_tmp228;}));});
# 960
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp35F;});}else{
# 963
...
({struct Cyc_Dict_Dict _tmp363=({struct Cyc_Dict_Dict _tmp362=_tmp229->ordinaries;struct _dyneither_ptr*_tmp361=_tmp22C;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp362,_tmp361,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp22B=_cycalloc(sizeof(*_tmp22B));
# 966
_tmp22B->tag=0U,({void*_tmp360=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp22A=_cycalloc(sizeof(*_tmp22A));_tmp22A->tag=2U,_tmp22A->f1=_tmp27F;_tmp22A;});_tmp22B->f1=_tmp360;});_tmp22B;}));});
# 964
_tmp229->ordinaries=_tmp363;});}
# 969
if(!Cyc_Binding_in_cinclude(env))
Cyc_Binding_resolve_stmt(env,_tmp27F->body);
# 972
env->local_vars=_tmp21F;
goto _LL0;};};};case 2U: _LL5: _tmp281=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_tmp280=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp21A)->f3;_LL6:
# 976
 if(Cyc_Binding_at_toplevel(env)){
({void*_tmp22E=0U;({unsigned int _tmp365=loc;struct _dyneither_ptr _tmp364=({const char*_tmp22F="let not allowed at top-level";_tag_dyneither(_tmp22F,sizeof(char),29U);});Cyc_Warn_err(_tmp365,_tmp364,_tag_dyneither(_tmp22E,sizeof(void*),0U));});});
goto _LL0;}
# 980
Cyc_Binding_resolve_exp(env,_tmp280);
Cyc_Binding_resolve_pat(env,_tmp281);
goto _LL0;case 3U: _LL7: _tmp282=((struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_LL8:
# 985
 for(0;_tmp282 != 0;_tmp282=_tmp282->tl){
Cyc_Binding_resolve_and_add_vardecl(loc,env,(struct Cyc_Absyn_Vardecl*)_tmp282->hd);}
goto _LL0;case 4U: _LL9: _tmp285=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_tmp284=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp21A)->f2;_tmp283=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp21A)->f3;_LLA:
# 990
 if(_tmp283 != 0)
Cyc_Binding_resolve_exp(env,_tmp283);
Cyc_Binding_resolve_and_add_vardecl(loc,env,_tmp284);
goto _LL0;case 8U: _LLB: _tmp286=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_LLC:
# 996
 Cyc_Binding_absolutize_decl(loc,env,_tmp286->name,_tmp286->extern_c?Cyc_Absyn_ExternC: Cyc_Absyn_Public);{
struct _tuple0*_tmp230=_tmp286->name;struct _tuple0*_tmp231=_tmp230;union Cyc_Absyn_Nmspace _tmp234;struct _dyneither_ptr*_tmp233;_LL23: _tmp234=_tmp231->f1;_tmp233=_tmp231->f2;_LL24:;{
# 999
struct Cyc_Binding_ResolveNSEnv*_tmp232=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,_tmp234);
if(_tmp286->defn != 0)
Cyc_Binding_resolve_type(loc,env,(void*)_check_null(_tmp286->defn));
# 1003
({struct Cyc_Dict_Dict _tmp366=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Typedefdecl*v))Cyc_Dict_insert)(_tmp232->typedefs,_tmp233,_tmp286);_tmp232->typedefs=_tmp366;});
# 1005
goto _LL0;};};case 5U: _LLD: _tmp287=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_LLE:
# 1008
 Cyc_Binding_absolutize_decl(loc,env,_tmp287->name,_tmp287->sc);{
struct _tuple0*_tmp235=_tmp287->name;struct _tuple0*_tmp236=_tmp235;union Cyc_Absyn_Nmspace _tmp23E;struct _dyneither_ptr*_tmp23D;_LL26: _tmp23E=_tmp236->f1;_tmp23D=_tmp236->f2;_LL27:;{
# 1011
struct Cyc_Binding_ResolveNSEnv*_tmp237=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,_tmp23E);
# 1013
if(((int(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_member)(_tmp237->aggrdecls,_tmp23D) && _tmp287->impl == 0)
goto _LL0;
# 1016
({struct Cyc_Dict_Dict _tmp367=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Aggrdecl*v))Cyc_Dict_insert)(_tmp237->aggrdecls,_tmp23D,_tmp287);_tmp237->aggrdecls=_tmp367;});
# 1018
({struct Cyc_Dict_Dict _tmp36A=({struct Cyc_Dict_Dict _tmp369=_tmp237->ordinaries;struct _dyneither_ptr*_tmp368=_tmp23D;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp369,_tmp368,(void*)({struct Cyc_Binding_AggrRes_Binding_Resolved_struct*_tmp238=_cycalloc(sizeof(*_tmp238));
_tmp238->tag=1U,_tmp238->f1=_tmp287;_tmp238;}));});
# 1018
_tmp237->ordinaries=_tmp36A;});
# 1020
if(_tmp287->impl != 0){
struct Cyc_Absyn_AggrdeclImpl*_tmp239=(struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp287->impl);struct Cyc_Absyn_AggrdeclImpl*_tmp23A=_tmp239;struct Cyc_List_List*_tmp23C;struct Cyc_List_List*_tmp23B;_LL29: _tmp23C=_tmp23A->rgn_po;_tmp23B=_tmp23A->fields;_LL2A:;
Cyc_Binding_resolve_rgnpo(loc,env,_tmp23C);
Cyc_Binding_resolve_aggrfields(loc,env,_tmp23B);}
# 1025
goto _LL0;};};case 7U: _LLF: _tmp288=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_LL10:
# 1028
 Cyc_Binding_absolutize_decl(loc,env,_tmp288->name,_tmp288->sc);{
struct _tuple0*_tmp23F=_tmp288->name;struct _tuple0*_tmp240=_tmp23F;union Cyc_Absyn_Nmspace _tmp245;struct _dyneither_ptr*_tmp244;_LL2C: _tmp245=_tmp240->f1;_tmp244=_tmp240->f2;_LL2D:;{
# 1031
struct Cyc_Binding_ResolveNSEnv*_tmp241=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,_tmp245);
# 1033
if(((int(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_member)(_tmp241->enumdecls,_tmp244) && _tmp288->fields == 0)
goto _LL0;
# 1037
({struct Cyc_Dict_Dict _tmp36B=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Enumdecl*v))Cyc_Dict_insert)(_tmp241->enumdecls,_tmp244,_tmp288);_tmp241->enumdecls=_tmp36B;});
# 1039
if(_tmp288->fields != 0){
# 1041
struct Cyc_List_List*fs=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp288->fields))->v;for(0;fs != 0;fs=fs->tl){
struct Cyc_Absyn_Enumfield*_tmp242=(struct Cyc_Absyn_Enumfield*)fs->hd;
Cyc_Binding_absolutize_decl(_tmp242->loc,env,_tmp242->name,_tmp288->sc);
if(_tmp242->tag != 0)
Cyc_Binding_resolve_exp(env,(struct Cyc_Absyn_Exp*)_check_null(_tmp242->tag));
({struct Cyc_Dict_Dict _tmp36E=({struct Cyc_Dict_Dict _tmp36D=_tmp241->ordinaries;struct _dyneither_ptr*_tmp36C=(*_tmp242->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp36D,_tmp36C,(void*)({struct Cyc_Binding_EnumRes_Binding_Resolved_struct*_tmp243=_cycalloc(sizeof(*_tmp243));
# 1048
_tmp243->tag=3U,_tmp243->f1=_tmp288,_tmp243->f2=_tmp242;_tmp243;}));});
# 1046
_tmp241->ordinaries=_tmp36E;});}}
# 1050
goto _LL0;};};case 6U: _LL11: _tmp289=((struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_LL12:
# 1054
{struct _handler_cons _tmp246;_push_handler(& _tmp246);{int _tmp248=0;if(setjmp(_tmp246.handler))_tmp248=1;if(!_tmp248){
{struct Cyc_List_List*_tmp249=((struct Cyc_List_List*(*)(unsigned int loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_List_List*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _dyneither_ptr*)))Cyc_Binding_resolve_lookup)(loc,env->ns,_tmp289->name,Cyc_Binding_lookup_datatypedecl);
struct Cyc_Absyn_Datatypedecl*_tmp24A=(struct Cyc_Absyn_Datatypedecl*)_tmp249->hd;
if(!_tmp24A->is_extensible)
(int)_throw((void*)({struct Cyc_Binding_BindingError_exn_struct*_tmp24B=_cycalloc(sizeof(*_tmp24B));_tmp24B->tag=Cyc_Binding_BindingError;_tmp24B;}));
_tmp289->name=_tmp24A->name;
_tmp289->is_extensible=1;{
struct _tuple0*_tmp24C=_tmp289->name;struct _tuple0*_tmp24D=_tmp24C;union Cyc_Absyn_Nmspace _tmp251;struct _dyneither_ptr*_tmp250;_LL2F: _tmp251=_tmp24D->f1;_tmp250=_tmp24D->f2;_LL30:;{
struct Cyc_Binding_ResolveNSEnv*_tmp24E=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,_tmp251);
({struct Cyc_Dict_Dict _tmp371=({struct Cyc_Dict_Dict _tmp370=_tmp24E->datatypedecls;struct _dyneither_ptr*_tmp36F=_tmp250;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_List_List*v))Cyc_Dict_insert)(_tmp370,_tmp36F,({struct Cyc_List_List*_tmp24F=_cycalloc(sizeof(*_tmp24F));
_tmp24F->hd=_tmp289,_tmp24F->tl=_tmp249;_tmp24F;}));});
# 1063
_tmp24E->datatypedecls=_tmp371;});};};}
# 1055
;_pop_handler();}else{void*_tmp247=(void*)_exn_thrown;void*_tmp252=_tmp247;void*_tmp259;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp252)->tag == Cyc_Binding_BindingError){_LL32: _LL33:
# 1067
 Cyc_Binding_absolutize_topdecl(loc,env,_tmp289->name,_tmp289->sc);{
struct _tuple0*_tmp253=_tmp289->name;struct _tuple0*_tmp254=_tmp253;union Cyc_Absyn_Nmspace _tmp258;struct _dyneither_ptr*_tmp257;_LL37: _tmp258=_tmp254->f1;_tmp257=_tmp254->f2;_LL38:;{
struct Cyc_Binding_ResolveNSEnv*_tmp255=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,_tmp258);
# 1071
if(((int(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_member)(_tmp255->datatypedecls,_tmp257) && _tmp289->fields == 0)
# 1073
goto _LL31;
({struct Cyc_Dict_Dict _tmp374=({struct Cyc_Dict_Dict _tmp373=_tmp255->datatypedecls;struct _dyneither_ptr*_tmp372=_tmp257;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_List_List*v))Cyc_Dict_insert)(_tmp373,_tmp372,({struct Cyc_List_List*_tmp256=_cycalloc(sizeof(*_tmp256));
_tmp256->hd=_tmp289,_tmp256->tl=0;_tmp256;}));});
# 1074
_tmp255->datatypedecls=_tmp374;});
# 1076
goto _LL31;};};}else{_LL34: _tmp259=_tmp252;_LL35:(int)_rethrow(_tmp259);}_LL31:;}};}{
# 1079
struct _tuple0*_tmp25A=_tmp289->name;struct _tuple0*_tmp25B=_tmp25A;union Cyc_Absyn_Nmspace _tmp268;struct _dyneither_ptr*_tmp267;_LL3A: _tmp268=_tmp25B->f1;_tmp267=_tmp25B->f2;_LL3B:;
if(_tmp289->fields != 0){
struct Cyc_List_List*_tmp25C=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp289->fields))->v;for(0;_tmp25C != 0;_tmp25C=_tmp25C->tl){
struct Cyc_Absyn_Datatypefield*_tmp25D=(struct Cyc_Absyn_Datatypefield*)_tmp25C->hd;
{struct Cyc_List_List*_tmp25E=_tmp25D->typs;for(0;_tmp25E != 0;_tmp25E=_tmp25E->tl){
Cyc_Binding_resolve_type(loc,env,(*((struct _tuple12*)_tmp25E->hd)).f2);}}
{union Cyc_Absyn_Nmspace _tmp25F=(*_tmp25D->name).f1;union Cyc_Absyn_Nmspace _tmp260=_tmp25F;switch((_tmp260.Abs_n).tag){case 1U: if((_tmp260.Rel_n).val == 0){_LL3D: _LL3E:
# 1087
 if(_tmp289->is_extensible)
({union Cyc_Absyn_Nmspace _tmp375=Cyc_Absyn_Abs_n((env->ns)->curr_ns,0);(*_tmp25D->name).f1=_tmp375;});else{
# 1090
(*_tmp25D->name).f1=(*_tmp289->name).f1;}
goto _LL3C;}else{_LL3F: _LL40:
# 1093
({void*_tmp261=0U;({unsigned int _tmp377=_tmp25D->loc;struct _dyneither_ptr _tmp376=({const char*_tmp262="qualified datatype field declaratations are not allowed";_tag_dyneither(_tmp262,sizeof(char),56U);});Cyc_Warn_err(_tmp377,_tmp376,_tag_dyneither(_tmp261,sizeof(void*),0U));});});
return;}case 2U: _LL41: _LL42:
 goto _LL3C;default: _LL43: _LL44:
({void*_tmp263=0U;({struct _dyneither_ptr _tmp378=({const char*_tmp264="datatype field Loc_n or C_n";_tag_dyneither(_tmp264,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp378,_tag_dyneither(_tmp263,sizeof(void*),0U));});});}_LL3C:;}{
# 1098
struct Cyc_Binding_ResolveNSEnv*_tmp265=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,(*_tmp25D->name).f1);
({struct Cyc_Dict_Dict _tmp37B=({struct Cyc_Dict_Dict _tmp37A=_tmp265->ordinaries;struct _dyneither_ptr*_tmp379=(*_tmp25D->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp37A,_tmp379,(void*)({struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*_tmp266=_cycalloc(sizeof(*_tmp266));
# 1101
_tmp266->tag=2U,_tmp266->f1=_tmp289,_tmp266->f2=_tmp25D;_tmp266;}));});
# 1099
_tmp265->ordinaries=_tmp37B;});};}}
# 1103
goto _LL0;};case 9U: _LL13: _tmp28B=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_tmp28A=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp21A)->f2;_LL14:
# 1106
((void(*)(struct Cyc_Binding_NSCtxt*ctxt,struct _dyneither_ptr*subname,int env,struct Cyc_Binding_ResolveNSEnv*(*mkdata)(int)))Cyc_Binding_enter_ns)(env->ns,_tmp28B,1,Cyc_Binding_mt_renv);
Cyc_Binding_resolve_decls(env,_tmp28A);
((void(*)(struct Cyc_Binding_NSCtxt*ctxt))Cyc_Binding_leave_ns)(env->ns);
goto _LL0;case 10U: _LL15: _tmp28D=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_tmp28C=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp21A)->f2;_LL16:
# 1111
((struct Cyc_List_List*(*)(unsigned int loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*usename))Cyc_Binding_enter_using)(d->loc,env->ns,_tmp28D);
Cyc_Binding_resolve_decls(env,_tmp28C);
((void(*)(struct Cyc_Binding_NSCtxt*ctxt))Cyc_Binding_leave_using)(env->ns);
goto _LL0;case 11U: _LL17: _tmp28E=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_LL18: {
# 1117
int _tmp269=env->in_cinclude;
env->in_cinclude=1;
Cyc_Binding_resolve_decls(env,_tmp28E);
env->in_cinclude=_tmp269;
goto _LL0;}case 12U: _LL19: _tmp290=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_tmp28F=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp21A)->f2;_LL1A:
# 1128
{struct Cyc_List_List*_tmp26A=_tmp28F;for(0;_tmp26A != 0;_tmp26A=_tmp26A->tl){
struct _tuple15*_tmp26B=(struct _tuple15*)_tmp26A->hd;struct _tuple15*_tmp26C=_tmp26B;unsigned int _tmp26E;struct _tuple0*_tmp26D;_LL46: _tmp26E=_tmp26C->f1;_tmp26D=_tmp26C->f2;_LL47:;
Cyc_Binding_absolutize_decl(_tmp26E,env,_tmp26D,Cyc_Absyn_ExternC);}}
# 1136
if(!Cyc_Binding_at_toplevel(env)){
({void*_tmp26F=0U;({unsigned int _tmp37D=loc;struct _dyneither_ptr _tmp37C=({const char*_tmp270="extern \"C include\" not at toplevel";_tag_dyneither(_tmp270,sizeof(char),35U);});Cyc_Warn_err(_tmp37D,_tmp37C,_tag_dyneither(_tmp26F,sizeof(void*),0U));});});
goto _LL0;}{
# 1141
struct Cyc_Binding_ResolveNSEnv*_tmp271=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)((env->ns)->ns_data,(env->ns)->curr_ns);
struct Cyc_Dict_Dict _tmp272=_tmp271->ordinaries;
int _tmp273=env->in_cinclude;
env->in_cinclude=1;
Cyc_Binding_resolve_decls(env,_tmp290);{
struct Cyc_Dict_Dict _tmp274=_tmp271->ordinaries;
struct Cyc_Dict_Dict _tmp275=_tmp272;
{struct Cyc_List_List*_tmp276=_tmp28F;for(0;_tmp276 != 0;_tmp276=_tmp276->tl){
struct _tuple15*_tmp277=(struct _tuple15*)_tmp276->hd;struct _tuple15*_tmp278=_tmp277;unsigned int _tmp27D;struct _dyneither_ptr*_tmp27C;_LL49: _tmp27D=_tmp278->f1;_tmp27C=(_tmp278->f2)->f2;_LL4A:;
if(!((int(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_member)(_tmp274,_tmp27C) || 
((int(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_member)(_tmp272,_tmp27C) && ({
void*_tmp37E=((void*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp272,_tmp27C);_tmp37E == ((void*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp274,_tmp27C);}))
({struct Cyc_String_pa_PrintArg_struct _tmp27B=({struct Cyc_String_pa_PrintArg_struct _tmp2A6;_tmp2A6.tag=0U,_tmp2A6.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp27C);_tmp2A6;});void*_tmp279[1U];_tmp279[0]=& _tmp27B;({unsigned int _tmp380=_tmp27D;struct _dyneither_ptr _tmp37F=({const char*_tmp27A="%s is exported but not defined";_tag_dyneither(_tmp27A,sizeof(char),31U);});Cyc_Warn_err(_tmp380,_tmp37F,_tag_dyneither(_tmp279,sizeof(void*),1U));});});
({struct Cyc_Dict_Dict _tmp383=({struct Cyc_Dict_Dict _tmp382=_tmp275;struct _dyneither_ptr*_tmp381=_tmp27C;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp382,_tmp381,((void*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp274,_tmp27C));});_tmp275=_tmp383;});}}
# 1156
_tmp271->ordinaries=_tmp275;
...
struct Cyc_Binding_Env*_tmp291=({struct Cyc_Binding_Env*_tmp294=_cycalloc(sizeof(*_tmp294));_tmp294->in_cinclude=0,({struct Cyc_Binding_NSCtxt*_tmp384=((struct Cyc_Binding_NSCtxt*(*)(int env,struct Cyc_Binding_ResolveNSEnv*(*mkdata)(int)))Cyc_Binding_mt_nsctxt)(1,Cyc_Binding_mt_renv);_tmp294->ns=_tmp384;}),_tmp294->local_vars=0;_tmp294;});
({struct Cyc_Binding_Env*_tmp386=_tmp291;Cyc_Binding_resolve_decl(_tmp386,({struct Cyc_Absyn_Decl*_tmp293=_cycalloc(sizeof(*_tmp293));({void*_tmp385=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp292=_cycalloc(sizeof(*_tmp292));_tmp292->tag=6U,_tmp292->f1=Cyc_Absyn_exn_tud;_tmp292;});_tmp293->r=_tmp385;}),_tmp293->loc=0U;_tmp293;}));});
Cyc_Binding_resolve_decls(_tmp291,tds);}
