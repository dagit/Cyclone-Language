...
({union Cyc_Absyn_Nmspace _tmp2CA=Cyc_Absyn_Abs_n(_tmp4D,0);(*usename).f1=_tmp2CA;});
goto _LL3;};case 2U: _LL6: _tmp54=(_tmp4B.Abs_n).val;_LL7:
# 160
 ns=({struct Cyc_List_List*_tmp2CB=_tmp54;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp2CB,({struct Cyc_List_List*_tmp4E=_cycalloc(sizeof(*_tmp4E));_tmp4E->hd=_tmp57,_tmp4E->tl=0;_tmp4E;}));});
goto _LL3;case 4U: _LL8: _LL9:
({void*_tmp4F=0U;({struct _dyneither_ptr _tmp2CC=({const char*_tmp50="enter_using, Loc_n";_tag_dyneither(_tmp50,sizeof(char),19U);});Cyc_Warn_impos(_tmp2CC,_tag_dyneither(_tmp4F,sizeof(void*),0U));});});default: _LLA: _LLB:
({void*_tmp51=0U;({struct _dyneither_ptr _tmp2CD=({const char*_tmp52="enter_using, C_n";_tag_dyneither(_tmp52,sizeof(char),17U);});Cyc_Warn_impos(_tmp2CD,_tag_dyneither(_tmp51,sizeof(void*),0U));});});}_LL3:;}
# 165
({struct Cyc_List_List*_tmp2CF=({struct Cyc_List_List*_tmp56=_cycalloc(sizeof(*_tmp56));({void*_tmp2CE=(void*)({struct Cyc_Binding_Using_Binding_NSDirective_struct*_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55->tag=1U,_tmp55->f1=ns;_tmp55;});_tmp56->hd=_tmp2CE;}),_tmp56->tl=ctxt->availables;_tmp56;});ctxt->availables=_tmp2CF;});
return ns;};}
# 168
void Cyc_Binding_leave_using(struct Cyc_Binding_NSCtxt*ctxt){
if(ctxt->availables == 0)
({void*_tmp59=0U;({struct _dyneither_ptr _tmp2D0=({const char*_tmp5A="leaving topmost namespace as a using";_tag_dyneither(_tmp5A,sizeof(char),37U);});Cyc_Warn_impos(_tmp2D0,_tag_dyneither(_tmp59,sizeof(void*),0U));});});{
...
return({struct Cyc_Binding_ResolveNSEnv*_tmp5F=_cycalloc(sizeof(*_tmp5F));({struct Cyc_Dict_Dict _tmp2D6=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->aggrdecls=_tmp2D6;}),({
struct Cyc_Dict_Dict _tmp2D5=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->datatypedecls=_tmp2D5;}),({
struct Cyc_Dict_Dict _tmp2D4=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->enumdecls=_tmp2D4;}),({
struct Cyc_Dict_Dict _tmp2D3=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->typedefs=_tmp2D3;}),({
struct Cyc_Dict_Dict _tmp2D2=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp5F->ordinaries=_tmp2D2;});_tmp5F;});}
# 226
...
struct _dyneither_ptr _tmp2D9=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(qv));_tmp29C.f1=_tmp2D9;});_tmp29C;});void*_tmp67[1U];_tmp67[0]=& _tmp69;({unsigned int _tmp2DB=loc;struct _dyneither_ptr _tmp2DA=({const char*_tmp68="qualified names in declarations unimplemented (%s)";_tag_dyneither(_tmp68,sizeof(char),51U);});Cyc_Warn_err(_tmp2DB,_tmp2DA,_tag_dyneither(_tmp67,sizeof(void*),1U));});});}_LL0:;}
# 295
...
({void*_tmp76=0U;({struct _dyneither_ptr _tmp2DC=({const char*_tmp77="shadowing free variable!";_tag_dyneither(_tmp77,sizeof(char),25U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp2DC,_tag_dyneither(_tmp76,sizeof(void*),0U));});});}_LLB:;}
# 317
...
if(!Cyc_Binding_at_toplevel(env))
({struct Cyc_Dict_Dict _tmp2E2=({struct Cyc_Dict_Dict _tmp2E1=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp2E0=_tmp88;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp2E1,_tmp2E0,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp84=_cycalloc(sizeof(*_tmp84));
_tmp84->tag=0U,({void*_tmp2DF=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp83=_cycalloc(sizeof(*_tmp83));_tmp83->tag=4U,_tmp83->f1=vd;_tmp83;});_tmp84->f1=_tmp2DF;});_tmp84;}));});
# 335
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp2E2;});else{
# 338
...
({struct Cyc_Dict_Dict _tmp2E6=({struct Cyc_Dict_Dict _tmp2E5=_tmp85->ordinaries;struct _dyneither_ptr*_tmp2E4=_tmp88;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp2E5,_tmp2E4,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp87=_cycalloc(sizeof(*_tmp87));
# 341
_tmp87->tag=0U,({void*_tmp2E3=(void*)({struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp86=_cycalloc(sizeof(*_tmp86));_tmp86->tag=1U,_tmp86->f1=vd;_tmp86;});_tmp87->f1=_tmp2E3;});_tmp87;}));});
# 339
_tmp85->ordinaries=_tmp2E6;});}};}
# 345
...
({void*_tmp2E7=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmpAD=_cycalloc(sizeof(*_tmpAD));_tmpAD->tag=31U,_tmpAD->f1=0,_tmpAD->f2=_tmpB5,_tmpAD->f3=_tmpB4;_tmpAD;});e->r=_tmp2E7;});_npop_handler(0U);return;case 3U: _LL5F: _tmpB7=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmpAC)->f1;_tmpB6=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmpAC)->f2;_LL60:
({void*_tmp2E8=(void*)({struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*_tmpAE=_cycalloc(sizeof(*_tmpAE));_tmpAE->tag=32U,_tmpAE->f1=_tmpB7,_tmpAE->f2=_tmpB6;_tmpAE;});e->r=_tmp2E8;});_npop_handler(0U);return;case 4U: _LL61: _tmpB9=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmpAC)->f1;_tmpB8=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmpAC)->f2;_LL62:
({void*_tmp2E9=(void*)({struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmpAF=_cycalloc(sizeof(*_tmpAF));_tmpAF->tag=33U,_tmpAF->f1=_tmpB9,_tmpAF->f2=_tmpB8;_tmpAF;});e->r=_tmp2E9;});_npop_handler(0U);return;default: _LL63: _tmpBA=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmpAC)->f1;_LL64:
# 388
({struct Cyc_String_pa_PrintArg_struct _tmpB2=({struct Cyc_String_pa_PrintArg_struct _tmp29E;_tmp29E.tag=0U,({struct _dyneither_ptr _tmp2EA=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpC0));_tmp29E.f1=_tmp2EA;});_tmp29E;});void*_tmpB0[1U];_tmpB0[0]=& _tmpB2;({unsigned int _tmp2EC=e->loc;struct _dyneither_ptr _tmp2EB=({const char*_tmpB1="bad occurrence of type name %s";_tag_dyneither(_tmpB1,sizeof(char),31U);});Cyc_Warn_err(_tmp2EC,_tmp2EB,_tag_dyneither(_tmpB0,sizeof(void*),1U));});});
...
# 392
({struct Cyc_String_pa_PrintArg_struct _tmpBE=({struct Cyc_String_pa_PrintArg_struct _tmp29F;_tmp29F.tag=0U,({struct _dyneither_ptr _tmp2ED=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpC0));_tmp29F.f1=_tmp2ED;});_tmp29F;});void*_tmpBC[1U];_tmpBC[0]=& _tmpBE;({unsigned int _tmp2EF=e->loc;struct _dyneither_ptr _tmp2EE=({const char*_tmpBD="undeclared identifier %s";_tag_dyneither(_tmpBD,sizeof(char),25U);});Cyc_Warn_err(_tmp2EF,_tmp2EE,_tag_dyneither(_tmpBC,sizeof(void*),1U));});});
...
_tmpCB=({struct Cyc_List_List*_tmpCD=_cycalloc(sizeof(*_tmpCD));({struct _tuple10*_tmp2F0=({struct _tuple10*_tmpCC=_cycalloc(sizeof(*_tmpCC));_tmpCC->f1=0,_tmpCC->f2=(struct Cyc_Absyn_Exp*)_tmpF1->hd;_tmpCC;});_tmpCD->hd=_tmp2F0;}),_tmpCD->tl=_tmpCB;_tmpCD;});}
({void*_tmp2F2=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmpCE=_cycalloc(sizeof(*_tmpCE));_tmpCE->tag=29U,_tmpCE->f1=_tmpD7->name,_tmpCE->f2=0,({struct Cyc_List_List*_tmp2F1=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmpCB);_tmpCE->f3=_tmp2F1;}),_tmpCE->f4=_tmpD7;_tmpCE;});e->r=_tmp2F2;});
...
struct _dyneither_ptr _tmp2F3=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpD8->name));_tmp2A0.f1=_tmp2F3;});_tmp2A0;});void*_tmpCF[1U];_tmpCF[0]=& _tmpD1;({unsigned int _tmp2F5=e->loc;struct _dyneither_ptr _tmp2F4=({const char*_tmpD0="%s is a constant, not a function";_tag_dyneither(_tmpD0,sizeof(char),33U);});Cyc_Warn_err(_tmp2F5,_tmp2F4,_tag_dyneither(_tmpCF,sizeof(void*),1U));});});
({void*_tmp2F6=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmpD2=_cycalloc(sizeof(*_tmpD2));_tmpD2->tag=31U,_tmpD2->f1=_tmpF1,_tmpD2->f2=_tmpD9,_tmpD2->f3=_tmpD8;_tmpD2;});e->r=_tmp2F6;});
...
struct _dyneither_ptr _tmp2F7=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpDF));_tmp2A1.f1=_tmp2F7;});_tmp2A1;});void*_tmpD3[1U];_tmpD3[0]=& _tmpD5;({unsigned int _tmp2F9=e->loc;struct _dyneither_ptr _tmp2F8=({const char*_tmpD4="%s is an enum constructor, not a function";_tag_dyneither(_tmpD4,sizeof(char),42U);});Cyc_Warn_err(_tmp2F9,_tmp2F8,_tag_dyneither(_tmpD3,sizeof(void*),1U));});});
...
# 428
({struct Cyc_String_pa_PrintArg_struct _tmpDD=({struct Cyc_String_pa_PrintArg_struct _tmp2A2;_tmp2A2.tag=0U,({struct _dyneither_ptr _tmp2FA=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmpDF));_tmp2A2.f1=_tmp2FA;});_tmp2A2;});void*_tmpDB[1U];_tmpDB[0]=& _tmpDD;({unsigned int _tmp2FC=e->loc;struct _dyneither_ptr _tmp2FB=({const char*_tmpDC="undeclared identifier %s";_tag_dyneither(_tmpDC,sizeof(char),25U);});Cyc_Warn_err(_tmp2FC,_tmp2FB,_tag_dyneither(_tmpDB,sizeof(void*),1U));});});
...
({struct Cyc_Absyn_Aggrdecl*_tmp2FD=((struct Cyc_Absyn_Aggrdecl*(*)(unsigned int loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_Absyn_Aggrdecl*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _dyneither_ptr*)))Cyc_Binding_resolve_lookup)(e->loc,env->ns,*_tmpF6,Cyc_Binding_lookup_aggrdecl);*_tmpF3=_tmp2FD;});
...
# 444
({struct Cyc_String_pa_PrintArg_struct _tmpE7=({struct Cyc_String_pa_PrintArg_struct _tmp2A3;_tmp2A3.tag=0U,({struct _dyneither_ptr _tmp2FE=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(*_tmpF6));_tmp2A3.f1=_tmp2FE;});_tmp2A3;});void*_tmpE5[1U];_tmpE5[0]=& _tmpE7;({unsigned int _tmp300=e->loc;struct _dyneither_ptr _tmp2FF=({const char*_tmpE6="unbound struct/union name %s";_tag_dyneither(_tmpE6,sizeof(char),29U);});Cyc_Warn_err(_tmp300,_tmp2FF,_tag_dyneither(_tmpE5,sizeof(void*),1U));});});
...
if(Cyc_Binding_at_toplevel(env)){
({struct Cyc_Dict_Dict*_tmp302=({struct Cyc_Dict_Dict*_tmpE9=_cycalloc(sizeof(*_tmpE9));({struct Cyc_Dict_Dict _tmp301=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmpE9=_tmp301;});_tmpE9;});env->local_vars=_tmp302;});
...
# 537
({void*_tmpEB=0U;({unsigned int _tmp304=e->loc;struct _dyneither_ptr _tmp303=({const char*_tmpEC="binding: compound literals unimplemented";_tag_dyneither(_tmpEC,sizeof(char),41U);});Cyc_Warn_err(_tmp304,_tmp303,_tag_dyneither(_tmpEB,sizeof(void*),0U));});});return;case 33U: _LL4B: _tmp127=(void*)((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmpA5)->f1;_tmp126=((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmpA5)->f2;_LL4C:
# 540
...
# 553
({void*_tmpED=0U;({unsigned int _tmp306=e->loc;struct _dyneither_ptr _tmp305=({const char*_tmpEE="asm expressions cannot occur within Cyclone code";_tag_dyneither(_tmpEE,sizeof(char),49U);});Cyc_Warn_err(_tmp306,_tmp305,_tag_dyneither(_tmpED,sizeof(void*),0U));});});}_LL0:;}
# 557
...
struct Cyc_Absyn_Vardecl*_tmp141=({struct _tuple0*_tmp307=({struct _tuple0*_tmp143=_cycalloc(sizeof(*_tmp143));_tmp143->f1=Cyc_Absyn_Loc_n,_tmp143->f2=_tmp140;_tmp143;});Cyc_Absyn_new_vardecl(0U,_tmp307,_tmp144,0);});
_tmp141->tq=_tmp145;
...
if(_tmp152 == 0){
if(need_va_name)
({void*_tmp149=0U;({unsigned int _tmp309=loc;struct _dyneither_ptr _tmp308=({const char*_tmp14A="missing name for vararg";_tag_dyneither(_tmp14A,sizeof(char),24U);});Cyc_Warn_err(_tmp309,_tmp308,_tag_dyneither(_tmp149,sizeof(void*),0U));});});}else{
# 603
void*_tmp14B=Cyc_Absyn_fatptr_type(_tmp150,Cyc_Absyn_heap_rgn_type,_tmp151,Cyc_Absyn_false_type);
struct Cyc_Absyn_Vardecl*_tmp14C=({struct _tuple0*_tmp30A=({struct _tuple0*_tmp14E=_cycalloc(sizeof(*_tmp14E));_tmp14E->f1=Cyc_Absyn_Loc_n,_tmp14E->f2=_tmp152;_tmp14E;});Cyc_Absyn_new_vardecl(0U,_tmp30A,_tmp14B,0);});
...
struct _dyneither_ptr*_tmp154=({struct _dyneither_ptr*_tmp15A=_cycalloc(sizeof(*_tmp15A));({struct _dyneither_ptr _tmp30B=({const char*_tmp159="return_value";_tag_dyneither(_tmp159,sizeof(char),13U);});*_tmp15A=_tmp30B;});_tmp15A;});
struct Cyc_Absyn_Vardecl*_tmp155=({struct _tuple0*_tmp30C=({struct _tuple0*_tmp158=_cycalloc(sizeof(*_tmp158));_tmp158->f1=Cyc_Absyn_Loc_n,_tmp158->f2=_tmp154;_tmp158;});Cyc_Absyn_new_vardecl(0U,_tmp30C,rettyp,0);});
({struct Cyc_Dict_Dict _tmp310=({struct Cyc_Dict_Dict _tmp30F=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp30E=_tmp154;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp30F,_tmp30E,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp157=_cycalloc(sizeof(*_tmp157));
_tmp157->tag=0U,({void*_tmp30D=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp156=_cycalloc(sizeof(*_tmp156));_tmp156->tag=4U,_tmp156->f1=_tmp155;_tmp156;});_tmp157->f1=_tmp30D;});_tmp157;}));});
# 633
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp310;});
# 635
...
({union Cyc_Absyn_DatatypeInfo _tmp311=Cyc_Absyn_UnknownDatatype(({struct Cyc_Absyn_UnknownDatatypeInfo _tmp2A4;_tmp2A4.name=_tmp161->name,_tmp2A4.is_extensible=_tmp164;_tmp2A4;}));*_tmp1B0=_tmp311;});
_npop_handler(0U);return;}
# 653
...
struct _dyneither_ptr _tmp312=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp173->name));_tmp2A7.f1=_tmp312;});_tmp2A7;});struct Cyc_String_pa_PrintArg_struct _tmp171=({struct Cyc_String_pa_PrintArg_struct _tmp2A6;_tmp2A6.tag=0U,({
struct _dyneither_ptr _tmp313=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp16D->name));_tmp2A6.f1=_tmp313;});_tmp2A6;});struct Cyc_String_pa_PrintArg_struct _tmp172=({struct Cyc_String_pa_PrintArg_struct _tmp2A5;_tmp2A5.tag=0U,({
struct _dyneither_ptr _tmp314=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp174->name));_tmp2A5.f1=_tmp314;});_tmp2A5;});void*_tmp16E[3U];_tmp16E[0]=& _tmp170,_tmp16E[1]=& _tmp171,_tmp16E[2]=& _tmp172;({unsigned int _tmp316=loc;struct _dyneither_ptr _tmp315=({const char*_tmp16F="%s is a variant of %s, not %s (shadowing not yet implemented properly)";_tag_dyneither(_tmp16F,sizeof(char),71U);});Cyc_Warn_err(_tmp316,_tmp315,_tag_dyneither(_tmp16E,sizeof(void*),3U));});});
_npop_handler(0U);return;}
# 678
({union Cyc_Absyn_DatatypeFieldInfo _tmp317=Cyc_Absyn_UnknownDatatypefield(({struct Cyc_Absyn_UnknownDatatypeFieldInfo _tmp2A8;_tmp2A8.datatype_name=_tmp174->name,_tmp2A8.field_name=_tmp173->name,_tmp2A8.is_extensible=_tmp17A;_tmp2A8;}));*_tmp1B2=_tmp317;});
# 680
...
({struct Cyc_String_pa_PrintArg_struct _tmp179=({struct Cyc_String_pa_PrintArg_struct _tmp2A9;_tmp2A9.tag=0U,({struct _dyneither_ptr _tmp318=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp17B));_tmp2A9.f1=_tmp318;});_tmp2A9;});void*_tmp177[1U];_tmp177[0]=& _tmp179;({unsigned int _tmp31A=loc;struct _dyneither_ptr _tmp319=({const char*_tmp178="%s is not a datatype field";_tag_dyneither(_tmp178,sizeof(char),27U);});Cyc_Warn_err(_tmp31A,_tmp319,_tag_dyneither(_tmp177,sizeof(void*),1U));});});
...
({struct Cyc_String_pa_PrintArg_struct _tmp19A=({struct Cyc_String_pa_PrintArg_struct _tmp2AA;_tmp2AA.tag=0U,({struct _dyneither_ptr _tmp320=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(*_tmp1BC));_tmp2AA.f1=_tmp320;});_tmp2AA;});void*_tmp198[1U];_tmp198[0]=& _tmp19A;({unsigned int _tmp322=loc;struct _dyneither_ptr _tmp321=({const char*_tmp199="unbound typdef name %s";_tag_dyneither(_tmp199,sizeof(char),23U);});Cyc_Warn_err(_tmp322,_tmp321,_tag_dyneither(_tmp198,sizeof(void*),1U));});});
...
# 735
({struct Cyc_Binding_Env*_tmp324=env;Cyc_Binding_resolve_decl(_tmp324,({struct Cyc_Absyn_Decl*_tmp19F=_cycalloc(sizeof(*_tmp19F));({void*_tmp323=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp19E=_cycalloc(sizeof(*_tmp19E));_tmp19E->tag=5U,_tmp19E->f1=_tmp1A4;_tmp19E;});_tmp19F->r=_tmp323;}),_tmp19F->loc=_tmp1BE->loc;_tmp19F;}));});goto _LL52;case 1U: _LL55: _tmp1A5=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)_tmp19D)->f1;_LL56:
# 737
({struct Cyc_Binding_Env*_tmp326=env;Cyc_Binding_resolve_decl(_tmp326,({struct Cyc_Absyn_Decl*_tmp1A1=_cycalloc(sizeof(*_tmp1A1));({void*_tmp325=(void*)({struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*_tmp1A0=_cycalloc(sizeof(*_tmp1A0));_tmp1A0->tag=7U,_tmp1A0->f1=_tmp1A5;_tmp1A0;});_tmp1A1->r=_tmp325;}),_tmp1A1->loc=_tmp1BE->loc;_tmp1A1;}));});goto _LL52;default: _LL57: _tmp1A6=((struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)_tmp19D)->f1;_LL58:
# 739
({struct Cyc_Binding_Env*_tmp328=env;Cyc_Binding_resolve_decl(_tmp328,({struct Cyc_Absyn_Decl*_tmp1A3=_cycalloc(sizeof(*_tmp1A3));({void*_tmp327=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp1A2=_cycalloc(sizeof(*_tmp1A2));_tmp1A2->tag=6U,_tmp1A2->f1=_tmp1A6;_tmp1A2;});_tmp1A3->r=_tmp327;}),_tmp1A3->loc=_tmp1BE->loc;_tmp1A3;}));});goto _LL52;}_LL52:;}
# 741
...
if(_tmp1A9 != 0)
({struct Cyc_Dict_Dict*_tmp329=({struct Cyc_Dict_Dict*_tmp1AA=_cycalloc(sizeof(*_tmp1AA));*_tmp1AA=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));_tmp1AA;});env->local_vars=_tmp329;});else{
# 793
({struct Cyc_Dict_Dict*_tmp32B=({struct Cyc_Dict_Dict*_tmp1AB=_cycalloc(sizeof(*_tmp1AB));({struct Cyc_Dict_Dict _tmp32A=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp1AB=_tmp32A;});_tmp1AB;});env->local_vars=_tmp32B;});}
{struct Cyc_List_List*_tmp1AC=_tmp1A8;for(0;_tmp1AC != 0;_tmp1AC=_tmp1AC->tl){
({struct Cyc_Dict_Dict _tmp32F=({struct Cyc_Dict_Dict _tmp32E=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp32D=(*((struct Cyc_Absyn_Vardecl*)_tmp1AC->hd)->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp32E,_tmp32D,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp1AE=_cycalloc(sizeof(*_tmp1AE));
_tmp1AE->tag=0U,({void*_tmp32C=(void*)({struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp1AD=_cycalloc(sizeof(*_tmp1AD));_tmp1AD->tag=3U,_tmp1AD->f1=(struct Cyc_Absyn_Vardecl*)_tmp1AC->hd;_tmp1AD;});_tmp1AE->f1=_tmp32C;});_tmp1AE;}));});
# 795
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp32F;});}}
# 798
...
# 817
({void*_tmp1D1=0U;({unsigned int _tmp331=_tmp217;struct _dyneither_ptr _tmp330=({const char*_tmp1D2="struct tag used without arguments in pattern";_tag_dyneither(_tmp1D2,sizeof(char),45U);});Cyc_Warn_err(_tmp331,_tmp330,_tag_dyneither(_tmp1D1,sizeof(void*),0U));});});
...
# 820
({void*_tmp332=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp1D3=_cycalloc(sizeof(*_tmp1D3));_tmp1D3->tag=8U,_tmp1D3->f1=_tmp1D7,_tmp1D3->f2=_tmp1D6,_tmp1D3->f3=0,_tmp1D3->f4=0;_tmp1D3;});p->r=_tmp332;});_npop_handler(0U);return;case 3U: _LL33: _tmp1D9=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp1D0)->f1;_tmp1D8=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp1D0)->f2;_LL34:
# 822
({void*_tmp333=(void*)({struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*_tmp1D4=_cycalloc(sizeof(*_tmp1D4));_tmp1D4->tag=13U,_tmp1D4->f1=_tmp1D9,_tmp1D4->f2=_tmp1D8;_tmp1D4;});p->r=_tmp333;});_npop_handler(0U);return;default: _LL35: _tmp1DB=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp1D0)->f1;_tmp1DA=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp1D0)->f2;_LL36:
# 824
({void*_tmp334=(void*)({struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*_tmp1D5=_cycalloc(sizeof(*_tmp1D5));_tmp1D5->tag=14U,_tmp1D5->f1=_tmp1DB,_tmp1D5->f2=_tmp1DA;_tmp1D5;});p->r=_tmp334;});_npop_handler(0U);return;}_LL2C:;}
# 814
...
({void*_tmp336=(void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp1DF=_cycalloc(sizeof(*_tmp1DF));_tmp1DF->tag=1U,_tmp1DF->f1=_tmp1DE,({struct Cyc_Absyn_Pat*_tmp335=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0U);_tmp1DF->f2=_tmp335;});_tmp1DF;});p->r=_tmp336;});
...
_tmp1E6=({struct Cyc_List_List*_tmp1E8=_cycalloc(sizeof(*_tmp1E8));({struct _tuple13*_tmp337=({struct _tuple13*_tmp1E7=_cycalloc(sizeof(*_tmp1E7));_tmp1E7->f1=0,_tmp1E7->f2=(struct Cyc_Absyn_Pat*)_tmp205->hd;_tmp1E7;});_tmp1E8->hd=_tmp337;}),_tmp1E8->tl=_tmp1E6;_tmp1E8;});}
({void*_tmp33B=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp1EB=_cycalloc(sizeof(*_tmp1EB));_tmp1EB->tag=7U,({union Cyc_Absyn_AggrInfo*_tmp33A=({union Cyc_Absyn_AggrInfo*_tmp1EA=_cycalloc(sizeof(*_tmp1EA));({union Cyc_Absyn_AggrInfo _tmp339=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp1E9=_cycalloc(sizeof(*_tmp1E9));*_tmp1E9=_tmp1EF;_tmp1E9;}));*_tmp1EA=_tmp339;});_tmp1EA;});_tmp1EB->f1=_tmp33A;}),_tmp1EB->f2=0,({struct Cyc_List_List*_tmp338=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp1E6);_tmp1EB->f3=_tmp338;}),_tmp1EB->f4=_tmp204;_tmp1EB;});p->r=_tmp33B;});
...
# 843
({void*_tmp33C=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp1EC=_cycalloc(sizeof(*_tmp1EC));_tmp1EC->tag=8U,_tmp1EC->f1=_tmp1F1,_tmp1EC->f2=_tmp1F0,_tmp1EC->f3=_tmp205,_tmp1EC->f4=_tmp204;_tmp1EC;});p->r=_tmp33C;});_npop_handler(0U);return;case 3U: _LL43: _LL44:
 goto _LL46;default: _LL45: _LL46:
# 846
({void*_tmp1ED=0U;({unsigned int _tmp33E=_tmp217;struct _dyneither_ptr _tmp33D=({const char*_tmp1EE="enum tag used with arguments in pattern";_tag_dyneither(_tmp1EE,sizeof(char),40U);});Cyc_Warn_err(_tmp33E,_tmp33D,_tag_dyneither(_tmp1ED,sizeof(void*),0U));});});_npop_handler(0U);return;}_LL3C:;}
# 834
...
({struct Cyc_String_pa_PrintArg_struct _tmp1F6=({struct Cyc_String_pa_PrintArg_struct _tmp2AB;_tmp2AB.tag=0U,({struct _dyneither_ptr _tmp33F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp206));_tmp2AB.f1=_tmp33F;});_tmp2AB;});void*_tmp1F4[1U];_tmp1F4[0]=& _tmp1F6;({unsigned int _tmp341=_tmp217;struct _dyneither_ptr _tmp340=({const char*_tmp1F5="%s is not a constructor in pattern";_tag_dyneither(_tmp1F5,sizeof(char),35U);});Cyc_Warn_err(_tmp341,_tmp340,_tag_dyneither(_tmp1F4,sizeof(void*),1U));});});
...
({void*_tmp344=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp1FE=_cycalloc(sizeof(*_tmp1FE));_tmp1FE->tag=7U,({union Cyc_Absyn_AggrInfo*_tmp343=({union Cyc_Absyn_AggrInfo*_tmp1FD=_cycalloc(sizeof(*_tmp1FD));({union Cyc_Absyn_AggrInfo _tmp342=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp1FC=_cycalloc(sizeof(*_tmp1FC));*_tmp1FC=_tmp1FB;_tmp1FC;}));*_tmp1FD=_tmp342;});_tmp1FD;});_tmp1FE->f1=_tmp343;}),_tmp1FE->f2=_tmp209,_tmp1FE->f3=_tmp208,_tmp1FE->f4=_tmp207;_tmp1FE;});p->r=_tmp344;});}
# 855
...
# 858
({void*_tmp200=0U;({unsigned int _tmp346=_tmp217;struct _dyneither_ptr _tmp345=({const char*_tmp201="non-aggregate name has designator patterns";_tag_dyneither(_tmp201,sizeof(char),43U);});Cyc_Warn_err(_tmp346,_tmp345,_tag_dyneither(_tmp200,sizeof(void*),0U));});});
...
struct _tuple0*_tmp21B=_tmp285->name;struct _tuple0*_tmp21C=_tmp21B;union Cyc_Absyn_Nmspace _tmp22D;struct _dyneither_ptr*_tmp22C;_LL24: _tmp22D=_tmp21C->f1;_tmp22C=_tmp21C->f2;_LL25:;{
# 936
...
# 938
({struct Cyc_Core_Opt*_tmp347=({struct Cyc_Core_Opt*_tmp21E=_cycalloc(sizeof(*_tmp21E));_tmp21E->v=_tmp21D;_tmp21E;});_tmp285->param_vardecls=_tmp347;});
# 940
if(Cyc_Binding_warn_override)
...
if(_tmp21F != 0)
({struct Cyc_Dict_Dict*_tmp348=({struct Cyc_Dict_Dict*_tmp220=_cycalloc(sizeof(*_tmp220));*_tmp220=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));_tmp220;});env->local_vars=_tmp348;});else{
# 947
({struct Cyc_Dict_Dict*_tmp34A=({struct Cyc_Dict_Dict*_tmp221=_cycalloc(sizeof(*_tmp221));({struct Cyc_Dict_Dict _tmp349=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp221=_tmp349;});_tmp221;});env->local_vars=_tmp34A;});}
{struct Cyc_List_List*_tmp222=_tmp21D;for(0;_tmp222 != 0;_tmp222=_tmp222->tl){
({struct Cyc_Dict_Dict _tmp34E=({struct Cyc_Dict_Dict _tmp34D=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp34C=(*((struct Cyc_Absyn_Vardecl*)_tmp222->hd)->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp34D,_tmp34C,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp224=_cycalloc(sizeof(*_tmp224));
_tmp224->tag=0U,({void*_tmp34B=(void*)({struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp223=_cycalloc(sizeof(*_tmp223));_tmp223->tag=3U,_tmp223->f1=(struct Cyc_Absyn_Vardecl*)_tmp222->hd;_tmp223;});_tmp224->f1=_tmp34B;});_tmp224;}));});
# 949
...
if(_tmp21F != 0){
# 958
({struct Cyc_Dict_Dict _tmp352=({struct Cyc_Dict_Dict _tmp351=*_tmp21F;struct _dyneither_ptr*_tmp350=_tmp22C;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp351,_tmp350,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp226=_cycalloc(sizeof(*_tmp226));
_tmp226->tag=0U,({void*_tmp34F=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp225=_cycalloc(sizeof(*_tmp225));_tmp225->tag=2U,_tmp225->f1=_tmp285;_tmp225;});_tmp226->f1=_tmp34F;});_tmp226;}));});
# 958
*_tmp21F=_tmp352;});
# 960
({struct Cyc_Dict_Dict _tmp356=({struct Cyc_Dict_Dict _tmp355=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _dyneither_ptr*_tmp354=_tmp22C;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp355,_tmp354,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp228=_cycalloc(sizeof(*_tmp228));
_tmp228->tag=0U,({void*_tmp353=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp227=_cycalloc(sizeof(*_tmp227));_tmp227->tag=2U,_tmp227->f1=_tmp285;_tmp227;});_tmp228->f1=_tmp353;});_tmp228;}));});
# 960
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp356;});}else{
# 963
...
({struct Cyc_Dict_Dict _tmp35A=({struct Cyc_Dict_Dict _tmp359=_tmp229->ordinaries;struct _dyneither_ptr*_tmp358=_tmp22C;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp359,_tmp358,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp22B=_cycalloc(sizeof(*_tmp22B));
# 966
_tmp22B->tag=0U,({void*_tmp357=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp22A=_cycalloc(sizeof(*_tmp22A));_tmp22A->tag=2U,_tmp22A->f1=_tmp285;_tmp22A;});_tmp22B->f1=_tmp357;});_tmp22B;}));});
# 964
_tmp229->ordinaries=_tmp35A;});}
# 969
...
# 976
 if(Cyc_Binding_at_toplevel(env)){
({void*_tmp22E=0U;({unsigned int _tmp35C=loc;struct _dyneither_ptr _tmp35B=({const char*_tmp22F="let not allowed at top-level";_tag_dyneither(_tmp22F,sizeof(char),29U);});Cyc_Warn_err(_tmp35C,_tmp35B,_tag_dyneither(_tmp22E,sizeof(void*),0U));});});
goto _LL0;}
# 980
...
# 996
 if(!Cyc_Binding_at_toplevel(env)){
({void*_tmp230=0U;({unsigned int _tmp35E=loc;struct _dyneither_ptr _tmp35D=({const char*_tmp231="nested type definitions are not yet supported";_tag_dyneither(_tmp231,sizeof(char),46U);});Cyc_Warn_err(_tmp35E,_tmp35D,_tag_dyneither(_tmp230,sizeof(void*),0U));});});
goto _LL0;}
# 1000
Cyc_Binding_absolutize_decl(loc,env,_tmp28C->name,_tmp28C->extern_c?Cyc_Absyn_ExternC: Cyc_Absyn_Public);{
struct _tuple0*_tmp232=_tmp28C->name;struct _tuple0*_tmp233=_tmp232;union Cyc_Absyn_Nmspace _tmp236;struct _dyneither_ptr*_tmp235;_LL27: _tmp236=_tmp233->f1;_tmp235=_tmp233->f2;_LL28:;{
# 1003
...
# 1007
({struct Cyc_Dict_Dict _tmp35F=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Typedefdecl*v))Cyc_Dict_insert)(_tmp234->typedefs,_tmp235,_tmp28C);_tmp234->typedefs=_tmp35F;});
# 1009
goto _LL0;};};case 5U: _LLD: _tmp28D=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp21A)->f1;_LLE:
# 1012
 if(!Cyc_Binding_at_toplevel(env)){
({void*_tmp237=0U;({unsigned int _tmp361=loc;struct _dyneither_ptr _tmp360=({const char*_tmp238="nested type definitions are not yet supported";_tag_dyneither(_tmp238,sizeof(char),46U);});Cyc_Warn_err(_tmp361,_tmp360,_tag_dyneither(_tmp237,sizeof(void*),0U));});});
goto _LL0;}
# 1016
Cyc_Binding_absolutize_decl(loc,env,_tmp28D->name,_tmp28D->sc);{
struct _tuple0*_tmp239=_tmp28D->name;struct _tuple0*_tmp23A=_tmp239;union Cyc_Absyn_Nmspace _tmp242;struct _dyneither_ptr*_tmp241;_LL2A: _tmp242=_tmp23A->f1;_tmp241=_tmp23A->f2;_LL2B:;{
# 1019
...
goto _LL0;
# 1024
({struct Cyc_Dict_Dict _tmp362=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Aggrdecl*v))Cyc_Dict_insert)(_tmp23B->aggrdecls,_tmp241,_tmp28D);_tmp23B->aggrdecls=_tmp362;});
# 1026
({struct Cyc_Dict_Dict _tmp365=({struct Cyc_Dict_Dict _tmp364=_tmp23B->ordinaries;struct _dyneither_ptr*_tmp363=_tmp241;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp364,_tmp363,(void*)({struct Cyc_Binding_AggrRes_Binding_Resolved_struct*_tmp23C=_cycalloc(sizeof(*_tmp23C));
_tmp23C->tag=1U,_tmp23C->f1=_tmp28D;_tmp23C;}));});
# 1026
_tmp23B->ordinaries=_tmp365;});
# 1028
if(_tmp28D->impl != 0){
struct Cyc_Absyn_AggrdeclImpl*_tmp23D=(struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp28D->impl);struct Cyc_Absyn_AggrdeclImpl*_tmp23E=_tmp23D;struct Cyc_List_List*_tmp240;struct Cyc_List_List*_tmp23F;_LL2D: _tmp240=_tmp23E->rgn_po;_tmp23F=_tmp23E->fields;_LL2E:;
...
# 1036
 if(!Cyc_Binding_at_toplevel(env)){
({void*_tmp243=0U;({unsigned int _tmp367=loc;struct _dyneither_ptr _tmp366=({const char*_tmp244="nested type definitions are not yet supported";_tag_dyneither(_tmp244,sizeof(char),46U);});Cyc_Warn_err(_tmp367,_tmp366,_tag_dyneither(_tmp243,sizeof(void*),0U));});});
goto _LL0;}
# 1040
Cyc_Binding_absolutize_decl(loc,env,_tmp28E->name,_tmp28E->sc);{
struct _tuple0*_tmp245=_tmp28E->name;struct _tuple0*_tmp246=_tmp245;union Cyc_Absyn_Nmspace _tmp24B;struct _dyneither_ptr*_tmp24A;_LL30: _tmp24B=_tmp246->f1;_tmp24A=_tmp246->f2;_LL31:;{
# 1043
...
goto _LL0;
# 1049
({struct Cyc_Dict_Dict _tmp368=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Enumdecl*v))Cyc_Dict_insert)(_tmp247->enumdecls,_tmp24A,_tmp28E);_tmp247->enumdecls=_tmp368;});
# 1051
if(_tmp28E->fields != 0){
# 1053
...
({struct Cyc_Dict_Dict _tmp36B=({struct Cyc_Dict_Dict _tmp36A=_tmp247->ordinaries;struct _dyneither_ptr*_tmp369=(*_tmp248->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp36A,_tmp369,(void*)({struct Cyc_Binding_EnumRes_Binding_Resolved_struct*_tmp249=_cycalloc(sizeof(*_tmp249));
# 1060
_tmp249->tag=3U,_tmp249->f1=_tmp28E,_tmp249->f2=_tmp248;_tmp249;}));});
# 1058
_tmp247->ordinaries=_tmp36B;});}}
# 1062
...
struct _tuple0*_tmp252=_tmp28F->name;struct _tuple0*_tmp253=_tmp252;union Cyc_Absyn_Nmspace _tmp257;struct _dyneither_ptr*_tmp256;_LL33: _tmp257=_tmp253->f1;_tmp256=_tmp253->f2;_LL34:;{
...
({struct Cyc_Dict_Dict _tmp36E=({struct Cyc_Dict_Dict _tmp36D=_tmp254->datatypedecls;struct _dyneither_ptr*_tmp36C=_tmp256;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_List_List*v))Cyc_Dict_insert)(_tmp36D,_tmp36C,({struct Cyc_List_List*_tmp255=_cycalloc(sizeof(*_tmp255));
_tmp255->hd=_tmp28F,_tmp255->tl=_tmp24F;_tmp255;}));});
# 1075
_tmp254->datatypedecls=_tmp36E;});};};}
# 1067
;_pop_handler();}else{void*_tmp24D=(void*)_exn_thrown;void*_tmp258=_tmp24D;void*_tmp25F;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp258)->tag == Cyc_Binding_BindingError){_LL36: _LL37:
# 1079
 Cyc_Binding_absolutize_topdecl(loc,env,_tmp28F->name,_tmp28F->sc);{
struct _tuple0*_tmp259=_tmp28F->name;struct _tuple0*_tmp25A=_tmp259;union Cyc_Absyn_Nmspace _tmp25E;struct _dyneither_ptr*_tmp25D;_LL3B: _tmp25E=_tmp25A->f1;_tmp25D=_tmp25A->f2;_LL3C:;{
...
# 1085
goto _LL35;
({struct Cyc_Dict_Dict _tmp371=({struct Cyc_Dict_Dict _tmp370=_tmp25B->datatypedecls;struct _dyneither_ptr*_tmp36F=_tmp25D;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_List_List*v))Cyc_Dict_insert)(_tmp370,_tmp36F,({struct Cyc_List_List*_tmp25C=_cycalloc(sizeof(*_tmp25C));
_tmp25C->hd=_tmp28F,_tmp25C->tl=0;_tmp25C;}));});
# 1086
_tmp25B->datatypedecls=_tmp371;});
# 1088
goto _LL35;};};}else{_LL38: _tmp25F=_tmp258;_LL39:(int)_rethrow(_tmp25F);}_LL35:;}};}{
# 1091
struct _tuple0*_tmp260=_tmp28F->name;struct _tuple0*_tmp261=_tmp260;union Cyc_Absyn_Nmspace _tmp26E;struct _dyneither_ptr*_tmp26D;_LL3E: _tmp26E=_tmp261->f1;_tmp26D=_tmp261->f2;_LL3F:;
if(_tmp28F->fields != 0){
...
{union Cyc_Absyn_Nmspace _tmp265=(*_tmp263->name).f1;union Cyc_Absyn_Nmspace _tmp266=_tmp265;switch((_tmp266.Abs_n).tag){case 1U: if((_tmp266.Rel_n).val == 0){_LL41: _LL42:
# 1099
 if(_tmp28F->is_extensible)
({union Cyc_Absyn_Nmspace _tmp372=Cyc_Absyn_Abs_n((env->ns)->curr_ns,0);(*_tmp263->name).f1=_tmp372;});else{
# 1102
(*_tmp263->name).f1=(*_tmp28F->name).f1;}
goto _LL40;}else{_LL43: _LL44:
# 1105
({void*_tmp267=0U;({unsigned int _tmp374=_tmp263->loc;struct _dyneither_ptr _tmp373=({const char*_tmp268="qualified datatype field declaratations are not allowed";_tag_dyneither(_tmp268,sizeof(char),56U);});Cyc_Warn_err(_tmp374,_tmp373,_tag_dyneither(_tmp267,sizeof(void*),0U));});});
return;}case 2U: _LL45: _LL46:
 goto _LL40;default: _LL47: _LL48:
({void*_tmp269=0U;({struct _dyneither_ptr _tmp375=({const char*_tmp26A="datatype field Loc_n or C_n";_tag_dyneither(_tmp26A,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp375,_tag_dyneither(_tmp269,sizeof(void*),0U));});});}_LL40:;}{
# 1110
...
({struct Cyc_Dict_Dict _tmp378=({struct Cyc_Dict_Dict _tmp377=_tmp26B->ordinaries;struct _dyneither_ptr*_tmp376=(*_tmp263->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp377,_tmp376,(void*)({struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*_tmp26C=_cycalloc(sizeof(*_tmp26C));
# 1113
_tmp26C->tag=2U,_tmp26C->f1=_tmp28F,_tmp26C->f2=_tmp263;_tmp26C;}));});
# 1111
_tmp26B->ordinaries=_tmp378;});};}}
# 1115
...
struct _tuple15*_tmp271=(struct _tuple15*)_tmp270->hd;struct _tuple15*_tmp272=_tmp271;unsigned int _tmp274;struct _tuple0*_tmp273;_LL4A: _tmp274=_tmp272->f1;_tmp273=_tmp272->f2;_LL4B:;
Cyc_Binding_absolutize_decl(_tmp274,env,_tmp273,Cyc_Absyn_ExternC);}}
# 1148
if(!Cyc_Binding_at_toplevel(env)){
({void*_tmp275=0U;({unsigned int _tmp37A=loc;struct _dyneither_ptr _tmp379=({const char*_tmp276="extern \"C include\" not at toplevel";_tag_dyneither(_tmp276,sizeof(char),35U);});Cyc_Warn_err(_tmp37A,_tmp379,_tag_dyneither(_tmp275,sizeof(void*),0U));});});
goto _LL0;}{
# 1153
...
struct _tuple15*_tmp27D=(struct _tuple15*)_tmp27C->hd;struct _tuple15*_tmp27E=_tmp27D;unsigned int _tmp283;struct _dyneither_ptr*_tmp282;_LL4D: _tmp283=_tmp27E->f1;_tmp282=(_tmp27E->f2)->f2;_LL4E:;
...
void*_tmp37B=((void*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp278,_tmp282);_tmp37B == ((void*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp27A,_tmp282);}))
({struct Cyc_String_pa_PrintArg_struct _tmp281=({struct Cyc_String_pa_PrintArg_struct _tmp2AC;_tmp2AC.tag=0U,_tmp2AC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp282);_tmp2AC;});void*_tmp27F[1U];_tmp27F[0]=& _tmp281;({unsigned int _tmp37D=_tmp283;struct _dyneither_ptr _tmp37C=({const char*_tmp280="%s is exported but not defined";_tag_dyneither(_tmp280,sizeof(char),31U);});Cyc_Warn_err(_tmp37D,_tmp37C,_tag_dyneither(_tmp27F,sizeof(void*),1U));});});
_tmp27B=({struct Cyc_Dict_Dict _tmp37F=_tmp27B;struct _dyneither_ptr*_tmp37E=_tmp282;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,void*v))Cyc_Dict_insert)(_tmp37F,_tmp37E,((void*(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp27A,_tmp282));});}}
# 1168
...
struct Cyc_Binding_Env*_tmp297=({struct Cyc_Binding_Env*_tmp29A=_cycalloc(sizeof(*_tmp29A));_tmp29A->in_cinclude=0,({struct Cyc_Binding_NSCtxt*_tmp380=((struct Cyc_Binding_NSCtxt*(*)(int env,struct Cyc_Binding_ResolveNSEnv*(*mkdata)(int)))Cyc_Binding_mt_nsctxt)(1,Cyc_Binding_mt_renv);_tmp29A->ns=_tmp380;}),_tmp29A->local_vars=0;_tmp29A;});
({struct Cyc_Binding_Env*_tmp382=_tmp297;Cyc_Binding_resolve_decl(_tmp382,({struct Cyc_Absyn_Decl*_tmp299=_cycalloc(sizeof(*_tmp299));({void*_tmp381=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp298=_cycalloc(sizeof(*_tmp298));_tmp298->tag=6U,_tmp298->f1=Cyc_Absyn_exn_tud;_tmp298;});_tmp299->r=_tmp381;}),_tmp299->loc=0U;_tmp299;}));});
