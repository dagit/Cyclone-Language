...
# 66
extern struct _fat_ptr Cyc_str_sepstr(struct Cyc_List_List*,struct _fat_ptr);struct Cyc_Iter_Iter{void*env;int(*next)(void*env,void*dest);};struct Cyc_Dict_T;struct Cyc_Dict_Dict{int(*rel)(void*,void*);struct _RegionHandle*r;const struct Cyc_Dict_T*t;};extern char Cyc_Dict_Present[8U];struct Cyc_Dict_Present_exn_struct{char*tag;};extern char Cyc_Dict_Absent[7U];struct Cyc_Dict_Absent_exn_struct{char*tag;};
# 62 "dict.h"
...
# 101
extern struct Cyc_Dict_Dict Cyc_Dict_singleton(int(*cmp)(void*,void*),void*k,void*v);
# 110
...
struct Cyc_List_List*_tmp315=({struct Cyc_List_List*_tmp2=_cycalloc(sizeof(*_tmp2));({void*_tmp314=(void*)({struct Cyc_Binding_Namespace_Binding_NSDirective_struct*_tmp1=_cycalloc(sizeof(*_tmp1));_tmp1->tag=0U,_tmp1->f1=0;_tmp1;});_tmp2->hd=_tmp314;}),_tmp2->tl=0;_tmp2;});_tmp3->availables=_tmp315;}),({
struct Cyc_Dict_Dict _tmp313=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct Cyc_List_List*,struct Cyc_List_List*),struct Cyc_List_List*k,void*v))Cyc_Dict_singleton)(Cyc_Absyn_varlist_cmp,0,data);_tmp3->ns_data=_tmp313;});_tmp3;});}
# 63
...
({void*_tmp7=0U;({struct _fat_ptr _tmp316=({const char*_tmp8="Binding:get_ns_data: relative ns";_tag_fat(_tmp8,sizeof(char),33U);});Cyc_Warn_impos(_tmp316,_tag_fat(_tmp7,sizeof(void*),0U));});});}_LL0:;}
# 81 "binding.cyc"
...
goto _LL0;}}_LL0:;}}
# 96
({struct Cyc_Warn_String_Warn_Warg_struct _tmp11=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E5;_tmp2E5.tag=0U,({struct _fat_ptr _tmp317=({const char*_tmp16="namespace ";_tag_fat(_tmp16,sizeof(char),11U);});_tmp2E5.f1=_tmp317;});_tmp2E5;});struct Cyc_Warn_String_Warn_Warg_struct _tmp12=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E4;_tmp2E4.tag=0U,({struct _fat_ptr _tmp319=(struct _fat_ptr)({struct Cyc_List_List*_tmp318=rel_ns;Cyc_str_sepstr(_tmp318,({const char*_tmp15="::";_tag_fat(_tmp15,sizeof(char),3U);}));});_tmp2E4.f1=_tmp319;});_tmp2E4;});struct Cyc_Warn_String_Warn_Warg_struct _tmp13=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E3;_tmp2E3.tag=0U,({struct _fat_ptr _tmp31A=({const char*_tmp14=" not found";_tag_fat(_tmp14,sizeof(char),11U);});_tmp2E3.f1=_tmp31A;});_tmp2E3;});void*_tmp10[3U];_tmp10[0]=& _tmp11,_tmp10[1]=& _tmp12,_tmp10[2]=& _tmp13;({unsigned _tmp31B=loc;Cyc_Warn_err2(_tmp31B,_tag_fat(_tmp10,sizeof(void*),3U));});});
...
void*_tmp35=({void*(*_tmp321)(void*,struct _fat_ptr*)=lookup;void*_tmp320=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,abs_ns);_tmp321(_tmp320,v);});_npop_handler(0U);return _tmp35;}
# 118
...
# 123
struct _handler_cons _tmp39;_push_handler(& _tmp39);{int _tmp3B=0;if(setjmp(_tmp39.handler))_tmp3B=1;if(!_tmp3B){{void*_tmp3C=({void*(*_tmp323)(void*,struct _fat_ptr*)=lookup;void*_tmp322=((void*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(ctxt->ns_data,ns);_tmp323(_tmp322,v);});_npop_handler(0U);return _tmp3C;};_pop_handler();}else{void*_tmp3A=(void*)Cyc_Core_get_exn_thrown();void*_tmp3D=_tmp3A;void*_tmp3E;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp3D)->tag == Cyc_Dict_Absent){_LL23: _LL24:
...
({void*_tmp40=0U;({struct _fat_ptr _tmp324=({const char*_tmp41="lookup local in global";_tag_fat(_tmp41,sizeof(char),23U);});Cyc_Warn_impos(_tmp324,_tag_fat(_tmp40,sizeof(void*),0U));});});}_LL3:;}}
# 129
...
struct Cyc_List_List*_tmp43=({struct Cyc_List_List*_tmp325=ns;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp325,({struct Cyc_List_List*_tmp46=_cycalloc(sizeof(*_tmp46));_tmp46->hd=subname,_tmp46->tl=0;_tmp46;}));});struct Cyc_List_List*ns2=_tmp43;
if(!((int(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_member)(ctxt->ns_data,ns2))
({struct Cyc_Dict_Dict _tmp328=({struct Cyc_Dict_Dict _tmp327=ctxt->ns_data;struct Cyc_List_List*_tmp326=ns2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k,void*v))Cyc_Dict_insert)(_tmp327,_tmp326,mkdata(env));});ctxt->ns_data=_tmp328;});
ctxt->curr_ns=ns2;
({struct Cyc_List_List*_tmp32A=({struct Cyc_List_List*_tmp45=_cycalloc(sizeof(*_tmp45));({void*_tmp329=(void*)({struct Cyc_Binding_Namespace_Binding_NSDirective_struct*_tmp44=_cycalloc(sizeof(*_tmp44));_tmp44->tag=0U,_tmp44->f1=ns2;_tmp44;});_tmp45->hd=_tmp329;}),_tmp45->tl=ctxt->availables;_tmp45;});ctxt->availables=_tmp32A;});}
# 137
void Cyc_Binding_leave_ns(struct Cyc_Binding_NSCtxt*ctxt){
if(ctxt->availables == 0)
({void*_tmp47=0U;({struct _fat_ptr _tmp32B=({const char*_tmp48="leaving topmost namespace";_tag_fat(_tmp48,sizeof(char),26U);});Cyc_Warn_impos(_tmp32B,_tag_fat(_tmp47,sizeof(void*),0U));});});{
...
({struct Cyc_List_List*_tmp32C=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(((struct Cyc_List_List*)_check_null(((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_rev)(ctxt->curr_ns)))->tl);ctxt->curr_ns=_tmp32C;});
goto _LL0;}else{_LL3: _LL4:
# 146
({void*_tmp4B=0U;({struct _fat_ptr _tmp32D=({const char*_tmp4C="leaving using as namespace";_tag_fat(_tmp4C,sizeof(char),27U);});Cyc_Warn_impos(_tmp32D,_tag_fat(_tmp4B,sizeof(void*),0U));});});}_LL0:;}}
# 149
struct Cyc_List_List*Cyc_Binding_enter_using(unsigned loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*usename){
...
# 154
ns=({unsigned _tmp330=loc;struct Cyc_Binding_NSCtxt*_tmp32F=ctxt;Cyc_Binding_resolve_rel_ns(_tmp330,_tmp32F,({struct Cyc_List_List*_tmp32E=vs;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp32E,({struct Cyc_List_List*_tmp53=_cycalloc(sizeof(*_tmp53));_tmp53->hd=v,_tmp53->tl=0;_tmp53;}));}));});{
...
# 159
ns=({struct Cyc_List_List*_tmp332=vs;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp332,({struct Cyc_List_List*_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55->hd=v,_tmp55->tl=0;_tmp55;}));});
goto _LL3;}case 4U: _LL8: _LL9:
({void*_tmp56=0U;({struct _fat_ptr _tmp333=({const char*_tmp57="enter_using, Loc_n";_tag_fat(_tmp57,sizeof(char),19U);});Cyc_Warn_impos(_tmp333,_tag_fat(_tmp56,sizeof(void*),0U));});});default: _LLA: _LLB:
({void*_tmp58=0U;({struct _fat_ptr _tmp334=({const char*_tmp59="enter_using, C_n";_tag_fat(_tmp59,sizeof(char),17U);});Cyc_Warn_impos(_tmp334,_tag_fat(_tmp58,sizeof(void*),0U));});});}_LL3:;}
# 164
({struct Cyc_List_List*_tmp336=({struct Cyc_List_List*_tmp5B=_cycalloc(sizeof(*_tmp5B));({void*_tmp335=(void*)({struct Cyc_Binding_Using_Binding_NSDirective_struct*_tmp5A=_cycalloc(sizeof(*_tmp5A));_tmp5A->tag=1U,_tmp5A->f1=ns;_tmp5A;});_tmp5B->hd=_tmp335;}),_tmp5B->tl=ctxt->availables;_tmp5B;});ctxt->availables=_tmp336;});
return ns;}}
# 167
void Cyc_Binding_leave_using(struct Cyc_Binding_NSCtxt*ctxt){
if(ctxt->availables == 0)
({void*_tmp5C=0U;({struct _fat_ptr _tmp337=({const char*_tmp5D="leaving topmost namespace as a using";_tag_fat(_tmp5D,sizeof(char),37U);});Cyc_Warn_impos(_tmp337,_tag_fat(_tmp5C,sizeof(void*),0U));});});{
...
return({struct Cyc_Binding_ResolveNSEnv*_tmp62=_cycalloc(sizeof(*_tmp62));({struct Cyc_Dict_Dict _tmp33D=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp62->aggrdecls=_tmp33D;}),({
struct Cyc_Dict_Dict _tmp33C=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp62->datatypedecls=_tmp33C;}),({
struct Cyc_Dict_Dict _tmp33B=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp62->enumdecls=_tmp33B;}),({
struct Cyc_Dict_Dict _tmp33A=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp62->typedefs=_tmp33A;}),({
struct Cyc_Dict_Dict _tmp339=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);_tmp62->ordinaries=_tmp339;});_tmp62;});}
# 226
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp6B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E8;_tmp2E8.tag=0U,({struct _fat_ptr _tmp340=({const char*_tmp6F="qualified names in declarations unimplemented (";_tag_fat(_tmp6F,sizeof(char),48U);});_tmp2E8.f1=_tmp340;});_tmp2E8;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp6C=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2E7;_tmp2E7.tag=1U,_tmp2E7.f1=qv;_tmp2E7;});struct Cyc_Warn_String_Warn_Warg_struct _tmp6D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E6;_tmp2E6.tag=0U,({struct _fat_ptr _tmp341=({const char*_tmp6E=")";_tag_fat(_tmp6E,sizeof(char),2U);});_tmp2E6.f1=_tmp341;});_tmp2E6;});void*_tmp6A[3U];_tmp6A[0]=& _tmp6B,_tmp6A[1]=& _tmp6C,_tmp6A[2]=& _tmp6D;({unsigned _tmp342=loc;Cyc_Warn_err2(_tmp342,_tag_fat(_tmp6A,sizeof(void*),3U));});});}_LL0:;}
# 292
...
({void*_tmp7D=0U;({struct _fat_ptr _tmp343=({const char*_tmp7E="shadowing free variable!";_tag_fat(_tmp7E,sizeof(char),25U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp343,_tag_fat(_tmp7D,sizeof(void*),0U));});});}_LLB:;}
# 314
...
# 320
({struct Cyc_Warn_String_Warn_Warg_struct _tmp83=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EA;_tmp2EA.tag=0U,({struct _fat_ptr _tmp344=({const char*_tmp85="declaration hides ";_tag_fat(_tmp85,sizeof(char),19U);});_tmp2EA.f1=_tmp344;});_tmp2EA;});struct Cyc_Warn_String_Warn_Warg_struct _tmp84=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E9;_tmp2E9.tag=0U,_tmp2E9.f1=hides_what;_tmp2E9;});void*_tmp82[2U];_tmp82[0]=& _tmp83,_tmp82[1]=& _tmp84;({unsigned _tmp345=loc;Cyc_Warn_warn2(_tmp345,_tag_fat(_tmp82,sizeof(void*),2U));});});
_npop_handler(0U);return;
# 302
...
if(!Cyc_Binding_at_toplevel(env))
({struct Cyc_Dict_Dict _tmp349=({struct Cyc_Dict_Dict _tmp348=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _fat_ptr*_tmp347=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp348,_tmp347,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp8D=_cycalloc(sizeof(*_tmp8D));
_tmp8D->tag=0U,({void*_tmp346=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp8C=_cycalloc(sizeof(*_tmp8C));_tmp8C->tag=4U,_tmp8C->f1=vd;_tmp8C;});_tmp8D->f1=_tmp346;});_tmp8D;}));});
# 332
...
({struct Cyc_Dict_Dict _tmp34D=({struct Cyc_Dict_Dict _tmp34C=decl_ns_data->ordinaries;struct _fat_ptr*_tmp34B=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp34C,_tmp34B,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp90=_cycalloc(sizeof(*_tmp90));
# 338
_tmp90->tag=0U,({void*_tmp34A=(void*)({struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp8F=_cycalloc(sizeof(*_tmp8F));_tmp8F->tag=1U,_tmp8F->f1=vd;_tmp8F;});_tmp90->f1=_tmp34A;});_tmp90;}));});
# 336
...
# 387
({struct Cyc_Warn_String_Warn_Warg_struct _tmp10F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EE;_tmp2EE.tag=0U,({struct _fat_ptr _tmp353=({const char*_tmp111="undeclared identifier ";_tag_fat(_tmp111,sizeof(char),23U);});_tmp2EE.f1=_tmp353;});_tmp2EE;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp110=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2ED;_tmp2ED.tag=1U,_tmp2ED.f1=q;_tmp2ED;});void*_tmp10E[2U];_tmp10E[0]=& _tmp10F,_tmp10E[1]=& _tmp110;({unsigned _tmp354=e->loc;Cyc_Warn_err2(_tmp354,_tag_fat(_tmp10E,sizeof(void*),2U));});});return;}else{_LL6A: _tmp10D=_tmp10C;_LL6B: {void*exn=_tmp10D;(int)_rethrow(exn);}}_LL67:;}}}}else{_LL5A: _LL5B:
# 389
 return;}_LL57:;}case 10U: _LL3: _tmpF1=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpF2=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_tmpF3=(int*)&((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmpAC)->f4;_LL4: {struct Cyc_Absyn_Exp*e1=_tmpF1;struct Cyc_List_List*es=_tmpF2;int*b=_tmpF3;
# 392
*b=1;
# 394
...
void*_tmp113=e1->r;void*_stmttmpB=_tmp113;void*_tmp114=_stmttmpB;void**_tmp115;if(((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp114)->tag == 1U){_LL6D: _tmp115=(void**)&((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp114)->f1;_LL6E: {void**b=_tmp115;
# 398
void*_tmp116=*b;void*_stmttmpC=_tmp116;void*_tmp117=_stmttmpC;struct _tuple0*_tmp118;if(((struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*)_tmp117)->tag == 0U){_LL72: _tmp118=((struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*)_tmp117)->f1;_LL73: {struct _tuple0*q=_tmp118;
# 400
struct _handler_cons _tmp119;_push_handler(& _tmp119);{int _tmp11B=0;if(setjmp(_tmp119.handler))_tmp11B=1;if(!_tmp11B){{void*_tmp11C=Cyc_Binding_lookup_ordinary(e1->loc,env,q);void*_stmttmpD=_tmp11C;void*_tmp11D=_stmttmpD;struct Cyc_Absyn_Datatypefield*_tmp11F;struct Cyc_Absyn_Datatypedecl*_tmp11E;struct Cyc_Absyn_Aggrdecl*_tmp120;void*_tmp121;switch(*((int*)_tmp11D)){case 0U: _LL77: _tmp121=(void*)((struct Cyc_Binding_VarRes_Binding_Resolved_struct*)_tmp11D)->f1;_LL78: {void*bnd=_tmp121;
# 402
*b=bnd;_npop_handler(0U);return;}case 1U: _LL79: _tmp120=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmp11D)->f1;_LL7A: {struct Cyc_Absyn_Aggrdecl*ad=_tmp120;
# 404
...
({void*_tmp357=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp125=_cycalloc(sizeof(*_tmp125));_tmp125->tag=29U,_tmp125->f1=ad->name,_tmp125->f2=0,({struct Cyc_List_List*_tmp356=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);_tmp125->f3=_tmp356;}),_tmp125->f4=ad;_tmp125;});e->r=_tmp357;});
_npop_handler(0U);return;}case 2U: _LL7B: _tmp11E=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp11D)->f1;_tmp11F=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp11D)->f2;_LL7C: {struct Cyc_Absyn_Datatypedecl*tud=_tmp11E;struct Cyc_Absyn_Datatypefield*tuf=_tmp11F;
# 410
if(tuf->typs == 0)
# 412
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp127=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F0;_tmp2F0.tag=1U,_tmp2F0.f1=tuf->name;_tmp2F0;});struct Cyc_Warn_String_Warn_Warg_struct _tmp128=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EF;_tmp2EF.tag=0U,({struct _fat_ptr _tmp358=({const char*_tmp129=" is a constant, not a function";_tag_fat(_tmp129,sizeof(char),31U);});_tmp2EF.f1=_tmp358;});_tmp2EF;});void*_tmp126[2U];_tmp126[0]=& _tmp127,_tmp126[1]=& _tmp128;({unsigned _tmp359=e->loc;Cyc_Warn_err2(_tmp359,_tag_fat(_tmp126,sizeof(void*),2U));});});
({void*_tmp35A=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmp12A=_cycalloc(sizeof(*_tmp12A));_tmp12A->tag=31U,_tmp12A->f1=es,_tmp12A->f2=tud,_tmp12A->f3=tuf;_tmp12A;});e->r=_tmp35A;});
_npop_handler(0U);return;}case 4U: _LL7D: _LL7E:
 goto _LL80;default: _LL7F: _LL80:
# 417
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp12C=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F2;_tmp2F2.tag=1U,_tmp2F2.f1=q;_tmp2F2;});struct Cyc_Warn_String_Warn_Warg_struct _tmp12D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F1;_tmp2F1.tag=0U,({struct _fat_ptr _tmp35B=({const char*_tmp12E=" is an enum constructor, not a function";_tag_fat(_tmp12E,sizeof(char),40U);});_tmp2F1.f1=_tmp35B;});_tmp2F1;});void*_tmp12B[2U];_tmp12B[0]=& _tmp12C,_tmp12B[1]=& _tmp12D;({unsigned _tmp35C=e->loc;Cyc_Warn_err2(_tmp35C,_tag_fat(_tmp12B,sizeof(void*),2U));});});_npop_handler(0U);return;}_LL76:;}
# 400
...
({struct Cyc_Absyn_Aggrdecl*_tmp35F=((struct Cyc_Absyn_Aggrdecl*(*)(unsigned loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_Absyn_Aggrdecl*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _fat_ptr*)))Cyc_Binding_resolve_lookup)(e->loc,env->ns,*tn,Cyc_Binding_lookup_aggrdecl);*adopt=_tmp35F;});
...
# 434
({struct Cyc_Warn_String_Warn_Warg_struct _tmp13B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F6;_tmp2F6.tag=0U,({struct _fat_ptr _tmp360=({const char*_tmp13D="unbound struct/union name ";_tag_fat(_tmp13D,sizeof(char),27U);});_tmp2F6.f1=_tmp360;});_tmp2F6;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp13C=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F5;_tmp2F5.tag=1U,_tmp2F5.f1=*tn;_tmp2F5;});void*_tmp13A[2U];_tmp13A[0]=& _tmp13B,_tmp13A[1]=& _tmp13C;({unsigned _tmp361=e->loc;Cyc_Warn_err2(_tmp361,_tag_fat(_tmp13A,sizeof(void*),2U));});});
return;}else{_LL89: _tmp139=_tmp138;_LL8A: {void*exn=_tmp139;(int)_rethrow(exn);}}_LL86:;}}}}case 27U: _LL7: _tmpEA=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpEB=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_tmpEC=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpAC)->f3;_LL8: {struct Cyc_Absyn_Vardecl*vd=_tmpEA;struct Cyc_Absyn_Exp*e1=_tmpEB;struct Cyc_Absyn_Exp*e2=_tmpEC;
# 439
Cyc_Binding_resolve_exp(env,e1);
if(Cyc_Binding_at_toplevel(env)){
({struct Cyc_Dict_Dict*_tmp363=({struct Cyc_Dict_Dict*_tmp13E=_cycalloc(sizeof(*_tmp13E));({struct Cyc_Dict_Dict _tmp362=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp13E=_tmp362;});_tmp13E;});env->local_vars=_tmp363;});
...
Cyc_Binding_resolve_exp(env,e2);
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=old_locals;
return;}}case 36U: _LL9: _tmpE9=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LLA: {struct Cyc_List_List*dles=_tmpE9;
# 455
for(0;dles != 0;dles=dles->tl){
Cyc_Binding_resolve_exp(env,(*((struct _tuple11*)dles->hd)).f2);}
return;}case 28U: _LLB: _tmpE7=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpE8=(void*)((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LLC: {struct Cyc_Absyn_Exp*e1=_tmpE7;void*t=_tmpE8;
# 461
Cyc_Binding_resolve_exp(env,e1);
...
# 465
 ...
 return;case 24U: _LL11: _tmpE6=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL12: {struct Cyc_List_List*es=_tmpE6;
# 468
_tmpE5=es;goto _LL14;}case 3U: _LL13: _tmpE5=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL14: {struct Cyc_List_List*es=_tmpE5;
# 470
for(0;es != 0;es=es->tl){
Cyc_Binding_resolve_exp(env,(struct Cyc_Absyn_Exp*)es->hd);}
return;}case 42U: _LL15: _tmpE4=((struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL16: {struct Cyc_Absyn_Exp*e1=_tmpE4;
# 474
_tmpE3=e1;goto _LL18;}case 41U: _LL17: _tmpE3=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL18: {struct Cyc_Absyn_Exp*e1=_tmpE3;
_tmpE2=e1;goto _LL1A;}case 38U: _LL19: _tmpE2=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL1A: {struct Cyc_Absyn_Exp*e1=_tmpE2;
_tmpE1=e1;goto _LL1C;}case 12U: _LL1B: _tmpE1=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL1C: {struct Cyc_Absyn_Exp*e1=_tmpE1;
_tmpE0=e1;goto _LL1E;}case 18U: _LL1D: _tmpE0=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL1E: {struct Cyc_Absyn_Exp*e1=_tmpE0;
_tmpDF=e1;goto _LL20;}case 11U: _LL1F: _tmpDF=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL20: {struct Cyc_Absyn_Exp*e1=_tmpDF;
_tmpDE=e1;goto _LL22;}case 5U: _LL21: _tmpDE=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL22: {struct Cyc_Absyn_Exp*e1=_tmpDE;
_tmpDD=e1;goto _LL24;}case 22U: _LL23: _tmpDD=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL24: {struct Cyc_Absyn_Exp*e1=_tmpDD;
_tmpDC=e1;goto _LL26;}case 21U: _LL25: _tmpDC=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL26: {struct Cyc_Absyn_Exp*e1=_tmpDC;
_tmpDB=e1;goto _LL28;}case 15U: _LL27: _tmpDB=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL28: {struct Cyc_Absyn_Exp*e1=_tmpDB;
_tmpDA=e1;goto _LL2A;}case 20U: _LL29: _tmpDA=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL2A: {struct Cyc_Absyn_Exp*e1=_tmpDA;
Cyc_Binding_resolve_exp(env,e1);return;}case 35U: _LL2B: _tmpD8=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpD9=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL2C: {struct Cyc_Absyn_Exp*e1=_tmpD8;struct Cyc_Absyn_Exp*e2=_tmpD9;
# 486
_tmpD6=e1;_tmpD7=e2;goto _LL2E;}case 9U: _LL2D: _tmpD6=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpD7=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL2E: {struct Cyc_Absyn_Exp*e1=_tmpD6;struct Cyc_Absyn_Exp*e2=_tmpD7;
_tmpD4=e1;_tmpD5=e2;goto _LL30;}case 4U: _LL2F: _tmpD4=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpD5=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpAC)->f3;_LL30: {struct Cyc_Absyn_Exp*e1=_tmpD4;struct Cyc_Absyn_Exp*e2=_tmpD5;
_tmpD2=e1;_tmpD3=e2;goto _LL32;}case 23U: _LL31: _tmpD2=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpD3=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL32: {struct Cyc_Absyn_Exp*e1=_tmpD2;struct Cyc_Absyn_Exp*e2=_tmpD3;
_tmpD0=e1;_tmpD1=e2;goto _LL34;}case 7U: _LL33: _tmpD0=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpD1=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL34: {struct Cyc_Absyn_Exp*e1=_tmpD0;struct Cyc_Absyn_Exp*e2=_tmpD1;
_tmpCE=e1;_tmpCF=e2;goto _LL36;}case 8U: _LL35: _tmpCE=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpCF=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL36: {struct Cyc_Absyn_Exp*e1=_tmpCE;struct Cyc_Absyn_Exp*e2=_tmpCF;
Cyc_Binding_resolve_exp(env,e1);Cyc_Binding_resolve_exp(env,e2);return;}case 34U: _LL37: _tmpCB=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpAC)->f1).rgn;_tmpCC=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpAC)->f1).elt_type;_tmpCD=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpAC)->f1).num_elts;_LL38: {struct Cyc_Absyn_Exp*eo=_tmpCB;void**to=_tmpCC;struct Cyc_Absyn_Exp*e1=_tmpCD;
# 494
if(eo != 0)Cyc_Binding_resolve_exp(env,eo);
if(to != 0)Cyc_Binding_resolve_type(e->loc,env,*to);
Cyc_Binding_resolve_exp(env,e1);
return;}case 16U: _LL39: _tmpC9=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpCA=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL3A: {struct Cyc_Absyn_Exp*eo=_tmpC9;struct Cyc_Absyn_Exp*e2=_tmpCA;
# 500
if(eo != 0)Cyc_Binding_resolve_exp(env,eo);
Cyc_Binding_resolve_exp(env,e2);
return;}case 6U: _LL3B: _tmpC6=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpC7=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_tmpC8=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpAC)->f3;_LL3C: {struct Cyc_Absyn_Exp*e1=_tmpC6;struct Cyc_Absyn_Exp*e2=_tmpC7;struct Cyc_Absyn_Exp*e3=_tmpC8;
# 505
Cyc_Binding_resolve_exp(env,e1);Cyc_Binding_resolve_exp(env,e2);Cyc_Binding_resolve_exp(env,e3);return;}case 13U: _LL3D: _tmpC4=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpC5=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL3E: {struct Cyc_Absyn_Exp*e1=_tmpC4;struct Cyc_List_List*ts=_tmpC5;
# 508
Cyc_Binding_resolve_exp(env,e1);
for(0;ts != 0;ts=ts->tl){
Cyc_Binding_resolve_type(e->loc,env,(void*)ts->hd);}
return;}case 14U: _LL3F: _tmpC2=(void*)((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpC3=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL40: {void*t=_tmpC2;struct Cyc_Absyn_Exp*e1=_tmpC3;
# 514
Cyc_Binding_resolve_exp(env,e1);Cyc_Binding_resolve_type(e->loc,env,t);return;}case 37U: _LL41: _tmpC1=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL42: {struct Cyc_Absyn_Stmt*s=_tmpC1;
# 516
Cyc_Binding_resolve_stmt(env,s);return;}case 39U: _LL43: _tmpC0=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL44: {void*t=_tmpC0;
# 518
_tmpBF=t;goto _LL46;}case 19U: _LL45: _tmpBF=(void*)((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL46: {void*t=_tmpBF;
_tmpBE=t;goto _LL48;}case 17U: _LL47: _tmpBE=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL48: {void*t=_tmpBE;
Cyc_Binding_resolve_type(e->loc,env,t);return;}case 25U: _LL49: _tmpBC=(((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmpAC)->f1)->f3;_tmpBD=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL4A: {void*t=_tmpBC;struct Cyc_List_List*dles=_tmpBD;
# 523
Cyc_Binding_resolve_type(e->loc,env,t);
_tmpBB=dles;goto _LL4C;}case 26U: _LL4B: _tmpBB=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL4C: {struct Cyc_List_List*dles=_tmpBB;
# 527
for(0;dles != 0;dles=dles->tl){
Cyc_Binding_resolve_exp(env,(*((struct _tuple11*)dles->hd)).f2);}
return;}case 33U: _LL4D: _tmpB9=(void*)((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpBA=((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL4E: {void*t=_tmpB9;struct Cyc_Absyn_Enumfield*ef=_tmpBA;
# 532
Cyc_Binding_resolve_type(e->loc,env,t);return;}case 32U: _LL4F: _tmpB7=((struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpB8=((struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL50: {struct Cyc_Absyn_Enumdecl*ed=_tmpB7;struct Cyc_Absyn_Enumfield*ef=_tmpB8;
return;}case 31U: _LL51: _tmpB4=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpB5=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_tmpB6=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmpAC)->f3;_LL52: {struct Cyc_List_List*es=_tmpB4;struct Cyc_Absyn_Datatypedecl*tud=_tmpB5;struct Cyc_Absyn_Datatypefield*tuf=_tmpB6;
# 535
for(0;es != 0;es=es->tl){
Cyc_Binding_resolve_exp(env,(struct Cyc_Absyn_Exp*)es->hd);}
return;}case 30U: _LL53: _tmpB2=(void*)((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpB3=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL54: {void*t=_tmpB2;struct Cyc_List_List*dles=_tmpB3;
# 539
Cyc_Binding_resolve_type(e->loc,env,t);
for(0;dles != 0;dles=dles->tl){
Cyc_Binding_resolve_exp(env,(*((struct _tuple11*)dles->hd)).f2);}
...
if(v == 0){
if(need_va_name)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp161=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F7;_tmp2F7.tag=0U,({struct _fat_ptr _tmp365=({const char*_tmp162="missing name for vararg";_tag_fat(_tmp162,sizeof(char),24U);});_tmp2F7.f1=_tmp365;});_tmp2F7;});void*_tmp160[1U];_tmp160[0]=& _tmp161;({unsigned _tmp366=loc;Cyc_Warn_err2(_tmp366,_tag_fat(_tmp160,sizeof(void*),1U));});});}else{
# 605
void*_tmp163=Cyc_Absyn_fatptr_type(t,Cyc_Absyn_heap_rgn_type,tq,Cyc_Absyn_false_type);void*typ=_tmp163;
...
i->return_value=vd;
({struct Cyc_Dict_Dict _tmp36D=({struct Cyc_Dict_Dict _tmp36C=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _fat_ptr*_tmp36B=v;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp36C,_tmp36B,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp16C=_cycalloc(sizeof(*_tmp16C));
_tmp16C->tag=0U,({void*_tmp36A=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp16B=_cycalloc(sizeof(*_tmp16B));_tmp16B->tag=4U,_tmp16B->f1=vd;_tmp16B;});_tmp16C->f1=_tmp36A;});_tmp16C;}));});
# 631
...
{void*_tmp19E=Cyc_Binding_lookup_ordinary(loc,env,qvf);void*_stmttmp15=_tmp19E;void*_tmp19F=_stmttmp15;struct Cyc_Absyn_Datatypefield*_tmp1A1;struct Cyc_Absyn_Datatypedecl*_tmp1A0;if(((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp19F)->tag == 2U){_LL35: _tmp1A0=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp19F)->f1;_tmp1A1=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp19F)->f2;_LL36: {struct Cyc_Absyn_Datatypedecl*tud=_tmp1A0;struct Cyc_Absyn_Datatypefield*tuf=_tmp1A1;
# 668
struct Cyc_Absyn_Datatypedecl*_tmp1A2=(struct Cyc_Absyn_Datatypedecl*)(((struct Cyc_List_List*(*)(unsigned loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_List_List*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _fat_ptr*)))Cyc_Binding_resolve_lookup)(loc,env->ns,qvd,Cyc_Binding_lookup_datatypedecl))->hd;struct Cyc_Absyn_Datatypedecl*tud2=_tmp1A2;
if(Cyc_Absyn_qvar_cmp(tud->name,tud2->name)!= 0){
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1A4=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2FE;_tmp2FE.tag=1U,_tmp2FE.f1=tuf->name;_tmp2FE;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1A5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FD;_tmp2FD.tag=0U,({struct _fat_ptr _tmp36F=({const char*_tmp1AC=" is a variant of ";_tag_fat(_tmp1AC,sizeof(char),18U);});_tmp2FD.f1=_tmp36F;});_tmp2FD;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1A6=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2FC;_tmp2FC.tag=1U,_tmp2FC.f1=tud2->name;_tmp2FC;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1A7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FB;_tmp2FB.tag=0U,({struct _fat_ptr _tmp370=({const char*_tmp1AB=" not ";_tag_fat(_tmp1AB,sizeof(char),6U);});_tmp2FB.f1=_tmp370;});_tmp2FB;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1A8=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2FA;_tmp2FA.tag=1U,_tmp2FA.f1=tud->name;_tmp2FA;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1A9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F9;_tmp2F9.tag=0U,({
struct _fat_ptr _tmp371=({const char*_tmp1AA=" (shadowing not yet implemented properly)";_tag_fat(_tmp1AA,sizeof(char),42U);});_tmp2F9.f1=_tmp371;});_tmp2F9;});void*_tmp1A3[6U];_tmp1A3[0]=& _tmp1A4,_tmp1A3[1]=& _tmp1A5,_tmp1A3[2]=& _tmp1A6,_tmp1A3[3]=& _tmp1A7,_tmp1A3[4]=& _tmp1A8,_tmp1A3[5]=& _tmp1A9;({unsigned _tmp372=loc;Cyc_Warn_err2(_tmp372,_tag_fat(_tmp1A3,sizeof(void*),6U));});});
_npop_handler(0U);return;}
# 674
...
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1B0=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp301;_tmp301.tag=1U,_tmp301.f1=qvf;_tmp301;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1B1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp300;_tmp300.tag=0U,({struct _fat_ptr _tmp374=({const char*_tmp1B2=" is not a datatype field";_tag_fat(_tmp1B2,sizeof(char),25U);});_tmp300.f1=_tmp374;});_tmp300;});void*_tmp1AF[2U];_tmp1AF[0]=& _tmp1B0,_tmp1AF[1]=& _tmp1B1;({unsigned _tmp375=loc;Cyc_Warn_err2(_tmp375,_tag_fat(_tmp1AF,sizeof(void*),2U));});});return;}}else{_LL32: _LL33:
 return;}_LL2F:;}}case 20U: _LL5: _tmp186=(union Cyc_Absyn_AggrInfo*)&((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f1)->f1;_tmp187=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f2;_LL6: {union Cyc_Absyn_AggrInfo*info=_tmp186;struct Cyc_List_List*targs=_tmp187;
# 685
for(0;targs != 0;targs=targs->tl){
Cyc_Binding_resolve_type(loc,env,(void*)targs->hd);}{
...
{struct Cyc_Absyn_Aggrdecl*_tmp1BB=((struct Cyc_Absyn_Aggrdecl*(*)(unsigned loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_Absyn_Aggrdecl*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _fat_ptr*)))Cyc_Binding_resolve_lookup)(loc,env->ns,qv,Cyc_Binding_lookup_aggrdecl);struct Cyc_Absyn_Aggrdecl*ad=_tmp1BB;
if((int)ad->kind != (int)ak)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1BD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp302;_tmp302.tag=0U,({struct _fat_ptr _tmp376=({const char*_tmp1BE="struct vs. union mismatch with earlier declaration";_tag_fat(_tmp1BE,sizeof(char),51U);});_tmp302.f1=_tmp376;});_tmp302;});void*_tmp1BC[1U];_tmp1BC[0]=& _tmp1BD;({unsigned _tmp377=loc;Cyc_Warn_err2(_tmp377,_tag_fat(_tmp1BC,sizeof(void*),1U));});});
if((((int)ak == (int)1U && bo != 0)&& ad->impl != 0)&&((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->tagged != (int)bo->v)
# 695
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp303;_tmp303.tag=0U,({struct _fat_ptr _tmp378=({const char*_tmp1C1="@tagged mismatch with earlier declaration";_tag_fat(_tmp1C1,sizeof(char),42U);});_tmp303.f1=_tmp378;});_tmp303;});void*_tmp1BF[1U];_tmp1BF[0]=& _tmp1C0;({unsigned _tmp379=loc;Cyc_Warn_err2(_tmp379,_tag_fat(_tmp1BF,sizeof(void*),1U));});});
...
# 710
 Cyc_Binding_absolutize_topdecl(loc,env,*qv,Cyc_Absyn_Public);return;}else{_LL4B: _tmp1C9=_tmp1C8;_LL4C: {void*exn=_tmp1C9;(int)_rethrow(exn);}}_LL48:;}}}}case 16U: _LLF: _tmp183=((struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f1)->f1;_LL10: {struct Cyc_List_List*fs=_tmp183;
# 748
struct Cyc_Binding_ResolveNSEnv*_tmp1E0=({struct Cyc_Binding_NSCtxt*_tmp37C=env->ns;((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(_tmp37C,({struct Cyc_List_List*_tmp37B=(env->ns)->curr_ns;Cyc_Absyn_Abs_n(_tmp37B,
...
({struct Cyc_Dict_Dict _tmp37F=({struct Cyc_Dict_Dict _tmp37E=decl_ns_data->ordinaries;struct _fat_ptr*_tmp37D=(*f->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp37E,_tmp37D,(void*)({struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*_tmp1E2=_cycalloc(sizeof(*_tmp1E2));_tmp1E2->tag=4U,_tmp1E2->f1=t,_tmp1E2->f2=f;_tmp1E2;}));});decl_ns_data->ordinaries=_tmp37F;});}
# 756
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1D1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp305;_tmp305.tag=0U,({struct _fat_ptr _tmp380=({const char*_tmp1D3="unbound typdef name ";_tag_fat(_tmp1D3,sizeof(char),21U);});_tmp305.f1=_tmp380;});_tmp305;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1D2=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp304;_tmp304.tag=1U,_tmp304.f1=*tdn;_tmp304;});void*_tmp1D0[2U];_tmp1D0[0]=& _tmp1D1,_tmp1D0[1]=& _tmp1D2;({unsigned _tmp381=loc;Cyc_Warn_err2(_tmp381,_tag_fat(_tmp1D0,sizeof(void*),2U));});});
return;}case 10U: _LLB: _tmp17C=((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp170)->f1;_tmp17D=(void***)&((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp170)->f2;_LLC: {struct Cyc_Absyn_TypeDecl*td=_tmp17C;void***to=_tmp17D;
# 726
struct Cyc_Dict_Dict*_tmp1D4=env->local_vars;struct Cyc_Dict_Dict*old_locals=_tmp1D4;
env->local_vars=0;
{void*_tmp1D5=td->r;void*_stmttmp17=_tmp1D5;void*_tmp1D6=_stmttmp17;struct Cyc_Absyn_Datatypedecl*_tmp1D7;struct Cyc_Absyn_Enumdecl*_tmp1D8;struct Cyc_Absyn_Aggrdecl*_tmp1D9;switch(*((int*)_tmp1D6)){case 0U: _LL53: _tmp1D9=((struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)_tmp1D6)->f1;_LL54: {struct Cyc_Absyn_Aggrdecl*ad=_tmp1D9;
# 730
({struct Cyc_Binding_Env*_tmp383=env;Cyc_Binding_resolve_decl(_tmp383,({struct Cyc_Absyn_Decl*_tmp1DB=_cycalloc(sizeof(*_tmp1DB));({void*_tmp382=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp1DA=_cycalloc(sizeof(*_tmp1DA));_tmp1DA->tag=6U,_tmp1DA->f1=ad;_tmp1DA;});_tmp1DB->r=_tmp382;}),_tmp1DB->loc=td->loc;_tmp1DB;}));});goto _LL52;}case 1U: _LL55: _tmp1D8=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)_tmp1D6)->f1;_LL56: {struct Cyc_Absyn_Enumdecl*ed=_tmp1D8;
# 732
({struct Cyc_Binding_Env*_tmp385=env;Cyc_Binding_resolve_decl(_tmp385,({struct Cyc_Absyn_Decl*_tmp1DD=_cycalloc(sizeof(*_tmp1DD));({void*_tmp384=(void*)({struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*_tmp1DC=_cycalloc(sizeof(*_tmp1DC));_tmp1DC->tag=8U,_tmp1DC->f1=ed;_tmp1DC;});_tmp1DD->r=_tmp384;}),_tmp1DD->loc=td->loc;_tmp1DD;}));});goto _LL52;}default: _LL57: _tmp1D7=((struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)_tmp1D6)->f1;_LL58: {struct Cyc_Absyn_Datatypedecl*tud=_tmp1D7;
# 734
({struct Cyc_Binding_Env*_tmp387=env;Cyc_Binding_resolve_decl(_tmp387,({struct Cyc_Absyn_Decl*_tmp1DF=_cycalloc(sizeof(*_tmp1DF));({void*_tmp386=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp1DE=_cycalloc(sizeof(*_tmp1DE));_tmp1DE->tag=7U,_tmp1DE->f1=tud;_tmp1DE;});_tmp1DF->r=_tmp386;}),_tmp1DF->loc=td->loc;_tmp1DF;}));});goto _LL52;}}_LL52:;}
# 736
env->local_vars=old_locals;
return;}case 7U: _LLD: _tmp17B=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp170)->f2;_LLE: {struct Cyc_List_List*fs=_tmp17B;
# 743
Cyc_Binding_resolve_aggrfields(loc,env,fs);
return;}case 1U: _LL11: _tmp17A=(void*)((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp170)->f2;_LL12: {void*to=_tmp17A;
# 757
if(to != 0)Cyc_Binding_resolve_type(loc,env,to);return;}case 2U: _LL13: _LL14:
# 759
 goto _LL16;case 3U: _LL19: _tmp177=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp170)->f1).elt_type;_tmp178=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp170)->f1).ptr_atts).rgn;_tmp179=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp170)->f1).ptr_atts).bounds;_LL1A: {void*t1=_tmp177;void*t2=_tmp178;void*bds=_tmp179;
# 767
Cyc_Binding_resolve_type(loc,env,t1);
Cyc_Binding_resolve_type(loc,env,t2);
Cyc_Binding_resolve_type(loc,env,bds);
return;}case 6U: _LL1B: _tmp176=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp170)->f1;_LL1C: {struct Cyc_List_List*tqts=_tmp176;
# 773
for(0;tqts != 0;tqts=tqts->tl){
Cyc_Binding_resolve_type(loc,env,(*((struct _tuple13*)tqts->hd)).f2);}
return;}case 4U: _LL1D: _tmp174=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp170)->f1).elt_type;_tmp175=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp170)->f1).num_elts;_LL1E: {void*t1=_tmp174;struct Cyc_Absyn_Exp*eo=_tmp175;
# 777
Cyc_Binding_resolve_type(loc,env,t1);
if(eo != 0)Cyc_Binding_resolve_exp(env,eo);
return;}case 5U: _LL1F: _tmp173=(struct Cyc_Absyn_FnInfo*)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp170)->f1;_LL20: {struct Cyc_Absyn_FnInfo*i=_tmp173;
# 784
...
# 790
({struct Cyc_Dict_Dict*_tmp38A=({struct Cyc_Dict_Dict*_tmp1E6=_cycalloc(sizeof(*_tmp1E6));({struct Cyc_Dict_Dict _tmp389=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp1E6=_tmp389;});_tmp1E6;});env->local_vars=_tmp38A;});}
{struct Cyc_List_List*_tmp1E7=vds;struct Cyc_List_List*vds1=_tmp1E7;for(0;vds1 != 0;vds1=vds1->tl){
({struct Cyc_Dict_Dict _tmp38E=({struct Cyc_Dict_Dict _tmp38D=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _fat_ptr*_tmp38C=(*((struct Cyc_Absyn_Vardecl*)vds1->hd)->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp38D,_tmp38C,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp1E9=_cycalloc(sizeof(*_tmp1E9));
_tmp1E9->tag=0U,({void*_tmp38B=(void*)({struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp1E8=_cycalloc(sizeof(*_tmp1E8));_tmp1E8->tag=3U,_tmp1E8->f1=(struct Cyc_Absyn_Vardecl*)vds1->hd;_tmp1E8;});_tmp1E9->f1=_tmp38B;});_tmp1E9;}));});
# 792
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp38E;});}}
# 795
Cyc_Binding_resolve_function_stuff(loc,env,i);
env->local_vars=old_locals;
return;}case 9U: _LL21: _tmp172=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp170)->f1;_LL22: {struct Cyc_Absyn_Exp*e=_tmp172;
# 799
...
void*_tmp1ED=r;struct Cyc_List_List*_tmp1EE;struct Cyc_Absyn_Exp*_tmp1EF;struct Cyc_List_List*_tmp1F0;struct Cyc_Absyn_Pat*_tmp1F1;struct Cyc_Absyn_Vardecl*_tmp1F2;struct Cyc_Absyn_Vardecl*_tmp1F3;struct Cyc_Absyn_Pat*_tmp1F5;struct Cyc_Absyn_Vardecl*_tmp1F4;struct Cyc_Absyn_Pat*_tmp1F7;struct Cyc_Absyn_Vardecl*_tmp1F6;struct Cyc_List_List*_tmp1F8;struct Cyc_List_List*_tmp1F9;int _tmp1FD;struct Cyc_List_List*_tmp1FC;struct Cyc_List_List*_tmp1FB;struct _tuple0*_tmp1FA;int _tmp200;struct Cyc_List_List*_tmp1FF;struct _tuple0*_tmp1FE;struct _tuple0*_tmp201;switch(*((int*)_tmp1ED)){case 15U: _LL4: _tmp201=((struct Cyc_Absyn_UnknownId_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;_LL5: {struct _tuple0*qv=_tmp201;
# 808
...
# 811
({struct Cyc_Warn_String_Warn_Warg_struct _tmp20E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp306;_tmp306.tag=0U,({struct _fat_ptr _tmp38F=({const char*_tmp20F="struct tag used without arguments in pattern";_tag_fat(_tmp20F,sizeof(char),45U);});_tmp306.f1=_tmp38F;});_tmp306;});void*_tmp20D[1U];_tmp20D[0]=& _tmp20E;({unsigned _tmp390=loc;Cyc_Warn_err2(_tmp390,_tag_fat(_tmp20D,sizeof(void*),1U));});});_npop_handler(0U);return;case 2U: _LL31: _tmp20B=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp206)->f1;_tmp20C=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp206)->f2;_LL32: {struct Cyc_Absyn_Datatypedecl*tud=_tmp20B;struct Cyc_Absyn_Datatypefield*tuf=_tmp20C;
# 813
({void*_tmp391=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp210=_cycalloc(sizeof(*_tmp210));_tmp210->tag=8U,_tmp210->f1=tud,_tmp210->f2=tuf,_tmp210->f3=0,_tmp210->f4=0;_tmp210;});p->r=_tmp391;});_npop_handler(0U);return;}case 3U: _LL33: _tmp209=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp206)->f1;_tmp20A=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp206)->f2;_LL34: {struct Cyc_Absyn_Enumdecl*ed=_tmp209;struct Cyc_Absyn_Enumfield*ef=_tmp20A;
# 815
({void*_tmp392=(void*)({struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*_tmp211=_cycalloc(sizeof(*_tmp211));_tmp211->tag=13U,_tmp211->f1=ed,_tmp211->f2=ef;_tmp211;});p->r=_tmp392;});_npop_handler(0U);return;}default: _LL35: _tmp207=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp206)->f1;_tmp208=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp206)->f2;_LL36: {void*t=_tmp207;struct Cyc_Absyn_Enumfield*ef=_tmp208;
# 817
({void*_tmp393=(void*)({struct Cyc_Absyn_AnonEnum_p_Absyn_Raw_pat_struct*_tmp212=_cycalloc(sizeof(*_tmp212));_tmp212->tag=14U,_tmp212->f1=t,_tmp212->f2=ef;_tmp212;});p->r=_tmp393;});_npop_handler(0U);return;}}_LL2C:;}
# 808
...
({void*_tmp395=(void*)({struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*_tmp216=_cycalloc(sizeof(*_tmp216));_tmp216->tag=1U,_tmp216->f1=vd,({struct Cyc_Absyn_Pat*_tmp394=Cyc_Absyn_new_pat((void*)& Cyc_Absyn_Wild_p_val,0U);_tmp216->f2=_tmp394;});_tmp216;});p->r=_tmp395;});
return;}}case 16U: _LL6: _tmp1FE=((struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;_tmp1FF=((struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_tmp200=((struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*)_tmp1ED)->f3;_LL7: {struct _tuple0*qv=_tmp1FE;struct Cyc_List_List*ps=_tmp1FF;int dots=_tmp200;
# 825
...
{struct _handler_cons _tmp218;_push_handler(& _tmp218);{int _tmp21A=0;if(setjmp(_tmp218.handler))_tmp21A=1;if(!_tmp21A){{void*_tmp21B=Cyc_Binding_lookup_ordinary(loc,env,qv);void*_stmttmp19=_tmp21B;void*_tmp21C=_stmttmp19;struct Cyc_Absyn_Datatypefield*_tmp21E;struct Cyc_Absyn_Datatypedecl*_tmp21D;struct Cyc_Absyn_Aggrdecl*_tmp21F;switch(*((int*)_tmp21C)){case 0U: _LL3D: _LL3E:
 goto _LL3C;case 1U: _LL3F: _tmp21F=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmp21C)->f1;_LL40: {struct Cyc_Absyn_Aggrdecl*ad=_tmp21F;
# 830
...
({void*_tmp39A=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp225=_cycalloc(sizeof(*_tmp225));_tmp225->tag=7U,({union Cyc_Absyn_AggrInfo*_tmp399=({union Cyc_Absyn_AggrInfo*_tmp224=_cycalloc(sizeof(*_tmp224));({union Cyc_Absyn_AggrInfo _tmp398=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp223=_cycalloc(sizeof(*_tmp223));*_tmp223=ad;_tmp223;}));*_tmp224=_tmp398;});_tmp224;});_tmp225->f1=_tmp399;}),_tmp225->f2=0,({struct Cyc_List_List*_tmp397=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(new_ps);_tmp225->f3=_tmp397;}),_tmp225->f4=dots;_tmp225;});p->r=_tmp39A;});
_npop_handler(0U);return;}case 2U: _LL41: _tmp21D=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp21C)->f1;_tmp21E=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp21C)->f2;_LL42: {struct Cyc_Absyn_Datatypedecl*tud=_tmp21D;struct Cyc_Absyn_Datatypefield*tuf=_tmp21E;
# 836
({void*_tmp39B=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp226=_cycalloc(sizeof(*_tmp226));_tmp226->tag=8U,_tmp226->f1=tud,_tmp226->f2=tuf,_tmp226->f3=ps,_tmp226->f4=dots;_tmp226;});p->r=_tmp39B;});_npop_handler(0U);return;}case 3U: _LL43: _LL44:
 goto _LL46;default: _LL45: _LL46:
# 839
({struct Cyc_Warn_String_Warn_Warg_struct _tmp228=({struct Cyc_Warn_String_Warn_Warg_struct _tmp307;_tmp307.tag=0U,({struct _fat_ptr _tmp39C=({const char*_tmp229="enum tag used with arguments in pattern";_tag_fat(_tmp229,sizeof(char),40U);});_tmp307.f1=_tmp39C;});_tmp307;});void*_tmp227[1U];_tmp227[0]=& _tmp228;({unsigned _tmp39D=loc;Cyc_Warn_err2(_tmp39D,_tag_fat(_tmp227,sizeof(void*),1U));});});_npop_handler(0U);return;}_LL3C:;}
# 827
...
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp22D=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp309;_tmp309.tag=1U,_tmp309.f1=qv;_tmp309;});struct Cyc_Warn_String_Warn_Warg_struct _tmp22E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp308;_tmp308.tag=0U,({struct _fat_ptr _tmp39E=({const char*_tmp22F=" is not a constructor in pattern";_tag_fat(_tmp22F,sizeof(char),33U);});_tmp308.f1=_tmp39E;});_tmp308;});void*_tmp22C[2U];_tmp22C[0]=& _tmp22D,_tmp22C[1]=& _tmp22E;({unsigned _tmp39F=loc;Cyc_Warn_err2(_tmp39F,_tag_fat(_tmp22C,sizeof(void*),2U));});});return;}case 7U: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1 != 0){if((((union Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1)->UnknownAggr).tag == 1){_LL8: _tmp1FA=(((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1)->UnknownAggr).val).f2;_tmp1FB=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_tmp1FC=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f3;_tmp1FD=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f4;_LL9: {struct _tuple0*n=_tmp1FA;struct Cyc_List_List*exist_ts=_tmp1FB;struct Cyc_List_List*dps=_tmp1FC;int dots=_tmp1FD;
# 844
...
{struct Cyc_Absyn_Aggrdecl*_tmp234=((struct Cyc_Absyn_Aggrdecl*(*)(unsigned loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_Absyn_Aggrdecl*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _fat_ptr*)))Cyc_Binding_resolve_lookup)(loc,env->ns,n,Cyc_Binding_lookup_aggrdecl);struct Cyc_Absyn_Aggrdecl*ad=_tmp234;
({void*_tmp3A2=(void*)({struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*_tmp237=_cycalloc(sizeof(*_tmp237));_tmp237->tag=7U,({union Cyc_Absyn_AggrInfo*_tmp3A1=({union Cyc_Absyn_AggrInfo*_tmp236=_cycalloc(sizeof(*_tmp236));({union Cyc_Absyn_AggrInfo _tmp3A0=Cyc_Absyn_KnownAggr(({struct Cyc_Absyn_Aggrdecl**_tmp235=_cycalloc(sizeof(*_tmp235));*_tmp235=ad;_tmp235;}));*_tmp236=_tmp3A0;});_tmp236;});_tmp237->f1=_tmp3A1;}),_tmp237->f2=exist_ts,_tmp237->f3=dps,_tmp237->f4=dots;_tmp237;});p->r=_tmp3A2;});}
# 847
...
# 850
({struct Cyc_Warn_String_Warn_Warg_struct _tmp23B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30A;_tmp30A.tag=0U,({struct _fat_ptr _tmp3A3=({const char*_tmp23C="non-aggregate name has designator patterns";_tag_fat(_tmp23C,sizeof(char),43U);});_tmp30A.f1=_tmp3A3;});_tmp30A;});void*_tmp23A[1U];_tmp23A[0]=& _tmp23B;({unsigned _tmp3A4=loc;Cyc_Warn_err2(_tmp3A4,_tag_fat(_tmp23A,sizeof(void*),1U));});});return;}else{_LL4F: _tmp239=_tmp238;_LL50: {void*exn=_tmp239;(int)_rethrow(exn);}}_LL4C:;}}}
# 852
...
# 879
_tmp1F9=dps;goto _LL25;}}case 0U: _LLA: _LLB:
# 854
 return;case 3U: _LLC: _tmp1F6=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;_tmp1F7=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_LLD: {struct Cyc_Absyn_Vardecl*vd=_tmp1F6;struct Cyc_Absyn_Pat*p2=_tmp1F7;
# 856
_tmp1F4=vd;_tmp1F5=p2;goto _LLF;}case 1U: _LLE: _tmp1F4=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;_tmp1F5=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_LLF: {struct Cyc_Absyn_Vardecl*vd=_tmp1F4;struct Cyc_Absyn_Pat*p2=_tmp1F5;
# 858
Cyc_Binding_resolve_pat(env,p2);
_tmp1F3=vd;goto _LL11;}case 4U: _LL10: _tmp1F3=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_LL11: {struct Cyc_Absyn_Vardecl*vd=_tmp1F3;
_tmp1F2=vd;goto _LL13;}case 2U: _LL12: _tmp1F2=((struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_LL13: {struct Cyc_Absyn_Vardecl*vd=_tmp1F2;
# 862
Cyc_Binding_resolve_and_add_vardecl(loc,env,vd);goto _LL3;}case 6U: _LL14: _tmp1F1=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;_LL15: {struct Cyc_Absyn_Pat*p2=_tmp1F1;
# 864
Cyc_Binding_resolve_pat(env,p2);return;}case 5U: _LL16: _tmp1F0=((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;_LL17: {struct Cyc_List_List*ps=_tmp1F0;
# 866
for(0;ps != 0;ps=ps->tl){
Cyc_Binding_resolve_pat(env,(struct Cyc_Absyn_Pat*)ps->hd);}
goto _LL3;}case 17U: _LL18: _tmp1EF=((struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;_LL19: {struct Cyc_Absyn_Exp*e=_tmp1EF;
# 870
...
# 872
 ...
 return;case 8U: _LL26: _tmp1EE=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp1ED)->f3;_LL27: {struct Cyc_List_List*ps=_tmp1EE;
# 885
for(0;ps != 0;ps=ps->tl){
Cyc_Binding_resolve_pat(env,(struct Cyc_Absyn_Pat*)ps->hd);}
...
void*_tmp243=res;struct Cyc_Absyn_Datatypefield*_tmp245;struct Cyc_Absyn_Datatypedecl*_tmp244;struct Cyc_Absyn_Enumfield*_tmp247;void*_tmp246;struct Cyc_Absyn_Aggrdecl*_tmp248;struct Cyc_Absyn_Enumfield*_tmp24A;struct Cyc_Absyn_Enumdecl*_tmp249;void*_tmp24B;switch(*((int*)_tmp243)){case 0U: _LL4: _tmp24B=(void*)((struct Cyc_Binding_VarRes_Binding_Resolved_struct*)_tmp243)->f1;_LL5: {void*bnd=_tmp24B;
# 907
...
({struct Cyc_Dict_Dict _tmp3A7=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(*out_dict,name,res);*out_dict=_tmp3A7;});
goto _LL3;}}case 3U: _LL6: _tmp249=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp243)->f1;_tmp24A=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp243)->f2;_LL7: {struct Cyc_Absyn_Enumdecl*ed=_tmp249;struct Cyc_Absyn_Enumfield*ef=_tmp24A;
# 918
({struct Cyc_Dict_Dict _tmp3A8=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(*out_dict,name,res);*out_dict=_tmp3A8;});
goto _LL3;}case 1U: _LL8: _tmp248=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmp243)->f1;_LL9: {struct Cyc_Absyn_Aggrdecl*ad=_tmp248;
# 922
({struct Cyc_Dict_Dict _tmp3A9=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(*out_dict,name,res);*out_dict=_tmp3A9;});
goto _LL3;}case 4U: _LLA: _tmp246=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp243)->f1;_tmp247=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp243)->f2;_LLB: {void*t=_tmp246;struct Cyc_Absyn_Enumfield*ef=_tmp247;
# 925
...
goto _LL0;}case 1U: _LL3: _tmp267=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_LL4: {struct Cyc_Absyn_Fndecl*fd=_tmp267;
# 957
if(env->in_cyc_override)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp26A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30B;_tmp30B.tag=0U,({struct _fat_ptr _tmp3AC=({const char*_tmp26B="Function declaration not permitted within cyclone_override block";_tag_fat(_tmp26B,sizeof(char),65U);});_tmp30B.f1=_tmp3AC;});_tmp30B;});void*_tmp269[1U];_tmp269[0]=& _tmp26A;({unsigned _tmp3AD=loc;Cyc_Warn_err2(_tmp3AD,_tag_fat(_tmp269,sizeof(void*),1U));});});
Cyc_Binding_absolutize_decl(loc,env,fd->name,fd->sc);{
struct _tuple0*_tmp26C=fd->name;struct _tuple0*_stmttmp1B=_tmp26C;struct _tuple0*_tmp26D=_stmttmp1B;struct _fat_ptr*_tmp26F;union Cyc_Absyn_Nmspace _tmp26E;_LL26: _tmp26E=_tmp26D->f1;_tmp26F=_tmp26D->f2;_LL27: {union Cyc_Absyn_Nmspace decl_ns=_tmp26E;struct _fat_ptr*decl_name=_tmp26F;
...
# 972
({struct Cyc_Dict_Dict*_tmp3B1=({struct Cyc_Dict_Dict*_tmp275=_cycalloc(sizeof(*_tmp275));({struct Cyc_Dict_Dict _tmp3B0=((struct Cyc_Dict_Dict(*)(int(*cmp)(struct _fat_ptr*,struct _fat_ptr*)))Cyc_Dict_empty)(Cyc_strptrcmp);*_tmp275=_tmp3B0;});_tmp275;});env->local_vars=_tmp3B1;});}
{struct Cyc_List_List*_tmp276=vds;struct Cyc_List_List*vds1=_tmp276;for(0;vds1 != 0;vds1=vds1->tl){
({struct Cyc_Dict_Dict _tmp3B5=({struct Cyc_Dict_Dict _tmp3B4=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _fat_ptr*_tmp3B3=(*((struct Cyc_Absyn_Vardecl*)vds1->hd)->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3B4,_tmp3B3,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp278=_cycalloc(sizeof(*_tmp278));
_tmp278->tag=0U,({void*_tmp3B2=(void*)({struct Cyc_Absyn_Param_b_Absyn_Binding_struct*_tmp277=_cycalloc(sizeof(*_tmp277));_tmp277->tag=3U,_tmp277->f1=(struct Cyc_Absyn_Vardecl*)vds1->hd;_tmp277;});_tmp278->f1=_tmp3B2;});_tmp278;}));});
# 974
...
if(old_locals != 0){
# 981
({struct Cyc_Dict_Dict _tmp3B9=({struct Cyc_Dict_Dict _tmp3B8=*old_locals;struct _fat_ptr*_tmp3B7=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3B8,_tmp3B7,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp27A=_cycalloc(sizeof(*_tmp27A));
_tmp27A->tag=0U,({void*_tmp3B6=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp279=_cycalloc(sizeof(*_tmp279));_tmp279->tag=2U,_tmp279->f1=fd;_tmp279;});_tmp27A->f1=_tmp3B6;});_tmp27A;}));});
# 981
*old_locals=_tmp3B9;});
# 983
({struct Cyc_Dict_Dict _tmp3BD=({struct Cyc_Dict_Dict _tmp3BC=*((struct Cyc_Dict_Dict*)_check_null(env->local_vars));struct _fat_ptr*_tmp3BB=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3BC,_tmp3BB,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp27C=_cycalloc(sizeof(*_tmp27C));
_tmp27C->tag=0U,({void*_tmp3BA=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp27B=_cycalloc(sizeof(*_tmp27B));_tmp27B->tag=2U,_tmp27B->f1=fd;_tmp27B;});_tmp27C->f1=_tmp3BA;});_tmp27C;}));});
# 983
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=_tmp3BD;});}else{
# 986
struct Cyc_Binding_ResolveNSEnv*_tmp27D=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp27D;
({struct Cyc_Dict_Dict _tmp3C1=({struct Cyc_Dict_Dict _tmp3C0=decl_ns_data->ordinaries;struct _fat_ptr*_tmp3BF=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3C0,_tmp3BF,(void*)({struct Cyc_Binding_VarRes_Binding_Resolved_struct*_tmp27F=_cycalloc(sizeof(*_tmp27F));
# 989
_tmp27F->tag=0U,({void*_tmp3BE=(void*)({struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp27E=_cycalloc(sizeof(*_tmp27E));_tmp27E->tag=2U,_tmp27E->f1=fd;_tmp27E;});_tmp27F->f1=_tmp3BE;});_tmp27F;}));});
# 987
...
# 995
env->local_vars=old_locals;
goto _LL0;}}}}case 2U: _LL5: _tmp265=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_tmp266=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp253)->f3;_LL6: {struct Cyc_Absyn_Pat*p=_tmp265;struct Cyc_Absyn_Exp*exp=_tmp266;
# 999
if(Cyc_Binding_at_toplevel(env)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp281=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30C;_tmp30C.tag=0U,({struct _fat_ptr _tmp3C2=({const char*_tmp282="let not allowed at top-level";_tag_fat(_tmp282,sizeof(char),29U);});_tmp30C.f1=_tmp3C2;});_tmp30C;});void*_tmp280[1U];_tmp280[0]=& _tmp281;({unsigned _tmp3C3=loc;Cyc_Warn_err2(_tmp3C3,_tag_fat(_tmp280,sizeof(void*),1U));});});
goto _LL0;}
# 1003
Cyc_Binding_resolve_exp(env,exp);
Cyc_Binding_resolve_pat(env,p);
goto _LL0;}case 3U: _LL7: _tmp264=((struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_LL8: {struct Cyc_List_List*vds=_tmp264;
# 1008
for(0;vds != 0;vds=vds->tl){
Cyc_Binding_resolve_and_add_vardecl(loc,env,(struct Cyc_Absyn_Vardecl*)vds->hd);}
goto _LL0;}case 4U: _LL9: _tmp261=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_tmp262=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp253)->f2;_tmp263=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp253)->f3;_LLA: {struct Cyc_Absyn_Tvar*tv=_tmp261;struct Cyc_Absyn_Vardecl*vd=_tmp262;struct Cyc_Absyn_Exp*open_exp_opt=_tmp263;
# 1013
if(open_exp_opt != 0)
Cyc_Binding_resolve_exp(env,open_exp_opt);
Cyc_Binding_resolve_and_add_vardecl(loc,env,vd);
goto _LL0;}case 9U: _LLB: _tmp260=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_LLC: {struct Cyc_Absyn_Typedefdecl*td=_tmp260;
# 1019
if(!Cyc_Binding_at_toplevel(env)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp284=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30D;_tmp30D.tag=0U,({struct _fat_ptr _tmp3C4=({const char*_tmp285="nested type definitions are not yet supported";_tag_fat(_tmp285,sizeof(char),46U);});_tmp30D.f1=_tmp3C4;});_tmp30D;});void*_tmp283[1U];_tmp283[0]=& _tmp284;({unsigned _tmp3C5=loc;Cyc_Warn_err2(_tmp3C5,_tag_fat(_tmp283,sizeof(void*),1U));});});
goto _LL0;}
# 1023
Cyc_Binding_absolutize_decl(loc,env,td->name,td->extern_c?Cyc_Absyn_ExternC: Cyc_Absyn_Public);{
struct _tuple0*_tmp286=td->name;struct _tuple0*_stmttmp1C=_tmp286;struct _tuple0*_tmp287=_stmttmp1C;struct _fat_ptr*_tmp289;union Cyc_Absyn_Nmspace _tmp288;_LL29: _tmp288=_tmp287->f1;_tmp289=_tmp287->f2;_LL2A: {union Cyc_Absyn_Nmspace decl_ns=_tmp288;struct _fat_ptr*decl_name=_tmp289;
# 1026
struct Cyc_Binding_ResolveNSEnv*_tmp28A=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp28A;
if(td->defn != 0)
Cyc_Binding_resolve_type(loc,env,(void*)_check_null(td->defn));
# 1030
if(!env->in_cyc_override)
({struct Cyc_Dict_Dict _tmp3C6=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_Absyn_Typedefdecl*v))Cyc_Dict_insert)(decl_ns_data->typedefs,decl_name,td);decl_ns_data->typedefs=_tmp3C6;});
# 1034
goto _LL0;}}}case 6U: _LLD: _tmp25F=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_LLE: {struct Cyc_Absyn_Aggrdecl*ad=_tmp25F;
# 1037
if(!Cyc_Binding_at_toplevel(env)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp28C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30E;_tmp30E.tag=0U,({struct _fat_ptr _tmp3C7=({const char*_tmp28D="nested type definitions are not yet supported";_tag_fat(_tmp28D,sizeof(char),46U);});_tmp30E.f1=_tmp3C7;});_tmp30E;});void*_tmp28B[1U];_tmp28B[0]=& _tmp28C;({unsigned _tmp3C8=loc;Cyc_Warn_err2(_tmp3C8,_tag_fat(_tmp28B,sizeof(void*),1U));});});
goto _LL0;}
# 1041
Cyc_Binding_absolutize_decl(loc,env,ad->name,ad->sc);{
struct _tuple0*_tmp28E=ad->name;struct _tuple0*_stmttmp1D=_tmp28E;struct _tuple0*_tmp28F=_stmttmp1D;struct _fat_ptr*_tmp291;union Cyc_Absyn_Nmspace _tmp290;_LL2C: _tmp290=_tmp28F->f1;_tmp291=_tmp28F->f2;_LL2D: {union Cyc_Absyn_Nmspace decl_ns=_tmp290;struct _fat_ptr*decl_name=_tmp291;
# 1044
struct Cyc_Binding_ResolveNSEnv*_tmp292=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp292;
# 1046
if(((int(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_member)(decl_ns_data->aggrdecls,decl_name)&& ad->impl == 0)
goto _LL0;
# 1049
if(!env->in_cyc_override){
({struct Cyc_Dict_Dict _tmp3C9=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_Absyn_Aggrdecl*v))Cyc_Dict_insert)(decl_ns_data->aggrdecls,decl_name,ad);decl_ns_data->aggrdecls=_tmp3C9;});
# 1052
({struct Cyc_Dict_Dict _tmp3CC=({struct Cyc_Dict_Dict _tmp3CB=decl_ns_data->ordinaries;struct _fat_ptr*_tmp3CA=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3CB,_tmp3CA,(void*)({struct Cyc_Binding_AggrRes_Binding_Resolved_struct*_tmp293=_cycalloc(sizeof(*_tmp293));
_tmp293->tag=1U,_tmp293->f1=ad;_tmp293;}));});
# 1052
decl_ns_data->ordinaries=_tmp3CC;});}
# 1055
if(ad->impl != 0){
struct Cyc_Absyn_AggrdeclImpl*_tmp294=(struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl);struct Cyc_Absyn_AggrdeclImpl*_stmttmp1E=_tmp294;struct Cyc_Absyn_AggrdeclImpl*_tmp295=_stmttmp1E;struct Cyc_List_List*_tmp297;struct Cyc_List_List*_tmp296;_LL2F: _tmp296=_tmp295->rgn_po;_tmp297=_tmp295->fields;_LL30: {struct Cyc_List_List*rpo=_tmp296;struct Cyc_List_List*fs=_tmp297;
Cyc_Binding_resolve_rgnpo(loc,env,rpo);
Cyc_Binding_resolve_aggrfields(loc,env,fs);}}
# 1060
goto _LL0;}}}case 8U: _LLF: _tmp25E=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_LL10: {struct Cyc_Absyn_Enumdecl*ed=_tmp25E;
# 1063
if(!Cyc_Binding_at_toplevel(env)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp299=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30F;_tmp30F.tag=0U,({struct _fat_ptr _tmp3CD=({const char*_tmp29A="nested type definitions are not yet supported";_tag_fat(_tmp29A,sizeof(char),46U);});_tmp30F.f1=_tmp3CD;});_tmp30F;});void*_tmp298[1U];_tmp298[0]=& _tmp299;({unsigned _tmp3CE=loc;Cyc_Warn_err2(_tmp3CE,_tag_fat(_tmp298,sizeof(void*),1U));});});
goto _LL0;}
# 1067
Cyc_Binding_absolutize_decl(loc,env,ed->name,ed->sc);{
struct _tuple0*_tmp29B=ed->name;struct _tuple0*_stmttmp1F=_tmp29B;struct _tuple0*_tmp29C=_stmttmp1F;struct _fat_ptr*_tmp29E;union Cyc_Absyn_Nmspace _tmp29D;_LL32: _tmp29D=_tmp29C->f1;_tmp29E=_tmp29C->f2;_LL33: {union Cyc_Absyn_Nmspace decl_ns=_tmp29D;struct _fat_ptr*decl_name=_tmp29E;
# 1070
struct Cyc_Binding_ResolveNSEnv*_tmp29F=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp29F;
# 1072
if(((int(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_member)(decl_ns_data->enumdecls,decl_name)&& ed->fields == 0)
goto _LL0;
# 1076
if(!env->in_cyc_override)
({struct Cyc_Dict_Dict _tmp3CF=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_Absyn_Enumdecl*v))Cyc_Dict_insert)(decl_ns_data->enumdecls,decl_name,ed);decl_ns_data->enumdecls=_tmp3CF;});
# 1079
if(ed->fields != 0){
# 1081
...
Cyc_Binding_resolve_exp(env,(struct Cyc_Absyn_Exp*)_check_null(f->tag));
if(!env->in_cyc_override)
({struct Cyc_Dict_Dict _tmp3D2=({struct Cyc_Dict_Dict _tmp3D1=decl_ns_data->ordinaries;struct _fat_ptr*_tmp3D0=(*f->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3D1,_tmp3D0,(void*)({struct Cyc_Binding_EnumRes_Binding_Resolved_struct*_tmp2A1=_cycalloc(sizeof(*_tmp2A1));
# 1089
_tmp2A1->tag=3U,_tmp2A1->f1=ed,_tmp2A1->f2=f;_tmp2A1;}));});
# 1087
decl_ns_data->ordinaries=_tmp3D2;});}}
# 1091
goto _LL0;}}}case 7U: _LL11: _tmp25D=((struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_LL12: {struct Cyc_Absyn_Datatypedecl*tud=_tmp25D;
# 1095
{struct _handler_cons _tmp2A2;_push_handler(& _tmp2A2);{int _tmp2A4=0;if(setjmp(_tmp2A2.handler))_tmp2A4=1;if(!_tmp2A4){
{struct Cyc_List_List*_tmp2A5=((struct Cyc_List_List*(*)(unsigned loc,struct Cyc_Binding_NSCtxt*ctxt,struct _tuple0*qv,struct Cyc_List_List*(*lookup)(struct Cyc_Binding_ResolveNSEnv*,struct _fat_ptr*)))Cyc_Binding_resolve_lookup)(loc,env->ns,tud->name,Cyc_Binding_lookup_datatypedecl);struct Cyc_List_List*decls=_tmp2A5;
...
tud->is_extensible=1;{
struct _tuple0*_tmp2A8=tud->name;struct _tuple0*_stmttmp20=_tmp2A8;struct _tuple0*_tmp2A9=_stmttmp20;struct _fat_ptr*_tmp2AB;union Cyc_Absyn_Nmspace _tmp2AA;_LL35: _tmp2AA=_tmp2A9->f1;_tmp2AB=_tmp2A9->f2;_LL36: {union Cyc_Absyn_Nmspace decl_ns=_tmp2AA;struct _fat_ptr*decl_name=_tmp2AB;
struct Cyc_Binding_ResolveNSEnv*_tmp2AC=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp2AC;
({struct Cyc_Dict_Dict _tmp3D5=({struct Cyc_Dict_Dict _tmp3D4=decl_ns_data->datatypedecls;struct _fat_ptr*_tmp3D3=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_List_List*v))Cyc_Dict_insert)(_tmp3D4,_tmp3D3,({struct Cyc_List_List*_tmp2AD=_cycalloc(sizeof(*_tmp2AD));
_tmp2AD->hd=tud,_tmp2AD->tl=decls;_tmp2AD;}));});
# 1104
decl_ns_data->datatypedecls=_tmp3D5;});}}}
# 1096
;_pop_handler();}else{void*_tmp2A3=(void*)Cyc_Core_get_exn_thrown();void*_tmp2AE=_tmp2A3;void*_tmp2AF;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp2AE)->tag == Cyc_Binding_BindingError){_LL38: _LL39:
# 1108
 Cyc_Binding_absolutize_topdecl(loc,env,tud->name,tud->sc);{
struct _tuple0*_tmp2B0=tud->name;struct _tuple0*_stmttmp21=_tmp2B0;struct _tuple0*_tmp2B1=_stmttmp21;struct _fat_ptr*_tmp2B3;union Cyc_Absyn_Nmspace _tmp2B2;_LL3D: _tmp2B2=_tmp2B1->f1;_tmp2B3=_tmp2B1->f2;_LL3E: {union Cyc_Absyn_Nmspace decl_ns=_tmp2B2;struct _fat_ptr*decl_name=_tmp2B3;
struct Cyc_Binding_ResolveNSEnv*_tmp2B4=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,decl_ns);struct Cyc_Binding_ResolveNSEnv*decl_ns_data=_tmp2B4;
# 1112
if(((int(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_member)(decl_ns_data->datatypedecls,decl_name)&& tud->fields == 0)
# 1114
goto _LL37;
({struct Cyc_Dict_Dict _tmp3D8=({struct Cyc_Dict_Dict _tmp3D7=decl_ns_data->datatypedecls;struct _fat_ptr*_tmp3D6=decl_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,struct Cyc_List_List*v))Cyc_Dict_insert)(_tmp3D7,_tmp3D6,({struct Cyc_List_List*_tmp2B5=_cycalloc(sizeof(*_tmp2B5));
_tmp2B5->hd=tud,_tmp2B5->tl=0;_tmp2B5;}));});
# 1115
decl_ns_data->datatypedecls=_tmp3D8;});
# 1117
goto _LL37;}}}else{_LL3A: _tmp2AF=_tmp2AE;_LL3B: {void*exn=_tmp2AF;(int)_rethrow(exn);}}_LL37:;}}}{
# 1120
struct _tuple0*_tmp2B6=tud->name;struct _tuple0*_stmttmp22=_tmp2B6;struct _tuple0*_tmp2B7=_stmttmp22;struct _fat_ptr*_tmp2B9;union Cyc_Absyn_Nmspace _tmp2B8;_LL40: _tmp2B8=_tmp2B7->f1;_tmp2B9=_tmp2B7->f2;_LL41: {union Cyc_Absyn_Nmspace decl_ns=_tmp2B8;struct _fat_ptr*decl_name=_tmp2B9;
if(tud->fields != 0){
...
Cyc_Binding_resolve_type(loc,env,(*((struct _tuple13*)tqts->hd)).f2);}}
{union Cyc_Absyn_Nmspace _tmp2BD=(*f->name).f1;union Cyc_Absyn_Nmspace _stmttmp23=_tmp2BD;union Cyc_Absyn_Nmspace _tmp2BE=_stmttmp23;switch((_tmp2BE.Abs_n).tag){case 1U: if((_tmp2BE.Rel_n).val == 0){_LL43: _LL44:
# 1128
...
# 1134
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp310;_tmp310.tag=0U,({struct _fat_ptr _tmp3DA=({const char*_tmp2C1="qualified datatype field declarations not allowed";_tag_fat(_tmp2C1,sizeof(char),50U);});_tmp310.f1=_tmp3DA;});_tmp310;});void*_tmp2BF[1U];_tmp2BF[0]=& _tmp2C0;({unsigned _tmp3DB=f->loc;Cyc_Warn_err2(_tmp3DB,_tag_fat(_tmp2BF,sizeof(void*),1U));});});
return;}case 2U: _LL47: _LL48:
 goto _LL42;default: _LL49: _LL4A:
({void*_tmp2C2=0U;({struct _fat_ptr _tmp3DC=({const char*_tmp2C3="datatype field Loc_n or C_n";_tag_fat(_tmp2C3,sizeof(char),28U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp3DC,_tag_fat(_tmp2C2,sizeof(void*),0U));});});}_LL42:;}{
# 1139
struct Cyc_Binding_ResolveNSEnv*_tmp2C4=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Binding_NSCtxt*ctxt,union Cyc_Absyn_Nmspace abs_ns))Cyc_Binding_get_ns_data)(env->ns,(*f->name).f1);struct Cyc_Binding_ResolveNSEnv*ns_data=_tmp2C4;
({struct Cyc_Dict_Dict _tmp3DF=({struct Cyc_Dict_Dict _tmp3DE=ns_data->ordinaries;struct _fat_ptr*_tmp3DD=(*f->name).f2;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3DE,_tmp3DD,(void*)({struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*_tmp2C5=_cycalloc(sizeof(*_tmp2C5));
# 1142
_tmp2C5->tag=2U,_tmp2C5->f1=tud,_tmp2C5->f2=f;_tmp2C5;}));});
# 1140
ns_data->ordinaries=_tmp3DF;});}}}
# 1144
goto _LL0;}}}case 10U: _LL13: _tmp25B=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_tmp25C=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp253)->f2;_LL14: {struct _fat_ptr*v=_tmp25B;struct Cyc_List_List*ds2=_tmp25C;
# 1147
...
goto _LL0;}case 11U: _LL15: _tmp259=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_tmp25A=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp253)->f2;_LL16: {struct _tuple0*qv=_tmp259;struct Cyc_List_List*ds2=_tmp25A;
# 1152
...
goto _LL0;}case 12U: _LL17: _tmp258=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_LL18: {struct Cyc_List_List*ds2=_tmp258;
# 1158
int _tmp2C6=env->in_cinclude;int old=_tmp2C6;
env->in_cinclude=1;
Cyc_Binding_resolve_decls(env,ds2);
env->in_cinclude=old;
goto _LL0;}case 13U: _LL19: _tmp254=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_tmp255=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp253)->f2;_tmp256=(struct Cyc_List_List**)&((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp253)->f3;_tmp257=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp253)->f4;_LL1A: {struct Cyc_List_List*ds2=_tmp254;struct Cyc_List_List*ovrs=_tmp255;struct Cyc_List_List**exports=_tmp256;struct _tuple10*hides=_tmp257;
# 1169
{struct Cyc_List_List*_tmp2C7=*exports;struct Cyc_List_List*exs=_tmp2C7;for(0;exs != 0;exs=exs->tl){
struct _tuple17*_tmp2C8=(struct _tuple17*)exs->hd;struct _tuple17*_stmttmp24=_tmp2C8;struct _tuple17*_tmp2C9=_stmttmp24;struct _tuple0*_tmp2CB;unsigned _tmp2CA;_LL4C: _tmp2CA=_tmp2C9->f1;_tmp2CB=_tmp2C9->f2;_LL4D: {unsigned loc=_tmp2CA;struct _tuple0*qv=_tmp2CB;
Cyc_Binding_absolutize_decl(loc,env,qv,Cyc_Absyn_ExternC);}}}
# 1177
if(!Cyc_Binding_at_toplevel(env)){
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2CD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp311;_tmp311.tag=0U,({struct _fat_ptr _tmp3E0=({const char*_tmp2CE="extern \"C include\" not at toplevel";_tag_fat(_tmp2CE,sizeof(char),35U);});_tmp311.f1=_tmp3E0;});_tmp311;});void*_tmp2CC[1U];_tmp2CC[0]=& _tmp2CD;({unsigned _tmp3E1=loc;Cyc_Warn_err2(_tmp3E1,_tag_fat(_tmp2CC,sizeof(void*),1U));});});
goto _LL0;}{
# 1181
struct Cyc_Binding_ResolveNSEnv*_tmp2CF=((struct Cyc_Binding_ResolveNSEnv*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)((env->ns)->ns_data,(env->ns)->curr_ns);struct Cyc_Binding_ResolveNSEnv*data=_tmp2CF;
...
if((unsigned)*exports)
({void*_tmp2D4=0U;({unsigned _tmp3E3=(*hides).f1;struct _fat_ptr _tmp3E2=({const char*_tmp2D5="export wildcard expects empty export list";_tag_fat(_tmp2D5,sizeof(char),42U);});Cyc_Warn_err(_tmp3E3,_tmp3E2,_tag_fat(_tmp2D4,sizeof(void*),0U));});});
env->in_cinclude=old;
({struct _tuple16*_tmp3E4=({struct _tuple16*_tmp2D6=_cycalloc(sizeof(*_tmp2D6));_tmp2D6->f1=exports,_tmp2D6->f2=& out_dict,_tmp2D6->f3=env,_tmp2D6->f4=hides;_tmp2D6;});((void(*)(void(*f)(struct _tuple16*,struct _fat_ptr*,void*),struct _tuple16*env,struct Cyc_Dict_Dict d))Cyc_Dict_iter_c)(Cyc_Binding_export_all_symbols,_tmp3E4,
...
struct _tuple17*_tmp2D8=(struct _tuple17*)exs->hd;struct _tuple17*_stmttmp25=_tmp2D8;struct _tuple17*_tmp2D9=_stmttmp25;struct _fat_ptr*_tmp2DB;unsigned _tmp2DA;_LL4F: _tmp2DA=_tmp2D9->f1;_tmp2DB=(_tmp2D9->f2)->f2;_LL50: {unsigned loc=_tmp2DA;struct _fat_ptr*v=_tmp2DB;
...
void*_tmp3E5=((void*(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_lookup)(old_dict,v);_tmp3E5 == ((void*(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_lookup)(new_dict,v);}))
({struct Cyc_String_pa_PrintArg_struct _tmp2DE=({struct Cyc_String_pa_PrintArg_struct _tmp312;_tmp312.tag=0U,_tmp312.f1=(struct _fat_ptr)((struct _fat_ptr)*v);_tmp312;});void*_tmp2DC[1U];_tmp2DC[0]=& _tmp2DE;({unsigned _tmp3E7=loc;struct _fat_ptr _tmp3E6=({const char*_tmp2DD="%s is exported but not defined";_tag_fat(_tmp2DD,sizeof(char),31U);});Cyc_Warn_err(_tmp3E7,_tmp3E6,_tag_fat(_tmp2DC,sizeof(void*),1U));});});
out_dict=({struct Cyc_Dict_Dict _tmp3E9=out_dict;struct _fat_ptr*_tmp3E8=v;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k,void*v))Cyc_Dict_insert)(_tmp3E9,_tmp3E8,((void*(*)(struct Cyc_Dict_Dict d,struct _fat_ptr*k))Cyc_Dict_lookup)(new_dict,v));});}}}
# 1208
data->ordinaries=out_dict;
env->in_cinclude=old;
# 1213
goto _LL0;}}}case 5U: _LL1B: _LL1C:
# 1215
