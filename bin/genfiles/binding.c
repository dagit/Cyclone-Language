...
({union Cyc_Absyn_Nmspace _tmp296=({struct Cyc_List_List*_tmp295=(env->ns)->curr_ns;Cyc_Absyn_Abs_n(_tmp295,Cyc_Binding_in_cinclude(env)||(int)sc == 4);});(*qv).f1=_tmp296;});else{
# 279
