...
union Cyc_Absyn_Nmspace _tmp4=abs_ns;struct Cyc_List_List*_tmp5;struct Cyc_List_List*_tmp6;switch((_tmp4.Abs_n).tag){case 3: _tmp6=(_tmp4.C_n).val;{struct Cyc_List_List*vs=_tmp6;
...
({void*_tmp7=0U;({struct _fat_ptr _tmp316=({const char*_tmp8="Binding:get_ns_data: relative ns";_tag_fat(_tmp8,sizeof(char),33U);});Cyc_Warn_impos(_tmp316,_tag_fat(_tmp7,sizeof(void*),0));});});};}
# 81 "binding.cyc"
...
void*_tmpB=(void*)as->hd;void*_stmttmp0=_tmpB;void*_tmpC=_stmttmp0;struct Cyc_List_List*_tmpD;struct Cyc_List_List*_tmpE;if(*((int*)_tmpC)== 1){_tmpE=((struct Cyc_Binding_Using_Binding_NSDirective_struct*)_tmpC)->f1;{struct Cyc_List_List*ns=_tmpE;
_tmpD=ns;goto _LL4;}}else{_tmpD=((struct Cyc_Binding_Namespace_Binding_NSDirective_struct*)_tmpC)->f1;_LL4: {struct Cyc_List_List*ns=_tmpD;
# 91
...
struct _tuple0*_tmp18=qv;struct _fat_ptr*_tmp1A;union Cyc_Absyn_Nmspace _tmp19;_tmp19=_tmp18->f1;_tmp1A=_tmp18->f2;{union Cyc_Absyn_Nmspace ns=_tmp19;struct _fat_ptr*v=_tmp1A;
union Cyc_Absyn_Nmspace _tmp1B=ns;struct Cyc_List_List*_tmp1C;struct Cyc_List_List*_tmp1D;struct Cyc_List_List*_tmp1E;switch((_tmp1B.Abs_n).tag){case 1: if((_tmp1B.Rel_n).val == 0){
# 105
{struct _handler_cons _tmp1F;_push_handler(& _tmp1F);{int _tmp21=0;if(setjmp(_tmp1F.handler))_tmp21=1;if(!_tmp21){{void*_tmp22=({void*(*_tmp31D)(void*,struct _fat_ptr*)=lookup;void*_tmp31C=((void*(*)(struct Cyc_Dict_Dict,struct Cyc_List_List*))Cyc_Dict_lookup)(ctxt->ns_data,ctxt->curr_ns);_tmp31D(_tmp31C,v);});_npop_handler(0);return _tmp22;};_pop_handler();}else{void*_tmp20=(void*)Cyc_Core_get_exn_thrown();void*_tmp23=_tmp20;void*_tmp24;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp23)->tag == Cyc_Dict_Absent)
goto _LLE;else{_tmp24=_tmp23;{void*exn=_tmp24;(int)_rethrow(exn);}}_LLE:;}}}
{struct Cyc_List_List*_tmp25=ctxt->availables;struct Cyc_List_List*as=_tmp25;for(0;as != 0;as=as->tl){
void*_tmp26=(void*)as->hd;void*_stmttmp1=_tmp26;void*_tmp27=_stmttmp1;struct Cyc_List_List*_tmp28;struct Cyc_List_List*_tmp29;if(*((int*)_tmp27)== 1){_tmp29=((struct Cyc_Binding_Using_Binding_NSDirective_struct*)_tmp27)->f1;{struct Cyc_List_List*ns=_tmp29;
_tmp28=ns;goto _LL17;}}else{_tmp28=((struct Cyc_Binding_Namespace_Binding_NSDirective_struct*)_tmp27)->f1;_LL17: {struct Cyc_List_List*ns=_tmp28;
# 111
{struct _handler_cons _tmp2A;_push_handler(& _tmp2A);{int _tmp2C=0;if(setjmp(_tmp2A.handler))_tmp2C=1;if(!_tmp2C){{void*_tmp2D=({void*(*_tmp31F)(void*,struct _fat_ptr*)=lookup;void*_tmp31E=((void*(*)(struct Cyc_Dict_Dict,struct Cyc_List_List*))Cyc_Dict_lookup)(ctxt->ns_data,ns);_tmp31F(_tmp31E,v);});_npop_handler(0);return _tmp2D;};_pop_handler();}else{void*_tmp2B=(void*)Cyc_Core_get_exn_thrown();void*_tmp2E=_tmp2B;void*_tmp2F;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp2E)->tag == Cyc_Dict_Absent)
goto _LL18;else{_tmp2F=_tmp2E;{void*exn=_tmp2F;(int)_rethrow(exn);}}_LL18:;}}}
goto _LL13;}}_LL13:;}}
# 115
(int)_throw((void*)({struct Cyc_Binding_BindingError_exn_struct*_tmp30=_cycalloc(sizeof(*_tmp30));_tmp30->tag=Cyc_Binding_BindingError;_tmp30;}));}else{_tmp1E=(_tmp1B.Rel_n).val;{struct Cyc_List_List*ns=_tmp1E;
# 117
...
# 118
;_pop_handler();}else{void*_tmp32=(void*)Cyc_Core_get_exn_thrown();void*_tmp36=_tmp32;void*_tmp37;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp36)->tag == Cyc_Dict_Absent)
# 120
(int)_throw((void*)({struct Cyc_Binding_BindingError_exn_struct*_tmp38=_cycalloc(sizeof(*_tmp38));_tmp38->tag=Cyc_Binding_BindingError;_tmp38;}));else{_tmp37=_tmp36;{void*exn=_tmp37;(int)_rethrow(exn);}};}}}}case 3: _tmp1D=(_tmp1B.C_n).val;{struct Cyc_List_List*ns=_tmp1D;
_tmp1C=ns;goto _LLB;}case 2: _tmp1C=(_tmp1B.Abs_n).val;_LLB: {struct Cyc_List_List*ns=_tmp1C;
# 123
...
(int)_throw((void*)({struct Cyc_Binding_BindingError_exn_struct*_tmp3F=_cycalloc(sizeof(*_tmp3F));_tmp3F->tag=Cyc_Binding_BindingError;_tmp3F;}));else{_tmp3E=_tmp3D;{void*exn=_tmp3E;(int)_rethrow(exn);}};}}}default:
({void*_tmp40=0U;({struct _fat_ptr _tmp324=({const char*_tmp41="lookup local in global";_tag_fat(_tmp41,sizeof(char),23U);});Cyc_Warn_impos(_tmp324,_tag_fat(_tmp40,sizeof(void*),0));});});};}}
# 129
...
void*_tmp49=(void*)((struct Cyc_List_List*)_check_null(ctxt->availables))->hd;void*_stmttmp2=_tmp49;void*_tmp4A=_stmttmp2;if(*((int*)_tmp4A)== 0){
# 142
...
struct _tuple0*_tmp4D=usename;struct _fat_ptr*_tmp4F;union Cyc_Absyn_Nmspace _tmp4E;_tmp4E=_tmp4D->f1;_tmp4F=_tmp4D->f2;{union Cyc_Absyn_Nmspace nsl=_tmp4E;struct _fat_ptr*v=_tmp4F;
struct Cyc_List_List*ns;
{union Cyc_Absyn_Nmspace _tmp50=nsl;struct Cyc_List_List*_tmp51;struct Cyc_List_List*_tmp52;switch((_tmp50.Loc_n).tag){case 1: _tmp52=(_tmp50.Rel_n).val;{struct Cyc_List_List*vs=_tmp52;
# 154
...
goto _LL3;}}case 2: _tmp51=(_tmp50.Abs_n).val;{struct Cyc_List_List*vs=_tmp51;
# 159
...
goto _LL3;}case 4:
({void*_tmp56=0U;({struct _fat_ptr _tmp333=({const char*_tmp57="enter_using, Loc_n";_tag_fat(_tmp57,sizeof(char),19U);});Cyc_Warn_impos(_tmp333,_tag_fat(_tmp56,sizeof(void*),0));});});default:
...
void*_tmp5E=(void*)((struct Cyc_List_List*)_check_null(ctxt->availables))->hd;void*_stmttmp3=_tmp5E;void*_tmp5F=_stmttmp3;if(*((int*)_tmp5F)== 1){
...
struct _tuple0*_tmp63=qv;struct _fat_ptr*_tmp65;union Cyc_Absyn_Nmspace _tmp64;_tmp64=_tmp63->f1;_tmp65=_tmp63->f2;{union Cyc_Absyn_Nmspace nsl=_tmp64;struct _fat_ptr*v=_tmp65;
union Cyc_Absyn_Nmspace _tmp66=nsl;switch((_tmp66.Rel_n).tag){case 4:
# 245
...
return((void*(*)(struct Cyc_Dict_Dict,struct _fat_ptr*))Cyc_Dict_lookup)(*((struct Cyc_Dict_Dict*)_check_null(env->local_vars)),v);case 1: if((_tmp66.Rel_n).val == 0){
# 249
if(!Cyc_Binding_at_toplevel(env)&&((int(*)(struct Cyc_Dict_Dict,struct _fat_ptr*))Cyc_Dict_member)(*((struct Cyc_Dict_Dict*)_check_null(env->local_vars)),v))
...
union Cyc_Absyn_Nmspace _tmp68=(*qv).f1;union Cyc_Absyn_Nmspace _stmttmp4=_tmp68;union Cyc_Absyn_Nmspace _tmp69=_stmttmp4;switch((_tmp69.Abs_n).tag){case 1: if((_tmp69.Rel_n).val == 0){
# 276
...
{void*_tmp74=Cyc_Binding_lookup_ordinary(loc,env,q);void*_stmttmp5=_tmp74;void*_tmp75=_stmttmp5;void*_tmp76;switch(*((int*)_tmp75)){case 0: _tmp76=(void*)((struct Cyc_Binding_VarRes_Binding_Resolved_struct*)_tmp75)->f1;{void*b=_tmp76;
# 304
if(Cyc_Binding_at_toplevel(env)){
_npop_handler(0);return;}
{void*_tmp77=b;switch(*((int*)_tmp77)){case 1:
 hides_what=({const char*_tmp78="global variable";_tag_fat(_tmp78,sizeof(char),16U);});goto _LLB;case 4:
 hides_what=({const char*_tmp79="local variable";_tag_fat(_tmp79,sizeof(char),15U);});goto _LLB;case 3:
 hides_what=({const char*_tmp7A="parameter";_tag_fat(_tmp7A,sizeof(char),10U);});goto _LLB;case 5:
 hides_what=({const char*_tmp7B="pattern variable";_tag_fat(_tmp7B,sizeof(char),17U);});goto _LLB;case 2:
 hides_what=({const char*_tmp7C="function";_tag_fat(_tmp7C,sizeof(char),9U);});goto _LLB;default:
...
# 314
goto _LL0;}case 1:
 hides_what=({const char*_tmp7F="struct constructor";_tag_fat(_tmp7F,sizeof(char),19U);});goto _LL0;case 2:
 hides_what=({const char*_tmp80="datatype constructor";_tag_fat(_tmp80,sizeof(char),21U);});goto _LL0;case 3:
...
_npop_handler(0);return;
# 302
;_pop_handler();}else{void*_tmp72=(void*)Cyc_Core_get_exn_thrown();void*_tmp86=_tmp72;void*_tmp87;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp86)->tag == Cyc_Binding_BindingError)
# 322
return;else{_tmp87=_tmp86;{void*exn=_tmp87;(int)_rethrow(exn);}};}}}
# 325
...
struct _tuple0*_tmp88=vd->name;struct _tuple0*_stmttmp6=_tmp88;struct _tuple0*_tmp89=_stmttmp6;struct _fat_ptr*_tmp8B;union Cyc_Absyn_Nmspace _tmp8A;_tmp8A=_tmp89->f1;_tmp8B=_tmp89->f2;{union Cyc_Absyn_Nmspace decl_ns=_tmp8A;struct _fat_ptr*decl_name=_tmp8B;
...
void*_tmp91=s->r;void*_stmttmp7=_tmp91;void*_tmp92=_stmttmp7;struct Cyc_List_List*_tmp94;struct Cyc_Absyn_Stmt*_tmp93;struct Cyc_List_List*_tmp96;struct Cyc_Absyn_Exp*_tmp95;struct Cyc_Absyn_Stmt*_tmp98;struct Cyc_Absyn_Decl*_tmp97;struct Cyc_Absyn_Stmt*_tmp99;struct Cyc_List_List*_tmp9A;struct Cyc_Absyn_Stmt*_tmp9E;struct Cyc_Absyn_Exp*_tmp9D;struct Cyc_Absyn_Exp*_tmp9C;struct Cyc_Absyn_Exp*_tmp9B;struct Cyc_Absyn_Stmt*_tmpA0;struct Cyc_Absyn_Exp*_tmp9F;struct Cyc_Absyn_Exp*_tmpA2;struct Cyc_Absyn_Stmt*_tmpA1;struct Cyc_Absyn_Stmt*_tmpA5;struct Cyc_Absyn_Stmt*_tmpA4;struct Cyc_Absyn_Exp*_tmpA3;struct Cyc_Absyn_Exp*_tmpA6;struct Cyc_Absyn_Stmt*_tmpA8;struct Cyc_Absyn_Stmt*_tmpA7;struct Cyc_Absyn_Exp*_tmpA9;switch(*((int*)_tmp92)){case 0:
 return;case 1: _tmpA9=((struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*)_tmp92)->f1;{struct Cyc_Absyn_Exp*e=_tmpA9;
Cyc_Binding_resolve_exp(env,e);return;}case 2: _tmpA7=((struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp92)->f1;_tmpA8=((struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp92)->f2;{struct Cyc_Absyn_Stmt*s1=_tmpA7;struct Cyc_Absyn_Stmt*s2=_tmpA8;
Cyc_Binding_resolve_stmt(env,s1);Cyc_Binding_resolve_stmt(env,s2);return;}case 3: _tmpA6=((struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp92)->f1;{struct Cyc_Absyn_Exp*eopt=_tmpA6;
if((unsigned)eopt)Cyc_Binding_resolve_exp(env,eopt);return;}case 4: _tmpA3=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp92)->f1;_tmpA4=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp92)->f2;_tmpA5=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp92)->f3;{struct Cyc_Absyn_Exp*e=_tmpA3;struct Cyc_Absyn_Stmt*s1=_tmpA4;struct Cyc_Absyn_Stmt*s2=_tmpA5;
# 349
Cyc_Binding_resolve_exp(env,e);Cyc_Binding_resolve_stmt(env,s1);Cyc_Binding_resolve_stmt(env,s2);return;}case 14: _tmpA1=((struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp92)->f1;_tmpA2=(((struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp92)->f2).f1;{struct Cyc_Absyn_Stmt*s1=_tmpA1;struct Cyc_Absyn_Exp*e=_tmpA2;
_tmp9F=e;_tmpA0=s1;goto _LLE;}case 5: _tmp9F=(((struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*)_tmp92)->f1).f1;_tmpA0=((struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*)_tmp92)->f2;_LLE: {struct Cyc_Absyn_Exp*e=_tmp9F;struct Cyc_Absyn_Stmt*s1=_tmpA0;
Cyc_Binding_resolve_exp(env,e);Cyc_Binding_resolve_stmt(env,s1);return;}case 9: _tmp9B=((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp92)->f1;_tmp9C=(((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp92)->f2).f1;_tmp9D=(((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp92)->f3).f1;_tmp9E=((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp92)->f4;{struct Cyc_Absyn_Exp*e1=_tmp9B;struct Cyc_Absyn_Exp*e2=_tmp9C;struct Cyc_Absyn_Exp*e3=_tmp9D;struct Cyc_Absyn_Stmt*s1=_tmp9E;
# 353
...
return;}case 6:
 ...
 return;case 11: _tmp9A=((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp92)->f1;{struct Cyc_List_List*es=_tmp9A;
# 360
for(1;es != 0;es=es->tl){
Cyc_Binding_resolve_exp(env,(struct Cyc_Absyn_Exp*)es->hd);}
return;}case 13: _tmp99=((struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*)_tmp92)->f2;{struct Cyc_Absyn_Stmt*s1=_tmp99;
Cyc_Binding_resolve_stmt(env,s1);return;}case 12: _tmp97=((struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp92)->f1;_tmp98=((struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp92)->f2;{struct Cyc_Absyn_Decl*d=_tmp97;struct Cyc_Absyn_Stmt*s1=_tmp98;
# 365
...
return;}case 10: _tmp95=((struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp92)->f1;_tmp96=((struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp92)->f2;{struct Cyc_Absyn_Exp*e=_tmp95;struct Cyc_List_List*scs=_tmp96;
Cyc_Binding_resolve_exp(env,e);Cyc_Binding_resolve_scs(env,scs);return;}default: _tmp93=((struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*)_tmp92)->f1;_tmp94=((struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*)_tmp92)->f2;{struct Cyc_Absyn_Stmt*s1=_tmp93;struct Cyc_List_List*scs=_tmp94;
...
void*_tmp113=e1->r;void*_stmttmpB=_tmp113;void*_tmp114=_stmttmpB;void**_tmp115;if(*((int*)_tmp114)== 1){_tmp115=(void**)&((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp114)->f1;{void**b=_tmp115;
# 398
void*_tmp116=*b;void*_stmttmpC=_tmp116;void*_tmp117=_stmttmpC;struct _tuple0*_tmp118;if(*((int*)_tmp117)== 0){_tmp118=((struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*)_tmp117)->f1;{struct _tuple0*q=_tmp118;
# 400
struct _handler_cons _tmp119;_push_handler(& _tmp119);{int _tmp11B=0;if(setjmp(_tmp119.handler))_tmp11B=1;if(!_tmp11B){{void*_tmp11C=Cyc_Binding_lookup_ordinary(e1->loc,env,q);void*_stmttmpD=_tmp11C;void*_tmp11D=_stmttmpD;struct Cyc_Absyn_Datatypefield*_tmp11F;struct Cyc_Absyn_Datatypedecl*_tmp11E;struct Cyc_Absyn_Aggrdecl*_tmp120;void*_tmp121;switch(*((int*)_tmp11D)){case 0: _tmp121=(void*)((struct Cyc_Binding_VarRes_Binding_Resolved_struct*)_tmp11D)->f1;{void*bnd=_tmp121;
# 402
*b=bnd;_npop_handler(0);return;}case 1: _tmp120=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmp11D)->f1;{struct Cyc_Absyn_Aggrdecl*ad=_tmp120;
# 404
...
_npop_handler(0);return;}case 2: _tmp11E=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp11D)->f1;_tmp11F=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp11D)->f2;{struct Cyc_Absyn_Datatypedecl*tud=_tmp11E;struct Cyc_Absyn_Datatypefield*tuf=_tmp11F;
# 410
if(tuf->typs == 0)
# 412
...
# 417
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp12C=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F2;_tmp2F2.tag=1,_tmp2F2.f1=q;_tmp2F2;});struct Cyc_Warn_String_Warn_Warg_struct _tmp12D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F1;_tmp2F1.tag=0,({struct _fat_ptr _tmp35B=({const char*_tmp12E=" is an enum constructor, not a function";_tag_fat(_tmp12E,sizeof(char),40U);});_tmp2F1.f1=_tmp35B;});_tmp2F1;});void*_tmp12B[2];_tmp12B[0]=& _tmp12C,_tmp12B[1]=& _tmp12D;({unsigned _tmp35C=e->loc;Cyc_Warn_err2(_tmp35C,_tag_fat(_tmp12B,sizeof(void*),2));});});_npop_handler(0);return;};}
# 400
;_pop_handler();}else{void*_tmp11A=(void*)Cyc_Core_get_exn_thrown();void*_tmp12F=_tmp11A;void*_tmp130;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp12F)->tag == Cyc_Binding_BindingError){
# 419
({struct Cyc_Warn_String_Warn_Warg_struct _tmp132=({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F4;_tmp2F4.tag=0,({struct _fat_ptr _tmp35D=({const char*_tmp134="undeclared identifier ";_tag_fat(_tmp134,sizeof(char),23U);});_tmp2F4.f1=_tmp35D;});_tmp2F4;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp133=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp2F3;_tmp2F3.tag=1,_tmp2F3.f1=q;_tmp2F3;});void*_tmp131[2];_tmp131[0]=& _tmp132,_tmp131[1]=& _tmp133;({unsigned _tmp35E=e->loc;Cyc_Warn_err2(_tmp35E,_tag_fat(_tmp131,sizeof(void*),2));});});return;}else{_tmp130=_tmp12F;{void*exn=_tmp130;(int)_rethrow(exn);}};}}}}else{
# 421
return;};}}else{
# 423
Cyc_Binding_resolve_exp(env,e1);return;};}}case 29: _tmpED=(struct _tuple0**)&((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpEE=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_tmpEF=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmpAC)->f3;_tmpF0=(struct Cyc_Absyn_Aggrdecl**)&((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmpAC)->f4;{struct _tuple0**tn=_tmpED;struct Cyc_List_List*ts=_tmpEE;struct Cyc_List_List*dles=_tmpEF;struct Cyc_Absyn_Aggrdecl**adopt=_tmpF0;
# 427
...
_npop_handler(0);return;
# 430
;_pop_handler();}else{void*_tmp136=(void*)Cyc_Core_get_exn_thrown();void*_tmp138=_tmp136;void*_tmp139;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp138)->tag == Cyc_Binding_BindingError){
# 434
...
return;}else{_tmp139=_tmp138;{void*exn=_tmp139;(int)_rethrow(exn);}};}}}}case 27: _tmpEA=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpEB=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_tmpEC=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpAC)->f3;{struct Cyc_Absyn_Vardecl*vd=_tmpEA;struct Cyc_Absyn_Exp*e1=_tmpEB;struct Cyc_Absyn_Exp*e2=_tmpEC;
# 439
...
Cyc_Binding_resolve_exp(env,e2);
*((struct Cyc_Dict_Dict*)_check_null(env->local_vars))=old_locals;
return;}}case 36: _tmpE9=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;{struct Cyc_List_List*dles=_tmpE9;
# 455
for(1;dles != 0;dles=dles->tl){
Cyc_Binding_resolve_exp(env,(*((struct _tuple11*)dles->hd)).f2);}
return;}case 28: _tmpE7=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpE8=(void*)((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;{struct Cyc_Absyn_Exp*e1=_tmpE7;void*t=_tmpE8;
# 461
Cyc_Binding_resolve_exp(env,e1);
...
# 465
 ...
 return;case 24: _tmpE6=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;{struct Cyc_List_List*es=_tmpE6;
# 468
_tmpE5=es;goto _LL14;}case 3: _tmpE5=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL14: {struct Cyc_List_List*es=_tmpE5;
# 470
for(1;es != 0;es=es->tl){
Cyc_Binding_resolve_exp(env,(struct Cyc_Absyn_Exp*)es->hd);}
return;}case 42: _tmpE4=((struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;{struct Cyc_Absyn_Exp*e1=_tmpE4;
# 474
_tmpE3=e1;goto _LL18;}case 41: _tmpE3=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL18: {struct Cyc_Absyn_Exp*e1=_tmpE3;
_tmpE2=e1;goto _LL1A;}case 38: _tmpE2=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL1A: {struct Cyc_Absyn_Exp*e1=_tmpE2;
_tmpE1=e1;goto _LL1C;}case 12: _tmpE1=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL1C: {struct Cyc_Absyn_Exp*e1=_tmpE1;
_tmpE0=e1;goto _LL1E;}case 18: _tmpE0=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL1E: {struct Cyc_Absyn_Exp*e1=_tmpE0;
_tmpDF=e1;goto _LL20;}case 11: _tmpDF=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL20: {struct Cyc_Absyn_Exp*e1=_tmpDF;
_tmpDE=e1;goto _LL22;}case 5: _tmpDE=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL22: {struct Cyc_Absyn_Exp*e1=_tmpDE;
_tmpDD=e1;goto _LL24;}case 22: _tmpDD=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL24: {struct Cyc_Absyn_Exp*e1=_tmpDD;
_tmpDC=e1;goto _LL26;}case 21: _tmpDC=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL26: {struct Cyc_Absyn_Exp*e1=_tmpDC;
_tmpDB=e1;goto _LL28;}case 15: _tmpDB=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL28: {struct Cyc_Absyn_Exp*e1=_tmpDB;
_tmpDA=e1;goto _LL2A;}case 20: _tmpDA=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL2A: {struct Cyc_Absyn_Exp*e1=_tmpDA;
Cyc_Binding_resolve_exp(env,e1);return;}case 35: _tmpD8=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpD9=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;{struct Cyc_Absyn_Exp*e1=_tmpD8;struct Cyc_Absyn_Exp*e2=_tmpD9;
# 486
_tmpD6=e1;_tmpD7=e2;goto _LL2E;}case 9: _tmpD6=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpD7=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL2E: {struct Cyc_Absyn_Exp*e1=_tmpD6;struct Cyc_Absyn_Exp*e2=_tmpD7;
_tmpD4=e1;_tmpD5=e2;goto _LL30;}case 4: _tmpD4=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpD5=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpAC)->f3;_LL30: {struct Cyc_Absyn_Exp*e1=_tmpD4;struct Cyc_Absyn_Exp*e2=_tmpD5;
_tmpD2=e1;_tmpD3=e2;goto _LL32;}case 23: _tmpD2=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpD3=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL32: {struct Cyc_Absyn_Exp*e1=_tmpD2;struct Cyc_Absyn_Exp*e2=_tmpD3;
_tmpD0=e1;_tmpD1=e2;goto _LL34;}case 7: _tmpD0=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpD1=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL34: {struct Cyc_Absyn_Exp*e1=_tmpD0;struct Cyc_Absyn_Exp*e2=_tmpD1;
_tmpCE=e1;_tmpCF=e2;goto _LL36;}case 8: _tmpCE=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpCF=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_LL36: {struct Cyc_Absyn_Exp*e1=_tmpCE;struct Cyc_Absyn_Exp*e2=_tmpCF;
Cyc_Binding_resolve_exp(env,e1);Cyc_Binding_resolve_exp(env,e2);return;}case 34: _tmpCB=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpAC)->f1).rgn;_tmpCC=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpAC)->f1).elt_type;_tmpCD=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpAC)->f1).num_elts;{struct Cyc_Absyn_Exp*eo=_tmpCB;void**to=_tmpCC;struct Cyc_Absyn_Exp*e1=_tmpCD;
# 494
if(eo != 0)Cyc_Binding_resolve_exp(env,eo);
if(to != 0)Cyc_Binding_resolve_type(e->loc,env,*to);
Cyc_Binding_resolve_exp(env,e1);
return;}case 16: _tmpC9=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpCA=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;{struct Cyc_Absyn_Exp*eo=_tmpC9;struct Cyc_Absyn_Exp*e2=_tmpCA;
# 500
if(eo != 0)Cyc_Binding_resolve_exp(env,eo);
Cyc_Binding_resolve_exp(env,e2);
return;}case 6: _tmpC6=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpC7=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_tmpC8=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpAC)->f3;{struct Cyc_Absyn_Exp*e1=_tmpC6;struct Cyc_Absyn_Exp*e2=_tmpC7;struct Cyc_Absyn_Exp*e3=_tmpC8;
# 505
Cyc_Binding_resolve_exp(env,e1);Cyc_Binding_resolve_exp(env,e2);Cyc_Binding_resolve_exp(env,e3);return;}case 13: _tmpC4=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpC5=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;{struct Cyc_Absyn_Exp*e1=_tmpC4;struct Cyc_List_List*ts=_tmpC5;
# 508
Cyc_Binding_resolve_exp(env,e1);
for(1;ts != 0;ts=ts->tl){
Cyc_Binding_resolve_type(e->loc,env,(void*)ts->hd);}
return;}case 14: _tmpC2=(void*)((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpC3=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;{void*t=_tmpC2;struct Cyc_Absyn_Exp*e1=_tmpC3;
# 514
Cyc_Binding_resolve_exp(env,e1);Cyc_Binding_resolve_type(e->loc,env,t);return;}case 37: _tmpC1=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;{struct Cyc_Absyn_Stmt*s=_tmpC1;
# 516
Cyc_Binding_resolve_stmt(env,s);return;}case 39: _tmpC0=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;{void*t=_tmpC0;
# 518
_tmpBF=t;goto _LL46;}case 19: _tmpBF=(void*)((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL46: {void*t=_tmpBF;
_tmpBE=t;goto _LL48;}case 17: _tmpBE=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL48: {void*t=_tmpBE;
Cyc_Binding_resolve_type(e->loc,env,t);return;}case 25: _tmpBC=(((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmpAC)->f1)->f3;_tmpBD=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;{void*t=_tmpBC;struct Cyc_List_List*dles=_tmpBD;
# 523
Cyc_Binding_resolve_type(e->loc,env,t);
_tmpBB=dles;goto _LL4C;}case 26: _tmpBB=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_LL4C: {struct Cyc_List_List*dles=_tmpBB;
# 527
for(1;dles != 0;dles=dles->tl){
Cyc_Binding_resolve_exp(env,(*((struct _tuple11*)dles->hd)).f2);}
return;}case 33: _tmpB9=(void*)((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpBA=((struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;{void*t=_tmpB9;struct Cyc_Absyn_Enumfield*ef=_tmpBA;
# 532
Cyc_Binding_resolve_type(e->loc,env,t);return;}case 32: _tmpB7=((struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpB8=((struct Cyc_Absyn_Enum_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;{struct Cyc_Absyn_Enumdecl*ed=_tmpB7;struct Cyc_Absyn_Enumfield*ef=_tmpB8;
return;}case 31: _tmpB4=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpB5=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_tmpB6=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmpAC)->f3;{struct Cyc_List_List*es=_tmpB4;struct Cyc_Absyn_Datatypedecl*tud=_tmpB5;struct Cyc_Absyn_Datatypefield*tuf=_tmpB6;
# 535
for(1;es != 0;es=es->tl){
Cyc_Binding_resolve_exp(env,(struct Cyc_Absyn_Exp*)es->hd);}
return;}case 30: _tmpB2=(void*)((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpB3=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;{void*t=_tmpB2;struct Cyc_List_List*dles=_tmpB3;
# 539
Cyc_Binding_resolve_type(e->loc,env,t);
for(1;dles != 0;dles=dles->tl){
Cyc_Binding_resolve_exp(env,(*((struct _tuple11*)dles->hd)).f2);}
return;}default: _tmpAD=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpAC)->f1;_tmpAE=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpAC)->f2;_tmpAF=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpAC)->f3;_tmpB0=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpAC)->f4;_tmpB1=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpAC)->f5;{int v=_tmpAD;struct _fat_ptr t=_tmpAE;struct Cyc_List_List*o=_tmpAF;struct Cyc_List_List*i=_tmpB0;struct Cyc_List_List*c=_tmpB1;
# 545
...
while((unsigned)l){
struct _tuple12*_tmp140=(struct _tuple12*)l->hd;struct _tuple12*_stmttmpE=_tmp140;struct _tuple12*_tmp141=_stmttmpE;struct Cyc_Absyn_Exp*_tmp142;_tmp142=_tmp141->f2;{struct Cyc_Absyn_Exp*e=_tmp142;
...
_npop_handler(0);return;}
# 651
;_pop_handler();}else{void*_tmp191=(void*)Cyc_Core_get_exn_thrown();void*_tmp194=_tmp191;void*_tmp195;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp194)->tag == Cyc_Binding_BindingError){
# 655
Cyc_Binding_absolutize_topdecl(loc,env,qv,Cyc_Absyn_Public);return;}else{_tmp195=_tmp194;{void*exn=_tmp195;(int)_rethrow(exn);}};}}}}else{
return;};}}case 19: _tmp188=(union Cyc_Absyn_DatatypeFieldInfo*)&((struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f1)->f1;_tmp189=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f2;{union Cyc_Absyn_DatatypeFieldInfo*info=_tmp188;struct Cyc_List_List*targs=_tmp189;
# 659
for(1;targs != 0;targs=targs->tl){
Cyc_Binding_resolve_type(loc,env,(void*)targs->hd);}{
union Cyc_Absyn_DatatypeFieldInfo _tmp196=*info;union Cyc_Absyn_DatatypeFieldInfo _stmttmp14=_tmp196;union Cyc_Absyn_DatatypeFieldInfo _tmp197=_stmttmp14;int _tmp19A;struct _tuple0*_tmp199;struct _tuple0*_tmp198;if((_tmp197.UnknownDatatypefield).tag == 1){_tmp198=((_tmp197.UnknownDatatypefield).val).datatype_name;_tmp199=((_tmp197.UnknownDatatypefield).val).field_name;_tmp19A=((_tmp197.UnknownDatatypefield).val).is_extensible;{struct _tuple0*qvd=_tmp198;struct _tuple0*qvf=_tmp199;int b=_tmp19A;
# 665
{struct _handler_cons _tmp19B;_push_handler(& _tmp19B);{int _tmp19D=0;if(setjmp(_tmp19B.handler))_tmp19D=1;if(!_tmp19D){
{void*_tmp19E=Cyc_Binding_lookup_ordinary(loc,env,qvf);void*_stmttmp15=_tmp19E;void*_tmp19F=_stmttmp15;struct Cyc_Absyn_Datatypefield*_tmp1A1;struct Cyc_Absyn_Datatypedecl*_tmp1A0;if(*((int*)_tmp19F)== 2){_tmp1A0=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp19F)->f1;_tmp1A1=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp19F)->f2;{struct Cyc_Absyn_Datatypedecl*tud=_tmp1A0;struct Cyc_Absyn_Datatypefield*tuf=_tmp1A1;
# 668
...
goto _LL34;}_LL34:;}
# 666
;_pop_handler();}else{void*_tmp19C=(void*)Cyc_Core_get_exn_thrown();void*_tmp1AD=_tmp19C;void*_tmp1AE;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp1AD)->tag == Cyc_Binding_BindingError)
# 679
goto _LL39;else{_tmp1AE=_tmp1AD;{void*exn=_tmp1AE;(int)_rethrow(exn);}}_LL39:;}}}
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1B0=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp301;_tmp301.tag=1,_tmp301.f1=qvf;_tmp301;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1B1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp300;_tmp300.tag=0,({struct _fat_ptr _tmp374=({const char*_tmp1B2=" is not a datatype field";_tag_fat(_tmp1B2,sizeof(char),25U);});_tmp300.f1=_tmp374;});_tmp300;});void*_tmp1AF[2];_tmp1AF[0]=& _tmp1B0,_tmp1AF[1]=& _tmp1B1;({unsigned _tmp375=loc;Cyc_Warn_err2(_tmp375,_tag_fat(_tmp1AF,sizeof(void*),2));});});return;}}else{
return;};}}case 20: _tmp186=(union Cyc_Absyn_AggrInfo*)&((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f1)->f1;_tmp187=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f2;{union Cyc_Absyn_AggrInfo*info=_tmp186;struct Cyc_List_List*targs=_tmp187;
# 685
for(1;targs != 0;targs=targs->tl){
Cyc_Binding_resolve_type(loc,env,(void*)targs->hd);}{
union Cyc_Absyn_AggrInfo _tmp1B3=*info;union Cyc_Absyn_AggrInfo _stmttmp16=_tmp1B3;union Cyc_Absyn_AggrInfo _tmp1B4=_stmttmp16;struct Cyc_Core_Opt*_tmp1B7;struct _tuple0*_tmp1B6;enum Cyc_Absyn_AggrKind _tmp1B5;if((_tmp1B4.UnknownAggr).tag == 1){_tmp1B5=((_tmp1B4.UnknownAggr).val).f1;_tmp1B6=((_tmp1B4.UnknownAggr).val).f2;_tmp1B7=((_tmp1B4.UnknownAggr).val).f3;{enum Cyc_Absyn_AggrKind ak=_tmp1B5;struct _tuple0*qv=_tmp1B6;struct Cyc_Core_Opt*bo=_tmp1B7;
# 689
...
_npop_handler(0);return;}
# 690
;_pop_handler();}else{void*_tmp1B9=(void*)Cyc_Core_get_exn_thrown();void*_tmp1C2=_tmp1B9;void*_tmp1C3;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp1C2)->tag == Cyc_Binding_BindingError){
# 699
Cyc_Binding_absolutize_topdecl(loc,env,qv,Cyc_Absyn_Public);return;}else{_tmp1C3=_tmp1C2;{void*exn=_tmp1C3;(int)_rethrow(exn);}};}}}}else{
return;};}}case 15: _tmp184=(struct _tuple0**)&((struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f1)->f1;_tmp185=((struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f1)->f2;{struct _tuple0**qv=_tmp184;struct Cyc_Absyn_Enumdecl*edo=_tmp185;
# 703
if(edo != 0)
return;{
...
_npop_handler(0);return;}
# 706
;_pop_handler();}else{void*_tmp1C5=(void*)Cyc_Core_get_exn_thrown();void*_tmp1C8=_tmp1C5;void*_tmp1C9;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp1C8)->tag == Cyc_Binding_BindingError){
# 710
Cyc_Binding_absolutize_topdecl(loc,env,*qv,Cyc_Absyn_Public);return;}else{_tmp1C9=_tmp1C8;{void*exn=_tmp1C9;(int)_rethrow(exn);}};}}}}case 16: _tmp183=((struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f1)->f1;{struct Cyc_List_List*fs=_tmp183;
# 748
...
# 756
return;}default: if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f2 == 0){_LL16:
# 760
 return;}else{_tmp181=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f1;_tmp182=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp170)->f2;{void*c=_tmp181;struct Cyc_List_List*ts=_tmp182;
# 762
for(1;ts != 0;ts=ts->tl){
Cyc_Binding_resolve_type(loc,env,(void*)ts->hd);}
return;}}}case 8: _tmp17E=(struct _tuple0**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp170)->f1;_tmp17F=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp170)->f2;_tmp180=(struct Cyc_Absyn_Typedefdecl**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp170)->f3;{struct _tuple0**tdn=_tmp17E;struct Cyc_List_List*targs=_tmp17F;struct Cyc_Absyn_Typedefdecl**tdo=_tmp180;
# 713
for(1;targs != 0;targs=targs->tl){
Cyc_Binding_resolve_type(loc,env,(void*)targs->hd);}
...
_npop_handler(0);return;}
# 716
;_pop_handler();}else{void*_tmp1CB=(void*)Cyc_Core_get_exn_thrown();void*_tmp1CE=_tmp1CB;void*_tmp1CF;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp1CE)->tag == Cyc_Binding_BindingError)
# 720
goto _LL4D;else{_tmp1CF=_tmp1CE;{void*exn=_tmp1CF;(int)_rethrow(exn);}}_LL4D:;}}}
...
return;}case 10: _tmp17C=((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp170)->f1;_tmp17D=(void***)&((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp170)->f2;{struct Cyc_Absyn_TypeDecl*td=_tmp17C;void***to=_tmp17D;
# 726
struct Cyc_Dict_Dict*_tmp1D4=env->local_vars;struct Cyc_Dict_Dict*old_locals=_tmp1D4;
env->local_vars=0;
{void*_tmp1D5=td->r;void*_stmttmp17=_tmp1D5;void*_tmp1D6=_stmttmp17;struct Cyc_Absyn_Datatypedecl*_tmp1D7;struct Cyc_Absyn_Enumdecl*_tmp1D8;struct Cyc_Absyn_Aggrdecl*_tmp1D9;switch(*((int*)_tmp1D6)){case 0: _tmp1D9=((struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)_tmp1D6)->f1;{struct Cyc_Absyn_Aggrdecl*ad=_tmp1D9;
# 730
({struct Cyc_Binding_Env*_tmp383=env;Cyc_Binding_resolve_decl(_tmp383,({struct Cyc_Absyn_Decl*_tmp1DB=_cycalloc(sizeof(*_tmp1DB));({void*_tmp382=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp1DA=_cycalloc(sizeof(*_tmp1DA));_tmp1DA->tag=5,_tmp1DA->f1=ad;_tmp1DA;});_tmp1DB->r=_tmp382;}),_tmp1DB->loc=td->loc;_tmp1DB;}));});goto _LL52;}case 1: _tmp1D8=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)_tmp1D6)->f1;{struct Cyc_Absyn_Enumdecl*ed=_tmp1D8;
# 732
({struct Cyc_Binding_Env*_tmp385=env;Cyc_Binding_resolve_decl(_tmp385,({struct Cyc_Absyn_Decl*_tmp1DD=_cycalloc(sizeof(*_tmp1DD));({void*_tmp384=(void*)({struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*_tmp1DC=_cycalloc(sizeof(*_tmp1DC));_tmp1DC->tag=7,_tmp1DC->f1=ed;_tmp1DC;});_tmp1DD->r=_tmp384;}),_tmp1DD->loc=td->loc;_tmp1DD;}));});goto _LL52;}default: _tmp1D7=((struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)_tmp1D6)->f1;{struct Cyc_Absyn_Datatypedecl*tud=_tmp1D7;
# 734
...
# 736
env->local_vars=old_locals;
return;}case 7: _tmp17B=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp170)->f2;{struct Cyc_List_List*fs=_tmp17B;
# 743
Cyc_Binding_resolve_aggrfields(loc,env,fs);
return;}case 1: _tmp17A=(void*)((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp170)->f2;{void*to=_tmp17A;
# 757
if(to != 0)Cyc_Binding_resolve_type(loc,env,to);return;}case 2:
# 759
 goto _LL16;case 3: _tmp177=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp170)->f1).elt_type;_tmp178=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp170)->f1).ptr_atts).rgn;_tmp179=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp170)->f1).ptr_atts).bounds;{void*t1=_tmp177;void*t2=_tmp178;void*bds=_tmp179;
# 767
Cyc_Binding_resolve_type(loc,env,t1);
Cyc_Binding_resolve_type(loc,env,t2);
Cyc_Binding_resolve_type(loc,env,bds);
return;}case 6: _tmp176=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp170)->f1;{struct Cyc_List_List*tqts=_tmp176;
# 773
for(1;tqts != 0;tqts=tqts->tl){
Cyc_Binding_resolve_type(loc,env,(*((struct _tuple13*)tqts->hd)).f2);}
return;}case 4: _tmp174=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp170)->f1).elt_type;_tmp175=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp170)->f1).num_elts;{void*t1=_tmp174;struct Cyc_Absyn_Exp*eo=_tmp175;
# 777
Cyc_Binding_resolve_type(loc,env,t1);
if(eo != 0)Cyc_Binding_resolve_exp(env,eo);
return;}case 5: _tmp173=(struct Cyc_Absyn_FnInfo*)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp170)->f1;{struct Cyc_Absyn_FnInfo*i=_tmp173;
# 784
...
env->local_vars=old_locals;
return;}case 9: _tmp172=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp170)->f1;{struct Cyc_Absyn_Exp*e=_tmp172;
# 799
_tmp171=e;goto _LL24;}default: _tmp171=((struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_tmp170)->f1;_LL24: {struct Cyc_Absyn_Exp*e=_tmp171;
...
struct Cyc_Absyn_Pat*_tmp1EA=p;unsigned _tmp1EC;void*_tmp1EB;_tmp1EB=_tmp1EA->r;_tmp1EC=_tmp1EA->loc;{void*r=_tmp1EB;unsigned loc=_tmp1EC;
void*_tmp1ED=r;struct Cyc_List_List*_tmp1EE;struct Cyc_Absyn_Exp*_tmp1EF;struct Cyc_List_List*_tmp1F0;struct Cyc_Absyn_Pat*_tmp1F1;struct Cyc_Absyn_Vardecl*_tmp1F2;struct Cyc_Absyn_Vardecl*_tmp1F3;struct Cyc_Absyn_Pat*_tmp1F5;struct Cyc_Absyn_Vardecl*_tmp1F4;struct Cyc_Absyn_Pat*_tmp1F7;struct Cyc_Absyn_Vardecl*_tmp1F6;struct Cyc_List_List*_tmp1F8;struct Cyc_List_List*_tmp1F9;int _tmp1FD;struct Cyc_List_List*_tmp1FC;struct Cyc_List_List*_tmp1FB;struct _tuple0*_tmp1FA;int _tmp200;struct Cyc_List_List*_tmp1FF;struct _tuple0*_tmp1FE;struct _tuple0*_tmp201;switch(*((int*)_tmp1ED)){case 15: _tmp201=((struct Cyc_Absyn_UnknownId_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;{struct _tuple0*qv=_tmp201;
# 808
{struct _handler_cons _tmp202;_push_handler(& _tmp202);{int _tmp204=0;if(setjmp(_tmp202.handler))_tmp204=1;if(!_tmp204){{void*_tmp205=Cyc_Binding_lookup_ordinary(loc,env,qv);void*_stmttmp18=_tmp205;void*_tmp206=_stmttmp18;struct Cyc_Absyn_Enumfield*_tmp208;void*_tmp207;struct Cyc_Absyn_Enumfield*_tmp20A;struct Cyc_Absyn_Enumdecl*_tmp209;struct Cyc_Absyn_Datatypefield*_tmp20C;struct Cyc_Absyn_Datatypedecl*_tmp20B;switch(*((int*)_tmp206)){case 0:
 goto _LL2C;case 1:
# 811
({struct Cyc_Warn_String_Warn_Warg_struct _tmp20E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp306;_tmp306.tag=0,({struct _fat_ptr _tmp38F=({const char*_tmp20F="struct tag used without arguments in pattern";_tag_fat(_tmp20F,sizeof(char),45U);});_tmp306.f1=_tmp38F;});_tmp306;});void*_tmp20D[1];_tmp20D[0]=& _tmp20E;({unsigned _tmp390=loc;Cyc_Warn_err2(_tmp390,_tag_fat(_tmp20D,sizeof(void*),1));});});_npop_handler(0);return;case 2: _tmp20B=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp206)->f1;_tmp20C=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp206)->f2;{struct Cyc_Absyn_Datatypedecl*tud=_tmp20B;struct Cyc_Absyn_Datatypefield*tuf=_tmp20C;
# 813
({void*_tmp391=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp210=_cycalloc(sizeof(*_tmp210));_tmp210->tag=8,_tmp210->f1=tud,_tmp210->f2=tuf,_tmp210->f3=0,_tmp210->f4=0;_tmp210;});p->r=_tmp391;});_npop_handler(0);return;}case 3: _tmp209=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp206)->f1;_tmp20A=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp206)->f2;{struct Cyc_Absyn_Enumdecl*ed=_tmp209;struct Cyc_Absyn_Enumfield*ef=_tmp20A;
# 815
({void*_tmp392=(void*)({struct Cyc_Absyn_Enum_p_Absyn_Raw_pat_struct*_tmp211=_cycalloc(sizeof(*_tmp211));_tmp211->tag=13,_tmp211->f1=ed,_tmp211->f2=ef;_tmp211;});p->r=_tmp392;});_npop_handler(0);return;}default: _tmp207=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp206)->f1;_tmp208=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp206)->f2;{void*t=_tmp207;struct Cyc_Absyn_Enumfield*ef=_tmp208;
# 817
...
# 808
;_pop_handler();}else{void*_tmp203=(void*)Cyc_Core_get_exn_thrown();void*_tmp213=_tmp203;void*_tmp214;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp213)->tag == Cyc_Binding_BindingError)
# 818
goto _LL37;else{_tmp214=_tmp213;{void*exn=_tmp214;(int)_rethrow(exn);}}_LL37:;}}}{
...
return;}}case 16: _tmp1FE=((struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;_tmp1FF=((struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_tmp200=((struct Cyc_Absyn_UnknownCall_p_Absyn_Raw_pat_struct*)_tmp1ED)->f3;{struct _tuple0*qv=_tmp1FE;struct Cyc_List_List*ps=_tmp1FF;int dots=_tmp200;
# 825
...
{struct _handler_cons _tmp218;_push_handler(& _tmp218);{int _tmp21A=0;if(setjmp(_tmp218.handler))_tmp21A=1;if(!_tmp21A){{void*_tmp21B=Cyc_Binding_lookup_ordinary(loc,env,qv);void*_stmttmp19=_tmp21B;void*_tmp21C=_stmttmp19;struct Cyc_Absyn_Datatypefield*_tmp21E;struct Cyc_Absyn_Datatypedecl*_tmp21D;struct Cyc_Absyn_Aggrdecl*_tmp21F;switch(*((int*)_tmp21C)){case 0:
 goto _LL3C;case 1: _tmp21F=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmp21C)->f1;{struct Cyc_Absyn_Aggrdecl*ad=_tmp21F;
# 830
...
_npop_handler(0);return;}case 2: _tmp21D=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp21C)->f1;_tmp21E=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp21C)->f2;{struct Cyc_Absyn_Datatypedecl*tud=_tmp21D;struct Cyc_Absyn_Datatypefield*tuf=_tmp21E;
# 836
({void*_tmp39B=(void*)({struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*_tmp226=_cycalloc(sizeof(*_tmp226));_tmp226->tag=8,_tmp226->f1=tud,_tmp226->f2=tuf,_tmp226->f3=ps,_tmp226->f4=dots;_tmp226;});p->r=_tmp39B;});_npop_handler(0);return;}case 3:
...
# 827
;_pop_handler();}else{void*_tmp219=(void*)Cyc_Core_get_exn_thrown();void*_tmp22A=_tmp219;void*_tmp22B;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp22A)->tag == Cyc_Binding_BindingError)
# 840
goto _LL47;else{_tmp22B=_tmp22A;{void*exn=_tmp22B;(int)_rethrow(exn);}}_LL47:;}}}
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp22D=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp309;_tmp309.tag=1,_tmp309.f1=qv;_tmp309;});struct Cyc_Warn_String_Warn_Warg_struct _tmp22E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp308;_tmp308.tag=0,({struct _fat_ptr _tmp39E=({const char*_tmp22F=" is not a constructor in pattern";_tag_fat(_tmp22F,sizeof(char),33U);});_tmp308.f1=_tmp39E;});_tmp308;});void*_tmp22C[2];_tmp22C[0]=& _tmp22D,_tmp22C[1]=& _tmp22E;({unsigned _tmp39F=loc;Cyc_Warn_err2(_tmp39F,_tag_fat(_tmp22C,sizeof(void*),2));});});return;}case 7: if(((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1 != 0){if((((union Cyc_Absyn_AggrInfo*)((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1)->UnknownAggr).tag == 1){_tmp1FA=(((((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1)->UnknownAggr).val).f2;_tmp1FB=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_tmp1FC=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f3;_tmp1FD=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f4;{struct _tuple0*n=_tmp1FA;struct Cyc_List_List*exist_ts=_tmp1FB;struct Cyc_List_List*dps=_tmp1FC;int dots=_tmp1FD;
# 844
...
# 847
;_pop_handler();}else{void*_tmp232=(void*)Cyc_Core_get_exn_thrown();void*_tmp238=_tmp232;void*_tmp239;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp238)->tag == Cyc_Binding_BindingError){
# 850
({struct Cyc_Warn_String_Warn_Warg_struct _tmp23B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp30A;_tmp30A.tag=0,({struct _fat_ptr _tmp3A3=({const char*_tmp23C="non-aggregate name has designator patterns";_tag_fat(_tmp23C,sizeof(char),43U);});_tmp30A.f1=_tmp3A3;});_tmp30A;});void*_tmp23A[1];_tmp23A[0]=& _tmp23B;({unsigned _tmp3A4=loc;Cyc_Warn_err2(_tmp3A4,_tag_fat(_tmp23A,sizeof(void*),1));});});return;}else{_tmp239=_tmp238;{void*exn=_tmp239;(int)_rethrow(exn);}};}}}
# 852
return;}}else{_tmp1F9=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f3;_LL25: {struct Cyc_List_List*dps=_tmp1F9;
# 881
for(1;dps != 0;dps=dps->tl){
Cyc_Binding_resolve_pat(env,(*((struct _tuple14*)dps->hd)).f2);}
return;}}}else{_tmp1F8=((struct Cyc_Absyn_Aggr_p_Absyn_Raw_pat_struct*)_tmp1ED)->f3;{struct Cyc_List_List*dps=_tmp1F8;
# 879
_tmp1F9=dps;goto _LL25;}}case 0:
# 854
 return;case 3: _tmp1F6=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;_tmp1F7=((struct Cyc_Absyn_Reference_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;{struct Cyc_Absyn_Vardecl*vd=_tmp1F6;struct Cyc_Absyn_Pat*p2=_tmp1F7;
# 856
_tmp1F4=vd;_tmp1F5=p2;goto _LLF;}case 1: _tmp1F4=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;_tmp1F5=((struct Cyc_Absyn_Var_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_LLF: {struct Cyc_Absyn_Vardecl*vd=_tmp1F4;struct Cyc_Absyn_Pat*p2=_tmp1F5;
# 858
Cyc_Binding_resolve_pat(env,p2);
_tmp1F3=vd;goto _LL11;}case 4: _tmp1F3=((struct Cyc_Absyn_TagInt_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_LL11: {struct Cyc_Absyn_Vardecl*vd=_tmp1F3;
_tmp1F2=vd;goto _LL13;}case 2: _tmp1F2=((struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*)_tmp1ED)->f2;_LL13: {struct Cyc_Absyn_Vardecl*vd=_tmp1F2;
# 862
Cyc_Binding_resolve_and_add_vardecl(loc,env,vd);goto _LL3;}case 6: _tmp1F1=((struct Cyc_Absyn_Pointer_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;{struct Cyc_Absyn_Pat*p2=_tmp1F1;
# 864
Cyc_Binding_resolve_pat(env,p2);return;}case 5: _tmp1F0=((struct Cyc_Absyn_Tuple_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;{struct Cyc_List_List*ps=_tmp1F0;
# 866
for(1;ps != 0;ps=ps->tl){
Cyc_Binding_resolve_pat(env,(struct Cyc_Absyn_Pat*)ps->hd);}
goto _LL3;}case 17: _tmp1EF=((struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*)_tmp1ED)->f1;{struct Cyc_Absyn_Exp*e=_tmp1EF;
# 870
...
# 872
 ...
 return;case 8: _tmp1EE=((struct Cyc_Absyn_Datatype_p_Absyn_Raw_pat_struct*)_tmp1ED)->f3;{struct Cyc_List_List*ps=_tmp1EE;
# 885
for(1;ps != 0;ps=ps->tl){
Cyc_Binding_resolve_pat(env,(struct Cyc_Absyn_Pat*)ps->hd);}
return;}case 13:
...
# 904
struct _tuple16*_tmp23D=cenv;struct Cyc_List_List*_tmp242;unsigned _tmp241;struct Cyc_Binding_Env*_tmp240;struct Cyc_Dict_Dict*_tmp23F;struct Cyc_List_List**_tmp23E;_tmp23E=_tmp23D->f1;_tmp23F=_tmp23D->f2;_tmp240=_tmp23D->f3;_tmp241=(_tmp23D->f4)->f1;_tmp242=(_tmp23D->f4)->f2;{struct Cyc_List_List**exlist_ptr=_tmp23E;struct Cyc_Dict_Dict*out_dict=_tmp23F;struct Cyc_Binding_Env*env=_tmp240;unsigned wcloc=_tmp241;struct Cyc_List_List*hidelist=_tmp242;
void*_tmp243=res;struct Cyc_Absyn_Datatypefield*_tmp245;struct Cyc_Absyn_Datatypedecl*_tmp244;struct Cyc_Absyn_Enumfield*_tmp247;void*_tmp246;struct Cyc_Absyn_Aggrdecl*_tmp248;struct Cyc_Absyn_Enumfield*_tmp24A;struct Cyc_Absyn_Enumdecl*_tmp249;void*_tmp24B;switch(*((int*)_tmp243)){case 0: _tmp24B=(void*)((struct Cyc_Binding_VarRes_Binding_Resolved_struct*)_tmp243)->f1;{void*bnd=_tmp24B;
# 907
...
goto _LL3;}}case 3: _tmp249=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp243)->f1;_tmp24A=((struct Cyc_Binding_EnumRes_Binding_Resolved_struct*)_tmp243)->f2;{struct Cyc_Absyn_Enumdecl*ed=_tmp249;struct Cyc_Absyn_Enumfield*ef=_tmp24A;
# 918
...
goto _LL3;}case 1: _tmp248=((struct Cyc_Binding_AggrRes_Binding_Resolved_struct*)_tmp243)->f1;{struct Cyc_Absyn_Aggrdecl*ad=_tmp248;
# 922
...
goto _LL3;}case 4: _tmp246=(void*)((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp243)->f1;_tmp247=((struct Cyc_Binding_AnonEnumRes_Binding_Resolved_struct*)_tmp243)->f2;{void*t=_tmp246;struct Cyc_Absyn_Enumfield*ef=_tmp247;
# 925
goto _LL3;}default: _tmp244=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp243)->f1;_tmp245=((struct Cyc_Binding_DatatypeRes_Binding_Resolved_struct*)_tmp243)->f2;{struct Cyc_Absyn_Datatypedecl*dd=_tmp244;struct Cyc_Absyn_Datatypefield*df=_tmp245;
# 927
...
goto _LL0;}case 1: _tmp267=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmp253)->f1;{struct Cyc_Absyn_Fndecl*fd=_tmp267;
# 957
if(env->in_cyc_override)
...
struct _tuple0*_tmp26C=fd->name;struct _tuple0*_stmttmp1B=_tmp26C;struct _tuple0*_tmp26D=_stmttmp1B;struct _fat_ptr*_tmp26F;union Cyc_Absyn_Nmspace _tmp26E;_tmp26E=_tmp26D->f1;_tmp26F=_tmp26D->f2;{union Cyc_Absyn_Nmspace decl_ns=_tmp26E;struct _fat_ptr*decl_name=_tmp26F;
...
# 995
env->local_vars=old_locals;
goto _LL0;}}}}case 2: _tmp265=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_tmp266=((struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*)_tmp253)->f3;{struct Cyc_Absyn_Pat*p=_tmp265;struct Cyc_Absyn_Exp*exp=_tmp266;
# 999
if(Cyc_Binding_at_toplevel(env)){
...
goto _LL0;}case 3: _tmp264=((struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*)_tmp253)->f1;{struct Cyc_List_List*vds=_tmp264;
# 1008
for(1;vds != 0;vds=vds->tl){
Cyc_Binding_resolve_and_add_vardecl(loc,env,(struct Cyc_Absyn_Vardecl*)vds->hd);}
goto _LL0;}case 4: _tmp261=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_tmp262=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp253)->f2;_tmp263=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmp253)->f3;{struct Cyc_Absyn_Tvar*tv=_tmp261;struct Cyc_Absyn_Vardecl*vd=_tmp262;struct Cyc_Absyn_Exp*open_exp_opt=_tmp263;
# 1013
if(open_exp_opt != 0)
Cyc_Binding_resolve_exp(env,open_exp_opt);
Cyc_Binding_resolve_and_add_vardecl(loc,env,vd);
goto _LL0;}case 8: _tmp260=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmp253)->f1;{struct Cyc_Absyn_Typedefdecl*td=_tmp260;
# 1019
if(!Cyc_Binding_at_toplevel(env)){
...
struct _tuple0*_tmp286=td->name;struct _tuple0*_stmttmp1C=_tmp286;struct _tuple0*_tmp287=_stmttmp1C;struct _fat_ptr*_tmp289;union Cyc_Absyn_Nmspace _tmp288;_tmp288=_tmp287->f1;_tmp289=_tmp287->f2;{union Cyc_Absyn_Nmspace decl_ns=_tmp288;struct _fat_ptr*decl_name=_tmp289;
# 1026
...
# 1034
goto _LL0;}}}case 5: _tmp25F=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmp253)->f1;{struct Cyc_Absyn_Aggrdecl*ad=_tmp25F;
# 1037
if(!Cyc_Binding_at_toplevel(env)){
...
struct _tuple0*_tmp28E=ad->name;struct _tuple0*_stmttmp1D=_tmp28E;struct _tuple0*_tmp28F=_stmttmp1D;struct _fat_ptr*_tmp291;union Cyc_Absyn_Nmspace _tmp290;_tmp290=_tmp28F->f1;_tmp291=_tmp28F->f2;{union Cyc_Absyn_Nmspace decl_ns=_tmp290;struct _fat_ptr*decl_name=_tmp291;
# 1044
...
# 1055
if(ad->impl != 0){
struct Cyc_Absyn_AggrdeclImpl*_tmp294=(struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl);struct Cyc_Absyn_AggrdeclImpl*_stmttmp1E=_tmp294;struct Cyc_Absyn_AggrdeclImpl*_tmp295=_stmttmp1E;struct Cyc_List_List*_tmp297;struct Cyc_List_List*_tmp296;_tmp296=_tmp295->rgn_po;_tmp297=_tmp295->fields;{struct Cyc_List_List*rpo=_tmp296;struct Cyc_List_List*fs=_tmp297;
Cyc_Binding_resolve_rgnpo(loc,env,rpo);
Cyc_Binding_resolve_aggrfields(loc,env,fs);}}
# 1060
goto _LL0;}}}case 7: _tmp25E=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmp253)->f1;{struct Cyc_Absyn_Enumdecl*ed=_tmp25E;
# 1063
if(!Cyc_Binding_at_toplevel(env)){
...
struct _tuple0*_tmp29B=ed->name;struct _tuple0*_stmttmp1F=_tmp29B;struct _tuple0*_tmp29C=_stmttmp1F;struct _fat_ptr*_tmp29E;union Cyc_Absyn_Nmspace _tmp29D;_tmp29D=_tmp29C->f1;_tmp29E=_tmp29C->f2;{union Cyc_Absyn_Nmspace decl_ns=_tmp29D;struct _fat_ptr*decl_name=_tmp29E;
# 1070
...
# 1091
goto _LL0;}}}case 6: _tmp25D=((struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*)_tmp253)->f1;{struct Cyc_Absyn_Datatypedecl*tud=_tmp25D;
# 1095
...
tud->is_extensible=1;{
struct _tuple0*_tmp2A8=tud->name;struct _tuple0*_stmttmp20=_tmp2A8;struct _tuple0*_tmp2A9=_stmttmp20;struct _fat_ptr*_tmp2AB;union Cyc_Absyn_Nmspace _tmp2AA;_tmp2AA=_tmp2A9->f1;_tmp2AB=_tmp2A9->f2;{union Cyc_Absyn_Nmspace decl_ns=_tmp2AA;struct _fat_ptr*decl_name=_tmp2AB;
...
# 1096
;_pop_handler();}else{void*_tmp2A3=(void*)Cyc_Core_get_exn_thrown();void*_tmp2AE=_tmp2A3;void*_tmp2AF;if(((struct Cyc_Binding_BindingError_exn_struct*)_tmp2AE)->tag == Cyc_Binding_BindingError){
# 1108
Cyc_Binding_absolutize_topdecl(loc,env,tud->name,tud->sc);{
struct _tuple0*_tmp2B0=tud->name;struct _tuple0*_stmttmp21=_tmp2B0;struct _tuple0*_tmp2B1=_stmttmp21;struct _fat_ptr*_tmp2B3;union Cyc_Absyn_Nmspace _tmp2B2;_tmp2B2=_tmp2B1->f1;_tmp2B3=_tmp2B1->f2;{union Cyc_Absyn_Nmspace decl_ns=_tmp2B2;struct _fat_ptr*decl_name=_tmp2B3;
...
# 1117
goto _LL35;}}}else{_tmp2AF=_tmp2AE;{void*exn=_tmp2AF;(int)_rethrow(exn);}}_LL35:;}}}{
# 1120
struct _tuple0*_tmp2B6=tud->name;struct _tuple0*_stmttmp22=_tmp2B6;struct _tuple0*_tmp2B7=_stmttmp22;struct _fat_ptr*_tmp2B9;union Cyc_Absyn_Nmspace _tmp2B8;_tmp2B8=_tmp2B7->f1;_tmp2B9=_tmp2B7->f2;{union Cyc_Absyn_Nmspace decl_ns=_tmp2B8;struct _fat_ptr*decl_name=_tmp2B9;
if(tud->fields != 0){
...
Cyc_Binding_resolve_type(loc,env,(*((struct _tuple13*)tqts->hd)).f2);}}
{union Cyc_Absyn_Nmspace _tmp2BD=(*f->name).f1;union Cyc_Absyn_Nmspace _stmttmp23=_tmp2BD;union Cyc_Absyn_Nmspace _tmp2BE=_stmttmp23;switch((_tmp2BE.Abs_n).tag){case 1: if((_tmp2BE.Rel_n).val == 0){
# 1128
...
# 1144
goto _LL0;}}}case 9: _tmp25B=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_tmp25C=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp253)->f2;{struct _fat_ptr*v=_tmp25B;struct Cyc_List_List*ds2=_tmp25C;
# 1147
...
goto _LL0;}case 10: _tmp259=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_tmp25A=((struct Cyc_Absyn_Using_d_Absyn_Raw_decl_struct*)_tmp253)->f2;{struct _tuple0*qv=_tmp259;struct Cyc_List_List*ds2=_tmp25A;
# 1152
...
goto _LL0;}case 11: _tmp258=((struct Cyc_Absyn_ExternC_d_Absyn_Raw_decl_struct*)_tmp253)->f1;{struct Cyc_List_List*ds2=_tmp258;
# 1158
int _tmp2C6=env->in_cinclude;int old=_tmp2C6;
env->in_cinclude=1;
Cyc_Binding_resolve_decls(env,ds2);
env->in_cinclude=old;
goto _LL0;}case 12: _tmp254=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp253)->f1;_tmp255=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp253)->f2;_tmp256=(struct Cyc_List_List**)&((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp253)->f3;_tmp257=((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp253)->f4;{struct Cyc_List_List*ds2=_tmp254;struct Cyc_List_List*ovrs=_tmp255;struct Cyc_List_List**exports=_tmp256;struct _tuple10*hides=_tmp257;
# 1169
{struct Cyc_List_List*_tmp2C7=*exports;struct Cyc_List_List*exs=_tmp2C7;for(0;exs != 0;exs=exs->tl){
struct _tuple17*_tmp2C8=(struct _tuple17*)exs->hd;struct _tuple17*_stmttmp24=_tmp2C8;struct _tuple17*_tmp2C9=_stmttmp24;struct _tuple0*_tmp2CB;unsigned _tmp2CA;_tmp2CA=_tmp2C9->f1;_tmp2CB=_tmp2C9->f2;{unsigned loc=_tmp2CA;struct _tuple0*qv=_tmp2CB;
...
struct _tuple17*_tmp2D8=(struct _tuple17*)exs->hd;struct _tuple17*_stmttmp25=_tmp2D8;struct _tuple17*_tmp2D9=_stmttmp25;struct _fat_ptr*_tmp2DB;unsigned _tmp2DA;_tmp2DA=_tmp2D9->f1;_tmp2DB=(_tmp2D9->f2)->f2;{unsigned loc=_tmp2DA;struct _fat_ptr*v=_tmp2DB;
