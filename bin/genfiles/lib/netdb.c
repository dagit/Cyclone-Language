...
ntohs( unsigned short); struct Cyc_NetDB_servent{ struct _tagged_arr s_name;
struct _tagged_arr s_aliases; unsigned short s_port; struct _tagged_arr s_proto;
} ; struct Cyc_NetDB_hostent{ struct _tagged_arr h_name; struct _tagged_arr
h_aliases; int h_addrtype; int h_length; struct _tagged_arr h_addr_list; } ;
extern struct Cyc_NetDB_servent* Cyc_NetDB_getservbyname( struct _tagged_arr
name, struct _tagged_arr proto); extern struct Cyc_NetDB_hostent* Cyc_NetDB_gethostbyname(
