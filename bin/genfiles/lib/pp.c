...
_temp33.f1=( struct _tagged_arr)* _temp26;{ void* _temp32[ 1u]={& _temp33}; Cyc_Stdio_fprintf(
...
s); return({ struct Cyc_PP_Doc* _temp67=( struct Cyc_PP_Doc*) GC_malloc( sizeof(
struct Cyc_PP_Doc)); _temp67->mwo= slen; _temp67->mw= Cyc_PP_infinity; _temp67->f=(
...
_temp68=( struct _tuple1*) GC_malloc( sizeof( struct _tuple1)); _temp68->f1=
slen; _temp68->f2= s; _temp68;})); _temp67;});} struct Cyc_PP_Doc* Cyc_PP_text(
...
full){ int slen= Cyc_String_strlen( shrt); return({ struct Cyc_PP_Doc* _temp101=(
struct Cyc_PP_Doc*) GC_malloc( sizeof( struct Cyc_PP_Doc)); _temp101->mwo= slen;
_temp101->mw= Cyc_PP_infinity; _temp101->f=( void*)(( void*(*)( struct Cyc_PP_Out*(*
...
_temp103;});} struct Cyc_PP_Doc* Cyc_PP_line_doc(){ if( Cyc_PP_line_doc_opt == 0){
Cyc_PP_line_doc_opt=({ struct Cyc_Core_Opt* _temp107=( struct Cyc_Core_Opt*)
...
_temp118;})); _temp117;});} int Cyc_PP_min( int x, int y){ if( x <= y){ return x;}
...
return({ struct Cyc_PP_Doc* _temp156[ 4u]; _temp156[ 3u]= Cyc_PP_ppseq_f( pp,
sep,(( struct Cyc_List_List*) _check_null( l))->tl); _temp156[ 2u]= Cyc_PP_oline_doc();
...
Cyc_List_List* l){ if( l == 0){ return Cyc_PP_nil_doc();} else{ if((( struct Cyc_List_List*)
...
Cyc_PP_Doc* oline= Cyc_PP_oline_doc(); struct Cyc_List_List* _temp157= l; while(((
struct Cyc_List_List*) _check_null( _temp157))->tl != 0) { struct Cyc_List_List*
_temp158=(( struct Cyc_List_List*) _check_null( _temp157))->tl;(( struct Cyc_List_List*)
_check_null( _temp157))->tl=({ struct Cyc_List_List* _temp159=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp159->hd=( void*) sep2; _temp159->tl=({
struct Cyc_List_List* _temp160=( struct Cyc_List_List*) GC_malloc( sizeof(
struct Cyc_List_List)); _temp160->hd=( void*) oline; _temp160->tl= _temp158;
_temp160;}); _temp159;}); _temp157= _temp158;} return Cyc_PP_cats( l);}}} struct
...
_check_null( l))->hd);} else{ return({ struct Cyc_PP_Doc* _temp161[ 4u];
_temp161[ 3u]= Cyc_PP_ppseql_f( pp, sep,(( struct Cyc_List_List*) _check_null( l))->tl);
_temp161[ 2u]= Cyc_PP_line_doc(); _temp161[ 1u]= Cyc_PP_text( sep); _temp161[ 0u]=
pp(( void*)(( struct Cyc_List_List*) _check_null( l))->hd); Cyc_PP_cat( _tag_arr(
...
sep,(( struct Cyc_List_List*) _check_null( l))->tl); _temp162[ 2u]= Cyc_PP_line_doc();
_temp162[ 1u]= Cyc_PP_text( sep); _temp162[ 0u]=( struct Cyc_PP_Doc*)(( struct
Cyc_List_List*) _check_null( l))->hd; Cyc_PP_cat( _tag_arr( _temp162, sizeof(
struct Cyc_PP_Doc*), 4u));});}}} struct Cyc_PP_Doc* Cyc_PP_seql( struct
