...
struct Cyc_Getopt_Stdlib__Ldiv{ int quot; int rem; } ; extern int abs( int __x)
 ...
 __attribute__(( cdecl )) ; extern struct Cyc_Getopt_Stdlib__Div div( int
__numer, int __denom)  __attribute__(( cdecl )) ; extern struct Cyc_Getopt_Stdlib__Ldiv
...
cdecl )) ; int Cyc_Getopt_getopt_long( int argc, struct _tagged_arr argv, struct
