...
mktime( struct Cyc_Getopt_Time_tm* _timeptr)  __attribute__(( cdecl )) ; extern
int time( int* _timer)  __attribute__(( cdecl )) ; extern struct Cyc_Getopt_Time_tm*
gmtime( const int* _timer)  __attribute__(( cdecl )) ; extern struct Cyc_Getopt_Time_tm*
localtime( const int* _timer)  __attribute__(( cdecl )) ; extern struct Cyc_Getopt_Time_tm*
