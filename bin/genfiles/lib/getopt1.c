...
tm_wday; int tm_yday; int tm_isdst; } ; extern unsigned int clock()
 ...
 __attribute__(( cdecl )) ; extern int mktime( struct Cyc_Getopt_Time_tm*
_timeptr)  __attribute__(( cdecl )) ; extern int time( int* _timer)
 __attribute__(( cdecl )) ; extern struct Cyc_Getopt_Time_tm* gmtime( const int*
_timer)  __attribute__(( cdecl )) ; extern struct Cyc_Getopt_Time_tm* localtime(
const int* _timer)  __attribute__(( cdecl )) ; extern struct Cyc_Getopt_Time_tm*
gmtime_r( const int*, struct Cyc_Getopt_Time_tm*)  __attribute__(( cdecl )) ;
...
_tzname[ 2u]  __attribute__(( dllimport )) ; extern void tzset()
 __attribute__(( cdecl )) ; struct Cyc_Getopt___sFILE; struct Cyc_Getopt__reent;
struct Cyc_Getopt__glue{ struct Cyc_Getopt__glue* _next; int _niobs; struct Cyc_Getopt___sFILE*
_iobs; } ; struct Cyc_Getopt__Bigint{ struct Cyc_Getopt__Bigint* _next; int _k;
int _maxwds; int _sign; int _wds; unsigned int _x[ 1u]; } ; struct Cyc_Getopt__atexit{
...
void* _cookie)  __attribute__(( cdecl )) ; struct Cyc_Getopt___sbuf _ub;
unsigned char* _up; int _ur; unsigned char _ubuf[ 3u]; unsigned char _nbuf[ 1u];
struct Cyc_Getopt___sbuf _lb; int _blksize; int _offset; struct Cyc_Getopt__reent*
_data; } ; struct Cyc_Getopt__reent_u1{ unsigned int _unused_rand; int
_strtok_last; unsigned char _asctime_buf[ 26u]; struct Cyc_Getopt_Time_tm
_localtime_buf; int _gamma_signgam; unsigned long long _rand_next; } ; struct
Cyc_Getopt__reent_u2{ unsigned int _nextf[ 30u]; unsigned int _nmalloc[ 30u]; }
; union Cyc_Getopt__reent_union{ struct Cyc_Getopt__reent_u1 _reent; struct Cyc_Getopt__reent_u2
_unused; } ; struct Cyc_Getopt__reent{ int _errno; struct Cyc_Getopt___sFILE*
_stdin; struct Cyc_Getopt___sFILE* _stdout; struct Cyc_Getopt___sFILE* _stderr;
int _inc; unsigned char _emergency[ 25u]; int _current_category; const
unsigned char* _current_locale; int __sdidinit; void(* __cleanup)( struct Cyc_Getopt__reent*)
 __attribute__(( cdecl )) ; struct Cyc_Getopt__Bigint* _result; int _result_k;
struct Cyc_Getopt__Bigint* _p5s; struct Cyc_Getopt__Bigint** _freelist; int
_cvtlen; unsigned char* _cvtbuf; union Cyc_Getopt__reent_union _new; struct Cyc_Getopt__atexit*
_atexit; struct Cyc_Getopt__atexit _atexit0; void(** _sig_func)( int); struct
Cyc_Getopt__glue __sglue; struct Cyc_Getopt___sFILE __sf[ 3u]; } ; extern struct
Cyc_Getopt__reent* _impure_ptr; extern void _reclaim_reent( struct Cyc_Getopt__reent*);
struct Cyc_Getopt_Stdlib__Div{ int quot; int rem; } ; struct Cyc_Getopt_Stdlib__Ldiv{
...
__func)())  __attribute__(( cdecl )) ; extern struct Cyc_Getopt_Stdlib__Div div(
int __numer, int __denom)  __attribute__(( cdecl )) ; extern struct Cyc_Getopt_Stdlib__Ldiv
...
grantpt( int)  __attribute__(( cdecl )) ; extern int unlockpt( int)
 __attribute__(( cdecl )) ; int Cyc_Getopt_getopt_long( int argc, struct
_tagged_ptr0 argv, struct _tagged_string options, struct _tagged_ptr1
...
struct _tagged_ptr0 argv, struct _tagged_string options, struct _tagged_ptr1
long_options, int* opt_index){ return Cyc_Getopt__getopt_internal( argc, argv,
