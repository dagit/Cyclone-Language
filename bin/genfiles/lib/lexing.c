...
char* tag; } ; extern int Cyc_Stdio_file_string_read( struct Cyc_Stdio___sFILE*
fd, struct _tagged_string dest, int dest_offset, int max_count); extern char Cyc_Lexing_Error_tag[
