...
_tagged_arr f1; } ; extern int Cyc_Stdio_file_string_read( struct Cyc_Stdio___sFILE*
fd, struct _tagged_arr dest, int dest_offset, int max_count); static const int
Cyc_Stdio_String_pa= 0; struct Cyc_Stdio_String_pa_struct{ int tag; struct
_tagged_arr f1; } ; static const int Cyc_Stdio_Int_pa= 1; struct Cyc_Stdio_Int_pa_struct{
int tag; unsigned int f1; } ; static const int Cyc_Stdio_Double_pa= 2; struct
Cyc_Stdio_Double_pa_struct{ int tag; double f1; } ; static const int Cyc_Stdio_ShortPtr_pa=
3; struct Cyc_Stdio_ShortPtr_pa_struct{ int tag; short* f1; } ; static const int
Cyc_Stdio_IntPtr_pa= 4; struct Cyc_Stdio_IntPtr_pa_struct{ int tag; unsigned int*
f1; } ; static const int Cyc_Stdio_ShortPtr_sa= 0; struct Cyc_Stdio_ShortPtr_sa_struct{
...
f1; } ; extern unsigned char Cyc_Lexing_Error[ 10u]; struct Cyc_Lexing_Error_struct{
...
Cyc_String_strdup( struct _tagged_arr src); unsigned char Cyc_Lexing_Error[ 10u]="\000\000\000\000Error";
...
lexbuf->lex_buffer_len -  n)); Cyc_String_zstrncpy( _tagged_arr_plus(
