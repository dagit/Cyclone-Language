...
_size; } ; typedef int Cyc__fpos_t; struct Cyc___sFILE{ unsigned char* _p; int
...
Cyc_Stdlib__Div{ int quot; int rem; } ; typedef struct Cyc_Stdlib__Div Cyc_Stdlib_div_t;
struct Cyc_Stdlib__Ldiv{ int quot; int rem; } ; typedef struct Cyc_Stdlib__Ldiv
Cyc_Stdlib_ldiv_t; extern int __mb_cur_max; extern int abs( int); extern int
...
unsigned int* __seed); extern double Cyc_Stdlib_atof( struct _tagged_string);
...
_tagged_string); extern double atof( unsigned char* _nptr); extern float atoff(
...
extern unsigned char* _findenv( unsigned char*, int*); extern unsigned char*
_findenv_r( struct Cyc__reent*, unsigned char*, int*); extern int putenv(
unsigned char* __string); extern int _putenv_r( struct Cyc__reent*,
