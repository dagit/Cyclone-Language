...
_tagged_string f1; } ; struct _tagged_ptr1{ struct Cyc_List_List** curr; struct
Cyc_List_List** base; struct Cyc_List_List** last_plus_one; } ; struct Cyc_Hashtable_Table{
int(* cmp)( void*, void*); int(* hash)( void*); int max_len; struct _tagged_ptr1
...
struct Cyc_List_List*) * _temp1); struct _tagged_ptr1 _temp4={ _temp2, _temp2,
...
key, void* val){ struct _tagged_ptr1 tab= t->tab; int bucket=( int)((* t->hash)(
key) %({ struct _tagged_ptr1 _temp7= tab;( unsigned int)( _temp7.last_plus_one -
_temp7.curr);}));*(( struct Cyc_List_List**(*)( struct _tagged_ptr1,
...
val; _temp6;}); _temp5->tl=*(( struct Cyc_List_List**(*)( struct _tagged_ptr1,
unsigned int, unsigned int)) _check_unknown_subscript)( tab, sizeof( struct Cyc_List_List*),
bucket); _temp5;}); if((( int(*)( struct Cyc_List_List* x)) Cyc_List_length)(*((
struct Cyc_List_List**(*)( struct _tagged_ptr1, unsigned int, unsigned int))
...
struct Cyc_Hashtable_Table* t, void* key){ struct _tagged_ptr1 tab= t->tab;
struct Cyc_List_List* l=*(( struct Cyc_List_List**(*)( struct _tagged_ptr1,
unsigned int, unsigned int)) _check_unknown_subscript)( tab, sizeof( struct Cyc_List_List*),(
int)((* t->hash)( key) %({ struct _tagged_ptr1 _temp8= tab;( unsigned int)(
...
struct _tagged_ptr1 tab= t->tab; int(* cmp)( void*, void*)= t->cmp; int bucket=(
int)((* t->hash)( key) %({ struct _tagged_ptr1 _temp9= tab;( unsigned int)(
_temp9.last_plus_one - _temp9.curr);})); struct Cyc_List_List* l=*(( struct Cyc_List_List**(*)(
struct _tagged_ptr1, unsigned int, unsigned int)) _check_unknown_subscript)( tab,
...
struct _tagged_ptr1 tab, int(* hash)( void*), struct Cyc_List_List* elems){ if(
elems == 0){ return;}(( void(*)( struct _tagged_ptr1 tab, int(* hash)( void*),
...
hash)( key) %({ struct _tagged_ptr1 _temp13= tab;( unsigned int)( _temp13.last_plus_one
- _temp13.curr);}));*(( struct Cyc_List_List**(*)( struct _tagged_ptr1,
unsigned int, unsigned int)) _check_unknown_subscript)( tab, sizeof( struct Cyc_List_List*),
...
val; _temp12;}); _temp11->tl=*(( struct Cyc_List_List**(*)( struct _tagged_ptr1,
unsigned int, unsigned int)) _check_unknown_subscript)( tab, sizeof( struct Cyc_List_List*),
nidx); _temp11;});}} void Cyc_Hashtable_resize( struct Cyc_Hashtable_Table* t){
struct _tagged_ptr1 odata= t->tab; int osize=( int)({ struct _tagged_ptr1
_temp18= odata;( unsigned int)( _temp18.last_plus_one - _temp18.curr);}); int
nsize= 2 * osize + 1; struct Cyc_List_List* mt= 0; struct _tagged_ptr1 ndata=({
...
struct _tagged_ptr1 _temp17={ _temp15, _temp15, _temp15 + _temp14};{
unsigned int _temp16= _temp14; unsigned int i; for( i= 0; i < _temp16; i ++){
_temp15[ i]= mt;}}; _temp17;});{ int i= 0; for( 0; i < osize; i ++){(( void(*)(
struct _tagged_ptr1 tab, int(* hash)( void*), struct Cyc_List_List* elems)) Cyc_Hashtable_insert_bucket)(
ndata, t->hash,*(( struct Cyc_List_List**(*)( struct _tagged_ptr1, unsigned int,
...
f)( void*, void*), struct Cyc_Hashtable_Table* t){ struct _tagged_ptr1 odata= t->tab;
int osize=( int)({ struct _tagged_ptr1 _temp19= odata;( unsigned int)( _temp19.last_plus_one
- _temp19.curr);}); int i= 0; for( 0; i < osize; i ++){ struct Cyc_List_List*
iter=*(( struct Cyc_List_List**(*)( struct _tagged_ptr1, unsigned int,
unsigned int)) _check_unknown_subscript)( odata, sizeof( struct Cyc_List_List*),
...
void*), void(* prn_val)( void*)){ struct _tagged_ptr1 odata= t->tab; int osize=(
int)({ struct _tagged_ptr1 _temp20= odata;( unsigned int)( _temp20.last_plus_one
- _temp20.curr);}); int i= 0; for( 0; i < osize; i ++){ printf("%d: ", i);{
struct Cyc_List_List* iter=*(( struct Cyc_List_List**(*)( struct _tagged_ptr1,
