...
key) %({ struct _tagged_ptr0 _temp8= tab;( unsigned int)( _temp8.last_plus_one -
_temp8.curr);}));*(( struct Cyc_List_List**(*)( struct _tagged_ptr0,
unsigned int, unsigned int)) _check_unknown_subscript)( tab, sizeof( struct Cyc_List_List*),
bucket)=({ struct Cyc_List_List* _temp6=( struct Cyc_List_List*) GC_malloc(
sizeof( struct Cyc_List_List)); _temp6->hd=( void*)({ struct _tuple0* _temp7=(
struct _tuple0*) GC_malloc( sizeof( struct _tuple0)); _temp7->f1= key; _temp7->f2=
val; _temp7;}); _temp6->tl=*(( struct Cyc_List_List**(*)( struct _tagged_ptr0,
unsigned int, unsigned int)) _check_unknown_subscript)( tab, sizeof( struct Cyc_List_List*),
bucket); _temp6;}); if((( int(*)( struct Cyc_List_List* x)) Cyc_List_length)(*((
...
_temp9.last_plus_one - _temp9.curr);}))); return(( void*(*)( int(* compare)(
...
int)((* t->hash)( key) %({ struct _tagged_ptr0 _temp10= tab;( unsigned int)(
_temp10.last_plus_one - _temp10.curr);})); struct Cyc_List_List* l=*(( struct
Cyc_List_List**(*)( struct _tagged_ptr0, unsigned int, unsigned int))
...
int)({ struct _tagged_string _temp11= s;( unsigned int)( _temp11.last_plus_one -
_temp11.curr);}); int shift= 0;{ int i= 0; for( 0; i < sz; ++ i){ ans= ans ^*((
...
hash)( key) %({ struct _tagged_ptr0 _temp14= tab;( unsigned int)( _temp14.last_plus_one
- _temp14.curr);}));*(( struct Cyc_List_List**(*)( struct _tagged_ptr0,
unsigned int, unsigned int)) _check_unknown_subscript)( tab, sizeof( struct Cyc_List_List*),
nidx)=({ struct Cyc_List_List* _temp12=( struct Cyc_List_List*) GC_malloc(
sizeof( struct Cyc_List_List)); _temp12->hd=( void*)({ struct _tuple0* _temp13=(
struct _tuple0*) GC_malloc( sizeof( struct _tuple0)); _temp13->f1= key; _temp13->f2=
val; _temp13;}); _temp12->tl=*(( struct Cyc_List_List**(*)( struct _tagged_ptr0,
unsigned int, unsigned int)) _check_unknown_subscript)( tab, sizeof( struct Cyc_List_List*),
nidx); _temp12;});}} void Cyc_Hashtable_resize( struct Cyc_Hashtable_Table* t){
struct _tagged_ptr0 odata= t->tab; int osize=( int)({ struct _tagged_ptr0
_temp20= odata;( unsigned int)( _temp20.last_plus_one - _temp20.curr);}); int
nsize= 2 * osize + 1; struct Cyc_List_List* mt= 0; struct _tagged_ptr0 ndata=({
unsigned int _temp15=( unsigned int) nsize; struct Cyc_List_List** _temp16=(
struct Cyc_List_List**) GC_malloc( sizeof( struct Cyc_List_List*) * _temp15);
struct _tagged_ptr0 _temp19={ _temp16, _temp16, _temp16 + _temp15};{
unsigned int _temp17= _temp15; unsigned int i; for( i= 0; i < _temp17; i ++){
_temp16[ i]= mt;}}; _temp19;});{ int i= 0; for( 0; i < osize; i ++){(( void(*)(
...
int osize=( int)({ struct _tagged_ptr0 _temp21= odata;( unsigned int)( _temp21.last_plus_one
- _temp21.curr);}); int i= 0; for( 0; i < osize; i ++){ struct Cyc_List_List*
...
int)({ struct _tagged_ptr0 _temp22= odata;( unsigned int)( _temp22.last_plus_one
- _temp22.curr);}); int i= 0; for( 0; i < osize; i ++){ printf("%d: ", i);{
