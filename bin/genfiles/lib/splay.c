...
0){ _LL9: _temp8=(( struct Cyc_Splay_Node_struct*) _temp2)->f1; goto _LL5;}
else{ goto _LL6;} _LL6: goto _LL7; _LL5: { struct Cyc_Splay_node* _temp10=
_temp8->v; goto _LL11; _LL11: { struct Cyc_Splay_Node_struct* _temp16=({ struct
Cyc_Splay_Node_struct* _temp12=( struct Cyc_Splay_Node_struct*) GC_malloc(
...
char* _temp21="Splay::rotate_left"; struct _tagged_string _temp22; _temp22.curr=
_temp21; _temp22.base= _temp21; _temp22.last_plus_one= _temp21 + 19; _temp22;});
_temp20;}); _temp19;})); _LL3:;}} static void Cyc_Splay_rotate_right( struct Cyc_Splay_noderef*
nr){ struct Cyc_Splay_node* _temp23= nr->v; goto _LL24; _LL24: { void* _temp25=(
void*) _temp23->right; struct Cyc_Splay_noderef* _temp31; _LL27: if((
unsigned int) _temp25 > 1u?*(( int*) _temp25) == Cyc_Splay_Node: 0){ _LL32:
_temp31=(( struct Cyc_Splay_Node_struct*) _temp25)->f1; goto _LL28;} else{ goto
_LL29;} _LL29: goto _LL30; _LL28: { struct Cyc_Splay_node* _temp33= _temp31->v;
goto _LL34; _LL34: { struct Cyc_Splay_Node_struct* _temp39=({ struct Cyc_Splay_Node_struct*
_temp35=( struct Cyc_Splay_Node_struct*) GC_malloc( sizeof( struct Cyc_Splay_Node_struct));
_temp35[ 0]=({ struct Cyc_Splay_Node_struct _temp36; _temp36.tag= Cyc_Splay_Node;
_temp36.f1=({ struct Cyc_Splay_noderef* _temp37=( struct Cyc_Splay_noderef*)
GC_malloc( sizeof( struct Cyc_Splay_noderef)); _temp37->v=({ struct Cyc_Splay_node*
_temp38=( struct Cyc_Splay_node*) GC_malloc( sizeof( struct Cyc_Splay_node));
_temp38->key=( void*)(( void*) _temp23->key); _temp38->data=( void*)(( void*)
_temp23->data); _temp38->left=( void*)(( void*) _temp23->left); _temp38->right=(
void*)(( void*) _temp33->left); _temp38;}); _temp37;}); _temp36;}); _temp35;});
goto _LL40; _LL40: nr->v=({ struct Cyc_Splay_node* _temp41=( struct Cyc_Splay_node*)
GC_malloc( sizeof( struct Cyc_Splay_node)); _temp41->key=( void*)(( void*)
_temp33->key); _temp41->data=( void*)(( void*) _temp33->data); _temp41->left=(
void*)(( void*) _temp39); _temp41->right=( void*)(( void*) _temp33->right);
_temp41;}); goto _LL26;}} _LL30:( void) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct*
...
_temp43.f1=({ char* _temp44="Splay::rotate_right"; struct _tagged_string _temp45;
