...
_temp85 > 1u?*(( int*) _temp85) == Cyc_Splay_Node: 0){ _LL92: _temp91=(( struct
Cyc_Splay_Node_struct*) _temp85)->f1; goto _LL88;} else{ goto _LL89;} _LL89: if(
_temp85 ==( void*) Cyc_Splay_Leaf){ goto _LL90;} else{ goto _LL86;} _LL88: {
struct Cyc_Splay_node* _temp93= _temp91->v; int _temp94= reln( reln_first_arg,(
void*) _temp93->key); if( _temp94 == 0){ Cyc_Splay_lift( r, path);{ int _temp95=
1; _npop_handler( 0u); return _temp95;}} else{ if( _temp94 < 0){ path=({ struct
Cyc_List_List* _temp96=( struct Cyc_List_List*) _region_malloc( temp, sizeof(
struct Cyc_List_List)); _temp96->hd=( void*)({ struct _tuple0* _temp97=( struct
_tuple0*) _region_malloc( temp, sizeof( struct _tuple0)); _temp97->f1=( void*)
Cyc_Splay_LEFT; _temp97->f2= _temp91; _temp97;}); _temp96->tl= path; _temp96;});
tree=( void*) _temp93->left;} else{ path=({ struct Cyc_List_List* _temp98=(
struct Cyc_List_List*) _region_malloc( temp, sizeof( struct Cyc_List_List));
_temp98->hd=( void*)({ struct _tuple0* _temp99=( struct _tuple0*) _region_malloc(
temp, sizeof( struct _tuple0)); _temp99->f1=( void*) Cyc_Splay_RIGHT; _temp99->f2=
_temp91; _temp99;}); _temp98->tl= path; _temp98;}); tree=( void*) _temp93->right;}}
goto _LL86;} _LL90: if( path != 0){ Cyc_Splay_lift( r,(( struct Cyc_List_List*)
_check_null( path))->tl);}{ int _temp100= 0; _npop_handler( 0u); return _temp100;}
_LL86:;}}; _pop_region( temp);} int Cyc_Splay_splay( int(* reln)( void*, void*),
void* reln_first_arg, void* tree){ return Cyc_Splay_rsplay( Cyc_Core_heap_region,
