...
typedef struct Cyc_Queue_Queue *Cyc_Queue_gqueue_t;
typedef struct Cyc_Queue_Queue *Cyc_Queue_queue_t;
extern int Cyc_Queue_is_empty(struct Cyc_Queue_Queue *);
extern char Cyc_Queue_Empty[10];
extern struct Cyc_Queue_Queue *Cyc_Queue_create();
extern void Cyc_Queue_add(struct Cyc_Queue_Queue *,void *x);
extern void *Cyc_Queue_take(struct Cyc_Queue_Queue *);
extern void *Cyc_Queue_peek(struct Cyc_Queue_Queue *);
extern void Cyc_Queue_clear(struct Cyc_Queue_Queue *);
extern int Cyc_Queue_length(struct Cyc_Queue_Queue *);
extern void Cyc_Queue_iter(void (*f)(void *),struct Cyc_Queue_Queue *);
extern void Cyc_Queue_app(void *(*f)(void *),struct Cyc_Queue_Queue *);
struct Cyc_Queue_Queue {
...
char Cyc_Queue_Empty[10];
struct Cyc_Queue_Queue *Cyc_Queue_create() {
  return ({ struct Cyc_Queue_Queue *_temp0 = (struct Cyc_Queue_Queue *)GC_malloc(sizeof(struct Cyc_Queue_Queue));
    _temp0->front = 0;
    _temp0->rear = 0;
    _temp0; });
}
void Cyc_Queue_add(struct Cyc_Queue_Queue *q,void *x) {
  struct Cyc_List_List *cell = ({ struct Cyc_List_List *_temp2 = (struct Cyc_List_List *)GC_malloc(sizeof(struct Cyc_List_List));
    _temp2->hd = (void *)x;
    _temp2->tl = 0;
    _temp2; });
  if (q->front == 0) {
    ...
    ({ struct Cyc_List_List *_temp1 = q->rear;
      if (_temp1 == 0) {
...
void *Cyc_Queue_take(struct Cyc_Queue_Queue *q) {
  if (q->front == 0) {
    (void)_throw((void *)Cyc_Queue_Empty);
  }
  else {
    void *x = (void *)({ struct Cyc_List_List *_temp4 = q->front;
      if (_temp4 == 0) {
	_throw(Null_Exception);
      }
      _temp4->hd; });
    q->front = ({ struct Cyc_List_List *_temp3 = q->front;
      if (_temp3 == 0) {
	_throw(Null_Exception);
      }
      _temp3->tl; });
...
void *Cyc_Queue_peek(struct Cyc_Queue_Queue *q) {
  if (q->front == 0) {
    ...
    return (void *)({ struct Cyc_List_List *_temp5 = q->front;
      if (_temp5 == 0) {
	_throw(Null_Exception);
      }
      _temp5->hd; });
...
int Cyc_Queue_length(struct Cyc_Queue_Queue *q) {
  return ((int (*)(struct Cyc_List_List *x))Cyc_List_length)(q->front);
}
void Cyc_Queue_iter(void (*f)(void *),struct Cyc_Queue_Queue *q) {
  struct Cyc_List_List *x = q->front;
  for(0; x != 0; x = ({ struct Cyc_List_List *_temp6 = x;
    if (_temp6 == 0) {
      _throw(Null_Exception);
    }
    _temp6->tl; })) {
    f((void *)({ struct Cyc_List_List *_temp7 = x;
	if (_temp7 == 0) {
	  _throw(Null_Exception);
	}
	_temp7->hd; }));
...
void Cyc_Queue_app(void *(*f)(void *),struct Cyc_Queue_Queue *q) {
  struct Cyc_List_List *x = q->front;
  for(0; x != 0; x = ({ struct Cyc_List_List *_temp8 = x;
    if (_temp8 == 0) {
      _throw(Null_Exception);
    }
    _temp8->tl; })) {
    f((void *)({ struct Cyc_List_List *_temp9 = x;
	if (_temp9 == 0) {
	  _throw(Null_Exception);
	}
	_temp9->hd; }));
