...
unsigned char*); extern int* __errno(); extern int isalnum( int __c)
...
_tolower( int __c)  __attribute__(( cdecl )) ; extern int _toupper( int __c)
 __attribute__(( cdecl )) ; struct Cyc_Stdlib__Div{ int quot; int rem; } ;
struct Cyc_Stdlib__Ldiv{ int quot; int rem; } ; extern int __mb_cur_max
...
extern int Cyc_Stdlib_strtol( struct _tagged_arr n, struct _tagged_arr* end, int
base); extern unsigned int Cyc_Stdlib_strtoul( struct _tagged_arr n, struct
_tagged_arr* end, int base); struct Cyc_Stdio___sFILE; extern struct Cyc_Stdio___sFILE*
Cyc_Stdio_stdin; extern int Cyc_Stdio_fgetc( struct Cyc_Stdio___sFILE*); extern
int Cyc_Stdio_getc( struct Cyc_Stdio___sFILE*); extern int Cyc_Stdio_ungetc( int,
