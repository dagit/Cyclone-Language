...
struct _tagged_arr name); extern struct Cyc_Pwd_passwd* Cyc_Pwd_getpwuid(
...
Cyc_Cpwd_Cpasswd* getpwuid( unsigned short uid); struct Cyc_Pwd_passwd* Cyc_Pwd_getpwnam(
struct _tagged_arr name){ struct Cyc_Cpwd_Cpasswd* src= getpwnam(
string_to_Cstring( name)); return( unsigned int) src?({ struct Cyc_Pwd_passwd*
