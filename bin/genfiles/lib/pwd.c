...
unsigned char*); extern int* __errno(); struct Cyc_Pwd_passwd{ struct
_tagged_arr pw_name; struct _tagged_arr pw_passwd; unsigned short pw_uid;
unsigned short pw_gid; struct _tagged_arr pw_gecos; struct _tagged_arr pw_dir;
struct _tagged_arr pw_shell; } ; extern struct Cyc_Pwd_passwd* Cyc_Pwd_getpwnam(
struct _tagged_arr name); struct Cyc_Cpwd_Cpasswd{ unsigned char* pw_name;
...
extern struct Cyc_Cpwd_Cpasswd* getpwnam( unsigned char* name); struct Cyc_Pwd_passwd*
Cyc_Pwd_getpwnam( struct _tagged_arr name){ struct Cyc_Cpwd_Cpasswd* src=
getpwnam( string_to_Cstring( name)); return( unsigned int) src?({ struct Cyc_Pwd_passwd*
_temp0=( struct Cyc_Pwd_passwd*) GC_malloc( sizeof( struct Cyc_Pwd_passwd));
