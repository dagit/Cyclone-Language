...
_temp3= n; if( _temp3 == 0){ _throw( Null_Exception);} _temp3->hd;})); if( i ==
0){ return 1;} else{ if( i < 0){ return 0;} else{ n=({ struct Cyc_List_List*
_temp4= n; if( _temp4 == 0){ _throw( Null_Exception);} _temp4->tl;});}}} return
...
else{ int i= compare( elt,( void*)({ struct Cyc_List_List* _temp6= n; if( _temp6
== 0){ _throw( Null_Exception);} _temp6->hd;})); if( i < 0){ return({ struct Cyc_List_List*
_temp7=( struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List));
_temp7->hd=( void*) elt; _temp7->tl= n; _temp7;});} else{ struct Cyc_List_List*
result=({ struct Cyc_List_List* _temp8=( struct Cyc_List_List*) GC_malloc(
sizeof( struct Cyc_List_List)); _temp8->hd=( void*)(( void*)({ struct Cyc_List_List*
_temp9= n; if( _temp9 == 0){ _throw( Null_Exception);} _temp9->hd;})); _temp8->tl=
0; _temp8;}); struct Cyc_List_List* prev= result; n=({ struct Cyc_List_List*
_temp10= n; if( _temp10 == 0){ _throw( Null_Exception);} _temp10->tl;}); while(
n != 0?( i= compare(( void*)({ struct Cyc_List_List* _temp11= n; if( _temp11 ==
0){ _throw( Null_Exception);} _temp11->hd;}), elt)) < 0: 0) {({ struct Cyc_List_List*
_temp12= prev; if( _temp12 == 0){ _throw( Null_Exception);} _temp12->tl=({
struct Cyc_List_List* _temp13=( struct Cyc_List_List*) GC_malloc( sizeof( struct
Cyc_List_List)); _temp13->hd=( void*)(( void*)({ struct Cyc_List_List* _temp14=
n; if( _temp14 == 0){ _throw( Null_Exception);} _temp14->hd;})); _temp13->tl= 0;
_temp13;});}); prev=({ struct Cyc_List_List* _temp15= prev; if( _temp15 == 0){
_throw( Null_Exception);} _temp15->tl;}); n=({ struct Cyc_List_List* _temp16= n;
if( _temp16 == 0){ _throw( Null_Exception);} _temp16->tl;});}({ struct Cyc_List_List*
_temp17= prev; if( _temp17 == 0){ _throw( Null_Exception);} _temp17->tl=({
struct Cyc_List_List* _temp18=( struct Cyc_List_List*) GC_malloc( sizeof( struct
Cyc_List_List)); _temp18->hd=( void*) elt; _temp18->tl= n; _temp18;});}); return
result;}}} struct Cyc_Set_Set* Cyc_Set_insert( struct Cyc_Set_Set* s, void* elt){
if((( int(*)( struct Cyc_Set_Set* s, void* elt)) Cyc_Set_member)( s, elt)){
return s;} else{ return({ struct Cyc_Set_Set* _temp19=( struct Cyc_Set_Set*)
GC_malloc( sizeof( struct Cyc_Set_Set)); _temp19->compare= s->compare; _temp19->cardinality=
s->cardinality + 1; _temp19->nodes=(( struct Cyc_List_List*(*)( int(* compare)(
void*, void*), struct Cyc_List_List* n, void* elt)) Cyc_Set_insert_b)( s->compare,
s->nodes, elt); _temp19;});}} struct Cyc_Set_Set* Cyc_Set_union_two( struct Cyc_Set_Set*
...
_temp20= x1; if( _temp20 == 0){ _throw( Null_Exception);} _temp20->hd;}),( void*)({
struct Cyc_List_List* _temp21= x2; if( _temp21 == 0){ _throw( Null_Exception);}
_temp21->hd;})); if( i == 0){ x2=({ struct Cyc_List_List* _temp22= x2; if(
_temp22 == 0){ _throw( Null_Exception);} _temp22->tl;});} else{ if( i < 0){ if(
curr == 0){ nodes=({ struct Cyc_List_List* _temp23=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp23->hd=( void*)(( void*)({
struct Cyc_List_List* _temp24= x1; if( _temp24 == 0){ _throw( Null_Exception);}
_temp24->hd;})); _temp23->tl= 0; _temp23;}); curr= nodes;} else{({ struct Cyc_List_List*
_temp25= curr; if( _temp25 == 0){ _throw( Null_Exception);} _temp25->tl=({
struct Cyc_List_List* _temp26=( struct Cyc_List_List*) GC_malloc( sizeof( struct
Cyc_List_List)); _temp26->hd=( void*)(( void*)({ struct Cyc_List_List* _temp27=
x1; if( _temp27 == 0){ _throw( Null_Exception);} _temp27->hd;})); _temp26->tl= 0;
_temp26;});}); curr=({ struct Cyc_List_List* _temp28= curr; if( _temp28 == 0){
_throw( Null_Exception);} _temp28->tl;});} x1=({ struct Cyc_List_List* _temp29=
x1; if( _temp29 == 0){ _throw( Null_Exception);} _temp29->tl;}); ++ cardinality;}
else{ if( curr == 0){ nodes=({ struct Cyc_List_List* _temp30=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp30->hd=( void*)(( void*)({
struct Cyc_List_List* _temp31= x2; if( _temp31 == 0){ _throw( Null_Exception);}
_temp31->hd;})); _temp30->tl= 0; _temp30;}); curr= nodes;} else{({ struct Cyc_List_List*
_temp32= curr; if( _temp32 == 0){ _throw( Null_Exception);} _temp32->tl=({
struct Cyc_List_List* _temp33=( struct Cyc_List_List*) GC_malloc( sizeof( struct
Cyc_List_List)); _temp33->hd=( void*)(( void*)({ struct Cyc_List_List* _temp34=
x2; if( _temp34 == 0){ _throw( Null_Exception);} _temp34->hd;})); _temp33->tl= 0;
_temp33;});}); curr=({ struct Cyc_List_List* _temp35= curr; if( _temp35 == 0){
_throw( Null_Exception);} _temp35->tl;});} x2=({ struct Cyc_List_List* _temp36=
x2; if( _temp36 == 0){ _throw( Null_Exception);} _temp36->tl;}); ++ cardinality;}}}
if( x1 != 0){ if( curr == 0){ nodes= x1;} else{({ struct Cyc_List_List* _temp37=
...
struct Cyc_List_List* result=({ struct Cyc_List_List* _temp42=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp42->hd=( void*)(( void*)({
struct Cyc_List_List* _temp43= n; if( _temp43 == 0){ _throw( Null_Exception);}
_temp43->hd;})); _temp42->tl= 0; _temp42;}); struct Cyc_List_List* prev= result;
n=({ struct Cyc_List_List* _temp44= n; if( _temp44 == 0){ _throw( Null_Exception);}
_temp44->tl;}); while( n != 0? compare(( void*)({ struct Cyc_List_List* _temp45=
n; if( _temp45 == 0){ _throw( Null_Exception);} _temp45->hd;}), elt) != 0: 0) {({
struct Cyc_List_List* _temp46= prev; if( _temp46 == 0){ _throw( Null_Exception);}
_temp46->tl=({ struct Cyc_List_List* _temp47=( struct Cyc_List_List*) GC_malloc(
sizeof( struct Cyc_List_List)); _temp47->hd=( void*)(( void*)({ struct Cyc_List_List*
_temp48= n; if( _temp48 == 0){ _throw( Null_Exception);} _temp48->hd;}));
_temp47->tl= 0; _temp47;});}); prev=({ struct Cyc_List_List* _temp49= prev; if(
_temp49 == 0){ _throw( Null_Exception);} _temp49->tl;}); n=({ struct Cyc_List_List*
_temp50= n; if( _temp50 == 0){ _throw( Null_Exception);} _temp50->tl;});}({
struct Cyc_List_List* _temp51= prev; if( _temp51 == 0){ _throw( Null_Exception);}
_temp51->tl=({ struct Cyc_List_List* _temp52= n; if( _temp52 == 0){ _throw(
Null_Exception);} _temp52->tl;});}); return result;}} struct Cyc_Set_Set* Cyc_Set_delete(
...
struct Cyc_List_List* _temp58= x1; if( _temp58 == 0){ _throw( Null_Exception);}
_temp58->hd;}),( void*)({ struct Cyc_List_List* _temp59= x2; if( _temp59 == 0){
_throw( Null_Exception);} _temp59->hd;})); if( i == 0){ if( result == 0){ result=({
struct Cyc_List_List* _temp60=( struct Cyc_List_List*) GC_malloc( sizeof( struct
Cyc_List_List)); _temp60->hd=( void*)(( void*)({ struct Cyc_List_List* _temp61=
x1; if( _temp61 == 0){ _throw( Null_Exception);} _temp61->hd;})); _temp60->tl= 0;
_temp60;}); prev= result;} else{({ struct Cyc_List_List* _temp62= prev; if(
_temp62 == 0){ _throw( Null_Exception);} _temp62->tl=({ struct Cyc_List_List*
_temp63=( struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List));
_temp63->hd=( void*)(( void*)({ struct Cyc_List_List* _temp64= x1; if( _temp64
== 0){ _throw( Null_Exception);} _temp64->hd;})); _temp63->tl= 0; _temp63;});});
prev=({ struct Cyc_List_List* _temp65= prev; if( _temp65 == 0){ _throw(
Null_Exception);} _temp65->tl;});} ++ card; x1=({ struct Cyc_List_List* _temp66=
x1; if( _temp66 == 0){ _throw( Null_Exception);} _temp66->tl;}); x2=({ struct
Cyc_List_List* _temp67= x2; if( _temp67 == 0){ _throw( Null_Exception);} _temp67->tl;});}
else{ if( i < 0){ x1=({ struct Cyc_List_List* _temp68= x1; if( _temp68 == 0){
_throw( Null_Exception);} _temp68->tl;});} else{ x2=({ struct Cyc_List_List*
_temp69= x2; if( _temp69 == 0){ _throw( Null_Exception);} _temp69->tl;});}}}
...
== 0){ return 0;}{ int i= comp(( void*)({ struct Cyc_List_List* _temp80= x1; if(
_temp80 == 0){ _throw( Null_Exception);} _temp80->hd;}),( void*)({ struct Cyc_List_List*
_temp81= x2; if( _temp81 == 0){ _throw( Null_Exception);} _temp81->hd;})); if( i
== 0){ x1=({ struct Cyc_List_List* _temp82= x1; if( _temp82 == 0){ _throw(
Null_Exception);} _temp82->tl;}); x2=({ struct Cyc_List_List* _temp83= x2; if(
_temp83 == 0){ _throw( Null_Exception);} _temp83->tl;});} else{ if( i > 0){ x2=({
struct Cyc_List_List* _temp84= x2; if( _temp84 == 0){ _throw( Null_Exception);}
_temp84->tl;});} else{ return 0;}}}} return 1;} struct Cyc_Set_Set* Cyc_Set_diff(
...
void*)({ struct Cyc_List_List* _temp85= x2; if( _temp85 == 0){ _throw(
Null_Exception);} _temp85->hd;}); if((( int(*)( int(* compare)( void*, void*),
...
_temp86= x2; if( _temp86 == 0){ _throw( Null_Exception);} _temp86->tl;});}
...
diff= comp(( void*)({ struct Cyc_List_List* _temp88= x1; if( _temp88 == 0){
_throw( Null_Exception);} _temp88->hd;}),( void*)({ struct Cyc_List_List*
_temp89= x2; if( _temp89 == 0){ _throw( Null_Exception);} _temp89->hd;})); if(
diff != 0){ return diff;} x1=({ struct Cyc_List_List* _temp90= x1; if( _temp90
== 0){ _throw( Null_Exception);} _temp90->tl;}); x2=({ struct Cyc_List_List*
_temp91= x2; if( _temp91 == 0){ _throw( Null_Exception);} _temp91->tl;});}
