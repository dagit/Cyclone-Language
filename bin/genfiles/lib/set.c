...
void*), struct Cyc_List_List* x); extern char Cyc_List_Nth[ 8u]; struct Cyc_Set_Set;
typedef struct Cyc_Set_Set* Cyc_Set_gset_t; typedef struct Cyc_Set_Set* Cyc_Set_hset_t;
typedef struct Cyc_Set_Set* Cyc_Set_set_t; extern struct Cyc_Set_Set* Cyc_Set_empty(
int(* comp)( void*, void*)); extern struct Cyc_Set_Set* Cyc_Set_singleton( int(*
comp)( void*, void*), void* x); extern struct Cyc_Set_Set* Cyc_Set_from_list(
int(* comp)( void*, void*), struct Cyc_List_List* x); extern struct Cyc_Set_Set*
...
s); extern char Cyc_Set_Absent[ 11u]; extern void* Cyc_Set_choose( struct Cyc_Set_Set*
s); struct Cyc_Set_Set{ int(* compare)( void*, void*); int cardinality; struct
Cyc_List_List* nodes; } ; struct Cyc_Set_Set* Cyc_Set_empty( int(* comp)( void*,
void*)){ return({ struct Cyc_Set_Set* _temp0=( struct Cyc_Set_Set*) GC_malloc(
sizeof( struct Cyc_Set_Set)); _temp0->compare= comp; _temp0->cardinality= 0;
_temp0->nodes= 0; _temp0;});} struct Cyc_Set_Set* Cyc_Set_singleton( int(* comp)(
void*, void*), void* x){ return({ struct Cyc_Set_Set* _temp1=( struct Cyc_Set_Set*)
...
Cyc_List_List)); _temp4->hd=( void*) elt; _temp4->tl= n; _temp4;});} else{
struct Cyc_List_List* result=({ struct Cyc_List_List* _temp7=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp7->hd=( void*)(( void*)(( struct
Cyc_List_List*) _check_null( n))->hd); _temp7->tl= 0; _temp7;}); struct Cyc_List_List*
prev= result; n=(( struct Cyc_List_List*) _check_null( n))->tl; while( n != 0?(
i= compare(( void*)(( struct Cyc_List_List*) _check_null( n))->hd, elt)) < 0: 0) {((
struct Cyc_List_List*) _check_null( prev))->tl=({ struct Cyc_List_List* _temp5=(
struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List)); _temp5->hd=(
void*)(( void*)(( struct Cyc_List_List*) _check_null( n))->hd); _temp5->tl= 0;
_temp5;}); prev=(( struct Cyc_List_List*) _check_null( prev))->tl; n=(( struct
...
sizeof( struct Cyc_List_List)); _temp6->hd=( void*) elt; _temp6->tl= n; _temp6;});
return result;}}} struct Cyc_Set_Set* Cyc_Set_insert( struct Cyc_Set_Set* s,
void* elt){ if((( int(*)( struct Cyc_Set_Set* s, void* elt)) Cyc_Set_member)( s,
elt)){ return s;} else{ return({ struct Cyc_Set_Set* _temp8=( struct Cyc_Set_Set*)
GC_malloc( sizeof( struct Cyc_Set_Set)); _temp8->compare= s->compare; _temp8->cardinality=
s->cardinality + 1; _temp8->nodes=(( struct Cyc_List_List*(*)( int(* compare)(
void*, void*), struct Cyc_List_List* n, void* elt)) Cyc_Set_insert_b)( s->compare,
s->nodes, elt); _temp8;});}} struct Cyc_Set_Set* Cyc_Set_union_two( struct Cyc_Set_Set*
...
0){ if( curr == 0){ nodes=({ struct Cyc_List_List* _temp9=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp9->hd=( void*)(( void*)(( struct
Cyc_List_List*) _check_null( x1))->hd); _temp9->tl= 0; _temp9;}); curr= nodes;}
else{(( struct Cyc_List_List*) _check_null( curr))->tl=({ struct Cyc_List_List*
_temp10=( struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List));
_temp10->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( x1))->hd);
_temp10->tl= 0; _temp10;}); curr=(( struct Cyc_List_List*) _check_null( curr))->tl;}
x1=(( struct Cyc_List_List*) _check_null( x1))->tl; ++ cardinality;} else{ if(
curr == 0){ nodes=({ struct Cyc_List_List* _temp11=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp11->hd=( void*)(( void*)((
struct Cyc_List_List*) _check_null( x2))->hd); _temp11->tl= 0; _temp11;}); curr=
...
_temp12->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( x2))->hd);
...
Cyc_List_length)( x2);}} return({ struct Cyc_Set_Set* _temp13=( struct Cyc_Set_Set*)
GC_malloc( sizeof( struct Cyc_Set_Set)); _temp13->compare= comp; _temp13->cardinality=
...
_check_null( n))->hd); _temp15->tl= 0; _temp15;}); struct Cyc_List_List* prev=
...
Cyc_List_List*) _check_null( prev))->tl=({ struct Cyc_List_List* _temp14=(
struct Cyc_List_List*) GC_malloc( sizeof( struct Cyc_List_List)); _temp14->hd=(
void*)(( void*)(( struct Cyc_List_List*) _check_null( n))->hd); _temp14->tl= 0;
_temp14;}); prev=(( struct Cyc_List_List*) _check_null( prev))->tl; n=(( struct
Cyc_List_List*) _check_null( n))->tl;}(( struct Cyc_List_List*) _check_null(
...
Cyc_Set_Set* _temp16=( struct Cyc_Set_Set*) GC_malloc( sizeof( struct Cyc_Set_Set));
_temp16->compare= s->compare; _temp16->cardinality= s->cardinality - 1; _temp16->nodes=((
struct Cyc_List_List*(*)( int(* compare)( void*, void*), struct Cyc_List_List* n,
void* elt)) Cyc_Set_delete_b)( s->compare, s->nodes, elt); _temp16;});} else{
...
_temp17->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( x1))->hd);
_temp17->tl= 0; _temp17;}); prev= result;} else{(( struct Cyc_List_List*)
_check_null( prev))->tl=({ struct Cyc_List_List* _temp18=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp18->hd=( void*)(( void*)((
struct Cyc_List_List*) _check_null( x1))->hd); _temp18->tl= 0; _temp18;}); prev=((
...
comp; _temp19->cardinality= card; _temp19->nodes= result; _temp19;});}} struct
...
return({ struct Cyc_Set_Set* _temp20=( struct Cyc_Set_Set*) GC_malloc( sizeof(
struct Cyc_Set_Set)); _temp20->compare= comp; _temp20->cardinality=(( int(*)(
struct Cyc_List_List* x)) Cyc_List_length)( z); _temp20->nodes= z; _temp20;});}
...
struct Cyc_Set_Set* _temp21=( struct Cyc_Set_Set*) GC_malloc( sizeof( struct Cyc_Set_Set));
_temp21->compare= comp; _temp21->cardinality= card; _temp21->nodes= x1; _temp21;});}
...
11u]; void* Cyc_Set_choose( struct Cyc_Set_Set* s){ if( s->nodes == 0){( void)
_throw(( void*) Cyc_Set_Absent);} return( void*)(( struct Cyc_List_List*)
_check_null( s->nodes))->hd;}