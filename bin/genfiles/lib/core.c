...
struct _tuple0{ void* f1; void* f2; } ; extern void* Cyc_Core_fst( struct
_tuple0*); extern void* Cyc_Core_snd( struct _tuple0*); struct _tuple1{ void* f1;
...
Cyc_Core_Opt)); _temp0->v=( void*) f(( void*)(( struct Cyc_Core_Opt*)
_check_null( o))->v); _temp0;});} struct _tagged_string Cyc_Core_new_string( int
i){ return({ unsigned int _temp1=( unsigned int) i; char* _temp2=( char*)
GC_malloc_atomic( sizeof( char) * _temp1); struct _tagged_string _temp5={ _temp2,
_temp2, _temp2 + _temp1};{ unsigned int _temp3= _temp1; unsigned int j; for( j=
0; j < _temp3; j ++){ _temp2[ j]='\000';}}; _temp5;});} int Cyc_Core_true_f(
...
_LL6: return 1; case 10: _LL7: return 1; case 11: _LL8: return 1; case 12: _LL9:
return 1; case 13: _LL10: return 1; case 32: _LL11: return 1; default: _LL12:
...
Cyc_Core_InvalidArg_struct* _temp14=( struct Cyc_Core_InvalidArg_struct*)
...
struct _tagged_string)({ char* _temp16=( char*)"string to integer conversion";
struct _tagged_string _temp17; _temp17.curr= _temp16; _temp17.base= _temp16;
_temp17.last_plus_one= _temp16 + 29; _temp17;}); _temp15;}); _temp14;}));}}}}
int Cyc_Core_int_of_string( struct _tagged_string s){ int n; int i; int base;
int sign= 1; for( i= 0; i <({ struct _tagged_string _temp18= s;( unsigned int)(
_temp18.last_plus_one - _temp18.curr);})? Cyc_Core_is_space(*(( char*(*)( struct
_tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s,
sizeof( char), i)): 0; ++ i){;} while( i <({ struct _tagged_string _temp19= s;(
unsigned int)( _temp19.last_plus_one - _temp19.curr);})?*(( char*(*)( struct
_tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s,
...
if( i ==({ struct _tagged_string _temp20= s;( unsigned int)( _temp20.last_plus_one
- _temp20.curr);})){( void) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct*
...
_temp22.f1=( struct _tagged_string)({ char* _temp23=( char*)"string to integer conversion";
struct _tagged_string _temp24; _temp24.curr= _temp23; _temp24.base= _temp23;
_temp24.last_plus_one= _temp23 + 29; _temp24;}); _temp22;}); _temp21;}));} if( i
+ 1 ==({ struct _tagged_string _temp25= s;( unsigned int)( _temp25.last_plus_one
- _temp25.curr);})? 1:*(( char*(*)( struct _tagged_string, unsigned int,
...
_check_unknown_subscript)( s, sizeof( char),( ++ i))){ case 'x': _LL26: base= 16;
++ i; break; case 'o': _LL27: base= 8; ++ i; break; case 'b': _LL28: base= 2; ++
i; break; default: _LL29: base= 10; break;}} for( n= 0; i <({ struct
_tagged_string _temp31= s;( unsigned int)( _temp31.last_plus_one - _temp31.curr);})?*((
char*(*)( struct _tagged_string, unsigned int, unsigned int))
_check_unknown_subscript)( s, sizeof( char), i) !='\000': 0; ++ i){ int digit=
Cyc_Core_int_of_char(*(( char*(*)( struct _tagged_string, unsigned int,
unsigned int)) _check_unknown_subscript)( s, sizeof( char), i)); if( digit >=
base){( void) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct* _temp32=(
...
_temp35.last_plus_one= _temp34 + 29; _temp35;}); _temp33;}); _temp32;}));} n= n
...
0; -- i){*(( char*(*)( struct _tagged_string, unsigned int, unsigned int))
_check_unknown_subscript)( ans, sizeof( char), i)=( char)('0' + n % 10); n /= 10;}}
return ans;}} struct _tagged_string Cyc_Core_string_of_char( char c){ struct
_tagged_string ans= Cyc_Core_new_string( 2);*(( char*(*)( struct _tagged_string,
unsigned int, unsigned int)) _check_unknown_subscript)( ans, sizeof( char), 0)=
c; return ans;}