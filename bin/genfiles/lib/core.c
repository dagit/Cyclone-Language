...
extern int Cyc_Core_false_f( void*); struct _tuple0{ void* f1; void* f2; } ;
extern void* Cyc_Core_fst( struct _tuple0*); extern void* Cyc_Core_snd( struct
_tuple0*); struct _tuple1{ void* f1; void* f2; void* f3; } ; extern void* Cyc_Core_third(
...
void**, void**); extern char Cyc_Core_InvalidArg[ 15u]; struct Cyc_Core_InvalidArg_struct{
...
struct _tagged_string f1; } ; extern int Cyc_Core_is_space( char); extern int
Cyc_Core_int_of_string( struct _tagged_string); extern struct _tagged_string Cyc_Core_string_of_int(
int); extern struct _tagged_string Cyc_Core_string_of_uint( unsigned int);
extern struct _tagged_string Cyc_Core_string_of_char( char); extern char*
...
extern int system( char*); char Cyc_Core_InvalidArg[ 15u]="\000\000\000\000InvalidArg";
char Cyc_Core_SysError[ 13u]="\000\000\000\000SysError"; struct Cyc_Core_SysError_struct{
char* tag; int f1; } ; char Cyc_Core_Failure[ 12u]="\000\000\000\000Failure";
char Cyc_Core_Impossible[ 15u]="\000\000\000\000Impossible"; char Cyc_Core_Not_found[
14u]="\000\000\000\000Not_found"; char Cyc_Core_Unreachable[ 16u]="\000\000\000\000Unreachable";
struct Cyc_Core_Opt* Cyc_Core_opt_map( void*(* f)( void*), struct Cyc_Core_Opt*
o){ if( o == 0){ return 0;} return({ struct Cyc_Core_Opt* _temp0=( struct Cyc_Core_Opt*)
GC_malloc( sizeof( struct Cyc_Core_Opt)); _temp0->v=( void*) f(( void*)({ struct
Cyc_Core_Opt* _temp1= o; if( _temp1 == 0){ _throw( Null_Exception);} _temp1->v;}));
_temp0;});} struct _tagged_string Cyc_Core_new_string( int i){ return({
unsigned int _temp2=( unsigned int) i; char* _temp3=( char*) GC_malloc_atomic(
sizeof( char) * _temp2); struct _tagged_string _temp6={ _temp3, _temp3, _temp3 +
_temp2};{ unsigned int _temp4= _temp2; unsigned int j; for( j= 0; j < _temp4; j
++){ _temp3[ j]='\000';}}; _temp6;});} int Cyc_Core_true_f( void* x){ return 1;}
int Cyc_Core_false_f( void* x){ return 0;} int Cyc_Core_intcmp( int a, int b){
return a - b;} int Cyc_Core_charcmp( char a, char b){ return( int) a -( int) b;}
int Cyc_Core_ptrcmp( void** a, void** b){ if( a == b){ return 0;} if( a > b){
return 1;} return - 1;} void* Cyc_Core_fst( struct _tuple0* pair){ return(* pair).f1;}
void* Cyc_Core_snd( struct _tuple0* pair){ return(* pair).f2;} void* Cyc_Core_third(
struct _tuple1* triple){ return(* triple).f3;} void* Cyc_Core_identity( void* x){
return x;} int Cyc_Core_is_space( char c){ switch(( int) c){ case 9: _LL7:
return 1; case 10: _LL8: return 1; case 11: _LL9: return 1; case 12: _LL10:
...
Cyc_Core_InvalidArg_struct* _temp15=( struct Cyc_Core_InvalidArg_struct*)
GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct)); _temp15[ 0]=({ struct
Cyc_Core_InvalidArg_struct _temp16; _temp16.tag= Cyc_Core_InvalidArg; _temp16.f1=(
struct _tagged_string)({ char* _temp17=( char*)"string to integer conversion";
