...
struct _tagged_string); extern struct _tagged_string Cyc_Getopt_optarg; extern
int Cyc_Getopt_optind; extern int Cyc_Getopt_opterr; extern int Cyc_Getopt_optopt;
struct Cyc_Getopt_option{ struct _tagged_string name; int has_arg; int* flag;
int val; } ; extern int Cyc_Getopt_getopt( int argc, struct _tagged_ptr0 argv,
struct _tagged_string shortopts); struct _tagged_ptr1{ struct Cyc_Getopt_option*
curr; struct Cyc_Getopt_option* base; struct Cyc_Getopt_option* last_plus_one; }
; extern int Cyc_Getopt__getopt_internal( int argc, struct _tagged_ptr0 argv,
struct _tagged_string shortopts, struct _tagged_ptr1 longopts, int* longind, int
long_only); struct _tagged_string Cyc_Getopt_optarg={ 0, 0, 0}; int Cyc_Getopt_optind=
0; static struct _tagged_string Cyc_Getopt_nextchar; int Cyc_Getopt_opterr= 1;
int Cyc_Getopt_optopt=( int)'?'; enum  Cyc_Getopt_ordering_tag{ Cyc_Getopt_REQUIRE_ORDER
 =  0u, Cyc_Getopt_PERMUTE  =  1u, Cyc_Getopt_RETURN_IN_ORDER  =  2u}; enum  Cyc_Getopt_ordering_tag
Cyc_Getopt_ordering; static struct _tagged_string Cyc_Getopt_posixly_correct;
...
s1, struct _tagged_string s2, unsigned int len); extern struct _tagged_string
Cyc_String_strchr( struct _tagged_string s, unsigned char c); static int Cyc_Getopt_first_nonopt;
static int Cyc_Getopt_last_nonopt; static struct _tagged_string Cyc_Getopt_nonoption_flags;
...
_temp10.last_plus_one)){ _throw( Null_Exception);}* _temp11;}) =='\000'){ if(
Cyc_Getopt_last_nonopt > Cyc_Getopt_optind){ Cyc_Getopt_last_nonopt= Cyc_Getopt_optind;}
...
_throw( Null_Exception);}* _temp19;})?({ struct _tagged_string _temp20= nameend;
unsigned char* _temp21= _temp20.curr; if( _temp20.base == 0? 1:( _temp21 <
_temp20.base? 1: _temp21 >= _temp20.last_plus_one)){ _throw( Null_Exception);}*
...
_temp30.last_plus_one)){ _throw( Null_Exception);}* _temp31;})){ if(((( const
struct Cyc_Getopt_option*(*)( struct _tagged_ptr1, unsigned int, unsigned int))
_check_unknown_subscript)( pfound, sizeof( struct Cyc_Getopt_option), 0u))->has_arg){
Cyc_Getopt_optarg=({ struct _tagged_string _temp32= nameend; _temp32.curr += 1;
_temp32;});} else{ if( Cyc_Getopt_opterr){ if(*(( unsigned char*(*)( struct
_tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)(*((
struct _tagged_string*(*)( struct _tagged_ptr0, unsigned int, unsigned int))
_check_unknown_subscript)( argv, sizeof( struct _tagged_string), Cyc_Getopt_optind
- 1), sizeof( unsigned char), 1) =='-'){({ struct _tagged_string _temp33=(
struct _tagged_string)*(( struct _tagged_string*(*)( struct _tagged_ptr0,
unsigned int, unsigned int)) _check_unknown_subscript)( argv, sizeof( struct
_tagged_string), 0); struct _tagged_string _temp34=((( const struct Cyc_Getopt_option*(*)(
struct _tagged_ptr1, unsigned int, unsigned int)) _check_unknown_subscript)(
pfound, sizeof( struct Cyc_Getopt_option), 0u))->name; fprintf( sfile_to_file(
Cyc_Stdio_stderr),"%.*s: option `--%.*s' doesn't allow an argument\n", _temp33.last_plus_one
- _temp33.curr, _temp33.curr, _temp34.last_plus_one - _temp34.curr, _temp34.curr);});}
else{({ struct _tagged_string _temp35=( struct _tagged_string)*(( struct
_tagged_string*(*)( struct _tagged_ptr0, unsigned int, unsigned int))
_check_unknown_subscript)( argv, sizeof( struct _tagged_string), 0); int _temp36=(
int)*(( unsigned char*(*)( struct _tagged_string, unsigned int, unsigned int))
_check_unknown_subscript)(*(( struct _tagged_string*(*)( struct _tagged_ptr0,
unsigned int, unsigned int)) _check_unknown_subscript)( argv, sizeof( struct
_tagged_string), Cyc_Getopt_optind - 1), sizeof( unsigned char), 0); struct
_tagged_string _temp37=((( const struct Cyc_Getopt_option*(*)( struct
...
_temp41 >= _temp40.last_plus_one)){ _throw( Null_Exception);}* _temp41;}))).curr
...
_temp70.base? 1: _temp71 >= _temp70.last_plus_one)){ _throw( Null_Exception);}*
...
_temp52.last_plus_one)){ _throw( Null_Exception);}* _temp53;}) =='\000'){ ++ Cyc_Getopt_optind;}
if( temp.curr ==(( struct _tagged_string)({ struct _tagged_string _temp54={ 0, 0,
0}; _temp54;})).curr? 1: c ==':'){ if( Cyc_Getopt_opterr){ if(( unsigned int)
Cyc_Getopt_posixly_correct.curr){({ struct _tagged_string _temp55=( struct
_tagged_string)*(( struct _tagged_string*(*)( struct _tagged_ptr0, unsigned int,
unsigned int)) _check_unknown_subscript)( argv, sizeof( struct _tagged_string),
0); int _temp56=( int) c; fprintf( sfile_to_file( Cyc_Stdio_stderr),"%.*s: illegal option -- %c\n",
_temp55.last_plus_one - _temp55.curr, _temp55.curr, _temp56);});} else{({ struct
_tagged_string _temp57=( struct _tagged_string)*(( struct _tagged_string*(*)(
struct _tagged_ptr0, unsigned int, unsigned int)) _check_unknown_subscript)(
argv, sizeof( struct _tagged_string), 0); int _temp58=( int) c; fprintf(
sfile_to_file( Cyc_Stdio_stderr),"%.*s: invalid option -- %c\n", _temp57.last_plus_one
- _temp57.curr, _temp57.curr, _temp58);});}} Cyc_Getopt_optopt=( int) c; return(
int)'?';} if(*(( const unsigned char*(*)( struct _tagged_string, unsigned int,
unsigned int)) _check_unknown_subscript)( temp, sizeof( unsigned char), 1) ==':'){
if(*(( const unsigned char*(*)( struct _tagged_string, unsigned int,
unsigned int)) _check_unknown_subscript)( temp, sizeof( unsigned char), 2) ==':'){
if(({ struct _tagged_string _temp59= Cyc_Getopt_nextchar; unsigned char* _temp60=
_temp59.curr; if( _temp59.base == 0? 1:( _temp60 < _temp59.base? 1: _temp60 >=
_temp59.last_plus_one)){ _throw( Null_Exception);}* _temp60;}) !='\000'){ Cyc_Getopt_optarg=
Cyc_Getopt_nextchar; Cyc_Getopt_optind ++;} else{ Cyc_Getopt_optarg=({ struct
_tagged_string _temp61={ 0, 0, 0}; _temp61;});} Cyc_Getopt_nextchar=({ struct
_tagged_string _temp62={ 0, 0, 0}; _temp62;});} else{ if(({ struct
_tagged_string _temp63= Cyc_Getopt_nextchar; unsigned char* _temp64= _temp63.curr;
if( _temp63.base == 0? 1:( _temp64 < _temp63.base? 1: _temp64 >= _temp63.last_plus_one)){
_throw( Null_Exception);}* _temp64;}) !='\000'){ Cyc_Getopt_optarg= Cyc_Getopt_nextchar;
Cyc_Getopt_optind ++;} else{ if( Cyc_Getopt_optind == argc){ if( Cyc_Getopt_opterr){({
struct _tagged_string _temp65=( struct _tagged_string)*(( struct _tagged_string*(*)(
struct _tagged_ptr0, unsigned int, unsigned int)) _check_unknown_subscript)(
