...
extern struct _tagged_arr Cyc_Stdlib_getenv( struct _tagged_arr); extern struct
_tagged_arr Cyc_Getopt_optarg; extern int Cyc_Getopt_optind; extern int Cyc_Getopt_opterr;
