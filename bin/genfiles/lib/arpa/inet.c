...
f1; } ; extern int Cyc_Inet_inet_aton( struct _tagged_string cp, struct Cyc_Inet_in_addr*
inp); extern int inet_aton( unsigned char* cp, struct Cyc_Inet_in_addr* inp);
int Cyc_Inet_inet_aton( struct _tagged_string cp, struct Cyc_Inet_in_addr* inp){
