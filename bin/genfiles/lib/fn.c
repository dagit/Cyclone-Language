...
struct Cyc_List_List_empty_struct{ char* tag;}; extern struct Cyc_List_List* Cyc_List_map_c(
...
4u]; struct Cyc_List_Nth_struct{ char* tag;}; typedef void* Cyc_Fn_Function;
extern const int Cyc_Fn_Fun_tag; struct Cyc_Fn_Fun_struct{ int tag; void*(* f1)(
void*, void*); void* f2;}; typedef void* Cyc_Fn_fn; extern void* Cyc_Fn_make_fn(
void*(* f)( void*, void*), void* x); extern void* Cyc_Fn_fp2fn( void*(* f)( void*));
extern void* Cyc_Fn_apply( void* f, void* x); extern void* Cyc_Fn_compose( void*
g, void* f); extern void* Cyc_Fn_curry( void* f); extern void* Cyc_Fn_uncurry(
void* f); extern struct Cyc_List_List* Cyc_Fn_map_fn( void* f, struct Cyc_List_List*
x); const int Cyc_Fn_Fun_tag= 0; void* Cyc_Fn_make_fn( void*(* f)( void*, void*),
void* x){ return({ struct Cyc_Fn_Fun_struct* _temp0=( struct Cyc_Fn_Fun_struct*)
GC_malloc( sizeof( struct Cyc_Fn_Fun_struct)); _temp0->tag= Cyc_Fn_Fun_tag;
_temp0->f1= f; _temp0->f2=( void*) x;( void*) _temp0;});} static void* Cyc_Fn_fp_apply(
void*(* f)( void*), void* x){ return f( x);} void* Cyc_Fn_fp2fn( void*(* f)(
void*)){ return(( void*(*)( void*(* f)( void*(*)( void*), void*), void*(* x)(
void*))) Cyc_Fn_make_fn)(( void*(*)( void*(* f)( void*), void* x)) Cyc_Fn_fp_apply,
f);} void* Cyc_Fn_apply( void* f, void* x){ void* _temp1= f; void* _temp5; void*(*
_temp7)( void*, void*); _LL3: if((( struct _enum_struct*) _temp1)->tag == Cyc_Fn_Fun_tag){
_LL8: _temp7=( void*(*)( void*, void*))(( struct Cyc_Fn_Fun_struct*) _temp1)->f1;
goto _LL6; _LL6: _temp5=( void*)(( struct Cyc_Fn_Fun_struct*) _temp1)->f2; goto
_LL4;} else{ goto _LL2;} _LL4: return _temp7( _temp5, x); _LL2:;} static void*
Cyc_Fn_fn_compose( struct _tuple0* f_and_g, void* arg){ struct _tuple0 _temp11;
void* _temp12; void* _temp14; struct _tuple0* _temp9= f_and_g; _temp11=* _temp9;
_LL15: _temp14= _temp11.f1; goto _LL13; _LL13: _temp12= _temp11.f2; goto _LL10;
_LL10: return(( void*(*)( void* f, void* x)) Cyc_Fn_apply)( _temp14,(( void*(*)(
void* f, void* x)) Cyc_Fn_apply)( _temp12, arg));} void* Cyc_Fn_compose( void* g,
...
struct _tuple0* _temp16=( struct _tuple0*) GC_malloc( sizeof( struct _tuple0));
_temp16->f1= f; _temp16->f2= g; _temp16;}));} static void* Cyc_Fn_inner( struct
