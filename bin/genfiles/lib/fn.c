...
struct Cyc_List_List* x); extern unsigned char Cyc_List_Nth[ 8u]; static const
int Cyc_Fn_Fun= 0; struct Cyc_Fn_Fun_struct{ int tag; void*(* f1)( void*, void*);
void* f2; } ; extern void* Cyc_Fn_make_fn( void*(* f)( void*, void*), void* x);
...
_temp11= _temp10.f2; goto _LL9; _LL9: return Cyc_Fn_apply( _temp13, Cyc_Fn_apply(
_temp11, arg));} void* Cyc_Fn_compose( void* g, void* f){ return(( void*(*)(
