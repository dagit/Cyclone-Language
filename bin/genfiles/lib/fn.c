...
void*); void* _temp2= f; if((( struct _tunion_struct*) _temp2)->tag == Cyc_Fn_Fun_tag){
...
_LL3;} else{ goto _LL3;} _LL3: return _temp6( _temp4, x);} static void* Cyc_Fn_fn_compose(
struct _tuple0* f_and_g, void* arg){ struct _tuple0 _temp10; void* _temp11; void*
