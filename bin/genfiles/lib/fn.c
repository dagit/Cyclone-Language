...
_temp1.tag= Cyc_Fn_Fun_tag; _temp1.f1= f; _temp1.f2=( void*) x; _temp1;});
...
void* _temp2= f; void* _temp6; void*(* _temp8)( void*, void*); _LL4: if(((
struct _tunion_struct*) _temp2)->tag == Cyc_Fn_Fun_tag){ _LL9: _temp8=( void*(*)(
void*, void*))(( struct Cyc_Fn_Fun_struct*) _temp2)->f1; goto _LL7; _LL7: _temp6=(
void*)(( struct Cyc_Fn_Fun_struct*) _temp2)->f2; goto _LL5;} else{ goto _LL3;}
_LL5: return _temp8( _temp6, x); _LL3:;} static void* Cyc_Fn_fn_compose( struct
_tuple0* f_and_g, void* arg){ struct _tuple0 _temp12; void* _temp13; void*
_temp15; struct _tuple0* _temp10= f_and_g; _temp12=* _temp10; _LL16: _temp15=
_temp12.f1; goto _LL14; _LL14: _temp13= _temp12.f2; goto _LL11; _LL11: return((
void*(*)( void* f, void* x)) Cyc_Fn_apply)( _temp15,(( void*(*)( void* f, void*
x)) Cyc_Fn_apply)( _temp13, arg));} void* Cyc_Fn_compose( void* g, void* f){
...
f; _temp17->f2= g; _temp17;}));} static void* Cyc_Fn_inner( struct _tuple0* env,
void* second){ return(( void*(*)( void* f, struct _tuple0* x)) Cyc_Fn_apply)((*
env).f1,({ struct _tuple0* _temp18=( struct _tuple0*) GC_malloc( sizeof( struct
_tuple0)); _temp18->f1=(* env).f2; _temp18->f2= second; _temp18;}));} static
...
env, void* second)) Cyc_Fn_inner,({ struct _tuple0* _temp19=( struct _tuple0*)
GC_malloc( sizeof( struct _tuple0)); _temp19->f1= f; _temp19->f2= first; _temp19;}));}
