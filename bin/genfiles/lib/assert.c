...
struct _tagged_string, struct Cyc_Stdio___sFILE*); extern char Cyc_Stdio_FileOpenError_tag[
14u]; struct Cyc_Stdio_FileOpenError_struct{ char* tag; struct _tagged_string f1;
} ; extern char Cyc_Stdio_FileCloseError_tag[ 15u]; struct Cyc_Stdio_FileCloseError_struct{
char* tag; } ; void* Cyc_Assert_AssertFail( struct _tagged_string mesg){ Cyc_Stdio_fputs(
mesg,( struct Cyc_Stdio___sFILE*) Cyc_Stdio_stderr); Cyc_Stdio_fputs(( struct
_tagged_string)({ char* _temp0=( char*)" -- assertion failed\n"; struct
_tagged_string _temp1; _temp1.curr= _temp0; _temp1.base= _temp0; _temp1.last_plus_one=
_temp0 + 22; _temp1;}),( struct Cyc_Stdio___sFILE*) Cyc_Stdio_stderr); return((
void*(*)( int)) exit)( - 1);}