...
extern void *Cyc_Assert_AssertFail(struct _tagged_string msg);
...
void *Cyc_Assert_AssertFail(struct _tagged_string mesg) {
  Cyc_Stdio_fputs(mesg,Cyc_Stdio_stderr);
  Cyc_Stdio_fputs((struct _tagged_string)({ char *_temp0 = (char *)" -- assertion failed\n";
		    struct _tagged_string _temp1;
		    _temp1.curr = _temp0;
		    _temp1.base = _temp0;
		    _temp1.last_plus_one = _temp0 + 22;
		    _temp1; }),Cyc_Stdio_stderr);
  return ((void *(*)(int))exit)(- 1);
}
