...
_sys_errlist[ 135u]  __attribute__(( dllimport )) ; struct _tagged_arr Cyc_Errno_sys_err(
int i){ if( i <  0? 1: i >  _sys_nerr){( int) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct*
