...
struct _tagged_string)({ char* _temp23=( char*)"singleton xarray must have size >=1";
...
_temp25.curr);})){ if( xarr->num_elmts == 0){ xarr->elmts=( struct _tagged_ptr0)({
void** _temp29=( void**)({ unsigned int _temp26= 10u; void** _temp27=( void**)
GC_malloc( sizeof( void*) * _temp26);{ unsigned int _temp28= _temp26;
unsigned int i; for( i= 0; i < _temp28; i ++){ _temp27[ i]= a;}}; _temp27;});
struct _tagged_ptr0 _temp30; _temp30.curr= _temp29; _temp30.base= _temp29;
_temp30.last_plus_one= _temp29 + 10; _temp30;});} else{ struct _tagged_ptr0
newarr=({ unsigned int _temp31=( unsigned int)( xarr->num_elmts * 2); void**
_temp32=( void**) GC_malloc( sizeof( void*) * _temp31); struct _tagged_ptr0
_temp34={ _temp32, _temp32, _temp32 + _temp31};{ unsigned int _temp33= _temp31;
unsigned int i; for( i= 0; i < _temp33; i ++){ _temp32[ i]=*(( void**(*)( struct
_tagged_ptr0, unsigned int, unsigned int)) _check_unknown_subscript)( xarr->elmts,
sizeof( void*), 0);}}; _temp34;});{ int i= 1; for( 0; i < xarr->num_elmts; ++ i){*((
...
_tagged_ptr0)({ void** _temp36=( void**)({ void** _temp35=( void**) GC_malloc(
sizeof( void*) * 0); _temp35;}); struct _tagged_ptr0 _temp37; _temp37.curr=
