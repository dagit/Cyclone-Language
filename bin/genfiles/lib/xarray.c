...
struct _tagged_ptr0 elmts; int num_elmts; } ; extern int Cyc_Xarray_length(
...
_temp5;}); _temp4;}));}*(( void**(*)( struct _tagged_ptr0, unsigned int,
unsigned int)) _check_unknown_subscript)( xarr->elmts, sizeof( void*), i)= a;}
struct Cyc_Xarray_Xarray* Cyc_Xarray_create_empty(){ struct _tagged_ptr0 x=({
void** _temp10=({ void** _temp9=( void**) GC_malloc( sizeof( void*) * 0); _temp9;});
struct _tagged_ptr0 _temp11; _temp11.curr= _temp10; _temp11.base= _temp10;
...
_tagged_ptr0 _temp25= xarr->elmts;( unsigned int)( _temp25.last_plus_one -
...
i ++){ _temp27[ i]= a;}}; _temp27;}); struct _tagged_ptr0 _temp30; _temp30.curr=
_temp29; _temp30.base= _temp29; _temp30.last_plus_one= _temp29 + 10; _temp30;});}
else{ struct _tagged_ptr0 newarr=({ unsigned int _temp31=( unsigned int)( xarr->num_elmts
* 2); void** _temp32=( void**) GC_malloc( sizeof( void*) * _temp31); struct
_tagged_ptr0 _temp34={ _temp32, _temp32, _temp32 + _temp31};{ unsigned int
...
i= 1; for( 0; i < xarr->num_elmts; ++ i){*(( void**(*)( struct _tagged_ptr0,
...
newarr;}}*(( void**(*)( struct _tagged_ptr0, unsigned int, unsigned int))
...
- 1;} struct _tagged_ptr0 Cyc_Xarray_to_array( struct Cyc_Xarray_Xarray* xarr){
if( xarr->num_elmts == 0){ return({ void** _temp36=({ void** _temp35=( void**)
GC_malloc( sizeof( void*) * 0); _temp35;}); struct _tagged_ptr0 _temp37; _temp37.curr=
_temp36; _temp37.base= _temp36; _temp37.last_plus_one= _temp36 + 0; _temp37;});}{
struct _tagged_ptr0 ans=({ unsigned int _temp38=( unsigned int) xarr->num_elmts;
void** _temp39=( void**) GC_malloc( sizeof( void*) * _temp38); struct
_tagged_ptr0 _temp41={ _temp39, _temp39, _temp39 + _temp38};{ unsigned int
...
_tagged_ptr0 arr){ if(({ struct _tagged_ptr0 _temp42= arr;( unsigned int)(
