...
x, struct Cyc_List_List* y){ return Cyc_List_rmap2( Cyc_Core_heap_region, f, x,
y);} void Cyc_List_app( void*(* f)( void*), struct Cyc_List_List* x){ while( x
!= 0) { f(( void*)(( struct Cyc_List_List*) _check_null( x))->hd); x=(( struct
Cyc_List_List*) _check_null( x))->tl;}} void Cyc_List_app_c( void*(* f)( void*,
void*), void* env, struct Cyc_List_List* x){ while( x != 0) { f( env,( void*)((
...
compare(( void*)(( struct Cyc_List_List*) _check_null( l))->hd, x) == 0){ return
1;} l=(( struct Cyc_List_List*) _check_null( l))->tl;} return 0;} void* Cyc_List_assoc(
...
_check_null( l2))->tl)){ if( l1 == l2){ return 0;}{ int _temp43= cmp(( void*)((
struct Cyc_List_List*) _check_null( l1))->hd,( void*)(( struct Cyc_List_List*)
_check_null( l2))->hd); if( _temp43 != 0){ return _temp43;}}} if( l1 != 0){
...
l1 != 0? l2 != 0: 0;( l1=(( struct Cyc_List_List*) _check_null( l1))->tl, l2=((
struct Cyc_List_List*) _check_null( l2))->tl)){ if( l1 == l2){ return 1;}{ int
_temp44= cmp(( void*)(( struct Cyc_List_List*) _check_null( l1))->hd,( void*)((
...
_temp46->tl= 0; _temp46;}); struct Cyc_List_List* end= result; for( 0; l != 0; l=((
...
struct Cyc_List_List* _temp45=( struct Cyc_List_List*) _region_malloc( r2,
sizeof( struct Cyc_List_List)); _temp45->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( l))->hd); _temp45->tl= 0; _temp45;}); end=(( struct Cyc_List_List*)
...
struct Cyc_List_List* l){ return Cyc_List_rfilter_c( Cyc_Core_heap_region, f,
env, l);} struct Cyc_List_List* Cyc_List_rfilter( struct _RegionHandle* r2, int(*
f)( void*), struct Cyc_List_List* l){ if( l == 0){ return 0;}{ struct Cyc_List_List*
result=({ struct Cyc_List_List* _temp48=( struct Cyc_List_List*) _region_malloc(
r2, sizeof( struct Cyc_List_List)); _temp48->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( l))->hd); _temp48->tl= 0; _temp48;}); struct Cyc_List_List* end=
result; for( 0; l != 0; l=(( struct Cyc_List_List*) _check_null( l))->tl){ if( f((
void*)(( struct Cyc_List_List*) _check_null( l))->hd)){(( struct Cyc_List_List*)
_check_null( end))->tl=({ struct Cyc_List_List* _temp47=( struct Cyc_List_List*)
_region_malloc( r2, sizeof( struct Cyc_List_List)); _temp47->hd=( void*)(( void*)((
struct Cyc_List_List*) _check_null( l))->hd); _temp47->tl= 0; _temp47;}); end=((
struct Cyc_List_List*) _check_null( end))->tl;}} return(( struct Cyc_List_List*)
_check_null( result))->tl;}} struct Cyc_List_List* Cyc_List_filter( int(* f)(
