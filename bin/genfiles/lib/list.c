...
struct Cyc_List_List{ void* hd; struct Cyc_List_List* tl; } ; struct
...
struct Cyc_List_List* x); extern struct _tagged_ptr1 Cyc_List_to_array( struct
Cyc_List_List* x); extern struct _tagged_ptr1 Cyc_List_rto_array( struct
_RegionHandle* r2, struct Cyc_List_List* x); extern struct Cyc_List_List* Cyc_List_from_array(
struct _tagged_ptr1 arr); extern struct Cyc_List_List* Cyc_List_rfrom_array(
struct _RegionHandle* r2, struct _tagged_ptr1 arr); extern struct Cyc_List_List*
...
struct _RegionHandle* r, struct _tagged_ptr1 argv){ struct Cyc_List_List* result=
0;{ int i=( int)(({ struct _tagged_ptr1 _temp1= argv;( unsigned int)( _temp1.last_plus_one
- _temp1.curr);}) - 1); for( 0; i >= 0; i --){ result=({ struct Cyc_List_List*
_temp0=( struct Cyc_List_List*) _region_malloc( r, sizeof( struct Cyc_List_List));
_temp0->hd=( void*)*(( void**(*)( struct _tagged_ptr1, unsigned int,
unsigned int)) _check_unknown_subscript)( argv, sizeof( void*), i); _temp0->tl=
result; _temp0;});}} return result;} struct Cyc_List_List* Cyc_List_list( struct
_tagged_ptr1 argv){ struct Cyc_List_List* result= 0;{ int i=( int)(({ struct
_tagged_ptr1 _temp3= argv;( unsigned int)( _temp3.last_plus_one - _temp3.curr);})
- 1); for( 0; i >= 0; i --){ result=({ struct Cyc_List_List* _temp2=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp2->hd=( void*)*(( void**(*)(
struct _tagged_ptr1, unsigned int, unsigned int)) _check_unknown_subscript)(
argv, sizeof( void*), i); _temp2->tl= result; _temp2;});}} return result;}
struct Cyc_List_List* Cyc_List_rcopy( struct _RegionHandle* r2, struct Cyc_List_List*
x){ struct Cyc_List_List* result; struct Cyc_List_List* prev; if( x == 0){
return 0;} result=({ struct Cyc_List_List* _temp4=( struct Cyc_List_List*)
_region_malloc( r2, sizeof( struct Cyc_List_List)); _temp4->hd=( void*)(( void*)((
struct Cyc_List_List*) _check_null( x))->hd); _temp4->tl= 0; _temp4;}); prev=
result; for( x=(( struct Cyc_List_List*) _check_null( x))->tl; x != 0; x=((
struct Cyc_List_List*) _check_null( x))->tl){(( struct Cyc_List_List*)
_check_null( prev))->tl=({ struct Cyc_List_List* _temp5=( struct Cyc_List_List*)
_region_malloc( r2, sizeof( struct Cyc_List_List)); _temp5->hd=( void*)(( void*)((
struct Cyc_List_List*) _check_null( x))->hd); _temp5->tl= 0; _temp5;}); prev=((
...
void*) f(( void*)(( struct Cyc_List_List*) _check_null( x))->hd); _temp6->tl= 0;
_temp6;}); prev= result; for( x=(( struct Cyc_List_List*) _check_null( x))->tl;
x != 0; x=(( struct Cyc_List_List*) _check_null( x))->tl){ struct Cyc_List_List*
temp=({ struct Cyc_List_List* _temp7=( struct Cyc_List_List*) _region_malloc( r2,
sizeof( struct Cyc_List_List)); _temp7->hd=( void*) f(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd); _temp7->tl= 0; _temp7;});(( struct Cyc_List_List*)
_check_null( prev))->tl= temp; prev= temp;} return result;} struct Cyc_List_List*
Cyc_List_map( void*(* f)( void*), struct Cyc_List_List* x){ return(( struct Cyc_List_List*(*)(
struct _RegionHandle* r2, void*(* f)( void*), struct Cyc_List_List* x)) Cyc_List_rmap)(
...
r2, sizeof( struct Cyc_List_List)); _temp8->hd=( void*) f( env,( void*)(( struct
Cyc_List_List*) _check_null( x))->hd); _temp8->tl= 0; _temp8;}); prev= result;
...
struct Cyc_List_List* _temp9=( struct Cyc_List_List*) _region_malloc( r2,
sizeof( struct Cyc_List_List)); _temp9->hd=( void*) f( env,( void*)(( struct Cyc_List_List*)
_check_null( x))->hd); _temp9->tl= 0; _temp9;}); prev=(( struct Cyc_List_List*)
...
0? 1: y == 0){( void) _throw(( void*) Cyc_List_List_mismatch);} result=({ struct
Cyc_List_List* _temp10=( struct Cyc_List_List*) _region_malloc( r3, sizeof(
struct Cyc_List_List)); _temp10->hd=( void*) f(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd,( void*)(( struct Cyc_List_List*) _check_null( y))->hd);
_temp10->tl= 0; _temp10;}); prev= result; x=(( struct Cyc_List_List*)
_check_null( x))->tl; y=(( struct Cyc_List_List*) _check_null( y))->tl; while( x
!= 0? y != 0: 0) {(( struct Cyc_List_List*) _check_null( prev))->tl=({ struct
Cyc_List_List* _temp11=( struct Cyc_List_List*) _region_malloc( r3, sizeof(
struct Cyc_List_List)); _temp11->hd=( void*) f(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd,( void*)(( struct Cyc_List_List*) _check_null( y))->hd);
...
struct Cyc_List_List* y)) Cyc_List_rmap2)( Cyc_Core_heap_region, f, x, y);} void
Cyc_List_app( void*(* f)( void*), struct Cyc_List_List* x){ while( x != 0) { f((
...
while( x != 0) { y=({ struct Cyc_List_List* _temp12=( struct Cyc_List_List*)
_region_malloc( r2, sizeof( struct Cyc_List_List)); _temp12->hd=( void*)(( void*)((
struct Cyc_List_List*) _check_null( x))->hd); _temp12->tl= y; _temp12;}); x=((
...
result=({ struct Cyc_List_List* _temp13=( struct Cyc_List_List*) _region_malloc(
r2, sizeof( struct Cyc_List_List)); _temp13->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd); _temp13->tl= 0; _temp13;}); prev= result; for( x=((
struct Cyc_List_List*) _check_null( x))->tl; x != 0; x=(( struct Cyc_List_List*)
_check_null( x))->tl){(( struct Cyc_List_List*) _check_null( prev))->tl=({
struct Cyc_List_List* _temp14=( struct Cyc_List_List*) _region_malloc( r2,
sizeof( struct Cyc_List_List)); _temp14->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd); _temp14->tl= 0; _temp14;}); prev=(( struct Cyc_List_List*)
...
_temp15=( struct Cyc_List_List*) _region_malloc( r3, sizeof( struct Cyc_List_List));
_temp15->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( a))->hd);
_temp15->tl= 0; _temp15;}); a=(( struct Cyc_List_List*) _check_null( a))->tl;}
else{ c=({ struct Cyc_List_List* _temp16=( struct Cyc_List_List*) _region_malloc(
r3, sizeof( struct Cyc_List_List)); _temp16->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( b))->hd); _temp16->tl= 0; _temp16;}); b=(( struct Cyc_List_List*)
...
struct Cyc_List_List* _temp17=( struct Cyc_List_List*) _region_malloc( r3,
sizeof( struct Cyc_List_List)); _temp17->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( a))->hd); _temp17->tl= 0; _temp17;}); c=(( struct Cyc_List_List*)
_check_null( c))->tl; a=(( struct Cyc_List_List*) _check_null( a))->tl;} else{((
struct Cyc_List_List*) _check_null( c))->tl=({ struct Cyc_List_List* _temp18=(
struct Cyc_List_List*) _region_malloc( r3, sizeof( struct Cyc_List_List));
_temp18->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( b))->hd);
_temp18->tl= 0; _temp18;}); c=(( struct Cyc_List_List*) _check_null( c))->tl; b=((
...
Cyc_List_List*) _check_null( x))->tl;} if( i < 0? 1: x == 0){( void) _throw((
...
result; struct Cyc_List_List* prev; if( x == 0? y == 0: 0){ return 0;} if( x ==
0? 1: y == 0){( void) _throw(( void*) Cyc_List_List_mismatch);} result=({ struct
Cyc_List_List* _temp19=( struct Cyc_List_List*) _region_malloc( r3, sizeof(
struct Cyc_List_List)); _temp19->hd=( void*)({ struct _tuple2* _temp20=( struct
_tuple2*) _region_malloc( r4, sizeof( struct _tuple2)); _temp20->f1=( void*)((
struct Cyc_List_List*) _check_null( x))->hd; _temp20->f2=( void*)(( struct Cyc_List_List*)
_check_null( y))->hd; _temp20;}); _temp19->tl= 0; _temp19;}); prev= result; x=((
struct Cyc_List_List*) _check_null( x))->tl; y=(( struct Cyc_List_List*)
_check_null( y))->tl; while( x != 0? y != 0: 0) {(( struct Cyc_List_List*)
_check_null( prev))->tl=({ struct Cyc_List_List* _temp21=( struct Cyc_List_List*)
_region_malloc( r3, sizeof( struct Cyc_List_List)); _temp21->hd=( void*)({
struct _tuple2* _temp22=( struct _tuple2*) _region_malloc( r4, sizeof( struct
_tuple2)); _temp22->f1=( void*)(( struct Cyc_List_List*) _check_null( x))->hd;
_temp22->f2=( void*)(( struct Cyc_List_List*) _check_null( y))->hd; _temp22;});
_temp21->tl= 0; _temp21;}); prev=(( struct Cyc_List_List*) _check_null( prev))->tl;
x=(( struct Cyc_List_List*) _check_null( x))->tl; y=(( struct Cyc_List_List*)
_check_null( y))->tl;} if( x != 0? 1: y != 0){( void) _throw(( void*) Cyc_List_List_mismatch);}
...
return({ struct _tuple0 _temp23; _temp23.f1= 0; _temp23.f2= 0; _temp23;});}
prev1=( result1=({ struct Cyc_List_List* _temp24=( struct Cyc_List_List*)
_region_malloc( r3, sizeof( struct Cyc_List_List)); _temp24->hd=( void*)(((
struct _tuple2*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f1; _temp24->tl= 0; _temp24;})); prev2=(
result2=({ struct Cyc_List_List* _temp25=( struct Cyc_List_List*) _region_malloc(
r4, sizeof( struct Cyc_List_List)); _temp25->hd=( void*)((( struct _tuple2*)((
struct Cyc_List_List*) _check_null( x))->hd)[ _check_known_subscript_notnull( 1u,
0)]).f2; _temp25->tl= 0; _temp25;})); for( x=(( struct Cyc_List_List*)
_check_null( x))->tl; x != 0; x=(( struct Cyc_List_List*) _check_null( x))->tl){((
struct Cyc_List_List*) _check_null( prev1))->tl=({ struct Cyc_List_List* _temp26=(
struct Cyc_List_List*) _region_malloc( r3, sizeof( struct Cyc_List_List));
_temp26->hd=( void*)((( struct _tuple2*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f1; _temp26->tl= 0; _temp26;});((
struct Cyc_List_List*) _check_null( prev2))->tl=({ struct Cyc_List_List* _temp27=(
struct Cyc_List_List*) _region_malloc( r4, sizeof( struct Cyc_List_List));
_temp27->hd=( void*)((( struct _tuple2*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f2; _temp27->tl= 0; _temp27;}); prev1=((
struct Cyc_List_List*) _check_null( prev1))->tl; prev2=(( struct Cyc_List_List*)
_check_null( prev2))->tl;} return({ struct _tuple0 _temp28; _temp28.f1= result1;
_temp28.f2= result2; _temp28;});} struct _tuple0 Cyc_List_split( struct Cyc_List_List*
...
_temp29; _temp29.f1= 0; _temp29.f2= 0; _temp29.f3= 0; _temp29;});} prev1=(
result1=({ struct Cyc_List_List* _temp30=( struct Cyc_List_List*) _region_malloc(
r3, sizeof( struct Cyc_List_List)); _temp30->hd=( void*)((( struct _tuple3*)((
struct Cyc_List_List*) _check_null( x))->hd)[ _check_known_subscript_notnull( 1u,
0)]).f1; _temp30->tl= 0; _temp30;})); prev2=( result2=({ struct Cyc_List_List*
_temp31=( struct Cyc_List_List*) _region_malloc( r4, sizeof( struct Cyc_List_List));
_temp31->hd=( void*)((( struct _tuple3*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f2; _temp31->tl= 0; _temp31;})); prev3=(
result3=({ struct Cyc_List_List* _temp32=( struct Cyc_List_List*) _region_malloc(
r5, sizeof( struct Cyc_List_List)); _temp32->hd=( void*)((( struct _tuple3*)((
struct Cyc_List_List*) _check_null( x))->hd)[ _check_known_subscript_notnull( 1u,
0)]).f3; _temp32->tl= 0; _temp32;})); for( x=(( struct Cyc_List_List*)
_check_null( x))->tl; x != 0; x=(( struct Cyc_List_List*) _check_null( x))->tl){((
struct Cyc_List_List*) _check_null( prev1))->tl=({ struct Cyc_List_List* _temp33=(
struct Cyc_List_List*) _region_malloc( r3, sizeof( struct Cyc_List_List));
_temp33->hd=( void*)((( struct _tuple3*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f1; _temp33->tl= 0; _temp33;});((
struct Cyc_List_List*) _check_null( prev2))->tl=({ struct Cyc_List_List* _temp34=(
struct Cyc_List_List*) _region_malloc( r4, sizeof( struct Cyc_List_List));
_temp34->hd=( void*)((( struct _tuple3*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f2; _temp34->tl= 0; _temp34;});((
struct Cyc_List_List*) _check_null( prev3))->tl=({ struct Cyc_List_List* _temp35=(
...
_check_known_subscript_notnull( 1u, 0)]).f3; _temp35->tl= 0; _temp35;}); prev1=((
struct Cyc_List_List*) _check_null( prev1))->tl; prev2=(( struct Cyc_List_List*)
_check_null( prev2))->tl; prev3=(( struct Cyc_List_List*) _check_null( prev3))->tl;}
return({ struct _tuple1 _temp36; _temp36.f1= result1; _temp36.f2= result2;
_temp36.f3= result3; _temp36;});} struct _tuple1 Cyc_List_split3( struct Cyc_List_List*
...
== 0){ return({ struct Cyc_Core_Opt* _temp37=( struct Cyc_Core_Opt*) GC_malloc(
sizeof( struct Cyc_Core_Opt)); _temp37->v=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( x))->hd); _temp37;});}} x=(( struct Cyc_List_List*) _check_null( x))->tl;}
return 0;} struct _tagged_ptr1 Cyc_List_rto_array( struct _RegionHandle* r2,
struct Cyc_List_List* x){ int s; struct _tagged_ptr1 arr; s=(( int(*)( struct
Cyc_List_List* x)) Cyc_List_length)( x); arr=({ unsigned int _temp38=(
unsigned int) s; void** _temp39=( void**) _region_malloc( r2, sizeof( void*) *
_temp38); struct _tagged_ptr1 _temp41={ _temp39, _temp39, _temp39 + _temp38};{
unsigned int _temp40= _temp38; unsigned int i; for( i= 0; i < _temp40; i ++){
_temp39[ i]=( void*)(( struct Cyc_List_List*) _check_null( x))->hd;}}; _temp41;});{
int i= 0; for( 0; i < s;( ++ i, x=(( struct Cyc_List_List*) _check_null( x))->tl)){*((
void**(*)( struct _tagged_ptr1, unsigned int, unsigned int))
_check_unknown_subscript)( arr, sizeof( void*), i)=( void*)(( struct Cyc_List_List*)
_check_null( x))->hd;}} return arr;} struct _tagged_ptr1 Cyc_List_to_array(
struct Cyc_List_List* x){ return(( struct _tagged_ptr1(*)( struct _RegionHandle*
...
_tagged_ptr1 arr){ struct Cyc_List_List* ans= 0;{ int i=( int)(({ struct
_tagged_ptr1 _temp43= arr;( unsigned int)( _temp43.last_plus_one - _temp43.curr);})
- 1); for( 0; i >= 0; -- i){ ans=({ struct Cyc_List_List* _temp42=( struct Cyc_List_List*)
_region_malloc( r2, sizeof( struct Cyc_List_List)); _temp42->hd=( void*)*(( void**(*)(
struct _tagged_ptr1, unsigned int, unsigned int)) _check_unknown_subscript)( arr,
sizeof( void*), i); _temp42->tl= ans; _temp42;});}} return ans;} struct Cyc_List_List*
Cyc_List_from_array( struct _tagged_ptr1 arr){ return(( struct Cyc_List_List*(*)(
struct _RegionHandle* r2, struct _tagged_ptr1 arr)) Cyc_List_rfrom_array)( Cyc_Core_heap_region,
...
res=({ struct Cyc_List_List* _temp44=( struct Cyc_List_List*) _region_malloc( r,
sizeof( struct Cyc_List_List)); _temp44->hd=( void*) f( i); _temp44->tl= res;
_temp44;});}} return(( struct Cyc_List_List*(*)( struct Cyc_List_List* x)) Cyc_List_imp_rev)(
...
res= 0;{ int i= 0; for( 0; i < n; ++ i){ res=({ struct Cyc_List_List* _temp45=(
struct Cyc_List_List*) _region_malloc( r, sizeof( struct Cyc_List_List));
_temp45->hd=( void*) f( env, i); _temp45->tl= res; _temp45;});}} return(( struct
...
l1 == l2){ return 0;}{ int _temp46= cmp(( void*)(( struct Cyc_List_List*)
_check_null( l1))->hd,( void*)(( struct Cyc_List_List*) _check_null( l2))->hd);
goto _LL47; _LL47: if( _temp46 != 0){ return _temp46;}}} if( l1 != 0){ return 1;}
if( l2 != 0){ return - 1;} return 0;} int Cyc_List_list_prefix( int(* cmp)( void*,
...
_check_null( l2))->tl)){ if( l1 == l2){ return 1;}{ int _temp48= cmp(( void*)((
struct Cyc_List_List*) _check_null( l1))->hd,( void*)(( struct Cyc_List_List*)
_check_null( l2))->hd); goto _LL49; _LL49: if( _temp48 != 0){ return 0;}}}
return l1 == 0;} struct Cyc_List_List* Cyc_List_rfilter_c( struct _RegionHandle*
r2, int(* f)( void*, void*), void* env, struct Cyc_List_List* l){ if( l == 0){
return 0;}{ struct Cyc_List_List* result=({ struct Cyc_List_List* _temp51=(
struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp51->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( l))->hd);
_temp51->tl= 0; _temp51;}); struct Cyc_List_List* end= result; for( 0; l != 0; l=((
...
struct Cyc_List_List* _temp50=( struct Cyc_List_List*) _region_malloc( r2,
sizeof( struct Cyc_List_List)); _temp50->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( l))->hd); _temp50->tl= 0; _temp50;}); end=(( struct Cyc_List_List*)
...
_temp53=( struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp53->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( l))->hd);
_temp53->tl= 0; _temp53;}); struct Cyc_List_List* end= result; for( 0; l != 0; l=((
struct Cyc_List_List*) _check_null( l))->tl){ if( f(( void*)(( struct Cyc_List_List*)
_check_null( l))->hd)){(( struct Cyc_List_List*) _check_null( end))->tl=({
struct Cyc_List_List* _temp52=( struct Cyc_List_List*) _region_malloc( r2,
sizeof( struct Cyc_List_List)); _temp52->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( l))->hd); _temp52->tl= 0; _temp52;}); end=(( struct Cyc_List_List*)
_check_null( end))->tl;}} return(( struct Cyc_List_List*) _check_null( result))->tl;}}
