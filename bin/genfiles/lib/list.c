...
Null_Exception);} _temp0->tl;});} return i;} char Cyc_List_List_empty[ 15u];
...
18u]; struct Cyc_List_List* Cyc_List_rmap2( struct _RegionHandle* r3, void*(* f)(
...
Cyc_List_List* _temp26=( struct Cyc_List_List*) _region_malloc( r3, sizeof(
struct Cyc_List_List)); _temp26->hd=( void*) f(( void*)({ struct Cyc_List_List*
_temp27= x; if( _temp27 == 0){ _throw( Null_Exception);} _temp27->hd;}),( void*)({
struct Cyc_List_List* _temp28= y; if( _temp28 == 0){ _throw( Null_Exception);}
_temp28->hd;})); _temp26->tl= 0; _temp26;}); prev= result; x=({ struct Cyc_List_List*
_temp29= x; if( _temp29 == 0){ _throw( Null_Exception);} _temp29->tl;}); y=({
struct Cyc_List_List* _temp30= y; if( _temp30 == 0){ _throw( Null_Exception);}
_temp30->tl;}); while( x != 0? y != 0: 0) {({ struct Cyc_List_List* _temp31=
prev; if( _temp31 == 0){ _throw( Null_Exception);} _temp31->tl=({ struct Cyc_List_List*
_temp32=( struct Cyc_List_List*) _region_malloc( r3, sizeof( struct Cyc_List_List));
_temp32->hd=( void*) f(( void*)({ struct Cyc_List_List* _temp33= x; if( _temp33
== 0){ _throw( Null_Exception);} _temp33->hd;}),( void*)({ struct Cyc_List_List*
_temp34= y; if( _temp34 == 0){ _throw( Null_Exception);} _temp34->hd;}));
_temp32->tl= 0; _temp32;});}); prev=({ struct Cyc_List_List* _temp35= prev; if(
_temp35 == 0){ _throw( Null_Exception);} _temp35->tl;}); x=({ struct Cyc_List_List*
_temp36= x; if( _temp36 == 0){ _throw( Null_Exception);} _temp36->tl;}); y=({
struct Cyc_List_List* _temp37= y; if( _temp37 == 0){ _throw( Null_Exception);}
_temp37->tl;});} if( x != 0? 1: y != 0){( void) _throw(( void*) Cyc_List_List_mismatch);}
...
void*)({ struct Cyc_List_List* _temp38= x; if( _temp38 == 0){ _throw(
Null_Exception);} _temp38->hd;})); x=({ struct Cyc_List_List* _temp39= x; if(
_temp39 == 0){ _throw( Null_Exception);} _temp39->tl;});}} void Cyc_List_app_c(
void*(* f)( void*, void*), void* env, struct Cyc_List_List* x){ while( x != 0) {
f( env,( void*)({ struct Cyc_List_List* _temp40= x; if( _temp40 == 0){ _throw(
...
Cyc_Core_heap_region, less_eq, a, b);} char Cyc_List_Nth[ 8u]; void* Cyc_List_nth(
struct Cyc_List_List* x, int i){ while( i > 0? x != 0: 0) { -- i; x=({ struct
Cyc_List_List* _temp132= x; if( _temp132 == 0){ _throw( Null_Exception);}
_temp132->tl;});} if( i < 0? 1: x == 0){( void) _throw(( void*) Cyc_List_Nth);}
return( void*)({ struct Cyc_List_List* _temp133= x; if( _temp133 == 0){ _throw(
Null_Exception);} _temp133->hd;});} int Cyc_List_forall( int(* pred)( void*),
...
Null_Exception);} _temp135->tl;});} return x == 0;} int Cyc_List_forall_c( int(*
pred)( void*, void*), void* env, struct Cyc_List_List* x){ while( x != 0? pred(
env,( void*)({ struct Cyc_List_List* _temp136= x; if( _temp136 == 0){ _throw(
Null_Exception);} _temp136->hd;})): 0) { x=({ struct Cyc_List_List* _temp137= x;
if( _temp137 == 0){ _throw( Null_Exception);} _temp137->tl;});} return x == 0;}
int Cyc_List_exists( int(* pred)( void*), struct Cyc_List_List* x){ while( x !=
0? ! pred(( void*)({ struct Cyc_List_List* _temp138= x; if( _temp138 == 0){
_throw( Null_Exception);} _temp138->hd;})): 0) { x=({ struct Cyc_List_List*
