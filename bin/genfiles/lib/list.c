...
15u]; void* Cyc_List_hd( struct Cyc_List_List* x){ if( x == 0){( void) _throw((
void*) Cyc_List_List_empty);} return( void*)(( struct Cyc_List_List*)
_check_null( x))->hd;} struct Cyc_List_List* Cyc_List_tl( struct Cyc_List_List*
x){ if( x == 0){( void) _throw(( void*) Cyc_List_List_empty);} return(( struct
Cyc_List_List*) _check_null( x))->tl;} struct Cyc_List_List* Cyc_List_rcopy(
...
char Cyc_List_List_mismatch[ 18u]; struct Cyc_List_List* Cyc_List_rmap2( struct
_RegionHandle* r3, void*(* f)( void*, void*), struct Cyc_List_List* x, struct
Cyc_List_List* y){ struct Cyc_List_List* result; struct Cyc_List_List* prev; if(
x == 0? y == 0: 0){ return 0;} if( x == 0? 1: y == 0){( void) _throw(( void*)
Cyc_List_List_mismatch);} result=({ struct Cyc_List_List* _temp6=( struct Cyc_List_List*)
_region_malloc( r3, sizeof( struct Cyc_List_List)); _temp6->hd=( void*) f(( void*)((
struct Cyc_List_List*) _check_null( x))->hd,( void*)(( struct Cyc_List_List*)
_check_null( y))->hd); _temp6->tl= 0; _temp6;}); prev= result; x=(( struct Cyc_List_List*)
_check_null( x))->tl; y=(( struct Cyc_List_List*) _check_null( y))->tl; while( x
!= 0? y != 0: 0) {(( struct Cyc_List_List*) _check_null( prev))->tl=({ struct
Cyc_List_List* _temp7=( struct Cyc_List_List*) _region_malloc( r3, sizeof(
struct Cyc_List_List)); _temp7->hd=( void*) f(( void*)(( struct Cyc_List_List*)
...
char Cyc_List_Nth[ 8u]; void* Cyc_List_nth( struct Cyc_List_List* x, int i){
while( i > 0? x != 0: 0) { -- i; x=(( struct Cyc_List_List*) _check_null( x))->tl;}
if( i < 0? 1: x == 0){( void) _throw(( void*) Cyc_List_Nth);} return( void*)((
struct Cyc_List_List*) _check_null( x))->hd;} int Cyc_List_forall( int(* pred)(
void*), struct Cyc_List_List* x){ while( x != 0? pred(( void*)(( struct Cyc_List_List*)
...
0) { x=(( struct Cyc_List_List*) _check_null( x))->tl;} return x != 0;} int Cyc_List_exists_c(
int(* pred)( void*, void*), void* env, struct Cyc_List_List* x){ while( x != 0?
! pred( env,( void*)(( struct Cyc_List_List*) _check_null( x))->hd): 0) { x=((
struct Cyc_List_List*) _check_null( x))->tl;} return x != 0;} struct _tuple2{
void* f1; void* f2; } ; struct Cyc_List_List* Cyc_List_rzip( struct
_RegionHandle* r3, struct _RegionHandle* r4, struct Cyc_List_List* x, struct Cyc_List_List*
y){ struct Cyc_List_List* result; struct Cyc_List_List* prev; if( x == 0? y == 0:
0){ return 0;} if( x == 0? 1: y == 0){( void) _throw(( void*) Cyc_List_List_mismatch);}
result=({ struct Cyc_List_List* _temp15=( struct Cyc_List_List*) _region_malloc(
r3, sizeof( struct Cyc_List_List)); _temp15->hd=( void*)({ struct _tuple2*
_temp16=( struct _tuple2*) _region_malloc( r4, sizeof( struct _tuple2)); _temp16->f1=(
void*)(( struct Cyc_List_List*) _check_null( x))->hd; _temp16->f2=( void*)((
struct Cyc_List_List*) _check_null( y))->hd; _temp16;}); _temp15->tl= 0; _temp15;});
...
_check_null( prev))->tl=({ struct Cyc_List_List* _temp17=( struct Cyc_List_List*)
_region_malloc( r3, sizeof( struct Cyc_List_List)); _temp17->hd=( void*)({
struct _tuple2* _temp18=( struct _tuple2*) _region_malloc( r4, sizeof( struct
_tuple2)); _temp18->f1=( void*)(( struct Cyc_List_List*) _check_null( x))->hd;
_temp18->f2=( void*)(( struct Cyc_List_List*) _check_null( y))->hd; _temp18;});
_temp17->tl= 0; _temp17;}); prev=(( struct Cyc_List_List*) _check_null( prev))->tl;
x=(( struct Cyc_List_List*) _check_null( x))->tl; y=(( struct Cyc_List_List*)
_check_null( y))->tl;} if( x != 0? 1: y != 0){( void) _throw(( void*) Cyc_List_List_mismatch);}
...
return({ struct _tuple0 _temp19; _temp19.f1= 0; _temp19.f2= 0; _temp19;});}
prev1=( result1=({ struct Cyc_List_List* _temp20=( struct Cyc_List_List*)
_region_malloc( r3, sizeof( struct Cyc_List_List)); _temp20->hd=( void*)(((
struct _tuple2*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f1; _temp20->tl= 0; _temp20;})); prev2=(
result2=({ struct Cyc_List_List* _temp21=( struct Cyc_List_List*) _region_malloc(
r4, sizeof( struct Cyc_List_List)); _temp21->hd=( void*)((( struct _tuple2*)((
struct Cyc_List_List*) _check_null( x))->hd)[ _check_known_subscript_notnull( 1u,
0)]).f2; _temp21->tl= 0; _temp21;})); for( x=(( struct Cyc_List_List*)
_check_null( x))->tl; x != 0; x=(( struct Cyc_List_List*) _check_null( x))->tl){((
struct Cyc_List_List*) _check_null( prev1))->tl=({ struct Cyc_List_List* _temp22=(
struct Cyc_List_List*) _region_malloc( r3, sizeof( struct Cyc_List_List));
_temp22->hd=( void*)((( struct _tuple2*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f1; _temp22->tl= 0; _temp22;});((
struct Cyc_List_List*) _check_null( prev2))->tl=({ struct Cyc_List_List* _temp23=(
struct Cyc_List_List*) _region_malloc( r4, sizeof( struct Cyc_List_List));
_temp23->hd=( void*)((( struct _tuple2*)(( struct Cyc_List_List*) _check_null( x))->hd)[
_check_known_subscript_notnull( 1u, 0)]).f2; _temp23->tl= 0; _temp23;}); prev1=((
struct Cyc_List_List*) _check_null( prev1))->tl; prev2=(( struct Cyc_List_List*)
_check_null( prev2))->tl;} return({ struct _tuple0 _temp24; _temp24.f1= result1;
_temp24.f2= result2; _temp24;});} struct _tuple0 Cyc_List_split( struct Cyc_List_List*
...
_temp34); struct _tagged_ptr0 _temp38={ _temp35, _temp35, _temp35 + _temp34};{
unsigned int _temp36= _temp34; unsigned int i; for( i= 0; i < _temp36; i ++){
_temp35[ i]=( void*)(( struct Cyc_List_List*) _check_null( x))->hd;}}; _temp38;});{
...
_tagged_ptr0 _temp40= arr;( unsigned int)( _temp40.last_plus_one - _temp40.curr);})
- 1; for( 0; i >= 0; -- i){ ans=({ struct Cyc_List_List* _temp39=( struct Cyc_List_List*)
_region_malloc( r2, sizeof( struct Cyc_List_List)); _temp39->hd=( void*)*(( void**(*)(
struct _tagged_ptr0, unsigned int, unsigned int)) _check_unknown_subscript)( arr,
sizeof( void*),( int) i); _temp39->tl= ans; _temp39;});}} return ans;} struct
...
0; for( 0; i < n; ++ i){ res=({ struct Cyc_List_List* _temp41=( struct Cyc_List_List*)
_region_malloc( r, sizeof( struct Cyc_List_List)); _temp41->hd=( void*) f( i);
_temp41->tl= res; _temp41;});}} return(( struct Cyc_List_List*(*)( struct Cyc_List_List*
...
i); _temp42->tl= res; _temp42;});}} return(( struct Cyc_List_List*(*)( struct
...
_check_null( l2))->hd); goto _LL44; _LL44: if( _temp43 != 0){ return _temp43;}}}
...
int _temp45= cmp(( void*)(( struct Cyc_List_List*) _check_null( l1))->hd,( void*)((
struct Cyc_List_List*) _check_null( l2))->hd); goto _LL46; _LL46: if( _temp45 !=
...
Cyc_List_rfilter( struct _RegionHandle* r2, int(* f)( void*), struct Cyc_List_List*
l){ if( l == 0){ return 0;}{ struct Cyc_List_List* result=({ struct Cyc_List_List*
_temp50=( struct Cyc_List_List*) _region_malloc( r2, sizeof( struct Cyc_List_List));
_temp50->hd=( void*)(( void*)(( struct Cyc_List_List*) _check_null( l))->hd);
_temp50->tl= 0; _temp50;}); struct Cyc_List_List* end= result; for( 0; l != 0; l=((
struct Cyc_List_List*) _check_null( l))->tl){ if( f(( void*)(( struct Cyc_List_List*)
_check_null( l))->hd)){(( struct Cyc_List_List*) _check_null( end))->tl=({
struct Cyc_List_List* _temp49=( struct Cyc_List_List*) _region_malloc( r2,
sizeof( struct Cyc_List_List)); _temp49->hd=( void*)(( void*)(( struct Cyc_List_List*)
_check_null( l))->hd); _temp49->tl= 0; _temp49;}); end=(( struct Cyc_List_List*)
_check_null( end))->tl;}} return(( struct Cyc_List_List*) _check_null( result))->tl;}}
