...
_temp4=( struct Cyc_Stdio_FileCloseError_struct*) GC_malloc( sizeof( struct Cyc_Stdio_FileCloseError_struct));
_temp4[ 0]=({ struct Cyc_Stdio_FileCloseError_struct _temp5; _temp5.tag= Cyc_Stdio_FileCloseError_tag;
_temp5;}); _temp4;}));}}