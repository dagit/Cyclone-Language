...
__stream); extern int Cyc_Stdio_putc( int __c, struct Cyc_Stdio___sFILE*
__stream); extern struct Cyc_Stdio___sFILE* Cyc_Stdio_fdopen( int __fd, struct
_tagged_arr __modes); extern unsigned char Cyc_Stdio_FileCloseError[ 19u];
