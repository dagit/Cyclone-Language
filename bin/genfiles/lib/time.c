...
extern double difftime( int _time2, int _time1); extern int mktime( struct Cyc_Time_tm*
...
struct Cyc_Time_tm* localtime_r( const int*, struct Cyc_Time_tm*); extern struct
...
_tagged_string Cyc_Time_timezone(); extern unsigned char* asctime( const struct
Cyc_Time_tm* _tblock); extern unsigned char* ctime( const int* _time); extern
unsigned int strftime( unsigned char* _s, unsigned int _maxsize, unsigned char*
_fmt, const struct Cyc_Time_tm* _t); extern unsigned char* asctime_r( const
struct Cyc_Time_tm*, unsigned char*); extern unsigned char* ctime_r( const int*,
unsigned char*); extern unsigned char* timezone(); struct _tagged_string Cyc_Time_asctime(
