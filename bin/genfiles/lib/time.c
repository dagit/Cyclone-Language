...
int tm_year; int tm_wday; int tm_yday; int tm_isdst; } ; extern unsigned int
clock()  __attribute__(( cdecl )) ; extern double difftime( int _time2, int
_time1)  __attribute__(( cdecl )) ; extern int mktime( struct Cyc_Time_tm*
_timeptr)  __attribute__(( cdecl )) ; extern int time( int* _timer)
 __attribute__(( cdecl )) ; extern struct Cyc_Time_tm* gmtime( const int* _timer)
 __attribute__(( cdecl )) ; extern struct Cyc_Time_tm* localtime( const int*
_timer)  __attribute__(( cdecl )) ; extern struct Cyc_Time_tm* gmtime_r( const
int*, struct Cyc_Time_tm*)  __attribute__(( cdecl )) ; extern struct Cyc_Time_tm*
...
dllimport )) ; extern void tzset()  __attribute__(( cdecl )) ; extern struct
_tagged_string Cyc_Time_asctime( const struct Cyc_Time_tm* _tblock); extern
struct _tagged_string Cyc_Time_ctime( const int* _time); extern unsigned int Cyc_Time_strftime(
struct _tagged_string _s, unsigned int _maxsize, struct _tagged_string _fmt,
const struct Cyc_Time_tm* _t); extern struct _tagged_string Cyc_Time_asctime_r(
const struct Cyc_Time_tm*, struct _tagged_string); extern struct _tagged_string
Cyc_Time_ctime_r( const int*, struct _tagged_string); extern struct
_tagged_string Cyc_Time_timezone(); extern char* asctime( const struct Cyc_Time_tm*
_tblock); extern char* ctime( const int* _time); extern unsigned int strftime(
char* _s, unsigned int _maxsize, char* _fmt, const struct Cyc_Time_tm* _t);
extern char* asctime_r( const struct Cyc_Time_tm*, char*); extern char* ctime_r(
const int*, char*); extern char* timezone(); struct _tagged_string Cyc_Time_asctime(
const struct Cyc_Time_tm* _tblock){ return Cstring_to_string( asctime( _tblock));}
struct _tagged_string Cyc_Time_ctime( const int* _time){ return
Cstring_to_string( ctime( _time));} unsigned int Cyc_Time_strftime( struct
_tagged_string _s, unsigned int _maxsize, struct _tagged_string _fmt, const
struct Cyc_Time_tm* _t){ unsigned int m=({ struct _tagged_string _temp0= _s;(
unsigned int)( _temp0.last_plus_one - _temp0.curr);}) < _maxsize?({ struct
_tagged_string _temp1= _s;( unsigned int)( _temp1.last_plus_one - _temp1.curr);}):
...
_temp4; _temp4.tag= Cyc_Core_InvalidArg; _temp4.f1=({ char* _temp5="Time::asctime_r: string too small (< 50)";
...
_temp9; _temp9.tag= Cyc_Core_InvalidArg; _temp9.f1=({ char* _temp10="Time::ctime_r: string too small (< 50)";
