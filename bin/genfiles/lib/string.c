...
s1, 0,( struct _tagged_string)({ char* _temp7=( char*)"String::strcmp"; struct
...
struct _tagged_string)({ char* _temp5=( char*)"String::strcmp"; struct
...
_temp11=( char*)"String::strncmp"; struct _tagged_string _temp12; _temp12.curr=
...
_temp9=( char*)"String::strncmp"; struct _tagged_string _temp10; _temp10.curr=
...
unsigned int n){ unsigned int len1= Cyc_String_int_strleno( s1, 0,( struct
_tagged_string)({ char* _temp15=( char*)"String::strncasecmp"; struct
...
struct _tagged_string)({ char* _temp13=( char*)"String::strncasecmp"; struct
...
++ i < min_length) { int diff=( int)*(( char*(*)( struct _tagged_string,
unsigned int, unsigned int)) _check_unknown_subscript)( a, sizeof( char), i) -(
int)*(( char*(*)( struct _tagged_string, unsigned int, unsigned int))
_check_unknown_subscript)( b, sizeof( char), i); if( diff != 0){ return diff;}}
return( int) as -( int) bs;}} int Cyc_String_zstrncmp( struct _tagged_string s1,
struct _tagged_string s2, unsigned int n){ if( n <= 0){ return 0;}{ unsigned int
s1size=({ struct _tagged_string _temp20= s1;( unsigned int)( _temp20.last_plus_one
...
int i= 0; for( 0; i < bound; i ++){ if(*(( char*(*)( struct _tagged_string,
unsigned int, unsigned int)) _check_unknown_subscript)( s1, sizeof( char), i) <*((
char*(*)( struct _tagged_string, unsigned int, unsigned int))
_check_unknown_subscript)( s2, sizeof( char), i)){ return - 1;} else{ if(*((
char*(*)( struct _tagged_string, unsigned int, unsigned int))
_check_unknown_subscript)( s2, sizeof( char), i) <*(( char*(*)( struct
_tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s1,
sizeof( char), i)){ return 1;}}}} if( min_size <= bound){ return 0;} if( s1size
...
if( slen + dlen <= dsize){ for( i= 0; i < slen; i ++){*(( char*(*)( struct
_tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( dest,
sizeof( char),( int)( i + dlen))=*(( char*(*)( struct _tagged_string,
unsigned int, unsigned int)) _check_unknown_subscript)( src, sizeof( char), i +
srcOfs);} if( i != dsize){*(( char*(*)( struct _tagged_string, unsigned int,
unsigned int)) _check_unknown_subscript)( dest, sizeof( char),( int)( i + dlen))='\000';}}
...
_temp24=( char*)"String::strcat"; struct _tagged_string _temp25; _temp25.curr=
...
i; int j; for( i= 0; i < _temp26; ++ i){*(( char*(*)( struct _tagged_string,
unsigned int, unsigned int)) _check_unknown_subscript)( ans, sizeof( char), i)=*((
char*(*)( struct _tagged_string, unsigned int, unsigned int))
_check_unknown_subscript)( a, sizeof( char), i);} for( j= 0; j < _temp28; ++ j){*((
char*(*)( struct _tagged_string, unsigned int, unsigned int))
...
return( struct _tagged_string)({ char* _temp32=( char*)""; struct _tagged_string
_temp33; _temp33.curr= _temp32; _temp33.base= _temp32; _temp33.last_plus_one=
_temp32 + 1; _temp33;});} if((( struct Cyc_List_List*) _check_null( strs))->tl
== 0){ return Cyc_String_strdup(*(( struct _tagged_string*)(( struct Cyc_List_List*)
_check_null( strs))->hd));}{ struct Cyc_List_List* p= strs; struct Cyc_List_List*
lens=({ struct Cyc_List_List* _temp35=( struct Cyc_List_List*) GC_malloc(
sizeof( struct Cyc_List_List)); _temp35->hd=( void*)(( unsigned int) 0); _temp35->tl=
0; _temp35;}); struct Cyc_List_List* end= lens; unsigned int len=( unsigned int)
0; unsigned int total_len=( unsigned int) 0; unsigned int list_len=(
unsigned int) 0; for( 0; p != 0; p=(( struct Cyc_List_List*) _check_null( p))->tl){
len= Cyc_String_strlen(*(( struct _tagged_string*)(( struct Cyc_List_List*)
_check_null( p))->hd)); total_len += len;(( struct Cyc_List_List*) _check_null(
end))->tl=({ struct Cyc_List_List* _temp34=( struct Cyc_List_List*) GC_malloc(
sizeof( struct Cyc_List_List)); _temp34->hd=( void*) len; _temp34->tl= 0;
_temp34;}); end=(( struct Cyc_List_List*) _check_null( end))->tl; ++ list_len;}
lens=(( struct Cyc_List_List*) _check_null( lens))->tl;{ unsigned int seplen=
Cyc_String_strlen( separator); total_len +=( list_len - 1) * seplen;{ struct
_tagged_string ans= Cyc_Core_new_string(( int) total_len); unsigned int i=(
unsigned int) 0; while((( struct Cyc_List_List*) _check_null( strs))->tl != 0) {
struct _tagged_string next=*(( struct _tagged_string*)(( struct Cyc_List_List*)
_check_null( strs))->hd); len=( unsigned int)(( struct Cyc_List_List*)
_check_null( lens))->hd; Cyc_String_strncpy( ans,( int) i, next, 0, len); i +=
...
_temp43.f1=( struct _tagged_string)({ char* _temp44=( char*)"String::strncpy";
struct _tagged_string _temp45; _temp45.curr= _temp44; _temp45.base= _temp44;
_temp45.last_plus_one= _temp44 + 16; _temp45;}); _temp43;}); _temp42;}));} if(
srcOfs < 0? 1:( n > 0? srcOfs >= _temp40: 0)){( void) _throw(( void*)({ struct
Cyc_Core_InvalidArg_struct* _temp46=( struct Cyc_Core_InvalidArg_struct*)
...
struct _tagged_string)({ char* _temp48=( char*)"String::strncpy"; struct
...
struct _tagged_string)({ char* _temp52=( char*)"String::strncpy"; struct
_tagged_string _temp53; _temp53.curr= _temp52; _temp53.base= _temp52; _temp53.last_plus_one=
_temp52 + 16; _temp53;}); _temp51;}); _temp50;}));}{ int i; for( i= 0; i < n; i
++){ char _temp54=*(( char*(*)( struct _tagged_string, unsigned int,
unsigned int)) _check_unknown_subscript)( src, sizeof( char), srcOfs + i); goto
_LL55; _LL55: if( _temp54 =='\000'){ break;}*(( char*(*)( struct _tagged_string,
unsigned int, unsigned int)) _check_unknown_subscript)( dest, sizeof( char),
destOfs + i)= _temp54;} for( 0; i < n; i ++){*(( char*(*)( struct _tagged_string,
unsigned int, unsigned int)) _check_unknown_subscript)( dest, sizeof( char),
destOfs + i)='\000';} return dest;}}} struct _tagged_string Cyc_String_zstrncpy(
struct _tagged_string dest, int destOfs, struct _tagged_string src, int srcOfs,
unsigned int n){ unsigned int _temp57=({ struct _tagged_string _temp56= dest;(
unsigned int)( _temp56.last_plus_one - _temp56.curr);}); goto _LL58; _LL58: {
unsigned int _temp60=({ struct _tagged_string _temp59= src;( unsigned int)(
_temp59.last_plus_one - _temp59.curr);}); goto _LL61; _LL61: if( destOfs < 0){(
void) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct* _temp62=( struct Cyc_Core_InvalidArg_struct*)
...
struct _tagged_string)({ char* _temp64=( char*)"String::zstrncpy"; struct
_tagged_string _temp65; _temp65.curr= _temp64; _temp65.base= _temp64; _temp65.last_plus_one=
_temp64 + 17; _temp65;}); _temp63;}); _temp62;}));} if( srcOfs < 0? 1:( n > 0?
srcOfs >= _temp60: 0)){( void) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct*
...
_temp67.f1=( struct _tagged_string)({ char* _temp68=( char*)"String::zstrncpy";
struct _tagged_string _temp69; _temp69.curr= _temp68; _temp69.base= _temp68;
_temp69.last_plus_one= _temp68 + 17; _temp69;}); _temp67;}); _temp66;}));} if( n
<= 0){ return dest;} if( destOfs + n > _temp57? 1: srcOfs + n > _temp60){( void)
_throw(( void*)({ struct Cyc_Core_InvalidArg_struct* _temp70=( struct Cyc_Core_InvalidArg_struct*)
...
struct _tagged_string)({ char* _temp72=( char*)"String::zstrncpy"; struct
_tagged_string _temp73; _temp73.curr= _temp72; _temp73.base= _temp72; _temp73.last_plus_one=
_temp72 + 17; _temp73;}); _temp71;}); _temp70;}));}{ int i; for( i= 0; i < n; i
++){*(( char*(*)( struct _tagged_string, unsigned int, unsigned int))
...
struct _tagged_string)({ char* _temp80=( char*)"String::substring"; struct
...
Cyc_Core_new_string(( int)( amt + 1));{ unsigned int i=( unsigned int) 0; for( 0;
i < amt; ++ i){*(( char*(*)( struct _tagged_string, unsigned int, unsigned int))
_check_unknown_subscript)( ans, sizeof( char),( int) i)=*(( char*(*)( struct
_tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s,
sizeof( char),( int)( start + i));}}*(( char*(*)( struct _tagged_string,
unsigned int, unsigned int)) _check_unknown_subscript)( ans, sizeof( char),( int)
amt)='\000'; return ans;}} struct _tagged_string Cyc_String_replace_suffix(
struct _tagged_string src, struct _tagged_string curr_suffix, struct
_tagged_string new_suffix){ unsigned int m=({ struct _tagged_string _temp91= src;(
unsigned int)( _temp91.last_plus_one - _temp91.curr);}); unsigned int n=({
struct _tagged_string _temp90= curr_suffix;( unsigned int)( _temp90.last_plus_one
- _temp90.curr);}); struct _tagged_string err=( struct _tagged_string)({ char*
_temp88=( char*)"String::replace_suffix"; struct _tagged_string _temp89; _temp89.curr=
_temp88; _temp89.base= _temp88; _temp89.last_plus_one= _temp88 + 23; _temp89;});
if( m < n){( void) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct* _temp82=(
struct Cyc_Core_InvalidArg_struct*) GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct));
...
s, 0,( struct _tagged_string)({ char* _temp98=( char*)"String::strpbrk"; struct
_tagged_string _temp99; _temp99.curr= _temp98; _temp99.base= _temp98; _temp99.last_plus_one=
_temp98 + 16; _temp99;})); char c='\000'; for( 0; len > 0?( c=({ struct
_tagged_string _temp92= s; char* _temp93= _temp92.curr; if( _temp92.base == 0? 1:(
_temp93 < _temp92.base? 1: _temp93 >= _temp92.last_plus_one)){ _throw(
...
_temp96.last_plus_one - _temp96.curr);}); j ++){ if( c ==*(( char*(*)( struct
_tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( accept,
sizeof( char), j)){ return s;}}} return({ struct _tagged_string _temp97={ 0, 0,
0}; _temp97;});} struct _tagged_string Cyc_String_strchr( struct _tagged_string
s, char c){ int len=( int) Cyc_String_int_strleno( s, 0,( struct _tagged_string)({
char* _temp105=( char*)"String::strchr"; struct _tagged_string _temp106;
_temp106.curr= _temp105; _temp106.base= _temp105; _temp106.last_plus_one=
_temp105 + 15; _temp106;})); char c2='\000'; for( 0; len > 0?( c2=({ struct
_tagged_string _temp100= s; char* _temp101= _temp100.curr; if( _temp100.base ==
0? 1:( _temp101 < _temp100.base? 1: _temp101 >= _temp100.last_plus_one)){ _throw(
Null_Exception);}* _temp101;})) != 0: 0;( len --,({ struct _tagged_string*
_temp102=& s; struct _tagged_string _temp103=* _temp102; _temp102->curr ++;
_temp103;}))){ if( c2 == c){ return s;}} return({ struct _tagged_string _temp104={
0, 0, 0}; _temp104;});} struct _tagged_string Cyc_String_strrchr( struct
_tagged_string s, char c){ int len=( int) Cyc_String_int_strleno( s, 0,( struct
_tagged_string)({ char* _temp112=( char*)"String::strrchr"; struct
...
s, 0,( struct _tagged_string)({ char* _temp116=( char*)"String::strspn"; struct
_tagged_string _temp117; _temp117.curr= _temp116; _temp117.base= _temp116;
_temp117.last_plus_one= _temp116 + 15; _temp117;}));{ unsigned int i=(
unsigned int) 0; for( 0; i < len; i ++){ int j; for( j= 0; j <({ struct
_tagged_string _temp114= accept;( unsigned int)( _temp114.last_plus_one -
_temp114.curr);}); j ++){ if(*(( char*(*)( struct _tagged_string, unsigned int,
unsigned int)) _check_unknown_subscript)( s, sizeof( char),( int) i) ==*(( char*(*)(
struct _tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)(
accept, sizeof( char), j)){ break;}} if( j ==({ struct _tagged_string _temp115=
accept;( unsigned int)( _temp115.last_plus_one - _temp115.curr);})){ return i;}}}
return len;} struct Cyc_List_List* Cyc_String_explode( struct _tagged_string s){
struct Cyc_List_List* result= 0;{ int i=( int)( Cyc_String_strlen( s) - 1); for(
0; i >= 0; i --){ result=({ struct Cyc_List_List* _temp118=( struct Cyc_List_List*)
GC_malloc( sizeof( struct Cyc_List_List)); _temp118->hd=( void*)(( int)*(( char*(*)(
struct _tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s,
sizeof( char), i)); _temp118->tl= result; _temp118;});}} return result;} struct
...
chars)); unsigned int i=( unsigned int) 0; while( chars != 0) {*(( char*(*)(
struct _tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s,
sizeof( char),( int) i ++)=( char)(( int)(( struct Cyc_List_List*) _check_null(
chars))->hd); chars=(( struct Cyc_List_List*) _check_null( chars))->tl;} return
s;} int Cyc_String_to_int( struct _tagged_string s, int* offset){ int ans= 0;
int sn= 1; int digit_seen= 0; int i= offset == 0? 0:*(( int*) _check_null(
offset)); while( i <({ struct _tagged_string _temp119= s;( unsigned int)(
_temp119.last_plus_one - _temp119.curr);})? Cyc_Character_isspace(*(( char*(*)(
struct _tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s,
sizeof( char), i)): 0) { i ++;} if( i <({ struct _tagged_string _temp120= s;(
unsigned int)( _temp120.last_plus_one - _temp120.curr);})?*(( char*(*)( struct
_tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s,
sizeof( char), i) =='-': 0){ i ++; sn= - 1;} while( i <({ struct _tagged_string
_temp121= s;( unsigned int)( _temp121.last_plus_one - _temp121.curr);})? Cyc_Character_isspace(*((
char*(*)( struct _tagged_string, unsigned int, unsigned int))
_check_unknown_subscript)( s, sizeof( char), i)): 0) { i ++;} while( i <({
struct _tagged_string _temp122= s;( unsigned int)( _temp122.last_plus_one -
_temp122.curr);})? Cyc_Character_isdigit(*(( char*(*)( struct _tagged_string,
...
_temp124.f1=( struct _tagged_string)({ char* _temp125=( char*)"String::to_int";
struct _tagged_string _temp126; _temp126.curr= _temp125; _temp126.base= _temp125;
_temp126.last_plus_one= _temp125 + 15; _temp126;}); _temp124;}); _temp123;}));}
...
struct _tagged_string)({ char* _temp134=( char*)"String::to_double"; struct
_tagged_string _temp135; _temp135.curr= _temp134; _temp135.base= _temp134;
_temp135.last_plus_one= _temp134 + 18; _temp135;}); _temp133;}); _temp132;}));}
if( i <({ struct _tagged_string _temp136= s;( unsigned int)( _temp136.last_plus_one
- _temp136.curr);})?*(( char*(*)( struct _tagged_string, unsigned int,
unsigned int)) _check_unknown_subscript)( s, sizeof( char), i) =='e'? 1:*(( char*(*)(
struct _tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s,
sizeof( char), i) =='E': 0){ i ++;{ int exponent= 0; int exp_sign= 1; digit_seen=
0; if( i <({ struct _tagged_string _temp137= s;( unsigned int)( _temp137.last_plus_one
- _temp137.curr);})?*(( char*(*)( struct _tagged_string, unsigned int,
unsigned int)) _check_unknown_subscript)( s, sizeof( char), i) =='-': 0){ i ++;
exp_sign= - 1;} else{ if( i <({ struct _tagged_string _temp138= s;( unsigned int)(
_temp138.last_plus_one - _temp138.curr);})?*(( char*(*)( struct _tagged_string,
unsigned int, unsigned int)) _check_unknown_subscript)( s, sizeof( char), i) =='+':
0){ i ++;}} while( i <({ struct _tagged_string _temp139= s;( unsigned int)(
_temp139.last_plus_one - _temp139.curr);})? Cyc_Character_isdigit(*(( char*(*)(
struct _tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s,
sizeof( char), i)): 0) { digit_seen= 1; exponent= exponent * 10 +( int)(*(( char*(*)(
struct _tagged_string, unsigned int, unsigned int)) _check_unknown_subscript)( s,
...
struct _tagged_string)({ char* _temp142=( char*)"String::to_double"; struct
