...
void* v; } ; extern struct _tagged_arr Cyc_Core_new_string( int); extern struct
_tagged_arr Cyc_Core_rnew_string( struct _RegionHandle*, int); extern
...
Cyc_List_Nth[ 8u]; extern int isalnum( int __c)  __attribute__(( cdecl )) ;
...
)) ; extern int _toupper( int __c)  __attribute__(( cdecl )) ; struct Cyc_Stdio___sFILE;
extern unsigned char Cyc_Stdio_FileCloseError[ 19u]; extern unsigned char Cyc_Stdio_FileOpenError[
18u]; struct Cyc_Stdio_FileOpenError_struct{ unsigned char* tag; struct
_tagged_arr f1; } ; extern struct _tagged_arr Cyc_String_strerror( int); extern
unsigned int Cyc_String_strlen( struct _tagged_arr s); extern int Cyc_String_strcmp(
...
struct _tagged_arr s1, struct _tagged_arr s2, unsigned int len); extern int Cyc_String_strncasecmp(
...
_tagged_arr, int, unsigned int); extern struct _tagged_arr Cyc_String_zstrncpy(
struct _tagged_arr, int, struct _tagged_arr, int, unsigned int); extern struct
_tagged_arr Cyc_String_expand( struct _tagged_arr s, unsigned int sz); extern
struct _tagged_arr Cyc_String_rexpand( struct _RegionHandle*, struct _tagged_arr
s, unsigned int sz); extern struct _tagged_arr Cyc_String_realloc_str( struct
...
struct _tagged_arr s, struct _tagged_arr accept); extern unsigned int Cyc_String_strspn(
...
< 0){( int) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct* _temp0=( struct
...
return( unsigned int)( i - ofs);}} static int Cyc_String_case_cmp( unsigned char
c1, unsigned char c2){ return c1 - c2;} static int Cyc_String_nocase_cmp(
...
min_length= len1 < len2? len1: len2; int i= - 1; while( ++ i < min_length) { int
diff= f(*(( const unsigned char*) _check_unknown_subscript( s1, sizeof(
...
n <= 0){ return 0;}{ unsigned int min_len= len1 > len2? len2: len1; unsigned int
bound= min_len > n? n: min_len;{ int i= 0; for( 0; i < bound; i ++){ int retc;
if(( retc= f(*(( const unsigned char*) _check_unknown_subscript( s1, sizeof(
unsigned char), i + ofs1)),*(( const unsigned char*) _check_unknown_subscript(
s2, sizeof( unsigned char), i + ofs2)))) != 0){ return retc;}}} return 0;}} int
Cyc_String_strncmp( struct _tagged_arr s1, struct _tagged_arr s2, unsigned int n){
unsigned int len1= Cyc_String_int_strleno( s1, 0, _tag_arr("String::strncmp",
sizeof( unsigned char), 16u)); unsigned int len2= Cyc_String_int_strleno( s2, 0,
_tag_arr("String::strncmp", sizeof( unsigned char), 16u)); return Cyc_String_ncmp(
s1, 0, len1, s2, 0, len2, n, Cyc_String_case_cmp);} int Cyc_String_strncasecmp(
struct _tagged_arr s1, struct _tagged_arr s2, unsigned int n){ unsigned int len1=
Cyc_String_int_strleno( s1, 0, _tag_arr("String::strncasecmp", sizeof(
unsigned char), 20u)); unsigned int len2= Cyc_String_int_strleno( s2, 0,
_tag_arr("String::strncasecmp", sizeof( unsigned char), 20u)); return Cyc_String_ncmp(
s1, 0, len1, s2, 0, len2, n, Cyc_String_nocase_cmp);} int Cyc_String_zstrcmp(
...
s1, sizeof( unsigned char), i))){ return 1;}}}} if( min_size <= bound){ return 0;}
if( s1size < s2size){ return - 1;} else{ return 1;}}} int Cyc_String_zstrptrcmp(
struct _tagged_arr* a, struct _tagged_arr* b){ return Cyc_String_zstrcmp(* a,* b);}
static struct _tagged_arr Cyc_String_int_strcato( struct _tagged_arr dest,
struct _tagged_arr src, int srcOfs, struct _tagged_arr error){ int i;
unsigned int dsize; unsigned int slen; unsigned int dlen; dsize= _get_arr_size(
dest, sizeof( unsigned char)); dlen= Cyc_String_strlen(( struct _tagged_arr)
dest); slen= Cyc_String_int_strleno( src, srcOfs, error); if( slen + dlen <=
dsize){ for( i= 0; i < slen; i ++){*(( unsigned char*) _check_unknown_subscript(
dest, sizeof( unsigned char),( int)( i + dlen)))=*(( const unsigned char*)
_check_unknown_subscript( src, sizeof( unsigned char), i + srcOfs));} if( i !=
dsize){*(( unsigned char*) _check_unknown_subscript( dest, sizeof( unsigned char),(
int)( i + dlen)))='\000';}} else{( int) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct*
...
struct _tagged_arr b){ unsigned int _temp4= Cyc_String_strlen( a); goto _LL5;
_LL5: { unsigned int _temp6= Cyc_String_strlen( b); goto _LL7; _LL7: { struct
_tagged_arr ans= Cyc_Core_rnew_string( r,( int)(( _temp4 + _temp6) + 1)); int i;
...
struct Cyc_List_List* strs){ unsigned int len; unsigned int total_len= 0; struct
_tagged_arr ans;{ struct _RegionHandle _temp8= _new_region(); struct
_RegionHandle* temp=& _temp8; _push_region( temp);{ struct Cyc_List_List* lens=({
struct Cyc_List_List* _temp12=( struct Cyc_List_List*) _region_malloc( temp,
sizeof( struct Cyc_List_List)); _temp12->hd=( void*)(( unsigned int) 0); _temp12->tl=
0; _temp12;}); struct Cyc_List_List* end= lens;{ struct Cyc_List_List* p= strs;
for( 0; p != 0; p=(( struct Cyc_List_List*) _check_null( p))->tl){ len= Cyc_String_strlen(*((
struct _tagged_arr*)(( struct Cyc_List_List*) _check_null( p))->hd)); total_len
+= len;(( struct Cyc_List_List*) _check_null( end))->tl=({ struct Cyc_List_List*
_temp9=( struct Cyc_List_List*) _region_malloc( temp, sizeof( struct Cyc_List_List));
_temp9->hd=( void*) len; _temp9->tl= 0; _temp9;}); end=(( struct Cyc_List_List*)
_check_null( end))->tl;}} lens=(( struct Cyc_List_List*) _check_null( lens))->tl;
ans= Cyc_Core_rnew_string( r,( int)( total_len + 1));{ unsigned int i= 0; while(
strs != 0) { struct _tagged_arr _temp10=*(( struct _tagged_arr*)(( struct Cyc_List_List*)
_check_null( strs))->hd); goto _LL11; _LL11: len=( unsigned int)(( struct Cyc_List_List*)
_check_null( lens))->hd; Cyc_String_strncpy( ans,( int) i, _temp10, 0, len); i +=
len; strs=(( struct Cyc_List_List*) _check_null( strs))->tl; lens=(( struct Cyc_List_List*)
_check_null( lens))->tl;}}}; _pop_region(& _temp8);} return ans;} struct
_tagged_arr Cyc_String_strconcat_l( struct Cyc_List_List* strs){ return Cyc_String_rstrconcat_l(
Cyc_Core_heap_region, strs);} struct _tagged_arr Cyc_String_rstr_sepstr( struct
_RegionHandle* r, struct Cyc_List_List* strs, struct _tagged_arr separator){ if(
strs == 0){ return Cyc_Core_rnew_string( r, 0);} if((( struct Cyc_List_List*)
_check_null( strs))->tl == 0){ return Cyc_String_rstrdup( r,*(( struct
_tagged_arr*)(( struct Cyc_List_List*) _check_null( strs))->hd));}{ struct Cyc_List_List*
_temp13= strs; goto _LL14; _LL14: { struct _RegionHandle _temp15= _new_region();
struct _RegionHandle* temp=& _temp15; _push_region( temp);{ struct Cyc_List_List*
lens=({ struct Cyc_List_List* _temp20=( struct Cyc_List_List*) _region_malloc(
temp, sizeof( struct Cyc_List_List)); _temp20->hd=( void*)(( unsigned int) 0);
_temp20->tl= 0; _temp20;}); struct Cyc_List_List* end= lens; unsigned int len= 0;
unsigned int total_len= 0; unsigned int list_len= 0; for( 0; _temp13 != 0;
_temp13=(( struct Cyc_List_List*) _check_null( _temp13))->tl){ len= Cyc_String_strlen(*((
struct _tagged_arr*)(( struct Cyc_List_List*) _check_null( _temp13))->hd));
total_len += len;(( struct Cyc_List_List*) _check_null( end))->tl=({ struct Cyc_List_List*
_temp16=( struct Cyc_List_List*) _region_malloc( temp, sizeof( struct Cyc_List_List));
_temp16->hd=( void*) len; _temp16->tl= 0; _temp16;}); end=(( struct Cyc_List_List*)
...
!= 0) { struct _tagged_arr _temp17=*(( struct _tagged_arr*)(( struct Cyc_List_List*)
_check_null( strs))->hd); goto _LL18; _LL18: len=( unsigned int)(( struct Cyc_List_List*)
_check_null( lens))->hd; Cyc_String_strncpy( ans,( int) i, _temp17, 0, len); i +=
...
_tagged_arr*)(( struct Cyc_List_List*) _check_null( strs))->hd), 0,(
unsigned int)(( struct Cyc_List_List*) _check_null( lens))->hd);{ struct
_tagged_arr _temp19= ans; _npop_handler( 0u); return _temp19;}}}}; _pop_region(&
_temp15);}}} struct _tagged_arr Cyc_String_str_sepstr( struct Cyc_List_List*
...
dest, int destOfs, struct _tagged_arr src, int srcOfs, unsigned int n){
unsigned int _temp21= _get_arr_size( dest, sizeof( unsigned char)); goto _LL22;
_LL22: { unsigned int _temp23= _get_arr_size( src, sizeof( unsigned char)); goto
_LL24; _LL24: if( destOfs < 0){( int) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct*
...
struct _tagged_arr dest, int destOfs, struct _tagged_arr src, int srcOfs,
unsigned int n){ unsigned int _temp33= _get_arr_size( dest, sizeof(
unsigned char)); goto _LL34; _LL34: { unsigned int _temp35= _get_arr_size( src,
sizeof( unsigned char)); goto _LL36; _LL36: if( destOfs < 0){( int) _throw((
void*)({ struct Cyc_Core_InvalidArg_struct* _temp37=( struct Cyc_Core_InvalidArg_struct*)
GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct)); _temp37[ 0]=({ struct
Cyc_Core_InvalidArg_struct _temp38; _temp38.tag= Cyc_Core_InvalidArg; _temp38.f1=
_tag_arr("String::zstrncpy", sizeof( unsigned char), 17u); _temp38;}); _temp37;}));}
if( srcOfs < 0? 1:( n > 0? srcOfs >= _temp35: 0)){( int) _throw(( void*)({
struct Cyc_Core_InvalidArg_struct* _temp39=( struct Cyc_Core_InvalidArg_struct*)
...
dest, 0, src, 0, len); if( len != _get_arr_size( dest, sizeof( unsigned char))){*((
...
Cyc_String_strncpy( temp, 0, src, 0, len); return temp;} struct _tagged_arr Cyc_String_strdup(
...
r,( int) sz); Cyc_String_strncpy( temp, 0, s, 0, slen); if( slen !=
_get_arr_size( s, sizeof( unsigned char))){*(( unsigned char*)
_check_unknown_subscript( temp, sizeof( unsigned char),( int) slen))='\000';}
return temp;} struct _tagged_arr Cyc_String_expand( struct _tagged_arr s,
unsigned int sz){ return Cyc_String_rexpand( Cyc_Core_heap_region, s, sz);}
struct _tagged_arr Cyc_String_rrealloc_str( struct _RegionHandle* r, struct
_tagged_arr str, unsigned int sz){ unsigned int maxsizeP= _get_arr_size( str,
sizeof( unsigned char)); if( maxsizeP == 0){ maxsizeP= 30 > sz? 30: sz; str= Cyc_Core_rnew_string(
r,( int) maxsizeP);*(( unsigned char*) _check_unknown_subscript( str, sizeof(
...
struct _tagged_arr str, unsigned int sz){ return Cyc_String_rrealloc_str( Cyc_Core_heap_region,
...
int) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct* _temp43=( struct Cyc_Core_InvalidArg_struct*)
...
struct _tagged_arr ans= Cyc_Core_rnew_string( r,( int)( amt + 1));{ unsigned int
i= 0; for( 0; i < amt; ++ i){*(( unsigned char*) _check_unknown_subscript( ans,
sizeof( unsigned char),( int) i))=*(( const unsigned char*)
_check_unknown_subscript( s, sizeof( unsigned char),( int)( start + i)));}}*((
unsigned char*) _check_unknown_subscript( ans, sizeof( unsigned char),( int) amt))='\000';
return ans;}} struct _tagged_arr Cyc_String_substring( struct _tagged_arr s, int
start, unsigned int amt){ return Cyc_String_rsubstring( Cyc_Core_heap_region, s,
start, amt);} struct _tagged_arr Cyc_String_rreplace_suffix( struct
_RegionHandle* r, struct _tagged_arr src, struct _tagged_arr curr_suffix, struct
_tagged_arr new_suffix){ unsigned int m= _get_arr_size( src, sizeof(
...
_temp45=( struct Cyc_Core_InvalidArg_struct*) GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct));
_temp45[ 0]=({ struct Cyc_Core_InvalidArg_struct _temp46; _temp46.tag= Cyc_Core_InvalidArg;
_temp46.f1= err; _temp46;}); _temp45;}));}{ unsigned int i= 1; for( 0; i <= n;
...
int) _throw(( void*)({ struct Cyc_Core_InvalidArg_struct* _temp47=( struct Cyc_Core_InvalidArg_struct*)
GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct)); _temp47[ 0]=({ struct
Cyc_Core_InvalidArg_struct _temp48; _temp48.tag= Cyc_Core_InvalidArg; _temp48.f1=
err; _temp48;}); _temp47;}));}}}{ struct _tagged_arr ans= Cyc_Core_rnew_string(
r,( int)(( m - n) + _get_arr_size( new_suffix, sizeof( unsigned char)))); Cyc_String_strncpy(
ans, 0, src, 0, m - n); Cyc_String_strncpy( ans,( int)( m - n), new_suffix, 0,
...
int) Cyc_String_int_strleno( s, 0, _tag_arr("String::strchr", sizeof(
unsigned char), 15u)); unsigned char c2='\000'; for( 0; len > 0?( c2=*(( const
unsigned char*) _check_unknown_subscript( s, sizeof( unsigned char), 0u))) != 0:
0;( len --, _tagged_arr_inplace_plus_post(& s, sizeof( unsigned char), 1))){ if(
c2 == c){ return s;}} return( struct _tagged_arr) _tag_arr( 0u, sizeof(
unsigned char), 0u);} struct _tagged_arr Cyc_String_strrchr( struct _tagged_arr
s, unsigned char c){ int len=( int) Cyc_String_int_strleno(( struct _tagged_arr)
s, 0, _tag_arr("String::strrchr", sizeof( unsigned char), 16u)); int i= len - 1;
...
return s;}} return _tag_arr( 0u, sizeof( unsigned char), 0u);} unsigned int Cyc_String_strspn(
struct _tagged_arr s, struct _tagged_arr accept){ unsigned int len= Cyc_String_int_strleno(
s, 0, _tag_arr("String::strspn", sizeof( unsigned char), 15u));{ unsigned int i=
0; for( 0; i < len; i ++){ int j; for( j= 0; j < _get_arr_size( accept, sizeof(
...
struct Cyc_List_List* Cyc_String_rexplode( struct _RegionHandle* r, struct
_tagged_arr s){ struct Cyc_List_List* result= 0;{ int i=( int)( Cyc_String_strlen(
s) - 1); for( 0; i >= 0; i --){ result=({ struct Cyc_List_List* _temp49=( struct
Cyc_List_List*) _region_malloc( r, sizeof( struct Cyc_List_List)); _temp49->hd=(
void*)(( int)*(( const unsigned char*) _check_unknown_subscript( s, sizeof(
unsigned char), i))); _temp49->tl= result; _temp49;});}} return result;} struct
Cyc_List_List* Cyc_String_explode( struct _tagged_arr s){ return Cyc_String_rexplode(
...
int i= offset == 0? 0:*(( int*) _check_null( offset)); while( i < _get_arr_size(
s, sizeof( unsigned char))? isspace(( int)*(( const unsigned char*)
