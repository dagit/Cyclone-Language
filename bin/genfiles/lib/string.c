...
Null_Exception);}* _temp93;})) != 0: 0; len --,({ struct _tagged_string* _temp94=&
s; struct _tagged_string _temp95=* _temp94; _temp94->curr ++; _temp95;})){ int j=
0; for( 0; j <({ struct _tagged_string _temp96= accept;( unsigned int)( _temp96.last_plus_one
- _temp96.curr);}); j ++){ if( c ==*(( char*(*)( struct _tagged_string,
unsigned int, unsigned int)) _check_unknown_subscript)( accept, sizeof( char), j)){
return s;}}} return({ struct _tagged_string _temp97={ 0, 0, 0}; _temp97;});}
...
_temp105=( char*)"String::strchr"; struct _tagged_string _temp106; _temp106.curr=
...
_tagged_string _temp103=* _temp102; _temp102->curr ++; _temp103;})){ if( c2 == c){
return s;}} return({ struct _tagged_string _temp104={ 0, 0, 0}; _temp104;});}
struct _tagged_string Cyc_String_strrchr( struct _tagged_string s, char c){ int
len=( int) Cyc_String_int_strleno( s, 0,( struct _tagged_string)({ char*
_temp112=( char*)"String::strrchr"; struct _tagged_string _temp113; _temp113.curr=
_temp112; _temp113.base= _temp112; _temp113.last_plus_one= _temp112 + 16;
_temp113;})); int i= len - 1; s.curr += i; for( 0; i >= 0; i --,({ struct
_tagged_string* _temp107=& s; struct _tagged_string _temp108=* _temp107;
_temp107->curr --; _temp108;})){ if(({ struct _tagged_string _temp109= s; char*
_temp110= _temp109.curr; if( _temp109.base == 0? 1:( _temp110 < _temp109.base? 1:
_temp110 >= _temp109.last_plus_one)){ _throw( Null_Exception);}* _temp110;}) ==
c){ return s;}} return({ struct _tagged_string _temp111={ 0, 0, 0}; _temp111;});}
unsigned int Cyc_String_strspn( struct _tagged_string s, struct _tagged_string
accept){ unsigned int len= Cyc_String_int_strleno( s, 0,( struct _tagged_string)({
char* _temp116=( char*)"String::strspn"; struct _tagged_string _temp117;
...
_check_unknown_subscript)( s, sizeof( char),( int)( i ++))=( char)(( int)((
struct Cyc_List_List*) _check_null( chars))->hd); chars=(( struct Cyc_List_List*)
