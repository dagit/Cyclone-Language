...
_tagged_string)({ char* _temp17=( char*)"String::strcmp"; struct _tagged_string
_temp18; _temp18.curr= _temp17; _temp18.base= _temp17; _temp18.last_plus_one=
...
struct _tagged_string _temp37= a; char* _temp39= _temp37.curr + i; if( _temp37.base
...
_temp42 >= _temp40.last_plus_one)){ _throw( Null_Exception);}* _temp42;}); if(
...
return 0;}{ unsigned int s1size=({ struct _tagged_string _temp43= s1;(
unsigned int)( _temp43.last_plus_one - _temp43.curr);}); unsigned int s2size=({
struct _tagged_string _temp44= s2;( unsigned int)( _temp44.last_plus_one -
_temp44.curr);}); unsigned int min_size= s1size > s2size? s2size: s1size;
unsigned int bound= min_size > n? n: min_size;{ int i= 0; for( 0; i < bound; i
++){ if(({ struct _tagged_string _temp45= s1; char* _temp47= _temp45.curr + i;
if( _temp45.base == 0? 1:( _temp47 < _temp45.base? 1: _temp47 >= _temp45.last_plus_one)){
_throw( Null_Exception);}* _temp47;}) <({ struct _tagged_string _temp48= s2;
char* _temp50= _temp48.curr + i; if( _temp48.base == 0? 1:( _temp50 < _temp48.base?
1: _temp50 >= _temp48.last_plus_one)){ _throw( Null_Exception);}* _temp50;})){
return - 1;} else{ if(({ struct _tagged_string _temp51= s2; char* _temp53=
_temp51.curr + i; if( _temp51.base == 0? 1:( _temp53 < _temp51.base? 1: _temp53
>= _temp51.last_plus_one)){ _throw( Null_Exception);}* _temp53;}) <({ struct
_tagged_string _temp54= s1; char* _temp56= _temp54.curr + i; if( _temp54.base ==
...
unsigned int i=( unsigned int) 0; while(({ struct Cyc_List_List* _temp105= strs;
if( _temp105 == 0){ _throw( Null_Exception);} _temp105->tl;}) != 0) { struct
_tagged_string next=*(( struct _tagged_string*)({ struct Cyc_List_List* _temp106=
strs; if( _temp106 == 0){ _throw( Null_Exception);} _temp106->hd;})); len=(
unsigned int)({ struct Cyc_List_List* _temp107= lens; if( _temp107 == 0){ _throw(
Null_Exception);} _temp107->hd;}); Cyc_String_strncpy( ans,( int) i, next, 0,
len); i += len; Cyc_String_strncpy( ans,( int) i, separator, 0, seplen); i +=
seplen; strs=({ struct Cyc_List_List* _temp108= strs; if( _temp108 == 0){ _throw(
Null_Exception);} _temp108->tl;}); lens=({ struct Cyc_List_List* _temp109= lens;
if( _temp109 == 0){ _throw( Null_Exception);} _temp109->tl;});} Cyc_String_strncpy(
ans,( int) i,*(( struct _tagged_string*)({ struct Cyc_List_List* _temp110= strs;
if( _temp110 == 0){ _throw( Null_Exception);} _temp110->hd;})), 0,( unsigned int)({
struct Cyc_List_List* _temp111= lens; if( _temp111 == 0){ _throw( Null_Exception);}
_temp111->hd;})); return ans;}}}} struct _tagged_string Cyc_String_strncpy(
...
_xtunion_struct*)({ struct Cyc_Core_InvalidArg_struct* _temp118=( struct Cyc_Core_InvalidArg_struct*)
GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct)); _temp118[ 0]=({ struct
Cyc_Core_InvalidArg_struct _temp119; _temp119.tag= Cyc_Core_InvalidArg_tag;
...
_temp122=( struct Cyc_Core_InvalidArg_struct*) GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct));
_temp122[ 0]=({ struct Cyc_Core_InvalidArg_struct _temp123; _temp123.tag= Cyc_Core_InvalidArg_tag;
...
int i; for( i= 0; i < n; i ++){ char srcChar=({ struct _tagged_string _temp126=
src; char* _temp128= _temp126.curr +( srcOfs + i); if( _temp126.base == 0? 1:(
_temp128 < _temp126.base? 1: _temp128 >= _temp126.last_plus_one)){ _throw(
Null_Exception);}* _temp128;}); if( srcChar =='\000'){ break;}({ struct
_tagged_string _temp129= dest; char* _temp131= _temp129.curr +( destOfs + i);
if( _temp129.base == 0? 1:( _temp131 < _temp129.base? 1: _temp131 >= _temp129.last_plus_one)){
_throw( Null_Exception);}* _temp131= srcChar;});} for( 0; i < n; i ++){({ struct
_tagged_string _temp132= dest; char* _temp134= _temp132.curr +( destOfs + i);
if( _temp132.base == 0? 1:( _temp134 < _temp132.base? 1: _temp134 >= _temp132.last_plus_one)){
_throw( Null_Exception);}* _temp134='\000';});} return dest;}} struct
...
struct _tagged_string _temp135= dest;( unsigned int)( _temp135.last_plus_one -
_temp135.curr);}); unsigned int srcSz=({ struct _tagged_string _temp136= src;(
unsigned int)( _temp136.last_plus_one - _temp136.curr);}); if( destOfs < 0){(
void) _throw(( struct _xtunion_struct*)({ struct Cyc_Core_InvalidArg_struct*
_temp137=( struct Cyc_Core_InvalidArg_struct*) GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct));
_temp137[ 0]=({ struct Cyc_Core_InvalidArg_struct _temp138; _temp138.tag= Cyc_Core_InvalidArg_tag;
...
if( srcOfs < 0? 1:( n > 0? srcOfs >= srcSz: 0)){( void) _throw(( struct
_xtunion_struct*)({ struct Cyc_Core_InvalidArg_struct* _temp141=( struct Cyc_Core_InvalidArg_struct*)
GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct)); _temp141[ 0]=({ struct
Cyc_Core_InvalidArg_struct _temp142; _temp142.tag= Cyc_Core_InvalidArg_tag;
...
if( n <= 0){ return dest;} if( destOfs + n > destSz? 1: srcOfs + n > srcSz){(
void) _throw(( struct _xtunion_struct*)({ struct Cyc_Core_InvalidArg_struct*
_temp145=( struct Cyc_Core_InvalidArg_struct*) GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct));
...
int i; for( i= 0; i < n; i ++){({ struct _tagged_string _temp149= dest; char*
_temp151= _temp149.curr +( destOfs + i); if( _temp149.base == 0? 1:( _temp151 <
_temp149.base? 1: _temp151 >= _temp149.last_plus_one)){ _throw( Null_Exception);}*
_temp151=({ struct _tagged_string _temp152= src; char* _temp154= _temp152.curr +(
srcOfs + i); if( _temp152.base == 0? 1:( _temp154 < _temp152.base? 1: _temp154
>= _temp152.last_plus_one)){ _throw( Null_Exception);}* _temp154;});});} return
...
_temp163.last_plus_one - _temp163.curr);}); if( maxsizeP == 0){ maxsizeP= 30 >
sz? 30: sz; str= Cyc_Core_new_string(( int) maxsizeP);({ struct _tagged_string
_temp164= str; char* _temp166= _temp164.curr + 0; if( _temp164.base == 0? 1:(
_temp166 < _temp164.base? 1: _temp166 >= _temp164.last_plus_one)){ _throw(
Null_Exception);}* _temp166='\000';});} else{ if( sz > maxsizeP){ maxsizeP=
...
new_suffix){ unsigned int m=({ struct _tagged_string _temp181= src;(
unsigned int)( _temp181.last_plus_one - _temp181.curr);}); unsigned int n=({
...
for( 0; i <= n; ++ i){ if(({ struct _tagged_string _temp187= src; char* _temp189=
_temp187.curr +( int)( m - i); if( _temp187.base == 0? 1:( _temp189 < _temp187.base?
1: _temp189 >= _temp187.last_plus_one)){ _throw( Null_Exception);}* _temp189;})
!=({ struct _tagged_string _temp190= curr_suffix; char* _temp192= _temp190.curr
+( int)( n - i); if( _temp190.base == 0? 1:( _temp192 < _temp190.base? 1:
_temp192 >= _temp190.last_plus_one)){ _throw( Null_Exception);}* _temp192;})){(
void) _throw(( struct _xtunion_struct*)({ struct Cyc_Core_InvalidArg_struct*
...
> 0?( c=({ struct _tagged_string _temp199= s; char* _temp200= _temp199.curr; if(
_temp199.base == 0? 1:( _temp200 < _temp199.base? 1: _temp200 >= _temp199.last_plus_one)){
...
_temp202;})){ int j= 0; for( 0; j <({ struct _tagged_string _temp203= accept;(
unsigned int)( _temp203.last_plus_one - _temp203.curr);}); j ++){ if( c ==({
struct _tagged_string _temp204= accept; char* _temp206= _temp204.curr + j; if(
_temp204.base == 0? 1:( _temp206 < _temp204.base? 1: _temp206 >= _temp204.last_plus_one)){
_throw( Null_Exception);}* _temp206;})){ return s;}}} return({ struct
_tagged_string _temp207={ 0, 0, 0}; _temp207;});} struct _tagged_string Cyc_String_strchr(
struct _tagged_string s, char c){ int len=( int) Cyc_String_int_strleno( s, 0,(
struct _tagged_string)({ char* _temp208=( char*)"String::strchr"; struct
_tagged_string _temp209; _temp209.curr= _temp208; _temp209.base= _temp208;
_temp209.last_plus_one= _temp208 + 15; _temp209;})); char c2='\000'; for( 0; len
> 0?( c2=({ struct _tagged_string _temp210= s; char* _temp211= _temp210.curr;
if( _temp210.base == 0? 1:( _temp211 < _temp210.base? 1: _temp211 >= _temp210.last_plus_one)){
_throw( Null_Exception);}* _temp211;})) != 0: 0; len --,({ struct _tagged_string*
_temp212=& s; struct _tagged_string _temp213=* _temp212; _temp212->curr ++;
_temp213;})){ if( c2 == c){ return s;}} return({ struct _tagged_string _temp214={
0, 0, 0}; _temp214;});} struct _tagged_string Cyc_String_strrchr( struct
_tagged_string s, char c){ int len=( int) Cyc_String_int_strleno( s, 0,( struct
_tagged_string)({ char* _temp215=( char*)"String::strrchr"; struct
...
_tagged_string _temp218=* _temp217; _temp217->curr --; _temp218;})){ if(({
...
_throw( Null_Exception);}* _temp220;}) == c){ return s;}} return({ struct
...
_tagged_string _temp224= accept;( unsigned int)( _temp224.last_plus_one -
_temp224.curr);}); j ++){ if(({ struct _tagged_string _temp225= s; char*
...
_temp227;}) ==({ struct _tagged_string _temp228= accept; char* _temp230=
...
break;}} if( j ==({ struct _tagged_string _temp231= accept;( unsigned int)(
_temp231.last_plus_one - _temp231.curr);})){ return i;}}} return len;} struct
...
_temp241 == 0){ _throw( Null_Exception);}* _temp241;}); while( i <({ struct
_tagged_string _temp242= s;( unsigned int)( _temp242.last_plus_one - _temp242.curr);})?
Cyc_Character_isspace(({ struct _tagged_string _temp243= s; char* _temp245=
_temp243.curr + i; if( _temp243.base == 0? 1:( _temp245 < _temp243.base? 1:
_temp245 >= _temp243.last_plus_one)){ _throw( Null_Exception);}* _temp245;})): 0) {
i ++;} if( i <({ struct _tagged_string _temp246= s;( unsigned int)( _temp246.last_plus_one
- _temp246.curr);})?({ struct _tagged_string _temp247= s; char* _temp249=
_temp247.curr + i; if( _temp247.base == 0? 1:( _temp249 < _temp247.base? 1:
_temp249 >= _temp247.last_plus_one)){ _throw( Null_Exception);}* _temp249;}) =='-':
0){ i ++; sn= - 1;} while( i <({ struct _tagged_string _temp250= s;(
unsigned int)( _temp250.last_plus_one - _temp250.curr);})? Cyc_Character_isspace(({
struct _tagged_string _temp251= s; char* _temp253= _temp251.curr + i; if(
_temp251.base == 0? 1:( _temp253 < _temp251.base? 1: _temp253 >= _temp251.last_plus_one)){
_throw( Null_Exception);}* _temp253;})): 0) { i ++;} while( i <({ struct
_tagged_string _temp254= s;( unsigned int)( _temp254.last_plus_one - _temp254.curr);})?
Cyc_Character_isdigit(({ struct _tagged_string _temp255= s; char* _temp257=
_temp255.curr + i; if( _temp255.base == 0? 1:( _temp257 < _temp255.base? 1:
_temp257 >= _temp255.last_plus_one)){ _throw( Null_Exception);}* _temp257;})): 0) {
digit_seen= 1; ans= ans * 10 +( int)(({ struct _tagged_string _temp258= s; char*
...
_xtunion_struct*)({ struct Cyc_Core_InvalidArg_struct* _temp261=( struct Cyc_Core_InvalidArg_struct*)
GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct)); _temp261[ 0]=({ struct
Cyc_Core_InvalidArg_struct _temp262; _temp262.tag= Cyc_Core_InvalidArg_tag;
...
_throw( Null_Exception);}* _temp266;}); while( i <({ struct _tagged_string
_temp267= s;( unsigned int)( _temp267.last_plus_one - _temp267.curr);})? Cyc_Character_isspace(({
struct _tagged_string _temp268= s; char* _temp270= _temp268.curr + i; if(
_temp268.base == 0? 1:( _temp270 < _temp268.base? 1: _temp270 >= _temp268.last_plus_one)){
_throw( Null_Exception);}* _temp270;})): 0) { i ++;} if( i <({ struct
_tagged_string _temp271= s;( unsigned int)( _temp271.last_plus_one - _temp271.curr);})?({
...
_throw( Null_Exception);}* _temp274;}) =='-': 0){ i ++; sn= - 1;} while( i <({
struct _tagged_string _temp275= s;( unsigned int)( _temp275.last_plus_one -
...
_temp278;})): 0) { digit_seen= 1; ans= ans * 10.0 +( double)(({ struct
_tagged_string _temp279= s; char* _temp281= _temp279.curr + i; if( _temp279.base
== 0? 1:( _temp281 < _temp279.base? 1: _temp281 >= _temp279.last_plus_one)){
_throw( Null_Exception);}* _temp281;}) -'0'); i ++;} if( i <({ struct
_tagged_string _temp282= s;( unsigned int)( _temp282.last_plus_one - _temp282.curr);})?({
struct _tagged_string _temp283= s; char* _temp285= _temp283.curr + i; if(
_temp283.base == 0? 1:( _temp285 < _temp283.base? 1: _temp285 >= _temp283.last_plus_one)){
_throw( Null_Exception);}* _temp285;}) =='.': 0){ i ++;{ double divisor=( double)
0.1; while( i <({ struct _tagged_string _temp286= s;( unsigned int)( _temp286.last_plus_one
...
_temp289;})): 0) { digit_seen= 1; ans= ans +( double)(({ struct _tagged_string
_temp290= s; char* _temp292= _temp290.curr + i; if( _temp290.base == 0? 1:(
_temp292 < _temp290.base? 1: _temp292 >= _temp290.last_plus_one)){ _throw(
Null_Exception);}* _temp292;}) -'0') * divisor; divisor= divisor / 10.0; i ++;}}}
if( ! digit_seen){( void) _throw(( struct _xtunion_struct*)({ struct Cyc_Core_InvalidArg_struct*
_temp293=( struct Cyc_Core_InvalidArg_struct*) GC_malloc( sizeof( struct Cyc_Core_InvalidArg_struct));
_temp293[ 0]=({ struct Cyc_Core_InvalidArg_struct _temp294; _temp294.tag= Cyc_Core_InvalidArg_tag;
...
if( i <({ struct _tagged_string _temp297= s;( unsigned int)( _temp297.last_plus_one
- _temp297.curr);})?({ struct _tagged_string _temp298= s; char* _temp300=
_temp298.curr + i; if( _temp298.base == 0? 1:( _temp300 < _temp298.base? 1:
_temp300 >= _temp298.last_plus_one)){ _throw( Null_Exception);}* _temp300;}) =='e'?
1:({ struct _tagged_string _temp301= s; char* _temp303= _temp301.curr + i; if(
_temp301.base == 0? 1:( _temp303 < _temp301.base? 1: _temp303 >= _temp301.last_plus_one)){
_throw( Null_Exception);}* _temp303;}) =='E': 0){ i ++;{ int exponent= 0; int
exp_sign= 1; digit_seen= 0; if( i <({ struct _tagged_string _temp304= s;(
unsigned int)( _temp304.last_plus_one - _temp304.curr);})?({ struct
_tagged_string _temp305= s; char* _temp307= _temp305.curr + i; if( _temp305.base
== 0? 1:( _temp307 < _temp305.base? 1: _temp307 >= _temp305.last_plus_one)){
_throw( Null_Exception);}* _temp307;}) =='-': 0){ i ++; exp_sign= - 1;} else{
if( i <({ struct _tagged_string _temp308= s;( unsigned int)( _temp308.last_plus_one
- _temp308.curr);})?({ struct _tagged_string _temp309= s; char* _temp311=
_temp309.curr + i; if( _temp309.base == 0? 1:( _temp311 < _temp309.base? 1:
_temp311 >= _temp309.last_plus_one)){ _throw( Null_Exception);}* _temp311;}) =='+':
0){ i ++;}} while( i <({ struct _tagged_string _temp312= s;( unsigned int)(
_temp312.last_plus_one - _temp312.curr);})? Cyc_Character_isdigit(({ struct
_tagged_string _temp313= s; char* _temp315= _temp313.curr + i; if( _temp313.base
== 0? 1:( _temp315 < _temp313.base? 1: _temp315 >= _temp313.last_plus_one)){
_throw( Null_Exception);}* _temp315;})): 0) { digit_seen= 1; exponent= exponent
* 10 +( int)(({ struct _tagged_string _temp316= s; char* _temp318= _temp316.curr
+ i; if( _temp316.base == 0? 1:( _temp318 < _temp316.base? 1: _temp318 >=
_temp316.last_plus_one)){ _throw( Null_Exception);}* _temp318;}) -'0'); i ++;}
if( ! digit_seen){( void) _throw(( struct _xtunion_struct*)({ struct Cyc_Core_InvalidArg_struct*
