...
_tagged_string f1; } ; struct Cyc_Buffer_t; extern struct Cyc_Buffer_t* Cyc_Buffer_create(
...
struct _tagged_string) b->buffer, 0, b->position);} unsigned int Cyc_Buffer_length(
