...
struct Cyc_Buffer_t*, struct _tagged_arr); extern int isalnum( int __c); extern
int isalpha( int __c); extern int iscntrl( int __c); extern int isdigit( int __c);
...
int __c); extern int _tolower( int __c); extern int _toupper( int __c);
