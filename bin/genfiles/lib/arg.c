...
Cyc_Arg_Justify_break_line( b, margin - indent, desc); if( desc.curr !=(( struct
_tagged_arr) _tag_arr( 0u, 0u, 0u)).curr){ Cyc_Buffer_add_string( b, indentstr);}
else{ Cyc_Buffer_add_string( b, _tag_arr("\n", sizeof( unsigned char), 2u));}}
return;}} void Cyc_Arg_usage( struct Cyc_List_List* speclist, struct _tagged_arr
errmsg){({ struct Cyc_Stdio_String_pa_struct _temp13; _temp13.tag= Cyc_Stdio_String_pa;
_temp13.f1=( struct _tagged_arr) errmsg;{ void* _temp12[ 1u]={& _temp13}; Cyc_Stdio_fprintf(
Cyc_Stdio_stderr, _tag_arr("%s\n", sizeof( unsigned char), 4u), _tag_arr(
_temp12, sizeof( void*), 1u));}});{ struct Cyc_Buffer_t* _temp14= Cyc_Buffer_create(
1024); while( speclist != 0) { Cyc_Arg_Justify_justify_b( _temp14, 12, 72,(
struct _tagged_arr) Cyc_String_strconcat((*(( struct _tuple0*)(( struct Cyc_List_List*)
...
_LL23;} _LL23: if(*(( int*) _temp17) == Cyc_Arg_Wrong){ _LL36: _temp35=(( struct
Cyc_Arg_Wrong_struct*) _temp17)->f1; goto _LL34; _LL34: _temp33=(( struct Cyc_Arg_Wrong_struct*)
_temp17)->f2; goto _LL32; _LL32: _temp31=(( struct Cyc_Arg_Wrong_struct*)
...
_temp108= 1;} if( ! _temp108){ n= Cyc_Core_int_of_string( arg);; _pop_handler();}
else{ void* _temp107=( void*) _exn_thrown; void* _temp110= _temp107; struct
_tagged_arr _temp116; _LL112: if(*(( void**) _temp110) == Cyc_Core_InvalidArg){
_LL117: _temp116=(( struct Cyc_Core_InvalidArg_struct*) _temp110)->f1; goto
_LL113;} else{ goto _LL114;} _LL114: goto _LL115; _LL113: Cyc_Arg_stop( initpos,(
void*)({ struct Cyc_Arg_Wrong_struct* _temp118=( struct Cyc_Arg_Wrong_struct*)
GC_malloc( sizeof( struct Cyc_Arg_Wrong_struct)); _temp118[ 0]=({ struct Cyc_Arg_Wrong_struct
_temp119; _temp119.tag= Cyc_Arg_Wrong; _temp119.f1= s; _temp119.f2= arg;
_temp119.f3= _tag_arr("an integer", sizeof( unsigned char), 11u); _temp119;});
_temp118;}), speclist, errmsg); _npop_handler( 0u); return; _LL115:( void)
_throw( _temp110); _LL111:;}}} _temp98( n); ++ Cyc_Arg_current; goto _LL69;}
_LL85: while( Cyc_Arg_current < l - 1) { _temp100(*(( struct _tagged_arr*)
_check_unknown_subscript( Cyc_Arg_args, sizeof( struct _tagged_arr), Cyc_Arg_current
+ 1))); ++ Cyc_Arg_current;} goto _LL69; _LL69:;}; _pop_handler();} else{ void*
_temp66=( void*) _exn_thrown; void* _temp121= _temp66; struct _tagged_arr
_temp127; _LL123: if(*(( void**) _temp121) == Cyc_Arg_Bad){ _LL128: _temp127=((
struct Cyc_Arg_Bad_struct*) _temp121)->f1; goto _LL124;} else{ goto _LL125;}
_LL125: goto _LL126; _LL124: Cyc_Arg_stop( initpos,( void*)({ struct Cyc_Arg_Message_struct*
_temp129=( struct Cyc_Arg_Message_struct*) GC_malloc( sizeof( struct Cyc_Arg_Message_struct));
_temp129[ 0]=({ struct Cyc_Arg_Message_struct _temp130; _temp130.tag= Cyc_Arg_Message;
_temp130.f1= _temp127; _temp130;}); _temp129;}), speclist, errmsg); goto _LL122;
_LL126:( void) _throw( _temp121); _LL122:;}}} ++ Cyc_Arg_current;} else{{ struct
_handler_cons _temp131; _push_handler(& _temp131);{ int _temp133= 0; if( setjmp(
_temp131.handler)){ _temp133= 1;} if( ! _temp133){ anonfun( s);; _pop_handler();}
else{ void* _temp132=( void*) _exn_thrown; void* _temp135= _temp132; struct
_tagged_arr _temp141; _LL137: if(*(( void**) _temp135) == Cyc_Arg_Bad){ _LL142:
_temp141=(( struct Cyc_Arg_Bad_struct*) _temp135)->f1; goto _LL138;} else{ goto
_LL139;} _LL139: goto _LL140; _LL138: Cyc_Arg_stop( initpos,( void*)({ struct
Cyc_Arg_Message_struct* _temp143=( struct Cyc_Arg_Message_struct*) GC_malloc(
sizeof( struct Cyc_Arg_Message_struct)); _temp143[ 0]=({ struct Cyc_Arg_Message_struct
_temp144; _temp144.tag= Cyc_Arg_Message; _temp144.f1= _temp141; _temp144;});
