...
_tagged_string _temp29; _LL11: if((( struct _tunion_struct*) _temp9)->tag == Cyc_Arg_Unknown){
_LL20: _temp19=( struct _tagged_string)(( struct Cyc_Arg_Unknown_struct*) _temp9)->f1;
goto _LL12;} else{ goto _LL13;} _LL13: if((( struct _tunion_struct*) _temp9)->tag
== Cyc_Arg_Missing){ _LL22: _temp21=( struct _tagged_string)(( struct Cyc_Arg_Missing_struct*)
_temp9)->f1; goto _LL14;} else{ goto _LL15;} _LL15: if((( struct _tunion_struct*)
_temp9)->tag == Cyc_Arg_Wrong){ _LL28: _temp27=( struct _tagged_string)(( struct
Cyc_Arg_Wrong_struct*) _temp9)->f1; goto _LL26; _LL26: _temp25=( struct
_tagged_string)(( struct Cyc_Arg_Wrong_struct*) _temp9)->f2; goto _LL24; _LL24:
_temp23=( struct _tagged_string)(( struct Cyc_Arg_Wrong_struct*) _temp9)->f3;
goto _LL16;} else{ goto _LL17;} _LL17: if((( struct _tunion_struct*) _temp9)->tag
== Cyc_Arg_Message){ _LL30: _temp29=( struct _tagged_string)(( struct Cyc_Arg_Message_struct*)
_temp9)->f1; goto _LL18;} else{ goto _LL10;} _LL12: if( Cyc_String_strcmp(
_temp19,( struct _tagged_string)({ char* _temp31=( char*)"-help"; struct
_tagged_string _temp32; _temp32.curr= _temp31; _temp32.base= _temp31; _temp32.last_plus_one=
_temp31 + 6; _temp32;})) != 0){({ struct _tagged_string _temp33= progname;
struct _tagged_string _temp34= _temp19; fprintf( Cyc_Stdio_stderr,"%.*s: unknown option `%.*s'.\n",
...
int); void(* _temp91)( struct _tagged_string); _LL69: if((( struct
_tunion_struct*) _temp67)->tag == Cyc_Arg_Unit_spec){ _LL82: _temp81=( void(*)())((
struct Cyc_Arg_Unit_spec_struct*) _temp67)->f1; goto _LL70;} else{ goto _LL71;}
_LL71: if((( struct _tunion_struct*) _temp67)->tag == Cyc_Arg_Set_spec){ _LL84:
_temp83=( int*)(( struct Cyc_Arg_Set_spec_struct*) _temp67)->f1; goto _LL72;}
else{ goto _LL73;} _LL73: if((( struct _tunion_struct*) _temp67)->tag == Cyc_Arg_Clear_spec){
_LL86: _temp85=( int*)(( struct Cyc_Arg_Clear_spec_struct*) _temp67)->f1; goto
_LL74;} else{ goto _LL75;} _LL75: if((( struct _tunion_struct*) _temp67)->tag ==
...
if((( struct _tunion_struct*) _temp67)->tag == Cyc_Arg_Int_spec){ _LL90: _temp89=(
void(*)( int))(( struct Cyc_Arg_Int_spec_struct*) _temp67)->f1; goto _LL78;}
else{ goto _LL79;} _LL79: if((( struct _tunion_struct*) _temp67)->tag == Cyc_Arg_Rest_spec){
_LL92: _temp91=( void(*)( struct _tagged_string))(( struct Cyc_Arg_Rest_spec_struct*)
_temp67)->f1; goto _LL80;} else{ goto _LL68;} _LL70: _temp81(); goto _LL68;
_LL72:* _temp83= 1; goto _LL68; _LL74:* _temp85= 0; goto _LL68; _LL76: if( Cyc_Arg_current
+ 1 < l){ _temp87(({ struct _tagged_ptr0 _temp93= Cyc_Arg_args; struct
_tagged_string* _temp95= _temp93.curr +( Cyc_Arg_current + 1); if( _temp93.base
== 0? 1:( _temp95 < _temp93.base? 1: _temp95 >= _temp93.last_plus_one)){ _throw(
...
_LL103: if(( void*)(*(( struct _xtunion_struct*) _temp101)).tag == Cyc_Core_InvalidArg){
_LL108: _temp107=( struct _tagged_string)(( struct Cyc_Core_InvalidArg_struct*)
_temp101)->f1; goto _LL104;} else{ goto _LL105;} _LL105: goto _LL106; _LL104:
Cyc_Arg_stop( initpos,( void*)({ struct Cyc_Arg_Wrong_struct* _temp109=( struct
Cyc_Arg_Wrong_struct*) GC_malloc( sizeof( struct Cyc_Arg_Wrong_struct));
_temp109[ 0]=({ struct Cyc_Arg_Wrong_struct _temp110; _temp110.tag= Cyc_Arg_Wrong;
_temp110.f1= s; _temp110.f2= arg; _temp110.f3=( struct _tagged_string)({ char*
_temp111=( char*)"an integer"; struct _tagged_string _temp112; _temp112.curr=
_temp111; _temp112.base= _temp111; _temp112.last_plus_one= _temp111 + 11;
_temp112;}); _temp110;}); _temp109;}), speclist, errmsg); _npop_handler( 0u);
return; _LL106:( void) _throw( _temp101); _LL102:;}}} _temp89( n); ++ Cyc_Arg_current;
...
++ Cyc_Arg_current;} goto _LL68; _LL68:;}; _pop_handler();} else{ void* _temp120=
_temp66; struct _tagged_string _temp126; _LL122: if(( void*)(*(( struct
_xtunion_struct*) _temp120)).tag == Cyc_Arg_Bad){ _LL127: _temp126=( struct
...
struct _tagged_string _temp139; _LL135: if(( void*)(*(( struct _xtunion_struct*)
_temp133)).tag == Cyc_Arg_Bad){ _LL140: _temp139=( struct _tagged_string)((
struct Cyc_Arg_Bad_struct*) _temp133)->f1; goto _LL136;} else{ goto _LL137;}
_LL137: goto _LL138; _LL136: Cyc_Arg_stop( initpos,( void*)({ struct Cyc_Arg_Message_struct*
_temp141=( struct Cyc_Arg_Message_struct*) GC_malloc( sizeof( struct Cyc_Arg_Message_struct));
_temp141[ 0]=({ struct Cyc_Arg_Message_struct _temp142; _temp142.tag= Cyc_Arg_Message;
_temp142.f1= _temp139; _temp142;}); _temp141;}), speclist, errmsg); goto _LL134;
_LL138:( void) _throw( _temp133); _LL134:;}}} ++ Cyc_Arg_current;}}}}