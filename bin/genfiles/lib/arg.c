...
Cyc_Stdio_stderr; typedef int Cyc_Stdio_fpos_t; extern char Cyc_Stdio_FileCloseError[
...
_tagged_string s1, struct _tagged_string s2); extern char Cyc_Arg_Bad[ 8u];
struct Cyc_Arg_Bad_struct{ char* tag; struct _tagged_string f1; } ; extern char
Cyc_Arg_Error[ 10u]; static const int Cyc_Arg_Unit_spec= 0; struct Cyc_Arg_Unit_spec_struct{
...
_tagged_string errmsg, struct _tagged_ptr0 args); char Cyc_Arg_Bad[ 8u]="\000\000\000\000Bad";
char Cyc_Arg_Error[ 10u]="\000\000\000\000Error"; static const int Cyc_Arg_Unknown=
...
struct _tagged_string), prog_pos):( struct _tagged_string)({ char* _temp39=(
char*)"(?)"; struct _tagged_string _temp40; _temp40.curr= _temp39; _temp40.base=
_temp39; _temp40.last_plus_one= _temp39 + 4; _temp40;});{ void* _temp3= e;
struct _tagged_string _temp13; struct _tagged_string _temp15; struct
_tagged_string _temp17; struct _tagged_string _temp19; struct _tagged_string
_temp21; struct _tagged_string _temp23; _LL5: if(*(( int*) _temp3) == Cyc_Arg_Unknown){
_LL14: _temp13=( struct _tagged_string)(( struct Cyc_Arg_Unknown_struct*) _temp3)->f1;
goto _LL6;} else{ goto _LL7;} _LL7: if(*(( int*) _temp3) == Cyc_Arg_Missing){
_LL16: _temp15=( struct _tagged_string)(( struct Cyc_Arg_Missing_struct*) _temp3)->f1;
goto _LL8;} else{ goto _LL9;} _LL9: if(*(( int*) _temp3) == Cyc_Arg_Wrong){
_LL22: _temp21=( struct _tagged_string)(( struct Cyc_Arg_Wrong_struct*) _temp3)->f1;
goto _LL20; _LL20: _temp19=( struct _tagged_string)(( struct Cyc_Arg_Wrong_struct*)
_temp3)->f2; goto _LL18; _LL18: _temp17=( struct _tagged_string)(( struct Cyc_Arg_Wrong_struct*)
_temp3)->f3; goto _LL10;} else{ goto _LL11;} _LL11: if(*(( int*) _temp3) == Cyc_Arg_Message){
_LL24: _temp23=( struct _tagged_string)(( struct Cyc_Arg_Message_struct*) _temp3)->f1;
goto _LL12;} else{ goto _LL4;} _LL6: if( Cyc_String_strcmp( _temp13,( struct
_tagged_string)({ char* _temp25=( char*)"-help"; struct _tagged_string _temp26;
_temp26.curr= _temp25; _temp26.base= _temp25; _temp26.last_plus_one= _temp25 + 6;
_temp26;})) != 0){({ struct _tagged_string _temp27= progname; struct
_tagged_string _temp28= _temp13; fprintf( Cyc_Stdio_stderr,"%.*s: unknown option `%.*s'.\n",
...
_check_unknown_subscript)( s, sizeof( char), 0) =='-': 0){ void* action;{ struct
_handler_cons _temp42; _push_handler(& _temp42);{ int _temp44= 0; if( setjmp(
_temp42.handler)){ _temp44= 1;} if( ! _temp44){ action= Cyc_Arg_lookup( speclist,
s);; _pop_handler();} else{ void* _temp43=( void*) _exn_thrown; void* _temp46=
_temp43; _LL48: if( _temp46 == Cyc_Core_Not_found){ goto _LL49;} else{ goto
_LL50;} _LL50: goto _LL51; _LL49: Cyc_Arg_stop( initpos,( void*)({ struct Cyc_Arg_Unknown_struct*
_temp52=( struct Cyc_Arg_Unknown_struct*) GC_malloc( sizeof( struct Cyc_Arg_Unknown_struct));
_temp52[ 0]=({ struct Cyc_Arg_Unknown_struct _temp53; _temp53.tag= Cyc_Arg_Unknown;
_temp53.f1= s; _temp53;}); _temp52;}), speclist, errmsg); return; _LL51:( void)
_throw( _temp46); _LL47:;}}}{ struct _handler_cons _temp54; _push_handler(&
_temp54);{ int _temp56= 0; if( setjmp( _temp54.handler)){ _temp56= 1;} if( !
_temp56){{ void* _temp57= action; void(* _temp71)(); int* _temp73; int* _temp75;
void(* _temp77)( struct _tagged_string); void(* _temp79)( int); void(* _temp81)(
struct _tagged_string); _LL59: if(*(( int*) _temp57) == Cyc_Arg_Unit_spec){
_LL72: _temp71=( void(*)())(( struct Cyc_Arg_Unit_spec_struct*) _temp57)->f1;
goto _LL60;} else{ goto _LL61;} _LL61: if(*(( int*) _temp57) == Cyc_Arg_Set_spec){
_LL74: _temp73=( int*)(( struct Cyc_Arg_Set_spec_struct*) _temp57)->f1; goto
_LL62;} else{ goto _LL63;} _LL63: if(*(( int*) _temp57) == Cyc_Arg_Clear_spec){
_LL76: _temp75=( int*)(( struct Cyc_Arg_Clear_spec_struct*) _temp57)->f1; goto
_LL64;} else{ goto _LL65;} _LL65: if(*(( int*) _temp57) == Cyc_Arg_String_spec){
_LL78: _temp77=( void(*)( struct _tagged_string))(( struct Cyc_Arg_String_spec_struct*)
_temp57)->f1; goto _LL66;} else{ goto _LL67;} _LL67: if(*(( int*) _temp57) ==
Cyc_Arg_Int_spec){ _LL80: _temp79=( void(*)( int))(( struct Cyc_Arg_Int_spec_struct*)
_temp57)->f1; goto _LL68;} else{ goto _LL69;} _LL69: if(*(( int*) _temp57) ==
Cyc_Arg_Rest_spec){ _LL82: _temp81=( void(*)( struct _tagged_string))(( struct
Cyc_Arg_Rest_spec_struct*) _temp57)->f1; goto _LL70;} else{ goto _LL58;} _LL60:
_temp71(); goto _LL58; _LL62:* _temp73= 1; goto _LL58; _LL64:* _temp75= 0; goto
_LL58; _LL66: if( Cyc_Arg_current + 1 < l){ _temp77(*(( struct _tagged_string*(*)(
struct _tagged_ptr0, unsigned int, unsigned int)) _check_unknown_subscript)( Cyc_Arg_args,
sizeof( struct _tagged_string), Cyc_Arg_current + 1)); ++ Cyc_Arg_current;}
else{ Cyc_Arg_stop( initpos,( void*)({ struct Cyc_Arg_Missing_struct* _temp83=(
struct Cyc_Arg_Missing_struct*) GC_malloc( sizeof( struct Cyc_Arg_Missing_struct));
_temp83[ 0]=({ struct Cyc_Arg_Missing_struct _temp84; _temp84.tag= Cyc_Arg_Missing;
_temp84.f1= s; _temp84;}); _temp83;}), speclist, errmsg);} goto _LL58; _LL68: {
...
_temp87= 1;} if( ! _temp87){ n= Cyc_Core_int_of_string( arg);; _pop_handler();}
else{ void* _temp86=( void*) _exn_thrown; void* _temp89= _temp86; struct
_tagged_string _temp95; _LL91: if(*(( void**) _temp89) == Cyc_Core_InvalidArg){
_LL96: _temp95=( struct _tagged_string)(( struct Cyc_Core_InvalidArg_struct*)
_temp89)->f1; goto _LL92;} else{ goto _LL93;} _LL93: goto _LL94; _LL92: Cyc_Arg_stop(
initpos,( void*)({ struct Cyc_Arg_Wrong_struct* _temp97=( struct Cyc_Arg_Wrong_struct*)
GC_malloc( sizeof( struct Cyc_Arg_Wrong_struct)); _temp97[ 0]=({ struct Cyc_Arg_Wrong_struct
_temp98; _temp98.tag= Cyc_Arg_Wrong; _temp98.f1= s; _temp98.f2= arg; _temp98.f3=(
struct _tagged_string)({ char* _temp99=( char*)"an integer"; struct
_tagged_string _temp100; _temp100.curr= _temp99; _temp100.base= _temp99;
_temp100.last_plus_one= _temp99 + 11; _temp100;}); _temp98;}); _temp97;}),
speclist, errmsg); _npop_handler( 0u); return; _LL94:( void) _throw( _temp89);
_LL90:;}}} _temp79( n); ++ Cyc_Arg_current; goto _LL58;} _LL70: while( Cyc_Arg_current
< l - 1) { _temp81(*(( struct _tagged_string*(*)( struct _tagged_ptr0,
unsigned int, unsigned int)) _check_unknown_subscript)( Cyc_Arg_args, sizeof(
struct _tagged_string), Cyc_Arg_current + 1)); ++ Cyc_Arg_current;} goto _LL58;
_LL58:;}; _pop_handler();} else{ void* _temp55=( void*) _exn_thrown; void*
_temp102= _temp55; struct _tagged_string _temp108; _LL104: if(*(( void**)
_temp102) == Cyc_Arg_Bad){ _LL109: _temp108=( struct _tagged_string)(( struct
Cyc_Arg_Bad_struct*) _temp102)->f1; goto _LL105;} else{ goto _LL106;} _LL106:
goto _LL107; _LL105: Cyc_Arg_stop( initpos,( void*)({ struct Cyc_Arg_Message_struct*
_temp110=( struct Cyc_Arg_Message_struct*) GC_malloc( sizeof( struct Cyc_Arg_Message_struct));
...
_LL123: _temp122=( struct _tagged_string)(( struct Cyc_Arg_Bad_struct*) _temp116)->f1;
goto _LL119;} else{ goto _LL120;} _LL120: goto _LL121; _LL119: Cyc_Arg_stop(
initpos,( void*)({ struct Cyc_Arg_Message_struct* _temp124=( struct Cyc_Arg_Message_struct*)
