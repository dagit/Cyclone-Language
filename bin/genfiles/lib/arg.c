...
struct _tagged_string), prog_pos):({ char* _temp39="(?)"; struct _tagged_string
_temp40; _temp40.curr= _temp39; _temp40.base= _temp39; _temp40.last_plus_one=
...
else{ goto _LL4;} _LL6: if( Cyc_String_strcmp( _temp13,({ char* _temp25="-help";
...
_LL72: _temp71=(( struct Cyc_Arg_Unit_spec_struct*) _temp57)->f1; goto _LL60;}
else{ goto _LL61;} _LL61: if(*(( int*) _temp57) == Cyc_Arg_Set_spec){ _LL74:
_temp73=(( struct Cyc_Arg_Set_spec_struct*) _temp57)->f1; goto _LL62;} else{
goto _LL63;} _LL63: if(*(( int*) _temp57) == Cyc_Arg_Clear_spec){ _LL76: _temp75=((
struct Cyc_Arg_Clear_spec_struct*) _temp57)->f1; goto _LL64;} else{ goto _LL65;}
_LL65: if(*(( int*) _temp57) == Cyc_Arg_String_spec){ _LL78: _temp77=(( struct
Cyc_Arg_String_spec_struct*) _temp57)->f1; goto _LL66;} else{ goto _LL67;} _LL67:
if(*(( int*) _temp57) == Cyc_Arg_Int_spec){ _LL80: _temp79=(( struct Cyc_Arg_Int_spec_struct*)
_temp57)->f1; goto _LL68;} else{ goto _LL69;} _LL69: if(*(( int*) _temp57) ==
Cyc_Arg_Rest_spec){ _LL82: _temp81=(( struct Cyc_Arg_Rest_spec_struct*) _temp57)->f1;
goto _LL70;} else{ goto _LL58;} _LL60: _temp71(); goto _LL58; _LL62:* _temp73= 1;
goto _LL58; _LL64:* _temp75= 0; goto _LL58; _LL66: if( Cyc_Arg_current + 1 < l){
_temp77(*(( struct _tagged_string*(*)( struct _tagged_ptr0, unsigned int,
unsigned int)) _check_unknown_subscript)( Cyc_Arg_args, sizeof( struct
_tagged_string), Cyc_Arg_current + 1)); ++ Cyc_Arg_current;} else{ Cyc_Arg_stop(
...
char* _temp99="an integer"; struct _tagged_string _temp100; _temp100.curr=
