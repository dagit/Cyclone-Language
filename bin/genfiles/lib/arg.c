...
_tagged_string errmsg, struct _tagged_ptr0 args); char Cyc_Arg_Bad[ 8u]; char
Cyc_Arg_Error[ 10u]; static const int Cyc_Arg_Unknown= 0; struct Cyc_Arg_Unknown_struct{
