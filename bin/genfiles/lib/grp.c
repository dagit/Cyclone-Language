...
struct Cyc_Grp_group* Cyc_Grp_getgrgid( unsigned short uid); extern int Cyc_Grp_initgroups(
...
Cyc_Grp_group* Cyc_Grp_getgrnam( struct _tagged_arr name){ struct Cyc_Cgrp_Cgroup*
src= getgrnam( string_to_Cstring( name)); return( unsigned int) src?({ struct
Cyc_Grp_group* _temp0=( struct Cyc_Grp_group*) GC_malloc( sizeof( struct Cyc_Grp_group));
...
0;} struct Cyc_Grp_group* Cyc_Grp_getgrgid( unsigned short gid){ struct Cyc_Cgrp_Cgroup*
