...
unsigned int) _temp1 > 1u?(( struct _tunion_struct*) _temp1)->tag == Cyc_Splay_Node:
0){ _LL8: _temp7=( struct Cyc_Splay_noderef*)(( struct Cyc_Splay_Node_struct*)
...
== Cyc_Splay_Node: 0){ _LL16: _temp15=( struct Cyc_Splay_noderef*)(( struct Cyc_Splay_Node_struct*)
...
_temp23; _LL19: if(( unsigned int) _temp17 > 1u?(( struct _tunion_struct*)
_temp17)->tag == Cyc_Splay_Node: 0){ _LL24: _temp23=( struct Cyc_Splay_noderef*)((
struct Cyc_Splay_Node_struct*) _temp17)->f1; goto _LL20;} else{ goto _LL21;}
_LL21: if( _temp17 ==( void*) Cyc_Splay_Leaf){ goto _LL22;} else{ goto _LL18;}
_LL20: { struct Cyc_Splay_node* n= _temp23->v; if(( d->reln)( key,( void*) n->key)
< 0){ newleft=( void*) n->left; newright=( void*)({ struct Cyc_Splay_Node_struct*
_temp25=( struct Cyc_Splay_Node_struct*) GC_malloc( sizeof( struct Cyc_Splay_Node_struct));
_temp25[ 0]=({ struct Cyc_Splay_Node_struct _temp26; _temp26.tag= Cyc_Splay_Node;
_temp26.f1=({ struct Cyc_Splay_noderef* _temp27=( struct Cyc_Splay_noderef*)
GC_malloc( sizeof( struct Cyc_Splay_noderef)); _temp27->v=({ struct Cyc_Splay_node*
_temp28=( struct Cyc_Splay_node*) GC_malloc( sizeof( struct Cyc_Splay_node));
_temp28->key=( void*)(( void*) n->key); _temp28->data=( void*)(( void*) n->data);
_temp28->left=( void*)(( void*) Cyc_Splay_Leaf); _temp28->right=( void*)(( void*)
n->right); _temp28;}); _temp27;}); _temp26;}); _temp25;});} else{ newleft=( void*)({
struct Cyc_Splay_Node_struct* _temp29=( struct Cyc_Splay_Node_struct*) GC_malloc(
sizeof( struct Cyc_Splay_Node_struct)); _temp29[ 0]=({ struct Cyc_Splay_Node_struct
_temp30; _temp30.tag= Cyc_Splay_Node; _temp30.f1=({ struct Cyc_Splay_noderef*
_temp31=( struct Cyc_Splay_noderef*) GC_malloc( sizeof( struct Cyc_Splay_noderef));
_temp31->v=({ struct Cyc_Splay_node* _temp32=( struct Cyc_Splay_node*) GC_malloc(
sizeof( struct Cyc_Splay_node)); _temp32->key=( void*)(( void*) n->key); _temp32->data=(
void*)(( void*) n->data); _temp32->left=( void*)(( void*) n->left); _temp32->right=(
void*)(( void*) Cyc_Splay_Leaf); _temp32;}); _temp31;}); _temp30;}); _temp29;});
newright=( void*) n->right;} goto _LL18;} _LL22: goto _LL18; _LL18:;} return({
struct Cyc_SlowDict_Dict* _temp33=( struct Cyc_SlowDict_Dict*) GC_malloc(
sizeof( struct Cyc_SlowDict_Dict)); _temp33->reln= d->reln; _temp33->tree=( void*)((
void*)({ struct Cyc_Splay_Node_struct* _temp34=( struct Cyc_Splay_Node_struct*)
GC_malloc( sizeof( struct Cyc_Splay_Node_struct)); _temp34[ 0]=({ struct Cyc_Splay_Node_struct
_temp35; _temp35.tag= Cyc_Splay_Node; _temp35.f1=({ struct Cyc_Splay_noderef*
_temp36=( struct Cyc_Splay_noderef*) GC_malloc( sizeof( struct Cyc_Splay_noderef));
_temp36->v=({ struct Cyc_Splay_node* _temp37=( struct Cyc_Splay_node*) GC_malloc(
sizeof( struct Cyc_Splay_node)); _temp37->key=( void*) key; _temp37->data=( void*)
data; _temp37->left=( void*) newleft; _temp37->right=( void*) newright; _temp37;});
_temp36;}); _temp35;}); _temp34;})); _temp33;});} struct Cyc_SlowDict_Dict* Cyc_SlowDict_insert_new(
...
== Cyc_Splay_Node: 0){ _LL53: _temp52=( struct Cyc_Splay_noderef*)(( struct Cyc_Splay_Node_struct*)
...
_temp64; _LL60: if(( unsigned int) _temp58 > 1u?(( struct _tunion_struct*)
_temp58)->tag == Cyc_Splay_Node: 0){ _LL65: _temp64=( struct Cyc_Splay_noderef*)((
struct Cyc_Splay_Node_struct*) _temp58)->f1; goto _LL61;} else{ goto _LL62;}
_LL62: if( _temp58 ==( void*) Cyc_Splay_Leaf){ goto _LL63;} else{ goto _LL59;}
_LL61: return({ struct Cyc_Core_Opt* _temp66=( struct Cyc_Core_Opt*) GC_malloc(
sizeof( struct Cyc_Core_Opt)); _temp66->v=( void*)(( void*)( _temp64->v)->data);
_temp66;}); _LL63:( void) _throw(( void*)({ struct Cyc_Core_Impossible_struct*
_temp67=( struct Cyc_Core_Impossible_struct*) GC_malloc( sizeof( struct Cyc_Core_Impossible_struct));
_temp67[ 0]=({ struct Cyc_Core_Impossible_struct _temp68; _temp68.tag= Cyc_Core_Impossible;
...
_temp70.last_plus_one= _temp69 + 13; _temp70;}); _temp68;}); _temp67;})); _LL59:;}
...
key,( void*) d->tree)){ void* _temp71=( void*) d->tree; struct Cyc_Splay_noderef*
_temp77; _LL73: if( _temp71 ==( void*) Cyc_Splay_Leaf){ goto _LL74;} else{ goto
_LL75;} _LL75: if(( unsigned int) _temp71 > 1u?(( struct _tunion_struct*)
_temp71)->tag == Cyc_Splay_Node: 0){ _LL78: _temp77=( struct Cyc_Splay_noderef*)((
struct Cyc_Splay_Node_struct*) _temp71)->f1; goto _LL76;} else{ goto _LL72;}
_LL74:( void) _throw(( void*)({ struct Cyc_Core_Impossible_struct* _temp79=(
...
_LL87;} _LL87: if(( unsigned int) _temp83 > 1u?(( struct _tunion_struct*)
_temp83)->tag == Cyc_Splay_Node: 0){ _LL90: _temp89=( struct Cyc_Splay_noderef*)((
struct Cyc_Splay_Node_struct*) _temp83)->f1; goto _LL88;} else{ goto _LL84;}
_LL86: return({ struct Cyc_SlowDict_Dict* _temp91=( struct Cyc_SlowDict_Dict*)
GC_malloc( sizeof( struct Cyc_SlowDict_Dict)); _temp91->reln= d->reln; _temp91->tree=(
void*)(( void*) n->right); _temp91;}); _LL88: { void* _temp92=( void*) n->right;
struct Cyc_Splay_noderef* _temp98; _LL94: if( _temp92 ==( void*) Cyc_Splay_Leaf){
goto _LL95;} else{ goto _LL96;} _LL96: if(( unsigned int) _temp92 > 1u?(( struct
_tunion_struct*) _temp92)->tag == Cyc_Splay_Node: 0){ _LL99: _temp98=( struct
Cyc_Splay_noderef*)(( struct Cyc_Splay_Node_struct*) _temp92)->f1; goto _LL97;}
else{ goto _LL93;} _LL95: return({ struct Cyc_SlowDict_Dict* _temp100=( struct
Cyc_SlowDict_Dict*) GC_malloc( sizeof( struct Cyc_SlowDict_Dict)); _temp100->reln=
d->reln; _temp100->tree=( void*)(( void*) n->left); _temp100;}); _LL97:(( int(*)(
...
if(( unsigned int) _temp106 > 1u?(( struct _tunion_struct*) _temp106)->tag ==
Cyc_Splay_Node: 0){ _LL113: _temp112=( struct Cyc_Splay_noderef*)(( struct Cyc_Splay_Node_struct*)
...
_temp114 > 1u?(( struct _tunion_struct*) _temp114)->tag == Cyc_Splay_Node: 0){
_LL121: _temp120=( struct Cyc_Splay_noderef*)(( struct Cyc_Splay_Node_struct*)
_temp114)->f1; goto _LL119;} else{ goto _LL115;} _LL117: return accum; _LL119: {
struct Cyc_Splay_node* n= _temp120->v; return f( env,( void*) n->key,( void*) n->data,((
...
f, env,( void*) n->right, accum)));} _LL115:;} void* Cyc_SlowDict_fold_c( void*(*
...
void*) Cyc_Splay_Leaf){ goto _LL125;} else{ goto _LL126;} _LL126: if((
unsigned int) _temp122 > 1u?(( struct _tunion_struct*) _temp122)->tag == Cyc_Splay_Node:
0){ _LL129: _temp128=( struct Cyc_Splay_noderef*)(( struct Cyc_Splay_Node_struct*)
...
goto _LL134;} _LL134: if(( unsigned int) _temp130 > 1u?(( struct _tunion_struct*)
_temp130)->tag == Cyc_Splay_Node: 0){ _LL137: _temp136=( struct Cyc_Splay_noderef*)((
struct Cyc_Splay_Node_struct*) _temp130)->f1; goto _LL135;} else{ goto _LL131;}
_LL133: goto _LL131; _LL135: { struct Cyc_Splay_node* n= _temp136->v;(( void(*)(
void(* f)( void*, void*), void* t)) Cyc_SlowDict_iter_tree)( f,( void*) n->left);
f(( void*) n->key,( void*) n->data);(( void(*)( void(* f)( void*, void*), void*
t)) Cyc_SlowDict_iter_tree)( f,( void*) n->right); goto _LL131;} _LL131:;} void
Cyc_SlowDict_iter( void(* f)( void*, void*), struct Cyc_SlowDict_Dict* d){((
...
_LL140: if( _temp138 ==( void*) Cyc_Splay_Leaf){ goto _LL141;} else{ goto _LL142;}
_LL142: if(( unsigned int) _temp138 > 1u?(( struct _tunion_struct*) _temp138)->tag
== Cyc_Splay_Node: 0){ _LL145: _temp144=( struct Cyc_Splay_noderef*)(( struct
Cyc_Splay_Node_struct*) _temp138)->f1; goto _LL143;} else{ goto _LL139;} _LL141:
goto _LL139; _LL143: { struct Cyc_Splay_node* n= _temp144->v;(( void(*)( void*(*
f)( void*, void*, void*), void* env, void* t)) Cyc_SlowDict_app_tree_c)( f, env,(
void*) n->left); f( env,( void*) n->key,( void*) n->data);(( void(*)( void*(* f)(
void*, void*, void*), void* env, void* t)) Cyc_SlowDict_app_tree_c)( f, env,(
void*) n->right); goto _LL139;} _LL139:;} void Cyc_SlowDict_app_c( void*(* f)(
void*, void*, void*), void* env, struct Cyc_SlowDict_Dict* d){(( void(*)( void*(*
f)( void*, void*, void*), void* env, void* t)) Cyc_SlowDict_app_tree_c)( f, env,(
void*) d->tree);} static void Cyc_SlowDict_iter_tree_c( void(* f)( void*, void*,
void*), void* env, void* t){ void* _temp146= t; struct Cyc_Splay_noderef*
_temp152; _LL148: if( _temp146 ==( void*) Cyc_Splay_Leaf){ goto _LL149;} else{
goto _LL150;} _LL150: if(( unsigned int) _temp146 > 1u?(( struct _tunion_struct*)
_temp146)->tag == Cyc_Splay_Node: 0){ _LL153: _temp152=( struct Cyc_Splay_noderef*)((
struct Cyc_Splay_Node_struct*) _temp146)->f1; goto _LL151;} else{ goto _LL147;}
_LL149: goto _LL147; _LL151: { struct Cyc_Splay_node* n= _temp152->v;(( void(*)(
void(* f)( void*, void*, void*), void* env, void* t)) Cyc_SlowDict_iter_tree_c)(
f, env,( void*) n->left); f( env,( void*) n->key,( void*) n->data);(( void(*)(
void(* f)( void*, void*, void*), void* env, void* t)) Cyc_SlowDict_iter_tree_c)(
f, env,( void*) n->right); goto _LL147;} _LL147:;} void Cyc_SlowDict_iter_c(
...
void* t){ void* _temp154= t; struct Cyc_Splay_noderef* _temp160; _LL156: if(
_temp154 ==( void*) Cyc_Splay_Leaf){ goto _LL157;} else{ goto _LL158;} _LL158:
if(( unsigned int) _temp154 > 1u?(( struct _tunion_struct*) _temp154)->tag ==
Cyc_Splay_Node: 0){ _LL161: _temp160=( struct Cyc_Splay_noderef*)(( struct Cyc_Splay_Node_struct*)
_temp154)->f1; goto _LL159;} else{ goto _LL155;} _LL157: return( void*) Cyc_Splay_Leaf;
_LL159: { struct Cyc_Splay_node* n= _temp160->v; return( void*)({ struct Cyc_Splay_Node_struct*
_temp162=( struct Cyc_Splay_Node_struct*) GC_malloc( sizeof( struct Cyc_Splay_Node_struct));
...
_temp167 > 1u?(( struct _tunion_struct*) _temp167)->tag == Cyc_Splay_Node: 0){
_LL174: _temp173=( struct Cyc_Splay_noderef*)(( struct Cyc_Splay_Node_struct*)
_temp167)->f1; goto _LL172;} else{ goto _LL168;} _LL170: return( void*) Cyc_Splay_Leaf;
_LL172: { struct Cyc_Splay_node* n= _temp173->v; return( void*)({ struct Cyc_Splay_Node_struct*
...
if(( unsigned int) _temp180 > 1u?(( struct _tunion_struct*) _temp180)->tag ==
Cyc_Splay_Node: 0){ _LL187: _temp186=( struct Cyc_Splay_noderef*)(( struct Cyc_Splay_Node_struct*)
