...
({void*_tmp51=0U;({unsigned _tmpCE=s->loc;struct _dyneither_ptr _tmpCD=({const char*_tmp52="repated label";_tag_dyneither(_tmp52,sizeof(char),14U);});Cyc_Warn_err(_tmpCE,_tmpCD,_tag_dyneither(_tmp51,sizeof(void*),0U));});});
# 249
...
# 344
({void*_tmp86=0U;({unsigned _tmpD5=_tmpA7->loc;struct _dyneither_ptr _tmpD4=({const char*_tmp87="jump has no target";_tag_dyneither(_tmp87,sizeof(char),19U);});Cyc_Warn_err(_tmpD5,_tmpD4,_tag_dyneither(_tmp86,sizeof(void*),0U));});});
goto _LL6;case 1U: _LL9: _LLA:
# 347
({void*_tmp88=0U;({unsigned _tmpD7=_tmpA7->loc;struct _dyneither_ptr _tmpD6=({const char*_tmp89="break causes outer switch to implicitly fallthru";_tag_dyneither(_tmp89,sizeof(char),49U);});Cyc_Warn_err(_tmpD7,_tmpD6,_tag_dyneither(_tmp88,sizeof(void*),0U));});});
# 349
...
# 362
({struct Cyc_String_pa_PrintArg_struct _tmp90=({struct Cyc_String_pa_PrintArg_struct _tmpB0;_tmpB0.tag=0U,_tmpB0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmpA0);_tmpB0;});void*_tmp8E[1U];_tmp8E[0]=& _tmp90;({unsigned _tmpD9=_tmpA7->loc;struct _dyneither_ptr _tmpD8=({const char*_tmp8F="label %s undefined";_tag_dyneither(_tmp8F,sizeof(char),19U);});Cyc_Warn_err(_tmpD9,_tmpD8,_tag_dyneither(_tmp8E,sizeof(void*),1U));});});
...
break;}
if(_tmpA3 == 0){
({void*_tmp95=0U;({unsigned _tmpDB=_tmpA7->loc;struct _dyneither_ptr _tmpDA=({const char*_tmp96="goto enters local scope or exception handler";_tag_dyneither(_tmp96,sizeof(char),45U);});Cyc_Warn_err(_tmpDB,_tmpDA,_tag_dyneither(_tmp95,sizeof(void*),0U));});});
# 375
goto _LL6;}}
# 378
