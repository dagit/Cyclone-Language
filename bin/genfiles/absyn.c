...
void*_tmp181=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55->tag=1U,({void*_tmp180=(void*)({struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp54=_cycalloc(sizeof(*_tmp54));_tmp54->tag=1U,({struct Cyc_Absyn_Vardecl*_tmp17F=({struct Cyc_Absyn_Vardecl*_tmp53=_cycalloc(sizeof(*_tmp53));_tmp53->sc=Cyc_Absyn_Extern,({struct _tuple0*_tmp17E=Cyc_Absyn_uniquergn_qvar();_tmp53->name=_tmp17E;}),_tmp53->varloc=0U,({
struct Cyc_Absyn_Tqual _tmp17D=Cyc_Absyn_empty_tqual(0U);_tmp53->tq=_tmp17D;}),_tmp53->type=t,_tmp53->initializer=0,_tmp53->rgn=0,_tmp53->attributes=0,_tmp53->escapes=0;_tmp53;});
# 389
...
struct Cyc_Absyn_Tqual _tmp1E2=Cyc_Absyn_empty_tqual(0U);_tmpA5->tq=_tmp1E2;}),_tmpA5->type=t,_tmpA5->initializer=init,_tmpA5->rgn=0,_tmpA5->attributes=0,_tmpA5->escapes=0;_tmpA5;});}
# 740
struct Cyc_Absyn_Vardecl*Cyc_Absyn_static_vardecl(struct _tuple0*x,void*t,struct Cyc_Absyn_Exp*init){
return({struct Cyc_Absyn_Vardecl*_tmpA6=_cycalloc(sizeof(*_tmpA6));_tmpA6->sc=Cyc_Absyn_Static,_tmpA6->name=x,_tmpA6->varloc=0U,({struct Cyc_Absyn_Tqual _tmp1E3=Cyc_Absyn_empty_tqual(0U);_tmpA6->tq=_tmp1E3;}),_tmpA6->type=t,_tmpA6->initializer=init,_tmpA6->rgn=0,_tmpA6->attributes=0,_tmpA6->escapes=0;_tmpA6;});}
# 745
