...
# 799
struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct _tmp352;struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*_tmp351;return Cyc_Absyn_new_decl((void*)((_tmp351=_cycalloc(sizeof(*_tmp351)),((_tmp351[0]=((_tmp352.tag=4,((_tmp352.f1=tv,((_tmp352.f2=vd,((_tmp352.f3=resetable,((_tmp352.f4=open_exp,_tmp352)))))))))),_tmp351)))),loc);}
# 801
...
# 885
Cyc_Absyn_pointer_expand(ret_typ,0),((_tmp384.effect=eff_typ,((_tmp384.args=args,((_tmp384.c_varargs=c_varargs,((_tmp384.cyc_varargs=cyc_varargs,((_tmp384.rgn_po=rgn_po,((_tmp384.attributes=atts,((_tmp384.requires_clause=req,((_tmp384.requires_relns=0,((_tmp384.ensures_clause=ens,((_tmp384.ensures_relns=0,_tmp384)))))))))))))))))))))))))),_tmp385)))),_tmp383))));};}
# 899
