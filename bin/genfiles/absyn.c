...
if(i != 0)return i;{
struct _tuple11 _tmp6=({struct _tuple11 _tmp12B;_tmp12B.f1=n1,_tmp12B.f2=n2;_tmp12B;});struct _tuple11 _stmttmp0=_tmp6;struct _tuple11 _tmp7=_stmttmp0;struct Cyc_List_List*_tmp9;struct Cyc_List_List*_tmp8;struct Cyc_List_List*_tmpB;struct Cyc_List_List*_tmpA;struct Cyc_List_List*_tmpD;struct Cyc_List_List*_tmpC;switch(((_tmp7.f1).Abs_n).tag){case 4U: if(((_tmp7.f2).Loc_n).tag == 4){_LL7: _LL8:
...
unsigned _tmp14C=Cyc_Position_segment_join(x.loc,y.loc);_tmp131.loc=_tmp14C;});_tmp131;});}
# 117
...
# 150
({void*_tmp14D=Cyc_Absyn_compress_kb(*k2);*k2=_tmp14D;});
return*k2;}}}_LL0:;}
# 154
...
# 159
({struct Cyc_Core_Opt*_tmp14F=({struct Cyc_Core_Opt*_tmp1A=_cycalloc(sizeof(*_tmp1A));({void*_tmp14E=Cyc_Tcutil_kind_to_bound(k);_tmp1A->v=_tmp14E;});_tmp1A;});*f=_tmp14F;});
return k;}}_LL0:;}
# 165
void*Cyc_Absyn_app_type(void*c,struct _fat_ptr args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp1B=_cycalloc(sizeof(*_tmp1B));_tmp1B->tag=0U,_tmp1B->f1=c,({struct Cyc_List_List*_tmp150=((struct Cyc_List_List*(*)(struct _fat_ptr arr))Cyc_List_from_array)(args);_tmp1B->f2=_tmp150;});_tmp1B;});}
# 168
...
return({void*_tmp23=0U;({void*_tmp151=(void*)({struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*_tmp24=_cycalloc(sizeof(*_tmp24));_tmp24->tag=15U,_tmp24->f1=n,_tmp24->f2=d;_tmp24;});Cyc_Absyn_app_type(_tmp151,_tag_fat(_tmp23,sizeof(void*),0U));});});}
# 228
void*Cyc_Absyn_anon_enum_type(struct Cyc_List_List*fs){
return({void*_tmp25=0U;({void*_tmp152=(void*)({struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*_tmp26=_cycalloc(sizeof(*_tmp26));_tmp26->tag=16U,_tmp26->f1=fs;_tmp26;});Cyc_Absyn_app_type(_tmp152,_tag_fat(_tmp25,sizeof(void*),0U));});});}
# 231
void*Cyc_Absyn_builtin_type(struct _fat_ptr s,struct Cyc_Absyn_Kind*k){
return({void*_tmp27=0U;({void*_tmp153=(void*)({struct Cyc_Absyn_BuiltinCon_Absyn_TyCon_struct*_tmp28=_cycalloc(sizeof(*_tmp28));_tmp28->tag=17U,_tmp28->f1=s,_tmp28->f2=k;_tmp28;});Cyc_Absyn_app_type(_tmp153,_tag_fat(_tmp27,sizeof(void*),0U));});});}
# 234
void*Cyc_Absyn_datatype_type(union Cyc_Absyn_DatatypeInfo di,struct Cyc_List_List*args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp2A=_cycalloc(sizeof(*_tmp2A));_tmp2A->tag=0U,({void*_tmp154=(void*)({struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*_tmp29=_cycalloc(sizeof(*_tmp29));_tmp29->tag=18U,_tmp29->f1=di;_tmp29;});_tmp2A->f1=_tmp154;}),_tmp2A->f2=args;_tmp2A;});}
# 237
void*Cyc_Absyn_datatype_field_type(union Cyc_Absyn_DatatypeFieldInfo di,struct Cyc_List_List*args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp2C=_cycalloc(sizeof(*_tmp2C));_tmp2C->tag=0U,({void*_tmp155=(void*)({struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*_tmp2B=_cycalloc(sizeof(*_tmp2B));_tmp2B->tag=19U,_tmp2B->f1=di;_tmp2B;});_tmp2C->f1=_tmp155;}),_tmp2C->f2=args;_tmp2C;});}
# 240
void*Cyc_Absyn_aggr_type(union Cyc_Absyn_AggrInfo ai,struct Cyc_List_List*args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp2E=_cycalloc(sizeof(*_tmp2E));_tmp2E->tag=0U,({void*_tmp156=(void*)({struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_tmp2D=_cycalloc(sizeof(*_tmp2D));_tmp2D->tag=20U,_tmp2D->f1=ai;_tmp2D;});_tmp2E->f1=_tmp156;}),_tmp2E->f2=args;_tmp2E;});}
# 244
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp32=({struct Cyc_Warn_String_Warn_Warg_struct _tmp13A;_tmp13A.tag=0U,({struct _fat_ptr _tmp157=({const char*_tmp36="gen_float_type(";_tag_fat(_tmp36,sizeof(char),16U);});_tmp13A.f1=_tmp157;});_tmp13A;});struct Cyc_Warn_Int_Warn_Warg_struct _tmp33=({struct Cyc_Warn_Int_Warn_Warg_struct _tmp139;_tmp139.tag=12U,_tmp139.f1=(int)i;_tmp139;});struct Cyc_Warn_String_Warn_Warg_struct _tmp34=({struct Cyc_Warn_String_Warn_Warg_struct _tmp138;_tmp138.tag=0U,({struct _fat_ptr _tmp158=({const char*_tmp35=")";_tag_fat(_tmp35,sizeof(char),2U);});_tmp138.f1=_tmp158;});_tmp138;});void*_tmp31[3U];_tmp31[0]=& _tmp32,_tmp31[1]=& _tmp33,_tmp31[2]=& _tmp34;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp31,sizeof(void*),3U));});}_LL0:;}
# 253
...
tufs=({struct Cyc_List_List*_tmp41=_cycalloc(sizeof(*_tmp41));({struct Cyc_Absyn_Datatypefield*_tmp15B=({struct Cyc_Absyn_Datatypefield*_tmp40=_cycalloc(sizeof(*_tmp40));({struct _tuple0*_tmp15A=({struct _tuple0*_tmp3F=_cycalloc(sizeof(*_tmp3F));((_tmp3F->f1).Abs_n).tag=2U,((_tmp3F->f1).Abs_n).val=0,({
struct _fat_ptr*_tmp159=({struct _fat_ptr*_tmp3E=_cycalloc(sizeof(*_tmp3E));*_tmp3E=*((struct _fat_ptr*)_check_known_subscript_notnull(builtin_exns,4U,sizeof(struct _fat_ptr),i));_tmp3E;});_tmp3F->f2=_tmp159;});_tmp3F;});
# 341
_tmp40->name=_tmp15A;}),_tmp40->typs=0,_tmp40->loc=0U,_tmp40->sc=Cyc_Absyn_Extern;_tmp40;});_tmp41->hd=_tmp15B;}),_tmp41->tl=tufs;_tmp41;});}}
# 345
tud_opt=({struct Cyc_Absyn_Datatypedecl*_tmp43=_cycalloc(sizeof(*_tmp43));_tmp43->sc=Cyc_Absyn_Extern,_tmp43->name=Cyc_Absyn_exn_name,_tmp43->tvs=0,({struct Cyc_Core_Opt*_tmp15C=({struct Cyc_Core_Opt*_tmp42=_cycalloc(sizeof(*_tmp42));_tmp42->v=tufs;_tmp42;});_tmp43->fields=_tmp15C;}),_tmp43->is_extensible=1;_tmp43;});}
# 347
...
static void*eopt=0;
if(exn_typ == 0){
eopt=Cyc_Absyn_datatype_type(({union Cyc_Absyn_DatatypeInfo _tmp13B;(_tmp13B.KnownDatatype).tag=2U,({struct Cyc_Absyn_Datatypedecl**_tmp15E=({struct Cyc_Absyn_Datatypedecl**_tmp48=_cycalloc(sizeof(*_tmp48));({struct Cyc_Absyn_Datatypedecl*_tmp15D=Cyc_Absyn_exn_tud();*_tmp48=_tmp15D;});_tmp48;});(_tmp13B.KnownDatatype).val=_tmp15E;});_tmp13B;}),0);
exn_typ=({void*_tmp161=(void*)_check_null(eopt);void*_tmp160=Cyc_Absyn_heap_rgn_type;struct Cyc_Absyn_Tqual _tmp15F=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp161,_tmp160,_tmp15F,Cyc_Absyn_false_type);});}
# 357
...
if(q == 0)
q=({struct _tuple0*_tmp4B=_cycalloc(sizeof(*_tmp4B));({union Cyc_Absyn_Nmspace _tmp164=Cyc_Absyn_Abs_n(0,0);_tmp4B->f1=_tmp164;}),({struct _fat_ptr*_tmp163=({struct _fat_ptr*_tmp4A=_cycalloc(sizeof(*_tmp4A));({struct _fat_ptr _tmp162=({const char*_tmp49="PrintArg";_tag_fat(_tmp49,sizeof(char),9U);});*_tmp4A=_tmp162;});_tmp4A;});_tmp4B->f2=_tmp163;});_tmp4B;});
return(struct _tuple0*)_check_null(q);}
# 366
struct _tuple0*Cyc_Absyn_datatype_scanf_arg_qvar (void){
static struct _tuple0*q=0;
if(q == 0)
q=({struct _tuple0*_tmp4E=_cycalloc(sizeof(*_tmp4E));({union Cyc_Absyn_Nmspace _tmp167=Cyc_Absyn_Abs_n(0,0);_tmp4E->f1=_tmp167;}),({struct _fat_ptr*_tmp166=({struct _fat_ptr*_tmp4D=_cycalloc(sizeof(*_tmp4D));({struct _fat_ptr _tmp165=({const char*_tmp4C="ScanfArg";_tag_fat(_tmp4C,sizeof(char),9U);});*_tmp4D=_tmp165;});_tmp4D;});_tmp4E->f2=_tmp166;});_tmp4E;});
return(struct _tuple0*)_check_null(q);}
# 378
struct _tuple0*Cyc_Absyn_uniquergn_qvar (void){
static struct _tuple0*q=0;
if(q == 0)
q=({struct _tuple0*_tmp54=_cycalloc(sizeof(*_tmp54));({union Cyc_Absyn_Nmspace _tmp16C=Cyc_Absyn_Abs_n(({struct Cyc_List_List*_tmp51=_cycalloc(sizeof(*_tmp51));({struct _fat_ptr*_tmp16B=({struct _fat_ptr*_tmp50=_cycalloc(sizeof(*_tmp50));({struct _fat_ptr _tmp16A=({const char*_tmp4F="Core";_tag_fat(_tmp4F,sizeof(char),5U);});*_tmp50=_tmp16A;});_tmp50;});_tmp51->hd=_tmp16B;}),_tmp51->tl=0;_tmp51;}),0);_tmp54->f1=_tmp16C;}),({struct _fat_ptr*_tmp169=({struct _fat_ptr*_tmp53=_cycalloc(sizeof(*_tmp53));({struct _fat_ptr _tmp168=({const char*_tmp52="unique_region";_tag_fat(_tmp52,sizeof(char),14U);});*_tmp53=_tmp168;});_tmp53;});_tmp54->f2=_tmp169;});_tmp54;});
return(struct _tuple0*)_check_null(q);}
# 384
...
void*_tmp171=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp58=_cycalloc(sizeof(*_tmp58));_tmp58->tag=1U,({void*_tmp170=(void*)({struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp57=_cycalloc(sizeof(*_tmp57));_tmp57->tag=1U,({struct Cyc_Absyn_Vardecl*_tmp16F=({struct Cyc_Absyn_Vardecl*_tmp56=_cycalloc(sizeof(*_tmp56));_tmp56->sc=Cyc_Absyn_Extern,({
struct _tuple0*_tmp16E=Cyc_Absyn_uniquergn_qvar();_tmp56->name=_tmp16E;}),_tmp56->varloc=0U,({
struct Cyc_Absyn_Tqual _tmp16D=Cyc_Absyn_empty_tqual(0U);_tmp56->tq=_tmp16D;}),_tmp56->type=t,_tmp56->initializer=0,_tmp56->rgn=0,_tmp56->attributes=0,_tmp56->escapes=0,_tmp56->is_proto=0;_tmp56;});
# 388
_tmp57->f1=_tmp16F;});_tmp57;});_tmp58->f1=_tmp170;});_tmp58;});_tmp59->r=_tmp171;});_tmp59;});}
# 396
...
return Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp13C;_tmp13C.elt_type=t,_tmp13C.elt_tq=tq,(_tmp13C.ptr_atts).rgn=r,(_tmp13C.ptr_atts).nullable=Cyc_Absyn_true_type,(_tmp13C.ptr_atts).bounds=Cyc_Absyn_fat_bound_type,(_tmp13C.ptr_atts).zero_term=zt,(_tmp13C.ptr_atts).ptrloc=0;_tmp13C;}));}
# 405
void*Cyc_Absyn_starb_type(void*t,void*r,struct Cyc_Absyn_Tqual tq,void*b,void*zt){
return Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp13D;_tmp13D.elt_type=t,_tmp13D.elt_tq=tq,(_tmp13D.ptr_atts).rgn=r,(_tmp13D.ptr_atts).nullable=Cyc_Absyn_true_type,(_tmp13D.ptr_atts).bounds=b,(_tmp13D.ptr_atts).zero_term=zt,(_tmp13D.ptr_atts).ptrloc=0;_tmp13D;}));}
# 410
void*Cyc_Absyn_atb_type(void*t,void*r,struct Cyc_Absyn_Tqual tq,void*b,void*zt){
return Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp13E;_tmp13E.elt_type=t,_tmp13E.elt_tq=tq,(_tmp13E.ptr_atts).rgn=r,(_tmp13E.ptr_atts).nullable=Cyc_Absyn_false_type,(_tmp13E.ptr_atts).bounds=b,(_tmp13E.ptr_atts).zero_term=zt,(_tmp13E.ptr_atts).ptrloc=0;_tmp13E;}));}
# 415
void*Cyc_Absyn_star_type(void*t,void*r,struct Cyc_Absyn_Tqual tq,void*zeroterm){
return({void*_tmp175=t;void*_tmp174=r;struct Cyc_Absyn_Tqual _tmp173=tq;void*_tmp172=Cyc_Absyn_bounds_one();Cyc_Absyn_starb_type(_tmp175,_tmp174,_tmp173,_tmp172,zeroterm);});}
# 418
...
return({void*_tmp179=t;void*_tmp178=r;struct Cyc_Absyn_Tqual _tmp177=tq;void*_tmp176=Cyc_Absyn_bounds_one();Cyc_Absyn_atb_type(_tmp179,_tmp178,_tmp177,_tmp176,zeroterm);});}
# 424
void*Cyc_Absyn_string_type(void*rgn){
return({void*_tmp17D=Cyc_Absyn_char_type;void*_tmp17C=rgn;struct Cyc_Absyn_Tqual _tmp17B=Cyc_Absyn_empty_tqual(0U);void*_tmp17A=Cyc_Absyn_fat_bound_type;Cyc_Absyn_starb_type(_tmp17D,_tmp17C,_tmp17B,_tmp17A,Cyc_Absyn_true_type);});}
# 427
void*Cyc_Absyn_const_string_type(void*rgn){
return({void*_tmp181=Cyc_Absyn_char_type;void*_tmp180=rgn;struct Cyc_Absyn_Tqual _tmp17F=Cyc_Absyn_const_tqual(0U);void*_tmp17E=Cyc_Absyn_fat_bound_type;Cyc_Absyn_starb_type(_tmp181,_tmp180,_tmp17F,_tmp17E,Cyc_Absyn_true_type);});}
# 431
...
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp60=_cycalloc(sizeof(*_tmp60));_tmp60->tag=0U,({void*_tmp184=(void*)({struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_tmp5F=_cycalloc(sizeof(*_tmp5F));_tmp5F->tag=20U,({union Cyc_Absyn_AggrInfo _tmp183=({enum Cyc_Absyn_AggrKind _tmp182=k;Cyc_Absyn_UnknownAggr(_tmp182,({struct _tuple0*_tmp5E=_cycalloc(sizeof(*_tmp5E));_tmp5E->f1=Cyc_Absyn_rel_ns_null,_tmp5E->f2=name;_tmp5E;}),0);});_tmp5F->f1=_tmp183;});_tmp5F;});_tmp60->f1=_tmp184;}),_tmp60->f2=0;_tmp60;});}
# 452
...
return({struct Cyc_Absyn_Exp*_tmp61=_cycalloc(sizeof(*_tmp61));_tmp61->topt=0,_tmp61->r=r,_tmp61->loc=loc,_tmp61->annot=(void*)& Cyc_Absyn_EmptyAnnot_val;_tmp61;});}
# 475
struct Cyc_Absyn_Exp*Cyc_Absyn_New_exp(struct Cyc_Absyn_Exp*rgn_handle,struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp185=(void*)({struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*_tmp62=_cycalloc(sizeof(*_tmp62));_tmp62->tag=16U,_tmp62->f1=rgn_handle,_tmp62->f2=e;_tmp62;});Cyc_Absyn_new_exp(_tmp185,loc);});}
# 478
struct Cyc_Absyn_Exp*Cyc_Absyn_copy_exp(struct Cyc_Absyn_Exp*e){
return({struct Cyc_Absyn_Exp*_tmp63=_cycalloc(sizeof(*_tmp63));*_tmp63=*e;_tmp63;});}
# 481
struct Cyc_Absyn_Exp*Cyc_Absyn_const_exp(union Cyc_Absyn_Cnst c,unsigned loc){
return({void*_tmp186=(void*)({struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp64=_cycalloc(sizeof(*_tmp64));_tmp64->tag=0U,_tmp64->f1=c;_tmp64;});Cyc_Absyn_new_exp(_tmp186,loc);});}
# 484
...
# 488
struct Cyc_Absyn_Exp*Cyc_Absyn_int_exp(enum Cyc_Absyn_Sign s,int i,unsigned seg){return({union Cyc_Absyn_Cnst _tmp187=Cyc_Absyn_Int_c(s,i);Cyc_Absyn_const_exp(_tmp187,seg);});}
...
struct Cyc_Absyn_Exp*Cyc_Absyn_char_exp(char c,unsigned loc){return({union Cyc_Absyn_Cnst _tmp188=Cyc_Absyn_Char_c(Cyc_Absyn_None,c);Cyc_Absyn_const_exp(_tmp188,loc);});}
struct Cyc_Absyn_Exp*Cyc_Absyn_float_exp(struct _fat_ptr f,int i,unsigned loc){
return({union Cyc_Absyn_Cnst _tmp189=Cyc_Absyn_Float_c(f,i);Cyc_Absyn_const_exp(_tmp189,loc);});}
# 510
static struct Cyc_Absyn_Exp*Cyc_Absyn_str2exp(union Cyc_Absyn_Cnst(*f)(struct _fat_ptr),struct _fat_ptr s,unsigned loc){
return({union Cyc_Absyn_Cnst _tmp18A=f(s);Cyc_Absyn_const_exp(_tmp18A,loc);});}
# 513
...
return({void*_tmp18C=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp66=_cycalloc(sizeof(*_tmp66));_tmp66->tag=1U,({void*_tmp18B=(void*)({struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*_tmp65=_cycalloc(sizeof(*_tmp65));_tmp65->tag=0U,_tmp65->f1=q;_tmp65;});_tmp66->f1=_tmp18B;});_tmp66;});Cyc_Absyn_new_exp(_tmp18C,loc);});}
# 520
struct Cyc_Absyn_Exp*Cyc_Absyn_varb_exp(void*b,unsigned loc){
return({void*_tmp18D=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp67=_cycalloc(sizeof(*_tmp67));_tmp67->tag=1U,_tmp67->f1=b;_tmp67;});Cyc_Absyn_new_exp(_tmp18D,loc);});}
# 524
...
return({void*_tmp18E=(void*)({struct Cyc_Absyn_Pragma_e_Absyn_Raw_exp_struct*_tmp68=_cycalloc(sizeof(*_tmp68));_tmp68->tag=2U,_tmp68->f1=s;_tmp68;});Cyc_Absyn_new_exp(_tmp18E,loc);});}
# 530
struct Cyc_Absyn_Exp*Cyc_Absyn_primop_exp(enum Cyc_Absyn_Primop p,struct Cyc_List_List*es,unsigned loc){
return({void*_tmp18F=(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp69=_cycalloc(sizeof(*_tmp69));_tmp69->tag=3U,_tmp69->f1=p,_tmp69->f2=es;_tmp69;});Cyc_Absyn_new_exp(_tmp18F,loc);});}
# 533
struct Cyc_Absyn_Exp*Cyc_Absyn_prim1_exp(enum Cyc_Absyn_Primop p,struct Cyc_Absyn_Exp*e,unsigned loc){
return({enum Cyc_Absyn_Primop _tmp191=p;struct Cyc_List_List*_tmp190=({struct Cyc_List_List*_tmp6A=_cycalloc(sizeof(*_tmp6A));_tmp6A->hd=e,_tmp6A->tl=0;_tmp6A;});Cyc_Absyn_primop_exp(_tmp191,_tmp190,loc);});}
# 536
...
return({enum Cyc_Absyn_Primop _tmp194=p;struct Cyc_List_List*_tmp193=({struct Cyc_List_List*_tmp6C=_cycalloc(sizeof(*_tmp6C));_tmp6C->hd=e1,({struct Cyc_List_List*_tmp192=({struct Cyc_List_List*_tmp6B=_cycalloc(sizeof(*_tmp6B));_tmp6B->hd=e2,_tmp6B->tl=0;_tmp6B;});_tmp6C->tl=_tmp192;});_tmp6C;});Cyc_Absyn_primop_exp(_tmp194,_tmp193,loc);});}
# 539
struct Cyc_Absyn_Exp*Cyc_Absyn_swap_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({void*_tmp195=(void*)({struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*_tmp6D=_cycalloc(sizeof(*_tmp6D));_tmp6D->tag=35U,_tmp6D->f1=e1,_tmp6D->f2=e2;_tmp6D;});Cyc_Absyn_new_exp(_tmp195,loc);});}
# 542
...
return({void*_tmp196=(void*)({struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmp6E=_cycalloc(sizeof(*_tmp6E));_tmp6E->tag=4U,_tmp6E->f1=e1,_tmp6E->f2=popt,_tmp6E->f3=e2;_tmp6E;});Cyc_Absyn_new_exp(_tmp196,loc);});}
# 555
...
return({void*_tmp197=(void*)({struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp6F=_cycalloc(sizeof(*_tmp6F));_tmp6F->tag=5U,_tmp6F->f1=e,_tmp6F->f2=i;_tmp6F;});Cyc_Absyn_new_exp(_tmp197,loc);});}
# 561
...
return({void*_tmp198=(void*)({struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_tmp70=_cycalloc(sizeof(*_tmp70));_tmp70->tag=6U,_tmp70->f1=e1,_tmp70->f2=e2,_tmp70->f3=e3;_tmp70;});Cyc_Absyn_new_exp(_tmp198,loc);});}
# 564
struct Cyc_Absyn_Exp*Cyc_Absyn_and_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({void*_tmp199=(void*)({struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_tmp71=_cycalloc(sizeof(*_tmp71));_tmp71->tag=7U,_tmp71->f1=e1,_tmp71->f2=e2;_tmp71;});Cyc_Absyn_new_exp(_tmp199,loc);});}
# 567
struct Cyc_Absyn_Exp*Cyc_Absyn_or_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({void*_tmp19A=(void*)({struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_tmp72=_cycalloc(sizeof(*_tmp72));_tmp72->tag=8U,_tmp72->f1=e1,_tmp72->f2=e2;_tmp72;});Cyc_Absyn_new_exp(_tmp19A,loc);});}
# 570
struct Cyc_Absyn_Exp*Cyc_Absyn_seq_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({void*_tmp19B=(void*)({struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_tmp73=_cycalloc(sizeof(*_tmp73));_tmp73->tag=9U,_tmp73->f1=e1,_tmp73->f2=e2;_tmp73;});Cyc_Absyn_new_exp(_tmp19B,loc);});}
# 573
struct Cyc_Absyn_Exp*Cyc_Absyn_unknowncall_exp(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*es,unsigned loc){
return({void*_tmp19C=(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp74=_cycalloc(sizeof(*_tmp74));_tmp74->tag=10U,_tmp74->f1=e,_tmp74->f2=es,_tmp74->f3=0,_tmp74->f4=0;_tmp74;});Cyc_Absyn_new_exp(_tmp19C,loc);});}
# 576
struct Cyc_Absyn_Exp*Cyc_Absyn_fncall_exp(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*es,unsigned loc){
return({void*_tmp19D=(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp75=_cycalloc(sizeof(*_tmp75));_tmp75->tag=10U,_tmp75->f1=e,_tmp75->f2=es,_tmp75->f3=0,_tmp75->f4=1;_tmp75;});Cyc_Absyn_new_exp(_tmp19D,loc);});}
# 579
struct Cyc_Absyn_Exp*Cyc_Absyn_noinstantiate_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp19E=(void*)({struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*_tmp76=_cycalloc(sizeof(*_tmp76));_tmp76->tag=12U,_tmp76->f1=e;_tmp76;});Cyc_Absyn_new_exp(_tmp19E,loc);});}
# 582
struct Cyc_Absyn_Exp*Cyc_Absyn_instantiate_exp(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*ts,unsigned loc){
return({void*_tmp19F=(void*)({struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*_tmp77=_cycalloc(sizeof(*_tmp77));_tmp77->tag=13U,_tmp77->f1=e,_tmp77->f2=ts;_tmp77;});Cyc_Absyn_new_exp(_tmp19F,loc);});}
# 585
...
return({void*_tmp1A0=(void*)({struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp78=_cycalloc(sizeof(*_tmp78));_tmp78->tag=14U,_tmp78->f1=t,_tmp78->f2=e,_tmp78->f3=user_cast,_tmp78->f4=c;_tmp78;});Cyc_Absyn_new_exp(_tmp1A0,loc);});}
# 588
struct Cyc_Absyn_Exp*Cyc_Absyn_throw_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1A1=(void*)({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_tmp79=_cycalloc(sizeof(*_tmp79));_tmp79->tag=11U,_tmp79->f1=e,_tmp79->f2=0;_tmp79;});Cyc_Absyn_new_exp(_tmp1A1,loc);});}
# 591
struct Cyc_Absyn_Exp*Cyc_Absyn_rethrow_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1A2=(void*)({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_tmp7A=_cycalloc(sizeof(*_tmp7A));_tmp7A->tag=11U,_tmp7A->f1=e,_tmp7A->f2=1;_tmp7A;});Cyc_Absyn_new_exp(_tmp1A2,loc);});}
# 594
struct Cyc_Absyn_Exp*Cyc_Absyn_address_exp(struct Cyc_Absyn_Exp*e,unsigned loc){return({void*_tmp1A3=(void*)({struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*_tmp7B=_cycalloc(sizeof(*_tmp7B));_tmp7B->tag=15U,_tmp7B->f1=e;_tmp7B;});Cyc_Absyn_new_exp(_tmp1A3,loc);});}
struct Cyc_Absyn_Exp*Cyc_Absyn_sizeoftype_exp(void*t,unsigned loc){
return({void*_tmp1A4=(void*)({struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*_tmp7C=_cycalloc(sizeof(*_tmp7C));_tmp7C->tag=17U,_tmp7C->f1=t;_tmp7C;});Cyc_Absyn_new_exp(_tmp1A4,loc);});}
# 598
struct Cyc_Absyn_Exp*Cyc_Absyn_sizeofexp_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1A5=(void*)({struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*_tmp7D=_cycalloc(sizeof(*_tmp7D));_tmp7D->tag=18U,_tmp7D->f1=e;_tmp7D;});Cyc_Absyn_new_exp(_tmp1A5,loc);});}
# 601
struct Cyc_Absyn_Exp*Cyc_Absyn_offsetof_exp(void*t,struct Cyc_List_List*ofs,unsigned loc){
return({void*_tmp1A6=(void*)({struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmp7E=_cycalloc(sizeof(*_tmp7E));_tmp7E->tag=19U,_tmp7E->f1=t,_tmp7E->f2=ofs;_tmp7E;});Cyc_Absyn_new_exp(_tmp1A6,loc);});}
# 604
struct Cyc_Absyn_Exp*Cyc_Absyn_deref_exp(struct Cyc_Absyn_Exp*e,unsigned loc){return({void*_tmp1A7=(void*)({struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_tmp7F=_cycalloc(sizeof(*_tmp7F));_tmp7F->tag=20U,_tmp7F->f1=e;_tmp7F;});Cyc_Absyn_new_exp(_tmp1A7,loc);});}
struct Cyc_Absyn_Exp*Cyc_Absyn_aggrmember_exp(struct Cyc_Absyn_Exp*e,struct _fat_ptr*n,unsigned loc){
return({void*_tmp1A8=(void*)({struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_tmp80=_cycalloc(sizeof(*_tmp80));_tmp80->tag=21U,_tmp80->f1=e,_tmp80->f2=n,_tmp80->f3=0,_tmp80->f4=0;_tmp80;});Cyc_Absyn_new_exp(_tmp1A8,loc);});}
# 608
struct Cyc_Absyn_Exp*Cyc_Absyn_aggrarrow_exp(struct Cyc_Absyn_Exp*e,struct _fat_ptr*n,unsigned loc){
return({void*_tmp1A9=(void*)({struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp81=_cycalloc(sizeof(*_tmp81));_tmp81->tag=22U,_tmp81->f1=e,_tmp81->f2=n,_tmp81->f3=0,_tmp81->f4=0;_tmp81;});Cyc_Absyn_new_exp(_tmp1A9,loc);});}
# 611
struct Cyc_Absyn_Exp*Cyc_Absyn_subscript_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({void*_tmp1AA=(void*)({struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*_tmp82=_cycalloc(sizeof(*_tmp82));_tmp82->tag=23U,_tmp82->f1=e1,_tmp82->f2=e2;_tmp82;});Cyc_Absyn_new_exp(_tmp1AA,loc);});}
# 614
struct Cyc_Absyn_Exp*Cyc_Absyn_tuple_exp(struct Cyc_List_List*es,unsigned loc){
return({void*_tmp1AB=(void*)({struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*_tmp83=_cycalloc(sizeof(*_tmp83));_tmp83->tag=24U,_tmp83->f1=es;_tmp83;});Cyc_Absyn_new_exp(_tmp1AB,loc);});}
# 617
struct Cyc_Absyn_Exp*Cyc_Absyn_stmt_exp(struct Cyc_Absyn_Stmt*s,unsigned loc){
return({void*_tmp1AC=(void*)({struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_tmp84=_cycalloc(sizeof(*_tmp84));_tmp84->tag=37U,_tmp84->f1=s;_tmp84;});Cyc_Absyn_new_exp(_tmp1AC,loc);});}
# 620
struct Cyc_Absyn_Exp*Cyc_Absyn_valueof_exp(void*t,unsigned loc){
return({void*_tmp1AD=(void*)({struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp85=_cycalloc(sizeof(*_tmp85));_tmp85->tag=39U,_tmp85->f1=t;_tmp85;});Cyc_Absyn_new_exp(_tmp1AD,loc);});}
# 624
...
# 627
return({void*_tmp1AE=(void*)({struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*_tmp86=_cycalloc(sizeof(*_tmp86));_tmp86->tag=40U,_tmp86->f1=volatile_kw,_tmp86->f2=tmpl,_tmp86->f3=outs,_tmp86->f4=ins,_tmp86->f5=clobs;_tmp86;});Cyc_Absyn_new_exp(_tmp1AE,loc);});}
# 629
struct Cyc_Absyn_Exp*Cyc_Absyn_extension_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1AF=(void*)({struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*_tmp87=_cycalloc(sizeof(*_tmp87));_tmp87->tag=41U,_tmp87->f1=e;_tmp87;});Cyc_Absyn_new_exp(_tmp1AF,loc);});}
# 632
struct Cyc_Absyn_Exp*Cyc_Absyn_assert_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1B0=(void*)({struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*_tmp88=_cycalloc(sizeof(*_tmp88));_tmp88->tag=42U,_tmp88->f1=e;_tmp88;});Cyc_Absyn_new_exp(_tmp1B0,loc);});}struct _tuple12{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
# 636
struct Cyc_Absyn_Exp*Cyc_Absyn_array_exp(struct Cyc_List_List*es,unsigned loc){
struct Cyc_List_List*_tmp89=0;struct Cyc_List_List*dles=_tmp89;
for(0;es != 0;es=es->tl){
dles=({struct Cyc_List_List*_tmp8B=_cycalloc(sizeof(*_tmp8B));({struct _tuple12*_tmp1B1=({struct _tuple12*_tmp8A=_cycalloc(sizeof(*_tmp8A));_tmp8A->f1=0,_tmp8A->f2=(struct Cyc_Absyn_Exp*)es->hd;_tmp8A;});_tmp8B->hd=_tmp1B1;}),_tmp8B->tl=dles;_tmp8B;});}
dles=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);
return({void*_tmp1B2=(void*)({struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_tmp8C=_cycalloc(sizeof(*_tmp8C));_tmp8C->tag=26U,_tmp8C->f1=dles;_tmp8C;});Cyc_Absyn_new_exp(_tmp1B2,loc);});}
# 643
struct Cyc_Absyn_Exp*Cyc_Absyn_unresolvedmem_exp(struct Cyc_Core_Opt*n,struct Cyc_List_List*dles,unsigned loc){
# 646
return({void*_tmp1B3=(void*)({struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmp8D=_cycalloc(sizeof(*_tmp8D));_tmp8D->tag=36U,_tmp8D->f1=n,_tmp8D->f2=dles;_tmp8D;});Cyc_Absyn_new_exp(_tmp1B3,loc);});}
# 649
struct Cyc_Absyn_Stmt*Cyc_Absyn_new_stmt(void*s,unsigned loc){
return({struct Cyc_Absyn_Stmt*_tmp8E=_cycalloc(sizeof(*_tmp8E));_tmp8E->r=s,_tmp8E->loc=loc,_tmp8E->annot=(void*)& Cyc_Absyn_EmptyAnnot_val;_tmp8E;});}
# 652
...
struct Cyc_Absyn_Stmt*Cyc_Absyn_exp_stmt(struct Cyc_Absyn_Exp*e,unsigned loc){return({void*_tmp1B4=(void*)({struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*_tmp8F=_cycalloc(sizeof(*_tmp8F));_tmp8F->tag=1U,_tmp8F->f1=e;_tmp8F;});Cyc_Absyn_new_stmt(_tmp1B4,loc);});}
struct Cyc_Absyn_Stmt*Cyc_Absyn_return_stmt(struct Cyc_Absyn_Exp*e,unsigned loc){return({void*_tmp1B5=(void*)({struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*_tmp90=_cycalloc(sizeof(*_tmp90));_tmp90->tag=3U,_tmp90->f1=e;_tmp90;});Cyc_Absyn_new_stmt(_tmp1B5,loc);});}
...
return({struct Cyc_Absyn_Stmt*_tmp1B7=(struct Cyc_Absyn_Stmt*)ss->hd;struct Cyc_Absyn_Stmt*_tmp1B6=Cyc_Absyn_seq_stmts(ss->tl,loc);Cyc_Absyn_seq_stmt(_tmp1B7,_tmp1B6,loc);});}}}struct _tuple13{void*f1;void*f2;};
# 665
struct Cyc_Absyn_Stmt*Cyc_Absyn_seq_stmt(struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2,unsigned loc){
struct _tuple13 _tmp91=({struct _tuple13 _tmp147;_tmp147.f1=s1->r,_tmp147.f2=s2->r;_tmp147;});struct _tuple13 _stmttmp3=_tmp91;struct _tuple13 _tmp92=_stmttmp3;if(((struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*)_tmp92.f1)->tag == 0U){_LL1: _LL2:
 return s2;}else{if(((struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*)_tmp92.f2)->tag == 0U){_LL3: _LL4:
 return s1;}else{_LL5: _LL6:
 return({void*_tmp1B8=(void*)({struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmp93=_cycalloc(sizeof(*_tmp93));_tmp93->tag=2U,_tmp93->f1=s1,_tmp93->f2=s2;_tmp93;});Cyc_Absyn_new_stmt(_tmp1B8,loc);});}}_LL0:;}
# 672
...
return({void*_tmp1B9=(void*)({struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*_tmp94=_cycalloc(sizeof(*_tmp94));_tmp94->tag=4U,_tmp94->f1=e,_tmp94->f2=s1,_tmp94->f3=s2;_tmp94;});Cyc_Absyn_new_stmt(_tmp1B9,loc);});}
# 675
struct Cyc_Absyn_Stmt*Cyc_Absyn_while_stmt(struct Cyc_Absyn_Exp*e,struct Cyc_Absyn_Stmt*s,unsigned loc){
return({void*_tmp1BB=(void*)({struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*_tmp95=_cycalloc(sizeof(*_tmp95));_tmp95->tag=5U,(_tmp95->f1).f1=e,({struct Cyc_Absyn_Stmt*_tmp1BA=Cyc_Absyn_skip_stmt(e->loc);(_tmp95->f1).f2=_tmp1BA;}),_tmp95->f2=s;_tmp95;});Cyc_Absyn_new_stmt(_tmp1BB,loc);});}
# 678
...
return({void*_tmp1BE=(void*)({struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*_tmp96=_cycalloc(sizeof(*_tmp96));_tmp96->tag=9U,_tmp96->f1=e1,(_tmp96->f2).f1=e2,({struct Cyc_Absyn_Stmt*_tmp1BD=Cyc_Absyn_skip_stmt(e3->loc);(_tmp96->f2).f2=_tmp1BD;}),
(_tmp96->f3).f1=e3,({struct Cyc_Absyn_Stmt*_tmp1BC=Cyc_Absyn_skip_stmt(e3->loc);(_tmp96->f3).f2=_tmp1BC;}),_tmp96->f4=s;_tmp96;});
# 679
Cyc_Absyn_new_stmt(_tmp1BE,loc);});}
# 683
struct Cyc_Absyn_Stmt*Cyc_Absyn_do_stmt(struct Cyc_Absyn_Stmt*s,struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1C0=(void*)({struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*_tmp97=_cycalloc(sizeof(*_tmp97));_tmp97->tag=14U,_tmp97->f1=s,(_tmp97->f2).f1=e,({struct Cyc_Absyn_Stmt*_tmp1BF=Cyc_Absyn_skip_stmt(e->loc);(_tmp97->f2).f2=_tmp1BF;});_tmp97;});Cyc_Absyn_new_stmt(_tmp1C0,loc);});}
# 686
struct Cyc_Absyn_Stmt*Cyc_Absyn_switch_stmt(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*scs,unsigned loc){
return({void*_tmp1C1=(void*)({struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*_tmp98=_cycalloc(sizeof(*_tmp98));_tmp98->tag=10U,_tmp98->f1=e,_tmp98->f2=scs,_tmp98->f3=0;_tmp98;});Cyc_Absyn_new_stmt(_tmp1C1,loc);});}
# 689
struct Cyc_Absyn_Stmt*Cyc_Absyn_trycatch_stmt(struct Cyc_Absyn_Stmt*s,struct Cyc_List_List*scs,unsigned loc){
return({void*_tmp1C2=(void*)({struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*_tmp99=_cycalloc(sizeof(*_tmp99));_tmp99->tag=15U,_tmp99->f1=s,_tmp99->f2=scs,_tmp99->f3=0;_tmp99;});Cyc_Absyn_new_stmt(_tmp1C2,loc);});}
# 692
struct Cyc_Absyn_Stmt*Cyc_Absyn_fallthru_stmt(struct Cyc_List_List*el,unsigned loc){
return({void*_tmp1C3=(void*)({struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*_tmp9A=_cycalloc(sizeof(*_tmp9A));_tmp9A->tag=11U,_tmp9A->f1=el,_tmp9A->f2=0;_tmp9A;});Cyc_Absyn_new_stmt(_tmp1C3,loc);});}
# 695
struct Cyc_Absyn_Stmt*Cyc_Absyn_goto_stmt(struct _fat_ptr*lab,unsigned loc){
return({void*_tmp1C4=(void*)({struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*_tmp9B=_cycalloc(sizeof(*_tmp9B));_tmp9B->tag=8U,_tmp9B->f1=lab;_tmp9B;});Cyc_Absyn_new_stmt(_tmp1C4,loc);});}
# 698
struct Cyc_Absyn_Stmt*Cyc_Absyn_label_stmt(struct _fat_ptr*v,struct Cyc_Absyn_Stmt*s,unsigned loc){
return({void*_tmp1C5=(void*)({struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*_tmp9C=_cycalloc(sizeof(*_tmp9C));_tmp9C->tag=13U,_tmp9C->f1=v,_tmp9C->f2=s;_tmp9C;});Cyc_Absyn_new_stmt(_tmp1C5,loc);});}
# 701
struct Cyc_Absyn_Stmt*Cyc_Absyn_decl_stmt(struct Cyc_Absyn_Decl*d,struct Cyc_Absyn_Stmt*s,unsigned loc){
return({void*_tmp1C6=(void*)({struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*_tmp9D=_cycalloc(sizeof(*_tmp9D));_tmp9D->tag=12U,_tmp9D->f1=d,_tmp9D->f2=s;_tmp9D;});Cyc_Absyn_new_stmt(_tmp1C6,loc);});}
# 704
...
struct Cyc_Absyn_Decl*d=({void*_tmp1C8=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp9F=_cycalloc(sizeof(*_tmp9F));_tmp9F->tag=0U,({struct Cyc_Absyn_Vardecl*_tmp1C7=Cyc_Absyn_new_vardecl(0U,x,t,init);_tmp9F->f1=_tmp1C7;});_tmp9F;});Cyc_Absyn_new_decl(_tmp1C8,loc);});
return({void*_tmp1C9=(void*)({struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*_tmp9E=_cycalloc(sizeof(*_tmp9E));_tmp9E->tag=12U,_tmp9E->f1=d,_tmp9E->f2=s;_tmp9E;});Cyc_Absyn_new_stmt(_tmp1C9,loc);});}
# 708
struct Cyc_Absyn_Stmt*Cyc_Absyn_assign_stmt(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({struct Cyc_Absyn_Exp*_tmp1CA=Cyc_Absyn_assign_exp(e1,e2,loc);Cyc_Absyn_exp_stmt(_tmp1CA,loc);});}
# 712
struct Cyc_Absyn_Pat*Cyc_Absyn_new_pat(void*p,unsigned s){return({struct Cyc_Absyn_Pat*_tmpA0=_cycalloc(sizeof(*_tmpA0));_tmpA0->r=p,_tmpA0->topt=0,_tmpA0->loc=s;_tmpA0;});}
struct Cyc_Absyn_Pat*Cyc_Absyn_exp_pat(struct Cyc_Absyn_Exp*e){return({void*_tmp1CB=(void*)({struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*_tmpA1=_cycalloc(sizeof(*_tmpA1));_tmpA1->tag=17U,_tmpA1->f1=e;_tmpA1;});Cyc_Absyn_new_pat(_tmp1CB,e->loc);});}
...
# 718
struct Cyc_Absyn_Decl*Cyc_Absyn_new_decl(void*r,unsigned loc){return({struct Cyc_Absyn_Decl*_tmpA2=_cycalloc(sizeof(*_tmpA2));_tmpA2->r=r,_tmpA2->loc=loc;_tmpA2;});}
struct Cyc_Absyn_Decl*Cyc_Absyn_let_decl(struct Cyc_Absyn_Pat*p,struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1CC=(void*)({struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*_tmpA3=_cycalloc(sizeof(*_tmpA3));_tmpA3->tag=2U,_tmpA3->f1=p,_tmpA3->f2=0,_tmpA3->f3=e,_tmpA3->f4=0;_tmpA3;});Cyc_Absyn_new_decl(_tmp1CC,loc);});}
# 722
struct Cyc_Absyn_Decl*Cyc_Absyn_letv_decl(struct Cyc_List_List*vds,unsigned loc){
return({void*_tmp1CD=(void*)({struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*_tmpA4=_cycalloc(sizeof(*_tmpA4));_tmpA4->tag=3U,_tmpA4->f1=vds;_tmpA4;});Cyc_Absyn_new_decl(_tmp1CD,loc);});}
# 725
...
return({void*_tmp1CE=(void*)({struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*_tmpA5=_cycalloc(sizeof(*_tmpA5));_tmpA5->tag=4U,_tmpA5->f1=tv,_tmpA5->f2=vd,_tmpA5->f3=open_exp;_tmpA5;});Cyc_Absyn_new_decl(_tmp1CE,loc);});}
# 728
...
# 730
return({void*_tmp1D1=(void*)({struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*_tmpA7=_cycalloc(sizeof(*_tmpA7));_tmpA7->tag=2U,({struct Cyc_Absyn_Pat*_tmp1D0=({void*_tmp1CF=(void*)({struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*_tmpA6=_cycalloc(sizeof(*_tmpA6));_tmpA6->tag=2U,_tmpA6->f1=tv,_tmpA6->f2=vd;_tmpA6;});Cyc_Absyn_new_pat(_tmp1CF,loc);});_tmpA7->f1=_tmp1D0;}),_tmpA7->f2=0,_tmpA7->f3=e,_tmpA7->f4=0;_tmpA7;});Cyc_Absyn_new_decl(_tmp1D1,loc);});}
# 733
...
# 756
return({void*_tmp1D5=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpAC=_cycalloc(sizeof(*_tmpAC));_tmpAC->tag=5U,({struct Cyc_Absyn_Aggrdecl*_tmp1D4=({struct Cyc_Absyn_Aggrdecl*_tmpAB=_cycalloc(sizeof(*_tmpAB));_tmpAB->kind=k,_tmpAB->sc=s,_tmpAB->name=n,_tmpAB->tvs=ts,_tmpAB->impl=i,_tmpAB->attributes=atts,_tmpAB->expected_mem_kind=0;_tmpAB;});_tmpAC->f1=_tmp1D4;});_tmpAC;});Cyc_Absyn_new_decl(_tmp1D5,loc);});}
# 761
...
# 764
return({struct Cyc_Absyn_TypeDecl*_tmpAF=_cycalloc(sizeof(*_tmpAF));({void*_tmp1D7=(void*)({struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*_tmpAE=_cycalloc(sizeof(*_tmpAE));_tmpAE->tag=0U,({struct Cyc_Absyn_Aggrdecl*_tmp1D6=({struct Cyc_Absyn_Aggrdecl*_tmpAD=_cycalloc(sizeof(*_tmpAD));_tmpAD->kind=k,_tmpAD->sc=s,_tmpAD->name=n,_tmpAD->tvs=ts,_tmpAD->impl=i,_tmpAD->attributes=atts,_tmpAD->expected_mem_kind=0;_tmpAD;});_tmpAE->f1=_tmp1D6;});_tmpAE;});_tmpAF->r=_tmp1D7;}),_tmpAF->loc=loc;_tmpAF;});}
# 770
...
# 783
return({void*_tmp1D9=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmpB1=_cycalloc(sizeof(*_tmpB1));_tmpB1->tag=6U,({struct Cyc_Absyn_Datatypedecl*_tmp1D8=({struct Cyc_Absyn_Datatypedecl*_tmpB0=_cycalloc(sizeof(*_tmpB0));_tmpB0->sc=s,_tmpB0->name=n,_tmpB0->tvs=ts,_tmpB0->fields=fs,_tmpB0->is_extensible=is_extensible;_tmpB0;});_tmpB1->f1=_tmp1D8;});_tmpB1;});Cyc_Absyn_new_decl(_tmp1D9,loc);});}
# 786
...
# 789
return({struct Cyc_Absyn_TypeDecl*_tmpB4=_cycalloc(sizeof(*_tmpB4));({void*_tmp1DB=(void*)({struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*_tmpB3=_cycalloc(sizeof(*_tmpB3));_tmpB3->tag=2U,({struct Cyc_Absyn_Datatypedecl*_tmp1DA=({struct Cyc_Absyn_Datatypedecl*_tmpB2=_cycalloc(sizeof(*_tmpB2));_tmpB2->sc=s,_tmpB2->name=n,_tmpB2->tvs=ts,_tmpB2->fields=fs,_tmpB2->is_extensible=is_extensible;_tmpB2;});_tmpB3->f1=_tmp1DA;});_tmpB3;});_tmpB4->r=_tmp1DB;}),_tmpB4->loc=loc;_tmpB4;});}
# 801 "absyn.cyc"
...
({void*_tmp1DC=Cyc_Absyn_pointer_expand((*((struct _tuple8*)args2->hd)).f3,1);(*((struct _tuple8*)args2->hd)).f3=_tmp1DC;});}}
...
# 811
void*_tmp1DD=Cyc_Absyn_pointer_expand(ret_type,0);(_tmpB6->f1).ret_type=_tmp1DD;}),(_tmpB6->f1).effect=eff_type,(_tmpB6->f1).args=args,(_tmpB6->f1).c_varargs=c_varargs,(_tmpB6->f1).cyc_varargs=cyc_varargs,(_tmpB6->f1).rgn_po=rgn_po,(_tmpB6->f1).attributes=atts,(_tmpB6->f1).requires_clause=req,(_tmpB6->f1).requires_relns=0,(_tmpB6->f1).ensures_clause=ens,(_tmpB6->f1).ensures_relns=0,(_tmpB6->f1).return_value=0;_tmpB6;});}
# 826
void*Cyc_Absyn_pointer_expand(void*t,int fresh_evar){
void*_tmpB7=Cyc_Tcutil_compress(t);void*_stmttmp4=_tmpB7;void*_tmpB8=_stmttmp4;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmpB8)->tag == 5U){_LL1: _LL2:
 return({void*_tmp1E0=t;void*_tmp1DF=
fresh_evar?
Cyc_Absyn_new_evar(({struct Cyc_Core_Opt*_tmpB9=_cycalloc(sizeof(*_tmpB9));_tmpB9->v=& Cyc_Tcutil_rk;_tmpB9;}),0): Cyc_Absyn_heap_rgn_type;
# 828
struct Cyc_Absyn_Tqual _tmp1DE=
# 832
Cyc_Absyn_empty_tqual(0U);
# 828
Cyc_Absyn_at_type(_tmp1E0,_tmp1DF,_tmp1DE,Cyc_Absyn_false_type);});}else{_LL3: _LL4:
# 833
 return t;}_LL0:;}
# 848 "absyn.cyc"
...
# 853
void*_tmpC1=Cyc_Tcutil_compress(vd->type);void*_stmttmp6=_tmpC1;void*_tmpC2=_stmttmp6;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmpC2)->tag == 4U){_LL18: _LL19:
...
void*_tmpC4=decl->r;void*_stmttmp7=_tmpC4;void*_tmpC5=_stmttmp7;struct Cyc_Absyn_Fndecl*_tmpC6;struct Cyc_Absyn_Vardecl*_tmpC7;struct Cyc_Absyn_Typedefdecl*_tmpC8;struct Cyc_Absyn_Enumdecl*_tmpC9;struct Cyc_Absyn_Aggrdecl*_tmpCA;switch(*((int*)_tmpC5)){case 5U: _LL1: _tmpCA=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmpC5)->f1;_LL2: {struct Cyc_Absyn_Aggrdecl*x=_tmpCA;
return(*x->name).f2;}case 7U: _LL3: _tmpC9=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmpC5)->f1;_LL4: {struct Cyc_Absyn_Enumdecl*x=_tmpC9;
return(*x->name).f2;}case 8U: _LL5: _tmpC8=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmpC5)->f1;_LL6: {struct Cyc_Absyn_Typedefdecl*x=_tmpC8;
...
struct Cyc_Absyn_Always_inline_att_Absyn_Attribute_struct Cyc_Absyn_Always_inline_att_val={26U};static char _tmpD1[3U]="f0";
# 939
...
if((unsigned)i >= fsz)
field_names=({unsigned _tmpD0=(unsigned)(i + 1);struct _fat_ptr**_tmpCF=_cycalloc(_check_times(_tmpD0,sizeof(struct _fat_ptr*)));({{unsigned _tmp148=(unsigned)(i + 1);unsigned j;for(j=0;j < _tmp148;++ j){
# 948
j < fsz?_tmpCF[j]=*((struct _fat_ptr**)_check_fat_subscript(field_names,sizeof(struct _fat_ptr*),(int)j)):({struct _fat_ptr*_tmp1E3=({struct _fat_ptr*_tmpCE=_cycalloc(sizeof(*_tmpCE));({struct _fat_ptr _tmp1E2=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpCD=({struct Cyc_Int_pa_PrintArg_struct _tmp149;_tmp149.tag=1U,_tmp149.f1=(unsigned long)((int)j);_tmp149;});void*_tmpCB[1U];_tmpCB[0]=& _tmpCD;({struct _fat_ptr _tmp1E1=({const char*_tmpCC="f%d";_tag_fat(_tmpCC,sizeof(char),4U);});Cyc_aprintf(_tmp1E1,_tag_fat(_tmpCB,sizeof(void*),1U));});});*_tmpCE=_tmp1E2;});_tmpCE;});_tmpCF[j]=_tmp1E3;});}}0;});_tag_fat(_tmpCF,sizeof(struct _fat_ptr*),_tmpD0);});
...
return({struct _tuple15 _tmp14A;_tmp14A.f1=ak,_tmp14A.f2=n;_tmp14A;});}}else{_LL3: _tmpD3=(*(_tmpD2.KnownAggr).val)->kind;_tmpD4=(*(_tmpD2.KnownAggr).val)->name;_LL4: {enum Cyc_Absyn_AggrKind k=_tmpD3;struct _tuple0*n=_tmpD4;
return({struct _tuple15 _tmp14B;_tmp14B.f1=k,_tmp14B.f2=n;_tmp14B;});}}_LL0:;}
# 958
...
({void*_tmpD9=0U;({struct _fat_ptr _tmp1E4=({const char*_tmpDA="unchecked aggrdecl";_tag_fat(_tmpDA,sizeof(char),19U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp1E4,_tag_fat(_tmpD9,sizeof(void*),0U));});});}else{_LL3: _tmpD8=*(_tmpD7.KnownAggr).val;_LL4: {struct Cyc_Absyn_Aggrdecl*ad=_tmpD8;
return ad;}}_LL0:;}
# 964
int Cyc_Absyn_is_nontagged_nonrequire_union_type(void*t){
void*_tmpDB=Cyc_Tcutil_compress(t);void*_stmttmp8=_tmpDB;void*_tmpDC=_stmttmp8;union Cyc_Absyn_AggrInfo _tmpDD;struct Cyc_List_List*_tmpDE;switch(*((int*)_tmpDC)){case 7U: if(((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmpDC)->f1 == Cyc_Absyn_UnionA){_LL1: _tmpDE=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmpDC)->f2;_LL2: {struct Cyc_List_List*fs=_tmpDE;
# 967
if(fs == 0)return 1;
...
if(ds == 0 || ds->tl != 0)
({void*_tmpF8=0U;({struct _fat_ptr _tmp1E5=({const char*_tmpF9="designator list not of length 1";_tag_fat(_tmpF9,sizeof(char),32U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp1E5,_tag_fat(_tmpF8,sizeof(void*),0U));});});{
void*_tmpFA=(void*)ds->hd;void*_stmttmpA=_tmpFA;void*_tmpFB=_stmttmpA;struct _fat_ptr*_tmpFC;if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmpFB)->tag == 1U){_LL1: _tmpFC=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmpFB)->f1;_LL2: {struct _fat_ptr*f=_tmpFC;
return f;}}else{_LL3: _LL4:
({void*_tmpFD=0U;({struct _fat_ptr _tmp1E6=({const char*_tmpFE="array designator in struct";_tag_fat(_tmpFE,sizeof(char),27U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp1E6,_tag_fat(_tmpFD,sizeof(void*),0U));});});}_LL0:;}}
# 1025
int Cyc_Absyn_type2bool(int def,void*t){
void*_tmpFF=Cyc_Tcutil_compress(t);void*_stmttmpB=_tmpFF;void*_tmp100=_stmttmpB;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp100)->tag == 0U)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp100)->f1)){case 11U: _LL1: _LL2:
...
void*_tmp101=e->r;void*_stmttmpC=_tmp101;void*_tmp102=_stmttmpC;switch(*((int*)_tmp102)){case 0U: _LL1: _LL2:
