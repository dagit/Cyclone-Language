...
if(i != 0)return i;{
struct _tuple11 _tmp6=({struct _tuple11 _tmp158;_tmp158.f1=n1,_tmp158.f2=n2;_tmp158;});struct _tuple11 _stmttmp0=_tmp6;struct _tuple11 _tmp7=_stmttmp0;struct Cyc_List_List*_tmp9;struct Cyc_List_List*_tmp8;struct Cyc_List_List*_tmpB;struct Cyc_List_List*_tmpA;struct Cyc_List_List*_tmpD;struct Cyc_List_List*_tmpC;switch(((_tmp7.f1).Abs_n).tag){case 4U: if(((_tmp7.f2).Loc_n).tag == 4){_LL7: _LL8:
...
return C_scope?({union Cyc_Absyn_Nmspace _tmp159;(_tmp159.C_n).tag=3U,(_tmp159.C_n).val=x;_tmp159;}):({union Cyc_Absyn_Nmspace _tmp15A;(_tmp15A.Abs_n).tag=2U,(_tmp15A.Abs_n).val=x;_tmp15A;});}
# 91
union Cyc_Absyn_Nmspace Cyc_Absyn_Rel_n(struct Cyc_List_List*x){return({union Cyc_Absyn_Nmspace _tmp15B;(_tmp15B.Rel_n).tag=1U,(_tmp15B.Rel_n).val=x;_tmp15B;});}
...
# 111
struct Cyc_Absyn_Tqual Cyc_Absyn_empty_tqual(unsigned loc){return({struct Cyc_Absyn_Tqual _tmp15C;_tmp15C.print_const=0,_tmp15C.q_volatile=0,_tmp15C.q_restrict=0,_tmp15C.real_const=0,_tmp15C.loc=loc;_tmp15C;});}
struct Cyc_Absyn_Tqual Cyc_Absyn_const_tqual(unsigned loc){return({struct Cyc_Absyn_Tqual _tmp15D;_tmp15D.print_const=1,_tmp15D.q_volatile=0,_tmp15D.q_restrict=0,_tmp15D.real_const=1,_tmp15D.loc=loc;_tmp15D;});}
struct Cyc_Absyn_Tqual Cyc_Absyn_combine_tqual(struct Cyc_Absyn_Tqual x,struct Cyc_Absyn_Tqual y){
return({struct Cyc_Absyn_Tqual _tmp15E;_tmp15E.print_const=x.print_const || y.print_const,_tmp15E.q_volatile=
x.q_volatile || y.q_volatile,_tmp15E.q_restrict=
x.q_restrict || y.q_restrict,_tmp15E.real_const=
x.real_const || y.real_const,({
unsigned _tmp185=Cyc_Position_segment_join(x.loc,y.loc);_tmp15E.loc=_tmp185;});_tmp15E;});}
# 120
...
return({union Cyc_Absyn_DatatypeInfo _tmp15F;(_tmp15F.UnknownDatatype).tag=1U,(_tmp15F.UnknownDatatype).val=udi;_tmp15F;});}
# 131
union Cyc_Absyn_DatatypeInfo Cyc_Absyn_KnownDatatype(struct Cyc_Absyn_Datatypedecl**d){
return({union Cyc_Absyn_DatatypeInfo _tmp160;(_tmp160.KnownDatatype).tag=2U,(_tmp160.KnownDatatype).val=d;_tmp160;});}
# 134
union Cyc_Absyn_DatatypeFieldInfo Cyc_Absyn_UnknownDatatypefield(struct Cyc_Absyn_UnknownDatatypeFieldInfo s){
return({union Cyc_Absyn_DatatypeFieldInfo _tmp161;(_tmp161.UnknownDatatypefield).tag=1U,(_tmp161.UnknownDatatypefield).val=s;_tmp161;});}
# 137
...
return({union Cyc_Absyn_DatatypeFieldInfo _tmp162;(_tmp162.KnownDatatypefield).tag=2U,((_tmp162.KnownDatatypefield).val).f1=dd,((_tmp162.KnownDatatypefield).val).f2=df;_tmp162;});}
# 140
union Cyc_Absyn_AggrInfo Cyc_Absyn_UnknownAggr(enum Cyc_Absyn_AggrKind ak,struct _tuple0*n,struct Cyc_Core_Opt*tagged){
return({union Cyc_Absyn_AggrInfo _tmp163;(_tmp163.UnknownAggr).tag=1U,((_tmp163.UnknownAggr).val).f1=ak,((_tmp163.UnknownAggr).val).f2=n,((_tmp163.UnknownAggr).val).f3=tagged;_tmp163;});}
# 143
union Cyc_Absyn_AggrInfo Cyc_Absyn_KnownAggr(struct Cyc_Absyn_Aggrdecl**ad){
return({union Cyc_Absyn_AggrInfo _tmp164;(_tmp164.KnownAggr).tag=2U,(_tmp164.KnownAggr).val=ad;_tmp164;});}
# 146
...
# 153
({void*_tmp186=Cyc_Absyn_compress_kb(*k2);*k2=_tmp186;});
return*k2;}}}_LL0:;}
# 157
...
# 162
({struct Cyc_Core_Opt*_tmp188=({struct Cyc_Core_Opt*_tmp1A=_cycalloc(sizeof(*_tmp1A));({void*_tmp187=Cyc_Tcutil_kind_to_bound(k);_tmp1A->v=_tmp187;});_tmp1A;});*f=_tmp188;});
return k;}}_LL0:;}
# 168
void*Cyc_Absyn_app_type(void*c,struct _fat_ptr args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp1B=_cycalloc(sizeof(*_tmp1B));_tmp1B->tag=0U,_tmp1B->f1=c,({struct Cyc_List_List*_tmp189=((struct Cyc_List_List*(*)(struct _fat_ptr arr))Cyc_List_from_array)(args);_tmp1B->f2=_tmp189;});_tmp1B;});}
# 171
...
return({void*_tmp23=0U;({void*_tmp18A=(void*)({struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*_tmp24=_cycalloc(sizeof(*_tmp24));_tmp24->tag=15U,_tmp24->f1=n,_tmp24->f2=d;_tmp24;});Cyc_Absyn_app_type(_tmp18A,_tag_fat(_tmp23,sizeof(void*),0U));});});}
# 231
void*Cyc_Absyn_anon_enum_type(struct Cyc_List_List*fs){
return({void*_tmp25=0U;({void*_tmp18B=(void*)({struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*_tmp26=_cycalloc(sizeof(*_tmp26));_tmp26->tag=16U,_tmp26->f1=fs;_tmp26;});Cyc_Absyn_app_type(_tmp18B,_tag_fat(_tmp25,sizeof(void*),0U));});});}
# 234
void*Cyc_Absyn_builtin_type(struct _fat_ptr s,struct Cyc_Absyn_Kind*k){
return({void*_tmp27=0U;({void*_tmp18C=(void*)({struct Cyc_Absyn_BuiltinCon_Absyn_TyCon_struct*_tmp28=_cycalloc(sizeof(*_tmp28));_tmp28->tag=17U,_tmp28->f1=s,_tmp28->f2=k;_tmp28;});Cyc_Absyn_app_type(_tmp18C,_tag_fat(_tmp27,sizeof(void*),0U));});});}
# 237
void*Cyc_Absyn_datatype_type(union Cyc_Absyn_DatatypeInfo di,struct Cyc_List_List*args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp2A=_cycalloc(sizeof(*_tmp2A));_tmp2A->tag=0U,({void*_tmp18D=(void*)({struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*_tmp29=_cycalloc(sizeof(*_tmp29));_tmp29->tag=18U,_tmp29->f1=di;_tmp29;});_tmp2A->f1=_tmp18D;}),_tmp2A->f2=args;_tmp2A;});}
# 240
void*Cyc_Absyn_datatype_field_type(union Cyc_Absyn_DatatypeFieldInfo di,struct Cyc_List_List*args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp2C=_cycalloc(sizeof(*_tmp2C));_tmp2C->tag=0U,({void*_tmp18E=(void*)({struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*_tmp2B=_cycalloc(sizeof(*_tmp2B));_tmp2B->tag=19U,_tmp2B->f1=di;_tmp2B;});_tmp2C->f1=_tmp18E;}),_tmp2C->f2=args;_tmp2C;});}
# 243
void*Cyc_Absyn_aggr_type(union Cyc_Absyn_AggrInfo ai,struct Cyc_List_List*args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp2E=_cycalloc(sizeof(*_tmp2E));_tmp2E->tag=0U,({void*_tmp18F=(void*)({struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_tmp2D=_cycalloc(sizeof(*_tmp2D));_tmp2D->tag=20U,_tmp2D->f1=ai;_tmp2D;});_tmp2E->f1=_tmp18F;}),_tmp2E->f2=args;_tmp2E;});}
# 247
...
({struct Cyc_Int_pa_PrintArg_struct _tmp33=({struct Cyc_Int_pa_PrintArg_struct _tmp165;_tmp165.tag=1U,_tmp165.f1=(unsigned long)((int)i);_tmp165;});void*_tmp31[1U];_tmp31[0]=& _tmp33;({struct _fat_ptr _tmp190=({const char*_tmp32="gen_float_type(%d)";_tag_fat(_tmp32,sizeof(char),19U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp190,_tag_fat(_tmp31,sizeof(void*),1U));});});}_LL0:;}
# 256
...
tufs=({struct Cyc_List_List*_tmp3E=_cycalloc(sizeof(*_tmp3E));({struct Cyc_Absyn_Datatypefield*_tmp193=({struct Cyc_Absyn_Datatypefield*_tmp3D=_cycalloc(sizeof(*_tmp3D));({struct _tuple0*_tmp192=({struct _tuple0*_tmp3C=_cycalloc(sizeof(*_tmp3C));((_tmp3C->f1).Abs_n).tag=2U,((_tmp3C->f1).Abs_n).val=0,({
struct _fat_ptr*_tmp191=({struct _fat_ptr*_tmp3B=_cycalloc(sizeof(*_tmp3B));*_tmp3B=*((struct _fat_ptr*)_check_known_subscript_notnull(builtin_exns,4U,sizeof(struct _fat_ptr),i));_tmp3B;});_tmp3C->f2=_tmp191;});_tmp3C;});
# 344
_tmp3D->name=_tmp192;}),_tmp3D->typs=0,_tmp3D->loc=0U,_tmp3D->sc=Cyc_Absyn_Extern;_tmp3D;});_tmp3E->hd=_tmp193;}),_tmp3E->tl=tufs;_tmp3E;});}}
# 348
tud_opt=({struct Cyc_Absyn_Datatypedecl*_tmp40=_cycalloc(sizeof(*_tmp40));_tmp40->sc=Cyc_Absyn_Extern,_tmp40->name=Cyc_Absyn_exn_name,_tmp40->tvs=0,({struct Cyc_Core_Opt*_tmp194=({struct Cyc_Core_Opt*_tmp3F=_cycalloc(sizeof(*_tmp3F));_tmp3F->v=tufs;_tmp3F;});_tmp40->fields=_tmp194;}),_tmp40->is_extensible=1;_tmp40;});}
# 350
...
static void*eopt=0;
if(exn_typ == 0){
eopt=Cyc_Absyn_datatype_type(({union Cyc_Absyn_DatatypeInfo _tmp166;(_tmp166.KnownDatatype).tag=2U,({struct Cyc_Absyn_Datatypedecl**_tmp196=({struct Cyc_Absyn_Datatypedecl**_tmp45=_cycalloc(sizeof(*_tmp45));({struct Cyc_Absyn_Datatypedecl*_tmp195=Cyc_Absyn_exn_tud();*_tmp45=_tmp195;});_tmp45;});(_tmp166.KnownDatatype).val=_tmp196;});_tmp166;}),0);
exn_typ=({void*_tmp199=(void*)_check_null(eopt);void*_tmp198=Cyc_Absyn_heap_rgn_type;struct Cyc_Absyn_Tqual _tmp197=Cyc_Absyn_empty_tqual(0U);Cyc_Absyn_at_type(_tmp199,_tmp198,_tmp197,Cyc_Absyn_false_type);});}
# 360
...
if(q == 0)
q=({struct _tuple0*_tmp48=_cycalloc(sizeof(*_tmp48));({union Cyc_Absyn_Nmspace _tmp19C=Cyc_Absyn_Abs_n(0,0);_tmp48->f1=_tmp19C;}),({struct _fat_ptr*_tmp19B=({struct _fat_ptr*_tmp47=_cycalloc(sizeof(*_tmp47));({struct _fat_ptr _tmp19A=({const char*_tmp46="PrintArg";_tag_fat(_tmp46,sizeof(char),9U);});*_tmp47=_tmp19A;});_tmp47;});_tmp48->f2=_tmp19B;});_tmp48;});
return(struct _tuple0*)_check_null(q);}
# 369
struct _tuple0*Cyc_Absyn_datatype_scanf_arg_qvar(){
static struct _tuple0*q=0;
if(q == 0)
q=({struct _tuple0*_tmp4B=_cycalloc(sizeof(*_tmp4B));({union Cyc_Absyn_Nmspace _tmp19F=Cyc_Absyn_Abs_n(0,0);_tmp4B->f1=_tmp19F;}),({struct _fat_ptr*_tmp19E=({struct _fat_ptr*_tmp4A=_cycalloc(sizeof(*_tmp4A));({struct _fat_ptr _tmp19D=({const char*_tmp49="ScanfArg";_tag_fat(_tmp49,sizeof(char),9U);});*_tmp4A=_tmp19D;});_tmp4A;});_tmp4B->f2=_tmp19E;});_tmp4B;});
return(struct _tuple0*)_check_null(q);}
# 381
struct _tuple0*Cyc_Absyn_uniquergn_qvar(){
static struct _tuple0*q=0;
if(q == 0)
q=({struct _tuple0*_tmp51=_cycalloc(sizeof(*_tmp51));({union Cyc_Absyn_Nmspace _tmp1A4=Cyc_Absyn_Abs_n(({struct Cyc_List_List*_tmp4E=_cycalloc(sizeof(*_tmp4E));({struct _fat_ptr*_tmp1A3=({struct _fat_ptr*_tmp4D=_cycalloc(sizeof(*_tmp4D));({struct _fat_ptr _tmp1A2=({const char*_tmp4C="Core";_tag_fat(_tmp4C,sizeof(char),5U);});*_tmp4D=_tmp1A2;});_tmp4D;});_tmp4E->hd=_tmp1A3;}),_tmp4E->tl=0;_tmp4E;}),0);_tmp51->f1=_tmp1A4;}),({struct _fat_ptr*_tmp1A1=({struct _fat_ptr*_tmp50=_cycalloc(sizeof(*_tmp50));({struct _fat_ptr _tmp1A0=({const char*_tmp4F="unique_region";_tag_fat(_tmp4F,sizeof(char),14U);});*_tmp50=_tmp1A0;});_tmp50;});_tmp51->f2=_tmp1A1;});_tmp51;});
return(struct _tuple0*)_check_null(q);}
# 387
...
void*_tmp1A9=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55->tag=1U,({void*_tmp1A8=(void*)({struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp54=_cycalloc(sizeof(*_tmp54));_tmp54->tag=1U,({struct Cyc_Absyn_Vardecl*_tmp1A7=({struct Cyc_Absyn_Vardecl*_tmp53=_cycalloc(sizeof(*_tmp53));_tmp53->sc=Cyc_Absyn_Extern,({struct _tuple0*_tmp1A6=Cyc_Absyn_uniquergn_qvar();_tmp53->name=_tmp1A6;}),_tmp53->varloc=0U,({
struct Cyc_Absyn_Tqual _tmp1A5=Cyc_Absyn_empty_tqual(0U);_tmp53->tq=_tmp1A5;}),_tmp53->type=t,_tmp53->initializer=0,_tmp53->rgn=0,_tmp53->attributes=0,_tmp53->escapes=0;_tmp53;});
# 392
_tmp54->f1=_tmp1A7;});_tmp54;});_tmp55->f1=_tmp1A8;});_tmp55;});_tmp56->r=_tmp1A9;});_tmp56;});}
# 396
...
return Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp167;_tmp167.elt_type=t,_tmp167.elt_tq=tq,(_tmp167.ptr_atts).rgn=r,(_tmp167.ptr_atts).nullable=Cyc_Absyn_true_type,(_tmp167.ptr_atts).bounds=Cyc_Absyn_fat_bound_type,(_tmp167.ptr_atts).zero_term=zt,(_tmp167.ptr_atts).ptrloc=0;_tmp167;}));}
# 409
void*Cyc_Absyn_starb_type(void*t,void*r,struct Cyc_Absyn_Tqual tq,void*b,void*zt){
return Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp168;_tmp168.elt_type=t,_tmp168.elt_tq=tq,(_tmp168.ptr_atts).rgn=r,(_tmp168.ptr_atts).nullable=Cyc_Absyn_true_type,(_tmp168.ptr_atts).bounds=b,(_tmp168.ptr_atts).zero_term=zt,(_tmp168.ptr_atts).ptrloc=0;_tmp168;}));}
# 414
void*Cyc_Absyn_atb_type(void*t,void*r,struct Cyc_Absyn_Tqual tq,void*b,void*zt){
return Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp169;_tmp169.elt_type=t,_tmp169.elt_tq=tq,(_tmp169.ptr_atts).rgn=r,(_tmp169.ptr_atts).nullable=Cyc_Absyn_false_type,(_tmp169.ptr_atts).bounds=b,(_tmp169.ptr_atts).zero_term=zt,(_tmp169.ptr_atts).ptrloc=0;_tmp169;}));}
# 419
void*Cyc_Absyn_star_type(void*t,void*r,struct Cyc_Absyn_Tqual tq,void*zeroterm){
return({void*_tmp1AD=t;void*_tmp1AC=r;struct Cyc_Absyn_Tqual _tmp1AB=tq;void*_tmp1AA=Cyc_Absyn_bounds_one();Cyc_Absyn_starb_type(_tmp1AD,_tmp1AC,_tmp1AB,_tmp1AA,zeroterm);});}
# 422
...
return({void*_tmp1B1=t;void*_tmp1B0=r;struct Cyc_Absyn_Tqual _tmp1AF=tq;void*_tmp1AE=Cyc_Absyn_bounds_one();Cyc_Absyn_atb_type(_tmp1B1,_tmp1B0,_tmp1AF,_tmp1AE,zeroterm);});}
# 428
void*Cyc_Absyn_string_type(void*rgn){
return({void*_tmp1B5=Cyc_Absyn_char_type;void*_tmp1B4=rgn;struct Cyc_Absyn_Tqual _tmp1B3=Cyc_Absyn_empty_tqual(0U);void*_tmp1B2=Cyc_Absyn_fat_bound_type;Cyc_Absyn_starb_type(_tmp1B5,_tmp1B4,_tmp1B3,_tmp1B2,Cyc_Absyn_true_type);});}
# 431
void*Cyc_Absyn_const_string_type(void*rgn){
return({void*_tmp1B9=Cyc_Absyn_char_type;void*_tmp1B8=rgn;struct Cyc_Absyn_Tqual _tmp1B7=Cyc_Absyn_const_tqual(0U);void*_tmp1B6=Cyc_Absyn_fat_bound_type;Cyc_Absyn_starb_type(_tmp1B9,_tmp1B8,_tmp1B7,_tmp1B6,Cyc_Absyn_true_type);});}
# 435
...
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp5D=_cycalloc(sizeof(*_tmp5D));_tmp5D->tag=0U,({void*_tmp1BC=(void*)({struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_tmp5C=_cycalloc(sizeof(*_tmp5C));_tmp5C->tag=20U,({union Cyc_Absyn_AggrInfo _tmp1BB=({enum Cyc_Absyn_AggrKind _tmp1BA=k;Cyc_Absyn_UnknownAggr(_tmp1BA,({struct _tuple0*_tmp5B=_cycalloc(sizeof(*_tmp5B));_tmp5B->f1=Cyc_Absyn_rel_ns_null,_tmp5B->f2=name;_tmp5B;}),0);});_tmp5C->f1=_tmp1BB;});_tmp5C;});_tmp5D->f1=_tmp1BC;}),_tmp5D->f2=0;_tmp5D;});}
# 456
...
# 466
union Cyc_Absyn_Cnst Cyc_Absyn_Char_c(enum Cyc_Absyn_Sign sn,char c){return({union Cyc_Absyn_Cnst _tmp16A;(_tmp16A.Char_c).tag=2U,((_tmp16A.Char_c).val).f1=sn,((_tmp16A.Char_c).val).f2=c;_tmp16A;});}
union Cyc_Absyn_Cnst Cyc_Absyn_Wchar_c(struct _fat_ptr s){return({union Cyc_Absyn_Cnst _tmp16B;(_tmp16B.Wchar_c).tag=3U,(_tmp16B.Wchar_c).val=s;_tmp16B;});}
union Cyc_Absyn_Cnst Cyc_Absyn_Short_c(enum Cyc_Absyn_Sign sn,short s){return({union Cyc_Absyn_Cnst _tmp16C;(_tmp16C.Short_c).tag=4U,((_tmp16C.Short_c).val).f1=sn,((_tmp16C.Short_c).val).f2=s;_tmp16C;});}
union Cyc_Absyn_Cnst Cyc_Absyn_Int_c(enum Cyc_Absyn_Sign sn,int i){return({union Cyc_Absyn_Cnst _tmp16D;(_tmp16D.Int_c).tag=5U,((_tmp16D.Int_c).val).f1=sn,((_tmp16D.Int_c).val).f2=i;_tmp16D;});}
union Cyc_Absyn_Cnst Cyc_Absyn_LongLong_c(enum Cyc_Absyn_Sign sn,long long l){return({union Cyc_Absyn_Cnst _tmp16E;(_tmp16E.LongLong_c).tag=6U,((_tmp16E.LongLong_c).val).f1=sn,((_tmp16E.LongLong_c).val).f2=l;_tmp16E;});}
union Cyc_Absyn_Cnst Cyc_Absyn_Float_c(struct _fat_ptr s,int i){return({union Cyc_Absyn_Cnst _tmp16F;(_tmp16F.Float_c).tag=7U,((_tmp16F.Float_c).val).f1=s,((_tmp16F.Float_c).val).f2=i;_tmp16F;});}
union Cyc_Absyn_Cnst Cyc_Absyn_String_c(struct _fat_ptr s){return({union Cyc_Absyn_Cnst _tmp170;(_tmp170.String_c).tag=8U,(_tmp170.String_c).val=s;_tmp170;});}
union Cyc_Absyn_Cnst Cyc_Absyn_Wstring_c(struct _fat_ptr s){return({union Cyc_Absyn_Cnst _tmp171;(_tmp171.Wstring_c).tag=9U,(_tmp171.Wstring_c).val=s;_tmp171;});}
# 476
...
return({void*_tmp1BD=(void*)({struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*_tmp5F=_cycalloc(sizeof(*_tmp5F));_tmp5F->tag=16U,_tmp5F->f1=rgn_handle,_tmp5F->f2=e;_tmp5F;});Cyc_Absyn_new_exp(_tmp1BD,loc);});}
# 482
...
return({void*_tmp1BE=(void*)({struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp61=_cycalloc(sizeof(*_tmp61));_tmp61->tag=0U,_tmp61->f1=c;_tmp61;});Cyc_Absyn_new_exp(_tmp1BE,loc);});}
# 488
...
# 492
struct Cyc_Absyn_Exp*Cyc_Absyn_int_exp(enum Cyc_Absyn_Sign s,int i,unsigned seg){return({union Cyc_Absyn_Cnst _tmp1BF=Cyc_Absyn_Int_c(s,i);Cyc_Absyn_const_exp(_tmp1BF,seg);});}
...
struct Cyc_Absyn_Exp*Cyc_Absyn_char_exp(char c,unsigned loc){return({union Cyc_Absyn_Cnst _tmp1C0=Cyc_Absyn_Char_c(Cyc_Absyn_None,c);Cyc_Absyn_const_exp(_tmp1C0,loc);});}
struct Cyc_Absyn_Exp*Cyc_Absyn_float_exp(struct _fat_ptr f,int i,unsigned loc){
return({union Cyc_Absyn_Cnst _tmp1C1=Cyc_Absyn_Float_c(f,i);Cyc_Absyn_const_exp(_tmp1C1,loc);});}
# 514
static struct Cyc_Absyn_Exp*Cyc_Absyn_str2exp(union Cyc_Absyn_Cnst(*f)(struct _fat_ptr),struct _fat_ptr s,unsigned loc){
return({union Cyc_Absyn_Cnst _tmp1C2=f(s);Cyc_Absyn_const_exp(_tmp1C2,loc);});}
# 517
...
return({void*_tmp1C4=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp63=_cycalloc(sizeof(*_tmp63));_tmp63->tag=1U,({void*_tmp1C3=(void*)({struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*_tmp62=_cycalloc(sizeof(*_tmp62));_tmp62->tag=0U,_tmp62->f1=q;_tmp62;});_tmp63->f1=_tmp1C3;});_tmp63;});Cyc_Absyn_new_exp(_tmp1C4,loc);});}
# 524
struct Cyc_Absyn_Exp*Cyc_Absyn_varb_exp(void*b,unsigned loc){
return({void*_tmp1C5=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp64=_cycalloc(sizeof(*_tmp64));_tmp64->tag=1U,_tmp64->f1=b;_tmp64;});Cyc_Absyn_new_exp(_tmp1C5,loc);});}
# 528
...
return({void*_tmp1C6=(void*)({struct Cyc_Absyn_Pragma_e_Absyn_Raw_exp_struct*_tmp65=_cycalloc(sizeof(*_tmp65));_tmp65->tag=2U,_tmp65->f1=s;_tmp65;});Cyc_Absyn_new_exp(_tmp1C6,loc);});}
# 534
struct Cyc_Absyn_Exp*Cyc_Absyn_primop_exp(enum Cyc_Absyn_Primop p,struct Cyc_List_List*es,unsigned loc){
return({void*_tmp1C7=(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp66=_cycalloc(sizeof(*_tmp66));_tmp66->tag=3U,_tmp66->f1=p,_tmp66->f2=es;_tmp66;});Cyc_Absyn_new_exp(_tmp1C7,loc);});}
# 537
struct Cyc_Absyn_Exp*Cyc_Absyn_prim1_exp(enum Cyc_Absyn_Primop p,struct Cyc_Absyn_Exp*e,unsigned loc){
return({enum Cyc_Absyn_Primop _tmp1C9=p;struct Cyc_List_List*_tmp1C8=({struct Cyc_List_List*_tmp67=_cycalloc(sizeof(*_tmp67));_tmp67->hd=e,_tmp67->tl=0;_tmp67;});Cyc_Absyn_primop_exp(_tmp1C9,_tmp1C8,loc);});}
# 540
...
return({enum Cyc_Absyn_Primop _tmp1CC=p;struct Cyc_List_List*_tmp1CB=({struct Cyc_List_List*_tmp69=_cycalloc(sizeof(*_tmp69));_tmp69->hd=e1,({struct Cyc_List_List*_tmp1CA=({struct Cyc_List_List*_tmp68=_cycalloc(sizeof(*_tmp68));_tmp68->hd=e2,_tmp68->tl=0;_tmp68;});_tmp69->tl=_tmp1CA;});_tmp69;});Cyc_Absyn_primop_exp(_tmp1CC,_tmp1CB,loc);});}
# 543
struct Cyc_Absyn_Exp*Cyc_Absyn_swap_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({void*_tmp1CD=(void*)({struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*_tmp6A=_cycalloc(sizeof(*_tmp6A));_tmp6A->tag=35U,_tmp6A->f1=e1,_tmp6A->f2=e2;_tmp6A;});Cyc_Absyn_new_exp(_tmp1CD,loc);});}
# 546
...
return({void*_tmp1CE=(void*)({struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmp6B=_cycalloc(sizeof(*_tmp6B));_tmp6B->tag=4U,_tmp6B->f1=e1,_tmp6B->f2=popt,_tmp6B->f3=e2;_tmp6B;});Cyc_Absyn_new_exp(_tmp1CE,loc);});}
# 559
...
return({void*_tmp1CF=(void*)({struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp6C=_cycalloc(sizeof(*_tmp6C));_tmp6C->tag=5U,_tmp6C->f1=e,_tmp6C->f2=i;_tmp6C;});Cyc_Absyn_new_exp(_tmp1CF,loc);});}
# 565
...
return({void*_tmp1D0=(void*)({struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_tmp6D=_cycalloc(sizeof(*_tmp6D));_tmp6D->tag=6U,_tmp6D->f1=e1,_tmp6D->f2=e2,_tmp6D->f3=e3;_tmp6D;});Cyc_Absyn_new_exp(_tmp1D0,loc);});}
# 568
struct Cyc_Absyn_Exp*Cyc_Absyn_and_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({void*_tmp1D1=(void*)({struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_tmp6E=_cycalloc(sizeof(*_tmp6E));_tmp6E->tag=7U,_tmp6E->f1=e1,_tmp6E->f2=e2;_tmp6E;});Cyc_Absyn_new_exp(_tmp1D1,loc);});}
# 571
struct Cyc_Absyn_Exp*Cyc_Absyn_or_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({void*_tmp1D2=(void*)({struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_tmp6F=_cycalloc(sizeof(*_tmp6F));_tmp6F->tag=8U,_tmp6F->f1=e1,_tmp6F->f2=e2;_tmp6F;});Cyc_Absyn_new_exp(_tmp1D2,loc);});}
# 574
struct Cyc_Absyn_Exp*Cyc_Absyn_seq_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({void*_tmp1D3=(void*)({struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_tmp70=_cycalloc(sizeof(*_tmp70));_tmp70->tag=9U,_tmp70->f1=e1,_tmp70->f2=e2;_tmp70;});Cyc_Absyn_new_exp(_tmp1D3,loc);});}
# 577
struct Cyc_Absyn_Exp*Cyc_Absyn_unknowncall_exp(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*es,unsigned loc){
return({void*_tmp1D4=(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp71=_cycalloc(sizeof(*_tmp71));_tmp71->tag=10U,_tmp71->f1=e,_tmp71->f2=es,_tmp71->f3=0,_tmp71->f4=0;_tmp71;});Cyc_Absyn_new_exp(_tmp1D4,loc);});}
# 580
struct Cyc_Absyn_Exp*Cyc_Absyn_fncall_exp(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*es,unsigned loc){
return({void*_tmp1D5=(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp72=_cycalloc(sizeof(*_tmp72));_tmp72->tag=10U,_tmp72->f1=e,_tmp72->f2=es,_tmp72->f3=0,_tmp72->f4=1;_tmp72;});Cyc_Absyn_new_exp(_tmp1D5,loc);});}
# 583
struct Cyc_Absyn_Exp*Cyc_Absyn_noinstantiate_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1D6=(void*)({struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*_tmp73=_cycalloc(sizeof(*_tmp73));_tmp73->tag=12U,_tmp73->f1=e;_tmp73;});Cyc_Absyn_new_exp(_tmp1D6,loc);});}
# 586
struct Cyc_Absyn_Exp*Cyc_Absyn_instantiate_exp(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*ts,unsigned loc){
return({void*_tmp1D7=(void*)({struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*_tmp74=_cycalloc(sizeof(*_tmp74));_tmp74->tag=13U,_tmp74->f1=e,_tmp74->f2=ts;_tmp74;});Cyc_Absyn_new_exp(_tmp1D7,loc);});}
# 589
...
return({void*_tmp1D8=(void*)({struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp75=_cycalloc(sizeof(*_tmp75));_tmp75->tag=14U,_tmp75->f1=t,_tmp75->f2=e,_tmp75->f3=user_cast,_tmp75->f4=c;_tmp75;});Cyc_Absyn_new_exp(_tmp1D8,loc);});}
# 592
struct Cyc_Absyn_Exp*Cyc_Absyn_throw_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1D9=(void*)({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_tmp76=_cycalloc(sizeof(*_tmp76));_tmp76->tag=11U,_tmp76->f1=e,_tmp76->f2=0;_tmp76;});Cyc_Absyn_new_exp(_tmp1D9,loc);});}
# 595
struct Cyc_Absyn_Exp*Cyc_Absyn_rethrow_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1DA=(void*)({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_tmp77=_cycalloc(sizeof(*_tmp77));_tmp77->tag=11U,_tmp77->f1=e,_tmp77->f2=1;_tmp77;});Cyc_Absyn_new_exp(_tmp1DA,loc);});}
# 598
struct Cyc_Absyn_Exp*Cyc_Absyn_address_exp(struct Cyc_Absyn_Exp*e,unsigned loc){return({void*_tmp1DB=(void*)({struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*_tmp78=_cycalloc(sizeof(*_tmp78));_tmp78->tag=15U,_tmp78->f1=e;_tmp78;});Cyc_Absyn_new_exp(_tmp1DB,loc);});}
struct Cyc_Absyn_Exp*Cyc_Absyn_sizeoftype_exp(void*t,unsigned loc){
return({void*_tmp1DC=(void*)({struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*_tmp79=_cycalloc(sizeof(*_tmp79));_tmp79->tag=17U,_tmp79->f1=t;_tmp79;});Cyc_Absyn_new_exp(_tmp1DC,loc);});}
# 602
struct Cyc_Absyn_Exp*Cyc_Absyn_sizeofexp_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1DD=(void*)({struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*_tmp7A=_cycalloc(sizeof(*_tmp7A));_tmp7A->tag=18U,_tmp7A->f1=e;_tmp7A;});Cyc_Absyn_new_exp(_tmp1DD,loc);});}
# 605
struct Cyc_Absyn_Exp*Cyc_Absyn_offsetof_exp(void*t,struct Cyc_List_List*ofs,unsigned loc){
return({void*_tmp1DE=(void*)({struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmp7B=_cycalloc(sizeof(*_tmp7B));_tmp7B->tag=19U,_tmp7B->f1=t,_tmp7B->f2=ofs;_tmp7B;});Cyc_Absyn_new_exp(_tmp1DE,loc);});}
# 608
struct Cyc_Absyn_Exp*Cyc_Absyn_deref_exp(struct Cyc_Absyn_Exp*e,unsigned loc){return({void*_tmp1DF=(void*)({struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_tmp7C=_cycalloc(sizeof(*_tmp7C));_tmp7C->tag=20U,_tmp7C->f1=e;_tmp7C;});Cyc_Absyn_new_exp(_tmp1DF,loc);});}
struct Cyc_Absyn_Exp*Cyc_Absyn_aggrmember_exp(struct Cyc_Absyn_Exp*e,struct _fat_ptr*n,unsigned loc){
return({void*_tmp1E0=(void*)({struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_tmp7D=_cycalloc(sizeof(*_tmp7D));_tmp7D->tag=21U,_tmp7D->f1=e,_tmp7D->f2=n,_tmp7D->f3=0,_tmp7D->f4=0;_tmp7D;});Cyc_Absyn_new_exp(_tmp1E0,loc);});}
# 612
struct Cyc_Absyn_Exp*Cyc_Absyn_aggrarrow_exp(struct Cyc_Absyn_Exp*e,struct _fat_ptr*n,unsigned loc){
return({void*_tmp1E1=(void*)({struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp7E=_cycalloc(sizeof(*_tmp7E));_tmp7E->tag=22U,_tmp7E->f1=e,_tmp7E->f2=n,_tmp7E->f3=0,_tmp7E->f4=0;_tmp7E;});Cyc_Absyn_new_exp(_tmp1E1,loc);});}
# 615
struct Cyc_Absyn_Exp*Cyc_Absyn_subscript_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({void*_tmp1E2=(void*)({struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*_tmp7F=_cycalloc(sizeof(*_tmp7F));_tmp7F->tag=23U,_tmp7F->f1=e1,_tmp7F->f2=e2;_tmp7F;});Cyc_Absyn_new_exp(_tmp1E2,loc);});}
# 618
struct Cyc_Absyn_Exp*Cyc_Absyn_tuple_exp(struct Cyc_List_List*es,unsigned loc){
return({void*_tmp1E3=(void*)({struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*_tmp80=_cycalloc(sizeof(*_tmp80));_tmp80->tag=24U,_tmp80->f1=es;_tmp80;});Cyc_Absyn_new_exp(_tmp1E3,loc);});}
# 621
struct Cyc_Absyn_Exp*Cyc_Absyn_stmt_exp(struct Cyc_Absyn_Stmt*s,unsigned loc){
return({void*_tmp1E4=(void*)({struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_tmp81=_cycalloc(sizeof(*_tmp81));_tmp81->tag=37U,_tmp81->f1=s;_tmp81;});Cyc_Absyn_new_exp(_tmp1E4,loc);});}
# 624
struct Cyc_Absyn_Exp*Cyc_Absyn_valueof_exp(void*t,unsigned loc){
return({void*_tmp1E5=(void*)({struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp82=_cycalloc(sizeof(*_tmp82));_tmp82->tag=39U,_tmp82->f1=t;_tmp82;});Cyc_Absyn_new_exp(_tmp1E5,loc);});}
# 628
...
# 631
return({void*_tmp1E6=(void*)({struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*_tmp83=_cycalloc(sizeof(*_tmp83));_tmp83->tag=40U,_tmp83->f1=volatile_kw,_tmp83->f2=tmpl,_tmp83->f3=outs,_tmp83->f4=ins,_tmp83->f5=clobs;_tmp83;});Cyc_Absyn_new_exp(_tmp1E6,loc);});}
# 633
struct Cyc_Absyn_Exp*Cyc_Absyn_extension_exp(struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1E7=(void*)({struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*_tmp84=_cycalloc(sizeof(*_tmp84));_tmp84->tag=41U,_tmp84->f1=e;_tmp84;});Cyc_Absyn_new_exp(_tmp1E7,loc);});}struct _tuple12{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
# 637
struct Cyc_Absyn_Exp*Cyc_Absyn_array_exp(struct Cyc_List_List*es,unsigned loc){
struct Cyc_List_List*_tmp85=0;struct Cyc_List_List*dles=_tmp85;
for(0;es != 0;es=es->tl){
dles=({struct Cyc_List_List*_tmp87=_cycalloc(sizeof(*_tmp87));({struct _tuple12*_tmp1E8=({struct _tuple12*_tmp86=_cycalloc(sizeof(*_tmp86));_tmp86->f1=0,_tmp86->f2=(struct Cyc_Absyn_Exp*)es->hd;_tmp86;});_tmp87->hd=_tmp1E8;}),_tmp87->tl=dles;_tmp87;});}
dles=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);
return({void*_tmp1E9=(void*)({struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_tmp88=_cycalloc(sizeof(*_tmp88));_tmp88->tag=26U,_tmp88->f1=dles;_tmp88;});Cyc_Absyn_new_exp(_tmp1E9,loc);});}
# 644
struct Cyc_Absyn_Exp*Cyc_Absyn_unresolvedmem_exp(struct Cyc_Core_Opt*n,struct Cyc_List_List*dles,unsigned loc){
# 647
return({void*_tmp1EA=(void*)({struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmp89=_cycalloc(sizeof(*_tmp89));_tmp89->tag=36U,_tmp89->f1=n,_tmp89->f2=dles;_tmp89;});Cyc_Absyn_new_exp(_tmp1EA,loc);});}
# 650
...
struct Cyc_Absyn_Stmt*Cyc_Absyn_exp_stmt(struct Cyc_Absyn_Exp*e,unsigned loc){return({void*_tmp1EB=(void*)({struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*_tmp8B=_cycalloc(sizeof(*_tmp8B));_tmp8B->tag=1U,_tmp8B->f1=e;_tmp8B;});Cyc_Absyn_new_stmt(_tmp1EB,loc);});}
struct Cyc_Absyn_Stmt*Cyc_Absyn_return_stmt(struct Cyc_Absyn_Exp*e,unsigned loc){return({void*_tmp1EC=(void*)({struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*_tmp8C=_cycalloc(sizeof(*_tmp8C));_tmp8C->tag=3U,_tmp8C->f1=e;_tmp8C;});Cyc_Absyn_new_stmt(_tmp1EC,loc);});}
...
return({struct Cyc_Absyn_Stmt*_tmp1EE=(struct Cyc_Absyn_Stmt*)ss->hd;struct Cyc_Absyn_Stmt*_tmp1ED=Cyc_Absyn_seq_stmts(ss->tl,loc);Cyc_Absyn_seq_stmt(_tmp1EE,_tmp1ED,loc);});}}}struct _tuple13{void*f1;void*f2;};
# 666
struct Cyc_Absyn_Stmt*Cyc_Absyn_seq_stmt(struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2,unsigned loc){
struct _tuple13 _tmp8D=({struct _tuple13 _tmp172;_tmp172.f1=s1->r,_tmp172.f2=s2->r;_tmp172;});struct _tuple13 _stmttmp3=_tmp8D;struct _tuple13 _tmp8E=_stmttmp3;if(((struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*)_tmp8E.f1)->tag == 0U){_LL1: _LL2:
 return s2;}else{if(((struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*)_tmp8E.f2)->tag == 0U){_LL3: _LL4:
 return s1;}else{_LL5: _LL6:
 return({void*_tmp1EF=(void*)({struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmp8F=_cycalloc(sizeof(*_tmp8F));_tmp8F->tag=2U,_tmp8F->f1=s1,_tmp8F->f2=s2;_tmp8F;});Cyc_Absyn_new_stmt(_tmp1EF,loc);});}}_LL0:;}
# 673
...
return({void*_tmp1F0=(void*)({struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*_tmp90=_cycalloc(sizeof(*_tmp90));_tmp90->tag=4U,_tmp90->f1=e,_tmp90->f2=s1,_tmp90->f3=s2;_tmp90;});Cyc_Absyn_new_stmt(_tmp1F0,loc);});}
# 676
struct Cyc_Absyn_Stmt*Cyc_Absyn_while_stmt(struct Cyc_Absyn_Exp*e,struct Cyc_Absyn_Stmt*s,unsigned loc){
return({void*_tmp1F2=(void*)({struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*_tmp91=_cycalloc(sizeof(*_tmp91));_tmp91->tag=5U,(_tmp91->f1).f1=e,({struct Cyc_Absyn_Stmt*_tmp1F1=Cyc_Absyn_skip_stmt(e->loc);(_tmp91->f1).f2=_tmp1F1;}),_tmp91->f2=s;_tmp91;});Cyc_Absyn_new_stmt(_tmp1F2,loc);});}
# 679
...
return({void*_tmp1F5=(void*)({struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*_tmp92=_cycalloc(sizeof(*_tmp92));_tmp92->tag=9U,_tmp92->f1=e1,(_tmp92->f2).f1=e2,({struct Cyc_Absyn_Stmt*_tmp1F4=Cyc_Absyn_skip_stmt(e3->loc);(_tmp92->f2).f2=_tmp1F4;}),
(_tmp92->f3).f1=e3,({struct Cyc_Absyn_Stmt*_tmp1F3=Cyc_Absyn_skip_stmt(e3->loc);(_tmp92->f3).f2=_tmp1F3;}),_tmp92->f4=s;_tmp92;});
# 680
Cyc_Absyn_new_stmt(_tmp1F5,loc);});}
# 684
struct Cyc_Absyn_Stmt*Cyc_Absyn_do_stmt(struct Cyc_Absyn_Stmt*s,struct Cyc_Absyn_Exp*e,unsigned loc){
return({void*_tmp1F7=(void*)({struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*_tmp93=_cycalloc(sizeof(*_tmp93));_tmp93->tag=14U,_tmp93->f1=s,(_tmp93->f2).f1=e,({struct Cyc_Absyn_Stmt*_tmp1F6=Cyc_Absyn_skip_stmt(e->loc);(_tmp93->f2).f2=_tmp1F6;});_tmp93;});Cyc_Absyn_new_stmt(_tmp1F7,loc);});}
# 687
struct Cyc_Absyn_Stmt*Cyc_Absyn_switch_stmt(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*scs,unsigned loc){
return({void*_tmp1F8=(void*)({struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*_tmp94=_cycalloc(sizeof(*_tmp94));_tmp94->tag=10U,_tmp94->f1=e,_tmp94->f2=scs,_tmp94->f3=0;_tmp94;});Cyc_Absyn_new_stmt(_tmp1F8,loc);});}
# 690
struct Cyc_Absyn_Stmt*Cyc_Absyn_trycatch_stmt(struct Cyc_Absyn_Stmt*s,struct Cyc_List_List*scs,unsigned loc){
return({void*_tmp1F9=(void*)({struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*_tmp95=_cycalloc(sizeof(*_tmp95));_tmp95->tag=15U,_tmp95->f1=s,_tmp95->f2=scs,_tmp95->f3=0;_tmp95;});Cyc_Absyn_new_stmt(_tmp1F9,loc);});}
# 693
struct Cyc_Absyn_Stmt*Cyc_Absyn_fallthru_stmt(struct Cyc_List_List*el,unsigned loc){
return({void*_tmp1FA=(void*)({struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*_tmp96=_cycalloc(sizeof(*_tmp96));_tmp96->tag=11U,_tmp96->f1=el,_tmp96->f2=0;_tmp96;});Cyc_Absyn_new_stmt(_tmp1FA,loc);});}
# 696
struct Cyc_Absyn_Stmt*Cyc_Absyn_goto_stmt(struct _fat_ptr*lab,unsigned loc){
return({void*_tmp1FB=(void*)({struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*_tmp97=_cycalloc(sizeof(*_tmp97));_tmp97->tag=8U,_tmp97->f1=lab;_tmp97;});Cyc_Absyn_new_stmt(_tmp1FB,loc);});}
# 699
struct Cyc_Absyn_Stmt*Cyc_Absyn_label_stmt(struct _fat_ptr*v,struct Cyc_Absyn_Stmt*s,unsigned loc){
return({void*_tmp1FC=(void*)({struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*_tmp98=_cycalloc(sizeof(*_tmp98));_tmp98->tag=13U,_tmp98->f1=v,_tmp98->f2=s;_tmp98;});Cyc_Absyn_new_stmt(_tmp1FC,loc);});}
# 702
struct Cyc_Absyn_Stmt*Cyc_Absyn_decl_stmt(struct Cyc_Absyn_Decl*d,struct Cyc_Absyn_Stmt*s,unsigned loc){
return({void*_tmp1FD=(void*)({struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*_tmp99=_cycalloc(sizeof(*_tmp99));_tmp99->tag=12U,_tmp99->f1=d,_tmp99->f2=s;_tmp99;});Cyc_Absyn_new_stmt(_tmp1FD,loc);});}
# 705
...
struct Cyc_Absyn_Decl*d=({void*_tmp1FF=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp9B=_cycalloc(sizeof(*_tmp9B));_tmp9B->tag=0U,({struct Cyc_Absyn_Vardecl*_tmp1FE=Cyc_Absyn_new_vardecl(0U,x,t,init);_tmp9B->f1=_tmp1FE;});_tmp9B;});Cyc_Absyn_new_decl(_tmp1FF,loc);});
return({void*_tmp200=(void*)({struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*_tmp9A=_cycalloc(sizeof(*_tmp9A));_tmp9A->tag=12U,_tmp9A->f1=d,_tmp9A->f2=s;_tmp9A;});Cyc_Absyn_new_stmt(_tmp200,loc);});}
# 709
struct Cyc_Absyn_Stmt*Cyc_Absyn_assign_stmt(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned loc){
return({struct Cyc_Absyn_Exp*_tmp201=Cyc_Absyn_assign_exp(e1,e2,loc);Cyc_Absyn_exp_stmt(_tmp201,loc);});}
# 713
...
struct Cyc_Absyn_Pat*Cyc_Absyn_exp_pat(struct Cyc_Absyn_Exp*e){return({void*_tmp202=(void*)({struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*_tmp9D=_cycalloc(sizeof(*_tmp9D));_tmp9D->tag=17U,_tmp9D->f1=e;_tmp9D;});Cyc_Absyn_new_pat(_tmp202,e->loc);});}
...
return({void*_tmp203=(void*)({struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*_tmp9F=_cycalloc(sizeof(*_tmp9F));_tmp9F->tag=2U,_tmp9F->f1=p,_tmp9F->f2=0,_tmp9F->f3=e,_tmp9F->f4=0;_tmp9F;});Cyc_Absyn_new_decl(_tmp203,loc);});}
# 723
struct Cyc_Absyn_Decl*Cyc_Absyn_letv_decl(struct Cyc_List_List*vds,unsigned loc){
return({void*_tmp204=(void*)({struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*_tmpA0=_cycalloc(sizeof(*_tmpA0));_tmpA0->tag=3U,_tmpA0->f1=vds;_tmpA0;});Cyc_Absyn_new_decl(_tmp204,loc);});}
# 726
...
return({void*_tmp205=(void*)({struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*_tmpA1=_cycalloc(sizeof(*_tmpA1));_tmpA1->tag=4U,_tmpA1->f1=tv,_tmpA1->f2=vd,_tmpA1->f3=open_exp;_tmpA1;});Cyc_Absyn_new_decl(_tmp205,loc);});}
# 729
...
# 731
return({void*_tmp208=(void*)({struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*_tmpA3=_cycalloc(sizeof(*_tmpA3));_tmpA3->tag=2U,({struct Cyc_Absyn_Pat*_tmp207=({void*_tmp206=(void*)({struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*_tmpA2=_cycalloc(sizeof(*_tmpA2));_tmpA2->tag=2U,_tmpA2->f1=tv,_tmpA2->f2=vd;_tmpA2;});Cyc_Absyn_new_pat(_tmp206,loc);});_tmpA3->f1=_tmp207;}),_tmpA3->f2=0,_tmpA3->f3=e,_tmpA3->f4=0;_tmpA3;});Cyc_Absyn_new_decl(_tmp208,loc);});}
# 734
...
struct Cyc_Absyn_Tqual _tmp209=Cyc_Absyn_empty_tqual(0U);_tmpA4->tq=_tmp209;}),_tmpA4->type=t,_tmpA4->initializer=init,_tmpA4->rgn=0,_tmpA4->attributes=0,_tmpA4->escapes=0;_tmpA4;});}
# 740
struct Cyc_Absyn_Vardecl*Cyc_Absyn_static_vardecl(struct _tuple0*x,void*t,struct Cyc_Absyn_Exp*init){
return({struct Cyc_Absyn_Vardecl*_tmpA5=_cycalloc(sizeof(*_tmpA5));_tmpA5->sc=Cyc_Absyn_Static,_tmpA5->name=x,_tmpA5->varloc=0U,({struct Cyc_Absyn_Tqual _tmp20A=Cyc_Absyn_empty_tqual(0U);_tmpA5->tq=_tmp20A;}),_tmpA5->type=t,_tmpA5->initializer=init,_tmpA5->rgn=0,_tmpA5->attributes=0,_tmpA5->escapes=0;_tmpA5;});}
# 745
...
# 755
return({void*_tmp20C=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmpA8=_cycalloc(sizeof(*_tmpA8));_tmpA8->tag=5U,({struct Cyc_Absyn_Aggrdecl*_tmp20B=({struct Cyc_Absyn_Aggrdecl*_tmpA7=_cycalloc(sizeof(*_tmpA7));_tmpA7->kind=k,_tmpA7->sc=s,_tmpA7->name=n,_tmpA7->tvs=ts,_tmpA7->impl=i,_tmpA7->attributes=atts,_tmpA7->expected_mem_kind=0;_tmpA7;});_tmpA8->f1=_tmp20B;});_tmpA8;});Cyc_Absyn_new_decl(_tmp20C,loc);});}
# 760
...
# 763
return({struct Cyc_Absyn_TypeDecl*_tmpAB=_cycalloc(sizeof(*_tmpAB));({void*_tmp20E=(void*)({struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*_tmpAA=_cycalloc(sizeof(*_tmpAA));_tmpAA->tag=0U,({struct Cyc_Absyn_Aggrdecl*_tmp20D=({struct Cyc_Absyn_Aggrdecl*_tmpA9=_cycalloc(sizeof(*_tmpA9));_tmpA9->kind=k,_tmpA9->sc=s,_tmpA9->name=n,_tmpA9->tvs=ts,_tmpA9->impl=i,_tmpA9->attributes=atts,_tmpA9->expected_mem_kind=0;_tmpA9;});_tmpAA->f1=_tmp20D;});_tmpAA;});_tmpAB->r=_tmp20E;}),_tmpAB->loc=loc;_tmpAB;});}
# 769
...
# 782
return({void*_tmp210=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmpAD=_cycalloc(sizeof(*_tmpAD));_tmpAD->tag=6U,({struct Cyc_Absyn_Datatypedecl*_tmp20F=({struct Cyc_Absyn_Datatypedecl*_tmpAC=_cycalloc(sizeof(*_tmpAC));_tmpAC->sc=s,_tmpAC->name=n,_tmpAC->tvs=ts,_tmpAC->fields=fs,_tmpAC->is_extensible=is_extensible;_tmpAC;});_tmpAD->f1=_tmp20F;});_tmpAD;});Cyc_Absyn_new_decl(_tmp210,loc);});}
# 785
...
# 788
return({struct Cyc_Absyn_TypeDecl*_tmpB0=_cycalloc(sizeof(*_tmpB0));({void*_tmp212=(void*)({struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*_tmpAF=_cycalloc(sizeof(*_tmpAF));_tmpAF->tag=2U,({struct Cyc_Absyn_Datatypedecl*_tmp211=({struct Cyc_Absyn_Datatypedecl*_tmpAE=_cycalloc(sizeof(*_tmpAE));_tmpAE->sc=s,_tmpAE->name=n,_tmpAE->tvs=ts,_tmpAE->fields=fs,_tmpAE->is_extensible=is_extensible;_tmpAE;});_tmpAF->f1=_tmp211;});_tmpAF;});_tmpB0->r=_tmp212;}),_tmpB0->loc=loc;_tmpB0;});}
# 800 "absyn.cyc"
...
# 806
{struct Cyc_List_List*_tmpB1=args;struct Cyc_List_List*args2=_tmpB1;for(0;args2 != 0;args2=args2->tl){
({void*_tmp213=Cyc_Absyn_pointer_expand((*((struct _tuple8*)args2->hd)).f3,1);(*((struct _tuple8*)args2->hd)).f3=_tmp213;});}}
...
# 826
struct Cyc_Absyn_Tqual _tmp215=
# 830
Cyc_Absyn_empty_tqual(0U);
# 826
Cyc_Absyn_at_type(_tmp217,_tmp216,_tmp215,Cyc_Absyn_false_type);});}else{_LL3: _LL4:
# 831
 return t;}_LL0:;}
# 846 "absyn.cyc"
int Cyc_Absyn_is_lvalue(struct Cyc_Absyn_Exp*e){
void*_tmpB6=e->r;void*_stmttmp5=_tmpB6;void*_tmpB7=_stmttmp5;struct Cyc_Absyn_Exp*_tmpB8;struct Cyc_Absyn_Exp*_tmpB9;struct Cyc_Absyn_Exp*_tmpBA;struct Cyc_Absyn_Vardecl*_tmpBB;struct Cyc_Absyn_Vardecl*_tmpBC;switch(*((int*)_tmpB7)){case 1U: switch(*((int*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmpB7)->f1)){case 2U: _LL1: _LL2:
 return 0;case 1U: _LL3: _tmpBC=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmpB7)->f1)->f1;_LL4: {struct Cyc_Absyn_Vardecl*vd=_tmpBC;
_tmpBB=vd;goto _LL6;}case 4U: _LL5: _tmpBB=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmpB7)->f1)->f1;_LL6: {struct Cyc_Absyn_Vardecl*vd=_tmpBB;
# 851
void*_tmpBD=Cyc_Tcutil_compress(vd->type);void*_stmttmp6=_tmpBD;void*_tmpBE=_stmttmp6;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmpBE)->tag == 4U){_LL18: _LL19:
...
# 855
 ...
 return 1;case 21U: _LLF: _tmpBA=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpB7)->f1;_LL10: {struct Cyc_Absyn_Exp*e1=_tmpBA;
return Cyc_Absyn_is_lvalue(e1);}case 13U: _LL11: _tmpB9=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmpB7)->f1;_LL12: {struct Cyc_Absyn_Exp*e1=_tmpB9;
return Cyc_Absyn_is_lvalue(e1);}case 12U: _LL13: _tmpB8=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmpB7)->f1;_LL14: {struct Cyc_Absyn_Exp*e1=_tmpB8;
...
{struct Cyc_List_List*_tmpBF=fields;struct Cyc_List_List*fs=_tmpBF;for(0;fs != 0;fs=fs->tl){
...
# 887
struct _fat_ptr*Cyc_Absyn_decl_name(struct Cyc_Absyn_Decl*decl){
void*_tmpC0=decl->r;void*_stmttmp7=_tmpC0;void*_tmpC1=_stmttmp7;struct Cyc_Absyn_Fndecl*_tmpC2;struct Cyc_Absyn_Vardecl*_tmpC3;struct Cyc_Absyn_Typedefdecl*_tmpC4;struct Cyc_Absyn_Enumdecl*_tmpC5;struct Cyc_Absyn_Aggrdecl*_tmpC6;switch(*((int*)_tmpC1)){case 5U: _LL1: _tmpC6=((struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*)_tmpC1)->f1;_LL2: {struct Cyc_Absyn_Aggrdecl*x=_tmpC6;
return(*x->name).f2;}case 7U: _LL3: _tmpC5=((struct Cyc_Absyn_Enum_d_Absyn_Raw_decl_struct*)_tmpC1)->f1;_LL4: {struct Cyc_Absyn_Enumdecl*x=_tmpC5;
return(*x->name).f2;}case 8U: _LL5: _tmpC4=((struct Cyc_Absyn_Typedef_d_Absyn_Raw_decl_struct*)_tmpC1)->f1;_LL6: {struct Cyc_Absyn_Typedefdecl*x=_tmpC4;
return(*x->name).f2;}case 0U: _LL7: _tmpC3=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmpC1)->f1;_LL8: {struct Cyc_Absyn_Vardecl*x=_tmpC3;
return(*x->name).f2;}case 1U: _LL9: _tmpC2=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_tmpC1)->f1;_LLA: {struct Cyc_Absyn_Fndecl*x=_tmpC2;
...
void*_tmpC7=a;struct _fat_ptr _tmpC8;struct _fat_ptr _tmpC9;int _tmpCA;int _tmpCB;int _tmpCC;int _tmpCE;int _tmpCD;int _tmpD0;int _tmpCF;struct _fat_ptr _tmpD1;struct Cyc_Absyn_Exp*_tmpD2;int _tmpD3;switch(*((int*)_tmpC7)){case 0U: _LL1: _tmpD3=((struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmpC7)->f1;_LL2: {int i=_tmpD3;
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpD6=({struct Cyc_Int_pa_PrintArg_struct _tmp173;_tmp173.tag=1U,_tmp173.f1=(unsigned long)i;_tmp173;});void*_tmpD4[1U];_tmpD4[0]=& _tmpD6;({struct _fat_ptr _tmp218=({const char*_tmpD5="regparm(%d)";_tag_fat(_tmpD5,sizeof(char),12U);});Cyc_aprintf(_tmp218,_tag_fat(_tmpD4,sizeof(void*),1U));});});}case 1U: _LL3: _LL4:
 return({const char*_tmpD7="stdcall";_tag_fat(_tmpD7,sizeof(char),8U);});case 2U: _LL5: _LL6:
 return({const char*_tmpD8="cdecl";_tag_fat(_tmpD8,sizeof(char),6U);});case 3U: _LL7: _LL8:
 return({const char*_tmpD9="fastcall";_tag_fat(_tmpD9,sizeof(char),9U);});case 4U: _LL9: _LLA:
 return({const char*_tmpDA="noreturn";_tag_fat(_tmpDA,sizeof(char),9U);});case 5U: _LLB: _LLC:
 return({const char*_tmpDB="const";_tag_fat(_tmpDB,sizeof(char),6U);});case 6U: _LLD: _tmpD2=((struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)_tmpC7)->f1;_LLE: {struct Cyc_Absyn_Exp*e=_tmpD2;
# 948
if(e == 0)return({const char*_tmpDC="aligned";_tag_fat(_tmpDC,sizeof(char),8U);});else{
# 950
enum Cyc_Cyclone_C_Compilers _tmpDD=Cyc_Cyclone_c_compiler;switch(_tmpDD){case Cyc_Cyclone_Gcc_c: _LL3A: _LL3B:
 return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpE0=({struct Cyc_String_pa_PrintArg_struct _tmp174;_tmp174.tag=0U,({struct _fat_ptr _tmp219=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp174.f1=_tmp219;});_tmp174;});void*_tmpDE[1U];_tmpDE[0]=& _tmpE0;({struct _fat_ptr _tmp21A=({const char*_tmpDF="aligned(%s)";_tag_fat(_tmpDF,sizeof(char),12U);});Cyc_aprintf(_tmp21A,_tag_fat(_tmpDE,sizeof(void*),1U));});});case Cyc_Cyclone_Vc_c: _LL3C: _LL3D:
 goto _LL3F;default: _LL3E: _LL3F:
 return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpE3=({struct Cyc_String_pa_PrintArg_struct _tmp175;_tmp175.tag=0U,({struct _fat_ptr _tmp21B=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp175.f1=_tmp21B;});_tmp175;});void*_tmpE1[1U];_tmpE1[0]=& _tmpE3;({struct _fat_ptr _tmp21C=({const char*_tmpE2="align(%s)";_tag_fat(_tmpE2,sizeof(char),10U);});Cyc_aprintf(_tmp21C,_tag_fat(_tmpE1,sizeof(void*),1U));});});}_LL39:;}}case 7U: _LLF: _LL10:
# 955
 return({const char*_tmpE4="packed";_tag_fat(_tmpE4,sizeof(char),7U);});case 8U: _LL11: _tmpD1=((struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*)_tmpC7)->f1;_LL12: {struct _fat_ptr s=_tmpD1;
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpE7=({struct Cyc_String_pa_PrintArg_struct _tmp176;_tmp176.tag=0U,_tmp176.f1=(struct _fat_ptr)((struct _fat_ptr)s);_tmp176;});void*_tmpE5[1U];_tmpE5[0]=& _tmpE7;({struct _fat_ptr _tmp21D=({const char*_tmpE6="section(\"%s\")";_tag_fat(_tmpE6,sizeof(char),14U);});Cyc_aprintf(_tmp21D,_tag_fat(_tmpE5,sizeof(void*),1U));});});}case 9U: _LL13: _LL14:
 return({const char*_tmpE8="nocommon";_tag_fat(_tmpE8,sizeof(char),9U);});case 10U: _LL15: _LL16:
 return({const char*_tmpE9="shared";_tag_fat(_tmpE9,sizeof(char),7U);});case 11U: _LL17: _LL18:
 return({const char*_tmpEA="unused";_tag_fat(_tmpEA,sizeof(char),7U);});case 12U: _LL19: _LL1A:
 return({const char*_tmpEB="weak";_tag_fat(_tmpEB,sizeof(char),5U);});case 13U: _LL1B: _LL1C:
 return({const char*_tmpEC="dllimport";_tag_fat(_tmpEC,sizeof(char),10U);});case 14U: _LL1D: _LL1E:
 return({const char*_tmpED="dllexport";_tag_fat(_tmpED,sizeof(char),10U);});case 15U: _LL1F: _LL20:
 return({const char*_tmpEE="no_instrument_function";_tag_fat(_tmpEE,sizeof(char),23U);});case 16U: _LL21: _LL22:
 return({const char*_tmpEF="constructor";_tag_fat(_tmpEF,sizeof(char),12U);});case 17U: _LL23: _LL24:
 return({const char*_tmpF0="destructor";_tag_fat(_tmpF0,sizeof(char),11U);});case 18U: _LL25: _LL26:
 return({const char*_tmpF1="no_check_memory_usage";_tag_fat(_tmpF1,sizeof(char),22U);});case 19U: if(((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmpC7)->f1 == Cyc_Absyn_Printf_ft){_LL27: _tmpCF=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmpC7)->f2;_tmpD0=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmpC7)->f3;_LL28: {int n=_tmpCF;int m=_tmpD0;
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpF4=({struct Cyc_Int_pa_PrintArg_struct _tmp178;_tmp178.tag=1U,_tmp178.f1=(unsigned)n;_tmp178;});struct Cyc_Int_pa_PrintArg_struct _tmpF5=({struct Cyc_Int_pa_PrintArg_struct _tmp177;_tmp177.tag=1U,_tmp177.f1=(unsigned)m;_tmp177;});void*_tmpF2[2U];_tmpF2[0]=& _tmpF4,_tmpF2[1]=& _tmpF5;({struct _fat_ptr _tmp21E=({const char*_tmpF3="format(printf,%u,%u)";_tag_fat(_tmpF3,sizeof(char),21U);});Cyc_aprintf(_tmp21E,_tag_fat(_tmpF2,sizeof(void*),2U));});});}}else{_LL29: _tmpCD=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmpC7)->f2;_tmpCE=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmpC7)->f3;_LL2A: {int n=_tmpCD;int m=_tmpCE;
# 969
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpF8=({struct Cyc_Int_pa_PrintArg_struct _tmp17A;_tmp17A.tag=1U,_tmp17A.f1=(unsigned)n;_tmp17A;});struct Cyc_Int_pa_PrintArg_struct _tmpF9=({struct Cyc_Int_pa_PrintArg_struct _tmp179;_tmp179.tag=1U,_tmp179.f1=(unsigned)m;_tmp179;});void*_tmpF6[2U];_tmpF6[0]=& _tmpF8,_tmpF6[1]=& _tmpF9;({struct _fat_ptr _tmp21F=({const char*_tmpF7="format(scanf,%u,%u)";_tag_fat(_tmpF7,sizeof(char),20U);});Cyc_aprintf(_tmp21F,_tag_fat(_tmpF6,sizeof(void*),2U));});});}}case 20U: _LL2B: _tmpCC=((struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_tmpC7)->f1;_LL2C: {int n=_tmpCC;
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpFC=({struct Cyc_Int_pa_PrintArg_struct _tmp17B;_tmp17B.tag=1U,_tmp17B.f1=(unsigned long)n;_tmp17B;});void*_tmpFA[1U];_tmpFA[0]=& _tmpFC;({struct _fat_ptr _tmp220=({const char*_tmpFB="initializes(%d)";_tag_fat(_tmpFB,sizeof(char),16U);});Cyc_aprintf(_tmp220,_tag_fat(_tmpFA,sizeof(void*),1U));});});}case 21U: _LL2D: _tmpCB=((struct Cyc_Absyn_Noliveunique_att_Absyn_Attribute_struct*)_tmpC7)->f1;_LL2E: {int n=_tmpCB;
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpFF=({struct Cyc_Int_pa_PrintArg_struct _tmp17C;_tmp17C.tag=1U,_tmp17C.f1=(unsigned long)n;_tmp17C;});void*_tmpFD[1U];_tmpFD[0]=& _tmpFF;({struct _fat_ptr _tmp221=({const char*_tmpFE="noliveunique(%d)";_tag_fat(_tmpFE,sizeof(char),17U);});Cyc_aprintf(_tmp221,_tag_fat(_tmpFD,sizeof(void*),1U));});});}case 22U: _LL2F: _tmpCA=((struct Cyc_Absyn_Consume_att_Absyn_Attribute_struct*)_tmpC7)->f1;_LL30: {int n=_tmpCA;
return(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp102=({struct Cyc_Int_pa_PrintArg_struct _tmp17D;_tmp17D.tag=1U,_tmp17D.f1=(unsigned long)n;_tmp17D;});void*_tmp100[1U];_tmp100[0]=& _tmp102;({struct _fat_ptr _tmp222=({const char*_tmp101="consume(%d)";_tag_fat(_tmp101,sizeof(char),12U);});Cyc_aprintf(_tmp222,_tag_fat(_tmp100,sizeof(void*),1U));});});}case 23U: _LL31: _LL32:
 return({const char*_tmp103="pure";_tag_fat(_tmp103,sizeof(char),5U);});case 26U: _LL33: _LL34:
 return({const char*_tmp104="always_inline";_tag_fat(_tmp104,sizeof(char),14U);});case 24U: _LL35: _tmpC9=((struct Cyc_Absyn_Mode_att_Absyn_Attribute_struct*)_tmpC7)->f1;_LL36: {struct _fat_ptr s=_tmpC9;
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp107=({struct Cyc_String_pa_PrintArg_struct _tmp17E;_tmp17E.tag=0U,_tmp17E.f1=(struct _fat_ptr)((struct _fat_ptr)s);_tmp17E;});void*_tmp105[1U];_tmp105[0]=& _tmp107;({struct _fat_ptr _tmp223=({const char*_tmp106="__mode__(\"%s\")";_tag_fat(_tmp106,sizeof(char),15U);});Cyc_aprintf(_tmp223,_tag_fat(_tmp105,sizeof(void*),1U));});});}default: _LL37: _tmpC8=((struct Cyc_Absyn_Alias_att_Absyn_Attribute_struct*)_tmpC7)->f1;_LL38: {struct _fat_ptr s=_tmpC8;
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp10A=({struct Cyc_String_pa_PrintArg_struct _tmp17F;_tmp17F.tag=0U,_tmp17F.f1=(struct _fat_ptr)((struct _fat_ptr)s);_tmp17F;});void*_tmp108[1U];_tmp108[0]=& _tmp10A;({struct _fat_ptr _tmp224=({const char*_tmp109="alias(\"%s\")";_tag_fat(_tmp109,sizeof(char),12U);});Cyc_aprintf(_tmp224,_tag_fat(_tmp108,sizeof(void*),1U));});});}}_LL0:;}
# 980
...
struct _tuple13 _tmp10C=({struct _tuple13 _tmp180;_tmp180.f1=att1,_tmp180.f2=att2;_tmp180;});struct _tuple13 _stmttmp8=_tmp10C;struct _tuple13 _tmp10D=_stmttmp8;int _tmp113;int _tmp112;enum Cyc_Absyn_Format_Type _tmp111;int _tmp110;int _tmp10F;enum Cyc_Absyn_Format_Type _tmp10E;struct _fat_ptr _tmp115;struct _fat_ptr _tmp114;struct Cyc_Absyn_Exp*_tmp117;struct Cyc_Absyn_Exp*_tmp116;int _tmp119;int _tmp118;int _tmp11B;int _tmp11A;switch(*((int*)_tmp10D.f1)){case 0U: if(((struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmp10D.f2)->tag == 0U){_LL1: _tmp11A=((struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmp10D.f1)->f1;_tmp11B=((struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmp10D.f2)->f1;_LL2: {int i1=_tmp11A;int i2=_tmp11B;
_tmp118=i1;_tmp119=i2;goto _LL4;}}else{goto _LLB;}case 20U: if(((struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_tmp10D.f2)->tag == 20U){_LL3: _tmp118=((struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_tmp10D.f1)->f1;_tmp119=((struct Cyc_Absyn_Initializes_att_Absyn_Attribute_struct*)_tmp10D.f2)->f1;_LL4: {int i1=_tmp118;int i2=_tmp119;
# 1010
return Cyc_Core_intcmp(i1,i2);}}else{goto _LLB;}case 6U: if(((struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)_tmp10D.f2)->tag == 6U){_LL5: _tmp116=((struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)_tmp10D.f1)->f1;_tmp117=((struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)_tmp10D.f2)->f1;_LL6: {struct Cyc_Absyn_Exp*e1=_tmp116;struct Cyc_Absyn_Exp*e2=_tmp117;
# 1012
if(e1 == e2)return 0;
if(e1 == 0)return - 1;
if(e2 == 0)return 1;
...
if(ftc != 0)return ftc;{
int _tmp11D=Cyc_Core_intcmp(i1,i2);int ic=_tmp11D;
if(ic != 0)return ic;
return Cyc_Core_intcmp(j1,j2);}}}else{goto _LLB;}default: _LLB: _LLC:
# 1024
 return({int _tmp225=Cyc_Absyn_attribute_case_number(att1);Cyc_Core_intcmp(_tmp225,Cyc_Absyn_attribute_case_number(att2));});}_LL0:;}
# 1027
int Cyc_Absyn_equal_att(void*a1,void*a2){
return Cyc_Absyn_attribute_cmp(a1,a2)== 0;}
# 1032
int Cyc_Absyn_fntype_att(void*a){
void*_tmp11E=a;int _tmp11F;switch(*((int*)_tmp11E)){case 0U: _LL1: _tmp11F=((struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmp11E)->f1;_LL2: {int i=_tmp11F;
...
# 1051
static struct _fat_ptr f0={_tmp126,_tmp126,_tmp126 + 3U};
...
if((unsigned)i >= fsz)
field_names=({unsigned _tmp125=(unsigned)(i + 1);struct _fat_ptr**_tmp124=_cycalloc(_check_times(_tmp125,sizeof(struct _fat_ptr*)));({{unsigned _tmp181=(unsigned)(i + 1);unsigned j;for(j=0;j < _tmp181;++ j){
# 1058
j < fsz?_tmp124[j]=*((struct _fat_ptr**)_check_fat_subscript(field_names,sizeof(struct _fat_ptr*),(int)j)):({struct _fat_ptr*_tmp228=({struct _fat_ptr*_tmp123=_cycalloc(sizeof(*_tmp123));({struct _fat_ptr _tmp227=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp122=({struct Cyc_Int_pa_PrintArg_struct _tmp182;_tmp182.tag=1U,_tmp182.f1=(unsigned long)((int)j);_tmp182;});void*_tmp120[1U];_tmp120[0]=& _tmp122;({struct _fat_ptr _tmp226=({const char*_tmp121="f%d";_tag_fat(_tmp121,sizeof(char),4U);});Cyc_aprintf(_tmp226,_tag_fat(_tmp120,sizeof(void*),1U));});});*_tmp123=_tmp227;});_tmp123;});_tmp124[j]=_tmp228;});}}0;});_tag_fat(_tmp124,sizeof(struct _fat_ptr*),_tmp125);});
...
union Cyc_Absyn_AggrInfo _tmp127=info;struct _tuple0*_tmp129;enum Cyc_Absyn_AggrKind _tmp128;struct _tuple0*_tmp12B;enum Cyc_Absyn_AggrKind _tmp12A;if((_tmp127.UnknownAggr).tag == 1){_LL1: _tmp12A=((_tmp127.UnknownAggr).val).f1;_tmp12B=((_tmp127.UnknownAggr).val).f2;_LL2: {enum Cyc_Absyn_AggrKind ak=_tmp12A;struct _tuple0*n=_tmp12B;
return({struct _tuple15 _tmp183;_tmp183.f1=ak,_tmp183.f2=n;_tmp183;});}}else{_LL3: _tmp128=(*(_tmp127.KnownAggr).val)->kind;_tmp129=(*(_tmp127.KnownAggr).val)->name;_LL4: {enum Cyc_Absyn_AggrKind k=_tmp128;struct _tuple0*n=_tmp129;
return({struct _tuple15 _tmp184;_tmp184.f1=k,_tmp184.f2=n;_tmp184;});}}_LL0:;}
# 1068
struct Cyc_Absyn_Aggrdecl*Cyc_Absyn_get_known_aggrdecl(union Cyc_Absyn_AggrInfo info){
union Cyc_Absyn_AggrInfo _tmp12C=info;struct Cyc_Absyn_Aggrdecl*_tmp12D;if((_tmp12C.UnknownAggr).tag == 1){_LL1: _LL2:
({void*_tmp12E=0U;({struct _fat_ptr _tmp229=({const char*_tmp12F="unchecked aggrdecl";_tag_fat(_tmp12F,sizeof(char),19U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp229,_tag_fat(_tmp12E,sizeof(void*),0U));});});}else{_LL3: _tmp12D=*(_tmp12C.KnownAggr).val;_LL4: {struct Cyc_Absyn_Aggrdecl*ad=_tmp12D;
return ad;}}_LL0:;}
# 1074
int Cyc_Absyn_is_nontagged_nonrequire_union_type(void*t){
void*_tmp130=Cyc_Tcutil_compress(t);void*_stmttmp9=_tmp130;void*_tmp131=_stmttmp9;union Cyc_Absyn_AggrInfo _tmp132;struct Cyc_List_List*_tmp133;switch(*((int*)_tmp131)){case 7U: if(((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp131)->f1 == Cyc_Absyn_UnionA){_LL1: _tmp133=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp131)->f2;_LL2: {struct Cyc_List_List*fs=_tmp133;
# 1077
if(fs == 0)return 1;
return((struct Cyc_Absyn_Aggrfield*)fs->hd)->requires_clause == 0;}}else{goto _LL5;}case 0U: if(((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp131)->f1)->tag == 20U){_LL3: _tmp132=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp131)->f1)->f1;_LL4: {union Cyc_Absyn_AggrInfo info=_tmp132;
# 1080
union Cyc_Absyn_AggrInfo _tmp134=info;int _tmp136;enum Cyc_Absyn_AggrKind _tmp135;enum Cyc_Absyn_AggrKind _tmp137;struct Cyc_Absyn_Aggrdecl*_tmp138;if((_tmp134.KnownAggr).tag == 2){_LL8: _tmp138=*(_tmp134.KnownAggr).val;_LL9: {struct Cyc_Absyn_Aggrdecl*ad=_tmp138;
# 1082
if((int)ad->kind != (int)Cyc_Absyn_UnionA)return 0;{
struct Cyc_Absyn_AggrdeclImpl*_tmp139=ad->impl;struct Cyc_Absyn_AggrdeclImpl*impl=_tmp139;
if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(impl))->tagged)return 0;{
struct Cyc_List_List*_tmp13A=impl->fields;struct Cyc_List_List*fields=_tmp13A;
if(fields == 0)return 1;
return((struct Cyc_Absyn_Aggrfield*)fields->hd)->requires_clause == 0;}}}}else{if(((_tmp134.UnknownAggr).val).f3 == 0){_LLA: _tmp137=((_tmp134.UnknownAggr).val).f1;_LLB: {enum Cyc_Absyn_AggrKind k=_tmp137;
return(int)k == (int)Cyc_Absyn_UnionA;}}else{_LLC: _tmp135=((_tmp134.UnknownAggr).val).f1;_tmp136=(int)(((_tmp134.UnknownAggr).val).f3)->v;_LLD: {enum Cyc_Absyn_AggrKind k=_tmp135;int b=_tmp136;
return(int)k == (int)1U && !b;}}}_LL7:;}}else{goto _LL5;}default: _LL5: _LL6:
# 1091
 return 0;}_LL0:;}
# 1094
int Cyc_Absyn_is_require_union_type(void*t){
void*_tmp13B=Cyc_Tcutil_compress(t);void*_stmttmpA=_tmp13B;void*_tmp13C=_stmttmpA;union Cyc_Absyn_AggrInfo _tmp13D;struct Cyc_List_List*_tmp13E;switch(*((int*)_tmp13C)){case 7U: if(((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp13C)->f1 == Cyc_Absyn_UnionA){_LL1: _tmp13E=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp13C)->f2;_LL2: {struct Cyc_List_List*fs=_tmp13E;
# 1097
if(fs == 0)return 0;
return((struct Cyc_Absyn_Aggrfield*)fs->hd)->requires_clause != 0;}}else{goto _LL5;}case 0U: if(((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp13C)->f1)->tag == 20U){_LL3: _tmp13D=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp13C)->f1)->f1;_LL4: {union Cyc_Absyn_AggrInfo info=_tmp13D;
# 1100
union Cyc_Absyn_AggrInfo _tmp13F=info;int _tmp141;enum Cyc_Absyn_AggrKind _tmp140;enum Cyc_Absyn_AggrKind _tmp142;struct Cyc_Absyn_Aggrdecl*_tmp143;if((_tmp13F.KnownAggr).tag == 2){_LL8: _tmp143=*(_tmp13F.KnownAggr).val;_LL9: {struct Cyc_Absyn_Aggrdecl*ad=_tmp143;
# 1102
if((int)ad->kind != (int)Cyc_Absyn_UnionA)return 0;{
struct Cyc_Absyn_AggrdeclImpl*_tmp144=ad->impl;struct Cyc_Absyn_AggrdeclImpl*impl=_tmp144;
if(((struct Cyc_Absyn_AggrdeclImpl*)_check_null(impl))->tagged)return 0;{
struct Cyc_List_List*_tmp145=impl->fields;struct Cyc_List_List*fields=_tmp145;
if(fields == 0)return 0;
return((struct Cyc_Absyn_Aggrfield*)fields->hd)->requires_clause != 0;}}}}else{if(((_tmp13F.UnknownAggr).val).f3 == 0){_LLA: _tmp142=((_tmp13F.UnknownAggr).val).f1;_LLB: {enum Cyc_Absyn_AggrKind k=_tmp142;
return 0;}}else{_LLC: _tmp140=((_tmp13F.UnknownAggr).val).f1;_tmp141=(int)(((_tmp13F.UnknownAggr).val).f3)->v;_LLD: {enum Cyc_Absyn_AggrKind k=_tmp140;int b=_tmp141;
return 0;}}}_LL7:;}}else{goto _LL5;}default: _LL5: _LL6:
# 1111
 return 0;}_LL0:;}
# 1115
struct _tuple0*Cyc_Absyn_binding2qvar(void*b){
void*_tmp146=b;struct Cyc_Absyn_Fndecl*_tmp147;struct Cyc_Absyn_Vardecl*_tmp148;struct Cyc_Absyn_Vardecl*_tmp149;struct Cyc_Absyn_Vardecl*_tmp14A;struct Cyc_Absyn_Vardecl*_tmp14B;struct _tuple0*_tmp14C;switch(*((int*)_tmp146)){case 0U: _LL1: _tmp14C=((struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*)_tmp146)->f1;_LL2: {struct _tuple0*qv=_tmp14C;
return qv;}case 1U: _LL3: _tmp14B=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)_tmp146)->f1;_LL4: {struct Cyc_Absyn_Vardecl*vd=_tmp14B;
_tmp14A=vd;goto _LL6;}case 3U: _LL5: _tmp14A=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)_tmp146)->f1;_LL6: {struct Cyc_Absyn_Vardecl*vd=_tmp14A;
_tmp149=vd;goto _LL8;}case 4U: _LL7: _tmp149=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)_tmp146)->f1;_LL8: {struct Cyc_Absyn_Vardecl*vd=_tmp149;
_tmp148=vd;goto _LLA;}case 5U: _LL9: _tmp148=((struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*)_tmp146)->f1;_LLA: {struct Cyc_Absyn_Vardecl*vd=_tmp148;
return vd->name;}default: _LLB: _tmp147=((struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*)_tmp146)->f1;_LLC: {struct Cyc_Absyn_Fndecl*fd=_tmp147;
return fd->name;}}_LL0:;}
# 1126
struct _fat_ptr*Cyc_Absyn_designatorlist_to_fieldname(struct Cyc_List_List*ds){
if(ds == 0 || ds->tl != 0)
({void*_tmp14D=0U;({struct _fat_ptr _tmp22A=({const char*_tmp14E="designator list not of length 1";_tag_fat(_tmp14E,sizeof(char),32U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp22A,_tag_fat(_tmp14D,sizeof(void*),0U));});});{
void*_tmp14F=(void*)ds->hd;void*_stmttmpB=_tmp14F;void*_tmp150=_stmttmpB;struct _fat_ptr*_tmp151;if(((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp150)->tag == 1U){_LL1: _tmp151=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp150)->f1;_LL2: {struct _fat_ptr*f=_tmp151;
return f;}}else{_LL3: _LL4:
({void*_tmp152=0U;({struct _fat_ptr _tmp22B=({const char*_tmp153="array designator in struct";_tag_fat(_tmp153,sizeof(char),27U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr))Cyc_Warn_impos)(_tmp22B,_tag_fat(_tmp152,sizeof(void*),0U));});});}_LL0:;}}
# 1135
int Cyc_Absyn_type2bool(int def,void*t){
void*_tmp154=Cyc_Tcutil_compress(t);void*_stmttmpC=_tmp154;void*_tmp155=_stmttmpC;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp155)->tag == 0U)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp155)->f1)){case 11U: _LL1: _LL2:
...
void*_tmp156=e->r;void*_stmttmpD=_tmp156;void*_tmp157=_stmttmpD;switch(*((int*)_tmp157)){case 0U: _LL1: _LL2:
 ...
 return 40U;default: _LL53: _LL54:
 return 41U;}_LL0:;}
# 1193
