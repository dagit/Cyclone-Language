...
void*_tmp23=bone;
if(_tmp23 == 0){
({void*_tmp15D=Cyc_Absyn_thin_bounds_int(1U);_tmp23=_tmp15D;});
bone=_tmp23;}
# 298
return _tmp23;}
# 300
...
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp2A=_cycalloc(sizeof(*_tmp2A));_tmp2A->tag=0U,({void*_tmp15E=(void*)({struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*_tmp29=_cycalloc(sizeof(*_tmp29));_tmp29->tag=15U,_tmp29->f1=n,_tmp29->f2=d;_tmp29;});_tmp2A->f1=_tmp15E;}),_tmp2A->f2=0;_tmp2A;});}
# 318
void*Cyc_Absyn_anon_enum_type(struct Cyc_List_List*fs){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp2C=_cycalloc(sizeof(*_tmp2C));_tmp2C->tag=0U,({void*_tmp15F=(void*)({struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*_tmp2B=_cycalloc(sizeof(*_tmp2B));_tmp2B->tag=16U,_tmp2B->f1=fs;_tmp2B;});_tmp2C->f1=_tmp15F;}),_tmp2C->f2=0;_tmp2C;});}
# 321
void*Cyc_Absyn_builtin_type(struct _dyneither_ptr s,struct Cyc_Absyn_Kind*k){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp2E=_cycalloc(sizeof(*_tmp2E));_tmp2E->tag=0U,({void*_tmp160=(void*)({struct Cyc_Absyn_BuiltinCon_Absyn_TyCon_struct*_tmp2D=_cycalloc(sizeof(*_tmp2D));_tmp2D->tag=17U,_tmp2D->f1=s,_tmp2D->f2=k;_tmp2D;});_tmp2E->f1=_tmp160;}),_tmp2E->f2=0;_tmp2E;});}
# 324
void*Cyc_Absyn_datatype_type(union Cyc_Absyn_DatatypeInfo di,struct Cyc_List_List*args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp30=_cycalloc(sizeof(*_tmp30));_tmp30->tag=0U,({void*_tmp161=(void*)({struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*_tmp2F=_cycalloc(sizeof(*_tmp2F));_tmp2F->tag=18U,_tmp2F->f1=di;_tmp2F;});_tmp30->f1=_tmp161;}),_tmp30->f2=args;_tmp30;});}
# 327
void*Cyc_Absyn_datatype_field_type(union Cyc_Absyn_DatatypeFieldInfo di,struct Cyc_List_List*args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp32=_cycalloc(sizeof(*_tmp32));_tmp32->tag=0U,({void*_tmp162=(void*)({struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*_tmp31=_cycalloc(sizeof(*_tmp31));_tmp31->tag=19U,_tmp31->f1=di;_tmp31;});_tmp32->f1=_tmp162;}),_tmp32->f2=args;_tmp32;});}
# 330
void*Cyc_Absyn_aggr_type(union Cyc_Absyn_AggrInfo ai,struct Cyc_List_List*args){
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp34=_cycalloc(sizeof(*_tmp34));_tmp34->tag=0U,({void*_tmp163=(void*)({struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_tmp33=_cycalloc(sizeof(*_tmp33));_tmp33->tag=20U,_tmp33->f1=ai;_tmp33;});_tmp34->f1=_tmp163;}),_tmp34->f2=args;_tmp34;});}
# 335
...
static void*eopt=0;
if(eopt == 0)
({void*_tmp164=Cyc_Absyn_datatype_type(({union Cyc_Absyn_DatatypeInfo _tmp136;(_tmp136.KnownDatatype).tag=2U,(_tmp136.KnownDatatype).val=& Cyc_Absyn_exn_tud;_tmp136;}),0);eopt=_tmp164;});
# 421
return eopt;}
# 424
void*Cyc_Absyn_exn_type(){
...
if(exn_type_val == 0)
({void*_tmp168=({void*_tmp167=Cyc_Absyn_exn_type_tt();void*_tmp166=Cyc_Absyn_heap_rgn_type;struct Cyc_Absyn_Tqual _tmp165=
Cyc_Absyn_empty_tqual(0U);
# 427
Cyc_Absyn_at_type(_tmp167,_tmp166,_tmp165,Cyc_Absyn_false_type);});exn_type_val=_tmp168;});
# 430
...
# 477
void*Cyc_Absyn_string_type(void*rgn){
return({void*_tmp16C=Cyc_Absyn_char_type;void*_tmp16B=rgn;struct Cyc_Absyn_Tqual _tmp16A=Cyc_Absyn_empty_tqual(0U);void*_tmp169=Cyc_Absyn_fat_bound_type;Cyc_Absyn_starb_type(_tmp16C,_tmp16B,_tmp16A,_tmp169,Cyc_Absyn_true_type);});}
# 480
void*Cyc_Absyn_const_string_type(void*rgn){
return({void*_tmp170=Cyc_Absyn_char_type;void*_tmp16F=rgn;struct Cyc_Absyn_Tqual _tmp16E=Cyc_Absyn_const_tqual(0U);void*_tmp16D=Cyc_Absyn_fat_bound_type;Cyc_Absyn_starb_type(_tmp170,_tmp16F,_tmp16E,_tmp16D,Cyc_Absyn_true_type);});}
# 484
...
void*_tmp171=Cyc_Absyn_bounds_one();(_tmp139.ptr_atts).bounds=_tmp171;}),(_tmp139.ptr_atts).zero_term=zeroterm,(_tmp139.ptr_atts).ptrloc=0;_tmp139;}));}
# 513
void*Cyc_Absyn_cstar_type(void*t,struct Cyc_Absyn_Tqual tq){
...
# 517
void*_tmp172=Cyc_Absyn_bounds_one();(_tmp13A.ptr_atts).bounds=_tmp172;}),(_tmp13A.ptr_atts).zero_term=Cyc_Absyn_false_type,(_tmp13A.ptr_atts).ptrloc=0;_tmp13A;}));}
# 521
...
void*_tmp173=Cyc_Absyn_bounds_one();(_tmp13B.ptr_atts).bounds=_tmp173;}),(_tmp13B.ptr_atts).zero_term=zeroterm,(_tmp13B.ptr_atts).ptrloc=0;_tmp13B;}));}
# 528
...
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp49=_cycalloc(sizeof(*_tmp49));_tmp49->tag=0U,({void*_tmp176=(void*)({struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_tmp48=_cycalloc(sizeof(*_tmp48));_tmp48->tag=20U,({union Cyc_Absyn_AggrInfo _tmp175=({enum Cyc_Absyn_AggrKind _tmp174=k;Cyc_Absyn_UnknownAggr(_tmp174,({struct _tuple0*_tmp47=_cycalloc(sizeof(*_tmp47));_tmp47->f1=Cyc_Absyn_rel_ns_null,_tmp47->f2=name;_tmp47;}),0);});_tmp48->f1=_tmp175;});_tmp48;});_tmp49->f1=_tmp176;}),_tmp49->f2=0;_tmp49;});}
# 557
...
return({void*_tmp177=(void*)({struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*_tmp4B=_cycalloc(sizeof(*_tmp4B));_tmp4B->tag=16U,_tmp4B->f1=rgn_handle,_tmp4B->f2=e;_tmp4B;});Cyc_Absyn_new_exp(_tmp177,loc);});}
# 584
...
return({void*_tmp178=(void*)({struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp4D=_cycalloc(sizeof(*_tmp4D));_tmp4D->tag=0U,_tmp4D->f1=c;_tmp4D;});Cyc_Absyn_new_exp(_tmp178,loc);});}
# 590
...
# 594
struct Cyc_Absyn_Exp*Cyc_Absyn_int_exp(enum Cyc_Absyn_Sign s,int i,unsigned int seg){return({union Cyc_Absyn_Cnst _tmp179=Cyc_Absyn_Int_c(s,i);Cyc_Absyn_const_exp(_tmp179,seg);});}
...
return({union Cyc_Absyn_Cnst _tmp17A=Cyc_Absyn_Char_c(Cyc_Absyn_None,c);Cyc_Absyn_const_exp(_tmp17A,loc);});}
# 615
struct Cyc_Absyn_Exp*Cyc_Absyn_wchar_exp(struct _dyneither_ptr s,unsigned int loc){
return({union Cyc_Absyn_Cnst _tmp17B=Cyc_Absyn_Wchar_c(s);Cyc_Absyn_const_exp(_tmp17B,loc);});}
# 618
struct Cyc_Absyn_Exp*Cyc_Absyn_float_exp(struct _dyneither_ptr f,int i,unsigned int loc){return({union Cyc_Absyn_Cnst _tmp17C=Cyc_Absyn_Float_c(f,i);Cyc_Absyn_const_exp(_tmp17C,loc);});}
struct Cyc_Absyn_Exp*Cyc_Absyn_string_exp(struct _dyneither_ptr s,unsigned int loc){return({union Cyc_Absyn_Cnst _tmp17D=Cyc_Absyn_String_c(s);Cyc_Absyn_const_exp(_tmp17D,loc);});}
struct Cyc_Absyn_Exp*Cyc_Absyn_wstring_exp(struct _dyneither_ptr s,unsigned int loc){return({union Cyc_Absyn_Cnst _tmp17E=Cyc_Absyn_Wstring_c(s);Cyc_Absyn_const_exp(_tmp17E,loc);});}
# 622
struct Cyc_Absyn_Exp*Cyc_Absyn_var_exp(struct _tuple0*q,unsigned int loc){
return({void*_tmp180=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp4F=_cycalloc(sizeof(*_tmp4F));_tmp4F->tag=1U,({void*_tmp17F=(void*)({struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*_tmp4E=_cycalloc(sizeof(*_tmp4E));_tmp4E->tag=0U,_tmp4E->f1=q;_tmp4E;});_tmp4F->f1=_tmp17F;});_tmp4F;});Cyc_Absyn_new_exp(_tmp180,loc);});}
# 625
struct Cyc_Absyn_Exp*Cyc_Absyn_varb_exp(void*b,unsigned int loc){
return({void*_tmp181=(void*)({struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*_tmp50=_cycalloc(sizeof(*_tmp50));_tmp50->tag=1U,_tmp50->f1=b;_tmp50;});Cyc_Absyn_new_exp(_tmp181,loc);});}
# 629
struct Cyc_Absyn_Exp*Cyc_Absyn_unknownid_exp(struct _tuple0*q,unsigned int loc){
return Cyc_Absyn_var_exp(q,loc);}
# 632
struct Cyc_Absyn_Exp*Cyc_Absyn_pragma_exp(struct _dyneither_ptr s,unsigned int loc){
return({void*_tmp182=(void*)({struct Cyc_Absyn_Pragma_e_Absyn_Raw_exp_struct*_tmp51=_cycalloc(sizeof(*_tmp51));_tmp51->tag=2U,_tmp51->f1=s;_tmp51;});Cyc_Absyn_new_exp(_tmp182,loc);});}
# 635
struct Cyc_Absyn_Exp*Cyc_Absyn_primop_exp(enum Cyc_Absyn_Primop p,struct Cyc_List_List*es,unsigned int loc){
return({void*_tmp183=(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp52=_cycalloc(sizeof(*_tmp52));_tmp52->tag=3U,_tmp52->f1=p,_tmp52->f2=es;_tmp52;});Cyc_Absyn_new_exp(_tmp183,loc);});}
# 638
struct Cyc_Absyn_Exp*Cyc_Absyn_prim1_exp(enum Cyc_Absyn_Primop p,struct Cyc_Absyn_Exp*e,unsigned int loc){
return({enum Cyc_Absyn_Primop _tmp185=p;struct Cyc_List_List*_tmp184=({struct Cyc_List_List*_tmp53=_cycalloc(sizeof(*_tmp53));_tmp53->hd=e,_tmp53->tl=0;_tmp53;});Cyc_Absyn_primop_exp(_tmp185,_tmp184,loc);});}
# 641
...
return({enum Cyc_Absyn_Primop _tmp188=p;struct Cyc_List_List*_tmp187=({struct Cyc_List_List*_tmp55=_cycalloc(sizeof(*_tmp55));_tmp55->hd=e1,({struct Cyc_List_List*_tmp186=({struct Cyc_List_List*_tmp54=_cycalloc(sizeof(*_tmp54));_tmp54->hd=e2,_tmp54->tl=0;_tmp54;});_tmp55->tl=_tmp186;});_tmp55;});Cyc_Absyn_primop_exp(_tmp188,_tmp187,loc);});}
# 644
struct Cyc_Absyn_Exp*Cyc_Absyn_swap_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned int loc){
return({void*_tmp189=(void*)({struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*_tmp56=_cycalloc(sizeof(*_tmp56));_tmp56->tag=35U,_tmp56->f1=e1,_tmp56->f2=e2;_tmp56;});Cyc_Absyn_new_exp(_tmp189,loc);});}
# 647
...
return({void*_tmp18A=(void*)({struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*_tmp57=_cycalloc(sizeof(*_tmp57));_tmp57->tag=4U,_tmp57->f1=e1,_tmp57->f2=popt,_tmp57->f3=e2;_tmp57;});Cyc_Absyn_new_exp(_tmp18A,loc);});}
# 660
...
return({void*_tmp18B=(void*)({struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*_tmp58=_cycalloc(sizeof(*_tmp58));_tmp58->tag=5U,_tmp58->f1=e,_tmp58->f2=i;_tmp58;});Cyc_Absyn_new_exp(_tmp18B,loc);});}
# 666
...
return({void*_tmp18C=(void*)({struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_tmp59=_cycalloc(sizeof(*_tmp59));_tmp59->tag=6U,_tmp59->f1=e1,_tmp59->f2=e2,_tmp59->f3=e3;_tmp59;});Cyc_Absyn_new_exp(_tmp18C,loc);});}
# 673
struct Cyc_Absyn_Exp*Cyc_Absyn_and_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned int loc){
return({void*_tmp18D=(void*)({struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_tmp5A=_cycalloc(sizeof(*_tmp5A));_tmp5A->tag=7U,_tmp5A->f1=e1,_tmp5A->f2=e2;_tmp5A;});Cyc_Absyn_new_exp(_tmp18D,loc);});}
# 676
struct Cyc_Absyn_Exp*Cyc_Absyn_or_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned int loc){
return({void*_tmp18E=(void*)({struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_tmp5B=_cycalloc(sizeof(*_tmp5B));_tmp5B->tag=8U,_tmp5B->f1=e1,_tmp5B->f2=e2;_tmp5B;});Cyc_Absyn_new_exp(_tmp18E,loc);});}
# 679
struct Cyc_Absyn_Exp*Cyc_Absyn_seq_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned int loc){
return({void*_tmp18F=(void*)({struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_tmp5C=_cycalloc(sizeof(*_tmp5C));_tmp5C->tag=9U,_tmp5C->f1=e1,_tmp5C->f2=e2;_tmp5C;});Cyc_Absyn_new_exp(_tmp18F,loc);});}
# 682
struct Cyc_Absyn_Exp*Cyc_Absyn_unknowncall_exp(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*es,unsigned int loc){
return({void*_tmp190=(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp5D=_cycalloc(sizeof(*_tmp5D));_tmp5D->tag=10U,_tmp5D->f1=e,_tmp5D->f2=es,_tmp5D->f3=0,_tmp5D->f4=0;_tmp5D;});Cyc_Absyn_new_exp(_tmp190,loc);});}
# 685
struct Cyc_Absyn_Exp*Cyc_Absyn_fncall_exp(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*es,unsigned int loc){
return({void*_tmp191=(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp5E=_cycalloc(sizeof(*_tmp5E));_tmp5E->tag=10U,_tmp5E->f1=e,_tmp5E->f2=es,_tmp5E->f3=0,_tmp5E->f4=1;_tmp5E;});Cyc_Absyn_new_exp(_tmp191,loc);});}
# 688
struct Cyc_Absyn_Exp*Cyc_Absyn_noinstantiate_exp(struct Cyc_Absyn_Exp*e,unsigned int loc){
return({void*_tmp192=(void*)({struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*_tmp5F=_cycalloc(sizeof(*_tmp5F));_tmp5F->tag=12U,_tmp5F->f1=e;_tmp5F;});Cyc_Absyn_new_exp(_tmp192,loc);});}
# 691
struct Cyc_Absyn_Exp*Cyc_Absyn_instantiate_exp(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*ts,unsigned int loc){
return({void*_tmp193=(void*)({struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*_tmp60=_cycalloc(sizeof(*_tmp60));_tmp60->tag=13U,_tmp60->f1=e,_tmp60->f2=ts;_tmp60;});Cyc_Absyn_new_exp(_tmp193,loc);});}
# 694
...
return({void*_tmp194=(void*)({struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp61=_cycalloc(sizeof(*_tmp61));_tmp61->tag=14U,_tmp61->f1=t,_tmp61->f2=e,_tmp61->f3=user_cast,_tmp61->f4=c;_tmp61;});Cyc_Absyn_new_exp(_tmp194,loc);});}
# 697
struct Cyc_Absyn_Exp*Cyc_Absyn_throw_exp(struct Cyc_Absyn_Exp*e,unsigned int loc){
return({void*_tmp195=(void*)({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_tmp62=_cycalloc(sizeof(*_tmp62));_tmp62->tag=11U,_tmp62->f1=e,_tmp62->f2=0;_tmp62;});Cyc_Absyn_new_exp(_tmp195,loc);});}
# 700
struct Cyc_Absyn_Exp*Cyc_Absyn_rethrow_exp(struct Cyc_Absyn_Exp*e,unsigned int loc){
return({void*_tmp196=(void*)({struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*_tmp63=_cycalloc(sizeof(*_tmp63));_tmp63->tag=11U,_tmp63->f1=e,_tmp63->f2=1;_tmp63;});Cyc_Absyn_new_exp(_tmp196,loc);});}
# 703
struct Cyc_Absyn_Exp*Cyc_Absyn_address_exp(struct Cyc_Absyn_Exp*e,unsigned int loc){return({void*_tmp197=(void*)({struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*_tmp64=_cycalloc(sizeof(*_tmp64));_tmp64->tag=15U,_tmp64->f1=e;_tmp64;});Cyc_Absyn_new_exp(_tmp197,loc);});}
struct Cyc_Absyn_Exp*Cyc_Absyn_sizeoftype_exp(void*t,unsigned int loc){
return({void*_tmp198=(void*)({struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*_tmp65=_cycalloc(sizeof(*_tmp65));_tmp65->tag=17U,_tmp65->f1=t;_tmp65;});Cyc_Absyn_new_exp(_tmp198,loc);});}
# 707
struct Cyc_Absyn_Exp*Cyc_Absyn_sizeofexp_exp(struct Cyc_Absyn_Exp*e,unsigned int loc){
return({void*_tmp199=(void*)({struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*_tmp66=_cycalloc(sizeof(*_tmp66));_tmp66->tag=18U,_tmp66->f1=e;_tmp66;});Cyc_Absyn_new_exp(_tmp199,loc);});}
# 710
struct Cyc_Absyn_Exp*Cyc_Absyn_offsetof_exp(void*t,struct Cyc_List_List*ofs,unsigned int loc){
return({void*_tmp19A=(void*)({struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmp67=_cycalloc(sizeof(*_tmp67));_tmp67->tag=19U,_tmp67->f1=t,_tmp67->f2=ofs;_tmp67;});Cyc_Absyn_new_exp(_tmp19A,loc);});}
# 713
struct Cyc_Absyn_Exp*Cyc_Absyn_deref_exp(struct Cyc_Absyn_Exp*e,unsigned int loc){return({void*_tmp19B=(void*)({struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*_tmp68=_cycalloc(sizeof(*_tmp68));_tmp68->tag=20U,_tmp68->f1=e;_tmp68;});Cyc_Absyn_new_exp(_tmp19B,loc);});}
struct Cyc_Absyn_Exp*Cyc_Absyn_aggrmember_exp(struct Cyc_Absyn_Exp*e,struct _dyneither_ptr*n,unsigned int loc){
return({void*_tmp19C=(void*)({struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_tmp69=_cycalloc(sizeof(*_tmp69));_tmp69->tag=21U,_tmp69->f1=e,_tmp69->f2=n,_tmp69->f3=0,_tmp69->f4=0;_tmp69;});Cyc_Absyn_new_exp(_tmp19C,loc);});}
# 717
struct Cyc_Absyn_Exp*Cyc_Absyn_aggrarrow_exp(struct Cyc_Absyn_Exp*e,struct _dyneither_ptr*n,unsigned int loc){
return({void*_tmp19D=(void*)({struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp6A=_cycalloc(sizeof(*_tmp6A));_tmp6A->tag=22U,_tmp6A->f1=e,_tmp6A->f2=n,_tmp6A->f3=0,_tmp6A->f4=0;_tmp6A;});Cyc_Absyn_new_exp(_tmp19D,loc);});}
# 720
struct Cyc_Absyn_Exp*Cyc_Absyn_subscript_exp(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned int loc){
return({void*_tmp19E=(void*)({struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*_tmp6B=_cycalloc(sizeof(*_tmp6B));_tmp6B->tag=23U,_tmp6B->f1=e1,_tmp6B->f2=e2;_tmp6B;});Cyc_Absyn_new_exp(_tmp19E,loc);});}
# 723
struct Cyc_Absyn_Exp*Cyc_Absyn_tuple_exp(struct Cyc_List_List*es,unsigned int loc){
return({void*_tmp19F=(void*)({struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*_tmp6C=_cycalloc(sizeof(*_tmp6C));_tmp6C->tag=24U,_tmp6C->f1=es;_tmp6C;});Cyc_Absyn_new_exp(_tmp19F,loc);});}
# 726
struct Cyc_Absyn_Exp*Cyc_Absyn_stmt_exp(struct Cyc_Absyn_Stmt*s,unsigned int loc){return({void*_tmp1A0=(void*)({struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*_tmp6D=_cycalloc(sizeof(*_tmp6D));_tmp6D->tag=37U,_tmp6D->f1=s;_tmp6D;});Cyc_Absyn_new_exp(_tmp1A0,loc);});}
# 728
...
return({void*_tmp1A1=(void*)({struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp6E=_cycalloc(sizeof(*_tmp6E));_tmp6E->tag=39U,_tmp6E->f1=t;_tmp6E;});Cyc_Absyn_new_exp(_tmp1A1,loc);});}
# 735
struct Cyc_Absyn_Exp*Cyc_Absyn_asm_exp(int volatile_kw,struct _dyneither_ptr body,unsigned int loc){
return({void*_tmp1A2=(void*)({struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*_tmp6F=_cycalloc(sizeof(*_tmp6F));_tmp6F->tag=40U,_tmp6F->f1=volatile_kw,_tmp6F->f2=body;_tmp6F;});Cyc_Absyn_new_exp(_tmp1A2,loc);});}
# 738
struct Cyc_Absyn_Exp*Cyc_Absyn_extension_exp(struct Cyc_Absyn_Exp*e,unsigned int loc){
return({void*_tmp1A3=(void*)({struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*_tmp70=_cycalloc(sizeof(*_tmp70));_tmp70->tag=41U,_tmp70->f1=e;_tmp70;});Cyc_Absyn_new_exp(_tmp1A3,loc);});}struct _tuple13{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
# 742
struct Cyc_Absyn_Exp*Cyc_Absyn_array_exp(struct Cyc_List_List*es,unsigned int loc){
# 744
struct Cyc_List_List*dles=0;
for(0;es != 0;es=es->tl){
({struct Cyc_List_List*_tmp1A5=({struct Cyc_List_List*_tmp72=_cycalloc(sizeof(*_tmp72));({struct _tuple13*_tmp1A4=({struct _tuple13*_tmp71=_cycalloc(sizeof(*_tmp71));_tmp71->f1=0,_tmp71->f2=(struct Cyc_Absyn_Exp*)es->hd;_tmp71;});_tmp72->hd=_tmp1A4;}),_tmp72->tl=dles;_tmp72;});dles=_tmp1A5;});}
({struct Cyc_List_List*_tmp1A6=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(dles);dles=_tmp1A6;});
return({void*_tmp1A7=(void*)({struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_tmp73=_cycalloc(sizeof(*_tmp73));_tmp73->tag=26U,_tmp73->f1=dles;_tmp73;});Cyc_Absyn_new_exp(_tmp1A7,loc);});}
# 750
struct Cyc_Absyn_Exp*Cyc_Absyn_unresolvedmem_exp(struct Cyc_Core_Opt*n,struct Cyc_List_List*dles,unsigned int loc){
# 753
return({void*_tmp1A8=(void*)({struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmp74=_cycalloc(sizeof(*_tmp74));_tmp74->tag=36U,_tmp74->f1=n,_tmp74->f2=dles;_tmp74;});Cyc_Absyn_new_exp(_tmp1A8,loc);});}
# 756
struct Cyc_Absyn_Stmt*Cyc_Absyn_new_stmt(void*s,unsigned int loc){
...
struct Cyc_Absyn_Stmt*Cyc_Absyn_exp_stmt(struct Cyc_Absyn_Exp*e,unsigned int loc){return({void*_tmp1A9=(void*)({struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*_tmp76=_cycalloc(sizeof(*_tmp76));_tmp76->tag=1U,_tmp76->f1=e;_tmp76;});Cyc_Absyn_new_stmt(_tmp1A9,loc);});}
...
return({struct Cyc_Absyn_Stmt*_tmp1AB=(struct Cyc_Absyn_Stmt*)ss->hd;struct Cyc_Absyn_Stmt*_tmp1AA=Cyc_Absyn_seq_stmts(ss->tl,loc);Cyc_Absyn_seq_stmt(_tmp1AB,_tmp1AA,loc);});}}}
# 769
struct Cyc_Absyn_Stmt*Cyc_Absyn_return_stmt(struct Cyc_Absyn_Exp*e,unsigned int loc){
return({void*_tmp1AC=(void*)({struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*_tmp77=_cycalloc(sizeof(*_tmp77));_tmp77->tag=3U,_tmp77->f1=e;_tmp77;});Cyc_Absyn_new_stmt(_tmp1AC,loc);});}
# 772
struct Cyc_Absyn_Stmt*Cyc_Absyn_ifthenelse_stmt(struct Cyc_Absyn_Exp*e,struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2,unsigned int loc){
return({void*_tmp1AD=(void*)({struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*_tmp78=_cycalloc(sizeof(*_tmp78));_tmp78->tag=4U,_tmp78->f1=e,_tmp78->f2=s1,_tmp78->f3=s2;_tmp78;});Cyc_Absyn_new_stmt(_tmp1AD,loc);});}
# 775
struct Cyc_Absyn_Stmt*Cyc_Absyn_while_stmt(struct Cyc_Absyn_Exp*e,struct Cyc_Absyn_Stmt*s,unsigned int loc){
return({void*_tmp1AF=(void*)({struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*_tmp79=_cycalloc(sizeof(*_tmp79));_tmp79->tag=5U,(_tmp79->f1).f1=e,({struct Cyc_Absyn_Stmt*_tmp1AE=Cyc_Absyn_skip_stmt(e->loc);(_tmp79->f1).f2=_tmp1AE;}),_tmp79->f2=s;_tmp79;});Cyc_Absyn_new_stmt(_tmp1AF,loc);});}
# 778
...
struct Cyc_Absyn_Stmt*Cyc_Absyn_for_stmt(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,struct Cyc_Absyn_Exp*e3,struct Cyc_Absyn_Stmt*s,unsigned int loc){
return({void*_tmp1B2=(void*)({struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*_tmp7A=_cycalloc(sizeof(*_tmp7A));_tmp7A->tag=9U,_tmp7A->f1=e1,(_tmp7A->f2).f1=e2,({struct Cyc_Absyn_Stmt*_tmp1B1=Cyc_Absyn_skip_stmt(e3->loc);(_tmp7A->f2).f2=_tmp1B1;}),
(_tmp7A->f3).f1=e3,({struct Cyc_Absyn_Stmt*_tmp1B0=Cyc_Absyn_skip_stmt(e3->loc);(_tmp7A->f3).f2=_tmp1B0;}),_tmp7A->f4=s;_tmp7A;});
# 781
Cyc_Absyn_new_stmt(_tmp1B2,loc);});}
# 785
struct Cyc_Absyn_Stmt*Cyc_Absyn_switch_stmt(struct Cyc_Absyn_Exp*e,struct Cyc_List_List*scs,unsigned int loc){
return({void*_tmp1B3=(void*)({struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*_tmp7B=_cycalloc(sizeof(*_tmp7B));_tmp7B->tag=10U,_tmp7B->f1=e,_tmp7B->f2=scs,_tmp7B->f3=0;_tmp7B;});Cyc_Absyn_new_stmt(_tmp1B3,loc);});}struct _tuple14{void*f1;void*f2;};
# 788
struct Cyc_Absyn_Stmt*Cyc_Absyn_seq_stmt(struct Cyc_Absyn_Stmt*s1,struct Cyc_Absyn_Stmt*s2,unsigned int loc){
struct _tuple14 _tmp7C=({struct _tuple14 _tmp145;_tmp145.f1=s1->r,_tmp145.f2=s2->r;_tmp145;});struct _tuple14 _tmp7D=_tmp7C;if(((struct Cyc_Absyn_Skip_s_Absyn_Raw_stmt_struct*)_tmp7D.f1)->tag == 0U){_LL1: _LL2:
 ...
 return({void*_tmp1B4=(void*)({struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*_tmp7E=_cycalloc(sizeof(*_tmp7E));_tmp7E->tag=2U,_tmp7E->f1=s1,_tmp7E->f2=s2;_tmp7E;});Cyc_Absyn_new_stmt(_tmp1B4,loc);});}}_LL0:;}
# 795
struct Cyc_Absyn_Stmt*Cyc_Absyn_fallthru_stmt(struct Cyc_List_List*el,unsigned int loc){
return({void*_tmp1B5=(void*)({struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*_tmp7F=_cycalloc(sizeof(*_tmp7F));_tmp7F->tag=11U,_tmp7F->f1=el,_tmp7F->f2=0;_tmp7F;});Cyc_Absyn_new_stmt(_tmp1B5,loc);});}
# 798
struct Cyc_Absyn_Stmt*Cyc_Absyn_decl_stmt(struct Cyc_Absyn_Decl*d,struct Cyc_Absyn_Stmt*s,unsigned int loc){
return({void*_tmp1B6=(void*)({struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*_tmp80=_cycalloc(sizeof(*_tmp80));_tmp80->tag=12U,_tmp80->f1=d,_tmp80->f2=s;_tmp80;});Cyc_Absyn_new_stmt(_tmp1B6,loc);});}
# 801
...
struct Cyc_Absyn_Decl*d=({void*_tmp1B8=(void*)({struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*_tmp82=_cycalloc(sizeof(*_tmp82));_tmp82->tag=0U,({struct Cyc_Absyn_Vardecl*_tmp1B7=Cyc_Absyn_new_vardecl(0U,x,t,init);_tmp82->f1=_tmp1B7;});_tmp82;});Cyc_Absyn_new_decl(_tmp1B8,loc);});
return({void*_tmp1B9=(void*)({struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*_tmp81=_cycalloc(sizeof(*_tmp81));_tmp81->tag=12U,_tmp81->f1=d,_tmp81->f2=s;_tmp81;});Cyc_Absyn_new_stmt(_tmp1B9,loc);});}
# 805
struct Cyc_Absyn_Stmt*Cyc_Absyn_label_stmt(struct _dyneither_ptr*v,struct Cyc_Absyn_Stmt*s,unsigned int loc){
return({void*_tmp1BA=(void*)({struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*_tmp83=_cycalloc(sizeof(*_tmp83));_tmp83->tag=13U,_tmp83->f1=v,_tmp83->f2=s;_tmp83;});Cyc_Absyn_new_stmt(_tmp1BA,loc);});}
# 808
struct Cyc_Absyn_Stmt*Cyc_Absyn_do_stmt(struct Cyc_Absyn_Stmt*s,struct Cyc_Absyn_Exp*e,unsigned int loc){
return({void*_tmp1BC=(void*)({struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*_tmp84=_cycalloc(sizeof(*_tmp84));_tmp84->tag=14U,_tmp84->f1=s,(_tmp84->f2).f1=e,({struct Cyc_Absyn_Stmt*_tmp1BB=Cyc_Absyn_skip_stmt(e->loc);(_tmp84->f2).f2=_tmp1BB;});_tmp84;});Cyc_Absyn_new_stmt(_tmp1BC,loc);});}
# 811
struct Cyc_Absyn_Stmt*Cyc_Absyn_trycatch_stmt(struct Cyc_Absyn_Stmt*s,struct Cyc_List_List*scs,unsigned int loc){
return({void*_tmp1BD=(void*)({struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*_tmp85=_cycalloc(sizeof(*_tmp85));_tmp85->tag=15U,_tmp85->f1=s,_tmp85->f2=scs,_tmp85->f3=0;_tmp85;});Cyc_Absyn_new_stmt(_tmp1BD,loc);});}
# 814
struct Cyc_Absyn_Stmt*Cyc_Absyn_goto_stmt(struct _dyneither_ptr*lab,unsigned int loc){
return({void*_tmp1BE=(void*)({struct Cyc_Absyn_Goto_s_Absyn_Raw_stmt_struct*_tmp86=_cycalloc(sizeof(*_tmp86));_tmp86->tag=8U,_tmp86->f1=lab;_tmp86;});Cyc_Absyn_new_stmt(_tmp1BE,loc);});}
# 817
struct Cyc_Absyn_Stmt*Cyc_Absyn_assign_stmt(struct Cyc_Absyn_Exp*e1,struct Cyc_Absyn_Exp*e2,unsigned int loc){
return({struct Cyc_Absyn_Exp*_tmp1BF=Cyc_Absyn_assign_exp(e1,e2,loc);Cyc_Absyn_exp_stmt(_tmp1BF,loc);});}
# 821
...
struct Cyc_Absyn_Pat*Cyc_Absyn_exp_pat(struct Cyc_Absyn_Exp*e){return({void*_tmp1C0=(void*)({struct Cyc_Absyn_Exp_p_Absyn_Raw_pat_struct*_tmp88=_cycalloc(sizeof(*_tmp88));_tmp88->tag=17U,_tmp88->f1=e;_tmp88;});Cyc_Absyn_new_pat(_tmp1C0,e->loc);});}
...
struct Cyc_Absyn_Decl*Cyc_Absyn_let_decl(struct Cyc_Absyn_Pat*p,struct Cyc_Absyn_Exp*e,unsigned int loc){
return({void*_tmp1C1=(void*)({struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*_tmp8A=_cycalloc(sizeof(*_tmp8A));_tmp8A->tag=2U,_tmp8A->f1=p,_tmp8A->f2=0,_tmp8A->f3=e,_tmp8A->f4=0;_tmp8A;});Cyc_Absyn_new_decl(_tmp1C1,loc);});}
# 831
struct Cyc_Absyn_Decl*Cyc_Absyn_letv_decl(struct Cyc_List_List*vds,unsigned int loc){
return({void*_tmp1C2=(void*)({struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*_tmp8B=_cycalloc(sizeof(*_tmp8B));_tmp8B->tag=3U,_tmp8B->f1=vds;_tmp8B;});Cyc_Absyn_new_decl(_tmp1C2,loc);});}
# 834
...
return({void*_tmp1C3=(void*)({struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*_tmp8C=_cycalloc(sizeof(*_tmp8C));_tmp8C->tag=4U,_tmp8C->f1=tv,_tmp8C->f2=vd,_tmp8C->f3=open_exp;_tmp8C;});Cyc_Absyn_new_decl(_tmp1C3,loc);});}
# 837
...
# 839
return({void*_tmp1C6=(void*)({struct Cyc_Absyn_Let_d_Absyn_Raw_decl_struct*_tmp8E=_cycalloc(sizeof(*_tmp8E));_tmp8E->tag=2U,({struct Cyc_Absyn_Pat*_tmp1C5=({void*_tmp1C4=(void*)({struct Cyc_Absyn_AliasVar_p_Absyn_Raw_pat_struct*_tmp8D=_cycalloc(sizeof(*_tmp8D));_tmp8D->tag=2U,_tmp8D->f1=tv,_tmp8D->f2=vd;_tmp8D;});Cyc_Absyn_new_pat(_tmp1C4,loc);});_tmp8E->f1=_tmp1C5;}),_tmp8E->f2=0,_tmp8E->f3=e,_tmp8E->f4=0;_tmp8E;});Cyc_Absyn_new_decl(_tmp1C6,loc);});}
# 842
struct Cyc_Absyn_Vardecl*Cyc_Absyn_new_vardecl(unsigned int varloc,struct _tuple0*x,void*t,struct Cyc_Absyn_Exp*init){
...
struct Cyc_Absyn_Tqual _tmp1C7=Cyc_Absyn_empty_tqual(0U);_tmp8F->tq=_tmp1C7;}),_tmp8F->type=t,_tmp8F->initializer=init,_tmp8F->rgn=0,_tmp8F->attributes=0,_tmp8F->escapes=0;_tmp8F;});}
# 848
struct Cyc_Absyn_Vardecl*Cyc_Absyn_static_vardecl(struct _tuple0*x,void*t,struct Cyc_Absyn_Exp*init){
return({struct Cyc_Absyn_Vardecl*_tmp90=_cycalloc(sizeof(*_tmp90));_tmp90->sc=Cyc_Absyn_Static,_tmp90->name=x,_tmp90->varloc=0U,({struct Cyc_Absyn_Tqual _tmp1C8=Cyc_Absyn_empty_tqual(0U);_tmp90->tq=_tmp1C8;}),_tmp90->type=t,_tmp90->initializer=init,_tmp90->rgn=0,_tmp90->attributes=0,_tmp90->escapes=0;_tmp90;});}
# 853
struct Cyc_Absyn_AggrdeclImpl*Cyc_Absyn_aggrdecl_impl(struct Cyc_List_List*exists,struct Cyc_List_List*po,struct Cyc_List_List*fs,int tagged){
# 857
...
struct Cyc_Absyn_Decl*Cyc_Absyn_aggr_decl(enum Cyc_Absyn_AggrKind k,enum Cyc_Absyn_Scope s,struct _tuple0*n,struct Cyc_List_List*ts,struct Cyc_Absyn_AggrdeclImpl*i,struct Cyc_List_List*atts,unsigned int loc){
# 863
return({void*_tmp1CA=(void*)({struct Cyc_Absyn_Aggr_d_Absyn_Raw_decl_struct*_tmp93=_cycalloc(sizeof(*_tmp93));_tmp93->tag=5U,({struct Cyc_Absyn_Aggrdecl*_tmp1C9=({struct Cyc_Absyn_Aggrdecl*_tmp92=_cycalloc(sizeof(*_tmp92));_tmp92->kind=k,_tmp92->sc=s,_tmp92->name=n,_tmp92->tvs=ts,_tmp92->impl=i,_tmp92->attributes=atts,_tmp92->expected_mem_kind=0;_tmp92;});_tmp93->f1=_tmp1C9;});_tmp93;});Cyc_Absyn_new_decl(_tmp1CA,loc);});}
# 868
struct Cyc_Absyn_TypeDecl*Cyc_Absyn_aggr_tdecl(enum Cyc_Absyn_AggrKind k,enum Cyc_Absyn_Scope s,struct _tuple0*n,struct Cyc_List_List*ts,struct Cyc_Absyn_AggrdeclImpl*i,struct Cyc_List_List*atts,unsigned int loc){
# 871
return({struct Cyc_Absyn_TypeDecl*_tmp96=_cycalloc(sizeof(*_tmp96));({void*_tmp1CC=(void*)({struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*_tmp95=_cycalloc(sizeof(*_tmp95));_tmp95->tag=0U,({struct Cyc_Absyn_Aggrdecl*_tmp1CB=({struct Cyc_Absyn_Aggrdecl*_tmp94=_cycalloc(sizeof(*_tmp94));_tmp94->kind=k,_tmp94->sc=s,_tmp94->name=n,_tmp94->tvs=ts,_tmp94->impl=i,_tmp94->attributes=atts,_tmp94->expected_mem_kind=0;_tmp94;});_tmp95->f1=_tmp1CB;});_tmp95;});_tmp96->r=_tmp1CC;}),_tmp96->loc=loc;_tmp96;});}
# 877
struct Cyc_Absyn_Decl*Cyc_Absyn_struct_decl(enum Cyc_Absyn_Scope s,struct _tuple0*n,struct Cyc_List_List*ts,struct Cyc_Absyn_AggrdeclImpl*i,struct Cyc_List_List*atts,unsigned int loc){
# 880
...
struct Cyc_Absyn_Decl*Cyc_Absyn_datatype_decl(enum Cyc_Absyn_Scope s,struct _tuple0*n,struct Cyc_List_List*ts,struct Cyc_Core_Opt*fs,int is_extensible,unsigned int loc){
# 890
return({void*_tmp1CE=(void*)({struct Cyc_Absyn_Datatype_d_Absyn_Raw_decl_struct*_tmp98=_cycalloc(sizeof(*_tmp98));_tmp98->tag=6U,({struct Cyc_Absyn_Datatypedecl*_tmp1CD=({struct Cyc_Absyn_Datatypedecl*_tmp97=_cycalloc(sizeof(*_tmp97));_tmp97->sc=s,_tmp97->name=n,_tmp97->tvs=ts,_tmp97->fields=fs,_tmp97->is_extensible=is_extensible;_tmp97;});_tmp98->f1=_tmp1CD;});_tmp98;});Cyc_Absyn_new_decl(_tmp1CE,loc);});}
# 893
struct Cyc_Absyn_TypeDecl*Cyc_Absyn_datatype_tdecl(enum Cyc_Absyn_Scope s,struct _tuple0*n,struct Cyc_List_List*ts,struct Cyc_Core_Opt*fs,int is_extensible,unsigned int loc){
# 896
return({struct Cyc_Absyn_TypeDecl*_tmp9B=_cycalloc(sizeof(*_tmp9B));({void*_tmp1D0=(void*)({struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*_tmp9A=_cycalloc(sizeof(*_tmp9A));_tmp9A->tag=2U,({struct Cyc_Absyn_Datatypedecl*_tmp1CF=({struct Cyc_Absyn_Datatypedecl*_tmp99=_cycalloc(sizeof(*_tmp99));_tmp99->sc=s,_tmp99->name=n,_tmp99->tvs=ts,_tmp99->fields=fs,_tmp99->is_extensible=is_extensible;_tmp99;});_tmp9A->f1=_tmp1CF;});_tmp9A;});_tmp9B->r=_tmp1D0;}),_tmp9B->loc=loc;_tmp9B;});}
# 908 "absyn.cyc"
...
void*_tmp9F=Cyc_Tcutil_compress(t);void*_tmpA0=_tmp9F;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmpA0)->tag == 5U){_LL1: _LL2:
 return({void*_tmp1D4=t;void*_tmp1D3=
fresh_evar?
...
# 941
struct Cyc_Absyn_Tqual _tmp1D2=
# 945
Cyc_Absyn_empty_tqual(0U);
# 941
Cyc_Absyn_at_type(_tmp1D4,_tmp1D3,_tmp1D2,Cyc_Absyn_false_type);});}else{_LL3: _LL4:
# 946
 return t;}_LL0:;}
# 961 "absyn.cyc"
...
void*_tmpAC=a;struct _dyneither_ptr _tmpEF;struct _dyneither_ptr _tmpEE;int _tmpED;int _tmpEC;int _tmpEB;int _tmpEA;int _tmpE9;int _tmpE8;int _tmpE7;struct _dyneither_ptr _tmpE6;struct Cyc_Absyn_Exp*_tmpE5;int _tmpE4;switch(*((int*)_tmpAC)){case 0U: _LL1: _tmpE4=((struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmpAC)->f1;_LL2:
 return(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpAF=({struct Cyc_Int_pa_PrintArg_struct _tmp146;_tmp146.tag=1U,_tmp146.f1=(unsigned long)_tmpE4;_tmp146;});void*_tmpAD[1U];_tmpAD[0]=& _tmpAF;({struct _dyneither_ptr _tmp1D5=({const char*_tmpAE="regparm(%d)";_tag_dyneither(_tmpAE,sizeof(char),12U);});Cyc_aprintf(_tmp1D5,_tag_dyneither(_tmpAD,sizeof(void*),1U));});});case 1U: _LL3: _LL4:
...
enum Cyc_Cyclone_C_Compilers _tmpB6=Cyc_Cyclone_c_compiler;if(_tmpB6 == Cyc_Cyclone_Gcc_c){_LL3A: _LL3B:
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpB9=({struct Cyc_String_pa_PrintArg_struct _tmp147;_tmp147.tag=0U,({struct _dyneither_ptr _tmp1D6=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmpE5));_tmp147.f1=_tmp1D6;});_tmp147;});void*_tmpB7[1U];_tmpB7[0]=& _tmpB9;({struct _dyneither_ptr _tmp1D7=({const char*_tmpB8="aligned(%s)";_tag_dyneither(_tmpB8,sizeof(char),12U);});Cyc_aprintf(_tmp1D7,_tag_dyneither(_tmpB7,sizeof(void*),1U));});});}else{_LL3C: _LL3D:
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpBC=({struct Cyc_String_pa_PrintArg_struct _tmp148;_tmp148.tag=0U,({struct _dyneither_ptr _tmp1D8=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmpE5));_tmp148.f1=_tmp1D8;});_tmp148;});void*_tmpBA[1U];_tmpBA[0]=& _tmpBC;({struct _dyneither_ptr _tmp1D9=({const char*_tmpBB="align(%s)";_tag_dyneither(_tmpBB,sizeof(char),10U);});Cyc_aprintf(_tmp1D9,_tag_dyneither(_tmpBA,sizeof(void*),1U));});});}_LL39:;}case 7U: _LLF: _LL10:
# 1037
 ...
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpE0=({struct Cyc_String_pa_PrintArg_struct _tmp151;_tmp151.tag=0U,_tmp151.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpEE);_tmp151;});void*_tmpDE[1U];_tmpDE[0]=& _tmpE0;({struct _dyneither_ptr _tmp1E0=({const char*_tmpDF="__mode__(\"%s\")";_tag_dyneither(_tmpDF,sizeof(char),15U);});Cyc_aprintf(_tmp1E0,_tag_dyneither(_tmpDE,sizeof(void*),1U));});});default: _LL37: _tmpEF=((struct Cyc_Absyn_Alias_att_Absyn_Attribute_struct*)_tmpAC)->f1;_LL38:
 return(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpE3=({struct Cyc_String_pa_PrintArg_struct _tmp152;_tmp152.tag=0U,_tmp152.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpEF);_tmp152;});void*_tmpE1[1U];_tmpE1[0]=& _tmpE3;({struct _dyneither_ptr _tmp1E1=({const char*_tmpE2="alias(\"%s\")";_tag_dyneither(_tmpE2,sizeof(char),12U);});Cyc_aprintf(_tmp1E1,_tag_dyneither(_tmpE1,sizeof(void*),1U));});});}_LL0:;}
# 1062
...
if(i >= fsz)
({struct _dyneither_ptr _tmp1E5=({unsigned int _tmpF8=(unsigned int)(i + 1);struct _dyneither_ptr**_tmpF7=_cycalloc(_check_times(_tmpF8,sizeof(struct _dyneither_ptr*)));({{unsigned int _tmp153=(unsigned int)(i + 1);unsigned int j;for(j=0;j < _tmp153;++ j){
# 1088
j < fsz?_tmpF7[j]=*((struct _dyneither_ptr**)_check_dyneither_subscript(Cyc_Absyn_field_names,sizeof(struct _dyneither_ptr*),(int)j)):({struct _dyneither_ptr*_tmp1E4=({struct _dyneither_ptr*_tmpF6=_cycalloc(sizeof(*_tmpF6));({struct _dyneither_ptr _tmp1E3=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmpF5=({struct Cyc_Int_pa_PrintArg_struct _tmp154;_tmp154.tag=1U,_tmp154.f1=(unsigned long)((int)j);_tmp154;});void*_tmpF3[1U];_tmpF3[0]=& _tmpF5;({struct _dyneither_ptr _tmp1E2=({const char*_tmpF4="f%d";_tag_dyneither(_tmpF4,sizeof(char),4U);});Cyc_aprintf(_tmp1E2,_tag_dyneither(_tmpF3,sizeof(void*),1U));});});*_tmpF6=_tmp1E3;});_tmpF6;});_tmpF7[j]=_tmp1E4;});}}0;});_tag_dyneither(_tmpF7,sizeof(struct _dyneither_ptr*),_tmpF8);});
# 1086
Cyc_Absyn_field_names=_tmp1E5;});
# 1089
...
({void*_tmpFF=0U;({struct _dyneither_ptr _tmp1E6=({const char*_tmp100="unchecked aggrdecl";_tag_dyneither(_tmp100,sizeof(char),19U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmp1E6,_tag_dyneither(_tmpFF,sizeof(void*),0U));});});}else{_LL3: _tmp101=*(_tmpFE.KnownAggr).val;_LL4:
 return _tmp101;}_LL0:;}
# 1104
...
if(ds == 0  || ds->tl != 0)
({void*_tmp11F=0U;({struct _dyneither_ptr _tmp1E7=({const char*_tmp120="designator list not of length 1";_tag_dyneither(_tmp120,sizeof(char),32U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp1E7,_tag_dyneither(_tmp11F,sizeof(void*),0U));});});{
...
({void*_tmp123=0U;({struct _dyneither_ptr _tmp1E8=({const char*_tmp124="array designator in struct";_tag_dyneither(_tmp124,sizeof(char),27U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Warn_impos)(_tmp1E8,_tag_dyneither(_tmp123,sizeof(void*),0U));});});}_LL0:;};}
# 1165
