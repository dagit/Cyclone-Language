...
# 995
 if(_tmp183 == - 1){const char*_tmp395;return(_tmp395="aligned",_tag_dyneither(_tmp395,sizeof(char),8));}else{
# 997
switch(Cyc_Cyclone_c_compiler){case Cyc_Cyclone_Gcc_c: _LLC9: {
const char*_tmp399;void*_tmp398[1];struct Cyc_Int_pa_PrintArg_struct _tmp397;return(struct _dyneither_ptr)((_tmp397.tag=1,((_tmp397.f1=(unsigned long)_tmp183,((_tmp398[0]=& _tmp397,Cyc_aprintf(((_tmp399="aligned(%d)",_tag_dyneither(_tmp399,sizeof(char),12))),_tag_dyneither(_tmp398,sizeof(void*),1))))))));}case Cyc_Cyclone_Vc_c: _LLCA: {
const char*_tmp39D;void*_tmp39C[1];struct Cyc_Int_pa_PrintArg_struct _tmp39B;return(struct _dyneither_ptr)((_tmp39B.tag=1,((_tmp39B.f1=(unsigned long)_tmp183,((_tmp39C[0]=& _tmp39B,Cyc_aprintf(((_tmp39D="align(%d)",_tag_dyneither(_tmp39D,sizeof(char),10))),_tag_dyneither(_tmp39C,sizeof(void*),1))))))));}}}_LLA3: {struct Cyc_Absyn_Packed_att_Absyn_Attribute_struct*_tmp184=(struct Cyc_Absyn_Packed_att_Absyn_Attribute_struct*)_tmp17A;if(_tmp184->tag != 7)goto _LLA5;}_LLA4: {
# 1001
