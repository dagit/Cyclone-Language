...
struct _fat_ptr*_Tmp5=({struct _fat_ptr*_Tmp6=_cycalloc(sizeof(struct _fat_ptr));*_Tmp6=*((struct _fat_ptr*)_check_known_subscript_notnull(builtin_exns,4U,sizeof(struct _fat_ptr),i));_Tmp6;});_Tmp4->f2=_Tmp5;});_Tmp4;});
# 351
...
# 490
CAST_LOOP: {
void*_Tmp1=e->r;void*_Tmp2;void*_Tmp3;switch(*((int*)_Tmp1)){case 39: _Tmp3=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_Tmp1)->f1;{void*t2=_Tmp3;
...
# 497
void*_Tmp5=e2->r;if(*((int*)_Tmp5)==39){
