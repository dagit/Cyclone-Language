...
# 53
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp17=({struct Cyc_String_pa_PrintArg_struct _tmp101;_tmp101.tag=0,({struct _fat_ptr _tmp133=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_typ2string(tp));_tmp101.f1=_tmp133;});_tmp101;});struct Cyc_String_pa_PrintArg_struct _tmp18=({struct Cyc_String_pa_PrintArg_struct _tmp100;_tmp100.tag=0,({struct _fat_ptr _tmp134=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_term2string(tm));_tmp100.f1=_tmp134;});_tmp100;});void*_tmp15[2];_tmp15[0]=& _tmp17,_tmp15[1]=& _tmp18;({struct _fat_ptr _tmp135=({const char*_tmp16="(%s)%s";_tag_fat(_tmp16,sizeof(char),7U);});Cyc_aprintf(_tmp135,_tag_fat(_tmp15,sizeof(void*),2));});});}};}
# 58
...
return(void*)({struct Cyc_AssnDef_LogicVar_AssnDef_Term_struct*_tmp24=_cycalloc(sizeof(*_tmp24));_tmp24->tag=2,_tmp24->f1=0,_tmp24->f2=counter ++,_tmp24->f3=t;_tmp24;});}struct _tuple11{void*f1;void*f2;};
# 106
...
if(vd2 == vd)return t2;}}{
# 536
void*_tmpAB=Cyc_AssnDef_fresh_var(vd->type);void*t=_tmpAB;
