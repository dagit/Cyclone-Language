...
int _Tmp6=Cyc_AssnDef_hash_exp(e);return _Tmp6 + i;}case 12: _Tmp4=((struct Cyc_AssnDef_Offsetf_AssnDef_Term_struct*)t)->f1;_Tmp1=(void*)((struct Cyc_AssnDef_Offsetf_AssnDef_Term_struct*)t)->f2;{struct _fat_ptr*f=_Tmp4;void*t=_Tmp1;
...
if(Cyc_Evexp_exp_cmp(e1,e2))return(int)e1 - (int)e2;else{return 0;}}}else{goto _LL1F;}case 10: if(*((int*)_Tmp0.f1)==10){_TmpC=((struct Cyc_AssnDef_Addr_AssnDef_Term_struct*)_Tmp0.f0)->f1;_TmpA=((struct Cyc_AssnDef_Addr_AssnDef_Term_struct*)_Tmp0.f1)->f1;{struct Cyc_Absyn_Vardecl*vd1=_TmpC;struct Cyc_Absyn_Vardecl*vd2=_TmpA;
...
goto _LL0;}case 12: _Tmp5=((struct Cyc_AssnDef_Offsetf_AssnDef_Term_struct*)t)->f1;_Tmp4=(void*)((struct Cyc_AssnDef_Offsetf_AssnDef_Term_struct*)t)->f2;_Tmp2=(void*)((struct Cyc_AssnDef_Offsetf_AssnDef_Term_struct*)t)->f3;{struct _fat_ptr*f=_Tmp5;void*t1=_Tmp4;void*tp=_Tmp2;
# 1006
void*s1=Cyc_AssnDef_subst_term(dict,t1,term_h);
