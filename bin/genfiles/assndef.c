...
return i!=j;}}else{goto _LL17;}}else{_LL17:
 return 0;}}};}}struct _tuple14{void*f0;struct Cyc_List_List*f1;};
# 501
static struct _tuple14 Cyc_AssnDef_split_addr(void*a){
# 503
struct Cyc_List_List*fields=0;
while(1){
{void*_Tmp0;unsigned _Tmp1;void*_Tmp2;if(*((int*)a)==12){_Tmp2=(void*)((struct Cyc_AssnDef_Offsetf_AssnDef_Term_struct*)a)->f1;_Tmp1=((struct Cyc_AssnDef_Offsetf_AssnDef_Term_struct*)a)->f2;_Tmp0=(void*)((struct Cyc_AssnDef_Offsetf_AssnDef_Term_struct*)a)->f3;{void*r=_Tmp2;unsigned i=_Tmp1;void*tp=_Tmp0;
# 507
fields=({struct Cyc_List_List*_Tmp3=_cycalloc(sizeof(struct Cyc_List_List));_Tmp3->hd=(void*)i,_Tmp3->tl=fields;_Tmp3;});
a=r;
continue;}}else{
# 511
struct _tuple14 _Tmp3;_Tmp3.f0=a,_Tmp3.f1=fields;return _Tmp3;};}
# 505
1U;}}
# 516
...
# 518
for(1;fs!=0;fs=fs->tl){
v=Cyc_AssnDef_proj(v,(unsigned)((int)fs->hd),0);}
return v;}
# 523
...
goto LOOP;}{
# 535
struct _tuple14 _Tmp5=Cyc_AssnDef_split_addr(a2);void*_Tmp6;void*_Tmp7;_Tmp7=_Tmp5.f0;_Tmp6=_Tmp5.f1;{void*root=_Tmp7;struct Cyc_List_List*fields=_Tmp6;
if(a1==root)
...
void*_Tmp0;void*_Tmp1;void*_Tmp2;if(*((int*)tm)==13){_Tmp2=(void*)((struct Cyc_AssnDef_Offseti_AssnDef_Term_struct*)tm)->f1;_Tmp1=(void*)((struct Cyc_AssnDef_Offseti_AssnDef_Term_struct*)tm)->f2;_Tmp0=(void*)((struct Cyc_AssnDef_Offseti_AssnDef_Term_struct*)tm)->f3;{void*j=_Tmp2;void*t=_Tmp1;void*tp2=_Tmp0;
# 612
if((tp!=0 && tp2!=0)&& Cyc_Unify_unify(tp,tp2)){
void*_Tmp3=Cyc_AssnDef_plus(i,j,Cyc_Absyn_sint_type);void*_Tmp4=t;return Cyc_AssnDef_offseti(_Tmp3,_Tmp4,tp);}
goto _LL4;}}else{_LL4: {
# 616
struct Cyc_AssnDef_Offseti_AssnDef_Term_struct t=({struct Cyc_AssnDef_Offseti_AssnDef_Term_struct _Tmp3;_Tmp3.tag=13,_Tmp3.f1=i,_Tmp3.f2=tm,_Tmp3.f3=tp;_Tmp3;});
return Cyc_AssnDef_hash_cons_term((void*)& t);}};}
# 620
...
return vd;}struct _tuple15{struct Cyc_List_List*f0;int f1;};struct _tuple16{int f0;void*f1;};
# 701
struct _tuple15 Cyc_AssnDef_get_coefficient_term_list(void*t){
...
goto _LL0;}_LL0:;}{
# 736
struct _tuple15 _Tmp0;_Tmp0.f0=coefficient_term_list,_Tmp0.f1=res;return _Tmp0;}}
# 746 "assndef.cyc"
...
struct _tuple15 _Tmp0=Cyc_AssnDef_get_coefficient_term_list(t1);int _Tmp1;void*_Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{struct Cyc_List_List*coefficient_term_list1=_Tmp2;int i1=_Tmp1;
struct _tuple15 _Tmp3=Cyc_AssnDef_get_coefficient_term_list(t2);int _Tmp4;void*_Tmp5;_Tmp5=_Tmp3.f0;_Tmp4=_Tmp3.f1;{struct Cyc_List_List*coefficient_term_list2=_Tmp5;int i2=_Tmp4;
...
return res;}}}
# 889
static struct _tuple15 Cyc_AssnDef_term2termlist(enum Cyc_Absyn_Primop p,void*t){
...
goto _LL0;}_LL0:;}{
# 907
struct _tuple15 _Tmp0;_Tmp0.f0=termlist,_Tmp0.f1=res;return _Tmp0;}}
# 911
...
struct _tuple15 _Tmp0=Cyc_AssnDef_term2termlist(p,t1);int _Tmp1;void*_Tmp2;_Tmp2=_Tmp0.f0;_Tmp1=_Tmp0.f1;{struct Cyc_List_List*term_list1=_Tmp2;int c1=_Tmp1;
struct _tuple15 _Tmp3=Cyc_AssnDef_term2termlist(p,t2);int _Tmp4;void*_Tmp5;_Tmp5=_Tmp3.f0;_Tmp4=_Tmp3.f1;{struct Cyc_List_List*term_list2=_Tmp5;int c2=_Tmp4;
