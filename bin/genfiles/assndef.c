...
goto _LL0;}default: _Tmp4=(void*)((struct Cyc_AssnDef_Proj_AssnDef_Term_struct*)t)->f1;_Tmp5=((struct Cyc_AssnDef_Proj_AssnDef_Term_struct*)t)->f2;{void*t=_Tmp4;unsigned i=_Tmp5;
# 84
...
return(int)((unsigned)t ^ i);}default: _Tmp4=((struct Cyc_AssnDef_Aggr_AssnDef_Term_struct*)t)->f1;{struct Cyc_List_List*ts=_Tmp4;
# 147
unsigned res=37U;
for(1;ts!=0;ts=ts->tl){
res=res ^ (unsigned)((void*)ts->hd);}
return(int)res;}};}struct _tuple23{void*f0;void*f1;};
# 154
...
return(void*)({struct Cyc_AssnDef_Proj_AssnDef_Term_struct*_Tmp6=_cycalloc(sizeof(struct Cyc_AssnDef_Proj_AssnDef_Term_struct));_Tmp6->tag=11,_Tmp6->f1=t,_Tmp6->f2=i,_Tmp6->f3=tp;_Tmp6;});}default: _Tmp4=((struct Cyc_AssnDef_Aggr_AssnDef_Term_struct*)t)->f1;_Tmp2=(void*)((struct Cyc_AssnDef_Aggr_AssnDef_Term_struct*)t)->f2;{struct Cyc_List_List*ts=_Tmp4;void*tp=_Tmp2;
return(void*)({struct Cyc_AssnDef_Aggr_AssnDef_Term_struct*_Tmp6=_cycalloc(sizeof(struct Cyc_AssnDef_Aggr_AssnDef_Term_struct));_Tmp6->tag=10,_Tmp6->f1=ts,_Tmp6->f2=tp;_Tmp6;});}};}
# 241
...
_Tmp4=vd;goto _LL18;}default: _Tmp4=((struct Cyc_AssnDef_Var_AssnDef_Term_struct*)t)->f1;_LL18: {struct Cyc_Absyn_Vardecl*vd=_Tmp4;
# 1061
