...
Cyc_fflush(Cyc_stderr);}
# 92
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_Tmp0=_cycalloc(sizeof(struct Cyc_Core_Impossible_exn_struct));_Tmp0->tag=Cyc_Core_Impossible,_Tmp0->f1=msg;_Tmp0;}));}
# 95
...
Cyc_Warn_verr(loc,fmt,ap);}
# 105
(int)_throw((void*)({struct Cyc_Core_Impossible_exn_struct*_Tmp0=_cycalloc(sizeof(struct Cyc_Core_Impossible_exn_struct));_Tmp0->tag=Cyc_Core_Impossible,_Tmp0->f1=({const char*_Tmp1="Compiler Error";_tag_fat(_Tmp1,sizeof(char),15U);});_Tmp0;}));}
# 108
...
if(s_len >= 80){
lst=({struct Cyc_List_List*(*_Tmp0)(struct Cyc_List_List*,struct Cyc_List_List*)=({(struct Cyc_List_List*(*)(struct Cyc_List_List*,struct Cyc_List_List*))Cyc_List_append;});struct Cyc_List_List*_Tmp1=({struct _fat_ptr*_Tmp2[3];({struct _fat_ptr*_Tmp3=({struct _fat_ptr*_Tmp4=_cycalloc(sizeof(struct _fat_ptr));*_Tmp4=({const char*_Tmp5="\n";_tag_fat(_Tmp5,sizeof(char),2U);});_Tmp4;});_Tmp2[0]=_Tmp3;}),({struct _fat_ptr*_Tmp3=({struct _fat_ptr*_Tmp4=_cycalloc(sizeof(struct _fat_ptr));*_Tmp4=s;_Tmp4;});_Tmp2[1]=_Tmp3;}),({struct _fat_ptr*_Tmp3=({struct _fat_ptr*_Tmp4=_cycalloc(sizeof(struct _fat_ptr));*_Tmp4=({const char*_Tmp5="\n";_tag_fat(_Tmp5,sizeof(char),2U);});_Tmp4;});_Tmp2[2]=_Tmp3;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_Tmp2,sizeof(struct _fat_ptr*),3));});_Tmp0(_Tmp1,lst);});
curr_line_len=0;}else{
if(curr_line_len + s_len >= 80){
lst=({struct Cyc_List_List*(*_Tmp0)(struct Cyc_List_List*,struct Cyc_List_List*)=({(struct Cyc_List_List*(*)(struct Cyc_List_List*,struct Cyc_List_List*))Cyc_List_append;});struct Cyc_List_List*_Tmp1=({struct _fat_ptr*_Tmp2[2];({struct _fat_ptr*_Tmp3=({struct _fat_ptr*_Tmp4=_cycalloc(sizeof(struct _fat_ptr));*_Tmp4=({const char*_Tmp5="\n";_tag_fat(_Tmp5,sizeof(char),2U);});_Tmp4;});_Tmp2[0]=_Tmp3;}),({struct _fat_ptr*_Tmp3=({struct _fat_ptr*_Tmp4=_cycalloc(sizeof(struct _fat_ptr));*_Tmp4=s;_Tmp4;});_Tmp2[1]=_Tmp3;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_Tmp2,sizeof(struct _fat_ptr*),2));});_Tmp0(_Tmp1,lst);});
...
curr_line_len +=s_len;}}}}}
# 147
return Cyc_strconcat_l(({(struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev;})(lst));}
# 149
