...
int(*_T49)(struct Cyc_Set_Set*,struct _tuple0*)=(int(*)(struct Cyc_Set_Set*,struct _tuple0*))_TF;_TE=_T49;}_T10=env;_T11=_T10->aggr_keepers;_T12=n;_T13=_TE(_T11,_T12);if(_T13)goto _TL4;else{goto _TL6;}
...
Cyc_LowTreeShake_build_tables_type(env,t);return 1;}default: _LLF:
 return 1;};}}
# 97
static int Cyc_LowTreeShake_build_tables_visit_f2(struct Cyc_LowTreeShake_Env*env,struct Cyc_Absyn_Stmt*s){struct Cyc_Absyn_Stmt*_T0;int*_T1;int _T2;struct Cyc_Absyn_Decl*_T3;int*_T4;unsigned _T5;struct Cyc_LowTreeShake_Env*_T6;struct Cyc_Absyn_Vardecl*_T7;void*_T8;struct Cyc_LowTreeShake_Env*_T9;struct Cyc_Absyn_Fndecl*_TA;struct Cyc_Absyn_FnInfo _TB;void*_TC;struct Cyc_Absyn_Fndecl*_TD;struct Cyc_Absyn_FnInfo _TE;struct Cyc_LowTreeShake_Env*_TF;struct Cyc_List_List*_T10;void*_T11;struct _tuple8*_T12;struct _tuple8 _T13;void*_T14;struct Cyc_List_List*_T15;struct Cyc_Warn_String_Warn_Warg_struct _T16;int(*_T17)(struct _fat_ptr);void*(*_T18)(struct _fat_ptr);struct _fat_ptr _T19;_T0=s;{
...
# 134
void(*_T49)(struct Cyc_Hashtable_Table*,struct _tuple0*,int)=(void(*)(struct Cyc_Hashtable_Table*,struct _tuple0*,int))_TE;_TD=_T49;}_TF=env;_T10=_TF->funs_defined;_T11=fd;_T12=_T11->name;_TD(_T10,_T12,1);_T13=env;_T14=fd;_T15=_T14->i;_T16=_T15.ret_type;
...
_T49.f1=_tag_fat("LowTreeShake: top-level Cyclone decl",sizeof(char),37U);_T3E=_T49;}{struct Cyc_Warn_String_Warn_Warg_struct _T49=_T3E;void*_T4A[1];_T4A[0]=& _T49;_T40=Cyc_Warn_impos2;{int(*_T4B)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T40;_T3F=_T4B;}_T41=_tag_fat(_T4A,sizeof(void*),1);_T3F(_T41);}}_LL0:;}_T42=tds;
# 126
