...
({struct Cyc_String_pa_PrintArg_struct _tmp3=({struct Cyc_String_pa_PrintArg_struct _tmp105;_tmp105.tag=0U,_tmp105.f1=(struct _fat_ptr)((struct _fat_ptr)Cyc_Unify_failure_reason);_tmp105;});void*_tmp1[1U];_tmp1[0]=& _tmp3;({struct Cyc___cycFILE*_tmp121=Cyc_stderr;struct _fat_ptr _tmp120=({const char*_tmp2="  %s\n";_tag_fat(_tmp2,sizeof(char),6U);});Cyc_fprintf(_tmp121,_tmp120,_tag_fat(_tmp1,sizeof(void*),1U));});});
return;}
# 61
...
int pos=2;
({struct Cyc_String_pa_PrintArg_struct _tmpB=({struct Cyc_String_pa_PrintArg_struct _tmp106;_tmp106.tag=0U,_tmp106.f1=(struct _fat_ptr)((struct _fat_ptr)s1);_tmp106;});void*_tmp9[1U];_tmp9[0]=& _tmpB;({struct Cyc___cycFILE*_tmp124=Cyc_stderr;struct _fat_ptr _tmp123=({const char*_tmpA="  %s";_tag_fat(_tmpA,sizeof(char),5U);});Cyc_fprintf(_tmp124,_tmp123,_tag_fat(_tmp9,sizeof(void*),1U));});});
pos +=_get_fat_size(s1,sizeof(char));
if(pos + 5 >= 80){
({void*_tmpC=0U;({struct Cyc___cycFILE*_tmp126=Cyc_stderr;struct _fat_ptr _tmp125=({const char*_tmpD="\n\t";_tag_fat(_tmpD,sizeof(char),3U);});Cyc_fprintf(_tmp126,_tmp125,_tag_fat(_tmpC,sizeof(void*),0U));});});
pos=8;}else{
# 76
({void*_tmpE=0U;({struct Cyc___cycFILE*_tmp128=Cyc_stderr;struct _fat_ptr _tmp127=({const char*_tmpF=" ";_tag_fat(_tmpF,sizeof(char),2U);});Cyc_fprintf(_tmp128,_tmp127,_tag_fat(_tmpE,sizeof(void*),0U));});});
++ pos;}
# 79
({void*_tmp10=0U;({struct Cyc___cycFILE*_tmp12A=Cyc_stderr;struct _fat_ptr _tmp129=({const char*_tmp11="and ";_tag_fat(_tmp11,sizeof(char),5U);});Cyc_fprintf(_tmp12A,_tmp129,_tag_fat(_tmp10,sizeof(void*),0U));});});
pos +=4;
if((unsigned)pos + _get_fat_size(s2,sizeof(char))>= (unsigned)80){
({void*_tmp12=0U;({struct Cyc___cycFILE*_tmp12C=Cyc_stderr;struct _fat_ptr _tmp12B=({const char*_tmp13="\n\t";_tag_fat(_tmp13,sizeof(char),3U);});Cyc_fprintf(_tmp12C,_tmp12B,_tag_fat(_tmp12,sizeof(void*),0U));});});
pos=8;}
# 85
({struct Cyc_String_pa_PrintArg_struct _tmp16=({struct Cyc_String_pa_PrintArg_struct _tmp107;_tmp107.tag=0U,_tmp107.f1=(struct _fat_ptr)((struct _fat_ptr)s2);_tmp107;});void*_tmp14[1U];_tmp14[0]=& _tmp16;({struct Cyc___cycFILE*_tmp12E=Cyc_stderr;struct _fat_ptr _tmp12D=({const char*_tmp15="%s ";_tag_fat(_tmp15,sizeof(char),4U);});Cyc_fprintf(_tmp12E,_tmp12D,_tag_fat(_tmp14,sizeof(void*),1U));});});
pos +=_get_fat_size(s2,sizeof(char))+ (unsigned)1;
if(pos + 17 >= 80){
({void*_tmp17=0U;({struct Cyc___cycFILE*_tmp130=Cyc_stderr;struct _fat_ptr _tmp12F=({const char*_tmp18="\n\t";_tag_fat(_tmp18,sizeof(char),3U);});Cyc_fprintf(_tmp130,_tmp12F,_tag_fat(_tmp17,sizeof(void*),0U));});});
pos=8;}
# 91
({void*_tmp19=0U;({struct Cyc___cycFILE*_tmp132=Cyc_stderr;struct _fat_ptr _tmp131=({const char*_tmp1A="are not compatible. ";_tag_fat(_tmp1A,sizeof(char),21U);});Cyc_fprintf(_tmp132,_tmp131,_tag_fat(_tmp19,sizeof(void*),0U));});});
pos +=17;
...
({void*_tmp1B=0U;({struct Cyc___cycFILE*_tmp136=Cyc_stderr;struct _fat_ptr _tmp135=({const char*_tmp1C="\n\t";_tag_fat(_tmp1C,sizeof(char),3U);});Cyc_fprintf(_tmp136,_tmp135,_tag_fat(_tmp1B,sizeof(void*),0U));});});
({struct Cyc_String_pa_PrintArg_struct _tmp1F=({struct Cyc_String_pa_PrintArg_struct _tmp108;_tmp108.tag=0U,_tmp108.f1=(struct _fat_ptr)((struct _fat_ptr)Cyc_Unify_failure_reason);_tmp108;});void*_tmp1D[1U];_tmp1D[0]=& _tmp1F;({struct Cyc___cycFILE*_tmp138=Cyc_stderr;struct _fat_ptr _tmp137=({const char*_tmp1E="%s";_tag_fat(_tmp1E,sizeof(char),3U);});Cyc_fprintf(_tmp138,_tmp137,_tag_fat(_tmp1D,sizeof(void*),1U));});});}
# 98
({void*_tmp20=0U;({struct Cyc___cycFILE*_tmp13A=Cyc_stderr;struct _fat_ptr _tmp139=({const char*_tmp21="\n";_tag_fat(_tmp21,sizeof(char),2U);});Cyc_fprintf(_tmp13A,_tmp139,_tag_fat(_tmp20,sizeof(void*),0U));});});
Cyc_fflush(Cyc_stderr);}}}
# 104
...
struct _tuple11 _tmp24=({struct _tuple11 _tmp109;({void*_tmp13C=Cyc_Kinds_compress_kb(kb1);_tmp109.f1=_tmp13C;}),({void*_tmp13B=Cyc_Kinds_compress_kb(kb2);_tmp109.f2=_tmp13B;});_tmp109;});struct _tuple11 _stmttmp0=_tmp24;struct _tuple11 _tmp25=_stmttmp0;void*_tmp27;struct Cyc_Core_Opt**_tmp26;struct Cyc_Core_Opt**_tmp29;void*_tmp28;struct Cyc_Absyn_Kind*_tmp2D;struct Cyc_Core_Opt**_tmp2C;struct Cyc_Absyn_Kind*_tmp2B;struct Cyc_Core_Opt**_tmp2A;struct Cyc_Absyn_Kind*_tmp30;struct Cyc_Core_Opt**_tmp2F;struct Cyc_Absyn_Kind*_tmp2E;struct Cyc_Absyn_Kind*_tmp32;struct Cyc_Absyn_Kind*_tmp31;switch(*((int*)_tmp25.f1)){case 0U: switch(*((int*)_tmp25.f2)){case 0U: _LL1: _tmp31=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp25.f1)->f1;_tmp32=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp25.f2)->f1;_LL2: {struct Cyc_Absyn_Kind*k1=_tmp31;struct Cyc_Absyn_Kind*k2=_tmp32;
...
if(rg != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp10A;_tmp10A.tag=0U,({struct _fat_ptr _tmp140=({const char*_tmp4C="occurs check: constrained Evar in compressed type";_tag_fat(_tmp4C,sizeof(char),50U);});_tmp10A.f1=_tmp140;});_tmp10A;});void*_tmp4A[1U];_tmp4A[0]=& _tmp4B;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp4A,sizeof(void*),1U));});{
# 148
int problem=0;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp10B;_tmp10B.tag=0U,({struct _fat_ptr _tmp142=({const char*_tmp5C="tq1 real_const not set.";_tag_fat(_tmp5C,sizeof(char),24U);});_tmp10B.f1=_tmp142;});_tmp10B;});void*_tmp5A[1U];_tmp5A[0]=& _tmp5B;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp5A,sizeof(void*),1U));});
if(tq2.print_const && !tq2.real_const)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp10C;_tmp10C.tag=0U,({struct _fat_ptr _tmp143=({const char*_tmp5F="tq2 real_const not set.";_tag_fat(_tmp5F,sizeof(char),24U);});_tmp10C.f1=_tmp143;});_tmp10C;});void*_tmp5D[1U];_tmp5D[0]=& _tmp5E;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp5D,sizeof(void*),1U));});
# 242
...
return;default: switch(*((int*)_tmp72.f1)){case 2U: goto _LL32;case 3U: goto _LL32;case 9U: goto _LL32;case 4U: goto _LL32;case 5U: goto _LL32;case 6U: goto _LL32;case 7U: goto _LL32;case 8U: goto _LL32;default: goto _LL32;}}else{switch(*((int*)_tmp72.f1)){case 2U: if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp72.f2)->tag == 2U){_LL22: _tmpB1=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp72.f1)->f1;_tmpB2=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp72.f2)->f1;_LL23: {struct Cyc_Absyn_Tvar*tv2=_tmpB1;struct Cyc_Absyn_Tvar*tv1=_tmpB2;
# 356
...
# 379
void*_tmpBE=Cyc_Absyn_compress(b1);void*_stmttmp3=_tmpBE;void*_tmpBF=_stmttmp3;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmpBF)->tag == 0U){if(((struct Cyc_Absyn_FatCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmpBF)->f1)->tag == 14U){_LL35: _LL36:
# 381
...
Cyc_Unify_fail_because((struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpCA=({struct Cyc_String_pa_PrintArg_struct _tmp116;_tmp116.tag=0U,({
struct _fat_ptr _tmp145=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_tvar2string((struct Cyc_Absyn_Tvar*)tvs1->hd));_tmp116.f1=_tmp145;});_tmp116;});struct Cyc_String_pa_PrintArg_struct _tmpCB=({struct Cyc_String_pa_PrintArg_struct _tmp115;_tmp115.tag=0U,({
struct _fat_ptr _tmp146=(struct _fat_ptr)((struct _fat_ptr)Cyc_Kinds_kind2string(Cyc_Kinds_tvar_kind((struct Cyc_Absyn_Tvar*)tvs1->hd,& Cyc_Kinds_bk)));_tmp115.f1=_tmp146;});_tmp115;});struct Cyc_String_pa_PrintArg_struct _tmpCC=({struct Cyc_String_pa_PrintArg_struct _tmp114;_tmp114.tag=0U,({
# 418
struct _fat_ptr _tmp147=(struct _fat_ptr)((struct _fat_ptr)Cyc_Kinds_kind2string(Cyc_Kinds_tvar_kind((struct Cyc_Absyn_Tvar*)tvs2->hd,& Cyc_Kinds_bk)));_tmp114.f1=_tmp147;});_tmp114;});void*_tmpC8[3U];_tmpC8[0]=& _tmpCA,_tmpC8[1]=& _tmpCB,_tmpC8[2]=& _tmpCC;({struct _fat_ptr _tmp148=({const char*_tmpC9="(type var %s has different kinds %s and %s)";_tag_fat(_tmpC9,sizeof(char),44U);});Cyc_aprintf(_tmp148,_tag_fat(_tmpC8,sizeof(void*),3U));});}));
# 420
...
if(bad_effect)
Cyc_Unify_fail_because((struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpEA=({struct Cyc_String_pa_PrintArg_struct _tmp11B;_tmp11B.tag=0U,({struct _fat_ptr _tmp14E=(struct _fat_ptr)((struct _fat_ptr)((unsigned)eff1?Cyc_Absynpp_typ2string(eff1):(struct _fat_ptr)({const char*_tmpED="-";_tag_fat(_tmpED,sizeof(char),2U);})));_tmp11B.f1=_tmp14E;});_tmp11B;});struct Cyc_String_pa_PrintArg_struct _tmpEB=({struct Cyc_String_pa_PrintArg_struct _tmp11A;_tmp11A.tag=0U,({
struct _fat_ptr _tmp14F=(struct _fat_ptr)((struct _fat_ptr)((unsigned)eff2?Cyc_Absynpp_typ2string(eff2):(struct _fat_ptr)({const char*_tmpEC="-";_tag_fat(_tmpEC,sizeof(char),2U);})));_tmp11A.f1=_tmp14F;});_tmp11A;});void*_tmpE8[2U];_tmpE8[0]=& _tmpEA,_tmpE8[1]=& _tmpEB;({struct _fat_ptr _tmp150=({const char*_tmpE9="(function effects (%s,%s) do not match)";_tag_fat(_tmpE9,sizeof(char),40U);});Cyc_aprintf(_tmp150,_tag_fat(_tmpE8,sizeof(void*),2U));});}));
...
Cyc_Unify_fail_because(({const char*_tmpFA="(tuple types have different numbers of components)";_tag_fat(_tmpFA,sizeof(char),51U);}));}}else{goto _LL32;}case 7U: if(((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp72.f2)->tag == 7U){_LL2E: _tmp77=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp72.f1)->f1;_tmp78=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp72.f1)->f2;_tmp79=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp72.f2)->f1;_tmp7A=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp72.f2)->f2;_LL2F: {enum Cyc_Absyn_AggrKind k2=_tmp77;struct Cyc_List_List*fs2=_tmp78;enum Cyc_Absyn_AggrKind k1=_tmp79;struct Cyc_List_List*fs1=_tmp7A;
# 498
if((int)k1 != (int)k2)
