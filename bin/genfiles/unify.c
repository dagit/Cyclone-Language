...
# 158
int problem=0;
{struct Cyc_List_List*s=(struct Cyc_List_List*)(*sopt)->v;for(0;s!=0 && !problem;s=s->tl){
...
# 407
if(!({struct Cyc_Absyn_Kind*_Tmp29=(struct Cyc_Absyn_Kind*)k->v;Cyc_Kinds_kind_eq(_Tmp29,Cyc_Tcutil_type_kind(t1));}))
