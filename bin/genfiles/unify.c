...
# 65
struct _tuple11 _tmp6=Cyc_Unify_ts_failure;void*_tmp23;void*_tmp22;_LL1: _tmp23=_tmp6.f1;_tmp22=_tmp6.f2;_LL2:;{
...
struct _tuple11 _tmp24=({struct _tuple11 _tmpFF;({void*_tmp12C=Cyc_Absyn_compress_kb(kb1);_tmpFF.f1=_tmp12C;}),({void*_tmp12B=Cyc_Absyn_compress_kb(kb2);_tmpFF.f2=_tmp12B;});_tmpFF;});struct _tuple11 _tmp25=_tmp24;struct Cyc_Core_Opt**_tmp3A;void*_tmp39;void*_tmp38;struct Cyc_Core_Opt**_tmp37;struct Cyc_Core_Opt**_tmp36;struct Cyc_Absyn_Kind*_tmp35;struct Cyc_Core_Opt**_tmp34;struct Cyc_Absyn_Kind*_tmp33;struct Cyc_Core_Opt**_tmp32;struct Cyc_Absyn_Kind*_tmp31;struct Cyc_Absyn_Kind*_tmp30;struct Cyc_Absyn_Kind*_tmp2F;struct Cyc_Core_Opt**_tmp2E;struct Cyc_Absyn_Kind*_tmp2D;struct Cyc_Absyn_Kind*_tmp2C;struct Cyc_Absyn_Kind*_tmp2B;switch(*((int*)_tmp25.f1)){case 0U: switch(*((int*)_tmp25.f2)){case 0U: _LL1: _tmp2C=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp25.f1)->f1;_tmp2B=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp25.f2)->f1;_LL2:
...
# 131
 _tmp38=_tmp39;_tmp37=_tmp3A;goto _LLC;}_LL0:;}struct _tuple13{struct Cyc_Absyn_Tqual f1;void*f2;};
# 140
...
struct _tuple11*_tmp41=(struct _tuple11*)_tmp4B->hd;struct _tuple11*_tmp42=_tmp41;void*_tmp44;void*_tmp43;_LL16: _tmp44=_tmp42->f1;_tmp43=_tmp42->f2;_LL17:;
...
Cyc_Unify_occurs(evar,r,env,(*((struct _tuple13*)_tmp52->hd)).f2);}
...
# 242
Cyc_Unify_ts_failure=({struct _tuple11 _tmp100;_tmp100.f1=t1,_tmp100.f2=t2;_tmp100;});
Cyc_Unify_tqs_const=({struct _tuple12 _tmp101;_tmp101.f1=tq1.real_const,_tmp101.f2=tq2.real_const;_tmp101;});
Cyc_Unify_failure_reason=({const char*_tmp60="(qualifiers don't match)";_tag_fat(_tmp60,sizeof(char),25U);});
(int)_throw((void*)& Cyc_Unify_Unify_val);}
# 248
Cyc_Unify_tqs_const=({struct _tuple12 _tmp102;_tmp102.f1=0,_tmp102.f2=0;_tmp102;});}
# 262 "unify.cyc"
...
Cyc_Unify_ts_failure=({struct _tuple11 _tmp104;_tmp104.f1=t1,_tmp104.f2=t2;_tmp104;});
...
Cyc_Unify_ts_failure=({struct _tuple11 _tmp105;_tmp105.f1=t1,_tmp105.f2=t2;_tmp105;});
...
inst=({struct Cyc_List_List*_tmp89=_region_malloc(rgn,sizeof(*_tmp89));({struct _tuple14*_tmp13B=({struct _tuple14*_tmp88=_region_malloc(rgn,sizeof(*_tmp88));_tmp88->f1=(struct Cyc_Absyn_Tvar*)_tmpF0->hd,({void*_tmp13A=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)_tmpE3->hd);_tmp88->f2=_tmp13A;});_tmp88;});_tmp89->hd=_tmp13B;}),_tmp89->tl=inst;_tmp89;});
_tmpE3=_tmpE3->tl;
_tmpF0=_tmpF0->tl;};}
# 414
if(_tmpF0 != 0)
...
# 436
Cyc_Unify_ts_failure=({struct _tuple11 _tmp109;_tmp109.f1=t1,_tmp109.f2=t2;_tmp109;});
...
# 442
{struct _tuple15 _tmp97=({struct _tuple15 _tmp10A;_tmp10A.f1=_tmpDD,_tmp10A.f2=_tmpEA;_tmp10A;});struct _tuple15 _tmp98=_tmp97;struct _fat_ptr*_tmpA2;struct Cyc_Absyn_Tqual _tmpA1;void*_tmpA0;int _tmp9F;struct _fat_ptr*_tmp9E;struct Cyc_Absyn_Tqual _tmp9D;void*_tmp9C;int _tmp9B;if(_tmp98.f1 == 0){if(_tmp98.f2 == 0){_LL40: _LL41:
...
if(!Cyc_Tcutil_equiv_fn_atts(_tmpE8,_tmpDB))
...
struct _tuple13 _tmpA8=*((struct _tuple13*)_tmpF1->hd);struct _tuple13 _tmpA9=_tmpA8;struct Cyc_Absyn_Tqual _tmpAF;void*_tmpAE;_LL49: _tmpAF=_tmpA9.f1;_tmpAE=_tmpA9.f2;_LL4A:;{
struct _tuple13 _tmpAA=*((struct _tuple13*)_tmpF2->hd);struct _tuple13 _tmpAB=_tmpAA;struct Cyc_Absyn_Tqual _tmpAD;void*_tmpAC;_LL4C: _tmpAD=_tmpAB.f1;_tmpAC=_tmpAB.f2;_LL4D:;
