...
unsigned int i);struct _dyneither_ptr Cyc_Core_new_string(unsigned int i){char*_tmp8;
...
_tmp9))));}struct Cyc_Core_NewRegion Cyc_Core_new_dynregion();struct Cyc_Core_NewRegion
