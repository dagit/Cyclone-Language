...
({void*_tmp1F6=Cyc_AssnDef_reduce(*a1);*a1=_tmp1F6;});
({void*_tmp1F7=Cyc_AssnDef_reduce(*a2);*a2=_tmp1F7;});
...
res=({void*_tmp1F8=ctxt;Cyc_Vcgen_weaken_it(_tmp1F8,Cyc_AssnDef_and(b1,b2));});
goto _LL0;}case 0:
...
goto _LL0;default:
 return({void*_tmp1F9=ctxt;Cyc_Vcgen_weaken_it(_tmp1F9,Cyc_AssnDef_reduce(a));});}_LL0:;}
# 150
return res;}}
# 160 "vcgen.cyc"
...
# 189
return({void*_tmp1FA=a;Cyc_AssnDef_and(_tmp1FA,Cyc_AssnDef_eq(tgt,src));});}}else{
({void*_tmpA=0U;({struct _fat_ptr _tmp1FB=({const char*_tmpB="vcgen do_assign";_tag_fat(_tmpB,sizeof(char),16U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp1FB,_tag_fat(_tmpA,sizeof(void*),0));});});}};}struct Cyc_Vcgen_SharedEnv{struct Cyc_Hashtable_Table*assn_table;struct Cyc_Hashtable_Table*succ_table;void*try_assn;void**exp_stmt;void*res_term;void*res_assn;};struct Cyc_Vcgen_Env{struct Cyc_Vcgen_SharedEnv*shared;struct Cyc_Dict_Dict state_counter;struct Cyc_Hashtable_Table**assn_info;};
# 229 "vcgen.cyc"
...
({struct Cyc_Dict_Dict _tmp1FC=((struct Cyc_Dict_Dict(*)(int(*)(int,struct Cyc_Absyn_Vardecl*,int,int),int,struct Cyc_Dict_Dict,struct Cyc_Dict_Dict))Cyc_Dict_union_two_c)(Cyc_Vcgen_max_counter,0,old_env->state_counter,new_env->state_counter);old_env->state_counter=_tmp1FC;});}
# 263
...
({struct Cyc_Dict_Dict _tmp1FD=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct Cyc_Absyn_Vardecl*,int))Cyc_Dict_insert)(env->state_counter,vd,res + 1);env->state_counter=_tmp1FD;});
...
*aprev=ain;}else{
# 302
({struct Cyc_Hashtable_Table*_tmp1FF=(env->shared)->assn_table;struct Cyc_Absyn_Stmt*_tmp1FE=s;((void(*)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Stmt*,void**))Cyc_Hashtable_insert)(_tmp1FF,_tmp1FE,({void**_tmp17=_cycalloc(sizeof(*_tmp17));*_tmp17=ain;_tmp17;}));});}
# 304
return ain;}
# 309
...
*aprev=ain;}else{
# 316
({struct Cyc_Hashtable_Table*_tmp201=(env->shared)->assn_table;struct Cyc_Absyn_Stmt*_tmp200=s;((void(*)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Stmt*,void**))Cyc_Hashtable_insert)(_tmp201,_tmp200,({void**_tmp19=_cycalloc(sizeof(*_tmp19));*_tmp19=ain;_tmp19;}));});}
# 318
return ain;}
# 323
static void Cyc_Vcgen_update_try_assn(struct Cyc_Vcgen_Env*env,void*a){
({void*_tmp202=Cyc_PrattProver_merge_assn((env->shared)->try_assn,a);(env->shared)->try_assn=_tmp202;});}
# 328
...
shared->res_term=v;
({void*_tmp206=({
void*_tmp205=({void*_tmp203=a;Cyc_AssnDef_and(_tmp203,Cyc_AssnDef_eq(v,t));});Cyc_PrattProver_merge_assn(_tmp205,({void*_tmp204=shared->res_assn;Cyc_AssnDef_and(_tmp204,Cyc_AssnDef_eq(v,shared->res_term));}));});
# 333
shared->res_assn=_tmp206;});}else{
# 336
({void*_tmp207=Cyc_PrattProver_merge_assn(a,shared->res_assn);shared->res_assn=_tmp207;});}}
# 341
...
if(result == 0)
return({struct _tuple12 _tmp1B5;_tmp1B5.f1=(void*)& Cyc_AssnDef_true_assn,_tmp1B5.f2=(void*)& Cyc_AssnDef_false_assn;_tmp1B5;});else{
# 351
return*(*result);}}
# 355
...
# 401
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp26=({struct Cyc_String_pa_PrintArg_struct _tmp1B6;_tmp1B6.tag=0,({struct _fat_ptr _tmp208=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp1B6.f1=_tmp208;});_tmp1B6;});void*_tmp24[1];_tmp24[0]=& _tmp26;({struct _fat_ptr _tmp209=({const char*_tmp25="if (%s) ...";_tag_fat(_tmp25,sizeof(char),12U);});Cyc_aprintf(_tmp209,_tag_fat(_tmp24,sizeof(void*),1));});});}case 5: _tmp21=(((struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*)_tmp20)->f1).f1;{struct Cyc_Absyn_Exp*e=_tmp21;
# 403
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp29=({struct Cyc_String_pa_PrintArg_struct _tmp1B7;_tmp1B7.tag=0,({struct _fat_ptr _tmp20A=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp1B7.f1=_tmp20A;});_tmp1B7;});void*_tmp27[1];_tmp27[0]=& _tmp29;({struct _fat_ptr _tmp20B=({const char*_tmp28="while (%s) ...";_tag_fat(_tmp28,sizeof(char),15U);});Cyc_aprintf(_tmp20B,_tag_fat(_tmp27,sizeof(void*),1));});});}case 9: _tmp21=((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp20)->f1;_tmp22=(((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp20)->f2).f1;_tmp23=(((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp20)->f3).f1;{struct Cyc_Absyn_Exp*e1=_tmp21;struct Cyc_Absyn_Exp*e2=_tmp22;struct Cyc_Absyn_Exp*e3=_tmp23;
# 405
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2C=({struct Cyc_String_pa_PrintArg_struct _tmp1BA;_tmp1BA.tag=0,({struct _fat_ptr _tmp20C=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e1));_tmp1BA.f1=_tmp20C;});_tmp1BA;});struct Cyc_String_pa_PrintArg_struct _tmp2D=({struct Cyc_String_pa_PrintArg_struct _tmp1B9;_tmp1B9.tag=0,({
struct _fat_ptr _tmp20D=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e2));_tmp1B9.f1=_tmp20D;});_tmp1B9;});struct Cyc_String_pa_PrintArg_struct _tmp2E=({struct Cyc_String_pa_PrintArg_struct _tmp1B8;_tmp1B8.tag=0,({struct _fat_ptr _tmp20E=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e3));_tmp1B8.f1=_tmp20E;});_tmp1B8;});void*_tmp2A[3];_tmp2A[0]=& _tmp2C,_tmp2A[1]=& _tmp2D,_tmp2A[2]=& _tmp2E;({struct _fat_ptr _tmp20F=({const char*_tmp2B="for (%s;%s;%s) ...";_tag_fat(_tmp2B,sizeof(char),19U);});Cyc_aprintf(_tmp20F,_tag_fat(_tmp2A,sizeof(void*),3));});});}case 10: _tmp21=((struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp20)->f1;{struct Cyc_Absyn_Exp*e=_tmp21;
# 408
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp31=({struct Cyc_String_pa_PrintArg_struct _tmp1BB;_tmp1BB.tag=0,({struct _fat_ptr _tmp210=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp1BB.f1=_tmp210;});_tmp1BB;});void*_tmp2F[1];_tmp2F[0]=& _tmp31;({struct _fat_ptr _tmp211=({const char*_tmp30="switch (%s) ...";_tag_fat(_tmp30,sizeof(char),16U);});Cyc_aprintf(_tmp211,_tag_fat(_tmp2F,sizeof(void*),1));});});}case 14: _tmp21=(((struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp20)->f2).f1;{struct Cyc_Absyn_Exp*e=_tmp21;
# 410
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp34=({struct Cyc_String_pa_PrintArg_struct _tmp1BC;_tmp1BC.tag=0,({struct _fat_ptr _tmp212=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp1BC.f1=_tmp212;});_tmp1BC;});void*_tmp32[1];_tmp32[0]=& _tmp34;({struct _fat_ptr _tmp213=({const char*_tmp33="do ... while (%s)";_tag_fat(_tmp33,sizeof(char),18U);});Cyc_aprintf(_tmp213,_tag_fat(_tmp32,sizeof(void*),1));});});}case 15: _tmp21=((struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*)_tmp20)->f1;{struct Cyc_Absyn_Stmt*s=_tmp21;
# 412
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp37=({struct Cyc_String_pa_PrintArg_struct _tmp1BD;_tmp1BD.tag=0,({struct _fat_ptr _tmp214=(struct _fat_ptr)((struct _fat_ptr)Cyc_Vcgen_stmt2shortstring(s));_tmp1BD.f1=_tmp214;});_tmp1BD;});void*_tmp35[1];_tmp35[0]=& _tmp37;({struct _fat_ptr _tmp215=({const char*_tmp36="try %s catch ...";_tag_fat(_tmp36,sizeof(char),17U);});Cyc_aprintf(_tmp215,_tag_fat(_tmp35,sizeof(void*),1));});});}case 2: _tmp21=((struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp20)->f1;{struct Cyc_Absyn_Stmt*s=_tmp21;
...
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp3B=({struct Cyc_String_pa_PrintArg_struct _tmp1BE;_tmp1BE.tag=0,_tmp1BE.f1=(struct _fat_ptr)((struct _fat_ptr)res);_tmp1BE;});void*_tmp39[1];_tmp39[0]=& _tmp3B;({struct _fat_ptr _tmp217=({const char*_tmp3A="%s...";_tag_fat(_tmp3A,sizeof(char),6U);});Cyc_aprintf(_tmp217,_tag_fat(_tmp39,sizeof(void*),1));});});}};}
# 475 "vcgen.cyc"
...
ain=({void*_tmp218=*Cyc_Vcgen_get_assn(env,dummy);Cyc_Vcgen_weaken_assn(_tmp218,ain);});
...
({void*_tmp68=0U;({struct _fat_ptr _tmp219=({const char*_tmp69="vcgen fallthru";_tag_fat(_tmp69,sizeof(char),15U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp219,_tag_fat(_tmp68,sizeof(void*),0));});});else{_tmp40=((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp3F)->f1;_tmp41=*((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp3F)->f2;{struct Cyc_List_List*es=_tmp40;struct Cyc_Absyn_Switch_clause*dest=_tmp41;
# 575
...
if(vd != 0)
a=({struct Cyc_Vcgen_Env*_tmp21C=env;void*_tmp21B=a;void*_tmp21A=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp70=_cycalloc(sizeof(*_tmp70));_tmp70->tag=1,_tmp70->f1=vd;_tmp70;});Cyc_Vcgen_do_assign(_tmp21C,_tmp21B,_tmp21A,(void*)((struct Cyc_List_List*)_check_null(ts))->hd);});}}
# 586
...
# 612
return({void*_tmp21D=ain;Cyc_PrattProver_merge_assn(_tmp21D,Cyc_Vcgen_vcgen_switch(env,scs,new_try_assn));});}}};}}struct _tuple15{struct Cyc_Absyn_Vardecl**f1;struct Cyc_Absyn_Exp*f2;};
# 616
...
if(vdopt != 0){
if(eopt != 0)
a=({struct Cyc_Vcgen_Env*_tmp220=env;void*_tmp21F=a;void*_tmp21E=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp7A=_cycalloc(sizeof(*_tmp7A));_tmp7A->tag=1,_tmp7A->f1=*vdopt;_tmp7A;});Cyc_Vcgen_do_assign(_tmp220,_tmp21F,_tmp21E,(Cyc_Vcgen_vcgen_rexp_nodebug(env,eopt,a)).f1);});else{
# 630
a=({struct Cyc_Vcgen_Env*_tmp223=env;void*_tmp222=a;void*_tmp221=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp7B=_cycalloc(sizeof(*_tmp7B));_tmp7B->tag=1,_tmp7B->f1=*vdopt;_tmp7B;});Cyc_Vcgen_do_assign(_tmp223,_tmp222,_tmp221,Cyc_AssnDef_fresh_var());});}}}}}
# 633
if(sc->where_clause != 0)
a=(Cyc_Vcgen_vcgen_test(env,(struct Cyc_Absyn_Exp*)_check_null(sc->where_clause),a)).f1;
res=({void*_tmp224=res;Cyc_PrattProver_merge_assn(_tmp224,Cyc_Vcgen_vcgen_stmt_nodebug(env,sc->body,a));});}
# 637
return res;}
# 640
...
a=({struct Cyc_Vcgen_Env*_tmp227=env;void*_tmp226=a;void*_tmp225=(void*)tv;Cyc_Vcgen_do_assign(_tmp227,_tmp226,_tmp225,Cyc_AssnDef_fresh_var());});
if(vd->initializer != 0){
...
struct _tuple12 _tmp9B=({struct _tuple12 _tmp1BF;_tmp1BF.f1=t1,_tmp1BF.f2=t2;_tmp1BF;});struct _tuple12 _stmttmp12=_tmp9B;struct _tuple12 _tmp9C=_stmttmp12;if(*((int*)_tmp9C.f1)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp9C.f1)->f1)== 1){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp9C.f1)->f1)->f1 == Cyc_Absyn_Unsigned)
...
return({struct _tuple12 _tmp1C0;({void*_tmp229=Cyc_PrattProver_merge_assn(a2t,a3t);_tmp1C0.f1=_tmp229;}),({void*_tmp228=Cyc_PrattProver_merge_assn(a2f,a3f);_tmp1C0.f2=_tmp228;});_tmp1C0;});}}}}case 7: _tmpA0=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp9E)->f1;_tmpA1=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp9E)->f2;{struct Cyc_Absyn_Exp*e1=_tmpA0;struct Cyc_Absyn_Exp*e2=_tmpA1;
# 711
...
return({struct _tuple12 _tmp1C1;_tmp1C1.f1=a2t,({void*_tmp22A=Cyc_PrattProver_merge_assn(a1f,a2f);_tmp1C1.f2=_tmp22A;});_tmp1C1;});}}}case 8: _tmpA0=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp9E)->f1;_tmpA1=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp9E)->f2;{struct Cyc_Absyn_Exp*e1=_tmpA0;struct Cyc_Absyn_Exp*e2=_tmpA1;
# 715
...
return({struct _tuple12 _tmp1C2;({void*_tmp22B=Cyc_PrattProver_merge_assn(a1t,a2t);_tmp1C2.f1=_tmp22B;}),_tmp1C2.f2=a2f;_tmp1C2;});}}}case 9: _tmpA0=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp9E)->f1;_tmpA1=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp9E)->f2;{struct Cyc_Absyn_Exp*e1=_tmpA0;struct Cyc_Absyn_Exp*e2=_tmpA1;
# 719
...
return({struct _tuple12 _tmp1C3;_tmp1C3.f1=af,_tmp1C3.f2=at;_tmp1C3;});}}}else{goto _LLD;}}else{if(((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp9E)->f2 != 0){if(((struct Cyc_List_List*)((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp9E)->f2)->tl != 0){if(((struct Cyc_List_List*)((struct Cyc_List_List*)((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp9E)->f2)->tl)->tl == 0){_tmp9F=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp9E)->f1;_tmpA0=(struct Cyc_Absyn_Exp*)(((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp9E)->f2)->hd;_tmpA1=(struct Cyc_Absyn_Exp*)((((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp9E)->f2)->tl)->hd;{enum Cyc_Absyn_Primop p=_tmp9F;struct Cyc_Absyn_Exp*e1=_tmpA0;struct Cyc_Absyn_Exp*e2=_tmpA1;
# 725
...
# 733
 at=({void*_tmp22C=at;Cyc_AssnDef_and(_tmp22C,Cyc_AssnDef_eq(t1,t2));});goto _LL30;case Cyc_Absyn_Neq:
 af=({void*_tmp22D=af;Cyc_AssnDef_and(_tmp22D,Cyc_AssnDef_eq(t1,t2));});goto _LL30;case Cyc_Absyn_Lt:
# 736
 if(Cyc_Vcgen_unsigned_comparison(e1,e2)){
at=({void*_tmp22E=at;Cyc_AssnDef_and(_tmp22E,Cyc_AssnDef_ult(t1,t2));});af=({void*_tmp22F=af;Cyc_AssnDef_and(_tmp22F,Cyc_AssnDef_ulte(t2,t1));});}else{
# 739
at=({void*_tmp230=at;Cyc_AssnDef_and(_tmp230,Cyc_AssnDef_slt(t1,t2));});af=({void*_tmp231=af;Cyc_AssnDef_and(_tmp231,Cyc_AssnDef_slte(t2,t1));});}
# 741
goto _LL30;case Cyc_Absyn_Lte:
# 743
 if(Cyc_Vcgen_unsigned_comparison(e1,e2)){
at=({void*_tmp232=at;Cyc_AssnDef_and(_tmp232,Cyc_AssnDef_ulte(t1,t2));});af=({void*_tmp233=af;Cyc_AssnDef_and(_tmp233,Cyc_AssnDef_ult(t2,t1));});}else{
# 746
at=({void*_tmp234=at;Cyc_AssnDef_and(_tmp234,Cyc_AssnDef_slte(t1,t2));});af=({void*_tmp235=af;Cyc_AssnDef_and(_tmp235,Cyc_AssnDef_slt(t2,t1));});}
# 748
goto _LL30;case Cyc_Absyn_Gt:
# 750
 if(Cyc_Vcgen_unsigned_comparison(e1,e2)){
at=({void*_tmp236=at;Cyc_AssnDef_and(_tmp236,Cyc_AssnDef_ult(t2,t1));});af=({void*_tmp237=af;Cyc_AssnDef_and(_tmp237,Cyc_AssnDef_ulte(t1,t2));});}else{
# 753
at=({void*_tmp238=at;Cyc_AssnDef_and(_tmp238,Cyc_AssnDef_slt(t2,t1));});af=({void*_tmp239=af;Cyc_AssnDef_and(_tmp239,Cyc_AssnDef_slte(t1,t2));});}
# 755
goto _LL30;case Cyc_Absyn_Gte:
# 757
 if(Cyc_Vcgen_unsigned_comparison(e1,e2)){
at=({void*_tmp23A=at;Cyc_AssnDef_and(_tmp23A,Cyc_AssnDef_ulte(t2,t1));});af=({void*_tmp23B=af;Cyc_AssnDef_and(_tmp23B,Cyc_AssnDef_ult(t1,t2));});}else{
# 760
at=({void*_tmp23C=at;Cyc_AssnDef_and(_tmp23C,Cyc_AssnDef_slte(t2,t1));});af=({void*_tmp23D=af;Cyc_AssnDef_and(_tmp23D,Cyc_AssnDef_slt(t1,t2));});}
# 762
goto _LL30;default:
 goto _LL30;}_LL30:;}
# 765
return({struct _tuple12 _tmp1C4;_tmp1C4.f1=at,_tmp1C4.f2=af;_tmp1C4;});}}}}else{goto _LLD;}}else{goto _LLD;}}else{goto _LLD;}}default: _LLD: {
# 767
...
return({struct _tuple12 _tmp1C5;({void*_tmp243=({void*_tmp242=aout;Cyc_AssnDef_and(_tmp242,({void*_tmp241=Cyc_AssnDef_one();Cyc_AssnDef_ulte(_tmp241,t);}));});_tmp1C5.f1=_tmp243;}),({void*_tmp240=({void*_tmp23F=aout;Cyc_AssnDef_and(_tmp23F,({void*_tmp23E=t;Cyc_AssnDef_eq(_tmp23E,Cyc_AssnDef_zero());}));});_tmp1C5.f2=_tmp240;});_tmp1C5;});}}};}
# 772
...
valid=0;}}}
# 790
return({struct _tuple13 _tmp1C6;valid?({struct Cyc_List_List**_tmp245=({struct Cyc_List_List**_tmpDA=_cycalloc(sizeof(*_tmpDA));({struct Cyc_List_List*_tmp244=((struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev)(res);*_tmpDA=_tmp244;});_tmpDA;});_tmp1C6.f1=_tmp245;}):(_tmp1C6.f1=0),_tmp1C6.f2=a;_tmp1C6;});}
# 793
...
return({struct _tuple12 _tmp1C7;topt == 0?({void*_tmp246=Cyc_AssnDef_fresh_var();_tmp1C7.f1=_tmp246;}):(_tmp1C7.f1=topt),_tmp1C7.f2=a;_tmp1C7;});}}
# 798
...
# 805
return({struct _tuple14 _tmp1C8;({struct Cyc_List_List*_tmp247=((struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev)(res);_tmp1C8.f1=_tmp247;}),_tmp1C8.f2=ain;_tmp1C8;});}
# 808
...
({void*_tmpE6=0U;({struct _fat_ptr _tmp248=({const char*_tmpE7="vcgen bind2vardecl";_tag_fat(_tmpE7,sizeof(char),19U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp248,_tag_fat(_tmpE6,sizeof(void*),0));});});case 3: _tmpE5=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)_tmpE4)->f1;{struct Cyc_Absyn_Vardecl*vd=_tmpE5;
...
# 822
return({struct _tuple12 _tmp1C9;({void*_tmp24A=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmpEB=_cycalloc(sizeof(*_tmpEB));_tmpEB->tag=1,({struct Cyc_Absyn_Vardecl*_tmp249=Cyc_Vcgen_bind2vardecl(b);_tmpEB->f1=_tmp249;});_tmpEB;});_tmp1C9.f1=_tmp24A;}),_tmp1C9.f2=ain;_tmp1C9;});}}else{
return({struct _tuple12 _tmp1CA;_tmp1CA.f1=0,({void*_tmp24B=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp1CA.f2=_tmp24B;});_tmp1CA;});};}struct _tuple16{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;struct Cyc_Absyn_Exp*f3;struct Cyc_Absyn_Vardecl*f4;};
# 829
static struct _tuple16 Cyc_Vcgen_get_requires_and_ensures_info(struct Cyc_Absyn_FnInfo*fi){
return({struct _tuple16 _tmp1CB;_tmp1CB.f1=fi->args,_tmp1CB.f2=fi->requires_clause,_tmp1CB.f3=fi->ensures_clause,_tmp1CB.f4=fi->return_value;_tmp1CB;});}
# 833
...
goto _LL0;}_LL0:;}
# 841
return({struct _tuple16 _tmp1CC;_tmp1CC.f1=0,_tmp1CC.f2=0,_tmp1CC.f3=0,_tmp1CC.f4=0;_tmp1CC;});}
# 844
...
# 861
a=({void*_tmp24D=a;Cyc_AssnDef_and(_tmp24D,({void*_tmp24C=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmpF4=_cycalloc(sizeof(*_tmpF4));_tmpF4->tag=1,_tmpF4->f1=vd;_tmpF4;});Cyc_AssnDef_eq(_tmp24C,(void*)inputs->hd);}));});}}}{
# 865
...
({struct Cyc_String_pa_PrintArg_struct _tmpFC=({struct Cyc_String_pa_PrintArg_struct _tmp1CE;_tmp1CE.tag=0,({
struct _fat_ptr _tmp24E=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(at)));_tmp1CE.f1=_tmp24E;});_tmp1CE;});struct Cyc_String_pa_PrintArg_struct _tmpFD=({struct Cyc_String_pa_PrintArg_struct _tmp1CD;_tmp1CD.tag=0,({struct _fat_ptr _tmp24F=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(a)));_tmp1CD.f1=_tmp24F;});_tmp1CD;});void*_tmpFA[2];_tmpFA[0]=& _tmpFC,_tmpFA[1]=& _tmpFD;({unsigned _tmp251=req->loc;struct _fat_ptr _tmp250=({const char*_tmpFB="cannot prove @requires %s from %s";_tag_fat(_tmpFB,sizeof(char),34U);});Cyc_Warn_err(_tmp251,_tmp250,_tag_fat(_tmpFA,sizeof(void*),2));});});}}}}
# 872
...
if(Cyc_Tcutil_is_const_exp(e))return({struct _tuple12 _tmp1CF;({void*_tmp252=Cyc_AssnDef_cnst(e);_tmp1CF.f1=_tmp252;}),_tmp1CF.f2=ain;_tmp1CF;});{
...
# 881
return({struct _tuple12 _tmp1D0;({void*_tmp253=(void*)({struct Cyc_AssnDef_Const_AssnDef_Term_struct*_tmp109=_cycalloc(sizeof(*_tmp109));_tmp109->tag=0,_tmp109->f1=e;_tmp109;});_tmp1D0.f1=_tmp253;}),_tmp1D0.f2=ain;_tmp1D0;});}case 1: _tmp100=(void*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{void*b=_tmp100;
return({struct _tuple12 _tmp1D1;({void*_tmp255=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp10A=_cycalloc(sizeof(*_tmp10A));_tmp10A->tag=1,({struct Cyc_Absyn_Vardecl*_tmp254=Cyc_Vcgen_bind2vardecl(b);_tmp10A->f1=_tmp254;});_tmp10A;});_tmp1D1.f1=_tmp255;}),_tmp1D1.f2=ain;_tmp1D1;});}case 3: _tmp107=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;_tmp100=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpFF)->f2;{enum Cyc_Absyn_Primop p=_tmp107;struct Cyc_List_List*es=_tmp100;
# 884
...
return({struct _tuple12 _tmp1D2;_tmp1D2.f1=t,_tmp1D2.f2=aout;_tmp1D2;});}}case 4: _tmp100=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;_tmp102=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpFF)->f2;_tmp104=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpFF)->f3;{struct Cyc_Absyn_Exp*e1=_tmp100;struct Cyc_Core_Opt*popt=_tmp102;struct Cyc_Absyn_Exp*e2=_tmp104;
# 889
...
t2=0;else{
# 896
t2=({enum Cyc_Absyn_Primop _tmp256=(enum Cyc_Absyn_Primop)popt->v;Cyc_AssnDef_primop(_tmp256,({void*_tmp118[2];_tmp118[0]=t1,_tmp118[1]=t2;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp118,sizeof(void*),2));}));});}}{
# 898
void*_tmp119=Cyc_Vcgen_do_assign(env,a2,lt,t2);void*a=_tmp119;
return({struct _tuple12 _tmp1D3;_tmp1D3.f1=lt,_tmp1D3.f2=a;_tmp1D3;});}}}}case 5: _tmp100=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;_tmp106=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmpFF)->f2;{struct Cyc_Absyn_Exp*e=_tmp100;enum Cyc_Absyn_Incrementor i=_tmp106;
# 901
...
# 907
 if(t1 != 0)assn=Cyc_AssnDef_primop(Cyc_Absyn_Plus,({void*_tmp120[2];_tmp120[0]=t1,({void*_tmp257=Cyc_AssnDef_one();_tmp120[1]=_tmp257;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp120,sizeof(void*),2));}));
res=assn;
goto _LL63;case Cyc_Absyn_PostInc:
# 911
 res=t1;
if(t1 != 0)assn=Cyc_AssnDef_primop(Cyc_Absyn_Plus,({void*_tmp121[2];_tmp121[0]=t1,({void*_tmp258=Cyc_AssnDef_one();_tmp121[1]=_tmp258;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp121,sizeof(void*),2));}));
goto _LL63;case Cyc_Absyn_PreDec:
# 915
 if(t1 != 0)assn=Cyc_AssnDef_primop(Cyc_Absyn_Minus,({void*_tmp122[2];_tmp122[0]=t1,({void*_tmp259=Cyc_AssnDef_one();_tmp122[1]=_tmp259;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp122,sizeof(void*),2));}));
res=assn;
goto _LL63;case Cyc_Absyn_PostDec:
# 919
 res=t1;
if(t1 != 0)assn=Cyc_AssnDef_primop(Cyc_Absyn_Minus,({void*_tmp123[2];_tmp123[0]=t1,({void*_tmp25A=Cyc_AssnDef_one();_tmp123[1]=_tmp25A;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp123,sizeof(void*),2));}));
goto _LL63;default:
({void*_tmp124=0U;({struct _fat_ptr _tmp25B=({const char*_tmp125="vcgen vcgen_rexp increment_e";_tag_fat(_tmp125,sizeof(char),29U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp25B,_tag_fat(_tmp124,sizeof(void*),0));});});}_LL63:;}{
# 924
void*_tmp126=Cyc_Vcgen_do_assign(env,a1,lt,assn);void*a=_tmp126;
return({struct _tuple12 _tmp1D4;_tmp1D4.f1=res,_tmp1D4.f2=a;_tmp1D4;});}}}case 6: _tmp100=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;_tmp102=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpFF)->f2;_tmp104=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpFF)->f3;{struct Cyc_Absyn_Exp*e1=_tmp100;struct Cyc_Absyn_Exp*e2=_tmp102;struct Cyc_Absyn_Exp*e3=_tmp104;
# 927
...
at=({void*_tmp25C=at;Cyc_AssnDef_and(_tmp25C,Cyc_AssnDef_eq(v,t1));});
af=({void*_tmp25D=af;Cyc_AssnDef_and(_tmp25D,Cyc_AssnDef_eq(v,t2));});
return({struct _tuple12 _tmp1D5;_tmp1D5.f1=v,({void*_tmp25E=Cyc_PrattProver_merge_assn(at,af);_tmp1D5.f2=_tmp25E;});_tmp1D5;});}else{
# 936
return({struct _tuple12 _tmp1D6;_tmp1D6.f1=0,({void*_tmp25F=Cyc_PrattProver_merge_assn(at,af);_tmp1D6.f2=_tmp25F;});_tmp1D6;});}}}}}case 7: _tmp100=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;_tmp102=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpFF)->f2;{struct Cyc_Absyn_Exp*e1=_tmp100;struct Cyc_Absyn_Exp*e2=_tmp102;
# 938
...
at=({void*_tmp260=at;Cyc_AssnDef_and(_tmp260,Cyc_AssnDef_eq(v,t));});
af=({void*_tmp262=af;Cyc_AssnDef_and(_tmp262,({void*_tmp261=v;Cyc_AssnDef_eq(_tmp261,Cyc_AssnDef_zero());}));});
return({struct _tuple12 _tmp1D7;_tmp1D7.f1=v,({void*_tmp263=Cyc_PrattProver_merge_assn(at,af);_tmp1D7.f2=_tmp263;});_tmp1D7;});}}}case 8: _tmp100=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;_tmp102=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpFF)->f2;{struct Cyc_Absyn_Exp*e1=_tmp100;struct Cyc_Absyn_Exp*e2=_tmp102;
# 945
...
at=({void*_tmp265=at;Cyc_AssnDef_and(_tmp265,({void*_tmp264=v;Cyc_AssnDef_eq(_tmp264,Cyc_AssnDef_one());}));});
af=({void*_tmp266=af;Cyc_AssnDef_and(_tmp266,Cyc_AssnDef_eq(v,t));});
return({struct _tuple12 _tmp1D8;_tmp1D8.f1=v,({void*_tmp267=Cyc_PrattProver_merge_assn(at,af);_tmp1D8.f2=_tmp267;});_tmp1D8;});}}}case 9: _tmp100=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;_tmp102=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpFF)->f2;{struct Cyc_Absyn_Exp*e1=_tmp100;struct Cyc_Absyn_Exp*e2=_tmp102;
# 952
...
if(ensopt == 0)
return({struct _tuple12 _tmp1D9;_tmp1D9.f1=0,_tmp1D9.f2=a2;_tmp1D9;});{
...
return({struct _tuple12 _tmp1DA;_tmp1DA.f1=v,_tmp1DA.f2=at;_tmp1DA;});}
# 977
return({struct _tuple12 _tmp1DB;_tmp1DB.f1=0,_tmp1DB.f2=at;_tmp1DB;});}}}}}}case 11: _tmp100=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{struct Cyc_Absyn_Exp*e=_tmp100;
# 979
...
return({struct _tuple12 _tmp1DC;_tmp1DC.f1=0,_tmp1DC.f2=(void*)& Cyc_AssnDef_false_assn;_tmp1DC;});}}case 12: _tmp100=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{struct Cyc_Absyn_Exp*e=_tmp100;
...
# 1015
 ...
 return({struct _tuple12 _tmp1E3;_tmp1E3.f1=0,_tmp1E3.f2=ain;_tmp1E3;});case 21: _tmp100=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{struct Cyc_Absyn_Exp*e=_tmp100;
# 1023
_tmp100=e;goto _LL2E;
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;
Cyc_Vcgen_update_try_assn(env,ain);
return({struct _tuple12 _tmp1E4;_tmp1E4.f1=0,_tmp1E4.f2=ain;_tmp1E4;});}case 38: _tmp100=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;_LL2E: {struct Cyc_Absyn_Exp*e=_tmp100;
# 1028
...
# 1030
return({struct _tuple12 _tmp1E5;_tmp1E5.f1=0,({void*_tmp26D=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp1E5.f2=_tmp26D;});_tmp1E5;});}case 20: _tmp100=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{struct Cyc_Absyn_Exp*e=_tmp100;
# 1032
...
void*bndterm;
void*bndassn;
bndterm=Cyc_AssnDef_primop(Cyc_Absyn_Numelts,({void*_tmp171[1];_tmp171[0]=t1;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp171,sizeof(void*),1));}));
bndassn=(void*)& Cyc_AssnDef_true_assn;
if(bound != 0){
struct _tuple12 _tmp172=Cyc_Vcgen_vcgen_rexp_nodebug(env,bound,(void*)& Cyc_AssnDef_true_assn);struct _tuple12 _stmttmp3D=_tmp172;struct _tuple12 _tmp173=_stmttmp3D;void*_tmp175;void*_tmp174;_tmp174=_tmp173.f1;_tmp175=_tmp173.f2;{void*bndt=_tmp174;void*bnda=_tmp175;
if(bndt != 0){
bndterm=bndt;
bndassn=bnda;}}}
# 1058
if(bndassn != (void*)& Cyc_AssnDef_true_assn)({void*_tmp176=0U;({struct Cyc___cycFILE*_tmp26F=Cyc_stderr;struct _fat_ptr _tmp26E=({const char*_tmp177="side effect in bound\n";_tag_fat(_tmp177,sizeof(char),22U);});Cyc_fprintf(_tmp26F,_tmp26E,_tag_fat(_tmp176,sizeof(void*),0));});});
additional=Cyc_AssnDef_ult(t2,bndterm);}
# 1061
if(additional != (void*)& Cyc_AssnDef_true_assn)
({struct Cyc_Hashtable_Table**_tmp271=env->assn_info;struct Cyc_Absyn_Exp*_tmp270=e1;Cyc_Vcgen_insert_assn_info(_tmp271,_tmp270,({struct _tuple12*_tmp178=_cycalloc(sizeof(*_tmp178));_tmp178->f1=a2,_tmp178->f2=additional;_tmp178;}));});
a2=Cyc_AssnDef_and(a2,additional);}}_LLA3:;}
# 1065
return({struct _tuple12 _tmp1E6;_tmp1E6.f1=0,_tmp1E6.f2=a2;_tmp1E6;});}}}case 31: _tmp100=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{struct Cyc_List_List*es=_tmp100;
# 1067
...
return({struct _tuple12 _tmp1E7;_tmp1E7.f1=0,({void*_tmp272=Cyc_Vcgen_vcgen_rexps_nosave(env,es,ain);_tmp1E7.f2=_tmp272;});_tmp1E7;});}case 25: _tmp100=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmpFF)->f2;{struct Cyc_List_List*dles=_tmp100;
# 1070
...
struct _tuple17*_tmp179=(struct _tuple17*)dles->hd;struct _tuple17*_stmttmp3E=_tmp179;struct _tuple17*_tmp17A=_stmttmp3E;void*_tmp17B;_tmp17B=_tmp17A->f2;{struct Cyc_Absyn_Exp*e=_tmp17B;
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;}}
# 1079
return({struct _tuple12 _tmp1E8;_tmp1E8.f1=0,_tmp1E8.f2=ain;_tmp1E8;});}case 27: _tmp100=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;_tmp102=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpFF)->f2;_tmp104=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpFF)->f3;{struct Cyc_Absyn_Vardecl*vd=_tmp100;struct Cyc_Absyn_Exp*e1=_tmp102;struct Cyc_Absyn_Exp*e2=_tmp104;
# 1083
struct _tuple12 _tmp17C=Cyc_Vcgen_vcgen_rexp_nodebug(env,e1,ain);struct _tuple12 _stmttmp3F=_tmp17C;struct _tuple12 _tmp17D=_stmttmp3F;void*_tmp17F;void*_tmp17E;_tmp17E=_tmp17D.f1;_tmp17F=_tmp17D.f2;{void*t1=_tmp17E;void*a=_tmp17F;
void*_tmp180=t1 == 0?Cyc_AssnDef_fresh_var(): t1;{void*t1=_tmp180;
struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp181=({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp188=_cycalloc(sizeof(*_tmp188));_tmp188->tag=1,_tmp188->f1=vd;_tmp188;});struct Cyc_AssnDef_Var_AssnDef_Term_struct*v=_tmp181;
# 1087
a=({struct Cyc_Vcgen_Env*_tmp275=env;void*_tmp274=a;void*_tmp273=(void*)v;Cyc_Vcgen_do_assign(_tmp275,_tmp274,_tmp273,Cyc_AssnDef_zero());});
while(1){
void*_tmp182=({void*_tmp276=a;Cyc_AssnDef_and(_tmp276,Cyc_AssnDef_ult((void*)v,t1));});void*at=_tmp182;
void*_tmp183=({void*_tmp277=a;Cyc_AssnDef_and(_tmp277,Cyc_AssnDef_ulte(t1,(void*)v));});void*af=_tmp183;
struct _tuple12 _tmp184=Cyc_Vcgen_vcgen_rexp_nodebug(env,e2,at);struct _tuple12 _stmttmp40=_tmp184;struct _tuple12 _tmp185=_stmttmp40;void*_tmp186;_tmp186=_tmp185.f2;{void*abody=_tmp186;
abody=({struct Cyc_Vcgen_Env*_tmp27B=env;void*_tmp27A=abody;void*_tmp279=(void*)v;Cyc_Vcgen_do_assign(_tmp27B,_tmp27A,_tmp279,Cyc_AssnDef_primop(Cyc_Absyn_Plus,({void*_tmp187[2];_tmp187[0]=(void*)v,({void*_tmp278=Cyc_AssnDef_one();_tmp187[1]=_tmp278;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp187,sizeof(void*),2));})));});
if(Cyc_Vcgen_implies(& abody,& a)){a=af;break;}
a=Cyc_Vcgen_weaken_assn(abody,a);}}
# 1096
return({struct _tuple12 _tmp1E9;_tmp1E9.f1=0,_tmp1E9.f2=a;_tmp1E9;});}}}case 28: _tmp100=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{struct Cyc_Absyn_Exp*e=_tmp100;
# 1098
return({struct _tuple12 _tmp1EA;_tmp1EA.f1=0,({void*_tmp27C=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp1EA.f2=_tmp27C;});_tmp1EA;});}case 34: _tmp103=((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{struct Cyc_Absyn_MallocInfo mi=_tmp103;
# 1100
if(mi.rgn != 0)
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,mi.rgn,ain)).f2;
return({struct _tuple12 _tmp1EB;_tmp1EB.f1=0,({void*_tmp27D=(Cyc_Vcgen_vcgen_rexp_nodebug(env,mi.num_elts,ain)).f2;_tmp1EB.f2=_tmp27D;});_tmp1EB;});}case 35: _tmp100=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;_tmp102=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmpFF)->f2;{struct Cyc_Absyn_Exp*e1=_tmp100;struct Cyc_Absyn_Exp*e2=_tmp102;
# 1104
struct _tuple12 _tmp189=Cyc_Vcgen_vcgen_lexp(env,e1,ain);struct _tuple12 _stmttmp41=_tmp189;struct _tuple12 _tmp18A=_stmttmp41;void*_tmp18C;void*_tmp18B;_tmp18B=_tmp18A.f1;_tmp18C=_tmp18A.f2;{void*lt1=_tmp18B;void*a1=_tmp18C;
Cyc_Vcgen_update_try_assn(env,a1);{
struct _tuple12 _tmp18D=Cyc_Vcgen_vcgen_lexp(env,e2,a1);struct _tuple12 _stmttmp42=_tmp18D;struct _tuple12 _tmp18E=_stmttmp42;void*_tmp190;void*_tmp18F;_tmp18F=_tmp18E.f1;_tmp190=_tmp18E.f2;{void*lt2=_tmp18F;void*a2=_tmp190;
Cyc_Vcgen_update_try_assn(env,a2);{
void*_tmp191=Cyc_Vcgen_deref_lterm(env,lt1,a2);void*t1=_tmp191;
void*_tmp192=Cyc_Vcgen_deref_lterm(env,lt2,a2);void*t2=_tmp192;
a2=Cyc_Vcgen_do_assign(env,a2,lt1,t2);
a2=Cyc_Vcgen_do_assign(env,a2,lt2,t1);
return({struct _tuple12 _tmp1EC;_tmp1EC.f1=0,_tmp1EC.f2=a2;_tmp1EC;});}}}}}case 37: _tmp100=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{struct Cyc_Absyn_Stmt*s=_tmp100;
# 1114
void**_tmp193=(env->shared)->exp_stmt;void**old_exp_stmt=_tmp193;
({void**_tmp27E=({void**_tmp194=_cycalloc(sizeof(*_tmp194));*_tmp194=0;_tmp194;});(env->shared)->exp_stmt=_tmp27E;});{
void*_tmp195=Cyc_Vcgen_vcgen_stmt_nodebug(env,s,ain);void*aout=_tmp195;
void*_tmp196=*((void**)_check_null((env->shared)->exp_stmt));void*t=_tmp196;
(env->shared)->exp_stmt=old_exp_stmt;
return({struct _tuple12 _tmp1ED;_tmp1ED.f1=t,_tmp1ED.f2=aout;_tmp1ED;});}}case 40:
 return({struct _tuple12 _tmp1EE;_tmp1EE.f1=0,_tmp1EE.f2=ain;_tmp1EE;});case 41: _tmp100=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{struct Cyc_Absyn_Exp*e=_tmp100;
...
# 1123
if(({struct _fat_ptr _tmp27F=(struct _fat_ptr)s;Cyc_strcmp(_tmp27F,({const char*_tmp197="print_assn";_tag_fat(_tmp197,sizeof(char),11U);}));})){
struct _fat_ptr _tmp198=Cyc_Position_string_of_segment(e->loc);struct _fat_ptr seg_str=_tmp198;
({struct Cyc_String_pa_PrintArg_struct _tmp19B=({struct Cyc_String_pa_PrintArg_struct _tmp1F0;_tmp1F0.tag=0,_tmp1F0.f1=(struct _fat_ptr)((struct _fat_ptr)seg_str);_tmp1F0;});struct Cyc_String_pa_PrintArg_struct _tmp19C=({struct Cyc_String_pa_PrintArg_struct _tmp1EF;_tmp1EF.tag=0,({struct _fat_ptr _tmp280=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(ain));_tmp1EF.f1=_tmp280;});_tmp1EF;});void*_tmp199[2];_tmp199[0]=& _tmp19B,_tmp199[1]=& _tmp19C;({struct Cyc___cycFILE*_tmp282=Cyc_stderr;struct _fat_ptr _tmp281=({const char*_tmp19A="%s: current assn is %s\n";_tag_fat(_tmp19A,sizeof(char),24U);});Cyc_fprintf(_tmp282,_tmp281,_tag_fat(_tmp199,sizeof(void*),2));});});}
# 1127
return({struct _tuple12 _tmp1F1;({void*_tmp283=Cyc_AssnDef_zero();_tmp1F1.f1=_tmp283;}),_tmp1F1.f2=ain;_tmp1F1;});}default: _tmp100=((struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*)_tmpFF)->f1;{struct Cyc_Absyn_Exp*e1=_tmp100;
# 1129
struct _tuple12 _tmp19D=Cyc_Vcgen_vcgen_test(env,e1,(void*)& Cyc_AssnDef_true_assn);struct _tuple12 _stmttmp43=_tmp19D;struct _tuple12 _tmp19E=_stmttmp43;void*_tmp19F;_tmp19F=_tmp19E.f1;{void*at=_tmp19F;
if(!Cyc_Vcgen_implies(& ain,& at))
({struct Cyc_String_pa_PrintArg_struct _tmp1A2=({struct Cyc_String_pa_PrintArg_struct _tmp1F2;_tmp1F2.tag=0,({
struct _fat_ptr _tmp284=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(ain)));_tmp1F2.f1=_tmp284;});_tmp1F2;});void*_tmp1A0[1];_tmp1A0[0]=& _tmp1A2;({unsigned _tmp286=e->loc;struct _fat_ptr _tmp285=({const char*_tmp1A1="cannot prove @assert from %s";_tag_fat(_tmp1A1,sizeof(char),29U);});Cyc_Warn_err(_tmp286,_tmp285,_tag_fat(_tmp1A0,sizeof(void*),1));});});
return({struct _tuple12 _tmp1F3;({void*_tmp288=Cyc_AssnDef_one();_tmp1F3.f1=_tmp288;}),({void*_tmp287=Cyc_AssnDef_and(ain,at);_tmp1F3.f2=_tmp287;});_tmp1F3;});}}};}}
# 1139
...
struct Cyc_Vcgen_Env*_tmp1A3=Cyc_Vcgen_initial_env(tables,fd,assn_info);struct Cyc_Vcgen_Env*env=_tmp1A3;
void*a=(void*)& Cyc_AssnDef_true_assn;
# 1143
struct _tuple16 _tmp1A4=Cyc_Vcgen_get_requires_and_ensures_info(& fd->i);struct _tuple16 _stmttmp44=_tmp1A4;struct _tuple16 _tmp1A5=_stmttmp44;void*_tmp1A9;void*_tmp1A8;void*_tmp1A7;void*_tmp1A6;_tmp1A6=_tmp1A5.f1;_tmp1A7=_tmp1A5.f2;_tmp1A8=_tmp1A5.f3;_tmp1A9=_tmp1A5.f4;{struct Cyc_List_List*args=_tmp1A6;struct Cyc_Absyn_Exp*reqopt=_tmp1A7;struct Cyc_Absyn_Exp*ensopt=_tmp1A8;struct Cyc_Absyn_Vardecl*ret_value=_tmp1A9;
if(reqopt != 0)
# 1146
...
struct _tuple12 _tmp1AA=Cyc_Vcgen_vcgen_test(env,ens,(void*)& Cyc_AssnDef_true_assn);struct _tuple12 _stmttmp45=_tmp1AA;struct _tuple12 _tmp1AB=_stmttmp45;void*_tmp1AC;_tmp1AC=_tmp1AB.f1;{void*at=_tmp1AC;
struct Cyc_Vcgen_SharedEnv*_tmp1AD=env->shared;struct Cyc_Vcgen_SharedEnv*senv=_tmp1AD;
void*_tmp1AE=senv->res_assn;void*res_assn_opt=_tmp1AE;
void*res_assn=(void*)& Cyc_AssnDef_false_assn;
if(res_assn_opt != 0)res_assn=res_assn_opt;{
struct _fat_ptr str=({const char*_tmp1B4="NULL";_tag_fat(_tmp1B4,sizeof(char),5U);});
if(senv->res_term != 0)str=Cyc_AssnDef_term2string((void*)_check_null(senv->res_term));
if(ret_value != 0 &&(unsigned)senv->res_term)
res_assn=({void*_tmp28A=res_assn;Cyc_AssnDef_and(_tmp28A,({void*_tmp289=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp1AF=_cycalloc(sizeof(*_tmp1AF));_tmp1AF->tag=1,_tmp1AF->f1=ret_value;_tmp1AF;});Cyc_AssnDef_eq(_tmp289,senv->res_term);}));});
if(!Cyc_Vcgen_implies(& res_assn,& at))
({struct Cyc_String_pa_PrintArg_struct _tmp1B2=({struct Cyc_String_pa_PrintArg_struct _tmp1F5;_tmp1F5.tag=0,({
struct _fat_ptr _tmp28B=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(at)));_tmp1F5.f1=_tmp28B;});_tmp1F5;});struct Cyc_String_pa_PrintArg_struct _tmp1B3=({struct Cyc_String_pa_PrintArg_struct _tmp1F4;_tmp1F4.tag=0,({struct _fat_ptr _tmp28C=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(res_assn)));_tmp1F4.f1=_tmp28C;});_tmp1F4;});void*_tmp1B0[2];_tmp1B0[0]=& _tmp1B2,_tmp1B0[1]=& _tmp1B3;({unsigned _tmp28E=ens->loc;struct _fat_ptr _tmp28D=({const char*_tmp1B1="cannot prove the @ensures clause %s from %s";_tag_fat(_tmp1B1,sizeof(char),44U);});Cyc_Warn_err(_tmp28E,_tmp28D,_tag_fat(_tmp1B0,sizeof(void*),2));});});}}}
# 1165
