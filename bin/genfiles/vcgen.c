...
# 313 "assndef.h"
extern void*Cyc_AssnDef_subst_args(struct Cyc_List_List*,struct Cyc_Absyn_Vardecl*,struct Cyc_List_List*,void*,void*,struct Cyc_AssnDef_AssnMap);
# 320
extern void*Cyc_AssnDef_widen(void*);
# 324
extern struct Cyc_Dict_Dict Cyc_AssnDef_empty_term_dict (void);
extern void*Cyc_AssnDef_subst_t(struct Cyc_Dict_Dict,void*);
extern void*Cyc_AssnDef_subst_a(struct Cyc_Dict_Dict,void*);
# 329
extern struct Cyc_Set_Set*Cyc_AssnDef_term_fr_logicvar(void*);
...
# 29 "unify.h"
int Cyc_Unify_unify(void*,void*);struct Cyc_Vcgen_FnInfo{struct Cyc_Set_Set*freevars;struct Cyc_List_List*actuals;void*result;void*init_memory;void*final_memory;void*assn;};
# 51 "vcgen.cyc"
static struct Cyc_Hashtable_Table*Cyc_Vcgen_fn_info_table;
# 53
static void Cyc_Vcgen_insert_fn_info(struct Cyc_Absyn_Fndecl*fd,void*init_memory,struct Cyc_List_List*actuals,void*result_term,void*final_memory,void*a){
# 61
struct Cyc_Set_Set*fvs1=({struct Cyc_Set_Set*_Tmp0=Cyc_AssnDef_term_fr_logicvar(result_term);Cyc_Set_union_two(_Tmp0,
Cyc_AssnDef_term_fr_logicvar(final_memory));});
struct Cyc_Set_Set*fvs2=Cyc_AssnDef_assn_fr_logicvar(a);
if(({unsigned _Tmp0=(unsigned)Cyc_Set_cardinality(fvs2);_Tmp0 > Cyc_Flags_max_vc_summary;})){
a=Cyc_AssnDef_widen(a);
fvs2=Cyc_AssnDef_assn_fr_logicvar(a);}{
# 68
struct Cyc_Set_Set*fvs=Cyc_Set_union_two(fvs1,fvs2);
# 70
fvs=Cyc_Set_delete(fvs,init_memory);
{struct Cyc_List_List*as=actuals;for(0;as!=0;as=as->tl){
fvs=Cyc_Set_delete(fvs,(void*)as->hd);}}{
struct Cyc_Vcgen_FnInfo*f;f=_cycalloc(sizeof(struct Cyc_Vcgen_FnInfo)),f->freevars=fvs,f->actuals=actuals,f->result=result_term,f->init_memory=init_memory,f->final_memory=final_memory,f->assn=a;{
# 79
struct Cyc_Hashtable_Table*h;
if(Cyc_Vcgen_fn_info_table==0){
...
Cyc_Vcgen_fn_info_table=h;}else{
h=Cyc_Vcgen_fn_info_table;}
({void(*_Tmp0)(struct Cyc_Hashtable_Table*,struct _tuple2*,struct Cyc_Vcgen_FnInfo*)=(void(*)(struct Cyc_Hashtable_Table*,struct _tuple2*,struct Cyc_Vcgen_FnInfo*))Cyc_Hashtable_insert;_Tmp0;})(h,fd->name,f);}}}}
# 88
...
# 92
static struct Cyc_Vcgen_FnInfo*Cyc_Vcgen_lookup_fn_info(struct Cyc_Absyn_Exp*e){
if(Cyc_Vcgen_fn_info_table==0)return 0;{
struct Cyc_Hashtable_Table*h=Cyc_Vcgen_fn_info_table;
...
# 97
struct Cyc_Vcgen_FnInfo**finfo_opt=({struct Cyc_Vcgen_FnInfo**(*_Tmp2)(struct Cyc_Hashtable_Table*,struct _tuple2*)=(struct Cyc_Vcgen_FnInfo**(*)(struct Cyc_Hashtable_Table*,struct _tuple2*))Cyc_Hashtable_lookup_opt;_Tmp2;})(h,fd->name);
if(finfo_opt==0)return 0;else{
return*finfo_opt;}}case 1: _Tmp1=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp0)->f1)->f1;{struct Cyc_Absyn_Vardecl*vd=_Tmp1;
# 101
struct Cyc_Vcgen_FnInfo**finfo_opt=({struct Cyc_Vcgen_FnInfo**(*_Tmp2)(struct Cyc_Hashtable_Table*,struct _tuple2*)=(struct Cyc_Vcgen_FnInfo**(*)(struct Cyc_Hashtable_Table*,struct _tuple2*))Cyc_Hashtable_lookup_opt;_Tmp2;})(h,vd->name);
if(finfo_opt==0)return 0;else{
return*finfo_opt;}}default: goto _LL7;}case 13: _Tmp1=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_Tmp0)->f1;{struct Cyc_Absyn_Exp*e1=_Tmp1;
return Cyc_Vcgen_lookup_fn_info(e1);}default: _LL7:
 return 0;};}}struct Cyc_Vcgen_Env{struct Cyc_Hashtable_Table*assn_table;struct Cyc_Hashtable_Table*succ_table;struct Cyc_Hashtable_Table**assn_info;struct Cyc_AssnDef_AssnMap*try_assnmap;void**exp_stmt;struct Cyc_Absyn_Vardecl*result;struct Cyc_AssnDef_AssnMap*res_assnmap;struct Cyc_AssnDef_AssnMap*continue_assnmap;int widen_paths;int pure_exp;void*invoke;};
# 142
...
struct Cyc_Vcgen_FnInfo*finfo=Cyc_Vcgen_lookup_fn_info(e1);
# 761
...
if(finfo!=0){
# 798 "vcgen.cyc"
struct Cyc_Dict_Dict S=Cyc_AssnDef_empty_term_dict();
S=Cyc_Dict_insert(S,finfo->init_memory,pre_memory);
{struct Cyc_List_List*as=finfo->actuals;for(0;ts!=0 && as!=0;(
ts=ts->tl,as=as->tl)){
S=Cyc_Dict_insert(S,(void*)as->hd,(void*)ts->hd);}}
# 804
({void(*_Tmp1B)(void(*)(struct Cyc_Dict_Dict*,void*),struct Cyc_Dict_Dict*,struct Cyc_Set_Set*)=(void(*)(void(*)(struct Cyc_Dict_Dict*,void*),struct Cyc_Dict_Dict*,struct Cyc_Set_Set*))Cyc_Set_iter_c;_Tmp1B;})(Cyc_Vcgen_add_free_var,& S,finfo->freevars);
am3=({struct Cyc_Absyn_Vardecl*_Tmp1B=Cyc_AssnDef_memory;void*_Tmp1C=Cyc_AssnDef_subst_t(S,finfo->final_memory);Cyc_AssnDef_update_var_map(_Tmp1B,_Tmp1C,am2);});
am3=({struct Cyc_AssnDef_AssnMap _Tmp1B=am3;Cyc_AssnDef_and_assnmap_assn(_Tmp1B,Cyc_AssnDef_subst_a(S,finfo->assn));});
actual_ret=Cyc_AssnDef_subst_t(S,finfo->result);}}
# 811
...
struct _tuple14 _Tmp4;({void*_Tmp5=Cyc_Vcgen_myaddr(env,vd);_Tmp4.f0=_Tmp5;}),_Tmp4.f1=amin;return _Tmp4;};}case 3: _Tmp2=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp0)->f1)->f1;{struct Cyc_Absyn_Vardecl*vd=_Tmp2;
# 1088
...
ret_value=Cyc_Absyn_new_vardecl(0U,v,fd->i.ret_type,0);}{
# 1780
...
# 1810
struct _tuple14 _TmpA=Cyc_AssnDef_lookup_var_map(Cyc_AssnDef_memory,*result_assn);struct Cyc_AssnDef_AssnMap _TmpB;void*_TmpC;_TmpC=_TmpA.f0;_TmpB=_TmpA.f1;{void*new_memory_term=_TmpC;struct Cyc_AssnDef_AssnMap res=_TmpB;
struct _tuple14 _TmpD=Cyc_AssnDef_lookup_var_map(ret_value,res);struct Cyc_AssnDef_AssnMap _TmpE;void*_TmpF;_TmpF=_TmpD.f0;_TmpE=_TmpD.f1;{void*result_term=_TmpF;struct Cyc_AssnDef_AssnMap res=_TmpE;
Cyc_Vcgen_insert_fn_info(fd,initmem,actuals,result_term,new_memory_term,res.assn);}}}
# 1817
if(thrwsopt!=0){
