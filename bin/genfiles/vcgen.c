...
void*res;
{void*_tmp0=a;void*_tmp2;void*_tmp1;void*_tmp4;void*_tmp3;switch(*((int*)_tmp0)){case 3: _LL1: _tmp3=(void*)((struct Cyc_AssnDef_And_AssnDef_Assn_struct*)_tmp0)->f1;_tmp4=(void*)((struct Cyc_AssnDef_And_AssnDef_Assn_struct*)_tmp0)->f2;_LL2: {void*a1=_tmp3;void*a2=_tmp4;
# 132
...
goto _LL0;}case 4: _LL3: _tmp1=(void*)((struct Cyc_AssnDef_Or_AssnDef_Assn_struct*)_tmp0)->f1;_tmp2=(void*)((struct Cyc_AssnDef_Or_AssnDef_Assn_struct*)_tmp0)->f2;_LL4: {void*a1=_tmp1;void*a2=_tmp2;
# 139
...
# 174
 return Cyc_AssnDef_kill(a);}else{if(*((int*)_tmp9)== 1){_LL3: _tmpA=((struct Cyc_AssnDef_Var_AssnDef_Term_struct*)_tmp9)->f1;_LL4: {struct Cyc_Absyn_Vardecl*vd=_tmpA;
# 180
if(vd->escapes){
...
({struct Cyc_Dict_Dict _tmp251=((struct Cyc_Dict_Dict(*)(int(*)(int,struct Cyc_Absyn_Vardecl*,int,int),int,struct Cyc_Dict_Dict,struct Cyc_Dict_Dict))Cyc_Dict_union_two_c)(Cyc_Vcgen_max_counter,0,old_env->state_counter,new_env->state_counter);old_env->state_counter=_tmp251;});}
# 263
...
({struct Cyc_Dict_Dict _tmp252=((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct Cyc_Absyn_Vardecl*,int))Cyc_Dict_insert)(env->state_counter,vd,res + 1);env->state_counter=_tmp252;});
...
*aprev=ain;}else{
# 302
({struct Cyc_Hashtable_Table*_tmp254=(env->shared)->assn_table;struct Cyc_Absyn_Stmt*_tmp253=s;((void(*)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Stmt*,void**))Cyc_Hashtable_insert)(_tmp254,_tmp253,({void**_tmp19=_cycalloc(sizeof(*_tmp19));*_tmp19=ain;_tmp19;}));});}
# 304
return ain;}
# 309
...
*aprev=ain;}else{
# 316
({struct Cyc_Hashtable_Table*_tmp256=(env->shared)->assn_table;struct Cyc_Absyn_Stmt*_tmp255=s;((void(*)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Stmt*,void**))Cyc_Hashtable_insert)(_tmp256,_tmp255,({void**_tmp1B=_cycalloc(sizeof(*_tmp1B));*_tmp1B=ain;_tmp1B;}));});}
# 318
return ain;}
# 323
...
void*_tmp21=s->r;void*_stmttmp0=_tmp21;void*_tmp22=_stmttmp0;struct Cyc_Absyn_Stmt*_tmp23;struct Cyc_Absyn_Stmt*_tmp24;struct Cyc_Absyn_Exp*_tmp25;struct Cyc_Absyn_Exp*_tmp26;struct Cyc_Absyn_Exp*_tmp29;struct Cyc_Absyn_Exp*_tmp28;struct Cyc_Absyn_Exp*_tmp27;struct Cyc_Absyn_Exp*_tmp2A;struct Cyc_Absyn_Exp*_tmp2B;switch(*((int*)_tmp22)){case 4: _LL1: _tmp2B=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp22)->f1;_LL2: {struct Cyc_Absyn_Exp*e=_tmp2B;
# 401
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2E=({struct Cyc_String_pa_PrintArg_struct _tmp20B;_tmp20B.tag=0,({struct _fat_ptr _tmp25D=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp20B.f1=_tmp25D;});_tmp20B;});void*_tmp2C[1];_tmp2C[0]=& _tmp2E;({struct _fat_ptr _tmp25E=({const char*_tmp2D="if (%s) ...";_tag_fat(_tmp2D,sizeof(char),12U);});Cyc_aprintf(_tmp25E,_tag_fat(_tmp2C,sizeof(void*),1));});});}case 5: _LL3: _tmp2A=(((struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*)_tmp22)->f1).f1;_LL4: {struct Cyc_Absyn_Exp*e=_tmp2A;
# 403
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp31=({struct Cyc_String_pa_PrintArg_struct _tmp20C;_tmp20C.tag=0,({struct _fat_ptr _tmp25F=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp20C.f1=_tmp25F;});_tmp20C;});void*_tmp2F[1];_tmp2F[0]=& _tmp31;({struct _fat_ptr _tmp260=({const char*_tmp30="while (%s) ...";_tag_fat(_tmp30,sizeof(char),15U);});Cyc_aprintf(_tmp260,_tag_fat(_tmp2F,sizeof(void*),1));});});}case 9: _LL5: _tmp27=((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp22)->f1;_tmp28=(((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp22)->f2).f1;_tmp29=(((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp22)->f3).f1;_LL6: {struct Cyc_Absyn_Exp*e1=_tmp27;struct Cyc_Absyn_Exp*e2=_tmp28;struct Cyc_Absyn_Exp*e3=_tmp29;
# 405
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp34=({struct Cyc_String_pa_PrintArg_struct _tmp20F;_tmp20F.tag=0,({struct _fat_ptr _tmp261=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e1));_tmp20F.f1=_tmp261;});_tmp20F;});struct Cyc_String_pa_PrintArg_struct _tmp35=({struct Cyc_String_pa_PrintArg_struct _tmp20E;_tmp20E.tag=0,({
struct _fat_ptr _tmp262=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e2));_tmp20E.f1=_tmp262;});_tmp20E;});struct Cyc_String_pa_PrintArg_struct _tmp36=({struct Cyc_String_pa_PrintArg_struct _tmp20D;_tmp20D.tag=0,({struct _fat_ptr _tmp263=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e3));_tmp20D.f1=_tmp263;});_tmp20D;});void*_tmp32[3];_tmp32[0]=& _tmp34,_tmp32[1]=& _tmp35,_tmp32[2]=& _tmp36;({struct _fat_ptr _tmp264=({const char*_tmp33="for (%s;%s;%s) ...";_tag_fat(_tmp33,sizeof(char),19U);});Cyc_aprintf(_tmp264,_tag_fat(_tmp32,sizeof(void*),3));});});}case 10: _LL7: _tmp26=((struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp22)->f1;_LL8: {struct Cyc_Absyn_Exp*e=_tmp26;
# 408
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp39=({struct Cyc_String_pa_PrintArg_struct _tmp210;_tmp210.tag=0,({struct _fat_ptr _tmp265=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp210.f1=_tmp265;});_tmp210;});void*_tmp37[1];_tmp37[0]=& _tmp39;({struct _fat_ptr _tmp266=({const char*_tmp38="switch (%s) ...";_tag_fat(_tmp38,sizeof(char),16U);});Cyc_aprintf(_tmp266,_tag_fat(_tmp37,sizeof(void*),1));});});}case 14: _LL9: _tmp25=(((struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp22)->f2).f1;_LLA: {struct Cyc_Absyn_Exp*e=_tmp25;
# 410
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp3C=({struct Cyc_String_pa_PrintArg_struct _tmp211;_tmp211.tag=0,({struct _fat_ptr _tmp267=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp211.f1=_tmp267;});_tmp211;});void*_tmp3A[1];_tmp3A[0]=& _tmp3C;({struct _fat_ptr _tmp268=({const char*_tmp3B="do ... while (%s)";_tag_fat(_tmp3B,sizeof(char),18U);});Cyc_aprintf(_tmp268,_tag_fat(_tmp3A,sizeof(void*),1));});});}case 15: _LLB: _tmp24=((struct Cyc_Absyn_TryCatch_s_Absyn_Raw_stmt_struct*)_tmp22)->f1;_LLC: {struct Cyc_Absyn_Stmt*s=_tmp24;
# 412
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp3F=({struct Cyc_String_pa_PrintArg_struct _tmp212;_tmp212.tag=0,({struct _fat_ptr _tmp269=(struct _fat_ptr)((struct _fat_ptr)Cyc_Vcgen_stmt2shortstring(s));_tmp212.f1=_tmp269;});_tmp212;});void*_tmp3D[1];_tmp3D[0]=& _tmp3F;({struct _fat_ptr _tmp26A=({const char*_tmp3E="try %s catch ...";_tag_fat(_tmp3E,sizeof(char),17U);});Cyc_aprintf(_tmp26A,_tag_fat(_tmp3D,sizeof(void*),1));});});}case 2: _LLD: _tmp23=((struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp22)->f1;_LLE: {struct Cyc_Absyn_Stmt*s=_tmp23;
...
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp43=({struct Cyc_String_pa_PrintArg_struct _tmp213;_tmp213.tag=0,_tmp213.f1=(struct _fat_ptr)((struct _fat_ptr)res);_tmp213;});void*_tmp41[1];_tmp41[0]=& _tmp43;({struct _fat_ptr _tmp26C=({const char*_tmp42="%s...";_tag_fat(_tmp42,sizeof(char),6U);});Cyc_aprintf(_tmp26C,_tag_fat(_tmp41,sizeof(void*),1));});});}}_LL0:;}
# 475 "vcgen.cyc"
...
return aout;}}case 2: _LLA: _tmp61=((struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp47)->f1;_tmp62=((struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp47)->f2;_LLB: {struct Cyc_Absyn_Stmt*s1=_tmp61;struct Cyc_Absyn_Stmt*s2=_tmp62;
# 497
ain=Cyc_Vcgen_vcgen_stmt_nodebug(env,s1,ain);
s=s2;
goto LOOP;}case 3: if(((struct Cyc_Absyn_Return_s_Absyn_Raw_stmt_struct*)_tmp47)->f1 == 0){_LLC: _LLD:
# 501
...
return(void*)& Cyc_AssnDef_false_assn;}}}case 4: _LL10: _tmp5D=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp47)->f1;_tmp5E=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp47)->f2;_tmp5F=((struct Cyc_Absyn_IfThenElse_s_Absyn_Raw_stmt_struct*)_tmp47)->f3;_LL11: {struct Cyc_Absyn_Exp*e1=_tmp5D;struct Cyc_Absyn_Stmt*s1=_tmp5E;struct Cyc_Absyn_Stmt*s2=_tmp5F;
# 508
...
if(Cyc_Vcgen_implies(& ain,Cyc_Vcgen_get_assn(env,dummy)))return af;}}}}case 7: _LL14: _LL15:
# 526
 goto _LL17;{
# 529
...
return(void*)& Cyc_AssnDef_false_assn;}case 6: _LL16: _LL17: {
# 536
...
if(Cyc_Vcgen_implies(& ain,Cyc_Vcgen_get_assn(env,dummy2)))return af;}}}}}case 14: _LL1A: _tmp51=((struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp47)->f1;_tmp52=(((struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp47)->f2).f1;_tmp53=(((struct Cyc_Absyn_Do_s_Absyn_Raw_stmt_struct*)_tmp47)->f2).f2;_LL1B: {struct Cyc_Absyn_Stmt*s=_tmp51;struct Cyc_Absyn_Exp*e=_tmp52;struct Cyc_Absyn_Stmt*dummy=_tmp53;
# 557
while(1){
...
Cyc_Vcgen_loop_assn(env,dummy,ain);}}}}case 10: _LL1C: _tmp4F=((struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp47)->f1;_tmp50=((struct Cyc_Absyn_Switch_s_Absyn_Raw_stmt_struct*)_tmp47)->f2;_LL1D: {struct Cyc_Absyn_Exp*e=_tmp4F;struct Cyc_List_List*scs=_tmp50;
# 570
...
return Cyc_Vcgen_vcgen_switch(env,scs,a);}}case 11: if(((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp47)->f2 == 0){_LL1E: _LL1F:
({void*_tmp86=0U;({struct _fat_ptr _tmp26E=({const char*_tmp87="vcgen fallthru";_tag_fat(_tmp87,sizeof(char),15U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp26E,_tag_fat(_tmp86,sizeof(void*),0));});});}else{_LL20: _tmp4D=((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp47)->f1;_tmp4E=*((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp47)->f2;_LL21: {struct Cyc_List_List*es=_tmp4D;struct Cyc_Absyn_Switch_clause*dest=_tmp4E;
# 575
...
if(vd != 0)
a=({struct Cyc_Vcgen_Env*_tmp271=env;void*_tmp270=a;void*_tmp26F=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp8E=_cycalloc(sizeof(*_tmp8E));_tmp8E->tag=1,_tmp8E->f1=vd;_tmp8E;});Cyc_Vcgen_do_assign(_tmp271,_tmp270,_tmp26F,(void*)((struct Cyc_List_List*)_check_null(ts))->hd);});}}
# 586
Cyc_Vcgen_forward_assn(env,dest->body,a);
return(void*)& Cyc_AssnDef_false_assn;}}}case 12: _LL22: _tmp4B=((struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp47)->f1;_tmp4C=((struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp47)->f2;_LL23: {struct Cyc_Absyn_Decl*d=_tmp4B;struct Cyc_Absyn_Stmt*s1=_tmp4C;
# 589
ain=Cyc_Vcgen_vcgen_local_decl(env,d,ain);
s=s1;
goto LOOP;}case 13: _LL24: _tmp4A=((struct Cyc_Absyn_Label_s_Absyn_Raw_stmt_struct*)_tmp47)->f2;_LL25: {struct Cyc_Absyn_Stmt*s=_tmp4A;
# 597
return Cyc_Vcgen_vcgen_stmt_nodebug(env,s,(void*)& Cyc_AssnDef_true_assn);}case 8: _LL26: _LL27:
...
if(vdopt != 0){
if(eopt != 0)
a=({struct Cyc_Vcgen_Env*_tmp275=env;void*_tmp274=a;void*_tmp273=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp98=_cycalloc(sizeof(*_tmp98));_tmp98->tag=1,_tmp98->f1=*vdopt;_tmp98;});Cyc_Vcgen_do_assign(_tmp275,_tmp274,_tmp273,(Cyc_Vcgen_vcgen_rexp_nodebug(env,eopt,a)).f1);});else{
# 630
a=({struct Cyc_Vcgen_Env*_tmp278=env;void*_tmp277=a;void*_tmp276=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp99=_cycalloc(sizeof(*_tmp99));_tmp99->tag=1,_tmp99->f1=*vdopt;_tmp99;});Cyc_Vcgen_do_assign(_tmp278,_tmp277,_tmp276,Cyc_AssnDef_fresh_var());});}}}}}
# 633
...
a=Cyc_Vcgen_do_assign(env,a1,(void*)tv,t);}}}}}}
# 668
return a;}}case 3: _LL5: _tmpA4=((struct Cyc_Absyn_Letv_d_Absyn_Raw_decl_struct*)_tmpA1)->f1;_LL6: {struct Cyc_List_List*vds=_tmpA4;
# 670
for(1;vds != 0;vds=vds->tl){
a=Cyc_Vcgen_add_vardecl(env,(struct Cyc_Absyn_Vardecl*)vds->hd,a);}
return a;}case 4: _LL7: _tmpA2=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmpA1)->f2;_tmpA3=((struct Cyc_Absyn_Region_d_Absyn_Raw_decl_struct*)_tmpA1)->f3;_LL8: {struct Cyc_Absyn_Vardecl*vd=_tmpA2;struct Cyc_Absyn_Exp*eopt=_tmpA3;
# 674
if(eopt != 0){
...
struct _tuple12 _tmpBD=({struct _tuple12 _tmp214;_tmp214.f1=t1,_tmp214.f2=t2;_tmp214;});struct _tuple12 _stmttmp12=_tmpBD;struct _tuple12 _tmpBE=_stmttmp12;if(*((int*)_tmpBE.f1)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmpBE.f1)->f1)== 1){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmpBE.f1)->f1)->f1 == Cyc_Absyn_Unsigned){_LL1: _LL2:
 ...
 return 1;}else{if(*((int*)_tmpBE.f1)== 3)goto _LL7;else{goto _LL7;}}}else{if(*((int*)_tmpBE.f1)== 3)goto _LL7;else{goto _LL7;}}}else{if(*((int*)_tmpBE.f1)== 3){if(*((int*)_tmpBE.f2)== 3){_LL5: _LL6:
...
return({struct _tuple12 _tmp215;({void*_tmp27E=Cyc_AssnDef_or(a2t,a3t);_tmp215.f1=_tmp27E;}),({void*_tmp27D=Cyc_AssnDef_or(a2f,a3f);_tmp215.f2=_tmp27D;});_tmp215;});}}}}case 7: _LL3: _tmpC9=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpC0)->f1;_tmpCA=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpC0)->f2;_LL4: {struct Cyc_Absyn_Exp*e1=_tmpC9;struct Cyc_Absyn_Exp*e2=_tmpCA;
# 711
...
return({struct _tuple12 _tmp216;_tmp216.f1=a2t,({void*_tmp27F=Cyc_AssnDef_or(a1f,a2f);_tmp216.f2=_tmp27F;});_tmp216;});}}}case 8: _LL5: _tmpC7=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpC0)->f1;_tmpC8=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpC0)->f2;_LL6: {struct Cyc_Absyn_Exp*e1=_tmpC7;struct Cyc_Absyn_Exp*e2=_tmpC8;
# 715
...
return({struct _tuple12 _tmp217;({void*_tmp280=Cyc_AssnDef_or(a1t,a2t);_tmp217.f1=_tmp280;}),_tmp217.f2=a2f;_tmp217;});}}}case 9: _LL7: _tmpC5=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpC0)->f1;_tmpC6=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpC0)->f2;_LL8: {struct Cyc_Absyn_Exp*e1=_tmpC5;struct Cyc_Absyn_Exp*e2=_tmpC6;
# 719
...
return Cyc_Vcgen_vcgen_test(env,e2,ain);}}case 3: if(((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpC0)->f1 == Cyc_Absyn_Not){if(((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpC0)->f2 != 0){_LL9: _tmpC4=(struct Cyc_Absyn_Exp*)(((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpC0)->f2)->hd;_LLA: {struct Cyc_Absyn_Exp*e1=_tmpC4;
# 722
...
valid=0;}}}
# 787
return({struct _tuple13 _tmp21B;valid?({struct Cyc_List_List**_tmp29C=({struct Cyc_List_List**_tmp105=_cycalloc(sizeof(*_tmp105));({struct Cyc_List_List*_tmp29B=((struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev)(res);*_tmp105=_tmp29B;});_tmp105;});_tmp21B.f1=_tmp29C;}):(_tmp21B.f1=0),_tmp21B.f2=a;_tmp21B;});}
# 790
...
# 802
return({struct _tuple14 _tmp21D;({struct Cyc_List_List*_tmp29E=((struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev)(res);_tmp21D.f1=_tmp29E;}),_tmp21D.f2=ain;_tmp21D;});}
# 805
static struct Cyc_Absyn_Vardecl*Cyc_Vcgen_bind2vardecl(void*b){
void*_tmp10F=b;struct Cyc_Absyn_Vardecl*_tmp110;struct Cyc_Absyn_Vardecl*_tmp111;struct Cyc_Absyn_Vardecl*_tmp112;struct Cyc_Absyn_Fndecl*_tmp113;struct Cyc_Absyn_Vardecl*_tmp114;switch(*((int*)_tmp10F)){case 1: _LL1: _tmp114=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)_tmp10F)->f1;_LL2: {struct Cyc_Absyn_Vardecl*vd=_tmp114;
return vd;}case 2: _LL3: _tmp113=((struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*)_tmp10F)->f1;_LL4: {struct Cyc_Absyn_Fndecl*fd=_tmp113;
return(struct Cyc_Absyn_Vardecl*)_check_null(fd->fn_vardecl);}case 0: _LL5: _LL6:
({void*_tmp115=0U;({struct _fat_ptr _tmp29F=({const char*_tmp116="vcgen bind2vardecl";_tag_fat(_tmp116,sizeof(char),19U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp29F,_tag_fat(_tmp115,sizeof(void*),0));});});case 3: _LL7: _tmp112=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)_tmp10F)->f1;_LL8: {struct Cyc_Absyn_Vardecl*vd=_tmp112;
return vd;}case 4: _LL9: _tmp111=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)_tmp10F)->f1;_LLA: {struct Cyc_Absyn_Vardecl*vd=_tmp111;
...
void*_tmp117=e->r;void*_stmttmp23=_tmp117;void*_tmp118=_stmttmp23;void*_tmp119;if(*((int*)_tmp118)== 1){_LL1: _tmp119=(void*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp118)->f1;_LL2: {void*b=_tmp119;
# 819
return({struct _tuple12 _tmp21E;({void*_tmp2A1=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp11A=_cycalloc(sizeof(*_tmp11A));_tmp11A->tag=1,({struct Cyc_Absyn_Vardecl*_tmp2A0=Cyc_Vcgen_bind2vardecl(b);_tmp11A->f1=_tmp2A0;});_tmp11A;});_tmp21E.f1=_tmp2A1;}),_tmp21E.f2=ain;_tmp21E;});}}else{_LL3: _LL4:
...
void*_tmp11B=t;struct Cyc_Absyn_FnInfo*_tmp11C;if(*((int*)_tmp11B)== 5){_LL1: _tmp11C=(struct Cyc_Absyn_FnInfo*)&((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp11B)->f1;_LL2: {struct Cyc_Absyn_FnInfo*fi=_tmp11C;
...
# 858
a=({void*_tmp2A4=a;Cyc_AssnDef_and(_tmp2A4,({void*_tmp2A3=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp123=_cycalloc(sizeof(*_tmp123));_tmp123->tag=1,_tmp123->f1=vd;_tmp123;});Cyc_AssnDef_eq(_tmp2A3,(void*)inputs->hd);}));});}}}{
# 862
...
({struct Cyc_String_pa_PrintArg_struct _tmp12B=({struct Cyc_String_pa_PrintArg_struct _tmp223;_tmp223.tag=0,({
struct _fat_ptr _tmp2A5=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(at)));_tmp223.f1=_tmp2A5;});_tmp223;});struct Cyc_String_pa_PrintArg_struct _tmp12C=({struct Cyc_String_pa_PrintArg_struct _tmp222;_tmp222.tag=0,({struct _fat_ptr _tmp2A6=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(a)));_tmp222.f1=_tmp2A6;});_tmp222;});void*_tmp129[2];_tmp129[0]=& _tmp12B,_tmp129[1]=& _tmp12C;({unsigned _tmp2A8=req->loc;struct _fat_ptr _tmp2A7=({const char*_tmp12A="cannot prove @requires %s from %s";_tag_fat(_tmp12A,sizeof(char),34U);});Cyc_Warn_err(_tmp2A8,_tmp2A7,_tag_fat(_tmp129,sizeof(void*),2));});});}}}}
# 869
...
return({struct _tuple12 _tmp227;_tmp227.f1=t,_tmp227.f2=aout;_tmp227;});}}case 4: _LL7: _tmp15D=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp15E=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_tmp15F=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp12E)->f3;_LL8: {struct Cyc_Absyn_Exp*e1=_tmp15D;struct Cyc_Core_Opt*popt=_tmp15E;struct Cyc_Absyn_Exp*e2=_tmp15F;
# 886
...
t2=0;else{
# 893
t2=({enum Cyc_Absyn_Primop _tmp2AD=(enum Cyc_Absyn_Primop)popt->v;Cyc_AssnDef_primop(_tmp2AD,({void*_tmp173[2];_tmp173[0]=t1,_tmp173[1]=t2;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp173,sizeof(void*),2));}));});}}{
# 895
void*_tmp174=Cyc_Vcgen_do_assign(env,a2,lt,t2);void*a=_tmp174;
return({struct _tuple12 _tmp228;_tmp228.f1=lt,_tmp228.f2=a;_tmp228;});}}}}case 5: _LL9: _tmp15B=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp15C=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LLA: {struct Cyc_Absyn_Exp*e=_tmp15B;enum Cyc_Absyn_Incrementor i=_tmp15C;
# 898
...
# 904
 if(t1 != 0)assn=Cyc_AssnDef_primop(Cyc_Absyn_Plus,({void*_tmp17B[2];_tmp17B[0]=t1,({void*_tmp2AE=Cyc_AssnDef_one();_tmp17B[1]=_tmp2AE;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp17B,sizeof(void*),2));}));
res=assn;
goto _LL63;case Cyc_Absyn_PostInc: _LL66: _LL67:
# 908
 res=t1;
if(t1 != 0)assn=Cyc_AssnDef_primop(Cyc_Absyn_Plus,({void*_tmp17C[2];_tmp17C[0]=t1,({void*_tmp2AF=Cyc_AssnDef_one();_tmp17C[1]=_tmp2AF;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp17C,sizeof(void*),2));}));
goto _LL63;case Cyc_Absyn_PreDec: _LL68: _LL69:
# 912
 if(t1 != 0)assn=Cyc_AssnDef_primop(Cyc_Absyn_Minus,({void*_tmp17D[2];_tmp17D[0]=t1,({void*_tmp2B0=Cyc_AssnDef_one();_tmp17D[1]=_tmp2B0;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp17D,sizeof(void*),2));}));
res=assn;
goto _LL63;case Cyc_Absyn_PostDec: _LL6A: _LL6B:
# 916
 res=t1;
if(t1 != 0)assn=Cyc_AssnDef_primop(Cyc_Absyn_Minus,({void*_tmp17E[2];_tmp17E[0]=t1,({void*_tmp2B1=Cyc_AssnDef_one();_tmp17E[1]=_tmp2B1;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp17E,sizeof(void*),2));}));
goto _LL63;default: _LL6C: _LL6D:
({void*_tmp17F=0U;({struct _fat_ptr _tmp2B2=({const char*_tmp180="vcgen vcgen_rexp increment_e";_tag_fat(_tmp180,sizeof(char),29U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp2B2,_tag_fat(_tmp17F,sizeof(void*),0));});});}_LL63:;}{
# 921
void*_tmp181=Cyc_Vcgen_do_assign(env,a1,lt,assn);void*a=_tmp181;
return({struct _tuple12 _tmp229;_tmp229.f1=res,_tmp229.f2=a;_tmp229;});}}}case 6: _LLB: _tmp158=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp159=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_tmp15A=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp12E)->f3;_LLC: {struct Cyc_Absyn_Exp*e1=_tmp158;struct Cyc_Absyn_Exp*e2=_tmp159;struct Cyc_Absyn_Exp*e3=_tmp15A;
# 924
...
# 933
return({struct _tuple12 _tmp22B;_tmp22B.f1=0,({void*_tmp2B6=Cyc_AssnDef_or(at,af);_tmp22B.f2=_tmp2B6;});_tmp22B;});}}}}}case 7: _LLD: _tmp156=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp157=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LLE: {struct Cyc_Absyn_Exp*e1=_tmp156;struct Cyc_Absyn_Exp*e2=_tmp157;
# 935
...
return({struct _tuple12 _tmp22C;_tmp22C.f1=v,({void*_tmp2BA=Cyc_AssnDef_or(at,af);_tmp22C.f2=_tmp2BA;});_tmp22C;});}}}case 8: _LLF: _tmp154=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp155=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LL10: {struct Cyc_Absyn_Exp*e1=_tmp154;struct Cyc_Absyn_Exp*e2=_tmp155;
# 942
...
return({struct _tuple12 _tmp22D;_tmp22D.f1=v,({void*_tmp2BE=Cyc_AssnDef_or(at,af);_tmp22D.f2=_tmp2BE;});_tmp22D;});}}}case 9: _LL11: _tmp152=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp153=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LL12: {struct Cyc_Absyn_Exp*e1=_tmp152;struct Cyc_Absyn_Exp*e2=_tmp153;
# 949
...
return Cyc_Vcgen_vcgen_rexp_nodebug(env,e2,a);}}case 10: _LL13: _tmp150=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp151=((struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LL14: {struct Cyc_Absyn_Exp*e=_tmp150;struct Cyc_List_List*es=_tmp151;
# 952
...
# 974
return({struct _tuple12 _tmp230;_tmp230.f1=0,_tmp230.f2=at;_tmp230;});}}}}}}case 11: _LL15: _tmp14F=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL16: {struct Cyc_Absyn_Exp*e=_tmp14F;
# 976
...
return({struct _tuple12 _tmp231;_tmp231.f1=0,_tmp231.f2=(void*)& Cyc_AssnDef_false_assn;_tmp231;});}}case 12: _LL17: _tmp14E=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL18: {struct Cyc_Absyn_Exp*e=_tmp14E;
return Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain);}case 13: _LL19: _tmp14D=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL1A: {struct Cyc_Absyn_Exp*e=_tmp14D;
return Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain);}case 14: _LL1B: _tmp14A=(void*)((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp14B=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_tmp14C=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp12E)->f4;_LL1C: {void*tp=_tmp14A;struct Cyc_Absyn_Exp*e=_tmp14B;enum Cyc_Absyn_Coercion c=_tmp14C;
# 984
...
return({struct _tuple12 _tmp236;topt == 0?_tmp236.f1=0:({void*_tmp2C2=Cyc_AssnDef_cast(tp,topt);_tmp236.f1=_tmp2C2;}),_tmp236.f2=a;_tmp236;});}}}case 16: _LL1D: _tmp148=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp149=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LL1E: {struct Cyc_Absyn_Exp*eopt=_tmp148;struct Cyc_Absyn_Exp*e=_tmp149;
# 1007
if(eopt != 0)
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,eopt,ain)).f2;
return({struct _tuple12 _tmp237;_tmp237.f1=0,({void*_tmp2C3=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp237.f2=_tmp2C3;});_tmp237;});}case 32: _LL1F: _LL20:
# 1012
 ...
 return({struct _tuple12 _tmp238;_tmp238.f1=0,_tmp238.f2=ain;_tmp238;});case 21: _LL2B: _tmp147=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL2C: {struct Cyc_Absyn_Exp*e=_tmp147;
# 1020
_tmp146=e;goto _LL2E;
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;
Cyc_Vcgen_update_try_assn(env,ain);
return({struct _tuple12 _tmp239;_tmp239.f1=0,_tmp239.f2=ain;_tmp239;});}case 38: _LL2D: _tmp146=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL2E: {struct Cyc_Absyn_Exp*e=_tmp146;
# 1025
_tmp145=e;goto _LL30;}case 15: _LL2F: _tmp145=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL30: {struct Cyc_Absyn_Exp*e=_tmp145;
# 1027
return({struct _tuple12 _tmp23A;_tmp23A.f1=0,({void*_tmp2C4=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp23A.f2=_tmp2C4;});_tmp23A;});}case 20: _LL31: _tmp144=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL32: {struct Cyc_Absyn_Exp*e=_tmp144;
# 1029
_tmp143=e;goto _LL34;}case 22: _LL33: _tmp143=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL34: {struct Cyc_Absyn_Exp*e=_tmp143;
_tmp141=e;_tmp142=Cyc_Vcgen_shared_zero_exp();goto _LL36;}case 23: _LL35: _tmp141=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp142=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LL36: {struct Cyc_Absyn_Exp*e1=_tmp141;struct Cyc_Absyn_Exp*e2=_tmp142;
# 1032
...
{void*_tmp1CA=Cyc_Absyn_compress((void*)_check_null(e1->topt));void*_stmttmp3C=_tmp1CA;void*_tmp1CB=_stmttmp3C;if(*((int*)_tmp1CB)== 6){_LLA4: _LLA5:
...
# 1042
additional=({void*_tmp2C5=t2;Cyc_AssnDef_ult(_tmp2C5,Cyc_AssnDef_primop(Cyc_Absyn_Numelts,({void*_tmp1CC[1];_tmp1CC[0]=t1;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1CC,sizeof(void*),1));})));});}
# 1044
...
# 1048
return({struct _tuple12 _tmp23B;_tmp23B.f1=0,_tmp23B.f2=a2;_tmp23B;});}}}case 31: _LL37: _tmp140=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL38: {struct Cyc_List_List*es=_tmp140;
# 1050
_tmp13F=es;goto _LL3A;}case 24: _LL39: _tmp13F=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL3A: {struct Cyc_List_List*es=_tmp13F;
return({struct _tuple12 _tmp23C;_tmp23C.f1=0,({void*_tmp2C8=Cyc_Vcgen_vcgen_rexps_nosave(env,es,ain);_tmp23C.f2=_tmp2C8;});_tmp23C;});}case 25: _LL3B: _tmp13E=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LL3C: {struct Cyc_List_List*dles=_tmp13E;
# 1053
_tmp13D=dles;goto _LL3E;}case 26: _LL3D: _tmp13D=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL3E: {struct Cyc_List_List*dles=_tmp13D;
_tmp13C=dles;goto _LL40;}case 29: _LL3F: _tmp13C=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp12E)->f3;_LL40: {struct Cyc_List_List*dles=_tmp13C;
_tmp13B=dles;goto _LL42;}case 36: _LL41: _tmp13B=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LL42: {struct Cyc_List_List*dles=_tmp13B;
_tmp13A=dles;goto _LL44;}case 30: _LL43: _tmp13A=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LL44: {struct Cyc_List_List*dles=_tmp13A;
# 1058
...
struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp1D6=({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp1DD=_cycalloc(sizeof(*_tmp1DD));_tmp1DD->tag=1,_tmp1DD->f1=vd;_tmp1DD;});struct Cyc_AssnDef_Var_AssnDef_Term_struct*v=_tmp1D6;
# 1070
...
abody=({struct Cyc_Vcgen_Env*_tmp2D1=env;void*_tmp2D0=abody;void*_tmp2CF=(void*)v;Cyc_Vcgen_do_assign(_tmp2D1,_tmp2D0,_tmp2CF,Cyc_AssnDef_primop(Cyc_Absyn_Plus,({void*_tmp1DC[2];_tmp1DC[0]=(void*)v,({void*_tmp2CE=Cyc_AssnDef_one();_tmp1DC[1]=_tmp2CE;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1DC,sizeof(void*),2));})));});
if(Cyc_Vcgen_implies(& abody,& a)){a=af;break;}
a=Cyc_Vcgen_weaken_assn(abody,a);}}
# 1079
return({struct _tuple12 _tmp23E;_tmp23E.f1=0,_tmp23E.f2=a;_tmp23E;});}}}case 28: _LL47: _tmp136=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL48: {struct Cyc_Absyn_Exp*e=_tmp136;
# 1081
return({struct _tuple12 _tmp23F;_tmp23F.f1=0,({void*_tmp2D2=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp23F.f2=_tmp2D2;});_tmp23F;});}case 34: _LL49: _tmp135=((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL4A: {struct Cyc_Absyn_MallocInfo mi=_tmp135;
# 1083
if(mi.rgn != 0)
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,mi.rgn,ain)).f2;
return({struct _tuple12 _tmp240;_tmp240.f1=0,({void*_tmp2D3=(Cyc_Vcgen_vcgen_rexp_nodebug(env,mi.num_elts,ain)).f2;_tmp240.f2=_tmp2D3;});_tmp240;});}case 35: _LL4B: _tmp133=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp134=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_LL4C: {struct Cyc_Absyn_Exp*e1=_tmp133;struct Cyc_Absyn_Exp*e2=_tmp134;
# 1087
...
return({struct _tuple12 _tmp241;_tmp241.f1=0,_tmp241.f2=a2;_tmp241;});}}}}}case 37: _LL4D: _tmp132=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL4E: {struct Cyc_Absyn_Stmt*s=_tmp132;
# 1097
...
return({struct _tuple12 _tmp242;_tmp242.f1=t,_tmp242.f2=aout;_tmp242;});}}case 40: _LL4F: _LL50:
 return({struct _tuple12 _tmp243;_tmp243.f1=0,_tmp243.f2=ain;_tmp243;});case 41: _LL51: _tmp131=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL52: {struct Cyc_Absyn_Exp*e=_tmp131;
return Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain);}case 2: _LL53: _tmp130=((struct Cyc_Absyn_Pragma_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL54: {struct _fat_ptr s=_tmp130;
# 1106
...
({struct Cyc_String_pa_PrintArg_struct _tmp1F0=({struct Cyc_String_pa_PrintArg_struct _tmp245;_tmp245.tag=0,_tmp245.f1=(struct _fat_ptr)((struct _fat_ptr)seg_str);_tmp245;});struct Cyc_String_pa_PrintArg_struct _tmp1F1=({struct Cyc_String_pa_PrintArg_struct _tmp244;_tmp244.tag=0,({struct _fat_ptr _tmp2D6=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(ain));_tmp244.f1=_tmp2D6;});_tmp244;});void*_tmp1EE[2];_tmp1EE[0]=& _tmp1F0,_tmp1EE[1]=& _tmp1F1;({struct Cyc___cycFILE*_tmp2D8=Cyc_stderr;struct _fat_ptr _tmp2D7=({const char*_tmp1EF="%s: current assn is %s\n";_tag_fat(_tmp1EF,sizeof(char),24U);});Cyc_fprintf(_tmp2D8,_tmp2D7,_tag_fat(_tmp1EE,sizeof(void*),2));});});}
# 1110
...
({struct Cyc_String_pa_PrintArg_struct _tmp1F7=({struct Cyc_String_pa_PrintArg_struct _tmp247;_tmp247.tag=0,({
struct _fat_ptr _tmp2DA=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(ain)));_tmp247.f1=_tmp2DA;});_tmp247;});void*_tmp1F5[1];_tmp1F5[0]=& _tmp1F7;({unsigned _tmp2DC=e->loc;struct _fat_ptr _tmp2DB=({const char*_tmp1F6="cannot prove @assert from %s";_tag_fat(_tmp1F6,sizeof(char),29U);});Cyc_Warn_err(_tmp2DC,_tmp2DB,_tag_fat(_tmp1F5,sizeof(void*),1));});});
...
res_assn=({void*_tmp2E0=res_assn;Cyc_AssnDef_and(_tmp2E0,({void*_tmp2DF=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp204=_cycalloc(sizeof(*_tmp204));_tmp204->tag=1,_tmp204->f1=ret_value;_tmp204;});Cyc_AssnDef_eq(_tmp2DF,senv->res_term);}));});
if(!Cyc_Vcgen_implies(& res_assn,& at))
({struct Cyc_String_pa_PrintArg_struct _tmp207=({struct Cyc_String_pa_PrintArg_struct _tmp24A;_tmp24A.tag=0,({
struct _fat_ptr _tmp2E1=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(at)));_tmp24A.f1=_tmp2E1;});_tmp24A;});struct Cyc_String_pa_PrintArg_struct _tmp208=({struct Cyc_String_pa_PrintArg_struct _tmp249;_tmp249.tag=0,({struct _fat_ptr _tmp2E2=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(res_assn)));_tmp249.f1=_tmp2E2;});_tmp249;});void*_tmp205[2];_tmp205[0]=& _tmp207,_tmp205[1]=& _tmp208;({unsigned _tmp2E4=ens->loc;struct _fat_ptr _tmp2E3=({const char*_tmp206="cannot prove the @ensures clause %s from %s";_tag_fat(_tmp206,sizeof(char),44U);});Cyc_Warn_err(_tmp2E4,_tmp2E3,_tag_fat(_tmp205,sizeof(void*),2));});});}}}
# 1148
