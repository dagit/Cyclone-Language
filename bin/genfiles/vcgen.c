...
a=({struct Cyc_Vcgen_Env*_tmp258=env;Cyc_Vcgen_may_widen(_tmp258,Cyc_AssnDef_or(*_check_null((env->shared)->try_assn),a));});
...
shared->res_term=v;
({void*_tmp25C=({
void*_tmp25B=({void*_tmp259=a;Cyc_AssnDef_and(_tmp259,Cyc_AssnDef_eq(v,t));});Cyc_AssnDef_or(_tmp25B,({void*_tmp25A=*_check_null(shared->res_assn);Cyc_AssnDef_and(_tmp25A,Cyc_AssnDef_eq(v,shared->res_term));}));});
# 370
*_check_null(shared->res_assn)=_tmp25C;});}else{
# 373
({void*_tmp25D=Cyc_AssnDef_or(a,*_check_null(shared->res_assn));*_check_null(shared->res_assn)=_tmp25D;});}}
# 378
...
struct _tuple13**_tmp22=({(struct _tuple13**(*)(struct Cyc_Hashtable_Table*,struct Cyc_Absyn_Exp*))Cyc_Hashtable_lookup_opt;})(*_check_null(assn_info),e);struct _tuple13**result=_tmp22;
if(result == 0)
# 388
...
# 553
struct _tuple13 _tmp4D=Cyc_Vcgen_vcgen_rexp_nodebug(env,_check_null(e),ain);struct _tuple13 _stmttmp3=_tmp4D;struct _tuple13 _tmp4E=_stmttmp3;void*_tmp50;void*_tmp4F;_tmp4F=_tmp4E.f1;_tmp50=_tmp4E.f2;{void*t=_tmp4F;void*aout=_tmp50;
...
if(ts != 0){
# 708
struct Cyc_List_List*_tmp9E=({struct Cyc_List_List*(*_tmp27F)(struct Cyc_List_List*)=({(struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_Tcutil_filter_nulls;});_tmp27F((({(struct _tuple0(*)(struct Cyc_List_List*))Cyc_List_split;})((struct Cyc_List_List*)(_check_null(dest->pat_vars))->v)).f1);});struct Cyc_List_List*x=_tmp9E;
# 710
...
if(vd != 0)
a=({struct Cyc_Vcgen_Env*_tmp282=env;void*_tmp281=a;void*_tmp280=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmpA0=_cycalloc(sizeof(*_tmpA0));_tmpA0->tag=2,_tmpA0->f1=vd;_tmpA0;});Cyc_Vcgen_do_assign(_tmp282,_tmp281,_tmp280,(void*)(_check_null(ts))->hd);});}}
# 716
...
ain=Cyc_Vcgen_vcgen_stmt_nodebug(env,s,ain);{
# 740
void*_tmpA3=*_check_null((env->shared)->try_assn);void*new_try_assn=_tmpA3;
...
{struct Cyc_List_List*_tmpA6=(struct Cyc_List_List*)(_check_null(sc->pat_vars))->v;struct Cyc_List_List*pvs=_tmpA6;for(0;pvs != 0;pvs=pvs->tl){
...
if(vd->initializer != 0){
struct _tuple13 _tmpAC=Cyc_Vcgen_vcgen_rexp_nodebug(env,_check_null(vd->initializer),a);struct _tuple13 _stmttmp15=_tmpAC;struct _tuple13 _tmpAD=_stmttmp15;void*_tmpAF;void*_tmpAE;_tmpAE=_tmpAD.f1;_tmpAF=_tmpAD.f2;{void*t=_tmpAE;void*a1=_tmpAF;
...
{struct Cyc_List_List*_tmpB9=(struct Cyc_List_List*)(_check_null(vds))->v;struct Cyc_List_List*vds=_tmpB9;for(0;vds != 0;vds=vds->tl){
...
void*_tmpC8=Cyc_Absyn_compress(_check_null(e1->topt));void*t1=_tmpC8;
void*_tmpC9=Cyc_Absyn_compress(_check_null(e2->topt));void*t2=_tmpC9;
...
t2=0;else{
# 1084
t2=({enum Cyc_Absyn_Primop _tmp2BD=(enum Cyc_Absyn_Primop)popt->v;Cyc_AssnDef_primop(_tmp2BD,({void*_tmp15C[2];_tmp15C[0]=t1,_tmp15C[1]=t2;({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp15C,sizeof(void*),2));}));});}}{
# 1086
...
# 1095
 if(t1 != 0)assn=Cyc_AssnDef_primop(0U,({void*_tmp164[2];_tmp164[0]=t1,({void*_tmp2BE=Cyc_AssnDef_one();_tmp164[1]=_tmp2BE;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp164,sizeof(void*),2));}));
res=assn;
goto _LL70;case Cyc_Absyn_PostInc:
# 1099
 res=t1;
if(t1 != 0)assn=Cyc_AssnDef_primop(0U,({void*_tmp165[2];_tmp165[0]=t1,({void*_tmp2BF=Cyc_AssnDef_one();_tmp165[1]=_tmp2BF;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp165,sizeof(void*),2));}));
goto _LL70;case Cyc_Absyn_PreDec:
# 1103
 if(t1 != 0)assn=Cyc_AssnDef_primop(2U,({void*_tmp166[2];_tmp166[0]=t1,({void*_tmp2C0=Cyc_AssnDef_one();_tmp166[1]=_tmp2C0;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp166,sizeof(void*),2));}));
res=assn;
goto _LL70;case Cyc_Absyn_PostDec:
# 1107
 res=t1;
if(t1 != 0)assn=Cyc_AssnDef_primop(2U,({void*_tmp167[2];_tmp167[0]=t1,({void*_tmp2C1=Cyc_AssnDef_one();_tmp167[1]=_tmp2C1;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp167,sizeof(void*),2));}));
goto _LL70;default:
({void*_tmp168=0U;({int(*_tmp2C3)(struct _fat_ptr,struct _fat_ptr)=({(int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos;});struct _fat_ptr _tmp2C2=({const char*_tmp169="vcgen vcgen_rexp increment_e";_tag_fat(_tmp169,sizeof(char),29U);});_tmp2C3(_tmp2C2,_tag_fat(_tmp168,sizeof(void*),0));});});}_LL70:;}{
# 1112
...
at=({void*_tmp2C4=at;Cyc_AssnDef_and(_tmp2C4,Cyc_AssnDef_eq(v,t1));});
af=({void*_tmp2C5=af;Cyc_AssnDef_and(_tmp2C5,Cyc_AssnDef_eq(v,t2));});
return({struct _tuple13 _tmp219;_tmp219.f1=v,({void*_tmp2C7=({struct Cyc_Vcgen_Env*_tmp2C6=env;Cyc_Vcgen_may_widen(_tmp2C6,Cyc_AssnDef_or(at,af));});_tmp219.f2=_tmp2C7;});_tmp219;});}else{
# 1124
return({struct _tuple13 _tmp21A;_tmp21A.f1=0,({void*_tmp2C9=({struct Cyc_Vcgen_Env*_tmp2C8=env;Cyc_Vcgen_may_widen(_tmp2C8,Cyc_AssnDef_or(at,af));});_tmp21A.f2=_tmp2C9;});_tmp21A;});}}}}}case 7: _tmp142=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp141)->f1;_tmp144=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp141)->f2;{struct Cyc_Absyn_Exp*e1=_tmp142;struct Cyc_Absyn_Exp*e2=_tmp144;
# 1126
...
at=({void*_tmp2CA=at;Cyc_AssnDef_and(_tmp2CA,Cyc_AssnDef_eq(v,t));});
af=({void*_tmp2CC=af;Cyc_AssnDef_and(_tmp2CC,({void*_tmp2CB=v;Cyc_AssnDef_eq(_tmp2CB,Cyc_AssnDef_zero());}));});
return({struct _tuple13 _tmp21B;_tmp21B.f1=v,({void*_tmp2CE=({struct Cyc_Vcgen_Env*_tmp2CD=env;Cyc_Vcgen_may_widen(_tmp2CD,Cyc_AssnDef_or(at,af));});_tmp21B.f2=_tmp2CE;});_tmp21B;});}}}case 8: _tmp142=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp141)->f1;_tmp144=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp141)->f2;{struct Cyc_Absyn_Exp*e1=_tmp142;struct Cyc_Absyn_Exp*e2=_tmp144;
# 1133
...
at=({void*_tmp2D0=at;Cyc_AssnDef_and(_tmp2D0,({void*_tmp2CF=v;Cyc_AssnDef_eq(_tmp2CF,Cyc_AssnDef_one());}));});
af=({void*_tmp2D1=af;Cyc_AssnDef_and(_tmp2D1,Cyc_AssnDef_eq(v,t));});
return({struct _tuple13 _tmp21C;_tmp21C.f1=v,({void*_tmp2D3=({struct Cyc_Vcgen_Env*_tmp2D2=env;Cyc_Vcgen_may_widen(_tmp2D2,Cyc_AssnDef_or(at,af));});_tmp21C.f2=_tmp2D3;});_tmp21C;});}}}case 9: _tmp142=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp141)->f1;_tmp144=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp141)->f2;{struct Cyc_Absyn_Exp*e1=_tmp142;struct Cyc_Absyn_Exp*e2=_tmp144;
# 1140
...
void*t=topt;
return({struct _tuple13 _tmp226;({void*_tmp2D6=Cyc_AssnDef_cast(tp,t);_tmp226.f1=_tmp2D6;}),_tmp226.f2=a;_tmp226;});}}else{
# 1207
Cyc_Vcgen_update_try_assn(env,ain);
return({struct _tuple13 _tmp227;topt == 0?_tmp227.f1=0:({void*_tmp2D7=Cyc_AssnDef_cast(tp,topt);_tmp227.f1=_tmp2D7;}),_tmp227.f2=a;_tmp227;});}}}case 16: _tmp142=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp141)->f1;_tmp144=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp141)->f2;{struct Cyc_Absyn_Exp*eopt=_tmp142;struct Cyc_Absyn_Exp*e=_tmp144;
# 1211
if(eopt != 0)
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,eopt,ain)).f2;
return({struct _tuple13 _tmp228;_tmp228.f1=0,({void*_tmp2D8=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp228.f2=_tmp2D8;});_tmp228;});}case 32:
# 1216
 ...
 return({struct _tuple13 _tmp229;({void*_tmp2D9=(void*)({struct Cyc_AssnDef_Const_AssnDef_Term_struct*_tmp1AB=_cycalloc(sizeof(*_tmp1AB));_tmp1AB->tag=1,_tmp1AB->f1=e;_tmp1AB;});_tmp229.f1=_tmp2D9;}),_tmp229.f2=ain;_tmp229;});case 21: _tmp142=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp141)->f1;{struct Cyc_Absyn_Exp*e=_tmp142;
# 1224
...
# 1231
return({struct _tuple13 _tmp22B;_tmp22B.f1=0,({void*_tmp2DA=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp22B.f2=_tmp2DA;});_tmp22B;});}case 20: _tmp142=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp141)->f1;{struct Cyc_Absyn_Exp*e=_tmp142;
# 1233
...
{void*_tmp1B4=Cyc_Absyn_compress(_check_null(e1->topt));void*_stmttmp47=_tmp1B4;void*_tmp1B5=_stmttmp47;if(*((int*)_tmp1B5)== 6)
goto _LLB4;else{
# 1243
Cyc_Vcgen_update_try_assn(env,a2);{
...
# 1247
if(t2 == 0)goto _LLB4;
term_numelts=Cyc_AssnDef_primop(18U,({void*_tmp1B6[1];_tmp1B6[0]=t1;({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp1B6,sizeof(void*),1));}));{
# 1259 "vcgen.cyc"
void*_tmp1B7=Cyc_AssnDef_ult(t2,term_numelts);void*inbound_assn=_tmp1B7;
({struct Cyc_Hashtable_Table**_tmp2DC=env->assn_info;struct Cyc_Absyn_Exp*_tmp2DB=e1;Cyc_Vcgen_insert_assn_info(_tmp2DC,_tmp2DB,({struct _tuple13*_tmp1B8=_cycalloc(sizeof(*_tmp1B8));_tmp1B8->f1=a2,_tmp1B8->f2=inbound_assn;_tmp1B8;}));});
...
return({struct _tuple13 _tmp22D;_tmp22D.f1=0,({void*_tmp2DD=Cyc_Vcgen_vcgen_rexps_nosave(env,es,ain);_tmp22D.f2=_tmp2DD;});_tmp22D;});}case 25: _tmp142=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp141)->f2;{struct Cyc_List_List*dles=_tmp142;
# 1268
...
while(1){
void*_tmp1C1=({void*_tmp2E1=a;Cyc_AssnDef_and(_tmp2E1,Cyc_AssnDef_ult((void*)v,t1));});void*at=_tmp1C1;
void*_tmp1C2=({void*_tmp2E2=a;Cyc_AssnDef_and(_tmp2E2,Cyc_AssnDef_ulte(t1,(void*)v));});void*af=_tmp1C2;
...
abody=({struct Cyc_Vcgen_Env*_tmp2E6=env;void*_tmp2E5=abody;void*_tmp2E4=(void*)v;Cyc_Vcgen_do_assign(_tmp2E6,_tmp2E5,_tmp2E4,Cyc_AssnDef_primop(0U,({void*_tmp1C6[2];_tmp1C6[0]=(void*)v,({void*_tmp2E3=Cyc_AssnDef_one();_tmp1C6[1]=_tmp2E3;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp1C6,sizeof(void*),2));})));});
...
# 1296
return({struct _tuple13 _tmp230;_tmp230.f1=0,({void*_tmp2E7=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp230.f2=_tmp2E7;});_tmp230;});}case 34: _tmp145=((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp141)->f1;{struct Cyc_Absyn_MallocInfo mi=_tmp145;
# 1298
if(mi.rgn != 0)
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,mi.rgn,ain)).f2;
return({struct _tuple13 _tmp231;_tmp231.f1=0,({void*_tmp2E8=(Cyc_Vcgen_vcgen_rexp_nodebug(env,mi.num_elts,ain)).f2;_tmp231.f2=_tmp2E8;});_tmp231;});}case 35: _tmp142=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp141)->f1;_tmp144=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp141)->f2;{struct Cyc_Absyn_Exp*e1=_tmp142;struct Cyc_Absyn_Exp*e2=_tmp144;
# 1302
...
({void**_tmp2E9=({void**_tmp1D3=_cycalloc(sizeof(*_tmp1D3));*_tmp1D3=0;_tmp1D3;});(env->shared)->exp_stmt=_tmp2E9;});{
void*_tmp1D4=Cyc_Vcgen_vcgen_stmt_nodebug(env,s,ain);void*aout=_tmp1D4;
void*_tmp1D5=*_check_null((env->shared)->exp_stmt);void*t=_tmp1D5;
...
return({struct _tuple13 _tmp235;({void*_tmp2EA=Cyc_AssnDef_zero();_tmp235.f1=_tmp2EA;}),_tmp235.f2=ain;_tmp235;});}default: _tmp142=((struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*)_tmp141)->f1;{struct Cyc_Absyn_Exp*e1=_tmp142;
# 1322
...
struct _fat_ptr _tmp2EB=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(at));_tmp237.f1=_tmp2EB;});_tmp237;});struct Cyc_String_pa_PrintArg_struct _tmp1DC=({struct Cyc_String_pa_PrintArg_struct _tmp236;_tmp236.tag=0,({struct _fat_ptr _tmp2EC=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(ain)));_tmp236.f1=_tmp2EC;});_tmp236;});void*_tmp1D9[2];_tmp1D9[0]=& _tmp1DB,_tmp1D9[1]=& _tmp1DC;({unsigned _tmp2EE=e->loc;struct _fat_ptr _tmp2ED=({const char*_tmp1DA="cannot prove @assert(%s) \n\nfrom %s";_tag_fat(_tmp1DA,sizeof(char),35U);});Cyc_Warn_err(_tmp2EE,_tmp2ED,_tag_fat(_tmp1D9,sizeof(void*),2));});});
return({struct _tuple13 _tmp238;({void*_tmp2F0=Cyc_AssnDef_one();_tmp238.f1=_tmp2F0;}),({void*_tmp2EF=Cyc_AssnDef_and(ain,at);_tmp238.f2=_tmp2EF;});_tmp238;});}}};}}
# 1332
...
void*_tmp1E8=*_check_null(senv->res_assn);void*res_assn_opt=_tmp1E8;
...
res_assn=({void*_tmp2F2=res_assn;Cyc_AssnDef_and(_tmp2F2,({void*_tmp2F1=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp1E9=_cycalloc(sizeof(*_tmp1E9));_tmp1E9->tag=2,_tmp1E9->f1=ret_value;_tmp1E9;});Cyc_AssnDef_eq(_tmp2F1,senv->res_term);}));});
...
struct _fat_ptr _tmp2F3=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(at)));_tmp23A.f1=_tmp2F3;});_tmp23A;});struct Cyc_String_pa_PrintArg_struct _tmp1ED=({struct Cyc_String_pa_PrintArg_struct _tmp239;_tmp239.tag=0,({struct _fat_ptr _tmp2F4=(struct _fat_ptr)((struct _fat_ptr)Cyc_AssnDef_assn2string(Cyc_AssnDef_reduce(res_assn)));_tmp239.f1=_tmp2F4;});_tmp239;});void*_tmp1EA[2];_tmp1EA[0]=& _tmp1EC,_tmp1EA[1]=& _tmp1ED;({unsigned _tmp2F6=ens->loc;struct _fat_ptr _tmp2F5=({const char*_tmp1EB="cannot prove the @ensures clause %s from %s";_tag_fat(_tmp1EB,sizeof(char),44U);});Cyc_Warn_err(_tmp2F6,_tmp2F5,_tag_fat(_tmp1EA,sizeof(void*),2));});});}}}
# 1359
