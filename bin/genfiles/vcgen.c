...
struct Cyc_Absyn_Vardecl*_tmp209=({struct Cyc_Absyn_Vardecl*_tmp20B=_cycalloc(sizeof(*_tmp20B));_tmp20B->sc=Cyc_Absyn_Public,_tmp20B->name=qv,_tmp20B->varloc=0U,_tmp20B->tq=tq,_tmp20B->type=t,_tmp20B->initializer=0,_tmp20B->rgn=0,_tmp20B->attributes=0,_tmp20B->escapes=0;_tmp20B;});struct Cyc_Absyn_Vardecl*vd=_tmp209;
# 1316
