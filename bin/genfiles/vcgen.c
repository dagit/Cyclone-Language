...
# 774
{void*_Tmp3=eleft->r;void*_Tmp4;if(*((int*)_Tmp3)==41){_Tmp4=((struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*)_Tmp3)->f1;{struct Cyc_Absyn_Exp*eassn=_Tmp4;
# 776
loop_inv_exp=eassn;
cond=eright;
goto _LL8;}}else{
