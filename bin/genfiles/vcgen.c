...
# 140
({void*_tmp21=0U;({struct _fat_ptr _tmp432=({const char*_tmp22="term2string primop args";_tag_fat(_tmp22,sizeof(char),24U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp432,_tag_fat(_tmp21,sizeof(void*),0U));});});}default: _LLD: _tmp1=(void*)((struct Cyc_Vcgen_Cast_Vcgen_Term_struct*)_tmp0)->f1;_tmp2=(void*)((struct Cyc_Vcgen_Cast_Vcgen_Term_struct*)_tmp0)->f2;_LLE: {void*tp=_tmp1;void*tm=_tmp2;
# 139
...
({void*_tmp5F=0U;({struct _fat_ptr _tmp439=({const char*_tmp60="assn2string primop";_tag_fat(_tmp60,sizeof(char),19U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp439,_tag_fat(_tmp5F,sizeof(void*),0U));});});}_LLF:;}
# 291
...
({void*_tmpD6=0U;({struct _fat_ptr _tmp459=({const char*_tmpD7="Vcgen::invert: non-primop";_tag_fat(_tmpD7,sizeof(char),26U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp459,_tag_fat(_tmpD6,sizeof(void*),0U));});});}_LLF:;}case 5U: _LLB: _LLC:
# 552
...
({void*_tmp220=0U;({struct _fat_ptr _tmp4C8=({const char*_tmp221="vcgen fallthru";_tag_fat(_tmp221,sizeof(char),15U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp4C8,_tag_fat(_tmp220,sizeof(void*),0U));});});}else{_LL20: _tmp1E7=((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp1E1)->f1;_tmp1E8=*((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp1E1)->f2;_LL21: {struct Cyc_List_List*es=_tmp1E7;struct Cyc_Absyn_Switch_clause*dest=_tmp1E8;
# 1656
...
void*_tmp258=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*t1=_tmp258;
void*_tmp259=Cyc_Tcutil_compress((void*)_check_null(e2->topt));void*t2=_tmp259;
...
({void*_tmp2B2=0U;({struct _fat_ptr _tmp4F8=({const char*_tmp2B3="vcgen bind2vardecl";_tag_fat(_tmp2B3,sizeof(char),19U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp4F8,_tag_fat(_tmp2B2,sizeof(void*),0U));});});case 3U: _LL7: _tmp2AF=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)_tmp2AC)->f1;_LL8: {struct Cyc_Absyn_Vardecl*vd=_tmp2AF;
...
({void*_tmp31C=0U;({struct _fat_ptr _tmp50B=({const char*_tmp31D="vcgen vcgen_rexp increment_e";_tag_fat(_tmp31D,sizeof(char),29U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Tcutil_impos)(_tmp50B,_tag_fat(_tmp31C,sizeof(void*),0U));});});}_LL63:;}{
# 1993
...
{void*_tmp367=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*_stmttmp50=_tmp367;void*_tmp368=_stmttmp50;if(((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp368)->tag == 6U){_LLA4: _LLA5:
