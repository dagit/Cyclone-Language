...
# 189
return({void*_tmp24F=a;Cyc_AssnDef_and(_tmp24F,Cyc_AssnDef_eq(tgt,src));});}}else{
({void*_tmpC=0U;({struct _fat_ptr _tmp250=({const char*_tmpD="vcgen do_assign";_tag_fat(_tmpD,sizeof(char),16U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp250,_tag_fat(_tmpC,sizeof(void*),0));});});}};}struct Cyc_Vcgen_SharedEnv{struct Cyc_Hashtable_Table*assn_table;struct Cyc_Hashtable_Table*succ_table;void*try_assn;void**exp_stmt;void*res_term;void*res_assn;};struct Cyc_Vcgen_Env{struct Cyc_Vcgen_SharedEnv*shared;struct Cyc_Dict_Dict state_counter;struct Cyc_Hashtable_Table**assn_info;};
# 229 "vcgen.cyc"
...
# 401
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp2E=({struct Cyc_String_pa_PrintArg_struct _tmp20B;_tmp20B.tag=0,({struct _fat_ptr _tmp25D=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp20B.f1=_tmp25D;});_tmp20B;});void*_tmp2C[1];_tmp2C[0]=& _tmp2E;({struct _fat_ptr _tmp25E=({const char*_tmp2D="if (%s) ...";_tag_fat(_tmp2D,sizeof(char),12U);});Cyc_aprintf(_tmp25E,_tag_fat(_tmp2C,sizeof(void*),1));});});}case 5: _tmp2A=(((struct Cyc_Absyn_While_s_Absyn_Raw_stmt_struct*)_tmp22)->f1).f1;{struct Cyc_Absyn_Exp*e=_tmp2A;
# 403
return(struct _fat_ptr)({struct Cyc_String_pa_PrintArg_struct _tmp31=({struct Cyc_String_pa_PrintArg_struct _tmp20C;_tmp20C.tag=0,({struct _fat_ptr _tmp25F=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp20C.f1=_tmp25F;});_tmp20C;});void*_tmp2F[1];_tmp2F[0]=& _tmp31;({struct _fat_ptr _tmp260=({const char*_tmp30="while (%s) ...";_tag_fat(_tmp30,sizeof(char),15U);});Cyc_aprintf(_tmp260,_tag_fat(_tmp2F,sizeof(void*),1));});});}case 9: _tmp27=((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp22)->f1;_tmp28=(((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp22)->f2).f1;_tmp29=(((struct Cyc_Absyn_For_s_Absyn_Raw_stmt_struct*)_tmp22)->f3).f1;{struct Cyc_Absyn_Exp*e1=_tmp27;struct Cyc_Absyn_Exp*e2=_tmp28;struct Cyc_Absyn_Exp*e3=_tmp29;
# 405
...
({void*_tmp86=0U;({struct _fat_ptr _tmp26E=({const char*_tmp87="vcgen fallthru";_tag_fat(_tmp87,sizeof(char),15U);});((int(*)(struct _fat_ptr,struct _fat_ptr))Cyc_Warn_impos)(_tmp26E,_tag_fat(_tmp86,sizeof(void*),0));});});else{_tmp4D=((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp47)->f1;_tmp4E=*((struct Cyc_Absyn_Fallthru_s_Absyn_Raw_stmt_struct*)_tmp47)->f2;{struct Cyc_List_List*es=_tmp4D;struct Cyc_Absyn_Switch_clause*dest=_tmp4E;
# 575
...
# 612
return({void*_tmp272=ain;Cyc_AssnDef_or(_tmp272,Cyc_Vcgen_vcgen_switch(env,scs,new_try_assn));});}}};}}struct _tuple15{struct Cyc_Absyn_Vardecl**f1;struct Cyc_Absyn_Exp*f2;};
# 616
...
return({struct _tuple12 _tmp215;({void*_tmp27E=Cyc_AssnDef_or(a2t,a3t);_tmp215.f1=_tmp27E;}),({void*_tmp27D=Cyc_AssnDef_or(a2f,a3f);_tmp215.f2=_tmp27D;});_tmp215;});}}}}case 7: _tmpC9=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpC0)->f1;_tmpCA=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpC0)->f2;{struct Cyc_Absyn_Exp*e1=_tmpC9;struct Cyc_Absyn_Exp*e2=_tmpCA;
# 711
...
return({struct _tuple12 _tmp216;_tmp216.f1=a2t,({void*_tmp27F=Cyc_AssnDef_or(a1f,a2f);_tmp216.f2=_tmp27F;});_tmp216;});}}}case 8: _tmpC7=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpC0)->f1;_tmpC8=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpC0)->f2;{struct Cyc_Absyn_Exp*e1=_tmpC7;struct Cyc_Absyn_Exp*e2=_tmpC8;
# 715
...
return({struct _tuple12 _tmp217;({void*_tmp280=Cyc_AssnDef_or(a1t,a2t);_tmp217.f1=_tmp280;}),_tmp217.f2=a2f;_tmp217;});}}}case 9: _tmpC5=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpC0)->f1;_tmpC6=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpC0)->f2;{struct Cyc_Absyn_Exp*e1=_tmpC5;struct Cyc_Absyn_Exp*e2=_tmpC6;
# 719
...
return({struct _tuple12 _tmp218;_tmp218.f1=af,_tmp218.f2=at;_tmp218;});}}}else{goto _LLD;}}else{if(((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpC0)->f2 != 0){if(((struct Cyc_List_List*)((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpC0)->f2)->tl != 0){if(((struct Cyc_List_List*)((struct Cyc_List_List*)((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpC0)->f2)->tl)->tl == 0){_tmpC1=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpC0)->f1;_tmpC2=(struct Cyc_Absyn_Exp*)(((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpC0)->f2)->hd;_tmpC3=(struct Cyc_Absyn_Exp*)((((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmpC0)->f2)->tl)->hd;{enum Cyc_Absyn_Primop p=_tmpC1;struct Cyc_Absyn_Exp*e1=_tmpC2;struct Cyc_Absyn_Exp*e2=_tmpC3;
# 725
...
{enum Cyc_Absyn_Primop _tmpFB=p;switch(_tmpFB){case Cyc_Absyn_Eq:
 at=({void*_tmp281=at;Cyc_AssnDef_and(_tmp281,Cyc_AssnDef_eq(t1,t2));});af=({void*_tmp282=af;Cyc_AssnDef_and(_tmp282,Cyc_AssnDef_neq(t1,t2));});goto _LL30;case Cyc_Absyn_Neq:
 at=({void*_tmp283=at;Cyc_AssnDef_and(_tmp283,Cyc_AssnDef_neq(t1,t2));});af=({void*_tmp284=af;Cyc_AssnDef_and(_tmp284,Cyc_AssnDef_eq(t1,t2));});goto _LL30;case Cyc_Absyn_Lt:
# 733
...
goto _LL30;default:
 goto _LL30;}_LL30:;}
# 762
return({struct _tuple12 _tmp219;_tmp219.f1=at,_tmp219.f2=af;_tmp219;});}}}}else{goto _LLD;}}else{goto _LLD;}}else{goto _LLD;}}default: _LLD: {
# 764
...
return({struct _tuple12 _tmp21A;({void*_tmp29A=({void*_tmp299=aout;Cyc_AssnDef_and(_tmp299,({void*_tmp298=t;Cyc_AssnDef_neq(_tmp298,Cyc_AssnDef_zero());}));});_tmp21A.f1=_tmp29A;}),({void*_tmp297=({void*_tmp296=aout;Cyc_AssnDef_and(_tmp296,({void*_tmp295=t;Cyc_AssnDef_eq(_tmp295,Cyc_AssnDef_zero());}));});_tmp21A.f2=_tmp297;});_tmp21A;});}}};}
# 769
...
# 819
return({struct _tuple12 _tmp21E;({void*_tmp2A1=(void*)({struct Cyc_AssnDef_Var_AssnDef_Term_struct*_tmp11A=_cycalloc(sizeof(*_tmp11A));_tmp11A->tag=1,({struct Cyc_Absyn_Vardecl*_tmp2A0=Cyc_Vcgen_bind2vardecl(b);_tmp11A->f1=_tmp2A0;});_tmp11A;});_tmp21E.f1=_tmp2A1;}),_tmp21E.f2=ain;_tmp21E;});}}else{
return({struct _tuple12 _tmp21F;_tmp21F.f1=0,({void*_tmp2A2=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp21F.f2=_tmp2A2;});_tmp21F;});};}struct _tuple16{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;struct Cyc_Absyn_Exp*f3;struct Cyc_Absyn_Vardecl*f4;};
# 826
...
return({struct _tuple12 _tmp228;_tmp228.f1=lt,_tmp228.f2=a;_tmp228;});}}}}case 5: _tmp15B=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp15C=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;{struct Cyc_Absyn_Exp*e=_tmp15B;enum Cyc_Absyn_Incrementor i=_tmp15C;
# 898
...
# 933
return({struct _tuple12 _tmp22B;_tmp22B.f1=0,({void*_tmp2B6=Cyc_AssnDef_or(at,af);_tmp22B.f2=_tmp2B6;});_tmp22B;});}}}}}case 7: _tmp156=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp157=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;{struct Cyc_Absyn_Exp*e1=_tmp156;struct Cyc_Absyn_Exp*e2=_tmp157;
# 935
...
return({struct _tuple12 _tmp22C;_tmp22C.f1=v,({void*_tmp2BA=Cyc_AssnDef_or(at,af);_tmp22C.f2=_tmp2BA;});_tmp22C;});}}}case 8: _tmp154=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp155=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;{struct Cyc_Absyn_Exp*e1=_tmp154;struct Cyc_Absyn_Exp*e2=_tmp155;
# 942
...
return({struct _tuple12 _tmp22D;_tmp22D.f1=v,({void*_tmp2BE=Cyc_AssnDef_or(at,af);_tmp22D.f2=_tmp2BE;});_tmp22D;});}}}case 9: _tmp152=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp153=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;{struct Cyc_Absyn_Exp*e1=_tmp152;struct Cyc_Absyn_Exp*e2=_tmp153;
# 949
...
# 974
return({struct _tuple12 _tmp230;_tmp230.f1=0,_tmp230.f2=at;_tmp230;});}}}}}}case 11: _tmp14F=((struct Cyc_Absyn_Throw_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;{struct Cyc_Absyn_Exp*e=_tmp14F;
# 976
...
return({struct _tuple12 _tmp231;_tmp231.f1=0,_tmp231.f2=(void*)& Cyc_AssnDef_false_assn;_tmp231;});}}case 12: _tmp14E=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;{struct Cyc_Absyn_Exp*e=_tmp14E;
...
return({struct _tuple12 _tmp236;topt == 0?_tmp236.f1=0:({void*_tmp2C2=Cyc_AssnDef_cast(tp,topt);_tmp236.f1=_tmp2C2;}),_tmp236.f2=a;_tmp236;});}}}case 16: _tmp148=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp149=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;{struct Cyc_Absyn_Exp*eopt=_tmp148;struct Cyc_Absyn_Exp*e=_tmp149;
# 1007
if(eopt != 0)
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,eopt,ain)).f2;
return({struct _tuple12 _tmp237;_tmp237.f1=0,({void*_tmp2C3=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp237.f2=_tmp2C3;});_tmp237;});}case 32:
# 1012
 ...
 return({struct _tuple12 _tmp238;_tmp238.f1=0,_tmp238.f2=ain;_tmp238;});case 21: _tmp147=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;{struct Cyc_Absyn_Exp*e=_tmp147;
# 1020
_tmp146=e;goto _LL2E;
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;
Cyc_Vcgen_update_try_assn(env,ain);
return({struct _tuple12 _tmp239;_tmp239.f1=0,_tmp239.f2=ain;_tmp239;});}case 38: _tmp146=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_LL2E: {struct Cyc_Absyn_Exp*e=_tmp146;
# 1025
...
# 1027
return({struct _tuple12 _tmp23A;_tmp23A.f1=0,({void*_tmp2C4=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp23A.f2=_tmp2C4;});_tmp23A;});}case 20: _tmp144=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;{struct Cyc_Absyn_Exp*e=_tmp144;
# 1029
...
# 1048
return({struct _tuple12 _tmp23B;_tmp23B.f1=0,_tmp23B.f2=a2;_tmp23B;});}}}case 31: _tmp140=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;{struct Cyc_List_List*es=_tmp140;
# 1050
...
return({struct _tuple12 _tmp23C;_tmp23C.f1=0,({void*_tmp2C8=Cyc_Vcgen_vcgen_rexps_nosave(env,es,ain);_tmp23C.f2=_tmp2C8;});_tmp23C;});}case 25: _tmp13E=((struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;{struct Cyc_List_List*dles=_tmp13E;
# 1053
...
struct _tuple17*_tmp1CE=(struct _tuple17*)dles->hd;struct _tuple17*_stmttmp3D=_tmp1CE;struct _tuple17*_tmp1CF=_stmttmp3D;struct Cyc_Absyn_Exp*_tmp1D0;_tmp1D0=_tmp1CF->f2;{struct Cyc_Absyn_Exp*e=_tmp1D0;
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;}}
# 1062
return({struct _tuple12 _tmp23D;_tmp23D.f1=0,_tmp23D.f2=ain;_tmp23D;});}case 27: _tmp137=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp138=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;_tmp139=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp12E)->f3;{struct Cyc_Absyn_Vardecl*vd=_tmp137;struct Cyc_Absyn_Exp*e1=_tmp138;struct Cyc_Absyn_Exp*e2=_tmp139;
# 1066
struct _tuple12 _tmp1D1=Cyc_Vcgen_vcgen_rexp_nodebug(env,e1,ain);struct _tuple12 _stmttmp3E=_tmp1D1;struct _tuple12 _tmp1D2=_stmttmp3E;void*_tmp1D4;void*_tmp1D3;_tmp1D3=_tmp1D2.f1;_tmp1D4=_tmp1D2.f2;{void*t1=_tmp1D3;void*a=_tmp1D4;
...
struct _tuple12 _tmp1D9=Cyc_Vcgen_vcgen_rexp_nodebug(env,e2,at);struct _tuple12 _stmttmp3F=_tmp1D9;struct _tuple12 _tmp1DA=_stmttmp3F;void*_tmp1DB;_tmp1DB=_tmp1DA.f2;{void*abody=_tmp1DB;
...
# 1079
return({struct _tuple12 _tmp23E;_tmp23E.f1=0,_tmp23E.f2=a;_tmp23E;});}}}case 28: _tmp136=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;{struct Cyc_Absyn_Exp*e=_tmp136;
# 1081
return({struct _tuple12 _tmp23F;_tmp23F.f1=0,({void*_tmp2D2=(Cyc_Vcgen_vcgen_rexp_nodebug(env,e,ain)).f2;_tmp23F.f2=_tmp2D2;});_tmp23F;});}case 34: _tmp135=((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;{struct Cyc_Absyn_MallocInfo mi=_tmp135;
# 1083
if(mi.rgn != 0)
ain=(Cyc_Vcgen_vcgen_rexp_nodebug(env,mi.rgn,ain)).f2;
return({struct _tuple12 _tmp240;_tmp240.f1=0,({void*_tmp2D3=(Cyc_Vcgen_vcgen_rexp_nodebug(env,mi.num_elts,ain)).f2;_tmp240.f2=_tmp2D3;});_tmp240;});}case 35: _tmp133=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;_tmp134=((struct Cyc_Absyn_Swap_e_Absyn_Raw_exp_struct*)_tmp12E)->f2;{struct Cyc_Absyn_Exp*e1=_tmp133;struct Cyc_Absyn_Exp*e2=_tmp134;
# 1087
struct _tuple12 _tmp1DE=Cyc_Vcgen_vcgen_lexp(env,e1,ain);struct _tuple12 _stmttmp40=_tmp1DE;struct _tuple12 _tmp1DF=_stmttmp40;void*_tmp1E1;void*_tmp1E0;_tmp1E0=_tmp1DF.f1;_tmp1E1=_tmp1DF.f2;{void*lt1=_tmp1E0;void*a1=_tmp1E1;
Cyc_Vcgen_update_try_assn(env,a1);{
struct _tuple12 _tmp1E2=Cyc_Vcgen_vcgen_lexp(env,e2,a1);struct _tuple12 _stmttmp41=_tmp1E2;struct _tuple12 _tmp1E3=_stmttmp41;void*_tmp1E5;void*_tmp1E4;_tmp1E4=_tmp1E3.f1;_tmp1E5=_tmp1E3.f2;{void*lt2=_tmp1E4;void*a2=_tmp1E5;
Cyc_Vcgen_update_try_assn(env,a2);{
...
return({struct _tuple12 _tmp241;_tmp241.f1=0,_tmp241.f2=a2;_tmp241;});}}}}}case 37: _tmp132=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;{struct Cyc_Absyn_Stmt*s=_tmp132;
# 1097
...
return({struct _tuple12 _tmp242;_tmp242.f1=t,_tmp242.f2=aout;_tmp242;});}}case 40:
 return({struct _tuple12 _tmp243;_tmp243.f1=0,_tmp243.f2=ain;_tmp243;});case 41: _tmp131=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;{struct Cyc_Absyn_Exp*e=_tmp131;
...
# 1110
return({struct _tuple12 _tmp246;({void*_tmp2D9=Cyc_AssnDef_zero();_tmp246.f1=_tmp2D9;}),_tmp246.f2=ain;_tmp246;});}default: _tmp12F=((struct Cyc_Absyn_Assert_e_Absyn_Raw_exp_struct*)_tmp12E)->f1;{struct Cyc_Absyn_Exp*e1=_tmp12F;
# 1112
struct _tuple12 _tmp1F2=Cyc_Vcgen_vcgen_test(env,e1,(void*)& Cyc_AssnDef_true_assn);struct _tuple12 _stmttmp42=_tmp1F2;struct _tuple12 _tmp1F3=_stmttmp42;void*_tmp1F4;_tmp1F4=_tmp1F3.f1;{void*at=_tmp1F4;
...
return({struct _tuple12 _tmp248;({void*_tmp2DE=Cyc_AssnDef_one();_tmp248.f1=_tmp2DE;}),({void*_tmp2DD=Cyc_AssnDef_and(ain,at);_tmp248.f2=_tmp2DD;});_tmp248;});}}};}}
# 1122
...
struct _tuple12 _tmp1FF=Cyc_Vcgen_vcgen_test(env,ens,(void*)& Cyc_AssnDef_true_assn);struct _tuple12 _stmttmp44=_tmp1FF;struct _tuple12 _tmp200=_stmttmp44;void*_tmp201;_tmp201=_tmp200.f1;{void*at=_tmp201;
