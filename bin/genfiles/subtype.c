...
# 623
Cyc_Tcutil_type_kind(t1);_T1B=_T1A->kind;_T1C=(int)_T1B;if(_T1C!=2)goto _TL18D;{struct _tuple17 _T122;_T122.f0=3U;_T122.f1=0;_T122.f2=0;_T1D=_T122;}return _T1D;_TL18D: _T1E=
...
# 718
 coerce=Cyc_Subtype_join_coercion(coerce,3U);goto _TL1C6;_TL1C5: _TL1C6: _TAC=
# 720
...
_T136.f0=Cyc_Subtype_join_coercion(coerce,3U);_T136.f1=Cyc_List_imp_append(retc,c);_T136.f2=silent;_TC7=_T136;}return _TC7;_TL1E8:;}}goto _TL1E7;_TL1E6: _TL1E7:{struct _tuple17 _T133;
# 750
