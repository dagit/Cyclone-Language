...
return({struct Cyc_Xarray_Xarray*_tmp9=_region_malloc(r,sizeof(*_tmp9));({struct _dyneither_ptr _tmp34=({unsigned _tmp8=(unsigned)len;void**_tmp7=({struct _RegionHandle*_tmp33=Cyc_Core_unique_region;_region_malloc(_tmp33,_check_times(_tmp8,sizeof(void*)));});({{unsigned _tmp28=(unsigned)len;unsigned i;for(i=0;i < _tmp28;++ i){_tmp7[i]=a;}}0;});_tag_dyneither(_tmp7,sizeof(void*),_tmp8);});_tmp9->elmts=_tmp34;}),_tmp9->num_elmts=0;_tmp9;});}
# 54
...
if((unsigned)xarr->num_elmts == _get_dyneither_size(xarr->elmts,sizeof(void*))){
if(xarr->num_elmts == 0)
({struct _dyneither_ptr _tmp37=_tag_dyneither(({unsigned _tmpD=10U;void**_tmpC=({struct _RegionHandle*_tmp36=Cyc_Core_unique_region;_region_malloc(_tmp36,_check_times(_tmpD,sizeof(void*)));});({{unsigned _tmp29=10U;unsigned i;for(i=0;i < _tmp29;++ i){_tmpC[i]=a;}}0;});_tmpC;}),sizeof(void*),10U);xarr->elmts=_tmp37;});else{
# 74
struct _dyneither_ptr newarr=({unsigned _tmp11=(unsigned)(xarr->num_elmts * 2);void**_tmp10=({struct _RegionHandle*_tmp38=Cyc_Core_unique_region;_region_malloc(_tmp38,_check_times(_tmp11,sizeof(void*)));});({{unsigned _tmp2A=(unsigned)(xarr->num_elmts * 2);unsigned i;for(i=0;i < _tmp2A;++ i){_tmp10[i]=*((void**)_check_dyneither_subscript(xarr->elmts,sizeof(void*),0));}}0;});_tag_dyneither(_tmp10,sizeof(void*),_tmp11);});
...
if(xarr->num_elmts == 0)
return _tag_dyneither(({unsigned _tmp13=0;void**_tmp12=({struct _RegionHandle*_tmp3A=r;_region_malloc(_tmp3A,_check_times(_tmp13,sizeof(void*)));});*_tmp12=0;_tmp12;}),sizeof(void*),0U);{
struct _dyneither_ptr ans=({unsigned _tmp15=(unsigned)xarr->num_elmts;void**_tmp14=({struct _RegionHandle*_tmp3B=r;_region_malloc(_tmp3B,_check_times(_tmp15,sizeof(void*)));});({{unsigned _tmp2B=(unsigned)xarr->num_elmts;unsigned i;for(i=0;i < _tmp2B;++ i){_tmp14[i]=*((void**)_check_dyneither_subscript(xarr->elmts,sizeof(void*),(int)i));}}0;});_tag_dyneither(_tmp14,sizeof(void*),_tmp15);});
return ans;};}
# 96
...
if(_get_dyneither_size(arr,sizeof(void*))== (unsigned)0)
...
struct _dyneither_ptr _tmp3D=({unsigned _tmp17=_get_dyneither_size(arr,sizeof(void*));void**_tmp16=({struct _RegionHandle*_tmp3C=Cyc_Core_unique_region;_region_malloc(_tmp3C,_check_times(_tmp17,sizeof(void*)));});({{unsigned _tmp2C=_get_dyneither_size(arr,sizeof(void*));unsigned i;for(i=0;i < _tmp2C;++ i){_tmp16[i]=((void**)arr.curr)[(int)i];}}0;});_tag_dyneither(_tmp16,sizeof(void*),_tmp17);});_tmp18->elmts=_tmp3D;}),_tmp18->num_elmts=(int)
...
if(newsz == 0)
return Cyc_Xarray_rcreate_empty(r);{
void*init=_get_dyneither_size(xarr1->elmts,sizeof(void*))== (unsigned)0?*((void**)_check_dyneither_subscript(xarr2->elmts,sizeof(void*),0)):*((void**)_check_dyneither_subscript(xarr1->elmts,sizeof(void*),0));
struct Cyc_Xarray_Xarray*ans=({struct Cyc_Xarray_Xarray*_tmp1B=_region_malloc(r,sizeof(*_tmp1B));({struct _dyneither_ptr _tmp3F=({unsigned _tmp1A=(unsigned)newsz;void**_tmp19=({struct _RegionHandle*_tmp3E=Cyc_Core_unique_region;_region_malloc(_tmp3E,_check_times(_tmp1A,sizeof(void*)));});({{unsigned _tmp2D=(unsigned)newsz;unsigned i;for(i=0;i < _tmp2D;++ i){_tmp19[i]=init;}}0;});_tag_dyneither(_tmp19,sizeof(void*),_tmp1A);});_tmp1B->elmts=_tmp3F;}),_tmp1B->num_elmts=0;_tmp1B;});
# 121
...
({struct _dyneither_ptr _tmp42=({unsigned _tmp1D=_get_dyneither_size(xarr->elmts,sizeof(void*));void**_tmp1C=({struct _RegionHandle*_tmp40=Cyc_Core_unique_region;_region_malloc(_tmp40,_check_times(_tmp1D,sizeof(void*)));});({{unsigned _tmp2E=_get_dyneither_size(xarr->elmts,sizeof(void*));unsigned i;for(i=0;i < _tmp2E;++ i){({void*_tmp41=f(*((void**)_check_dyneither_subscript(xarr->elmts,sizeof(void*),0)));_tmp1C[i]=_tmp41;});}}0;});_tag_dyneither(_tmp1C,sizeof(void*),_tmp1D);});_tmp1E->elmts=_tmp42;}),_tmp1E->num_elmts=xarr->num_elmts;_tmp1E;});
# 158
{int i=1;for(0;i < xarr->num_elmts;++ i){
...
({struct _dyneither_ptr _tmp46=({unsigned _tmp20=_get_dyneither_size(xarr->elmts,sizeof(void*));void**_tmp1F=({struct _RegionHandle*_tmp44=Cyc_Core_unique_region;_region_malloc(_tmp44,_check_times(_tmp20,sizeof(void*)));});({{unsigned _tmp2F=_get_dyneither_size(xarr->elmts,sizeof(void*));unsigned i;for(i=0;i < _tmp2F;++ i){({void*_tmp45=f(env,*((void**)_check_dyneither_subscript(xarr->elmts,sizeof(void*),0)));_tmp1F[i]=_tmp45;});}}0;});_tag_dyneither(_tmp1F,sizeof(void*),_tmp20);});_tmp21->elmts=_tmp46;}),_tmp21->num_elmts=xarr->num_elmts;_tmp21;});
# 173
{int i=1;for(0;i < xarr->num_elmts;++ i){
