...
return 0;
# 257
return dyn.curr;};}struct Cyc_Xarray_Xarray{struct _RegionHandle*r;struct
_dyneither_ptr elmts;int num_elmts;};
...
# 82
struct Cyc_Xarray_Xarray*Cyc_Xarray_rfrom_array(struct _RegionHandle*,struct
_dyneither_ptr arr);
# 86
struct Cyc_Xarray_Xarray*Cyc_Xarray_append(struct Cyc_Xarray_Xarray*,struct Cyc_Xarray_Xarray*);
# 90
struct Cyc_Xarray_Xarray*Cyc_Xarray_rappend(struct _RegionHandle*,struct Cyc_Xarray_Xarray*,
...
# 111
struct Cyc_Xarray_Xarray*Cyc_Xarray_rmap(struct _RegionHandle*,void*(*f)(void*),
struct Cyc_Xarray_Xarray*);
# 115
struct Cyc_Xarray_Xarray*Cyc_Xarray_map_c(void*(*f)(void*,void*),void*,struct Cyc_Xarray_Xarray*);
# 118
struct Cyc_Xarray_Xarray*Cyc_Xarray_rmap_c(struct _RegionHandle*,void*(*f)(void*,
void*),void*,struct Cyc_Xarray_Xarray*);
# 122
...
# 25 "/home/jgm/cyclone/lib/xarray.cyc"
...
# 31
struct Cyc_Core_Invalid_argument_exn_struct _tmp3E;const char*_tmp3D;struct Cyc_Core_Invalid_argument_exn_struct*
_tmp3C;(int)_throw((void*)((_tmp3C=_cycalloc(sizeof(*_tmp3C)),((_tmp3C[0]=((
_tmp3E.tag=Cyc_Core_Invalid_argument,((_tmp3E.f1=((_tmp3D="Xarray::get: bad index",
...
if(i < 0  || i >= xarr->num_elmts){
# 37
struct Cyc_Core_Invalid_argument_exn_struct _tmp44;const char*_tmp43;struct Cyc_Core_Invalid_argument_exn_struct*
...
# 42
void**_tmp45;struct _dyneither_ptr x=_tag_dyneither(((_tmp45=_region_malloc(r,
sizeof(void*)* 0),_tmp45)),sizeof(void*),0);
# 43
struct Cyc_Xarray_Xarray*_tmp46;return(_tmp46=_region_malloc(r,sizeof(*_tmp46)),((
_tmp46->r=r,((_tmp46->elmts=x,((_tmp46->num_elmts=0,_tmp46)))))));}
# 45
...
if(len < 0){
# 50
struct Cyc_Core_Invalid_argument_exn_struct _tmp4C;const char*_tmp4B;struct Cyc_Core_Invalid_argument_exn_struct*
_tmp4A;(int)_throw((void*)((_tmp4A=_cycalloc(sizeof(*_tmp4A)),((_tmp4A[0]=((
_tmp4C.tag=Cyc_Core_Invalid_argument,((_tmp4C.f1=((_tmp4B="xarrays must have a non-negative size buffer",
_tag_dyneither(_tmp4B,sizeof(char),45))),_tmp4C)))),_tmp4A)))));}{
# 51
unsigned int _tmp58;void**_tmp57;struct _dyneither_ptr _tmp56;unsigned int _tmp55;
unsigned int _tmp54;struct Cyc_Xarray_Xarray*_tmp53;return(_tmp53=_region_malloc(r,
sizeof(*_tmp53)),((_tmp53->r=r,((_tmp53->elmts=((_tmp58=(unsigned int)len,((
_tmp57=(void**)_region_malloc(r,_check_times(sizeof(void*),_tmp58)),((_tmp56=
_tag_dyneither(_tmp57,sizeof(void*),_tmp58),((((_tmp55=_tmp58,_tmp52(& a,& _tmp54,&
_tmp55,& _tmp57))),_tmp56)))))))),((_tmp53->num_elmts=0,_tmp53)))))));};}
# 54
struct Cyc_Xarray_Xarray*Cyc_Xarray_create(int len,void*a){
# 55
return Cyc_Xarray_rcreate(Cyc_Core_heap_region,len,a);}
# 58
struct Cyc_Xarray_Xarray*Cyc_Xarray_rsingleton(struct _RegionHandle*r,int len,void*
a){
# 59
if(len < 1){struct Cyc_Core_Invalid_argument_exn_struct _tmp5E;const char*_tmp5D;
struct Cyc_Core_Invalid_argument_exn_struct*_tmp5C;(int)_throw((void*)((_tmp5C=
...
_check_dyneither_subscript((*xarr)->elmts,sizeof(void*),0));}}
# 69
...
if(xarr->num_elmts == 0){
# 72
unsigned int _tmp62;unsigned int _tmp61;void**_tmp60;unsigned int _tmp5F;xarr->elmts=
_tag_dyneither(((_tmp5F=(unsigned int)10,((_tmp60=(void**)_region_malloc(xarr->r,
_check_times(sizeof(void*),_tmp5F)),((((_tmp61=_tmp5F,_tmp63(& a,& _tmp62,& _tmp61,&
_tmp60))),_tmp60)))))),sizeof(void*),(unsigned int)10);}else{
# 74
unsigned int _tmp68;unsigned int _tmp67;struct _dyneither_ptr _tmp66;void**_tmp65;
unsigned int _tmp64;struct _dyneither_ptr newarr=(_tmp64=(unsigned int)(xarr->num_elmts
* 2),((_tmp65=(void**)_region_malloc(xarr->r,_check_times(sizeof(void*),_tmp64)),((
_tmp66=_tag_dyneither(_tmp65,sizeof(void*),_tmp64),((((_tmp67=_tmp64,_tmp69(&
xarr,& _tmp68,& _tmp67,& _tmp65))),_tmp66)))))));
# 75
{int i=1;for(0;i < xarr->num_elmts;++ i){
# 76
*((void**)_check_dyneither_subscript(newarr,sizeof(void*),i))=*((void**)
_check_dyneither_subscript(xarr->elmts,sizeof(void*),i));}}
# 77
xarr->elmts=newarr;}}
# 80
...
# 85
return xarr->num_elmts - 1;}struct _dyneither_ptr Cyc_Xarray_rto_array(struct
_RegionHandle*r,struct Cyc_Xarray_Xarray*xarr);static void _tmp70(struct Cyc_Xarray_Xarray**
xarr,unsigned int*_tmp6F,unsigned int*_tmp6E,void***_tmp6C){for(*_tmp6F=0;*
_tmp6F < *_tmp6E;(*_tmp6F)++){(*_tmp6C)[*_tmp6F]=*((void**)
_check_dyneither_subscript((*xarr)->elmts,sizeof(void*),(int)*_tmp6F));}}
# 88
struct _dyneither_ptr Cyc_Xarray_rto_array(struct _RegionHandle*r,struct Cyc_Xarray_Xarray*
xarr){
# 89
if(xarr->num_elmts == 0){
# 90
void**_tmp6A;return _tag_dyneither(((_tmp6A=_region_malloc(r,sizeof(void*)* 0),
_tmp6A)),sizeof(void*),0);}{
# 91
unsigned int _tmp6F;unsigned int _tmp6E;struct _dyneither_ptr _tmp6D;void**_tmp6C;
unsigned int _tmp6B;struct _dyneither_ptr ans=(_tmp6B=(unsigned int)xarr->num_elmts,((
...
arr).curr)[(int)*_tmp75];}}
# 99
struct Cyc_Xarray_Xarray*Cyc_Xarray_rfrom_array(struct _RegionHandle*r,struct
_dyneither_ptr arr){
# 100
...
_tmp77=_region_malloc(r,sizeof(*_tmp77)),((_tmp77->r=r,((_tmp77->elmts=(
# 103
(_tmp7C=_get_dyneither_size(arr,sizeof(void*)),((_tmp7B=(void**)_region_malloc(
r,_check_times(sizeof(void*),_tmp7C)),((_tmp7A=_tag_dyneither(_tmp7B,sizeof(void*),
_tmp7C),((((_tmp79=_tmp7C,_tmp76(& arr,& _tmp78,& _tmp79,& _tmp7B))),_tmp7A)))))))),((
_tmp77->num_elmts=(int)
# 104
...
xarr1,struct Cyc_Xarray_Xarray*xarr2){
# 114
int newsz=(int)(_get_dyneither_size(xarr1->elmts,sizeof(void*))+ 
_get_dyneither_size(xarr2->elmts,sizeof(void*)));
# 115
if(newsz == 0)
# 116
return Cyc_Xarray_rcreate_empty(r);{
# 117
void*init=_get_dyneither_size(xarr1->elmts,sizeof(void*))== 0?*((void**)
_check_dyneither_subscript(xarr2->elmts,sizeof(void*),0)):*((void**)
_check_dyneither_subscript(xarr1->elmts,sizeof(void*),0));
# 118
...
# 121
Cyc_Xarray_add(ans,*((void**)_check_dyneither_subscript(xarr1->elmts,sizeof(
void*),i)));}}
# 122
{int i=0;for(0;i < xarr2->num_elmts;++ i){
# 123
Cyc_Xarray_add(ans,*((void**)_check_dyneither_subscript(xarr2->elmts,sizeof(
void*),i)));}}
# 124
return ans;};}
# 127
struct Cyc_Xarray_Xarray*Cyc_Xarray_append(struct Cyc_Xarray_Xarray*xarr1,struct
Cyc_Xarray_Xarray*xarr2){
# 128
...
struct Cyc_Xarray_Xarray*xarr);static void _tmp8E(struct Cyc_Xarray_Xarray**xarr,
void*(**f)(void*),unsigned int*_tmp8D,unsigned int*_tmp8C,void***_tmp8A){for(*
_tmp8D=0;*_tmp8D < *_tmp8C;(*_tmp8D)++){(*_tmp8A)[*_tmp8D]=
# 156
...
# 154
unsigned int _tmp94;void**_tmp93;struct _dyneither_ptr _tmp92;unsigned int _tmp91;
unsigned int _tmp90;struct Cyc_Xarray_Xarray*_tmp8F;struct Cyc_Xarray_Xarray*ans=
# 155
(_tmp8F=_region_malloc(r,sizeof(*_tmp8F)),((_tmp8F->r=r,((_tmp8F->elmts=(
# 156
(_tmp94=_get_dyneither_size(xarr->elmts,sizeof(void*)),((_tmp93=(void**)
_region_malloc(r,_check_times(sizeof(void*),_tmp94)),((_tmp92=_tag_dyneither(
_tmp93,sizeof(void*),_tmp94),((((_tmp91=_tmp94,_tmp8E(& xarr,& f,& _tmp90,& _tmp91,&
_tmp93))),_tmp92)))))))),((_tmp8F->num_elmts=xarr->num_elmts,_tmp8F)))))));
# 158
{int i=1;for(0;i < xarr->num_elmts;++ i){
# 159
*((void**)_check_dyneither_subscript(ans->elmts,sizeof(void*),i))=f(*((void**)
_check_dyneither_subscript(xarr->elmts,sizeof(void*),i)));}}
# 160
return ans;};}
# 163
...
xarr);static void _tmp9A(struct Cyc_Xarray_Xarray**xarr,void*(**f)(void*,void*),
void**env,unsigned int*_tmp99,unsigned int*_tmp98,void***_tmp96){for(*_tmp99=0;*
_tmp99 < *_tmp98;(*_tmp99)++){(*_tmp96)[*_tmp99]=
# 171
...
void*),void*env,struct Cyc_Xarray_Xarray*xarr){
# 168
if(xarr->num_elmts == 0)return Cyc_Xarray_rcreate_empty(r);{
# 170
...
# 171
(_tmp9B=_region_malloc(r,sizeof(*_tmp9B)),((_tmp9B->r=r,((_tmp9B->elmts=((
_tmpA0=_get_dyneither_size(xarr->elmts,sizeof(void*)),((_tmp9F=(void**)
_region_malloc(r,_check_times(sizeof(void*),_tmpA0)),((_tmp9E=_tag_dyneither(
_tmp9F,sizeof(void*),_tmpA0),((((_tmp9D=_tmpA0,_tmp9A(& xarr,& f,& env,& _tmp9C,&
_tmp9D,& _tmp9F))),_tmp9E)))))))),((_tmp9B->num_elmts=xarr->num_elmts,_tmp9B)))))));
# 173
{int i=1;for(0;i < xarr->num_elmts;++ i){
# 174
*((void**)_check_dyneither_subscript(ans->elmts,sizeof(void*),i))=f(env,*((void**)
_check_dyneither_subscript(xarr->elmts,sizeof(void*),i)));}}
# 175
return ans;};}
# 178
struct Cyc_Xarray_Xarray*Cyc_Xarray_map_c(void*(*f)(void*,void*),void*env,struct
Cyc_Xarray_Xarray*xarr){
# 179
...
# 188
struct Cyc_Core_Invalid_argument_exn_struct _tmpA6;const char*_tmpA5;struct Cyc_Core_Invalid_argument_exn_struct*
_tmpA4;(int)_throw((void*)((_tmpA4=_cycalloc(sizeof(*_tmpA4)),((_tmpA4[0]=((
_tmpA6.tag=Cyc_Core_Invalid_argument,((_tmpA6.f1=((_tmpA5="number deleted is greater than length of xarray",
_tag_dyneither(_tmpA5,sizeof(char),48))),_tmpA6)))),_tmpA4)))));}
# 189
xarr->num_elmts -=num;}
# 192
void Cyc_Xarray_remove(struct Cyc_Xarray_Xarray*xarr,int i){
...
# 194
struct Cyc_Core_Invalid_argument_exn_struct _tmpAC;const char*_tmpAB;struct Cyc_Core_Invalid_argument_exn_struct*
_tmpAA;(int)_throw((void*)((_tmpAA=_cycalloc(sizeof(*_tmpAA)),((_tmpAA[0]=((
_tmpAC.tag=Cyc_Core_Invalid_argument,((_tmpAC.f1=((_tmpAB="xarray index out of bounds",
_tag_dyneither(_tmpAB,sizeof(char),27))),_tmpAC)))),_tmpAA)))));}
# 195
{int j=i;for(0;j < xarr->num_elmts - 2;++ j){
# 196
*((void**)_check_dyneither_subscript(xarr->elmts,sizeof(void*),j))=*((void**)
_check_dyneither_subscript(xarr->elmts,sizeof(void*),j + 1));}}
# 197
-- xarr->num_elmts;}
