...
# 47
void Cyc_Toc_finish();struct Cyc_RgnOrder_RgnPO;
# 32 "rgnorder.h"
...
struct _fat_ptr _tmp92=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp89.f1=_tmp92;});_tmp89;});void*_tmp5[1U];_tmp5[0]=& _tmp7;({struct _fat_ptr _tmp93=({const char*_tmp6="remove_aggrs_exp -- unexpected array or comprehension: %s";_tag_fat(_tmp6,sizeof(char),58U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp93,_tag_fat(_tmp5,sizeof(void*),1U));});});}struct _tuple15{struct Cyc_List_List*f1;struct Cyc_Absyn_Exp*f2;};
# 99
...
({void*_tmp12=0U;({struct _fat_ptr _tmp97=({const char*_tmp13="removeAggrs: toc did not set a new-destination";_tag_fat(_tmp13,sizeof(char),47U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp97,_tag_fat(_tmp12,sizeof(void*),0U));});});}_LL41:;}
# 134
...
struct _tuple15*_tmp17=(struct _tuple15*)_tmp16->hd;struct _tuple15*_tmp18=_tmp17;struct Cyc_List_List*_tmp1C;struct Cyc_Absyn_Exp*_tmp1B;_LL47: _tmp1C=_tmp18->f1;_tmp1B=_tmp18->f2;_LL48:;{
struct _fat_ptr*_tmp19=Cyc_Absyn_designatorlist_to_fieldname(_tmp1C);
...
# 160
if(_tmp38 == 0)
({void*_tmp1D=0U;({struct _fat_ptr _tmp9B=({const char*_tmp1E="zero-field aggregate";_tag_fat(_tmp1E,sizeof(char),21U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmp9B,_tag_fat(_tmp1D,sizeof(void*),0U));});});{
struct Cyc_Absyn_Exp*init_e=(*((struct _tuple15*)_tmp38->hd)).f2;
for(_tmp38=_tmp38->tl;_tmp38 != 0;_tmp38=_tmp38->tl){
init_e=Cyc_Absyn_seq_exp(init_e,(*((struct _tuple15*)_tmp38->hd)).f2,0U);}
if(do_stmt_exp){
void*(*_tmp1F)(struct _tuple0*name)=(unsigned)_tmp37 &&(int)_tmp37->kind == (int)Cyc_Absyn_UnionA?Cyc_Absyn_unionq_type: Cyc_Absyn_strctq;
...
({void*_tmp22=0U;({struct _fat_ptr _tmpA1=({const char*_tmp23="remove-aggrs: Array_e in bad position";_tag_fat(_tmp23,sizeof(char),38U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmpA1,_tag_fat(_tmp22,sizeof(void*),0U));});});}else{_LL4C: _LL4D:
 goto _LL49;}_LL49:;}
# 188
did_assign=1;{
...
# 195
struct _tuple15*_tmp25=(struct _tuple15*)_tmp24->hd;struct _tuple15*_tmp26=_tmp25;struct Cyc_Absyn_Exp*_tmp28;_LL4F: _tmp28=_tmp26->f2;_LL50:;{
...
# 199
struct Cyc_Absyn_Exp*init_e=(*((struct _tuple15*)_tmp3A->hd)).f2;
for(_tmp3A=_tmp3A->tl;_tmp3A != 0;_tmp3A=_tmp3A->tl){
init_e=Cyc_Absyn_seq_exp(init_e,(*((struct _tuple15*)_tmp3A->hd)).f2,0U);}
e->r=init_e->r;
e->topt=0;
...
({void*_tmp2B=0U;({struct _fat_ptr _tmpA4=({const char*_tmp2C="remove-aggrs: comprehension in bad position";_tag_fat(_tmp2C,sizeof(char),44U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmpA4,_tag_fat(_tmp2B,sizeof(void*),0U));});});}else{_LL54: _LL55:
 goto _LL51;}_LL51:;}{
# 214
...
({void*_tmp2F=0U;({struct _fat_ptr _tmpB5=({const char*_tmp30="remove-aggrs: no-init-comp in bad position";_tag_fat(_tmp30,sizeof(char),43U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmpB5,_tag_fat(_tmp2F,sizeof(void*),0U));});});}else{_LL59: _LL5A:
 goto _LL56;}_LL56:;}
# 250
*e=*_tmp3F;
...
struct _fat_ptr _tmpB7=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(e));_tmp8F.f1=_tmpB7;});_tmp8F;});void*_tmp32[1U];_tmp32[0]=& _tmp34;({struct _fat_ptr _tmpB8=({const char*_tmp33="bad exp after translation to C: %s";_tag_fat(_tmp33,sizeof(char),35U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmpB8,_tag_fat(_tmp32,sizeof(void*),1U));});});}_LL0:;}
# 305
...
({void*_tmp61=0U;({struct _fat_ptr _tmpC2=({const char*_tmp62="bad local declaration after xlation to C";_tag_fat(_tmp62,sizeof(char),41U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmpC2,_tag_fat(_tmp61,sizeof(void*),0U));});});}_LL1F:;}
# 383
return;default: _LL1D: _LL1E:
({void*_tmp65=0U;({struct _fat_ptr _tmpC3=({const char*_tmp66="bad stmt after xlation to C";_tag_fat(_tmp66,sizeof(char),28U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmpC3,_tag_fat(_tmp65,sizeof(void*),0U));});});}_LL0:;}
# 388
...
({void*_tmp7E=0U;({struct _fat_ptr _tmpC4=({const char*_tmp7F="Cyclone decl after xlation to C";_tag_fat(_tmp7F,sizeof(char),32U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmpC4,_tag_fat(_tmp7E,sizeof(void*),0U));});});case 9U: _LL13: _tmp85=((struct Cyc_Absyn_Namespace_d_Absyn_Raw_decl_struct*)_tmp7D)->f2;_LL14:
...
# 408
({void*_tmp80=0U;({struct _fat_ptr _tmpC5=({const char*_tmp81="nested translation unit after xlation to C";_tag_fat(_tmp81,sizeof(char),43U);});((int(*)(struct _fat_ptr fmt,struct _fat_ptr ap))Cyc_Warn_impos)(_tmpC5,_tag_fat(_tmp80,sizeof(void*),0U));});});}_LL0:;}}
# 410
return ds;}
