...
struct Cyc_RemoveAggrs_Result _stmttmpB=({struct Cyc_RemoveAggrs_Env _Tmp7=({struct Cyc_RemoveAggrs_Env _Tmp8;_Tmp8.ctxt=0U,_Tmp8.dest=var_exp;_Tmp8;});Cyc_RemoveAggrs_remove_aggrs_exp(_Tmp7,
