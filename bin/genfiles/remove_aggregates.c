...
dles=({struct Cyc_List_List*_tmpE=_cycalloc(sizeof(*_tmpE));({struct _tuple11*_tmp94=({struct _tuple11*_tmpD=_cycalloc(sizeof(*_tmpD));_tmpD->f1=0,_tmpD->f2=_tmpC;_tmpD;});_tmpE->hd=_tmp94;}),_tmpE->tl=dles;_tmpE;});}}
# 114
...
struct _tuple11*_tmp17=(struct _tuple11*)_tmp16->hd;struct _tuple11*_tmp18=_tmp17;struct Cyc_List_List*_tmp1C;struct Cyc_Absyn_Exp*_tmp1B;_LL47: _tmp1C=_tmp18->f1;_tmp1B=_tmp18->f2;_LL48:;{
...
struct Cyc_Absyn_Exp*init_e=(*((struct _tuple11*)_tmp38->hd)).f2;
for(_tmp38=_tmp38->tl;_tmp38 != 0;_tmp38=_tmp38->tl){
init_e=Cyc_Absyn_seq_exp(init_e,(*((struct _tuple11*)_tmp38->hd)).f2,0U);}
if(do_stmt_exp){
...
# 195
struct _tuple11*_tmp25=(struct _tuple11*)_tmp24->hd;struct _tuple11*_tmp26=_tmp25;struct Cyc_Absyn_Exp*_tmp28;_LL4F: _tmp28=_tmp26->f2;_LL50:;{
...
# 199
struct Cyc_Absyn_Exp*init_e=(*((struct _tuple11*)_tmp3A->hd)).f2;
for(_tmp3A=_tmp3A->tl;_tmp3A != 0;_tmp3A=_tmp3A->tl){
init_e=Cyc_Absyn_seq_exp(init_e,(*((struct _tuple11*)_tmp3A->hd)).f2,0U);}
e->r=init_e->r;
e->topt=0;
