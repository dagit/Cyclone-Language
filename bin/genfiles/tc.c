...
# 306
({struct Cyc_Warn_String_Warn_Warg_struct _tmp9D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp204;_tmp204.tag=0U,({struct _fat_ptr _tmp2B6=({const char*_tmpA1="second argument of main has type ";_tag_fat(_tmpA1,sizeof(char),34U);});_tmp204.f1=_tmp2B6;});_tmp204;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp9E=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp203;_tmp203.tag=2U,_tmp203.f1=(void*)t2;_tmp203;});struct Cyc_Warn_String_Warn_Warg_struct _tmp9F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp202;_tmp202.tag=0U,({
struct _fat_ptr _tmp2B7=({const char*_tmpA0=" instead of char??";_tag_fat(_tmpA0,sizeof(char),19U);});_tmp202.f1=_tmp2B7;});_tmp202;});void*_tmp9C[3U];_tmp9C[0]=& _tmp9D,_tmp9C[1]=& _tmp9E,_tmp9C[2]=& _tmp9F;({unsigned _tmp2B8=loc;Cyc_Warn_err2(_tmp2B8,_tag_fat(_tmp9C,sizeof(void*),3U));});});}}}}}}}}}}
# 314
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpA5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp206;_tmp206.tag=0U,({struct _fat_ptr _tmp2B9=({const char*_tmpA7="redeclaration of typedef ";_tag_fat(_tmpA7,sizeof(char),26U);});_tmp206.f1=_tmp2B9;});_tmp206;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpA6=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp205;_tmp205.tag=1U,_tmp205.f1=q;_tmp205;});void*_tmpA4[2U];_tmpA4[0]=& _tmpA5,_tmpA4[1]=& _tmpA6;({unsigned _tmp2BA=loc;Cyc_Warn_err2(_tmp2BA,_tag_fat(_tmpA4,sizeof(void*),2U));});});
return;}
# 325
...
# 337
if(td->defn != 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpAE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp209;_tmp209.tag=0U,({struct _fat_ptr _tmp2BC=({const char*_tmpB2="type variable ";_tag_fat(_tmpB2,sizeof(char),15U);});_tmp209.f1=_tmp2BC;});_tmp209;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmpAF=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp208;_tmp208.tag=7U,_tmp208.f1=(struct Cyc_Absyn_Tvar*)tvs->hd;_tmp208;});struct Cyc_Warn_String_Warn_Warg_struct _tmpB0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp207;_tmp207.tag=0U,({struct _fat_ptr _tmp2BD=({const char*_tmpB1=" is not used in typedef";_tag_fat(_tmpB1,sizeof(char),24U);});_tmp207.f1=_tmp2BD;});_tmp207;});void*_tmpAD[3U];_tmpAD[0]=& _tmpAE,_tmpAD[1]=& _tmpAF,_tmpAD[2]=& _tmpB0;({unsigned _tmp2BE=loc;Cyc_Warn_warn2(_tmp2BE,_tag_fat(_tmpAD,sizeof(void*),3U));});});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpC4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp20B;_tmp20B.tag=0U,({struct _fat_ptr _tmp2C4=({const char*_tmpC6="duplicate member ";_tag_fat(_tmpC6,sizeof(char),18U);});_tmp20B.f1=_tmp2C4;});_tmp20B;});struct Cyc_Warn_String_Warn_Warg_struct _tmpC5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp20A;_tmp20A.tag=0U,_tmp20A.f1=*fn;_tmp20A;});void*_tmpC3[2U];_tmpC3[0]=& _tmpC4,_tmpC3[1]=& _tmpC5;({unsigned _tmp2C5=loc;Cyc_Warn_err2(_tmp2C5,_tag_fat(_tmpC3,sizeof(void*),2U));});});
# 379
...
if((int)str_or_union != (int)1U)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpCA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp20C;_tmp20C.tag=0U,({struct _fat_ptr _tmp2C8=({const char*_tmpCB="@requires clauses are allowed only on union members";_tag_fat(_tmpCB,sizeof(char),52U);});_tmp20C.f1=_tmp2C8;});_tmp20C;});void*_tmpC9[1U];_tmpC9[0]=& _tmpCA;({unsigned _tmp2C9=loc;Cyc_Warn_err2(_tmp2C9,_tag_fat(_tmpC9,sizeof(void*),1U));});});{
...
struct _fat_ptr _tmp2CB=({const char*_tmpD1=" instead of integral type";_tag_fat(_tmpD1,sizeof(char),26U);});_tmp20D.f1=_tmp2CB;});_tmp20D;});void*_tmpCD[3U];_tmpCD[0]=& _tmpCE,_tmpCD[1]=& _tmpCF,_tmpCD[2]=& _tmpD0;({unsigned _tmp2CC=requires_clause->loc;Cyc_Warn_err2(_tmp2CC,_tag_fat(_tmpCD,sizeof(void*),3U));});});else{
# 406
...
struct _fat_ptr _tmp2D2=({const char*_tmpDB="@requires clause may overlap with previous clauses";_tag_fat(_tmpDB,sizeof(char),51U);});_tmp211.f1=_tmp2D2;});_tmp211;});void*_tmpD9[1U];_tmpD9[0]=& _tmpDA;({unsigned _tmp2D3=requires_clause->loc;Cyc_Warn_err2(_tmp2D3,_tag_fat(_tmpD9,sizeof(void*),1U));});});}}
...
# 447
({struct Cyc_Warn_String_Warn_Warg_struct _tmpF2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp218;_tmp218.tag=0U,({struct _fat_ptr _tmp2E0=({const char*_tmpFB="type ";_tag_fat(_tmpFB,sizeof(char),6U);});_tmp218.f1=_tmp2E0;});_tmp218;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmpF3=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp217;_tmp217.tag=1U,_tmp217.f1=n;_tmp217;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp216;_tmp216.tag=0U,({struct _fat_ptr _tmp2E1=({const char*_tmpFA=" attempts to abstract type variable ";_tag_fat(_tmpFA,sizeof(char),37U);});_tmp216.f1=_tmp2E1;});_tmp216;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmpF5=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp215;_tmp215.tag=7U,_tmp215.f1=(struct Cyc_Absyn_Tvar*)tvs2->hd;_tmp215;});struct Cyc_Warn_String_Warn_Warg_struct _tmpF6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp214;_tmp214.tag=0U,({
struct _fat_ptr _tmp2E2=({const char*_tmpF9=" of kind ";_tag_fat(_tmpF9,sizeof(char),10U);});_tmp214.f1=_tmp2E2;});_tmp214;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmpF7=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp213;_tmp213.tag=9U,({struct Cyc_Absyn_Kind*_tmp2E3=({struct Cyc_Absyn_Kind*_tmpF8=_cycalloc(sizeof(*_tmpF8));_tmpF8->kind=Cyc_Absyn_MemKind,_tmpF8->aliasqual=a;_tmpF8;});_tmp213.f1=_tmp2E3;});_tmp213;});void*_tmpF1[6U];_tmpF1[0]=& _tmpF2,_tmpF1[1]=& _tmpF3,_tmpF1[2]=& _tmpF4,_tmpF1[3]=& _tmpF5,_tmpF1[4]=& _tmpF6,_tmpF1[5]=& _tmpF7;({unsigned _tmp2E4=loc;Cyc_Warn_err2(_tmp2E4,_tag_fat(_tmpF1,sizeof(void*),6U));});});
...
# 467
({struct Cyc_Warn_String_Warn_Warg_struct _tmp10C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp21D;_tmp21D.tag=0U,({struct _fat_ptr _tmp2EB=({const char*_tmp113="type ";_tag_fat(_tmp113,sizeof(char),6U);});_tmp21D.f1=_tmp2EB;});_tmp21D;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp10D=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp21C;_tmp21C.tag=1U,_tmp21C.f1=q;_tmp21C;});struct Cyc_Warn_String_Warn_Warg_struct _tmp10E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp21B;_tmp21B.tag=0U,({struct _fat_ptr _tmp2EC=({const char*_tmp112=" attempts to abstract type variable ";_tag_fat(_tmp112,sizeof(char),37U);});_tmp21B.f1=_tmp2EC;});_tmp21B;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp10F=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp21A;_tmp21A.tag=7U,_tmp21A.f1=(struct Cyc_Absyn_Tvar*)tvs2->hd;_tmp21A;});struct Cyc_Warn_String_Warn_Warg_struct _tmp110=({struct Cyc_Warn_String_Warn_Warg_struct _tmp219;_tmp219.tag=0U,({
struct _fat_ptr _tmp2ED=({const char*_tmp111=" of kind TR";_tag_fat(_tmp111,sizeof(char),12U);});_tmp219.f1=_tmp2ED;});_tmp219;});void*_tmp10B[5U];_tmp10B[0]=& _tmp10C,_tmp10B[1]=& _tmp10D,_tmp10B[2]=& _tmp10E,_tmp10B[3]=& _tmp10F,_tmp10B[4]=& _tmp110;({unsigned _tmp2EE=loc;Cyc_Warn_err2(_tmp2EE,_tag_fat(_tmp10B,sizeof(void*),5U));});});goto _LL0;case Cyc_Absyn_Unique: goto _LL11;default: goto _LL15;}else{if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmpFD)->f1)->aliasqual == Cyc_Absyn_Unique){_LL11: _tmpFF=(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmpFD)->f1)->kind;_LL12: {enum Cyc_Absyn_KindQual k=_tmpFF;
# 471
({struct Cyc_Warn_String_Warn_Warg_struct _tmp115=({struct Cyc_Warn_String_Warn_Warg_struct _tmp223;_tmp223.tag=0U,({struct _fat_ptr _tmp2EF=({const char*_tmp11E="type ";_tag_fat(_tmp11E,sizeof(char),6U);});_tmp223.f1=_tmp2EF;});_tmp223;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp116=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp222;_tmp222.tag=1U,_tmp222.f1=q;_tmp222;});struct Cyc_Warn_String_Warn_Warg_struct _tmp117=({struct Cyc_Warn_String_Warn_Warg_struct _tmp221;_tmp221.tag=0U,({struct _fat_ptr _tmp2F0=({const char*_tmp11D=" attempts to abstract type variable ";_tag_fat(_tmp11D,sizeof(char),37U);});_tmp221.f1=_tmp2F0;});_tmp221;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp118=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp220;_tmp220.tag=7U,_tmp220.f1=(struct Cyc_Absyn_Tvar*)tvs2->hd;_tmp220;});struct Cyc_Warn_String_Warn_Warg_struct _tmp119=({struct Cyc_Warn_String_Warn_Warg_struct _tmp21F;_tmp21F.tag=0U,({
struct _fat_ptr _tmp2F1=({const char*_tmp11C=" of kind ";_tag_fat(_tmp11C,sizeof(char),10U);});_tmp21F.f1=_tmp2F1;});_tmp21F;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmp11A=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp21E;_tmp21E.tag=9U,({struct Cyc_Absyn_Kind*_tmp2F2=({struct Cyc_Absyn_Kind*_tmp11B=_cycalloc(sizeof(*_tmp11B));_tmp11B->kind=k,_tmp11B->aliasqual=Cyc_Absyn_Unique;_tmp11B;});_tmp21E.f1=_tmp2F2;});_tmp21E;});void*_tmp114[6U];_tmp114[0]=& _tmp115,_tmp114[1]=& _tmp116,_tmp114[2]=& _tmp117,_tmp114[3]=& _tmp118,_tmp114[4]=& _tmp119,_tmp114[5]=& _tmp11A;({unsigned _tmp2F3=loc;Cyc_Warn_err2(_tmp2F3,_tag_fat(_tmp114,sizeof(void*),6U));});});goto _LL0;}}else{if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmpFD)->f1)->kind == Cyc_Absyn_MemKind){_LL13: _tmpFE=(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmpFD)->f1)->aliasqual;_LL14: {enum Cyc_Absyn_AliasQual a=_tmpFE;
# 474
({struct Cyc_Warn_String_Warn_Warg_struct _tmp120=({struct Cyc_Warn_String_Warn_Warg_struct _tmp229;_tmp229.tag=0U,({struct _fat_ptr _tmp2F4=({const char*_tmp129="type ";_tag_fat(_tmp129,sizeof(char),6U);});_tmp229.f1=_tmp2F4;});_tmp229;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp121=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp228;_tmp228.tag=1U,_tmp228.f1=q;_tmp228;});struct Cyc_Warn_String_Warn_Warg_struct _tmp122=({struct Cyc_Warn_String_Warn_Warg_struct _tmp227;_tmp227.tag=0U,({struct _fat_ptr _tmp2F5=({const char*_tmp128=" attempts to abstract type variable ";_tag_fat(_tmp128,sizeof(char),37U);});_tmp227.f1=_tmp2F5;});_tmp227;});struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp123=({struct Cyc_Warn_Tvar_Warn_Warg_struct _tmp226;_tmp226.tag=7U,_tmp226.f1=(struct Cyc_Absyn_Tvar*)tvs2->hd;_tmp226;});struct Cyc_Warn_String_Warn_Warg_struct _tmp124=({struct Cyc_Warn_String_Warn_Warg_struct _tmp225;_tmp225.tag=0U,({
struct _fat_ptr _tmp2F6=({const char*_tmp127=" of kind ";_tag_fat(_tmp127,sizeof(char),10U);});_tmp225.f1=_tmp2F6;});_tmp225;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmp125=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp224;_tmp224.tag=9U,({struct Cyc_Absyn_Kind*_tmp2F7=({struct Cyc_Absyn_Kind*_tmp126=_cycalloc(sizeof(*_tmp126));_tmp126->kind=Cyc_Absyn_MemKind,_tmp126->aliasqual=a;_tmp126;});_tmp224.f1=_tmp2F7;});_tmp224;});void*_tmp11F[6U];_tmp11F[0]=& _tmp120,_tmp11F[1]=& _tmp121,_tmp11F[2]=& _tmp122,_tmp11F[3]=& _tmp123,_tmp11F[4]=& _tmp124,_tmp11F[5]=& _tmp125;({unsigned _tmp2F8=loc;Cyc_Warn_err2(_tmp2F8,_tag_fat(_tmp11F,sizeof(void*),6U));});});goto _LL0;}}else{_LL15: _LL16:
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp13B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp22A;_tmp22A.tag=0U,({struct _fat_ptr _tmp2FF=({const char*_tmp13C="@tagged is allowed only on union declarations";_tag_fat(_tmp13C,sizeof(char),46U);});_tmp22A.f1=_tmp2FF;});_tmp22A;});void*_tmp13A[1U];_tmp13A[0]=& _tmp13B;({unsigned _tmp300=loc;Cyc_Warn_err2(_tmp300,_tag_fat(_tmp13A,sizeof(void*),1U));});});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp13E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp231;_tmp231.tag=0U,({struct _fat_ptr _tmp306=({const char*_tmp148="member ";_tag_fat(_tmp148,sizeof(char),8U);});_tmp231.f1=_tmp306;});_tmp231;});struct Cyc_Warn_String_Warn_Warg_struct _tmp13F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp230;_tmp230.tag=0U,_tmp230.f1=*((struct Cyc_Absyn_Aggrfield*)f->hd)->name;_tmp230;});struct Cyc_Warn_String_Warn_Warg_struct _tmp140=({struct Cyc_Warn_String_Warn_Warg_struct _tmp22F;_tmp22F.tag=0U,({struct _fat_ptr _tmp307=({const char*_tmp147=" of union ";_tag_fat(_tmp147,sizeof(char),11U);});_tmp22F.f1=_tmp307;});_tmp22F;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp141=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp22E;_tmp22E.tag=1U,_tmp22E.f1=q;_tmp22E;});struct Cyc_Warn_String_Warn_Warg_struct _tmp142=({struct Cyc_Warn_String_Warn_Warg_struct _tmp22D;_tmp22D.tag=0U,({struct _fat_ptr _tmp308=({const char*_tmp146=" has type ";_tag_fat(_tmp146,sizeof(char),11U);});_tmp22D.f1=_tmp308;});_tmp22D;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp143=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp22C;_tmp22C.tag=2U,_tmp22C.f1=(void*)((struct Cyc_Absyn_Aggrfield*)f->hd)->type;_tmp22C;});struct Cyc_Warn_String_Warn_Warg_struct _tmp144=({struct Cyc_Warn_String_Warn_Warg_struct _tmp22B;_tmp22B.tag=0U,({
struct _fat_ptr _tmp309=({const char*_tmp145=" so it can only be written and not read";_tag_fat(_tmp145,sizeof(char),40U);});_tmp22B.f1=_tmp309;});_tmp22B;});void*_tmp13D[7U];_tmp13D[0]=& _tmp13E,_tmp13D[1]=& _tmp13F,_tmp13D[2]=& _tmp140,_tmp13D[3]=& _tmp141,_tmp13D[4]=& _tmp142,_tmp13D[5]=& _tmp143,_tmp13D[6]=& _tmp144;({unsigned _tmp30A=loc;Cyc_Warn_warn2(_tmp30A,_tag_fat(_tmp13D,sizeof(void*),7U));});});}}
*adp=ad;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp14C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp232;_tmp232.tag=0U,({struct _fat_ptr _tmp30B=({const char*_tmp14D="cannot reuse struct names for unions and vice-versa";_tag_fat(_tmp14D,sizeof(char),52U);});_tmp232.f1=_tmp30B;});_tmp232;});void*_tmp14B[1U];_tmp14B[0]=& _tmp14C;({unsigned _tmp30C=loc;Cyc_Warn_err2(_tmp30C,_tag_fat(_tmp14B,sizeof(void*),1U));});});{
# 543
...
# 554
if(tagged &&(int)ad->kind == (int)Cyc_Absyn_StructA)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp151=({struct Cyc_Warn_String_Warn_Warg_struct _tmp233;_tmp233.tag=0U,({struct _fat_ptr _tmp30E=({const char*_tmp152="@tagged is allowed only on union declarations";_tag_fat(_tmp152,sizeof(char),46U);});_tmp233.f1=_tmp30E;});_tmp233;});void*_tmp150[1U];_tmp150[0]=& _tmp151;({unsigned _tmp30F=loc;Cyc_Warn_err2(_tmp30F,_tag_fat(_tmp150,sizeof(void*),1U));});});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp157=({struct Cyc_Warn_String_Warn_Warg_struct _tmp236;_tmp236.tag=0U,({struct _fat_ptr _tmp315=({const char*_tmp159="noalias pointers in datatypes are not allowed: ";_tag_fat(_tmp159,sizeof(char),48U);});_tmp236.f1=_tmp315;});_tmp236;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp158=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp235;_tmp235.tag=1U,_tmp235.f1=f->name;_tmp235;});void*_tmp156[2U];_tmp156[0]=& _tmp157,_tmp156[1]=& _tmp158;({unsigned _tmp316=f->loc;Cyc_Warn_err2(_tmp316,_tag_fat(_tmp156,sizeof(void*),2U));});});
# 590
({int _tmp317=
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp15F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp23A;_tmp23A.tag=0U,({struct _fat_ptr _tmp318=({const char*_tmp164="duplicate field ";_tag_fat(_tmp164,sizeof(char),17U);});_tmp23A.f1=_tmp318;});_tmp23A;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp160=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp239;_tmp239.tag=1U,_tmp239.f1=f->name;_tmp239;});struct Cyc_Warn_String_Warn_Warg_struct _tmp161=({struct Cyc_Warn_String_Warn_Warg_struct _tmp238;_tmp238.tag=0U,({struct _fat_ptr _tmp319=({const char*_tmp163=" in ";_tag_fat(_tmp163,sizeof(char),5U);});_tmp238.f1=_tmp319;});_tmp238;});struct Cyc_Warn_String_Warn_Warg_struct _tmp162=({struct Cyc_Warn_String_Warn_Warg_struct _tmp237;_tmp237.tag=0U,_tmp237.f1=obj;_tmp237;});void*_tmp15E[4U];_tmp15E[0]=& _tmp15F,_tmp15E[1]=& _tmp160,_tmp15E[2]=& _tmp161,_tmp15E[3]=& _tmp162;({unsigned _tmp31A=f->loc;Cyc_Warn_err2(_tmp31A,_tag_fat(_tmp15E,sizeof(void*),4U));});});else{
# 610
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp167=({struct Cyc_Warn_String_Warn_Warg_struct _tmp23C;_tmp23C.tag=0U,({struct _fat_ptr _tmp31B=({const char*_tmp169="ignoring scope of field ";_tag_fat(_tmp169,sizeof(char),25U);});_tmp23C.f1=_tmp31B;});_tmp23C;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp168=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp23B;_tmp23B.tag=1U,_tmp23B.f1=f->name;_tmp23B;});void*_tmp166[2U];_tmp166[0]=& _tmp167,_tmp166[1]=& _tmp168;({unsigned _tmp31C=loc;Cyc_Warn_warn2(_tmp31C,_tag_fat(_tmp166,sizeof(void*),2U));});});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp18A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp242;_tmp242.tag=0U,({struct _fat_ptr _tmp328=({const char*_tmp18E="enum field name ";_tag_fat(_tmp18E,sizeof(char),17U);});_tmp242.f1=_tmp328;});_tmp242;});struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp18B=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp241;_tmp241.tag=1U,_tmp241.f1=f->name;_tmp241;});struct Cyc_Warn_String_Warn_Warg_struct _tmp18C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp240;_tmp240.tag=0U,({struct _fat_ptr _tmp329=({const char*_tmp18D=" shadows global name";_tag_fat(_tmp18D,sizeof(char),21U);});_tmp240.f1=_tmp329;});_tmp240;});void*_tmp189[3U];_tmp189[0]=& _tmp18A,_tmp189[1]=& _tmp18B,_tmp189[2]=& _tmp18C;({unsigned _tmp32A=f->loc;Cyc_Warn_err2(_tmp32A,_tag_fat(_tmp189,sizeof(void*),3U));});});
if(f->tag == 0)
...
# 761
 if(!in_include)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1A8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp248;_tmp248.tag=0U,({struct _fat_ptr _tmp331=({const char*_tmp1A9="static declaration within extern \"C\"";_tag_fat(_tmp1A9,sizeof(char),37U);});_tmp248.f1=_tmp331;});_tmp248;});void*_tmp1A7[1U];_tmp1A7[0]=& _tmp1A8;({unsigned _tmp332=loc;Cyc_Warn_warn2(_tmp332,_tag_fat(_tmp1A7,sizeof(void*),1U));});});
return 0;case Cyc_Absyn_Abstract: _LL3: _LL4:
# 765
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1AB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp249;_tmp249.tag=0U,({struct _fat_ptr _tmp333=({const char*_tmp1AC="abstract declaration within extern \"C\"";_tag_fat(_tmp1AC,sizeof(char),39U);});_tmp249.f1=_tmp333;});_tmp249;});void*_tmp1AA[1U];_tmp1AA[0]=& _tmp1AB;({unsigned _tmp334=loc;Cyc_Warn_warn2(_tmp334,_tag_fat(_tmp1AA,sizeof(void*),1U));});});
...
# 772
 if(!in_inc_rep)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1AE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp24A;_tmp24A.tag=0U,({struct _fat_ptr _tmp335=({const char*_tmp1AF="nested extern \"C\" declaration";_tag_fat(_tmp1AF,sizeof(char),30U);});_tmp24A.f1=_tmp335;});_tmp24A;});void*_tmp1AD[1U];_tmp1AD[0]=& _tmp1AE;({unsigned _tmp336=loc;Cyc_Warn_warn2(_tmp336,_tag_fat(_tmp1AD,sizeof(void*),1U));});});
return 1;}_LL0:;}
# 778
...
# 805
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp24B;_tmp24B.tag=0U,({struct _fat_ptr _tmp337=({const char*_tmp1CA="top level let-declarations are not implemented";_tag_fat(_tmp1CA,sizeof(char),47U);});_tmp24B.f1=_tmp337;});_tmp24B;});void*_tmp1C8[1U];_tmp1C8[0]=& _tmp1C9;({unsigned _tmp338=loc;Cyc_Warn_err2(_tmp338,_tag_fat(_tmp1C8,sizeof(void*),1U));});});goto _LL0;case 4U: _LL5: _LL6:
# 807
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1CC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp24C;_tmp24C.tag=0U,({struct _fat_ptr _tmp339=({const char*_tmp1CD="top level region declarations are not implemented";_tag_fat(_tmp1CD,sizeof(char),50U);});_tmp24C.f1=_tmp339;});_tmp24C;});void*_tmp1CB[1U];_tmp1CB[0]=& _tmp1CC;({unsigned _tmp33A=loc;Cyc_Warn_err2(_tmp33A,_tag_fat(_tmp1CB,sizeof(void*),1U));});});goto _LL0;case 0U: _LL7: _tmp1C7=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_tmp1B9)->f1;_LL8: {struct Cyc_Absyn_Vardecl*vd=_tmp1C7;
# 809
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1CF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp24D;_tmp24D.tag=0U,({struct _fat_ptr _tmp33B=({const char*_tmp1D0="spurious __cyclone_port_on__";_tag_fat(_tmp1D0,sizeof(char),29U);});_tmp24D.f1=_tmp33B;});_tmp24D;});void*_tmp1CE[1U];_tmp1CE[0]=& _tmp1CF;({unsigned _tmp33C=d->loc;Cyc_Warn_warn2(_tmp33C,_tag_fat(_tmp1CE,sizeof(void*),1U));});});goto _LL0;case 14U: _LL15: _LL16:
...
({struct Cyc_List_List*_tmp33E=({struct Cyc_List_List*_tmp33D=ns;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(_tmp33D,({struct Cyc_List_List*_tmp1D2=_cycalloc(sizeof(*_tmp1D2));_tmp1D2->hd=v,_tmp1D2->tl=0;_tmp1D2;}));});te->ns=_tmp33E;});
...
if(!(*exp).f3)
({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp1D7=({struct Cyc_Warn_Qvar_Warn_Warg_struct _tmp24F;_tmp24F.tag=1U,_tmp24F.f1=(*exp).f2;_tmp24F;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1D8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp24E;_tmp24E.tag=0U,({struct _fat_ptr _tmp33F=({const char*_tmp1D9=" is exported but not defined";_tag_fat(_tmp1D9,sizeof(char),29U);});_tmp24E.f1=_tmp33F;});_tmp24E;});void*_tmp1D6[2U];_tmp1D6[0]=& _tmp1D7,_tmp1D6[1]=& _tmp1D8;({unsigned _tmp340=(*exp).f1;Cyc_Warn_warn2(_tmp340,_tag_fat(_tmp1D6,sizeof(void*),2U));});});}
# 884
goto _LL0;}}}_LL0:;}}
# 889
...
({struct Cyc_List_List*_tmp342=Cyc_Tc_treeshake_f(env,*ds2p);*ds2p=_tmp342;});return 1;}case 12U: _LL9: _tmp1E0=(struct Cyc_List_List**)&((struct Cyc_Absyn_ExternCinclude_d_Absyn_Raw_decl_struct*)_tmp1DF)->f1;_LLA: {struct Cyc_List_List**ds2p=_tmp1E0;
# 942
