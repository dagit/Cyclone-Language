...
if(i < 1  || i > nargs){
({struct Cyc_String_pa_PrintArg_struct _tmp4=({struct Cyc_String_pa_PrintArg_struct _tmp1D5;_tmp1D5.tag=0U,({struct _dyneither_ptr _tmp213=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string(att));_tmp1D5.f1=_tmp213;});_tmp1D5;});void*_tmp2[1U];_tmp2[0]=& _tmp4;({unsigned int _tmp215=loc;struct _dyneither_ptr _tmp214=({const char*_tmp3="%s has an out-of-range index";_tag_dyneither(_tmp3,sizeof(char),29U);});Cyc_Tcutil_terr(_tmp215,_tmp214,_tag_dyneither(_tmp2,sizeof(void*),1U));});});
return 0;}
# 62
...
({struct Cyc_String_pa_PrintArg_struct _tmp14=({struct Cyc_String_pa_PrintArg_struct _tmp1D9;_tmp1D9.tag=0U,_tmp1D9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s);_tmp1D9;});void*_tmp12[1U];_tmp12[0]=& _tmp14;({unsigned int _tmp21C=loc;struct _dyneither_ptr _tmp21B=({const char*_tmp13="%s non-null pointers";_tag_dyneither(_tmp13,sizeof(char),21U);});Cyc_Tcutil_terr(_tmp21C,_tmp21B,_tag_dyneither(_tmp12,sizeof(void*),1U));});});
if(!Cyc_Tcutil_is_bound_one(_tmp1F))
({struct Cyc_String_pa_PrintArg_struct _tmp17=({struct Cyc_String_pa_PrintArg_struct _tmp1DA;_tmp1DA.tag=0U,_tmp1DA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s);_tmp1DA;});void*_tmp15[1U];_tmp15[0]=& _tmp17;({unsigned int _tmp21E=loc;struct _dyneither_ptr _tmp21D=({const char*_tmp16="%s pointers of size 1";_tag_dyneither(_tmp16,sizeof(char),22U);});Cyc_Tcutil_terr(_tmp21E,_tmp21D,_tag_dyneither(_tmp15,sizeof(void*),1U));});});
if(Cyc_Tcutil_force_type2bool(0,_tmp1E))
({struct Cyc_String_pa_PrintArg_struct _tmp1A=({struct Cyc_String_pa_PrintArg_struct _tmp1DB;_tmp1DB.tag=0U,_tmp1DB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s);_tmp1DB;});void*_tmp18[1U];_tmp18[0]=& _tmp1A;({unsigned int _tmp220=loc;struct _dyneither_ptr _tmp21F=({const char*_tmp19="%s pointers to non-zero-terminated arrays";_tag_dyneither(_tmp19,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp220,_tmp21F,_tag_dyneither(_tmp18,sizeof(void*),1U));});});
goto _LL11;}else{_LL14: _LL15:
# 96
({struct Cyc_String_pa_PrintArg_struct _tmp1D=({struct Cyc_String_pa_PrintArg_struct _tmp1DC;_tmp1DC.tag=0U,_tmp1DC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s);_tmp1DC;});void*_tmp1B[1U];_tmp1B[0]=& _tmp1D;({unsigned int _tmp222=loc;struct _dyneither_ptr _tmp221=({const char*_tmp1C="%s pointers";_tag_dyneither(_tmp1C,sizeof(char),12U);});Cyc_Tcutil_terr(_tmp222,_tmp221,_tag_dyneither(_tmp1B,sizeof(void*),1U));});});}_LL11:;}
# 98
...
({void*_tmp27=0U;({unsigned int _tmp225=loc;struct _dyneither_ptr _tmp224=({const char*_tmp28="noliveunique attribute allowed only on unique pointers";_tag_dyneither(_tmp28,sizeof(char),55U);});Cyc_Tcutil_terr(_tmp225,_tmp224,_tag_dyneither(_tmp27,sizeof(void*),0U));});});
...
({void*_tmp2D=0U;({unsigned int _tmp228=loc;struct _dyneither_ptr _tmp227=({const char*_tmp2E="consume attribute allowed only on unique pointers";_tag_dyneither(_tmp2E,sizeof(char),50U);});Cyc_Tcutil_terr(_tmp228,_tmp227,_tag_dyneither(_tmp2D,sizeof(void*),0U));});});
...
# 151
 _tmp91=({void*_tmp23A=({void*_tmp239=_tmp49;struct Cyc_Absyn_Tqual _tmp238=_tmp48;struct Cyc_Absyn_Exp*_tmp237=Cyc_Absyn_uint_exp((unsigned int)((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp45),0U);void*_tmp236=_tmp47;Cyc_Absyn_array_type(_tmp239,_tmp238,_tmp237,_tmp236,_tmp46);});vd->type=_tmp23A;});
...
({void*_tmp4A=0U;({unsigned int _tmp23E=loc;struct _dyneither_ptr _tmp23D=({const char*_tmp4B="extern declaration should not have initializer";_tag_dyneither(_tmp4B,sizeof(char),47U);});Cyc_Tcutil_terr(_tmp23E,_tmp23D,_tag_dyneither(_tmp4A,sizeof(void*),0U));});});}else{
if(!Cyc_Tcutil_is_function_type(_tmp91)){
# 178
...
struct _dyneither_ptr _tmp23F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)_tmp8F->hd));_tmp1E1.f1=_tmp23F;});_tmp1E1;});struct Cyc_String_pa_PrintArg_struct _tmp51=({struct Cyc_String_pa_PrintArg_struct _tmp1E0;_tmp1E0.tag=0U,({struct _dyneither_ptr _tmp240=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(vd->name));_tmp1E0.f1=_tmp240;});_tmp1E0;});void*_tmp4E[2U];_tmp4E[0]=& _tmp50,_tmp4E[1]=& _tmp51;({unsigned int _tmp242=loc;struct _dyneither_ptr _tmp241=({const char*_tmp4F="bad attribute %s for variable %s";_tag_dyneither(_tmp4F,sizeof(char),33U);});Cyc_Tcutil_terr(_tmp242,_tmp241,_tag_dyneither(_tmp4E,sizeof(void*),2U));});});
goto _LL17;}_LL17:;}
# 196
if(_tmp90 == 0  || in_cinclude){
...
# 224
({void*_tmp77=0U;({unsigned int _tmp256=loc;struct _dyneither_ptr _tmp255=({const char*_tmp78="initializer is not a constant expression";_tag_dyneither(_tmp78,sizeof(char),41U);});Cyc_Tcutil_terr(_tmp256,_tmp255,_tag_dyneither(_tmp77,sizeof(void*),0U));});});
...
struct _dyneither_ptr _tmp258=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)_tmp8F->hd));_tmp1EE.f1=_tmp258;});_tmp1EE;});void*_tmp7E[1U];_tmp7E[0]=& _tmp80;({unsigned int _tmp25A=loc;struct _dyneither_ptr _tmp259=({const char*_tmp7F="bad attribute %s in function declaration";_tag_dyneither(_tmp7F,sizeof(char),41U);});Cyc_Tcutil_terr(_tmp25A,_tmp259,_tag_dyneither(_tmp7E,sizeof(void*),1U));});});
...
({void*_tmp99=0U;({unsigned int _tmp264=loc;struct _dyneither_ptr _tmp263=({const char*_tmp9A="extern \"C\" functions cannot be implemented in Cyclone";_tag_dyneither(_tmp9A,sizeof(char),54U);});Cyc_Tcutil_terr(_tmp264,_tmp263,_tag_dyneither(_tmp99,sizeof(void*),0U));});});
# 292
...
struct _dyneither_ptr _tmp277=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmpD4));_tmp1F1.f1=_tmp277;});_tmp1F1;});void*_tmpC0[1U];_tmpC0[0]=& _tmpC2;({unsigned int _tmp279=loc;struct _dyneither_ptr _tmp278=({const char*_tmpC1="main declared with first argument of type %s instead of int";_tag_dyneither(_tmpC1,sizeof(char),60U);});Cyc_Tcutil_terr(_tmp279,_tmp278,_tag_dyneither(_tmpC0,sizeof(void*),1U));});});
goto _LL18;}_LL18:;}
# 376
_tmpBB=_tmpBB->tl;
if(_tmpBB != 0){
...
# 429
 if(td->defn != 0)
({struct Cyc_String_pa_PrintArg_struct _tmpDD=({struct Cyc_String_pa_PrintArg_struct _tmp1F4;_tmp1F4.tag=0U,_tmp1F4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)tvs->hd)->name);_tmp1F4;});void*_tmpDB[1U];_tmpDB[0]=& _tmpDD;({unsigned int _tmp29B=loc;struct _dyneither_ptr _tmp29A=({const char*_tmpDC="type variable %s is not used in typedef definition";_tag_dyneither(_tmpDC,sizeof(char),51U);});Cyc_Tcutil_warn(_tmp29B,_tmp29A,_tag_dyneither(_tmpDB,sizeof(void*),1U));});});
# 432
...
({struct Cyc_String_pa_PrintArg_struct _tmpED=({struct Cyc_String_pa_PrintArg_struct _tmp1F5;_tmp1F5.tag=0U,_tmp1F5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp105);_tmp1F5;});void*_tmpEB[1U];_tmpEB[0]=& _tmpED;({unsigned int _tmp2A2=loc;struct _dyneither_ptr _tmp2A1=({const char*_tmpEC="duplicate member %s";_tag_dyneither(_tmpEC,sizeof(char),20U);});Cyc_Tcutil_terr(_tmp2A2,_tmp2A1,_tag_dyneither(_tmpEB,sizeof(void*),1U));});});
# 473
...
if((int)str_or_union != (int)1U)
({void*_tmpF0=0U;({unsigned int _tmp2A6=loc;struct _dyneither_ptr _tmp2A5=({const char*_tmpF1="@requires clauses are only allowed on union members";_tag_dyneither(_tmpF1,sizeof(char),52U);});Cyc_Tcutil_terr(_tmp2A6,_tmp2A5,_tag_dyneither(_tmpF0,sizeof(void*),0U));});});{
...
# 498
struct _dyneither_ptr _tmp2A7=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmp100->topt)));_tmp1F6.f1=_tmp2A7;});_tmp1F6;});void*_tmpF3[1U];_tmpF3[0]=& _tmpF5;({unsigned int _tmp2A9=_tmp100->loc;struct _dyneither_ptr _tmp2A8=({const char*_tmpF4="@requires clause has type %s instead of integral type";_tag_dyneither(_tmpF4,sizeof(char),54U);});Cyc_Tcutil_terr(_tmp2A9,_tmp2A8,_tag_dyneither(_tmpF3,sizeof(void*),1U));});});else{
# 500
({unsigned int _tmp2AC=_tmp100->loc;struct Cyc_Tcenv_Tenv*_tmp2AB=te;struct Cyc_List_List*_tmp2AA=tvs;Cyc_Tcutil_check_type(_tmp2AC,_tmp2AB,_tmp2AA,& Cyc_Tcutil_ik,0,0,(void*)({struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_tmpF6=_cycalloc(sizeof(*_tmpF6));_tmpF6->tag=9U,_tmpF6->f1=_tmp100;_tmpF6;}));});{
# 502
struct Cyc_List_List*_tmpF7=Cyc_Relations_exp2relns(uprev_rgn,_tmp100);
# 509
if(!Cyc_Relations_consistent_relations(_tmpF7))
({void*_tmpF8=0U;({unsigned int _tmp2AE=_tmp100->loc;struct _dyneither_ptr _tmp2AD=({const char*_tmpF9="@requires clause may be unsatisfiable";_tag_dyneither(_tmpF9,sizeof(char),38U);});Cyc_Tcutil_terr(_tmp2AE,_tmp2AD,_tag_dyneither(_tmpF8,sizeof(void*),0U));});});
# 515
...
({void*_tmpFB=0U;({unsigned int _tmp2B0=_tmp100->loc;struct _dyneither_ptr _tmp2AF=({const char*_tmpFC="@requires clause may overlap with previous clauses";_tag_dyneither(_tmpFC,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp2B0,_tmp2AF,_tag_dyneither(_tmpFB,sizeof(void*),0U));});});}}
# 520
...
# 523
if(prev_relations != 0)
({void*_tmpFE=0U;({unsigned int _tmp2B2=loc;struct _dyneither_ptr _tmp2B1=({const char*_tmpFF="if one field has a @requires clause, they all must";_tag_dyneither(_tmpFF,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp2B2,_tmp2B1,_tag_dyneither(_tmpFE,sizeof(void*),0U));});});}};}};
# 457
...
struct _dyneither_ptr _tmp2BD=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(({struct Cyc_Absyn_Kind*_tmp115=_cycalloc(sizeof(*_tmp115));_tmp115->kind=Cyc_Absyn_MemKind,_tmp115->aliasqual=_tmp11C;_tmp115;})));_tmp1F7.f1=_tmp2BD;});_tmp1F7;});void*_tmp110[3U];_tmp110[0]=& _tmp112,_tmp110[1]=& _tmp113,_tmp110[2]=& _tmp114;({unsigned int _tmp2BF=loc;struct _dyneither_ptr _tmp2BE=({const char*_tmp111="type %s attempts to abstract type variable %s of kind %s";_tag_dyneither(_tmp111,sizeof(char),57U);});Cyc_Tcutil_terr(_tmp2BF,_tmp2BE,_tag_dyneither(_tmp110,sizeof(void*),3U));});});
...
({void*_tmp129=0U;({unsigned int _tmp2CA=loc;struct _dyneither_ptr _tmp2C9=({const char*_tmp12A="@tagged qualifier is only allowed on union declarations";_tag_dyneither(_tmp12A,sizeof(char),56U);});Cyc_Tcutil_terr(_tmp2CA,_tmp2C9,_tag_dyneither(_tmp129,sizeof(void*),0U));});});
...
struct _dyneither_ptr _tmp2D0=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(((struct Cyc_Absyn_Aggrfield*)f->hd)->type));_tmp1FC.f1=_tmp2D0;});_tmp1FC;});void*_tmp12B[3U];_tmp12B[0]=& _tmp12D,_tmp12B[1]=& _tmp12E,_tmp12B[2]=& _tmp12F;({unsigned int _tmp2D2=loc;struct _dyneither_ptr _tmp2D1=({const char*_tmp12C="member %s of union %s has type %s which is not `bits-only' so it can only be written and not read";_tag_dyneither(_tmp12C,sizeof(char),98U);});Cyc_Tcutil_warn(_tmp2D2,_tmp2D1,_tag_dyneither(_tmp12B,sizeof(void*),3U));});});}}
# 619
*_tmp128=ad;
...
({void*_tmp132=0U;({unsigned int _tmp2D4=loc;struct _dyneither_ptr _tmp2D3=({const char*_tmp133="cannot reuse struct names for unions and vice-versa";_tag_dyneither(_tmp133,sizeof(char),52U);});Cyc_Tcutil_terr(_tmp2D4,_tmp2D3,_tag_dyneither(_tmp132,sizeof(void*),0U));});});{
# 626
...
({void*_tmp136=0U;({unsigned int _tmp2D7=loc;struct _dyneither_ptr _tmp2D6=({const char*_tmp137="@tagged qualifier is only allowed on union declarations";_tag_dyneither(_tmp137,sizeof(char),56U);});Cyc_Tcutil_terr(_tmp2D7,_tmp2D6,_tag_dyneither(_tmp136,sizeof(void*),0U));});});
...
# 676
({struct Cyc_String_pa_PrintArg_struct _tmp14A=({struct Cyc_String_pa_PrintArg_struct _tmp201;_tmp201.tag=0U,_tmp201.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*q).f2);_tmp201;});struct Cyc_String_pa_PrintArg_struct _tmp14B=({struct Cyc_String_pa_PrintArg_struct _tmp200;_tmp200.tag=0U,_tmp200.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)tvs2->hd)->name);_tmp200;});void*_tmp148[2U];_tmp148[0]=& _tmp14A,_tmp148[1]=& _tmp14B;({unsigned int _tmp2E4=loc;struct _dyneither_ptr _tmp2E3=({const char*_tmp149="type %s attempts to abstract type variable %s of kind TR";_tag_dyneither(_tmp149,sizeof(char),57U);});Cyc_Tcutil_terr(_tmp2E4,_tmp2E3,_tag_dyneither(_tmp148,sizeof(void*),2U));});});
...
# 708
struct _dyneither_ptr _tmp2EB=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp163->name));_tmp208.f1=_tmp2EB;});_tmp208;});void*_tmp164[1U];_tmp164[0]=& _tmp166;({unsigned int _tmp2ED=_tmp163->loc;struct _dyneither_ptr _tmp2EC=({const char*_tmp165="noalias pointers in datatypes are not allowed (%s)";_tag_dyneither(_tmp165,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp2ED,_tmp2EC,_tag_dyneither(_tmp164,sizeof(void*),1U));});});
({int _tmp2EE=
...
({struct Cyc_String_pa_PrintArg_struct _tmp16D=({struct Cyc_String_pa_PrintArg_struct _tmp20A;_tmp20A.tag=0U,_tmp20A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp16A->name).f2);_tmp20A;});struct Cyc_String_pa_PrintArg_struct _tmp16E=({struct Cyc_String_pa_PrintArg_struct _tmp209;_tmp209.tag=0U,_tmp209.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)obj);_tmp209;});void*_tmp16B[2U];_tmp16B[0]=& _tmp16D,_tmp16B[1]=& _tmp16E;({unsigned int _tmp2F0=_tmp16A->loc;struct _dyneither_ptr _tmp2EF=({const char*_tmp16C="duplicate field name %s in %s";_tag_dyneither(_tmp16C,sizeof(char),30U);});Cyc_Tcutil_terr(_tmp2F0,_tmp2EF,_tag_dyneither(_tmp16B,sizeof(void*),2U));});});else{
# 733
...
({struct Cyc_String_pa_PrintArg_struct _tmp172=({struct Cyc_String_pa_PrintArg_struct _tmp20B;_tmp20B.tag=0U,_tmp20B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp16A->name).f2);_tmp20B;});void*_tmp170[1U];_tmp170[0]=& _tmp172;({unsigned int _tmp2F2=loc;struct _dyneither_ptr _tmp2F1=({const char*_tmp171="ignoring scope of field %s";_tag_dyneither(_tmp171,sizeof(char),27U);});Cyc_Tcutil_warn(_tmp2F2,_tmp2F1,_tag_dyneither(_tmp170,sizeof(void*),1U));});});
...
({struct Cyc_String_pa_PrintArg_struct _tmp18E=({struct Cyc_String_pa_PrintArg_struct _tmp20D;_tmp20D.tag=0U,_tmp20D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp18B->name).f2);_tmp20D;});void*_tmp18C[1U];_tmp18C[0]=& _tmp18E;({unsigned int _tmp2FD=_tmp18B->loc;struct _dyneither_ptr _tmp2FC=({const char*_tmp18D="duplicate enum constructor %s";_tag_dyneither(_tmp18D,sizeof(char),30U);});Cyc_Tcutil_terr(_tmp2FD,_tmp2FC,_tag_dyneither(_tmp18C,sizeof(void*),1U));});});else{
# 851
...
({struct Cyc_String_pa_PrintArg_struct _tmp192=({struct Cyc_String_pa_PrintArg_struct _tmp20E;_tmp20E.tag=0U,_tmp20E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp18B->name).f2);_tmp20E;});void*_tmp190[1U];_tmp190[0]=& _tmp192;({unsigned int _tmp2FF=_tmp18B->loc;struct _dyneither_ptr _tmp2FE=({const char*_tmp191="enum field name %s shadows global name";_tag_dyneither(_tmp191,sizeof(char),39U);});Cyc_Tcutil_terr(_tmp2FF,_tmp2FE,_tag_dyneither(_tmp190,sizeof(void*),1U));});});
# 856
if(_tmp18B->tag == 0){
...
({struct Cyc_String_pa_PrintArg_struct _tmp1A3=({struct Cyc_String_pa_PrintArg_struct _tmp210;_tmp210.tag=0U,_tmp210.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*q).f2);_tmp210;});struct Cyc_String_pa_PrintArg_struct _tmp1A4=({struct Cyc_String_pa_PrintArg_struct _tmp20F;_tmp20F.tag=0U,_tmp20F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp1A0->name).f2);_tmp20F;});void*_tmp1A1[2U];_tmp1A1[0]=& _tmp1A3,_tmp1A1[1]=& _tmp1A4;({unsigned int _tmp303=loc;struct _dyneither_ptr _tmp302=({const char*_tmp1A2="enum %s, field %s: expression is not constant";_tag_dyneither(_tmp1A2,sizeof(char),46U);});Cyc_Tcutil_terr(_tmp303,_tmp302,_tag_dyneither(_tmp1A1,sizeof(void*),2U));});});}}}
# 891
...
# 894
 if(!in_include)
({void*_tmp1A6=0U;({unsigned int _tmp305=loc;struct _dyneither_ptr _tmp304=({const char*_tmp1A7="static declaration nested within extern \"C\"";_tag_dyneither(_tmp1A7,sizeof(char),44U);});Cyc_Tcutil_warn(_tmp305,_tmp304,_tag_dyneither(_tmp1A6,sizeof(void*),0U));});});
return 0;case Cyc_Absyn_Abstract: _LL3: _LL4:
# 898
({void*_tmp1A8=0U;({unsigned int _tmp307=loc;struct _dyneither_ptr _tmp306=({const char*_tmp1A9="abstract declaration nested within extern \"C\"";_tag_dyneither(_tmp1A9,sizeof(char),46U);});Cyc_Tcutil_warn(_tmp307,_tmp306,_tag_dyneither(_tmp1A8,sizeof(void*),0U));});});
...
# 905
({void*_tmp1AA=0U;({unsigned int _tmp309=loc;struct _dyneither_ptr _tmp308=({const char*_tmp1AB="nested extern \"C\" declaration";_tag_dyneither(_tmp1AB,sizeof(char),30U);});Cyc_Tcutil_warn(_tmp309,_tmp308,_tag_dyneither(_tmp1AA,sizeof(void*),0U));});});
return 1;}_LL0:;}
# 915
...
# 929
({void*_tmp1AF=0U;({unsigned int _tmp30B=loc;struct _dyneither_ptr _tmp30A=({const char*_tmp1B0="top level let-declarations are not implemented";_tag_dyneither(_tmp1B0,sizeof(char),47U);});Cyc_Tcutil_terr(_tmp30B,_tmp30A,_tag_dyneither(_tmp1AF,sizeof(void*),0U));});});
goto _LL0;case 4U: _LL5: _LL6:
# 932
({void*_tmp1B1=0U;({unsigned int _tmp30D=loc;struct _dyneither_ptr _tmp30C=({const char*_tmp1B2="top level region declarations are not implemented";_tag_dyneither(_tmp1B2,sizeof(char),50U);});Cyc_Tcutil_terr(_tmp30D,_tmp30C,_tag_dyneither(_tmp1B1,sizeof(void*),0U));});});
...
# 967
({void*_tmp1B3=0U;({unsigned int _tmp30F=d->loc;struct _dyneither_ptr _tmp30E=({const char*_tmp1B4="spurious __cyclone_port_on__";_tag_dyneither(_tmp1B4,sizeof(char),29U);});Cyc_Tcutil_warn(_tmp30F,_tmp30E,_tag_dyneither(_tmp1B3,sizeof(void*),0U));});});
...
struct _dyneither_ptr _tmp312=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string((*_tmp1B8).f2));_tmp211.f1=_tmp312;});_tmp211;});void*_tmp1B9[1U];_tmp1B9[0]=& _tmp1BB;({unsigned int _tmp314=(*_tmp1B8).f1;struct _dyneither_ptr _tmp313=({const char*_tmp1BA="%s is exported but not defined";_tag_dyneither(_tmp1BA,sizeof(char),31U);});Cyc_Tcutil_warn(_tmp314,_tmp313,_tag_dyneither(_tmp1B9,sizeof(void*),1U));});});}
# 1008
goto _LL0;}}_LL0:;}}
# 1013
