...
# 565
({struct Cyc_Warn_String_Warn_Warg_struct _tmpC2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4C4;_tmp4C4.tag=0,({struct _fat_ptr _tmp5B0=({const char*_tmpC3="type_kind: Unresolved DatatypeFieldType";_tag_fat(_tmpC3,sizeof(char),40U);});_tmp4C4.f1=_tmp5B0;});_tmp4C4;});void*_tmpC1[1];_tmpC1[0]=& _tmpC2;({int(*_tmp5B1)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5B1(_tag_fat(_tmpC1,sizeof(void*),1));});});}default: if(((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_tmpBB)->f1).UnknownAggr).tag == 1)
# 568
...
# 620
if(td == 0 || td->kind == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpD0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4C6;_tmp4C6.tag=0,({struct _fat_ptr _tmp5B2=({const char*_tmpD2="type_kind: typedef found: ";_tag_fat(_tmpD2,sizeof(char),27U);});_tmp4C6.f1=_tmp5B2;});_tmp4C6;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpD1=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4C5;_tmp4C5.tag=2,_tmp4C5.f1=(void*)t;_tmp4C5;});void*_tmpCF[2];_tmpCF[0]=& _tmpD0,_tmpCF[1]=& _tmpD1;({int(*_tmp5B3)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5B3(_tag_fat(_tmpCF,sizeof(void*),2));});});
...
{struct Cyc_Absyn_Kind*_tmpD3=Cyc_Kinds_tvar_kind(tv,& Cyc_Kinds_bk);struct Cyc_Absyn_Kind*_stmttmp1D=_tmpD3;struct Cyc_Absyn_Kind*_tmpD4=_stmttmp1D;switch((int)((struct Cyc_Absyn_Kind*)_tmpD4)->kind){case Cyc_Absyn_RgnKind: switch((int)((struct Cyc_Absyn_Kind*)_tmpD4)->aliasqual){case Cyc_Absyn_Unique:
 ...
 t=(void*)({struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_tmpD5=_cycalloc(sizeof(*_tmpD5));_tmpD5->tag=9,({struct Cyc_Absyn_Exp*_tmp5B4=Cyc_Absyn_uint_exp(0U,0U);_tmpD5->f1=_tmp5B4;});_tmpD5;});goto _LL0;case Cyc_Absyn_BoolKind:
...
# 668
return Cyc_Tcutil_normalize_effect(Cyc_Absyn_join_eff(({void*_tmpE2[2];({void*_tmp5B6=Cyc_Absyn_access_eff(r);_tmpE2[0]=_tmp5B6;}),({void*_tmp5B5=Cyc_Tcutil_rgns_of(et);_tmpE2[1]=_tmp5B5;});({struct Cyc_List_List*(*_tmp5B7)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmp5B7(_tag_fat(_tmpE2,sizeof(void*),2));});})));}case 4: _tmpD9=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmpD8)->f1).elt_type;{void*et=_tmpD9;
# 670
...
# 681
void*_tmpE3=({struct Cyc_List_List*_tmp5B8=({(struct Cyc_List_List*(*)(struct _tuple17*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*))Cyc_List_map;})(Cyc_Tcutil_region_free_subst,tvs);Cyc_Tcutil_substitute(_tmp5B8,(void*)_check_null(eff));});void*e=_tmpE3;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpE7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4C7;_tmp4C7.tag=0,({struct _fat_ptr _tmp5B9=({const char*_tmpE8="typedecl in rgns_of";_tag_fat(_tmpE8,sizeof(char),20U);});_tmp4C7.f1=_tmp5B9;});_tmp4C7;});void*_tmpE6[1];_tmpE6[0]=& _tmpE7;({int(*_tmp5BA)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5BA(_tag_fat(_tmpE6,sizeof(void*),1));});});case 9:
 goto _LL1C;default: _LL1C:
...
({void*_tmp5C5=Cyc_Tcutil_dummy_fntype(Cyc_Absyn_join_eff(({void*_tmp108[2];_tmp108[0]=ev,({void*_tmp5C3=Cyc_Absyn_access_eff(r);_tmp108[1]=_tmp5C3;});({struct Cyc_List_List*(*_tmp5C4)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmp5C4(_tag_fat(_tmp108,sizeof(void*),2));});})));*p=_tmp5C5;});
return 1;}}else{
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp10A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4C9;_tmp4C9.tag=0,({struct _fat_ptr _tmp5C6=({const char*_tmp10B="effect evar has wrong kind";_tag_fat(_tmp10B,sizeof(char),27U);});_tmp4C9.f1=_tmp5C6;});_tmp4C9;});void*_tmp109[1];_tmp109[0]=& _tmp10A;({int(*_tmp5C7)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5C7(_tag_fat(_tmp109,sizeof(void*),1));});});
if(!constrain)return 0;{
# 800
void*_tmp10C=Cyc_Absyn_new_evar(& Cyc_Kinds_eko,s);void*ev=_tmp10C;
# 803
Cyc_Unify_occurs(ev,Cyc_Core_heap_region,(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(s))->v,r);
({void*_tmp5CA=Cyc_Absyn_join_eff(({void*_tmp10D[2];_tmp10D[0]=ev,({void*_tmp5C8=Cyc_Absyn_access_eff(r);_tmp10D[1]=_tmp5C8;});({struct Cyc_List_List*(*_tmp5C9)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmp5C9(_tag_fat(_tmp10D,sizeof(void*),2));});}));*p=_tmp5CA;});
...
# 835
if(k == 0 ||(int)((struct Cyc_Absyn_Kind*)k->v)->kind != 4)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp11B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4CB;_tmp4CB.tag=0,({struct _fat_ptr _tmp5CC=({const char*_tmp11C="effect evar has wrong kind";_tag_fat(_tmp11C,sizeof(char),27U);});_tmp4CB.f1=_tmp5CC;});_tmp4CB;});void*_tmp11A[1];_tmp11A[0]=& _tmp11B;({int(*_tmp5CD)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5CD(_tag_fat(_tmp11A,sizeof(void*),1));});});
...
void*_tmp11E=Cyc_Absyn_join_eff(({void*_tmp11F[2];_tmp11F[0]=ev,({void*_tmp5CE=Cyc_Absyn_regionsof_eff(t);_tmp11F[1]=_tmp5CE;});({struct Cyc_List_List*(*_tmp5CF)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmp5CF(_tag_fat(_tmp11F,sizeof(void*),2));});}));void*new_typ=_tmp11E;
*p=new_typ;
return 1;}}}default: _LL9:
 return 0;};}}
# 853
...
({void*_tmp5D2=Cyc_Tcutil_dummy_fntype(Cyc_Absyn_join_eff(({void*_tmp12D[2];_tmp12D[0]=ev,({void*_tmp5D0=Cyc_Absyn_var_type(v);_tmp12D[1]=_tmp5D0;});({struct Cyc_List_List*(*_tmp5D1)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmp5D1(_tag_fat(_tmp12D,sizeof(void*),2));});})));*p=_tmp5D2;});
return 1;}}else{
...
# 881
if(k == 0 ||(int)((struct Cyc_Absyn_Kind*)k->v)->kind != 4)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp12F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4CC;_tmp4CC.tag=0,({struct _fat_ptr _tmp5D3=({const char*_tmp130="effect evar has wrong kind";_tag_fat(_tmp130,sizeof(char),27U);});_tmp4CC.f1=_tmp5D3;});_tmp4CC;});void*_tmp12E[1];_tmp12E[0]=& _tmp12F;({int(*_tmp5D4)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5D4(_tag_fat(_tmp12E,sizeof(void*),1));});});{
# 885
...
return 0;{
void*_tmp132=Cyc_Absyn_join_eff(({void*_tmp133[2];_tmp133[0]=ev,({void*_tmp5D5=Cyc_Absyn_var_type(v);_tmp133[1]=_tmp5D5;});({struct Cyc_List_List*(*_tmp5D6)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmp5D6(_tag_fat(_tmp133,sizeof(void*),2));});}));void*new_typ=_tmp132;
*p=new_typ;
return 1;}}}default: _LL9:
 return 0;};}}
# 897
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp141=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4CE;_tmp4CE.tag=0,({struct _fat_ptr _tmp5D7=({const char*_tmp143="subset_effect: bad effect: ";_tag_fat(_tmp143,sizeof(char),28U);});_tmp4CE.f1=_tmp5D7;});_tmp4CE;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp142=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4CD;_tmp4CD.tag=2,_tmp4CD.f1=(void*)e1;_tmp4CD;});void*_tmp140[2];_tmp140[0]=& _tmp141,_tmp140[1]=& _tmp142;({int(*_tmp5D8)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5D8(_tag_fat(_tmp140,sizeof(void*),2));});});};}
# 973
...
# 1035
({struct Cyc_Warn_String_Warn_Warg_struct _tmp14E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4CF;_tmp4CF.tag=0,({struct _fat_ptr _tmp5D9=({const char*_tmp14F="bad con";_tag_fat(_tmp14F,sizeof(char),8U);});_tmp4CF.f1=_tmp5D9;});_tmp4CF;});void*_tmp14D[1];_tmp14D[0]=& _tmp14E;({int(*_tmp5DA)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5DA(_tag_fat(_tmp14D,sizeof(void*),1));});});}case 2: switch((int)((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp14C)->f1){case 0:
# 1014
 return 16;case 1:
 return 17;default:
 return 18;}case 3:
...
if(a1 != 0 && a2 == 0)return 1;
return({int(*_tmp5DD)(void*,void*)=cmp;void*_tmp5DC=(void*)_check_null(a1);_tmp5DD(_tmp5DC,(void*)_check_null(a2));});}
# 1114
...
t2=Cyc_Absyn_compress(t2);
if(t1 == t2)return 0;{
int _tmp186=({int _tmp5DE=Cyc_Tcutil_type_case_number(t1);Cyc_Core_intcmp(_tmp5DE,Cyc_Tcutil_type_case_number(t2));});int shallowcmp=_tmp186;
if(shallowcmp != 0)
return shallowcmp;{
# 1153
...
if(e1 == e2)return 0;
if(e1 == 0 || e2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1A7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4D5;_tmp4D5.tag=0,({struct _fat_ptr _tmp5DF=({const char*_tmp1A8="missing expression in array index";_tag_fat(_tmp1A8,sizeof(char),34U);});_tmp4D5.f1=_tmp5DF;});_tmp4D5;});void*_tmp1A6[1];_tmp1A6[0]=& _tmp1A7;({int(*_tmp5E0)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5E0(_tag_fat(_tmp1A6,sizeof(void*),1));});});
...
r=({struct Cyc_Absyn_Tqual _tmp5E1=((struct Cyc_Absyn_VarargInfo*)_check_null(f1.cyc_varargs))->tq;Cyc_Tcutil_tqual_cmp(_tmp5E1,((struct Cyc_Absyn_VarargInfo*)_check_null(f2.cyc_varargs))->tq);});
if(r != 0)return r;
...
if(r != 0)return r;
# 1245
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1BE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4D6;_tmp4D6.tag=0,({struct _fat_ptr _tmp5E2=({const char*_tmp1BF="typecmp: function type comparison should never get here!";_tag_fat(_tmp1BF,sizeof(char),57U);});_tmp4D6.f1=_tmp5E2;});_tmp4D6;});void*_tmp1BD[1];_tmp1BD[0]=& _tmp1BE;({int(*_tmp5E3)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5E3(_tag_fat(_tmp1BD,sizeof(void*),1));});});}}}}}else{goto _LL15;}case 6: if(*((int*)_tmp188.f2)== 6){_tmp189=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp188.f1)->f1;_tmp18A=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp188.f2)->f1;{struct Cyc_List_List*ts2=_tmp189;struct Cyc_List_List*ts1=_tmp18A;
# 1248
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4D7;_tmp4D7.tag=0,({struct _fat_ptr _tmp5E4=({const char*_tmp1C2="Unmatched case in typecmp";_tag_fat(_tmp1C2,sizeof(char),26U);});_tmp4D7.f1=_tmp5E4;});_tmp4D7;});void*_tmp1C0[1];_tmp1C0[0]=& _tmp1C1;({int(*_tmp5E5)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5E5(_tag_fat(_tmp1C0,sizeof(void*),1));});});};}}}
# 1263
static int Cyc_Tcutil_will_lose_precision(void*t1,void*t2){
struct _tuple15 _tmp1C3=({struct _tuple15 _tmp4DA;({void*_tmp5E7=Cyc_Absyn_compress(t1);_tmp4DA.f1=_tmp5E7;}),({void*_tmp5E6=Cyc_Absyn_compress(t2);_tmp4DA.f2=_tmp5E6;});_tmp4DA;});struct _tuple15 _stmttmp3B=_tmp1C3;struct _tuple15 _tmp1C4=_stmttmp3B;void*_tmp1C6;void*_tmp1C5;if(*((int*)_tmp1C4.f1)== 0){if(*((int*)_tmp1C4.f2)== 0){_tmp1C5=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1C4.f1)->f1;_tmp1C6=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1C4.f2)->f1;{void*c1=_tmp1C5;void*c2=_tmp1C6;
# 1266
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1D5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E0;_tmp4E0.tag=0,({struct _fat_ptr _tmp5EA=({const char*_tmp1DA="type mismatch: expecting ";_tag_fat(_tmp1DA,sizeof(char),26U);});_tmp4E0.f1=_tmp5EA;});_tmp4E0;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1D6=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4DF;_tmp4DF.tag=2,_tmp4DF.f1=(void*)t;_tmp4DF;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1D7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4DE;_tmp4DE.tag=0,({struct _fat_ptr _tmp5EB=({const char*_tmp1D9=" but found ";_tag_fat(_tmp1D9,sizeof(char),12U);});_tmp4DE.f1=_tmp5EB;});_tmp4DE;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1D8=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4DD;_tmp4DD.tag=2,_tmp4DD.f1=(void*)_check_null(((struct Cyc_Absyn_Exp*)el->hd)->topt);_tmp4DD;});void*_tmp1D4[4];_tmp1D4[0]=& _tmp1D5,_tmp1D4[1]=& _tmp1D6,_tmp1D4[2]=& _tmp1D7,_tmp1D4[3]=& _tmp1D8;({unsigned _tmp5EC=((struct Cyc_Absyn_Exp*)el->hd)->loc;Cyc_Warn_err2(_tmp5EC,_tag_fat(_tmp1D4,sizeof(void*),4));});});
# 1346
return 0;}}}
# 1348
return 1;}
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1DE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E1;_tmp4E1.tag=0,({struct _fat_ptr _tmp5ED=({const char*_tmp1DF="integral size mismatch; conversion supplied";_tag_fat(_tmp1DF,sizeof(char),44U);});_tmp4E1.f1=_tmp5ED;});_tmp4E1;});void*_tmp1DD[1];_tmp1DD[0]=& _tmp1DE;({unsigned _tmp5EE=e->loc;Cyc_Warn_warn2(_tmp5EE,_tag_fat(_tmp1DD,sizeof(void*),1));});});
...
({void*_tmp5EF=t;Cyc_Unify_unify(_tmp5EF,Cyc_Absyn_bounds_one());});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1E8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E3;_tmp4E3.tag=0,({struct _fat_ptr _tmp5F0=({const char*_tmp1EA="get_bounds_exp: ";_tag_fat(_tmp1EA,sizeof(char),17U);});_tmp4E3.f1=_tmp5F0;});_tmp4E3;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1E9=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4E2;_tmp4E2.tag=2,_tmp4E2.f1=(void*)b;_tmp4E2;});void*_tmp1E7[2];_tmp1E7[0]=& _tmp1E8,_tmp1E7[1]=& _tmp1E9;({int(*_tmp5F1)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5F1(_tag_fat(_tmp1E7,sizeof(void*),2));});});};}}
# 1419
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1EF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E5;_tmp4E5.tag=0,({struct _fat_ptr _tmp5F2=({const char*_tmp1F1="get_ptr_bounds_exp not pointer: ";_tag_fat(_tmp1F1,sizeof(char),33U);});_tmp4E5.f1=_tmp5F2;});_tmp4E5;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1F0=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4E4;_tmp4E4.tag=2,_tmp4E4.f1=(void*)t;_tmp4E4;});void*_tmp1EE[2];_tmp1EE[0]=& _tmp1EF,_tmp1EE[1]=& _tmp1F0;({int(*_tmp5F3)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp5F3(_tag_fat(_tmp1EE,sizeof(void*),2));});});};}
# 1428
...
struct _tuple20 _tmp200=({struct _tuple20 _tmp4E7;({struct Cyc_Absyn_Exp*_tmp5F7=({void*_tmp5F6=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp5F6,(pinfo_a.ptr_atts).bounds);});_tmp4E7.f1=_tmp5F7;}),({
struct Cyc_Absyn_Exp*_tmp5F5=({void*_tmp5F4=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp5F4,(pinfo_b.ptr_atts).bounds);});_tmp4E7.f2=_tmp5F5;});_tmp4E7;});
# 1455
...
void*_tmp5F8=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp5F8,(pinfo_b.ptr_atts).bounds);}))
goto _LL9;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp205=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E6;_tmp4E6.tag=0,({struct _fat_ptr _tmp5F9=({const char*_tmp206="implicit cast to shorter array";_tag_fat(_tmp206,sizeof(char),31U);});_tmp4E6.f1=_tmp5F9;});_tmp4E6;});void*_tmp204[1];_tmp204[0]=& _tmp205;({unsigned _tmp5FA=loc;Cyc_Warn_warn2(_tmp5FA,_tag_fat(_tmp204,sizeof(void*),1));});});
if(!({struct Cyc_Absyn_Exp*_tmp5FB=(struct Cyc_Absyn_Exp*)_check_null(e2);Cyc_Evexp_lte_const_exp(_tmp5FB,(struct Cyc_Absyn_Exp*)_check_null(e1));}))
return 0;
goto _LL9;}}}_LL9:;}
# 1477
...
return 1;
# 1504
if(!({void*_tmp5FF=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp5FF,(pinfo_b.ptr_atts).bounds);})||
...
return e;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _tmp212=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4ED;_tmp4ED.tag=0,({struct _fat_ptr _tmp600=({const char*_tmp213="pointer_elt_type";_tag_fat(_tmp213,sizeof(char),17U);});_tmp4ED.f1=_tmp600;});_tmp4ED;});void*_tmp211[1];_tmp211[0]=& _tmp212;({int(*_tmp601)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp601(_tag_fat(_tmp211,sizeof(void*),1));});});};}
# 1533
...
return p->rgn;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _tmp218=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4EE;_tmp4EE.tag=0,({struct _fat_ptr _tmp602=({const char*_tmp219="pointer_elt_type";_tag_fat(_tmp219,sizeof(char),17U);});_tmp4EE.f1=_tmp602;});_tmp4EE;});void*_tmp217[1];_tmp217[0]=& _tmp218;({int(*_tmp603)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp603(_tag_fat(_tmp217,sizeof(void*),1));});});};}
# 1540
...
return 0;
({void*_tmp604=(Cyc_Absyn_null_exp(0U))->r;e1->r=_tmp604;});
e1->topt=t2;
return 1;}}else{
...
struct _tuple1*v=({struct _tuple1*_tmp239=_cycalloc(sizeof(*_tmp239));_tmp239->f1=Cyc_Absyn_Loc_n,({struct _fat_ptr*_tmp607=({struct _fat_ptr*_tmp238=_cycalloc(sizeof(*_tmp238));({struct _fat_ptr _tmp606=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp237=({struct Cyc_Int_pa_PrintArg_struct _tmp4F0;_tmp4F0.tag=1,_tmp4F0.f1=(unsigned long)counter ++;_tmp4F0;});void*_tmp235[1];_tmp235[0]=& _tmp237;({struct _fat_ptr _tmp605=({const char*_tmp236="__aliasvar%d";_tag_fat(_tmp236,sizeof(char),13U);});Cyc_aprintf(_tmp605,_tag_fat(_tmp235,sizeof(void*),1));});});*_tmp238=_tmp606;});_tmp238;});_tmp239->f2=_tmp607;});_tmp239;});
struct Cyc_Absyn_Vardecl*vd=Cyc_Absyn_new_vardecl(0U,v,e_type,e);
struct Cyc_Absyn_Exp*ve=({void*_tmp608=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp234=_cycalloc(sizeof(*_tmp234));_tmp234->tag=4,_tmp234->f1=vd;_tmp234;});Cyc_Absyn_varb_exp(_tmp608,e->loc);});
# 1621
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp23F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F5;_tmp4F5.tag=0,({struct _fat_ptr _tmp609=({const char*_tmp246="integral size mismatch; ";_tag_fat(_tmp246,sizeof(char),25U);});_tmp4F5.f1=_tmp609;});_tmp4F5;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp240=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F4;_tmp4F4.tag=2,_tmp4F4.f1=(void*)t1;_tmp4F4;});struct Cyc_Warn_String_Warn_Warg_struct _tmp241=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F3;_tmp4F3.tag=0,({
struct _fat_ptr _tmp60A=({const char*_tmp245=" -> ";_tag_fat(_tmp245,sizeof(char),5U);});_tmp4F3.f1=_tmp60A;});_tmp4F3;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp242=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F2;_tmp4F2.tag=2,_tmp4F2.f1=(void*)t2;_tmp4F2;});struct Cyc_Warn_String_Warn_Warg_struct _tmp243=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F1;_tmp4F1.tag=0,({struct _fat_ptr _tmp60B=({const char*_tmp244=" conversion supplied";_tag_fat(_tmp244,sizeof(char),21U);});_tmp4F1.f1=_tmp60B;});_tmp4F1;});void*_tmp23E[5];_tmp23E[0]=& _tmp23F,_tmp23E[1]=& _tmp240,_tmp23E[2]=& _tmp241,_tmp23E[3]=& _tmp242,_tmp23E[4]=& _tmp243;({unsigned _tmp60C=e->loc;Cyc_Warn_warn2(_tmp60C,_tag_fat(_tmp23E,sizeof(void*),5));});});
Cyc_Tcutil_unchecked_cast(e,t2,1U);
return 1;}
# 1684
if(Cyc_Tcutil_can_insert_alias(e,t1,t2,e->loc)){
if(Cyc_Flags_warn_alias_coerce)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp248=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4FB;_tmp4FB.tag=0,({struct _fat_ptr _tmp60D=({const char*_tmp250="implicit alias coercion for ";_tag_fat(_tmp250,sizeof(char),29U);});_tmp4FB.f1=_tmp60D;});_tmp4FB;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp249=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp4FA;_tmp4FA.tag=4,_tmp4FA.f1=e;_tmp4FA;});struct Cyc_Warn_String_Warn_Warg_struct _tmp24A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F9;_tmp4F9.tag=0,({struct _fat_ptr _tmp60E=({const char*_tmp24F=":";_tag_fat(_tmp24F,sizeof(char),2U);});_tmp4F9.f1=_tmp60E;});_tmp4F9;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp24B=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F8;_tmp4F8.tag=2,_tmp4F8.f1=(void*)t1;_tmp4F8;});struct Cyc_Warn_String_Warn_Warg_struct _tmp24C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F7;_tmp4F7.tag=0,({struct _fat_ptr _tmp60F=({const char*_tmp24E=" to ";_tag_fat(_tmp24E,sizeof(char),5U);});_tmp4F7.f1=_tmp60F;});_tmp4F7;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp24D=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F6;_tmp4F6.tag=2,_tmp4F6.f1=(void*)t2;_tmp4F6;});void*_tmp247[6];_tmp247[0]=& _tmp248,_tmp247[1]=& _tmp249,_tmp247[2]=& _tmp24A,_tmp247[3]=& _tmp24B,_tmp247[4]=& _tmp24C,_tmp247[5]=& _tmp24D;({unsigned _tmp610=e->loc;Cyc_Warn_warn2(_tmp610,_tag_fat(_tmp247,sizeof(void*),6));});});
if(alias_coercion != 0)
*alias_coercion=1;}
# 1691
...
if((int)c != 2)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp252=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4FF;_tmp4FF.tag=0,({struct _fat_ptr _tmp611=({const char*_tmp257="implicit cast from ";_tag_fat(_tmp257,sizeof(char),20U);});_tmp4FF.f1=_tmp611;});_tmp4FF;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp253=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4FE;_tmp4FE.tag=2,_tmp4FE.f1=(void*)t1;_tmp4FE;});struct Cyc_Warn_String_Warn_Warg_struct _tmp254=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4FD;_tmp4FD.tag=0,({struct _fat_ptr _tmp612=({const char*_tmp256=" to ";_tag_fat(_tmp256,sizeof(char),5U);});_tmp4FD.f1=_tmp612;});_tmp4FD;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp255=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4FC;_tmp4FC.tag=2,_tmp4FC.f1=(void*)t2;_tmp4FC;});void*_tmp251[4];_tmp251[0]=& _tmp252,_tmp251[1]=& _tmp253,_tmp251[2]=& _tmp254,_tmp251[3]=& _tmp255;({unsigned _tmp613=e->loc;Cyc_Warn_warn2(_tmp613,_tag_fat(_tmp251,sizeof(void*),4));});});
return 1;}
# 1705
return 0;}
# 1711
...
return({struct Cyc_List_List*_tmp260=_region_malloc(r,sizeof(*_tmp260));({struct _tuple12*_tmp614=({struct _tuple12*_tmp25F=_region_malloc(r,sizeof(*_tmp25F));_tmp25F->f1=x->tq,_tmp25F->f2=t;_tmp25F;});_tmp260->hd=_tmp614;}),_tmp260->tl=0;_tmp260;});
...
if(({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(ts)== 1)
return({struct Cyc_List_List*_tmp26B=_region_malloc(r,sizeof(*_tmp26B));({struct _tuple12*_tmp615=({struct _tuple12*_tmp26A=_region_malloc(r,sizeof(*_tmp26A));_tmp26A->f1=tq,_tmp26A->f2=t;_tmp26A;});_tmp26B->hd=_tmp615;}),_tmp26B->tl=0;_tmp26B;});
return ts;}}}
# 1745
...
# 1767
return({struct Cyc_List_List*_tmp279=_region_malloc(r,sizeof(*_tmp279));({struct _tuple12*_tmp617=({struct _tuple12*_tmp278=_region_malloc(r,sizeof(*_tmp278));({struct Cyc_Absyn_Tqual _tmp616=Cyc_Absyn_empty_tqual(0U);_tmp278->f1=_tmp616;}),_tmp278->f2=t1;_tmp278;});_tmp279->hd=_tmp617;}),_tmp279->tl=0;_tmp279;});{
...
# 1790
 goto _LL0;}_LL0:;}}
# 1793
return({struct Cyc_List_List*_tmp28B=_region_malloc(r,sizeof(*_tmp28B));({struct _tuple12*_tmp61B=({struct _tuple12*_tmp28A=_region_malloc(r,sizeof(*_tmp28A));({struct Cyc_Absyn_Tqual _tmp61A=Cyc_Absyn_empty_tqual(0U);_tmp28A->f1=_tmp61A;}),_tmp28A->f2=t1;_tmp28A;});_tmp28B->hd=_tmp61B;}),_tmp28B->tl=0;_tmp28B;});}
# 1796
static int Cyc_Tcutil_isomorphic(void*t1,void*t2){
struct _tuple15 _tmp28C=({struct _tuple15 _tmp503;({void*_tmp61D=Cyc_Absyn_compress(t1);_tmp503.f1=_tmp61D;}),({void*_tmp61C=Cyc_Absyn_compress(t2);_tmp503.f2=_tmp61C;});_tmp503;});struct _tuple15 _stmttmp51=_tmp28C;struct _tuple15 _tmp28D=_stmttmp51;enum Cyc_Absyn_Size_of _tmp28F;enum Cyc_Absyn_Size_of _tmp28E;if(*((int*)_tmp28D.f1)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f1)->f1)== 1){if(*((int*)_tmp28D.f2)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f2)->f1)== 1){_tmp28E=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f1)->f1)->f2;_tmp28F=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f2)->f1)->f2;{enum Cyc_Absyn_Size_of b1=_tmp28E;enum Cyc_Absyn_Size_of b2=_tmp28F;
# 1799
...
struct Cyc_Absyn_Exp*_tmp2A2=({void*_tmp61E=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp61E,b_a);});struct Cyc_Absyn_Exp*e1=_tmp2A2;
struct Cyc_Absyn_Exp*_tmp2A3=({void*_tmp61F=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp61F,b_b);});struct Cyc_Absyn_Exp*e2=_tmp2A3;
if(e1 != e2){
...
if(({int _tmp626=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(tvs1);_tmp626 != ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(tvs2);}))return 0;{
...
inst=({struct Cyc_List_List*_tmp2AA=_cycalloc(sizeof(*_tmp2AA));({struct _tuple17*_tmp628=({struct _tuple17*_tmp2A9=_cycalloc(sizeof(*_tmp2A9));_tmp2A9->f1=(struct Cyc_Absyn_Tvar*)tvs2->hd,({void*_tmp627=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)tvs1->hd);_tmp2A9->f2=_tmp627;});_tmp2A9;});_tmp2AA->hd=_tmp628;}),_tmp2AA->tl=inst;_tmp2AA;});
tvs1=tvs1->tl;
tvs2=tvs2->tl;}
# 1883
if(inst != 0){
f1.tvars=0;
f2.tvars=0;
return({struct Cyc_RgnOrder_RgnPO*_tmp62B=po;struct Cyc_List_List*_tmp62A=assume;void*_tmp629=(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp2AB=_cycalloc(sizeof(*_tmp2AB));_tmp2AB->tag=5,_tmp2AB->f1=f1;_tmp2AB;});Cyc_Tcutil_subtype(_tmp62B,_tmp62A,_tmp629,(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp2AC=_cycalloc(sizeof(*_tmp2AC));_tmp2AC->tag=5,_tmp2AC->f1=f2;_tmp2AC;}));});}}}
# 1890
...
# 1895
if(({int _tmp62C=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(args1);_tmp62C != ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(args2);}))return 0;
# 1897
...
# 1915
if(!({void*_tmp62D=(void*)_check_null(f1.effect);Cyc_Tcutil_subset_effect(1,_tmp62D,(void*)_check_null(f2.effect));}))return 0;
# 1917
...
struct Cyc_List_List*_tmp2D2=({struct Cyc_List_List*_tmp2DA=_cycalloc(sizeof(*_tmp2DA));({struct _tuple15*_tmp62E=({struct _tuple15*_tmp2D9=_cycalloc(sizeof(*_tmp2D9));_tmp2D9->f1=t1,_tmp2D9->f2=t2;_tmp2D9;});_tmp2DA->hd=_tmp62E;}),_tmp2DA->tl=0;_tmp2DA;});struct Cyc_List_List*assump=_tmp2D2;
int _tmp2D3=q_b.real_const || !q_a.real_const;int quals_okay=_tmp2D3;
# 2000 "tcutil.cyc"
int _tmp2D4=
({void*_tmp62F=b_b;Cyc_Unify_unify(_tmp62F,Cyc_Absyn_bounds_one());})&& !Cyc_Tcutil_force_type2bool(0,zt_b);
# 2000
...
struct Cyc_Absyn_Exp*_tmp2D7=({void*_tmp630=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp630,b_a);});struct Cyc_Absyn_Exp*e_a=_tmp2D7;
struct Cyc_Absyn_Exp*_tmp2D8=({void*_tmp631=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp631,b_b);});struct Cyc_Absyn_Exp*e_b=_tmp2D8;
...
int _tmp632=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(ed1->fields))->v);_tmp632 >= ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(ed2->fields))->v);}))
return 3U;
...
({void*_tmp633=(void*)({struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp2E5=_cycalloc(sizeof(*_tmp2E5));_tmp2E5->tag=14,_tmp2E5->f1=t,_tmp2E5->f2=inner,_tmp2E5->f3=0,_tmp2E5->f4=c;_tmp2E5;});e->r=_tmp633;});
e->topt=t;}}
# 2084
...
return({struct Cyc_Absyn_Tvar*_tmp2EA=_cycalloc(sizeof(*_tmp2EA));({struct _fat_ptr*_tmp636=({struct _fat_ptr*_tmp2E9=_cycalloc(sizeof(*_tmp2E9));({struct _fat_ptr _tmp635=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp2E8=({struct Cyc_Int_pa_PrintArg_struct _tmp505;_tmp505.tag=1,_tmp505.f1=(unsigned long)Cyc_Tcutil_tvar_counter ++;_tmp505;});void*_tmp2E6[1];_tmp2E6[0]=& _tmp2E8;({struct _fat_ptr _tmp634=({const char*_tmp2E7="#%d";_tag_fat(_tmp2E7,sizeof(char),4U);});Cyc_aprintf(_tmp634,_tag_fat(_tmp2E6,sizeof(void*),1));});});*_tmp2E9=_tmp635;});_tmp2E9;});_tmp2EA->name=_tmp636;}),_tmp2EA->identity=-1,_tmp2EA->kind=k;_tmp2EA;});}
# 2093
...
if(({struct _fat_ptr _tmp637=(struct _fat_ptr)*var;Cyc_strcmp(_tmp637,({const char*_tmp2F6="return_value";_tag_fat(_tmp2F6,sizeof(char),13U);}));})== 0){
({union Cyc_Relations_RelnOp _tmp638=Cyc_Relations_RReturn();*rop=_tmp638;});
goto _LL0;}{
# 2129
unsigned c=0U;
...
({union Cyc_Relations_RelnOp _tmp639=Cyc_Relations_RParam(c);*rop=_tmp639;});
break;}}}}
# 2137
...
if(vopt != 0 && Cyc_strcmp((struct _fat_ptr)*var,(struct _fat_ptr)*vopt)== 0){
({union Cyc_Relations_RelnOp _tmp63A=Cyc_Relations_RParamNumelts(c);*rop=_tmp63A;});
break;}}}}
# 2149
goto _LL0;}}}default:
 goto _LL0;}_LL0:;}
...
# 2175
return({struct _tuple25*_tmp309=_region_malloc(rgn,sizeof(*_tmp309));({struct _tuple24*_tmp63B=({struct _tuple24*_tmp308=_region_malloc(rgn,sizeof(*_tmp308));_tmp308->f1=(*y).f1,_tmp308->f2=(*y).f2;_tmp308;});_tmp309->f1=_tmp63B;}),_tmp309->f2=(*y).f3;_tmp309;});}
# 2177
...
return new_e1 == e1?e:({struct Cyc_Absyn_Exp*_tmp63E=e;Cyc_Tcutil_copye(_tmp63E,(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp31C=_cycalloc(sizeof(*_tmp31C));_tmp31C->tag=3,_tmp31C->f1=p,({struct Cyc_List_List*_tmp63D=({struct Cyc_Absyn_Exp*_tmp31B[1];_tmp31B[0]=new_e1;({struct Cyc_List_List*(*_tmp63C)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmp63C(_tag_fat(_tmp31B,sizeof(struct Cyc_Absyn_Exp*),1));});});_tmp31C->f2=_tmp63D;});_tmp31C;}));});}else{
...
return({struct Cyc_Absyn_Exp*_tmp641=e;Cyc_Tcutil_copye(_tmp641,(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp322=_cycalloc(sizeof(*_tmp322));_tmp322->tag=3,_tmp322->f1=p,({struct Cyc_List_List*_tmp640=({struct Cyc_Absyn_Exp*_tmp321[2];_tmp321[0]=new_e1,_tmp321[1]=new_e2;({struct Cyc_List_List*(*_tmp63F)(struct _fat_ptr)=({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;});_tmp63F(_tag_fat(_tmp321,sizeof(struct Cyc_Absyn_Exp*),2));});});_tmp322->f2=_tmp640;});_tmp322;}));});}}
# 2215
return({struct Cyc_Warn_String_Warn_Warg_struct _tmp324=({struct Cyc_Warn_String_Warn_Warg_struct _tmp506;_tmp506.tag=0,({struct _fat_ptr _tmp642=({const char*_tmp325="primop does not have 1 or 2 args!";_tag_fat(_tmp325,sizeof(char),34U);});_tmp506.f1=_tmp642;});_tmp506;});void*_tmp323[1];_tmp323[0]=& _tmp324;({struct Cyc_Absyn_Exp*(*_tmp643)(struct _fat_ptr)=({(struct Cyc_Absyn_Exp*(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp643(_tag_fat(_tmp323,sizeof(void*),1));});});}case 6: _tmp313=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp312)->f1;_tmp314=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp312)->f2;_tmp317=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp312)->f3;{struct Cyc_Absyn_Exp*e1=_tmp313;struct Cyc_Absyn_Exp*e2=_tmp314;struct Cyc_Absyn_Exp*e3=_tmp317;
# 2217
...
if(new_e1 == e1 && new_e2 == e2)return e;
return({struct Cyc_Absyn_Exp*_tmp645=e;Cyc_Tcutil_copye(_tmp645,(void*)({struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_tmp32C=_cycalloc(sizeof(*_tmp32C));_tmp32C->tag=7,_tmp32C->f1=new_e1,_tmp32C->f2=new_e2;_tmp32C;}));});}case 8: _tmp313=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp312)->f1;_tmp314=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp312)->f2;{struct Cyc_Absyn_Exp*e1=_tmp313;struct Cyc_Absyn_Exp*e2=_tmp314;
# 2228
...
return e;}}else{
return({struct Cyc_Absyn_Exp*_tmp64D=e;Cyc_Tcutil_copye(_tmp64D,(void*)({struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp342=_cycalloc(sizeof(*_tmp342));_tmp342->tag=39,_tmp342->f1=new_typ;_tmp342;}));});};}}default:
# 2262
 return({struct Cyc_Warn_String_Warn_Warg_struct _tmp344=({struct Cyc_Warn_String_Warn_Warg_struct _tmp507;_tmp507.tag=0,({struct _fat_ptr _tmp64E=({const char*_tmp345="non-type-level-expression in Tcutil::rsubsexp";_tag_fat(_tmp345,sizeof(char),46U);});_tmp507.f1=_tmp64E;});_tmp507;});void*_tmp343[1];_tmp343[0]=& _tmp344;({struct Cyc_Absyn_Exp*(*_tmp64F)(struct _fat_ptr)=({(struct Cyc_Absyn_Exp*(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp64F(_tag_fat(_tmp343,sizeof(void*),1));});});};}
# 2266
...
return t;
return Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp508;_tmp508.elt_type=new_t1,_tmp508.elt_tq=tq,(_tmp508.ptr_atts).rgn=new_r,(_tmp508.ptr_atts).nullable=n,(_tmp508.ptr_atts).bounds=new_b,(_tmp508.ptr_atts).zero_term=new_zt,(_tmp508.ptr_atts).ptrloc=0,(_tmp508.ptr_atts).autoreleased=new_rel;_tmp508;}));}case 5: _tmp359=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).tvars;_tmp35A=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).effect;_tmp35C=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).ret_tqual;_tmp35D=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).ret_type;_tmp35E=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).args;_tmp35F=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).c_varargs;_tmp360=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).cyc_varargs;_tmp361=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).rgn_po;_tmp362=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).attributes;_tmp363=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).requires_clause;_tmp364=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).ensures_clause;_tmp365=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).return_value;{struct Cyc_List_List*vs=_tmp359;void*eff=_tmp35A;struct Cyc_Absyn_Tqual rtq=_tmp35C;void*rtyp=_tmp35D;struct Cyc_List_List*args=_tmp35E;int c_varargs=_tmp35F;struct Cyc_Absyn_VarargInfo*cyc_varargs=_tmp360;struct Cyc_List_List*rgn_po=_tmp361;struct Cyc_List_List*atts=_tmp362;struct Cyc_Absyn_Exp*req=_tmp363;struct Cyc_Absyn_Exp*ens=_tmp364;struct Cyc_Absyn_Vardecl*ret_value=_tmp365;
# 2339
if(Cyc_Tcutil_skip_fntypes)return t;
# 2341
{struct Cyc_List_List*_tmp378=vs;struct Cyc_List_List*p=_tmp378;for(0;p != 0;p=p->tl){
inst=({struct Cyc_List_List*_tmp37A=_region_malloc(rgn,sizeof(*_tmp37A));({struct _tuple17*_tmp651=({struct _tuple17*_tmp379=_region_malloc(rgn,sizeof(*_tmp379));_tmp379->f1=(struct Cyc_Absyn_Tvar*)p->hd,({void*_tmp650=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)p->hd);_tmp379->f2=_tmp650;});_tmp379;});_tmp37A->hd=_tmp651;}),_tmp37A->tl=inst;_tmp37A;});}}{
struct _tuple0 _tmp37B=({struct _tuple0(*_tmp654)(struct _RegionHandle*,struct _RegionHandle*,struct Cyc_List_List*)=({(struct _tuple0(*)(struct _RegionHandle*,struct _RegionHandle*,struct Cyc_List_List*))Cyc_List_rsplit;});struct _RegionHandle*_tmp653=rgn;struct _RegionHandle*_tmp652=rgn;_tmp654(_tmp653,_tmp652,
...
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp38B=_cycalloc(sizeof(*_tmp38B));_tmp38B->tag=5,(_tmp38B->f1).tvars=vs,(_tmp38B->f1).effect=eff2,(_tmp38B->f1).ret_tqual=rtq,({void*_tmp655=Cyc_Tcutil_rsubstitute(rgn,inst,rtyp);(_tmp38B->f1).ret_type=_tmp655;}),(_tmp38B->f1).args=args2,(_tmp38B->f1).c_varargs=c_varargs,(_tmp38B->f1).cyc_varargs=cyc_varargs2,(_tmp38B->f1).rgn_po=rgn_po2,(_tmp38B->f1).attributes=atts,(_tmp38B->f1).requires_clause=req2,(_tmp38B->f1).requires_relns=req_relns2,(_tmp38B->f1).ensures_clause=ens2,(_tmp38B->f1).ensures_relns=ens_relns2,(_tmp38B->f1).return_value=ret_value;_tmp38B;});}}}}}case 6: _tmp359=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp358)->f1;{struct Cyc_List_List*tqts=_tmp359;
# 2368
...
# 2377
return !change?t:(void*)({struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmp390=_cycalloc(sizeof(*_tmp390));_tmp390->tag=6,({struct Cyc_List_List*_tmp658=({struct Cyc_List_List*(*_tmp657)(struct _tuple12*(*)(struct _tuple12*,void*),struct Cyc_List_List*,struct Cyc_List_List*)=({(struct Cyc_List_List*(*)(struct _tuple12*(*)(struct _tuple12*,void*),struct Cyc_List_List*,struct Cyc_List_List*))Cyc_List_map2;});struct Cyc_List_List*_tmp656=tqts;_tmp657(Cyc_Tcutil_map2_tq,_tmp656,({(struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev;})(ts2));});_tmp390->f1=_tmp658;});_tmp390;});}case 7: _tmp35B=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp358)->f1;_tmp359=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp358)->f2;{enum Cyc_Absyn_AggrKind k=_tmp35B;struct Cyc_List_List*fs=_tmp359;
# 2379
...
# 2393
 if(Cyc_Tcutil_skip_fntypes)return t;
({struct Cyc_Warn_String_Warn_Warg_struct _tmp39A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp509;_tmp509.tag=0,({struct _fat_ptr _tmp659=({const char*_tmp39B="found typedecltype in rsubs";_tag_fat(_tmp39B,sizeof(char),28U);});_tmp509.f1=_tmp659;});_tmp509;});void*_tmp399[1];_tmp399[0]=& _tmp39A;({int(*_tmp65A)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp65A(_tag_fat(_tmp399,sizeof(void*),1));});});};}
# 2398
...
return({struct _tuple17*_tmp3A4=_cycalloc(sizeof(*_tmp3A4));_tmp3A4->f1=tv,({void*_tmp65C=({struct Cyc_Core_Opt*_tmp65B=k;Cyc_Absyn_new_evar(_tmp65B,({struct Cyc_Core_Opt*_tmp3A3=_cycalloc(sizeof(*_tmp3A3));_tmp3A3->v=s;_tmp3A3;}));});_tmp3A4->f2=_tmp65C;});_tmp3A4;});}struct _tuple26{struct Cyc_List_List*f1;struct _RegionHandle*f2;};
# 2429
...
return({struct _tuple17*_tmp3AA=_region_malloc(rgn,sizeof(*_tmp3AA));_tmp3AA->f1=tv,({void*_tmp65E=({struct Cyc_Core_Opt*_tmp65D=k;Cyc_Absyn_new_evar(_tmp65D,({struct Cyc_Core_Opt*_tmp3A9=_cycalloc(sizeof(*_tmp3A9));_tmp3A9->v=s;_tmp3A9;}));});_tmp3AA->f2=_tmp65E;});_tmp3AA;});}}
# 2436
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3AC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50C;_tmp50C.tag=0,({struct _fat_ptr _tmp65F=({const char*_tmp3B0="bitfield ";_tag_fat(_tmp3B0,sizeof(char),10U);});_tmp50C.f1=_tmp65F;});_tmp50C;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3AD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50B;_tmp50B.tag=0,_tmp50B.f1=*fn;_tmp50B;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3AE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50A;_tmp50A.tag=0,({struct _fat_ptr _tmp660=({const char*_tmp3AF=" does not have constant width";_tag_fat(_tmp3AF,sizeof(char),30U);});_tmp50A.f1=_tmp660;});_tmp50A;});void*_tmp3AB[3];_tmp3AB[0]=& _tmp3AC,_tmp3AB[1]=& _tmp3AD,_tmp3AB[2]=& _tmp3AE;({unsigned _tmp661=loc;Cyc_Warn_err2(_tmp661,_tag_fat(_tmp3AB,sizeof(void*),3));});});else{
# 2443
...
if(!known)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50D;_tmp50D.tag=0,({struct _fat_ptr _tmp662=({const char*_tmp3B7="cannot evaluate bitfield width at compile time";_tag_fat(_tmp3B7,sizeof(char),47U);});_tmp50D.f1=_tmp662;});_tmp50D;});void*_tmp3B5[1];_tmp3B5[0]=& _tmp3B6;({unsigned _tmp663=loc;Cyc_Warn_warn2(_tmp663,_tag_fat(_tmp3B5,sizeof(void*),1));});});
if((int)i < 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50E;_tmp50E.tag=0,({struct _fat_ptr _tmp664=({const char*_tmp3BA="bitfield has negative width";_tag_fat(_tmp3BA,sizeof(char),28U);});_tmp50E.f1=_tmp664;});_tmp50E;});void*_tmp3B8[1];_tmp3B8[0]=& _tmp3B9;({unsigned _tmp665=loc;Cyc_Warn_err2(_tmp665,_tag_fat(_tmp3B8,sizeof(void*),1));});});
w=i;}}{
# 2450
...
# 2462
if(bad)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50F;_tmp50F.tag=0,({struct _fat_ptr _tmp666=({const char*_tmp3C1="bitfield larger than type";_tag_fat(_tmp3C1,sizeof(char),26U);});_tmp50F.f1=_tmp666;});_tmp50F;});void*_tmp3BF[1];_tmp3BF[0]=& _tmp3C0;({unsigned _tmp667=loc;Cyc_Warn_warn2(_tmp667,_tag_fat(_tmp3BF,sizeof(void*),1));});});
goto _LL3;}}else{goto _LL6;}}else{_LL6:
# 2466
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp513;_tmp513.tag=0,({struct _fat_ptr _tmp668=({const char*_tmp3C8="bitfield ";_tag_fat(_tmp3C8,sizeof(char),10U);});_tmp513.f1=_tmp668;});_tmp513;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3C4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp512;_tmp512.tag=0,_tmp512.f1=*fn;_tmp512;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3C5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp511;_tmp511.tag=0,({struct _fat_ptr _tmp669=({const char*_tmp3C7=" must have integral type but has type ";_tag_fat(_tmp3C7,sizeof(char),39U);});_tmp511.f1=_tmp669;});_tmp511;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp3C6=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp510;_tmp510.tag=2,_tmp510.f1=(void*)field_type;_tmp510;});void*_tmp3C2[4];_tmp3C2[0]=& _tmp3C3,_tmp3C2[1]=& _tmp3C4,_tmp3C2[2]=& _tmp3C5,_tmp3C2[3]=& _tmp3C6;({unsigned _tmp66A=loc;Cyc_Warn_err2(_tmp66A,_tag_fat(_tmp3C2,sizeof(void*),4));});});
# 2468
goto _LL3;}_LL3:;}}}
# 2475
...
if(declared_const)({struct Cyc_Warn_String_Warn_Warg_struct _tmp3CD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp514;_tmp514.tag=0,({struct _fat_ptr _tmp66B=({const char*_tmp3CE="extra const";_tag_fat(_tmp3CE,sizeof(char),12U);});_tmp514.f1=_tmp66B;});_tmp514;});void*_tmp3CC[1];_tmp3CC[0]=& _tmp3CD;({unsigned _tmp66C=loc;Cyc_Warn_warn2(_tmp66C,_tag_fat(_tmp3CC,sizeof(void*),1));});});
return 1;}
# 2483
if((unsigned)tdopt)
...
if(tv->identity == -1)
({int _tmp66D=Cyc_Tcutil_new_tvar_id();tv->identity=_tmp66D;});}
# 2494
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3D0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp517;_tmp517.tag=0,_tmp517.f1=msg;_tmp517;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3D1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp516;_tmp516.tag=0,({struct _fat_ptr _tmp66E=({const char*_tmp3D3=": ";_tag_fat(_tmp3D3,sizeof(char),3U);});_tmp516.f1=_tmp66E;});_tmp516;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3D2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp515;_tmp515.tag=0,({struct _fat_ptr _tmp66F=a2string(vs->hd);_tmp515.f1=_tmp66F;});_tmp515;});void*_tmp3CF[3];_tmp3CF[0]=& _tmp3D0,_tmp3CF[1]=& _tmp3D1,_tmp3CF[2]=& _tmp3D2;({unsigned _tmp670=loc;Cyc_Warn_err2(_tmp670,_tag_fat(_tmp3CF,sizeof(void*),3));});});}}}
# 2508
...
({void(*_tmp673)(int(*)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*,unsigned,struct _fat_ptr(*)(struct Cyc_Absyn_Tvar*),struct _fat_ptr)=({(void(*)(int(*)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*,unsigned,struct _fat_ptr(*)(struct Cyc_Absyn_Tvar*),struct _fat_ptr))Cyc_Tcutil_check_unique_unsorted;});struct Cyc_List_List*_tmp672=tvs;unsigned _tmp671=loc;_tmp673(Cyc_Absyn_tvar_cmp,_tmp672,_tmp671,Cyc_Absynpp_tvar2string,({const char*_tmp3D4="duplicate type variable";_tag_fat(_tmp3D4,sizeof(char),24U);}));});}struct _tuple27{struct Cyc_Absyn_Aggrfield*f1;int f2;};struct _tuple28{struct Cyc_List_List*f1;void*f2;};struct _tuple29{struct Cyc_Absyn_Aggrfield*f1;void*f2;};
# 2529 "tcutil.cyc"
...
if(({struct _fat_ptr _tmp674=(struct _fat_ptr)*((struct Cyc_Absyn_Aggrfield*)sd_fields->hd)->name;Cyc_strcmp(_tmp674,({const char*_tmp3D6="";_tag_fat(_tmp3D6,sizeof(char),1U);}));})!= 0)
fields=({struct Cyc_List_List*_tmp3D8=_region_malloc(temp,sizeof(*_tmp3D8));({struct _tuple27*_tmp675=({struct _tuple27*_tmp3D7=_region_malloc(temp,sizeof(*_tmp3D7));_tmp3D7->f1=(struct Cyc_Absyn_Aggrfield*)sd_fields->hd,_tmp3D7->f2=0;_tmp3D7;});_tmp3D8->hd=_tmp675;}),_tmp3D8->tl=fields;_tmp3D8;});}}
...
({struct Cyc_List_List*_tmp677=({struct Cyc_List_List*_tmp3DF=_cycalloc(sizeof(*_tmp3DF));({void*_tmp676=(void*)({struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_tmp3DE=_cycalloc(sizeof(*_tmp3DE));_tmp3DE->tag=1,_tmp3DE->f1=((*((struct _tuple27*)fields2->hd)).f1)->name;_tmp3DE;});_tmp3DF->hd=_tmp676;}),_tmp3DF->tl=0;_tmp3DF;});(*((struct _tuple28*)des->hd)).f1=_tmp677;});
ans=({struct Cyc_List_List*_tmp3E1=_region_malloc(rgn,sizeof(*_tmp3E1));({struct _tuple29*_tmp678=({struct _tuple29*_tmp3E0=_region_malloc(rgn,sizeof(*_tmp3E0));_tmp3E0->f1=(*((struct _tuple27*)fields2->hd)).f1,_tmp3E0->f2=a;_tmp3E0;});_tmp3E1->hd=_tmp678;}),_tmp3E1->tl=ans;_tmp3E1;});
break;}}
# 2560
if(fields2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3E3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp519;_tmp519.tag=0,({struct _fat_ptr _tmp679=({const char*_tmp3E5="too many arguments to ";_tag_fat(_tmp3E5,sizeof(char),23U);});_tmp519.f1=_tmp679;});_tmp519;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3E4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp518;_tmp518.tag=0,_tmp518.f1=aggr_str;_tmp518;});void*_tmp3E2[2];_tmp3E2[0]=& _tmp3E3,_tmp3E2[1]=& _tmp3E4;({unsigned _tmp67A=loc;Cyc_Warn_err2(_tmp67A,_tag_fat(_tmp3E2,sizeof(void*),2));});});}else{
if(dl->tl != 0)
# 2564
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3E7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51A;_tmp51A.tag=0,({struct _fat_ptr _tmp67B=({const char*_tmp3E8="multiple designators are not yet supported";_tag_fat(_tmp3E8,sizeof(char),43U);});_tmp51A.f1=_tmp67B;});_tmp51A;});void*_tmp3E6[1];_tmp3E6[0]=& _tmp3E7;({unsigned _tmp67C=loc;Cyc_Warn_err2(_tmp67C,_tag_fat(_tmp3E6,sizeof(void*),1));});});else{
# 2567
void*_tmp3E9=(void*)dl->hd;void*_stmttmp66=_tmp3E9;void*_tmp3EA=_stmttmp66;void*_tmp3EB;if(*((int*)_tmp3EA)== 0){
# 2569
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3ED=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51C;_tmp51C.tag=0,({struct _fat_ptr _tmp67D=({const char*_tmp3EF="array designator used in argument to ";_tag_fat(_tmp3EF,sizeof(char),38U);});_tmp51C.f1=_tmp67D;});_tmp51C;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3EE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51B;_tmp51B.tag=0,_tmp51B.f1=aggr_str;_tmp51B;});void*_tmp3EC[2];_tmp3EC[0]=& _tmp3ED,_tmp3EC[1]=& _tmp3EE;({unsigned _tmp67E=loc;Cyc_Warn_err2(_tmp67E,_tag_fat(_tmp3EC,sizeof(void*),2));});});
...
if((*((struct _tuple27*)fields2->hd)).f2)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3F2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51F;_tmp51F.tag=0,({struct _fat_ptr _tmp67F=({const char*_tmp3F6="member ";_tag_fat(_tmp3F6,sizeof(char),8U);});_tmp51F.f1=_tmp67F;});_tmp51F;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3F3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51E;_tmp51E.tag=0,_tmp51E.f1=*v;_tmp51E;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3F4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51D;_tmp51D.tag=0,({struct _fat_ptr _tmp680=({const char*_tmp3F5=" has already been used as an argument";_tag_fat(_tmp3F5,sizeof(char),38U);});_tmp51D.f1=_tmp680;});_tmp51D;});void*_tmp3F1[3];_tmp3F1[0]=& _tmp3F2,_tmp3F1[1]=& _tmp3F3,_tmp3F1[2]=& _tmp3F4;({unsigned _tmp681=loc;Cyc_Warn_err2(_tmp681,_tag_fat(_tmp3F1,sizeof(void*),3));});});
(*((struct _tuple27*)fields2->hd)).f2=1;
ans=({struct Cyc_List_List*_tmp3F8=_region_malloc(rgn,sizeof(*_tmp3F8));({struct _tuple29*_tmp682=({struct _tuple29*_tmp3F7=_region_malloc(rgn,sizeof(*_tmp3F7));_tmp3F7->f1=(*((struct _tuple27*)fields2->hd)).f1,_tmp3F7->f2=a;_tmp3F7;});_tmp3F8->hd=_tmp682;}),_tmp3F8->tl=ans;_tmp3F8;});
break;}}
# 2581
if(fields2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp521;_tmp521.tag=0,({struct _fat_ptr _tmp683=({const char*_tmp3FC="bad field designator ";_tag_fat(_tmp3FC,sizeof(char),22U);});_tmp521.f1=_tmp683;});_tmp521;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3FB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp520;_tmp520.tag=0,_tmp520.f1=*v;_tmp520;});void*_tmp3F9[2];_tmp3F9[0]=& _tmp3FA,_tmp3F9[1]=& _tmp3FB;({unsigned _tmp684=loc;Cyc_Warn_err2(_tmp684,_tag_fat(_tmp3F9,sizeof(void*),2));});});
goto _LL3;}}_LL3:;}}}}
# 2588
if((int)aggr_kind == 0){
if(({int _tmp685=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(ans);_tmp685 < ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(fields);}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp522;_tmp522.tag=0,({struct _fat_ptr _tmp686=({const char*_tmp3FF="too few arguments to struct";_tag_fat(_tmp3FF,sizeof(char),28U);});_tmp522.f1=_tmp686;});_tmp522;});void*_tmp3FD[1];_tmp3FD[0]=& _tmp3FE;({unsigned _tmp687=loc;Cyc_Warn_err2(_tmp687,_tag_fat(_tmp3FD,sizeof(void*),1));});});}else{
if(({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(ans)!= 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp401=({struct Cyc_Warn_String_Warn_Warg_struct _tmp523;_tmp523.tag=0,({struct _fat_ptr _tmp688=({const char*_tmp402="union expression should have one member";_tag_fat(_tmp402,sizeof(char),40U);});_tmp523.f1=_tmp688;});_tmp523;});void*_tmp400[1];_tmp400[0]=& _tmp401;({unsigned _tmp689=loc;Cyc_Warn_err2(_tmp689,_tag_fat(_tmp400,sizeof(void*),1));});});}{
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp40A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp525;_tmp525.tag=0,({struct _fat_ptr _tmp68A=({const char*_tmp40C="we have a cast in a lhs: ";_tag_fat(_tmp40C,sizeof(char),26U);});_tmp525.f1=_tmp68A;});_tmp525;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp40B=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp524;_tmp524.tag=4,_tmp524.f1=e1;_tmp524;});void*_tmp409[2];_tmp409[0]=& _tmp40A,_tmp409[1]=& _tmp40B;({int(*_tmp68B)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp68B(_tag_fat(_tmp409,sizeof(void*),2));});});case 20: _tmp408=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp407)->f1;{struct Cyc_Absyn_Exp*e1a=_tmp408;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp40E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp527;_tmp527.tag=0,({struct _fat_ptr _tmp68C=({const char*_tmp410="found zero pointer aggregate member assignment: ";_tag_fat(_tmp410,sizeof(char),49U);});_tmp527.f1=_tmp68C;});_tmp527;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp40F=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp526;_tmp526.tag=4,_tmp526.f1=e1;_tmp526;});void*_tmp40D[2];_tmp40D[0]=& _tmp40E,_tmp40D[1]=& _tmp40F;({int(*_tmp68D)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp68D(_tag_fat(_tmp40D,sizeof(void*),2));});});
...
# 2614
if(Cyc_Tcutil_is_zero_ptr_type((void*)_check_null(e1a->topt),ptr_type,is_fat,elt_type))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp412=({struct Cyc_Warn_String_Warn_Warg_struct _tmp529;_tmp529.tag=0,({struct _fat_ptr _tmp68E=({const char*_tmp414="found zero pointer instantiate/noinstantiate: ";_tag_fat(_tmp414,sizeof(char),47U);});_tmp529.f1=_tmp68E;});_tmp529;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp413=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp528;_tmp528.tag=4,_tmp528.f1=e1;_tmp528;});void*_tmp411[2];_tmp411[0]=& _tmp412,_tmp411[1]=& _tmp413;({int(*_tmp68F)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp68F(_tag_fat(_tmp411,sizeof(void*),2));});});
return 0;}case 1:
 return 0;default:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp416=({struct Cyc_Warn_String_Warn_Warg_struct _tmp52B;_tmp52B.tag=0,({struct _fat_ptr _tmp690=({const char*_tmp418="found bad lhs in is_zero_ptr_deref: ";_tag_fat(_tmp418,sizeof(char),37U);});_tmp52B.f1=_tmp690;});_tmp52B;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp417=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp52A;_tmp52A.tag=4,_tmp52A.f1=e1;_tmp52A;});void*_tmp415[2];_tmp415[0]=& _tmp416,_tmp415[1]=& _tmp417;({int(*_tmp691)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp691(_tag_fat(_tmp415,sizeof(void*),2));});});};}
# 2628
...
# 2641
({struct Cyc_Core_Opt*_tmp693=({struct Cyc_Core_Opt*_tmp426=_cycalloc(sizeof(*_tmp426));({void*_tmp692=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp425=_cycalloc(sizeof(*_tmp425));_tmp425->tag=2,_tmp425->f1=0,_tmp425->f2=& Cyc_Kinds_rk;_tmp425;});_tmp426->v=_tmp692;});_tmp426;});*x=_tmp693;});
...
# 2663
({struct Cyc_Core_Opt*_tmp696=({struct Cyc_Core_Opt*_tmp435=_cycalloc(sizeof(*_tmp435));({void*_tmp695=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp434=_cycalloc(sizeof(*_tmp434));_tmp434->tag=2,_tmp434->f1=0,({struct Cyc_Absyn_Kind*_tmp694=({struct Cyc_Absyn_Kind*_tmp433=_cycalloc(sizeof(*_tmp433));_tmp433->kind=k,_tmp433->aliasqual=0U;_tmp433;});_tmp434->f2=_tmp694;});_tmp434;});_tmp435->v=_tmp695;});_tmp435;});*x=_tmp696;});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp44C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp52C;_tmp52C.tag=0,({struct _fat_ptr _tmp697=({const char*_tmp44D="is_noalias_stmt_exp: ill-formed StmtExp";_tag_fat(_tmp44D,sizeof(char),40U);});_tmp52C.f1=_tmp697;});_tmp52C;});void*_tmp44B[1];_tmp44B[0]=& _tmp44C;({int(*_tmp698)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp698(_tag_fat(_tmp44B,sizeof(void*),1));});});}_LL1A:;}}default: _LL13:
# 2743
 return 1;};}
# 2760 "tcutil.cyc"
...
if(finfo != 0)
return({struct _tuple14 _tmp536;_tmp536.f1=((*finfo).f1).real_const,({void*_tmp699=(Cyc_Tcutil_addressof_props(e1)).f2;_tmp536.f2=_tmp699;});_tmp536;});
...
# 2857
return({struct _tuple14 _tmp538;_tmp538.f1=tq.real_const,({void*_tmp69A=(Cyc_Tcutil_addressof_props(e1)).f2;_tmp538.f2=_tmp69A;});_tmp538;});}default:
 return bogus_ans;};}default:
# 2861
({struct Cyc_Warn_String_Warn_Warg_struct _tmp47A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp539;_tmp539.tag=0,({struct _fat_ptr _tmp69B=({const char*_tmp47B="unary & applied to non-lvalue";_tag_fat(_tmp47B,sizeof(char),30U);});_tmp539.f1=_tmp69B;});_tmp539;});void*_tmp479[1];_tmp479[0]=& _tmp47A;({unsigned _tmp69C=e->loc;Cyc_Warn_err2(_tmp69C,_tag_fat(_tmp479,sizeof(void*),1));});});
return bogus_ans;};}
# 2868
void Cyc_Tcutil_check_bound(unsigned loc,unsigned i,void*b,int do_warn){
struct Cyc_Absyn_Exp*_tmp47C=({void*_tmp69D=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp69D,b);});struct Cyc_Absyn_Exp*eopt=_tmp47C;
if(eopt == 0)return;{
...
if(known && j <= i)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp482=({struct Cyc_Warn_String_Warn_Warg_struct _tmp53E;_tmp53E.tag=0,({struct _fat_ptr _tmp69E=({const char*_tmp487="a dereference is out of bounds: ";_tag_fat(_tmp487,sizeof(char),33U);});_tmp53E.f1=_tmp69E;});_tmp53E;});struct Cyc_Warn_Int_Warn_Warg_struct _tmp483=({struct Cyc_Warn_Int_Warn_Warg_struct _tmp53D;_tmp53D.tag=12,_tmp53D.f1=(int)j;_tmp53D;});struct Cyc_Warn_String_Warn_Warg_struct _tmp484=({struct Cyc_Warn_String_Warn_Warg_struct _tmp53C;_tmp53C.tag=0,({
struct _fat_ptr _tmp69F=({const char*_tmp486=" <= ";_tag_fat(_tmp486,sizeof(char),5U);});_tmp53C.f1=_tmp69F;});_tmp53C;});struct Cyc_Warn_Int_Warn_Warg_struct _tmp485=({struct Cyc_Warn_Int_Warn_Warg_struct _tmp53B;_tmp53B.tag=12,_tmp53B.f1=(int)i;_tmp53B;});void*_tmp481[4];_tmp481[0]=& _tmp482,_tmp481[1]=& _tmp483,_tmp481[2]=& _tmp484,_tmp481[3]=& _tmp485;({void(*_tmp6A1)(unsigned,struct _fat_ptr)=
# 2873
do_warn?Cyc_Warn_warn2: Cyc_Warn_err2;unsigned _tmp6A0=loc;_tmp6A1(_tmp6A0,_tag_fat(_tmp481,sizeof(void*),4));});});
# 2875
return;}}}
# 2878
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4A9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp541;_tmp541.tag=0,({struct _fat_ptr _tmp6A2=({const char*_tmp4AD="qualifier within typedef type ";_tag_fat(_tmp4AD,sizeof(char),31U);});_tmp541.f1=_tmp6A2;});_tmp541;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4AA=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp540;_tmp540.tag=2,_tmp540.f1=(void*)t;_tmp540;});struct Cyc_Warn_String_Warn_Warg_struct _tmp4AB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp53F;_tmp53F.tag=0,({struct _fat_ptr _tmp6A3=({const char*_tmp4AC=" is ignored";_tag_fat(_tmp4AC,sizeof(char),12U);});_tmp53F.f1=_tmp6A3;});_tmp53F;});void*_tmp4A8[3];_tmp4A8[0]=& _tmp4A9,_tmp4A8[1]=& _tmp4AA,_tmp4A8[2]=& _tmp4AB;({unsigned _tmp6A4=loc;Cyc_Warn_warn2(_tmp6A4,_tag_fat(_tmp4A8,sizeof(void*),3));});});
return;}}}else{
return;};}
# 3021
...
return({void*_tmp6A5=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp6A5,(pi.ptr_atts).bounds);});}case 4: _tmp4B0=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp4AF)->f1).num_elts;{struct Cyc_Absyn_Exp*e=_tmp4B0;
return e;}default:
 return 0;};}
# 3031
...
if(convert_tag){
if(eopt->topt == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4BE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp542;_tmp542.tag=0,({struct _fat_ptr _tmp6A6=({const char*_tmp4BF="cannot convert tag without type!";_tag_fat(_tmp4BF,sizeof(char),33U);});_tmp542.f1=_tmp6A6;});_tmp542;});void*_tmp4BD[1];_tmp4BD[0]=& _tmp4BE;({int(*_tmp6A7)(struct _fat_ptr)=({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;});_tmp6A7(_tag_fat(_tmp4BD,sizeof(void*),1));});});{
