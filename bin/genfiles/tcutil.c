...
*elt_type=elt;
*is_fat=0;
({void*_tmp6B7=Cyc_Tcutil_promote_array(t,Cyc_Absyn_heap_rgn_type,0);*ptr_type=_tmp6B7;});
...
struct Cyc_Absyn_Exp*_tmp39=({void*_tmp6B8=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp6B8,b);});struct Cyc_Absyn_Exp*eopt=_tmp39;
if(eopt == 0)return 0;{
...
return({struct Cyc_Absyn_Tvar*_tmp61=_cycalloc(sizeof(*_tmp61));_tmp61->name=tv->name,_tmp61->identity=- 1,({void*_tmp6B9=Cyc_Tcutil_copy_kindbound(tv->kind);_tmp61->kind=_tmp6B9;});_tmp61;});}
# 358
...
return({struct _tuple9*_tmp66=_cycalloc(sizeof(*_tmp66));_tmp66->f1=x,_tmp66->f2=y,({void*_tmp6BA=Cyc_Tcutil_copy_type(t);_tmp66->f3=_tmp6BA;});_tmp66;});}}
# 362
static struct _tuple12*Cyc_Tcutil_copy_tqt(struct _tuple12*arg){
return({struct _tuple12*_tmp67=_cycalloc(sizeof(*_tmp67));_tmp67->f1=(*arg).f1,({void*_tmp6BB=Cyc_Tcutil_copy_type((*arg).f2);_tmp67->f2=_tmp6BB;});_tmp67;});}
# 365
...
return({struct Cyc_Absyn_Aggrfield*_tmp68=_cycalloc(sizeof(*_tmp68));_tmp68->name=f->name,_tmp68->tq=f->tq,({void*_tmp6BD=Cyc_Tcutil_copy_type(f->type);_tmp68->type=_tmp6BD;}),_tmp68->width=f->width,_tmp68->attributes=f->attributes,({
struct Cyc_Absyn_Exp*_tmp6BC=Cyc_Tcutil_deep_copy_exp_opt(1,f->requires_clause);_tmp68->requires_clause=_tmp6BC;});_tmp68;});}struct _tuple15{void*f1;void*f2;};
# 372
...
return({struct _tuple15*_tmp6C=_cycalloc(sizeof(*_tmp6C));({void*_tmp6BF=Cyc_Tcutil_copy_type(r1);_tmp6C->f1=_tmp6BF;}),({void*_tmp6BE=Cyc_Tcutil_copy_type(r2);_tmp6C->f2=_tmp6BE;});_tmp6C;});}}
# 376
...
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp98=_cycalloc(sizeof(*_tmp98));_tmp98->tag=0U,_tmp98->f1=c,({struct Cyc_List_List*_tmp6C0=((struct Cyc_List_List*(*)(void*(*f)(void*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_copy_type,ts);_tmp98->f2=_tmp6C0;});_tmp98;});}}case 1U: _LL5: _LL6:
...
# 396
return(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmpA0=_cycalloc(sizeof(*_tmpA0));_tmpA0->tag=4U,({void*_tmp6C3=Cyc_Tcutil_copy_type(et);(_tmpA0->f1).elt_type=_tmp6C3;}),(_tmpA0->f1).tq=tq,({struct Cyc_Absyn_Exp*_tmp6C2=Cyc_Tcutil_deep_copy_exp_opt(1,eo);(_tmpA0->f1).num_elts=_tmp6C2;}),({
void*_tmp6C1=Cyc_Tcutil_copy_type(zt);(_tmpA0->f1).zero_term=_tmp6C1;}),(_tmpA0->f1).zt_loc=ztl;_tmpA0;});}case 5U: _LLD: _tmp7A=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).tvars;_tmp7B=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).effect;_tmp7C=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).ret_tqual;_tmp7D=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).ret_type;_tmp7E=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).args;_tmp7F=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).c_varargs;_tmp80=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).cyc_varargs;_tmp81=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).rgn_po;_tmp82=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).attributes;_tmp83=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).requires_clause;_tmp84=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).requires_relns;_tmp85=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).ensures_clause;_tmp86=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).ensures_relns;_tmp87=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6E)->f1).return_value;_LLE: {struct Cyc_List_List*tvs=_tmp7A;void*effopt=_tmp7B;struct Cyc_Absyn_Tqual rt_tq=_tmp7C;void*rt=_tmp7D;struct Cyc_List_List*args=_tmp7E;int c_varargs=_tmp7F;struct Cyc_Absyn_VarargInfo*cyc_varargs=_tmp80;struct Cyc_List_List*rgn_po=_tmp81;struct Cyc_List_List*atts=_tmp82;struct Cyc_Absyn_Exp*req=_tmp83;struct Cyc_List_List*req_rlns=_tmp84;struct Cyc_Absyn_Exp*ens=_tmp85;struct Cyc_List_List*ens_rlns=_tmp86;struct Cyc_Absyn_Vardecl*ret_val=_tmp87;
# 399
...
if(cyc_varargs != 0)
({void*_tmp6C4=Cyc_Tcutil_copy_type(cyc_varargs->type);((struct Cyc_Absyn_VarargInfo*)_check_null(cyc_varargs2))->type=_tmp6C4;});{
...
({void*_tmp6C5=Cyc_Tcutil_copy_type(ret_val2->type);ret_val2->type=_tmp6C5;});
if((unsigned)ret_val2->rgn)({void*_tmp6C6=Cyc_Tcutil_copy_type(ret_val2->rgn);ret_val2->rgn=_tmp6C6;});}
# 419
...
# 422
return(void*)({struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmpAE=_cycalloc(sizeof(*_tmpAE));_tmpAE->tag=6U,({struct Cyc_List_List*_tmp6C7=((struct Cyc_List_List*(*)(struct _tuple12*(*f)(struct _tuple12*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_copy_tqt,tqts);_tmpAE->f1=_tmp6C7;});_tmpAE;});}case 7U: _LL11: _tmp77=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp6E)->f1;_tmp78=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp6E)->f2;_LL12: {enum Cyc_Absyn_AggrKind k=_tmp77;struct Cyc_List_List*fs=_tmp78;
return(void*)({struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_tmpAF=_cycalloc(sizeof(*_tmpAF));_tmpAF->tag=7U,_tmpAF->f1=k,({struct Cyc_List_List*_tmp6C8=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Aggrfield*(*f)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_copy_field,fs);_tmpAF->f2=_tmp6C8;});_tmpAF;});}case 9U: _LL13: _tmp76=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp6E)->f1;_LL14: {struct Cyc_Absyn_Exp*e=_tmp76;
...
# 427
return(void*)({struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmpB2=_cycalloc(sizeof(*_tmpB2));_tmpB2->tag=8U,_tmpB2->f1=tdn,({struct Cyc_List_List*_tmp6C9=((struct Cyc_List_List*(*)(void*(*f)(void*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_copy_type,ts);_tmpB2->f2=_tmp6C9;}),_tmpB2->f3=td,_tmpB2->f4=0;_tmpB2;});}default: switch(*((int*)((struct Cyc_Absyn_TypeDecl*)((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp6E)->f1)->r)){case 0U: _LL19: _tmp71=((struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)(((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp6E)->f1)->r)->f1;_LL1A: {struct Cyc_Absyn_Aggrdecl*ad=_tmp71;
# 430
...
return({union Cyc_Absyn_AggrInfo _tmp6CA=Cyc_Absyn_UnknownAggr(ad->kind,ad->name,0);Cyc_Absyn_aggr_type(_tmp6CA,targs);});}case 1U: _LL1B: _tmp70=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)(((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp6E)->f1)->r)->f1;_LL1C: {struct Cyc_Absyn_Enumdecl*ed=_tmp70;
# 433
...
return({union Cyc_Absyn_DatatypeInfo _tmp6CB=Cyc_Absyn_UnknownDatatype(({struct Cyc_Absyn_UnknownDatatypeInfo _tmp62E;_tmp62E.name=dd->name,_tmp62E.is_extensible=0;_tmp62E;}));Cyc_Absyn_datatype_type(_tmp6CB,targs);});}}}_LL0:;}
# 441
...
return(void*)({struct Cyc_Absyn_ArrayElement_Absyn_Designator_struct*_tmpB8=_cycalloc(sizeof(*_tmpB8));_tmpB8->tag=0U,({struct Cyc_Absyn_Exp*_tmp6CC=Cyc_Tcutil_deep_copy_exp(preserve_types,e);_tmpB8->f1=_tmp6CC;});_tmpB8;});}}else{_LL3: _tmpB6=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmpB5)->f1;_LL4: {struct _fat_ptr*v=_tmpB6;
...
# 449
return({struct _tuple16*_tmpB9=_cycalloc(sizeof(*_tmpB9));({struct Cyc_List_List*_tmp6CE=((struct Cyc_List_List*(*)(void*(*f)(int,void*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcutil_copy_designator,preserve_types,(e[0]).f1);_tmpB9->f1=_tmp6CE;}),({
struct Cyc_Absyn_Exp*_tmp6CD=Cyc_Tcutil_deep_copy_exp(preserve_types,(e[0]).f2);_tmpB9->f2=_tmp6CD;});_tmpB9;});}
# 453
...
new_e=({enum Cyc_Absyn_Primop _tmp6D0=p;struct Cyc_List_List*_tmp6CF=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(DC,pt,es);Cyc_Absyn_primop_exp(_tmp6D0,_tmp6CF,e->loc);});goto _LL0;}case 5U: _LL9: _tmp120=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmp121=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_LLA: {struct Cyc_Absyn_Exp*e1=_tmp120;enum Cyc_Absyn_Incrementor i=_tmp121;
new_e=({struct Cyc_Absyn_Exp*_tmp6D2=DC(pt,e1);enum Cyc_Absyn_Incrementor _tmp6D1=i;Cyc_Absyn_increment_exp(_tmp6D2,_tmp6D1,e->loc);});goto _LL0;}case 7U: _LLB: _tmp11E=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmp11F=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_LLC: {struct Cyc_Absyn_Exp*e1=_tmp11E;struct Cyc_Absyn_Exp*e2=_tmp11F;
new_e=({struct Cyc_Absyn_Exp*_tmp6D4=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp6D3=DC(pt,e2);Cyc_Absyn_and_exp(_tmp6D4,_tmp6D3,e->loc);});goto _LL0;}case 8U: _LLD: _tmp11C=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmp11D=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_LLE: {struct Cyc_Absyn_Exp*e1=_tmp11C;struct Cyc_Absyn_Exp*e2=_tmp11D;
new_e=({struct Cyc_Absyn_Exp*_tmp6D6=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp6D5=DC(pt,e2);Cyc_Absyn_or_exp(_tmp6D6,_tmp6D5,e->loc);});goto _LL0;}case 9U: _LLF: _tmp11A=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmp11B=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_LL10: {struct Cyc_Absyn_Exp*e1=_tmp11A;struct Cyc_Absyn_Exp*e2=_tmp11B;
new_e=({struct Cyc_Absyn_Exp*_tmp6D8=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp6D7=DC(pt,e2);Cyc_Absyn_seq_exp(_tmp6D8,_tmp6D7,e->loc);});goto _LL0;}case 6U: _LL11: _tmp117=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmp118=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_tmp119=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmpBD)->f3;_LL12: {struct Cyc_Absyn_Exp*e1=_tmp117;struct Cyc_Absyn_Exp*e2=_tmp118;struct Cyc_Absyn_Exp*e3=_tmp119;
# 467
new_e=({struct Cyc_Absyn_Exp*_tmp6DB=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp6DA=DC(pt,e2);struct Cyc_Absyn_Exp*_tmp6D9=DC(pt,e3);Cyc_Absyn_conditional_exp(_tmp6DB,_tmp6DA,_tmp6D9,e->loc);});goto _LL0;}case 4U: _LL13: _tmp114=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmp115=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_tmp116=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmpBD)->f3;_LL14: {struct Cyc_Absyn_Exp*e1=_tmp114;struct Cyc_Core_Opt*po=_tmp115;struct Cyc_Absyn_Exp*e2=_tmp116;
# 469
new_e=({struct Cyc_Absyn_Exp*_tmp6DE=DC(pt,e1);struct Cyc_Core_Opt*_tmp6DD=(unsigned)po?({struct Cyc_Core_Opt*_tmp127=_cycalloc(sizeof(*_tmp127));_tmp127->v=(void*)po->v;_tmp127;}): 0;struct Cyc_Absyn_Exp*_tmp6DC=DC(pt,e2);Cyc_Absyn_assignop_exp(_tmp6DE,_tmp6DD,_tmp6DC,e->loc);});
...
# 472
new_e=({void*_tmp6E4=(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp12A=_cycalloc(sizeof(*_tmp12A));_tmp12A->tag=10U,({
struct Cyc_Absyn_Exp*_tmp6E3=DC(pt,e1);_tmp12A->f1=_tmp6E3;}),({struct Cyc_List_List*_tmp6E2=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(DC,pt,es);_tmp12A->f2=_tmp6E2;}),({
struct Cyc_Absyn_VarargCallInfo*_tmp6E1=({struct Cyc_Absyn_VarargCallInfo*_tmp129=_cycalloc(sizeof(*_tmp129));_tmp129->num_varargs=n,_tmp129->injectors=is,({
struct Cyc_Absyn_VarargInfo*_tmp6E0=({struct Cyc_Absyn_VarargInfo*_tmp128=_cycalloc(sizeof(*_tmp128));_tmp128->name=nm,_tmp128->tq=tq,({void*_tmp6DF=Cyc_Tcutil_copy_type(t);_tmp128->type=_tmp6DF;}),_tmp128->inject=i;_tmp128;});_tmp129->vai=_tmp6E0;});_tmp129;});
# 474
_tmp12A->f3=_tmp6E1;}),_tmp12A->f4=resolved;_tmp12A;});
# 472
Cyc_Absyn_new_exp(_tmp6E4,e->loc);});
# 477
...
# 479
new_e=({void*_tmp6E7=(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp12B=_cycalloc(sizeof(*_tmp12B));_tmp12B->tag=10U,({struct Cyc_Absyn_Exp*_tmp6E6=DC(pt,e1);_tmp12B->f1=_tmp6E6;}),({struct Cyc_List_List*_tmp6E5=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(DC,pt,es);_tmp12B->f2=_tmp6E5;}),_tmp12B->f3=vci,_tmp12B->f4=resolved;_tmp12B;});Cyc_Absyn_new_exp(_tmp6E7,e->loc);});
...
# 482
new_e=b?({struct Cyc_Absyn_Exp*_tmp6E9=DC(pt,e1);Cyc_Absyn_rethrow_exp(_tmp6E9,e->loc);}):({struct Cyc_Absyn_Exp*_tmp6E8=DC(pt,e1);Cyc_Absyn_throw_exp(_tmp6E8,e->loc);});
...
# 485
new_e=({struct Cyc_Absyn_Exp*_tmp6EA=DC(pt,e1);Cyc_Absyn_noinstantiate_exp(_tmp6EA,e->loc);});goto _LL0;}case 13U: _LL1D: _tmp102=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmp103=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_LL1E: {struct Cyc_Absyn_Exp*e1=_tmp102;struct Cyc_List_List*ts=_tmp103;
# 487
new_e=({struct Cyc_Absyn_Exp*_tmp6EC=DC(pt,e1);struct Cyc_List_List*_tmp6EB=((struct Cyc_List_List*(*)(void*(*f)(void*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_copy_type,ts);Cyc_Absyn_instantiate_exp(_tmp6EC,_tmp6EB,e->loc);});goto _LL0;}case 14U: _LL1F: _tmpFE=(void*)((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpFF=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_tmp100=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmpBD)->f3;_tmp101=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmpBD)->f4;_LL20: {void*t=_tmpFE;struct Cyc_Absyn_Exp*e1=_tmpFF;int b=_tmp100;enum Cyc_Absyn_Coercion c=_tmp101;
# 489
new_e=({void*_tmp6F0=Cyc_Tcutil_copy_type(t);struct Cyc_Absyn_Exp*_tmp6EF=DC(pt,e1);int _tmp6EE=b;enum Cyc_Absyn_Coercion _tmp6ED=c;Cyc_Absyn_cast_exp(_tmp6F0,_tmp6EF,_tmp6EE,_tmp6ED,e->loc);});goto _LL0;}case 16U: _LL21: _tmpFC=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpFD=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_LL22: {struct Cyc_Absyn_Exp*eo=_tmpFC;struct Cyc_Absyn_Exp*e1=_tmpFD;
# 491
new_e=({struct Cyc_Absyn_Exp*_tmp6F2=(unsigned)eo?DC(pt,eo): 0;struct Cyc_Absyn_Exp*_tmp6F1=DC(pt,e1);Cyc_Absyn_New_exp(_tmp6F2,_tmp6F1,e->loc);});goto _LL0;}case 15U: _LL23: _tmpFB=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_LL24: {struct Cyc_Absyn_Exp*e1=_tmpFB;
new_e=({struct Cyc_Absyn_Exp*_tmp6F3=DC(pt,e1);Cyc_Absyn_address_exp(_tmp6F3,e->loc);});goto _LL0;}case 17U: _LL25: _tmpFA=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_LL26: {void*t=_tmpFA;
new_e=({void*_tmp6F4=Cyc_Tcutil_copy_type(t);Cyc_Absyn_sizeoftype_exp(_tmp6F4,e->loc);});goto _LL0;}case 18U: _LL27: _tmpF9=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_LL28: {struct Cyc_Absyn_Exp*e1=_tmpF9;
new_e=({struct Cyc_Absyn_Exp*_tmp6F5=DC(pt,e1);Cyc_Absyn_sizeofexp_exp(_tmp6F5,e->loc);});goto _LL0;}case 19U: _LL29: _tmpF7=(void*)((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpF8=((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_LL2A: {void*t=_tmpF7;struct Cyc_List_List*ofs=_tmpF8;
new_e=({void*_tmp6F7=Cyc_Tcutil_copy_type(t);struct Cyc_List_List*_tmp6F6=ofs;Cyc_Absyn_offsetof_exp(_tmp6F7,_tmp6F6,e->loc);});goto _LL0;}case 20U: _LL2B: _tmpF6=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_LL2C: {struct Cyc_Absyn_Exp*e1=_tmpF6;
new_e=({struct Cyc_Absyn_Exp*_tmp6F8=DC(pt,e1);Cyc_Absyn_deref_exp(_tmp6F8,e->loc);});goto _LL0;}case 41U: _LL2D: _tmpF5=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_LL2E: {struct Cyc_Absyn_Exp*e1=_tmpF5;
new_e=({struct Cyc_Absyn_Exp*_tmp6F9=DC(pt,e1);Cyc_Absyn_extension_exp(_tmp6F9,e->loc);});goto _LL0;}case 24U: _LL2F: _tmpF4=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_LL30: {struct Cyc_List_List*es=_tmpF4;
new_e=({struct Cyc_List_List*_tmp6FA=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(DC,pt,es);Cyc_Absyn_tuple_exp(_tmp6FA,e->loc);});goto _LL0;}case 21U: _LL31: _tmpF0=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpF1=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_tmpF2=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpBD)->f3;_tmpF3=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmpBD)->f4;_LL32: {struct Cyc_Absyn_Exp*e1=_tmpF0;struct _fat_ptr*n=_tmpF1;int f1=_tmpF2;int f2=_tmpF3;
# 500
new_e=({void*_tmp6FC=(void*)({struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_tmp12C=_cycalloc(sizeof(*_tmp12C));_tmp12C->tag=21U,({struct Cyc_Absyn_Exp*_tmp6FB=DC(pt,e1);_tmp12C->f1=_tmp6FB;}),_tmp12C->f2=n,_tmp12C->f3=f1,_tmp12C->f4=f2;_tmp12C;});Cyc_Absyn_new_exp(_tmp6FC,e->loc);});goto _LL0;}case 22U: _LL33: _tmpEC=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpED=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_tmpEE=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmpBD)->f3;_tmpEF=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmpBD)->f4;_LL34: {struct Cyc_Absyn_Exp*e1=_tmpEC;struct _fat_ptr*n=_tmpED;int f1=_tmpEE;int f2=_tmpEF;
# 502
new_e=({void*_tmp6FE=(void*)({struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp12D=_cycalloc(sizeof(*_tmp12D));_tmp12D->tag=22U,({struct Cyc_Absyn_Exp*_tmp6FD=DC(pt,e1);_tmp12D->f1=_tmp6FD;}),_tmp12D->f2=n,_tmp12D->f3=f1,_tmp12D->f4=f2;_tmp12D;});Cyc_Absyn_new_exp(_tmp6FE,e->loc);});goto _LL0;}case 23U: _LL35: _tmpEA=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpEB=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_LL36: {struct Cyc_Absyn_Exp*e1=_tmpEA;struct Cyc_Absyn_Exp*e2=_tmpEB;
# 504
new_e=({struct Cyc_Absyn_Exp*_tmp700=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp6FF=DC(pt,e2);Cyc_Absyn_subscript_exp(_tmp700,_tmp6FF,e->loc);});goto _LL0;}case 26U: _LL37: _tmpE9=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_LL38: {struct Cyc_List_List*eds=_tmpE9;
# 506
new_e=({void*_tmp702=(void*)({struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_tmp12E=_cycalloc(sizeof(*_tmp12E));_tmp12E->tag=26U,({struct Cyc_List_List*_tmp701=((struct Cyc_List_List*(*)(struct _tuple16*(*f)(int,struct _tuple16*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcutil_copy_eds,pt,eds);_tmp12E->f1=_tmp701;});_tmp12E;});Cyc_Absyn_new_exp(_tmp702,e->loc);});goto _LL0;}case 31U: _LL39: _tmpE6=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpE7=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_tmpE8=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmpBD)->f3;_LL3A: {struct Cyc_List_List*es=_tmpE6;struct Cyc_Absyn_Datatypedecl*dtd=_tmpE7;struct Cyc_Absyn_Datatypefield*dtf=_tmpE8;
# 508
new_e=({void*_tmp704=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmp12F=_cycalloc(sizeof(*_tmp12F));_tmp12F->tag=31U,({struct Cyc_List_List*_tmp703=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*f)(int,struct Cyc_Absyn_Exp*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(DC,pt,es);_tmp12F->f1=_tmp703;}),_tmp12F->f2=dtd,_tmp12F->f3=dtf;_tmp12F;});Cyc_Absyn_new_exp(_tmp704,e->loc);});goto _LL0;}case 27U: _LL3B: _tmpE2=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpE3=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_tmpE4=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpBD)->f3;_tmpE5=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmpBD)->f4;_LL3C: {struct Cyc_Absyn_Vardecl*vd=_tmpE2;struct Cyc_Absyn_Exp*e1=_tmpE3;struct Cyc_Absyn_Exp*e2=_tmpE4;int b=_tmpE5;
# 510
new_e=({void*_tmp707=(void*)({struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*_tmp130=_cycalloc(sizeof(*_tmp130));_tmp130->tag=27U,_tmp130->f1=vd,({struct Cyc_Absyn_Exp*_tmp706=DC(pt,e1);_tmp130->f2=_tmp706;}),({struct Cyc_Absyn_Exp*_tmp705=DC(pt,e2);_tmp130->f3=_tmp705;}),_tmp130->f4=b;_tmp130;});Cyc_Absyn_new_exp(_tmp707,e->loc);});goto _LL0;}case 28U: _LL3D: _tmpDF=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpE0=(void*)((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_tmpE1=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmpBD)->f3;_LL3E: {struct Cyc_Absyn_Exp*e=_tmpDF;void*t=_tmpE0;int b=_tmpE1;
# 512
new_e=({void*_tmp70A=(void*)({struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*_tmp131=_cycalloc(sizeof(*_tmp131));_tmp131->tag=28U,({struct Cyc_Absyn_Exp*_tmp709=DC(pt,e);_tmp131->f1=_tmp709;}),({void*_tmp708=Cyc_Tcutil_copy_type(t);_tmp131->f2=_tmp708;}),_tmp131->f3=b;_tmp131;});Cyc_Absyn_new_exp(_tmp70A,e->loc);});
...
# 515
new_e=({void*_tmp70D=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmp132=_cycalloc(sizeof(*_tmp132));_tmp132->tag=29U,_tmp132->f1=n,({struct Cyc_List_List*_tmp70C=((struct Cyc_List_List*(*)(void*(*f)(void*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_copy_type,ts);_tmp132->f2=_tmp70C;}),({struct Cyc_List_List*_tmp70B=((struct Cyc_List_List*(*)(struct _tuple16*(*f)(int,struct _tuple16*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcutil_copy_eds,pt,eds);_tmp132->f3=_tmp70B;}),_tmp132->f4=agr;_tmp132;});Cyc_Absyn_new_exp(_tmp70D,e->loc);});
# 517
...
# 519
new_e=({void*_tmp710=(void*)({struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*_tmp133=_cycalloc(sizeof(*_tmp133));_tmp133->tag=30U,({void*_tmp70F=Cyc_Tcutil_copy_type(t);_tmp133->f1=_tmp70F;}),({struct Cyc_List_List*_tmp70E=((struct Cyc_List_List*(*)(struct _tuple16*(*f)(int,struct _tuple16*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcutil_copy_eds,pt,eds);_tmp133->f2=_tmp70E;});_tmp133;});Cyc_Absyn_new_exp(_tmp710,e->loc);});
...
# 522
new_e=({void*_tmp714=(void*)({struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*_tmp135=_cycalloc(sizeof(*_tmp135));_tmp135->tag=25U,({struct _tuple9*_tmp713=({struct _tuple9*_tmp134=_cycalloc(sizeof(*_tmp134));_tmp134->f1=vopt,_tmp134->f2=tq,({void*_tmp712=Cyc_Tcutil_copy_type(t);_tmp134->f3=_tmp712;});_tmp134;});_tmp135->f1=_tmp713;}),({
struct Cyc_List_List*_tmp711=((struct Cyc_List_List*(*)(struct _tuple16*(*f)(int,struct _tuple16*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcutil_copy_eds,pt,eds);_tmp135->f2=_tmp711;});_tmp135;});
# 522
Cyc_Absyn_new_exp(_tmp714,e->loc);});
# 524
...
# 527
new_e=({void*_tmp716=(void*)({struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmp136=_cycalloc(sizeof(*_tmp136));_tmp136->tag=33U,({void*_tmp715=Cyc_Tcutil_copy_type(t);_tmp136->f1=_tmp715;}),_tmp136->f2=ef;_tmp136;});Cyc_Absyn_new_exp(_tmp716,e->loc);});goto _LL0;}case 34U: _LL49: _tmpCB=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpBD)->f1).is_calloc;_tmpCC=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpBD)->f1).rgn;_tmpCD=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpBD)->f1).elt_type;_tmpCE=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpBD)->f1).num_elts;_tmpCF=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpBD)->f1).fat_result;_tmpD0=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmpBD)->f1).inline_call;_LL4A: {int ic=_tmpCB;struct Cyc_Absyn_Exp*r=_tmpCC;void**t=_tmpCD;struct Cyc_Absyn_Exp*n=_tmpCE;int res=_tmpCF;int inlc=_tmpD0;
# 529
struct Cyc_Absyn_Exp*e2=Cyc_Absyn_copy_exp(e);
struct Cyc_Absyn_Exp*r1=r;if(r != 0)r1=DC(pt,r);{
void**t1=t;if(t != 0)t1=({void**_tmp137=_cycalloc(sizeof(*_tmp137));({void*_tmp717=Cyc_Tcutil_copy_type(*t);*_tmp137=_tmp717;});_tmp137;});
({void*_tmp718=(void*)({struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*_tmp138=_cycalloc(sizeof(*_tmp138));_tmp138->tag=34U,(_tmp138->f1).is_calloc=ic,(_tmp138->f1).rgn=r1,(_tmp138->f1).elt_type=t1,(_tmp138->f1).num_elts=n,(_tmp138->f1).fat_result=res,(_tmp138->f1).inline_call=inlc;_tmp138;});e2->r=_tmp718;});
new_e=e2;
...
new_e=({struct Cyc_Absyn_Exp*_tmp71A=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp719=DC(pt,e2);Cyc_Absyn_swap_exp(_tmp71A,_tmp719,e->loc);});goto _LL0;}case 36U: _LL4D: _tmpC7=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpC8=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_LL4E: {struct Cyc_Core_Opt*nopt=_tmpC7;struct Cyc_List_List*eds=_tmpC8;
# 537
...
new_e=({void*_tmp71C=(void*)({struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmp13A=_cycalloc(sizeof(*_tmp13A));_tmp13A->tag=36U,_tmp13A->f1=nopt1,({struct Cyc_List_List*_tmp71B=((struct Cyc_List_List*(*)(struct _tuple16*(*f)(int,struct _tuple16*),int env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcutil_copy_eds,pt,eds);_tmp13A->f2=_tmp71B;});_tmp13A;});Cyc_Absyn_new_exp(_tmp71C,e->loc);});
goto _LL0;}case 37U: _LL4F: _LL50:
# 542
(int)_throw((void*)({struct Cyc_Core_Failure_exn_struct*_tmp13C=_cycalloc(sizeof(*_tmp13C));_tmp13C->tag=Cyc_Core_Failure,({struct _fat_ptr _tmp71D=({const char*_tmp13B="deep_copy: statement expressions unsupported";_tag_fat(_tmp13B,sizeof(char),45U);});_tmp13C->f1=_tmp71D;});_tmp13C;}));case 38U: _LL51: _tmpC5=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpC6=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_LL52: {struct Cyc_Absyn_Exp*e1=_tmpC5;struct _fat_ptr*fn=_tmpC6;
# 544
new_e=({void*_tmp71F=(void*)({struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*_tmp13D=_cycalloc(sizeof(*_tmp13D));_tmp13D->tag=38U,({struct Cyc_Absyn_Exp*_tmp71E=DC(pt,e1);_tmp13D->f1=_tmp71E;}),_tmp13D->f2=fn;_tmp13D;});Cyc_Absyn_new_exp(_tmp71F,e->loc);});goto _LL0;}case 39U: _LL53: _tmpC4=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_LL54: {void*t=_tmpC4;
new_e=({void*_tmp720=Cyc_Tcutil_copy_type(t);Cyc_Absyn_valueof_exp(_tmp720,e->loc);});goto _LL0;}case 40U: _LL55: _tmpBF=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpBD)->f1;_tmpC0=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpBD)->f2;_tmpC1=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpBD)->f3;_tmpC2=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpBD)->f4;_tmpC3=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmpBD)->f5;_LL56: {int v=_tmpBF;struct _fat_ptr t=_tmpC0;struct Cyc_List_List*o=_tmpC1;struct Cyc_List_List*i=_tmpC2;struct Cyc_List_List*c=_tmpC3;
...
# 569
if((int)k1 != (int)k2){
struct _tuple17 _tmp144=({struct _tuple17 _tmp62F;_tmp62F.f1=k1,_tmp62F.f2=k2;_tmp62F;});struct _tuple17 _stmttmp1C=_tmp144;struct _tuple17 _tmp145=_stmttmp1C;switch(_tmp145.f1){case Cyc_Absyn_BoxKind: switch(_tmp145.f2){case Cyc_Absyn_MemKind: _LL7: _LL8:
...
# 577
if((int)a1 != (int)a2){
struct _tuple18 _tmp146=({struct _tuple18 _tmp630;_tmp630.f1=a1,_tmp630.f2=a2;_tmp630;});struct _tuple18 _stmttmp1D=_tmp146;struct _tuple18 _tmp147=_stmttmp1D;switch(_tmp147.f1){case Cyc_Absyn_Aliasable: if(_tmp147.f2 == Cyc_Absyn_Top){_LL10: _LL11:
...
({void*_tmp721=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp14C=_cycalloc(sizeof(*_tmp14C));_tmp14C->tag=2U,_tmp14C->f1=0,_tmp14C->f2=def;_tmp14C;});tv->kind=_tmp721;});return def;}_LL0:;}struct _tuple19{struct Cyc_Absyn_Tvar*f1;void*f2;};
# 594
...
tv->kind=kb;
return({struct _tuple19 _tmp631;_tmp631.f1=tv,_tmp631.f2=oldkb;_tmp631;});}}else{_LL3: _LL4:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp152=({struct Cyc_Warn_String_Warn_Warg_struct _tmp633;_tmp633.tag=0U,({struct _fat_ptr _tmp722=({const char*_tmp154="swap_kind: cannot update the kind of ";_tag_fat(_tmp154,sizeof(char),38U);});_tmp633.f1=_tmp722;});_tmp633;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp153=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp632;_tmp632.tag=2U,_tmp632.f1=(void*)t;_tmp632;});void*_tmp151[2U];_tmp151[0]=& _tmp152,_tmp151[1]=& _tmp153;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp151,sizeof(void*),2U));});}_LL0:;}
# 606
...
# 621
 inst=({struct Cyc_List_List*_tmp15C=_region_malloc(temp,sizeof(*_tmp15C));({struct _tuple19*_tmp723=({struct _tuple19*_tmp15B=_region_malloc(temp,sizeof(*_tmp15B));_tmp15B->f1=tv,_tmp15B->f2=t;_tmp15B;});_tmp15C->hd=_tmp723;}),_tmp15C->tl=inst;_tmp15C;});goto _LL0;default: _LL5: _LL6:
 goto _LL0;}_LL0:;}
# 625
if(inst != 0){
field_type=({struct _RegionHandle*_tmp725=temp;struct Cyc_List_List*_tmp724=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(inst);Cyc_Tcutil_rsubstitute(_tmp725,_tmp724,field_type);});
...
# 665
({struct Cyc_Warn_String_Warn_Warg_struct _tmp16E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp634;_tmp634.tag=0U,({struct _fat_ptr _tmp726=({const char*_tmp16F="type_kind: Unresolved DatatypeFieldType";_tag_fat(_tmp16F,sizeof(char),40U);});_tmp634.f1=_tmp726;});_tmp634;});void*_tmp16D[1U];_tmp16D[0]=& _tmp16E;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp16D,sizeof(void*),1U));});}default: if(((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_tmp166)->f1).UnknownAggr).tag == 1){_LL48: _LL49:
# 668
...
# 720
if(td == 0 || td->kind == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp17C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp636;_tmp636.tag=0U,({struct _fat_ptr _tmp727=({const char*_tmp17E="type_kind: typedef found: ";_tag_fat(_tmp17E,sizeof(char),27U);});_tmp636.f1=_tmp727;});_tmp636;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp17D=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp635;_tmp635.tag=2U,_tmp635.f1=(void*)t;_tmp635;});void*_tmp17B[2U];_tmp17B[0]=& _tmp17C,_tmp17B[1]=& _tmp17D;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp17B,sizeof(void*),2U));});
...
{struct Cyc_Absyn_Kind*_tmp180=Cyc_Tcutil_tvar_kind(tv,& Cyc_Tcutil_bk);struct Cyc_Absyn_Kind*_stmttmp25=_tmp180;struct Cyc_Absyn_Kind*_tmp181=_stmttmp25;switch(((struct Cyc_Absyn_Kind*)_tmp181)->kind){case Cyc_Absyn_RgnKind: switch(((struct Cyc_Absyn_Kind*)_tmp181)->aliasqual){case Cyc_Absyn_Unique: _LL1: _LL2:
 ...
 t=(void*)({struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_tmp182=_cycalloc(sizeof(*_tmp182));_tmp182->tag=9U,({struct Cyc_Absyn_Exp*_tmp728=Cyc_Absyn_uint_exp(0U,0U);_tmp182->f1=_tmp728;});_tmp182;});goto _LL0;case Cyc_Absyn_BoolKind: _LL9: _LLA:
...
# 811
void*_tmp197=({struct Cyc_List_List*_tmp72B=((struct Cyc_List_List*(*)(struct _tuple19*(*f)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*x))Cyc_List_map)(Cyc_Tcutil_region_free_subst,tvs);Cyc_Tcutil_substitute(_tmp72B,(void*)_check_null(eff));});void*e=_tmp197;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp19B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp637;_tmp637.tag=0U,({struct _fat_ptr _tmp72C=({const char*_tmp19C="typedecl in rgns_of";_tag_fat(_tmp19C,sizeof(char),20U);});_tmp637.f1=_tmp72C;});_tmp637;});void*_tmp19A[1U];_tmp19A[0]=& _tmp19B;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp19A,sizeof(void*),1U));});case 9U: _LL19: _LL1A:
 goto _LL1C;default: _LL1B: _LL1C:
...
({void*_tmp72D=(void*)Cyc_Tcutil_compress(Cyc_Tcutil_normalize_effect(eff));effs->hd=_tmp72D;});{
...
# 859
({struct Cyc_List_List*_tmp72E=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(effects);*es=_tmp72E;});
...
struct Cyc_Absyn_Tqual _tmp72F=Cyc_Absyn_empty_tqual(0U);(_tmp1AB->f1).ret_tqual=_tmp72F;}),(_tmp1AB->f1).ret_type=Cyc_Absyn_void_type,(_tmp1AB->f1).args=0,(_tmp1AB->f1).c_varargs=0,(_tmp1AB->f1).cyc_varargs=0,(_tmp1AB->f1).rgn_po=0,(_tmp1AB->f1).attributes=0,(_tmp1AB->f1).requires_clause=0,(_tmp1AB->f1).requires_relns=0,(_tmp1AB->f1).ensures_clause=0,(_tmp1AB->f1).ensures_relns=0,(_tmp1AB->f1).return_value=0;_tmp1AB;});
# 873
struct Cyc_Absyn_FnType_Absyn_Type_struct*fntype=_tmp1AA;
# 883
return({void*_tmp733=(void*)fntype;void*_tmp732=Cyc_Absyn_heap_rgn_type;struct Cyc_Absyn_Tqual _tmp731=Cyc_Absyn_empty_tqual(0U);void*_tmp730=Cyc_Absyn_bounds_one();Cyc_Absyn_atb_type(_tmp733,_tmp732,_tmp731,_tmp730,Cyc_Absyn_false_type);});}
# 890
int Cyc_Tcutil_region_in_effect(int constrain,void*r,void*e){
...
if(r == r2)return 1;{
struct _tuple15 _tmp1B4=({struct _tuple15 _tmp638;_tmp638.f1=r,_tmp638.f2=r2;_tmp638;});struct _tuple15 _stmttmp2C=_tmp1B4;struct _tuple15 _tmp1B5=_stmttmp2C;struct Cyc_Absyn_Tvar*_tmp1B7;struct Cyc_Absyn_Tvar*_tmp1B6;if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp1B5.f1)->tag == 2U){if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp1B5.f2)->tag == 2U){_LLC: _tmp1B6=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp1B5.f1)->f1;_tmp1B7=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp1B5.f2)->f1;_LLD: {struct Cyc_Absyn_Tvar*tv1=_tmp1B6;struct Cyc_Absyn_Tvar*tv2=_tmp1B7;
...
({void*_tmp735=Cyc_Tcutil_dummy_fntype(Cyc_Absyn_join_eff(({void*_tmp1C2[2U];_tmp1C2[0]=ev,({void*_tmp734=Cyc_Absyn_access_eff(r);_tmp1C2[1]=_tmp734;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1C2,sizeof(void*),2U));})));*p=_tmp735;});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp639;_tmp639.tag=0U,({struct _fat_ptr _tmp736=({const char*_tmp1C5="effect evar has wrong kind";_tag_fat(_tmp1C5,sizeof(char),27U);});_tmp639.f1=_tmp736;});_tmp639;});void*_tmp1C3[1U];_tmp1C3[0]=& _tmp1C4;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1C3,sizeof(void*),1U));});
if(!constrain)return 0;{
# 932
void*_tmp1C6=Cyc_Absyn_new_evar(& Cyc_Tcutil_eko,s);void*ev=_tmp1C6;
# 935
Cyc_Unify_occurs(ev,Cyc_Core_heap_region,(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(s))->v,r);
({void*_tmp738=Cyc_Absyn_join_eff(({void*_tmp1C7[2U];_tmp1C7[0]=ev,({void*_tmp737=Cyc_Absyn_access_eff(r);_tmp1C7[1]=_tmp737;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1C7,sizeof(void*),2U));}));*p=_tmp738;});
return 1;}}default: _LL9: _LLA:
 return 0;}_LL0:;}}
# 945
...
# 967
if(k == 0 ||(int)((struct Cyc_Absyn_Kind*)k->v)->kind != (int)Cyc_Absyn_EffKind)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1D8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp63B;_tmp63B.tag=0U,({struct _fat_ptr _tmp73A=({const char*_tmp1D9="effect evar has wrong kind";_tag_fat(_tmp1D9,sizeof(char),27U);});_tmp63B.f1=_tmp73A;});_tmp63B;});void*_tmp1D7[1U];_tmp1D7[0]=& _tmp1D8;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1D7,sizeof(void*),1U));});
...
void*_tmp1DB=Cyc_Absyn_join_eff(({void*_tmp1DC[2U];_tmp1DC[0]=ev,({void*_tmp73B=Cyc_Absyn_regionsof_eff(t);_tmp1DC[1]=_tmp73B;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1DC,sizeof(void*),2U));}));void*new_typ=_tmp1DB;
*p=new_typ;
return 1;}}}default: _LL9: _LLA:
 return 0;}_LL0:;}}
# 985
...
({void*_tmp73D=Cyc_Tcutil_dummy_fntype(Cyc_Absyn_join_eff(({void*_tmp1EE[2U];_tmp1EE[0]=ev,({void*_tmp73C=Cyc_Absyn_var_type(v);_tmp1EE[1]=_tmp73C;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1EE,sizeof(void*),2U));})));*p=_tmp73D;});
...
# 1013
if(k == 0 ||(int)((struct Cyc_Absyn_Kind*)k->v)->kind != (int)Cyc_Absyn_EffKind)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1F0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp63C;_tmp63C.tag=0U,({struct _fat_ptr _tmp73E=({const char*_tmp1F1="effect evar has wrong kind";_tag_fat(_tmp1F1,sizeof(char),27U);});_tmp63C.f1=_tmp73E;});_tmp63C;});void*_tmp1EF[1U];_tmp1EF[0]=& _tmp1F0;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp1EF,sizeof(void*),1U));});{
# 1017
...
return 0;{
void*_tmp1F3=Cyc_Absyn_join_eff(({void*_tmp1F4[2U];_tmp1F4[0]=ev,({void*_tmp73F=Cyc_Absyn_var_type(v);_tmp1F4[1]=_tmp73F;});((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp1F4,sizeof(void*),2U));}));void*new_typ=_tmp1F3;
*p=new_typ;
return 1;}}}default: _LL9: _LLA:
 return 0;}_LL0:;}}
# 1029
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp209=({struct Cyc_Warn_String_Warn_Warg_struct _tmp63E;_tmp63E.tag=0U,({struct _fat_ptr _tmp740=({const char*_tmp20B="subset_effect: bad effect: ";_tag_fat(_tmp20B,sizeof(char),28U);});_tmp63E.f1=_tmp740;});_tmp63E;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp20A=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp63D;_tmp63D.tag=2U,_tmp63D.f1=(void*)e1;_tmp63D;});void*_tmp208[2U];_tmp208[0]=& _tmp209,_tmp208[1]=& _tmp20A;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp208,sizeof(void*),2U));});}_LL0:;}
# 1106
...
# 1168
({struct Cyc_Warn_String_Warn_Warg_struct _tmp216=({struct Cyc_Warn_String_Warn_Warg_struct _tmp63F;_tmp63F.tag=0U,({struct _fat_ptr _tmp741=({const char*_tmp217="bad con";_tag_fat(_tmp217,sizeof(char),8U);});_tmp63F.f1=_tmp741;});_tmp63F;});void*_tmp215[1U];_tmp215[0]=& _tmp216;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp215,sizeof(void*),1U));});}case 2U: switch(((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp214)->f1){case 0U: _LL21: _LL22:
# 1147
...
# 1201
return({struct _tuple20 _tmp640;_tmp640.f1=dd->name,_tmp640.f2=df->name;_tmp640;});}}else{_LL3: _tmp21F=((_tmp21E.UnknownDatatypefield).val).datatype_name;_tmp220=((_tmp21E.UnknownDatatypefield).val).field_name;_LL4: {struct _tuple1*d=_tmp21F;struct _tuple1*f=_tmp220;
# 1203
return({struct _tuple20 _tmp641;_tmp641.f1=d,_tmp641.f2=f;_tmp641;});}}_LL0:;}struct _tuple21{enum Cyc_Absyn_AggrKind f1;struct _tuple1*f2;};
# 1206
...
return({struct _tuple21 _tmp642;_tmp642.f1=k,_tmp642.f2=n;_tmp642;});}}else{_LL3: _tmp224=*(_tmp223.KnownAggr).val;_LL4: {struct Cyc_Absyn_Aggrdecl*ad=_tmp224;
return({struct _tuple21 _tmp643;_tmp643.f1=ad->kind,_tmp643.f2=ad->name;_tmp643;});}}_LL0:;}
# 1212
...
# 1224
return({struct _tuple1*_tmp742=Cyc_Tcutil_get_datatype_qvar(info1);Cyc_Absyn_qvar_cmp(_tmp742,Cyc_Tcutil_get_datatype_qvar(info2));});}}else{goto _LLD;}case 19U: if(((struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*)_tmp228.f2)->tag == 19U){_LL9: _tmp22B=((struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*)_tmp228.f1)->f1;_tmp22C=((struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*)_tmp228.f2)->f1;_LLA: {union Cyc_Absyn_DatatypeFieldInfo info1=_tmp22B;union Cyc_Absyn_DatatypeFieldInfo info2=_tmp22C;
# 1226
...
if(a1 != 0 && a2 == 0)return 1;
return({int(*_tmp744)(void*,void*)=cmp;void*_tmp743=(void*)_check_null(a1);_tmp744(_tmp743,(void*)_check_null(a2));});}
# 1247
...
# 1292
({struct Cyc_Warn_String_Warn_Warg_struct _tmp27F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp645;_tmp645.tag=0U,({struct _fat_ptr _tmp746=({const char*_tmp280="typecmp: can only compare closed types";_tag_fat(_tmp280,sizeof(char),39U);});_tmp645.f1=_tmp746;});_tmp645;});void*_tmp27E[1U];_tmp27E[0]=& _tmp27F;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp27E,sizeof(void*),1U));});}else{goto _LL15;}case 2U: if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp256.f2)->tag == 2U){_LL5: _tmp277=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp256.f1)->f1;_tmp278=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp256.f2)->f1;_LL6: {struct Cyc_Absyn_Tvar*tv2=_tmp277;struct Cyc_Absyn_Tvar*tv1=_tmp278;
# 1296
...
if(e1 == e2)return 0;
if(e1 == 0 || e2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp28B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp646;_tmp646.tag=0U,({struct _fat_ptr _tmp747=({const char*_tmp28C="missing expression in array index";_tag_fat(_tmp28C,sizeof(char),34U);});_tmp646.f1=_tmp747;});_tmp646;});void*_tmp28A[1U];_tmp28A[0]=& _tmp28B;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp28A,sizeof(void*),1U));});
...
r=({struct Cyc_Absyn_Tqual _tmp748=((struct Cyc_Absyn_VarargInfo*)_check_null(f1.cyc_varargs))->tq;Cyc_Tcutil_tqual_cmp(_tmp748,((struct Cyc_Absyn_VarargInfo*)_check_null(f2.cyc_varargs))->tq);});
if(r != 0)return r;
...
if(r != 0)return r;
# 1375
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2A2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp647;_tmp647.tag=0U,({struct _fat_ptr _tmp749=({const char*_tmp2A3="typecmp: function type comparison should never get here!";_tag_fat(_tmp2A3,sizeof(char),57U);});_tmp647.f1=_tmp749;});_tmp647;});void*_tmp2A1[1U];_tmp2A1[0]=& _tmp2A2;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp2A1,sizeof(void*),1U));});}}}}}else{goto _LL15;}case 6U: if(((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp256.f2)->tag == 6U){_LLD: _tmp25F=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp256.f1)->f1;_tmp260=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp256.f2)->f1;_LLE: {struct Cyc_List_List*ts2=_tmp25F;struct Cyc_List_List*ts1=_tmp260;
# 1378
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2B9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp651;_tmp651.tag=0U,({struct _fat_ptr _tmp74F=({const char*_tmp2BE="type mismatch: expecting ";_tag_fat(_tmp2BE,sizeof(char),26U);});_tmp651.f1=_tmp74F;});_tmp651;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2BA=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp650;_tmp650.tag=2U,_tmp650.f1=(void*)t;_tmp650;});struct Cyc_Warn_String_Warn_Warg_struct _tmp2BB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp64F;_tmp64F.tag=0U,({struct _fat_ptr _tmp750=({const char*_tmp2BD=" but found ";_tag_fat(_tmp2BD,sizeof(char),12U);});_tmp64F.f1=_tmp750;});_tmp64F;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2BC=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp64E;_tmp64E.tag=2U,_tmp64E.f1=(void*)_check_null(((struct Cyc_Absyn_Exp*)el->hd)->topt);_tmp64E;});void*_tmp2B8[4U];_tmp2B8[0]=& _tmp2B9,_tmp2B8[1]=& _tmp2BA,_tmp2B8[2]=& _tmp2BB,_tmp2B8[3]=& _tmp2BC;({unsigned _tmp751=((struct Cyc_Absyn_Exp*)el->hd)->loc;Cyc_Warn_err2(_tmp751,_tag_fat(_tmp2B8,sizeof(void*),4U));});});
# 1476
return 0;}}}
# 1478
return 1;}
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2C2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp652;_tmp652.tag=0U,({struct _fat_ptr _tmp752=({const char*_tmp2C3="integral size mismatch; conversion supplied";_tag_fat(_tmp2C3,sizeof(char),44U);});_tmp652.f1=_tmp752;});_tmp652;});void*_tmp2C1[1U];_tmp2C1[0]=& _tmp2C2;({unsigned _tmp753=e->loc;Cyc_Warn_warn2(_tmp753,_tag_fat(_tmp2C1,sizeof(void*),1U));});});
...
({void*_tmp754=t;Cyc_Unify_unify(_tmp754,Cyc_Absyn_bounds_one());});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2CC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp654;_tmp654.tag=0U,({struct _fat_ptr _tmp755=({const char*_tmp2CE="get_bounds_exp: ";_tag_fat(_tmp2CE,sizeof(char),17U);});_tmp654.f1=_tmp755;});_tmp654;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2CD=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp653;_tmp653.tag=2U,_tmp653.f1=(void*)b;_tmp653;});void*_tmp2CB[2U];_tmp2CB[0]=& _tmp2CC,_tmp2CB[1]=& _tmp2CD;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp2CB,sizeof(void*),2U));});}_LL0:;}}
# 1549
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2D3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp656;_tmp656.tag=0U,({struct _fat_ptr _tmp756=({const char*_tmp2D5="get_ptr_bounds_exp not pointer: ";_tag_fat(_tmp2D5,sizeof(char),33U);});_tmp656.f1=_tmp756;});_tmp656;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2D4=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp655;_tmp655.tag=2U,_tmp655.f1=(void*)t;_tmp655;});void*_tmp2D2[2U];_tmp2D2[0]=& _tmp2D3,_tmp2D2[1]=& _tmp2D4;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp2D2,sizeof(void*),2U));});}_LL0:;}
# 1558
...
struct _tuple22 _tmp2E4=({struct _tuple22 _tmp658;({struct Cyc_Absyn_Exp*_tmp75A=({void*_tmp759=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp759,(pinfo_a.ptr_atts).bounds);});_tmp658.f1=_tmp75A;}),({
struct Cyc_Absyn_Exp*_tmp758=({void*_tmp757=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp757,(pinfo_b.ptr_atts).bounds);});_tmp658.f2=_tmp758;});_tmp658;});
# 1585
...
void*_tmp75B=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp75B,(pinfo_b.ptr_atts).bounds);}))
goto _LL9;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2E9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp657;_tmp657.tag=0U,({struct _fat_ptr _tmp75C=({const char*_tmp2EA="implicit cast to shorter array";_tag_fat(_tmp2EA,sizeof(char),31U);});_tmp657.f1=_tmp75C;});_tmp657;});void*_tmp2E8[1U];_tmp2E8[0]=& _tmp2E9;({unsigned _tmp75D=loc;Cyc_Warn_warn2(_tmp75D,_tag_fat(_tmp2E8,sizeof(void*),1U));});});
if(!({struct Cyc_Absyn_Exp*_tmp75E=(struct Cyc_Absyn_Exp*)_check_null(e2);Cyc_Evexp_lte_const_exp(_tmp75E,(struct Cyc_Absyn_Exp*)_check_null(e1));}))
return 0;
goto _LL9;}}}_LL9:;}
# 1607
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2EC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp65C;_tmp65C.tag=0U,({struct _fat_ptr _tmp75F=({const char*_tmp2F1="implicit cast from region ";_tag_fat(_tmp2F1,sizeof(char),27U);});_tmp65C.f1=_tmp75F;});_tmp65C;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2ED=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp65B;_tmp65B.tag=2U,_tmp65B.f1=(void*)(pinfo_a.ptr_atts).rgn;_tmp65B;});struct Cyc_Warn_String_Warn_Warg_struct _tmp2EE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp65A;_tmp65A.tag=0U,({
struct _fat_ptr _tmp760=({const char*_tmp2F0=" to region ";_tag_fat(_tmp2F0,sizeof(char),12U);});_tmp65A.f1=_tmp760;});_tmp65A;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp2EF=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp659;_tmp659.tag=2U,_tmp659.f1=(void*)(pinfo_b.ptr_atts).rgn;_tmp659;});void*_tmp2EB[4U];_tmp2EB[0]=& _tmp2EC,_tmp2EB[1]=& _tmp2ED,_tmp2EB[2]=& _tmp2EE,_tmp2EB[3]=& _tmp2EF;({unsigned _tmp761=loc;Cyc_Warn_warn2(_tmp761,_tag_fat(_tmp2EB,sizeof(void*),4U));});});}
# 1619
...
return 1;
# 1630
if(!({void*_tmp762=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp762,(pinfo_b.ptr_atts).bounds);})||
...
return e;}}else{_LL3: _LL4:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2F6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp65E;_tmp65E.tag=0U,({struct _fat_ptr _tmp763=({const char*_tmp2F7="pointer_elt_type";_tag_fat(_tmp2F7,sizeof(char),17U);});_tmp65E.f1=_tmp763;});_tmp65E;});void*_tmp2F5[1U];_tmp2F5[0]=& _tmp2F6;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp2F5,sizeof(void*),1U));});}_LL0:;}
# 1658
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp2FC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp65F;_tmp65F.tag=0U,({struct _fat_ptr _tmp764=({const char*_tmp2FD="pointer_elt_type";_tag_fat(_tmp2FD,sizeof(char),17U);});_tmp65F.f1=_tmp764;});_tmp65F;});void*_tmp2FB[1U];_tmp2FB[0]=& _tmp2FC;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp2FB,sizeof(void*),1U));});}_LL0:;}
# 1665
...
goto _LL3;default: _LLA: _LLB:
 goto _LL3;}_LL3:;}
# 1786
({struct Cyc_Warn_String_Warn_Warg_struct _tmp313=({struct Cyc_Warn_String_Warn_Warg_struct _tmp661;_tmp661.tag=0U,({struct _fat_ptr _tmp765=({const char*_tmp315="kind_to_opt: bad kind ";_tag_fat(_tmp315,sizeof(char),23U);});_tmp661.f1=_tmp765;});_tmp661;});struct Cyc_Warn_Kind_Warn_Warg_struct _tmp314=({struct Cyc_Warn_Kind_Warn_Warg_struct _tmp660;_tmp660.tag=9U,_tmp660.f1=ka;_tmp660;});void*_tmp312[2U];_tmp312[0]=& _tmp313,_tmp312[1]=& _tmp314;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp312,sizeof(void*),2U));});}}
# 1789
void*Cyc_Tcutil_kind_to_bound(struct Cyc_Absyn_Kind*k){
...
return({struct Cyc_Core_Opt*_tmp317=_cycalloc(sizeof(*_tmp317));({void*_tmp766=Cyc_Tcutil_kind_to_bound(k);_tmp317->v=_tmp766;});_tmp317;});}
# 1798
...
return 0;
({void*_tmp767=(Cyc_Absyn_null_exp(0U))->r;e1->r=_tmp767;});
e1->topt=t2;
return 1;}}else{_LL3: _LL4:
 return 0;}_LL0:;}}
# 1812
...
struct _tuple1*v=({struct _tuple1*_tmp32E=_cycalloc(sizeof(*_tmp32E));_tmp32E->f1=Cyc_Absyn_Loc_n,({struct _fat_ptr*_tmp76A=({struct _fat_ptr*_tmp32D=_cycalloc(sizeof(*_tmp32D));({struct _fat_ptr _tmp769=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp32C=({struct Cyc_Int_pa_PrintArg_struct _tmp663;_tmp663.tag=1U,_tmp663.f1=(unsigned long)counter ++;_tmp663;});void*_tmp32A[1U];_tmp32A[0]=& _tmp32C;({struct _fat_ptr _tmp768=({const char*_tmp32B="__aliasvar%d";_tag_fat(_tmp32B,sizeof(char),13U);});Cyc_aprintf(_tmp768,_tag_fat(_tmp32A,sizeof(void*),1U));});});*_tmp32D=_tmp769;});_tmp32D;});_tmp32E->f2=_tmp76A;});_tmp32E;});
struct Cyc_Absyn_Vardecl*vd=Cyc_Absyn_new_vardecl(0U,v,e_type,e);
struct Cyc_Absyn_Exp*ve=({void*_tmp76B=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp329=_cycalloc(sizeof(*_tmp329));_tmp329->tag=4U,_tmp329->f1=vd;_tmp329;});Cyc_Absyn_varb_exp(_tmp76B,e->loc);});
# 1831
...
# 1850
return({struct _tuple23 _tmp662;_tmp662.f1=d,_tmp662.f2=ve;_tmp662;});}}
# 1855
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp334=({struct Cyc_Warn_String_Warn_Warg_struct _tmp668;_tmp668.tag=0U,({struct _fat_ptr _tmp76C=({const char*_tmp33B="integral size mismatch; ";_tag_fat(_tmp33B,sizeof(char),25U);});_tmp668.f1=_tmp76C;});_tmp668;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp335=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp667;_tmp667.tag=2U,_tmp667.f1=(void*)t1;_tmp667;});struct Cyc_Warn_String_Warn_Warg_struct _tmp336=({struct Cyc_Warn_String_Warn_Warg_struct _tmp666;_tmp666.tag=0U,({
struct _fat_ptr _tmp76D=({const char*_tmp33A=" -> ";_tag_fat(_tmp33A,sizeof(char),5U);});_tmp666.f1=_tmp76D;});_tmp666;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp337=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp665;_tmp665.tag=2U,_tmp665.f1=(void*)t2;_tmp665;});struct Cyc_Warn_String_Warn_Warg_struct _tmp338=({struct Cyc_Warn_String_Warn_Warg_struct _tmp664;_tmp664.tag=0U,({struct _fat_ptr _tmp76E=({const char*_tmp339=" conversion supplied";_tag_fat(_tmp339,sizeof(char),21U);});_tmp664.f1=_tmp76E;});_tmp664;});void*_tmp333[5U];_tmp333[0]=& _tmp334,_tmp333[1]=& _tmp335,_tmp333[2]=& _tmp336,_tmp333[3]=& _tmp337,_tmp333[4]=& _tmp338;({unsigned _tmp76F=e->loc;Cyc_Warn_warn2(_tmp76F,_tag_fat(_tmp333,sizeof(void*),5U));});});
Cyc_Tcutil_unchecked_cast(e,t2,Cyc_Absyn_No_coercion);
return 1;}
# 1894
if(Cyc_Tcutil_can_insert_alias(e,t1,t2,e->loc)){
if(Cyc_Tcutil_warn_alias_coerce)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp33D=({struct Cyc_Warn_String_Warn_Warg_struct _tmp66E;_tmp66E.tag=0U,({struct _fat_ptr _tmp770=({const char*_tmp345="implicit alias coercion for ";_tag_fat(_tmp345,sizeof(char),29U);});_tmp66E.f1=_tmp770;});_tmp66E;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp33E=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp66D;_tmp66D.tag=4U,_tmp66D.f1=e;_tmp66D;});struct Cyc_Warn_String_Warn_Warg_struct _tmp33F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp66C;_tmp66C.tag=0U,({struct _fat_ptr _tmp771=({const char*_tmp344=":";_tag_fat(_tmp344,sizeof(char),2U);});_tmp66C.f1=_tmp771;});_tmp66C;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp340=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp66B;_tmp66B.tag=2U,_tmp66B.f1=(void*)t1;_tmp66B;});struct Cyc_Warn_String_Warn_Warg_struct _tmp341=({struct Cyc_Warn_String_Warn_Warg_struct _tmp66A;_tmp66A.tag=0U,({struct _fat_ptr _tmp772=({const char*_tmp343=" to ";_tag_fat(_tmp343,sizeof(char),5U);});_tmp66A.f1=_tmp772;});_tmp66A;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp342=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp669;_tmp669.tag=2U,_tmp669.f1=(void*)t2;_tmp669;});void*_tmp33C[6U];_tmp33C[0]=& _tmp33D,_tmp33C[1]=& _tmp33E,_tmp33C[2]=& _tmp33F,_tmp33C[3]=& _tmp340,_tmp33C[4]=& _tmp341,_tmp33C[5]=& _tmp342;({unsigned _tmp773=e->loc;Cyc_Warn_warn2(_tmp773,_tag_fat(_tmp33C,sizeof(void*),6U));});});
if(alias_coercion != 0)
*alias_coercion=1;}
# 1901
...
if((int)c != (int)2U)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp347=({struct Cyc_Warn_String_Warn_Warg_struct _tmp672;_tmp672.tag=0U,({struct _fat_ptr _tmp774=({const char*_tmp34C="implicit cast from ";_tag_fat(_tmp34C,sizeof(char),20U);});_tmp672.f1=_tmp774;});_tmp672;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp348=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp671;_tmp671.tag=2U,_tmp671.f1=(void*)t1;_tmp671;});struct Cyc_Warn_String_Warn_Warg_struct _tmp349=({struct Cyc_Warn_String_Warn_Warg_struct _tmp670;_tmp670.tag=0U,({struct _fat_ptr _tmp775=({const char*_tmp34B=" to ";_tag_fat(_tmp34B,sizeof(char),5U);});_tmp670.f1=_tmp775;});_tmp670;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp34A=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp66F;_tmp66F.tag=2U,_tmp66F.f1=(void*)t2;_tmp66F;});void*_tmp346[4U];_tmp346[0]=& _tmp347,_tmp346[1]=& _tmp348,_tmp346[2]=& _tmp349,_tmp346[3]=& _tmp34A;({unsigned _tmp776=e->loc;Cyc_Warn_warn2(_tmp776,_tag_fat(_tmp346,sizeof(void*),4U));});});
return 1;}
# 1915
return 0;}
# 1921
...
return({struct Cyc_List_List*_tmp355=_region_malloc(r,sizeof(*_tmp355));({struct _tuple12*_tmp777=({struct _tuple12*_tmp354=_region_malloc(r,sizeof(*_tmp354));_tmp354->f1=x->tq,_tmp354->f2=t;_tmp354;});_tmp355->hd=_tmp777;}),_tmp355->tl=0;_tmp355;});
...
if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ts)== 1)
return({struct Cyc_List_List*_tmp360=_region_malloc(r,sizeof(*_tmp360));({struct _tuple12*_tmp778=({struct _tuple12*_tmp35F=_region_malloc(r,sizeof(*_tmp35F));_tmp35F->f1=tq,_tmp35F->f2=t;_tmp35F;});_tmp360->hd=_tmp778;}),_tmp360->tl=0;_tmp360;});
return ts;}}}
# 1955
...
# 1977
return({struct Cyc_List_List*_tmp370=_region_malloc(r,sizeof(*_tmp370));({struct _tuple12*_tmp77A=({struct _tuple12*_tmp36F=_region_malloc(r,sizeof(*_tmp36F));({struct Cyc_Absyn_Tqual _tmp779=Cyc_Absyn_empty_tqual(0U);_tmp36F->f1=_tmp779;}),_tmp36F->f2=t1;_tmp36F;});_tmp370->hd=_tmp77A;}),_tmp370->tl=0;_tmp370;});{
...
struct _tuple24 env=({struct _tuple24 _tmp673;_tmp673.f1=inst,_tmp673.f2=r,_tmp673.f3=flatten;_tmp673;});
...
# 1962
struct _tuple25 _tmp366=({struct _tuple25 _tmp674;_tmp674.f1=r,_tmp674.f2=flatten;_tmp674;});struct _tuple25 env=_tmp366;
# 1964
...
return({struct _RegionHandle*_tmp77B=r;((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*x))Cyc_List_rflatten)(_tmp77B,({struct Cyc_List_List*_tmp36D=_region_malloc(r,sizeof(*_tmp36D));_tmp36D->hd=hd2,_tmp36D->tl=tl2;_tmp36D;}));});}}}_LLB:;}case 7U: if(((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp361)->f1 == Cyc_Absyn_StructA){_LL7: _tmp362=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp361)->f2;_LL8: {struct Cyc_List_List*fs=_tmp362;
# 1990
struct _tuple24 env=({struct _tuple24 _tmp675;_tmp675.f1=0,_tmp675.f2=r,_tmp675.f3=flatten;_tmp675;});
...
# 2000
 goto _LL0;}_LL0:;}}
# 2003
return({struct Cyc_List_List*_tmp382=_region_malloc(r,sizeof(*_tmp382));({struct _tuple12*_tmp77D=({struct _tuple12*_tmp381=_region_malloc(r,sizeof(*_tmp381));({struct Cyc_Absyn_Tqual _tmp77C=Cyc_Absyn_empty_tqual(0U);_tmp381->f1=_tmp77C;}),_tmp381->f2=t1;_tmp381;});_tmp382->hd=_tmp77D;}),_tmp382->tl=0;_tmp382;});}
# 2007
...
struct Cyc_Absyn_Exp*_tmp39E=({void*_tmp780=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp780,b_a);});struct Cyc_Absyn_Exp*e1=_tmp39E;
struct Cyc_Absyn_Exp*_tmp39F=({void*_tmp781=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp781,b_b);});struct Cyc_Absyn_Exp*e2=_tmp39F;
if(e1 != e2){
...
if(({int _tmp788=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(tvs1);_tmp788 != ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(tvs2);}))return 0;{
...
inst=({struct Cyc_List_List*_tmp3A6=_cycalloc(sizeof(*_tmp3A6));({struct _tuple19*_tmp78A=({struct _tuple19*_tmp3A5=_cycalloc(sizeof(*_tmp3A5));_tmp3A5->f1=(struct Cyc_Absyn_Tvar*)tvs2->hd,({void*_tmp789=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)tvs1->hd);_tmp3A5->f2=_tmp789;});_tmp3A5;});_tmp3A6->hd=_tmp78A;}),_tmp3A6->tl=inst;_tmp3A6;});
tvs1=tvs1->tl;
tvs2=tvs2->tl;}
# 2104
if(inst != 0){
f1.tvars=0;
f2.tvars=0;
return({struct Cyc_RgnOrder_RgnPO*_tmp78D=po;struct Cyc_List_List*_tmp78C=assume;void*_tmp78B=(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp3A7=_cycalloc(sizeof(*_tmp3A7));_tmp3A7->tag=5U,_tmp3A7->f1=f1;_tmp3A7;});Cyc_Tcutil_subtype(_tmp78D,_tmp78C,_tmp78B,(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp3A8=_cycalloc(sizeof(*_tmp3A8));_tmp3A8->tag=5U,_tmp3A8->f1=f2;_tmp3A8;}));});}}}
# 2111
...
# 2116
if(({int _tmp78E=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(args1);_tmp78E != ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(args2);}))return 0;
# 2118
...
# 2136
if(!({void*_tmp78F=(void*)_check_null(f1.effect);Cyc_Tcutil_subset_effect(1,_tmp78F,(void*)_check_null(f2.effect));}))return 0;
# 2138
...
struct Cyc_List_List*_tmp3D2=({struct Cyc_List_List*_tmp3DA=_cycalloc(sizeof(*_tmp3DA));({struct _tuple15*_tmp790=({struct _tuple15*_tmp3D9=_cycalloc(sizeof(*_tmp3D9));_tmp3D9->f1=t1,_tmp3D9->f2=t2;_tmp3D9;});_tmp3DA->hd=_tmp790;}),_tmp3DA->tl=0;_tmp3DA;});struct Cyc_List_List*assump=_tmp3D2;
int _tmp3D3=q_b.real_const || !q_a.real_const;int quals_okay=_tmp3D3;
# 2221 "tcutil.cyc"
int _tmp3D4=
({void*_tmp791=b_b;Cyc_Unify_unify(_tmp791,Cyc_Absyn_bounds_one());})&& !Cyc_Tcutil_force_type2bool(0,zt_b);
# 2221
...
struct Cyc_Absyn_Exp*_tmp3D7=({void*_tmp792=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp792,b_a);});struct Cyc_Absyn_Exp*e_a=_tmp3D7;
struct Cyc_Absyn_Exp*_tmp3D8=({void*_tmp793=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp793,b_b);});struct Cyc_Absyn_Exp*e_b=_tmp3D8;
...
int _tmp794=((int(*)(struct Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(ed1->fields))->v);_tmp794 >= ((int(*)(struct Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(ed2->fields))->v);}))
...
({void*_tmp795=(void*)({struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp3E5=_cycalloc(sizeof(*_tmp3E5));_tmp3E5->tag=14U,_tmp3E5->f1=t,_tmp3E5->f2=inner,_tmp3E5->f3=0,_tmp3E5->f4=c;_tmp3E5;});e->r=_tmp795;});
e->topt=t;}}
# 2304
...
return({struct Cyc_Absyn_Tvar*_tmp3EA=_cycalloc(sizeof(*_tmp3EA));({struct _fat_ptr*_tmp798=({struct _fat_ptr*_tmp3E9=_cycalloc(sizeof(*_tmp3E9));({struct _fat_ptr _tmp797=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp3E8=({struct Cyc_Int_pa_PrintArg_struct _tmp678;_tmp678.tag=1U,_tmp678.f1=(unsigned long)Cyc_Tcutil_tvar_counter ++;_tmp678;});void*_tmp3E6[1U];_tmp3E6[0]=& _tmp3E8;({struct _fat_ptr _tmp796=({const char*_tmp3E7="#%d";_tag_fat(_tmp3E7,sizeof(char),4U);});Cyc_aprintf(_tmp796,_tag_fat(_tmp3E6,sizeof(void*),1U));});});*_tmp3E9=_tmp797;});_tmp3E9;});_tmp3EA->name=_tmp798;}),_tmp3EA->identity=- 1,_tmp3EA->kind=k;_tmp3EA;});}
# 2313
...
if(({struct _fat_ptr _tmp799=(struct _fat_ptr)*var;Cyc_strcmp(_tmp799,({const char*_tmp3F7="return_value";_tag_fat(_tmp3F7,sizeof(char),13U);}));})== 0){
({union Cyc_Relations_RelnOp _tmp79A=Cyc_Relations_RReturn();*rop=_tmp79A;});
goto _LL0;}{
# 2349
unsigned c=0U;
...
({union Cyc_Relations_RelnOp _tmp79B=Cyc_Relations_RParam(c);*rop=_tmp79B;});
break;}}}}
# 2357
...
if(vopt != 0 && Cyc_strcmp((struct _fat_ptr)*var,(struct _fat_ptr)*vopt)== 0){
({union Cyc_Relations_RelnOp _tmp79C=Cyc_Relations_RParamNumelts(c);*rop=_tmp79C;});
break;}}}}
# 2369
...
# 2395
return({struct _tuple27*_tmp40A=_region_malloc(rgn,sizeof(*_tmp40A));({struct _tuple26*_tmp79D=({struct _tuple26*_tmp409=_region_malloc(rgn,sizeof(*_tmp409));_tmp409->f1=(*y).f1,_tmp409->f2=(*y).f2;_tmp409;});_tmp40A->f1=_tmp79D;}),_tmp40A->f2=(*y).f3;_tmp40A;});}
# 2397
...
return new_e1 == e1?e:({struct Cyc_Absyn_Exp*_tmp79F=e;Cyc_Tcutil_copye(_tmp79F,(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp42C=_cycalloc(sizeof(*_tmp42C));_tmp42C->tag=3U,_tmp42C->f1=p,({struct Cyc_List_List*_tmp79E=({struct Cyc_Absyn_Exp*_tmp42B[1U];_tmp42B[0]=new_e1;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp42B,sizeof(struct Cyc_Absyn_Exp*),1U));});_tmp42C->f2=_tmp79E;});_tmp42C;}));});}else{
...
return({struct Cyc_Absyn_Exp*_tmp7A1=e;Cyc_Tcutil_copye(_tmp7A1,(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp432=_cycalloc(sizeof(*_tmp432));_tmp432->tag=3U,_tmp432->f1=p,({struct Cyc_List_List*_tmp7A0=({struct Cyc_Absyn_Exp*_tmp431[2U];_tmp431[0]=new_e1,_tmp431[1]=new_e2;((struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list)(_tag_fat(_tmp431,sizeof(struct Cyc_Absyn_Exp*),2U));});_tmp432->f2=_tmp7A0;});_tmp432;}));});}}
# 2435
return({struct Cyc_Warn_String_Warn_Warg_struct _tmp434=({struct Cyc_Warn_String_Warn_Warg_struct _tmp679;_tmp679.tag=0U,({struct _fat_ptr _tmp7A2=({const char*_tmp435="primop does not have 1 or 2 args!";_tag_fat(_tmp435,sizeof(char),34U);});_tmp679.f1=_tmp7A2;});_tmp679;});void*_tmp433[1U];_tmp433[0]=& _tmp434;((struct Cyc_Absyn_Exp*(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp433,sizeof(void*),1U));});}case 6U: _LLD: _tmp424=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp413)->f1;_tmp425=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp413)->f2;_tmp426=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp413)->f3;_LLE: {struct Cyc_Absyn_Exp*e1=_tmp424;struct Cyc_Absyn_Exp*e2=_tmp425;struct Cyc_Absyn_Exp*e3=_tmp426;
# 2437
...
return e;}}else{_LL26: _LL27:
 return({struct Cyc_Absyn_Exp*_tmp7AC=e;Cyc_Tcutil_copye(_tmp7AC,(void*)({struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp452=_cycalloc(sizeof(*_tmp452));_tmp452->tag=39U,_tmp452->f1=new_typ;_tmp452;}));});}_LL23:;}}default: _LL21: _LL22:
# 2482
 return({struct Cyc_Warn_String_Warn_Warg_struct _tmp454=({struct Cyc_Warn_String_Warn_Warg_struct _tmp67A;_tmp67A.tag=0U,({struct _fat_ptr _tmp7AD=({const char*_tmp455="non-type-level-expression in Tcutil::rsubsexp";_tag_fat(_tmp455,sizeof(char),46U);});_tmp67A.f1=_tmp7AD;});_tmp67A;});void*_tmp453[1U];_tmp453[0]=& _tmp454;((struct Cyc_Absyn_Exp*(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp453,sizeof(void*),1U));});}_LL0:;}
# 2486
...
return t;
return Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp67B;_tmp67B.elt_type=new_t1,_tmp67B.elt_tq=tq,(_tmp67B.ptr_atts).rgn=new_r,(_tmp67B.ptr_atts).nullable=n,(_tmp67B.ptr_atts).bounds=new_b,(_tmp67B.ptr_atts).zero_term=new_zt,(_tmp67B.ptr_atts).ptrloc=0;_tmp67B;}));}case 5U: _LL9: _tmp471=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).tvars;_tmp472=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).effect;_tmp473=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).ret_tqual;_tmp474=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).ret_type;_tmp475=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).args;_tmp476=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).c_varargs;_tmp477=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).cyc_varargs;_tmp478=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).rgn_po;_tmp479=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).attributes;_tmp47A=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).requires_clause;_tmp47B=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).ensures_clause;_tmp47C=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp468)->f1).return_value;_LLA: {struct Cyc_List_List*vs=_tmp471;void*eff=_tmp472;struct Cyc_Absyn_Tqual rtq=_tmp473;void*rtyp=_tmp474;struct Cyc_List_List*args=_tmp475;int c_varargs=_tmp476;struct Cyc_Absyn_VarargInfo*cyc_varargs=_tmp477;struct Cyc_List_List*rgn_po=_tmp478;struct Cyc_List_List*atts=_tmp479;struct Cyc_Absyn_Exp*req=_tmp47A;struct Cyc_Absyn_Exp*ens=_tmp47B;struct Cyc_Absyn_Vardecl*ret_value=_tmp47C;
# 2562
if(Cyc_Tcutil_skip_fntypes)return t;
# 2564
{struct Cyc_List_List*_tmp49D=vs;struct Cyc_List_List*p=_tmp49D;for(0;p != 0;p=p->tl){
inst=({struct Cyc_List_List*_tmp49F=_region_malloc(rgn,sizeof(*_tmp49F));({struct _tuple19*_tmp7AF=({struct _tuple19*_tmp49E=_region_malloc(rgn,sizeof(*_tmp49E));_tmp49E->f1=(struct Cyc_Absyn_Tvar*)p->hd,({void*_tmp7AE=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)p->hd);_tmp49E->f2=_tmp7AE;});_tmp49E;});_tmp49F->hd=_tmp7AF;}),_tmp49F->tl=inst;_tmp49F;});}}{
struct _tuple0 _tmp4A0=({struct _RegionHandle*_tmp7B1=rgn;struct _RegionHandle*_tmp7B0=rgn;((struct _tuple0(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x))Cyc_List_rsplit)(_tmp7B1,_tmp7B0,
...
# 2601
return !change?t:(void*)({struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmp4B5=_cycalloc(sizeof(*_tmp4B5));_tmp4B5->tag=6U,({struct Cyc_List_List*_tmp7B4=({struct Cyc_List_List*_tmp7B3=tqts;((struct Cyc_List_List*(*)(struct _tuple12*(*f)(struct _tuple12*,void*),struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_map2)(Cyc_Tcutil_map2_tq,_tmp7B3,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(ts2));});_tmp4B5->f1=_tmp7B4;});_tmp4B5;});}case 7U: _LLD: _tmp46E=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp468)->f1;_tmp46F=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp468)->f2;_LLE: {enum Cyc_Absyn_AggrKind k=_tmp46E;struct Cyc_List_List*fs=_tmp46F;
# 2603
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4BF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp67C;_tmp67C.tag=0U,({struct _fat_ptr _tmp7B5=({const char*_tmp4C0="found typedecltype in rsubs";_tag_fat(_tmp4C0,sizeof(char),28U);});_tmp67C.f1=_tmp7B5;});_tmp67C;});void*_tmp4BE[1U];_tmp4BE[0]=& _tmp4BF;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp4BE,sizeof(void*),1U));});}}_LL0:;}
# 2622
...
void*_tmp4C6=Cyc_Tcutil_substitute(inst,t);void*new_t=_tmp4C6;
Cyc_Tcutil_skip_fntypes=0;
return new_t;}}
# 2648
struct _tuple19*Cyc_Tcutil_make_inst_var(struct Cyc_List_List*s,struct Cyc_Absyn_Tvar*tv){
struct Cyc_Core_Opt*_tmp4C7=Cyc_Tcutil_kind_to_opt(Cyc_Tcutil_tvar_kind(tv,& Cyc_Tcutil_bk));struct Cyc_Core_Opt*k=_tmp4C7;
return({struct _tuple19*_tmp4C9=_cycalloc(sizeof(*_tmp4C9));_tmp4C9->f1=tv,({void*_tmp7B7=({struct Cyc_Core_Opt*_tmp7B6=k;Cyc_Absyn_new_evar(_tmp7B6,({struct Cyc_Core_Opt*_tmp4C8=_cycalloc(sizeof(*_tmp4C8));_tmp4C8->v=s;_tmp4C8;}));});_tmp4C9->f2=_tmp7B7;});_tmp4C9;});}struct _tuple28{struct Cyc_List_List*f1;struct _RegionHandle*f2;};
# 2653
struct _tuple19*Cyc_Tcutil_r_make_inst_var(struct _tuple28*env,struct Cyc_Absyn_Tvar*tv){
# 2655
struct _tuple28*_tmp4CA=env;struct _RegionHandle*_tmp4CC;struct Cyc_List_List*_tmp4CB;_LL1: _tmp4CB=_tmp4CA->f1;_tmp4CC=_tmp4CA->f2;_LL2: {struct Cyc_List_List*s=_tmp4CB;struct _RegionHandle*rgn=_tmp4CC;
struct Cyc_Core_Opt*_tmp4CD=Cyc_Tcutil_kind_to_opt(Cyc_Tcutil_tvar_kind(tv,& Cyc_Tcutil_bk));struct Cyc_Core_Opt*k=_tmp4CD;
return({struct _tuple19*_tmp4CF=_region_malloc(rgn,sizeof(*_tmp4CF));_tmp4CF->f1=tv,({void*_tmp7B9=({struct Cyc_Core_Opt*_tmp7B8=k;Cyc_Absyn_new_evar(_tmp7B8,({struct Cyc_Core_Opt*_tmp4CE=_cycalloc(sizeof(*_tmp4CE));_tmp4CE->v=s;_tmp4CE;}));});_tmp4CF->f2=_tmp7B9;});_tmp4CF;});}}
# 2660
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4D1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp67F;_tmp67F.tag=0U,({struct _fat_ptr _tmp7BA=({const char*_tmp4D5="bitfield ";_tag_fat(_tmp4D5,sizeof(char),10U);});_tmp67F.f1=_tmp7BA;});_tmp67F;});struct Cyc_Warn_String_Warn_Warg_struct _tmp4D2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp67E;_tmp67E.tag=0U,_tmp67E.f1=*fn;_tmp67E;});struct Cyc_Warn_String_Warn_Warg_struct _tmp4D3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp67D;_tmp67D.tag=0U,({struct _fat_ptr _tmp7BB=({const char*_tmp4D4=" does not have constant width";_tag_fat(_tmp4D4,sizeof(char),30U);});_tmp67D.f1=_tmp7BB;});_tmp67D;});void*_tmp4D0[3U];_tmp4D0[0]=& _tmp4D1,_tmp4D0[1]=& _tmp4D2,_tmp4D0[2]=& _tmp4D3;({unsigned _tmp7BC=loc;Cyc_Warn_err2(_tmp7BC,_tag_fat(_tmp4D0,sizeof(void*),3U));});});else{
# 2667
struct _tuple13 _tmp4D6=Cyc_Evexp_eval_const_uint_exp(width);struct _tuple13 _stmttmp6C=_tmp4D6;struct _tuple13 _tmp4D7=_stmttmp6C;int _tmp4D9;unsigned _tmp4D8;_LL1: _tmp4D8=_tmp4D7.f1;_tmp4D9=_tmp4D7.f2;_LL2: {unsigned i=_tmp4D8;int known=_tmp4D9;
if(!known)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4DB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp680;_tmp680.tag=0U,({struct _fat_ptr _tmp7BD=({const char*_tmp4DC="cannot evaluate bitfield width at compile time";_tag_fat(_tmp4DC,sizeof(char),47U);});_tmp680.f1=_tmp7BD;});_tmp680;});void*_tmp4DA[1U];_tmp4DA[0]=& _tmp4DB;({unsigned _tmp7BE=loc;Cyc_Warn_warn2(_tmp7BE,_tag_fat(_tmp4DA,sizeof(void*),1U));});});
if((int)i < 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4DE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp681;_tmp681.tag=0U,({struct _fat_ptr _tmp7BF=({const char*_tmp4DF="bitfield has negative width";_tag_fat(_tmp4DF,sizeof(char),28U);});_tmp681.f1=_tmp7BF;});_tmp681;});void*_tmp4DD[1U];_tmp4DD[0]=& _tmp4DE;({unsigned _tmp7C0=loc;Cyc_Warn_err2(_tmp7C0,_tag_fat(_tmp4DD,sizeof(void*),1U));});});
w=i;}}{
# 2674
void*_tmp4E0=Cyc_Tcutil_compress(field_type);void*_stmttmp6D=_tmp4E0;void*_tmp4E1=_stmttmp6D;enum Cyc_Absyn_Size_of _tmp4E2;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4E1)->tag == 0U){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4E1)->f1)->tag == 1U){_LL4: _tmp4E2=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4E1)->f1)->f2;_LL5: {enum Cyc_Absyn_Size_of b=_tmp4E2;
# 2677
int bad;
{enum Cyc_Absyn_Size_of _tmp4E3=b;switch(_tmp4E3){case Cyc_Absyn_Char_sz: _LL9: _LLA:
...
# 2686
if(bad)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp682;_tmp682.tag=0U,({struct _fat_ptr _tmp7C1=({const char*_tmp4E6="bitfield larger than type";_tag_fat(_tmp4E6,sizeof(char),26U);});_tmp682.f1=_tmp7C1;});_tmp682;});void*_tmp4E4[1U];_tmp4E4[0]=& _tmp4E5;({unsigned _tmp7C2=loc;Cyc_Warn_warn2(_tmp7C2,_tag_fat(_tmp4E4,sizeof(void*),1U));});});
goto _LL3;}}else{goto _LL6;}}else{_LL6: _LL7:
# 2690
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp686;_tmp686.tag=0U,({struct _fat_ptr _tmp7C3=({const char*_tmp4ED="bitfield ";_tag_fat(_tmp4ED,sizeof(char),10U);});_tmp686.f1=_tmp7C3;});_tmp686;});struct Cyc_Warn_String_Warn_Warg_struct _tmp4E9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp685;_tmp685.tag=0U,_tmp685.f1=*fn;_tmp685;});struct Cyc_Warn_String_Warn_Warg_struct _tmp4EA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp684;_tmp684.tag=0U,({struct _fat_ptr _tmp7C4=({const char*_tmp4EC=" must have integral type but has type ";_tag_fat(_tmp4EC,sizeof(char),39U);});_tmp684.f1=_tmp7C4;});_tmp684;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4EB=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp683;_tmp683.tag=2U,_tmp683.f1=(void*)field_type;_tmp683;});void*_tmp4E7[4U];_tmp4E7[0]=& _tmp4E8,_tmp4E7[1]=& _tmp4E9,_tmp4E7[2]=& _tmp4EA,_tmp4E7[3]=& _tmp4EB;({unsigned _tmp7C5=loc;Cyc_Warn_err2(_tmp7C5,_tag_fat(_tmp4E7,sizeof(void*),4U));});});
# 2692
goto _LL3;}_LL3:;}}}
# 2699
int Cyc_Tcutil_extract_const_from_typedef(unsigned loc,int declared_const,void*t){
void*_tmp4EE=t;void*_tmp4F0;struct Cyc_Absyn_Typedefdecl*_tmp4EF;if(((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp4EE)->tag == 8U){_LL1: _tmp4EF=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp4EE)->f3;_tmp4F0=(void*)((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp4EE)->f4;_LL2: {struct Cyc_Absyn_Typedefdecl*td=_tmp4EF;void*tdopt=_tmp4F0;
# 2702
if((((struct Cyc_Absyn_Typedefdecl*)_check_null(td))->tq).real_const ||(td->tq).print_const){
if(declared_const)({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp687;_tmp687.tag=0U,({struct _fat_ptr _tmp7C6=({const char*_tmp4F3="extra const";_tag_fat(_tmp4F3,sizeof(char),12U);});_tmp687.f1=_tmp7C6;});_tmp687;});void*_tmp4F1[1U];_tmp4F1[0]=& _tmp4F2;({unsigned _tmp7C7=loc;Cyc_Warn_warn2(_tmp7C7,_tag_fat(_tmp4F1,sizeof(void*),1U));});});
return 1;}
# 2707
if((unsigned)tdopt)
...
if(tv->identity == - 1)
({int _tmp7C8=Cyc_Tcutil_new_tvar_id();tv->identity=_tmp7C8;});}
# 2718
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp68A;_tmp68A.tag=0U,_tmp68A.f1=msg;_tmp68A;});struct Cyc_Warn_String_Warn_Warg_struct _tmp4F6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp689;_tmp689.tag=0U,({struct _fat_ptr _tmp7C9=({const char*_tmp4F8=": ";_tag_fat(_tmp4F8,sizeof(char),3U);});_tmp689.f1=_tmp7C9;});_tmp689;});struct Cyc_Warn_String_Warn_Warg_struct _tmp4F7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp688;_tmp688.tag=0U,({struct _fat_ptr _tmp7CA=a2string(vs->hd);_tmp688.f1=_tmp7CA;});_tmp688;});void*_tmp4F4[3U];_tmp4F4[0]=& _tmp4F5,_tmp4F4[1]=& _tmp4F6,_tmp4F4[2]=& _tmp4F7;({unsigned _tmp7CB=loc;Cyc_Warn_err2(_tmp7CB,_tag_fat(_tmp4F4,sizeof(void*),3U));});});}}}
# 2732
...
({struct Cyc_List_List*_tmp7CD=tvs;unsigned _tmp7CC=loc;((void(*)(int(*cmp)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*vs,unsigned loc,struct _fat_ptr(*a2string)(struct Cyc_Absyn_Tvar*),struct _fat_ptr msg))Cyc_Tcutil_check_unique_unsorted)(Cyc_Absyn_tvar_cmp,_tmp7CD,_tmp7CC,Cyc_Absynpp_tvar2string,({const char*_tmp4F9="duplicate type variable";_tag_fat(_tmp4F9,sizeof(char),24U);}));});}struct _tuple29{struct Cyc_Absyn_Aggrfield*f1;int f2;};struct _tuple30{struct Cyc_List_List*f1;void*f2;};struct _tuple31{struct Cyc_Absyn_Aggrfield*f1;void*f2;};
# 2753 "tcutil.cyc"
...
# 2758
struct _RegionHandle _tmp4FA=_new_region("temp");struct _RegionHandle*temp=& _tmp4FA;_push_region(temp);
# 2762
{struct Cyc_List_List*fields=0;
{struct Cyc_List_List*sd_fields=sdfields;for(0;sd_fields != 0;sd_fields=sd_fields->tl){
if(({struct _fat_ptr _tmp7CE=(struct _fat_ptr)*((struct Cyc_Absyn_Aggrfield*)sd_fields->hd)->name;Cyc_strcmp(_tmp7CE,({const char*_tmp4FB="";_tag_fat(_tmp4FB,sizeof(char),1U);}));})!= 0)
fields=({struct Cyc_List_List*_tmp4FD=_region_malloc(temp,sizeof(*_tmp4FD));({struct _tuple29*_tmp7CF=({struct _tuple29*_tmp4FC=_region_malloc(temp,sizeof(*_tmp4FC));_tmp4FC->f1=(struct Cyc_Absyn_Aggrfield*)sd_fields->hd,_tmp4FC->f2=0;_tmp4FC;});_tmp4FD->hd=_tmp7CF;}),_tmp4FD->tl=fields;_tmp4FD;});}}
fields=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(fields);{
# 2768
struct _fat_ptr aggr_str=(int)aggr_kind == (int)0U?({const char*_tmp529="struct";_tag_fat(_tmp529,sizeof(char),7U);}):({const char*_tmp52A="union";_tag_fat(_tmp52A,sizeof(char),6U);});
# 2771
struct Cyc_List_List*ans=0;
for(0;des != 0;des=des->tl){
struct _tuple30*_tmp4FE=(struct _tuple30*)des->hd;struct _tuple30*_stmttmp6E=_tmp4FE;struct _tuple30*_tmp4FF=_stmttmp6E;void*_tmp501;struct Cyc_List_List*_tmp500;_LL1: _tmp500=_tmp4FF->f1;_tmp501=_tmp4FF->f2;_LL2: {struct Cyc_List_List*dl=_tmp500;void*a=_tmp501;
if(dl == 0){
# 2776
...
({struct Cyc_List_List*_tmp7D1=({struct Cyc_List_List*_tmp504=_cycalloc(sizeof(*_tmp504));({void*_tmp7D0=(void*)({struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_tmp503=_cycalloc(sizeof(*_tmp503));_tmp503->tag=1U,_tmp503->f1=((*((struct _tuple29*)fields2->hd)).f1)->name;_tmp503;});_tmp504->hd=_tmp7D0;}),_tmp504->tl=0;_tmp504;});(*((struct _tuple30*)des->hd)).f1=_tmp7D1;});
ans=({struct Cyc_List_List*_tmp506=_region_malloc(rgn,sizeof(*_tmp506));({struct _tuple31*_tmp7D2=({struct _tuple31*_tmp505=_region_malloc(rgn,sizeof(*_tmp505));_tmp505->f1=(*((struct _tuple29*)fields2->hd)).f1,_tmp505->f2=a;_tmp505;});_tmp506->hd=_tmp7D2;}),_tmp506->tl=ans;_tmp506;});
break;}}
# 2784
if(fields2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp508=({struct Cyc_Warn_String_Warn_Warg_struct _tmp68C;_tmp68C.tag=0U,({struct _fat_ptr _tmp7D3=({const char*_tmp50A="too many arguments to ";_tag_fat(_tmp50A,sizeof(char),23U);});_tmp68C.f1=_tmp7D3;});_tmp68C;});struct Cyc_Warn_String_Warn_Warg_struct _tmp509=({struct Cyc_Warn_String_Warn_Warg_struct _tmp68B;_tmp68B.tag=0U,_tmp68B.f1=aggr_str;_tmp68B;});void*_tmp507[2U];_tmp507[0]=& _tmp508,_tmp507[1]=& _tmp509;({unsigned _tmp7D4=loc;Cyc_Warn_err2(_tmp7D4,_tag_fat(_tmp507,sizeof(void*),2U));});});}else{
if(dl->tl != 0)
# 2788
({struct Cyc_Warn_String_Warn_Warg_struct _tmp50C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp68D;_tmp68D.tag=0U,({struct _fat_ptr _tmp7D5=({const char*_tmp50D="multiple designators are not yet supported";_tag_fat(_tmp50D,sizeof(char),43U);});_tmp68D.f1=_tmp7D5;});_tmp68D;});void*_tmp50B[1U];_tmp50B[0]=& _tmp50C;({unsigned _tmp7D6=loc;Cyc_Warn_err2(_tmp7D6,_tag_fat(_tmp50B,sizeof(void*),1U));});});else{
# 2791
void*_tmp50E=(void*)dl->hd;void*_stmttmp6F=_tmp50E;void*_tmp50F=_stmttmp6F;struct _fat_ptr*_tmp510;if(((struct Cyc_Absyn_ArrayElement_Absyn_Designator_struct*)_tmp50F)->tag == 0U){_LL4: _LL5:
# 2793
({struct Cyc_Warn_String_Warn_Warg_struct _tmp512=({struct Cyc_Warn_String_Warn_Warg_struct _tmp68F;_tmp68F.tag=0U,({struct _fat_ptr _tmp7D7=({const char*_tmp514="array designator used in argument to ";_tag_fat(_tmp514,sizeof(char),38U);});_tmp68F.f1=_tmp7D7;});_tmp68F;});struct Cyc_Warn_String_Warn_Warg_struct _tmp513=({struct Cyc_Warn_String_Warn_Warg_struct _tmp68E;_tmp68E.tag=0U,_tmp68E.f1=aggr_str;_tmp68E;});void*_tmp511[2U];_tmp511[0]=& _tmp512,_tmp511[1]=& _tmp513;({unsigned _tmp7D8=loc;Cyc_Warn_err2(_tmp7D8,_tag_fat(_tmp511,sizeof(void*),2U));});});
goto _LL3;}else{_LL6: _tmp510=((struct Cyc_Absyn_FieldName_Absyn_Designator_struct*)_tmp50F)->f1;_LL7: {struct _fat_ptr*v=_tmp510;
# 2796
struct Cyc_List_List*_tmp515=fields;struct Cyc_List_List*fields2=_tmp515;
for(0;fields2 != 0;fields2=fields2->tl){
if(Cyc_strptrcmp(v,((*((struct _tuple29*)fields2->hd)).f1)->name)== 0){
if((*((struct _tuple29*)fields2->hd)).f2)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp517=({struct Cyc_Warn_String_Warn_Warg_struct _tmp692;_tmp692.tag=0U,({struct _fat_ptr _tmp7D9=({const char*_tmp51B="member ";_tag_fat(_tmp51B,sizeof(char),8U);});_tmp692.f1=_tmp7D9;});_tmp692;});struct Cyc_Warn_String_Warn_Warg_struct _tmp518=({struct Cyc_Warn_String_Warn_Warg_struct _tmp691;_tmp691.tag=0U,_tmp691.f1=*v;_tmp691;});struct Cyc_Warn_String_Warn_Warg_struct _tmp519=({struct Cyc_Warn_String_Warn_Warg_struct _tmp690;_tmp690.tag=0U,({struct _fat_ptr _tmp7DA=({const char*_tmp51A=" has already been used as an argument";_tag_fat(_tmp51A,sizeof(char),38U);});_tmp690.f1=_tmp7DA;});_tmp690;});void*_tmp516[3U];_tmp516[0]=& _tmp517,_tmp516[1]=& _tmp518,_tmp516[2]=& _tmp519;({unsigned _tmp7DB=loc;Cyc_Warn_err2(_tmp7DB,_tag_fat(_tmp516,sizeof(void*),3U));});});
(*((struct _tuple29*)fields2->hd)).f2=1;
ans=({struct Cyc_List_List*_tmp51D=_region_malloc(rgn,sizeof(*_tmp51D));({struct _tuple31*_tmp7DC=({struct _tuple31*_tmp51C=_region_malloc(rgn,sizeof(*_tmp51C));_tmp51C->f1=(*((struct _tuple29*)fields2->hd)).f1,_tmp51C->f2=a;_tmp51C;});_tmp51D->hd=_tmp7DC;}),_tmp51D->tl=ans;_tmp51D;});
break;}}
# 2805
if(fields2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp51F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp694;_tmp694.tag=0U,({struct _fat_ptr _tmp7DD=({const char*_tmp521="bad field designator ";_tag_fat(_tmp521,sizeof(char),22U);});_tmp694.f1=_tmp7DD;});_tmp694;});struct Cyc_Warn_String_Warn_Warg_struct _tmp520=({struct Cyc_Warn_String_Warn_Warg_struct _tmp693;_tmp693.tag=0U,_tmp693.f1=*v;_tmp693;});void*_tmp51E[2U];_tmp51E[0]=& _tmp51F,_tmp51E[1]=& _tmp520;({unsigned _tmp7DE=loc;Cyc_Warn_err2(_tmp7DE,_tag_fat(_tmp51E,sizeof(void*),2U));});});
goto _LL3;}}_LL3:;}}}}
# 2812
if((int)aggr_kind == (int)0U){
if(({int _tmp7DF=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ans);_tmp7DF < ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(fields);}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp523=({struct Cyc_Warn_String_Warn_Warg_struct _tmp695;_tmp695.tag=0U,({struct _fat_ptr _tmp7E0=({const char*_tmp524="too few arguments to struct";_tag_fat(_tmp524,sizeof(char),28U);});_tmp695.f1=_tmp7E0;});_tmp695;});void*_tmp522[1U];_tmp522[0]=& _tmp523;({unsigned _tmp7E1=loc;Cyc_Warn_err2(_tmp7E1,_tag_fat(_tmp522,sizeof(void*),1U));});});}else{
if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(ans)!= 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp526=({struct Cyc_Warn_String_Warn_Warg_struct _tmp696;_tmp696.tag=0U,({struct _fat_ptr _tmp7E2=({const char*_tmp527="union expression should have one member";_tag_fat(_tmp527,sizeof(char),40U);});_tmp696.f1=_tmp7E2;});_tmp696;});void*_tmp525[1U];_tmp525[0]=& _tmp526;({unsigned _tmp7E3=loc;Cyc_Warn_err2(_tmp7E3,_tag_fat(_tmp525,sizeof(void*),1U));});});}{
struct Cyc_List_List*_tmp528=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(ans);_npop_handler(0U);return _tmp528;}}}
# 2762
;_pop_region();}
# 2823
int Cyc_Tcutil_is_zero_ptr_deref(struct Cyc_Absyn_Exp*e1,void**ptr_type,int*is_fat,void**elt_type){
# 2825
void*_tmp52B=e1->r;void*_stmttmp70=_tmp52B;void*_tmp52C=_stmttmp70;struct Cyc_Absyn_Exp*_tmp52D;struct Cyc_Absyn_Exp*_tmp52E;struct Cyc_Absyn_Exp*_tmp52F;struct Cyc_Absyn_Exp*_tmp530;struct Cyc_Absyn_Exp*_tmp531;struct Cyc_Absyn_Exp*_tmp532;switch(*((int*)_tmp52C)){case 14U: _LL1: _LL2:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp534=({struct Cyc_Warn_String_Warn_Warg_struct _tmp698;_tmp698.tag=0U,({struct _fat_ptr _tmp7E4=({const char*_tmp536="we have a cast in a lhs: ";_tag_fat(_tmp536,sizeof(char),26U);});_tmp698.f1=_tmp7E4;});_tmp698;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp535=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp697;_tmp697.tag=4U,_tmp697.f1=e1;_tmp697;});void*_tmp533[2U];_tmp533[0]=& _tmp534,_tmp533[1]=& _tmp535;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp533,sizeof(void*),2U));});case 20U: _LL3: _tmp532=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_LL4: {struct Cyc_Absyn_Exp*e1a=_tmp532;
_tmp531=e1a;goto _LL6;}case 23U: _LL5: _tmp531=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_LL6: {struct Cyc_Absyn_Exp*e1a=_tmp531;
# 2829
return Cyc_Tcutil_is_zero_ptr_type((void*)_check_null(e1a->topt),ptr_type,is_fat,elt_type);}case 22U: _LL7: _tmp530=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_LL8: {struct Cyc_Absyn_Exp*e1a=_tmp530;
_tmp52F=e1a;goto _LLA;}case 21U: _LL9: _tmp52F=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_LLA: {struct Cyc_Absyn_Exp*e1a=_tmp52F;
# 2833
if(Cyc_Tcutil_is_zero_ptr_type((void*)_check_null(e1a->topt),ptr_type,is_fat,elt_type))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp538=({struct Cyc_Warn_String_Warn_Warg_struct _tmp69A;_tmp69A.tag=0U,({struct _fat_ptr _tmp7E5=({const char*_tmp53A="found zero pointer aggregate member assignment: ";_tag_fat(_tmp53A,sizeof(char),49U);});_tmp69A.f1=_tmp7E5;});_tmp69A;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp539=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp699;_tmp699.tag=4U,_tmp699.f1=e1;_tmp699;});void*_tmp537[2U];_tmp537[0]=& _tmp538,_tmp537[1]=& _tmp539;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp537,sizeof(void*),2U));});
return 0;}case 13U: _LLB: _tmp52E=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_LLC: {struct Cyc_Absyn_Exp*e1a=_tmp52E;
_tmp52D=e1a;goto _LLE;}case 12U: _LLD: _tmp52D=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_LLE: {struct Cyc_Absyn_Exp*e1a=_tmp52D;
# 2838
if(Cyc_Tcutil_is_zero_ptr_type((void*)_check_null(e1a->topt),ptr_type,is_fat,elt_type))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp53C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp69C;_tmp69C.tag=0U,({struct _fat_ptr _tmp7E6=({const char*_tmp53E="found zero pointer instantiate/noinstantiate: ";_tag_fat(_tmp53E,sizeof(char),47U);});_tmp69C.f1=_tmp7E6;});_tmp69C;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp53D=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp69B;_tmp69B.tag=4U,_tmp69B.f1=e1;_tmp69B;});void*_tmp53B[2U];_tmp53B[0]=& _tmp53C,_tmp53B[1]=& _tmp53D;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp53B,sizeof(void*),2U));});
return 0;}case 1U: _LLF: _LL10:
 return 0;default: _LL11: _LL12:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp540=({struct Cyc_Warn_String_Warn_Warg_struct _tmp69E;_tmp69E.tag=0U,({struct _fat_ptr _tmp7E7=({const char*_tmp542="found bad lhs in is_zero_ptr_deref: ";_tag_fat(_tmp542,sizeof(char),37U);});_tmp69E.f1=_tmp7E7;});_tmp69E;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp541=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp69D;_tmp69D.tag=4U,_tmp69D.f1=e1;_tmp69D;});void*_tmp53F[2U];_tmp53F[0]=& _tmp540,_tmp53F[1]=& _tmp541;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp53F,sizeof(void*),2U));});}_LL0:;}
# 2852
int Cyc_Tcutil_is_noalias_region(void*r,int must_be_unique){
void*_tmp543=Cyc_Tcutil_compress(r);void*_stmttmp71=_tmp543;void*_tmp544=_stmttmp71;struct Cyc_Absyn_Tvar*_tmp545;enum Cyc_Absyn_AliasQual _tmp547;enum Cyc_Absyn_KindQual _tmp546;switch(*((int*)_tmp544)){case 0U: switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp544)->f1)){case 7U: _LL1: _LL2:
 return !must_be_unique;case 6U: _LL3: _LL4:
 return 1;default: goto _LL9;}case 8U: if(((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp544)->f3 != 0){if(((struct Cyc_Absyn_Typedefdecl*)((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp544)->f3)->kind != 0){if(((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp544)->f4 == 0){_LL5: _tmp546=((struct Cyc_Absyn_Kind*)((((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp544)->f3)->kind)->v)->kind;_tmp547=((struct Cyc_Absyn_Kind*)((((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp544)->f3)->kind)->v)->aliasqual;_LL6: {enum Cyc_Absyn_KindQual k=_tmp546;enum Cyc_Absyn_AliasQual a=_tmp547;
# 2857
return(int)k == (int)3U &&((int)a == (int)1U ||(int)a == (int)2U && !must_be_unique);}}else{goto _LL9;}}else{goto _LL9;}}else{goto _LL9;}case 2U: _LL7: _tmp545=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp544)->f1;_LL8: {struct Cyc_Absyn_Tvar*tv=_tmp545;
# 2861
struct Cyc_Absyn_Kind*_tmp548=Cyc_Tcutil_tvar_kind(tv,& Cyc_Tcutil_rk);struct Cyc_Absyn_Kind*_stmttmp72=_tmp548;struct Cyc_Absyn_Kind*_tmp549=_stmttmp72;enum Cyc_Absyn_AliasQual _tmp54B;enum Cyc_Absyn_KindQual _tmp54A;_LLC: _tmp54A=_tmp549->kind;_tmp54B=_tmp549->aliasqual;_LLD: {enum Cyc_Absyn_KindQual k=_tmp54A;enum Cyc_Absyn_AliasQual a=_tmp54B;
if((int)k == (int)3U &&((int)a == (int)1U ||(int)a == (int)2U && !must_be_unique)){
void*_tmp54C=Cyc_Absyn_compress_kb(tv->kind);void*_stmttmp73=_tmp54C;void*_tmp54D=_stmttmp73;struct Cyc_Core_Opt**_tmp54E;if(((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp54D)->tag == 2U){if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp54D)->f2)->kind == Cyc_Absyn_RgnKind){if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp54D)->f2)->aliasqual == Cyc_Absyn_Top){_LLF: _tmp54E=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp54D)->f1;_LL10: {struct Cyc_Core_Opt**x=_tmp54E;
# 2865
({struct Cyc_Core_Opt*_tmp7E9=({struct Cyc_Core_Opt*_tmp550=_cycalloc(sizeof(*_tmp550));({void*_tmp7E8=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp54F=_cycalloc(sizeof(*_tmp54F));_tmp54F->tag=2U,_tmp54F->f1=0,_tmp54F->f2=& Cyc_Tcutil_rk;_tmp54F;});_tmp550->v=_tmp7E8;});_tmp550;});*x=_tmp7E9;});
...
# 2877
int Cyc_Tcutil_is_noalias_pointer(void*t,int must_be_unique){
void*_tmp551=Cyc_Tcutil_compress(t);void*_stmttmp74=_tmp551;void*_tmp552=_stmttmp74;struct Cyc_Absyn_Tvar*_tmp553;void*_tmp554;switch(*((int*)_tmp552)){case 3U: _LL1: _tmp554=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp552)->f1).ptr_atts).rgn;_LL2: {void*r=_tmp554;
# 2880
return Cyc_Tcutil_is_noalias_region(r,must_be_unique);}case 2U: _LL3: _tmp553=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp552)->f1;_LL4: {struct Cyc_Absyn_Tvar*tv=_tmp553;
# 2882
struct Cyc_Absyn_Kind*_tmp555=Cyc_Tcutil_tvar_kind(tv,& Cyc_Tcutil_bk);struct Cyc_Absyn_Kind*_stmttmp75=_tmp555;struct Cyc_Absyn_Kind*_tmp556=_stmttmp75;enum Cyc_Absyn_AliasQual _tmp558;enum Cyc_Absyn_KindQual _tmp557;_LL8: _tmp557=_tmp556->kind;_tmp558=_tmp556->aliasqual;_LL9: {enum Cyc_Absyn_KindQual k=_tmp557;enum Cyc_Absyn_AliasQual a=_tmp558;
enum Cyc_Absyn_KindQual _tmp559=k;switch(_tmp559){case Cyc_Absyn_BoxKind: _LLB: _LLC:
...
void*_tmp55A=Cyc_Absyn_compress_kb(tv->kind);void*_stmttmp76=_tmp55A;void*_tmp55B=_stmttmp76;enum Cyc_Absyn_KindQual _tmp55D;struct Cyc_Core_Opt**_tmp55C;if(((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp55B)->tag == 2U){if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp55B)->f2)->aliasqual == Cyc_Absyn_Top){_LL14: _tmp55C=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp55B)->f1;_tmp55D=(((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp55B)->f2)->kind;_LL15: {struct Cyc_Core_Opt**x=_tmp55C;enum Cyc_Absyn_KindQual k=_tmp55D;
# 2888
({struct Cyc_Core_Opt*_tmp7EC=({struct Cyc_Core_Opt*_tmp560=_cycalloc(sizeof(*_tmp560));({void*_tmp7EB=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp55F=_cycalloc(sizeof(*_tmp55F));_tmp55F->tag=2U,_tmp55F->f1=0,({struct Cyc_Absyn_Kind*_tmp7EA=({struct Cyc_Absyn_Kind*_tmp55E=_cycalloc(sizeof(*_tmp55E));_tmp55E->kind=k,_tmp55E->aliasqual=Cyc_Absyn_Aliasable;_tmp55E;});_tmp55F->f2=_tmp7EA;});_tmp55F;});_tmp560->v=_tmp7EB;});_tmp560;});*x=_tmp7EC;});
...
return 1;{
void*_tmp561=t;struct Cyc_List_List*_tmp562;struct Cyc_List_List*_tmp564;union Cyc_Absyn_DatatypeFieldInfo _tmp563;struct Cyc_List_List*_tmp566;struct Cyc_Absyn_Aggrdecl**_tmp565;struct Cyc_List_List*_tmp567;switch(*((int*)_tmp561)){case 6U: _LL1: _tmp567=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp561)->f1;_LL2: {struct Cyc_List_List*qts=_tmp567;
# 2905
for(0;qts != 0;qts=qts->tl){
if(Cyc_Tcutil_is_noalias_pointer_or_aggr((*((struct _tuple12*)qts->hd)).f2))
return 1;}
return 0;}case 0U: switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp561)->f1)){case 20U: if(((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp561)->f1)->f1).KnownAggr).tag == 2){_LL3: _tmp565=((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp561)->f1)->f1).KnownAggr).val;_tmp566=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp561)->f2;_LL4: {struct Cyc_Absyn_Aggrdecl**adp=_tmp565;struct Cyc_List_List*ts=_tmp566;
# 2910
if((*adp)->impl == 0)
return 0;{
struct Cyc_List_List*_tmp568=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_zip)((*adp)->tvs,ts);struct Cyc_List_List*inst=_tmp568;
{struct Cyc_List_List*_tmp569=((struct Cyc_Absyn_AggrdeclImpl*)_check_null((*adp)->impl))->fields;struct Cyc_List_List*x=_tmp569;for(0;x != 0;x=x->tl){
...
# 2922
 ...
 return 0;case 19U: _LLB: _tmp563=((struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp561)->f1)->f1;_tmp564=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp561)->f2;_LLC: {union Cyc_Absyn_DatatypeFieldInfo tinfo=_tmp563;struct Cyc_List_List*ts=_tmp564;
# 2926
union Cyc_Absyn_DatatypeFieldInfo _tmp56A=tinfo;struct Cyc_Absyn_Datatypefield*_tmp56C;struct Cyc_Absyn_Datatypedecl*_tmp56B;if((_tmp56A.UnknownDatatypefield).tag == 1){_LL10: _LL11:
 return 0;}else{_LL12: _tmp56B=((_tmp56A.KnownDatatypefield).val).f1;_tmp56C=((_tmp56A.KnownDatatypefield).val).f2;_LL13: {struct Cyc_Absyn_Datatypedecl*td=_tmp56B;struct Cyc_Absyn_Datatypefield*fld=_tmp56C;
# 2929
struct Cyc_List_List*_tmp56D=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_zip)(td->tvs,ts);struct Cyc_List_List*inst=_tmp56D;
{struct Cyc_List_List*_tmp56E=fld->typs;struct Cyc_List_List*typs=_tmp56E;for(0;typs != 0;typs=typs->tl){
...
return 1;}}
# 2935
return 0;}}_LLF:;}default: goto _LLD;}case 7U: _LL5: _tmp562=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp561)->f2;_LL6: {struct Cyc_List_List*x=_tmp562;
# 2918
for(0;x != 0;x=x->tl){
...
void*_tmp56F=e->r;void*_stmttmp77=_tmp56F;void*_tmp570=_stmttmp77;struct Cyc_Absyn_Stmt*_tmp571;struct Cyc_Absyn_Exp*_tmp572;struct Cyc_Absyn_Exp*_tmp573;struct Cyc_Absyn_Exp*_tmp575;struct Cyc_Absyn_Exp*_tmp574;struct Cyc_Absyn_Exp*_tmp577;struct Cyc_Absyn_Exp*_tmp576;struct _fat_ptr*_tmp579;struct Cyc_Absyn_Exp*_tmp578;struct Cyc_Absyn_Exp*_tmp57A;struct Cyc_Absyn_Exp*_tmp57B;switch(*((int*)_tmp570)){case 1U: if(((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp570)->f1)->tag == 1U){_LL1: _LL2:
 return 0;}else{goto _LL13;}case 22U: _LL3: _tmp57B=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp570)->f1;_LL4: {struct Cyc_Absyn_Exp*e1=_tmp57B;
_tmp57A=e1;goto _LL6;}case 20U: _LL5: _tmp57A=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp570)->f1;_LL6: {struct Cyc_Absyn_Exp*e1=_tmp57A;
# 2949
return Cyc_Tcutil_is_noalias_pointer((void*)_check_null(e1->topt),1)&& Cyc_Tcutil_is_noalias_path(e1);}case 21U: _LL7: _tmp578=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp570)->f1;_tmp579=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp570)->f2;_LL8: {struct Cyc_Absyn_Exp*e1=_tmp578;struct _fat_ptr*f=_tmp579;
return Cyc_Tcutil_is_noalias_path(e1);}case 23U: _LL9: _tmp576=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp570)->f1;_tmp577=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp570)->f2;_LLA: {struct Cyc_Absyn_Exp*e1=_tmp576;struct Cyc_Absyn_Exp*e2=_tmp577;
# 2952
void*_tmp57C=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*_stmttmp78=_tmp57C;void*_tmp57D=_stmttmp78;if(((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp57D)->tag == 6U){_LL16: _LL17:
 return Cyc_Tcutil_is_noalias_path(e1);}else{_LL18: _LL19:
 return 0;}_LL15:;}case 6U: _LLB: _tmp574=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp570)->f2;_tmp575=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp570)->f3;_LLC: {struct Cyc_Absyn_Exp*e1=_tmp574;struct Cyc_Absyn_Exp*e2=_tmp575;
# 2957
return Cyc_Tcutil_is_noalias_path(e1)&& Cyc_Tcutil_is_noalias_path(e2);}case 9U: _LLD: _tmp573=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp570)->f2;_LLE: {struct Cyc_Absyn_Exp*e2=_tmp573;
_tmp572=e2;goto _LL10;}case 14U: _LLF: _tmp572=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp570)->f2;_LL10: {struct Cyc_Absyn_Exp*e2=_tmp572;
return Cyc_Tcutil_is_noalias_path(e2);}case 37U: _LL11: _tmp571=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp570)->f1;_LL12: {struct Cyc_Absyn_Stmt*s=_tmp571;
# 2961
while(1){
void*_tmp57E=s->r;void*_stmttmp79=_tmp57E;void*_tmp57F=_stmttmp79;struct Cyc_Absyn_Exp*_tmp580;struct Cyc_Absyn_Stmt*_tmp582;struct Cyc_Absyn_Decl*_tmp581;struct Cyc_Absyn_Stmt*_tmp584;struct Cyc_Absyn_Stmt*_tmp583;switch(*((int*)_tmp57F)){case 2U: _LL1B: _tmp583=((struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp57F)->f1;_tmp584=((struct Cyc_Absyn_Seq_s_Absyn_Raw_stmt_struct*)_tmp57F)->f2;_LL1C: {struct Cyc_Absyn_Stmt*s1=_tmp583;struct Cyc_Absyn_Stmt*s2=_tmp584;
s=s2;goto _LL1A;}case 12U: _LL1D: _tmp581=((struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp57F)->f1;_tmp582=((struct Cyc_Absyn_Decl_s_Absyn_Raw_stmt_struct*)_tmp57F)->f2;_LL1E: {struct Cyc_Absyn_Decl*d=_tmp581;struct Cyc_Absyn_Stmt*s1=_tmp582;
s=s1;goto _LL1A;}case 1U: _LL1F: _tmp580=((struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*)_tmp57F)->f1;_LL20: {struct Cyc_Absyn_Exp*e=_tmp580;
return Cyc_Tcutil_is_noalias_path(e);}default: _LL21: _LL22:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp586=({struct Cyc_Warn_String_Warn_Warg_struct _tmp69F;_tmp69F.tag=0U,({struct _fat_ptr _tmp7ED=({const char*_tmp587="is_noalias_stmt_exp: ill-formed StmtExp";_tag_fat(_tmp587,sizeof(char),40U);});_tmp69F.f1=_tmp7ED;});_tmp69F;});void*_tmp585[1U];_tmp585[0]=& _tmp586;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp585,sizeof(void*),1U));});}_LL1A:;}}default: _LL13: _LL14:
# 2969
 return 1;}_LL0:;}
# 2986 "tcutil.cyc"
struct _tuple14 Cyc_Tcutil_addressof_props(struct Cyc_Absyn_Exp*e){
# 2988
struct _tuple14 bogus_ans=({struct _tuple14 _tmp6AD;_tmp6AD.f1=0,_tmp6AD.f2=Cyc_Absyn_heap_rgn_type;_tmp6AD;});
void*_tmp588=e->r;void*_stmttmp7A=_tmp588;void*_tmp589=_stmttmp7A;struct Cyc_Absyn_Exp*_tmp58B;struct Cyc_Absyn_Exp*_tmp58A;struct Cyc_Absyn_Exp*_tmp58C;int _tmp58F;struct _fat_ptr*_tmp58E;struct Cyc_Absyn_Exp*_tmp58D;int _tmp592;struct _fat_ptr*_tmp591;struct Cyc_Absyn_Exp*_tmp590;void*_tmp593;switch(*((int*)_tmp589)){case 1U: _LL1: _tmp593=(void*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp589)->f1;_LL2: {void*x=_tmp593;
# 2992
void*_tmp594=x;struct Cyc_Absyn_Vardecl*_tmp595;struct Cyc_Absyn_Vardecl*_tmp596;struct Cyc_Absyn_Vardecl*_tmp597;struct Cyc_Absyn_Vardecl*_tmp598;switch(*((int*)_tmp594)){case 0U: _LLE: _LLF:
 goto _LL11;case 2U: _LL10: _LL11:
 return bogus_ans;case 1U: _LL12: _tmp598=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)_tmp594)->f1;_LL13: {struct Cyc_Absyn_Vardecl*vd=_tmp598;
# 2996
void*_tmp599=Cyc_Tcutil_compress((void*)_check_null(e->topt));void*_stmttmp7B=_tmp599;void*_tmp59A=_stmttmp7B;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp59A)->tag == 4U){_LL1B: _LL1C:
# 2998
 return({struct _tuple14 _tmp6A0;_tmp6A0.f1=1,_tmp6A0.f2=Cyc_Absyn_heap_rgn_type;_tmp6A0;});}else{_LL1D: _LL1E:
 return({struct _tuple14 _tmp6A1;_tmp6A1.f1=(vd->tq).real_const,_tmp6A1.f2=Cyc_Absyn_heap_rgn_type;_tmp6A1;});}_LL1A:;}case 4U: _LL14: _tmp597=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)_tmp594)->f1;_LL15: {struct Cyc_Absyn_Vardecl*vd=_tmp597;
# 3002
void*_tmp59B=Cyc_Tcutil_compress((void*)_check_null(e->topt));void*_stmttmp7C=_tmp59B;void*_tmp59C=_stmttmp7C;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp59C)->tag == 4U){_LL20: _LL21:
 return({struct _tuple14 _tmp6A2;_tmp6A2.f1=1,_tmp6A2.f2=(void*)_check_null(vd->rgn);_tmp6A2;});}else{_LL22: _LL23:
# 3005
 vd->escapes=1;
return({struct _tuple14 _tmp6A3;_tmp6A3.f1=(vd->tq).real_const,_tmp6A3.f2=(void*)_check_null(vd->rgn);_tmp6A3;});}_LL1F:;}case 5U: _LL16: _tmp596=((struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*)_tmp594)->f1;_LL17: {struct Cyc_Absyn_Vardecl*vd=_tmp596;
# 3008
_tmp595=vd;goto _LL19;}default: _LL18: _tmp595=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)_tmp594)->f1;_LL19: {struct Cyc_Absyn_Vardecl*vd=_tmp595;
# 3010
vd->escapes=1;
return({struct _tuple14 _tmp6A4;_tmp6A4.f1=(vd->tq).real_const,_tmp6A4.f2=(void*)_check_null(vd->rgn);_tmp6A4;});}}_LLD:;}case 21U: _LL3: _tmp590=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp589)->f1;_tmp591=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp589)->f2;_tmp592=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp589)->f3;_LL4: {struct Cyc_Absyn_Exp*e1=_tmp590;struct _fat_ptr*f=_tmp591;int is_tagged=_tmp592;
# 3015
if(is_tagged)return bogus_ans;{
# 3018
void*_tmp59D=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*_stmttmp7D=_tmp59D;void*_tmp59E=_stmttmp7D;struct Cyc_Absyn_Aggrdecl*_tmp59F;struct Cyc_List_List*_tmp5A0;switch(*((int*)_tmp59E)){case 7U: _LL25: _tmp5A0=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp59E)->f2;_LL26: {struct Cyc_List_List*fs=_tmp5A0;
# 3020
struct Cyc_Absyn_Aggrfield*_tmp5A1=Cyc_Absyn_lookup_field(fs,f);struct Cyc_Absyn_Aggrfield*finfo=_tmp5A1;
if(finfo != 0 && finfo->width == 0){
struct _tuple14 _tmp5A2=Cyc_Tcutil_addressof_props(e1);struct _tuple14 _stmttmp7E=_tmp5A2;struct _tuple14 _tmp5A3=_stmttmp7E;void*_tmp5A5;int _tmp5A4;_LL2C: _tmp5A4=_tmp5A3.f1;_tmp5A5=_tmp5A3.f2;_LL2D: {int c=_tmp5A4;void*t=_tmp5A5;
return({struct _tuple14 _tmp6A5;_tmp6A5.f1=(finfo->tq).real_const || c,_tmp6A5.f2=t;_tmp6A5;});}}
# 3025
return bogus_ans;}case 0U: if(((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp59E)->f1)->tag == 20U){if(((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp59E)->f1)->f1).KnownAggr).tag == 2){_LL27: _tmp59F=*((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp59E)->f1)->f1).KnownAggr).val;_LL28: {struct Cyc_Absyn_Aggrdecl*ad=_tmp59F;
# 3027
struct Cyc_Absyn_Aggrfield*_tmp5A6=Cyc_Absyn_lookup_decl_field(ad,f);struct Cyc_Absyn_Aggrfield*finfo=_tmp5A6;
if(finfo != 0 && finfo->width == 0){
struct _tuple14 _tmp5A7=Cyc_Tcutil_addressof_props(e1);struct _tuple14 _stmttmp7F=_tmp5A7;struct _tuple14 _tmp5A8=_stmttmp7F;void*_tmp5AA;int _tmp5A9;_LL2F: _tmp5A9=_tmp5A8.f1;_tmp5AA=_tmp5A8.f2;_LL30: {int c=_tmp5A9;void*t=_tmp5AA;
return({struct _tuple14 _tmp6A6;_tmp6A6.f1=(finfo->tq).real_const || c,_tmp6A6.f2=t;_tmp6A6;});}}
# 3032
return bogus_ans;}}else{goto _LL29;}}else{goto _LL29;}default: _LL29: _LL2A:
 return bogus_ans;}_LL24:;}}case 22U: _LL5: _tmp58D=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp589)->f1;_tmp58E=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp589)->f2;_tmp58F=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp589)->f3;_LL6: {struct Cyc_Absyn_Exp*e1=_tmp58D;struct _fat_ptr*f=_tmp58E;int is_tagged=_tmp58F;
# 3037
if(is_tagged)return bogus_ans;{
# 3040
void*_tmp5AB=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*_stmttmp80=_tmp5AB;void*_tmp5AC=_stmttmp80;void*_tmp5AE;void*_tmp5AD;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp5AC)->tag == 3U){_LL32: _tmp5AD=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp5AC)->f1).elt_type;_tmp5AE=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp5AC)->f1).ptr_atts).rgn;_LL33: {void*t1=_tmp5AD;void*r=_tmp5AE;
# 3042
struct Cyc_Absyn_Aggrfield*finfo;
{void*_tmp5AF=Cyc_Tcutil_compress(t1);void*_stmttmp81=_tmp5AF;void*_tmp5B0=_stmttmp81;struct Cyc_Absyn_Aggrdecl*_tmp5B1;struct Cyc_List_List*_tmp5B2;switch(*((int*)_tmp5B0)){case 7U: _LL37: _tmp5B2=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp5B0)->f2;_LL38: {struct Cyc_List_List*fs=_tmp5B2;
# 3045
finfo=Cyc_Absyn_lookup_field(fs,f);goto _LL36;}case 0U: if(((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp5B0)->f1)->tag == 20U){if(((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp5B0)->f1)->f1).KnownAggr).tag == 2){_LL39: _tmp5B1=*((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp5B0)->f1)->f1).KnownAggr).val;_LL3A: {struct Cyc_Absyn_Aggrdecl*ad=_tmp5B1;
# 3047
...
# 3050
if(finfo != 0 && finfo->width == 0)
return({struct _tuple14 _tmp6A7;_tmp6A7.f1=(finfo->tq).real_const,_tmp6A7.f2=r;_tmp6A7;});
return bogus_ans;}}else{_LL34: _LL35:
 return bogus_ans;}_LL31:;}}case 20U: _LL7: _tmp58C=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp589)->f1;_LL8: {struct Cyc_Absyn_Exp*e1=_tmp58C;
# 3057
void*_tmp5B3=Cyc_Tcutil_compress((void*)_check_null(e1->topt));void*_stmttmp82=_tmp5B3;void*_tmp5B4=_stmttmp82;void*_tmp5B6;struct Cyc_Absyn_Tqual _tmp5B5;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp5B4)->tag == 3U){_LL3E: _tmp5B5=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp5B4)->f1).elt_tq;_tmp5B6=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp5B4)->f1).ptr_atts).rgn;_LL3F: {struct Cyc_Absyn_Tqual tq=_tmp5B5;void*r=_tmp5B6;
# 3059
return({struct _tuple14 _tmp6A8;_tmp6A8.f1=tq.real_const,_tmp6A8.f2=r;_tmp6A8;});}}else{_LL40: _LL41:
 return bogus_ans;}_LL3D:;}case 23U: _LL9: _tmp58A=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp589)->f1;_tmp58B=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp589)->f2;_LLA: {struct Cyc_Absyn_Exp*e1=_tmp58A;struct Cyc_Absyn_Exp*e2=_tmp58B;
# 3065
void*t=Cyc_Tcutil_compress((void*)_check_null(e1->topt));
void*_tmp5B7=t;struct Cyc_Absyn_Tqual _tmp5B8;void*_tmp5BA;struct Cyc_Absyn_Tqual _tmp5B9;struct Cyc_List_List*_tmp5BB;switch(*((int*)_tmp5B7)){case 6U: _LL43: _tmp5BB=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp5B7)->f1;_LL44: {struct Cyc_List_List*ts=_tmp5BB;
# 3069
struct _tuple13 _tmp5BC=Cyc_Evexp_eval_const_uint_exp(e2);struct _tuple13 _stmttmp83=_tmp5BC;struct _tuple13 _tmp5BD=_stmttmp83;int _tmp5BF;unsigned _tmp5BE;_LL4C: _tmp5BE=_tmp5BD.f1;_tmp5BF=_tmp5BD.f2;_LL4D: {unsigned i=_tmp5BE;int known=_tmp5BF;
if(!known)
return bogus_ans;{
struct _tuple12*_tmp5C0=Cyc_Absyn_lookup_tuple_field(ts,(int)i);struct _tuple12*finfo=_tmp5C0;
if(finfo != 0)
return({struct _tuple14 _tmp6A9;_tmp6A9.f1=((*finfo).f1).real_const,({void*_tmp7EE=(Cyc_Tcutil_addressof_props(e1)).f2;_tmp6A9.f2=_tmp7EE;});_tmp6A9;});
return bogus_ans;}}}case 3U: _LL45: _tmp5B9=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp5B7)->f1).elt_tq;_tmp5BA=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp5B7)->f1).ptr_atts).rgn;_LL46: {struct Cyc_Absyn_Tqual tq=_tmp5B9;void*r=_tmp5BA;
# 3077
return({struct _tuple14 _tmp6AA;_tmp6AA.f1=tq.real_const,_tmp6AA.f2=r;_tmp6AA;});}case 4U: _LL47: _tmp5B8=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp5B7)->f1).tq;_LL48: {struct Cyc_Absyn_Tqual tq=_tmp5B8;
# 3083
return({struct _tuple14 _tmp6AB;_tmp6AB.f1=tq.real_const,({void*_tmp7EF=(Cyc_Tcutil_addressof_props(e1)).f2;_tmp6AB.f2=_tmp7EF;});_tmp6AB;});}default: _LL49: _LL4A:
 return bogus_ans;}_LL42:;}default: _LLB: _LLC:
# 3087
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5C2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp6AC;_tmp6AC.tag=0U,({struct _fat_ptr _tmp7F0=({const char*_tmp5C3="unary & applied to non-lvalue";_tag_fat(_tmp5C3,sizeof(char),30U);});_tmp6AC.f1=_tmp7F0;});_tmp6AC;});void*_tmp5C1[1U];_tmp5C1[0]=& _tmp5C2;({unsigned _tmp7F1=e->loc;Cyc_Warn_err2(_tmp7F1,_tag_fat(_tmp5C1,sizeof(void*),1U));});});
return bogus_ans;}_LL0:;}
# 3094
void Cyc_Tcutil_check_bound(unsigned loc,unsigned i,void*b,int do_warn){
struct Cyc_Absyn_Exp*_tmp5C4=({void*_tmp7F2=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp7F2,b);});struct Cyc_Absyn_Exp*eopt=_tmp5C4;
if(eopt == 0)return;{
struct _tuple13 _tmp5C5=Cyc_Evexp_eval_const_uint_exp(eopt);struct _tuple13 _stmttmp84=_tmp5C5;struct _tuple13 _tmp5C6=_stmttmp84;int _tmp5C8;unsigned _tmp5C7;_LL1: _tmp5C7=_tmp5C6.f1;_tmp5C8=_tmp5C6.f2;_LL2: {unsigned j=_tmp5C7;int known=_tmp5C8;
if(known && j <= i)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp5CA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp6B1;_tmp6B1.tag=0U,({struct _fat_ptr _tmp7F3=({const char*_tmp5CF="a dereference is out of bounds: ";_tag_fat(_tmp5CF,sizeof(char),33U);});_tmp6B1.f1=_tmp7F3;});_tmp6B1;});struct Cyc_Warn_Int_Warn_Warg_struct _tmp5CB=({struct Cyc_Warn_Int_Warn_Warg_struct _tmp6B0;_tmp6B0.tag=12U,_tmp6B0.f1=(int)j;_tmp6B0;});struct Cyc_Warn_String_Warn_Warg_struct _tmp5CC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp6AF;_tmp6AF.tag=0U,({
struct _fat_ptr _tmp7F4=({const char*_tmp5CE=" <= ";_tag_fat(_tmp5CE,sizeof(char),5U);});_tmp6AF.f1=_tmp7F4;});_tmp6AF;});struct Cyc_Warn_Int_Warn_Warg_struct _tmp5CD=({struct Cyc_Warn_Int_Warn_Warg_struct _tmp6AE;_tmp6AE.tag=12U,_tmp6AE.f1=(int)i;_tmp6AE;});void*_tmp5C9[4U];_tmp5C9[0]=& _tmp5CA,_tmp5C9[1]=& _tmp5CB,_tmp5C9[2]=& _tmp5CC,_tmp5C9[3]=& _tmp5CD;({void(*_tmp7F6)(unsigned,struct _fat_ptr)=
# 3099
do_warn?Cyc_Warn_warn2: Cyc_Warn_err2;unsigned _tmp7F5=loc;_tmp7F6(_tmp7F5,_tag_fat(_tmp5C9,sizeof(void*),4U));});});
# 3101
return;}}}
# 3104
...
int(*_tmp5D0)(int var_okay,struct Cyc_Absyn_Exp*e)=Cyc_Tcutil_cnst_exp;int(*rec)(int var_okay,struct Cyc_Absyn_Exp*e)=_tmp5D0;
void*_tmp5D1=e->r;void*_stmttmp85=_tmp5D1;void*_tmp5D2=_stmttmp85;struct Cyc_List_List*_tmp5D3;struct Cyc_List_List*_tmp5D4;struct Cyc_List_List*_tmp5D5;struct Cyc_List_List*_tmp5D6;struct Cyc_List_List*_tmp5D7;struct Cyc_List_List*_tmp5D8;struct Cyc_Absyn_Exp*_tmp5D9;struct Cyc_Absyn_Exp*_tmp5DB;struct Cyc_Absyn_Exp*_tmp5DA;struct Cyc_Absyn_Exp*_tmp5DC;struct Cyc_Absyn_Exp*_tmp5DD;struct Cyc_Absyn_Exp*_tmp5DE;struct Cyc_Absyn_Exp*_tmp5DF;struct Cyc_Absyn_Exp*_tmp5E0;struct Cyc_Absyn_Exp*_tmp5E2;struct Cyc_Absyn_Exp*_tmp5E1;struct Cyc_Absyn_Exp*_tmp5E5;struct Cyc_Absyn_Exp*_tmp5E4;struct Cyc_Absyn_Exp*_tmp5E3;void*_tmp5E6;switch(*((int*)_tmp5D2)){case 0U: _LL1: _LL2:
 goto _LL4;case 2U: _LL3: _LL4:
 ...
 return 1;case 1U: _LLF: _tmp5E6=(void*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_LL10: {void*b=_tmp5E6;
# 3125
void*_tmp5E7=b;struct Cyc_Absyn_Vardecl*_tmp5E8;struct Cyc_Absyn_Vardecl*_tmp5E9;switch(*((int*)_tmp5E7)){case 2U: _LL32: _LL33:
 return 1;case 1U: _LL34: _tmp5E9=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)_tmp5E7)->f1;_LL35: {struct Cyc_Absyn_Vardecl*vd=_tmp5E9;
# 3128
void*_tmp5EA=Cyc_Tcutil_compress(vd->type);void*_stmttmp86=_tmp5EA;void*_tmp5EB=_stmttmp86;switch(*((int*)_tmp5EB)){case 4U: _LL3D: _LL3E:
 goto _LL40;case 5U: _LL3F: _LL40:
 return 1;default: _LL41: _LL42:
 return var_okay;}_LL3C:;}case 4U: _LL36: _tmp5E8=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)_tmp5E7)->f1;_LL37: {struct Cyc_Absyn_Vardecl*vd=_tmp5E8;
# 3134
if((int)vd->sc != (int)Cyc_Absyn_Static)
return var_okay;{
void*_tmp5EC=Cyc_Tcutil_compress(vd->type);void*_stmttmp87=_tmp5EC;void*_tmp5ED=_stmttmp87;switch(*((int*)_tmp5ED)){case 4U: _LL44: _LL45:
...
# 3141
 ...
 return var_okay;}_LL31:;}case 6U: _LL11: _tmp5E3=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_tmp5E4=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp5D2)->f2;_tmp5E5=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp5D2)->f3;_LL12: {struct Cyc_Absyn_Exp*e1=_tmp5E3;struct Cyc_Absyn_Exp*e2=_tmp5E4;struct Cyc_Absyn_Exp*e3=_tmp5E5;
# 3145
return(rec(0,e1)&& rec(0,e2))&& rec(0,e3);}case 9U: _LL13: _tmp5E1=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_tmp5E2=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp5D2)->f2;_LL14: {struct Cyc_Absyn_Exp*e1=_tmp5E1;struct Cyc_Absyn_Exp*e2=_tmp5E2;
return rec(0,e1)&& rec(0,e2);}case 41U: _LL15: _tmp5E0=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_LL16: {struct Cyc_Absyn_Exp*e2=_tmp5E0;
_tmp5DF=e2;goto _LL18;}case 12U: _LL17: _tmp5DF=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_LL18: {struct Cyc_Absyn_Exp*e2=_tmp5DF;
_tmp5DE=e2;goto _LL1A;}case 13U: _LL19: _tmp5DE=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_LL1A: {struct Cyc_Absyn_Exp*e2=_tmp5DE;
_tmp5DD=e2;goto _LL1C;}case 14U: _LL1B: _tmp5DD=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp5D2)->f2;_LL1C: {struct Cyc_Absyn_Exp*e2=_tmp5DD;
# 3152
return Cyc_Tcutil_cnst_exp(var_okay,e2);}case 15U: _LL1D: _tmp5DC=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_LL1E: {struct Cyc_Absyn_Exp*e2=_tmp5DC;
return rec(1,e2);}case 27U: _LL1F: _tmp5DA=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp5D2)->f2;_tmp5DB=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp5D2)->f3;_LL20: {struct Cyc_Absyn_Exp*e1=_tmp5DA;struct Cyc_Absyn_Exp*e2=_tmp5DB;
return rec(0,e1)&& rec(0,e2);}case 28U: _LL21: _tmp5D9=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_LL22: {struct Cyc_Absyn_Exp*e=_tmp5D9;
return rec(0,e);}case 26U: _LL23: _tmp5D8=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_LL24: {struct Cyc_List_List*des=_tmp5D8;
_tmp5D7=des;goto _LL26;}case 30U: _LL25: _tmp5D7=((struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*)_tmp5D2)->f2;_LL26: {struct Cyc_List_List*des=_tmp5D7;
_tmp5D6=des;goto _LL28;}case 29U: _LL27: _tmp5D6=((struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*)_tmp5D2)->f3;_LL28: {struct Cyc_List_List*des=_tmp5D6;
# 3159
for(0;des != 0;des=des->tl){
if(!Cyc_Tcutil_cnst_exp(0,(*((struct _tuple16*)des->hd)).f2))
return 0;}
return 1;}case 3U: _LL29: _tmp5D5=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp5D2)->f2;_LL2A: {struct Cyc_List_List*es=_tmp5D5;
_tmp5D4=es;goto _LL2C;}case 24U: _LL2B: _tmp5D4=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_LL2C: {struct Cyc_List_List*es=_tmp5D4;
_tmp5D3=es;goto _LL2E;}case 31U: _LL2D: _tmp5D3=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp5D2)->f1;_LL2E: {struct Cyc_List_List*es=_tmp5D3;
# 3166
for(0;es != 0;es=es->tl){
...
void*_tmp5EE=Cyc_Tcutil_compress(t);void*_stmttmp88=_tmp5EE;void*_tmp5EF=_stmttmp88;struct Cyc_List_List*_tmp5F0;struct Cyc_List_List*_tmp5F1;void*_tmp5F2;void*_tmp5F3;struct Cyc_List_List*_tmp5F5;void*_tmp5F4;switch(*((int*)_tmp5EF)){case 0U: _LL1: _tmp5F4=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp5EF)->f1;_tmp5F5=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp5EF)->f2;_LL2: {void*c=_tmp5F4;struct Cyc_List_List*ts=_tmp5F5;
# 3181
void*_tmp5F6=c;union Cyc_Absyn_AggrInfo _tmp5F7;struct Cyc_List_List*_tmp5F8;struct Cyc_Absyn_Enumdecl*_tmp5F9;switch(*((int*)_tmp5F6)){case 0U: _LLE: _LLF:
 goto _LL11;case 1U: _LL10: _LL11:
 goto _LL13;case 2U: _LL12: _LL13:
 return 1;case 15U: _LL14: _tmp5F9=((struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*)_tmp5F6)->f2;_LL15: {struct Cyc_Absyn_Enumdecl*edo=_tmp5F9;
# 3186
if(edo == 0 || edo->fields == 0)
return 0;
_tmp5F8=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(edo->fields))->v;goto _LL17;}case 16U: _LL16: _tmp5F8=((struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*)_tmp5F6)->f1;_LL17: {struct Cyc_List_List*fs=_tmp5F8;
# 3190
{struct Cyc_List_List*_tmp5FA=fs;struct Cyc_List_List*fs2=_tmp5FA;for(0;fs2 != 0;fs2=fs2->tl){
if(((struct Cyc_Absyn_Enumfield*)fs2->hd)->tag == 0)
return fs2 == fs;{
struct _tuple13 _tmp5FB=Cyc_Evexp_eval_const_uint_exp((struct Cyc_Absyn_Exp*)_check_null(((struct Cyc_Absyn_Enumfield*)fs2->hd)->tag));struct _tuple13 _stmttmp89=_tmp5FB;struct _tuple13 _tmp5FC=_stmttmp89;int _tmp5FE;unsigned _tmp5FD;_LL1D: _tmp5FD=_tmp5FC.f1;_tmp5FE=_tmp5FC.f2;_LL1E: {unsigned i=_tmp5FD;int known=_tmp5FE;
if(known && i == (unsigned)0)
return 1;}}}}
# 3197
return 0;}case 20U: _LL18: _tmp5F7=((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_tmp5F6)->f1;_LL19: {union Cyc_Absyn_AggrInfo info=_tmp5F7;
# 3200
struct Cyc_Absyn_Aggrdecl*_tmp5FF=Cyc_Absyn_get_known_aggrdecl(info);struct Cyc_Absyn_Aggrdecl*ad=_tmp5FF;
...
return Cyc_Tcutil_fields_zeroable(ad->tvs,ts,((struct Cyc_Absyn_AggrdeclImpl*)_check_null(ad->impl))->fields);}default: _LL1A: _LL1B:
 return 0;}_LLD:;}case 3U: _LL3: _tmp5F3=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp5EF)->f1).ptr_atts).nullable;_LL4: {void*n=_tmp5F3;
# 3208
return Cyc_Tcutil_force_type2bool(1,n);}case 4U: _LL5: _tmp5F2=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp5EF)->f1).elt_type;_LL6: {void*t=_tmp5F2;
return Cyc_Tcutil_zeroable_type(t);}case 6U: _LL7: _tmp5F1=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp5EF)->f1;_LL8: {struct Cyc_List_List*tqs=_tmp5F1;
# 3211
for(0;tqs != 0;tqs=tqs->tl){
if(!Cyc_Tcutil_zeroable_type((*((struct _tuple12*)tqs->hd)).f2))
return 0;}
return 1;}case 7U: _LL9: _tmp5F0=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp5EF)->f2;_LLA: {struct Cyc_List_List*fs=_tmp5F0;
...
# 3221
struct _RegionHandle _tmp600=_new_region("rgn");struct _RegionHandle*rgn=& _tmp600;_push_region(rgn);
{struct Cyc_List_List*_tmp601=((struct Cyc_List_List*(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_rzip)(rgn,rgn,tvs,ts);struct Cyc_List_List*inst=_tmp601;
for(0;fs != 0;fs=fs->tl){
void*t=((struct Cyc_Absyn_Aggrfield*)fs->hd)->type;
if(Cyc_Tcutil_zeroable_type(t))continue;
t=Cyc_Tcutil_rsubstitute(rgn,inst,((struct Cyc_Absyn_Aggrfield*)fs->hd)->type);
if(!Cyc_Tcutil_zeroable_type(t)){int _tmp602=0;_npop_handler(0U);return _tmp602;}}{
# 3229
int _tmp603=1;_npop_handler(0U);return _tmp603;}}
# 3222
;_pop_region();}
# 3233
void Cyc_Tcutil_check_no_qual(unsigned loc,void*t){
void*_tmp604=t;struct Cyc_Absyn_Typedefdecl*_tmp605;if(((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp604)->tag == 8U){_LL1: _tmp605=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp604)->f3;_LL2: {struct Cyc_Absyn_Typedefdecl*tdopt=_tmp605;
# 3236
if(tdopt == 0)
return;{
struct Cyc_Absyn_Tqual _tmp606=tdopt->tq;struct Cyc_Absyn_Tqual tq=_tmp606;
if(((tq.print_const || tq.q_volatile)|| tq.q_restrict)|| tq.real_const)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp608=({struct Cyc_Warn_String_Warn_Warg_struct _tmp6B4;_tmp6B4.tag=0U,({struct _fat_ptr _tmp7F7=({const char*_tmp60C="qualifier within typedef type ";_tag_fat(_tmp60C,sizeof(char),31U);});_tmp6B4.f1=_tmp7F7;});_tmp6B4;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp609=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp6B3;_tmp6B3.tag=2U,_tmp6B3.f1=(void*)t;_tmp6B3;});struct Cyc_Warn_String_Warn_Warg_struct _tmp60A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp6B2;_tmp6B2.tag=0U,({struct _fat_ptr _tmp7F8=({const char*_tmp60B=" is ignored";_tag_fat(_tmp60B,sizeof(char),12U);});_tmp6B2.f1=_tmp7F8;});_tmp6B2;});void*_tmp607[3U];_tmp607[0]=& _tmp608,_tmp607[1]=& _tmp609,_tmp607[2]=& _tmp60A;({unsigned _tmp7F9=loc;Cyc_Warn_warn2(_tmp7F9,_tag_fat(_tmp607,sizeof(void*),3U));});});
return;}}}else{_LL3: _LL4:
 return;}_LL0:;}
# 3248
struct Cyc_List_List*Cyc_Tcutil_transfer_fn_type_atts(void*t,struct Cyc_List_List*atts){
void*_tmp60D=Cyc_Tcutil_compress(t);void*_stmttmp8A=_tmp60D;void*_tmp60E=_stmttmp8A;struct Cyc_List_List**_tmp60F;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp60E)->tag == 5U){_LL1: _tmp60F=(struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp60E)->f1).attributes;_LL2: {struct Cyc_List_List**fnatts=_tmp60F;
# 3251
struct Cyc_List_List*_tmp610=0;struct Cyc_List_List*res_atts=_tmp610;
for(0;atts != 0;atts=atts->tl){
if(!Cyc_Absyn_fntype_att((void*)atts->hd))
res_atts=({struct Cyc_List_List*_tmp611=_cycalloc(sizeof(*_tmp611));_tmp611->hd=(void*)atts->hd,_tmp611->tl=res_atts;_tmp611;});else{
if(!((int(*)(int(*compare)(void*,void*),struct Cyc_List_List*l,void*x))Cyc_List_mem)(Cyc_Absyn_attribute_cmp,*fnatts,(void*)atts->hd))
({struct Cyc_List_List*_tmp7FA=({struct Cyc_List_List*_tmp612=_cycalloc(sizeof(*_tmp612));_tmp612->hd=(void*)atts->hd,_tmp612->tl=*fnatts;_tmp612;});*fnatts=_tmp7FA;});}}
return res_atts;}}else{_LL3: _LL4:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp614=({struct Cyc_Warn_String_Warn_Warg_struct _tmp6B5;_tmp6B5.tag=0U,({struct _fat_ptr _tmp7FB=({const char*_tmp615="transfer_fn_type_atts";_tag_fat(_tmp615,sizeof(char),22U);});_tmp6B5.f1=_tmp7FB;});_tmp6B5;});void*_tmp613[1U];_tmp613[0]=& _tmp614;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp613,sizeof(void*),1U));});}_LL0:;}
# 3263
struct Cyc_Absyn_Exp*Cyc_Tcutil_get_type_bound(void*t){
void*_tmp616=Cyc_Tcutil_compress(t);void*_stmttmp8B=_tmp616;void*_tmp617=_stmttmp8B;struct Cyc_Absyn_Exp*_tmp618;struct Cyc_Absyn_PtrInfo _tmp619;switch(*((int*)_tmp617)){case 3U: _LL1: _tmp619=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp617)->f1;_LL2: {struct Cyc_Absyn_PtrInfo pi=_tmp619;
return({void*_tmp7FC=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp7FC,(pi.ptr_atts).bounds);});}case 4U: _LL3: _tmp618=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp617)->f1).num_elts;_LL4: {struct Cyc_Absyn_Exp*e=_tmp618;
return e;}default: _LL5: _LL6:
 return 0;}_LL0:;}
# 3273
struct Cyc_Absyn_Vardecl*Cyc_Tcutil_nonesc_vardecl(void*b){
void*_tmp61A=b;struct Cyc_Absyn_Vardecl*_tmp61B;struct Cyc_Absyn_Vardecl*_tmp61C;struct Cyc_Absyn_Vardecl*_tmp61D;struct Cyc_Absyn_Vardecl*_tmp61E;switch(*((int*)_tmp61A)){case 5U: _LL1: _tmp61E=((struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*)_tmp61A)->f1;_LL2: {struct Cyc_Absyn_Vardecl*x=_tmp61E;
_tmp61D=x;goto _LL4;}case 4U: _LL3: _tmp61D=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)_tmp61A)->f1;_LL4: {struct Cyc_Absyn_Vardecl*x=_tmp61D;
_tmp61C=x;goto _LL6;}case 3U: _LL5: _tmp61C=((struct Cyc_Absyn_Param_b_Absyn_Binding_struct*)_tmp61A)->f1;_LL6: {struct Cyc_Absyn_Vardecl*x=_tmp61C;
_tmp61B=x;goto _LL8;}case 1U: _LL7: _tmp61B=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)_tmp61A)->f1;_LL8: {struct Cyc_Absyn_Vardecl*x=_tmp61B;
return x->escapes?0: x;}default: _LL9: _LLA:
 return 0;}_LL0:;}
# 3284
struct Cyc_List_List*Cyc_Tcutil_filter_nulls(struct Cyc_List_List*l){
struct Cyc_List_List*_tmp61F=0;struct Cyc_List_List*res=_tmp61F;
{struct Cyc_List_List*x=l;for(0;x != 0;x=x->tl){
if((void**)x->hd != 0)res=({struct Cyc_List_List*_tmp620=_cycalloc(sizeof(*_tmp620));_tmp620->hd=*((void**)_check_null((void**)x->hd)),_tmp620->tl=res;_tmp620;});}}
return res;}
# 3291
void*Cyc_Tcutil_promote_array(void*t,void*rgn,int convert_tag){
void*_tmp621=Cyc_Tcutil_compress(t);void*_stmttmp8C=_tmp621;void*_tmp622=_stmttmp8C;unsigned _tmp627;void*_tmp626;struct Cyc_Absyn_Exp*_tmp625;struct Cyc_Absyn_Tqual _tmp624;void*_tmp623;if(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp622)->tag == 4U){_LL1: _tmp623=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp622)->f1).elt_type;_tmp624=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp622)->f1).tq;_tmp625=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp622)->f1).num_elts;_tmp626=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp622)->f1).zero_term;_tmp627=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp622)->f1).zt_loc;_LL2: {void*et=_tmp623;struct Cyc_Absyn_Tqual tq=_tmp624;struct Cyc_Absyn_Exp*eopt=_tmp625;void*zt=_tmp626;unsigned ztl=_tmp627;
# 3294
void*b;
if(eopt == 0)
...
if(convert_tag){
if(eopt->topt == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp629=({struct Cyc_Warn_String_Warn_Warg_struct _tmp6B6;_tmp6B6.tag=0U,({struct _fat_ptr _tmp7FD=({const char*_tmp62A="cannot convert tag without type!";_tag_fat(_tmp62A,sizeof(char),33U);});_tmp6B6.f1=_tmp7FD;});_tmp6B6;});void*_tmp628[1U];_tmp628[0]=& _tmp629;((int(*)(struct _fat_ptr))Cyc_Warn_impos2)(_tag_fat(_tmp628,sizeof(void*),1U));});{
void*_tmp62B=Cyc_Tcutil_compress((void*)_check_null(eopt->topt));void*_stmttmp8D=_tmp62B;void*_tmp62C=_stmttmp8D;void*_tmp62D;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp62C)->tag == 0U){if(((struct Cyc_Absyn_TagCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp62C)->f1)->tag == 4U){if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp62C)->f2 != 0){_LL6: _tmp62D=(void*)(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp62C)->f2)->hd;_LL7: {void*t=_tmp62D;
# 3303
