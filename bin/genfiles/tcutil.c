...
# 711
({void*_tmpA80=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp16A=_cycalloc(sizeof(*_tmp16A));_tmp16A->tag=2U,_tmp16A->f1=0,_tmp16A->f2=def;_tmp16A;});tv->kind=_tmpA80;});
return def;}_LL0:;}
# 716
...
Cyc_Tcutil_unify_it(_tmp316,_tmp31C);
...
Cyc_Tcutil_unify_it(_tmp317,_tmp31D);{
# 1690
...
({void*_tmpAE3=(void*)({struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp40E=_cycalloc(sizeof(*_tmp40E));_tmp40E->tag=0U,_tmp40E->f1=Cyc_Absyn_Null_c;_tmp40E;});e1->r=_tmpAE3;});{
struct Cyc_Core_Opt*_tmp40F=Cyc_Tcenv_lookup_opt_type_vars(te);
void*_tmp410=Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp992;({void*_tmpAE8=Cyc_Absyn_new_evar(& Cyc_Tcutil_ako,_tmp40F);_tmp992.elt_type=_tmpAE8;}),({
struct Cyc_Absyn_Tqual _tmpAE7=Cyc_Absyn_empty_tqual(0U);_tmp992.elt_tq=_tmpAE7;}),
({void*_tmpAE6=Cyc_Absyn_new_evar(& Cyc_Tcutil_trko,_tmp40F);(_tmp992.ptr_atts).rgn=_tmpAE6;}),(_tmp992.ptr_atts).nullable=Cyc_Absyn_true_type,({
# 2473
void*_tmpAE5=Cyc_Absyn_new_evar(& Cyc_Tcutil_ptrbko,_tmp40F);(_tmp992.ptr_atts).bounds=_tmpAE5;}),({
void*_tmpAE4=Cyc_Absyn_new_evar(& Cyc_Tcutil_boolko,_tmp40F);(_tmp992.ptr_atts).zero_term=_tmpAE4;}),(_tmp992.ptr_atts).ptrloc=0;_tmp992;}));
e1->topt=_tmp410;{
int bogus=0;
int retv=Cyc_Tcutil_coerce_arg(te,e1,t2,& bogus);
if(bogus != 0)
({struct Cyc_String_pa_PrintArg_struct _tmp413=({struct Cyc_String_pa_PrintArg_struct _tmp991;_tmp991.tag=0U,({
struct _dyneither_ptr _tmpAE9=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e1));_tmp991.f1=_tmpAE9;});_tmp991;});struct Cyc_String_pa_PrintArg_struct _tmp414=({struct Cyc_String_pa_PrintArg_struct _tmp990;_tmp990.tag=0U,({struct _dyneither_ptr _tmpAEA=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Position_string_of_segment(e1->loc));_tmp990.f1=_tmpAEA;});_tmp990;});void*_tmp411[2U];_tmp411[0]=& _tmp413,_tmp411[1]=& _tmp414;({struct _dyneither_ptr _tmpAEB=({const char*_tmp412="zero_to_null resulted in an alias coercion on %s at %s\n";_tag_dyneither(_tmp412,sizeof(char),56U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpAEB,_tag_dyneither(_tmp411,sizeof(void*),2U));});});
return retv;};};}
# 2483
return 0;}
# 2486
...
struct _tuple2*v=({struct _tuple2*_tmp428=_cycalloc(sizeof(*_tmp428));_tmp428->f1=Cyc_Absyn_Loc_n,({struct _dyneither_ptr*_tmpAEE=({struct _dyneither_ptr*_tmp427=_cycalloc(sizeof(*_tmp427));({struct _dyneither_ptr _tmpAED=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp426=({struct Cyc_Int_pa_PrintArg_struct _tmp994;_tmp994.tag=1U,_tmp994.f1=(unsigned long)counter ++;_tmp994;});void*_tmp424[1U];_tmp424[0]=& _tmp426;({struct _dyneither_ptr _tmpAEC=({const char*_tmp425="__aliasvar%d";_tag_dyneither(_tmp425,sizeof(char),13U);});Cyc_aprintf(_tmpAEC,_tag_dyneither(_tmp424,sizeof(void*),1U));});});*_tmp427=_tmpAED;});_tmp427;});_tmp428->f2=_tmpAEE;});_tmp428;});
struct Cyc_Absyn_Vardecl*vd=Cyc_Absyn_new_vardecl(0U,v,e_type,e);
struct Cyc_Absyn_Exp*ve=({void*_tmpAEF=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp423=_cycalloc(sizeof(*_tmp423));_tmp423->tag=4U,_tmp423->f1=vd;_tmp423;});Cyc_Absyn_varb_exp(_tmpAEF,e->loc);});
# 2505
...
({struct Cyc_String_pa_PrintArg_struct _tmp42F=({struct Cyc_String_pa_PrintArg_struct _tmp996;_tmp996.tag=0U,({
struct _dyneither_ptr _tmpAF0=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t1));_tmp996.f1=_tmpAF0;});_tmp996;});struct Cyc_String_pa_PrintArg_struct _tmp430=({struct Cyc_String_pa_PrintArg_struct _tmp995;_tmp995.tag=0U,({struct _dyneither_ptr _tmpAF1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t2));_tmp995.f1=_tmpAF1;});_tmp995;});void*_tmp42D[2U];_tmp42D[0]=& _tmp42F,_tmp42D[1]=& _tmp430;({unsigned int _tmpAF3=e->loc;struct _dyneither_ptr _tmpAF2=({const char*_tmp42E="integral size mismatch; %s -> %s conversion supplied";_tag_dyneither(_tmp42E,sizeof(char),53U);});Cyc_Tcutil_warn(_tmpAF3,_tmpAF2,_tag_dyneither(_tmp42D,sizeof(void*),2U));});});
Cyc_Tcutil_unchecked_cast(te,e,t2,Cyc_Absyn_No_coercion);
return 1;}else{
# 2568
if(Cyc_Tcutil_can_insert_alias(e,t1,t2,e->loc)){
if(Cyc_Tcutil_warn_alias_coerce)
({struct Cyc_String_pa_PrintArg_struct _tmp433=({struct Cyc_String_pa_PrintArg_struct _tmp999;_tmp999.tag=0U,({
struct _dyneither_ptr _tmpAF4=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e));_tmp999.f1=_tmpAF4;});_tmp999;});struct Cyc_String_pa_PrintArg_struct _tmp434=({struct Cyc_String_pa_PrintArg_struct _tmp998;_tmp998.tag=0U,({struct _dyneither_ptr _tmpAF5=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t1));_tmp998.f1=_tmpAF5;});_tmp998;});struct Cyc_String_pa_PrintArg_struct _tmp435=({struct Cyc_String_pa_PrintArg_struct _tmp997;_tmp997.tag=0U,({struct _dyneither_ptr _tmpAF6=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t2));_tmp997.f1=_tmpAF6;});_tmp997;});void*_tmp431[3U];_tmp431[0]=& _tmp433,_tmp431[1]=& _tmp434,_tmp431[2]=& _tmp435;({unsigned int _tmpAF8=e->loc;struct _dyneither_ptr _tmpAF7=({const char*_tmp432="implicit alias coercion for %s:%s to %s";_tag_dyneither(_tmp432,sizeof(char),40U);});Cyc_Tcutil_warn(_tmpAF8,_tmpAF7,_tag_dyneither(_tmp431,sizeof(void*),3U));});});
*alias_coercion=1;}
# 2575
...
if((int)c != (int)2U)
({struct Cyc_String_pa_PrintArg_struct _tmp438=({struct Cyc_String_pa_PrintArg_struct _tmp99B;_tmp99B.tag=0U,({
struct _dyneither_ptr _tmpAF9=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t1));_tmp99B.f1=_tmpAF9;});_tmp99B;});struct Cyc_String_pa_PrintArg_struct _tmp439=({struct Cyc_String_pa_PrintArg_struct _tmp99A;_tmp99A.tag=0U,({struct _dyneither_ptr _tmpAFA=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t2));_tmp99A.f1=_tmpAFA;});_tmp99A;});void*_tmp436[2U];_tmp436[0]=& _tmp438,_tmp436[1]=& _tmp439;({unsigned int _tmpAFC=e->loc;struct _dyneither_ptr _tmpAFB=({const char*_tmp437="implicit cast from %s to %s";_tag_dyneither(_tmp437,sizeof(char),28U);});Cyc_Tcutil_warn(_tmpAFC,_tmpAFB,_tag_dyneither(_tmp436,sizeof(void*),2U));});});
return 1;}else{
# 2588
return 0;}}}}}
# 2595
...
# 2619
struct _tuple25 _tmp43A=*env;struct _tuple25 _tmp43B=_tmp43A;struct Cyc_List_List*_tmp443;struct _RegionHandle*_tmp442;struct Cyc_Tcenv_Tenv*_tmp441;int _tmp440;_LL1: _tmp443=_tmp43B.f1;_tmp442=_tmp43B.f2;_tmp441=_tmp43B.f3;_tmp440=_tmp43B.f4;_LL2:;{
# 2621
...
return({struct Cyc_List_List*_tmp43F=_region_malloc(_tmp442,sizeof(*_tmp43F));({struct _tuple12*_tmpAFD=({struct _tuple12*_tmp43E=_region_malloc(_tmp442,sizeof(*_tmp43E));_tmp43E->f1=x->tq,_tmp43E->f2=_tmp43C;_tmp43E;});_tmp43F->hd=_tmpAFD;}),_tmp43F->tl=0;_tmp43F;});else{
return _tmp43D;}};}struct _tuple26{struct _RegionHandle*f1;struct Cyc_Tcenv_Tenv*f2;int f3;};
# 2627
static struct Cyc_List_List*Cyc_Tcutil_rcopy_tqt(struct _tuple26*env,struct _tuple12*x){
# 2629
struct _tuple26 _tmp444=*env;struct _tuple26 _tmp445=_tmp444;struct _RegionHandle*_tmp44F;struct Cyc_Tcenv_Tenv*_tmp44E;int _tmp44D;_LL1: _tmp44F=_tmp445.f1;_tmp44E=_tmp445.f2;_tmp44D=_tmp445.f3;_LL2:;{
struct _tuple12 _tmp446=*x;struct _tuple12 _tmp447=_tmp446;struct Cyc_Absyn_Tqual _tmp44C;void*_tmp44B;_LL4: _tmp44C=_tmp447.f1;_tmp44B=_tmp447.f2;_LL5:;{
...
return({struct Cyc_List_List*_tmp44A=_region_malloc(_tmp44F,sizeof(*_tmp44A));({struct _tuple12*_tmpAFE=({struct _tuple12*_tmp449=_region_malloc(_tmp44F,sizeof(*_tmp449));_tmp449->f1=_tmp44C,_tmp449->f2=_tmp44B;_tmp449;});_tmp44A->hd=_tmpAFE;}),_tmp44A->tl=0;_tmp44A;});else{
return _tmp448;}};};}
# 2636
...
# 2660
return({struct Cyc_List_List*_tmp45B=_region_malloc(r,sizeof(*_tmp45B));({struct _tuple12*_tmpB00=({struct _tuple12*_tmp45A=_region_malloc(r,sizeof(*_tmp45A));({struct Cyc_Absyn_Tqual _tmpAFF=Cyc_Absyn_empty_tqual(0U);_tmp45A->f1=_tmpAFF;}),_tmp45A->f2=t1;_tmp45A;});_tmp45B->hd=_tmpB00;}),_tmp45B->tl=0;_tmp45B;});{
...
struct _tuple25 env=({struct _tuple25 _tmp99C;_tmp99C.f1=_tmp45C,_tmp99C.f2=r,_tmp99C.f3=te,_tmp99C.f4=flatten;_tmp99C;});
...
env.f4=0;{
struct Cyc_List_List*_tmp460=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*(*f)(struct _tuple25*,struct Cyc_Absyn_Aggrfield*),struct _tuple25*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(r,Cyc_Tcutil_flatten_type_f,& env,_tmp463);
...
# 2645
struct _tuple26 _tmp451=({struct _tuple26 _tmp99D;_tmp99D.f1=r,_tmp99D.f2=te,_tmp99D.f3=flatten;_tmp99D;});
# 2647
struct Cyc_List_List*_tmp452=_tmp46E;struct _tuple12*_tmp459;struct Cyc_List_List*_tmp458;if(_tmp452 == 0){_LLC: _LLD:
 return 0;}else{_LLE: _tmp459=(struct _tuple12*)_tmp452->hd;_tmp458=_tmp452->tl;_LLF: {
# 2650
struct Cyc_List_List*_tmp453=Cyc_Tcutil_rcopy_tqt(& _tmp451,_tmp459);
_tmp451.f3=0;{
struct Cyc_List_List*_tmp454=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*(*f)(struct _tuple26*,struct _tuple12*),struct _tuple26*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(r,Cyc_Tcutil_rcopy_tqt,& _tmp451,_tmp46E);
...
env.f4=0;{
struct Cyc_List_List*_tmp467=((struct Cyc_List_List*(*)(struct _RegionHandle*,struct Cyc_List_List*(*f)(struct _tuple25*,struct Cyc_Absyn_Aggrfield*),struct _tuple25*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(r,Cyc_Tcutil_flatten_type_f,& env,_tmp46A);
...
# 2683
 goto _LL0;}_LL0:;};}
# 2686
return({struct Cyc_List_List*_tmp471=_region_malloc(r,sizeof(*_tmp471));({struct _tuple12*_tmpB03=({struct _tuple12*_tmp470=_region_malloc(r,sizeof(*_tmp470));({struct Cyc_Absyn_Tqual _tmpB02=Cyc_Absyn_empty_tqual(0U);_tmp470->f1=_tmpB02;}),_tmp470->f2=t1;_tmp470;});_tmp471->hd=_tmpB03;}),_tmp471->tl=0;_tmp471;});}
# 2690
...
struct Cyc_Absyn_Exp*_tmp47A=({void*_tmpB06=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmpB06,_tmp498);});
struct Cyc_Absyn_Exp*_tmp47B=({void*_tmpB07=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmpB07,_tmp492);});
if(_tmp47A != _tmp47B){
...
if(({int _tmpB0E=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp47F);_tmpB0E != ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp480);}))return 0;{
struct Cyc_List_List*inst=0;
while(_tmp47F != 0){
...
inst=({struct Cyc_List_List*_tmp482=_cycalloc(sizeof(*_tmp482));({struct _tuple15*_tmpB10=({struct _tuple15*_tmp481=_cycalloc(sizeof(*_tmp481));_tmp481->f1=(struct Cyc_Absyn_Tvar*)_tmp480->hd,({void*_tmpB0F=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)_tmp47F->hd);_tmp481->f2=_tmpB0F;});_tmp481;});_tmp482->hd=_tmpB10;}),_tmp482->tl=inst;_tmp482;});
_tmp47F=_tmp47F->tl;
_tmp480=_tmp480->tl;}
# 2796
if(inst != 0){
_tmp4A3.tvars=0;
_tmp4A2.tvars=0;
return({struct Cyc_Tcenv_Tenv*_tmpB13=te;struct Cyc_List_List*_tmpB12=assume;void*_tmpB11=(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp483=_cycalloc(sizeof(*_tmp483));_tmp483->tag=5U,_tmp483->f1=_tmp4A3;_tmp483;});Cyc_Tcutil_subtype(_tmpB13,_tmpB12,_tmpB11,(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp484=_cycalloc(sizeof(*_tmp484));_tmp484->tag=5U,_tmp484->f1=_tmp4A2;_tmp484;}));});}};}
# 2803
...
# 2808
if(({int _tmpB14=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp485);_tmpB14 != ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp486);}))return 0;
# 2810
for(0;_tmp485 != 0;(_tmp485=_tmp485->tl,_tmp486=_tmp486->tl)){
struct _tuple10 _tmp487=*((struct _tuple10*)_tmp485->hd);struct _tuple10 _tmp488=_tmp487;struct Cyc_Absyn_Tqual _tmp48E;void*_tmp48D;_LLA: _tmp48E=_tmp488.f2;_tmp48D=_tmp488.f3;_LLB:;{
struct _tuple10 _tmp489=*((struct _tuple10*)((struct Cyc_List_List*)_check_null(_tmp486))->hd);struct _tuple10 _tmp48A=_tmp489;struct Cyc_Absyn_Tqual _tmp48C;void*_tmp48B;_LLD: _tmp48C=_tmp48A.f2;_tmp48B=_tmp48A.f3;_LLE:;
# 2814
...
# 2828
if(!({void*_tmpB15=(void*)_check_null(_tmp4A3.effect);Cyc_Tcutil_subset_effect(1,_tmpB15,(void*)_check_null(_tmp4A2.effect));}))return 0;
# 2830
...
if(tqs1 == 0)return 0;{
struct _tuple12*_tmp4A4=(struct _tuple12*)tqs1->hd;struct _tuple12*_tmp4A5=_tmp4A4;struct Cyc_Absyn_Tqual _tmp4AB;void*_tmp4AA;_LL1: _tmp4AB=_tmp4A5->f1;_tmp4AA=_tmp4A5->f2;_LL2:;{
struct _tuple12*_tmp4A6=(struct _tuple12*)tqs2->hd;struct _tuple12*_tmp4A7=_tmp4A6;struct Cyc_Absyn_Tqual _tmp4A9;void*_tmp4A8;_LL4: _tmp4A9=_tmp4A7->f1;_tmp4A8=_tmp4A7->f2;_LL5:;
# 2861
...
struct Cyc_List_List*_tmp4AF=({struct Cyc_List_List*_tmp4B7=_cycalloc(sizeof(*_tmp4B7));({struct _tuple0*_tmpB16=({struct _tuple0*_tmp4B6=_cycalloc(sizeof(*_tmp4B6));_tmp4B6->f1=t1,_tmp4B6->f2=t2;_tmp4B6;});_tmp4B7->hd=_tmpB16;}),_tmp4B7->tl=0;_tmp4B7;});
int _tmp4B0=_tmp4BC.real_const  || !_tmp4CB.real_const;
# 2926 "tcutil.cyc"
int _tmp4B1=
({void*_tmpB17=_tmp4B9;Cyc_Tcutil_unify(_tmpB17,Cyc_Absyn_bounds_one());}) && !Cyc_Tcutil_force_type2bool(0,_tmp4B8);
# 2929
int _tmp4B2=_tmp4B0  && (
...
struct Cyc_Absyn_Exp*_tmp4B4=({void*_tmpB18=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmpB18,_tmp4C8);});
struct Cyc_Absyn_Exp*_tmp4B5=({void*_tmpB19=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmpB19,_tmp4B9);});
...
int _tmpB1A=((int(*)(struct Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp4D1->fields))->v);_tmpB1A >= ((int(*)(struct Cyc_List_List*x))Cyc_List_length)((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(_tmp4C4->fields))->v);}))
...
({void*_tmpB1B=(void*)({struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp4D4=_cycalloc(sizeof(*_tmp4D4));_tmp4D4->tag=14U,_tmp4D4->f1=t,_tmp4D4->f2=_tmp4D3,_tmp4D4->f3=0,_tmp4D4->f4=c;_tmp4D4;});e->r=_tmpB1B;});
e->topt=t;}}
# 3015
void*Cyc_Tcutil_max_arithmetic_type(void*t1,void*t2){
{struct _tuple0 _tmp4D5=({struct _tuple0 _tmp9A2;({void*_tmpB1D=Cyc_Tcutil_compress(t1);_tmp9A2.f1=_tmpB1D;}),({void*_tmpB1C=Cyc_Tcutil_compress(t2);_tmp9A2.f2=_tmpB1C;});_tmp9A2;});struct _tuple0 _tmp4D6=_tmp4D5;void*_tmp4DC;void*_tmp4DB;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4D6.f1)->tag == 0U){if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4D6.f2)->tag == 0U){_LL1: _tmp4DC=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4D6.f1)->f1;_tmp4DB=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4D6.f2)->f1;_LL2:
# 3018
{struct _tuple0 _tmp4D7=({struct _tuple0 _tmp9A1;_tmp9A1.f1=_tmp4DC,_tmp9A1.f2=_tmp4DB;_tmp9A1;});struct _tuple0 _tmp4D8=_tmp4D7;int _tmp4DA;int _tmp4D9;if(((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp4D8.f1)->tag == 2U){if(((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp4D8.f2)->tag == 2U){_LL6: _tmp4DA=((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f1;_tmp4D9=((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f1;_LL7:
# 3020
 if(_tmp4DA != 0  && _tmp4DA != 1)return t1;else{
if(_tmp4D9 != 0  && _tmp4D9 != 1)return t2;else{
if(_tmp4DA >= _tmp4D9)return t1;else{
return t2;}}}}else{_LL8: _LL9:
 return t1;}}else{if(((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp4D8.f2)->tag == 2U){_LLA: _LLB:
 return t2;}else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->tag == 1U){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f1 == Cyc_Absyn_Unsigned){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_LongLong_sz){_LLC: _LLD:
 goto _LLF;}else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->tag == 1U){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f1 == Cyc_Absyn_Unsigned){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_LongLong_sz)goto _LLE;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_Long_sz)goto _LL14;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_Long_sz)goto _LL16;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_Int_sz)goto _LL1C;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_Int_sz)goto _LL1E;else{goto _LL24;}}}}}}else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_LongLong_sz)goto _LL12;else{switch(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2){case Cyc_Absyn_Long_sz: goto _LL14;case Cyc_Absyn_Int_sz: goto _LL1C;default: if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_Long_sz)goto _LL22;else{goto _LL24;}}}}}else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_Long_sz){_LL14: _LL15:
# 3030
 goto _LL17;}else{if(((struct Cyc_Absyn_TagCon_Absyn_TyCon_struct*)_tmp4D8.f2)->tag == 4U)goto _LL1A;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_Int_sz){_LL1C: _LL1D:
# 3035
 goto _LL1F;}else{goto _LL24;}}}}}}else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->tag == 1U){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f1 == Cyc_Absyn_Unsigned){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_LongLong_sz)goto _LLE;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_LongLong_sz)goto _LL10;else{switch(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2){case Cyc_Absyn_Long_sz: goto _LL16;case Cyc_Absyn_Int_sz: goto _LL1E;default: if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_Long_sz)goto _LL20;else{goto _LL24;}}}}}else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_LongLong_sz)goto _LL10;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_LongLong_sz)goto _LL12;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_Long_sz)goto _LL20;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_Long_sz)goto _LL22;else{goto _LL24;}}}}}}else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_LongLong_sz){_LL10: _LL11:
# 3028
 goto _LL13;}else{if(((struct Cyc_Absyn_TagCon_Absyn_TyCon_struct*)_tmp4D8.f2)->tag == 4U)goto _LL1A;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f1)->f2 == Cyc_Absyn_Long_sz){_LL20: _LL21:
# 3037
 goto _LL23;}else{goto _LL24;}}}}}}else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->tag == 1U){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f1 == Cyc_Absyn_Unsigned)switch(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2){case Cyc_Absyn_LongLong_sz: _LLE: _LLF:
# 3027
 return Cyc_Absyn_ulonglong_type;case Cyc_Absyn_Long_sz: _LL16: _LL17:
# 3031
 return Cyc_Absyn_ulong_type;default: if(((struct Cyc_Absyn_TagCon_Absyn_TyCon_struct*)_tmp4D8.f1)->tag == 4U)goto _LL18;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_Int_sz){_LL1E: _LL1F:
# 3036
 return Cyc_Absyn_uint_type;}else{goto _LL24;}}}else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_LongLong_sz){_LL12: _LL13:
# 3029
 return Cyc_Absyn_slonglong_type;}else{if(((struct Cyc_Absyn_TagCon_Absyn_TyCon_struct*)_tmp4D8.f1)->tag == 4U)goto _LL18;else{if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)_tmp4D8.f2)->f2 == Cyc_Absyn_Long_sz){_LL22: _LL23:
# 3038
 return Cyc_Absyn_slong_type;}else{goto _LL24;}}}}}else{if(((struct Cyc_Absyn_TagCon_Absyn_TyCon_struct*)_tmp4D8.f1)->tag == 4U){_LL18: _LL19:
# 3033
 goto _LL1B;}else{if(((struct Cyc_Absyn_TagCon_Absyn_TyCon_struct*)_tmp4D8.f2)->tag == 4U){_LL1A: _LL1B:
...
if(c1 == c2)return 1;{
struct _tuple0 _tmp4DD=({struct _tuple0 _tmp9A3;_tmp9A3.f1=c1,_tmp9A3.f2=c2;_tmp9A3;});struct _tuple0 _tmp4DE=_tmp4DD;struct Cyc_Core_Opt**_tmp4F2;struct Cyc_Absyn_Kind*_tmp4F1;struct Cyc_Core_Opt**_tmp4F0;struct Cyc_Absyn_Kind*_tmp4EF;struct Cyc_Core_Opt**_tmp4EE;struct Cyc_Absyn_Kind*_tmp4ED;struct Cyc_Absyn_Kind*_tmp4EC;struct Cyc_Core_Opt**_tmp4EB;struct Cyc_Core_Opt**_tmp4EA;struct Cyc_Absyn_Kind*_tmp4E9;struct Cyc_Core_Opt**_tmp4E8;struct Cyc_Absyn_Kind*_tmp4E7;struct Cyc_Absyn_Kind*_tmp4E6;struct Cyc_Absyn_Kind*_tmp4E5;if(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp4DE.f1)->tag == 0U)switch(*((int*)_tmp4DE.f2)){case 0U: _LL1: _tmp4E6=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp4DE.f1)->f1;_tmp4E5=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp4DE.f2)->f1;_LL2:
 return _tmp4E6 == _tmp4E5;case 1U: goto _LL3;default: _LL9: _tmp4E9=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp4DE.f1)->f1;_tmp4E8=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp4DE.f2)->f1;_tmp4E7=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp4DE.f2)->f2;_LLA:
# 3067
 if(Cyc_Tcutil_kind_leq(_tmp4E9,_tmp4E7)){
({struct Cyc_Core_Opt*_tmpB1E=({struct Cyc_Core_Opt*_tmp4E2=_cycalloc(sizeof(*_tmp4E2));_tmp4E2->v=c1;_tmp4E2;});*_tmp4E8=_tmpB1E;});return 1;}else{
return 0;}}else{if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp4DE.f2)->tag == 1U){_LL3: _tmp4EA=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp4DE.f2)->f1;_LL4:
# 3060
({struct Cyc_Core_Opt*_tmpB1F=({struct Cyc_Core_Opt*_tmp4DF=_cycalloc(sizeof(*_tmp4DF));_tmp4DF->v=c1;_tmp4DF;});*_tmp4EA=_tmpB1F;});return 1;}else{if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp4DE.f1)->tag == 1U){_LL5: _tmp4EB=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp4DE.f1)->f1;_LL6:
({struct Cyc_Core_Opt*_tmpB20=({struct Cyc_Core_Opt*_tmp4E0=_cycalloc(sizeof(*_tmp4E0));_tmp4E0->v=c2;_tmp4E0;});*_tmp4EB=_tmpB20;});return 1;}else{if(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp4DE.f2)->tag == 0U){_LL7: _tmp4EE=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp4DE.f1)->f1;_tmp4ED=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp4DE.f1)->f2;_tmp4EC=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp4DE.f2)->f1;_LL8:
# 3063
 if(Cyc_Tcutil_kind_leq(_tmp4EC,_tmp4ED)){
({struct Cyc_Core_Opt*_tmpB21=({struct Cyc_Core_Opt*_tmp4E1=_cycalloc(sizeof(*_tmp4E1));_tmp4E1->v=c2;_tmp4E1;});*_tmp4EE=_tmpB21;});return 1;}else{
return 0;}}else{_LLB: _tmp4F2=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp4DE.f1)->f1;_tmp4F1=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp4DE.f1)->f2;_tmp4F0=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp4DE.f2)->f1;_tmp4EF=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp4DE.f2)->f2;_LLC:
# 3071
 if(Cyc_Tcutil_kind_leq(_tmp4F1,_tmp4EF)){
({struct Cyc_Core_Opt*_tmpB22=({struct Cyc_Core_Opt*_tmp4E3=_cycalloc(sizeof(*_tmp4E3));_tmp4E3->v=c1;_tmp4E3;});*_tmp4F0=_tmpB22;});return 1;}else{
if(Cyc_Tcutil_kind_leq(_tmp4EF,_tmp4F1)){
({struct Cyc_Core_Opt*_tmpB23=({struct Cyc_Core_Opt*_tmp4E4=_cycalloc(sizeof(*_tmp4E4));_tmp4E4->v=c2;_tmp4E4;});*_tmp4F2=_tmpB23;});return 1;}else{
return 0;}}}}}}_LL0:;};}
# 3080
...
struct _dyneither_ptr s=(struct _dyneither_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp4F8=({struct Cyc_Int_pa_PrintArg_struct _tmp9A4;_tmp9A4.tag=1U,_tmp9A4.f1=(unsigned long)i;_tmp9A4;});void*_tmp4F6[1U];_tmp4F6[0]=& _tmp4F8;({struct _dyneither_ptr _tmpB24=({const char*_tmp4F7="#%d";_tag_dyneither(_tmp4F7,sizeof(char),4U);});Cyc_aprintf(_tmpB24,_tag_dyneither(_tmp4F6,sizeof(void*),1U));});});
return({struct Cyc_Absyn_Tvar*_tmp4F5=_cycalloc(sizeof(*_tmp4F5));({struct _dyneither_ptr*_tmpB25=({unsigned int _tmp4F4=1;struct _dyneither_ptr*_tmp4F3=_cycalloc(_check_times(_tmp4F4,sizeof(struct _dyneither_ptr)));_tmp4F3[0]=s;_tmp4F3;});_tmp4F5->name=_tmpB25;}),_tmp4F5->identity=- 1,_tmp4F5->kind=k;_tmp4F5;});}
# 3092
int Cyc_Tcutil_is_temp_tvar(struct Cyc_Absyn_Tvar*t){
struct _dyneither_ptr _tmp4F9=*t->name;
return(int)*((const char*)_check_dyneither_subscript(_tmp4F9,sizeof(char),0))== (int)'#';}
# 3097
void Cyc_Tcutil_rewrite_temp_tvar(struct Cyc_Absyn_Tvar*t){
({struct Cyc_String_pa_PrintArg_struct _tmp4FC=({struct Cyc_String_pa_PrintArg_struct _tmp9A5;_tmp9A5.tag=0U,_tmp9A5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*t->name);_tmp9A5;});void*_tmp4FA[1U];_tmp4FA[0]=& _tmp4FC;({struct _dyneither_ptr _tmpB26=({const char*_tmp4FB="%s";_tag_dyneither(_tmp4FB,sizeof(char),3U);});Cyc_printf(_tmpB26,_tag_dyneither(_tmp4FA,sizeof(void*),1U));});});
if(!Cyc_Tcutil_is_temp_tvar(t))return;{
struct _dyneither_ptr _tmp4FD=({struct _dyneither_ptr _tmpB27=({const char*_tmp503="`";_tag_dyneither(_tmp503,sizeof(char),2U);});Cyc_strconcat(_tmpB27,(struct _dyneither_ptr)*t->name);});
({struct _dyneither_ptr _tmp4FE=_dyneither_ptr_plus(_tmp4FD,sizeof(char),1);char _tmp4FF=*((char*)_check_dyneither_subscript(_tmp4FE,sizeof(char),0U));char _tmp500='t';if(_get_dyneither_size(_tmp4FE,sizeof(char))== 1U  && (_tmp4FF == 0  && _tmp500 != 0))_throw_arraybounds();*((char*)_tmp4FE.curr)=_tmp500;});
({struct _dyneither_ptr*_tmpB28=({unsigned int _tmp502=1;struct _dyneither_ptr*_tmp501=_cycalloc(_check_times(_tmp502,sizeof(struct _dyneither_ptr)));_tmp501[0]=(struct _dyneither_ptr)_tmp4FD;_tmp501;});t->name=_tmpB28;});};}
# 3106
...
_tmp504=({struct Cyc_List_List*_tmp505=_cycalloc(sizeof(*_tmp505));_tmp505->hd=(void*)atts->hd,_tmp505->tl=_tmp504;_tmp505;});}}{
struct Cyc_Absyn_FnInfo _tmp506=fd->i;
_tmp506.attributes=_tmp504;
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp507=_cycalloc(sizeof(*_tmp507));_tmp507->tag=5U,_tmp507->f1=_tmp506;_tmp507;});};}
# 3121
...
# 3129
union Cyc_Relations_RelnOp _tmp508=*rop;union Cyc_Relations_RelnOp _tmp509=_tmp508;struct Cyc_Absyn_Vardecl*_tmp51C;struct Cyc_Absyn_Vardecl*_tmp51B;switch((_tmp509.RNumelts).tag){case 2U: _LL1: _tmp51B=(_tmp509.RVar).val;_LL2: {
# 3131
struct _tuple2 _tmp50A=*_tmp51B->name;struct _tuple2 _tmp50B=_tmp50A;union Cyc_Absyn_Nmspace _tmp512;struct _dyneither_ptr*_tmp511;_LL8: _tmp512=_tmp50B.f1;_tmp511=_tmp50B.f2;_LL9:;
if(!((int)((_tmp512.Loc_n).tag == 4)))goto _LL0;
if(({struct _dyneither_ptr _tmpB29=(struct _dyneither_ptr)*_tmp511;Cyc_strcmp(_tmpB29,({const char*_tmp50C="return_value";_tag_dyneither(_tmp50C,sizeof(char),13U);}));})== 0){
({union Cyc_Relations_RelnOp _tmpB2A=Cyc_Relations_RReturn();*rop=_tmpB2A;});
goto _LL0;}{
# 3137
unsigned int c=0U;
{struct Cyc_List_List*_tmp50D=args;for(0;_tmp50D != 0;(_tmp50D=_tmp50D->tl,c ++)){
struct _tuple10*_tmp50E=(struct _tuple10*)_tmp50D->hd;struct _tuple10*_tmp50F=_tmp50E;struct _dyneither_ptr*_tmp510;_LLB: _tmp510=_tmp50F->f1;_LLC:;
if(_tmp510 != 0){
if(Cyc_strcmp((struct _dyneither_ptr)*_tmp511,(struct _dyneither_ptr)*_tmp510)== 0){
({union Cyc_Relations_RelnOp _tmpB2B=Cyc_Relations_RParam(c);*rop=_tmpB2B;});
break;}}}}
# 3147
goto _LL0;};}case 3U: _LL3: _tmp51C=(_tmp509.RNumelts).val;_LL4: {
# 3149
struct _tuple2 _tmp513=*_tmp51C->name;struct _tuple2 _tmp514=_tmp513;union Cyc_Absyn_Nmspace _tmp51A;struct _dyneither_ptr*_tmp519;_LLE: _tmp51A=_tmp514.f1;_tmp519=_tmp514.f2;_LLF:;
if(!((int)((_tmp51A.Loc_n).tag == 4)))goto _LL0;{
unsigned int c=0U;
{struct Cyc_List_List*_tmp515=args;for(0;_tmp515 != 0;(_tmp515=_tmp515->tl,c ++)){
struct _tuple10*_tmp516=(struct _tuple10*)_tmp515->hd;struct _tuple10*_tmp517=_tmp516;struct _dyneither_ptr*_tmp518;_LL11: _tmp518=_tmp517->f1;_LL12:;
if(_tmp518 != 0){
if(Cyc_strcmp((struct _dyneither_ptr)*_tmp519,(struct _dyneither_ptr)*_tmp518)== 0){
...
# 3174
if(e == 0)return 0;{
struct Cyc_List_List*_tmp51D=Cyc_Relations_exp2relns(Cyc_Core_heap_region,e);
((void(*)(void(*f)(struct Cyc_List_List*,struct Cyc_Relations_Reln*),struct Cyc_List_List*env,struct Cyc_List_List*x))Cyc_List_iter_c)(Cyc_Tcutil_replace_rops,args,_tmp51D);
return _tmp51D;};}
# 3181
...
struct _tuple12*_tmp51E=pr;struct Cyc_Absyn_Tqual _tmp521;void*_tmp520;_LL1: _tmp521=_tmp51E->f1;_tmp520=_tmp51E->f2;_LL2:;
if(_tmp520 == t)return pr;else{
return({struct _tuple12*_tmp51F=_cycalloc(sizeof(*_tmp51F));_tmp51F->f1=_tmp521,_tmp51F->f2=t;_tmp51F;});}}struct _tuple27{struct _dyneither_ptr*f1;struct Cyc_Absyn_Tqual f2;};struct _tuple28{struct _tuple27*f1;void*f2;};
# 3188
static struct _tuple28*Cyc_Tcutil_substitute_f1(struct _RegionHandle*rgn,struct _tuple10*y){
# 3190
return({struct _tuple28*_tmp523=_region_malloc(rgn,sizeof(*_tmp523));({struct _tuple27*_tmpB2D=({struct _tuple27*_tmp522=_region_malloc(rgn,sizeof(*_tmp522));_tmp522->f1=(*y).f1,_tmp522->f2=(*y).f2;_tmp522;});_tmp523->f1=_tmpB2D;}),_tmp523->f2=(*y).f3;_tmp523;});}
# 3192
static struct _tuple10*Cyc_Tcutil_substitute_f2(struct _tuple10*orig_arg,void*t){
# 3194
struct _tuple10 _tmp524=*orig_arg;struct _tuple10 _tmp525=_tmp524;struct _dyneither_ptr*_tmp529;struct Cyc_Absyn_Tqual _tmp528;void*_tmp527;_LL1: _tmp529=_tmp525.f1;_tmp528=_tmp525.f2;_tmp527=_tmp525.f3;_LL2:;
if(t == _tmp527)return orig_arg;
return({struct _tuple10*_tmp526=_cycalloc(sizeof(*_tmp526));_tmp526->f1=_tmp529,_tmp526->f2=_tmp528,_tmp526->f3=t;_tmp526;});}
# 3198
...
# 3208
return({struct Cyc_Absyn_Exp*_tmp52A=_cycalloc(sizeof(*_tmp52A));_tmp52A->topt=old->topt,_tmp52A->r=r,_tmp52A->loc=old->loc,_tmp52A->annot=old->annot;_tmp52A;});}
# 3213
struct Cyc_Absyn_Exp*Cyc_Tcutil_rsubsexp(struct _RegionHandle*r,struct Cyc_List_List*inst,struct Cyc_Absyn_Exp*e){
void*_tmp52B=e->r;void*_tmp52C=_tmp52B;void*_tmp56C;void*_tmp56B;struct Cyc_List_List*_tmp56A;struct Cyc_Absyn_Exp*_tmp569;struct Cyc_Absyn_Exp*_tmp568;void*_tmp567;void*_tmp566;struct Cyc_Absyn_Exp*_tmp565;int _tmp564;enum Cyc_Absyn_Coercion _tmp563;struct Cyc_Absyn_Exp*_tmp562;struct Cyc_Absyn_Exp*_tmp561;struct Cyc_Absyn_Exp*_tmp560;struct Cyc_Absyn_Exp*_tmp55F;struct Cyc_Absyn_Exp*_tmp55E;struct Cyc_Absyn_Exp*_tmp55D;struct Cyc_Absyn_Exp*_tmp55C;struct Cyc_Absyn_Exp*_tmp55B;struct Cyc_Absyn_Exp*_tmp55A;enum Cyc_Absyn_Primop _tmp559;struct Cyc_List_List*_tmp558;switch(*((int*)_tmp52C)){case 0U: _LL1: _LL2:
 goto _LL4;case 32U: _LL3: _LL4:
 goto _LL6;case 33U: _LL5: _LL6:
 goto _LL8;case 2U: _LL7: _LL8:
 goto _LLA;case 1U: _LL9: _LLA:
 return e;case 3U: _LLB: _tmp559=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_tmp558=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp52C)->f2;_LLC:
# 3222
 if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp558)== 1){
struct Cyc_Absyn_Exp*_tmp52D=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp558))->hd;
struct Cyc_Absyn_Exp*_tmp52E=Cyc_Tcutil_rsubsexp(r,inst,_tmp52D);
if(_tmp52E == _tmp52D)return e;
return({struct Cyc_Absyn_Exp*_tmpB2F=e;Cyc_Tcutil_copye(_tmpB2F,(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp530=_cycalloc(sizeof(*_tmp530));_tmp530->tag=3U,_tmp530->f1=_tmp559,({struct Cyc_List_List*_tmpB2E=({struct Cyc_Absyn_Exp*_tmp52F[1U];_tmp52F[0]=_tmp52E;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp52F,sizeof(struct Cyc_Absyn_Exp*),1U));});_tmp530->f2=_tmpB2E;});_tmp530;}));});}else{
if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp558)== 2){
struct Cyc_Absyn_Exp*_tmp531=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp558))->hd;
struct Cyc_Absyn_Exp*_tmp532=(struct Cyc_Absyn_Exp*)((struct Cyc_List_List*)_check_null(_tmp558->tl))->hd;
struct Cyc_Absyn_Exp*_tmp533=Cyc_Tcutil_rsubsexp(r,inst,_tmp531);
struct Cyc_Absyn_Exp*_tmp534=Cyc_Tcutil_rsubsexp(r,inst,_tmp532);
if(_tmp533 == _tmp531  && _tmp534 == _tmp532)return e;
return({struct Cyc_Absyn_Exp*_tmpB31=e;Cyc_Tcutil_copye(_tmpB31,(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp536=_cycalloc(sizeof(*_tmp536));_tmp536->tag=3U,_tmp536->f1=_tmp559,({struct Cyc_List_List*_tmpB30=({struct Cyc_Absyn_Exp*_tmp535[2U];_tmp535[0]=_tmp533,_tmp535[1]=_tmp534;((struct Cyc_List_List*(*)(struct _dyneither_ptr))Cyc_List_list)(_tag_dyneither(_tmp535,sizeof(struct Cyc_Absyn_Exp*),2U));});_tmp536->f2=_tmpB30;});_tmp536;}));});}else{
return({void*_tmp537=0U;({struct _dyneither_ptr _tmpB32=({const char*_tmp538="primop does not have 1 or 2 args!";_tag_dyneither(_tmp538,sizeof(char),34U);});((struct Cyc_Absyn_Exp*(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB32,_tag_dyneither(_tmp537,sizeof(void*),0U));});});}}case 6U: _LLD: _tmp55C=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_tmp55B=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp52C)->f2;_tmp55A=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp52C)->f3;_LLE: {
# 3236
struct Cyc_Absyn_Exp*_tmp539=Cyc_Tcutil_rsubsexp(r,inst,_tmp55C);
struct Cyc_Absyn_Exp*_tmp53A=Cyc_Tcutil_rsubsexp(r,inst,_tmp55B);
struct Cyc_Absyn_Exp*_tmp53B=Cyc_Tcutil_rsubsexp(r,inst,_tmp55A);
if((_tmp539 == _tmp55C  && _tmp53A == _tmp55B) && _tmp53B == _tmp55A)return e;
return({struct Cyc_Absyn_Exp*_tmpB33=e;Cyc_Tcutil_copye(_tmpB33,(void*)({struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*_tmp53C=_cycalloc(sizeof(*_tmp53C));_tmp53C->tag=6U,_tmp53C->f1=_tmp539,_tmp53C->f2=_tmp53A,_tmp53C->f3=_tmp53B;_tmp53C;}));});}case 7U: _LLF: _tmp55E=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_tmp55D=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp52C)->f2;_LL10: {
# 3242
struct Cyc_Absyn_Exp*_tmp53D=Cyc_Tcutil_rsubsexp(r,inst,_tmp55E);
struct Cyc_Absyn_Exp*_tmp53E=Cyc_Tcutil_rsubsexp(r,inst,_tmp55D);
if(_tmp53D == _tmp55E  && _tmp53E == _tmp55D)return e;
return({struct Cyc_Absyn_Exp*_tmpB34=e;Cyc_Tcutil_copye(_tmpB34,(void*)({struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_tmp53F=_cycalloc(sizeof(*_tmp53F));_tmp53F->tag=7U,_tmp53F->f1=_tmp53D,_tmp53F->f2=_tmp53E;_tmp53F;}));});}case 8U: _LL11: _tmp560=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_tmp55F=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp52C)->f2;_LL12: {
# 3247
struct Cyc_Absyn_Exp*_tmp540=Cyc_Tcutil_rsubsexp(r,inst,_tmp560);
struct Cyc_Absyn_Exp*_tmp541=Cyc_Tcutil_rsubsexp(r,inst,_tmp55F);
if(_tmp540 == _tmp560  && _tmp541 == _tmp55F)return e;
return({struct Cyc_Absyn_Exp*_tmpB35=e;Cyc_Tcutil_copye(_tmpB35,(void*)({struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*_tmp542=_cycalloc(sizeof(*_tmp542));_tmp542->tag=8U,_tmp542->f1=_tmp540,_tmp542->f2=_tmp541;_tmp542;}));});}case 9U: _LL13: _tmp562=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_tmp561=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp52C)->f2;_LL14: {
# 3252
struct Cyc_Absyn_Exp*_tmp543=Cyc_Tcutil_rsubsexp(r,inst,_tmp562);
struct Cyc_Absyn_Exp*_tmp544=Cyc_Tcutil_rsubsexp(r,inst,_tmp561);
if(_tmp543 == _tmp562  && _tmp544 == _tmp561)return e;
return({struct Cyc_Absyn_Exp*_tmpB36=e;Cyc_Tcutil_copye(_tmpB36,(void*)({struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*_tmp545=_cycalloc(sizeof(*_tmp545));_tmp545->tag=9U,_tmp545->f1=_tmp543,_tmp545->f2=_tmp544;_tmp545;}));});}case 14U: _LL15: _tmp566=(void*)((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_tmp565=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp52C)->f2;_tmp564=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp52C)->f3;_tmp563=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp52C)->f4;_LL16: {
# 3257
struct Cyc_Absyn_Exp*_tmp546=Cyc_Tcutil_rsubsexp(r,inst,_tmp565);
void*_tmp547=Cyc_Tcutil_rsubstitute(r,inst,_tmp566);
if(_tmp546 == _tmp565  && _tmp547 == _tmp566)return e;
return({struct Cyc_Absyn_Exp*_tmpB37=e;Cyc_Tcutil_copye(_tmpB37,(void*)({struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp548=_cycalloc(sizeof(*_tmp548));_tmp548->tag=14U,_tmp548->f1=_tmp547,_tmp548->f2=_tmp546,_tmp548->f3=_tmp564,_tmp548->f4=_tmp563;_tmp548;}));});}case 17U: _LL17: _tmp567=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_LL18: {
# 3262
void*_tmp549=Cyc_Tcutil_rsubstitute(r,inst,_tmp567);
if(_tmp549 == _tmp567)return e;
return({struct Cyc_Absyn_Exp*_tmpB38=e;Cyc_Tcutil_copye(_tmpB38,(void*)({struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*_tmp54A=_cycalloc(sizeof(*_tmp54A));_tmp54A->tag=17U,_tmp54A->f1=_tmp549;_tmp54A;}));});}case 18U: _LL19: _tmp568=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_LL1A: {
# 3266
struct Cyc_Absyn_Exp*_tmp54B=Cyc_Tcutil_rsubsexp(r,inst,_tmp568);
if(_tmp54B == _tmp568)return e;
return({struct Cyc_Absyn_Exp*_tmpB39=e;Cyc_Tcutil_copye(_tmpB39,(void*)({struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*_tmp54C=_cycalloc(sizeof(*_tmp54C));_tmp54C->tag=18U,_tmp54C->f1=_tmp54B;_tmp54C;}));});}case 41U: _LL1B: _tmp569=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_LL1C: {
# 3270
struct Cyc_Absyn_Exp*_tmp54D=Cyc_Tcutil_rsubsexp(r,inst,_tmp569);
if(_tmp54D == _tmp569)return e;
return({struct Cyc_Absyn_Exp*_tmpB3A=e;Cyc_Tcutil_copye(_tmpB3A,(void*)({struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*_tmp54E=_cycalloc(sizeof(*_tmp54E));_tmp54E->tag=41U,_tmp54E->f1=_tmp54D;_tmp54E;}));});}case 19U: _LL1D: _tmp56B=(void*)((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_tmp56A=((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp52C)->f2;_LL1E: {
# 3274
void*_tmp54F=Cyc_Tcutil_rsubstitute(r,inst,_tmp56B);
if(_tmp54F == _tmp56B)return e;
return({struct Cyc_Absyn_Exp*_tmpB3B=e;Cyc_Tcutil_copye(_tmpB3B,(void*)({struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*_tmp550=_cycalloc(sizeof(*_tmp550));_tmp550->tag=19U,_tmp550->f1=_tmp54F,_tmp550->f2=_tmp56A;_tmp550;}));});}case 39U: _LL1F: _tmp56C=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmp52C)->f1;_LL20: {
# 3278
void*_tmp551=Cyc_Tcutil_rsubstitute(r,inst,_tmp56C);
if(_tmp551 == _tmp56C)return e;{
# 3281
void*_tmp552=Cyc_Tcutil_compress(_tmp551);void*_tmp553=_tmp552;struct Cyc_Absyn_Exp*_tmp555;if(((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp553)->tag == 9U){_LL24: _tmp555=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp553)->f1;_LL25:
 return _tmp555;}else{_LL26: _LL27:
# 3284
 return({struct Cyc_Absyn_Exp*_tmpB3C=e;Cyc_Tcutil_copye(_tmpB3C,(void*)({struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp554=_cycalloc(sizeof(*_tmp554));_tmp554->tag=39U,_tmp554->f1=_tmp551;_tmp554;}));});}_LL23:;};}default: _LL21: _LL22:
# 3287
 return({void*_tmp556=0U;({struct _dyneither_ptr _tmpB3D=({const char*_tmp557="non-type-level-expression in Tcutil::rsubsexp";_tag_dyneither(_tmp557,sizeof(char),46U);});((struct Cyc_Absyn_Exp*(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB3D,_tag_dyneither(_tmp556,sizeof(void*),0U));});});}_LL0:;}
# 3291
...
# 3302
void*_tmp56D=f->type;
struct Cyc_Absyn_Exp*_tmp56E=f->requires_clause;
void*_tmp56F=Cyc_Tcutil_rsubstitute(r,inst,_tmp56D);
struct Cyc_Absyn_Exp*_tmp570=Cyc_Tcutil_rsubs_exp_opt(r,inst,_tmp56E);
if(_tmp56D == _tmp56F  && _tmp56E == _tmp570)return f;else{
return({struct Cyc_Absyn_Aggrfield*_tmp571=_cycalloc(sizeof(*_tmp571));_tmp571->name=f->name,_tmp571->tq=f->tq,_tmp571->type=_tmp56F,_tmp571->width=f->width,_tmp571->attributes=f->attributes,_tmp571->requires_clause=_tmp570;_tmp571;});}}
# 3312
...
# 3315
if(fs == 0)return 0;{
struct Cyc_Absyn_Aggrfield*_tmp572=(struct Cyc_Absyn_Aggrfield*)fs->hd;
struct Cyc_List_List*_tmp573=fs->tl;
struct Cyc_Absyn_Aggrfield*_tmp574=Cyc_Tcutil_subst_aggrfield(r,inst,_tmp572);
struct Cyc_List_List*_tmp575=Cyc_Tcutil_subst_aggrfields(r,inst,_tmp573);
if(_tmp574 == _tmp572  && _tmp575 == _tmp573)return fs;
return({struct Cyc_List_List*_tmp576=_cycalloc(sizeof(*_tmp576));_tmp576->hd=_tmp574,_tmp576->tl=_tmp575;_tmp576;});};}
# 3324
...
# 3327
struct _tuple1 _tmp577=((struct _tuple1(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x))Cyc_List_rsplit)(rgn,rgn,rgn_po);struct _tuple1 _tmp578=_tmp577;struct Cyc_List_List*_tmp57C;struct Cyc_List_List*_tmp57B;_LL1: _tmp57C=_tmp578.f1;_tmp57B=_tmp578.f2;_LL2:;{
struct Cyc_List_List*_tmp579=Cyc_Tcutil_substs(rgn,inst,_tmp57C);
struct Cyc_List_List*_tmp57A=Cyc_Tcutil_substs(rgn,inst,_tmp57B);
if(_tmp579 == _tmp57C  && _tmp57A == _tmp57B)
return rgn_po;else{
# 3333
return((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_zip)(_tmp579,_tmp57A);}};}
# 3336
void*Cyc_Tcutil_rsubstitute(struct _RegionHandle*rgn,struct Cyc_List_List*inst,void*t){
# 3339
void*_tmp57D=Cyc_Tcutil_compress(t);void*_tmp57E=_tmp57D;struct Cyc_Absyn_Exp*_tmp5D6;struct Cyc_Absyn_Exp*_tmp5D5;void*_tmp5D4;struct Cyc_List_List*_tmp5D3;void*_tmp5D2;void*_tmp5D1;enum Cyc_Absyn_AggrKind _tmp5D0;struct Cyc_List_List*_tmp5CF;struct Cyc_List_List*_tmp5CE;struct Cyc_List_List*_tmp5CD;void*_tmp5CC;struct Cyc_Absyn_Tqual _tmp5CB;void*_tmp5CA;struct Cyc_List_List*_tmp5C9;int _tmp5C8;struct Cyc_Absyn_VarargInfo*_tmp5C7;struct Cyc_List_List*_tmp5C6;struct Cyc_List_List*_tmp5C5;struct Cyc_Absyn_Exp*_tmp5C4;struct Cyc_Absyn_Exp*_tmp5C3;void*_tmp5C2;struct Cyc_Absyn_Tqual _tmp5C1;void*_tmp5C0;void*_tmp5BF;void*_tmp5BE;void*_tmp5BD;void*_tmp5BC;struct Cyc_Absyn_Tqual _tmp5BB;struct Cyc_Absyn_Exp*_tmp5BA;void*_tmp5B9;unsigned int _tmp5B8;struct _tuple2*_tmp5B7;struct Cyc_List_List*_tmp5B6;struct Cyc_Absyn_Typedefdecl*_tmp5B5;void*_tmp5B4;struct Cyc_Absyn_Tvar*_tmp5B3;switch(*((int*)_tmp57E)){case 2U: _LL1: _tmp5B3=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp57E)->f1;_LL2: {
# 3342
struct _handler_cons _tmp57F;_push_handler(& _tmp57F);{int _tmp581=0;if(setjmp(_tmp57F.handler))_tmp581=1;if(!_tmp581){{void*_tmp582=((void*(*)(int(*cmp)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct Cyc_Absyn_Tvar*x))Cyc_List_assoc_cmp)(Cyc_Absyn_tvar_cmp,inst,_tmp5B3);_npop_handler(0U);return _tmp582;};_pop_handler();}else{void*_tmp580=(void*)_exn_thrown;void*_tmp583=_tmp580;void*_tmp584;if(((struct Cyc_Core_Not_found_exn_struct*)_tmp583)->tag == Cyc_Core_Not_found){_LL1C: _LL1D:
 return t;}else{_LL1E: _tmp584=_tmp583;_LL1F:(int)_rethrow(_tmp584);}_LL1B:;}};}case 8U: _LL3: _tmp5B7=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp57E)->f1;_tmp5B6=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp57E)->f2;_tmp5B5=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp57E)->f3;_tmp5B4=(void*)((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp57E)->f4;_LL4: {
# 3345
struct Cyc_List_List*_tmp585=Cyc_Tcutil_substs(rgn,inst,_tmp5B6);
return _tmp585 == _tmp5B6?t:(void*)({struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_tmp586=_cycalloc(sizeof(*_tmp586));_tmp586->tag=8U,_tmp586->f1=_tmp5B7,_tmp586->f2=_tmp585,_tmp586->f3=_tmp5B5,_tmp586->f4=_tmp5B4;_tmp586;});}case 4U: _LL5: _tmp5BC=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp57E)->f1).elt_type;_tmp5BB=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp57E)->f1).tq;_tmp5BA=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp57E)->f1).num_elts;_tmp5B9=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp57E)->f1).zero_term;_tmp5B8=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp57E)->f1).zt_loc;_LL6: {
# 3348
void*_tmp587=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5BC);
struct Cyc_Absyn_Exp*_tmp588=_tmp5BA == 0?0: Cyc_Tcutil_rsubsexp(rgn,inst,_tmp5BA);
void*_tmp589=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5B9);
return(_tmp587 == _tmp5BC  && _tmp588 == _tmp5BA) && _tmp589 == _tmp5B9?t:(void*)({struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_tmp58A=_cycalloc(sizeof(*_tmp58A));
_tmp58A->tag=4U,(_tmp58A->f1).elt_type=_tmp587,(_tmp58A->f1).tq=_tmp5BB,(_tmp58A->f1).num_elts=_tmp588,(_tmp58A->f1).zero_term=_tmp589,(_tmp58A->f1).zt_loc=_tmp5B8;_tmp58A;});}case 3U: _LL7: _tmp5C2=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp57E)->f1).elt_type;_tmp5C1=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp57E)->f1).elt_tq;_tmp5C0=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp57E)->f1).ptr_atts).rgn;_tmp5BF=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp57E)->f1).ptr_atts).nullable;_tmp5BE=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp57E)->f1).ptr_atts).bounds;_tmp5BD=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp57E)->f1).ptr_atts).zero_term;_LL8: {
# 3354
void*_tmp58B=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5C2);
void*_tmp58C=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5C0);
void*_tmp58D=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5BE);
void*_tmp58E=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5BD);
if(((_tmp58B == _tmp5C2  && _tmp58C == _tmp5C0) && _tmp58D == _tmp5BE) && _tmp58E == _tmp5BD)
return t;
return Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp9A6;_tmp9A6.elt_type=_tmp58B,_tmp9A6.elt_tq=_tmp5C1,(_tmp9A6.ptr_atts).rgn=_tmp58C,(_tmp9A6.ptr_atts).nullable=_tmp5BF,(_tmp9A6.ptr_atts).bounds=_tmp58D,(_tmp9A6.ptr_atts).zero_term=_tmp58E,(_tmp9A6.ptr_atts).ptrloc=0;_tmp9A6;}));}case 5U: _LL9: _tmp5CD=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).tvars;_tmp5CC=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).effect;_tmp5CB=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).ret_tqual;_tmp5CA=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).ret_type;_tmp5C9=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).args;_tmp5C8=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).c_varargs;_tmp5C7=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).cyc_varargs;_tmp5C6=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).rgn_po;_tmp5C5=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).attributes;_tmp5C4=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).requires_clause;_tmp5C3=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp57E)->f1).ensures_clause;_LLA:
# 3364
{struct Cyc_List_List*_tmp58F=_tmp5CD;for(0;_tmp58F != 0;_tmp58F=_tmp58F->tl){
inst=({struct Cyc_List_List*_tmp591=_region_malloc(rgn,sizeof(*_tmp591));({struct _tuple15*_tmpB3F=({struct _tuple15*_tmp590=_region_malloc(rgn,sizeof(*_tmp590));_tmp590->f1=(struct Cyc_Absyn_Tvar*)_tmp58F->hd,({void*_tmpB3E=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)_tmp58F->hd);_tmp590->f2=_tmpB3E;});_tmp590;});_tmp591->hd=_tmpB3F;}),_tmp591->tl=inst;_tmp591;});}}{
struct _tuple1 _tmp592=({struct _RegionHandle*_tmpB41=rgn;struct _RegionHandle*_tmpB40=rgn;((struct _tuple1(*)(struct _RegionHandle*r1,struct _RegionHandle*r2,struct Cyc_List_List*x))Cyc_List_rsplit)(_tmpB41,_tmpB40,
((struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple28*(*f)(struct _RegionHandle*,struct _tuple10*),struct _RegionHandle*env,struct Cyc_List_List*x))Cyc_List_rmap_c)(rgn,Cyc_Tcutil_substitute_f1,rgn,_tmp5C9));});
# 3366
struct _tuple1 _tmp593=_tmp592;struct Cyc_List_List*_tmp5A2;struct Cyc_List_List*_tmp5A1;_LL21: _tmp5A2=_tmp593.f1;_tmp5A1=_tmp593.f2;_LL22:;{
# 3368
struct Cyc_List_List*_tmp594=_tmp5C9;
struct Cyc_List_List*_tmp595=Cyc_Tcutil_substs(rgn,inst,_tmp5A1);
if(_tmp595 != _tmp5A1)
_tmp594=((struct Cyc_List_List*(*)(struct _tuple10*(*f)(struct _tuple10*,void*),struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_map2)(Cyc_Tcutil_substitute_f2,_tmp5C9,_tmp595);{
void*eff2;
if(_tmp5CC == 0)
eff2=0;else{
# 3376
void*new_eff=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5CC);
if(new_eff == _tmp5CC)
eff2=_tmp5CC;else{
# 3380
eff2=new_eff;}}{
...
cyc_varargs2=0;else{
# 3386
struct Cyc_Absyn_VarargInfo _tmp596=*_tmp5C7;struct Cyc_Absyn_VarargInfo _tmp597=_tmp596;struct _dyneither_ptr*_tmp59D;struct Cyc_Absyn_Tqual _tmp59C;void*_tmp59B;int _tmp59A;_LL24: _tmp59D=_tmp597.name;_tmp59C=_tmp597.tq;_tmp59B=_tmp597.type;_tmp59A=_tmp597.inject;_LL25:;{
void*_tmp598=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp59B);
if(_tmp598 == _tmp59B)cyc_varargs2=_tmp5C7;else{
# 3390
cyc_varargs2=({struct Cyc_Absyn_VarargInfo*_tmp599=_cycalloc(sizeof(*_tmp599));_tmp599->name=_tmp59D,_tmp599->tq=_tmp59C,_tmp599->type=_tmp598,_tmp599->inject=_tmp59A;_tmp599;});}};}{
# 3392
struct Cyc_List_List*rgn_po2=Cyc_Tcutil_rsubst_rgnpo(rgn,inst,_tmp5C6);
struct Cyc_Absyn_Exp*req2=Cyc_Tcutil_rsubs_exp_opt(rgn,inst,_tmp5C4);
struct Cyc_Absyn_Exp*ens2=Cyc_Tcutil_rsubs_exp_opt(rgn,inst,_tmp5C3);
struct Cyc_List_List*_tmp59E=Cyc_Tcutil_extract_relns(_tmp594,req2);
struct Cyc_List_List*_tmp59F=Cyc_Tcutil_extract_relns(_tmp594,ens2);
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp5A0=_cycalloc(sizeof(*_tmp5A0));
_tmp5A0->tag=5U,(_tmp5A0->f1).tvars=_tmp5CD,(_tmp5A0->f1).effect=eff2,(_tmp5A0->f1).ret_tqual=_tmp5CB,({void*_tmpB42=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5CA);(_tmp5A0->f1).ret_type=_tmpB42;}),(_tmp5A0->f1).args=_tmp594,(_tmp5A0->f1).c_varargs=_tmp5C8,(_tmp5A0->f1).cyc_varargs=cyc_varargs2,(_tmp5A0->f1).rgn_po=rgn_po2,(_tmp5A0->f1).attributes=_tmp5C5,(_tmp5A0->f1).requires_clause=req2,(_tmp5A0->f1).requires_relns=_tmp59E,(_tmp5A0->f1).ensures_clause=ens2,(_tmp5A0->f1).ensures_relns=_tmp59F;_tmp5A0;});};};};};};case 6U: _LLB: _tmp5CE=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp57E)->f1;_LLC: {
# 3402
struct Cyc_List_List*ts2=0;
int change=0;
{struct Cyc_List_List*_tmp5A3=_tmp5CE;for(0;_tmp5A3 != 0;_tmp5A3=_tmp5A3->tl){
void*_tmp5A4=(*((struct _tuple12*)_tmp5A3->hd)).f2;
void*_tmp5A5=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5A4);
if(_tmp5A4 != _tmp5A5)
change=1;
# 3410
ts2=({struct Cyc_List_List*_tmp5A6=_region_malloc(rgn,sizeof(*_tmp5A6));_tmp5A6->hd=_tmp5A5,_tmp5A6->tl=ts2;_tmp5A6;});}}
# 3412
if(!change)
return t;{
struct Cyc_List_List*_tmp5A7=({struct Cyc_List_List*_tmpB43=_tmp5CE;((struct Cyc_List_List*(*)(struct _tuple12*(*f)(struct _tuple12*,void*),struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_map2)(Cyc_Tcutil_map2_tq,_tmpB43,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(ts2));});
return(void*)({struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmp5A8=_cycalloc(sizeof(*_tmp5A8));_tmp5A8->tag=6U,_tmp5A8->f1=_tmp5A7;_tmp5A8;});};}case 7U: _LLD: _tmp5D0=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp57E)->f1;_tmp5CF=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp57E)->f2;_LLE: {
# 3417
struct Cyc_List_List*_tmp5A9=Cyc_Tcutil_subst_aggrfields(rgn,inst,_tmp5CF);
if(_tmp5CF == _tmp5A9)return t;
return(void*)({struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_tmp5AA=_cycalloc(sizeof(*_tmp5AA));_tmp5AA->tag=7U,_tmp5AA->f1=_tmp5D0,_tmp5AA->f2=_tmp5A9;_tmp5AA;});}case 1U: _LLF: _tmp5D1=(void*)((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp57E)->f2;_LL10:
# 3421
 if(_tmp5D1 != 0)return Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5D1);else{
return t;}case 0U: if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp57E)->f2 == 0){_LL11: _tmp5D2=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp57E)->f1;_LL12:
 return t;}else{_LL13: _tmp5D4=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp57E)->f1;_tmp5D3=((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp57E)->f2;_LL14: {
# 3425
struct Cyc_List_List*_tmp5AB=Cyc_Tcutil_substs(rgn,inst,_tmp5D3);
if(_tmp5D3 == _tmp5AB)return t;else{
return(void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp5AC=_cycalloc(sizeof(*_tmp5AC));_tmp5AC->tag=0U,_tmp5AC->f1=_tmp5D4,_tmp5AC->f2=_tmp5AB;_tmp5AC;});}}}case 9U: _LL15: _tmp5D5=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp57E)->f1;_LL16: {
# 3429
struct Cyc_Absyn_Exp*_tmp5AD=Cyc_Tcutil_rsubsexp(rgn,inst,_tmp5D5);
return _tmp5AD == _tmp5D5?t:(void*)({struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_tmp5AE=_cycalloc(sizeof(*_tmp5AE));_tmp5AE->tag=9U,_tmp5AE->f1=_tmp5AD;_tmp5AE;});}case 11U: _LL17: _tmp5D6=((struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_tmp57E)->f1;_LL18: {
# 3432
struct Cyc_Absyn_Exp*_tmp5AF=Cyc_Tcutil_rsubsexp(rgn,inst,_tmp5D6);
return _tmp5AF == _tmp5D6?t:(void*)({struct Cyc_Absyn_TypeofType_Absyn_Type_struct*_tmp5B0=_cycalloc(sizeof(*_tmp5B0));_tmp5B0->tag=11U,_tmp5B0->f1=_tmp5AF;_tmp5B0;});}default: _LL19: _LL1A:
({void*_tmp5B1=0U;({struct _dyneither_ptr _tmpB44=({const char*_tmp5B2="found typedecltype in rsubs";_tag_dyneither(_tmp5B2,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB44,_tag_dyneither(_tmp5B1,sizeof(void*),0U));});});}_LL0:;}
# 3438
static struct Cyc_List_List*Cyc_Tcutil_substs(struct _RegionHandle*rgn,struct Cyc_List_List*inst,struct Cyc_List_List*ts){
# 3441
if(ts == 0)
return 0;{
void*_tmp5D7=(void*)ts->hd;
struct Cyc_List_List*_tmp5D8=ts->tl;
void*_tmp5D9=Cyc_Tcutil_rsubstitute(rgn,inst,_tmp5D7);
struct Cyc_List_List*_tmp5DA=Cyc_Tcutil_substs(rgn,inst,_tmp5D8);
if(_tmp5D7 == _tmp5D9  && _tmp5D8 == _tmp5DA)
return ts;
return({struct Cyc_List_List*_tmp5DB=_cycalloc(sizeof(*_tmp5DB));_tmp5DB->hd=_tmp5D9,_tmp5DB->tl=_tmp5DA;_tmp5DB;});};}
# 3452
...
struct Cyc_Core_Opt*_tmp5DC=Cyc_Tcutil_kind_to_opt(Cyc_Tcutil_tvar_kind(tv,& Cyc_Tcutil_bk));
return({struct _tuple15*_tmp5DE=_cycalloc(sizeof(*_tmp5DE));_tmp5DE->f1=tv,({void*_tmpB46=({struct Cyc_Core_Opt*_tmpB45=_tmp5DC;Cyc_Absyn_new_evar(_tmpB45,({struct Cyc_Core_Opt*_tmp5DD=_cycalloc(sizeof(*_tmp5DD));_tmp5DD->v=s;_tmp5DD;}));});_tmp5DE->f2=_tmpB46;});_tmp5DE;});}
# 3464
struct _tuple15*Cyc_Tcutil_r_make_inst_var(struct _tuple16*env,struct Cyc_Absyn_Tvar*tv){
# 3466
struct _tuple16*_tmp5DF=env;struct Cyc_List_List*_tmp5E4;struct _RegionHandle*_tmp5E3;_LL1: _tmp5E4=_tmp5DF->f1;_tmp5E3=_tmp5DF->f2;_LL2:;{
struct Cyc_Core_Opt*_tmp5E0=Cyc_Tcutil_kind_to_opt(Cyc_Tcutil_tvar_kind(tv,& Cyc_Tcutil_bk));
return({struct _tuple15*_tmp5E2=_region_malloc(_tmp5E3,sizeof(*_tmp5E2));_tmp5E2->f1=tv,({void*_tmpB48=({struct Cyc_Core_Opt*_tmpB47=_tmp5E0;Cyc_Absyn_new_evar(_tmpB47,({struct Cyc_Core_Opt*_tmp5E1=_cycalloc(sizeof(*_tmp5E1));_tmp5E1->v=_tmp5E4;_tmp5E1;}));});_tmp5E2->f2=_tmpB48;});_tmp5E2;});};}
# 3476
...
({struct Cyc_String_pa_PrintArg_struct _tmp5E7=({struct Cyc_String_pa_PrintArg_struct _tmp9A9;_tmp9A9.tag=0U,_tmp9A9.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*tv->name);_tmp9A9;});struct Cyc_String_pa_PrintArg_struct _tmp5E8=({struct Cyc_String_pa_PrintArg_struct _tmp9A8;_tmp9A8.tag=0U,({
struct _dyneither_ptr _tmpB49=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kindbound2string(k1));_tmp9A8.f1=_tmpB49;});_tmp9A8;});struct Cyc_String_pa_PrintArg_struct _tmp5E9=({struct Cyc_String_pa_PrintArg_struct _tmp9A7;_tmp9A7.tag=0U,({struct _dyneither_ptr _tmpB4A=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kindbound2string(k2));_tmp9A7.f1=_tmpB4A;});_tmp9A7;});void*_tmp5E5[3U];_tmp5E5[0]=& _tmp5E7,_tmp5E5[1]=& _tmp5E8,_tmp5E5[2]=& _tmp5E9;({unsigned int _tmpB4C=loc;struct _dyneither_ptr _tmpB4B=({const char*_tmp5E6="type variable %s is used with inconsistent kinds %s and %s";_tag_dyneither(_tmp5E6,sizeof(char),59U);});Cyc_Tcutil_terr(_tmpB4C,_tmpB4B,_tag_dyneither(_tmp5E5,sizeof(void*),3U));});});
if(tv->identity == - 1)
tv->identity=((struct Cyc_Absyn_Tvar*)tvs2->hd)->identity;else{
if(tv->identity != ((struct Cyc_Absyn_Tvar*)tvs2->hd)->identity)
({void*_tmp5EA=0U;({struct _dyneither_ptr _tmpB4D=({const char*_tmp5EB="same type variable has different identity!";_tag_dyneither(_tmp5EB,sizeof(char),43U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB4D,_tag_dyneither(_tmp5EA,sizeof(void*),0U));});});}
return tvs;}}}
# 3494
({int _tmpB4E=Cyc_Tcutil_new_tvar_id();tv->identity=_tmpB4E;});
return({struct Cyc_List_List*_tmp5EC=_cycalloc(sizeof(*_tmp5EC));_tmp5EC->hd=tv,_tmp5EC->tl=tvs;_tmp5EC;});}
# 3500
static struct Cyc_List_List*Cyc_Tcutil_fast_add_free_tvar(struct Cyc_List_List*tvs,struct Cyc_Absyn_Tvar*tv){
# 3502
if(tv->identity == - 1)
({void*_tmp5ED=0U;({struct _dyneither_ptr _tmpB4F=({const char*_tmp5EE="fast_add_free_tvar: bad identity in tv";_tag_dyneither(_tmp5EE,sizeof(char),39U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB4F,_tag_dyneither(_tmp5ED,sizeof(void*),0U));});});
{struct Cyc_List_List*tvs2=tvs;for(0;tvs2 != 0;tvs2=tvs2->tl){
# 3506
struct Cyc_Absyn_Tvar*_tmp5EF=(struct Cyc_Absyn_Tvar*)tvs2->hd;
if(_tmp5EF->identity == - 1)
({void*_tmp5F0=0U;({struct _dyneither_ptr _tmpB50=({const char*_tmp5F1="fast_add_free_tvar: bad identity in tvs2";_tag_dyneither(_tmp5F1,sizeof(char),41U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB50,_tag_dyneither(_tmp5F0,sizeof(void*),0U));});});
if(_tmp5EF->identity == tv->identity)
return tvs;}}
# 3513
return({struct Cyc_List_List*_tmp5F2=_cycalloc(sizeof(*_tmp5F2));_tmp5F2->hd=tv,_tmp5F2->tl=tvs;_tmp5F2;});}struct _tuple29{struct Cyc_Absyn_Tvar*f1;int f2;};
# 3519
...
# 3524
if(tv->identity == - 1)
({void*_tmp5F3=0U;({struct _dyneither_ptr _tmpB51=({const char*_tmp5F4="fast_add_free_tvar_bool: bad identity in tv";_tag_dyneither(_tmp5F4,sizeof(char),44U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB51,_tag_dyneither(_tmp5F3,sizeof(void*),0U));});});
{struct Cyc_List_List*tvs2=tvs;for(0;tvs2 != 0;tvs2=tvs2->tl){
# 3528
struct _tuple29*_tmp5F5=(struct _tuple29*)tvs2->hd;struct _tuple29*_tmp5F6=_tmp5F5;struct Cyc_Absyn_Tvar*_tmp5FA;int*_tmp5F9;_LL1: _tmp5FA=_tmp5F6->f1;_tmp5F9=(int*)& _tmp5F6->f2;_LL2:;
if(_tmp5FA->identity == - 1)
({void*_tmp5F7=0U;({struct _dyneither_ptr _tmpB52=({const char*_tmp5F8="fast_add_free_tvar_bool: bad identity in tvs2";_tag_dyneither(_tmp5F8,sizeof(char),46U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB52,_tag_dyneither(_tmp5F7,sizeof(void*),0U));});});
if(_tmp5FA->identity == tv->identity){
*_tmp5F9=*_tmp5F9  || b;
return tvs;}}}
# 3536
return({struct Cyc_List_List*_tmp5FC=_region_malloc(r,sizeof(*_tmp5FC));({struct _tuple29*_tmpB53=({struct _tuple29*_tmp5FB=_region_malloc(r,sizeof(*_tmp5FB));_tmp5FB->f1=tv,_tmp5FB->f2=b;_tmp5FB;});_tmp5FC->hd=_tmpB53;}),_tmp5FC->tl=tvs;_tmp5FC;});}
# 3540
static struct Cyc_List_List*Cyc_Tcutil_add_bound_tvar(struct Cyc_List_List*tvs,struct Cyc_Absyn_Tvar*tv){
# 3542
if(tv->identity == - 1)
({struct Cyc_String_pa_PrintArg_struct _tmp5FF=({struct Cyc_String_pa_PrintArg_struct _tmp9AA;_tmp9AA.tag=0U,({struct _dyneither_ptr _tmpB54=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_tvar2string(tv));_tmp9AA.f1=_tmpB54;});_tmp9AA;});void*_tmp5FD[1U];_tmp5FD[0]=& _tmp5FF;({struct _dyneither_ptr _tmpB55=({const char*_tmp5FE="bound tvar id for %s is NULL";_tag_dyneither(_tmp5FE,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB55,_tag_dyneither(_tmp5FD,sizeof(void*),1U));});});
return({struct Cyc_List_List*_tmp600=_cycalloc(sizeof(*_tmp600));_tmp600->hd=tv,_tmp600->tl=tvs;_tmp600;});}struct _tuple30{void*f1;int f2;};
# 3551
static struct Cyc_List_List*Cyc_Tcutil_add_free_evar(struct _RegionHandle*r,struct Cyc_List_List*es,void*e,int b){
# 3554
void*_tmp601=Cyc_Tcutil_compress(e);void*_tmp602=_tmp601;int _tmp60C;if(((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp602)->tag == 1U){_LL1: _tmp60C=((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp602)->f3;_LL2:
# 3556
{struct Cyc_List_List*es2=es;for(0;es2 != 0;es2=es2->tl){
struct _tuple30*_tmp603=(struct _tuple30*)es2->hd;struct _tuple30*_tmp604=_tmp603;void*_tmp609;int*_tmp608;_LL6: _tmp609=_tmp604->f1;_tmp608=(int*)& _tmp604->f2;_LL7:;{
void*_tmp605=Cyc_Tcutil_compress(_tmp609);void*_tmp606=_tmp605;int _tmp607;if(((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp606)->tag == 1U){_LL9: _tmp607=((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp606)->f3;_LLA:
# 3560
 if(_tmp60C == _tmp607){
if(b != *_tmp608)*_tmp608=1;
return es;}
# 3564
goto _LL8;}else{_LLB: _LLC:
 goto _LL8;}_LL8:;};}}
# 3568
return({struct Cyc_List_List*_tmp60B=_region_malloc(r,sizeof(*_tmp60B));({struct _tuple30*_tmpB56=({struct _tuple30*_tmp60A=_region_malloc(r,sizeof(*_tmp60A));_tmp60A->f1=e,_tmp60A->f2=b;_tmp60A;});_tmp60B->hd=_tmpB56;}),_tmp60B->tl=es;_tmp60B;});}else{_LL3: _LL4:
 return es;}_LL0:;}
# 3573
...
break;}}}
# 3585
if(!present)r=({struct Cyc_List_List*_tmp60D=_region_malloc(rgn,sizeof(*_tmp60D));_tmp60D->hd=(struct Cyc_Absyn_Tvar*)tvs->hd,_tmp60D->tl=r;_tmp60D;});}
# 3587
...
for(0;tvs != 0;tvs=tvs->tl){
struct _tuple29 _tmp60E=*((struct _tuple29*)tvs->hd);struct _tuple29 _tmp60F=_tmp60E;struct Cyc_Absyn_Tvar*_tmp612;int _tmp611;_LL1: _tmp612=_tmp60F.f1;_tmp611=_tmp60F.f2;_LL2:;{
int present=0;
{struct Cyc_List_List*b=btvs;for(0;b != 0;b=b->tl){
if(_tmp612->identity == ((struct Cyc_Absyn_Tvar*)b->hd)->identity){
present=1;
break;}}}
# 3606
if(!present)res=({struct Cyc_List_List*_tmp610=_region_malloc(r,sizeof(*_tmp610));_tmp610->hd=(struct _tuple29*)tvs->hd,_tmp610->tl=res;_tmp610;});};}
# 3608
...
({struct Cyc_String_pa_PrintArg_struct _tmp615=({struct Cyc_String_pa_PrintArg_struct _tmp9AB;_tmp9AB.tag=0U,_tmp9AB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*fn);_tmp9AB;});void*_tmp613[1U];_tmp613[0]=& _tmp615;({unsigned int _tmpB58=loc;struct _dyneither_ptr _tmpB57=({const char*_tmp614="bitfield %s does not have constant width";_tag_dyneither(_tmp614,sizeof(char),41U);});Cyc_Tcutil_terr(_tmpB58,_tmpB57,_tag_dyneither(_tmp613,sizeof(void*),1U));});});else{
# 3619
struct _tuple13 _tmp616=Cyc_Evexp_eval_const_uint_exp(width);struct _tuple13 _tmp617=_tmp616;unsigned int _tmp61D;int _tmp61C;_LL1: _tmp61D=_tmp617.f1;_tmp61C=_tmp617.f2;_LL2:;
if(!_tmp61C)
({void*_tmp618=0U;({unsigned int _tmpB5A=loc;struct _dyneither_ptr _tmpB59=({const char*_tmp619="cannot evaluate bitfield width at compile time";_tag_dyneither(_tmp619,sizeof(char),47U);});Cyc_Tcutil_warn(_tmpB5A,_tmpB59,_tag_dyneither(_tmp618,sizeof(void*),0U));});});
if((int)_tmp61D < 0)
({void*_tmp61A=0U;({unsigned int _tmpB5C=loc;struct _dyneither_ptr _tmpB5B=({const char*_tmp61B="bitfield has negative width";_tag_dyneither(_tmp61B,sizeof(char),28U);});Cyc_Tcutil_terr(_tmpB5C,_tmpB5B,_tag_dyneither(_tmp61A,sizeof(void*),0U));});});
w=_tmp61D;}{
# 3626
void*_tmp61E=Cyc_Tcutil_compress(field_type);void*_tmp61F=_tmp61E;enum Cyc_Absyn_Size_of _tmp62D;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp61F)->tag == 0U){if(((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp61F)->f1)->tag == 1U){_LL4: _tmp62D=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp61F)->f1)->f2;_LL5:
# 3629
{enum Cyc_Absyn_Size_of _tmp620=_tmp62D;switch(_tmp620){case Cyc_Absyn_Char_sz: _LL9: _LLA:
 if(w > (unsigned int)8)({void*_tmp621=0U;({unsigned int _tmpB5E=loc;struct _dyneither_ptr _tmpB5D=({const char*_tmp622="bitfield larger than type";_tag_dyneither(_tmp622,sizeof(char),26U);});Cyc_Tcutil_warn(_tmpB5E,_tmpB5D,_tag_dyneither(_tmp621,sizeof(void*),0U));});});goto _LL8;case Cyc_Absyn_Short_sz: _LLB: _LLC:
 if(w > (unsigned int)16)({void*_tmp623=0U;({unsigned int _tmpB60=loc;struct _dyneither_ptr _tmpB5F=({const char*_tmp624="bitfield larger than type";_tag_dyneither(_tmp624,sizeof(char),26U);});Cyc_Tcutil_warn(_tmpB60,_tmpB5F,_tag_dyneither(_tmp623,sizeof(void*),0U));});});goto _LL8;case Cyc_Absyn_Long_sz: _LLD: _LLE:
 goto _LL10;case Cyc_Absyn_Int_sz: _LLF: _LL10:
 if(w > (unsigned int)32)({void*_tmp625=0U;({unsigned int _tmpB62=loc;struct _dyneither_ptr _tmpB61=({const char*_tmp626="bitfield larger than type";_tag_dyneither(_tmp626,sizeof(char),26U);});Cyc_Tcutil_warn(_tmpB62,_tmpB61,_tag_dyneither(_tmp625,sizeof(void*),0U));});});goto _LL8;case Cyc_Absyn_LongLong_sz: _LL11: _LL12:
 goto _LL14;default: _LL13: _LL14:
 if(w > (unsigned int)64)({void*_tmp627=0U;({unsigned int _tmpB64=loc;struct _dyneither_ptr _tmpB63=({const char*_tmp628="bitfield larger than type";_tag_dyneither(_tmp628,sizeof(char),26U);});Cyc_Tcutil_warn(_tmpB64,_tmpB63,_tag_dyneither(_tmp627,sizeof(void*),0U));});});goto _LL8;}_LL8:;}
# 3637
goto _LL3;}else{goto _LL6;}}else{_LL6: _LL7:
# 3639
({struct Cyc_String_pa_PrintArg_struct _tmp62B=({struct Cyc_String_pa_PrintArg_struct _tmp9AD;_tmp9AD.tag=0U,_tmp9AD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*fn);_tmp9AD;});struct Cyc_String_pa_PrintArg_struct _tmp62C=({struct Cyc_String_pa_PrintArg_struct _tmp9AC;_tmp9AC.tag=0U,({
struct _dyneither_ptr _tmpB65=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(field_type));_tmp9AC.f1=_tmpB65;});_tmp9AC;});void*_tmp629[2U];_tmp629[0]=& _tmp62B,_tmp629[1]=& _tmp62C;({unsigned int _tmpB67=loc;struct _dyneither_ptr _tmpB66=({const char*_tmp62A="bitfield %s must have integral type but has type %s";_tag_dyneither(_tmp62A,sizeof(char),52U);});Cyc_Tcutil_terr(_tmpB67,_tmpB66,_tag_dyneither(_tmp629,sizeof(void*),2U));});});
goto _LL3;}_LL3:;};}}
# 3646
static void Cyc_Tcutil_check_field_atts(unsigned int loc,struct _dyneither_ptr*fn,struct Cyc_List_List*atts){
for(0;atts != 0;atts=atts->tl){
void*_tmp62E=(void*)atts->hd;void*_tmp62F=_tmp62E;switch(*((int*)_tmp62F)){case 7U: _LL1: _LL2:
 goto _LL4;case 6U: _LL3: _LL4:
 continue;default: _LL5: _LL6:
({struct Cyc_String_pa_PrintArg_struct _tmp632=({struct Cyc_String_pa_PrintArg_struct _tmp9AF;_tmp9AF.tag=0U,({
struct _dyneither_ptr _tmpB68=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)atts->hd));_tmp9AF.f1=_tmpB68;});_tmp9AF;});struct Cyc_String_pa_PrintArg_struct _tmp633=({struct Cyc_String_pa_PrintArg_struct _tmp9AE;_tmp9AE.tag=0U,_tmp9AE.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*fn);_tmp9AE;});void*_tmp630[2U];_tmp630[0]=& _tmp632,_tmp630[1]=& _tmp633;({unsigned int _tmpB6A=loc;struct _dyneither_ptr _tmpB69=({const char*_tmp631="bad attribute %s on member %s";_tag_dyneither(_tmp631,sizeof(char),30U);});Cyc_Tcutil_terr(_tmpB6A,_tmpB69,_tag_dyneither(_tmp630,sizeof(void*),2U));});});}_LL0:;}}struct Cyc_Tcutil_CVTEnv{struct _RegionHandle*r;struct Cyc_List_List*kind_env;struct Cyc_List_List*free_vars;struct Cyc_List_List*free_evars;int generalize_evars;int fn_result;};
# 3674
int Cyc_Tcutil_extract_const_from_typedef(unsigned int loc,int declared_const,void*t){
void*_tmp634=t;struct Cyc_Absyn_Typedefdecl*_tmp638;void*_tmp637;if(((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp634)->tag == 8U){_LL1: _tmp638=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp634)->f3;_tmp637=(void*)((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp634)->f4;_LL2:
# 3677
 if((((struct Cyc_Absyn_Typedefdecl*)_check_null(_tmp638))->tq).real_const  || (_tmp638->tq).print_const){
if(declared_const)({void*_tmp635=0U;({unsigned int _tmpB6C=loc;struct _dyneither_ptr _tmpB6B=({const char*_tmp636="extra const";_tag_dyneither(_tmp636,sizeof(char),12U);});Cyc_Tcutil_warn(_tmpB6C,_tmpB6B,_tag_dyneither(_tmp635,sizeof(void*),0U));});});
return 1;}
# 3682
if((unsigned int)_tmp637)
return Cyc_Tcutil_extract_const_from_typedef(loc,declared_const,_tmp637);else{
...
if(td != 0){
if(td->defn != 0){
void*_tmp639=Cyc_Tcutil_compress((void*)_check_null(td->defn));void*_tmp63A=_tmp639;void*_tmp63E;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp63A)->tag == 3U){_LL1: _tmp63E=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp63A)->f1).ptr_atts).rgn;_LL2:
# 3694
{void*_tmp63B=Cyc_Tcutil_compress(_tmp63E);void*_tmp63C=_tmp63B;struct Cyc_Absyn_Tvar*_tmp63D;if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp63C)->tag == 2U){_LL6: _tmp63D=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp63C)->f1;_LL7:
# 3696
 return Cyc_Absyn_tvar_cmp(tvar,_tmp63D)== 0;}else{_LL8: _LL9:
 goto _LL5;}_LL5:;}
# 3699
goto _LL0;}else{_LL3: _LL4:
 goto _LL0;}_LL0:;}}else{
...
# 3712
void*_tmp63F=Cyc_Absyn_compress_kb(tvar->kind);void*_tmp640=_tmp63F;switch(*((int*)_tmp640)){case 2U: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp640)->f2)->kind == Cyc_Absyn_RgnKind){if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp640)->f2)->aliasqual == Cyc_Absyn_Top){_LL1: _LL2:
 goto _LL4;}else{goto _LL5;}}else{goto _LL5;}case 0U: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp640)->f1)->kind == Cyc_Absyn_RgnKind){if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp640)->f1)->aliasqual == Cyc_Absyn_Top){_LL3: _LL4:
# 3721
...
({struct Cyc_String_pa_PrintArg_struct _tmp643=({struct Cyc_String_pa_PrintArg_struct _tmp9B1;_tmp9B1.tag=0U,_tmp9B1.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)clause_name);_tmp9B1;});struct Cyc_String_pa_PrintArg_struct _tmp644=({struct Cyc_String_pa_PrintArg_struct _tmp9B0;_tmp9B0.tag=0U,({
struct _dyneither_ptr _tmpB6D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(clause->topt)));_tmp9B0.f1=_tmpB6D;});_tmp9B0;});void*_tmp641[2U];_tmp641[0]=& _tmp643,_tmp641[1]=& _tmp644;({unsigned int _tmpB6F=loc;struct _dyneither_ptr _tmpB6E=({const char*_tmp642="%s clause has type %s instead of integral type";_tag_dyneither(_tmp642,sizeof(char),47U);});Cyc_Tcutil_terr(_tmpB6F,_tmpB6E,_tag_dyneither(_tmp641,sizeof(void*),2U));});});
...
({struct Cyc_String_pa_PrintArg_struct _tmp647=({struct Cyc_String_pa_PrintArg_struct _tmp9B3;_tmp9B3.tag=0U,_tmp9B3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)clause_name);_tmp9B3;});struct Cyc_String_pa_PrintArg_struct _tmp648=({struct Cyc_String_pa_PrintArg_struct _tmp9B2;_tmp9B2.tag=0U,({
struct _dyneither_ptr _tmpB70=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(clause));_tmp9B2.f1=_tmpB70;});_tmp9B2;});void*_tmp645[2U];_tmp645[0]=& _tmp647,_tmp645[1]=& _tmp648;({unsigned int _tmpB72=clause->loc;struct _dyneither_ptr _tmpB71=({const char*_tmp646="%s clause '%s' may be unsatisfiable";_tag_dyneither(_tmp646,sizeof(char),36U);});Cyc_Tcutil_terr(_tmpB72,_tmpB71,_tag_dyneither(_tmp645,sizeof(void*),2U));});});}
# 3755
...
# 3798
{union Cyc_Absyn_AggrInfo _tmp649=*info;union Cyc_Absyn_AggrInfo _tmp64A=_tmp649;struct Cyc_Absyn_Aggrdecl*_tmp66D;enum Cyc_Absyn_AggrKind _tmp66C;struct _tuple2*_tmp66B;struct Cyc_Core_Opt*_tmp66A;if((_tmp64A.UnknownAggr).tag == 1){_LL1: _tmp66C=((_tmp64A.UnknownAggr).val).f1;_tmp66B=((_tmp64A.UnknownAggr).val).f2;_tmp66A=((_tmp64A.UnknownAggr).val).f3;_LL2: {
# 3800
struct Cyc_Absyn_Aggrdecl**adp;
{struct _handler_cons _tmp64B;_push_handler(& _tmp64B);{int _tmp64D=0;if(setjmp(_tmp64B.handler))_tmp64D=1;if(!_tmp64D){
adp=Cyc_Tcenv_lookup_aggrdecl(te,loc,_tmp66B);{
struct Cyc_Absyn_Aggrdecl*_tmp64E=*adp;
if((int)_tmp64E->kind != (int)_tmp66C){
if((int)_tmp64E->kind == (int)Cyc_Absyn_StructA)
({struct Cyc_String_pa_PrintArg_struct _tmp651=({struct Cyc_String_pa_PrintArg_struct _tmp9B6;_tmp9B6.tag=0U,({
struct _dyneither_ptr _tmpB73=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp66B));_tmp9B6.f1=_tmpB73;});_tmp9B6;});struct Cyc_String_pa_PrintArg_struct _tmp652=({struct Cyc_String_pa_PrintArg_struct _tmp9B5;_tmp9B5.tag=0U,({struct _dyneither_ptr _tmpB74=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp66B));_tmp9B5.f1=_tmpB74;});_tmp9B5;});void*_tmp64F[2U];_tmp64F[0]=& _tmp651,_tmp64F[1]=& _tmp652;({unsigned int _tmpB76=loc;struct _dyneither_ptr _tmpB75=({const char*_tmp650="expecting struct %s instead of union %s";_tag_dyneither(_tmp650,sizeof(char),40U);});Cyc_Tcutil_terr(_tmpB76,_tmpB75,_tag_dyneither(_tmp64F,sizeof(void*),2U));});});else{
# 3809
({struct Cyc_String_pa_PrintArg_struct _tmp655=({struct Cyc_String_pa_PrintArg_struct _tmp9B8;_tmp9B8.tag=0U,({
struct _dyneither_ptr _tmpB77=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp66B));_tmp9B8.f1=_tmpB77;});_tmp9B8;});struct Cyc_String_pa_PrintArg_struct _tmp656=({struct Cyc_String_pa_PrintArg_struct _tmp9B7;_tmp9B7.tag=0U,({struct _dyneither_ptr _tmpB78=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp66B));_tmp9B7.f1=_tmpB78;});_tmp9B7;});void*_tmp653[2U];_tmp653[0]=& _tmp655,_tmp653[1]=& _tmp656;({unsigned int _tmpB7A=loc;struct _dyneither_ptr _tmpB79=({const char*_tmp654="expecting union %s instead of struct %s";_tag_dyneither(_tmp654,sizeof(char),40U);});Cyc_Tcutil_terr(_tmpB7A,_tmpB79,_tag_dyneither(_tmp653,sizeof(void*),2U));});});}}
# 3812
if((unsigned int)_tmp66A  && (int)_tmp66A->v){
if(!((unsigned int)_tmp64E->impl) || !((struct Cyc_Absyn_AggrdeclImpl*)_check_null(_tmp64E->impl))->tagged)
({struct Cyc_String_pa_PrintArg_struct _tmp659=({struct Cyc_String_pa_PrintArg_struct _tmp9B9;_tmp9B9.tag=0U,({
struct _dyneither_ptr _tmpB7B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp66B));_tmp9B9.f1=_tmpB7B;});_tmp9B9;});void*_tmp657[1U];_tmp657[0]=& _tmp659;({unsigned int _tmpB7D=loc;struct _dyneither_ptr _tmpB7C=({const char*_tmp658="@tagged qualfiers don't agree on union %s";_tag_dyneither(_tmp658,sizeof(char),42U);});Cyc_Tcutil_terr(_tmpB7D,_tmpB7C,_tag_dyneither(_tmp657,sizeof(void*),1U));});});}
# 3818
({union Cyc_Absyn_AggrInfo _tmpB7E=Cyc_Absyn_KnownAggr(adp);*info=_tmpB7E;});};
# 3802
;_pop_handler();}else{void*_tmp64C=(void*)_exn_thrown;void*_tmp65A=_tmp64C;void*_tmp660;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp65A)->tag == Cyc_Dict_Absent){_LL6: _LL7: {
# 3822
struct Cyc_Absyn_Aggrdecl*_tmp65B=({struct Cyc_Absyn_Aggrdecl*_tmp65F=_cycalloc(sizeof(*_tmp65F));_tmp65F->kind=_tmp66C,_tmp65F->sc=Cyc_Absyn_Extern,_tmp65F->name=_tmp66B,_tmp65F->tvs=0,_tmp65F->impl=0,_tmp65F->attributes=0,_tmp65F->expected_mem_kind=0;_tmp65F;});
Cyc_Tc_tcAggrdecl(te,loc,_tmp65B);
adp=Cyc_Tcenv_lookup_aggrdecl(te,loc,_tmp66B);
({union Cyc_Absyn_AggrInfo _tmpB7F=Cyc_Absyn_KnownAggr(adp);*info=_tmpB7F;});
# 3827
if(*targs != 0){
({struct Cyc_String_pa_PrintArg_struct _tmp65E=({struct Cyc_String_pa_PrintArg_struct _tmp9BA;_tmp9BA.tag=0U,({struct _dyneither_ptr _tmpB80=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp66B));_tmp9BA.f1=_tmpB80;});_tmp9BA;});void*_tmp65C[1U];_tmp65C[0]=& _tmp65E;({unsigned int _tmpB82=loc;struct _dyneither_ptr _tmpB81=({const char*_tmp65D="declare parameterized type %s before using";_tag_dyneither(_tmp65D,sizeof(char),43U);});Cyc_Tcutil_terr(_tmpB82,_tmpB81,_tag_dyneither(_tmp65C,sizeof(void*),1U));});});
return cvtenv;}
# 3831
goto _LL5;}}else{_LL8: _tmp660=_tmp65A;_LL9:(int)_rethrow(_tmp660);}_LL5:;}};}
# 3833
_tmp66D=*adp;goto _LL4;}}else{_LL3: _tmp66D=*(_tmp64A.KnownAggr).val;_LL4: {
# 3835
struct Cyc_List_List*tvs=_tmp66D->tvs;
struct Cyc_List_List*ts=*targs;
for(0;ts != 0  && tvs != 0;(ts=ts->tl,tvs=tvs->tl)){
struct Cyc_Absyn_Tvar*_tmp661=(struct Cyc_Absyn_Tvar*)tvs->hd;
void*_tmp662=(void*)ts->hd;
# 3843
{struct _tuple0 _tmp663=({struct _tuple0 _tmp9BB;({void*_tmpB83=Cyc_Absyn_compress_kb(_tmp661->kind);_tmp9BB.f1=_tmpB83;}),_tmp9BB.f2=_tmp662;_tmp9BB;});struct _tuple0 _tmp664=_tmp663;struct Cyc_Absyn_Tvar*_tmp665;if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp664.f1)->tag == 1U){if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp664.f2)->tag == 2U){_LLB: _tmp665=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp664.f2)->f1;_LLC:
# 3845
({struct Cyc_List_List*_tmpB84=Cyc_Tcutil_add_free_tvar(loc,cvtenv.kind_env,_tmp665);cvtenv.kind_env=_tmpB84;});
({struct Cyc_List_List*_tmpB85=Cyc_Tcutil_fast_add_free_tvar_bool(cvtenv.r,cvtenv.free_vars,_tmp665,1);cvtenv.free_vars=_tmpB85;});
...
# 3854
if(ts != 0)
({struct Cyc_String_pa_PrintArg_struct _tmp668=({struct Cyc_String_pa_PrintArg_struct _tmp9BC;_tmp9BC.tag=0U,({struct _dyneither_ptr _tmpB86=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp66D->name));_tmp9BC.f1=_tmpB86;});_tmp9BC;});void*_tmp666[1U];_tmp666[0]=& _tmp668;({unsigned int _tmpB88=loc;struct _dyneither_ptr _tmpB87=({const char*_tmp667="too many parameters for type %s";_tag_dyneither(_tmp667,sizeof(char),32U);});Cyc_Tcutil_terr(_tmpB88,_tmpB87,_tag_dyneither(_tmp666,sizeof(void*),1U));});});
if(tvs != 0){
# 3858
...
hidden_ts=({struct Cyc_List_List*_tmp669=_cycalloc(sizeof(*_tmp669));_tmp669->hd=e,_tmp669->tl=hidden_ts;_tmp669;});
...
# 3867
if((allow_abs_aggr  && _tmp66D->impl == 0) && !
Cyc_Tcutil_kind_leq(& Cyc_Tcutil_ak,expected_kind))
# 3872
_tmp66D->expected_mem_kind=1;}}_LL0:;}
# 3875
return cvtenv;}
# 3879
...
# 3885
struct Cyc_List_List*_tmp66E=*targsp;
{union Cyc_Absyn_DatatypeInfo _tmp66F=*info;union Cyc_Absyn_DatatypeInfo _tmp670=_tmp66F;struct Cyc_Absyn_Datatypedecl*_tmp687;struct _tuple2*_tmp686;int _tmp685;if((_tmp670.UnknownDatatype).tag == 1){_LL1: _tmp686=((_tmp670.UnknownDatatype).val).name;_tmp685=((_tmp670.UnknownDatatype).val).is_extensible;_LL2: {
# 3888
struct Cyc_Absyn_Datatypedecl**tudp;
{struct _handler_cons _tmp671;_push_handler(& _tmp671);{int _tmp673=0;if(setjmp(_tmp671.handler))_tmp673=1;if(!_tmp673){tudp=Cyc_Tcenv_lookup_datatypedecl(te,loc,_tmp686);;_pop_handler();}else{void*_tmp672=(void*)_exn_thrown;void*_tmp674=_tmp672;void*_tmp67A;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp674)->tag == Cyc_Dict_Absent){_LL6: _LL7: {
# 3892
struct Cyc_Absyn_Datatypedecl*_tmp675=({struct Cyc_Absyn_Datatypedecl*_tmp679=_cycalloc(sizeof(*_tmp679));_tmp679->sc=Cyc_Absyn_Extern,_tmp679->name=_tmp686,_tmp679->tvs=0,_tmp679->fields=0,_tmp679->is_extensible=_tmp685;_tmp679;});
Cyc_Tc_tcDatatypedecl(te,loc,_tmp675);
tudp=Cyc_Tcenv_lookup_datatypedecl(te,loc,_tmp686);
# 3896
if(_tmp66E != 0){
({struct Cyc_String_pa_PrintArg_struct _tmp678=({struct Cyc_String_pa_PrintArg_struct _tmp9BD;_tmp9BD.tag=0U,({
struct _dyneither_ptr _tmpB8B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp686));_tmp9BD.f1=_tmpB8B;});_tmp9BD;});void*_tmp676[1U];_tmp676[0]=& _tmp678;({unsigned int _tmpB8D=loc;struct _dyneither_ptr _tmpB8C=({const char*_tmp677="declare parameterized datatype %s before using";_tag_dyneither(_tmp677,sizeof(char),47U);});Cyc_Tcutil_terr(_tmpB8D,_tmpB8C,_tag_dyneither(_tmp676,sizeof(void*),1U));});});
return cvtenv;}
# 3901
goto _LL5;}}else{_LL8: _tmp67A=_tmp674;_LL9:(int)_rethrow(_tmp67A);}_LL5:;}};}
# 3905
if(_tmp685  && !(*tudp)->is_extensible)
({struct Cyc_String_pa_PrintArg_struct _tmp67D=({struct Cyc_String_pa_PrintArg_struct _tmp9BE;_tmp9BE.tag=0U,({struct _dyneither_ptr _tmpB8E=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp686));_tmp9BE.f1=_tmpB8E;});_tmp9BE;});void*_tmp67B[1U];_tmp67B[0]=& _tmp67D;({unsigned int _tmpB90=loc;struct _dyneither_ptr _tmpB8F=({const char*_tmp67C="datatype %s was not declared @extensible";_tag_dyneither(_tmp67C,sizeof(char),41U);});Cyc_Tcutil_terr(_tmpB90,_tmpB8F,_tag_dyneither(_tmp67B,sizeof(void*),1U));});});
({union Cyc_Absyn_DatatypeInfo _tmpB91=Cyc_Absyn_KnownDatatype(tudp);*info=_tmpB91;});
_tmp687=*tudp;goto _LL4;}}else{_LL3: _tmp687=*(_tmp670.KnownDatatype).val;_LL4: {
# 3911
struct Cyc_List_List*tvs=_tmp687->tvs;
for(0;_tmp66E != 0  && tvs != 0;(_tmp66E=_tmp66E->tl,tvs=tvs->tl)){
void*t=(void*)_tmp66E->hd;
struct Cyc_Absyn_Tvar*tv=(struct Cyc_Absyn_Tvar*)tvs->hd;
# 3917
{struct _tuple0 _tmp67E=({struct _tuple0 _tmp9BF;({void*_tmpB92=Cyc_Absyn_compress_kb(tv->kind);_tmp9BF.f1=_tmpB92;}),_tmp9BF.f2=t;_tmp9BF;});struct _tuple0 _tmp67F=_tmp67E;struct Cyc_Absyn_Tvar*_tmp680;if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp67F.f1)->tag == 1U){if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp67F.f2)->tag == 2U){_LLB: _tmp680=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp67F.f2)->f1;_LLC:
# 3919
({struct Cyc_List_List*_tmpB93=Cyc_Tcutil_add_free_tvar(loc,cvtenv.kind_env,_tmp680);cvtenv.kind_env=_tmpB93;});
({struct Cyc_List_List*_tmpB94=Cyc_Tcutil_fast_add_free_tvar_bool(cvtenv.r,cvtenv.free_vars,_tmp680,1);cvtenv.free_vars=_tmpB94;});
continue;}else{goto _LLD;}}else{_LLD: _LLE:
 goto _LLA;}_LLA:;}{
# 3924
...
# 3928
if(_tmp66E != 0)
({struct Cyc_String_pa_PrintArg_struct _tmp683=({struct Cyc_String_pa_PrintArg_struct _tmp9C0;_tmp9C0.tag=0U,({
struct _dyneither_ptr _tmpB95=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp687->name));_tmp9C0.f1=_tmpB95;});_tmp9C0;});void*_tmp681[1U];_tmp681[0]=& _tmp683;({unsigned int _tmpB97=loc;struct _dyneither_ptr _tmpB96=({const char*_tmp682="too many type arguments for datatype %s";_tag_dyneither(_tmp682,sizeof(char),40U);});Cyc_Tcutil_terr(_tmpB97,_tmpB96,_tag_dyneither(_tmp681,sizeof(void*),1U));});});
if(tvs != 0){
# 3933
struct Cyc_List_List*hidden_ts=0;
for(0;tvs != 0;tvs=tvs->tl){
...
void*e=Cyc_Absyn_new_evar(0,0);
hidden_ts=({struct Cyc_List_List*_tmp684=_cycalloc(sizeof(*_tmp684));_tmp684->hd=e,_tmp684->tl=hidden_ts;_tmp684;});
...
# 3954
{union Cyc_Absyn_DatatypeFieldInfo _tmp688=*info;union Cyc_Absyn_DatatypeFieldInfo _tmp689=_tmp688;struct Cyc_Absyn_Datatypedecl*_tmp69C;struct Cyc_Absyn_Datatypefield*_tmp69B;struct _tuple2*_tmp69A;struct _tuple2*_tmp699;int _tmp698;if((_tmp689.UnknownDatatypefield).tag == 1){_LL1: _tmp69A=((_tmp689.UnknownDatatypefield).val).datatype_name;_tmp699=((_tmp689.UnknownDatatypefield).val).field_name;_tmp698=((_tmp689.UnknownDatatypefield).val).is_extensible;_LL2: {
# 3957
struct Cyc_Absyn_Datatypedecl*tud=*Cyc_Tcenv_lookup_datatypedecl(te,loc,_tmp69A);
struct Cyc_Absyn_Datatypefield*tuf;
# 3962
{struct Cyc_List_List*_tmp68A=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(tud->fields))->v;for(0;1;_tmp68A=_tmp68A->tl){
if(_tmp68A == 0)({void*_tmp68B=0U;({struct _dyneither_ptr _tmpB9A=({const char*_tmp68C="Tcutil found a bad datatypefield";_tag_dyneither(_tmp68C,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpB9A,_tag_dyneither(_tmp68B,sizeof(void*),0U));});});
if(Cyc_Absyn_qvar_cmp(((struct Cyc_Absyn_Datatypefield*)_tmp68A->hd)->name,_tmp699)== 0){
tuf=(struct Cyc_Absyn_Datatypefield*)_tmp68A->hd;
break;}}}
# 3969
({union Cyc_Absyn_DatatypeFieldInfo _tmpB9B=Cyc_Absyn_KnownDatatypefield(tud,tuf);*info=_tmpB9B;});
_tmp69C=tud;_tmp69B=tuf;goto _LL4;}}else{_LL3: _tmp69C=((_tmp689.KnownDatatypefield).val).f1;_tmp69B=((_tmp689.KnownDatatypefield).val).f2;_LL4: {
# 3973
...
struct Cyc_Absyn_Tvar*tv=(struct Cyc_Absyn_Tvar*)tvs->hd;
# 3979
{struct _tuple0 _tmp68D=({struct _tuple0 _tmp9C1;({void*_tmpB9C=Cyc_Absyn_compress_kb(tv->kind);_tmp9C1.f1=_tmpB9C;}),_tmp9C1.f2=t;_tmp9C1;});struct _tuple0 _tmp68E=_tmp68D;struct Cyc_Absyn_Tvar*_tmp68F;if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp68E.f1)->tag == 1U){if(((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp68E.f2)->tag == 2U){_LL6: _tmp68F=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp68E.f2)->f1;_LL7:
# 3981
({struct Cyc_List_List*_tmpB9D=Cyc_Tcutil_add_free_tvar(loc,cvtenv.kind_env,_tmp68F);cvtenv.kind_env=_tmpB9D;});
({struct Cyc_List_List*_tmpB9E=Cyc_Tcutil_fast_add_free_tvar_bool(cvtenv.r,cvtenv.free_vars,_tmp68F,1);cvtenv.free_vars=_tmpB9E;});
...
# 3990
if(targs != 0)
({struct Cyc_String_pa_PrintArg_struct _tmp692=({struct Cyc_String_pa_PrintArg_struct _tmp9C3;_tmp9C3.tag=0U,({
struct _dyneither_ptr _tmpB9F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp69C->name));_tmp9C3.f1=_tmpB9F;});_tmp9C3;});struct Cyc_String_pa_PrintArg_struct _tmp693=({struct Cyc_String_pa_PrintArg_struct _tmp9C2;_tmp9C2.tag=0U,({struct _dyneither_ptr _tmpBA0=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp69B->name));_tmp9C2.f1=_tmpBA0;});_tmp9C2;});void*_tmp690[2U];_tmp690[0]=& _tmp692,_tmp690[1]=& _tmp693;({unsigned int _tmpBA2=loc;struct _dyneither_ptr _tmpBA1=({const char*_tmp691="too many type arguments for datatype %s.%s";_tag_dyneither(_tmp691,sizeof(char),43U);});Cyc_Tcutil_terr(_tmpBA2,_tmpBA1,_tag_dyneither(_tmp690,sizeof(void*),2U));});});
if(tvs != 0)
({struct Cyc_String_pa_PrintArg_struct _tmp696=({struct Cyc_String_pa_PrintArg_struct _tmp9C5;_tmp9C5.tag=0U,({
struct _dyneither_ptr _tmpBA3=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp69C->name));_tmp9C5.f1=_tmpBA3;});_tmp9C5;});struct Cyc_String_pa_PrintArg_struct _tmp697=({struct Cyc_String_pa_PrintArg_struct _tmp9C4;_tmp9C4.tag=0U,({struct _dyneither_ptr _tmpBA4=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp69B->name));_tmp9C4.f1=_tmpBA4;});_tmp9C4;});void*_tmp694[2U];_tmp694[0]=& _tmp696,_tmp694[1]=& _tmp697;({unsigned int _tmpBA6=loc;struct _dyneither_ptr _tmpBA5=({const char*_tmp695="too few type arguments for datatype %s.%s";_tag_dyneither(_tmp695,sizeof(char),42U);});Cyc_Tcutil_terr(_tmpBA6,_tmpBA5,_tag_dyneither(_tmp694,sizeof(void*),2U));});});
goto _LL0;}}_LL0:;}
# 3998
return cvtenv;}
# 4001
...
# 4006
struct Cyc_List_List*_tmp69D=*targsp;
{void*_tmp69E=c;union Cyc_Absyn_DatatypeFieldInfo*_tmp6C5;union Cyc_Absyn_DatatypeInfo*_tmp6C4;union Cyc_Absyn_AggrInfo*_tmp6C3;struct Cyc_List_List*_tmp6C2;struct _tuple2*_tmp6C1;struct Cyc_Absyn_Enumdecl**_tmp6C0;switch(*((int*)_tmp69E)){case 1U: _LL1: _LL2:
# 4009
...
# 4013
 if(_tmp69D != 0)({struct Cyc_String_pa_PrintArg_struct _tmp6A1=({struct Cyc_String_pa_PrintArg_struct _tmp9C6;_tmp9C6.tag=0U,({
struct _dyneither_ptr _tmpBA7=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)({struct Cyc_Absyn_AppType_Absyn_Type_struct*_tmp6A2=_cycalloc(sizeof(*_tmp6A2));_tmp6A2->tag=0U,_tmp6A2->f1=c,_tmp6A2->f2=_tmp69D;_tmp6A2;})));_tmp9C6.f1=_tmpBA7;});_tmp9C6;});void*_tmp69F[1U];_tmp69F[0]=& _tmp6A1;({struct _dyneither_ptr _tmpBA8=({const char*_tmp6A0="%s applied to argument(s)";_tag_dyneither(_tmp6A0,sizeof(char),26U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpBA8,_tag_dyneither(_tmp69F,sizeof(void*),1U));});});
goto _LL0;case 9U: _LL15: _LL16:
# 4017
 for(0;_tmp69D != 0;_tmp69D=_tmp69D->tl){
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_ek,(void*)_tmp69D->hd,1,1);}
goto _LL0;case 4U: _LL17: _LL18:
# 4021
 if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp69D)!= 1)({void*_tmp6A3=0U;({struct _dyneither_ptr _tmpBA9=({const char*_tmp6A4="tag_t applied to wrong number of arguments";_tag_dyneither(_tmp6A4,sizeof(char),43U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpBA9,_tag_dyneither(_tmp6A3,sizeof(void*),0U));});});
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_ik,(void*)((struct Cyc_List_List*)_check_null(_tmp69D))->hd,0,1);goto _LL0;case 15U: _LL19: _tmp6C1=((struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*)_tmp69E)->f1;_tmp6C0=(struct Cyc_Absyn_Enumdecl**)&((struct Cyc_Absyn_EnumCon_Absyn_TyCon_struct*)_tmp69E)->f2;_LL1A:
# 4024
 if(_tmp69D != 0)({void*_tmp6A5=0U;({struct _dyneither_ptr _tmpBAA=({const char*_tmp6A6="enum applied to argument(s)";_tag_dyneither(_tmp6A6,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpBAA,_tag_dyneither(_tmp6A5,sizeof(void*),0U));});});
if(*_tmp6C0 == 0  || ((struct Cyc_Absyn_Enumdecl*)_check_null(*_tmp6C0))->fields == 0){
struct _handler_cons _tmp6A7;_push_handler(& _tmp6A7);{int _tmp6A9=0;if(setjmp(_tmp6A7.handler))_tmp6A9=1;if(!_tmp6A9){
{struct Cyc_Absyn_Enumdecl**ed=Cyc_Tcenv_lookup_enumdecl(te,loc,_tmp6C1);
*_tmp6C0=*ed;}
# 4027
;_pop_handler();}else{void*_tmp6A8=(void*)_exn_thrown;void*_tmp6AA=_tmp6A8;void*_tmp6AD;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp6AA)->tag == Cyc_Dict_Absent){_LL2C: _LL2D: {
# 4031
struct Cyc_Absyn_Enumdecl*_tmp6AB=({struct Cyc_Absyn_Enumdecl*_tmp6AC=_cycalloc(sizeof(*_tmp6AC));_tmp6AC->sc=Cyc_Absyn_Extern,_tmp6AC->name=_tmp6C1,_tmp6AC->fields=0;_tmp6AC;});
Cyc_Tc_tcEnumdecl(te,loc,_tmp6AB);{
struct Cyc_Absyn_Enumdecl**ed=Cyc_Tcenv_lookup_enumdecl(te,loc,_tmp6C1);
*_tmp6C0=*ed;
goto _LL2B;};}}else{_LL2E: _tmp6AD=_tmp6AA;_LL2F:(int)_rethrow(_tmp6AD);}_LL2B:;}};}
# 4037
goto _LL0;case 16U: _LL1B: _tmp6C2=((struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*)_tmp69E)->f1;_LL1C:
# 4039
 if(_tmp69D != 0)({void*_tmp6AE=0U;({struct _dyneither_ptr _tmpBAB=({const char*_tmp6AF="enum applied to argument(s)";_tag_dyneither(_tmp6AF,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpBAB,_tag_dyneither(_tmp6AE,sizeof(void*),0U));});});{
# 4041
struct Cyc_List_List*prev_fields=0;
unsigned int tag_count=0U;
for(0;_tmp6C2 != 0;_tmp6C2=_tmp6C2->tl){
struct Cyc_Absyn_Enumfield*_tmp6B0=(struct Cyc_Absyn_Enumfield*)_tmp6C2->hd;
if(((int(*)(int(*compare)(struct _dyneither_ptr*,struct _dyneither_ptr*),struct Cyc_List_List*l,struct _dyneither_ptr*x))Cyc_List_mem)(Cyc_strptrcmp,prev_fields,(*_tmp6B0->name).f2))
({struct Cyc_String_pa_PrintArg_struct _tmp6B3=({struct Cyc_String_pa_PrintArg_struct _tmp9C7;_tmp9C7.tag=0U,_tmp9C7.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp6B0->name).f2);_tmp9C7;});void*_tmp6B1[1U];_tmp6B1[0]=& _tmp6B3;({unsigned int _tmpBAD=_tmp6B0->loc;struct _dyneither_ptr _tmpBAC=({const char*_tmp6B2="duplicate enum field name %s";_tag_dyneither(_tmp6B2,sizeof(char),29U);});Cyc_Tcutil_terr(_tmpBAD,_tmpBAC,_tag_dyneither(_tmp6B1,sizeof(void*),1U));});});else{
# 4048
prev_fields=({struct Cyc_List_List*_tmp6B4=_cycalloc(sizeof(*_tmp6B4));_tmp6B4->hd=(*_tmp6B0->name).f2,_tmp6B4->tl=prev_fields;_tmp6B4;});}
if(_tmp6B0->tag == 0)
({struct Cyc_Absyn_Exp*_tmpBAE=Cyc_Absyn_uint_exp(tag_count,_tmp6B0->loc);_tmp6B0->tag=_tmpBAE;});else{
if(!Cyc_Tcutil_is_const_exp((struct Cyc_Absyn_Exp*)_check_null(_tmp6B0->tag)))
({struct Cyc_String_pa_PrintArg_struct _tmp6B7=({struct Cyc_String_pa_PrintArg_struct _tmp9C8;_tmp9C8.tag=0U,_tmp9C8.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*_tmp6B0->name).f2);_tmp9C8;});void*_tmp6B5[1U];_tmp6B5[0]=& _tmp6B7;({unsigned int _tmpBB0=loc;struct _dyneither_ptr _tmpBAF=({const char*_tmp6B6="enum field %s: expression is not constant";_tag_dyneither(_tmp6B6,sizeof(char),42U);});Cyc_Tcutil_terr(_tmpBB0,_tmpBAF,_tag_dyneither(_tmp6B5,sizeof(void*),1U));});});}{
unsigned int t1=(Cyc_Evexp_eval_const_uint_exp((struct Cyc_Absyn_Exp*)_check_null(_tmp6B0->tag))).f1;
tag_count=t1 + (unsigned int)1;};}
# 4056
goto _LL0;};case 10U: _LL1D: _LL1E:
# 4058
 if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp69D)!= 1)({void*_tmp6B8=0U;({struct _dyneither_ptr _tmpBB1=({const char*_tmp6B9="regions has wrong number of arguments";_tag_dyneither(_tmp6B9,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpBB1,_tag_dyneither(_tmp6B8,sizeof(void*),0U));});});
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_tak,(void*)((struct Cyc_List_List*)_check_null(_tmp69D))->hd,1,1);goto _LL0;case 3U: _LL1F: _LL20:
# 4061
 if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp69D)!= 1)({void*_tmp6BA=0U;({struct _dyneither_ptr _tmpBB2=({const char*_tmp6BB="region_t has wrong number of arguments";_tag_dyneither(_tmp6BB,sizeof(char),39U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpBB2,_tag_dyneither(_tmp6BA,sizeof(void*),0U));});});
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_trk,(void*)((struct Cyc_List_List*)_check_null(_tmp69D))->hd,1,1);
goto _LL0;case 13U: _LL21: _LL22:
# 4065
 if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp69D)!= 1)({void*_tmp6BC=0U;({struct _dyneither_ptr _tmpBB3=({const char*_tmp6BD="@thin has wrong number of arguments";_tag_dyneither(_tmp6BD,sizeof(char),36U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpBB3,_tag_dyneither(_tmp6BC,sizeof(void*),0U));});});
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_ik,(void*)((struct Cyc_List_List*)_check_null(_tmp69D))->hd,0,1);
goto _LL0;case 8U: _LL23: _LL24:
# 4069
 if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp69D)!= 1)({void*_tmp6BE=0U;({struct _dyneither_ptr _tmpBB4=({const char*_tmp6BF="access has wrong number of arguments";_tag_dyneither(_tmp6BF,sizeof(char),37U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpBB4,_tag_dyneither(_tmp6BE,sizeof(void*),0U));});});
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_trk,(void*)((struct Cyc_List_List*)_check_null(_tmp69D))->hd,1,1);goto _LL0;case 20U: _LL25: _tmp6C3=(union Cyc_Absyn_AggrInfo*)&((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_tmp69E)->f1;_LL26:
# 4072
 cvtenv=Cyc_Tcutil_i_check_valid_aggr(loc,te,cvtenv,expected_kind,_tmp6C3,targsp,allow_abs_aggr);
# 4074
goto _LL0;case 18U: _LL27: _tmp6C4=(union Cyc_Absyn_DatatypeInfo*)&((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)_tmp69E)->f1;_LL28:
# 4076
 cvtenv=Cyc_Tcutil_i_check_valid_datatype(loc,te,cvtenv,expected_kind,_tmp6C4,targsp,allow_abs_aggr);
# 4078
goto _LL0;default: _LL29: _tmp6C5=(union Cyc_Absyn_DatatypeFieldInfo*)&((struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*)_tmp69E)->f1;_LL2A:
# 4080
 cvtenv=Cyc_Tcutil_i_check_valid_datatype_field(loc,te,cvtenv,expected_kind,_tmp6C5,_tmp69D,allow_abs_aggr);
# 4082
goto _LL0;}_LL0:;}
# 4084
...
static struct Cyc_Tcutil_CVTEnv Cyc_Tcutil_i_check_valid_type(unsigned int loc,struct Cyc_Tcenv_Tenv*te,struct Cyc_Tcutil_CVTEnv cvtenv,struct Cyc_Absyn_Kind*expected_kind,void*t,int put_in_effect,int allow_abs_aggr){
# 4096
{void*_tmp6C6=Cyc_Tcutil_compress(t);void*_tmp6C7=_tmp6C6;struct _tuple2*_tmp7CB;struct Cyc_List_List**_tmp7CA;struct Cyc_Absyn_Typedefdecl**_tmp7C9;void**_tmp7C8;enum Cyc_Absyn_AggrKind _tmp7C7;struct Cyc_List_List*_tmp7C6;struct Cyc_List_List*_tmp7C5;struct Cyc_List_List**_tmp7C4;void**_tmp7C3;struct Cyc_Absyn_Tqual*_tmp7C2;void*_tmp7C1;struct Cyc_List_List*_tmp7C0;int _tmp7BF;struct Cyc_Absyn_VarargInfo*_tmp7BE;struct Cyc_List_List*_tmp7BD;struct Cyc_List_List*_tmp7BC;struct Cyc_Absyn_Exp*_tmp7BB;struct Cyc_List_List**_tmp7BA;struct Cyc_Absyn_Exp*_tmp7B9;struct Cyc_List_List**_tmp7B8;void*_tmp7B7;struct Cyc_Absyn_Tqual*_tmp7B6;struct Cyc_Absyn_Exp**_tmp7B5;void*_tmp7B4;unsigned int _tmp7B3;struct Cyc_Absyn_Exp*_tmp7B2;struct Cyc_Absyn_Exp*_tmp7B1;void*_tmp7B0;struct Cyc_Absyn_Tqual*_tmp7AF;void*_tmp7AE;void*_tmp7AD;void*_tmp7AC;void*_tmp7AB;void*_tmp7AA;void***_tmp7A9;struct Cyc_Absyn_Tvar*_tmp7A8;struct Cyc_Core_Opt**_tmp7A7;void**_tmp7A6;void*_tmp7A5;struct Cyc_List_List**_tmp7A4;switch(*((int*)_tmp6C7)){case 0U: _LL1: _tmp7A5=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp6C7)->f1;_tmp7A4=(struct Cyc_List_List**)&((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp6C7)->f2;_LL2:
# 4098
 cvtenv=Cyc_Tcutil_i_check_valid_type_app(loc,te,cvtenv,expected_kind,_tmp7A5,_tmp7A4,put_in_effect,allow_abs_aggr);
# 4100
goto _LL0;case 1U: _LL3: _tmp7A7=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp6C7)->f1;_tmp7A6=(void**)&((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp6C7)->f2;_LL4:
# 4103
 if(*_tmp7A7 == 0  || 
Cyc_Tcutil_kind_leq(expected_kind,(struct Cyc_Absyn_Kind*)((struct Cyc_Core_Opt*)_check_null(*_tmp7A7))->v) && !Cyc_Tcutil_kind_leq((struct Cyc_Absyn_Kind*)((struct Cyc_Core_Opt*)_check_null(*_tmp7A7))->v,expected_kind))
({struct Cyc_Core_Opt*_tmpBB5=Cyc_Tcutil_kind_to_opt(expected_kind);*_tmp7A7=_tmpBB5;});
if(((cvtenv.fn_result  && cvtenv.generalize_evars) && (int)expected_kind->kind == (int)Cyc_Absyn_RgnKind) && !te->tempest_generalize){
# 4108
if((int)expected_kind->aliasqual == (int)Cyc_Absyn_Unique)
*_tmp7A6=Cyc_Absyn_unique_rgn_type;else{
# 4111
*_tmp7A6=Cyc_Absyn_heap_rgn_type;}}else{
if((cvtenv.generalize_evars  && (int)expected_kind->kind != (int)Cyc_Absyn_BoolKind) && (int)expected_kind->kind != (int)Cyc_Absyn_PtrBndKind){
# 4115
struct Cyc_Absyn_Tvar*_tmp6C8=Cyc_Tcutil_new_tvar((void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp6C9=_cycalloc(sizeof(*_tmp6C9));_tmp6C9->tag=2U,_tmp6C9->f1=0,_tmp6C9->f2=expected_kind;_tmp6C9;}));
({void*_tmpBB6=Cyc_Absyn_var_type(_tmp6C8);*_tmp7A6=_tmpBB6;});
_tmp7A8=_tmp6C8;goto _LL6;}else{
# 4119
...
# 4121
goto _LL0;case 2U: _LL5: _tmp7A8=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmp6C7)->f1;_LL6:
# 4123
{void*_tmp6CA=Cyc_Absyn_compress_kb(_tmp7A8->kind);void*_tmp6CB=_tmp6CA;struct Cyc_Core_Opt**_tmp6CE;if(((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp6CB)->tag == 1U){_LL1A: _tmp6CE=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp6CB)->f1;_LL1B:
# 4125
({struct Cyc_Core_Opt*_tmpBB9=({struct Cyc_Core_Opt*_tmp6CD=_cycalloc(sizeof(*_tmp6CD));({void*_tmpBB8=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp6CC=_cycalloc(sizeof(*_tmp6CC));_tmp6CC->tag=2U,_tmp6CC->f1=0,_tmp6CC->f2=expected_kind;_tmp6CC;});_tmp6CD->v=_tmpBB8;});_tmp6CD;});*_tmp6CE=_tmpBB9;});goto _LL19;}else{_LL1C: _LL1D:
 goto _LL19;}_LL19:;}
# 4130
({struct Cyc_List_List*_tmpBBA=Cyc_Tcutil_add_free_tvar(loc,cvtenv.kind_env,_tmp7A8);cvtenv.kind_env=_tmpBBA;});
# 4133
({struct Cyc_List_List*_tmpBBB=Cyc_Tcutil_fast_add_free_tvar_bool(cvtenv.r,cvtenv.free_vars,_tmp7A8,put_in_effect);cvtenv.free_vars=_tmpBBB;});
# 4135
{void*_tmp6CF=Cyc_Absyn_compress_kb(_tmp7A8->kind);void*_tmp6D0=_tmp6CF;struct Cyc_Core_Opt**_tmp6D4;struct Cyc_Absyn_Kind*_tmp6D3;if(((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp6D0)->tag == 2U){_LL1F: _tmp6D4=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp6D0)->f1;_tmp6D3=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp6D0)->f2;_LL20:
# 4137
 if(Cyc_Tcutil_kind_leq(expected_kind,_tmp6D3))
({struct Cyc_Core_Opt*_tmpBBD=({struct Cyc_Core_Opt*_tmp6D2=_cycalloc(sizeof(*_tmp6D2));({void*_tmpBBC=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp6D1=_cycalloc(sizeof(*_tmp6D1));_tmp6D1->tag=2U,_tmp6D1->f1=0,_tmp6D1->f2=expected_kind;_tmp6D1;});_tmp6D2->v=_tmpBBC;});_tmp6D2;});*_tmp6D4=_tmpBBD;});
goto _LL1E;}else{_LL21: _LL22:
 goto _LL1E;}_LL1E:;}
# 4142
goto _LL0;case 10U: _LL7: _tmp7AA=(((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp6C7)->f1)->r;_tmp7A9=(void***)&((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp6C7)->f2;_LL8: {
# 4148
void*new_t=Cyc_Tcutil_copy_type(Cyc_Tcutil_compress(t));
{void*_tmp6D5=_tmp7AA;struct Cyc_Absyn_Datatypedecl*_tmp6D8;struct Cyc_Absyn_Enumdecl*_tmp6D7;struct Cyc_Absyn_Aggrdecl*_tmp6D6;switch(*((int*)_tmp6D5)){case 0U: _LL24: _tmp6D6=((struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)_tmp6D5)->f1;_LL25:
# 4151
 if(te->in_extern_c_include)
_tmp6D6->sc=Cyc_Absyn_ExternC;
Cyc_Tc_tcAggrdecl(te,loc,_tmp6D6);goto _LL23;case 1U: _LL26: _tmp6D7=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)_tmp6D5)->f1;_LL27:
# 4155
 if(te->in_extern_c_include)
_tmp6D7->sc=Cyc_Absyn_ExternC;
Cyc_Tc_tcEnumdecl(te,loc,_tmp6D7);goto _LL23;default: _LL28: _tmp6D8=((struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)_tmp6D5)->f1;_LL29:
# 4159
 Cyc_Tc_tcDatatypedecl(te,loc,_tmp6D8);goto _LL23;}_LL23:;}
# 4161
({void**_tmpBBE=({void**_tmp6D9=_cycalloc(sizeof(*_tmp6D9));*_tmp6D9=new_t;_tmp6D9;});*_tmp7A9=_tmpBBE;});
return Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,expected_kind,new_t,put_in_effect,allow_abs_aggr);}case 3U: _LL9: _tmp7B0=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp6C7)->f1).elt_type;_tmp7AF=(struct Cyc_Absyn_Tqual*)&(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp6C7)->f1).elt_tq;_tmp7AE=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp6C7)->f1).ptr_atts).rgn;_tmp7AD=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp6C7)->f1).ptr_atts).nullable;_tmp7AC=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp6C7)->f1).ptr_atts).bounds;_tmp7AB=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp6C7)->f1).ptr_atts).zero_term;_LLA: {
# 4167
int is_zero_terminated;
# 4169
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_tak,_tmp7B0,1,1);
({int _tmpBBF=Cyc_Tcutil_extract_const_from_typedef(loc,_tmp7AF->print_const,_tmp7B0);_tmp7AF->real_const=_tmpBBF;});{
struct Cyc_Absyn_Kind*k;
{enum Cyc_Absyn_AliasQual _tmp6DA=expected_kind->aliasqual;enum Cyc_Absyn_AliasQual _tmp6DB=_tmp6DA;switch(_tmp6DB){case Cyc_Absyn_Aliasable: _LL2B: _LL2C:
...
# 4178
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,k,_tmp7AE,1,1);
# 4181
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_boolk,_tmp7AB,0,1);
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_boolk,_tmp7AD,0,1);
({void*_tmpBC0=_tmp7AB;Cyc_Tcutil_unify(_tmpBC0,Cyc_Tcutil_is_char_type(_tmp7B0)?Cyc_Absyn_true_type: Cyc_Absyn_false_type);});
is_zero_terminated=Cyc_Absyn_type2bool(0,_tmp7AB);
if(is_zero_terminated){
# 4187
if(!Cyc_Tcutil_admits_zero(_tmp7B0))
({struct Cyc_String_pa_PrintArg_struct _tmp6DE=({struct Cyc_String_pa_PrintArg_struct _tmp9C9;_tmp9C9.tag=0U,({
struct _dyneither_ptr _tmpBC1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp7B0));_tmp9C9.f1=_tmpBC1;});_tmp9C9;});void*_tmp6DC[1U];_tmp6DC[0]=& _tmp6DE;({unsigned int _tmpBC3=loc;struct _dyneither_ptr _tmpBC2=({const char*_tmp6DD="cannot have a pointer to zero-terminated %s elements";_tag_dyneither(_tmp6DD,sizeof(char),53U);});Cyc_Tcutil_terr(_tmpBC3,_tmpBC2,_tag_dyneither(_tmp6DC,sizeof(void*),1U));});});}
# 4192
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_ptrbk,_tmp7AC,0,allow_abs_aggr);{
struct Cyc_Absyn_Exp*_tmp6DF=({void*_tmpBC4=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmpBC4,_tmp7AC);});
if(_tmp6DF != 0){
struct _tuple13 _tmp6E0=Cyc_Evexp_eval_const_uint_exp(_tmp6DF);struct _tuple13 _tmp6E1=_tmp6E0;unsigned int _tmp6E5;int _tmp6E4;_LL34: _tmp6E5=_tmp6E1.f1;_tmp6E4=_tmp6E1.f2;_LL35:;
if(is_zero_terminated  && (!_tmp6E4  || _tmp6E5 < (unsigned int)1))
({void*_tmp6E2=0U;({unsigned int _tmpBC6=loc;struct _dyneither_ptr _tmpBC5=({const char*_tmp6E3="zero-terminated pointer cannot point to empty sequence";_tag_dyneither(_tmp6E3,sizeof(char),55U);});Cyc_Tcutil_terr(_tmpBC6,_tmpBC5,_tag_dyneither(_tmp6E2,sizeof(void*),0U));});});}
# 4199
goto _LL0;};};}case 9U: _LLB: _tmp7B1=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp6C7)->f1;_LLC:
# 4204
({struct Cyc_Tcenv_Tenv*_tmpBC7=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmpBC7,0,_tmp7B1);});
if(!Cyc_Tcutil_coerce_uint_type(te,_tmp7B1))
({void*_tmp6E6=0U;({unsigned int _tmpBC9=loc;struct _dyneither_ptr _tmpBC8=({const char*_tmp6E7="valueof_t requires an int expression";_tag_dyneither(_tmp6E7,sizeof(char),37U);});Cyc_Tcutil_terr(_tmpBC9,_tmpBC8,_tag_dyneither(_tmp6E6,sizeof(void*),0U));});});
cvtenv=Cyc_Tcutil_i_check_valid_type_level_exp(_tmp7B1,te,cvtenv);
goto _LL0;case 11U: _LLD: _tmp7B2=((struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_tmp6C7)->f1;_LLE:
# 4213
({struct Cyc_Tcenv_Tenv*_tmpBCA=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmpBCA,0,_tmp7B2);});
goto _LL0;case 4U: _LLF: _tmp7B7=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp6C7)->f1).elt_type;_tmp7B6=(struct Cyc_Absyn_Tqual*)&(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp6C7)->f1).tq;_tmp7B5=(struct Cyc_Absyn_Exp**)&(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp6C7)->f1).num_elts;_tmp7B4=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp6C7)->f1).zero_term;_tmp7B3=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp6C7)->f1).zt_loc;_LL10: {
# 4218
struct Cyc_Absyn_Exp*_tmp6E8=*_tmp7B5;
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_tmk,_tmp7B7,1,allow_abs_aggr);
({int _tmpBCB=Cyc_Tcutil_extract_const_from_typedef(loc,_tmp7B6->print_const,_tmp7B7);_tmp7B6->real_const=_tmpBCB;});{
# 4222
int is_zero_terminated=Cyc_Tcutil_force_type2bool(0,_tmp7B4);
if(is_zero_terminated){
# 4225
if(!Cyc_Tcutil_admits_zero(_tmp7B7))
({struct Cyc_String_pa_PrintArg_struct _tmp6EB=({struct Cyc_String_pa_PrintArg_struct _tmp9CA;_tmp9CA.tag=0U,({
struct _dyneither_ptr _tmpBCC=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp7B7));_tmp9CA.f1=_tmpBCC;});_tmp9CA;});void*_tmp6E9[1U];_tmp6E9[0]=& _tmp6EB;({unsigned int _tmpBCE=loc;struct _dyneither_ptr _tmpBCD=({const char*_tmp6EA="cannot have a zero-terminated array of %s elements";_tag_dyneither(_tmp6EA,sizeof(char),51U);});Cyc_Tcutil_terr(_tmpBCE,_tmpBCD,_tag_dyneither(_tmp6E9,sizeof(void*),1U));});});}
# 4231
if(_tmp6E8 == 0){
# 4233
if(is_zero_terminated)
# 4235
({struct Cyc_Absyn_Exp*_tmpBCF=_tmp6E8=Cyc_Absyn_uint_exp(1U,0U);*_tmp7B5=_tmpBCF;});else{
# 4238
({void*_tmp6EC=0U;({unsigned int _tmpBD1=loc;struct _dyneither_ptr _tmpBD0=({const char*_tmp6ED="array bound defaults to 1 here";_tag_dyneither(_tmp6ED,sizeof(char),31U);});Cyc_Tcutil_warn(_tmpBD1,_tmpBD0,_tag_dyneither(_tmp6EC,sizeof(void*),0U));});});
({struct Cyc_Absyn_Exp*_tmpBD2=_tmp6E8=Cyc_Absyn_uint_exp(1U,0U);*_tmp7B5=_tmpBD2;});}}
# 4242
({struct Cyc_Tcenv_Tenv*_tmpBD3=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmpBD3,0,_tmp6E8);});
if(!Cyc_Tcutil_coerce_uint_type(te,_tmp6E8))
({void*_tmp6EE=0U;({unsigned int _tmpBD5=loc;struct _dyneither_ptr _tmpBD4=({const char*_tmp6EF="array bounds expression is not an unsigned int";_tag_dyneither(_tmp6EF,sizeof(char),47U);});Cyc_Tcutil_terr(_tmpBD5,_tmpBD4,_tag_dyneither(_tmp6EE,sizeof(void*),0U));});});
cvtenv=Cyc_Tcutil_i_check_valid_type_level_exp(_tmp6E8,te,cvtenv);{
# 4250
struct _tuple13 _tmp6F0=Cyc_Evexp_eval_const_uint_exp(_tmp6E8);struct _tuple13 _tmp6F1=_tmp6F0;unsigned int _tmp6F7;int _tmp6F6;_LL37: _tmp6F7=_tmp6F1.f1;_tmp6F6=_tmp6F1.f2;_LL38:;
# 4252
if((is_zero_terminated  && _tmp6F6) && _tmp6F7 < (unsigned int)1)
({void*_tmp6F2=0U;({unsigned int _tmpBD7=loc;struct _dyneither_ptr _tmpBD6=({const char*_tmp6F3="zero terminated array cannot have zero elements";_tag_dyneither(_tmp6F3,sizeof(char),48U);});Cyc_Tcutil_warn(_tmpBD7,_tmpBD6,_tag_dyneither(_tmp6F2,sizeof(void*),0U));});});
# 4255
if((_tmp6F6  && _tmp6F7 < (unsigned int)1) && Cyc_Cyclone_tovc_r){
({void*_tmp6F4=0U;({unsigned int _tmpBD9=loc;struct _dyneither_ptr _tmpBD8=({const char*_tmp6F5="arrays with 0 elements are not supported except with gcc -- changing to 1.";_tag_dyneither(_tmp6F5,sizeof(char),75U);});Cyc_Tcutil_warn(_tmpBD9,_tmpBD8,_tag_dyneither(_tmp6F4,sizeof(void*),0U));});});
({struct Cyc_Absyn_Exp*_tmpBDA=Cyc_Absyn_uint_exp(1U,0U);*_tmp7B5=_tmpBDA;});}
# 4259
goto _LL0;};};}case 5U: _LL11: _tmp7C4=(struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).tvars;_tmp7C3=(void**)&(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).effect;_tmp7C2=(struct Cyc_Absyn_Tqual*)&(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).ret_tqual;_tmp7C1=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).ret_type;_tmp7C0=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).args;_tmp7BF=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).c_varargs;_tmp7BE=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).cyc_varargs;_tmp7BD=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).rgn_po;_tmp7BC=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).attributes;_tmp7BB=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).requires_clause;_tmp7BA=(struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).requires_relns;_tmp7B9=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).ensures_clause;_tmp7B8=(struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp6C7)->f1).ensures_relns;_LL12: {
# 4266
int num_convs=0;
int seen_cdecl=0;
int seen_stdcall=0;
...
int fmt_desc_arg=-1;
int fmt_arg_start=-1;
for(0;_tmp7BC != 0;_tmp7BC=_tmp7BC->tl){
if(!Cyc_Absyn_fntype_att((void*)_tmp7BC->hd))
({struct Cyc_String_pa_PrintArg_struct _tmp6FA=({struct Cyc_String_pa_PrintArg_struct _tmp9CB;_tmp9CB.tag=0U,({struct _dyneither_ptr _tmpBDB=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absyn_attribute2string((void*)_tmp7BC->hd));_tmp9CB.f1=_tmpBDB;});_tmp9CB;});void*_tmp6F8[1U];_tmp6F8[0]=& _tmp6FA;({unsigned int _tmpBDD=loc;struct _dyneither_ptr _tmpBDC=({const char*_tmp6F9="bad function type attribute %s";_tag_dyneither(_tmp6F9,sizeof(char),31U);});Cyc_Tcutil_terr(_tmpBDD,_tmpBDC,_tag_dyneither(_tmp6F8,sizeof(void*),1U));});});{
void*_tmp6FB=(void*)_tmp7BC->hd;void*_tmp6FC=_tmp6FB;enum Cyc_Absyn_Format_Type _tmp701;int _tmp700;int _tmp6FF;switch(*((int*)_tmp6FC)){case 1U: _LL3A: _LL3B:
# 4279
...
# 4283
 if(!seen_fastcall){seen_fastcall=1;++ num_convs;}goto _LL39;case 19U: _LL40: _tmp701=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmp6FC)->f1;_tmp700=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmp6FC)->f2;_tmp6FF=((struct Cyc_Absyn_Format_att_Absyn_Attribute_struct*)_tmp6FC)->f3;_LL41:
# 4285
 if(!seen_format){
seen_format=1;
ft=_tmp701;
fmt_desc_arg=_tmp700;
fmt_arg_start=_tmp6FF;}else{
# 4291
({void*_tmp6FD=0U;({unsigned int _tmpBDF=loc;struct _dyneither_ptr _tmpBDE=({const char*_tmp6FE="function can't have multiple format attributes";_tag_dyneither(_tmp6FE,sizeof(char),47U);});Cyc_Tcutil_terr(_tmpBDF,_tmpBDE,_tag_dyneither(_tmp6FD,sizeof(void*),0U));});});}
goto _LL39;default: _LL42: _LL43:
 goto _LL39;}_LL39:;};}
# 4296
if(num_convs > 1)
({void*_tmp702=0U;({unsigned int _tmpBE1=loc;struct _dyneither_ptr _tmpBE0=({const char*_tmp703="function can't have multiple calling conventions";_tag_dyneither(_tmp703,sizeof(char),49U);});Cyc_Tcutil_terr(_tmpBE1,_tmpBE0,_tag_dyneither(_tmp702,sizeof(void*),0U));});});
# 4301
Cyc_Tcutil_check_unique_tvars(loc,*_tmp7C4);
{struct Cyc_List_List*b=*_tmp7C4;for(0;b != 0;b=b->tl){
...
void*_tmp704=Cyc_Absyn_compress_kb(((struct Cyc_Absyn_Tvar*)b->hd)->kind);void*_tmp705=_tmp704;if(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp705)->tag == 0U){if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp705)->f1)->kind == Cyc_Absyn_MemKind){_LL45: _LL46:
# 4307
({struct Cyc_String_pa_PrintArg_struct _tmp708=({struct Cyc_String_pa_PrintArg_struct _tmp9CC;_tmp9CC.tag=0U,_tmp9CC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)b->hd)->name);_tmp9CC;});void*_tmp706[1U];_tmp706[0]=& _tmp708;({unsigned int _tmpBE5=loc;struct _dyneither_ptr _tmpBE4=({const char*_tmp707="function attempts to abstract Mem type variable %s";_tag_dyneither(_tmp707,sizeof(char),51U);});Cyc_Tcutil_terr(_tmpBE5,_tmpBE4,_tag_dyneither(_tmp706,sizeof(void*),1U));});});
goto _LL44;}else{goto _LL47;}}else{_LL47: _LL48:
 goto _LL44;}_LL44:;};}}{
# 4315
struct Cyc_Tcutil_CVTEnv _tmp709=({struct Cyc_Tcutil_CVTEnv _tmp9CF;_tmp9CF.r=Cyc_Core_heap_region,_tmp9CF.kind_env=cvtenv.kind_env,_tmp9CF.free_vars=0,_tmp9CF.free_evars=0,_tmp9CF.generalize_evars=cvtenv.generalize_evars,_tmp9CF.fn_result=1;_tmp9CF;});
# 4317
_tmp709=Cyc_Tcutil_i_check_valid_type(loc,te,_tmp709,& Cyc_Tcutil_tmk,_tmp7C1,1,1);
({int _tmpBE6=Cyc_Tcutil_extract_const_from_typedef(loc,_tmp7C2->print_const,_tmp7C1);_tmp7C2->real_const=_tmpBE6;});
_tmp709.fn_result=0;
# 4323
{struct Cyc_List_List*a=_tmp7C0;for(0;a != 0;a=a->tl){
struct _tuple10*_tmp70A=(struct _tuple10*)a->hd;
void*_tmp70B=(*_tmp70A).f3;
_tmp709=Cyc_Tcutil_i_check_valid_type(loc,te,_tmp709,& Cyc_Tcutil_tmk,_tmp70B,1,1);{
int _tmp70C=Cyc_Tcutil_extract_const_from_typedef(loc,((*_tmp70A).f2).print_const,_tmp70B);
((*_tmp70A).f2).real_const=_tmp70C;
# 4331
if(Cyc_Tcutil_is_array_type(_tmp70B)){
# 4333
void*_tmp70D=Cyc_Absyn_new_evar(0,0);
_tmp709=Cyc_Tcutil_i_check_valid_type(loc,te,_tmp709,& Cyc_Tcutil_rk,_tmp70D,1,1);
({void*_tmpBE7=Cyc_Tcutil_promote_array(_tmp70B,_tmp70D,0);(*_tmp70A).f3=_tmpBE7;});}};}}
# 4340
if(_tmp7BE != 0){
if(_tmp7BF)({void*_tmp70E=0U;({struct _dyneither_ptr _tmpBE8=({const char*_tmp70F="both c_vararg and cyc_vararg";_tag_dyneither(_tmp70F,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpBE8,_tag_dyneither(_tmp70E,sizeof(void*),0U));});});{
struct Cyc_Absyn_VarargInfo _tmp710=*_tmp7BE;struct Cyc_Absyn_VarargInfo _tmp711=_tmp710;void*_tmp722;int _tmp721;_LL4A: _tmp722=_tmp711.type;_tmp721=_tmp711.inject;_LL4B:;
_tmp709=Cyc_Tcutil_i_check_valid_type(loc,te,_tmp709,& Cyc_Tcutil_tmk,_tmp722,1,1);
({int _tmpBE9=Cyc_Tcutil_extract_const_from_typedef(loc,(_tmp7BE->tq).print_const,_tmp722);(_tmp7BE->tq).real_const=_tmpBE9;});
# 4346
if(_tmp721){
void*_tmp712=Cyc_Tcutil_compress(_tmp722);void*_tmp713=_tmp712;void*_tmp720;void*_tmp71F;void*_tmp71E;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp713)->tag == 3U){_LL4D: _tmp720=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp713)->f1).elt_type;_tmp71F=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp713)->f1).ptr_atts).bounds;_tmp71E=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp713)->f1).ptr_atts).zero_term;_LL4E:
# 4349
{void*_tmp714=Cyc_Tcutil_compress(_tmp720);void*_tmp715=_tmp714;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp715)->tag == 0U){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp715)->f1)->tag == 18U){_LL52: _LL53:
# 4351
 if(Cyc_Tcutil_force_type2bool(0,_tmp71E))
({void*_tmp716=0U;({unsigned int _tmpBEB=loc;struct _dyneither_ptr _tmpBEA=({const char*_tmp717="can't inject into a zeroterm pointer";_tag_dyneither(_tmp717,sizeof(char),37U);});Cyc_Tcutil_terr(_tmpBEB,_tmpBEA,_tag_dyneither(_tmp716,sizeof(void*),0U));});});
if(!({void*_tmpBEC=Cyc_Absyn_bounds_one();Cyc_Tcutil_unify(_tmpBEC,_tmp71F);}))
({void*_tmp718=0U;({unsigned int _tmpBEE=loc;struct _dyneither_ptr _tmpBED=({const char*_tmp719="can't inject into a fat pointer to datatype";_tag_dyneither(_tmp719,sizeof(char),44U);});Cyc_Tcutil_terr(_tmpBEE,_tmpBED,_tag_dyneither(_tmp718,sizeof(void*),0U));});});
goto _LL51;}else{goto _LL54;}}else{_LL54: _LL55:
({void*_tmp71A=0U;({unsigned int _tmpBF0=loc;struct _dyneither_ptr _tmpBEF=({const char*_tmp71B="can't inject a non-datatype type";_tag_dyneither(_tmp71B,sizeof(char),33U);});Cyc_Tcutil_terr(_tmpBF0,_tmpBEF,_tag_dyneither(_tmp71A,sizeof(void*),0U));});});goto _LL51;}_LL51:;}
# 4358
goto _LL4C;}else{_LL4F: _LL50:
({void*_tmp71C=0U;({unsigned int _tmpBF2=loc;struct _dyneither_ptr _tmpBF1=({const char*_tmp71D="expecting a datatype pointer type";_tag_dyneither(_tmp71D,sizeof(char),34U);});Cyc_Tcutil_terr(_tmpBF2,_tmpBF1,_tag_dyneither(_tmp71C,sizeof(void*),0U));});});goto _LL4C;}_LL4C:;}};}
# 4364
if(seen_format){
int _tmp723=((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmp7C0);
if((((fmt_desc_arg < 0  || fmt_desc_arg > _tmp723) || fmt_arg_start < 0) || 
# 4368
(_tmp7BE == 0  && !_tmp7BF) && fmt_arg_start != 0) || 
(_tmp7BE != 0  || _tmp7BF) && fmt_arg_start != _tmp723 + 1)
# 4371
({void*_tmp724=0U;({unsigned int _tmpBF4=loc;struct _dyneither_ptr _tmpBF3=({const char*_tmp725="bad format descriptor";_tag_dyneither(_tmp725,sizeof(char),22U);});Cyc_Tcutil_terr(_tmpBF4,_tmpBF3,_tag_dyneither(_tmp724,sizeof(void*),0U));});});else{
# 4374
struct _tuple10 _tmp726=*((struct _tuple10*(*)(struct Cyc_List_List*x,int n))Cyc_List_nth)(_tmp7C0,fmt_desc_arg - 1);struct _tuple10 _tmp727=_tmp726;void*_tmp73C;_LL57: _tmp73C=_tmp727.f3;_LL58:;
# 4376
{void*_tmp728=Cyc_Tcutil_compress(_tmp73C);void*_tmp729=_tmp728;void*_tmp735;void*_tmp734;void*_tmp733;if(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp729)->tag == 3U){_LL5A: _tmp735=(((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp729)->f1).elt_type;_tmp734=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp729)->f1).ptr_atts).bounds;_tmp733=((((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp729)->f1).ptr_atts).zero_term;_LL5B:
# 4379
 if(!Cyc_Tcutil_is_char_type(_tmp735))
({void*_tmp72A=0U;({unsigned int _tmpBF6=loc;struct _dyneither_ptr _tmpBF5=({const char*_tmp72B="format descriptor is not a string";_tag_dyneither(_tmp72B,sizeof(char),34U);});Cyc_Tcutil_terr(_tmpBF6,_tmpBF5,_tag_dyneither(_tmp72A,sizeof(void*),0U));});});else{
# 4382
struct Cyc_Absyn_Exp*_tmp72C=({void*_tmpBF7=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmpBF7,_tmp734);});
if(_tmp72C == 0  && _tmp7BF)
({void*_tmp72D=0U;({unsigned int _tmpBF9=loc;struct _dyneither_ptr _tmpBF8=({const char*_tmp72E="format descriptor is not a char * type";_tag_dyneither(_tmp72E,sizeof(char),39U);});Cyc_Tcutil_terr(_tmpBF9,_tmpBF8,_tag_dyneither(_tmp72D,sizeof(void*),0U));});});else{
if(_tmp72C != 0  && !_tmp7BF)
({void*_tmp72F=0U;({unsigned int _tmpBFB=loc;struct _dyneither_ptr _tmpBFA=({const char*_tmp730="format descriptor is not a char ? type";_tag_dyneither(_tmp730,sizeof(char),39U);});Cyc_Tcutil_terr(_tmpBFB,_tmpBFA,_tag_dyneither(_tmp72F,sizeof(void*),0U));});});}}
# 4388
goto _LL59;}else{_LL5C: _LL5D:
({void*_tmp731=0U;({unsigned int _tmpBFD=loc;struct _dyneither_ptr _tmpBFC=({const char*_tmp732="format descriptor is not a string type";_tag_dyneither(_tmp732,sizeof(char),39U);});Cyc_Tcutil_terr(_tmpBFD,_tmpBFC,_tag_dyneither(_tmp731,sizeof(void*),0U));});});goto _LL59;}_LL59:;}
# 4391
if(fmt_arg_start != 0  && !_tmp7BF){
# 4395
int problem;
{struct _tuple32 _tmp736=({struct _tuple32 _tmp9CD;_tmp9CD.f1=ft,({void*_tmpBFE=Cyc_Tcutil_compress(Cyc_Tcutil_pointer_elt_type(((struct Cyc_Absyn_VarargInfo*)_check_null(_tmp7BE))->type));_tmp9CD.f2=_tmpBFE;});_tmp9CD;});struct _tuple32 _tmp737=_tmp736;struct Cyc_Absyn_Datatypedecl*_tmp739;struct Cyc_Absyn_Datatypedecl*_tmp738;switch(_tmp737.f1){case Cyc_Absyn_Printf_ft: if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp737.f2)->tag == 0U){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp737.f2)->f1)->tag == 18U){if(((((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp737.f2)->f1)->f1).KnownDatatype).tag == 2){_LL5F: _tmp738=*((((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp737.f2)->f1)->f1).KnownDatatype).val;_LL60:
# 4398
 problem=Cyc_Absyn_qvar_cmp(_tmp738->name,Cyc_Absyn_datatype_print_arg_qvar)!= 0;goto _LL5E;}else{goto _LL63;}}else{goto _LL63;}}else{goto _LL63;}case Cyc_Absyn_Scanf_ft: if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp737.f2)->tag == 0U){if(((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp737.f2)->f1)->tag == 18U){if(((((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp737.f2)->f1)->f1).KnownDatatype).tag == 2){_LL61: _tmp739=*((((struct Cyc_Absyn_DatatypeCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp737.f2)->f1)->f1).KnownDatatype).val;_LL62:
# 4400
 problem=Cyc_Absyn_qvar_cmp(_tmp739->name,Cyc_Absyn_datatype_scanf_arg_qvar)!= 0;goto _LL5E;}else{goto _LL63;}}else{goto _LL63;}}else{goto _LL63;}default: _LL63: _LL64:
# 4402
 problem=1;goto _LL5E;}_LL5E:;}
# 4404
if(problem)
({void*_tmp73A=0U;({unsigned int _tmpC00=loc;struct _dyneither_ptr _tmpBFF=({const char*_tmp73B="format attribute and vararg types don't match";_tag_dyneither(_tmp73B,sizeof(char),46U);});Cyc_Tcutil_terr(_tmpC00,_tmpBFF,_tag_dyneither(_tmp73A,sizeof(void*),0U));});});}}}
# 4412
{struct Cyc_List_List*rpo=_tmp7BD;for(0;rpo != 0;rpo=rpo->tl){
struct _tuple0*_tmp73D=(struct _tuple0*)rpo->hd;struct _tuple0*_tmp73E=_tmp73D;void*_tmp740;void*_tmp73F;_LL66: _tmp740=_tmp73E->f1;_tmp73F=_tmp73E->f2;_LL67:;
_tmp709=Cyc_Tcutil_i_check_valid_type(loc,te,_tmp709,& Cyc_Tcutil_ek,_tmp740,1,1);
_tmp709=Cyc_Tcutil_i_check_valid_type(loc,te,_tmp709,& Cyc_Tcutil_trk,_tmp73F,1,1);}}{
# 4420
struct Cyc_Tcenv_Fenv*_tmp741=Cyc_Tcenv_bogus_fenv(_tmp7C1,_tmp7C0);
struct Cyc_Tcenv_Tenv*_tmp742=({struct Cyc_Tcenv_Tenv*_tmp780=_cycalloc(sizeof(*_tmp780));_tmp780->ns=te->ns,_tmp780->ae=te->ae,_tmp780->le=_tmp741,_tmp780->allow_valueof=1,_tmp780->in_extern_c_include=te->in_extern_c_include,_tmp780->in_tempest=te->in_tempest,_tmp780->tempest_generalize=te->tempest_generalize;_tmp780;});
struct _tuple31 _tmp743=({unsigned int _tmpC04=loc;struct Cyc_Tcenv_Tenv*_tmpC03=_tmp742;struct Cyc_Tcutil_CVTEnv _tmpC02=_tmp709;struct _dyneither_ptr _tmpC01=({const char*_tmp77F="@requires";_tag_dyneither(_tmp77F,sizeof(char),10U);});Cyc_Tcutil_check_clause(_tmpC04,_tmpC03,_tmpC02,_tmpC01,_tmp7BB);});struct _tuple31 _tmp744=_tmp743;struct Cyc_Tcutil_CVTEnv _tmp77E;struct Cyc_List_List*_tmp77D;_LL69: _tmp77E=_tmp744.f1;_tmp77D=_tmp744.f2;_LL6A:;
_tmp709=_tmp77E;
*_tmp7BA=_tmp77D;
((void(*)(void(*f)(struct Cyc_List_List*,struct Cyc_Relations_Reln*),struct Cyc_List_List*env,struct Cyc_List_List*x))Cyc_List_iter_c)(Cyc_Tcutil_replace_rops,_tmp7C0,_tmp77D);{
# 4433
struct _tuple31 _tmp745=({unsigned int _tmpC08=loc;struct Cyc_Tcenv_Tenv*_tmpC07=_tmp742;struct Cyc_Tcutil_CVTEnv _tmpC06=_tmp709;struct _dyneither_ptr _tmpC05=({const char*_tmp77C="@ensures";_tag_dyneither(_tmp77C,sizeof(char),9U);});Cyc_Tcutil_check_clause(_tmpC08,_tmpC07,_tmpC06,_tmpC05,_tmp7B9);});struct _tuple31 _tmp746=_tmp745;struct Cyc_Tcutil_CVTEnv _tmp77B;struct Cyc_List_List*_tmp77A;_LL6C: _tmp77B=_tmp746.f1;_tmp77A=_tmp746.f2;_LL6D:;
_tmp709=_tmp77B;
*_tmp7B8=_tmp77A;
((void(*)(void(*f)(struct Cyc_List_List*,struct Cyc_Relations_Reln*),struct Cyc_List_List*env,struct Cyc_List_List*x))Cyc_List_iter_c)(Cyc_Tcutil_replace_rops,_tmp7C0,_tmp77A);
# 4438
if(*_tmp7C3 != 0)
_tmp709=Cyc_Tcutil_i_check_valid_type(loc,te,_tmp709,& Cyc_Tcutil_ek,(void*)_check_null(*_tmp7C3),1,1);else{
# 4441
struct Cyc_List_List*effect=0;
# 4446
{struct Cyc_List_List*tvs=_tmp709.free_vars;for(0;tvs != 0;tvs=tvs->tl){
struct _tuple29 _tmp747=*((struct _tuple29*)tvs->hd);struct _tuple29 _tmp748=_tmp747;struct Cyc_Absyn_Tvar*_tmp756;int _tmp755;_LL6F: _tmp756=_tmp748.f1;_tmp755=_tmp748.f2;_LL70:;
if(!_tmp755)continue;{
void*_tmp749=Cyc_Absyn_compress_kb(_tmp756->kind);void*_tmp74A=_tmp749;struct Cyc_Core_Opt**_tmp754;struct Cyc_Absyn_Kind*_tmp753;struct Cyc_Core_Opt**_tmp752;struct Cyc_Core_Opt**_tmp751;struct Cyc_Absyn_Kind*_tmp750;switch(*((int*)_tmp74A)){case 2U: _LL72: _tmp751=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp74A)->f1;_tmp750=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp74A)->f2;if((int)_tmp750->kind == (int)Cyc_Absyn_RgnKind){_LL73:
# 4452
 if((int)_tmp750->aliasqual == (int)Cyc_Absyn_Top){
({struct Cyc_Core_Opt*_tmpC09=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_rk);*_tmp751=_tmpC09;});_tmp753=_tmp750;goto _LL75;}
# 4455
({struct Cyc_Core_Opt*_tmpC0A=Cyc_Tcutil_kind_to_bound_opt(_tmp750);*_tmp751=_tmpC0A;});_tmp753=_tmp750;goto _LL75;}else{switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp74A)->f2)->kind){case Cyc_Absyn_BoolKind: _LL76: _LL77:
# 4458
 goto _LL79;case Cyc_Absyn_PtrBndKind: _LL78: _LL79:
 goto _LL7B;case Cyc_Absyn_IntKind: _LL7A: _LL7B:
 goto _LL7D;case Cyc_Absyn_EffKind: _LL82: _tmp752=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp74A)->f1;_LL83:
# 4465
({struct Cyc_Core_Opt*_tmpC0B=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_ek);*_tmp752=_tmpC0B;});goto _LL85;default: goto _LL88;}}case 0U: _LL74: _tmp753=((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp74A)->f1;if((int)_tmp753->kind == (int)Cyc_Absyn_RgnKind){_LL75:
# 4457
 effect=({struct Cyc_List_List*_tmp74B=_cycalloc(sizeof(*_tmp74B));({void*_tmpC0C=Cyc_Absyn_access_eff(Cyc_Absyn_var_type(_tmp756));_tmp74B->hd=_tmpC0C;}),_tmp74B->tl=effect;_tmp74B;});goto _LL71;}else{switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp74A)->f1)->kind){case Cyc_Absyn_BoolKind: _LL7C: _LL7D:
# 4461
...
# 4467
 effect=({struct Cyc_List_List*_tmp74C=_cycalloc(sizeof(*_tmp74C));({void*_tmpC0D=Cyc_Absyn_var_type(_tmp756);_tmp74C->hd=_tmpC0D;}),_tmp74C->tl=effect;_tmp74C;});goto _LL71;default: _LL88: _LL89:
# 4472
 effect=({struct Cyc_List_List*_tmp74F=_cycalloc(sizeof(*_tmp74F));({void*_tmpC0E=Cyc_Absyn_regionsof_eff(Cyc_Absyn_var_type(_tmp756));_tmp74F->hd=_tmpC0E;}),_tmp74F->tl=effect;_tmp74F;});goto _LL71;}}default: _LL86: _tmp754=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp74A)->f1;_LL87:
# 4469
({struct Cyc_Core_Opt*_tmpC10=({struct Cyc_Core_Opt*_tmp74E=_cycalloc(sizeof(*_tmp74E));({void*_tmpC0F=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp74D=_cycalloc(sizeof(*_tmp74D));_tmp74D->tag=2U,_tmp74D->f1=0,_tmp74D->f2=& Cyc_Tcutil_ak;_tmp74D;});_tmp74E->v=_tmpC0F;});_tmp74E;});*_tmp754=_tmpC10;});goto _LL89;}_LL71:;};}}
# 4476
{struct Cyc_List_List*ts=_tmp709.free_evars;for(0;ts != 0;ts=ts->tl){
struct _tuple30 _tmp757=*((struct _tuple30*)ts->hd);struct _tuple30 _tmp758=_tmp757;void*_tmp75F;int _tmp75E;_LL8B: _tmp75F=_tmp758.f1;_tmp75E=_tmp758.f2;_LL8C:;
if(!_tmp75E)continue;{
struct Cyc_Absyn_Kind*_tmp759=Cyc_Tcutil_type_kind(_tmp75F);struct Cyc_Absyn_Kind*_tmp75A=_tmp759;switch(((struct Cyc_Absyn_Kind*)_tmp75A)->kind){case Cyc_Absyn_RgnKind: _LL8E: _LL8F:
# 4481
 effect=({struct Cyc_List_List*_tmp75B=_cycalloc(sizeof(*_tmp75B));({void*_tmpC11=Cyc_Absyn_access_eff(_tmp75F);_tmp75B->hd=_tmpC11;}),_tmp75B->tl=effect;_tmp75B;});goto _LL8D;case Cyc_Absyn_EffKind: _LL90: _LL91:
# 4483
 effect=({struct Cyc_List_List*_tmp75C=_cycalloc(sizeof(*_tmp75C));_tmp75C->hd=_tmp75F,_tmp75C->tl=effect;_tmp75C;});goto _LL8D;case Cyc_Absyn_IntKind: _LL92: _LL93:
 goto _LL8D;default: _LL94: _LL95:
# 4486
 effect=({struct Cyc_List_List*_tmp75D=_cycalloc(sizeof(*_tmp75D));({void*_tmpC12=Cyc_Absyn_regionsof_eff(_tmp75F);_tmp75D->hd=_tmpC12;}),_tmp75D->tl=effect;_tmp75D;});goto _LL8D;}_LL8D:;};}}
# 4489
({void*_tmpC13=Cyc_Absyn_join_eff(effect);*_tmp7C3=_tmpC13;});}
# 4495
if(*_tmp7C4 != 0){
struct Cyc_List_List*bs=*_tmp7C4;for(0;bs != 0;bs=bs->tl){
void*_tmp760=Cyc_Absyn_compress_kb(((struct Cyc_Absyn_Tvar*)bs->hd)->kind);void*_tmp761=_tmp760;struct Cyc_Core_Opt**_tmp771;struct Cyc_Absyn_Kind*_tmp770;struct Cyc_Core_Opt**_tmp76F;struct Cyc_Core_Opt**_tmp76E;struct Cyc_Core_Opt**_tmp76D;struct Cyc_Core_Opt**_tmp76C;struct Cyc_Core_Opt**_tmp76B;struct Cyc_Core_Opt**_tmp76A;struct Cyc_Core_Opt**_tmp769;struct Cyc_Core_Opt**_tmp768;struct Cyc_Core_Opt**_tmp767;switch(*((int*)_tmp761)){case 1U: _LL97: _tmp767=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp761)->f1;_LL98:
# 4499
({struct Cyc_String_pa_PrintArg_struct _tmp764=({struct Cyc_String_pa_PrintArg_struct _tmp9CE;_tmp9CE.tag=0U,_tmp9CE.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)bs->hd)->name);_tmp9CE;});void*_tmp762[1U];_tmp762[0]=& _tmp764;({unsigned int _tmpC15=loc;struct _dyneither_ptr _tmpC14=({const char*_tmp763="Type variable %s unconstrained, assuming boxed";_tag_dyneither(_tmp763,sizeof(char),47U);});Cyc_Tcutil_warn(_tmpC15,_tmpC14,_tag_dyneither(_tmp762,sizeof(void*),1U));});});
# 4501
_tmp768=_tmp767;goto _LL9A;case 2U: switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f2)->kind){case Cyc_Absyn_BoxKind: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f2)->aliasqual == Cyc_Absyn_Top){_LL99: _tmp768=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f1;_LL9A:
 _tmp769=_tmp768;goto _LL9C;}else{goto _LLA9;}case Cyc_Absyn_MemKind: switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f2)->aliasqual){case Cyc_Absyn_Top: _LL9B: _tmp769=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f1;_LL9C:
 _tmp76A=_tmp769;goto _LL9E;case Cyc_Absyn_Aliasable: _LL9D: _tmp76A=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f1;_LL9E:
 _tmp76C=_tmp76A;goto _LLA0;case Cyc_Absyn_Unique: _LLA3: _tmp76B=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f1;_LLA4:
# 4508
 _tmp76E=_tmp76B;goto _LLA6;default: goto _LLA9;}case Cyc_Absyn_AnyKind: switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f2)->aliasqual){case Cyc_Absyn_Top: _LL9F: _tmp76C=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f1;_LLA0:
# 4505
 _tmp76D=_tmp76C;goto _LLA2;case Cyc_Absyn_Aliasable: _LLA1: _tmp76D=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f1;_LLA2:
# 4507
({struct Cyc_Core_Opt*_tmpC16=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_bk);*_tmp76D=_tmpC16;});goto _LL96;case Cyc_Absyn_Unique: _LLA5: _tmp76E=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f1;_LLA6:
# 4510
({struct Cyc_Core_Opt*_tmpC17=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_ubk);*_tmp76E=_tmpC17;});goto _LL96;default: goto _LLA9;}case Cyc_Absyn_RgnKind: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f2)->aliasqual == Cyc_Absyn_Top){_LLA7: _tmp76F=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f1;_LLA8:
# 4512
({struct Cyc_Core_Opt*_tmpC18=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_rk);*_tmp76F=_tmpC18;});goto _LL96;}else{goto _LLA9;}default: _LLA9: _tmp771=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f1;_tmp770=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp761)->f2;_LLAA:
# 4514
({struct Cyc_Core_Opt*_tmpC19=Cyc_Tcutil_kind_to_bound_opt(_tmp770);*_tmp771=_tmpC19;});goto _LL96;}default: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp761)->f1)->kind == Cyc_Absyn_MemKind){_LLAB: _LLAC:
# 4516
({void*_tmp765=0U;({unsigned int _tmpC1B=loc;struct _dyneither_ptr _tmpC1A=({const char*_tmp766="functions can't abstract M types";_tag_dyneither(_tmp766,sizeof(char),33U);});Cyc_Tcutil_terr(_tmpC1B,_tmpC1A,_tag_dyneither(_tmp765,sizeof(void*),0U));});});goto _LL96;}else{_LLAD: _LLAE:
 goto _LL96;}}_LL96:;}}
# 4521
({struct Cyc_List_List*_tmpC1C=Cyc_Tcutil_remove_bound_tvars(Cyc_Core_heap_region,_tmp709.kind_env,*_tmp7C4);cvtenv.kind_env=_tmpC1C;});
({struct Cyc_List_List*_tmpC1D=Cyc_Tcutil_remove_bound_tvars_bool(_tmp709.r,_tmp709.free_vars,*_tmp7C4);_tmp709.free_vars=_tmpC1D;});
# 4524
{struct Cyc_List_List*tvs=_tmp709.free_vars;for(0;tvs != 0;tvs=tvs->tl){
struct _tuple29 _tmp772=*((struct _tuple29*)tvs->hd);struct _tuple29 _tmp773=_tmp772;struct Cyc_Absyn_Tvar*_tmp775;int _tmp774;_LLB0: _tmp775=_tmp773.f1;_tmp774=_tmp773.f2;_LLB1:;
({struct Cyc_List_List*_tmpC1E=Cyc_Tcutil_fast_add_free_tvar_bool(cvtenv.r,cvtenv.free_vars,_tmp775,_tmp774);cvtenv.free_vars=_tmpC1E;});}}
# 4529
{struct Cyc_List_List*evs=_tmp709.free_evars;for(0;evs != 0;evs=evs->tl){
struct _tuple30 _tmp776=*((struct _tuple30*)evs->hd);struct _tuple30 _tmp777=_tmp776;void*_tmp779;int _tmp778;_LLB3: _tmp779=_tmp777.f1;_tmp778=_tmp777.f2;_LLB4:;
({struct Cyc_List_List*_tmpC1F=Cyc_Tcutil_add_free_evar(cvtenv.r,cvtenv.free_evars,_tmp779,_tmp778);cvtenv.free_evars=_tmpC1F;});}}
# 4533
goto _LL0;};};};}case 6U: _LL13: _tmp7C5=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp6C7)->f1;_LL14:
# 4536
 for(0;_tmp7C5 != 0;_tmp7C5=_tmp7C5->tl){
struct _tuple12*_tmp781=(struct _tuple12*)_tmp7C5->hd;
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_tmk,(*_tmp781).f2,1,0);
({int _tmpC20=
Cyc_Tcutil_extract_const_from_typedef(loc,((*_tmp781).f1).print_const,(*_tmp781).f2);
# 4539
((*_tmp781).f1).real_const=_tmpC20;});}
# 4542
goto _LL0;case 7U: _LL15: _tmp7C7=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp6C7)->f1;_tmp7C6=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp6C7)->f2;_LL16: {
# 4546
struct Cyc_List_List*prev_fields=0;
for(0;_tmp7C6 != 0;_tmp7C6=_tmp7C6->tl){
struct Cyc_Absyn_Aggrfield*_tmp782=(struct Cyc_Absyn_Aggrfield*)_tmp7C6->hd;struct Cyc_Absyn_Aggrfield*_tmp783=_tmp782;struct _dyneither_ptr*_tmp793;struct Cyc_Absyn_Tqual*_tmp792;void*_tmp791;struct Cyc_Absyn_Exp*_tmp790;struct Cyc_List_List*_tmp78F;struct Cyc_Absyn_Exp*_tmp78E;_LLB6: _tmp793=_tmp783->name;_tmp792=(struct Cyc_Absyn_Tqual*)& _tmp783->tq;_tmp791=_tmp783->type;_tmp790=_tmp783->width;_tmp78F=_tmp783->attributes;_tmp78E=_tmp783->requires_clause;_LLB7:;
if(((int(*)(int(*compare)(struct _dyneither_ptr*,struct _dyneither_ptr*),struct Cyc_List_List*l,struct _dyneither_ptr*x))Cyc_List_mem)(Cyc_strptrcmp,prev_fields,_tmp793))
({struct Cyc_String_pa_PrintArg_struct _tmp786=({struct Cyc_String_pa_PrintArg_struct _tmp9D0;_tmp9D0.tag=0U,_tmp9D0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp793);_tmp9D0;});void*_tmp784[1U];_tmp784[0]=& _tmp786;({unsigned int _tmpC22=loc;struct _dyneither_ptr _tmpC21=({const char*_tmp785="duplicate field %s";_tag_dyneither(_tmp785,sizeof(char),19U);});Cyc_Tcutil_terr(_tmpC22,_tmpC21,_tag_dyneither(_tmp784,sizeof(void*),1U));});});
if(({struct _dyneither_ptr _tmpC23=(struct _dyneither_ptr)*_tmp793;Cyc_strcmp(_tmpC23,({const char*_tmp787="";_tag_dyneither(_tmp787,sizeof(char),1U);}));})!= 0)
prev_fields=({struct Cyc_List_List*_tmp788=_cycalloc(sizeof(*_tmp788));_tmp788->hd=_tmp793,_tmp788->tl=prev_fields;_tmp788;});
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,& Cyc_Tcutil_tmk,_tmp791,1,0);
({int _tmpC24=Cyc_Tcutil_extract_const_from_typedef(loc,_tmp792->print_const,_tmp791);_tmp792->real_const=_tmpC24;});
Cyc_Tcutil_check_bitfield(loc,te,_tmp791,_tmp790,_tmp793);
Cyc_Tcutil_check_field_atts(loc,_tmp793,_tmp78F);
if(_tmp78E != 0){
# 4559
if((int)_tmp7C7 != (int)1U)
({void*_tmp789=0U;({unsigned int _tmpC26=loc;struct _dyneither_ptr _tmpC25=({const char*_tmp78A="@requires clause is only allowed on union members";_tag_dyneither(_tmp78A,sizeof(char),50U);});Cyc_Tcutil_terr(_tmpC26,_tmpC25,_tag_dyneither(_tmp789,sizeof(void*),0U));});});
({struct Cyc_Tcenv_Tenv*_tmpC27=Cyc_Tcenv_allow_valueof(te);Cyc_Tcexp_tcExp(_tmpC27,0,_tmp78E);});
if(!Cyc_Tcutil_is_integral(_tmp78E))
({struct Cyc_String_pa_PrintArg_struct _tmp78D=({struct Cyc_String_pa_PrintArg_struct _tmp9D1;_tmp9D1.tag=0U,({
struct _dyneither_ptr _tmpC28=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)_check_null(_tmp78E->topt)));_tmp9D1.f1=_tmpC28;});_tmp9D1;});void*_tmp78B[1U];_tmp78B[0]=& _tmp78D;({unsigned int _tmpC2A=loc;struct _dyneither_ptr _tmpC29=({const char*_tmp78C="@requires clause has type %s instead of integral type";_tag_dyneither(_tmp78C,sizeof(char),54U);});Cyc_Tcutil_terr(_tmpC2A,_tmpC29,_tag_dyneither(_tmp78B,sizeof(void*),1U));});});
cvtenv=Cyc_Tcutil_i_check_valid_type_level_exp(_tmp78E,te,cvtenv);}}
# 4568
goto _LL0;}default: _LL17: _tmp7CB=((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp6C7)->f1;_tmp7CA=(struct Cyc_List_List**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp6C7)->f2;_tmp7C9=(struct Cyc_Absyn_Typedefdecl**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp6C7)->f3;_tmp7C8=(void**)&((struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_tmp6C7)->f4;_LL18: {
# 4571
struct Cyc_List_List*targs=*_tmp7CA;
# 4573
struct Cyc_Absyn_Typedefdecl*td;
{struct _handler_cons _tmp794;_push_handler(& _tmp794);{int _tmp796=0;if(setjmp(_tmp794.handler))_tmp796=1;if(!_tmp796){td=Cyc_Tcenv_lookup_typedefdecl(te,loc,_tmp7CB);;_pop_handler();}else{void*_tmp795=(void*)_exn_thrown;void*_tmp797=_tmp795;void*_tmp79B;if(((struct Cyc_Dict_Absent_exn_struct*)_tmp797)->tag == Cyc_Dict_Absent){_LLB9: _LLBA:
# 4576
({struct Cyc_String_pa_PrintArg_struct _tmp79A=({struct Cyc_String_pa_PrintArg_struct _tmp9D2;_tmp9D2.tag=0U,({struct _dyneither_ptr _tmpC2B=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp7CB));_tmp9D2.f1=_tmpC2B;});_tmp9D2;});void*_tmp798[1U];_tmp798[0]=& _tmp79A;({unsigned int _tmpC2D=loc;struct _dyneither_ptr _tmpC2C=({const char*_tmp799="unbound typedef name %s";_tag_dyneither(_tmp799,sizeof(char),24U);});Cyc_Tcutil_terr(_tmpC2D,_tmpC2C,_tag_dyneither(_tmp798,sizeof(void*),1U));});});
return cvtenv;}else{_LLBB: _tmp79B=_tmp797;_LLBC:(int)_rethrow(_tmp79B);}_LLB8:;}};}
# 4579
*_tmp7C9=td;{
...
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,k,(void*)ts->hd,1,allow_abs_aggr);
Cyc_Tcutil_check_no_qual(loc,(void*)ts->hd);
inst=({struct Cyc_List_List*_tmp79D=_cycalloc(sizeof(*_tmp79D));({struct _tuple15*_tmpC2E=({struct _tuple15*_tmp79C=_cycalloc(sizeof(*_tmp79C));_tmp79C->f1=(struct Cyc_Absyn_Tvar*)tvs->hd,_tmp79C->f2=(void*)ts->hd;_tmp79C;});_tmp79D->hd=_tmpC2E;}),_tmp79D->tl=inst;_tmp79D;});}
# 4593
if(ts != 0)
({struct Cyc_String_pa_PrintArg_struct _tmp7A0=({struct Cyc_String_pa_PrintArg_struct _tmp9D3;_tmp9D3.tag=0U,({struct _dyneither_ptr _tmpC2F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp7CB));_tmp9D3.f1=_tmpC2F;});_tmp9D3;});void*_tmp79E[1U];_tmp79E[0]=& _tmp7A0;({unsigned int _tmpC31=loc;struct _dyneither_ptr _tmpC30=({const char*_tmp79F="too many parameters for typedef %s";_tag_dyneither(_tmp79F,sizeof(char),35U);});Cyc_Tcutil_terr(_tmpC31,_tmpC30,_tag_dyneither(_tmp79E,sizeof(void*),1U));});});
if(tvs != 0){
struct Cyc_List_List*hidden_ts=0;
# 4598
for(0;tvs != 0;tvs=tvs->tl){
...
void*e=Cyc_Absyn_new_evar(0,0);
hidden_ts=({struct Cyc_List_List*_tmp7A1=_cycalloc(sizeof(*_tmp7A1));_tmp7A1->hd=e,_tmp7A1->tl=hidden_ts;_tmp7A1;});
cvtenv=Cyc_Tcutil_i_check_valid_type(loc,te,cvtenv,k,e,1,allow_abs_aggr);
inst=({struct Cyc_List_List*_tmp7A3=_cycalloc(sizeof(*_tmp7A3));({struct _tuple15*_tmpC32=({struct _tuple15*_tmp7A2=_cycalloc(sizeof(*_tmp7A2));_tmp7A2->f1=(struct Cyc_Absyn_Tvar*)tvs->hd,_tmp7A2->f2=e;_tmp7A2;});_tmp7A3->hd=_tmpC32;}),_tmp7A3->tl=inst;_tmp7A3;});}
# 4606
({struct Cyc_List_List*_tmpC34=({struct Cyc_List_List*_tmpC33=targs;((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_imp_append)(_tmpC33,((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(hidden_ts));});*_tmp7CA=_tmpC34;});}
# 4608
if(td->defn != 0){
void*new_typ=
...
goto _LL0;};}}_LL0:;}
# 4616
if(!({struct Cyc_Absyn_Kind*_tmpC35=Cyc_Tcutil_type_kind(t);Cyc_Tcutil_kind_leq(_tmpC35,expected_kind);}))
({struct Cyc_String_pa_PrintArg_struct _tmp7CE=({struct Cyc_String_pa_PrintArg_struct _tmp9D6;_tmp9D6.tag=0U,({
struct _dyneither_ptr _tmpC36=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp9D6.f1=_tmpC36;});_tmp9D6;});struct Cyc_String_pa_PrintArg_struct _tmp7CF=({struct Cyc_String_pa_PrintArg_struct _tmp9D5;_tmp9D5.tag=0U,({struct _dyneither_ptr _tmpC37=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(Cyc_Tcutil_type_kind(t)));_tmp9D5.f1=_tmpC37;});_tmp9D5;});struct Cyc_String_pa_PrintArg_struct _tmp7D0=({struct Cyc_String_pa_PrintArg_struct _tmp9D4;_tmp9D4.tag=0U,({struct _dyneither_ptr _tmpC38=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(expected_kind));_tmp9D4.f1=_tmpC38;});_tmp9D4;});void*_tmp7CC[3U];_tmp7CC[0]=& _tmp7CE,_tmp7CC[1]=& _tmp7CF,_tmp7CC[2]=& _tmp7D0;({unsigned int _tmpC3A=loc;struct _dyneither_ptr _tmpC39=({const char*_tmp7CD="type %s has kind %s but as used here needs kind %s";_tag_dyneither(_tmp7CD,sizeof(char),51U);});Cyc_Tcutil_terr(_tmpC3A,_tmpC39,_tag_dyneither(_tmp7CC,sizeof(void*),3U));});});
# 4620
return cvtenv;}
# 4628
...
# 4630
{void*_tmp7D1=e->r;void*_tmp7D2=_tmp7D1;struct Cyc_Absyn_Exp*_tmp7E5;struct Cyc_Absyn_Exp*_tmp7E4;void*_tmp7E3;void*_tmp7E2;void*_tmp7E1;void*_tmp7E0;struct Cyc_Absyn_Exp*_tmp7DF;struct Cyc_Absyn_Exp*_tmp7DE;struct Cyc_Absyn_Exp*_tmp7DD;struct Cyc_Absyn_Exp*_tmp7DC;struct Cyc_Absyn_Exp*_tmp7DB;struct Cyc_Absyn_Exp*_tmp7DA;struct Cyc_Absyn_Exp*_tmp7D9;struct Cyc_Absyn_Exp*_tmp7D8;struct Cyc_Absyn_Exp*_tmp7D7;struct Cyc_Absyn_Exp*_tmp7D6;struct Cyc_List_List*_tmp7D5;switch(*((int*)_tmp7D2)){case 0U: _LL1: _LL2:
 goto _LL4;case 32U: _LL3: _LL4:
 goto _LL6;case 33U: _LL5: _LL6:
 goto _LL8;case 2U: _LL7: _LL8:
 goto _LLA;case 1U: _LL9: _LLA:
 goto _LL0;case 3U: _LLB: _tmp7D5=((struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*)_tmp7D2)->f2;_LLC:
# 4637
 for(0;_tmp7D5 != 0;_tmp7D5=_tmp7D5->tl){
cvtenv=Cyc_Tcutil_i_check_valid_type_level_exp((struct Cyc_Absyn_Exp*)_tmp7D5->hd,te,cvtenv);}
goto _LL0;case 6U: _LLD: _tmp7D8=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp7D2)->f1;_tmp7D7=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp7D2)->f2;_tmp7D6=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp7D2)->f3;_LLE:
# 4641
...
goto _LL0;case 7U: _LLF: _tmp7DA=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp7D2)->f1;_tmp7D9=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp7D2)->f2;_LL10:
 _tmp7DC=_tmp7DA;_tmp7DB=_tmp7D9;goto _LL12;case 8U: _LL11: _tmp7DC=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp7D2)->f1;_tmp7DB=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp7D2)->f2;_LL12:
 _tmp7DE=_tmp7DC;_tmp7DD=_tmp7DB;goto _LL14;case 9U: _LL13: _tmp7DE=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp7D2)->f1;_tmp7DD=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp7D2)->f2;_LL14:
# 4648
...
goto _LL0;case 14U: _LL15: _tmp7E0=(void*)((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp7D2)->f1;_tmp7DF=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp7D2)->f2;_LL16:
# 4652
 cvtenv=Cyc_Tcutil_i_check_valid_type_level_exp(_tmp7DF,te,cvtenv);
cvtenv=Cyc_Tcutil_i_check_valid_type(e->loc,te,cvtenv,& Cyc_Tcutil_tak,_tmp7E0,1,0);
goto _LL0;case 19U: _LL17: _tmp7E1=(void*)((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp7D2)->f1;_LL18:
 _tmp7E2=_tmp7E1;goto _LL1A;case 17U: _LL19: _tmp7E2=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_tmp7D2)->f1;_LL1A:
# 4657
 cvtenv=Cyc_Tcutil_i_check_valid_type(e->loc,te,cvtenv,& Cyc_Tcutil_tak,_tmp7E2,1,0);
goto _LL0;case 39U: _LL1B: _tmp7E3=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmp7D2)->f1;_LL1C:
# 4660
 cvtenv=Cyc_Tcutil_i_check_valid_type(e->loc,te,cvtenv,& Cyc_Tcutil_ik,_tmp7E3,1,0);
goto _LL0;case 18U: _LL1D: _tmp7E4=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmp7D2)->f1;_LL1E:
# 4663
 cvtenv=Cyc_Tcutil_i_check_valid_type_level_exp(_tmp7E4,te,cvtenv);
goto _LL0;case 41U: _LL1F: _tmp7E5=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmp7D2)->f1;_LL20:
# 4666
 cvtenv=Cyc_Tcutil_i_check_valid_type_level_exp(_tmp7E5,te,cvtenv);
goto _LL0;default: _LL21: _LL22:
# 4669
({void*_tmp7D3=0U;({struct _dyneither_ptr _tmpC3B=({const char*_tmp7D4="non-type-level-expression in Tcutil::i_check_valid_type_level_exp";_tag_dyneither(_tmp7D4,sizeof(char),66U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC3B,_tag_dyneither(_tmp7D3,sizeof(void*),0U));});});}_LL0:;}
# 4671
return cvtenv;}
# 4674
...
# 4679
struct Cyc_List_List*_tmp7E6=cvt.kind_env;
...
struct _tuple29 _tmp7E7=*((struct _tuple29*)vs->hd);struct _tuple29 _tmp7E8=_tmp7E7;struct Cyc_Absyn_Tvar*_tmp7E9;_LL1: _tmp7E9=_tmp7E8.f1;_LL2:;
({struct Cyc_List_List*_tmpC3C=Cyc_Tcutil_fast_add_free_tvar(_tmp7E6,_tmp7E9);cvt.kind_env=_tmpC3C;});}}
# 4690
{struct Cyc_List_List*evs=cvt.free_evars;for(0;evs != 0;evs=evs->tl){
struct _tuple30 _tmp7EA=*((struct _tuple30*)evs->hd);struct _tuple30 _tmp7EB=_tmp7EA;void*_tmp7F4;_LL4: _tmp7F4=_tmp7EB.f1;_LL5:;{
void*_tmp7EC=Cyc_Tcutil_compress(_tmp7F4);void*_tmp7ED=_tmp7EC;struct Cyc_Core_Opt**_tmp7F3;if(((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp7ED)->tag == 1U){_LL7: _tmp7F3=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp7ED)->f4;_LL8:
# 4694
 if(*_tmp7F3 == 0)
({struct Cyc_Core_Opt*_tmpC3D=({struct Cyc_Core_Opt*_tmp7EE=_cycalloc(sizeof(*_tmp7EE));_tmp7EE->v=_tmp7E6;_tmp7EE;});*_tmp7F3=_tmpC3D;});else{
# 4698
struct Cyc_List_List*_tmp7EF=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(*_tmp7F3))->v;
struct Cyc_List_List*_tmp7F0=0;
for(0;_tmp7EF != 0;_tmp7EF=_tmp7EF->tl){
if(((int(*)(int(*compare)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*l,struct Cyc_Absyn_Tvar*x))Cyc_List_mem)(Cyc_Tcutil_fast_tvar_cmp,_tmp7E6,(struct Cyc_Absyn_Tvar*)_tmp7EF->hd))
_tmp7F0=({struct Cyc_List_List*_tmp7F1=_cycalloc(sizeof(*_tmp7F1));_tmp7F1->hd=(struct Cyc_Absyn_Tvar*)_tmp7EF->hd,_tmp7F1->tl=_tmp7F0;_tmp7F1;});}
({struct Cyc_Core_Opt*_tmpC3E=({struct Cyc_Core_Opt*_tmp7F2=_cycalloc(sizeof(*_tmp7F2));_tmp7F2->v=_tmp7F0;_tmp7F2;});*_tmp7F3=_tmpC3E;});}
# 4705
...
{void*_tmp7F5=Cyc_Tcutil_compress(e);void*_tmp7F6=_tmp7F5;if(((struct Cyc_Absyn_Evar_Absyn_Type_struct*)_tmp7F6)->tag == 1U){_LL1: _LL2:
 goto _LL0;}else{_LL3: _LL4:
# 4722
 continue;}_LL0:;}{
# 4724
struct Cyc_Absyn_Kind*_tmp7F7=Cyc_Tcutil_type_kind(e);struct Cyc_Absyn_Kind*_tmp7F8=_tmp7F7;switch(((struct Cyc_Absyn_Kind*)_tmp7F8)->kind){case Cyc_Absyn_RgnKind: switch(((struct Cyc_Absyn_Kind*)_tmp7F8)->aliasqual){case Cyc_Absyn_Unique: _LL6: _LL7:
# 4726
 if(!Cyc_Tcutil_unify(e,Cyc_Absyn_unique_rgn_type))
({void*_tmp7F9=0U;({struct _dyneither_ptr _tmpC3F=({const char*_tmp7FA="can't unify evar with unique region!";_tag_dyneither(_tmp7FA,sizeof(char),37U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC3F,_tag_dyneither(_tmp7F9,sizeof(void*),0U));});});
goto _LL5;case Cyc_Absyn_Aliasable: _LL8: _LL9:
 goto _LLB;case Cyc_Absyn_Top: _LLA: _LLB:
# 4731
 if(!Cyc_Tcutil_unify(e,Cyc_Absyn_heap_rgn_type))({void*_tmp7FB=0U;({struct _dyneither_ptr _tmpC40=({const char*_tmp7FC="can't unify evar with heap!";_tag_dyneither(_tmp7FC,sizeof(char),28U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC40,_tag_dyneither(_tmp7FB,sizeof(void*),0U));});});
goto _LL5;default: goto _LL12;}case Cyc_Absyn_EffKind: _LLC: _LLD:
# 4734
 if(!Cyc_Tcutil_unify(e,Cyc_Absyn_empty_effect))({void*_tmp7FD=0U;({struct _dyneither_ptr _tmpC41=({const char*_tmp7FE="can't unify evar with {}!";_tag_dyneither(_tmp7FE,sizeof(char),26U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC41,_tag_dyneither(_tmp7FD,sizeof(void*),0U));});});
goto _LL5;case Cyc_Absyn_BoolKind: _LLE: _LLF:
# 4737
 if(!Cyc_Tcutil_unify(e,Cyc_Absyn_false_type))({struct Cyc_String_pa_PrintArg_struct _tmp801=({struct Cyc_String_pa_PrintArg_struct _tmp9D7;_tmp9D7.tag=0U,({
struct _dyneither_ptr _tmpC42=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(e));_tmp9D7.f1=_tmpC42;});_tmp9D7;});void*_tmp7FF[1U];_tmp7FF[0]=& _tmp801;({struct _dyneither_ptr _tmpC43=({const char*_tmp800="can't unify evar %s with @false!";_tag_dyneither(_tmp800,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC43,_tag_dyneither(_tmp7FF,sizeof(void*),1U));});});
goto _LL5;case Cyc_Absyn_PtrBndKind: _LL10: _LL11:
# 4741
 if(!({void*_tmpC44=e;Cyc_Tcutil_unify(_tmpC44,Cyc_Absyn_bounds_one());}))({void*_tmp802=0U;({struct _dyneither_ptr _tmpC45=({const char*_tmp803="can't unify evar with bounds_one!";_tag_dyneither(_tmp803,sizeof(char),34U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC45,_tag_dyneither(_tmp802,sizeof(void*),0U));});});
goto _LL5;default: _LL12: _LL13:
# 4744
({struct Cyc_String_pa_PrintArg_struct _tmp806=({struct Cyc_String_pa_PrintArg_struct _tmp9D9;_tmp9D9.tag=0U,({
struct _dyneither_ptr _tmpC46=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(e));_tmp9D9.f1=_tmpC46;});_tmp9D9;});struct Cyc_String_pa_PrintArg_struct _tmp807=({struct Cyc_String_pa_PrintArg_struct _tmp9D8;_tmp9D8.tag=0U,({struct _dyneither_ptr _tmpC47=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(in_t));_tmp9D8.f1=_tmpC47;});_tmp9D8;});void*_tmp804[2U];_tmp804[0]=& _tmp806,_tmp804[1]=& _tmp807;({unsigned int _tmpC49=loc;struct _dyneither_ptr _tmpC48=({const char*_tmp805="hidden type variable %s isn't abstracted in type %s";_tag_dyneither(_tmp805,sizeof(char),52U);});Cyc_Tcutil_terr(_tmpC49,_tmpC48,_tag_dyneither(_tmp804,sizeof(void*),2U));});});
goto _LL5;}_LL5:;};}}
# 4756
...
struct Cyc_List_List*_tmp808=Cyc_Tcenv_lookup_type_vars(te);
struct Cyc_Absyn_Kind*expected_kind=Cyc_Tcutil_is_function_type(t)?& Cyc_Tcutil_tak:& Cyc_Tcutil_tmk;
struct Cyc_Tcutil_CVTEnv _tmp809=({unsigned int _tmpC4D=loc;struct Cyc_Tcenv_Tenv*_tmpC4C=te;struct Cyc_Tcutil_CVTEnv _tmpC4B=({struct Cyc_Tcutil_CVTEnv _tmp9DD;_tmp9DD.r=Cyc_Core_heap_region,_tmp9DD.kind_env=_tmp808,_tmp9DD.free_vars=0,_tmp9DD.free_evars=0,_tmp9DD.generalize_evars=generalize_evars,_tmp9DD.fn_result=0;_tmp9DD;});struct Cyc_Absyn_Kind*_tmpC4A=expected_kind;Cyc_Tcutil_check_valid_type(_tmpC4D,_tmpC4C,_tmpC4B,_tmpC4A,1,t);});
# 4765
struct Cyc_List_List*_tmp80A=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Tvar*(*f)(struct _tuple29*),struct Cyc_List_List*x))Cyc_List_map)((struct Cyc_Absyn_Tvar*(*)(struct _tuple29*))Cyc_Core_fst,_tmp809.free_vars);
struct Cyc_List_List*_tmp80B=((struct Cyc_List_List*(*)(void*(*f)(struct _tuple30*),struct Cyc_List_List*x))Cyc_List_map)((void*(*)(struct _tuple30*))Cyc_Core_fst,_tmp809.free_evars);
# 4769
if(_tmp808 != 0){
struct Cyc_List_List*_tmp80C=0;
{struct Cyc_List_List*_tmp80D=_tmp80A;for(0;(unsigned int)_tmp80D;_tmp80D=_tmp80D->tl){
struct Cyc_Absyn_Tvar*_tmp80E=(struct Cyc_Absyn_Tvar*)_tmp80D->hd;
int found=0;
{struct Cyc_List_List*_tmp80F=_tmp808;for(0;(unsigned int)_tmp80F;_tmp80F=_tmp80F->tl){
if(Cyc_Absyn_tvar_cmp(_tmp80E,(struct Cyc_Absyn_Tvar*)_tmp80F->hd)== 0){found=1;break;}}}
if(!found)
_tmp80C=({struct Cyc_List_List*_tmp810=_cycalloc(sizeof(*_tmp810));_tmp810->hd=(struct Cyc_Absyn_Tvar*)_tmp80D->hd,_tmp810->tl=_tmp80C;_tmp810;});}}
# 4779
_tmp80A=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(_tmp80C);}
# 4785
{struct Cyc_List_List*x=_tmp80A;for(0;x != 0;x=x->tl){
void*_tmp811=Cyc_Absyn_compress_kb(((struct Cyc_Absyn_Tvar*)x->hd)->kind);void*_tmp812=_tmp811;enum Cyc_Absyn_AliasQual _tmp820;struct Cyc_Core_Opt**_tmp81F;struct Cyc_Absyn_Kind*_tmp81E;struct Cyc_Core_Opt**_tmp81D;struct Cyc_Core_Opt**_tmp81C;struct Cyc_Core_Opt**_tmp81B;struct Cyc_Core_Opt**_tmp81A;struct Cyc_Core_Opt**_tmp819;struct Cyc_Core_Opt**_tmp818;switch(*((int*)_tmp812)){case 1U: _LL1: _tmp818=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Unknown_kb_Absyn_KindBound_struct*)_tmp812)->f1;_LL2:
 _tmp819=_tmp818;goto _LL4;case 2U: switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f2)->kind){case Cyc_Absyn_BoxKind: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f2)->aliasqual == Cyc_Absyn_Top){_LL3: _tmp819=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f1;_LL4:
 _tmp81A=_tmp819;goto _LL6;}else{goto _LLD;}case Cyc_Absyn_MemKind: switch(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f2)->aliasqual){case Cyc_Absyn_Top: _LL5: _tmp81A=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f1;_LL6:
 _tmp81B=_tmp81A;goto _LL8;case Cyc_Absyn_Aliasable: _LL7: _tmp81B=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f1;_LL8:
# 4791
({struct Cyc_Core_Opt*_tmpC4E=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_bk);*_tmp81B=_tmpC4E;});goto _LL0;case Cyc_Absyn_Unique: _LL9: _tmp81C=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f1;_LLA:
# 4793
({struct Cyc_Core_Opt*_tmpC4F=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_ubk);*_tmp81C=_tmpC4F;});goto _LL0;default: goto _LLD;}case Cyc_Absyn_RgnKind: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f2)->aliasqual == Cyc_Absyn_Top){_LLB: _tmp81D=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f1;_LLC:
# 4795
({struct Cyc_Core_Opt*_tmpC50=Cyc_Tcutil_kind_to_bound_opt(& Cyc_Tcutil_rk);*_tmp81D=_tmpC50;});goto _LL0;}else{goto _LLD;}default: _LLD: _tmp81F=(struct Cyc_Core_Opt**)&((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f1;_tmp81E=((struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*)_tmp812)->f2;_LLE:
# 4797
({struct Cyc_Core_Opt*_tmpC51=Cyc_Tcutil_kind_to_bound_opt(_tmp81E);*_tmp81F=_tmpC51;});goto _LL0;}default: if(((struct Cyc_Absyn_Kind*)((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp812)->f1)->kind == Cyc_Absyn_MemKind){_LLF: _tmp820=(((struct Cyc_Absyn_Eq_kb_Absyn_KindBound_struct*)_tmp812)->f1)->aliasqual;_LL10:
# 4799
({struct Cyc_String_pa_PrintArg_struct _tmp815=({struct Cyc_String_pa_PrintArg_struct _tmp9DB;_tmp9DB.tag=0U,({
struct _dyneither_ptr _tmpC52=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_tvar2string((struct Cyc_Absyn_Tvar*)x->hd));_tmp9DB.f1=_tmpC52;});_tmp9DB;});struct Cyc_String_pa_PrintArg_struct _tmp816=({struct Cyc_String_pa_PrintArg_struct _tmp9DA;_tmp9DA.tag=0U,({struct _dyneither_ptr _tmpC53=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(({struct Cyc_Absyn_Kind*_tmp817=_cycalloc(sizeof(*_tmp817));_tmp817->kind=Cyc_Absyn_MemKind,_tmp817->aliasqual=_tmp820;_tmp817;})));_tmp9DA.f1=_tmpC53;});_tmp9DA;});void*_tmp813[2U];_tmp813[0]=& _tmp815,_tmp813[1]=& _tmp816;({unsigned int _tmpC55=loc;struct _dyneither_ptr _tmpC54=({const char*_tmp814="type variable %s cannot have kind %s";_tag_dyneither(_tmp814,sizeof(char),37U);});Cyc_Tcutil_terr(_tmpC55,_tmpC54,_tag_dyneither(_tmp813,sizeof(void*),2U));});});
goto _LL0;}else{_LL11: _LL12:
 goto _LL0;}}_LL0:;}}
# 4806
if(_tmp80A != 0  || _tmp80B != 0){
{void*_tmp821=Cyc_Tcutil_compress(t);void*_tmp822=_tmp821;struct Cyc_List_List**_tmp823;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp822)->tag == 5U){_LL14: _tmp823=(struct Cyc_List_List**)&(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp822)->f1).tvars;_LL15:
# 4809
 if(*_tmp823 == 0){
# 4811
({struct Cyc_List_List*_tmpC56=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_copy)(_tmp80A);*_tmp823=_tmpC56;});
_tmp80A=0;}
# 4814
...
# 4817
if(_tmp80A != 0)
({struct Cyc_String_pa_PrintArg_struct _tmp826=({struct Cyc_String_pa_PrintArg_struct _tmp9DC;_tmp9DC.tag=0U,_tmp9DC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)_tmp80A->hd)->name);_tmp9DC;});void*_tmp824[1U];_tmp824[0]=& _tmp826;({unsigned int _tmpC58=loc;struct _dyneither_ptr _tmpC57=({const char*_tmp825="unbound type variable %s";_tag_dyneither(_tmp825,sizeof(char),25U);});Cyc_Tcutil_terr(_tmpC58,_tmpC57,_tag_dyneither(_tmp824,sizeof(void*),1U));});});
if(!Cyc_Tcutil_is_function_type(t) || !te->in_tempest)
Cyc_Tcutil_check_free_evars(_tmp80B,t,loc);}};}
# 4828
...
{void*_tmp827=Cyc_Tcutil_compress(t);void*_tmp828=_tmp827;struct Cyc_Absyn_FnInfo _tmp82B;if(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp828)->tag == 5U){_LL1: _tmp82B=((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp828)->f1;_LL2:
# 4834
 fd->i=_tmp82B;
({int _tmpC59=
Cyc_Tcutil_extract_const_from_typedef(loc,(_tmp82B.ret_tqual).print_const,_tmp82B.ret_type);
# 4835
((fd->i).ret_tqual).real_const=_tmpC59;});
# 4837
goto _LL0;}else{_LL3: _LL4:
({void*_tmp829=0U;({struct _dyneither_ptr _tmpC5A=({const char*_tmp82A="check_fndecl_valid_type: not a FnType";_tag_dyneither(_tmp82A,sizeof(char),38U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC5A,_tag_dyneither(_tmp829,sizeof(void*),0U));});});}_LL0:;}{
# 4840
struct _RegionHandle _tmp82C=_new_region("r");struct _RegionHandle*r=& _tmp82C;_push_region(r);
({struct Cyc_List_List*_tmpC5C=((struct Cyc_List_List*(*)(struct _dyneither_ptr*(*f)(struct _tuple10*),struct Cyc_List_List*x))Cyc_List_map)((struct _dyneither_ptr*(*)(struct _tuple10*t))Cyc_Tcutil_fst_fdarg,(fd->i).args);unsigned int _tmpC5B=loc;Cyc_Tcutil_check_unique_vars(_tmpC5C,_tmpC5B,({const char*_tmp82D="function declaration has repeated parameter";_tag_dyneither(_tmp82D,sizeof(char),44U);}));});
# 4844
fd->cached_type=t;
# 4841
;_pop_region(r);};}
...
# 4855
struct Cyc_Tcutil_CVTEnv _tmp82E=({unsigned int _tmpC61=loc;struct Cyc_Tcenv_Tenv*_tmpC60=te;struct Cyc_Tcutil_CVTEnv _tmpC5F=({struct Cyc_Tcutil_CVTEnv _tmp9E0;_tmp9E0.r=Cyc_Core_heap_region,_tmp9E0.kind_env=bound_tvars,_tmp9E0.free_vars=0,_tmp9E0.free_evars=0,_tmp9E0.generalize_evars=0,_tmp9E0.fn_result=0;_tmp9E0;});struct Cyc_Absyn_Kind*_tmpC5E=expected_kind;int _tmpC5D=allow_abs_aggr;Cyc_Tcutil_check_valid_type(_tmpC61,_tmpC60,_tmpC5F,_tmpC5E,_tmpC5D,t);});
# 4859
struct Cyc_List_List*_tmp82F=({struct _RegionHandle*_tmpC63=Cyc_Core_heap_region;struct Cyc_List_List*_tmpC62=((struct Cyc_List_List*(*)(struct Cyc_Absyn_Tvar*(*f)(struct _tuple29*),struct Cyc_List_List*x))Cyc_List_map)((struct Cyc_Absyn_Tvar*(*)(struct _tuple29*))Cyc_Core_fst,_tmp82E.free_vars);Cyc_Tcutil_remove_bound_tvars(_tmpC63,_tmpC62,bound_tvars);});
# 4861
...
({struct Cyc_String_pa_PrintArg_struct _tmp834=({struct Cyc_String_pa_PrintArg_struct _tmp9DF;_tmp9DF.tag=0U,_tmp9DF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp831);_tmp9DF;});struct Cyc_String_pa_PrintArg_struct _tmp835=({struct Cyc_String_pa_PrintArg_struct _tmp9DE;_tmp9DE.tag=0U,({struct _dyneither_ptr _tmpC64=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp9DE.f1=_tmpC64;});_tmp9DE;});void*_tmp832[2U];_tmp832[0]=& _tmp834,_tmp832[1]=& _tmp835;({unsigned int _tmpC66=loc;struct _dyneither_ptr _tmpC65=({const char*_tmp833="unbound type variable %s in type %s";_tag_dyneither(_tmp833,sizeof(char),36U);});Cyc_Tcutil_terr(_tmpC66,_tmpC65,_tag_dyneither(_tmp832,sizeof(void*),2U));});});}}
# 4866
if(!allow_evars)
...
if(tv->identity == - 1)
({int _tmpC67=Cyc_Tcutil_new_tvar_id();tv->identity=_tmpC67;});}
# 4875
...
({struct Cyc_String_pa_PrintArg_struct _tmp838=({struct Cyc_String_pa_PrintArg_struct _tmp9E2;_tmp9E2.tag=0U,_tmp9E2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)msg);_tmp9E2;});struct Cyc_String_pa_PrintArg_struct _tmp839=({struct Cyc_String_pa_PrintArg_struct _tmp9E1;_tmp9E1.tag=0U,({struct _dyneither_ptr _tmpC68=(struct _dyneither_ptr)((struct _dyneither_ptr)a2string(vs->hd));_tmp9E1.f1=_tmpC68;});_tmp9E1;});void*_tmp836[2U];_tmp836[0]=& _tmp838,_tmp836[1]=& _tmp839;({unsigned int _tmpC6A=loc;struct _dyneither_ptr _tmpC69=({const char*_tmp837="%s: %s";_tag_dyneither(_tmp837,sizeof(char),7U);});Cyc_Tcutil_terr(_tmpC6A,_tmpC69,_tag_dyneither(_tmp836,sizeof(void*),2U));});});}}}
# 4890
...
({struct Cyc_List_List*_tmpC6C=tvs;unsigned int _tmpC6B=loc;((void(*)(int(*cmp)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*vs,unsigned int loc,struct _dyneither_ptr(*a2string)(struct Cyc_Absyn_Tvar*),struct _dyneither_ptr msg))Cyc_Tcutil_check_unique_unsorted)(Cyc_Absyn_tvar_cmp,_tmpC6C,_tmpC6B,Cyc_Absynpp_tvar2string,({const char*_tmp83A="duplicate type variable";_tag_dyneither(_tmp83A,sizeof(char),24U);}));});}struct _tuple33{struct Cyc_Absyn_Aggrfield*f1;int f2;};struct _tuple34{struct Cyc_List_List*f1;void*f2;};struct _tuple35{struct Cyc_Absyn_Aggrfield*f1;void*f2;};
# 4912 "tcutil.cyc"
...
if(({struct _dyneither_ptr _tmpC6D=(struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)sd_fields->hd)->name;Cyc_strcmp(_tmpC6D,({const char*_tmp83C="";_tag_dyneither(_tmp83C,sizeof(char),1U);}));})!= 0)
fields=({struct Cyc_List_List*_tmp83E=_region_malloc(temp,sizeof(*_tmp83E));({struct _tuple33*_tmpC6E=({struct _tuple33*_tmp83D=_region_malloc(temp,sizeof(*_tmp83D));_tmp83D->f1=(struct Cyc_Absyn_Aggrfield*)sd_fields->hd,_tmp83D->f2=0;_tmp83D;});_tmp83E->hd=_tmpC6E;}),_tmp83E->tl=fields;_tmp83E;});}}
# 4926
...
({struct Cyc_List_List*_tmpC70=({struct Cyc_List_List*_tmp843=_cycalloc(sizeof(*_tmp843));({void*_tmpC6F=(void*)({struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_tmp842=_cycalloc(sizeof(*_tmp842));_tmp842->tag=1U,_tmp842->f1=((*((struct _tuple33*)_tmp841->hd)).f1)->name;_tmp842;});_tmp843->hd=_tmpC6F;}),_tmp843->tl=0;_tmp843;});(*((struct _tuple34*)des->hd)).f1=_tmpC70;});
ans=({struct Cyc_List_List*_tmp845=_region_malloc(rgn,sizeof(*_tmp845));({struct _tuple35*_tmpC71=({struct _tuple35*_tmp844=_region_malloc(rgn,sizeof(*_tmp844));_tmp844->f1=(*((struct _tuple33*)_tmp841->hd)).f1,_tmp844->f2=_tmp85A;_tmp844;});_tmp845->hd=_tmpC71;}),_tmp845->tl=ans;_tmp845;});
break;}}
# 4944
if(_tmp841 == 0)
({struct Cyc_String_pa_PrintArg_struct _tmp848=({struct Cyc_String_pa_PrintArg_struct _tmp9E3;_tmp9E3.tag=0U,_tmp9E3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)aggr_str);_tmp9E3;});void*_tmp846[1U];_tmp846[0]=& _tmp848;({unsigned int _tmpC73=loc;struct _dyneither_ptr _tmpC72=({const char*_tmp847="too many arguments to %s";_tag_dyneither(_tmp847,sizeof(char),25U);});Cyc_Tcutil_terr(_tmpC73,_tmpC72,_tag_dyneither(_tmp846,sizeof(void*),1U));});});}else{
if(_tmp85B->tl != 0)
# 4948
({void*_tmp849=0U;({unsigned int _tmpC75=loc;struct _dyneither_ptr _tmpC74=({const char*_tmp84A="multiple designators are not yet supported";_tag_dyneither(_tmp84A,sizeof(char),43U);});Cyc_Tcutil_terr(_tmpC75,_tmpC74,_tag_dyneither(_tmp849,sizeof(void*),0U));});});else{
# 4951
...
({struct Cyc_String_pa_PrintArg_struct _tmp853=({struct Cyc_String_pa_PrintArg_struct _tmp9E5;_tmp9E5.tag=0U,_tmp9E5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp859);_tmp9E5;});void*_tmp851[1U];_tmp851[0]=& _tmp853;({unsigned int _tmpC79=loc;struct _dyneither_ptr _tmpC78=({const char*_tmp852="member %s has already been used as an argument";_tag_dyneither(_tmp852,sizeof(char),47U);});Cyc_Tcutil_terr(_tmpC79,_tmpC78,_tag_dyneither(_tmp851,sizeof(void*),1U));});});
(*((struct _tuple33*)_tmp850->hd)).f2=1;
ans=({struct Cyc_List_List*_tmp855=_region_malloc(rgn,sizeof(*_tmp855));({struct _tuple35*_tmpC7A=({struct _tuple35*_tmp854=_region_malloc(rgn,sizeof(*_tmp854));_tmp854->f1=(*((struct _tuple33*)_tmp850->hd)).f1,_tmp854->f2=_tmp85A;_tmp854;});_tmp855->hd=_tmpC7A;}),_tmp855->tl=ans;_tmp855;});
break;}}
# 4965
if(_tmp850 == 0)
({struct Cyc_String_pa_PrintArg_struct _tmp858=({struct Cyc_String_pa_PrintArg_struct _tmp9E6;_tmp9E6.tag=0U,_tmp9E6.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp859);_tmp9E6;});void*_tmp856[1U];_tmp856[0]=& _tmp858;({unsigned int _tmpC7C=loc;struct _dyneither_ptr _tmpC7B=({const char*_tmp857="bad field designator %s";_tag_dyneither(_tmp857,sizeof(char),24U);});Cyc_Tcutil_terr(_tmpC7C,_tmpC7B,_tag_dyneither(_tmp856,sizeof(void*),1U));});});
goto _LL3;}}_LL3:;}}}
# 4970
...
({void*_tmp85C=0U;({unsigned int _tmpC7E=loc;struct _dyneither_ptr _tmpC7D=({const char*_tmp85D="too few arguments to struct";_tag_dyneither(_tmp85D,sizeof(char),28U);});Cyc_Tcutil_terr(_tmpC7E,_tmpC7D,_tag_dyneither(_tmp85C,sizeof(void*),0U));});});
break;}}else{
# 4979
int found=0;
for(0;fields != 0;fields=fields->tl){
if((*((struct _tuple33*)fields->hd)).f2){
if(found)({void*_tmp85E=0U;({unsigned int _tmpC80=loc;struct _dyneither_ptr _tmpC7F=({const char*_tmp85F="only one member of a union is allowed";_tag_dyneither(_tmp85F,sizeof(char),38U);});Cyc_Tcutil_terr(_tmpC80,_tmpC7F,_tag_dyneither(_tmp85E,sizeof(void*),0U));});});
found=1;}}
# 4986
if(!found)({void*_tmp860=0U;({unsigned int _tmpC82=loc;struct _dyneither_ptr _tmpC81=({const char*_tmp861="missing member for union";_tag_dyneither(_tmp861,sizeof(char),25U);});Cyc_Tcutil_terr(_tmpC82,_tmpC81,_tag_dyneither(_tmp860,sizeof(void*),0U));});});}{
# 4989
...
({struct Cyc_String_pa_PrintArg_struct _tmp869=({struct Cyc_String_pa_PrintArg_struct _tmp9E7;_tmp9E7.tag=0U,({struct _dyneither_ptr _tmpC83=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e1));_tmp9E7.f1=_tmpC83;});_tmp9E7;});void*_tmp867[1U];_tmp867[0]=& _tmp869;({struct _dyneither_ptr _tmpC84=({const char*_tmp868="we have a cast in a lhs:  %s";_tag_dyneither(_tmp868,sizeof(char),29U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC84,_tag_dyneither(_tmp867,sizeof(void*),1U));});});case 20U: _LL3: _tmp873=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp866)->f1;_LL4:
...
struct _dyneither_ptr _tmpC85=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e1));_tmp9E8.f1=_tmpC85;});_tmp9E8;});void*_tmp86A[1U];_tmp86A[0]=& _tmp86C;({struct _dyneither_ptr _tmpC86=({const char*_tmp86B="found zero pointer aggregate member assignment: %s";_tag_dyneither(_tmp86B,sizeof(char),51U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC86,_tag_dyneither(_tmp86A,sizeof(void*),1U));});});
...
struct _dyneither_ptr _tmpC87=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e1));_tmp9E9.f1=_tmpC87;});_tmp9E9;});void*_tmp86D[1U];_tmp86D[0]=& _tmp86F;({struct _dyneither_ptr _tmpC88=({const char*_tmp86E="found zero pointer instantiate/noinstantiate: %s";_tag_dyneither(_tmp86E,sizeof(char),49U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC88,_tag_dyneither(_tmp86D,sizeof(void*),1U));});});
return 0;case 1U: _LLF: _LL10:
 return 0;default: _LL11: _LL12:
({struct Cyc_String_pa_PrintArg_struct _tmp872=({struct Cyc_String_pa_PrintArg_struct _tmp9EA;_tmp9EA.tag=0U,({struct _dyneither_ptr _tmpC89=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(e1));_tmp9EA.f1=_tmpC89;});_tmp9EA;});void*_tmp870[1U];_tmp870[0]=& _tmp872;({struct _dyneither_ptr _tmpC8A=({const char*_tmp871="found bad lhs in is_zero_ptr_deref: %s";_tag_dyneither(_tmp871,sizeof(char),39U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC8A,_tag_dyneither(_tmp870,sizeof(void*),1U));});});}_LL0:;}
# 5026
int Cyc_Tcutil_is_noalias_region(void*r,int must_be_unique){
# 5029
...
# 5041
({struct Cyc_Core_Opt*_tmpC8C=({struct Cyc_Core_Opt*_tmp880=_cycalloc(sizeof(*_tmp880));({void*_tmpC8B=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp87F=_cycalloc(sizeof(*_tmp87F));_tmp87F->tag=2U,_tmp87F->f1=0,_tmp87F->f2=& Cyc_Tcutil_rk;_tmp87F;});_tmp880->v=_tmpC8B;});_tmp880;});*_tmp881=_tmpC8C;});
...
# 5064
({struct Cyc_Core_Opt*_tmpC8F=({struct Cyc_Core_Opt*_tmp890=_cycalloc(sizeof(*_tmp890));({void*_tmpC8E=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp88F=_cycalloc(sizeof(*_tmp88F));_tmp88F->tag=2U,_tmp88F->f1=0,({struct Cyc_Absyn_Kind*_tmpC8D=({struct Cyc_Absyn_Kind*_tmp88E=_cycalloc(sizeof(*_tmp88E));_tmp88E->kind=_tmp891,_tmp88E->aliasqual=Cyc_Absyn_Aliasable;_tmp88E;});_tmp88F->f2=_tmpC8D;});_tmp88F;});_tmp890->v=_tmpC8E;});_tmp890;});*_tmp892=_tmpC8F;});
...
({void*_tmp8B3=0U;({struct _dyneither_ptr _tmpC90=({const char*_tmp8B4="is_noalias_stmt_exp: ill-formed StmtExp";_tag_dyneither(_tmp8B4,sizeof(char),40U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC90,_tag_dyneither(_tmp8B3,sizeof(void*),0U));});});}_LL1A:;}default: _LL13: _LL14:
# 5165
 return 1;}_LL0:;}
# 5182 "tcutil.cyc"
struct _tuple17 Cyc_Tcutil_addressof_props(struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Exp*e){
...
if(_tmp8ED != 0)
return({struct _tuple17 _tmp9F4;_tmp9F4.f1=((*_tmp8ED).f1).real_const,({void*_tmpC91=(Cyc_Tcutil_addressof_props(te,_tmp8FF)).f2;_tmp9F4.f2=_tmpC91;});_tmp9F4;});
...
# 5279
 return({struct _tuple17 _tmp9F6;_tmp9F6.f1=_tmp8F3.real_const,({void*_tmpC92=(Cyc_Tcutil_addressof_props(te,_tmp8FF)).f2;_tmp9F6.f2=_tmpC92;});_tmp9F6;});default: _LL49: _LL4A:
 return bogus_ans;}_LL42:;}default: _LLB: _LLC:
# 5283
({void*_tmp8F4=0U;({unsigned int _tmpC94=e->loc;struct _dyneither_ptr _tmpC93=({const char*_tmp8F5="unary & applied to non-lvalue";_tag_dyneither(_tmp8F5,sizeof(char),30U);});Cyc_Tcutil_terr(_tmpC94,_tmpC93,_tag_dyneither(_tmp8F4,sizeof(void*),0U));});});
return bogus_ans;}_LL0:;}
# 5290
void Cyc_Tcutil_check_bound(unsigned int loc,unsigned int i,void*b,int do_warn){
struct Cyc_Absyn_Exp*_tmp900=({void*_tmpC95=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmpC95,b);});
if(_tmp900 == 0)return;{
...
if(do_warn)
({struct Cyc_Int_pa_PrintArg_struct _tmp906=({struct Cyc_Int_pa_PrintArg_struct _tmp9F9;_tmp9F9.tag=1U,_tmp9F9.f1=(unsigned long)((int)_tmp90D);_tmp9F9;});struct Cyc_Int_pa_PrintArg_struct _tmp907=({struct Cyc_Int_pa_PrintArg_struct _tmp9F8;_tmp9F8.tag=1U,_tmp9F8.f1=(unsigned long)((int)i);_tmp9F8;});void*_tmp904[2U];_tmp904[0]=& _tmp906,_tmp904[1]=& _tmp907;({unsigned int _tmpC97=loc;struct _dyneither_ptr _tmpC96=({const char*_tmp905="a dereference will be out of bounds: %d <= %d";_tag_dyneither(_tmp905,sizeof(char),46U);});Cyc_Tcutil_warn(_tmpC97,_tmpC96,_tag_dyneither(_tmp904,sizeof(void*),2U));});});else{
# 5299
({struct Cyc_Int_pa_PrintArg_struct _tmp90A=({struct Cyc_Int_pa_PrintArg_struct _tmp9FB;_tmp9FB.tag=1U,_tmp9FB.f1=(unsigned long)((int)_tmp90D);_tmp9FB;});struct Cyc_Int_pa_PrintArg_struct _tmp90B=({struct Cyc_Int_pa_PrintArg_struct _tmp9FA;_tmp9FA.tag=1U,_tmp9FA.f1=(unsigned long)((int)i);_tmp9FA;});void*_tmp908[2U];_tmp908[0]=& _tmp90A,_tmp908[1]=& _tmp90B;({unsigned int _tmpC99=loc;struct _dyneither_ptr _tmpC98=({const char*_tmp909="dereference is out of bounds: %d <= %d";_tag_dyneither(_tmp909,sizeof(char),39U);});Cyc_Tcutil_terr(_tmpC99,_tmpC98,_tag_dyneither(_tmp908,sizeof(void*),2U));});});}}
return;};}
# 5303
...
({struct Cyc_String_pa_PrintArg_struct _tmp949=({struct Cyc_String_pa_PrintArg_struct _tmp9FC;_tmp9FC.tag=0U,({struct _dyneither_ptr _tmpC9A=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t));_tmp9FC.f1=_tmpC9A;});_tmp9FC;});void*_tmp947[1U];_tmp947[0]=& _tmp949;({unsigned int _tmpC9C=loc;struct _dyneither_ptr _tmpC9B=({const char*_tmp948="qualifier within typedef type %s is ignored";_tag_dyneither(_tmp948,sizeof(char),44U);});Cyc_Tcutil_warn(_tmpC9C,_tmpC9B,_tag_dyneither(_tmp947,sizeof(void*),1U));});});}
# 5452
goto _LL0;}else{_LL3: _LL4:
 goto _LL0;}_LL0:;}
# 5459
...
({struct Cyc_List_List*_tmpC9D=({struct Cyc_List_List*_tmp94E=_cycalloc(sizeof(*_tmp94E));_tmp94E->hd=(void*)atts->hd,_tmp94E->tl=*_tmp952;_tmp94E;});*_tmp952=_tmpC9D;});}else{
# 5469
...
({void*_tmp950=0U;({struct _dyneither_ptr _tmpC9E=({const char*_tmp951="transfer_fn_type_atts";_tag_dyneither(_tmp951,sizeof(char),22U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpC9E,_tag_dyneither(_tmp950,sizeof(void*),0U));});});}_LL0:;}
# 5476
struct Cyc_Absyn_Exp*Cyc_Tcutil_get_type_bound(void*t){
void*_tmp953=Cyc_Tcutil_compress(t);void*_tmp954=_tmp953;struct Cyc_Absyn_Exp*_tmp956;struct Cyc_Absyn_PtrInfo _tmp955;switch(*((int*)_tmp954)){case 3U: _LL1: _tmp955=((struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_tmp954)->f1;_LL2:
 return({void*_tmpC9F=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmpC9F,(_tmp955.ptr_atts).bounds);});case 4U: _LL3: _tmp956=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp954)->f1).num_elts;_LL4:
...
if(convert_tag){
if(bnd->topt == 0)
({void*_tmp960=0U;({struct _dyneither_ptr _tmpCA0=({const char*_tmp961="cannot convert tag without type!";_tag_dyneither(_tmp961,sizeof(char),33U);});((int(*)(struct _dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(_tmpCA0,_tag_dyneither(_tmp960,sizeof(void*),0U));});});{
...
# 5520
 b=Cyc_Absyn_thin_bounds_exp(({void*_tmpCA1=Cyc_Absyn_uint_type;Cyc_Absyn_cast_exp(_tmpCA1,Cyc_Absyn_valueof_exp(_tmp964,0U),0,Cyc_Absyn_No_coercion,0U);}));
