...
struct _tuple0 _tmpFD8;struct _tuple0 _tmp2F0=(_tmpFD8.f1=att1,((_tmpFD8.f2=att2,_tmpFD8)));struct _tuple0 _tmp2F1=_tmp2F0;int _tmp2F3;int _tmp2F5;int _tmp2F7;int _tmp2F9;int _tmp2FB;int _tmp2FD;struct _dyneither_ptr _tmp2FF;struct _dyneither_ptr _tmp301;enum Cyc_Absyn_Format_Type _tmp303;int _tmp304;int _tmp305;enum Cyc_Absyn_Format_Type _tmp307;int _tmp308;int _tmp309;_LL1CB:{struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*_tmp2F2=(struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmp2F1.f1;if(_tmp2F2->tag != 0)goto _LL1CD;else{_tmp2F3=_tmp2F2->f1;}}{struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*_tmp2F4=(struct Cyc_Absyn_Regparm_att_Absyn_Attribute_struct*)_tmp2F1.f2;if(_tmp2F4->tag != 0)goto _LL1CD;else{_tmp2F5=_tmp2F4->f1;}};_LL1CC:
 ...
 _tmp2FB=_tmp2F7;_tmp2FD=_tmp2F9;goto _LL1D0;_LL1CF:{struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_tmp2FA=(struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)_tmp2F1.f1;if(_tmp2FA->tag != 6)goto _LL1D1;else{_tmp2FB=_tmp2FA->f1;}}{struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*_tmp2FC=(struct Cyc_Absyn_Aligned_att_Absyn_Attribute_struct*)_tmp2F1.f2;if(_tmp2FC->tag != 6)goto _LL1D1;else{_tmp2FD=_tmp2FC->f1;}};_LL1D0:
 return Cyc_Core_intcmp(_tmp2FB,_tmp2FD);_LL1D1:{struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*_tmp2FE=(struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*)_tmp2F1.f1;if(_tmp2FE->tag != 8)goto _LL1D3;else{_tmp2FF=_tmp2FE->f1;}}{struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*_tmp300=(struct Cyc_Absyn_Section_att_Absyn_Attribute_struct*)_tmp2F1.f2;if(_tmp300->tag != 8)goto _LL1D3;else{_tmp301=_tmp300->f1;}};_LL1D2:
