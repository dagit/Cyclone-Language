...
void*rel2=Cyc_Tcutil_copy_type(rel);{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_TA4=_cycalloc(sizeof(struct Cyc_Absyn_PointerType_Absyn_Type_struct));_TA4->tag=4;
_TA4->f1.elt_type=elt2;_TA4->f1.elt_tq=tq2;_TA4->f1.ptr_atts.eff=rgn2;_TA4->f1.ptr_atts.nullable=nbl2;_TA4->f1.ptr_atts.bounds=bs2;_TA4->f1.ptr_atts.zero_term=zt2;_TA4->f1.ptr_atts.ptrloc=loc;_TA4->f1.ptr_atts.autoreleased=rel2;_TA4->f1.ptr_atts.aqual=aq;_T1E=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_TA4;}_T1F=(void*)_T1E;return _T1F;}case 5:{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_TA4=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T82;_T20=_TA4->f1;_TA3=_T20.elt_type;_T21=_TA4->f1;_TA1=_T21.tq;_T22=_TA4->f1;_TA2=_T22.num_elts;_T23=_TA4->f1;_TA0=_T23.zero_term;_T24=_TA4->f1;_T9A=_T24.zt_loc;}{void*et=_TA3;struct Cyc_Absyn_Tqual tq=_TA1;struct Cyc_Absyn_Exp*eo=_TA2;void*zt=_TA0;unsigned ztl=_T9A;{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_TA4=_cycalloc(sizeof(struct Cyc_Absyn_ArrayType_Absyn_Type_struct));_TA4->tag=5;
# 376
_TA4->f1.elt_type=Cyc_Tcutil_copy_type(et);_TA4->f1.tq=tq;_TA4->f1.num_elts=Cyc_Tcutil_deep_copy_exp_opt(1,eo);
_TA4->f1.zero_term=Cyc_Tcutil_copy_type(zt);_TA4->f1.zt_loc=ztl;_T25=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_TA4;}_T26=(void*)_T25;
# 376
return _T26;}case 6:{struct Cyc_Absyn_FnType_Absyn_Type_struct*_TA4=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T82;_T27=_TA4->f1;_T99=_T27.tvars;_T28=_TA4->f1;_TA3=_T28.effect;_T29=_TA4->f1;_TA1=_T29.ret_tqual;_T2A=_TA4->f1;_TA2=_T2A.ret_type;_T2B=_TA4->f1;_T98=_T2B.args;_T2C=_TA4->f1;_T97=_T2C.c_varargs;_T2D=_TA4->f1;_T96=_T2D.cyc_varargs;_T2E=_TA4->f1;_T95=_T2E.qual_bnd;_T2F=_TA4->f1;_T94=_T2F.attributes;_T30=_TA4->f1;_T93=_T30.checks_clause;_T31=_TA4->f1;_T92=_T31.checks_assn;_T32=_TA4->f1;_T91=_T32.requires_clause;_T33=_TA4->f1;_T90=_T33.requires_assn;_T34=_TA4->f1;_T8F=_T34.ensures_clause;_T35=_TA4->f1;_T8E=_T35.ensures_assn;_T36=_TA4->f1;_T8D=_T36.throws_clause;_T37=_TA4->f1;_T8C=_T37.throws_assn;_T38=_TA4->f1;_T8B=_T38.return_value;_T39=_TA4->f1;_T8A=_T39.arg_vardecls;_T3A=_TA4->f1;_T89=_T3A.effconstr;}{struct Cyc_List_List*tvs=_T99;void*effopt=_TA3;struct Cyc_Absyn_Tqual rt_tq=_TA1;void*rt=_TA2;struct Cyc_List_List*args=_T98;int c_varargs=_T97;struct Cyc_Absyn_VarargInfo*cyc_varargs=_T96;struct Cyc_List_List*qb=_T95;struct Cyc_List_List*atts=_T94;struct Cyc_Absyn_Exp*chk=_T93;struct Cyc_AssnDef_ExistAssnFn*chk_rlns=_T92;struct Cyc_Absyn_Exp*req=_T91;struct Cyc_AssnDef_ExistAssnFn*req_rlns=_T90;struct Cyc_Absyn_Exp*ens=_T8F;struct Cyc_AssnDef_ExistAssnFn*ens_rlns=_T8E;struct Cyc_Absyn_Exp*thrws=_T8D;struct Cyc_AssnDef_ExistAssnFn*thrws_rlns=_T8C;struct Cyc_Absyn_Vardecl*ret_val=_T8B;struct Cyc_List_List*argvds=_T8A;struct Cyc_List_List*effc=_T89;_T3C=Cyc_List_map;{
# 380
struct Cyc_List_List*(*_TA4)(struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct Cyc_Absyn_Tvar*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*))_T3C;_T3B=_TA4;}_T3D=tvs;{struct Cyc_List_List*tvs2=_T3B(Cyc_Tcutil_copy_tvar,_T3D);
...
struct Cyc_List_List*(*_TA4)(struct _tuple9*(*)(struct _tuple9*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple9*(*)(struct _tuple9*),struct Cyc_List_List*))_T40;_T3F=_TA4;}_T41=args;{struct Cyc_List_List*args2=_T3F(Cyc_Tcutil_copy_arg,_T41);
int c_varargs2=c_varargs;
if(cyc_varargs!=0)goto _TL7F;_T42=0;goto _TL80;_TL7F:{struct Cyc_Absyn_VarargInfo*_TA4=_cycalloc(sizeof(struct Cyc_Absyn_VarargInfo));_T44=cyc_varargs;*_TA4=*_T44;_T43=(struct Cyc_Absyn_VarargInfo*)_TA4;}_T42=_T43;_TL80: {struct Cyc_Absyn_VarargInfo*cyc_varargs2=_T42;
...
struct Cyc_List_List*(*_TA4)(struct _tuple15*(*)(struct _tuple15*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple15*(*)(struct _tuple15*),struct Cyc_List_List*))_T4A;_T49=_TA4;}_T4B=qb;{struct Cyc_List_List*qb2=_T49(Cyc_Tcutil_copy_type_pair,_T4B);
...
# 403
struct Cyc_List_List*(*_TA4)(struct Cyc_Absyn_Vardecl*(*)(struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct Cyc_Absyn_Vardecl*(*)(struct Cyc_Absyn_Vardecl*),struct Cyc_List_List*))_T4D;_T4C=_TA4;}_T4E=argvds;{struct Cyc_List_List*argvds2=_T4C(Cyc_Tcutil_copy_vardecl_opt,_T4E);
struct Cyc_Absyn_Vardecl*ret_val2=Cyc_Tcutil_copy_vardecl_opt(ret_val);{struct Cyc_Absyn_FnType_Absyn_Type_struct*_TA4=_cycalloc(sizeof(struct Cyc_Absyn_FnType_Absyn_Type_struct));_TA4->tag=6;
_TA4->f1.tvars=tvs2;_TA4->f1.effect=effopt2;_TA4->f1.ret_tqual=rt_tq;_TA4->f1.ret_type=rt2;_TA4->f1.args=args2;_TA4->f1.c_varargs=c_varargs2;
_TA4->f1.cyc_varargs=cyc_varargs2;_TA4->f1.qual_bnd=qb2;_TA4->f1.attributes=atts2;_TA4->f1.checks_clause=chk2;_TA4->f1.checks_assn=chk_rlns2;
_TA4->f1.requires_clause=req2;_TA4->f1.requires_assn=req_rlns2;
_TA4->f1.ensures_clause=ens2;_TA4->f1.ensures_assn=ens_rlns2;_TA4->f1.throws_clause=thrws2;_TA4->f1.throws_assn=thrws_rlns2;_TA4->f1.return_value=ret_val2;
_TA4->f1.arg_vardecls=argvds2;_TA4->f1.effconstr=effc2;_T4F=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_TA4;}_T50=(void*)_T4F;
# 405
return _T50;}}}}}}}}case 7:{struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_TA4=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_T82;_T88=_TA4->f1;_T97=_TA4->f2;_T99=_TA4->f3;}{enum Cyc_Absyn_AggrKind k=_T88;int b=_T97;struct Cyc_List_List*fs=_T99;{struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_TA4=_cycalloc(sizeof(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct));_TA4->tag=7;
# 410
_TA4->f1=k;_TA4->f2=b;_T53=Cyc_List_map;{struct Cyc_List_List*(*_TA5)(struct Cyc_Absyn_Aggrfield*(*)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct Cyc_Absyn_Aggrfield*(*)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*))_T53;_T52=_TA5;}_T54=fs;_TA4->f3=_T52(Cyc_Tcutil_copy_field,_T54);_T51=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_TA4;}_T55=(void*)_T51;return _T55;}case 9:{struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_TA4=(struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_T82;_T93=_TA4->f1;}{struct Cyc_Absyn_Exp*e=_T93;{struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_TA4=_cycalloc(sizeof(struct Cyc_Absyn_ValueofType_Absyn_Type_struct));_TA4->tag=9;
_TA4->f1=e;_T56=(struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_TA4;}_T57=(void*)_T56;return _T57;}case 11:{struct Cyc_Absyn_TypeofType_Absyn_Type_struct*_TA4=(struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_T82;_T93=_TA4->f1;}{struct Cyc_Absyn_Exp*e=_T93;{struct Cyc_Absyn_TypeofType_Absyn_Type_struct*_TA4=_cycalloc(sizeof(struct Cyc_Absyn_TypeofType_Absyn_Type_struct));_TA4->tag=11;
_TA4->f1=e;_T58=(struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_TA4;}_T59=(void*)_T58;return _T59;}case 8:{struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_TA4=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_T82;_T87=_TA4->f1;_T99=_TA4->f2;_T86=_TA4->f3;}{struct _tuple1*tdn=_T87;struct Cyc_List_List*ts=_T99;struct Cyc_Absyn_Typedefdecl*td=_T86;{struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_TA4=_cycalloc(sizeof(struct Cyc_Absyn_TypedefType_Absyn_Type_struct));_TA4->tag=8;
# 414
_TA4->f1=tdn;_T5B=ts;_TA4->f2=Cyc_List_map(Cyc_Tcutil_copy_type,_T5B);_TA4->f3=td;_TA4->f4=0;_T5A=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_TA4;}_T5C=(void*)_T5A;return _T5C;}case 10: _T5D=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_T82;_T5E=_T5D->f1;_T5F=(struct Cyc_Absyn_TypeDecl*)_T5E;_T60=_T5F->r;_T61=(int*)_T60;_T62=*_T61;switch(_T62){case 0:{struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*_TA4=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_T82;_T63=_TA4->f1;{struct Cyc_Absyn_TypeDecl _TA5=*_T63;_T64=_TA5.r;{struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*_TA6=(struct Cyc_Absyn_Aggr_td_Absyn_Raw_typedecl_struct*)_T64;_T85=_TA6->f1;}}}{struct Cyc_Absyn_Aggrdecl*ad=_T85;_T66=Cyc_List_map;{
# 417
struct Cyc_List_List*(*_TA4)(void*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(void*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*))_T66;_T65=_TA4;}_T67=ad;_T68=_T67->tvs;{struct Cyc_List_List*targs=_T65(Cyc_Tcutil_tvar2type,_T68);_T69=ad;_T6A=_T69->kind;_T6B=ad;_T6C=_T6B->name;_T6D=
Cyc_Absyn_UnknownAggr(_T6A,_T6C,0);_T6E=targs;_T6F=Cyc_Absyn_aggr_type(_T6D,_T6E);return _T6F;}}case 1:{struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*_TA4=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_T82;_T70=_TA4->f1;{struct Cyc_Absyn_TypeDecl _TA5=*_T70;_T71=_TA5.r;{struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*_TA6=(struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)_T71;_T84=_TA6->f1;}}}{struct Cyc_Absyn_Enumdecl*ed=_T84;_T72=ed;_T73=_T72->name;_T74=
# 420
Cyc_Absyn_enum_type(_T73,0);return _T74;}default:{struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*_TA4=(struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_T82;_T75=_TA4->f1;{struct Cyc_Absyn_TypeDecl _TA5=*_T75;_T76=_TA5.r;{struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*_TA6=(struct Cyc_Absyn_Datatype_td_Absyn_Raw_typedecl_struct*)_T76;_T83=_TA6->f1;}}}{struct Cyc_Absyn_Datatypedecl*dd=_T83;_T78=Cyc_List_map;{
# 422
struct Cyc_List_List*(*_TA4)(void*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(void*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*))_T78;_T77=_TA4;}_T79=dd;_T7A=_T79->tvs;{struct Cyc_List_List*targs=_T77(Cyc_Tcutil_tvar2type,_T7A);{struct Cyc_Absyn_UnknownDatatypeInfo _TA4;_T7C=dd;
_TA4.name=_T7C->name;_TA4.is_extensible=0;_T7B=_TA4;}_T7D=Cyc_Absyn_UnknownDatatype(_T7B);_T7E=targs;_T7F=Cyc_Absyn_datatype_type(_T7D,_T7E);return _T7F;}}};default:{struct Cyc_Absyn_SubsetType_Absyn_Type_struct*_TA4=(struct Cyc_Absyn_SubsetType_Absyn_Type_struct*)_T82;_T8B=_TA4->f1;_T93=_TA4->f2;_T92=_TA4->f3;}{struct Cyc_Absyn_Vardecl*vd=_T8B;struct Cyc_Absyn_Exp*w=_T93;struct Cyc_AssnDef_ExistAssnFn*a=_T92;
# 425
struct Cyc_Absyn_Vardecl*vd2=Cyc_Tcutil_copy_vardecl_opt(vd);
struct Cyc_Absyn_Exp*w2=Cyc_Tcutil_deep_copy_exp(1,w);
struct Cyc_AssnDef_ExistAssnFn*a2=a;{struct Cyc_Absyn_SubsetType_Absyn_Type_struct*_TA4=_cycalloc(sizeof(struct Cyc_Absyn_SubsetType_Absyn_Type_struct));_TA4->tag=12;
_TA4->f1=vd2;_TA4->f2=w2;_TA4->f3=a2;_T80=(struct Cyc_Absyn_SubsetType_Absyn_Type_struct*)_TA4;}_T81=(void*)_T80;return _T81;}};}
# 433
...
# 804
struct Cyc_List_List*(*_T45)(struct _tuple17*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple17*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*))_T2F;_T2E=_T45;}_T30=tvs;_T31=_T2E(Cyc_Tcutil_region_free_subst,_T30);_T32=_check_null(eff);{void*e=Cyc_Tcutil_substitute(_T31,_T32);_T33=
...
if(new_t1!=t1)goto _TL487;if(new_e!=e)goto _TL487;if(new_zt!=zt)goto _TL487;_T16=t;goto _TL488;_TL487:{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_TB5=_cycalloc(sizeof(struct Cyc_Absyn_ArrayType_Absyn_Type_struct));_TB5->tag=5;
_TB5->f1.elt_type=new_t1;_TB5->f1.tq=tq;_TB5->f1.num_elts=new_e;_TB5->f1.zero_term=new_zt;_TB5->f1.zt_loc=ztl;_T17=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_TB5;}_T16=(void*)_T17;_TL488:
# 2445
 return _T16;}case 4:{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_TB5=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T9D;_T18=_TB5->f1;_TB4=_T18.elt_type;_T19=_TB5->f1;_TB0=_T19.elt_tq;_T1A=_TB5->f1;_T1B=_T1A.ptr_atts;_TB3=_T1B.eff;_T1C=_TB5->f1;_T1D=_T1C.ptr_atts;_TB2=_T1D.nullable;_T1E=_TB5->f1;_T1F=_T1E.ptr_atts;_TB1=_T1F.bounds;_T20=_TB5->f1;_T21=_T20.ptr_atts;_TAE=_T21.zero_term;_T22=_TB5->f1;_T23=_T22.ptr_atts;_TAD=_T23.autoreleased;_T24=_TB5->f1;_T25=_T24.ptr_atts;_TAC=_T25.aqual;}{void*t1=_TB4;struct Cyc_Absyn_Tqual tq=_TB0;void*r=_TB3;void*n=_TB2;void*b=_TB1;void*zt=_TAE;void*rel=_TAD;void*aq=_TAC;
# 2448
void*new_t1=Cyc_Tcutil_rsubstitute(rgn,inst,t1);
...
return _T26;_TL489:{struct Cyc_Absyn_PtrInfo _TB5;
_TB5.elt_type=new_t1;_TB5.elt_tq=tq;_TB5.ptr_atts.eff=new_r;_TB5.ptr_atts.nullable=n;_TB5.ptr_atts.bounds=new_b;_TB5.ptr_atts.zero_term=new_zt;_TB5.ptr_atts.ptrloc=0;_TB5.ptr_atts.autoreleased=new_rel;_TB5.ptr_atts.aqual=new_aq;_T27=_TB5;}_T28=Cyc_Absyn_pointer_type(_T27);return _T28;}case 6:{struct Cyc_Absyn_FnType_Absyn_Type_struct*_TB5=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_T9D;_T29=_TB5->f1;_TB4=_T29.tvars;_T2A=_TB5->f1;_TB3=_T2A.effect;_T2B=_TB5->f1;_TB0=_T2B.ret_tqual;_T2C=_TB5->f1;_TB2=_T2C.ret_type;_T2D=_TB5->f1;_TAB=_T2D.args;_T2E=_TB5->f1;_TAA=_T2E.c_varargs;_T2F=_TB5->f1;_TA9=_T2F.cyc_varargs;_T30=_TB5->f1;_TA8=_T30.qual_bnd;_T31=_TB5->f1;_TA7=_T31.attributes;_T32=_TB5->f1;_TA6=_T32.checks_clause;_T33=_TB5->f1;_TA5=_T33.requires_clause;_T34=_TB5->f1;_TA4=_T34.ensures_clause;_T35=_TB5->f1;_TA3=_T35.throws_clause;_T36=_TB5->f1;_TA2=_T36.return_value;_T37=_TB5->f1;_TA1=_T37.arg_vardecls;_T38=_TB5->f1;_TA0=_T38.effconstr;}{struct Cyc_List_List*vs=_TB4;void*eff=_TB3;struct Cyc_Absyn_Tqual rtq=_TB0;void*rtyp=_TB2;struct Cyc_List_List*args=_TAB;int c_varargs=_TAA;struct Cyc_Absyn_VarargInfo*cyc_varargs=_TA9;struct Cyc_List_List*qb=_TA8;struct Cyc_List_List*atts=_TA7;struct Cyc_Absyn_Exp*chk=_TA6;struct Cyc_Absyn_Exp*req=_TA5;struct Cyc_Absyn_Exp*ens=_TA4;struct Cyc_Absyn_Exp*thrws=_TA3;struct Cyc_Absyn_Vardecl*ret_value=_TA2;struct Cyc_List_List*argvds=_TA1;struct Cyc_List_List*effconstr=_TA0;_T39=Cyc_Tcutil_skip_fntypes;
# 2459
if(!_T39)goto _TL48B;_T3A=t;return _T3A;_TL48B:{
# 2461
struct Cyc_List_List*p=vs;_TL490: if(p!=0)goto _TL48E;else{goto _TL48F;}
_TL48E: _T3C=rgn;{struct Cyc_List_List*_TB5=_region_malloc(_T3C,0U,sizeof(struct Cyc_List_List));_T3E=rgn;{struct _tuple17*_TB6=_region_malloc(_T3E,0U,sizeof(struct _tuple17));_T3F=p;_T40=_T3F->hd;_TB6->f0=(struct Cyc_Absyn_Tvar*)_T40;_T41=p;_T42=_T41->hd;_T43=(struct Cyc_Absyn_Tvar*)_T42;_TB6->f1=Cyc_Absyn_var_type(_T43);_T3D=(struct _tuple17*)_TB6;}_TB5->hd=_T3D;_TB5->tl=inst;_T3B=(struct Cyc_List_List*)_TB5;}inst=_T3B;_T44=p;
# 2461
p=_T44->tl;goto _TL490;_TL48F:;}_T45=rgn;_T46=rgn;_T48=Cyc_List_rmap_c;{
# 2464
struct Cyc_List_List*(*_TB5)(struct _RegionHandle*,struct _tuple23*(*)(struct _RegionHandle*,struct _tuple9*),struct _RegionHandle*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _RegionHandle*,struct _tuple23*(*)(struct _RegionHandle*,struct _tuple9*),struct _RegionHandle*,struct Cyc_List_List*))_T48;_T47=_TB5;}_T49=rgn;_T4A=rgn;_T4B=args;_T4C=_T47(_T49,Cyc_Tcutil_substitute_f1,_T4A,_T4B);{
# 2463
struct _tuple0 _TB5=Cyc_List_rsplit(_T45,_T46,_T4C);struct Cyc_List_List*_TB6;struct Cyc_List_List*_TB7;_TB7=_TB5.f0;_TB6=_TB5.f1;{struct Cyc_List_List*qs=_TB7;struct Cyc_List_List*ts=_TB6;
# 2465
...
struct Cyc_List_List*(*_TB8)(struct _tuple9*(*)(struct _tuple9*,void*),struct Cyc_List_List*,struct Cyc_List_List*)=(struct Cyc_List_List*(*)(struct _tuple9*(*)(struct _tuple9*,void*),struct Cyc_List_List*,struct Cyc_List_List*))_T4E;_T4D=_TB8;}_T4F=args;_T50=ts2;args2=_T4D(Cyc_Tcutil_substitute_f2,_T4F,_T50);goto _TL492;_TL491: _TL492:
...
# 2475
_TL495: _T52=cyc_varargs;{struct Cyc_Absyn_VarargInfo _TB8=*_T52;int _TB9;void*_TBA;struct Cyc_Absyn_Tqual _TBB;struct _fat_ptr*_TBC;_TBC=_TB8.name;_TBB=_TB8.tq;_TBA=_TB8.type;_TB9=_TB8.inject;{struct _fat_ptr*n=_TBC;struct Cyc_Absyn_Tqual tq=_TBB;void*t=_TBA;int i=_TB9;
void*t2=Cyc_Tcutil_rsubstitute(rgn,inst,t);
if(t2!=t)goto _TL497;_T53=cyc_varargs;goto _TL498;_TL497:{struct Cyc_Absyn_VarargInfo*_TBD=_cycalloc(sizeof(struct Cyc_Absyn_VarargInfo));_TBD->name=n;_TBD->tq=tq;_TBD->type=t2;_TBD->inject=i;_T54=(struct Cyc_Absyn_VarargInfo*)_TBD;}_T53=_T54;_TL498: cyc_varargs2=_T53;}}_TL496: {
# 2479
...
if(av==0)goto _TL49D;{struct Cyc_Absyn_Vardecl*_TB8=_cycalloc(sizeof(struct Cyc_Absyn_Vardecl));_T58=av;
*_TB8=*_T58;_T57=(struct Cyc_Absyn_Vardecl*)_TB8;}av2=_T57;_T59=av2;_T5A=rgn;_T5B=inst;_T5C=av;_T5D=_T5C->type;
_T59->type=Cyc_Tcutil_rsubstitute(_T5A,_T5B,_T5D);goto _TL49E;_TL49D: _TL49E:{struct Cyc_List_List*_TB8=_cycalloc(sizeof(struct Cyc_List_List));
# 2499
_TB8->hd=av2;_TB8->tl=argvds2;_T5E=(struct Cyc_List_List*)_TB8;}argvds2=_T5E;}_T5F=avs;
# 2492
avs=_T5F->tl;goto _TL49C;_TL49B:;}
# 2501
argvds2=Cyc_List_imp_rev(argvds2);{
struct Cyc_Absyn_Vardecl*ret_value2=0;
if(ret_value==0)goto _TL49F;{struct Cyc_Absyn_Vardecl*_TB8=_cycalloc(sizeof(struct Cyc_Absyn_Vardecl));_T61=ret_value;
*_TB8=*_T61;_T60=(struct Cyc_Absyn_Vardecl*)_TB8;}ret_value2=_T60;_T62=ret_value2;_T63=rgn;_T64=inst;_T65=ret_value2;_T66=_T65->type;
...
# 2527
struct Cyc_List_List*boundvds;boundvds=_cycalloc(sizeof(struct Cyc_List_List));_T75=boundvds;_T75->hd=Cyc_AssnDef_memory;_T76=boundvds;{struct Cyc_List_List*_TB8=_cycalloc(sizeof(struct Cyc_List_List));
_TB8->hd=Cyc_AssnDef_pre_memory;_TB8->tl=argvds2;_T77=(struct Cyc_List_List*)_TB8;}_T76->tl=_T77;
...
_check_null(ens_am2);_T7A=*_T79;{struct Cyc_List_List*_TB8=_cycalloc(sizeof(struct Cyc_List_List));_TB8->hd=ret_value2;_TB8->tl=boundvds;_T7B=(struct Cyc_List_List*)_TB8;}ens_assn2=Cyc_AssnDef_assnmap2existassnfn(_T7A,_T7B);}goto _TL4A6;_TL4A5: _TL4A6:
# 2534
...
_check_null(thrws_am2);_T7E=*_T7D;_T7F=boundvds;thrws_assn2=Cyc_AssnDef_assnmap2existassnfn(_T7E,_T7F);}goto _TL4A8;_TL4A7: _TL4A8:{struct Cyc_Absyn_FnType_Absyn_Type_struct*_TB8=_cycalloc(sizeof(struct Cyc_Absyn_FnType_Absyn_Type_struct));_TB8->tag=6;
# 2539
_TB8->f1.tvars=vs;_TB8->f1.effect=eff2;_TB8->f1.ret_tqual=rtq;_TB8->f1.ret_type=Cyc_Tcutil_rsubstitute(rgn,inst,rtyp);_TB8->f1.args=args2;
_TB8->f1.c_varargs=c_varargs;_TB8->f1.cyc_varargs=cyc_varargs2;_TB8->f1.qual_bnd=qb2;_TB8->f1.attributes=atts;
_TB8->f1.checks_clause=chk2;_TB8->f1.checks_assn=chk_assn2;
_TB8->f1.requires_clause=req2;_TB8->f1.requires_assn=req_assn2;_TB8->f1.ensures_clause=ens2;_TB8->f1.ensures_assn=ens_assn2;
_TB8->f1.throws_clause=thrws2;_TB8->f1.throws_assn=thrws_assn2;_TB8->f1.return_value=ret_value2;_TB8->f1.arg_vardecls=argvds2;_TB8->f1.effconstr=effconstr2;_T80=(struct Cyc_Absyn_FnType_Absyn_Type_struct*)_TB8;}_T81=(void*)_T80;
# 2539
return _T81;}}}}}}}}}}case 7:{struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_TB5=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_T9D;_T9F=_TB5->f1;_TAA=_TB5->f2;_TB4=_TB5->f3;}{enum Cyc_Absyn_AggrKind k=_T9F;int b=_TAA;struct Cyc_List_List*fs=_TB4;
# 2545
struct Cyc_List_List*new_fs=Cyc_Tcutil_subst_aggrfields(rgn,inst,fs);
if(fs!=new_fs)goto _TL4A9;_T82=t;goto _TL4AA;_TL4A9:{struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_TB5=_cycalloc(sizeof(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct));_TB5->tag=7;_TB5->f1=k;_TB5->f2=b;_TB5->f3=new_fs;_T83=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_TB5;}_T82=(void*)_T83;_TL4AA: return _T82;}case 3:{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_TB5=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T9D;_T84=_TB5->f2;_TB4=(void*)_T84;}{void*r=_TB4;_TB4=r;goto _LL10;}case 1:{struct Cyc_Absyn_Evar_Absyn_Type_struct*_TB5=(struct Cyc_Absyn_Evar_Absyn_Type_struct*)_T9D;_T85=_TB5->f2;_TB4=(void*)_T85;}_LL10: {void*r=_TB4;
# 2549
if(r!=0)goto _TL4AB;_T86=t;goto _TL4AC;_TL4AB: _T86=Cyc_Tcutil_rsubstitute(rgn,inst,r);_TL4AC: return _T86;}case 0:{struct Cyc_Absyn_AppType_Absyn_Type_struct*_TB5=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T9D;_T87=_TB5->f1;_TB4=(void*)_T87;_TAB=_TB5->f2;}{void*c=_TB4;struct Cyc_List_List*ts=_TAB;
# 2554
struct Cyc_List_List*new_ts=Cyc_Tcutil_substs(rgn,inst,Cyc_Core_heap_region,ts);
if(ts!=new_ts)goto _TL4AD;_T88=t;goto _TL4AE;_TL4AD:{struct Cyc_Absyn_AppType_Absyn_Type_struct*_TB5=_cycalloc(sizeof(struct Cyc_Absyn_AppType_Absyn_Type_struct));_TB5->tag=0;_TB5->f1=c;_TB5->f2=new_ts;_T89=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_TB5;}_T88=(void*)_T89;_TL4AE: return _T88;}case 9:{struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_TB5=(struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_T9D;_TA6=_TB5->f1;}{struct Cyc_Absyn_Exp*e=_TA6;
# 2557
struct Cyc_Absyn_Exp*new_e=Cyc_Tcutil_rsubsexp(rgn,inst,e);
if(new_e!=e)goto _TL4AF;_T8A=t;goto _TL4B0;_TL4AF:{struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_TB5=_cycalloc(sizeof(struct Cyc_Absyn_ValueofType_Absyn_Type_struct));_TB5->tag=9;_TB5->f1=new_e;_T8B=(struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_TB5;}_T8A=(void*)_T8B;_TL4B0: return _T8A;}case 11:{struct Cyc_Absyn_TypeofType_Absyn_Type_struct*_TB5=(struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_T9D;_TA6=_TB5->f1;}{struct Cyc_Absyn_Exp*e=_TA6;
# 2560
struct Cyc_Absyn_Exp*new_e=Cyc_Tcutil_rsubsexp(rgn,inst,e);
if(new_e!=e)goto _TL4B1;_T8C=t;goto _TL4B2;_TL4B1:{struct Cyc_Absyn_TypeofType_Absyn_Type_struct*_TB5=_cycalloc(sizeof(struct Cyc_Absyn_TypeofType_Absyn_Type_struct));_TB5->tag=11;_TB5->f1=new_e;_T8D=(struct Cyc_Absyn_TypeofType_Absyn_Type_struct*)_TB5;}_T8C=(void*)_T8D;_TL4B2: return _T8C;}case 10: _T8E=Cyc_Tcutil_skip_fntypes;
# 2563
if(!_T8E)goto _TL4B3;_T8F=t;return _T8F;_TL4B3:{struct Cyc_Warn_String_Warn_Warg_struct _TB5;_TB5.tag=0;
_TB5.f1=_tag_fat("found typedecltype in rsubs",sizeof(char),28U);_T90=_TB5;}{struct Cyc_Warn_String_Warn_Warg_struct _TB5=_T90;void*_TB6[1];_TB6[0]=& _TB5;_T92=Cyc_Warn_impos2;{int(*_TB7)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_T92;_T91=_TB7;}_T93=_tag_fat(_TB6,sizeof(void*),1);_T91(_T93);}default:{struct Cyc_Absyn_SubsetType_Absyn_Type_struct*_TB5=(struct Cyc_Absyn_SubsetType_Absyn_Type_struct*)_T9D;_TA2=_TB5->f1;_TA6=_TB5->f2;_T9E=_TB5->f3;}{struct Cyc_Absyn_Vardecl*vd=_TA2;struct Cyc_Absyn_Exp*e=_TA6;struct Cyc_AssnDef_ExistAssnFn*a=_T9E;
# 2566
...
struct Cyc_Absyn_Exp*e2=Cyc_Tcutil_rsubsexp(rgn,inst,e);{struct Cyc_Absyn_SubsetType_Absyn_Type_struct*_TB5=_cycalloc(sizeof(struct Cyc_Absyn_SubsetType_Absyn_Type_struct));_TB5->tag=12;
_TB5->f1=vd;_TB5->f2=e;_TB5->f3=a;_T9B=(struct Cyc_Absyn_SubsetType_Absyn_Type_struct*)_TB5;}_T9C=(void*)_T9B;return _T9C;}}};}
# 2573
...
# 2940
_check_null(_TB);{void*_TA0=Cyc_Absyn_compress(_TC);_TD=(int*)_TA0;_TE=*_TD;if(_TE!=5)goto _TL554;{struct _tuple13 _TA1;
# 2942
_TA1.f0=1;_TA1.f1=Cyc_Absyn_heap_rgn_type;_TF=_TA1;}return _TF;_TL554:{struct _tuple13 _TA1;_T11=vd;_T12=_T11->tq;
...
# 2946
_check_null(_T15);{void*_TA0=Cyc_Absyn_compress(_T16);_T17=(int*)_TA0;_T18=*_T17;if(_T18!=5)goto _TL556;{struct _tuple13 _TA1;
_TA1.f0=1;_T1A=vd;_T1B=_T1A->rgn;_TA1.f1=_check_null(_T1B);_T19=_TA1;}return _T19;_TL556: _T1C=vd;
# 2949
...
# 2959
if(!_T2A)goto _TL558;_T2B=bogus_ans;return _T2B;_TL558: {
# 2961
...
if(_T4C)goto _TL569;else{goto _TL56A;}_TL56A: _T4D=finfo;_T4E=_T4D->tq;_T4F=_T4E.real_const;if(_T4F)goto _TL569;else{goto _TL567;}_TL569: _T4B=1;goto _TL568;_TL567: _T4B=c;_TL568: _TA6.f0=_T4B;_TA6.f1=t;_T4A=_TA6;}return _T4A;}}_TL565: _T50=bogus_ans;
# 2984
return _T50;}_TL563: goto _LL2B;_TL561: goto _LL2B;default: _LL2B: _T51=bogus_ans;
...
# 2989
if(!_T52)goto _TL56B;_T53=bogus_ans;return _T53;_TL56B: {
# 2991
int subset=0;_T54=e1;_T55=_T54->topt;_T56=
# 2994
_check_null(_T55);{void*_T9F=Cyc_Absyn_compress(_T56);void*_TA0;void*_TA1;_T57=(int*)_T9F;_T58=*_T57;if(_T58!=4)goto _TL56D;{struct Cyc_Absyn_PointerType_Absyn_Type_struct*_TA2=(struct Cyc_Absyn_PointerType_Absyn_Type_struct*)_T9F;_T59=_TA2->f1;_TA1=_T59.elt_type;_T5A=_TA2->f1;_T5B=_T5A.ptr_atts;_TA0=_T5B.eff;}{void*t1=_TA1;void*r=_TA0;
# 2996
...
# 3004
finfo=Cyc_Absyn_lookup_field(fs,f);goto _LL38;}case 0: _T5F=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_TA2;_T60=_T5F->f1;_T61=(int*)_T60;_T62=*_T61;if(_T62!=24)goto _TL570;_T63=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_TA2;_T64=_T63->f1;_T65=(struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_T64;_T66=_T65->f1;_T67=_T66.KnownAggr;_T68=_T67.tag;if(_T68!=2)goto _TL572;{struct Cyc_Absyn_AppType_Absyn_Type_struct*_TA6=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_TA2;_T69=_TA6->f1;{struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*_TA7=(struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_T69;_T6A=_TA7->f1;_T6B=_T6A.KnownAggr;_T6C=_T6B.val;{struct Cyc_Absyn_Aggrdecl*_TA8=*_T6C;_TA3=_TA8;}}}{struct Cyc_Absyn_Aggrdecl*ad=_TA3;
# 3006
finfo=Cyc_Absyn_lookup_decl_field(ad,f);goto _LL38;}_TL572: goto _LL3F;_TL570: goto _LL3F;default: _LL3F: _T6D=bogus_ans;
return _T6D;}_LL38:;}
# 3009
if(finfo==0)goto _TL574;_T6E=finfo;_T6F=_T6E->width;if(_T6F!=0)goto _TL574;{struct _tuple13 _TA2;_T72=subset;
if(!_T72)goto _TL576;_T71=1;goto _TL577;_TL576: _T73=finfo;_T74=_T73->tq;_T71=_T74.real_const;_TL577: _TA2.f0=_T71;_TA2.f1=r;_T70=_TA2;}return _T70;_TL574: _T75=bogus_ans;
return _T75;}_TL56D: _T76=bogus_ans;
...
Cyc_Tcutil_is_cvar_type(b);if(!_T0)goto _TL57B;
if(i <= 1U)goto _TL57D;_T1=loc;_T2=
Cyc_Tcutil_ptrbnd_cvar_equivalent(b);_T3=_check_null(_T2);_T4=
Cyc_Absyn_fatconst();_T5=
# 3047
Cyc_BansheeIf_equality_constraint(_T3,_T4);_T6=Cyc_BansheeIf_add_constraint(_T1,_T5);if(_T6)goto _TL57F;else{goto _TL581;}
# 3049
_TL581:{struct Cyc_Warn_String_Warn_Warg_struct _T19;_T19.tag=0;_T19.f1=_tag_fat("cannot infer an appropriate bound",sizeof(char),34U);_T7=_T19;}{struct Cyc_Warn_String_Warn_Warg_struct _T19=_T7;void*_T1A[1];_T1A[0]=& _T19;_T9=do_warn;if(!_T9)goto _TL582;_T8=Cyc_Warn_warn2;goto _TL583;_TL582: _T8=Cyc_Warn_err2;_TL583: _TA=loc;_TB=_tag_fat(_T1A,sizeof(void*),1);_T8(_TA,_TB);}goto _TL580;_TL57F: _TL580: goto _TL57E;_TL57D: _TL57E:
# 3052
 return;_TL57B: _TC=
# 3054
Cyc_Absyn_bounds_one();_TD=b;{struct Cyc_Absyn_Exp*eopt=Cyc_Tcutil_get_bounds_exp(_TC,_TD);
if(eopt!=0)goto _TL584;return;_TL584: {
...
if(!_TE)goto _TL586;if(j > i)goto _TL586;{struct Cyc_Warn_String_Warn_Warg_struct _T1C;_T1C.tag=0;
...
# 3058
if(!_T16)goto _TL588;_T15=Cyc_Warn_warn2;goto _TL589;_TL588: _T15=Cyc_Warn_err2;_TL589: _T17=loc;_T18=_tag_fat(_T20,sizeof(void*),4);_T15(_T17,_T18);}}}}goto _TL587;_TL586: _TL587:
# 3060
 return;}}}}
# 3063
...
# 3093
if(_T10==0)goto _TL58D;_T11=var_okay;
return _T11;_TL58D: _T12=vd;_T13=_T12->type;{
...
# 3104
rec(0,valueof_okay,e1);if(!_T19)goto _TL590;_T1A=rec(0,valueof_okay,e2);if(!_T1A)goto _TL590;_T18=
rec(0,valueof_okay,e3);goto _TL591;_TL590: _T18=0;_TL591:
# 3104
...
# 3116
rec(0,valueof_okay,e1);if(!_T20)goto _TL594;_T1F=rec(0,valueof_okay,e2);goto _TL595;_TL594: _T1F=0;_TL595: return _T1F;}case 27:{struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*_T3C=(struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_T35;_T3A=_T3C->f1;}{struct Cyc_Absyn_Exp*e=_T3A;_T21=
...
# 3121
_TL599: if(des!=0)goto _TL597;else{goto _TL598;}
_TL597: _T22=valueof_okay;_T23=des;_T24=_T23->hd;_T25=(struct _tuple16*)_T24;_T26=*_T25;_T27=_T26.f1;_T28=Cyc_Tcutil_cnst_exp(0,_T22,_T27);if(_T28)goto _TL59A;else{goto _TL59C;}
_TL59C: return 0;_TL59A: _T29=des;
# 3121
des=_T29->tl;goto _TL599;_TL598:
# 3124
...
# 3127
_TL5A0: if(es!=0)goto _TL59E;else{goto _TL59F;}
_TL59E: _T2A=valueof_okay;_T2B=es;_T2C=_T2B->hd;_T2D=(struct Cyc_Absyn_Exp*)_T2C;_T2E=Cyc_Tcutil_cnst_exp(0,_T2A,_T2D);if(_T2E)goto _TL5A1;else{goto _TL5A3;}
_TL5A3: return 0;_TL5A1: _T2F=es;
# 3127
es=_T2F->tl;goto _TL5A0;_TL59F:
# 3130
...
# 3133
void*_T3C=_T31->r;struct Cyc_Absyn_Exp*_T3D;_T32=(int*)_T3C;_T33=*_T32;if(_T33!=1)goto _TL5A4;{struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*_T3E=(struct Cyc_Absyn_Exp_s_Absyn_Raw_stmt_struct*)_T3C;_T3D=_T3E->f1;}{struct Cyc_Absyn_Exp*e=_T3D;_T34=
Cyc_Tcutil_cnst_exp(var_okay,valueof_okay,e);return _T34;}_TL5A4:
 return 0;;}}default:
# 3137
 return 0;};}}
# 3140
...
# 3157
if(edo==0)goto _TL5AA;else{goto _TL5AB;}_TL5AB: _T7=edo;_T8=_T7->fields;if(_T8==0)goto _TL5AA;else{goto _TL5A8;}
_TL5AA: return 0;_TL5A8: _T9=edo;_TA=_T9->fields;_TB=_TA->v;_T35=(struct Cyc_List_List*)_TB;goto _LL17;}case 20: _TC=c;{struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*_T37=(struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*)_TC;_T35=_T37->f1;}_LL17: {struct Cyc_List_List*fs=_T35;{
# 3161
struct Cyc_List_List*fs2=fs;_TL5AF: if(fs2!=0)goto _TL5AD;else{goto _TL5AE;}
_TL5AD: _TD=fs2;_TE=_TD->hd;_TF=(struct Cyc_Absyn_Enumfield*)_TE;_T10=_TF->tag;if(_T10!=0)goto _TL5B0;_T11=fs2==fs;
return _T11;_TL5B0: _T12=fs2;_T13=_T12->hd;_T14=(struct Cyc_Absyn_Enumfield*)_T13;_T15=_T14->tag;{
...
if(!_T16)goto _TL5B2;if(i!=0U)goto _TL5B2;
return 1;_TL5B2:;}}_T17=fs2;
# 3161
fs2=_T17->tl;goto _TL5AF;_TL5AE:;}
# 3168
...
if(_T1A!=0)goto _TL5B4;return 0;_TL5B4: _T1B=ad;_T1C=_T1B->impl;_T1D=_T1C->exist_vars;
if(_T1D==0)goto _TL5B6;return 0;_TL5B6: _T1E=ad;_T1F=_T1E->kind;_T20=(int)_T1F;
if(_T20!=1)goto _TL5B8;_T21=ad;_T22=_T21->impl;_T23=_T22->tagged;if(!_T23)goto _TL5B8;return 0;_TL5B8: _T24=ad;_T25=_T24->tvs;_T26=ts;_T27=ad;_T28=_T27->impl;_T29=_T28->fields;_T2A=
...
_TL5BD: if(fs!=0)goto _TL5BB;else{goto _TL5BC;}
_TL5BB: _T0=fs;_T1=_T0->hd;_T2=(struct Cyc_Absyn_Aggrfield*)_T1;{void*t=_T2->type;_T3=
Cyc_Tcutil_zeroable_type(t);if(!_T3)goto _TL5BE;goto _TL5BA;_TL5BE: _T4=rgn;_T5=inst;_T6=fs;_T7=_T6->hd;_T8=(struct Cyc_Absyn_Aggrfield*)_T7;_T9=_T8->type;
t=Cyc_Tcutil_rsubstitute(_T4,_T5,_T9);_TA=
Cyc_Tcutil_zeroable_type(t);if(_TA)goto _TL5C0;else{goto _TL5C2;}_TL5C2:{int _TD=0;_npop_handler(0);return _TD;}_TL5C0:;}_TL5BA: _TB=fs;
# 3189
fs=_TB->tl;goto _TL5BD;_TL5BC: {int _TD=1;_npop_handler(0);return _TD;}}_pop_region();}
# 3199
void Cyc_Tcutil_check_no_qual(unsigned loc,void*t){void*_T0;int*_T1;int _T2;void*_T3;struct Cyc_Absyn_Typedefdecl*_T4;struct Cyc_Absyn_Tqual _T5;int _T6;struct Cyc_Absyn_Tqual _T7;int _T8;struct Cyc_Absyn_Tqual _T9;int _TA;struct Cyc_Absyn_Tqual _TB;int _TC;struct Cyc_Warn_String_Warn_Warg_struct _TD;struct Cyc_Warn_Typ_Warn_Warg_struct _TE;struct Cyc_Warn_String_Warn_Warg_struct _TF;unsigned _T10;struct _fat_ptr _T11;struct Cyc_Absyn_Typedefdecl*_T12;_T0=t;_T1=(int*)_T0;_T2=*_T1;if(_T2!=8)goto _TL5C3;_T3=t;{struct Cyc_Absyn_TypedefType_Absyn_Type_struct*_T13=(struct Cyc_Absyn_TypedefType_Absyn_Type_struct*)_T3;_T12=_T13->f3;}{struct Cyc_Absyn_Typedefdecl*tdopt=_T12;
# 3202
if(tdopt!=0)goto _TL5C5;
return;_TL5C5: _T4=tdopt;{
struct Cyc_Absyn_Tqual tq=_T4->tq;_T5=tq;_T6=_T5.print_const;
if(_T6)goto _TL5C9;else{goto _TL5CC;}_TL5CC: _T7=tq;_T8=_T7.q_volatile;if(_T8)goto _TL5C9;else{goto _TL5CB;}_TL5CB: _T9=tq;_TA=_T9.q_restrict;if(_TA)goto _TL5C9;else{goto _TL5CA;}_TL5CA: _TB=tq;_TC=_TB.real_const;if(_TC)goto _TL5C9;else{goto _TL5C7;}
_TL5C9:{struct Cyc_Warn_String_Warn_Warg_struct _T13;_T13.tag=0;_T13.f1=_tag_fat("qualifier within typedef type ",sizeof(char),31U);_TD=_T13;}{struct Cyc_Warn_String_Warn_Warg_struct _T13=_TD;{struct Cyc_Warn_Typ_Warn_Warg_struct _T14;_T14.tag=2;_T14.f1=t;_TE=_T14;}{struct Cyc_Warn_Typ_Warn_Warg_struct _T14=_TE;{struct Cyc_Warn_String_Warn_Warg_struct _T15;_T15.tag=0;_T15.f1=_tag_fat(" is ignored",sizeof(char),12U);_TF=_T15;}{struct Cyc_Warn_String_Warn_Warg_struct _T15=_TF;void*_T16[3];_T16[0]=& _T13;_T16[1]=& _T14;_T16[2]=& _T15;_T10=loc;_T11=_tag_fat(_T16,sizeof(void*),3);Cyc_Warn_warn2(_T10,_T11);}}}goto _TL5C8;_TL5C7: _TL5C8:
 return;}}_TL5C3:
 return;;}
# 3215
...
# 3230
if(!_T9)goto _TL5CF;_T7=0;goto _TL5D0;_TL5CF: _T7=x;_TL5D0: return _T7;}default:
 return 0;};}
# 3236
...
_TL5D4: if(l!=0)goto _TL5D2;else{goto _TL5D3;}
_TL5D2: _T0=l;_T1=_T0->hd;_T2=(void**)_T1;if(_T2==0)goto _TL5D5;{struct Cyc_List_List*_T9=_cycalloc(sizeof(struct Cyc_List_List));_T4=l;_T5=_T4->hd;_T6=(void**)_T5;_T9->hd=*_T6;_T9->tl=res;_T3=(struct Cyc_List_List*)_T9;}res=_T3;goto _TL5D6;_TL5D5: _TL5D6: _T7=l;
# 3238
l=_T7->tl;goto _TL5D4;_TL5D3: _T8=res;
# 3240
return _T8;}
# 3243
...
void*_T1E=Cyc_Absyn_compress(t);void*_T1F;struct Cyc_Absyn_Exp*_T20;struct Cyc_Absyn_Tqual _T21;void*_T22;_T0=(int*)_T1E;_T1=*_T0;if(_T1!=5)goto _TL5D7;{struct Cyc_Absyn_ArrayType_Absyn_Type_struct*_T23=(struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_T1E;_T2=_T23->f1;_T22=_T2.elt_type;_T3=_T23->f1;_T21=_T3.tq;_T4=_T23->f1;_T20=_T4.num_elts;_T5=_T23->f1;_T1F=_T5.zero_term;}{void*et=_T22;struct Cyc_Absyn_Tqual tq=_T21;struct Cyc_Absyn_Exp*eopt=_T20;void*zt=_T1F;
# 3246
void*b;
if(eopt!=0)goto _TL5D9;
b=Cyc_Absyn_fat_bound_type;goto _TL5DA;
_TL5D9: _T6=convert_tag;if(!_T6)goto _TL5DB;_T7=eopt;_T8=_T7->topt;
if(_T8!=0)goto _TL5DD;{struct Cyc_Warn_String_Warn_Warg_struct _T23;_T23.tag=0;
_T23.f1=_tag_fat("cannot convert tag without type!",sizeof(char),33U);_T9=_T23;}{struct Cyc_Warn_String_Warn_Warg_struct _T23=_T9;void*_T24[1];_T24[0]=& _T23;_TB=Cyc_Warn_impos2;{int(*_T25)(struct _fat_ptr)=(int(*)(struct _fat_ptr))_TB;_TA=_T25;}_TC=_tag_fat(_T24,sizeof(void*),1);_TA(_TC);}goto _TL5DE;_TL5DD: _TL5DE: _TD=eopt;_TE=_TD->topt;{
void*_T23=Cyc_Absyn_compress(_TE);void*_T24;_TF=(int*)_T23;_T10=*_TF;if(_T10!=0)goto _TL5DF;_T11=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T23;_T12=_T11->f1;_T13=(int*)_T12;_T14=*_T13;if(_T14!=5)goto _TL5E1;_T15=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T23;_T16=_T15->f2;if(_T16==0)goto _TL5E3;{struct Cyc_Absyn_AppType_Absyn_Type_struct*_T25=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T23;_T17=_T25->f2;{struct Cyc_List_List _T26=*_T17;_T18=_T26.hd;_T24=(void*)_T18;}}{void*t=_T24;_T19=
# 3255
Cyc_Absyn_valueof_exp(t,0U);b=Cyc_Absyn_thin_bounds_exp(_T19);goto _LL5;}_TL5E3: goto _LL8;_TL5E1: goto _LL8;_TL5DF: _LL8: _T1B=
# 3257
Cyc_Tcutil_is_const_exp(eopt);if(!_T1B)goto _TL5E5;_T1A=Cyc_Absyn_thin_bounds_exp(eopt);goto _TL5E6;_TL5E5: _T1A=Cyc_Absyn_fat_bound_type;_TL5E6: b=_T1A;_LL5:;}goto _TL5DC;
# 3260
_TL5DB: b=Cyc_Absyn_thin_bounds_exp(eopt);_TL5DC: _TL5DA: _T1C=
Cyc_Absyn_atb_type(et,rgn,aqual,tq,b,zt,Cyc_Absyn_false_type);return _T1C;}_TL5D7: _T1D=t;
return _T1D;;}
# 3266
...
void*_T8=_T1.f0;_T2=(int*)_T8;_T3=*_T2;if(_T3!=0)goto _TL5E7;_T4=(struct Cyc_Absyn_AppType_Absyn_Type_struct*)_T8;_T5=_T4->f1;_T6=(int*)_T5;_T7=*_T6;if(_T7!=15)goto _TL5E9;
# 3269
return 1;_TL5E9: goto _LL3;_TL5E7: _LL3:
# 3271
 return 0;;}}
# 3275
...
struct Cyc_List_List*args=_T10->args;_TL5F0: _T11=args;_T12=(unsigned)_T11;if(_T12)goto _TL5EE;else{goto _TL5EF;}
_TL5EE: _T13=args;_T14=_T13->hd;_T15=(struct _tuple9*)_T14;_T16=_T15->f2;_T17=fn;_T18=env;Cyc_Tcutil_visit_for_cvars(_T16,_T17,_T18);_T19=args;
# 3307
args=_T19->tl;goto _TL5F0;_TL5EF:;}
# 3310
...
# 3313
_TL5F4: _T1C=ts;_T1D=(unsigned)_T1C;if(_T1D)goto _TL5F2;else{goto _TL5F3;}_TL5F2: _T1E=ts;_T1F=_T1E->hd;_T20=fn;_T21=env;Cyc_Tcutil_visit_for_cvars(_T1F,_T20,_T21);_T22=ts;ts=_T22->tl;goto _TL5F4;_TL5F3:
 return;}case 7: _T23=t;_T24=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_T23;_T25=_T24->f2;if(_T25!=1)goto _TL5F5;_T26=t;{struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_T33=(struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_T26;_T30=_T33->f3;}{struct Cyc_List_List*fields=_T30;
# 3316
_TL5FA: _T27=fields;_T28=(unsigned)_T27;if(_T28)goto _TL5F8;else{goto _TL5F9;}
_TL5F8: _T29=fields;_T2A=_T29->hd;_T2B=(struct Cyc_Absyn_Aggrfield*)_T2A;_T2C=_T2B->type;_T2D=fn;_T2E=env;Cyc_Tcutil_visit_for_cvars(_T2C,_T2D,_T2E);_T2F=fields;
# 3316
fields=_T2F->tl;goto _TL5FA;_TL5F9:
# 3319
 return;}_TL5F5: goto _LLB;default: _LLB:
# 3321
 return;};}
# 3325
...
_check_null(b);_T1=*_T0;_T2=env;if(_T1!=_T2)goto _TL5FB;_T3=b;_T4=& Cyc_Kinds_ptrbko;_T5=(struct Cyc_Core_Opt*)_T4;
*_T3=Cyc_Absyn_cvar_type(_T5);goto _TL5FC;_TL5FB: _TL5FC:;}
# 3331
static void Cyc_Tcutil_replace_cvar_fn(void**b,void*env){void**_T0;void*_T1;int _T2;void**_T3;_T0=
_check_null(b);_T1=*_T0;_T2=Cyc_Tcutil_is_cvar_type(_T1);if(!_T2)goto _TL5FD;_T3=b;
*_T3=env;goto _TL5FE;_TL5FD: _TL5FE:;}
# 3337
static void Cyc_Tcutil_revert_one_cvar(void**b,int ignore){void**_T0;int*_T1;int _T2;int _T3;void**_T4;void**_T5;_T0=
_check_null(b);{void*_T6=*_T0;int _T7;_T1=(int*)_T6;_T2=*_T1;if(_T2!=3)goto _TL5FF;{struct Cyc_Absyn_Cvar_Absyn_Type_struct*_T8=(struct Cyc_Absyn_Cvar_Absyn_Type_struct*)_T6;_T7=_T8->f7;}{int ovfat=_T7;_T3=ovfat;
# 3340
if(_T3)goto _TL601;else{goto _TL603;}
_TL603: _T4=b;*_T4=Cyc_Absyn_bounds_one();goto _TL602;
# 3344
_TL601: _T5=b;*_T5=Cyc_Absyn_fat_bound_type;_TL602: goto _LL0;}_TL5FF: goto _LL0;_LL0:;}}
# 3352
...
# 3365
int Cyc_Tcutil_is_main(struct _tuple1*n){struct _tuple1*_T0;union Cyc_Absyn_Nmspace _T1;struct _union_Nmspace_Abs_n _T2;unsigned _T3;union Cyc_Absyn_Nmspace _T4;struct _union_Nmspace_Abs_n _T5;struct Cyc_List_List*_T6;struct _fat_ptr*_T7;struct _fat_ptr _T8;struct _fat_ptr _T9;int _TA;int _TB;struct _fat_ptr*_TC;union Cyc_Absyn_Nmspace _TD;_T0=n;{struct _tuple1 _TE=*_T0;_TD=_TE.f0;_TC=_TE.f1;}{union Cyc_Absyn_Nmspace nms=_TD;struct _fat_ptr*v=_TC;_T1=nms;_T2=_T1.Abs_n;_T3=_T2.tag;if(_T3!=1)goto _TL604;_T4=nms;_T5=_T4.Abs_n;_T6=_T5.val;if(_T6!=0)goto _TL606;_T7=v;_T8=*_T7;_T9=
# 3368
_tag_fat("main",sizeof(char),5U);_TA=Cyc_strcmp(_T8,_T9);_TB=_TA==0;return _TB;_TL606: goto _LL6;_TL604: _LL6:
 return 0;;}}
# 3374
...
_TL60A: _T11=ts;_T12=(unsigned)_T11;if(_T12)goto _TL60B;else{goto _TL60C;}
_TL60B: _T13=ts;_T14=_T13->hd;Cyc_Tcutil_deconstruct_type(_T14);_T15=ts;
ts=_T15->tl;goto _TL60A;_TL60C: _T16=Cyc_stderr;_T17=
# 3414
...
if(!_T2B)goto _TL60D;_T2C=Cyc_stderr;_T2D=
_tag_fat(" resolved to = ",sizeof(char),16U);_T2E=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T2C,_T2D,_T2E);
Cyc_Tcutil_deconstruct_type(r);goto _TL60E;_TL60D: _TL60E: _T2F=Cyc_stderr;_T30=
# 3422
...
if(!_T38)goto _TL60F;_T39=Cyc_stderr;_T3A=
_tag_fat(" with compression = ",sizeof(char),21U);_T3B=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T39,_T3A,_T3B);
Cyc_Tcutil_deconstruct_type(r);goto _TL610;_TL60F: _TL610: _T3C=Cyc_stderr;_T3D=
# 3430
...
if(!_T4B)goto _TL611;{struct Cyc_String_pa_PrintArg_struct _TB7;_TB7.tag=0;_T4D=tv;_T4E=_T4D->aquals_bound;
_TB7.f1=Cyc_Absynpp_typ2string(_T4E);_T4C=_TB7;}{struct Cyc_String_pa_PrintArg_struct _TB7=_T4C;void*_TB8[1];_TB8[0]=& _TB7;_T4F=Cyc_stderr;_T50=_tag_fat(" AQbnd = %s",sizeof(char),12U);_T51=_tag_fat(_TB8,sizeof(void*),1);Cyc_fprintf(_T4F,_T50,_T51);}goto _TL612;_TL611: _TL612: _T52=Cyc_stderr;_T53=
...
struct Cyc_List_List*it=_T77->args;_TL616: if(it!=0)goto _TL614;else{goto _TL615;}
_TL614: _T78=it;_T79=_T78->hd;{struct _tuple9*_TB7=(struct _tuple9*)_T79;void*_TB8;{struct _tuple9 _TB9=*_TB7;_TB8=_TB9.f2;}{void*at=_TB8;_T7A=Cyc_stderr;_T7B=
...
# 3452
it=_T7D->tl;goto _TL616;_TL615:;}_T7E=i;{
# 3457
struct Cyc_List_List*qt=_T7E->qual_bnd;_TL61A: if(qt!=0)goto _TL618;else{goto _TL619;}
_TL618: _T7F=qt;_T80=_T7F->hd;{struct _tuple15*_TB7=(struct _tuple15*)_T80;void*_TB8;void*_TB9;{struct _tuple15 _TBA=*_TB7;_TB9=_TBA.f0;_TB8=_TBA.f1;}{void*t1=_TB9;void*t2=_TB8;_T81=Cyc_stderr;_T82=
...
# 3457
qt=_T87->tl;goto _TL61A;_TL619:;}_T88=Cyc_stderr;_T89=
# 3464
...
if(!_T8D)goto _TL61B;_T8E=i;_T8F=_T8E->effect;
Cyc_Tcutil_deconstruct_type(_T8F);goto _TL61C;
# 3468
_TL61B: _T90=Cyc_stderr;_T91=_tag_fat("NULL",sizeof(char),5U);_T92=_tag_fat(0U,sizeof(void*),0);Cyc_fprintf(_T90,_T91,_T92);_TL61C: goto _LL0;}case 7: _T93=Cyc_stderr;_T94=
# 3471
...
if(!_T9C)goto _TL61D;
Cyc_Tcutil_deconstruct_type(topt);goto _TL61E;_TL61D: _TL61E: goto _LL0;}case 9: _T9D=Cyc_stderr;_T9E=
# 3478
