...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1DE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E1;_tmp4E1.tag=0,({struct _fat_ptr _tmp5DB=({const char*_tmp1DF="integral size mismatch; conversion supplied";_tag_fat(_tmp1DF,sizeof(char),44U);});_tmp4E1.f1=_tmp5DB;});_tmp4E1;});void*_tmp1DD[1];_tmp1DD[0]=& _tmp1DE;Cyc_Warn_warn2(e->loc,_tag_fat(_tmp1DD,sizeof(void*),1));});
...
({void*_tmp5DC=t;Cyc_Unify_unify(_tmp5DC,Cyc_Absyn_bounds_one());});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1E8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E3;_tmp4E3.tag=0,({struct _fat_ptr _tmp5DD=({const char*_tmp1EA="get_bounds_exp: ";_tag_fat(_tmp1EA,sizeof(char),17U);});_tmp4E3.f1=_tmp5DD;});_tmp4E3;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1E9=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4E2;_tmp4E2.tag=2,_tmp4E2.f1=(void*)b;_tmp4E2;});void*_tmp1E7[2];_tmp1E7[0]=& _tmp1E8,_tmp1E7[1]=& _tmp1E9;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp1E7,sizeof(void*),2));});};}}
# 1419
...
struct _tuple20 _tmp200=({struct _tuple20 _tmp4E7;({struct Cyc_Absyn_Exp*_tmp5E2=({void*_tmp5E1=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp5E1,(pinfo_a.ptr_atts).bounds);});_tmp4E7.f1=_tmp5E2;}),({
struct Cyc_Absyn_Exp*_tmp5E0=({void*_tmp5DF=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp5DF,(pinfo_b.ptr_atts).bounds);});_tmp4E7.f2=_tmp5E0;});_tmp4E7;});
# 1455
...
void*_tmp5E3=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp5E3,(pinfo_b.ptr_atts).bounds);}))
goto _LL9;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp205=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E6;_tmp4E6.tag=0,({struct _fat_ptr _tmp5E4=({const char*_tmp206="implicit cast to shorter array";_tag_fat(_tmp206,sizeof(char),31U);});_tmp4E6.f1=_tmp5E4;});_tmp4E6;});void*_tmp204[1];_tmp204[0]=& _tmp205;Cyc_Warn_warn2(loc,_tag_fat(_tmp204,sizeof(void*),1));});
if(!({struct Cyc_Absyn_Exp*_tmp5E5=(struct Cyc_Absyn_Exp*)_check_null(e2);Cyc_Evexp_lte_const_exp(_tmp5E5,(struct Cyc_Absyn_Exp*)_check_null(e1));}))
return 0;
goto _LL9;}}}_LL9:;}
# 1477
...
return 1;
# 1504
if(!({void*_tmp5E8=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp5E8,(pinfo_b.ptr_atts).bounds);})||
...
return e;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _tmp212=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4ED;_tmp4ED.tag=0,({struct _fat_ptr _tmp5E9=({const char*_tmp213="pointer_elt_type";_tag_fat(_tmp213,sizeof(char),17U);});_tmp4ED.f1=_tmp5E9;});_tmp4ED;});void*_tmp211[1];_tmp211[0]=& _tmp212;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp211,sizeof(void*),1));});};}
# 1533
...
return p->rgn;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _tmp218=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4EE;_tmp4EE.tag=0,({struct _fat_ptr _tmp5EA=({const char*_tmp219="pointer_elt_type";_tag_fat(_tmp219,sizeof(char),17U);});_tmp4EE.f1=_tmp5EA;});_tmp4EE;});void*_tmp217[1];_tmp217[0]=& _tmp218;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp217,sizeof(void*),1));});};}
# 1540
...
return 0;
({void*_tmp5EB=(Cyc_Absyn_null_exp(0U))->r;e1->r=_tmp5EB;});
e1->topt=t2;
return 1;}}else{
...
struct _tuple1*v=({struct _tuple1*_tmp239=_cycalloc(sizeof(*_tmp239));_tmp239->f1=Cyc_Absyn_Loc_n,({struct _fat_ptr*_tmp5EE=({struct _fat_ptr*_tmp238=_cycalloc(sizeof(*_tmp238));({struct _fat_ptr _tmp5ED=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp237=({struct Cyc_Int_pa_PrintArg_struct _tmp4F0;_tmp4F0.tag=1,_tmp4F0.f1=(unsigned long)counter ++;_tmp4F0;});void*_tmp235[1];_tmp235[0]=& _tmp237;({struct _fat_ptr _tmp5EC=({const char*_tmp236="__aliasvar%d";_tag_fat(_tmp236,sizeof(char),13U);});Cyc_aprintf(_tmp5EC,_tag_fat(_tmp235,sizeof(void*),1));});});*_tmp238=_tmp5ED;});_tmp238;});_tmp239->f2=_tmp5EE;});_tmp239;});
struct Cyc_Absyn_Vardecl*vd=Cyc_Absyn_new_vardecl(0U,v,e_type,e);
struct Cyc_Absyn_Exp*ve=({void*_tmp5EF=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp234=_cycalloc(sizeof(*_tmp234));_tmp234->tag=4,_tmp234->f1=vd;_tmp234;});Cyc_Absyn_varb_exp(_tmp5EF,e->loc);});
# 1621
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp23F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F5;_tmp4F5.tag=0,({struct _fat_ptr _tmp5F0=({const char*_tmp246="integral size mismatch; ";_tag_fat(_tmp246,sizeof(char),25U);});_tmp4F5.f1=_tmp5F0;});_tmp4F5;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp240=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F4;_tmp4F4.tag=2,_tmp4F4.f1=(void*)t1;_tmp4F4;});struct Cyc_Warn_String_Warn_Warg_struct _tmp241=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F3;_tmp4F3.tag=0,({
struct _fat_ptr _tmp5F1=({const char*_tmp245=" -> ";_tag_fat(_tmp245,sizeof(char),5U);});_tmp4F3.f1=_tmp5F1;});_tmp4F3;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp242=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F2;_tmp4F2.tag=2,_tmp4F2.f1=(void*)t2;_tmp4F2;});struct Cyc_Warn_String_Warn_Warg_struct _tmp243=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F1;_tmp4F1.tag=0,({struct _fat_ptr _tmp5F2=({const char*_tmp244=" conversion supplied";_tag_fat(_tmp244,sizeof(char),21U);});_tmp4F1.f1=_tmp5F2;});_tmp4F1;});void*_tmp23E[5];_tmp23E[0]=& _tmp23F,_tmp23E[1]=& _tmp240,_tmp23E[2]=& _tmp241,_tmp23E[3]=& _tmp242,_tmp23E[4]=& _tmp243;Cyc_Warn_warn2(e->loc,_tag_fat(_tmp23E,sizeof(void*),5));});
Cyc_Tcutil_unchecked_cast(e,t2,1U);
return 1;}
# 1684
if(Cyc_Tcutil_can_insert_alias(e,t1,t2,e->loc)){
if(Cyc_Flags_warn_alias_coerce)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp248=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4FB;_tmp4FB.tag=0,({struct _fat_ptr _tmp5F3=({const char*_tmp250="implicit alias coercion for ";_tag_fat(_tmp250,sizeof(char),29U);});_tmp4FB.f1=_tmp5F3;});_tmp4FB;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp249=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp4FA;_tmp4FA.tag=4,_tmp4FA.f1=e;_tmp4FA;});struct Cyc_Warn_String_Warn_Warg_struct _tmp24A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F9;_tmp4F9.tag=0,({struct _fat_ptr _tmp5F4=({const char*_tmp24F=":";_tag_fat(_tmp24F,sizeof(char),2U);});_tmp4F9.f1=_tmp5F4;});_tmp4F9;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp24B=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F8;_tmp4F8.tag=2,_tmp4F8.f1=(void*)t1;_tmp4F8;});struct Cyc_Warn_String_Warn_Warg_struct _tmp24C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F7;_tmp4F7.tag=0,({struct _fat_ptr _tmp5F5=({const char*_tmp24E=" to ";_tag_fat(_tmp24E,sizeof(char),5U);});_tmp4F7.f1=_tmp5F5;});_tmp4F7;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp24D=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F6;_tmp4F6.tag=2,_tmp4F6.f1=(void*)t2;_tmp4F6;});void*_tmp247[6];_tmp247[0]=& _tmp248,_tmp247[1]=& _tmp249,_tmp247[2]=& _tmp24A,_tmp247[3]=& _tmp24B,_tmp247[4]=& _tmp24C,_tmp247[5]=& _tmp24D;Cyc_Warn_warn2(e->loc,_tag_fat(_tmp247,sizeof(void*),6));});
if(alias_coercion != 0)
*alias_coercion=1;}
# 1691
...
if((int)c != 2)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp252=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4FF;_tmp4FF.tag=0,({struct _fat_ptr _tmp5F6=({const char*_tmp257="implicit cast from ";_tag_fat(_tmp257,sizeof(char),20U);});_tmp4FF.f1=_tmp5F6;});_tmp4FF;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp253=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4FE;_tmp4FE.tag=2,_tmp4FE.f1=(void*)t1;_tmp4FE;});struct Cyc_Warn_String_Warn_Warg_struct _tmp254=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4FD;_tmp4FD.tag=0,({struct _fat_ptr _tmp5F7=({const char*_tmp256=" to ";_tag_fat(_tmp256,sizeof(char),5U);});_tmp4FD.f1=_tmp5F7;});_tmp4FD;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp255=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4FC;_tmp4FC.tag=2,_tmp4FC.f1=(void*)t2;_tmp4FC;});void*_tmp251[4];_tmp251[0]=& _tmp252,_tmp251[1]=& _tmp253,_tmp251[2]=& _tmp254,_tmp251[3]=& _tmp255;Cyc_Warn_warn2(e->loc,_tag_fat(_tmp251,sizeof(void*),4));});
return 1;}
# 1705
return 0;}
# 1711
...
return({struct Cyc_List_List*_tmp260=_region_malloc(r,sizeof(*_tmp260));({struct _tuple12*_tmp5F8=({struct _tuple12*_tmp25F=_region_malloc(r,sizeof(*_tmp25F));_tmp25F->f1=x->tq,_tmp25F->f2=t;_tmp25F;});_tmp260->hd=_tmp5F8;}),_tmp260->tl=0;_tmp260;});
...
if(({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(ts)== 1)
return({struct Cyc_List_List*_tmp26B=_region_malloc(r,sizeof(*_tmp26B));({struct _tuple12*_tmp5F9=({struct _tuple12*_tmp26A=_region_malloc(r,sizeof(*_tmp26A));_tmp26A->f1=tq,_tmp26A->f2=t;_tmp26A;});_tmp26B->hd=_tmp5F9;}),_tmp26B->tl=0;_tmp26B;});
return ts;}}}
# 1745
...
# 1767
return({struct Cyc_List_List*_tmp279=_region_malloc(r,sizeof(*_tmp279));({struct _tuple12*_tmp5FB=({struct _tuple12*_tmp278=_region_malloc(r,sizeof(*_tmp278));({struct Cyc_Absyn_Tqual _tmp5FA=Cyc_Absyn_empty_tqual(0U);_tmp278->f1=_tmp5FA;}),_tmp278->f2=t1;_tmp278;});_tmp279->hd=_tmp5FB;}),_tmp279->tl=0;_tmp279;});{
...
# 1790
 goto _LL0;}_LL0:;}}
# 1793
return({struct Cyc_List_List*_tmp28B=_region_malloc(r,sizeof(*_tmp28B));({struct _tuple12*_tmp5FF=({struct _tuple12*_tmp28A=_region_malloc(r,sizeof(*_tmp28A));({struct Cyc_Absyn_Tqual _tmp5FE=Cyc_Absyn_empty_tqual(0U);_tmp28A->f1=_tmp5FE;}),_tmp28A->f2=t1;_tmp28A;});_tmp28B->hd=_tmp5FF;}),_tmp28B->tl=0;_tmp28B;});}
# 1796
static int Cyc_Tcutil_isomorphic(void*t1,void*t2){
struct _tuple15 _tmp28C=({struct _tuple15 _tmp503;({void*_tmp601=Cyc_Absyn_compress(t1);_tmp503.f1=_tmp601;}),({void*_tmp600=Cyc_Absyn_compress(t2);_tmp503.f2=_tmp600;});_tmp503;});struct _tuple15 _stmttmp51=_tmp28C;struct _tuple15 _tmp28D=_stmttmp51;enum Cyc_Absyn_Size_of _tmp28F;enum Cyc_Absyn_Size_of _tmp28E;if(*((int*)_tmp28D.f1)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f1)->f1)== 1){if(*((int*)_tmp28D.f2)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f2)->f1)== 1){_tmp28E=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f1)->f1)->f2;_tmp28F=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f2)->f1)->f2;{enum Cyc_Absyn_Size_of b1=_tmp28E;enum Cyc_Absyn_Size_of b2=_tmp28F;
# 1799
...
struct Cyc_Absyn_Exp*_tmp2A2=({void*_tmp602=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp602,b_a);});struct Cyc_Absyn_Exp*e1=_tmp2A2;
struct Cyc_Absyn_Exp*_tmp2A3=({void*_tmp603=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp603,b_b);});struct Cyc_Absyn_Exp*e2=_tmp2A3;
if(e1 != e2){
...
if(({int _tmp60A=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(tvs1);_tmp60A != ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(tvs2);}))return 0;{
...
inst=({struct Cyc_List_List*_tmp2AA=_cycalloc(sizeof(*_tmp2AA));({struct _tuple17*_tmp60C=({struct _tuple17*_tmp2A9=_cycalloc(sizeof(*_tmp2A9));_tmp2A9->f1=(struct Cyc_Absyn_Tvar*)tvs2->hd,({void*_tmp60B=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)tvs1->hd);_tmp2A9->f2=_tmp60B;});_tmp2A9;});_tmp2AA->hd=_tmp60C;}),_tmp2AA->tl=inst;_tmp2AA;});
tvs1=tvs1->tl;
tvs2=tvs2->tl;}
# 1883
if(inst != 0){
f1.tvars=0;
f2.tvars=0;
return({struct Cyc_RgnOrder_RgnPO*_tmp60F=po;struct Cyc_List_List*_tmp60E=assume;void*_tmp60D=(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp2AB=_cycalloc(sizeof(*_tmp2AB));_tmp2AB->tag=5,_tmp2AB->f1=f1;_tmp2AB;});Cyc_Tcutil_subtype(_tmp60F,_tmp60E,_tmp60D,(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp2AC=_cycalloc(sizeof(*_tmp2AC));_tmp2AC->tag=5,_tmp2AC->f1=f2;_tmp2AC;}));});}}}
# 1890
...
# 1895
if(({int _tmp610=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(args1);_tmp610 != ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(args2);}))return 0;
# 1897
...
# 1915
if(!({void*_tmp611=(void*)_check_null(f1.effect);Cyc_Tcutil_subset_effect(1,_tmp611,(void*)_check_null(f2.effect));}))return 0;
# 1917
...
struct Cyc_List_List*_tmp2D2=({struct Cyc_List_List*_tmp2DA=_cycalloc(sizeof(*_tmp2DA));({struct _tuple15*_tmp612=({struct _tuple15*_tmp2D9=_cycalloc(sizeof(*_tmp2D9));_tmp2D9->f1=t1,_tmp2D9->f2=t2;_tmp2D9;});_tmp2DA->hd=_tmp612;}),_tmp2DA->tl=0;_tmp2DA;});struct Cyc_List_List*assump=_tmp2D2;
int _tmp2D3=q_b.real_const || !q_a.real_const;int quals_okay=_tmp2D3;
# 2000 "tcutil.cyc"
int _tmp2D4=
({void*_tmp613=b_b;Cyc_Unify_unify(_tmp613,Cyc_Absyn_bounds_one());})&& !Cyc_Tcutil_force_type2bool(0,zt_b);
# 2000
...
struct Cyc_Absyn_Exp*_tmp2D7=({void*_tmp614=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp614,b_a);});struct Cyc_Absyn_Exp*e_a=_tmp2D7;
struct Cyc_Absyn_Exp*_tmp2D8=({void*_tmp615=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp615,b_b);});struct Cyc_Absyn_Exp*e_b=_tmp2D8;
...
int _tmp616=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(ed1->fields))->v);_tmp616 >= ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})((struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(ed2->fields))->v);}))
return 3U;
...
({void*_tmp617=(void*)({struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp2E5=_cycalloc(sizeof(*_tmp2E5));_tmp2E5->tag=14,_tmp2E5->f1=t,_tmp2E5->f2=inner,_tmp2E5->f3=0,_tmp2E5->f4=c;_tmp2E5;});e->r=_tmp617;});
e->topt=t;}}
# 2084
...
return({struct Cyc_Absyn_Tvar*_tmp2EA=_cycalloc(sizeof(*_tmp2EA));({struct _fat_ptr*_tmp61A=({struct _fat_ptr*_tmp2E9=_cycalloc(sizeof(*_tmp2E9));({struct _fat_ptr _tmp619=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp2E8=({struct Cyc_Int_pa_PrintArg_struct _tmp505;_tmp505.tag=1,_tmp505.f1=(unsigned long)Cyc_Tcutil_tvar_counter ++;_tmp505;});void*_tmp2E6[1];_tmp2E6[0]=& _tmp2E8;({struct _fat_ptr _tmp618=({const char*_tmp2E7="#%d";_tag_fat(_tmp2E7,sizeof(char),4U);});Cyc_aprintf(_tmp618,_tag_fat(_tmp2E6,sizeof(void*),1));});});*_tmp2E9=_tmp619;});_tmp2E9;});_tmp2EA->name=_tmp61A;}),_tmp2EA->identity=-1,_tmp2EA->kind=k;_tmp2EA;});}
# 2093
...
if(({struct _fat_ptr _tmp61B=(struct _fat_ptr)*var;Cyc_strcmp(_tmp61B,({const char*_tmp2F6="return_value";_tag_fat(_tmp2F6,sizeof(char),13U);}));})== 0){
({union Cyc_Relations_RelnOp _tmp61C=Cyc_Relations_RReturn();*rop=_tmp61C;});
goto _LL0;}{
# 2129
unsigned c=0U;
...
({union Cyc_Relations_RelnOp _tmp61D=Cyc_Relations_RParam(c);*rop=_tmp61D;});
break;}}}}
# 2137
...
if(vopt != 0 && Cyc_strcmp((struct _fat_ptr)*var,(struct _fat_ptr)*vopt)== 0){
({union Cyc_Relations_RelnOp _tmp61E=Cyc_Relations_RParamNumelts(c);*rop=_tmp61E;});
break;}}}}
# 2149
goto _LL0;}}}default:
 goto _LL0;}_LL0:;}
...
# 2175
return({struct _tuple25*_tmp309=_region_malloc(rgn,sizeof(*_tmp309));({struct _tuple24*_tmp61F=({struct _tuple24*_tmp308=_region_malloc(rgn,sizeof(*_tmp308));_tmp308->f1=(*y).f1,_tmp308->f2=(*y).f2;_tmp308;});_tmp309->f1=_tmp61F;}),_tmp309->f2=(*y).f3;_tmp309;});}
# 2177
...
return new_e1 == e1?e:({struct Cyc_Absyn_Exp*_tmp621=e;Cyc_Tcutil_copye(_tmp621,(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp31C=_cycalloc(sizeof(*_tmp31C));_tmp31C->tag=3,_tmp31C->f1=p,({struct Cyc_List_List*_tmp620=({struct Cyc_Absyn_Exp*_tmp31B[1];_tmp31B[0]=new_e1;({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp31B,sizeof(struct Cyc_Absyn_Exp*),1));});_tmp31C->f2=_tmp620;});_tmp31C;}));});}else{
...
return({struct Cyc_Absyn_Exp*_tmp623=e;Cyc_Tcutil_copye(_tmp623,(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp322=_cycalloc(sizeof(*_tmp322));_tmp322->tag=3,_tmp322->f1=p,({struct Cyc_List_List*_tmp622=({struct Cyc_Absyn_Exp*_tmp321[2];_tmp321[0]=new_e1,_tmp321[1]=new_e2;({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp321,sizeof(struct Cyc_Absyn_Exp*),2));});_tmp322->f2=_tmp622;});_tmp322;}));});}}
# 2215
return({struct Cyc_Warn_String_Warn_Warg_struct _tmp324=({struct Cyc_Warn_String_Warn_Warg_struct _tmp506;_tmp506.tag=0,({struct _fat_ptr _tmp624=({const char*_tmp325="primop does not have 1 or 2 args!";_tag_fat(_tmp325,sizeof(char),34U);});_tmp506.f1=_tmp624;});_tmp506;});void*_tmp323[1];_tmp323[0]=& _tmp324;({(struct Cyc_Absyn_Exp*(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp323,sizeof(void*),1));});}case 6: _tmp313=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp312)->f1;_tmp314=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp312)->f2;_tmp317=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp312)->f3;{struct Cyc_Absyn_Exp*e1=_tmp313;struct Cyc_Absyn_Exp*e2=_tmp314;struct Cyc_Absyn_Exp*e3=_tmp317;
# 2217
...
if(new_e1 == e1 && new_e2 == e2)return e;
return({struct Cyc_Absyn_Exp*_tmp626=e;Cyc_Tcutil_copye(_tmp626,(void*)({struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_tmp32C=_cycalloc(sizeof(*_tmp32C));_tmp32C->tag=7,_tmp32C->f1=new_e1,_tmp32C->f2=new_e2;_tmp32C;}));});}case 8: _tmp313=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp312)->f1;_tmp314=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp312)->f2;{struct Cyc_Absyn_Exp*e1=_tmp313;struct Cyc_Absyn_Exp*e2=_tmp314;
# 2228
...
return e;}}else{
return({struct Cyc_Absyn_Exp*_tmp62E=e;Cyc_Tcutil_copye(_tmp62E,(void*)({struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp342=_cycalloc(sizeof(*_tmp342));_tmp342->tag=39,_tmp342->f1=new_typ;_tmp342;}));});};}}default:
# 2262
 return({struct Cyc_Warn_String_Warn_Warg_struct _tmp344=({struct Cyc_Warn_String_Warn_Warg_struct _tmp507;_tmp507.tag=0,({struct _fat_ptr _tmp62F=({const char*_tmp345="non-type-level-expression in Tcutil::rsubsexp";_tag_fat(_tmp345,sizeof(char),46U);});_tmp507.f1=_tmp62F;});_tmp507;});void*_tmp343[1];_tmp343[0]=& _tmp344;({(struct Cyc_Absyn_Exp*(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp343,sizeof(void*),1));});};}
# 2266
...
inst=({struct Cyc_List_List*_tmp37A=_region_malloc(rgn,sizeof(*_tmp37A));({struct _tuple17*_tmp631=({struct _tuple17*_tmp379=_region_malloc(rgn,sizeof(*_tmp379));_tmp379->f1=(struct Cyc_Absyn_Tvar*)p->hd,({void*_tmp630=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)p->hd);_tmp379->f2=_tmp630;});_tmp379;});_tmp37A->hd=_tmp631;}),_tmp37A->tl=inst;_tmp37A;});}}{
struct _tuple0 _tmp37B=({struct _tuple0(*_tmp634)(struct _RegionHandle*,struct _RegionHandle*,struct Cyc_List_List*)=({(struct _tuple0(*)(struct _RegionHandle*,struct _RegionHandle*,struct Cyc_List_List*))Cyc_List_rsplit;});struct _RegionHandle*_tmp633=rgn;struct _RegionHandle*_tmp632=rgn;_tmp634(_tmp633,_tmp632,
...
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp38B=_cycalloc(sizeof(*_tmp38B));_tmp38B->tag=5,(_tmp38B->f1).tvars=vs,(_tmp38B->f1).effect=eff2,(_tmp38B->f1).ret_tqual=rtq,({void*_tmp635=Cyc_Tcutil_rsubstitute(rgn,inst,rtyp);(_tmp38B->f1).ret_type=_tmp635;}),(_tmp38B->f1).args=args2,(_tmp38B->f1).c_varargs=c_varargs,(_tmp38B->f1).cyc_varargs=cyc_varargs2,(_tmp38B->f1).rgn_po=rgn_po2,(_tmp38B->f1).attributes=atts,(_tmp38B->f1).requires_clause=req2,(_tmp38B->f1).requires_relns=req_relns2,(_tmp38B->f1).ensures_clause=ens2,(_tmp38B->f1).ensures_relns=ens_relns2,(_tmp38B->f1).return_value=ret_value;_tmp38B;});}}}}}case 6: _tmp359=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp358)->f1;{struct Cyc_List_List*tqts=_tmp359;
# 2368
...
# 2377
return !change?t:(void*)({struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmp390=_cycalloc(sizeof(*_tmp390));_tmp390->tag=6,({struct Cyc_List_List*_tmp638=({struct Cyc_List_List*(*_tmp637)(struct _tuple12*(*)(struct _tuple12*,void*),struct Cyc_List_List*,struct Cyc_List_List*)=({(struct Cyc_List_List*(*)(struct _tuple12*(*)(struct _tuple12*,void*),struct Cyc_List_List*,struct Cyc_List_List*))Cyc_List_map2;});struct Cyc_List_List*_tmp636=tqts;_tmp637(Cyc_Tcutil_map2_tq,_tmp636,({(struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev;})(ts2));});_tmp390->f1=_tmp638;});_tmp390;});}case 7: _tmp35B=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp358)->f1;_tmp359=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp358)->f2;{enum Cyc_Absyn_AggrKind k=_tmp35B;struct Cyc_List_List*fs=_tmp359;
# 2379
...
# 2393
 if(Cyc_Tcutil_skip_fntypes)return t;
({struct Cyc_Warn_String_Warn_Warg_struct _tmp39A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp509;_tmp509.tag=0,({struct _fat_ptr _tmp639=({const char*_tmp39B="found typedecltype in rsubs";_tag_fat(_tmp39B,sizeof(char),28U);});_tmp509.f1=_tmp639;});_tmp509;});void*_tmp399[1];_tmp399[0]=& _tmp39A;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp399,sizeof(void*),1));});};}
# 2398
...
return({struct _tuple17*_tmp3A4=_cycalloc(sizeof(*_tmp3A4));_tmp3A4->f1=tv,({void*_tmp63B=({struct Cyc_Core_Opt*_tmp63A=k;Cyc_Absyn_new_evar(_tmp63A,({struct Cyc_Core_Opt*_tmp3A3=_cycalloc(sizeof(*_tmp3A3));_tmp3A3->v=s;_tmp3A3;}));});_tmp3A4->f2=_tmp63B;});_tmp3A4;});}struct _tuple26{struct Cyc_List_List*f1;struct _RegionHandle*f2;};
# 2429
...
return({struct _tuple17*_tmp3AA=_region_malloc(rgn,sizeof(*_tmp3AA));_tmp3AA->f1=tv,({void*_tmp63D=({struct Cyc_Core_Opt*_tmp63C=k;Cyc_Absyn_new_evar(_tmp63C,({struct Cyc_Core_Opt*_tmp3A9=_cycalloc(sizeof(*_tmp3A9));_tmp3A9->v=s;_tmp3A9;}));});_tmp3AA->f2=_tmp63D;});_tmp3AA;});}}
# 2436
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3AC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50C;_tmp50C.tag=0,({struct _fat_ptr _tmp63E=({const char*_tmp3B0="bitfield ";_tag_fat(_tmp3B0,sizeof(char),10U);});_tmp50C.f1=_tmp63E;});_tmp50C;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3AD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50B;_tmp50B.tag=0,_tmp50B.f1=*fn;_tmp50B;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3AE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50A;_tmp50A.tag=0,({struct _fat_ptr _tmp63F=({const char*_tmp3AF=" does not have constant width";_tag_fat(_tmp3AF,sizeof(char),30U);});_tmp50A.f1=_tmp63F;});_tmp50A;});void*_tmp3AB[3];_tmp3AB[0]=& _tmp3AC,_tmp3AB[1]=& _tmp3AD,_tmp3AB[2]=& _tmp3AE;Cyc_Warn_err2(loc,_tag_fat(_tmp3AB,sizeof(void*),3));});else{
# 2443
...
if(!known)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50D;_tmp50D.tag=0,({struct _fat_ptr _tmp640=({const char*_tmp3B7="cannot evaluate bitfield width at compile time";_tag_fat(_tmp3B7,sizeof(char),47U);});_tmp50D.f1=_tmp640;});_tmp50D;});void*_tmp3B5[1];_tmp3B5[0]=& _tmp3B6;Cyc_Warn_warn2(loc,_tag_fat(_tmp3B5,sizeof(void*),1));});
if((int)i < 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50E;_tmp50E.tag=0,({struct _fat_ptr _tmp641=({const char*_tmp3BA="bitfield has negative width";_tag_fat(_tmp3BA,sizeof(char),28U);});_tmp50E.f1=_tmp641;});_tmp50E;});void*_tmp3B8[1];_tmp3B8[0]=& _tmp3B9;Cyc_Warn_err2(loc,_tag_fat(_tmp3B8,sizeof(void*),1));});
w=i;}}{
# 2450
...
# 2462
if(bad)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50F;_tmp50F.tag=0,({struct _fat_ptr _tmp642=({const char*_tmp3C1="bitfield larger than type";_tag_fat(_tmp3C1,sizeof(char),26U);});_tmp50F.f1=_tmp642;});_tmp50F;});void*_tmp3BF[1];_tmp3BF[0]=& _tmp3C0;Cyc_Warn_warn2(loc,_tag_fat(_tmp3BF,sizeof(void*),1));});
goto _LL3;}}else{goto _LL6;}}else{_LL6:
# 2466
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp513;_tmp513.tag=0,({struct _fat_ptr _tmp643=({const char*_tmp3C8="bitfield ";_tag_fat(_tmp3C8,sizeof(char),10U);});_tmp513.f1=_tmp643;});_tmp513;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3C4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp512;_tmp512.tag=0,_tmp512.f1=*fn;_tmp512;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3C5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp511;_tmp511.tag=0,({struct _fat_ptr _tmp644=({const char*_tmp3C7=" must have integral type but has type ";_tag_fat(_tmp3C7,sizeof(char),39U);});_tmp511.f1=_tmp644;});_tmp511;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp3C6=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp510;_tmp510.tag=2,_tmp510.f1=(void*)field_type;_tmp510;});void*_tmp3C2[4];_tmp3C2[0]=& _tmp3C3,_tmp3C2[1]=& _tmp3C4,_tmp3C2[2]=& _tmp3C5,_tmp3C2[3]=& _tmp3C6;Cyc_Warn_err2(loc,_tag_fat(_tmp3C2,sizeof(void*),4));});
# 2468
goto _LL3;}_LL3:;}}}
# 2475
...
if(declared_const)({struct Cyc_Warn_String_Warn_Warg_struct _tmp3CD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp514;_tmp514.tag=0,({struct _fat_ptr _tmp645=({const char*_tmp3CE="extra const";_tag_fat(_tmp3CE,sizeof(char),12U);});_tmp514.f1=_tmp645;});_tmp514;});void*_tmp3CC[1];_tmp3CC[0]=& _tmp3CD;Cyc_Warn_warn2(loc,_tag_fat(_tmp3CC,sizeof(void*),1));});
return 1;}
# 2483
if((unsigned)tdopt)
...
if(tv->identity == -1)
({int _tmp646=Cyc_Tcutil_new_tvar_id();tv->identity=_tmp646;});}
# 2494
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3D0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp517;_tmp517.tag=0,_tmp517.f1=msg;_tmp517;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3D1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp516;_tmp516.tag=0,({struct _fat_ptr _tmp647=({const char*_tmp3D3=": ";_tag_fat(_tmp3D3,sizeof(char),3U);});_tmp516.f1=_tmp647;});_tmp516;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3D2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp515;_tmp515.tag=0,({struct _fat_ptr _tmp648=a2string(vs->hd);_tmp515.f1=_tmp648;});_tmp515;});void*_tmp3CF[3];_tmp3CF[0]=& _tmp3D0,_tmp3CF[1]=& _tmp3D1,_tmp3CF[2]=& _tmp3D2;Cyc_Warn_err2(loc,_tag_fat(_tmp3CF,sizeof(void*),3));});}}}
# 2508
...
({void(*_tmp64B)(int(*)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*,unsigned,struct _fat_ptr(*)(struct Cyc_Absyn_Tvar*),struct _fat_ptr)=({(void(*)(int(*)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*,unsigned,struct _fat_ptr(*)(struct Cyc_Absyn_Tvar*),struct _fat_ptr))Cyc_Tcutil_check_unique_unsorted;});struct Cyc_List_List*_tmp64A=tvs;unsigned _tmp649=loc;_tmp64B(Cyc_Absyn_tvar_cmp,_tmp64A,_tmp649,Cyc_Absynpp_tvar2string,({const char*_tmp3D4="duplicate type variable";_tag_fat(_tmp3D4,sizeof(char),24U);}));});}struct _tuple27{struct Cyc_Absyn_Aggrfield*f1;int f2;};struct _tuple28{struct Cyc_List_List*f1;void*f2;};struct _tuple29{struct Cyc_Absyn_Aggrfield*f1;void*f2;};
# 2529 "tcutil.cyc"
...
if(({struct _fat_ptr _tmp64C=(struct _fat_ptr)*((struct Cyc_Absyn_Aggrfield*)sd_fields->hd)->name;Cyc_strcmp(_tmp64C,({const char*_tmp3D6="";_tag_fat(_tmp3D6,sizeof(char),1U);}));})!= 0)
fields=({struct Cyc_List_List*_tmp3D8=_region_malloc(temp,sizeof(*_tmp3D8));({struct _tuple27*_tmp64D=({struct _tuple27*_tmp3D7=_region_malloc(temp,sizeof(*_tmp3D7));_tmp3D7->f1=(struct Cyc_Absyn_Aggrfield*)sd_fields->hd,_tmp3D7->f2=0;_tmp3D7;});_tmp3D8->hd=_tmp64D;}),_tmp3D8->tl=fields;_tmp3D8;});}}
...
({struct Cyc_List_List*_tmp64F=({struct Cyc_List_List*_tmp3DF=_cycalloc(sizeof(*_tmp3DF));({void*_tmp64E=(void*)({struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_tmp3DE=_cycalloc(sizeof(*_tmp3DE));_tmp3DE->tag=1,_tmp3DE->f1=((*((struct _tuple27*)fields2->hd)).f1)->name;_tmp3DE;});_tmp3DF->hd=_tmp64E;}),_tmp3DF->tl=0;_tmp3DF;});(*((struct _tuple28*)des->hd)).f1=_tmp64F;});
ans=({struct Cyc_List_List*_tmp3E1=_region_malloc(rgn,sizeof(*_tmp3E1));({struct _tuple29*_tmp650=({struct _tuple29*_tmp3E0=_region_malloc(rgn,sizeof(*_tmp3E0));_tmp3E0->f1=(*((struct _tuple27*)fields2->hd)).f1,_tmp3E0->f2=a;_tmp3E0;});_tmp3E1->hd=_tmp650;}),_tmp3E1->tl=ans;_tmp3E1;});
break;}}
# 2560
if(fields2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3E3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp519;_tmp519.tag=0,({struct _fat_ptr _tmp651=({const char*_tmp3E5="too many arguments to ";_tag_fat(_tmp3E5,sizeof(char),23U);});_tmp519.f1=_tmp651;});_tmp519;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3E4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp518;_tmp518.tag=0,_tmp518.f1=aggr_str;_tmp518;});void*_tmp3E2[2];_tmp3E2[0]=& _tmp3E3,_tmp3E2[1]=& _tmp3E4;Cyc_Warn_err2(loc,_tag_fat(_tmp3E2,sizeof(void*),2));});}else{
if(dl->tl != 0)
# 2564
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3E7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51A;_tmp51A.tag=0,({struct _fat_ptr _tmp652=({const char*_tmp3E8="multiple designators are not yet supported";_tag_fat(_tmp3E8,sizeof(char),43U);});_tmp51A.f1=_tmp652;});_tmp51A;});void*_tmp3E6[1];_tmp3E6[0]=& _tmp3E7;Cyc_Warn_err2(loc,_tag_fat(_tmp3E6,sizeof(void*),1));});else{
# 2567
void*_tmp3E9=(void*)dl->hd;void*_stmttmp66=_tmp3E9;void*_tmp3EA=_stmttmp66;void*_tmp3EB;if(*((int*)_tmp3EA)== 0){
# 2569
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3ED=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51C;_tmp51C.tag=0,({struct _fat_ptr _tmp653=({const char*_tmp3EF="array designator used in argument to ";_tag_fat(_tmp3EF,sizeof(char),38U);});_tmp51C.f1=_tmp653;});_tmp51C;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3EE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51B;_tmp51B.tag=0,_tmp51B.f1=aggr_str;_tmp51B;});void*_tmp3EC[2];_tmp3EC[0]=& _tmp3ED,_tmp3EC[1]=& _tmp3EE;Cyc_Warn_err2(loc,_tag_fat(_tmp3EC,sizeof(void*),2));});
...
if((*((struct _tuple27*)fields2->hd)).f2)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3F2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51F;_tmp51F.tag=0,({struct _fat_ptr _tmp654=({const char*_tmp3F6="member ";_tag_fat(_tmp3F6,sizeof(char),8U);});_tmp51F.f1=_tmp654;});_tmp51F;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3F3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51E;_tmp51E.tag=0,_tmp51E.f1=*v;_tmp51E;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3F4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51D;_tmp51D.tag=0,({struct _fat_ptr _tmp655=({const char*_tmp3F5=" has already been used as an argument";_tag_fat(_tmp3F5,sizeof(char),38U);});_tmp51D.f1=_tmp655;});_tmp51D;});void*_tmp3F1[3];_tmp3F1[0]=& _tmp3F2,_tmp3F1[1]=& _tmp3F3,_tmp3F1[2]=& _tmp3F4;Cyc_Warn_err2(loc,_tag_fat(_tmp3F1,sizeof(void*),3));});
(*((struct _tuple27*)fields2->hd)).f2=1;
ans=({struct Cyc_List_List*_tmp3F8=_region_malloc(rgn,sizeof(*_tmp3F8));({struct _tuple29*_tmp656=({struct _tuple29*_tmp3F7=_region_malloc(rgn,sizeof(*_tmp3F7));_tmp3F7->f1=(*((struct _tuple27*)fields2->hd)).f1,_tmp3F7->f2=a;_tmp3F7;});_tmp3F8->hd=_tmp656;}),_tmp3F8->tl=ans;_tmp3F8;});
break;}}
# 2581
if(fields2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp521;_tmp521.tag=0,({struct _fat_ptr _tmp657=({const char*_tmp3FC="bad field designator ";_tag_fat(_tmp3FC,sizeof(char),22U);});_tmp521.f1=_tmp657;});_tmp521;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3FB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp520;_tmp520.tag=0,_tmp520.f1=*v;_tmp520;});void*_tmp3F9[2];_tmp3F9[0]=& _tmp3FA,_tmp3F9[1]=& _tmp3FB;Cyc_Warn_err2(loc,_tag_fat(_tmp3F9,sizeof(void*),2));});
goto _LL3;}}_LL3:;}}}}
# 2588
if((int)aggr_kind == 0){
if(({int _tmp658=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(ans);_tmp658 < ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(fields);}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp522;_tmp522.tag=0,({struct _fat_ptr _tmp659=({const char*_tmp3FF="too few arguments to struct";_tag_fat(_tmp3FF,sizeof(char),28U);});_tmp522.f1=_tmp659;});_tmp522;});void*_tmp3FD[1];_tmp3FD[0]=& _tmp3FE;Cyc_Warn_err2(loc,_tag_fat(_tmp3FD,sizeof(void*),1));});}else{
if(({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(ans)!= 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp401=({struct Cyc_Warn_String_Warn_Warg_struct _tmp523;_tmp523.tag=0,({struct _fat_ptr _tmp65A=({const char*_tmp402="union expression should have one member";_tag_fat(_tmp402,sizeof(char),40U);});_tmp523.f1=_tmp65A;});_tmp523;});void*_tmp400[1];_tmp400[0]=& _tmp401;Cyc_Warn_err2(loc,_tag_fat(_tmp400,sizeof(void*),1));});}{
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp40A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp525;_tmp525.tag=0,({struct _fat_ptr _tmp65B=({const char*_tmp40C="we have a cast in a lhs: ";_tag_fat(_tmp40C,sizeof(char),26U);});_tmp525.f1=_tmp65B;});_tmp525;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp40B=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp524;_tmp524.tag=4,_tmp524.f1=e1;_tmp524;});void*_tmp409[2];_tmp409[0]=& _tmp40A,_tmp409[1]=& _tmp40B;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp409,sizeof(void*),2));});case 20: _tmp408=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp407)->f1;{struct Cyc_Absyn_Exp*e1a=_tmp408;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp40E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp527;_tmp527.tag=0,({struct _fat_ptr _tmp65C=({const char*_tmp410="found zero pointer aggregate member assignment: ";_tag_fat(_tmp410,sizeof(char),49U);});_tmp527.f1=_tmp65C;});_tmp527;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp40F=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp526;_tmp526.tag=4,_tmp526.f1=e1;_tmp526;});void*_tmp40D[2];_tmp40D[0]=& _tmp40E,_tmp40D[1]=& _tmp40F;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp40D,sizeof(void*),2));});
...
# 2614
if(Cyc_Tcutil_is_zero_ptr_type((void*)_check_null(e1a->topt),ptr_type,is_fat,elt_type))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp412=({struct Cyc_Warn_String_Warn_Warg_struct _tmp529;_tmp529.tag=0,({struct _fat_ptr _tmp65D=({const char*_tmp414="found zero pointer instantiate/noinstantiate: ";_tag_fat(_tmp414,sizeof(char),47U);});_tmp529.f1=_tmp65D;});_tmp529;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp413=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp528;_tmp528.tag=4,_tmp528.f1=e1;_tmp528;});void*_tmp411[2];_tmp411[0]=& _tmp412,_tmp411[1]=& _tmp413;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp411,sizeof(void*),2));});
return 0;}case 1:
 return 0;default:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp416=({struct Cyc_Warn_String_Warn_Warg_struct _tmp52B;_tmp52B.tag=0,({struct _fat_ptr _tmp65E=({const char*_tmp418="found bad lhs in is_zero_ptr_deref: ";_tag_fat(_tmp418,sizeof(char),37U);});_tmp52B.f1=_tmp65E;});_tmp52B;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp417=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp52A;_tmp52A.tag=4,_tmp52A.f1=e1;_tmp52A;});void*_tmp415[2];_tmp415[0]=& _tmp416,_tmp415[1]=& _tmp417;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp415,sizeof(void*),2));});};}
# 2628
...
# 2641
({struct Cyc_Core_Opt*_tmp660=({struct Cyc_Core_Opt*_tmp426=_cycalloc(sizeof(*_tmp426));({void*_tmp65F=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp425=_cycalloc(sizeof(*_tmp425));_tmp425->tag=2,_tmp425->f1=0,_tmp425->f2=& Cyc_Kinds_rk;_tmp425;});_tmp426->v=_tmp65F;});_tmp426;});*x=_tmp660;});
...
# 2663
({struct Cyc_Core_Opt*_tmp663=({struct Cyc_Core_Opt*_tmp435=_cycalloc(sizeof(*_tmp435));({void*_tmp662=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp434=_cycalloc(sizeof(*_tmp434));_tmp434->tag=2,_tmp434->f1=0,({struct Cyc_Absyn_Kind*_tmp661=({struct Cyc_Absyn_Kind*_tmp433=_cycalloc(sizeof(*_tmp433));_tmp433->kind=k,_tmp433->aliasqual=0U;_tmp433;});_tmp434->f2=_tmp661;});_tmp434;});_tmp435->v=_tmp662;});_tmp435;});*x=_tmp663;});
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp44C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp52C;_tmp52C.tag=0,({struct _fat_ptr _tmp664=({const char*_tmp44D="is_noalias_stmt_exp: ill-formed StmtExp";_tag_fat(_tmp44D,sizeof(char),40U);});_tmp52C.f1=_tmp664;});_tmp52C;});void*_tmp44B[1];_tmp44B[0]=& _tmp44C;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp44B,sizeof(void*),1));});}_LL1A:;}}default: _LL13:
# 2743
 return 1;};}
# 2760 "tcutil.cyc"
...
if(finfo != 0)
return({struct _tuple14 _tmp536;_tmp536.f1=((*finfo).f1).real_const,({void*_tmp665=(Cyc_Tcutil_addressof_props(e1)).f2;_tmp536.f2=_tmp665;});_tmp536;});
...
# 2857
return({struct _tuple14 _tmp538;_tmp538.f1=tq.real_const,({void*_tmp666=(Cyc_Tcutil_addressof_props(e1)).f2;_tmp538.f2=_tmp666;});_tmp538;});}default:
 return bogus_ans;};}default:
# 2861
({struct Cyc_Warn_String_Warn_Warg_struct _tmp47A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp539;_tmp539.tag=0,({struct _fat_ptr _tmp667=({const char*_tmp47B="unary & applied to non-lvalue";_tag_fat(_tmp47B,sizeof(char),30U);});_tmp539.f1=_tmp667;});_tmp539;});void*_tmp479[1];_tmp479[0]=& _tmp47A;Cyc_Warn_err2(e->loc,_tag_fat(_tmp479,sizeof(void*),1));});
return bogus_ans;};}
# 2868
void Cyc_Tcutil_check_bound(unsigned loc,unsigned i,void*b,int do_warn){
struct Cyc_Absyn_Exp*_tmp47C=({void*_tmp668=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp668,b);});struct Cyc_Absyn_Exp*eopt=_tmp47C;
if(eopt == 0)return;{
...
if(known && j <= i)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp482=({struct Cyc_Warn_String_Warn_Warg_struct _tmp53E;_tmp53E.tag=0,({struct _fat_ptr _tmp669=({const char*_tmp487="a dereference is out of bounds: ";_tag_fat(_tmp487,sizeof(char),33U);});_tmp53E.f1=_tmp669;});_tmp53E;});struct Cyc_Warn_Int_Warn_Warg_struct _tmp483=({struct Cyc_Warn_Int_Warn_Warg_struct _tmp53D;_tmp53D.tag=12,_tmp53D.f1=(int)j;_tmp53D;});struct Cyc_Warn_String_Warn_Warg_struct _tmp484=({struct Cyc_Warn_String_Warn_Warg_struct _tmp53C;_tmp53C.tag=0,({
struct _fat_ptr _tmp66A=({const char*_tmp486=" <= ";_tag_fat(_tmp486,sizeof(char),5U);});_tmp53C.f1=_tmp66A;});_tmp53C;});struct Cyc_Warn_Int_Warn_Warg_struct _tmp485=({struct Cyc_Warn_Int_Warn_Warg_struct _tmp53B;_tmp53B.tag=12,_tmp53B.f1=(int)i;_tmp53B;});void*_tmp481[4];_tmp481[0]=& _tmp482,_tmp481[1]=& _tmp483,_tmp481[2]=& _tmp484,_tmp481[3]=& _tmp485;((
# 2873
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4A9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp541;_tmp541.tag=0,({struct _fat_ptr _tmp66B=({const char*_tmp4AD="qualifier within typedef type ";_tag_fat(_tmp4AD,sizeof(char),31U);});_tmp541.f1=_tmp66B;});_tmp541;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4AA=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp540;_tmp540.tag=2,_tmp540.f1=(void*)t;_tmp540;});struct Cyc_Warn_String_Warn_Warg_struct _tmp4AB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp53F;_tmp53F.tag=0,({struct _fat_ptr _tmp66C=({const char*_tmp4AC=" is ignored";_tag_fat(_tmp4AC,sizeof(char),12U);});_tmp53F.f1=_tmp66C;});_tmp53F;});void*_tmp4A8[3];_tmp4A8[0]=& _tmp4A9,_tmp4A8[1]=& _tmp4AA,_tmp4A8[2]=& _tmp4AB;Cyc_Warn_warn2(loc,_tag_fat(_tmp4A8,sizeof(void*),3));});
return;}}}else{
return;};}
# 3021
...
return({void*_tmp66D=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp66D,(pi.ptr_atts).bounds);});}case 4: _tmp4B0=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp4AF)->f1).num_elts;{struct Cyc_Absyn_Exp*e=_tmp4B0;
return e;}default:
 return 0;};}
# 3031
...
if(convert_tag){
if(eopt->topt == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4BE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp542;_tmp542.tag=0,({struct _fat_ptr _tmp66E=({const char*_tmp4BF="cannot convert tag without type!";_tag_fat(_tmp4BF,sizeof(char),33U);});_tmp542.f1=_tmp66E;});_tmp542;});void*_tmp4BD[1];_tmp4BD[0]=& _tmp4BE;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp4BD,sizeof(void*),1));});{
