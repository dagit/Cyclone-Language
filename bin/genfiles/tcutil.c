...
# 205
extern struct Cyc_List_List*Cyc_List_rflatten(struct _RegionHandle*,struct Cyc_List_List*);extern char Cyc_List_Nth[4U];
# 270
...
void*_tmp18=Cyc_Absyn_compress(_check_null(e->topt));void*_stmttmpB=_tmp18;void*_tmp19=_stmttmpB;void*_tmp1A;if(*((int*)_tmp19)== 1)
return Cyc_Unify_unify(_check_null(e->topt),Cyc_Absyn_sint_type);else{_tmp1A=_tmp19;{void*t=_tmp1A;
return Cyc_Tcutil_is_integral_type(t);}};}
# 139
int Cyc_Tcutil_is_numeric(struct Cyc_Absyn_Exp*e){
if(Cyc_Tcutil_is_integral(e))
return 1;{
void*_tmp1B=Cyc_Absyn_compress(_check_null(e->topt));void*_stmttmpC=_tmp1B;void*_tmp1C=_stmttmpC;if(*((int*)_tmp1C)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1C)->f1)== 2)
return 1;else{goto _LL3;}}else{_LL3:
 return 0;};}}
# 149
...
*elt_type=elt;
*is_fat=0;
({void*_tmp542=Cyc_Tcutil_promote_array(t,Cyc_Absyn_heap_rgn_type,0);*ptr_type=_tmp542;});
return 1;}default:
 return 0;};}
# 229
...
struct Cyc_Absyn_Exp*_tmp36=({void*_tmp543=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp543,b);});struct Cyc_Absyn_Exp*eopt=_tmp36;
if(eopt == 0)return 0;{
...
return({struct Cyc_Absyn_Tvar*_tmp45=_cycalloc(sizeof(*_tmp45));_tmp45->name=tv->name,_tmp45->identity=-1,({void*_tmp544=Cyc_Kinds_copy_kindbound(tv->kind);_tmp45->kind=_tmp544;});_tmp45;});}
# 304
...
return({struct _tuple9*_tmp4A=_cycalloc(sizeof(*_tmp4A));_tmp4A->f1=x,_tmp4A->f2=y,({void*_tmp545=Cyc_Tcutil_copy_type(t);_tmp4A->f3=_tmp545;});_tmp4A;});}}
# 308
static struct _tuple12*Cyc_Tcutil_copy_tqt(struct _tuple12*arg){
return({struct _tuple12*_tmp4B=_cycalloc(sizeof(*_tmp4B));_tmp4B->f1=(*arg).f1,({void*_tmp546=Cyc_Tcutil_copy_type((*arg).f2);_tmp4B->f2=_tmp546;});_tmp4B;});}
# 311
...
return({struct Cyc_Absyn_Aggrfield*_tmp4C=_cycalloc(sizeof(*_tmp4C));_tmp4C->name=f->name,_tmp4C->tq=f->tq,({void*_tmp548=Cyc_Tcutil_copy_type(f->type);_tmp4C->type=_tmp548;}),_tmp4C->width=f->width,_tmp4C->attributes=f->attributes,({
struct Cyc_Absyn_Exp*_tmp547=Cyc_Tcutil_deep_copy_exp_opt(1,f->requires_clause);_tmp4C->requires_clause=_tmp547;});_tmp4C;});}struct _tuple15{void*f1;void*f2;};
# 318
...
return({struct _tuple15*_tmp50=_cycalloc(sizeof(*_tmp50));({void*_tmp54A=Cyc_Tcutil_copy_type(r1);_tmp50->f1=_tmp54A;}),({void*_tmp549=Cyc_Tcutil_copy_type(r2);_tmp50->f2=_tmp549;});_tmp50;});}}
# 322
...
if(cyc_varargs != 0)
({void*_tmp54F=Cyc_Tcutil_copy_type(cyc_varargs->type);(_check_null(cyc_varargs2))->type=_tmp54F;});{
...
({void*_tmp550=Cyc_Tcutil_copy_type(ret_val2->type);ret_val2->type=_tmp550;});
if((unsigned)ret_val2->rgn)({void*_tmp551=Cyc_Tcutil_copy_type(ret_val2->rgn);ret_val2->rgn=_tmp551;});}
# 366
...
# 369
return(void*)({struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmp7A=_cycalloc(sizeof(*_tmp7A));_tmp7A->tag=6,({struct Cyc_List_List*_tmp552=({(struct Cyc_List_List*(*)(struct _tuple12*(*)(struct _tuple12*),struct Cyc_List_List*))Cyc_List_map;})(Cyc_Tcutil_copy_tqt,tqts);_tmp7A->f1=_tmp552;});_tmp7A;});}case 7: _tmp56=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp52)->f1;_tmp53=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp52)->f2;{enum Cyc_Absyn_AggrKind k=_tmp56;struct Cyc_List_List*fs=_tmp53;
return(void*)({struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*_tmp7B=_cycalloc(sizeof(*_tmp7B));_tmp7B->tag=7,_tmp7B->f1=k,({struct Cyc_List_List*_tmp553=({(struct Cyc_List_List*(*)(struct Cyc_Absyn_Aggrfield*(*)(struct Cyc_Absyn_Aggrfield*),struct Cyc_List_List*))Cyc_List_map;})(Cyc_Tcutil_copy_field,fs);_tmp7B->f2=_tmp553;});_tmp7B;});}case 9: _tmp53=((struct Cyc_Absyn_ValueofType_Absyn_Type_struct*)_tmp52)->f1;{struct Cyc_Absyn_Exp*e=_tmp53;
...
return({union Cyc_Absyn_AggrInfo _tmp555=Cyc_Absyn_UnknownAggr(ad->kind,ad->name,0);Cyc_Absyn_aggr_type(_tmp555,targs);});}case 1: _tmp53=((struct Cyc_Absyn_Enum_td_Absyn_Raw_typedecl_struct*)(((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmp52)->f1)->r)->f1;{struct Cyc_Absyn_Enumdecl*ed=_tmp53;
# 380
...
return({union Cyc_Absyn_DatatypeInfo _tmp556=Cyc_Absyn_UnknownDatatype(({struct Cyc_Absyn_UnknownDatatypeInfo _tmp4C2;_tmp4C2.name=dd->name,_tmp4C2.is_extensible=0;_tmp4C2;}));Cyc_Absyn_datatype_type(_tmp556,targs);});}}};}
# 388
...
return(void*)({struct Cyc_Absyn_ArrayElement_Absyn_Designator_struct*_tmp83=_cycalloc(sizeof(*_tmp83));_tmp83->tag=0,({struct Cyc_Absyn_Exp*_tmp557=Cyc_Tcutil_deep_copy_exp(preserve_types,e);_tmp83->f1=_tmp557;});_tmp83;});}}else{
...
# 396
return({struct _tuple16*_tmp84=_cycalloc(sizeof(*_tmp84));({struct Cyc_List_List*_tmp559=({(struct Cyc_List_List*(*)(void*(*)(int,void*),int,struct Cyc_List_List*))Cyc_List_map_c;})(Cyc_Tcutil_copy_designator,preserve_types,(e[0]).f1);_tmp84->f1=_tmp559;}),({
struct Cyc_Absyn_Exp*_tmp558=Cyc_Tcutil_deep_copy_exp(preserve_types,(e[0]).f2);_tmp84->f2=_tmp558;});_tmp84;});}
# 400
...
new_e=({enum Cyc_Absyn_Primop _tmp55B=p;struct Cyc_List_List*_tmp55A=({(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(int,struct Cyc_Absyn_Exp*),int,struct Cyc_List_List*))Cyc_List_map_c;})(DC,pt,es);Cyc_Absyn_primop_exp(_tmp55B,_tmp55A,e->loc);});goto _LL0;}case 5: _tmp89=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp94=((struct Cyc_Absyn_Increment_e_Absyn_Raw_exp_struct*)_tmp88)->f2;{struct Cyc_Absyn_Exp*e1=_tmp89;enum Cyc_Absyn_Incrementor i=_tmp94;
new_e=({struct Cyc_Absyn_Exp*_tmp55D=DC(pt,e1);enum Cyc_Absyn_Incrementor _tmp55C=i;Cyc_Absyn_increment_exp(_tmp55D,_tmp55C,e->loc);});goto _LL0;}case 7: _tmp89=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*)_tmp88)->f2;{struct Cyc_Absyn_Exp*e1=_tmp89;struct Cyc_Absyn_Exp*e2=_tmp8C;
new_e=({struct Cyc_Absyn_Exp*_tmp55F=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp55E=DC(pt,e2);Cyc_Absyn_and_exp(_tmp55F,_tmp55E,e->loc);});goto _LL0;}case 8: _tmp89=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp88)->f2;{struct Cyc_Absyn_Exp*e1=_tmp89;struct Cyc_Absyn_Exp*e2=_tmp8C;
new_e=({struct Cyc_Absyn_Exp*_tmp561=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp560=DC(pt,e2);Cyc_Absyn_or_exp(_tmp561,_tmp560,e->loc);});goto _LL0;}case 9: _tmp89=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_SeqExp_e_Absyn_Raw_exp_struct*)_tmp88)->f2;{struct Cyc_Absyn_Exp*e1=_tmp89;struct Cyc_Absyn_Exp*e2=_tmp8C;
new_e=({struct Cyc_Absyn_Exp*_tmp563=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp562=DC(pt,e2);Cyc_Absyn_seq_exp(_tmp563,_tmp562,e->loc);});goto _LL0;}case 6: _tmp89=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp88)->f2;_tmp8D=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp88)->f3;{struct Cyc_Absyn_Exp*e1=_tmp89;struct Cyc_Absyn_Exp*e2=_tmp8C;struct Cyc_Absyn_Exp*e3=_tmp8D;
# 414
new_e=({struct Cyc_Absyn_Exp*_tmp566=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp565=DC(pt,e2);struct Cyc_Absyn_Exp*_tmp564=DC(pt,e3);Cyc_Absyn_conditional_exp(_tmp566,_tmp565,_tmp564,e->loc);});goto _LL0;}case 4: _tmp89=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp88)->f2;_tmp8D=((struct Cyc_Absyn_AssignOp_e_Absyn_Raw_exp_struct*)_tmp88)->f3;{struct Cyc_Absyn_Exp*e1=_tmp89;struct Cyc_Core_Opt*po=_tmp8C;struct Cyc_Absyn_Exp*e2=_tmp8D;
# 416
new_e=({struct Cyc_Absyn_Exp*_tmp569=DC(pt,e1);struct Cyc_Core_Opt*_tmp568=(unsigned)po?({struct Cyc_Core_Opt*_tmp97=_cycalloc(sizeof(*_tmp97));_tmp97->v=(void*)po->v;_tmp97;}): 0;struct Cyc_Absyn_Exp*_tmp567=DC(pt,e2);Cyc_Absyn_assignop_exp(_tmp569,_tmp568,_tmp567,e->loc);});
...
# 419
new_e=({void*_tmp56F=(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp9A=_cycalloc(sizeof(*_tmp9A));_tmp9A->tag=10,({
struct Cyc_Absyn_Exp*_tmp56E=DC(pt,e1);_tmp9A->f1=_tmp56E;}),({struct Cyc_List_List*_tmp56D=({(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(int,struct Cyc_Absyn_Exp*),int,struct Cyc_List_List*))Cyc_List_map_c;})(DC,pt,es);_tmp9A->f2=_tmp56D;}),({
struct Cyc_Absyn_VarargCallInfo*_tmp56C=({struct Cyc_Absyn_VarargCallInfo*_tmp99=_cycalloc(sizeof(*_tmp99));_tmp99->num_varargs=n,_tmp99->injectors=is,({
struct Cyc_Absyn_VarargInfo*_tmp56B=({struct Cyc_Absyn_VarargInfo*_tmp98=_cycalloc(sizeof(*_tmp98));_tmp98->name=nm,_tmp98->tq=tq,({void*_tmp56A=Cyc_Tcutil_copy_type(t);_tmp98->type=_tmp56A;}),_tmp98->inject=i;_tmp98;});_tmp99->vai=_tmp56B;});_tmp99;});
# 421
_tmp9A->f3=_tmp56C;}),_tmp9A->f4=resolved;_tmp9A;});
# 419
Cyc_Absyn_new_exp(_tmp56F,e->loc);});
# 424
...
# 426
new_e=({void*_tmp572=(void*)({struct Cyc_Absyn_FnCall_e_Absyn_Raw_exp_struct*_tmp9B=_cycalloc(sizeof(*_tmp9B));_tmp9B->tag=10,({struct Cyc_Absyn_Exp*_tmp571=DC(pt,e1);_tmp9B->f1=_tmp571;}),({struct Cyc_List_List*_tmp570=({(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(int,struct Cyc_Absyn_Exp*),int,struct Cyc_List_List*))Cyc_List_map_c;})(DC,pt,es);_tmp9B->f2=_tmp570;}),_tmp9B->f3=vci,_tmp9B->f4=resolved;_tmp9B;});Cyc_Absyn_new_exp(_tmp572,e->loc);});
...
# 429
new_e=b?({struct Cyc_Absyn_Exp*_tmp574=DC(pt,e1);Cyc_Absyn_rethrow_exp(_tmp574,e->loc);}):({struct Cyc_Absyn_Exp*_tmp573=DC(pt,e1);Cyc_Absyn_throw_exp(_tmp573,e->loc);});
goto _LL0;}case 12: _tmp89=((struct Cyc_Absyn_NoInstantiate_e_Absyn_Raw_exp_struct*)_tmp88)->f1;{struct Cyc_Absyn_Exp*e1=_tmp89;
# 432
new_e=({struct Cyc_Absyn_Exp*_tmp575=DC(pt,e1);Cyc_Absyn_noinstantiate_exp(_tmp575,e->loc);});goto _LL0;}case 13: _tmp89=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_Instantiate_e_Absyn_Raw_exp_struct*)_tmp88)->f2;{struct Cyc_Absyn_Exp*e1=_tmp89;struct Cyc_List_List*ts=_tmp8C;
# 434
new_e=({struct Cyc_Absyn_Exp*_tmp577=DC(pt,e1);struct Cyc_List_List*_tmp576=({(struct Cyc_List_List*(*)(void*(*)(void*),struct Cyc_List_List*))Cyc_List_map;})(Cyc_Tcutil_copy_type,ts);Cyc_Absyn_instantiate_exp(_tmp577,_tmp576,e->loc);});goto _LL0;}case 14: _tmp89=(void*)((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp88)->f2;_tmp8A=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp88)->f3;_tmp92=((struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*)_tmp88)->f4;{void*t=_tmp89;struct Cyc_Absyn_Exp*e1=_tmp8C;int b=_tmp8A;enum Cyc_Absyn_Coercion c=_tmp92;
# 436
new_e=({void*_tmp57B=Cyc_Tcutil_copy_type(t);struct Cyc_Absyn_Exp*_tmp57A=DC(pt,e1);int _tmp579=b;enum Cyc_Absyn_Coercion _tmp578=c;Cyc_Absyn_cast_exp(_tmp57B,_tmp57A,_tmp579,_tmp578,e->loc);});goto _LL0;}case 16: _tmp89=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_New_e_Absyn_Raw_exp_struct*)_tmp88)->f2;{struct Cyc_Absyn_Exp*eo=_tmp89;struct Cyc_Absyn_Exp*e1=_tmp8C;
# 438
new_e=({struct Cyc_Absyn_Exp*_tmp57D=(unsigned)eo?DC(pt,eo): 0;struct Cyc_Absyn_Exp*_tmp57C=DC(pt,e1);Cyc_Absyn_New_exp(_tmp57D,_tmp57C,e->loc);});goto _LL0;}case 15: _tmp89=((struct Cyc_Absyn_Address_e_Absyn_Raw_exp_struct*)_tmp88)->f1;{struct Cyc_Absyn_Exp*e1=_tmp89;
new_e=({struct Cyc_Absyn_Exp*_tmp57E=DC(pt,e1);Cyc_Absyn_address_exp(_tmp57E,e->loc);});goto _LL0;}case 17: _tmp89=(void*)((struct Cyc_Absyn_Sizeoftype_e_Absyn_Raw_exp_struct*)_tmp88)->f1;{void*t=_tmp89;
new_e=({void*_tmp57F=Cyc_Tcutil_copy_type(t);Cyc_Absyn_sizeoftype_exp(_tmp57F,e->loc);});goto _LL0;}case 18: _tmp89=((struct Cyc_Absyn_Sizeofexp_e_Absyn_Raw_exp_struct*)_tmp88)->f1;{struct Cyc_Absyn_Exp*e1=_tmp89;
new_e=({struct Cyc_Absyn_Exp*_tmp580=DC(pt,e1);Cyc_Absyn_sizeofexp_exp(_tmp580,e->loc);});goto _LL0;}case 19: _tmp89=(void*)((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_Offsetof_e_Absyn_Raw_exp_struct*)_tmp88)->f2;{void*t=_tmp89;struct Cyc_List_List*ofs=_tmp8C;
new_e=({void*_tmp582=Cyc_Tcutil_copy_type(t);struct Cyc_List_List*_tmp581=ofs;Cyc_Absyn_offsetof_exp(_tmp582,_tmp581,e->loc);});goto _LL0;}case 20: _tmp89=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp88)->f1;{struct Cyc_Absyn_Exp*e1=_tmp89;
new_e=({struct Cyc_Absyn_Exp*_tmp583=DC(pt,e1);Cyc_Absyn_deref_exp(_tmp583,e->loc);});goto _LL0;}case 41: _tmp89=((struct Cyc_Absyn_Extension_e_Absyn_Raw_exp_struct*)_tmp88)->f1;{struct Cyc_Absyn_Exp*e1=_tmp89;
new_e=({struct Cyc_Absyn_Exp*_tmp584=DC(pt,e1);Cyc_Absyn_extension_exp(_tmp584,e->loc);});goto _LL0;}case 24: _tmp89=((struct Cyc_Absyn_Tuple_e_Absyn_Raw_exp_struct*)_tmp88)->f1;{struct Cyc_List_List*es=_tmp89;
new_e=({struct Cyc_List_List*_tmp585=({(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(int,struct Cyc_Absyn_Exp*),int,struct Cyc_List_List*))Cyc_List_map_c;})(DC,pt,es);Cyc_Absyn_tuple_exp(_tmp585,e->loc);});goto _LL0;}case 21: _tmp89=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp88)->f2;_tmp8A=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp88)->f3;_tmp8E=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp88)->f4;{struct Cyc_Absyn_Exp*e1=_tmp89;struct _fat_ptr*n=_tmp8C;int f1=_tmp8A;int f2=_tmp8E;
# 447
new_e=({void*_tmp587=(void*)({struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*_tmp9C=_cycalloc(sizeof(*_tmp9C));_tmp9C->tag=21,({struct Cyc_Absyn_Exp*_tmp586=DC(pt,e1);_tmp9C->f1=_tmp586;}),_tmp9C->f2=n,_tmp9C->f3=f1,_tmp9C->f4=f2;_tmp9C;});Cyc_Absyn_new_exp(_tmp587,e->loc);});goto _LL0;}case 22: _tmp89=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp88)->f2;_tmp8A=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp88)->f3;_tmp8E=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp88)->f4;{struct Cyc_Absyn_Exp*e1=_tmp89;struct _fat_ptr*n=_tmp8C;int f1=_tmp8A;int f2=_tmp8E;
# 449
new_e=({void*_tmp589=(void*)({struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*_tmp9D=_cycalloc(sizeof(*_tmp9D));_tmp9D->tag=22,({struct Cyc_Absyn_Exp*_tmp588=DC(pt,e1);_tmp9D->f1=_tmp588;}),_tmp9D->f2=n,_tmp9D->f3=f1,_tmp9D->f4=f2;_tmp9D;});Cyc_Absyn_new_exp(_tmp589,e->loc);});goto _LL0;}case 23: _tmp89=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_Subscript_e_Absyn_Raw_exp_struct*)_tmp88)->f2;{struct Cyc_Absyn_Exp*e1=_tmp89;struct Cyc_Absyn_Exp*e2=_tmp8C;
# 451
new_e=({struct Cyc_Absyn_Exp*_tmp58B=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp58A=DC(pt,e2);Cyc_Absyn_subscript_exp(_tmp58B,_tmp58A,e->loc);});goto _LL0;}case 26: _tmp89=((struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*)_tmp88)->f1;{struct Cyc_List_List*eds=_tmp89;
# 453
new_e=({void*_tmp58D=(void*)({struct Cyc_Absyn_Array_e_Absyn_Raw_exp_struct*_tmp9E=_cycalloc(sizeof(*_tmp9E));_tmp9E->tag=26,({struct Cyc_List_List*_tmp58C=({(struct Cyc_List_List*(*)(struct _tuple16*(*)(int,struct _tuple16*),int,struct Cyc_List_List*))Cyc_List_map_c;})(Cyc_Tcutil_copy_eds,pt,eds);_tmp9E->f1=_tmp58C;});_tmp9E;});Cyc_Absyn_new_exp(_tmp58D,e->loc);});goto _LL0;}case 31: _tmp89=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp88)->f2;_tmp8D=((struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*)_tmp88)->f3;{struct Cyc_List_List*es=_tmp89;struct Cyc_Absyn_Datatypedecl*dtd=_tmp8C;struct Cyc_Absyn_Datatypefield*dtf=_tmp8D;
# 455
new_e=({void*_tmp58F=(void*)({struct Cyc_Absyn_Datatype_e_Absyn_Raw_exp_struct*_tmp9F=_cycalloc(sizeof(*_tmp9F));_tmp9F->tag=31,({struct Cyc_List_List*_tmp58E=({(struct Cyc_List_List*(*)(struct Cyc_Absyn_Exp*(*)(int,struct Cyc_Absyn_Exp*),int,struct Cyc_List_List*))Cyc_List_map_c;})(DC,pt,es);_tmp9F->f1=_tmp58E;}),_tmp9F->f2=dtd,_tmp9F->f3=dtf;_tmp9F;});Cyc_Absyn_new_exp(_tmp58F,e->loc);});goto _LL0;}case 27: _tmp89=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp88)->f2;_tmp8D=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp88)->f3;_tmp8A=((struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*)_tmp88)->f4;{struct Cyc_Absyn_Vardecl*vd=_tmp89;struct Cyc_Absyn_Exp*e1=_tmp8C;struct Cyc_Absyn_Exp*e2=_tmp8D;int b=_tmp8A;
# 457
new_e=({void*_tmp592=(void*)({struct Cyc_Absyn_Comprehension_e_Absyn_Raw_exp_struct*_tmpA0=_cycalloc(sizeof(*_tmpA0));_tmpA0->tag=27,_tmpA0->f1=vd,({struct Cyc_Absyn_Exp*_tmp591=DC(pt,e1);_tmpA0->f2=_tmp591;}),({struct Cyc_Absyn_Exp*_tmp590=DC(pt,e2);_tmpA0->f3=_tmp590;}),_tmpA0->f4=b;_tmpA0;});Cyc_Absyn_new_exp(_tmp592,e->loc);});goto _LL0;}case 28: _tmp89=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=(void*)((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp88)->f2;_tmp8A=((struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*)_tmp88)->f3;{struct Cyc_Absyn_Exp*e=_tmp89;void*t=_tmp8C;int b=_tmp8A;
# 459
new_e=({void*_tmp595=(void*)({struct Cyc_Absyn_ComprehensionNoinit_e_Absyn_Raw_exp_struct*_tmpA1=_cycalloc(sizeof(*_tmpA1));_tmpA1->tag=28,({struct Cyc_Absyn_Exp*_tmp594=DC(pt,e);_tmpA1->f1=_tmp594;}),({void*_tmp593=Cyc_Tcutil_copy_type(t);_tmpA1->f2=_tmp593;}),_tmpA1->f3=b;_tmpA1;});Cyc_Absyn_new_exp(_tmp595,e->loc);});
...
# 462
new_e=({void*_tmp598=(void*)({struct Cyc_Absyn_Aggregate_e_Absyn_Raw_exp_struct*_tmpA2=_cycalloc(sizeof(*_tmpA2));_tmpA2->tag=29,_tmpA2->f1=n,({struct Cyc_List_List*_tmp597=({(struct Cyc_List_List*(*)(void*(*)(void*),struct Cyc_List_List*))Cyc_List_map;})(Cyc_Tcutil_copy_type,ts);_tmpA2->f2=_tmp597;}),({struct Cyc_List_List*_tmp596=({(struct Cyc_List_List*(*)(struct _tuple16*(*)(int,struct _tuple16*),int,struct Cyc_List_List*))Cyc_List_map_c;})(Cyc_Tcutil_copy_eds,pt,eds);_tmpA2->f3=_tmp596;}),_tmpA2->f4=agr;_tmpA2;});Cyc_Absyn_new_exp(_tmp598,e->loc);});
# 464
...
# 466
new_e=({void*_tmp59B=(void*)({struct Cyc_Absyn_AnonStruct_e_Absyn_Raw_exp_struct*_tmpA3=_cycalloc(sizeof(*_tmpA3));_tmpA3->tag=30,({void*_tmp59A=Cyc_Tcutil_copy_type(t);_tmpA3->f1=_tmp59A;}),({struct Cyc_List_List*_tmp599=({(struct Cyc_List_List*(*)(struct _tuple16*(*)(int,struct _tuple16*),int,struct Cyc_List_List*))Cyc_List_map_c;})(Cyc_Tcutil_copy_eds,pt,eds);_tmpA3->f2=_tmp599;});_tmpA3;});Cyc_Absyn_new_exp(_tmp59B,e->loc);});
...
# 469
new_e=({void*_tmp59F=(void*)({struct Cyc_Absyn_CompoundLit_e_Absyn_Raw_exp_struct*_tmpA5=_cycalloc(sizeof(*_tmpA5));_tmpA5->tag=25,({struct _tuple9*_tmp59E=({struct _tuple9*_tmpA4=_cycalloc(sizeof(*_tmpA4));_tmpA4->f1=vopt,_tmpA4->f2=tq,({void*_tmp59D=Cyc_Tcutil_copy_type(t);_tmpA4->f3=_tmp59D;});_tmpA4;});_tmpA5->f1=_tmp59E;}),({
struct Cyc_List_List*_tmp59C=({(struct Cyc_List_List*(*)(struct _tuple16*(*)(int,struct _tuple16*),int,struct Cyc_List_List*))Cyc_List_map_c;})(Cyc_Tcutil_copy_eds,pt,eds);_tmpA5->f2=_tmp59C;});_tmpA5;});
# 469
Cyc_Absyn_new_exp(_tmp59F,e->loc);});
# 471
...
# 474
new_e=({void*_tmp5A1=(void*)({struct Cyc_Absyn_AnonEnum_e_Absyn_Raw_exp_struct*_tmpA6=_cycalloc(sizeof(*_tmpA6));_tmpA6->tag=33,({void*_tmp5A0=Cyc_Tcutil_copy_type(t);_tmpA6->f1=_tmp5A0;}),_tmpA6->f2=ef;_tmpA6;});Cyc_Absyn_new_exp(_tmp5A1,e->loc);});goto _LL0;}case 34: _tmp8A=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp88)->f1).is_calloc;_tmp89=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp88)->f1).rgn;_tmp8C=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp88)->f1).elt_type;_tmp8D=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp88)->f1).num_elts;_tmp8E=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp88)->f1).fat_result;_tmp8F=(((struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*)_tmp88)->f1).inline_call;{int ic=_tmp8A;struct Cyc_Absyn_Exp*r=_tmp89;void**t=_tmp8C;struct Cyc_Absyn_Exp*n=_tmp8D;int res=_tmp8E;int inlc=_tmp8F;
# 476
struct Cyc_Absyn_Exp*e2=Cyc_Absyn_copy_exp(e);
struct Cyc_Absyn_Exp*r1=r;if(r != 0)r1=DC(pt,r);{
void**t1=t;if(t != 0)t1=({void**_tmpA7=_cycalloc(sizeof(*_tmpA7));({void*_tmp5A2=Cyc_Tcutil_copy_type(*t);*_tmpA7=_tmp5A2;});_tmpA7;});
({void*_tmp5A3=(void*)({struct Cyc_Absyn_Malloc_e_Absyn_Raw_exp_struct*_tmpA8=_cycalloc(sizeof(*_tmpA8));_tmpA8->tag=34,(_tmpA8->f1).is_calloc=ic,(_tmpA8->f1).rgn=r1,(_tmpA8->f1).elt_type=t1,(_tmpA8->f1).num_elts=n,(_tmpA8->f1).fat_result=res,(_tmpA8->f1).inline_call=inlc;_tmpA8;});e2->r=_tmp5A3;});
new_e=e2;
...
new_e=({struct Cyc_Absyn_Exp*_tmp5A5=DC(pt,e1);struct Cyc_Absyn_Exp*_tmp5A4=DC(pt,e2);Cyc_Absyn_swap_exp(_tmp5A5,_tmp5A4,e->loc);});goto _LL0;}case 36: _tmp89=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmp88)->f2;{struct Cyc_Core_Opt*nopt=_tmp89;struct Cyc_List_List*eds=_tmp8C;
# 484
...
new_e=({void*_tmp5A7=(void*)({struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*_tmpAA=_cycalloc(sizeof(*_tmpAA));_tmpAA->tag=36,_tmpAA->f1=nopt1,({struct Cyc_List_List*_tmp5A6=({(struct Cyc_List_List*(*)(struct _tuple16*(*)(int,struct _tuple16*),int,struct Cyc_List_List*))Cyc_List_map_c;})(Cyc_Tcutil_copy_eds,pt,eds);_tmpAA->f2=_tmp5A6;});_tmpAA;});Cyc_Absyn_new_exp(_tmp5A7,e->loc);});
goto _LL0;}case 37:
# 489
(int)_throw((void*)({struct Cyc_Core_Failure_exn_struct*_tmpAC=_cycalloc(sizeof(*_tmpAC));_tmpAC->tag=Cyc_Core_Failure,({struct _fat_ptr _tmp5A8=({const char*_tmpAB="deep_copy: statement expressions unsupported";_tag_fat(_tmpAB,sizeof(char),45U);});_tmpAC->f1=_tmp5A8;});_tmpAC;}));case 38: _tmp89=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8C=((struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*)_tmp88)->f2;{struct Cyc_Absyn_Exp*e1=_tmp89;struct _fat_ptr*fn=_tmp8C;
# 491
new_e=({void*_tmp5AA=(void*)({struct Cyc_Absyn_Tagcheck_e_Absyn_Raw_exp_struct*_tmpAD=_cycalloc(sizeof(*_tmpAD));_tmpAD->tag=38,({struct Cyc_Absyn_Exp*_tmp5A9=DC(pt,e1);_tmpAD->f1=_tmp5A9;}),_tmpAD->f2=fn;_tmpAD;});Cyc_Absyn_new_exp(_tmp5AA,e->loc);});goto _LL0;}case 39: _tmp89=(void*)((struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*)_tmp88)->f1;{void*t=_tmp89;
new_e=({void*_tmp5AB=Cyc_Tcutil_copy_type(t);Cyc_Absyn_valueof_exp(_tmp5AB,e->loc);});goto _LL0;}case 40: _tmp8A=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmp88)->f1;_tmp8B=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmp88)->f2;_tmp89=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmp88)->f3;_tmp8C=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmp88)->f4;_tmp8D=((struct Cyc_Absyn_Asm_e_Absyn_Raw_exp_struct*)_tmp88)->f5;{int v=_tmp8A;struct _fat_ptr t=_tmp8B;struct Cyc_List_List*o=_tmp89;struct Cyc_List_List*i=_tmp8C;struct Cyc_List_List*c=_tmp8D;
...
void*_tmpB1=(void*)(_check_null(ts))->hd;void*t=_tmpB1;
enum Cyc_Absyn_KindQual _tmpB2=(Cyc_Kinds_tvar_kind(tv,& Cyc_Kinds_bk))->kind;enum Cyc_Absyn_KindQual _stmttmp18=_tmpB2;enum Cyc_Absyn_KindQual _tmpB3=_stmttmp18;switch((int)_tmpB3){case Cyc_Absyn_IntKind:
 ...
 inst=({struct Cyc_List_List*_tmpB5=_region_malloc(r,sizeof(*_tmpB5));({struct _tuple17*_tmp5AC=({struct _tuple17*_tmpB4=_region_malloc(r,sizeof(*_tmpB4));_tmpB4->f1=tv,_tmpB4->f2=t;_tmpB4;});_tmpB5->hd=_tmp5AC;}),_tmpB5->tl=inst;_tmpB5;});goto _LL0;default:
 goto _LL0;}_LL0:;}
# 524
if(inst != 0){
field_type=({struct _RegionHandle*_tmp5AE=r;struct Cyc_List_List*_tmp5AD=({(struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev;})(inst);Cyc_Tcutil_rsubstitute(_tmp5AE,_tmp5AD,field_type);});
...
return(struct Cyc_Absyn_Kind*)(_check_null(k))->v;}case 2: _tmpB8=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpB7)->f1;{struct Cyc_Absyn_Tvar*tv=_tmpB8;
...
# 565
({struct Cyc_Warn_String_Warn_Warg_struct _tmpC2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4C3;_tmp4C3.tag=0,({struct _fat_ptr _tmp5AF=({const char*_tmpC3="type_kind: Unresolved DatatypeFieldType";_tag_fat(_tmpC3,sizeof(char),40U);});_tmp4C3.f1=_tmp5AF;});_tmp4C3;});void*_tmpC1[1];_tmpC1[0]=& _tmpC2;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmpC1,sizeof(void*),1));});}default: if(((((struct Cyc_Absyn_AggrCon_Absyn_TyCon_struct*)_tmpBB)->f1).UnknownAggr).tag == 1)
# 568
...
# 620
if(td == 0 || td->kind == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmpD0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4C5;_tmp4C5.tag=0,({struct _fat_ptr _tmp5B0=({const char*_tmpD2="type_kind: typedef found: ";_tag_fat(_tmpD2,sizeof(char),27U);});_tmp4C5.f1=_tmp5B0;});_tmp4C5;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmpD1=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4C4;_tmp4C4.tag=2,_tmp4C4.f1=(void*)t;_tmp4C4;});void*_tmpCF[2];_tmpCF[0]=& _tmpD0,_tmpCF[1]=& _tmpD1;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmpCF,sizeof(void*),2));});
return(struct Cyc_Absyn_Kind*)(_check_null(td->kind))->v;}default: switch(*((int*)((struct Cyc_Absyn_TypeDecl*)((struct Cyc_Absyn_TypeDeclType_Absyn_Type_struct*)_tmpB7)->f1)->r)){case 1:
...
{struct Cyc_Absyn_Kind*_tmpD3=Cyc_Kinds_tvar_kind(tv,& Cyc_Kinds_bk);struct Cyc_Absyn_Kind*_stmttmp1D=_tmpD3;struct Cyc_Absyn_Kind*_tmpD4=_stmttmp1D;switch((int)((struct Cyc_Absyn_Kind*)_tmpD4)->kind){case Cyc_Absyn_RgnKind: switch((int)((struct Cyc_Absyn_Kind*)_tmpD4)->aliasqual){case Cyc_Absyn_Unique:
 ...
 t=(void*)({struct Cyc_Absyn_ValueofType_Absyn_Type_struct*_tmpD5=_cycalloc(sizeof(*_tmpD5));_tmpD5->tag=9,({struct Cyc_Absyn_Exp*_tmp5B1=Cyc_Absyn_uint_exp(0U,0U);_tmpD5->f1=_tmp5B1;});_tmpD5;});goto _LL0;case Cyc_Absyn_BoolKind:
...
# 681
void*_tmpE3=({struct Cyc_List_List*_tmp5B4=({(struct Cyc_List_List*(*)(struct _tuple17*(*)(struct Cyc_Absyn_Tvar*),struct Cyc_List_List*))Cyc_List_map;})(Cyc_Tcutil_region_free_subst,tvs);Cyc_Tcutil_substitute(_tmp5B4,_check_null(eff));});void*e=_tmpE3;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmpE7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4C6;_tmp4C6.tag=0,({struct _fat_ptr _tmp5B5=({const char*_tmpE8="typedecl in rgns_of";_tag_fat(_tmpE8,sizeof(char),20U);});_tmp4C6.f1=_tmp5B5;});_tmp4C6;});void*_tmpE6[1];_tmpE6[0]=& _tmpE7;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmpE6,sizeof(void*),1));});case 9:
 goto _LL1C;default: _LL1C:
...
({void*_tmp5B6=(void*)Cyc_Absyn_compress(Cyc_Tcutil_normalize_effect(eff));effs->hd=_tmp5B6;});{
...
# 727
({struct Cyc_List_List*_tmp5B7=({(struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev;})(effects);*es=_tmp5B7;});
...
struct Cyc_Absyn_Tqual _tmp5B8=Cyc_Absyn_empty_tqual(0U);(_tmpF5->f1).ret_tqual=_tmp5B8;}),(_tmpF5->f1).ret_type=Cyc_Absyn_void_type,(_tmpF5->f1).args=0,(_tmpF5->f1).c_varargs=0,(_tmpF5->f1).cyc_varargs=0,(_tmpF5->f1).rgn_po=0,(_tmpF5->f1).attributes=0,(_tmpF5->f1).requires_clause=0,(_tmpF5->f1).requires_relns=0,(_tmpF5->f1).ensures_clause=0,(_tmpF5->f1).ensures_relns=0,(_tmpF5->f1).return_value=0;_tmpF5;});
# 741
struct Cyc_Absyn_FnType_Absyn_Type_struct*fntype=_tmpF4;
# 751
return({void*_tmp5BD=(void*)fntype;void*_tmp5BC=Cyc_Absyn_heap_rgn_type;struct Cyc_Absyn_Tqual _tmp5BB=Cyc_Absyn_empty_tqual(0U);void*_tmp5BA=Cyc_Absyn_bounds_one();void*_tmp5B9=Cyc_Absyn_false_type;Cyc_Absyn_atb_type(_tmp5BD,_tmp5BC,_tmp5BB,_tmp5BA,_tmp5B9,Cyc_Absyn_false_type);});}
# 758
...
if(r == r2)return 1;{
struct _tuple15 _tmpFB=({struct _tuple15 _tmp4C7;_tmp4C7.f1=r,_tmp4C7.f2=r2;_tmp4C7;});struct _tuple15 _stmttmp24=_tmpFB;struct _tuple15 _tmpFC=_stmttmp24;void*_tmpFE;void*_tmpFD;if(*((int*)_tmpFC.f1)== 2){if(*((int*)_tmpFC.f2)== 2){_tmpFD=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpFC.f1)->f1;_tmpFE=((struct Cyc_Absyn_VarType_Absyn_Type_struct*)_tmpFC.f2)->f1;{struct Cyc_Absyn_Tvar*tv1=_tmpFD;struct Cyc_Absyn_Tvar*tv2=_tmpFE;
...
({void*_tmp5BF=Cyc_Tcutil_dummy_fntype(Cyc_Absyn_join_eff(({void*_tmp108[2];_tmp108[0]=ev,({void*_tmp5BE=Cyc_Absyn_access_eff(r);_tmp108[1]=_tmp5BE;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp108,sizeof(void*),2));})));*p=_tmp5BF;});
return 1;}}else{
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp10A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4C8;_tmp4C8.tag=0,({struct _fat_ptr _tmp5C0=({const char*_tmp10B="effect evar has wrong kind";_tag_fat(_tmp10B,sizeof(char),27U);});_tmp4C8.f1=_tmp5C0;});_tmp4C8;});void*_tmp109[1];_tmp109[0]=& _tmp10A;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp109,sizeof(void*),1));});
if(!constrain)return 0;{
# 800
void*_tmp10C=Cyc_Absyn_new_evar(& Cyc_Kinds_eko,s);void*ev=_tmp10C;
# 803
Cyc_Unify_occurs(ev,Cyc_Core_heap_region,(struct Cyc_List_List*)(_check_null(s))->v,r);
({void*_tmp5C2=Cyc_Absyn_join_eff(({void*_tmp10D[2];_tmp10D[0]=ev,({void*_tmp5C1=Cyc_Absyn_access_eff(r);_tmp10D[1]=_tmp5C1;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp10D,sizeof(void*),2));}));*p=_tmp5C2;});
...
# 835
if(k == 0 ||(int)((struct Cyc_Absyn_Kind*)k->v)->kind != 4)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp11B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4CA;_tmp4CA.tag=0,({struct _fat_ptr _tmp5C4=({const char*_tmp11C="effect evar has wrong kind";_tag_fat(_tmp11C,sizeof(char),27U);});_tmp4CA.f1=_tmp5C4;});_tmp4CA;});void*_tmp11A[1];_tmp11A[0]=& _tmp11B;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp11A,sizeof(void*),1));});
...
void*_tmp11E=Cyc_Absyn_join_eff(({void*_tmp11F[2];_tmp11F[0]=ev,({void*_tmp5C5=Cyc_Absyn_regionsof_eff(t);_tmp11F[1]=_tmp5C5;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp11F,sizeof(void*),2));}));void*new_typ=_tmp11E;
*p=new_typ;
return 1;}}}default: _LL9:
 return 0;};}}
# 853
...
({void*_tmp5C7=Cyc_Tcutil_dummy_fntype(Cyc_Absyn_join_eff(({void*_tmp12D[2];_tmp12D[0]=ev,({void*_tmp5C6=Cyc_Absyn_var_type(v);_tmp12D[1]=_tmp5C6;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp12D,sizeof(void*),2));})));*p=_tmp5C7;});
return 1;}}else{
...
# 881
if(k == 0 ||(int)((struct Cyc_Absyn_Kind*)k->v)->kind != 4)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp12F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4CB;_tmp4CB.tag=0,({struct _fat_ptr _tmp5C8=({const char*_tmp130="effect evar has wrong kind";_tag_fat(_tmp130,sizeof(char),27U);});_tmp4CB.f1=_tmp5C8;});_tmp4CB;});void*_tmp12E[1];_tmp12E[0]=& _tmp12F;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp12E,sizeof(void*),1));});{
# 885
...
return 0;{
void*_tmp132=Cyc_Absyn_join_eff(({void*_tmp133[2];_tmp133[0]=ev,({void*_tmp5C9=Cyc_Absyn_var_type(v);_tmp133[1]=_tmp5C9;});({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp133,sizeof(void*),2));}));void*new_typ=_tmp132;
*p=new_typ;
return 1;}}}default: _LL9:
 return 0;};}}
# 897
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp141=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4CD;_tmp4CD.tag=0,({struct _fat_ptr _tmp5CA=({const char*_tmp143="subset_effect: bad effect: ";_tag_fat(_tmp143,sizeof(char),28U);});_tmp4CD.f1=_tmp5CA;});_tmp4CD;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp142=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4CC;_tmp4CC.tag=2,_tmp4CC.f1=(void*)e1;_tmp4CC;});void*_tmp140[2];_tmp140[0]=& _tmp141,_tmp140[1]=& _tmp142;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp140,sizeof(void*),2));});};}
# 973
...
# 1035
({struct Cyc_Warn_String_Warn_Warg_struct _tmp14E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4CE;_tmp4CE.tag=0,({struct _fat_ptr _tmp5CB=({const char*_tmp14F="bad con";_tag_fat(_tmp14F,sizeof(char),8U);});_tmp4CE.f1=_tmp5CB;});_tmp4CE;});void*_tmp14D[1];_tmp14D[0]=& _tmp14E;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp14D,sizeof(void*),1));});}case 2: switch((int)((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp14C)->f1){case 0:
# 1014
 return 16;case 1:
 return 17;default:
 return 18;}case 3:
...
# 1068
return({struct _tuple18 _tmp4CF;_tmp4CF.f1=dd->name,_tmp4CF.f2=df->name;_tmp4CF;});}}else{_tmp156=((_tmp155.UnknownDatatypefield).val).datatype_name;_tmp157=((_tmp155.UnknownDatatypefield).val).field_name;{struct _tuple1*d=_tmp156;struct _tuple1*f=_tmp157;
# 1070
return({struct _tuple18 _tmp4D0;_tmp4D0.f1=d,_tmp4D0.f2=f;_tmp4D0;});}};}struct _tuple19{enum Cyc_Absyn_AggrKind f1;struct _tuple1*f2;};
# 1073
...
return({struct _tuple19 _tmp4D1;_tmp4D1.f1=k,_tmp4D1.f2=n;_tmp4D1;});}}else{_tmp159=*(_tmp158.KnownAggr).val;{struct Cyc_Absyn_Aggrdecl*ad=_tmp159;
return({struct _tuple19 _tmp4D2;_tmp4D2.f1=ad->kind,_tmp4D2.f2=ad->name;_tmp4D2;});}};}
# 1079
...
# 1091
return({struct _tuple1*_tmp5CC=Cyc_Tcutil_get_datatype_qvar(info1);Cyc_Absyn_qvar_cmp(_tmp5CC,Cyc_Tcutil_get_datatype_qvar(info2));});}}else{goto _LLD;}case 19: if(*((int*)_tmp15C.f2)== 19){_tmp15F=((struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*)_tmp15C.f1)->f1;_tmp160=((struct Cyc_Absyn_DatatypeFieldCon_Absyn_TyCon_struct*)_tmp15C.f2)->f1;{union Cyc_Absyn_DatatypeFieldInfo info1=_tmp15F;union Cyc_Absyn_DatatypeFieldInfo info2=_tmp160;
# 1093
...
if(a1 != 0 && a2 == 0)return 1;
return({int(*_tmp5CE)(void*,void*)=cmp;void*_tmp5CD=_check_null(a1);_tmp5CE(_tmp5CD,_check_null(a2));});}
# 1114
...
if(e1 == e2)return 0;
if(e1 == 0 || e2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1A7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4D4;_tmp4D4.tag=0,({struct _fat_ptr _tmp5D0=({const char*_tmp1A8="missing expression in array index";_tag_fat(_tmp1A8,sizeof(char),34U);});_tmp4D4.f1=_tmp5D0;});_tmp4D4;});void*_tmp1A6[1];_tmp1A6[0]=& _tmp1A7;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp1A6,sizeof(void*),1));});
...
r=({struct Cyc_Absyn_Tqual _tmp5D1=(_check_null(f1.cyc_varargs))->tq;Cyc_Tcutil_tqual_cmp(_tmp5D1,(_check_null(f2.cyc_varargs))->tq);});
if(r != 0)return r;
...
if(r != 0)return r;
# 1245
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1BE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4D5;_tmp4D5.tag=0,({struct _fat_ptr _tmp5D2=({const char*_tmp1BF="typecmp: function type comparison should never get here!";_tag_fat(_tmp1BF,sizeof(char),57U);});_tmp4D5.f1=_tmp5D2;});_tmp4D5;});void*_tmp1BD[1];_tmp1BD[0]=& _tmp1BE;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp1BD,sizeof(void*),1));});}}}}}else{goto _LL15;}case 6: if(*((int*)_tmp188.f2)== 6){_tmp189=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp188.f1)->f1;_tmp18A=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp188.f2)->f1;{struct Cyc_List_List*ts2=_tmp189;struct Cyc_List_List*ts1=_tmp18A;
# 1248
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1C1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4D6;_tmp4D6.tag=0,({struct _fat_ptr _tmp5D3=({const char*_tmp1C2="Unmatched case in typecmp";_tag_fat(_tmp1C2,sizeof(char),26U);});_tmp4D6.f1=_tmp5D3;});_tmp4D6;});void*_tmp1C0[1];_tmp1C0[0]=& _tmp1C1;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp1C0,sizeof(void*),1));});};}}}
# 1263
static int Cyc_Tcutil_will_lose_precision(void*t1,void*t2){
struct _tuple15 _tmp1C3=({struct _tuple15 _tmp4D9;({void*_tmp5D5=Cyc_Absyn_compress(t1);_tmp4D9.f1=_tmp5D5;}),({void*_tmp5D4=Cyc_Absyn_compress(t2);_tmp4D9.f2=_tmp5D4;});_tmp4D9;});struct _tuple15 _stmttmp3B=_tmp1C3;struct _tuple15 _tmp1C4=_stmttmp3B;void*_tmp1C6;void*_tmp1C5;if(*((int*)_tmp1C4.f1)== 0){if(*((int*)_tmp1C4.f2)== 0){_tmp1C5=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1C4.f1)->f1;_tmp1C6=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1C4.f2)->f1;{void*c1=_tmp1C5;void*c2=_tmp1C6;
# 1266
struct _tuple15 _tmp1C7=({struct _tuple15 _tmp4D8;_tmp4D8.f1=c1,_tmp4D8.f2=c2;_tmp4D8;});struct _tuple15 _stmttmp3C=_tmp1C7;struct _tuple15 _tmp1C8=_stmttmp3C;int _tmp1CA;int _tmp1C9;switch(*((int*)_tmp1C8.f1)){case 2: switch(*((int*)_tmp1C8.f2)){case 2: _tmp1C9=((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp1C8.f1)->f1;_tmp1CA=((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp1C8.f2)->f1;{int i1=_tmp1C9;int i2=_tmp1CA;
return i2 < i1;}case 1:
...
{struct _tuple15 _tmp1CB=({struct _tuple15 _tmp4DB;({void*_tmp5D7=Cyc_Absyn_compress(t1);_tmp4DB.f1=_tmp5D7;}),({void*_tmp5D6=Cyc_Absyn_compress(t2);_tmp4DB.f2=_tmp5D6;});_tmp4DB;});struct _tuple15 _stmttmp3D=_tmp1CB;struct _tuple15 _tmp1CC=_stmttmp3D;void*_tmp1CE;void*_tmp1CD;if(*((int*)_tmp1CC.f1)== 0){if(*((int*)_tmp1CC.f2)== 0){_tmp1CD=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1CC.f1)->f1;_tmp1CE=(void*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp1CC.f2)->f1;{void*c1=_tmp1CD;void*c2=_tmp1CE;
# 1296
{struct _tuple15 _tmp1CF=({struct _tuple15 _tmp4DA;_tmp4DA.f1=c1,_tmp4DA.f2=c2;_tmp4DA;});struct _tuple15 _stmttmp3E=_tmp1CF;struct _tuple15 _tmp1D0=_stmttmp3E;int _tmp1D2;int _tmp1D1;if(*((int*)_tmp1D0.f1)== 2){if(*((int*)_tmp1D0.f2)== 2){_tmp1D1=((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp1D0.f1)->f1;_tmp1D2=((struct Cyc_Absyn_FloatCon_Absyn_TyCon_struct*)_tmp1D0.f2)->f1;{int i1=_tmp1D1;int i2=_tmp1D2;
# 1298
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1D5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4DF;_tmp4DF.tag=0,({struct _fat_ptr _tmp5D8=({const char*_tmp1DA="type mismatch: expecting ";_tag_fat(_tmp1DA,sizeof(char),26U);});_tmp4DF.f1=_tmp5D8;});_tmp4DF;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1D6=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4DE;_tmp4DE.tag=2,_tmp4DE.f1=(void*)t;_tmp4DE;});struct Cyc_Warn_String_Warn_Warg_struct _tmp1D7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4DD;_tmp4DD.tag=0,({struct _fat_ptr _tmp5D9=({const char*_tmp1D9=" but found ";_tag_fat(_tmp1D9,sizeof(char),12U);});_tmp4DD.f1=_tmp5D9;});_tmp4DD;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1D8=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4DC;_tmp4DC.tag=2,_tmp4DC.f1=(void*)
_check_null(((struct Cyc_Absyn_Exp*)el->hd)->topt);_tmp4DC;});void*_tmp1D4[4];_tmp1D4[0]=& _tmp1D5,_tmp1D4[1]=& _tmp1D6,_tmp1D4[2]=& _tmp1D7,_tmp1D4[3]=& _tmp1D8;Cyc_Warn_err2(((struct Cyc_Absyn_Exp*)el->hd)->loc,_tag_fat(_tmp1D4,sizeof(void*),4));});
return 0;}}}
# 1348
return 1;}
# 1353
...
void*_tmp1DB=Cyc_Absyn_compress(_check_null(e->topt));void*_stmttmp3F=_tmp1DB;void*_tmp1DC=_stmttmp3F;if(*((int*)_tmp1DC)== 3){
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1DE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E0;_tmp4E0.tag=0,({struct _fat_ptr _tmp5DA=({const char*_tmp1DF="integral size mismatch; conversion supplied";_tag_fat(_tmp1DF,sizeof(char),44U);});_tmp4E0.f1=_tmp5DA;});_tmp4E0;});void*_tmp1DD[1];_tmp1DD[0]=& _tmp1DE;Cyc_Warn_warn2(e->loc,_tag_fat(_tmp1DD,sizeof(void*),1));});
...
({void*_tmp5DB=t;Cyc_Unify_unify(_tmp5DB,Cyc_Absyn_bounds_one());});
return Cyc_Absyn_compress(t);}
# 1396
struct Cyc_Absyn_Exp*Cyc_Tcutil_get_thin_bound(struct Cyc_List_List*ts){
void*_tmp1E0=Cyc_Absyn_compress((void*)(_check_null(ts))->hd);void*t=_tmp1E0;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1E8=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E2;_tmp4E2.tag=0,({struct _fat_ptr _tmp5DC=({const char*_tmp1EA="get_bounds_exp: ";_tag_fat(_tmp1EA,sizeof(char),17U);});_tmp4E2.f1=_tmp5DC;});_tmp4E2;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1E9=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4E1;_tmp4E1.tag=2,_tmp4E1.f1=(void*)b;_tmp4E1;});void*_tmp1E7[2];_tmp1E7[0]=& _tmp1E8,_tmp1E7[1]=& _tmp1E9;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp1E7,sizeof(void*),2));});};}}
# 1419
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp1EF=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E4;_tmp4E4.tag=0,({struct _fat_ptr _tmp5DD=({const char*_tmp1F1="get_ptr_bounds_exp not pointer: ";_tag_fat(_tmp1F1,sizeof(char),33U);});_tmp4E4.f1=_tmp5DD;});_tmp4E4;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp1F0=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4E3;_tmp4E3.tag=2,_tmp4E3.f1=(void*)t;_tmp4E3;});void*_tmp1EE[2];_tmp1EE[0]=& _tmp1EF,_tmp1EE[1]=& _tmp1F0;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp1EE,sizeof(void*),2));});};}
# 1428
...
struct _tuple20 _tmp200=({struct _tuple20 _tmp4E6;({struct Cyc_Absyn_Exp*_tmp5E1=({void*_tmp5E0=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp5E0,(pinfo_a.ptr_atts).bounds);});_tmp4E6.f1=_tmp5E1;}),({
struct Cyc_Absyn_Exp*_tmp5DF=({void*_tmp5DE=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp5DE,(pinfo_b.ptr_atts).bounds);});_tmp4E6.f2=_tmp5DF;});_tmp4E6;});
# 1455
...
void*_tmp5E2=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp5E2,(pinfo_b.ptr_atts).bounds);}))
goto _LL9;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp205=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E5;_tmp4E5.tag=0,({struct _fat_ptr _tmp5E3=({const char*_tmp206="implicit cast to shorter array";_tag_fat(_tmp206,sizeof(char),31U);});_tmp4E5.f1=_tmp5E3;});_tmp4E5;});void*_tmp204[1];_tmp204[0]=& _tmp205;Cyc_Warn_warn2(loc,_tag_fat(_tmp204,sizeof(void*),1));});
if(!({struct Cyc_Absyn_Exp*_tmp5E4=_check_null(e2);Cyc_Evexp_lte_const_exp(_tmp5E4,_check_null(e1));}))
return 0;
goto _LL9;}}}_LL9:;}
# 1477
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp208=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4EA;_tmp4EA.tag=0,({struct _fat_ptr _tmp5E5=({const char*_tmp20D="implicit cast from region ";_tag_fat(_tmp20D,sizeof(char),27U);});_tmp4EA.f1=_tmp5E5;});_tmp4EA;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp209=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4E9;_tmp4E9.tag=2,_tmp4E9.f1=(void*)(pinfo_a.ptr_atts).rgn;_tmp4E9;});struct Cyc_Warn_String_Warn_Warg_struct _tmp20A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4E8;_tmp4E8.tag=0,({
struct _fat_ptr _tmp5E6=({const char*_tmp20C=" to region ";_tag_fat(_tmp20C,sizeof(char),12U);});_tmp4E8.f1=_tmp5E6;});_tmp4E8;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp20B=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4E7;_tmp4E7.tag=2,_tmp4E7.f1=(void*)(pinfo_b.ptr_atts).rgn;_tmp4E7;});void*_tmp207[4];_tmp207[0]=& _tmp208,_tmp207[1]=& _tmp209,_tmp207[2]=& _tmp20A,_tmp207[3]=& _tmp20B;Cyc_Warn_warn2(loc,_tag_fat(_tmp207,sizeof(void*),4));});}
# 1489
...
return 1;
# 1504
if(!({void*_tmp5E7=Cyc_Absyn_bounds_one();Cyc_Unify_unify(_tmp5E7,(pinfo_b.ptr_atts).bounds);})||
...
return e;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _tmp212=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4EC;_tmp4EC.tag=0,({struct _fat_ptr _tmp5E8=({const char*_tmp213="pointer_elt_type";_tag_fat(_tmp213,sizeof(char),17U);});_tmp4EC.f1=_tmp5E8;});_tmp4EC;});void*_tmp211[1];_tmp211[0]=& _tmp212;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp211,sizeof(void*),1));});};}
# 1533
...
return p->rgn;}}else{
({struct Cyc_Warn_String_Warn_Warg_struct _tmp218=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4ED;_tmp4ED.tag=0,({struct _fat_ptr _tmp5E9=({const char*_tmp219="pointer_elt_type";_tag_fat(_tmp219,sizeof(char),17U);});_tmp4ED.f1=_tmp5E9;});_tmp4ED;});void*_tmp217[1];_tmp217[0]=& _tmp218;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp217,sizeof(void*),1));});};}
# 1540
...
return 0;
({void*_tmp5EA=(Cyc_Absyn_null_exp(0U))->r;e1->r=_tmp5EA;});
e1->topt=t2;
return 1;}}else{
...
struct _tuple1*v=({struct _tuple1*_tmp239=_cycalloc(sizeof(*_tmp239));_tmp239->f1=Cyc_Absyn_Loc_n,({struct _fat_ptr*_tmp5ED=({struct _fat_ptr*_tmp238=_cycalloc(sizeof(*_tmp238));({struct _fat_ptr _tmp5EC=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp237=({struct Cyc_Int_pa_PrintArg_struct _tmp4EF;_tmp4EF.tag=1,_tmp4EF.f1=(unsigned long)counter ++;_tmp4EF;});void*_tmp235[1];_tmp235[0]=& _tmp237;({struct _fat_ptr _tmp5EB=({const char*_tmp236="__aliasvar%d";_tag_fat(_tmp236,sizeof(char),13U);});Cyc_aprintf(_tmp5EB,_tag_fat(_tmp235,sizeof(void*),1));});});*_tmp238=_tmp5EC;});_tmp238;});_tmp239->f2=_tmp5ED;});_tmp239;});
struct Cyc_Absyn_Vardecl*vd=Cyc_Absyn_new_vardecl(0U,v,e_type,e);
struct Cyc_Absyn_Exp*ve=({void*_tmp5EE=(void*)({struct Cyc_Absyn_Local_b_Absyn_Binding_struct*_tmp234=_cycalloc(sizeof(*_tmp234));_tmp234->tag=4,_tmp234->f1=vd;_tmp234;});Cyc_Absyn_varb_exp(_tmp5EE,e->loc);});
# 1621
...
# 1640
return({struct _tuple21 _tmp4EE;_tmp4EE.f1=d,_tmp4EE.f2=ve;_tmp4EE;});}}
# 1645
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp23F=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F4;_tmp4F4.tag=0,({struct _fat_ptr _tmp5EF=({const char*_tmp246="integral size mismatch; ";_tag_fat(_tmp246,sizeof(char),25U);});_tmp4F4.f1=_tmp5EF;});_tmp4F4;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp240=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F3;_tmp4F3.tag=2,_tmp4F3.f1=(void*)t1;_tmp4F3;});struct Cyc_Warn_String_Warn_Warg_struct _tmp241=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F2;_tmp4F2.tag=0,({
struct _fat_ptr _tmp5F0=({const char*_tmp245=" -> ";_tag_fat(_tmp245,sizeof(char),5U);});_tmp4F2.f1=_tmp5F0;});_tmp4F2;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp242=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F1;_tmp4F1.tag=2,_tmp4F1.f1=(void*)t2;_tmp4F1;});struct Cyc_Warn_String_Warn_Warg_struct _tmp243=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F0;_tmp4F0.tag=0,({struct _fat_ptr _tmp5F1=({const char*_tmp244=" conversion supplied";_tag_fat(_tmp244,sizeof(char),21U);});_tmp4F0.f1=_tmp5F1;});_tmp4F0;});void*_tmp23E[5];_tmp23E[0]=& _tmp23F,_tmp23E[1]=& _tmp240,_tmp23E[2]=& _tmp241,_tmp23E[3]=& _tmp242,_tmp23E[4]=& _tmp243;Cyc_Warn_warn2(e->loc,_tag_fat(_tmp23E,sizeof(void*),5));});
Cyc_Tcutil_unchecked_cast(e,t2,1U);
return 1;}
# 1684
if(Cyc_Tcutil_can_insert_alias(e,t1,t2,e->loc)){
if(Cyc_Flags_warn_alias_coerce)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp248=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4FA;_tmp4FA.tag=0,({struct _fat_ptr _tmp5F2=({const char*_tmp250="implicit alias coercion for ";_tag_fat(_tmp250,sizeof(char),29U);});_tmp4FA.f1=_tmp5F2;});_tmp4FA;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp249=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp4F9;_tmp4F9.tag=4,_tmp4F9.f1=e;_tmp4F9;});struct Cyc_Warn_String_Warn_Warg_struct _tmp24A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F8;_tmp4F8.tag=0,({struct _fat_ptr _tmp5F3=({const char*_tmp24F=":";_tag_fat(_tmp24F,sizeof(char),2U);});_tmp4F8.f1=_tmp5F3;});_tmp4F8;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp24B=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F7;_tmp4F7.tag=2,_tmp4F7.f1=(void*)t1;_tmp4F7;});struct Cyc_Warn_String_Warn_Warg_struct _tmp24C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4F6;_tmp4F6.tag=0,({struct _fat_ptr _tmp5F4=({const char*_tmp24E=" to ";_tag_fat(_tmp24E,sizeof(char),5U);});_tmp4F6.f1=_tmp5F4;});_tmp4F6;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp24D=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4F5;_tmp4F5.tag=2,_tmp4F5.f1=(void*)t2;_tmp4F5;});void*_tmp247[6];_tmp247[0]=& _tmp248,_tmp247[1]=& _tmp249,_tmp247[2]=& _tmp24A,_tmp247[3]=& _tmp24B,_tmp247[4]=& _tmp24C,_tmp247[5]=& _tmp24D;Cyc_Warn_warn2(e->loc,_tag_fat(_tmp247,sizeof(void*),6));});
if(alias_coercion != 0)
*alias_coercion=1;}
# 1691
...
if((int)c != 2)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp252=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4FE;_tmp4FE.tag=0,({struct _fat_ptr _tmp5F5=({const char*_tmp257="implicit cast from ";_tag_fat(_tmp257,sizeof(char),20U);});_tmp4FE.f1=_tmp5F5;});_tmp4FE;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp253=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4FD;_tmp4FD.tag=2,_tmp4FD.f1=(void*)t1;_tmp4FD;});struct Cyc_Warn_String_Warn_Warg_struct _tmp254=({struct Cyc_Warn_String_Warn_Warg_struct _tmp4FC;_tmp4FC.tag=0,({struct _fat_ptr _tmp5F6=({const char*_tmp256=" to ";_tag_fat(_tmp256,sizeof(char),5U);});_tmp4FC.f1=_tmp5F6;});_tmp4FC;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp255=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4FB;_tmp4FB.tag=2,_tmp4FB.f1=(void*)t2;_tmp4FB;});void*_tmp251[4];_tmp251[0]=& _tmp252,_tmp251[1]=& _tmp253,_tmp251[2]=& _tmp254,_tmp251[3]=& _tmp255;Cyc_Warn_warn2(e->loc,_tag_fat(_tmp251,sizeof(void*),4));});
return 1;}
# 1705
return 0;}
# 1711
...
return({struct Cyc_List_List*_tmp260=_region_malloc(r,sizeof(*_tmp260));({struct _tuple12*_tmp5F7=({struct _tuple12*_tmp25F=_region_malloc(r,sizeof(*_tmp25F));_tmp25F->f1=x->tq,_tmp25F->f2=t;_tmp25F;});_tmp260->hd=_tmp5F7;}),_tmp260->tl=0;_tmp260;});
...
if(({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(ts)== 1)
return({struct Cyc_List_List*_tmp26B=_region_malloc(r,sizeof(*_tmp26B));({struct _tuple12*_tmp5F8=({struct _tuple12*_tmp26A=_region_malloc(r,sizeof(*_tmp26A));_tmp26A->f1=tq,_tmp26A->f2=t;_tmp26A;});_tmp26B->hd=_tmp5F8;}),_tmp26B->tl=0;_tmp26B;});
return ts;}}}
# 1745
...
return({struct Cyc_List_List*_tmp279=_region_malloc(r,sizeof(*_tmp279));({struct _tuple12*_tmp5FA=({struct _tuple12*_tmp278=_region_malloc(r,sizeof(*_tmp278));({struct Cyc_Absyn_Tqual _tmp5F9=Cyc_Absyn_empty_tqual(0U);_tmp278->f1=_tmp5F9;}),_tmp278->f2=t1;_tmp278;});_tmp279->hd=_tmp5FA;}),_tmp279->tl=0;_tmp279;});{
...
struct _tuple22 env=({struct _tuple22 _tmp4FF;_tmp4FF.f1=inst,_tmp4FF.f2=r,_tmp4FF.f3=flatten;_tmp4FF;});
struct Cyc_List_List*_tmp27B=(_check_null(ad->impl))->fields;struct Cyc_List_List*_stmttmp50=_tmp27B;struct Cyc_List_List*_tmp27C=_stmttmp50;void*_tmp27E;void*_tmp27D;if(_tmp27C == 0)
...
# 1752
struct _tuple23 _tmp26F=({struct _tuple23 _tmp500;_tmp500.f1=r,_tmp500.f2=flatten;_tmp500;});struct _tuple23 env=_tmp26F;
# 1754
...
# 1790
 goto _LL0;}_LL0:;}}
# 1793
return({struct Cyc_List_List*_tmp28B=_region_malloc(r,sizeof(*_tmp28B));({struct _tuple12*_tmp5FE=({struct _tuple12*_tmp28A=_region_malloc(r,sizeof(*_tmp28A));({struct Cyc_Absyn_Tqual _tmp5FD=Cyc_Absyn_empty_tqual(0U);_tmp28A->f1=_tmp5FD;}),_tmp28A->f2=t1;_tmp28A;});_tmp28B->hd=_tmp5FE;}),_tmp28B->tl=0;_tmp28B;});}
# 1796
static int Cyc_Tcutil_isomorphic(void*t1,void*t2){
struct _tuple15 _tmp28C=({struct _tuple15 _tmp502;({void*_tmp600=Cyc_Absyn_compress(t1);_tmp502.f1=_tmp600;}),({void*_tmp5FF=Cyc_Absyn_compress(t2);_tmp502.f2=_tmp5FF;});_tmp502;});struct _tuple15 _stmttmp51=_tmp28C;struct _tuple15 _tmp28D=_stmttmp51;enum Cyc_Absyn_Size_of _tmp28F;enum Cyc_Absyn_Size_of _tmp28E;if(*((int*)_tmp28D.f1)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f1)->f1)== 1){if(*((int*)_tmp28D.f2)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f2)->f1)== 1){_tmp28E=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f1)->f1)->f2;_tmp28F=((struct Cyc_Absyn_IntCon_Absyn_TyCon_struct*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp28D.f2)->f1)->f2;{enum Cyc_Absyn_Size_of b1=_tmp28E;enum Cyc_Absyn_Size_of b2=_tmp28F;
# 1799
...
struct Cyc_Absyn_Exp*_tmp2A2=({void*_tmp601=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp601,b_a);});struct Cyc_Absyn_Exp*e1=_tmp2A2;
struct Cyc_Absyn_Exp*_tmp2A3=({void*_tmp602=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp602,b_b);});struct Cyc_Absyn_Exp*e2=_tmp2A3;
if(e1 != e2){
...
if(({int _tmp609=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(tvs1);_tmp609 != ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(tvs2);}))return 0;{
...
inst=({struct Cyc_List_List*_tmp2AA=_cycalloc(sizeof(*_tmp2AA));({struct _tuple17*_tmp60B=({struct _tuple17*_tmp2A9=_cycalloc(sizeof(*_tmp2A9));_tmp2A9->f1=(struct Cyc_Absyn_Tvar*)tvs2->hd,({void*_tmp60A=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)tvs1->hd);_tmp2A9->f2=_tmp60A;});_tmp2A9;});_tmp2AA->hd=_tmp60B;}),_tmp2AA->tl=inst;_tmp2AA;});
tvs1=tvs1->tl;
tvs2=tvs2->tl;}
# 1883
if(inst != 0){
f1.tvars=0;
f2.tvars=0;
return({struct Cyc_RgnOrder_RgnPO*_tmp60E=po;struct Cyc_List_List*_tmp60D=assume;void*_tmp60C=(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp2AB=_cycalloc(sizeof(*_tmp2AB));_tmp2AB->tag=5,_tmp2AB->f1=f1;_tmp2AB;});Cyc_Tcutil_subtype(_tmp60E,_tmp60D,_tmp60C,(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp2AC=_cycalloc(sizeof(*_tmp2AC));_tmp2AC->tag=5,_tmp2AC->f1=f2;_tmp2AC;}));});}}}
# 1890
...
# 1895
if(({int _tmp60F=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(args1);_tmp60F != ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(args2);}))return 0;
# 1897
...
struct _tuple9 _tmp2B3=*((struct _tuple9*)(_check_null(args2))->hd);struct _tuple9 _stmttmp54=_tmp2B3;struct _tuple9 _tmp2B4=_stmttmp54;void*_tmp2B6;struct Cyc_Absyn_Tqual _tmp2B5;_tmp2B5=_tmp2B4.f2;_tmp2B6=_tmp2B4.f3;{struct Cyc_Absyn_Tqual tq2=_tmp2B5;void*t2=_tmp2B6;
# 1901
...
# 1915
if(!({void*_tmp610=_check_null(f1.effect);Cyc_Tcutil_subset_effect(1,_tmp610,_check_null(f2.effect));}))return 0;
# 1917
...
struct Cyc_Absyn_Exp*_tmp2D7=({void*_tmp613=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp613,b_a);});struct Cyc_Absyn_Exp*e_a=_tmp2D7;
struct Cyc_Absyn_Exp*_tmp2D8=({void*_tmp614=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp614,b_b);});struct Cyc_Absyn_Exp*e_b=_tmp2D8;
...
int _tmp615=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})((struct Cyc_List_List*)(_check_null(ed1->fields))->v);_tmp615 >= ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})((struct Cyc_List_List*)(_check_null(ed2->fields))->v);}))
return 3U;
...
({void*_tmp616=(void*)({struct Cyc_Absyn_Cast_e_Absyn_Raw_exp_struct*_tmp2E5=_cycalloc(sizeof(*_tmp2E5));_tmp2E5->tag=14,_tmp2E5->f1=t,_tmp2E5->f2=inner,_tmp2E5->f3=0,_tmp2E5->f4=c;_tmp2E5;});e->r=_tmp616;});
e->topt=t;}}
# 2084
...
return({struct Cyc_Absyn_Tvar*_tmp2EA=_cycalloc(sizeof(*_tmp2EA));({struct _fat_ptr*_tmp619=({struct _fat_ptr*_tmp2E9=_cycalloc(sizeof(*_tmp2E9));({struct _fat_ptr _tmp618=(struct _fat_ptr)({struct Cyc_Int_pa_PrintArg_struct _tmp2E8=({struct Cyc_Int_pa_PrintArg_struct _tmp504;_tmp504.tag=1,_tmp504.f1=(unsigned long)Cyc_Tcutil_tvar_counter ++;_tmp504;});void*_tmp2E6[1];_tmp2E6[0]=& _tmp2E8;({struct _fat_ptr _tmp617=({const char*_tmp2E7="#%d";_tag_fat(_tmp2E7,sizeof(char),4U);});Cyc_aprintf(_tmp617,_tag_fat(_tmp2E6,sizeof(void*),1));});});*_tmp2E9=_tmp618;});_tmp2E9;});_tmp2EA->name=_tmp619;}),_tmp2EA->identity=-1,_tmp2EA->kind=k;_tmp2EA;});}
# 2093
...
if(({struct _fat_ptr _tmp61A=(struct _fat_ptr)*var;Cyc_strcmp(_tmp61A,({const char*_tmp2F6="return_value";_tag_fat(_tmp2F6,sizeof(char),13U);}));})== 0){
({union Cyc_Relations_RelnOp _tmp61B=Cyc_Relations_RReturn();*rop=_tmp61B;});
goto _LL0;}{
# 2129
unsigned c=0U;
...
({union Cyc_Relations_RelnOp _tmp61C=Cyc_Relations_RParam(c);*rop=_tmp61C;});
break;}}}}
# 2137
...
if(vopt != 0 && Cyc_strcmp((struct _fat_ptr)*var,(struct _fat_ptr)*vopt)== 0){
({union Cyc_Relations_RelnOp _tmp61D=Cyc_Relations_RParamNumelts(c);*rop=_tmp61D;});
break;}}}}
# 2149
goto _LL0;}}}default:
 goto _LL0;}_LL0:;}
...
# 2175
return({struct _tuple25*_tmp309=_region_malloc(rgn,sizeof(*_tmp309));({struct _tuple24*_tmp61E=({struct _tuple24*_tmp308=_region_malloc(rgn,sizeof(*_tmp308));_tmp308->f1=(*y).f1,_tmp308->f2=(*y).f2;_tmp308;});_tmp309->f1=_tmp61E;}),_tmp309->f2=(*y).f3;_tmp309;});}
# 2177
...
struct Cyc_Absyn_Exp*_tmp319=(struct Cyc_Absyn_Exp*)(_check_null(es))->hd;struct Cyc_Absyn_Exp*e1=_tmp319;
struct Cyc_Absyn_Exp*_tmp31A=Cyc_Tcutil_rsubsexp(r,inst,e1);struct Cyc_Absyn_Exp*new_e1=_tmp31A;
return new_e1 == e1?e:({struct Cyc_Absyn_Exp*_tmp620=e;Cyc_Tcutil_copye(_tmp620,(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp31C=_cycalloc(sizeof(*_tmp31C));_tmp31C->tag=3,_tmp31C->f1=p,({struct Cyc_List_List*_tmp61F=({struct Cyc_Absyn_Exp*_tmp31B[1];_tmp31B[0]=new_e1;({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp31B,sizeof(struct Cyc_Absyn_Exp*),1));});_tmp31C->f2=_tmp61F;});_tmp31C;}));});}else{
if(({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(es)== 2){
struct Cyc_Absyn_Exp*_tmp31D=(struct Cyc_Absyn_Exp*)(_check_null(es))->hd;struct Cyc_Absyn_Exp*e1=_tmp31D;
struct Cyc_Absyn_Exp*_tmp31E=(struct Cyc_Absyn_Exp*)(_check_null(es->tl))->hd;struct Cyc_Absyn_Exp*e2=_tmp31E;
...
return({struct Cyc_Absyn_Exp*_tmp622=e;Cyc_Tcutil_copye(_tmp622,(void*)({struct Cyc_Absyn_Primop_e_Absyn_Raw_exp_struct*_tmp322=_cycalloc(sizeof(*_tmp322));_tmp322->tag=3,_tmp322->f1=p,({struct Cyc_List_List*_tmp621=({struct Cyc_Absyn_Exp*_tmp321[2];_tmp321[0]=new_e1,_tmp321[1]=new_e2;({(struct Cyc_List_List*(*)(struct _fat_ptr))Cyc_List_list;})(_tag_fat(_tmp321,sizeof(struct Cyc_Absyn_Exp*),2));});_tmp322->f2=_tmp621;});_tmp322;}));});}}
# 2215
return({struct Cyc_Warn_String_Warn_Warg_struct _tmp324=({struct Cyc_Warn_String_Warn_Warg_struct _tmp505;_tmp505.tag=0,({struct _fat_ptr _tmp623=({const char*_tmp325="primop does not have 1 or 2 args!";_tag_fat(_tmp325,sizeof(char),34U);});_tmp505.f1=_tmp623;});_tmp505;});void*_tmp323[1];_tmp323[0]=& _tmp324;({(struct Cyc_Absyn_Exp*(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp323,sizeof(void*),1));});}case 6: _tmp313=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp312)->f1;_tmp314=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp312)->f2;_tmp317=((struct Cyc_Absyn_Conditional_e_Absyn_Raw_exp_struct*)_tmp312)->f3;{struct Cyc_Absyn_Exp*e1=_tmp313;struct Cyc_Absyn_Exp*e2=_tmp314;struct Cyc_Absyn_Exp*e3=_tmp317;
# 2217
...
if(new_e1 == e1 && new_e2 == e2)return e;
return({struct Cyc_Absyn_Exp*_tmp625=e;Cyc_Tcutil_copye(_tmp625,(void*)({struct Cyc_Absyn_And_e_Absyn_Raw_exp_struct*_tmp32C=_cycalloc(sizeof(*_tmp32C));_tmp32C->tag=7,_tmp32C->f1=new_e1,_tmp32C->f2=new_e2;_tmp32C;}));});}case 8: _tmp313=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp312)->f1;_tmp314=((struct Cyc_Absyn_Or_e_Absyn_Raw_exp_struct*)_tmp312)->f2;{struct Cyc_Absyn_Exp*e1=_tmp313;struct Cyc_Absyn_Exp*e2=_tmp314;
# 2228
...
return e;}}else{
return({struct Cyc_Absyn_Exp*_tmp62D=e;Cyc_Tcutil_copye(_tmp62D,(void*)({struct Cyc_Absyn_Valueof_e_Absyn_Raw_exp_struct*_tmp342=_cycalloc(sizeof(*_tmp342));_tmp342->tag=39,_tmp342->f1=new_typ;_tmp342;}));});};}}default:
# 2262
 return({struct Cyc_Warn_String_Warn_Warg_struct _tmp344=({struct Cyc_Warn_String_Warn_Warg_struct _tmp506;_tmp506.tag=0,({struct _fat_ptr _tmp62E=({const char*_tmp345="non-type-level-expression in Tcutil::rsubsexp";_tag_fat(_tmp345,sizeof(char),46U);});_tmp506.f1=_tmp62E;});_tmp506;});void*_tmp343[1];_tmp343[0]=& _tmp344;({(struct Cyc_Absyn_Exp*(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp343,sizeof(void*),1));});};}
# 2266
...
return t;
return Cyc_Absyn_pointer_type(({struct Cyc_Absyn_PtrInfo _tmp507;_tmp507.elt_type=new_t1,_tmp507.elt_tq=tq,(_tmp507.ptr_atts).rgn=new_r,(_tmp507.ptr_atts).nullable=n,(_tmp507.ptr_atts).bounds=new_b,(_tmp507.ptr_atts).zero_term=new_zt,(_tmp507.ptr_atts).ptrloc=0,(_tmp507.ptr_atts).autoreleased=new_rel;_tmp507;}));}case 5: _tmp359=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).tvars;_tmp35A=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).effect;_tmp35C=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).ret_tqual;_tmp35D=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).ret_type;_tmp35E=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).args;_tmp35F=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).c_varargs;_tmp360=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).cyc_varargs;_tmp361=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).rgn_po;_tmp362=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).attributes;_tmp363=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).requires_clause;_tmp364=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).ensures_clause;_tmp365=(((struct Cyc_Absyn_FnType_Absyn_Type_struct*)_tmp358)->f1).return_value;{struct Cyc_List_List*vs=_tmp359;void*eff=_tmp35A;struct Cyc_Absyn_Tqual rtq=_tmp35C;void*rtyp=_tmp35D;struct Cyc_List_List*args=_tmp35E;int c_varargs=_tmp35F;struct Cyc_Absyn_VarargInfo*cyc_varargs=_tmp360;struct Cyc_List_List*rgn_po=_tmp361;struct Cyc_List_List*atts=_tmp362;struct Cyc_Absyn_Exp*req=_tmp363;struct Cyc_Absyn_Exp*ens=_tmp364;struct Cyc_Absyn_Vardecl*ret_value=_tmp365;
# 2339
if(Cyc_Tcutil_skip_fntypes)return t;
# 2341
{struct Cyc_List_List*_tmp378=vs;struct Cyc_List_List*p=_tmp378;for(0;p != 0;p=p->tl){
inst=({struct Cyc_List_List*_tmp37A=_region_malloc(rgn,sizeof(*_tmp37A));({struct _tuple17*_tmp630=({struct _tuple17*_tmp379=_region_malloc(rgn,sizeof(*_tmp379));_tmp379->f1=(struct Cyc_Absyn_Tvar*)p->hd,({void*_tmp62F=Cyc_Absyn_var_type((struct Cyc_Absyn_Tvar*)p->hd);_tmp379->f2=_tmp62F;});_tmp379;});_tmp37A->hd=_tmp630;}),_tmp37A->tl=inst;_tmp37A;});}}{
struct _tuple0 _tmp37B=({struct _tuple0(*_tmp633)(struct _RegionHandle*,struct _RegionHandle*,struct Cyc_List_List*)=({(struct _tuple0(*)(struct _RegionHandle*,struct _RegionHandle*,struct Cyc_List_List*))Cyc_List_rsplit;});struct _RegionHandle*_tmp632=rgn;struct _RegionHandle*_tmp631=rgn;_tmp633(_tmp632,_tmp631,
...
return(void*)({struct Cyc_Absyn_FnType_Absyn_Type_struct*_tmp38B=_cycalloc(sizeof(*_tmp38B));_tmp38B->tag=5,(_tmp38B->f1).tvars=vs,(_tmp38B->f1).effect=eff2,(_tmp38B->f1).ret_tqual=rtq,({void*_tmp634=Cyc_Tcutil_rsubstitute(rgn,inst,rtyp);(_tmp38B->f1).ret_type=_tmp634;}),(_tmp38B->f1).args=args2,(_tmp38B->f1).c_varargs=c_varargs,(_tmp38B->f1).cyc_varargs=cyc_varargs2,(_tmp38B->f1).rgn_po=rgn_po2,(_tmp38B->f1).attributes=atts,(_tmp38B->f1).requires_clause=req2,(_tmp38B->f1).requires_relns=req_relns2,(_tmp38B->f1).ensures_clause=ens2,(_tmp38B->f1).ensures_relns=ens_relns2,(_tmp38B->f1).return_value=ret_value;_tmp38B;});}}}}}case 6: _tmp359=((struct Cyc_Absyn_TupleType_Absyn_Type_struct*)_tmp358)->f1;{struct Cyc_List_List*tqts=_tmp359;
# 2368
...
# 2377
return !change?t:(void*)({struct Cyc_Absyn_TupleType_Absyn_Type_struct*_tmp390=_cycalloc(sizeof(*_tmp390));_tmp390->tag=6,({struct Cyc_List_List*_tmp637=({struct Cyc_List_List*(*_tmp636)(struct _tuple12*(*)(struct _tuple12*,void*),struct Cyc_List_List*,struct Cyc_List_List*)=({(struct Cyc_List_List*(*)(struct _tuple12*(*)(struct _tuple12*,void*),struct Cyc_List_List*,struct Cyc_List_List*))Cyc_List_map2;});struct Cyc_List_List*_tmp635=tqts;_tmp636(Cyc_Tcutil_map2_tq,_tmp635,({(struct Cyc_List_List*(*)(struct Cyc_List_List*))Cyc_List_imp_rev;})(ts2));});_tmp390->f1=_tmp637;});_tmp390;});}case 7: _tmp35B=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp358)->f1;_tmp359=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp358)->f2;{enum Cyc_Absyn_AggrKind k=_tmp35B;struct Cyc_List_List*fs=_tmp359;
# 2379
...
# 2393
 if(Cyc_Tcutil_skip_fntypes)return t;
({struct Cyc_Warn_String_Warn_Warg_struct _tmp39A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp508;_tmp508.tag=0,({struct _fat_ptr _tmp638=({const char*_tmp39B="found typedecltype in rsubs";_tag_fat(_tmp39B,sizeof(char),28U);});_tmp508.f1=_tmp638;});_tmp508;});void*_tmp399[1];_tmp399[0]=& _tmp39A;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp399,sizeof(void*),1));});};}
# 2398
...
return({struct _tuple17*_tmp3A4=_cycalloc(sizeof(*_tmp3A4));_tmp3A4->f1=tv,({void*_tmp63A=({struct Cyc_Core_Opt*_tmp639=k;Cyc_Absyn_new_evar(_tmp639,({struct Cyc_Core_Opt*_tmp3A3=_cycalloc(sizeof(*_tmp3A3));_tmp3A3->v=s;_tmp3A3;}));});_tmp3A4->f2=_tmp63A;});_tmp3A4;});}struct _tuple26{struct Cyc_List_List*f1;struct _RegionHandle*f2;};
# 2429
...
return({struct _tuple17*_tmp3AA=_region_malloc(rgn,sizeof(*_tmp3AA));_tmp3AA->f1=tv,({void*_tmp63C=({struct Cyc_Core_Opt*_tmp63B=k;Cyc_Absyn_new_evar(_tmp63B,({struct Cyc_Core_Opt*_tmp3A9=_cycalloc(sizeof(*_tmp3A9));_tmp3A9->v=s;_tmp3A9;}));});_tmp3AA->f2=_tmp63C;});_tmp3AA;});}}
# 2436
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3AC=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50B;_tmp50B.tag=0,({struct _fat_ptr _tmp63D=({const char*_tmp3B0="bitfield ";_tag_fat(_tmp3B0,sizeof(char),10U);});_tmp50B.f1=_tmp63D;});_tmp50B;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3AD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50A;_tmp50A.tag=0,_tmp50A.f1=*fn;_tmp50A;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3AE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp509;_tmp509.tag=0,({struct _fat_ptr _tmp63E=({const char*_tmp3AF=" does not have constant width";_tag_fat(_tmp3AF,sizeof(char),30U);});_tmp509.f1=_tmp63E;});_tmp509;});void*_tmp3AB[3];_tmp3AB[0]=& _tmp3AC,_tmp3AB[1]=& _tmp3AD,_tmp3AB[2]=& _tmp3AE;Cyc_Warn_err2(loc,_tag_fat(_tmp3AB,sizeof(void*),3));});else{
# 2443
...
if(!known)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B6=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50C;_tmp50C.tag=0,({struct _fat_ptr _tmp63F=({const char*_tmp3B7="cannot evaluate bitfield width at compile time";_tag_fat(_tmp3B7,sizeof(char),47U);});_tmp50C.f1=_tmp63F;});_tmp50C;});void*_tmp3B5[1];_tmp3B5[0]=& _tmp3B6;Cyc_Warn_warn2(loc,_tag_fat(_tmp3B5,sizeof(void*),1));});
if((int)i < 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3B9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50D;_tmp50D.tag=0,({struct _fat_ptr _tmp640=({const char*_tmp3BA="bitfield has negative width";_tag_fat(_tmp3BA,sizeof(char),28U);});_tmp50D.f1=_tmp640;});_tmp50D;});void*_tmp3B8[1];_tmp3B8[0]=& _tmp3B9;Cyc_Warn_err2(loc,_tag_fat(_tmp3B8,sizeof(void*),1));});
w=i;}}{
# 2450
...
# 2462
if(bad)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp50E;_tmp50E.tag=0,({struct _fat_ptr _tmp641=({const char*_tmp3C1="bitfield larger than type";_tag_fat(_tmp3C1,sizeof(char),26U);});_tmp50E.f1=_tmp641;});_tmp50E;});void*_tmp3BF[1];_tmp3BF[0]=& _tmp3C0;Cyc_Warn_warn2(loc,_tag_fat(_tmp3BF,sizeof(void*),1));});
goto _LL3;}}else{goto _LL6;}}else{_LL6:
# 2466
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3C3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp512;_tmp512.tag=0,({struct _fat_ptr _tmp642=({const char*_tmp3C8="bitfield ";_tag_fat(_tmp3C8,sizeof(char),10U);});_tmp512.f1=_tmp642;});_tmp512;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3C4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp511;_tmp511.tag=0,_tmp511.f1=*fn;_tmp511;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3C5=({struct Cyc_Warn_String_Warn_Warg_struct _tmp510;_tmp510.tag=0,({struct _fat_ptr _tmp643=({const char*_tmp3C7=" must have integral type but has type ";_tag_fat(_tmp3C7,sizeof(char),39U);});_tmp510.f1=_tmp643;});_tmp510;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp3C6=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp50F;_tmp50F.tag=2,_tmp50F.f1=(void*)field_type;_tmp50F;});void*_tmp3C2[4];_tmp3C2[0]=& _tmp3C3,_tmp3C2[1]=& _tmp3C4,_tmp3C2[2]=& _tmp3C5,_tmp3C2[3]=& _tmp3C6;Cyc_Warn_err2(loc,_tag_fat(_tmp3C2,sizeof(void*),4));});
# 2468
goto _LL3;}_LL3:;}}}
# 2475
...
if(declared_const)({struct Cyc_Warn_String_Warn_Warg_struct _tmp3CD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp513;_tmp513.tag=0,({struct _fat_ptr _tmp644=({const char*_tmp3CE="extra const";_tag_fat(_tmp3CE,sizeof(char),12U);});_tmp513.f1=_tmp644;});_tmp513;});void*_tmp3CC[1];_tmp3CC[0]=& _tmp3CD;Cyc_Warn_warn2(loc,_tag_fat(_tmp3CC,sizeof(void*),1));});
return 1;}
# 2483
if((unsigned)tdopt)
...
if(tv->identity == -1)
({int _tmp645=Cyc_Tcutil_new_tvar_id();tv->identity=_tmp645;});}
# 2494
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3D0=({struct Cyc_Warn_String_Warn_Warg_struct _tmp516;_tmp516.tag=0,_tmp516.f1=msg;_tmp516;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3D1=({struct Cyc_Warn_String_Warn_Warg_struct _tmp515;_tmp515.tag=0,({struct _fat_ptr _tmp646=({const char*_tmp3D3=": ";_tag_fat(_tmp3D3,sizeof(char),3U);});_tmp515.f1=_tmp646;});_tmp515;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3D2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp514;_tmp514.tag=0,({struct _fat_ptr _tmp647=a2string(vs->hd);_tmp514.f1=_tmp647;});_tmp514;});void*_tmp3CF[3];_tmp3CF[0]=& _tmp3D0,_tmp3CF[1]=& _tmp3D1,_tmp3CF[2]=& _tmp3D2;Cyc_Warn_err2(loc,_tag_fat(_tmp3CF,sizeof(void*),3));});}}}
# 2508
...
({void(*_tmp64A)(int(*)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*,unsigned,struct _fat_ptr(*)(struct Cyc_Absyn_Tvar*),struct _fat_ptr)=({(void(*)(int(*)(struct Cyc_Absyn_Tvar*,struct Cyc_Absyn_Tvar*),struct Cyc_List_List*,unsigned,struct _fat_ptr(*)(struct Cyc_Absyn_Tvar*),struct _fat_ptr))Cyc_Tcutil_check_unique_unsorted;});struct Cyc_List_List*_tmp649=tvs;unsigned _tmp648=loc;_tmp64A(Cyc_Absyn_tvar_cmp,_tmp649,_tmp648,Cyc_Absynpp_tvar2string,({const char*_tmp3D4="duplicate type variable";_tag_fat(_tmp3D4,sizeof(char),24U);}));});}struct _tuple27{struct Cyc_Absyn_Aggrfield*f1;int f2;};struct _tuple28{struct Cyc_List_List*f1;void*f2;};struct _tuple29{struct Cyc_Absyn_Aggrfield*f1;void*f2;};
# 2529 "tcutil.cyc"
...
if(({struct _fat_ptr _tmp64B=(struct _fat_ptr)*((struct Cyc_Absyn_Aggrfield*)sd_fields->hd)->name;Cyc_strcmp(_tmp64B,({const char*_tmp3D6="";_tag_fat(_tmp3D6,sizeof(char),1U);}));})!= 0)
fields=({struct Cyc_List_List*_tmp3D8=_region_malloc(temp,sizeof(*_tmp3D8));({struct _tuple27*_tmp64C=({struct _tuple27*_tmp3D7=_region_malloc(temp,sizeof(*_tmp3D7));_tmp3D7->f1=(struct Cyc_Absyn_Aggrfield*)sd_fields->hd,_tmp3D7->f2=0;_tmp3D7;});_tmp3D8->hd=_tmp64C;}),_tmp3D8->tl=fields;_tmp3D8;});}}
...
({struct Cyc_List_List*_tmp64E=({struct Cyc_List_List*_tmp3DF=_cycalloc(sizeof(*_tmp3DF));({void*_tmp64D=(void*)({struct Cyc_Absyn_FieldName_Absyn_Designator_struct*_tmp3DE=_cycalloc(sizeof(*_tmp3DE));_tmp3DE->tag=1,_tmp3DE->f1=((*((struct _tuple27*)fields2->hd)).f1)->name;_tmp3DE;});_tmp3DF->hd=_tmp64D;}),_tmp3DF->tl=0;_tmp3DF;});(*((struct _tuple28*)des->hd)).f1=_tmp64E;});
ans=({struct Cyc_List_List*_tmp3E1=_region_malloc(rgn,sizeof(*_tmp3E1));({struct _tuple29*_tmp64F=({struct _tuple29*_tmp3E0=_region_malloc(rgn,sizeof(*_tmp3E0));_tmp3E0->f1=(*((struct _tuple27*)fields2->hd)).f1,_tmp3E0->f2=a;_tmp3E0;});_tmp3E1->hd=_tmp64F;}),_tmp3E1->tl=ans;_tmp3E1;});
break;}}
# 2560
if(fields2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3E3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp518;_tmp518.tag=0,({struct _fat_ptr _tmp650=({const char*_tmp3E5="too many arguments to ";_tag_fat(_tmp3E5,sizeof(char),23U);});_tmp518.f1=_tmp650;});_tmp518;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3E4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp517;_tmp517.tag=0,_tmp517.f1=aggr_str;_tmp517;});void*_tmp3E2[2];_tmp3E2[0]=& _tmp3E3,_tmp3E2[1]=& _tmp3E4;Cyc_Warn_err2(loc,_tag_fat(_tmp3E2,sizeof(void*),2));});}else{
if(dl->tl != 0)
# 2564
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3E7=({struct Cyc_Warn_String_Warn_Warg_struct _tmp519;_tmp519.tag=0,({struct _fat_ptr _tmp651=({const char*_tmp3E8="multiple designators are not yet supported";_tag_fat(_tmp3E8,sizeof(char),43U);});_tmp519.f1=_tmp651;});_tmp519;});void*_tmp3E6[1];_tmp3E6[0]=& _tmp3E7;Cyc_Warn_err2(loc,_tag_fat(_tmp3E6,sizeof(void*),1));});else{
# 2567
void*_tmp3E9=(void*)dl->hd;void*_stmttmp66=_tmp3E9;void*_tmp3EA=_stmttmp66;void*_tmp3EB;if(*((int*)_tmp3EA)== 0){
# 2569
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3ED=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51B;_tmp51B.tag=0,({struct _fat_ptr _tmp652=({const char*_tmp3EF="array designator used in argument to ";_tag_fat(_tmp3EF,sizeof(char),38U);});_tmp51B.f1=_tmp652;});_tmp51B;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3EE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51A;_tmp51A.tag=0,_tmp51A.f1=aggr_str;_tmp51A;});void*_tmp3EC[2];_tmp3EC[0]=& _tmp3ED,_tmp3EC[1]=& _tmp3EE;Cyc_Warn_err2(loc,_tag_fat(_tmp3EC,sizeof(void*),2));});
...
if((*((struct _tuple27*)fields2->hd)).f2)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3F2=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51E;_tmp51E.tag=0,({struct _fat_ptr _tmp653=({const char*_tmp3F6="member ";_tag_fat(_tmp3F6,sizeof(char),8U);});_tmp51E.f1=_tmp653;});_tmp51E;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3F3=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51D;_tmp51D.tag=0,_tmp51D.f1=*v;_tmp51D;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3F4=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51C;_tmp51C.tag=0,({struct _fat_ptr _tmp654=({const char*_tmp3F5=" has already been used as an argument";_tag_fat(_tmp3F5,sizeof(char),38U);});_tmp51C.f1=_tmp654;});_tmp51C;});void*_tmp3F1[3];_tmp3F1[0]=& _tmp3F2,_tmp3F1[1]=& _tmp3F3,_tmp3F1[2]=& _tmp3F4;Cyc_Warn_err2(loc,_tag_fat(_tmp3F1,sizeof(void*),3));});
(*((struct _tuple27*)fields2->hd)).f2=1;
ans=({struct Cyc_List_List*_tmp3F8=_region_malloc(rgn,sizeof(*_tmp3F8));({struct _tuple29*_tmp655=({struct _tuple29*_tmp3F7=_region_malloc(rgn,sizeof(*_tmp3F7));_tmp3F7->f1=(*((struct _tuple27*)fields2->hd)).f1,_tmp3F7->f2=a;_tmp3F7;});_tmp3F8->hd=_tmp655;}),_tmp3F8->tl=ans;_tmp3F8;});
break;}}
# 2581
if(fields2 == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FA=({struct Cyc_Warn_String_Warn_Warg_struct _tmp520;_tmp520.tag=0,({struct _fat_ptr _tmp656=({const char*_tmp3FC="bad field designator ";_tag_fat(_tmp3FC,sizeof(char),22U);});_tmp520.f1=_tmp656;});_tmp520;});struct Cyc_Warn_String_Warn_Warg_struct _tmp3FB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp51F;_tmp51F.tag=0,_tmp51F.f1=*v;_tmp51F;});void*_tmp3F9[2];_tmp3F9[0]=& _tmp3FA,_tmp3F9[1]=& _tmp3FB;Cyc_Warn_err2(loc,_tag_fat(_tmp3F9,sizeof(void*),2));});
goto _LL3;}}_LL3:;}}}}
# 2588
if((int)aggr_kind == 0){
if(({int _tmp657=({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(ans);_tmp657 < ({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(fields);}))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp3FE=({struct Cyc_Warn_String_Warn_Warg_struct _tmp521;_tmp521.tag=0,({struct _fat_ptr _tmp658=({const char*_tmp3FF="too few arguments to struct";_tag_fat(_tmp3FF,sizeof(char),28U);});_tmp521.f1=_tmp658;});_tmp521;});void*_tmp3FD[1];_tmp3FD[0]=& _tmp3FE;Cyc_Warn_err2(loc,_tag_fat(_tmp3FD,sizeof(void*),1));});}else{
if(({(int(*)(struct Cyc_List_List*))Cyc_List_length;})(ans)!= 1)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp401=({struct Cyc_Warn_String_Warn_Warg_struct _tmp522;_tmp522.tag=0,({struct _fat_ptr _tmp659=({const char*_tmp402="union expression should have one member";_tag_fat(_tmp402,sizeof(char),40U);});_tmp522.f1=_tmp659;});_tmp522;});void*_tmp400[1];_tmp400[0]=& _tmp401;Cyc_Warn_err2(loc,_tag_fat(_tmp400,sizeof(void*),1));});}{
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp40A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp524;_tmp524.tag=0,({struct _fat_ptr _tmp65A=({const char*_tmp40C="we have a cast in a lhs: ";_tag_fat(_tmp40C,sizeof(char),26U);});_tmp524.f1=_tmp65A;});_tmp524;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp40B=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp523;_tmp523.tag=4,_tmp523.f1=e1;_tmp523;});void*_tmp409[2];_tmp409[0]=& _tmp40A,_tmp409[1]=& _tmp40B;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp409,sizeof(void*),2));});case 20: _tmp408=((struct Cyc_Absyn_Deref_e_Absyn_Raw_exp_struct*)_tmp407)->f1;{struct Cyc_Absyn_Exp*e1a=_tmp408;
...
# 2605
return Cyc_Tcutil_is_zero_ptr_type(_check_null(e1a->topt),ptr_type,is_fat,elt_type);}case 22: _tmp408=((struct Cyc_Absyn_AggrArrow_e_Absyn_Raw_exp_struct*)_tmp407)->f1;{struct Cyc_Absyn_Exp*e1a=_tmp408;
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp40E=({struct Cyc_Warn_String_Warn_Warg_struct _tmp526;_tmp526.tag=0,({struct _fat_ptr _tmp65B=({const char*_tmp410="found zero pointer aggregate member assignment: ";_tag_fat(_tmp410,sizeof(char),49U);});_tmp526.f1=_tmp65B;});_tmp526;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp40F=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp525;_tmp525.tag=4,_tmp525.f1=e1;_tmp525;});void*_tmp40D[2];_tmp40D[0]=& _tmp40E,_tmp40D[1]=& _tmp40F;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp40D,sizeof(void*),2));});
...
# 2614
if(Cyc_Tcutil_is_zero_ptr_type(_check_null(e1a->topt),ptr_type,is_fat,elt_type))
({struct Cyc_Warn_String_Warn_Warg_struct _tmp412=({struct Cyc_Warn_String_Warn_Warg_struct _tmp528;_tmp528.tag=0,({struct _fat_ptr _tmp65C=({const char*_tmp414="found zero pointer instantiate/noinstantiate: ";_tag_fat(_tmp414,sizeof(char),47U);});_tmp528.f1=_tmp65C;});_tmp528;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp413=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp527;_tmp527.tag=4,_tmp527.f1=e1;_tmp527;});void*_tmp411[2];_tmp411[0]=& _tmp412,_tmp411[1]=& _tmp413;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp411,sizeof(void*),2));});
return 0;}case 1:
 return 0;default:
({struct Cyc_Warn_String_Warn_Warg_struct _tmp416=({struct Cyc_Warn_String_Warn_Warg_struct _tmp52A;_tmp52A.tag=0,({struct _fat_ptr _tmp65D=({const char*_tmp418="found bad lhs in is_zero_ptr_deref: ";_tag_fat(_tmp418,sizeof(char),37U);});_tmp52A.f1=_tmp65D;});_tmp52A;});struct Cyc_Warn_Exp_Warn_Warg_struct _tmp417=({struct Cyc_Warn_Exp_Warn_Warg_struct _tmp529;_tmp529.tag=4,_tmp529.f1=e1;_tmp529;});void*_tmp415[2];_tmp415[0]=& _tmp416,_tmp415[1]=& _tmp417;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp415,sizeof(void*),2));});};}
# 2628
...
# 2641
({struct Cyc_Core_Opt*_tmp65F=({struct Cyc_Core_Opt*_tmp426=_cycalloc(sizeof(*_tmp426));({void*_tmp65E=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp425=_cycalloc(sizeof(*_tmp425));_tmp425->tag=2,_tmp425->f1=0,_tmp425->f2=& Cyc_Kinds_rk;_tmp425;});_tmp426->v=_tmp65E;});_tmp426;});*x=_tmp65F;});
...
# 2663
({struct Cyc_Core_Opt*_tmp662=({struct Cyc_Core_Opt*_tmp435=_cycalloc(sizeof(*_tmp435));({void*_tmp661=(void*)({struct Cyc_Absyn_Less_kb_Absyn_KindBound_struct*_tmp434=_cycalloc(sizeof(*_tmp434));_tmp434->tag=2,_tmp434->f1=0,({struct Cyc_Absyn_Kind*_tmp660=({struct Cyc_Absyn_Kind*_tmp433=_cycalloc(sizeof(*_tmp433));_tmp433->kind=k,_tmp433->aliasqual=0U;_tmp433;});_tmp434->f2=_tmp660;});_tmp434;});_tmp435->v=_tmp661;});_tmp435;});*x=_tmp662;});
...
{struct Cyc_List_List*_tmp43B=(_check_null((*adp)->impl))->fields;struct Cyc_List_List*x=_tmp43B;for(0;x != 0;x=x->tl){
...
# 2723
return Cyc_Tcutil_is_noalias_pointer(_check_null(e1->topt),1)&& Cyc_Tcutil_is_noalias_path(e1);}case 21: _tmp443=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp442)->f1;_tmp444=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp442)->f2;{struct Cyc_Absyn_Exp*e1=_tmp443;struct _fat_ptr*f=_tmp444;
...
# 2726
void*_tmp445=Cyc_Absyn_compress(_check_null(e1->topt));void*_stmttmp6F=_tmp445;void*_tmp446=_stmttmp6F;if(*((int*)_tmp446)== 6)
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp44C=({struct Cyc_Warn_String_Warn_Warg_struct _tmp52B;_tmp52B.tag=0,({struct _fat_ptr _tmp663=({const char*_tmp44D="is_noalias_stmt_exp: ill-formed StmtExp";_tag_fat(_tmp44D,sizeof(char),40U);});_tmp52B.f1=_tmp663;});_tmp52B;});void*_tmp44B[1];_tmp44B[0]=& _tmp44C;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp44B,sizeof(void*),1));});}_LL1A:;}}default: _LL13:
# 2743
 return 1;};}
# 2760 "tcutil.cyc"
struct _tuple14 Cyc_Tcutil_addressof_props(struct Cyc_Absyn_Exp*e){
# 2762
struct _tuple14 bogus_ans=({struct _tuple14 _tmp539;_tmp539.f1=0,_tmp539.f2=Cyc_Absyn_heap_rgn_type;_tmp539;});
...
# 2770
void*_tmp455=Cyc_Absyn_compress(_check_null(e->topt));void*_stmttmp72=_tmp455;void*_tmp456=_stmttmp72;if(*((int*)_tmp456)== 4)
# 2772
return({struct _tuple14 _tmp52C;_tmp52C.f1=1,_tmp52C.f2=Cyc_Absyn_heap_rgn_type;_tmp52C;});else{
return({struct _tuple14 _tmp52D;_tmp52D.f1=(vd->tq).real_const,_tmp52D.f2=Cyc_Absyn_heap_rgn_type;_tmp52D;});};}case 4: _tmp454=((struct Cyc_Absyn_Local_b_Absyn_Binding_struct*)_tmp453)->f1;{struct Cyc_Absyn_Vardecl*vd=_tmp454;
# 2776
void*_tmp457=Cyc_Absyn_compress(_check_null(e->topt));void*_stmttmp73=_tmp457;void*_tmp458=_stmttmp73;if(*((int*)_tmp458)== 4)
return({struct _tuple14 _tmp52E;_tmp52E.f1=1,_tmp52E.f2=_check_null(vd->rgn);_tmp52E;});else{
# 2779
vd->escapes=1;
return({struct _tuple14 _tmp52F;_tmp52F.f1=(vd->tq).real_const,_tmp52F.f2=_check_null(vd->rgn);_tmp52F;});};}case 5: _tmp454=((struct Cyc_Absyn_Pat_b_Absyn_Binding_struct*)_tmp453)->f1;{struct Cyc_Absyn_Vardecl*vd=_tmp454;
# 2782
...
# 2784
vd->escapes=1;
return({struct _tuple14 _tmp530;_tmp530.f1=(vd->tq).real_const,_tmp530.f2=_check_null(vd->rgn);_tmp530;});}};}case 21: _tmp450=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp44F)->f1;_tmp451=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp44F)->f2;_tmp452=((struct Cyc_Absyn_AggrMember_e_Absyn_Raw_exp_struct*)_tmp44F)->f3;{struct Cyc_Absyn_Exp*e1=_tmp450;struct _fat_ptr*f=_tmp451;int is_tagged=_tmp452;
# 2789
if(is_tagged)return bogus_ans;{
# 2792
void*_tmp459=Cyc_Absyn_compress(_check_null(e1->topt));void*_stmttmp74=_tmp459;void*_tmp45A=_stmttmp74;void*_tmp45B;switch(*((int*)_tmp45A)){case 7: _tmp45B=((struct Cyc_Absyn_AnonAggrType_Absyn_Type_struct*)_tmp45A)->f2;{struct Cyc_List_List*fs=_tmp45B;
# 2794
...
return({struct _tuple14 _tmp531;_tmp531.f1=(finfo->tq).real_const || c,_tmp531.f2=t;_tmp531;});}}
# 2799
...
# 2824
if(finfo != 0 && finfo->width == 0)
return({struct _tuple14 _tmp533;_tmp533.f1=(finfo->tq).real_const,_tmp533.f2=r;_tmp533;});
...
if(finfo != 0)
return({struct _tuple14 _tmp535;_tmp535.f1=((*finfo).f1).real_const,({void*_tmp664=(Cyc_Tcutil_addressof_props(e1)).f2;_tmp535.f2=_tmp664;});_tmp535;});
...
# 2851
return({struct _tuple14 _tmp536;_tmp536.f1=tq.real_const,_tmp536.f2=r;_tmp536;});}case 4: _tmp472=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp471)->f1).tq;{struct Cyc_Absyn_Tqual tq=_tmp472;
# 2857
return({struct _tuple14 _tmp537;_tmp537.f1=tq.real_const,({void*_tmp665=(Cyc_Tcutil_addressof_props(e1)).f2;_tmp537.f2=_tmp665;});_tmp537;});}default:
 return bogus_ans;};}default:
# 2861
({struct Cyc_Warn_String_Warn_Warg_struct _tmp47A=({struct Cyc_Warn_String_Warn_Warg_struct _tmp538;_tmp538.tag=0,({struct _fat_ptr _tmp666=({const char*_tmp47B="unary & applied to non-lvalue";_tag_fat(_tmp47B,sizeof(char),30U);});_tmp538.f1=_tmp666;});_tmp538;});void*_tmp479[1];_tmp479[0]=& _tmp47A;Cyc_Warn_err2(e->loc,_tag_fat(_tmp479,sizeof(void*),1));});
return bogus_ans;};}
# 2868
void Cyc_Tcutil_check_bound(unsigned loc,unsigned i,void*b,int do_warn){
struct Cyc_Absyn_Exp*_tmp47C=({void*_tmp667=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp667,b);});struct Cyc_Absyn_Exp*eopt=_tmp47C;
if(eopt == 0)return;{
...
if(known && j <= i)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp482=({struct Cyc_Warn_String_Warn_Warg_struct _tmp53D;_tmp53D.tag=0,({struct _fat_ptr _tmp668=({const char*_tmp487="a dereference is out of bounds: ";_tag_fat(_tmp487,sizeof(char),33U);});_tmp53D.f1=_tmp668;});_tmp53D;});struct Cyc_Warn_Int_Warn_Warg_struct _tmp483=({struct Cyc_Warn_Int_Warn_Warg_struct _tmp53C;_tmp53C.tag=12,_tmp53C.f1=(int)j;_tmp53C;});struct Cyc_Warn_String_Warn_Warg_struct _tmp484=({struct Cyc_Warn_String_Warn_Warg_struct _tmp53B;_tmp53B.tag=0,({
struct _fat_ptr _tmp669=({const char*_tmp486=" <= ";_tag_fat(_tmp486,sizeof(char),5U);});_tmp53B.f1=_tmp669;});_tmp53B;});struct Cyc_Warn_Int_Warn_Warg_struct _tmp485=({struct Cyc_Warn_Int_Warn_Warg_struct _tmp53A;_tmp53A.tag=12,_tmp53A.f1=(int)i;_tmp53A;});void*_tmp481[4];_tmp481[0]=& _tmp482,_tmp481[1]=& _tmp483,_tmp481[2]=& _tmp484,_tmp481[3]=& _tmp485;((
# 2873
do_warn?Cyc_Warn_warn2: Cyc_Warn_err2))(loc,_tag_fat(_tmp481,sizeof(void*),4));});
# 2875
return;}}}
# 2878
...
return 0;
_tmp49A=(struct Cyc_List_List*)(_check_null(edo->fields))->v;goto _LL17;}case 16: _tmp49A=((struct Cyc_Absyn_AnonEnumCon_Absyn_TyCon_struct*)_tmp498)->f1;_LL17: {struct Cyc_List_List*fs=_tmp49A;
# 2964
...
return fs2 == fs;{
struct _tuple13 _tmp49C=Cyc_Evexp_eval_const_uint_exp(_check_null(((struct Cyc_Absyn_Enumfield*)fs2->hd)->tag));struct _tuple13 _stmttmp80=_tmp49C;struct _tuple13 _tmp49D=_stmttmp80;int _tmp49F;unsigned _tmp49E;_tmp49E=_tmp49D.f1;_tmp49F=_tmp49D.f2;{unsigned i=_tmp49E;int known=_tmp49F;
if(known && i == 0U)
return 1;}}}}
# 2971
...
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4A9=({struct Cyc_Warn_String_Warn_Warg_struct _tmp540;_tmp540.tag=0,({struct _fat_ptr _tmp66A=({const char*_tmp4AD="qualifier within typedef type ";_tag_fat(_tmp4AD,sizeof(char),31U);});_tmp540.f1=_tmp66A;});_tmp540;});struct Cyc_Warn_Typ_Warn_Warg_struct _tmp4AA=({struct Cyc_Warn_Typ_Warn_Warg_struct _tmp53F;_tmp53F.tag=2,_tmp53F.f1=(void*)t;_tmp53F;});struct Cyc_Warn_String_Warn_Warg_struct _tmp4AB=({struct Cyc_Warn_String_Warn_Warg_struct _tmp53E;_tmp53E.tag=0,({struct _fat_ptr _tmp66B=({const char*_tmp4AC=" is ignored";_tag_fat(_tmp4AC,sizeof(char),12U);});_tmp53E.f1=_tmp66B;});_tmp53E;});void*_tmp4A8[3];_tmp4A8[0]=& _tmp4A9,_tmp4A8[1]=& _tmp4AA,_tmp4A8[2]=& _tmp4AB;Cyc_Warn_warn2(loc,_tag_fat(_tmp4A8,sizeof(void*),3));});
return;}}}else{
return;};}
# 3021
...
return({void*_tmp66C=Cyc_Absyn_bounds_one();Cyc_Tcutil_get_bounds_exp(_tmp66C,(pi.ptr_atts).bounds);});}case 4: _tmp4B0=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp4AF)->f1).num_elts;{struct Cyc_Absyn_Exp*e=_tmp4B0;
return e;}default:
 return 0;};}
# 3031
...
for(1;l != 0;l=l->tl){
if((void**)l->hd != 0)res=({struct Cyc_List_List*_tmp4B5=_cycalloc(sizeof(*_tmp4B5));_tmp4B5->hd=*_check_null((void**)l->hd),_tmp4B5->tl=res;_tmp4B5;});}
return res;}
# 3049
void*Cyc_Tcutil_promote_array(void*t,void*rgn,int convert_tag){
void*_tmp4B6=Cyc_Absyn_compress(t);void*_stmttmp82=_tmp4B6;void*_tmp4B7=_stmttmp82;void*_tmp4BB;void*_tmp4BA;struct Cyc_Absyn_Tqual _tmp4B9;void*_tmp4B8;if(*((int*)_tmp4B7)== 4){_tmp4B8=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp4B7)->f1).elt_type;_tmp4B9=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp4B7)->f1).tq;_tmp4BA=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp4B7)->f1).num_elts;_tmp4BB=(((struct Cyc_Absyn_ArrayType_Absyn_Type_struct*)_tmp4B7)->f1).zero_term;{void*et=_tmp4B8;struct Cyc_Absyn_Tqual tq=_tmp4B9;struct Cyc_Absyn_Exp*eopt=_tmp4BA;void*zt=_tmp4BB;
# 3052
void*b;
if(eopt == 0)
...
if(convert_tag){
if(eopt->topt == 0)
({struct Cyc_Warn_String_Warn_Warg_struct _tmp4BD=({struct Cyc_Warn_String_Warn_Warg_struct _tmp541;_tmp541.tag=0,({struct _fat_ptr _tmp66D=({const char*_tmp4BE="cannot convert tag without type!";_tag_fat(_tmp4BE,sizeof(char),33U);});_tmp541.f1=_tmp66D;});_tmp541;});void*_tmp4BC[1];_tmp4BC[0]=& _tmp4BD;({(int(*)(struct _fat_ptr))Cyc_Warn_impos2;})(_tag_fat(_tmp4BC,sizeof(void*),1));});{
void*_tmp4BF=Cyc_Absyn_compress(_check_null(eopt->topt));void*_stmttmp83=_tmp4BF;void*_tmp4C0=_stmttmp83;void*_tmp4C1;if(*((int*)_tmp4C0)== 0){if(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4C0)->f1)== 4){if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4C0)->f2 != 0){_tmp4C1=(void*)(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp4C0)->f2)->hd;{void*t=_tmp4C1;
# 3061
