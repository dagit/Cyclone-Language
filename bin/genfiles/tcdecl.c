...
# 399
struct _tuple17 _stmttmp8=Cyc_Tcdecl_split(f);struct _tuple17 _Tmp0=_stmttmp8;void*_Tmp1;void*_Tmp2;_Tmp2=_Tmp0.f1;_Tmp1=_Tmp0.f2;{struct Cyc_List_List*f1=_Tmp2;struct Cyc_List_List*f2=_Tmp1;
if(f1 != 0 && f1->tl != 0)
