...
_tmp4A == 0  && _tmp50 != 0) || 
_tmp4A != 0  && _tmp50 == 0){
{const char*_tmp1B8;void*_tmp1B7[3];const char*_tmp1B6;struct Cyc_String_pa_PrintArg_struct _tmp1B5;struct Cyc_String_pa_PrintArg_struct _tmp1B4;struct Cyc_String_pa_PrintArg_struct _tmp1B3;(_tmp1B3.tag=0,((_tmp1B3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp47),((_tmp1B4.tag=0,((_tmp1B4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp32),((_tmp1B5.tag=0,((_tmp1B5.f1=(struct _dyneither_ptr)((_tmp1B6="type",_tag_dyneither(_tmp1B6,sizeof(char),5))),((_tmp1B7[0]=& _tmp1B5,((_tmp1B7[1]=& _tmp1B4,((_tmp1B7[2]=& _tmp1B3,Cyc_Tcdecl_merr(loc,msg,((_tmp1B8="%s %s : bitfield mismatch on field %s",_tag_dyneither(_tmp1B8,sizeof(char),38))),_tag_dyneither(_tmp1B7,sizeof(void*),3)))))))))))))))))));}
_tmp33=0;}{
# 217
