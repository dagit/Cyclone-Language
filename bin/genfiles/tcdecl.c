...
y);extern char Cyc_List_Nth[4];struct Cyc_List_Nth_exn_struct{char*tag;};struct Cyc_Lineno_Pos{
...
Cyc_Absyn_empty_tqual(unsigned int);struct Cyc_Absyn_Kind*Cyc_Absyn_force_kb(void*
kb);struct _dyneither_ptr Cyc_Absyn_attribute2string(void*);extern char Cyc_Tcdecl_Incompatible[
...
Cyc_Tcenv_Tenv*Cyc_Tcenv_tenv_t;int Cyc_Tcutil_unify_kindbound(void*,void*);void
Cyc_Tcutil_explain_failure();int Cyc_Tcutil_unify(void*,void*);void*Cyc_Tcutil_substitute(
...
enum Cyc_Absyn_Scope sc);char Cyc_Tcdecl_Incompatible[13]="Incompatible";struct Cyc_Tcdecl_Incompatible_exn_struct
...
_tmp1A1=0;*_tmp1A1 < *_tmp1A0;(*_tmp1A1)++){struct Cyc_String_pa_PrintArg_struct
...
int)(*_tmp1A1 - 1)));}}void Cyc_Tcdecl_merr(unsigned int loc,struct _dyneither_ptr*
msg1,struct _dyneither_ptr fmt,struct _dyneither_ptr ap){if(msg1 == 0)(int)_throw((
void*)& Cyc_Tcdecl_Incompatible_val);{const char*_tmp199;struct _dyneither_ptr fmt2=(
struct _dyneither_ptr)Cyc_strconcat(((_tmp199="%s ",_tag_dyneither(_tmp199,
sizeof(char),4))),(struct _dyneither_ptr)fmt);unsigned int _tmp1A1;unsigned int
_tmp1A0;struct _dyneither_ptr _tmp19F;void**_tmp19E;unsigned int _tmp19D;struct
_dyneither_ptr ap2=(_tmp19D=_get_dyneither_size(ap,sizeof(void*))+ 1,((_tmp19E=(
void**)_cycalloc(_check_times(sizeof(void*),_tmp19D)),((_tmp19F=_tag_dyneither(
_tmp19E,sizeof(void*),_tmp19D),((((_tmp1A0=_tmp19D,_tmp1A2(& msg1,& ap,& _tmp1A1,&
_tmp1A0,& _tmp19E))),_tmp19F)))))));Cyc_Position_post_error(Cyc_Position_mk_err_elab(
loc,(struct _dyneither_ptr)Cyc_vrprintf(Cyc_Core_heap_region,fmt2,ap2)));};}
...
_dyneither_ptr*msg){const char*_tmp1A3;struct _dyneither_ptr s0_str=s0 == Cyc_Absyn_Public?(
_tmp1A3="public",_tag_dyneither(_tmp1A3,sizeof(char),7)): Cyc_Absynpp_scope2string(
s0);const char*_tmp1A4;struct _dyneither_ptr s1_str=s1 == Cyc_Absyn_Public?(_tmp1A4="public",
_tag_dyneither(_tmp1A4,sizeof(char),7)): Cyc_Absynpp_scope2string(s1);const char*
_tmp1AB;void*_tmp1AA[4];struct Cyc_String_pa_PrintArg_struct _tmp1A9;struct Cyc_String_pa_PrintArg_struct
_tmp1A8;struct Cyc_String_pa_PrintArg_struct _tmp1A7;struct Cyc_String_pa_PrintArg_struct
_tmp1A6;(_tmp1A6.tag=0,((_tmp1A6.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_scope2string(s0)),((_tmp1A7.tag=0,((_tmp1A7.f1=(struct _dyneither_ptr)((
struct _dyneither_ptr)Cyc_Absynpp_scope2string(s1)),((_tmp1A8.tag=0,((_tmp1A8.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)v),((_tmp1A9.tag=0,((_tmp1A9.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)t),((_tmp1AA[0]=& _tmp1A9,((_tmp1AA[1]=&
_tmp1A8,((_tmp1AA[2]=& _tmp1A7,((_tmp1AA[3]=& _tmp1A6,Cyc_Tcdecl_merr(loc,msg,((
_tmp1AB="%s %s is %s whereas expected scope is %s",_tag_dyneither(_tmp1AB,
sizeof(char),41))),_tag_dyneither(_tmp1AA,sizeof(void*),4)))))))))))))))))))))))));}
...
_tmp2E;int _tmp2F;_LL1E: {struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*_tmp2C=(
struct Cyc_Absyn_Const_e_Absyn_Raw_exp_struct*)_tmp2B;if(_tmp2C->tag != 0)goto
_LL20;else{_tmp2D=_tmp2C->f1;if((_tmp2D.Int_c).tag != 5)goto _LL20;_tmp2E=(struct
_tuple5)(_tmp2D.Int_c).val;_tmp2F=_tmp2E.f2;}}_LL1F: return(unsigned int)_tmp2F;
_LL20:;_LL21: {struct Cyc_Core_Invalid_argument_exn_struct _tmp1B5;const char*
_tmp1B4;struct Cyc_Core_Invalid_argument_exn_struct*_tmp1B3;(int)_throw((void*)((
_tmp1B3=_cycalloc(sizeof(*_tmp1B3)),((_tmp1B3[0]=((_tmp1B5.tag=Cyc_Core_Invalid_argument,((
_tmp1B5.f1=((_tmp1B4="Tcdecl::get_uint_const_value",_tag_dyneither(_tmp1B4,
sizeof(char),29))),_tmp1B5)))),_tmp1B3)))));}_LL1D:;}inline static int Cyc_Tcdecl_check_tvs(
struct Cyc_List_List*tvs0,struct Cyc_List_List*tvs1,struct _dyneither_ptr t,struct
_dyneither_ptr v,unsigned int loc,struct _dyneither_ptr*msg){if(((int(*)(struct Cyc_List_List*
x))Cyc_List_length)(tvs0)!= ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
tvs1)){{const char*_tmp1BA;void*_tmp1B9[2];struct Cyc_String_pa_PrintArg_struct
_tmp1B8;struct Cyc_String_pa_PrintArg_struct _tmp1B7;(_tmp1B7.tag=0,((_tmp1B7.f1=(
...
_tmp1C2;void*_tmp1C1[5];struct Cyc_String_pa_PrintArg_struct _tmp1C0;struct Cyc_String_pa_PrintArg_struct
_tmp1BF;struct Cyc_String_pa_PrintArg_struct _tmp1BE;struct Cyc_String_pa_PrintArg_struct
_tmp1BD;struct Cyc_String_pa_PrintArg_struct _tmp1BC;(_tmp1BC.tag=0,((_tmp1BC.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(_tmp3A)),((
_tmp1BD.tag=0,((_tmp1BD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((
struct Cyc_Absyn_Tvar*)_tmp37->hd)->name),((_tmp1BE.tag=0,((_tmp1BE.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(_tmp39)),((_tmp1BF.tag=
0,((_tmp1BF.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)v),((_tmp1C0.tag=0,((
_tmp1C0.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t),((_tmp1C1[0]=& _tmp1C0,((
_tmp1C1[1]=& _tmp1BF,((_tmp1C1[2]=& _tmp1BE,((_tmp1C1[3]=& _tmp1BD,((_tmp1C1[4]=&
_tmp1BC,Cyc_Tcdecl_merr(loc,msg,((_tmp1C2="%s %s has a different kind (%s) for type parameter %s (%s)",
...
_tmp1CF)))),_tmp1D1)))))),((_tmp1CE->tl=inst,_tmp1CE))))));}return inst;}struct
_tuple13{struct Cyc_Absyn_AggrdeclImpl*f1;struct Cyc_Absyn_AggrdeclImpl*f2;};
struct _tuple14{void*f1;void*f2;};struct Cyc_Absyn_Aggrdecl*Cyc_Tcdecl_merge_aggrdecl(
struct Cyc_Absyn_Aggrdecl*d0,struct Cyc_Absyn_Aggrdecl*d1,unsigned int loc,struct
...
_tmp1E6[3];const char*_tmp1E5;struct Cyc_String_pa_PrintArg_struct _tmp1E4;struct
Cyc_String_pa_PrintArg_struct _tmp1E3;struct Cyc_String_pa_PrintArg_struct _tmp1E2;(
_tmp1E2.tag=0,((_tmp1E2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp66),((
_tmp1E3.tag=0,((_tmp1E3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp4A),((
_tmp1E4.tag=0,((_tmp1E4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)((
_tmp1E5="type",_tag_dyneither(_tmp1E5,sizeof(char),5)))),((_tmp1E6[0]=& _tmp1E4,((
_tmp1E6[1]=& _tmp1E3,((_tmp1E6[2]=& _tmp1E2,Cyc_Tcdecl_merr(loc,msg,((_tmp1E7="%s %s : attribute mismatch on field %s",
...
_tmp1EE[3];const char*_tmp1ED;struct Cyc_String_pa_PrintArg_struct _tmp1EC;struct
Cyc_String_pa_PrintArg_struct _tmp1EB;struct Cyc_String_pa_PrintArg_struct _tmp1EA;(
_tmp1EA.tag=0,((_tmp1EA.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp66),((
_tmp1EB.tag=0,((_tmp1EB.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp4A),((
_tmp1EC.tag=0,((_tmp1EC.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)((
_tmp1ED="type",_tag_dyneither(_tmp1ED,sizeof(char),5)))),((_tmp1EE[0]=& _tmp1EC,((
_tmp1EE[1]=& _tmp1EB,((_tmp1EE[2]=& _tmp1EA,Cyc_Tcdecl_merr(loc,msg,((_tmp1EF="%s %s : qualifier mismatch on field %s",
...
_tmp1F7;void*_tmp1F6[3];const char*_tmp1F5;struct Cyc_String_pa_PrintArg_struct
...
_tmp68,subst_t1)){{const char*_tmp1FE;void*_tmp1FD[4];struct Cyc_String_pa_PrintArg_struct
_tmp1FC;struct Cyc_String_pa_PrintArg_struct _tmp1FB;struct Cyc_String_pa_PrintArg_struct
...
void*_tmp202[2];struct Cyc_String_pa_PrintArg_struct _tmp201;struct Cyc_String_pa_PrintArg_struct
...
_tmp4B=0;}if(_tmp60 != 0){{const char*_tmp208;void*_tmp207[2];struct Cyc_String_pa_PrintArg_struct
_tmp206;struct Cyc_String_pa_PrintArg_struct _tmp205;(_tmp205.tag=0,((_tmp205.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)_tmp60->hd)->name),((
...
_tmp4B=0;}if(_tmp5B != _tmp61){{const char*_tmp20C;void*_tmp20B[1];struct Cyc_String_pa_PrintArg_struct
...
void*_tmp215[4];struct Cyc_String_pa_PrintArg_struct _tmp214;struct Cyc_String_pa_PrintArg_struct
_tmp213;struct Cyc_String_pa_PrintArg_struct _tmp212;struct Cyc_String_pa_PrintArg_struct
_tmp211;(_tmp211.tag=0,((_tmp211.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*
f0->name).f2),((_tmp212.tag=0,((_tmp212.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)*(*f1->name).f2),((_tmp213.tag=0,((_tmp213.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)v),((_tmp214.tag=0,((_tmp214.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)t),((_tmp215[0]=& _tmp214,((_tmp215[1]=&
_tmp213,((_tmp215[2]=& _tmp212,((_tmp215[3]=& _tmp211,Cyc_Tcdecl_merr(loc,msg,((
_tmp216="%s %s: field name mismatch %s != %s",_tag_dyneither(_tmp216,sizeof(char),
36))),_tag_dyneither(_tmp215,sizeof(void*),4)))))))))))))))))))))))));}return 0;}{
struct _dyneither_ptr _tmpA5=*(*f0->name).f2;enum Cyc_Absyn_Scope _tmpAB;int _tmpAC;
const char*_tmp21B;void*_tmp21A[2];struct Cyc_String_pa_PrintArg_struct _tmp219;
struct Cyc_String_pa_PrintArg_struct _tmp218;struct _tuple10 _tmpAA=Cyc_Tcdecl_merge_scope(
f0->sc,f1->sc,(struct _dyneither_ptr)((_tmp218.tag=0,((_tmp218.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)v),((_tmp219.tag=0,((_tmp219.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)t),((_tmp21A[0]=& _tmp219,((_tmp21A[1]=&
_tmp218,Cyc_aprintf(((_tmp21B="in %s %s, field",_tag_dyneither(_tmp21B,sizeof(
char),16))),_tag_dyneither(_tmp21A,sizeof(void*),2)))))))))))))),_tmpA5,loc,msg,
0);_tmpAB=_tmpAA.f1;_tmpAC=_tmpAA.f2;{struct Cyc_List_List*_tmpAD=f0->typs;struct
Cyc_List_List*_tmpAE=f1->typs;if(((int(*)(struct Cyc_List_List*x))Cyc_List_length)(
_tmpAD)!= ((int(*)(struct Cyc_List_List*x))Cyc_List_length)(_tmpAE)){{const char*
_tmp221;void*_tmp220[3];struct Cyc_String_pa_PrintArg_struct _tmp21F;struct Cyc_String_pa_PrintArg_struct
_tmp21E;struct Cyc_String_pa_PrintArg_struct _tmp21D;(_tmp21D.tag=0,((_tmp21D.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)_tmpA5),((_tmp21E.tag=0,((_tmp21E.f1=(
...
_check_null(_tmpAE))->hd)).f1)){{const char*_tmp227;void*_tmp226[3];struct Cyc_String_pa_PrintArg_struct
_tmp225;struct Cyc_String_pa_PrintArg_struct _tmp224;struct Cyc_String_pa_PrintArg_struct
...
char*_tmp22F;void*_tmp22E[5];struct Cyc_String_pa_PrintArg_struct _tmp22D;struct
Cyc_String_pa_PrintArg_struct _tmp22C;struct Cyc_String_pa_PrintArg_struct _tmp22B;
struct Cyc_String_pa_PrintArg_struct _tmp22A;struct Cyc_String_pa_PrintArg_struct
...
_tmp245[3];struct Cyc_String_pa_PrintArg_struct _tmp244;struct Cyc_String_pa_PrintArg_struct
_tmp243;struct Cyc_String_pa_PrintArg_struct _tmp242;(_tmp242.tag=0,((_tmp242.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Tcdecl_is_x2string(d1->is_extensible)),((
...
_tmpEF != 0){{const char*_tmp24F;void*_tmp24E[3];struct Cyc_String_pa_PrintArg_struct
_tmp24D;struct Cyc_String_pa_PrintArg_struct _tmp24C;struct Cyc_String_pa_PrintArg_struct
...
_tmpF2 != 0){{const char*_tmp255;void*_tmp254[3];struct Cyc_String_pa_PrintArg_struct
_tmp253;struct Cyc_String_pa_PrintArg_struct _tmp252;struct Cyc_String_pa_PrintArg_struct
...
Cyc_strptrcmp(_tmp118,_tmp11F)!= 0){{const char*_tmp25E;void*_tmp25D[3];struct Cyc_String_pa_PrintArg_struct
_tmp25C;struct Cyc_String_pa_PrintArg_struct _tmp25B;struct Cyc_String_pa_PrintArg_struct
...
_tmp120))){{const char*_tmp263;void*_tmp262[2];struct Cyc_String_pa_PrintArg_struct
_tmp261;struct Cyc_String_pa_PrintArg_struct _tmp260;(_tmp260.tag=0,((_tmp260.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)*_tmp11F),((_tmp261.tag=0,((_tmp261.f1=(
...
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(t0)),((
_tmp267.tag=0,((_tmp267.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
t1)),((_tmp268.tag=0,((_tmp268.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)v),((
_tmp269.tag=0,((_tmp269.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t),((
_tmp26A[0]=& _tmp269,((_tmp26A[1]=& _tmp268,((_tmp26A[2]=& _tmp267,((_tmp26A[3]=&
_tmp266,Cyc_Tcdecl_merr(loc,msg,((_tmp26B="%s %s has type \n%s\n instead of \n%s\n",
...
_tmp274[2];struct Cyc_String_pa_PrintArg_struct _tmp273;struct Cyc_String_pa_PrintArg_struct
_tmp272;(_tmp272.tag=0,((_tmp272.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
v),((_tmp273.tag=0,((_tmp273.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t),((
...
for(0;atts0 != 0;atts0=atts0->tl){const char*_tmp27C;void*_tmp27B[1];struct Cyc_String_pa_PrintArg_struct
...
for(0;atts1 != 0;atts1=atts1->tl){const char*_tmp283;void*_tmp282[1];struct Cyc_String_pa_PrintArg_struct
...
0){void*subst_defn1=Cyc_Tcutil_substitute(_tmp154,(void*)_check_null(d1->defn));
if(!Cyc_Tcdecl_check_type((void*)_check_null(d0->defn),subst_defn1)){{const char*
_tmp290;void*_tmp28F[3];struct Cyc_String_pa_PrintArg_struct _tmp28E;struct Cyc_String_pa_PrintArg_struct
_tmp28D;struct Cyc_String_pa_PrintArg_struct _tmp28C;(_tmp28C.tag=0,((_tmp28C.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string((void*)
_check_null(d0->defn))),((_tmp28D.tag=0,((_tmp28D.f1=(struct _dyneither_ptr)((
...
_LL38: _tmp15C=_tmp15B.f1;{struct Cyc_Absyn_Unresolved_b_Absyn_Binding_struct*
...
!= 0)goto _LL3A;};_LL39: return(void*)& Cyc_Absyn_Unresolved_b_val;_LL3A: _tmp160=
_tmp15B.f1;{struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp161=(struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)
_tmp160;if(_tmp161->tag != 1)goto _LL3C;else{_tmp162=_tmp161->f1;}};_tmp163=
_tmp15B.f2;{struct Cyc_Absyn_Global_b_Absyn_Binding_struct*_tmp164=(struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)
...
Cyc_Absyn_Global_b_Absyn_Binding_struct _tmp294;struct Cyc_Absyn_Global_b_Absyn_Binding_struct*
...
!= 2)goto _LL3E;else{_tmp16B=_tmp16A->f1;}};_LL3D: {int _tmp17C;const char*_tmp295;
struct _tuple10 _tmp17B=Cyc_Tcdecl_check_var_or_fn_decl(_tmp168->sc,_tmp168->type,
_tmp168->tq,_tmp168->attributes,_tmp16B->sc,(void*)_check_null(_tmp16B->cached_typ),
...
_tmp16C=_tmp15B.f1;{struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*_tmp16D=(
struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*)_tmp16C;if(_tmp16D->tag != 2)goto
_LL40;};_tmp16E=_tmp15B.f2;{struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*
_tmp16F=(struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*)_tmp16E;if(_tmp16F->tag
!= 2)goto _LL40;else{_tmp170=_tmp16F->f1;}};_LL3F:{const char*_tmp299;void*_tmp298[
1];struct Cyc_String_pa_PrintArg_struct _tmp297;(_tmp297.tag=0,((_tmp297.f1=(
struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp170->name)),((
_tmp298[0]=& _tmp297,Cyc_Tcdecl_merr(loc,msg,((_tmp299="redefinition of function %s",
...
!= 1)goto _LL42;else{_tmp176=_tmp175->f1;}};_LL41: {int _tmp182;const char*_tmp29A;
struct _tuple10 _tmp181=Cyc_Tcdecl_check_var_or_fn_decl(_tmp173->sc,(void*)
_check_null(_tmp173->cached_typ),Cyc_Absyn_empty_tqual(0),_tmp173->attributes,
...
_LL42:;_LL43: {struct Cyc_Core_Invalid_argument_exn_struct _tmp2A0;const char*
_tmp29F;struct Cyc_Core_Invalid_argument_exn_struct*_tmp29E;(int)_throw((void*)((
_tmp29E=_cycalloc(sizeof(*_tmp29E)),((_tmp29E[0]=((_tmp2A0.tag=Cyc_Core_Invalid_argument,((
...
char*_tmp2A6;void*_tmp2A5[3];struct Cyc_String_pa_PrintArg_struct _tmp2A4;struct
Cyc_String_pa_PrintArg_struct _tmp2A3;struct Cyc_String_pa_PrintArg_struct _tmp2A2;(
_tmp2A2.tag=0,((_tmp2A2.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp18E),((
_tmp2A3.tag=0,((_tmp2A3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(
_tmp18C->name)),((_tmp2A4.tag=0,((_tmp2A4.f1=(struct _dyneither_ptr)((struct
_dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp188->name)),((_tmp2A5[0]=& _tmp2A4,((
_tmp2A5[1]=& _tmp2A3,((_tmp2A5[2]=& _tmp2A2,Cyc_Tcdecl_merr(loc,msg,((_tmp2A6="@extensible datatype %s and %s have both a field named %s",
