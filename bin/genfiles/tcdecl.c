...
# 39 "tcdecl.h"
void Cyc_Tcdecl_merr(unsigned loc,struct _dyneither_ptr*msg1,struct _dyneither_ptr fmt,struct _dyneither_ptr ap);struct _tuple10{enum Cyc_Absyn_Scope f1;int f2;};
# 55 "tcdecl.h"
struct _tuple10 Cyc_Tcdecl_merge_scope(enum Cyc_Absyn_Scope s0,enum Cyc_Absyn_Scope s1,struct _dyneither_ptr t,struct _dyneither_ptr v,unsigned loc,struct _dyneither_ptr*msg,int allow_externC_extern_merge);
# 60
...
# 82
struct Cyc_List_List*Cyc_Tcdecl_sort_xdatatype_fields(struct Cyc_List_List*f,int*res,struct _dyneither_ptr*v,unsigned loc,struct _dyneither_ptr*msg);struct Cyc_Iter_Iter{void*env;int(*next)(void*env,void*dest);};
# 37 "iter.h"
...
struct _dyneither_ptr ap2=({unsigned _tmp4=_get_dyneither_size(ap,sizeof(void*))+ (unsigned)1;void**_tmp3=_cycalloc(_check_times(_tmp4,sizeof(void*)));({{unsigned _tmp168=_get_dyneither_size(ap,sizeof(void*))+ (unsigned)1;unsigned i;for(i=0;i < _tmp168;++ i){
i == (unsigned)0?({void*_tmp1D2=(void*)({struct Cyc_String_pa_PrintArg_struct*_tmp2=_cycalloc(sizeof(*_tmp2));_tmp2->tag=0U,_tmp2->f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*msg1);_tmp2;});_tmp3[i]=_tmp1D2;}):(_tmp3[i]=*((void**)_check_dyneither_subscript(ap,sizeof(void*),(int)(i - (unsigned)1))));}}0;});_tag_dyneither(_tmp3,sizeof(void*),_tmp4);});
Cyc_Position_post_error(({unsigned _tmp1D3=loc;Cyc_Position_mk_err(_tmp1D3,(struct _dyneither_ptr)Cyc_vrprintf(Cyc_Core_heap_region,fmt2,ap2));}));};};}
# 56
static void Cyc_Tcdecl_merge_scope_err(enum Cyc_Absyn_Scope s0,enum Cyc_Absyn_Scope s1,struct _dyneither_ptr t,struct _dyneither_ptr v,unsigned loc,struct _dyneither_ptr*msg){
# 58
struct _dyneither_ptr s0_str=(int)s0 == (int)2U?({const char*_tmpC="public ";_tag_dyneither(_tmpC,sizeof(char),8U);}): Cyc_Absynpp_scope2string(s0);
struct _dyneither_ptr s1_str=(int)s1 == (int)2U?({const char*_tmpB="public ";_tag_dyneither(_tmpB,sizeof(char),8U);}): Cyc_Absynpp_scope2string(s1);
({struct Cyc_String_pa_PrintArg_struct _tmp7=({struct Cyc_String_pa_PrintArg_struct _tmp16C;_tmp16C.tag=0U,_tmp16C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t);_tmp16C;});struct Cyc_String_pa_PrintArg_struct _tmp8=({struct Cyc_String_pa_PrintArg_struct _tmp16B;_tmp16B.tag=0U,_tmp16B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)v);_tmp16B;});struct Cyc_String_pa_PrintArg_struct _tmp9=({struct Cyc_String_pa_PrintArg_struct _tmp16A;_tmp16A.tag=0U,_tmp16A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s1_str);_tmp16A;});struct Cyc_String_pa_PrintArg_struct _tmpA=({struct Cyc_String_pa_PrintArg_struct _tmp169;_tmp169.tag=0U,_tmp169.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)s0_str);_tmp169;});void*_tmp5[4U];_tmp5[0]=& _tmp7,_tmp5[1]=& _tmp8,_tmp5[2]=& _tmp9,_tmp5[3]=& _tmpA;({unsigned _tmp1D6=loc;struct _dyneither_ptr*_tmp1D5=msg;struct _dyneither_ptr _tmp1D4=({const char*_tmp6="%s %s is %sbut expected scope is %s";_tag_dyneither(_tmp6,sizeof(char),36U);});Cyc_Tcdecl_merr(_tmp1D6,_tmp1D5,_tmp1D4,_tag_dyneither(_tmp5,sizeof(void*),4U));});});}struct _tuple11{enum Cyc_Absyn_Scope f1;enum Cyc_Absyn_Scope f2;};
# 64
struct _tuple10 Cyc_Tcdecl_merge_scope(enum Cyc_Absyn_Scope s0,enum Cyc_Absyn_Scope s1,struct _dyneither_ptr t,struct _dyneither_ptr v,unsigned loc,struct _dyneither_ptr*msg,int externCmerge){
# 66
...
struct _dyneither_ptr _tmp1DC=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(_tmp1A));_tmp175.f1=_tmp1DC;});_tmp175;});struct Cyc_String_pa_PrintArg_struct _tmp21=({struct Cyc_String_pa_PrintArg_struct _tmp174;_tmp174.tag=0U,_tmp174.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Tvar*)_tmp18->hd)->name);_tmp174;});struct Cyc_String_pa_PrintArg_struct _tmp22=({struct Cyc_String_pa_PrintArg_struct _tmp173;_tmp173.tag=0U,({struct _dyneither_ptr _tmp1DD=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(_tmp1B));_tmp173.f1=_tmp1DD;});_tmp173;});void*_tmp1C[5U];_tmp1C[0]=& _tmp1E,_tmp1C[1]=& _tmp1F,_tmp1C[2]=& _tmp20,_tmp1C[3]=& _tmp21,_tmp1C[4]=& _tmp22;({unsigned _tmp1E0=loc;struct _dyneither_ptr*_tmp1DF=msg;struct _dyneither_ptr _tmp1DE=({const char*_tmp1D="%s %s has a different kind (%s) for type parameter %s (%s)";_tag_dyneither(_tmp1D,sizeof(char),59U);});Cyc_Tcdecl_merr(_tmp1E0,_tmp1DF,_tmp1DE,_tag_dyneither(_tmp1C,sizeof(void*),5U));});});
return 0;};}
# 121
return 1;};}
# 124
static int Cyc_Tcdecl_check_atts(struct Cyc_List_List*atts0,struct Cyc_List_List*atts1,struct _dyneither_ptr t,struct _dyneither_ptr v,unsigned loc,struct _dyneither_ptr*msg){
# 126
if(!Cyc_Tcutil_same_atts(atts0,atts1)){
({struct Cyc_String_pa_PrintArg_struct _tmp25=({struct Cyc_String_pa_PrintArg_struct _tmp179;_tmp179.tag=0U,_tmp179.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t);_tmp179;});struct Cyc_String_pa_PrintArg_struct _tmp26=({struct Cyc_String_pa_PrintArg_struct _tmp178;_tmp178.tag=0U,_tmp178.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)v);_tmp178;});void*_tmp23[2U];_tmp23[0]=& _tmp25,_tmp23[1]=& _tmp26;({unsigned _tmp1E3=loc;struct _dyneither_ptr*_tmp1E2=msg;struct _dyneither_ptr _tmp1E1=({const char*_tmp24="%s %s has different attributes";_tag_dyneither(_tmp24,sizeof(char),31U);});Cyc_Tcdecl_merr(_tmp1E3,_tmp1E2,_tmp1E1,_tag_dyneither(_tmp23,sizeof(void*),2U));});});
return 0;}
# 130
...
# 152
if(!({struct Cyc_List_List*_tmp1EA=d0->tvs;struct Cyc_List_List*_tmp1E9=d1->tvs;struct _dyneither_ptr _tmp1E8=({const char*_tmp2C="type";_tag_dyneither(_tmp2C,sizeof(char),5U);});struct _dyneither_ptr _tmp1E7=_tmp2A;unsigned _tmp1E6=loc;Cyc_Tcdecl_check_tvs(_tmp1EA,_tmp1E9,_tmp1E8,_tmp1E7,_tmp1E6,msg);}))return 0;{
# 155
struct _tuple10 _tmp2D=({
enum Cyc_Absyn_Scope _tmp1EF=d0->sc;enum Cyc_Absyn_Scope _tmp1EE=d1->sc;struct _dyneither_ptr _tmp1ED=({const char*_tmp83="type";_tag_dyneither(_tmp83,sizeof(char),5U);});struct _dyneither_ptr _tmp1EC=_tmp2A;unsigned _tmp1EB=loc;Cyc_Tcdecl_merge_scope(_tmp1EF,_tmp1EE,_tmp1ED,_tmp1EC,_tmp1EB,msg,1);});
# 155
struct _tuple10 _tmp2E=_tmp2D;enum Cyc_Absyn_Scope _tmp82;int _tmp81;_LL1: _tmp82=_tmp2E.f1;_tmp81=_tmp2E.f2;_LL2:;
# 157
if(!_tmp81)_tmp2B=0;
# 160
if(!({struct Cyc_List_List*_tmp1F4=d0->attributes;struct Cyc_List_List*_tmp1F3=d1->attributes;struct _dyneither_ptr _tmp1F2=({const char*_tmp2F="type";_tag_dyneither(_tmp2F,sizeof(char),5U);});struct _dyneither_ptr _tmp1F1=_tmp2A;unsigned _tmp1F0=loc;Cyc_Tcdecl_check_atts(_tmp1F4,_tmp1F3,_tmp1F2,_tmp1F1,_tmp1F0,msg);}))_tmp2B=0;{
# 162
...
# 171
 if(!({struct Cyc_List_List*_tmp1F9=_tmp7F;struct Cyc_List_List*_tmp1F8=_tmp7B;struct _dyneither_ptr _tmp1F7=({const char*_tmp32="type";_tag_dyneither(_tmp32,sizeof(char),5U);});struct _dyneither_ptr _tmp1F6=_tmp2A;unsigned _tmp1F5=loc;Cyc_Tcdecl_check_tvs(_tmp1F9,_tmp1F8,_tmp1F7,_tmp1F6,_tmp1F5,msg);}))
return 0;{
# 175
...
struct _dyneither_ptr _tmp20E=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmp67));_tmp188.f1=_tmp20E;});_tmp188;});struct Cyc_String_pa_PrintArg_struct _tmp56=({struct Cyc_String_pa_PrintArg_struct _tmp187;_tmp187.tag=0U,({struct _dyneither_ptr _tmp20F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_exp2string(_tmp61));_tmp187.f1=_tmp20F;});_tmp187;});void*_tmp52[3U];_tmp52[0]=& _tmp54,_tmp52[1]=& _tmp55,_tmp52[2]=& _tmp56;({unsigned _tmp212=loc;struct _dyneither_ptr*_tmp211=msg;struct _dyneither_ptr _tmp210=({const char*_tmp53="type %s : mismatch on @requires clauses: %s != %s";_tag_dyneither(_tmp53,sizeof(char),50U);});Cyc_Tcdecl_merr(_tmp212,_tmp211,_tmp210,_tag_dyneither(_tmp52,sizeof(void*),3U));});});
_tmp2B=0;}}else{
# 219
if(_tmp67 == 0 && _tmp61 != 0 ||
 _tmp67 != 0 && _tmp61 == 0){
({struct Cyc_String_pa_PrintArg_struct _tmp5A=({struct Cyc_String_pa_PrintArg_struct _tmp18A;_tmp18A.tag=0U,_tmp18A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp2A);_tmp18A;});void*_tmp58[1U];_tmp58[0]=& _tmp5A;({unsigned _tmp215=loc;struct _dyneither_ptr*_tmp214=msg;struct _dyneither_ptr _tmp213=({const char*_tmp59="type %s : mismatch on @requires clauses";_tag_dyneither(_tmp59,sizeof(char),40U);});Cyc_Tcdecl_merr(_tmp215,_tmp214,_tmp213,_tag_dyneither(_tmp58,sizeof(void*),1U));});});
_tmp2B=0;}}{
# 225
...
struct _dyneither_ptr _tmp216=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp6A));_tmp18C.f1=_tmp216;});_tmp18C;});struct Cyc_String_pa_PrintArg_struct _tmp60=({struct Cyc_String_pa_PrintArg_struct _tmp18B;_tmp18B.tag=0U,({struct _dyneither_ptr _tmp217=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(subst_t1));_tmp18B.f1=_tmp217;});_tmp18B;});void*_tmp5B[4U];_tmp5B[0]=& _tmp5D,_tmp5B[1]=& _tmp5E,_tmp5B[2]=& _tmp5F,_tmp5B[3]=& _tmp60;({unsigned _tmp21A=loc;struct _dyneither_ptr*_tmp219=msg;struct _dyneither_ptr _tmp218=({const char*_tmp5C="type %s : type mismatch on field %s: %s != %s";_tag_dyneither(_tmp5C,sizeof(char),46U);});Cyc_Tcdecl_merr(_tmp21A,_tmp219,_tmp218,_tag_dyneither(_tmp5B,sizeof(void*),4U));});});
Cyc_Tcutil_explain_failure();
_tmp2B=0;}};};}
# 234
if(_tmp7D != 0){
({struct Cyc_String_pa_PrintArg_struct _tmp6F=({struct Cyc_String_pa_PrintArg_struct _tmp190;_tmp190.tag=0U,_tmp190.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp2A);_tmp190;});struct Cyc_String_pa_PrintArg_struct _tmp70=({struct Cyc_String_pa_PrintArg_struct _tmp18F;_tmp18F.tag=0U,_tmp18F.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)_tmp7D->hd)->name);_tmp18F;});void*_tmp6D[2U];_tmp6D[0]=& _tmp6F,_tmp6D[1]=& _tmp70;({unsigned _tmp21D=loc;struct _dyneither_ptr*_tmp21C=msg;struct _dyneither_ptr _tmp21B=({const char*_tmp6E="type %s is missing field %s";_tag_dyneither(_tmp6E,sizeof(char),28U);});Cyc_Tcdecl_merr(_tmp21D,_tmp21C,_tmp21B,_tag_dyneither(_tmp6D,sizeof(void*),2U));});});
_tmp2B=0;}
# 238
if(_tmp79 != 0){
({struct Cyc_String_pa_PrintArg_struct _tmp73=({struct Cyc_String_pa_PrintArg_struct _tmp192;_tmp192.tag=0U,_tmp192.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp2A);_tmp192;});struct Cyc_String_pa_PrintArg_struct _tmp74=({struct Cyc_String_pa_PrintArg_struct _tmp191;_tmp191.tag=0U,_tmp191.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*((struct Cyc_Absyn_Aggrfield*)_tmp79->hd)->name);_tmp191;});void*_tmp71[2U];_tmp71[0]=& _tmp73,_tmp71[1]=& _tmp74;({unsigned _tmp220=loc;struct _dyneither_ptr*_tmp21F=msg;struct _dyneither_ptr _tmp21E=({const char*_tmp72="type %s has extra field %s";_tag_dyneither(_tmp72,sizeof(char),27U);});Cyc_Tcdecl_merr(_tmp220,_tmp21F,_tmp21E,_tag_dyneither(_tmp71,sizeof(void*),2U));});});
_tmp2B=0;}
# 243
if(_tmp7C != _tmp78){
({struct Cyc_String_pa_PrintArg_struct _tmp77=({struct Cyc_String_pa_PrintArg_struct _tmp193;_tmp193.tag=0U,_tmp193.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp2A);_tmp193;});void*_tmp75[1U];_tmp75[0]=& _tmp77;({unsigned _tmp223=loc;struct _dyneither_ptr*_tmp222=msg;struct _dyneither_ptr _tmp221=({const char*_tmp76="%s : previous declaration disagrees with @tagged qualifier";_tag_dyneither(_tmp76,sizeof(char),59U);});Cyc_Tcdecl_merr(_tmp223,_tmp222,_tmp221,_tag_dyneither(_tmp75,sizeof(void*),1U));});});
_tmp2B=0;}
# 248
d2=d0;
goto _LL3;};}}_LL3:;}
...
({struct Cyc_String_pa_PrintArg_struct _tmp88=({struct Cyc_String_pa_PrintArg_struct _tmp198;_tmp198.tag=0U,_tmp198.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t);_tmp198;});struct Cyc_String_pa_PrintArg_struct _tmp89=({struct Cyc_String_pa_PrintArg_struct _tmp197;_tmp197.tag=0U,_tmp197.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)v);_tmp197;});struct Cyc_String_pa_PrintArg_struct _tmp8A=({struct Cyc_String_pa_PrintArg_struct _tmp196;_tmp196.tag=0U,_tmp196.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*f1->name).f2);_tmp196;});struct Cyc_String_pa_PrintArg_struct _tmp8B=({struct Cyc_String_pa_PrintArg_struct _tmp195;_tmp195.tag=0U,_tmp195.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*f0->name).f2);_tmp195;});void*_tmp86[4U];_tmp86[0]=& _tmp88,_tmp86[1]=& _tmp89,_tmp86[2]=& _tmp8A,_tmp86[3]=& _tmp8B;({unsigned _tmp226=loc;struct _dyneither_ptr*_tmp225=msg;struct _dyneither_ptr _tmp224=({const char*_tmp87="%s %s: field name mismatch %s != %s";_tag_dyneither(_tmp87,sizeof(char),36U);});Cyc_Tcdecl_merr(_tmp226,_tmp225,_tmp224,_tag_dyneither(_tmp86,sizeof(void*),4U));});});
# 279
return 0;}{
# 282
...
({struct Cyc_String_pa_PrintArg_struct _tmp98=({struct Cyc_String_pa_PrintArg_struct _tmp19E;_tmp19E.tag=0U,_tmp19E.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)t);_tmp19E;});struct Cyc_String_pa_PrintArg_struct _tmp99=({struct Cyc_String_pa_PrintArg_struct _tmp19D;_tmp19D.tag=0U,_tmp19D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)v);_tmp19D;});struct Cyc_String_pa_PrintArg_struct _tmp9A=({struct Cyc_String_pa_PrintArg_struct _tmp19C;_tmp19C.tag=0U,_tmp19C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp8C);_tmp19C;});void*_tmp96[3U];_tmp96[0]=& _tmp98,_tmp96[1]=& _tmp99,_tmp96[2]=& _tmp9A;({unsigned _tmp233=loc;struct _dyneither_ptr*_tmp232=msg;struct _dyneither_ptr _tmp231=({const char*_tmp97="%s %s, field %s: parameter qualifier";_tag_dyneither(_tmp97,sizeof(char),37U);});Cyc_Tcdecl_merr(_tmp233,_tmp232,_tmp231,_tag_dyneither(_tmp96,sizeof(void*),3U));});});
_tmpA4=0;}{
# 302
...
return _tmpAE;}
# 341
static struct Cyc_List_List*Cyc_Tcdecl_merge_xdatatype_fields(struct Cyc_List_List*f0s,struct Cyc_List_List*f1s,struct Cyc_List_List*inst,struct Cyc_List_List*tvs0,struct Cyc_List_List*tvs1,int*res,int*incl,struct _dyneither_ptr t,struct _dyneither_ptr v,unsigned loc,struct _dyneither_ptr*msg){
# 350
...
# 403
struct Cyc_List_List*Cyc_Tcdecl_sort_xdatatype_fields(struct Cyc_List_List*f,int*res,struct _dyneither_ptr*v,unsigned loc,struct _dyneither_ptr*msg){
# 406
...
struct Cyc_Absyn_Enumfield*_tmpEB=(struct Cyc_Absyn_Enumfield*)_tmpFF->hd;struct Cyc_Absyn_Enumfield*_tmpEC=_tmpEB;struct _dyneither_ptr*_tmpFD;struct Cyc_Absyn_Exp*_tmpFC;unsigned _tmpFB;_LLB: _tmpFD=(_tmpEC->name)->f2;_tmpFC=_tmpEC->tag;_tmpFB=_tmpEC->loc;_LLC:;{
struct Cyc_Absyn_Enumfield*_tmpED=(struct Cyc_Absyn_Enumfield*)_tmpFE->hd;struct Cyc_Absyn_Enumfield*_tmpEE=_tmpED;struct _dyneither_ptr*_tmpFA;struct Cyc_Absyn_Exp*_tmpF9;unsigned _tmpF8;_LLE: _tmpFA=(_tmpEE->name)->f2;_tmpF9=_tmpEE->tag;_tmpF8=_tmpEE->loc;_LLF:;
# 525
if(Cyc_strptrcmp(_tmpFD,_tmpFA)!= 0){
({struct Cyc_String_pa_PrintArg_struct _tmpF1=({struct Cyc_String_pa_PrintArg_struct _tmp1B5;_tmp1B5.tag=0U,_tmp1B5.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmpE5);_tmp1B5;});struct Cyc_String_pa_PrintArg_struct _tmpF2=({struct Cyc_String_pa_PrintArg_struct _tmp1B4;_tmp1B4.tag=0U,_tmp1B4.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmpFD);_tmp1B4;});struct Cyc_String_pa_PrintArg_struct _tmpF3=({struct Cyc_String_pa_PrintArg_struct _tmp1B3;_tmp1B3.tag=0U,_tmp1B3.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*_tmpFA);_tmp1B3;});void*_tmpEF[3U];_tmpEF[0]=& _tmpF1,_tmpEF[1]=& _tmpF2,_tmpEF[2]=& _tmpF3;({unsigned _tmp258=loc;struct _dyneither_ptr*_tmp257=msg;struct _dyneither_ptr _tmp256=({const char*_tmpF0="enum %s: field name mismatch %s != %s";_tag_dyneither(_tmpF0,sizeof(char),38U);});Cyc_Tcdecl_merr(_tmp258,_tmp257,_tmp256,_tag_dyneither(_tmpEF,sizeof(void*),3U));});});
_tmpE6=0;}
# 530
...
enum Cyc_Absyn_Scope _tmp283=d0->sc;void*_tmp282=d0->type;struct Cyc_Absyn_Tqual _tmp281=d0->tq;struct Cyc_List_List*_tmp280=d0->attributes;enum Cyc_Absyn_Scope _tmp27F=d1->sc;void*_tmp27E=d1->type;struct Cyc_Absyn_Tqual _tmp27D=d1->tq;struct Cyc_List_List*_tmp27C=d1->attributes;struct _dyneither_ptr _tmp27B=({const char*_tmp133="variable";_tag_dyneither(_tmp133,sizeof(char),9U);});struct _dyneither_ptr _tmp27A=_tmp12C;unsigned _tmp279=loc;Cyc_Tcdecl_check_var_or_fn_decl(_tmp283,_tmp282,_tmp281,_tmp280,_tmp27F,_tmp27E,_tmp27D,_tmp27C,_tmp27B,_tmp27A,_tmp279,msg);});
# 602
...
# 622
if(!({struct Cyc_List_List*_tmp288=d0->tvs;struct Cyc_List_List*_tmp287=d1->tvs;struct _dyneither_ptr _tmp286=({const char*_tmp135="typedef";_tag_dyneither(_tmp135,sizeof(char),8U);});struct _dyneither_ptr _tmp285=_tmp134;unsigned _tmp284=loc;Cyc_Tcdecl_check_tvs(_tmp288,_tmp287,_tmp286,_tmp285,_tmp284,msg);}))return 0;{
# 625
...
# 648
struct Cyc_List_List*_tmp292=(_tmp152->i).attributes;struct _dyneither_ptr _tmp291=({const char*_tmp147="function";_tag_dyneither(_tmp147,sizeof(char),9U);});struct _dyneither_ptr _tmp290=
# 651
...
# 654
({struct Cyc_String_pa_PrintArg_struct _tmp14A=({struct Cyc_String_pa_PrintArg_struct _tmp1CB;_tmp1CB.tag=0U,({struct _dyneither_ptr _tmp29A=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp154->name));_tmp1CB.f1=_tmp29A;});_tmp1CB;});void*_tmp148[1U];_tmp148[0]=& _tmp14A;({unsigned _tmp29D=loc;struct _dyneither_ptr*_tmp29C=msg;struct _dyneither_ptr _tmp29B=({const char*_tmp149="redefinition of function %s";_tag_dyneither(_tmp149,sizeof(char),28U);});Cyc_Tcdecl_merr(_tmp29D,_tmp29C,_tmp29B,_tag_dyneither(_tmp148,sizeof(void*),1U));});});
...
struct _dyneither_ptr _tmp2A9=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp167->name));_tmp1CF.f1=_tmp2A9;});_tmp1CF;});struct Cyc_String_pa_PrintArg_struct _tmp15D=({struct Cyc_String_pa_PrintArg_struct _tmp1CE;_tmp1CE.tag=0U,({struct _dyneither_ptr _tmp2AA=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_qvar2string(_tmp165->name));_tmp1CE.f1=_tmp2AA;});_tmp1CE;});struct Cyc_String_pa_PrintArg_struct _tmp15E=({struct Cyc_String_pa_PrintArg_struct _tmp1CD;_tmp1CD.tag=0U,_tmp1CD.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp159);_tmp1CD;});void*_tmp15A[3U];_tmp15A[0]=& _tmp15C,_tmp15A[1]=& _tmp15D,_tmp15A[2]=& _tmp15E;({unsigned _tmp2AD=loc;struct _dyneither_ptr*_tmp2AC=msg;struct _dyneither_ptr _tmp2AB=({const char*_tmp15B="@extensible datatype %s and %s have both a field named %s";_tag_dyneither(_tmp15B,sizeof(char),58U);});Cyc_Tcdecl_merr(_tmp2AD,_tmp2AC,_tmp2AB,_tag_dyneither(_tmp15A,sizeof(void*),3U));});});
return 0;}
# 681
if(!({struct Cyc_List_List*_tmp2B2=_tmp167->tvs;struct Cyc_List_List*_tmp2B1=_tmp165->tvs;struct _dyneither_ptr _tmp2B0=({const char*_tmp15F="@extensible datatype";_tag_dyneither(_tmp15F,sizeof(char),21U);});struct _dyneither_ptr _tmp2AF=Cyc_Absynpp_qvar2string(_tmp167->name);unsigned _tmp2AE=loc;Cyc_Tcdecl_check_tvs(_tmp2B2,_tmp2B1,_tmp2B0,_tmp2AF,_tmp2AE,msg);}))
return 0;{
# 684
