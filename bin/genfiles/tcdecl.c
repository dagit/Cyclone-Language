...
# 43 "/tmp/cyclone/include/position.h"
...
return 0;}
# 138
return 1;}struct _tuple14{struct Cyc_Absyn_AggrdeclImpl*f1;struct Cyc_Absyn_AggrdeclImpl*f2;};struct _tuple15{void*f1;void*f2;};
# 142
...
({struct Cyc_List_List*_tmp239=((struct Cyc_List_List*(*)(struct _tuple16*(*f)(struct Cyc_List_List*,struct _tuple16*),struct Cyc_List_List*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcdecl_substitute_datatypefield_f2,inst1,f1->typs);f0->typs=_tmp239;});
# 335
return f0;}
# 342
...
# 407
struct _tuple17 _tmpBF=((struct _tuple17(*)(struct Cyc_List_List*f))Cyc_Tcdecl_split)(f);struct _tuple17 _stmttmp8=_tmpBF;struct _tuple17 _tmpC0=_stmttmp8;struct Cyc_List_List*_tmpC2;struct Cyc_List_List*_tmpC1;_LL1: _tmpC1=_tmpC0.f1;_tmpC2=_tmpC0.f2;_LL2: {struct Cyc_List_List*f1=_tmpC1;struct Cyc_List_List*f2=_tmpC2;
if(f1 != 0 && f1->tl != 0)
...
# 456 "/tmp/cyclone/src/tcdecl.cyc"
...
({struct Cyc_String_pa_PrintArg_struct _tmp12C=({struct Cyc_String_pa_PrintArg_struct _tmp1C5;_tmp1C5.tag=0U,({struct _fat_ptr _tmp276=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_attribute2string((void*)atts1->hd));_tmp1C5.f1=_tmp276;});_tmp1C5;});void*_tmp12A[1U];_tmp12A[0]=& _tmp12C;({struct Cyc___cycFILE*_tmp278=Cyc_stderr;struct _fat_ptr _tmp277=({const char*_tmp12B="%s ";_tag_fat(_tmp12B,sizeof(char),4U);});Cyc_fprintf(_tmp278,_tmp277,_tag_fat(_tmp12A,sizeof(void*),1U));});});}
