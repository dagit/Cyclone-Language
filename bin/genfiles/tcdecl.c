...
# 66
{struct _tuple12 _tmpD=({struct _tuple12 _tmp16D;_tmp16D.f1=s0,_tmp16D.f2=s1;_tmp16D;});struct _tuple12 _tmpE=_tmpD;switch(_tmpE.f1){case Cyc_Absyn_ExternC: switch(_tmpE.f2){case Cyc_Absyn_ExternC: _LL1: _LL2:
# 68
...
# 155
struct _tuple11 _tmp2E=_tmp2D;enum Cyc_Absyn_Scope _tmp82;int _tmp81;_LL1: _tmp82=_tmp2E.f1;_tmp81=_tmp2E.f2;_LL2:;
# 157
if(!_tmp81)_tmp2B=0;
# 160
...
# 164
{struct _tuple14 _tmp30=({struct _tuple14 _tmp192;_tmp192.f1=d0->impl,_tmp192.f2=d1->impl;_tmp192;});struct _tuple14 _tmp31=_tmp30;struct Cyc_List_List*_tmp7F;struct Cyc_List_List*_tmp7E;struct Cyc_List_List*_tmp7D;int _tmp7C;struct Cyc_List_List*_tmp7B;struct Cyc_List_List*_tmp7A;struct Cyc_List_List*_tmp79;int _tmp78;if(_tmp31.f2 == 0){_LL4: _LL5:
...
Cyc_Tcdecl_check_type((*((struct _tuple15*)_tmp7E->hd)).f1,(*((struct _tuple15*)_tmp7A->hd)).f1);
Cyc_Tcdecl_check_type((*((struct _tuple15*)_tmp7E->hd)).f2,(*((struct _tuple15*)_tmp7A->hd)).f2);}
# 187
...
# 285
struct _tuple11 _tmp8E=_tmp8D;enum Cyc_Absyn_Scope _tmpA5;int _tmpA4;_LL1: _tmpA5=_tmp8E.f1;_tmpA4=_tmp8E.f2;_LL2:;{
# 289
...
# 298
if(!Cyc_Absyn_equal_tqual((*((struct _tuple16*)_tmp8F->hd)).f1,(*((struct _tuple16*)_tmp90->hd)).f1)){
...
_tmpA4=0;}{
# 302
void*subst_t1=Cyc_Tcutil_substitute(inst,(*((struct _tuple16*)_tmp90->hd)).f2);
# 304
if(!Cyc_Tcdecl_check_type((*((struct _tuple16*)_tmp8F->hd)).f2,subst_t1)){
...
# 323
struct _tuple16*_tmpAA=x;struct Cyc_Absyn_Tqual _tmpAD;void*_tmpAC;_LL1: _tmpAD=_tmpAA->f1;_tmpAC=_tmpAA->f2;_LL2:;
return({struct _tuple16*_tmpAB=_cycalloc(sizeof(*_tmpAB));_tmpAB->f1=_tmpAD,({void*_tmp238=Cyc_Tcutil_substitute(inst,_tmpAC);_tmpAB->f2=_tmp238;});_tmpAB;});}
# 329
...
({struct Cyc_List_List*_tmp239=((struct Cyc_List_List*(*)(struct _tuple16*(*f)(struct Cyc_List_List*,struct _tuple16*),struct Cyc_List_List*env,struct Cyc_List_List*x))Cyc_List_map_c)(Cyc_Tcdecl_substitute_datatypefield_f2,inst1,f1->typs);_tmpAE->typs=_tmp239;});
# 334
return _tmpAE;}
# 341
...
struct _tuple17 _tmpB9=Cyc_Tcdecl_split(((struct Cyc_List_List*)_check_null(f->tl))->tl);struct _tuple17 _tmpBA=_tmpB9;struct Cyc_List_List*_tmpBE;struct Cyc_List_List*_tmpBD;_LL1: _tmpBE=_tmpBA.f1;_tmpBD=_tmpBA.f2;_LL2:;
...
# 406
struct _tuple17 _tmpBF=((struct _tuple17(*)(struct Cyc_List_List*f))Cyc_Tcdecl_split)(f);struct _tuple17 _tmpC0=_tmpBF;struct Cyc_List_List*_tmpC4;struct Cyc_List_List*_tmpC3;_LL1: _tmpC4=_tmpC0.f1;_tmpC3=_tmpC0.f2;_LL2:;
...
# 435
struct _tuple11 _tmpCC=Cyc_Tcdecl_merge_scope(d0->sc,d1->sc,t,_tmpC5,loc,msg,0);struct _tuple11 _tmpCD=_tmpCC;enum Cyc_Absyn_Scope _tmpE3;int _tmpE2;_LL1: _tmpE3=_tmpCD.f1;_tmpE2=_tmpCD.f2;_LL2:;
if(!_tmpE2)_tmpC6=0;{
# 438
struct Cyc_Absyn_Datatypedecl*d2;
# 441
{struct _tuple18 _tmpCE=({struct _tuple18 _tmp1B0;_tmp1B0.f1=d0->fields,_tmp1B0.f2=d1->fields;_tmp1B0;});struct _tuple18 _tmpCF=_tmpCE;struct Cyc_List_List*_tmpE0;struct Cyc_List_List*_tmpDF;if(_tmpCF.f2 == 0){_LL4: _LL5:
...
int _tmpE6=1;
# 508
struct _tuple11 _tmpE7=({enum Cyc_Absyn_Scope _tmp254=d0->sc;enum Cyc_Absyn_Scope _tmp253=d1->sc;struct _fat_ptr _tmp252=({const char*_tmp106="enum";_tag_fat(_tmp106,sizeof(char),5U);});struct _fat_ptr _tmp251=_tmpE5;unsigned _tmp250=loc;Cyc_Tcdecl_merge_scope(_tmp254,_tmp253,_tmp252,_tmp251,_tmp250,msg,1);});struct _tuple11 _tmpE8=_tmpE7;enum Cyc_Absyn_Scope _tmp105;int _tmp104;_LL1: _tmp105=_tmpE8.f1;_tmp104=_tmpE8.f2;_LL2:;
if(!_tmp104)_tmpE6=0;{
# 511
struct Cyc_Absyn_Enumdecl*d2;
# 514
{struct _tuple18 _tmpE9=({struct _tuple18 _tmp1B7;_tmp1B7.f1=d0->fields,_tmp1B7.f2=d1->fields;_tmp1B7;});struct _tuple18 _tmpEA=_tmpE9;struct Cyc_List_List*_tmp102;struct Cyc_List_List*_tmp101;if(_tmpEA.f2 == 0){_LL4: _LL5:
...
int _tmp107=1;
# 558
struct _tuple11 _tmp108=Cyc_Tcdecl_merge_scope(sc0,sc1,t,v,loc,msg,0);struct _tuple11 _tmp109=_tmp108;enum Cyc_Absyn_Scope _tmp12E;int _tmp12D;_LL1: _tmp12E=_tmp109.f1;_tmp12D=_tmp109.f2;_LL2:;
...
_tmp107=0;}
# 595
return({struct _tuple11 _tmp1C6;_tmp1C6.f1=_tmp12E,_tmp1C6.f2=_tmp107;_tmp1C6;});}
# 598
...
# 603
struct _tuple11 _tmp131=_tmp130;enum Cyc_Absyn_Scope _tmp135;int _tmp134;_LL1: _tmp135=_tmp131.f1;_tmp134=_tmp131.f2;_LL2:;
# 607
if(!_tmp134)return 0;
# 609
...
# 650
struct _tuple11 _tmp143=({enum Cyc_Absyn_Scope _tmp29A=_tmp151->sc;void*_tmp299=_tmp151->type;struct Cyc_Absyn_Tqual _tmp298=_tmp151->tq;struct Cyc_List_List*_tmp297=_tmp151->attributes;enum Cyc_Absyn_Scope _tmp296=_tmp150->sc;void*_tmp295=(void*)_check_null(_tmp150->cached_type);struct Cyc_Absyn_Tqual _tmp294=
...
# 650
unsigned _tmp290=loc;Cyc_Tcdecl_check_var_or_fn_decl(_tmp29A,_tmp299,_tmp298,_tmp297,_tmp296,_tmp295,_tmp294,_tmp293,_tmp292,_tmp291,_tmp290,msg);});struct _tuple11 _tmp144=_tmp143;int _tmp145;_LLC: _tmp145=_tmp144.f2;_LLD:;
# 654
...
# 660
struct _tuple11 _tmp14A=({enum Cyc_Absyn_Scope _tmp2A9=_tmp154->sc;void*_tmp2A8=(void*)_check_null(_tmp154->cached_type);struct Cyc_Absyn_Tqual _tmp2A7=Cyc_Absyn_empty_tqual(0U);struct Cyc_List_List*_tmp2A6=(_tmp154->i).attributes;enum Cyc_Absyn_Scope _tmp2A5=_tmp153->sc;void*_tmp2A4=_tmp153->type;struct Cyc_Absyn_Tqual _tmp2A3=_tmp153->tq;struct Cyc_List_List*_tmp2A2=_tmp153->attributes;struct _fat_ptr _tmp2A1=({const char*_tmp14D="variable";_tag_fat(_tmp14D,sizeof(char),9U);});struct _fat_ptr _tmp2A0=
# 663
Cyc_Absynpp_qvar2string(_tmp154->name);
# 660
unsigned _tmp29F=loc;Cyc_Tcdecl_check_var_or_fn_decl(_tmp2A9,_tmp2A8,_tmp2A7,_tmp2A6,_tmp2A5,_tmp2A4,_tmp2A3,_tmp2A2,_tmp2A1,_tmp2A0,_tmp29F,msg);});struct _tuple11 _tmp14B=_tmp14A;int _tmp14C;_LLF: _tmp14C=_tmp14B.f2;_LL10:;
# 664
