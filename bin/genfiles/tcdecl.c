...
# 43
if(msg1==0)
(void*)_throw((void*)& Cyc_Tcdecl_Incompatible_val);{
...
(void*)_throw((void*)({struct Cyc_Core_Invalid_argument_exn_struct*_Tmp2=_cycalloc(sizeof(struct Cyc_Core_Invalid_argument_exn_struct));_Tmp2->tag=Cyc_Core_Invalid_argument,_Tmp2->f1=({const char*_Tmp3="Tcdecl::get_uint_const_value";_tag_fat(_Tmp3,sizeof(char),29U);});_Tmp2;}));};}struct _tuple13{struct Cyc_Absyn_Tvar*f1;void*f2;};
# 103
...
Cyc_Tcdecl_merge_scope(d0->sc,d1->sc,({const char*_Tmp1="type";_tag_fat(_Tmp1,sizeof(char),5U);}),v,loc,msg,1);
# 155
...
# 281
struct _tuple11 _Tmp0=({
enum Cyc_Absyn_Scope _Tmp1=f0->sc;enum Cyc_Absyn_Scope _Tmp2=f1->sc;struct _fat_ptr _Tmp3=({struct Cyc_String_pa_PrintArg_struct _Tmp4=({struct Cyc_String_pa_PrintArg_struct _Tmp5;_Tmp5.tag=0,_Tmp5.f1=t;_Tmp5;});struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,_Tmp6.f1=v;_Tmp6;});void*_Tmp6[2];_Tmp6[0]=& _Tmp4,_Tmp6[1]=& _Tmp5;Cyc_aprintf(({const char*_Tmp7="in %s %s, field";_tag_fat(_Tmp7,sizeof(char),16U);}),_tag_fat(_Tmp6,sizeof(void*),2));});struct _fat_ptr _Tmp4=name;unsigned _Tmp5=loc;Cyc_Tcdecl_merge_scope(_Tmp1,_Tmp2,_Tmp3,_Tmp4,_Tmp5,msg,0);});
# 281
...
int res=1;
# 496
struct _tuple11 _Tmp0=Cyc_Tcdecl_merge_scope(d0->sc,d1->sc,({const char*_Tmp1="enum";_tag_fat(_Tmp1,sizeof(char),5U);}),v,loc,msg,1);int _Tmp1;enum Cyc_Absyn_Scope _Tmp2;_Tmp2=_Tmp0.f1;_Tmp1=_Tmp0.f2;{enum Cyc_Absyn_Scope new_scope=_Tmp2;int res_scope=_Tmp1;
if(!res_scope)res=0;{
# 499
...
# 587
struct _tuple11 _Tmp0=
Cyc_Tcdecl_check_var_or_fn_decl(d0->sc,d0->type,d0->tq,d0->attributes,d1->sc,d1->type,d1->tq,d1->attributes,({const char*_Tmp1="variable";_tag_fat(_Tmp1,sizeof(char),9U);}),v,loc,msg);
# 587
int _Tmp1;enum Cyc_Absyn_Scope _Tmp2;_Tmp2=_Tmp0.f1;_Tmp1=_Tmp0.f2;{enum Cyc_Absyn_Scope new_scope=_Tmp2;int res=_Tmp1;
# 592
if(!res)return 0;
...
# 631
struct Cyc_List_List*_TmpB=d1->i.attributes;struct _fat_ptr _TmpC=({const char*_TmpD="function";_tag_fat(_TmpD,sizeof(char),9U);});struct _fat_ptr _TmpD=
# 634
...
struct _fat_ptr _Tmp6=Cyc_Absynpp_qvar2string(b0->name);_Tmp5.f1=_Tmp6;});_Tmp5;});struct Cyc_String_pa_PrintArg_struct _Tmp5=({struct Cyc_String_pa_PrintArg_struct _Tmp6;_Tmp6.tag=0,({struct _fat_ptr _Tmp7=Cyc_Absynpp_qvar2string(b1->name);_Tmp6.f1=_Tmp7;});_Tmp6;});struct Cyc_String_pa_PrintArg_struct _Tmp6=({struct Cyc_String_pa_PrintArg_struct _Tmp7;_Tmp7.tag=0,_Tmp7.f1=v;_Tmp7;});void*_Tmp7[3];_Tmp7[0]=& _Tmp4,_Tmp7[1]=& _Tmp5,_Tmp7[2]=& _Tmp6;Cyc_Tcdecl_merr(loc,msg,({const char*_Tmp8="@extensible datatype %s and %s both have a field named %s";_tag_fat(_Tmp8,sizeof(char),58U);}),_tag_fat(_Tmp7,sizeof(void*),3));});
return 0;}
# 668
if(!({struct Cyc_List_List*_Tmp4=b0->tvs;struct Cyc_List_List*_Tmp5=b1->tvs;struct _fat_ptr _Tmp6=({const char*_Tmp7="@extensible datatype";_tag_fat(_Tmp7,sizeof(char),21U);});struct _fat_ptr _Tmp7=Cyc_Absynpp_qvar2string(b0->name);unsigned _Tmp8=loc;Cyc_Tcdecl_check_tvs(_Tmp4,_Tmp5,_Tmp6,_Tmp7,_Tmp8,msg);}))
return 0;{
# 671
struct Cyc_List_List*inst1=Cyc_Tcdecl_build_tvs_map(b0->tvs,b1->tvs);
# 674
struct Cyc_Absyn_Datatypefield*f2=Cyc_Tcdecl_merge_datatypefield(f0,f1,inst1,({const char*_Tmp4="@extensible datatype field";_tag_fat(_Tmp4,sizeof(char),27U);}),v,msg);
if(f2==0)return 0;
if(f2==f0)return d0;
