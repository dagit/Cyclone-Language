...
# 164
{struct _tuple14 _Tmp3=({struct _tuple14 _Tmp4;_Tmp4.f1=d0->impl,_Tmp4.f2=d1->impl;_Tmp4;});int _Tmp4;void*_Tmp5;void*_Tmp6;void*_Tmp7;int _Tmp8;void*_Tmp9;void*_TmpA;void*_TmpB;if(_Tmp3.f2==0){
...
return 0;{
# 175
struct Cyc_List_List*inst=({struct Cyc_List_List*_TmpC=Cyc_List_append(d0->tvs,exist_vars0);Cyc_Tcdecl_build_tvs_map(_TmpC,
...
struct Cyc_Absyn_Aggrfield*_TmpC=(struct Cyc_Absyn_Aggrfield*)f0s->hd;void*_TmpD;void*_TmpE;void*_TmpF;void*_Tmp10;struct Cyc_Absyn_Tqual _Tmp11;void*_Tmp12;_Tmp12=_TmpC->name;_Tmp11=_TmpC->tq;_Tmp10=_TmpC->type;_TmpF=_TmpC->width;_TmpE=_TmpC->attributes;_TmpD=_TmpC->requires_clause;{struct _fat_ptr*fn0=_Tmp12;struct Cyc_Absyn_Tqual tq0=_Tmp11;void*t0=_Tmp10;struct Cyc_Absyn_Exp*width0=_TmpF;struct Cyc_List_List*atts0=_TmpE;struct Cyc_Absyn_Exp*req0=_TmpD;
struct Cyc_Absyn_Aggrfield*_Tmp13=(struct Cyc_Absyn_Aggrfield*)f1s->hd;void*_Tmp14;void*_Tmp15;void*_Tmp16;void*_Tmp17;struct Cyc_Absyn_Tqual _Tmp18;void*_Tmp19;_Tmp19=_Tmp13->name;_Tmp18=_Tmp13->tq;_Tmp17=_Tmp13->type;_Tmp16=_Tmp13->width;_Tmp15=_Tmp13->attributes;_Tmp14=_Tmp13->requires_clause;{struct _fat_ptr*fn1=_Tmp19;struct Cyc_Absyn_Tqual tq1=_Tmp18;void*t1=_Tmp17;struct Cyc_Absyn_Exp*width1=_Tmp16;struct Cyc_List_List*atts1=_Tmp15;struct Cyc_Absyn_Exp*req1=_Tmp14;
# 191
if(Cyc_strptrcmp(fn0,fn1)!=0){
({struct Cyc_String_pa_PrintArg_struct _Tmp1A=({struct Cyc_String_pa_PrintArg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=(struct _fat_ptr)_tag_fat("type",sizeof(char),5U);_Tmp1B;});struct Cyc_String_pa_PrintArg_struct _Tmp1B=({struct Cyc_String_pa_PrintArg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=(struct _fat_ptr)((struct _fat_ptr)v);_Tmp1C;});struct Cyc_String_pa_PrintArg_struct _Tmp1C=({struct Cyc_String_pa_PrintArg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=(struct _fat_ptr)((struct _fat_ptr)*fn0);_Tmp1D;});struct Cyc_String_pa_PrintArg_struct _Tmp1D=({struct Cyc_String_pa_PrintArg_struct _Tmp1E;_Tmp1E.tag=0,_Tmp1E.f1=(struct _fat_ptr)((struct _fat_ptr)*fn1);_Tmp1E;});void*_Tmp1E[4];_Tmp1E[0]=& _Tmp1A,_Tmp1E[1]=& _Tmp1B,_Tmp1E[2]=& _Tmp1C,_Tmp1E[3]=& _Tmp1D;Cyc_Tcdecl_merr(loc,msg,_tag_fat("%s %s : field name mismatch %s != %s",sizeof(char),37U),_tag_fat(_Tmp1E,sizeof(void*),4));});
# 194
return 0;}
# 196
if(!Cyc_Atts_same_atts(atts0,atts1)){
({struct Cyc_String_pa_PrintArg_struct _Tmp1A=({struct Cyc_String_pa_PrintArg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=(struct _fat_ptr)_tag_fat("type",sizeof(char),5U);_Tmp1B;});struct Cyc_String_pa_PrintArg_struct _Tmp1B=({struct Cyc_String_pa_PrintArg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=(struct _fat_ptr)((struct _fat_ptr)v);_Tmp1C;});struct Cyc_String_pa_PrintArg_struct _Tmp1C=({struct Cyc_String_pa_PrintArg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=(struct _fat_ptr)((struct _fat_ptr)*fn0);_Tmp1D;});void*_Tmp1D[3];_Tmp1D[0]=& _Tmp1A,_Tmp1D[1]=& _Tmp1B,_Tmp1D[2]=& _Tmp1C;Cyc_Tcdecl_merr(loc,msg,_tag_fat("%s %s : attribute mismatch on field %s",sizeof(char),39U),_tag_fat(_Tmp1D,sizeof(void*),3));});
res=0;}
# 200
if(!Cyc_Absyn_equal_tqual(tq0,tq1)){
({struct Cyc_String_pa_PrintArg_struct _Tmp1A=({struct Cyc_String_pa_PrintArg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=(struct _fat_ptr)_tag_fat("type",sizeof(char),5U);_Tmp1B;});struct Cyc_String_pa_PrintArg_struct _Tmp1B=({struct Cyc_String_pa_PrintArg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=(struct _fat_ptr)((struct _fat_ptr)v);_Tmp1C;});struct Cyc_String_pa_PrintArg_struct _Tmp1C=({struct Cyc_String_pa_PrintArg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=(struct _fat_ptr)((struct _fat_ptr)*fn0);_Tmp1D;});void*_Tmp1D[3];_Tmp1D[0]=& _Tmp1A,_Tmp1D[1]=& _Tmp1B,_Tmp1D[2]=& _Tmp1C;Cyc_Tcdecl_merr(loc,msg,_tag_fat("%s %s : qualifier mismatch on field %s",sizeof(char),39U),_tag_fat(_Tmp1D,sizeof(void*),3));});
res=0;}
# 204
...
Cyc_Tcdecl_get_uint_const_value(width1);})||
 width0==0 && width1!=0)||
 width0!=0 && width1==0){
({struct Cyc_String_pa_PrintArg_struct _Tmp1A=({struct Cyc_String_pa_PrintArg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=(struct _fat_ptr)_tag_fat("type",sizeof(char),5U);_Tmp1B;});struct Cyc_String_pa_PrintArg_struct _Tmp1B=({struct Cyc_String_pa_PrintArg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=(struct _fat_ptr)((struct _fat_ptr)v);_Tmp1C;});struct Cyc_String_pa_PrintArg_struct _Tmp1C=({struct Cyc_String_pa_PrintArg_struct _Tmp1D;_Tmp1D.tag=0,_Tmp1D.f1=(struct _fat_ptr)((struct _fat_ptr)*fn0);_Tmp1D;});void*_Tmp1D[3];_Tmp1D[0]=& _Tmp1A,_Tmp1D[1]=& _Tmp1B,_Tmp1D[2]=& _Tmp1C;Cyc_Tcdecl_merr(loc,msg,_tag_fat("%s %s : bitfield mismatch on field %s",sizeof(char),38U),_tag_fat(_Tmp1D,sizeof(void*),3));});
res=0;}
# 212
if(req0!=0 && req1!=0){
...
({struct Cyc_String_pa_PrintArg_struct _Tmp1A=({struct Cyc_String_pa_PrintArg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=(struct _fat_ptr)((struct _fat_ptr)v);_Tmp1B;});struct Cyc_String_pa_PrintArg_struct _Tmp1B=({struct Cyc_String_pa_PrintArg_struct _Tmp1C;_Tmp1C.tag=0,({
struct _fat_ptr _Tmp1D=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(req0));_Tmp1C.f1=_Tmp1D;});_Tmp1C;});struct Cyc_String_pa_PrintArg_struct _Tmp1C=({struct Cyc_String_pa_PrintArg_struct _Tmp1D;_Tmp1D.tag=0,({struct _fat_ptr _Tmp1E=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_exp2string(req1));_Tmp1D.f1=_Tmp1E;});_Tmp1D;});void*_Tmp1D[3];_Tmp1D[0]=& _Tmp1A,_Tmp1D[1]=& _Tmp1B,_Tmp1D[2]=& _Tmp1C;Cyc_Tcdecl_merr(loc,msg,_tag_fat("type %s : mismatch on @requires clauses: %s != %s",sizeof(char),50U),_tag_fat(_Tmp1D,sizeof(void*),3));});
res=0;}}else{
# 219
if(req0==0 && req1!=0 ||
 req0!=0 && req1==0){
({struct Cyc_String_pa_PrintArg_struct _Tmp1A=({struct Cyc_String_pa_PrintArg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=(struct _fat_ptr)((struct _fat_ptr)v);_Tmp1B;});void*_Tmp1B[1];_Tmp1B[0]=& _Tmp1A;Cyc_Tcdecl_merr(loc,msg,_tag_fat("type %s : mismatch on @requires clauses",sizeof(char),40U),_tag_fat(_Tmp1B,sizeof(void*),1));});
res=0;}}{
# 225
void*subst_t1=Cyc_Tcutil_substitute(inst,t1);
if(!Cyc_Tcdecl_check_type(t0,subst_t1)){
({struct Cyc_String_pa_PrintArg_struct _Tmp1A=({struct Cyc_String_pa_PrintArg_struct _Tmp1B;_Tmp1B.tag=0,_Tmp1B.f1=(struct _fat_ptr)((struct _fat_ptr)v);_Tmp1B;});struct Cyc_String_pa_PrintArg_struct _Tmp1B=({struct Cyc_String_pa_PrintArg_struct _Tmp1C;_Tmp1C.tag=0,_Tmp1C.f1=(struct _fat_ptr)((struct _fat_ptr)*fn0);_Tmp1C;});struct Cyc_String_pa_PrintArg_struct _Tmp1C=({struct Cyc_String_pa_PrintArg_struct _Tmp1D;_Tmp1D.tag=0,({
struct _fat_ptr _Tmp1E=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_typ2string(t0));_Tmp1D.f1=_Tmp1E;});_Tmp1D;});struct Cyc_String_pa_PrintArg_struct _Tmp1D=({struct Cyc_String_pa_PrintArg_struct _Tmp1E;_Tmp1E.tag=0,({struct _fat_ptr _Tmp1F=(struct _fat_ptr)((struct _fat_ptr)Cyc_Absynpp_typ2string(subst_t1));_Tmp1E.f1=_Tmp1F;});_Tmp1E;});void*_Tmp1E[4];_Tmp1E[0]=& _Tmp1A,_Tmp1E[1]=& _Tmp1B,_Tmp1E[2]=& _Tmp1C,_Tmp1E[3]=& _Tmp1D;Cyc_Tcdecl_merr(loc,msg,_tag_fat("type %s : type mismatch on field %s: %s != %s",sizeof(char),46U),_tag_fat(_Tmp1E,sizeof(void*),4));});
Cyc_Unify_explain_failure();
res=0;}}}}}
# 234
if(f0s!=0){
({struct Cyc_String_pa_PrintArg_struct _TmpC=({struct Cyc_String_pa_PrintArg_struct _TmpD;_TmpD.tag=0,_TmpD.f1=(struct _fat_ptr)((struct _fat_ptr)v);_TmpD;});struct Cyc_String_pa_PrintArg_struct _TmpD=({struct Cyc_String_pa_PrintArg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=(struct _fat_ptr)((struct _fat_ptr)*((struct Cyc_Absyn_Aggrfield*)f0s->hd)->name);_TmpE;});void*_TmpE[2];_TmpE[0]=& _TmpC,_TmpE[1]=& _TmpD;Cyc_Tcdecl_merr(loc,msg,_tag_fat("type %s is missing field %s",sizeof(char),28U),_tag_fat(_TmpE,sizeof(void*),2));});
res=0;}
# 238
if(f1s!=0){
({struct Cyc_String_pa_PrintArg_struct _TmpC=({struct Cyc_String_pa_PrintArg_struct _TmpD;_TmpD.tag=0,_TmpD.f1=(struct _fat_ptr)((struct _fat_ptr)v);_TmpD;});struct Cyc_String_pa_PrintArg_struct _TmpD=({struct Cyc_String_pa_PrintArg_struct _TmpE;_TmpE.tag=0,_TmpE.f1=(struct _fat_ptr)((struct _fat_ptr)*((struct Cyc_Absyn_Aggrfield*)f1s->hd)->name);_TmpE;});void*_TmpE[2];_TmpE[0]=& _TmpC,_TmpE[1]=& _TmpD;Cyc_Tcdecl_merr(loc,msg,_tag_fat("type %s has extra field %s",sizeof(char),27U),_tag_fat(_TmpE,sizeof(void*),2));});
res=0;}
# 243
if(tagged0!=tagged1){
({struct Cyc_String_pa_PrintArg_struct _TmpC=({struct Cyc_String_pa_PrintArg_struct _TmpD;_TmpD.tag=0,_TmpD.f1=(struct _fat_ptr)((struct _fat_ptr)v);_TmpD;});void*_TmpD[1];_TmpD[0]=& _TmpC;Cyc_Tcdecl_merr(loc,msg,_tag_fat("%s : previous declaration disagrees with @tagged qualifier",sizeof(char),59U),_tag_fat(_TmpD,sizeof(void*),1));});
res=0;}
# 248
d2=d0;
goto _LL3;}}}}_LL3:;}
