...
# 63
extern struct Cyc_Set_Set*Cyc_Set_insert(struct Cyc_Set_Set*,void*);extern char Cyc_Set_Absent[7U];struct Cyc___cycFILE;struct Cyc_String_pa_PrintArg_struct{int tag;struct _fat_ptr f1;};
# 100 "cycboot.h"
...
void*_stmttmp0=e->r;void*_Tmp0=_stmttmp0;struct Cyc_Absyn_MallocInfo _Tmp1;void*_Tmp2;void*_Tmp3;void*_Tmp4;switch(*((int*)_Tmp0)){case 1: switch(*((int*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp0)->f1)){case 2: _Tmp4=((struct Cyc_Absyn_Funname_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp0)->f1)->f1;{struct Cyc_Absyn_Fndecl*fd=_Tmp4;
# 59
struct _handler_cons _Tmp5;_push_handler(& _Tmp5);{int _Tmp6=0;if(setjmp(_Tmp5.handler))_Tmp6=1;if(!_Tmp6){
# 62
{struct Cyc_Set_Set*_Tmp7=({struct Cyc_Set_Set*(*_Tmp8)(struct Cyc_Set_Set*,struct Cyc_Absyn_Fndecl*)=({(struct Cyc_Set_Set*(*)(struct Cyc_Set_Set*,struct Cyc_Absyn_Fndecl*))Cyc_Set_insert;});struct Cyc_Set_Set*_Tmp9=s;_Tmp8(_Tmp9,({(struct Cyc_Absyn_Fndecl*(*)(struct Cyc_Hashtable_Table*,struct _tuple0*))Cyc_Hashtable_lookup;})(fds,fd->name));});_npop_handler(0);return _Tmp7;};_pop_handler();}else{void*_Tmp7=(void*)Cyc_Core_get_exn_thrown();void*_Tmp8=_Tmp7;void*_Tmp9;if(((struct Cyc_Core_Not_found_exn_struct*)_Tmp8)->tag == Cyc_Core_Not_found)
# 64
return s;else{_Tmp9=_Tmp8;{void*exn=_Tmp9;(int)_rethrow(exn);}};}}}case 1: _Tmp4=((struct Cyc_Absyn_Global_b_Absyn_Binding_struct*)((struct Cyc_Absyn_Var_e_Absyn_Raw_exp_struct*)_Tmp0)->f1)->f1;{struct Cyc_Absyn_Vardecl*vd=_Tmp4;
# 67
struct _handler_cons _Tmp5;_push_handler(& _Tmp5);{int _Tmp6=0;if(setjmp(_Tmp5.handler))_Tmp6=1;if(!_Tmp6){
{struct Cyc_Set_Set*_Tmp7=({struct Cyc_Set_Set*(*_Tmp8)(struct Cyc_Set_Set*,struct Cyc_Absyn_Fndecl*)=({(struct Cyc_Set_Set*(*)(struct Cyc_Set_Set*,struct Cyc_Absyn_Fndecl*))Cyc_Set_insert;});struct Cyc_Set_Set*_Tmp9=s;_Tmp8(_Tmp9,({(struct Cyc_Absyn_Fndecl*(*)(struct Cyc_Hashtable_Table*,struct _tuple0*))Cyc_Hashtable_lookup;})(fds,vd->name));});_npop_handler(0);return _Tmp7;};_pop_handler();}else{void*_Tmp7=(void*)Cyc_Core_get_exn_thrown();void*_Tmp8=_Tmp7;void*_Tmp9;if(((struct Cyc_Core_Not_found_exn_struct*)_Tmp8)->tag == Cyc_Core_Not_found)
# 70
return s;else{_Tmp9=_Tmp8;{void*exn=_Tmp9;(int)_rethrow(exn);}};}}}default:
# 72
...
struct _tuple11*_stmttmp1=(struct _tuple11*)dles->hd;struct _tuple11*_Tmp5=_stmttmp1;void*_Tmp6;_Tmp6=_Tmp5->f2;{struct Cyc_Absyn_Exp*e=_Tmp6;
...
void*_stmttmp2=d->r;void*_Tmp0=_stmttmp2;void*_Tmp1;void*_Tmp2;switch(*((int*)_Tmp0)){case 0: _Tmp2=((struct Cyc_Absyn_Var_d_Absyn_Raw_decl_struct*)_Tmp0)->f1;{struct Cyc_Absyn_Vardecl*vd=_Tmp2;
# 121
...
void*_stmttmp3=stmt->r;void*_Tmp0=_stmttmp3;void*_Tmp1;void*_Tmp2;void*_Tmp3;void*_Tmp4;switch(*((int*)_Tmp0)){case 6:
...
void*_stmttmp4=((struct Cyc_Absyn_Decl*)ds->hd)->r;void*_Tmp1=_stmttmp4;void*_Tmp2;switch(*((int*)_Tmp1)){case 1: _Tmp2=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_Tmp1)->f1;{struct Cyc_Absyn_Fndecl*fd=_Tmp2;
# 177
cg=({struct Cyc_Dict_Dict(*_Tmp3)(struct Cyc_Dict_Dict,struct Cyc_Absyn_Fndecl*,struct Cyc_Set_Set*)=({(struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict,struct Cyc_Absyn_Fndecl*,struct Cyc_Set_Set*))Cyc_Graph_add_edges;});struct Cyc_Dict_Dict _Tmp4=cg;struct Cyc_Absyn_Fndecl*_Tmp5=fd;_Tmp3(_Tmp4,_Tmp5,Cyc_Callgraph_cg_stmt(fds,fd->body,mt));});
...
# 190
{struct Cyc_List_List*_Tmp0=ds;struct Cyc_List_List*ds=_Tmp0;for(0;ds != 0;ds=ds->tl){
void*_stmttmp5=((struct Cyc_Absyn_Decl*)ds->hd)->r;void*_Tmp1=_stmttmp5;void*_Tmp2;switch(*((int*)_Tmp1)){case 1: _Tmp2=((struct Cyc_Absyn_Fn_d_Absyn_Raw_decl_struct*)_Tmp1)->f1;{struct Cyc_Absyn_Fndecl*f=_Tmp2;
# 193
