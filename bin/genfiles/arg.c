...
_tmp4 <= _get_dyneither_size(s,sizeof(char))?0:({struct _dyneither_ptr _tmp65=({const char*_tmp5="len <= numelts(s)";_tag_dyneither(_tmp5,sizeof(char),18);});((int(*)(struct _dyneither_ptr assertion,struct _dyneither_ptr file,unsigned int line))Cyc___assert_fail)(_tmp65,({const char*_tmp6="arg.cyc";_tag_dyneither(_tmp6,sizeof(char),8);}),93);});
if(howmuch > _tmp4){
...
# 166
({struct Cyc_String_pa_PrintArg_struct _tmp19;_tmp19.tag=0;_tmp19.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)errmsg);({void*_tmp17[1]={& _tmp19};({struct Cyc___cycFILE*_tmp6E=Cyc_stderr;struct _dyneither_ptr _tmp6D=({const char*_tmp18="%s\n";_tag_dyneither(_tmp18,sizeof(char),4);});Cyc_fprintf(_tmp6E,_tmp6D,_tag_dyneither(_tmp17,sizeof(void*),1));});});});{
...
# 174
({struct Cyc_String_pa_PrintArg_struct _tmp1D;_tmp1D.tag=0;({struct _dyneither_ptr _tmp71=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Buffer_contents(_tmp1A));_tmp1D.f1=_tmp71;});({void*_tmp1B[1]={& _tmp1D};({struct Cyc___cycFILE*_tmp73=Cyc_stderr;struct _dyneither_ptr _tmp72=({const char*_tmp1C="%s";_tag_dyneither(_tmp1C,sizeof(char),3);});Cyc_fprintf(_tmp73,_tmp72,_tag_dyneither(_tmp1B,sizeof(void*),1));});});});};}
# 177
...
# 190
({struct Cyc_String_pa_PrintArg_struct _tmp27;_tmp27.tag=0;_tmp27.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp33);({struct Cyc_String_pa_PrintArg_struct _tmp26;_tmp26.tag=0;_tmp26.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)progname);({void*_tmp24[2]={& _tmp26,& _tmp27};({struct Cyc___cycFILE*_tmp78=Cyc_stderr;struct _dyneither_ptr _tmp77=({const char*_tmp25="%s: option `%s' needs an argument.\n";_tag_dyneither(_tmp25,sizeof(char),36);});Cyc_fprintf(_tmp78,_tmp77,_tag_dyneither(_tmp24,sizeof(void*),2));});});});});
...
# 193
({struct Cyc_String_pa_PrintArg_struct _tmp2D;_tmp2D.tag=0;_tmp2D.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp34);({struct Cyc_String_pa_PrintArg_struct _tmp2C;_tmp2C.tag=0;_tmp2C.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp36);({struct Cyc_String_pa_PrintArg_struct _tmp2B;_tmp2B.tag=0;_tmp2B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp35);({struct Cyc_String_pa_PrintArg_struct _tmp2A;_tmp2A.tag=0;_tmp2A.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)progname);({void*_tmp28[4]={& _tmp2A,& _tmp2B,& _tmp2C,& _tmp2D};({struct Cyc___cycFILE*_tmp7A=Cyc_stderr;struct _dyneither_ptr _tmp79=({const char*_tmp29="%s: wrong argument `%s'; option `%s' expects %s.\n";_tag_dyneither(_tmp29,sizeof(char),50);});Cyc_fprintf(_tmp7A,_tmp79,_tag_dyneither(_tmp28,sizeof(void*),4));});});});});});});
# 195
goto _LL0;default: _LL7: _tmp37=((struct Cyc_Arg_Message_Arg_error_struct*)_tmp1E)->f1;_LL8:
# 197
({struct Cyc_String_pa_PrintArg_struct _tmp31;_tmp31.tag=0;_tmp31.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)_tmp37);({struct Cyc_String_pa_PrintArg_struct _tmp30;_tmp30.tag=0;_tmp30.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)progname);({void*_tmp2E[2]={& _tmp30,& _tmp31};({struct Cyc___cycFILE*_tmp7C=Cyc_stderr;struct _dyneither_ptr _tmp7B=({const char*_tmp2F="%s: %s.\n";_tag_dyneither(_tmp2F,sizeof(char),9);});Cyc_fprintf(_tmp7C,_tmp7B,_tag_dyneither(_tmp2E,sizeof(void*),2));});});});});
goto _LL0;}_LL0:;}
# 200
...
void*action;
{struct _handler_cons _tmp39;_push_handler(& _tmp39);{int _tmp3B=0;if(setjmp(_tmp39.handler))_tmp3B=1;if(!_tmp3B){({void*_tmp7F=Cyc_Arg_lookup(speclist,s);action=_tmp7F;});;_pop_handler();}else{void*_tmp3A=(void*)_exn_thrown;void*_tmp3C=_tmp3A;void*_tmp3F;if(((struct Cyc_Core_Not_found_exn_struct*)_tmp3C)->tag == Cyc_Core_Not_found){_LLA: _LLB:
# 224
 if(!anonflagfun(s)){
({int _tmp83=initpos;void*_tmp82=(void*)({struct Cyc_Arg_Unknown_Arg_error_struct*_tmp3D=_cycalloc(sizeof(*_tmp3D));({struct Cyc_Arg_Unknown_Arg_error_struct _tmp80=({struct Cyc_Arg_Unknown_Arg_error_struct _tmp3E;_tmp3E.tag=0;_tmp3E.f1=s;_tmp3E;});_tmp3D[0]=_tmp80;});_tmp3D;});struct Cyc_List_List*_tmp81=speclist;Cyc_Arg_stop(_tmp83,_tmp82,_tmp81,errmsg);});
return;}else{
# 229
++ Cyc_Arg_current;
...
# 244
({int _tmp87=initpos;void*_tmp86=(void*)({struct Cyc_Arg_Missing_Arg_error_struct*_tmp44=_cycalloc(sizeof(*_tmp44));({struct Cyc_Arg_Missing_Arg_error_struct _tmp84=({struct Cyc_Arg_Missing_Arg_error_struct _tmp45;_tmp45.tag=1;_tmp45.f1=s;_tmp45;});_tmp44[0]=_tmp84;});_tmp44;});struct Cyc_List_List*_tmp85=speclist;Cyc_Arg_stop(_tmp87,_tmp86,_tmp85,errmsg);});}
...
++ Cyc_Arg_current;}else{
# 251
({int _tmp8B=initpos;void*_tmp8A=(void*)({struct Cyc_Arg_Missing_Arg_error_struct*_tmp46=_cycalloc(sizeof(*_tmp46));({struct Cyc_Arg_Missing_Arg_error_struct _tmp88=({struct Cyc_Arg_Missing_Arg_error_struct _tmp47;_tmp47.tag=1;_tmp47.f1=s;_tmp47;});_tmp46[0]=_tmp88;});_tmp46;});struct Cyc_List_List*_tmp89=speclist;Cyc_Arg_stop(_tmp8B,_tmp8A,_tmp89,errmsg);});}
...
# 271
({int _tmp96=initpos;void*_tmp95=(void*)({struct Cyc_Arg_Message_Arg_error_struct*_tmp57=_cycalloc(sizeof(*_tmp57));({struct Cyc_Arg_Message_Arg_error_struct _tmp93=({struct Cyc_Arg_Message_Arg_error_struct _tmp58;_tmp58.tag=2;_tmp58.f1=_tmp59;_tmp58;});_tmp57[0]=_tmp93;});_tmp57;});struct Cyc_List_List*_tmp94=speclist;Cyc_Arg_stop(_tmp96,_tmp95,_tmp94,errmsg);});goto _LL1F;}else{_LL22: _tmp5A=_tmp56;_LL23:(int)_rethrow(_tmp5A);}_LL1F:;}};}
# 273
++ Cyc_Arg_current;}else{
# 276
...
# 278
({int _tmp9A=initpos;void*_tmp99=(void*)({struct Cyc_Arg_Message_Arg_error_struct*_tmp5F=_cycalloc(sizeof(*_tmp5F));({struct Cyc_Arg_Message_Arg_error_struct _tmp97=({struct Cyc_Arg_Message_Arg_error_struct _tmp60;_tmp60.tag=2;_tmp60.f1=_tmp61;_tmp60;});_tmp5F[0]=_tmp97;});_tmp5F;});struct Cyc_List_List*_tmp98=speclist;Cyc_Arg_stop(_tmp9A,_tmp99,_tmp98,errmsg);});goto _LL24;}else{_LL27: _tmp62=_tmp5E;_LL28:(int)_rethrow(_tmp62);}_LL24:;}};}
# 280
++ Cyc_Arg_current;}}};}
