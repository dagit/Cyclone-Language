...
e2->topt=e1->topt;{
# 256
void*t=e2->topt == 0?(void*)({struct Cyc_Absyn_TypeofType_Absyn_Type_struct*_tmp4A=_cycalloc(sizeof(*_tmp4A));_tmp4A->tag=11,_tmp4A->f1=e2;_tmp4A;}): Cyc_Toc_typ_to_c(_check_null(e2->topt));
...
if(vd->initializer != 0){
# 374
void*_tmp5E=(_check_null(vd->initializer))->r;void*_stmttmpA=_tmp5E;void*_tmp5F=_stmttmpA;void*_tmp60;if(*((int*)_tmp5F)== 36){_tmp60=((struct Cyc_Absyn_UnresolvedMem_e_Absyn_Raw_exp_struct*)_tmp5F)->f2;{struct Cyc_List_List*dles=_tmp60;
# 387 "toseqc.cyc"
struct Cyc_Absyn_Stmt*_tmp61=({struct Cyc_Absyn_Exp*_tmp9B=_check_null(vd->initializer);Cyc_Toseqc_exps_to_seqc(_tmp9B,
...
# 398
{void*_tmp65=(_check_null(vd->initializer))->r;void*_stmttmpC=_tmp65;void*_tmp66=_stmttmpC;void*_tmp67;if(*((int*)_tmp66)== 37){_tmp67=((struct Cyc_Absyn_StmtExp_e_Absyn_Raw_exp_struct*)_tmp66)->f1;{struct Cyc_Absyn_Stmt*s3=_tmp67;
# 400
...
_check_null(vd->initializer);_tmp87;});struct Cyc_Warn_String_Warn_Warg_struct _tmp6B=({struct Cyc_Warn_String_Warn_Warg_struct _tmp86;_tmp86.tag=0,({struct _fat_ptr _tmp9D=({const char*_tmp6C="|";_tag_fat(_tmp6C,sizeof(char),2U);});_tmp86.f1=_tmp9D;});_tmp86;});void*_tmp68[3];_tmp68[0]=& _tmp69,_tmp68[1]=& _tmp6A,_tmp68[2]=& _tmp6B;({
# 405
