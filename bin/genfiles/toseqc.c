...
# 280
void*t=_tmp5C->topt == 0?(void*)({struct Cyc_Absyn_TypeofType_Absyn_Type_struct*_tmp5D=_cycalloc(sizeof(*_tmp5D));_tmp5D->tag=27U,_tmp5D->f1=_tmp5C;_tmp5D;}): Cyc_Toc_typ_to_c((void*)_check_null(_tmp5C->topt));
# 284
