...
_tmp326;void*_tmp325[1];struct Cyc_String_pa_struct _tmp324;(_tmp324.tag=0,((
_tmp324.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)msg),((_tmp325[0]=&
_tmp324,Cyc_fprintf(Cyc_stderr,((_tmp326="Internal error in tcenv: %s\n",
...
_RegionHandle*r){struct Cyc_Tcenv_Genv*_tmp327;return(_tmp327=_region_malloc(r,
sizeof(*_tmp327)),((_tmp327->grgn=r,((_tmp327->namespaces=((struct Cyc_Set_Set*(*)(
struct _RegionHandle*r,int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))
Cyc_Set_rempty)(r,Cyc_strptrcmp),((_tmp327->aggrdecls=((struct Cyc_Dict_Dict(*)(
struct _RegionHandle*,int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_rempty)(
r,Cyc_strptrcmp),((_tmp327->datatypedecls=((struct Cyc_Dict_Dict(*)(struct
_RegionHandle*,int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_rempty)(
r,Cyc_strptrcmp),((_tmp327->enumdecls=((struct Cyc_Dict_Dict(*)(struct
_RegionHandle*,int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_rempty)(
r,Cyc_strptrcmp),((_tmp327->typedefs=((struct Cyc_Dict_Dict(*)(struct
_RegionHandle*,int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_rempty)(
r,Cyc_strptrcmp),((_tmp327->ordinaries=((struct Cyc_Dict_Dict(*)(struct
_RegionHandle*,int(*cmp)(struct _dyneither_ptr*,struct _dyneither_ptr*)))Cyc_Dict_rempty)(
r,Cyc_strptrcmp),((_tmp327->availables=0,_tmp327)))))))))))))))));}struct
...
struct Cyc_Core_Opt*_tmp328;Cyc_Tcutil_empty_var_set=((_tmp328=_cycalloc(sizeof(*
_tmp328)),((_tmp328->v=((struct Cyc_Set_Set*(*)(int(*cmp)(struct _dyneither_ptr*,
struct _dyneither_ptr*)))Cyc_Set_empty)(Cyc_strptrcmp),_tmp328))));}{struct Cyc_Tcenv_Genv*
_tmpA=Cyc_Tcenv_empty_genv(r);{struct Cyc_Absyn_Datatypedecl**_tmp329;_tmpA->datatypedecls=((
struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k,struct Cyc_Absyn_Datatypedecl**
v))Cyc_Dict_insert)(_tmpA->datatypedecls,(*Cyc_Absyn_exn_name).f2,((_tmp329=
_cycalloc(sizeof(*_tmp329)),((_tmp329[0]=Cyc_Absyn_exn_tud,_tmp329)))));}{struct
Cyc_List_List*_tmpC=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(Cyc_Absyn_exn_tud->fields))->v;
for(0;_tmpC != 0;_tmpC=_tmpC->tl){struct Cyc_Tcenv_DatatypeRes_struct*_tmp32F;
struct Cyc_Tcenv_DatatypeRes_struct _tmp32E;struct _tuple11*_tmp32D;_tmpA->ordinaries=((
...
_tmpC->hd)->name).f2,((_tmp32D=_region_malloc(r,sizeof(*_tmp32D)),((_tmp32D->f1=(
void*)((_tmp32F=_cycalloc(sizeof(*_tmp32F)),((_tmp32F[0]=((_tmp32E.tag=2,((
_tmp32E.f1=Cyc_Absyn_exn_tud,((_tmp32E.f2=(struct Cyc_Absyn_Datatypefield*)_tmpC->hd,
_tmp32E)))))),_tmp32F)))),((_tmp32D->f2=1,_tmp32D)))))));}}{struct Cyc_Dict_Dict
...
0,_tmpA);struct Cyc_Tcenv_Tenv*_tmp330;return(_tmp330=_region_malloc(r,sizeof(*
_tmp330)),((_tmp330->ns=0,((_tmp330->ae=ae,((_tmp330->le=0,((_tmp330->allow_valueof=
0,_tmp330)))))))));};};}static struct Cyc_Tcenv_Genv*Cyc_Tcenv_lookup_namespace(
...
if(ns == 0){const char*_tmp331;return((struct Cyc_List_List*(*)(struct
...
te,struct Cyc_Position_Segment*loc,void*(*lookup)(struct Cyc_Tcenv_Genv*,struct
_dyneither_ptr*),struct _dyneither_ptr*v))Cyc_Tcenv_scoped_lookup)(te,loc,Cyc_Tcenv_lookup_ordinary_global_f,
...
struct Cyc_Tcenv_Tenv*te,struct Cyc_Position_Segment*loc,struct _dyneither_ptr*n,
struct Cyc_List_List*ns);struct Cyc_List_List*Cyc_Tcenv_resolve_namespace(struct
Cyc_Tcenv_Tenv*te,struct Cyc_Position_Segment*loc,struct _dyneither_ptr*n,struct
Cyc_List_List*ns){struct Cyc_List_List*_tmp3B=te->ns;struct _RegionHandle*_tmp3C=
Cyc_Tcenv_get_fnrgn(te);struct Cyc_List_List*_tmp3D=0;while(1){struct Cyc_Tcenv_Genv*
...
ge,struct _dyneither_ptr*v);static struct Cyc_Absyn_Aggrdecl**Cyc_Tcenv_lookup_aggrdecl_f(
struct Cyc_Tcenv_Genv*ge,struct _dyneither_ptr*v){struct Cyc_Dict_Dict _tmp4C=ge->aggrdecls;
return((struct Cyc_Absyn_Aggrdecl**(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*
k))Cyc_Dict_lookup)(_tmp4C,v);}struct Cyc_Absyn_Aggrdecl**Cyc_Tcenv_lookup_aggrdecl(
...
loc,struct _tuple0*q){struct _tuple0 _tmp4E;union Cyc_Absyn_Nmspace _tmp4F;struct
_dyneither_ptr*_tmp50;struct _tuple0*_tmp4D=q;_tmp4E=*_tmp4D;_tmp4F=_tmp4E.f1;
_tmp50=_tmp4E.f2;{union Cyc_Absyn_Nmspace _tmp51=_tmp4F;int _tmp52;struct Cyc_List_List*
_tmp53;struct Cyc_List_List*_tmp54;struct Cyc_List_List*_tmp55;struct Cyc_List_List*
_tmp56;struct Cyc_List_List _tmp57;struct _dyneither_ptr*_tmp58;struct Cyc_List_List*
_tmp59;_LL1B: if((_tmp51.Loc_n).tag != 4)goto _LL1D;_tmp52=(int)(_tmp51.Loc_n).val;
_LL1C: goto _LL1E;_LL1D: if((_tmp51.Rel_n).tag != 1)goto _LL1F;_tmp53=(struct Cyc_List_List*)(
_tmp51.Rel_n).val;if(_tmp53 != 0)goto _LL1F;_LL1E: return((struct Cyc_Absyn_Aggrdecl**(*)(
...
te,loc,Cyc_Tcenv_lookup_aggrdecl_f,_tmp50);_LL1F: if((_tmp51.C_n).tag != 3)goto
_LL21;_tmp54=(struct Cyc_List_List*)(_tmp51.C_n).val;_LL20: _tmp55=_tmp54;goto
_LL22;_LL21: if((_tmp51.Abs_n).tag != 2)goto _LL23;_tmp55=(struct Cyc_List_List*)(
_tmp51.Abs_n).val;_LL22: {struct Cyc_Dict_Dict _tmp5A=(((struct Cyc_Tcenv_Genv*(*)(
struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(te->ae,_tmp55))->aggrdecls;
return((struct Cyc_Absyn_Aggrdecl**(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*
k))Cyc_Dict_lookup)(_tmp5A,_tmp50);}_LL23: if((_tmp51.Rel_n).tag != 1)goto _LL1A;
_tmp56=(struct Cyc_List_List*)(_tmp51.Rel_n).val;if(_tmp56 == 0)goto _LL1A;_tmp57=*
_tmp56;_tmp58=(struct _dyneither_ptr*)_tmp57.hd;_tmp59=_tmp57.tl;_LL24: {struct
Cyc_Dict_Dict _tmp5B=(Cyc_Tcenv_lookup_namespace(te,loc,_tmp58,_tmp59))->aggrdecls;
return((struct Cyc_Absyn_Aggrdecl**(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*
k))Cyc_Dict_lookup)(_tmp5B,_tmp50);}_LL1A:;};}static struct Cyc_Absyn_Datatypedecl**
...
struct Cyc_Position_Segment*loc,struct _tuple0*q){struct _tuple0 _tmp5E;union Cyc_Absyn_Nmspace
_tmp5F;struct _dyneither_ptr*_tmp60;struct _tuple0*_tmp5D=q;_tmp5E=*_tmp5D;_tmp5F=
_tmp5E.f1;_tmp60=_tmp5E.f2;{union Cyc_Absyn_Nmspace _tmp61=_tmp5F;int _tmp62;struct
Cyc_List_List*_tmp63;struct Cyc_List_List*_tmp64;struct Cyc_List_List _tmp65;struct
_dyneither_ptr*_tmp66;struct Cyc_List_List*_tmp67;struct Cyc_List_List*_tmp68;
struct Cyc_List_List*_tmp69;_LL26: if((_tmp61.Loc_n).tag != 4)goto _LL28;_tmp62=(int)(
_tmp61.Loc_n).val;_LL27: goto _LL29;_LL28: if((_tmp61.Rel_n).tag != 1)goto _LL2A;
_tmp63=(struct Cyc_List_List*)(_tmp61.Rel_n).val;if(_tmp63 != 0)goto _LL2A;_LL29:
...
_tmp60);_LL2A: if((_tmp61.Rel_n).tag != 1)goto _LL2C;_tmp64=(struct Cyc_List_List*)(
_tmp61.Rel_n).val;if(_tmp64 == 0)goto _LL2C;_tmp65=*_tmp64;_tmp66=(struct
_dyneither_ptr*)_tmp65.hd;_tmp67=_tmp65.tl;_LL2B: {struct Cyc_Dict_Dict _tmp6A=(
Cyc_Tcenv_lookup_namespace(te,loc,_tmp66,_tmp67))->datatypedecls;return((struct
Cyc_Absyn_Datatypedecl**(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(
_tmp6A,_tmp60);}_LL2C: if((_tmp61.C_n).tag != 3)goto _LL2E;_tmp68=(struct Cyc_List_List*)(
_tmp61.C_n).val;_LL2D: _tmp69=_tmp68;goto _LL2F;_LL2E: if((_tmp61.Abs_n).tag != 2)
goto _LL25;_tmp69=(struct Cyc_List_List*)(_tmp61.Abs_n).val;_LL2F: {struct Cyc_Dict_Dict
_tmp6B=(((struct Cyc_Tcenv_Genv*(*)(struct Cyc_Dict_Dict d,struct Cyc_List_List*k))
Cyc_Dict_lookup)(te->ae,_tmp69))->datatypedecls;return((struct Cyc_Absyn_Datatypedecl**(*)(
struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmp6B,_tmp60);}
_LL25:;};}static struct Cyc_Absyn_Datatypedecl**Cyc_Tcenv_lookup_xdatatypedecl_f(
...
struct _dyneither_ptr*v);static struct Cyc_Absyn_Enumdecl**Cyc_Tcenv_lookup_enumdecl_f(
struct Cyc_Tcenv_Genv*ge,struct _dyneither_ptr*v){struct Cyc_Dict_Dict _tmp91=ge->enumdecls;
return((struct Cyc_Absyn_Enumdecl**(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*
k))Cyc_Dict_lookup)(_tmp91,v);}struct Cyc_Absyn_Enumdecl**Cyc_Tcenv_lookup_enumdecl(
struct Cyc_Tcenv_Tenv*te,struct Cyc_Position_Segment*loc,struct _tuple0*q);struct
Cyc_Absyn_Enumdecl**Cyc_Tcenv_lookup_enumdecl(struct Cyc_Tcenv_Tenv*te,struct Cyc_Position_Segment*
loc,struct _tuple0*q){struct _tuple0 _tmp93;union Cyc_Absyn_Nmspace _tmp94;struct
_dyneither_ptr*_tmp95;struct _tuple0*_tmp92=q;_tmp93=*_tmp92;_tmp94=_tmp93.f1;
_tmp95=_tmp93.f2;{union Cyc_Absyn_Nmspace _tmp96=_tmp94;int _tmp97;struct Cyc_List_List*
_tmp98;struct Cyc_List_List*_tmp99;struct Cyc_List_List _tmp9A;struct _dyneither_ptr*
_tmp9B;struct Cyc_List_List*_tmp9C;struct Cyc_List_List*_tmp9D;struct Cyc_List_List*
_tmp9E;_LL46: if((_tmp96.Loc_n).tag != 4)goto _LL48;_tmp97=(int)(_tmp96.Loc_n).val;
_LL47: goto _LL49;_LL48: if((_tmp96.Rel_n).tag != 1)goto _LL4A;_tmp98=(struct Cyc_List_List*)(
_tmp96.Rel_n).val;if(_tmp98 != 0)goto _LL4A;_LL49: return((struct Cyc_Absyn_Enumdecl**(*)(
struct Cyc_Tcenv_Tenv*te,struct Cyc_Position_Segment*loc,struct Cyc_Absyn_Enumdecl**(*
lookup)(struct Cyc_Tcenv_Genv*,struct _dyneither_ptr*),struct _dyneither_ptr*v))Cyc_Tcenv_scoped_lookup)(
te,loc,Cyc_Tcenv_lookup_enumdecl_f,_tmp95);_LL4A: if((_tmp96.Rel_n).tag != 1)goto
_LL4C;_tmp99=(struct Cyc_List_List*)(_tmp96.Rel_n).val;if(_tmp99 == 0)goto _LL4C;
_tmp9A=*_tmp99;_tmp9B=(struct _dyneither_ptr*)_tmp9A.hd;_tmp9C=_tmp9A.tl;_LL4B: {
struct Cyc_Dict_Dict _tmp9F=(Cyc_Tcenv_lookup_namespace(te,loc,_tmp9B,_tmp9C))->enumdecls;
return((struct Cyc_Absyn_Enumdecl**(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*
k))Cyc_Dict_lookup)(_tmp9F,_tmp95);}_LL4C: if((_tmp96.C_n).tag != 3)goto _LL4E;
_tmp9D=(struct Cyc_List_List*)(_tmp96.C_n).val;_LL4D: _tmp9E=_tmp9D;goto _LL4F;
_LL4E: if((_tmp96.Abs_n).tag != 2)goto _LL45;_tmp9E=(struct Cyc_List_List*)(_tmp96.Abs_n).val;
_LL4F: {struct Cyc_Dict_Dict _tmpA0=(((struct Cyc_Tcenv_Genv*(*)(struct Cyc_Dict_Dict
d,struct Cyc_List_List*k))Cyc_Dict_lookup)(te->ae,_tmp9E))->enumdecls;return((
struct Cyc_Absyn_Enumdecl**(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(
_tmpA0,_tmp95);}_LL45:;};}static struct Cyc_Absyn_Typedefdecl*Cyc_Tcenv_lookup_typedefdecl_f(
...
struct Cyc_Dict_Dict _tmpA1=ge->typedefs;return((struct Cyc_Absyn_Typedefdecl*(*)(
struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup)(_tmpA1,v);}struct
...
struct Cyc_Tcenv_Tenv*te,struct Cyc_Position_Segment*loc,struct _tuple0*q){struct
_tuple0 _tmpA3;union Cyc_Absyn_Nmspace _tmpA4;struct _dyneither_ptr*_tmpA5;struct
_tuple0*_tmpA2=q;_tmpA3=*_tmpA2;_tmpA4=_tmpA3.f1;_tmpA5=_tmpA3.f2;{union Cyc_Absyn_Nmspace
_tmpA6=_tmpA4;int _tmpA7;struct Cyc_List_List*_tmpA8;struct Cyc_List_List*_tmpA9;
struct Cyc_List_List _tmpAA;struct _dyneither_ptr*_tmpAB;struct Cyc_List_List*_tmpAC;
struct Cyc_List_List*_tmpAD;struct Cyc_List_List*_tmpAE;_LL51: if((_tmpA6.Loc_n).tag
!= 4)goto _LL53;_tmpA7=(int)(_tmpA6.Loc_n).val;_LL52: goto _LL54;_LL53: if((_tmpA6.Rel_n).tag
!= 1)goto _LL55;_tmpA8=(struct Cyc_List_List*)(_tmpA6.Rel_n).val;if(_tmpA8 != 0)
goto _LL55;_LL54: return((struct Cyc_Absyn_Typedefdecl*(*)(struct Cyc_Tcenv_Tenv*te,
...
Cyc_Tcenv_lookup_typedefdecl_f,_tmpA5);_LL55: if((_tmpA6.Rel_n).tag != 1)goto _LL57;
_tmpA9=(struct Cyc_List_List*)(_tmpA6.Rel_n).val;if(_tmpA9 == 0)goto _LL57;_tmpAA=*
_tmpA9;_tmpAB=(struct _dyneither_ptr*)_tmpAA.hd;_tmpAC=_tmpAA.tl;_LL56: {struct
Cyc_Dict_Dict _tmpAF=(Cyc_Tcenv_lookup_namespace(te,loc,_tmpAB,_tmpAC))->typedefs;
return((struct Cyc_Absyn_Typedefdecl*(*)(struct Cyc_Dict_Dict d,struct
_dyneither_ptr*k))Cyc_Dict_lookup)(_tmpAF,_tmpA5);}_LL57: if((_tmpA6.C_n).tag != 3)
goto _LL59;_tmpAD=(struct Cyc_List_List*)(_tmpA6.C_n).val;_LL58: _tmpAE=_tmpAD;goto
_LL5A;_LL59: if((_tmpA6.Abs_n).tag != 2)goto _LL50;_tmpAE=(struct Cyc_List_List*)(
_tmpA6.Abs_n).val;_LL5A: {struct Cyc_Dict_Dict _tmpB0=(((struct Cyc_Tcenv_Genv*(*)(
struct Cyc_Dict_Dict d,struct Cyc_List_List*k))Cyc_Dict_lookup)(te->ae,_tmpAE))->typedefs;
return((struct Cyc_Absyn_Typedefdecl*(*)(struct Cyc_Dict_Dict d,struct
_dyneither_ptr*k))Cyc_Dict_lookup)(_tmpB0,_tmpA5);}_LL50:;};}static struct Cyc_Tcenv_Fenv*
Cyc_Tcenv_get_fenv(struct Cyc_Tcenv_Tenv*te,struct _dyneither_ptr err_msg);static
...
struct _RegionHandle*Cyc_Tcenv_coerce_heap_region(){return(struct _RegionHandle*)
Cyc_Core_heap_region;}struct _RegionHandle*Cyc_Tcenv_get_fnrgn(struct Cyc_Tcenv_Tenv*
te);struct _RegionHandle*Cyc_Tcenv_get_fnrgn(struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Fenv*
_tmpB2=te->le;if(_tmpB2 != 0){struct Cyc_Tcenv_Fenv _tmpB4;struct _RegionHandle*
_tmpB5;struct Cyc_Tcenv_Fenv*_tmpB3=(struct Cyc_Tcenv_Fenv*)_tmpB2;_tmpB4=*_tmpB3;
_tmpB5=_tmpB4.fnrgn;return _tmpB5;}return Cyc_Tcenv_coerce_heap_region();}static
...
const char*_tmp352;((int(*)(struct _dyneither_ptr msg))Cyc_Tcenv_env_err)(((_tmp352="put_fenv",
_tag_dyneither(_tmp352,sizeof(char),9))));}{struct Cyc_Tcenv_Tenv*_tmp353;return(
_tmp353=_region_malloc(l,sizeof(*_tmp353)),((_tmp353->ns=te->ns,((_tmp353->ae=te->ae,((
_tmp353->le=(struct Cyc_Tcenv_Fenv*)fe,((_tmp353->allow_valueof=te->allow_valueof,
_tmp353)))))))));};}static struct Cyc_Tcenv_Tenv*Cyc_Tcenv_put_emptyfenv(struct
...
struct _RegionHandle*l,struct Cyc_Tcenv_Fenv*f){struct Cyc_Tcenv_SharedFenv*_tmpBA;
struct Cyc_List_List*_tmpBB;struct Cyc_RgnOrder_RgnPO*_tmpBC;struct Cyc_Tcenv_Bindings*
_tmpBD;struct Cyc_Absyn_Stmt*_tmpBE;struct Cyc_Tcenv_CtrlEnv*_tmpBF;void*_tmpC0;
void*_tmpC1;int _tmpC2;struct _RegionHandle*_tmpC3;struct Cyc_Tcenv_Fenv _tmpB9=*f;
_tmpBA=_tmpB9.shared;_tmpBB=_tmpB9.type_vars;_tmpBC=_tmpB9.region_order;_tmpBD=
_tmpB9.locals;_tmpBE=_tmpB9.encloser;_tmpBF=_tmpB9.ctrl_env;_tmpC0=_tmpB9.capability;
_tmpC1=_tmpB9.curr_rgn;_tmpC2=_tmpB9.in_notreadctxt;_tmpC3=_tmpB9.fnrgn;{struct
Cyc_Tcenv_Fenv*_tmp355;return(_tmp355=_region_malloc(l,sizeof(*_tmp355)),((
_tmp355->shared=(struct Cyc_Tcenv_SharedFenv*)_tmpBA,((_tmp355->type_vars=(struct
Cyc_List_List*)_tmpBB,((_tmp355->region_order=(struct Cyc_RgnOrder_RgnPO*)_tmpBC,((
_tmp355->locals=(struct Cyc_Tcenv_Bindings*)((struct Cyc_Tcenv_Bindings*)_tmpBD),((
...
struct Cyc_List_List*_tmpC7;struct Cyc_RgnOrder_RgnPO*_tmpC8;struct Cyc_Tcenv_Bindings*
...
_tmpC5.in_notreadctxt;{struct _RegionHandle*_tmpD0;void*_tmpD1;void*_tmpD2;struct
_tuple9*_tmpD3;void*_tmpD4;int _tmpD5;struct Cyc_Tcenv_CtrlEnv _tmpCF=*_tmpCB;
...
struct Cyc_Tcenv_Bindings*)((struct Cyc_Tcenv_Bindings*)_tmpC9),((_tmp357->encloser=(
struct Cyc_Absyn_Stmt*)_tmpCA,((_tmp357->ctrl_env=(struct Cyc_Tcenv_CtrlEnv*)
...
_tmpDB;struct Cyc_Tcenv_SharedFenv*_tmpDC;const char*_tmp358;struct Cyc_Tcenv_Fenv*
_tmpDA=Cyc_Tcenv_get_fenv(te,((_tmp358="return_typ",_tag_dyneither(_tmp358,
sizeof(char),11))));_tmpDB=*_tmpDA;_tmpDC=_tmpDB.shared;{void*_tmpDE;struct Cyc_Tcenv_SharedFenv
_tmpDD=*_tmpDC;_tmpDE=_tmpDD.return_typ;return _tmpDE;};}struct Cyc_List_List*Cyc_Tcenv_lookup_type_vars(
struct Cyc_Tcenv_Tenv*te);struct Cyc_List_List*Cyc_Tcenv_lookup_type_vars(struct
Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Fenv*_tmpDF=te->le;if(te->le == 0)return 0;{
struct Cyc_List_List*_tmpE1;struct Cyc_Tcenv_Fenv _tmpE0=*((struct Cyc_Tcenv_Fenv*)
_check_null(_tmpDF));_tmpE1=_tmpE0.type_vars;return _tmpE1;};}struct Cyc_Core_Opt*
...
struct Cyc_List_List*tvs){struct Cyc_Tcenv_Fenv _tmpE5;struct Cyc_Tcenv_SharedFenv*
_tmpE6;struct Cyc_List_List*_tmpE7;struct Cyc_RgnOrder_RgnPO*_tmpE8;struct Cyc_Tcenv_Bindings*
_tmpE9;struct Cyc_Absyn_Stmt*_tmpEA;struct Cyc_Tcenv_CtrlEnv*_tmpEB;void*_tmpEC;
void*_tmpED;int _tmpEE;const char*_tmp35A;struct Cyc_Tcenv_Fenv*_tmpE4=Cyc_Tcenv_get_fenv(
te,((_tmp35A="add_type_vars",_tag_dyneither(_tmp35A,sizeof(char),14))));_tmpE5=*
_tmpE4;_tmpE6=_tmpE5.shared;_tmpE7=_tmpE5.type_vars;_tmpE8=_tmpE5.region_order;
_tmpE9=_tmpE5.locals;_tmpEA=_tmpE5.encloser;_tmpEB=_tmpE5.ctrl_env;_tmpEC=_tmpE5.capability;
_tmpED=_tmpE5.curr_rgn;_tmpEE=_tmpE5.in_notreadctxt;Cyc_Tcutil_add_tvar_identities(
tvs);{struct Cyc_List_List*_tmpEF=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,
struct Cyc_List_List*y))Cyc_List_append)(tvs,_tmpE7);Cyc_Tcutil_check_unique_tvars(
loc,_tmpEF);{struct Cyc_Tcenv_Fenv*_tmp35B;struct Cyc_Tcenv_Fenv*_tmpF0=(_tmp35B=
_region_malloc(r,sizeof(*_tmp35B)),((_tmp35B->shared=(struct Cyc_Tcenv_SharedFenv*)
_tmpE6,((_tmp35B->type_vars=(struct Cyc_List_List*)_tmpEF,((_tmp35B->region_order=(
struct Cyc_RgnOrder_RgnPO*)_tmpE8,((_tmp35B->locals=(struct Cyc_Tcenv_Bindings*)((
struct Cyc_Tcenv_Bindings*)_tmpE9),((_tmp35B->encloser=(struct Cyc_Absyn_Stmt*)
...
te){struct Cyc_Tcenv_Fenv*_tmpF2=te->le;if(_tmpF2 == 0)return Cyc_Tcenv_put_emptyfenv(
...
vd){struct _dyneither_ptr*_tmpF3=(*vd->name).f2;{union Cyc_Absyn_Nmspace _tmpF4=(*
vd->name).f1;int _tmpF5;_LL5C: if((_tmpF4.Loc_n).tag != 4)goto _LL5E;_tmpF5=(int)(
_tmpF4.Loc_n).val;_LL5D: goto _LL5B;_LL5E:;_LL5F: {struct Cyc_Core_Impossible_struct
...
_tmpFE;struct Cyc_Tcenv_Bindings*_tmpFF;struct Cyc_Absyn_Stmt*_tmp100;struct Cyc_Tcenv_CtrlEnv*
_tmp101;void*_tmp102;void*_tmp103;int _tmp104;const char*_tmp362;struct Cyc_Tcenv_Fenv*
_tmpFA=Cyc_Tcenv_get_fenv(te,((_tmp362="add_local_var",_tag_dyneither(_tmp362,
sizeof(char),14))));_tmpFB=*_tmpFA;_tmpFC=_tmpFB.shared;_tmpFD=_tmpFB.type_vars;
_tmpFE=_tmpFB.region_order;_tmpFF=_tmpFB.locals;_tmp100=_tmpFB.encloser;_tmp101=
_tmpFB.ctrl_env;_tmp102=_tmpFB.capability;_tmp103=_tmpFB.curr_rgn;_tmp104=_tmpFB.in_notreadctxt;{
struct Cyc_Absyn_Local_b_struct*_tmp368;struct Cyc_Absyn_Local_b_struct _tmp367;
struct Cyc_Tcenv_Bindings*_tmp366;struct Cyc_Tcenv_Bindings*_tmp105=(_tmp366=
_region_malloc(r,sizeof(*_tmp366)),((_tmp366->v=_tmpF3,((_tmp366->b=(void*)((
_tmp368=_cycalloc(sizeof(*_tmp368)),((_tmp368[0]=((_tmp367.tag=4,((_tmp367.f1=vd,
_tmp367)))),_tmp368)))),((_tmp366->tl=(struct Cyc_Tcenv_Bindings*)_tmpFF,_tmp366)))))));
struct Cyc_Tcenv_Fenv*_tmp369;struct Cyc_Tcenv_Fenv*_tmp106=(_tmp369=
_region_malloc(r,sizeof(*_tmp369)),((_tmp369->shared=(struct Cyc_Tcenv_SharedFenv*)
_tmpFC,((_tmp369->type_vars=(struct Cyc_List_List*)_tmpFD,((_tmp369->region_order=(
struct Cyc_RgnOrder_RgnPO*)_tmpFE,((_tmp369->locals=(struct Cyc_Tcenv_Bindings*)
_tmp105,((_tmp369->encloser=(struct Cyc_Absyn_Stmt*)_tmp100,((_tmp369->ctrl_env=(
struct Cyc_Tcenv_CtrlEnv*)((struct Cyc_Tcenv_CtrlEnv*)_tmp101),((_tmp369->capability=(
void*)_tmp102,((_tmp369->curr_rgn=(void*)_tmp103,((_tmp369->in_notreadctxt=(int)
_tmp104,((_tmp369->fnrgn=(struct _RegionHandle*)r,_tmp369)))))))))))))))))))));
return Cyc_Tcenv_put_fenv(r,te,_tmp106);};};}struct Cyc_Tcenv_Tenv*Cyc_Tcenv_enter_notreadctxt(
struct _RegionHandle*r,struct Cyc_Tcenv_Tenv*te);struct Cyc_Tcenv_Tenv*Cyc_Tcenv_enter_notreadctxt(
struct _RegionHandle*r,struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Fenv*_tmp10B=te->le;
if(_tmp10B == 0)return Cyc_Tcenv_put_emptyfenv(r,te);{struct Cyc_Tcenv_SharedFenv*
_tmp10D;struct Cyc_List_List*_tmp10E;struct Cyc_RgnOrder_RgnPO*_tmp10F;struct Cyc_Tcenv_Bindings*
_tmp110;struct Cyc_Absyn_Stmt*_tmp111;struct Cyc_Tcenv_CtrlEnv*_tmp112;void*
_tmp113;void*_tmp114;int _tmp115;struct Cyc_Tcenv_Fenv _tmp10C=*_tmp10B;_tmp10D=
_tmp10C.shared;_tmp10E=_tmp10C.type_vars;_tmp10F=_tmp10C.region_order;_tmp110=
_tmp10C.locals;_tmp111=_tmp10C.encloser;_tmp112=_tmp10C.ctrl_env;_tmp113=_tmp10C.capability;
_tmp114=_tmp10C.curr_rgn;_tmp115=_tmp10C.in_notreadctxt;{struct Cyc_Tcenv_Fenv*
_tmp36A;struct Cyc_Tcenv_Fenv*_tmp116=(_tmp36A=_region_malloc(r,sizeof(*_tmp36A)),((
_tmp36A->shared=(struct Cyc_Tcenv_SharedFenv*)_tmp10D,((_tmp36A->type_vars=(
struct Cyc_List_List*)_tmp10E,((_tmp36A->region_order=(struct Cyc_RgnOrder_RgnPO*)
_tmp10F,((_tmp36A->locals=(struct Cyc_Tcenv_Bindings*)((struct Cyc_Tcenv_Bindings*)
_tmp110),((_tmp36A->encloser=(struct Cyc_Absyn_Stmt*)_tmp111,((_tmp36A->ctrl_env=(
struct Cyc_Tcenv_CtrlEnv*)((struct Cyc_Tcenv_CtrlEnv*)_tmp112),((_tmp36A->capability=(
void*)_tmp113,((_tmp36A->curr_rgn=(void*)_tmp114,((_tmp36A->in_notreadctxt=(int)
1,((_tmp36A->fnrgn=(struct _RegionHandle*)r,_tmp36A)))))))))))))))))))));return
Cyc_Tcenv_put_fenv(r,te,_tmp116);};};}struct Cyc_Tcenv_Tenv*Cyc_Tcenv_clear_notreadctxt(
...
_tmp11A;struct Cyc_List_List*_tmp11B;struct Cyc_RgnOrder_RgnPO*_tmp11C;struct Cyc_Tcenv_Bindings*
_tmp11D;struct Cyc_Absyn_Stmt*_tmp11E;struct Cyc_Tcenv_CtrlEnv*_tmp11F;void*
_tmp120;void*_tmp121;int _tmp122;struct Cyc_Tcenv_Fenv _tmp119=*_tmp118;_tmp11A=
_tmp119.shared;_tmp11B=_tmp119.type_vars;_tmp11C=_tmp119.region_order;_tmp11D=
_tmp119.locals;_tmp11E=_tmp119.encloser;_tmp11F=_tmp119.ctrl_env;_tmp120=_tmp119.capability;
_tmp121=_tmp119.curr_rgn;_tmp122=_tmp119.in_notreadctxt;{struct Cyc_Tcenv_Fenv*
_tmp36B;struct Cyc_Tcenv_Fenv*_tmp123=(_tmp36B=_region_malloc(r,sizeof(*_tmp36B)),((
_tmp36B->shared=(struct Cyc_Tcenv_SharedFenv*)_tmp11A,((_tmp36B->type_vars=(
struct Cyc_List_List*)_tmp11B,((_tmp36B->region_order=(struct Cyc_RgnOrder_RgnPO*)
_tmp11C,((_tmp36B->locals=(struct Cyc_Tcenv_Bindings*)((struct Cyc_Tcenv_Bindings*)
_tmp11D),((_tmp36B->encloser=(struct Cyc_Absyn_Stmt*)_tmp11E,((_tmp36B->ctrl_env=(
struct Cyc_Tcenv_CtrlEnv*)((struct Cyc_Tcenv_CtrlEnv*)_tmp11F),((_tmp36B->capability=(
void*)_tmp120,((_tmp36B->curr_rgn=(void*)_tmp121,((_tmp36B->in_notreadctxt=(int)
0,((_tmp36B->fnrgn=(struct _RegionHandle*)r,_tmp36B)))))))))))))))))))));return
Cyc_Tcenv_put_fenv(r,te,_tmp123);};};}int Cyc_Tcenv_in_notreadctxt(struct Cyc_Tcenv_Tenv*
te);int Cyc_Tcenv_in_notreadctxt(struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Fenv*
_tmp125=te->le;if(_tmp125 == 0)return 0;{struct Cyc_Tcenv_Fenv _tmp127;int _tmp128;
struct Cyc_Tcenv_Fenv*_tmp126=(struct Cyc_Tcenv_Fenv*)_tmp125;_tmp127=*_tmp126;
_tmp128=_tmp127.in_notreadctxt;return _tmp128;};}struct Cyc_Tcenv_Tenv*Cyc_Tcenv_add_pat_var(
struct _RegionHandle*r,struct Cyc_Position_Segment*loc,struct Cyc_Tcenv_Tenv*te,
struct Cyc_Absyn_Vardecl*vd);struct Cyc_Tcenv_Tenv*Cyc_Tcenv_add_pat_var(struct
_RegionHandle*r,struct Cyc_Position_Segment*loc,struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Vardecl*
vd){struct _dyneither_ptr*_tmp129=(*vd->name).f2;struct Cyc_Tcenv_Fenv _tmp12C;
struct Cyc_Tcenv_SharedFenv*_tmp12D;struct Cyc_List_List*_tmp12E;struct Cyc_RgnOrder_RgnPO*
_tmp12F;struct Cyc_Tcenv_Bindings*_tmp130;struct Cyc_Absyn_Stmt*_tmp131;struct Cyc_Tcenv_CtrlEnv*
...
_tmp371.f1=vd,_tmp371)))),_tmp372)))),((_tmp370->tl=(struct Cyc_Tcenv_Bindings*)
...
struct Cyc_RgnOrder_RgnPO*)_tmp12F,((_tmp373->locals=(struct Cyc_Tcenv_Bindings*)
_tmp136,((_tmp373->encloser=(struct Cyc_Absyn_Stmt*)_tmp131,((_tmp373->ctrl_env=(
struct Cyc_Tcenv_CtrlEnv*)((struct Cyc_Tcenv_CtrlEnv*)_tmp132),((_tmp373->capability=(
void*)_tmp133,((_tmp373->curr_rgn=(void*)_tmp134,((_tmp373->in_notreadctxt=(int)
_tmp135,((_tmp373->fnrgn=(struct _RegionHandle*)r,_tmp373)))))))))))))))))))));
return Cyc_Tcenv_put_fenv(r,te,_tmp137);};}void*Cyc_Tcenv_lookup_ordinary(struct
...
te,struct Cyc_Position_Segment*loc,struct _tuple0*q){struct Cyc_Tcenv_Fenv*_tmp13C=
te->le;struct _tuple0 _tmp13E;union Cyc_Absyn_Nmspace _tmp13F;struct _dyneither_ptr*
_tmp140;struct _tuple0*_tmp13D=q;_tmp13E=*_tmp13D;_tmp13F=_tmp13E.f1;_tmp140=
_tmp13E.f2;{union Cyc_Absyn_Nmspace _tmp141=_tmp13F;int _tmp142;struct Cyc_List_List*
_tmp143;_LL61: if((_tmp141.Loc_n).tag != 4)goto _LL63;_tmp142=(int)(_tmp141.Loc_n).val;
_LL62: if(_tmp13C == 0){struct Cyc_Dict_Absent_struct _tmp376;struct Cyc_Dict_Absent_struct*
_tmp375;(int)_throw((void*)((_tmp375=_cycalloc_atomic(sizeof(*_tmp375)),((
_tmp375[0]=((_tmp376.tag=Cyc_Dict_Absent,_tmp376)),_tmp375)))));}goto _LL64;_LL63:
if((_tmp141.Rel_n).tag != 1)goto _LL65;_tmp143=(struct Cyc_List_List*)(_tmp141.Rel_n).val;
if(_tmp143 != 0)goto _LL65;if(!(_tmp13C != 0))goto _LL65;_LL64: {struct Cyc_Tcenv_Fenv
_tmp147;struct Cyc_Tcenv_Bindings*_tmp148;struct Cyc_Tcenv_Fenv*_tmp146=(struct Cyc_Tcenv_Fenv*)
_tmp13C;_tmp147=*_tmp146;_tmp148=_tmp147.locals;{struct _handler_cons _tmp149;
_push_handler(& _tmp149);{int _tmp14B=0;if(setjmp(_tmp149.handler))_tmp14B=1;if(!
_tmp14B){{struct Cyc_Tcenv_VarRes_struct _tmp379;struct Cyc_Tcenv_VarRes_struct*
_tmp378;void*_tmp14E=(void*)((_tmp378=_region_malloc(r,sizeof(*_tmp378)),((
_tmp378[0]=((_tmp379.tag=0,((_tmp379.f1=(void*)Cyc_Tcenv_lookup_binding(_tmp148,
_tmp140),_tmp379)))),_tmp378))));_npop_handler(0);return _tmp14E;};_pop_handler();}
else{void*_tmp14A=(void*)_exn_thrown;void*_tmp150=_tmp14A;_LL68: {struct Cyc_Tcenv_NoBinding_struct*
...
Cyc_Absyn_Stmt**sopt){struct Cyc_Tcenv_Fenv _tmp15D;struct Cyc_Tcenv_CtrlEnv*
_tmp15E;const char*_tmp37D;struct Cyc_Tcenv_Fenv*_tmp15C=Cyc_Tcenv_get_fenv(te,((
_tmp37D="process_continue",_tag_dyneither(_tmp37D,sizeof(char),17))));_tmp15D=*
_tmp15C;_tmp15E=_tmp15D.ctrl_env;{void*_tmp15F=_tmp15E->continue_stmt;struct Cyc_Absyn_Stmt*
_tmp161;_LL72: {struct Cyc_Tcenv_Stmt_j_struct*_tmp160=(struct Cyc_Tcenv_Stmt_j_struct*)
_tmp15F;if(_tmp160->tag != 3)goto _LL74;else{_tmp161=_tmp160->f1;}}_LL73:{struct
Cyc_List_List*_tmp37E;_tmp161->non_local_preds=((_tmp37E=_cycalloc(sizeof(*
_tmp37E)),((_tmp37E->hd=s,((_tmp37E->tl=_tmp161->non_local_preds,_tmp37E))))));}*
sopt=(struct Cyc_Absyn_Stmt*)_tmp161;return;_LL74: {struct Cyc_Tcenv_NotLoop_j_struct*
_tmp162=(struct Cyc_Tcenv_NotLoop_j_struct*)_tmp15F;if(_tmp162->tag != 0)goto _LL76;}
_LL75:{const char*_tmp381;void*_tmp380;(_tmp380=0,Cyc_Tcutil_terr(s->loc,((
_tmp381="continue not in a loop",_tag_dyneither(_tmp381,sizeof(char),23))),
_tag_dyneither(_tmp380,sizeof(void*),0)));}return;_LL76: {struct Cyc_Tcenv_CaseEnd_j_struct*
_tmp163=(struct Cyc_Tcenv_CaseEnd_j_struct*)_tmp15F;if(_tmp163->tag != 1)goto _LL78;}
_LL77: goto _LL79;_LL78: {struct Cyc_Tcenv_FnEnd_j_struct*_tmp164=(struct Cyc_Tcenv_FnEnd_j_struct*)
_tmp15F;if(_tmp164->tag != 2)goto _LL71;}_LL79: {const char*_tmp382;((int(*)(struct
_dyneither_ptr msg))Cyc_Tcenv_env_err)(((_tmp382="bad continue destination",
_tag_dyneither(_tmp382,sizeof(char),25))));}_LL71:;};}void Cyc_Tcenv_process_break(
struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Stmt*s,struct Cyc_Absyn_Stmt**sopt);void
Cyc_Tcenv_process_break(struct Cyc_Tcenv_Tenv*te,struct Cyc_Absyn_Stmt*s,struct Cyc_Absyn_Stmt**
sopt){struct Cyc_Tcenv_Fenv _tmp16B;struct Cyc_Tcenv_CtrlEnv*_tmp16C;struct Cyc_Tcenv_SharedFenv*
_tmp16D;const char*_tmp383;struct Cyc_Tcenv_Fenv*_tmp16A=Cyc_Tcenv_get_fenv(te,((
_tmp383="process_break",_tag_dyneither(_tmp383,sizeof(char),14))));_tmp16B=*
_tmp16A;_tmp16C=_tmp16B.ctrl_env;_tmp16D=_tmp16B.shared;{void*_tmp16E=_tmp16C->break_stmt;
struct Cyc_Absyn_Stmt*_tmp170;_LL7B: {struct Cyc_Tcenv_Stmt_j_struct*_tmp16F=(
struct Cyc_Tcenv_Stmt_j_struct*)_tmp16E;if(_tmp16F->tag != 3)goto _LL7D;else{
_tmp170=_tmp16F->f1;}}_LL7C:{struct Cyc_List_List*_tmp384;_tmp170->non_local_preds=((
...
sopt){struct Cyc_Tcenv_Fenv _tmp184;struct Cyc_Tcenv_SharedFenv*_tmp185;const char*
_tmp391;struct Cyc_Tcenv_Fenv*_tmp183=Cyc_Tcenv_get_fenv(te,((_tmp391="process_goto",
_tag_dyneither(_tmp391,sizeof(char),13))));_tmp184=*_tmp183;_tmp185=_tmp184.shared;{
struct Cyc_Absyn_Stmt**sopt2=((struct Cyc_Absyn_Stmt**(*)(struct Cyc_Dict_Dict d,
struct _dyneither_ptr*k))Cyc_Dict_lookup_opt)(_tmp185->seen_labels,l);if(sopt2 == 
0){struct Cyc_Dict_Dict _tmp186=_tmp185->needed_labels;struct Cyc_List_List**slopt=((
struct Cyc_List_List**(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup_opt)(
_tmp186,l);struct _RegionHandle*frgn=_tmp185->frgn;if(slopt == 0){struct Cyc_List_List**
...
_tmp394))))));}*sopt=(struct Cyc_Absyn_Stmt*)s;}};}struct _tuple9*Cyc_Tcenv_process_fallthru(
...
_tmp18C;struct Cyc_Tcenv_CtrlEnv*_tmp18D;const char*_tmp395;struct Cyc_Tcenv_Fenv*
_tmp18B=Cyc_Tcenv_get_fenv(te,((_tmp395="process_fallthru",_tag_dyneither(
_tmp395,sizeof(char),17))));_tmp18C=*_tmp18B;_tmp18D=_tmp18C.ctrl_env;{struct
_tuple9*_tmp18E=(struct _tuple9*)_tmp18D->fallthru_clause;if(_tmp18E != 0){{struct
Cyc_List_List*_tmp396;(((*_tmp18E).f1)->body)->non_local_preds=((_tmp396=
_cycalloc(sizeof(*_tmp396)),((_tmp396->hd=s,((_tmp396->tl=(((*_tmp18E).f1)->body)->non_local_preds,
...
_tmp193;struct Cyc_Tcenv_SharedFenv*_tmp194;struct Cyc_List_List*_tmp195;struct Cyc_RgnOrder_RgnPO*
_tmp196;struct Cyc_Tcenv_Bindings*_tmp197;struct Cyc_Absyn_Stmt*_tmp198;struct Cyc_Tcenv_CtrlEnv*
...
_RegionHandle*_tmp19F;void*_tmp1A0;void*_tmp1A1;struct _tuple9*_tmp1A2;void*
...
struct Cyc_Tcenv_CList*_tmp1A6=(struct Cyc_Tcenv_CList*)((struct Cyc_List_List*(*)(
...
_tmp1A1,((_tmp39B->fallthru_clause=((_tmp39C=_region_malloc(_tmp19F,sizeof(*
_tmp39C)),((_tmp39C->f1=clause,((_tmp39C->f2=new_tvs,((_tmp39C->f3=_tmp1A6,
_tmp39C)))))))),((_tmp39B->next_stmt=_tmp1A3,((_tmp39B->try_depth=_tmp1A4,
_tmp39B)))))))))))));struct Cyc_Tcenv_Fenv*_tmp39D;struct Cyc_Tcenv_Fenv*_tmp1A8=(
...
struct Cyc_RgnOrder_RgnPO*)_tmp196,((_tmp39D->locals=(struct Cyc_Tcenv_Bindings*)((
struct Cyc_Tcenv_Bindings*)_tmp197),((_tmp39D->encloser=(struct Cyc_Absyn_Stmt*)
...
_tmp1AE=_tmp1AD.ctrl_env;_tmp1AE->fallthru_clause=0;return Cyc_Tcenv_put_fenv(r,
...
_tmp1B4;struct Cyc_RgnOrder_RgnPO*_tmp1B5;struct Cyc_Tcenv_Bindings*_tmp1B6;struct
Cyc_Absyn_Stmt*_tmp1B7;struct Cyc_Tcenv_CtrlEnv*_tmp1B8;void*_tmp1B9;void*_tmp1BA;
int _tmp1BB;const char*_tmp39F;struct Cyc_Tcenv_Fenv*_tmp1B1=Cyc_Tcenv_get_fenv(te,((
_tmp39F="set_in_loop",_tag_dyneither(_tmp39F,sizeof(char),12))));_tmp1B2=*
...
_tmp3A9)))),_tmp3AA)))),((_tmp3A6->fallthru_clause=(struct _tuple9*)_tmp1B8->fallthru_clause,((
...
_tmp1B5,((_tmp3AB->locals=(struct Cyc_Tcenv_Bindings*)((struct Cyc_Tcenv_Bindings*)
...
_RegionHandle*r,struct Cyc_Tcenv_Tenv*te){const char*_tmp3AC;struct Cyc_Tcenv_Fenv*
fe=Cyc_Tcenv_copy_fenv_new_ctrl(r,Cyc_Tcenv_get_fenv(te,((_tmp3AC="enter_try",
_tag_dyneither(_tmp3AC,sizeof(char),10)))));struct Cyc_Tcenv_Fenv _tmp1C3;struct
Cyc_Tcenv_CtrlEnv*_tmp1C4;struct Cyc_Tcenv_Fenv*_tmp1C2=fe;_tmp1C3=*_tmp1C2;
_tmp1C4=_tmp1C3.ctrl_env;++ _tmp1C4->try_depth;return Cyc_Tcenv_put_fenv(r,te,fe);}
int Cyc_Tcenv_get_try_depth(struct Cyc_Tcenv_Tenv*te);int Cyc_Tcenv_get_try_depth(
struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Fenv _tmp1C8;struct Cyc_Tcenv_CtrlEnv*
_tmp1C9;const char*_tmp3AD;struct Cyc_Tcenv_Fenv*_tmp1C7=Cyc_Tcenv_get_fenv(te,((
_tmp3AD="get_try_depth",_tag_dyneither(_tmp3AD,sizeof(char),14))));_tmp1C8=*
_tmp1C7;_tmp1C9=_tmp1C8.ctrl_env;return _tmp1C9->try_depth;}struct Cyc_Tcenv_Tenv*
...
_tmp3AE;struct Cyc_Tcenv_Fenv*fe=Cyc_Tcenv_copy_fenv_new_ctrl(r,Cyc_Tcenv_get_fenv(
te,((_tmp3AE="set_in_switch",_tag_dyneither(_tmp3AE,sizeof(char),14)))));struct
Cyc_Tcenv_Fenv _tmp1CB;struct Cyc_Tcenv_CtrlEnv*_tmp1CC;struct Cyc_Tcenv_Fenv*
_tmp1CA=fe;_tmp1CB=*_tmp1CA;_tmp1CC=_tmp1CB.ctrl_env;_tmp1CC->break_stmt=_tmp1CC->next_stmt;
_tmp1CC->next_stmt=(void*)& Cyc_Tcenv_CaseEnd_j_val;return Cyc_Tcenv_put_fenv(r,te,
...
Cyc_Tcenv_Tenv*te,void*j){struct Cyc_Tcenv_SharedFenv*_tmp1D0;struct Cyc_List_List*
_tmp1D1;struct Cyc_RgnOrder_RgnPO*_tmp1D2;struct Cyc_Tcenv_Bindings*_tmp1D3;struct
Cyc_Absyn_Stmt*_tmp1D4;struct Cyc_Tcenv_CtrlEnv*_tmp1D5;void*_tmp1D6;void*_tmp1D7;
int _tmp1D8;const char*_tmp3AF;struct Cyc_Tcenv_Fenv _tmp1CF=*Cyc_Tcenv_get_fenv(te,((
_tmp3AF="set_next",_tag_dyneither(_tmp3AF,sizeof(char),9))));_tmp1D0=_tmp1CF.shared;
_tmp1D1=_tmp1CF.type_vars;_tmp1D2=_tmp1CF.region_order;_tmp1D3=_tmp1CF.locals;
_tmp1D4=_tmp1CF.encloser;_tmp1D5=_tmp1CF.ctrl_env;_tmp1D6=_tmp1CF.capability;
_tmp1D7=_tmp1CF.curr_rgn;_tmp1D8=_tmp1CF.in_notreadctxt;{struct Cyc_Tcenv_CtrlEnv*
_tmp3B0;struct Cyc_Tcenv_CtrlEnv*new_cenv=(_tmp3B0=_region_malloc(r,sizeof(*
_tmp3B0)),((_tmp3B0->ctrl_rgn=r,((_tmp3B0->continue_stmt=(void*)_tmp1D5->continue_stmt,((
_tmp3B0->break_stmt=(void*)_tmp1D5->break_stmt,((_tmp3B0->next_stmt=j,((_tmp3B0->fallthru_clause=(
...
struct Cyc_RgnOrder_RgnPO*)_tmp1D2,((_tmp3B1->locals=(struct Cyc_Tcenv_Bindings*)((
struct Cyc_Tcenv_Bindings*)_tmp1D3),((_tmp3B1->encloser=(struct Cyc_Absyn_Stmt*)
...
s){struct Cyc_Tcenv_Fenv _tmp1DD;struct Cyc_Tcenv_SharedFenv*_tmp1DE;const char*
_tmp3B2;struct Cyc_Tcenv_Fenv*_tmp1DC=Cyc_Tcenv_get_fenv(te,((_tmp3B2="add_label",
_tag_dyneither(_tmp3B2,sizeof(char),10))));_tmp1DD=*_tmp1DC;_tmp1DE=_tmp1DD.shared;{
struct Cyc_Dict_Dict needed=_tmp1DE->needed_labels;struct Cyc_List_List**sl_opt=((
struct Cyc_List_List**(*)(struct Cyc_Dict_Dict d,struct _dyneither_ptr*k))Cyc_Dict_lookup_opt)(
needed,v);struct _RegionHandle*frgn=_tmp1DE->frgn;if(sl_opt != 0){_tmp1DE->needed_labels=((
...
struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Fenv _tmp1EA;struct Cyc_Tcenv_SharedFenv*
_tmp1EB;const char*_tmp3B8;struct Cyc_Tcenv_Fenv*_tmp1E9=Cyc_Tcenv_get_fenv(te,((
_tmp3B8="all_labels_resolved",_tag_dyneither(_tmp3B8,sizeof(char),20))));_tmp1EA=*
_tmp1E9;_tmp1EB=_tmp1EA.shared;return((int(*)(struct Cyc_Dict_Dict d))Cyc_Dict_is_empty)(
_tmp1EB->needed_labels);}struct Cyc_Absyn_Stmt*Cyc_Tcenv_get_encloser(struct Cyc_Tcenv_Tenv*
te);struct Cyc_Absyn_Stmt*Cyc_Tcenv_get_encloser(struct Cyc_Tcenv_Tenv*te){struct
Cyc_Tcenv_Fenv _tmp1EE;struct Cyc_Absyn_Stmt*_tmp1EF;const char*_tmp3B9;struct Cyc_Tcenv_Fenv*
...
Cyc_Tcenv_Tenv*te){if(te->le == 0){struct Cyc_Tcenv_Tenv*_tmp3BA;return(_tmp3BA=
_region_malloc(r2,sizeof(*_tmp3BA)),((_tmp3BA->ns=te->ns,((_tmp3BA->ae=te->ae,((
_tmp3BA->le=0,((_tmp3BA->allow_valueof=1,_tmp3BA)))))))));}{struct Cyc_Tcenv_SharedFenv*
_tmp1F2;struct Cyc_List_List*_tmp1F3;struct Cyc_RgnOrder_RgnPO*_tmp1F4;struct Cyc_Tcenv_Bindings*
...
struct Cyc_Tcenv_Bindings*)((struct Cyc_Tcenv_Bindings*)_tmp1F5),((_tmp3BB->encloser=(
struct Cyc_Absyn_Stmt*)_tmp1F6,((_tmp3BB->ctrl_env=(struct Cyc_Tcenv_CtrlEnv*)((
...
_tmp200;struct Cyc_List_List*_tmp201;struct Cyc_RgnOrder_RgnPO*_tmp202;struct Cyc_Tcenv_Bindings*
_tmp203;struct Cyc_Absyn_Stmt*_tmp204;struct Cyc_Tcenv_CtrlEnv*_tmp205;void*
_tmp206;void*_tmp207;int _tmp208;const char*_tmp3BD;struct Cyc_Tcenv_Fenv _tmp1FF=*
Cyc_Tcenv_get_fenv(te,((_tmp3BD="set_encloser",_tag_dyneither(_tmp3BD,sizeof(
char),13))));_tmp200=_tmp1FF.shared;_tmp201=_tmp1FF.type_vars;_tmp202=_tmp1FF.region_order;
_tmp203=_tmp1FF.locals;_tmp204=_tmp1FF.encloser;_tmp205=_tmp1FF.ctrl_env;_tmp206=
_tmp1FF.capability;_tmp207=_tmp1FF.curr_rgn;_tmp208=_tmp1FF.in_notreadctxt;{
struct Cyc_Tcenv_Fenv*_tmp3BE;struct Cyc_Tcenv_Fenv*_tmp209=(_tmp3BE=
_region_malloc(r,sizeof(*_tmp3BE)),((_tmp3BE->shared=(struct Cyc_Tcenv_SharedFenv*)
_tmp200,((_tmp3BE->type_vars=(struct Cyc_List_List*)_tmp201,((_tmp3BE->region_order=(
struct Cyc_RgnOrder_RgnPO*)_tmp202,((_tmp3BE->locals=(struct Cyc_Tcenv_Bindings*)((
struct Cyc_Tcenv_Bindings*)_tmp203),((_tmp3BE->encloser=(struct Cyc_Absyn_Stmt*)s,((
_tmp3BE->ctrl_env=(struct Cyc_Tcenv_CtrlEnv*)((struct Cyc_Tcenv_CtrlEnv*)_tmp205),((
_tmp3BE->capability=(void*)_tmp206,((_tmp3BE->curr_rgn=(void*)_tmp207,((_tmp3BE->in_notreadctxt=(
int)_tmp208,((_tmp3BE->fnrgn=(struct _RegionHandle*)r,_tmp3BE)))))))))))))))))))));
...
te,void*rgn,int resetable,int opened){struct Cyc_Absyn_Tvar*tv;{void*_tmp20B=Cyc_Tcutil_compress(
rgn);struct Cyc_Absyn_Tvar*_tmp20D;_LL94: {struct Cyc_Absyn_VarType_struct*_tmp20C=(
struct Cyc_Absyn_VarType_struct*)_tmp20B;if(_tmp20C->tag != 2)goto _LL96;else{
_tmp20D=_tmp20C->f1;}}_LL95: tv=_tmp20D;goto _LL93;_LL96:;_LL97:{const char*_tmp3BF;
tv=((struct Cyc_Absyn_Tvar*(*)(struct _dyneither_ptr msg))Cyc_Tcenv_env_err)(((
_tmp3BF="bad add region",_tag_dyneither(_tmp3BF,sizeof(char),15))));}goto _LL93;
_LL93:;}{struct Cyc_Tcenv_SharedFenv*_tmp211;struct Cyc_List_List*_tmp212;struct
Cyc_RgnOrder_RgnPO*_tmp213;struct Cyc_Tcenv_Bindings*_tmp214;struct Cyc_Absyn_Stmt*
_tmp215;struct Cyc_Tcenv_CtrlEnv*_tmp216;void*_tmp217;void*_tmp218;int _tmp219;
const char*_tmp3C0;struct Cyc_Tcenv_Fenv _tmp210=*Cyc_Tcenv_get_fenv(te,((_tmp3C0="add_region",
_tag_dyneither(_tmp3C0,sizeof(char),11))));_tmp211=_tmp210.shared;_tmp212=
...
_tmp210.curr_rgn;_tmp219=_tmp210.in_notreadctxt;_tmp213=Cyc_RgnOrder_add_youngest(
_tmp211->frgn,_tmp213,tv,resetable,opened);{struct Cyc_Absyn_JoinEff_struct
_tmp3D3;struct Cyc_List_List*_tmp3D2;struct Cyc_Absyn_AccessEff_struct*_tmp3D1;
struct Cyc_Absyn_AccessEff_struct _tmp3D0;struct Cyc_List_List*_tmp3CF;struct Cyc_Absyn_JoinEff_struct*
_tmp3CE;_tmp217=(void*)((_tmp3CE=_cycalloc(sizeof(*_tmp3CE)),((_tmp3CE[0]=((
_tmp3D3.tag=24,((_tmp3D3.f1=((_tmp3CF=_cycalloc(sizeof(*_tmp3CF)),((_tmp3CF->hd=(
void*)((_tmp3D1=_cycalloc(sizeof(*_tmp3D1)),((_tmp3D1[0]=((_tmp3D0.tag=23,((
_tmp3D0.f1=(void*)rgn,_tmp3D0)))),_tmp3D1)))),((_tmp3CF->tl=((_tmp3D2=_cycalloc(
sizeof(*_tmp3D2)),((_tmp3D2->hd=_tmp217,((_tmp3D2->tl=0,_tmp3D2)))))),_tmp3CF)))))),
...
struct Cyc_RgnOrder_RgnPO*)_tmp213,((_tmp3D4->locals=(struct Cyc_Tcenv_Bindings*)((
struct Cyc_Tcenv_Bindings*)_tmp214),((_tmp3D4->encloser=(struct Cyc_Absyn_Stmt*)
...
_tmp224;struct Cyc_List_List*_tmp225;struct Cyc_RgnOrder_RgnPO*_tmp226;struct Cyc_Tcenv_Bindings*
_tmp227;struct Cyc_Absyn_Stmt*_tmp228;struct Cyc_Tcenv_CtrlEnv*_tmp229;void*
_tmp22A;void*_tmp22B;int _tmp22C;const char*_tmp3D5;struct Cyc_Tcenv_Fenv _tmp223=*
Cyc_Tcenv_get_fenv(te,((_tmp3D5="new_named_block",_tag_dyneither(_tmp3D5,sizeof(
char),16))));_tmp224=_tmp223.shared;_tmp225=_tmp223.type_vars;_tmp226=_tmp223.region_order;
_tmp227=_tmp223.locals;_tmp228=_tmp223.encloser;_tmp229=_tmp223.ctrl_env;_tmp22A=
_tmp223.capability;_tmp22B=_tmp223.curr_rgn;_tmp22C=_tmp223.in_notreadctxt;{
const char*_tmp3D6;struct Cyc_Tcenv_Fenv*fe=Cyc_Tcenv_copy_fenv_old_ctrl(r,Cyc_Tcenv_get_fenv(
te,((_tmp3D6="new_block",_tag_dyneither(_tmp3D6,sizeof(char),10)))));struct Cyc_Absyn_VarType_struct
_tmp3D9;struct Cyc_Absyn_VarType_struct*_tmp3D8;void*block_typ=(void*)((_tmp3D8=
_cycalloc(sizeof(*_tmp3D8)),((_tmp3D8[0]=((_tmp3D9.tag=2,((_tmp3D9.f1=block_rgn,
_tmp3D9)))),_tmp3D8))));{struct Cyc_List_List*_tmp3DA;_tmp225=((_tmp3DA=_cycalloc(
sizeof(*_tmp3DA)),((_tmp3DA->hd=block_rgn,((_tmp3DA->tl=_tmp225,_tmp3DA))))));}
Cyc_Tcutil_check_unique_tvars(loc,_tmp225);_tmp226=Cyc_RgnOrder_add_youngest(
_tmp224->frgn,_tmp226,block_rgn,0,0);{struct Cyc_Absyn_JoinEff_struct _tmp3ED;
struct Cyc_List_List*_tmp3EC;struct Cyc_Absyn_AccessEff_struct*_tmp3EB;struct Cyc_Absyn_AccessEff_struct
_tmp3EA;struct Cyc_List_List*_tmp3E9;struct Cyc_Absyn_JoinEff_struct*_tmp3E8;
_tmp22A=(void*)((_tmp3E8=_cycalloc(sizeof(*_tmp3E8)),((_tmp3E8[0]=((_tmp3ED.tag=
24,((_tmp3ED.f1=((_tmp3E9=_cycalloc(sizeof(*_tmp3E9)),((_tmp3E9->hd=(void*)((
_tmp3EB=_cycalloc(sizeof(*_tmp3EB)),((_tmp3EB[0]=((_tmp3EA.tag=23,((_tmp3EA.f1=(
void*)block_typ,_tmp3EA)))),_tmp3EB)))),((_tmp3E9->tl=((_tmp3EC=_cycalloc(
sizeof(*_tmp3EC)),((_tmp3EC->hd=_tmp22A,((_tmp3EC->tl=0,_tmp3EC)))))),_tmp3E9)))))),
_tmp3ED)))),_tmp3E8))));}_tmp22B=block_typ;{struct Cyc_Tcenv_Fenv*_tmp3EE;struct
Cyc_Tcenv_Fenv*_tmp234=(_tmp3EE=_region_malloc(r,sizeof(*_tmp3EE)),((_tmp3EE->shared=(
struct Cyc_Tcenv_SharedFenv*)_tmp224,((_tmp3EE->type_vars=(struct Cyc_List_List*)
_tmp225,((_tmp3EE->region_order=(struct Cyc_RgnOrder_RgnPO*)_tmp226,((_tmp3EE->locals=(
struct Cyc_Tcenv_Bindings*)((struct Cyc_Tcenv_Bindings*)_tmp227),((_tmp3EE->encloser=(
struct Cyc_Absyn_Stmt*)_tmp228,((_tmp3EE->ctrl_env=(struct Cyc_Tcenv_CtrlEnv*)((
struct Cyc_Tcenv_CtrlEnv*)_tmp229),((_tmp3EE->capability=(void*)_tmp22A,((_tmp3EE->curr_rgn=(
void*)_tmp22B,((_tmp3EE->in_notreadctxt=(int)_tmp22C,((_tmp3EE->fnrgn=(struct
_RegionHandle*)r,_tmp3EE)))))))))))))))))))));return Cyc_Tcenv_put_fenv(r,te,
_tmp234);};};}static struct Cyc_Absyn_Eq_kb_struct Cyc_Tcenv_rgn_kb={0,& Cyc_Tcutil_rk};
...
struct Cyc_Tcenv_Tenv*Cyc_Tcenv_new_outlives_constraints(struct _RegionHandle*r,
struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List*cs,struct Cyc_Position_Segment*loc){
struct Cyc_Tcenv_SharedFenv*_tmp23C;struct Cyc_List_List*_tmp23D;struct Cyc_RgnOrder_RgnPO*
_tmp23E;struct Cyc_Tcenv_Bindings*_tmp23F;struct Cyc_Absyn_Stmt*_tmp240;struct Cyc_Tcenv_CtrlEnv*
_tmp241;void*_tmp242;void*_tmp243;int _tmp244;const char*_tmp3EF;struct Cyc_Tcenv_Fenv
_tmp23B=*Cyc_Tcenv_get_fenv(te,((_tmp3EF="new_outlives_constraints",
...
_tmp23E,((_tmp3F0->locals=(struct Cyc_Tcenv_Bindings*)((struct Cyc_Tcenv_Bindings*)
...
_tmp263=te->le;if(_tmp263 == 0)return(void*)& Cyc_Absyn_HeapRgn_val;{struct Cyc_Tcenv_Fenv*
fe=(struct Cyc_Tcenv_Fenv*)_tmp263;struct Cyc_Tcenv_Fenv _tmp265;void*_tmp266;
struct Cyc_Tcenv_Fenv*_tmp264=fe;_tmp265=*_tmp264;_tmp266=_tmp265.curr_rgn;return
_tmp266;};}void Cyc_Tcenv_check_rgn_accessible(struct Cyc_Tcenv_Tenv*te,struct Cyc_Position_Segment*
loc,void*rgn);void Cyc_Tcenv_check_rgn_accessible(struct Cyc_Tcenv_Tenv*te,struct
Cyc_Position_Segment*loc,void*rgn){const char*_tmp406;struct Cyc_Tcenv_Fenv*fe=Cyc_Tcenv_get_fenv(
te,((_tmp406="check_rgn_accessible",_tag_dyneither(_tmp406,sizeof(char),21))));
struct Cyc_Tcenv_Fenv _tmp268;void*_tmp269;struct Cyc_RgnOrder_RgnPO*_tmp26A;struct
Cyc_Tcenv_Fenv*_tmp267=fe;_tmp268=*_tmp267;_tmp269=_tmp268.capability;_tmp26A=
_tmp268.region_order;if(Cyc_Tcutil_region_in_effect(0,rgn,_tmp269) || Cyc_Tcutil_region_in_effect(
1,rgn,_tmp269))return;{struct Cyc_Absyn_AccessEff_struct _tmp409;struct Cyc_Absyn_AccessEff_struct*
_tmp408;if(Cyc_RgnOrder_eff_outlives_eff(_tmp26A,(void*)((_tmp408=_cycalloc(
sizeof(*_tmp408)),((_tmp408[0]=((_tmp409.tag=23,((_tmp409.f1=(void*)rgn,_tmp409)))),
_tmp408)))),_tmp269))return;}{const char*_tmp40D;void*_tmp40C[1];struct Cyc_String_pa_struct
_tmp40B;(_tmp40B.tag=0,((_tmp40B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(rgn)),((_tmp40C[0]=& _tmp40B,Cyc_Tcutil_terr(loc,((_tmp40D="Expression accesses unavailable region %s",
...
struct Cyc_Tcenv_Fenv _tmp273;struct Cyc_RgnOrder_RgnPO*_tmp274;const char*_tmp40E;
struct Cyc_Tcenv_Fenv*_tmp272=Cyc_Tcenv_get_fenv(te,((_tmp40E="check_rgn_resetable",
_tag_dyneither(_tmp40E,sizeof(char),20))));_tmp273=*_tmp272;_tmp274=_tmp273.region_order;{
void*_tmp275=Cyc_Tcutil_compress(rgn);struct Cyc_Absyn_Tvar*_tmp277;_LL99: {
struct Cyc_Absyn_VarType_struct*_tmp276=(struct Cyc_Absyn_VarType_struct*)_tmp275;
if(_tmp276->tag != 2)goto _LL9B;else{_tmp277=_tmp276->f1;}}_LL9A: if(!Cyc_RgnOrder_is_region_resetable(
_tmp274,_tmp277)){const char*_tmp412;void*_tmp411[1];struct Cyc_String_pa_struct
_tmp410;(_tmp410.tag=0,((_tmp410.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)
Cyc_Absynpp_typ2string(rgn)),((_tmp411[0]=& _tmp410,Cyc_Tcutil_terr(loc,((_tmp412="Region %s is not resetable",
...
struct Cyc_Tcenv_Fenv*_tmp27D=te->le;rt_a=Cyc_Tcutil_compress(rt_a);rt_b=Cyc_Tcutil_compress(
rt_b);if(_tmp27D == 0)return rt_a == (void*)& Cyc_Absyn_UniqueRgn_val  || rt_a == (
void*)& Cyc_Absyn_HeapRgn_val  && rt_b != (void*)& Cyc_Absyn_UniqueRgn_val;{struct
Cyc_Tcenv_Fenv*fe=(struct Cyc_Tcenv_Fenv*)_tmp27D;struct Cyc_Tcenv_Fenv _tmp27F;
struct Cyc_RgnOrder_RgnPO*_tmp280;struct Cyc_Tcenv_Fenv*_tmp27E=fe;_tmp27F=*
...
struct Cyc_Position_Segment*loc,void*eff){struct Cyc_Tcenv_Fenv _tmp286;void*
_tmp287;struct Cyc_RgnOrder_RgnPO*_tmp288;struct Cyc_Tcenv_SharedFenv*_tmp289;
const char*_tmp419;struct Cyc_Tcenv_Fenv*_tmp285=Cyc_Tcenv_get_fenv(te,((_tmp419="check_effect_accessible",
_tag_dyneither(_tmp419,sizeof(char),24))));_tmp286=*_tmp285;_tmp287=_tmp286.capability;
_tmp288=_tmp286.region_order;_tmp289=_tmp286.shared;if(Cyc_Tcutil_subset_effect(
0,eff,_tmp287))return;if(Cyc_RgnOrder_eff_outlives_eff(_tmp288,eff,_tmp287))
return;{struct _RegionHandle*frgn=_tmp289->frgn;struct _tuple13*_tmp41C;struct Cyc_List_List*
...
struct Cyc_Tcenv_Tenv*te){struct Cyc_Tcenv_Fenv _tmp28E;struct Cyc_Tcenv_SharedFenv*
_tmp28F;const char*_tmp41D;struct Cyc_Tcenv_Fenv*_tmp28D=Cyc_Tcenv_get_fenv(te,((
_tmp41D="check_delayed_effects",_tag_dyneither(_tmp41D,sizeof(char),22))));
_tmp28E=*_tmp28D;_tmp28F=_tmp28E.shared;{struct Cyc_List_List*_tmp290=_tmp28F->delayed_effect_checks;
for(0;_tmp290 != 0;_tmp290=_tmp290->tl){struct _tuple13 _tmp292;void*_tmp293;void*
_tmp294;struct Cyc_RgnOrder_RgnPO*_tmp295;struct Cyc_Position_Segment*_tmp296;
struct _tuple13*_tmp291=(struct _tuple13*)_tmp290->hd;_tmp292=*_tmp291;_tmp293=
_tmp292.f1;_tmp294=_tmp292.f2;_tmp295=_tmp292.f3;_tmp296=_tmp292.f4;if(Cyc_Tcutil_subset_effect(
1,_tmp294,_tmp293))continue;if(Cyc_RgnOrder_eff_outlives_eff(_tmp295,_tmp294,
_tmp293))continue;{const char*_tmp422;void*_tmp421[2];struct Cyc_String_pa_struct
_tmp420;struct Cyc_String_pa_struct _tmp41F;(_tmp41F.tag=0,((_tmp41F.f1=(struct
_dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp294)),((_tmp420.tag=
0,((_tmp420.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(
_tmp293)),((_tmp421[0]=& _tmp420,((_tmp421[1]=& _tmp41F,Cyc_Tcutil_terr(_tmp296,((
_tmp422="Capability \n%s\ndoes not cover function's effect\n%s",_tag_dyneither(
_tmp422,sizeof(char),51))),_tag_dyneither(_tmp421,sizeof(void*),2)))))))))))));};}};}
...
_tmp29B=te->le;if(_tmp29B == 0){for(0;po != 0;po=po->tl){struct Cyc_Absyn_AccessEff_struct
_tmp425;struct Cyc_Absyn_AccessEff_struct*_tmp424;if(!Cyc_Tcutil_subset_effect(1,(*((
struct _tuple12*)po->hd)).f1,Cyc_Absyn_empty_effect) || !Cyc_Tcutil_subset_effect(
1,(void*)((_tmp424=_cycalloc(sizeof(*_tmp424)),((_tmp424[0]=((_tmp425.tag=23,((
_tmp425.f1=(void*)(*((struct _tuple12*)po->hd)).f2,_tmp425)))),_tmp424)))),Cyc_Absyn_empty_effect)){
const char*_tmp428;void*_tmp427;(_tmp427=0,Cyc_Tcutil_terr(loc,((_tmp428="the required region ordering is not satisfied here",
...
te){struct Cyc_Tcenv_Fenv _tmp2A8;struct Cyc_Tcenv_SharedFenv*_tmp2A9;const char*
_tmp42C;struct Cyc_Tcenv_Fenv*_tmp2A7=Cyc_Tcenv_get_fenv(te,((_tmp42C="check_delayed_constraints",
_tag_dyneither(_tmp42C,sizeof(char),26))));_tmp2A8=*_tmp2A7;_tmp2A9=_tmp2A8.shared;{
struct Cyc_List_List*_tmp2AA=_tmp2A9->delayed_constraint_checks;for(0;_tmp2AA != 0;
_tmp2AA=_tmp2AA->tl){struct _tuple14 _tmp2AC;struct Cyc_RgnOrder_RgnPO*_tmp2AD;
struct Cyc_List_List*_tmp2AE;struct Cyc_Position_Segment*_tmp2AF;struct _tuple14*
_tmp2AB=(struct _tuple14*)_tmp2AA->hd;_tmp2AC=*_tmp2AB;_tmp2AD=_tmp2AC.f1;_tmp2AE=
_tmp2AC.f2;_tmp2AF=_tmp2AC.f3;if(!Cyc_RgnOrder_satisfies_constraints(_tmp2AD,
_tmp2AE,(void*)& Cyc_Absyn_HeapRgn_val,1)){const char*_tmp42F;void*_tmp42E;(
...
Cyc_Tcenv_Bindings*locals=0;struct _dyneither_ptr*_tmp43C;const char*_tmp43B;void*
...
locals=((_tmp44E=_region_malloc(r,sizeof(*_tmp44E)),((_tmp44E->v=(*((struct
_tuple15*)_tmp2B5->hd)).f1,((_tmp44E->b=(void*)((_tmp450=_cycalloc(sizeof(*
_tmp450)),((_tmp450[0]=((_tmp44F.tag=3,((_tmp44F.f1=_tmp2B6,_tmp44F)))),_tmp450)))),((
_tmp44E->tl=locals,_tmp44E))))))));};}}if(fd->cyc_varargs != 0){struct Cyc_Core_Opt*
_tmp2C0;struct Cyc_Absyn_Tqual _tmp2C1;void*_tmp2C2;int _tmp2C3;struct Cyc_Absyn_VarargInfo
_tmp2BF=*((struct Cyc_Absyn_VarargInfo*)_check_null(fd->cyc_varargs));_tmp2C0=
_tmp2BF.name;_tmp2C1=_tmp2BF.tq;_tmp2C2=_tmp2BF.type;_tmp2C3=_tmp2BF.inject;if(
_tmp2C0 != 0){void*_tmp2C4=Cyc_Absyn_dyneither_typ(_tmp2C2,param_rgn,_tmp2C1,Cyc_Absyn_false_conref);
struct Cyc_Absyn_Vardecl _tmp456;struct _tuple0*_tmp455;struct Cyc_Absyn_Vardecl*
_tmp454;struct Cyc_Absyn_Vardecl*_tmp2C5=(_tmp454=_cycalloc(sizeof(struct Cyc_Absyn_Vardecl)
* 1),((_tmp454[0]=((_tmp456.sc=Cyc_Absyn_Public,((_tmp456.name=((_tmp455=
_cycalloc(sizeof(*_tmp455)),((_tmp455->f1=(union Cyc_Absyn_Nmspace)Cyc_Absyn_Loc_n,((
_tmp455->f2=(struct _dyneither_ptr*)_tmp2C0->v,_tmp455)))))),((_tmp456.tq=Cyc_Absyn_empty_tqual(
0),((_tmp456.type=_tmp2C4,((_tmp456.initializer=0,((_tmp456.rgn=param_rgn_opt,((
...
locals=((_tmp45B=_region_malloc(r,sizeof(*_tmp45B)),((_tmp45B->v=(struct
_dyneither_ptr*)_tmp2C0->v,((_tmp45B->b=(void*)((_tmp45D=_cycalloc(sizeof(*
_tmp45D)),((_tmp45D[0]=((_tmp45C.tag=3,((_tmp45C.f1=_tmp2C5,_tmp45C)))),_tmp45D)))),((
_tmp45B->tl=locals,_tmp45B))))))));};}else{const char*_tmp460;void*_tmp45F;(
_tmp45F=0,Cyc_Tcutil_terr(loc,((_tmp460="missing name for varargs",
...
_tmp2B3,((_tmp479->locals=(struct Cyc_Tcenv_Bindings*)locals,((_tmp479->encloser=(
...
_tmp47B->fallthru_clause=0,((_tmp47B->next_stmt=(void*)& Cyc_Tcenv_FnEnd_j_val,((
...
_tmp2E4;struct Cyc_Tcenv_Bindings*_tmp2E5;struct Cyc_RgnOrder_RgnPO*_tmp2E6;struct
Cyc_List_List*_tmp2E7;struct Cyc_Tcenv_SharedFenv*_tmp2E8;struct _RegionHandle*
_tmp2E9;struct Cyc_Tcenv_Fenv*_tmp2E3=old_fenv;_tmp2E4=*_tmp2E3;_tmp2E5=_tmp2E4.locals;
_tmp2E6=_tmp2E4.region_order;_tmp2E7=_tmp2E4.type_vars;_tmp2E8=_tmp2E4.shared;
_tmp2E9=_tmp2E4.fnrgn;{struct _RegionHandle*_tmp2EA=_tmp2E8->frgn;struct Cyc_Tcenv_Bindings*
_tmp2EB=(struct Cyc_Tcenv_Bindings*)_tmp2E5;struct _dyneither_ptr*_tmp48E;const
char*_tmp48D;void*_tmp48C[1];struct Cyc_String_pa_struct _tmp48B;struct Cyc_Absyn_Tvar*
_tmp48A;struct Cyc_Absyn_Tvar*rgn0=(_tmp48A=_cycalloc(sizeof(*_tmp48A)),((_tmp48A->name=((
_tmp48E=_cycalloc(sizeof(*_tmp48E)),((_tmp48E[0]=(struct _dyneither_ptr)((_tmp48B.tag=
0,((_tmp48B.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*fd->name).f2),((
_tmp48C[0]=& _tmp48B,Cyc_aprintf(((_tmp48D="`%s",_tag_dyneither(_tmp48D,sizeof(
char),4))),_tag_dyneither(_tmp48C,sizeof(void*),1)))))))),_tmp48E)))),((_tmp48A->identity=
Cyc_Tcutil_new_tvar_id(),((_tmp48A->kind=(void*)& Cyc_Tcenv_rgn_kb,_tmp48A)))))));{
struct Cyc_List_List*_tmp2EC=fd->tvs;for(0;_tmp2EC != 0;_tmp2EC=_tmp2EC->tl){
struct Cyc_Absyn_Kind _tmp2EE;enum Cyc_Absyn_KindQual _tmp2EF;enum Cyc_Absyn_AliasQual
_tmp2F0;struct Cyc_Absyn_Kind*_tmp2ED=Cyc_Tcutil_tvar_kind((struct Cyc_Absyn_Tvar*)
_tmp2EC->hd,& Cyc_Tcutil_bk);_tmp2EE=*_tmp2ED;_tmp2EF=_tmp2EE.kind;_tmp2F0=
_tmp2EE.aliasqual;if(_tmp2EF == Cyc_Absyn_RgnKind){if(_tmp2F0 == Cyc_Absyn_Aliasable)
_tmp2E6=Cyc_RgnOrder_add_youngest(_tmp2EA,_tmp2E6,(struct Cyc_Absyn_Tvar*)_tmp2EC->hd,
0,0);else{const char*_tmp491;void*_tmp490;(_tmp490=0,((int(*)(struct
_dyneither_ptr fmt,struct _dyneither_ptr ap))Cyc_Tcutil_impos)(((_tmp491="non-intuitionistic tvar in nested_fenv",
_tag_dyneither(_tmp491,sizeof(char),39))),_tag_dyneither(_tmp490,sizeof(void*),0)));}}}}
_tmp2E6=Cyc_RgnOrder_add_youngest(_tmp2EA,_tmp2E6,rgn0,0,0);{struct Cyc_List_List*
_tmp492;struct Cyc_List_List*_tmp2F3=(_tmp492=_cycalloc(sizeof(*_tmp492)),((
_tmp492->hd=rgn0,((_tmp492->tl=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,
struct Cyc_List_List*y))Cyc_List_append)(fd->tvs,_tmp2E7),_tmp492)))));Cyc_Tcutil_check_unique_tvars(
loc,_tmp2F3);{struct Cyc_Absyn_VarType_struct _tmp495;struct Cyc_Absyn_VarType_struct*
_tmp494;void*param_rgn=(void*)((_tmp494=_cycalloc(sizeof(*_tmp494)),((_tmp494[0]=((
_tmp495.tag=2,((_tmp495.f1=rgn0,_tmp495)))),_tmp494))));struct Cyc_Core_Opt*
_tmp496;struct Cyc_Core_Opt*param_rgn_opt=(_tmp496=_cycalloc(sizeof(*_tmp496)),((
_tmp496->v=param_rgn,_tmp496)));struct Cyc_List_List*_tmp2F4=0;{struct Cyc_List_List*
_tmp2F5=fd->args;for(0;_tmp2F5 != 0;_tmp2F5=_tmp2F5->tl){struct Cyc_Absyn_Vardecl
_tmp49C;struct _tuple0*_tmp49B;struct Cyc_Absyn_Vardecl*_tmp49A;struct Cyc_Absyn_Vardecl*
_tmp2F6=(_tmp49A=_cycalloc(sizeof(struct Cyc_Absyn_Vardecl)* 1),((_tmp49A[0]=((
_tmp49C.sc=Cyc_Absyn_Public,((_tmp49C.name=((_tmp49B=_cycalloc(sizeof(*_tmp49B)),((
_tmp49B->f1=(union Cyc_Absyn_Nmspace)Cyc_Absyn_Loc_n,((_tmp49B->f2=(*((struct
_tuple15*)_tmp2F5->hd)).f1,_tmp49B)))))),((_tmp49C.tq=(*((struct _tuple15*)
_tmp2F5->hd)).f2,((_tmp49C.type=(*((struct _tuple15*)_tmp2F5->hd)).f3,((_tmp49C.initializer=
0,((_tmp49C.rgn=param_rgn_opt,((_tmp49C.attributes=0,((_tmp49C.escapes=0,_tmp49C)))))))))))))))),
...
_tmp2EB=(struct Cyc_Tcenv_Bindings*)((_tmp4A3=_region_malloc(_tmp2EA,sizeof(*
...
_tmp2EB=(struct Cyc_Tcenv_Bindings*)((_tmp4B0=_region_malloc(_tmp2EA,sizeof(*
...
struct Cyc_Tcenv_Bindings*)_tmp2EB,((_tmp4CE->encloser=(struct Cyc_Absyn_Stmt*)fd->body,((
_tmp4CE->ctrl_env=(struct Cyc_Tcenv_CtrlEnv*)((struct Cyc_Tcenv_CtrlEnv*)((_tmp4D0=
_region_malloc(_tmp2EA,sizeof(*_tmp4D0)),((_tmp4D0->ctrl_rgn=_tmp2EA,((_tmp4D0->continue_stmt=(
void*)& Cyc_Tcenv_NotLoop_j_val,((_tmp4D0->break_stmt=(void*)& Cyc_Tcenv_NotLoop_j_val,((
_tmp4D0->fallthru_clause=0,((_tmp4D0->next_stmt=(void*)& Cyc_Tcenv_FnEnd_j_val,((
_tmp4D0->try_depth=0,_tmp4D0))))))))))))))),((_tmp4CE->capability=(void*)((void*)((
_tmp4D6=_cycalloc(sizeof(*_tmp4D6)),((_tmp4D6[0]=((_tmp4D1.tag=24,((_tmp4D1.f1=((
_tmp4D5=_cycalloc(sizeof(*_tmp4D5)),((_tmp4D5->hd=(void*)((_tmp4D3=_cycalloc(
sizeof(*_tmp4D3)),((_tmp4D3[0]=((_tmp4D4.tag=23,((_tmp4D4.f1=(void*)param_rgn,
_tmp4D4)))),_tmp4D3)))),((_tmp4D5->tl=((_tmp4D2=_cycalloc(sizeof(*_tmp4D2)),((
_tmp4D2->hd=(void*)((struct Cyc_Core_Opt*)_check_null(fd->effect))->v,((_tmp4D2->tl=
0,_tmp4D2)))))),_tmp4D5)))))),_tmp4D1)))),_tmp4D6))))),((_tmp4CE->curr_rgn=(void*)
param_rgn,((_tmp4CE->in_notreadctxt=(int)0,((_tmp4CE->fnrgn=(struct _RegionHandle*)
_tmp2E9,_tmp4CE))))))))))))))))))))));};};};};}
