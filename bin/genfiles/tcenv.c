...
# 51 "tcenv.cyc"
typedef struct Cyc_Set_Set*Cyc_Tcenv_set_t;char Cyc_Tcenv_Env_error[10]="Env_error";
# 54
...
# 658
static struct Cyc_Tcenv_SharedFenv*Cyc_Tcenv_new_shared_fenv(struct _RegionHandle*r,void*ret){
return({struct Cyc_Tcenv_SharedFenv*_tmp181=_region_malloc(r,sizeof(*_tmp181));_tmp181->frgn=r;_tmp181->return_typ=ret;_tmp181->delayed_effect_checks=0;_tmp181->delayed_constraint_checks=0;_tmp181;});}
# 665
...
struct Cyc_List_List*_tmp182=({struct Cyc_List_List*_tmp196=_cycalloc(sizeof(*_tmp196));_tmp196->hd=rgn0;_tmp196->tl=fd->tvs;_tmp196;});
Cyc_Tcutil_check_unique_tvars(loc,_tmp182);{
# 672
struct Cyc_RgnOrder_RgnPO*_tmp183=Cyc_RgnOrder_initial_fn_po(r,fd->tvs,fd->rgn_po,(void*)_check_null(fd->effect),rgn0,loc);
# 674
...
{struct Cyc_List_List*_tmp184=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v;for(0;_tmp184 != 0;_tmp184=_tmp184->tl){
((struct Cyc_Absyn_Vardecl*)_tmp184->hd)->rgn=param_rgn;}}
if(fd->cyc_varargs != 0){
struct Cyc_Absyn_VarargInfo _tmp185=*((struct Cyc_Absyn_VarargInfo*)_check_null(fd->cyc_varargs));struct Cyc_Absyn_VarargInfo _tmp186=_tmp185;struct _dyneither_ptr*_tmp18C;struct Cyc_Absyn_Tqual _tmp18B;void*_tmp18A;int _tmp189;_LL83: _tmp18C=_tmp186.name;_tmp18B=_tmp186.tq;_tmp18A=_tmp186.type;_tmp189=_tmp186.inject;_LL84:;{
# 680
struct Cyc_List_List*_tmp187=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v;for(0;_tmp187 != 0;_tmp187=_tmp187->tl){
struct Cyc_Absyn_Vardecl*_tmp188=(struct Cyc_Absyn_Vardecl*)_tmp187->hd;
if(Cyc_strptrcmp((*_tmp188->name).f2,(struct _dyneither_ptr*)_check_null(_tmp18C))== 0){
_tmp188->type=Cyc_Absyn_dyneither_typ(_tmp18A,param_rgn,_tmp18B,Cyc_Absyn_false_conref);
break;}}};}
# 688
return({struct Cyc_Tcenv_Fenv*_tmp18D=_region_malloc(r,sizeof(*_tmp18D));_tmp18D->shared=(struct Cyc_Tcenv_SharedFenv*)
Cyc_Tcenv_new_shared_fenv(r,fd->ret_type);_tmp18D->type_vars=(struct Cyc_List_List*)_tmp182;_tmp18D->region_order=(struct Cyc_RgnOrder_RgnPO*)_tmp183;_tmp18D->ctrl_env=(const struct _tuple10*)0;_tmp18D->capability=(void*)((void*)({struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp18E=_cycalloc(sizeof(*_tmp18E));_tmp18E[0]=({struct Cyc_Absyn_JoinEff_Absyn_Type_struct _tmp18F;_tmp18F.tag=24;_tmp18F.f1=({struct Cyc_List_List*_tmp190=_cycalloc(sizeof(*_tmp190));_tmp190->hd=(void*)({struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmp192=_cycalloc(sizeof(*_tmp192));_tmp192[0]=({struct Cyc_Absyn_AccessEff_Absyn_Type_struct _tmp193;_tmp193.tag=23;_tmp193.f1=param_rgn;_tmp193;});_tmp192;});_tmp190->tl=({struct Cyc_List_List*_tmp191=_cycalloc(sizeof(*_tmp191));_tmp191->hd=(void*)_check_null(fd->effect);_tmp191->tl=0;_tmp191;});_tmp190;});_tmp18F;});_tmp18E;}));_tmp18D->curr_rgn=(void*)param_rgn;_tmp18D->flags=(struct Cyc_Tcenv_FenvFlags)({(_tmp18D->flags).in_notreadctxt=0;(_tmp18D->flags).in_lhs=0;(_tmp18D->flags).in_new=0;(_tmp18D->flags).abstract_ok=0;_tmp18D->flags;});_tmp18D->fnrgn=(struct _RegionHandle*)r;_tmp18D;});};}
# 701
...
_tmp1C2=Cyc_RgnOrder_add_unordered(_tmp19D,_tmp1C2,(struct Cyc_Absyn_Tvar*)_tmp19E->hd);else{
# 714
...
{struct Cyc_List_List*_tmp1A5=fd->rgn_po;for(0;_tmp1A5 != 0;_tmp1A5=_tmp1A5->tl){
_tmp1C2=Cyc_RgnOrder_add_outlives_constraint(_tmp19D,_tmp1C2,(*((struct _tuple14*)_tmp1A5->hd)).f1,(*((struct _tuple14*)_tmp1A5->hd)).f2,loc);}}{
struct Cyc_List_List*_tmp1A6=({struct Cyc_List_List*_tmp1B9=_cycalloc(sizeof(*_tmp1B9));_tmp1B9->hd=rgn0;_tmp1B9->tl=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(fd->tvs,_tmp1C1);_tmp1B9;});
Cyc_Tcutil_check_unique_tvars(loc,_tmp1A6);{
...
{struct Cyc_List_List*_tmp1A7=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v;for(0;_tmp1A7 != 0;_tmp1A7=_tmp1A7->tl){
((struct Cyc_Absyn_Vardecl*)_tmp1A7->hd)->rgn=param_rgn;}}
if(fd->cyc_varargs != 0){
struct Cyc_Absyn_VarargInfo _tmp1A8=*((struct Cyc_Absyn_VarargInfo*)_check_null(fd->cyc_varargs));struct Cyc_Absyn_VarargInfo _tmp1A9=_tmp1A8;struct _dyneither_ptr*_tmp1AF;struct Cyc_Absyn_Tqual _tmp1AE;void*_tmp1AD;int _tmp1AC;_LL8C: _tmp1AF=_tmp1A9.name;_tmp1AE=_tmp1A9.tq;_tmp1AD=_tmp1A9.type;_tmp1AC=_tmp1A9.inject;_LL8D:;{
# 727
struct Cyc_List_List*_tmp1AA=(struct Cyc_List_List*)((struct Cyc_Core_Opt*)_check_null(fd->param_vardecls))->v;for(0;_tmp1AA != 0;_tmp1AA=_tmp1AA->tl){
struct Cyc_Absyn_Vardecl*_tmp1AB=(struct Cyc_Absyn_Vardecl*)_tmp1AA->hd;
if(Cyc_strptrcmp((*_tmp1AB->name).f2,(struct _dyneither_ptr*)_check_null(_tmp1AF))== 0){
_tmp1AB->type=Cyc_Absyn_dyneither_typ(_tmp1AD,param_rgn,_tmp1AE,Cyc_Absyn_false_conref);
break;}}};}
# 735
return({struct Cyc_Tcenv_Fenv*_tmp1B0=_region_malloc(_tmp19D,sizeof(*_tmp1B0));_tmp1B0->shared=(struct Cyc_Tcenv_SharedFenv*)
Cyc_Tcenv_new_shared_fenv(_tmp19D,fd->ret_type);_tmp1B0->type_vars=(struct Cyc_List_List*)_tmp1A6;_tmp1B0->region_order=(struct Cyc_RgnOrder_RgnPO*)_tmp1C2;_tmp1B0->ctrl_env=(const struct _tuple10*)0;_tmp1B0->capability=(void*)((void*)({struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp1B1=_cycalloc(sizeof(*_tmp1B1));_tmp1B1[0]=({struct Cyc_Absyn_JoinEff_Absyn_Type_struct _tmp1B2;_tmp1B2.tag=24;_tmp1B2.f1=({struct Cyc_List_List*_tmp1B3=_cycalloc(sizeof(*_tmp1B3));_tmp1B3->hd=(void*)({struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmp1B5=_cycalloc(sizeof(*_tmp1B5));_tmp1B5[0]=({struct Cyc_Absyn_AccessEff_Absyn_Type_struct _tmp1B6;_tmp1B6.tag=23;_tmp1B6.f1=param_rgn;_tmp1B6;});_tmp1B5;});_tmp1B3->tl=({struct Cyc_List_List*_tmp1B4=_cycalloc(sizeof(*_tmp1B4));_tmp1B4->hd=(void*)_check_null(fd->effect);_tmp1B4->tl=0;_tmp1B4;});_tmp1B3;});_tmp1B2;});_tmp1B1;}));_tmp1B0->curr_rgn=(void*)param_rgn;_tmp1B0->flags=(struct Cyc_Tcenv_FenvFlags)({(_tmp1B0->flags).in_notreadctxt=0;(_tmp1B0->flags).in_lhs=0;(_tmp1B0->flags).in_new=0;(_tmp1B0->flags).abstract_ok=0;_tmp1B0->flags;});_tmp1B0->fnrgn=(struct _RegionHandle*)_tmp1BF;_tmp1B0;});};};};}
# 748
struct Cyc_Tcenv_Fenv*Cyc_Tcenv_bogus_fenv(struct _RegionHandle*r,void*ret_type,struct Cyc_List_List*args){
# 750
struct Cyc_Absyn_Tvar*rgn0=({struct Cyc_Absyn_Tvar*_tmp1D0=_cycalloc(sizeof(*_tmp1D0));_tmp1D0->name=_init_dyneither_ptr(_cycalloc(sizeof(struct _dyneither_ptr)),"bogus",sizeof(char),6);_tmp1D0->identity=Cyc_Tcutil_new_tvar_id();_tmp1D0->kind=(void*)& Cyc_Tcenv_rgn_kb;_tmp1D0;});
struct Cyc_List_List*_tmp1C3=({struct Cyc_List_List*_tmp1CF=_cycalloc(sizeof(*_tmp1CF));_tmp1CF->hd=rgn0;_tmp1CF->tl=0;_tmp1CF;});
struct Cyc_RgnOrder_RgnPO*_tmp1C4=Cyc_RgnOrder_initial_fn_po(r,0,0,(void*)({struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp1CD=_cycalloc(sizeof(*_tmp1CD));_tmp1CD[0]=({struct Cyc_Absyn_JoinEff_Absyn_Type_struct _tmp1CE;_tmp1CE.tag=24;_tmp1CE.f1=0;_tmp1CE;});_tmp1CD;}),rgn0,0);
void*param_rgn=(void*)({struct Cyc_Absyn_VarType_Absyn_Type_struct*_tmp1CB=_cycalloc(sizeof(*_tmp1CB));_tmp1CB[0]=({struct Cyc_Absyn_VarType_Absyn_Type_struct _tmp1CC;_tmp1CC.tag=2;_tmp1CC.f1=rgn0;_tmp1CC;});_tmp1CB;});
return({struct Cyc_Tcenv_Fenv*_tmp1C5=_region_malloc(r,sizeof(*_tmp1C5));_tmp1C5->shared=(struct Cyc_Tcenv_SharedFenv*)
Cyc_Tcenv_new_shared_fenv(r,ret_type);_tmp1C5->type_vars=(struct Cyc_List_List*)_tmp1C3;_tmp1C5->region_order=(struct Cyc_RgnOrder_RgnPO*)_tmp1C4;_tmp1C5->ctrl_env=(const struct _tuple10*)0;_tmp1C5->capability=(void*)((void*)({struct Cyc_Absyn_JoinEff_Absyn_Type_struct*_tmp1C6=_cycalloc(sizeof(*_tmp1C6));_tmp1C6[0]=({struct Cyc_Absyn_JoinEff_Absyn_Type_struct _tmp1C7;_tmp1C7.tag=24;_tmp1C7.f1=({struct Cyc_List_List*_tmp1C8=_cycalloc(sizeof(*_tmp1C8));_tmp1C8->hd=(void*)({struct Cyc_Absyn_AccessEff_Absyn_Type_struct*_tmp1C9=_cycalloc(sizeof(*_tmp1C9));_tmp1C9[0]=({struct Cyc_Absyn_AccessEff_Absyn_Type_struct _tmp1CA;_tmp1CA.tag=23;_tmp1CA.f1=param_rgn;_tmp1CA;});_tmp1C9;});_tmp1C8->tl=0;_tmp1C8;});_tmp1C7;});_tmp1C6;}));_tmp1C5->curr_rgn=(void*)param_rgn;_tmp1C5->flags=(struct Cyc_Tcenv_FenvFlags)({(_tmp1C5->flags).in_notreadctxt=0;(_tmp1C5->flags).in_lhs=0;(_tmp1C5->flags).in_new=0;(_tmp1C5->flags).abstract_ok=0;_tmp1C5->flags;});_tmp1C5->fnrgn=(struct _RegionHandle*)r;_tmp1C5;});}
