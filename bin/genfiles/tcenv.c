...
# 271
const struct _tuple10*_tmp30=({struct Cyc_Tcenv_Tenv*_tmpF7=te;Cyc_Tcenv_get_fenv(_tmpF7,({const char*_tmp32="process_fallthru";_tag_dyneither(_tmp32,sizeof(char),17U);}));})->ctrl_env;
...
struct _tuple10*_tmp34=({struct _tuple10*_tmp38=_cycalloc(sizeof(*_tmp38));_tmp38->f1=clause,_tmp38->f2=new_tvs,({struct Cyc_List_List*_tmpF9=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(ft_typ);_tmp38->f3=_tmpF9;});_tmp38;});
...
return;
({struct Cyc_String_pa_PrintArg_struct _tmp74=({struct Cyc_String_pa_PrintArg_struct _tmpE4;_tmpE4.tag=0U,({struct _dyneither_ptr _tmp11E=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(rgn));_tmpE4.f1=_tmp11E;});_tmpE4;});void*_tmp72[1U];_tmp72[0]=& _tmp74;({unsigned int _tmp120=loc;struct _dyneither_ptr _tmp11F=({const char*_tmp73="Expression accesses unavailable region %s";_tag_dyneither(_tmp73,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp120,_tmp11F,_tag_dyneither(_tmp72,sizeof(void*),1U));});});}
# 423
...
({void*_tmp90=0U;({unsigned int _tmp12D=loc;struct _dyneither_ptr _tmp12C=({const char*_tmp91="the required region ordering is not satisfied here";_tag_dyneither(_tmp91,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp12D,_tmp12C,_tag_dyneither(_tmp90,sizeof(void*),0U));});});}
return;}{
# 484
...
({void*_tmp9B=0U;({unsigned int _tmp132=_tmp9D;struct _dyneither_ptr _tmp131=({const char*_tmp9C="the required region ordering is not satisfied here";_tag_dyneither(_tmp9C,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp132,_tmp131,_tag_dyneither(_tmp9B,sizeof(void*),0U));});});}}
# 500
