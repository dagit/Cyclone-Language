...
# 272
const struct _tuple11*_tmp30=({struct Cyc_Tcenv_Tenv*_tmpF2=te;Cyc_Tcenv_get_fenv(_tmpF2,({const char*_tmp32="process_fallthru";_tag_fat(_tmp32,sizeof(char),17U);}));})->ctrl_env;
...
struct _tuple11*_tmp34=({struct _tuple11*_tmp38=_cycalloc(sizeof(*_tmp38));_tmp38->f1=clause,_tmp38->f2=new_tvs,({struct Cyc_List_List*_tmpF4=((struct Cyc_List_List*(*)(struct Cyc_List_List*x))Cyc_List_imp_rev)(ft_typ);_tmp38->f3=_tmpF4;});_tmp38;});
...
# 383
if(r1_le_r2 && !r2_le_r1)
({struct _tuple10*_tmp110=({struct _tuple10*_tmp69=_cycalloc(sizeof(*_tmp69));({struct _tuple10 _tmp10F=({void*_tmp10E=_tmp60;Cyc_Tcutil_swap_kind(_tmp10E,Cyc_Tcutil_kind_to_bound(_tmp61));});*_tmp69=_tmp10F;});_tmp69;});*oldtv=_tmp110;});else{
if(!r1_le_r2 && r2_le_r1)
({struct _tuple10*_tmp113=({struct _tuple10*_tmp6A=_cycalloc(sizeof(*_tmp6A));({struct _tuple10 _tmp112=({void*_tmp111=_tmp5F;Cyc_Tcutil_swap_kind(_tmp111,Cyc_Tcutil_kind_to_bound(_tmp62));});*_tmp6A=_tmp112;});_tmp6A;});*oldtv=_tmp113;});}}{
# 389
...
_tmp6B=({struct Cyc_List_List*_tmp6D=_cycalloc(sizeof(*_tmp6D));({struct _tuple13*_tmp115=({struct _tuple13*_tmp6C=_cycalloc(sizeof(*_tmp6C));({void*_tmp114=Cyc_Absyn_access_eff(_tmp5F);_tmp6C->f1=_tmp114;}),_tmp6C->f2=_tmp60;_tmp6C;});_tmp6D->hd=_tmp115;}),_tmp6D->tl=_tmp6B;_tmp6D;});
if((_tmp60 != Cyc_Absyn_heap_rgn_type && _tmp60 != Cyc_Absyn_unique_rgn_type)&& _tmp60 != Cyc_Absyn_refcnt_rgn_type)
_tmp6B=({struct Cyc_List_List*_tmp6F=_cycalloc(sizeof(*_tmp6F));({struct _tuple13*_tmp117=({struct _tuple13*_tmp6E=_cycalloc(sizeof(*_tmp6E));({void*_tmp116=Cyc_Absyn_access_eff(_tmp60);_tmp6E->f1=_tmp116;}),_tmp6E->f2=_tmp5F;_tmp6E;});_tmp6F->hd=_tmp117;}),_tmp6F->tl=_tmp6B;_tmp6F;});
...
({struct _tuple14*_tmp121=({struct _tuple14*_tmp78=_cycalloc(sizeof(*_tmp78));_tmp78->f1=_tmp7C,_tmp78->f2=eff,_tmp78->f3=_tmp7B,_tmp78->f4=loc;_tmp78;});_tmp79->hd=_tmp121;}),_tmp79->tl=_tmp7A->delayed_effect_checks;_tmp79;});
# 437
...
struct _tuple14*_tmp7F=(struct _tuple14*)_tmp7E->hd;struct _tuple14*_tmp80=_tmp7F;void*_tmp88;void*_tmp87;struct Cyc_RgnOrder_RgnPO*_tmp86;unsigned _tmp85;_LL1: _tmp88=_tmp80->f1;_tmp87=_tmp80->f2;_tmp86=_tmp80->f3;_tmp85=_tmp80->f4;_LL2:;
...
({struct _tuple15*_tmp12B=({struct _tuple15*_tmp8F=_cycalloc(sizeof(*_tmp8F));_tmp8F->f1=_tmp92,_tmp8F->f2=po,_tmp8F->f3=loc;_tmp8F;});_tmp90->hd=_tmp12B;}),_tmp90->tl=_tmp91->delayed_constraint_checks;_tmp90;});
# 471
...
struct _tuple15*_tmp94=(struct _tuple15*)_tmp93->hd;struct _tuple15*_tmp95=_tmp94;struct Cyc_RgnOrder_RgnPO*_tmp9A;struct Cyc_List_List*_tmp99;unsigned _tmp98;_LL1: _tmp9A=_tmp95->f1;_tmp99=_tmp95->f2;_tmp98=_tmp95->f3;_LL2:;
...
_tmpD1=Cyc_RgnOrder_add_outlives_constraint(_tmpD1,(*((struct _tuple13*)_tmpBA->hd)).f1,(*((struct _tuple13*)_tmpBA->hd)).f2,loc);}}{
