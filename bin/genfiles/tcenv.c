...
({struct Cyc_Dict_Dict _tmpF0=({struct Cyc_Dict_Dict _tmpEF=_tmp0->datatypedecls;struct _tuple0*_tmpEE=Cyc_Absyn_exn_name;((struct Cyc_Dict_Dict(*)(struct Cyc_Dict_Dict d,struct _tuple0*k,struct Cyc_Absyn_Datatypedecl**v))Cyc_Dict_insert)(_tmpEF,_tmpEE,({struct Cyc_Absyn_Datatypedecl**_tmp1=_cycalloc(sizeof(*_tmp1));*_tmp1=Cyc_Absyn_exn_tud;_tmp1;}));});_tmp0->datatypedecls=_tmpF0;});
...
return({struct Cyc_Absyn_Datatypedecl***_tmp5=_region_malloc(r,sizeof(*_tmp5));({struct Cyc_Absyn_Datatypedecl**_tmpF1=((struct Cyc_Absyn_Datatypedecl**(*)(struct Cyc_Dict_Dict d,struct _tuple0*k))Cyc_Dict_lookup)((te->ae)->datatypedecls,q);*_tmp5=_tmpF1;});_tmp5;});}
# 137
...
return(({struct Cyc_Tcenv_Tenv*_tmpF2=te;Cyc_Tcenv_get_fenv(_tmpF2,({const char*_tmpC="return_typ";_tag_dyneither(_tmpC,sizeof(char),11U);}));})->shared)->return_typ;}
# 167
...
return({struct Cyc_Core_Opt*_tmpE=_cycalloc(sizeof(*_tmpE));({struct Cyc_List_List*_tmpF3=Cyc_Tcenv_lookup_type_vars(te);_tmpE->v=_tmpF3;});_tmpE;});}
# 177
struct Cyc_Tcenv_Tenv*Cyc_Tcenv_add_type_vars(unsigned int loc,struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List*tvs){
struct Cyc_Tcenv_Fenv*_tmpF=({struct Cyc_Tcenv_Fenv*_tmp12=_cycalloc(sizeof(*_tmp12));({struct Cyc_Tcenv_Fenv _tmpF5=*({struct Cyc_Tcenv_Tenv*_tmpF4=te;Cyc_Tcenv_get_fenv(_tmpF4,({const char*_tmp11="add_type_vars";_tag_dyneither(_tmp11,sizeof(char),14U);}));});*_tmp12=_tmpF5;});_tmp12;});
...
# 271
const struct _tuple10*_tmp30=({struct Cyc_Tcenv_Tenv*_tmpF6=te;Cyc_Tcenv_get_fenv(_tmpF6,({const char*_tmp32="process_fallthru";_tag_dyneither(_tmp32,sizeof(char),17U);}));})->ctrl_env;
if(_tmp30 != (const struct _tuple10*)0)
({struct Cyc_Absyn_Switch_clause**_tmpF7=({struct Cyc_Absyn_Switch_clause**_tmp31=_cycalloc(sizeof(*_tmp31));*_tmp31=(*_tmp30).f1;_tmp31;});*clauseopt=_tmpF7;});
return _tmp30;}
# 277
struct Cyc_Tcenv_Tenv*Cyc_Tcenv_set_fallthru(struct Cyc_Tcenv_Tenv*te,struct Cyc_List_List*new_tvs,struct Cyc_List_List*vds,struct Cyc_Absyn_Switch_clause*clause){
# 279
...
struct Cyc_Tcenv_Fenv*_tmp4B=({struct Cyc_Tcenv_Fenv*_tmp53=_cycalloc(sizeof(*_tmp53));({struct Cyc_Tcenv_Fenv _tmpFE=*({struct Cyc_Tcenv_Tenv*_tmpFD=te;Cyc_Tcenv_get_fenv(_tmpFD,({const char*_tmp52="add_region";_tag_dyneither(_tmp52,sizeof(char),11U);}));});*_tmp53=_tmpFE;});_tmp53;});
...
({void*_tmp101=Cyc_Absyn_join_eff(({struct Cyc_List_List*_tmp51=_cycalloc(sizeof(*_tmp51));({void*_tmp100=Cyc_Absyn_access_eff(rgn);_tmp51->hd=_tmp100;}),({
struct Cyc_List_List*_tmpFF=({struct Cyc_List_List*_tmp50=_cycalloc(sizeof(*_tmp50));_tmp50->hd=_tmp4B->capability,_tmp50->tl=0;_tmp50;});_tmp51->tl=_tmpFF;});_tmp51;}));
# 331
_tmp4B->capability=_tmp101;});
# 333
...
struct Cyc_Tcenv_Fenv*_tmp54=({struct Cyc_Tcenv_Fenv*_tmp5B=_cycalloc(sizeof(*_tmp5B));({struct Cyc_Tcenv_Fenv _tmp103=*({struct Cyc_Tcenv_Tenv*_tmp102=te;Cyc_Tcenv_get_fenv(_tmp102,({const char*_tmp5A="new_named_block";_tag_dyneither(_tmp5A,sizeof(char),16U);}));});*_tmp5B=_tmp103;});_tmp5B;});
...
({struct Cyc_List_List*_tmp104=({struct Cyc_List_List*_tmp56=_cycalloc(sizeof(*_tmp56));_tmp56->hd=block_rgn,_tmp56->tl=_tmp54->type_vars;_tmp56;});_tmp54->type_vars=_tmp104;});
Cyc_Tcutil_check_unique_tvars(loc,_tmp54->type_vars);
({struct Cyc_RgnOrder_RgnPO*_tmp105=Cyc_RgnOrder_add_youngest(_tmp54->region_order,block_rgn,0);_tmp54->region_order=_tmp105;});
({void*_tmp108=Cyc_Absyn_join_eff(({struct Cyc_List_List*_tmp58=_cycalloc(sizeof(*_tmp58));({void*_tmp107=Cyc_Absyn_access_eff((void*)_tmp55);_tmp58->hd=_tmp107;}),({
struct Cyc_List_List*_tmp106=({struct Cyc_List_List*_tmp57=_cycalloc(sizeof(*_tmp57));_tmp57->hd=_tmp54->capability,_tmp57->tl=0;_tmp57;});_tmp58->tl=_tmp106;});_tmp58;}));
# 342
_tmp54->capability=_tmp108;});
# 344
...
# 358
struct Cyc_Tcenv_Fenv*_tmp5C=({struct Cyc_Tcenv_Fenv*_tmp5E=_cycalloc(sizeof(*_tmp5E));({struct Cyc_Tcenv_Fenv _tmp10A=*({struct Cyc_Tcenv_Tenv*_tmp109=te;Cyc_Tcenv_get_fenv(_tmp109,({const char*_tmp5D="new_outlives_constraints";_tag_dyneither(_tmp5D,sizeof(char),25U);}));});*_tmp5E=_tmp10A;});_tmp5E;});
for(0;cs != 0;cs=cs->tl){
({struct Cyc_RgnOrder_RgnPO*_tmp10B=
Cyc_RgnOrder_add_outlives_constraint(_tmp5C->region_order,(*((struct _tuple13*)cs->hd)).f1,(*((struct _tuple13*)cs->hd)).f2,loc);
# 360
_tmp5C->region_order=_tmp10B;});}
# 362
...
struct _dyneither_ptr _tmp10C=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp5F));_tmpE3.f1=_tmp10C;});_tmpE3;});struct Cyc_String_pa_PrintArg_struct _tmp66=({struct Cyc_String_pa_PrintArg_struct _tmpE2;_tmpE2.tag=0U,({struct _dyneither_ptr _tmp10D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp60));_tmpE2.f1=_tmp10D;});_tmpE2;});struct Cyc_String_pa_PrintArg_struct _tmp67=({struct Cyc_String_pa_PrintArg_struct _tmpE1;_tmpE1.tag=0U,({struct _dyneither_ptr _tmp10E=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(_tmp61));_tmpE1.f1=_tmp10E;});_tmpE1;});struct Cyc_String_pa_PrintArg_struct _tmp68=({struct Cyc_String_pa_PrintArg_struct _tmpE0;_tmpE0.tag=0U,({struct _dyneither_ptr _tmp10F=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_kind2string(_tmp62));_tmpE0.f1=_tmp10F;});_tmpE0;});void*_tmp63[4U];_tmp63[0]=& _tmp65,_tmp63[1]=& _tmp66,_tmp63[2]=& _tmp67,_tmp63[3]=& _tmp68;({unsigned int _tmp111=loc;struct _dyneither_ptr _tmp110=({const char*_tmp64="Cannot compare region handles for %s and %s\n  kinds %s and %s are not compatible\n";_tag_dyneither(_tmp64,sizeof(char),82U);});Cyc_Tcutil_terr(_tmp111,_tmp110,_tag_dyneither(_tmp63,sizeof(void*),4U));});});
return Cyc_Tcenv_new_outlives_constraints(te,0,loc);}else{
# 382
if(r1_le_r2  && !r2_le_r1)
({struct _tuple11*_tmp114=({struct _tuple11*_tmp69=_cycalloc(sizeof(*_tmp69));({struct _tuple11 _tmp113=({void*_tmp112=_tmp60;Cyc_Tcutil_swap_kind(_tmp112,Cyc_Tcutil_kind_to_bound(_tmp61));});*_tmp69=_tmp113;});_tmp69;});*oldtv=_tmp114;});else{
if(!r1_le_r2  && r2_le_r1)
({struct _tuple11*_tmp117=({struct _tuple11*_tmp6A=_cycalloc(sizeof(*_tmp6A));({struct _tuple11 _tmp116=({void*_tmp115=_tmp5F;Cyc_Tcutil_swap_kind(_tmp115,Cyc_Tcutil_kind_to_bound(_tmp62));});*_tmp6A=_tmp116;});_tmp6A;});*oldtv=_tmp117;});}}{
# 388
...
_tmp6B=({struct Cyc_List_List*_tmp6D=_cycalloc(sizeof(*_tmp6D));({struct _tuple13*_tmp118=({struct _tuple13*_tmp6C=_cycalloc(sizeof(*_tmp6C));_tmp6C->f1=eff1,_tmp6C->f2=_tmp60;_tmp6C;});_tmp6D->hd=_tmp118;}),_tmp6D->tl=_tmp6B;_tmp6D;});}
# 393
...
_tmp6B=({struct Cyc_List_List*_tmp6F=_cycalloc(sizeof(*_tmp6F));({struct _tuple13*_tmp119=({struct _tuple13*_tmp6E=_cycalloc(sizeof(*_tmp6E));_tmp6E->f1=eff2,_tmp6E->f2=_tmp5F;_tmp6E;});_tmp6F->hd=_tmp119;}),_tmp6F->tl=_tmp6B;_tmp6F;});}
# 397
...
struct Cyc_Tcenv_Fenv*fe=({struct Cyc_Tcenv_Tenv*_tmp11A=te;Cyc_Tcenv_get_fenv(_tmp11A,({const char*_tmp77="check_rgn_accessible";_tag_dyneither(_tmp77,sizeof(char),21U);}));});
...
return;
if(({struct Cyc_RgnOrder_RgnPO*_tmp11C=_tmp75;void*_tmp11B=Cyc_Absyn_access_eff(rgn);Cyc_RgnOrder_eff_outlives_eff(_tmp11C,_tmp11B,_tmp76);}))
return;
({struct Cyc_String_pa_PrintArg_struct _tmp74=({struct Cyc_String_pa_PrintArg_struct _tmpE4;_tmpE4.tag=0U,({struct _dyneither_ptr _tmp11D=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(rgn));_tmpE4.f1=_tmp11D;});_tmpE4;});void*_tmp72[1U];_tmp72[0]=& _tmp74;({unsigned int _tmp11F=loc;struct _dyneither_ptr _tmp11E=({const char*_tmp73="Expression accesses unavailable region %s";_tag_dyneither(_tmp73,sizeof(char),42U);});Cyc_Tcutil_terr(_tmp11F,_tmp11E,_tag_dyneither(_tmp72,sizeof(void*),1U));});});}
# 423
...
void*_tmp79=rt_a;if(((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp79)->tag == 0U)switch(*((int*)((struct Cyc_Absyn_AppType_Absyn_Type_struct*)_tmp79)->f1)){case 7U: _LL1: _LL2:
 ...
 return 0;}_LL0:;}{
# 436
int _tmp7A=({struct Cyc_RgnOrder_RgnPO*_tmp121=_tmp78->region_order;void*_tmp120=Cyc_Absyn_access_eff(rt_a);Cyc_RgnOrder_effect_outlives(_tmp121,_tmp120,rt_b);});
# 440
return _tmp7A;};}struct _tuple14{void*f1;void*f2;struct Cyc_RgnOrder_RgnPO*f3;unsigned int f4;};
# 445
void Cyc_Tcenv_check_effect_accessible(struct Cyc_Tcenv_Tenv*te,unsigned int loc,void*eff){
struct Cyc_Tcenv_Fenv*_tmp7B=({
struct Cyc_Tcenv_Tenv*_tmp122=te;Cyc_Tcenv_get_fenv(_tmp122,({const char*_tmp82="check_effect_accessible";_tag_dyneither(_tmp82,sizeof(char),24U);}));});
# 446
...
return;
({struct Cyc_List_List*_tmp124=({struct Cyc_List_List*_tmp7E=_cycalloc(sizeof(*_tmp7E));
({struct _tuple14*_tmp123=({struct _tuple14*_tmp7D=_cycalloc(sizeof(*_tmp7D));_tmp7D->f1=_tmp81,_tmp7D->f2=eff,_tmp7D->f3=_tmp80,_tmp7D->f4=loc;_tmp7D;});_tmp7E->hd=_tmp123;}),_tmp7E->tl=_tmp7F->delayed_effect_checks;_tmp7E;});
# 452
_tmp7F->delayed_effect_checks=_tmp124;});}
# 455
void Cyc_Tcenv_check_delayed_effects(struct Cyc_Tcenv_Tenv*te){
struct Cyc_List_List*_tmp83=(({
struct Cyc_Tcenv_Tenv*_tmp125=te;Cyc_Tcenv_get_fenv(_tmp125,({const char*_tmp8E="check_delayed_constraints";_tag_dyneither(_tmp8E,sizeof(char),26U);}));})->shared)->delayed_effect_checks;
...
struct _dyneither_ptr _tmp126=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp8D));_tmpE6.f1=_tmp126;});_tmpE6;});struct Cyc_String_pa_PrintArg_struct _tmp89=({struct Cyc_String_pa_PrintArg_struct _tmpE5;_tmpE5.tag=0U,({struct _dyneither_ptr _tmp127=(struct _dyneither_ptr)((struct _dyneither_ptr)Cyc_Absynpp_typ2string(_tmp8C));_tmpE5.f1=_tmp127;});_tmpE5;});void*_tmp86[2U];_tmp86[0]=& _tmp88,_tmp86[1]=& _tmp89;({unsigned int _tmp129=_tmp8A;struct _dyneither_ptr _tmp128=({const char*_tmp87="Capability \n%s\ndoes not cover function's effect\n%s";_tag_dyneither(_tmp87,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp129,_tmp128,_tag_dyneither(_tmp86,sizeof(void*),2U));});});}}struct _tuple15{struct Cyc_RgnOrder_RgnPO*f1;struct Cyc_List_List*f2;unsigned int f3;};
# 473
void Cyc_Tcenv_check_rgn_partial_order(struct Cyc_Tcenv_Tenv*te,unsigned int loc,struct Cyc_List_List*po){
# 475
...
void*_tmp12A=Cyc_Absyn_access_eff((*((struct _tuple13*)po->hd)).f2);Cyc_Tcutil_subset_effect(1,_tmp12A,Cyc_Absyn_empty_effect);}))
({void*_tmp90=0U;({unsigned int _tmp12C=loc;struct _dyneither_ptr _tmp12B=({const char*_tmp91="the required region ordering is not satisfied here";_tag_dyneither(_tmp91,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp12C,_tmp12B,_tag_dyneither(_tmp90,sizeof(void*),0U));});});}
return;}{
# 484
...
({struct Cyc_List_List*_tmp12E=({struct Cyc_List_List*_tmp95=_cycalloc(sizeof(*_tmp95));
({struct _tuple15*_tmp12D=({struct _tuple15*_tmp94=_cycalloc(sizeof(*_tmp94));_tmp94->f1=_tmp97,_tmp94->f2=po,_tmp94->f3=loc;_tmp94;});_tmp95->hd=_tmp12D;}),_tmp95->tl=_tmp96->delayed_constraint_checks;_tmp95;});
# 486
_tmp96->delayed_constraint_checks=_tmp12E;});};}
# 490
void Cyc_Tcenv_check_delayed_constraints(struct Cyc_Tcenv_Tenv*te){
struct Cyc_List_List*_tmp98=(({
struct Cyc_Tcenv_Tenv*_tmp12F=te;Cyc_Tcenv_get_fenv(_tmp12F,({const char*_tmpA0="check_delayed_constraints";_tag_dyneither(_tmpA0,sizeof(char),26U);}));})->shared)->delayed_constraint_checks;
for(0;_tmp98 != 0;_tmp98=_tmp98->tl){
struct _tuple15*_tmp99=(struct _tuple15*)_tmp98->hd;struct _tuple15*_tmp9A=_tmp99;struct Cyc_RgnOrder_RgnPO*_tmp9F;struct Cyc_List_List*_tmp9E;unsigned int _tmp9D;_LL1: _tmp9F=_tmp9A->f1;_tmp9E=_tmp9A->f2;_tmp9D=_tmp9A->f3;_LL2:;
if(!Cyc_RgnOrder_satisfies_constraints(_tmp9F,_tmp9E,Cyc_Absyn_heap_rgn_type,1))
({void*_tmp9B=0U;({unsigned int _tmp131=_tmp9D;struct _dyneither_ptr _tmp130=({const char*_tmp9C="the required region ordering is not satisfied here";_tag_dyneither(_tmp9C,sizeof(char),51U);});Cyc_Tcutil_terr(_tmp131,_tmp130,_tag_dyneither(_tmp9B,sizeof(void*),0U));});});}}
# 500
...
({struct _dyneither_ptr*_tmp135=({struct _dyneither_ptr*_tmpB5=_cycalloc(sizeof(*_tmpB5));({struct _dyneither_ptr _tmp134=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpB4=({struct Cyc_String_pa_PrintArg_struct _tmpE7;_tmpE7.tag=0U,_tmpE7.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*fd->name).f2);_tmpE7;});void*_tmpB2[1U];_tmpB2[0]=& _tmpB4;({struct _dyneither_ptr _tmp133=({const char*_tmpB3="`%s";_tag_dyneither(_tmpB3,sizeof(char),4U);});Cyc_aprintf(_tmp133,_tag_dyneither(_tmpB2,sizeof(void*),1U));});});*_tmpB5=_tmp134;});_tmpB5;});_tmpB6->name=_tmp135;}),({
int _tmp132=Cyc_Tcutil_new_tvar_id();_tmpB6->identity=_tmp132;}),_tmpB6->kind=(void*)& Cyc_Tcenv_rgn_kb;_tmpB6;});
struct Cyc_List_List*_tmpA2=({struct Cyc_List_List*_tmpB1=_cycalloc(sizeof(*_tmpB1));_tmpB1->hd=rgn0,_tmpB1->tl=fd->tvs;_tmpB1;});
Cyc_Tcutil_check_unique_tvars(loc,_tmpA2);{
# 513
struct Cyc_RgnOrder_RgnPO*_tmpA3=Cyc_RgnOrder_initial_fn_po(fd->tvs,fd->rgn_po,(void*)_check_null(fd->effect),rgn0,loc);
...
if(fd->cyc_varargs != 0){
struct Cyc_Absyn_VarargInfo _tmpA5=*((struct Cyc_Absyn_VarargInfo*)_check_null(fd->cyc_varargs));struct Cyc_Absyn_VarargInfo _tmpA6=_tmpA5;struct _dyneither_ptr*_tmpAC;struct Cyc_Absyn_Tqual _tmpAB;void*_tmpAA;int _tmpA9;_LL1: _tmpAC=_tmpA6.name;_tmpAB=_tmpA6.tq;_tmpAA=_tmpA6.type;_tmpA9=_tmpA6.inject;_LL2:;{
# 520
...
({void*_tmp136=Cyc_Absyn_fatptr_type(_tmpAA,param_rgn,_tmpAB,Cyc_Absyn_false_type);_tmpA8->type=_tmp136;});
break;}}};}
# 528
return({struct Cyc_Tcenv_Fenv*_tmpAF=_cycalloc(sizeof(*_tmpAF));
({struct Cyc_Tcenv_SharedFenv*_tmp13A=Cyc_Tcenv_new_shared_fenv(fd->ret_type);_tmpAF->shared=_tmp13A;}),_tmpAF->type_vars=_tmpA2,_tmpAF->region_order=_tmpA3,_tmpAF->ctrl_env=0,({
# 533
void*_tmp139=Cyc_Absyn_join_eff(({struct Cyc_List_List*_tmpAE=_cycalloc(sizeof(*_tmpAE));({void*_tmp138=Cyc_Absyn_access_eff(param_rgn);_tmpAE->hd=_tmp138;}),({
struct Cyc_List_List*_tmp137=({struct Cyc_List_List*_tmpAD=_cycalloc(sizeof(*_tmpAD));_tmpAD->hd=(void*)_check_null(fd->effect),_tmpAD->tl=0;_tmpAD;});_tmpAE->tl=_tmp137;});_tmpAE;}));
# 533
_tmpAF->capability=_tmp139;}),_tmpAF->curr_rgn=param_rgn,
# 536
...
({struct _dyneither_ptr*_tmp13E=({struct _dyneither_ptr*_tmpD2=_cycalloc(sizeof(*_tmpD2));({struct _dyneither_ptr _tmp13D=(struct _dyneither_ptr)({struct Cyc_String_pa_PrintArg_struct _tmpD1=({struct Cyc_String_pa_PrintArg_struct _tmpE8;_tmpE8.tag=0U,_tmpE8.f1=(struct _dyneither_ptr)((struct _dyneither_ptr)*(*fd->name).f2);_tmpE8;});void*_tmpCF[1U];_tmpCF[0]=& _tmpD1;({struct _dyneither_ptr _tmp13C=({const char*_tmpD0="`%s";_tag_dyneither(_tmpD0,sizeof(char),4U);});Cyc_aprintf(_tmp13C,_tag_dyneither(_tmpCF,sizeof(void*),1U));});});*_tmpD2=_tmp13D;});_tmpD2;});_tmpD3->name=_tmp13E;}),({
...
{struct Cyc_List_List*_tmpBF=fd->rgn_po;for(0;_tmpBF != 0;_tmpBF=_tmpBF->tl){
_tmpD6=Cyc_RgnOrder_add_outlives_constraint(_tmpD6,(*((struct _tuple13*)_tmpBF->hd)).f1,(*((struct _tuple13*)_tmpBF->hd)).f2,loc);}}{
struct Cyc_List_List*_tmpC0=({struct Cyc_List_List*_tmpCE=_cycalloc(sizeof(*_tmpCE));_tmpCE->hd=rgn0,({struct Cyc_List_List*_tmp140=((struct Cyc_List_List*(*)(struct Cyc_List_List*x,struct Cyc_List_List*y))Cyc_List_append)(fd->tvs,_tmpD5);_tmpCE->tl=_tmp140;});_tmpCE;});
...
if(fd->cyc_varargs != 0){
struct Cyc_Absyn_VarargInfo _tmpC2=*((struct Cyc_Absyn_VarargInfo*)_check_null(fd->cyc_varargs));struct Cyc_Absyn_VarargInfo _tmpC3=_tmpC2;struct _dyneither_ptr*_tmpC9;struct Cyc_Absyn_Tqual _tmpC8;void*_tmpC7;int _tmpC6;_LL7: _tmpC9=_tmpC3.name;_tmpC8=_tmpC3.tq;_tmpC7=_tmpC3.type;_tmpC6=_tmpC3.inject;_LL8:;{
# 565
...
({void*_tmp141=Cyc_Absyn_fatptr_type(_tmpC7,param_rgn,_tmpC8,Cyc_Absyn_false_type);_tmpC5->type=_tmp141;});
break;}}};}
# 573
return({struct Cyc_Tcenv_Fenv*_tmpCC=_cycalloc(sizeof(*_tmpCC));
({struct Cyc_Tcenv_SharedFenv*_tmp145=Cyc_Tcenv_new_shared_fenv(fd->ret_type);_tmpCC->shared=_tmp145;}),_tmpCC->type_vars=_tmpC0,_tmpCC->region_order=_tmpD6,_tmpCC->ctrl_env=0,({
# 578
void*_tmp144=Cyc_Absyn_join_eff(({struct Cyc_List_List*_tmpCB=_cycalloc(sizeof(*_tmpCB));({void*_tmp143=Cyc_Absyn_access_eff(param_rgn);_tmpCB->hd=_tmp143;}),({
struct Cyc_List_List*_tmp142=({struct Cyc_List_List*_tmpCA=_cycalloc(sizeof(*_tmpCA));_tmpCA->hd=(void*)_check_null(fd->effect),_tmpCA->tl=0;_tmpCA;});_tmpCB->tl=_tmp142;});_tmpCB;}));
# 578
_tmpCC->capability=_tmp144;}),_tmpCC->curr_rgn=param_rgn,
# 581
...
struct Cyc_Tcenv_Fenv*Cyc_Tcenv_bogus_fenv(void*ret_type,struct Cyc_List_List*args){
# 587
struct Cyc_Absyn_Tvar*rgn0=({struct Cyc_Absyn_Tvar*_tmpDF=_cycalloc(sizeof(*_tmpDF));({struct _dyneither_ptr*_tmp148=({struct _dyneither_ptr*_tmpDE=_cycalloc(sizeof(*_tmpDE));({struct _dyneither_ptr _tmp147=({const char*_tmpDD="bogus";_tag_dyneither(_tmpDD,sizeof(char),6U);});*_tmpDE=_tmp147;});_tmpDE;});_tmpDF->name=_tmp148;}),({int _tmp146=Cyc_Tcutil_new_tvar_id();_tmpDF->identity=_tmp146;}),_tmpDF->kind=(void*)& Cyc_Tcenv_rgn_kb;_tmpDF;});
struct Cyc_List_List*_tmpD7=({struct Cyc_List_List*_tmpDC=_cycalloc(sizeof(*_tmpDC));_tmpDC->hd=rgn0,_tmpDC->tl=0;_tmpDC;});
struct Cyc_RgnOrder_RgnPO*_tmpD8=({void*_tmp149=Cyc_Absyn_join_eff(0);Cyc_RgnOrder_initial_fn_po(0,0,_tmp149,rgn0,0U);});
...
({struct Cyc_Tcenv_SharedFenv*_tmp14C=Cyc_Tcenv_new_shared_fenv(ret_type);_tmpDA->shared=_tmp14C;}),_tmpDA->type_vars=_tmpD7,_tmpDA->region_order=_tmpD8,_tmpDA->ctrl_env=0,({
# 596
void*_tmp14B=Cyc_Absyn_join_eff(({struct Cyc_List_List*_tmpD9=_cycalloc(sizeof(*_tmpD9));({void*_tmp14A=Cyc_Absyn_access_eff(param_rgn);_tmpD9->hd=_tmp14A;}),_tmpD9->tl=0;_tmpD9;}));_tmpDA->capability=_tmp14B;}),_tmpDA->curr_rgn=param_rgn,
# 598
