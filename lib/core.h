...
extern xtunion exn { InvalidArg(string) };
extern xtunion exn { Failure(string) };
extern xtunion exn { Impossible(string) };
extern xtunion exn { Not_found };
extern xtunion exn { Unreachable(string) };
