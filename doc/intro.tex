...
AT\&T\@, Maryland, and Washington; much work began at Cornell.  Dan Grossman, Trevor Jim, and Greg Morrisett worked out the
...
project.  Mike Hicks ported a number of libraries and programs
to Cyclone, helped with the configuration and installation procedures,
and has been the lead on adding unique and reference-counted pointers to
Cyclone, among other things.  Mathieu Baudet contributed the bulk of the code for the
...
flex to Cyclone.  James Cheney has added support for 
representation types, singleton ints, marshalling support, etc.
All of these people have also contributed by finding
