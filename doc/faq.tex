...
\begin{faqa}{faq:kinds}{What do \texttt{`a::B}, \texttt{`a::M}, \texttt{`a::A}, \texttt{`a::R}, and \texttt{`a::E} mean?}
...
For porting code, we have defined a \textt{free} function that behaves as a
no-op, having type
\begin{verbatim}
  void free(`a::A ?);
\end{verbatim}
...
values because many Cyclone types get translated to \textt{void *.}  Third,
