...
storage has been deallocated.  See Section~\ref{sec:regions} for more
...
determine a region.
See~\hyperref[{sec:tut-regions}]{Section~\ref{sec:regions}} 
and~\hyperref[{sec:regions}]{Section~\ref{sec:regions}} for more information.
\end{faqa}
...
call \emph{kinds}.  There are four ``normal'' kinds: B (for Box), M (for Memory), A
