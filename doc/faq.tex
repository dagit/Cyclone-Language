...
\texttt{codegen}, \texttt{cut}, \texttt{datatype}, \texttt{fallthru},
\texttt{fill}, \texttt{let}, \texttt{malloc}, \texttt{namespace},
\texttt{new}, \texttt{NULL}, \texttt{region_t}, \texttt{regions},
\texttt{rmalloc}, \texttt{rnew}, \texttt{splice}, \texttt{throw},
...
creating objects, and destructing objects of a dataypte apply.
\end{faqa}
