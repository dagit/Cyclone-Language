 ...
 (setq c++-font-lock-keywords-2
  (append c++-font-lock-keywords-1
   (list
    ...
    ;; DAN: Take everything up to the : or && (we have patterns)
    ;; Must come before types because of _
    ;; Caps-for-constructors is just a convention -- maybe others don't like it.
    ;; (I was doing the paren thing, but it's a pain)
    '("\\<\\(case\\|goto\\)\\>\\(\\([^&:\n]\\|::\\|&[^&]\\)+\\)\\(:\\|&&\\)"
      (1 font-lock-keyword-face)
      (2 font-lock-constant-face)
