...
kind of pointer is indicated with a \texttt{*}, as in C\@.  For
...
There's much more to Cyclone pointers than we've described here.  For
example, a pointer type can also specify that it points to a
particular \emph{region} of memory, or that it points to a sequence of
known length.  We explain pointers in much more detail in
