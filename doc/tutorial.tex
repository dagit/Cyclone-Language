...
\item You can't cast an integer to a pointer.  Cyclone prevents this
  ...
  fact, you can't use \texttt{(void *)0} as a pointer in Cyclone, even
  though this is how C typically defines \texttt{NULL}.  Instead,
  Cyclone provides \texttt{NULL} as a keyword.
